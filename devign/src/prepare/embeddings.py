...
def nodes_to_input(nodes, target, nodes_dim, keyed_vectors, edge_type):
    print("\n--------------Executing nodes_to_input with below parameters started--------------");
    print("\n--------------nodes: ", nodes, "--------------");
    print("\n--------------target: ", target, "--------------");
    print("\n--------------nodes_dim: ", nodes_dim, "--------------");
    ...
    print("\n--------------label: ", label, "--------------");
    nodesEmbeddingNodes = nodes_embedding(nodes)
    print("\n--------------nodesEmbeddingNodes: ", nodesEmbeddingNodes, "--------------");
    graphsEmbeddingNodes = graphs_embedding(nodes)
    print("\n--------------graphsEmbeddingNodes: ", graphsEmbeddingNodes, "--------------");
    computedTorchData = Data(x=nodesEmbeddingNodes, edge_index=graphsEmbeddingNodes, y=label)
    print("\n--------------Executing nodes_to_input with below computedTorchData as output finished--------------");
    print(computedTorchData)
    return computedTorchData
