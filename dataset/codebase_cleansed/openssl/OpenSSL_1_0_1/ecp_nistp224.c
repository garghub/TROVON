...
felem_mul(tmp, ftmp3, ftmp2); felem_reduce(ftmp2, tmp);
felem_square(tmp, ftmp2); felem_reduce(ftmp3, tmp);
for (i = 0; i < 23; ++i)
{
felem_square(tmp, ftmp3); felem_reduce(ftmp3, tmp);
...
felem_square(tmp, ftmp3); felem_reduce(ftmp4, tmp);
for (i = 0; i < 47; ++i)
{
...
felem_mul(tmp, ftmp2, ftmp4); felem_reduce(ftmp2, tmp);
for (i = 0; i < 6; ++i)
{
felem_square(tmp, ftmp2); felem_reduce(ftmp2, tmp);
}
...
felem_mul(tmp, ftmp, ftmp3); felem_reduce(out, tmp);
}
static void
