...
ofld_req4.dst_mac_addr_lo32[0] = hba->ctlr.dest_addr[5];
...
enbl_req.dst_mac_addr_lo32[0] = hba->ctlr.dest_addr[5];
...
disable_req.dst_mac_addr_lo32[0] = hba->ctlr.dest_addr[5];
