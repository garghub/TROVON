...
gpio_request_one(GPIO_PORT61, GPIOF_OUT_INIT_HIGH, NULL);
gpio_request_one(GPIO_PORT202, GPIOF_OUT_INIT_LOW, NULL);
gpio_request(GPIO_FN_IRQ10, NULL);
gpio_request_one(GPIO_PORT166, GPIOF_OUT_INIT_HIGH, NULL);
...
gpio_request_one(GPIO_PORT18, GPIOF_OUT_INIT_HIGH, NULL);
gpio_request_one(GPIO_PORT159, GPIOF_IN, NULL);
...
gpio_request_one(GPIO_PORT17, GPIOF_OUT_INIT_LOW, NULL);
gpio_request_one(GPIO_PORT74, GPIOF_OUT_INIT_HIGH, NULL);
gpio_request_one(GPIO_PORT75, GPIOF_OUT_INIT_HIGH, NULL);
...
gpio_request_one(GPIO_PORT173, GPIOF_OUT_INIT_LOW, NULL);
gpio_request_one(GPIO_PORT172, GPIOF_OUT_INIT_HIGH, NULL);
gpio_request_one(GPIO_PORT158, GPIOF_OUT_INIT_LOW, NULL);
