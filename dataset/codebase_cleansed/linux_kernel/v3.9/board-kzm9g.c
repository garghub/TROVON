...
gpio_request_one(GPIO_PORT224, GPIOF_IN, NULL);
...
gpio_request_one(GPIO_PORT222, GPIOF_OUT_INIT_HIGH, NULL);
gpio_request_one(GPIO_PORT226, GPIOF_OUT_INIT_HIGH, NULL);
gpio_request_one(GPIO_PORT223, GPIOF_IN, NULL);
...
gpio_request_one(GPIO_PORT15, GPIOF_OUT_INIT_HIGH, NULL);
...
gpio_request_one(GPIO_PORT14, GPIOF_OUT_INIT_HIGH, NULL);
