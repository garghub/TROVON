...
hwsq_wr32(hwsq, 0x100210, 0x00000000);
hwsq_wr32(hwsq, 0x1002dc, 0x00000001);
hwsq_wr32(hwsq, 0xc040, mast);
hwsq_wr32(hwsq, 0x4008, orig | 0x00000200);
hwsq_wr32(hwsq, 0x400c, coef);
hwsq_wr32(hwsq, 0x4008, ctrl);
hwsq_wr32(hwsq, 0x1002d4, 0x00000001);
hwsq_wr32(hwsq, 0x1002dc, 0x00000000);
hwsq_wr32(hwsq, 0x100210, 0x80000000);
hwsq_usec(hwsq, 12);
hwsq_usec(hwsq, 48);
...
if (dev_priv->chipset < 0x92)
nv_mask(dev, 0x00c040, 0x001000b0, 0x00100080);
else
