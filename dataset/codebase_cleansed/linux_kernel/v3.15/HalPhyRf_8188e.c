void ODM_TxPwrTrackAdjust88E(struct odm_dm_struct *dm_odm, u8 Type,
u8 *pDirection,
u32 *pOutWriteVal
)
{
...
ThermalValue = (u8)PHY_QueryRFReg(Adapter, RF_PATH_A, RF_T_METER_88E, 0xfc00);
ODM_RT_TRACE(dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD,
...
if ((tmpreg&0x70) != 0)
rtw_write8(adapt, 0xd03, tmpreg&0x8F);
else
