...
{
rtw_write8(padapter, 0x6cc, 0x0);
rtw_write32(padapter, 0x6c8, 0xffff);
...
rtw_write32(padapter, 0x870, 0x0);
rtw_write8(padapter, 0x40, 0x24);
} else {
rtw_write8(padapter, 0x40, 0x20);
rtw_write16(padapter, 0x860, 0x210);
rtw_write32(padapter, 0x870, 0x300);
rtw_write32(padapter, 0x874, 0x22804000);
}
