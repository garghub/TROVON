...
size_t bufferSize = 2;
bufferSize += 2;
bufferSize += primitive->calibrationDataLength;
return bufferSize;
}
...
size_t bufferSize = 2;
bufferSize += 2;
bufferSize += primitive->mibAttributeLength;
return bufferSize;
}
...
bufferSize += 2;
bufferSize += 2;
bufferSize += primitive->filterLength;
bufferSize += 1;
bufferSize += 4;
return bufferSize;
}
...
bufferSize += 1;
bufferSize += 2;
bufferSize += primitive->scanConfig.passiveChannelListCount;
return bufferSize;
}
...
bufferSize += 1;
bufferSize += 2;
bufferSize += primitive->channelListCount;
bufferSize += 2;
bufferSize += primitive->probeIeLength;
return bufferSize;
}
...
bufferSize += 1;
bufferSize += 2;
bufferSize += primitive->tspecLength;
bufferSize += 2;
bufferSize += primitive->tclasLength;
return bufferSize;
}
...
size_t bufferSize = 2;
bufferSize += 4;
bufferSize += primitive->dataLength;
return bufferSize;
}
...
bufferSize += 1;
bufferSize += 2;
bufferSize += primitive->connectionInfo.beaconFrameLength;
bufferSize += 2;
bufferSize += primitive->connectionInfo.associationReqFrameLength;
bufferSize += 2;
bufferSize += primitive->connectionInfo.associationRspFrameLength;
bufferSize += 2;
bufferSize += primitive->connectionInfo.assocScanInfoElementsLength;
bufferSize += 2;
bufferSize += 2;
bufferSize += 6;
bufferSize += 2;
bufferSize += primitive->connectionInfo.assocReqInfoElementsLength;
bufferSize += 2;
bufferSize += 2;
bufferSize += 2;
bufferSize += 2;
bufferSize += primitive->connectionInfo.assocRspInfoElementsLength;
bufferSize += 2;
return bufferSize;
}
...
bufferSize += 1;
bufferSize += 2;
bufferSize += primitive->result.informationElementsLength;
bufferSize += 1;
...
bufferSize += 1;
bufferSize += 2;
bufferSize += primitive->scanResults[i1].informationElementsLength;
bufferSize += 1;
...
bufferSize += 4;
bufferSize += 4;
bufferSize += (primitive->versions.routerBuild ? strlen(primitive->versions.routerBuild) : 0) + 1;
bufferSize += 4;
bufferSize += (primitive->versions.smeBuild ? strlen(primitive->versions.smeBuild) : 0) + 1;
bufferSize += 4;
return bufferSize;
}
...
size_t bufferSize = 2;
bufferSize += (primitive->errorMessage ? strlen(primitive->errorMessage) : 0) + 1;
return bufferSize;
}
...
size_t bufferSize = 2;
bufferSize += (primitive->infoMessage ? strlen(primitive->infoMessage) : 0) + 1;
return bufferSize;
}
