...
ODM_SetBBReg(dm_odm, ODM_REG_IGI_A_11N, BIT7, 0);
ODM_SetBBReg(dm_odm, ODM_REG_LNA_SWITCH_11N, BIT31, 1);
return;
}
ODM_RT_TRACE(dm_odm, ODM_COMP_ANT_DIV, ODM_DBG_LOUD, ("odm_RX_HWAntDivInit()\n"));
value32 = ODM_GetMACReg(dm_odm, ODM_REG_ANTSEL_PIN_11N, bMaskDWord);
ODM_SetMACReg(dm_odm, ODM_REG_ANTSEL_PIN_11N, bMaskDWord, value32|(BIT23|BIT25));
ODM_SetBBReg(dm_odm, ODM_REG_PIN_CTRL_11N, BIT9|BIT8, 0);
ODM_SetBBReg(dm_odm, ODM_REG_RX_ANT_CTRL_11N, BIT10, 0);
ODM_SetBBReg(dm_odm, ODM_REG_LNA_SWITCH_11N, BIT22, 1);
ODM_SetBBReg(dm_odm, ODM_REG_LNA_SWITCH_11N, BIT31, 1);
ODM_SetBBReg(dm_odm, ODM_REG_ANTDIV_PARA1_11N, bMaskDWord, 0x000000a0);
ODM_SetBBReg(dm_odm, ODM_REG_BB_PWR_SAV4_11N, BIT7, 1);
ODM_SetBBReg(dm_odm, ODM_REG_CCK_ANTDIV_PARA2_11N, BIT4, 1);
ODM_UpdateRxIdleAnt_88E(dm_odm, MAIN_ANT);
ODM_SetBBReg(dm_odm, ODM_REG_ANT_MAPPING1_11N, 0xFFFF, 0x0201);
}
...
dm_odm->AntDivType = CGCS_RX_SW_ANTDIV;
ODM_SetBBReg(dm_odm, ODM_REG_IGI_A_11N, BIT7, 0);
ODM_SetBBReg(dm_odm, ODM_REG_RX_ANT_CTRL_11N, BIT5|BIT4|BIT3, 0);
return;
}
...
ODM_SetBBReg(dm_odm, ODM_REG_PIN_CTRL_11N, BIT9|BIT8, 0);
ODM_SetBBReg(dm_odm, ODM_REG_RX_ANT_CTRL_11N, BIT10, 0);
ODM_SetBBReg(dm_odm, ODM_REG_LNA_SWITCH_11N, BIT22, 0);
ODM_SetBBReg(dm_odm, ODM_REG_LNA_SWITCH_11N, BIT31, 1);
ODM_SetBBReg(dm_odm, ODM_REG_ANTDIV_PARA1_11N, bMaskDWord, 0x000000a0);
ODM_SetBBReg(dm_odm, ODM_REG_BB_PWR_SAV4_11N, BIT7, 1);
ODM_SetBBReg(dm_odm, ODM_REG_CCK_ANTDIV_PARA2_11N, BIT4, 1);
ODM_SetBBReg(dm_odm, ODM_REG_TX_ANT_CTRL_11N, BIT21, 0);
ODM_UpdateRxIdleAnt_88E(dm_odm, MAIN_ANT);
if (!dm_odm->bIsMPChip) {
ODM_SetBBReg(dm_odm, ODM_REG_RX_DEFUALT_A_11N, BIT10|BIT9|BIT8, 1);
ODM_SetBBReg(dm_odm, ODM_REG_RX_DEFUALT_A_11N, BIT13|BIT12|BIT11, 2);
} else {
ODM_SetBBReg(dm_odm, ODM_REG_ANT_MAPPING1_11N, bMaskDWord, 0x0201);
}
}
...
ODM_SetBBReg(dm_odm, 0x870, BIT9|BIT8, 0);
ODM_SetBBReg(dm_odm, 0x864, BIT10, 0);
ODM_SetBBReg(dm_odm, 0xb2c, BIT22, 0);
ODM_SetBBReg(dm_odm, 0xb2c, BIT31, 1);
ODM_SetBBReg(dm_odm, 0xca4, bMaskDWord, 0x000000a0);
if (AntCombination == 2) {
if (!dm_odm->bIsMPChip) {
ODM_SetBBReg(dm_odm, 0x858, BIT10|BIT9|BIT8, 1);
ODM_SetBBReg(dm_odm, 0x858, BIT13|BIT12|BIT11, 2);
} else {
...
if (!dm_odm->bIsMPChip) {
ODM_SetBBReg(dm_odm, 0x858, BIT10|BIT9|BIT8, 0);
ODM_SetBBReg(dm_odm, 0x858, BIT13|BIT12|BIT11, 1);
ODM_SetBBReg(dm_odm, 0x878, BIT16, 0);
ODM_SetBBReg(dm_odm, 0x858, BIT15|BIT14, 2);
ODM_SetBBReg(dm_odm, 0x878, BIT19|BIT18|BIT17, 3);
ODM_SetBBReg(dm_odm, 0x878, BIT22|BIT21|BIT20, 4);
ODM_SetBBReg(dm_odm, 0x878, BIT25|BIT24|BIT23, 5);
ODM_SetBBReg(dm_odm, 0x878, BIT28|BIT27|BIT26, 6);
ODM_SetBBReg(dm_odm, 0x878, BIT31|BIT30|BIT29, 7);
} else {
...
ODM_SetBBReg(dm_odm, 0x80c, BIT21, 1);
ODM_SetBBReg(dm_odm, 0x864, BIT5|BIT4|BIT3, 0);
ODM_SetBBReg(dm_odm, 0x864, BIT8|BIT7|BIT6, 1);
ODM_SetBBReg(dm_odm, 0x864, BIT2|BIT1|BIT0, (AntCombination-1));
ODM_SetBBReg(dm_odm, 0xc50, BIT7, 1);
}
...
if (dm_odm->AntDivType == CG_TRX_HW_ANTDIV) {
ODM_SetBBReg(dm_odm, ODM_REG_RX_ANT_CTRL_11N, BIT5|BIT4|BIT3, DefaultAnt);
ODM_SetBBReg(dm_odm, ODM_REG_RX_ANT_CTRL_11N, BIT8|BIT7|BIT6, OptionalAnt);
ODM_SetBBReg(dm_odm, ODM_REG_ANTSEL_CTRL_11N, BIT14|BIT13|BIT12, DefaultAnt);
ODM_SetMACReg(dm_odm, ODM_REG_RESP_TX_11N, BIT6|BIT7, DefaultAnt);
...
ODM_SetBBReg(dm_odm, ODM_REG_IGI_A_11N, BIT7, 0);
ODM_SetBBReg(dm_odm, ODM_REG_CCK_ANTDIV_PARA1_11N, BIT15, 0);
if (dm_odm->AntDivType == CG_TRX_HW_ANTDIV)
ODM_SetBBReg(dm_odm, ODM_REG_TX_ANT_CTRL_11N, BIT21, 0);
...
ODM_SetBBReg(dm_odm, ODM_REG_IGI_A_11N, BIT7, 1);
ODM_SetBBReg(dm_odm, ODM_REG_CCK_ANTDIV_PARA1_11N, BIT15, 1);
if (dm_odm->AntDivType == CG_TRX_HW_ANTDIV)
ODM_SetBBReg(dm_odm, ODM_REG_TX_ANT_CTRL_11N, BIT21, 1);
dm_fat_tbl->bBecomeLinked = dm_odm->bLinked;
}
}
