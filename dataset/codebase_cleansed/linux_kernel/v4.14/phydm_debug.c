...
if (ptr > 311)
ptr -= 312;
odm_set_bb_reg(dm, 0x1910, 0x03FF0000, ptr);
...
short_cfo_b = (s32)(value32 & 0xfff);
short_cfo_a = (s32)((value32 & 0x0fff0000) >> 16);
long_cfo_b = (s32)(value32_1 & 0x1fff);
...
avg_cfo_b = (s32)(value32_1 & 0x1fff);
...
acq_cfo_b = (s32)(value32_1 & 0x1fff);
...
lfo_a, lfo_b, lfo_c, lfo_d);
value32 = odm_get_bb_reg(dm, 0xf20, MASKDWORD);
...
hrx_bw, h_length);
value32 = odm_get_bb_reg(dm, 0xf30, MASKDWORD);
if (rx_ht == 1) {
...
value32 = odm_get_bb_reg(dm, 0xf34, MASKDWORD);
{
...
odm_set_bb_reg(dm, 0x9e8, BIT(24), 0);
...
extend_c2h_dbg_content = buffer + 2;
