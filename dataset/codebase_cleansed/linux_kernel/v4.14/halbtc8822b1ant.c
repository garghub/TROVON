...
btcoexist, 0x42, BIT(3), bit_val[2]);
btcoexist->btc_write_1byte_bitmask(
btcoexist, 0x65, BIT(7), bit_val[3]);
btcoexist->btc_write_1byte_bitmask(
btcoexist, 0x72, BIT(2), bit_val[4]);
}
}
static u32
...
return btcoexist->btc_read_4byte(btcoexist, 0x1708);
}
static void
