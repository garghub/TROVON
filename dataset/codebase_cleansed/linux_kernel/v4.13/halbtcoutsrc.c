...
cmd_buffer1[0] |= (oper_ver & 0x0f);
cmd_buffer1[0] |= ((req_num << 4) & 0xf0);
cmd_buffer1[1] = 0x0d;
cmd_buffer1[2] = value_to_set[0];
rtlpriv->cfg->ops->fill_h2c_cmd(rtlpriv->mac80211.hw, 0x67, 4,
&cmd_buffer1[0]);
msleep(200);
req_num++;
cmd_buffer2[0] |= (oper_ver & 0x0f);
cmd_buffer2[0] |= ((req_num << 4) & 0xf0);
cmd_buffer2[1] = 0x0c;
cmd_buffer2[3] = addr_to_set[0];
rtlpriv->cfg->ops->fill_h2c_cmd(rtlpriv->mac80211.hw, 0x67, 4,
&cmd_buffer2[0]);
}
}
