...
gint8 tmpval;
guint32 i;
*out = ep_alloc_array0(guint8, in_len);
if (*out == NULL) {
return 0;
}
...
buf = (guchar *)ep_alloc0(max_iorlen+1);
...
print_string = (gchar * )ep_alloc0(len + 1);
...
sign = tval & 0x0f;
sindex = 0;
*seq = ep_alloc_array0(gchar, slen + 3);
#if DEBUG
