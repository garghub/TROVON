...
break;
case PT_G723:
if (rp->info->info_payload_len%24 == 0)
tmp_buff = g_malloc(sizeof(SAMPLE) * rp->info->info_payload_len * 10);
else if (rp->info->info_payload_len%20 == 0)
tmp_buff = g_malloc(sizeof(SAMPLE) * rp->info->info_payload_len * 13);
else {
return 0;
}
...
stream_parameters.channelCount = NUM_CHANNELS;
