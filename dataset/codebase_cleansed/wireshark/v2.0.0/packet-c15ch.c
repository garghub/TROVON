...
ch_buff = (char *) wmem_alloc(wmem_packet_scope(), num_digits + 1);
...
loc_string = (char *) wmem_alloc0(wmem_packet_scope(), MAX_LEN_LOC_STRING);
...
guint32 key_val;
concat_string = (char *) wmem_alloc0(wmem_packet_scope(), MAX_LEN_CONCAT_STRING);
...
tvb, 8, 4, ENC_BIG_ENDIAN);
ti = proto_tree_add_string(c15ch_nitnxlate_tree, hf_c15ch_nitnxlate_concat_string, tvb, 12, 40 ,
concat_string);
...
from_loc_string = (char *) wmem_alloc0(wmem_packet_scope(), MAX_LEN_LOC_STRING);
...
to_loc_string = (char *) wmem_alloc0(wmem_packet_scope(), MAX_LEN_LOC_STRING);
