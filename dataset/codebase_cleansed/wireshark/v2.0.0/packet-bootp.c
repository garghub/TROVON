...
consumedx = get_dns_name(rfc3396_sip_server.tvb_composite, offset, tvb_reported_length(rfc3396_sip_server.tvb_composite), 1 , &dns_name);
if (rfc3396_sip_server.total_number_of_block == 1) {
...
{"nop", special, NULL},
{"DeviceManufacturerOUI", oui, &hf_bootp_option125_tr111_device_manufacturer_oui},
...
{"nop", special, NULL},
{"Option Request = ", bytes, &hf_bootp_option125_cl_option_request},
