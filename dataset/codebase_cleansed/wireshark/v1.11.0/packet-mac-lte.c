...
UL_tti_info.subframe = 0xff;
memset(&DL_tti_info, 0, sizeof(DL_tti_info));
DL_tti_info.subframe = 0xff;
...
{ &ei_mac_lte_reserved_not_zero, { "mac-lte.reserved_not_zero", PI_MALFORMED, PI_ERROR, "Reserved bit not zero", EXPFILL }},
{ &ei_mac_lte_rar_timing_advance_not_zero_note, { "mac-lte.mac-lte.rar.ta.not_zero", PI_SEQUENCE, PI_NOTE, "RAR Timing advance not zero", EXPFILL }},
{ &ei_mac_lte_rar_timing_advance_not_zero_warn, { "mac-lte.mac-lte.rar.ta.not_zero", PI_SEQUENCE, PI_WARN, "RAR Timing advance not zero", EXPFILL }},
...
{ &ei_mac_lte_orig_tx_ul_frame_not_found, { "mac-lte.orig_tx_ul_frame_not_found", PI_SEQUENCE, PI_ERROR, "Original Tx of UL frame not found", EXPFILL }},
...
{ &ei_mac_lte_sr_results_not_grant_or_failure_indication, { "mac-lte.sr_results_not_grant_or_failure_indication", PI_SEQUENCE, PI_ERROR, "SR results in neither a grant nor a failure indication", EXPFILL }},
...
{ &ei_mac_lte_control_subheader_after_data_subheader, { "mac-lte.control_subheader_after_data_subheader", PI_MALFORMED, PI_ERROR, "?L-SCH Control subheaders should not appear after data subheaders", EXPFILL }},
...
{ &ei_mac_lte_lcid_unexpected, { "mac-lte.lcid_unexpected", PI_MALFORMED, PI_ERROR, "?L-SCH: Unexpected LCID received", EXPFILL }},
{ &ei_mac_lte_too_many_subheaders, { "mac-lte.too_many_subheaders", PI_MALFORMED, PI_ERROR, "Reached too many subheaders - frame obviously malformed", EXPFILL }},
...
{ &ei_mac_lte_control_element_size_invalid, { "mac-lte.control_element.size_invalid", PI_MALFORMED, PI_ERROR, "Control Element has an unexpected size", EXPFILL }},
{ &ei_mac_lte_bsr_warn_threshold_exceeded, { "mac-lte.bsr_warn_threshold_exceeded", PI_SEQUENCE, PI_WARN, "BSR for LCG X exceeds threshold", EXPFILL }},
...
{ &ei_mac_lte_rach_preamble_sent_warn, { "mac-lte.rach_preamble_sent", PI_SEQUENCE, PI_WARN, "RACH Preamble sent", EXPFILL }},
{ &ei_mac_lte_rach_preamble_sent_note, { "mac-lte.rach_preamble_sent", PI_SEQUENCE, PI_NOTE, "RACH Preamble sent", EXPFILL }},
...
{ &ei_mac_lte_ul_mac_frame_retx, { "mac-lte.ul_mac_frame_retx", PI_SEQUENCE, PI_WARN, "UL MAC frame ReTX", EXPFILL }},
