...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_VersionVector_low);
return offset;
}
static int
...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_VersionVector_high);
return offset;
}
int
...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_Update_uid_version);
return offset;
}
static int
...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_Update_gsvn_version);
return offset;
}
static int
...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_Update_parent_version);
return offset;
}
static int
...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_AsyncVersionVectorResponse_vv_generation);
return offset;
}
static int
...
static int
frstrans_dissect_element_RdcParameters_rdc_chunker_algorithm(tvbuff_t *tvb _U_, int offset _U_, packet_info *pinfo _U_, proto_tree *tree _U_, guint8 *drep _U_)
{
offset = frstrans_dissect_enum_RdcChunckerAlgorithm(tvb, offset, pinfo, tree, drep, hf_frstrans_frstrans_RdcParameters_rdc_chunker_algorithm, 0);
return offset;
}
static int
frstrans_dissect_element_RdcParameters_u(tvbuff_t *tvb _U_, int offset _U_, packet_info *pinfo _U_, proto_tree *tree _U_, guint8 *drep _U_)
{
offset = frstrans_dissect_RdcParameterUnion(tvb, offset, pinfo, tree, drep, hf_frstrans_frstrans_RdcParameters_u, 0);
return offset;
}
int
...
offset = frstrans_dissect_element_RdcParameters_rdc_chunker_algorithm(tvb, offset, pinfo, tree, drep);
offset = frstrans_dissect_element_RdcParameters_u(tvb, offset, pinfo, tree, drep);
proto_item_set_len(item, offset-old_offset);
return offset;
}
int
...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_RdcFileInfo_on_disk_file_size);
return offset;
}
static int
...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_RdcFileInfo_file_size_estimate);
return offset;
}
static int
...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_RequestUpdates_gvsn_version);
return offset;
}
static int
...
{
offset=cnf_dissect_hyper(tvb, offset, pinfo, tree, drep, 0, hf_frstrans_frstrans_RequestVersionVector_vv_generation);
return offset;
}
static int
...
static int
frstrans_dissect_FRSTRANS_RAW_GET_FILE_DATA_ASYNC_response(tvbuff_t *tvb _U_, int offset _U_, packet_info *pinfo _U_, proto_tree *tree _U_, guint8 *drep _U_)
{
pinfo->dcerpc_procedure_name="FRSTRANS_RAW_GET_FILE_DATA_ASYNC";
return offset;
}
static int
frstrans_dissect_FRSTRANS_RAW_GET_FILE_DATA_ASYNC_request(tvbuff_t *tvb _U_, int offset _U_, packet_info *pinfo _U_, proto_tree *tree _U_, guint8 *drep _U_)
{
pinfo->dcerpc_procedure_name="FRSTRANS_RAW_GET_FILE_DATA_ASYNC";
return offset;
}
static int
frstrans_dissect_FRSTRANS_RDC_GET_FILE_DATA_ASYNC_response(tvbuff_t *tvb _U_, int offset _U_, packet_info *pinfo _U_, proto_tree *tree _U_, guint8 *drep _U_)
{
pinfo->dcerpc_procedure_name="FRSTRANS_RDC_GET_FILE_DATA_ASYNC";
return offset;
}
static int
frstrans_dissect_FRSTRANS_RDC_GET_FILE_DATA_ASYNC_request(tvbuff_t *tvb _U_, int offset _U_, packet_info *pinfo _U_, proto_tree *tree _U_, guint8 *drep _U_)
{
pinfo->dcerpc_procedure_name="FRSTRANS_RDC_GET_FILE_DATA_ASYNC";
return offset;
}
