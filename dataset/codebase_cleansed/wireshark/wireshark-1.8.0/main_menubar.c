...
{
match_selected_ptree_cb( NULL , user_data, MATCH_SELECTED_REPLACE|MATCH_SELECTED_COPY_ONLY);
}
static void
...
{
match_selected_plist_cb( NULL , user_data, MATCH_SELECTED_REPLACE|MATCH_SELECTED_COPY_ONLY);
}
static void
packet_list_menu_copy_bytes_oht_cb(GtkAction *action _U_, gpointer user_data)
{
copy_hex_cb( NULL , user_data, CD_ALLINFO | CD_FLAGS_SELECTEDONLY);
}
static void
packet_list_menu_copy_bytes_oh_cb(GtkAction *action _U_, gpointer user_data)
{
copy_hex_cb( NULL , user_data, CD_HEXCOLUMNS | CD_FLAGS_SELECTEDONLY);
}
static void
packet_list_menu_copy_bytes_text_cb(GtkAction *action _U_, gpointer user_data)
{
copy_hex_cb( NULL , user_data, CD_TEXTONLY | CD_FLAGS_SELECTEDONLY);
}
static void
packet_list_menu_copy_bytes_hex_strm_cb(GtkAction *action _U_, gpointer user_data)
{
copy_hex_cb( NULL , user_data, CD_HEX | CD_FLAGS_SELECTEDONLY);
}
static void
packet_list_menu_copy_bytes_bin_strm_cb(GtkAction *action _U_, gpointer user_data)
{
copy_hex_cb( NULL , user_data, CD_BINARY | CD_FLAGS_SELECTEDONLY);
}
static void
...
(gpointer)packet_list_heading_menu_popup_action_entries,
...
(gpointer)packet_list_heading_menu_toggle_action_entries,
...
(gpointer)packet_list_menu_popup_action_entries,
...
(gpointer)tree_view_menu_popup_action_entries,
...
(gpointer)bytes_menu_radio_action_entries,
...
(gpointer)statusbar_profiles_menu_action_entries,
...
gtk_action_set_visible (action, val);
}
static void
