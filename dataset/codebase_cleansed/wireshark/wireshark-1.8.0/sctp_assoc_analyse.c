...
list_store = GTK_LIST_STORE(gtk_tree_view_get_model(GTK_TREE_VIEW (u_data->analyse_nb->page2->clist)));
...
list_store = GTK_LIST_STORE(gtk_tree_view_get_model(GTK_TREE_VIEW (u_data->analyse_nb->page3->clist)));
gtk_list_store_insert_with_values( list_store , &iter, G_MAXINT,
0, field[0], -1);
list = g_list_next(list);
}
