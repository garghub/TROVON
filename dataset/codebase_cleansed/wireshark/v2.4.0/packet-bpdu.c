...
dissector_add_uint("llc.cisco_pid", 0x0108, bpdu_handle);
dissector_add_uint("llc.cisco_pid", 0x0109, bpdu_handle);
dissector_add_uint("llc.cisco_pid", 0x010c, bpdu_handle);
dissector_add_uint("llc.cisco_pid", 0x010b, bpdu_cisco_handle);
}
