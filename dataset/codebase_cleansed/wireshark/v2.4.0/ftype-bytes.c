...
bytes_to_repr,
bytes_repr_len,
{ .set_value_byte_array = bytes_fvalue_set },
...
bytes_to_repr,
bytes_repr_len,
{ .set_value_bytes = ax25_fvalue_set },
{ .get_value_ptr = value_get },
cmp_eq,
cmp_ne,
cmp_gt,
...
bytes_to_repr,
bytes_repr_len,
{ .set_value_bytes = vines_fvalue_set },
{ .get_value_ptr = value_get },
cmp_eq,
cmp_ne,
cmp_gt,
...
bytes_to_repr,
bytes_repr_len,
{ .set_value_bytes = ether_fvalue_set },
{ .get_value_ptr = value_get },
cmp_eq,
cmp_ne,
cmp_gt,
...
oid_to_repr,
oid_repr_len,
{ .set_value_byte_array = oid_fvalue_set },
{ .get_value_ptr = value_get },
cmp_eq,
cmp_ne,
cmp_gt,
...
system_id_to_repr,
bytes_repr_len,
{ .set_value_byte_array = system_id_fvalue_set },
{ .get_value_ptr = value_get },
cmp_eq,
cmp_ne,
cmp_gt,
...
bytes_to_repr,
bytes_repr_len,
{ .set_value_bytes = fcwwn_fvalue_set },
{ .get_value_ptr = value_get },
cmp_eq,
cmp_ne,
cmp_gt,
