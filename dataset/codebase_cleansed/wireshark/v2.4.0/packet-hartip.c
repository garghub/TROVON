...
dissect_byte(body_tree, hf_hartip_pt_rsp_device_profile, tvb, offset);
}
return bodylen;
}
return 0;
...
dissect_float(body_tree, hf_hartip_pt_rsp_pv, tvb, offset);
return bodylen;
}
return 0;
}
...
dissect_float(body_tree, hf_hartip_pt_rsp_pv_percent_range, tvb, offset);
return bodylen;
}
return 0;
}
...
dissect_float(body_tree, hf_hartip_pt_rsp_qv, tvb, offset);
return bodylen;
}
return 0;
}
...
dissect_byte(body_tree, hf_hartip_pt_rsp_year, tvb, offset);
return bodylen;
}
return 0;
}
