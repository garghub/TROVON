...
switch (afi) {
case NSAP_IDI_ISO_DCC_BIN:
case NSAP_IDI_ISO_DCC_BIN_GROUP:
...
break;
case NSAP_IDI_ISO_6523_ICD_BIN:
case NSAP_IDI_ISO_6523_ICD_BIN_GROUP:
...
proto_tree_add_item(tree, hf_atmarp_src_atm_selector, tvb, offset + 19, 1, ENC_BIG_ENDIAN);
break;
case NSAP_IDI_E_164_BIN_FSD_NZ:
case NSAP_IDI_E_164_BIN_FSD_NZ_GROUP:
