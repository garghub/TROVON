...
V_5 -> V_563 = V_564 ;
V_5 -> V_565 = V_564 ;
V_544 = F_292 ( & V_479 , V_5 , V_74 , V_74 + 1 , V_80 ) ;
if ( V_544 < 0 ) {
if ( V_544 == - V_566 )
V_110 = V_546 ;
goto V_567;
...
F_36 ( & V_5 -> V_58 ) ;
V_544 = F_292 ( & V_22 -> V_474 , V_5 , V_73 , V_73 + 1 , V_80 ) ;
if ( V_544 < 0 ) {
if ( V_544 == - V_566 )
V_110 = V_546 ;
goto V_568;
...
F_36 ( & V_5 -> V_58 ) ;
V_544 = F_292 ( & V_14 -> V_75 , V_72 , V_73 , V_73 + 1 , V_80 ) ;
if ( V_544 < 0 ) {
if ( V_544 == - V_566 )
V_110 = V_571 ;
goto V_570;
...
goto V_513;
V_110 = - V_450 ;
V_476 = F_314 ( L_38 , V_581 | V_582 , NULL , & V_583 , NULL ) ;
if ( ! V_476 ) {
F_309 ( L_53 ) ;
goto V_513;
}
V_462 . V_473 = F_315 ( L_54 ) ;
if ( ! V_462 . V_473 ) {
F_309 ( L_55 ) ;
goto V_513;
}
...
void F_189 ( struct V_588 * V_128 )
{
if ( V_128 == NULL )
return;
F_319 ( V_128 -> V_188 , V_589 | V_351 | V_590 ) ;
F_319 ( V_128 -> V_591 , V_589 | V_351 | V_590 ) ;
F_55 ( V_128 -> V_120 ) ;
F_55 ( V_128 ) ;
}
static void F_320 ( struct V_102 * V_592 )
{
struct V_104 * V_24 ;
F_71 ( & V_592 -> V_106 ) ;
V_24 = V_592 -> V_104 ;
...
{
struct V_594 * V_100 = V_233 ;
T_4 V_254 ;
int V_158 ;
memset ( V_100 , 0 , sizeof( * V_100 ) ) ;
V_100 -> V_595 = F_90 ( F_105 ( V_5 -> V_196 ) ) ;
for ( V_158 = V_162 ; V_158 < V_163 ; V_158 ++ )
V_100 -> V_164 [ V_158 ] = F_90 ( V_5 -> V_128 -> V_160 . V_164 [ V_158 ] ) ;
V_100 -> V_44 = F_64 ( V_5 -> V_128 -> V_160 . V_44 ) ;
V_100 -> V_92 = F_64 ( V_596 ) ;
V_100 -> V_597 = F_64 ( V_5 -> V_128 -> V_160 . V_597 ) ;
V_100 -> V_598 = F_64 ( V_5 -> V_128 -> V_160 . V_598 ) ;
V_100 -> V_599 = F_64 ( V_5 -> V_453 -> V_600 ) ;
V_100 -> V_601 = F_64 ( V_602 ) ;
V_100 -> V_603 = F_90 ( V_5 -> V_128 -> V_160 . V_603 ) ;
V_100 -> V_604 = F_64 ( V_5 -> V_128 -> V_160 . V_604 ) ;
V_100 -> V_605 = F_64 ( V_5 -> V_412 ) ;
V_100 -> V_606 = F_64 ( V_5 -> V_128 -> V_160 . V_606 ) ;
V_100 -> V_607 = F_64 ( V_5 -> V_128 -> V_160 . V_607 ) ;
F_97 ( V_5 , F_325 ( V_5 -> V_128 ) == V_5 -> V_128 -> V_160 . V_608 ) ;
V_254 = V_5 -> V_128 -> V_160 . V_608 ;
if ( F_326 ( V_5 , V_5 -> V_128 , V_254 , V_609 ) ) {
F_11 ( V_5 , L_64 ) ;
F_327 ( V_5 , 1 , V_610 ) ;
}
}
...
struct V_594 * V_100 ;
F_61 ( V_163 != 4 ) ;
F_61 ( sizeof( struct V_594 ) != 4096 ) ;
F_328 ( & V_5 -> V_399 ) ;
if ( ! F_329 ( V_611 , & V_5 -> V_44 ) )
return;
if ( ! F_89 ( V_5 , V_612 ) )
return;
...
goto V_324;
F_324 ( V_5 , V_100 ) ;
V_5 -> V_128 -> V_160 . V_595 = F_105 ( V_5 -> V_196 ) ;
F_331 ( V_5 ) ;
V_324:
F_85 ( V_5 ) ;
}
...
struct V_614 * V_615 )
{
T_5 V_606 = F_333 ( V_613 -> V_606 ) ;
T_5 V_607 = F_333 ( V_613 -> V_607 ) ;
T_3 V_616 ;
if ( V_606 == 0 && V_607 == 0 ) {
V_606 = 1 ;
V_607 = V_617 / 8 ;
...
if ( V_606 == 0 || V_607 == 0 )
goto V_110;
V_616 = ( T_3 ) V_606 * V_607 ;
if ( V_616 > ( 16 * 1024 * 1024 / 4 ) )
goto V_110;
if ( V_616 < V_617 / 8 )
goto V_110;
V_615 -> V_607 = V_607 ;
...
static int F_334 ( struct V_4 * V_5 , struct V_588 * V_345 )
{
T_4 V_618 = F_105 ( V_345 -> V_591 ) ;
struct V_614 * V_615 = & V_345 -> V_160 ;
T_9 V_619 ;
T_9 V_620 ;
if ( V_615 -> V_598 < 0 ) {
if ( V_615 -> V_604 > V_615 -> V_598 )
goto V_110;
V_619 = - V_615 -> V_598 ;
V_620 = V_615 -> V_598 - V_615 -> V_604 ;
} else {
if ( V_615 -> V_598 != V_621 )
goto V_110;
if ( V_615 -> V_604 < V_615 -> V_598 + V_615 -> V_616 * V_621 )
goto V_110;
V_619 = V_615 -> V_604 - V_621 ;
V_620 = V_615 -> V_597 - V_615 -> V_604 ;
}
if ( V_615 -> V_622 >= 0 ) {
if ( V_615 -> V_597 != V_623
|| V_615 -> V_598 != V_621
|| V_615 -> V_604 != V_621 + V_617
|| V_615 -> V_606 != 1
|| V_615 -> V_607 != V_617 / 8 )
goto V_110;
}
if ( V_618 < V_615 -> V_597 )
goto V_110;
if ( V_618 - V_615 -> V_597 < F_335 ( V_345 ) )
goto V_110;
if ( ( V_619 & 7 ) || ( V_619 < V_617 ) )
goto V_110;
if ( V_619 != V_615 -> V_616 * V_621 )
goto V_110;
if ( V_615 -> V_604 & 7 )
goto V_110;
if ( V_620 < ( V_615 -> V_595 + 7 ) / V_621 / 8 / 512 )
goto V_110;
return 0 ;
V_110:
F_11 ( V_5 , L_66
...
L_68 ,
V_615 -> V_622 ,
V_615 -> V_606 , V_615 -> V_607 ,
V_615 -> V_598 , V_615 -> V_604 , V_615 -> V_597 ,
( unsigned long long ) V_615 -> V_595 ,
( unsigned long long ) V_618 ) ;
return - V_577 ;
}
int F_336 ( struct V_4 * V_5 , struct V_588 * V_345 )
{
struct V_594 * V_100 ;
T_5 V_92 , V_44 ;
...
if ( ! V_100 )
return V_545 ;
V_345 -> V_160 . V_622 = V_345 -> V_120 -> V_622 ;
V_345 -> V_160 . V_608 = F_325 ( V_345 ) ;
if ( F_326 ( V_5 , V_345 , V_345 -> V_160 . V_608 , V_625 ) ) {
F_11 ( V_5 , L_69 ) ;
V_333 = V_626 ;
goto V_110;
}
...
if ( F_333 ( V_100 -> V_601 ) != V_602 ) {
F_11 ( V_5 , L_73 ,
F_333 ( V_100 -> V_601 ) , V_602 ) ;
goto V_110;
}
V_345 -> V_160 . V_595 = F_337 ( V_100 -> V_595 ) ;
for ( V_158 = V_162 ; V_158 < V_163 ; V_158 ++ )
V_345 -> V_160 . V_164 [ V_158 ] = F_337 ( V_100 -> V_164 [ V_158 ] ) ;
V_345 -> V_160 . V_44 = F_333 ( V_100 -> V_44 ) ;
V_345 -> V_160 . V_603 = F_337 ( V_100 -> V_603 ) ;
V_345 -> V_160 . V_597 = F_333 ( V_100 -> V_597 ) ;
V_345 -> V_160 . V_598 = F_333 ( V_100 -> V_598 ) ;
V_345 -> V_160 . V_604 = F_333 ( V_100 -> V_604 ) ;
if ( F_332 ( V_5 , V_100 , & V_345 -> V_160 ) )
goto V_110;
if ( F_334 ( V_5 , V_345 ) )
goto V_110;
if ( F_333 ( V_100 -> V_604 ) != V_345 -> V_160 . V_604 ) {
F_11 ( V_5 , L_74 ,
F_333 ( V_100 -> V_604 ) , V_345 -> V_160 . V_604 ) ;
goto V_110;
}
if ( F_333 ( V_100 -> V_597 ) != V_345 -> V_160 . V_597 ) {
F_11 ( V_5 , L_75 ,
F_333 ( V_100 -> V_597 ) , V_345 -> V_160 . V_597 ) ;
goto V_110;
}
V_333 = V_573 ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
...
{
if ( ! F_340 ( V_611 , & V_5 -> V_44 ) ) {
F_341 ( & V_5 -> V_399 , V_632 + V_633 ) ;
V_5 -> V_634 . line = line ;
V_5 -> V_634 . F_32 = F_32 ;
}
}
...
void F_344 ( struct V_4 * V_5 , int V_635 , T_3 V_203 ) __must_hold( T_10 )
{
if ( V_635 == V_162 ) {
if ( V_5 -> V_10 . V_349 == V_350 )
V_203 |= 1 ;
...
V_5 -> V_128 -> V_160 . V_164 [ V_635 ] = V_203 ;
F_342 ( V_5 ) ;
}
void F_346 ( struct V_4 * V_5 , int V_635 , T_3 V_203 ) __must_hold( T_10 )
{
unsigned long V_44 ;
F_24 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
F_344 ( V_5 , V_635 , V_203 ) ;
F_26 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
}
void F_99 ( struct V_4 * V_5 , int V_635 , T_3 V_203 ) __must_hold( T_10 )
{
unsigned long V_44 ;
F_24 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
if ( V_5 -> V_128 -> V_160 . V_164 [ V_635 ] ) {
F_343 ( V_5 ) ;
V_5 -> V_128 -> V_160 . V_164 [ V_173 ] = V_5 -> V_128 -> V_160 . V_164 [ V_635 ] ;
}
F_344 ( V_5 , V_635 , V_203 ) ;
F_26 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
}
...
F_9 ( & V_5 -> V_128 -> V_160 . V_161 ) ;
V_636 = V_5 -> V_128 -> V_160 . V_164 [ V_172 ] ;
if ( V_636 )
F_159 ( V_5 , L_76 , V_636 ) ;
...
unsigned long long V_636 = V_5 -> V_128 -> V_160 . V_164 [ V_172 ] ;
if ( V_636 )
F_159 ( V_5 , L_76 , V_636 ) ;
...
static int V_397 ( struct V_492 * V_391 , int V_637 )
{
struct V_4 * V_5 =
F_207 ( V_391 , struct V_4 , V_390 . V_391 ) ;
struct V_390 * V_638 = & V_5 -> V_390 ;
int V_333 = - V_115 ;
F_97 ( V_5 , F_217 ( & V_5 -> V_366 ) == 0 ) ;
if ( F_84 ( V_5 ) ) {
F_354 ( V_5 , V_638 -> V_639 , V_638 -> V_44 ) ;
V_333 = V_638 -> V_640 ( V_5 ) ;
F_355 ( V_5 ) ;
F_85 ( V_5 ) ;
}
F_356 ( V_641 , & V_5 -> V_44 ) ;
F_7 ( & V_5 -> V_12 ) ;
if ( V_638 -> V_495 )
V_638 -> V_495 ( V_5 , V_333 ) ;
F_160 ( V_642 , & V_5 -> V_44 ) ;
V_638 -> V_639 = NULL ;
V_638 -> V_44 = 0 ;
return 0 ;
}
void F_357 ( struct V_4 * V_5 ,
int (* V_640)( struct V_4 * ) ,
void (* V_495)( struct V_4 * , int ) ,
char * V_639 , enum V_643 V_44 )
{
F_97 ( V_5 , V_46 == F_22 ( V_5 ) -> V_14 -> V_463 . V_55 ) ;
F_97 ( V_5 , ! F_92 ( V_642 , & V_5 -> V_44 ) ) ;
F_97 ( V_5 , ! F_92 ( V_641 , & V_5 -> V_44 ) ) ;
F_97 ( V_5 , F_190 ( & V_5 -> V_390 . V_391 . V_388 ) ) ;
if ( V_5 -> V_390 . V_639 )
F_11 ( V_5 , L_78 ,
V_639 , V_5 -> V_390 . V_639 ) ;
V_5 -> V_390 . V_640 = V_640 ;
V_5 -> V_390 . V_495 = V_495 ;
V_5 -> V_390 . V_639 = V_639 ;
V_5 -> V_390 . V_44 = V_44 ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
F_150 ( V_641 , & V_5 -> V_44 ) ;
if ( F_217 ( & V_5 -> V_366 ) == 0 ) {
if ( ! F_340 ( V_642 , & V_5 -> V_44 ) )
F_249 ( & F_22 ( V_5 ) -> V_14 -> V_431 ,
& V_5 -> V_390 . V_391 ) ;
}
F_14 ( & V_5 -> V_22 -> V_23 ) ;
}
int F_358 ( struct V_4 * V_5 , int (* V_640)( struct V_4 * ) ,
char * V_639 , enum V_643 V_44 )
{
int V_333 ;
F_97 ( V_5 , V_46 != F_22 ( V_5 ) -> V_14 -> V_463 . V_55 ) ;
...
void F_350 ( struct V_4 * V_5 , int V_645 ) __must_hold( T_10 )
{
if ( ( V_5 -> V_128 -> V_160 . V_44 & V_645 ) != V_645 ) {
F_342 ( V_5 ) ;
V_5 -> V_128 -> V_160 . V_44 |= V_645 ;
}
}
void F_131 ( struct V_4 * V_5 , int V_645 ) __must_hold( T_10 )
{
if ( ( V_5 -> V_128 -> V_160 . V_44 & V_645 ) != 0 ) {
F_342 ( V_5 ) ;
V_5 -> V_128 -> V_160 . V_44 &= ~ V_645 ;
}
}
int F_128 ( struct V_588 * V_345 , int V_645 )
{
return ( V_345 -> V_160 . V_44 & V_645 ) != 0 ;
}
...
int F_364 ( struct V_4 * V_5 , struct V_676 * V_158 )
{
struct V_118 * V_119 ;
F_365 ( V_67 ) ;
long V_677 ;
...
V_677 = V_119 -> V_274 ? V_119 -> V_677 * V_633 / 10 * V_119 -> V_274 : V_679 ;
F_49 () ;
V_158 -> V_680 = true ;
F_366 ( & V_5 -> V_12 , & V_67 , V_681 ) ;
F_14 ( & V_5 -> V_22 -> V_23 ) ;
V_677 = F_367 ( V_677 ) ;
F_368 ( & V_5 -> V_12 , & V_67 ) ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
if ( ! V_677 || V_5 -> V_10 . V_32 < V_258 )
return - V_678 ;
if ( F_369 ( V_46 ) )
return - V_682 ;
return 0 ;
...
F_370 ( struct V_683 * V_684 )
{
long V_685 ;
if ( ! V_684 -> V_686 -- ) {
F_98 ( & V_685 , sizeof( V_685 ) ) ;
V_684 -> V_10 += V_685 ;
V_684 -> V_686 = V_687 ;
}
V_684 -> V_10 = V_684 -> V_10 * V_688 + V_689 ;
return F_371 ( V_684 -> V_10 ) ;
}
static char *
...
return ( type < V_701 ) ? V_690 [ type ] : L_138 ;
}
unsigned int
F_373 ( struct V_4 * V_5 , unsigned int type )
{
static struct V_683 V_702 = { 0 , 0 } ;
unsigned int V_703 = (
( V_704 == 0 ||
( ( 1 << F_48 ( V_5 ) ) & V_704 ) != 0 ) &&
( ( ( F_370 ( & V_702 ) % 100 ) + 1 ) <= V_705 ) ) ;
if ( V_703 ) {
V_706 ++ ;
if ( F_374 ( & V_707 ) )
F_159 ( V_5 , L_139 ,
...
{
static char V_708 [ 38 ] = L_140 ;
if ( V_708 [ 0 ] == 0 ) {
#ifdef F_310
sprintf ( V_708 , L_141 , V_61 -> V_709 ) ;
#else
V_708 [ 0 ] = 'b' ;
#endif
}
