...
int F_67 ( struct V_101 * V_31 , struct V_102 * V_42 )
{
struct V_13 * V_14 ;
struct V_46 * V_26 ;
struct V_117 * V_118 ;
...
int V_104 ;
F_18 ( V_31 , L_18 ) ;
V_14 = F_68 ( V_31 , sizeof( * V_14 ) , V_56 ) ;
if ( V_14 == NULL )
return - V_121 ;
V_26 = & V_14 -> V_26 ;
V_26 -> V_31 = V_31 ;
V_26 -> V_122 . V_93 = F_61 ;
V_26 -> V_122 . V_123 = F_64 ;
V_26 -> V_122 . V_124 = F_65 ;
V_26 -> V_122 . V_125 = F_66 ;
V_104 = F_69 ( V_26 ) ;
if ( V_104 != 0 )
goto V_126;
F_70 ( & V_14 -> V_58 ) ;
F_71 ( & V_14 -> V_33 ) ;
V_127 . V_128 = V_14 ;
V_14 -> V_28 = F_72 ( V_31 , & V_127 , V_42 ) ;
if ( V_14 -> V_28 == NULL ) {
V_104 = - V_129 ;
goto V_130;
}
V_26 -> V_28 = V_14 -> V_28 ;
F_52 ( V_14 -> V_28 ) ;
V_118 = F_73 ( V_14 -> V_28 , V_42 -> V_103 , V_14 ) ;
if ( V_118 == NULL ) {
V_104 = - V_129 ;
F_38 ( V_31 , L_19 ) ;
goto V_131;
...
F_14 ( V_14 -> V_28 , & V_120 , sizeof( V_120 ) ) ;
F_74 ( V_14 -> V_31 , L_20 ,
V_120 . V_133 . V_134 , V_120 . V_133 . V_135 ,
V_120 . V_133 . V_136 , V_120 . V_133 . type ) ;
F_74 ( V_14 -> V_31 , L_21 , V_120 . V_133 . type ) ;
F_74 ( V_14 -> V_31 , L_22 ,
V_120 . V_137 . V_138 , V_120 . V_137 . time ) ;
V_42 -> V_28 = V_14 ;
V_14 -> V_103 = V_118 ;
return 0 ;
V_132:
...
void F_78 ( struct V_101 * V_31 , struct V_102 * V_42 )
{
struct V_13 * V_14 = V_42 -> V_28 ;
F_52 ( V_14 -> V_28 ) ;
F_79 ( V_14 -> V_28 ) ;
