...
if ( V_71 -> V_79 -> V_80 > V_81 )
goto V_75;
V_74 = V_82 - V_71 -> V_79 -> V_83 ;
V_19 -> V_19 . V_15 &= V_84 ;
V_19 -> V_19 . V_15 |= V_85 ;
V_19 -> V_19 . V_86 = F_23 ;
V_72 = V_11 -> V_14 ;
...
struct V_5 * V_6 = NULL ;
struct V_24 * V_25 = F_13 ( V_8 -> V_26 ) -> V_27 ;
struct V_11 * V_50 = NULL , * V_49 , * V_89 , * V_28 = NULL ;
int V_31 = 0 ;
F_3 ( L_16 ) ;
...
struct V_69 , V_70 ) ;
F_3 ( L_37 ,
V_8 -> V_20 . V_101 , F_50 ( & V_19 -> V_19 . V_102 ) ,
* V_95 ) ;
if ( ! V_8 -> V_26 )
goto V_103;
V_100 = 1 ;
if ( F_46 ( V_70 , 0 , * V_95 ) < 0 )
V_100 = 0 ;
V_71 = F_13 ( V_8 -> V_26 ) ;
ASSERT ( F_45 ( V_71 -> V_76 ) ) ;
ASSERT ( V_71 -> V_27 -> V_37 -> V_77 ) ;
...
( * V_95 ) -- ;
V_98 ++ ;
} else if ( V_100 && F_53 ( & V_97 , V_11 ) == 0 ) {
F_54 ( V_19 , & V_97 ) ;
F_32 ( V_19 , 1 ) ;
V_31 = - V_34 ;
} else {
...
V_31 = 0 ;
if ( V_98 > 0 ) {
V_99 = F_47 ( V_8 , V_19 , & V_96 ) ;
if ( V_99 == - V_66 || V_99 == - V_104 )
V_31 = V_99 ;
}
F_14 ( L_38 ,
V_31 , * V_95 , F_24 ( V_94 ) ? L_39 : L_16 ) ;
return V_31 ;
V_103:
F_32 ( V_19 , * V_95 ) ;
return - V_67 ;
...
int F_59 ( struct V_105 * V_19 , struct V_11 * V_11 )
{
struct V_7 * V_8 ;
struct V_69 * V_70 ;
struct V_106 * V_106 ;
...
V_70 = F_2 ( V_8 -> V_20 . V_70 ,
struct V_69 , V_70 ) ;
V_107 . V_112 = V_70 -> V_112 ;
V_107 . V_113 = V_8 -> V_26 ;
V_106 = F_61 ( & V_107 , V_114 | V_115 , V_70 -> V_116 ) ;
if ( F_62 ( V_106 ) ) {
V_31 = F_63 ( V_106 ) ;
} else {
V_108 = ( T_4 ) V_11 -> V_14 << V_82 ;
V_109 = V_8 -> V_20 . V_117 ;
V_110 = V_81 ;
if ( V_109 & ~ V_118 ) {
F_64 ( V_108 , < , V_109 ) ;
if ( V_109 - V_108 < V_81 ) {
...
V_108 , V_109 ) ;
V_110 = V_109 - V_108 ;
F_64 ( V_108 + V_110 , == , V_109 ) ;
}
}
V_111 = F_65 ( V_11 ) ;
V_31 = F_66 ( V_106 , V_111 , V_110 , & V_108 ) ;
F_67 ( V_11 ) ;
if ( V_31 != V_110 )
V_31 = - V_35 ;
F_68 ( V_106 ) ;
...
void F_69 ( struct V_119 * V_120 , struct V_11 * V_11 )
{
struct V_7 * V_8 ;
struct V_69 * V_70 ;
V_8 = F_2 ( V_120 , struct V_7 , V_20 ) ;
V_70 = F_2 ( V_8 -> V_20 . V_70 ,
struct V_69 , V_70 ) ;
F_3 ( L_45 , V_8 , V_11 -> V_14 ) ;
F_10 ( & V_8 -> V_20 . V_47 -> V_121 ) ;
}
