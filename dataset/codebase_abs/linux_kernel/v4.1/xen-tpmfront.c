...
int V_45 ;
T_4 V_46 ;
V_4 -> V_5 = ( void * ) F_22 ( V_47 | V_48 ) ;
if ( ! V_4 -> V_5 ) {
F_23 ( V_39 , - V_49 , L_1 ) ;
return - V_49 ;
}
V_45 = F_24 ( V_39 , & V_4 -> V_5 , 1 , & V_46 ) ;
if ( V_45 < 0 )
return V_45 ;
V_4 -> V_50 = V_46 ;
V_45 = F_25 ( V_39 , & V_4 -> V_16 ) ;
if ( V_45 )
return V_45 ;
V_45 = F_26 ( V_4 -> V_16 , F_14 , 0 ,
L_2 , V_4 ) ;
if ( V_45 <= 0 ) {
F_23 ( V_39 , V_45 , L_3 ) ;
return V_45 ;
}
V_4 -> V_2 -> V_27 . V_51 = V_45 ;
V_52:
V_45 = F_27 ( & V_43 ) ;
if ( V_45 ) {
F_23 ( V_39 , V_45 , L_4 ) ;
...
V_45 = F_28 ( V_43 , V_39 -> V_53 ,
L_5 , L_6 , V_4 -> V_50 ) ;
if ( V_45 ) {
V_44 = L_7 ;
goto V_54;
}
V_45 = F_28 ( V_43 , V_39 -> V_53 , L_8 , L_6 ,
V_4 -> V_16 ) ;
if ( V_45 ) {
V_44 = L_9 ;
goto V_54;
}
V_45 = F_28 ( V_43 , V_39 -> V_53 , L_10 , L_11 ) ;
if ( V_45 ) {
V_44 = L_12 ;
goto V_54;
}
...
F_34 ( ( unsigned long ) V_4 -> V_5 ) ;
if ( V_4 -> V_2 && V_4 -> V_2 -> V_27 . V_51 )
F_35 ( V_4 -> V_2 -> V_27 . V_51 , V_4 ) ;
F_36 ( V_4 ) ;
}
static int F_37 ( struct V_41 * V_39 ,
...
static int F_43 ( struct V_41 * V_39 )
{
struct V_1 * V_2 = F_39 ( & V_39 -> V_39 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_40 ( V_2 ) ;
F_32 ( V_4 ) ;
F_2 ( V_2 ) = NULL ;
...
{
F_43 ( V_39 ) ;
return F_37 ( V_39 , NULL ) ;
}
static void F_45 ( struct V_41 * V_39 ,
enum V_59 V_60 )
{
int V_61 ;
switch ( V_60 ) {
