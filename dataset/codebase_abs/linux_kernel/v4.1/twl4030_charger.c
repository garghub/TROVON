...
F_31 ( struct V_117 * V_23 )
{
struct V_118 * V_119 = V_23 -> V_120 ;
struct V_116 * V_121 ;
T_3 V_122 ;
if ( ! V_119 )
return NULL ;
V_121 = F_32 ( V_23 , sizeof( * V_121 ) , V_123 ) ;
if ( ! V_121 )
return V_121 ;
if ( F_33 ( V_119 , L_14 , & V_122 ) == 0 )
V_121 -> V_124 = V_122 ;
if ( F_33 ( V_119 , L_15 , & V_122 ) == 0 )
V_121 -> V_125 = V_122 ;
return V_121 ;
}
static inline const struct V_116 *
F_31 ( struct V_117 * V_23 )
{
return NULL ;
}
static int T_4 F_34 ( struct V_126 * V_127 )
{
struct V_13 * V_14 ;
const struct V_116 * V_121 = V_127 -> V_23 . V_128 ;
int V_6 ;
T_3 V_4 ;
V_14 = F_35 ( sizeof( * V_14 ) , V_123 ) ;
if ( V_14 == NULL )
return - V_129 ;
if ( ! V_121 )
V_121 = F_31 ( & V_127 -> V_23 ) ;
V_14 -> V_23 = & V_127 -> V_23 ;
V_14 -> V_130 = F_36 ( V_127 , 0 ) ;
V_14 -> V_131 = F_36 ( V_127 , 1 ) ;
V_6 = F_7 ( V_14 ) ;
if ( V_6 ) {
F_20 ( & V_127 -> V_23 , L_16 , V_6 ) ;
goto V_132;
}
F_37 ( V_127 , V_14 ) ;
V_14 -> V_53 = F_38 ( & V_127 -> V_23 , & V_133 ,
NULL ) ;
if ( F_39 ( V_14 -> V_53 ) ) {
V_6 = F_40 ( V_14 -> V_53 ) ;
F_13 ( & V_127 -> V_23 , L_17 , V_6 ) ;
goto V_134;
}
V_14 -> V_30 = F_41 ( V_14 -> V_23 , L_18 ) ;
V_14 -> V_54 = F_38 ( & V_127 -> V_23 , & V_135 ,
NULL ) ;
if ( F_39 ( V_14 -> V_54 ) ) {
V_6 = F_40 ( V_14 -> V_54 ) ;
F_13 ( & V_127 -> V_23 , L_19 , V_6 ) ;
goto V_136;
}
V_6 = F_42 ( V_14 -> V_130 , NULL ,
F_17 , V_137 , V_127 -> V_138 ,
V_14 ) ;
if ( V_6 < 0 ) {
F_13 ( & V_127 -> V_23 , L_20 ,
V_14 -> V_130 , V_6 ) ;
goto V_139;
}
V_6 = F_42 ( V_14 -> V_131 , NULL ,
F_19 , V_137 , V_127 -> V_138 , V_14 ) ;
if ( V_6 < 0 ) {
F_13 ( & V_127 -> V_23 , L_20 ,
V_14 -> V_131 , V_6 ) ;
goto V_140;
...
F_43 ( & V_14 -> V_71 , F_21 ) ;
V_14 -> V_141 = F_44 ( V_142 ) ;
if ( ! F_45 ( V_14 -> V_141 ) ) {
V_14 -> V_79 . V_143 = F_23 ;
F_46 ( V_14 -> V_141 , & V_14 -> V_79 ) ;
}
...
V_145:
if ( ! F_45 ( V_14 -> V_141 ) ) {
F_47 ( V_14 -> V_141 , & V_14 -> V_79 ) ;
F_48 ( V_14 -> V_141 ) ;
}
F_49 ( V_14 -> V_131 , V_14 ) ;
V_140:
F_49 ( V_14 -> V_130 , V_14 ) ;
V_139:
F_50 ( V_14 -> V_54 ) ;
V_136:
F_50 ( V_14 -> V_53 ) ;
...
static int T_5 F_52 ( struct V_126 * V_127 )
{
struct V_13 * V_14 = F_53 ( V_127 ) ;
F_15 ( false ) ;
F_10 ( V_14 , false ) ;
F_16 ( 0 , 0 ) ;
F_3 ( V_58 , 0xff ,
