...
void
F_50 ( struct V_35 * V_36 , unsigned V_123 , T_5 V_128 )
{
bool V_129 ;
T_5 * V_75 = F_51 ( & V_36 -> V_114 , & V_129 ) ;
V_75 = F_52 ( V_36 , V_123 , V_75 ) ;
if ( V_129 )
F_53 ( V_128 , ( void V_130 V_131 * ) V_75 ) ;
else
* V_75 = V_128 ;
}
T_1
F_54 ( struct V_35 * V_36 , unsigned V_123 )
{
bool V_129 ;
T_1 * V_75 = F_51 ( & V_36 -> V_114 , & V_129 ) ;
V_75 = F_52 ( V_36 , V_123 , V_75 ) ;
if ( V_129 )
return F_55 ( ( void V_130 V_131 * ) V_75 ) ;
else
return * V_75 ;
}
void
F_56 ( struct V_35 * V_36 , unsigned V_123 , T_1 V_128 )
{
bool V_129 ;
T_1 * V_75 = F_51 ( & V_36 -> V_114 , & V_129 ) ;
V_75 = F_52 ( V_36 , V_123 , V_75 ) ;
if ( V_129 )
F_57 ( V_128 , ( void V_130 V_131 * ) V_75 ) ;
else
* V_75 = V_128 ;
}
static struct V_132 *
F_58 ( struct V_133 * V_34 , unsigned long V_6 ,
...
return F_59 ( V_34 , V_2 -> V_138 -> V_141 , V_6 ,
V_134 , V_136 ) ;
}
#endif
return F_60 ( V_34 , V_6 , V_134 , V_136 ) ;
}
static int
F_61 ( struct V_133 * V_34 , T_2 V_8 )
{
return 0 ;
}
static int
F_62 ( struct V_133 * V_34 , T_2 type ,
struct V_142 * V_143 )
{
struct V_9 * V_10 = F_12 ( V_34 ) ;
switch ( type ) {
...
static void
F_64 ( struct V_32 * V_33 , struct V_95 * V_80 )
{
struct V_35 * V_36 = V_35 ( V_33 ) ;
switch ( V_33 -> V_75 . V_104 ) {
case V_105 :
...
static int
F_65 ( struct V_160 * V_161 , T_1 V_162 )
{
int V_56 = F_66 ( V_161 , 2 ) ;
if ( V_56 == 0 ) {
F_67 ( V_161 , V_163 , 0x0000 , 1 ) ;
F_68 ( V_161 , V_162 & 0x0000ffff ) ;
F_69 ( V_161 ) ;
}
return V_56 ;
}
static int
F_70 ( struct V_160 * V_161 , struct V_32 * V_33 ,
struct V_164 * V_165 , struct V_164 * V_166 )
{
struct V_106 * V_167 = V_165 -> V_107 ;
int V_56 = F_66 ( V_161 , 10 ) ;
if ( V_56 == 0 ) {
F_67 ( V_161 , V_163 , 0x0400 , 8 ) ;
F_68 ( V_161 , F_71 ( V_167 -> V_168 [ 0 ] . V_169 ) ) ;
F_68 ( V_161 , F_72 ( V_167 -> V_168 [ 0 ] . V_169 ) ) ;
F_68 ( V_161 , F_71 ( V_167 -> V_168 [ 1 ] . V_169 ) ) ;
F_68 ( V_161 , F_72 ( V_167 -> V_168 [ 1 ] . V_169 ) ) ;
F_68 ( V_161 , V_48 ) ;
F_68 ( V_161 , V_48 ) ;
F_68 ( V_161 , V_48 ) ;
F_68 ( V_161 , V_166 -> V_76 ) ;
F_73 ( V_161 , V_163 , 0x0300 , 0x0386 ) ;
}
return V_56 ;
}
static int
F_74 ( struct V_160 * V_161 , T_1 V_162 )
{
int V_56 = F_66 ( V_161 , 2 ) ;
if ( V_56 == 0 ) {
F_67 ( V_161 , V_163 , 0x0000 , 1 ) ;
...
static int
F_75 ( struct V_160 * V_161 , struct V_32 * V_33 ,
struct V_164 * V_165 , struct V_164 * V_166 )
{
struct V_106 * V_167 = V_165 -> V_107 ;
...
if ( V_56 )
return V_56 ;
F_67 ( V_161 , V_163 , 0x030c , 8 ) ;
F_68 ( V_161 , F_71 ( V_170 ) ) ;
F_68 ( V_161 , F_72 ( V_170 ) ) ;
F_68 ( V_161 , F_71 ( V_171 ) ) ;
F_68 ( V_161 , F_72 ( V_171 ) ) ;
F_68 ( V_161 , V_48 ) ;
F_68 ( V_161 , V_48 ) ;
F_68 ( V_161 , V_48 ) ;
F_68 ( V_161 , V_173 ) ;
F_67 ( V_161 , V_163 , 0x0300 , 1 ) ;
F_68 ( V_161 , 0x00000110 ) ;
V_172 -= V_173 ;
V_170 += ( V_48 * V_173 ) ;
V_171 += ( V_48 * V_173 ) ;
}
...
static int
F_76 ( struct V_160 * V_161 , struct V_32 * V_33 ,
struct V_164 * V_165 , struct V_164 * V_166 )
{
struct V_106 * V_167 = V_165 -> V_107 ;
T_6 V_170 = V_167 -> V_168 [ 0 ] . V_169 ;
...
if ( V_56 )
return V_56 ;
F_67 ( V_161 , V_163 , 0x0238 , 2 ) ;
F_68 ( V_161 , F_71 ( V_171 ) ) ;
F_68 ( V_161 , F_72 ( V_171 ) ) ;
F_67 ( V_161 , V_163 , 0x030c , 6 ) ;
F_68 ( V_161 , F_71 ( V_170 ) ) ;
F_68 ( V_161 , F_72 ( V_170 ) ) ;
F_68 ( V_161 , V_48 ) ;
F_68 ( V_161 , V_48 ) ;
...
{
struct V_106 * V_167 = V_165 -> V_107 ;
int V_56 = F_66 ( V_161 , 7 ) ;
if ( V_56 == 0 ) {
F_78 ( V_161 , V_163 , 0x0320 , 6 ) ;
F_68 ( V_161 , F_71 ( V_167 -> V_168 [ 0 ] . V_169 ) ) ;
F_68 ( V_161 , F_72 ( V_167 -> V_168 [ 0 ] . V_169 ) ) ;
F_68 ( V_161 , F_71 ( V_167 -> V_168 [ 1 ] . V_169 ) ) ;
F_68 ( V_161 , F_72 ( V_167 -> V_168 [ 1 ] . V_169 ) ) ;
F_68 ( V_161 , 0x00000000 ) ;
F_68 ( V_161 , V_166 -> V_76 << V_77 ) ;
}
return V_56 ;
}
static int
F_80 ( struct V_160 * V_161 , struct V_32 * V_33 ,
struct V_164 * V_165 , struct V_164 * V_166 )
{
struct V_106 * V_167 = V_165 -> V_107 ;
int V_56 = F_66 ( V_161 , 7 ) ;
if ( V_56 == 0 ) {
F_78 ( V_161 , V_163 , 0x0304 , 6 ) ;
F_68 ( V_161 , V_166 -> V_76 << V_77 ) ;
F_68 ( V_161 , F_71 ( V_167 -> V_168 [ 0 ] . V_169 ) ) ;
F_68 ( V_161 , F_72 ( V_167 -> V_168 [ 0 ] . V_169 ) ) ;
F_68 ( V_161 , F_71 ( V_167 -> V_168 [ 1 ] . V_169 ) ) ;
...
static int
F_81 ( struct V_160 * V_161 , T_1 V_162 )
{
int V_56 = F_66 ( V_161 , 6 ) ;
if ( V_56 == 0 ) {
F_78 ( V_161 , V_163 , 0x0000 , 1 ) ;
F_68 ( V_161 , V_162 ) ;
F_78 ( V_161 , V_163 , 0x0180 , 3 ) ;
F_68 ( V_161 , V_161 -> V_10 -> V_174 . V_162 ) ;
F_68 ( V_161 , V_161 -> V_175 . V_162 ) ;
F_68 ( V_161 , V_161 -> V_175 . V_162 ) ;
}
return V_56 ;
}
...
V_56 = F_66 ( V_161 , 18 + 6 * ( V_177 + V_178 ) ) ;
if ( V_56 )
return V_56 ;
V_179 = F_83 ( V_176 , ( T_6 ) ( 4 * 1024 * 1024 ) ) ;
V_180 = 16 * 4 ;
V_181 = V_179 / V_180 ;
if ( V_177 ) {
F_78 ( V_161 , V_163 , 0x0200 , 7 ) ;
F_68 ( V_161 , 0 ) ;
F_68 ( V_161 , 0 ) ;
F_68 ( V_161 , V_180 ) ;
F_68 ( V_161 , V_181 ) ;
...
F_78 ( V_161 , V_163 , 0x0200 , 1 ) ;
F_68 ( V_161 , 1 ) ;
}
if ( V_178 ) {
F_78 ( V_161 , V_163 , 0x021c , 7 ) ;
F_68 ( V_161 , 0 ) ;
F_68 ( V_161 , 0 ) ;
F_68 ( V_161 , V_180 ) ;
F_68 ( V_161 , V_181 ) ;
...
F_78 ( V_161 , V_163 , 0x021c , 1 ) ;
F_68 ( V_161 , 1 ) ;
}
F_78 ( V_161 , V_163 , 0x0238 , 2 ) ;
F_68 ( V_161 , F_71 ( V_170 ) ) ;
F_68 ( V_161 , F_71 ( V_171 ) ) ;
F_78 ( V_161 , V_163 , 0x030c , 8 ) ;
F_68 ( V_161 , F_72 ( V_170 ) ) ;
...
F_68 ( V_161 , V_180 ) ;
F_68 ( V_161 , V_181 ) ;
F_68 ( V_161 , 0x00000101 ) ;
F_68 ( V_161 , 0x00000000 ) ;
F_78 ( V_161 , V_163 , V_182 , 1 ) ;
F_68 ( V_161 , 0 ) ;
V_176 -= V_179 ;
V_170 += V_179 ;
V_171 += V_179 ;
...
static int
F_84 ( struct V_160 * V_161 , T_1 V_162 )
{
int V_56 = F_66 ( V_161 , 4 ) ;
if ( V_56 == 0 ) {
F_78 ( V_161 , V_163 , 0x0000 , 1 ) ;
F_68 ( V_161 , V_162 ) ;
F_78 ( V_161 , V_163 , 0x0180 , 1 ) ;
F_68 ( V_161 , V_161 -> V_10 -> V_174 . V_162 ) ;
}
return V_56 ;
}
static inline T_2
F_85 ( struct V_32 * V_33 ,
...
static int
F_86 ( struct V_160 * V_161 , struct V_32 * V_33 ,
struct V_164 * V_165 , struct V_164 * V_166 )
{
...
if ( V_56 )
return V_56 ;
F_78 ( V_161 , V_163 , V_185 , 2 ) ;
F_68 ( V_161 , F_85 ( V_33 , V_161 , V_165 ) ) ;
F_68 ( V_161 , F_85 ( V_33 , V_161 , V_166 ) ) ;
V_172 = V_166 -> V_76 ;
while ( V_172 ) {
int V_173 = ( V_172 > 2047 ) ? 2047 : V_172 ;
V_56 = F_66 ( V_161 , 11 ) ;
...
static int
F_87 ( struct V_9 * V_10 , struct V_32 * V_33 ,
struct V_164 * V_75 )
{
...
int V_56 ;
V_56 = F_88 ( V_10 -> V_60 . V_61 , V_6 , V_187 -> V_47 ,
V_189 , & V_187 -> V_168 [ 0 ] ) ;
if ( V_56 )
return V_56 ;
V_56 = F_88 ( V_10 -> V_60 . V_61 , V_6 , V_188 -> V_47 ,
V_189 , & V_187 -> V_168 [ 1 ] ) ;
if ( V_56 ) {
F_89 ( & V_187 -> V_168 [ 0 ] ) ;
return V_56 ;
}
F_90 ( & V_187 -> V_168 [ 0 ] , V_187 ) ;
F_90 ( & V_187 -> V_168 [ 1 ] , V_188 ) ;
return 0 ;
}
static int
F_91 ( struct V_32 * V_33 , int V_102 , bool V_190 ,
bool V_122 , struct V_164 * V_166 )
{
struct V_9 * V_10 = F_12 ( V_33 -> V_34 ) ;
struct V_160 * V_161 = V_10 -> V_71 . V_161 ;
struct V_191 * V_192 = ( void * ) F_92 ( & V_161 -> V_15 -> V_193 ) ;
struct V_29 * V_20 ;
int V_56 ;
if ( V_10 -> V_15 . V_42 . V_43 >= V_44 ) {
V_56 = F_87 ( V_10 , V_33 , V_166 ) ;
if ( V_56 )
return V_56 ;
}
F_93 ( & V_192 -> V_194 , V_195 ) ;
V_56 = F_94 ( V_35 ( V_33 ) , V_161 , true , V_190 ) ;
if ( V_56 == 0 ) {
V_56 = V_10 -> V_71 . V_196 ( V_161 , V_33 , & V_33 -> V_75 , V_166 ) ;
if ( V_56 == 0 ) {
V_56 = F_95 ( V_161 , false , & V_20 ) ;
if ( V_56 == 0 ) {
V_56 = F_96 ( V_33 ,
& V_20 -> V_193 ,
V_102 ,
...
if ( V_56 ) {
F_101 ( & V_10 -> V_71 . V_204 ) ;
continue;
}
V_10 -> V_71 . V_196 = V_200 -> F_99 ;
V_10 -> V_71 . V_161 = V_161 ;
V_197 = V_200 -> V_197 ;
break;
}
} while ( ( ++ V_200 ) -> F_99 );
F_102 ( V_10 , L_12 , V_197 ) ;
}
static int
F_103 ( struct V_32 * V_33 , bool V_102 , bool V_190 ,
bool V_122 , struct V_164 * V_166 )
{
struct V_79 V_205 = {
. V_86 = 0 ,
...
V_206 = * V_166 ;
V_206 . V_107 = NULL ;
V_56 = F_104 ( V_33 , & V_78 , & V_206 , V_190 , V_122 ) ;
if ( V_56 )
return V_56 ;
V_56 = F_105 ( V_33 -> V_71 , & V_206 ) ;
if ( V_56 )
goto V_109;
V_56 = F_91 ( V_33 , true , V_190 , V_122 , & V_206 ) ;
if ( V_56 )
goto V_109;
V_56 = F_106 ( V_33 , true , V_122 , V_166 ) ;
V_109:
F_107 ( V_33 , & V_206 ) ;
return V_56 ;
}
static int
F_108 ( struct V_32 * V_33 , bool V_102 , bool V_190 ,
bool V_122 , struct V_164 * V_166 )
{
struct V_79 V_205 = {
. V_86 = 0 ,
...
if ( V_56 )
return V_56 ;
V_56 = F_106 ( V_33 , true , V_122 , & V_206 ) ;
if ( V_56 )
goto V_109;
V_56 = F_91 ( V_33 , true , V_190 , V_122 , V_166 ) ;
if ( V_56 )
goto V_109;
V_109:
F_107 ( V_33 , & V_206 ) ;
...
static void
F_109 ( struct V_32 * V_33 , struct V_164 * V_166 )
{
struct V_35 * V_36 = V_35 ( V_33 ) ;
struct V_207 * V_168 ;
if ( V_33 -> V_208 != F_11 )
...
static int
F_112 ( struct V_32 * V_33 , struct V_164 * V_166 ,
struct V_3 * * V_209 )
{
struct V_9 * V_10 = F_12 ( V_33 -> V_34 ) ;
struct V_1 * V_2 = V_10 -> V_2 ;
...
struct V_9 * V_10 = F_12 ( V_33 -> V_34 ) ;
struct V_1 * V_2 = V_10 -> V_2 ;
struct V_20 * V_20 = F_114 ( V_33 -> V_211 ) ;
F_8 ( V_2 , * V_210 , V_20 ) ;
* V_210 = V_209 ;
}
static int
F_115 ( struct V_32 * V_33 , bool V_102 , bool V_190 ,
bool V_122 , struct V_164 * V_166 )
{
struct V_9 * V_10 = F_12 ( V_33 -> V_34 ) ;
struct V_35 * V_36 = V_35 ( V_33 ) ;
...
F_21 ( V_10 , L_13 , V_36 ) ;
if ( V_10 -> V_15 . V_42 . V_43 < V_44 ) {
V_56 = F_112 ( V_33 , V_166 , & V_209 ) ;
if ( V_56 )
return V_56 ;
}
if ( V_165 -> V_104 == V_144 && ! V_33 -> V_71 ) {
F_116 ( V_33 -> V_75 . V_107 != NULL ) ;
V_33 -> V_75 = * V_166 ;
V_166 -> V_107 = NULL ;
goto V_109;
}
...
V_56 = F_103 ( V_33 , V_102 , V_190 ,
V_122 , V_166 ) ;
else if ( V_165 -> V_104 == V_144 )
V_56 = F_108 ( V_33 , V_102 , V_190 ,
V_122 , V_166 ) ;
else
V_56 = F_91 ( V_33 , V_102 , V_190 ,
V_122 , V_166 ) ;
if ( ! V_56 )
goto V_109;
}
V_56 = F_117 ( V_33 , true , V_190 , V_122 ) ;
if ( V_56 == 0 )
V_56 = F_118 ( V_33 , V_102 , V_122 , V_166 ) ;
V_109:
if ( V_10 -> V_15 . V_42 . V_43 < V_44 ) {
if ( V_56 )
F_113 ( V_33 , NULL , & V_209 ) ;
else
F_113 ( V_33 , V_209 , & V_36 -> V_12 ) ;
}
return V_56 ;
}
static int
F_119 ( struct V_32 * V_33 , struct V_212 * V_38 )
{
struct V_35 * V_36 = V_35 ( V_33 ) ;
return F_120 ( & V_36 -> V_37 . V_213 , V_38 ) ;
}
static int
F_121 ( struct V_133 * V_34 , struct V_164 * V_75 )
{
...
V_75 -> V_214 . V_129 = ! V_10 -> V_2 -> V_138 -> V_215 ;
}
#endif
...
case V_105 :
V_75 -> V_214 . V_169 = V_75 -> V_184 << V_77 ;
V_75 -> V_214 . V_193 = F_122 ( F_25 ( & V_10 -> V_15 ) , 1 ) ;
V_75 -> V_214 . V_129 = true ;
if ( V_10 -> V_15 . V_42 . V_43 >= V_44 ) {
struct V_216 * V_217 = F_63 ( & V_10 -> V_15 ) ;
...
struct V_35 * V_36 = V_35 ( V_33 ) ;
struct V_41 * V_15 = & V_10 -> V_15 ;
T_1 V_221 = F_125 ( F_25 ( V_15 ) , 1 ) >> V_77 ;
int V_11 , V_56 ;
if ( V_33 -> V_75 . V_104 != V_105 ) {
if ( V_10 -> V_15 . V_42 . V_43 < V_44 ||
! F_126 ( V_36 ) )
...
#ifdef F_131
if ( F_132 () ) {
return F_129 ( ( void * ) V_71 , V_2 -> V_2 ) ;
}
#endif
V_223 = F_133 ( V_71 ) ;
if ( V_223 ) {
...
T_7 V_5 ;
V_5 = F_134 ( V_222 , V_71 -> V_228 [ V_11 ] , 0 , V_48 ,
V_232 ) ;
if ( F_135 ( V_222 , V_5 ) ) {
while ( -- V_11 ) {
F_136 ( V_222 , V_117 -> V_118 [ V_11 ] ,
V_48 , V_232 ) ;
V_117 -> V_118 [ V_11 ] = 0 ;
}
F_137 ( V_71 ) ;
...
#ifdef F_131
if ( F_132 () ) {
F_139 ( ( void * ) V_71 , V_2 -> V_2 ) ;
return;
}
#endif
for ( V_11 = 0 ; V_11 < V_71 -> V_76 ; V_11 ++ ) {
if ( V_117 -> V_118 [ V_11 ] ) {
F_136 ( V_222 , V_117 -> V_118 [ V_11 ] , V_48 ,
V_232 ) ;
}
}
F_137 ( V_71 ) ;
...
void
F_141 ( struct V_35 * V_36 , struct V_29 * V_20 , bool V_234 )
{
struct V_52 * V_211 = V_36 -> V_33 . V_211 ;
if ( V_234 )
F_142 ( V_211 , & V_20 -> V_193 ) ;
else if ( V_20 )
F_143 ( V_211 , & V_20 -> V_193 ) ;
}
struct V_207 *
F_144 ( struct V_35 * V_36 , struct V_235 * V_61 )
{
struct V_207 * V_168 ;
F_110 (vma, &nvbo->vma_list, head) {
if ( V_168 -> V_61 == V_61 )
...
int
F_145 ( struct V_35 * V_36 , struct V_235 * V_61 ,
struct V_207 * V_168 )
{
const T_1 V_6 = V_36 -> V_33 . V_75 . V_76 << V_77 ;
int V_56 ;
V_56 = F_88 ( V_61 , V_6 , V_36 -> V_47 ,
V_189 , V_168 ) ;
if ( V_56 )
return V_56 ;
...
V_36 -> V_47 != V_168 -> V_61 -> V_62 -> V_58 ) )
F_90 ( V_168 , V_36 -> V_33 . V_75 . V_107 ) ;
F_146 ( & V_168 -> V_68 , & V_36 -> V_70 ) ;
V_168 -> V_236 = 1 ;
return 0 ;
}
void
F_147 ( struct V_35 * V_36 , struct V_207 * V_168 )
{
if ( V_168 -> V_167 ) {
if ( V_36 -> V_33 . V_75 . V_104 != V_144 )
F_111 ( V_168 ) ;
