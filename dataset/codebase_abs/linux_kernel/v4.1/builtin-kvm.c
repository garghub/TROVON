...
V_111 = F_74 ( V_14 -> V_112 , V_34 , & V_4 , 0 ) ;
F_73 ( V_14 -> V_120 , V_116 ) ;
if ( V_111 ) {
F_8 ( L_45 , V_111 ) ;
return - 1 ;
...
V_132 . V_141 . V_140 = 0 ;
if ( F_80 ( V_14 -> V_134 , 0 , & V_132 , NULL ) != 0 ) {
F_8 ( L_47 , V_142 ) ;
F_81 ( V_14 -> V_134 ) ;
goto V_137;
}
...
T_5 V_143 ;
int V_133 ;
V_133 = F_83 ( V_14 -> V_134 , & V_143 , sizeof( T_5 ) ) ;
if ( V_133 < 0 ) {
if ( V_142 == V_144 )
return 0 ;
F_8 ( L_48 , V_142 ) ;
...
static int F_84 ( int V_145 )
{
long V_146 = 0 ;
V_146 = F_85 ( V_145 , V_147 ) ;
if ( V_146 < 0 ) {
F_8 ( L_51 , V_145 ) ;
return - 1 ;
}
if ( F_85 ( V_145 , V_148 , V_146 | V_149 ) < 0 ) {
F_8 ( L_52 , V_145 ) ;
return - 1 ;
}
return 0 ;
...
if ( F_89 ( V_14 -> V_120 , V_14 -> V_134 ) < 0 )
goto V_137;
V_151 = F_89 ( V_14 -> V_120 , fileno ( V_150 ) ) ;
if ( V_151 < 0 )
goto V_137;
if ( F_84 ( fileno ( V_150 ) ) != 0 )
goto V_137;
F_90 ( V_14 -> V_120 ) ;
while ( ! V_130 ) {
...
if ( V_111 < 0 ) {
printf ( L_53 ,
F_100 ( V_142 , V_166 , sizeof( V_166 ) ) ) ;
goto V_137;
}
if ( F_101 ( V_120 , V_14 -> V_85 . V_185 , false ) < 0 ) {
F_102 ( L_54 ,
F_100 ( V_142 , V_166 , sizeof( V_166 ) ) ) ;
F_103 ( V_120 ) ;
goto V_137;
...
V_14 -> V_103 = V_186 ;
V_14 -> V_112 = F_105 ( & V_189 , false , & V_14 -> V_103 ) ;
if ( ! V_14 -> V_112 ) {
F_8 ( L_55 ) ;
return - 1 ;
}
F_106 ( & V_14 -> V_112 -> V_108 . V_113 ) ;
if ( ! F_107 ( V_14 -> V_112 , L_56 ) )
return - V_114 ;
V_152 = F_66 ( V_14 ) ;
if ( V_152 < 0 )
return V_152 ;
return F_108 ( V_14 -> V_112 ) ;
}
static int F_109 ( struct V_13 * V_14 )
{
if ( V_14 -> V_85 . V_86 . V_64 ) {
V_14 -> V_106 = F_110 ( V_14 -> V_85 . V_86 . V_64 ) ;
if ( V_14 -> V_106 == NULL ) {
F_8 ( L_57 ) ;
return - V_114 ;
}
...
static int
F_113 ( struct V_13 * V_14 , int V_195 , const char * * V_196 )
{
unsigned int V_197 , V_28 , V_35 , V_198 ;
const char * * V_199 ;
...
V_198 = 0 ;
for ( V_202 = V_203 ; * V_202 ; V_202 ++ )
V_198 ++ ;
V_197 = F_114 ( V_200 ) + V_195 + 2 +
2 * V_198 ;
V_199 = calloc ( V_197 + 1 , sizeof( char * ) ) ;
if ( V_199 == NULL )
return - V_204 ;
for ( V_28 = 0 ; V_28 < F_114 ( V_200 ) ; V_28 ++ )
V_199 [ V_28 ] = F_115 ( V_200 [ V_28 ] ) ;
for ( V_35 = 0 ; V_35 < V_198 ; V_35 ++ ) {
V_199 [ V_28 ++ ] = L_65 ;
V_199 [ V_28 ++ ] = F_115 ( V_203 [ V_35 ] ) ;
}
V_199 [ V_28 ++ ] = F_115 ( L_66 ) ;
V_199 [ V_28 ++ ] = F_115 ( V_14 -> V_191 ) ;
for ( V_35 = 1 ; V_35 < ( unsigned int ) V_195 ; V_35 ++ , V_28 ++ )
V_199 [ V_28 ] = V_196 [ V_35 ] ;
F_116 ( V_205 , 'e' , L_67 , V_206 ) ;
F_116 ( V_205 , 0 , L_68 , V_206 ) ;
F_116 ( V_205 , 'R' , L_69 , V_206 ) ;
F_116 ( V_205 , 'F' , L_70 , V_207 ) ;
F_116 ( V_205 , 0 , L_71 , V_207 ) ;
F_116 ( V_205 , 'g' , NULL , V_207 ) ;
F_116 ( V_205 , 0 , L_72 , V_207 ) ;
F_116 ( V_205 , 'd' , L_73 , V_207 ) ;
F_116 ( V_205 , 'T' , L_74 , V_207 ) ;
F_116 ( V_205 , 'P' , L_75 , V_207 ) ;
F_116 ( V_205 , 'n' , L_76 , V_207 ) ;
F_116 ( V_205 , 'N' , L_77 , V_207 ) ;
F_116 ( V_205 , 'B' , L_78 , V_207 ) ;
F_116 ( V_205 , 'G' , L_79 , V_207 ) ;
F_116 ( V_205 , 'b' , L_80 , V_207 ) ;
F_116 ( V_205 , 'j' , L_81 , V_207 ) ;
F_116 ( V_205 , 'W' , L_82 , V_207 ) ;
F_116 ( V_205 , 0 , L_83 , V_207 ) ;
V_208 = V_201 ;
return F_117 ( V_28 , V_199 , NULL ) ;
}
static int
F_118 ( struct V_13 * V_14 , int V_195 , const char * * V_196 )
{
const struct V_209 V_210 [] = {
F_119 ( 0 , L_67 , & V_14 -> V_26 , L_84 ,
L_85
L_86 ) ,
F_120 ( 0 , L_87 , & V_14 -> V_60 ,
L_88 ) ,
F_119 ( 'k' , L_89 , & V_14 -> V_71 , L_90 ,
L_91
L_92 ) ,
F_119 ( 'p' , L_93 , & V_14 -> V_85 . V_86 . V_64 , L_93 ,
L_94 ) ,
F_121 ( 'f' , L_95 , & V_14 -> V_194 , L_96 ) ,
F_122 ()
} ;
...
static struct V_165 * F_125 ( void )
{
struct V_165 * V_120 ;
char * V_212 , * V_9 , * V_213 ;
int V_111 = - 1 ;
const char * const * V_202 ;
V_120 = F_126 () ;
if ( V_120 == NULL )
...
int V_195 , const char * * V_196 )
{
char V_214 [ V_215 ] ;
int V_111 ;
const struct V_209 V_216 [] = {
F_119 ( 'p' , L_93 , & V_14 -> V_85 . V_86 . V_64 , L_93 ,
L_100 ) ,
F_131 ( 'm' , L_101 , & V_14 -> V_85 . V_185 , L_102 ,
L_103 ,
V_217 ) ,
F_132 ( 'v' , L_104 , & V_218 ,
L_105 ) ,
F_121 ( 'a' , L_106 , & V_14 -> V_85 . V_86 . V_87 ,
L_107 ) ,
F_133 ( 'd' , L_108 , & V_14 -> V_139 ,
L_109 ) ,
F_119 ( 0 , L_67 , & V_14 -> V_26 , L_84 ,
L_110
L_111 ) ,
...
V_14 -> V_103 . exit = V_221 ;
V_14 -> V_103 . V_222 = V_223 ;
V_14 -> V_103 . V_224 = F_61 ;
V_14 -> V_103 . V_126 = true ;
F_135 ( & V_14 -> V_103 ) ;
V_14 -> V_139 = 1 ;
V_14 -> V_85 . V_225 = 1 ;
V_14 -> V_85 . V_185 = 512 ;
V_14 -> V_85 . V_86 . V_226 = false ;
V_14 -> V_85 . V_86 . V_227 = NULL ;
V_14 -> V_85 . V_86 . V_228 = V_229 ;
F_106 ( NULL ) ;
F_136 () ;
V_230 = 0 ;
F_137 ( false ) ;
if ( V_195 ) {
V_195 = F_123 ( V_195 , V_196 , V_216 ,
V_219 , 0 ) ;
if ( V_195 )
F_124 ( V_219 , V_216 ) ;
}
V_14 -> V_61 *= V_231 ;
V_111 = F_138 ( & V_14 -> V_85 . V_86 ) ;
if ( V_111 ) {
F_139 ( & V_14 -> V_85 . V_86 , V_111 , V_214 , V_215 ) ;
F_140 ( L_3 , V_214 ) ;
}
if ( F_141 ( & V_14 -> V_85 . V_86 ) )
V_14 -> V_85 . V_86 . V_87 = true ;
V_14 -> V_120 = F_125 () ;
if ( V_14 -> V_120 == NULL ) {
V_111 = - 1 ;
...
V_232 . V_233 = V_14 -> V_120 -> V_234 ;
if ( F_142 ( V_14 -> V_120 , & V_14 -> V_85 . V_86 ) < 0 )
F_124 ( V_219 , V_216 ) ;
V_14 -> V_112 = F_105 ( & V_189 , false , & V_14 -> V_103 ) ;
if ( V_14 -> V_112 == NULL ) {
V_111 = - 1 ;
...
F_143 ( V_14 -> V_112 ) ;
F_144 ( & V_14 -> V_112 -> V_126 , true ) ;
F_145 ( & V_14 -> V_112 -> V_235 . V_236 , & V_14 -> V_85 . V_86 ,
V_14 -> V_120 -> V_237 , false ) ;
V_111 = F_94 ( V_14 ) ;
if ( V_111 )
goto V_137;
V_111 = F_87 ( V_14 ) ;
...
static int F_149 ( const char * V_191 , int V_195 , const char * * V_196 )
{
struct V_13 V_14 = {
. V_191 = V_191 ,
. V_60 = - 1 ,
...
if ( ! strncmp ( V_196 [ 1 ] , L_125 , 3 ) )
return F_113 ( & V_14 , V_195 - 1 , V_196 + 1 ) ;
if ( ! strncmp ( V_196 [ 1 ] , L_126 , 3 ) )
return F_118 ( & V_14 , V_195 - 1 , V_196 + 1 ) ;
#ifdef F_150
if ( ! strncmp ( V_196 [ 1 ] , L_127 , 4 ) )
return F_130 ( & V_14 , V_195 - 1 , V_196 + 1 ) ;
#endif
V_238:
return F_151 ( V_195 , V_196 , NULL ) ;
}
static int F_152 ( const char * V_191 , int V_195 , const char * * V_196 )
{
int V_197 , V_28 = 0 , V_35 ;
const char * * V_199 ;
V_197 = V_195 + 2 ;
V_199 = calloc ( V_197 + 1 , sizeof( char * ) ) ;
V_199 [ V_28 ++ ] = F_127 ( L_58 ) ;
V_199 [ V_28 ++ ] = F_127 ( L_66 ) ;
V_199 [ V_28 ++ ] = F_127 ( V_191 ) ;
for ( V_35 = 1 ; V_35 < V_195 ; V_35 ++ , V_28 ++ )
V_199 [ V_28 ] = V_196 [ V_35 ] ;
F_22 ( V_28 != V_197 ) ;
return F_117 ( V_28 , V_199 , NULL ) ;
}
static int F_153 ( const char * V_191 , int V_195 , const char * * V_196 )
{
int V_197 , V_28 = 0 , V_35 ;
const char * * V_199 ;
V_197 = V_195 + 2 ;
V_199 = calloc ( V_197 + 1 , sizeof( char * ) ) ;
V_199 [ V_28 ++ ] = F_127 ( L_128 ) ;
V_199 [ V_28 ++ ] = F_127 ( L_129 ) ;
V_199 [ V_28 ++ ] = F_127 ( V_191 ) ;
for ( V_35 = 1 ; V_35 < V_195 ; V_35 ++ , V_28 ++ )
V_199 [ V_28 ] = V_196 [ V_35 ] ;
F_22 ( V_28 != V_197 ) ;
return F_154 ( V_28 , V_199 , NULL ) ;
}
static int
F_155 ( const char * V_191 , int V_195 , const char * * V_196 )
{
int V_197 , V_28 = 0 , V_35 ;
const char * * V_199 ;
V_197 = V_195 + 2 ;
V_199 = calloc ( V_197 + 1 , sizeof( char * ) ) ;
V_199 [ V_28 ++ ] = F_127 ( L_130 ) ;
V_199 [ V_28 ++ ] = F_127 ( L_129 ) ;
V_199 [ V_28 ++ ] = F_127 ( V_191 ) ;
for ( V_35 = 1 ; V_35 < V_195 ; V_35 ++ , V_28 ++ )
V_199 [ V_28 ] = V_196 [ V_35 ] ;
F_22 ( V_28 != V_197 ) ;
return F_156 ( V_28 , V_199 , NULL ) ;
}
int F_157 ( int V_195 , const char * * V_196 , const char * T_6 V_12 )
{
const char * V_191 = NULL ;
const struct V_209 V_239 [] = {
F_119 ( 'i' , L_131 , & V_191 , L_132 ,
L_133 ) ,
F_119 ( 'o' , L_134 , & V_191 , L_132 ,
L_135 ) ,
F_121 ( 0 , L_136 , & V_240 ,
L_137 ) ,
F_121 ( 0 , L_138 , & V_241 ,
L_139 ) ,
F_119 ( 0 , L_140 , & V_232 . V_242 , L_141 ,
L_142
L_143 ) ,
F_119 ( 0 , L_144 , & V_232 . V_243 ,
L_132 , L_145 ) ,
F_119 ( 0 , L_146 , & V_232 . V_244 ,
L_132 , L_147 ) ,
F_119 ( 0 , L_148 , & V_232 . V_245 ,
L_132 , L_149 ) ,
F_132 ( 'v' , L_104 , & V_218 ,
L_105 ) ,
F_122 ()
} ;
const char * const V_246 [] = { L_150 , L_58 , L_128 , L_151 ,
L_130 , L_152 , NULL } ;
const char * V_247 [] = { NULL , NULL } ;
V_241 = 0 ;
V_240 = 1 ;
V_195 = F_158 ( V_195 , V_196 , V_239 , V_246 , V_247 ,
V_248 ) ;
if ( ! V_195 )
F_124 ( V_247 , V_239 ) ;
if ( ! V_241 )
...
if ( ! strncmp ( V_196 [ 0 ] , L_125 , 3 ) )
return F_152 ( V_191 , V_195 , V_196 ) ;
else if ( ! strncmp ( V_196 [ 0 ] , L_126 , 3 ) )
return F_153 ( V_191 , V_195 , V_196 ) ;
else if ( ! strncmp ( V_196 [ 0 ] , L_151 , 4 ) )
return F_160 ( V_195 , V_196 , NULL ) ;
else if ( ! strncmp ( V_196 [ 0 ] , L_150 , 3 ) )
return F_161 ( V_195 , V_196 , NULL ) ;
else if ( ! strncmp ( V_196 [ 0 ] , L_130 , 12 ) )
return F_155 ( V_191 , V_195 , V_196 ) ;
#ifdef F_162
else if ( ! strncmp ( V_196 [ 0 ] , L_152 , 4 ) )
return F_149 ( V_191 , V_195 , V_196 ) ;
#endif
else
F_124 ( V_247 , V_239 ) ;
return 0 ;
