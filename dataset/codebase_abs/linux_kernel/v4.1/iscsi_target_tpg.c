...
int F_41 ( struct V_1 * V_5 , int V_71 )
{
struct V_2 * V_3 ;
T_2 V_72 = V_5 -> V_7 ;
F_15 ( & V_5 -> V_14 ) ;
...
struct V_87 * V_88 = F_43 ( V_86 , struct V_87 ,
V_85 ) ;
return & V_88 -> V_89 ;
}
struct V_33 * F_44 (
...
F_17 ( L_22 ,
V_5 -> V_9 -> V_3 , V_32 -> V_106 , V_32 -> V_107 , V_5 -> V_4 ,
V_32 -> V_108 -> V_109 ) ;
return V_35 ;
}
static int F_55 (
...
int F_40 ( struct V_1 * V_5 , T_3 V_27 )
{
