...
F_7 ( 1 , L_14 ,
V_100 -> V_51 ) ;
V_8 -> V_103 = V_100 -> V_104 ;
V_8 -> V_105 = V_100 -> V_105 ;
V_8 -> V_106 = V_100 -> V_106 ;
F_7 ( 1 , L_15 ) ;
V_27 = F_10 ( V_25 , V_102 -> V_80 ) ;
if ( ! V_27 ) {
V_27 = F_28 ( V_25 ) ;
F_7 ( 1 , L_16 ) ;
} else
...
F_7 ( 1 , L_31 ,
V_28 , V_8 -> V_114 ) ;
F_8 ( V_8 , V_115 , V_8 -> V_114 ) ;
F_27 ( V_8 , V_8 -> V_59 , V_116 ) ;
if ( V_117 )
F_30 ( V_8 ) ;
V_8 -> V_118 = V_109 ;
return 0 ;
...
struct V_7 * V_8 = V_25 -> V_26 ;
T_3 V_109 = V_25 -> V_110 . V_111 ;
T_3 V_120 = V_25 -> V_110 . V_121 ;
T_3 V_122 = V_25 -> V_110 . V_123 ;
if ( F_33 ( V_25 , 0 ) != 0 ) {
F_7 ( 1 , L_32 ) ;
return - V_34 ;
}
F_7 ( 1 , L_33 , V_28 , V_120 ) ;
switch ( V_122 ) {
case V_124 :
F_7 ( 1 , L_34 , V_28 ) ;
V_8 -> V_55 = V_56 ;
...
if ( V_143 -> V_144 & V_153 ) {
V_8 -> V_52 = V_154 ;
return;
}
if ( V_143 -> V_144 & V_155 ) {
V_8 -> V_52 = V_156 ;
return;
}
if ( V_143 -> V_144 & V_157 ) {
V_8 -> V_52 = V_158 ;
return;
}
}
...
if ( V_8 -> V_161 == V_163 )
V_161 = V_164 ;
else if ( V_8 -> V_161 == V_165 )
V_161 = V_166 ;
else if ( V_8 -> V_161 == V_167 )
V_161 = V_168 ;
else {
F_7 ( 1 , L_49 , V_28 ,
V_8 -> V_161 ) ;
...
V_27 = F_12 ( V_8 , V_50 [ V_161 ] . V_47 ,
V_50 [ V_161 ] . V_48 , V_161 ) ;
if ( V_27 != 0 ) {
F_4 ( V_17 L_29 ) ;
return - V_18 ;
}
...
static int F_41 ( struct V_24 * V_25 , T_3 * V_120 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
F_7 ( 1 , L_3 , V_28 ) ;
* V_120 = V_8 -> V_59 + V_8 -> V_125 ;
return 0 ;
}
static int F_42 ( struct V_24 * V_25 , T_3 * V_120 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
F_7 ( 1 , L_3 , V_28 ) ;
* V_120 = V_8 -> V_112 * 1000 ;
return 0 ;
}
static int F_43 ( struct V_24 * V_25 , T_3 * V_109 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
F_7 ( 1 , L_3 , V_28 ) ;
* V_109 = V_8 -> V_118 ;
...
static int F_44 ( struct V_24 * V_25 , T_3 * V_171 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
T_2 V_74 = 0 ;
F_18 ( V_8 , & V_74 ) ;
...
static int F_33 ( struct V_24 * V_25 , int V_172 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
const struct V_1 * V_100 = F_1 ( V_8 -> V_2 ) ;
const struct V_101 * V_102 ;
int V_27 , V_41 ;
T_2 V_159 ;
T_2 V_173 ;
F_45 ( & V_8 -> V_174 ) ;
if ( ! V_172 && F_34 ( V_25 ) == 0 )
return 0 ;
if ( ! V_8 -> V_101 ) {
V_27 = F_46 ( & V_102 , V_100 -> V_51 ,
V_8 -> V_14 . V_16 -> V_175 . V_176 ) ;
if ( V_27 ) {
F_47 ( L_51 , V_27 ) ;
return V_27 ;
}
F_7 ( 1 , L_52 , V_102 -> V_177 ) ;
if ( V_102 -> V_177 != V_100 -> V_177 ) {
F_47 ( L_53 ) ;
F_48 ( V_102 ) ;
return - V_34 ;
}
...
if ( V_41 )
F_4 ( V_178 L_54 ) ;
V_27 = F_29 ( V_25 , V_100 , V_102 ) ;
if ( V_27 != 0 )
goto V_179;
F_9 ( 20 ) ;
if ( V_8 -> V_106 ) {
if ( F_5 ( V_8 , V_180 , & V_173 ) ) {
F_4 ( V_17
L_55 ) ;
continue;
}
...
static void F_49 ( struct V_183 * V_174 )
{
struct V_7 * V_8 = F_50 ( V_174 , struct V_7 ,
V_174 . V_184 ) ;
...
static int F_61 ( struct V_24 * V_25 , void * V_188 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
struct V_189 * V_190 = V_188 ;
F_7 ( 1 , L_3 , V_28 ) ;
if ( V_190 -> V_112 )
V_8 -> V_112 = V_190 -> V_112 ;
if ( V_190 -> V_161 )
V_8 -> V_161 = V_190 -> V_161 ;
if ( V_190 -> V_114 )
V_8 -> V_114 = V_190 -> V_114 ;
return 0 ;
}
struct V_24 * F_62 ( struct V_24 * V_25 ,
struct V_191 * V_192 ,
...
V_193 ? V_193 -> V_195 : - 1 ) ;
F_58 ( & V_187 ) ;
V_194 = F_64 ( struct V_7 , V_8 ,
V_196 ,
V_192 , V_193 -> V_195 , L_67 ) ;
switch ( V_194 ) {
case 0 :
goto V_197;
case 1 :
...
if ( V_8 -> V_112 == 0 ) {
V_8 -> V_112 = V_193 -> V_112 ;
}
if ( V_8 -> V_99 == 0 )
V_8 -> V_99 = V_193 -> V_99 ;
if ( V_8 -> V_161 == 0 )
V_8 -> V_161 = V_193 -> V_161 ;
if ( ( V_8 -> V_2 == 0 ) || ( V_193 -> V_2 ) )
V_8 -> V_2 = ( V_193 -> V_2 ) ? V_193 -> V_2 : 0 ;
if ( ( V_8 -> V_114 == 0 ) || ( V_193 -> V_114 ) )
V_8 -> V_114 = ( V_193 -> V_114 ) ? V_193 -> V_114 : 0x8a ;
if ( F_5 ( V_8 , V_139 , & V_138 ) != 0 )
goto V_197;
switch ( V_138 ) {
case V_198 :
F_4 ( V_182
