...
struct V_3 * V_4 , struct V_28 * V_20 ,
struct V_28 * V_16 , unsigned int V_10 ,
void (* F_22)( void * V_7 , T_1 * V_20 , const T_1 * V_16 ) ,
void * V_39 , void * V_40 )
{
const unsigned int V_9 = 128 / 8 ;
bool V_13 = false ;
...
V_4 , V_13 ,
V_10 < V_9 ? V_9 : V_10 ) ;
F_22 ( V_39 , V_6 . V_30 , V_6 . V_30 ) ;
while ( V_10 ) {
V_10 = F_20 ( V_2 , V_40 , V_4 , & V_6 ) ;
V_14 = F_5 ( V_4 , & V_6 , V_10 ) ;
V_10 = V_6 . V_10 ;
}
F_6 ( V_13 ) ;
...
void F_23 ( void * V_7 , T_3 * V_20 , const T_3 * V_16 , T_5 * V_30 ,
T_2 V_29 )
{
T_5 V_41 = * V_30 ;
F_24 ( V_30 , & V_41 ) ;
F_10 ( V_20 , V_16 , ( T_3 * ) & V_41 ) ;
V_29 ( V_7 , ( T_1 * ) V_20 , ( T_1 * ) V_20 ) ;
F_10 ( V_20 , V_20 , ( T_3 * ) & V_41 ) ;
}
