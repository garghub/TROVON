...
static void F_204 ( struct V_29 * V_30 , T_1 V_318 )
{
T_1 V_290 = V_318 - V_30 -> V_105 ;
F_205 ( & V_30 -> V_361 ) ;
V_30 -> V_362 += V_290 ;
F_206 ( & V_30 -> V_361 ) ;
V_30 -> V_105 = V_318 ;
...
static int F_208 ( struct V_1 * V_2 , const struct V_3 * V_4 , T_1 V_318 ,
T_1 V_151 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
int V_181 = 0 ;
...
bool F_211 ( struct V_367 * V_367 , const struct V_3 * V_4 ,
int V_124 , T_1 * V_368 )
{
...
goto V_369;
if ( * V_368 ) {
T_5 V_370 = ( T_5 ) ( V_76 - * V_368 ) ;
if ( 0 <= V_370 && V_370 < V_371 ) {
F_69 ( V_367 , V_124 ) ;
return true ;
}
}
...
{
V_30 -> V_49 . V_378 = V_30 -> V_49 . V_379 ;
V_30 -> V_49 . V_380 = F_215 () ;
}
static void F_216 ( struct V_29 * V_30 , T_1 V_77 )
{
if ( V_30 -> V_49 . V_263 && ! F_53 ( V_77 , V_30 -> V_381 ) ) {
if ( F_217 ( & V_30 -> V_49 , 0 ) )
F_214 ( V_30 ) ;
}
}
static void F_218 ( struct V_1 * V_2 , T_1 V_318 , int V_181 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
...
static inline void F_219 ( struct V_1 * V_2 , T_1 V_383 )
{
const struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_6 -> V_233 -> V_384 )
V_6 -> V_233 -> V_384 ( V_2 , V_383 ) ;
}
...
bool V_303 = false ;
T_1 V_333 ;
int V_385 = V_30 -> V_110 ;
const int V_288 = V_30 -> V_110 - V_30 -> V_133 ;
int V_226 = 0 ;
long V_207 = - 1L ;
F_195 ( V_2 -> V_386 . V_345 ) ;
if ( F_46 ( V_318 , V_158 ) ) {
...
if ( ! ( V_181 & V_390 ) && F_53 ( V_318 , V_158 ) ) {
F_209 ( V_30 , V_151 ) ;
F_204 ( V_30 , V_318 ) ;
V_181 |= V_365 ;
F_219 ( V_2 , V_391 ) ;
...
F_69 ( F_70 ( V_2 ) , V_396 ) ;
V_181 |= F_208 ( V_2 , V_4 , V_318 , V_151 ) ;
if ( F_16 ( V_4 ) -> V_139 )
...
return 1 ;
V_388:
F_224 ( V_2 , L_12 , V_318 , V_30 -> V_105 , V_30 -> V_107 ) ;
return - 1 ;
V_387:
if ( F_16 ( V_4 ) -> V_139 ) {
V_181 |= F_115 ( V_2 , V_4 , V_158 ,
...
F_224 ( V_2 , L_13 , V_318 , V_30 -> V_105 , V_30 -> V_107 ) ;
return 0 ;
}
static void F_225 ( int V_10 , const unsigned char * V_402 ,
bool V_45 , struct V_403 * V_404 ,
bool V_405 )
{
if ( ! V_404 || ! V_45 || V_10 < 0 || ( V_10 & 1 ) )
return;
if ( V_10 >= V_406 &&
V_10 <= V_407 )
memcpy ( V_404 -> V_408 , V_402 , V_10 ) ;
else if ( V_10 != 0 )
V_10 = - 1 ;
V_404 -> V_10 = V_10 ;
V_404 -> exp = V_405 ;
...
struct V_409 * V_410 , int V_411 ,
struct V_403 * V_404 )
{
const unsigned char * V_208 ;
const struct V_15 * V_43 = F_6 ( V_4 ) ;
int V_412 = ( V_43 -> V_413 * 4 ) - sizeof( struct V_15 ) ;
...
switch ( V_414 ) {
case V_418 :
if ( V_415 == V_419 && V_43 -> V_45 && ! V_411 ) {
T_6 V_420 = F_227 ( V_208 ) ;
if ( V_420 ) {
if ( V_410 -> V_421 &&
V_410 -> V_421 < V_420 )
V_420 = V_410 -> V_421 ;
...
( ! V_411 && V_430 ) ) ) {
V_410 -> V_263 = 1 ;
V_410 -> V_379 = F_83 ( V_208 ) ;
V_410 -> V_91 = F_83 ( V_208 + 4 ) ;
}
break;
case V_431 :
if ( V_415 == V_432 && V_43 -> V_45 &&
! V_411 && V_433 ) {
V_410 -> V_119 = V_434 ;
F_229 ( V_410 ) ;
}
...
if ( * V_208 == F_232 ( ( V_417 << 24 ) | ( V_417 << 16 )
| ( V_427 << 8 ) | V_428 ) ) {
V_30 -> V_49 . V_263 = 1 ;
++ V_208 ;
V_30 -> V_49 . V_379 = F_233 ( * V_208 ) ;
++ V_208 ;
if ( * V_208 )
V_30 -> V_49 . V_91 = F_233 ( * V_208 ) - V_30 -> V_443 ;
else
V_30 -> V_49 . V_91 = 0 ;
return true ;
}
...
{
if ( V_43 -> V_413 == ( sizeof( * V_43 ) / 4 ) ) {
V_30 -> V_49 . V_263 = 0 ;
return false ;
} else if ( V_30 -> V_49 . V_429 &&
V_43 -> V_413 == ( ( sizeof( * V_43 ) + V_444 ) / 4 ) ) {
if ( F_231 ( V_30 , V_43 ) )
return true ;
}
F_226 ( V_4 , & V_30 -> V_49 , 1 , NULL ) ;
if ( V_30 -> V_49 . V_263 && V_30 -> V_49 . V_91 )
V_30 -> V_49 . V_91 -= V_30 -> V_443 ;
return true ;
}
const T_4 * F_235 ( const struct V_15 * V_43 )
{
int V_412 = ( V_43 -> V_413 << 2 ) - sizeof( * V_43 ) ;
...
default:
V_415 = * V_208 ++ ;
if ( V_415 < 2 || V_415 > V_412 )
return NULL ;
if ( V_414 == V_437 )
return V_415 == V_445 ? V_208 : NULL ;
}
V_208 += V_415 - 2 ;
V_412 -= V_415 ;
}
...
V_318 == V_30 -> V_105 &&
! F_203 ( V_30 , V_318 , V_77 , F_152 ( V_43 -> V_60 ) << V_30 -> V_49 . V_364 ) &&
( T_5 ) ( V_30 -> V_49 . V_378 - V_30 -> V_49 . V_379 ) <= ( F_2 ( V_2 ) -> V_98 * 1024 ) / V_375 ) ;
}
static inline bool F_237 ( const struct V_1 * V_2 ,
const struct V_3 * V_4 )
{
const struct V_29 * V_30 = F_7 ( V_2 ) ;
return ! F_217 ( & V_30 -> V_49 , V_446 ) &&
! F_236 ( V_2 , V_4 ) ;
}
static inline bool F_238 ( const struct V_29 * V_30 , T_1 V_77 , T_1 V_92 )
{
return ! F_46 ( V_92 , V_30 -> V_381 ) &&
...
if ( V_2 -> V_457 == V_470 ||
V_2 -> V_447 == V_453 )
F_250 ( V_2 , V_471 , V_472 ) ;
else
F_250 ( V_2 , V_471 , V_473 ) ;
}
}
static inline bool F_251 ( struct V_200 * V_156 , T_1 V_77 ,
T_1 V_92 )
{
...
F_69 ( F_70 ( V_2 ) , V_124 ) ;
V_30 -> V_49 . V_477 = 1 ;
V_30 -> V_478 [ 0 ] . V_143 = V_77 ;
V_30 -> V_478 [ 0 ] . V_92 = V_92 ;
}
}
...
{
int V_480 ;
struct V_200 * V_156 = & V_30 -> V_481 [ 0 ] ;
struct V_200 * V_482 = V_156 + 1 ;
for ( V_480 = 1 ; V_480 < V_30 -> V_49 . V_157 ; ) {
if ( F_251 ( V_156 , V_482 -> V_143 , V_482 -> V_92 ) ) {
int V_214 ;
V_30 -> V_49 . V_157 -- ;
for ( V_214 = V_480 ; V_214 < V_30 -> V_49 . V_157 ; V_214 ++ )
...
struct V_29 * V_30 = F_7 ( V_2 ) ;
struct V_200 * V_156 = & V_30 -> V_481 [ 0 ] ;
int V_483 = V_30 -> V_49 . V_157 ;
int V_480 ;
if ( ! V_483 )
goto V_484;
for ( V_480 = 0 ; V_480 < V_483 ; V_480 ++ , V_156 ++ ) {
if ( F_251 ( V_156 , V_77 , V_92 ) ) {
for (; V_480 > 0 ; V_480 -- , V_156 -- )
F_118 ( * V_156 , * ( V_156 - 1 ) ) ;
if ( V_483 > 1 )
F_255 ( V_30 ) ;
return;
...
for ( V_480 = 0 ; V_480 < V_157 ; ) {
if ( ! F_46 ( V_30 -> V_90 , V_156 -> V_143 ) ) {
int V_214 ;
F_116 ( F_46 ( V_30 -> V_90 , V_156 -> V_92 ) ) ;
for ( V_214 = V_480 + 1 ; V_214 < V_157 ; V_214 ++ )
V_30 -> V_481 [ V_214 - 1 ] = V_30 -> V_481 [ V_214 ] ;
V_157 -- ;
continue;
}
V_480 ++ ;
...
int V_290 ;
* V_487 = false ;
if ( F_16 ( V_486 ) -> V_77 != F_16 ( V_485 ) -> V_92 )
return false ;
if ( ! F_260 ( V_485 , V_486 , V_487 , & V_290 ) )
return false ;
F_261 ( V_290 , & V_2 -> V_81 ) ;
F_262 ( V_2 , V_290 ) ;
F_69 ( F_70 ( V_2 ) , V_488 ) ;
F_16 ( V_485 ) -> V_92 = F_16 ( V_486 ) -> V_92 ;
F_16 ( V_485 ) -> V_151 = F_16 ( V_486 ) -> V_151 ;
F_16 ( V_485 ) -> V_192 |= F_16 ( V_486 ) -> V_192 ;
return true ;
}
...
bool V_487 , V_491 ;
while ( ( V_4 = F_264 ( & V_30 -> V_468 ) ) != NULL ) {
if ( F_53 ( F_16 ( V_4 ) -> V_77 , V_30 -> V_90 ) )
break;
if ( F_46 ( F_16 ( V_4 ) -> V_77 , V_489 ) ) {
T_3 V_477 = V_489 ;
if ( F_46 ( F_16 ( V_4 ) -> V_92 , V_489 ) )
V_489 = F_16 ( V_4 ) -> V_92 ;
F_253 ( V_2 , F_16 ( V_4 ) -> V_77 , V_477 ) ;
}
F_265 ( V_4 , & V_30 -> V_468 ) ;
if ( ! F_53 ( F_16 ( V_4 ) -> V_92 , V_30 -> V_90 ) ) {
F_224 ( V_2 , L_16 ) ;
F_266 ( V_4 ) ;
continue;
...
F_16 ( V_4 ) -> V_92 ) ;
V_490 = F_267 ( & V_2 -> V_492 ) ;
V_491 = V_490 && F_259 ( V_2 , V_490 , V_4 , & V_487 ) ;
...
T_1 V_77 , V_92 ;
F_19 ( V_30 , V_4 ) ;
if ( F_104 ( F_270 ( V_2 , V_4 , V_4 -> V_59 ) ) ) {
F_69 ( F_70 ( V_2 ) , V_495 ) ;
F_266 ( V_4 ) ;
return;
}
...
V_494 = F_267 ( & V_30 -> V_468 ) ;
if ( ! V_494 ) {
if ( F_143 ( V_30 ) ) {
V_30 -> V_49 . V_157 = 1 ;
V_30 -> V_481 [ 0 ] . V_143 = F_16 ( V_4 ) -> V_77 ;
V_30 -> V_481 [ 0 ] . V_92 =
F_16 ( V_4 ) -> V_92 ;
}
F_275 ( & V_30 -> V_468 , V_4 ) ;
goto V_497;
}
V_77 = F_16 ( V_4 ) -> V_77 ;
V_92 = F_16 ( V_4 ) -> V_92 ;
if ( V_77 == F_16 ( V_494 ) -> V_92 ) {
bool V_487 ;
if ( ! F_259 ( V_2 , V_494 , V_4 , & V_487 ) ) {
F_276 ( & V_30 -> V_468 , V_494 , V_4 ) ;
} else {
F_29 ( V_2 , V_4 ) ;
F_269 ( V_4 , V_487 ) ;
V_4 = NULL ;
...
if ( ! V_30 -> V_49 . V_157 ||
V_30 -> V_481 [ 0 ] . V_92 != V_77 )
goto V_498;
V_30 -> V_481 [ 0 ] . V_92 = V_92 ;
goto V_497;
}
while ( 1 ) {
if ( ! F_53 ( F_16 ( V_494 ) -> V_77 , V_77 ) )
break;
if ( F_277 ( & V_30 -> V_468 , V_494 ) ) {
V_494 = NULL ;
break;
}
V_494 = F_278 ( & V_30 -> V_468 , V_494 ) ;
}
if ( V_494 && F_46 ( V_77 , F_16 ( V_494 ) -> V_92 ) ) {
if ( ! F_53 ( V_92 , F_16 ( V_494 ) -> V_92 ) ) {
F_69 ( F_70 ( V_2 ) , V_499 ) ;
F_266 ( V_4 ) ;
V_4 = NULL ;
F_252 ( V_2 , V_77 , V_92 ) ;
...
F_276 ( & V_30 -> V_468 , V_494 , V_4 ) ;
while ( ! F_279 ( & V_30 -> V_468 , V_4 ) ) {
V_494 = F_280 ( & V_30 -> V_468 , V_4 ) ;
if ( ! F_53 ( V_92 , F_16 ( V_494 ) -> V_77 ) )
break;
if ( F_46 ( V_92 , F_16 ( V_494 ) -> V_92 ) ) {
F_253 ( V_2 , F_16 ( V_494 ) -> V_77 ,
V_92 ) ;
break;
}
F_265 ( V_494 , & V_30 -> V_468 ) ;
F_253 ( V_2 , F_16 ( V_494 ) -> V_77 ,
F_16 ( V_494 ) -> V_92 ) ;
F_69 ( F_70 ( V_2 ) , V_499 ) ;
F_266 ( V_494 ) ;
...
static int T_9 F_282 ( struct V_1 * V_2 , struct V_3 * V_4 , int V_500 ,
bool * V_487 )
{
int V_491 ;
struct V_3 * V_490 = F_267 ( & V_2 -> V_492 ) ;
F_283 ( V_4 , V_500 ) ;
V_491 = ( V_490 &&
F_259 ( V_2 , V_490 , V_4 , V_487 ) ) ? 1 : 0 ;
...
int F_284 ( struct V_1 * V_2 , struct V_501 * V_264 , T_10 V_493 )
{
struct V_3 * V_4 ;
bool V_487 ;
if ( V_493 == 0 )
return 0 ;
V_4 = F_285 ( V_493 , V_2 -> V_502 ) ;
if ( ! V_4 )
goto V_166;
if ( F_270 ( V_2 , V_4 , V_4 -> V_59 ) )
goto V_503;
if ( F_286 ( F_287 ( V_4 , V_493 ) , V_264 , V_493 ) )
goto V_503;
F_16 ( V_4 ) -> V_77 = F_7 ( V_2 ) -> V_90 ;
F_16 ( V_4 ) -> V_92 = F_16 ( V_4 ) -> V_77 + V_493 ;
F_16 ( V_4 ) -> V_151 = F_7 ( V_2 ) -> V_105 - 1 ;
if ( F_282 ( V_2 , V_4 , 0 , & V_487 ) ) {
F_196 ( V_487 ) ;
F_266 ( V_4 ) ;
}
return V_493 ;
...
goto V_505;
F_290 ( V_4 ) ;
F_283 ( V_4 , F_6 ( V_4 ) -> V_413 * 4 ) ;
F_13 ( V_30 , V_4 ) ;
V_30 -> V_49 . V_477 = 0 ;
if ( F_16 ( V_4 ) -> V_77 == V_30 -> V_90 ) {
if ( F_239 ( V_30 ) == 0 )
goto V_506;
if ( V_30 -> V_507 . V_508 == V_509 &&
V_30 -> V_78 == V_30 -> V_90 && V_30 -> V_507 . V_10 &&
F_291 ( V_2 ) && ! V_30 -> V_510 ) {
int V_511 = F_43 (unsigned int, skb->len,
tp->ucopy.len) ;
F_292 ( V_512 ) ;
F_293 () ;
if ( ! F_294 ( V_4 , 0 , V_30 -> V_507 . V_264 , V_511 ) ) {
V_30 -> V_507 . V_10 -= V_511 ;
V_30 -> V_78 += V_511 ;
V_491 = ( V_511 == V_4 -> V_10 ) ;
F_48 ( V_2 ) ;
}
F_295 () ;
}
...
V_513:
if ( V_491 < 0 &&
F_270 ( V_2 , V_4 , V_4 -> V_59 ) )
goto V_505;
V_491 = F_282 ( V_2 , V_4 , 0 , & V_487 ) ;
}
F_207 ( V_30 , F_16 ( V_4 ) -> V_92 ) ;
if ( V_4 -> V_10 )
F_49 ( V_2 , V_4 ) ;
...
static struct V_3 * F_296 ( struct V_1 * V_2 , struct V_3 * V_4 ,
struct V_515 * V_516 )
{
struct V_3 * V_345 = NULL ;
if ( ! F_279 ( V_516 , V_4 ) )
V_345 = F_280 ( V_516 , V_4 ) ;
F_265 ( V_4 , V_516 ) ;
F_266 ( V_4 ) ;
F_69 ( F_70 ( V_2 ) , V_517 ) ;
return V_345 ;
...
static void
F_297 ( struct V_1 * V_2 , struct V_515 * V_516 ,
struct V_3 * V_518 , struct V_3 * V_490 ,
T_1 V_519 , T_1 V_497 )
{
struct V_3 * V_4 , * V_520 ;
bool V_521 ;
V_4 = V_518 ;
V_522:
V_521 = true ;
...
if ( V_4 == V_490 )
break;
if ( ! F_46 ( V_519 , F_16 ( V_4 ) -> V_92 ) ) {
V_4 = F_296 ( V_2 , V_4 , V_516 ) ;
if ( ! V_4 )
break;
goto V_522;
}
...
F_46 ( F_16 ( V_4 ) -> V_77 , V_519 ) ) ) {
V_521 = false ;
break;
}
if ( ! F_279 ( V_516 , V_4 ) ) {
struct V_3 * V_345 = F_280 ( V_516 , V_4 ) ;
if ( V_345 != V_490 &&
...
return;
while ( F_46 ( V_519 , V_497 ) ) {
int V_523 = F_43 ( int , F_299 ( 0 , 0 ) , V_497 - V_519 ) ;
struct V_3 * V_524 ;
V_524 = F_285 ( V_523 , V_171 ) ;
if ( ! V_524 )
return;
memcpy ( V_524 -> V_525 , V_4 -> V_525 , sizeof( V_4 -> V_525 ) ) ;
F_16 ( V_524 ) -> V_77 = F_16 ( V_524 ) -> V_92 = V_519 ;
F_300 ( V_516 , V_4 , V_524 ) ;
F_281 ( V_524 , V_2 ) ;
while ( V_523 > 0 ) {
int V_526 = V_519 - F_16 ( V_4 ) -> V_77 ;
int V_493 = F_16 ( V_4 ) -> V_92 - V_519 ;
F_92 ( V_526 < 0 ) ;
if ( V_493 > 0 ) {
V_493 = F_9 ( V_523 , V_493 ) ;
if ( F_301 ( V_4 , V_526 , F_287 ( V_524 , V_493 ) , V_493 ) )
F_302 () ;
F_16 ( V_524 ) -> V_92 += V_493 ;
V_523 -= V_493 ;
V_519 += V_493 ;
}
if ( ! F_46 ( V_519 , F_16 ( V_4 ) -> V_92 ) ) {
...
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
struct V_3 * V_4 = F_264 ( & V_30 -> V_468 ) ;
struct V_3 * V_518 ;
T_1 V_519 , V_497 ;
if ( ! V_4 )
return;
...
for (; ; ) {
struct V_3 * V_345 = NULL ;
if ( ! F_279 ( & V_30 -> V_468 , V_4 ) )
V_345 = F_280 ( & V_30 -> V_468 , V_4 ) ;
V_4 = V_345 ;
if ( ! V_4 ||
F_53 ( F_16 ( V_4 ) -> V_77 , V_497 ) ||
F_46 ( F_16 ( V_4 ) -> V_92 , V_519 ) ) {
F_297 ( V_2 , & V_30 -> V_468 ,
V_518 , V_4 , V_519 , V_497 ) ;
V_518 = V_4 ;
if ( ! V_4 )
break;
V_519 = F_16 ( V_4 ) -> V_77 ;
...
if ( F_46 ( F_16 ( V_4 ) -> V_77 , V_519 ) )
V_519 = F_16 ( V_4 ) -> V_77 ;
if ( F_53 ( F_16 ( V_4 ) -> V_92 , V_497 ) )
V_497 = F_16 ( V_4 ) -> V_92 ;
}
}
}
...
F_308 () ;
if ( V_2 -> V_533 &&
F_309 ( V_534 , & V_2 -> V_533 -> V_383 ) )
F_305 ( V_2 ) ;
}
}
static inline void F_310 ( struct V_1 * V_2 )
{
F_311 ( V_2 ) ;
F_306 ( V_2 ) ;
}
static void F_312 ( struct V_1 * V_2 , int V_535 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
if ( ( ( V_30 -> V_90 - V_30 -> V_381 ) > F_2 ( V_2 ) -> V_8 . V_12 &&
F_313 ( V_2 ) >= V_30 -> V_23 ) ||
F_11 ( V_2 ) ||
( V_535 && F_264 ( & V_30 -> V_468 ) ) ) {
F_213 ( V_2 ) ;
} else {
F_314 ( V_2 ) ;
}
}
static inline void F_315 ( struct V_1 * V_2 )
{
if ( ! F_316 ( V_2 ) ) {
return;
}
...
static void F_317 ( struct V_1 * V_2 , const struct V_15 * V_43 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
T_1 V_208 = F_152 ( V_43 -> V_536 ) ;
if ( V_208 && ! V_537 )
V_208 -- ;
...
return;
if ( V_30 -> V_510 && ! F_53 ( V_208 , V_30 -> V_538 ) )
return;
F_318 ( V_2 ) ;
if ( V_30 -> V_538 == V_30 -> V_78 && V_30 -> V_510 &&
! F_242 ( V_2 , V_539 ) && V_30 -> V_78 != V_30 -> V_90 ) {
struct V_3 * V_4 = F_264 ( & V_2 -> V_492 ) ;
V_30 -> V_78 ++ ;
...
static void F_319 ( struct V_1 * V_2 , struct V_3 * V_4 , const struct V_15 * V_43 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
if ( V_43 -> V_541 )
F_317 ( V_2 , V_43 ) ;
if ( V_30 -> V_510 == V_540 ) {
T_1 V_208 = V_30 -> V_538 - F_233 ( V_43 -> V_77 ) + ( V_43 -> V_413 * 4 ) -
V_43 -> V_45 ;
if ( V_208 < V_4 -> V_10 ) {
T_4 V_203 ;
if ( F_301 ( V_4 , V_208 , & V_203 , 1 ) )
F_302 () ;
V_30 -> V_510 = V_542 | V_203 ;
if ( ! F_242 ( V_2 , V_455 ) )
V_2 -> V_514 ( V_2 ) ;
}
}
}
static int F_320 ( struct V_1 * V_2 , struct V_3 * V_4 , int V_543 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
int V_511 = V_4 -> V_10 - V_543 ;
int V_166 ;
F_293 () ;
if ( F_321 ( V_4 ) )
V_166 = F_294 ( V_4 , V_543 , V_30 -> V_507 . V_264 , V_511 ) ;
else
V_166 = F_322 ( V_4 , V_543 , V_30 -> V_507 . V_264 ) ;
if ( ! V_166 ) {
V_30 -> V_507 . V_10 -= V_511 ;
V_30 -> V_78 += V_511 ;
F_48 ( V_2 ) ;
...
static T_11 F_323 ( struct V_1 * V_2 ,
struct V_3 * V_4 )
{
T_11 V_544 ;
if ( F_291 ( V_2 ) ) {
...
static inline bool F_325 ( struct V_1 * V_2 ,
struct V_3 * V_4 )
{
return ! F_321 ( V_4 ) &&
F_323 ( V_2 , V_4 ) ;
}
static bool F_326 ( struct V_1 * V_2 , struct V_3 * V_4 ,
const struct V_15 * V_43 , int V_545 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
...
struct V_29 * V_30 = F_7 ( V_2 ) ;
if ( F_104 ( ! V_2 -> V_554 ) )
F_2 ( V_2 ) -> V_555 -> V_556 ( V_2 , V_4 ) ;
V_30 -> V_49 . V_263 = 0 ;
if ( ( F_5 ( V_43 ) & V_557 ) == V_30 -> V_366 &&
F_16 ( V_4 ) -> V_77 == V_30 -> V_90 &&
! F_53 ( F_16 ( V_4 ) -> V_151 , V_30 -> V_107 ) ) {
int V_18 = V_30 -> V_18 ;
if ( V_18 == sizeof( struct V_15 ) + V_444 ) {
if ( ! F_231 ( V_30 , V_43 ) )
goto V_558;
if ( ( T_5 ) ( V_30 -> V_49 . V_379 - V_30 -> V_49 . V_378 ) < 0 )
goto V_558;
}
if ( V_10 <= V_18 ) {
if ( V_10 == V_18 ) {
if ( V_18 ==
( sizeof( struct V_15 ) + V_444 ) &&
V_30 -> V_90 == V_30 -> V_381 )
F_214 ( V_30 ) ;
F_220 ( V_2 , V_4 , 0 ) ;
F_266 ( V_4 ) ;
F_310 ( V_2 ) ;
...
if ( V_30 -> V_507 . V_508 == V_509 &&
V_30 -> V_78 == V_30 -> V_90 &&
V_10 - V_18 <= V_30 -> V_507 . V_10 &&
F_291 ( V_2 ) ) {
F_292 ( V_512 ) ;
if ( ! F_320 ( V_2 , V_4 , V_18 ) ) {
if ( V_18 ==
( sizeof( struct V_15 ) +
V_444 ) &&
V_30 -> V_90 == V_30 -> V_381 )
...
V_558:
if ( V_10 < ( V_43 -> V_413 << 2 ) || F_325 ( V_2 , V_4 ) )
goto V_560;
if ( ! V_43 -> V_318 && ! V_43 -> V_546 && ! V_43 -> V_45 )
goto V_549;
if ( ! F_326 ( V_2 , V_4 , V_43 , 1 ) )
return;
V_562:
if ( F_220 ( V_2 , V_4 , V_390 | V_389 ) < 0 )
goto V_549;
F_47 ( V_2 , V_4 ) ;
F_319 ( V_2 , V_4 , V_43 ) ;
F_289 ( V_2 , V_4 ) ;
...
return;
V_560:
F_327 ( F_70 ( V_2 ) , V_565 ) ;
F_327 ( F_70 ( V_2 ) , V_552 ) ;
V_549:
F_266 ( V_4 ) ;
}
void F_329 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_246 ( V_2 , V_461 ) ;
if ( V_4 ) {
V_6 -> V_555 -> V_556 ( V_2 , V_4 ) ;
F_330 ( V_2 , V_4 ) ;
}
V_6 -> V_555 -> V_566 ( V_2 ) ;
F_331 ( V_2 ) ;
...
F_35 ( V_2 ) ;
if ( F_242 ( V_2 , V_568 ) )
F_333 ( V_2 , F_334 ( V_30 ) ) ;
if ( ! V_30 -> V_49 . V_364 )
F_335 ( V_30 , V_30 -> V_360 ) ;
else
V_30 -> V_366 = 0 ;
if ( ! F_242 ( V_2 , V_455 ) ) {
V_2 -> V_469 ( V_2 ) ;
F_250 ( V_2 , V_569 , V_570 ) ;
}
}
static bool F_336 ( struct V_1 * V_2 , struct V_3 * V_571 ,
struct V_403 * V_402 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
struct V_3 * V_13 = V_30 -> V_572 ? F_105 ( V_2 ) : NULL ;
T_6 V_66 = V_30 -> V_49 . V_50 , V_573 = 0 ;
bool V_574 = false ;
if ( V_66 == V_30 -> V_49 . V_421 ) {
struct V_409 V_575 ;
F_337 ( & V_575 ) ;
V_575 . V_421 = V_575 . V_50 = 0 ;
F_226 ( V_571 , & V_575 , 0 , NULL ) ;
V_66 = V_575 . V_50 ;
}
if ( ! V_30 -> V_576 ) {
V_402 -> V_10 = - 1 ;
} else if ( V_30 -> V_316 ) {
V_574 = ( V_402 -> V_10 < 0 && V_13 ) ;
} else if ( V_402 -> V_10 < 0 && ! V_30 -> V_572 ) {
V_573 = V_30 -> V_577 ? 2 : 1 ;
}
F_338 ( V_2 , V_66 , V_402 , V_574 , V_573 ) ;
if ( V_13 ) {
F_110 (data, sk) {
if ( V_13 == F_81 ( V_2 ) ||
F_339 ( V_2 , V_13 ) )
...
V_30 -> V_579 = V_30 -> V_572 ;
if ( V_30 -> V_579 )
F_69 ( F_70 ( V_2 ) , V_580 ) ;
return false ;
}
static int F_340 ( struct V_1 * V_2 , struct V_3 * V_4 ,
const struct V_15 * V_43 , unsigned int V_10 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_29 * V_30 = F_7 ( V_2 ) ;
struct V_403 V_404 = { . V_10 = - 1 } ;
int V_581 = V_30 -> V_49 . V_50 ;
F_226 ( V_4 , & V_30 -> V_49 , 0 , & V_404 ) ;
if ( V_30 -> V_49 . V_263 && V_30 -> V_49 . V_91 )
V_30 -> V_49 . V_91 -= V_30 -> V_443 ;
if ( V_43 -> V_318 ) {
...
goto V_584;
F_20 ( V_30 , V_43 ) ;
F_341 ( V_30 , F_16 ( V_4 ) -> V_77 ) ;
F_220 ( V_2 , V_4 , V_390 ) ;
V_30 -> V_90 = F_16 ( V_4 ) -> V_77 + 1 ;
V_30 -> V_381 = F_16 ( V_4 ) -> V_77 + 1 ;
V_30 -> V_360 = F_152 ( V_43 -> V_60 ) ;
if ( ! V_30 -> V_49 . V_425 ) {
V_30 -> V_49 . V_364 = V_30 -> V_49 . V_585 = 0 ;
...
if ( V_30 -> V_49 . V_380 && V_30 -> V_49 . V_263 &&
F_345 ( & V_30 -> V_49 , 0 ) )
goto V_584;
if ( V_43 -> V_45 ) {
F_246 ( V_2 , V_460 ) ;
...
V_593 = V_30 -> V_320 ;
if ( V_593 ) {
F_196 ( V_2 -> V_447 != V_460 &&
V_2 -> V_447 != V_465 ) ;
if ( ! F_348 ( V_2 , V_4 , V_593 , true ) )
goto V_549;
}
if ( ! V_43 -> V_318 && ! V_43 -> V_546 && ! V_43 -> V_45 )
goto V_549;
if ( ! F_326 ( V_2 , V_4 , V_43 , 0 ) )
return 0 ;
V_595 = F_220 ( V_2 , V_4 , V_390 |
V_389 ) > 0 ;
switch ( V_2 -> V_447 ) {
case V_460 :
if ( ! V_595 )
return 1 ;
if ( V_593 ) {
V_315 = F_349 ( V_593 ) -> V_599 ;
V_30 -> V_316 = V_593 -> V_600 ;
F_350 ( V_2 , V_593 , false ) ;
} else {
V_315 = V_30 -> V_567 ;
V_6 -> V_555 -> V_566 ( V_2 ) ;
F_332 ( V_2 ) ;
...
V_30 -> V_360 = F_152 ( V_43 -> V_60 ) << V_30 -> V_49 . V_364 ;
F_341 ( V_30 , F_16 ( V_4 ) -> V_77 ) ;
F_183 ( V_2 , V_315 ) ;
if ( V_30 -> V_49 . V_429 )
V_30 -> V_65 -= V_444 ;
...
F_53 ( F_16 ( V_4 ) -> V_92 - V_43 -> V_597 , V_30 -> V_90 ) ) ) {
F_243 ( V_2 ) ;
F_69 ( F_70 ( V_2 ) , V_605 ) ;
return 1 ;
}
V_601 = F_352 ( V_2 ) ;
if ( V_601 > V_606 ) {
F_333 ( V_2 , V_601 - V_606 ) ;
} else if ( V_43 -> V_597 || F_291 ( V_2 ) ) {
F_333 ( V_2 , V_601 ) ;
} else {
F_247 ( V_2 , V_466 , V_601 ) ;
goto V_549;
}
break;
}
...
static inline void F_354 ( struct V_592 * V_593 , T_12 V_607 , int V_608 )
{
struct V_609 * V_610 = F_355 ( V_593 ) ;
if ( V_608 == V_268 )
F_356 ( L_21 ,
& V_610 -> V_611 , V_607 ) ;
#if F_154 ( V_271 )
...
static void F_357 ( struct V_592 * V_593 ,
const struct V_3 * V_4 ,
const struct V_1 * V_613 ,
const struct V_113 * V_114 )
{
const struct V_15 * V_43 = F_6 ( V_4 ) ;
const struct V_367 * V_367 = F_70 ( V_613 ) ;
bool V_614 = V_43 -> V_44 && V_43 -> V_34 ;
bool V_615 , V_616 ;
if ( ! V_614 )
return;
V_615 = ! F_358 ( F_16 ( V_4 ) -> V_36 ) ;
V_616 = V_367 -> V_617 . V_618 || F_359 ( V_114 , V_619 ) ;
if ( ( ! V_615 && V_616 ) || F_17 ( V_613 ) )
F_355 ( V_593 ) -> V_616 = 1 ;
}
static void F_360 ( struct V_592 * V_593 ,
const struct V_409 * V_49 ,
struct V_3 * V_4 , const struct V_1 * V_2 )
{
struct V_609 * V_610 = F_355 ( V_593 ) ;
V_593 -> V_23 = 0 ;
V_593 -> V_620 = 0 ;
F_349 ( V_593 ) -> V_621 = F_16 ( V_4 ) -> V_77 ;
F_349 ( V_593 ) -> V_90 = F_16 ( V_4 ) -> V_77 + 1 ;
F_349 ( V_593 ) -> V_599 = V_76 ;
F_349 ( V_593 ) -> V_368 = 0 ;
V_593 -> V_66 = V_49 -> V_50 ;
V_593 -> V_378 = V_49 -> V_263 ? V_49 -> V_379 : 0 ;
V_610 -> V_429 = V_49 -> V_429 ;
V_610 -> V_119 = V_49 -> V_119 ;
V_610 -> V_364 = V_49 -> V_364 ;
V_610 -> V_425 = V_49 -> V_425 ;
V_610 -> V_226 = 0 ;
V_610 -> V_616 = 0 ;
V_610 -> V_622 = F_6 ( V_4 ) -> V_623 ;
V_610 -> V_624 = F_152 ( F_6 ( V_4 ) -> V_625 ) ;
V_610 -> V_626 = F_361 ( V_2 , V_4 ) ;
}
struct V_592 * F_362 ( const struct V_627 * V_628 ,
struct V_1 * V_629 )
{
struct V_592 * V_593 = F_363 ( V_628 , V_629 ) ;
if ( V_593 ) {
struct V_609 * V_610 = F_355 ( V_593 ) ;
F_364 ( V_610 , V_383 ) ;
V_610 -> V_575 = NULL ;
F_365 ( & V_610 -> V_630 , 0 ) ;
V_610 -> V_631 = V_632 ;
F_366 ( & V_610 -> V_633 , F_70 ( V_629 ) ) ;
V_610 -> V_634 = V_629 -> V_267 ;
}
return V_593 ;
}
static bool F_367 ( struct V_1 * V_2 ,
const struct V_3 * V_4 ,
const char * V_635 )
{
...
#endif
F_69 ( F_70 ( V_2 ) , V_641 ) ;
V_638 = F_2 ( V_2 ) -> V_588 . V_642 ;
if ( ! V_638 -> V_643 && V_639 != 2 ) {
V_638 -> V_643 = 1 ;
F_369 ( L_25 ,
V_635 , F_152 ( F_6 ( V_4 ) -> V_625 ) , V_264 ) ;
}
return V_636 ;
}
int F_370 ( struct V_627 * V_644 ,
...
T_3 V_648 = F_16 ( V_4 ) -> V_649 ;
bool V_636 = false , V_650 ;
struct V_651 V_652 ;
struct V_403 V_404 = { . V_10 = - 1 } ;
int V_166 ;
if ( ( V_639 == 2 ||
F_371 ( V_2 ) ) && ! V_648 ) {
V_636 = F_367 ( V_2 , V_4 , V_644 -> V_653 ) ;
if ( ! V_636 )
goto V_505;
}
if ( F_372 ( V_2 ) && F_373 ( V_2 ) > 1 ) {
F_69 ( F_70 ( V_2 ) , V_654 ) ;
goto V_505;
}
V_593 = F_362 ( V_644 , V_2 ) ;
if ( ! V_593 )
goto V_505;
F_349 ( V_593 ) -> V_655 = V_646 ;
F_337 ( & V_647 ) ;
V_647 . V_50 = V_646 -> V_50 ;
V_647 . V_421 = V_30 -> V_49 . V_421 ;
F_226 ( V_4 , & V_647 , 0 , V_636 ? NULL : & V_404 ) ;
if ( V_636 && ! V_647 . V_263 )
F_337 ( & V_647 ) ;
V_647 . V_429 = V_647 . V_263 ;
F_360 ( V_593 , & V_647 , V_4 , V_2 ) ;
F_355 ( V_593 ) -> V_656 = V_2 -> V_657 ;
V_646 -> V_658 ( V_593 , V_2 , V_4 ) ;
if ( F_374 ( V_2 , V_4 , V_593 ) )
goto V_659;
if ( ! V_636 && ! V_648 ) {
if ( V_660 . V_661 ) {
bool V_662 ;
V_114 = V_646 -> V_663 ( V_2 , & V_652 , V_593 , & V_662 ) ;
if ( V_114 && V_662 &&
! F_375 ( V_593 , V_114 , true ,
V_647 . V_263 ) ) {
F_69 ( F_70 ( V_2 ) , V_664 ) ;
goto V_665;
}
...
( V_666 - F_376 ( V_2 ) <
( V_666 >> 2 ) ) &&
! F_375 ( V_593 , V_114 , false ,
V_647 . V_263 ) ) {
F_354 ( V_593 , F_152 ( F_6 ( V_4 ) -> V_623 ) ,
V_644 -> V_608 ) ;
goto V_665;
}
V_648 = V_646 -> V_667 ( V_4 ) ;
}
if ( ! V_114 ) {
V_114 = V_646 -> V_663 ( V_2 , & V_652 , V_593 , NULL ) ;
if ( ! V_114 )
goto V_659;
}
F_357 ( V_593 , V_4 , V_2 , V_114 ) ;
if ( V_636 ) {
V_648 = F_377 ( V_646 , V_2 , V_4 , & V_593 -> V_66 ) ;
V_593 -> V_620 = V_647 . V_429 ;
if ( ! V_647 . V_429 )
F_355 ( V_593 ) -> V_616 = 0 ;
}
F_349 ( V_593 ) -> V_668 = V_648 ;
F_378 ( V_593 , V_2 , V_114 ) ;
V_650 = ! V_636 &&
F_379 ( V_2 , V_4 , V_593 , & V_404 , V_114 ) ;
V_166 = V_646 -> V_669 ( V_2 , V_114 , & V_652 , V_593 ,
F_380 ( V_4 ) , & V_404 ) ;
if ( ! V_650 ) {
if ( V_166 || V_636 )
goto V_659;
F_349 ( V_593 ) -> V_670 = false ;
V_646 -> V_671 ( V_2 , V_593 , V_672 ) ;
}
return 0 ;
V_665:
F_381 ( V_114 ) ;
