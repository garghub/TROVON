...
char V_22 [ 64 ] ;
V_2 -> V_101 ++ ;
if ( F_92 ( V_102 , V_2 -> V_103 + V_104 ) ||
F_92 ( V_2 -> V_103 , V_102 ) ) {
F_93 ( V_105 L_6 ,
F_94 ( V_8 , V_22 ) ,
V_2 -> V_101 ) ;
V_2 -> V_103 = V_102 ;
...
static void F_95 ( struct V_7 * V_8 , unsigned char V_45 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
if ( F_96 ( V_8 ) ) {
if ( F_97 ( V_8 ) )
...
static void
F_98 ( struct V_7 * V_8 , int signal , unsigned char V_45 )
{
F_79 ( signal , V_8 ) ;
if ( F_99 ( V_8 ) )
F_100 ( V_8 ) ;
...
static int
F_101 ( struct V_7 * V_8 , unsigned char V_45 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
if ( F_99 ( V_8 ) ) {
if ( V_45 == F_102 ( V_8 ) ) {
...
if ( V_8 -> V_108 && ! V_8 -> V_109 && F_99 ( V_8 ) && F_109 ( V_8 ) ) {
F_100 ( V_8 ) ;
F_59 ( V_8 ) ;
}
if ( V_45 == '\r' ) {
...
( V_45 == F_73 ( V_8 ) && F_113 ( V_8 ) ) ) {
F_71 ( V_45 , V_8 ) ;
F_58 ( V_8 ) ;
return 0 ;
}
if ( V_45 == F_114 ( V_8 ) && F_113 ( V_8 ) ) {
V_2 -> V_110 = 1 ;
if ( F_61 ( V_8 ) ) {
F_70 ( V_2 ) ;
if ( F_69 ( V_8 ) ) {
...
if ( V_45 == F_115 ( V_8 ) && F_61 ( V_8 ) && F_113 ( V_8 ) ) {
T_1 V_73 = V_2 -> V_25 ;
F_70 ( V_2 ) ;
F_68 ( V_45 , V_8 ) ;
F_67 ( '\n' , V_2 ) ;
...
if ( V_45 == ( unsigned char ) '\377' && F_90 ( V_8 ) )
F_28 ( V_45 , V_2 ) ;
V_111:
F_119 ( V_2 -> V_3 & ( V_6 - 1 ) , V_2 -> V_52 ) ;
F_28 ( V_45 , V_2 ) ;
F_120 ( & V_2 -> V_25 , V_2 -> V_3 ) ;
...
static inline void
F_121 ( struct V_7 * V_8 , unsigned char V_45 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
if ( V_8 -> V_108 && ! V_8 -> V_109 && F_99 ( V_8 ) && F_109 ( V_8 ) ) {
F_100 ( V_8 ) ;
...
static void F_122 ( struct V_7 * V_8 , unsigned char V_45 )
{
F_121 ( V_8 , V_45 ) ;
}
static inline void
F_123 ( struct V_7 * V_8 , unsigned char V_45 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
if ( V_8 -> V_108 && ! V_8 -> V_109 && F_99 ( V_8 ) && F_109 ( V_8 ) ) {
F_100 ( V_8 ) ;
...
static void F_124 ( struct V_7 * V_8 , unsigned char V_45 )
{
if ( F_125 ( V_8 ) )
V_45 &= 0x7f ;
if ( F_126 ( V_8 ) && F_113 ( V_8 ) )
V_45 = tolower ( V_45 ) ;
if ( F_99 ( V_8 ) ) {
if ( V_45 == F_103 ( V_8 ) )
F_104 ( V_8 ) ;
else if ( V_45 == F_102 ( V_8 ) ||
( V_8 -> V_108 && ! V_8 -> V_109 && F_109 ( V_8 ) &&
V_45 != F_106 ( V_8 ) && V_45 != F_107 ( V_8 ) &&
V_45 != F_108 ( V_8 ) ) ) {
F_100 ( V_8 ) ;
F_59 ( V_8 ) ;
}
...
static void
F_127 ( struct V_7 * V_8 , unsigned char V_45 , char V_114 )
{
char V_22 [ 64 ] ;
switch ( V_114 ) {
case V_115 :
...
F_127 ( V_8 , V_45 , V_114 ) ;
}
static void
F_130 ( struct V_7 * V_8 , const unsigned char * V_70 ,
char * V_121 , int V_40 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
T_1 V_15 , V_85 ;
V_85 = V_2 -> V_3 & ( V_6 - 1 ) ;
V_15 = F_131 ( T_1 , V_40 , V_6 - V_85 ) ;
...
static void
F_132 ( struct V_7 * V_8 , const unsigned char * V_70 ,
char * V_121 , int V_40 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
char V_114 = V_120 ;
...
static void
F_136 ( struct V_7 * V_8 , const unsigned char * V_70 ,
char * V_121 , int V_40 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
char V_114 = V_120 ;
...
static void F_137 ( struct V_7 * V_8 , const unsigned char * V_70 ,
char * V_121 , int V_40 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
bool V_123 = F_125 ( V_8 ) || ( F_126 ( V_8 ) && F_113 ( V_8 ) ) ;
if ( V_2 -> V_124 )
F_130 ( V_8 , V_70 , V_121 , V_40 ) ;
else if ( V_2 -> V_125 || ( F_135 ( V_8 ) && ! V_123 ) )
F_132 ( V_8 , V_70 , V_121 , V_40 ) ;
else if ( V_8 -> V_126 && ! F_135 ( V_8 ) )
...
if ( V_2 -> V_12 && ! F_135 ( V_8 ) )
return;
F_120 ( & V_2 -> V_24 , V_2 -> V_3 ) ;
if ( ( F_1 ( V_2 ) >= V_2 -> V_127 ) || F_135 ( V_8 ) ) {
F_19 ( & V_8 -> V_26 , V_28 , V_113 ) ;
if ( F_25 ( & V_8 -> V_58 ) )
F_26 ( & V_8 -> V_58 , V_100 ) ;
}
...
static int
F_138 ( struct V_7 * V_8 , const unsigned char * V_70 ,
...
V_131 = 0 ;
V_15 = F_140 ( V_40 , V_129 ) ;
if ( ! V_15 )
break;
if ( ! V_131 || ! V_121 || * V_121 != V_116 )
F_137 ( V_8 , V_70 , V_121 , V_15 ) ;
V_70 += V_15 ;
if ( V_121 )
V_121 += V_15 ;
V_40 -= V_15 ;
...
static void F_141 ( struct V_7 * V_8 , const unsigned char * V_70 ,
char * V_121 , int V_40 )
{
F_138 ( V_8 , V_70 , V_121 , V_40 , 0 ) ;
}
static int F_142 ( struct V_7 * V_8 , const unsigned char * V_70 ,
char * V_121 , int V_40 )
{
return F_138 ( V_8 , V_70 , V_121 , V_40 , 1 ) ;
}
int F_143 ( int V_96 )
{
return ( F_144 ( & V_133 -> V_134 , V_96 ) ||
V_133 -> V_135 -> V_136 [ V_96 - 1 ] . V_137 . V_138 == V_139 ) ;
}
static void F_145 ( struct V_7 * V_8 , struct V_140 * V_83 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
if ( ! V_83 || ( V_83 -> V_141 ^ V_8 -> V_142 . V_141 ) & V_143 ) {
F_30 ( V_2 -> V_52 , V_6 ) ;
V_2 -> V_50 = V_2 -> V_4 ;
if ( ! F_146 ( V_8 ) || ! F_1 ( V_2 ) ) {
V_2 -> V_25 = V_2 -> V_4 ;
V_2 -> V_53 = 0 ;
} else {
F_119 ( ( V_2 -> V_3 - 1 ) & ( V_6 - 1 ) ,
V_2 -> V_52 ) ;
V_2 -> V_25 = V_2 -> V_3 ;
V_2 -> V_53 = 1 ;
}
...
V_2 -> V_12 = ( F_146 ( V_8 ) != 0 ) ;
if ( F_125 ( V_8 ) || F_126 ( V_8 ) || F_110 ( V_8 ) ||
F_111 ( V_8 ) || F_112 ( V_8 ) || F_146 ( V_8 ) ||
F_99 ( V_8 ) || F_105 ( V_8 ) || F_61 ( V_8 ) ||
F_90 ( V_8 ) ) {
F_30 ( V_2 -> V_122 , 256 ) ;
if ( F_110 ( V_8 ) || F_111 ( V_8 ) )
F_119 ( '\r' , V_2 -> V_122 ) ;
if ( F_112 ( V_8 ) )
F_119 ( '\n' , V_2 -> V_122 ) ;
if ( F_146 ( V_8 ) ) {
F_119 ( F_72 ( V_8 ) , V_2 -> V_122 ) ;
F_119 ( F_77 ( V_8 ) , V_2 -> V_122 ) ;
F_119 ( F_116 ( V_8 ) , V_2 -> V_122 ) ;
F_119 ( '\n' , V_2 -> V_122 ) ;
F_119 ( F_117 ( V_8 ) , V_2 -> V_122 ) ;
if ( F_113 ( V_8 ) ) {
F_119 ( F_73 ( V_8 ) , V_2 -> V_122 ) ;
F_119 ( F_114 ( V_8 ) , V_2 -> V_122 ) ;
F_119 ( F_118 ( V_8 ) , V_2 -> V_122 ) ;
if ( F_61 ( V_8 ) )
F_119 ( F_115 ( V_8 ) ,
V_2 -> V_122 ) ;
}
...
if ( F_99 ( V_8 ) ) {
F_119 ( F_102 ( V_8 ) , V_2 -> V_122 ) ;
F_119 ( F_103 ( V_8 ) , V_2 -> V_122 ) ;
}
if ( F_105 ( V_8 ) ) {
F_119 ( F_106 ( V_8 ) , V_2 -> V_122 ) ;
F_119 ( F_107 ( V_8 ) , V_2 -> V_122 ) ;
F_119 ( F_108 ( V_8 ) , V_2 -> V_122 ) ;
}
F_147 ( V_112 , V_2 -> V_122 ) ;
V_2 -> V_125 = 0 ;
V_2 -> V_124 = 0 ;
} else {
V_2 -> V_125 = 1 ;
...
if ( ! F_99 ( V_8 ) && V_83 && ( V_83 -> V_145 & V_146 ) && ! V_8 -> V_109 ) {
F_100 ( V_8 ) ;
F_59 ( V_8 ) ;
}
if ( F_25 ( & V_8 -> V_41 ) )
...
static inline int F_154 ( struct V_7 * V_8 , int V_150 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
int V_151 = V_150 && ! F_155 ( V_8 ) && F_156 ( V_8 ) ? F_156 ( V_8 ) : 1 ;
if ( V_2 -> V_12 && ! F_135 ( V_8 ) )
return V_2 -> V_25 != V_2 -> V_4 ;
else
return V_2 -> V_24 - V_2 -> V_4 >= V_151 ;
}
static inline int F_157 ( struct V_7 * V_8 )
{
...
T_1 V_15 ;
bool V_155 ;
T_1 V_85 = F_139 ( & V_2 -> V_24 ) ;
T_1 V_73 = V_2 -> V_4 & ( V_6 - 1 ) ;
V_67 = 0 ;
V_15 = F_140 ( V_85 - V_2 -> V_4 , V_6 - V_73 ) ;
V_15 = F_140 ( * V_69 , V_15 ) ;
if ( V_15 ) {
V_67 = F_10 ( * V_154 , F_3 ( V_2 , V_73 ) , V_15 ) ;
V_15 -= V_67 ;
V_155 = V_15 == 1 && F_2 ( V_2 , V_73 ) == F_116 ( V_8 ) ;
F_7 ( V_8 , F_3 ( V_2 , V_73 ) , V_15 ,
V_2 -> V_12 ) ;
F_120 ( & V_2 -> V_4 , V_2 -> V_4 + V_15 ) ;
if ( F_135 ( V_8 ) && V_2 -> V_12 && V_155 &&
( V_85 == V_2 -> V_4 ) )
V_15 = 0 ;
* V_154 += V_15 ;
* V_69 -= V_15 ;
...
int V_159 , V_160 = 0 ;
bool V_161 = 0 ;
V_15 = F_140 ( * V_69 , F_139 ( & V_2 -> V_25 ) - V_2 -> V_4 ) ;
if ( ! V_15 )
return 0 ;
V_73 = V_2 -> V_4 & ( V_6 - 1 ) ;
V_156 = F_131 ( T_1 , V_73 + V_15 , V_6 ) ;
F_161 ( L_8 ,
V_60 , * V_69 , V_73 , V_15 , V_156 ) ;
V_158 = F_162 ( V_2 -> V_52 , V_156 , V_73 ) ;
V_157 = V_15 - ( V_156 - V_73 ) ;
if ( V_158 == V_6 && V_157 ) {
V_158 = F_162 ( V_2 -> V_52 , V_157 , 0 ) ;
if ( V_158 != V_157 )
V_160 = 1 ;
} else if ( V_158 != V_156 )
V_160 = 1 ;
...
* V_69 -= V_15 ;
if ( V_160 )
F_147 ( V_158 , V_2 -> V_52 ) ;
F_120 ( & V_2 -> V_4 , V_2 -> V_4 + V_45 ) ;
if ( V_160 ) {
if ( ! V_2 -> V_53 )
V_2 -> V_50 = V_2 -> V_4 ;
else
...
static int F_164 ( struct V_7 * V_8 , struct V_164 * V_164 )
{
if ( V_164 -> V_165 -> V_65 == V_166 ||
V_133 -> signal -> V_8 != V_8 )
return 0 ;
F_165 ( & V_8 -> V_55 ) ;
if ( ! V_8 -> V_167 )
F_93 ( V_119 L_10 ) ;
else if ( F_166 ( V_133 ) != V_8 -> V_167 ) {
F_167 ( & V_8 -> V_55 ) ;
if ( F_143 ( V_168 ) || F_168 () )
return - V_169 ;
F_81 ( F_166 ( V_133 ) , V_168 , 1 ) ;
F_169 ( V_170 ) ;
return - V_171 ;
}
F_167 ( & V_8 -> V_55 ) ;
...
static T_3 F_170 ( struct V_7 * V_8 , struct V_164 * V_164 ,
...
V_175 = ( V_104 / 10 ) * F_155 ( V_8 ) ;
V_2 -> V_127 = V_174 = 1 ;
}
}
V_54 = V_8 -> V_54 ;
V_73 = V_2 -> V_4 ;
F_174 ( & V_8 -> V_58 , & V_172 ) ;
while ( V_69 ) {
...
F_84 ( & V_8 -> V_59 ) ;
V_175 = F_177 ( & V_172 , V_180 ,
V_175 ) ;
F_86 ( & V_8 -> V_59 ) ;
continue;
}
if ( V_2 -> V_12 && ! F_135 ( V_8 ) ) {
V_67 = F_160 ( V_8 , & V_154 , & V_69 ) ;
if ( V_67 == - V_163 ) {
V_67 = 0 ;
continue;
} else if ( V_67 )
...
static T_3 F_179 ( struct V_7 * V_8 , struct V_164 * V_164 ,
...
int V_45 ;
T_3 V_67 = 0 ;
if ( F_180 ( V_8 ) && V_164 -> V_165 -> V_65 != V_166 ) {
V_67 = F_181 ( V_8 ) ;
if ( V_67 )
return V_67 ;
}
F_86 ( & V_8 -> V_59 ) ;
F_59 ( V_8 ) ;
F_174 ( & V_8 -> V_41 , & V_172 ) ;
while ( 1 ) {
if ( F_176 ( V_133 ) ) {
V_67 = - V_171 ;
break;
}
if ( F_175 ( V_164 ) || ( V_8 -> V_35 && ! V_8 -> V_35 -> V_40 ) ) {
V_67 = - V_169 ;
break;
}
if ( F_57 ( V_8 ) ) {
...
F_84 ( & V_8 -> V_59 ) ;
F_177 ( & V_172 , V_180 , V_178 ) ;
F_86 ( & V_8 -> V_59 ) ;
}
V_71:
F_178 ( & V_8 -> V_41 , & V_172 ) ;
if ( V_154 - V_22 != V_69 && V_8 -> V_26 )
F_119 ( V_27 , & V_8 -> V_20 ) ;
F_84 ( & V_8 -> V_59 ) ;
return ( V_154 - V_22 ) ? V_154 - V_22 : V_67 ;
}
static unsigned int F_182 ( struct V_7 * V_8 , struct V_164 * V_164 ,
T_4 * V_172 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
unsigned int V_184 = 0 ;
F_183 ( V_164 , & V_8 -> V_58 , V_172 ) ;
F_183 ( V_164 , & V_8 -> V_41 , V_172 ) ;
if ( F_157 ( V_8 ) )
V_184 |= V_185 ;
if ( F_154 ( V_8 , 1 ) )
V_184 |= V_100 | V_186 ;
...
if ( F_156 ( V_8 ) && ! F_155 ( V_8 ) )
V_2 -> V_127 = F_156 ( V_8 ) ;
else
V_2 -> V_127 = 1 ;
}
if ( V_8 -> V_37 -> V_65 && ! F_184 ( V_8 ) &&
F_185 ( V_8 ) < V_188 &&
F_53 ( V_8 ) > 0 )
V_184 |= V_42 | V_189 ;
return V_184 ;
...
static int F_187 ( struct V_7 * V_8 , struct V_164 * V_164 ,
...
switch ( V_190 ) {
case V_192 :
return F_8 ( F_185 ( V_8 ) , ( int T_2 * ) V_191 ) ;
case V_193 :
F_36 ( & V_8 -> V_59 ) ;
if ( F_146 ( V_8 ) )
V_67 = F_186 ( V_2 ) ;
...
default:
return F_188 ( V_8 , V_164 , V_190 , V_191 ) ;
}
}
static void F_189 ( struct V_7 * V_8 , int V_194 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
if ( ! F_25 ( & V_8 -> V_58 ) ) {
if ( V_194 )
