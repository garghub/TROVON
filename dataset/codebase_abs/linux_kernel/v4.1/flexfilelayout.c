...
{
F_97 ( V_125 -> V_2 , V_125 -> V_78 ,
V_125 -> V_215 + V_125 -> V_206 . V_132 ) ;
F_12 ( L_21 , V_19 , V_125 -> V_2 -> V_216 ,
( unsigned long ) F_78 ( V_125 -> V_2 ) -> V_77 -> V_217 ) ;
}
static bool
F_98 ( struct V_50 * V_78 , int V_101 )
{
struct V_66 * V_218 = F_71 ( V_78 , V_101 ) ;
return F_99 ( V_218 ) ;
}
static int F_100 ( struct V_127 * V_128 ,
struct V_124 * V_125 )
{
if ( F_11 ( F_83 ( V_219 , & V_125 -> args . V_211 -> V_138 ) ) ) {
F_101 ( V_128 , - V_63 ) ;
return - V_63 ;
}
...
V_128 -> V_145 == 0 ) {
F_110 ( V_128 , & V_125 -> V_206 . V_225 ) ;
return;
}
V_125 -> V_228 -> V_229 ( V_128 , V_125 ) ;
}
static void F_111 ( struct V_127 * V_128 , void * V_28 )
{
struct V_124 * V_125 = V_28 ;
F_112 ( V_128 ,
& F_113 ( V_125 -> V_2 ) -> V_230 [ V_231 ] ) ;
}
...
if ( V_125 -> V_206 . V_141 -> V_95 == V_233 ||
V_125 -> V_206 . V_141 -> V_95 == V_234 )
F_96 ( V_125 ) ;
return 0 ;
}
...
F_89 ( V_28 -> V_78 , V_28 -> V_236 ,
V_28 -> args . V_43 , V_28 -> args . V_132 ,
V_28 -> V_206 . V_207 , V_237 ) ;
V_10 = F_88 ( V_128 , NULL , V_28 -> V_212 ,
V_28 -> V_78 , V_28 -> V_236 ) ;
switch ( V_10 ) {
case - V_190 :
case - V_191 :
...
F_97 ( V_28 -> V_2 , V_28 -> V_78 , V_28 -> V_238 ) ;
return 0 ;
}
...
static void F_122 ( struct V_127 * V_128 , void * V_28 )
{
struct V_124 * V_125 = V_28 ;
if ( F_121 ( V_128 , V_125 ) )
return;
F_103 ( V_128 ) ;
}
...
{
struct V_235 * V_242 = V_28 ;
F_112 ( V_128 ,
& F_113 ( V_242 -> V_2 ) -> V_230 [ V_243 ] ) ;
}
static enum V_244
F_129 ( struct V_124 * V_125 )
{
...
struct V_23 * V_24 ;
F_12 ( L_27 ,
V_19 , V_125 -> V_2 -> V_216 ,
V_125 -> args . V_249 , ( V_250 ) V_125 -> args . V_132 , V_43 ) ;
V_91 = F_49 ( V_78 , V_101 , false ) ;
if ( ! V_91 )
goto V_251;
V_246 = F_130 ( V_78 , V_101 , V_91 -> V_212 ,
V_125 -> V_2 ) ;
if ( F_131 ( V_246 ) )
goto V_251;
V_248 = F_132 ( V_78 , V_101 , V_125 -> V_82 ) ;
if ( F_131 ( V_248 ) )
goto V_251;
V_200 = F_133 ( V_78 , V_101 ) ;
F_12 ( L_28 , V_19 ,
V_91 -> V_252 , F_134 ( & V_91 -> V_212 -> V_253 ) , V_200 ) ;
F_135 ( & V_91 -> V_212 -> V_253 ) ;
V_125 -> V_212 = V_91 -> V_212 ;
V_24 = F_136 ( V_78 , V_101 ) ;
if ( V_24 )
V_125 -> args . V_24 = V_24 ;
V_125 -> args . V_43 = V_43 ;
V_125 -> V_215 = V_43 ;
F_137 ( V_246 , V_125 , V_248 , V_91 -> V_212 -> V_254 ,
V_200 == 3 ? & V_255 :
& V_256 ,
0 , V_257 ) ;
return V_258 ;
...
static enum V_244
F_138 ( struct V_124 * V_125 , int V_261 )
{
struct V_50 * V_78 = V_125 -> V_78 ;
struct V_97 * V_91 ;
struct V_245 * V_246 ;
...
V_200 = F_133 ( V_78 , V_101 ) ;
F_12 ( L_29 ,
V_19 , V_125 -> V_2 -> V_216 , V_261 , ( V_250 ) V_125 -> args . V_132 ,
V_43 , V_91 -> V_252 , F_134 ( & V_91 -> V_212 -> V_253 ) ,
V_200 ) ;
V_125 -> V_220 = F_114 ;
F_135 ( & V_91 -> V_212 -> V_253 ) ;
V_125 -> V_212 = V_91 -> V_212 ;
...
static T_4 F_139 ( struct V_50 * V_78 , T_4 V_34 )
{
return V_34 ;
}
static struct V_23 *
F_140 ( struct V_50 * V_78 , T_4 V_34 )
{
struct V_32 * V_265 = F_41 ( V_78 ) ;
return & V_265 -> V_35 [ V_34 ] -> V_37 [ 0 ] ;
}
static int F_141 ( struct V_235 * V_28 , int V_266 )
{
...
if ( F_131 ( V_246 ) )
goto V_267;
V_248 = F_132 ( V_78 , V_101 , V_28 -> V_82 ) ;
if ( F_131 ( V_248 ) )
goto V_267;
V_200 = F_133 ( V_78 , V_101 ) ;
F_12 ( L_30 , V_19 ,
V_28 -> V_2 -> V_216 , V_266 , F_134 ( & V_91 -> V_212 -> V_253 ) ,
V_200 ) ;
V_28 -> V_268 = F_118 ;
V_28 -> V_82 = V_248 ;
F_135 ( & V_91 -> V_212 -> V_253 ) ;
V_28 -> V_212 = V_91 -> V_212 ;
V_24 = F_140 ( V_78 , V_28 -> V_236 ) ;
if ( V_24 )
V_28 -> args . V_24 = V_24 ;
return F_142 ( V_246 , V_28 , V_91 -> V_212 -> V_254 ,
V_200 == 3 ? & V_269 :
& V_270 ,
V_266 , V_257 ) ;
V_267:
...
static int
F_144 ( struct V_2 * V_2 , struct V_271 * V_272 ,
int V_266 , struct V_88 * V_89 )
{
return F_145 ( V_2 , V_272 , V_266 , V_89 ,
F_141 ) ;
}
static struct V_273 *
F_146 ( struct V_2 * V_2 )
{
...
static void
F_147 ( struct V_66 * V_274 )
{
F_148 ( F_149 ( V_274 , struct V_275 ,
V_276 ) ) ;
}
static int F_150 ( struct V_4 * V_277 ,
struct V_13 * V_14 ,
const struct V_278 * args )
{
struct V_1 * V_125 = & V_277 -> V_7 ;
T_3 * V_279 ;
int V_132 = 0 , V_41 = 0 ;
V_279 = F_151 ( V_14 , 4 ) ;
if ( F_11 ( ! V_279 ) )
...
V_41 = F_152 ( V_277 , V_14 , & V_132 , & args -> V_42 ) ;
F_44 ( & V_125 -> V_71 -> V_84 ) ;
* V_279 = F_153 ( V_132 ) ;
return V_41 ;
}
static void F_154 ( struct V_4 * V_277 ,
struct V_13 * V_14 ,
const struct V_278 * args )
{
T_3 * V_16 ;
...
static struct V_66 *
F_156 ( struct V_150 * V_281 ,
struct V_282 * V_283 , T_1 V_3 )
{
struct V_275 * V_284 ;
V_284 = F_157 ( V_281 , V_283 , V_3 ) ;
if ( ! V_284 )
return NULL ;
return & V_284 -> V_276 ;
}
static void
F_158 ( struct V_1 * V_8 ,
struct V_13 * V_14 ,
const struct V_278 * args )
{
struct V_4 * V_277 = F_8 ( V_8 ) ;
T_3 * V_279 ;
F_12 ( L_31 , V_19 ) ;
V_279 = F_151 ( V_14 , 4 ) ;
F_159 ( ! V_279 ) ;
if ( F_150 ( V_277 , V_14 , args ) )
goto V_192;
F_154 ( V_277 , V_14 , args ) ;
V_192:
* V_279 = F_153 ( ( V_14 -> V_16 - V_279 - 1 ) * 4 ) ;
F_12 ( L_32 , V_19 ) ;
}
