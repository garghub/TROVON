...
unsigned long V_31 ;
T_3 V_32 = 0 ;
int V_33 = sizeof( struct V_1 ) + sizeof( struct V_4 ) ;
struct V_1 * V_2 = V_34 ;
struct V_16 V_17 ;
if ( V_14 > ( V_35 - V_33 ) ) {
F_13 ( L_4 ) ;
...
V_37:
F_14 ( & V_38 ) ;
memset ( V_2 , 0 , V_35 - sizeof( struct V_4 ) ) ;
memcpy ( V_2 -> V_27 , V_27 , V_39 ) ;
V_2 -> V_40 = V_41 ;
V_2 -> V_28 = V_28 ;
V_2 -> V_12 = V_42 ++ ;
V_2 -> V_19 = V_19 & V_43 ;
