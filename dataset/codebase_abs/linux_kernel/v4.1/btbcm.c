...
int F_11 ( struct V_1 * V_2 , const T_1 * V_15 )
{
struct V_5 * V_6 ;
int V_9 ;
V_6 = F_2 ( V_2 , 0xfc01 , 6 , V_15 , V_8 ) ;
if ( F_3 ( V_6 ) ) {
V_9 = F_4 ( V_6 ) ;
F_5 ( L_5 ,
V_2 -> V_10 , V_9 ) ;
...
int F_12 ( struct V_1 * V_2 , const char * V_19 )
{
...
T_4 V_25 ;
int V_9 ;
V_9 = F_13 ( & V_22 , V_19 , & V_2 -> V_26 ) ;
if ( V_9 < 0 ) {
F_9 ( L_6 , V_2 -> V_10 , V_19 ) ;
return V_9 ;
}
...
V_24 -= V_21 -> V_30 ;
V_25 = F_15 ( V_21 -> V_25 ) ;
V_6 = F_2 ( V_2 , V_25 , V_21 -> V_30 , V_29 ,
V_8 ) ;
if ( F_3 ( V_6 ) ) {
V_9 = F_4 ( V_6 ) ;
F_5 ( L_9 ,
...
static struct V_5 * F_21 ( struct V_1 * V_2 )
{
struct V_5 * V_6 ;
...
if ( F_3 ( V_6 ) )
return F_4 ( V_6 ) ;
F_9 ( L_17 , V_2 -> V_10 , V_6 -> V_13 [ 1 ] ) ;
F_6 ( V_6 ) ;
switch ( ( V_37 & 0xf000 ) >> 12 ) {
case 0 :
for ( V_42 = 0 ; V_45 [ V_42 ] . V_10 ; V_42 ++ ) {
if ( V_36 == V_45 [ V_42 ] . V_36 ) {
V_40 = V_45 [ V_42 ] . V_10 ;
break;
}
}
snprintf ( V_35 , sizeof( V_35 ) , L_18 ,
V_40 ? : L_19 ) ;
break;
case 1 :
case 2 :
...
if ( F_3 ( V_6 ) )
return F_4 ( V_6 ) ;
V_39 = F_23 ( V_6 -> V_13 + 1 ) ;
V_38 = F_23 ( V_6 -> V_13 + 3 ) ;
F_6 ( V_6 ) ;
for ( V_42 = 0 ; V_46 [ V_42 ] . V_10 ; V_42 ++ ) {
if ( V_36 == V_46 [ V_42 ] . V_36 ) {
V_40 = V_46 [ V_42 ] . V_10 ;
break;
}
}
