...
case V_86 :
F_49 ( V_11 , V_27 ,
V_117 | V_121 | V_122 , V_120 ) ;
break;
case V_109 :
F_49 ( V_11 , V_27 ,
V_117 | V_123 | V_124 , V_120 ) ;
break;
case V_110 :
F_49 ( V_11 , V_27 ,
V_117 | V_123 | V_125 , V_120 ) ;
break;
case V_111 :
F_49 ( V_11 , V_27 ,
V_117 | V_123 | V_126 , V_120 ) ;
break;
case V_127 :
F_49 ( V_11 , V_27 ,
V_128 | V_129 | V_130 , V_120 ) ;
break;
case V_131 :
F_49 ( V_11 , V_27 ,
V_128 | V_132 | V_133 , V_120 ) ;
break;
default:
F_26 ( V_11 , L_7 , V_73 -> V_2 ) ;
break;
}
F_49 ( V_11 , V_27 , V_134 , V_135 ) ;
if ( V_11 -> V_136 != V_137 )
F_14 ( V_11 , V_27 ,
V_138 | V_139 ) ;
}
...
{
F_19 ( V_11 , V_141 , V_142 ) ;
F_14 ( V_11 , V_143 , V_142 ) ;
}
static void F_52 ( struct V_10 * V_11 )
{
F_16 ( V_11 , V_143 , V_142 ) ;
}
static void F_53 ( struct V_10 * V_11 )
{
unsigned long V_23 ;
F_30 ( & V_11 -> V_59 , V_23 ) ;
F_16 ( V_11 , V_52 , V_144 ) ;
F_16 ( V_11 , V_27 , V_28 ) ;
F_49 ( V_11 , V_38 , 2 , V_145 ) ;
F_34 ( & V_11 -> V_59 , V_23 ) ;
}
...
unsigned long V_23 ;
F_30 ( & V_11 -> V_59 , V_23 ) ;
F_14 ( V_11 , V_52 , V_144 ) ;
V_11 -> V_150 ( V_11 ) ;
F_34 ( & V_11 -> V_59 , V_23 ) ;
}
static int F_58 ( struct V_10 * V_11 )
{
return F_59 ( V_11 , V_151 , V_152 , 0 ) ;
}
...
V_156 . V_157 = V_158 ;
V_156 . V_159 = V_160 ;
return F_59 ( V_11 , V_151 , V_161 , & V_156 ) ;
}
static int F_64 ( struct V_10 * V_11 )
{
struct V_162 V_163 ;
int V_148 ;
F_65 ( & V_163 , & V_11 -> V_16 , V_11 -> V_164 ) ;
V_148 = F_59 ( V_11 , V_151 , V_165 , 0 ) ;
if ( V_148 == 0 )
V_148 = F_59 ( V_11 , V_166 , V_167 , & V_163 ) ;
V_148 += F_63 ( V_11 ) ;
return V_148 ;
}
...
int V_148 ;
unsigned long V_23 ;
if ( V_11 -> V_168 == V_169 && V_11 -> V_22 == 0 &&
F_23 ( V_11 , 0 ) )
return - V_48 ;
if ( F_9 ( V_11 ) ) {
F_64 ( V_11 ) ;
...
const struct V_173 * V_73 , unsigned int * V_22 ,
unsigned int * V_174 , unsigned int V_175 [] ,
void * V_176 [] )
{
struct V_10 * V_11 = F_68 ( V_172 ) ;
int V_177 = ( V_11 -> V_168 == V_178 ) ? 3 : 2 ;
V_175 [ 0 ] = V_11 -> V_16 . V_17 ;
* V_174 = 1 ;
if ( * V_22 < V_177 )
* V_22 = V_177 ;
if ( V_11 -> V_168 == V_178 )
V_176 [ 0 ] = V_11 -> V_179 ;
else if ( V_11 -> V_168 == V_180 )
V_176 [ 0 ] = V_11 -> V_181 ;
return 0 ;
}
static void F_69 ( struct V_7 * V_8 )
{
struct V_6 * V_182 = F_2 ( V_8 ) ;
struct V_10 * V_11 = F_68 ( V_8 -> V_171 ) ;
unsigned long V_23 ;
int V_183 ;
F_30 ( & V_11 -> V_59 , V_23 ) ;
V_183 = ( V_11 -> V_61 == V_184 ) && ! F_31 ( & V_11 -> V_63 ) ;
F_70 ( & V_182 -> V_67 , & V_11 -> V_63 ) ;
...
static int F_71 ( struct V_171 * V_172 , unsigned int V_185 )
{
struct V_10 * V_11 = F_68 ( V_172 ) ;
unsigned int V_12 ;
if ( V_11 -> V_61 != V_146 ) {
...
V_11 -> V_18 = 0 ;
if ( V_11 -> V_168 != V_169 && F_31 ( & V_11 -> V_63 ) ) {
V_11 -> V_61 = V_184 ;
return 0 ;
}
...
struct V_6 * V_182 = F_2 ( V_8 ) ;
struct V_10 * V_11 = F_68 ( V_8 -> V_171 ) ;
int V_188 = V_11 -> V_16 . V_17 / V_189 + 1 ;
V_182 -> V_190 = F_24 ( V_11 -> V_45 ,
V_188 * sizeof( struct V_96 ) ,
& V_182 -> V_93 , V_47 ) ;
if ( V_182 -> V_190 == NULL ) {
F_26 ( V_11 , L_11 ) ;
return - V_48 ;
...
{
struct V_6 * V_182 = F_2 ( V_8 ) ;
struct V_191 * V_191 = F_76 ( V_8 , 0 ) ;
struct V_96 * V_192 = V_182 -> V_190 ;
struct V_193 * V_194 ;
int V_3 ;
F_77 (sg_table->sgl, sg, sg_table->nents, i) {
V_192 -> V_195 = F_78 ( V_194 ) ;
V_192 -> V_196 = F_79 ( V_194 ) ;
V_192 ++ ;
}
return 0 ;
}
...
struct V_6 * V_182 = F_2 ( V_8 ) ;
int V_188 = V_11 -> V_16 . V_17 / V_189 + 1 ;
F_25 ( V_11 -> V_45 , V_188 * sizeof( struct V_96 ) ,
V_182 -> V_190 , V_182 -> V_93 ) ;
}
static int F_81 ( struct V_10 * V_11 )
{
struct V_171 * V_172 = & V_11 -> V_197 ;
memset ( V_172 , 0 , sizeof( * V_172 ) ) ;
V_172 -> type = V_198 ;
V_172 -> V_199 = V_11 ;
V_172 -> V_200 = & V_11 -> V_153 ;
F_72 ( & V_11 -> V_63 ) ;
switch ( V_11 -> V_168 ) {
case V_178 :
#ifdef F_82
V_172 -> V_201 = & V_202 ;
V_172 -> V_203 = & V_204 ;
V_172 -> V_205 = sizeof( struct V_6 ) ;
V_172 -> V_206 = V_207 | V_208 ;
V_11 -> V_140 = F_42 ;
V_11 -> V_209 = F_43 ;
V_11 -> V_179 = F_83 ( V_11 -> V_45 ) ;
if ( F_84 ( V_11 -> V_179 ) )
...
V_11 -> V_140 = F_45 ;
V_11 -> V_209 = F_46 ;
V_11 -> V_181 = F_87 ( V_11 -> V_45 ) ;
if ( F_84 ( V_11 -> V_181 ) )
return F_85 ( V_11 -> V_181 ) ;
#endif
break;
case V_169 :
#ifdef F_88
...
static int F_95 ( struct V_213 * V_214 , void * V_215 ,
enum V_216 type )
{
struct V_10 * V_11 = V_214 -> V_217 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_96 ( & V_11 -> V_197 , type ) ;
F_62 ( & V_11 -> V_153 ) ;
return V_148 ;
}
static int F_97 ( struct V_213 * V_214 , void * V_215 ,
enum V_216 type )
{
struct V_10 * V_11 = V_214 -> V_217 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_98 ( & V_11 -> V_197 , type ) ;
F_62 ( & V_11 -> V_153 ) ;
return V_148 ;
}
static int F_99 ( struct V_213 * V_214 , void * V_215 ,
struct V_218 * V_219 )
{
struct V_10 * V_11 = V_214 -> V_217 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_100 ( & V_11 -> V_197 , V_219 ) ;
F_62 ( & V_11 -> V_153 ) ;
return V_148 ;
}
static int F_101 ( struct V_213 * V_214 , void * V_215 ,
struct V_220 * V_58 )
{
struct V_10 * V_11 = V_214 -> V_217 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_102 ( & V_11 -> V_197 , V_58 ) ;
F_62 ( & V_11 -> V_153 ) ;
return V_148 ;
}
static int F_103 ( struct V_213 * V_214 , void * V_215 ,
struct V_220 * V_58 )
{
struct V_10 * V_11 = V_214 -> V_217 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_104 ( & V_11 -> V_197 , V_58 ) ;
F_62 ( & V_11 -> V_153 ) ;
return V_148 ;
}
static int F_105 ( struct V_213 * V_214 , void * V_215 ,
struct V_220 * V_58 )
{
struct V_10 * V_11 = V_214 -> V_217 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_106 ( & V_11 -> V_197 , V_58 , V_214 -> V_221 & V_222 ) ;
F_62 ( & V_11 -> V_153 ) ;
return V_148 ;
}
static int F_107 ( struct V_213 * V_213 , void * V_215 ,
struct V_223 * V_224 )
{
...
V_224 -> V_227 = V_228 |
V_229 | V_230 ;
V_224 -> V_231 = V_224 -> V_227 | V_232 ;
return 0 ;
}
static int F_108 ( struct V_213 * V_214 ,
void * V_215 , struct V_233 * V_73 )
{
if ( V_73 -> V_234 >= V_4 )
return - V_186 ;
F_109 ( V_73 -> V_235 , V_5 [ V_73 -> V_234 ] . V_192 ,
sizeof( V_73 -> V_235 ) ) ;
V_73 -> V_2 = V_5 [ V_73 -> V_234 ] . V_2 ;
return 0 ;
}
static int F_110 ( struct V_213 * V_214 , void * V_215 ,
struct V_173 * V_73 )
{
...
V_70 = F_1 ( V_236 -> V_2 ) ;
V_236 -> V_2 = V_70 -> V_2 ;
F_65 ( & V_163 , V_236 , V_70 -> V_164 ) ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_59 ( V_11 , V_166 , V_237 , & V_163 ) ;
F_62 ( & V_11 -> V_153 ) ;
F_111 ( V_236 , & V_163 ) ;
switch ( V_70 -> V_2 ) {
case V_85 :
...
static int F_112 ( struct V_213 * V_214 , void * V_215 ,
struct V_173 * V_73 )
{
struct V_10 * V_11 = V_215 ;
struct V_1 * V_70 ;
int V_148 ;
if ( V_11 -> V_61 != V_146 || V_11 -> V_197 . V_239 > 0 )
return - V_240 ;
V_70 = F_1 ( V_73 -> V_73 . V_236 . V_2 ) ;
V_148 = F_110 ( V_214 , V_215 , V_73 ) ;
if ( V_148 )
return V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_11 -> V_16 = V_73 -> V_73 . V_236 ;
V_11 -> V_164 = V_70 -> V_164 ;
if ( V_11 -> V_168 == V_169 ) {
V_148 = F_36 ( V_11 ) ;
if ( V_148 )
goto V_241;
...
static int F_115 ( struct V_213 * V_214 , void * V_215 , unsigned int * V_3 )
{
* V_3 = 0 ;
return 0 ;
}
...
static int F_117 ( struct V_213 * V_214 , void * V_215 , T_4 V_248 )
{
return 0 ;
}
static int F_118 ( struct V_213 * V_214 , void * V_215 , T_4 * V_248 )
{
* V_248 = V_249 ;
return 0 ;
}
static int F_119 ( struct V_213 * V_214 , void * V_215 ,
struct V_250 * V_251 )
{
struct V_10 * V_11 = V_215 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_59 ( V_11 , V_166 , V_252 , V_251 ) ;
F_62 ( & V_11 -> V_153 ) ;
...
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_59 ( V_11 , V_166 , V_256 , V_251 ) ;
F_62 ( & V_11 -> V_153 ) ;
V_251 -> V_253 . V_254 . V_255 = V_43 ;
return V_148 ;
}
...
int V_148 ;
V_70 = F_1 ( V_175 -> V_262 ) ;
if ( V_70 -> V_2 != V_175 -> V_262 )
return - V_186 ;
V_259 . V_263 = V_70 -> V_164 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_59 ( V_11 , V_264 , V_265 , NULL , & V_259 ) ;
F_62 ( & V_11 -> V_153 ) ;
if ( V_148 )
return V_148 ;
if ( V_259 . V_266 == V_259 . V_267 &&
V_259 . V_268 == V_259 . V_269 ) {
V_175 -> type = V_270 ;
V_175 -> V_271 . V_76 = V_259 . V_266 ;
V_175 -> V_271 . V_77 = V_259 . V_268 ;
return 0 ;
}
V_175 -> type = V_272 ;
V_175 -> V_273 . V_266 = V_259 . V_266 ;
V_175 -> V_273 . V_267 = V_259 . V_267 ;
V_175 -> V_273 . V_268 = V_259 . V_268 ;
V_175 -> V_273 . V_269 = V_259 . V_269 ;
V_175 -> V_273 . V_274 = 1 ;
V_175 -> V_273 . V_275 = 1 ;
return 0 ;
}
...
int V_148 ;
V_70 = F_1 ( V_277 -> V_262 ) ;
if ( V_70 -> V_2 != V_277 -> V_262 )
return - V_186 ;
V_279 . V_263 = V_70 -> V_164 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_59 ( V_11 , V_264 , V_280 , NULL , & V_279 ) ;
F_62 ( & V_11 -> V_153 ) ;
if ( V_148 )
return V_148 ;
V_277 -> type = V_281 ;
V_277 -> V_271 = V_279 . V_277 ;
return 0 ;
}
static int F_123 ( struct V_213 * V_213 , void * V_215 ,
struct V_282 * V_283 )
{
struct V_10 * V_11 = V_215 ;
if ( V_283 -> V_283 > V_11 -> V_284 - 4 )
return - V_186 ;
V_283 -> V_285 = F_124 ( V_11 , V_283 -> V_283 ) ;
V_283 -> V_286 = 4 ;
return 0 ;
}
static int F_125 ( struct V_213 * V_213 , void * V_215 ,
const struct V_282 * V_283 )
{
struct V_10 * V_11 = V_215 ;
if ( V_283 -> V_283 > V_11 -> V_284 - 4 )
return - V_186 ;
F_19 ( V_11 , V_283 -> V_283 , V_283 -> V_285 ) ;
return 0 ;
}
static int F_126 ( struct V_213 * V_214 )
{
struct V_10 * V_11 = F_127 ( V_214 ) ;
int V_148 = 0 ;
V_214 -> V_217 = V_11 ;
V_11 -> V_64 . V_287 = 0 ;
V_11 -> V_64 . V_65 = 0 ;
...
static int F_128 ( struct V_213 * V_214 )
{
struct V_10 * V_11 = V_214 -> V_217 ;
F_18 ( V_11 , L_14 ,
V_11 -> V_64 . V_287 , V_11 -> V_64 . V_65 ,
V_11 -> V_64 . V_66 ) ;
F_61 ( & V_11 -> V_153 ) ;
( V_11 -> V_288 ) -- ;
if ( V_11 -> V_288 == 0 ) {
...
F_22 ( V_11 ) ;
F_57 ( V_11 ) ;
if ( V_11 -> V_168 == V_169 && V_289 )
F_27 ( V_11 ) ;
}
F_62 ( & V_11 -> V_153 ) ;
return 0 ;
}
static T_5 F_129 ( struct V_213 * V_214 ,
char T_6 * V_290 , T_7 V_291 , T_8 * V_292 )
{
struct V_10 * V_11 = V_214 -> V_217 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_130 ( & V_11 -> V_197 , V_290 , V_291 , V_292 ,
V_214 -> V_221 & V_222 ) ;
F_62 ( & V_11 -> V_153 ) ;
return V_148 ;
}
static unsigned int F_131 ( struct V_213 * V_214 ,
struct V_293 * V_294 )
{
struct V_10 * V_11 = V_214 -> V_217 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_132 ( & V_11 -> V_197 , V_214 , V_294 ) ;
F_62 ( & V_11 -> V_153 ) ;
return V_148 ;
}
static int F_133 ( struct V_213 * V_214 , struct V_295 * V_296 )
{
struct V_10 * V_11 = V_214 -> V_217 ;
int V_148 ;
F_61 ( & V_11 -> V_153 ) ;
V_148 = F_134 ( & V_11 -> V_197 , V_296 ) ;
F_62 ( & V_11 -> V_153 ) ;
return V_148 ;
}
...
int F_136 ( struct V_10 * V_11 , unsigned int V_297 )
{
unsigned int V_12 , V_298 = 0 ;
F_19 ( V_11 , V_141 , V_142 ) ;
for ( V_12 = 0 ; V_12 < V_11 -> V_22 ; V_12 ++ )
if ( V_297 & ( V_299 << V_12 ) &&
...
V_148 = F_140 ( V_11 -> V_45 , & V_11 -> V_308 ) ;
if ( V_148 )
return V_148 ;
F_141 ( & V_11 -> V_153 ) ;
V_11 -> V_61 = V_154 ;
...
F_72 ( & V_11 -> V_63 ) ;
F_53 ( V_11 ) ;
V_306 . V_311 = V_11 -> V_311 ;
V_306 . V_312 = V_11 -> V_312 ;
V_11 -> V_313 = V_303 . V_304 ;
V_11 -> V_314 = F_142 ( & V_11 -> V_308 ,
V_11 -> V_315 , & V_303 , NULL ) ;
if ( V_11 -> V_314 == NULL ) {
V_148 = - V_316 ;
goto V_317;
}
...
if ( V_148 )
goto V_317;
V_148 = F_143 ( & V_11 -> V_318 , 10 ) ;
if ( V_148 )
goto V_317;
V_11 -> V_308 . V_318 = & V_11 -> V_318 ;
F_61 ( & V_11 -> V_153 ) ;
V_11 -> V_319 = V_320 ;
V_11 -> V_319 . V_308 = & V_11 -> V_308 ;
F_144 ( & V_11 -> V_319 , V_11 ) ;
V_148 = F_145 ( & V_11 -> V_319 , V_321 , - 1 ) ;
if ( V_148 )
goto V_241;
if ( V_11 -> V_168 == V_169 && ! V_289 ) {
if ( F_23 ( V_11 , 1 ) )
...
F_12 ( V_25 , & V_11 -> V_23 ) ;
if ( V_11 -> V_61 == V_62 ) {
if ( V_11 -> V_168 == V_180 && V_11 -> V_78 [ 0 ] )
