...
static inline void F_323 ( struct V_451 * V_6 )
{
struct V_10 * V_11 =
F_324 ( V_6 , struct V_10 , V_451 ) ;
F_292 ( V_11 ) ;
}
...
if ( V_17 <= 3 )
break;
V_452 = F_329 ( & V_11 -> V_17 , V_17 , V_17 - 1 ) ;
if ( V_452 == V_17 )
return;
}
F_70 ( & V_11 -> V_352 ) ;
