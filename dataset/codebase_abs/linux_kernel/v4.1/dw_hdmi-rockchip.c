...
static int F_17 ( struct V_32 * V_5 , struct V_32 * V_33 ,
void * V_34 )
{
struct V_35 * V_36 = F_18 ( V_5 ) ;
...
if ( ! V_36 -> V_5 . V_6 )
return - V_47 ;
V_2 = F_19 ( & V_36 -> V_5 , sizeof( * V_2 ) , V_48 ) ;
if ( ! V_2 )
return - V_49 ;
V_40 = F_20 ( V_50 , V_36 -> V_5 . V_6 ) ;
V_38 = V_40 -> V_34 ;
V_2 -> V_5 = & V_36 -> V_5 ;
V_23 = & V_2 -> V_23 ;
V_45 = F_21 ( V_36 , 0 ) ;
if ( V_45 < 0 )
return V_45 ;
V_44 = F_22 ( V_36 , V_51 , 0 ) ;
if ( ! V_44 )
return - V_52 ;
F_23 ( V_36 , V_2 ) ;
V_23 -> V_53 = F_24 ( V_42 , V_5 -> V_6 ) ;
if ( V_23 -> V_53 == 0 )
return - V_54 ;
V_46 = F_1 ( V_2 ) ;
if ( V_46 ) {
...
F_26 ( V_42 , V_23 , & V_56 ,
V_57 ) ;
return F_27 ( V_5 , V_33 , V_34 , V_23 , V_44 , V_45 , V_38 ) ;
}
static void F_28 ( struct V_32 * V_5 , struct V_32 * V_33 ,
void * V_34 )
{
return F_29 ( V_5 , V_33 , V_34 ) ;
}
static int F_30 ( struct V_35 * V_36 )
{
return F_31 ( & V_36 -> V_5 , & V_58 ) ;
}
