...
static int F_54 ( struct V_1 * V_2 , struct V_165 * V_166 ,
T_5 V_17 )
{
struct V_2 * V_12 = V_2 -> V_12 ;
struct V_13 * V_14 = F_6 ( V_12 ) -> V_14 ;
...
return - V_81 ;
F_12 ( V_12 ) ;
V_18 = F_56 ( V_12 , V_166 -> V_167 ) ;
F_18 ( V_12 ) ;
if ( V_18 )
return V_18 ;
F_57 ( V_14 ) ;
V_18 = F_58 ( V_14 , V_166 , V_17 ) ;
F_59 ( V_14 ) ;
return V_18 ;
}
static int F_60 ( struct V_1 * V_2 , struct V_165 * V_166 ,
T_5 V_17 , int V_42 )
{
struct V_2 * V_12 = V_2 -> V_12 ;
...
F_18 ( V_12 ) ;
if ( V_2 -> type == V_57 )
V_18 = F_63 ( V_2 , V_166 , V_17 , V_42 ) ;
else
V_18 = F_64 ( V_2 , V_166 , V_17 , V_42 ) ;
if ( V_170 -> V_14 -> V_45 != V_59 )
return V_18 ;
F_12 ( V_12 ) ;
if ( ! F_41 ( V_171 , & V_170 -> V_14 -> V_172 ) )
goto V_28;
if ( V_170 -> V_173 ) {
if ( ! F_65 ( V_12 , V_170 -> V_173 ) )
V_170 -> V_173 = NULL ;
else
goto V_28;
}
if ( F_66 ( & V_12 -> V_174 ) <= V_12 -> V_175 >> 1 )
F_67 ( V_170 -> V_14 , 0 ) ;
V_28:
F_18 ( V_12 ) ;
return V_18 ;
...
static int F_79 ( struct V_1 * V_2 , int V_182 )
{
struct V_2 * V_12 = V_2 -> V_12 ;
struct V_13 * V_14 ;
struct V_150 * V_118 ;
...
static void F_86 ( struct V_2 * V_192 )
{
struct V_2 * V_12 ;
F_7 ( L_8 , V_192 ,
F_70 ( V_192 -> V_25 ) ) ;
...
V_12 = F_90 ( F_91 ( V_192 ) , NULL , V_195 ,
V_196 ) ;
if ( ! V_12 ) {
F_18 ( V_192 ) ;
return NULL ;
...
static int F_95 ( struct V_13 * V_14 , struct V_197 * V_198 )
{
...
V_18 = F_65 ( V_12 , V_198 ) ;
if ( V_18 < 0 && V_14 -> V_45 == V_59 ) {
F_6 ( V_12 ) -> V_173 = V_198 ;
F_67 ( V_14 , 1 ) ;
V_18 = 0 ;
}
V_28:
...
static struct V_197 * F_100 ( struct V_13 * V_14 ,
unsigned long V_201 ,
...
int V_18 ;
F_59 ( V_14 ) ;
V_198 = F_101 ( V_12 , V_201 + V_17 , V_202 , & V_18 ) ;
F_57 ( V_14 ) ;
if ( ! V_198 )
return F_102 ( V_18 ) ;
V_198 -> V_203 = V_12 -> V_204 ;
F_103 ( V_198 ) -> V_205 . V_14 = V_14 ;
return V_198 ;
}
...
F_71 ( F_6 ( V_12 ) -> V_14 ) ;
if ( F_6 ( V_12 ) -> V_173 ) {
F_112 ( F_6 ( V_12 ) -> V_173 ) ;
F_6 ( V_12 ) -> V_173 = NULL ;
}
F_113 ( & V_12 -> V_207 ) ;
F_113 ( & V_12 -> V_208 ) ;
}
static void F_114 ( struct V_197 * V_198 , void * V_209 ,
int * V_210 )
{
F_115 ( struct V_15 * , V_16 , V_209 ) ;
memset ( V_16 , 0 , sizeof( struct V_15 ) ) ;
V_16 -> V_211 = V_20 ;
V_16 -> V_22 = F_103 ( V_198 ) -> V_205 . V_5 ;
F_17 ( & V_16 -> V_30 , & F_103 ( V_198 ) -> V_205 . V_212 ) ;
* V_210 = sizeof( struct V_15 ) ;
}
static void F_93 ( struct V_2 * V_12 , struct V_2 * V_192 )
{
struct V_13 * V_14 = F_6 ( V_12 ) -> V_14 ;
F_7 ( L_1 , V_12 ) ;
if ( V_192 ) {
struct V_13 * V_213 = F_6 ( V_192 ) -> V_14 ;
V_12 -> V_55 = V_192 -> V_55 ;
F_43 ( V_12 ) -> V_42 = F_43 ( V_192 ) -> V_42 ;
...
static struct V_2 * F_90 ( struct V_222 * V_222 , struct V_1 * V_2 ,
int V_223 , T_6 V_224 )
{
struct V_2 * V_12 ;
struct V_13 * V_14 ;
V_12 = F_118 ( V_222 , V_225 , V_224 , & V_226 ) ;
if ( ! V_12 )
return NULL ;
F_119 ( V_2 , V_12 ) ;
F_120 ( & F_43 ( V_12 ) -> V_227 ) ;
V_12 -> V_228 = F_111 ;
V_12 -> V_206 = V_229 ;
F_121 ( V_12 , V_176 ) ;
V_12 -> V_230 = V_223 ;
...
static int F_125 ( struct V_222 * V_222 , struct V_1 * V_2 , int V_231 ,
int V_232 )
{
struct V_2 * V_12 ;
F_7 ( L_12 , V_2 ) ;
...
return - V_163 ;
V_2 -> V_3 = & V_4 ;
V_12 = F_90 ( V_222 , V_2 , V_231 , V_196 ) ;
if ( ! V_12 )
return - V_199 ;
F_93 ( V_12 , NULL ) ;
F_126 ( & V_191 , V_12 ) ;
...
if ( V_18 < 0 )
return V_18 ;
V_18 = F_130 ( V_195 , & V_236 ) ;
if ( V_18 < 0 ) {
F_131 ( L_13 ) ;
goto error;
}
V_18 = F_132 ( & V_237 , L_14 , & V_191 ,
NULL ) ;
if ( V_18 < 0 ) {
F_131 ( L_15 ) ;
F_133 ( V_195 ) ;
