...
struct V_1 * F_40 ( struct V_40 * V_41 ,
struct V_8 * V_9 ,
struct V_14 * V_15 ,
int V_42 )
{
...
F_14 ( & V_55 -> V_34 -> V_24 ) ;
F_19 ( & V_55 -> V_24 , V_28 ) ;
F_41 ( & V_55 -> V_34 -> V_26 , & V_55 -> V_25 ) ;
F_16 ( & V_55 -> V_24 ) ;
F_16 ( & V_55 -> V_34 -> V_24 ) ;
F_16 ( & V_15 -> V_23 ) ;
return V_55 ;
}
int F_42 ( struct V_1 * V_1 , int V_57 )
{
...
V_63 . V_64 . V_65 = V_15 -> V_66 ;
V_63 . V_64 . type = V_67 ;
if ( ( V_1 = F_40 ( V_41 , V_9 , V_15 , 0 ) ) == NULL )
return - V_60 ;
V_63 . V_68 = V_1 -> V_69 . V_68 ;
memcpy ( V_63 . V_70 , V_1 -> V_69 . V_70 , V_63 . V_68 ) ;
V_63 . V_70 [ V_63 . V_68 ] = '\0' ;
F_17 ( V_1 ) ;
if ( F_47 ( V_62 , & V_63 , sizeof( struct V_61 ) ) )
V_30 = - V_71 ;
F_14 ( & V_15 -> V_46 ) ;
V_5 = F_2 ( V_1 ) ;
V_5 -> V_6 = V_7 ;
...
int F_49 ( struct V_40 * V_41 , struct V_8 * V_9 ,
struct V_14 * V_15 , int V_72 )
{
struct V_1 * V_1 ;
int V_30 = - V_60 ;
if ( F_50 ( V_15 -> type ) )
V_1 = F_32 ( V_41 , V_9 , V_15 , V_72 ) ;
else
V_1 = F_40 ( V_41 , V_9 , V_15 , V_72 ) ;
if ( V_1 ) {
struct V_4 * V_5 = F_2 ( V_1 ) ;
V_30 = F_43 ( V_15 , V_1 , V_73 ) ;
F_14 ( & V_15 -> V_46 ) ;
V_5 -> V_6 = V_7 ;
V_5 -> V_47 &= ~ V_51 ;
F_48 ( & V_5 -> V_52 ) ;
...
int F_51 ( struct V_40 * V_41 , struct V_8 * V_9 ,
struct V_14 * V_15 , int T_1 * V_74 )
{
int V_3 = 0 ;
if ( V_74 && F_52 ( V_3 , V_74 ) )
return - V_71 ;
return F_49 ( V_41 , V_9 , V_15 , V_3 ) ;
}
