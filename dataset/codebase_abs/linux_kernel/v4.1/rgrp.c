...
int F_138 ( struct V_92 * V_93 , struct V_234 * V_235 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
...
V_306 ) ) ||
( V_267 == 0 && V_235 -> V_240 > V_36 -> V_38 . V_22 -> V_109 ) )
goto V_304;
if ( V_75 -> V_188 . V_189 )
F_91 ( V_36 -> V_38 . V_22 ) ;
if ( ! F_47 ( V_36 ) )
...
( V_267 == 2 && V_235 -> V_308 &&
V_36 -> V_38 . V_22 -> V_187 >= V_235 -> V_308 ) ) {
V_93 -> V_298 = V_36 -> V_38 . V_22 ;
V_235 -> V_309 = V_93 -> V_298 -> V_187 ;
return 0 ;
}
V_307:
...
static void F_142 ( const struct V_1 * V_2 , bool V_311 ,
unsigned int * V_59 )
{
struct V_1 V_130 = { . V_22 = V_2 -> V_22 , } ;
const unsigned int V_312 = * V_59 ;
T_2 V_44 ;
int V_218 ;
* V_59 = 1 ;
V_44 = F_12 ( V_2 ) ;
F_111 ( V_2 -> V_22 -> V_116 , F_2 ( V_2 ) -> V_17 ) ;
F_1 ( V_2 , true , V_311 ? V_313 : V_314 ) ;
V_44 ++ ;
while ( * V_59 < V_312 ) {
...
F_1 ( & V_130 , true , V_314 ) ;
( * V_59 ) ++ ;
V_44 ++ ;
}
}
static struct V_69 * F_143 ( struct V_74 * V_75 , T_2 V_315 ,
T_4 V_316 , unsigned char V_4 )
{
struct V_1 V_2 ;
struct V_9 * V_10 , * V_317 = NULL ;
V_2 . V_22 = F_27 ( V_75 , V_315 , 1 ) ;
if ( ! V_2 . V_22 ) {
if ( F_144 ( V_75 ) )
F_25 ( V_75 , L_15 , ( unsigned long long ) V_315 ) ;
return NULL ;
}
F_16 ( & V_2 , V_315 ) ;
while ( V_316 -- ) {
...
F_28 ( & V_22 -> V_112 ) ;
for ( V_59 = F_32 ( & V_22 -> V_107 ) ; V_59 ; V_59 = F_34 ( & V_319 -> V_102 ) ) {
V_319 = F_29 ( V_59 , struct V_35 , V_102 ) ;
F_44 ( V_104 , V_319 ) ;
}
F_30 ( & V_22 -> V_112 ) ;
}
...
V_320 = F_150 ( V_36 -> V_39 , V_34 ) ;
V_36 -> V_39 -= V_320 ;
V_22 -> V_108 -= V_320 ;
F_48 ( V_36 , V_321 ) ;
if ( V_36 -> V_39 && ! V_218 )
goto V_67;
F_151 ( V_322 , & V_36 -> V_239 ) ;
}
F_46 ( V_36 ) ;
}
V_67:
...
const struct V_92 * V_93 , bool V_311 )
{
T_2 V_41 ;
if ( F_47 ( V_93 -> V_98 ) ) {
* V_2 = V_93 -> V_98 -> V_38 ;
...
if ( ! V_311 && F_26 ( V_2 -> V_22 , V_93 -> V_95 ) )
V_41 = V_93 -> V_95 ;
else
V_41 = V_2 -> V_22 -> V_242 + V_2 -> V_22 -> V_46 ;
F_16 ( V_2 , V_41 ) ;
}
int F_153 ( struct V_92 * V_93 , T_2 * V_323 , unsigned int * V_324 ,
bool V_311 , T_2 * V_325 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_194 * V_326 ;
...
if ( error ) {
F_102 ( V_75 , L_19 ,
( unsigned long long ) V_93 -> V_96 , error , * V_324 ,
F_121 ( V_110 , & V_2 . V_22 -> V_78 -> V_111 ) ,
V_2 . V_22 -> V_109 ) ;
goto V_328;
}
F_142 ( & V_2 , V_311 , V_324 ) ;
V_44 = F_12 ( & V_2 ) ;
V_2 . V_22 -> V_242 = V_44 - V_2 . V_22 -> V_46 ;
if ( F_47 ( V_93 -> V_98 ) )
F_148 ( V_93 , & V_2 , * V_324 ) ;
V_327 = * V_324 ;
if ( V_311 )
V_327 -- ;
if ( ! V_311 ) {
V_93 -> V_95 = V_44 + V_327 - 1 ;
error = F_154 ( V_93 , & V_326 ) ;
if ( error == 0 ) {
struct V_329 * V_330 =
(struct V_329 * ) V_326 -> V_18 ;
F_111 ( V_93 -> V_158 , V_326 ) ;
V_330 -> V_331 = V_330 -> V_332 =
F_84 ( V_93 -> V_95 ) ;
F_95 ( V_326 ) ;
}
}
if ( V_2 . V_22 -> V_79 < * V_324 ) {
F_5 ( L_20 , * V_324 ) ;
goto V_328;
}
V_2 . V_22 -> V_79 -= * V_324 ;
...
F_155 ( V_75 , 0 , - ( T_9 ) * V_324 , V_311 ? 1 : 0 ) ;
if ( V_311 )
F_156 ( V_75 , V_44 , * V_324 ) ;
F_157 ( V_93 , * V_324 , V_93 -> V_94 . V_333 , V_93 -> V_94 . V_334 ) ;
V_2 . V_22 -> V_187 -= * V_324 ;
F_158 ( V_93 , V_2 . V_22 , V_44 , * V_324 ,
V_311 ? V_313 : V_314 ) ;
* V_323 = V_44 ;
return 0 ;
V_328:
...
void F_159 ( struct V_92 * V_93 , T_2 V_315 , T_4 V_316 , int V_335 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_69 * V_22 ;
V_22 = F_143 ( V_75 , V_315 , V_316 , V_61 ) ;
if ( ! V_22 )
return;
F_158 ( V_93 , V_22 , V_315 , V_316 , V_61 ) ;
V_22 -> V_79 += V_316 ;
V_22 -> V_149 &= ~ V_229 ;
...
if ( V_335 || V_93 -> V_336 )
F_160 ( V_93 , V_315 , V_316 ) ;
}
void F_161 ( struct V_92 * V_93 , T_2 V_315 , T_4 V_316 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
F_159 ( V_93 , V_315 , V_316 , 1 ) ;
F_155 ( V_75 , 0 , + V_316 , 0 ) ;
F_157 ( V_93 , - ( T_9 ) V_316 , V_93 -> V_94 . V_333 , V_93 -> V_94 . V_334 ) ;
}
...
struct V_69 * V_22 ;
T_2 V_337 = V_93 -> V_96 ;
V_22 = F_143 ( V_75 , V_337 , 1 , V_182 ) ;
if ( ! V_22 )
return;
F_158 ( V_93 , V_22 , V_337 , 1 , V_182 ) ;
F_111 ( V_22 -> V_116 , V_22 -> V_78 [ 0 ] . V_17 ) ;
F_82 ( V_22 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_86 ( V_22 -> V_145 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_87 ( V_22 , 1 ) ;
}
static void F_163 ( struct V_69 * V_22 , T_2 V_337 )
{
struct V_74 * V_75 = V_22 -> V_55 ;
struct V_69 * V_338 ;
V_338 = F_143 ( V_75 , V_337 , 1 , V_61 ) ;
if ( ! V_338 )
return;
F_164 ( V_75 , V_22 == V_338 ) ;
if ( ! V_22 -> V_80 )
F_7 ( V_22 ) ;
V_22 -> V_80 -- ;
V_22 -> V_79 ++ ;
...
F_157 ( V_93 , - 1 , V_93 -> V_94 . V_333 , V_93 -> V_94 . V_334 ) ;
F_160 ( V_93 , V_93 -> V_96 , 1 ) ;
}
int F_166 ( struct V_74 * V_75 , T_2 V_339 , unsigned int type )
{
struct V_69 * V_22 ;
struct V_159 V_340 ;
int error = - V_48 ;
V_22 = F_27 ( V_75 , V_339 , 1 ) ;
if ( ! V_22 )
goto V_141;
error = F_79 ( V_22 -> V_116 , V_162 , 0 , & V_340 ) ;
if ( error )
goto V_141;
if ( F_141 ( V_22 , V_339 ) != type )
error = - V_341 ;
F_80 ( & V_340 ) ;
V_141:
return error ;
}
void F_167 ( struct V_92 * V_93 , struct V_342 * V_343 ,
T_2 V_44 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_69 * V_22 ;
...
V_93 -> V_298 = V_22 ;
for ( V_77 = 0 ; V_77 < V_343 -> V_346 ; V_77 ++ )
if ( V_343 -> V_347 [ V_77 ] == V_22 )
return;
if ( V_343 -> V_346 == V_343 -> V_348 ) {
V_344 = V_343 -> V_348 + 10 ;
V_31 = F_62 ( V_344 , sizeof( struct V_69 * ) ,
V_100 | V_318 ) ;
if ( V_343 -> V_347 ) {
memcpy ( V_31 , V_343 -> V_347 ,
V_343 -> V_348 * sizeof( struct V_69 * ) ) ;
F_38 ( V_343 -> V_347 ) ;
}
V_343 -> V_348 = V_344 ;
V_343 -> V_347 = V_31 ;
}
V_343 -> V_347 [ V_343 -> V_346 ++ ] = V_22 ;
}
void F_168 ( struct V_342 * V_343 , unsigned int V_30 )
{
unsigned int V_77 ;
V_343 -> V_345 = F_62 ( V_343 -> V_346 , sizeof( struct V_159 ) ,
V_100 | V_318 ) ;
for ( V_77 = 0 ; V_77 < V_343 -> V_346 ; V_77 ++ )
F_169 ( V_343 -> V_347 [ V_77 ] -> V_116 ,
V_30 , 0 ,
& V_343 -> V_345 [ V_77 ] ) ;
}
void F_170 ( struct V_342 * V_343 )
{
unsigned int V_77 ;
F_38 ( V_343 -> V_347 ) ;
if ( V_343 -> V_345 ) {
for ( V_77 = 0 ; V_77 < V_343 -> V_346 ; V_77 ++ )
F_171 ( & V_343 -> V_345 [ V_77 ] ) ;
F_38 ( V_343 -> V_345 ) ;
V_343 -> V_345 = NULL ;
}
}
