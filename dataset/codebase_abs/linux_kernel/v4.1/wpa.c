...
V_97 = F_41 ( & V_4 -> V_54 . V_132 . V_102 ) ;
F_64 ( V_127 -> V_133 , V_97 ) ;
F_63 ( V_11 , V_78 ) ;
F_69 ( V_4 -> V_54 . V_132 . V_103 , V_78 ,
...
F_64 ( V_127 -> V_133 , V_97 ) ;
F_63 ( V_11 , V_78 ) ;
F_71 ( V_4 -> V_54 . V_132 . V_103 , V_78 ,
V_11 -> V_3 + 24 , V_11 -> V_18 - 24 , V_127 -> V_5 ) ;
return V_20 ;
}
T_4
...
V_127 -> V_131 != sizeof( * V_127 ) - 2 )
return V_51 ;
F_65 ( V_135 , V_127 -> V_133 ) ;
if ( memcmp ( V_135 , V_4 -> V_54 . V_132 . V_105 , 6 ) <= 0 ) {
V_4 -> V_54 . V_132 . V_106 ++ ;
return V_51 ;
}
if ( ! ( V_38 -> V_40 & V_46 ) ) {
F_63 ( V_11 , V_78 ) ;
...
V_4 -> V_54 . V_132 . V_136 ++ ;
return V_51 ;
}
}
memcpy ( V_4 -> V_54 . V_132 . V_105 , V_135 , 6 ) ;
...
V_127 -> V_131 = sizeof( * V_127 ) - 2 ;
V_127 -> V_95 = F_32 ( V_4 -> V_15 . V_50 ) ;
V_97 = F_41 ( & V_4 -> V_54 . V_138 . V_102 ) ;
F_64 ( V_127 -> V_133 , V_97 ) ;
F_63 ( V_11 , V_78 ) ;
V_9 = (struct V_8 * ) V_11 -> V_3 ;
memcpy ( V_137 , V_9 -> V_89 , V_90 ) ;
F_65 ( V_137 + V_90 , V_127 -> V_133 ) ;
