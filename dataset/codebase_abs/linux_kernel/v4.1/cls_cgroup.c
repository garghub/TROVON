...
static bool F_25 ( struct V_3 * V_4 , bool V_46 )
{
struct V_7 * V_8 = F_15 ( V_4 -> V_9 ) ;
if ( ! V_46 )
return false ;
...
static void F_28 ( struct V_3 * V_4 , struct V_48 * V_25 )
{
struct V_7 * V_8 = F_15 ( V_4 -> V_9 ) ;
if ( V_25 -> V_49 < V_25 -> V_50 )
goto V_50;
if ( V_25 -> V_51 ( V_4 , ( unsigned long ) V_8 , V_25 ) < 0 ) {
V_25 -> V_52 = 1 ;
return;
}
V_50:
...
static int F_29 ( struct V_20 * V_20 , struct V_3 * V_4 , unsigned long V_53 ,
struct V_1 * V_2 , struct V_54 * V_31 )
{
struct V_7 * V_8 = F_15 ( V_4 -> V_9 ) ;
struct V_23 * V_55 ;
V_31 -> V_56 = V_8 -> V_17 ;
