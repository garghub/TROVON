...
{
struct V_84 * V_85 = V_3 ;
int V_86 , V_87 = 0 ;
if ( V_85 -> V_88 != - 1 ) {
if ( V_85 -> V_88 != V_89 ||
V_85 -> V_90 < 0 || V_85 -> V_90 > V_91 ) {
V_87 = - V_15 ;
goto V_92;
}
V_86 = F_27 ( V_85 -> V_88 ,
V_85 -> V_90 ) ;
V_2 -> V_86 = F_28 ( V_86 , V_2 -> V_86 ) ;
if ( V_85 -> V_90 >= 1 ) {
V_87 = F_9 ( V_2 , V_5 ) ;
if ( V_87 )
goto V_92;
...
if ( V_85 -> V_93 != - 1 ) {
if ( V_85 -> V_93 != V_2 -> V_19 -> V_94 ||
V_85 -> V_95 < 0 || V_85 -> V_95 >
V_2 -> V_19 -> V_96 ) {
V_87 = - V_15 ;
goto V_92;
}
...
V_85 -> V_88 = V_89 ;
V_85 -> V_90 = V_91 ;
V_85 -> V_93 = V_2 -> V_19 -> V_94 ;
V_85 -> V_95 = V_2 -> V_19 -> V_96 ;
return V_87 ;
}
...
static int F_31 ( char T_1 * V_97 , T_2 * V_98 , const char * V_50 )
{
int V_99 ;
V_99 = strlen ( V_50 ) ;
if ( V_99 > * V_98 )
...
struct V_4 * V_5 )
{
struct F_32 * V_100 = V_3 ;
int V_18 ;
V_100 -> V_101 = V_2 -> V_19 -> V_94 ;
V_100 -> V_102 = V_2 -> V_19 -> V_96 ;
V_100 -> V_103 = V_2 -> V_19 -> V_104 ;
V_18 = F_31 ( V_100 -> V_105 , & V_100 -> V_106 ,
V_2 -> V_19 -> V_105 ) ;
if ( ! V_18 )
V_18 = F_31 ( V_100 -> V_107 , & V_100 -> V_108 ,
V_2 -> V_19 -> V_107 ) ;
if ( ! V_18 )
V_18 = F_31 ( V_100 -> V_109 , & V_100 -> V_110 ,
V_2 -> V_19 -> V_109 ) ;
return V_18 ;
}
static int F_33 ( T_3 V_34 , struct V_4 * V_5 )
{
if ( F_34 ( ( V_34 & V_111 ) && ! F_35 ( V_112 ) ) )
return - V_113 ;
if ( F_34 ( ( V_34 & V_114 ) && ! F_36 ( V_5 ) &&
! V_5 -> V_41 ) )
return - V_113 ;
if ( F_34 ( ( V_34 & V_115 ) && ! V_5 -> V_116 &&
! F_37 ( V_5 ) ) )
return - V_113 ;
if ( F_34 ( ! ( V_34 & V_117 ) &&
F_37 ( V_5 ) ) )
...
long F_38 ( struct V_119 * V_120 ,
unsigned int V_121 , unsigned long V_122 )
{
struct V_4 * V_5 = V_120 -> V_123 ;
struct V_1 * V_2 ;
const struct V_124 * V_125 = NULL ;
T_4 * V_126 ;
unsigned int V_127 = F_39 ( V_121 ) ;
int V_87 = - V_15 ;
char V_128 [ 128 ] ;
char * V_129 = NULL ;
...
if ( V_127 - V_134 >= V_2 -> V_19 -> V_136 )
goto V_137;
V_125 = & V_2 -> V_19 -> V_138 [ V_127 - V_134 ] ;
} else {
if ( V_127 >= V_139 )
goto V_137;
V_125 = & V_140 [ V_127 ] ;
}
V_132 = F_41 ( V_125 -> V_121 ) ;
V_130 = F_41 ( V_121 ) ;
V_131 = F_28 ( V_130 , V_132 ) ;
V_121 = V_125 -> V_121 ;
F_30 ( L_5 ,
F_42 ( V_141 ) ,
( long ) F_43 ( V_5 -> V_96 -> V_142 -> V_143 ) ,
V_5 -> V_41 , V_125 -> V_105 ) ;
V_126 = V_125 -> V_126 ;
if ( F_34 ( ! V_126 ) ) {
F_30 ( L_6 ) ;
V_87 = - V_15 ;
...
V_87 = F_33 ( V_125 -> V_34 , V_5 ) ;
if ( F_34 ( V_87 ) )
goto V_137;
if ( V_121 & ( V_144 | V_145 ) ) {
if ( V_131 <= sizeof( V_128 ) ) {
V_129 = V_128 ;
} else {
V_129 = F_44 ( V_131 , V_21 ) ;
if ( ! V_129 ) {
V_87 = - V_146 ;
goto V_137;
}
...
if ( V_131 > V_130 )
memset ( V_129 + V_130 , 0 , V_131 - V_130 ) ;
}
if ( V_121 & V_144 ) {
if ( F_45 ( V_129 , ( void T_1 * ) V_122 ,
V_130 ) != 0 ) {
V_87 = - V_12 ;
goto V_137;
}
...
bool F_46 ( unsigned int V_127 , unsigned int * V_34 )
{
if ( V_127 >= V_134 && V_127 < V_135 )
return false ;
if ( V_127 >= V_139 )
return false ;
* V_34 = V_140 [ V_127 ] . V_34 ;
return true ;
}
