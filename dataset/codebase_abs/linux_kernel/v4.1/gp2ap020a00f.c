...
if ( V_133 == V_126 ||
V_133 == V_136 ) {
V_134 = F_21 ( ( T_1 * ) & V_110 -> V_135 [ V_132 ] ) ;
F_24 ( V_110 , & V_134 ) ;
F_42 ( V_134 , & V_110 -> V_135 [ V_132 ] ) ;
V_132 += 4 ;
} else {
V_132 += 2 ;
}
}
F_43 ( V_109 , V_110 -> V_135 ,
V_131 -> V_137 ) ;
V_121:
F_44 ( V_109 -> V_106 ) ;
return V_111 ;
}
static V_52 F_45 ( const struct V_138 * V_139 ,
enum V_140 V_141 )
{
switch ( V_139 -> type ) {
case V_113 :
...
struct V_138 const * V_139 , int * V_95 )
{
enum V_61 V_62 ;
int V_16 ;
switch ( V_139 -> V_160 ) {
...
V_16 = F_18 ( V_12 , V_139 -> V_162 , V_95 ) ;
if ( V_16 < 0 )
F_23 ( & V_12 -> V_97 -> V_2 ,
L_10 ) ;
V_16 = F_2 ( V_12 ,
...
V_16 = F_55 ( V_12 , V_139 , V_95 ) ;
break;
}
V_152:
F_48 ( & V_12 -> V_151 ) ;
return V_16 < 0 ? V_16 : V_153 ;
}
...
if ( V_16 < 0 )
goto V_152;
V_12 -> V_135 = F_59 ( V_109 -> V_165 , V_166 ) ;
if ( ! V_12 -> V_135 ) {
V_16 = - V_167 ;
goto V_152;
}
...
static int F_64 ( struct V_168 * V_97 ,
...
return - V_167 ;
V_12 = F_29 ( V_109 ) ;
V_12 -> V_171 = F_66 ( & V_97 -> V_2 , L_12 ) ;
if ( F_67 ( V_12 -> V_171 ) )
return F_68 ( V_12 -> V_171 ) ;
V_16 = F_69 ( V_12 -> V_171 ) ;
if ( V_16 )
return V_16 ;
V_18 = F_70 ( V_97 , & V_172 ) ;
if ( F_67 ( V_18 ) ) {
F_23 ( & V_97 -> V_2 , L_13 ) ;
V_16 = F_68 ( V_18 ) ;
goto V_173;
...
F_73 ( & V_12 -> V_90 ) ;
F_74 ( & V_12 -> V_151 ) ;
V_109 -> V_2 . V_175 = & V_97 -> V_2 ;
V_109 -> V_176 = V_177 ;
V_109 -> V_178 = F_71 ( V_177 ) ;
V_109 -> V_147 = & V_179 ;
V_109 -> V_180 = V_170 -> V_180 ;
V_109 -> V_181 = V_182 ;
V_16 = F_75 ( V_109 , & V_183 ,
& F_39 , & V_184 ) ;
if ( V_16 < 0 )
goto V_173;
...
V_12 -> V_106 -> V_186 = & V_187 ;
V_12 -> V_106 -> V_2 . V_175 = & V_12 -> V_97 -> V_2 ;
...
static int F_83 ( struct V_168 * V_97 )
{
