...
static void
F_80 ( int V_2 , struct V_1 * V_16 , T_1 V_4 , T_4 * V_48 )
{
T_1 V_6 ;
if ( V_16 -> V_49 ) {
...
V_4 = F_38 () ;
if ( V_48 ) {
F_80 ( V_2 , V_16 , V_4 , V_48 ) ;
V_53 = V_16 -> V_52 ;
} else {
if ( V_16 -> V_49 && ! F_81 ( V_2 ) ) {
...
unsigned long V_63 ;
struct V_64 * V_65 = F_77 ( V_66 . V_67 ) ;
T_4 V_68 ;
V_68 = F_90 () ;
do {
V_56 = F_91 ( & V_10 ) ;
