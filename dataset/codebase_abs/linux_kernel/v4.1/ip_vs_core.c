...
static inline bool F_92 ( const struct V_12 * V_13 ,
int V_185 )
{
if ( V_13 -> V_186 )
return false ;
...
static unsigned int
F_93 ( int V_51 , struct V_14 * V_15 , struct V_39 * V_40 ,
...
static unsigned int
F_96 ( unsigned int V_116 , struct V_14 * V_15 , int V_51 )
{
...
if ( V_15 -> V_153 )
return V_107 ;
if ( F_84 ( V_15 -> V_195 != NULL && V_116 == V_196 &&
V_51 == V_140 ) ) {
struct V_197 * V_195 = V_15 -> V_195 ;
struct V_198 * V_199 = F_98 ( V_15 -> V_195 ) ;
...
if ( F_17 ( V_13 ) )
return F_93 ( V_51 , V_15 , V_40 , V_13 , & V_58 , V_116 ) ;
if ( F_50 ( V_36 ) &&
( V_41 -> V_43 == V_5 ||
V_41 -> V_43 == V_4 ||
V_41 -> V_43 == V_6 ) ) {
...
if ( V_87 == NULL )
return V_107 ;
if ( F_101 ( V_36 , V_51 , V_58 . V_43 , & V_58 . V_67 ,
V_87 [ 0 ] ) ) {
if ( ( V_58 . V_43 != V_5 &&
V_58 . V_43 != V_6 )
|| ( ( V_58 . V_43 == V_5
...
static unsigned int
F_102 ( const struct V_204 * V_205 , struct V_14 * V_15 ,
const struct V_206 * V_187 )
{
return F_96 ( V_205 -> V_116 , V_15 , V_140 ) ;
}
static unsigned int
...
const struct V_206 * V_187 )
{
return F_96 ( V_205 -> V_116 , V_15 , V_65 ) ;
}
static unsigned int
...
F_108 ( V_15 ) ;
F_28 ( 12 , L_37 ,
& F_61 ( V_15 ) -> V_67 , & F_61 ( V_15 ) -> V_71 , V_215 ) ;
...
if ( F_107 ( V_15 , V_207 ) == NULL )
goto V_217;
F_108 ( V_15 ) ;
F_28 ( 12 , L_38 ,
& F_61 ( V_15 ) -> V_67 , & F_61 ( V_15 ) -> V_71 ,
type , V_213 , F_111 ( V_210 ) ) ;
F_48 ( V_15 , type , V_213 , V_210 ) ;
F_14 ( V_13 , V_15 ) ;
V_217:
F_112 ( V_15 ) ;
V_150 = V_160 ;
...
return V_107 ;
V_36 = F_7 ( V_15 ) ;
V_40 = F_100 ( V_36 , V_135 . V_43 ) ;
if ( ! V_40 )
return V_107 ;
V_41 = V_40 -> V_41 ;
if ( V_135 . V_144 )
return V_107 ;
F_35 ( 11 , V_65 , V_41 , V_15 , V_222 ,
L_40 ) ;
...
if ( V_185 && ! V_58 . V_144 &&
F_91 ( V_15 , & V_58 ) && V_13 &&
( ( F_84 ( F_51 ( V_19 ) ) && V_13 -> V_17 &&
F_84 ( ! F_39 ( & V_13 -> V_17 -> V_227 ) ) ) ||
F_84 ( F_92 ( V_13 , V_185 ) ) ) ) {
if ( ! F_39 ( & V_13 -> V_228 ) )
F_119 ( V_13 ) ;
F_36 ( V_13 ) ;
V_13 = NULL ;
...
V_224 = F_122 ( 1 , & V_13 -> V_106 ) ;
if ( V_19 -> V_231 & V_232 )
F_123 ( V_36 , V_13 , V_224 ) ;
F_31 ( V_13 ) ;
return V_100 ;
}
static unsigned int
F_124 ( const struct V_204 * V_205 , struct V_14 * V_15 ,
const struct V_206 * V_187 )
{
return F_116 ( V_205 -> V_116 , V_15 , V_140 ) ;
}
static unsigned int
...
const struct V_206 * V_187 )
{
return F_116 ( V_205 -> V_116 , V_15 , V_65 ) ;
}
static unsigned int
...
if ( F_84 ( F_117 ( V_19 ) || ! V_19 -> V_203 ) )
return V_107 ;
return F_106 ( V_15 , & V_233 , V_205 -> V_116 ) ;
}
static unsigned int
...
if ( F_84 ( F_117 ( V_19 ) || ! V_19 -> V_203 ) )
return V_107 ;
return F_114 ( V_15 , & V_233 , V_205 -> V_116 , & V_130 ) ;
}
static int T_8 F_130 ( struct V_36 * V_36 )
{
struct V_18 * V_19 ;
V_19 = F_131 ( V_36 , V_234 ) ;
if ( V_19 == NULL )
return - V_235 ;
V_19 -> V_203 = 0 ;
V_19 -> V_36 = V_36 ;
V_19 -> V_236 = F_39 ( & V_237 ) ;
F_44 ( & V_237 ) ;
V_36 -> V_19 = V_19 ;
if ( F_132 ( V_36 ) < 0 )
goto V_238;
