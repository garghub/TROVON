...
static void F_16 ( struct V_41 * V_30 )
{
...
return F_19 ( NULL , V_3 -> V_9 , & V_46 , V_3 ,
& V_3 -> V_27 ) ;
}
static int T_1 F_20 ( const struct V_41 * V_30 , T_3 V_47 , T_3 V_48 )
{
struct V_2 * V_3 = V_30 -> V_36 ;
struct V_4 * V_5 = V_3 -> V_7 ;
return V_5 -> V_11 ? V_49 : V_50 ;
}
static void T_1 F_21 ( int V_11 , void T_4 * V_10 )
{
F_22 ( V_51 L_3 , V_11 ) ;
if ( F_23 ( V_10 ) ) {
