...
unsigned int V_133 , V_134 , V_27 , V_145 , V_146 , V_147 , V_148 ;
struct V_149 V_150 ;
T_1 V_151 ;
V_134 = F_48 ( V_2 -> V_136 ) ;
if ( V_134 )
return V_134 ;
V_151 = F_3 ( V_2 , V_7 ) ;
if ( ( V_151 & 0x00ffffff ) < 0x00020200 ) {
F_53 ( V_2 -> V_33 . V_34 . V_35 ,
L_11 ,
( V_151 >> 24 ) & 0xff , ( V_151 >> 16 ) & 0xff ,
( V_151 >> 8 ) & 0xff , V_151 & 0xff ) ;
F_50 ( V_2 -> V_136 ) ;
return - V_152 ;
}
if ( V_151 == V_153 ) {
...
V_140 = V_2 -> V_154 / 1000 ;
V_139 = F_54 ( V_2 -> V_136 ) / 1000 ;
V_150 = V_155 [ 0 ] ;
for ( V_133 = 0 ; V_133 < F_10 ( V_155 ) ; V_133 ++ ) {
if ( V_2 -> V_154 <= V_155 [ V_133 ] . V_156 ) {
V_150 = V_155 [ V_133 ] ;
break;
}
}
V_145 = V_157 * V_139 / ( 256 * 16 * V_140 ) ;
V_145 = F_55 (unsigned int, prescale, 1 , 8 ) ;
V_139 /= V_145 ;
V_146 = ( 256 * 16 * V_140 ) / V_139 ;
if ( V_139 < 20000 ) {
V_148 = V_158 ;
} else if ( V_139 < 40000 ) {
V_148 = V_159 ;
} else {
V_148 = ( 64000 / ( ( V_139 / 1000 ) * V_160 ) ) ;
if ( 64000 % ( ( V_139 / 1000 ) * V_160 ) )
V_146 ++ ;
if ( V_148 > V_161 )
V_148 = V_161 ;
V_148 = ( V_148 & V_161 ) << V_162 ;
}
V_27 = V_148 | ( ( V_146 & V_163 ) << V_164 ) | ( V_145 - 1 ) ;
F_1 ( V_2 , V_165 , V_27 ) ;
V_141 = ( 256 * 1000000 ) / ( V_139 * V_146 ) ;
V_147 = 1000000 / ( V_140 * V_141 ) ;
if ( ( 1000000 % ( V_140 * V_141 ) ) >=
( ( V_140 * V_141 ) / 2 ) )
V_147 ++ ;
V_142 = V_150 . V_142 / V_141 ;
if ( V_150 . V_142 % V_141 )
V_142 ++ ;
if ( V_142 > 0 )
V_27 = V_142 - 1 ;
else
...
V_27 = 0 ;
F_1 ( V_2 , V_167 , V_27 ) ;
V_144 = V_150 . V_144 / V_141 ;
if ( V_150 . V_144 % V_141 )
V_144 ++ ;
if ( V_144 > 1 )
V_27 = V_144 - 1 ;
else
...
F_1 ( V_2 , V_168 , V_27 ) ;
V_144 = V_27 ;
V_27 = V_150 . V_169 / V_141 ;
if ( V_27 > 0 )
-- V_27 ;
F_1 ( V_2 , V_170 , V_27 ) ;
V_27 = V_150 . V_171 / V_141 ;
if ( V_27 > 0 )
-- V_27 ;
F_1 ( V_2 , V_172 , V_27 ) ;
F_1 ( V_2 , V_173 , V_27 + V_144 + 2 ) ;
V_27 = V_150 . V_174 / V_141 ;
if ( V_27 > 0 )
-- V_27 ;
F_1 ( V_2 , V_175 , V_27 ) ;
F_1 ( V_2 , V_176 , V_177 ) ;
...
static int F_56 ( struct V_182 * V_183 )
{
struct V_184 * V_185 = V_183 -> V_34 . V_186 ;
struct V_1 * V_2 ;
struct V_187 * V_188 ;
int V_107 , V_134 ;
T_1 V_46 ;
V_2 = F_57 ( & V_183 -> V_34 , sizeof( struct V_1 ) , V_189 ) ;
if ( ! V_2 )
return - V_190 ;
V_188 = F_58 ( V_183 , V_191 , 0 ) ;
V_2 -> V_5 = F_59 ( & V_183 -> V_34 , V_188 ) ;
if ( F_60 ( V_2 -> V_5 ) )
return F_61 ( V_2 -> V_5 ) ;
V_107 = F_62 ( V_183 , 0 ) ;
if ( V_107 < 0 ) {
F_31 ( & V_183 -> V_34 , L_13 ) ;
return V_107 ;
}
V_2 -> V_192 = F_63 ( & V_183 -> V_34 , L_14 ) ;
if ( F_60 ( V_2 -> V_192 ) ) {
F_31 ( & V_183 -> V_34 , L_15 ) ;
return F_61 ( V_2 -> V_192 ) ;
}
V_2 -> V_136 = F_63 ( & V_183 -> V_34 , L_16 ) ;
if ( F_60 ( V_2 -> V_136 ) ) {
F_31 ( & V_183 -> V_34 , L_17 ) ;
return F_61 ( V_2 -> V_136 ) ;
}
V_134 = F_64 ( & V_183 -> V_34 , V_107 , F_36 , 0 ,
V_183 -> V_193 , V_2 ) ;
if ( V_134 ) {
F_31 ( & V_183 -> V_34 , L_18 , V_107 ) ;
return V_134 ;
}
F_65 ( & V_2 -> V_65 ) ;
V_2 -> V_65 . V_194 = F_32 ;
V_2 -> V_65 . V_27 = ( unsigned long ) V_2 ;
V_2 -> V_154 = V_155 [ 0 ] . V_156 ;
if ( ! F_66 ( V_185 , L_19 , & V_46 ) )
V_2 -> V_154 = V_46 ;
F_67 ( & V_2 -> V_33 , V_2 ) ;
V_2 -> V_33 . V_34 . V_35 = & V_183 -> V_34 ;
V_2 -> V_33 . V_34 . V_186 = V_185 ;
V_2 -> V_33 . V_195 = V_196 ;
V_2 -> V_33 . V_197 = & V_198 ;
V_2 -> V_33 . V_199 = 5 ;
V_2 -> V_33 . V_200 = V_183 -> V_201 ;
snprintf ( V_2 -> V_33 . V_193 , sizeof( V_2 -> V_33 . V_193 ) , L_20 ) ;
F_6 ( V_2 , V_70 ) ;
F_68 ( & V_2 -> V_100 ) ;
F_69 ( & V_2 -> V_72 ) ;
F_70 ( V_183 , V_2 ) ;
V_134 = F_48 ( V_2 -> V_192 ) ;
if ( V_134 )
return V_134 ;
V_134 = F_52 ( V_2 ) ;
if ( V_134 )
...
static int F_72 ( struct V_182 * V_34 )
{
...
static int F_75 ( struct V_203 * V_34 )
{
...
static int F_77 ( struct V_203 * V_34 )
{
struct V_1 * V_2 = F_76 ( V_34 ) ;
int V_134 ;
V_134 = F_48 ( V_2 -> V_192 ) ;
