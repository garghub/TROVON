...
break;
case V_290 :
if ( V_2 -> V_47 . V_291 == V_292 ) {
V_48 = F_31 ( F_5 ( V_5 -> V_293 ) ,
V_5 -> V_293 ) ;
if ( V_48 != 0 ) {
F_24 ( V_2 -> V_29 ,
L_12 ,
...
struct V_56 * V_57 = F_20 ( V_2 -> V_29 ) ;
struct V_370 V_371 ;
unsigned long V_58 , V_391 ;
int V_48 , V_88 , V_392 ;
if ( V_390 == V_5 -> V_393 && V_372 == V_5 -> V_394 &&
V_373 == V_5 -> V_395 )
return 0 ;
if ( V_373 == 0 ) {
F_4 ( V_2 -> V_29 , L_25 ) ;
...
V_88 |= V_371 . V_377 << V_401 ;
V_88 |= V_371 . V_379 << V_402 ;
F_6 ( V_2 , V_141 ,
V_403 | V_404 |
V_405 , V_88 ) ;
V_88 = 0 ;
...
( V_371 . V_380 << V_410 ) |
( V_371 . V_384 ) ) ;
F_21 ( V_2 , V_139 , V_371 . V_387 ) ;
F_6 ( V_2 , V_140 ,
V_411 | V_412 ,
( V_371 . V_386 << V_413 ) |
V_371 . V_378 ) ;
F_21 ( V_2 , V_143 , V_371 . V_388 ) ;
V_48 = F_3 ( V_2 , V_137 ) ;
if ( ! ( V_48 & V_396 ) )
F_11 ( V_2 ) ;
F_49 ( & V_5 -> V_414 ) ;
...
static inline struct V_4 * F_52 ( struct V_418 * V_419 )
{
return F_53 ( V_419 , struct V_4 , V_418 ) ;
}
static void F_54 ( struct V_418 * V_419 , unsigned V_420 , int V_38 )
{
struct V_4 * V_5 = F_52 ( V_419 ) ;
F_55 ( V_5 -> V_295 , V_259 + V_420 ,
V_421 , ! ! V_38 << V_422 ) ;
}
static int F_56 ( struct V_418 * V_419 ,
unsigned V_420 , int V_38 )
{
struct V_4 * V_5 = F_52 ( V_419 ) ;
int V_65 ;
V_65 = ( 1 << V_423 ) | ( ! ! V_38 << V_422 ) ;
return F_55 ( V_5 -> V_295 , V_259 + V_420 ,
V_341 | V_424 |
V_421 , V_65 ) ;
}
static int F_57 ( struct V_418 * V_419 , unsigned V_420 )
{
struct V_4 * V_5 = F_52 ( V_419 ) ;
unsigned int V_88 ;
int V_48 ;
V_48 = F_58 ( V_5 -> V_295 , V_259 + V_420 , & V_88 ) ;
if ( V_48 < 0 )
return V_48 ;
return ( V_88 & V_421 ) != 0 ;
}
static int F_59 ( struct V_418 * V_419 , unsigned V_420 )
{
struct V_4 * V_5 = F_52 ( V_419 ) ;
return F_55 ( V_5 -> V_295 , V_259 + V_420 ,
V_341 | V_424 ,
...
int F_64 ( struct V_1 * V_2 , struct V_429 * V_430 ,
T_2 V_431 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
...
static T_3 F_76 ( int V_60 , void * V_461 )
{
...
static T_3 F_78 ( int V_60 , void * V_461 )
{
T_3 V_48 = V_463 ;
T_3 V_65 ;
do {
V_65 = F_76 ( V_60 , V_461 ) ;
if ( V_65 != V_463 )
V_48 = V_65 ;
} while ( V_65 != V_463 );
return V_48 ;
...
F_4 ( V_2 -> V_29 , L_48 ,
V_5 -> V_15 ) ;
V_5 -> V_472 . V_476 = V_5 -> V_15 ;
V_5 -> V_472 . V_477 = V_5 -> V_26 ;
V_48 = F_82 ( V_2 , V_471 , F_5 ( V_471 ) ) ;
if ( V_48 != 0 )
F_24 ( V_2 -> V_29 ,
L_49 , V_48 ) ;
}
...
V_478 = V_480 ;
V_478 |= V_481 ;
if ( V_478 & ( V_482 | V_483 ) )
V_48 = F_85 ( V_57 -> V_60 , NULL ,
F_78 ,
V_478 , L_50 , V_2 ) ;
else
V_48 = F_85 ( V_57 -> V_60 , NULL , F_76 ,
V_478 , L_50 , V_2 ) ;
if ( V_48 == 0 ) {
F_6 ( V_2 , V_271 ,
V_484 , 0 ) ;
...
static int F_88 ( struct V_56 * V_57 ,
const struct V_489 * V_37 )
{
struct V_4 * V_5 ;
int V_48 , V_12 ;
unsigned int V_88 ;
V_5 = F_89 ( & V_57 -> V_29 , sizeof( struct V_4 ) ,
V_475 ) ;
if ( V_5 == NULL )
return - V_490 ;
F_90 ( V_57 , V_5 ) ;
V_5 -> V_29 = & V_57 -> V_29 ;
if ( F_91 ( & V_57 -> V_29 ) )
memcpy ( & V_5 -> V_7 , F_91 ( & V_57 -> V_29 ) ,
sizeof( V_5 -> V_7 ) ) ;
if ( V_5 -> V_7 . V_294 > 0 ) {
V_48 = F_92 ( V_5 -> V_7 . V_294 ,
V_491 , L_52 ) ;
if ( V_48 < 0 ) {
F_24 ( & V_57 -> V_29 , L_53 ,
V_5 -> V_7 . V_294 , V_48 ) ;
...
V_5 -> V_293 [ V_12 ] . V_493 = V_494 [ V_12 ] ;
V_48 = F_93 ( & V_57 -> V_29 , F_5 ( V_5 -> V_293 ) ,
V_5 -> V_293 ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 , L_54 , V_48 ) ;
goto V_495;
}
V_5 -> V_496 [ 0 ] . V_497 = V_498 ;
V_5 -> V_496 [ 1 ] . V_497 = V_499 ;
V_5 -> V_496 [ 2 ] . V_497 = V_500 ;
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_293 ) ; V_12 ++ ) {
V_48 = F_94 ( V_5 -> V_293 [ V_12 ] . V_501 ,
& V_5 -> V_496 [ V_12 ] ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 ,
L_55 ,
...
V_5 -> V_295 = F_95 ( V_57 , & V_502 ) ;
if ( F_96 ( V_5 -> V_295 ) ) {
V_48 = F_97 ( V_5 -> V_295 ) ;
F_24 ( & V_57 -> V_29 , L_56 , V_48 ) ;
goto V_503;
}
V_48 = F_58 ( V_5 -> V_295 , V_89 , & V_88 ) ;
if ( V_48 < 0 ) {
...
V_48 = F_58 ( V_5 -> V_295 , V_128 , & V_88 ) ;
if ( V_48 < 0 ) {
F_24 ( & V_57 -> V_29 , L_59 ,
V_48 ) ;
goto V_504;
...
V_5 -> V_7 . V_508 << V_509 |
V_5 -> V_7 . V_510 ) ;
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_7 . V_511 ) ; V_12 ++ ) {
if ( ! V_5 -> V_7 . V_511 [ V_12 ] )
continue;
F_99 ( V_5 -> V_295 , V_259 + V_12 ,
V_5 -> V_7 . V_511 [ V_12 ] & 0xffff ) ;
}
if ( V_5 -> V_7 . V_512 )
F_55 ( V_5 -> V_295 ,
V_274 ,
...
F_55 ( V_5 -> V_295 , V_97 ,
V_516 , V_516 ) ;
F_55 ( V_5 -> V_295 , V_101 ,
V_517 , V_517 ) ;
F_55 ( V_5 -> V_295 , V_102 ,
V_517 , V_517 ) ;
F_55 ( V_5 -> V_295 , V_103 ,
V_518 , V_518 ) ;
F_55 ( V_5 -> V_295 , V_104 ,
V_518 , V_518 ) ;
F_55 ( V_5 -> V_295 , V_105 ,
V_517 , V_517 ) ;
F_55 ( V_5 -> V_295 , V_106 ,
V_517 , V_517 ) ;
F_55 ( V_5 -> V_295 , V_107 ,
V_518 , V_518 ) ;
F_55 ( V_5 -> V_295 , V_108 ,
V_518 , V_518 ) ;
F_55 ( V_5 -> V_295 , V_183 ,
V_519 , V_519 ) ;
F_55 ( V_5 -> V_295 , V_184 ,
V_519 , V_519 ) ;
F_55 ( V_5 -> V_295 , V_213 ,
V_520 , V_520 ) ;
F_55 ( V_5 -> V_295 , V_214 ,
V_520 , V_520 ) ;
F_55 ( V_5 -> V_295 , V_185 ,
V_521 , V_521 ) ;
F_55 ( V_5 -> V_295 , V_186 ,
V_521 , V_521 ) ;
F_55 ( V_5 -> V_295 , V_215 ,
V_522 , V_522 ) ;
F_55 ( V_5 -> V_295 , V_216 ,
V_522 , V_522 ) ;
F_55 ( V_5 -> V_295 ,
V_160 ,
V_523 |
...
V_561 ,
1 << V_548 | 1 ) ;
V_48 = F_58 ( V_5 -> V_295 , V_259 , & V_88 ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 , L_62 , V_48 ) ;
goto V_504;
}
if ( V_88 & V_341 )
F_55 ( V_5 -> V_295 , V_148 ,
V_562 ,
V_562 ) ;
V_48 = F_58 ( V_5 -> V_295 , V_260 , & V_88 ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 , L_63 , V_48 ) ;
goto V_504;
}
if ( V_88 & V_342 )
F_55 ( V_5 -> V_295 , V_171 ,
V_563 ,
V_563 ) ;
F_60 ( V_5 ) ;
V_48 = F_100 ( & V_57 -> V_29 ,
& V_564 , V_565 ,
F_5 ( V_565 ) ) ;
if ( V_48 < 0 )
goto V_566;
...
static int F_102 ( struct V_56 * V_567 )
{
