...
V_83 = F_26 ( F_27 ( V_105 -> V_115 ) ) ;
if ( memcmp ( V_83 -> V_95 , V_100 -> V_116 ,
V_117 ) )
continue;
F_3 ( V_21 , L_24 ) ;
F_3 ( V_21 , L_25 ,
F_10 ( V_100 -> V_113 ) ) ;
V_107 -> V_118 -> V_119 ( V_83 , V_96 , 0 , NULL ) ;
if ( V_111 )
V_105 -> V_120 = false ;
else
V_105 -> V_120 = true ;
F_28 ( V_121 , & V_105 -> V_122 ) ;
F_22 ( V_91 ) ;
return true ;
}
V_101 = false ;
F_29 (open, &tcon->pending_opens, olist) {
if ( memcmp ( V_110 -> V_95 , V_100 -> V_116 ,
V_117 ) )
continue;
if ( ! V_101 && V_111 ) {
V_101 = true ;
...
V_117 ) ;
V_91 -> V_94 = F_30 ( V_110 -> V_94 ) ;
F_28 ( V_121 , & V_91 -> V_92 ) ;
}
F_3 ( V_21 , L_26 ) ;
F_3 ( V_21 , L_25 ,
F_10 ( V_100 -> V_113 ) ) ;
...
F_31 ( char * V_124 )
{
struct V_99 * V_100 = (struct V_99 * ) V_124 ;
struct V_102 * V_103 , * V_125 , * V_126 ;
struct V_106 * V_107 ;
struct V_127 * V_108 ;
struct V_97 * V_98 ;
struct V_90 * V_91 ;
V_91 = F_32 ( sizeof( struct V_90 ) , V_128 ) ;
if ( ! V_91 )
return false ;
F_33 ( & V_91 -> V_92 , F_17 ) ;
...
V_107 = F_25 ( V_103 , struct V_106 , V_130 ) ;
F_24 (tmp1, &server->smb_ses_list) {
V_108 = F_25 ( V_125 , struct V_127 , V_131 ) ;
F_34 ( & V_132 ) ;
F_24 (tmp2, &ses->tcon_list) {
V_98 = F_25 ( V_126 , struct V_97 ,
V_133 ) ;
F_35 (
& V_98 -> V_134 . V_135 . V_136 ) ;
...
bool
F_37 ( char * V_124 , struct V_106 * V_107 )
{
struct V_137 * V_100 = (struct V_137 * ) V_124 ;
struct V_102 * V_103 , * V_125 , * V_126 ;
struct V_127 * V_108 ;
struct V_97 * V_98 ;
struct V_82 * V_83 ;
...
F_3 ( V_21 , L_30 , V_100 -> V_138 ) ;
F_34 ( & V_129 ) ;
F_24 (tmp, &server->smb_ses_list) {
V_108 = F_25 ( V_103 , struct V_127 , V_131 ) ;
F_24 (tmp1, &ses->tcon_list) {
V_98 = F_25 ( V_125 , struct V_97 , V_133 ) ;
F_35 ( & V_98 -> V_134 . V_135 . V_136 ) ;
F_34 ( & V_132 ) ;
F_24 (tmp2, &tcon->openFileList) {
V_105 = F_25 ( V_126 , struct V_104 ,
V_114 ) ;
if ( V_100 -> V_139 !=
V_105 -> V_140 . V_141 ||
V_100 -> V_142 !=
