...
V_329 = F_143 () ;
#ifdef F_144
V_329 = V_329 || F_145 ( F_144 ) ;
#endif
if ( ! V_329 )
goto V_331;
if ( V_204 -> V_320 == 0x1af4 &&
V_204 -> V_321 == 0x1100 ) {
V_330 = L_39 ;
...
V_331:
if ( V_330 != NULL )
F_133 ( & V_204 -> V_18 , L_42 , V_330 ) ;
return V_329 ;
}
static int F_146 ( struct V_295 * V_17 ,
struct V_298 * V_204 ,
unsigned long V_137 ,
struct V_1 * * V_332 )
{
...
static struct V_336 V_341 [ 4 ] = {
{ V_287 , 0 } ,
{ V_286 , 0x10 } ,
{ V_285 , 0x20 } ,
{ V_288 , 0x70 } ,
} ;
static struct V_336 V_342 [ 6 ] = {
{ V_343 , 0x40 } ,
{ V_344 , 0x50 } ,
{ V_345 , 0x60 } ,
{ V_346 , 0x70 } ,
...
struct V_336 * V_216 ;
* V_332 = NULL ;
if ( ( V_123 = F_147 ( V_204 ) ) < 0 )
return V_123 ;
V_2 = F_148 ( sizeof( * V_2 ) , V_349 ) ;
if ( V_2 == NULL ) {
F_117 ( V_204 ) ;
return - V_350 ;
}
...
if ( V_204 -> V_351 == V_352 &&
V_204 -> V_192 == V_353 )
V_2 -> V_124 = 1 ;
if ( ( V_123 = F_150 ( V_204 , V_17 -> V_202 ) ) < 0 ) {
F_118 ( V_2 ) ;
F_117 ( V_204 ) ;
return V_123 ;
}
if ( V_137 == V_138 ) {
V_2 -> V_4 = F_151 ( V_204 , 0 , 0 ) ;
goto V_354;
}
if ( F_152 ( V_204 , 2 ) & V_355 )
V_2 -> V_6 = F_151 ( V_204 , 2 , 0 ) ;
else
V_2 -> V_6 = F_151 ( V_204 , 0 , 0 ) ;
if ( ! V_2 -> V_6 ) {
F_18 ( V_17 -> V_18 , L_43 ) ;
F_112 ( V_2 ) ;
return - V_8 ;
}
if ( F_152 ( V_204 , 3 ) & V_355 )
V_2 -> V_4 = F_151 ( V_204 , 3 , 0 ) ;
else
V_2 -> V_4 = F_151 ( V_204 , 1 , 0 ) ;
V_354:
if ( ! V_2 -> V_4 ) {
F_18 ( V_17 -> V_18 , L_44 ) ;
F_112 ( V_2 ) ;
...
if ( F_153 ( V_203 , F_88 ( V_204 ) ,
V_2 -> V_89 * sizeof( T_2 ) * V_357 * 2 ,
& V_2 -> V_292 ) < 0 ) {
F_112 ( V_2 ) ;
F_18 ( V_17 -> V_18 , L_45 ) ;
return - V_350 ;
...
V_2 -> V_244 = 3 ;
V_2 -> V_11 = V_360 ;
V_2 -> V_29 = V_361 | V_362 | V_363 ;
break;
case V_144 :
V_2 -> V_244 = 3 ;
V_2 -> V_11 = V_364 ;
V_2 -> V_29 = V_361 | V_362 | V_365 ;
break;
default:
V_2 -> V_244 = 2 ;
V_2 -> V_11 = V_360 ;
V_2 -> V_29 = V_361 | V_362 ;
break;
}
for ( V_78 = 0 ; V_78 < V_2 -> V_244 ; V_78 ++ )
...
if ( F_126 ( V_204 -> V_83 , F_37 ,
V_299 , V_300 , V_2 ) ) {
F_18 ( V_17 -> V_18 , L_46 , V_204 -> V_83 ) ;
F_112 ( V_2 ) ;
return - V_19 ;
}
V_2 -> V_83 = V_204 -> V_83 ;
if ( ( V_123 = F_155 ( V_17 , V_366 , V_2 , & V_233 ) ) < 0 ) {
F_112 ( V_2 ) ;
return V_123 ;
}
* V_332 = V_2 ;
...
{
const struct V_317 * V_367 ;
V_367 = F_102 ( V_204 , V_368 ) ;
if ( V_367 ) {
if ( V_367 -> V_322 )
F_157 ( & V_204 -> V_18 ,
L_47 ,
...
static int F_159 ( struct V_298 * V_204 ,
...
int V_123 ;
struct V_371 * V_196 ;
V_123 = F_160 ( & V_204 -> V_18 , V_372 , V_373 , V_374 , 0 , & V_17 ) ;
if ( V_123 < 0 )
return V_123 ;
if ( V_218 < 0 )
V_218 = F_156 ( V_204 ) ;
strcpy ( V_17 -> V_375 , L_49 ) ;
if ( ! V_218 ) {
switch ( V_370 -> V_376 ) {
case V_154 :
strcpy ( V_17 -> V_375 , L_50 ) ;
break;
case V_155 :
strcpy ( V_17 -> V_375 , L_51 ) ;
}
}
strcpy ( V_17 -> V_202 , L_8 ) ;
for ( V_196 = V_377 ; V_196 -> V_373 ; V_196 ++ ) {
if ( V_204 -> V_192 == V_196 -> V_373 ) {
strcpy ( V_17 -> V_202 , V_196 -> V_378 ) ;
break;
}
}
if ( V_88 < 0 ) {
...
if ( ( V_123 = F_146 ( V_17 , V_204 , V_370 -> V_376 ,
& V_2 ) ) < 0 ) {
F_161 ( V_17 ) ;
return V_123 ;
}
V_17 -> V_23 = V_2 ;
if ( ( V_123 = F_94 ( V_2 , V_226 , V_379 ) ) < 0 ) {
F_161 ( V_17 ) ;
return V_123 ;
}
if ( ( V_123 = F_90 ( V_2 ) ) < 0 ) {
...
F_138 ( V_2 ) ;
snprintf ( V_17 -> V_380 , sizeof( V_17 -> V_380 ) ,
L_52 , V_17 -> V_202 ,
F_162 ( V_2 -> V_21 [ 0 ] ) , V_2 -> V_83 ) ;
if ( V_226 == 0 || V_226 == 1 ) {
if ( V_226 == 0 ) {
if ( F_135 ( V_2 ) == 0 )
F_130 ( V_2 ) ;
...
static void F_165 ( struct V_298 * V_204 )
{
F_161 ( F_166 ( V_204 ) ) ;
}
