...
struct V_71 * V_134 )
{
struct V_82 * V_83 = & V_134 -> V_76 . V_83 ;
int V_45 , V_31 ;
struct V_24 * V_25 ;
T_4 V_87 ;
V_87 = F_2 ( V_83 -> V_87 ) ;
...
{
struct V_110 V_138 ;
memset ( & V_138 , 0 , sizeof( struct V_110 ) ) ;
memcpy ( V_138 . V_92 , V_137 -> V_92 , V_47 ) ;
V_138 . V_139 |=
F_42 ( ( T_2 ) V_137 -> V_45 << V_140 ) ;
V_138 . V_139 |= F_42 (
( T_2 ) V_137 -> V_141 << V_142 ) ;
V_138 . V_143 = F_42 ( V_144 ) ;
F_55 ( V_2 , V_112 , 0 , 0 , & V_138 , false ) ;
}
...
void F_58 ( struct V_147 * V_19 , T_1 V_30 )
{
struct V_1 * V_2 ;
struct V_24 * V_25 ;
unsigned long V_148 ;
int V_28 ;
for ( V_28 = 0 ; V_28 < V_19 -> V_149 ; V_28 ++ ) {
V_2 = V_19 -> V_2 [ V_28 ] ;
if ( ! V_2 )
continue;
F_16 ( & V_2 -> V_44 , V_148 ) ;
