...
struct V_1 * F_21 ( struct V_35 * V_25 , enum V_133 V_59 )
{
struct V_11 * V_4 = V_25 -> V_134 ;
unsigned long V_38 ;
struct V_1 * V_2 , * V_58 ;
if ( V_59 >= V_135 )
return F_22 ( - V_27 ) ;
...
int F_24 ( struct V_35 * V_25 , struct V_138 * V_26 ,
unsigned long V_5 , unsigned long V_17 )
{
struct V_11 * V_4 ;
int V_139 ;
V_4 = F_25 ( V_26 , sizeof( * V_4 ) , V_140 ) ;
if ( ! V_4 )
return - V_141 ;
V_25 -> V_134 = V_4 ;
F_26 ( & V_4 -> V_40 ) ;
V_4 -> V_5 = F_27 ( V_26 , V_5 , V_142 ) ;
if ( ! V_4 -> V_5 )
return - V_141 ;
V_4 -> V_17 = F_27 ( V_26 , V_17 , V_143 ) ;
if ( ! V_4 -> V_17 )
return - V_141 ;
F_28 ( V_26 , L_7 , V_5 , V_4 -> V_5 ) ;
V_4 -> V_25 = V_25 ;
for ( V_139 = 0 ; V_139 < V_135 ; V_139 ++ ) {
V_4 -> V_59 [ V_139 ] . V_59 = V_139 ;
V_4 -> V_59 [ V_139 ] . V_4 = V_4 ;
V_4 -> V_59 [ V_139 ] . V_18 = & V_144 [ V_139 ] ;
V_4 -> V_59 [ V_139 ] . V_42 = & V_145 [ V_139 ] ;
}
return 0 ;
}
void F_29 ( struct V_35 * V_25 )
{
}
