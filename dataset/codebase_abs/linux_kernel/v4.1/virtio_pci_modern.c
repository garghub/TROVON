...
{
int V_95 ;
for ( V_95 = F_61 ( V_7 , V_96 ) ;
V_95 > 0 ;
V_95 = F_62 ( V_7 , V_95 , V_96 ) ) {
T_1 type , V_14 ;
F_15 ( V_7 , V_95 + F_16 ( struct V_18 ,
V_93 ) ,
& type ) ;
F_15 ( V_7 , V_95 + F_16 ( struct V_18 ,
V_14 ) ,
...
F_65 ( V_99 !=
F_16 ( struct V_18 , V_100 ) ) ;
F_65 ( V_101 !=
F_16 ( struct V_18 , V_102 ) ) ;
F_65 ( V_103 !=
...
int V_58 , V_24 , V_129 , V_130 , V_36 ;
T_4 V_131 ;
T_4 V_132 ;
F_64 () ;
...
return - V_133 ;
if ( V_6 -> V_36 < 0x1040 ) {
V_22 -> V_20 . V_134 . V_36 = V_6 -> V_135 ;
} else {
V_22 -> V_20 . V_134 . V_36 = V_6 -> V_36 - 0x1040 ;
}
V_22 -> V_20 . V_134 . V_136 = V_6 -> V_137 ;
V_24 = F_60 ( V_6 , V_138 ,
V_139 | V_140 ) ;
if ( ! V_24 ) {
F_67 ( & V_6 -> V_7 ,
...
V_129 = F_60 ( V_6 , V_141 ,
V_139 | V_140 ) ;
V_130 = F_60 ( V_6 , V_142 ,
V_139 | V_140 ) ;
if ( ! V_129 || ! V_130 ) {
F_18 ( & V_6 -> V_7 ,
L_14 ,
...
if ( ! V_22 -> V_24 )
goto V_144;
V_22 -> V_129 = F_14 ( V_6 , V_129 , sizeof( T_1 ) , 1 ,
0 , 1 ,
NULL ) ;
if ( ! V_22 -> V_129 )
goto V_145;
F_17 ( V_6 ,
V_130 + F_16 ( struct V_108 ,
V_109 ) ,
& V_22 -> V_77 ) ;
F_17 ( V_6 ,
V_130 + F_16 ( struct V_108 ,
...
V_146 . V_16 ) ,
& V_132 ) ;
if ( ( T_5 ) V_131 + ( V_132 % V_45 ) <= V_45 ) {
V_22 -> V_76 = F_14 ( V_6 , V_130 , 2 , 2 ,
0 , V_131 ,
& V_22 -> V_78 ) ;
if ( ! V_22 -> V_76 )
goto V_79;
...
if ( ! V_22 -> V_36 )
goto V_147;
V_22 -> V_20 . V_148 = & V_149 ;
} else {
V_22 -> V_20 . V_148 = & V_150 ;
}
V_22 -> V_151 = F_39 ;
V_22 -> F_45 = F_45 ;
V_22 -> F_59 = F_59 ;
