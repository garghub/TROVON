...
static inline void F_24 ( struct V_1 * V_2 , T_4 V_75 )
{
F_17 ( L_12
L_13
L_14 ,
...
T_2 V_157 )
{
struct V_158 * V_158 = F_38 ( V_155 , V_159 | V_160 | V_161 , 0600 ) ;
int V_162 ;
if ( F_39 ( V_158 ) ) {
F_16 ( L_30 , V_155 ) ;
return - V_163 ;
}
V_162 = F_40 ( V_158 , V_156 , V_157 , 0 ) ;
if ( V_162 < 0 )
F_16 ( L_31 , V_155 ) ;
F_41 ( V_158 ) ;
...
L_36 , & V_166 -> V_173 [ 0 ] ,
F_44 ( & V_32 -> V_174 . V_175 ) ) ;
V_59 = F_37 ( V_155 , V_156 , V_61 ) ;
F_45 ( V_156 ) ;
return V_59 ;
}
static void F_46 ( struct V_176 * V_177 )
{
struct V_31 * V_32 = F_47 ( V_177 ,
