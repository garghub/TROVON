...
struct V_2 * V_3 = F_59 ( V_209 ) ;
switch ( V_253 -> V_240 | F_81 ( V_254 -> V_111 ) ) {
case V_13 | V_255 :
if ( V_197 & V_256 ) {
if ( V_3 -> V_127 == V_178 )
return - V_257 ;
...
{
int V_262 ;
V_262 = F_86 ( V_261 , & V_3 -> V_10 ) ;
if ( V_262 < 0 )
goto error;
V_262 = F_87 ( & V_3 -> V_194 , V_261 ) ;
if ( V_262 < 0 )
goto error;
V_262 = F_87 ( & V_3 -> V_185 , V_261 ) ;
if ( V_262 < 0 )
goto error;
return 0 ;
error:
...
struct V_252 * V_263 = V_3 -> V_263 ;
struct V_251 * V_264 = & V_209 -> V_111 ;
int V_262 ;
V_3 -> V_127 = V_258 ;
F_89 ( V_209 , & V_265 ) ;
V_209 -> V_266 = & V_267 ;
...
F_91 ( V_209 , V_3 ) ;
V_209 -> V_197 |= V_269 ;
V_263 [ V_13 ] . V_197 = V_270
| V_271 ;
V_263 [ V_113 ] . V_197 = V_272 ;
V_264 -> V_273 = & V_274 ;
V_262 = F_92 ( V_264 , V_275 , V_263 , 0 ) ;
if ( V_262 < 0 )
return V_262 ;
F_78 ( V_209 , NULL ) ;
V_3 -> V_194 . type = V_206 ;
V_3 -> V_194 . V_273 = & V_276 ;
V_3 -> V_194 . V_19 = F_6 ( V_3 ) ;
V_3 -> V_194 . V_277 = F_93 ( 4096 * 4096 ) * 2 * 3 ;
V_3 -> V_194 . V_278 = 32 ;
V_3 -> V_185 . type = V_207 ;
V_3 -> V_185 . V_273 = & V_276 ;
V_3 -> V_185 . V_19 = F_6 ( V_3 ) ;
V_3 -> V_185 . V_277 = F_93 ( 4096 * 4096 ) * 2 * 3 ;
V_3 -> V_185 . V_278 = 32 ;
V_262 = F_94 ( & V_3 -> V_194 , L_10 ) ;
if ( V_262 < 0 )
goto V_279;
V_262 = F_94 ( & V_3 -> V_185 , L_10 ) ;
if ( V_262 < 0 )
goto V_280;
V_3 -> V_185 . V_204 . V_111 . V_197 |= V_281 ;
V_262 = F_95 ( & V_3 -> V_194 . V_204 . V_111 , 0 ,
& V_3 -> V_10 . V_111 , V_13 , 0 ) ;
if ( V_262 < 0 )
goto V_282;
V_262 = F_95 ( & V_3 -> V_10 . V_111 , V_113 ,
