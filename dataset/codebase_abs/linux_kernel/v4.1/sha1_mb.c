...
V_9 = F_73 ( V_59 -> V_84 . V_103 ,
struct V_1 , V_72 ) ;
if ( F_74 ( V_102 , V_9 -> V_78 . V_83 ) )
break;
F_25 () ;
...
return - V_112 ;
F_79 (cpu) {
V_104 = F_80 ( V_85 . V_86 , V_87 ) ;
V_104 -> V_75 = 0 ;
V_104 -> V_82 = 0 ;
V_104 -> V_113 = false ;
F_81 ( & V_104 -> V_60 , V_114 ) ;
V_104 -> V_87 = V_87 ;
V_104 -> V_101 = & V_85 ;
V_104 -> V_28 = (struct V_27 * ) F_82 ( sizeof( struct V_27 ) , V_115 ) ;
if ( ! V_104 -> V_28 )
goto V_116;
F_12 ( V_104 -> V_28 ) ;
F_83 ( & V_104 -> V_84 ) ;
