...
static int F_43 ( struct V_3 * V_4 , struct V_123 * V_124 )
{
const struct V_53 * V_54 ;
struct V_5 * V_6 ;
struct V_12 * V_13 ;
static const int V_131 = 2000 ;
int V_27 ;
int V_120 ;
V_6 = F_44 ( V_4 , sizeof( * V_6 ) ) ;
if ( ! V_6 )
return - V_132 ;
V_120 = F_45 ( V_4 , V_124 -> V_126 [ 0 ] , 0x1c ) ;
if ( V_120 )
return V_120 ;
V_27 = F_41 ( V_4 ) ;
if ( V_27 >= F_46 ( V_133 ) )
...
V_4 -> V_55 = V_133 + V_27 ;
V_54 = V_4 -> V_55 ;
V_4 -> V_128 = V_54 -> V_135 ;
F_33 ( V_4 , V_124 ) ;
V_4 -> V_104 = F_47 ( V_4 -> V_30 + V_136 ,
0 , V_137 , 0 ) ;
if ( ! V_4 -> V_104 )
return - V_132 ;
V_120 = F_48 ( V_4 , 1 ) ;
...
V_4 -> V_14 = V_13 ;
V_13 -> V_140 |= V_149 ;
V_13 -> V_150 = V_13 -> V_144 ;
V_13 -> V_151 = F_25 ;
V_13 -> V_152 = F_20 ;
V_13 -> V_153 = F_10 ;
}
F_9 ( V_6 -> V_46 , V_4 -> V_30 + V_49 ) ;
F_49 ( V_154 | V_155 , V_4 -> V_30 + V_102 ) ;
F_49 ( V_154 , V_4 -> V_30 + V_102 ) ;
V_6 -> V_69 = 0 ;
F_9 ( V_6 -> V_69 , V_4 -> V_30 + V_102 ) ;
for ( V_27 = 0 ; V_27 < V_131 ; V_27 ++ ) {
if ( ( V_156 & F_2 ( V_4 -> V_30 + V_31 ) ) == 0 )
break;
F_50 ( 1000 ) ;
}
if ( V_27 == V_131 ) {
...
{
if ( V_4 -> V_30 )
F_9 ( V_155 | V_154 , V_4 -> V_30 + V_102 ) ;
F_39 ( V_4 ) ;
F_52 ( V_4 ) ;
}
