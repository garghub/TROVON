...
V_51 = F_5 ( V_4 ) ;
V_51 -> V_28 -- ;
F_74 ( V_46 , F_6 ( V_6 ) , V_137 ) ;
F_87 ( V_46 , F_6 ( V_6 ) , V_138 , V_4 -> V_31 ) ;
return F_13 ( V_25 , V_139 , NULL , V_4 ,
V_4 -> V_8 , V_6 -> V_8 ,
F_61 ) ;
error:
F_74 ( V_46 , F_6 ( V_6 ) , V_140 ) ;
V_106:
F_15 ( V_4 ) ;
return - V_36 ;
}
static void F_88 ( struct V_3 * V_141 , struct V_3 * V_142 )
{
V_141 -> V_104 = V_142 -> V_104 ;
V_141 -> V_66 = V_142 -> V_66 ;
V_141 -> V_14 = V_142 -> V_14 ;
F_89 ( V_141 ) ;
...
V_4 -> V_164 -= V_144 -> V_164 ;
}
V_154 = 0 ;
V_85 = 0 ;
V_144 = F_105 ( V_4 ) -> V_165 ;
F_106 ( V_4 ) ;
* V_155 = V_166 ;
V_145 = F_107 ( F_58 ( V_4 ) , V_148 , V_24 ) ;
if ( ! V_145 ) {
F_14 ( V_46 , F_6 ( F_2 ( V_4 ) ) ,
V_75 ) ;
return - V_167 ;
...
F_108 ( V_4 , V_148 ) ;
V_147 = (struct V_146 * ) F_109 ( V_4 , sizeof( struct V_146 ) ) ;
F_109 ( V_4 , V_148 ) ;
F_44 ( V_4 ) ;
memcpy ( F_58 ( V_4 ) , V_145 , V_148 ) ;
F_110 ( V_46 , V_147 , V_120 ) ;
V_147 -> V_65 = V_65 ;
V_147 -> V_168 = 0 ;
V_147 -> V_84 = F_3 ( V_169 ) ;
V_152 = V_147 -> V_170 ;
V_158 = F_100 ( V_4 ) ;
V_4 -> V_171 = V_158 - F_111 ( V_4 ) ;
V_4 -> V_31 = V_158 ;
F_5 ( V_4 ) -> V_64 = F_3 ( V_158 -
sizeof( struct V_50 ) ) ;
F_112 ( & V_120 -> V_6 ) ;
for (; ; ) {
if ( V_144 ) {
...
V_148 ) ;
V_85 += V_4 -> V_31 - V_148 - sizeof( struct V_146 ) ;
V_147 -> V_65 = V_65 ;
V_147 -> V_168 = 0 ;
V_147 -> V_84 = F_3 ( V_85 ) ;
if ( V_144 -> V_81 )
...
F_117 ( V_4 ) )
goto V_177;
V_149 = V_4 -> V_31 - V_148 ;
V_153 = V_148 ;
* V_155 = V_166 ;
V_150 = F_36 ( V_120 -> V_6 . V_8 ) ;
V_151 = V_120 -> V_6 . V_8 -> V_178 ;
while ( V_149 > 0 ) {
V_31 = V_149 ;
if ( V_31 > V_56 )
V_31 = V_56 ;
...
V_144 = F_118 ( V_31 + V_148 + sizeof( struct V_146 ) +
V_150 + V_151 , V_24 ) ;
if ( ! V_144 ) {
F_14 ( V_46 , F_6 ( F_2 ( V_4 ) ) ,
V_75 ) ;
...
F_88 ( V_144 , V_4 ) ;
F_119 ( V_144 , V_150 ) ;
F_120 ( V_144 , V_31 + V_148 + sizeof( struct V_146 ) ) ;
F_44 ( V_144 ) ;
...
V_147 -> V_170 = V_152 ;
F_104 ( F_122 ( V_4 , V_153 , F_123 ( V_144 ) ,
V_31 ) ) ;
V_149 -= V_31 ;
V_147 -> V_84 = F_3 ( V_85 ) ;
if ( V_149 > 0 )
V_147 -> V_84 |= F_3 ( V_169 ) ;
F_5 ( V_144 ) -> V_64 = F_3 ( V_144 -> V_31 -
sizeof( struct V_50 ) ) ;
V_153 += V_31 ;
V_85 += V_31 ;
V_154 = F_95 ( V_2 , V_144 ) ;
if ( V_154 )
goto V_177;
F_14 ( V_46 , F_6 ( F_2 ( V_4 ) ) ,
V_174 ) ;
...
const struct V_11 * V_184 )
{
return ( V_182 -> V_185 != 128 || ! F_125 ( V_183 , & V_182 -> V_126 ) ) &&
( ! V_184 || ! F_125 ( V_183 , V_184 ) ) ;
}
...
V_120 = (struct V_33 * ) V_6 ;
if ( F_124 ( & V_120 -> V_125 , & V_42 -> V_16 , V_48 -> V_190 ) ||
#ifdef F_128
F_124 ( & V_120 -> V_191 , & V_42 -> V_22 , V_48 -> V_192 ) ||
#endif
( V_42 -> V_193 && V_42 -> V_193 != V_6 -> V_8 -> V_83 ) ) {
F_127 ( V_6 ) ;
V_6 = NULL ;
}
V_186:
...
V_154 = F_133 ( V_46 , V_120 , & V_42 -> V_16 ,
V_2 ? F_35 ( V_2 ) -> V_196 : 0 ,
& V_42 -> V_22 ) ;
if ( V_154 )
goto V_197;
if ( ! V_195 && ( * V_6 ) -> error ) {
...
V_120 = (struct V_33 * ) * V_6 ;
F_18 () ;
V_194 = F_20 ( V_120 -> V_6 . V_8 , F_19 ( V_120 ) ) ;
V_154 = V_194 && ! ( V_194 -> V_198 & V_199 ) ? - V_36 : 0 ;
F_25 () ;
if ( V_154 ) {
struct V_200 * V_201 ;
struct V_41 V_202 ;
int V_203 ;
V_201 = F_134 ( V_46 , & V_42 -> V_22 ,
( * V_6 ) -> V_8 , 1 ) ;
V_203 = ( V_201 && V_201 -> V_19 & V_204 ) ;
if ( V_201 )
F_135 ( V_201 ) ;
if ( V_203 ) {
F_127 ( * V_6 ) ;
memcpy ( & V_202 , V_42 , sizeof( struct V_41 ) ) ;
memset ( & V_202 . V_16 , 0 , sizeof( struct V_11 ) ) ;
* V_6 = F_132 ( V_46 , V_2 , & V_202 ) ;
V_154 = ( * V_6 ) -> error ;
if ( V_154 )
goto V_197;
}
...
const struct V_11 * V_206 )
{
struct V_5 * V_6 = NULL ;
int V_154 ;
V_154 = F_129 ( V_2 , & V_6 , V_42 ) ;
if ( V_154 )
return F_138 ( V_154 ) ;
if ( V_206 )
V_42 -> V_16 = * V_206 ;
...
const struct V_11 * V_206 )
{
struct V_5 * V_6 = F_142 ( V_2 , F_35 ( V_2 ) -> V_207 ) ;
int V_154 ;
...
struct V_208 * V_209 ,
int F_144 ( void * V_142 , char * V_141 , int V_85 , int V_31 ,
int V_210 , struct V_3 * V_4 ) ,
void * V_142 , int V_211 , int V_212 , int V_213 ,
int V_214 , int V_56 , unsigned int V_19 ,
struct V_33 * V_120 )
{
struct V_3 * V_4 ;
struct V_146 V_215 ;
...
return V_154 ;
F_119 ( V_4 , V_212 ) ;
F_120 ( V_4 , V_213 + V_214 ) ;
F_44 ( V_4 ) ;
V_4 -> V_179 = V_4 -> V_180 + V_213 ;
V_4 -> V_14 = F_3 ( V_15 ) ;
V_4 -> V_217 = 0 ;
F_147 ( V_209 , V_4 ) ;
} else if ( F_28 ( V_4 ) ) {
...
V_4 -> V_172 = V_176 ;
F_105 ( V_4 ) -> V_219 = ( V_56 - V_213 -
sizeof( struct V_146 ) ) & ~ 7 ;
F_105 ( V_4 ) -> V_220 = V_221 ;
F_110 ( F_34 ( V_2 ) , & V_215 , V_120 ) ;
F_105 ( V_4 ) -> V_222 = V_215 . V_170 ;
V_218:
return F_148 ( V_2 , V_4 , F_144 , V_142 ,
( V_211 - V_214 ) ) ;
}
...
int V_31 , int V_210 , struct V_3 * V_4 ) ,
void * V_142 , int V_211 , int V_214 ,
unsigned int V_19 , int V_253 )
{
struct V_3 * V_4 , * V_254 = NULL ;
unsigned int V_228 , V_213 , V_56 , V_229 ;
int V_255 = 0 ;
int V_256 = 0 ;
int V_212 ;
int V_257 ;
...
V_56 = V_233 -> V_248 ;
V_229 = V_56 ;
V_212 = F_36 ( V_120 -> V_6 . V_8 ) ;
V_213 = sizeof( struct V_50 ) + V_120 -> V_261 +
( V_44 ? V_44 -> V_58 : 0 ) ;
V_228 = ( ( V_56 - V_213 ) & ~ 7 ) + V_213 -
sizeof( struct V_146 ) ;
...
V_263 = V_56 ;
if ( ( V_233 -> V_211 + V_211 > V_56 - V_264 ) && V_253 &&
( V_2 -> V_265 == V_266 ||
V_2 -> V_265 == V_267 ) ) {
...
if ( V_233 -> V_211 + V_211 > V_263 - V_264 ) {
V_268:
F_49 ( V_2 , V_74 , V_42 ,
V_56 - V_264 +
sizeof( struct V_50 ) ) ;
...
( V_2 -> V_269 == V_270 ) ) {
V_154 = F_143 ( V_2 , V_209 , F_144 , V_142 , V_211 ,
V_212 , V_213 ,
V_214 , V_56 , V_19 , V_120 ) ;
if ( V_154 )
goto error;
return 0 ;
}
...
goto V_279;
while ( V_211 > 0 ) {
V_257 = ( V_233 -> V_211 <= V_56 && ! ( V_233 -> V_19 & V_249 ) ? V_56 : V_228 ) - V_4 -> V_31 ;
if ( V_257 < V_211 )
...
V_254 = V_4 ;
V_280 = V_211 + V_282 ;
if ( V_280 > ( V_233 -> V_211 <= V_56 && ! ( V_233 -> V_19 & V_249 ) ? V_56 : V_228 ) - V_213 )
V_280 = V_228 - V_213 - V_120 -> V_6 . V_284 ;
if ( ( V_19 & V_285 ) &&
...
V_283 = V_280 + V_213 ;
V_283 += V_256 ;
if ( V_280 != V_211 + V_282 ) {
V_280 += V_120 -> V_6 . V_284 ;
}
V_283 += V_120 -> V_6 . V_284 ;
V_281 = V_280 + V_213 ;
V_283 += sizeof( struct V_146 ) ;
if ( V_214 ) {
V_4 = F_146 ( V_2 ,
V_283 + V_212 ,
( V_19 & V_216 ) , & V_154 ) ;
...
V_4 -> V_172 = V_260 ;
V_4 -> V_217 = 0 ;
F_119 ( V_4 , V_212 + sizeof( struct V_146 ) +
V_256 ) ;
F_105 ( V_4 ) -> V_258 = V_258 ;
V_258 = 0 ;
F_105 ( V_4 ) -> V_259 = V_259 ;
V_259 = 0 ;
V_89 = F_120 ( V_4 , V_281 ) ;
F_161 ( V_4 , V_255 ) ;
V_89 += V_213 ;
V_4 -> V_179 = ( V_4 -> V_180 +
V_213 ) ;
...
V_257 = V_280 - V_214 - V_282 ;
if ( V_257 < 0 ) {
V_154 = - V_36 ;
F_15 ( V_4 ) ;
goto error;
} else if ( V_257 > 0 && F_144 ( V_142 , V_89 + V_214 , V_85 , V_257 , V_282 , V_4 ) < 0 ) {
V_154 = - V_289 ;
F_15 ( V_4 ) ;
goto error;
}
...
unsigned int V_290 ;
V_290 = V_4 -> V_31 ;
if ( F_144 ( V_142 , F_120 ( V_4 , V_257 ) ,
...
int F_144 ( void * V_142 , char * V_141 , int V_85 , int V_31 ,
int V_210 , struct V_3 * V_4 ) ,
void * V_142 , int V_211 , int V_214 , int V_55 ,
...
return 0 ;
if ( F_176 ( & V_2 -> V_302 ) ) {
V_154 = F_152 ( V_2 , & V_300 -> V_233 , & V_48 -> V_233 , V_55 ,
...
V_142 , V_211 , V_214 , V_19 , V_253 ) ;
}
static void F_178 ( struct V_232 * V_233 ,
struct V_234 * V_235 )
{
if ( V_235 -> V_44 ) {
F_114 ( V_235 -> V_44 -> V_238 ) ;
F_114 ( V_235 -> V_44 -> V_239 ) ;
F_114 ( V_235 -> V_44 -> V_240 ) ;
F_114 ( V_235 -> V_44 -> V_116 ) ;
F_114 ( V_235 -> V_44 ) ;
V_235 -> V_44 = NULL ;
}
if ( V_233 -> V_241 . V_6 ) {
...
if ( ! V_4 )
goto V_186;
V_304 = & ( F_105 ( V_4 ) -> V_165 ) ;
if ( V_4 -> V_89 < F_58 ( V_4 ) )
F_108 ( V_4 , F_181 ( V_4 ) ) ;
while ( ( V_303 = F_180 ( V_209 ) ) != NULL ) {
F_108 ( V_303 , F_182 ( V_4 ) ) ;
* V_304 = V_303 ;
V_304 = & ( V_303 -> V_81 ) ;
V_4 -> V_31 += V_303 -> V_31 ;
V_4 -> V_171 += V_303 -> V_31 ;
V_4 -> V_164 += V_303 -> V_164 ;
V_303 -> V_162 = NULL ;
V_303 -> V_2 = NULL ;
}
V_4 -> V_70 = F_156 ( V_2 ) ;
...
V_235 . V_44 = NULL ;
V_154 = F_152 ( V_2 , & V_233 , & V_235 , V_55 , V_45 , V_44 , V_120 , V_42 ) ;
if ( V_154 )
return F_138 ( V_154 ) ;
if ( V_253 < 0 )
V_253 = F_35 ( V_2 ) -> V_253 ;
V_154 = F_155 ( V_2 , V_42 , & V_209 , & V_233 . V_241 , & V_235 ,
& V_307 -> V_308 , F_144 , V_142 ,
V_211 + V_255 , V_214 + V_255 ,
V_19 , V_253 ) ;
if ( V_154 ) {
F_191 ( V_2 , & V_209 , & V_233 , & V_235 ) ;
return F_138 ( V_154 ) ;
}
return F_179 ( V_2 , & V_209 , & V_233 , & V_235 ) ;
}
