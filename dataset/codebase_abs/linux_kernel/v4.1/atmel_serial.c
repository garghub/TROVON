...
static T_5 F_98 ( int V_169 , void * V_170 )
{
struct V_2 * V_4 = V_170 ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
unsigned int V_10 , V_167 , V_127 , V_171 = 0 ;
bool V_172 = false ;
F_89 ( & V_5 -> V_173 ) ;
do {
V_10 = F_7 ( V_4 ) ;
...
V_167 = V_10 & V_127 ;
if ( ! V_172 ) {
if ( V_169 == V_5 -> V_70 [ V_13 ] )
V_167 |= V_71 ;
if ( V_169 == V_5 -> V_70 [ V_16 ] )
V_167 |= V_72 ;
if ( V_169 == V_5 -> V_70 [ V_19 ] )
V_167 |= V_73 ;
if ( V_169 == V_5 -> V_70 [ V_22 ] )
V_167 |= V_74 ;
V_172 = true ;
}
if ( ! V_167 )
...
F_87 ( & V_5 -> V_173 ) ;
return V_171 ? V_177 : V_178 ;
}
static void F_101 ( struct V_2 * V_4 )
{
struct V_1 * V_5 = F_1 ( V_4 ) ;
struct V_179 * V_180 = & V_5 -> V_181 ;
F_102 ( V_4 -> V_33 ,
V_180 -> V_182 ,
V_180 -> V_183 ,
V_116 ) ;
...
if ( F_104 ( V_4 ) )
return;
V_100 -> V_86 += V_180 -> V_184 ;
V_100 -> V_86 &= V_104 - 1 ;
V_4 -> V_92 . V_103 += V_180 -> V_184 ;
V_180 -> V_184 = 0 ;
F_25 ( V_4 , V_56 ) ;
if ( ! F_45 ( V_100 ) && ! F_46 ( V_4 ) ) {
F_105 ( V_4 -> V_33 ,
...
V_180 -> V_184 = V_152 ;
F_106 ( V_4 , V_180 -> V_182 + V_100 -> V_86 ) ;
F_107 ( V_4 , V_152 ) ;
F_25 ( V_4 , V_58 ) ;
F_18 ( V_4 , V_5 -> V_28 ) ;
} else {
...
struct V_179 * V_180 = & V_5 -> V_181 ;
struct V_80 * V_100 = & V_4 -> V_101 -> V_100 ;
V_180 -> V_88 = V_100 -> V_88 ;
V_180 -> V_182 = F_109 ( V_4 -> V_33 ,
V_180 -> V_88 ,
V_104 ,
V_116 ) ;
V_180 -> V_183 = V_104 ;
...
continue;
F_114 ( V_4 , V_10 , V_96 , V_84 . V_79 , V_185 ) ;
}
F_87 ( & V_4 -> V_110 ) ;
F_88 ( & V_4 -> V_101 -> V_4 ) ;
F_89 ( & V_4 -> V_110 ) ;
...
struct V_179 * V_180 = & V_5 -> V_191 [ V_190 ] ;
F_102 ( V_4 -> V_33 ,
V_180 -> V_182 ,
V_180 -> V_183 ,
V_144 ) ;
...
do {
F_21 ( V_4 , V_153 ) ;
V_180 = & V_5 -> V_191 [ V_192 ] ;
V_85 = F_118 ( V_4 ) - V_180 -> V_182 ;
V_86 = V_180 -> V_184 ;
V_85 = F_119 ( V_85 , V_180 -> V_183 ) ;
if ( F_120 ( V_85 != V_86 ) ) {
F_121 ( V_4 -> V_33 , V_180 -> V_182 ,
V_180 -> V_183 , V_144 ) ;
V_152 = V_85 - V_86 ;
F_86 ( V_148 , V_180 -> V_88 + V_180 -> V_184 ,
V_152 ) ;
F_105 ( V_4 -> V_33 , V_180 -> V_182 ,
V_180 -> V_183 , V_144 ) ;
V_4 -> V_92 . V_156 += V_152 ;
V_180 -> V_184 = V_85 ;
}
if ( V_85 >= V_180 -> V_183 ) {
V_180 -> V_184 = 0 ;
F_122 ( V_4 , V_180 -> V_182 ) ;
F_123 ( V_4 , V_180 -> V_183 ) ;
V_192 = ! V_192 ;
V_5 -> V_193 = V_192 ;
}
} while ( V_85 >= V_180 -> V_183 );
F_87 ( & V_4 -> V_110 ) ;
F_88 ( V_148 ) ;
F_89 ( & V_4 -> V_110 ) ;
F_18 ( V_4 , V_61 | V_62 ) ;
...
V_5 -> V_193 = 0 ;
F_126 ( V_4 , V_5 -> V_191 [ 0 ] . V_182 ) ;
F_127 ( V_4 , V_194 ) ;
F_122 ( V_4 , V_5 -> V_191 [ 1 ] . V_182 ) ;
F_123 ( V_4 , V_194 ) ;
return 0 ;
}
...
struct V_1 * V_5 = F_1 ( V_4 ) ;
enum V_221 V_190 ;
for ( V_190 = 0 ; V_190 < V_222 ; V_190 ++ )
if ( V_5 -> V_70 [ V_190 ] >= 0 )
F_142 ( V_5 -> V_70 [ V_190 ] , V_4 ) ;
}
...
enum V_221 V_190 ;
int V_223 = 0 ;
for ( V_190 = 0 ; ( V_190 < V_222 ) && ! V_223 ; V_190 ++ ) {
if ( V_169 [ V_190 ] < 0 )
continue;
F_144 ( V_169 [ V_190 ] , V_224 ) ;
V_223 = F_145 ( V_169 [ V_190 ] , F_98 , V_225 ,
L_26 , V_4 ) ;
if ( V_223 )
F_65 ( V_4 -> V_33 , L_27 ,
V_169 [ V_190 ] ) ;
...
for ( V_190 = 0 ; V_190 < V_222 ; V_190 ++ ) {
V_333 = F_11 ( V_330 -> V_12 , V_190 ) ;
if ( V_333 && ( F_210 ( V_333 ) == V_334 ) )
V_330 -> V_70 [ V_190 ] = F_211 ( V_333 ) ;
else
V_330 -> V_70 [ V_190 ] = - V_115 ;
}
return 0 ;
}
