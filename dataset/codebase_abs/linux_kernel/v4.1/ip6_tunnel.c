...
static void
F_142 ( struct V_47 * V_48 , const struct V_222 * V_202 )
{
...
static void
F_143 ( struct V_222 * V_202 , const struct V_47 * V_48 )
{
...
static int
F_144 ( struct V_7 * V_8 , struct V_223 * V_224 , int V_225 )
{
int V_55 = 0 ;
struct V_222 V_48 ;
struct V_47 V_226 ;
...
case V_227 :
if ( V_8 == V_38 -> V_69 ) {
if ( F_145 ( & V_48 , V_224 -> V_228 . V_229 , sizeof( V_48 ) ) ) {
V_55 = - V_230 ;
break;
}
F_142 ( & V_226 , & V_48 ) ;
V_23 = F_37 ( V_34 , & V_226 , 0 ) ;
if ( F_60 ( V_23 ) )
V_23 = F_28 ( V_8 ) ;
} else {
...
if ( F_146 ( V_224 -> V_228 . V_229 , & V_48 , sizeof( V_48 ) ) ) {
V_55 = - V_230 ;
}
break;
case V_231 :
...
break;
F_142 ( & V_226 , & V_48 ) ;
V_23 = F_37 ( V_34 , & V_226 , V_225 == V_231 ) ;
if ( V_225 == V_232 ) {
if ( ! F_60 ( V_23 ) ) {
if ( V_23 -> V_8 != V_8 ) {
V_55 = - V_67 ;
...
V_23 = F_28 ( V_8 ) ;
if ( V_8 == V_38 -> V_69 )
V_55 = F_141 ( V_23 , & V_226 ) ;
else
V_55 = F_138 ( V_23 , & V_226 ) ;
}
if ( ! F_60 ( V_23 ) ) {
V_55 = 0 ;
F_143 ( & V_48 , & V_23 -> V_41 ) ;
...
static int
F_149 ( struct V_7 * V_8 , int V_238 )
{
struct V_22 * V_239 = F_28 ( V_8 ) ;
if ( V_239 -> V_41 . V_110 == V_127 ) {
if ( V_238 < 68 )
return - V_236 ;
} else {
if ( V_238 < V_119 )
...
if ( V_238 > 0xFFF8 - V_8 -> V_221 )
return - V_236 ;
V_8 -> V_112 = V_238 ;
return 0 ;
}
int F_150 ( const struct V_7 * V_8 )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
return V_23 -> V_41 . V_153 ;
}
...
V_8 -> V_242 = F_24 ;
V_8 -> type = V_243 ;
V_8 -> V_221 = V_244 + sizeof( struct V_73 ) ;
V_8 -> V_112 = V_245 - sizeof( struct V_73 ) ;
V_23 = F_28 ( V_8 ) ;
if ( ! ( V_23 -> V_41 . V_44 & V_200 ) )
V_8 -> V_112 -= 8 ;
V_8 -> V_44 |= V_246 ;
...
static int T_9 F_156 ( struct V_7 * V_8 )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
struct V_34 * V_34 = F_29 ( V_8 ) ;
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
...
static int F_157 ( struct V_251 * V_252 [] , struct V_251 * V_81 [] )
{
T_5 V_110 ;
if ( ! V_81 || ! V_81 [ V_253 ] )
return 0 ;
V_110 = F_158 ( V_81 [ V_253 ] ) ;
if ( V_110 != V_141 &&
V_110 != V_127 &&
V_110 != 0 )
return - V_236 ;
...
static void F_159 ( struct V_251 * V_81 [] ,
struct V_47 * V_41 )
{
...
return;
if ( V_81 [ V_254 ] )
V_41 -> V_153 = F_160 ( V_81 [ V_254 ] ) ;
if ( V_81 [ V_255 ] )
V_41 -> V_42 = F_161 ( V_81 [ V_255 ] ) ;
if ( V_81 [ V_256 ] )
V_41 -> V_43 = F_161 ( V_81 [ V_256 ] ) ;
if ( V_81 [ V_257 ] )
V_41 -> V_197 = F_158 ( V_81 [ V_257 ] ) ;
if ( V_81 [ V_258 ] )
V_41 -> V_117 = F_158 ( V_81 [ V_258 ] ) ;
if ( V_81 [ V_259 ] )
V_41 -> V_217 = F_162 ( V_81 [ V_259 ] ) ;
if ( V_81 [ V_260 ] )
V_41 -> V_44 = F_160 ( V_81 [ V_260 ] ) ;
if ( V_81 [ V_253 ] )
V_41 -> V_110 = F_158 ( V_81 [ V_253 ] ) ;
}
static int F_163 ( struct V_34 * V_261 , struct V_7 * V_8 ,
struct V_251 * V_252 [] , struct V_251 * V_81 [] )
{
struct V_34 * V_34 = F_29 ( V_8 ) ;
struct V_22 * V_262 , * V_23 ;
V_262 = F_28 ( V_8 ) ;
F_159 ( V_81 , & V_262 -> V_41 ) ;
V_23 = F_37 ( V_34 , & V_262 -> V_41 , 0 ) ;
if ( ! F_60 ( V_23 ) )
return - V_67 ;
return F_27 ( V_8 ) ;
}
static int F_164 ( struct V_7 * V_8 , struct V_251 * V_252 [] ,
struct V_251 * V_81 [] )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
struct V_47 V_48 ;
...
static void F_165 ( struct V_7 * V_8 , struct V_263 * V_264 )
{
struct V_34 * V_34 = F_29 ( V_8 ) ;
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
if ( V_8 != V_38 -> V_69 )
...
static T_10 F_167 ( const struct V_7 * V_8 )
{
return
F_168 ( 4 ) +
F_168 ( sizeof( struct V_1 ) ) +
F_168 ( sizeof( struct V_1 ) ) +
F_168 ( 1 ) +
F_168 ( 1 ) +
F_168 ( 4 ) +
...
static int F_169 ( struct V_70 * V_71 , const struct V_7 * V_8 )
{
struct V_22 * V_265 = F_28 ( V_8 ) ;
struct V_47 * V_266 = & V_265 -> V_41 ;
if ( F_170 ( V_71 , V_254 , V_266 -> V_153 ) ||
F_171 ( V_71 , V_255 , & V_266 -> V_42 ) ||
F_171 ( V_71 , V_256 , & V_266 -> V_43 ) ||
F_172 ( V_71 , V_257 , V_266 -> V_197 ) ||
F_172 ( V_71 , V_258 , V_266 -> V_117 ) ||
F_173 ( V_71 , V_259 , V_266 -> V_217 ) ||
F_170 ( V_71 , V_260 , V_266 -> V_44 ) ||
F_172 ( V_71 , V_253 , V_266 -> V_110 ) )
goto V_267;
return 0 ;
V_267:
return - V_190 ;
}
struct V_34 * F_174 ( const struct V_7 * V_8 )
{
struct V_22 * V_265 = F_28 ( V_8 ) ;
return V_265 -> V_34 ;
}
static void T_11 F_175 ( struct V_34 * V_34 )
{
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
struct V_7 * V_8 , * V_268 ;
int V_49 ;
struct V_22 * V_23 ;
F_176 ( V_269 ) ;
F_177 (net, dev, aux)
if ( V_8 -> V_58 == & V_59 )
F_166 ( V_8 , & V_269 ) ;
for ( V_49 = 0 ; V_49 < V_270 ; V_49 ++ ) {
V_23 = F_22 ( V_38 -> V_271 [ V_49 ] ) ;
while ( V_23 ) {
if ( ! F_112 ( F_29 ( V_23 -> V_8 ) , V_34 ) )
F_166 ( V_23 -> V_8 , & V_269 ) ;
V_23 = F_22 ( V_23 -> V_53 ) ;
}
}
F_178 ( & V_269 ) ;
}
static int T_9 F_179 ( struct V_34 * V_34 )
{
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
struct V_22 * V_23 = NULL ;
int V_55 ;
V_38 -> V_51 [ 0 ] = V_38 -> V_46 ;
V_38 -> V_51 [ 1 ] = V_38 -> V_271 ;
V_55 = - V_61 ;
...
F_35 ( V_38 -> V_69 , V_34 ) ;
V_38 -> V_69 -> V_58 = & V_59 ;
V_38 -> V_69 -> V_273 |= V_274 ;
V_55 = F_156 ( V_38 -> V_69 ) ;
if ( V_55 < 0 )
goto V_275;
V_55 = F_180 ( V_38 -> V_69 ) ;
if ( V_55 < 0 )
goto V_275;
V_23 = F_28 ( V_38 -> V_69 ) ;
...
static void T_11 F_181 ( struct V_34 * V_34 )
{
F_182 () ;
F_175 ( V_34 ) ;
F_183 () ;
...
if ( V_55 < 0 )
goto V_277;
V_55 = F_186 ( & V_278 , V_279 ) ;
if ( V_55 < 0 ) {
F_187 ( L_11 , V_280 ) ;
goto V_281;
}
V_55 = F_186 ( & V_282 , V_283 ) ;
if ( V_55 < 0 ) {
F_187 ( L_12 , V_280 ) ;
goto V_284;
}
...
{
F_192 ( & V_59 ) ;
if ( F_189 ( & V_278 , V_279 ) )
F_193 ( L_13 , V_280 ) ;
if ( F_189 ( & V_282 , V_283 ) )
F_193 ( L_14 , V_280 ) ;
F_190 ( & V_276 ) ;
}
