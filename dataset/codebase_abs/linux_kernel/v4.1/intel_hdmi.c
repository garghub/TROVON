...
static bool F_84 ( struct V_97 * V_124 )
{
...
for ( V_39 = 0 ; V_39 < V_126 -> V_131 ; V_39 ++ ) {
if ( ! V_126 -> V_132 [ V_39 ] )
continue;
V_128 = V_126 -> V_133 [ V_39 ] ;
if ( V_128 -> V_49 != V_124 -> V_3 . V_49 )
continue;
V_13 = F_86 ( V_128 -> V_134 ) ;
V_130 += V_13 -> type == V_135 ;
V_129 ++ ;
}
...
int V_136 = V_98 -> V_3 . V_60 . V_109 * 3 / 2 ;
int V_137 = F_79 ( V_2 , false ) ;
int V_138 ;
V_98 -> V_92 = V_2 -> V_92 ;
if ( V_98 -> V_92 )
V_98 -> V_103 = true ;
...
V_2 -> V_105 = false ;
V_2 -> V_65 = false ;
F_91 ( F_92 ( V_18 ) -> V_143 ) ;
F_92 ( V_18 ) -> V_143 = NULL ;
}
static bool
...
V_2 -> V_146 ) ) ;
F_98 ( V_6 , V_95 ) ;
F_92 ( V_18 ) -> V_143 = V_144 ;
if ( V_144 && V_144 -> V_147 & V_148 ) {
V_2 -> V_65 =
F_99 ( V_144 ) ;
V_2 -> V_105 = F_100 ( V_144 ) ;
if ( V_2 -> V_149 != V_150 )
V_2 -> V_105 =
V_2 -> V_149 == V_151 ;
if ( V_2 -> V_149 != V_152 )
...
static enum V_153
F_102 ( struct V_17 * V_18 , bool V_154 )
{
enum V_153 V_155 ;
F_89 ( L_13 ,
V_18 -> V_3 . V_156 , V_18 -> V_157 ) ;
F_90 ( V_18 ) ;
if ( F_93 ( V_18 ) ) {
struct V_2 * V_2 = F_9 ( V_18 ) ;
F_2 ( V_2 ) -> V_3 . type = V_135 ;
V_155 = V_158 ;
} else
V_155 = V_159 ;
return V_155 ;
...
{
struct V_144 * V_144 ;
V_144 = F_92 ( V_18 ) -> V_143 ;
if ( V_144 == NULL )
return 0 ;
return F_105 ( V_18 , V_144 ) ;
}
static bool
...
int V_61 ;
V_61 = F_108 ( & V_18 -> V_3 , V_161 , V_37 ) ;
if ( V_61 )
return V_61 ;
if ( V_161 == V_6 -> V_162 ) {
enum V_163 V_39 = V_37 ;
bool V_105 ;
if ( V_39 == V_2 -> V_149 )
return 0 ;
V_2 -> V_149 = V_39 ;
...
{
struct V_14 * V_181 = F_24 ( & V_13 -> V_3 ) ;
struct V_2 * V_2 = & V_181 -> V_16 ;
struct V_1 * V_4 = V_13 -> V_3 . V_4 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_48 * V_48 =
F_27 ( V_13 -> V_3 . V_49 ) ;
...
F_116 ( V_6 , V_51 , F_118 ( V_46 ) , V_184 ) ;
...
struct V_48 * V_48 =
F_27 ( V_13 -> V_3 . V_49 ) ;
enum V_182 V_191 = F_112 ( V_181 ) ;
enum V_51 V_51 = V_48 -> V_51 ;
T_2 V_37 ;
F_54 ( V_13 ) ;
F_113 ( & V_6 -> V_183 ) ;
if ( V_51 != V_192 ) {
V_37 = F_114 ( V_6 , V_51 , V_193 ) ;
V_37 &= ~ ( V_194 | V_195 ) ;
if ( V_191 == V_196 )
V_37 |= V_197 ;
if ( V_191 == V_198 )
V_37 |= V_199 ;
F_116 ( V_6 , V_51 , V_193 , V_37 ) ;
} else {
V_37 = F_114 ( V_6 , V_51 , V_200 ) ;
V_37 &= ~ ( V_201 | V_202 ) ;
if ( V_191 == V_196 )
V_37 |= V_203 ;
if ( V_191 == V_198 )
V_37 |= V_204 ;
F_116 ( V_6 , V_51 , V_200 , V_37 ) ;
}
V_37 = F_114 ( V_6 , V_51 , F_115 ( V_191 ) ) ;
V_37 |= V_205 ;
if ( V_51 != V_192 )
V_37 &= ~ V_206 ;
else
V_37 |= V_206 ;
F_116 ( V_6 , V_51 , F_115 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_136 ( V_191 ) ) ;
V_37 |= V_205 ;
if ( V_51 != V_192 )
V_37 &= ~ V_206 ;
else
V_37 |= V_206 ;
F_116 ( V_6 , V_51 , F_136 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_137 ( V_191 ) ) ;
if ( V_51 != V_192 )
V_37 &= ~ V_207 ;
else
V_37 |= V_207 ;
F_116 ( V_6 , V_51 , F_137 ( V_191 ) , V_37 ) ;
F_127 ( & V_6 -> V_183 ) ;
}
...
T_2 V_37 ;
F_113 ( & V_6 -> V_183 ) ;
V_37 = F_114 ( V_6 , V_51 , F_140 ( V_191 ) ) ;
V_37 |= V_208 ;
F_116 ( V_6 , V_51 , F_140 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_141 ( V_191 ) ) ;
V_37 |= V_208 ;
F_116 ( V_6 , V_51 , F_141 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_142 ( V_191 ) ) ;
V_37 &= ~ ( V_185 | V_186 ) ;
F_116 ( V_6 , V_51 , F_142 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_143 ( V_191 ) ) ;
V_37 &= ~ ( V_185 | V_186 ) ;
F_116 ( V_6 , V_51 , F_143 ( V_191 ) , V_37 ) ;
F_127 ( & V_6 -> V_183 ) ;
}
...
T_2 V_37 ;
F_113 ( & V_6 -> V_183 ) ;
V_37 = F_114 ( V_6 , V_51 , F_145 ( V_191 ) ) ;
V_37 &= ~ V_209 ;
F_116 ( V_6 , V_51 , F_145 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_146 ( V_191 ) ) ;
V_37 &= ~ V_209 ;
F_116 ( V_6 , V_51 , F_146 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_140 ( V_191 ) ) ;
V_37 |= V_208 ;
F_116 ( V_6 , V_51 , F_140 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_141 ( V_191 ) ) ;
...
V_36 = ( V_39 == 1 ) ? 0x0 : 0x1 ;
F_116 ( V_6 , V_51 , F_147 ( V_191 , V_39 ) ,
V_36 << V_210 ) ;
}
V_37 = F_114 ( V_6 , V_51 , F_148 ( V_191 ) ) ;
V_37 &= ~ ( V_211 | V_212 ) ;
V_37 &= ~ ( V_213 | V_214 ) ;
V_37 |= V_215 | V_216 ;
F_116 ( V_6 , V_51 , F_148 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_149 ( V_191 ) ) ;
V_37 &= ~ ( V_211 | V_212 ) ;
V_37 &= ~ ( V_213 | V_214 ) ;
V_37 |= V_215 | V_216 ;
F_116 ( V_6 , V_51 , F_149 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_150 ( V_191 ) ) ;
V_37 &= ~ ( V_217 | V_218 ) ;
V_37 |= V_219 | V_220 ;
F_116 ( V_6 , V_51 , F_150 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , F_151 ( V_191 ) ) ;
V_37 &= ~ ( V_217 | V_218 ) ;
V_37 |= V_219 | V_220 ;
F_116 ( V_6 , V_51 , F_151 ( V_191 ) , V_37 ) ;
for ( V_39 = 0 ; V_39 < 4 ; V_39 ++ ) {
V_37 = F_114 ( V_6 , V_51 , F_152 ( V_191 , V_39 ) ) ;
V_37 &= ~ V_221 ;
V_37 |= 128 << V_222 ;
F_116 ( V_6 , V_51 , F_152 ( V_191 , V_39 ) , V_37 ) ;
}
for ( V_39 = 0 ; V_39 < 4 ; V_39 ++ ) {
V_37 = F_114 ( V_6 , V_51 , F_153 ( V_191 , V_39 ) ) ;
V_37 &= ~ V_223 ;
V_37 |= 102 << V_224 ;
F_116 ( V_6 , V_51 , F_153 ( V_191 , V_39 ) , V_37 ) ;
}
for ( V_39 = 0 ; V_39 < 4 ; V_39 ++ ) {
V_37 = F_114 ( V_6 , V_51 , F_154 ( V_191 , V_39 ) ) ;
V_37 &= ~ V_225 ;
F_116 ( V_6 , V_51 , F_154 ( V_191 , V_39 ) , V_37 ) ;
}
#if 0
...
V_37 |= V_211 | V_212 ;
F_116 ( V_6 , V_51 , F_149 ( V_191 ) , V_37 ) ;
V_37 = F_114 ( V_6 , V_51 , V_226 ) ;
V_37 |= V_227 ;
F_116 ( V_6 , V_51 , V_226 , V_37 ) ;
F_127 ( & V_6 -> V_183 ) ;
V_2 -> V_180 ( & V_13 -> V_3 ,
V_48 -> V_53 -> V_92 ,
V_60 ) ;
...
if ( ! F_158 ( V_18 -> V_4 ) )
F_159 ( & V_18 -> V_3 ,
V_18 -> V_4 -> V_172 . V_173 ,
V_174 ) ;
}
static void
F_160 ( struct V_2 * V_2 , struct V_17 * V_18 )
{
F_161 ( V_18 ) ;
F_162 ( V_18 ) ;
V_2 -> V_139 = true ;
...
F_168 ( V_228 , V_80 ) ;
F_169 ( V_18 ) ;
if ( F_80 ( V_4 ) && ! F_170 ( V_4 ) ) {
T_2 V_110 = F_6 ( V_253 ) ;
F_20 ( V_253 , ( V_110 & ~ 0xf ) | 0xd ) ;
}
}
void F_171 ( struct V_1 * V_4 , int V_11 , enum V_46 V_46 )
{
struct V_14 * V_15 ;
struct V_80 * V_80 ;
struct V_228 * V_228 ;
V_15 = F_172 ( sizeof( * V_15 ) , V_254 ) ;
if ( ! V_15 )
return;
V_228 = F_173 () ;
if ( ! V_228 ) {
