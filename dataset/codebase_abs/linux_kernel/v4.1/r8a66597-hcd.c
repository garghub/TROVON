...
V_301 -> V_320 = V_321 ;
V_301 -> V_322 = 0 ;
V_301 -> V_323 = V_1 -> V_57 ;
V_301 -> V_324 = 9 ;
V_301 -> V_325 = 0 ;
V_301 -> V_326 =
F_183 ( V_327 | V_328 ) ;
V_301 -> V_329 . V_330 . V_331 [ 0 ] =
( ( 1 << V_1 -> V_57 ) - 1 ) << 1 ;
V_301 -> V_329 . V_330 . V_331 [ 1 ] = ~ 0 ;
}
static int F_184 ( struct V_250 * V_251 , T_1 V_332 , T_1 V_333 ,
T_1 V_334 , char * V_258 , T_1 V_335 )
{
struct V_1 * V_1 = F_154 ( V_251 ) ;
int V_37 ;
...
struct V_1 * V_1 = F_154 ( V_251 ) ;
int V_13 ;
F_49 ( & V_1 -> V_101 . V_63 -> V_65 , L_20 , V_356 ) ;
for ( V_13 = 0 ; V_13 < V_1 -> V_57 ; V_13 ++ ) {
struct V_198 * V_199 = & V_1 -> V_113 [ V_13 ] ;
unsigned long V_289 = F_156 ( V_13 ) ;
if ( ! ( V_199 -> V_13 & V_216 ) )
...
V_199 -> V_13 &= ~ V_357 ;
V_199 -> V_13 |= V_360 << 16 ;
F_12 ( V_1 , V_361 , V_361 | V_291 , V_289 ) ;
F_14 ( V_362 ) ;
F_12 ( V_1 , V_291 , V_361 | V_291 , V_289 ) ;
}
return 0 ;
}
static int F_188 ( struct V_363 * V_65 )
{
struct V_1 * V_1 = F_28 ( V_65 ) ;
int V_13 ;
F_49 ( V_65 , L_20 , V_356 ) ;
F_26 ( V_1 ) ;
for ( V_13 = 0 ; V_13 < V_1 -> V_57 ; V_13 ++ ) {
struct V_198 * V_199 = & V_1 -> V_113 [ V_13 ] ;
...
static int F_189 ( struct V_363 * V_65 )
{
struct V_1 * V_1 = F_28 ( V_65 ) ;
struct V_250 * V_251 = F_92 ( V_1 ) ;
F_49 ( V_65 , L_20 , V_356 ) ;
...
static int F_191 ( struct V_364 * V_365 )
{
struct V_1 * V_1 = F_192 ( V_365 ) ;
struct V_250 * V_251 = F_92 ( V_1 ) ;
F_193 ( & V_1 -> V_194 ) ;
F_194 ( V_251 ) ;
F_195 ( V_1 -> V_3 ) ;
...
static int F_198 ( struct V_364 * V_365 )
{
char V_366 [ 8 ] ;
struct V_367 * V_368 = NULL , * V_369 ;
int V_370 = - 1 ;
void T_7 * V_3 = NULL ;
...
if ( V_365 -> V_65 . V_372 ) {
V_37 = - V_373 ;
F_48 ( & V_365 -> V_65 , L_23 ) ;
goto V_374;
}
V_368 = F_200 ( V_365 , V_375 , 0 ) ;
if ( ! V_368 ) {
V_37 = - V_188 ;
F_48 ( & V_365 -> V_65 , L_24 ) ;
goto V_374;
}
V_369 = F_200 ( V_365 , V_376 , 0 ) ;
if ( ! V_369 ) {
V_37 = - V_188 ;
F_48 ( & V_365 -> V_65 ,
L_25 ) ;
...
V_370 = V_369 -> V_377 ;
V_371 = V_369 -> V_293 & V_378 ;
V_3 = F_201 ( V_368 -> V_377 , F_202 ( V_368 ) ) ;
if ( V_3 == NULL ) {
V_37 = - V_106 ;
F_48 ( & V_365 -> V_65 , L_26 ) ;
goto V_374;
}
if ( V_365 -> V_65 . V_379 == NULL ) {
F_48 ( & V_365 -> V_65 , L_27 ) ;
V_37 = - V_188 ;
goto V_374;
}
V_251 = F_203 ( & V_380 , & V_365 -> V_65 , ( char * ) V_381 ) ;
if ( ! V_251 ) {
V_37 = - V_106 ;
F_48 ( & V_365 -> V_65 , L_28 ) ;
goto V_374;
}
V_1 = F_154 ( V_251 ) ;
memset ( V_1 , 0 , sizeof( struct V_1 ) ) ;
F_204 ( V_365 , V_1 ) ;
V_1 -> V_17 = F_205 ( & V_365 -> V_65 ) ;
V_1 -> V_41 = V_371 == V_382 ;
if ( V_1 -> V_17 -> V_18 ) {
snprintf ( V_366 , sizeof( V_366 ) , L_29 , V_365 -> V_383 ) ;
V_1 -> V_19 = F_206 ( & V_365 -> V_65 , V_366 ) ;
if ( F_207 ( V_1 -> V_19 ) ) {
F_48 ( & V_365 -> V_65 , L_30 ,
V_366 ) ;
V_37 = F_208 ( V_1 -> V_19 ) ;
goto V_384;
}
...
F_45 ( & V_1 -> V_112 ) ;
V_251 -> V_386 = V_368 -> V_377 ;
V_251 -> V_387 = 1 ;
V_37 = F_211 ( V_251 , V_370 , V_371 ) ;
if ( V_37 != 0 ) {
F_48 ( & V_365 -> V_65 , L_31 ) ;
goto V_385;
}
F_212 ( V_251 -> V_318 . V_388 ) ;
return 0 ;
V_385:
if ( V_1 -> V_17 -> V_18 )
F_196 ( V_1 -> V_19 ) ;
