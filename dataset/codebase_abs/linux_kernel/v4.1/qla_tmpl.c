...
int V_127 = 0 ;
V_127 = sscanf ( V_128 , L_40 ,
V_126 + 0 , V_126 + 1 , V_126 + 2 , V_126 + 3 , V_126 + 4 , V_126 + 5 ) ;
V_116 -> V_129 [ 0 ] = V_126 [ 3 ] << 24 | V_126 [ 2 ] << 16 | V_126 [ 1 ] << 8 | V_126 [ 0 ] ;
V_116 -> V_129 [ 1 ] = V_126 [ 5 ] << 8 | V_126 [ 4 ] ;
V_116 -> V_129 [ 2 ] = 0x12345678 ;
}
static void
F_58 ( struct V_115 * V_116 ,
struct V_1 * V_2 )
{
V_116 -> V_130 [ 0 ] = V_2 -> V_3 -> V_131 ;
V_116 -> V_130 [ 1 ] = V_2 -> V_3 -> V_132 ;
V_116 -> V_130 [ 2 ] = V_2 -> V_3 -> V_133 ;
V_116 -> V_130 [ 3 ] =
V_2 -> V_3 -> V_134 << 16 | V_2 -> V_3 -> V_135 ;
V_116 -> V_130 [ 4 ] =
V_2 -> V_3 -> V_136 [ 1 ] << 16 | V_2 -> V_3 -> V_136 [ 0 ] ;
}
static void
F_59 ( struct V_1 * V_2 ,
struct V_115 * V_116 )
...
while ( V_12 -- )
V_137 += * V_7 ++ ;
V_137 = ( V_137 & 0xffffffff ) + ( V_137 >> 32 ) ;
return ~ V_137 ;
}
static inline int
F_61 ( struct V_115 * V_116 )
{
return F_60 ( V_116 , V_116 -> V_138 ) == 0 ;
}
static inline int
F_62 ( struct V_115 * V_116 )
{
return V_116 -> V_139 == V_140 ;
}
static void
F_63 ( struct V_1 * V_2 )
{
struct V_115 * V_116 = V_2 -> V_3 -> V_141 ;
T_3 V_8 ;
if ( F_64 ( V_116 ) ) {
V_8 = V_116 -> V_138 ;
