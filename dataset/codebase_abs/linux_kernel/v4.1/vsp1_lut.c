...
{
struct V_1 * V_2 = F_8 ( V_12 ) ;
V_46 -> V_29 = * F_12 ( & V_2 -> V_4 , V_21 , V_46 -> V_30 ,
V_46 -> V_34 ) ;
return 0 ;
}
...
V_46 -> V_29 . V_23 != V_27 )
V_46 -> V_29 . V_23 = V_27 ;
V_29 = F_12 ( & V_2 -> V_4 , V_21 , V_46 -> V_30 ,
V_46 -> V_34 ) ;
if ( V_46 -> V_30 == V_47 ) {
V_46 -> V_29 = * V_29 ;
return 0 ;
}
V_29 -> V_43 = F_16 (unsigned int, fmt->format.width,
LUT_MIN_SIZE, LUT_MAX_SIZE) ;
V_29 -> V_44 = F_16 (unsigned int, fmt->format.height,
LUT_MIN_SIZE, LUT_MAX_SIZE) ;
V_29 -> V_48 = V_49 ;
V_29 -> V_50 = V_51 ;
V_46 -> V_29 = * V_29 ;
V_29 = F_12 ( & V_2 -> V_4 , V_21 , V_47 ,
V_46 -> V_34 ) ;
* V_29 = V_46 -> V_29 ;
return 0 ;
}
struct V_1 * F_17 ( struct V_52 * V_5 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_53 ;
V_2 = F_18 ( V_5 -> V_54 , sizeof( * V_2 ) , V_55 ) ;
if ( V_2 == NULL )
return F_19 ( - V_56 ) ;
V_2 -> V_4 . type = V_57 ;
V_53 = F_20 ( V_5 , & V_2 -> V_4 , 2 ) ;
if ( V_53 < 0 )
return F_19 ( V_53 ) ;
V_12 = & V_2 -> V_4 . V_12 ;
F_21 ( V_12 , & V_58 ) ;
