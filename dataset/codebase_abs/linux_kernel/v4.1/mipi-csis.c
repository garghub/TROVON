...
V_50 = V_104 ;
memcpy ( V_98 -> V_84 , V_11 -> V_105 + V_50 , V_98 -> V_85 ) ;
V_98 -> V_84 = NULL ;
F_52 () ;
}
if ( ( V_99 & V_106 ) || V_24 ) {
...
static int F_53 ( struct V_108 * V_45 ,
struct V_1 * V_11 )
{
struct V_109 * V_110 = V_45 -> V_44 . V_111 ;
struct V_112 V_113 ;
if ( F_54 ( V_110 , L_16 ,
& V_11 -> V_114 ) )
V_11 -> V_114 = V_115 ;
...
& V_11 -> V_116 ) )
return - V_42 ;
V_110 = F_55 ( V_110 , NULL ) ;
if ( ! V_110 ) {
F_24 ( & V_45 -> V_44 , L_18 ,
V_45 -> V_44 . V_111 -> V_117 ) ;
return - V_42 ;
}
F_56 ( V_110 , & V_113 ) ;
V_11 -> V_69 = V_113 . V_118 . V_119 - V_120 ;
if ( V_11 -> V_69 >= V_121 )
return - V_122 ;
F_54 ( V_110 , L_19 ,
& V_11 -> V_35 ) ;
V_11 -> V_39 = F_57 ( V_110 ,
L_20 ) ;
V_11 -> V_22 = V_113 . V_123 . V_124 . V_125 ;
F_58 ( V_110 ) ;
return 0 ;
}
static int F_59 ( struct V_108 * V_45 )
{
...
int V_46 = - V_132 ;
int V_8 ;
V_11 = F_60 ( V_44 , sizeof( * V_11 ) , V_133 ) ;
if ( ! V_11 )
return - V_132 ;
F_61 ( & V_11 -> V_62 ) ;
F_62 ( & V_11 -> V_55 ) ;
V_11 -> V_45 = V_45 ;
V_127 = F_63 ( V_134 , V_44 -> V_111 ) ;
if ( F_64 ( V_127 == NULL ) )
return - V_42 ;
V_129 = V_127 -> V_84 ;
V_11 -> V_15 = V_129 -> V_15 ;
V_46 = F_53 ( V_45 , V_11 ) ;
if ( V_46 < 0 )
return V_46 ;
if ( V_11 -> V_22 == 0 || V_11 -> V_22 > V_11 -> V_116 ) {
F_24 ( V_44 , L_21 ,
V_11 -> V_22 , V_11 -> V_116 ) ;
return - V_42 ;
}
V_11 -> V_135 = F_65 ( V_44 , L_22 ) ;
if ( F_16 ( V_11 -> V_135 ) )
return F_22 ( V_11 -> V_135 ) ;
V_131 = F_66 ( V_45 , V_136 , 0 ) ;
V_11 -> V_105 = F_67 ( V_44 , V_131 ) ;
if ( F_16 ( V_11 -> V_105 ) )
return F_22 ( V_11 -> V_105 ) ;
...
return V_46 ;
if ( V_11 -> V_114 )
V_46 = F_70 ( V_11 -> clock [ V_141 ] ,
V_11 -> V_114 ) ;
else
F_71 ( V_44 , L_24 ) ;
if ( V_46 < 0 )
goto V_142;
V_46 = F_72 ( V_11 -> clock [ V_141 ] ) ;
if ( V_46 < 0 )
goto V_142;
...
V_11 -> V_149 [ V_79 ] . V_54 = V_152 ;
V_46 = F_76 ( & V_11 -> V_4 . V_153 ,
V_154 , V_11 -> V_149 , 0 ) ;
if ( V_46 < 0 )
goto V_143;
F_77 ( & V_11 -> V_4 , V_45 ) ;
...
F_83 ( & V_11 -> V_4 . V_153 ) ;
V_143:
F_84 ( V_11 -> clock [ V_141 ] ) ;
V_142:
F_15 ( V_11 ) ;
return V_46 ;
}
static int F_85 ( struct V_43 * V_44 , bool V_157 )
{
struct V_108 * V_45 = F_86 ( V_44 ) ;
...
static int F_81 ( struct V_43 * V_44 , bool V_157 )
{
struct V_108 * V_45 = F_86 ( V_44 ) ;
struct V_2 * V_4 = F_87 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
...
static int F_96 ( struct V_108 * V_45 )
{
struct V_2 * V_4 = F_87 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
F_97 ( & V_45 -> V_44 ) ;
