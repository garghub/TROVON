...
V_2 -> V_35 = V_265 -> V_40 ;
V_2 -> V_265 = V_265 ;
V_295 = F_170 ( V_265 , V_296 ,
F_171 ( V_297 ) ) ;
if ( F_172 ( V_295 ) )
return F_173 ( V_295 ) ;
V_298 . V_299 = V_295 [ V_300 ] . V_301 ;
V_2 -> V_175 = V_175 && ! ( F_174 ( V_2 -> V_251 ) ) ;
return 0 ;
}
static T_7 F_175 ( struct V_302 * V_303 ,
struct V_304 * V_282 , int V_305 )
{
struct V_279 * V_280 = F_176 ( V_303 ) ;
...
int F_177 ( struct V_1 * V_2 , struct V_311 * V_312 ,
...
F_178 ( & V_197 -> V_280 , & V_2 -> V_168 ) ;
F_179 ( & V_197 -> V_280 , L_69 , V_20 ) ;
V_197 -> V_20 = F_180 ( & V_197 -> V_280 ) ;
V_33 = F_181 ( & V_197 -> V_280 ) ;
if ( V_33 ) {
F_166 ( L_70 , V_301 , V_33 ) ;
F_182 ( & V_197 -> V_280 ) ;
goto V_324;
}
}
...
V_315 = L_72 ;
if ( V_314 ) {
V_315 = F_184 ( & V_197 -> V_107 -> V_327 , V_314 , V_326 ) ;
if ( F_172 ( V_315 ) )
V_315 = L_72 ;
}
}
F_166 ( L_73 ,
V_197 -> V_141 ? L_74 : L_75 ,
V_197 -> V_119 ? L_76 : L_75 ,
V_197 -> V_138 ? L_77 : L_75 ,
V_315 ) ;
F_156 ( V_314 ) ;
return 0 ;
V_325:
...
int F_185 ( struct V_1 * V_2 , struct V_328 * V_312 )
{
char V_48 [ 8 ] ;
int V_196 , V_33 ;
for ( V_196 = 0 ; V_196 < V_2 -> V_73 ; ++ V_196 ) {
snprintf ( V_48 , sizeof( V_48 ) , L_78 , V_196 ) ;
V_33 = F_177 ( V_2 , & V_312 -> V_240 [ V_196 ] , V_196 , V_48 , NULL ) ;
if ( V_33 )
goto V_329;
}
F_166 ( L_67 , V_2 -> V_73 ) ;
...
void F_186 ( struct V_1 * V_2 , const char * V_330 ,
const char * V_331 )
{
int V_196 ;
V_196 = F_187 () ;
...
static void V_286 ( struct V_332 * V_285 )
{
...
if ( F_114 ( V_2 -> V_240 ) ) {
struct V_84 * * V_333 = V_2 -> V_240 ;
unsigned V_196 = V_2 -> V_73 ;
for (; V_196 ; -- V_196 , ++ V_333 ) {
struct V_84 * V_197 = * V_333 ;
if ( ! V_197 )
continue;
F_77 ( V_197 ) ;
if ( V_2 -> V_288 )
...
static int F_192 ( struct V_334 * V_335 , struct V_6 * V_7 )
{
struct V_5 * V_4 = F_3 ( V_7 ) ;
struct V_336 * V_251 = V_335 -> V_265 -> V_251 ;
int V_196 ;
struct V_18 * V_19 ;
unsigned V_337 ;
int V_338 ;
struct V_339 * V_340 ;
V_340 = F_193 ( V_7 -> V_341 ) ;
if ( ! V_340 -> V_342 ) {
V_338 = F_169 ( V_4 -> V_2 , V_335 -> V_265 ,
V_4 -> V_2 -> V_175 ) ;
if ( V_338 )
return V_338 ;
...
V_4 -> V_251 = V_251 ;
V_196 = F_194 ( V_335 , V_7 ) ;
if ( V_196 < 0 )
return V_196 ;
V_298 . V_343 = V_196 ;
V_4 -> V_67 = V_196 ;
V_19 = F_195 ( V_251 , & V_344 ) ;
if ( ! V_19 )
goto V_345;
V_19 -> V_37 = V_4 -> V_2 ;
V_4 -> V_21 = V_19 ;
V_19 = F_195 ( V_251 , & V_346 ) ;
if ( ! V_19 )
goto V_345;
V_19 -> V_37 = V_4 -> V_2 ;
V_4 -> V_22 = V_19 ;
...
V_349 . V_348 =
V_346 . V_348 ;
V_337 = F_196 ( unsigned , V_102 / 1024 , 15 ) ;
V_350 . V_348 =
V_344 . V_348 ;
V_351 . V_352 = V_337 ;
V_353 . V_348 =
...
static void F_198 ( struct V_334 * V_335 , struct V_6 * V_7 )
{
struct V_5 * V_4 = F_3 ( V_7 ) ;
struct V_1 * V_2 = V_4 -> V_2 ;
F_8 ( V_4 , L_86 ) ;
...
static inline struct V_359 * F_201 ( struct V_360 * V_361 )
{
return F_4 ( F_202 ( V_361 ) , struct V_359 , V_362 ) ;
}
static inline struct V_339 * F_203 ( struct V_360 * V_361 )
{
return F_4 ( F_202 ( V_361 ) , struct V_339 ,
V_363 . V_362 ) ;
}
static void F_204 ( struct V_360 * V_361 )
{
struct V_359 * V_364 ;
V_364 = F_201 ( V_361 ) ;
F_156 ( V_364 ) ;
}
static T_4 F_205 ( struct V_359 * V_340 , char * V_365 )
{
struct V_339 * V_339 ;
V_339 = F_203 ( V_340 -> V_362 . V_366 . V_367 ) ;
return F_132 ( V_340 -> V_197 , & V_339 -> V_2 -> V_168 , V_365 ) ;
}
static T_4 F_206 ( struct V_359 * V_340 ,
const char * V_365 , T_6 V_158 )
{
struct V_339 * V_339 ;
V_339 = F_203 ( V_340 -> V_362 . V_366 . V_367 ) ;
return F_138 ( V_340 -> V_197 , & V_339 -> V_2 -> V_168 , V_365 , V_158 ) ;
}
static T_4 F_207 ( struct V_359 * V_340 , char * V_365 )
{
return F_127 ( V_340 -> V_197 , V_365 ) ;
}
static T_4 F_208 ( struct V_359 * V_340 ,
const char * V_365 , T_6 V_158 )
{
struct V_339 * V_339 ;
V_339 = F_203 ( V_340 -> V_362 . V_366 . V_367 ) ;
return F_134 ( V_340 -> V_197 , & V_339 -> V_2 -> V_168 , V_365 , V_158 ) ;
}
static T_4 F_209 ( struct V_359 * V_340 ,
char * V_365 )
{
return F_210 ( V_340 -> V_197 , V_365 ) ;
}
static T_4 F_211 ( struct V_359 * V_340 ,
const char * V_365 , T_6 V_158 )
{
return F_212 ( V_340 -> V_197 , V_365 , V_158 ) ;
}
static T_4 F_213 ( struct V_359 * V_340 , char * V_365 )
{
return F_214 ( V_340 -> V_197 , V_365 ) ;
}
static T_4 F_215 ( struct V_359 * V_340 ,
const char * V_365 , T_6 V_158 )
{
struct V_339 * V_339 ;
V_339 = F_203 ( V_340 -> V_362 . V_366 . V_367 ) ;
return F_216 ( V_340 -> V_197 , & V_339 -> V_2 -> V_168 , V_365 ,
V_158 ) ;
}
static T_4 F_217 ( struct V_359 * V_340 , char * V_365 )
{
return F_129 ( V_340 -> V_197 , V_365 ) ;
}
static T_4 F_218 ( struct V_359 * V_340 ,
const char * V_365 , T_6 V_158 )
{
return F_136 ( V_340 -> V_197 , V_365 , V_158 ) ;
}
static struct V_368 * F_219 ( struct V_368 * V_362 ,
const char * V_20 )
{
struct V_359 * V_340 ;
struct V_339 * V_339 ;
...
V_370 ++ ;
V_338 = F_220 ( V_370 , 0 , & V_371 ) ;
if ( V_338 )
return F_148 ( V_338 ) ;
V_339 = F_203 ( & V_362 -> V_366 ) ;
if ( V_371 >= V_233 )
return F_148 ( - V_372 ) ;
F_221 ( & V_339 -> V_28 ) ;
if ( V_339 -> V_373 || V_339 -> V_2 -> V_240 [ V_371 ] ) {
V_338 = - V_317 ;
goto V_374;
}
V_340 = F_147 ( sizeof( * V_340 ) , V_77 ) ;
if ( ! V_340 ) {
V_338 = - V_242 ;
goto V_374;
}
...
V_369 . V_141 = true ;
V_338 = F_177 ( V_339 -> V_2 , & V_369 , V_371 , V_20 ,
( const char * * ) & V_362 -> V_366 . V_375 ) ;
if ( V_338 ) {
F_156 ( V_340 ) ;
goto V_374;
}
V_340 -> V_197 = V_339 -> V_2 -> V_240 [ V_371 ] ;
V_340 -> V_376 = V_371 ;
F_222 ( & V_339 -> V_28 ) ;
F_223 ( & V_340 -> V_362 , V_20 , & V_377 ) ;
return & V_340 -> V_362 ;
V_374:
F_222 ( & V_339 -> V_28 ) ;
return F_148 ( V_338 ) ;
}
static void F_224 ( struct V_368 * V_362 , struct V_360 * V_361 )
{
struct V_359 * V_364 ;
struct V_339 * V_339 ;
V_364 = F_201 ( V_361 ) ;
...
if ( V_339 -> V_373 ) {
struct V_360 * V_251 ;
V_251 = V_362 -> V_366 . V_367 -> V_367 ;
F_225 ( V_251 ) ;
}
F_160 ( V_364 -> V_197 , V_339 -> V_2 -> V_288 ) ;
V_339 -> V_2 -> V_240 [ V_364 -> V_376 ] = NULL ;
V_364 -> V_376 = 0 ;
F_222 ( & V_339 -> V_28 ) ;
F_226 ( V_361 ) ;
}
static void F_227 ( struct V_360 * V_361 )
{
struct V_339 * V_340 = F_203 ( V_361 ) ;
F_228 ( & V_340 -> V_363 ) ;
}
static T_4 F_229 ( struct V_339 * V_340 , char * V_365 )
{
int V_378 ;
F_221 ( & V_340 -> V_28 ) ;
V_378 = sprintf ( V_365 , L_88 , V_340 -> V_2 -> V_175 ) ;
F_222 ( & V_340 -> V_28 ) ;
return V_378 ;
}
static T_4 F_230 ( struct V_339 * V_340 , const char * V_365 ,
T_6 V_158 )
{
int V_338 ;
bool V_379 ;
...
V_338 = F_231 ( V_365 , & V_379 ) ;
if ( ! V_338 ) {
V_340 -> V_2 -> V_175 = V_379 ;
V_338 = V_158 ;
}
F_222 ( & V_340 -> V_28 ) ;
return V_338 ;
}
static T_4 F_232 ( struct V_339 * V_340 , char * V_365 )
{
int V_378 ;
F_221 ( & V_340 -> V_28 ) ;
V_378 = sprintf ( V_365 , L_88 , V_340 -> V_2 -> V_246 ) ;
F_222 ( & V_340 -> V_28 ) ;
return V_378 ;
}
static T_4 F_233 ( struct V_339 * V_340 ,
const char * V_365 , T_6 V_158 )
{
int V_338 ;
V_60 V_371 ;
...
V_338 = F_220 ( V_365 , 0 , & V_371 ) ;
if ( V_338 )
goto V_380;
V_338 = F_144 ( V_371 ) ;
if ( V_338 )
goto V_380;
F_157 ( V_340 -> V_2 , V_371 ) ;
V_338 = V_158 ;
V_380:
F_222 ( & V_340 -> V_28 ) ;
return V_338 ;
}
static void F_234 ( struct V_381 * V_341 )
{
struct V_339 * V_340 ;
V_340 = F_193 ( V_341 ) ;
F_142 ( V_340 -> V_2 ) ;
...
static struct V_381 * F_235 ( void )
{
struct V_339 * V_340 ;
struct V_311 V_369 ;
int V_33 ;
...
return F_148 ( - V_242 ) ;
F_236 ( & V_340 -> V_28 ) ;
V_340 -> V_363 . V_382 = F_234 ;
V_340 -> V_2 = F_146 ( V_340 -> V_2 ) ;
if ( F_172 ( V_340 -> V_2 ) ) {
V_33 = F_173 ( V_340 -> V_2 ) ;
goto V_383;
}
V_33 = F_165 ( V_340 -> V_2 , V_233 ) ;
if ( V_33 )
goto V_383;
V_33 = F_157 ( V_340 -> V_2 ,
V_384 ) ;
if ( V_33 )
goto V_385;
F_166 ( V_386 L_89 V_387 L_90 ) ;
memset ( & V_369 , 0 , sizeof( V_369 ) ) ;
V_369 . V_141 = true ;
V_33 = F_177 ( V_340 -> V_2 , & V_369 , 0 , L_91 ,
( const char * * ) & V_340 -> V_363 . V_362 . V_366 . V_375 ) ;
V_340 -> V_388 . V_197 = V_340 -> V_2 -> V_240 [ 0 ] ;
V_340 -> V_388 . V_376 = 0 ;
F_223 ( & V_340 -> V_388 . V_362 , L_91 , & V_377 ) ;
V_340 -> V_389 [ 0 ] = & V_340 -> V_388 . V_362 ;
V_340 -> V_363 . V_362 . V_389 = V_340 -> V_389 ;
F_223 ( & V_340 -> V_363 . V_362 , L_75 , & V_390 ) ;
return & V_340 -> V_363 ;
V_385:
F_156 ( V_340 -> V_2 -> V_240 ) ;
V_383:
F_156 ( V_340 ) ;
return F_148 ( V_33 ) ;
}
...
V_340 = F_4 ( V_7 -> V_341 , struct V_339 , V_363 ) ;
F_221 ( & V_340 -> V_28 ) ;
V_340 -> V_373 -- ;
F_222 ( & V_340 -> V_28 ) ;
F_156 ( V_4 ) ;
}
static struct V_6 * F_238 ( struct V_381 * V_341 )
{
struct V_339 * V_340 = F_193 ( V_341 ) ;
...
unsigned V_196 ;
V_312 -> V_73 =
F_30 ( V_398 -> V_240 ? : ( V_398 -> V_399 ? : 1u ) ,
( unsigned ) V_233 ) ;
for ( V_196 = 0 , V_197 = V_312 -> V_240 ; V_196 < V_312 -> V_73 ; ++ V_196 , ++ V_197 ) {
V_197 -> V_119 = ! ! V_398 -> V_119 [ V_196 ] ;
V_197 -> V_138 = ! ! V_398 -> V_138 [ V_196 ] ;
V_197 -> V_141 = ! ! V_398 -> V_141 [ V_196 ] ;
V_197 -> V_318 =
V_398 -> V_399 > V_196 && V_398 -> V_132 [ V_196 ] [ 0 ]
? V_398 -> V_132 [ V_196 ]
: NULL ;
}
V_312 -> V_400 = NULL ;
