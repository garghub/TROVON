...
struct V_611 * V_613 ;
struct V_611 V_614 ;
V_16 = F_286 ( & V_3 -> V_4 , sizeof( * V_16 ) , V_615 ) ;
if ( ! V_16 )
return - V_616 ;
V_16 -> V_157 = V_3 ;
F_287 ( & V_3 -> V_4 , V_16 ) ;
...
V_16 -> V_141 . V_26 = 0 ;
#endif
V_613 = F_294 ( V_3 , V_617 , L_178 ) ;
if ( ! V_613 ) {
V_613 = F_295 ( V_3 , V_617 , 0 ) ;
if ( ! V_613 ) {
F_44 ( L_179 ) ;
return - V_153 ;
}
...
V_612 = V_613 ;
V_16 -> V_19 = F_296 ( & V_3 -> V_4 , V_613 -> T_9 ,
F_297 ( V_613 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_180 ) ;
return - V_616 ;
}
V_613 = F_294 ( V_3 , V_617 , L_181 ) ;
if ( ! V_613 ) {
V_613 = F_295 ( V_3 , V_617 , 0 ) ;
if ( ! V_613 ) {
F_44 ( L_179 ) ;
...
V_16 -> V_21 = F_296 ( & V_3 -> V_4 , V_613 -> T_9 ,
F_297 ( V_613 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_182 ) ;
return - V_616 ;
}
V_613 = F_294 ( V_3 , V_617 , L_183 ) ;
if ( ! V_613 ) {
V_613 = F_295 ( V_3 , V_617 , 0 ) ;
if ( ! V_613 ) {
F_44 ( L_179 ) ;
...
V_16 -> V_23 = F_296 ( & V_3 -> V_4 , V_613 -> T_9 ,
F_297 ( V_613 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_184 ) ;
return - V_616 ;
...
V_623 , F_300 ( & V_3 -> V_4 ) , V_16 -> V_157 ) ;
if ( V_155 < 0 ) {
F_44 ( L_186 ) ;
return V_155 ;
}
...
V_625 = F_301 ( V_628 , V_3 -> V_4 . V_598 ) ;
if ( ! V_625 ) {
F_44 ( L_187 ) ;
return - V_202 ;
}
...
static int T_13 F_307 ( struct V_2 * V_3 )
{
struct V_1 * V_16 = F_1 ( V_3 ) ;
F_308 ( & V_3 -> V_4 ) ;
F_73 ( V_16 -> V_196 > 0 ) ;
...
static int F_310 ( struct V_632 * V_4 )
{
...
static int F_314 ( struct V_632 * V_4 )
{
struct V_2 * V_157 = F_4 ( V_4 ) ;
struct V_1 * V_16 = F_1 ( V_157 ) ;
int V_155 ;
