...
static inline int F_42 ( struct V_114 * V_114 )
{
return F_43 ( V_114 ) && ! F_44 ( V_114 ) ;
}
static int F_45 ( struct V_115 * V_115 , int (* F_46)( struct V_1 * , void * ) ,
void * V_103 , struct V_93 * V_93 ,
void (* F_47)( struct V_93 * ) )
{
struct V_114 * V_116 ;
int V_117 = - V_102 ;
V_116 = V_115 -> V_118 . V_114 -> V_119 ;
if ( ! V_116 || F_48 ( V_116 ) )
goto V_120;
F_49 ( & F_50 ( V_116 ) -> V_121 ) ;
if ( F_42 ( V_115 -> V_118 . V_114 )
&& F_40 ( V_93 ) )
V_117 = 0 ;
F_51 ( & F_50 ( V_116 ) -> V_121 ) ;
if ( ! V_117 ) {
V_117 = F_52 ( V_115 , F_46 , V_103 ) ;
if ( V_117 )
F_37 ( V_93 , F_47 ) ;
}
V_120:
...
static int F_53 ( struct V_122 * V_122 , struct V_115 * V_115 )
{
struct V_45 * V_46 = V_122 -> V_123 ;
return F_45 ( V_115 , F_38 , V_46 ,
& V_46 -> V_93 , V_124 ) ;
}
static int F_54 ( struct V_122 * V_122 , struct V_115 * V_115 )
{
struct V_45 * V_46 = V_122 -> V_123 ;
F_37 ( & V_46 -> V_93 , V_124 ) ;
return F_55 ( V_122 , V_115 ) ;
}
void F_56 ( struct V_45 * V_46 )
{
struct V_114 * V_114 ;
if ( ! V_125 )
return;
V_114 = F_57 ( V_46 -> V_126 , V_125 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_46 -> V_128 = V_114 ;
V_114 = F_57 ( L_59 , V_46 -> V_128 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_46 -> V_129 = V_114 ;
V_114 = F_57 ( L_60 , V_46 -> V_128 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_46 -> V_130 = V_114 ;
V_114 = F_59 ( L_61 , V_131 | V_132 ,
V_46 -> V_128 , V_46 ,
& V_133 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
...
static void F_62 ( struct V_114 * * V_135 )
{
F_63 ( * V_135 ) ;
* V_135 = NULL ;
}
...
do {
V_138 = * V_137 ;
} while ( V_138 . V_139 != V_137 -> V_139 );
if ( ! V_138 . V_140 )
return;
F_2 ( V_2 , L_63 ,
V_138 . V_139 ,
F_3 ( V_30 - V_138 . V_36 ) ,
V_138 . V_141 , V_138 . line ,
V_138 . V_140 ) ;
}
static void F_65 ( struct V_1 * V_2 ,
const char * V_142 ,
unsigned int V_139 , struct V_136 * V_137 , unsigned long V_30 )
{
unsigned int V_143 ;
unsigned int V_32 ;
F_2 ( V_2 , L_32 , V_142 ) ;
V_143 = V_139 % V_144 ;
for ( V_32 = V_143 ; V_32 < V_144 ; V_32 ++ )
F_64 ( V_2 , V_137 + V_32 , V_30 ) ;
for ( V_32 = 0 ; V_32 < V_143 ; V_32 ++ )
F_64 ( V_2 , V_137 + V_32 , V_30 ) ;
}
static int F_66 ( struct V_1 * V_2 , void * V_145 )
{
struct V_87 * V_88 = V_2 -> V_100 ;
unsigned long V_54 = V_101 ;
F_2 ( V_2 , L_49 , 0 ) ;
F_6 ( V_2 , L_64 ) ;
F_65 ( V_2 , L_65 , V_88 -> V_146 , V_88 -> V_147 , V_54 ) ;
F_65 ( V_2 , L_66 , V_88 -> V_148 , V_88 -> V_149 , V_54 ) ;
return 0 ;
}
static int F_67 ( struct V_122 * V_122 , struct V_115 * V_115 )
{
struct V_87 * V_88 = V_122 -> V_123 ;
return F_45 ( V_115 , F_66 , V_88 ,
& V_88 -> V_93 , V_113 ) ;
}
static int F_68 ( struct V_122 * V_122 , struct V_115 * V_115 )
{
struct V_87 * V_88 = V_122 -> V_123 ;
F_37 ( & V_88 -> V_93 , V_113 ) ;
return F_55 ( V_122 , V_115 ) ;
}
static int F_69 ( struct V_1 * V_2 , void * V_145 )
{
struct V_87 * V_88 = V_2 -> V_100 ;
unsigned long V_30 = V_101 ;
struct V_9 * V_150 , * V_151 ;
F_2 ( V_2 , L_49 , 0 ) ;
F_22 ( & V_88 -> V_46 -> V_57 ) ;
V_150 = V_88 -> V_92 ;
if ( V_150 )
...
static int F_70 ( struct V_122 * V_122 , struct V_115 * V_115 )
{
struct V_87 * V_88 = V_122 -> V_123 ;
return F_45 ( V_115 , F_69 , V_88 ,
& V_88 -> V_93 , V_113 ) ;
}
static int F_71 ( struct V_122 * V_122 , struct V_115 * V_115 )
{
struct V_87 * V_88 = V_122 -> V_123 ;
F_37 ( & V_88 -> V_93 , V_113 ) ;
return F_55 ( V_122 , V_115 ) ;
}
void F_72 ( struct V_87 * V_88 )
{
struct V_114 * V_154 = V_88 -> V_46 -> V_130 ;
struct V_114 * V_114 ;
if ( ! V_154 )
return;
V_114 = F_57 ( L_67 , V_154 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_88 -> V_155 = V_114 ;
V_114 = F_59 ( L_68 , V_131 | V_132 ,
V_88 -> V_155 , V_88 ,
& V_156 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_88 -> V_157 = V_114 ;
V_114 = F_59 ( L_69 , V_131 | V_132 ,
V_88 -> V_155 , V_88 ,
& V_158 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
...
{
struct V_162 * V_163 = F_75 ( V_161 , struct V_162 , V_164 ) ;
F_2 ( V_2 , L_70 , V_163 -> V_165 ,
F_31 ( V_166 , & V_163 -> V_63 ) ? L_71 : L_72 ,
F_31 ( V_167 , & V_163 -> V_63 ) ? L_73 : L_74 ,
F_31 ( V_168 , & V_163 -> V_63 ) ? L_75 : L_76
) ;
}
static int F_76 ( struct V_1 * V_2 , void * V_145 )
{
struct V_47 * V_42 = V_2 -> V_100 ;
F_2 ( V_2 , L_49 , 0 ) ;
if ( F_77 ( V_42 , V_169 ) ) {
F_78 ( V_2 , V_42 -> V_170 ) ;
F_79 ( V_2 , V_42 -> V_170 , L_77 , F_74 ) ;
F_80 ( V_42 ) ;
}
return 0 ;
}
static int F_81 ( struct V_1 * V_2 , void * V_145 )
{
struct V_47 * V_42 = V_2 -> V_100 ;
F_2 ( V_2 , L_49 , 0 ) ;
if ( F_77 ( V_42 , V_169 ) ) {
F_78 ( V_2 , V_42 -> V_171 ) ;
F_79 ( V_2 , V_42 -> V_171 , L_78 , NULL ) ;
F_80 ( V_42 ) ;
}
return 0 ;
}
static int F_82 ( struct V_1 * V_2 , void * V_145 )
{
struct V_47 * V_42 = V_2 -> V_100 ;
...
V_150 = F_23 ( & V_42 -> V_58 [ V_32 ] ,
struct V_9 , V_59 ) ;
V_151 = F_23 ( & V_42 -> V_172 [ V_32 ] ,
struct V_9 , V_173 ) ;
if ( V_150 )
F_9 ( V_2 , V_150 , V_30 ) ;
if ( V_151 && V_151 != V_150 )
...
static int F_83 ( struct V_1 * V_2 , void * V_145 )
{
struct V_47 * V_42 = V_2 -> V_100 ;
struct V_174 * V_175 ;
enum V_176 V_177 ;
if ( ! F_77 ( V_42 , V_169 ) )
return - V_178 ;
V_175 = & V_42 -> V_179 -> V_175 ;
F_22 ( & V_175 -> V_180 ) ;
for ( V_177 = V_181 ; V_177 <= V_182 ; V_177 ++ ) {
F_2 ( V_2 , L_79 , V_175 -> V_183 [ V_177 ] ) ;
}
F_24 ( & V_175 -> V_180 ) ;
F_80 ( V_42 ) ;
return 0 ;
}
void F_84 ( struct V_47 * V_42 )
{
struct V_114 * V_184 = V_42 -> V_46 -> V_129 ;
char V_185 [ 8 ] ;
char V_186 [ 8 ] ;
char * V_187 = NULL ;
struct V_114 * V_114 ;
...
V_114 = F_57 ( V_186 , V_184 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_42 -> V_189 = V_114 ;
snprintf ( V_185 , sizeof( V_185 ) , L_80 , V_42 -> V_43 ) ;
V_187 = F_85 ( V_190 , L_81 ,
V_42 -> V_46 -> V_126 , V_42 -> V_44 ) ;
if ( ! V_187 )
goto V_127;
V_114 = F_86 ( V_185 , V_188 , V_187 ) ;
F_87 ( V_187 ) ;
V_187 = NULL ;
if ( F_58 ( V_114 ) )
goto V_127;
V_42 -> V_191 = V_114 ;
#define F_88 ( V_126 ) do { \
...
void F_90 ( struct V_200 * V_201 )
{
struct V_114 * V_202 = V_201 -> V_88 -> V_155 ;
struct V_114 * V_114 ;
char V_186 [ 8 ] ;
if ( ! V_202 )
return;
snprintf ( V_186 , sizeof( V_186 ) , L_80 , V_201 -> V_42 -> V_44 ) ;
V_114 = F_57 ( V_186 , V_202 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_201 -> V_203 = V_114 ;
return;
...
void F_91 ( struct V_200 * V_201 )
{
F_62 ( & V_201 -> V_203 ) ;
}
static int F_92 ( struct V_1 * V_2 , void * V_145 )
{
F_2 ( V_2 , L_83 , F_93 () ) ;
F_2 ( V_2 , L_84 , V_204 ) ;
F_2 ( V_2 , L_85 , V_205 ) ;
...
static int F_94 ( struct V_122 * V_122 , struct V_115 * V_115 )
{
return F_52 ( V_115 , F_92 , NULL ) ;
}
void F_95 ( void )
{
F_62 ( & V_125 ) ;
...
{
struct V_114 * V_114 ;
V_114 = F_57 ( L_88 , NULL ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_209 = V_114 ;
V_114 = F_59 ( L_89 , 0444 , V_209 , NULL , & V_210 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_208 = V_114 ;
V_114 = F_57 ( L_90 , V_209 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_125 = V_114 ;
V_114 = F_57 ( L_91 , V_209 ) ;
if ( F_58 ( V_114 ) )
goto V_127;
V_188 = V_114 ;
return 0 ;
