...
F_64 ( V_75 ) ;
F_72 ( & V_75 -> V_132 ) ;
V_121 = F_65 ( V_55 -> V_133 , 1 ) ;
if ( V_118 ) {
F_87 ( V_55 -> V_2 , & V_75 -> V_76 ) ;
F_88 ( & V_75 -> V_134 , & V_55 -> V_135 ) ;
V_55 -> V_136 ++ ;
if ( V_121 -> V_137 )
...
static int F_130 ( struct V_2 * V_2 , bool V_160 )
{
int V_189 ;
struct V_54 * V_55 ;
struct V_190 * V_191 ;
...
static inline void
F_135 ( struct V_74 * V_75 , struct V_194 * V_11 )
{
struct V_92 * V_93 ;
F_68 ( & V_75 -> V_132 ) ;
...
static int F_136 ( struct V_196 * V_197 , unsigned long V_198 ,
void * V_199 )
{
struct V_194 * V_11 = F_137 ( V_199 ) ;
...
int V_213 = * V_212 ;
int V_214 ;
V_214 = F_143 ( V_204 , V_205 , V_206 , V_207 , V_208 ) ;
...
static struct V_54 * F_149 ( struct V_218 * V_219 , T_7 V_220 )
{
struct V_2 * V_2 = F_150 ( V_219 ) ;
...
static void * F_151 ( struct V_218 * V_219 , T_7 * V_220 )
__acquires( T_8 )
{
F_58 () ;
return * V_220 ? F_149 ( V_219 , * V_220 - 1 ) : V_225 ;
}
static void * F_152 ( struct V_218 * V_219 , void * V_226 , T_7 * V_220 )
{
struct V_190 * V_227 ;
struct V_221 * V_222 ;
struct V_54 * V_55 ;
++ * V_220 ;
if ( V_226 == V_225 )
return F_149 ( V_219 , 0 ) ;
V_55 = V_226 ;
V_222 = V_219 -> V_223 ;
if ( V_222 -> V_204 == V_61 ) {
V_227 = F_153 ( F_154 ( & V_55 -> V_60 ) ) ;
if ( V_227 )
return F_155 ( V_227 , struct V_54 , V_60 ) ;
...
V_227 = F_153 ( F_154 ( & V_55 -> V_62 ) ) ;
if ( V_227 )
return F_155 ( V_227 , struct V_54 , V_62 ) ;
V_228:
while ( ++ V_222 -> V_224 < V_192 ) {
F_36 (svc,
...
static void F_156 ( struct V_218 * V_219 , void * V_226 )
__releases( T_8 )
{
F_59 () ;
}
static int F_157 ( struct V_218 * V_219 , void * V_226 )
{
if ( V_226 == V_225 ) {
F_158 ( V_219 ,
L_29 ,
...
struct V_120 * V_121 = F_153 ( V_55 -> V_133 ) ;
if ( V_222 -> V_204 == V_61 ) {
#ifdef F_24
if ( V_55 -> V_40 == V_48 )
F_158 ( V_219 , L_32 ,
...
F_23 ( V_55 -> V_43 ) ,
V_121 -> V_195 ,
( V_55 -> V_12 & V_231 ) ? L_34 : L_35 ) ;
} else {
F_158 ( V_219 , L_36 ,
V_55 -> V_53 , V_121 -> V_195 ,
( V_55 -> V_12 & V_231 ) ? L_34 : L_35 ) ;
}
if ( V_55 -> V_12 & V_232 )
F_158 ( V_219 , L_37 ,
...
static int F_162 ( struct V_233 * V_233 , struct V_234 * V_234 )
{
return F_163 ( V_233 , V_234 , & V_235 ,
sizeof( struct V_221 ) ) ;
}
static int F_164 ( struct V_218 * V_219 , void * V_226 )
{
struct V_2 * V_2 = F_165 ( V_219 ) ;
struct V_100 V_236 ;
F_160 ( V_219 ,
L_42 ) ;
F_158 ( V_219 ,
...
static int F_166 ( struct V_233 * V_233 , struct V_234 * V_234 )
{
return F_167 ( V_233 , V_234 , F_164 ) ;
}
static int F_168 ( struct V_218 * V_219 , void * V_226 )
{
struct V_2 * V_2 = F_165 ( V_219 ) ;
...
static int F_171 ( struct V_233 * V_233 , struct V_234 * V_234 )
{
return F_167 ( V_233 , V_234 , F_168 ) ;
}
static int F_172 ( struct V_2 * V_2 , struct V_240 * V_171 )
{
#if F_173 ( V_241 ) || F_173 ( V_242 )
struct V_243 * V_244 ;
#endif
F_103 ( 2 , L_53 ,
V_171 -> V_245 ,
...
static void F_175 ( struct V_170 * V_253 ,
struct V_254 * V_255 )
{
...
static int
F_177 ( struct V_258 * V_259 , int V_260 , void T_6 * V_261 , unsigned int V_262 )
{
...
struct V_116 V_117 ;
struct V_14 * V_15 = F_41 ( V_2 ) ;
F_179 ( sizeof( V_263 ) > 255 ) ;
if ( ! F_180 ( F_178 ( V_259 ) -> V_265 , V_266 ) )
return - V_267 ;
if ( V_260 < V_268 || V_260 > V_269 )
return - V_144 ;
if ( V_262 != V_270 [ F_181 ( V_260 ) ] ) {
F_103 ( 1 , L_54 ,
V_262 , V_270 [ F_181 ( V_260 ) ] ) ;
return - V_144 ;
}
if ( F_182 ( V_263 , V_261 , V_262 ) != 0 )
return - V_271 ;
F_18 () ;
if ( V_260 == V_272 ||
V_260 == V_273 ) {
...
F_133 ( & V_15 -> V_276 ) ;
if ( V_260 == V_272 )
V_156 = F_183 ( V_2 , V_275 -> V_277 , V_275 -> V_278 ,
V_275 -> V_279 ) ;
else
V_156 = F_184 ( V_2 , V_275 -> V_277 ) ;
F_134 ( & V_15 -> V_276 ) ;
goto V_280;
}
F_133 ( & V_193 ) ;
if ( V_260 == V_281 ) {
V_156 = F_130 ( V_2 , false ) ;
goto V_282;
} else if ( V_260 == V_283 ) {
V_156 = F_172 ( V_2 , (struct V_240 * ) V_263 ) ;
goto V_282;
}
...
static void
F_185 ( struct V_293 * V_9 , struct V_54 * V_102 )
{
struct V_120 * V_121 ;
struct V_100 V_237 ;
V_121 = F_65 ( V_102 -> V_133 , 1 ) ;
V_9 -> V_59 = V_102 -> V_59 ;
V_9 -> V_4 = V_102 -> V_4 . V_46 ;
V_9 -> V_43 = V_102 -> V_43 ;
V_9 -> V_53 = V_102 -> V_53 ;
F_186 ( V_9 -> V_175 , V_121 -> V_195 , sizeof( V_9 -> V_175 ) ) ;
V_9 -> V_12 = V_102 -> V_12 ;
V_9 -> V_181 = V_102 -> V_181 / V_182 ;
V_9 -> V_180 = V_102 -> V_180 ;
V_9 -> V_136 = V_102 -> V_136 ;
F_78 ( & V_237 , & V_102 -> V_76 ) ;
F_81 ( & V_9 -> V_76 , & V_237 ) ;
}
static inline int
F_187 ( struct V_2 * V_2 ,
...
static inline int
F_189 ( struct V_2 * V_2 , const struct V_300 * V_295 ,
...
static inline void
F_190 ( struct V_2 * V_2 , struct V_240 * V_171 )
{
#if F_173 ( V_241 ) || F_173 ( V_242 )
struct V_243 * V_244 ;
#endif
...
static int
F_191 ( struct V_258 * V_259 , int V_260 , void T_6 * V_261 , int * V_262 )
{
...
return - V_144 ;
V_303 = V_305 [ F_181 ( V_260 ) ] ;
if ( * V_262 < ( int ) V_303 ) {
F_103 ( 1 , L_56 , * V_262 , V_303 ) ;
return - V_144 ;
}
if ( F_182 ( V_263 , V_261 , V_303 ) != 0 )
return - V_271 ;
if ( V_260 == V_306 ) {
...
if ( V_15 -> V_308 & V_309 ) {
V_307 [ 0 ] . V_277 = V_309 ;
F_186 ( V_307 [ 0 ] . V_278 , V_15 -> V_310 ,
sizeof( V_307 [ 0 ] . V_278 ) ) ;
V_307 [ 0 ] . V_279 = V_15 -> V_311 ;
}
if ( V_15 -> V_308 & V_312 ) {
V_307 [ 1 ] . V_277 = V_312 ;
F_186 ( V_307 [ 1 ] . V_278 , V_15 -> V_313 ,
sizeof( V_307 [ 1 ] . V_278 ) ) ;
V_307 [ 1 ] . V_279 = V_15 -> V_314 ;
}
if ( F_188 ( V_261 , & V_307 , sizeof( V_307 ) ) != 0 )
V_156 = - V_271 ;
F_134 ( & V_15 -> V_276 ) ;
return V_156 ;
}
...
sprintf ( V_316 , L_57 ,
F_159 ( V_229 ) , V_230 ) ;
if ( F_188 ( V_261 , V_316 , strlen ( V_316 ) + 1 ) != 0 ) {
V_156 = - V_271 ;
goto V_67;
}
...
if ( F_188 ( V_261 , & V_319 , sizeof( V_319 ) ) != 0 )
V_156 = - V_271 ;
}
break;
case V_322 :
...
if ( * V_262 != V_321 ) {
F_28 ( L_58 , * V_262 , V_321 ) ;
V_156 = - V_144 ;
goto V_67;
}
V_156 = F_187 ( V_2 , V_295 , V_261 ) ;
}
break;
case V_323 :
{
...
if ( V_55 ) {
F_185 ( V_298 , V_55 ) ;
if ( F_188 ( V_261 , V_298 , sizeof( * V_298 ) ) != 0 )
V_156 = - V_271 ;
} else
V_156 = - V_287 ;
}
...
V_321 = sizeof( * V_295 ) +
sizeof( struct V_301 ) * V_295 -> V_136 ;
if ( * V_262 != V_321 ) {
F_28 ( L_58 , * V_262 , V_321 ) ;
V_156 = - V_144 ;
goto V_67;
}
V_156 = F_189 ( V_2 , V_295 , V_261 ) ;
}
break;
case V_325 :
{
struct V_240 V_326 ;
F_190 ( V_2 , & V_326 ) ;
if ( F_188 ( V_261 , & V_326 , sizeof( V_326 ) ) != 0 )
V_156 = - V_271 ;
}
break;
default:
...
static int F_192 ( struct V_327 * V_328 , int V_329 ,
struct V_100 * V_237 )
{
struct V_330 * V_331 = F_193 ( V_328 , V_329 ) ;
if ( ! V_331 )
return - V_332 ;
if ( F_194 ( V_328 , V_333 , ( V_110 ) V_237 -> V_104 ) ||
F_194 ( V_328 , V_334 , ( V_110 ) V_237 -> V_105 ) ||
F_194 ( V_328 , V_335 , ( V_110 ) V_237 -> V_106 ) ||
F_195 ( V_328 , V_336 , V_237 -> V_107 ) ||
F_195 ( V_328 , V_337 , V_237 -> V_108 ) ||
F_194 ( V_328 , V_338 , ( V_110 ) V_237 -> V_111 ) ||
F_194 ( V_328 , V_339 , ( V_110 ) V_237 -> V_112 ) ||
F_194 ( V_328 , V_340 , ( V_110 ) V_237 -> V_113 ) ||
F_194 ( V_328 , V_341 , ( V_110 ) V_237 -> V_114 ) ||
F_194 ( V_328 , V_342 , ( V_110 ) V_237 -> V_115 ) )
goto V_343;
F_196 ( V_328 , V_331 ) ;
return 0 ;
V_343:
...
static int F_198 ( struct V_327 * V_328 , int V_329 ,
struct V_100 * V_237 )
{
struct V_330 * V_331 = F_193 ( V_328 , V_329 ) ;
if ( ! V_331 )
return - V_332 ;
if ( F_195 ( V_328 , V_333 , V_237 -> V_104 ) ||
F_195 ( V_328 , V_334 , V_237 -> V_105 ) ||
F_195 ( V_328 , V_335 , V_237 -> V_106 ) ||
F_195 ( V_328 , V_336 , V_237 -> V_107 ) ||
F_195 ( V_328 , V_337 , V_237 -> V_108 ) ||
F_195 ( V_328 , V_338 , V_237 -> V_111 ) ||
F_195 ( V_328 , V_339 , V_237 -> V_112 ) ||
F_195 ( V_328 , V_340 , V_237 -> V_113 ) ||
F_195 ( V_328 , V_341 , V_237 -> V_114 ) ||
F_195 ( V_328 , V_342 , V_237 -> V_115 ) )
goto V_343;
F_196 ( V_328 , V_331 ) ;
return 0 ;
V_343:
...
static int F_199 ( struct V_327 * V_328 ,
struct V_54 * V_55 )
{
struct V_120 * V_121 ;
struct V_173 * V_174 ;
...
. V_346 = ~ 0 } ;
struct V_100 V_237 ;
V_344 = F_193 ( V_328 , V_347 ) ;
if ( ! V_344 )
return - V_332 ;
if ( F_200 ( V_328 , V_348 , V_55 -> V_40 ) )
goto V_343;
if ( V_55 -> V_53 ) {
if ( F_194 ( V_328 , V_349 , V_55 -> V_53 ) )
goto V_343;
} else {
if ( F_200 ( V_328 , V_350 , V_55 -> V_59 ) ||
F_201 ( V_328 , V_351 , sizeof( V_55 -> V_4 ) , & V_55 -> V_4 ) ||
F_202 ( V_328 , V_352 , V_55 -> V_43 ) )
goto V_343;
}
V_121 = F_65 ( V_55 -> V_133 , 1 ) ;
V_174 = F_65 ( V_55 -> V_174 , 1 ) ;
if ( F_203 ( V_328 , V_353 , V_121 -> V_195 ) ||
( V_174 && F_203 ( V_328 , V_354 , V_174 -> V_195 ) ) ||
F_201 ( V_328 , V_355 , sizeof( V_12 ) , & V_12 ) ||
F_194 ( V_328 , V_356 , V_55 -> V_181 / V_182 ) ||
F_204 ( V_328 , V_357 , V_55 -> V_180 ) )
goto V_343;
F_78 ( & V_237 , & V_55 -> V_76 ) ;
if ( F_192 ( V_328 , V_358 , & V_237 ) )
goto V_343;
if ( F_198 ( V_328 , V_359 , & V_237 ) )
goto V_343;
F_196 ( V_328 , V_344 ) ;
return 0 ;
V_343:
...
static int F_205 ( struct V_327 * V_328 ,
struct V_54 * V_55 ,
struct V_360 * V_361 )
{
void * V_362 ;
V_362 = F_206 ( V_328 , F_207 ( V_361 -> V_328 ) . V_363 , V_361 -> V_364 -> V_365 ,
& V_366 , V_367 ,
V_368 ) ;
if ( ! V_362 )
return - V_332 ;
if ( F_199 ( V_328 , V_55 ) < 0 )
goto V_343;
F_208 ( V_328 , V_362 ) ;
return 0 ;
V_343:
...
if ( V_376 ) {
V_253 -> V_59 = V_68 ;
V_253 -> V_53 = F_215 ( V_376 ) ;
} else {
V_253 -> V_59 = F_214 ( V_377 ) ;
F_216 ( & V_253 -> V_4 , V_378 , sizeof( V_253 -> V_4 ) ) ;
V_253 -> V_43 = F_217 ( V_375 ) ;
V_253 -> V_53 = 0 ;
}
F_58 () ;
if ( V_253 -> V_53 )
...
return - V_144 ;
F_216 ( & V_12 , V_382 , sizeof( V_12 ) ) ;
if ( V_55 )
V_253 -> V_12 = V_55 -> V_12 ;
V_253 -> V_12 = ( V_253 -> V_12 & ~ V_12 . V_346 ) |
( V_12 . V_12 & V_12 . V_346 ) ;
V_253 -> V_175 = F_218 ( V_381 ) ;
V_253 -> V_177 = V_383 ? F_218 ( V_383 ) : NULL ;
V_253 -> V_181 = F_215 ( V_384 ) ;
V_253 -> V_180 = F_219 ( V_385 ) ;
}
return 0 ;
}
static struct V_54 * F_220 ( struct V_2 * V_2 ,
struct V_330 * V_369 )
{
struct V_170 V_253 ;
struct V_54 * V_55 ;
int V_156 ;
V_156 = F_212 ( V_2 , & V_253 , V_369 , 0 , & V_55 ) ;
return V_156 ? F_221 ( V_156 ) : V_55 ;
}
static int F_222 ( struct V_327 * V_328 , struct V_74 * V_75 )
{
struct V_330 * V_386 ;
struct V_100 V_237 ;
V_386 = F_193 ( V_328 , V_387 ) ;
if ( ! V_386 )
return - V_332 ;
if ( F_201 ( V_328 , V_388 , sizeof( V_75 -> V_4 ) , & V_75 -> V_4 ) ||
F_202 ( V_328 , V_389 , V_75 -> V_43 ) ||
F_194 ( V_328 , V_390 ,
( F_15 ( & V_75 -> V_122 ) &
V_90 ) ) ||
F_194 ( V_328 , V_391 ,
F_15 ( & V_75 -> V_124 ) ) ||
F_194 ( V_328 , V_392 , V_75 -> V_129 ) ||
F_194 ( V_328 , V_393 , V_75 -> V_131 ) ||
F_194 ( V_328 , V_394 ,
F_15 ( & V_75 -> V_153 ) ) ||
F_194 ( V_328 , V_395 ,
F_15 ( & V_75 -> V_154 ) ) ||
F_194 ( V_328 , V_396 ,
F_15 ( & V_75 -> V_155 ) ) ||
F_200 ( V_328 , V_397 , V_75 -> V_40 ) )
goto V_343;
F_78 ( & V_237 , & V_75 -> V_76 ) ;
if ( F_192 ( V_328 , V_398 , & V_237 ) )
goto V_343;
if ( F_198 ( V_328 , V_399 , & V_237 ) )
goto V_343;
F_196 ( V_328 , V_386 ) ;
return 0 ;
V_343:
...
static int F_224 ( struct V_327 * V_328 ,
struct V_360 * V_361 )
{
int V_189 = 0 ;
int V_238 = V_361 -> args [ 0 ] ;
...
struct V_2 * V_2 = F_211 ( V_328 ) ;
F_133 ( & V_193 ) ;
if ( F_225 ( V_361 -> V_364 , V_402 , V_372 ,
V_401 , V_403 ) )
goto V_176;
V_55 = F_220 ( V_2 , V_372 [ V_347 ] ) ;
if ( F_226 ( V_55 ) || V_55 == NULL )
goto V_176;
F_69 (dest, &svc->destinations, n_list) {
if ( ++ V_189 <= V_238 )
continue;
if ( F_223 ( V_328 , V_75 , V_361 ) < 0 ) {
V_189 -- ;
goto V_343;
}
}
...
static int F_227 ( struct V_116 * V_117 ,
struct V_330 * V_369 , int V_370 )
{
...
return - V_144 ;
memset ( V_117 , 0 , sizeof( * V_117 ) ) ;
F_216 ( & V_117 -> V_4 , V_378 , sizeof( V_117 -> V_4 ) ) ;
V_117 -> V_43 = F_217 ( V_375 ) ;
if ( V_405 )
V_117 -> V_40 = F_214 ( V_405 ) ;
else
V_117 -> V_40 = 0 ;
if ( V_370 ) {
...
return - V_144 ;
V_117 -> V_122 = F_215 ( V_407 )
& V_90 ;
V_117 -> V_124 = F_215 ( V_408 ) ;
V_117 -> V_129 = F_215 ( V_409 ) ;
V_117 -> V_131 = F_215 ( V_410 ) ;
}
return 0 ;
}
static int F_228 ( struct V_327 * V_328 , T_3 V_277 ,
const char * V_278 , T_3 V_279 )
{
struct V_330 * V_411 ;
V_411 = F_193 ( V_328 , V_412 ) ;
if ( ! V_411 )
return - V_332 ;
if ( F_194 ( V_328 , V_413 , V_277 ) ||
F_203 ( V_328 , V_414 , V_278 ) ||
F_194 ( V_328 , V_415 , V_279 ) )
goto V_343;
F_196 ( V_328 , V_411 ) ;
return 0 ;
V_343:
...
if ( ! V_362 )
return - V_332 ;
if ( F_228 ( V_328 , V_277 , V_278 , V_279 ) )
goto V_343;
F_208 ( V_328 , V_362 ) ;
return 0 ;
V_343:
...
static int F_230 ( struct V_327 * V_328 ,
struct V_360 * V_361 )
{
struct V_2 * V_2 = F_211 ( V_328 ) ;
struct V_14 * V_15 = F_41 ( V_2 ) ;
...
static int F_231 ( struct V_2 * V_2 , struct V_330 * * V_372 )
{
if ( ! ( V_372 [ V_413 ] &&
V_372 [ V_414 ] &&
V_372 [ V_415 ] ) )
...
F_190 ( V_2 , & V_326 ) ;
if ( V_372 [ V_417 ] )
V_326 . V_245 = F_215 ( V_372 [ V_417 ] ) ;
if ( V_372 [ V_418 ] )
V_326 . V_246 =
F_215 ( V_372 [ V_418 ] ) ;
if ( V_372 [ V_419 ] )
V_326 . V_247 = F_215 ( V_372 [ V_419 ] ) ;
return F_172 ( V_2 , & V_326 ) ;
}
static int F_234 ( struct V_327 * V_328 , struct V_420 * V_319 )
{
int V_156 = 0 , V_260 ;
struct V_2 * V_2 ;
struct V_14 * V_15 ;
...
V_435 = F_237 ( V_442 , V_147 ) ;
if ( ! V_435 )
return - V_148 ;
F_133 ( & V_193 ) ;
V_436 = F_238 ( V_435 , V_319 , & V_366 , 0 , V_437 ) ;
if ( V_436 == NULL )
goto V_343;
switch ( V_260 ) {
case V_438 :
...
#endif
#ifdef V_242
if ( F_194 ( V_435 , V_419 , V_326 . V_247 ) )
goto V_343;
#endif
break;
}
case V_439 :
if ( F_194 ( V_435 , V_443 ,
V_229 ) ||
F_194 ( V_435 , V_444 ,
V_230 ) )
goto V_343;
...
F_100 ( & V_15 -> V_33 ) ;
if ( ! F_38 ( V_2 , & V_447 ) ) {
V_446 = F_247 ( V_448 , sizeof( V_448 ) , V_147 ) ;
if ( V_446 == NULL )
return - V_148 ;
if ( V_2 -> V_265 != & V_449 )
V_446 [ 0 ] . V_450 = NULL ;
...
V_15 -> V_469 = F_250 ( int , V_470 , 0 , 3 ) ;
...
V_15 -> V_475 = F_251 ( V_2 , L_61 , V_446 ) ;
if ( V_15 -> V_475 == NULL ) {
if ( ! F_38 ( V_2 , & V_447 ) )
F_49 ( V_446 ) ;
return - V_148 ;
...
F_258 ( & V_15 -> V_85 [ V_189 ] ) ;
F_121 ( & V_15 -> V_161 ) ;
F_100 ( & V_15 -> V_96 ) ;
F_259 ( & V_15 -> V_99 , F_114 ,
( unsigned long ) V_2 ) ;
F_9 ( & V_15 -> V_69 , 0 ) ;
F_9 ( & V_15 -> V_73 , 0 ) ;
...
F_260 ( L_62 , 0 , V_2 -> V_479 , & V_480 ) ;
F_260 ( L_63 , 0 , V_2 -> V_479 , & V_481 ) ;
F_260 ( L_64 , 0 , V_2 -> V_479 ,
& V_482 ) ;
if ( F_246 ( V_2 ) )
goto V_483;
return 0 ;
...
F_75 ( V_2 ) ;
F_253 ( V_2 ) ;
F_262 ( L_64 , V_2 -> V_479 ) ;
F_262 ( L_63 , V_2 -> V_479 ) ;
F_262 ( L_62 , V_2 -> V_479 ) ;
F_48 ( V_15 -> V_202 . V_77 ) ;
}
int T_11 F_263 ( void )
{
