...
{
struct V_272 * V_18 = F_74 ( & V_165 -> V_10 ) ;
struct V_4 * V_5 ;
unsigned int V_38 ;
int V_57 , V_8 , V_273 ;
...
F_83 ( & V_165 -> V_10 , L_87 , V_5 -> V_286 + 'A' ) ;
V_57 = F_10 ( V_5 ) ;
if ( V_57 < 0 ) {
F_4 ( & V_165 -> V_10 , L_88 ) ;
goto V_284;
...
static int F_94 ( struct V_309 * V_10 )
{
...
static int F_98 ( struct V_309 * V_10 )
{
struct V_4 * V_5 = F_95 ( V_10 ) ;
int V_57 ;
V_57 = F_82 ( F_3 ( V_5 -> V_278 ) ,
