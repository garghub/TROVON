...
if ( V_287 -> V_307 ) {
V_294 = 0 ;
V_295 = F_202 ( V_287 -> V_308 , V_287 -> V_309 ) ;
} else {
...
struct V_76 V_77 ;
struct V_43 V_44 ;
T_1 V_311 = V_287 -> V_36 - V_287 -> V_312 ;
T_1 V_308 ;
int V_8 ;
int V_313 = 0 ;
bool V_314 = false ;
...
F_47 ( & V_77 ) ;
V_8 = F_241 ( V_2 , log , V_84 , V_41 , V_287 -> V_36 ,
...
V_94 = V_41 -> V_59 [ 0 ] ;
V_310 = F_35 ( V_94 , V_41 -> V_60 [ 0 ] ,
struct V_83 ) ;
F_242 ( V_94 , V_310 , V_2 -> V_79 ,
& V_77 ) ;
if ( F_174 ( V_296 , & V_287 -> V_257 ) )
F_243 ( V_94 , V_310 ,
V_87 ,
...
V_86 ,
& V_77 ) ;
V_308 = F_202 ( V_287 -> V_308 , V_287 -> V_309 ) ;
if ( V_287 -> V_307 != V_316 ) {
F_244 ( V_94 , V_310 ,
V_287 -> V_297 ,
& V_77 ) ;
F_245 ( V_94 , V_310 , V_308 ,
& V_77 ) ;
} else if ( V_287 -> V_297 < V_317 ) {
F_244 ( V_94 , V_310 ,
V_287 -> V_297 -
V_311 , & V_77 ) ;
F_245 ( V_94 , V_310 , V_308 ,
...
F_244 ( V_94 , V_310 , 0 , & V_77 ) ;
F_245 ( V_94 , V_310 , 0 ,
& V_77 ) ;
}
F_246 ( V_94 , V_310 , V_311 , & V_77 ) ;
F_247 ( V_94 , V_310 , V_287 -> V_37 , & V_77 ) ;
F_248 ( V_94 , V_310 , V_287 -> V_318 , & V_77 ) ;
F_249 ( V_94 , V_310 , V_287 -> V_307 ,
& V_77 ) ;
F_250 ( V_94 , V_310 , 0 , & V_77 ) ;
F_251 ( V_94 , V_310 , 0 , & V_77 ) ;
F_51 ( V_94 ) ;
F_31 ( V_41 ) ;
return V_8 ;
}
...
struct V_5 * V_6 )
{
struct V_284 * V_287 , * V_319 ;
struct V_270 V_320 ;
struct V_321 * V_322 = & F_115 ( V_84 ) -> V_323 ;
T_1 V_324 ;
int V_8 = 0 ;
int V_325 = 0 ;
F_169 ( & V_320 ) ;
F_253 ( & V_322 -> V_326 ) ;
V_324 = V_4 -> V_11 -> V_327 ;
...
if ( V_287 -> V_247 <= V_324 )
continue;
F_6 ( & V_287 -> V_331 ) ;
F_5 ( V_332 , & V_287 -> V_257 ) ;
F_7 ( & V_287 -> V_22 , & V_320 ) ;
V_325 ++ ;
}
F_255 ( NULL , & V_320 , F_233 ) ;
V_330:
while ( ! F_71 ( & V_320 ) ) {
V_287 = F_72 ( V_320 . V_103 , struct V_284 , V_22 ) ;
F_167 ( & V_287 -> V_22 ) ;
if ( V_8 ) {
F_256 ( V_322 , V_287 ) ;
F_257 ( V_287 ) ;
...
F_258 ( & V_322 -> V_326 ) ;
V_8 = F_240 ( V_2 , V_84 , V_4 , V_287 , V_41 , V_288 ,
V_6 ) ;
F_253 ( & V_322 -> V_326 ) ;
F_256 ( V_322 , V_287 ) ;
F_257 ( V_287 ) ;
...
bool V_336 = false ;
T_1 V_142 = F_61 ( V_84 ) ;
struct V_321 * V_337 = & F_115 ( V_84 ) -> V_323 ;
T_1 V_246 = 0 ;
V_41 = F_89 () ;
if ( ! V_41 )
return - V_63 ;
...
V_242 . V_82 = ( T_1 ) - 1 ;
if ( F_39 ( V_84 -> V_147 ) ||
F_115 ( V_84 ) -> V_247 > V_4 -> V_11 -> V_327 )
V_8 = F_261 ( V_2 , V_84 ) ;
else
V_8 = F_262 ( V_84 ) ;
if ( V_8 ) {
...
break;
V_236 = V_41 -> V_59 [ 0 ] ;
if ( V_335 && V_334 + V_335 == V_41 -> V_60 [ 0 ] ) {
V_335 ++ ;
goto V_343;
} else if ( ! V_335 ) {
V_334 = V_41 -> V_60 [ 0 ] ;
...
list) {
const T_1 V_344 = V_287 -> V_292 + V_287 -> V_293 - 1 ;
if ( V_287 -> V_292 >= V_36 && V_344 <= V_222 )
F_167 ( & V_287 -> V_22 ) ;
}
F_258 ( & V_337 -> V_326 ) ;
}
if ( V_261 == V_341 && F_39 ( V_84 -> V_147 ) ) {
...
F_266 ( & F_115 ( V_84 ) -> V_326 ) ;
F_115 ( V_84 ) -> V_227 = V_2 -> V_79 ;
F_115 ( V_84 ) -> V_221 = F_115 ( V_84 ) -> V_345 ;
F_267 ( & F_115 ( V_84 ) -> V_326 ) ;
V_228:
if ( F_268 ( V_224 ) )
F_269 ( & V_288 ) ;
else
...
static T_2 int F_271 ( struct V_1 * V_2 ,
struct V_84 * V_84 ,
struct V_346 * V_192 ,
struct V_347 * V_348 ,
T_1 V_349 )
...
struct V_84 * V_351 = V_84 ;
if ( F_46 ( V_84 -> V_147 ) &&
F_115 ( V_84 ) -> V_247 <= V_349 &&
F_115 ( V_84 ) -> V_352 <= V_349 )
goto V_13;
if ( ! F_39 ( V_84 -> V_147 ) ) {
if ( ! V_192 || F_272 ( V_192 ) || V_348 != F_273 ( V_192 ) -> V_353 )
goto V_13;
V_84 = F_273 ( V_192 ) ;
}
while ( 1 ) {
...
if ( ! V_41 )
return - V_63 ;
V_357 = F_32 ( sizeof( * V_357 ) , V_62 ) ;
if ( ! V_357 ) {
F_93 ( V_41 ) ;
return - V_63 ;
}
V_357 -> V_142 = F_61 ( V_354 ) ;
F_7 ( & V_357 -> V_22 , & V_355 ) ;
while ( ! F_71 ( & V_355 ) ) {
struct V_28 * V_94 ;
struct V_43 V_235 ;
int V_165 ;
int V_169 ;
V_357 = F_278 ( & V_355 , struct V_356 ,
V_22 ) ;
if ( V_8 )
goto V_358;
V_235 . V_54 = V_357 -> V_142 ;
V_235 . type = V_157 ;
V_235 . V_82 = 0 ;
V_131:
F_31 ( V_41 ) ;
...
type != V_239 )
continue;
F_79 ( V_94 , V_107 , & V_359 ) ;
if ( V_359 . type == V_240 )
continue;
V_360 = F_279 ( V_4 -> V_11 -> V_348 , & V_359 ,
V_4 , NULL ) ;
if ( F_86 ( V_360 ) ) {
V_8 = F_133 ( V_360 ) ;
goto V_358;
}
if ( F_280 ( V_360 , V_2 -> V_79 ) ) {
F_77 ( V_360 ) ;
continue;
}
V_6 -> V_241 = false ;
...
V_362 = V_341 ;
F_31 ( V_41 ) ;
V_8 = F_260 ( V_2 , V_4 , V_360 ,
V_362 , 0 , V_363 , V_6 ) ;
F_77 ( V_360 ) ;
if ( V_8 )
goto V_358;
if ( V_6 -> V_241 ) {
V_361 = F_32 ( sizeof( * V_361 ) ,
V_62 ) ;
if ( ! V_361 ) {
V_8 = - V_63 ;
goto V_358;
}
V_361 -> V_142 = V_359 . V_54 ;
F_7 ( & V_361 -> V_22 , & V_355 ) ;
}
break;
}
if ( V_169 == V_165 ) {
...
struct V_5 * V_6 )
{
int V_261 = V_364 ? V_275 : V_341 ;
struct V_347 * V_348 ;
struct V_346 * V_350 = NULL ;
int V_8 = 0 ;
T_1 V_349 = V_4 -> V_11 -> V_327 ;
const struct V_346 * const V_365 = V_192 ;
const bool V_366 = ( F_115 ( V_84 ) -> V_352 >
V_349 ) ;
bool V_367 = false ;
struct V_84 * V_351 = V_84 ;
V_348 = V_84 -> V_353 ;
...
V_8 = F_271 ( V_2 , V_84 , V_192 ,
V_348 , V_349 ) ;
if ( V_8 )
goto V_369;
if ( F_280 ( V_84 , V_2 -> V_79 ) ) {
V_8 = V_371 ;
goto V_369;
}
V_8 = F_1 ( V_2 , V_4 , V_6 ) ;
if ( V_8 )
goto V_369;
V_8 = F_260 ( V_2 , V_4 , V_84 , V_261 , V_36 , V_222 , V_6 ) ;
if ( V_8 )
goto V_372;
if ( F_46 ( V_84 -> V_147 ) &&
F_115 ( V_84 ) -> V_247 <= V_349 &&
...
struct V_3 * V_4 , struct V_346 * V_346 ,
const T_6 V_36 ,
const T_6 V_222 ,
struct V_5 * V_6 )
{
struct V_346 * V_192 = F_275 ( V_346 ) ;
int V_8 ;
V_8 = F_281 ( V_2 , V_4 , F_273 ( V_346 ) , V_192 ,
V_36 , V_222 , 0 , V_6 ) ;
F_276 ( V_192 ) ;
return V_8 ;
}
int F_284 ( struct V_3 * V_25 )
{
int V_8 ;
struct V_40 * V_41 ;
struct V_1 * V_2 ;
...
V_373 . V_54 = V_151 . V_82 ;
V_373 . type = V_240 ;
V_373 . V_82 = ( T_1 ) - 1 ;
V_31 . V_182 = F_288 ( V_11 , & V_373 ) ;
if ( F_86 ( V_31 . V_182 ) ) {
...
return;
V_377:
F_115 ( V_105 ) -> V_352 = V_2 -> V_79 ;
}
int F_293 ( struct V_1 * V_2 ,
struct V_84 * V_84 , struct V_84 * V_378 ,
struct V_346 * V_192 )
{
...
if ( F_115 ( V_84 ) -> V_227 <=
V_4 -> V_11 -> V_327 &&
( ! V_378 || F_115 ( V_378 ) -> V_227 <=
V_4 -> V_11 -> V_327 ) )
return 0 ;
return F_281 ( V_2 , V_4 , V_84 , V_192 , 0 ,
V_363 , 1 , NULL ) ;
}
