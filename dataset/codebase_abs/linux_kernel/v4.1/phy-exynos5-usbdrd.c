...
const struct V_95 * V_70 ;
struct V_96 * V_20 ;
T_1 V_22 ;
int V_97 , V_50 ;
int V_98 ;
V_23 = F_38 ( V_36 , sizeof( * V_23 ) , V_99 ) ;
if ( ! V_23 )
return - V_100 ;
F_39 ( V_36 , V_23 ) ;
V_23 -> V_36 = V_36 ;
V_92 = F_40 ( V_86 , V_101 , 0 ) ;
V_23 -> V_24 = F_41 ( V_36 , V_92 ) ;
if ( F_33 ( V_23 -> V_24 ) )
return F_34 ( V_23 -> V_24 ) ;
V_94 = F_42 ( V_102 , V_86 -> V_36 . V_89 ) ;
V_70 = V_94 -> V_103 ;
V_23 -> V_70 = V_70 ;
V_50 = F_31 ( V_23 ) ;
if ( V_50 ) {
...
switch ( V_98 ) {
case 1 :
V_22 = V_23 -> V_70 -> V_104 ;
break;
case 0 :
default:
V_22 = V_23 -> V_70 -> V_105 ;
break;
}
...
V_23 -> V_4 [ V_97 ] . V_49 = V_49 ;
V_23 -> V_4 [ V_97 ] . V_5 = V_97 ;
V_23 -> V_4 [ V_97 ] . V_20 = V_20 ;
V_23 -> V_4 [ V_97 ] . V_22 = V_22 ;
V_23 -> V_4 [ V_97 ] . V_59 = & V_70 -> V_59 [ V_97 ] ;
F_49 ( V_49 , & V_23 -> V_4 [ V_97 ] ) ;
}
V_90 = F_50 ( V_36 ,
F_27 ) ;
if ( F_33 ( V_90 ) ) {
