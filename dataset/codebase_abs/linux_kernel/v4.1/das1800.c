...
{
const struct V_4 * V_164 = V_2 -> V_6 ;
int V_165 ;
int V_166 ;
V_165 = V_164 - V_167 ;
...
break;
case 0x6 :
if ( V_165 == V_175 || V_165 == V_180 )
return V_165 ;
V_165 = V_175 ;
break;
case 0x7 :
if ( V_165 == V_172 || V_165 == V_181 ||
V_165 == V_182 || V_165 == V_183 )
return V_165 ;
V_165 = V_172 ;
break;
case 0x8 :
if ( V_165 == V_184 || V_165 == V_185 )
return V_165 ;
V_165 = V_184 ;
break;
default:
...
if ( ! V_18 )
return - V_188 ;
V_187 = F_65 ( V_2 , V_153 -> V_155 [ 0 ] , V_189 ) ;
if ( V_187 )
return V_187 ;
V_164 = F_62 ( V_2 ) ;
if ( V_164 < 0 ) {
...
V_2 -> V_191 = V_5 -> V_186 ;
if ( V_5 -> V_192 == 2 ) {
unsigned long V_193 = V_2 -> V_12 + V_194 ;
V_187 = F_66 ( V_2 , V_193 , V_189 ) ;
if ( V_187 )
return V_187 ;
V_18 -> V_193 = V_193 ;
}
...
F_58 ( V_2 , V_153 ) ;
V_18 -> V_23 = F_68 ( V_21 , sizeof( T_1 ) , V_195 ) ;
if ( ! V_18 -> V_23 )
return - V_188 ;
V_2 -> V_96 = F_69 ( V_2 -> V_12 + V_196 ,
V_197 , V_198 , 0 ) ;
if ( ! V_2 -> V_96 )
return - V_188 ;
V_187 = F_70 ( V_2 , 4 ) ;
...
V_16 = & V_2 -> V_199 [ 0 ] ;
V_16 -> type = V_200 ;
V_16 -> V_201 = V_202 | V_203 | V_204 ;
if ( V_5 -> V_205 )
V_16 -> V_201 |= V_206 ;
V_16 -> V_207 = V_5 -> V_208 ;
V_16 -> V_209 = ( 1 << V_5 -> V_7 ) - 1 ;
V_16 -> V_210 = V_5 -> V_211 ;
V_16 -> V_212 = F_52 ;
if ( V_2 -> V_66 ) {
V_2 -> V_52 = V_16 ;
V_16 -> V_201 |= V_213 ;
V_16 -> V_214 = V_16 -> V_207 ;
V_16 -> V_215 = F_48 ;
V_16 -> V_216 = F_32 ;
V_16 -> V_217 = F_21 ;
V_16 -> V_218 = F_17 ;
