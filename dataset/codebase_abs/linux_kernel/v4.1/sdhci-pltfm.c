...
V_4 -> clock = F_12 ( V_5 ) ;
if ( F_13 ( V_7 , L_14 , NULL ) )
V_2 -> V_25 -> V_26 |= V_27 ;
if ( F_13 ( V_7 , L_15 , NULL ) )
V_2 -> V_25 -> V_26 |= V_28 ;
}
void F_8 ( struct V_10 * V_11 ) {}
...
V_2 -> V_41 = F_22 ( V_11 , 0 ) ;
if ( ! F_23 ( V_33 -> V_42 , F_16 ( V_33 ) ,
F_24 ( V_2 -> V_25 ) ) ) {
F_17 ( & V_11 -> V_12 , L_17 ) ;
V_34 = - V_43 ;
goto V_44;
}
V_2 -> V_45 = F_25 ( V_33 -> V_42 , F_16 ( V_33 ) ) ;
if ( ! V_2 -> V_45 ) {
F_17 ( & V_11 -> V_12 , L_18 ) ;
V_34 = - V_36 ;
goto V_46;
...
return V_2 ;
V_46:
F_27 ( V_33 -> V_42 , F_16 ( V_33 ) ) ;
V_44:
F_28 ( V_2 ) ;
V_37:
F_17 ( & V_11 -> V_12 , L_19 , V_48 , V_34 ) ;
return F_29 ( V_34 ) ;
}
void F_30 ( struct V_10 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
struct V_32 * V_33 = F_15 ( V_11 , V_35 , 0 ) ;
F_31 ( V_2 -> V_45 ) ;
F_27 ( V_33 -> V_42 , F_16 ( V_33 ) ) ;
F_28 ( V_2 ) ;
}
...
struct V_1 * V_2 = F_9 ( V_11 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_49 = ( F_35 ( V_2 -> V_45 + V_50 ) == 0xffffffff ) ;
F_36 ( V_2 , V_49 ) ;
F_37 ( V_4 -> V_5 ) ;
F_30 ( V_11 ) ;
return 0 ;
