...
if ( F_119 ( & V_14 -> V_93 ) ) {
V_186 &= ~ V_118 ;
F_28 ( & V_14 -> V_93 , V_86 , V_293 ) ;
}
if ( F_118 ( V_186 & V_294 ) ) {
F_108 ( V_14 , V_186 ) ;
return;
}
if ( V_186 & V_295 ) {
...
const T_8 * V_296 = V_99 -> V_223 + V_297 ;
T_2 V_298 = F_122 ( V_296 [ 0 ] ) ;
if ( V_298 & ( 1 << 15 ) )
F_120 ( V_14 ) ;
}
}
...
if ( V_14 -> V_292 && V_99 -> V_299 -> V_300 )
V_292 = F_2 ( V_22 + V_89 ) ;
else
V_292 = F_2 ( V_22 + V_202 ) ;
}
V_129 = F_123 ( V_14 , V_292 ) ;
...
static T_9 F_125 ( int V_301 , void * V_302 )
{
struct V_13 * V_14 = V_302 ;
struct V_98 * V_99 = V_14 -> V_18 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
T_2 V_186 ;
V_186 = F_126 ( & V_99 -> V_303 , 0 ) ;
if ( ! V_186 )
return V_304 ;
F_127 ( V_14 -> V_30 ) ;
F_117 ( V_14 , V_22 , V_186 ) ;
...
static T_9 F_129 ( int V_301 , void * V_302 )
{
struct V_13 * V_14 = V_302 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
struct V_98 * V_99 = V_14 -> V_18 ;
...
V_186 = F_2 ( V_22 + V_167 ) ;
F_3 ( V_186 , V_22 + V_167 ) ;
F_130 ( V_186 , & V_99 -> V_303 ) ;
F_59 ( L_52 ) ;
return V_306 ;
}
static T_9 F_131 ( int V_301 , void * V_302 )
{
struct V_79 * V_17 = V_302 ;
struct V_15 * V_16 ;
unsigned int V_2 , V_307 = 0 ;
void T_1 * V_1 ;
T_2 V_256 , V_308 ;
F_59 ( L_33 ) ;
V_16 = V_17 -> V_18 ;
...
unsigned int F_136 ( struct V_230 * V_231 )
{
struct V_13 * V_14 = V_231 -> V_14 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
struct V_98 * V_99 = V_14 -> V_18 ;
V_99 -> V_299 = V_231 -> V_7 -> V_93 ;
if ( V_231 -> V_175 . V_242 == V_309 )
F_3 ( 1 << V_231 -> V_181 , V_22 + V_89 ) ;
if ( V_99 -> V_209 && V_99 -> V_310 != V_231 -> V_7 -> V_93 -> V_132 ) {
T_2 V_252 = F_2 ( V_22 + V_253 ) ;
V_252 &= ~ ( V_311 | V_255 ) ;
V_252 |= V_231 -> V_7 -> V_93 -> V_132 << V_312 ;
F_3 ( V_252 , V_22 + V_253 ) ;
V_99 -> V_310 = V_231 -> V_7 -> V_93 -> V_132 ;
}
F_3 ( 1 << V_231 -> V_181 , V_22 + V_202 ) ;
F_45 ( V_231 -> V_7 -> V_93 ) ;
return 0 ;
}
static bool F_137 ( struct V_230 * V_231 )
{
struct V_98 * V_99 = V_231 -> V_14 -> V_18 ;
T_6 * V_223 = V_99 -> V_223 ;
if ( V_99 -> V_209 )
V_223 += V_231 -> V_7 -> V_93 -> V_132 * V_313 ;
if ( V_231 -> V_175 . V_242 == V_314 && V_231 -> V_315 == V_316 &&
! ( V_231 -> V_28 & V_317 ) ) {
F_138 ( V_223 + V_318 , & V_231 -> V_319 ) ;
V_231 -> V_319 . V_226 = ( V_223 + V_318 ) [ 15 ] ;
} else
F_138 ( V_223 + V_224 , & V_231 -> V_319 ) ;
return true ;
}
...
F_142 ( V_14 ) ;
if ( ! F_143 ( V_14 -> V_93 . V_6 ) )
F_29 ( V_14 ) ;
}
static void F_144 ( struct V_230 * V_231 )
{
struct V_13 * V_14 = V_231 -> V_14 ;
if ( V_231 -> V_28 & V_317 )
F_68 ( V_14 ) ;
}
static void F_37 ( struct V_13 * V_14 , bool V_321 )
{
struct V_15 * V_16 = V_14 -> V_17 -> V_18 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
struct V_162 * V_7 = V_14 -> V_93 . V_6 ;
T_2 V_322 , V_323 , V_324 , V_325 , V_326 ;
int V_129 ;
unsigned int V_272 ;
V_322 = F_2 ( V_22 + V_327 ) ;
if ( ! ( V_322 & V_328 ) ) {
...
if ( V_129 )
return;
V_323 = ( V_322 & V_332 ) >> V_333 ;
V_324 = V_334 / ( V_323 + 1 ) ;
if ( V_324 > 0x3ff )
V_324 = 0x3ff ;
if ( V_7 -> V_335 [ V_336 ] &
V_337 ) {
V_325 = V_7 -> V_335 [ V_338 ] &
V_339 ;
if ( ! V_325 )
V_325 = 10 ;
V_326 = V_7 -> V_335 [ V_340 ] ;
if ( ! V_326 )
V_326 = 20 ;
} else {
V_325 = 10 ;
...
static int F_150 ( struct V_13 * V_14 , T_10 V_348 )
{
const char * V_138 = NULL ;
int V_129 ;
V_129 = F_42 ( V_14 , & V_138 ) ;
...
F_151 ( V_14 , L_28 , V_138 , V_129 ) ;
F_114 ( V_14 ) ;
}
return V_129 ;
}
static int F_152 ( struct V_13 * V_14 )
{
struct V_15 * V_16 = V_14 -> V_17 -> V_18 ;
...
T_5 V_350 ;
T_4 V_351 , V_352 ;
V_99 = F_153 ( V_7 , sizeof( * V_99 ) , V_353 ) ;
if ( ! V_99 )
return - V_354 ;
if ( V_14 -> V_17 -> V_169 > 1 ) {
V_99 -> V_355 = F_153 ( V_7 , 8 , V_353 ) ;
if ( ! V_99 -> V_355 ) {
F_154 ( V_7 , V_99 ) ;
return - V_354 ;
}
snprintf ( V_99 -> V_355 , 8 ,
L_63 , F_155 ( V_7 ) , V_14 -> V_149 ) ;
}
if ( ( V_16 -> V_19 & V_70 ) && F_156 ( V_14 ) ) {
void T_1 * V_22 = F_12 ( V_14 ) ;
T_2 V_108 = F_2 ( V_22 + V_23 ) ;
if ( V_108 & V_356 )
V_99 -> V_345 = true ;
...
V_349 = F_157 ( V_7 , V_351 , & V_350 , V_353 ) ;
if ( ! V_349 )
return - V_354 ;
memset ( V_349 , 0 , V_351 ) ;
V_99 -> V_185 = V_349 ;
V_99 -> V_100 = V_350 ;
V_349 += V_359 ;
V_350 += V_359 ;
...
void F_160 ( struct V_79 * V_17 , const char * V_362 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
void T_1 * V_1 = V_16 -> V_1 ;
T_2 V_50 , V_19 , V_20 , V_363 , V_364 ;
const char * V_365 ;
V_50 = F_2 ( V_1 + V_21 ) ;
V_19 = V_16 -> V_19 ;
V_20 = V_16 -> V_20 ;
...
T_6 V_381 ;
void T_1 * V_1 = V_16 -> V_1 ;
T_2 V_25 = F_2 ( V_1 + V_382 ) ;
T_2 V_26 = F_2 ( V_1 + V_31 ) ;
if ( ! V_383 || ! ( V_16 -> V_19 & V_373 ) )
return;
V_381 = ( V_26 & V_384 ) >> 16 ;
if ( V_381 ) {
V_16 -> V_25 = ( ( V_25 >> 16 ) * 4 ) ;
...
static int F_162 ( struct V_79 * V_17 , int V_301 ,
struct V_386 * V_387 )
{
int V_2 , V_129 ;
V_129 = F_163 ( V_17 ) ;
...
return V_129 ;
for ( V_2 = 0 ; V_2 < V_17 -> V_169 ; V_2 ++ ) {
struct V_98 * V_99 = V_17 -> V_170 [ V_2 ] -> V_18 ;
if ( ! V_99 ) {
F_164 ( V_301 + V_2 ) ;
continue;
}
V_129 = F_165 ( V_17 -> V_7 , V_301 + V_2 ,
F_129 ,
F_125 , V_388 ,
V_99 -> V_355 , V_17 -> V_170 [ V_2 ] ) ;
if ( V_129 )
goto V_389;
}
for ( V_2 = 0 ; V_2 < V_17 -> V_169 ; V_2 ++ )
F_166 ( V_17 -> V_170 [ V_2 ] , L_97 , V_301 + V_2 ) ;
V_129 = F_167 ( V_17 , V_387 ) ;
if ( V_129 )
goto V_390;
return 0 ;
V_390:
...
V_389:
for ( V_2 -- ; V_2 >= 0 ; V_2 -- )
F_168 ( V_17 -> V_7 , V_301 + V_2 , V_17 -> V_170 [ V_2 ] ) ;
return V_129 ;
}
int F_169 ( struct V_79 * V_17 , int V_301 ,
struct V_386 * V_387 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
int V_129 ;
if ( V_16 -> V_28 & V_361 )
V_129 = F_162 ( V_17 , V_301 , V_387 ) ;
else
V_129 = F_170 ( V_17 , V_301 , F_131 ,
V_388 , V_387 ) ;
return V_129 ;
}
