...
static int F_27 ( struct V_12 * V_13 , struct V_3 * V_4 )
{
struct V_55 * V_56 ;
struct V_1 * V_2 = & V_13 -> V_34 . V_2 ;
struct V_9 * V_53 = & V_2 -> V_53 ;
struct V_9 V_76 = { L_16 } ;
struct V_12 * V_77 ;
struct V_32 * V_78 ;
struct V_79 V_80 ;
int V_15 ;
...
V_53 -> V_10 ) ;
if ( ! V_77 -> V_82 ) {
F_12 ( L_19 , V_4 -> V_21 . V_10 ) ;
return - V_24 ;
}
V_15 = F_29 ( NULL , & V_78 , V_77 , & V_76 ,
& V_2 -> V_40 , NULL ) ;
if ( V_15 ) {
F_12 ( L_20 , V_4 -> V_21 . V_10 , V_15 ) ;
return V_15 ;
}
...
if ( ! F_59 ( & V_115 -> V_118 ) ) {
F_12 ( L_38 V_128 L_39 ,
V_4 -> V_20 -> V_33 -> V_27 ,
F_58 ( & V_115 -> V_118 ) , - V_24 ) ;
V_15 = - V_24 ;
goto V_122;
}
V_4 = F_55 ( V_2 , & V_115 -> V_118 ) ;
...
int F_80 ( struct V_1 * V_2 , struct V_103 * V_225 , T_2 V_215 )
{
struct V_3 * V_4 ;
int V_15 ;
V_4 = F_81 ( V_2 , V_215 ) ;
...
static int F_98 ( struct V_12 * V_13 , T_2 V_110 , void * V_240 )
{
...
if ( sscanf ( F_88 ( V_228 , 2 ) , L_49 , & V_91 ) != 1 ) {
V_15 = - V_24 ;
goto V_226;
}
if ( sscanf ( F_88 ( V_228 , 3 ) , L_49 , & V_93 ) != 1 ) {
V_15 = - V_24 ;
goto V_226;
}
...
struct V_165 * V_243 , T_3 V_244 , T_1 V_245 )
{
struct V_12 * V_13 = F_6 ( exp ) ;
struct V_1 * V_2 = & V_13 -> V_34 . V_2 ;
struct V_165 * V_246 ;
...
struct V_253 * V_255 , T_4 V_256 , const char * V_257 ,
...
if ( V_15 )
return V_15 ;
F_3 ( V_266 , L_52 V_128 L_53 , F_58 ( V_225 ) ) ;
for ( V_14 = 0 ; V_14 < V_2 -> V_7 . V_18 ; V_14 ++ ) {
if ( V_2 -> V_19 [ V_14 ] == NULL || V_2 -> V_19 [ V_14 ] -> V_20 == NULL )
continue;
...
if ( F_19 ( V_4 ) )
return F_56 ( V_4 ) ;
F_3 ( V_266 , L_54 V_128 L_53 , F_58 ( & V_196 -> V_197 ) ) ;
...
static int F_115 ( struct V_32 * exp , struct V_195 * V_196 ,
const void * V_38 , int V_270 , int V_271 , T_1 V_272 ,
T_1 V_273 , T_6 V_274 , T_3 V_275 ,
struct V_261 * * V_262 )
{
struct V_12 * V_13 = exp -> V_33 ;
struct V_1 * V_2 = & V_13 -> V_34 . V_2 ;
...
if ( * V_262 == NULL )
return V_15 ;
F_3 ( V_266 , L_57 V_128 L_53 , F_58 ( & V_196 -> V_210 ) ) ;
}
return V_15 ;
}
...
return 0 ;
F_3 ( V_266 , L_58 V_128 L_59 V_128 L_53 ,
...
if ( V_15 )
return V_15 ;
F_3 ( V_266 , L_60 V_128 L_53 ,
F_121 ( V_267 ) , F_58 ( & V_196 -> V_197 ) ) ;
V_4 = F_114 ( V_2 , V_196 , & V_196 -> V_197 ) ;
if ( F_19 ( V_4 ) )
return F_56 ( V_4 ) ;
F_3 ( V_266 , L_60 V_128 L_61 ,
...
int V_306 , T_7 V_271 , int V_307 , int V_308 )
{
...
return F_56 ( V_4 ) ;
if ( V_4 -> V_87 != V_306 ) {
F_3 ( V_266 , L_64 V_128 L_53 , F_58 ( V_225 ) ) ;
...
return V_15 ;
F_7 ( V_196 -> V_276 != 0 ) ;
F_3 ( V_266 , L_66 V_128 L_67 V_128 L_53 ,
...
int V_15 ;
F_7 ( V_319 != 0 ) ;
F_3 ( V_266 , L_68 V_128 L_69 V_128 L_53 ,
...
if ( V_15 != 0 )
return V_15 ;
F_3 ( V_266 , L_75 V_128 L_76 V_128 L_61 ,
...
V_2 = & V_13 -> V_34 . V_2 ;
if ( V_367 >= strlen ( L_79 ) && ! strcmp ( V_368 , L_79 ) ) {
struct V_3 * V_4 ;
int V_14 ;
V_15 = F_20 ( V_13 ) ;
if ( V_15 )
...
static int F_165 ( const struct V_51 * V_52 , struct V_32 * exp ,
T_2 V_367 , void * V_368 , T_2 V_369 ,
...
static int F_166 ( struct V_32 * exp , struct V_383 * * V_384 ,
struct V_371 * V_372 )
{
struct V_12 * V_13 = F_6 ( exp ) ;
struct V_1 * V_2 = & V_13 -> V_34 . V_2 ;
...
static int F_168 ( struct V_32 * exp , struct V_371 * * V_386 ,
...
static int F_173 ( struct V_32 * exp , T_3 * V_282 , void * V_38 ,
T_3 * V_307 )
{
struct V_1 * V_2 = & exp -> V_33 -> V_34 . V_2 ;
int V_15 ;
...
static T_7 F_175 ( struct V_32 * exp , T_3 V_245 ,
const struct V_103 * V_225 , T_10 type ,
T_8 * V_309 , T_7 V_271 ,
struct V_57 * V_282 )
{
struct V_12 * V_13 = exp -> V_33 ;
...
T_7 V_15 ;
int V_14 ;
F_3 ( V_266 , L_82 V_128 L_53 , F_58 ( V_225 ) ) ;
for ( V_14 = 0 ; V_14 < V_2 -> V_7 . V_18 ; V_14 ++ ) {
if ( V_2 -> V_19 [ V_14 ] == NULL ||
V_2 -> V_19 [ V_14 ] -> V_20 == NULL ||
V_2 -> V_19 [ V_14 ] -> V_6 == 0 )
...
static int F_177 ( struct V_32 * exp ,
struct V_261 * V_206 ,
struct V_32 * V_400 ,
struct V_32 * V_401 ,
struct V_402 * V_403 )
...
static int F_179 ( struct V_32 * exp , struct V_402 * V_403 )
{
struct V_12 * V_13 = exp -> V_33 ;
struct V_1 * V_2 = & V_13 -> V_34 . V_2 ;
if ( V_403 -> V_396 )
...
static int F_190 ( struct V_32 * exp , struct V_261 * V_206 ,
...
static int F_192 ( struct V_32 * exp ,
struct V_412 * V_413 ,
struct V_279 * V_280 )
{
...
static int F_194 ( struct V_32 * exp , struct V_281 * V_267 ,
struct V_103 * V_225 , T_3 * V_307 )
{
struct V_12 * V_13 = exp -> V_33 ;
struct V_1 * V_2 = & V_13 -> V_34 . V_2 ;
struct V_3 * V_4 ;
...
static int F_196 ( struct V_12 * V_415 , struct V_32 * exp ,
struct V_179 * V_180 )
{
struct V_12 * V_13 = F_6 ( exp ) ;
struct V_1 * V_2 = & V_13 -> V_34 . V_2 ;
...
static int F_197 ( struct V_12 * V_415 , struct V_32 * exp ,
struct V_179 * V_180 )
{
struct V_12 * V_13 = F_6 ( exp ) ;
struct V_1 * V_2 = & V_13 -> V_34 . V_2 ;
