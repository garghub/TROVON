...
if ( V_60 -> V_2 -> V_13 . V_35 [ V_11 ] != V_60 -> V_35 ) {
F_30 ( L_17 ) ;
return - V_23 ;
}
return V_11 ;
...
{
int V_75 = - 1 ;
bool V_76 = false , V_77 = false , V_73 = false ;
T_2 V_78 , V_49 = 0 ;
T_2 * V_5 = & V_78 ;
int V_11 , V_12 = 0 ;
while ( V_60 -> V_68 < V_60 -> V_79 -> V_57 ) {
T_2 V_80 = F_38 ( V_60 , V_60 -> V_68 ) ;
T_2 V_81 = F_38 ( V_60 , V_60 -> V_68 + 1 ) ;
if ( ( V_80 < 8 ) || ( V_80 & 3 ) ) {
F_30 ( L_19 , V_80 ) ;
V_12 = - V_23 ;
goto V_82;
...
T_3 V_88 = V_86 -> V_32 ;
F_44 ( V_50 , V_89 ) ;
F_44 ( V_50 , ( V_88 >> 3 ) & 0x000FFFFF ) ;
F_44 ( V_50 , ( V_88 >> 23 ) & 0x000FFFFF ) ;
F_44 ( V_50 , 0x01003000 | ( V_87 ? 1 : 0 ) ) ;
if ( ! V_87 )
F_44 ( V_50 , V_90 ) ;
return true ;
}
...
{
struct V_84 * V_50 = & V_2 -> V_50 [ V_55 -> V_50 ] ;
F_44 ( V_50 , V_91 ) ;
F_44 ( V_50 , V_55 -> V_32 ) ;
...
struct V_51 * V_52 )
{
struct V_84 * V_50 = & V_2 -> V_50 [ V_52 -> V_50 ] ;
T_3 V_88 = V_2 -> V_92 [ V_52 -> V_50 ] . V_32 ;
F_44 ( V_50 , V_93 ) ;
F_44 ( V_50 , V_88 ) ;
F_44 ( V_50 , F_33 ( V_88 ) ) ;
F_44 ( V_50 , V_52 -> V_94 ) ;
...
int F_47 ( struct V_1 * V_2 , struct V_84 * V_50 )
{
T_2 V_96 = F_48 ( V_2 , V_50 ) ;
unsigned V_11 ;
int V_12 ;
...
int F_52 ( struct V_1 * V_2 , struct V_84 * V_50 )
{
