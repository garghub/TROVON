...
while ( line ) {
V_29 = NULL ;
V_28 = strtok_r ( line , L_5 , & V_30 ) ;
V_25 = F_18 ( V_28 , NULL , 16 ) ;
strtok_r ( NULL , L_5 , & V_30 ) ;
V_26 = strtok_r ( NULL , L_6 , & V_30 ) ;
V_29 = strtok_r ( NULL , L_7 , & V_30 ) ;
if ( V_29 )
V_29 = V_29 + 1 ;
F_19 ( V_5 , V_26 , V_25 , V_29 ) ;
