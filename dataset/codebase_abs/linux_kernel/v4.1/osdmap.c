...
static struct V_35 * F_15 ( void * V_36 , void * V_15 )
{
struct V_35 * V_37 ;
int V_38 = - V_22 ;
int V_39 , V_24 ;
...
F_19 ( V_18 == 0 ) ;
V_7 = V_37 -> V_51 [ V_39 ] = F_16 ( V_18 , V_26 ) ;
if ( V_7 == NULL )
goto V_52;
F_6 ( V_14 , V_15 , 4 * sizeof( V_19 ) , V_20 ) ;
V_7 -> V_61 = F_7 ( V_14 ) ;
...
goto V_20;
#endif
V_70 = V_37 -> V_53 [ V_39 ] = F_22 ( sizeof( * V_70 ) +
...
F_5 ( L_17 , V_39 , V_70 ) ;
V_70 -> V_2 = V_68 ;
F_23 ( V_14 , V_15 , & V_70 -> V_74 , 4 , V_20 ) ;
...
static int F_25 ( struct V_82 V_83 , struct V_82 V_70 )
{
...
while ( * V_14 ) {
V_91 = * V_14 ;
V_92 = F_27 ( V_91 , struct V_86 , V_95 ) ;
V_37 = F_25 ( V_87 -> V_94 , V_92 -> V_94 ) ;
if ( V_37 < 0 )
V_14 = & ( * V_14 ) -> V_96 ;
else if ( V_37 > 0 )
V_14 = & ( * V_14 ) -> V_97 ;
...
int V_37 ;
while ( V_99 ) {
V_92 = F_27 ( V_99 , struct V_86 , V_95 ) ;
V_37 = F_25 ( V_94 , V_92 -> V_94 ) ;
if ( V_37 < 0 ) {
V_99 = V_99 -> V_96 ;
} else if ( V_37 > 0 ) {
V_99 = V_99 -> V_97 ;
...
static int F_31 ( struct V_88 * V_89 , struct V_82 V_94 )
{
struct V_86 * V_92 = F_30 ( V_89 , V_94 ) ;
if ( V_92 ) {
...
static int F_34 ( struct V_88 * V_89 , struct V_8 * V_87 )
{
struct V_90 * * V_14 = & V_89 -> V_90 ;
struct V_90 * V_91 = NULL ;
struct V_8 * V_9 = NULL ;
...
static struct V_8 * F_35 ( struct V_88 * V_89 , V_93 V_61 )
{
struct V_8 * V_9 ;
struct V_90 * V_99 = V_89 -> V_90 ;
while ( V_99 ) {
V_9 = F_27 ( V_99 , struct V_8 , V_95 ) ;
if ( V_61 < V_9 -> V_61 )
V_99 = V_99 -> V_96 ;
...
struct V_8 * F_36 ( struct V_101 * V_102 , V_93 V_61 )
{
return F_35 ( & V_102 -> V_103 , V_61 ) ;
}
const char * F_37 ( struct V_101 * V_102 , V_93 V_61 )
{
struct V_8 * V_9 ;
if ( V_61 == V_104 )
return NULL ;
if ( F_38 ( V_61 > ( V_93 ) V_105 ) )
return NULL ;
V_9 = F_35 ( & V_102 -> V_103 , ( int ) V_61 ) ;
return V_9 ? V_9 -> V_106 : NULL ;
}
int F_39 ( struct V_101 * V_102 , const char * V_106 )
{
struct V_90 * V_107 ;
for ( V_107 = F_40 ( & V_102 -> V_103 ) ; V_107 ; V_107 = F_41 ( V_107 ) ) {
struct V_8 * V_9 =
F_27 ( V_107 , struct V_8 , V_95 ) ;
if ( V_9 -> V_106 && strcmp ( V_9 -> V_106 , V_106 ) == 0 )
return V_9 -> V_61 ;
}
return - V_100 ;
}
static void F_42 ( struct V_88 * V_89 , struct V_8 * V_9 )
{
F_32 ( & V_9 -> V_95 , V_89 ) ;
F_33 ( V_9 -> V_106 ) ;
F_33 ( V_9 ) ;
}
static int F_43 ( void * * V_14 , void * V_15 , struct V_8 * V_9 )
{
V_80 V_108 , V_109 ;
unsigned V_2 , V_110 ;
void * V_111 ;
...
V_109 = F_21 ( V_14 ) ;
if ( V_108 < 5 ) {
F_44 ( L_29 , V_108 , V_109 ) ;
return - V_22 ;
}
if ( V_109 > 9 ) {
F_44 ( L_30 , V_108 , V_109 ) ;
return - V_22 ;
}
V_2 = F_7 ( V_14 ) ;
...
static int F_46 ( void * * V_14 , void * V_15 , struct V_101 * V_102 )
{
struct V_8 * V_9 ;
V_19 V_110 , V_2 ;
V_93 V_84 ;
F_11 ( V_14 , V_15 , V_110 , V_20 ) ;
F_5 ( L_31 , V_110 ) ;
while ( V_110 -- ) {
F_47 ( V_14 , V_15 , V_84 , V_20 ) ;
F_11 ( V_14 , V_15 , V_2 , V_20 ) ;
F_5 ( L_32 , V_84 , V_2 ) ;
F_6 ( V_14 , V_15 , V_2 , V_20 ) ;
V_9 = F_35 ( & V_102 -> V_103 , V_84 ) ;
if ( V_9 ) {
char * V_106 = F_48 ( * V_14 , V_2 , V_26 ) ;
if ( ! V_106 )
return - V_27 ;
F_33 ( V_9 -> V_106 ) ;
V_9 -> V_106 = V_106 ;
...
void F_49 ( struct V_101 * V_102 )
{
F_5 ( L_34 , V_102 ) ;
if ( V_102 -> V_117 )
F_24 ( V_102 -> V_117 ) ;
while ( ! F_50 ( & V_102 -> V_118 ) ) {
struct V_86 * V_92 =
F_27 ( F_40 ( & V_102 -> V_118 ) ,
struct V_86 , V_95 ) ;
F_32 ( & V_92 -> V_95 , & V_102 -> V_118 ) ;
F_33 ( V_92 ) ;
}
while ( ! F_50 ( & V_102 -> V_119 ) ) {
struct V_86 * V_92 =
F_27 ( F_40 ( & V_102 -> V_119 ) ,
struct V_86 , V_95 ) ;
F_32 ( & V_92 -> V_95 , & V_102 -> V_119 ) ;
F_33 ( V_92 ) ;
}
while ( ! F_50 ( & V_102 -> V_103 ) ) {
struct V_8 * V_9 =
F_27 ( F_40 ( & V_102 -> V_103 ) ,
struct V_8 , V_95 ) ;
F_42 ( & V_102 -> V_103 , V_9 ) ;
}
F_33 ( V_102 -> V_120 ) ;
F_33 ( V_102 -> V_121 ) ;
F_33 ( V_102 -> V_122 ) ;
...
static int F_51 ( struct V_101 * V_102 , int V_124 )
{
V_80 * V_3 ;
V_19 * V_63 ;
struct V_125 * V_126 ;
int V_39 ;
V_3 = F_52 ( V_102 -> V_120 , V_124 * sizeof( * V_3 ) , V_26 ) ;
if ( ! V_3 )
return - V_27 ;
V_102 -> V_120 = V_3 ;
V_63 = F_52 ( V_102 -> V_121 , V_124 * sizeof( * V_63 ) , V_26 ) ;
if ( ! V_63 )
return - V_27 ;
V_102 -> V_121 = V_63 ;
V_126 = F_52 ( V_102 -> V_122 , V_124 * sizeof( * V_126 ) , V_26 ) ;
if ( ! V_126 )
return - V_27 ;
V_102 -> V_122 = V_126 ;
...
static int F_53 ( void * * V_14 , void * V_15 ,
const char * V_131 , V_80 * V_132 )
{
V_80 V_133 ;
F_54 ( V_14 , V_15 , V_133 , V_134 ) ;
if ( V_133 >= 7 ) {
V_80 V_135 ;
F_54 ( V_14 , V_15 , V_135 , V_134 ) ;
if ( V_135 > V_136 ) {
F_44 ( L_35 ,
V_133 , V_135 ,
V_136 , V_131 ) ;
...
{
V_19 V_99 ;
F_11 ( V_14 , V_15 , V_99 , V_134 ) ;
while ( V_99 -- ) {
struct V_8 * V_9 ;
V_93 V_84 ;
int V_140 ;
F_47 ( V_14 , V_15 , V_84 , V_134 ) ;
V_9 = F_35 ( & V_102 -> V_103 , V_84 ) ;
if ( ! V_139 || ! V_9 ) {
...
return - V_27 ;
V_9 -> V_61 = V_84 ;
V_140 = F_34 ( & V_102 -> V_103 , V_9 ) ;
if ( V_140 ) {
F_33 ( V_9 ) ;
return V_140 ;
}
}
V_140 = F_43 ( V_14 , V_15 , V_9 ) ;
if ( V_140 )
return V_140 ;
}
return 0 ;
...
if ( V_140 )
return V_140 ;
F_11 ( V_14 , V_15 , V_2 , V_134 ) ;
V_140 = F_31 ( & V_102 -> V_118 , V_94 ) ;
F_19 ( ! V_139 && V_140 != - V_100 ) ;
if ( ! V_139 || V_2 > 0 ) {
struct V_86 * V_92 ;
F_6 ( V_14 , V_15 , V_2 * sizeof( V_19 ) , V_134 ) ;
if ( V_2 > ( V_141 - sizeof( * V_92 ) ) / sizeof( V_19 ) )
return - V_22 ;
V_92 = F_16 ( sizeof( * V_92 ) + V_2 * sizeof( V_19 ) , V_26 ) ;
if ( ! V_92 )
return - V_27 ;
V_92 -> V_94 = V_94 ;
V_92 -> V_118 . V_2 = V_2 ;
...
if ( V_140 )
return V_140 ;
F_11 ( V_14 , V_15 , V_143 , V_134 ) ;
V_140 = F_31 ( & V_102 -> V_119 , V_94 ) ;
F_19 ( ! V_139 && V_140 != - V_100 ) ;
if ( ! V_139 || V_143 != ( V_19 ) - 1 ) {
struct V_86 * V_92 ;
V_92 = F_16 ( sizeof( * V_92 ) , V_26 ) ;
if ( ! V_92 )
return - V_27 ;
V_92 -> V_94 = V_94 ;
V_92 -> V_119 . V_143 = V_143 ;
V_140 = F_26 ( V_92 , & V_102 -> V_119 ) ;
if ( V_140 ) {
F_33 ( V_92 ) ;
return V_140 ;
}
...
if ( ! V_102 -> V_123 ) {
int V_39 ;
V_102 -> V_123 = F_22 ( V_102 -> V_127 * sizeof( V_19 ) ,
V_26 ) ;
if ( ! V_102 -> V_123 )
return - V_27 ;
...
V_38 = F_53 ( V_14 , V_15 , L_40 , & V_133 ) ;
if ( V_38 )
goto V_20;
...
if ( V_38 )
goto V_20;
V_38 = F_46 ( V_14 , V_15 , V_102 ) ;
if ( V_38 )
goto V_20;
F_11 ( V_14 , V_15 , V_102 -> V_150 , V_134 ) ;
F_11 ( V_14 , V_15 , V_102 -> V_114 , V_134 ) ;
F_11 ( V_14 , V_15 , V_124 , V_134 ) ;
V_38 = F_51 ( V_102 , V_124 ) ;
if ( V_38 )
goto V_20;
...
F_11 ( V_14 , V_15 , V_2 , V_134 ) ;
V_102 -> V_117 = F_15 ( * V_14 , F_74 ( * V_14 + V_2 , V_15 ) ) ;
if ( F_75 ( V_102 -> V_117 ) ) {
...
V_80 V_133 ;
F_5 ( L_39 , V_146 , * V_14 , V_15 , ( int ) ( V_15 - * V_14 ) ) ;
V_38 = F_53 ( V_14 , V_15 , L_44 , & V_133 ) ;
if ( V_38 )
goto V_20;
...
F_11 ( V_14 , V_15 , V_2 , V_134 ) ;
if ( V_2 > 0 ) {
V_157 = F_15 ( * V_14 , F_74 ( * V_14 + V_2 , V_15 ) ) ;
if ( F_75 ( V_157 ) ) {
V_38 = F_76 ( V_157 ) ;
V_157 = NULL ;
goto V_20;
...
struct V_125 V_126 ;
F_11 ( V_14 , V_15 , V_143 , V_134 ) ;
F_23 ( V_14 , V_15 , & V_126 , sizeof( V_126 ) , V_134 ) ;
F_73 ( & V_126 ) ;
F_70 ( L_46 , V_143 ) ;
F_19 ( V_143 >= V_102 -> V_127 ) ;
...
{
struct V_8 * V_9 ;
V_9 = F_35 ( & V_184 -> V_103 , V_186 -> V_84 ) ;
if ( ! V_9 )
return - V_190 ;
...
V_19 V_199 ;
int V_2 ;
V_84 = F_35 ( & V_184 -> V_103 , V_94 . V_84 ) ;
if ( ! V_84 ) {
* V_200 = - 1 ;
return - V_100 ;
}
