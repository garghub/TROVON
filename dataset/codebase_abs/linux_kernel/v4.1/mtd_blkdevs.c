...
if ( V_13 -> V_29 ) {
F_52 ( V_94 , V_69 -> V_7 ) ;
V_69 -> V_7 -> V_95 . V_96 = V_97 ;
}
V_72 -> V_98 = V_69 -> V_7 ;
V_69 -> V_47 = F_54 ( L_4 , 0 , 0 ,
V_13 -> V_89 , V_69 -> V_56 -> V_99 ) ;
if ( ! V_69 -> V_47 )
goto V_100;
F_55 ( & V_69 -> V_38 , F_23 ) ;
V_72 -> V_101 = & V_69 -> V_56 -> V_3 ;
if ( V_69 -> V_81 )
F_56 ( V_72 , 1 ) ;
F_57 ( V_72 ) ;
if ( V_69 -> V_102 ) {
V_52 = F_58 ( & F_59 ( V_72 ) -> V_103 ,
V_69 -> V_102 ) ;
F_60 ( V_52 ) ;
}
return 0 ;
...
static void F_68 ( struct V_106 * V_56 )
{
struct V_12 * V_13 ;
...
static void F_70 ( struct V_106 * V_56 )
{
struct V_12 * V_13 ;
if ( V_56 -> type == V_109 )
return;
F_42 (tr, &blktrans_majors, list)
V_13 -> V_110 ( V_13 , V_56 ) ;
}
