...
F_76 ( F_77 ( V_3 ) , & V_182 , V_186 ) ;
F_130 ( V_325 , & V_3 -> V_134 -> V_193 ) ;
F_131 ( V_3 , & V_180 , F_128 ( V_3 , V_312 , V_193 , V_305 ) ) ;
F_132 ( V_325 , & V_3 -> V_134 -> V_193 ) ;
F_82 ( F_77 ( V_3 ) , & V_182 ) ;
}
F_133 (queue, skb, n) {
...
{
unsigned char V_331 = V_5 -> V_85 & V_231 ;
if ( F_139 ( V_312 ) >= V_5 -> V_103 )
return 1 ;
if ( V_331 != V_87 ) {
if ( V_193 & V_306 ) {
if ( V_5 -> V_82 == 0 )
...
struct V_4 * V_5 = F_2 ( V_3 ) ;
int V_337 = F_144 ( int , V_5 -> V_185 , V_5 -> V_90 ) ;
if ( V_193 & V_306 )
return 16 ;
if ( V_198 ) {
...
{
struct V_364 * V_70 = V_363 -> V_365 ;
struct V_2 * V_314 = NULL ;
for( V_70 -> V_366 = 0 ;
V_70 -> V_366 < V_367 ;
++ V_70 -> V_366 ) {
V_314 = F_28 ( & V_10 [ V_70 -> V_366 ] ) ;
if ( V_314 )
break;
}
return V_314 ;
