...
int V_121 ;
V_13 V_69 ;
if ( V_72 -> V_17 != F_50 ( V_122 ) )
return V_72 ;
V_121 = F_74 ( V_72 ) ;
if ( F_75 ( V_72 , V_121 , & V_22 , sizeof( V_22 ) ) < 0 )
return V_72 ;
if ( V_22 . V_76 < 5 || V_22 . V_123 != 4 )
return V_72 ;
V_69 = F_44 ( V_22 . V_117 ) ;
if ( V_72 -> V_69 < V_121 + V_69 || V_69 < ( V_22 . V_76 * 4 ) )
return V_72 ;
if ( F_76 ( & V_22 ) ) {
V_72 = F_77 ( V_72 , V_102 ) ;
if ( V_72 ) {
if ( ! F_78 ( V_72 , V_121 + V_22 . V_76 * 4 ) )
return V_72 ;
if ( F_47 ( V_72 , V_121 + V_69 ) )
return V_72 ;
memset ( F_42 ( V_72 ) , 0 , sizeof( struct V_124 ) ) ;
if ( F_70 ( V_72 , V_23 ) )
return NULL ;
F_79 ( V_72 ) ;
}
...
static int T_4 F_80 ( struct V_3 * V_3 )
{
struct V_125 * V_126 ;
struct V_127 * V_128 ;
V_126 = V_129 ;
if ( ! F_81 ( V_3 , & V_130 ) ) {
V_126 = F_82 ( V_126 , sizeof( V_129 ) , V_131 ) ;
if ( ! V_126 )
goto V_132;
V_126 [ 0 ] . V_112 = & V_3 -> V_4 . V_5 . V_133 ;
V_126 [ 0 ] . V_134 = & V_3 -> V_4 . V_5 . V_135 ;
V_126 [ 0 ] . V_136 = & V_130 . V_4 . V_5 . V_133 ;
V_126 [ 1 ] . V_112 = & V_3 -> V_4 . V_5 . V_135 ;
V_126 [ 1 ] . V_136 = & V_3 -> V_4 . V_5 . V_133 ;
V_126 [ 2 ] . V_112 = & V_3 -> V_4 . V_5 . V_63 ;
if ( V_3 -> V_137 != & V_138 )
V_126 [ 0 ] . V_139 = NULL ;
}
V_128 = F_83 ( V_3 , L_3 , V_126 ) ;
if ( ! V_128 )
goto V_140;
V_3 -> V_4 . V_141 = V_128 ;
return 0 ;
...
static void T_5 F_85 ( struct V_3 * V_3 )
{
struct V_125 * V_126 ;
V_126 = V_3 -> V_4 . V_141 -> V_142 ;
F_86 ( V_3 -> V_4 . V_141 ) ;
F_84 ( V_126 ) ;
}
static void T_6 F_87 ( void )
{
F_83 ( & V_130 , L_3 , V_143 ) ;
}
...
static int T_4 F_88 ( struct V_3 * V_3 )
{
V_3 -> V_4 . V_5 . V_133 = 4 * 1024 * 1024 ;
V_3 -> V_4 . V_5 . V_135 = 3 * 1024 * 1024 ;
V_3 -> V_4 . V_5 . V_63 = V_144 ;
F_89 ( & V_3 -> V_4 . V_5 ) ;
return F_80 ( V_3 ) ;
}
static void T_5 F_90 ( struct V_3 * V_3 )
{
F_85 ( V_3 ) ;
F_91 ( & V_3 -> V_4 . V_5 , & V_10 ) ;
}
void T_6 F_92 ( void )
{
F_87 () ;
