...
struct V_28 * V_29 ;
T_2 * V_30 ;
V_26 = & V_2 -> V_31 [ V_32 ] . V_33 ;
F_5 (head, list) {
V_29 = F_6 ( V_27 , struct V_28 , V_26 ) ;
if ( V_29 -> V_34 == 5 )
break;
}
if ( V_27 == V_26 ) {
...
if ( V_29 -> V_36 < 1 || V_29 -> V_37 [ 0 ] -> V_38 < 7 ) {
F_7 ( V_2 , L_8 ) ;
return - V_35 ;
}
V_30 = V_29 -> V_37 [ 0 ] -> V_30 ;
V_30 [ 0 ] = 0x12 ;
V_30 [ 1 ] = 0x10 ;
V_30 [ 2 ] = 0x11 ;
V_30 [ 3 ] = 0x12 ;
...
static int F_9 ( struct V_1 * V_2 , const struct V_40 * V_34 )
{
int V_41 ;
V_41 = F_10 ( V_2 ) ;
if ( V_41 ) {
