...
F_23 ( V_2 , V_75 , 6 , V_70 ) ;
}
int F_33 ( struct V_1 * V_2 , bool V_76 ,
T_5 * V_55 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
int V_6 ;
...
* V_55 = V_78 ;
if ( ! F_38 ( V_4 , V_74 ) &&
! F_39 ( & V_4 -> V_79 , & V_4 -> V_70 ) )
return 0 ;
V_6 = F_40 ( V_4 , V_4 -> V_80 , & V_4 -> V_70 ) ;
if ( V_6 < 0 ) {
F_21 ( L_6 , V_4 -> V_27 ) ;
return V_6 ;
}
F_35 ( V_2 , & V_4 -> V_70 ) ;
V_77 = F_41 ( V_4 -> V_81 * 1000 ) ;
F_42 ( V_4 -> V_14 , & V_4 -> V_82 , V_77 ) ;
return 0 ;
}
if ( V_76 ) {
T_7 V_83 ;
...
struct V_89 * V_90 ;
V_90 = F_45 ( V_4 , V_91 , & V_44 -> V_40 ) ;
if ( ! V_90 )
return true ;
if ( V_90 -> V_92 != V_93 && V_90 -> V_92 != V_94 )
return true ;
}
return false ;
}
...
V_95 = V_98 ;
if ( F_49 ( V_99 , & V_4 -> V_11 ) == ! ! ( V_95 & V_97 ) )
return;
if ( F_34 ( V_4 , V_100 ) )
V_95 |= V_101 ;
F_23 ( V_2 , V_102 , 1 , & V_95 ) ;
}
...
static void F_54 ( struct V_3 * V_4 , T_5 V_113 ,
T_3 V_16 )
{
if ( V_113 )
F_4 ( L_9
