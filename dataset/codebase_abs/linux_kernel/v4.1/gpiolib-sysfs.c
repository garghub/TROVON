...
if ( V_7 -> V_30 -> V_81 && V_7 -> V_30 -> V_82 &&
V_71 ) {
F_35 ( V_56 , & V_7 -> V_11 ) ;
}
F_54 ( & V_79 , V_11 ) ;
V_73 = F_23 ( V_7 ) ;
if ( V_7 -> V_30 -> V_83 && V_7 -> V_30 -> V_83 [ V_73 ] )
V_72 = V_7 -> V_30 -> V_83 [ V_73 ] ;
...
static int F_61 ( struct V_1 * V_2 , const void * V_85 )
{
return F_2 ( V_2 ) == V_85 ;
}
...
if ( F_4 ( V_10 , & V_7 -> V_11 ) ) {
struct V_1 * V_86 ;
V_86 = F_63 ( & V_74 , NULL , V_7 , F_61 ) ;
if ( V_86 != NULL ) {
V_8 = F_64 ( & V_2 -> V_38 , & V_86 -> V_38 ,
V_48 ) ;
F_65 ( V_86 ) ;
} else {
V_8 = - V_40 ;
...
if ( V_8 )
F_70 ( V_30 , L_14 , V_68 , V_8 ) ;
for ( V_46 = 0 ; V_46 < V_30 -> V_62 ; V_46 ++ ) {
V_7 = & V_30 -> V_7 [ V_46 ] ;
if ( F_52 ( V_70 , & V_7 -> V_11 ) )
F_49 ( V_7 ) ;
}
