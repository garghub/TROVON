...
V_97 -> V_222 = V_222 ;
V_97 -> V_227 = V_256 ;
V_10 = F_118 ( & V_261 , V_254 , & V_97 -> V_189 , V_97 ,
V_262 ) ;
if ( V_10 < 0 ) {
F_119 ( V_97 -> V_210 ) ;
F_29 ( V_97 ) ;
...
return snprintf ( V_266 , V_267 , L_28 , V_97 -> V_268 ) ;
}
static T_5 F_126 (
struct V_220 * V_189 ,
const char * V_266 ,
...
V_10 = snprintf ( V_266 , V_267 , L_29 ,
V_183 -> V_188 -> V_228 -> V_272 ) ;
V_123:
F_131 ( & V_97 -> V_260 ) ;
return V_10 ;
}
...
{
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
unsigned char V_279 [ V_243 ] , * V_280 ;
int V_10 ;
if ( ! strncmp ( V_266 , L_36 , 4 ) ) {
V_10 = F_138 ( V_97 ) ;
return ( ! V_10 ) ? V_269 : V_10 ;
}
if ( strlen ( V_266 ) >= V_243 ) {
F_8 ( L_37
L_38 , V_266 , V_243 ) ;
return - V_61 ;
}
snprintf ( V_279 , V_243 , L_22 , V_266 ) ;
V_280 = strstr ( V_279 , L_21 ) ;
if ( ! V_280 ) {
F_8 ( L_39 ) ;
return - V_61 ;
}
if ( V_279 [ strlen ( V_279 ) - 1 ] == '\n' )
V_279 [ strlen ( V_279 ) - 1 ] = '\0' ;
V_10 = F_132 ( V_97 , & V_279 [ 4 ] ) ;
if ( V_10 < 0 )
return V_10 ;
return V_269 ;
}
static int F_141 ( struct V_220 * V_189 , struct V_281 * V_209 )
{
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
F_142 ( & V_97 -> V_98 ) ;
F_143 () ;
...
static int F_147 ( struct V_83 * V_76 )
{
return 0 ;
}
static void F_148 ( struct V_16 * * V_282 )
{
struct V_16 * V_17 = * V_282 ;
if ( ! V_17 )
return;
V_17 -> V_283 = NULL ;
}
static int F_149 ( struct V_284 * V_285 , struct V_2 * V_3 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
struct V_49 * V_50 = V_285 -> V_76 -> V_50 ;
struct V_16 * V_17 ;
int V_286 ;
int V_10 ;
V_286 = F_150 ( V_285 , V_3 ) ;
if ( V_286 < 0 )
return V_286 ;
V_287 . V_288 = V_286 ;
V_289 . V_288 = V_286 ;
V_9 -> V_286 = V_286 ;
V_17 = F_151 ( V_50 , & V_290 ,
& V_291 ) ;
if ( ! V_17 )
goto V_292;
V_17 -> V_283 = V_9 ;
V_9 -> V_32 = V_17 ;
V_17 = F_151 ( V_50 , & V_293 ,
& V_294 ) ;
if ( ! V_17 )
goto V_292;
V_17 -> V_283 = V_9 ;
V_9 -> V_13 = V_17 ;
V_17 = F_151 ( V_50 , & V_295 ,
& V_296 ) ;
if ( ! V_17 )
goto V_292;
V_17 -> V_283 = V_9 ;
V_9 -> V_105 = V_17 ;
V_17 = F_151 ( V_50 , & V_297 ,
& V_298 ) ;
if ( ! V_17 )
goto V_292;
V_17 -> V_283 = V_9 ;
V_9 -> V_107 = V_17 ;
V_299 . V_300 = V_290 . V_300 ;
V_301 . V_300 = V_293 . V_300 ;
V_302 . V_300 =
V_295 . V_300 ;
V_303 . V_300 = V_297 . V_300 ;
V_304 . V_300 = V_290 . V_300 ;
V_305 . V_300 = V_293 . V_300 ;
V_306 . V_300 =
V_295 . V_300 ;
V_307 . V_300 = V_297 . V_300 ;
V_10 = F_152 ( V_3 , V_308 ,
V_309 , V_310 ) ;
if ( V_10 )
goto V_292;
return 0 ;
...
static void F_153 ( struct V_284 * V_285 , struct V_2 * V_3 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
F_154 ( V_3 ) ;
F_29 ( V_9 ) ;
}
static void F_155 ( struct V_180 * V_311 )
{
struct V_312 * V_181 = F_2 ( V_311 , struct V_312 ,
V_181 ) ;
struct V_1 * V_9 = V_181 -> V_9 ;
int V_313 = V_181 -> V_313 ;
F_29 ( V_181 ) ;
if ( V_9 -> V_11 & V_77 )
F_31 ( V_9 ) ;
if ( V_9 -> V_11 & V_131 )
...
F_57 ( V_9 ) ;
F_156 ( V_9 -> V_4 . V_75 -> V_76 ) ;
}
static int F_157 ( struct V_2 * V_3 , unsigned V_316 , unsigned V_313 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
if ( ( V_313 == V_314 ) || ( V_313 == V_315 ) ) {
struct V_312 * V_181 ;
V_181 = F_18 ( sizeof( * V_181 ) , V_15 ) ;
if ( ! V_181 )
return - V_55 ;
F_74 ( & V_181 -> V_181 , F_155 ) ;
V_181 -> V_9 = V_9 ;
V_181 -> V_313 = V_313 ;
F_158 ( & V_181 -> V_181 ) ;
return V_317 ;
...
static int F_161 ( struct V_284 * V_285 )
{
struct V_1 * V_9 ;
int V_10 ;
...
V_9 -> V_4 . V_323 = F_159 ;
V_9 -> V_97 = V_258 ;
V_287 . V_324 = V_325 [ V_326 ] . V_327 ;
V_289 . V_324 = V_325 [ V_328 ] . V_327 ;
V_10 = F_162 ( V_285 , & V_9 -> V_4 ) ;
if ( V_10 )
goto V_65;
return 0 ;
V_65:
...
static int F_163 ( struct V_83 * V_76 )
{
int V_10 ;
V_10 = F_164 ( V_76 , V_325 ) ;
if ( V_10 )
return V_10 ;
V_329 . V_330 =
V_325 [ V_331 ] . V_327 ;
V_329 . V_332 = V_325 [ V_333 ] . V_327 ;
V_329 . V_334 =
V_325 [ V_335 ] . V_327 ;
V_336 . V_337 =
V_325 [ V_338 ] . V_327 ;
V_10 = F_165 ( V_76 , & V_336 ,
F_161 ) ;
if ( V_10 )
return V_10 ;
F_166 ( V_76 , & V_339 ) ;
