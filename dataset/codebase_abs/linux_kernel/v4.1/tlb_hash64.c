...
void F_24 ( struct V_1 * V_2 , unsigned long V_30 ,
unsigned long V_31 )
{
int V_32 ;
unsigned long V_33 ;
...
F_28 ( V_33 ) ;
F_29 () ;
for (; V_30 < V_31 ; V_30 += V_34 ) {
T_1 * V_4 = F_30 ( V_2 -> V_35 , V_30 ,
& V_32 ) ;
unsigned long V_5 ;
if ( V_4 == NULL )
continue;
...
if ( ! ( V_5 & V_36 ) )
continue;
if ( F_33 ( V_32 && F_34 ( * ( V_37 * ) V_5 ) ) )
F_35 ( V_2 , V_30 , ( V_37 * ) V_4 , V_5 ) ;
else
F_1 ( V_2 , V_30 , V_4 , V_5 , 0 ) ;
}
F_36 () ;
F_37 ( V_33 ) ;
}
void F_38 ( struct V_1 * V_2 , V_37 * V_38 , unsigned long V_3 )
{
T_1 * V_5 ;
T_1 * V_39 ;
unsigned long V_33 ;
...
F_29 () ;
V_39 = F_39 ( V_38 , V_3 ) ;
for ( V_5 = V_39 ; V_5 < V_39 + V_41 ; V_5 ++ ) {
unsigned long V_42 = F_31 ( * V_5 ) ;
if ( V_42 & V_36 )
F_1 ( V_2 , V_3 , V_5 , V_42 , 0 ) ;
V_3 += V_34 ;
}
F_36 () ;
F_37 ( V_33 ) ;
