...
unsigned int V_46 ;
int V_98 ;
V_98 = V_59 -> V_99 -> V_100 ( V_59 -> V_7 . V_101 , & V_90 ) ;
if ( V_98 )
return V_98 ;
V_2 = V_90 . V_93 ;
for ( V_46 = 0 ; V_46 < F_17 ( V_2 -> V_47 ) ; V_46 ++ ) {
...
unsigned int V_102 , void * V_44 )
{
struct V_1 * V_2 ;
int V_103 = 0 ;
V_2 = F_31 ( V_59 -> V_7 . V_101 ) ;
switch ( V_102 ) {
case V_104 :
F_45 ( V_59 ) ;
F_27 ( V_2 ) ;
...
int V_43 ;
int V_98 ;
V_2 = F_50 ( & V_109 -> V_7 , sizeof( * V_2 ) , V_112 ) ;
if ( ! V_2 )
return - V_113 ;
V_111 = F_51 ( V_109 , V_114 , 0 ) ;
V_2 -> V_4 = F_52 ( & V_109 -> V_7 , V_111 ) ;
if ( F_34 ( V_2 -> V_4 ) )
return F_37 ( V_2 -> V_4 ) ;
V_2 -> V_115 = F_53 ( & V_109 -> V_7 , L_2 ) ;
if ( F_34 ( V_2 -> V_115 ) ) {
F_36 ( & V_109 -> V_7 , L_3 ) ;
return F_37 ( V_2 -> V_115 ) ;
}
V_2 -> clock = F_54 ( & V_109 -> V_7 , L_2 ) ;
if ( F_34 ( V_2 -> clock ) ) {
F_36 ( & V_109 -> V_7 , L_4 ) ;
return F_37 ( V_2 -> clock ) ;
}
V_2 -> V_88 = F_54 ( & V_109 -> V_7 , L_5 ) ;
if ( F_34 ( V_2 -> V_88 ) ) {
F_36 ( & V_109 -> V_7 , L_6 ) ;
...
F_58 ( V_2 -> V_115 ) ;
V_2 -> V_12 = F_59 ( V_2 -> V_88 , V_116 ) / V_14 ;
V_2 -> V_19 = F_60 ( V_2 -> V_88 ) / V_14 ;
F_3 ( V_2 , V_16 - 1 ,
V_118 ) ;
for ( V_46 = 0 ; V_46 < F_17 ( V_119 ) ; V_46 ++ ) {
V_7 = V_2 -> V_47 + V_46 ;
V_7 -> V_20 = V_119 + V_46 ;
...
V_122 . V_123 = F_60 ( V_2 -> V_88 ) ;
V_2 -> V_59 = F_66 ( & V_109 -> V_7 ,
& V_122 ,
L_12 ,
NULL ) ;
return 0 ;
