...
V_4 -> V_56 = V_57 | V_58 ;
V_4 -> V_59 = 8 ;
V_4 -> V_60 = ( 1 << V_15 -> V_37 ) - 1 ;
V_4 -> V_33 = V_61 [ V_15 -> V_62 ] ;
V_4 -> V_63 = F_3 ;
V_18 -> V_35 = V_64 [ V_15 -> V_62 ] ;
} else {
V_4 -> type = V_65 ;
}
V_4 = & V_2 -> V_54 [ 1 ] ;
...
V_4 -> V_56 = V_68 ;
V_4 -> V_59 = 2 ;
V_4 -> V_60 = ( 1 << V_15 -> V_66 ) - 1 ;
V_4 -> V_33 = & V_69 ;
V_4 -> V_70 = F_26 ;
V_25 = F_29 ( V_4 ) ;
if ( V_25 )
return V_25 ;
for ( V_51 = 0 ; V_51 < V_4 -> V_59 ; V_51 ++ ) {
V_4 -> V_50 [ V_51 ] = V_4 -> V_60 / 2 ;
...
V_4 = & V_2 -> V_54 [ 4 ] ;
if ( V_15 -> V_77 != 0 ) {
V_25 = F_30 ( V_2 , V_4 , NULL , V_15 -> V_77 ) ;
if ( V_25 )
return V_25 ;
} else {
V_4 -> type = V_65 ;
