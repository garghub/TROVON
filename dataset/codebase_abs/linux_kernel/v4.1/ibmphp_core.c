...
V_30 -> V_19 = V_93 ;
V_30 -> V_104 = V_105 -> V_104 ;
V_101 -> V_30 = V_30 ;
for ( V_101 -> V_32 = 0 ; V_101 -> V_32 < 256 ; V_101 -> V_32 += 8 ) {
if ( ! F_57 ( V_101 , V_106 , & V_103 ) &&
( V_103 != 0x0000 ) && ( V_103 != 0xffff ) ) {
F_2 ( L_52 ,
V_66 ) ;
V_102 = F_58 ( V_93 , V_105 -> V_104 , NULL ) ;
if ( ! V_102 )
continue;
F_59 ( V_102 ) ;
break;
...
static int F_60 ( struct V_92 * V_96 )
{
struct V_64 * V_107 ;
int V_108 ;
int V_109 = 0 ;
...
if ( ! ( V_109 ) && ( V_96 -> V_101 -> V_111 == V_112 ) ) {
F_63 ( V_96 -> V_101 ) ;
V_107 = V_96 -> V_101 -> V_113 ;
if ( V_107 )
F_59 ( V_107 ) ;
}
V_110:
...
int V_3 ;
struct V_1 * V_114 ;
T_2 V_25 = V_4 -> V_9 -> V_115 ;
while ( V_25 <= V_4 -> V_9 -> V_116 ) {
if ( V_25 == V_4 -> V_19 ) {
V_25 ++ ;
continue;
}
...
T_2 V_127 = 0 ;
T_2 V_128 = 0 ;
for ( V_25 = V_4 -> V_9 -> V_115 ; V_25 <= V_4 -> V_9 -> V_116 ; V_25 ++ ) {
V_114 = F_65 ( V_25 ) ;
if ( ! V_114 )
return - V_53 ;
if ( ( F_32 ( V_114 -> V_40 ) ) &&
...
{
V_82 ( L_62 ) ;
if ( ( V_4 -> V_58 & V_134 ) == V_135 )
V_82 ( L_63 ) ;
else if ( ( V_4 -> V_58 & V_134 ) == V_136 )
V_82 ( L_64 ) ;
else if ( ( V_4 -> V_58 & V_134 ) == V_137 )
V_82 ( L_65 ) ;
else
V_82 ( L_66 ) ;
}
static int F_76 ( struct V_43 * V_138 )
{
int V_3 , V_25 , V_139 ;
struct V_1 * V_4 ;
T_2 V_94 ;
...
V_94 = 0x00 ;
do {
V_140 = F_44 ( V_4 -> V_30 , V_4 -> V_96 -> V_31 ,
V_94 ++ ) ;
if ( V_140 && ! ( V_140 -> V_101 ) )
F_60 ( V_140 ) ;
} while ( V_140 );
F_78 ( V_4 ) ;
if ( F_8 ( & V_4 ) ) {
...
int V_3 = 0 ;
V_14 = 1 ;
V_82 ( V_145 L_93 V_146 L_94 ) ;
V_105 = F_42 ( sizeof( * V_105 ) , V_84 ) ;
if ( ! V_105 ) {
F_15 ( L_95 ) ;
V_3 = - V_26 ;
goto exit;
...
memcpy ( V_105 , V_30 , sizeof( * V_105 ) ) ;
V_147 = F_2 ;
F_93 () ;
