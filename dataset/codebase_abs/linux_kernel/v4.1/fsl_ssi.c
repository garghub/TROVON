...
V_91 = V_94 * V_87 * ( V_88 + 1 ) ;
if ( V_95 )
V_89 = F_30 ( V_2 -> V_97 ) ;
else
V_89 = F_31 ( V_2 -> V_97 , V_91 ) ;
if ( V_89 * 5 > F_30 ( V_2 -> V_72 ) )
continue;
V_89 /= V_87 ;
V_86 = V_89 / ( V_88 + 1 ) ;
if ( V_94 == V_86 )
...
V_209 = F_71 ( V_188 , V_219 , 0 ) ;
V_189 = F_72 ( & V_188 -> V_101 , V_209 ) ;
if ( F_28 ( V_189 ) )
return F_56 ( V_189 ) ;
V_2 -> V_197 = V_209 -> V_220 ;
V_71 = F_73 ( V_191 , L_15 , L_5 ) ;
if ( V_71 < 0 ) {
V_2 -> V_194 = false ;
V_2 -> V_11 = F_74 ( & V_188 -> V_101 , V_189 ,
& V_221 ) ;
} else {
V_2 -> V_194 = true ;
V_2 -> V_11 = F_75 ( & V_188 -> V_101 ,
L_5 , V_189 , & V_221 ) ;
}
if ( F_28 ( V_2 -> V_11 ) ) {
...
V_2 -> V_8 = F_76 ( V_188 , 0 ) ;
if ( V_2 -> V_8 < 0 ) {
F_33 ( & V_188 -> V_101 , L_17 , V_188 -> V_210 ) ;
return V_2 -> V_8 ;
}
if ( ! F_77 ( V_191 , L_18 , NULL ) ) {
V_2 -> V_79 . V_80 = 1 ;
V_2 -> V_79 . V_222 = 1 ;
V_2 -> V_79 . V_223 = 1 ;
}
V_207 = F_67 ( V_191 , L_19 , NULL ) ;
if ( V_207 )
V_2 -> V_147 = F_78 ( V_207 ) ;
else
V_2 -> V_147 = 8 ;
F_79 ( & V_188 -> V_101 , V_2 ) ;
if ( V_2 -> V_15 -> V_168 ) {
V_71 = F_54 ( V_188 , V_2 , V_189 ) ;
if ( V_71 )
return V_71 ;
}
V_71 = F_80 ( & V_188 -> V_101 , & V_224 ,
& V_2 -> V_79 , 1 ) ;
if ( V_71 ) {
F_33 ( & V_188 -> V_101 , L_20 , V_71 ) ;
goto V_225;
}
if ( V_2 -> V_48 ) {
V_71 = F_81 ( & V_188 -> V_101 , V_2 -> V_8 ,
F_4 , 0 , F_70 ( & V_188 -> V_101 ) ,
V_2 ) ;
if ( V_71 < 0 ) {
F_33 ( & V_188 -> V_101 , L_21 ,
V_2 -> V_8 ) ;
goto V_225;
}
}
V_71 = F_82 ( & V_2 -> V_17 , & V_188 -> V_101 ) ;
if ( V_71 )
goto V_225;
if ( ! F_67 ( V_191 , L_22 , NULL ) )
goto V_226;
V_206 = F_67 ( F_83 ( L_23 ) , L_24 , NULL ) ;
V_185 = strrchr ( V_206 , ',' ) ;
if ( V_185 )
V_206 = V_185 + 1 ;
snprintf ( V_210 , sizeof( V_210 ) , L_25 , V_206 ) ;
F_53 ( V_210 ) ;
V_2 -> V_188 =
F_84 ( & V_188 -> V_101 , V_210 , 0 , NULL , 0 ) ;
if ( F_28 ( V_2 -> V_188 ) ) {
V_71 = F_56 ( V_2 -> V_188 ) ;
F_33 ( & V_188 -> V_101 , L_26 , V_71 ) ;
goto V_227;
}
V_226:
if ( V_2 -> V_3 )
...
{
struct V_1 * V_2 = F_87 ( & V_188 -> V_101 ) ;
F_85 ( & V_2 -> V_17 ) ;
if ( V_2 -> V_188 )
F_88 ( V_2 -> V_188 ) ;
if ( V_2 -> V_15 -> V_168 )
