...
struct V_182 * V_183 )
{
struct V_184 * V_185 = F_32 ( V_181 ) ;
struct V_105 * V_106 = ( void * ) V_185 -> V_42 ;
F_21 ( V_2 , L_8 ) ;
F_21 ( V_2 , L_9 ,
V_106 -> V_159 ? L_10 : L_11 ) ;
F_21 ( V_2 , L_12 , V_106 -> V_186 ) ;
F_21 ( V_2 , L_13 , V_106 -> V_187 ) ;
F_21 ( V_2 , L_14 ,
F_8 ( V_106 -> V_27 ) ) ;
F_21 ( V_2 , L_15 ,
F_8 ( V_106 -> V_29 ) ) ;
...
V_131 -> V_149 == V_191 )
return;
V_190 = F_34 ( V_2 -> V_192 [ V_131 -> V_149 ] ,
F_35 ( & V_2 -> V_43 ) ) ;
if ( F_36 ( V_190 ) )
return;
V_124 = F_37 ( V_190 ) ;
...
if ( ! V_2 -> V_26 . V_159 )
return;
F_21 ( V_2 , L_18 , V_10 -> V_155 . V_195 ,
V_194 == V_196 ? L_19 : L_20 ) ;
if ( V_194 == V_197 || V_2 -> V_21 -> V_22 ||
F_4 ( V_2 , V_10 ) == V_163 )
...
if ( V_2 -> V_26 . V_200 )
return V_199 ;
V_198 = F_4 ( V_2 , V_124 -> V_10 ) ;
if ( V_198 == V_163 || V_198 == V_19 )
return V_199 ;
return V_201 ;
}
...
{
struct V_184 * V_185 = F_32 ( V_181 ) ;
T_2 V_204 = F_45 ( ( void * ) V_185 -> V_42 ) ;
T_3 T_4 V_205 , V_206 ;
int V_13 ;
T_3 V_207 ;
struct V_30 * V_31 ;
...
if ( V_204 == V_2 -> V_208 )
return 0 ;
for ( V_207 = 0 ; V_207 < F_46 ( V_97 ) - 1 ; V_207 ++ )
if ( V_204 < V_97 [ V_207 + 1 ] . V_209 )
break;
V_205 = V_97 [ V_207 ] . V_209 ;
if ( V_207 < F_46 ( V_97 ) - 1 )
V_206 = V_97 [ V_207 + 1 ] . V_209 ;
else
V_206 = V_97 [ V_207 ] . V_209 ;
F_21 ( V_2 , L_22 ,
...
V_84 |
V_85 ) ;
memcpy ( V_31 -> V_96 , V_97 [ V_207 ] . V_98 ,
sizeof( V_31 -> V_96 ) ) ;
memcpy ( V_31 -> V_99 , V_97 [ V_207 ] . V_98 ,
sizeof( V_31 -> V_99 ) ) ;
V_13 = F_16 ( V_2 , & V_33 ) ;
F_17 ( V_31 ) ;
return V_13 ;
