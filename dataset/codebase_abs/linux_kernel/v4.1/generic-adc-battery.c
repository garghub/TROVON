...
bool V_54 ;
int V_18 ;
V_53 = F_18 ( V_52 , struct V_53 , V_52 ) ;
V_4 = F_18 ( V_53 , struct V_1 , V_5 ) ;
V_7 = V_4 -> V_7 ;
V_18 = V_4 -> V_18 ;
V_54 = F_19 ( V_4 -> V_3 ) ;
V_4 -> V_55 = V_54 ;
...
static T_1 F_21 ( int V_59 , void * V_60 )
{
struct V_1 * V_4 = V_60 ;
struct V_6 * V_7 = V_4 -> V_7 ;
int V_61 ;
...
int V_73 ;
int V_74 = 0 ;
V_4 = F_23 ( & V_66 -> V_33 , sizeof( * V_4 ) , V_75 ) ;
if ( ! V_4 ) {
F_16 ( & V_66 -> V_33 , L_3 ) ;
return - V_76 ;
}
...
for ( V_73 = 0 ; V_73 < F_25 ( V_82 ) ; V_73 ++ ) {
V_4 -> V_30 [ V_73 ] = F_26 ( & V_66 -> V_33 ,
V_82 [ V_73 ] ) ;
if ( F_27 ( V_4 -> V_30 [ V_73 ] ) ) {
V_8 = F_28 ( V_4 -> V_30 [ V_73 ] ) ;
V_4 -> V_30 [ V_73 ] = NULL ;
} else {
...
V_68 -> V_87 = F_25 ( V_81 ) + V_74 ;
V_4 -> V_3 = F_29 ( & V_66 -> V_33 , V_68 , & V_70 ) ;
if ( F_27 ( V_4 -> V_3 ) ) {
V_8 = F_28 ( V_4 -> V_3 ) ;
goto V_88;
}
...
static int F_43 ( struct V_93 * V_33 )
{
...
static int F_46 ( struct V_93 * V_33 )
{
struct V_1 * V_4 = F_44 ( V_33 ) ;
struct V_6 * V_7 = V_4 -> V_7 ;
int V_61 ;
