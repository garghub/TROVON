...
static int F_83 ( struct V_151 * V_75 )
{
struct V_69 * V_159 = F_84 ( V_75 ) ;
F_85 ( & V_160 , & V_159 -> V_2 ) ;
return 0 ;
}
static int F_86 ( struct V_151 * V_75 )
{
struct V_69 * V_159 = F_84 ( V_75 ) ;
F_87 ( & V_160 , & V_159 -> V_2 ) ;
return 0 ;
}
