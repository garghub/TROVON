...
V_18 -> V_147 . V_215 , V_173 , NULL , V_173 -> V_13 ,
V_249 ) ;
V_250:
if ( ! V_19 ) {
...
F_155 ( V_173 , V_27 ) ;
V_19 = F_156 ( V_247 , V_248 , V_8 , V_173 ,
NULL , V_173 -> V_13 , V_249 ) ;
V_250:
if ( ! V_19 ) {
F_157 ( V_18 , V_2 , type ) ;
F_158 ( V_18 , V_2 , V_251 ) ;
...
static int F_23 ( struct V_7 * V_8 , struct V_14 * V_296 ,
struct V_1 * V_2 )
{
int V_19 ;
if ( ! V_296 -> V_32 ) {
return F_37 ( V_2 , & V_296 -> V_11 , V_296 -> V_29 , 0 , NULL , 0 ) ;
}
V_19 = F_37 ( V_2 , & V_296 -> V_11 , V_296 -> V_29 ,
V_296 -> V_32 -> V_61 , V_296 -> V_32 -> V_62 , 0 ) ;
F_16 ( V_8 , V_296 -> V_32 , F_39 ( V_296 -> V_32 -> V_66 ) ) ;
V_296 -> V_32 = NULL ;
return V_19 ;
}
...
V_19 = F_218 ( & V_18 -> V_147 . V_321 , V_319 ,
V_320 , V_223 , V_18 ) ;
if ( V_19 < 0 ) {
F_219 ( L_8 ,
V_19 ) ;
