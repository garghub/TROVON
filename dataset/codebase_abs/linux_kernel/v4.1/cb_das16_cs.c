...
unsigned int V_29 = V_4 -> V_30 [ V_16 ] ;
unsigned short V_23 ;
int V_31 ;
int V_21 ;
for ( V_21 = 0 ; V_21 < V_6 -> V_27 ; V_21 ++ ) {
...
V_35 = 0xf0 ;
V_20 = F_14 ( V_2 , V_4 , V_6 , V_12 , V_35 ) ;
if ( V_20 )
return V_20 ;
V_14 -> V_25 &= ~ 0x00c0 ;
...
int V_21 ;
for ( V_21 = 0 ; V_21 < F_16 ( V_41 ) ; V_21 ++ ) {
V_40 = & V_41 [ V_21 ] ;
...
V_38 -> V_53 = V_2 ;
V_14 = F_20 ( V_2 , sizeof( * V_14 ) ) ;
if ( ! V_14 )
return - V_54 ;
V_2 -> V_55 = F_21 ( V_2 -> V_9 + V_56 ,
V_57 , V_58 , 0 ) ;
if ( ! V_2 -> V_55 )
return - V_54 ;
V_20 = F_22 ( V_2 , 3 ) ;
