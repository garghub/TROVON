...
( 1L << V_204 ) |
( 1L << V_205 ) ) ) ;
V_197 -> V_102 |= ( 1L << V_206 ) ;
F_162 () ;
V_197 -> V_207 = V_17 -> V_207 ;
F_33 ( V_197 -> V_153 ) ;
V_197 -> V_153 = V_17 -> V_153 ;
V_197 -> V_208 = V_17 -> V_208 + V_131 ;
...
{
int V_210 , V_211 ;
T_12 V_212 = V_17 -> V_208 << ( V_213 - V_6 ) ;
struct V_214 * V_215 ;
F_33 ( ! F_126 ( V_17 ) ) ;
F_33 ( F_244 ( V_17 ) ) ;
V_210 = 0 ;
F_245 (avc, &anon_vma->rb_root, pgoff, pgoff) {
struct V_80 * V_81 = V_215 -> V_81 ;
unsigned long V_116 = F_246 ( V_17 , V_81 ) ;
F_33 ( F_247 ( V_81 ) ) ;
V_210 += F_217 ( V_17 , V_81 , V_116 ) ;
}
if ( V_210 != F_168 ( V_17 ) ) {
F_12 ( L_17 ,
V_210 , F_168 ( V_17 ) ) ;
...
unsigned long V_116 = F_246 ( V_17 , V_81 ) ;
F_33 ( F_247 ( V_81 ) ) ;
V_211 += F_238 ( V_17 , V_81 , V_116 ) ;
}
if ( V_210 != V_211 ) {
F_12 ( L_18 ,
V_210 , V_211 , F_168 ( V_17 ) ) ;
F_248 () ;
}
}
...
static inline struct V_223 * F_261 ( void )
{
if ( ! V_222 )
return NULL ;
return F_262 ( V_222 , V_134 ) ;
}
static inline void F_263 ( struct V_223 * V_223 )
{
F_264 ( V_222 , V_223 ) ;
}
static struct V_223 * F_265 ( struct V_86 * V_87 )
{
struct V_223 * V_223 ;
...
{
V_223 -> V_87 = V_87 ;
F_268 ( V_224 , & V_223 -> V_225 , ( long ) V_87 ) ;
}
static inline int F_269 ( struct V_86 * V_87 )
{
return F_36 ( & V_87 -> V_226 ) == 0 ;
}
...
if ( F_10 ( F_272 ( V_228 , & V_87 -> V_102 ) ) ) {
F_263 ( V_223 ) ;
return 0 ;
}
F_167 ( & V_229 ) ;
F_267 ( V_87 , V_223 ) ;
V_227 = F_14 ( & V_13 . V_14 ) ;
F_273 ( & V_223 -> V_230 , & V_13 . V_14 ) ;
F_100 ( & V_229 ) ;
F_274 ( & V_87 -> V_231 ) ;
if ( V_227 )
F_15 ( & V_15 ) ;
...
if ( V_81 -> V_234 )
return 0 ;
F_166 ( V_82 & V_220 , V_81 ) ;
V_232 = ( V_81 -> V_104 + ~ V_103 ) & V_103 ;
V_233 = V_81 -> V_106 & V_103 ;
if ( V_232 < V_233 )
...
static void F_284 ( T_9 * V_139 , T_9 * V_237 )
{
while ( -- V_237 >= V_139 ) {
T_9 V_238 = * V_237 ;
if ( ! F_159 ( V_238 ) && ! F_285 ( F_286 ( V_238 ) ) )
F_281 ( F_287 ( V_238 ) ) ;
}
}
...
T_9 * V_237 ;
int V_239 = 0 ;
bool V_240 = false , V_241 = false ;
for ( V_237 = V_139 ; V_237 < V_139 + V_32 ;
V_237 ++ , V_101 += V_137 ) {
T_9 V_238 = * V_237 ;
if ( F_159 ( V_238 ) || F_285 ( F_286 ( V_238 ) ) ) {
if ( ++ V_239 <= V_63 )
...
{
T_9 * V_237 ;
for ( V_237 = V_139 ; V_237 < V_139 + V_32 ; V_237 ++ ) {
T_9 V_238 = * V_237 ;
struct V_17 * V_119 ;
if ( F_159 ( V_238 ) || F_285 ( F_286 ( V_238 ) ) ) {
F_301 ( V_17 , V_101 ) ;
F_109 ( V_81 -> V_145 , V_96 , 1 ) ;
if ( F_285 ( F_286 ( V_238 ) ) ) {
F_167 ( V_93 ) ;
F_302 ( V_81 -> V_145 , V_101 , V_237 ) ;
F_100 ( V_93 ) ;
}
} else {
V_119 = F_287 ( V_238 ) ;
...
if ( V_244 [ V_242 ] )
return false ;
for ( V_131 = 0 ; V_131 < V_245 ; V_131 ++ ) {
if ( ! V_244 [ V_131 ] )
continue;
if ( F_308 ( V_242 , V_131 ) > V_246 )
return true ;
}
return false ;
}
...
{
static int V_247 = V_248 ;
int V_242 , V_249 = 0 , V_250 = 0 ;
for ( V_242 = 0 ; V_242 < V_245 ; V_242 ++ )
if ( V_244 [ V_242 ] > V_250 ) {
V_250 = V_244 [ V_242 ] ;
V_249 = V_242 ;
}
if ( V_249 <= V_247 )
for ( V_242 = V_247 + 1 ; V_242 < V_245 ;
V_242 ++ )
if ( V_250 == V_244 [ V_242 ] ) {
V_249 = V_242 ;
break;
}
V_247 = V_249 ;
...
static bool F_310 ( struct V_17 * * V_251 , bool * V_252 )
{
if ( F_11 ( * V_251 ) ) {
if ( ! * V_252 )
return false ;
...
static struct V_17 *
F_311 ( struct V_17 * * V_251 , T_6 V_89 , struct V_86 * V_87 ,
struct V_80 * V_81 , unsigned long V_101 ,
int V_253 )
{
F_91 ( * V_251 , * V_251 ) ;
F_312 ( & V_87 -> V_235 ) ;
* V_251 = F_313 ( V_253 , V_89 , V_25 ) ;
if ( F_10 ( ! * V_251 ) ) {
F_25 ( V_254 ) ;
* V_251 = F_177 ( - V_67 ) ;
return NULL ;
...
static struct V_17 * F_315 ( bool * V_252 )
{
struct V_17 * V_251 ;
do {
V_251 = F_314 ( F_316 () ) ;
...
{
if ( ( ! ( V_81 -> V_82 & V_219 ) && ! F_318 () ) ||
( V_81 -> V_82 & V_183 ) )
return false ;
if ( ! V_81 -> V_123 || V_81 -> V_234 )
return false ;
if ( F_247 ( V_81 ) )
return false ;
F_166 ( V_81 -> V_82 & V_220 , V_81 ) ;
return true ;
}
...
V_259 ;
V_141 = F_311 ( V_251 , V_89 , V_87 , V_81 , V_101 , V_253 ) ;
if ( ! V_141 )
return;
...
V_232 = ( V_81 -> V_104 + ~ V_103 ) & V_103 ;
V_233 = V_81 -> V_106 & V_103 ;
if ( V_101 < V_232 || V_101 + V_105 > V_233 )
goto V_79;
if ( ! F_317 ( V_81 ) )
goto V_79;
...
V_257 = F_322 ( V_87 , V_16 ) ;
V_132 = V_101 ;
V_133 = V_101 + V_105 ;
F_151 ( V_87 , V_132 , V_133 ) ;
V_256 = F_98 ( V_87 , V_16 ) ;
V_130 = F_323 ( V_81 , V_101 , V_16 ) ;
F_100 ( V_256 ) ;
F_164 ( V_87 , V_132 , V_133 ) ;
F_167 ( V_257 ) ;
V_258 = F_288 ( V_81 , V_101 , V_139 ) ;
F_100 ( V_257 ) ;
if ( F_10 ( ! V_258 ) ) {
F_161 ( V_139 ) ;
F_167 ( V_256 ) ;
...
F_252 ( V_81 -> V_123 ) ;
F_300 ( V_139 , V_141 , V_81 , V_101 , V_257 ) ;
F_161 ( V_139 ) ;
F_97 ( V_141 ) ;
V_92 = F_324 ( V_130 ) ;
...
for ( V_261 = V_101 , V_237 = V_139 ; V_237 < V_139 + V_32 ;
V_237 ++ , V_261 += V_137 ) {
T_9 V_238 = * V_237 ;
if ( F_159 ( V_238 ) || F_285 ( F_286 ( V_238 ) ) ) {
if ( ++ V_239 <= V_63 )
...
if ( V_46 ) {
V_253 = F_309 () ;
F_319 ( V_87 , V_101 , V_251 , V_81 , V_253 ) ;
}
V_79:
return V_46 ;
}
static void F_328 ( struct V_223 * V_223 )
{
struct V_86 * V_87 = V_223 -> V_87 ;
F_42 ( V_263 != 1 && ! F_329 ( & V_229 ) ) ;
if ( F_269 ( V_87 ) ) {
F_276 ( & V_223 -> V_225 ) ;
F_277 ( & V_223 -> V_230 ) ;
F_263 ( V_223 ) ;
...
{
struct V_17 * V_251 = NULL ;
unsigned int V_264 = 0 , V_265 = 0 ;
unsigned int V_59 = V_58 ;
bool V_252 = true ;
F_335 () ;
while ( V_264 < V_59 ) {
if ( ! F_310 ( & V_251 , & V_252 ) )
break;
F_150 () ;
if ( F_10 ( F_333 () || F_336 ( V_266 ) ) )
break;
F_167 ( & V_229 ) ;
if ( ! V_13 . V_223 )
V_265 ++ ;
...
static void F_343 ( struct V_80 * V_81 ,
unsigned long V_88 , T_1 * V_16 )
{
struct V_86 * V_87 = V_81 -> V_145 ;
T_7 V_92 ;
...
for ( V_131 = 0 ; V_131 < V_32 ; V_131 ++ , V_88 += V_137 ) {
T_9 * V_139 , V_85 ;
V_85 = F_344 ( F_345 ( V_88 ) , V_81 -> V_95 ) ;
V_85 = F_346 ( V_85 ) ;
V_139 = F_158 ( & V_130 , V_88 ) ;
F_42 ( ! F_159 ( * V_139 ) ) ;
F_160 ( V_87 , V_88 , V_139 , V_85 ) ;
...
void F_347 ( struct V_80 * V_81 , unsigned long V_101 ,
T_1 * V_16 )
{
T_8 * V_93 ;
struct V_17 * V_17 ;
...
void F_348 ( struct V_86 * V_87 , unsigned long V_101 ,
T_1 * V_16 )
{
struct V_80 * V_81 ;
V_81 = F_320 ( V_87 , V_101 ) ;
...
static void F_349 ( struct V_86 * V_87 ,
unsigned long V_101 )
{
T_10 * V_188 ;
T_11 * V_189 ;
...
if ( ! F_216 ( * V_16 ) )
return;
F_348 ( V_87 , V_101 , V_16 ) ;
}
void F_350 ( struct V_80 * V_81 ,
unsigned long V_270 ,
unsigned long V_271 ,
long V_272 )
{
...
F_349 ( V_81 -> V_145 , V_270 ) ;
if ( V_271 & ~ V_103 &&
( V_271 & V_103 ) >= V_81 -> V_104 &&
( V_271 & V_103 ) + V_105 <= V_81 -> V_106 )
F_349 ( V_81 -> V_145 , V_271 ) ;
if ( V_272 > 0 ) {
struct V_80 * V_273 = V_81 -> V_274 ;
unsigned long V_275 = V_273 -> V_104 ;
V_275 += V_272 << V_6 ;
if ( V_275 & ~ V_103 &&
( V_275 & V_103 ) >= V_273 -> V_104 &&
( V_275 & V_103 ) + V_105 <= V_273 -> V_106 )
F_349 ( V_273 -> V_145 , V_275 ) ;
}
}
