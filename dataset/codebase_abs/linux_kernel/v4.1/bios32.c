...
F_29 (window, &sys->resources)
if ( F_30 ( V_74 -> V_78 ) == V_79 )
return 0 ;
...
static void F_33 ( struct V_36 * V_87 , struct V_88 * V_89 ,
struct V_90 * V_91 )
{
...
V_64 = F_34 ( sizeof( struct V_4 ) , V_94 ) ;
if ( ! V_64 )
F_35 ( L_9 ) ;
#ifdef F_36
V_64 -> V_7 = V_89 -> V_7 ;
...
F_37 ( & V_64 -> V_75 ) ;
if ( V_89 -> V_96 )
V_64 -> V_96 = V_89 -> V_96 [ V_92 ] ;
V_72 = V_89 -> V_97 ( V_92 , V_64 ) ;
if ( V_72 > 0 ) {
V_72 = F_26 ( V_92 , V_64 ) ;
if ( V_72 ) {
F_38 ( V_64 ) ;
...
if ( V_89 -> V_98 )
V_64 -> V_6 = V_89 -> V_98 ( V_92 , V_64 ) ;
else
V_64 -> V_6 = F_39 ( V_87 , V_64 -> V_71 ,
V_89 -> V_99 , V_64 , & V_64 -> V_75 ) ;
if ( ! V_64 -> V_6 )
F_35 ( L_10 ) ;
V_71 = V_64 -> V_6 -> V_100 . V_21 + 1 ;
F_40 ( & V_64 -> V_101 , V_91 ) ;
} else {
F_38 ( V_64 ) ;
if ( V_72 < 0 )
break;
...
char * T_5 F_51 ( char * V_107 )
{
if ( ! strcmp ( V_107 , L_11 ) ) {
V_68 = 1 ;
return NULL ;
} else if ( ! strcmp ( V_107 , L_12 ) ) {
F_43 ( V_105 ) ;
return NULL ;
}
return V_107 ;
}
T_6 F_52 ( void * V_108 , const struct V_20 * V_78 ,
T_6 V_109 , T_6 V_110 )
{
...
V_22 = ( V_22 + V_110 - 1 ) & ~ ( V_110 - 1 ) ;
if ( V_64 -> V_95 )
return V_64 -> V_95 ( V_3 , V_78 , V_22 , V_109 , V_110 ) ;
return V_22 ;
}
int F_53 ( struct V_2 * V_3 , int V_111 )
{
if ( F_45 ( V_105 ) )
return 0 ;
return F_54 ( V_3 , V_111 ) ;
}
int F_55 ( struct V_2 * V_3 , struct V_112 * V_113 ,
enum V_114 V_115 , int V_116 )
{
if ( V_115 == V_117 )
return - V_118 ;
V_113 -> V_119 = F_56 ( V_113 -> V_119 ) ;
if ( F_57 ( V_113 , V_113 -> V_120 , V_113 -> V_121 ,
V_113 -> V_122 - V_113 -> V_120 ,
V_113 -> V_119 ) )
return - V_123 ;
return 0 ;
}
void T_5 F_58 ( unsigned long V_124 )
{
struct V_125 V_126 = {
. V_127 = V_128 ,
. type = V_129 ,
