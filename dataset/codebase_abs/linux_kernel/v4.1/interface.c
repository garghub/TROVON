...
F_55 ( & V_9 -> V_27 , V_63 ) ;
V_64 = F_56 ( F_57 ( V_9 -> V_23 ) ) ;
if ( V_64 == V_63 )
return 0 ;
F_18 ( V_11 , & V_41 ) ;
F_58 ( & F_59 ( V_9 -> V_23 ) -> V_67 ) ;
if ( V_64 & ~ V_68 && V_63 > V_64 ) {
F_34 ( L_20 , V_64 ) ;
V_62 . V_69 = V_70 ;
V_62 . V_71 = V_64 & V_68 ;
V_42 = F_60 ( V_9 -> V_23 , & V_62 , NULL ) ;
if ( V_42 < 0 )
goto V_72;
}
V_62 . V_69 = V_70 ;
...
static void F_66 ( struct V_2 * V_11 )
{
F_3 ( L_12 ) ;
}
