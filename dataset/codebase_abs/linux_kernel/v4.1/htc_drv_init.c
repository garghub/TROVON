...
F_83 ( V_191 ) |
F_83 ( V_192 ) ;
V_14 -> V_15 -> V_193 = & V_194 ;
V_14 -> V_15 -> V_195 = 1 ;
V_14 -> V_15 -> V_175 &= ~ V_196 ;
V_14 -> V_15 -> V_175 |= V_197 |
V_198 ;
V_14 -> V_15 -> V_175 |= V_199 ;
V_14 -> V_200 = 4 ;
V_14 -> V_201 = 1 ;
V_14 -> V_202 = sizeof( struct V_203 ) ;
V_14 -> V_204 = sizeof( struct V_205 ) ;
V_14 -> V_206 = sizeof( struct V_207 ) +
sizeof( struct V_208 ) + 4 ;
if ( V_4 -> V_12 -> V_209 . V_210 & V_211 )
V_14 -> V_15 -> V_212 [ V_213 ] =
& V_2 -> V_214 [ V_213 ] ;
if ( V_4 -> V_12 -> V_209 . V_210 & V_215 )
V_14 -> V_15 -> V_212 [ V_216 ] =
& V_2 -> V_214 [ V_216 ] ;
F_84 ( V_12 ) ;
V_174 = F_85 ( V_4 ) ;
if ( V_174 ) {
V_14 -> V_15 -> V_217 = V_174 -> V_218 ;
V_14 -> V_15 -> V_219 = V_174 -> V_220 ;
}
F_86 ( V_14 , V_2 -> V_221 ) ;
}
...
if ( V_28 )
return - V_108 ;
V_4 -> V_225 = F_89 ( V_223 . V_226 ) ;
V_4 -> V_227 = F_89 ( V_223 . V_228 ) ;
snprintf ( V_14 -> V_15 -> V_229 , sizeof( V_14 -> V_15 -> V_229 ) , L_17 ,
V_4 -> V_225 ,
V_4 -> V_227 ) ;
F_27 ( V_4 -> V_10 , L_18 ,
V_4 -> V_225 ,
...
if ( error != 0 )
goto V_235;
error = F_91 ( & V_2 -> V_236 , V_4 -> V_14 -> V_15 ,
F_28 ) ;
if ( error )
goto V_237;
V_57 = & V_2 -> V_236 ;
...
goto V_244;
if ( ! F_98 ( V_57 ) ) {
error = F_99 ( V_14 -> V_15 , V_57 -> V_245 ) ;
if ( error )
goto V_246;
}
error = F_100 ( V_4 -> V_12 ) ;
if ( error ) {
F_64 ( V_2 , L_23 ) ;
goto V_246;
}
...
V_4 -> V_47 ,
V_4 -> V_49 ) ;
F_101 ( V_4 -> V_12 , V_233 , sizeof( V_233 ) ) ;
F_102 ( V_14 -> V_15 , L_25 , V_233 ) ;
F_103 ( V_4 ) ;
F_104 ( V_4 ) ;
return 0 ;
V_246:
...
int F_105 ( struct V_248 * V_249 , struct V_250 * V_10 ,
T_1 V_26 , char * V_123 , T_2 V_27 )
{
struct V_13 * V_14 ;
struct V_3 * V_4 ;
int V_28 ;
V_14 = F_106 ( sizeof( struct V_3 ) , & V_251 ) ;
if ( ! V_14 )
return - V_125 ;
V_4 = V_14 -> V_4 ;
V_4 -> V_14 = V_14 ;
...
void F_111 ( struct V_248 * V_249 , bool V_254 )
{
if ( V_249 -> V_252 ) {
if ( V_254 )
V_249 -> V_252 -> V_12 -> V_128 |= V_255 ;
F_13 ( V_249 -> V_252 ) ;
F_109 ( V_249 -> V_252 ) ;
F_110 ( V_249 -> V_252 -> V_14 ) ;
}
}
void F_112 ( struct V_248 * V_249 )
{
F_113 ( V_249 -> V_252 , V_256 ) ;
}
int F_114 ( struct V_248 * V_249 )
{
struct V_3 * V_4 = V_249 -> V_252 ;
int V_28 ;
V_28 = F_5 ( V_4 ) ;
if ( V_28 )
return V_28 ;
