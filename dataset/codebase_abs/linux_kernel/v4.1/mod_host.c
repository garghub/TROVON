...
V_19 -> V_130 =
F_108 ( V_131 | V_132 ) ;
V_19 -> V_133 . V_134 . V_135 [ 0 ] = ( V_93 << 1 ) ;
V_19 -> V_133 . V_134 . V_135 [ 1 ] = ~ 0 ;
F_32 ( V_10 , L_37 , V_37 ) ;
break;
}
return 0 ;
...
struct V_2 * V_3 = F_67 ( V_8 ) ;
struct V_27 * V_21 ;
T_3 * V_143 = F_118 ( V_8 , V_143 ) ;
int V_144 = F_118 ( V_8 , V_144 ) ;
int V_145 , V_33 , V_32 ;
V_145 = V_146 ;
for ( V_32 = 0 ; V_32 < V_144 ; V_32 ++ ) {
V_33 = ( V_143 [ V_32 ] == V_145 ) ;
V_145 = V_143 [ V_32 ] ;
if ( V_146 == V_143 [ V_32 ] ) {
V_21 = F_119 ( V_8 ) ;
F_120 ( V_3 ) = V_21 ;
...
struct V_2 * V_3 = F_67 ( V_8 ) ;
struct V_44 * V_45 = F_55 ( V_3 ) ;
struct V_148 * V_12 = F_123 ( V_8 ) ;
struct V_9 * V_10 = F_3 ( V_8 ) ;
int V_34 ;
V_34 = F_124 ( V_45 , 0 , 0 ) ;
if ( V_34 < 0 )
return 0 ;
F_125 ( V_45 -> V_48 . V_149 ) ;
F_126 ( V_8 ) ;
F_127 ( V_8 ,
F_88 ) ;
F_117 ( V_8 ) ;
...
V_45 -> V_155 = 1 ;
V_3 = F_71 ( V_45 ) ;
F_133 ( V_8 , & V_3 -> V_12 , V_156 ) ;
V_3 -> V_12 . V_157 = L_46 ;
V_3 -> V_12 . V_158 = F_122 ;
V_3 -> V_12 . V_159 = F_129 ;
F_134 ( V_3 ) ;
F_135 (udev, hpriv, i) {
V_26 -> V_47 = NULL ;
F_40 ( & V_26 -> V_42 ) ;
