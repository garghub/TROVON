...
V_6 = F_84 ( sizeof( struct V_1 ) , V_84 ) ;
if ( V_6 == NULL ) {
F_5 ( V_52 L_5 ,
V_53 ) ;
V_60 = - V_85 ;
...
V_6 -> V_29 = V_29 ;
V_6 -> V_38 . V_109 = F_22 ;
F_92 ( & V_6 -> V_7 , & V_29 -> V_71 . V_72 ) ;
if ( ! V_29 -> V_71 . V_110 ) {
V_60 = F_93 ( V_29 ) ;
if ( V_60 )
goto V_111;
}
V_60 = F_94 ( V_29 , V_6 -> V_20 ) ;
if ( V_60 )
goto V_111;
V_73:
F_95 ( & V_29 -> V_95 , V_93 ) ;
...
if ( V_114 -> V_14 == 0 ) {
V_114 -> V_14 = V_113 -> V_113 ;
if ( V_114 -> V_14 == 0 ||
V_114 -> V_14 > V_116 ) {
V_60 = - V_49 ;
goto V_115;
}
V_114 -> V_13 = F_84 ( sizeof( struct V_12 ) *
V_113 -> V_113 ,
V_84 ) ;
if ( ! V_114 -> V_13 ) {
V_60 = - V_85 ;
...
V_114 -> V_35 =
F_84 ( sizeof( struct V_12 ) * V_113 -> V_113 ,
V_84 ) ;
if ( ! V_114 -> V_35 ) {
F_32 ( V_114 -> V_13 ) ;
V_60 = - V_85 ;
...
for ( V_10 = 0 ; V_10 < V_114 -> V_14 ; V_10 ++ )
if ( V_114 -> V_35 [ V_10 ] . V_15 == 0 ||
V_114 -> V_35 [ V_10 ] . V_118 == V_118 -> V_118 ) {
V_114 -> V_35 [ V_10 ] . V_118 = V_118 -> V_118 ;
V_114 -> V_35 [ V_10 ] . V_15 = V_118 -> V_41 ;
V_114 -> V_13 [ V_10 ] . V_118 = V_118 -> V_118 ;
break;
}
if ( V_10 == V_114 -> V_14 ) {
V_60 = - V_120 ;
...
long F_101 ( struct V_29 * V_29 , unsigned V_121 ,
unsigned long V_122 )
{
void T_5 * V_123 = ( void T_5 * ) V_122 ;
int V_60 ;
switch ( V_121 ) {
case V_124 : {
struct V_92 V_8 ;
V_60 = - V_125 ;
if ( F_102 ( & V_8 , V_123 , sizeof V_8 ) )
goto V_73;
V_60 = F_82 ( V_29 , & V_8 ) ;
if ( V_60 )
goto V_73;
...
struct V_63 V_68 ;
V_60 = - V_125 ;
if ( F_102 ( & V_68 , V_123 , sizeof V_68 ) )
goto V_73;
V_60 = F_68 ( V_29 , & V_68 ) ;
if ( V_60 )
goto V_73;
...
struct V_112 V_113 ;
V_60 = - V_125 ;
if ( F_102 ( & V_113 , V_123 , sizeof V_113 ) )
goto V_73;
V_60 = F_98 ( V_29 , & V_113 ) ;
if ( V_60 )
goto V_73;
break;
}
...
struct V_117 V_118 ;
V_60 = - V_125 ;
if ( F_102 ( & V_118 , V_123 , sizeof V_118 ) )
goto V_73;
V_60 = F_99 ( V_29 , & V_118 ) ;
if ( V_60 )
goto V_73;
break;
}
