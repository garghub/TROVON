...
F_100 ( V_73 & ~ V_83 ) ;
if ( F_60 ( * V_9 ) ) {
V_48 = F_101 ( V_72 -> V_77 , V_73 , V_9 ) ;
} else {
V_48 = * V_9 ;
F_102 ( V_9 ) ;
F_103 () ;
F_104 ( V_72 -> V_77 , & V_48 , V_73 ) ;
}
return V_48 ;
}
...
{
return F_106 ( V_72 -> V_77 , V_73 , V_9 ) ;
}
int F_107 ( struct V_71 * V_72 ,
unsigned long V_73 , T_4 * V_9 )
{
return F_106 ( V_72 -> V_77 , V_73 , V_9 ) ;
}
void F_108 ( struct V_71 * V_72 ,
unsigned long V_73 , T_4 * V_9 )
{
unsigned long V_80 , V_81 ;
F_100 ( V_73 & ~ V_83 ) ;
...
void F_110 ( struct V_49 * V_50 , T_4 * V_9 ,
T_8 V_85 )
{
T_8 * V_86 ;
F_88 ( & V_50 -> V_52 ) ;
...
T_8 F_111 ( struct V_49 * V_50 , T_4 * V_9 )
{
T_8 V_85 ;
T_8 * V_86 ;
F_88 ( & V_50 -> V_52 ) ;
...
void F_112 ( struct V_49 * V_50 , unsigned long V_26 ,
T_4 * V_9 , T_4 V_48 )
{
#ifdef F_87
...
F_33 ( ! F_60 ( V_48 ) ) ;
#endif
F_113 ( V_26 , F_95 ( V_48 ) ) ;
return F_11 ( V_50 , V_26 , F_91 ( V_9 ) , F_92 ( V_48 ) ) ;
}
void F_114 ( struct V_71 * V_72 , unsigned long V_73 ,
T_4 * V_9 )
{
...
if ( ! F_116 ( V_26 ) ) {
V_89 = F_117 ( V_26 ) ;
V_91 = F_118 ( V_50 -> V_53 . V_97 , V_26 , V_89 ) ;
F_33 ( V_91 == 0 ) ;
} else {
V_91 = F_119 ( V_26 , V_17 ) ;
V_89 = V_17 ;
}
V_81 = F_120 ( F_121 () ) ;
if ( F_122 ( F_123 ( V_50 ) , V_81 ) )
V_6 |= V_98 ;
return F_124 ( V_91 , V_26 , V_9 , V_90 , V_89 , V_6 ) ;
}
static T_4 F_125 ( T_4 V_48 , T_9 V_99 )
{
F_95 ( V_48 ) |= F_32 ( V_99 ) ;
return V_48 ;
}
T_4 F_126 ( unsigned long V_100 , T_9 V_99 )
{
T_4 V_48 ;
F_95 ( V_48 ) = V_100 << V_101 ;
F_95 ( V_48 ) |= V_102 ;
V_48 = F_125 ( V_48 , V_99 ) ;
return V_48 ;
}
T_4 F_127 ( struct V_45 * V_45 , T_9 V_99 )
{
return F_126 ( F_128 ( V_45 ) , V_99 ) ;
}
T_4 F_129 ( T_4 V_48 , T_9 V_103 )
{
F_95 ( V_48 ) &= V_104 ;
V_48 = F_125 ( V_48 , V_103 ) ;
return V_48 ;
}
void F_130 ( struct V_71 * V_72 , unsigned long V_26 ,
T_4 * V_48 )
{
return;
}
T_4 F_101 ( struct V_49 * V_50 ,
