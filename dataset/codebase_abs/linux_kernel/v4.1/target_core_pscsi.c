...
static void F_42 ( struct V_109 * V_110 , struct V_111 * V_112 ,
unsigned char * V_113 )
{
struct V_1 * V_64 = F_1 ( V_110 -> V_114 ) ;
struct V_27 * V_63 = V_64 -> V_67 ;
int V_115 ;
struct V_116 * V_117 = V_110 -> V_118 ;
unsigned char * V_29 ;
if ( ! V_117 )
return;
V_29 = & V_117 -> V_119 [ 0 ] ;
V_115 = V_117 -> V_120 ;
if ( ! V_110 -> V_121 || ! V_110 -> V_122 )
goto V_123;
if ( ( ( V_29 [ 0 ] == V_33 ) || ( V_29 [ 0 ] == V_124 ) ) &&
( F_43 ( V_115 ) << 1 ) == V_125 ) {
if ( V_110 -> V_121 -> V_126 & V_127 ) {
unsigned char * V_31 ;
V_31 = F_44 ( V_110 ) ;
if ( ! V_31 )
;
...
V_128:
if ( V_113 && ( F_43 ( V_115 ) & V_133 ) ) {
memcpy ( V_113 , V_117 -> V_134 , V_135 ) ;
V_110 -> V_136 |= V_137 ;
}
}
...
V_142 = F_48 ( V_138 , V_9 ) ;
if ( ! V_142 )
return - V_10 ;
V_140 = V_142 ;
while ( ( V_141 = F_49 ( & V_142 , L_43 ) ) != NULL ) {
if ( ! * V_141 )
continue;
V_145 = F_50 ( V_141 , V_146 , args ) ;
switch ( V_145 ) {
case V_147 :
if ( V_8 -> V_12 == V_26 ) {
F_5 ( L_44
...
static T_3 F_52 ( struct V_2 * V_3 , char * V_151 )
{
struct V_7 * V_8 = V_3 -> V_4 -> V_14 ;
struct V_1 * V_64 = F_1 ( V_3 ) ;
struct V_27 * V_63 = V_64 -> V_67 ;
...
static void F_53 ( struct V_155 * V_155 , int error )
{
F_54 ( V_155 ) ;
}
static inline struct V_155 * F_55 ( int V_156 )
{
struct V_155 * V_155 ;
...
static T_5
F_57 ( struct V_109 * V_110 , struct V_111 * V_158 , T_1 V_159 ,
enum V_160 V_161 , struct V_155 * * V_162 )
{
struct V_1 * V_64 = F_1 ( V_110 -> V_114 ) ;
struct V_155 * V_155 = NULL , * V_163 = NULL ;
struct V_138 * V_138 ;
struct V_111 * V_112 ;
T_1 V_164 = V_110 -> V_122 , V_153 , V_165 , V_166 , V_56 ;
int V_167 = ( V_110 -> V_122 + V_158 [ 0 ] . V_168 +
V_169 - 1 ) >> V_170 ;
int V_156 = 0 , V_171 ;
int V_172 = ( V_161 == V_173 ) ;
* V_162 = NULL ;
F_6 ( L_65 , V_167 ) ;
...
goto V_175;
if ( V_165 > 0 && V_164 > 0 ) {
V_166 = F_24 (unsigned int, len, PAGE_SIZE - off) ;
V_166 = F_60 ( V_166 , V_164 ) ;
if ( ! V_155 ) {
V_156 = F_24 ( int , V_176 , V_167 ) ;
V_167 -= V_156 ;
V_155 = F_55 ( V_156 ) ;
if ( ! V_155 )
goto V_175;
...
F_6 ( L_67
L_68 , V_155 ,
( V_172 ) ? L_69 : L_70 , V_156 ) ;
if ( ! * V_162 )
* V_162 = V_163 = V_155 ;
else
V_163 = V_163 -> V_179 = V_155 ;
}
F_6 ( L_71
L_72 , V_153 , V_155 ,
V_138 , V_165 , V_56 ) ;
V_171 = F_61 ( V_64 -> V_67 -> V_65 ,
V_155 , V_138 , V_166 , V_56 ) ;
if ( V_171 != V_166 )
goto V_175;
F_6 ( L_73 ,
V_155 -> V_180 , V_156 ) ;
if ( V_155 -> V_180 > V_156 ) {
F_6 ( L_74
L_75
L_76 , V_155 -> V_180 , V_153 , V_155 ) ;
V_155 = NULL ;
}
V_164 -= V_166 ;
}
...
static T_5
F_63 ( struct V_109 * V_110 )
{
if ( V_110 -> V_136 & V_182 )
return V_183 ;
return F_64 ( V_110 , V_184 ) ;
}
static T_5
V_184 ( struct V_109 * V_110 )
{
struct V_111 * V_158 = V_110 -> V_185 ;
T_1 V_159 = V_110 -> V_186 ;
enum V_160 V_161 = V_110 -> V_161 ;
struct V_1 * V_64 = F_1 ( V_110 -> V_114 ) ;
struct V_116 * V_117 ;
struct V_187 * V_188 ;
struct V_155 * V_162 ;
T_5 V_32 ;
V_117 = F_4 ( sizeof( * V_117 ) + F_65 ( V_110 -> V_189 ) , V_9 ) ;
if ( ! V_117 ) {
return V_181 ;
}
V_110 -> V_118 = V_117 ;
memcpy ( V_117 -> V_119 , V_110 -> V_189 ,
F_65 ( V_110 -> V_189 ) ) ;
if ( ! V_158 ) {
V_188 = F_66 ( V_64 -> V_67 -> V_65 ,
( V_161 == V_173 ) ,
V_9 ) ;
if ( F_31 ( V_188 ) ) {
F_5 ( L_77 ) ;
...
F_68 ( ! V_110 -> V_122 ) ;
V_32 = F_57 ( V_110 , V_158 , V_159 , V_161 , & V_162 ) ;
if ( V_32 )
goto V_175;
V_188 = F_69 ( V_64 -> V_67 -> V_65 , V_162 ,
V_9 ) ;
if ( F_31 ( V_188 ) ) {
F_5 ( L_78 ) ;
V_32 = V_181 ;
...
V_188 -> V_191 = V_192 ;
V_188 -> V_193 = V_110 ;
V_188 -> V_194 = F_65 ( V_117 -> V_119 ) ;
V_188 -> V_110 = & V_117 -> V_119 [ 0 ] ;
V_188 -> V_195 = & V_117 -> V_134 [ 0 ] ;
V_188 -> V_196 = 0 ;
...
V_188 -> V_197 = V_199 ;
V_188 -> V_200 = V_201 ;
F_70 ( V_64 -> V_67 -> V_65 , NULL , V_188 ,
( V_110 -> V_202 == V_203 ) ,
V_192 ) ;
return 0 ;
V_190:
while ( V_162 ) {
struct V_155 * V_155 = V_162 ;
V_162 = V_162 -> V_179 ;
F_62 ( V_155 , 0 ) ;
}
V_32 = V_181 ;
...
struct V_1 * V_64 = F_1 ( V_3 ) ;
struct V_27 * V_63 = V_64 -> V_67 ;
return ( V_63 ) ? V_63 -> type : V_204 ;
}
static T_6 F_72 ( struct V_2 * V_3 )
{
struct V_1 * V_64 = F_1 ( V_3 ) ;
if ( V_64 -> V_89 && V_64 -> V_89 -> V_205 )
return V_64 -> V_89 -> V_205 -> V_206 ;
F_73 () ;
return 0 ;
}
static void V_192 ( struct V_187 * V_188 , int V_207 )
{
struct V_109 * V_110 = V_188 -> V_193 ;
struct V_116 * V_117 = V_110 -> V_118 ;
V_117 -> V_120 = V_188 -> V_208 ;
V_117 -> V_209 = V_188 -> V_210 ;
V_110 -> V_211 = F_43 ( V_117 -> V_120 ) << 1 ;
if ( V_110 -> V_211 ) {
F_6 ( L_79
L_80 , V_110 , V_117 -> V_119 [ 0 ] ,
V_117 -> V_120 ) ;
}
switch ( F_74 ( V_117 -> V_120 ) ) {
case V_212 :
F_75 ( V_110 , V_110 -> V_211 ) ;
break;
default:
F_6 ( L_81
L_80 , V_110 , V_117 -> V_119 [ 0 ] ,
