...
if ( V_60 )
goto V_80;
F_3 ( V_81 | V_82 , V_4 -> V_8 + V_83 ) ;
for ( V_49 = 0 ; V_49 < V_79 ; V_49 ++ ) {
if ( V_78 [ V_49 ] . V_40 == 0 ) {
V_60 = - V_84 ;
goto V_80;
}
...
if ( V_78 [ V_49 ] . V_85 & V_86 )
V_60 = F_24 ( V_4 , & V_78 [ V_49 ] ) ;
else
V_60 = F_16 ( V_4 , & V_78 [ V_49 ] ) ;
if ( V_60 )
break;
V_60 = F_10 ( V_4 , V_13 ) ;
if ( V_60 )
...
static T_2 F_30 ( struct V_76 * V_77 )
{
...
F_10 ( V_4 , V_13 ) ;
F_34 ( V_4 -> V_90 ) ;
V_92 = F_2 ( V_4 -> V_8 + V_83 ) ;
V_92 |= V_93 ;
F_3 ( V_92 , V_4 -> V_8 + V_83 ) ;
F_34 ( V_4 -> V_91 ) ;
}
...
V_4 -> V_90 = F_45 ( V_4 -> V_2 , L_5 ) ;
if ( F_42 ( V_4 -> V_90 ) ) {
F_19 ( V_4 -> V_2 , L_6 ) ;
return F_43 ( V_4 -> V_90 ) ;
}
V_4 -> V_91 = F_45 ( V_4 -> V_2 , L_7 ) ;
if ( F_42 ( V_4 -> V_91 ) ) {
F_19 ( V_4 -> V_2 , L_8 ) ;
...
V_114 , L_9 , V_4 ) ;
if ( V_60 ) {
F_19 ( V_4 -> V_2 , L_10 , V_4 -> V_1 ) ;
goto V_113;
}
F_20 ( V_4 -> V_1 ) ;
V_104 = F_2 ( V_4 -> V_8 + V_115 ) ;
F_47 ( V_4 -> V_2 , L_11 , V_104 ) ;
...
V_4 -> V_116 , V_4 -> V_41 ) ;
F_54 ( & V_4 -> V_77 , V_4 ) ;
V_4 -> V_77 . V_119 = & V_120 ;
V_4 -> V_77 . V_121 = & V_122 ;
V_4 -> V_77 . V_2 . V_123 = V_4 -> V_2 ;
V_4 -> V_77 . V_2 . V_99 = V_95 -> V_2 . V_99 ;
F_55 ( V_4 -> V_77 . V_124 , L_13 , sizeof( V_4 -> V_77 . V_124 ) ) ;
F_56 ( V_4 -> V_2 , V_125 ) ;
F_57 ( V_4 -> V_2 ) ;
F_58 ( V_4 -> V_2 ) ;
F_59 ( V_4 -> V_2 ) ;
...
static int F_66 ( struct V_127 * V_127 )
{
struct V_3 * V_4 = F_67 ( V_127 ) ;
F_47 ( V_127 , L_14 ) ;
F_33 ( V_4 ) ;
return 0 ;
}
...
static int F_69 ( struct V_127 * V_127 )
{
F_66 ( V_127 ) ;
return 0 ;
}
static int F_70 ( struct V_127 * V_127 )
{
F_68 ( V_127 ) ;
F_28 ( V_127 ) ;
F_71 ( V_127 ) ;
