...
V_95 = V_96 ;
V_15 -> V_91 . V_94 = V_22 ;
V_85 = V_15 -> V_82 -> V_124 ( V_8 -> V_2 , V_92 ) ;
break;
case V_125 :
F_8 ( V_98 -> V_2 , L_11 ) ;
V_95 = V_126 ;
...
F_8 ( V_98 -> V_2 , L_12 ) ;
V_95 = V_129 ;
V_85 = V_15 -> V_82 -> V_130 ( V_8 -> V_2 , V_92 ) ;
break;
case V_131 :
case V_132 :
F_8 ( V_98 -> V_2 , L_13 ) ;
V_95 = V_96 ;
V_85 = V_15 -> V_82 -> V_133 ( V_8 -> V_2 , V_92 ) ;
break;
default:
return - V_3 ;
}
...
return 0 ;
V_135 = & V_15 -> V_91 ;
V_85 = V_15 -> V_82 -> V_136 ( V_8 -> V_2 , V_135 ) ;
if ( V_85 ) {
F_5 ( V_98 -> V_2 , L_14 , V_85 ) ;
return V_85 ;
}
V_22 -> V_32 -> V_137 = V_135 -> V_138 ;
return V_135 -> V_101 ;
}
static int F_51 ( struct V_97 * V_98 )
{
struct V_12 * V_13 = V_98 -> V_139 ;
struct V_140 * V_74 = V_98 -> V_74 ;
int V_141 = 0 ;
if ( V_13 -> V_4 -> V_142 . V_143 ||
V_13 -> V_4 -> V_144 . V_143 ) {
V_141 = F_52 ( V_74 ,
V_145 ,
F_53 ( V_146 ) ,
V_147 , V_148 ) ;
...
{
struct V_59 * V_151 = F_55 ( V_150 -> V_2 ) ;
V_151 -> V_152 = V_150 -> V_153 . V_154 ;
return F_56 ( V_150 ) ;
}
static int F_57 ( struct V_155 * V_156 )
{
struct V_59 * V_151 ;
int V_118 ;
struct V_157 * V_69 ;
V_151 = F_58 ( & V_156 -> V_2 , sizeof( * V_151 ) , V_105 ) ;
if ( V_151 == NULL ) {
return - V_106 ;
}
V_69 = F_58 ( & V_156 -> V_2 , sizeof( * V_69 ) , V_105 ) ;
if ( V_69 == NULL ) {
return - V_106 ;
}
V_69 -> V_70 = V_158 ;
V_69 -> V_71 = F_59 ( V_158 ) ;
V_151 -> V_69 = V_69 ;
V_151 -> V_156 = V_156 ;
F_60 ( & V_151 -> V_159 ) ;
F_61 ( & V_156 -> V_2 , V_151 ) ;
V_118 = F_62 ( & V_156 -> V_2 , & V_160 ) ;
if ( V_118 ) {
F_5 ( & V_156 -> V_2 , L_16 ) ;
return V_118 ;
}
V_118 = F_63 ( & V_156 -> V_2 , & V_161 ,
V_162 , F_59 ( V_162 ) ) ;
if ( V_118 ) {
F_5 ( & V_156 -> V_2 , L_17 ) ;
F_64 ( & V_156 -> V_2 ) ;
...
static int F_67 ( struct V_75 * V_2 )
{
struct V_59 * V_151 = F_55 ( V_2 ) ;
int V_56 ;
F_68 ( V_151 -> V_152 -> V_2 ) ;
F_69 ( V_151 -> V_152 -> V_2 ) ;
for ( V_56 = 0 ; V_56 < V_151 -> V_152 -> V_163 ; V_56 ++ ) {
struct V_12 * V_13 = V_151 -> V_152 -> V_98 [ V_56 ] . V_139 ;
if ( V_13 -> V_119 ) {
F_46 ( V_13 , V_13 -> V_9 , 0 ) ;
F_45 ( V_13 , false ) ;
}
...
static void F_70 ( struct V_75 * V_2 )
{
struct V_59 * V_151 = F_55 ( V_2 ) ;
int V_56 ;
for ( V_56 = 0 ; V_56 < V_151 -> V_152 -> V_163 ; V_56 ++ ) {
...
if ( V_13 -> V_119 ) {
F_45 ( V_13 , true ) ;
F_46 ( V_13 , V_13 -> V_9 , 1 ) ;
}
}
F_71 ( V_151 -> V_152 -> V_2 ) ;
}
