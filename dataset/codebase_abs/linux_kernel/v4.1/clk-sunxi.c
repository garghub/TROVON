...
if ( ! V_67 )
return;
V_67 -> V_71 = F_28 ( ( V_68 + 1 ) * sizeof( struct V_18 * ) , V_37 ) ;
if ( ! V_67 -> V_71 ) {
F_29 ( V_67 ) ;
return;
}
...
V_71 [ V_20 ] = F_30 ( NULL , V_33 , & V_11 , 1 ,
NULL , NULL ,
V_77 , V_79 ,
V_76 , & V_100 ,
V_88 ) ;
