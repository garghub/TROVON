...
* V_20 ++ = V_15 -> V_6 << 6 ;
memcpy ( V_18 + 3 , V_15 -> V_18 , V_15 -> V_32 ) ;
if ( ! V_22 -> V_34 ) {
...
V_16 = 3 + V_15 -> V_32 ;
memcpy ( V_18 + 3 , V_15 -> V_18 , V_15 -> V_32 ) ;
V_35 = V_13 -> V_17 - V_14 - 8 ;
if ( ! V_22 -> V_34 ) {
F_17 ( & V_31 , V_20 , V_35 + 4 ) ;
F_18 ( V_15 -> V_9 , V_18 , V_16 ) ;
if ( F_21 ( & V_26 , & V_31 , & V_31 , V_35 + 4 ) )
return - 7 ;
V_28 = ~ F_15 ( ~ 0 , V_20 , V_35 ) ;
V_29 [ 0 ] = V_28 ;
V_29 [ 1 ] = V_28 >> 8 ;
V_29 [ 2 ] = V_28 >> 16 ;
V_29 [ 3 ] = V_28 >> 24 ;
if ( memcmp ( V_29 , V_20 + V_35 , 4 ) != 0 ) {
return - 2 ;
}
}
memmove ( V_13 -> V_36 + 4 , V_13 -> V_36 , V_14 ) ;
F_22 ( V_13 , 4 ) ;
F_23 ( V_13 , V_13 -> V_17 - 4 ) ;
return 0 ;
}
static int F_24 ( void * V_18 , int V_17 , T_2 * V_37 , void * V_3 )
{
struct V_2 * V_15 = V_3 ;
if ( V_17 < 0 || V_17 > V_19 )
return - 1 ;
...
static int F_25 ( void * V_18 , int V_17 , T_2 * V_37 , void * V_3 )
{
struct V_2 * V_15 = V_3 ;
if ( V_17 < V_15 -> V_32 )
return - 1 ;
memcpy ( V_18 , V_15 -> V_18 , V_15 -> V_32 ) ;
return V_15 -> V_32 ;
}
static void F_26 ( struct V_38 * V_39 , void * V_3 )
{
struct V_2 * V_15 = V_3 ;
F_27 ( V_39 , L_4 , V_15 -> V_6 , V_15 -> V_32 ) ;
}
