...
V_37 [ V_17 ] = V_34 ;
if ( V_1 -> V_50 )
F_13 ( V_1 -> V_51 , V_34 -> V_15 ,
V_34 -> V_52 << 9 ) ;
if ( V_34 -> V_15 -> V_53 -> V_50 -> V_54 )
V_4 -> V_55 = 1 ;
...
return - V_45 ;
if ( V_1 -> V_50 ) {
F_34 ( V_1 -> V_50 , V_1 -> V_44 ) ;
F_35 ( V_1 -> V_50 , V_1 -> V_44 ) ;
F_36 ( V_1 -> V_50 , V_1 -> V_44 ) ;
}
if ( V_1 -> V_5 == NULL ) {
V_12 = F_8 ( V_1 , & V_4 ) ;
if ( V_12 < 0 )
...
int V_78 = V_1 -> V_8 *
( V_1 -> V_44 << 9 ) / V_79 ;
if ( V_1 -> V_50 -> V_16 . V_80 < 2 * V_78 )
V_1 -> V_50 -> V_16 . V_80 = 2 * V_78 ;
}
F_4 ( V_1 ) ;
V_12 = F_38 ( V_1 ) ;
return V_12 ;
