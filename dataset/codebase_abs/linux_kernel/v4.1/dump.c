...
if ( V_18 [ V_6 ] . V_4 )
for ( V_49 = 0 ; V_49 < V_18 [ V_6 ] . V_5 ; V_49 ++ )
V_18 [ V_6 ] . V_9 |= V_18 [ V_6 ] . V_4 [ V_49 ] . V_9 ;
#ifdef F_31
V_42 [ V_50 ] . V_19 =
( unsigned long ) F_32 ( V_51 ) ;
V_42 [ V_52 ] . V_19 =
( unsigned long ) F_32 ( V_53 ) ;
#endif
V_48 = F_33 ( L_7 , 0400 , NULL , NULL ,
& V_54 ) ;
return V_48 ? 0 : - V_55 ;
}
