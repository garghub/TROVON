...
F_103 ( & V_2 -> V_63 ) ;
V_2 -> V_63 . V_166 = V_156 ;
V_2 -> V_63 . V_157 = V_156 ;
V_2 -> V_63 . V_158 = V_156 ;
V_2 -> V_63 . V_114 = V_2 -> V_113 & V_167 ;
}
if ( V_41 & V_42 )
...
F_109 ( V_29 , V_171 ) ;
#ifdef F_110
V_170 = F_111 ( V_2 , V_111 ) ;
F_112 ( V_170 , sizeof( V_172 ) ) ;
ASSERT ( V_2 -> V_8 -> V_112 == V_170 ) ;
#endif
V_169 = V_29 -> V_173 ;
for ( V_170 = 0 ; V_170 < V_2 -> V_8 -> V_112 ; V_170 ++ ) {
struct V_174 * V_175 ;
V_175 = (struct V_174 * ) & V_169 [ V_170 ] ;
F_113 ( V_2 , V_175 , V_56 + V_170 , type , V_176 ,
L_4 ) ;
V_175 -> V_36 = type ;
V_175 -> V_177 = 0 ;
V_175 -> V_178 = 0 ;
...
error = 0 ;
while ( V_183 -- ) {
error = F_117 ( V_2 , NULL , V_2 -> V_185 ,
F_118 ( V_2 , V_182 ) ,
...
return 0 ;
V_190 = F_120 ( V_197 * sizeof( * V_190 ) , V_102 ) ;
V_192 = 0 ;
V_193 = F_121 ( V_2 , V_2 -> V_198 -> V_199 ) ;
do {
T_2 V_200 ;
V_191 = V_197 ;
V_200 = F_122 ( V_188 ) ;
error = F_123 ( V_188 , V_192 , V_193 - V_192 ,
V_190 , & V_191 , 0 ) ;
F_49 ( V_188 , V_200 ) ;
if ( error )
break;
...
F_126 ( V_4 ) ;
F_127 ( & V_4 -> V_20 . V_178 , 1 ) ;
V_4 -> V_211 ++ ;
if ( V_207 ) {
F_127 ( & V_4 -> V_20 . V_177 , V_207 ) ;
V_4 -> V_212 += V_207 ;
}
if ( V_208 ) {
F_127 ( & V_4 -> V_20 . V_179 , V_208 ) ;
V_4 -> V_213 += V_208 ;
}
if ( V_4 -> V_20 . V_21 ) {
F_128 ( V_2 , V_4 ) ;
...
if ( F_44 ( V_2 ) ) {
V_236 = F_1 ( V_2 , V_45 , F_138 ,
& V_184 ) ;
if ( ! error )
error = V_236 ;
}
if ( F_45 ( V_2 ) ) {
V_236 = F_1 ( V_2 , V_47 , F_138 ,
& V_184 ) ;
if ( ! error )
error = V_236 ;
}
...
V_250:
F_65 ( & V_2 -> V_164 ) ;
V_248 = V_2 -> V_63 . V_114 ;
V_2 -> V_63 . V_114 = V_2 -> V_113 & V_251 ;
F_60 ( & V_2 -> V_164 ) ;
if ( V_248 != ( V_2 -> V_113 & V_251 ) ) {
if ( F_146 ( V_2 , false ) ) {
ASSERT ( ! ( F_38 ( V_2 ) ) ) ;
F_106 ( V_2 , L_10 ,
V_30 ) ;
...
error = F_95 ( V_2 , NULL , V_2 -> V_63 . V_166 ,
0 , 0 , & V_239 ) ;
if ( error )
return error ;
}
...
ASSERT ( V_267 ) ;
ASSERT ( V_267 != V_266 ) ;
F_152 ( V_152 , V_267 , V_268 , - ( V_55 -> V_66 . V_196 ) ) ;
F_152 ( V_152 , V_267 , V_271 , - 1 ) ;
F_152 ( V_152 , V_266 , V_268 , V_55 -> V_66 . V_196 ) ;
F_152 ( V_152 , V_266 , V_271 , 1 ) ;
* V_265 = F_149 ( V_266 ) ;
return V_267 ;
}
int
...
V_55 -> V_65 = F_149 ( V_273 ) ;
F_152 ( V_152 , V_273 , V_271 , 1 ) ;
}
if ( V_274 && F_44 ( V_2 ) ) {
ASSERT ( V_55 -> V_70 == NULL ) ;
ASSERT ( V_55 -> V_66 . V_71 == F_7 ( V_274 -> V_20 . V_21 ) ) ;
V_55 -> V_70 = F_149 ( V_274 ) ;
F_152 ( V_152 , V_274 , V_271 , 1 ) ;
}
if ( V_275 && F_45 ( V_2 ) ) {
ASSERT ( V_55 -> V_72 == NULL ) ;
ASSERT ( F_46 ( V_55 ) == F_7 ( V_275 -> V_20 . V_21 ) ) ;
V_55 -> V_72 = F_149 ( V_275 ) ;
F_152 ( V_152 , V_275 , V_271 , 1 ) ;
}
}
