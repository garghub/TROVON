...
static int F_73 ( int V_60 , struct V_47 * V_47 ,
unsigned long V_26 ,
unsigned long V_43 )
{
struct V_31 * V_32 ;
...
continue;
if ( V_47 && V_47 != F_75 ( F_57 ( V_26 ) ) )
continue;
return V_26 ;
}
return 0 ;
}
static int F_76 ( int V_60 , struct V_47 * V_47 ,
unsigned long V_26 ,
unsigned long V_43 )
{
struct V_31 * V_32 ;
...
continue;
if ( V_47 && V_47 != F_75 ( F_57 ( V_42 ) ) )
continue;
return V_42 ;
}
return 0 ;
}
static void F_77 ( struct V_47 * V_47 , unsigned long V_26 ,
unsigned long V_43 )
{
...
static void F_80 ( struct V_47 * V_47 , unsigned long V_26 )
{
struct V_40 * V_41 = V_47 -> V_61 ;
int V_44 = V_35 ;
int V_58 ;
...
V_58 = V_47 - V_41 -> V_49 ;
F_61 ( V_47 -> V_61 , & V_14 ) ;
F_77 ( V_47 , V_26 , V_26 + V_44 ) ;
F_79 ( V_41 , V_26 , V_26 + V_44 ) ;
F_62 ( V_47 -> V_61 , & V_14 ) ;
}
static int F_81 ( struct V_47 * V_47 , struct V_31 * V_32 )
{
unsigned long V_26 ;
int V_80 ;
int V_66 = - V_81 ;
...
if ( V_97 == V_93 )
V_95 = V_98 ;
if ( F_55 ( V_47 ) <= V_95 && ! F_98 ( V_60 , V_93 ) )
V_91 -> V_99 = V_60 ;
else
V_91 -> V_99 = - 1 ;
#ifdef F_100
...
if ( V_97 == V_101 )
V_95 = V_98 ;
if ( F_55 ( V_47 ) <= V_95 && ! F_98 ( V_60 , V_101 ) )
V_91 -> V_102 = V_60 ;
else
V_91 -> V_102 = - 1 ;
#else
...
static void F_101 ( int V_45 , struct V_94 * V_91 )
{
if ( V_91 -> V_99 >= 0 )
F_102 ( V_45 , V_93 ) ;
if ( V_91 -> V_102 >= 0 )
...
int T_3 F_103 ( unsigned long V_42 , unsigned long V_44 , int V_104 )
{
unsigned long V_14 ;
...
int F_132 ( int V_60 , T_1 V_8 , T_1 V_9 , int V_125 )
{
...
{
return F_137 ( V_19 ) && F_138 ( V_19 ) >= V_128 ;
}
static struct V_19 * F_139 ( struct V_19 * V_19 )
{
F_19 ( F_140 ( V_19 ) & ( V_129 - 1 ) ) ;
if ( F_136 ( V_19 ) ) {
int V_130 ;
V_130 = F_138 ( V_19 ) ;
...
for (; V_19 < V_132 ; V_19 = F_139 ( V_19 ) ) {
if ( ! F_142 ( V_19 ) )
return 0 ;
F_143 () ;
}
...
V_42 += V_133 ) {
V_30 = 0 ;
while ( ( V_30 < V_133 ) && ! F_145 ( V_42 + V_30 ) )
V_30 ++ ;
if ( V_30 == V_133 )
continue;
V_19 = F_57 ( V_42 + V_30 ) ;
if ( V_47 && F_75 ( V_19 ) != V_47 )
return 0 ;
V_47 = F_75 ( V_19 ) ;
}
return 1 ;
...
V_19 = F_57 ( V_42 ) ;
if ( F_148 ( V_19 ) ) {
struct V_19 * V_138 = F_154 ( V_19 ) ;
V_42 = F_140 ( V_138 ) + ( 1 << F_151 ( V_138 ) ) - 1 ;
if ( F_151 ( V_138 ) > V_139 ) {
V_66 = - V_140 ;
break;
}
if ( F_155 ( V_19 , & V_137 ) )
...
static int T_7 F_175 ( char * V_79 )
{
#ifdef F_176
F_177 ( true ) ;
V_149 = true ;
...
V_112 += V_41 -> V_49 [ V_148 ] . V_112 ;
if ( V_44 >= V_112 )
V_91 -> V_103 = F_78 ( V_47 ) ;
else
V_91 -> V_103 = - 1 ;
}
static void F_179 ( int V_45 , struct V_94 * V_91 )
{
if ( V_91 -> V_99 >= 0 )
F_180 ( V_45 , V_93 ) ;
if ( ( V_97 != V_93 ) &&
...
V_45 = F_78 ( V_47 ) ;
V_44 = V_43 - V_26 ;
if ( F_55 ( V_47 ) <= V_96 && ! F_174 ( V_47 , V_44 ) )
return - V_81 ;
...
void * V_91 , int (* F_194)( struct V_166 * , void * ) )
{
...
static int F_198 ( struct V_166 * V_167 , void * V_91 )
{
int V_66 = ! F_199 ( V_167 ) ;
if ( F_8 ( V_66 ) ) {
T_8 V_173 , V_174 ;
V_173 = F_200 ( F_72 ( V_167 -> V_169 ) ) ;
V_174 = F_200 ( F_72 ( V_167 -> V_170 + 1 ) ) - 1 ;
F_87 ( L_12
L_13 ,
& V_173 , & V_174 ) ;
}
