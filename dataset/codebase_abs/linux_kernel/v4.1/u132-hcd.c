...
return V_49 ;
V_222 -> V_224 = V_225 ;
V_222 -> V_226 = ( V_138 & V_180 ) >> 24 ;
V_222 -> V_227 = 0 ;
V_222 -> V_228 = V_1 -> V_59 ;
V_149 = 1 + ( V_1 -> V_59 / 8 ) ;
V_222 -> V_229 = 7 + 2 * V_149 ;
V_149 = V_230 | V_231 ;
if ( V_138 & V_152 )
V_149 |= V_232 ;
if ( V_138 & V_176 )
...
V_149 |= V_235 ;
V_222 -> V_236 = F_128 ( V_149 ) ;
V_49 = F_45 ( V_1 , V_53 . V_100 , & V_223 ) ;
if ( V_49 )
return V_49 ;
memset ( V_222 -> V_97 . V_237 . V_238 , 0xff ,
sizeof( V_222 -> V_97 . V_237 . V_238 ) ) ;
V_222 -> V_97 . V_237 . V_238 [ 0 ] = V_223 & V_239 ;
if ( V_1 -> V_59 > 7 ) {
V_222 -> V_97 . V_237 . V_238 [ 1 ] = ( V_223 & V_239 ) >> 8 ;
V_222 -> V_97 . V_237 . V_238 [ 2 ] = 0xff ;
} else
V_222 -> V_97 . V_237 . V_238 [ 1 ] = 0xff ;
return 0 ;
}
static int F_129 ( struct V_1 * V_1 , T_5 * V_222 )
{
T_2 V_240 = - 1 ;
int V_241 = F_45 ( V_1 , V_53 . V_54 , & V_240 ) ;
* V_222 = F_130 ( V_240 ) ;
return V_241 ;
}
static int F_131 ( struct V_1 * V_1 , T_5 * V_222 , T_3 V_242 )
{
if ( V_242 == 0 || V_242 > V_1 -> V_59 ) {
return - V_141 ;
} else {
int V_123 = V_242 - 1 ;
T_2 V_243 = - 1 ;
int V_244 = F_45 ( V_1 ,
V_53 . V_61 [ V_123 ] , & V_243 ) ;
* V_222 = F_130 ( V_243 ) ;
if ( * ( T_3 * ) ( V_222 + 2 ) ) {
...
static int F_132 ( struct V_1 * V_1 , int V_245 )
{
int V_49 ;
T_2 V_246 ;
T_3 V_247 ;
T_3 V_248 ;
V_49 = F_45 ( V_1 , V_246 , & V_246 ) ;
if ( V_49 )
return V_49 ;
V_247 = V_246 ;
V_248 = V_247 + V_249 ;
...
static int F_134 ( struct V_1 * V_1 , T_3 V_255 ,
T_3 V_242 )
{
if ( V_242 == 0 || V_242 > V_1 -> V_59 ) {
return - V_141 ;
...
int V_49 ;
int V_245 = V_242 - 1 ;
struct V_256 * V_123 = & V_1 -> V_123 [ V_245 ] ;
V_123 -> V_257 &= ~ ( 1 << V_255 ) ;
switch ( V_255 ) {
case V_258 :
V_49 = F_90 ( V_1 ,
V_53 . V_61 [ V_245 ] , V_259 ) ;
if ( V_49 )
return V_49 ;
return 0 ;
case V_260 :
V_49 = F_90 ( V_1 ,
V_53 . V_61 [ V_245 ] , V_261 ) ;
if ( V_49 )
return V_49 ;
return 0 ;
case V_262 :
V_49 = F_132 ( V_1 , V_245 ) ;
if ( V_49 )
return V_49 ;
return 0 ;
default:
...
static int F_135 ( struct V_1 * V_1 , T_3 V_255 ,
T_3 V_242 )
{
if ( V_242 == 0 || V_242 > V_1 -> V_59 ) {
return - V_141 ;
...
int V_60 , V_275 = 0 , V_38 = 1 ;
if ( V_1 -> V_157 & V_181 ) {
if ( ( V_1 -> V_57 & V_139 ) > V_276 ) {
...
static int F_137 ( struct V_5 * V_6 , T_3 V_279 , T_3 V_255 ,
T_3 V_242 , char * V_84 , T_3 V_280 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 1 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_12
...
static int F_138 ( struct V_5 * V_6 , unsigned V_291 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 1 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_12
...
F_43 ( V_1 ) ;
while ( V_292 -- > 0 ) {
struct V_22 * V_23 = & V_1 -> V_23 [ V_292 ] ;
F_27 ( V_1 , V_23 ) ;
} while ( V_294 -- > 0 ) {
struct V_27 * V_28 = V_1 -> V_28 [ V_294 ] ;
if ( V_28 )
F_39 ( V_1 , V_28 ) ;
}
V_1 -> V_14 += 1 ;
...
F_107 ( & V_1 -> V_47 , F_47 ) ;
while ( V_297 -- > 0 ) {
struct V_256 * V_123 = & V_1 -> V_123 [ V_297 ] ;
V_123 -> V_1 = V_1 ;
V_123 -> V_302 = 0 ;
V_123 -> V_303 = 0 ;
V_123 -> V_124 = 0 ;
...
while ( V_298 -- > 0 ) {
struct V_203 * V_31 = & V_1 -> V_31 [ V_298 ] ;
V_31 -> V_30 = 0 ;
}
while ( V_300 -- > 0 ) {
struct V_2 * V_3 = & V_1 -> V_3 [ V_300 ] ;
int V_60 = F_146 ( V_3 -> V_43 ) ;
int V_304 = F_146 ( V_3 -> V_45 ) ;
V_3 -> V_19 = NULL ;
V_3 -> V_4 = 0 ;
V_3 -> V_20 = 0 ;
V_3 -> V_305 = 0 ;
...
if ( V_12 -> V_18 . V_307 )
return - V_141 ;
V_6 = F_150 ( & V_308 , & V_12 -> V_18 , F_151 ( & V_12 -> V_18 ) ) ;
if ( ! V_6 ) {
F_118 ( V_208 L_77
) ;
F_49 ( V_12 ) ;
