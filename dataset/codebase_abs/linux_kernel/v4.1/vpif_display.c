...
while ( ( V_248 = F_91 ( V_243 , V_250 , V_249 ) ) ) {
V_50 = F_92 ( & V_243 -> V_69 , V_248 -> V_251 , F_39 ,
V_252 , V_119 ,
( void * ) ( & V_70 . V_69 [ V_249 ] ->
V_51 ) ) ;
if ( V_50 ) {
V_50 = - V_13 ;
F_10 ( L_28 ) ;
...
V_70 . V_208 . V_257 = V_70 . V_80 -> V_211 ;
V_70 . V_208 . V_258 = V_70 . V_80 -> V_254 [ 0 ] ;
V_70 . V_208 . V_259 = F_74 ;
V_70 . V_208 . V_260 = F_87 ;
V_50 = F_95 ( & V_70 . V_143 ,
& V_70 . V_208 ) ;
if ( V_50 ) {
F_10 ( L_31 ) ;
V_50 = - V_13 ;
...
static int F_97 ( struct V_242 * V_261 )
{
struct V_7 * V_8 ;
struct V_4 * V_5 ;
int V_71 ;
...
static int F_98 ( struct V_261 * V_69 )
{
struct V_7 * V_8 ;
struct V_4 * V_5 ;
int V_71 ;
...
static int F_102 ( struct V_261 * V_69 )
{
struct V_7 * V_8 ;
struct V_4 * V_5 ;
int V_71 ;
