...
static void F_113 ( struct V_4 * V_5 , int V_231 )
{
V_5 -> V_158 = 0 ;
V_5 -> V_159 = V_5 -> V_27 ;
V_5 -> V_232 = V_233 ;
...
static int F_121 ( T_4 V_257 , const struct V_258 * V_259 , int V_185 )
{
int F_63 = 0 ;
int V_260 ;
...
return F_121 ( V_257 , V_263 , F_123 ( V_263 ) - 1 ) ;
}
...
static void F_132 ( struct V_284 * V_285 )
{
F_71 () ;
if ( V_286 >= 0 ) {
if ( V_286 != V_100 &&
...
static int V_295 ;
if ( V_74 != - 1 )
return F_136 ( & V_295 , V_74 ) ;
else
return V_295 ;
}
static void F_137 ( struct V_296 * V_297 , const char * V_23 , unsigned V_36 )
{
struct V_4 * V_5 = V_99 [ V_100 ] . V_25 ;
unsigned char V_9 ;
static F_138 ( V_298 ) ;
...
static struct V_303 * F_142 ( struct V_296 * V_9 , int * V_304 )
{
* V_304 = V_9 -> V_304 ? V_9 -> V_304 - 1 : V_100 ;
return V_305 ;
}
int F_143 ( struct V_137 * V_138 , unsigned long V_306 )
{
char type , V_307 ;
...
case V_311 :
F_71 () ;
V_169 = F_145 ( (struct V_312 T_7 * ) ( V_14 + 1 ) , V_138 ) ;
F_72 () ;
break;
case V_313 :
V_169 = F_146 ( V_138 ) ;
...
break;
case V_322 :
if ( F_144 ( V_19 , ( V_323 T_7 * ) ( V_14 + 4 ) ) ) {
V_169 = - V_310 ;
} else {
F_71 () ;
...
static int F_152 ( struct V_137 * V_138 , const unsigned char * V_197 , int V_36 )
{
int V_327 ;
V_327 = F_124 ( V_138 , V_197 , V_36 ) ;
F_153 ( V_138 ) ;
return V_327 ;
}
static int F_154 ( struct V_137 * V_138 , unsigned char V_328 )
{
if ( F_126 () )
return 0 ;
return F_124 ( V_138 , & V_328 , 1 ) ;
}
...
static int F_164 ( struct V_303 * V_331 , struct V_137 * V_138 )
{
...
V_169 = F_165 ( & V_5 -> V_127 , V_331 , V_138 ) ;
if ( V_169 )
goto V_332;
V_138 -> V_168 = V_5 ;
...
static int F_166 ( struct V_137 * V_138 , struct V_337 * V_338 )
{
return 0 ;
}
static void F_167 ( struct V_137 * V_138 , struct V_337 * V_338 )
{
}
static void F_168 ( struct V_137 * V_138 )
{
struct V_4 * V_5 = V_138 -> V_168 ;
F_169 ( V_5 == NULL ) ;
F_71 () ;
...
static T_9 F_176 ( struct V_362 * V_363 ,
struct V_364 * V_365 , char * V_197 )
{
return sprintf ( V_197 , L_10 , V_100 + 1 ) ;
}
int T_8 F_177 ( const struct V_366 * V_367 )
{
F_178 ( & V_368 , V_367 ) ;
if ( F_179 ( & V_368 , F_180 ( V_369 , 0 ) , 1 ) ||
F_181 ( F_180 ( V_369 , 0 ) , 1 , L_11 ) < 0 )
F_182 ( L_12 ) ;
V_103 = F_183 ( V_370 , NULL ,
F_180 ( V_369 , 0 ) , NULL ,
V_371 , L_13 ) ;
if ( F_184 ( V_103 ) )
V_103 = NULL ;
...
static int F_193 ( const struct V_383 * V_384 , int V_261 , int V_262 ,
int V_385 )
{
...
static int F_195 ( const struct V_383 * V_384 , int V_261 , int V_262 )
{
int V_79 , V_327 = 0 ;
for ( V_79 = V_261 ; V_79 <= V_262 ; V_79 ++ ) {
struct V_4 * V_5 = V_99 [ V_79 ] . V_25 ;
...
int F_196 ( const struct V_383 * V_384 , int V_261 , int V_262 , int V_385 )
{
struct V_386 * V_111 = V_384 -> V_111 ;
...
V_385 = 1 ;
if ( V_261 != - 1 ) {
V_169 = F_196 ( V_384 , V_261 , V_262 , V_385 ) ;
if ( V_169 != 0 )
return V_169 ;
}
V_261 = - 1 ;
...
static inline int F_198 ( struct V_349 * V_351 )
{
return 0 ;
}
...
static T_9 F_200 ( struct V_362 * V_363 , struct V_364 * V_365 ,
const char * V_197 , T_10 V_36 )
{
struct V_349 * V_351 = F_201 ( V_363 ) ;
int V_393 = F_202 ( V_197 , NULL , 0 ) ;
F_71 () ;
if ( V_393 )
F_198 ( V_351 ) ;
else
...
static T_9 F_203 ( struct V_362 * V_363 , struct V_364 * V_365 ,
char * V_197 )
{
struct V_349 * V_351 = F_201 ( V_363 ) ;
int V_393 = F_197 ( V_351 -> V_351 ) ;
...
static int F_205 ( struct V_349 * V_351 )
{
V_351 -> V_353 |= V_395 ;
return 0 ;
}
static void F_206 ( struct V_349 * V_351 )
{
V_351 -> V_353 &= ~ V_395 ;
}
int F_197 ( const struct V_383 * V_384 )
{
int V_79 , V_396 = 0 ;
for ( V_79 = 0 ; V_79 < V_108 ; V_79 ++ ) {
if ( V_113 [ V_79 ] == V_384 ) {
...
if ( F_209 ( V_404 [ 0 ] , & V_402 ) ) {
snprintf ( V_403 , 4 , L_27 , V_5 -> V_27 ) ;
F_210 ( 2 , V_404 ) ;
}
}
if ( V_5 -> V_31 < 999 ) {
...
V_286 = V_399 ;
V_86 = V_401 ;
V_99 [ V_100 ] . V_25 -> V_87 = V_400 ;
V_5 = V_99 [ V_100 ] . V_25 ;
if ( V_5 -> V_16 -> F_211 )
V_169 = V_5 -> V_16 -> F_211 ( V_5 ) ;
return V_169 ;
}
static int F_212 ( const struct V_383 * V_384 , int V_261 , int V_262 )
{
struct V_386 * V_111 = V_384 -> V_111 ;
struct V_349 * V_349 ;
const char * V_352 ;
...
int F_214 ( const struct V_383 * V_384 )
{
int V_79 ;
if ( F_197 ( V_384 ) )
return - V_406 ;
...
int F_216 ( const struct V_383 * V_384 , int V_261 , int V_262 , int V_385 )
{
int V_135 ;
V_135 = F_212 ( V_384 , V_261 , V_262 ) ;
if ( V_135 == - V_406 )
V_135 = 0 ;
if ( ! V_135 )
F_193 ( V_384 , V_261 , V_262 , V_385 ) ;
...
void F_217 ( const struct V_383 * V_384 )
{
F_71 () ;
F_214 ( V_384 ) ;
F_72 () ;
...
V_351 , V_409 ,
L_29 , V_351 -> V_407 ) ;
if ( F_184 ( V_351 -> V_363 ) ) {
F_128 ( V_410 L_34
L_35 ,
V_351 -> V_352 , F_213 ( V_351 -> V_363 ) ) ;
V_351 -> V_363 = NULL ;
} else {
F_205 ( V_351 ) ;
}
...
static int F_151 ( char T_7 * V_14 )
{
unsigned int V_293 ;
if ( F_144 ( V_293 , V_14 + 1 ) )
return - V_310 ;
V_412 = ( V_293 < 4 ) ? V_293 : 0 ;
return 0 ;
}
void F_134 ( int V_413 )
{
struct V_4 * V_5 = V_99 [ V_100 ] . V_25 ;
int V_79 ;
F_21 () ;
...
V_290 = 0 ;
F_38 ( V_5 ) ;
V_79 = V_5 -> V_16 -> V_416 ( V_5 , V_217 ? 1 : ( V_412 + 1 ) , 0 ) ;
V_86 = V_100 + 1 ;
if ( V_79 )
F_37 ( V_5 ) ;
if ( V_417 && V_417 ( 1 ) )
...
if ( V_217 && V_412 ) {
V_355 = V_414 ;
F_172 ( & V_357 , V_358 + V_217 ) ;
}
F_68 ( V_418 , V_5 -> V_102 , V_5 -> V_102 ) ;
}
void F_221 ( int V_419 )
{
struct V_4 * V_5 ;
if ( ! V_420 )
F_127 () ;
...
static void F_223 ( unsigned long V_422 )
{
if ( F_224 ( ! F_225 () ) ) {
F_172 ( & V_357 , V_358 + ( V_212 * V_218 ) ) ;
return;
...
int F_227 ( unsigned char T_7 * V_306 )
{
int V_79 , V_252 , V_339 ;
unsigned char V_424 [ 3 * 16 ] ;
if ( F_228 ( V_424 , V_306 , sizeof( V_424 ) ) )
return - V_310 ;
F_71 () ;
...
int F_229 ( unsigned char T_7 * V_306 )
{
int V_79 , V_339 ;
unsigned char V_424 [ 3 * 16 ] ;
F_71 () ;
...
F_72 () ;
if ( F_230 ( V_306 , V_424 , sizeof( V_424 ) ) )
return - V_310 ;
return 0 ;
}
...
static int F_231 ( struct V_4 * V_5 , struct V_425 * V_426 )
{
struct V_427 V_428 ;
int V_429 = - V_156 ;
int V_9 ;
...
V_429 = V_5 -> V_16 -> F_231 ( V_5 , & V_428 ) ;
else
V_429 = - V_431 ;
F_72 () ;
if ( V_429 )
...
if ( V_426 -> V_307 && F_230 ( V_426 -> V_307 , V_428 . V_307 , V_9 ) )
V_429 = - V_310 ;
V_432:
F_58 ( V_428 . V_307 ) ;
return V_429 ;
}
static int F_232 ( struct V_4 * V_5 , struct V_425 * V_426 )
{
struct V_427 V_428 ;
int V_429 = - V_156 ;
int V_437 ;
...
if ( F_144 ( V_440 , & V_439 [ 32 * V_79 + V_438 - 1 ] ) )
return - V_310 ;
if ( V_440 )
goto V_441;
}
...
V_428 . V_307 = F_233 ( V_426 -> V_307 , V_437 ) ;
if ( F_184 ( V_428 . V_307 ) )
return F_213 ( V_428 . V_307 ) ;
F_71 () ;
if ( V_5 -> V_87 != V_288 )
V_429 = - V_156 ;
else if ( V_5 -> V_16 -> F_232 )
V_429 = V_5 -> V_16 -> F_232 ( V_5 , & V_428 , V_426 -> V_379 ) ;
else
V_429 = - V_431 ;
F_72 () ;
F_58 ( V_428 . V_307 ) ;
...
if ( ! V_426 -> V_307 )
V_26 = NULL ;
else if ( F_235 ( V_372 , V_426 -> V_307 , V_442 - 1 ) < 0 )
return - V_310 ;
else
V_372 [ V_442 - 1 ] = 0 ;
F_71 () ;
...
if ( V_5 -> V_16 -> F_234 )
V_429 = V_5 -> V_16 -> F_234 ( V_5 , & V_428 , V_26 ) ;
else
V_429 = - V_431 ;
F_72 () ;
if ( ! V_429 ) {
...
static int F_236 ( struct V_4 * V_5 , struct V_425 * V_426 )
{
...
V_429 = V_5 -> V_16 -> F_236 ( V_5 , V_351 ) ;
F_72 () ;
return V_429 ;
}
int F_237 ( struct V_4 * V_5 , struct V_425 * V_426 )
{
switch ( V_426 -> V_426 ) {
case V_444 :
return F_232 ( V_5 , V_426 ) ;
case V_445 :
return F_231 ( V_5 , V_426 ) ;
case V_446 :
return F_234 ( V_5 , V_426 ) ;
case V_447 :
return F_236 ( V_5 , V_426 ) ;
}
return - V_431 ;
}
...
unsigned short * F_239 ( struct V_4 * V_5 , int V_449 , int V_13 )
{
...
T_1 F_242 ( struct V_4 * V_5 , const T_1 * V_450 )
{
if ( ( unsigned long ) V_450 == V_5 -> V_76 && V_81 != - 1 )
return V_81 ;
return F_19 ( V_450 ) ;
}
void F_243 ( struct V_4 * V_5 , T_1 V_451 , T_1 * V_450 )
{
F_28 ( V_451 , V_450 ) ;
