...
V_2 = F_52 ( V_24 ) ;
V_193 = F_63 ( V_9 ) ;
for ( V_95 = 0 ; V_95 < V_193 -> V_197 ; V_95 ++ ) {
if ( ! strcmp ( V_193 -> V_198 [ V_95 ] , V_15 -> V_184 -> V_199 ) )
V_196 = true ;
}
if ( ! V_196 )
return 0 ;
for ( V_195 = 0 ; V_195 < V_193 -> V_184 -> V_200 ; V_195 ++ ) {
enum V_201 V_202 ;
V_202 = V_193 -> V_184 -> V_203 [ V_195 ] ;
if ( F_64 ( V_193 , V_202 , & V_8 ) )
continue;
switch ( V_202 ) {
case V_204 :
...
static void F_65 ( struct V_207 * V_208 )
{
int V_209 = 10 ;
struct V_1 * V_2 = F_66 ( V_208 ,
...
{
struct V_1 * V_2 =
F_66 ( V_208 , struct V_1 , V_232 . V_208 ) ;
int V_8 ;
if ( ! V_2 -> V_17 . V_34 ) {
V_8 = F_38 ( V_2 ,
V_2 -> V_58 . V_59 ) ;
...
static void F_89 ( struct V_207 * V_208 )
{
struct V_1 * V_2 = F_66 ( V_208 ,
...
if ( F_103 ( V_2 -> V_10 ) || F_104 ( V_2 -> V_10 )
|| F_105 ( V_2 -> V_10 ) || F_35 ( V_2 -> V_10 ) )
V_8 = F_56 ( V_2 -> V_9 ,
V_35 ,
V_292 ,
V_293 ,
...
static int F_107 ( struct V_171 * V_319 ,
unsigned long V_173 , void * V_320 )
{
struct V_1 * V_2 =
F_66 ( V_319 , struct V_1 , V_319 ) ;
enum V_321 V_322 ;
...
static int F_112 ( struct V_327 * V_328 ,
T_4 V_241 )
{
struct V_1 * V_2 = F_111 ( V_328 ) ;
F_53 ( & V_2 -> V_212 ) ;
...
static int F_116 ( struct V_327 * V_328 )
{
struct V_1 * V_2 = F_111 ( V_328 ) ;
int V_95 , V_260 , V_8 ;
...
V_260 = F_117 ( V_328 , V_330 [ V_95 ] . V_199 ) ;
F_118 ( V_260 , V_2 ) ;
}
V_8 = F_56 ( V_2 -> V_9 ,
V_310 , V_314 , V_315 , 0 ) ;
...
F_124 ( V_2 -> V_165 . V_15 ) ;
return 0 ;
}
static int F_125 ( struct V_327 * V_328 )
{
...
V_2 = F_126 ( & V_328 -> V_9 , sizeof( * V_2 ) , V_346 ) ;
if ( ! V_2 ) {
...
V_2 -> V_100 = V_339 ;
if ( V_336 ) {
V_8 = F_127 ( & V_328 -> V_9 , V_336 , V_2 -> V_100 ) ;
if ( V_8 ) {
F_5 ( & V_328 -> V_9 , L_108 ) ;
return V_8 ;
}
V_2 -> V_16 = F_128 ( V_336 , L_109 ) ;
} else
V_2 -> V_16 = false ;
V_2 -> V_9 = & V_328 -> V_9 ;
V_2 -> V_10 = F_63 ( V_328 -> V_9 . V_10 ) ;
V_2 -> V_31 = F_129 ( L_110 ) ;
F_130 ( & V_2 -> V_105 . V_240 ) ;
F_131 ( & V_2 -> V_135 ) ;
V_2 -> V_20 = false ;
V_2 -> V_235 = 0 ;
V_342 . V_198 = V_348 ;
V_342 . V_197 = F_28 ( V_348 ) ;
V_342 . V_349 = & V_2 -> V_165 ;
V_343 . V_198 = V_348 ;
V_343 . V_197 = F_28 ( V_348 ) ;
...
if ( V_2 -> V_165 . V_332 ) {
V_2 -> V_165 . V_15 = F_140 ( V_2 -> V_9 ,
& V_365 ,
& V_342 ) ;
if ( F_138 ( V_2 -> V_165 . V_15 ) ) {
F_5 ( V_2 -> V_9 , L_116 ) ;
V_8 = F_139 ( V_2 -> V_165 . V_15 ) ;
goto V_364;
}
}
if ( V_2 -> V_24 . V_332 ) {
V_2 -> V_24 . V_15 = F_140 ( V_2 -> V_9 ,
& V_366 ,
& V_343 ) ;
if ( F_138 ( V_2 -> V_24 . V_15 ) ) {
F_5 ( V_2 -> V_9 , L_117 ) ;
V_8 = F_139 ( V_2 -> V_24 . V_15 ) ;
goto V_367;
}
}
V_2 -> V_331 = F_141 ( V_368 ) ;
if ( F_142 ( V_2 -> V_331 ) ) {
F_5 ( V_2 -> V_9 , L_118 ) ;
V_8 = - V_282 ;
goto V_369;
}
V_2 -> V_319 . V_370 = F_107 ;
V_8 = F_143 ( V_2 -> V_331 , & V_2 -> V_319 ) ;
if ( V_8 ) {
F_5 ( V_2 -> V_9 , L_119 ) ;
goto V_371;
}
...
for ( V_95 = 0 ; V_95 < F_28 ( V_330 ) ; V_95 ++ ) {
V_260 = F_117 ( V_328 , V_330 [ V_95 ] . V_199 ) ;
V_8 = F_144 ( V_260 , NULL , V_330 [ V_95 ] . V_372 ,
V_373 | V_374 ,
