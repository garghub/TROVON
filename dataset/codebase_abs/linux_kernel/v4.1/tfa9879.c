...
return - V_65 ;
F_11 ( V_60 , V_10 ) ;
V_10 -> V_66 = F_12 ( V_60 , & V_67 ) ;
if ( F_13 ( V_10 -> V_66 ) )
return F_14 ( V_10 -> V_66 ) ;
for ( V_63 = 0 ; V_63 < F_15 ( V_68 ) ; V_63 ++ )
F_16 ( V_10 -> V_66 ,
V_68 [ V_63 ] . V_57 , V_68 [ V_63 ] . V_69 ) ;
return F_17 ( & V_60 -> V_56 , & V_70 ,
& V_71 , 1 ) ;
}
static int F_18 ( struct V_59 * V_72 )
{
F_19 ( & V_72 -> V_56 ) ;
return 0 ;
}
