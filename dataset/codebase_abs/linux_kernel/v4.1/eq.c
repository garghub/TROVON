...
F_51 ( V_2 , L_26 ,
F_44 ( V_30 -> V_64 . V_180 . V_181 ) ,
F_44 ( V_30 -> V_64 . V_180 . V_182 ) ) ;
} else
F_12 ( V_2 , L_27 ,
...
F_2 ( V_13 , 1 ) ;
if ( ! ( V_117 & ~ 0xffffff ) )
F_53 ( & V_13 -> V_190 . V_191 ) ;
return V_118 ;
}
static T_3 F_54 ( int V_192 , void * V_193 )
{
struct V_1 * V_2 = V_193 ;
struct V_44 * V_45 = V_44 ( V_2 ) ;
int V_38 = 0 ;
int V_47 ;
F_55 ( V_45 -> V_194 . V_195 , V_45 -> V_194 . V_196 ) ;
for ( V_47 = 0 ; V_47 < V_2 -> V_5 . V_197 + 1 ; ++ V_47 )
V_38 |= F_35 ( V_2 , & V_45 -> V_194 . V_13 [ V_47 ] ) ;
return F_56 ( V_38 ) ;
}
static T_3 F_57 ( int V_192 , void * V_198 )
{
struct V_12 * V_13 = V_198 ;
...
struct V_44 * V_45 = V_44 ( V_2 ) ;
struct V_206 * V_207 =
V_45 -> V_43 . V_40 . V_57 [ V_46 ] . V_207 ;
V_16 V_208 = V_201 -> V_208 ;
V_16 V_138 = V_208 & 0x3FF ;
T_1 V_209 = V_201 -> V_209 ;
int V_106 = 0 ;
int V_47 ;
if ( V_46 == V_2 -> V_5 . V_56 )
V_106 = F_34 ( V_2 , V_209 , ( V_208 & 0x80000000 ) | V_138 ,
0 , V_210 , V_211 ,
V_212 ) ;
if ( ! V_106 )
for ( V_47 = 0 ; V_47 < V_213 ; ++ V_47 )
if ( V_209 & ( 1LL << V_47 ) )
V_207 [ V_47 ] . V_138 = V_208 >> 31 ? - 1 : V_138 ;
return V_106 ;
}
static int F_59 ( struct V_1 * V_2 , T_1 V_214 , int V_215 ,
int V_216 )
{
return F_34 ( V_2 , V_214 , ( V_215 << 31 ) | V_216 ,
0 , V_210 , V_211 ,
V_116 ) ;
}
static int F_60 ( struct V_1 * V_2 , struct V_202 * V_217 ,
int V_216 )
{
return F_34 ( V_2 , V_217 -> V_218 , V_216 , 0 ,
V_219 , V_115 ,
V_116 ) ;
}
static int F_61 ( struct V_1 * V_2 , int V_216 )
{
return F_34 ( V_2 , 0 , V_216 , 1 , V_220 ,
V_115 , V_116 ) ;
}
static int F_62 ( struct V_1 * V_2 )
{
return ( V_2 -> V_5 . V_197 + 1 + V_2 -> V_5 . V_221 +
V_2 -> V_5 . V_222 ) / 4 - V_2 -> V_5 . V_221 / 4 + 1 ;
}
static void T_4 * F_63 ( struct V_1 * V_2 , struct V_12 * V_13 )
{
struct V_44 * V_45 = V_44 ( V_2 ) ;
int V_223 ;
V_223 = V_13 -> V_138 / 4 - V_2 -> V_5 . V_221 / 4 ;
if ( ! V_45 -> V_194 . V_224 [ V_223 ] ) {
V_45 -> V_194 . V_224 [ V_223 ] =
F_64 ( F_65 ( V_2 -> V_50 -> V_225 , 2 ) +
( ( V_13 -> V_138 / 4 ) << V_226 ) ,
V_26 ) ;
if ( ! V_45 -> V_194 . V_224 [ V_223 ] ) {
F_51 ( V_2 , L_34 ,
...
return V_45 -> V_194 . V_224 [ V_223 ] + 0x800 + 8 * ( V_13 -> V_138 % 4 ) ;
}
...
if ( V_45 -> V_194 . V_224 [ V_47 ] ) {
F_67 ( V_45 -> V_194 . V_224 [ V_47 ] ) ;
V_45 -> V_194 . V_224 [ V_47 ] = NULL ;
}
}
static int F_68 ( struct V_1 * V_2 , int V_24 ,
T_2 V_227 , struct V_12 * V_13 )
{
struct V_44 * V_45 = V_44 ( V_2 ) ;
struct V_202 * V_217 ;
struct V_228 * V_229 ;
...
V_230 = F_71 ( V_13 -> V_24 * V_2 -> V_5 . V_22 ) / V_26 ;
V_13 -> V_25 = F_72 ( V_230 * sizeof * V_13 -> V_25 ,
V_235 ) ;
if ( ! V_13 -> V_25 )
goto V_236;
for ( V_47 = 0 ; V_47 < V_230 ; ++ V_47 )
V_13 -> V_25 [ V_47 ] . V_27 = NULL ;
V_231 = F_72 ( V_230 * sizeof *V_231 , V_235 ) ;
if ( ! V_231 )
goto V_237;
V_217 = F_73 ( V_2 ) ;
if ( F_74 ( V_217 ) )
...
goto V_238;
V_231 [ V_47 ] = V_232 ;
V_13 -> V_25 [ V_47 ] . V_239 = V_232 ;
memset ( V_13 -> V_25 [ V_47 ] . V_27 , 0 , V_26 ) ;
}
V_13 -> V_138 = F_76 ( & V_45 -> V_194 . V_240 ) ;
if ( V_13 -> V_138 == - 1 )
goto V_238;
...
V_106 = F_77 ( V_2 , V_230 , V_226 , & V_13 -> V_242 ) ;
if ( V_106 )
goto V_241;
V_106 = F_78 ( V_2 , & V_13 -> V_242 , 0 , V_230 , V_231 ) ;
if ( V_106 )
goto V_243;
V_229 -> V_6 = F_4 ( V_244 |
V_245 ) ;
V_229 -> V_246 = F_79 ( V_13 -> V_24 ) ;
V_229 -> V_227 = V_227 ;
V_229 -> V_247 = V_226 - V_248 ;
V_233 = F_80 ( V_2 , & V_13 -> V_242 ) ;
V_229 -> V_249 = V_233 >> 32 ;
V_229 -> V_250 = F_4 ( V_233 & 0xffffffff ) ;
V_106 = F_60 ( V_2 , V_217 , V_13 -> V_138 ) ;
if ( V_106 ) {
F_12 ( V_2 , L_35 , V_106 ) ;
goto V_243;
}
...
F_82 ( V_2 , V_217 ) ;
V_13 -> V_17 = 0 ;
F_83 ( & V_13 -> V_190 . V_251 ) ;
F_83 ( & V_13 -> V_190 . V_252 ) ;
F_84 ( & V_13 -> V_190 . V_90 ) ;
F_85 ( & V_13 -> V_190 . V_191 , V_253 ,
( unsigned long ) & V_13 -> V_190 ) ;
return V_106 ;
V_243:
F_86 ( V_2 , & V_13 -> V_242 ) ;
V_241:
F_87 ( & V_45 -> V_194 . V_240 , V_13 -> V_138 , V_254 ) ;
V_238:
for ( V_47 = 0 ; V_47 < V_230 ; ++ V_47 )
if ( V_13 -> V_25 [ V_47 ] . V_27 )
F_88 ( & V_2 -> V_50 -> V_225 -> V_2 , V_26 ,
V_13 -> V_25 [ V_47 ] . V_27 ,
V_13 -> V_25 [ V_47 ] . V_239 ) ;
F_82 ( V_2 , V_217 ) ;
V_237:
F_81 ( V_13 -> V_25 ) ;
F_81 ( V_231 ) ;
...
int V_106 ;
int V_47 ;
int V_230 = F_71 ( V_2 -> V_5 . V_22 * V_13 -> V_24 ) / V_26 ;
V_106 = F_61 ( V_2 , V_13 -> V_138 ) ;
if ( V_106 )
F_12 ( V_2 , L_36 , V_106 ) ;
F_90 ( V_13 -> V_192 ) ;
F_91 ( & V_13 -> V_190 . V_191 ) ;
F_86 ( V_2 , & V_13 -> V_242 ) ;
for ( V_47 = 0 ; V_47 < V_230 ; ++ V_47 )
F_88 ( & V_2 -> V_50 -> V_225 -> V_2 , V_26 ,
V_13 -> V_25 [ V_47 ] . V_27 ,
...
{
struct V_255 * V_194 = & V_44 ( V_2 ) -> V_194 ;
struct V_44 * V_45 = V_44 ( V_2 ) ;
int V_47 , V_256 ;
if ( V_194 -> V_257 )
F_93 ( V_2 -> V_50 -> V_225 -> V_192 , V_2 ) ;
for ( V_47 = 0 ; V_47 < V_2 -> V_5 . V_197 + 1 ; ++ V_47 )
if ( V_194 -> V_13 [ V_47 ] . V_257 ) {
F_93 ( V_194 -> V_13 [ V_47 ] . V_192 , V_194 -> V_13 + V_47 ) ;
V_194 -> V_13 [ V_47 ] . V_257 = 0 ;
}
for ( V_47 = 0 ; V_47 < V_2 -> V_5 . V_222 ; V_47 ++ ) {
if ( V_45 -> V_258 . V_259 & 1ULL << V_47 ) {
V_256 = V_2 -> V_5 . V_197 + 1 + V_47 ;
F_93 ( V_45 -> V_194 . V_13 [ V_256 ] . V_192 ,
& V_45 -> V_194 . V_13 [ V_256 ] ) ;
}
}
F_81 ( V_194 -> V_260 ) ;
}
...
{
struct V_44 * V_45 = V_44 ( V_2 ) ;
V_45 -> V_261 = F_64 ( F_65 ( V_2 -> V_50 -> V_225 ,
V_45 -> V_262 . V_263 ) +
V_45 -> V_262 . V_264 , V_265 ) ;
if ( ! V_45 -> V_261 ) {
F_51 ( V_2 , L_37 ) ;
return - V_234 ;
}
...
{
struct V_44 * V_45 = V_44 ( V_2 ) ;
V_45 -> V_194 . V_13 = F_97 ( V_2 -> V_5 . V_266 - V_2 -> V_5 . V_221 ,
sizeof * V_45 -> V_194 . V_13 , V_235 ) ;
if ( ! V_45 -> V_194 . V_13 )
return - V_234 ;
return 0 ;
}
...
int V_106 ;
int V_47 ;
V_45 -> V_194 . V_224 = F_97 ( F_62 ( V_2 ) ,
sizeof * V_45 -> V_194 . V_224 ,
V_235 ) ;
if ( ! V_45 -> V_194 . V_224 ) {
V_106 = - V_234 ;
goto V_237;
}
V_106 = F_100 ( & V_45 -> V_194 . V_240 ,
F_69 ( V_2 -> V_5 . V_266 ) ,
V_2 -> V_5 . V_266 - 1 ,
V_2 -> V_5 . V_221 ,
F_69 ( V_2 -> V_5 . V_266 ) -
...
goto V_267;
V_45 -> V_194 . V_195 =
F_102 ( 1 << ( V_45 -> V_194 . V_268 & 31 ) ) ;
V_45 -> V_194 . V_196 = V_45 -> V_261 +
( V_45 -> V_194 . V_268 < 32 ? 4 : 0 ) ;
}
V_45 -> V_194 . V_260 =
F_72 ( V_269 * ( V_2 -> V_5 . V_197 + 1 +
V_2 -> V_5 . V_222 ) ,
V_235 ) ;
if ( ! V_45 -> V_194 . V_260 ) {
V_106 = - V_234 ;
...
for ( V_47 = 0 ; V_47 < V_2 -> V_5 . V_197 ; ++ V_47 ) {
V_106 = F_68 ( V_2 , V_2 -> V_5 . V_270 -
V_2 -> V_5 . V_271 +
V_189 ,
( V_2 -> V_6 & V_272 ) ? V_47 : 0 ,
& V_45 -> V_194 . V_13 [ V_47 ] ) ;
if ( V_106 ) {
-- V_47 ;
goto V_273;
}
}
V_106 = F_68 ( V_2 , V_274 + V_189 ,
( V_2 -> V_6 & V_272 ) ? V_2 -> V_5 . V_197 : 0 ,
& V_45 -> V_194 . V_13 [ V_2 -> V_5 . V_197 ] ) ;
if ( V_106 )
goto V_275;
for ( V_47 = V_2 -> V_5 . V_197 + 1 ;
V_47 < V_2 -> V_5 . V_197 + V_2 -> V_5 . V_222 + 1 ; ++ V_47 ) {
V_106 = F_68 ( V_2 , V_2 -> V_5 . V_270 -
V_2 -> V_5 . V_271 +
V_189 ,
( V_2 -> V_6 & V_272 ) ? V_47 : 0 ,
...
const char * V_276 ;
for ( V_47 = 0 ; V_47 < V_2 -> V_5 . V_197 + 1 ; ++ V_47 ) {
if ( V_47 < V_2 -> V_5 . V_197 ) {
snprintf ( V_45 -> V_194 . V_260 +
V_47 * V_269 ,
V_269 ,
L_38 , V_47 ,
F_103 ( V_2 -> V_50 -> V_225 ) ) ;
} else {
snprintf ( V_45 -> V_194 . V_260 +
V_47 * V_269 ,
V_269 ,
...
V_276 = V_45 -> V_194 . V_260 +
V_47 * V_269 ;
V_106 = F_104 ( V_45 -> V_194 . V_13 [ V_47 ] . V_192 ,
F_57 , 0 , V_276 ,
V_45 -> V_194 . V_13 + V_47 ) ;
if ( V_106 )
goto V_277;
V_45 -> V_194 . V_13 [ V_47 ] . V_257 = 1 ;
}
} else {
snprintf ( V_45 -> V_194 . V_260 ,
V_269 ,
V_278 L_40 ,
F_103 ( V_2 -> V_50 -> V_225 ) ) ;
V_106 = F_104 ( V_2 -> V_50 -> V_225 -> V_192 , F_54 ,
V_279 , V_45 -> V_194 . V_260 , V_2 ) ;
if ( V_106 )
goto V_277;
V_45 -> V_194 . V_257 = 1 ;
}
V_106 = F_59 ( V_2 , F_1 ( V_2 ) , 0 ,
V_45 -> V_194 . V_13 [ V_2 -> V_5 . V_197 ] . V_138 ) ;
if ( V_106 )
F_12 ( V_2 , L_41 ,
V_45 -> V_194 . V_13 [ V_2 -> V_5 . V_197 ] . V_138 , V_106 ) ;
for ( V_47 = 0 ; V_47 < V_2 -> V_5 . V_197 + 1 ; ++ V_47 )
F_2 ( & V_45 -> V_194 . V_13 [ V_47 ] , 1 ) ;
return 0 ;
V_277:
F_89 ( V_2 , & V_45 -> V_194 . V_13 [ V_2 -> V_5 . V_197 ] ) ;
V_275:
V_47 = V_2 -> V_5 . V_197 - 1 ;
V_273:
while ( V_47 >= 0 ) {
F_89 ( V_2 , & V_45 -> V_194 . V_13 [ V_47 ] ) ;
-- V_47 ;
}
if ( ! F_101 ( V_2 ) )
F_95 ( V_2 ) ;
...
V_267:
F_66 ( V_2 ) ;
F_105 ( & V_45 -> V_194 . V_240 ) ;
V_237:
F_81 ( V_45 -> V_194 . V_224 ) ;
return V_106 ;
}
...
V_45 -> V_194 . V_13 [ V_2 -> V_5 . V_197 ] . V_138 ) ;
F_92 ( V_2 ) ;
for ( V_47 = 0 ; V_47 < V_2 -> V_5 . V_197 + V_2 -> V_5 . V_222 + 1 ; ++ V_47 )
F_89 ( V_2 , & V_45 -> V_194 . V_13 [ V_47 ] ) ;
if ( ! F_101 ( V_2 ) )
F_95 ( V_2 ) ;
F_66 ( V_2 ) ;
...
int V_106 ;
V_106 = F_108 ( V_2 ) ;
if ( ! ( V_2 -> V_6 & V_272 ) || F_101 ( V_2 ) )
return V_106 ;
for( V_47 = 0 ; ! V_106 && ( V_47 < V_2 -> V_5 . V_197 ) ; ++ V_47 ) {
F_109 ( V_2 ) ;
V_106 = F_59 ( V_2 , F_1 ( V_2 ) , 0 ,
V_45 -> V_194 . V_13 [ V_47 ] . V_138 ) ;
if ( V_106 ) {
F_12 ( V_2 , L_42 ) ;
F_110 ( V_2 ) ;
break;
...
int F_111 ( struct V_1 * V_2 , char * V_280 , struct V_281 * V_282 ,
int * V_283 )
{
struct V_44 * V_45 = V_44 ( V_2 ) ;
int V_256 = 0 , V_106 = 0 , V_47 ;
F_112 ( & V_45 -> V_258 . V_284 ) ;
for ( V_47 = 0 ; ! V_256 && V_47 < V_2 -> V_5 . V_222 ; V_47 ++ ) {
if ( ~ V_45 -> V_258 . V_259 & 1ULL << V_47 ) {
V_45 -> V_258 . V_259 |= 1ULL << V_47 ;
V_256 = V_2 -> V_5 . V_197 + 1 + V_47 ;
snprintf ( V_45 -> V_194 . V_260 +
V_256 * V_269 ,
V_269 , L_43 , V_280 ) ;
...
if ( V_282 ) {
V_106 = F_114 ( V_282 ,
V_45 -> V_194 . V_13 [ V_256 ] . V_192 ) ;
if ( V_106 )
F_12 ( V_2 , L_44 ) ;
}
#endif
V_106 = F_104 ( V_45 -> V_194 . V_13 [ V_256 ] . V_192 ,
F_57 , 0 ,
& V_45 -> V_194 . V_260 [ V_256 << 5 ] ,
V_45 -> V_194 . V_13 + V_256 ) ;
if ( V_106 ) {
V_45 -> V_258 . V_259 ^= 1 << V_47 ;
V_256 = 0 ;
continue;
}
F_2 ( & V_45 -> V_194 . V_13 [ V_256 ] , 1 ) ;
}
}
F_115 ( & V_45 -> V_258 . V_284 ) ;
if ( V_256 ) {
* V_283 = V_256 ;
} else {
* V_283 = 0 ;
V_106 = ( V_47 == V_2 -> V_5 . V_222 ) ? - V_285 : V_106 ;
}
return V_106 ;
}
int F_116 ( struct V_1 * V_2 , int V_256 )
{
struct V_44 * V_45 = V_44 ( V_2 ) ;
return V_45 -> V_194 . V_13 [ V_256 ] . V_192 ;
}
void F_117 ( struct V_1 * V_2 , int V_256 )
{
struct V_44 * V_45 = V_44 ( V_2 ) ;
int V_47 = V_256 - V_2 -> V_5 . V_197 - 1 ;
if ( F_118 ( V_47 >= 0 ) ) {
F_112 ( & V_45 -> V_258 . V_284 ) ;
if ( V_45 -> V_258 . V_259 & 1ULL << V_47 ) {
F_93 ( V_45 -> V_194 . V_13 [ V_256 ] . V_192 ,
