...
int V_64 ;
for ( V_64 = 0 ; V_64 < V_58 -> V_65 ; V_64 ++ ) {
struct V_66 * V_67 = & V_58 -> V_68 [ V_64 ] ;
if ( V_67 -> V_69 == ( V_70 | V_71 ) ) {
F_36 ( ! V_58 -> V_60 -> V_8 -> V_72 ) ;
V_63 = V_58 -> V_60 -> V_8 -> V_72 ( V_67 -> V_73 ) ;
F_36 ( ! V_63 -> V_74 ) ;
V_67 -> V_73 = V_63 -> V_74 - V_75 ;
}
}
}
static void F_37 ( struct V_76 * V_60 )
{
int V_64 ;
for ( V_64 = 0 ; V_64 < V_60 -> V_77 ; V_64 ++ )
F_9 ( V_60 -> V_78 [ V_64 ] ) ;
F_29 ( V_60 -> V_78 ) ;
}
...
V_58 -> V_65 = V_3 -> V_84 ;
V_21 = - V_44 ;
if ( F_25 ( V_58 -> V_89 , F_21 ( V_3 -> V_89 ) ,
V_58 -> V_65 * sizeof( struct V_66 ) ) != 0 )
goto V_90;
V_58 -> V_91 = NULL ;
V_58 -> V_92 = false ;
...
F_35 ( V_58 ) ;
F_50 ( V_58 ) ;
V_21 = F_18 ( L_2 , & V_79 , V_58 , V_24 | V_25 ) ;
if ( V_21 < 0 )
goto F_37;
return V_21 ;
F_37:
