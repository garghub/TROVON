...
V_14 -> V_47 = V_47 ;
V_14 -> V_110 = V_31 ;
F_98 ( & V_14 -> V_163 , & V_31 -> V_164 ) ;
V_31 -> V_60 ++ ;
}
return 0 ;
}
static void F_99 ( struct V_4 * V_165 )
{
F_14 ( F_7 ( V_165 , struct V_1 , V_165 ) ) ;
}
int F_100 ( struct V_2 * V_3 , char * V_106 , int V_4 ,
int V_166 , int V_167 ,
struct V_1 * * V_168 )
{
struct V_1 * V_47 ;
...
F_101 ( & V_47 -> V_79 ) ;
F_11 ( & V_47 -> V_94 ) ;
F_102 ( & V_47 -> V_54 [ V_32 ] . V_164 ) ;
F_102 ( & V_47 -> V_54 [ V_56 ] . V_164 ) ;
if ( V_106 != NULL )
F_103 ( V_47 -> V_106 , V_106 , sizeof( V_47 -> V_106 ) ) ;
F_104 ( & V_47 -> V_165 , V_3 ) ;
V_47 -> V_165 . V_176 = F_99 ;
F_105 ( & V_47 -> V_165 , L_19 , V_3 -> V_63 , V_4 ) ;
if ( ( V_42 = F_97 ( V_47 ,
& V_47 -> V_54 [ V_32 ] ,
V_32 ,
V_167 ) ) < 0 ) {
...
{
struct V_13 * V_14 ;
while ( ! F_109 ( & V_31 -> V_164 ) ) {
V_14 = F_110 ( V_31 -> V_164 . V_178 , struct V_13 , V_163 ) ;
F_111 ( & V_14 -> V_163 ) ;
F_14 ( V_14 ) ;
}
}
...
static void F_114 ( struct V_183 * V_4 )
{
...
V_47 -> V_187 ++ ;
#ifdef F_119
F_120 ( F_119 , V_47 -> V_3 -> V_63 , V_47 -> V_107 ) ;
#endif
}
}
...
V_159 = F_121 ( V_47 -> V_3 , V_107 , V_47 -> V_3 -> V_190 ) ;
if ( V_159 ) {
V_159 -> V_100 = V_47 ;
...
V_47 -> V_179 = V_159 ;
#if F_123 ( V_194 ) || ( F_123 ( V_195 ) && F_123 ( V_196 ) )
if ( ! V_47 -> V_38 || ! V_47 -> V_38 -> V_172 ) {
if ( F_124 ( V_47 -> V_3 , V_47 -> V_4 , V_197 , 0 , & V_47 -> V_184 ) >= 0 ) {
V_47 -> V_184 -> V_100 = V_47 ;
V_47 -> V_184 -> V_104 = F_114 ;
sprintf ( V_47 -> V_184 -> V_107 , L_23 , V_47 -> V_3 -> V_63 , V_47 -> V_4 ) ;
F_125 ( V_47 -> V_3 , V_47 -> V_184 ) ;
}
}
#endif
return 0 ;
...
if ( V_47 -> V_187 ) {
if ( ( int ) V_47 -> V_4 == V_188 [ V_47 -> V_3 -> V_63 ] ) {
F_127 ( V_91 , V_47 -> V_3 , 0 ) ;
#ifdef F_119
F_128 ( F_119 , V_47 -> V_3 -> V_63 ) ;
#endif
}
if ( ( int ) V_47 -> V_4 == V_189 [ V_47 -> V_3 -> V_63 ] )
F_127 ( V_91 , V_47 -> V_3 , 1 ) ;
V_47 -> V_187 = 0 ;
}
#endif
F_117 ( & V_47 -> V_165 ) ;
...
void F_129 ( struct V_1 * V_47 , int V_31 ,
struct V_199 * V_38 )
{
struct V_13 * V_14 ;
