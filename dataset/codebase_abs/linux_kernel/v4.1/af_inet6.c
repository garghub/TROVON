...
{
int V_202 ;
V_1 -> V_203 . V_204 = F_74 ( struct V_205 ) ;
if ( ! V_1 -> V_203 . V_204 )
return - V_206 ;
V_1 -> V_203 . V_207 = F_74 ( struct V_205 ) ;
if ( ! V_1 -> V_203 . V_207 )
goto V_208;
V_1 -> V_203 . V_209 = F_74 ( struct V_210 ) ;
if ( ! V_1 -> V_203 . V_209 )
goto V_211;
F_75 (i) {
struct V_210 * V_212 ;
V_212 = F_76 ( V_1 -> V_203 . V_209 , V_202 ) ;
F_77 ( & V_212 -> V_213 ) ;
}
V_1 -> V_203 . V_214 = F_74 ( struct V_215 ) ;
if ( ! V_1 -> V_203 . V_214 )
goto V_216;
V_1 -> V_203 . V_217 = F_78 ( sizeof( struct V_218 ) ,
V_33 ) ;
if ( ! V_1 -> V_203 . V_217 )
goto V_219;
return 0 ;
V_219:
F_79 ( V_1 -> V_203 . V_214 ) ;
V_216:
F_79 ( V_1 -> V_203 . V_209 ) ;
V_211:
F_79 ( V_1 -> V_203 . V_207 ) ;
V_208:
F_79 ( V_1 -> V_203 . V_204 ) ;
return - V_206 ;
}
...
V_1 -> V_57 . V_58 . V_223 = 0 ;
V_1 -> V_57 . V_58 . V_224 = 3 ;
V_1 -> V_57 . V_58 . V_225 = 1 * V_221 ;
F_83 ( & V_1 -> V_57 . V_226 , 1 ) ;
V_17 = F_73 ( V_1 ) ;
if ( V_17 )
return V_17 ;
#ifdef F_84
...
struct V_157 * V_229 ;
int V_17 = 0 ;
F_93 ( sizeof( struct V_186 ) ) ;
for ( V_229 = & V_164 [ 0 ] ; V_229 < & V_164 [ V_162 ] ; ++ V_229 )
F_94 ( V_229 ) ;
if ( V_230 ) {
F_95 ( L_6 ) ;
goto V_34;
