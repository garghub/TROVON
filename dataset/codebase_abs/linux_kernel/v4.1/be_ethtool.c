...
V_79 += V_81 ;
F_26 (adapter, rxo, j) {
struct V_85 * V_71 = F_27 ( V_74 ) ;
do {
V_80 = F_28 ( & V_71 -> V_86 ) ;
V_72 [ V_79 ] = V_71 -> V_87 ;
V_72 [ V_79 + 1 ] = V_71 -> V_88 ;
} while ( F_29 ( & V_71 -> V_86 , V_80 ) );
...
F_30 (adapter, txo, j) {
struct V_91 * V_71 = F_31 ( V_76 ) ;
do {
V_80 = F_28 ( & V_71 -> V_92 ) ;
V_72 [ V_79 ] = V_71 -> V_93 ;
} while ( F_29 ( & V_71 -> V_92 , V_80 ) );
do {
V_80 = F_28 ( & V_71 -> V_86 ) ;
...
static void F_32 ( struct V_1 * V_2 , T_4 V_97 ,
T_5 * V_72 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_67 , V_78 ;
...
static int F_33 ( struct V_1 * V_2 , int V_97 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
switch ( V_97 ) {
case V_103 :
...
static T_1 F_35 ( struct V_5 * V_6 , T_1 V_125 )
{
T_1 V_126 = 0 ;
switch ( V_6 -> V_108 . V_109 ) {
case V_110 :
...
static int F_37 ( struct V_1 * V_2 , struct V_153 * V_154 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
T_2 V_155 ;
T_6 V_156 = 0 ;
...
V_154 -> V_175 = F_44 ( V_2 ) ? V_176 : V_177 ;
...
static void
F_46 ( struct V_1 * V_2 , struct V_189 * V_154 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_47 ( V_6 , & V_154 -> V_190 , & V_154 -> V_191 ) ;
...
static int F_55 ( struct V_1 * V_2 , struct V_205 * V_206 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
static int F_60 ( struct V_1 * V_2 , struct V_212 * V_213 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
static V_96 F_63 ( struct V_5 * V_6 , T_2 V_226 ,
V_96 * V_26 )
{
F_64 ( V_6 , V_6 -> V_198 , V_226 , 1 ) ;
* V_26 = F_65 ( V_6 , V_6 -> V_198 ,
V_226 , 1500 , 2 , 0xabc ) ;
F_64 ( V_6 , V_6 -> V_198 , V_227 , 1 ) ;
return * V_26 ;
}
static void F_66 ( struct V_1 * V_2 , struct V_228 * V_229 ,
V_96 * V_72 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_26 ;
...
if ( F_63 ( V_6 , V_235 , & V_72 [ 0 ] ) != 0 )
V_229 -> V_232 |= V_233 ;
if ( F_63 ( V_6 , V_236 , & V_72 [ 1 ] ) != 0 )
V_229 -> V_232 |= V_233 ;
...
static int F_67 ( struct V_1 * V_2 , struct V_240 * V_241 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_68 ( V_6 , V_241 -> V_72 ) ;
}
...
static void F_73 ( struct V_1 * V_2 , T_1 V_255 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_6 -> V_254 == V_255 )
return;
...
if ( F_74 ( V_6 ) )
F_75 ( V_6 , V_255 & V_256 ?
V_257 :
V_258 ) ;
V_6 -> V_254 = V_255 ;
}
static V_96 F_76 ( struct V_5 * V_6 , V_96 V_259 )
{
V_96 V_72 = 0 ;
switch ( V_259 ) {
case V_260 :
...
static int F_77 ( struct V_1 * V_2 , struct V_276 * V_277 ,
T_1 * V_278 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ! F_78 ( V_6 ) ) {
...
switch ( V_277 -> V_277 ) {
case V_279 :
V_277 -> V_72 = F_76 ( V_6 , V_277 -> V_259 ) ;
break;
case V_280 :
...
V_26 = F_81 ( V_6 , V_6 -> V_261 . V_281 ,
V_262 , 128 , V_6 -> V_261 . V_286 ) ;
if ( ! V_26 )
V_6 -> V_261 . V_262 = V_262 ;
return F_51 ( V_26 ) ;
}
static int F_82 ( struct V_1 * V_2 , struct V_276 * V_277 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_26 = 0 ;
if ( ! F_78 ( V_6 ) ) {
...
! V_289 -> V_290 || V_289 -> V_290 > F_84 ( V_6 ) )
return - V_106 ;
...
static int F_89 ( struct V_1 * V_2 , T_1 * V_299 , T_2 * V_300 ,
T_2 * V_301 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_67 ;
...
static int F_90 ( struct V_1 * V_2 , const T_1 * V_299 ,
