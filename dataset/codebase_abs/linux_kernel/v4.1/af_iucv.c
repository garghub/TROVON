...
V_50 = F_126 ( F_15 ( & V_233 -> V_27 ) , V_84 | V_128 ) ;
if ( ! V_50 )
break;
...
goto V_277;
V_276:
V_274 = F_165 ( sizeof( struct V_232 ) , V_84 | V_128 ) ;
if ( ! V_274 )
goto V_277;
V_274 -> V_37 = V_37 ;
V_274 -> V_27 = * V_27 ;
F_81 ( & V_274 -> V_120 , & V_7 -> V_119 . V_120 ) ;
V_277:
...
struct V_279 * V_120 = & F_10 ( V_9 ) -> V_21 ;
struct V_49 * V_280 = V_120 -> V_281 ;
unsigned long V_29 ;
F_158 ( V_9 ) ;
if ( ! F_59 ( V_120 ) ) {
F_80 ( & V_120 -> V_12 , V_29 ) ;
while ( V_280 != (struct V_49 * ) V_120 ) {
