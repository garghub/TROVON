...
struct V_1 * F_35 ( void T_1 * V_4 , int V_135 ,
int V_136 )
{
struct V_1 * V_137 ;
T_2 V_138 = F_2 ( V_4 + V_139 ) ;
V_137 = F_36 ( sizeof( const struct V_1 ) , V_140 ) ;
if ( ! V_137 )
return NULL ;
V_137 -> V_5 = V_4 ;
V_137 -> V_141 = V_135 ;
...
V_137 -> V_32 = 0 ;
if ( V_137 -> V_141 )
V_137 -> V_32 = F_37 ( V_137 -> V_141 ) ;
V_137 -> V_137 = & V_142 ;
V_137 -> V_143 = & V_144 ;
V_137 -> V_112 . V_145 = V_146 ;
V_137 -> V_112 . V_47 = V_147 ;
V_137 -> V_112 . V_148 = V_149 ;
V_137 -> V_150 . V_17 = V_151 ;
V_137 -> V_150 . V_152 = V_153 ;
V_137 -> V_154 = V_138 ;
return V_137 ;
}
