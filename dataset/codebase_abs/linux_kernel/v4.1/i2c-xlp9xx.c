...
struct V_1 * V_2 )
{
struct V_87 * V_88 = V_86 -> V_73 . V_89 ;
T_1 V_90 ;
int V_91 ;
V_91 = F_24 ( V_88 , L_3 , & V_90 ) ;
if ( V_91 ) {
V_90 = V_92 ;
F_19 ( & V_86 -> V_73 , L_4 , V_90 ) ;
} else if ( V_90 == 0 || V_90 > V_93 ) {
F_25 ( & V_86 -> V_73 , L_5 ,
V_90 ) ;
V_90 = V_92 ;
}
...
struct V_94 * V_95 ;
int V_91 = 0 ;
V_2 = F_27 ( & V_86 -> V_73 , sizeof( * V_2 ) , V_96 ) ;
if ( ! V_2 )
return - V_97 ;
V_95 = F_28 ( V_86 , V_98 , 0 ) ;
V_2 -> V_5 = F_29 ( & V_86 -> V_73 , V_95 ) ;
if ( F_30 ( V_2 -> V_5 ) )
return F_31 ( V_2 -> V_5 ) ;
...
F_23 ( V_86 , V_2 ) ;
F_13 ( V_2 ) ;
V_91 = F_34 ( & V_86 -> V_73 , V_2 -> V_22 , F_11 , 0 ,
V_86 -> V_99 , V_2 ) ;
if ( V_91 ) {
F_33 ( & V_86 -> V_73 , L_7 ) ;
return V_91 ;
...
F_35 ( & V_2 -> V_37 ) ;
V_2 -> V_81 . V_73 . V_100 = & V_86 -> V_73 ;
V_2 -> V_81 . V_101 = & V_102 ;
V_2 -> V_81 . V_73 . V_89 = V_86 -> V_73 . V_89 ;
V_2 -> V_73 = & V_86 -> V_73 ;
snprintf ( V_2 -> V_81 . V_99 , sizeof( V_2 -> V_81 . V_99 ) , L_8 ) ;
F_36 ( & V_2 -> V_81 , V_2 ) ;
V_91 = F_37 ( & V_2 -> V_81 ) ;
if ( V_91 ) {
F_33 ( & V_86 -> V_73 , L_9 ) ;
...
F_38 ( V_86 , V_2 ) ;
F_19 ( & V_86 -> V_73 , L_10 , V_2 -> V_81 . V_103 ) ;
return 0 ;
}
