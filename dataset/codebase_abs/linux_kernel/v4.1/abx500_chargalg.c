...
if ( ! strcmp ( V_132 -> V_139 [ V_134 ] , V_131 -> V_140 -> V_141 ) )
V_136 = true ;
}
if ( ! V_136 )
return 0 ;
if ( ! F_41 ( V_132 , V_142 , & V_126 ) ) {
V_5 -> V_78 . V_143 = V_126 . V_144 ;
V_137 = true ;
}
for ( V_135 = 0 ; V_135 < V_132 -> V_140 -> V_145 ; V_135 ++ ) {
enum V_146 V_147 ;
V_147 = V_132 -> V_140 -> V_148 [ V_135 ] ;
if ( ! V_5 -> V_34 &&
V_132 -> V_140 -> type == V_149 )
V_5 -> V_34 = F_42 ( V_132 ) ;
else if ( ! V_5 -> V_25 &&
V_132 -> V_140 -> type == V_150 )
V_5 -> V_25 = F_42 ( V_132 ) ;
if ( F_41 ( V_132 , V_147 , & V_126 ) )
continue;
switch ( V_147 ) {
case V_151 :
switch ( V_132 -> V_140 -> type ) {
case V_152 :
if ( V_126 . V_144 )
V_5 -> V_8 . V_153 = false ;
else
...
static void F_50 ( struct V_226 * V_227 )
{
struct V_4 * V_5 = F_2 ( V_227 ,
struct V_4 , V_11 ) ;
F_45 ( V_5 ) ;
...
static T_1 F_59 ( struct V_241 * V_242 ,
...
static int F_64 ( struct V_252 * V_253 )
{
struct V_4 * V_5 = F_65 ( V_253 ) ;
if ( V_5 -> V_22 . V_56 )
F_43 ( V_5 -> V_10 , & V_5 -> V_75 , 0 ) ;
F_43 ( V_5 -> V_10 , & V_5 -> V_228 , 0 ) ;
return 0 ;
}
static int F_66 ( struct V_252 * V_253 ,
T_3 V_16 )
{
struct V_4 * V_5 = F_65 ( V_253 ) ;
if ( V_5 -> V_22 . V_56 )
...
static int F_68 ( struct V_252 * V_253 )
{
struct V_4 * V_5 = F_65 ( V_253 ) ;
F_60 ( V_5 ) ;
F_69 ( & V_5 -> V_6 ) ;
...
struct V_4 * V_5 ;
int V_126 = 0 ;
V_5 = F_74 ( & V_253 -> V_7 , sizeof( * V_5 ) , V_262 ) ;
if ( ! V_5 ) {
F_3 ( & V_253 -> V_7 , L_45 , V_263 ) ;
return - V_264 ;
}
if ( ! V_258 ) {
F_3 ( & V_253 -> V_7 , L_46 ) ;
...
V_261 . V_139 = V_265 ;
V_261 . V_138 = F_76 ( V_265 ) ;
V_261 . V_266 = V_5 ;
F_77 ( & V_5 -> V_6 , V_267 , V_268 ) ;
V_5 -> V_6 . V_269 = F_1 ;
F_77 ( & V_5 -> V_13 , V_267 , V_268 ) ;
V_5 -> V_13 . V_269 =
F_5 ;
V_5 -> V_10 =
F_78 ( L_48 ) ;
