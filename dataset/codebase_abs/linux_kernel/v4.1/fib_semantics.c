...
{
T_4 V_73 = F_36 ( sizeof( struct V_74 ) )
+ F_37 ( 4 )
+ F_37 ( 4 )
+ F_37 ( 4 )
+ F_37 ( 4 )
+ F_37 ( V_75 ) ;
V_73 += F_37 ( ( V_66 * F_37 ( 4 ) ) ) ;
if ( V_23 -> V_57 ) {
T_4 V_76 = F_37 ( sizeof( struct V_77 ) ) ;
V_76 += 2 * F_37 ( 4 ) ;
V_73 += F_37 ( V_23 -> V_57 * V_76 ) ;
}
return V_73 ;
}
void F_38 ( int V_78 , T_3 V_79 , struct V_80 * V_81 ,
int V_82 , V_30 V_83 , const struct V_84 * V_85 ,
unsigned int V_86 )
{
struct V_87 * V_88 ;
V_30 V_89 = V_85 -> V_90 ? V_85 -> V_90 -> V_91 : 0 ;
int V_92 = - V_93 ;
V_88 = F_39 ( F_35 ( V_81 -> V_94 ) , V_95 ) ;
if ( ! V_88 )
goto V_96;
V_92 = F_40 ( V_88 , V_85 -> V_97 , V_89 , V_78 , V_83 ,
V_81 -> V_98 , V_79 , V_82 ,
...
F_43 ( V_88 , V_85 -> V_101 , V_85 -> V_97 , V_102 ,
V_85 -> V_90 , V_95 ) ;
return;
V_96:
if ( V_92 < 0 )
F_44 ( V_85 -> V_101 , V_102 , V_92 ) ;
}
static int F_45 ( struct V_22 * V_23 , int V_103 ,
struct V_22 * * V_104 , int * V_105 ,
int V_106 )
{
struct V_107 * V_108 ;
int V_109 = V_110 ;
V_108 = F_46 ( & V_111 , & V_23 -> V_5 [ 0 ] . V_47 , V_23 -> V_112 ) ;
if ( V_108 ) {
V_109 = V_108 -> V_113 ;
F_47 ( V_108 ) ;
}
...
static int F_48 ( struct V_77 * V_116 , int V_117 )
{
int V_118 = 0 ;
while ( F_49 ( V_116 , V_117 ) ) {
V_118 ++ ;
V_116 = F_50 ( V_116 , & V_117 ) ;
}
return V_117 > 0 ? 0 : V_118 ;
}
static int F_51 ( struct V_22 * V_23 , struct V_77 * V_116 ,
...
V_121 = F_52 ( V_116 ) ;
if ( V_121 > 0 ) {
struct V_127 * V_128 , * V_129 = F_53 ( V_116 ) ;
V_128 = F_54 ( V_129 , V_121 , V_130 ) ;
V_25 -> V_47 = V_128 ? F_55 ( V_128 ) : 0 ;
#ifdef F_17
V_128 = F_54 ( V_129 , V_121 , V_131 ) ;
V_25 -> V_34 = V_128 ? F_56 ( V_128 ) : 0 ;
if ( V_25 -> V_34 )
V_23 -> V_35 -> V_36 . V_37 ++ ;
#endif
}
...
int F_57 ( struct V_119 * V_120 , struct V_22 * V_23 )
{
#ifdef F_26
struct V_77 * V_116 ;
int V_117 ;
...
struct V_127 * V_128 , * V_129 = F_53 ( V_116 ) ;
V_128 = F_54 ( V_129 , V_121 , V_130 ) ;
if ( V_128 && F_55 ( V_128 ) != V_6 -> V_47 )
return 1 ;
#ifdef F_17
V_128 = F_54 ( V_129 , V_121 , V_131 ) ;
if ( V_128 && F_56 ( V_128 ) != V_6 -> V_34 )
return 1 ;
#endif
}
V_116 = F_50 ( V_116 , & V_117 ) ;
...
static int F_58 ( struct V_119 * V_120 , struct V_22 * V_23 ,
struct V_5 * V_6 )
{
int V_92 ;
struct V_137 * V_137 ;
...
return - V_122 ;
if ( F_59 ( V_137 , V_6 -> V_47 ) != V_144 )
return - V_122 ;
V_70 = F_60 ( V_137 , V_6 -> V_46 ) ;
if ( ! V_70 )
return - V_145 ;
if ( ! ( V_70 -> V_146 & V_147 ) )
return - V_148 ;
...
static inline unsigned int F_68 ( T_3 V_52 )
{
unsigned int V_53 = ( V_56 - 1 ) ;
...
static struct V_63 * F_69 ( int V_163 )
{
if ( V_163 <= V_164 )
return F_70 ( V_163 , V_95 ) ;
else
return (struct V_63 * )
F_71 ( V_95 | V_165 ,
F_72 ( V_163 ) ) ;
}
static void F_73 ( struct V_63 * V_8 , int V_163 )
{
if ( ! V_8 )
return;
if ( V_163 <= V_164 )
...
F_74 ( ( unsigned long ) V_8 , F_72 ( V_163 ) ) ;
}
static void F_75 ( struct V_63 * V_166 ,
struct V_63 * V_167 ,
unsigned int V_168 )
{
...
struct V_173 * V_108 ;
struct V_22 * V_23 ;
F_76 (fi, n, head, fib_hash) {
struct V_63 * V_174 ;
unsigned int V_175 ;
F_21 ( & V_23 -> V_40 ) ;
V_175 = F_28 ( V_23 ) ;
V_174 = & V_166 [ V_175 ] ;
F_77 ( & V_23 -> V_40 , V_174 ) ;
}
}
V_64 = V_166 ;
for ( V_9 = 0 ; V_9 < V_171 ; V_9 ++ ) {
...
struct V_173 * V_108 ;
struct V_22 * V_23 ;
F_76 (fi, n, lhead, fib_lhash) {
struct V_63 * V_177 ;
unsigned int V_175 ;
F_21 ( & V_23 -> V_42 ) ;
V_175 = F_68 ( V_23 -> V_41 ) ;
V_177 = & V_167 [ V_175 ] ;
F_77 ( & V_23 -> V_42 , V_177 ) ;
}
}
V_172 = V_167 ;
F_23 ( & V_38 ) ;
...
T_3 F_78 ( struct V_137 * V_137 , struct V_5 * V_6 )
{
V_6 -> V_178 = F_79 ( V_6 -> V_26 ,
V_6 -> V_47 ,
V_6 -> V_179 -> V_59 ) ;
V_6 -> V_180 = F_80 ( & V_137 -> V_36 . V_181 ) ;
return V_6 -> V_178 ;
}
struct V_22 * F_81 ( struct V_119 * V_120 )
{
int V_92 ;
...
#ifdef F_26
if ( V_120 -> V_135 ) {
V_118 = F_48 ( V_120 -> V_135 , V_120 -> V_136 ) ;
if ( V_118 == 0 )
goto V_184;
}
#endif
...
F_75 ( V_166 , V_167 , V_168 ) ;
if ( ! V_56 )
goto V_186;
}
V_23 = F_70 ( sizeof( * V_23 ) + V_118 * sizeof( struct V_5 ) , V_95 ) ;
if ( ! V_23 )
goto V_186;
V_33 ++ ;
if ( V_120 -> V_187 ) {
V_23 -> V_29 = F_70 ( sizeof( V_30 ) * V_66 , V_95 ) ;
if ( ! V_23 -> V_29 )
goto V_186;
} else
V_23 -> V_29 = ( V_30 * ) V_31 ;
...
F_12 (fi) {
V_25 -> V_179 = V_23 ;
V_25 -> V_27 = F_82 (struct rtable __rcu *) ;
if ( ! V_25 -> V_27 )
goto V_186;
} F_14 (fi)
if ( V_120 -> V_187 ) {
struct V_127 * V_128 ;
int V_117 ;
F_83 (nla, cfg->fc_mx, cfg->fc_mx_len, remaining) {
int type = F_84 ( V_128 ) ;
if ( type ) {
V_30 V_52 ;
if ( type > V_66 )
...
if ( V_120 -> V_135 ) {
#ifdef F_26
V_92 = F_51 ( V_23 , V_120 -> V_135 , V_120 -> V_136 , V_120 ) ;
if ( V_92 != 0 )
goto V_186;
...
goto V_184;
#ifdef F_17
if ( V_120 -> V_195 && V_23 -> V_5 -> V_34 != V_120 -> V_195 )
goto V_184;
#endif
#else
goto V_184;
...
goto V_184;
V_6 -> V_48 = V_200 ;
V_6 -> V_26 = F_87 ( V_137 , V_23 -> V_5 -> V_46 ) ;
V_92 = - V_145 ;
if ( ! V_6 -> V_26 )
goto V_186;
} else {
F_12 (fi) {
V_92 = F_58 ( V_120 , V_23 , V_25 ) ;
if ( V_92 != 0 )
goto V_186;
} F_14 (fi)
}
...
int F_40 ( struct V_87 * V_88 , V_30 V_97 , V_30 V_89 , int V_78 ,
V_30 V_83 , T_5 type , T_3 V_4 , int V_82 , T_5 V_203 ,
struct V_22 * V_23 , unsigned int V_146 )
{
struct V_204 * V_90 ;
struct V_74 * V_205 ;
V_90 = F_90 ( V_88 , V_97 , V_89 , V_78 , sizeof( * V_205 ) , V_146 ) ;
if ( ! V_90 )
return - V_100 ;
V_205 = F_91 ( V_90 ) ;
V_205 -> V_206 = V_207 ;
...
goto V_214;
if ( V_23 -> V_61 &&
F_92 ( V_88 , V_220 , V_23 -> V_61 ) )
goto V_214;
if ( F_94 ( V_88 , V_23 -> V_29 ) < 0 )
goto V_214;
if ( V_23 -> V_41 &&
F_93 ( V_88 , V_221 , V_23 -> V_41 ) )
goto V_214;
if ( V_23 -> V_57 == 1 ) {
if ( V_23 -> V_5 -> V_47 &&
F_93 ( V_88 , V_130 , V_23 -> V_5 -> V_47 ) )
goto V_214;
if ( V_23 -> V_5 -> V_46 &&
F_92 ( V_88 , V_222 , V_23 -> V_5 -> V_46 ) )
goto V_214;
#ifdef F_17
if ( V_23 -> V_5 [ 0 ] . V_34 &&
F_92 ( V_88 , V_131 , V_23 -> V_5 [ 0 ] . V_34 ) )
goto V_214;
#endif
}
#ifdef F_26
...
struct V_77 * V_116 ;
struct V_127 * V_223 ;
V_223 = F_95 ( V_88 , V_224 ) ;
if ( ! V_223 )
goto V_214;
F_25 (fi) {
V_116 = F_96 ( V_88 , sizeof( * V_116 ) ) ;
if ( ! V_116 )
goto V_214;
...
if ( V_6 -> V_47 &&
F_93 ( V_88 , V_130 , V_6 -> V_47 ) )
goto V_214;
#ifdef F_17
if ( V_6 -> V_34 &&
F_92 ( V_88 , V_131 , V_6 -> V_34 ) )
goto V_214;
#endif
V_116 -> V_225 = F_97 ( V_88 ) - ( void * ) V_116 ;
} F_14 ( V_23 ) ;
F_98 ( V_88 , V_223 ) ;
}
#endif
...
int F_101 ( struct V_137 * V_137 , T_3 V_226 )
{
int V_227 = 0 ;
unsigned int V_8 = F_68 ( V_226 ) ;
struct V_63 * V_21 = & V_172 [ V_8 ] ;
struct V_22 * V_23 ;
if ( ! V_172 || V_226 == 0 )
return 0 ;
F_30 (fi, head, fib_lhash) {
if ( ! F_31 ( V_23 -> V_35 , V_137 ) )
continue;
if ( V_23 -> V_41 == V_226 ) {
V_23 -> V_67 |= V_51 ;
V_227 ++ ;
...
int F_102 ( struct V_69 * V_70 , int V_228 )
{
int V_227 = 0 ;
int V_158 = V_200 ;
...
void F_104 ( struct V_139 * V_140 )
{
struct V_22 * V_23 = NULL , * V_104 = NULL ;
struct V_63 * V_234 = V_140 -> V_234 ;
struct V_235 * V_236 = V_140 -> V_237 ;
int V_103 = - 1 , V_105 = - 1 ;
struct V_80 * V_81 ;
F_105 (fa, fa_head, fa_list) {
struct V_22 * V_238 = V_81 -> V_94 ;
if ( V_238 -> V_59 != V_140 -> V_158 ||
V_81 -> V_98 != V_144 )
continue;
if ( V_238 -> V_61 > V_140 -> V_23 -> V_61 )
break;
if ( ! V_238 -> V_5 [ 0 ] . V_47 ||
V_238 -> V_5 [ 0 ] . V_48 != V_143 )
continue;
F_106 ( V_81 ) ;
if ( ! V_23 ) {
if ( V_238 != V_140 -> V_23 )
break;
} else if ( ! F_45 ( V_23 , V_103 , & V_104 ,
& V_105 , V_236 -> V_239 ) ) {
F_107 ( V_140 , V_23 ) ;
V_236 -> V_239 = V_103 ;
goto V_157;
...
if ( ! F_45 ( V_23 , V_103 , & V_104 , & V_105 ,
V_236 -> V_239 ) ) {
F_107 ( V_140 , V_23 ) ;
V_236 -> V_239 = V_103 ;
goto V_157;
