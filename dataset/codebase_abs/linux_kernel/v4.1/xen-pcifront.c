...
struct V_127 V_128 ;
T_7 V_129 ;
V_28 = F_90 ( V_4 -> V_23 , V_4 -> V_20 , 1 , & V_129 ) ;
if ( V_28 < 0 )
goto V_43;
V_4 -> V_125 = V_129 ;
V_28 = F_91 ( V_4 -> V_23 , & V_4 -> V_32 ) ;
if ( V_28 )
goto V_43;
V_28 = F_92 ( V_4 -> V_32 , F_69 ,
0 , L_42 , V_4 ) ;
if ( V_28 < 0 )
return V_28 ;
V_4 -> V_33 = V_28 ;
...
V_28 = F_95 ( V_128 , V_4 -> V_23 -> V_131 ,
L_45 , L_46 , V_4 -> V_125 ) ;
if ( ! V_28 )
V_28 = F_95 ( V_128 , V_4 -> V_23 -> V_131 ,
L_47 , L_46 , V_4 -> V_32 ) ;
...
static int F_98 ( struct V_1 * V_4 )
{
int V_28 = - V_135 ;
int V_61 , V_136 , V_137 ;
char V_138 [ 64 ] ;
unsigned int V_5 , V_6 ;
if ( F_99 ( V_4 -> V_23 -> V_131 ) !=
V_134 )
goto V_43;
V_28 = F_70 ( V_4 ) ;
if ( V_28 && V_28 != - V_120 ) {
...
V_28 = F_100 ( V_139 , V_4 -> V_23 -> V_140 ,
L_54 , L_55 , & V_136 ) ;
if ( V_28 == - V_141 ) {
F_101 ( V_4 -> V_23 , V_28 ,
L_56 ) ;
...
V_137 = snprintf ( V_138 , sizeof( V_138 ) , L_59 , V_61 ) ;
if ( F_102 ( V_137 >= ( sizeof( V_138 ) - 1 ) ) ) {
V_28 = - V_89 ;
goto V_43;
}
V_28 = F_100 ( V_139 , V_4 -> V_23 -> V_140 , V_138 ,
L_60 , & V_5 , & V_6 ) ;
if ( V_28 != 2 ) {
if ( V_28 >= 0 )
V_28 = - V_66 ;
...
int V_28 = 0 ;
int V_61 , V_148 ;
unsigned int V_5 , V_6 , V_149 , V_150 ;
struct V_58 * V_58 ;
char V_138 [ 64 ] ;
if ( F_99 ( V_4 -> V_23 -> V_131 ) !=
V_142 )
goto V_43;
V_28 = F_100 ( V_139 , V_4 -> V_23 -> V_140 , L_63 , L_55 ,
& V_148 ) ;
if ( V_28 != 1 ) {
if ( V_28 >= 0 )
V_28 = - V_66 ;
...
int V_151 , V_98 ;
V_151 = snprintf ( V_138 , sizeof( V_138 ) , L_65 , V_61 ) ;
if ( F_102 ( V_151 >= ( sizeof( V_138 ) - 1 ) ) ) {
V_28 = - V_89 ;
goto V_43;
}
V_28 = F_100 ( V_139 , V_4 -> V_23 -> V_140 , V_138 , L_55 ,
& V_98 ) ;
if ( V_28 != 1 )
V_98 = V_152 ;
if ( V_98 != V_145 )
continue;
V_151 = snprintf ( V_138 , sizeof( V_138 ) , L_66 , V_61 ) ;
if ( F_102 ( V_151 >= ( sizeof( V_138 ) - 1 ) ) ) {
V_28 = - V_89 ;
goto V_43;
}
V_28 = F_100 ( V_139 , V_4 -> V_23 -> V_140 , V_138 ,
L_67 , & V_5 , & V_6 , & V_149 , & V_150 ) ;
if ( V_28 != 4 ) {
if ( V_28 >= 0 )
V_28 = - V_66 ;
F_94 ( V_4 -> V_23 , V_28 ,
...
V_28 = F_97 ( V_4 -> V_23 , V_147 ) ;
V_43:
return V_28 ;
}
static void T_8 F_108 ( struct V_121 * V_23 ,
enum V_143 V_153 )
{
struct V_1 * V_4 = F_109 ( & V_23 -> V_24 ) ;
switch ( V_153 ) {
case V_152 :
case V_154 :
case V_155 :
