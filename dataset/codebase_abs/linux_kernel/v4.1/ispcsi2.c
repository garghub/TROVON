...
switch ( V_244 -> V_225 | F_78 ( V_245 -> V_159 ) ) {
case V_175 | V_247 :
if ( V_246 & V_248 ) {
if ( V_4 -> V_43 & ~ V_45 )
return - V_140 ;
...
{
int V_252 ;
V_252 = F_83 ( V_251 , & V_4 -> V_158 ) ;
if ( V_252 < 0 )
goto error;
V_252 = F_84 ( & V_4 -> V_176 , V_251 ) ;
if ( V_252 < 0 )
goto error;
return 0 ;
error:
...
struct V_243 * V_253 = & V_223 -> V_159 ;
int V_252 ;
F_86 ( V_223 , & V_254 ) ;
V_223 -> V_255 = & V_256 ;
...
F_88 ( V_223 , V_4 ) ;
V_223 -> V_246 |= V_258 ;
V_166 [ V_175 ] . V_246 = V_259 ;
V_166 [ V_28 ] . V_246 = V_260
| V_261 ;
V_253 -> V_262 = & V_263 ;
V_252 = F_89 ( V_253 , V_264 , V_166 , 0 ) ;
if ( V_252 < 0 )
return V_252 ;
F_69 ( V_223 , NULL ) ;
V_4 -> V_176 . type = V_265 ;
V_4 -> V_176 . V_262 = & V_266 ;
V_4 -> V_176 . V_267 = 32 ;
V_4 -> V_176 . V_268 = 1 ;
V_4 -> V_176 . V_269 = 0x1ffe0 ;
V_4 -> V_176 . V_2 = V_4 -> V_2 ;
V_4 -> V_176 . V_270 = F_90 ( 4096 * 4096 ) * 3 ;
V_252 = F_91 ( & V_4 -> V_176 , L_19 ) ;
if ( V_252 < 0 )
goto V_271;
V_252 = F_92 ( & V_4 -> V_158 . V_159 , V_175 ,
& V_4 -> V_176 . V_202 . V_159 , 0 , 0 ) ;
if ( V_252 < 0 )
goto V_272;
return 0 ;
V_272:
F_93 ( & V_4 -> V_176 ) ;
V_271:
F_94 ( & V_4 -> V_158 . V_159 ) ;
return V_252 ;
}
int F_95 ( struct V_1 * V_2 )
{
struct V_3 * V_273 = & V_2 -> V_203 ;
struct V_3 * V_274 = & V_2 -> V_275 ;
int V_252 ;
V_273 -> V_2 = V_2 ;
V_273 -> V_136 = 1 ;
V_273 -> V_9 = V_276 ;
V_273 -> V_277 = V_278 ;
V_273 -> V_138 = & V_2 -> V_279 ;
V_273 -> V_241 = V_240 ;
F_96 ( & V_273 -> V_199 ) ;
V_252 = F_85 ( V_273 ) ;
if ( V_252 < 0 )
