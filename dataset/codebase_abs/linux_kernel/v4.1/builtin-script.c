...
struct V_11 * V_12 , struct V_76 * V_77 )
{
struct V_63 * V_63 = V_77 -> V_63 ;
struct V_15 * V_16 = & V_12 -> V_16 ;
...
if ( V_77 . V_104 )
return 0 ;
if ( V_105 && ! F_41 ( V_62 -> V_71 , V_106 ) )
return 0 ;
V_94 -> F_27 ( V_75 , V_62 , V_12 , & V_77 ) ;
return 0 ;
}
static int F_42 ( struct V_98 * T_6 , union V_74 * V_75 ,
struct V_107 * * V_108 )
{
struct V_109 * V_110 = F_43 ( T_6 , struct V_109 , T_6 ) ;
struct V_107 * V_111 ;
struct V_11 * V_12 , * V_112 ;
int V_113 ;
V_113 = F_44 ( T_6 , V_75 , V_108 ) ;
if ( V_113 )
return V_113 ;
V_111 = * V_108 ;
V_12 = F_45 ( * V_108 ) ;
...
static int F_46 ( struct V_98 * T_6 ,
union V_74 * V_75 ,
struct V_61 * V_62 ,
struct V_99 * V_99 )
{
struct V_63 * V_63 ;
struct V_109 * T_2 = F_43 ( T_6 , struct V_109 , T_6 ) ;
struct V_19 * V_20 = T_2 -> V_20 ;
struct V_11 * V_12 = F_47 ( V_20 -> V_111 ) ;
int V_114 = - 1 ;
V_63 = F_48 ( V_99 , V_75 -> V_115 . V_69 , V_75 -> V_115 . V_70 ) ;
if ( V_63 == NULL ) {
F_7 ( L_45 ) ;
return - 1 ;
}
...
return - 1 ;
V_63 = F_48 ( V_99 , V_75 -> V_117 . V_69 , V_75 -> V_117 . V_70 ) ;
if ( V_63 == NULL ) {
F_7 ( L_46 ) ;
return - 1 ;
}
...
return - 1 ;
V_63 = F_48 ( V_99 , V_75 -> V_118 . V_69 , V_75 -> V_118 . V_70 ) ;
if ( V_63 == NULL ) {
F_7 ( L_48 ) ;
return - 1 ;
}
...
return - 1 ;
V_63 = F_48 ( V_99 , V_75 -> V_119 . V_69 , V_75 -> V_119 . V_70 ) ;
if ( V_63 == NULL ) {
F_7 ( L_49 ) ;
return - 1 ;
}
...
L_135 ) ,
F_110 ( 0 , L_136 , & V_56 . V_214 , L_137 ,
L_138 ) ,
F_110 ( 0 , L_139 , & V_56 . V_215 , L_140 ,
L_141 ) ,
F_106 ( 'I' , L_142 , & V_194 ,
L_143 ) ,
F_106 ( '\0' , L_144 , & V_56 . V_216 ,
L_145 ) ,
F_106 ( '\0' , L_146 , & T_2 . V_122 ,
L_147 ) ,
F_106 ( '\0' , L_148 , & T_2 . V_123 ,
L_149 ) ,
F_106 ( 'f' , L_150 , & V_183 . V_217 , L_151 ) ,
F_111 ()
} ;
const char * const V_218 [] = { L_152 , L_153 , NULL } ;
const char * V_219 [] = {
L_154 ,
L_155 ,
L_156 ,
...
F_34 () ;
T_3 = F_112 ( T_3 , T_4 , V_205 , V_218 , V_219 ,
V_192 ) ;
V_183 . V_148 = V_184 ;
if ( T_3 > 1 && ! strncmp ( T_4 [ 0 ] , L_159 , strlen ( L_159 ) ) ) {
V_197 = F_100 ( T_4 [ 1 ] , V_220 ) ;
if ( ! V_197 )
return F_113 ( T_3 , T_4 , NULL ) ;
}
if ( T_3 > 1 && ! strncmp ( T_4 [ 0 ] , L_160 , strlen ( L_160 ) ) ) {
...
if ( F_103 ( T_3 - V_222 , & T_4 [ V_222 ] ) != 0 ) {
V_113 = - 1 ;
goto V_58;
}
}
...
V_190 [ V_1 ++ ] = L_173 ;
V_190 [ V_1 ++ ] = L_174 ;
for ( V_7 = V_222 + 1 ; V_7 < T_3 ; V_7 ++ )
V_190 [ V_1 ++ ] = T_4 [ V_7 ] ;
V_190 [ V_1 ++ ] = NULL ;
F_119 ( L_170 , ( char * * ) V_190 ) ;
free ( V_190 ) ;
exit ( - 1 ) ;
}
F_117 ( V_221 [ 0 ] , 0 ) ;
...
return - 1 ;
if ( V_103 || V_195 ) {
F_121 ( V_20 , stdout , V_194 ) ;
if ( V_195 )
goto V_224;
}
if ( F_122 ( & V_20 -> V_103 . V_225 ) < 0 )
goto V_224;
T_2 . V_20 = V_20 ;
if ( V_105 ) {
V_113 = F_123 ( V_20 , V_105 , V_106 ) ;
if ( V_113 < 0 )
goto V_224;
}
if ( ! V_53 )
...
V_227 = F_124 ( V_183 . V_148 , V_228 ) ;
if ( V_227 < 0 ) {
V_113 = - V_229 ;
perror ( L_177 ) ;
goto V_224;
}
V_113 = F_125 ( V_227 , & V_226 ) ;
if ( V_113 < 0 ) {
perror ( L_178 ) ;
goto V_224;
}
...
V_113 = V_94 -> V_232 ( V_20 -> V_233 . V_93 ,
L_180 ) ;
goto V_224;
}
if ( V_136 ) {
V_113 = V_94 -> V_234 ( V_136 , T_3 , T_4 ) ;
if ( V_113 )
goto V_224;
F_7 ( L_181 , V_136 ) ;
V_196 = true ;
