...
const T_1 * V_4 , T_2 V_65 , T_4 V_154 )
{
struct V_1 * V_2 = V_89 -> V_90 ;
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
struct V_155 * V_156 ;
...
return;
V_156 -> type = V_169 ;
V_156 -> V_170 . V_4 = ( ( T_1 * ) V_156 ) + sizeof( * V_156 ) ;
V_156 -> V_170 . V_65 = V_65 ;
memcpy ( ( void * ) V_156 -> V_170 . V_4 , V_4 , V_65 ) ;
V_156 -> V_170 . V_125 = V_125 ;
F_65 ( & V_2 -> V_159 , V_33 ) ;
F_66 ( & V_156 -> V_160 , & V_2 -> V_161 ) ;
F_67 ( & V_2 -> V_159 , V_33 ) ;
F_68 ( V_162 , & V_6 -> V_163 ) ;
...
F_79 ( & V_120 -> V_71 ,
V_6 -> V_7 . V_173 ) ;
if ( V_172 && V_172 -> V_174 >= 0 ) {
int V_175 ;
T_5 V_176 ;
V_175 = V_172 -> V_174 ;
V_176 = V_172 -> V_15 [ V_175 ] . V_176 ;
if ( V_176 == V_177 ||
V_176 == V_178 ) {
V_120 -> V_57 = V_175 ;
V_120 -> V_55 = V_172 -> V_15 [ V_175 ] . V_55 ;
V_120 -> V_56 = V_172 -> V_15 [ V_175 ] . V_56 ;
if ( V_120 -> V_69 . V_179 == 0 )
V_120 -> V_69 . V_179 = V_176 ;
if ( V_120 -> V_69 . V_180 == 0 ) {
V_120 -> V_69 . V_180 = 1 ;
V_120 -> V_69 . V_181 [ 0 ] = V_176 ;
}
}
}
V_2 -> V_101 = V_172 ;
