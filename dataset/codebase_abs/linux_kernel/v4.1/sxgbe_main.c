...
F_11 ( & V_4 -> V_11 , F_6 ,
( unsigned long ) V_4 ) ;
V_4 -> V_11 . V_18 = F_8 ( V_1 ) ;
F_12 ( & V_4 -> V_11 ) ;
V_4 -> V_6 -> V_7 -> V_19 ( V_4 -> V_9 ,
V_2 ,
V_4 -> V_20 ) ;
F_13 ( L_1 ) ;
V_13 = true ;
...
{
if ( V_4 -> V_21 )
V_4 -> V_6 -> V_7 -> V_22 ( V_4 -> V_9 , V_4 -> V_16 -> V_23 ) ;
}
static void F_15 ( struct V_3 * V_4 )
{
T_1 V_24 = F_16 ( V_4 -> V_25 ) ;
if ( V_24 < V_26 )
V_4 -> V_27 = V_28 ;
else if ( V_24 <= V_29 )
V_4 -> V_27 = V_30 ;
...
static inline T_1 F_17 ( struct V_39 * V_40 , int V_41 )
{
return V_40 -> V_42 + V_41 - V_40 -> V_43 - 1 ;
}
static void F_18 ( struct V_44 * V_45 )
{
struct V_3 * V_4 = F_19 ( V_45 ) ;
struct V_46 * V_16 = V_4 -> V_16 ;
T_2 V_47 = 0 ;
T_2 V_48 = 0xff ;
if ( ! V_16 )
return;
if ( V_16 -> V_23 ) {
if ( V_16 -> V_48 != V_4 -> V_48 ) {
V_47 = 1 ;
switch ( V_16 -> V_48 ) {
case V_49 :
V_48 = V_50 ;
...
static int F_23 ( struct V_44 * V_58 )
{
char V_59 [ V_60 + 3 ] ;
char V_61 [ V_60 ] ;
struct V_46 * V_16 ;
struct V_3 * V_4 = F_19 ( V_58 ) ;
...
V_4 -> V_63 -> V_69 ) ;
F_24 ( V_58 , L_5 , V_70 , V_59 ) ;
V_16 = F_25 ( V_58 , V_59 , & F_18 , V_62 ) ;
if ( F_26 ( V_16 ) ) {
F_27 ( V_58 , L_6 ) ;
return F_28 ( V_16 ) ;
}
...
static int F_39 ( struct V_106 * V_45 , T_2 V_113 ,
struct V_39 * V_114 , int V_115 )
{
if ( ! V_114 ) {
F_40 ( V_45 , L_9 ) ;
return - V_103 ;
}
V_114 -> V_94 = F_41 ( V_45 ,
V_115 * sizeof( struct V_116 ) ,
& V_114 -> V_117 , V_102 ) ;
if ( ! V_114 -> V_94 )
return - V_103 ;
V_114 -> V_118 = F_42 ( V_45 , V_115 ,
sizeof( V_119 ) , V_102 ) ;
if ( ! V_114 -> V_118 )
goto V_120;
V_114 -> V_121 = F_42 ( V_45 , V_115 ,
...
return 0 ;
V_120:
F_44 ( V_45 , V_115 * sizeof( struct V_116 ) ,
V_114 -> V_94 , V_114 -> V_117 ) ;
return - V_103 ;
}
static void F_45 ( struct V_106 * V_45 , struct V_98 * V_99 ,
int V_123 )
{
F_44 ( V_45 , V_123 * sizeof( struct V_95 ) ,
V_99 -> V_88 , V_99 -> V_124 ) ;
F_46 ( V_99 -> V_105 ) ;
F_46 ( V_99 -> V_104 ) ;
}
static int F_47 ( struct V_44 * V_45 , T_2 V_113 ,
...
unsigned int V_13 = 0 ;
V_126 = F_48 ( V_45 -> V_127 + V_128 + V_129 + V_130 , 8 ) ;
F_49 ( V_4 , V_131 , V_45 , L_10 , V_70 , V_126 ) ;
if ( V_99 == NULL ) {
F_27 ( V_45 , L_11 ) ;
return - V_103 ;
}
...
struct V_95 * V_96 ;
V_96 = V_99 -> V_88 + V_125 ;
F_36 ( V_45 , V_96 , V_125 , V_126 , V_99 ) ;
}
F_46 ( V_99 -> V_104 ) ;
V_133:
F_46 ( V_99 -> V_105 ) ;
...
static void F_51 ( struct V_106 * V_45 , struct V_39 * V_114 ,
int V_115 )
{
F_44 ( V_45 , V_115 * sizeof( struct V_116 ) ,
V_114 -> V_94 , V_114 -> V_117 ) ;
}
static int F_52 ( struct V_44 * V_137 )
{
int V_138 , V_13 ;
...
static void F_54 ( struct V_39 * V_142 )
{
int V_143 ;
...
int V_138 ;
F_53 (SXGBE_TX_QUEUES, queue_num) {
struct V_39 * V_147 = V_4 -> V_93 [ V_138 ] ;
F_54 ( V_147 ) ;
}
}
...
static void F_63 ( struct V_39 * V_147 )
{
struct V_3 * V_4 = V_147 -> V_140 ;
unsigned int V_115 = V_4 -> V_81 ;
struct V_156 * V_157 ;
T_2 V_113 = V_147 -> V_113 ;
V_157 = F_64 ( V_4 -> V_45 , V_113 ) ;
F_65 ( & V_147 -> V_122 ) ;
V_4 -> V_158 . V_159 ++ ;
while ( V_147 -> V_42 != V_147 -> V_43 ) {
unsigned int V_160 = V_147 -> V_42 % V_115 ;
...
{
struct V_39 * V_114 = V_4 -> V_93 [ V_138 ] ;
struct V_156 * V_157 = F_64 ( V_4 -> V_45 ,
V_138 ) ;
F_77 ( V_157 ) ;
...
{
struct V_39 * V_96 = (struct V_39 * ) V_107 ;
F_63 ( V_96 ) ;
}
...
T_2 V_138 ;
F_53 (SXGBE_TX_QUEUES, queue_num) {
struct V_39 * V_96 = V_4 -> V_93 [ V_138 ] ;
V_96 -> V_210 = V_211 ;
V_96 -> V_212 = V_213 ;
F_11 ( & V_96 -> V_214 , F_111 ,
( unsigned long ) & V_4 -> V_93 [ V_138 ] ) ;
V_96 -> V_214 . V_18 = F_113 ( V_96 -> V_212 ) ;
F_12 ( & V_96 -> V_214 ) ;
}
}
...
F_109 ( V_4 ) ;
V_4 -> V_6 -> V_7 -> V_221 ( V_4 -> V_9 , V_45 -> V_196 , 0 ) ;
V_4 -> V_6 -> V_7 -> V_222 ( V_4 -> V_9 ) ;
F_53 (SXGBE_RX_QUEUES, queue_num) {
V_4 -> V_6 -> V_7 -> V_223 ( V_4 -> V_9 , V_138 ) ;
}
V_13 = F_118 ( V_4 -> V_106 , V_4 -> V_224 , V_225 ,
V_226 , V_45 -> V_227 , V_45 ) ;
if ( F_2 ( V_13 < 0 ) ) {
F_27 ( V_45 , L_20 ,
V_70 , V_4 -> V_224 , V_13 ) ;
goto V_220;
}
if ( V_4 -> V_228 != V_45 -> V_224 ) {
V_13 = F_118 ( V_4 -> V_106 , V_4 -> V_228 ,
V_225 ,
V_226 , V_45 -> V_227 , V_45 ) ;
if ( F_2 ( V_13 < 0 ) ) {
F_27 ( V_45 , L_21 ,
...
F_53 (SXGBE_TX_QUEUES, queue_num) {
V_13 = F_118 ( V_4 -> V_106 ,
( V_4 -> V_93 [ V_138 ] ) -> V_229 ,
V_230 , 0 ,
V_45 -> V_227 , V_4 -> V_93 [ V_138 ] ) ;
if ( F_2 ( V_13 < 0 ) ) {
F_27 ( V_45 , L_22 ,
V_70 , V_4 -> V_224 , V_13 ) ;
goto V_220;
...
static T_3 F_130 ( struct V_100 * V_101 , struct V_44 * V_45 )
{
...
struct V_3 * V_4 = F_19 ( V_45 ) ;
unsigned int V_115 = V_4 -> V_81 ;
struct V_39 * V_147 = V_4 -> V_93 [ V_255 ] ;
...
F_138 () ;
V_147 -> V_43 ++ ;
F_49 ( V_4 , V_283 , V_45 , L_26 ,
V_70 , V_147 -> V_43 % V_115 ,
V_147 -> V_42 % V_115 , V_160 ,
V_245 , V_259 ) ;
if ( F_2 ( F_17 ( V_147 , V_115 ) <= ( V_284 + 1 ) ) ) {
F_49 ( V_4 , V_6 , V_45 , L_27 ,
V_70 ) ;
F_77 ( V_157 ) ;
}
V_45 -> V_166 . V_285 += V_101 -> V_252 ;
...
{
struct V_44 * V_312 = (struct V_44 * ) V_311 ;
...
{
int V_298 ;
struct V_39 * V_93 = (struct V_39 * ) V_311 ;
...
static struct V_334 * F_156 ( struct V_44 * V_45 ,
struct V_334 * V_166 )
{
struct V_3 * V_4 = F_19 ( V_45 ) ;
...
static int F_159 ( struct V_44 * V_45 , int V_370 )
{
...
static void F_164 ( struct V_44 * V_45 )
{
struct V_3 * V_4 = F_19 ( V_45 ) ;
...
int V_380 = 1 ;
F_24 ( V_45 , L_30 ,
V_70 , F_165 ( V_45 ) , F_166 ( V_45 ) ) ;
if ( V_45 -> V_381 & V_382 ) {
V_376 = V_383 ;
} else if ( ( F_165 ( V_45 ) > V_384 ) ||
( V_45 -> V_381 & V_385 ) ) {
V_376 = V_386 ;
...
static void F_173 ( struct V_44 * V_45 )
{
struct V_3 * V_4 = F_19 ( V_45 ) ;
F_174 ( V_4 -> V_224 ) ;
V_231 ( V_4 -> V_224 , V_45 ) ;
F_175 ( V_4 -> V_224 ) ;
}
static int F_176 ( struct V_44 * V_45 , struct V_394 * V_395 , int V_396 )
{
struct V_3 * V_4 = F_19 ( V_45 ) ;
int V_13 = - V_397 ;
if ( ! F_160 ( V_45 ) )
...
if ( ! V_4 -> V_16 )
return - V_109 ;
V_13 = F_177 ( V_4 -> V_16 , V_395 , V_396 ) ;
break;
default:
break;
}
...
goto V_419;
V_58 -> V_420 = & V_421 ;
V_58 -> V_422 = V_423 | V_424 | V_425 |
V_367 | V_426 | V_427 |
V_428 ;
V_58 -> V_170 |= V_58 -> V_422 | V_429 ;
V_58 -> V_430 = F_191 ( V_431 ) ;
V_58 -> V_432 |= V_433 ;
...
F_193 ( V_58 , & V_4 -> V_242 , F_147 , 64 ) ;
F_43 ( & V_4 -> V_335 ) ;
V_4 -> V_25 = F_194 ( V_4 -> V_106 , V_441 ) ;
if ( F_26 ( V_4 -> V_25 ) ) {
F_195 ( V_58 , L_37 ,
V_70 ) ;
goto V_442;
...
int F_202 ( struct V_44 * V_58 )
{
struct V_3 * V_4 = F_19 ( V_58 ) ;
T_2 V_138 ;
F_203 ( V_58 , L_40 , V_70 ) ;
F_53 (SXGBE_RX_QUEUES, queue_num) {
...
int F_205 ( struct V_44 * V_58 )
{
return 0 ;
}
int F_206 ( struct V_44 * V_58 )
{
return 0 ;
}
int F_207 ( struct V_44 * V_58 )
{
return - V_446 ;
}
int F_208 ( struct V_44 * V_58 )
{
return - V_446 ;
}
