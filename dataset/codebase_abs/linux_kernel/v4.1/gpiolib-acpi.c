...
static unsigned int F_68 ( const union V_126 * V_127 )
{
const union V_126 * V_128 = V_127 -> V_129 . V_130 ;
const union V_126 * V_131 = V_128 + V_127 -> V_129 . V_132 ;
...
static int F_69 ( struct V_29 * V_30 , void * V_3 )
{
unsigned int * V_132 = V_3 ;
if ( V_30 -> type == V_41 )
* V_132 += V_30 -> V_3 . V_43 . V_89 ;
return 1 ;
}
int F_70 ( struct V_134 * V_4 , const char * V_135 )
{
struct V_69 * V_70 = F_71 ( V_4 ) ;
const union V_126 * V_127 ;
const struct V_71 * V_77 ;
int V_132 = - V_99 ;
int V_40 ;
char V_94 [ 32 ] ;
unsigned int V_12 ;
for ( V_12 = 0 ; V_12 < F_72 ( V_136 ) ; V_12 ++ ) {
if ( V_135 && strcmp ( V_135 , L_18 ) )
snprintf ( V_94 , sizeof( V_94 ) , L_19 ,
V_135 , V_136 [ V_12 ] ) ;
else
snprintf ( V_94 , sizeof( V_94 ) , L_20 ,
V_136 [ V_12 ] ) ;
V_40 = F_73 ( V_70 , V_94 , V_137 ,
& V_127 ) ;
if ( V_40 == 0 ) {
if ( V_127 -> type == V_133 )
V_132 = 1 ;
else if ( V_127 -> type == V_138 )
V_132 = F_68 ( V_127 ) ;
} else if ( V_70 -> V_73 ) {
for ( V_77 = V_70 -> V_73 ; V_77 -> V_74 ; V_77 ++ )
if ( strcmp ( V_94 , V_77 -> V_74 ) == 0 ) {
V_132 = V_77 -> V_78 ;
break;
}
}
