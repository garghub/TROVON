...
V_142 = F_76 ( & V_14 -> V_147 , V_127 ,
V_135 ) ;
V_133 -> V_139 = V_142 -> V_139 ;
V_133 -> V_140 = V_142 -> V_140 ;
V_144 = F_77 ( & V_14 -> V_147 , V_127 ,
V_135 ) ;
} else {
...
static int F_87 ( struct V_110 * V_110 , void * V_170 ,
struct V_82 * V_167 )
{
struct V_13 * V_14 = F_60 ( V_110 ) ;
struct V_88 * V_89 = & V_167 -> V_6 . V_93 ;
struct V_171 * V_101 = & V_89 -> V_101 [ 0 ] ;
struct V_90 * V_91 = & V_14 -> V_21 ;
const struct V_1 * V_6 = V_91 -> V_6 ;
V_101 -> V_172 = ( V_91 -> V_96 * V_6 -> V_100 [ 0 ] ) / 8 ;
V_101 -> V_102 = V_101 -> V_172 * V_91 -> V_97 ;
V_89 -> V_85 = V_6 -> V_98 ;
V_89 -> V_2 = V_6 -> V_12 ;
V_89 -> V_94 = V_91 -> V_96 ;
V_89 -> V_95 = V_91 -> V_97 ;
...
struct V_88 * V_89 ,
const struct V_1 * * V_173 )
{
T_1 V_174 = V_89 -> V_101 [ 0 ] . V_172 ;
struct V_130 * V_131 = V_14 -> V_131 ;
const struct V_1 * V_175 = V_14 -> V_20 . V_6 ;
const struct V_1 * V_6 ;
if ( F_75 ( V_175 == NULL ) )
return - V_22 ;
if ( V_175 -> V_11 & V_176 )
...
if ( ( V_174 == 0 || ( ( V_174 * 8 ) / V_6 -> V_100 [ 0 ] ) < V_89 -> V_94 ) )
V_89 -> V_101 [ 0 ] . V_172 = ( V_89 -> V_94 *
V_6 -> V_100 [ 0 ] ) / 8 ;
...
static int F_89 ( struct V_110 * V_110 , void * V_170 ,
struct V_82 * V_167 )
{
struct V_13 * V_14 = F_60 ( V_110 ) ;
...
{
struct V_177 * V_178 = & V_14 -> V_147 ;
struct V_128 V_142 , V_179 ;
struct V_180 * V_134 ;
int V_79 ;
while ( 1 ) {
V_134 = & V_178 -> V_113 . V_181 [ 0 ] ;
if ( ! ( V_134 -> V_11 & V_182 ) )
break;
if ( V_178 == & V_14 -> V_147 ) {
struct V_90 * V_183 = & V_14 -> V_21 ;
V_142 . V_129 . V_94 = V_183 -> V_96 ;
V_142 . V_129 . V_95 = V_183 -> V_97 ;
V_142 . V_129 . V_139 = V_14 -> V_20 . V_6 -> V_3 ;
} else {
V_142 . V_134 = V_134 -> V_5 ;
V_142 . V_145 = V_184 ;
V_79 = F_93 ( V_178 , V_134 , V_185 , NULL ,
& V_142 ) ;
if ( V_79 < 0 && V_79 != - V_186 )
return - V_187 ;
}
V_134 = F_94 ( V_134 ) ;
if ( V_134 == NULL ||
F_95 ( V_134 -> V_113 ) != V_188 )
break;
V_178 = F_96 ( V_134 -> V_113 ) ;
V_179 . V_134 = V_134 -> V_5 ;
V_179 . V_145 = V_184 ;
V_79 = F_93 ( V_178 , V_134 , V_185 , NULL , & V_179 ) ;
if ( V_79 < 0 && V_79 != - V_186 )
return - V_187 ;
if ( V_179 . V_129 . V_94 != V_142 . V_129 . V_94 ||
V_179 . V_129 . V_95 != V_142 . V_129 . V_95 ||
V_179 . V_129 . V_139 != V_142 . V_129 . V_139 )
return - V_187 ;
}
return 0 ;
}
...
if ( F_24 ( V_14 ) )
return - V_115 ;
V_79 = F_98 ( V_113 , & V_14 -> V_43 . V_190 -> V_191 ) ;
if ( V_79 < 0 )
return V_79 ;
V_79 = F_92 ( V_14 ) ;
if ( V_79 < 0 )
goto V_192;
V_14 -> V_18 = F_99 ( & V_14 -> V_147 . V_113 ) ;
...
struct V_13 * V_14 = F_60 ( V_110 ) ;
int V_79 ;
V_194 -> V_77 = F_104 ( T_1 , V_195 , V_194 -> V_77 ) ;
V_79 = F_105 ( V_110 , V_49 , V_194 ) ;
if ( ! V_79 )
V_14 -> V_108 = V_194 -> V_77 ;
return V_79 ;
}
static int F_106 ( struct V_143 * V_196 , struct V_143 * V_197 )
{
if ( V_196 -> V_151 < V_197 -> V_151 || V_196 -> V_153 < V_197 -> V_153 )
return 0 ;
if ( V_196 -> V_151 + V_196 -> V_94 > V_197 -> V_151 + V_197 -> V_94 )
return 0 ;
if ( V_196 -> V_153 + V_196 -> V_95 > V_197 -> V_153 + V_197 -> V_95 )
return 0 ;
return 1 ;
}
static int F_107 ( struct V_110 * V_110 , void * V_170 ,
struct V_198 * V_199 )
{
struct V_13 * V_14 = F_60 ( V_110 ) ;
...
V_199 -> V_150 . V_151 = 0 ;
V_199 -> V_150 . V_153 = 0 ;
V_199 -> V_150 . V_94 = V_167 -> V_96 ;
V_199 -> V_150 . V_95 = V_167 -> V_97 ;
return 0 ;
case V_204 :
V_199 -> V_150 = V_167 -> V_144 ;
return 0 ;
}
return - V_22 ;
}
static int F_108 ( struct V_110 * V_110 , void * V_170 ,
struct V_198 * V_199 )
{
struct V_13 * V_14 = F_60 ( V_110 ) ;
struct V_90 * V_167 = & V_14 -> V_21 ;
struct V_143 V_144 = V_199 -> V_150 ;
unsigned long V_11 ;
if ( V_199 -> type != V_200 ||
V_199 -> V_201 != V_204 )
return - V_22 ;
F_82 ( V_14 , & V_144 ) ;
if ( ( V_199 -> V_11 & V_205 ) &&
! F_106 ( & V_144 , & V_199 -> V_150 ) )
return - V_206 ;
if ( ( V_199 -> V_11 & V_207 ) &&
! F_106 ( & V_199 -> V_150 , & V_144 ) )
return - V_206 ;
V_199 -> V_150 = V_144 ;
F_5 ( & V_14 -> V_23 , V_11 ) ;
V_167 -> V_144 = V_144 ;
...
const struct V_180 * V_208 ,
const struct V_180 * V_209 , T_1 V_11 )
{
struct V_177 * V_178 = F_96 ( V_113 ) ;
struct V_13 * V_14 = F_110 ( V_178 ) ;
unsigned int V_210 = F_95 ( V_209 -> V_113 ) ;
int V_79 = 0 ;
if ( F_75 ( V_14 == NULL ) )
return 0 ;
F_78 ( 1 , V_26 , V_178 , L_6 ,
V_27 , V_209 -> V_113 -> V_169 , V_208 -> V_113 -> V_169 ,
V_11 , V_14 -> V_211 ) ;
switch ( V_208 -> V_5 ) {
case V_135 :
if ( V_210 != V_188 ) {
...
if ( V_134 != V_135 )
V_134 = V_214 ;
return F_76 ( V_178 , V_127 , V_134 ) ;
}
static int F_115 ( struct V_177 * V_178 ,
struct V_126 * V_127 ,
struct V_128 * V_6 )
{
struct V_13 * V_14 = F_110 ( V_178 ) ;
...
if ( V_6 -> V_145 == V_146 ) {
V_133 = F_114 ( V_178 , V_127 , V_6 -> V_134 ) ;
V_6 -> V_129 = * V_133 ;
return 0 ;
}
F_61 ( & V_14 -> V_114 ) ;
...
struct V_132 * V_133 = & V_6 -> V_129 ;
struct V_90 * V_141 = & V_14 -> V_20 ;
struct V_90 * V_220 = & V_14 -> V_21 ;
const struct V_1 * V_173 ;
F_78 ( 1 , V_26 , V_178 , L_8 ,
V_6 -> V_134 , V_133 -> V_139 , V_133 -> V_94 , V_133 -> V_95 ) ;
F_61 ( & V_14 -> V_114 ) ;
if ( ( F_38 ( & V_14 -> V_61 ) == V_218 &&
V_178 -> V_113 . V_221 > 0 ) ||
( F_38 ( & V_14 -> V_61 ) == V_62 &&
F_91 ( & V_14 -> V_109 ) ) ) {
F_65 ( & V_14 -> V_114 ) ;
...
V_173 = F_72 ( V_14 , V_127 , V_6 ) ;
if ( V_6 -> V_145 == V_146 ) {
struct V_132 * V_179 ;
V_133 = F_114 ( V_178 , V_127 , V_6 -> V_134 ) ;
* V_133 = V_6 -> V_129 ;
if ( V_6 -> V_134 == V_135 ) {
unsigned int V_134 = V_214 ;
V_179 = F_114 ( V_178 , V_127 , V_134 ) ;
* V_179 = * V_133 ;
}
F_65 ( & V_14 -> V_114 ) ;
return 0 ;
...
V_141 -> V_144 . V_151 = 0 ;
V_141 -> V_144 . V_153 = 0 ;
V_220 -> V_144 = V_141 -> V_144 ;
V_220 -> V_96 = V_133 -> V_94 ;
V_220 -> V_97 = V_133 -> V_95 ;
}
F_65 ( & V_14 -> V_114 ) ;
return 0 ;
}
...
struct V_13 * V_14 = F_110 ( V_178 ) ;
struct V_90 * V_167 = & V_14 -> V_20 ;
if ( ( V_199 -> V_201 != V_223 &&
V_199 -> V_201 != V_224 ) ||
V_199 -> V_134 != V_135 )
return - V_22 ;
if ( V_199 -> V_145 == V_146 ) {
V_199 -> V_150 = * F_77 ( V_178 , V_127 , V_199 -> V_134 ) ;
return 0 ;
}
F_61 ( & V_14 -> V_114 ) ;
if ( V_199 -> V_201 == V_223 ) {
...
struct V_90 * V_167 = & V_14 -> V_20 ;
int V_79 = 0 ;
if ( V_199 -> V_201 != V_223 || V_199 -> V_134 != V_135 )
return - V_22 ;
F_61 ( & V_14 -> V_114 ) ;
F_79 ( V_14 , & V_199 -> V_150 ) ;
if ( V_199 -> V_145 == V_146 ) {
* F_77 ( V_178 , V_127 , V_199 -> V_134 ) = V_199 -> V_150 ;
} else {
unsigned long V_11 ;
F_5 ( & V_14 -> V_23 , V_11 ) ;
V_167 -> V_144 = V_199 -> V_150 ;
V_14 -> V_21 . V_144 = V_199 -> V_150 ;
F_25 ( V_47 , & V_14 -> V_32 ) ;
F_14 ( & V_14 -> V_23 , V_11 ) ;
}
F_65 ( & V_14 -> V_114 ) ;
...
static int F_119 ( struct V_177 * V_178 , int V_225 )
{
struct V_13 * V_14 = F_110 ( V_178 ) ;
unsigned long V_11 ;
int V_79 ;
V_14 -> V_18 = F_99 ( & V_178 -> V_113 ) ;
if ( F_38 ( & V_14 -> V_61 ) != V_218 )
return - V_186 ;
F_61 ( & V_14 -> V_114 ) ;
if ( V_225 ) {
...
static int F_122 ( struct V_177 * V_178 )
{
struct V_13 * V_14 = F_110 ( V_178 ) ;
struct V_75 * V_76 = & V_14 -> V_109 ;
struct V_226 * V_227 = & V_14 -> V_43 . V_106 ;
int V_79 ;
memset ( V_227 , 0 , sizeof( * V_227 ) ) ;
F_111 ( & V_14 -> V_61 , V_62 ) ;
snprintf ( V_227 -> V_169 , sizeof( V_227 -> V_169 ) , L_11 ,
V_14 -> V_5 ) ;
V_227 -> V_228 = & V_229 ;
V_227 -> V_230 = & V_231 ;
V_227 -> V_232 = V_178 -> V_232 ;
V_227 -> V_233 = - 1 ;
V_227 -> V_234 = V_235 ;
V_227 -> V_236 = V_76 ;
V_14 -> V_108 = 0 ;
...
V_76 -> type = V_200 ;
V_76 -> V_237 = V_238 | V_239 ;
V_76 -> V_240 = & V_241 ;
V_76 -> V_242 = & V_243 ;
V_76 -> V_244 = sizeof( struct V_29 ) ;
V_76 -> V_78 = V_14 ;
V_76 -> V_245 = V_246 ;
...
if ( V_79 < 0 )
return V_79 ;
V_14 -> V_247 . V_11 = V_182 ;
V_79 = F_125 ( & V_227 -> V_113 , 1 , & V_14 -> V_247 , 0 ) ;
if ( V_79 < 0 )
return V_79 ;
F_126 ( V_227 , V_14 ) ;
V_14 -> V_43 . V_190 = F_4 ( V_178 ) ;
V_79 = F_127 ( V_227 , V_248 , - 1 ) ;
if ( V_79 < 0 ) {
F_128 ( & V_227 -> V_113 ) ;
V_14 -> V_43 . V_190 = NULL ;
return V_79 ;
}
F_129 ( V_178 -> V_232 , L_12 ,
V_227 -> V_169 , F_130 ( V_227 ) ) ;
return 0 ;
}
static void F_131 ( struct V_177 * V_178 )
{
struct V_13 * V_14 = F_110 ( V_178 ) ;
if ( V_14 == NULL )
return;
...
static int F_134 ( struct V_249 * V_250 )
{
struct V_13 * V_14 = F_54 ( V_250 -> V_251 , struct V_13 ,
V_252 ) ;
F_25 ( V_47 , & V_14 -> V_32 ) ;
return 0 ;
}
...
V_141 -> V_96 = V_253 ;
V_141 -> V_97 = V_254 ;
V_141 -> V_144 . V_94 = V_253 ;
V_141 -> V_144 . V_95 = V_254 ;
V_141 -> V_144 . V_151 = 0 ;
V_141 -> V_144 . V_153 = 0 ;
* V_220 = * V_141 ;
}
...
{
struct V_255 * V_251 = & V_14 -> V_252 ;
struct V_177 * V_178 = & V_14 -> V_147 ;
int V_79 ;
F_137 ( V_178 , & V_256 ) ;
V_178 -> V_11 |= V_257 ;
snprintf ( V_178 -> V_169 , sizeof( V_178 -> V_169 ) , L_13 , V_14 -> V_5 ) ;
V_14 -> V_258 [ V_135 ] . V_11 = V_182 ;
V_14 -> V_258 [ V_214 ] . V_11 = V_259 ;
V_14 -> V_258 [ V_217 ] . V_11 = V_259 ;
V_79 = F_125 ( & V_178 -> V_113 , V_260 ,
V_14 -> V_258 , 0 ) ;
if ( V_79 )
return V_79 ;
F_138 ( V_251 , 1 ) ;
V_14 -> V_24 = F_139 ( V_251 , & V_261 ,
NULL ) ;
if ( V_251 -> error ) {
F_128 ( & V_178 -> V_113 ) ;
return V_251 -> error ;
...
{
int V_79 ;
V_14 -> clock = F_150 ( & V_14 -> V_118 -> V_119 , V_267 ) ;
if ( F_145 ( V_14 -> clock ) )
...
static int F_153 ( struct V_268 * V_118 )
{
struct V_130 * V_269 = NULL ;
struct V_270 * V_119 = & V_118 -> V_119 ;
...
if ( ! V_119 -> V_275 )
return - V_276 ;
V_14 = F_154 ( V_119 , sizeof( * V_14 ) , V_277 ) ;
if ( ! V_14 )
return - V_278 ;
V_272 = F_155 ( V_279 , V_119 -> V_275 ) ;
if ( V_272 )
V_269 = (struct V_130 * ) V_272 -> V_280 ;
V_14 -> V_5 = F_156 ( V_119 -> V_275 , L_14 ) ;
if ( ! V_269 || V_14 -> V_5 >= V_269 -> V_281 ||
V_14 -> V_5 < 0 ) {
F_157 ( V_119 , L_15 ,
V_119 -> V_275 -> V_282 ) ;
return - V_22 ;
...
F_159 ( & V_14 -> V_23 ) ;
F_160 ( & V_14 -> V_114 ) ;
V_274 = F_161 ( V_118 , V_283 , 0 ) ;
V_14 -> V_284 = F_162 ( V_119 , V_274 ) ;
if ( F_145 ( V_14 -> V_284 ) )
return F_151 ( V_14 -> V_284 ) ;
V_274 = F_161 ( V_118 , V_285 , 0 ) ;
if ( V_274 == NULL ) {
F_157 ( V_119 , L_16 ) ;
return - V_19 ;
}
...
if ( V_79 )
return V_79 ;
V_79 = F_163 ( V_119 , V_274 -> V_286 , F_32 ,
0 , F_85 ( V_119 ) , V_14 ) ;
if ( V_79 ) {
...
F_165 ( V_119 ) ;
if ( ! F_166 ( V_119 ) ) {
V_79 = F_167 ( V_14 -> clock ) ;
if ( V_79 < 0 )
goto V_288;
}
V_14 -> V_103 = F_168 ( V_119 ) ;
if ( F_145 ( V_14 -> V_103 ) ) {
...
static int F_171 ( struct V_270 * V_119 )
{
struct V_13 * V_14 = F_172 ( V_119 ) ;
F_167 ( V_14 -> clock ) ;
return 0 ;
}
static int F_173 ( struct V_270 * V_119 )
{
struct V_13 * V_14 = F_172 ( V_119 ) ;
F_170 ( V_14 -> clock ) ;
return 0 ;
}
static int F_174 ( struct V_270 * V_119 )
{
struct V_13 * V_14 = F_172 ( V_119 ) ;
struct V_29 * V_30 ;
unsigned long V_11 ;
...
static int F_175 ( struct V_270 * V_119 )
{
struct V_13 * V_14 = F_172 ( V_119 ) ;
bool V_28 = F_28 ( V_117 , & V_14 -> V_32 ) ;
int V_79 ;
if ( F_44 ( V_290 , & V_14 -> V_32 ) )
return 0 ;
V_79 = F_23 ( V_14 , V_28 ) ;
if ( V_79 < 0 || ! F_24 ( V_14 ) )
return V_79 ;
...
static int F_176 ( struct V_268 * V_118 )
{
struct V_13 * V_14 = F_177 ( V_118 ) ;
struct V_270 * V_119 = & V_118 -> V_119 ;
F_178 ( V_119 ) ;
F_179 ( V_119 ) ;
F_141 ( V_14 ) ;
