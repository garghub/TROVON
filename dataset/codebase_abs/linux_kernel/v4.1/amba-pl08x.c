...
V_3 -> V_81 = F_100 ( V_232 , L_52 , V_75 ) ;
if ( ! V_3 -> V_81 ) {
F_53 ( V_3 ) ;
return - V_201 ;
}
...
static int F_112 ( struct V_247 * V_29 , const struct V_248 * V_31 )
{
struct V_23 * V_24 ;
...
int V_13 = 0 ;
int V_75 ;
V_13 = F_113 ( V_29 , NULL ) ;
if ( V_13 )
return V_13 ;
V_13 = F_114 ( & V_29 -> V_30 , F_115 ( 32 ) ) ;
if ( V_13 )
goto V_251;
...
F_116 ( V_252 , V_24 -> memcpy . V_253 ) ;
V_24 -> memcpy . V_30 = & V_29 -> V_30 ;
V_24 -> memcpy . V_254 = F_60 ;
V_24 -> memcpy . V_255 = F_79 ;
V_24 -> memcpy . V_256 = F_63 ;
V_24 -> memcpy . V_257 = F_64 ;
V_24 -> memcpy . V_258 = F_74 ;
V_24 -> memcpy . V_259 = F_89 ;
V_24 -> memcpy . V_260 = F_91 ;
V_24 -> memcpy . V_261 = F_92 ;
V_24 -> memcpy . V_262 = F_90 ;
V_24 -> memcpy . V_263 = V_264 ;
V_24 -> memcpy . V_265 = V_264 ;
V_24 -> memcpy . V_266 = F_117 ( V_267 ) ;
V_24 -> memcpy . V_268 = V_269 ;
F_116 ( V_270 , V_24 -> V_211 . V_253 ) ;
F_116 ( V_271 , V_24 -> V_211 . V_253 ) ;
V_24 -> V_211 . V_30 = & V_29 -> V_30 ;
V_24 -> V_211 . V_254 = F_60 ;
V_24 -> V_211 . V_256 = F_63 ;
V_24 -> V_211 . V_257 = F_64 ;
V_24 -> V_211 . V_258 = F_74 ;
V_24 -> V_211 . V_272 = F_84 ;
V_24 -> V_211 . V_273 = F_88 ;
V_24 -> V_211 . V_259 = F_89 ;
V_24 -> V_211 . V_260 = F_91 ;
V_24 -> V_211 . V_261 = F_92 ;
V_24 -> V_211 . V_262 = F_90 ;
V_24 -> V_211 . V_263 = V_264 ;
V_24 -> V_211 . V_265 = V_264 ;
V_24 -> V_211 . V_266 = F_117 ( V_190 ) | F_117 ( V_185 ) ;
V_24 -> V_211 . V_268 = V_269 ;
V_24 -> V_11 = F_118 ( & V_29 -> V_30 ) ;
if ( ! V_24 -> V_11 ) {
F_46 ( & V_29 -> V_30 , L_73 ) ;
V_13 = - V_212 ;
goto V_274;
...
V_24 -> V_121 = F_119 ( V_277 , & V_24 -> V_29 -> V_30 ,
V_250 , V_278 , 0 ) ;
if ( ! V_24 -> V_121 ) {
V_13 = - V_201 ;
goto V_279;
}
V_24 -> V_37 = F_120 ( V_29 -> V_280 . V_281 , F_121 ( & V_29 -> V_280 ) ) ;
if ( ! V_24 -> V_37 ) {
V_13 = - V_201 ;
goto V_282;
}
...
V_13 = F_122 ( V_29 -> V_221 [ 0 ] , F_95 , 0 , V_277 , V_24 ) ;
if ( V_13 ) {
F_46 ( & V_29 -> V_30 , L_74 ,
V_123 , V_29 -> V_221 [ 0 ] ) ;
goto V_283;
...
V_19 -> V_31 = V_75 ;
V_19 -> V_37 = V_24 -> V_37 + F_123 ( V_75 ) ;
V_19 -> V_21 = V_19 -> V_37 + V_8 -> V_285 ;
F_124 ( & V_19 -> V_78 ) ;
if ( V_8 -> V_219 ) {
T_1 V_20 ;
V_20 = F_8 ( V_19 -> V_21 ) ;
if ( V_20 & ( V_286 | V_287 ) ) {
F_102 ( & V_29 -> V_30 , L_77 , V_75 ) ;
V_19 -> V_79 = true ;
}
}
F_31 ( & V_29 -> V_30 , L_78 ,
...
F_127 ( V_29 , V_24 ) ;
F_109 ( V_24 ) ;
F_102 ( & V_24 -> V_29 -> V_30 , L_85 ,
F_128 ( V_29 ) , V_24 -> V_8 -> V_28 ? L_86 : L_10 , F_129 ( V_29 ) ,
( unsigned long long ) V_29 -> V_280 . V_281 , V_29 -> V_221 [ 0 ] ) ;
return 0 ;
V_292:
F_130 ( & V_24 -> memcpy ) ;
V_291:
...
V_143 = F_136 ( & V_217 ) ;
if ( V_143 )
F_137 (KERN_WARNING DRIVER_NAME
L_87 ,
retval) ;
return V_143 ;
}
