...
V_18 = F_33 ( V_26 , & V_26 -> V_36 , V_55 + 1 ,
V_56 |
V_57 ,
0 , & V_26 -> V_31 ) ;
if ( V_18 )
...
V_18 = F_33 ( V_26 , & V_26 -> V_36 , V_55 , V_37 , V_38 ,
& V_26 -> V_27 ) ;
if ( V_18 ) {
F_32 ( V_26 , L_3 , V_18 ) ;
F_17 ( V_26 ) ;
...
V_18 = F_34 ( V_26 -> V_27 -> V_62 , NULL , V_63 ,
...
F_37 ( V_26 -> V_27 , V_67 , 0 , 1 ) ;
F_38 ( V_26 -> V_27 , V_63 ) ;
} else
if ( V_36 -> V_52 . V_53 < V_54 ) {
F_39 ( V_26 -> V_27 , V_68 , 0 , 1 ) ;
F_38 ( V_26 -> V_27 , 0x001f0000 ) ;
}
}
V_65 = ( void * ) F_40 ( & V_26 -> V_30 ) -> V_69 ;
V_65 -> V_70 = V_71 ;
V_65 -> V_72 = V_26 -> V_27 ;
}
if ( V_18 ) {
...
if ( ! V_77 )
return - V_23 ;
V_77 -> V_79 [ 0 ] . V_21 = F_45 ( V_2 , 1 ) ;
V_77 -> V_79 [ 0 ] . V_13 = F_46 ( V_2 , 1 ) ;
V_77 -> V_80 = 1 ;
if ( F_46 ( V_2 , 2 ) ) {
V_77 -> V_79 [ V_77 -> V_80 ] . V_21 = F_45 ( V_2 , 2 ) ;
V_77 -> V_79 [ V_77 -> V_80 ] . V_13 = F_46 ( V_2 , 2 ) ;
V_77 -> V_80 ++ ;
}
if ( F_46 ( V_2 , 3 ) ) {
V_77 -> V_79 [ V_77 -> V_80 ] . V_21 = F_45 ( V_2 , 3 ) ;
V_77 -> V_79 [ V_77 -> V_80 ] . V_13 = F_46 ( V_2 , 3 ) ;
V_77 -> V_80 ++ ;
}
#ifdef F_47
...
F_104 ( V_26 , L_15 ) ;
if ( V_26 -> V_34 && F_21 ( V_26 ) -> V_117 ) {
if ( ! F_21 ( V_26 ) -> V_117 ( V_26 ) ) {
V_18 = - V_23 ;
goto V_116;
}
}
...
if ( V_26 -> V_34 && F_21 ( V_26 ) -> V_119 )
F_21 ( V_26 ) -> V_119 ( V_26 ) ;
V_116:
if ( V_11 -> V_108 . V_109 ) {
F_104 ( V_26 , L_17 ) ;
F_113 ( V_11 , V_113 ) ;
...
static int
F_140 ( struct V_10 * V_11 , struct V_138 * V_139 )
{
struct V_25 * V_26 = V_25 ( V_11 ) ;
struct V_15 * V_16 ;
...
return V_18 ;
F_141 ( V_140 , V_143 ) ;
snprintf ( V_3 , sizeof( V_3 ) , L_25 , V_140 , F_142 ( V_139 -> V_144 ) ) ;
...
V_139 -> V_147 = V_16 ;
F_143 ( & V_26 -> V_93 . V_22 ) ;
F_144 ( & V_16 -> V_148 , & V_26 -> V_95 ) ;
F_145 ( & V_26 -> V_93 . V_22 ) ;
V_145:
F_85 ( V_11 -> V_11 ) ;
F_146 ( V_11 -> V_11 ) ;
return V_18 ;
...
static void
F_147 ( struct V_10 * V_11 , struct V_138 * V_139 )
{
...
static void
F_150 ( struct V_10 * V_11 , struct V_138 * V_139 )
{
struct V_15 * V_16 = V_15 ( V_139 ) ;
F_12 ( V_16 ) ;
F_85 ( V_11 -> V_11 ) ;
...
long
F_151 ( struct V_150 * V_150 , unsigned int V_151 , unsigned long V_152 )
{
...
if ( V_18 < 0 && V_18 != - V_142 )
return V_18 ;
switch ( F_152 ( V_151 ) - V_156 ) {
case V_157 :
V_18 = F_153 ( V_153 , ( void V_158 * ) V_152 , F_154 ( V_151 ) ) ;
break;
default:
V_18 = F_155 ( V_150 , V_151 , V_152 ) ;
break;
}
F_85 ( V_11 -> V_11 ) ;
F_146 ( V_11 -> V_11 ) ;
...
V_166 = F_162 ( V_26 , L_38 , F_159 ( & V_2 -> V_11 ) ) ;
if ( V_166 < 0 )
goto V_169;
V_26 -> V_8 = V_2 ;
F_163 ( V_2 , V_26 ) ;
