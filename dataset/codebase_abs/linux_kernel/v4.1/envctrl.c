...
V_107 = 5000 ;
F_4 (KERN_INFO PFX L_29 , current->comm) ;
for (; ; ) {
F_39 ( V_107 ) ;
if ( F_40 () )
break;
...
F_4 (KERN_INFO PFX L_32 , current->comm) ;
return 0 ;
}
...
while ( V_81 ) {
if ( ! strcmp ( V_81 -> V_94 , L_33 ) ) {
V_103 [ V_116 ] . V_100 = V_124 ;
F_33 ( V_81 , & ( V_103 [ V_116 ++ ] ) ) ;
} else if ( ! strcmp ( V_81 -> V_94 , L_34 ) ) {
...
V_117 = F_43 ( & V_132 ) ;
if ( V_117 ) {
F_4 (KERN_ERR PFX L_35 ,
envctrl_dev.minor) ;
goto V_133;
}
F_4 (KERN_INFO PFX L_36 ) ;
for ( -- V_116 ; V_116 >= 0 ; -- V_116 ) {
F_4 ( L_37 ,
( V_101 == V_103 [ V_116 ] . V_100 ) ? L_34 :
( ( V_124 == V_103 [ V_116 ] . V_100 ) ? L_33 : L_38 ) ,
V_103 [ V_116 ] . V_6 , ( 0 == V_116 ) ? L_39 : L_40 ) ;
}
V_134 = F_44 ( F_38 , NULL , L_41 ) ;
if ( F_45 ( V_134 ) ) {
V_117 = F_46 ( V_134 ) ;
goto V_135;
}
