...
V_289 = V_273 * V_104 * V_217 ;
F_187 ( V_289 , 2 * V_218 * V_290 ) ;
V_288 = V_289 ;
if ( V_104 > 2 * V_218 ) {
if ( V_290 == V_217 )
return 0 ;
V_289 = V_273 * ( V_104 - 2 * V_218 ) * V_217 ;
...
if ( F_182 ( V_273 , V_274 , V_287 , V_277 , V_103 ,
V_104 , V_217 , V_218 , * V_68 ) ) {
F_76 ( L_20 ) ;
return - V_286 ;
}
if ( V_296 > ( V_299 * 2 ) ) {
...
unsigned long V_273 = F_201 ( V_6 ) ;
unsigned long V_274 = F_202 ( V_6 ) ;
...
unsigned long V_273 = F_205 ( V_61 ) ;
unsigned long V_274 = F_206 ( V_61 ) ;
...
int F_207 ( enum V_60 V_61 , const struct V_312 * V_313 ,
bool V_319 , const struct V_275 * V_287 ,
bool V_291 )
{
int V_47 ;
...
V_47 = F_204 ( V_61 , V_101 , V_313 -> V_99 , V_313 -> V_316 ,
...
int F_208 ( const struct V_324 * V_325 ,
...
int V_297 = V_287 -> V_327 ;
enum V_100 V_101 =
V_310 | V_107 ;
F_12 ( L_37
L_38 , V_325 -> V_99 , V_325 -> V_316 , V_296 ,
V_297 , V_325 -> V_103 , V_325 -> V_104 , V_325 -> V_115 , V_325 -> V_219 ,
V_325 -> V_262 ) ;
V_47 = F_204 ( V_61 , V_101 , V_325 -> V_99 , V_325 -> V_316 ,
V_325 -> V_328 , V_277 , V_317 , V_296 , V_297 , V_325 -> V_103 ,
V_325 -> V_104 , V_325 -> V_115 , V_325 -> V_219 , V_325 -> V_262 , V_105 ,
V_325 -> V_318 , V_108 , V_325 -> V_137 ,
V_319 , V_287 , V_291 ) ;
switch ( V_325 -> V_115 ) {
case V_122 :
case V_125 :
...
static void F_214 ( bool V_330 )
{
if ( ! F_14 ( V_331 ) )
return;
F_9 ( V_17 , V_330 ? 1 : 0 , 29 , 29 ) ;
}
...
void F_219 ( enum V_336 V_337 )
{
F_9 ( V_18 , V_337 , 2 , 1 ) ;
}
static void F_220 ( enum V_5 V_6 , T_2 V_338 )
{
F_1 ( F_221 ( V_6 ) , V_338 ) ;
}
static void F_222 ( enum V_5 V_339 ,
enum V_340 type ,
T_2 V_341 )
{
F_7 ( V_339 , V_342 , type ) ;
F_1 ( F_223 ( V_339 ) , V_341 ) ;
}
static void F_224 ( enum V_5 V_339 , bool V_63 )
{
F_7 ( V_339 , V_343 , V_63 ) ;
}
static void F_225 ( enum V_5 V_339 ,
bool V_63 )
{
if ( ! F_14 ( V_27 ) )
return;
...
{
F_220 ( V_6 , V_345 -> V_346 ) ;
F_222 ( V_6 , V_345 -> V_347 , V_345 -> V_341 ) ;
F_224 ( V_6 , V_345 -> V_348 ) ;
F_225 ( V_6 ,
V_345 -> V_349 ) ;
if ( F_14 ( V_37 ) ) {
F_134 ( V_6 , V_345 -> V_350 ) ;
F_135 ( V_6 , & V_345 -> V_351 ) ;
}
}
static void F_227 ( enum V_5 V_6 , T_5 V_352 )
{
int V_353 ;
switch ( V_352 ) {
case 12 :
...
static void F_228 ( enum V_355 V_337 )
{
T_2 V_248 ;
int V_356 , V_357 ;
switch ( V_337 ) {
...
V_248 = F_3 ( V_17 ) ;
V_248 = F_124 ( V_248 , V_356 , 15 , 15 ) ;
V_248 = F_124 ( V_248 , V_357 , 16 , 16 ) ;
F_1 ( V_17 , V_248 ) ;
}
...
{
F_228 ( V_363 -> V_364 ) ;
F_229 ( V_6 , V_363 -> V_365 ) ;
F_217 ( V_6 , V_363 -> V_366 ) ;
F_231 ( V_6 , & V_363 -> V_367 ) ;
F_227 ( V_6 , V_363 -> V_368 ) ;
F_214 ( V_363 -> V_369 ) ;
F_218 ( V_6 ) ;
}
static bool F_232 ( T_1 V_103 , T_1 V_104 )
{
return V_103 <= V_3 . V_52 -> V_370 &&
V_104 <= V_3 . V_52 -> V_371 ;
}
static bool F_233 ( int V_284 , int V_283 , int V_285 ,
int V_372 , int V_373 , int V_374 )
{
if ( V_284 < 1 || V_284 > V_3 . V_52 -> V_375 ||
V_283 < 1 || V_283 > V_3 . V_52 -> V_376 ||
V_285 < 1 || V_285 > V_3 . V_52 -> V_376 ||
V_372 < 1 || V_372 > V_3 . V_52 -> V_375 ||
V_373 < 0 || V_373 > V_3 . V_52 -> V_377 ||
V_374 < 0 || V_374 > V_3 . V_52 -> V_377 )
return false ;
return true ;
}
...
{
if ( F_136 ( V_6 ) )
return V_273 <= V_3 . V_52 -> V_378 ? true : false ;
else
...
const struct V_275 * V_314 )
{
if ( ! F_232 ( V_314 -> V_282 , V_314 -> V_327 ) )
return false ;
if ( ! F_234 ( V_6 , V_314 -> V_309 ) )
return false ;
if ( F_136 ( V_6 ) ) {
if ( V_314 -> V_315 )
return false ;
if ( ! F_233 ( V_314 -> V_284 , V_314 -> V_283 ,
V_314 -> V_285 , V_314 -> V_372 , V_314 -> V_373 ,
V_314 -> V_374 ) )
return false ;
}
return true ;
}
static void F_236 ( enum V_5 V_6 , int V_284 ,
int V_283 , int V_285 , int V_372 , int V_373 , int V_374 ,
enum V_380 V_381 ,
enum V_380 V_382 ,
enum V_383 V_384 ,
enum V_380 V_385 ,
enum V_383 V_386 )
{
T_2 V_387 , V_388 , V_248 ;
bool V_389 , V_390 , V_391 , V_392 , V_393 , V_394 ;
V_387 = F_92 ( V_284 - 1 , V_3 . V_52 -> V_395 , 0 ) |
F_92 ( V_283 - 1 , V_3 . V_52 -> V_396 , 8 ) |
F_92 ( V_285 - 1 , V_3 . V_52 -> V_397 , 20 ) ;
V_388 = F_92 ( V_372 - 1 , V_3 . V_52 -> V_395 , 0 ) |
F_92 ( V_373 , V_3 . V_52 -> V_396 , 8 ) |
F_92 ( V_374 , V_3 . V_52 -> V_397 , 20 ) ;
F_1 ( F_237 ( V_6 ) , V_387 ) ;
F_1 ( F_238 ( V_6 ) , V_388 ) ;
switch ( V_381 ) {
case V_398 :
...
T_2 V_403 , V_2 ;
V_403 = ( 1 << 0 ) | ( 1 << 3 ) | ( 1 << 6 ) ;
V_2 = ( V_390 << 0 ) | ( V_391 << 3 ) | ( V_389 << 6 ) ;
V_403 <<= 16 + V_109 [ V_6 ] ;
V_2 <<= 16 + V_109 [ V_6 ] ;
F_240 ( V_3 . V_402 , V_3 . V_404 ,
V_403 , V_2 ) ;
}
}
...
F_12 ( L_40 , V_6 , V_276 . V_282 , V_276 . V_327 ) ;
if ( ! F_235 ( V_6 , & V_276 ) ) {
F_121 () ;
return;
}
if ( F_136 ( V_6 ) ) {
F_236 ( V_6 , V_276 . V_284 , V_276 . V_283 , V_276 . V_285 , V_276 . V_372 ,
V_276 . V_373 , V_276 . V_374 , V_276 . V_381 , V_276 . V_382 ,
V_276 . V_384 , V_276 . V_385 , V_276 . V_386 ) ;
V_405 = V_276 . V_282 + V_276 . V_283 + V_276 . V_284 + V_276 . V_285 ;
V_406 = V_276 . V_327 + V_276 . V_373 + V_276 . V_372 + V_276 . V_374 ;
V_407 = V_314 -> V_309 / V_405 ;
V_408 = V_314 -> V_309 / V_405 / V_406 ;
F_12 ( L_41 , V_314 -> V_309 ) ;
F_12 ( L_42 ,
V_276 . V_284 , V_276 . V_283 , V_276 . V_285 , V_276 . V_372 , V_276 . V_373 , V_276 . V_374 ) ;
F_12 ( L_43 ,
V_276 . V_381 , V_276 . V_382 , V_276 . V_384 ,
V_276 . V_385 , V_276 . V_386 ) ;
F_12 ( L_44 , V_407 , V_408 ) ;
} else {
if ( V_276 . V_315 == true )
V_276 . V_327 /= 2 ;
}
F_142 ( V_6 , V_276 . V_282 , V_276 . V_327 ) ;
}
static void F_242 ( enum V_5 V_6 , T_1 V_409 ,
T_1 V_410 )
{
F_84 ( V_409 < 1 ) ;
F_84 ( V_410 < 1 ) ;
F_1 ( F_243 ( V_6 ) ,
F_92 ( V_409 , 23 , 16 ) | F_92 ( V_410 , 7 , 0 ) ) ;
if ( F_14 ( V_43 ) == false &&
V_6 == V_145 )
V_3 . V_411 = F_244 () / V_409 ;
}
static void F_245 ( enum V_5 V_6 , int * V_409 ,
int * V_410 )
{
T_2 V_248 ;
V_248 = F_3 ( F_243 ( V_6 ) ) ;
* V_409 = F_126 ( V_248 , 23 , 16 ) ;
* V_410 = F_126 ( V_248 , 7 , 0 ) ;
}
unsigned long F_244 ( void )
{
struct V_412 * V_413 ;
...
unsigned long F_201 ( enum V_5 V_6 )
{
unsigned long V_47 ;
if ( F_136 ( V_6 ) ) {
int V_420 ;
...
void F_250 ( unsigned long V_273 )
{
V_3 . V_421 = V_273 ;
}
...
static void F_251 ( struct V_422 * V_423 , enum V_5 V_6 )
{
int V_419 , V_420 ;
enum V_424 V_425 ;
F_252 ( V_423 , L_49 , V_11 [ V_6 ] . V_58 ) ;
V_425 = F_249 ( V_6 ) ;
F_252 ( V_423 , L_50 , V_11 [ V_6 ] . V_58 ,
F_253 ( V_425 ) ,
F_254 ( V_425 ) ) ;
F_245 ( V_6 , & V_419 , & V_420 ) ;
F_252 ( V_423 , L_51 ,
F_202 ( V_6 ) , V_419 ) ;
F_252 ( V_423 , L_52 ,
F_201 ( V_6 ) , V_420 ) ;
}
void F_255 ( struct V_422 * V_423 )
{
int V_419 ;
T_2 V_248 ;
enum V_424 V_426 = F_246 () ;
if ( F_61 () )
return;
F_252 ( V_423 , L_53 ) ;
F_252 ( V_423 , L_54 ,
...
static void F_256 ( struct V_422 * V_423 )
{
int V_21 , V_22 ;
const char * V_428 [] = {
[ V_145 ] = L_57 ,
...
struct V_448 * V_416 )
{
if ( V_416 -> V_409 > 255 || V_416 -> V_409 == 0 )
return - V_286 ;
if ( V_416 -> V_410 < 1 || V_416 -> V_410 > 255 )
return - V_286 ;
V_416 -> V_449 = F_244 / V_416 -> V_409 ;
V_416 -> V_450 = V_416 -> V_449 / V_416 -> V_410 ;
return 0 ;
}
bool F_260 ( unsigned long V_3 ,
unsigned long V_451 , unsigned long V_452 ,
T_9 V_453 , void * V_454 )
{
int V_455 , V_456 , V_457 ;
int V_458 , V_459 , V_460 ;
unsigned long V_450 , V_449 ;
unsigned long V_461 ;
...
V_461 = F_193 ( V_467 ) ;
V_451 = V_451 ? V_451 : 1 ;
V_452 = V_452 ? V_452 : V_468 ;
V_456 = F_185 ( F_183 ( V_3 , V_461 ) , 1ul ) ;
V_457 = F_153 ( V_3 / V_451 , 255ul ) ;
for ( V_455 = V_456 ; V_455 <= V_457 ; ++ V_455 ) {
V_449 = V_3 / V_455 ;
V_459 = F_185 ( F_183 ( V_449 , V_452 ) , V_462 ) ;
V_460 = F_153 ( V_449 / V_451 , V_463 ) ;
for ( V_458 = V_459 ; V_458 <= V_460 ; ++ V_458 ) {
V_450 = V_449 / V_458 ;
if ( F_14 ( V_43 ) )
V_465 = F_194 () ;
else
V_465 = V_449 ;
if ( V_465 < V_450 * V_464 )
continue;
if ( V_453 ( V_455 , V_458 , V_449 , V_450 , V_454 ) )
return true ;
}
}
return false ;
...
const struct V_448 * V_416 )
{
F_12 ( L_65 , V_416 -> V_449 , V_416 -> V_409 ) ;
F_12 ( L_66 , V_416 -> V_450 , V_416 -> V_410 ) ;
F_242 ( V_6 , V_416 -> V_409 , V_416 -> V_410 ) ;
}
...
unsigned long V_465 ;
V_465 = F_244 () ;
V_416 -> V_409 = F_6 ( F_243 ( V_6 ) , 23 , 16 ) ;
V_416 -> V_410 = F_6 ( F_243 ( V_6 ) , 7 , 0 ) ;
V_416 -> V_449 = V_465 / V_416 -> V_409 ;
V_416 -> V_450 = V_416 -> V_449 / V_416 -> V_410 ;
return 0 ;
}
T_2 F_264 ( void )
...
void F_266 ( T_2 V_403 )
{
T_2 V_469 = F_3 ( V_435 ) ;
F_60 ( ( V_403 ^ V_469 ) & V_403 ) ;
F_1 ( V_435 , V_403 ) ;
}
void F_267 ( void )
{
...
static int T_10 F_270 ( struct V_474 * V_48 )
{
const struct V_475 * V_476 ;
struct V_475 * V_477 ;
V_477 = F_271 ( & V_48 -> V_49 , sizeof( * V_477 ) , V_478 ) ;
if ( ! V_477 ) {
F_272 ( & V_48 -> V_49 , L_67 ) ;
return - V_479 ;
}
switch ( F_273 () ) {
case V_480 :
...
memcpy ( V_477 , V_476 , sizeof( * V_477 ) ) ;
V_3 . V_52 = V_477 ;
return 0 ;
}
static T_11 F_274 ( int V_497 , void * V_498 )
{
if ( ! V_3 . V_499 )
return V_500 ;
return V_3 . V_501 ( V_497 , V_3 . V_502 ) ;
}
int F_275 ( T_12 V_503 , void * V_504 )
{
int V_47 ;
if ( V_3 . V_501 != NULL )
return - V_505 ;
...
V_3 . V_502 = V_504 ;
F_276 () ;
V_47 = F_277 ( & V_3 . V_48 -> V_49 , V_3 . V_497 , F_274 ,
V_506 , L_68 , & V_3 ) ;
if ( V_47 ) {
V_3 . V_501 = NULL ;
V_3 . V_502 = NULL ;
...
void F_278 ( void * V_504 )
{
F_279 ( & V_3 . V_48 -> V_49 , V_3 . V_497 , & V_3 ) ;
V_3 . V_501 = NULL ;
V_3 . V_502 = NULL ;
}
static int T_10 F_280 ( struct V_474 * V_48 )
{
T_2 V_507 ;
int V_47 = 0 ;
struct V_508 * V_509 ;
struct V_510 * V_511 = V_48 -> V_49 . V_512 ;
V_3 . V_48 = V_48 ;
F_281 ( & V_3 . V_20 ) ;
V_47 = F_270 ( V_3 . V_48 ) ;
if ( V_47 )
return V_47 ;
V_509 = F_282 ( V_3 . V_48 , V_513 , 0 ) ;
if ( ! V_509 ) {
F_76 ( L_69 ) ;
return - V_286 ;
}
V_3 . V_4 = F_283 ( & V_48 -> V_49 , V_509 -> V_173 ,
F_284 ( V_509 ) ) ;
if ( ! V_3 . V_4 ) {
F_76 ( L_70 ) ;
return - V_479 ;
}
V_3 . V_497 = F_285 ( V_3 . V_48 , 0 ) ;
if ( V_3 . V_497 < 0 ) {
F_76 ( L_71 ) ;
return - V_496 ;
}
if ( V_511 && F_286 ( V_511 , L_72 ) ) {
V_3 . V_402 = F_287 ( V_511 , L_72 ) ;
if ( F_288 ( V_3 . V_402 ) ) {
F_272 ( & V_48 -> V_49 , L_73 ) ;
return F_289 ( V_3 . V_402 ) ;
}
if ( F_290 ( V_511 , L_72 , 1 ,
& V_3 . V_404 ) ) {
F_272 ( & V_48 -> V_49 , L_74 ) ;
return - V_286 ;
}
}
F_291 ( & V_48 -> V_49 ) ;
...
F_269 () ;
V_507 = F_3 ( V_431 ) ;
F_292 ( & V_48 -> V_49 , L_75 ,
F_126 ( V_507 , 7 , 4 ) , F_126 ( V_507 , 3 , 0 ) ) ;
F_64 () ;
F_293 () ;
F_294 ( L_76 , F_256 ) ;
return 0 ;
...
static int T_13 F_296 ( struct V_474 * V_48 )
{
F_295 ( & V_48 -> V_49 ) ;
F_297 () ;
return 0 ;
}
static int F_298 ( struct V_515 * V_49 )
{
V_3 . V_499 = false ;
F_276 () ;
F_299 ( V_3 . V_497 ) ;
...
static int F_300 ( struct V_515 * V_49 )
{
if ( F_6 ( V_18 , 2 , 1 ) != V_471 ) {
F_269 () ;
F_58 () ;
}
V_3 . V_499 = true ;
...
int T_10 F_301 ( void )
{
return F_302 ( & V_516 , F_280 ) ;
}
void T_13 F_303 ( void )
{
F_304 ( & V_516 ) ;
}
