...
if ( V_68 -> V_76 )
V_72 -> V_45 . V_53 = F_18 ( V_70 [ V_77 ] ) ;
if ( V_68 -> V_78 )
V_72 -> V_15 . V_53 = F_18 ( V_70 [ V_79 ] ) ;
...
V_68 -> V_80 = V_72 -> V_63 ;
if ( ( V_72 -> V_15 . V_46 &&
F_22 ( V_66 , V_79 , & V_72 -> V_15 . V_53 ) ) ||
( V_72 -> V_45 . V_46 &&
F_22 ( V_66 , V_77 , & V_72 -> V_45 . V_53 ) ) )
goto V_81;
return 0 ;
V_81:
return - V_75 ;
...
if ( F_28 ( V_83 ) )
return F_29 ( V_83 ) ;
V_28 = F_30 ( V_83 , 0 , V_86 , 0 ) ;
if ( V_28 )
goto V_87;
V_28 = F_30 ( V_83 , 0x7FFE , V_88 , 0 ) ;
if ( V_28 )
goto V_87;
V_2 -> V_11 . V_12 = V_83 ;
V_41:
