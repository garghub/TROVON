...
static int F_74 ( struct V_84 * V_55 )
{
struct V_3 * V_4 = F_75 ( V_55 ) ;
F_76 ( & V_4 -> V_2 ) ;
return 0 ;
}
static int F_77 ( const char * V_100 ,
...
int V_109 , V_110 = 0 ;
struct V_84 * V_55 ;
V_46 = F_78 ( V_100 , & V_108 ) ;
V_109 = sscanf ( V_108 , L_4 ,
& V_6 , & V_32 , & V_110 ,
& V_111 , & V_110 ) ;
...
V_55 = F_82 ( & V_115 ,
L_7 , V_111 ++ ,
V_107 , F_83 ( V_107 ) , NULL , 0 ) ;
if ( F_60 ( V_55 ) )
return F_61 ( V_55 ) ;
return 0 ;
}
static int F_84 ( struct V_100 * V_11 , void * V_116 )
{
char * V_117 = V_116 ;
unsigned int V_18 = strlen ( V_117 ) ;
struct V_84 * V_55 = F_85 ( V_11 ) ;
snprintf ( V_117 + V_18 , V_68 - V_18 , L_8 ,
...
static int F_86 ( char * V_117 , const struct V_105 * V_106 )
{
V_117 [ 0 ] = '\0' ;
F_87 ( & V_115 , V_117 ,
F_84 ) ;
...
static int F_88 ( struct V_100 * V_11 ,
void * V_116 )
{
F_89 ( F_85 ( V_11 ) ) ;
return 0 ;
