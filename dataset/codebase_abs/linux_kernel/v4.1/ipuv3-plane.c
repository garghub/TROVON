...
{
int V_40 ;
V_1 -> V_3 = F_34 ( V_1 -> V_2 , V_1 -> V_56 ) ;
if ( F_35 ( V_1 -> V_3 ) ) {
V_40 = F_36 ( V_1 -> V_3 ) ;
F_37 ( L_7 , V_40 ) ;
return V_40 ;
}
V_1 -> V_55 = F_38 ( V_1 -> V_2 , V_1 -> V_56 ) ;
if ( F_35 ( V_1 -> V_55 ) ) {
V_40 = F_36 ( V_1 -> V_55 ) ;
F_37 ( L_8 , V_40 ) ;
goto V_57;
...
static int F_51 ( struct V_58 * V_59 , struct V_28 * V_29 ,
struct V_12 * V_13 , int V_30 , int V_31 ,
unsigned int V_32 , unsigned int V_33 ,
T_1 V_34 , T_1 V_35 ,
T_1 V_36 , T_1 V_37 )
{
struct V_1 * V_1 = F_52 ( V_59 ) ;
int V_40 = 0 ;
F_8 ( L_10 , V_59 ) ;
if ( ! V_1 -> V_27 )
V_40 = F_33 ( V_1 ) ;
if ( V_40 < 0 )
return V_40 ;
V_40 = F_13 ( V_1 , V_29 , & V_29 -> V_60 , V_13 ,
V_30 , V_31 , V_32 , V_33 ,
...
struct V_1 * F_58 ( struct V_62 * V_22 , struct V_63 * V_2 ,
int V_56 , int V_50 , unsigned int V_64 ,
bool V_65 )
{
struct V_1 * V_1 ;
int V_40 ;
