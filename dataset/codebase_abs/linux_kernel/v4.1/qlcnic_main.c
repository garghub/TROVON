...
V_179 ) ;
F_102 ( V_2 ) ;
V_146 = F_97 ( V_2 , V_174 ) ;
if ( V_146 == V_180 )
V_177 = V_147 ;
else
V_177 = F_103 ( V_146 , V_2 -> V_4 -> V_27 ) ;
if ( V_177 == V_181 ) {
V_2 -> V_4 -> V_146 = V_181 ;
F_71 ( & V_2 -> V_5 -> V_30 ,
L_12 ,
...
F_71 ( & V_5 -> V_30 , L_14 , ( int ) ( V_195 >> 10 ) ) ;
V_4 -> V_137 = V_194 ;
V_4 -> V_196 = V_196 ;
...
static void F_111 ( struct V_1 * V_2 , char * V_204 )
{
struct V_23 * V_5 = V_2 -> V_5 ;
int V_131 , V_205 = 0 ;
...
V_2 -> V_215 = F_113 ( V_209 , V_210 , V_211 ) ;
V_52 = F_114 ( V_2 ) ;
if ( V_52 ) {
F_83 ( & V_5 -> V_30 , L_17 ) ;
return;
...
V_52 = F_117 ( V_2 , & V_238 , V_2 -> V_4 -> V_27 ) ;
if ( V_52 )
return V_52 ;
...
static int
F_120 ( struct V_21 * V_22 , T_5 V_263 , T_3 V_51 )
{
struct V_1 * V_2 = F_19 ( V_22 ) ;
int V_52 ;
if ( F_20 ( V_2 ) ) {
...
F_123 ( V_51 , V_2 -> V_264 ) ;
return 0 ;
}
static int
F_124 ( struct V_21 * V_22 , T_5 V_263 , T_3 V_51 )
{
struct V_1 * V_2 = F_19 ( V_22 ) ;
int V_52 ;
if ( F_20 ( V_2 ) ) {
...
goto V_294;
F_151 ( V_2 ) ;
F_152 ( V_2 , V_297 , V_298 ) ;
V_292:
V_52 = F_153 ( V_2 ) ;
if ( V_52 )
goto V_294;
F_99 ( V_2 , V_299 , V_300 ) ;
F_154 ( V_2 , 1 ) ;
V_52 = F_132 ( V_2 ) ;
if ( V_52 ) {
F_83 ( & V_2 -> V_5 -> V_30 ,
...
V_52 = F_157 ( V_303 -> V_121 , V_302 , V_41 ,
V_303 -> V_204 , V_303 ) ;
if ( V_52 )
return V_52 ;
}
...
V_52 = F_157 ( V_11 -> V_121 , V_302 , V_41 ,
V_11 -> V_204 , V_11 ) ;
if ( V_52 )
return V_52 ;
}
...
F_167 ( V_2 , V_334 , V_304 ) ;
}
F_24 ( V_22 ) ;
F_168 ( V_2 , V_22 -> V_338 ) ;
V_2 -> V_4 -> V_339 = 0 ;
if ( V_2 -> V_95 > 1 )
F_169 ( V_2 , 1 ) ;
F_162 ( V_2 ) ;
...
F_184 ( V_2 , V_345 ) ;
if ( F_20 ( V_2 ) )
F_185 ( & V_2 -> V_4 -> V_346 -> V_347 ) ;
F_23 ( V_2 ) ;
F_186 ( V_2 ) ;
V_2 -> V_41 &= ~ V_319 ;
F_187 ( V_2 ) ;
for ( V_304 = 0 ; V_304 < V_2 -> V_93 ; V_304 ++ )
F_188 ( V_2 , & V_2 -> V_11 [ V_304 ] ) ;
}
...
int F_208 ( struct V_21 * V_22 , int V_358 )
{
struct V_1 * V_2 = F_19 ( V_22 ) ;
struct V_18 * V_303 ;
struct V_333 * V_334 ;
...
static int F_222 ( struct V_23 * V_5 , int * V_369 )
{
...
V_11 -> V_402 = F_228 ( V_22 , V_304 ) ;
V_399 = F_81 ( F_229 ( V_11 ) ) ;
if ( V_399 == NULL ) {
F_226 ( V_2 ) ;
return - V_57 ;
}
memset ( V_399 , 0 , F_229 ( V_11 ) ) ;
V_11 -> V_399 = V_399 ;
F_230 ( & V_11 -> V_403 ) ;
}
if ( F_65 ( V_2 ) ||
...
if ( V_52 )
return V_52 ;
if ( ! ( F_236 ( V_5 , 0 ) & V_410 ) ) {
V_52 = - V_411 ;
goto V_412;
}
V_52 = F_222 ( V_5 , & V_369 ) ;
if ( V_52 )
goto V_412;
V_52 = F_237 ( V_5 , V_413 ) ;
if ( V_52 )
goto V_412;
F_238 ( V_5 ) ;
F_239 ( V_5 ) ;
...
F_294 ( & V_2 -> V_343 . V_459 [ V_131 ] ) ;
V_2 -> V_470 . V_463 = V_2 -> V_343 . V_463 ;
V_34 = F_66 ( V_2 -> V_470 . V_463 ,
sizeof( struct V_468 ) , V_469 ) ;
if ( ! V_34 )
return;
...
int V_473 = 0 ;
if ( F_65 ( V_2 ) )
V_245 = F_296 ( V_2 -> V_4 , V_474 ) ;
if ( F_57 ( V_2 ) )
V_245 = F_97 ( V_2 , V_475 ) ;
V_471 = F_297 ( V_245 ) ;
V_472 = F_298 ( V_245 ) ;
if ( V_471 == V_476 ) {
F_83 ( & V_22 -> V_30 ,
...
F_68 ( V_22 ,
L_68 ,
V_304 , F_302 ( V_303 -> V_485 ) ,
V_303 -> V_486 , F_302 ( V_303 -> V_487 ) ,
V_303 -> V_401 ) ;
}
for ( V_304 = 0 ; V_304 < V_2 -> V_93 ; V_304 ++ ) {
V_11 = & V_2 -> V_11 [ V_304 ] ;
...
static struct V_499 * F_308 ( struct V_21 * V_22 )
{
struct V_1 * V_2 = F_19 ( V_22 ) ;
...
{
T_1 V_512 ;
V_512 = F_302 ( V_2 -> V_126 ) ;
if ( ! ( V_512 & V_2 -> V_4 -> V_124 ) )
return V_513 ;
V_512 = F_302 ( V_2 -> V_128 ) ;
if ( ! F_311 ( V_512 ) )
return V_513 ;
...
static void
F_154 ( struct V_1 * V_2 , T_2 V_518 )
{
T_1 V_519 ;
V_519 = V_2 -> V_436 & 0xf ;
V_519 |= V_518 << 7 ;
V_519 |= ( V_426 - V_2 -> V_425 ) << 8 ;
F_99 ( V_2 , V_520 , V_519 ) ;
V_2 -> V_425 = V_426 ;
}
static int
...
if ( F_96 ( V_2 ) )
return - V_113 ;
V_519 = F_97 ( V_2 , V_523 ) ;
if ( V_46 == V_521 )
F_318 ( V_519 , V_2 -> V_436 ) ;
else if ( V_46 == V_522 )
F_319 ( V_519 , V_2 -> V_436 ) ;
F_99 ( V_2 , V_523 , V_519 ) ;
F_100 ( V_2 ) ;
return 0 ;
}
static int
...
void F_266 ( struct V_1 * V_2 , T_2 V_524 )
{
T_1 V_519 ;
if ( F_96 ( V_2 ) )
goto V_52;
V_519 = F_97 ( V_2 , V_525 ) ;
F_322 ( V_519 , V_2 -> V_436 ) ;
F_99 ( V_2 , V_525 , V_519 ) ;
if ( V_524 ) {
F_99 ( V_2 , V_299 ,
V_301 ) ;
F_71 ( & V_2 -> V_5 -> V_30 ,
...
V_535 = F_97 ( V_2 , V_299 ) ;
F_326 ( V_2 , V_537 , L_79 , V_535 ) ;
switch ( V_535 ) {
case V_526 :
F_99 ( V_2 , V_299 ,
V_538 ) ;
...
F_99 ( V_2 , V_299 ,
V_538 ) ;
F_123 ( V_529 , & V_2 -> V_46 ) ;
F_326 ( V_2 , V_547 , L_85 ) ;
F_154 ( V_2 , 0 ) ;
V_519 = F_97 ( V_2 ,
V_523 ) ;
F_318 ( V_519 , V_2 -> V_436 ) ;
...
F_189 ( V_2 , V_22 ) ;
V_512 = F_97 ( V_2 , V_550 ) ;
if ( V_512 & V_551 ) {
F_83 ( & V_2 -> V_5 -> V_30 ,
L_90 ,
V_512 ) ;
if ( F_332 ( V_512 ) == V_552 ) {
F_83 ( & V_2 -> V_5 -> V_30 ,
L_91
L_92 ) ;
F_83 ( & V_2 -> V_5 -> V_30 ,
...
F_345 ( V_2 , 0 ) ;
if ( V_566 )
F_126 ( V_568 , & V_2 -> V_46 ) ;
F_83 ( & V_2 -> V_5 -> V_30 , L_102 ) ;
V_563 = F_97 ( V_2 , V_550 ) ;
...
void F_125 ( struct V_21 * V_22 , unsigned long V_599 )
{
struct V_1 * V_2 = F_19 ( V_22 ) ;
struct V_21 * V_30 ;
T_3 V_51 ;
F_369 ( V_2 , V_22 , V_599 ) ;
F_375 () ;
F_376 (vid, adapter->vlans, VLAN_N_VID) {
V_30 = F_377 ( V_22 , F_378 ( V_606 ) , V_51 ) ;
if ( ! V_30 )
continue;
F_369 ( V_2 , V_30 , V_599 ) ;
}
F_379 () ;
}
static int F_380 ( struct V_607 * V_608 ,
unsigned long V_599 , void * V_609 )
{
struct V_1 * V_2 ;
struct V_21 * V_30 = F_381 ( V_609 ) ;
V_610:
if ( V_30 == NULL )
goto V_515;
if ( V_30 -> V_396 & V_611 ) {
...
switch ( V_599 ) {
case V_361 :
F_372 ( V_2 , V_602 -> V_603 , V_604 ) ;
break;
case V_265 :
F_372 ( V_2 , V_602 -> V_603 , V_605 ) ;
break;
default:
break;
}
...
void F_125 ( struct V_21 * V_30 , unsigned long V_599 )
{ }
static int T_16 F_385 ( void )
{
int V_26 ;
F_386 ( V_482 L_120 , V_615 ) ;
#ifdef F_387
F_388 ( & V_616 ) ;
F_389 ( & V_617 ) ;
#endif
