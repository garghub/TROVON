...
#ifdef F_29
if ( V_2 -> V_82 ) {
V_9 = F_30 ( V_2 -> V_82 , ( unsigned long * ) V_79 ) ;
if ( ! V_9 )
* V_79 /= 100 ;
} else
#endif
...
static inline struct V_34 * F_93 ( struct V_186 * V_187 )
{
if ( V_187 -> V_20 . V_178 )
return F_85 ( & V_187 -> V_20 ) ;
return F_94 ( & V_187 -> V_20 ) ;
}
static enum V_188 F_95 ( struct V_189 * V_189 , T_2 V_125 )
{
V_190 = false ;
return V_191 ;
}
static int F_96 ( struct V_186 * V_187 )
{
struct V_34 * V_10 = F_93 ( V_187 ) ;
struct V_1 * V_2 ;
int V_9 = 0 , V_8 = 0 ;
int V_148 = 0 ;
union V_3 V_4 ;
...
F_4 ( V_24 ) ;
F_101 ( & V_2 -> V_68 , F_23 ) ;
V_2 -> V_169 = F_102 ( NULL , & V_2 -> V_170 ,
& V_193 ) ;
if ( F_73 ( V_2 -> V_169 ) ) {
F_5 ( & V_187 -> V_20 , L_77 ,
V_2 -> V_170 . V_138 ) ;
...
F_35 ( & V_94 ) ;
F_103 ( & V_2 -> V_203 , & V_204 ) ;
F_37 ( & V_94 ) ;
F_104 ( & V_187 -> V_20 , true ) ;
...
static int F_113 ( struct V_151 * V_20 )
{
int V_9 = 0 ;
if ( F_114 ( V_20 ) ) {
F_47 ( V_20 , false ) ;
...
static int F_116 ( struct V_151 * V_20 )
{
struct V_1 * V_2 = F_117 ( V_20 ) ;
if ( F_115 () )
return - V_206 ;
if ( ! V_61 )
V_61 = true ;
...
static void F_119 ( struct V_151 * V_20 )
{
struct V_1 * V_2 = F_117 ( V_20 ) ;
if ( V_61 )
V_61 = false ;
...
bool V_210 = false ;
for ( V_8 = 0 ; V_2 -> V_10 -> V_19 [ V_8 ] ; V_8 ++ ) {
if ( ! strcmp ( V_6 -> V_10 -> V_138 , V_2 -> V_10 -> V_19 [ V_8 ] ) ) {
V_210 = true ;
break;
}
}
...
case V_216 :
case V_217 :
F_20 ( V_2 , V_211 ? V_211 : V_91 [ type ] ) ;
break;
default:
