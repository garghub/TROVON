...
if ( ! V_330 )
return - V_129 ;
V_4 -> V_132 = F_175 ( V_330 ) ;
V_331 = F_176 ( V_330 ) ;
if ( V_331 )
memcpy ( V_4 -> V_331 , V_331 , V_199 ) ;
F_177 ( V_330 , L_107 , & V_4 -> V_333 ) ;
F_177 ( V_330 , L_108 , & V_332 ) ;
if ( V_332 == 4 )
V_4 -> V_5 |= V_6 ;
else
V_4 -> V_5 |= V_8 ;
if ( F_178 ( V_330 , L_109 , NULL ) )
V_4 -> V_226 = V_334 ;
if ( F_178 ( V_330 , L_110 , NULL ) )
V_4 -> V_228 = V_335 ;
if ( F_178 ( V_330 , L_111 , NULL ) )
V_4 -> V_5 |= V_58 ;
if ( F_178 ( V_330 , L_112 , NULL ) )
V_4 -> V_5 |= V_60 ;
if ( F_178 ( V_330 , L_113 , NULL ) )
V_4 -> V_5 |= V_317 ;
return 0 ;
}
static inline int F_174 (
struct V_328 * V_4 ,
struct V_329 * V_330 )
{
return - V_129 ;
...
if ( ! F_183 ( V_325 -> V_327 , V_337 , V_287 ) ) {
V_339 = - V_274 ;
goto V_340;
}
...
V_29 -> V_135 = V_135 ;
V_338 = F_186 ( V_135 ) ;
V_2 -> V_7 = F_187 ( V_325 -> V_327 , V_337 ) ;
V_2 -> V_29 = V_29 ;
V_2 -> V_291 = ( ( 1 << V_342 ) - 1 ) ;
F_188 ( V_22 , V_29 ) ;
V_339 = F_33 ( V_22 ) ;
...
F_14 ( V_2 , V_230 , V_218 ) ;
F_105 ( V_29 ) ;
V_339 = F_191 ( V_29 -> V_135 , F_125 ,
V_338 | V_348 , V_29 -> V_134 , V_29 ) ;
if ( V_339 ) {
F_43 ( V_2 , V_130 ,
L_118 , V_29 -> V_135 ) ;
goto V_345;
...
V_339 = F_193 ( V_29 ) ;
if ( V_339 ) {
F_43 ( V_2 , V_130 , L_119 , V_339 ) ;
goto V_349;
} else {
F_53 ( V_2 , V_130 ,
L_120 , V_29 -> V_134 ) ;
}
V_339 = F_73 ( V_22 , V_29 ) ;
if ( V_339 ) {
F_43 ( V_2 , V_130 , L_121 , V_339 ) ;
goto V_350;
}
F_107 ( & V_2 -> V_46 ) ;
if ( F_134 ( V_29 -> V_213 ) ) {
...
memcpy ( V_29 -> V_213 , V_2 -> V_4 . V_331 , V_199 ) ;
F_53 ( V_2 , V_130 ,
L_123 ) ;
} else {
F_194 ( V_29 ) ;
...
static int F_196 ( struct V_351 * V_29 )
{
...
static int F_198 ( struct V_351 * V_29 )
{
struct V_23 * V_24 = F_197 ( V_29 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
unsigned int V_313 = 100 ;
