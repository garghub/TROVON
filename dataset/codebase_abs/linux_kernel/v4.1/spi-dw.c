...
static void F_23 ( struct V_5 * V_6 , const char * V_57 )
{
F_24 ( V_6 ) ;
F_25 ( & V_6 -> V_13 -> V_14 , L_20 , V_57 ) ;
V_6 -> V_13 -> V_58 -> V_59 = - V_60 ;
F_26 ( V_6 -> V_13 ) ;
}
static T_7 F_27 ( struct V_5 * V_6 )
{
...
static T_7 F_30 ( int V_68 , void * V_69 )
{
...
if ( V_74 -> V_84 ) {
V_78 = V_39 -> V_84 ;
if ( ( V_74 -> V_84 != V_78 ) || ! V_39 -> V_77 ) {
V_78 = V_74 -> V_84 ;
V_77 = ( V_6 -> V_85 / V_78 + 1 ) & 0xfffe ;
V_39 -> V_84 = V_78 ;
V_39 -> V_77 = V_77 ;
F_35 ( V_6 , V_39 -> V_77 ) ;
}
...
static void F_36 ( struct V_70 * V_13 ,
struct V_102 * V_57 )
{
struct V_5 * V_6 = F_13 ( V_13 ) ;
if ( V_6 -> V_80 )
...
static void F_42 ( struct V_115 * V_14 , struct V_5 * V_6 )
{
F_24 ( V_6 ) ;
if ( ! V_6 -> V_48 ) {
T_5 V_116 ;
for ( V_116 = 1 ; V_116 < 256 ; V_116 ++ ) {
F_15 ( V_6 , V_20 , V_116 ) ;
if ( V_116 != F_4 ( V_6 , V_20 ) )
break;
}
F_15 ( V_6 , V_20 , 0 ) ;
V_6 -> V_48 = ( V_116 == 1 ) ? 0 : V_116 ;
F_43 ( V_14 , L_23 , V_6 -> V_48 ) ;
}
}
int F_44 ( struct V_115 * V_14 , struct V_5 * V_6 )
{
struct V_70 * V_13 ;
int V_10 ;
F_45 ( V_6 == NULL ) ;
...
V_6 -> type = V_117 ;
V_6 -> V_118 = 0 ;
V_6 -> V_119 = ( V_120 ) ( V_6 -> V_121 + 0x60 ) ;
snprintf ( V_6 -> V_122 , sizeof( V_6 -> V_122 ) , L_24 , V_6 -> V_123 ) ;
V_10 = F_47 ( V_14 , V_6 -> V_68 , F_30 , V_124 ,
V_6 -> V_122 , V_13 ) ;
if ( V_10 < 0 ) {
F_25 ( & V_13 -> V_14 , L_25 ) ;
goto V_125;
}
V_13 -> V_126 = V_127 | V_128 | V_111 ;
V_13 -> V_129 = F_48 ( 8 ) | F_48 ( 16 ) ;
V_13 -> V_123 = V_6 -> V_123 ;
V_13 -> V_130 = V_6 -> V_131 ;
V_13 -> V_132 = F_37 ;
V_13 -> V_133 = F_41 ;
V_13 -> V_134 = F_12 ;
V_13 -> V_135 = F_33 ;
V_13 -> V_136 = F_36 ;
V_13 -> V_109 = V_6 -> V_85 ;
V_13 -> V_14 . V_137 = V_14 -> V_137 ;
F_42 ( V_14 , V_6 ) ;
if ( V_6 -> V_98 && V_6 -> V_98 -> V_138 ) {
V_10 = V_6 -> V_98 -> V_138 ( V_6 ) ;
if ( V_10 ) {
F_49 ( V_14 , L_26 ) ;
V_6 -> V_118 = 0 ;
} else {
...
{
int V_10 ;
F_42 ( & V_6 -> V_13 -> V_14 , V_6 ) ;
V_10 = F_57 ( V_6 -> V_13 ) ;
if ( V_10 )
F_25 ( & V_6 -> V_13 -> V_14 , L_28 , V_10 ) ;
return V_10 ;
}
