...
void F_78 ( struct V_4 * V_5 , struct V_1 * V_2 , int V_85 )
{
F_80 ( V_5 , V_2 ) ;
F_72 ( V_5 , V_2 ) ;
V_2 -> V_5 = V_5 ;
...
static T_4
F_93 ( struct V_26 * V_22 , struct V_106 * V_107 , char * V_108 )
{
struct V_109 * V_54 = F_94 ( V_107 ) ;
struct V_6 * V_7 ;
T_4 error ;
if ( ! V_54 -> V_110 )
return - V_111 ;
...
static T_4
F_95 ( struct V_26 * V_22 , struct V_106 * V_107 ,
...
struct V_6 * V_7 = V_5 -> V_8 ;
int error ;
error = F_97 ( & V_7 -> V_22 , & V_5 -> V_22 , L_9 , L_10 ) ;
if ( ! error ) {
struct V_109 * V_107 = V_7 -> type -> V_115 ;
if ( V_107 ) {
while ( V_107 -> V_107 . V_12 ) {
if ( F_98 ( & V_7 -> V_22 , & V_107 -> V_107 ) )
break;
V_107 ++ ;
}
}
...
int F_102 ( struct V_11 * V_7 )
{
char * V_119 = L_11 ;
if ( V_7 -> V_120 ) {
if ( F_103 ( V_7 -> V_120 < sizeof( struct V_121 ) ) ||
F_103 ( V_7 -> V_122 < F_104 ( struct V_121 ) ) )
return - V_32 ;
snprintf ( V_7 -> V_123 , sizeof( V_7 -> V_123 ) ,
L_12 , V_7 -> V_13 ) ;
V_7 -> V_124 = F_105 ( V_7 -> V_123 , V_7 -> V_120 ,
V_7 -> V_122 , 0 , NULL ) ;
if ( ! V_7 -> V_124 )
return - V_125 ;
}
...
static int F_110 ( struct V_4 * V_5 , struct V_11 * V_130 )
{
...
static int F_117 ( struct V_4 * V_5 , const char * V_12 )
{
char V_13 [ V_134 ] ;
struct V_11 * V_7 ;
if ( ! V_5 -> V_8 )
return - V_135 ;
F_118 ( V_13 , V_12 , sizeof( V_13 ) ) ;
V_7 = F_8 ( F_119 ( V_13 ) , true ) ;
if ( ! V_7 ) {
F_27 ( V_33 L_16 , V_13 ) ;
return - V_32 ;
}
...
T_4 F_121 ( struct V_4 * V_5 , const char * V_12 ,
T_5 V_136 )
{
int V_63 ;
if ( ! V_5 -> V_8 )
...
T_4 F_122 ( struct V_4 * V_5 , char * V_12 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
struct V_11 * V_137 ;
struct V_11 * V_138 ;
int V_139 = 0 ;
if ( ! V_5 -> V_8 || ! F_123 ( V_5 ) )
...
struct V_1 * F_124 ( struct V_4 * V_5 ,
struct V_1 * V_2 )
{
struct V_44 * V_140 = F_125 ( & V_2 -> V_44 ) ;
if ( V_140 )
return F_126 ( V_140 ) ;
return NULL ;
}
struct V_1 * F_127 ( struct V_4 * V_5 ,
struct V_1 * V_2 )
{
struct V_44 * V_141 = F_128 ( & V_2 -> V_44 ) ;
if ( V_141 )
return F_126 ( V_141 ) ;
return NULL ;
}
