...
static int F_105 ( struct V_81 * V_36 , T_4 V_249 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_44 * V_45 = F_20 ( V_3 -> V_12 ) ;
...
if ( F_42 ( V_3 , V_36 , & V_3 -> V_12 -> V_258 [ V_256 ] ) < 0 ) {
F_33 ( V_45 , L_39 ) ;
V_10 = - V_186 ;
goto V_247;
}
...
switch ( V_290 ) {
case V_299 :
V_10 = F_121 ( V_45 , V_27 , V_127 , V_292 ) ;
if ( V_10 >= 0 ) {
V_292 -> V_300 = V_10 ;
V_292 -> V_88 |= V_301 ;
