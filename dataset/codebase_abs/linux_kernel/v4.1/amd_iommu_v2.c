...
static void F_30 ( struct V_15 * * V_32 )
{
int V_33 ;
for ( V_33 = 0 ; V_33 < 512 ; ++ V_33 ) {
if ( V_32 [ V_33 ] == NULL )
continue;
F_31 ( ( unsigned long ) V_32 [ V_33 ] ) ;
}
}
static void F_32 ( struct V_15 * * V_32 )
{
struct V_15 * * V_19 ;
int V_33 ;
for ( V_33 = 0 ; V_33 < 512 ; ++ V_33 ) {
...
F_35 () ;
F_31 ( ( unsigned long ) V_8 -> V_23 ) ;
}
static struct V_15 * F_36 ( struct V_37 * V_35 )
{
return F_37 ( V_35 , struct V_15 , V_35 ) ;
}
static void F_38 ( struct V_37 * V_35 ,
unsigned long V_38 )
{
struct V_15 * V_15 ;
struct V_7 * V_8 ;
V_15 = F_36 ( V_35 ) ;
V_8 = V_15 -> V_7 ;
F_39 ( V_8 -> V_12 , V_15 -> V_16 , V_38 ) ;
}
static int F_40 ( struct V_37 * V_35 ,
struct V_39 * V_36 ,
unsigned long V_40 ,
unsigned long V_41 )
{
...
static void F_42 ( struct V_37 * V_35 ,
struct V_39 * V_36 ,
...
V_8 = V_15 -> V_7 ;
if ( ( V_40 ^ ( V_41 - 1 ) ) < V_42 )
F_39 ( V_8 -> V_12 , V_15 -> V_16 ,
V_40 ) ;
else
F_43 ( V_8 -> V_12 , V_15 -> V_16 ) ;
}
static void F_44 ( struct V_37 * V_35 , struct V_39 * V_36 )
{
struct V_15 * V_15 ;
struct V_7 * V_8 ;
bool V_43 ;
...
static void F_46 ( struct V_15 * V_15 ,
T_1 V_45 , int V_46 )
{
unsigned long V_9 ;
F_5 ( & V_15 -> V_26 , V_9 ) ;
...
static void F_49 ( struct V_51 * V_51 )
{
int V_46 ;
if ( ! V_51 -> V_8 -> V_52 ) {
F_46 ( V_51 -> V_53 , V_51 -> V_45 , V_54 ) ;
return;
}
...
switch ( V_46 ) {
case V_55 :
F_46 ( V_51 -> V_53 , V_51 -> V_45 , V_50 ) ;
break;
case V_56 :
F_46 ( V_51 -> V_53 , V_51 -> V_45 , V_54 ) ;
break;
case V_57 :
F_46 ( V_51 -> V_53 , V_51 -> V_45 , V_58 ) ;
break;
default:
F_35 () ;
}
...
{
struct V_51 * V_51 = F_37 ( V_60 , struct V_51 , V_60 ) ;
struct V_39 * V_36 ;
struct V_61 * V_62 ;
T_2 V_38 ;
int V_25 , V_63 ;
...
F_53 ( & V_36 -> V_65 ) ;
V_67:
F_47 ( V_51 -> V_8 , V_51 -> V_53 , V_51 -> V_45 ) ;
F_21 ( V_51 -> V_53 ) ;
F_11 ( V_51 ) ;
}
static int F_55 ( struct V_69 * V_70 , unsigned long V_71 , void * V_72 )
{
struct V_73 * V_74 ;
struct V_15 * V_15 ;
struct V_7 * V_8 ;
...
int F_59 ( struct V_1 * V_2 , int V_16 ,
struct V_78 * V_79 )
{
struct V_15 * V_15 ;
struct V_7 * V_8 ;
...
void F_69 ( struct V_1 * V_2 , int V_16 )
{
struct V_15 * V_15 ;
struct V_7 * V_8 ;
T_1 V_3 ;
...
int F_70 ( struct V_1 * V_2 , int V_89 )
{
struct V_7 * V_8 ;
unsigned long V_9 ;
int V_25 , V_90 ;
...
goto V_94;
F_72 ( V_8 -> V_12 ) ;
V_25 = F_73 ( V_8 -> V_12 , V_89 ) ;
if ( V_25 )
goto V_95;
V_25 = F_74 ( V_8 -> V_12 , & V_2 -> V_13 ) ;
if ( V_25 != 0 )
goto V_95;
F_5 ( & V_10 , V_9 ) ;
if ( F_2 ( V_3 ) != NULL ) {
