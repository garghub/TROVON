...
unsigned short V_33 , char V_47 ,
T_3 V_48 , int V_38 , union V_49 * V_50 )
{
unsigned long V_30 = ( unsigned long ) V_26 -> V_31 ;
struct V_16 V_17 ;
T_3 V_51 [ 2 ] ;
...
case V_57 :
if ( ! V_47 ) {
V_51 [ 0 ] = V_50 -> V_58 & 0xff ;
V_51 [ 1 ] = ( V_50 -> V_58 >> 8 ) & 0xff ;
}
V_17 . V_40 = F_11 ( F_12 ( V_51 ) ) ;
V_17 . V_38 = F_10 ( 2 ) ;
V_17 . V_45 = F_10 ( V_48 ) ;
V_17 . V_44 = 1 ;
V_17 . type = ( V_47 == V_55 ) ?
...
break;
case V_59 :
V_17 . V_40 = F_11 ( F_12 ( & V_50 -> V_60 [ 1 ] ) ) ;
V_17 . V_38 = F_10 ( V_50 -> V_60 [ 0 ] ) ;
V_17 . V_45 = F_10 ( V_48 ) ;
V_17 . V_44 = 1 ;
V_17 . type = ( V_47 == V_55 ) ?
V_42 : V_43 ;
...
V_1 = F_2 ( V_30 , & V_17 ) ;
if ( ! V_1 && V_47 && V_38 == V_57 ) {
V_50 -> V_58 = ( ( T_2 ) V_51 [ 1 ] ) << 8 ;
V_50 -> V_58 |= V_51 [ 0 ] ;
}
return V_1 ;
}
...
V_61 -> V_77 = & V_78 ;
V_61 -> V_71 . V_79 = & V_69 -> V_71 ;
V_61 -> V_71 . V_72 = F_19 ( V_69 -> V_71 . V_72 ) ;
V_70 = F_20 ( V_69 -> V_71 . V_72 , L_4 , NULL ) ;
if ( V_70 )
F_21 ( V_61 -> V_80 , V_70 , sizeof( V_61 -> V_80 ) ) ;
else
F_21 ( V_61 -> V_80 , L_5 , sizeof( V_61 -> V_80 ) ) ;
F_22 ( V_69 , V_61 ) ;
V_1 = F_23 ( V_61 ) ;
if ( V_1 )
F_17 ( & V_69 -> V_71 , L_6 ) ;
