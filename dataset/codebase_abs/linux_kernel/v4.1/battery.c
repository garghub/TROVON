...
return - V_24 ;
F_14 ( & V_2 -> V_98 ) ;
V_4 = F_24 ( V_2 -> V_3 -> V_99 , L_15 ,
V_2 -> V_55 ) ;
F_16 ( & V_2 -> V_98 ) ;
if ( F_17 ( V_4 ) )
return - V_24 ;
F_25 ( ( V_111 , L_16 , V_2 -> V_55 ) ) ;
return 0 ;
}
static int F_26 ( struct V_1 * V_2 )
{
if ( ! F_27 ( V_2 -> V_3 -> V_99 , L_15 ) ) {
F_28 ( V_53 , & V_2 -> V_54 ) ;
return 0 ;
}
F_29 ( V_53 , & V_2 -> V_54 ) ;
...
return sprintf ( V_115 , L_17 , V_2 -> V_55 * 1000 ) ;
}
...
V_2 -> V_119 . V_93 = F_34 ( V_2 -> V_3 ) ;
V_2 -> V_119 . type = V_124 ;
V_2 -> V_119 . V_125 = F_4 ;
V_2 -> V_126 = F_35 ( & V_2 -> V_3 -> V_112 ,
& V_2 -> V_119 , & V_117 ) ;
if ( F_36 ( V_2 -> V_126 ) ) {
int V_92 = F_37 ( V_2 -> V_126 ) ;
V_2 -> V_126 = NULL ;
return V_92 ;
}
return F_38 ( & V_2 -> V_126 -> V_112 , & V_127 ) ;
}
...
F_40 ( & V_2 -> V_126 -> V_112 , & V_127 ) ;
F_41 ( V_2 -> V_126 ) ;
V_2 -> V_126 = NULL ;
F_16 ( & V_2 -> V_128 ) ;
}
static void F_42 ( const struct V_129 * V_130 , void * V_131 )
{
struct V_1 * V_2 = (struct V_1 * ) V_131 ;
if ( V_130 -> type == V_132 && V_130 -> V_133 >= 8 ) {
const T_1 * V_134 = ( const T_1 * ) ( V_130 + 1 ) ;
int V_135 = F_43 ( ( const V_136 * ) ( V_134 + 6 ) ) ;
if ( V_130 -> V_133 >= 18 )
V_135 *= V_134 [ 17 ] ;
...
if ( F_7 ( V_104 , & V_2 -> V_54 ) )
return;
if ( V_2 -> V_67 && F_45 ( L_19 ) ) {
const char * V_137 ;
V_137 = F_46 ( V_138 ) ;
if ( V_137 && ! strncasecmp ( V_137 , L_20 , 8 ) ) {
F_47 ( F_42 , V_2 ) ;
if ( F_7 ( V_104 ,
& V_2 -> V_54 ) &&
V_2 -> V_37 ) {
...
static int F_48 ( struct V_1 * V_2 , bool V_139 )
{
int V_92 , V_140 = F_1 ( V_2 ) ;
V_92 = F_10 ( V_2 ) ;
if ( V_92 )
return V_92 ;
if ( ! F_1 ( V_2 ) ) {
...
static int F_51 ( struct V_141 * V_142 , int V_92 )
{
...
static int F_53 ( struct V_141 * V_142 , int V_92 )
{
struct V_1 * V_2 = V_142 -> V_131 ;
if ( V_92 )
goto V_143;
...
static int F_54 ( struct V_141 * V_142 , int V_92 )
{
struct V_1 * V_2 = V_142 -> V_131 ;
if ( V_92 )
goto V_143;
...
if ( ! V_2 || ( V_78 > sizeof( V_150 ) - 1 ) )
return - V_66 ;
if ( ! F_1 ( V_2 ) ) {
V_92 = - V_24 ;
goto V_143;
}
if ( F_56 ( V_150 , V_96 , V_78 ) ) {
V_92 = - V_77 ;
goto V_143;
}
V_150 [ V_78 ] = '\0' ;
...
{
struct V_1 * V_2 = V_142 -> V_131 ;
int V_92 = F_48 ( V_2 , false ) ;
return V_154 [ V_153 ] ( V_142 , V_92 ) ;
}
...
L_63 ) ;
if ( ! F_61 ( V_3 ) ) {
F_61 ( V_3 ) = F_62 ( F_34 ( V_3 ) ,
V_158 ) ;
if ( ! F_61 ( V_3 ) )
return - V_24 ;
}
for ( V_74 = 0 ; V_74 < V_159 ; ++ V_74 ) {
V_157 = F_63 ( V_160 [ V_74 ] . V_93 ,
V_160 [ V_74 ] . V_80 ,
F_61 ( V_3 ) ,
& V_160 [ V_74 ] . V_161 ,
F_64 ( V_3 ) ) ;
...
static int F_75 ( const struct V_174 * V_175 )
{
V_100 = 1 ;
return 0 ;
}
static int F_76 ( const struct V_174 * V_175 )
{
V_164 = 1000 ;
return 0 ;
}
