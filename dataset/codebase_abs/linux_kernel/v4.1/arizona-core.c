...
V_93 = 0 ;
F_44 (arizona->dev->of_node, L_62 , prop,
cur, val) {
if ( V_93 == F_43 ( V_1 -> V_5 . V_97 ) )
break;
V_1 -> V_5 . V_97 [ V_93 ] = V_16 ;
V_93 ++ ;
}
return 0 ;
}
...
case V_100 :
case V_101 :
for ( V_56 = 0 ; V_56 < F_43 ( V_102 ) ; V_56 ++ )
V_1 -> V_103 [ V_56 ] . V_104
= V_102 [ V_56 ] ;
V_1 -> V_105 = F_43 ( V_102 ) ;
break;
default:
F_10 ( V_1 -> V_8 , L_63 ,
V_1 -> type ) ;
...
V_1 -> V_80 = true ;
V_2 = F_50 ( V_1 -> V_8 , - 1 , V_107 ,
F_43 ( V_107 ) , NULL , 0 , NULL ) ;
if ( V_2 != 0 ) {
F_10 ( V_8 , L_64 , V_2 ) ;
return V_2 ;
}
V_2 = F_51 ( V_8 , V_1 -> V_105 ,
V_1 -> V_103 ) ;
if ( V_2 != 0 ) {
F_10 ( V_8 , L_65 ,
V_2 ) ;
...
break;
default:
F_10 ( V_1 -> V_8 , L_72 , V_53 ) ;
goto V_114;
}
if ( ! V_1 -> V_5 . V_94 ) {
F_30 ( V_1 -> V_10 ) ;
V_2 = F_18 ( V_1 -> V_10 , V_113 , 0 ) ;
if ( V_2 != 0 ) {
F_10 ( V_8 , L_73 , V_2 ) ;
goto V_114;
}
...
#endif
default:
F_10 ( V_1 -> V_8 , L_85 , V_53 ) ;
goto V_114;
}
F_61 ( V_8 , L_86 , V_98 , V_1 -> V_117 + 'A' ) ;
if ( F_46 ) {
V_2 = F_46 ( V_1 ) ;
if ( V_2 != 0 ) {
F_10 ( V_1 -> V_8 , L_48 ,
...
if ( ! V_1 -> V_5 . V_126 [ V_56 ] . V_127 &&
! V_1 -> V_5 . V_126 [ V_56 ] . V_128 )
continue;
if ( ! V_1 -> V_5 . V_126 [ V_56 ] . V_127 )
V_1 -> V_5 . V_126 [ V_56 ] . V_127 = 2800 ;
V_16 = ( V_1 -> V_5 . V_126 [ V_56 ] . V_127 - 1500 ) / 100 ;
V_16 <<= V_129 ;
if ( V_1 -> V_5 . V_126 [ V_56 ] . V_130 )
V_16 |= V_131 ;
if ( V_1 -> V_5 . V_126 [ V_56 ] . V_132 )
V_16 |= V_133 ;
if ( V_1 -> V_5 . V_126 [ V_56 ] . V_134 )
V_16 |= V_135 ;
if ( V_1 -> V_5 . V_126 [ V_56 ] . V_128 )
V_16 |= V_136 ;
F_4 ( V_1 -> V_10 ,
V_137 + V_56 ,
V_138 |
...
V_16 = V_1 -> V_5 . V_97 [ V_56 ]
<< V_140 ;
V_16 |= V_1 -> V_5 . V_96 [ V_56 ] << V_141 ;
F_4 ( V_1 -> V_10 ,
V_142 + ( V_56 * 8 ) ,
V_143 |
V_144 , V_16 ) ;
}
for ( V_56 = 0 ; V_56 < V_145 ; V_56 ++ ) {
if ( V_1 -> V_5 . V_146 [ V_56 ] )
V_16 = V_147 ;
else
V_16 = 0 ;
F_4 ( V_1 -> V_10 ,
...
if ( V_1 -> V_5 . V_150 [ V_56 ] )
F_4 ( V_1 -> V_10 ,
V_151 + ( V_56 * 2 ) ,
V_152 |
V_153 ,
V_1 -> V_5 . V_150 [ V_56 ] ) ;
if ( V_1 -> V_5 . V_154 [ V_56 ] )
F_4 ( V_1 -> V_10 ,
V_155 + ( V_56 * 2 ) ,
V_156 ,
V_1 -> V_5 . V_154 [ V_56 ] ) ;
...
break;
case V_101 :
V_2 = F_50 ( V_1 -> V_8 , - 1 , V_162 ,
F_43 ( V_162 ) , NULL , 0 , NULL ) ;
break;
}
if ( V_2 != 0 ) {
F_10 ( V_1 -> V_8 , L_91 , V_2 ) ;
goto V_163;
}
#ifdef F_67
F_28 ( V_1 -> V_78 ) ;
