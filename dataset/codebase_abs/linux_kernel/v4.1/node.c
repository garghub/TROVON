...
static int F_39 ( unsigned long V_74 )
{
struct V_75 * V_75 ;
if ( ! F_40 ( V_74 ) )
return - 1 ;
...
int F_44 ( struct V_76 * V_77 , int V_15 )
{
int V_70 ;
...
if ( V_84 != V_15 )
continue;
V_70 = F_46 ( & V_72 [ V_15 ] -> V_2 . V_73 ,
& V_77 -> V_2 . V_73 ,
F_36 ( & V_77 -> V_2 . V_73 ) ) ;
if ( V_70 )
return V_70 ;
return F_46 ( & V_77 -> V_2 . V_73 ,
& V_72 [ V_15 ] -> V_2 . V_73 ,
F_36 ( & V_72 [ V_15 ] -> V_2 . V_73 ) ) ;
}
return 0 ;
}
int F_47 ( struct V_76 * V_77 ,
unsigned long V_85 )
{
F_48 ( V_86 , V_87 , V_88 ) ;
unsigned long V_74 , V_78 , V_79 ;
...
static int F_52 ( int V_15 )
{
unsigned long V_90 = F_53 ( V_15 ) -> V_91 ;
unsigned long V_92 = V_90 + F_53 ( V_15 ) -> V_93 ;
unsigned long V_74 ;
struct V_76 * V_77 = NULL ;
int V_94 = 0 ;
for ( V_74 = V_90 ; V_74 < V_92 ; V_74 += V_83 ) {
unsigned long V_95 = F_54 ( V_74 ) ;
struct V_96 * V_97 ;
int V_70 ;
if ( ! F_55 ( V_95 ) )
continue;
...
{
struct V_5 * V_5 = F_60 ( V_99 , struct V_5 , V_61 ) ;
if ( ! F_19 ( V_5 ) )
F_21 ( V_5 ) ;
}
static void F_61 ( int V_15 )
{
F_62 ( & V_72 [ V_15 ] -> V_61 , F_59 ) ;
}
...
static int F_52 ( int V_15 ) { return 0 ; }
static inline int F_63 ( struct V_100 * V_101 ,
unsigned long V_102 , void * V_103 )
{
return V_114 ;
}
...
if ( V_115 != V_15 )
V_63 = V_72 [ V_115 ] ;
V_72 [ V_15 ] = F_67 ( sizeof( struct V_5 ) , V_88 ) ;
if ( ! V_72 [ V_15 ] )
return - V_89 ;
...
static T_1 F_71 ( enum V_116 V_117 , char * V_4 )
{
int V_14 ;
V_14 = F_72 ( V_4 , V_11 - 1 , L_42 ,
F_73 ( & V_116 [ V_117 ] ) ) ;
V_4 [ V_14 ++ ] = '\n' ;
V_4 [ V_14 ] = '\0' ;
return V_14 ;
...
struct V_12 * V_13 , char * V_4 )
{
struct V_118 * V_119 = F_60 ( V_13 , struct V_118 , V_13 ) ;
return F_71 ( V_119 -> V_117 , V_4 ) ;
}
static int T_3 F_75 ( void )
{
int V_70 ;
F_4 ( F_76 ( V_120 ) != V_121 ) ;
F_4 ( F_76 ( V_122 ) - 1 != V_121 ) ;
V_70 = F_77 ( & V_65 , V_123 ) ;
if ( ! V_70 ) {
static struct V_100 V_124 = {
. V_125 = F_63 ,
. V_126 = V_127 ,
} ;
F_78 ( & V_124 ) ;
