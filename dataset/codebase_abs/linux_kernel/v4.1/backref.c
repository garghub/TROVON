...
int F_98 ( struct V_44 * V_45 , T_1 V_148 ,
...
char * F_102 ( struct V_44 * V_155 , struct V_46 * V_47 ,
...
int F_110 ( struct V_56 * V_57 , T_1 V_168 ,
...
V_2 . V_18 = V_168 ;
V_2 . V_10 = ( T_1 ) - 1 ;
V_25 = F_99 ( NULL , V_57 -> V_138 , & V_2 , V_47 , 0 , 0 ) ;
if ( V_25 < 0 )
return V_25 ;
V_25 = F_112 ( V_57 -> V_138 , V_47 , 0 ) ;
if ( V_25 ) {
if ( V_25 > 0 )
V_25 = - V_76 ;
return V_25 ;
...
static int F_113 ( unsigned long * V_120 , struct V_3 * V_4 ,
struct V_1 * V_2 ,
...
int F_114 ( unsigned long * V_120 , struct V_3 * V_4 ,
...
return 1 ;
while ( 1 ) {
V_25 = F_113 ( V_120 , V_4 , V_2 , V_123 , V_125 ,
& V_176 , & type ) ;
if ( V_25 < 0 )
return V_25 ;
if ( type == V_109 ||
...
struct V_146 V_182 = F_95 ( V_182 ) ;
struct V_73 V_183 ;
struct V_73 V_184 ;
F_37 ( L_10 ,
V_177 ) ;
if ( ! V_64 ) {
V_141 = F_117 ( V_57 -> V_138 ) ;
if ( F_31 ( V_141 ) )
return F_33 ( V_141 ) ;
F_96 ( V_57 , & V_182 ) ;
} else {
...
if ( ! V_64 ) {
F_97 ( V_57 , & V_182 ) ;
F_118 ( V_141 , V_57 -> V_138 ) ;
} else {
F_93 ( & V_57 -> V_145 ) ;
}
return V_25 ;
}
int F_119 ( T_1 V_168 , struct V_56 * V_57 ,
struct V_46 * V_47 ,
T_7 * V_178 , void * V_179 )
{
int V_25 ;
...
struct V_1 V_119 ;
int V_64 = V_47 -> V_64 ;
V_25 = F_110 ( V_57 , V_168 , V_47 , & V_119 , & V_124 ) ;
F_39 ( V_47 ) ;
if ( V_25 < 0 )
return V_25 ;
if ( V_124 & V_127 )
...
V_25 = F_116 ( V_57 , V_119 . V_18 ,
V_7 , V_64 ,
V_178 , V_179 ) ;
return V_25 ;
}
static int F_120 ( T_1 V_17 , struct V_44 * V_155 ,
struct V_46 * V_47 ,
...
V_190 = F_123 ( V_22 ) ;
V_133 = F_13 ( V_4 , V_22 , struct V_164 ) ;
for ( V_186 = 0 ; V_186 < F_124 ( V_4 , V_190 ) ; V_186 += V_187 ) {
V_156 = F_108 ( V_4 , V_133 ) ;
F_37 ( L_13
...
static int F_125 ( T_1 V_17 , struct V_44 * V_155 ,
struct V_46 * V_47 ,
T_8 * V_178 , void * V_179 )
{
int V_25 ;
...
unsigned long V_120 ;
while ( 1 ) {
V_25 = F_98 ( V_155 , V_17 , V_10 , V_47 , & V_153 ,
& V_10 ) ;
if ( V_25 < 0 )
break;
if ( V_25 ) {
...
V_118 = V_47 -> V_53 [ 0 ] ;
V_125 = F_72 ( V_118 , V_22 ) ;
V_120 = F_101 ( V_118 , V_22 ) ;
V_191 = 0 ;
while ( V_191 < V_125 ) {
T_4 V_156 ;
V_153 = (struct V_150 * ) ( V_120 + V_191 ) ;
V_36 = F_126 ( V_4 , V_153 ) ;
V_156 = F_127 ( V_4 , V_153 ) ;
V_25 = V_178 ( V_36 , V_156 ,
( unsigned long ) & V_153 -> V_192 , V_4 , V_179 ) ;
if ( V_25 )
break;
V_191 += F_127 ( V_118 , V_153 ) ;
V_191 += sizeof( * V_153 ) ;
}
F_104 ( V_4 ) ;
F_55 ( V_4 ) ;
...
static int F_128 ( T_1 V_17 , struct V_44 * V_155 ,
struct V_46 * V_47 , T_8 * V_178 ,
void * V_179 )
{
int V_25 ;
int V_193 = 0 ;
V_25 = F_120 ( V_17 , V_155 , V_47 , V_178 , V_179 ) ;
if ( ! V_25 )
++ V_193 ;
else if ( V_25 != - V_76 )
return V_25 ;
V_25 = F_125 ( V_17 , V_155 , V_47 , V_178 , V_179 ) ;
if ( V_25 == - V_76 && V_193 )
return 0 ;
return V_25 ;
}
static int F_129 ( T_1 V_17 , T_4 V_156 , unsigned long V_157 ,
...
V_196 = F_102 ( V_195 -> V_155 , V_195 -> V_46 , V_156 ,
...
int F_130 ( T_1 V_17 , struct V_194 * V_195 )
{
return F_128 ( V_17 , V_195 -> V_155 , V_195 -> V_46 ,
F_129 , V_195 ) ;
}
struct V_203 * F_131 ( T_4 V_204 )
{
struct V_203 * V_205 ;
T_9 V_206 ;
V_206 = F_132 ( T_9 , V_204 , sizeof( * V_205 ) ) ;
V_205 = F_133 ( V_206 ) ;
if ( ! V_205 )
return F_109 ( - V_15 ) ;
...
struct V_194 * F_134 ( T_10 V_204 , struct V_44 * V_155 ,
struct V_46 * V_47 )
{
struct V_194 * V_207 ;
struct V_203 * V_196 ;
