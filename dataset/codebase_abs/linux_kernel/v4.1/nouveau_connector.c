...
& V_99 -> V_57 . V_114 ,
V_99 -> V_57 . V_115 ,
V_99 -> V_57 . V_116 , NULL ) ;
if ( ! V_34 )
return - V_108 ;
} else {
V_34 = V_99 -> V_113 ( V_99 , true ) ;
if ( V_34 )
return V_34 ;
}
return 0 ;
...
F_44 ( struct V_2 * V_3 )
{
const struct V_132 * V_78 = V_3 -> V_79 ;
struct V_22 * V_23 = V_22 ( V_3 -> V_5 ) ;
struct V_15 * V_17 = V_15 ( V_3 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_114 -> V_137 = F_45 ( V_114 ) ;
if ( V_78 -> V_138 ( V_3 , V_114 ) != V_139 ||
( V_114 -> V_140 & V_141 ) )
continue;
if ( V_114 -> type & V_142 ) {
F_46 ( V_23 , L_5 ) ;
return F_47 ( V_5 , V_114 ) ;
}
...
F_46 ( V_23 , L_6 ,
V_134 , V_135 , V_136 ) ;
return V_133 ? F_47 ( V_5 , V_133 ) : NULL ;
}
static int
F_48 ( struct V_2 * V_3 )
{
struct V_15 * V_17 = V_15 ( V_3 ) ;
struct V_131 * V_145 = V_17 -> V_146 , * V_147 ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
( V_114 -> V_143 != V_145 -> V_143 ||
V_114 -> V_144 != V_145 -> V_144 ) ) {
V_147 = F_49 ( V_5 , V_114 -> V_143 , V_114 -> V_144 ,
F_45 ( V_145 ) , false ,
false , false ) ;
if ( ! V_147 )
continue;
...
struct V_15 * V_17 = V_15 ( V_3 ) ;
struct V_1 * V_6 = V_17 -> V_47 ;
struct V_151 * V_152 = & V_23 -> V_82 ;
struct V_131 * V_114 = V_17 -> V_146 ;
bool V_153 ;
if ( V_17 -> V_19 && V_3 -> V_154 . V_155 )
return;
if ( V_17 -> type == V_29 ) {
V_3 -> V_154 . V_155 = 6 ;
return;
...
if ( V_17 -> V_19 &&
V_17 -> type == V_105 )
V_153 = ( ( V_158 * ) V_17 -> V_19 ) [ 121 ] == 2 ;
else
V_153 = V_114 -> clock >= V_152 -> V_156 . V_159 ;
if ( ( ! V_153 && ( V_152 -> V_156 . V_160 & 1 ) ) ||
( V_153 && ( V_152 -> V_156 . V_160 & 2 ) ) )
V_3 -> V_154 . V_155 = 8 ;
}
static int
F_52 ( struct V_2 * V_3 )
...
V_17 -> V_146 =
F_44 ( V_3 ) ;
if ( V_34 == 0 && V_17 -> V_146 ) {
struct V_131 * V_114 ;
V_114 = F_47 ( V_5 , V_17 -> V_146 ) ;
F_50 ( V_3 , V_114 ) ;
V_34 = 1 ;
}
if ( V_3 -> V_161 == V_162 )
...
struct V_15 * V_17 = V_15 ( V_3 ) ;
struct V_22 * V_23 = V_22 ( V_3 -> V_5 ) ;
struct V_163 * V_14 = V_17 -> V_47 -> V_14 ;
if ( V_14 -> V_164 != V_165 ||
V_23 -> V_26 . V_48 . V_166 >= 0x46 )
return 165000 ;
else if ( V_23 -> V_26 . V_48 . V_166 >= 0x40 )
return 155000 ;
else if ( V_23 -> V_26 . V_48 . V_166 >= 0x18 )
return 135000 ;
else
return 112000 ;
}
...
case V_53 :
if ( V_17 -> V_146 &&
( V_114 -> V_143 > V_17 -> V_146 -> V_143 ||
V_114 -> V_144 > V_17 -> V_146 -> V_144 ) )
return V_169 ;
V_167 = 0 ;
V_168 = 400000 ;
break;
case V_40 :
V_168 = F_56 ( V_3 ) ;
if ( V_170 && V_6 -> V_14 -> V_171 )
V_168 *= 2 ;
break;
case V_41 :
V_168 = V_6 -> V_14 -> V_172 . V_173 ;
if ( ! V_168 )
V_168 = 350000 ;
break;
case V_76 :
return F_42 ( V_16 ) -> V_138 ( V_16 , V_114 ) ;
case V_33 :
...
static int
F_64 ( struct V_185 * V_186 )
{
struct V_15 * V_17 =
F_65 ( V_186 , F_66 ( * V_17 ) , V_18 ) ;
struct V_2 * V_3 = & V_17 -> V_57 ;
struct V_22 * V_23 = V_22 ( V_3 -> V_5 ) ;
const struct V_187 * V_188 = V_186 -> V_181 ;
const char * V_42 = V_3 -> V_42 ;
if ( V_188 -> V_189 & V_190 ) {
} else {
bool V_191 = ( V_188 -> V_189 != V_192 ) ;
F_46 ( V_23 , L_7 , V_191 ? L_8 : L_9 , V_42 ) ;
if ( V_191 )
F_63 ( V_3 , V_180 ) ;
else
F_63 ( V_3 , V_193 ) ;
...
static T_2
F_68 ( struct V_195 * V_20 , struct V_196 * V_197 )
{
struct V_15 * V_17 =
...
if ( ! V_6 || ! ( V_198 = V_6 -> V_35 ) )
return - V_28 ;
if ( F_69 ( V_197 -> V_199 > 16 ) )
return - V_200 ;
if ( V_197 -> V_199 == 0 )
return V_197 -> V_199 ;
V_34 = F_70 ( V_198 ) -> F_71 ( V_198 , 0 ) ;
if ( V_34 )
return V_34 ;
V_34 = V_198 -> V_201 -> V_20 ( V_198 , false , V_197 -> V_202 , V_197 -> V_203 ,
V_197 -> V_204 , V_197 -> V_199 ) ;
F_70 ( V_198 ) -> F_72 ( V_198 ) ;
if ( V_34 >= 0 ) {
V_197 -> V_205 = V_34 ;
return V_197 -> V_199 ;
}
...
static int
F_73 ( enum V_206 V_14 )
{
switch ( V_14 ) {
case V_207 : return V_208 ;
case V_209 :
case V_210 :
case V_211 : return V_212 ;
case V_213 :
case V_214 :
case V_56 : return V_215 ;
case V_216 : return V_217 ;
case V_104 :
case V_105 : return V_162 ;
case V_218 :
case V_219 :
case V_220 : return V_221 ;
case V_29 : return V_222 ;
case V_223 :
case V_224 :
...
struct V_2 *
F_74 ( struct V_4 * V_5 , int V_228 )
{
const struct V_229 * V_230 = & V_231 ;
struct V_22 * V_23 = V_22 ( V_5 ) ;
...
V_3 = & V_17 -> V_57 ;
V_17 -> V_228 = V_228 ;
V_17 -> V_14 = F_77 ( V_5 , V_228 ) ;
if ( V_17 -> V_14 ) {
T_3 V_234 = F_78 ( V_17 -> V_14 [ 0 ] ) ;
if ( F_79 ( V_5 ) [ 3 ] >= 4 )
V_234 |= ( T_3 ) F_78 ( V_17 -> V_14 [ 2 ] ) << 16 ;
...
if ( V_17 -> type == V_235 ) {
struct V_22 * V_23 = V_22 ( V_5 ) ;
struct V_236 * V_237 = & V_23 -> V_82 . V_14 ;
T_3 V_238 = 0 ;
int V_9 ;
for ( V_9 = 0 ; V_9 < V_237 -> V_239 ; V_9 ++ ) {
if ( V_237 -> V_234 [ V_9 ] . V_3 == V_17 -> V_228 )
