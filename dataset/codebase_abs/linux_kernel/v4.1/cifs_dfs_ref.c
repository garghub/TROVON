...
if ( strncasecmp ( V_17 + V_28 , L_4 , 4 ) == 0 ) {
V_28 += V_29 ;
continue;
}
if ( strncasecmp ( V_17 + V_28 , L_5 , 3 ) == 0 ) {
V_28 += V_29 ;
continue;
}
...
static struct V_37 * F_22 ( struct V_46 * V_47 )
{
...
V_51 = F_29 ( V_56 ) -> V_51 ;
V_53 = F_30 () ;
V_22 = F_31 ( V_53 , V_51 , V_52 + 1 , V_39 -> V_60 ,
& V_49 , & V_48 ,
F_32 ( V_39 ) ) ;
F_33 ( V_53 ) ;
F_34 ( V_56 ) ;
...
struct V_37 * F_36 ( struct V_65 * V_65 )
{
struct V_37 * V_66 ;
F_16 ( V_33 , L_11 , V_34 ) ;
V_66 = F_22 ( V_65 -> V_46 ) ;
