...
if ( ! * V_94 )
continue;
V_117 = F_55 ( V_94 , V_119 , args ) ;
if ( ( V_117 != V_120 ) && ( V_117 != V_121 ) ) {
V_118 = F_56 ( & args [ 0 ] , & V_108 ) ;
if ( V_118 < 0 ) {
F_9 ( V_17 ,
L_27 ) ;
continue;
...
struct V_28 * V_94 ;
struct V_91 * V_91 ;
V_94 = F_59 ( sizeof( struct V_28 ) , V_116 ) ;
if ( ! V_94 )
return - V_68 ;
...
V_12 = F_79 ( V_100 -> V_152 -> V_153 , V_154 ,
V_155 , V_156 , & V_126 , 1 ) ;
if ( V_12 ) {
F_65 ( L_31 ,
V_130 , F_66 ( V_100 ) ) ;
...
static int
F_80 ( struct V_23 * V_18 , const char * V_150 , char * args )
{
int V_12 ;
struct V_125 * V_126 ;
struct V_159 V_160 ;
...
V_12 = F_79 ( V_100 -> V_152 -> V_153 , V_164 ,
V_155 , 0 , & V_126 , 1 ) ;
if ( V_12 < 0 ) {
F_65 ( L_31 ,
V_130 , F_66 ( V_100 ) ) ;
