...
V_26 = F_8 ( V_2 -> V_28 ) ;
if ( ! V_17 ) {
V_17 = F_9 ( sizeof( * V_17 ) , V_29 ) ;
if ( ! V_17 )
return - V_30 ;
V_2 -> V_18 = V_17 ;
}
V_17 -> F_2 = V_26 -> F_2 [ V_2 -> V_31 & ( V_32 | V_33 ) ] ;
if ( ! V_17 -> F_2 )
return - V_22 ;
if ( V_26 -> V_34 ) {
int V_35 = V_26 -> V_34 ( V_2 , NULL ) ;
if ( V_35 < 0 )
return V_35 ;
}
...
static int F_18 ( struct V_42 * V_28 ,
struct V_43 * V_44 )
{
struct V_25 * V_26 ;
unsigned V_3 ;
...
{
struct V_42 * V_28 = V_26 -> V_28 ;
int V_57 ;
if ( ! V_28 || ! V_26 -> V_40 )
return - V_22 ;
F_25 ( & V_26 -> V_38 ) ;
if ( ! V_28 -> V_58 )
V_28 -> V_58 = V_32 | V_33 | V_26 -> V_27 ;
if ( V_28 -> V_59 || V_28 -> V_60 )
return - V_22 ;
V_28 -> V_61 = F_17 ;
V_28 -> V_62 = F_23 ;
V_28 -> V_60 = F_18 ;
