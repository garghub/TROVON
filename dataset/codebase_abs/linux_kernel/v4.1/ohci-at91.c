...
if ( ! V_2 -> V_87 ) {
V_20 -> V_88 = F_66 ( V_20 , & V_20 -> V_12 -> V_14 ) ;
V_20 -> V_88 &= V_89 ;
F_67 ( V_20 , V_20 -> V_88 , & V_20 -> V_12 -> V_14 ) ;
V_20 -> V_90 = V_91 ;
( void ) F_66 ( V_20 , & V_20 -> V_12 -> V_14 ) ;
F_4 ( V_2 ) ;
}
return V_53 ;
}
static int F_68 ( struct V_22 * V_13 )
{
struct V_9 * V_10 = F_60 ( V_13 ) ;
struct V_1 * V_2 = F_8 ( V_10 ) ;
if ( V_2 -> V_87 )
