...
static int F_73 ( unsigned V_22 , bool V_166 )
{
unsigned V_167 = 0 ;
if ( V_22 <= 2 )
V_167 = V_22 ;
...
{
int V_22 , V_172 , V_173 = 0 ;
if ( V_9 -> V_15 == 0x10 && ( V_9 -> V_76 & V_119 ) )
return 2 ;
F_25 ( 0 , L_48 ) ;
for ( V_22 = 0 ; V_22 < 2 ; V_22 ++ ) {
T_1 V_174 = ( V_22 ? V_9 -> V_175 : V_9 -> V_176 ) ;
...
static int F_77 ( unsigned V_22 , bool V_166 )
{
unsigned V_167 = 0 ;
int V_177 = 0 ;
...
static int F_78 ( unsigned V_22 , unsigned V_178 )
{
unsigned V_167 = 0 ;
int V_177 = 0 ;
if ( V_22 < 4 || V_22 == 6 )
...
T_3 V_194 = F_35 ( V_9 ) ;
T_3 V_195 = ( V_9 -> V_183 & 0xFFFFFC00 ) << 16 ;
if ( V_191 ) {
if ( ( ! ( V_192 >> 16 ) ||
V_192 < F_34 ( V_9 ) ) &&
F_33 ( V_9 ) &&
...
static int F_71 ( struct V_26 * V_27 , T_4 V_164 )
{
struct V_8 * V_9 = V_27 -> V_29 ;
int V_237 = - 1 ;
if ( V_9 -> V_89 == 8 )
...
V_9 -> V_232 -> V_256 ( V_27 , V_33 , & V_6 ) ;
F_110 ( V_27 , & V_6 , V_245 ) ;
}
...
V_9 -> V_31 = F_60 ( V_9 -> V_17 -> V_132 , V_258 , V_9 -> V_17 ) ;
if ( ! V_9 -> V_31 ) {
F_69 ( V_9 -> V_12 ) ;
V_9 -> V_12 = NULL ;
F_118 ( L_79
...
struct V_279 * V_225 ;
enum V_280 V_281 ;
int V_22 , V_172 , V_282 = 1 ;
int V_277 = 0 ;
T_1 V_4 ;
F_8 ( V_9 -> V_31 , V_283 , & V_4 ) ;
V_9 -> V_161 = V_4 ;
F_25 ( 0 , L_96 ,
V_9 -> V_57 , V_4 ,
! ! ( V_4 & V_162 ) , ! ! ( V_4 & V_284 ) ) ;
F_29 (i, 0 , pvt) {
bool V_285 = ! ! F_30 ( V_22 , 0 , V_9 ) ;
bool V_286 = false ;
if ( V_9 -> V_15 != 0xf )
V_286 = ! ! F_30 ( V_22 , 1 , V_9 ) ;
if ( ! V_285 && ! V_286 )
continue;
V_43 = V_27 -> V_287 [ V_22 ] ;
V_282 = 0 ;
F_25 ( 1 , L_97 ,
V_9 -> V_57 , V_22 ) ;
if ( V_285 ) {
V_277 = F_123 ( V_9 , 0 , V_22 ) ;
V_43 -> V_173 [ 0 ] -> V_225 -> V_277 = V_277 ;
}
if ( V_9 -> V_15 != 0xf && V_286 ) {
int V_288 = F_123 ( V_9 , 1 , V_22 ) ;
V_43 -> V_173 [ 1 ] -> V_225 -> V_277 = V_288 ;
V_277 += V_288 ;
}
F_25 ( 1 , L_98 , V_22 , V_277 ) ;
if ( V_9 -> V_161 & V_284 )
...
F_8 ( V_31 , V_312 , & V_310 ) ;
V_238 -> V_313 = V_310 & V_45 ;
V_238 -> V_314 = true ;
V_310 |= V_45 ;
F_9 ( V_31 , V_312 , V_310 ) ;
F_8 ( V_31 , V_283 , & V_310 ) ;
F_25 ( 0 , L_103 ,
...
V_27 -> V_326 = V_327 ;
V_27 -> V_328 = V_329 ;
V_27 -> V_330 = V_15 -> V_330 ;
V_27 -> V_331 = F_119 ( V_9 -> V_17 ) ;
V_27 -> V_332 = NULL ;
V_27 -> V_333 = F_15 ;
V_27 -> V_334 = F_16 ;
}
...
V_349 [ 1 ] . V_356 = 2 ;
V_349 [ 1 ] . V_357 = false ;
V_27 = F_145 ( V_34 , F_13 ( V_349 ) , V_349 , 0 ) ;
if ( ! V_27 )
goto V_354;
V_27 -> V_29 = V_9 ;
V_27 -> V_2 = & V_9 -> V_17 -> V_135 ;
F_140 ( V_27 , V_335 ) ;
if ( F_124 ( V_27 ) )
V_27 -> V_74 = V_75 ;
V_64 = - V_260 ;
...
{
T_4 V_34 = F_143 ( V_2 ) ;
struct V_1 * V_31 = F_66 ( V_34 ) -> V_156 ;
struct V_305 * V_238 ;
int V_64 = 0 ;
V_64 = F_153 ( V_2 ) ;
if ( V_64 < 0 ) {
...
goto V_369;
F_3 ( L_120 ) ;
if ( ! F_136 ( V_238 , V_34 , V_31 ) )
goto V_369;
}
V_64 = F_142 ( V_2 ) ;
if ( V_64 < 0 ) {
F_118 ( L_121 , V_34 ) ;
F_137 ( V_238 , V_34 , V_31 ) ;
}
return V_64 ;
V_369:
F_151 ( V_238 ) ;
...
V_27 = F_155 ( & V_2 -> V_135 ) ;
F_68 ( ! V_27 ) ;
V_27 = F_156 ( & V_2 -> V_135 ) ;
if ( ! V_27 )
return;
V_9 = V_27 -> V_29 ;
F_137 ( V_238 , V_34 , V_31 ) ;
