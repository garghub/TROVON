...
struct V_14 * V_17 = F_17 ( V_16 ) ;
if ( V_32 ) {
return F_27 ( & V_17 -> V_21 , V_29 , V_30 ) ;
} else {
if ( V_17 -> V_18 ) {
if ( V_17 -> V_18 + V_30 < V_20 ) {
memcpy ( V_17 -> V_33 + V_17 -> V_18 , V_29 , V_30 ) ;
V_17 -> V_18 += V_30 ;
return 0 ;
}
...
F_21 () ;
F_22 () ;
F_28 ( V_17 -> V_19 , V_8 -> V_27 , V_17 -> V_33 ,
V_20 ) ;
F_24 () ;
V_29 += V_20 - V_17 -> V_18 ;
V_30 -= V_20 - V_17 -> V_18 ;
...
F_21 () ;
F_22 () ;
F_28 ( V_17 -> V_19 , V_8 -> V_27 , V_29 , V_31 ) ;
F_24 () ;
V_29 += V_31 ;
V_30 -= V_31 ;
}
...
static int F_29 ( struct V_15 * V_16 , T_1 * V_34 )
{
int V_35 ;
struct V_7 * V_8 = F_3 ( F_10 ( V_16 -> V_2 ) ) ;
struct V_14 * V_17 = F_17 ( V_16 ) ;
if ( V_32 ) {
return F_30 ( & V_17 -> V_21 , V_34 ) ;
} else {
if ( V_17 -> V_18 ) {
