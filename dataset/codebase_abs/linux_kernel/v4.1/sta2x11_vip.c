...
F_93 ( & V_6 -> V_164 , V_6 ) ;
V_86 = F_94 ( & V_6 -> V_164 , V_167 , - 1 ) ;
if ( V_86 )
goto V_168;
V_6 -> V_169 = F_95 ( V_6 -> V_146 -> V_170 ) ;
if ( ! V_6 -> V_169 ) {
V_86 = - V_162 ;
F_71 ( & V_58 -> V_126 , L_19 ) ;
goto V_171;
}
V_6 -> V_70 = F_96 ( & V_6 -> V_42 , V_6 -> V_169 ,
L_20 , V_6 -> V_146 -> V_172 ,
NULL ) ;
if ( ! V_6 -> V_70 ) {
V_86 = - V_162 ;
...
static void F_106 ( struct V_142 * V_58 )
{
struct V_175 * V_42 = F_107 ( V_58 ) ;
struct V_5 * V_6 =
...
static int F_108 ( struct V_142 * V_58 , T_4 V_176 )
{
struct V_175 * V_42 = F_107 ( V_58 ) ;
struct V_5 * V_6 =
F_2 ( V_42 , struct V_5 , V_42 ) ;
...
V_6 -> V_177 [ V_179 ] = F_5 ( V_6 , V_45 ) ;
F_3 ( V_6 , V_45 , 0 ) ;
for ( V_85 = 1 ; V_85 < V_179 ; V_85 ++ )
V_6 -> V_177 [ V_85 ] = F_5 ( V_6 , 4 * V_85 ) ;
for ( V_85 = 0 ; V_85 < V_180 ; V_85 ++ )
V_6 -> V_177 [ V_179 + V_181 + V_85 ] =
F_5 ( V_6 , V_182 [ V_85 ] ) ;
F_110 ( & V_6 -> V_16 , V_94 ) ;
F_111 ( V_58 ) ;
if ( F_112 ( V_58 , F_113 ( V_58 , V_176 ) ) ) {
V_6 -> V_183 = 1 ;
}
F_52 ( L_23 ) ;
return 0 ;
}
static int F_114 ( struct V_142 * V_58 )
{
struct V_175 * V_42 = F_107 ( V_58 ) ;
struct V_5 * V_6 =
F_2 ( V_42 , struct V_5 , V_42 ) ;
...
F_109 ( & V_6 -> V_16 , V_94 ) ;
for ( V_85 = 1 ; V_85 < V_179 ; V_85 ++ )
F_3 ( V_6 , 4 * V_85 , V_6 -> V_177 [ V_85 ] ) ;
for ( V_85 = 0 ; V_85 < V_180 ; V_85 ++ )
F_3 ( V_6 , V_182 [ V_85 ] ,
V_6 -> V_177 [ V_179 + V_181 + V_85 ] ) ;
F_3 ( V_6 , V_17 , V_6 -> V_177 [ 0 ] ) ;
F_3 ( V_6 , V_45 , V_6 -> V_177 [ V_179 ] ) ;
F_110 ( & V_6 -> V_16 , V_94 ) ;
return 0 ;
}
