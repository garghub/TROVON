...
F_2 ( & V_2 -> V_29 ) ;
while ( V_19 &&
( V_24 = F_12 ( V_17 , V_23 , V_19 , & V_17 -> V_30 ) ) > 0 ) {
V_23 += V_24 ;
V_19 -= V_24 ;
}
F_3 ( & V_2 -> V_29 ) ;
...
T_3 V_41 ;
F_4 ( L_2 ,
( unsigned long ) V_4 -> V_42 , V_4 -> V_12 . V_43 , V_4 -> V_12 . V_12 , type ) ;
...
case V_50 :
{
struct V_51 * V_52 = & V_40 . V_37 . V_53 ;
V_41 = sizeof( * V_52 ) ;
V_52 -> V_42 = V_4 -> V_42 ;
...
int F_40 ( struct V_1 * V_2 , struct V_70 * V_70 ,
enum V_87 V_88 )
{
struct V_3 * V_4 ;
struct V_84 V_84 ;
...
V_103 = V_25 -> V_105 ;
F_53 ( & V_25 -> V_105 , V_106 & ~ V_103 . V_107 [ 0 ] ) ;
F_15 () ;
...
V_65 = F_31 ( V_70 ) ;
if ( ! V_65 ) {
V_108 = F_37 ( V_70 -> V_81 , & V_70 -> V_82 ) ;
if ( V_108 )
V_65 = F_31 ( V_108 ) ;
}
if ( V_65 ) {
...
F_2 ( & V_2 -> V_6 ) ;
for ( V_109 = & V_2 -> V_8 ; ( V_4 = * V_109 ) != NULL ; V_109 = & V_4 -> V_9 ) {
if ( V_4 -> V_42 == V_42 )
break;
}
if ( ! V_4 ) {
