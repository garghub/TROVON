...
F_2 ( V_68 -> V_236 == 0 ) ;
V_229 = V_197 -> V_84 ;
V_230 = F_91 ( V_237 , V_229 , V_68 -> V_238 ) ;
if ( V_230 < V_229 &&
( V_68 -> V_72 & V_239 ) == 0 ) {
F_54 ( L_17 ,
F_38 ( V_51 -> V_87 ) , F_39 ( V_35 ) ,
...
V_35 . V_1 = V_197 -> V_184 ;
V_35 . V_81 = V_197 -> V_82 ;
V_197 -> V_53 . V_241 . V_205 = F_81 ( V_197 -> V_53 . V_241 . V_205 ) ;
V_197 -> V_53 . V_241 . V_230 = F_82 ( V_197 -> V_53 . V_241 . V_230 ) ;
V_115 = F_87 ( V_197 -> V_53 . V_241 . V_228 . V_231 ) ;
F_88 ( V_115 ) ;
V_68 = F_89 ( & V_197 -> V_53 . V_241 . V_228 ) ;
if ( V_68 == NULL || V_68 -> V_232 == 0 || V_68 -> V_233 != NULL ) {
F_73 ( V_195 ,
L_19 ,
F_38 ( V_51 -> V_87 ) , F_39 ( V_35 ) ,
( V_68 == NULL ) ? L_14 : L_15 ,
V_197 -> V_53 . V_241 . V_228 . V_234 ,
V_197 -> V_53 . V_241 . V_228 . V_231 ) ;
if ( V_68 != NULL && V_68 -> V_233 != NULL )
F_37 ( L_20 ,
V_68 -> V_233 -> V_235 ) ;
F_90 ( V_115 ) ;
...
T_7 V_35 = { 0 } ;
T_7 V_33 = { 0 } ;
char * V_247 = F_74 ( V_197 -> type ) ;
V_35 . V_1 = V_197 -> V_184 ;
V_35 . V_81 = V_197 -> V_82 ;
V_33 . V_1 = V_197 -> V_79 ;
V_33 . V_81 = V_197 -> V_80 ;
F_52 ( L_28 , V_197 , V_247 ) ;
F_52 ( L_29 , F_39 ( V_35 ) ) ;
F_52 ( L_30 , F_39 ( V_33 ) ) ;
switch ( V_197 -> type ) {
default:
...
int
F_96 ( T_4 * V_51 , V_133 * V_197 , T_1 V_249 ,
void * V_52 , int V_250 )
{
int V_57 = 0 ;
int V_115 ;
...
V_51 -> V_256 = F_97 () ;
if ( V_51 -> V_257 != NULL &&
V_51 -> V_257 -> V_258 == V_259 )
V_51 -> V_257 -> V_258 = V_260 ;
F_99 ( V_51 ) ;
}
if ( ! V_251 ) {
...
F_4 ( V_115 ) ;
V_57 = F_71 ( & V_53 -> V_94 , V_249 , V_115 ) ;
if ( V_57 != 0 ) {
F_6 ( V_115 ) ;
F_37 ( L_46 ,
F_38 ( V_249 ) , F_38 ( V_184 ) ,
...
void
F_105 ( struct V_4 * V_265 , char * V_266 )
{
while ( ! F_12 ( V_265 ) ) {
T_7 V_267 = { 0 } ;
T_5 * V_53 ;
V_53 = F_9 ( V_265 -> V_6 , T_5 , V_135 ) ;
F_10 ( & V_53 -> V_135 ) ;
V_267 . V_1 = V_53 -> V_78 . V_184 ;
V_267 . V_81 = V_53 -> V_78 . V_82 ;
F_2 ( V_53 -> V_69 == NULL ) ;
F_2 ( V_53 -> V_149 ) ;
F_2 ( V_53 -> V_94 != NULL ) ;
F_2 ( V_53 -> V_78 . type == V_244 ) ;
F_52 ( L_47 ,
F_39 ( V_267 ) ,
V_53 -> V_78 . V_53 . V_200 . V_206 ,
V_53 -> V_78 . V_53 . V_200 . V_205 ,
V_53 -> V_78 . V_53 . V_200 . V_36 ,
V_53 -> V_78 . V_84 , V_266 ) ;
...
F_2 ( V_53 -> V_78 . type == V_244 ) ;
F_73 ( V_195 , L_48 ,
F_39 ( V_267 ) , V_53 -> V_78 . V_53 . V_200 . V_206 ,
V_53 -> V_78 . V_53 . V_200 . V_205 ,
V_53 -> V_78 . V_53 . V_200 . V_36 ,
V_53 -> V_78 . V_84 ) ;
...
int
F_107 ( T_1 V_268 , T_16 V_269 , T_17 V_241 ,
T_7 V_75 , unsigned int V_270 ,
...
V_53 -> V_274 = ! ! F_108 () ;
V_115 = F_87 ( V_269 . V_275 ) ;
F_88 ( V_115 ) ;
V_68 = F_109 ( & V_269 ) ;
if ( V_68 == NULL || V_68 -> V_232 == 0 || V_68 -> V_233 != NULL ) {
F_37 ( L_51 ,
V_205 , V_270 , F_39 ( V_75 ) ,
...
F_92 ( V_53 , V_68 , 0 , 0 ) ;
F_30 ( V_53 , V_244 , V_75 , 0 , V_68 -> V_238 ) ;
V_53 -> V_78 . V_53 . V_200 . V_205 = F_32 ( V_205 ) ;
V_53 -> V_78 . V_53 . V_200 . V_206 = F_31 ( V_270 ) ;
V_53 -> V_78 . V_53 . V_200 . V_36 = F_31 ( V_36 ) ;
V_53 -> V_78 . V_53 . V_200 . V_248 = V_248 ;
if ( V_241 == V_276 ) {
...
T_5 *
F_110 ( T_4 * V_51 , T_5 * V_282 )
{
struct V_252 * V_53 = F_101 () ;
struct V_271 * V_283 = V_282 -> V_69 ;
T_7 V_284 = V_282 -> V_77 ;
int V_115 ;
F_2 ( ! V_282 -> V_189 ) ;
F_2 ( ! V_282 -> V_70 ) ;
V_115 = F_87 ( V_283 -> V_278 . V_279 ) ;
F_88 ( V_115 ) ;
F_2 ( V_283 -> V_285 > 0 ) ;
if ( V_53 == NULL ) {
F_37 ( L_54 ,
F_38 ( V_51 -> V_87 ) , F_39 ( V_284 ) ) ;
goto V_261;
}
if ( V_283 -> V_232 == 0 ) {
F_37 ( L_55 ,
...
F_2 ( V_283 -> V_236 == 0 ) ;
F_73 ( V_195 , L_56 ,
F_38 ( V_51 -> V_87 ) , F_39 ( V_284 ) , V_283 ) ;
V_53 -> V_262 = V_284 . V_1 ;
V_53 -> V_76 = V_245 ;
V_53 -> V_78 . V_184 = V_284 . V_1 ;
V_53 -> V_78 . V_84 = V_283 -> V_238 ;
V_53 -> V_58 = 1 ;
F_92 ( V_53 , V_283 , V_283 -> V_236 , V_283 -> V_238 ) ;
F_90 ( V_115 ) ;
V_115 = F_65 ( V_284 . V_1 ) ;
F_4 ( V_115 ) ;
F_70 ( V_53 , V_115 ) ;
F_6 ( V_115 ) ;
F_78 ( V_53 , V_240 ) ;
...
F_4 ( V_115 ) ;
V_8 . V_123 [ V_115 ] -> V_124 ++ ;
V_8 . V_123 [ V_115 ] -> V_125 += V_283 -> V_238 ;
F_6 ( V_115 ) ;
if ( V_53 != NULL )
F_102 ( V_53 ) ;
return NULL ;
...
{
F_2 ( V_227 != NULL ) ;
F_2 ( V_227 -> V_76 == V_245 ) ;
F_2 ( V_227 -> V_286 . type == V_240 ) ;
F_2 ( V_37 <= V_227 -> V_286 . V_230 ) ;
V_227 -> V_286 . V_230 = V_37 ;
}
int
F_112 ( T_1 V_268 , T_16 V_269 ,
T_7 V_75 , unsigned int V_270 ,
T_18 V_205 , unsigned int V_36 )
{
struct V_252 * V_53 ;
...
F_92 ( V_53 , V_68 , 0 , 0 ) ;
F_30 ( V_53 , V_245 , V_75 , 0 , 0 ) ;
V_53 -> V_78 . V_53 . V_220 . V_205 = F_32 ( V_205 ) ;
V_53 -> V_78 . V_53 . V_220 . V_206 = F_31 ( V_270 ) ;
V_53 -> V_78 . V_53 . V_220 . V_222 = F_31 ( V_36 ) ;
V_53 -> V_78 . V_53 . V_220 . V_221 = F_31 ( V_68 -> V_238 ) ;
...
int
F_113 ( T_1 V_287 , T_1 * V_288 , T_15 * V_289 )
{
struct V_4 * V_290 ;
struct V_163 * V_51 ;
T_12 * V_175 ;
T_15 V_291 = F_35 ( V_287 ) ;
int V_292 ;
int V_115 ;
T_15 V_293 = 2 ;
struct V_4 * V_294 ;
...
V_51 = F_9 ( V_290 , T_4 , V_295 ) ;
if ( V_51 -> V_87 == V_287 ) {
if ( V_288 != NULL )
* V_288 = V_287 ;
if ( V_289 != NULL ) {
if ( F_34 ( F_35 ( V_287 ) ) == V_88 )
* V_289 = 0 ;
else
* V_289 = 1 ;
}
...
V_294 = F_116 ( V_291 ) ;
F_115 (e, rn_list) {
V_175 = F_9 ( V_290 , T_12 , V_297 ) ;
if ( V_175 -> V_298 == V_291 ) {
T_11 * V_299 ;
T_11 * V_300 = NULL ;
F_2 ( ! F_12 ( & V_175 -> V_301 ) ) ;
F_63 (route, &rnet->lrn_routes,
lr_list) {
if ( V_300 == NULL ||
V_299 -> V_172 < V_300 -> V_172 )
V_300 = V_299 ;
}
F_2 ( V_300 != NULL ) ;
V_292 = V_300 -> V_172 ;
if ( V_288 != NULL )
* V_288 = V_300 -> V_169 -> V_108 -> V_87 ;
if ( V_289 != NULL )
* V_289 = V_293 ;
F_6 ( V_115 ) ;
return V_292 + 1 ;
