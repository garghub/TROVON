...
! F_86 ( V_116 -> V_16 , V_179 -> V_182 ) )
return - V_129 ;
switch ( V_179 -> V_182 ) {
case V_184 :
if ( V_179 -> V_185 != F_87 ( sizeof( V_186 ) ) )
return - V_129 ;
V_116 -> V_180 = * ( V_186 * ) F_88 ( V_179 ) ;
break;
default:
return - V_129 ;
}
...
int F_89 ( struct V_15 * V_16 , struct V_176 * V_177 , T_5 V_118 )
{
const struct V_45 * V_46 = F_8 ( V_16 ) ;
...
V_191 = F_91 ( V_16 , V_188 ) ;
if ( ( 1 << V_16 -> V_18 ) & ~ ( V_195 | V_196 ) )
if ( ( V_111 = F_92 ( V_16 , & V_191 ) ) != 0 )
goto V_194;
V_190 = V_16 -> V_22 -> V_197 + V_118 ;
F_55 ( V_16 ) ;
V_116 = F_93 ( V_16 , V_190 , V_188 , & V_111 ) ;
F_52 ( V_16 ) ;
if ( V_116 == NULL )
goto V_194;
F_94 ( V_116 , V_16 -> V_22 -> V_197 ) ;
V_111 = F_95 ( F_96 ( V_116 , V_118 ) , V_177 , V_118 ) ;
if ( V_111 != 0 )
goto V_198;
...
int F_100 ( struct V_15 * V_16 , struct V_176 * V_177 , T_5 V_118 , int V_200 ,
int V_74 , int * V_201 )
{
...
int F_108 ( struct V_91 * V_15 , int V_71 )
{
struct V_15 * V_16 = V_15 -> V_16 ;
unsigned char V_78 ;
int V_77 ;
...
void F_111 ( struct V_15 * V_16 , long V_218 )
{
struct V_45 * V_46 = F_8 ( V_16 ) ;
struct V_115 * V_116 ;
V_128 V_219 = 0 ;
...
F_112 ( V_16 , & V_46 -> V_199 ) ;
while ( ( V_116 = F_113 ( & V_16 -> V_82 ) ) != NULL ) {
V_219 += V_116 -> V_118 ;
F_39 ( V_116 ) ;
}
if ( V_219 ) {
...
void F_125 ( struct V_15 * V_16 , int V_225 )
{
F_3 ( L_30 , V_225 ) ;
}
static inline int T_6 F_126 ( void )
{
V_226 = F_127 ( struct V_227 ) ;
if ( ! V_226 )
return - V_131 ;
return 0 ;
}
...
int V_111 ;
F_131 ( sizeof( struct V_231 ) >
F_132 ( struct V_115 , V_232 ) ) ;
V_111 = F_133 ( & V_233 , 0 , V_130 ) ;
if ( V_111 )
goto V_234;
V_111 = - V_139 ;
F_134 ( & V_235 ) ;
...
F_138 ( & V_235 . V_247 [ V_138 ] . V_251 , V_138 ) ;
if ( F_139 ( & V_235 ) )
goto V_252;
V_230 = V_229 ;
do {
...
F_140 ( & V_235 . V_255 [ V_138 ] . V_257 ) ;
F_141 ( & V_235 . V_255 [ V_138 ] . V_251 ) ;
}
V_111 = F_126 () ;
if ( V_111 )
goto V_258;
...
F_128 () ;
V_258:
F_148 ( ( unsigned long ) V_235 . V_255 , V_230 ) ;
V_256:
F_149 ( & V_235 ) ;
V_252:
F_148 ( ( unsigned long ) V_235 . V_247 , V_229 ) ;
V_250:
F_150 ( V_235 . V_236 ) ;
V_239:
F_151 ( & V_233 ) ;
...
F_153 () ;
F_128 () ;
F_148 ( ( unsigned long ) V_235 . V_255 ,
F_154 ( V_235 . V_253 *
sizeof( struct V_254 ) ) ) ;
F_148 ( ( unsigned long ) V_235 . V_247 ,
F_154 ( ( V_235 . V_246 + 1 ) *
sizeof( struct V_243 ) ) ) ;
F_149 ( & V_235 ) ;
F_150 ( V_235 . V_236 ) ;
