...
static void F_68 ( struct V_94 * V_49 , T_1 V_160 , T_4 * V_50 )
{
int V_23 ;
if ( V_160 != V_161 )
return;
for ( V_23 = 0 ; V_23 < F_69 ( V_162 ) ; V_23 ++ , V_50 += V_163 )
memcpy ( V_50 , V_162 [ V_23 ] . V_105 , V_163 ) ;
}
static int F_70 ( struct V_94 * V_49 , int V_164 )
{
switch ( V_164 ) {
case V_161 :
return F_69 ( V_162 ) ;
...
static void F_71 ( struct V_94 * V_49 ,
struct V_166 * V_167 , T_2 * V_50 )
{
int V_23 ;
struct V_1 * V_2 = F_47 ( V_49 ) ;
for ( V_23 = 0 ; V_23 < F_69 ( V_162 ) ; V_23 ++ )
V_50 [ V_23 ] = F_72 ( V_2 , V_162 [ V_23 ] . V_34 ) ;
}
static int F_73 ( struct V_94 * V_49 , struct V_168 * V_169 , int V_109 )
{
return - V_165 ;
}
...
V_41 = 0 ;
do {
V_72 = F_75 ( V_2 -> V_48 -> V_61 ,
V_170 [ 0 ] . V_44 , V_170 [ 1 ] . V_44 ,
V_170 [ 2 ] . V_44 , V_170 [ 3 ] . V_44 ,
V_170 [ 4 ] . V_44 , V_170 [ 5 ] . V_44 ,
V_41 , & V_41 ) ;
} while ( ( V_72 == V_90 ) && ( V_171 -- ) );
if ( V_72 != V_62 && V_72 != V_172 ) {
F_50 ( V_2 -> V_45 , L_29
L_30 , V_72 ) ;
return 1 ;
}
...
static T_6 F_76 ( struct V_38 * V_39 ,
struct V_94 * V_45 )
{
struct V_1 * V_2 = F_47 ( V_45 ) ;
unsigned int V_173 ;
...
int V_175 = 0 ;
V_28 V_27 ;
if ( F_77 ( V_39 ) -> V_176 > 5 && F_78 ( V_39 ) ) {
V_45 -> V_167 . V_177 ++ ;
goto V_73;
}
if ( V_39 -> V_178 == V_179 &&
( ( V_39 -> V_180 == F_79 ( V_181 ) &&
F_80 ( V_39 ) -> V_180 != V_182 ) ||
( V_39 -> V_180 == F_79 ( V_183 ) &&
F_81 ( V_39 ) -> V_184 != V_182 ) ) &&
F_82 ( V_39 ) ) {
F_50 ( V_45 , L_31 ) ;
V_45 -> V_167 . V_177 ++ ;
goto V_73;
...
F_85 ( V_39 , V_2 -> V_83 ,
V_39 -> V_58 ) ;
V_170 [ 0 ] . V_53 . V_54 = V_173 | V_39 -> V_58 ;
V_170 [ 0 ] . V_53 . V_56 = V_2 -> V_84 ;
if ( F_74 ( V_2 , V_170 ) ) {
V_2 -> V_191 ++ ;
V_45 -> V_167 . V_177 ++ ;
} else {
V_45 -> V_167 . V_192 ++ ;
V_45 -> V_167 . V_193 += V_39 -> V_58 ;
}
goto V_73;
}
V_27 = F_22 ( & V_2 -> V_48 -> V_49 , V_39 -> V_50 ,
...
if ( F_23 ( & V_2 -> V_48 -> V_49 , V_27 ) )
goto V_195;
V_170 [ 0 ] . V_53 . V_54 = V_173 | F_86 ( V_39 ) ;
V_170 [ 0 ] . V_53 . V_56 = V_27 ;
for ( V_23 = 0 ; V_23 < F_77 ( V_39 ) -> V_176 ; V_23 ++ ) {
const T_7 * V_196 = & F_77 ( V_39 ) -> V_197 [ V_23 ] ;
V_27 = F_87 ( & V_2 -> V_48 -> V_49 , V_196 , 0 ,
F_88 ( V_196 ) , V_194 ) ;
if ( F_23 ( & V_2 -> V_48 -> V_49 , V_27 ) )
goto V_198;
V_170 [ V_23 + 1 ] . V_53 . V_54 = V_173 | F_88 ( V_196 ) ;
V_170 [ V_23 + 1 ] . V_53 . V_56 = V_27 ;
}
if ( F_74 ( V_2 , V_170 ) ) {
V_2 -> V_191 ++ ;
V_45 -> V_167 . V_177 ++ ;
...
F_27 ( & V_2 -> V_48 -> V_49 ,
V_170 [ 0 ] . V_53 . V_56 ,
V_170 [ 0 ] . V_53 . V_54 & V_199 ,
V_194 ) ;
for ( V_23 = 1 ; V_23 < F_77 ( V_39 ) -> V_176 + 1 ; V_23 ++ )
F_89 ( & V_2 -> V_48 -> V_49 , V_170 [ V_23 ] . V_53 . V_56 ,
V_170 [ V_23 ] . V_53 . V_54 & V_199 ,
V_194 ) ;
V_73:
F_90 ( V_39 ) ;
return V_200 ;
...
static int F_93 ( struct V_203 * V_96 , int V_204 )
{
struct V_1 * V_2 =
F_94 ( V_96 , struct V_1 , V_96 ) ;
...
F_100 ( V_39 , V_12 ) ;
V_39 -> V_180 = F_101 ( V_39 , V_45 ) ;
if ( V_209 )
V_39 -> V_178 = V_211 ;
F_102 ( V_39 ) ;
V_45 -> V_167 . V_212 ++ ;
V_45 -> V_167 . V_213 += V_12 ;
V_205 ++ ;
}
}
F_31 ( V_2 ) ;
...
static T_8 V_104 ( int V_103 , void * V_215 )
{
struct V_94 * V_45 = V_215 ;
struct V_1 * V_2 = F_47 ( V_45 ) ;
unsigned long V_42 ;
if ( F_105 ( & V_2 -> V_96 ) ) {
V_42 = F_52 ( V_2 -> V_48 -> V_61 ,
...
static void F_107 ( struct V_94 * V_45 )
{
struct V_1 * V_2 = F_47 ( V_45 ) ;
unsigned long V_42 ;
if ( ( V_45 -> V_217 & V_218 ) ||
( F_108 ( V_45 ) > V_2 -> V_219 ) ) {
V_42 = F_109 ( V_2 -> V_48 -> V_61 ,
V_220 |
V_221 ,
0 ) ;
if ( V_42 != V_62 ) {
...
static int F_111 ( struct V_94 * V_49 , int V_228 )
{
struct V_1 * V_2 = F_47 ( V_49 ) ;
struct V_229 * V_230 = V_2 -> V_48 ;
int V_231 = V_228 + V_60 ;
int V_23 , V_87 ;
int V_232 = 0 ;
if ( V_228 < V_233 )
return - V_234 ;
for ( V_23 = 0 ; V_23 < V_69 ; V_23 ++ )
if ( V_231 <= V_2 -> V_70 [ V_23 ] . V_18 )
break;
if ( V_23 == V_69 )
return - V_234 ;
if ( F_65 ( V_2 -> V_45 ) ) {
...
if ( V_232 && ( V_87 = F_46 ( V_2 -> V_45 ) ) )
return V_87 ;
return - V_234 ;
}
static void F_114 ( struct V_94 * V_49 )
{
F_31 ( F_47 ( V_49 ) ) ;
V_104 ( V_49 -> V_103 , V_49 ) ;
}
static unsigned long F_113 ( struct V_229 * V_48 )
{
struct V_94 * V_45 = F_115 ( & V_48 -> V_49 ) ;
struct V_1 * V_2 ;
struct V_235 * V_236 ;
unsigned long V_72 ;
int V_23 ;
int V_237 = 1 ;
V_236 = F_116 ( & V_48 -> V_49 ) ;
if ( V_45 == NULL )
return F_117 ( V_238 , V_236 ) ;
V_2 = F_47 ( V_45 ) ;
V_72 = V_239 + V_240 ;
V_72 += F_117 ( V_45 -> V_59 , V_236 ) ;
for ( V_23 = 0 ; V_23 < V_69 ; V_23 ++ ) {
if ( V_2 -> V_70 [ V_23 ] . V_22 )
V_72 +=
V_2 -> V_70 [ V_23 ] . V_20 *
F_117 ( V_2 -> V_70 [ V_23 ] .
V_18 , V_236 ) ;
V_237 += V_2 -> V_70 [ V_23 ] . V_20 ;
}
V_72 += F_117 (
V_237 * sizeof( struct V_99 ) , V_236 ) ;
return V_72 ;
}
static int F_118 ( struct V_94 * V_49 , void * V_65 )
{
struct V_1 * V_2 = F_47 ( V_49 ) ;
struct V_241 * V_33 = V_65 ;
T_2 V_86 ;
int V_87 ;
if ( ! F_119 ( V_33 -> V_242 ) )
return - V_243 ;
V_86 = F_45 ( V_33 -> V_242 ) ;
V_87 = F_120 ( V_2 -> V_48 -> V_61 , V_86 ) ;
if ( V_87 ) {
F_50 ( V_2 -> V_45 , L_41 , V_87 ) ;
return V_87 ;
}
F_121 ( V_49 -> V_100 , V_33 -> V_242 ) ;
return 0 ;
}
static int F_122 ( struct V_229 * V_49 , const struct V_244 * V_245 )
{
int V_87 , V_23 , V_246 ;
struct V_94 * V_45 ;
struct V_1 * V_2 ;
unsigned char * V_247 ;
unsigned int * V_248 ;
F_123 ( & V_49 -> V_49 , L_42 ,
V_49 -> V_61 ) ;
V_247 = ( unsigned char * ) F_124 ( V_49 , V_249 ,
& V_246 ) ;
if ( ! V_247 ) {
F_125 ( & V_49 -> V_49 , L_43 ) ;
return - V_234 ;
}
if ( V_246 == 8 )
V_247 += 2 ;
else if ( V_246 != 6 ) {
F_125 ( & V_49 -> V_49 , L_44 ,
V_246 ) ;
return - V_234 ;
}
V_248 = ( unsigned int * ) F_124 ( V_49 ,
V_250 , NULL ) ;
if ( ! V_248 ) {
F_125 ( & V_49 -> V_49 , L_45
L_46 ) ;
return - V_234 ;
}
V_45 = F_126 ( sizeof( struct V_1 ) ) ;
if ( ! V_45 )
return - V_97 ;
V_2 = F_47 ( V_45 ) ;
F_127 ( & V_49 -> V_49 , V_45 ) ;
V_2 -> V_48 = V_49 ;
V_2 -> V_45 = V_45 ;
V_2 -> V_219 = * V_248 ;
V_2 -> V_107 = 0 ;
F_128 ( V_45 , & V_2 -> V_96 , F_93 , 16 ) ;
V_45 -> V_103 = V_49 -> V_103 ;
V_45 -> V_251 = & V_252 ;
V_45 -> V_253 = & V_254 ;
F_129 ( V_45 , & V_49 -> V_49 ) ;
V_45 -> V_255 = V_256 | V_137 |
V_154 | V_156 ;
V_45 -> V_136 |= V_45 -> V_255 ;
memcpy ( V_45 -> V_100 , V_247 , V_93 ) ;
for ( V_23 = 0 ; V_23 < V_69 ; V_23 ++ ) {
struct V_257 * V_258 = & V_2 -> V_70 [ V_23 ] . V_258 ;
int error ;
F_9 ( & V_2 -> V_70 [ V_23 ] , V_23 ,
V_259 [ V_23 ] , V_17 [ V_23 ] ,
V_19 [ V_23 ] ) ;
error = F_130 ( V_258 , & V_260 ,
& V_49 -> V_49 . V_258 , L_47 , V_23 ) ;
if ( ! error )
F_131 ( V_258 , V_261 ) ;
}
F_20 ( V_45 , L_48 , V_2 ) ;
...
static int F_134 ( struct V_229 * V_49 )
{
struct V_94 * V_45 = F_115 ( & V_49 -> V_49 ) ;
struct V_1 * V_2 = F_47 ( V_45 ) ;
int V_23 ;
for ( V_23 = 0 ; V_23 < V_69 ; V_23 ++ )
F_135 ( & V_2 -> V_70 [ V_23 ] . V_258 ) ;
F_136 ( V_45 ) ;
F_133 ( V_45 ) ;
F_127 ( & V_49 -> V_49 , NULL ) ;
return 0 ;
}
static T_9 F_137 ( struct V_257 * V_258 ,
struct V_262 * V_263 , char * V_185 )
{
struct V_14 * V_15 = F_94 ( V_258 ,
struct V_14 ,
V_258 ) ;
if ( V_263 == & V_264 )
return sprintf ( V_185 , L_52 , V_15 -> V_22 ) ;
else if ( V_263 == & V_265 )
return sprintf ( V_185 , L_52 , V_15 -> V_20 ) ;
else if ( V_263 == & V_266 )
return sprintf ( V_185 , L_52 , V_15 -> V_18 ) ;
return 0 ;
}
static T_9 F_138 ( struct V_257 * V_258 , struct V_262 * V_263 ,
const char * V_185 , T_10 V_36 )
{
struct V_14 * V_15 = F_94 ( V_258 ,
struct V_14 ,
V_258 ) ;
struct V_94 * V_45 = F_115 (
F_94 ( V_258 -> V_267 , struct V_75 , V_258 ) ) ;
struct V_1 * V_2 = F_47 ( V_45 ) ;
long V_268 = F_139 ( V_185 , NULL , 10 ) ;
long V_87 ;
if ( V_263 == & V_264 ) {
if ( V_268 && ! V_15 -> V_22 ) {
if ( F_65 ( V_45 ) ) {
...
static int F_140 ( struct V_75 * V_49 )
{
struct V_94 * V_45 = F_115 ( V_49 ) ;
V_104 ( V_45 -> V_103 , V_45 ) ;
return 0 ;
}
static int T_11 F_141 ( void )
{
F_142 ( V_272 L_54 , V_133 ,
V_273 , V_135 ) ;
return F_143 ( & V_274 ) ;
}
