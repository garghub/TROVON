...
static int F_14 ( struct V_70 * V_13 , const struct V_1 * V_2 )
{
const struct V_7 * V_8 = F_2 ( V_2 ) ;
switch ( V_8 -> type ) {
case V_58 :
if ( F_15 ( V_13 , V_54 , F_16 ( V_44 ) ) )
goto V_71;
break;
case V_59 :
if ( F_15 ( V_13 , V_54 , F_16 ( V_47 ) ) )
goto V_71;
break;
}
if ( F_15 ( V_13 , V_60 , F_16 ( V_8 -> V_17 ) ) )
goto V_71;
if ( V_8 -> V_16 ) {
if ( F_17 ( V_13 , V_55 ,
V_8 -> V_16 ) ||
...
if ( V_8 -> V_27 != 0 ) {
if ( F_15 ( V_13 , V_68 , F_16 ( V_8 -> V_27 ) ) )
goto V_71;
}
return 0 ;
V_71:
