...
V_292 -> V_41 = V_291 ;
V_291 -> V_53 = V_292 ;
V_292 -> V_139 . V_140 = V_291 -> V_276 ;
V_291 -> V_276 -> V_298 = & V_292 -> V_139 ;
F_83 ( V_291 -> V_276 , F_84 ( V_107 -> V_159 ) ) ;
V_48 -> V_51 [ V_76 ] . V_53 = V_292 ;
F_11 ( V_48 , NULL ) ;
memcpy ( V_291 -> V_55 , V_48 -> V_49 , V_46 ) ;
F_6 ( V_50 , V_48 -> V_49 ) ;
...
V_133 = F_86 ( V_50 , L_89 , & V_294 ) ;
if ( V_133 < 0 ) {
F_10 ( L_90 ) ;
F_85 ( V_292 ) ;
goto exit;
}
if ( V_291 -> V_294 != V_294 ) {
F_10 ( L_91 ,
V_294 , V_291 -> V_294 ) ;
F_85 ( V_292 ) ;
goto exit;
...
F_87 ( & V_48 -> V_254 ) ;
F_88 ( & V_48 -> V_160 . V_195 , F_48 ) ;
F_87 ( & V_48 -> V_160 . V_200 ) ;
F_87 ( & V_48 -> V_189 ) ;
}
exit:
return V_133 ;
...
V_46 ) == 0 ) {
V_299 = F_24 ( V_300 , V_100 ) ;
if ( V_299 != NULL ) {
* ( V_301 * ) V_299 = F_26 ( V_300 ) ;
if ( F_68 ( V_41 , V_302 ,
V_299 , V_300 ) == 0 ) {
V_211 = (struct V_210 * ) ( V_299 + 4 ) ;
...
F_67 ( V_53 -> V_41 , 0 ) ;
F_90 ( V_48 , & V_69 ) ;
V_307 . type = F_15 ( ( T_4 ) V_305 ) ;
V_307 . V_73 = F_15 ( V_69 ) ;
memcpy ( V_307 . V_239 , V_48 -> V_56 , sizeof( V_307 . V_239 ) ) ;
F_92 ( V_107 , V_53 ) ;
V_133 = F_9 ( V_53 -> V_41 , L_94 , & V_307 ,
sizeof( V_307 ) ) ;
if ( V_133 ) {
F_10 ( L_95 , V_133 ) ;
F_92 ( V_107 , NULL ) ;
...
V_133 = F_7 ( V_53 -> V_41 , V_309 ,
V_310 ) ;
return V_133 ;
}
static int F_94 ( struct V_47 * V_48 ,
struct V_40 * V_41 , T_2 V_311 [ V_46 ] ,
enum V_304 V_146 )
{
struct V_306 V_307 ;
int V_133 ;
T_4 V_69 ;
F_90 ( V_48 , & V_69 ) ;
memcpy ( V_307 . V_239 , V_311 , V_46 ) ;
V_307 . type = F_15 ( ( T_4 ) V_146 ) ;
V_307 . V_73 = F_15 ( V_69 ) ;
V_133 = F_9 ( V_41 , L_97 , & V_307 ,
sizeof( V_307 ) ) ;
if ( V_133 )
return V_133 ;
return V_133 ;
}
static int F_95 ( struct V_75 * V_53 )
{
struct V_132 * V_107 = F_96 ( & V_53 -> V_139 ) ;
struct V_134 * V_312 = F_97 ( V_107 ) ;
struct V_40 * V_41 = F_75 ( V_312 ) ;
T_2 * V_239 = V_53 -> V_139 . V_140 -> V_49 ;
return F_9 ( V_41 , L_98 , V_239 , V_46 ) ;
}
static int F_98 ( struct V_75 * V_53 )
{
struct V_132 * V_107 = F_96 ( & V_53 -> V_139 ) ;
struct V_134 * V_312 = F_97 ( V_107 ) ;
struct V_40 * V_41 = F_75 ( V_312 ) ;
...
static struct V_177 * F_99 ( struct V_47 * V_48 ,
struct V_159 * V_159 ,
T_2 * V_239 )
{
struct V_75 * V_292 ;
...
return F_100 ( - V_313 ) ;
V_292 = F_81 ( V_48 -> V_107 , V_297 ,
false ) ;
if ( F_82 ( V_292 ) ) {
F_10 ( L_88 ) ;
return (struct V_177 * ) V_292 ;
}
V_50 = V_48 -> V_51 [ V_52 ] . V_53 -> V_41 ;
F_11 ( V_48 , V_239 ) ;
F_6 ( V_50 , V_48 -> V_49 ) ;
F_92 ( V_48 -> V_107 , V_292 ) ;
V_133 = F_8 ( V_50 , L_24 , 1 ) ;
if ( V_133 < 0 ) {
F_10 ( L_32 ) ;
F_92 ( V_48 -> V_107 , NULL ) ;
goto V_314;
}
V_133 = F_93 ( V_48 -> V_107 , V_315 ,
F_53 ( 1500 ) ) ;
F_92 ( V_48 -> V_107 , NULL ) ;
if ( ! V_133 ) {
F_10 ( L_100 ) ;
...
V_48 -> V_51 [ V_76 ] . V_53 = V_292 ;
memcpy ( V_291 -> V_55 , V_48 -> V_49 , V_46 ) ;
memcpy ( & V_292 -> V_139 . V_316 , V_48 -> V_49 , sizeof( V_48 -> V_49 ) ) ;
V_133 = F_86 ( V_50 , L_89 , & V_294 ) ;
if ( V_133 < 0 ) {
F_10 ( L_90 ) ;
goto V_314;
}
F_101 ( V_291 -> V_294 != V_294 ) ;
F_87 ( & V_48 -> V_254 ) ;
F_88 ( & V_48 -> V_160 . V_195 , F_48 ) ;
F_87 ( & V_48 -> V_160 . V_200 ) ;
F_87 ( & V_48 -> V_189 ) ;
...
struct V_177 * F_104 ( struct V_159 * V_159 , const char * V_317 ,
unsigned char V_318 ,
enum V_319 type , T_1 * V_150 ,
struct V_320 * V_321 )
{
struct V_132 * V_107 = F_35 ( V_159 ) ;
struct V_40 * V_41 = F_75 ( F_97 ( V_107 ) ) ;
struct V_75 * V_53 ;
enum V_304 V_146 ;
int V_133 ;
if ( F_105 ( V_107 ) )
return F_100 ( - V_322 ) ;
F_5 ( V_65 , L_101 , V_317 , type ) ;
switch ( type ) {
case V_323 :
V_146 = V_324 ;
break;
...
break;
case V_297 :
return F_99 ( & V_107 -> V_48 , V_159 ,
V_321 -> V_326 ) ;
default:
return F_100 ( - V_327 ) ;
}
V_53 = F_81 ( V_107 , type , false ) ;
if ( F_82 ( V_53 ) )
return (struct V_177 * ) V_53 ;
F_92 ( V_107 , V_53 ) ;
V_133 = F_94 ( & V_107 -> V_48 , V_41 , V_107 -> V_48 . V_56 ,
V_146 ) ;
if ( V_133 ) {
F_92 ( V_107 , NULL ) ;
goto V_314;
}
V_133 = F_93 ( V_107 , V_315 ,
F_53 ( 1500 ) ) ;
F_92 ( V_107 , NULL ) ;
if ( ! V_133 ) {
F_10 ( L_100 ) ;
...
strncpy ( V_41 -> V_276 -> V_317 , V_317 , sizeof( V_41 -> V_276 -> V_317 ) - 1 ) ;
V_41 -> V_276 -> V_318 = V_318 ;
V_133 = F_106 ( V_41 , true ) ;
if ( V_133 ) {
F_10 ( L_103 ) ;
goto V_314;
}
...
{
struct V_132 * V_107 = F_108 ( V_159 ) ;
struct V_47 * V_48 = & V_107 -> V_48 ;
struct V_75 * V_53 ;
unsigned long V_329 = F_53 ( 1500 ) ;
bool V_330 = false ;
int V_133 ;
F_5 ( V_27 , L_105 ) ;
