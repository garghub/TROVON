...
int V_176 ;
F_111 (i)
F_112 ( * F_113 ( V_2 -> V_3 . F_1 , V_176 ) ) ;
F_114 ( V_2 -> V_3 . F_1 ) ;
V_2 -> V_3 . F_1 = NULL ;
}
static int T_6 F_115 ( struct V_2 * V_2 )
{
int V_176 , V_90 ;
V_2 -> V_3 . F_1 = F_116 ( struct V_1 * ) ;
if ( ! V_2 -> V_3 . F_1 )
return - V_177 ;
F_111 (i) {
struct V_1 * V_4 ;
V_90 = F_117 ( & V_4 , V_178 ,
V_179 , V_82 , V_2 ) ;
if ( V_90 < 0 )
goto V_180;
* F_113 ( V_2 -> V_3 . F_1 , V_176 ) = V_4 ;
V_4 -> V_181 = 2 * F_118 ( 64 * 1024 ) ;
F_119 ( V_4 , V_182 ) ;
F_42 ( V_4 ) -> V_183 = V_184 ;
}
V_2 -> V_3 . V_148 = 0 ;
V_2 -> V_3 . V_171 = 1 ;
V_2 -> V_3 . V_145 = 1 ;
