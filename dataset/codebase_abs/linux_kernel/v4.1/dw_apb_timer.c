...
void F_35 ( struct V_5 * V_60 )
{
unsigned long V_13 = F_4 ( & V_60 -> V_9 , V_14 ) ;
V_13 &= ~ V_33 ;
...
unsigned long V_30 )
{
struct V_5 * V_60 = F_22 ( sizeof( * V_60 ) , V_43 ) ;
if ( ! V_60 )
return NULL ;
V_60 -> V_9 . V_11 = V_11 ;
V_60 -> V_9 . V_30 = V_30 ;
...
V_60 -> V_7 . V_42 = V_42 ;
V_60 -> V_7 . V_63 = F_37 ;
V_60 -> V_7 . V_64 = F_40 ( 32 ) ;
V_60 -> V_7 . V_56 = V_65 ;
V_60 -> V_7 . V_66 = F_38 ;
return V_60 ;
}
void F_41 ( struct V_5 * V_60 )
{
F_42 ( & V_60 -> V_7 , V_60 -> V_9 . V_30 ) ;
}
T_3 F_36 ( struct V_5 * V_60 )
{
return ( T_3 ) ~ F_4 ( & V_60 -> V_9 , V_62 ) ;
}
