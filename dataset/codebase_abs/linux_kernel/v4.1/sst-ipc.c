...
F_15 ( & V_3 -> V_4 [ V_32 ] . V_10 ) ;
F_16 ( & V_3 -> V_4 [ V_32 ] . V_6 , & V_3 -> V_5 ) ;
}
return 0 ;
}
...
V_38 = F_19 ( V_3 -> V_13 , V_39 ) ;
if ( V_38 & ( V_40 | V_41 ) ) {
F_10 ( & V_3 -> V_13 -> V_14 , V_8 ) ;
return;
}
V_4 = F_3 ( & V_3 -> V_29 , struct V_1 , V_6 ) ;
F_20 ( & V_4 -> V_6 , & V_3 -> V_42 ) ;
if ( V_3 -> V_15 . V_43 != NULL )
V_3 -> V_15 . V_43 ( V_3 , V_4 ) ;
F_10 ( & V_3 -> V_13 -> V_14 , V_8 ) ;
}
int F_21 ( struct V_2 * V_3 , T_1 V_20 ,
...
struct V_1 * V_4 ;
T_1 V_44 ;
if ( V_3 -> V_15 . V_45 != NULL )
V_20 = V_3 -> V_15 . V_45 ( V_20 , & V_44 ) ;
if ( F_2 ( & V_3 -> V_42 ) ) {
F_24 ( V_3 -> V_46 , L_2 ,
V_20 ) ;
return NULL ;
}
F_25 (msg, &ipc->rx_list, list) {
if ( ( V_4 -> V_20 & V_44 ) == V_20 )
return V_4 ;
}
return NULL ;
}
...
int V_48 = 0 , V_49 = 0 ;
F_8 ( & V_3 -> V_13 -> V_14 , V_8 ) ;
F_29 (msg, tmp, &ipc->tx_list, list) {
F_20 ( & V_4 -> V_6 , & V_3 -> V_5 ) ;
V_48 ++ ;
}
F_29 (msg, tmp, &ipc->rx_list, list) {
F_20 ( & V_4 -> V_6 , & V_3 -> V_5 ) ;
V_49 ++ ;
}
F_10 ( & V_3 -> V_13 -> V_14 , V_8 ) ;
