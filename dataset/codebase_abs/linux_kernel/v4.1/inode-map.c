...
if ( ! V_55 )
break;
V_53 = F_36 ( V_55 , struct V_52 , V_57 ) ;
F_37 ( V_53 -> V_58 ) ;
...
return - V_19 ;
V_81 = V_78 -> V_88 ;
V_78 -> V_88 = & V_3 -> V_5 -> V_89 ;
V_82 = V_78 -> V_90 ;
V_78 -> V_90 = F_52 ( V_3 , 10 ) ;
V_17 = F_53 ( V_3 , V_78 -> V_88 ,
V_78 -> V_90 ,
V_91 ) ;
if ( V_17 )
goto V_29;
F_54 ( V_3 -> V_5 , L_4 ,
V_78 -> V_92 , V_78 -> V_90 , 1 ) ;
V_27:
V_79 = F_55 ( V_3 , V_12 ) ;
if ( F_26 ( V_79 ) && ( F_56 ( V_79 ) != - V_93 || V_85 ) ) {
V_17 = F_56 ( V_79 ) ;
goto V_94;
}
if ( F_26 ( V_79 ) ) {
F_37 ( V_85 ) ;
V_85 = true ;
V_17 = F_57 ( V_3 , V_78 , V_12 ) ;
if ( V_17 )
goto V_94;
goto V_27;
}
F_58 ( V_79 ) -> V_95 = 0 ;
V_17 = F_59 ( V_78 , V_3 , V_79 ) ;
if ( V_17 ) {
F_60 ( V_78 , V_3 , V_17 ) ;
goto V_96;
}
if ( F_61 ( V_79 ) > 0 ) {
V_17 = F_62 ( V_3 , V_78 , NULL , V_79 ) ;
if ( V_17 ) {
if ( V_17 != - V_46 )
F_60 ( V_78 , V_3 , V_17 ) ;
goto V_96;
...
F_19 ( & V_3 -> V_36 ) ;
F_18 ( & V_7 -> V_68 ) ;
V_84 = sizeof( struct V_52 ) * V_7 -> V_67 ;
V_84 = F_42 ( V_84 , V_66 ) ;
V_84 += V_7 -> V_65 * V_66 ;
F_19 ( & V_7 -> V_68 ) ;
V_84 += 8 * V_66 ;
...
F_66 ( V_79 , V_84 ) ;
V_17 = F_67 ( V_3 , V_78 , V_12 , V_79 ) ;
V_96:
F_68 ( V_79 ) ;
V_94:
F_54 ( V_3 -> V_5 , L_4 ,
V_78 -> V_92 , V_78 -> V_90 , 0 ) ;
F_69 ( V_3 , V_78 -> V_88 , V_78 -> V_90 ) ;
V_29:
V_78 -> V_88 = V_81 ;
V_78 -> V_90 = V_82 ;
F_21 ( V_12 ) ;
...
V_98 . type = - 1 ;
V_98 . V_25 = ( T_1 ) - 1 ;
V_17 = F_5 ( NULL , V_3 , & V_98 , V_12 , 0 , 0 ) ;
if ( V_17 < 0 )
goto error;
F_37 ( V_17 == 0 ) ;
if ( V_12 -> V_31 [ 0 ] > 0 ) {
