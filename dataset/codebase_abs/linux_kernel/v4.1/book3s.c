...
int F_35 ( struct V_1 * V_2 , unsigned int V_59 )
{
int V_60 = 1 ;
int V_18 = 0 ;
bool V_15 = F_9 ( V_2 ) ;
...
int F_115 ( struct V_9 * V_9 , unsigned long V_213 )
{
return V_9 -> V_3 . V_121 -> V_214 ( V_9 , V_213 ) ;
}
int F_116 ( struct V_9 * V_9 , unsigned long V_215 , unsigned long V_216 )
{
return V_9 -> V_3 . V_121 -> V_217 ( V_9 , V_215 , V_216 ) ;
}
int F_117 ( struct V_9 * V_9 , unsigned long V_215 , unsigned long V_216 )
{
return V_9 -> V_3 . V_121 -> V_218 ( V_9 , V_215 , V_216 ) ;
}
int F_118 ( struct V_9 * V_9 , unsigned long V_213 )
{
return V_9 -> V_3 . V_121 -> V_219 ( V_9 , V_213 ) ;
}
void F_119 ( struct V_9 * V_9 , unsigned long V_213 , T_7 V_98 )
{
...
void F_124 ( struct V_9 * V_9 )
{
V_9 -> V_3 . V_121 -> V_225 ( V_9 ) ;
#ifdef F_122
F_125 ( V_9 ) ;
F_126 ( ! F_127 ( & V_9 -> V_3 . V_222 ) ) ;
#endif
}
...
T_2 V_228 ;
int V_229 ;
if ( ! F_129 ( V_226 ) || ( V_226 > sizeof( V_228 ) ) )
return V_230 ;
V_229 = F_130 ( V_2 , V_231 , V_227 , V_226 , & V_228 ) ;
if ( V_229 != 0 )
return V_230 ;
switch ( V_226 ) {
case 1 :
F_84 ( V_2 , 4 , * ( V_232 * ) & V_228 ) ;
break;
case 2 :
F_84 ( V_2 , 4 , F_131 ( * ( V_233 * ) & V_228 ) ) ;
break;
case 4 :
F_84 ( V_2 , 4 , F_132 ( * ( V_234 * ) & V_228 ) ) ;
break;
case 8 :
F_84 ( V_2 , 4 , F_133 ( * ( V_235 * ) & V_228 ) ) ;
break;
default:
F_134 () ;
}
...
break;
case 2 :
* ( V_233 * ) & V_228 = F_136 ( V_148 ) ;
break;
case 4 :
* ( V_234 * ) & V_228 = F_137 ( V_148 ) ;
break;
case 8 :
* ( V_235 * ) & V_228 = F_138 ( V_148 ) ;
break;
default:
return V_230 ;
}
V_229 = F_139 ( V_2 , V_231 , V_227 , V_226 , & V_228 ) ;
if ( V_229 != 0 )
return V_230 ;
return V_236 ;
}
...
int F_141 ( struct V_9 * V_9 , unsigned long V_237 )
{
return V_9 -> V_3 . V_121 -> V_238 ( V_237 ) ;
}
static int F_142 ( void )
{
int V_106 ;
V_106 = F_143 ( NULL , sizeof( struct V_1 ) , 0 , V_239 ) ;
if ( V_106 )
return V_106 ;
#ifdef F_144
V_106 = F_145 () ;
