...
static int F_27 ( struct V_50 * V_51 , struct V_1 * V_2 )
{
struct V_3 V_4 ;
if ( ( ! V_2 -> V_17 [ V_19 ] ) ||
( ! V_2 -> V_17 [ V_18 ] ) ||
...
static int F_29 ( struct V_50 * V_51 , struct V_1 * V_2 )
{
char * V_21 ;
struct V_3 V_4 ;
if ( ! V_2 -> V_17 [ V_19 ] )
...
static int F_31 ( struct V_12 * V_13 , void * V_65 )
{
int V_5 = - V_15 ;
struct V_66 * V_67 = V_65 ;
void * V_68 ;
V_68 = F_32 ( V_67 -> V_51 , F_33 ( V_67 -> V_69 -> V_51 ) . V_70 ,
V_67 -> V_71 , & V_72 ,
V_73 , V_74 ) ;
if ( V_68 == NULL )
goto V_75;
...
static int F_39 ( struct V_50 * V_51 , struct V_1 * V_2 )
{
struct V_3 V_4 ;
F_28 ( V_51 , & V_4 ) ;
return F_40 ( & V_4 ) ;
}
static int F_41 ( struct V_50 * V_51 , struct V_1 * V_2 )
{
int V_5 = - V_15 ;
...
int V_5 = - V_15 ;
void * V_68 ;
V_68 = F_32 ( V_51 , F_33 ( V_77 -> V_51 ) . V_70 , V_77 -> V_80 -> V_81 ,
& V_72 , V_73 ,
V_90 ) ;
if ( V_68 == NULL )
goto V_91;
...
static int F_51 ( struct V_50 * V_51 , struct V_1 * V_2 )
{
int V_5 = - V_15 ;
struct V_50 * V_83 = NULL ;
void * V_68 ;
