...
if ( V_51 ) {
V_2 -> V_68 = F_33 ( V_51 -> V_69 ) ;
F_34 ( V_2 , V_51 -> V_70 ) ;
}
if ( V_28 -> V_38 != V_28 -> V_9 ) {
V_39 = F_35 ( V_53 , V_28 -> V_9 , V_2 ) ;
if ( V_39 < 0 )
goto V_37;
}
V_39 = F_22 ( V_2 ) ;
...
if ( F_38 ( V_2 -> V_7 -> V_17 , V_71 ) ||
F_38 ( V_2 -> V_7 -> V_17 , V_72 ) )
F_39 ( V_2 -> V_7 ) ;
if ( F_9 ( V_2 -> V_7 -> V_17 ) ) {
V_2 -> V_7 -> V_17 [ 0 ] |= 0x02 ;
V_2 -> V_7 -> V_17 [ 0 ] &= 0xbf ;
...
static void F_40 ( struct V_1 * V_2 , struct V_34 * V_30 )
{
struct V_27 * V_28 = ( void * ) & V_2 -> V_9 ;
struct V_35 * V_53 = F_30 ( V_30 ) ;
struct V_34 * V_75 ;
if ( V_28 -> V_36 && V_28 -> V_36 -> V_76 )
V_28 -> V_36 -> V_76 ( V_28 -> V_38 ) ;
if ( V_30 == V_28 -> V_38 )
V_75 = V_28 -> V_9 ;
else
V_75 = V_28 -> V_38 ;
...
static int F_41 ( struct V_34 * V_30 , T_4 V_77 )
{
struct V_1 * V_2 = F_21 ( V_30 ) ;
struct V_27 * V_28 = ( void * ) & V_2 -> V_9 ;
int V_21 ;
...
struct V_27 * V_28 = ( void * ) & V_2 -> V_9 ;
int V_21 = 0 ;
bool V_79 = ( V_30 == V_28 -> V_38 && V_28 -> V_36 &&
V_28 -> V_36 -> V_80 ) ;
if ( V_79 )
V_21 = V_28 -> V_36 -> V_80 ( V_30 ) ;
if ( V_21 < 0 )
goto V_37;
V_21 = F_43 ( V_30 ) ;
if ( V_21 < 0 && V_79 )
V_28 -> V_36 -> V_78 ( V_30 , V_81 ) ;
V_37:
return V_21 ;
}
...
{
struct V_82 * V_84 = (struct V_82 * ) V_83 ;
if ( ! V_84 -> V_85 ) {
F_14 ( & V_30 -> V_2 , L_10 ) ;
V_84 -> V_85 = ( unsigned long ) & V_86 ;
}
return F_46 ( V_30 , V_84 ) ;
}
