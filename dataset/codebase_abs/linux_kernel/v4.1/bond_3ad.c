...
V_5 -> V_34 -> V_209 ) ) {
F_19 ( V_5 ) . V_172 = 0 ;
F_19 ( V_5 ) . system . V_210 = 0xFFFF ;
F_19 ( V_5 ) . system . V_208 = * ( (struct V_211 * ) V_5 -> V_34 -> V_209 ) ;
V_44 = V_207 ;
F_70 ( V_5 ,
V_212 *
V_44 ) ;
...
V_2 -> V_3 = V_3 ;
V_2 -> V_35 = F_6 ( V_3 ) -> V_213 ;
V_2 -> V_178 = 0 ;
V_2 -> V_178 |= F_22 ( V_2 ) ;
V_2 -> V_178 |= ( F_20 ( V_2 ) << 1 ) ;
V_2 -> V_60 = V_2 -> V_178 ;
if ( ! ( V_2 -> V_60 & V_144 ) )
V_2 -> V_65 &= ~ V_142 ;
...
V_4 = & ( F_6 ( V_3 ) -> V_4 ) ;
F_66 ( V_4 ) ;
V_4 -> V_187 = * ( (struct V_211 * ) V_5 -> V_34 -> V_209 ) ;
...
{
struct V_2 * V_2 , * V_214 , * V_215 ;
struct V_4 * V_4 , * V_216 , * V_167 ;
int V_217 = 0 ;
...
if ( ! V_218 )
V_216 = NULL ;
if ( ( V_216 ) && ( ( ! V_216 -> V_87 ) || ( ( V_216 -> V_87 == V_2 ) && ! V_216 -> V_87 -> V_88 ) ) ) {
F_21 ( V_5 -> V_34 , L_31 ,
V_4 -> V_172 ,
V_216 -> V_172 ) ;
if ( ( V_216 -> V_87 == V_2 ) &&
...
V_216 -> V_176 = V_4 -> V_176 ;
V_216 -> V_177 = V_4 -> V_177 ;
V_216 -> V_173 = V_4 -> V_173 ;
V_216 -> V_8 = V_4 -> V_8 ;
V_216 -> V_57 = V_4 -> V_57 ;
V_216 -> V_174 = V_4 -> V_174 ;
V_216 -> V_179 = V_4 -> V_179 ;
V_216 -> V_180 = V_4 -> V_180 ;
V_216 -> V_87 = V_4 -> V_87 ;
V_216 -> V_97 = V_4 -> V_97 ;
V_216 -> V_93 = V_4 -> V_93 ;
for ( V_215 = V_4 -> V_87 ; V_215 ;
V_215 = V_215 -> V_88 ) {
V_215 -> V_4 = V_216 ;
V_215 -> V_171 = V_216 -> V_172 ;
}
F_57 ( V_4 ) ;
if ( V_217 )
F_60 ( F_3 ( V_2 ) ,
...
V_167 = & ( F_6 ( V_218 ) -> V_4 ) ;
V_214 = NULL ;
for ( V_215 = V_167 -> V_87 ; V_215 ;
V_214 = V_215 ,
V_215 = V_215 -> V_88 ) {
if ( V_215 == V_2 ) {
if ( V_214 )
V_214 -> V_88 = V_215 -> V_88 ;
else
V_167 -> V_87 = V_215 -> V_88 ;
V_167 -> V_93 -- ;
if ( V_167 -> V_93 == 0 ) {
V_217 = V_167 -> V_97 ;
F_57 ( V_167 ) ;
...
void F_78 ( struct V_222 * V_223 )
{
struct V_1 * V_5 = F_79 ( V_223 , struct V_1 ,
V_224 . V_223 ) ;
struct V_4 * V_4 ;
struct V_95 * V_96 ;
struct V_3 * V_3 ;
...
F_85 ( V_5 -> V_229 , & V_5 -> V_224 , V_230 ) ;
}
static int F_86 ( struct V_52 * V_52 , struct V_3 * V_3 ,
T_2 V_101 )
{
struct V_2 * V_2 ;
int V_231 = V_232 ;
...
V_2 = & ( F_6 ( V_3 ) -> V_2 ) ;
if ( ! V_2 -> V_3 ) {
F_75 ( V_3 -> V_5 -> V_34 , L_46 ,
V_3 -> V_34 -> V_79 ) ;
return;
}
F_74 ( & V_3 -> V_5 -> V_220 ) ;
V_2 -> V_178 &= ~ ( V_144 | V_237 ) ;
if ( V_11 == V_12 ) {
V_2 -> V_135 = true ;
V_2 -> V_178 |=
( F_20 ( V_2 ) << 1 ) | F_22 ( V_2 ) ;
...
if ( ! V_4 )
return - 1 ;
V_239 -> V_240 = V_4 -> V_172 ;
V_239 -> V_241 = V_4 -> V_93 ;
V_239 -> V_75 = V_4 -> V_173 ;
V_239 -> V_59 = V_4 -> V_174 ;
F_44 ( V_239 -> V_8 ,
V_4 -> V_8 . V_9 ) ;
return 0 ;
}
int F_96 ( struct V_1 * V_5 , struct V_239 * V_239 )
{
int V_231 ;
F_4 () ;
V_231 = F_95 ( V_5 , V_239 ) ;
F_7 () ;
return V_231 ;
}
...
struct V_3 * V_3 )
{
struct V_52 * V_52 , V_242 ;
if ( V_99 -> V_106 != V_107 )
return V_232 ;
if ( ! F_26 ( F_98 ( V_99 ) -> V_111 , V_112 ) )
return V_232 ;
V_52 = F_99 ( V_99 , 0 , sizeof( V_242 ) , & V_242 ) ;
if ( ! V_52 )
return V_232 ;
return F_86 ( V_52 , V_3 , V_99 -> V_243 ) ;
}
