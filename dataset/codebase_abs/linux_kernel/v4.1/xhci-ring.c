...
if ( V_228 )
return;
F_15 ( V_10 , L_80 , V_247 ) ;
F_114 ( V_248 , & V_111 -> V_136 ) ;
F_47 ( & V_10 -> V_122 ) ;
F_118 ( V_111 ) ;
F_50 ( & V_10 -> V_122 ) ;
}
...
if ( V_251 >= V_253 && V_251 <= V_254 )
return V_102 ;
}
V_102 = V_102 -> V_14 ;
V_253 = F_1 ( V_102 , & V_102 -> V_6 [ 0 ] ) ;
} while ( V_102 != V_104 );
return NULL ;
}
...
unsigned int V_56 , unsigned int V_57 ,
unsigned int V_58 ,
struct V_77 * V_256 , union V_3 * V_257 )
{
struct V_60 * V_61 = & V_10 -> V_62 [ V_56 ] -> V_63 [ V_57 ] ;
struct V_160 * V_161 ;
V_161 = F_73 ( V_10 , false , false , V_162 ) ;
...
int F_124 ( struct V_9 * V_10 , unsigned int V_259 )
{
...
static int F_125 ( struct V_9 * V_10 , struct V_77 * V_256 ,
union V_3 * V_257 , struct V_264 * V_124 ,
struct V_60 * V_61 , int * V_109 , bool V_265 )
{
struct V_81 * V_266 ;
struct V_11 * V_82 ;
unsigned int V_56 ;
...
V_266 = V_10 -> V_62 [ V_56 ] ;
V_57 = F_126 ( F_3 ( V_124 -> V_136 ) ) - 1 ;
V_82 = F_127 ( V_61 , F_35 ( V_124 -> V_267 ) ) ;
V_95 = F_36 ( V_10 , V_266 -> V_96 , V_57 ) ;
V_259 = F_98 ( F_3 ( V_124 -> V_268 ) ) ;
if ( V_265 )
goto V_269;
if ( V_259 == V_270 || V_259 == V_271 ) {
V_61 -> V_130 = V_256 ;
return 0 ;
}
if ( V_259 == V_272 ||
...
V_82 -> V_58 , V_256 , V_257 ) ;
} else {
while ( V_82 -> V_24 != V_256 -> F_4 )
F_8 ( V_10 , V_82 ) ;
F_8 ( V_10 , V_82 ) ;
}
V_269:
V_74 = V_256 -> V_74 ;
V_112 = V_74 -> V_113 ;
if ( V_74 -> V_273 > V_74 -> V_274 ) {
F_30 ( V_10 , L_84 ,
V_74 -> V_274 ,
V_74 -> V_273 ) ;
V_74 -> V_273 = 0 ;
if ( V_256 -> V_74 -> V_275 & V_276 )
* V_109 = - V_277 ;
else
* V_109 = 0 ;
}
...
static int F_128 ( struct V_9 * V_10 , struct V_77 * V_256 ,
union V_3 * V_257 , struct V_264 * V_124 ,
...
case V_270 :
case V_271 :
return F_125 ( V_10 , V_256 , V_257 , V_124 , V_61 , V_109 , false ) ;
default:
if ( ! F_123 ( V_10 ,
V_95 , V_259 ) )
break;
...
static int F_130 ( struct V_9 * V_10 , struct V_77 * V_256 ,
union V_3 * V_257 , struct V_264 * V_124 ,
struct V_60 * V_61 , int * V_109 )
{
struct V_11 * V_82 ;
...
V_82 = F_127 ( V_61 , F_35 ( V_124 -> V_267 ) ) ;
V_259 = F_98 ( F_3 ( V_124 -> V_268 ) ) ;
V_112 = V_256 -> V_74 -> V_113 ;
V_281 = V_112 -> V_114 ;
V_284 = & V_256 -> V_74 -> V_286 [ V_281 ] ;
switch ( V_259 ) {
case V_147 :
if ( F_129 ( F_3 ( V_124 -> V_268 ) ) == 0 ) {
V_284 -> V_109 = 0 ;
break;
}
if ( ( V_10 -> V_35 & V_287 ) )
V_259 = V_278 ;
case V_278 :
V_284 -> V_109 = V_256 -> V_74 -> V_275 & V_276 ?
- V_277 : 0 ;
break;
case V_288 :
V_284 -> V_109 = - V_289 ;
...
if ( V_259 == V_147 || V_285 ) {
V_284 -> V_273 = V_284 -> V_116 ;
V_256 -> V_74 -> V_273 += V_284 -> V_116 ;
} else {
for ( V_103 = V_82 -> V_24 ,
V_102 = V_82 -> V_23 ; V_103 != V_257 ;
F_7 ( V_10 , V_82 , & V_102 , & V_103 ) ) {
if ( ! F_131 ( V_103 -> V_29 . V_30 [ 3 ] ) &&
! F_5 ( V_103 -> V_29 . V_30 [ 3 ] ) )
V_282 += F_132 ( F_3 ( V_103 -> V_29 . V_30 [ 2 ] ) ) ;
}
V_282 += F_132 ( F_3 ( V_103 -> V_29 . V_30 [ 2 ] ) ) -
F_129 ( F_3 ( V_124 -> V_268 ) ) ;
if ( V_259 != V_270 ) {
V_284 -> V_273 = V_282 ;
V_256 -> V_74 -> V_273 += V_282 ;
}
}
return F_125 ( V_10 , V_256 , V_257 , V_124 , V_61 , V_109 , false ) ;
}
static int F_133 ( struct V_9 * V_10 , struct V_77 * V_256 ,
struct V_264 * V_124 ,
struct V_60 * V_61 , int * V_109 )
{
struct V_11 * V_82 ;
...
F_8 ( V_10 , V_82 ) ;
F_8 ( V_10 , V_82 ) ;
return F_125 ( V_10 , V_256 , NULL , V_124 , V_61 , V_109 , true ) ;
}
static int F_134 ( struct V_9 * V_10 , struct V_77 * V_256 ,
union V_3 * V_257 , struct V_264 * V_124 ,
struct V_60 * V_61 , int * V_109 )
{
struct V_11 * V_82 ;
...
F_137 () ;
switch ( ( F_3 ( V_124 -> V_209 . V_136 ) & V_297 ) ) {
case F_38 ( V_298 ) :
F_95 ( V_10 , & V_124 -> V_209 ) ;
break;
case F_38 ( V_299 ) :
...
break;
default:
if ( ( F_3 ( V_124 -> V_209 . V_136 ) & V_297 ) >=
F_38 ( 48 ) )
F_101 ( V_10 , V_124 ) ;
else
V_10 -> V_173 |= 1 << 3 ;
...
if ( V_111 -> V_309 ) {
T_2 V_310 ;
V_310 = F_17 ( & V_10 -> V_311 -> V_310 ) ;
V_310 |= V_312 ;
F_16 ( V_310 , & V_10 -> V_311 -> V_310 ) ;
}
if ( V_10 -> V_53 & V_54 ) {
F_15 ( V_10 , L_101
L_102 ) ;
V_46 = F_19 ( V_10 , & V_10 -> V_311 -> V_313 ) ;
F_20 ( V_10 , V_46 | V_314 ,
& V_10 -> V_311 -> V_313 ) ;
F_47 ( & V_10 -> V_122 ) ;
return V_308 ;
}
V_303 = V_10 -> V_13 -> V_24 ;
while ( F_136 ( V_10 ) > 0 ) {}
V_46 = F_19 ( V_10 , & V_10 -> V_311 -> V_313 ) ;
if ( V_303 != V_10 -> V_13 -> V_24 ) {
...
L_104 ) ;
V_46 &= V_315 ;
V_46 |= ( ( T_3 ) V_97 & ( T_3 ) ~ V_315 ) ;
}
V_46 |= V_314 ;
F_20 ( V_10 , V_46 , & V_10 -> V_311 -> V_313 ) ;
F_47 ( & V_10 -> V_122 ) ;
return V_308 ;
}
T_7 F_140 ( int V_309 , void * V_111 )
{
return F_138 ( V_111 ) ;
}
...
struct V_194 * V_4 ;
V_4 = & V_12 -> V_20 -> V_29 ;
V_4 -> V_30 [ 0 ] = F_11 ( V_316 ) ;
V_4 -> V_30 [ 1 ] = F_11 ( V_317 ) ;
V_4 -> V_30 [ 2 ] = F_11 ( V_318 ) ;
V_4 -> V_30 [ 3 ] = F_11 ( V_319 ) ;
F_9 ( V_10 , V_12 , V_27 ) ;
}
static int F_142 ( struct V_9 * V_10 , struct V_11 * V_82 ,
T_2 V_64 , unsigned int V_38 , T_8 V_320 )
{
unsigned int V_321 ;
switch ( V_64 ) {
case V_322 :
...
F_34 ( V_10 , V_329 ,
L_110 ) ;
V_321 = V_38 - V_82 -> V_25 ;
if ( F_143 ( V_10 , V_82 , V_321 ,
V_320 ) ) {
F_22 ( V_10 , L_111 ) ;
return - V_328 ;
}
...
struct V_77 * V_256 ;
struct V_11 * V_82 ;
struct V_94 * V_95 = F_36 ( V_10 , V_266 -> V_96 , V_57 ) ;
V_82 = F_69 ( V_266 , V_57 , V_58 ) ;
if ( ! V_82 ) {
F_15 ( V_10 , L_112 ,
V_58 ) ;
return - V_325 ;
...
V_256 -> V_74 = V_74 ;
F_147 ( & V_256 -> V_69 , & V_82 -> V_69 ) ;
V_256 -> V_104 = V_82 -> V_32 ;
V_256 -> V_105 = V_82 -> V_20 ;
V_112 -> V_256 [ V_330 ] = V_256 ;
return 0 ;
}
static unsigned int F_148 ( struct V_9 * V_10 , struct V_74 * V_74 )
{
int V_331 , V_38 , V_332 , V_221 , V_134 ;
struct V_333 * V_334 ;
V_334 = NULL ;
V_331 = V_74 -> V_335 ;
V_221 = V_74 -> V_274 ;
...
unsigned int V_282 = F_150 ( V_334 ) ;
V_332 = V_336 -
( F_151 ( V_334 ) & ( V_336 - 1 ) ) ;
V_332 &= V_336 - 1 ;
if ( V_332 != 0 )
V_38 ++ ;
while ( V_332 < F_150 ( V_334 ) && V_332 < V_221 ) {
V_38 ++ ;
V_332 += V_336 ;
}
V_282 = F_152 ( int , V_282 , V_221 ) ;
V_221 -= V_282 ;
if ( V_221 == 0 )
break;
}
...
static void F_153 ( struct V_74 * V_74 , int V_38 , int V_332 )
{
if ( V_38 != 0 )
F_154 ( & V_74 -> V_75 -> V_75 , L_113
L_114 , V_247 ,
V_74 -> V_61 -> V_76 . V_295 , V_38 ) ;
if ( V_332 != V_74 -> V_274 )
F_154 ( & V_74 -> V_75 -> V_75 , L_115
L_116 ,
V_247 ,
V_74 -> V_61 -> V_76 . V_295 ,
V_332 , V_332 ,
V_74 -> V_274 ,
V_74 -> V_274 ) ;
}
static void F_155 ( struct V_9 * V_10 , int V_56 ,
unsigned int V_57 , unsigned int V_58 , int V_337 ,
struct V_194 * V_249 )
{
F_12 () ;
if ( V_337 )
V_249 -> V_30 [ 3 ] |= F_11 ( V_337 ) ;
else
V_249 -> V_30 [ 3 ] &= F_11 ( ~ V_37 ) ;
F_25 ( V_10 , V_56 , V_57 , V_58 ) ;
}
int F_156 ( struct V_9 * V_10 , T_8 V_320 ,
...
int V_338 ;
int V_339 ;
V_338 = F_157 ( F_3 ( V_95 -> V_151 ) ) ;
V_339 = V_74 -> V_340 ;
if ( V_74 -> V_75 -> V_215 == V_341 ||
V_74 -> V_75 -> V_215 == V_342 )
V_339 *= 8 ;
if ( V_338 != V_339 ) {
F_158 ( & V_74 -> V_75 -> V_75 ,
L_117 ,
V_339 , V_339 == 1 ? L_118 : L_119 ,
V_338 , V_338 == 1 ? L_118 : L_119 ) ;
V_74 -> V_340 = V_338 ;
if ( V_74 -> V_75 -> V_215 == V_341 ||
V_74 -> V_75 -> V_215 == V_342 )
V_74 -> V_340 /= 8 ;
}
return F_159 ( V_10 , V_320 , V_74 , V_56 , V_57 ) ;
}
static T_2 F_160 ( unsigned int V_343 )
{
T_2 V_344 = ( 1 << ( 21 - 17 + 1 ) ) - 1 ;
if ( ( V_343 >> 10 ) >= V_344 )
return V_344 << 17 ;
else
return ( V_343 >> 10 ) << 17 ;
}
static T_2 F_161 ( int V_332 , int V_345 ,
unsigned int V_346 , struct V_74 * V_74 ,
unsigned int V_347 )
{
int V_348 ;
if ( V_347 == 0 || ( V_332 == 0 && V_345 == 0 ) )
return 0 ;
V_348 = ( V_332 + V_345 ) /
F_162 ( F_163 ( & V_74 -> V_61 -> V_76 ) ) ;
if ( ( V_346 - V_348 ) > 31 )
return 31 << 17 ;
return ( V_346 - V_348 ) << 17 ;
}
static int F_164 ( struct V_9 * V_10 , T_8 V_320 ,
struct V_74 * V_74 , int V_56 , unsigned int V_57 )
{
struct V_11 * V_82 ;
unsigned int V_38 ;
...
V_331 = V_74 -> V_335 ;
V_346 = F_165 ( V_74 -> V_274 ,
F_163 ( & V_74 -> V_61 -> V_76 ) ) ;
V_345 = F_144 ( V_10 , V_10 -> V_62 [ V_56 ] ,
V_57 , V_74 -> V_58 ,
V_38 , V_74 , 0 , V_320 ) ;
if ( V_345 < 0 )
return V_345 ;
V_112 = V_74 -> V_113 ;
V_256 = V_112 -> V_256 [ 0 ] ;
V_249 = & V_82 -> V_20 -> V_29 ;
V_337 = V_82 -> V_26 ;
V_332 = 0 ;
V_334 = V_74 -> V_334 ;
V_85 = ( T_3 ) F_151 ( V_334 ) ;
V_349 = F_150 ( V_334 ) ;
V_345 = V_336 - ( V_85 & ( V_336 - 1 ) ) ;
V_345 = F_152 ( int , V_345 , V_349 ) ;
if ( V_345 > V_74 -> V_274 )
V_345 = V_74 -> V_274 ;
V_105 = true ;
do {
...
F_30 ( V_10 , L_120 ) ;
F_15 ( V_10 , L_121 ,
( unsigned int ) ( V_85 + V_336 ) & ~ ( V_336 - 1 ) ,
( unsigned int ) V_85 + V_345 ) ;
}
if ( V_10 -> V_353 < 0x100 ) {
V_343 = F_160 (
V_74 -> V_274 -
...
( V_85 & ( V_336 - 1 ) ) ;
V_345 = F_152 ( int , V_345 , V_349 ) ;
if ( V_332 + V_345 > V_74 -> V_274 )
V_345 =
V_74 -> V_274 - V_332 ;
} while ( V_332 < V_74 -> V_274 );
F_153 ( V_74 , V_38 , V_332 ) ;
F_155 ( V_10 , V_56 , V_57 , V_74 -> V_58 ,
V_337 , V_249 ) ;
return 0 ;
}
int F_159 ( struct V_9 * V_10 , T_8 V_320 ,
struct V_74 * V_74 , int V_56 , unsigned int V_57 )
{
struct V_11 * V_82 ;
struct V_112 * V_112 ;
...
int V_337 ;
T_2 V_30 , V_350 ;
int V_332 , V_345 , V_47 ;
unsigned int V_346 ;
T_3 V_85 ;
if ( V_74 -> V_331 )
return F_164 ( V_10 , V_320 , V_74 , V_56 , V_57 ) ;
V_82 = F_31 ( V_10 , V_74 ) ;
if ( ! V_82 )
return - V_325 ;
V_38 = 0 ;
...
int F_171 ( struct V_9 * V_10 , T_8 V_320 ,
struct V_74 * V_74 , int V_56 , unsigned int V_57 )
{
struct V_11 * V_82 ;
int V_38 ;
...
V_249 = & V_82 -> V_20 -> V_29 ;
V_337 = V_82 -> V_26 ;
V_357 = (struct V_356 * ) V_74 -> V_358 ;
V_30 = 0 ;
V_30 |= V_359 | F_38 ( V_360 ) ;
if ( V_337 == 0 )
V_30 |= 0x1 ;
if ( V_10 -> V_353 == 0x100 ) {
if ( V_74 -> V_274 > 0 ) {
if ( V_357 -> V_361 & V_362 )
V_30 |= F_172 ( V_363 ) ;
else
V_30 |= F_172 ( V_364 ) ;
}
...
V_357 -> V_361 | V_357 -> V_365 << 8 | F_173 ( V_357 -> V_366 ) << 16 ,
F_173 ( V_357 -> V_367 ) | F_173 ( V_357 -> V_368 ) << 16 ,
F_132 ( 8 ) | F_167 ( 0 ) ,
V_30 ) ;
if ( F_166 ( V_74 ) )
V_30 = V_352 | F_38 ( V_369 ) ;
else
V_30 = F_38 ( V_369 ) ;
V_350 = F_132 ( V_74 -> V_274 ) |
F_160 ( V_74 -> V_274 ) |
F_167 ( 0 ) ;
if ( V_74 -> V_274 > 0 ) {
if ( V_357 -> V_361 & V_362 )
...
V_256 -> F_4 = V_82 -> V_20 ;
if ( V_74 -> V_274 > 0 && V_357 -> V_361 & V_362 )
V_30 = 0 ;
else
V_30 = V_370 ;
...
0 ,
F_167 ( 0 ) ,
V_30 | V_351 | F_38 ( V_371 ) | V_82 -> V_26 ) ;
...
int V_38 = 0 ;
T_3 V_85 , V_372 ;
V_85 = ( T_3 ) ( V_74 -> V_355 + V_74 -> V_286 [ V_134 ] . V_373 ) ;
V_372 = V_74 -> V_286 [ V_134 ] . V_116 ;
V_38 = F_165 ( V_372 + ( V_85 & ( V_336 - 1 ) ) ,
V_336 ) ;
if ( V_38 == 0 )
V_38 ++ ;
return V_38 ;
...
struct V_217 * V_218 ,
struct V_74 * V_74 , unsigned int V_346 )
{
unsigned int V_374 ;
if ( V_10 -> V_353 < 0x100 || V_218 -> V_215 != V_375 )
return 0 ;
V_374 = V_74 -> V_61 -> V_376 . V_377 ;
return F_165 ( V_346 , V_374 + 1 ) - 1 ;
}
...
static int F_177 ( struct V_9 * V_10 , T_8 V_320 ,
struct V_74 * V_74 , int V_56 , unsigned int V_57 )
{
struct V_11 * V_82 ;
struct V_112 * V_112 ;
...
int V_337 ;
T_2 V_30 , V_350 ;
int V_332 , V_345 , V_372 , V_381 , V_47 ;
T_3 V_382 , V_85 ;
int V_134 , V_135 ;
bool V_27 ;
...
V_382 = ( T_3 ) V_74 -> V_355 ;
V_249 = & V_82 -> V_20 -> V_29 ;
V_337 = V_82 -> V_26 ;
V_112 = V_74 -> V_113 ;
for ( V_134 = 0 ; V_134 < V_379 ; V_134 ++ ) {
unsigned int V_346 ;
unsigned int V_384 ;
unsigned int V_378 ;
V_105 = true ;
V_332 = 0 ;
V_85 = V_382 + V_74 -> V_286 [ V_134 ] . V_373 ;
V_372 = V_74 -> V_286 [ V_134 ] . V_116 ;
V_381 = V_372 ;
V_346 = F_165 ( V_372 ,
F_162 (
...
if ( V_346 == 0 )
V_346 ++ ;
V_384 = F_175 ( V_10 , V_74 -> V_75 , V_74 ,
V_346 ) ;
V_378 = F_176 ( V_10 ,
V_74 -> V_75 , V_74 , V_346 ) ;
V_380 = F_174 ( V_10 , V_74 , V_134 ) ;
V_47 = F_144 ( V_10 , V_10 -> V_62 [ V_56 ] , V_57 ,
V_74 -> V_58 , V_380 , V_74 , V_134 , V_320 ) ;
if ( V_47 < 0 ) {
if ( V_134 == 0 )
return V_47 ;
goto V_146;
}
V_256 = V_112 -> V_256 [ V_134 ] ;
for ( V_135 = 0 ; V_135 < V_380 ; V_135 ++ ) {
T_2 V_343 = 0 ;
V_30 = 0 ;
if ( V_105 ) {
V_30 = F_178 ( V_384 ) |
...
F_57 ( & V_112 -> V_256 [ V_134 ] -> V_69 ) ;
V_112 -> V_256 [ 0 ] -> F_4 = V_82 -> V_20 ;
F_37 ( V_10 , V_82 , V_112 -> V_256 [ 0 ] , true ) ;
V_82 -> V_20 = V_112 -> V_256 [ 0 ] -> V_105 ;
V_82 -> V_32 = V_112 -> V_256 [ 0 ] -> V_104 ;
V_82 -> V_26 = V_337 ;
V_82 -> V_25 = V_82 -> V_140 ;
F_46 ( F_42 ( V_74 -> V_75 -> V_115 ) , V_74 ) ;
return V_47 ;
}
int F_181 ( struct V_9 * V_10 , T_8 V_320 ,
struct V_74 * V_74 , int V_56 , unsigned int V_57 )
{
struct V_81 * V_266 ;
struct V_11 * V_82 ;
...
int V_338 ;
int V_339 ;
int V_379 , V_38 , V_134 ;
int V_47 ;
V_266 = V_10 -> V_62 [ V_56 ] ;
V_82 = V_266 -> V_63 [ V_57 ] . V_12 ;
V_95 = F_36 ( V_10 , V_266 -> V_96 , V_57 ) ;
V_38 = 0 ;
V_379 = V_74 -> V_383 ;
for ( V_134 = 0 ; V_134 < V_379 ; V_134 ++ )
...
return F_177 ( V_10 , V_320 , V_74 , V_56 , V_57 ) ;
}
static int F_182 ( struct V_9 * V_10 , struct V_160 * V_174 ,
T_2 V_316 , T_2 V_317 ,
T_2 V_318 , T_2 V_319 , bool V_393 )
{
int V_394 = V_10 -> V_395 ;
int V_47 ;
if ( V_10 -> V_53 & V_54 )
return - V_55 ;
if ( ! V_393 )
V_394 ++ ;
V_47 = F_142 ( V_10 , V_10 -> V_49 , V_327 ,
V_394 , V_162 ) ;
if ( V_47 < 0 ) {
F_22 ( V_10 , L_124 ) ;
if ( V_393 )
...
F_141 ( V_10 , V_10 -> V_49 , false , V_316 , V_317 , V_318 ,
V_319 | V_10 -> V_49 -> V_26 ) ;
return 0 ;
}
...
T_1 V_396 , T_2 V_56 , enum V_397 V_357 )
{
return F_182 ( V_10 , V_174 , F_168 ( V_396 ) ,
F_169 ( V_396 ) , 0 ,
F_38 ( V_201 ) | F_185 ( V_56 )
| ( V_357 == V_398 ? V_399 : 0 ) , false ) ;
}
int F_187 ( struct V_9 * V_10 , struct V_160 * V_174 ,
T_2 V_316 , T_2 V_317 , T_2 V_318 , T_2 V_319 )
{
return F_182 ( V_10 , V_174 , V_316 , V_317 , V_318 , V_319 , false ) ;
}
...
int V_56 , unsigned int V_57 , int V_400 )
{
T_2 V_401 = F_185 ( V_56 ) ;
T_2 V_402 = F_191 ( V_57 ) ;
T_2 type = F_38 ( V_202 ) ;
T_2 V_403 = F_192 ( V_400 ) ;
return F_182 ( V_10 , V_174 , 0 , 0 , 0 ,
V_401 | V_402 | type | V_403 , false ) ;
}
...
F_168 ( V_85 ) | V_405 | V_128 -> V_98 ,
F_169 ( V_85 ) , V_404 ,
V_401 | V_402 | type , false ) ;
if ( V_47 < 0 ) {
F_195 ( V_10 , V_174 ) ;
return;
}
