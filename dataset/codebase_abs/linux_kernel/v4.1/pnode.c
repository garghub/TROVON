...
int F_35 ( struct V_1 * V_45 , struct V_46 * V_47 ,
struct V_1 * V_48 , struct V_49 * V_50 )
{
struct V_1 * V_12 , * V_34 ;
int V_51 = 0 ;
V_39 = V_52 -> V_53 -> V_13 -> V_39 ;
V_32 = V_45 ;
V_36 = V_48 ;
V_30 = V_47 ;
V_44 = V_50 ;
V_35 = V_45 -> V_15 ;
for ( V_34 = F_1 ( V_45 ) ; V_34 != V_45 ; V_34 = F_1 ( V_34 ) ) {
V_51 = F_24 ( V_34 ) ;
if ( V_51 )
goto V_54;
}
for ( V_12 = F_23 ( V_45 , V_45 ) ; V_12 ;
V_12 = F_23 ( V_12 , V_45 ) ) {
V_34 = V_12 ;
do {
V_51 = F_24 ( V_34 ) ;
...
V_12 = V_34 -> V_37 ;
if ( V_12 -> V_15 != V_45 -> V_15 )
F_37 ( V_12 -> V_15 ) ;
}
F_33 ( & V_42 ) ;
return V_51 ;
}
static inline int F_38 ( struct V_1 * V_7 , int V_55 )
{
return F_39 ( V_7 ) > V_55 ;
}
int F_40 ( struct V_1 * V_7 , int V_56 )
{
struct V_1 * V_12 , * V_29 ;
struct V_1 * V_57 = V_7 -> V_37 ;
int V_51 = 0 ;
if ( V_7 == V_57 )
return F_38 ( V_7 , V_56 ) ;
if ( ! F_10 ( & V_7 -> V_58 ) || F_38 ( V_7 , V_56 ) )
return 1 ;
for ( V_12 = F_21 ( V_57 , V_57 ) ; V_12 ;
V_12 = F_21 ( V_12 , V_57 ) ) {
V_29 = F_41 ( & V_12 -> V_7 , V_7 -> V_59 ) ;
if ( V_29 && F_10 ( & V_29 -> V_58 ) &&
( V_51 = F_38 ( V_29 , 1 ) ) )
break;
}
return V_51 ;
...
static void F_44 ( struct V_1 * V_7 )
{
struct V_1 * V_57 = V_7 -> V_37 ;
struct V_1 * V_12 ;
F_43 ( V_57 == V_7 ) ;
...
F_12 ( & V_29 -> V_60 ) ;
V_29 -> V_7 . V_26 |= V_61 ;
F_47 ( & V_29 -> V_62 , & V_7 -> V_62 ) ;
}
}
}
int F_48 ( struct V_22 * V_44 )
{
struct V_1 * V_7 ;
F_49 (mnt, list, mnt_list)
F_44 ( V_7 ) ;
