...
F_269 ( V_311 , & V_301 -> V_312 , 0 ) ;
F_82 ( & V_10 -> V_165 ) ;
F_270 ( V_311 ) ;
F_50 ( ! F_39 ( & V_10 -> V_164 ) ) ;
}
static void F_271 ( struct V_313 * V_314 )
{
struct V_315 * V_316 = F_272 ( V_314 ) ;
...
F_36 ( & V_301 -> V_319 ) ;
F_266 ( V_301 -> V_320 ) ;
F_274 ( V_301 -> V_40 . V_321 ) ;
V_317 = V_301 ;
}
F_82 ( & V_301 -> V_318 -> V_165 ) ;
F_41 ( V_317 ) ;
}
static int F_275 ( T_6 * V_320 , int V_322 )
{
int V_323 , V_324 = 1 ;
if ( V_322 == 0 || V_322 == 1 )
return V_322 ;
...
static int F_278 ( const void * V_326 , const void * V_327 )
{
return * ( T_6 * ) V_326 - * ( T_6 * ) V_327 ;
}
static int F_279 ( const void * V_326 , const void * V_327 )
{
return F_276 ( * ( T_6 * ) V_326 ) - F_276 ( * ( T_6 * ) V_327 ) ;
}
static struct V_309 * F_280 ( struct V_9 * V_10 ,
enum V_328 type )
{
struct V_309 * V_301 ;
struct V_329 * V_321 = F_281 ( V_153 ) ;
F_17 ( & V_10 -> V_165 ) ;
...
static struct V_309 * F_282 ( struct V_9 * V_10 ,
enum V_328 type )
{
struct V_309 * V_301 ;
F_17 ( & V_10 -> V_165 ) ;
V_301 = F_280 ( V_10 , type ) ;
if ( V_301 )
return V_301 ;
V_301 = F_57 ( sizeof( struct V_309 ) , V_72 ) ;
if ( ! V_301 )
return V_301 ;
F_283 ( & V_301 -> V_312 , F_271 ) ;
V_301 -> V_40 . type = type ;
V_301 -> V_40 . V_321 = F_284 ( F_281 ( V_153 ) ) ;
V_301 -> V_318 = V_10 ;
F_58 ( & V_301 -> V_319 , & V_10 -> V_164 ) ;
return V_301 ;
}
static int F_285 ( struct V_9 * V_10 , enum V_328 type ,
struct V_309 * * V_330 )
{
T_6 * V_331 ;
int V_322 ;
...
V_322 = V_332 ;
if ( F_60 ( V_10 ) )
F_289 ( V_331 , V_322 , sizeof( T_6 ) , F_279 , NULL ) ;
else
F_289 ( V_331 , V_322 , sizeof( T_6 ) , F_278 , NULL ) ;
if ( type == V_333 )
V_322 = F_275 ( V_331 , V_322 ) ;
V_301 = F_282 ( V_10 , type ) ;
if ( ! V_301 ) {
F_266 ( V_331 ) ;
return - V_73 ;
}
...
int F_290 ( struct V_334 * V_335 , struct V_182 * V_182 )
{
struct V_115 * V_29 = F_291 ( V_182 ) ;
struct V_9 * V_10 ;
struct V_299 V_300 ;
struct V_95 * V_201 ;
...
static void * F_294 ( struct V_126 * V_348 , T_5 * V_294 )
{
...
if ( F_277 ( V_10 , V_301 -> V_320 [ V_352 ] ) == V_223 ) {
V_350 = V_352 ;
break;
} else if ( F_277 ( V_10 , V_301 -> V_320 [ V_352 ] ) <= V_223 )
V_350 = V_352 + 1 ;
else
V_4 = V_352 ;
}
...
* V_294 = F_277 ( V_10 , * V_351 ) ;
return V_351 ;
}
static void F_295 ( struct V_126 * V_348 , void * V_239 )
{
struct V_27 * V_28 = V_348 -> V_349 ;
struct V_309 * V_301 = V_28 -> V_30 ;
if ( V_301 )
F_269 ( V_311 , & V_301 -> V_312 ,
V_353 ) ;
F_82 ( & F_195 ( V_348 ) -> V_9 -> V_165 ) ;
}
static void * F_296 ( struct V_126 * V_348 , void * V_239 , T_5 * V_294 )
{
struct V_27 * V_28 = V_348 -> V_349 ;
struct V_309 * V_301 = V_28 -> V_30 ;
T_6 * V_155 = V_239 ;
...
* V_294 = F_277 ( F_195 ( V_348 ) -> V_9 , * V_155 ) ;
return V_155 ;
}
}
static int F_297 ( struct V_126 * V_348 , void * V_239 )
{
F_115 ( V_348 , L_32 , * ( int * ) V_239 ) ;
return 0 ;
}
static T_7 F_298 ( struct V_11 * V_22 ,
struct V_31 * V_32 )
{
return F_28 ( V_22 -> V_9 ) ;
}
static int F_299 ( struct V_11 * V_22 ,
struct V_31 * V_32 , T_7 V_354 )
{
if ( V_354 )
F_139 ( V_34 , & V_22 -> V_9 -> V_25 ) ;
else
F_300 ( V_34 , & V_22 -> V_9 -> V_25 ) ;
return 0 ;
}
static T_7 F_301 ( struct V_11 * V_22 ,
struct V_31 * V_32 )
{
return F_29 ( V_131 , & V_22 -> V_9 -> V_25 ) ;
}
static int F_302 ( struct V_11 * V_22 ,
struct V_31 * V_32 , T_7 V_354 )
{
if ( V_354 )
F_139 ( V_131 , & V_22 -> V_9 -> V_25 ) ;
else
F_300 ( V_131 , & V_22 -> V_9 -> V_25 ) ;
return 0 ;
}
...
static void F_303 ( struct V_313 * V_314 )
{
struct V_11 * V_22 =
...
static void F_307 ( struct V_55 * V_55 )
{
struct V_11 * V_22 =
F_12 ( V_55 , struct V_11 , V_55 ) ;
F_136 ( & V_22 -> V_355 , F_303 ) ;
F_308 ( V_358 , & V_22 -> V_355 ) ;
}
static void F_309 ( struct V_313 * V_314 )
{
struct V_11 * V_22 =
F_12 ( V_314 , struct V_11 , V_355 ) ;
struct V_15 * V_16 = V_22 -> V_16 ;
...
F_82 ( & V_18 ) ;
F_311 ( & V_22 -> V_55 , F_307 ) ;
}
static void V_173 ( struct V_362 * V_363 )
{
struct V_11 * V_22 =
F_12 ( V_363 , struct V_11 , V_172 ) ;
F_136 ( & V_22 -> V_355 , F_309 ) ;
F_308 ( V_358 , & V_22 -> V_355 ) ;
}
static void F_312 ( struct V_11 * V_22 ,
...
static int F_313 ( struct V_11 * V_22 )
{
struct V_15 * V_16 = V_22 -> V_16 ;
int V_6 = 0 ;
F_17 ( & V_18 ) ;
...
static void F_314 ( struct V_11 * V_22 )
{
struct V_15 * V_16 = V_22 -> V_16 ;
F_17 ( & V_18 ) ;
if ( ! ( V_22 -> V_25 & V_26 ) )
...
if ( F_144 ( V_22 ) )
return F_145 ( V_22 ) ;
F_312 ( V_22 , V_16 , V_10 ) ;
V_212 = F_142 ( & V_22 -> V_172 , V_173 , 0 , V_72 ) ;
if ( V_212 )
goto V_369;
V_212 = F_1 ( & V_16 -> V_357 , NULL , 2 , 0 , V_170 ) ;
if ( V_212 < 0 )
goto V_370;
V_22 -> V_8 = V_212 ;
if ( V_367 ) {
...
F_316 ( & V_22 -> V_163 , & V_12 -> V_91 ) ;
F_7 ( & V_16 -> V_357 , V_22 , V_22 -> V_8 ) ;
V_212 = F_313 ( V_22 ) ;
if ( V_212 )
goto V_372;
...
static int F_317 ( struct V_115 * V_375 , const char * V_101 ,
T_2 V_102 )
{
...
V_29 = F_318 ( V_14 -> V_29 , V_101 , V_102 , V_10 ) ;
if ( F_144 ( V_29 ) ) {
V_6 = F_145 ( V_29 ) ;
goto V_378;
}
...
F_316 ( & V_10 -> V_13 . V_163 , & F_11 ( V_10 ) -> V_13 . V_91 ) ;
F_48 ( & V_19 -> V_90 ) ;
F_89 ( V_14 ) ;
...
static void F_321 ( struct V_313 * V_314 )
{
struct V_11 * V_22 =
F_12 ( V_314 , struct V_11 , V_355 ) ;
F_79 ( & V_18 ) ;
...
static void F_322 ( struct V_362 * V_363 )
{
struct V_11 * V_22 =
F_12 ( V_363 , struct V_11 , V_172 ) ;
F_136 ( & V_22 -> V_355 , F_321 ) ;
F_308 ( V_358 , & V_22 -> V_355 ) ;
}
...
F_103 ( V_22 -> V_9 , 1 << V_22 -> V_16 -> V_8 ) ;
F_21 ( V_22 ) ;
F_323 ( & V_22 -> V_172 , F_322 ) ;
}
static int F_320 ( struct V_9 * V_10 )
__releases( &cgroup_mutex
static int F_324 ( struct V_115 * V_29 )
{
struct V_9 * V_10 ;
int V_6 = 0 ;
V_10 = F_99 ( V_29 ) ;
...
static void T_8 F_325 ( struct V_15 * V_16 , bool V_380 )
{
struct V_11 * V_22 ;
F_326 ( V_381 L_39 , V_16 -> V_101 ) ;
F_79 ( & V_18 ) ;
F_138 ( & V_16 -> V_357 ) ;
F_56 ( & V_16 -> V_117 ) ;
V_16 -> V_19 = & V_92 ;
...
F_50 ( F_144 ( V_22 ) ) ;
F_312 ( V_22 , V_16 , & V_92 . V_10 ) ;
V_22 -> V_25 |= V_382 ;
if ( V_380 ) {
V_22 -> V_8 = 1 ;
} else {
V_22 -> V_8 = F_1 ( & V_16 -> V_357 , V_22 , 1 , 2 , V_72 ) ;
F_50 ( V_22 -> V_8 < 0 ) ;
}
...
struct V_11 * V_22 =
V_24 . V_17 [ V_16 -> V_8 ] ;
V_22 -> V_8 = F_1 ( & V_16 -> V_357 , V_22 , 1 , 2 ,
V_72 ) ;
F_50 ( V_22 -> V_8 < 0 ) ;
} else {
F_325 ( V_16 , false ) ;
...
F_332 ( L_43 , 0 , NULL , & V_391 ) ;
return 0 ;
}
static int T_8 F_333 ( void )
{
V_358 = F_334 ( L_44 , 0 , 1 ) ;
F_50 ( ! V_358 ) ;
V_311 = F_334 ( L_45 ,
0 , 1 ) ;
F_50 ( ! V_311 ) ;
...
int F_335 ( struct V_126 * V_260 , struct V_329 * V_321 ,
...
static int F_336 ( struct V_126 * V_260 , void * V_239 )
{
struct V_15 * V_16 ;
int V_41 ;
F_116 ( V_260 , L_49 ) ;
...
static int F_337 ( struct V_393 * V_393 , struct V_394 * V_394 )
{
return F_338 ( V_394 , F_336 , NULL ) ;
}
void F_339 ( struct V_95 * V_251 )
{
...
struct V_11 * V_22 = F_342 ( V_201 , V_41 ) ;
...
V_398 = F_345 ( V_10 -> V_19 -> V_130 , V_72 ) ;
if ( ! V_397 || ! V_398 )
goto V_171;
...
V_400 [ 2 ] = NULL ;
F_82 ( & V_18 ) ;
F_346 ( V_399 [ 0 ] , V_399 , V_400 , V_401 ) ;
goto V_189;
V_171:
F_82 ( & V_18 ) ;
V_189:
...
static int T_8 F_347 ( char * V_402 )
{
struct V_15 * V_16 ;
char * V_135 ;
int V_41 ;
...
struct V_11 * F_349 ( struct V_182 * V_182 ,
struct V_15 * V_16 )
{
struct V_115 * V_29 = F_291 ( V_182 ) ;
...
struct V_11 * F_350 ( int V_8 , struct V_15 * V_16 )
{
F_76 ( ! F_351 () ) ;
return V_8 > 0 ? F_352 ( & V_16 -> V_357 , V_8 ) : NULL ;
}
static struct V_11 *
F_353 ( struct V_11 * V_12 )
{
...
static void F_354 ( struct V_11 * V_22 )
{
F_41 ( V_22 ) ;
}
static T_7 F_355 ( struct V_11 * V_22 ,
struct V_31 * V_32 )
{
...
static int F_358 ( struct V_126 * V_127 , void * V_239 )
{
struct V_44 * V_45 ;
struct V_42 * V_43 ;
char * V_404 ;
...
F_65 ( & V_36 ) ;
F_19 () ;
V_43 = F_292 ( V_153 -> V_203 ) ;
F_69 (link, &cset->cgrp_links, cgrp_link) {
struct V_9 * V_81 = V_45 -> V_10 ;
F_359 ( V_81 , V_404 , V_405 + 1 ) ;
F_115 ( V_127 , L_56 ,
...
static int F_360 ( struct V_126 * V_127 , void * V_239 )
{
...
static T_7 F_361 ( struct V_11 * V_22 , struct V_31 * V_32 )
{
return ( ! F_343 ( V_22 -> V_9 ) &&
! F_256 ( & V_22 -> V_9 -> V_13 ) ) ;
}
