...
V_1 -> V_74 = V_74 ;
V_20 -> V_78 . V_79 = sizeof( struct V_80 )
+ F_89 ( & V_74 -> V_81 ) ;
return 0 ;
}
...
static void
F_92 ( struct V_82 * V_58 , int V_30 )
{
struct V_83 * V_84 = V_58 -> V_85 ;
if ( V_30 == - V_86 )
return;
V_84 -> V_30 = V_30 ;
F_93 ( & V_84 -> V_87 ) ;
...
if ( ! V_58 )
goto V_93;
V_92 = F_99 ( sizeof( * V_92 ) , V_95 ) ;
if ( ! V_92 )
goto V_96;
memset ( V_92 -> V_5 , 0 , sizeof( V_92 -> V_5 ) ) ;
memset ( V_6 , 0 , V_97 ) ;
F_100 ( & V_92 -> V_84 . V_87 ) ;
F_101 ( & V_92 -> V_98 , V_6 , V_97 ) ;
F_102 ( V_58 , V_89 ) ;
F_103 ( V_58 , V_43 |
V_99 ,
F_92 ,
& V_92 -> V_84 ) ;
F_104 ( V_58 , & V_92 -> V_98 ,
& V_92 -> V_98 , V_97 , V_92 -> V_5 ) ;
V_64 = F_105 ( V_58 ) ;
if ( V_64 == - V_86 || V_64 == - V_100 ) {
V_64 = F_106
( & V_92 -> V_84 . V_87 ) ;
if ( ! V_64 )
V_64 = V_92 -> V_84 . V_30 ;
...
static int F_110 ( struct V_19 * V_101 , const T_1 * V_51 ,
unsigned int V_27 )
{
int V_64 = 0 ;
struct V_25 * V_20 = F_16 ( V_101 ) ;
struct V_18 * V_1 = F_13 ( V_101 ) ;
T_1 * V_102 , * V_103 = NULL ;
if ( V_27 < 4 ) {
F_111 ( V_20 , V_33 ) ;
return - V_34 ;
}
...
memcpy ( V_1 -> V_104 , V_51 + V_27 , sizeof( V_1 -> V_104 ) ) ;
if ( ( unsigned long ) ( & ( V_1 -> V_105 . V_106 [ 0 ] ) ) % V_21 )
return - V_34 ;
if ( ( unsigned long ) V_51 % V_21 ) {
V_103 = F_99 ( V_27 + V_21 , V_95 ) ;
if ( ! V_103 )
return - V_94 ;
V_102 = F_14 ( V_103 , V_21 ) ;
memcpy ( V_102 , V_51 , V_27 ) ;
V_51 = V_102 ;
}
if ( ! F_20 () )
V_64 = F_21 ( & ( V_1 -> V_105 ) ,
...
static int F_112 ( struct V_19 * V_107 , const T_1 * V_51 ,
unsigned int V_27 )
{
struct V_18 * V_1 = F_13 ( V_107 ) ;
struct V_19 * V_108 = F_88 ( V_1 -> V_74 ) ;
struct V_18 * V_109 = F_13 ( V_108 ) ;
struct V_73 * V_74 = V_1 -> V_74 ;
int V_64 ;
V_64 = F_113 ( V_108 , V_51 , V_27 ) ;
if ( ! V_64 ) {
memcpy ( V_1 , V_109 , sizeof( * V_1 ) ) ;
V_1 -> V_74 = V_74 ;
}
return V_64 ;
}
static int F_114 ( struct V_19 * V_101 ,
unsigned int V_110 )
{
switch ( V_110 ) {
case 8 :
...
F_115 ( V_101 ) -> V_110 = V_110 ;
return 0 ;
}
static int F_116 ( struct V_19 * V_107 ,
unsigned int V_110 )
{
struct V_18 * V_1 = F_13 ( V_107 ) ;
struct V_19 * V_108 = F_88 ( V_1 -> V_74 ) ;
int V_64 ;
V_64 = F_117 ( V_108 , V_110 ) ;
if ( ! V_64 )
F_115 ( V_107 ) -> V_110 = V_110 ;
return V_64 ;
}
static int F_118 ( struct V_80 * V_58 )
{
T_1 V_111 = 0 ;
T_1 * V_36 , * V_35 , * V_112 ;
T_6 V_113 = F_119 ( 1 ) ;
struct V_19 * V_20 = F_120 ( V_58 ) ;
struct V_18 * V_1 = F_13 ( V_20 ) ;
T_2 V_27 = V_1 -> V_105 . V_14 ;
void * V_12 = & ( V_1 -> V_105 ) ;
unsigned long V_10 = F_121 ( V_20 ) ;
T_1 V_114 [ 16 + V_21 ] ;
T_1 * V_5 = ( T_1 * ) F_14 ( ( T_1 * ) V_114 , V_21 ) ;
struct V_115 V_116 ;
struct V_115 V_117 ;
struct V_115 V_118 ;
unsigned int V_119 ;
if ( F_122 ( V_58 -> V_120 != 8 && V_58 -> V_120 != 12 ) )
return - V_34 ;
if ( F_122 ( V_10 != 8 && V_10 != 12 && V_10 != 16 ) )
return - V_34 ;
if ( F_122 ( V_27 != V_15 &&
V_27 != V_31 &&
V_27 != V_32 ) )
...
* ( V_5 + V_119 ) = V_1 -> V_104 [ V_119 ] ;
for ( V_119 = 0 ; V_119 < 8 ; V_119 ++ )
* ( V_5 + 4 + V_119 ) = V_58 -> V_5 [ V_119 ] ;
* ( ( T_6 * ) ( V_5 + 12 ) ) = V_113 ;
if ( ( F_123 ( V_58 -> V_36 ) ) && ( F_123 ( V_58 -> V_112 ) ) ) {
V_111 = 1 ;
F_124 ( & V_116 , V_58 -> V_36 ) ;
F_124 ( & V_117 , V_58 -> V_112 ) ;
V_36 = F_125 ( & V_116 ) ;
V_112 = F_125 ( & V_117 ) ;
V_35 = V_36 ;
if ( F_122 ( V_58 -> V_36 != V_58 -> V_35 ) ) {
F_124 ( & V_118 , V_58 -> V_35 ) ;
V_35 = F_125 ( & V_118 ) ;
}
} else {
V_36 = F_99 ( V_58 -> V_121 + V_10 + V_58 -> V_120 ,
V_122 ) ;
if ( F_122 ( ! V_36 ) )
return - V_94 ;
V_112 = ( V_36 + V_58 -> V_121 + V_10 ) ;
F_126 ( V_36 , V_58 -> V_36 , 0 , V_58 -> V_121 , 0 ) ;
F_126 ( V_112 , V_58 -> V_112 , 0 ,
V_58 -> V_120 , 0 ) ;
V_35 = V_36 ;
}
F_127 ( V_12 , V_35 , V_36 , ( unsigned long ) V_58 -> V_121 , V_5 ,
V_1 -> V_6 , V_112 , ( unsigned long ) V_58 -> V_120 , V_35
+ ( ( unsigned long ) V_58 -> V_121 ) , V_10 ) ;
if ( V_111 ) {
if ( F_122 ( V_58 -> V_36 != V_58 -> V_35 ) ) {
F_128 ( V_35 ) ;
F_129 ( & V_118 , 0 , 0 ) ;
...
F_126 ( V_35 , V_58 -> V_35 , 0 ,
V_58 -> V_121 + V_10 , 1 ) ;
F_107 ( V_36 ) ;
}
return 0 ;
}
static int F_130 ( struct V_80 * V_58 )
{
T_1 V_111 = 0 ;
T_1 * V_36 , * V_35 , * V_112 ;
...
unsigned long V_10 = F_121 ( V_20 ) ;
T_1 V_125 [ 32 + V_21 ] ;
T_1 * V_5 = ( T_1 * ) F_14 ( ( T_1 * ) V_125 , V_21 ) ;
T_1 * V_126 = V_5 + 16 ;
struct V_115 V_116 ;
struct V_115 V_117 ;
struct V_115 V_118 ;
unsigned int V_119 ;
if ( F_122 ( ( V_58 -> V_121 < V_10 ) ||
( V_58 -> V_120 != 8 && V_58 -> V_120 != 12 ) ) )
return - V_34 ;
if ( F_122 ( V_10 != 8 && V_10 != 12 && V_10 != 16 ) )
return - V_34 ;
if ( F_122 ( V_27 != V_15 &&
...
V_27 != V_32 ) )
return - V_34 ;
V_123 = ( unsigned long ) ( V_58 -> V_121 - V_10 ) ;
for ( V_119 = 0 ; V_119 < 4 ; V_119 ++ )
* ( V_5 + V_119 ) = V_1 -> V_104 [ V_119 ] ;
for ( V_119 = 0 ; V_119 < 8 ; V_119 ++ )
* ( V_5 + 4 + V_119 ) = V_58 -> V_5 [ V_119 ] ;
...
V_36 = F_99 ( V_58 -> V_121 + V_58 -> V_120 , V_122 ) ;
if ( ! V_36 )
return - V_94 ;
V_112 = ( V_36 + V_58 -> V_121 ) ;
F_126 ( V_36 , V_58 -> V_36 , 0 , V_58 -> V_121 , 0 ) ;
F_126 ( V_112 , V_58 -> V_112 , 0 ,
V_58 -> V_120 , 0 ) ;
V_35 = V_36 ;
}
F_131 ( V_12 , V_35 , V_36 , V_123 , V_5 ,
V_1 -> V_6 , V_112 , ( unsigned long ) V_58 -> V_120 ,
V_126 , V_10 ) ;
V_124 = F_132 ( V_36 + V_123 , V_126 , V_10 ) ?
- V_127 : 0 ;
if ( V_111 ) {
if ( F_122 ( V_58 -> V_36 != V_58 -> V_35 ) ) {
F_128 ( V_35 ) ;
...
F_126 ( V_35 , V_58 -> V_35 , 0 , V_123 , 1 ) ;
F_107 ( V_36 ) ;
}
return V_124 ;
}
static int F_133 ( struct V_80 * V_58 )
{
int V_64 ;
struct V_19 * V_20 = F_120 ( V_58 ) ;
struct V_18 * V_1 = F_13 ( V_20 ) ;
if ( ! F_20 () ) {
struct V_80 * V_128 =
(struct V_80 * ) F_134 ( V_58 ) ;
memcpy ( V_128 , V_58 , sizeof( * V_58 ) ) ;
F_135 ( V_128 , & V_1 -> V_74 -> V_81 ) ;
V_64 = F_136 ( V_128 ) ;
} else {
F_22 () ;
V_64 = F_118 ( V_58 ) ;
...
static int F_137 ( struct V_80 * V_58 )
{
int V_64 ;
struct V_19 * V_20 = F_120 ( V_58 ) ;
struct V_18 * V_1 = F_13 ( V_20 ) ;
...
static int F_139 ( struct V_80 * V_58 )
{
int V_64 ;
if ( F_122 ( ! F_20 () ) ) {
F_140 ( 1 , L_7 ) ;
...
static int F_141 ( struct V_80 * V_58 )
{
int V_64 ;
if ( F_122 ( ! F_20 () ) ) {
F_140 ( 1 , L_7 ) ;
...
if ( V_30 )
return V_30 ;
return F_150 ( V_135 , F_151 ( V_135 ) ) ;
}
static void T_8 F_152 ( void )
{
F_153 ( V_135 , F_151 ( V_135 ) ) ;
F_154 () ;
}
