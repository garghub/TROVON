...
static struct V_48 * F_16 ( T_7 V_49 , struct V_50 * V_51 )
{
struct V_52 V_53 ;
F_17 ( V_51 -> V_54 , V_55 ,
V_56 , V_49 , & V_53 ) ;
...
static int
F_18 ( T_8 V_57 , T_7 V_49 , T_9 * V_58 ,
int V_59 , void * V_60 )
{
...
/ sizeof( T_7 ) ;
return F_19 ( V_57 , V_49 , & V_61 , V_58 ,
V_59 , V_60 ) ;
}
#ifndef F_20
if ( ! F_15 ( V_48 -> V_32 , V_51 -> V_33 , & V_35 ) ) {
int V_21 = F_14 ( V_48 -> V_32 , V_51 -> V_33 ) ;
int V_71 = F_8 ( V_21 , V_48 -> V_32 -> V_22 ) ;
T_7 V_72 = V_71 ? 0 : V_48 -> V_65 ;
memset ( & V_61 , 0 , sizeof( V_61 ) ) ;
if ( F_21 ( 0 , & V_61 , V_49 , V_72 , V_48 -> V_32 -> V_22 ,
V_48 -> V_65 , V_48 -> V_2 ) )
return F_19 ( V_57 , V_49 , & V_61 , V_58 ,
V_59 , V_60 ) ;
}
...
static int F_27 ( struct V_50 * V_51 , T_7 V_79 ,
T_7 * V_40 )
{
struct V_52 V_53 ;
T_6 V_83 ;
...
if ( ! V_53 . V_48 -> V_32 )
return - 1 ;
V_83 = F_28 ( V_53 . V_48 -> V_32 , V_53 . V_48 , V_51 -> V_33 ,
V_79 , ( T_1 * ) V_40 , sizeof( * V_40 ) ) ;
return ! ( V_83 == sizeof( * V_40 ) ) ;
}
static int F_29 ( T_8 T_11 V_57 ,
T_7 V_79 , T_7 * V_84 ,
int V_74 , void * V_60 )
{
struct V_50 * V_51 = V_60 ;
...
V_44 = F_30 ( & V_65 , & V_51 -> V_87 -> V_89 , V_91 ) ;
if ( V_44 )
return V_44 ;
V_2 = V_65 + V_86 -> V_83 ;
...
if ( V_94 < 0 )
return - V_12 ;
V_44 = F_30 ( & V_3 , & V_51 -> V_87 -> V_89 , V_94 ) ;
if ( V_44 ) {
F_23 ( L_15 , V_93 ) ;
return V_44 ;
}
...
static void F_33 ( T_8 T_11 V_57 ,
T_9 * V_58 T_11 ,
void * V_60 T_11 )
{
F_9 ( L_17 ) ;
}
static int F_34 ( T_2 V_49 , struct V_54 * V_54 ,
T_16 V_95 , void * V_60 )
{
struct V_96 V_97 ;
struct V_52 V_53 ;
...
static int F_46 ( struct V_50 * V_51 , T_16 V_95 ,
void * V_60 , int V_110 )
{
T_8 V_103 ;
T_14 V_111 ;
int V_44 ;
V_103 = F_42 ( V_51 -> V_54 ) ;
if ( V_103 == NULL )
return - 1 ;
V_44 = F_47 ( & V_111 , V_103 , V_51 ) ;
if ( V_44 )
F_36 ( V_44 ) ;
while ( ! V_44 && ( F_48 ( & V_111 ) > 0 ) && V_110 -- ) {
T_7 V_49 ;
F_49 ( & V_111 , V_112 , & V_49 ) ;
V_44 = V_49 ? F_34 ( V_49 , V_51 -> V_54 , V_95 , V_60 ) : 0 ;
}
return V_44 ;
}
int F_50 ( T_16 V_95 , void * V_60 ,
struct V_54 * V_54 ,
...
if ( ! V_40 -> V_89 . V_90 )
return - V_12 ;
V_44 = F_30 ( & V_49 , & V_40 -> V_89 , V_115 ) ;
if ( V_44 )
return V_44 ;
V_44 = F_34 ( V_49 , V_54 , V_95 , V_60 ) ;
if ( V_44 )
return - V_108 ;
return -- V_110 > 0 ? F_46 ( & V_51 , V_95 , V_60 , V_110 ) : 0 ;
}
