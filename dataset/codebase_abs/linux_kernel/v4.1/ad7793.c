...
return V_40 ? V_40 : V_71 ;
}
static T_2 F_31 ( struct V_66 * V_48 ,
...
V_41 >>= ( V_76 -> V_64 . V_65 - ( V_56 ? 0 : 1 ) ) ;
* V_77 = 0 ;
* V_78 = V_41 ;
return V_85 ;
case V_87 :
if ( ! V_56 )
* V_77 = - ( 1 << ( V_76 -> V_64 . V_65 - 1 ) ) ;
else
* V_77 = 0 ;
if ( V_76 -> type == V_86 ) {
unsigned long long V_88 ;
unsigned int V_89 ;
V_89 = V_76 -> V_64 . V_65 - ( V_56 ? 0 : 1 ) ;
V_88 = 273ULL << V_89 ;
F_23 ( V_88 , 1444 ) ;
* V_77 -= V_88 ;
}
...
static int F_36 ( struct V_92 * V_43 )
{
...
V_37 = F_37 ( & V_43 -> V_48 , sizeof( * V_5 ) ) ;
if ( V_37 == NULL )
return - V_96 ;
V_5 = F_13 ( V_37 ) ;
F_38 ( & V_5 -> V_3 , V_37 , V_43 , & V_97 ) ;
if ( V_15 -> V_29 != V_98 ) {
V_5 -> V_99 = F_39 ( & V_43 -> V_48 , L_8 ) ;
if ( F_40 ( V_5 -> V_99 ) )
...
V_5 -> V_23 =
& V_101 [ F_44 ( V_43 ) -> V_102 ] ;
F_45 ( V_43 , V_37 ) ;
V_37 -> V_48 . V_103 = & V_43 -> V_48 ;
V_37 -> V_104 = F_44 ( V_43 ) -> V_104 ;
V_37 -> V_105 = V_106 ;
V_37 -> V_63 = V_5 -> V_23 -> V_63 ;
V_37 -> V_107 = V_5 -> V_23 -> V_107 ;
V_37 -> V_108 = V_5 -> V_23 -> V_109 ;
V_40 = F_46 ( V_37 ) ;
if ( V_40 )
goto V_100;
...
static int F_50 ( struct V_92 * V_43 )
{
const struct V_14 * V_15 = V_43 -> V_48 . V_93 ;
struct V_36 * V_37 = F_51 ( V_43 ) ;
struct V_1 * V_5 = F_13 ( V_37 ) ;
F_52 ( V_37 ) ;
F_48 ( V_37 ) ;
if ( V_15 -> V_29 != V_98 )
