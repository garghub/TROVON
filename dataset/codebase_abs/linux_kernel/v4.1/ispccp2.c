...
struct V_1 * V_2 = F_58 ( V_192 ) ;
switch ( V_218 -> V_194 | F_74 ( V_219 -> V_101 ) ) {
case V_100 | V_221 :
if ( V_220 & V_222 ) {
if ( V_2 -> V_177 == V_178 )
return - V_223 ;
...
{
int V_35 ;
V_35 = F_79 ( V_230 , & V_2 -> V_111 ) ;
if ( V_35 < 0 )
goto error;
V_35 = F_80 ( & V_2 -> V_137 , V_230 ) ;
if ( V_35 < 0 )
goto error;
return 0 ;
error:
...
struct V_217 * V_231 = & V_192 -> V_101 ;
int V_35 ;
V_2 -> V_177 = V_224 ;
V_2 -> V_226 = V_228 ;
F_82 ( V_192 , & V_232 ) ;
...
F_84 ( V_192 , V_2 ) ;
V_192 -> V_220 |= V_236 ;
V_99 [ V_100 ] . V_220 = V_237
| V_238 ;
V_99 [ V_113 ] . V_220 = V_239 ;
V_231 -> V_240 = & V_241 ;
V_35 = F_85 ( V_231 , V_242 , V_99 , 0 ) ;
if ( V_35 < 0 )
return V_35 ;
F_63 ( V_192 , NULL ) ;
V_2 -> V_137 . type = V_243 ;
V_2 -> V_137 . V_244 = 32 ;
V_2 -> V_137 . V_245 = 0xffffffe0 ;
V_2 -> V_137 . V_4 = F_2 ( V_2 ) ;
V_2 -> V_137 . V_240 = & V_246 ;
V_2 -> V_137 . V_247 = F_86 ( 4096 * 4096 ) * 3 ;
V_35 = F_87 ( & V_2 -> V_137 , L_10 ) ;
if ( V_35 < 0 )
goto V_248;
V_35 = F_88 ( & V_2 -> V_137 . V_215 . V_101 , 0 ,
