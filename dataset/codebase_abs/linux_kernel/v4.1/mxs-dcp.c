...
static void F_57 ( struct V_84 * V_56 )
{
struct V_1 * V_2 = F_18 ( V_56 ) ;
F_58 ( V_2 -> V_86 ) ;
V_2 -> V_86 = NULL ;
}
static int F_59 ( struct V_102 * V_21 )
{
struct V_3 * V_4 = V_5 ;
int V_8 ;
struct V_103 * V_56 = F_60 ( V_21 ) ;
struct V_1 * V_2 = F_61 ( V_56 ) ;
struct V_104 * V_24 = F_62 ( V_21 ) ;
struct V_105 * V_106 = F_63 ( V_56 ) ;
struct V_9 * V_10 = & V_4 -> V_11 -> V_10 [ V_2 -> V_6 ] ;
T_2 V_107 = 0 ;
...
F_66 ( V_21 -> V_114 [ V_70 ] ,
V_21 -> V_114 [ V_106 -> V_115 - V_70 - 1 ] ) ;
}
}
return 0 ;
}
static int F_67 ( void * V_76 )
{
struct V_3 * V_4 = V_5 ;
const int V_6 = V_118 ;
struct V_54 * V_78 ;
...
static int F_68 ( struct V_102 * V_21 )
{
struct V_103 * V_56 = F_60 ( V_21 ) ;
struct V_1 * V_2 = F_61 ( V_56 ) ;
struct V_105 * V_106 = F_63 ( V_56 ) ;
...
static int F_70 ( struct V_102 * V_21 , int V_113 )
{
struct V_3 * V_4 = V_5 ;
struct V_104 * V_24 = F_62 ( V_21 ) ;
struct V_103 * V_56 = F_60 ( V_21 ) ;
...
static int F_71 ( struct V_102 * V_21 )
{
return F_70 ( V_21 , 0 ) ;
}
static int F_72 ( struct V_102 * V_21 )
{
F_73 ( V_21 , NULL , V_21 -> V_114 , 0 ) ;
V_21 -> V_123 = 0 ;
return F_70 ( V_21 , 1 ) ;
}
...
static int F_75 ( struct V_102 * V_21 )
{
int V_8 ;
V_8 = F_68 ( V_21 ) ;
if ( V_8 )
...
static int F_76 ( struct V_84 * V_56 )
{
F_77 ( F_78 ( V_56 ) ,
sizeof( struct V_104 ) ) ;
return 0 ;
}
static void F_79 ( struct V_84 * V_56 )
{
}
static T_5 F_80 ( int V_124 , void * V_125 )
{
...
if ( ! V_7 )
return V_127 ;
F_4 ( V_7 , V_4 -> V_16 + V_128 ) ;
for ( V_70 = 0 ; V_70 < V_129 ; V_70 ++ )
if ( V_7 & ( 1 << V_70 ) )
V_82 ( & V_4 -> V_15 [ V_70 ] ) ;
return V_130 ;
}
...
if ( V_137 < 0 )
return V_137 ;
V_4 = F_84 ( V_13 , sizeof( * V_4 ) , V_140 ) ;
if ( ! V_4 )
return - V_141 ;
V_4 -> V_13 = V_13 ;
V_4 -> V_16 = F_85 ( V_13 , V_135 ) ;
if ( F_55 ( V_4 -> V_16 ) )
return F_56 ( V_4 -> V_16 ) ;
V_8 = F_86 ( V_13 , V_136 , F_80 , 0 ,
L_5 , V_4 ) ;
if ( V_8 ) {
F_10 ( V_13 , L_6 ) ;
return V_8 ;
}
V_8 = F_86 ( V_13 , V_137 , F_80 , 0 ,
L_7 , V_4 ) ;
if ( V_8 ) {
F_10 ( V_13 , L_8 ) ;
return V_8 ;
}
V_4 -> V_11 = F_84 ( V_13 , sizeof( * V_4 -> V_11 ) + V_142 ,
V_140 ) ;
if ( ! V_4 -> V_11 )
return - V_141 ;
V_4 -> V_11 = F_87 ( V_4 -> V_11 , V_142 ) ;
V_8 = F_88 ( V_4 -> V_16 ) ;
if ( V_8 )
return V_8 ;
F_4 ( V_143 |
...
F_4 ( V_146 ,
V_4 -> V_16 + V_147 ) ;
F_4 ( 0xffff0000 , V_4 -> V_16 + V_148 ) ;
for ( V_70 = 0 ; V_70 < V_129 ; V_70 ++ )
F_4 ( 0xffffffff , V_4 -> V_16 + F_5 ( V_70 ) ) ;
F_4 ( 0xffffffff , V_4 -> V_16 + V_128 ) ;
V_5 = V_4 ;
F_89 ( V_132 , V_4 ) ;
for ( V_70 = 0 ; V_70 < V_129 ; V_70 ++ ) {
F_69 ( & V_4 -> V_80 [ V_70 ] ) ;
F_90 ( & V_4 -> V_15 [ V_70 ] ) ;
F_91 ( & V_4 -> V_81 [ V_70 ] , 50 ) ;
}
V_4 -> V_87 [ V_118 ] = F_92 ( F_67 ,
NULL , L_9 ) ;
if ( F_55 ( V_4 -> V_87 [ V_118 ] ) ) {
F_10 ( V_13 , L_10 ) ;
return F_56 ( V_4 -> V_87 [ V_118 ] ) ;
}
V_4 -> V_87 [ V_77 ] = F_92 ( F_26 ,
NULL , L_11 ) ;
if ( F_55 ( V_4 -> V_87 [ V_77 ] ) ) {
F_10 ( V_13 , L_10 ) ;
V_8 = F_56 ( V_4 -> V_87 [ V_77 ] ) ;
goto V_149;
}
V_4 -> V_150 = F_11 ( V_4 -> V_16 + V_151 ) ;
if ( V_4 -> V_150 & V_152 ) {
V_8 = F_93 ( V_153 ,
F_94 ( V_153 ) ) ;
if ( V_8 ) {
