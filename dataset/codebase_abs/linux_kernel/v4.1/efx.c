...
{
#ifdef F_254
struct V_308 * V_309 = F_255 ( V_2 -> V_154 ) ;
if ( F_256 ( V_309 ) ) {
return 1 ;
}
#endif
...
static void F_259 ( struct V_127 * V_128 )
{
struct V_1 * V_2 = F_11 ( V_128 , struct V_1 , V_313 ) ;
unsigned long V_314 ;
enum V_296 V_297 ;
V_314 = F_260 ( V_2 -> V_212 ) ;
V_297 = F_261 ( V_314 ) - 1 ;
if ( V_297 == V_315 )
F_257 ( V_2 ) ;
if ( ( V_297 == V_307 ||
...
F_262 ( V_297 , & V_2 -> V_212 ) ;
F_238 () ;
if ( F_260 ( V_2 -> V_3 ) != V_291 )
return;
F_160 ( V_2 ) ;
...
F_267 ( & V_2 -> V_321 ) ;
#endif
F_269 ( & V_2 -> V_313 , F_259 ) ;
F_270 ( & V_2 -> V_144 , F_196 ) ;
F_270 ( & V_2 -> V_322 , V_323 ) ;
V_2 -> V_154 = V_154 ;
V_2 -> V_324 = V_325 ;
V_2 -> V_3 = V_295 ;
...
void F_276 ( struct V_1 * V_2 , T_8 * V_255 )
{
T_8 V_334 = 0 ;
struct V_9 * V_10 ;
F_53 (channel, efx)
...
static void F_280 ( struct V_154 * V_154 )
{
struct V_1 * V_2 ;
V_2 = F_234 ( V_154 ) ;
if ( ! V_2 )
...
V_341 = F_285 ( V_160 , 0 , sizeof( V_339 ) , V_339 ) ;
if ( V_341 <= 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_83 ) ;
return;
}
V_342 = F_286 ( V_339 , 0 , V_341 , V_344 ) ;
if ( V_342 < 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_84 ) ;
return;
}
V_343 = F_287 ( & V_339 [ V_342 ] ) ;
V_43 = V_343 ;
V_39 = V_342 + V_345 ;
if ( V_39 + V_43 > V_341 )
V_43 = V_341 - V_39 ;
V_39 = F_288 ( V_339 , V_39 , V_43 , L_85 ) ;
if ( V_39 < 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_86 ) ;
return;
}
V_43 = F_289 ( & V_339 [ V_39 ] ) ;
V_39 += V_346 ;
if ( V_39 + V_43 > V_341 ) {
...
V_39 = V_342 + V_345 ;
V_43 = V_343 ;
V_39 = F_288 ( V_339 , V_39 , V_43 , L_89 ) ;
if ( V_39 < 0 ) {
...
static int F_292 ( struct V_154 * V_154 ,
const struct V_349 * V_180 )
{
struct V_236 * V_7 ;
struct V_1 * V_2 ;
int V_35 ;
V_7 = F_293 ( sizeof( * V_2 ) , V_350 ,
V_351 ) ;
if ( ! V_7 )
return - V_103 ;
V_2 = F_199 ( V_7 ) ;
...
F_294 ( V_154 , V_2 ) ;
F_295 ( V_7 , & V_154 -> V_160 ) ;
V_35 = F_266 ( V_2 , V_154 , V_7 ) ;
if ( V_35 )
goto V_138;
...
static int F_298 ( struct V_278 * V_160 )
{
struct V_1 * V_2 = F_234 ( F_235 ( V_160 ) ) ;
F_237 () ;
if ( V_2 -> V_3 != V_4 ) {
...
V_2 -> V_212 = 0 ;
F_301 ( V_154 ) ;
return F_302 ( V_154 , V_366 ) ;
}
static int F_303 ( struct V_278 * V_160 )
{
struct V_154 * V_154 = F_235 ( V_160 ) ;
struct V_1 * V_2 = F_234 ( V_154 ) ;
int V_35 ;
V_35 = F_302 ( V_154 , V_367 ) ;
if ( V_35 )
return V_35 ;
F_304 ( V_154 ) ;
V_35 = F_133 ( V_154 ) ;
...
static int F_305 ( struct V_278 * V_160 )
{
int V_35 ;
F_298 ( V_160 ) ;
V_35 = F_300 ( V_160 ) ;
...
static T_9 F_306 ( struct V_154 * V_368 ,
enum V_369 V_3 )
{
T_9 V_370 = V_371 ;
...
static void F_309 ( struct V_154 * V_368 )
{
struct V_1 * V_2 = F_234 ( V_368 ) ;
int V_35 ;
F_237 () ;
