...
V_91 | V_92 ;
F_48 ( & V_37 -> V_41 ) ;
V_19 = V_37 -> V_93 = V_37 -> V_41 . V_1 -> V_16 ;
V_37 -> V_84 = V_19 -> V_94 ;
...
struct V_19 * V_19 = V_18 -> V_1 -> V_16 ;
if ( V_19 -> V_118 -> F_64 )
return V_19 -> V_118 -> F_64 ( V_18 -> V_1 , V_5 , V_87 ) ;
else {
V_5 -> V_41 = * V_18 ;
return F_45 ( V_5 , NULL , V_87 ) ;
}
}
...
V_121 |= V_135 ;
V_120 -> V_121 = V_121 ;
V_120 -> V_136 = V_117 & V_95 ? 0 : V_137 ;
if ( V_117 & V_109 ) {
V_120 -> V_136 |= V_138 ;
if ( V_117 & V_110 )
V_120 -> V_136 |= V_139 ;
...
long F_82 ( int V_145 , const char T_2 * V_141 , int V_117 , T_3 V_49 )
{
struct V_119 V_120 ;
...
V_35 = F_85 ( V_117 ) ;
if ( V_35 >= 0 ) {
struct V_4 * V_37 = F_75 ( V_145 , V_146 , & V_120 ) ;
if ( F_67 ( V_37 ) ) {
F_86 ( V_35 ) ;
V_35 = F_84 ( V_37 ) ;
} else {
...
int F_89 ( struct V_4 * V_5 , T_8 V_147 )
{
int V_148 = 0 ;
if ( ! F_90 ( V_5 ) ) {
F_91 ( V_149 L_1 ) ;
...
if ( V_5 -> V_64 -> V_150 )
V_148 = V_5 -> V_64 -> V_150 ( V_5 , V_147 ) ;
