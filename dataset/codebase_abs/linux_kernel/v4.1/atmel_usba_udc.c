...
struct V_38 * V_13 )
{
struct V_299 * V_300 = F_158 ( & V_61 -> V_62 ) ;
struct V_3 * V_290 ;
int V_39 ;
if ( ! V_300 )
return F_146 ( - V_301 ) ;
V_290 = F_149 ( & V_61 -> V_62 , sizeof( struct V_3 ) * V_300 -> V_260 ,
V_11 ) ;
if ( ! V_290 )
return F_146 ( - V_12 ) ;
V_13 -> V_66 . V_72 = & V_290 [ 0 ] . V_4 ;
V_13 -> V_76 = V_300 -> V_76 ;
V_13 -> V_77 = V_300 -> V_77 ;
V_13 -> V_260 = V_300 -> V_260 ;
F_3 ( & V_290 [ 0 ] . V_4 . V_293 ) ;
for ( V_39 = 0 ; V_39 < V_300 -> V_260 ; V_39 ++ ) {
struct V_3 * V_4 = & V_290 [ V_39 ] ;
V_4 -> V_294 = V_13 -> V_44 + F_153 ( V_39 ) ;
V_4 -> V_295 = V_13 -> V_44 + F_154 ( V_39 ) ;
V_4 -> V_85 = V_13 -> V_85 + F_155 ( V_39 ) ;
V_4 -> V_4 . V_296 = & V_297 ;
V_4 -> V_4 . V_47 = V_300 -> V_4 [ V_39 ] . V_47 ;
V_4 -> V_123 = V_300 -> V_4 [ V_39 ] . V_123 ;
F_156 ( & V_4 -> V_4 , V_4 -> V_123 ) ;
V_4 -> V_13 = V_13 ;
F_3 ( & V_4 -> V_17 ) ;
V_4 -> V_139 = V_300 -> V_4 [ V_39 ] . V_139 ;
V_4 -> V_120 = V_300 -> V_4 [ V_39 ] . V_120 ;
V_4 -> V_54 = V_300 -> V_4 [ V_39 ] . V_54 ;
V_4 -> V_137 = V_300 -> V_4 [ V_39 ] . V_137 ;
if ( V_39 )
F_7 ( & V_4 -> V_4 . V_293 , & V_13 -> V_66 . V_293 ) ;
}
return V_290 ;
...
V_85 = F_35 ( V_61 , V_67 , V_304 ) ;
if ( ! V_44 || ! V_85 )
return - V_301 ;
V_247 = F_160 ( V_61 , 0 ) ;
if ( V_247 < 0 )
return V_247 ;
V_269 = F_161 ( & V_61 -> V_62 , L_77 ) ;
if ( F_34 ( V_269 ) )
return F_162 ( V_269 ) ;
V_270 = F_161 ( & V_61 -> V_62 , L_78 ) ;
if ( F_34 ( V_270 ) )
return F_162 ( V_270 ) ;
F_163 ( & V_13 -> V_14 ) ;
F_164 ( & V_13 -> V_274 ) ;
...
V_13 -> V_76 = - V_176 ;
V_41 = - V_12 ;
V_13 -> V_44 = F_165 ( & V_61 -> V_62 , V_44 -> V_305 , F_37 ( V_44 ) ) ;
if ( ! V_13 -> V_44 ) {
F_31 ( & V_61 -> V_62 , L_79 ) ;
return V_41 ;
}
F_109 ( & V_61 -> V_62 , L_80 ,
( unsigned long ) V_44 -> V_305 , V_13 -> V_44 ) ;
V_13 -> V_85 = F_165 ( & V_61 -> V_62 , V_85 -> V_305 , F_37 ( V_85 ) ) ;
if ( ! V_13 -> V_85 ) {
F_31 ( & V_61 -> V_62 , L_81 ) ;
return V_41 ;
}
F_109 ( & V_61 -> V_62 , L_82 ,
( unsigned long ) V_85 -> V_305 , V_13 -> V_85 ) ;
F_166 ( V_61 , V_13 ) ;
V_41 = F_128 ( V_269 ) ;
if ( V_41 ) {
F_31 ( & V_61 -> V_62 , L_83 ) ;
...
V_13 -> V_247 = V_247 ;
if ( F_44 ( V_13 -> V_76 ) ) {
if ( ! F_168 ( & V_61 -> V_62 , V_13 -> V_76 , L_84 ) ) {
