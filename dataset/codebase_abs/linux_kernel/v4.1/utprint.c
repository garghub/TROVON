...
const char * F_7 ( char * string , T_3 V_5 )
{
char V_14 [ 20 ] ;
const char * V_15 ;
char * V_16 ;
...
return ( F_9 ( V_10 , string ) ) ;
}
int F_12 ( char * string , T_1 V_32 , const char * V_33 , ... )
{
T_6 args ;
int V_2 ;
va_start ( args , V_33 ) ;
V_2 = F_10 ( string , V_32 , V_33 , args ) ;
va_end ( args ) ;
return ( V_2 ) ;
}
int F_13 ( T_7 V_39 , const char * V_33 , T_6 args )
{
T_8 V_40 ;
int V_2 ;
V_40 = F_14 ( V_41 ) ;
...
( void ) F_15 ( V_39 , V_42 , V_2 , 1 ) ;
F_16 ( V_41 , V_40 ) ;
return ( V_2 ) ;
}
int F_17 ( T_7 V_39 , const char * V_33 , ... )
{
T_6 args ;
int V_2 ;
va_start ( args , V_33 ) ;
V_2 = F_13 ( V_39 , V_33 , args ) ;
va_end ( args ) ;
return ( V_2 ) ;
}
