...
V_171 = F_64 ( V_141 , V_94 , sizeof( V_87 -> V_102 ) ,
& V_87 -> V_102 ) ;
if ( V_171 )
goto V_44;
if ( V_87 -> V_174 )
...
return F_181 ( V_113 -> V_133 . V_199 , V_141 , V_143 , & V_146 ) ;
}
}
V_38 = F_76 ( V_143 , V_376 [ type ] , V_2 ,
V_364 -> V_377 ? : V_189 ,
V_364 -> V_378 ? : V_192 ) ;
if ( V_38 < 0 )
return V_38 ;
if ( V_364 -> V_379 == NULL )
return - V_7 ;
return V_364 -> V_379 ( V_141 , V_143 , V_2 ) ;
}
static void F_182 ( struct V_140 * V_141 )
{
struct V_113 * V_113 = F_41 ( V_141 -> V_144 ) ;
F_183 ( & V_113 -> V_133 . V_380 ) ;
F_184 ( V_141 , & F_177 ) ;
F_185 ( & V_113 -> V_133 . V_380 ) ;
}
...
static int F_187 ( struct V_140 * V_141 , struct V_86 * V_87 , const struct V_145 * V_146 )
{
struct V_322 * V_323 ;
struct V_142 * V_143 ;
int V_38 ;
V_143 = F_68 ( V_141 , V_146 -> V_150 , 0 , V_381 , sizeof( * V_323 ) , 0 ) ;
if ( V_143 == NULL )
return - V_165 ;
V_323 = F_42 ( V_143 ) ;
...
{
struct V_113 * V_113 = F_189 ( V_87 ) ;
struct V_140 * V_141 ;
V_141 = F_80 ( F_186 () , V_196 ) ;
if ( V_141 == NULL )
return - V_68 ;
if ( F_187 ( V_141 , V_87 , V_146 ) < 0 ) {
F_82 ( V_141 ) ;
return - V_165 ;
}
return F_83 ( V_113 , V_141 , 0 , V_382 ) ;
}
static int F_190 ( struct V_86 * V_87 , const struct V_145 * V_146 )
{
struct V_113 * V_113 = F_189 ( V_87 ) ;
struct V_140 * V_141 ;
...
F_98 () ;
return F_83 ( V_113 , V_141 , 0 , V_383 ) ;
}
static int F_191 ( const struct V_145 * V_146 )
{
...
if ( V_141 == NULL )
return - V_68 ;
V_143 = F_68 ( V_141 , V_146 -> V_150 , V_146 -> V_132 , V_384 , sizeof( * V_24 ) , 0 ) ;
if ( V_143 == NULL ) {
F_82 ( V_141 ) ;
return - V_165 ;
}
...
F_71 ( V_141 , V_143 ) ;
return F_83 ( V_113 , V_141 , 0 , V_385 ) ;
}
static inline T_4 F_192 ( struct V_86 * V_87 )
{
T_4 V_386 = 0 ;
if ( V_87 -> V_118 )
V_386 += F_88 ( F_8 ( V_87 -> V_118 ) ) ;
if ( V_87 -> V_120 ) {
V_386 += F_88 ( sizeof( struct V_5 ) +
( V_87 -> V_120 -> V_66 + 7 ) / 8 ) ;
V_386 += F_88 ( F_6 ( V_87 -> V_120 ) ) ;
}
if ( V_87 -> V_122 )
V_386 += F_88 ( F_4 ( V_87 -> V_122 ) ) ;
if ( V_87 -> V_124 )
V_386 += F_88 ( sizeof( * V_87 -> V_124 ) ) ;
if ( V_87 -> V_127 )
V_386 += F_88 ( sizeof( * V_87 -> V_127 ) ) ;
if ( V_87 -> V_128 )
V_386 += F_88 ( sizeof( V_87 -> V_128 ) ) ;
if ( V_87 -> V_77 )
V_386 += F_88 ( F_12 ( V_87 -> V_77 ) ) ;
else
V_386 += F_88 ( sizeof( struct V_101 ) ) ;
if ( V_87 -> V_174 )
V_386 += F_88 ( sizeof( struct V_19 ) +
V_87 -> V_174 -> V_22 ) ;
if ( V_87 -> V_129 )
V_386 += F_88 ( sizeof( * V_87 -> V_129 ) ) ;
if ( V_87 -> V_58 . V_117 )
V_386 += F_88 ( sizeof( V_87 -> V_58 . V_117 ) ) ;
V_386 += F_88 ( sizeof( V_387 ) ) ;
return V_386 ;
}
static int F_193 ( struct V_86 * V_87 , const struct V_145 * V_146 )
{
struct V_113 * V_113 = F_189 ( V_87 ) ;
struct V_23 * V_24 ;
struct V_153 * V_33 ;
...
if ( V_141 == NULL )
return - V_68 ;
V_143 = F_68 ( V_141 , V_146 -> V_150 , V_146 -> V_132 , V_146 -> V_152 , V_388 , 0 ) ;
V_38 = - V_165 ;
if ( V_143 == NULL )
goto V_390;
V_24 = F_42 ( V_143 ) ;
...
V_163 = F_60 ( V_141 , V_391 , sizeof( * V_24 ) ) ;
V_38 = - V_165 ;
if ( V_163 == NULL )
goto V_390;
V_24 = F_2 ( V_163 ) ;
...
static int F_194 ( struct V_86 * V_87 , const struct V_145 * V_146 )
{
switch ( V_146 -> V_152 ) {
case V_381 :
return F_188 ( V_87 , V_146 ) ;
case V_311 :
return F_190 ( V_87 , V_146 ) ;
case V_389 :
case V_392 :
case V_148 :
return F_193 ( V_87 , V_146 ) ;
case V_384 :
return F_191 ( V_146 ) ;
default:
F_195 ( V_393 L_3 ,
...
static inline T_4 F_196 ( struct V_86 * V_87 ,
struct V_268 * V_270 )
{
...
static int F_197 ( struct V_140 * V_141 , struct V_86 * V_87 ,
struct V_276 * V_394 , struct V_268 * V_270 )
{
T_6 V_132 = F_198 () ;
struct V_324 * V_325 ;
struct V_142 * V_143 ;
int V_38 ;
V_143 = F_68 ( V_141 , 0 , 0 , V_395 , sizeof( * V_325 ) , 0 ) ;
if ( V_143 == NULL )
return - V_165 ;
V_325 = F_42 ( V_143 ) ;
...
V_325 -> V_281 = V_394 -> V_281 ;
V_325 -> V_282 = V_394 -> V_282 ;
V_325 -> V_283 = V_394 -> V_283 ;
...
static int F_199 ( struct V_86 * V_87 , struct V_276 * V_394 ,
struct V_268 * V_270 )
{
struct V_113 * V_113 = F_189 ( V_87 ) ;
struct V_140 * V_141 ;
V_141 = F_80 ( F_196 ( V_87 , V_270 ) , V_196 ) ;
if ( V_141 == NULL )
return - V_68 ;
if ( F_197 ( V_141 , V_87 , V_394 , V_270 ) < 0 )
F_98 () ;
return F_83 ( V_113 , V_141 , 0 , V_396 ) ;
}
static struct V_268 * F_200 ( struct V_186 * V_144 , int V_397 ,
...
static inline T_4 F_201 ( struct V_268 * V_270 )
{
...
static int F_202 ( struct V_140 * V_141 , struct V_268 * V_270 ,
...
struct V_142 * V_143 ;
int V_38 ;
V_143 = F_68 ( V_141 , V_146 -> V_150 , 0 , V_404 , sizeof( * V_403 ) , 0 ) ;
if ( V_143 == NULL )
return - V_165 ;
V_403 = F_42 ( V_143 ) ;
F_124 ( V_270 , & V_403 -> V_269 , V_251 ) ;
V_38 = F_134 ( V_270 , V_141 ) ;
if ( ! V_38 )
V_38 = F_136 ( V_270 , V_141 ) ;
if ( ! V_38 )
...
{
struct V_113 * V_113 = F_204 ( V_270 ) ;
struct V_140 * V_141 ;
V_141 = F_80 ( F_201 ( V_270 ) , V_196 ) ;
if ( V_141 == NULL )
return - V_68 ;
if ( F_202 ( V_141 , V_270 , V_251 , V_146 ) < 0 )
F_98 () ;
return F_83 ( V_113 , V_141 , 0 , V_382 ) ;
}
...
V_163 = F_60 ( V_141 , V_405 , sizeof( * V_24 ) ) ;
V_38 = - V_165 ;
if ( V_163 == NULL )
goto V_390;
V_24 = F_2 ( V_163 ) ;
...
goto V_390;
F_71 ( V_141 , V_143 ) ;
return F_83 ( V_113 , V_141 , 0 , V_406 ) ;
V_390:
F_82 ( V_141 ) ;
return V_38 ;
}
static int F_206 ( const struct V_145 * V_146 )
{
struct V_113 * V_113 = V_146 -> V_113 ;
struct V_142 * V_143 ;
struct V_140 * V_141 ;
...
if ( V_141 == NULL )
return - V_68 ;
V_143 = F_68 ( V_141 , V_146 -> V_150 , V_146 -> V_132 , V_407 , 0 , 0 ) ;
V_38 = - V_165 ;
if ( V_143 == NULL )
goto V_390;
...
static int F_207 ( struct V_268 * V_270 , int V_251 , const struct V_145 * V_146 )
{
switch ( V_146 -> V_152 ) {
case V_297 :
case V_408 :
case V_304 :
return F_205 ( V_270 , V_251 , V_146 ) ;
case V_407 :
return F_206 ( V_146 ) ;
case V_404 :
...
static inline T_4 F_208 ( void )
{
return F_87 ( sizeof( struct V_409 ) ) ;
}
static int F_209 ( struct V_140 * V_141 , T_2 V_34 ,
struct V_357 * V_88 , T_1 * V_410 )
{
struct V_409 * V_411 ;
struct V_142 * V_143 ;
V_143 = F_68 ( V_141 , 0 , 0 , V_412 , sizeof( * V_411 ) , 0 ) ;
if ( V_143 == NULL )
return - V_165 ;
V_411 = F_42 ( V_143 ) ;
V_411 -> V_34 = V_34 ;
memcpy ( & V_411 -> V_88 , V_88 , sizeof( V_411 -> V_88 ) ) ;
if ( V_410 ) {
int V_38 = F_64 ( V_141 , V_53 , sizeof( * V_410 ) , V_410 ) ;
if ( V_38 ) {
F_70 ( V_141 , V_143 ) ;
return V_38 ;
}
...
static int F_210 ( struct V_113 * V_113 , T_2 V_34 ,
struct V_357 * V_88 , T_1 * V_410 )
{
struct V_140 * V_141 ;
V_141 = F_80 ( F_208 () , V_196 ) ;
if ( V_141 == NULL )
return - V_68 ;
if ( F_209 ( V_141 , V_34 , V_88 , V_410 ) < 0 )
F_98 () ;
return F_83 ( V_113 , V_141 , 0 , V_413 ) ;
}
static inline T_4 F_211 ( void )
{
return F_87 ( sizeof( struct V_414 ) ) ;
}
static int F_212 ( struct V_140 * V_141 , struct V_86 * V_87 ,
T_1 * V_349 , T_7 V_415 )
{
struct V_414 * V_338 ;
struct V_142 * V_143 ;
V_143 = F_68 ( V_141 , 0 , 0 , V_416 , sizeof( * V_338 ) , 0 ) ;
if ( V_143 == NULL )
return - V_165 ;
V_338 = F_42 ( V_143 ) ;
...
V_338 -> V_415 = V_415 ;
V_338 -> V_417 = V_87 -> V_127 -> V_418 ;
V_338 -> V_90 = V_87 -> V_58 . V_90 ;
F_71 ( V_141 , V_143 ) ;
return 0 ;
}
static int F_213 ( struct V_86 * V_87 , T_1 * V_419 ,
T_7 V_420 )
{
struct V_113 * V_113 = F_189 ( V_87 ) ;
struct V_140 * V_141 ;
...
if ( ! V_87 -> V_127 )
return - V_7 ;
V_141 = F_80 ( F_211 () , V_196 ) ;
if ( V_141 == NULL )
return - V_68 ;
if ( F_212 ( V_141 , V_87 , V_419 , V_420 ) < 0 )
F_98 () ;
return F_83 ( V_113 , V_141 , 0 , V_421 ) ;
}
static bool F_214 ( const struct V_145 * V_146 )
{
return ( bool ) F_215 ( V_146 -> V_113 ) ;
}
static int T_8 F_216 ( struct V_113 * V_113 )
{
struct V_186 * V_199 ;
struct V_422 V_423 = {
. V_424 = V_425 ,
...
V_199 = F_217 ( V_113 , V_427 , & V_423 ) ;
if ( V_199 == NULL )
return - V_68 ;
V_113 -> V_133 . V_428 = V_199 ;
F_218 ( V_113 -> V_133 . V_199 , V_199 ) ;
return 0 ;
}
static void T_9 F_219 ( struct V_429 * V_430 )
{
struct V_113 * V_113 ;
F_220 (net, net_exit_list, exit_list)
F_221 ( V_113 -> V_133 . V_199 , NULL ) ;
F_222 () ;
F_220 (net, net_exit_list, exit_list)
F_223 ( V_113 -> V_133 . V_428 ) ;
}
