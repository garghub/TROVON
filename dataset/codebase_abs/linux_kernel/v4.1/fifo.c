...
F_66 ( V_9 , L_11 ,
V_23 -> V_90 , F_42 ( V_7 ) , V_2 -> V_20 , V_2 -> V_14 ) ;
F_65 ( V_7 , 1 ) ;
F_85 ( V_7 , V_23 ) ;
F_60 ( V_7 , V_2 -> V_83 ) ;
F_86 ( V_25 ) ;
...
if ( F_43 ( V_7 ) )
return 0 ;
if ( ( V_13 < F_47 ( V_6 , V_92 ) ) ||
F_29 ( V_7 ) )
goto F_67;
if ( ! F_47 ( V_6 , V_93 ) && V_13 & 0x7 )
goto F_67;
V_91 = F_47 ( V_6 , V_93 ) ?
V_94 - 1 : 0x7 ;
...
static int F_96 ( struct V_1 * V_2 , int * V_4 )
{
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
if ( F_47 ( V_6 , V_93 ) )
return F_94 ( V_2 , V_4 ) ;
...
static T_6 F_101 ( struct V_1 * V_2 ,
...
struct V_24 * V_25 = F_20 ( V_23 , V_2 ) ;
int V_61 ;
F_104 ( V_6 , V_103 , F_42 ( V_7 ) ) ;
V_61 = F_39 ( V_6 , V_23 ) ;
F_22 ( V_7 , V_23 ) ;
V_2 -> V_21 = F_101 ( V_2 , V_25 , V_61 ) ;
F_92 ( V_7 , V_23 ) ;
F_23 ( V_2 ) ;
F_24 ( V_7 , V_7 -> V_23 ) ;
* V_4 = 1 ;
...
static int F_105 ( struct V_1 * V_2 , int * V_4 )
{
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
if ( F_47 ( V_6 , V_93 ) )
return F_103 ( V_2 , V_4 ) ;
else
return F_100 ( V_2 , V_4 ) ;
}
static bool F_106 ( struct V_24 * V_25 , void * V_104 )
{
...
static void F_107 ( struct V_5 * V_6 , struct V_22 * V_23 )
{
if ( V_23 -> V_65 )
F_108 ( V_23 -> V_65 ) ;
if ( V_23 -> V_67 )
...
F_110 ( V_44 ) ;
F_111 ( V_110 , V_44 ) ;
V_23 -> V_65 = F_112 ( V_44 , F_106 ,
& V_23 -> V_111 ) ;
F_110 ( V_44 ) ;
F_111 ( V_110 , V_44 ) ;
V_23 -> V_67 = F_112 ( V_44 , F_106 ,
& V_23 -> V_112 ) ;
}
static void F_113 ( struct V_8 * V_9 , struct V_22 * V_23 ,
int V_113 )
{
char V_90 [ 16 ] ;
snprintf ( V_90 , sizeof( V_90 ) , L_12 , V_113 ) ;
if ( V_113 & 1 ) {
V_23 -> V_65 = F_114 ( V_9 , V_90 ) ;
if ( F_115 ( V_23 -> V_65 ) )
V_23 -> V_65 = NULL ;
} else {
V_23 -> V_67 = F_114 ( V_9 , V_90 ) ;
if ( F_115 ( V_23 -> V_67 ) )
V_23 -> V_67 = NULL ;
}
}
static void F_116 ( struct V_5 * V_6 , struct V_22 * V_23 ,
int V_113 )
{
struct V_8 * V_9 = F_5 ( V_6 ) ;
if ( V_9 -> V_114 )
F_113 ( V_9 , V_23 , V_113 ) ;
else
F_109 ( V_23 ) ;
...
{
struct V_120 * V_121 = F_122 ( V_6 ) ;
struct V_22 * V_122 = F_50 ( V_6 ) ;
struct V_22 * V_123 ;
int V_57 ;
V_121 -> V_124 = F_117 ;
V_121 -> V_125 = F_119 ;
