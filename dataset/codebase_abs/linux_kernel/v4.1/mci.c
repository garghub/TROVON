...
if ( V_125 & V_145 ) {
V_125 &= ~ V_145 ;
V_126 = F_43 ( V_53 , V_146 ) ;
}
if ( V_125 & V_147 ) {
V_125 &= ~ V_147 ;
while ( V_129 == V_130 ) {
if ( F_41 ( V_148 , & V_8 -> V_149 ) )
return;
V_128 = V_3 -> V_123 . V_113 ;
V_126 = F_56 ( V_53 , & V_129 ) ;
if ( V_126 == V_150 )
break;
V_128 += ( V_126 >> 2 ) ;
V_127 = F_57 ( V_128 ) ;
...
V_125 &= ~ V_155 ;
if ( V_125 & V_156 ) {
int V_157 = F_61 ( V_29 -> V_158 ,
V_159 ) ;
V_125 &= ~ V_156 ;
F_19 ( V_8 , V_41 ,
L_17 ,
F_61 ( V_29 -> V_158 , V_160 ) ?
L_18 : L_19 ,
F_61 ( V_29 -> V_158 , V_161 ) ,
V_157 ) ;
}
if ( V_125 & V_162 )
V_125 &= ~ V_162 ;
...
V_124 &= ~ ( V_142 |
V_143 ) ;
F_42 ( V_26 , V_164 , NULL ) ;
}
}
void F_62 ( struct V_25 * V_26 )
{
struct V_7 * V_8 = F_17 ( V_26 -> V_27 ) ;
if ( ! V_8 -> V_165 )
return;
if ( V_26 -> V_27 -> V_166 . V_167 & V_168 )
V_26 -> V_27 -> V_169 |= V_170 ;
}
void F_63 ( struct V_25 * V_26 , bool V_171 )
{
struct V_52 * V_53 = V_26 -> V_27 ;
struct V_28 * V_3 = & V_53 -> V_30 . V_3 ;
struct V_172 * V_173 = V_53 -> V_45 ;
T_2 V_174 [] = { 0x00000000 , 0xffff0000 , 0xffffffff , 0x7fffffff } ;
int V_78 ;
T_3 V_175 , V_176 ;
T_4 V_177 ;
if ( ! V_173 || ! F_21 ( V_173 ) )
...
L_20 ,
V_177 , V_175 , V_176 ) ;
for ( V_78 = V_175 ; V_78 < V_176 ; V_78 ++ )
F_66 ( & V_174 , V_78 ) ;
V_178:
for ( V_78 = 0 ; V_78 < 4 ; V_78 ++ )
V_3 -> V_181 [ V_78 ] = V_174 [ V_78 ] ;
F_45 ( V_53 ) ;
F_43 ( V_53 , V_182 ) ;
}
void F_67 ( struct V_25 * V_26 , bool V_183 ,
bool V_184 )
{
struct V_52 * V_53 = V_26 -> V_27 ;
struct V_28 * V_29 = & V_26 -> V_27 -> V_30 . V_3 ;
bool V_185 = V_29 -> V_184 ;
if ( ! ( V_29 -> V_32 & V_186 ) ) {
V_29 -> V_184 = false ;
return;
}
...
return;
if ( V_183 ) {
struct V_187 * V_188 = & V_26 -> V_189 -> V_188 ;
if ( F_64 ( V_53 -> V_45 ) &&
( V_53 -> V_45 -> V_179 > V_188 -> V_179 ) &&
( V_53 -> V_45 -> V_179 <= V_188 -> V_179 + 20 ) )
return;
if ( F_65 ( V_53 -> V_45 ) &&
( V_53 -> V_45 -> V_179 < V_188 -> V_179 ) &&
( V_53 -> V_45 -> V_179 >= V_188 -> V_179 - 20 ) )
...
V_29 -> V_184 = V_184 ;
if ( V_185 != V_29 -> V_184 )
F_68 ( V_53 , V_26 -> V_189 -> V_190 , false ) ;
}
...
if ( ! ( V_29 -> V_32 & V_186 ) )
return;
if ( V_53 -> V_191 . V_192 >= 40 ) {
if ( V_21 -> V_194 < 0 )
V_21 -> V_194 = 0 ;
if ( ++ V_21 -> V_194 >= V_195 ) {
V_21 -> V_194 = 0 ;
F_67 ( V_26 , false , true ) ;
}
} else {
if ( V_21 -> V_194 > 0 )
V_21 -> V_194 = 0 ;
