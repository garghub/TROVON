...
V_42 = F_2 ( V_17 . V_44 , V_2 , V_3 , V_12 ) ;
if ( V_42 )
return V_42 ;
V_17 . V_45 = 0 ;
V_17 . V_46 = V_47 ;
V_17 . V_48 = V_40 ;
V_17 . V_49 = V_41 ;
V_42 = F_7 ( V_35 -> V_50 , & V_17 ) ;
if ( V_42 < 0 )
return V_42 ;
V_42 = F_4 ( V_17 . V_51 , V_2 , & V_3 ) ;
if ( V_42 < 0 )
return V_42 ;
return V_3 ;
}
static T_3 F_8 ( struct V_32 * V_33 )
{
return V_52 | V_53 ;
}
static int F_9 ( struct V_54 * V_55 )
{
struct V_56 * V_57 = V_55 -> V_38 . V_58 ;
struct V_59 * V_50 = F_10 ( V_55 -> V_38 . V_60 ) ;
...
V_35 = F_12 ( V_38 , sizeof( * V_35 ) , V_63 ) ;
if ( V_35 == NULL )
return - V_64 ;
V_61 = F_13 ( V_57 , L_4 , & V_39 ) ;
if ( V_61 ) {
F_11 ( V_38 , L_5 ) ;
return V_61 ;
}
...
V_35 -> V_38 = V_38 ;
V_35 -> V_33 . V_65 = V_66 ;
F_14 ( V_35 -> V_33 . V_67 , L_6 , sizeof( V_35 -> V_33 . V_67 ) ) ;
V_35 -> V_33 . V_68 = & V_69 ;
V_35 -> V_33 . V_36 = V_35 ;
V_35 -> V_33 . V_38 . V_60 = & V_55 -> V_38 ;
V_35 -> V_33 . V_38 . V_58 = V_57 ;
V_35 -> V_33 . V_70 = V_71 ;
V_61 = F_15 ( & V_35 -> V_33 ) ;
if ( V_61 ) {
F_11 ( V_38 , L_7 ) ;
...
static int F_17 ( struct V_54 * V_38 )
{
struct V_34 * V_35 = F_18 ( V_38 ) ;
F_19 ( & V_35 -> V_33 ) ;
return 0 ;
}
