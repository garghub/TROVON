...
static struct V_1 * F_21 ( struct V_1 * * V_21 , struct V_1 * * V_22 )
{
...
static struct V_1 * F_23 ( struct V_1 * * V_21 , struct V_1 * * V_22 )
{
struct V_1 * V_31 = NULL ;
...
static void F_28 ( enum V_7 type , struct V_1 * * V_44 , struct V_1 * * V_21 , struct V_1 * * V_22 )
{
#define V_9 (*ep1)
#define V_10 (*ep2)
if ( V_9 -> type == type ) {
...
static int F_36 ( enum V_7 V_53 , enum V_7 V_54 )
{
if ( V_53 == V_54 )
return 0 ;
switch ( V_53 ) {
