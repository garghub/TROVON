...
unsigned int V_5 ;
for ( V_5 = 0 ; V_5 <= V_19 -> V_54 ; V_5 ++ )
if ( F_43 ( V_19 -> V_19 [ V_5 ] ) )
return false ;
return true ;
}
static bool F_44 ( struct V_9 * V_10 , bool V_84 )
{
struct V_63 * V_64 = V_10 -> V_41 ;
...
static int F_45 ( struct V_9 * V_10 , unsigned long V_85 )
{
...
static T_4 F_46 ( struct V_18 * V_19 , T_4 V_65 )
{
struct V_13 * V_21 ;
unsigned long V_25 ;
unsigned long * V_88 = F_25 ( F_47 ( V_89 ) * sizeof( unsigned long ) ,
V_72 ) ;
if ( ! V_88 )
return V_65 | 0xFFF ;
...
V_21 ;
V_21 = F_17 ( V_21 -> V_36 ) )
F_48 ( F_49 ( V_21 -> V_65 ) , V_88 ) ;
V_25 = F_50 ( V_88 , V_89 , 0x800 ) ;
if ( V_25 >= V_89 )
V_25 = F_50 ( V_88 , V_89 , 1 ) ;
F_26 ( V_88 ) ;
return V_65 | ( V_25 >= V_89 ? 0xFFF : V_25 ) ;
}
static int F_51 ( struct V_90 * V_90 , struct V_9 * V_10 ,
...
int V_96 ;
struct V_97 V_98 ;
F_52 ( & V_98 , V_99 , V_100 ) ;
V_96 = F_53 ( V_90 , V_10 , V_93 , V_94 , & V_98 , V_95 ) ;
if ( V_96 < 0 )
return V_96 ;
V_96 = - V_86 ;
if ( V_93 [ V_101 ] ) {
T_4 V_65 = F_54 ( V_93 [ V_101 ] ) ;
...
if ( V_93 [ V_104 ] ) {
V_21 -> V_12 . V_105 = F_54 ( V_93 [ V_104 ] ) ;
F_55 ( V_10 , & V_21 -> V_12 , V_91 ) ;
}
#ifdef F_11
if ( V_93 [ V_106 ] ) {
int V_107 ;
V_107 = F_56 ( V_90 , V_93 [ V_106 ] ) ;
if ( V_107 < 0 )
goto V_103;
V_21 -> V_50 = V_107 ;
}
#endif
F_57 ( V_10 , & V_21 -> V_52 , & V_98 ) ;
return 0 ;
V_103:
F_30 ( & V_98 ) ;
return V_96 ;
...
break;
F_27 ( V_21 -> V_36 , V_109 -> V_36 ) ;
F_28 ( * V_108 , V_21 ) ;
}
static struct V_13 * F_59 ( struct V_9 * V_10 ,
struct V_13 * V_21 )
{
struct V_13 * V_110 ;
struct V_2 * V_111 = & V_21 -> V_3 ;
V_110 = F_25 ( sizeof( * V_21 ) + V_111 -> V_38 * sizeof( struct V_29 ) ,
V_72 ) ;
if ( ! V_110 )
return NULL ;
F_27 ( V_110 -> V_36 , V_21 -> V_36 ) ;
V_110 -> V_65 = V_21 -> V_65 ;
F_27 ( V_110 -> V_62 , V_21 -> V_62 ) ;
#ifdef F_11
V_110 -> V_50 = V_21 -> V_50 ;
#endif
V_110 -> V_4 = V_21 -> V_4 ;
V_110 -> V_12 = V_21 -> V_12 ;
F_27 ( V_110 -> V_46 , V_21 -> V_46 ) ;
if ( V_110 -> V_46 )
V_110 -> V_46 -> V_74 ++ ;
#ifdef F_6
...
F_52 ( & V_110 -> V_52 , V_99 , V_100 ) ;
return V_110 ;
}
static int F_60 ( struct V_90 * V_90 , struct V_7 * V_112 ,
...
if ( V_114 == NULL )
return V_65 ? - V_86 : 0 ;
V_96 = F_61 ( V_93 , V_116 , V_114 , V_119 ) ;
if ( V_96 < 0 )
return V_96 ;
...
if ( F_22 ( V_21 -> V_65 ) == 0 )
return - V_86 ;
V_110 = F_59 ( V_10 , V_21 ) ;
if ( ! V_110 )
return - V_120 ;
V_96 = F_51 ( V_90 , V_10 , V_91 ,
F_17 ( V_21 -> V_62 ) , V_110 , V_93 ,
V_113 [ V_121 ] , V_95 ) ;
if ( V_96 ) {
F_29 ( V_10 , V_110 , false ) ;
return V_96 ;
}
F_58 ( V_10 , V_64 , V_110 ) ;
F_36 ( V_10 , & V_21 -> V_12 ) ;
F_37 ( & V_21 -> V_78 , F_32 ) ;
return 0 ;
}
if ( V_93 [ V_122 ] ) {
unsigned int V_54 = F_54 ( V_93 [ V_122 ] ) ;
if ( -- V_54 > 0x100 )
return - V_86 ;
if ( F_22 ( V_65 ) )
return - V_86 ;
...
return - V_86 ;
V_65 = V_117 | F_49 ( V_65 ) ;
} else
V_65 = F_46 ( V_19 , V_117 ) ;
if ( V_93 [ V_124 ] == NULL )
return - V_86 ;
V_111 = F_62 ( V_93 [ V_124 ] ) ;
V_21 = F_25 ( sizeof( * V_21 ) + V_111 -> V_38 * sizeof( struct V_29 ) , V_72 ) ;
if ( V_21 == NULL )
return - V_73 ;
#ifdef F_6
V_118 = sizeof( struct V_125 ) + V_111 -> V_38 * sizeof( V_126 ) ;
V_21 -> V_31 = F_63 ( V_118 , F_64 ( struct V_125 ) ) ;
if ( ! V_21 -> V_31 ) {
F_26 ( V_21 ) ;
return - V_73 ;
}
...
F_27 ( V_21 -> V_62 , V_19 ) ;
V_21 -> V_65 = V_65 ;
V_21 -> V_4 = V_111 -> V_6 ? F_65 ( F_2 ( V_111 -> V_6 ) ) - 1 : 0 ;
F_52 ( & V_21 -> V_52 , V_99 , V_100 ) ;
V_21 -> V_10 = V_10 ;
#ifdef F_8
V_21 -> V_37 = F_66 ( T_4 ) ;
if ( ! V_21 -> V_37 ) {
...
if ( V_93 [ V_127 ] ) {
struct V_128 * V_33 ;
V_33 = F_62 ( V_93 [ V_127 ] ) ;
V_21 -> V_35 = V_33 -> V_35 ;
V_21 -> V_34 = V_33 -> V_34 ;
}
#endif
V_96 = F_51 ( V_90 , V_10 , V_91 , V_19 , V_21 , V_93 , V_113 [ V_121 ] , V_95 ) ;
if ( V_96 == 0 ) {
struct V_13 T_5 * * V_108 ;
struct V_13 * V_109 ;
...
V_108 = & V_109 -> V_36 , V_109 = F_17 ( * V_108 ) )
if ( F_49 ( V_65 ) < F_49 ( V_109 -> V_65 ) )
break;
F_27 ( V_21 -> V_36 , V_109 ) ;
F_28 ( * V_108 , V_21 ) ;
...
static void F_67 ( struct V_9 * V_10 , struct V_129 * V_85 )
{
struct V_63 * V_64 = V_10 -> V_41 ;
struct V_18 * V_19 ;
struct V_13 * V_21 ;
...
static int F_68 ( struct V_90 * V_90 , struct V_9 * V_10 , unsigned long V_134 ,
...
if ( F_70 ( V_8 , V_123 , V_117 ) )
goto V_139;
}
if ( V_21 -> V_12 . V_105 &&
F_70 ( V_8 , V_104 , V_21 -> V_12 . V_105 ) )
goto V_139;
V_46 = F_17 ( V_21 -> V_46 ) ;
if ( V_46 &&
F_70 ( V_8 , V_101 , V_46 -> V_65 ) )
goto V_139;
#ifdef F_8
...
int V_143 ;
F_72 (cpum) {
T_7 V_144 = * F_73 ( V_21 -> V_37 , V_143 ) ;
V_33 . V_142 += V_144 ;
}
if ( F_71 ( V_8 , V_127 , sizeof( V_33 ) , & V_33 ) )
goto V_139;
}
#endif
if ( F_74 ( V_8 , & V_21 -> V_52 ) < 0 )
goto V_139;
#ifdef F_11
if ( V_21 -> V_50 ) {
struct V_145 * V_146 ;
V_146 = F_75 ( V_90 , V_21 -> V_50 ) ;
if ( V_146 && F_76 ( V_8 , V_106 , V_146 -> V_147 ) )
goto V_139;
}
#endif
#ifdef F_6
V_140 = F_25 ( sizeof( struct V_125 ) +
...
F_72 (cpu) {
int V_25 ;
struct V_125 * V_31 = F_73 ( V_21 -> V_31 , V_141 ) ;
