...
if ( ! strcmp ( V_109 -> V_113 [ V_43 ] , V_96 -> V_114 -> V_105 ) )
V_111 = true ;
}
if ( ! V_111 )
return 0 ;
for ( V_110 = 0 ; V_110 < V_109 -> V_114 -> V_115 ; V_110 ++ ) {
enum V_97 V_116 ;
V_116 = V_109 -> V_114 -> V_117 [ V_110 ] ;
if ( F_47 ( V_109 , V_116 , & V_23 ) )
continue;
switch ( V_116 ) {
case V_101 :
...
struct V_1 * V_5 = F_51 ( V_122 ) ;
int V_43 , V_83 ;
for ( V_43 = 0 ; V_43 < F_54 ( V_124 ) ; V_43 ++ ) {
V_83 = F_55 ( V_122 , V_124 [ V_43 ] . V_105 ) ;
F_56 ( V_83 , V_5 ) ;
}
F_57 ( V_5 -> V_81 ) ;
F_58 () ;
...
T_1 V_100 ;
V_5 = F_61 ( & V_122 -> V_19 , sizeof( * V_5 ) , V_133 ) ;
if ( ! V_5 ) {
...
for ( V_43 = 0 ; V_43 < F_54 ( V_124 ) ; V_43 ++ ) {
V_83 = F_55 ( V_122 , V_124 [ V_43 ] . V_105 ) ;
V_23 = F_70 ( V_83 , NULL , V_124 [ V_43 ] . V_148 ,
V_149 | V_150 ,
