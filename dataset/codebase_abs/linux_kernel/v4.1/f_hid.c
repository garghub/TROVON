...
static inline struct V_132 * F_65 ( struct V_133 * V_134 )
{
return F_2 ( F_66 ( V_134 ) , struct V_132 ,
V_135 . V_136 ) ;
}
static void F_67 ( struct V_133 * V_134 )
{
struct V_132 * V_137 = F_65 ( V_134 ) ;
F_68 ( & V_137 -> V_135 ) ;
}
static T_1 F_69 ( struct V_132 * V_137 , char * V_138 )
{
int V_139 ;
F_18 ( & V_137 -> V_44 ) ;
V_139 = V_137 -> V_89 ;
memcpy ( V_138 , V_137 -> V_90 , V_137 -> V_89 ) ;
F_20 ( & V_137 -> V_44 ) ;
return V_139 ;
}
static T_1 F_70 ( struct V_132 * V_137 ,
const char * V_138 , T_3 V_140 )
{
int V_16 = - V_141 ;
char * V_142 ;
F_18 ( & V_137 -> V_44 ) ;
...
static void F_74 ( struct V_148 * V_3 )
{
struct V_132 * V_137 ;
V_137 = F_2 ( V_3 , struct V_132 , V_135 ) ;
F_18 ( & V_149 ) ;
F_72 ( V_137 -> V_127 ) ;
if ( F_75 ( & V_131 . V_150 ) )
F_76 () ;
...
static struct V_148 * F_77 ( void )
{
struct V_132 * V_137 ;
struct V_148 * V_16 ;
int V_36 = 0 ;
V_137 = F_30 ( sizeof( * V_137 ) , V_32 ) ;
if ( ! V_137 )
return F_78 ( - V_42 ) ;
F_52 ( & V_137 -> V_44 ) ;
V_137 -> V_135 . V_151 = F_74 ;
V_16 = & V_137 -> V_135 ;
F_18 ( & V_149 ) ;
if ( F_75 ( & V_131 . V_150 ) ) {
V_36 = F_79 ( NULL , V_152 ) ;
if ( V_36 ) {
V_16 = F_78 ( V_36 ) ;
F_13 ( V_137 ) ;
goto V_153;
...
V_137 -> V_127 = F_63 () ;
if ( V_137 -> V_127 < 0 ) {
V_16 = F_78 ( V_137 -> V_127 ) ;
F_13 ( V_137 ) ;
if ( F_75 ( & V_131 . V_150 ) )
F_76 () ;
goto V_153;
}
F_80 ( & V_137 -> V_135 . V_136 , L_21 , & V_154 ) ;
V_153:
F_20 ( & V_149 ) ;
return V_16 ;
}
...
struct V_132 * V_137 ;
V_9 = F_1 ( V_3 ) ;
V_137 = F_2 ( V_3 -> V_155 , struct V_132 , V_135 ) ;
F_13 ( V_9 -> V_90 ) ;
F_13 ( V_9 ) ;
F_18 ( & V_137 -> V_44 ) ;
-- V_137 -> V_143 ;
...
static struct V_2 * F_84 ( struct V_148 * V_155 )
{
struct V_1 * V_9 ;
struct V_132 * V_137 ;
...
if ( ! V_9 )
return F_78 ( - V_42 ) ;
V_137 = F_2 ( V_155 , struct V_132 , V_135 ) ;
F_18 ( & V_137 -> V_44 ) ;
++ V_137 -> V_143 ;
V_9 -> V_127 = V_137 -> V_127 ;
V_9 -> V_117 = V_137 -> V_156 ;
V_9 -> V_118 = V_137 -> V_157 ;
V_9 -> V_30 = V_137 -> V_30 ;
V_9 -> V_89 = V_137 -> V_89 ;
if ( V_137 -> V_90 ) {
V_9 -> V_90 = F_71 ( V_137 -> V_90 ,
V_137 -> V_89 ,
V_32 ) ;
if ( ! V_9 -> V_90 ) {
F_13 ( V_9 ) ;
