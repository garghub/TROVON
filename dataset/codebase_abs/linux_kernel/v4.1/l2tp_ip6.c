...
V_38 = & V_85 -> V_61 ;
if ( V_52 -> V_101 ) {
V_121 . V_117 = V_85 -> V_97 & V_137 ;
if ( V_121 . V_117 & V_138 ) {
V_117 = F_70 ( V_3 , V_121 . V_117 ) ;
if ( V_117 == NULL )
return - V_58 ;
}
}
...
V_56 = F_71 ( F_6 ( V_3 ) , V_3 , V_109 , & V_121 , V_115 ,
& V_123 , & V_124 , & V_125 ) ;
if ( V_56 < 0 ) {
F_72 ( V_117 ) ;
return V_56 ;
...
V_115 = V_52 -> V_115 ;
if ( V_117 )
V_115 = F_73 ( & V_111 , V_117 , V_115 ) ;
V_115 = F_74 ( & V_111 , V_115 ) ;
...
V_113 = F_75 ( & V_121 , V_115 , & V_114 ) ;
if ( ! V_121 . V_140 && F_76 ( & V_121 . V_38 ) )
V_121 . V_140 = V_52 -> V_149 ;
else if ( ! V_121 . V_140 )
V_121 . V_140 = V_52 -> V_150 ;
F_77 ( V_3 , F_78 ( & V_121 ) ) ;
V_119 = F_79 ( V_3 , & V_121 , V_113 ) ;
if ( F_80 ( V_119 ) ) {
V_56 = F_81 ( V_119 ) ;
goto V_107;
}
if ( V_123 < 0 )
V_123 = F_82 ( V_52 , & V_121 , V_119 ) ;
if ( V_124 < 0 )
V_124 = V_52 -> V_124 ;
if ( V_125 < 0 )
V_125 = V_52 -> V_125 ;
if ( V_109 -> V_130 & V_151 )
goto V_152;
V_153:
F_39 ( V_3 ) ;
V_56 = F_83 ( V_3 , V_154 , V_109 ,
V_127 , V_126 , V_123 , V_124 , V_115 ,
& V_121 , (struct V_155 * ) V_119 ,
V_109 -> V_130 , V_125 ) ;
if ( V_56 )
F_40 ( V_3 ) ;
else if ( ! ( V_109 -> V_130 & V_156 ) )
V_56 = F_64 ( V_3 ) ;
F_41 ( V_3 ) ;
V_157:
F_84 ( V_119 ) ;
...
V_152:
F_85 ( V_119 ) ;
if ( ! ( V_109 -> V_130 & V_158 ) || V_31 )
goto V_153;
V_56 = 0 ;
goto V_157;
}
static int F_86 ( struct V_2 * V_3 , struct V_108 * V_109 , T_2 V_31 ,
int V_159 , int V_92 , int * V_48 )
{
struct V_51 * V_52 = F_45 ( V_3 ) ;
F_69 ( struct V_53 * , V_85 , V_109 -> V_112 ) ;
T_2 V_160 = 0 ;
...
* V_48 = sizeof( * V_85 ) ;
if ( V_92 & V_161 )
return F_87 ( V_3 , V_109 , V_31 , V_48 ) ;
V_15 = F_88 ( V_3 , V_92 , V_159 , & V_56 ) ;
if ( ! V_15 )
goto V_107;
V_160 = V_15 -> V_31 ;
if ( V_31 < V_160 ) {
