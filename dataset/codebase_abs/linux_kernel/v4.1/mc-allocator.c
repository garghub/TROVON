...
struct V_5 * V_6 = V_10 -> V_25 ;
if ( F_2 ( V_10 -> type != V_47 ) )
return - V_12 ;
if ( F_2 ( ! V_6 ) )
return - V_12 ;
error = F_28 ( V_42 , V_6 -> V_16 . V_24 , & V_54 ) ;
if ( error < 0 ) {
F_6 ( & V_6 -> V_21 , L_4 , error ) ;
return error ;
}
error = F_29 ( V_42 , V_54 ) ;
if ( error < 0 ) {
F_6 ( & V_6 -> V_21 , L_5 , error ) ;
return error ;
}
error = F_30 ( V_42 , V_54 ) ;
if ( error < 0 ) {
F_6 ( & V_6 -> V_21 , L_6 , error ) ;
return error ;
}
return 0 ;
}
