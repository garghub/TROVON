...
static int T_6 F_109 ( struct V_108 * V_103 )
{
if ( V_4 . V_151 )
F_107 ( V_4 . V_151 ) ;
if ( V_4 . V_153 )
...
static int F_110 ( struct V_155 * V_104 )
{
F_5 () ;
F_111 ( V_104 , 0 ) ;
return 0 ;
}
static int F_112 ( struct V_155 * V_104 )
{
int T_2 ;
T_2 = F_111 ( V_104 , 1000000000 ) ;
if ( T_2 )
return T_2 ;
F_9 () ;
return 0 ;
