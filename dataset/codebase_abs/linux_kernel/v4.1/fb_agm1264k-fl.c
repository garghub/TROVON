...
if ( ! V_51 )
return - V_54 ;
F_2 ( V_55 , V_2 , L_1 , V_5 ) ;
for ( V_43 = 0 ; V_43 < V_2 -> V_10 -> V_45 . V_46 ; ++ V_43 )
for ( V_42 = 0 ; V_42 < V_2 -> V_10 -> V_45 . V_52 ; ++ V_42 ) {
T_4 V_56 = V_48 [ V_42 * V_2 -> V_10 -> V_45 . V_46 + V_43 ] ;
T_4 V_57 = V_56 & 0x1f ;
T_4 V_58 = ( V_56 & ( 0x3f << 5 ) ) >> 5 ;
T_4 V_59 = ( V_56 & ( 0x1f << ( 5 + 6 ) ) ) >> ( 5 + 6 ) ;
V_56 = ( 299 * V_59 + 587 * V_58 + 114 * V_57 ) / 200 ;
if ( V_56 > 255 )
V_56 = 255 ;
V_51 [ V_42 * V_2 -> V_10 -> V_45 . V_46 + V_43 ] =
( signed short ) V_60 [ V_56 ] ;
}
for ( V_43 = 0 ; V_43 < V_2 -> V_10 -> V_45 . V_46 ; ++ V_43 )
for ( V_42 = 0 ; V_42 < V_2 -> V_10 -> V_45 . V_52 ; ++ V_42 ) {
signed short V_56 =
V_51 [ V_42 * V_2 -> V_10 -> V_45 . V_46 + V_43 ] ;
signed short V_61 = V_56 - V_62 ;
signed short V_63 = V_56 - V_64 ;
signed short error ;
T_4 V_3 , V_65 ;
if ( abs ( V_61 ) >= abs ( V_63 ) ) {
error = V_63 ;
V_56 = 0xff ;
} else {
error = V_61 ;
...
|| V_42 + V_65 >= V_2 -> V_10 -> V_45 . V_52 )
continue;
V_68 = & V_51 [
( V_42 + V_65 ) * V_2 -> V_10 -> V_45 . V_46 +
V_43 + V_3 ] ;
V_69 = V_70 [ V_3 ] [ V_65 ] ;
if ( V_69 == - 1 )
* V_68 = V_56 ;
else {
signed short V_71 = * V_68 +
error * V_69 ;
if ( V_71 > V_64 )
V_71 = V_64 ;
if ( V_71 < V_62 )
...
{
F_13 ( V_72 , V_2 , V_2 -> V_10 -> V_11 , T_1 , V_27 , V_25 ,
L_17 , V_5 , V_25 ) ;
F_5 ( V_2 -> V_18 , 0 ) ;
while ( V_25 -- ) {
T_1 V_3 , V_73 ;
V_73 = * ( T_1 * ) V_27 ++ ;
for ( V_3 = 0 ; V_3 < 8 ; ++ V_3 )
F_5 ( V_2 -> V_8 . V_15 [ V_3 ] , V_73 & ( 1 << V_3 ) ) ;
F_5 ( V_2 -> V_13 , 1 ) ;
F_6 ( 5 ) ;
F_5 ( V_2 -> V_13 , 0 ) ;
F_6 ( 1 ) ;
