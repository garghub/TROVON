...
V_315 = F_109 ( & V_317 ) ;
for(; ; ) {
struct V_310 * V_310 = F_110 ( V_312 ) ;
...
if ( F_2 ( F_111 ( & V_317 , V_315 ) || V_314 ) ) {
F_43 () ;
if ( ! V_314 ) {
F_13 ( V_172 , V_30 , V_38 ) ;
goto V_316;
...
static struct V_20 * F_112 ( struct V_1 * V_172 ,
unsigned char type )
{
struct V_20 * V_319 ;
...
V_319 -> type = type ;
F_113 ( & V_319 -> V_167 , & V_172 -> V_193 ) ;
V_172 -> V_185 ++ ;
return V_319 ;
}
struct V_323 *
F_114 ( const T_7 char * V_324 )
{
...
void F_115 ( struct V_323 * V_43 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
struct V_20 * V_4 ;
if ( ! V_172 -> V_177 )
return;
V_4 = F_112 ( V_172 , V_326 ) ;
if ( ! V_4 )
return;
V_4 -> V_43 = V_43 ;
V_4 -> V_327 = V_328 ;
...
F_116 ( V_92 -> V_329 , & V_172 -> V_186 ) ;
}
void F_117 ( struct V_323 * V_43 , const struct V_187 * V_187 ,
unsigned int V_268 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
const struct V_310 * V_310 = F_110 ( V_187 ) ;
struct V_20 * V_4 ;
...
F_118 (n, &context->names_list, list) {
if ( V_4 -> V_22 ) {
...
V_274:
if ( V_313 ) {
V_4 -> V_327 = V_4 -> V_43 ? F_119 ( V_4 -> V_43 -> V_43 ) : V_328 ;
V_4 -> type = V_332 ;
if ( V_268 & V_336 )
V_4 -> V_298 = true ;
} else {
...
F_108 ( V_187 ) ;
F_120 ( V_4 , V_187 , V_310 ) ;
}
void F_121 ( const struct V_338 * V_338 )
{
F_117 ( NULL , V_338 -> V_339 . V_187 , 0 ) ;
}
void F_122 ( const struct V_310 * V_313 ,
...
if ( ! V_342 ) {
V_4 = F_112 ( V_172 , V_332 ) ;
if ( ! V_4 )
return;
F_120 ( V_4 , NULL , V_313 ) ;
}
if ( ! V_343 ) {
V_343 = F_112 ( V_172 , type ) ;
if ( ! V_343 )
return;
if ( V_342 ) {
...
if ( ! F_128 ( V_348 ) )
return - V_347 ;
if ( F_127 ( V_349 ) && F_129 ( V_59 ) )
return - V_347 ;
return 0 ;
}
static void F_130 ( T_2 V_350 , T_2 V_351 ,
...
goto V_274;
if ( F_129 ( V_59 ) )
V_199 = ( unsigned int ) F_136 ( & V_356 ) ;
V_355 -> V_199 = V_199 ;
V_355 -> V_59 = V_59 ;
V_274:
F_130 ( V_353 , V_59 , V_352 , V_199 , V_46 ) ;
return V_46 ;
}
void F_137 ( int V_238 , T_1 V_21 , struct V_256 * V_239 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
if ( V_239 )
...
void F_138 ( T_9 V_246 , T_6 V_247 , unsigned int V_248 ,
...
void F_139 ( T_9 V_246 , const struct V_357 * V_358 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
if ( V_358 )
...
void F_140 ( T_9 V_246 , struct V_256 * V_258 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
V_172 -> V_144 . V_230 = 0 ;
F_142 ( V_360 , & V_172 -> V_144 . V_142 ) ;
V_172 -> type = V_143 ;
}
void F_143 ( unsigned long V_232 , T_8 V_42 , T_10 V_48 , T_1 V_21 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
void F_144 ( struct V_361 * V_362 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> type = V_221 ;
V_172 -> V_224 . V_225 = V_362 -> V_225 ;
}
int F_145 ( int V_228 , unsigned long * args )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
void F_146 ( int V_365 , int V_366 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> V_285 [ 0 ] = V_365 ;
V_172 -> V_285 [ 1 ] = V_366 ;
}
int F_147 ( int V_183 , void * V_367 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
if ( ! V_172 -> V_197 ) {
void * V_30 = F_84 ( sizeof( struct V_368 ) , V_36 ) ;
if ( ! V_30 )
return - V_196 ;
V_172 -> V_197 = V_30 ;
}
...
void F_148 ( struct V_49 * V_345 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> V_291 = F_28 ( V_345 ) ;
V_172 -> V_292 = F_134 ( V_345 ) ;
V_172 -> V_293 = F_131 ( V_345 ) ;
V_172 -> V_294 = F_135 ( V_345 ) ;
F_37 ( V_345 , & V_172 -> V_295 ) ;
memcpy ( V_172 -> V_296 , V_345 -> V_200 , V_369 ) ;
}
int F_149 ( int V_370 , struct V_49 * V_345 )
{
struct V_289 * V_371 ;
struct V_49 * V_50 = V_92 ;
struct V_1 * V_2 = V_50 -> V_1 ;
T_2 V_42 = F_150 () , V_372 = F_131 ( V_345 ) ;
...
if ( ! V_2 -> V_291 ) {
V_2 -> V_291 = F_152 ( V_345 ) ;
V_2 -> V_292 = F_134 ( V_345 ) ;
V_2 -> V_293 = V_372 ;
V_2 -> V_294 = F_135 ( V_345 ) ;
...
void F_155 ( const struct V_51 * V_382 , const struct V_51 * V_383 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
void F_156 ( int V_267 , int V_268 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
static void F_157 ( struct V_201 * V_202 )
{
T_2 V_198 , V_42 ;
T_3 V_48 ;
unsigned int V_199 ;
...
F_73 ( V_202 , F_159 ( V_200 , V_92 ) ) ;
F_160 ( V_202 , V_92 -> V_222 ) ;
}
void F_161 ( long V_394 )
{
struct V_201 * V_202 ;
if ( ! V_304 )
return;
...
void F_162 ( unsigned long V_397 , long V_394 , int V_398 )
{
struct V_201 * V_202 ;
