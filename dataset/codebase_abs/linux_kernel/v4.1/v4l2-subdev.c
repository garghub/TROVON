...
if ( V_43 )
return V_43 ;
return F_31 ( V_4 , V_6 , V_76 , V_14 -> V_6 , V_29 ) ;
}
case V_77 : {
struct V_28 * V_29 = V_42 ;
V_43 = F_17 ( V_4 , V_29 ) ;
if ( V_43 )
return V_43 ;
return F_31 ( V_4 , V_6 , V_78 , V_14 -> V_6 , V_29 ) ;
}
case V_79 : {
...
V_89 -> V_30 != V_32 )
return - V_33 ;
if ( V_89 -> V_6 >= V_4 -> V_7 . V_8 )
return - V_33 ;
return F_31 ( V_4 , V_6 , V_90 , V_14 -> V_6 ,
V_89 ) ;
}
case V_91 : {
...
V_93 -> V_30 != V_32 )
return - V_33 ;
if ( V_93 -> V_6 >= V_4 -> V_7 . V_8 )
return - V_33 ;
return F_31 ( V_4 , V_6 , V_94 , V_14 -> V_6 ,
V_93 ) ;
}
case V_95 : {
struct V_96 * V_97 = V_42 ;
if ( V_97 -> V_6 >= V_4 -> V_7 . V_8 )
return - V_33 ;
return F_31 ( V_4 , V_98 , V_99 , V_42 ) ;
}
case V_100 : {
struct V_96 * V_97 = V_42 ;
if ( V_97 -> V_6 >= V_4 -> V_7 . V_8 )
return - V_33 ;
return F_31 ( V_4 , V_98 , V_101 , V_42 ) ;
}
case V_102 : {
...
V_104 -> V_30 != V_32 )
return - V_33 ;
if ( V_104 -> V_6 >= V_4 -> V_7 . V_8 )
return - V_33 ;
return F_31 ( V_4 , V_6 , V_105 , V_14 -> V_6 ,
V_104 ) ;
}
case V_106 : {
...
if ( V_43 )
return V_43 ;
return F_31 ( V_4 , V_6 , V_109 , V_39 ) ;
}
case V_110 : {
struct V_38 * V_39 = V_42 ;
V_43 = F_20 ( V_4 , V_39 ) ;
...
if ( V_114 -> V_6 >= V_4 -> V_7 . V_8 )
return - V_33 ;
return F_31 ( V_4 , V_6 , V_115 , V_114 ) ;
}
case V_116 : {
struct V_117 * V_118 = V_42 ;
if ( V_118 -> V_6 >= V_4 -> V_7 . V_8 )
return - V_33 ;
return F_31 ( V_4 , V_6 , V_119 , V_118 ) ;
}
case V_120 :
return F_31 ( V_4 , V_98 , V_121 , V_42 ) ;
case V_122 :
return F_31 ( V_4 , V_98 , V_123 , V_42 ) ;
case V_124 :
return F_31 ( V_4 , V_98 , V_125 , V_42 ) ;
#endif
default:
return F_31 ( V_4 , V_60 , V_126 , V_41 , V_42 ) ;
}
return 0 ;
}
...
struct V_12 * V_13 = F_7 ( V_11 ) ;
struct V_3 * V_4 = F_8 ( V_13 ) ;
return F_31 ( V_4 , V_60 , V_127 , V_41 , V_42 ) ;
}
static unsigned int F_38 ( struct V_11 * V_11 , T_1 * V_128 )
{
struct V_12 * V_13 = F_7 ( V_11 ) ;
struct V_3 * V_4 = F_8 ( V_13 ) ;
...
return - V_33 ;
if ( V_133 -> V_29 . V_137 != V_134 -> V_29 . V_137 &&
V_134 -> V_29 . V_137 != V_138 )
return - V_33 ;
return 0 ;
}
static int
...
if ( V_43 < 0 )
return 0 ;
V_144 = F_44 ( V_132 -> V_144 -> V_7 ) ;
V_43 = F_31 ( V_144 , V_6 , V_146 , V_132 ,
& V_133 , & V_134 ) ;
if ( V_43 != - V_56 )
return V_43 ;
return F_41 (
V_144 , V_132 , & V_133 , & V_134 ) ;
}
