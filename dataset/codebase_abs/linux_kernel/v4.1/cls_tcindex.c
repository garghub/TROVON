...
static bool F_40 ( struct V_19 * V_20 , bool V_83 )
{
struct V_6 * V_7 = F_12 ( V_20 -> V_22 ) ;
struct V_40 V_41 ;
if ( ! V_83 )
...
static int F_42 ( struct V_46 * V_46 , struct V_19 * V_20 , unsigned long V_84 ,
...
int V_37 ;
V_86 -> V_89 = 0 ;
for ( V_37 = 0 ; ! V_86 -> V_89 && V_37 < V_7 -> V_14 ; V_37 ++ ) {
V_13 = & V_7 -> V_11 [ V_37 ] ;
for ( V_10 = F_12 ( * V_13 ) ;
! V_86 -> V_89 && V_10 ;
