...
static void F_42 ( struct V_10 * V_11 , int V_87 , int V_88 )
{
T_1 T_2 * V_89 ;
T_1 V_21 ;
int V_90 ;
...
#endif
V_105 -> V_118 = F_53 ( V_36 ) ;
}
static void F_54 ( struct V_119 * V_119 )
{
struct V_120 * V_57 = V_119 -> V_121 ;
F_55 ( V_57 ) ;
}
static struct V_119 * F_56 (
struct V_1 * V_2 ,
void * V_122 ,
void * V_15 ,
struct V_120 * V_57
...
if ( ! V_119 )
return NULL ;
V_119 -> V_126 = F_59 ( V_2 , 0 ) ;
V_124 = ( F_60 ( V_119 -> V_126 ) ? V_2 -> V_127 : V_2 -> V_128 )
[ F_61 ( V_119 -> V_126 ) ] ;
if ( ! V_124 ) {
F_62 ( V_119 ) ;
return NULL ;
...
V_15 = F_70 ( V_133 , V_125 ) ;
if ( ! V_15 )
return - V_146 ;
V_122 = F_70 ( sizeof( struct V_142 ) , V_125 ) ;
if ( ! V_122 ) {
F_71 ( V_15 ) ;
return - V_146 ;
}
V_122 -> V_149 = V_150 ;
V_122 -> V_151 = V_152 ;
V_122 -> V_153 = F_53 ( V_154 << 8 ) ;
V_122 -> V_155 = 0 ;
V_122 -> V_156 = F_53 ( V_133 ) ;
V_119 = F_56 ( V_2 , V_122 , V_15 , & V_57 ) ;
if ( ! V_119 )
goto V_157;
V_94 = F_72 ( V_17 , V_119 , 1 ) ;
if ( V_94 )
goto V_158;
if ( ! F_73 ( & V_57 , F_35 ( 2000 ) ) ) {
F_74 ( V_119 ) ;
V_94 = - V_159 ;
F_69 ( V_11 , L_15 , V_160 ) ;
goto V_158;
}
F_9 ( 15 * 1000 ) ;
V_119 -> V_13 = - V_134 ;
...
F_64 ( & V_119 -> V_138 ) ;
F_64 ( & V_119 -> V_129 -> V_139 ) ;
V_94 = F_72 ( V_17 , V_119 , 0 ) ;
if ( ! V_94 && ! F_73 ( & V_57 ,
F_35 ( 2000 ) ) ) {
F_74 ( V_119 ) ;
V_94 = - V_159 ;
F_69 ( V_11 , L_16 , V_160 ) ;
}
V_158:
F_62 ( V_119 ) ;
V_157:
...
struct V_10 * V_11 = F_20 ( V_17 ) ;
int V_93 = F_5 ( V_11 -> V_19 ) ;
T_1 T_2 * V_89 = & V_11 -> V_20 -> V_21 [
( V_155 & 0xff ) - 1 ] ;
T_1 T_2 * V_40 = & V_11 -> V_20 -> V_41 [ ( V_155 & 0xff ) - 1 ] ;
T_1 V_36 , V_162 , V_13 ;
unsigned long V_95 ;
int V_94 = 0 ;
unsigned V_163 ;
...
} else if ( ! F_48 ( V_53 , V_11 -> V_102 [ V_155 ] ) ) {
;
...
V_155 &= 0xff ;
if ( F_39 ( V_11 -> V_75 ) ) {
if ( V_155 == F_82 ( V_11 -> V_19 ) &&
( F_83 ( & V_11 -> V_75 -> V_200 ) & V_201 ) ) {
V_94 = - V_148 ;
goto V_202;
}
}
...
static void F_86 ( struct V_16 * V_17 , int V_87 )
{
struct V_10 * V_11 = F_20 ( V_17 ) ;
if ( F_44 ( V_11 ) )
return;
...
static int F_87 ( struct V_16 * V_17 , int V_87 )
{
struct V_10 * V_11 = F_20 ( V_17 ) ;
T_1 T_2 * V_12 ;
if ( F_44 ( V_11 ) )
...
static int F_8 ( struct V_10 * V_11 , int V_87 , bool V_207 )
{
struct V_16 * V_17 = F_3 ( V_11 ) ;
...
F_12 ( V_11 , V_36 & ~ V_23 , V_89 ) ;
if ( V_17 -> V_208 -> V_209 )
V_17 -> V_208 -> V_209 ( V_17 , V_87 , V_207 ) ;
return 0 ;
}
