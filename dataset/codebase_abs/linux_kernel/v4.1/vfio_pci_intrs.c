...
static int F_42 ( struct V_3 * V_4 , unsigned V_47 ,
unsigned V_48 , T_2 * V_49 , bool V_37 )
{
int V_38 , V_50 , V_15 = 0 ;
if ( V_47 + V_48 > V_4 -> V_24 )
return - V_19 ;
for ( V_38 = 0 , V_50 = V_47 ; V_38 < V_48 && ! V_15 ; V_38 ++ , V_50 ++ ) {
int V_27 = V_49 ? V_49 [ V_38 ] : - 1 ;
V_15 = F_39 ( V_4 , V_50 , V_27 , V_37 ) ;
}
if ( V_15 ) {
for ( -- V_50 ; V_50 >= V_47 ; V_50 -- )
F_39 ( V_4 , V_50 , - 1 , V_37 ) ;
}
return V_15 ;
}
static void F_43 ( struct V_3 * V_4 , bool V_37 )
{
struct V_8 * V_9 = V_4 -> V_9 ;
int V_38 ;
F_42 ( V_4 , 0 , V_4 -> V_24 , NULL , V_37 ) ;
...
unsigned V_51 , unsigned V_47 ,
unsigned V_48 , T_3 V_10 , void * V_52 )
{
if ( ! F_3 ( V_4 ) || V_47 != 0 || V_48 != 1 )
return - V_19 ;
if ( V_10 & V_53 ) {
F_14 ( V_4 ) ;
} else if ( V_10 & V_54 ) {
...
unsigned V_48 , T_3 V_10 , void * V_52 )
{
if ( F_3 ( V_4 ) && ! V_48 && ( V_10 & V_53 ) ) {
F_30 ( V_4 ) ;
return 0 ;
}
if ( ! ( F_3 ( V_4 ) || F_18 ( V_4 ) ) || V_47 != 0 || V_48 != 1 )
return - V_19 ;
if ( V_10 & V_55 ) {
T_2 V_27 = * ( T_2 * ) V_52 ;
int V_15 ;
...
{
int V_38 ;
bool V_37 = ( V_51 == V_41 ) ? true : false ;
if ( F_49 ( V_4 , V_51 ) && ! V_48 && ( V_10 & V_53 ) ) {
F_43 ( V_4 , V_37 ) ;
return 0 ;
}
if ( ! ( F_49 ( V_4 , V_51 ) || F_18 ( V_4 ) ) )
return - V_19 ;
if ( V_10 & V_55 ) {
T_2 * V_49 = V_52 ;
int V_15 ;
if ( V_4 -> V_25 == V_51 )
return F_42 ( V_4 , V_47 , V_48 ,
V_49 , V_37 ) ;
V_15 = F_33 ( V_4 , V_47 + V_48 , V_37 ) ;
if ( V_15 )
return V_15 ;
V_15 = F_42 ( V_4 , V_47 , V_48 , V_49 , V_37 ) ;
if ( V_15 )
F_43 ( V_4 , V_37 ) ;
return V_15 ;
}
if ( ! F_49 ( V_4 , V_51 ) || V_47 + V_48 > V_4 -> V_24 )
return - V_19 ;
for ( V_38 = V_47 ; V_38 < V_47 + V_48 ; V_38 ++ ) {
if ( ! V_4 -> V_6 [ V_38 ] . V_7 )
continue;
if ( V_10 & V_53 ) {
...
static int F_50 ( struct V_30 * * V_6 ,
T_3 V_10 , void * V_52 )
{
T_2 V_27 = * ( T_2 * ) V_52 ;
if ( ! ( V_10 & V_58 ) )
...
if ( V_51 != V_60 )
return - V_19 ;
return F_50 ( & V_4 -> V_61 , V_10 , V_52 ) ;
}
static int F_52 ( struct V_3 * V_4 ,
unsigned V_51 , unsigned V_47 ,
unsigned V_48 , T_3 V_10 , void * V_52 )
{
if ( V_51 != V_62 || V_47 != 0 || V_48 != 1 )
return - V_19 ;
return F_50 ( & V_4 -> V_63 , V_10 , V_52 ) ;
}
int F_53 ( struct V_3 * V_4 , T_3 V_10 ,
unsigned V_51 , unsigned V_47 , unsigned V_48 ,
void * V_52 )
{
int (* F_54)( struct V_3 * V_4 , unsigned V_51 ,
unsigned V_47 , unsigned V_48 , T_3 V_10 ,
void * V_52 ) = NULL ;
switch ( V_51 ) {
case V_26 :
switch ( V_10 & V_64 ) {
...
if ( ! F_54 )
return - V_56 ;
return F_54 ( V_4 , V_51 , V_47 , V_48 , V_10 , V_52 ) ;
}
