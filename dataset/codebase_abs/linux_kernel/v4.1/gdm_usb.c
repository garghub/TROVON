...
static T_3 F_52 ( struct V_1 * V_2 , T_1 * V_91 )
{
struct V_27 * V_28 = & V_2 -> V_28 ;
struct V_23 * V_24 = NULL ;
...
return V_93 + F_53 ( struct V_92 , V_14 ) ;
}
...
V_106 -> V_102 = F_57 ( & V_2 -> V_11 , V_102 ) ;
V_106 -> V_113 = F_57 ( & V_2 -> V_11 , V_103 ) ;
V_106 -> V_105 = F_57 ( & V_2 -> V_11 , V_105 ) ;
...
static struct V_116 * F_59 ( void * V_67 )
{
struct V_1 * V_2 = V_67 ;
return & V_2 -> V_11 ;
}
static int F_60 ( struct V_117 * V_71 ,
...
V_120 = F_62 ( V_7 -> V_125 . V_120 ) ;
V_121 = F_62 ( V_7 -> V_125 . V_121 ) ;
F_63 ( L_14 , V_120 , V_121 ) ;
if ( V_122 > V_126 ) {
F_63 ( L_15 ) ;
return - V_88 ;
}
...
static void F_70 ( struct V_117 * V_71 )
{
struct V_66 * V_66 ;
struct V_1 * V_2 ;
T_2 V_120 , V_121 ;
...
static int F_74 ( struct V_117 * V_71 , T_4 V_140 )
{
struct V_66 * V_66 ;
struct V_1 * V_2 ;
struct V_37 * V_38 ;
...
static int F_75 ( struct V_117 * V_71 )
{
struct V_66 * V_66 ;
struct V_1 * V_2 ;
struct V_27 * V_28 ;
...
V_38 = & V_2 -> V_38 ;
if ( V_2 -> V_52 != V_99 ) {
F_43 ( V_71 -> V_132 , L_19 ) ;
return - 1 ;
}
V_2 -> V_52 = V_53 ;
F_23 ( & V_38 -> V_40 , V_39 ) ;
V_141 = V_38 -> V_33 - V_60 ;
F_24 ( & V_38 -> V_40 , V_39 ) ;
if ( V_141 >= 0 ) {
