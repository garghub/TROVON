...
V_40 [ 0 ] = F_22 ( V_47 ) ;
while ( V_5 > 0 ) {
int V_49 = F_23 ( int , V_5 , F_24 ( V_40 ) - 1 ) ;
int V_11 , V_9 ;
...
static void F_25 ( struct V_23 * V_29 , const T_3 * V_50 )
{
int V_5 ;
while ( ( V_5 = * V_50 ++ ) ) {
T_3 V_30 = * V_50 ++ ;
...
static void F_26 ( struct V_23 * V_29 , int V_51 , T_3 V_30 )
{
unsigned long V_10 = V_52 + F_27 ( V_51 ) ;
T_3 V_53 ;
F_19 ( V_29 , V_30 , 1 ) ;
do {
V_53 = F_18 ( V_29 , V_30 ) ;
...
static T_3 * F_30 ( struct V_23 * V_29 , T_3 V_55 )
{
...
{
T_3 * V_17 = F_30 ( V_29 , V_57 ) ;
if ( V_17 )
F_25 ( V_29 , V_17 ) ;
}
static void F_32 ( struct V_23 * V_29 )
{
...
F_34 ( V_29 , V_70 , V_58 & 0xffff , V_58 >> 16 ) ;
F_25 ( V_29 , V_61 ) ;
F_26 ( V_29 , 250 , V_71 ) ;
V_60 = F_18 ( V_29 , V_72 ) ;
if ( ! V_29 -> error && V_60 ) {
...
{
T_3 * V_17 = F_30 ( V_29 , V_73 ) ;
if ( V_17 )
F_25 ( V_29 , V_17 ) ;
}
static void F_36 ( struct V_23 * V_29 )
{
T_3 * V_17 = F_30 ( V_29 , V_74 ) ;
if ( ! V_17 )
return;
F_16 ( V_29 , V_75 , V_76 ) ;
F_25 ( V_29 , V_17 ) ;
...
static void F_38 ( struct V_23 * V_29 )
{
T_3 V_83 = V_29 -> V_24 . V_84 -> V_45 | ( V_29 -> V_24 . V_84 -> V_45 << 1 ) ;
F_19 ( V_29 , F_39 ( 0 ) , V_83 ) ;
if ( V_29 -> V_85 )
F_37 ( V_29 ) ;
}
static void F_40 ( struct V_23 * V_29 , T_3 V_86 , bool V_87 )
{
T_3 V_88 , V_89 ;
if ( ! V_29 -> V_90 )
V_88 = F_18 ( V_29 , V_91 ) ;
...
static void F_41 ( struct V_23 * V_29 , int V_93 )
{
...
static void F_42 ( struct V_23 * V_29 , int V_100 )
{
unsigned int time = V_100 / 10 ;
F_34 ( V_29 , V_101 ,
time & 0xffff , time >> 16 , 1 ) ;
}
static void F_43 ( struct V_23 * V_29 , int V_102 )
{
F_34 ( V_29 , V_103 , V_102 , 1 ) ;
}
static void F_44 ( struct V_23 * V_29 , int V_104 )
{
if ( V_104 == V_105 ) {
F_40 ( V_29 , V_106 | V_107 , true ) ;
} else {
unsigned int V_108 = V_29 -> V_24 . V_100 -> V_45 ;
F_42 ( V_29 , V_108 ) ;
F_43 ( V_29 , V_29 -> V_24 . V_102 -> V_45 ) ;
F_40 ( V_29 , V_106 | V_107 , false ) ;
}
}
static void F_45 ( struct V_23 * V_29 , int V_109 )
{
if ( V_109 == V_110 ) {
F_40 ( V_29 , V_111 , true ) ;
} else {
F_34 ( V_29 , V_112 , V_109 , 1 ) ;
F_40 ( V_29 , V_111 , false ) ;
}
}
static void F_46 ( struct V_23 * V_29 , int V_45 )
{
...
static int F_47 ( struct V_121 * V_122 )
{
int V_9 , V_32 = - 1 ;
for ( V_9 = 0 ; V_9 < F_24 ( V_123 ) ; V_9 ++ ) {
...
static int F_49 ( struct V_23 * V_29 )
{
T_3 V_126 ;
if ( V_29 -> V_127 == V_128 )
V_126 = V_129 ;
...
static T_3 F_50 ( struct V_23 * V_29 )
{
...
static void F_51 ( struct V_23 * V_29 , T_3 V_134 )
{
F_19 ( V_29 , F_52 ( 0 ) , V_134 ) ;
F_37 ( V_29 ) ;
}
static void F_53 ( struct V_23 * V_29 )
{
T_3 V_132 , V_134 ;
int V_49 ;
...
static void F_55 ( struct V_23 * V_29 )
{
T_3 V_132 ;
V_132 = F_50 ( V_29 ) ;
if ( V_29 -> error )
...
static void F_56 ( struct V_139 * V_34 , const struct V_139 * V_109 ,
...
static int F_57 ( struct V_23 * V_29 )
{
struct V_139 * V_144 , V_34 ;
T_3 V_132 ;
int V_11 ;
V_144 = & V_29 -> V_145 ;
F_34 ( V_29 , V_146 , V_144 -> V_141 , V_144 -> V_143 ,
V_144 -> V_140 , V_144 -> V_142 ) ;
F_56 ( & V_34 , & V_29 -> V_147 , & V_29 -> V_145 ,
& V_29 -> V_148 ) ;
F_34 ( V_29 , V_149 , V_34 . V_141 , V_34 . V_143 ,
...
return 0 ;
V_144 = & V_29 -> V_147 ;
F_34 ( V_29 , F_58 ( 0 ) , V_144 -> V_141 , V_144 -> V_143 ) ;
F_51 ( V_29 , V_29 -> V_151 ) ;
F_55 ( V_29 ) ;
return F_48 ( V_29 ) ;
}
static void F_59 ( struct V_23 * V_29 )
{
...
static void F_61 ( struct V_23 * V_29 , int V_56 )
{
struct V_164 * V_165 = & V_29 -> V_166 [ V_56 ] ;
F_62 ( V_165 -> V_165 , V_165 -> V_167 ) ;
}
static void F_63 ( struct V_23 * V_29 , int V_56 )
{
struct V_164 * V_165 = & V_29 -> V_166 [ V_56 ] ;
F_62 ( V_165 -> V_165 , ! V_165 -> V_167 ) ;
}
static int F_64 ( struct V_23 * V_29 )
{
int V_11 ;
V_11 = F_65 ( V_168 , V_29 -> V_169 ) ;
if ( V_11 < 0 )
goto V_132;
V_11 = F_66 ( V_29 -> clock , V_29 -> V_59 ) ;
if ( V_11 < 0 )
goto V_170;
V_11 = F_67 ( V_29 -> clock ) ;
if ( V_11 < 0 )
goto V_170;
...
return 0 ;
V_170:
F_69 ( V_168 , V_29 -> V_169 ) ;
V_132:
F_15 ( & V_29 -> V_25 , L_20 , V_173 , V_11 ) ;
return V_11 ;
}
static int F_70 ( struct V_23 * V_29 )
{
int V_11 ;
V_29 -> V_85 = 0 ;
V_29 -> V_138 = 0 ;
...
static void F_74 ( struct V_23 * V_29 )
{
V_29 -> V_153 = 0 ;
V_29 -> V_151 = 10000 / 15 ;
...
static int F_75 ( struct V_23 * V_29 )
{
struct V_31 * V_32 = F_10 ( & V_29 -> V_25 ) ;
const struct V_178 * V_4 ;
int V_11 ;
V_11 = F_76 ( & V_4 , V_179 , & V_32 -> V_2 ) ;
if ( V_11 < 0 ) {
F_77 ( & V_32 -> V_2 , L_22 ,
V_179 ) ;
return V_11 ;
...
static int F_79 ( struct V_19 * V_25 , int V_181 )
{
...
F_81 ( & V_29 -> V_182 ) ;
if ( ! V_11 && V_181 )
V_11 = F_82 ( & V_29 -> V_24 . V_22 ) ;
return V_11 ;
}
static void F_83 ( struct V_23 * V_29 , int V_87 )
{
F_34 ( V_29 , V_186 , V_87 , 1 ) ;
}
static int F_84 ( struct V_19 * V_25 , int V_181 )
{
struct V_23 * V_29 = F_8 ( V_25 ) ;
int V_11 ;
F_80 ( & V_29 -> V_182 ) ;
...
static int F_85 ( struct V_19 * V_25 ,
struct V_187 * V_188 )
{
struct V_23 * V_29 = F_8 ( V_25 ) ;
F_80 ( & V_29 -> V_182 ) ;
...
static void F_86 ( struct V_23 * V_29 ,
struct V_187 * V_188 )
{
...
static int F_89 ( struct V_19 * V_25 ,
struct V_194 * V_195 ,
struct V_196 * V_197 )
{
...
if ( V_125 -> V_198 >= F_24 ( V_123 ) )
return - V_13 ;
V_125 -> V_125 = V_123 [ V_125 -> V_198 ] . V_125 ;
return 0 ;
}
static int F_92 ( struct V_19 * V_25 ,
struct V_194 * V_195 ,
struct V_207 * V_208 )
{
int V_9 ;
...
static void F_93 ( struct V_121 * V_122 )
{
V_122 -> V_141 = V_202 ;
V_122 -> V_143 = V_204 ;
V_122 -> V_125 = V_206 ;
...
static int F_95 ( struct V_19 * V_25 , struct V_194 * V_195 ,
struct V_216 * V_217 )
{
struct V_23 * V_29 = F_8 ( V_25 ) ;
...
V_122 = F_96 ( V_25 , V_195 , V_217 -> V_199 ) ;
V_217 -> V_221 = * V_122 ;
return 0 ;
}
V_122 = & V_217 -> V_221 ;
...
static int F_97 ( struct V_19 * V_25 , struct V_194 * V_195 ,
struct V_216 * V_217 )
{
...
V_122 -> V_214 = V_215 ;
if ( V_217 -> V_219 == V_220 ) {
* F_96 ( V_25 , V_195 , V_217 -> V_199 ) = * V_122 ;
return 0 ;
}
if ( V_217 -> V_199 == V_200 ) {
F_93 ( V_122 ) ;
...
static enum V_223 F_98 ( V_193 V_199 , V_193 V_224 )
{
switch ( V_224 ) {
case V_225 :
...
static int F_99 ( V_193 V_224 )
{
return V_224 == V_225 ||
V_224 == V_231 ;
}
static int F_100 ( struct V_19 * V_25 ,
struct V_194 * V_195 ,
struct V_234 * V_235 )
{
static enum V_223 V_236 ;
struct V_23 * V_29 = F_8 ( V_25 ) ;
V_236 = F_98 ( V_235 -> V_199 , V_235 -> V_224 ) ;
switch ( V_236 ) {
case V_232 :
return - V_13 ;
case V_227 :
...
V_235 -> V_34 = * F_102 ( V_25 , V_195 , V_235 -> V_199 ) ;
return 0 ;
}
F_80 ( & V_29 -> V_182 ) ;
switch ( V_236 ) {
...
static void F_103 ( V_193 * V_238 , V_193 * V_39 , V_193 V_239 )
{
if ( * V_39 > V_239 )
* V_39 = V_239 ;
if ( * V_238 + * V_39 > V_239 )
...
static void F_104 ( struct V_139 * V_34 , V_193 V_141 , V_193 V_143 )
{
F_103 ( & V_34 -> V_140 , & V_34 -> V_141 , V_141 ) ;
F_103 ( & V_34 -> V_142 , & V_34 -> V_143 , V_143 ) ;
}
static void F_105 ( struct V_139 * * V_240 ,
enum V_223 V_241 ,
struct V_139 * V_109 )
{
...
V_34 = V_240 [ V_9 ] ;
V_242 = V_240 [ V_9 - 1 ] ;
F_104 ( V_34 , V_242 -> V_141 , V_242 -> V_143 ) ;
} while ( ++ V_9 != V_232 );
* V_109 = * V_240 [ V_241 ] ;
}
static bool F_106 ( const struct V_139 * V_243 ,
const struct V_139 * V_244 )
{
return ! memcmp ( V_243 , V_244 , sizeof( * V_243 ) ) ;
}
static int F_107 ( struct V_19 * V_25 ,
struct V_194 * V_195 ,
struct V_234 * V_235 )
{
static enum V_223 V_236 ;
...
int V_11 = 0 ;
V_236 = F_98 ( V_235 -> V_199 , V_235 -> V_224 ) ;
if ( V_236 == V_232 || F_99 ( V_235 -> V_224 ) )
return - V_13 ;
if ( V_236 == V_226 ) {
V_235 -> V_34 . V_140 = 0 ;
V_235 -> V_34 . V_142 = 0 ;
...
V_240 = (struct V_139 * [] ) {
& V_237 ,
F_102 ( V_25 , V_195 , V_200 ) ,
F_101 ( V_25 , V_195 , V_200 ) ,
F_102 (sd, cfg, PAD_OUT)
} ;
F_105 ( V_240 , V_236 , & V_235 -> V_34 ) ;
return 0 ;
}
V_240 = (struct V_139 * [] ) {
& V_237 ,
...
F_105 ( V_240 , V_236 , & V_235 -> V_34 ) ;
if ( ! F_106 ( & V_29 -> V_145 , & V_237 ) ||
! F_106 ( & V_29 -> V_148 , & V_237 ) )
V_29 -> V_79 = 1 ;
if ( V_29 -> V_85 )
V_11 = F_57 ( V_29 ) ;
F_81 ( & V_29 -> V_182 ) ;
...
V_24 -> V_93 = F_112 ( V_266 , V_263 , V_247 ,
0 , 1 , 1 , 1 ) ;
V_24 -> V_96 = F_112 ( V_266 , V_263 , V_267 ,
0 , 255 , 1 , V_268 ) ;
V_24 -> V_98 = F_112 ( V_266 , V_263 , V_269 ,
0 , 255 , 1 , V_270 ) ;
F_113 ( 3 , & V_24 -> V_93 , 0 , false ) ;
V_24 -> V_271 = F_112 ( V_266 , V_263 , V_254 , 0 , 1 , 1 , 0 ) ;
V_24 -> V_84 = F_112 ( V_266 , V_263 , V_272 , 0 , 1 , 1 , 0 ) ;
F_114 ( 2 , & V_24 -> V_271 ) ;
V_24 -> V_273 = F_115 ( V_266 , V_263 ,
V_253 ,
V_274 , 0 , V_105 ) ;
V_24 -> V_100 = F_112 ( V_266 , V_263 , V_275 ,
0 , 6000000U , 1 , 100000U ) ;
V_24 -> V_102 = F_112 ( V_266 , V_263 , V_276 ,
0 , 256 , 1 , 256 ) ;
F_113 ( 3 , & V_24 -> V_273 , 0 , false ) ;
F_115 ( V_266 , V_263 , V_255 ,
V_110 , 0 ,
V_110 ) ;
F_115 ( V_266 , V_263 , V_250 ,
V_118 , ~ 0x6f , V_114 ) ;
F_112 ( V_266 , V_263 , V_260 ,
0 , 256 , 1 , 0 ) ;
F_112 ( V_266 , V_263 , V_256 , - 127 , 127 , 1 , 0 ) ;
F_112 ( V_266 , V_263 , V_248 , - 127 , 127 , 1 , 0 ) ;
F_112 ( V_266 , V_263 , V_251 , - 127 , 127 , 1 , 0 ) ;
F_112 ( V_266 , V_263 , V_258 , - 127 , 127 , 1 , 0 ) ;
F_116 ( V_266 , V_263 , V_261 ,
F_24 ( V_277 ) - 1 ,
0 , 0 , V_277 ) ;
if ( V_266 -> error ) {
F_15 ( & V_29 -> V_25 , L_26 ,
...
static int F_118 ( struct V_19 * V_25 , struct V_279 * V_280 )
{
struct V_121 * V_122 ;
V_122 = F_96 ( V_25 , V_280 -> V_199 , V_200 ) ;
F_93 ( V_122 ) ;
if ( F_7 ( V_25 ) )
return 0 ;
V_122 = F_96 ( V_25 , V_280 -> V_199 , V_281 ) ;
V_122 -> V_124 = V_123 [ 0 ] . V_124 ;
V_122 -> V_125 = V_123 [ 0 ] . V_125 ;
V_122 -> V_141 = V_237 . V_141 ;
V_122 -> V_143 = V_237 . V_143 ;
V_122 -> V_214 = V_215 ;
* F_102 ( V_25 , V_280 -> V_199 , V_200 ) = V_237 ;
* F_101 ( V_25 , V_280 -> V_199 , V_200 ) = V_237 ;
* F_102 ( V_25 , V_280 -> V_199 , V_281 ) = V_237 ;
return 0 ;
}
static int F_119 ( struct V_23 * V_29 )
{
...
static int F_120 ( struct V_19 * V_25 )
{
struct V_23 * V_29 = F_8 ( V_25 ) ;
int V_11 ;
V_11 = F_121 ( V_25 -> V_290 , & V_29 -> V_28 ) ;
if ( V_11 < 0 )
F_15 ( V_25 , L_29 ,
V_29 -> V_28 . V_245 ) ;
else
V_11 = F_122 ( & V_29 -> V_28 . V_26 , V_200 ,
& V_29 -> V_25 . V_26 , V_200 ,
V_291 |
V_292 ) ;
return V_11 ;
}
static void F_123 ( struct V_19 * V_25 )
{
struct V_23 * V_29 = F_8 ( V_25 ) ;
F_124 ( & V_29 -> V_28 ) ;
}
static int F_125 ( struct V_23 * V_29 )
{
...
if ( V_293 [ V_9 ] . V_167 )
V_38 |= V_296 ;
V_11 = F_126 ( & V_32 -> V_2 , V_293 [ V_9 ] . V_165 , V_38 , V_245 [ V_9 ] ) ;
if ( V_11 < 0 ) {
...
static int F_127 ( struct V_164 * V_166 , struct V_1 * V_2 )
{
...
int V_11 , V_9 ;
for ( V_9 = 0 ; V_9 < V_294 ; ++ V_9 ) {
V_11 = F_128 ( V_299 , V_297 [ V_9 ] , 0 , & V_38 ) ;
if ( V_11 < 0 ) {
...
static int F_129 ( struct V_23 * V_29 , struct V_1 * V_2 )
{
struct V_298 * V_299 = V_2 -> V_300 ;
struct V_298 * V_303 ;
struct V_304 V_305 ;
...
V_11 = F_127 ( V_29 -> V_166 , V_2 ) ;
if ( V_11 < 0 )
return V_11 ;
V_303 = F_132 ( V_299 , NULL ) ;
if ( ! V_303 ) {
F_2 ( V_2 , L_39 ,
V_299 -> V_307 ) ;
return - V_13 ;
...
static int F_135 ( struct V_23 * V_29 ,
struct V_31 * V_32 )
{
struct V_19 * V_25 ;
int V_11 ;
...
F_138 ( V_32 -> V_43 ) , V_32 -> V_30 ) ;
V_25 -> V_315 = & V_316 ;
V_25 -> V_38 |= V_317 ;
V_29 -> V_318 . V_38 = V_319 ;
V_25 -> V_26 . type = V_27 ;
V_11 = F_139 ( & V_25 -> V_26 , V_320 , & V_29 -> V_318 , 0 ) ;
if ( V_11 < 0 )
goto V_132;
V_25 = & V_29 -> V_25 ;
F_140 ( V_25 , V_32 , & V_321 ) ;
...
V_11 = F_139 ( & V_25 -> V_26 , V_326 , V_29 -> V_323 , 0 ) ;
if ( ! V_11 )
return 0 ;
F_141 ( & V_29 -> V_28 . V_26 ) ;
V_132:
F_2 ( & V_32 -> V_2 , L_43 , V_25 -> V_245 ) ;
return V_11 ;
}
static int F_142 ( struct V_23 * V_29 )
{
struct V_31 * V_32 = F_10 ( & V_29 -> V_25 ) ;
int V_11 ;
int V_9 ;
...
V_29 -> V_148 = V_237 ;
V_29 -> V_147 = V_237 ;
V_11 = F_129 ( V_29 , & V_32 -> V_2 ) ;
if ( V_11 < 0 )
return V_11 ;
V_11 = F_135 ( V_29 , V_32 ) ;
if ( V_11 < 0 )
return V_11 ;
V_11 = F_125 ( V_29 ) ;
if ( V_11 < 0 )
...
if ( V_11 < 0 )
goto V_330;
V_29 -> clock = F_146 ( V_29 -> V_25 . V_2 , V_331 ) ;
if ( F_71 ( V_29 -> clock ) ) {
V_11 = - V_332 ;
goto V_330;
}
...
if ( V_11 < 0 )
goto V_330;
V_11 = F_147 ( & V_29 -> V_25 ) ;
if ( V_11 < 0 )
goto V_333;
return 0 ;
V_333:
F_117 ( V_29 -> V_25 . V_278 ) ;
V_330:
F_141 ( & V_29 -> V_25 . V_26 ) ;
F_141 ( & V_29 -> V_28 . V_26 ) ;
return V_11 ;
}
static int F_148 ( struct V_31 * V_32 )
{
struct V_19 * V_25 = F_149 ( V_32 ) ;
struct V_23 * V_29 = F_8 ( V_25 ) ;
F_150 ( V_25 ) ;
F_117 ( V_25 -> V_278 ) ;
F_141 ( & V_25 -> V_26 ) ;
