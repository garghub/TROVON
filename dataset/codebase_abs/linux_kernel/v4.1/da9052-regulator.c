...
{
const struct V_53 * V_54 = F_16 ( V_52 ) ;
struct V_55 V_56 = { } ;
struct V_8 * V_9 ;
struct V_13 * V_13 ;
struct V_57 * V_58 ;
V_9 = F_17 ( & V_52 -> V_59 , sizeof( struct V_8 ) ,
V_60 ) ;
if ( ! V_9 )
return - V_61 ;
V_13 = F_18 ( V_52 -> V_59 . V_62 ) ;
V_58 = F_19 ( V_13 -> V_59 ) ;
V_9 -> V_13 = V_13 ;
...
V_56 . V_64 = V_13 -> V_64 ;
if ( V_58 && V_58 -> V_65 ) {
V_56 . V_66 = V_58 -> V_65 [ V_54 -> V_26 ] ;
} else {
#ifdef F_21
struct V_67 * V_68 = V_13 -> V_59 -> V_69 ;
struct V_67 * V_70 ;
if ( ! V_68 )
return - V_71 ;
V_68 = F_22 ( V_68 , L_2 ) ;
