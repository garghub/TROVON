...
int V_24 = - 1 ;
for (; ; ) {
V_15 = F_13 ( V_20 -> V_22 , V_10 -> V_25 , V_15 + 1 ) ;
if ( V_15 == V_10 -> V_25 )
break;
F_4 ( L_3 ,
V_15 , F_14 ( V_10 -> V_26 [ V_15 ] . V_27 ) , V_24 ) ;
if ( F_14 ( V_10 -> V_26 [ V_15 ] . V_27 ) > V_24 ) {
V_23 = V_15 ;
V_24 = F_14 ( V_10 -> V_26 [ V_15 ] . V_27 ) ;
}
}
V_20 -> V_23 = V_23 ;
V_20 -> V_24 = V_24 ;
...
static void F_16 ( struct V_9 * V_10 , int V_28 , int V_21 ,
bool V_29 , bool V_30 )
{
struct V_11 * V_12 ;
struct V_31 * V_26 ;
...
static void F_17 ( struct V_9 * V_10 , int V_21 )
{
struct V_31 * V_26 ;
bool V_29 , V_30 ;
int V_36 ;
...
F_16 ( V_10 , V_26 -> V_42 , V_21 , V_29 , V_30 ) ;
} else if ( ! ( V_26 -> V_27 & V_43 ) ) {
for ( V_36 = 0 ; V_36 < V_10 -> V_44 ; V_36 ++ ) {
if ( V_26 -> V_41 & ( 1 << V_36 ) ) {
F_16 ( V_10 , V_36 , V_21 , V_29 ,
V_30 ) ;
}
}
} else {
...
static void F_18 ( void * V_45 , int V_21 , int V_46 )
{
struct V_9 * V_10 = V_45 ;
struct V_31 * V_26 ;
if ( V_21 >= V_47 ) {
F_19 ( 1 , L_16 , V_17 , V_21 ) ;
return;
}
V_26 = & V_10 -> V_26 [ V_21 ] ;
F_4 ( L_17 ,
...
static inline T_1 F_22 ( struct V_9 * V_10 , int V_21 )
{
...
static inline void F_21 ( struct V_9 * V_10 , int V_21 ,
T_1 V_76 )
{
...
static inline void F_25 ( struct V_9 * V_10 , int V_21 ,
T_1 V_76 )
{
if ( V_10 -> V_74 & V_75 ) {
struct V_31 * V_26 = & V_10 -> V_26 [ V_21 ] ;
...
static void F_27 ( struct V_9 * V_10 , T_2 V_76 )
{
if ( V_76 & V_49 ) {
F_20 ( V_10 ) ;
return;
...
static int F_28 ( void * V_45 , T_3 V_90 , T_4 V_76 )
{
struct V_9 * V_10 = V_45 ;
int V_91 = 0 ;
...
static int F_30 ( void * V_45 , T_3 V_90 , T_4 * V_95 )
{
struct V_9 * V_10 = V_45 ;
T_4 V_96 ;
int V_91 = 0 ;
...
static int F_32 ( void * V_45 , T_3 V_90 , T_4 V_76 )
{
struct V_9 * V_10 = V_45 ;
int V_93 ;
V_90 += 0x10f0 ;
...
break;
case 0x30 :
F_21 ( V_10 , V_10 -> V_102 + V_93 , V_76 ) ;
break;
}
return 0 ;
}
static int F_33 ( void * V_45 , T_3 V_90 , T_4 * V_95 )
{
struct V_9 * V_10 = V_45 ;
T_1 V_96 = - 1 ;
int V_93 ;
...
break;
case 0x30 :
V_96 = F_22 ( V_10 , V_10 -> V_102 + V_93 ) ;
break;
}
V_97:
F_4 ( L_24 , V_17 , V_96 ) ;
...
static int F_38 ( void * V_45 , T_3 V_90 , T_4 * V_95 )
{
T_1 V_112 = 0 ;
F_4 ( L_23 , V_17 , V_90 ) ;
* V_95 = V_112 ;
...
static int F_39 ( void * V_45 , T_3 V_90 , T_4 V_76 )
{
F_4 ( L_25 , V_17 , V_90 , V_76 ) ;
return 0 ;
}
static int F_29 ( void * V_45 , T_3 V_90 ,
T_4 V_76 , int V_93 )
{
struct V_9 * V_10 = V_45 ;
struct V_31 * V_26 ;
...
F_18 ( V_10 , V_10 -> V_94 + V_93 , 1 ) ;
F_18 ( V_10 , V_10 -> V_94 + V_93 , 0 ) ;
break;
case 0x80 :
...
V_115 = V_114 ;
V_114 = F_15 ( V_10 , & V_12 -> V_35 ) ;
V_21 = F_15 ( V_10 , & V_12 -> V_33 ) ;
V_26 = & V_10 -> V_26 [ V_21 ] ;
if ( V_21 != - 1 &&
( V_114 == - 1 ||
F_14 ( V_26 -> V_27 ) > V_12 -> V_35 . V_24 ) ) {
F_4 ( L_32 ,
V_93 , V_21 ) ;
F_3 ( V_10 , V_12 , V_18 ) ;
}
F_40 ( & V_10 -> V_116 ) ;
F_41 ( V_10 -> V_117 , 0 , V_115 ) ;
F_42 ( & V_10 -> V_116 ) ;
break;
}
default:
...
static int F_43 ( void * V_45 , T_3 V_90 , T_4 V_76 )
{
struct V_9 * V_10 = V_45 ;
return F_29 ( V_10 , V_90 , V_76 ,
( V_90 & 0x1f000 ) >> 12 ) ;
}
static T_1 F_44 ( struct V_9 * V_10 , struct V_11 * V_12 ,
int V_118 )
{
struct V_31 * V_26 ;
int V_96 , V_15 ;
F_4 ( L_33 ) ;
F_6 ( V_10 , V_12 , V_18 ) ;
V_15 = F_15 ( V_10 , & V_12 -> V_33 ) ;
F_4 ( L_34 , V_15 ) ;
if ( V_15 == - 1 )
return V_10 -> V_56 ;
V_26 = & V_10 -> V_26 [ V_15 ] ;
if ( ! ( V_26 -> V_27 & V_40 ) ||
! ( F_14 ( V_26 -> V_27 ) > V_12 -> V_34 ) ) {
F_45 ( L_35 ,
...
unsigned long V_74 ;
F_48 ( & V_10 -> V_116 , V_74 ) ;
if ( ( V_10 -> V_48 & V_10 -> V_89 ) == V_121 )
F_49 ( V_4 , F_44 ( V_10 , & V_10 -> V_12 [ V_118 ] , V_118 ) ) ;
...
static int F_51 ( void * V_45 , T_3 V_90 , T_4 * V_95 )
{
struct V_9 * V_10 = V_45 ;
return F_31 ( V_10 , V_90 , V_95 ,
( V_90 & 0x1f000 ) >> 12 ) ;
}
static void F_52 ( struct V_9 * V_10 , const struct V_122 * V_123 )
{
if ( V_10 -> V_124 >= V_125 ) {
F_53 ( 1 , L_37 ) ;
return;
...
static int F_56 ( struct V_9 * V_10 , T_3 V_90 , T_4 * V_95 )
{
int V_36 ;
...
static int F_57 ( struct V_9 * V_10 , T_3 V_90 , T_4 V_76 )
{
int V_36 ;
for ( V_36 = 0 ; V_36 < V_10 -> V_124 ; V_36 ++ ) {
const struct V_122 * V_123 = V_10 -> V_126 [ V_36 ] ;
...
struct V_139 * V_140 ,
T_3 V_90 , int V_141 , void * V_95 )
{
struct V_9 * V_10 = F_59 ( V_140 , struct V_9 , V_142 ) ;
int V_143 ;
union {
T_4 V_76 ;
T_5 V_144 [ 4 ] ;
...
F_60 ( & V_10 -> V_116 ) ;
V_143 = F_56 ( V_10 , V_90 - V_10 -> V_147 , & V_145 . V_76 ) ;
F_61 ( & V_10 -> V_116 ) ;
if ( V_141 == 4 ) {
* ( T_4 * ) V_95 = V_145 . V_76 ;
F_4 ( L_39 ,
...
struct V_139 * V_140 ,
T_3 V_90 , int V_141 , const void * V_95 )
{
struct V_9 * V_10 = F_59 ( V_140 , struct V_9 , V_142 ) ;
int V_143 ;
if ( V_141 != 4 ) {
...
F_60 ( & V_10 -> V_116 ) ;
V_143 = F_57 ( V_10 , V_90 - V_10 -> V_147 ,
* ( const T_4 * ) V_95 ) ;
F_61 ( & V_10 -> V_116 ) ;
F_4 ( L_42 ,
...
{
F_64 ( & V_10 -> V_142 , & V_149 ) ;
F_65 ( V_10 -> V_117 , V_150 ,
V_10 -> V_147 , V_151 ,
& V_10 -> V_142 ) ;
}
static void F_66 ( struct V_9 * V_10 )
{
F_67 ( V_10 -> V_117 , V_150 , & V_10 -> V_142 ) ;
}
static int F_68 ( struct V_9 * V_10 , struct V_152 * V_153 )
{
T_6 V_154 ;
if ( F_69 ( & V_154 , ( T_6 V_155 * ) ( long ) V_153 -> V_90 , sizeof( T_6 ) ) )
return - V_156 ;
if ( V_154 & 0x3ffff ) {
F_4 ( L_43 ,
V_17 , V_154 ) ;
...
F_63 ( V_10 ) ;
V_97:
F_71 ( & V_10 -> V_117 -> V_157 ) ;
return 0 ;
}
static int F_72 ( struct V_9 * V_10 , T_3 V_90 , T_4 * V_76 , int type )
{
int V_143 ;
if ( V_90 & 3 )
return - V_92 ;
F_60 ( & V_10 -> V_116 ) ;
if ( type == V_158 )
V_143 = F_57 ( V_10 , V_90 , * V_76 ) ;
else
V_143 = F_56 ( V_10 , V_90 , V_76 ) ;
F_61 ( & V_10 -> V_116 ) ;
F_4 ( L_45 , V_17 , type , V_90 , * V_76 ) ;
return V_143 ;
}
static int F_73 ( struct V_159 * V_160 , struct V_152 * V_153 )
{
...
switch ( V_153 -> V_153 ) {
case V_165 :
return F_68 ( V_10 , V_153 ) ;
}
break;
case V_166 :
if ( F_74 ( V_162 , ( T_4 V_155 * ) ( long ) V_153 -> V_90 ) )
return - V_156 ;
return F_72 ( V_10 , V_153 -> V_153 , & V_162 , V_158 ) ;
case V_167 :
...
V_168 = V_10 -> V_147 ;
F_71 ( & V_10 -> V_117 -> V_157 ) ;
if ( F_76 ( ( T_6 V_155 * ) ( long ) V_153 -> V_90 ,
& V_168 , sizeof( T_6 ) ) )
return - V_156 ;
return 0 ;
}
break;
case V_166 :
V_143 = F_72 ( V_10 , V_153 -> V_153 , & V_162 , V_169 ) ;
if ( V_143 )
return V_143 ;
if ( F_77 ( V_162 , ( T_4 V_155 * ) ( long ) V_153 -> V_90 ) )
return - V_156 ;
return 0 ;
case V_167 :
if ( V_153 -> V_153 > V_128 )
...
static int F_78 ( struct V_159 * V_160 , struct V_152 * V_153 )
{
switch ( V_153 -> V_163 ) {
case V_164 :
switch ( V_153 -> V_153 ) {
...
{
struct V_170 * V_171 ;
V_171 = F_82 ( ( sizeof( * V_171 ) ) , V_172 ) ;
if ( ! V_171 )
return - V_173 ;
F_83 ( V_10 -> V_117 , V_171 , 0 , 0 ) ;
F_80 ( V_171 ) ;
return 0 ;
}
static int F_84 ( struct V_159 * V_160 , T_4 type )
{
struct V_9 * V_10 ;
int V_143 ;
if ( V_160 -> V_117 -> V_7 . V_120 )
return - V_146 ;
V_10 = F_82 ( sizeof( struct V_9 ) , V_172 ) ;
if ( ! V_10 )
return - V_173 ;
V_160 -> V_161 = V_10 ;
...
int F_87 ( struct V_159 * V_160 , struct V_3 * V_4 ,
T_4 V_118 )
{
struct V_9 * V_10 = V_160 -> V_161 ;
int V_143 = 0 ;
...
V_10 -> V_44 = F_88 ( V_10 -> V_44 , V_118 + 1 ) ;
V_4 -> V_7 . V_120 = V_10 ;
V_4 -> V_7 . V_8 = V_118 ;
V_4 -> V_7 . V_189 = V_191 ;
if ( V_10 -> V_89 == V_121 )
...
void F_89 ( struct V_9 * V_10 , struct V_3 * V_4 )
{
F_55 ( ! V_10 -> V_12 [ V_4 -> V_7 . V_8 ] . V_4 ) ;
...
int F_91 ( struct V_194 * V_195 ,
struct V_117 * V_117 , int V_196 , int V_46 , bool V_197 )
{
struct V_9 * V_10 = V_117 -> V_7 . V_120 ;
unsigned long V_74 ;
F_48 ( & V_10 -> V_116 , V_74 ) ;
F_36 ( V_117 -> V_7 . V_120 , V_106 , V_195 -> V_110 . V_200 ) ;
F_50 ( & V_10 -> V_116 , V_74 ) ;
return 0 ;
}
int F_92 ( struct V_194 * V_195 ,
