...
F_64 ( & V_67 ) ;
F_46 ( & V_73 , & V_74 ) ;
while ( V_73 . V_61 != & V_74 ) {
struct V_1 * V_3 ;
struct V_75 V_75 ;
struct V_69 * V_76 ;
struct V_26 * V_26 ;
int V_77 ;
V_3 = F_16 ( V_73 . V_61 , struct V_1 , V_9 ) ;
F_5 ( V_3 ) ;
F_59 ( & V_73 ) ;
F_46 ( & V_73 , & V_3 -> V_9 ) ;
F_65 ( & V_67 ) ;
V_77 = F_72 ( V_3 -> V_12 , 0 , & V_75 ) ;
if ( V_77 )
goto V_78;
V_76 = F_73 ( & V_75 ) ;
F_74 ( & V_75 ) ;
...
int F_78 ( struct V_54 * V_55 , char * V_12 , T_2 V_79 )
{
if ( V_12 [ 0 ] != '/' ||
V_55 -> V_60 != V_80 ||
V_79 != V_81 ||
V_55 -> V_82 || V_55 -> V_83 || V_55 -> V_3 )
return - V_84 ;
V_55 -> V_3 = F_1 ( V_12 ) ;
if ( ! V_55 -> V_3 )
return - V_48 ;
...
static int F_80 ( struct V_69 * V_70 , void * V_71 )
{
return F_47 ( F_70 ( V_70 -> V_72 ) , V_71 ) ;
}
static int F_81 ( void * V_85 )
{
for (; ; ) {
F_82 ( V_86 ) ;
if ( F_61 ( & V_68 ) )
...
int F_91 ( char * V_52 , char * V_39 )
{
struct V_32 V_73 , V_92 ;
int V_93 = 0 ;
struct V_75 V_94 , V_95 ;
struct V_69 * V_96 ;
int V_77 ;
V_77 = F_72 ( V_39 , 0 , & V_95 ) ;
if ( V_77 )
return V_77 ;
V_96 = F_73 ( & V_95 ) ;
F_74 ( & V_95 ) ;
