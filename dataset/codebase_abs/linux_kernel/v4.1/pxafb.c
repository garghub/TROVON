...
V_2 -> V_51 = F_141 ( ( V_90 -> V_320 >> 10 ) & 0xff ) ;
...
static int F_149 ( struct V_199 * V_91 , const char * V_351 )
{
struct V_58 * V_90 = F_28 ( V_91 ) ;
...
V_353 = V_65 ;
if ( ! V_355 && ! V_356 ) {
V_48 = F_150 ( & V_352 [ V_65 + 1 ] , NULL , 0 ) ;
V_355 = 1 ;
} else
goto V_357;
break;
case 'x' :
if ( ! V_356 ) {
V_68 = F_150 ( & V_352 [ V_65 + 1 ] , NULL , 0 ) ;
V_356 = 1 ;
} else
goto V_357;
break;
...
static int F_152 ( struct V_199 * V_91 , char * V_351 )
{
struct V_58 * V_90 = F_28 ( V_91 ) ;
struct V_57 * V_60 = & V_90 -> V_62 [ 0 ] ;
char V_358 [ 64 ] ;
...
if ( V_358 [ 0 ] != '\0' )
F_151 ( V_91 , L_70 , V_358 ) ;
return 0 ;
}
static int F_154 ( struct V_199 * V_91 , char * V_371 )
{
char * V_351 ;
int V_37 ;
if ( ! V_371 || ! * V_371 )
return 0 ;
F_155 ( V_91 , L_71 , V_371 ? V_371 : L_72 ) ;
while ( ( V_351 = F_156 ( & V_371 , L_73 ) ) != NULL ) {
V_37 = F_152 ( V_91 , V_351 ) ;
if ( V_37 )
return V_37 ;
}
return 0 ;
...
return - V_159 ;
if ( V_371 )
F_159 ( V_372 , V_371 , sizeof( V_372 ) ) ;
return 0 ;
}
...
static int F_162 ( struct V_375 * V_91 )
{
struct V_1 * V_2 ;
struct V_58 * V_90 ;
struct V_376 * V_377 ;
...
V_377 = F_163 ( V_91 , V_383 , 0 ) ;
if ( V_377 == NULL ) {
F_80 ( & V_91 -> V_91 , L_88 ) ;
V_37 = - V_159 ;
goto V_384;
}
V_377 = F_164 ( V_377 -> V_120 , F_165 ( V_377 ) , V_91 -> V_352 ) ;
if ( V_377 == NULL ) {
F_80 ( & V_91 -> V_91 , L_89 ) ;
V_37 = - V_385 ;
goto V_384;
}
V_2 -> V_4 = F_166 ( V_377 -> V_120 , F_165 ( V_377 ) ) ;
if ( V_2 -> V_4 == NULL ) {
F_80 ( & V_91 -> V_91 , L_90 ) ;
V_37 = - V_385 ;
goto V_386;
...
V_2 -> V_96 = F_167 ( V_2 -> V_91 , V_2 -> V_387 ,
& V_2 -> V_210 , V_187 ) ;
if ( V_2 -> V_96 == NULL ) {
F_80 ( & V_91 -> V_91 , L_91 ) ;
V_37 = - V_189 ;
...
F_78 ( V_2 ) ;
#ifdef F_29
V_2 -> V_312 . V_393 = F_134 ;
V_2 -> V_315 . V_393 = F_136 ;
F_171 ( & V_2 -> V_312 ,
V_394 ) ;
F_171 ( & V_2 -> V_315 ,
V_395 ) ;
...
V_389:
F_173 ( & V_91 -> V_91 , V_2 -> V_387 ,
V_2 -> V_96 , V_2 -> V_210 ) ;
V_388:
F_174 ( V_2 -> V_4 ) ;
V_386:
F_175 ( V_377 -> V_120 , F_165 ( V_377 ) ) ;
V_384:
F_176 ( V_2 -> V_196 ) ;
F_145 ( V_2 ) ;
V_378:
...
static int F_177 ( struct V_375 * V_91 )
{
