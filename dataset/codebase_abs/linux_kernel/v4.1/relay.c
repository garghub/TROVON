...
V_58 = F_50 ( V_6 , V_6 -> V_4 [ V_38 ] , V_38 ) ;
if ( F_16 ( ! V_58 ) ) {
V_105 = - V_30 ;
break;
}
...
V_143 = V_132 ;
if ( F_90 ( V_141 -> V_144 . V_4 , V_142 , V_132 ) ) {
V_141 -> error = - V_145 ;
V_143 = 0 ;
}
...
static T_6 F_91 ( struct V_26 * V_27 , T_7 * V_147 ,
T_8 V_148 ,
T_5 * V_141 )
{
struct V_3 * V_4 = V_27 -> V_96 ;
...
if ( ! V_141 -> V_138 )
return 0 ;
F_45 ( & F_92 ( V_27 ) -> V_149 ) ;
do {
if ( ! F_85 ( V_4 , * V_147 ) )
break;
V_140 = F_87 ( * V_147 , V_4 ) ;
...
break;
if ( V_143 ) {
F_84 ( V_4 , V_140 , V_143 ) ;
* V_147 = F_88 ( V_4 , V_140 , V_143 ) ;
}
} while ( V_141 -> V_138 && V_143 );
F_47 ( & F_92 ( V_27 ) -> V_149 ) ;
return V_141 -> V_146 ;
}
static T_6 F_94 ( struct V_26 * V_27 ,
char T_9 * V_150 ,
T_2 V_138 ,
T_7 * V_147 )
{
...
V_141 . error = 0 ;
return F_91 ( V_27 , V_147 , F_89 , & V_141 ) ;
}
static void F_95 ( struct V_3 * V_151 , int V_67 )
{
V_151 -> V_67 += V_67 ;
if ( V_151 -> V_67 >= V_151 -> V_6 -> V_95 ) {
F_74 ( V_151 -> V_6 , V_151 -> V_51 , 1 ) ;
V_151 -> V_67 %= V_151 -> V_6 -> V_95 ;
}
}
static void F_96 ( struct V_152 * V_153 ,
struct V_154 * V_4 )
{
struct V_3 * V_151 ;
V_151 = (struct V_3 * ) F_97 ( V_4 -> V_12 ) ;
F_95 ( V_151 , V_4 -> V_155 ) ;
}
static void F_98 ( struct V_156 * V_157 , unsigned int V_38 )
{
}
static T_6 F_99 ( struct V_26 * V_158 ,
T_7 * V_147 ,
struct V_152 * V_153 ,
T_2 V_159 ,
unsigned int V_107 ,
...
T_2 V_140 = ( T_2 ) F_100 ( V_166 , V_29 ) ;
...
static T_6 F_105 ( struct V_26 * V_158 ,
T_7 * V_147 ,
struct V_152 * V_153 ,
T_2 V_159 ,
unsigned int V_107 )
...
V_181 = 0 ;
while ( V_159 && ! V_181 ) {
V_143 = F_99 ( V_158 , V_147 , V_153 , V_159 , V_107 , & V_160 ) ;
if ( V_143 < 0 )
break;
else if ( ! V_143 ) {
if ( V_107 & V_182 )
