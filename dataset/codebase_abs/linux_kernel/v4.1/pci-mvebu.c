...
static struct V_34 * F_44 ( int V_10 , struct V_111 * V_112 )
{
struct V_110 * V_52 = F_33 ( V_112 ) ;
struct V_34 * V_35 ;
V_35 = F_45 ( & V_52 -> V_53 -> V_54 , V_112 -> V_127 ,
& V_128 , V_112 , & V_112 -> V_123 ) ;
if ( ! V_35 )
return NULL ;
F_46 ( V_35 ) ;
return V_35 ;
}
static T_4 F_47 ( struct V_129 * V_54 ,
...
return F_48 ( V_65 , F_49 ( T_4 , V_135 ,
F_50 ( V_16 ) ) ) ;
else if ( V_131 -> V_133 & V_136 )
return F_48 ( V_65 , F_49 ( T_4 , V_137 ,
F_50 ( V_16 ) ) ) ;
else
return V_65 ;
}
static void F_51 ( struct V_110 * V_52 )
{
struct V_138 V_139 ;
memset ( & V_139 , 0 , sizeof( V_139 ) ) ;
#ifdef F_52
V_139 . V_140 = V_52 -> V_141 ;
#endif
V_139 . V_142 = 1 ;
V_139 . V_113 = ( void * * ) & V_52 ;
V_139 . V_143 = F_38 ;
V_139 . V_144 = F_44 ;
V_139 . V_145 = V_146 ;
V_139 . V_147 = & V_128 ;
...
static void T_5 * F_54 ( struct V_149 * V_53 ,
struct V_150 * V_151 ,
struct V_1 * V_2 )
{
struct V_130 V_152 ;
int V_50 = 0 ;
V_50 = F_55 ( V_151 , 0 , & V_152 ) ;
if ( V_50 )
return F_56 ( V_50 ) ;
return F_57 ( & V_53 -> V_54 , & V_152 ) ;
}
static int F_58 ( struct V_150 * V_151 , int V_36 ,
unsigned long type ,
unsigned int * V_153 ,
unsigned int * V_154 )
{
const int V_155 = 3 , V_156 = 2 ;
const T_6 * V_157 ;
int V_158 , V_159 , V_160 , V_161 , V_17 ;
* V_153 = - 1 ;
* V_154 = - 1 ;
V_157 = F_59 ( V_151 , L_5 , & V_158 ) ;
if ( ! V_157 )
return - V_162 ;
V_161 = F_60 ( V_151 ) ;
V_160 = V_161 + V_155 + V_156 ;
V_159 = V_158 / sizeof( T_6 ) / V_160 ;
for ( V_17 = 0 ; V_17 < V_159 ; V_17 ++ , V_157 += V_160 ) {
T_1 V_133 = F_61 ( V_157 , 1 ) ;
T_1 V_163 = F_61 ( V_157 + 1 , 1 ) ;
T_7 V_164 = F_61 ( V_157 + V_155 , V_161 ) ;
unsigned long V_165 ;
if ( F_62 ( V_133 ) == V_166 )
V_165 = V_134 ;
else if ( F_62 ( V_133 ) == V_167 )
V_165 = V_136 ;
else
continue;
if ( V_163 == F_36 ( V_36 ) && type == V_165 ) {
* V_153 = F_63 ( V_164 ) ;
* V_154 = F_64 ( V_164 ) ;
return 0 ;
}
...
static void F_65 ( struct V_110 * V_52 )
{
struct V_150 * V_169 ;
V_169 = F_66 ( V_52 -> V_53 -> V_54 . V_170 ,
L_6 , 0 ) ;
if ( ! V_169 )
return;
V_52 -> V_141 = F_67 ( V_169 ) ;
if ( V_52 -> V_141 )
V_52 -> V_141 -> V_54 = & V_52 -> V_53 -> V_54 ;
}
...
for ( V_17 = 0 ; V_17 < V_52 -> V_114 ; V_17 ++ ) {
struct V_1 * V_2 = V_52 -> V_115 + V_17 ;
V_2 -> V_171 = F_3 ( V_2 , V_8 ) ;
}
return 0 ;
}
static int F_70 ( struct V_77 * V_54 )
{
struct V_110 * V_52 ;
int V_17 ;
V_52 = F_69 ( V_54 ) ;
for ( V_17 = 0 ; V_17 < V_52 -> V_114 ; V_17 ++ ) {
struct V_1 * V_2 = V_52 -> V_115 + V_17 ;
F_1 ( V_2 , V_2 -> V_171 , V_8 ) ;
F_18 ( V_2 ) ;
}
return 0 ;
}
static int F_71 ( struct V_149 * V_53 )
{
struct V_110 * V_52 ;
struct V_150 * V_151 = V_53 -> V_54 . V_170 ;
struct V_150 * V_172 ;
int V_17 , V_50 ;
V_52 = F_72 ( & V_53 -> V_54 , sizeof( struct V_110 ) ,
V_173 ) ;
if ( ! V_52 )
return - V_174 ;
V_52 -> V_53 = V_53 ;
...
F_75 ( & V_52 -> V_64 ) ;
if ( F_40 ( & V_52 -> V_64 ) != 0 ) {
V_52 -> V_120 . V_133 = V_52 -> V_64 . V_133 ;
V_52 -> V_120 . V_65 = V_175 ;
V_52 -> V_120 . V_51 = F_76 ( T_4 ,
V_176 ,
F_40 ( & V_52 -> V_64 ) ) ;
} else
V_52 -> V_120 = V_52 -> V_64 ;
V_50 = F_77 ( V_151 , & V_52 -> V_126 ) ;
if ( V_50 ) {
F_26 ( & V_53 -> V_54 , L_8 ,
V_50 ) ;
return V_50 ;
...
V_52 -> V_115 = F_72 ( & V_53 -> V_54 , V_17 *
sizeof( struct V_1 ) ,
V_173 ) ;
if ( ! V_52 -> V_115 )
return - V_174 ;
...
& V_2 -> V_178 ) )
V_2 -> V_178 = 0 ;
V_2 -> V_119 = F_82 ( V_173 , L_12 ,
V_2 -> V_2 , V_2 -> V_178 ) ;
V_2 -> V_36 = F_83 ( V_172 ) ;
if ( V_2 -> V_36 < 0 )
continue;
V_50 = F_58 ( V_151 , V_2 -> V_36 , V_136 ,
& V_2 -> V_70 , & V_2 -> V_71 ) ;
if ( V_50 < 0 ) {
F_26 ( & V_53 -> V_54 , L_13 ,
V_2 -> V_2 , V_2 -> V_178 ) ;
...
if ( F_40 ( & V_52 -> V_64 ) != 0 )
F_58 ( V_151 , V_2 -> V_36 , V_134 ,
& V_2 -> V_6 , & V_2 -> V_7 ) ;
else {
V_2 -> V_6 = - 1 ;
V_2 -> V_7 = - 1 ;
}
V_2 -> V_179 = F_84 ( V_172 ,
L_14 , 0 , & V_133 ) ;
if ( F_85 ( V_2 -> V_179 ) ) {
T_1 V_180 = 20000 ;
V_2 -> V_181 = V_133 & V_182 ;
V_2 -> V_183 = F_82 ( V_173 ,
L_15 , V_2 -> V_2 , V_2 -> V_178 ) ;
F_80 ( V_172 , L_16 ,
& V_180 ) ;
V_50 = F_86 ( & V_53 -> V_54 ,
V_2 -> V_179 , V_184 , V_2 -> V_183 ) ;
if ( V_50 ) {
if ( V_50 == - V_185 )
return V_50 ;
continue;
...
V_52 -> V_114 = V_17 ;
for ( V_17 = 0 ; V_17 < ( V_176 - V_135 ) ; V_17 += V_135 )
F_93 ( V_17 , V_52 -> V_64 . V_65 + V_17 ) ;
F_65 ( V_52 ) ;
F_51 ( V_52 ) ;
F_73 ( V_53 , V_52 ) ;
return 0 ;
