...
case V_54 :
if ( V_5 -> V_9 . V_27 . V_55 != 0x50 )
V_12 -> V_56 = ( V_24 -> V_30 & 0x7f00 ) >> 8 ;
break;
case V_57 :
case V_58 :
V_12 -> V_56 = ( V_24 -> V_30 & 0xff00 ) >> 8 ;
break;
default:
break;
}
...
static void
F_22 ( struct V_1 * V_2 , const char * V_40 )
{
}
static int
...
return - V_29 ;
V_12 -> V_32 = 12 ;
V_26 = F_29 ( V_2 -> V_10 , V_15 -> V_34 << 12 , V_12 -> V_32 ,
V_64 , & V_12 -> V_13 [ 0 ] ) ;
if ( V_26 ) {
F_19 ( V_12 ) ;
return V_26 ;
...
static void
F_30 ( struct V_1 * V_2 , const char * V_40 )
{
}
int
...
V_5 -> V_103 . V_104 = V_5 -> V_9 . V_27 . V_105 ;
V_26 = F_53 ( & V_5 -> V_75 . V_6 , V_106 ,
V_5 -> V_103 . V_104 >> V_35 ) ;
if ( V_26 ) {
F_52 ( V_5 , L_7 , V_26 ) ;
return V_26 ;
}
...
V_26 = F_53 ( & V_5 -> V_75 . V_6 , V_110 ,
V_5 -> V_103 . V_108 >> V_35 ) ;
if ( V_26 ) {
F_52 ( V_5 , L_8 , V_26 ) ;
return V_26 ;
}
F_57 ( V_5 , L_9 , ( T_1 ) ( V_5 -> V_103 . V_104 >> 20 ) ) ;
F_57 ( V_5 , L_10 , ( T_1 ) ( V_5 -> V_103 . V_108 >> 20 ) ) ;
return 0 ;
}
void
F_58 ( struct V_4 * V_5 )
