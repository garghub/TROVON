...
static int F_61 ( struct V_26 * V_27 , int V_39 )
{
struct V_1 * V_2 = V_27 -> V_28 ;
F_59 ( V_2 -> V_33 -> V_34 , V_92 , V_38 ) ;
return 0 ;
}
static void F_62 ( struct V_26 * V_27 , int V_39 )
{
struct V_1 * V_2 = V_27 -> V_28 ;
...
struct V_26 * V_94 ;
int V_56 ;
V_94 = F_64 ( & V_95 , & V_70 -> V_27 ) ;
if ( ! V_94 )
return - V_79 ;
V_56 = F_65 ( V_94 , F_66 ( V_94 -> V_27 ) ) ;
if ( V_56 )
goto V_96;
V_56 = F_20 ( V_94 ) ;
if ( V_56 )
...
static int F_72 ( struct V_99 * V_27 )
{
struct V_26 * V_100 = F_25 ( V_27 ) ;
struct V_90 * V_39 ;
if ( F_73 ( V_27 ) )
return 0 ;
F_74 ( V_100 ) ;
...
static int F_77 ( struct V_99 * V_27 )
{
struct V_26 * V_100 = F_25 ( V_27 ) ;
struct V_90 * V_39 ;
if ( F_73 ( V_27 ) )
