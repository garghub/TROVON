...
static int F_18 ( struct V_26 * V_27 , T_3 * V_45 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
int V_7 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_5 , V_33 ,
...
static int F_26 ( struct V_26 * V_27 , T_2 * V_47 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
int V_7 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_5 , V_33 ,
...
static int F_30 ( struct V_26 * V_27 , T_4 * V_48 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
int V_7 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_5 , V_33 ,
...
static int F_34 ( struct V_26 * V_27 , T_4 * V_49 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
int V_7 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_5 , V_33 ,
...
static int F_38 ( struct V_26 * V_27 , T_2 * V_50 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
int V_7 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_5 , V_33 ,
...
static enum V_53 F_51 ( struct V_26 * V_27 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
struct V_39 * V_40 = & V_27 -> V_34 ;
int V_7 , V_30 ;
...
static int F_58 ( struct V_26 * V_27 , int V_62 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_12 , V_33 , V_62 ) ;
return F_9 ( V_2 , 0xdb , V_62 ? 1 : 0 , 0x1 ) ;
}
static int F_59 ( struct V_60 * V_63 , unsigned V_64 ,
int V_5 )
{
struct V_1 * V_2 =
F_60 ( V_63 , struct V_1 , V_60 ) ;
T_1 V_28 [ V_65 ] ;
F_11 ( & V_2 -> V_3 -> V_14 , L_13 , V_33 , V_64 , V_5 ) ;
memcpy ( V_28 , V_2 -> V_28 , sizeof( V_28 ) ) ;
V_28 [ V_64 ] = V_36 | V_66 | ( V_5 << 2 ) ;
return F_10 ( & V_2 -> V_27 , V_28 ) ;
}
static void F_61 ( struct V_60 * V_63 , unsigned V_64 , int V_5 )
{
struct V_1 * V_2 =
F_60 ( V_63 , struct V_1 , V_60 ) ;
T_1 V_28 [ V_65 ] ;
...
static int F_62 ( struct V_60 * V_63 , unsigned V_64 )
{
struct V_1 * V_2 =
F_60 ( V_63 , struct V_1 , V_60 ) ;
F_11 ( & V_2 -> V_3 -> V_14 , L_14 , V_33 , V_64 ) ;
return ( V_2 -> V_28 [ V_64 ] >> 2 ) & 0x01 ;
}
struct V_26 * F_63 ( const struct V_67 * V_22 ,
struct V_68 * V_3 , int * V_69
)
{
struct V_1 * V_2 ;
int V_7 ;
T_1 V_25 ;
V_2 = F_64 ( sizeof( struct V_1 ) , V_70 ) ;
if ( ! V_2 ) {
V_7 = - V_71 ;
F_65 ( & V_3 -> V_14 , L_15 ,
V_15 ) ;
...
V_2 -> V_3 = V_3 ;
memcpy ( & V_2 -> V_22 , V_22 , sizeof( struct V_67 ) ) ;
memcpy ( & V_2 -> V_27 . V_72 , & V_73 , sizeof( struct V_74 ) ) ;
V_2 -> V_27 . V_29 = V_2 ;
