...
if ( F_19 ( V_33 ) || F_20 ( V_2 ) ) {
F_1 ( V_2 ) ;
return;
}
V_34 = V_2 -> V_12 >> 1 ;
do {
F_18 ( V_2 , V_33 -> V_37 [ V_33 -> V_38 ] ) ;
...
static T_1 F_23 ( int V_41 , void * V_42 )
{
struct V_1 * V_2 = V_42 ;
unsigned int V_7 ;
F_17 ( & V_2 -> V_30 ) ;
...
int V_51 ;
unsigned int V_3 ;
V_51 = F_29 ( V_2 -> V_41 , F_23 , 0 , L_1 , V_2 ) ;
if ( V_51 )
return V_51 ;
V_3 = F_2 ( V_2 ) ;
F_3 ( V_2 ,
...
V_58 = F_33 ( V_2 , V_55 , V_56 , 0 , V_2 -> V_60 / 16 ) ;
if ( V_58 == 0 )
F_34 ( L_2 , V_2 -> V_60 / 16 ) ;
V_59 = ( F_35 ( V_2 , V_58 ) ) * 2 ;
V_3 = F_2 ( V_2 ) ;
V_3 &= ~ ( V_61 | V_62 ) ;
if ( V_55 -> V_63 & V_64 ) {
V_3 |= V_61 ;
...
{
return F_44 ( V_2 -> V_74 , 0x100 , L_4 )
!= NULL ? 0 : - V_75 ;
return 0 ;
}
static void F_45 ( struct V_1 * V_2 , int V_57 )
{
if ( V_57 & V_76 ) {
V_2 -> type = V_73 ;
F_43 ( V_2 ) ;
...
static void F_52 ( struct V_1 * V_2 , int V_8 )
{
unsigned int V_7 ;
do {
V_7 = F_5 ( V_2 ) ;
...
static void
F_53 ( struct V_88 * V_89 , const char * V_90 , unsigned int V_34 )
{
...
static int T_2 F_57 ( struct V_88 * V_89 , char * V_96 )
{
struct V_1 * V_2 ;
int V_58 = 38400 ;
int V_95 = 8 ;
...
F_59 ( & V_2 -> V_30 ) ;
if ( V_96 )
F_60 ( V_96 , & V_58 , & V_23 , & V_95 , & V_97 ) ;
else
F_55 ( V_2 , & V_58 , & V_23 , & V_95 ) ;
return F_61 ( V_2 , V_89 , V_58 , V_23 , V_95 , V_97 ) ;
}
...
struct V_110 * V_111 ;
int line = 0 ;
F_68 (np, apbuart_match) {
const int * V_112 ;
const T_3 * V_113 ;
const struct V_114 * V_115 ;
struct V_1 * V_2 ;
unsigned long V_116 ;
V_112 = F_69 ( V_111 , L_7 , NULL ) ;
if ( V_112 && ( * V_112 == 0 ) )
continue;
V_115 = F_69 ( V_111 , L_8 , NULL ) ;
V_113 = F_69 ( V_111 , L_9 , NULL ) ;
...
V_2 = & V_91 [ line ] ;
V_2 -> V_74 = V_116 ;
V_2 -> V_118 = F_70 ( V_116 , sizeof( struct V_119 ) ) ;
V_2 -> V_41 = 0 ;
V_2 -> V_120 = V_121 ;
V_2 -> V_122 = & V_123 ;
V_2 -> V_57 = V_124 ;
V_2 -> line = line ;
V_2 -> V_60 = * V_113 ;
V_2 -> V_12 = F_47 ( (struct V_1 * ) V_2 , line ) ;
line ++ ;
if ( line == V_125 )
break;
}
