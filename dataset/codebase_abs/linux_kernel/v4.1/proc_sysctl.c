...
type = V_66 -> V_79 >> 12 ;
F_78 ( V_117 ) ;
return F_80 ( V_116 , V_119 . V_19 , V_119 . V_95 , V_120 , type ) ;
}
static bool F_81 ( struct V_100 * V_100 ,
struct V_115 * V_116 ,
struct V_17 * V_21 ,
struct V_9 * V_38 )
{
...
static int F_82 ( struct V_17 * V_21 , struct V_9 * V_38 ,
unsigned long * V_124 , struct V_100 * V_100 ,
struct V_115 * V_116 )
{
bool V_105 ;
if ( ( * V_124 ) ++ < V_116 -> V_124 )
return true ;
if ( F_22 ( F_60 ( V_38 -> V_57 ) ) )
V_105 = F_81 ( V_100 , V_116 , V_21 , V_38 ) ;
else
...
static int F_83 ( struct V_100 * V_100 , struct V_115 * V_116 )
{
...
if ( ! F_82 ( V_91 , V_22 , & V_124 , V_100 , V_116 ) ) {
F_36 ( V_91 ) ;
break;
}
}
...
static int F_85 ( struct V_66 * V_66 , int V_125 )
{
struct V_17 * V_21 ;
struct V_9 * V_38 ;
int error ;
if ( ( V_125 & V_63 ) && F_86 ( V_66 -> V_79 ) )
return - V_64 ;
V_21 = F_55 ( V_66 ) ;
if ( F_57 ( V_21 ) )
return F_66 ( V_21 ) ;
V_38 = F_53 ( V_66 ) -> V_74 ;
if ( ! V_38 )
error = V_125 & V_62 ? - V_64 : 0 ;
else
error = F_49 ( V_21 , V_38 , V_125 & ~ V_126 ) ;
F_36 ( V_21 ) ;
return error ;
}
static int F_87 ( struct V_89 * V_89 , struct V_127 * V_128 )
{
struct V_66 * V_66 = F_79 ( V_89 ) ;
int error ;
if ( V_128 -> V_129 & ( V_130 | V_131 | V_132 ) )
return - V_106 ;
error = F_88 ( V_66 , V_128 ) ;
if ( error )
return error ;
F_89 ( V_66 , V_128 ) ;
F_90 ( V_66 ) ;
...
static int F_91 ( struct V_133 * V_134 , struct V_89 * V_89 , struct V_135 * V_136 )
{
struct V_66 * V_66 = F_79 ( V_89 ) ;
struct V_17 * V_21 = F_55 ( V_66 ) ;
struct V_9 * V_38 = F_53 ( V_66 ) -> V_74 ;
...
F_92 ( V_66 , V_136 ) ;
if ( V_38 )
V_136 -> V_57 = ( V_136 -> V_57 & V_137 ) | V_38 -> V_57 ;
F_36 ( V_21 ) ;
return 0 ;
}
static int F_93 ( struct V_89 * V_89 , unsigned int V_90 )
{
if ( V_90 & V_138 )
return - V_139 ;
return ! F_53 ( F_79 ( V_89 ) ) -> V_73 -> V_43 ;
}
static int F_94 ( const struct V_89 * V_89 )
{
return ! ! F_53 ( F_79 ( V_89 ) ) -> V_73 -> V_43 ;
}
static int F_95 ( struct V_17 * V_29 )
{
...
V_105 = V_37 -> V_140 ( V_37 ) ;
F_27 ( & V_48 ) ;
return V_105 ;
}
static int F_96 ( const struct V_89 * V_8 , const struct V_89 * V_89 ,
unsigned int V_95 , const char * V_141 , const struct V_92 * V_19 )
{
struct V_17 * V_21 ;
struct V_66 * V_66 ;
V_66 = F_97 ( V_89 ) ;
...
if ( V_19 -> V_95 != V_95 )
return 1 ;
if ( memcmp ( V_19 -> V_19 , V_141 , V_95 ) )
return 1 ;
V_21 = F_98 ( F_53 ( V_66 ) -> V_73 ) ;
return ! V_21 || ! F_95 ( V_21 ) ;
}
...
static struct V_5 * F_100 ( struct V_36 * V_37 ,
const char * V_19 , int V_20 )
{
struct V_9 * V_38 ;
struct V_5 * V_143 ;
struct V_26 * V_24 ;
char * V_144 ;
V_143 = F_101 ( sizeof( * V_143 ) + sizeof( struct V_26 ) +
sizeof( struct V_9 ) * 2 + V_20 + 1 ,
V_145 ) ;
if ( ! V_143 )
return NULL ;
V_24 = (struct V_26 * ) ( V_143 + 1 ) ;
V_38 = (struct V_9 * ) ( V_24 + 1 ) ;
V_144 = ( char * ) ( V_38 + 2 ) ;
memcpy ( V_144 , V_19 , V_20 ) ;
V_144 [ V_20 ] = '\0' ;
V_38 [ 0 ] . V_10 = V_144 ;
V_38 [ 0 ] . V_57 = V_85 | V_146 | V_147 ;
F_15 ( & V_143 -> V_7 , V_37 -> V_6 . V_7 . V_25 , V_37 , V_24 , V_38 ) ;
return V_143 ;
}
static struct V_5 * F_102 ( struct V_5 * V_6 ,
const char * V_19 , int V_20 )
{
struct V_36 * V_37 = V_6 -> V_7 . V_37 ;
struct V_5 * V_148 , * V_143 = NULL ;
int V_44 ;
F_29 ( & V_48 ) ;
V_148 = F_99 ( V_6 , V_19 , V_20 ) ;
if ( ! F_57 ( V_148 ) )
goto V_149;
if ( F_66 ( V_148 ) != - V_51 )
goto V_150;
F_27 ( & V_48 ) ;
V_143 = F_100 ( V_37 , V_19 , V_20 ) ;
F_29 ( & V_48 ) ;
V_148 = F_30 ( - V_97 ) ;
if ( ! V_143 )
goto V_150;
...
static struct V_5 * F_103 ( struct V_36 * V_37 , struct V_5 * V_6 )
{
struct V_5 * V_8 ;
const char * V_10 ;
if ( ! V_6 -> V_7 . V_8 )
return & V_37 -> V_6 ;
V_8 = F_103 ( V_37 , V_6 -> V_7 . V_8 ) ;
if ( F_57 ( V_8 ) )
return V_8 ;
V_10 = V_6 -> V_7 . V_9 [ 0 ] . V_10 ;
return F_99 ( V_8 , V_10 , strlen ( V_10 ) ) ;
}
...
static int F_104 ( const char * V_152 , struct V_9 * V_38 , char * V_153 , ... )
{
struct V_154 V_155 ;
T_7 args ;
va_start ( args , V_153 ) ;
...
V_155 . V_156 = & args ;
F_10 ( L_6 ,
V_152 , V_38 -> V_10 , & V_155 ) ;
va_end ( args ) ;
return - V_49 ;
}
static int F_105 ( const char * V_152 , struct V_9 * V_38 )
{
int V_44 = 0 ;
for (; V_38 -> V_10 ; V_38 ++ ) {
if ( V_38 -> V_117 )
V_44 = F_104 ( V_152 , V_38 , L_7 ) ;
if ( ( V_38 -> V_107 == V_157 ) ||
( V_38 -> V_107 == V_158 ) ||
( V_38 -> V_107 == V_159 ) ||
( V_38 -> V_107 == V_160 ) ||
...
( V_38 -> V_107 == V_164 ) ) {
if ( ! V_38 -> V_151 )
V_44 = F_104 ( V_152 , V_38 , L_8 ) ;
if ( ! V_38 -> V_165 )
V_44 = F_104 ( V_152 , V_38 , L_9 ) ;
}
if ( ! V_38 -> V_107 )
V_44 = F_104 ( V_152 , V_38 , L_10 ) ;
if ( ( V_38 -> V_57 & ( V_146 | V_166 ) ) != V_38 -> V_57 )
V_44 = F_104 ( V_152 , V_38 , L_11 ,
V_38 -> V_57 ) ;
}
return V_44 ;
}
static struct V_17 * F_106 ( struct V_5 * V_6 , struct V_9 * V_38 ,
struct V_35 * V_167 )
{
struct V_9 * V_168 , * V_22 , * V_169 ;
struct V_17 * V_170 ;
struct V_26 * V_24 ;
char * V_171 ;
int V_172 , V_173 ;
...
V_172 ++ ;
V_173 += strlen ( V_22 -> V_10 ) + 1 ;
}
V_170 = F_101 ( sizeof( struct V_17 ) +
sizeof( struct V_26 ) * V_172 +
sizeof( struct V_9 ) * ( V_172 + 1 ) +
V_173 ,
V_145 ) ;
if ( ! V_170 )
return NULL ;
V_24 = (struct V_26 * ) ( V_170 + 1 ) ;
V_168 = (struct V_9 * ) ( V_24 + V_172 ) ;
V_171 = ( char * ) & V_168 [ V_172 + 1 ] ;
for ( V_169 = V_168 , V_22 = V_38 ; V_22 -> V_10 ; V_169 ++ , V_22 ++ ) {
int V_95 = strlen ( V_22 -> V_10 ) + 1 ;
memcpy ( V_171 , V_22 -> V_10 , V_95 ) ;
V_169 -> V_10 = V_171 ;
V_169 -> V_57 = V_174 | V_175 ;
V_169 -> V_151 = V_167 ;
V_171 += V_95 ;
}
F_15 ( V_170 , V_6 -> V_7 . V_25 , V_6 -> V_7 . V_37 , V_24 , V_168 ) ;
V_170 -> V_42 = V_172 ;
return V_170 ;
}
static bool F_107 ( struct V_5 * V_6 ,
struct V_9 * V_38 , struct V_35 * V_167 )
{
struct V_17 * V_21 ;
struct V_9 * V_22 , * V_169 ;
for ( V_22 = V_38 ; V_22 -> V_10 ; V_22 ++ ) {
const char * V_10 = V_22 -> V_10 ;
V_169 = F_7 ( & V_21 , V_6 , V_10 , strlen ( V_10 ) ) ;
if ( ! V_169 )
return false ;
if ( F_54 ( V_169 -> V_57 ) && F_54 ( V_22 -> V_57 ) )
continue;
if ( F_60 ( V_169 -> V_57 ) && ( V_169 -> V_151 == V_167 ) )
continue;
return false ;
}
for ( V_22 = V_38 ; V_22 -> V_10 ; V_22 ++ ) {
...
{
struct V_36 * V_176 = & V_88 . V_54 ;
struct V_5 * V_177 = NULL ;
struct V_17 * V_170 ;
int V_44 ;
if ( V_21 -> V_37 == V_176 )
return 0 ;
V_177 = F_103 ( V_176 , V_21 -> V_8 ) ;
if ( F_57 ( V_177 ) )
return 0 ;
if ( F_107 ( V_177 , V_21 -> V_9 , V_21 -> V_25 ) )
return 0 ;
V_177 -> V_7 . V_42 ++ ;
F_27 ( & V_48 ) ;
V_170 = F_106 ( V_177 , V_21 -> V_9 , V_21 -> V_25 ) ;
F_29 ( & V_48 ) ;
V_44 = - V_97 ;
if ( ! V_170 )
goto V_71;
...
struct V_17 * F_109 (
struct V_36 * V_37 ,
const char * V_152 , struct V_9 * V_38 )
{
struct V_35 * V_25 = V_37 -> V_6 . V_7 . V_25 ;
struct V_17 * V_7 ;
const char * V_19 , * V_178 ;
struct V_5 * V_6 ;
struct V_9 * V_22 ;
struct V_26 * V_24 ;
int V_172 = 0 ;
for ( V_22 = V_38 ; V_22 -> V_10 ; V_22 ++ )
V_172 ++ ;
V_7 = F_101 ( sizeof( struct V_17 ) +
sizeof( struct V_26 ) * V_172 , V_145 ) ;
if ( ! V_7 )
return NULL ;
...
V_6 -> V_7 . V_42 ++ ;
F_27 ( & V_48 ) ;
for ( V_19 = V_152 ; V_19 ; V_19 = V_178 ) {
int V_20 ;
V_178 = strchr ( V_19 , '/' ) ;
if ( V_178 ) {
V_20 = V_178 - V_19 ;
...
struct V_17 * F_111 ( const char * V_152 , struct V_9 * V_38 )
{
return F_109 ( & V_88 . V_54 ,
V_152 , V_38 ) ;
}
static char * F_112 ( const char * V_152 , char * V_124 , const char * V_19 )
{
int V_20 ;
V_20 = strlen ( V_19 ) ;
if ( ( ( V_124 - V_152 ) + V_20 + 2 ) >= V_180 )
return NULL ;
memcpy ( V_124 , V_19 , V_20 ) ;
V_124 [ V_20 ] = '/' ;
V_124 [ V_20 + 1 ] = '\0' ;
V_124 += V_20 + 1 ;
return V_124 ;
}
static int F_113 ( struct V_9 * V_38 )
{
int V_181 = 0 ;
int V_182 = 0 ;
struct V_9 * V_22 ;
...
for ( V_22 = V_38 ; V_22 -> V_10 ; V_22 ++ ) {
if ( V_22 -> V_117 )
V_182 += F_113 ( V_22 -> V_117 ) ;
else
V_181 = 1 ;
}
return V_182 + V_181 ;
}
static int F_114 ( const char * V_152 , char * V_124 ,
struct V_17 * * * V_183 , struct V_36 * V_37 ,
struct V_9 * V_38 )
{
struct V_9 * V_39 = NULL ;
struct V_9 * V_22 , * V_184 ;
int V_185 = 0 ;
int V_186 = 0 ;
int V_44 = - V_97 ;
for ( V_22 = V_38 ; V_22 -> V_10 ; V_22 ++ ) {
...
if ( V_186 && V_185 ) {
struct V_9 * V_143 ;
V_184 = F_101 ( sizeof( struct V_9 ) * ( V_185 + 1 ) ,
V_145 ) ;
if ( ! V_184 )
goto V_71;
V_39 = V_184 ;
for ( V_143 = V_184 , V_22 = V_38 ; V_22 -> V_10 ; V_22 ++ ) {
if ( V_22 -> V_117 )
continue;
* V_143 = * V_22 ;
V_143 ++ ;
...
continue;
V_44 = - V_188 ;
V_187 = F_112 ( V_152 , V_124 , V_22 -> V_10 ) ;
if ( ! V_187 )
goto V_71;
V_44 = F_114 ( V_152 , V_187 , V_183 ,
V_37 , V_22 -> V_117 ) ;
V_124 [ 0 ] = '\0' ;
if ( V_44 )
goto V_71;
...
struct V_17 * F_115 (
struct V_36 * V_37 ,
const struct V_189 * V_152 , struct V_9 * V_38 )
{
struct V_9 * V_39 = V_38 ;
int V_182 = F_113 ( V_38 ) ;
struct V_17 * V_7 = NULL , * * V_190 , * * V_183 ;
const struct V_189 * V_191 ;
char * V_192 , * V_124 ;
V_124 = V_192 = F_116 ( V_180 , V_145 ) ;
if ( ! V_192 )
return NULL ;
V_124 [ 0 ] = '\0' ;
for ( V_191 = V_152 ; V_191 -> V_10 ; V_191 ++ ) {
V_124 = F_112 ( V_192 , V_124 , V_191 -> V_10 ) ;
if ( ! V_124 )
goto V_71;
}
while ( V_38 -> V_10 && V_38 -> V_117 && ! V_38 [ 1 ] . V_10 ) {
V_124 = F_112 ( V_192 , V_124 , V_38 -> V_10 ) ;
if ( ! V_124 )
goto V_71;
V_38 = V_38 -> V_117 ;
}
if ( V_182 == 1 ) {
V_7 = F_109 ( V_37 , V_192 , V_38 ) ;
if ( V_7 )
V_7 -> V_39 = V_39 ;
} else {
V_7 = F_101 ( sizeof( * V_7 ) +
sizeof( * V_190 ) * V_182 , V_145 ) ;
if ( ! V_7 )
goto V_71;
V_190 = (struct V_17 * * ) ( V_7 + 1 ) ;
V_183 = V_190 ;
V_7 -> V_39 = V_39 ;
if ( F_114 ( V_192 , V_124 , & V_183 ,
V_37 , V_38 ) )
goto V_193;
}
V_71:
...
V_193:
while ( V_183 > V_190 ) {
struct V_17 * V_194 = * ( -- V_183 ) ;
struct V_9 * V_38 = V_194 -> V_39 ;
F_117 ( V_194 ) ;
F_108 ( V_38 ) ;
}
F_108 ( V_7 ) ;
...
struct V_17 * F_118 ( const struct V_189 * V_152 ,
struct V_9 * V_38 )
{
return F_115 ( & V_88 . V_54 ,
V_152 , V_38 ) ;
}
struct V_17 * F_119 ( struct V_9 * V_38 )
{
static const struct V_189 V_195 [] = { {} } ;
return F_118 ( V_195 , V_38 ) ;
}
...
struct V_9 * V_169 ;
const char * V_19 = V_22 -> V_10 ;
V_169 = F_7 ( & V_196 , V_177 , V_19 , strlen ( V_19 ) ) ;
if ( V_169 &&
( ( F_54 ( V_169 -> V_57 ) && F_54 ( V_22 -> V_57 ) ) ||
( F_60 ( V_169 -> V_57 ) && ( V_169 -> V_151 == V_25 ) ) ) ) {
F_20 ( V_196 ) ;
}
else {
F_10 ( L_12 ) ;
...
void F_117 ( struct V_17 * V_7 )
{
int V_182 ;
F_120 () ;
if ( V_7 == NULL )
return;
V_182 = F_113 ( V_7 -> V_39 ) ;
if ( F_22 ( V_182 > 1 ) ) {
struct V_17 * * V_190 ;
int V_197 ;
V_190 = (struct V_17 * * ) ( V_7 + 1 ) ;
for ( V_197 = V_182 - 1 ; V_197 >= 0 ; V_197 -- ) {
struct V_17 * V_194 = V_190 [ V_197 ] ;
struct V_9 * V_38 = V_194 -> V_39 ;
F_117 ( V_194 ) ;
F_108 ( V_38 ) ;
}
...
struct V_35 * V_25 ,
int (* V_140)( struct V_36 * ) )
{
memset ( V_37 , 0 , sizeof( * V_37 ) ) ;
V_37 -> V_140 = V_140 ;
F_15 ( & V_37 -> V_6 . V_7 , V_25 , V_37 , NULL , V_198 ) ;
}
void F_122 ( struct V_36 * V_37 )
{
F_123 ( ! F_124 ( & V_37 -> V_6 . V_25 ) ) ;
}
int T_8 F_125 ( void )
{
struct V_199 * V_200 ;
V_200 = F_126 ( L_13 , NULL ) ;
V_200 -> V_201 = & V_86 ;
V_200 -> V_202 = & V_87 ;
V_200 -> V_203 = 0 ;
return F_127 () ;
