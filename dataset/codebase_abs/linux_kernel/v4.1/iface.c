...
unsigned char V_142 , enum V_67 type ,
T_2 V_16 )
{
...
int V_70 = - V_144 ;
F_4 () ;
V_143 = F_60 ( sizeof( * V_4 ) + V_48 -> V_54 . V_145 , V_141 ,
V_142 , F_52 ) ;
if ( ! V_143 )
return F_61 ( - V_144 ) ;
V_143 -> V_146 = V_48 -> V_54 . V_147 ;
V_70 = F_62 ( V_143 , V_143 -> V_141 ) ;
if ( V_70 < 0 )
goto V_25;
F_63 ( V_143 -> V_148 ,
