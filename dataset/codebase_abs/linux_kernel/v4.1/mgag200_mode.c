...
if ( ( V_32 -> V_125 % 8 ) != 0 || ( V_32 -> V_159 % 8 ) != 0 ||
( V_32 -> V_160 % 8 ) != 0 || ( V_32 -> V_128 % 8 ) != 0 ) {
return V_216 ;
}
if ( V_32 -> V_217 > 2048 || V_32 -> V_218 > 4096 ||
V_32 -> V_219 > 4096 || V_32 -> V_220 > 4096 ||
V_32 -> V_221 > 2048 || V_32 -> V_222 > 4096 ||
V_32 -> V_223 > 4096 || V_32 -> V_224 > 4096 ) {
return V_225 ;
}
if ( V_202 -> V_226 . V_227 ) {
if ( V_202 -> V_226 . V_228 )
V_169 = V_202 -> V_226 . V_169 ;
}
if ( ( V_32 -> V_125 * V_32 -> V_129 * ( V_169 / 8 ) ) > V_7 -> V_229 . V_230 ) {
if ( V_202 -> V_226 . V_227 )
V_202 -> V_226 . V_227 = false ;
return V_225 ;
}
return V_231 ;
}
...
* V_202 )
{
int V_232 = V_202 -> V_233 [ 0 ] ;
if ( V_232 )
return F_78 ( V_202 -> V_5 , V_232 ) ;
return NULL ;
}
static enum V_234 F_79 ( struct V_187
* V_202 , bool V_235 )
{
return V_236 ;
}
...
struct V_187 * V_202 ;
int V_117 ;
V_7 -> V_191 . V_240 = true ;
V_7 -> V_5 -> V_241 . V_242 = V_243 ;
V_7 -> V_5 -> V_241 . V_244 = V_245 ;
V_7 -> V_5 -> V_241 . V_246 = V_7 -> V_229 . V_247 ;
F_51 ( V_7 ) ;
V_195 = F_66 ( V_7 -> V_5 ) ;
if ( ! V_195 ) {
F_33 ( L_5 ) ;
