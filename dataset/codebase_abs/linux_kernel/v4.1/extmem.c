...
F_4 ( V_1 , V_22 ) ;
F_9 (l, &dcss_list) {
V_27 = F_10 ( V_26 , struct V_24 , V_30 ) ;
...
static int
F_13 ( struct V_24 * V_39 )
{
unsigned long V_40 , V_41 ;
int V_42 , V_6 , V_23 ;
struct V_43 * V_44 ;
struct V_45 * V_46 ;
V_46 = F_2 ( sizeof( * V_46 ) , V_2 | V_3 ) ;
V_44 = F_2 ( sizeof( * V_44 ) , V_2 | V_3 ) ;
...
static int
F_18 ( char * V_1 , int V_72 , unsigned long * V_73 , unsigned long * V_61 )
{
unsigned long V_68 , V_74 , V_40 ;
struct V_24 * V_39 ;
int V_6 , V_42 ;
V_68 = V_74 = 0 ;
V_39 = F_2 ( sizeof( * V_39 ) , V_2 | V_3 ) ;
if ( V_39 == NULL ) {
V_6 = - V_7 ;
goto V_75;
}
...
V_6 = F_19 ( V_39 -> V_68 , V_39 -> V_61 - V_39 -> V_68 + 1 ) ;
if ( V_6 )
goto V_47;
V_39 -> V_77 = F_15 ( sizeof( struct V_78 ) , V_2 ) ;
if ( V_39 -> V_77 == NULL ) {
V_6 = - V_7 ;
goto V_79;
}
...
V_39 -> V_77 -> V_80 |= V_87 ;
if ( F_21 ( & V_88 , V_39 -> V_77 ) ) {
V_6 = - V_76 ;
F_3 ( V_39 -> V_77 ) ;
goto V_79;
}
if ( V_72 )
V_42 = F_11 ( & V_11 , V_39 -> V_22 ,
& V_68 , & V_74 ) ;
else
V_42 = F_11 ( & V_9 , V_39 -> V_22 ,
& V_68 , & V_74 ) ;
if ( V_42 < 0 ) {
F_11 ( & V_13 , V_39 -> V_22 ,
& V_40 , & V_40 ) ;
...
F_3 ( V_39 -> V_77 ) ;
V_79:
F_26 ( V_39 -> V_68 , V_39 -> V_61 - V_39 -> V_68 + 1 ) ;
V_47:
F_3 ( V_39 ) ;
V_75:
return V_6 ;
...
int
F_27 ( char * V_1 , int V_72 , unsigned long * V_73 ,
unsigned long * V_61 )
{
struct V_24 * V_39 ;
int V_6 ;
...
V_101 = 0 ;
F_38 ( V_99 , NULL , 0 , & V_101 ) ;
if ( V_101 ) {
F_35 ( L_20
L_21 , V_101 ) ;
goto V_75;
}
F_38 ( V_100 , NULL , 0 , & V_101 ) ;
if ( V_101 ) {
F_35 ( L_22
L_21 , V_101 ) ;
goto V_75;
