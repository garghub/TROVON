...
( V_119
<< F_34 ( V_120 ) ) ;
V_12 -> V_114 . V_121 [ 0 ] = V_95 ;
V_12 -> V_114 . V_121 [ 1 ] = 0 ;
V_2 -> V_56 = F_8 ( V_2 -> V_60 , V_89 | V_31 ) ;
if ( ! V_2 -> V_56 )
goto V_111;
V_12 -> V_22 -> V_23 ( V_2 -> V_56 , V_2 -> V_60 , V_24 ) ;
V_12 -> V_114 . V_122 [ 0 ] = F_35 ( V_2 -> V_56 ) ;
V_12 -> V_114 . V_122 [ 1 ] = 0 ;
return & V_2 -> V_11 ;
V_111:
F_19 ( V_2 ) ;
return NULL ;
...
if ( V_2 -> V_91 == V_16 ) {
unsigned long V_124 ;
V_124 = V_2 -> V_60 >> F_31 ( sizeof( T_2 ) ) ;
if ( V_124 <= V_125 ) {
V_2 -> V_60 = V_124 << V_2 -> V_21 ;
V_2 -> V_91 -- ;
}
}
V_95 = V_126 |
...
V_95 |= ( 64ULL - V_12 -> V_86 ) << V_112 ;
V_95 |= ( ~ V_123 & V_128 ) << V_129 ;
V_12 -> V_130 . V_131 = V_95 ;
V_2 -> V_56 = F_8 ( V_2 -> V_60 , V_89 | V_31 ) ;
if ( ! V_2 -> V_56 )
goto V_111;
V_12 -> V_22 -> V_23 ( V_2 -> V_56 , V_2 -> V_60 , V_24 ) ;
V_12 -> V_130 . V_132 = F_35 ( V_2 -> V_56 ) ;
return & V_2 -> V_11 ;
V_111:
F_19 ( V_2 ) ;
return NULL ;
...
V_11 = F_33 ( V_12 , V_24 ) ;
if ( V_11 ) {
V_12 -> V_114 . V_115 |= V_133 ;
V_12 -> V_114 . V_115 &= 0xffffffff ;
}
return V_11 ;
}
static struct V_61 *
...
static void F_40 ( unsigned long V_3 , T_3 V_25 , bool V_135 ,
void * V_24 )
{
F_3 ( V_24 != V_134 ) ;
F_3 ( ! ( V_25 & V_134 -> V_28 ) ) ;
...
static void F_42 ( void * V_136 , T_3 V_25 , void * V_24 )
{
F_3 ( V_24 != V_134 ) ;
}
...
struct V_53 * V_54 ;
V_9 = true ;
for ( V_140 = 0 ; V_140 < F_46 ( V_138 ) ; ++ V_140 ) {
V_134 = V_12 ;
V_54 = F_47 ( V_138 [ V_140 ] , V_12 , V_12 ) ;
if ( ! V_54 ) {
F_44 ( L_3 ) ;
return - V_32 ;
}
if ( V_54 -> V_94 ( V_54 , 42 ) )
return F_48 ( V_54 , V_140 ) ;
if ( V_54 -> V_94 ( V_54 , V_79 + 42 ) )
return F_48 ( V_54 , V_140 ) ;
if ( V_54 -> V_94 ( V_54 , V_142 + 42 ) )
return F_48 ( V_54 , V_140 ) ;
V_3 = 0 ;
V_141 = F_49 ( & V_12 -> V_28 , V_143 ) ;
while ( V_141 != V_143 ) {
V_25 = 1UL << V_141 ;
...
V_3 += V_79 ;
V_141 ++ ;
V_141 = F_50 ( & V_12 -> V_28 , V_143 , V_141 ) ;
}
...
{
static const unsigned long V_144 [] = {
V_77 | V_78 | V_79 ,
V_80 | V_81 ,
V_82 | V_83 ,
} ;
...
int V_140 , V_141 , V_145 = 0 , V_146 = 0 ;
struct V_73 V_12 = {
. V_22 = & V_147 ,
. V_88 = 48 ,
} ;
for ( V_140 = 0 ; V_140 < F_46 ( V_144 ) ; ++ V_140 ) {
for ( V_141 = 0 ; V_141 < F_46 ( V_86 ) ; ++ V_141 ) {
V_12 . V_28 = V_144 [ V_140 ] ;
V_12 . V_86 = V_86 [ V_141 ] ;
F_53 ( L_4 ,
V_144 [ V_140 ] , V_86 [ V_141 ] ) ;
if ( F_45 ( & V_12 ) )
V_146 ++ ;
else
V_145 ++ ;
...
F_53 ( L_5 , V_145 , V_146 ) ;
return V_146 ? - V_148 : 0 ;
}
