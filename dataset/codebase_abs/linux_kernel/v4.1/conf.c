...
while ( ( V_51 = F_36 ( V_49 , V_50 , L_50 , V_58 , NULL ) ) != - 1 ) {
if ( V_51 == 's' ) {
F_37 ( NULL ) ;
continue;
}
...
if ( ! V_24 )
break;
if ( ( strcmp ( V_24 , L_10 ) != 0 ) && ( strcmp ( V_24 , L_60 ) != 0 ) ) {
if ( F_43 ( V_24 , V_78 ) ) {
fprintf ( V_72 ,
_ ( L_61 ) ,
V_24 ) ;
...
switch ( V_12 ) {
case V_73 : V_24 = L_62 ; break;
case V_74 : V_24 = L_63 ; break;
case V_75 : V_24 = L_64 ; break;
case V_76 : V_24 = L_65 ; break;
case V_63 : V_24 = L_66 ; break;
default: break;
}
if ( F_43 ( V_24 , V_78 ) &&
F_43 ( L_67 , V_78 ) ) {
