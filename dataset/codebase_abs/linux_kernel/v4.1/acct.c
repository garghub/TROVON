...
V_64 -> V_89 = F_53 ( F_64 ( F_65 ( V_66 -> V_89 ) ) ) ;
V_64 -> V_90 = F_53 ( F_64 ( F_65 ( V_66 -> V_90 ) ) ) ;
V_64 -> V_91 = V_66 -> V_91 ;
...
goto V_6;
F_56 ( & V_64 ) ;
V_64 . V_104 = F_68 ( V_7 -> V_103 -> V_105 , V_98 -> V_106 ) ;
V_64 . V_107 = F_69 ( V_7 -> V_103 -> V_105 , V_98 -> V_108 ) ;
#if V_72 == 1 || V_72 == 2
...
V_64 . V_111 = F_70 ( V_40 , V_25 ) ;
F_13 () ;
V_64 . V_112 = F_70 ( F_71 ( V_40 -> V_113 ) ,
V_25 ) ;
F_15 () ;
}
#endif
if ( F_72 ( V_7 ) ) {
T_6 V_114 = 0 ;
F_73 ( V_7 , ( char * ) & V_64 , sizeof( T_5 ) , & V_114 ) ;
F_74 ( V_7 ) ;
}
V_6:
...
void F_76 ( long V_115 , int V_116 )
{
struct V_65 * V_66 = & V_40 -> signal -> V_66 ;
T_7 V_117 , V_118 ;
