...
static void F_126 ( struct V_5 * V_6 , int V_107 )
{
struct V_1 * V_2 = V_6 -> V_2 ;
struct V_20 * V_21 = V_6 -> V_21 ;
struct V_14 * V_15 = V_6 -> V_15 ;
...
F_130 ( & V_2 -> V_115 ) ;
F_131 ( V_2 ) ;
F_132 ( V_2 -> V_116 , & V_2 -> V_117 ) ;
} else
F_133 ( & V_2 -> V_115 ) ;
F_134 ( & V_2 -> V_42 , V_118 ) ;
break;
}
}
...
break;
F_33 ( & V_2 -> V_54 , V_53 ) ;
V_123 = V_2 -> V_10 . V_123 ;
F_34 ( & V_2 -> V_54 , V_53 ) ;
if ( V_123 != & V_2 -> V_10 ) {
V_6 = F_140 ( V_123 , struct V_5 , V_9 ) ;
if ( F_136 ( V_6 ) != V_119 )
F_69 ( V_2 ) ;
}
}
...
{
struct V_124 * V_125 ;
V_125 = F_142 ( F_137 , V_2 , L_29 ,
F_143 ( & V_2 -> V_110 -> V_41 ) ) ;
if ( F_76 ( V_125 ) ) {
F_116 ( & V_2 -> V_110 -> V_41 ,
L_30 ) ;
return F_144 ( V_125 ) ;
...
F_70 ( & V_2 -> V_24 , V_53 ) ;
F_4 (port, &adapter->port_list, list)
F_23 ( V_126 , & V_21 -> V_12 ) ;
F_73 ( & V_2 -> V_24 , V_53 ) ;
F_148 ( V_2 -> V_22 -> V_23 , V_53 ) ;
F_15 (sdev, adapter->scsi_host)
F_23 ( V_126 , & F_11 ( V_15 ) -> V_12 ) ;
