...
if ( error )
goto V_168;
V_13 -> V_251 = F_82 ( V_230 , L_38 ) ;
if ( F_54 ( V_13 -> V_251 ) ) {
error = F_55 ( V_13 -> V_251 ) ;
F_41 ( V_13 , L_39 , error ) ;
goto V_252;
}
V_13 -> V_253 = F_82 ( V_230 , L_40 ) ;
if ( F_54 ( V_13 -> V_253 ) ) {
...
V_13 -> V_255 = 0 ;
V_13 -> V_256 = F_82 ( V_230 , L_42 ) ;
if ( F_54 ( V_13 -> V_256 ) ) {
error = F_55 ( V_13 -> V_256 ) ;
F_41 ( V_13 , L_43 , error ) ;
goto V_257;
}
F_93 ( & V_13 -> V_256 -> V_258 ,
& V_259 ) ;
error = F_94 ( V_13 ) ;
if ( error )
goto V_250;
...
V_13 -> V_263 = F_82 ( V_261 , V_86 ) ;
if ( F_54 ( V_13 -> V_263 ) ) {
error = F_55 ( V_13 -> V_263 ) ;
F_41 ( V_13 , L_47 , error ) ;
goto V_168;
}
sprintf ( V_86 , L_48 , V_13 -> V_236 -> V_220 ) ;
V_13 -> V_264 = F_82 ( V_261 , V_86 ) ;
if ( F_54 ( V_13 -> V_264 ) ) {
...
struct V_272 * V_273 = & V_13 -> V_198 ;
struct V_274 * args = & V_13 -> V_152 ;
...
V_273 -> V_199 = V_271 ;
V_273 -> V_246 = 1 ;
for ( V_276 = args -> V_280 ; ( V_275 = F_100 ( & V_276 , L_56 ) ) ; ) {
T_3 V_281 [ V_282 ] ;
int V_283 , V_284 ;
if ( ! V_275 || ! * V_275 )
continue;
V_283 = F_101 ( V_275 , * V_271 -> V_285 , V_281 ) ;
switch ( V_283 ) {
case V_286 :
V_188 = F_102 ( & V_281 [ 0 ] , & V_284 ) ;
if ( V_188 || V_284 < 0 )
goto V_287;
...
{
const struct V_270 * V_271 = V_13 -> V_198 . V_199 ;
if ( F_105 ( ! F_106 ( V_293 , & V_13 -> V_22 ) ) &&
V_271 -> V_294 )
V_271 -> V_294 ( V_13 ) ;
}
static int F_107 ( struct V_10 * V_13 )
{
if ( V_13 -> V_198 . V_199 -> V_292 == NULL )
return 0 ;
return F_108 ( & V_13 -> V_22 , V_21 , V_295 )
? - V_296 : 0 ;
}
...
char V_297 [ 20 ] ;
char V_298 [ 20 ] ;
char * V_197 [] = { V_297 , V_298 , NULL } ;
sprintf ( V_297 , L_60 , ( V_12 -> V_299 & V_300 ) ? 1 : 0 ) ;
sprintf ( V_298 , L_61 , V_13 -> V_152 . V_235 ? 1 : 0 ) ;
F_64 ( & V_13 -> V_201 , V_301 , V_197 ) ;
}
static int F_110 ( struct V_11 * V_12 , struct V_274 * args , int V_71 )
{
struct V_10 * V_13 ;
struct V_159 V_160 ;
int error ;
...
F_111 ( V_12 ) -> V_49 |= V_322 ;
V_12 -> V_323 = 1 ;
V_12 -> V_324 = V_325 ;
V_13 -> V_73 . V_95 = F_112 ( V_12 , V_326 ) ;
V_13 -> V_73 . V_96 = V_12 -> V_327 ;
V_13 -> V_124 = V_13 -> V_73 . V_96 -
V_125 ;
V_13 -> V_126 = 1 << V_13 -> V_124 ;
V_13 -> V_23 . V_328 = V_13 -> V_152 . V_329 ;
V_13 -> V_23 . V_330 = V_13 -> V_152 . V_331 ;
if ( V_13 -> V_152 . V_332 ) {
V_13 -> V_23 . V_333 = 0 ;
V_13 -> V_23 . V_334 = V_13 -> V_152 . V_332 ;
} else {
V_13 -> V_23 . V_333 = 1 ;
V_13 -> V_23 . V_334 = 30 ;
}
...
snprintf ( V_13 -> V_335 , V_157 , L_63 , V_13 -> V_158 ) ;
error = F_114 ( V_13 ) ;
if ( error )
return error ;
F_115 ( V_13 ) ;
...
if ( V_13 -> V_152 . V_235 )
snprintf ( V_13 -> V_335 , V_157 , L_64 ,
V_13 -> V_158 ) ;
else
snprintf ( V_13 -> V_335 , V_157 , L_65 ,
...
static int F_121 ( struct V_11 * V_87 , void * V_342 )
{
V_87 -> V_47 = V_342 ;
V_87 -> V_343 = V_87 -> V_47 -> V_344 ;
V_87 -> V_345 = & F_122 ( V_87 -> V_47 ) -> V_346 ;
return 0 ;
}
static int F_123 ( struct V_11 * V_87 , void * V_347 )
{
struct V_348 * V_349 = V_347 ;
return ( V_349 == V_87 -> V_47 ) ;
}
static struct V_182 * F_124 ( struct V_350 * V_351 , int V_49 ,
...
V_87 = F_127 ( V_351 , F_123 , F_121 , V_49 , V_349 ) ;
F_76 ( & V_349 -> V_357 ) ;
error = F_55 ( V_87 ) ;
if ( F_54 ( V_87 ) )
goto V_360;
...
if ( V_87 -> V_194 ) {
error = - V_359 ;
if ( ( V_49 ^ V_87 -> V_299 ) & V_300 )
goto V_368;
} else {
char V_369 [ V_370 ] ;
V_87 -> V_371 = V_353 ;
F_46 ( V_87 -> V_155 , F_132 ( V_349 , V_369 ) , sizeof( V_87 -> V_155 ) ) ;
F_59 ( V_87 , F_133 ( V_349 ) ) ;
error = F_110 ( V_87 , & args , V_49 & V_372 ? 1 : 0 ) ;
if ( error )
goto V_368;
V_87 -> V_299 |= V_373 ;
V_349 -> V_374 = V_87 ;
...
static int F_136 ( struct V_11 * V_87 , void * V_347 )
{
return - V_78 ;
}
static struct V_182 * F_137 ( struct V_350 * V_351 ,
int V_49 , const char * V_352 , void * V_342 )
{
struct V_11 * V_87 ;
struct V_10 * V_13 ;
struct V_375 V_375 ;
int error ;
error = F_138 ( V_352 , V_376 , & V_375 ) ;
if ( error ) {
F_17 ( L_69 ,
V_352 , error ) ;
return F_135 ( error ) ;
}
V_87 = F_127 ( & V_377 , F_123 , F_136 , V_49 ,
F_81 ( V_375 . V_182 ) -> V_378 -> V_47 ) ;
F_139 ( & V_375 ) ;
if ( F_54 ( V_87 ) ) {
F_17 ( L_70 ) ;
return F_126 ( V_87 ) ;
