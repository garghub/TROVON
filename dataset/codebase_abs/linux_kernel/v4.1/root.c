...
V_7 = F_15 ( V_27 ) ;
V_8 = V_3 ;
if ( ! F_16 ( V_28 ) && ! F_17 ( V_24 ) )
return F_18 ( - V_29 ) ;
if ( ! F_19 ( V_7 -> V_30 , V_28 ) )
return F_18 ( - V_29 ) ;
}
V_2 = F_20 ( V_24 , F_1 , F_2 , V_21 , V_7 ) ;
if ( F_21 ( V_2 ) )
return F_22 ( V_2 ) ;
if ( ! F_5 ( V_8 , V_7 ) ) {
F_23 ( V_2 ) ;
...
static int F_42 ( struct V_40 * V_41 , struct V_22 * V_22 , struct V_42 * V_43
)
{
F_43 ( F_44 ( V_22 ) , V_43 ) ;
V_43 -> V_44 = V_45 . V_44 + F_45 () ;
return 0 ;
}
static struct V_22 * F_46 ( struct V_46 * V_47 , struct V_22 * V_22 , unsigned int V_21 )
{
if ( ! F_47 ( V_47 , V_22 , V_21 ) )
return NULL ;
return F_48 ( V_47 , V_22 , V_21 ) ;
}
static int F_49 ( struct V_48 * V_48 , struct V_49 * V_50 )
{
if ( V_50 -> V_51 < V_52 ) {
int error = F_50 ( V_48 , V_50 ) ;
if ( F_51 ( error <= 0 ) )
return error ;
V_50 -> V_51 = V_52 ;
}
return F_52 ( V_48 , V_50 ) ;
}
