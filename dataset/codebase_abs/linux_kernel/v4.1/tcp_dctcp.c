...
static T_3 F_18 ( struct V_9 * V_10 , T_1 V_46 , int * V_47 ,
union V_48 * V_49 )
{
const struct V_3 * V_4 = F_4 ( V_10 ) ;
if ( V_46 & ( 1 << ( V_50 - 1 ) ) ||
V_46 & ( 1 << ( V_51 - 1 ) ) ) {
memset ( V_49 , 0 , sizeof( struct V_52 ) ) ;
if ( F_6 ( V_10 ) -> V_25 != & V_26 ) {
V_49 -> V_3 . V_53 = 1 ;
V_49 -> V_3 . V_54 = ( V_55 ) V_4 -> V_24 ;
V_49 -> V_3 . V_20 = V_4 -> V_20 ;
V_49 -> V_3 . V_56 = V_4 -> V_7 ;
V_49 -> V_3 . V_57 = V_4 -> V_8 ;
}
* V_47 = V_50 ;
return sizeof( * V_49 ) ;
}
