...
{
struct V_7 * V_68 = V_75 -> V_78 ;
F_46 ( F_47 ( V_75 ) , V_77 ) ;
V_77 -> V_70 = ( V_68 -> V_41 / 512 ) * F_44 ( V_68 , V_77 -> V_69 ) ;
V_77 -> V_79 = V_68 -> V_41 ;
return 0 ;
}
static int F_48 ( struct V_80 * V_80 , struct V_81 * V_82 )
{
return F_49 ( V_80 , F_30 , V_82 ) ;
}
static int F_50 ( struct V_83 * V_83 , struct V_80 * V_80 )
{
return F_51 ( V_80 , F_30 ) ;
}
int F_52 ( struct V_80 * V_80 , T_4 V_84 , unsigned V_85 )
{
return F_53 ( V_80 , V_84 , V_85 , F_30 ) ;
}
static void F_54 ( struct V_86 * V_87 , T_4 V_26 )
{
...
static int F_56 ( struct V_83 * V_83 , struct V_86 * V_87 ,
T_4 V_84 , unsigned V_85 , unsigned V_89 ,
struct V_80 * * V_90 , void * * V_91 )
{
int V_92 ;
V_92 = F_57 ( V_87 , V_84 , V_85 , V_89 , V_90 , F_30 ) ;
if ( F_58 ( V_92 ) )
F_54 ( V_87 , V_84 + V_85 ) ;
return V_92 ;
}
static T_3 F_59 ( struct V_86 * V_87 , T_3 V_4 )
{
return F_60 ( V_87 , V_4 , F_30 ) ;
}
