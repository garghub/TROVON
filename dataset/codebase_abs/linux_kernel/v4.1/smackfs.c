...
V_173 = F_14 ( V_55 , V_63 ) ;
F_17 ( V_55 ) ;
return V_25 ;
}
static T_1 F_84 ( struct V_61 * V_162 , char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
char V_163 [ 32 ] ;
T_1 V_25 ;
...
{
struct V_175 * V_176 = F_87 () ;
return F_23 ( V_76 , V_77 , & V_176 -> V_73 ) ;
}
static void * F_88 ( struct V_75 * V_76 , void * V_82 , T_4 * V_77 )
{
struct V_175 * V_176 = F_87 () ;
return F_25 ( V_76 , V_82 , V_77 , & V_176 -> V_73 ) ;
}
...
static int F_90 ( struct V_85 * V_85 , struct V_61 * V_61 )
{
return F_36 ( V_61 , & V_177 ) ;
}
static T_1 F_91 ( struct V_61 * V_61 , const char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
struct V_175 * V_176 = F_87 () ;
return F_20 ( V_61 , V_62 , V_63 , V_64 , & V_176 -> V_73 ,
& V_176 -> V_74 , V_67 ) ;
}
...
if ( V_63 < V_69 )
return - V_53 ;
V_178 = F_18 ( V_55 , & V_50 , 0 ) ;
} else {
V_178 = F_19 ( V_55 , & V_50 , 0 , 3 ) ;
}
if ( V_178 >= 0 )
V_178 = V_28 ( V_50 . V_27 , V_50 . V_26 ,
V_50 . V_29 , NULL ) ;
else if ( V_178 != - V_54 )
return - V_53 ;
V_55 [ 0 ] = V_178 >= 0 ? '1' : '0' ;
...
struct V_22 * V_23 =
F_34 ( V_34 , struct V_22 , V_34 ) ;
F_28 ( V_76 , V_23 -> V_35 , V_179 ) ;
return 0 ;
}
static int F_99 ( struct V_85 * V_85 , struct V_61 * V_61 )
{
...
struct V_20 * V_14 =
F_34 ( V_34 , struct V_20 , V_34 ) ;
F_28 ( V_76 , V_14 , V_179 ) ;
return 0 ;
}
static int F_104 ( struct V_85 * V_85 , struct V_61 * V_61 )
{
return F_36 ( V_61 , & V_181 ) ;
}
...
T_3 V_63 , T_4 * V_64 )
{
return F_92 ( V_61 , V_62 , V_63 , V_64 , V_130 ) ;
}
...
V_184 = F_14 ( V_55 , V_63 ) ;
}
F_17 ( V_55 ) ;
return V_25 ;
}
static T_1 F_113 ( struct V_61 * V_162 , char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
char V_163 [ 32 ] ;
T_1 V_25 ;
...
if ( sscanf ( V_163 , L_9 , & V_60 ) != 1 )
return - V_53 ;
if ( V_60 < V_187 || V_60 > V_188 )
return - V_53 ;
V_186 = V_60 ;
return V_63 ;
}
static int F_115 ( struct V_189 * V_190 , void * V_55 , int V_191 )
{
int V_25 ;
struct V_85 * V_192 ;
static struct V_193 V_194 [] = {
[ V_195 ] = {
L_17 , & V_196 , V_197 | V_198 } ,
[ V_199 ] = {
L_18 , & V_200 , V_197 | V_198 } ,
[ V_201 ] = {
L_19 , & V_202 , V_197 | V_198 } ,
[ V_203 ] = {
L_20 , & V_204 , V_197 | V_198 } ,
[ V_205 ] = {
L_21 , & V_206 , V_197 | V_198 } ,
[ V_207 ] = {
L_22 , & V_208 , V_197 | V_198 } ,
[ V_209 ] = {
L_23 , & V_210 , V_197 | V_198 } ,
[ V_211 ] = {
L_24 , & V_212 , V_197 | V_198 } ,
[ V_213 ] = {
L_25 , & V_214 , V_197 | V_215 } ,
[ V_216 ] = {
L_26 , & V_217 , V_197 | V_215 } ,
[ V_218 ] = {
L_27 , & V_219 , V_197 | V_198 } ,
[ V_220 ] = {
L_28 , & V_221 , V_197 | V_198 } ,
[ V_222 ] = {
L_29 , & V_223 , V_197 | V_215 } ,
[ V_224 ] = {
L_30 , & V_225 , V_197 | V_215 } ,
[ V_226 ] = {
L_31 , & V_227 , V_197 | V_198 } ,
[ V_228 ] = {
L_32 , & V_229 ,
V_197 | V_198 } ,
[ V_230 ] = {
L_33 , & V_231 , V_197 | V_198 } ,
[ V_232 ] = {
L_34 , & V_233 , V_197 | V_198 } ,
[ V_234 ] = {
L_35 , & V_235 , V_197 | V_198 } ,
#ifdef F_116
[ V_236 ] = {
L_36 , & V_237 , V_197 | V_198 } ,
#endif
{ L_14 }
} ;
V_25 = F_117 ( V_190 , V_238 , V_194 ) ;
if ( V_25 != 0 ) {
F_41 ( V_239 L_37 ,
V_94 , V_25 ) ;
return V_25 ;
}
V_192 = F_118 ( V_190 -> V_240 ) ;
return 0 ;
}
static struct V_241 * F_119 ( struct V_242 * V_243 ,
int V_244 , const char * V_245 , void * V_55 )
{
return F_120 ( V_243 , V_244 , V_55 , F_115 ) ;
}
static int T_7 F_121 ( struct V_6 * V_7 )
{
V_7 -> V_110 . V_246 = V_7 -> V_84 ;
V_7 -> V_110 . V_244 =
V_247 | V_248 ;
