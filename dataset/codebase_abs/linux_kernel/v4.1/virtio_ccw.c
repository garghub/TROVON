...
static int F_113 ( struct V_143 * V_40 , int V_173 )
{
int V_17 ;
struct V_1 * V_36 = F_85 ( & V_40 -> V_63 ) ;
if ( ! V_36 )
...
static int T_11 F_114 ( char * * V_176 , unsigned int * V_177 , int V_178 ,
int V_179 , int V_180 )
{
int V_181 ;
V_181 = 0 ;
...
static int T_11 F_116 ( char * V_183 , unsigned int * V_184 ,
...
goto V_99;
V_185 = V_183 ;
V_39 = F_114 ( & V_185 , V_184 , 1 , 2 , V_186 ) ;
if ( V_39 || ( V_185 [ 0 ] != '.' ) )
goto V_99;
V_185 ++ ;
V_39 = F_114 ( & V_185 , V_156 , 1 , 1 , V_187 ) ;
if ( V_39 || ( V_185 [ 0 ] != '.' ) )
goto V_99;
V_185 ++ ;
V_39 = F_114 ( & V_185 , V_154 , 4 , 4 , V_188 ) ;
if ( V_39 || ( V_185 [ 0 ] != '\0' ) )
goto V_99;
V_17 = 0 ;
V_99:
...
int V_17 ;
V_183 = V_196 ;
while ( ( V_195 = F_118 ( & V_183 , L_20 ) ) ) {
V_17 = F_116 ( F_118 ( & V_195 , L_21 ) , & V_189 ,
& V_191 , & V_193 ) ;
if ( V_17 )
continue;
if ( V_195 != NULL ) {
V_17 = F_116 ( V_195 , & V_190 ,
& V_192 , & V_194 ) ;
if ( ( V_191 > V_192 ) ||
