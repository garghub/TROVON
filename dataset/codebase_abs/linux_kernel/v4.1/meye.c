...
V_142 -> V_146 = V_147 |
V_148 ;
V_142 -> V_149 = V_142 -> V_146 | V_150 ;
return 0 ;
}
static int F_73 ( struct V_115 * V_115 , void * V_135 , struct V_151 * V_6 )
{
if ( V_6 -> V_152 != 0 )
return - V_124 ;
strcpy ( V_6 -> V_153 , L_10 ) ;
V_6 -> type = V_154 ;
return 0 ;
}
...
static int F_76 ( struct V_155 * V_156 )
{
F_63 ( & V_7 . V_128 ) ;
switch ( V_156 -> V_157 ) {
case V_158 :
F_64 (
V_159 , V_156 -> V_160 ) ;
V_7 . V_161 = V_156 -> V_160 << 10 ;
break;
case V_162 :
F_64 (
V_163 , V_156 -> V_160 ) ;
V_7 . V_164 = V_156 -> V_160 << 10 ;
break;
case V_165 :
F_64 (
V_166 , V_156 -> V_160 ) ;
V_7 . V_167 = V_156 -> V_160 << 10 ;
break;
case V_168 :
F_64 (
V_169 , V_156 -> V_160 ) ;
V_7 . V_170 = V_156 -> V_160 << 10 ;
break;
case V_171 :
F_64 (
V_130 , V_156 -> V_160 ) ;
V_7 . V_25 . V_126 = V_156 -> V_160 ;
break;
case V_172 :
F_64 (
V_129 , V_156 -> V_160 ) ;
V_7 . V_25 . V_125 = V_156 -> V_160 ;
break;
case V_173 :
F_64 (
V_131 , V_156 -> V_160 ) ;
V_7 . V_25 . V_127 = V_156 -> V_160 ;
break;
case V_174 :
V_7 . V_25 . V_21 = V_156 -> V_160 ;
break;
case V_175 :
V_7 . V_25 . V_48 = V_156 -> V_160 ;
break;
default:
F_65 ( & V_7 . V_128 ) ;
return - V_124 ;
...
if ( V_177 -> V_152 == 0 ) {
V_177 -> V_178 = 0 ;
strcpy ( V_177 -> V_179 , L_11 ) ;
V_177 -> V_180 = V_181 ;
} else {
V_177 -> V_178 = V_182 ;
strcpy ( V_177 -> V_179 , L_12 ) ;
V_177 -> V_180 = V_183 ;
}
return 0 ;
}
...
struct V_184 * V_177 )
{
if ( V_177 -> V_185 . V_186 . V_180 != V_181 &&
V_177 -> V_185 . V_186 . V_180 != V_183 )
return - V_124 ;
if ( V_177 -> V_185 . V_186 . V_187 != V_188 &&
V_177 -> V_185 . V_186 . V_187 != V_189 )
return - V_124 ;
V_177 -> V_185 . V_186 . V_187 = V_189 ;
if ( V_177 -> V_185 . V_186 . V_190 <= 320 ) {
V_177 -> V_185 . V_186 . V_190 = 320 ;
V_177 -> V_185 . V_186 . V_191 = 240 ;
} else {
V_177 -> V_185 . V_186 . V_190 = 640 ;
V_177 -> V_185 . V_186 . V_191 = 480 ;
}
V_177 -> V_185 . V_186 . V_192 = V_177 -> V_185 . V_186 . V_190 * 2 ;
V_177 -> V_185 . V_186 . V_193 = V_177 -> V_185 . V_186 . V_191 *
V_177 -> V_185 . V_186 . V_192 ;
V_177 -> V_185 . V_186 . V_194 = 0 ;
return 0 ;
}
...
V_177 -> V_185 . V_186 . V_187 = V_189 ;
V_177 -> V_185 . V_186 . V_190 = F_20 () ;
V_177 -> V_185 . V_186 . V_191 = F_21 () ;
V_177 -> V_185 . V_186 . V_192 = V_177 -> V_185 . V_186 . V_190 * 2 ;
V_177 -> V_185 . V_186 . V_193 = V_177 -> V_185 . V_186 . V_191 *
V_177 -> V_185 . V_186 . V_192 ;
return 0 ;
...
switch ( V_177 -> V_185 . V_186 . V_180 ) {
case V_181 :
V_7 . V_71 = V_91 ;
break;
case V_183 :
...
return - V_124 ;
if ( V_7 . V_105 && V_196 -> V_199 == V_133 ) {
return 0 ;
}
F_63 ( & V_7 . V_128 ) ;
if ( V_7 . V_105 ) {
...
V_133 = F_82 ( 2 , F_83 ( ( int ) V_196 -> V_199 , V_119 ) ) ;
V_196 -> V_199 = V_133 ;
...
static int F_84 ( struct V_115 * V_115 , void * V_135 , struct V_202 * V_17 )
{
unsigned int V_152 = V_17 -> V_152 ;
if ( V_152 >= V_133 )
return - V_124 ;
V_17 -> V_203 = V_7 . V_107 [ V_152 ] . V_1 ;
V_17 -> V_178 = V_204 | V_205 ;
if ( V_7 . V_107 [ V_152 ] . V_108 == V_134 )
V_17 -> V_178 |= V_206 ;
if ( V_7 . V_107 [ V_152 ] . V_108 == V_109 )
V_17 -> V_178 |= V_207 ;
V_17 -> V_187 = V_189 ;
V_17 -> V_110 = V_7 . V_107 [ V_152 ] . V_110 ;
V_17 -> V_98 = V_7 . V_107 [ V_152 ] . V_98 ;
V_17 -> V_197 = V_198 ;
V_17 -> V_208 . V_209 = V_152 * V_106 ;
V_17 -> V_20 = V_106 ;
return 0 ;
}
static int F_85 ( struct V_115 * V_115 , void * V_135 , struct V_202 * V_17 )
{
if ( V_17 -> V_197 != V_198 )
return - V_124 ;
if ( V_17 -> V_152 >= V_133 )
return - V_124 ;
if ( V_7 . V_107 [ V_17 -> V_152 ] . V_108 != V_120 )
return - V_124 ;
F_63 ( & V_7 . V_128 ) ;
V_17 -> V_178 |= V_206 ;
V_17 -> V_178 &= ~ V_207 ;
V_7 . V_107 [ V_17 -> V_152 ] . V_108 = V_134 ;
F_52 ( & V_7 . V_103 , ( unsigned char * ) & V_17 -> V_152 ,
sizeof( int ) , & V_7 . V_104 ) ;
F_65 ( & V_7 . V_128 ) ;
return 0 ;
}
static int F_86 ( struct V_115 * V_115 , void * V_135 , struct V_202 * V_17 )
{
int V_97 ;
if ( V_17 -> V_197 != V_198 )
return - V_124 ;
...
V_17 -> V_152 = V_97 ;
V_17 -> V_203 = V_7 . V_107 [ V_97 ] . V_1 ;
V_17 -> V_178 = V_204 | V_205 ;
V_17 -> V_187 = V_189 ;
V_17 -> V_110 = V_7 . V_107 [ V_97 ] . V_110 ;
V_17 -> V_98 = V_7 . V_107 [ V_97 ] . V_98 ;
V_17 -> V_197 = V_198 ;
V_17 -> V_208 . V_209 = V_97 * V_106 ;
V_17 -> V_20 = V_106 ;
V_7 . V_107 [ V_97 ] . V_108 = V_120 ;
F_65 ( & V_7 . V_128 ) ;
return 0 ;
}
static int F_88 ( struct V_115 * V_115 , void * V_135 , enum V_210 V_6 )
{
F_63 ( & V_7 . V_128 ) ;
switch ( V_7 . V_71 ) {
case V_91 :
...
static int F_89 ( struct V_115 * V_115 , void * V_135 , enum V_210 V_6 )
{
F_63 ( & V_7 . V_128 ) ;
F_37 () ;
F_57 ( & V_7 . V_103 ) ;
...
static long F_90 ( struct V_115 * V_115 , void * V_135 , bool V_211 ,
unsigned int V_212 , void * V_213 )
{
switch ( V_212 ) {
case V_214 :
return F_61 ( (struct V_121 * ) V_213 ) ;
case V_215 :
return F_62 ( (struct V_121 * ) V_213 ) ;
case V_216 :
return F_66 ( ( int * ) V_213 ) ;
case V_217 :
return F_67 ( V_115 , V_135 , ( int * ) V_213 ) ;
case V_218 :
return F_69 () ;
case V_219 :
return F_70 ( ( int * ) V_213 ) ;
default:
return - V_220 ;
}
}
static unsigned int F_91 ( struct V_115 * V_115 , T_6 * V_221 )
{
unsigned int V_222 = F_92 ( V_115 , V_221 ) ;
F_63 ( & V_7 . V_128 ) ;
F_93 ( V_115 , & V_7 . V_113 , V_221 ) ;
if ( F_87 ( & V_7 . V_111 ) )
V_222 |= V_223 | V_224 ;
F_65 ( & V_7 . V_128 ) ;
return V_222 ;
}
static void F_94 ( struct V_225 * V_226 )
{
long V_227 = ( long ) V_226 -> V_228 ;
V_7 . V_200 [ V_227 ] ++ ;
}
static void F_95 ( struct V_225 * V_226 )
{
long V_227 = ( long ) V_226 -> V_228 ;
V_7 . V_200 [ V_227 ] -- ;
}
static int F_96 ( struct V_115 * V_115 , struct V_225 * V_226 )
{
unsigned long V_18 = V_226 -> V_229 ;
unsigned long V_1 = V_226 -> V_230 - V_226 -> V_229 ;
unsigned long V_209 = V_226 -> V_231 << V_232 ;
...
V_234 = ( unsigned long ) V_7 . V_105 + V_209 ;
while ( V_1 > 0 ) {
V_233 = F_97 ( ( void * ) V_234 ) ;
if ( F_98 ( V_226 , V_18 , V_233 , V_4 , V_235 ) ) {
F_65 ( & V_7 . V_128 ) ;
return - V_139 ;
}
V_18 += V_4 ;
...
V_226 -> V_236 = & V_237 ;
V_226 -> V_238 &= ~ V_239 ;
V_226 -> V_238 |= V_240 | V_241 ;
V_226 -> V_228 = ( void * ) ( V_209 / V_106 ) ;
F_94 ( V_226 ) ;
F_65 ( & V_7 . V_128 ) ;
return 0 ;
}
static int F_99 ( struct V_242 * V_243 , T_7 V_108 )
{
F_100 ( V_243 ) ;
V_7 . V_244 = V_7 . V_71 ;
F_37 () ;
...
static int F_101 ( struct V_242 * V_243 )
{
F_102 ( V_243 ) ;
F_103 ( V_7 . V_9 , V_245 , 1 ) ;
F_28 ( V_74 , 0 ) ;
F_28 ( V_38 , V_46 ) ;
F_38 ( 1 ) ;
F_25 ( V_246 , 1 ) ;
...
static int F_104 ( struct V_242 * V_249 , const struct V_250 * V_251 )
{
static const struct V_252 V_253 = {
. V_157 = V_171 ,
. type = V_254 ,
. V_255 = & V_256 ,
. V_153 = L_16 ,
...
static const struct V_252 V_260 = {
. V_157 = V_173 ,
. type = V_254 ,
. V_255 = & V_256 ,
. V_153 = L_17 ,
...
static const struct V_252 V_261 = {
. V_157 = V_175 ,
. type = V_254 ,
. V_255 = & V_256 ,
. V_153 = L_18 ,
...
V_7 . V_269 = V_270 ;
V_7 . V_269 . V_263 = & V_7 . V_263 ;
V_264 = - V_271 ;
if ( ( V_264 = F_64 ( V_272 , 1 ) ) ) {
F_106 ( V_263 , L_23 ) ;
F_106 ( V_263 , L_24
L_25 ) ;
goto V_273;
}
if ( ( V_264 = F_110 ( V_7 . V_9 ) ) ) {
F_106 ( V_263 , L_26 ) ;
goto V_274;
}
V_265 = F_111 ( V_7 . V_9 , 0 ) ;
if ( ! V_265 ) {
F_106 ( V_263 , L_27 ) ;
goto V_275;
}
...
V_7 . V_31 = F_114 ( V_265 , V_276 ) ;
if ( ! V_7 . V_31 ) {
F_106 ( V_263 , L_29 ) ;
goto V_277;
}
V_7 . V_278 = V_249 -> V_95 ;
if ( F_115 ( V_7 . V_278 , F_49 ,
V_279 , L_8 , F_49 ) ) {
F_106 ( V_263 , L_30 ) ;
goto V_280;
}
F_116 ( V_7 . V_9 , V_281 , 8 ) ;
F_116 ( V_7 . V_9 , V_282 , 64 ) ;
F_117 ( V_7 . V_9 ) ;
F_103 ( V_7 . V_9 , V_245 , 1 ) ;
F_28 ( V_74 , 0 ) ;
F_28 ( V_38 , V_46 ) ;
...
F_121 ( & V_7 . V_283 , & V_256 ,
V_168 , 0 , 63 , 1 , 32 ) ;
F_122 ( & V_7 . V_283 , & V_253 , NULL ) ;
F_121 ( & V_7 . V_283 , & V_256 ,
V_172 , 0 , 63 , 1 , 32 ) ;
F_122 ( & V_7 . V_283 , & V_260 , NULL ) ;
F_121 ( & V_7 . V_283 , & V_256 ,
V_174 , 0 , 10 , 1 , 8 ) ;
F_122 ( & V_7 . V_283 , & V_261 , NULL ) ;
if ( V_7 . V_283 . error ) {
F_106 ( V_263 , L_31 ) ;
goto V_284;
}
F_123 ( & V_7 . V_283 ) ;
V_7 . V_269 . V_285 = & V_7 . V_283 ;
if ( F_124 ( & V_7 . V_269 , V_286 ,
V_287 ) < 0 ) {
F_106 ( V_263 , L_32 ) ;
goto V_284;
}
...
V_288 ) ;
F_125 ( V_263 , L_34 ,
V_7 . V_9 -> V_289 , V_265 , V_7 . V_278 ) ;
return 0 ;
V_284:
F_126 ( & V_7 . V_283 ) ;
F_127 ( V_7 . V_278 , F_49 ) ;
V_280:
F_128 ( V_7 . V_31 ) ;
V_277:
F_129 ( F_111 ( V_7 . V_9 , 0 ) ,
F_113 ( V_7 . V_9 , 0 ) ) ;
V_275:
F_130 ( V_7 . V_9 ) ;
V_274:
...
static void F_132 ( struct V_242 * V_249 )
{
F_133 ( & V_7 . V_269 ) ;
F_37 () ;
F_36 () ;
