...
{
int V_13 = V_14 ;
struct V_15 * V_16 = & V_2 -> V_5 [ V_13 - 1 ] . V_11 ;
struct V_15 * V_17 = & V_2 -> V_5 [ V_4 ] . V_11 ;
while ( V_13 > 0 && ( F_2 ( & V_2 -> V_5 [ V_4 ] , V_17 -> V_8 ) >
F_2 ( & V_2 -> V_5 [ V_12 [ V_13 - 1 ] ] , V_16 -> V_8 ) ) ) {
V_13 -- ;
V_16 = & V_2 -> V_5 [ V_12 [ V_13 - 1 ] ] . V_11 ;
}
if ( V_13 < V_14 - 1 )
memmove ( & V_12 [ V_13 + 1 ] , & V_12 [ V_13 ] , V_14 - ( V_13 + 1 ) ) ;
if ( V_13 < V_14 )
V_12 [ V_13 ] = V_4 ;
}
static void
...
struct V_15 * V_39 = & V_2 -> V_5 [ V_4 ] . V_11 ;
struct V_15 * V_16 = & V_2 -> V_5 [ V_51 ] . V_11 ;
F_10 ( V_39 ) ;
...
struct V_15 * V_39 = & V_2 -> V_5 [ V_119 ] . V_11 ;
...
int V_21 = V_2 -> V_32 [ 0 ] ;
int V_52 ;
V_16 = & V_2 -> V_5 [ V_21 ] . V_11 ;
V_52 = F_2 ( & V_2 -> V_5 [ V_21 ] , V_16 -> V_8 ) ;
