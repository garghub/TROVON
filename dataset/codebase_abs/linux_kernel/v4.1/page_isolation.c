...
int F_28 ( unsigned long V_12 , unsigned long V_29 ,
unsigned V_18 )
{
unsigned long V_5 ;
struct V_1 * V_1 ;
...
static int
F_29 ( unsigned long V_5 , unsigned long V_29 ,
bool V_2 )
{
struct V_1 * V_1 ;
while ( V_5 < V_29 ) {
...
int F_34 ( unsigned long V_12 , unsigned long V_29 ,
bool V_2 )
{
...
struct V_1 * F_35 ( struct V_1 * V_1 , unsigned long V_33 ,
int * * V_34 )
{
T_1 V_35 = V_36 | V_37 ;
if ( F_36 ( V_1 ) ) {
T_2 V_38 = F_37 ( F_38 ( V_1 ) ) ;
T_2 V_39 ;
F_39 ( V_39 , V_38 ) ;
return F_40 ( F_41 ( F_42 ( V_1 ) ) ,
F_43 ( F_38 ( V_1 ) , V_39 ) ) ;
}
if ( F_44 ( V_1 ) )
V_35 |= V_40 ;
