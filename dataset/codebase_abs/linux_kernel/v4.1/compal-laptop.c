...
if ( ! F_49 () ) {
struct V_154 V_30 ;
memset ( & V_30 , 0 , sizeof( struct V_154 ) ) ;
V_30 . type = V_155 ;
V_30 . V_156 = V_9 ;
V_157 = F_50 ( V_158 ,
NULL , NULL ,
...
if ( ! V_131 )
return 0 ;
V_13 = F_61 ( & V_167 -> V_45 , sizeof( struct V_48 ) , V_171 ) ;
if ( ! V_13 )
return - V_143 ;
F_40 ( V_13 ) ;
V_52 = F_62 ( & V_167 -> V_45 . V_172 , & V_173 ) ;
if ( V_52 )
return V_52 ;
V_168 = F_63 ( & V_167 -> V_45 ,
L_12 , V_13 ,
V_174 ) ;
if ( F_51 ( V_168 ) ) {
V_52 = F_52 ( V_168 ) ;
...
F_38 ( V_13 ) ;
V_170 . V_175 = V_13 ;
V_13 -> V_91 = F_64 ( & V_139 -> V_45 , & V_176 ,
& V_170 ) ;
if ( F_51 ( V_13 -> V_91 ) ) {
V_52 = F_52 ( V_13 -> V_91 ) ;
goto remove;
...
static int F_69 ( struct V_166 * V_167 )
{
struct V_48 * V_13 ;
if ( ! V_131 )
return 0 ;
