...
static T_7 F_123 ( int V_3 , void * V_55 )
{
return V_166 ;
}
...
static int F_125 ( struct V_1 * V_2 , int V_13 )
{
struct V_42 * V_42 = & V_2 -> V_6 . V_42 ;
...
if ( F_121 ( V_5 ) )
return 0 ;
V_12 = V_31 -> V_12 = F_129 ( & V_5 -> V_172 ) ;
if ( ! V_12 )
return - V_173 ;
if ( ! V_31 -> V_13 )
V_31 -> V_13 = V_174 ;
...
static int F_131 ( struct V_5 * V_5 , int type )
{
switch ( type ) {
case V_164 :
F_132 ( V_5 ) ;
...
if ( F_129 ( & V_5 -> V_172 ) > V_5 -> V_6 . V_178 )
return - V_179 ;
return 0 ;
}
int F_135 ( struct V_5 * V_5 , T_2 type )
{
...
static int F_138 ( struct V_5 * V_5 )
{
T_3 V_31 = V_5 -> V_6 . V_7 . V_188 ;
T_3 V_192 = V_5 -> V_6 . V_7 . V_190 ;
if ( F_139 ( V_31 ) || F_139 ( V_192 ) )
return 0 ;
...
static int F_140 ( struct V_5 * V_5 , T_3 * V_195 ,
T_3 V_85 , T_3 V_29 )
{
int V_80 ;
if ( V_85 & ~ V_196 )
...
int F_141 ( struct V_5 * V_5 , unsigned long type , T_1 * V_85 , bool V_198 )
{
int V_199 = 0 ;
...
int F_143 ( struct V_211 * V_88 , struct V_212 * V_213 )
{
int V_199 ;
switch ( V_213 -> V_214 ) {
case V_215 : {
...
if ( F_144 ( & V_85 , V_216 , sizeof( V_85 ) ) )
return - V_217 ;
V_199 = F_141 ( V_88 -> V_5 , type , & V_85 , true ) ;
...
return - V_162 ;
F_80 ( & V_88 -> V_5 -> V_95 ) ;
if ( F_146 ( V_88 -> V_5 ) || V_88 -> V_5 -> V_6 . V_7 . V_13 )
V_80 = - V_165 ;
else
...
int F_147 ( struct V_211 * V_88 , struct V_212 * V_213 )
{
int V_199 = - V_93 ;
switch ( V_213 -> V_214 ) {
case V_215 : {
...
T_1 V_85 ;
unsigned long type = ( unsigned long ) V_213 -> V_213 ;
V_199 = F_141 ( V_88 -> V_5 , type , & V_85 , false ) ;
if ( V_199 )
return ( V_199 == - V_173 ) ? - V_93 : V_199 ;
if ( F_148 ( V_216 , & V_85 , sizeof( V_85 ) ) )
return - V_217 ;
break;
}
case V_218 : {
T_2 T_8 * V_216 = ( T_2 T_8 * ) ( long ) V_213 -> V_85 ;
V_199 = F_149 ( V_88 -> V_5 -> V_6 . V_7 . V_13 , V_216 ) ;
break;
}
}
return V_199 ;
}
int F_150 ( const struct V_74 * V_75 , T_3 V_25 )
{
if ( F_64 ( V_75 , 4 , V_25 ) )
return 0 ;
else
...
static void F_151 ( void * V_222 )
{
F_152 ( V_7 -> V_223 , 0 ) ;
}
static int F_153 ( struct V_224 * V_225 ,
...
const int (* F_156)( struct V_234 * , const struct V_117 * * ,
const struct V_235 * * );
struct V_234 * V_236 ;
int V_80 ;
V_236 = F_157 ( NULL ,
...
F_156 = V_233 -> V_55 ;
V_80 = F_156 ( V_236 , & V_117 , & V_7 ) ;
if ( V_80 )
return V_80 ;
V_80 = F_158 ( V_7 -> V_223 , F_123 ,
L_11 , F_159 () ) ;
if ( V_80 ) {
F_130 ( L_12 , V_7 -> V_223 ) ;
return V_80 ;
}
V_80 = F_160 ( & V_238 ) ;
if ( V_80 ) {
