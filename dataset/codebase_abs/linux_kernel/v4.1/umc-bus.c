...
static T_1 F_23 ( struct V_1 * V_2 , struct V_27 * V_28 , char * V_29 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
return sprintf ( V_29 , L_2 , V_7 -> V_24 ) ;
}
static T_1 F_24 ( struct V_1 * V_2 , struct V_27 * V_28 , char * V_29 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
return sprintf ( V_29 , L_3 , V_7 -> V_30 ) ;
}
