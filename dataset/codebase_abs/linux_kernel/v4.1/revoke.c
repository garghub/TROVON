...
static void F_63 ( T_1 * V_85 , struct V_39 * V_41 )
{
struct V_74 * V_86 ;
T_7 V_87 ;
if ( ! F_57 ( V_85 ) )
return;
V_86 = (struct V_74 * ) ( V_41 -> V_76 + V_85 -> V_50 -
sizeof( struct V_74 ) ) ;
V_86 -> V_88 = 0 ;
V_87 = F_64 ( V_85 , V_85 -> V_89 , V_41 -> V_76 , V_85 -> V_50 ) ;
V_86 -> V_88 = F_60 ( V_87 ) ;
}
