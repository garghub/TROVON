...
static int F_30 ( struct V_150 * V_43 , struct V_13 * V_14 )
{
...
T_1 V_155 ;
T_2 V_156 ;
V_96 = F_31 ( V_43 , sizeof( * V_96 ) , V_157 ) ;
if ( ! V_96 )
return - V_158 ;
F_32 ( V_152 , L_14 ,
& V_96 -> V_127 ) ;
...
F_32 ( V_152 , L_17 ,
& V_96 -> V_136 ) ;
if ( F_33 ( V_152 , L_18 , NULL ) )
V_96 -> V_98 = 1 ;
if ( F_33 ( V_152 , L_19 , NULL ) )
V_96 -> V_100 = 1 ;
if ( F_33 ( V_152 , L_20 , NULL ) )
V_96 -> V_102 = 1 ;
V_96 -> V_106 = V_159 ;
if ( ! F_34 ( V_152 , L_21 ,
& V_154 ) ) {
...
V_155 = 140 ;
F_36 ( V_152 , L_23 , & V_155 ) ;
V_96 -> V_109 = F_37 ( T_1 , V_155 , 0 , 300 ) / 20 ;
if ( F_33 ( V_152 , L_24 , NULL ) )
V_96 -> V_112 = 1 ;
if ( F_33 ( V_152 , L_25 , NULL ) )
V_96 -> V_115 = 1 ;
if ( F_33 ( V_152 , L_26 , NULL ) )
V_96 -> V_117 = 1 ;
if ( F_33 ( V_152 , L_27 , NULL ) )
V_96 -> V_119 = 1 ;
if ( F_33 ( V_152 , L_28 , NULL ) )
V_96 -> V_121 = 1 ;
if ( F_33 ( V_152 , L_29 , NULL ) )
V_96 -> V_123 = 1 ;
if ( F_33 ( V_152 , L_30 , NULL ) )
V_96 -> V_125 = 1 ;
if ( F_33 ( V_152 , L_31 , NULL ) )
V_96 -> V_139 = 1 ;
if ( F_33 ( V_152 , L_32 , NULL ) )
V_96 -> V_141 = 1 ;
if ( F_33 ( V_152 , L_33 , NULL ) )
V_96 -> V_143 = 1 ;
if ( F_33 ( V_152 , L_34 , NULL ) )
V_96 -> V_145 = 1 ;
if ( ! F_32 ( V_152 , L_35 , & V_156 ) ) {
if ( F_38 ( V_156 ) && V_156 >= 1 && V_156 <= 128 )
V_96 -> V_148 = F_39 ( V_156 ) ;
else
F_35 ( V_43 , L_36 ,
V_156 ) ;
}
...
static int F_40 ( struct V_162 * V_163 ,
const struct V_164 * V_165 )
{
struct V_150 * V_43 = & V_163 -> V_43 ;
struct V_13 * V_14 ;
int V_19 , V_18 ;
V_14 = F_31 ( V_43 , sizeof( struct V_13 ) , V_157 ) ;
if ( ! V_14 )
return - V_158 ;
F_41 ( & V_14 -> V_20 ) ;
V_14 -> V_96 = F_42 ( V_43 ) ;
...
#endif
V_14 -> V_82 = F_44 ( V_43 , L_37 ,
V_166 ) ;
if ( F_45 ( V_14 -> V_82 ) )
return F_46 ( V_14 -> V_82 ) ;
V_14 -> V_81 = F_47 ( V_43 , L_38 ,
V_166 ) ;
if ( F_45 ( V_14 -> V_81 ) )
return F_46 ( V_14 -> V_81 ) ;
for ( V_18 = 0 ; V_18 < F_20 ( V_14 -> V_94 ) ; V_18 ++ )
V_14 -> V_94 [ V_18 ] . V_167 = V_168 [ V_18 ] ;
V_19 = F_48 ( V_43 , F_20 ( V_14 -> V_94 ) ,
V_14 -> V_94 ) ;
if ( V_19 < 0 ) {
F_18 ( V_43 , L_39 , V_19 ) ;
return V_19 ;
}
V_14 -> V_21 = F_49 ( V_163 , & V_169 ) ;
if ( F_45 ( V_14 -> V_21 ) ) {
V_19 = F_46 ( V_14 -> V_21 ) ;
F_18 ( V_43 , L_40 , V_19 ) ;
return V_19 ;
...
F_50 ( V_163 , V_14 ) ;
V_19 = F_51 ( V_43 , & V_170 , & V_171 , 1 ) ;
if ( V_19 < 0 )
F_18 ( V_43 , L_41 , V_19 ) ;
return V_19 ;
}
static int F_52 ( struct V_162 * V_172 )
{
F_53 ( & V_172 -> V_43 ) ;
return 0 ;
}
