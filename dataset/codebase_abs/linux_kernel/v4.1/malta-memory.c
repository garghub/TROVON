...
{
F_10 ( L_12 , F_11 ( ( unsigned long * ) V_22 ) ,
...
unsigned F_17 ( unsigned V_35 )
{
T_3 V_36 = ( V_11 & ~ 0xffffull ) - 1 ;
struct V_37 V_38 [] = {
{ 0x00000000 , 0x0fffffff , V_39 } ,
{ 0x20000000 , V_36 , V_39 } ,
{ 0x80000000 , 0x80000000 + V_36 , V_39 } ,
} ;
unsigned V_31 , V_40 = F_18 ( V_38 ) ;
if ( V_11 <= 0x10000000 ) {
V_40 -- ;
for ( V_31 = 1 ; V_31 < V_40 ; V_31 ++ )
V_38 [ V_31 ] = V_38 [ V_31 + 1 ] ;
}
return V_37 ( V_38 , V_40 , V_35 ) ;
}
T_3 F_19 ( void )
{
return 0x1fc10000 ;
