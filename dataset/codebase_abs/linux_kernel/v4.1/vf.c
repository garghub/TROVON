...
static T_1 F_24 ( struct V_1 * V_2 , T_2 V_84 , T_2 V_85 ,
bool V_86 )
{
struct V_10 * V_11 = & V_2 -> V_11 ;
T_2 V_16 [ 2 ] ;
...
void F_27 ( struct V_1 * V_2 , T_4 V_110 )
{
T_2 V_16 [ 2 ] ;
V_16 [ 0 ] = V_111 ;
V_16 [ 1 ] = V_110 ;
...
int F_28 ( struct V_1 * V_2 , int V_112 )
{
int V_55 ;
T_2 V_73 [ 3 ] ;
V_73 [ 0 ] = V_113 ;
...
int F_29 ( struct V_1 * V_2 , unsigned int * V_114 ,
unsigned int * V_115 )
{
int V_55 ;
T_2 V_73 [ 5 ] ;
...
if ( ! V_55 ) {
V_73 [ 0 ] &= ~ V_51 ;
if ( V_73 [ 0 ] != ( V_117 | V_29 ) )
return V_67 ;
V_2 -> V_5 . V_42 = V_73 [ V_118 ] ;
if ( V_2 -> V_5 . V_42 == 0 ||
V_2 -> V_5 . V_42 > V_119 )
V_2 -> V_5 . V_42 = V_119 ;
V_2 -> V_5 . V_37 = V_73 [ V_120 ] ;
if ( V_2 -> V_5 . V_37 == 0 ||
V_2 -> V_5 . V_37 > V_121 )
V_2 -> V_5 . V_37 = V_121 ;
* V_114 = V_73 [ V_122 ] ;
if ( * V_114 > V_2 -> V_5 . V_37 )
* V_114 = 1 ;
* V_115 = V_73 [ V_123 ] ;
if ( * V_115 >= V_2 -> V_5 . V_42 )
* V_115 = 0 ;
}
return V_55 ;
}
