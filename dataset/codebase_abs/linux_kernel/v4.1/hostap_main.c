...
T_3 F_28 ( T_2 * V_3 ,
void (* F_29)( struct V_50 * , int V_51 , void * ) ,
void * V_52 )
{
unsigned long V_47 ;
struct V_53 * V_54 ;
V_54 = F_30 ( sizeof( * V_54 ) , V_55 ) ;
if ( V_54 == NULL )
return 0 ;
V_54 -> F_29 = F_29 ;
V_54 -> V_52 = V_52 ;
...
int F_35 ( struct V_1 * V_7 , int V_62 , T_3 V_63 )
{
struct V_9 * V_10 ;
T_4 V_64 = F_36 ( V_63 ) ;
V_10 = F_3 ( V_7 ) ;
return V_10 -> V_3 -> F_29 -> V_65 ( V_7 , V_62 , & V_64 , 2 ) ;
}
int F_37 ( struct V_1 * V_7 , int V_62 , const char * V_63 )
{
struct V_9 * V_10 ;
char V_66 [ V_67 + 2 ] ;
int V_68 ;
...
return V_10 -> V_3 -> F_29 -> V_65 ( V_7 , V_62 , & V_66 , V_67 + 2 ) ;
}
T_3 F_38 ( T_2 * V_3 )
{
...
V_88 = V_87 ;
if ( V_3 -> F_29 -> V_93 ( V_3 -> V_7 , V_94 , & V_63 , 2 ,
1 ) < 0 ) {
F_11 ( V_22 L_8 ) ;
goto V_95;
}
...
if ( V_3 -> F_29 -> V_113 ( V_3 -> V_7 , V_119 ,
V_115 , & V_63 , NULL ) ) {
F_11 ( V_120 L_13 ,
V_3 -> V_7 -> V_6 ) ;
V_11 = - 1 ;
...
return F_35 ( V_3 -> V_7 , V_127 , V_63 ) ;
}
int F_44 ( T_2 * V_3 )
{
int V_63 = V_3 -> V_128 ;
if ( V_3 -> V_129 < F_45 ( 0 , 7 , 0 ) &&
V_63 != V_130 && V_63 != V_131 )
V_63 = V_130 ;
if ( F_35 ( V_3 -> V_7 , V_132 , V_63 ) ) {
F_11 ( V_120 L_15
...
void F_46 ( const char * V_6 , const struct V_133 * V_134 )
{
T_3 V_135 , V_136 ;
V_135 = F_47 ( V_134 -> V_135 ) ;
F_11 ( V_22 L_17
L_18
L_19 ,
V_6 , V_135 , ( V_135 >> 8 ) & 0x07 , V_135 >> 13 , V_135 & 1 ,
V_134 -> V_137 , V_134 -> signal , V_134 -> V_138 , V_134 -> V_139 , V_140 ) ;
V_136 = F_47 ( V_134 -> V_141 ) ;
F_11 ( V_22 L_20
L_21 ,
V_136 , ( V_136 & V_142 ) >> 2 ,
( V_136 & V_143 ) >> 4 ,
F_47 ( V_134 -> V_144 ) , F_47 ( V_134 -> V_145 ) ,
F_47 ( V_134 -> V_146 ) ,
...
void F_49 ( const char * V_6 , const struct V_155 * V_156 )
{
T_3 V_136 ;
F_11 ( V_22 L_27
L_28 ,
V_6 , F_47 ( V_156 -> V_135 ) , V_156 -> V_157 , V_156 -> V_158 ,
F_47 ( V_156 -> V_159 ) , V_140 ) ;
V_136 = F_47 ( V_156 -> V_141 ) ;
F_11 ( V_22 L_20
L_21 ,
V_136 , ( V_136 & V_142 ) >> 2 ,
( V_136 & V_143 ) >> 4 ,
F_47 ( V_156 -> V_144 ) , F_47 ( V_156 -> V_145 ) ,
F_47 ( V_156 -> V_146 ) ,
V_136 & V_147 ? L_22 : L_23 ,
V_136 & V_148 ? L_24 : L_23 ) ;
F_11 ( V_22 L_25 ,
...
static int F_50 ( const struct V_50 * V_160 ,
unsigned char * V_161 )
{
memcpy ( V_161 , F_51 ( V_160 ) + 10 , V_37 ) ;
return V_37 ;
}
int F_52 ( T_4 V_136 )
{
if ( F_53 ( V_136 ) && F_54 ( V_136 ) )
return 30 ;
else if ( F_55 ( V_136 ) || F_56 ( V_136 ) )
return 10 ;
else if ( F_57 ( V_136 ) )
return 16 ;
return 24 ;
}
static int F_58 ( struct V_1 * V_7 )
{
struct V_9 * V_10 ;
T_2 * V_3 ;
F_59 ( V_162 , L_29 , V_7 -> V_6 ) ;
V_10 = F_3 ( V_7 ) ;
V_3 = V_10 -> V_3 ;
if ( V_7 == V_3 -> V_24 ) {
F_60 ( V_3 , V_163 ) ;
...
( ! V_3 -> F_29 -> V_165 || V_3 -> F_29 -> V_165 ( V_3 ) ) &&
V_3 -> V_166 && V_3 -> V_39 && V_3 -> V_69 == V_167 )
F_62 ( V_7 , V_3 -> V_39 , 1 ) ;
#endif
if ( V_7 == V_3 -> V_7 ) {
V_3 -> F_29 -> V_168 ( V_7 , V_169 ) ;
}
if ( F_63 ( V_7 ) ) {
F_64 ( V_7 ) ;
F_65 ( V_7 ) ;
...
if ( ( V_3 -> F_29 -> V_165 && ! V_3 -> F_29 -> V_165 ( V_3 ) ) ||
V_3 -> V_180 )
return - V_49 ;
if ( ! F_71 ( V_3 -> V_175 ) )
return - V_49 ;
V_3 -> V_176 ++ ;
if ( ! V_3 -> V_181 && V_3 -> F_29 -> V_182 ( V_7 , 1 ) ) {
F_11 ( V_21 L_33 ,
V_7 -> V_6 ) ;
F_58 ( V_7 ) ;
return - V_49 ;
...
static int F_76 ( struct V_1 * V_7 , void * V_184 )
{
struct V_9 * V_10 ;
T_2 * V_3 ;
struct V_29 * V_30 ;
...
V_10 = F_3 ( V_7 ) ;
V_3 = V_10 -> V_3 ;
if ( V_3 -> F_29 -> V_65 ( V_7 , V_186 , V_27 -> V_187 ,
V_37 ) < 0 || V_3 -> F_29 -> V_188 ( V_7 ) )
return - V_44 ;
F_18 ( & V_3 -> V_33 ) ;
F_19 (ptr, &local->hostap_interfaces) {
V_10 = F_20 ( V_30 , struct V_9 , V_12 ) ;
...
void F_77 ( struct V_190 * V_191 )
{
T_2 * V_3 =
F_78 ( V_191 , T_2 , V_171 ) ;
...
static void F_79 ( struct V_1 * V_7 )
{
#if 0
...
static int F_80 ( struct V_1 * V_7 , int V_194 )
{
...
if ( ! V_3 -> V_129 )
V_11 = - 1 ;
else if ( V_3 -> V_129 >= F_45 ( 1 , 3 , 1 ) ) {
if ( V_3 -> F_29 -> V_93 ( V_3 -> V_7 ,
V_230 ,
...
if ( V_3 -> F_29 -> V_93 ( V_3 -> V_7 , V_239 ,
& V_229 , sizeof( V_229 ) , 1 ) >= 0 ) {
...
struct V_246 * V_247 ;
struct V_1 * V_7 = V_3 -> V_7 ;
V_160 = F_93 ( V_248 + V_243 ) ;
if ( V_160 == NULL )
return - V_45 ;
V_245 = (struct V_244 * )
F_94 ( V_160 , V_248 ) ;
memset ( V_245 , 0 , V_248 ) ;
V_245 -> V_141 = F_36 ( V_249 | V_241 ) ;
memcpy ( V_245 -> V_250 , V_240 , V_37 ) ;
memcpy ( V_245 -> V_251 , V_7 -> V_189 , V_37 ) ;
memcpy ( V_245 -> V_252 , V_240 , V_37 ) ;
if ( V_242 )
memcpy ( F_94 ( V_160 , V_243 ) , V_242 , V_243 ) ;
V_247 = (struct V_246 * ) V_160 -> V_60 ;
...
( T_1 * ) & V_63 , 2 ) ;
F_27 ( V_257 . V_259 . V_187 ) ;
F_99 ( V_3 -> V_7 , V_260 , & V_257 , NULL ) ;
return V_11 ;
}
static int T_6 F_100 ( void )
{
if ( V_261 . V_262 != NULL ) {
V_263 = F_101 ( L_46 , V_261 . V_262 ) ;
if ( ! V_263 )
F_11 ( V_21 L_47
L_48 ) ;
} else
