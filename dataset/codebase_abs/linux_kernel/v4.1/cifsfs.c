...
F_46 ( V_92 , L_60 , V_8 -> V_162 ) ;
F_46 ( V_92 , L_61 , V_8 -> V_163 / V_164 ) ;
return 0 ;
}
...
static int F_61 ( struct V_1 * V_2 , int * V_74 , char * V_171 )
{
F_62 ( V_2 ) ;
* V_74 |= V_172 ;
return 0 ;
...
static struct V_46 *
F_65 ( struct V_173 * V_174 , struct V_1 * V_2 )
{
struct V_46 * V_46 ;
struct V_3 * V_8 = F_2 ( V_2 ) ;
char * V_175 = NULL ;
char * V_92 , * V_176 ;
char V_177 ;
V_175 = F_66 ( V_174 , V_8 ,
F_9 ( V_8 ) ) ;
if ( V_175 == NULL )
return F_67 ( - V_39 ) ;
F_15 ( V_41 , L_63 , V_175 ) ;
V_177 = F_68 ( V_8 ) ;
V_46 = F_69 ( V_2 -> V_38 ) ;
V_176 = V_92 = V_175 ;
do {
struct V_7 * V_178 = F_70 ( V_46 ) ;
struct V_46 * V_179 ;
if ( ! V_178 ) {
F_71 ( V_46 ) ;
V_46 = F_67 ( - V_180 ) ;
...
break;
V_176 = V_92 ++ ;
while ( * V_92 && * V_92 != V_177 )
V_92 ++ ;
F_73 ( & V_178 -> V_183 ) ;
V_179 = F_74 ( V_176 , V_46 , V_92 - V_176 ) ;
F_75 ( & V_178 -> V_183 ) ;
F_71 ( V_46 ) ;
V_46 = V_179 ;
} while ( ! F_11 ( V_46 ) );
...
static int F_77 ( struct V_1 * V_2 , void * V_171 )
{
struct V_184 * V_185 = V_171 ;
V_2 -> V_186 = V_185 -> V_8 ;
return F_78 ( V_2 , NULL ) ;
}
static struct V_46 *
F_79 ( struct V_187 * V_188 ,
int V_74 , const char * V_189 , void * V_171 )
{
int V_11 ;
struct V_1 * V_2 ;
struct V_3 * V_8 ;
...
struct V_184 V_185 ;
struct V_46 * V_121 ;
F_15 ( V_41 , L_64 , V_189 , V_74 ) ;
V_190 = F_80 ( ( char * ) V_171 , V_189 ) ;
if ( F_11 ( V_190 ) )
return F_81 ( V_190 ) ;
V_8 = F_82 ( sizeof( struct V_3 ) , V_72 ) ;
if ( V_8 == NULL ) {
V_121 = F_67 ( - V_39 ) ;
goto V_191;
}
V_8 -> V_192 = F_83 ( V_171 , V_193 , V_72 ) ;
if ( V_8 -> V_192 == NULL ) {
V_121 = F_67 ( - V_39 ) ;
goto V_194;
}
...
V_185 . V_74 = V_74 ;
V_74 |= V_172 | V_197 ;
V_2 = F_86 ( V_188 , V_198 , F_77 , V_74 , & V_185 ) ;
if ( F_11 ( V_2 ) ) {
V_121 = F_81 ( V_2 ) ;
F_18 ( V_8 ) ;
goto V_199;
...
static T_2
F_89 ( struct V_202 * V_203 , struct V_204 * V_205 )
{
T_2 V_11 ;
struct V_7 * V_7 = F_90 ( V_203 -> V_206 ) ;
V_11 = F_91 ( V_7 ) ;
if ( V_11 )
return V_11 ;
return F_92 ( V_203 , V_205 ) ;
}
static T_2 F_93 ( struct V_202 * V_203 , struct V_204 * V_207 )
{
struct V_7 * V_7 = F_90 ( V_203 -> V_206 ) ;
...
static T_1 F_99 ( struct V_58 * V_58 , T_1 V_211 , int V_212 )
{
if ( V_212 != V_213 && V_212 != V_214 ) {
int V_11 ;
struct V_7 * V_7 = F_90 ( V_58 ) ;
if ( ! F_100 ( F_37 ( V_7 ) ) && V_7 -> V_210 &&
V_7 -> V_210 -> V_215 != 0 ) {
V_11 = F_101 ( V_7 -> V_210 ) ;
if ( V_11 ) {
F_102 ( V_7 -> V_210 , V_11 ) ;
return V_11 ;
}
}
F_37 ( V_7 ) -> time = 0 ;
...
return F_104 ( V_58 , V_211 , V_212 ) ;
}
static int
F_105 ( struct V_58 * V_58 , long V_216 , struct V_217 * * V_218 , void * * V_219 )
{
struct V_7 * V_7 = F_90 ( V_58 ) ;
...
return - V_223 ;
if ( V_216 == V_224 ||
( ( V_216 == V_225 ) && F_100 ( F_37 ( V_7 ) ) ) ||
( ( V_216 == V_226 ) && F_96 ( F_37 ( V_7 ) ) ) )
return F_107 ( V_58 , V_216 , V_218 , V_219 ) ;
else if ( F_108 ( V_221 -> V_227 ) -> V_228 &&
! F_100 ( F_37 ( V_7 ) ) )
return F_107 ( V_58 , V_216 , V_218 , V_219 ) ;
else
return - V_229 ;
...
V_269 = F_128 ( L_77 , V_270 | V_271 , 0 ) ;
if ( ! V_269 ) {
V_11 = - V_39 ;
goto V_272;
}
