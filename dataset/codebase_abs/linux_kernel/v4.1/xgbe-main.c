...
V_2 -> V_93 = V_39 ;
V_56 -> V_94 = V_2 -> V_93 ;
V_56 -> V_95 = ( unsigned long ) V_2 -> V_76 ;
memcpy ( V_56 -> V_96 , V_2 -> V_79 , V_56 -> V_97 ) ;
F_3 ( V_2 ) ;
V_28 = & V_2 -> V_28 ;
V_29 = & V_2 -> V_29 ;
V_28 -> exit ( V_2 ) ;
...
V_33 -> V_98 = & V_33 -> V_99 ;
V_39 = F_36 ( V_33 ,
F_37 ( V_2 -> V_100 . V_101 ) ) ;
if ( V_39 ) {
F_8 ( V_33 , L_18 ) ;
goto V_72;
}
V_2 -> V_102 = F_38 (unsigned int, num_online_cpus(),
pdata->hw_feat.tx_ch_cnt) ;
V_2 -> V_103 = V_2 -> V_102 ;
V_39 = F_39 ( V_56 , V_2 -> V_102 ) ;
if ( V_39 ) {
F_8 ( V_33 , L_19 ) ;
goto V_72;
}
V_2 -> V_104 = F_38 (unsigned int,
netif_get_num_default_rss_queues(),
pdata->hw_feat.rx_ch_cnt) ;
V_2 -> V_105 = V_2 -> V_100 . V_106 ;
V_39 = F_40 ( V_56 , V_2 -> V_104 ) ;
if ( V_39 ) {
F_8 ( V_33 , L_20 ) ;
goto V_72;
}
F_41 ( V_2 -> V_107 , sizeof( V_2 -> V_107 ) ) ;
for ( V_60 = 0 ; V_60 < V_108 ; V_60 ++ )
F_42 ( V_2 -> V_109 [ V_60 ] , V_110 , V_111 ,
V_60 % V_2 -> V_104 ) ;
F_42 ( V_2 -> V_112 , V_113 , V_114 , 1 ) ;
F_42 ( V_2 -> V_112 , V_113 , V_115 , 1 ) ;
F_42 ( V_2 -> V_112 , V_113 , V_116 , 1 ) ;
V_2 -> V_117 = F_43 ( V_118 , L_21 , V_52 -> V_119 ) ;
if ( ! V_2 -> V_117 ) {
F_8 ( V_33 , L_22 ) ;
V_39 = - V_62 ;
goto V_72;
...
V_129 |
V_130 ;
V_56 -> V_138 |= V_56 -> V_124 ;
V_2 -> V_139 = V_56 -> V_138 ;
V_56 -> V_140 |= V_141 ;
V_56 -> V_142 = 0 ;
F_49 ( V_2 ) ;
F_50 ( V_2 ) ;
