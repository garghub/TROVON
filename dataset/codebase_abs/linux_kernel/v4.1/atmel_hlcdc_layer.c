...
void F_33 ( struct V_8 * V_9 , int V_35 ,
T_1 V_85 , T_1 V_3 )
{
struct V_17 * V_18 = & V_9 -> V_19 ;
struct V_20 * V_21 ;
...
V_34 -> V_49 = V_88 + ( V_10 * sizeof( * V_34 ) ) ;
}
return 0 ;
}
...
( V_89 * sizeof( unsigned long ) ) ) * 2 ,
V_72 ) ;
if ( ! V_90 )
return - V_73 ;
for ( V_10 = 0 ; V_10 < 2 ; V_10 ++ ) {
V_18 -> V_22 [ V_10 ] . V_23 = V_90 ;
V_90 += V_89 * sizeof( unsigned long ) ;
V_18 -> V_22 [ V_10 ] . V_26 = V_90 ;
V_90 += V_24 -> V_25 * sizeof( T_1 ) ;
}
V_18 -> V_37 = - 1 ;
V_18 -> V_49 = - 1 ;
return 0 ;
...
struct V_31 * V_31 = V_92 -> V_32 -> V_31 ;
unsigned int V_94 ;
int V_95 ;
int V_10 ;
V_9 -> V_32 = V_92 -> V_32 ;
...
F_12 ( V_31 , V_24 -> V_38 + V_69 ,
V_70 ) ;
for ( V_10 = 0 ; V_10 < V_24 -> V_96 -> V_97 ; V_10 ++ ) {
int V_80 = F_31 ( V_24 -> V_96 -> V_96 [ V_10 ] ) ;
if ( V_80 > V_9 -> V_11 )
V_9 -> V_11 = V_80 ;
}
F_43 ( & V_9 -> V_63 ) ;
F_44 ( & V_9 -> V_14 , V_24 -> V_98 ,
F_1 ) ;
V_95 = F_36 ( V_87 , V_9 ) ;
if ( V_95 )
return V_95 ;
V_95 = F_40 ( V_87 , V_9 , V_24 ) ;
if ( V_95 )
return V_95 ;
F_12 ( V_31 , V_24 -> V_38 + V_99 ,
0xffffffff ) ;
...
V_47 |
V_67 ) << ( 8 * V_10 ) ;
F_12 ( V_31 , V_24 -> V_38 + V_100 , V_94 ) ;
return 0 ;
}
void F_45 ( struct V_86 * V_87 ,
struct V_8 * V_9 )
{
const struct V_30 * V_24 = V_9 -> V_24 ;
struct V_31 * V_31 = V_9 -> V_32 -> V_31 ;
