...
V_27 . V_43 = V_76 ;
V_27 . V_44 . V_77 . V_78 = F_16 ( V_23 -> V_15 . V_66 . V_67 ) * 100000 ;
...
T_1 V_96 = 0 , V_97 = 0 ;
T_4 * V_33 ;
F_17 ( V_23 -> V_15 . V_52 , V_23 -> V_15 . V_54 , V_95 , & V_97 , V_94 , & V_96 ) ;
F_18 ( V_98 , V_99 , ( L_15 , V_23 -> V_15 . V_50 . V_50 ) ) ;
F_18 ( V_98 , V_99 , ( L_16 , V_96 , V_97 ) ) ;
if ( V_96 > 0 ) {
V_33 = V_92 ;
memset ( V_92 , 0 , V_93 ) ;
...
while ( V_102 < V_103 ) {
if ( F_19 ( & V_106 [ V_102 ] , & V_105 ) && ( V_105 > 2 ) ) {
V_104 = & V_106 [ V_102 ] ;
V_27 . V_43 = V_101 ;
...
if ( F_20 ( V_8 , V_114 ) == true &&
F_21 ( & V_8 -> V_14 . V_15 , & V_23 -> V_15 ) ) {
...
static int F_22 ( struct V_124 * V_125 , T_3 V_90 )
{
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
int V_126 = 0 ;
...
static int F_25 ( struct V_124 * V_125 , struct V_143 * V_144 , T_3 V_145 )
{
int V_126 = 0 ;
...
F_18 ( V_162 , V_99 , ( L_27 , V_146 ) ) ;
F_24 ( L_27 , V_146 ) ;
if ( V_146 > V_161 )
return - V_142 ;
F_18 ( V_162 , V_99 , ( L_28 , V_146 ) ) ;
if ( V_147 > 0 ) {
V_147 = V_147 <= 5 ? 5 : 13 ;
V_148 = V_147 + F_26 ( struct V_149 , V_167 ) ;
V_150 = (struct V_149 * ) F_27 ( V_148 ) ;
if ( V_150 == NULL ) {
F_18 ( V_162 , V_163 , ( L_29 ) ) ;
goto exit;
}
...
if ( F_20 ( V_8 , V_185 | V_186 ) ) {
V_180 = F_30 ( V_183 , F_31 ( V_8 ) ) ;
if ( V_180 == NULL ) {
;
} else {
...
F_24 ( L_34 ) ;
F_32 ( V_2 , ( unsigned char * ) V_180 , true ) ;
} else {
...
F_29 ( V_2 , & V_2 -> V_129 , V_144 -> V_44 . V_153 . V_160 , 1 ) ;
}
}
V_181 = F_33 ( V_2 ) ;
if ( V_181 == NULL ) {
...
static int F_35 ( struct V_1 * V_2 , char * V_200 , unsigned short V_201 )
{
T_4 * V_92 = NULL ;
int V_202 = 0 , V_203 = 0 ;
int V_126 = 0 ;
...
F_24 ( L_37 , V_92 [ V_37 ] , V_92 [ V_37 + 1 ] , V_92 [ V_37 + 2 ] , V_92 [ V_37 + 3 ] , V_92 [ V_37 + 4 ] , V_92 [ V_37 + 5 ] , V_92 [ V_37 + 6 ] , V_92 [ V_37 + 7 ] ) ;
}
if ( V_201 < V_207 ) {
F_18 ( V_162 , V_163 , ( L_38 , V_201 ) ) ;
V_126 = - 1 ;
goto exit;
}
...
T_6 * V_228 = NULL ;
F_18 ( V_98 , V_99 , ( L_41 , V_21 -> V_43 ) ) ;
if ( F_20 ( V_8 , V_114 | V_229 ) == true ) {
V_33 = F_11 ( & V_227 -> V_52 [ 12 ] , V_53 , & V_30 , V_227 -> V_54 - 12 ) ;
if ( V_33 && V_30 > 0 )
V_36 = true ;
V_228 = & V_227 -> V_63 ;
if ( F_12 ( ( T_4 * ) V_228 ) == true ) {
if ( V_36 )
snprintf ( V_4 -> V_64 , V_65 , L_3 ) ;
else
snprintf ( V_4 -> V_64 , V_65 , L_4 ) ;
} else if ( ( F_13 ( ( T_4 * ) V_228 ) ) == true ) {
if ( V_36 )
...
struct V_226 * V_227 = & V_8 -> V_14 . V_15 ;
if ( F_20 ( V_8 , V_114 ) ) {
V_4 -> V_77 . V_78 = F_16 ( V_227 -> V_66 . V_67 ) * 100000 ;
V_4 -> V_77 . V_79 = 1 ;
V_4 -> V_77 . V_37 = V_227 -> V_66 . V_67 ;
} else {
V_4 -> V_77 . V_78 = F_16 ( V_2 -> V_231 . V_232 ) * 100000 ;
V_4 -> V_77 . V_79 = 1 ;
V_4 -> V_77 . V_37 = V_2 -> V_231 . V_232 ;
}
return 0 ;
}
static int F_44 ( struct V_124 * V_125 , struct V_20 * V_233 ,
...
default:
V_126 = - V_142 ;
F_18 ( V_162 , V_163 , ( L_48 , V_245 [ V_4 -> V_72 ] ) ) ;
goto exit;
}
if ( F_46 ( V_2 , V_236 ) == false ) {
V_126 = - V_237 ;
goto exit;
}
F_47 ( V_2 , V_236 ) ;
...
static int F_48 ( struct V_124 * V_125 , struct V_20 * V_233 ,
union V_3 * V_4 , char * V_234 )
{
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
...
if ( F_20 ( V_8 , V_185 ) )
V_4 -> V_72 = V_243 ;
else if ( ( F_20 ( V_8 , V_229 ) ) ||
( F_20 ( V_8 , V_246 ) ) )
V_4 -> V_72 = V_74 ;
else if ( F_20 ( V_8 , V_247 ) )
V_4 -> V_72 = V_73 ;
else
V_4 -> V_72 = V_239 ;
return 0 ;
...
V_269 -> V_77 [ V_272 ] . V_78 = F_16 ( V_271 -> V_289 [ V_37 ] . V_290 ) * 100000 ;
...
F_24 ( L_57 , V_327 ) ;
V_324 = V_326 -> V_328 ;
F_24 ( L_58 , V_327 , V_326 -> V_43 , V_324 ) ;
switch ( V_326 -> V_43 ) {
case V_329 :
if ( ! F_61 ( V_2 ) )
V_126 = - 1 ;
...
static int F_62 ( struct V_124 * V_125 , struct V_20 * V_233 ,
union V_3 * V_4 , char * V_225 )
{
T_4 V_331 = false ;
int V_126 = 0 ;
...
V_333 [ 0 ] . V_51 = V_345 ;
F_24 ( L_61 , V_343 -> V_348 , V_343 -> V_346 ) ;
F_53 ( & V_8 -> V_319 ) ;
...
V_365 = 100 ;
V_366 = V_340 | V_341 ;
while ( F_20 ( V_8 , V_366 ) ) {
F_66 ( 30 ) ;
V_102 ++ ;
if ( V_102 > V_365 )
break;
}
F_53 ( & ( V_8 -> V_315 . V_319 ) ) ;
V_310 = F_54 ( V_314 ) ;
V_363 = V_310 -> V_321 ;
while ( V_310 != V_363 ) {
if ( ( V_25 - V_364 ) < V_369 ) {
...
F_18 ( V_98 , V_99 , ( L_74 ) ) ;
F_18 ( V_162 , V_99 , ( L_75 , V_376 , V_88 ) ) ;
if ( V_376 == - 1 ) {
V_377 = 11 ;
goto V_379;
}
...
F_18 ( V_162 , V_99 , ( L_76 , V_374 [ V_37 ] ) ) ;
}
return 0 ;
}
...
{
T_1 V_34 = 0 ;
V_34 = F_74 ( (struct V_1 * ) F_23 ( V_125 ) ) ;
if ( V_34 == 0 )
return - V_237 ;
V_4 -> V_87 . V_88 = 0 ;
...
F_24 ( L_77 , V_327 , V_2 -> V_335 . V_381 ) ;
return 0 ;
}
...
F_24 ( L_78 , V_327 , V_2 -> V_383 . V_384 ) ;
return 0 ;
}
...
V_388 . V_169 = V_388 . V_168 + F_26 ( struct V_149 , V_167 ) ;
} else {
V_388 . V_168 = 0 ;
if ( V_387 == 1 ) {
V_2 -> V_129 . V_395 = V_157 ;
F_24 ( L_85 , V_157 , V_2 -> V_129 . V_177 [ V_157 ] ) ;
...
{
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
return F_35 ( V_2 , V_225 , V_4 -> V_47 . V_49 ) ;
}
...
V_126 = F_22 ( V_125 , ( T_3 ) V_144 -> V_90 ) ;
break;
case V_412 :
break;
case V_413 :
...
V_144 = (struct V_143 * ) F_27 ( V_33 -> V_49 ) ;
if ( V_144 == NULL ) {
V_126 = - V_206 ;
goto V_441;
}
...
T_4 V_454 = V_208 ;
V_448 = F_98 ( sizeof( struct V_447 ) , V_205 ) ;
if ( V_448 == NULL ) {
V_454 = V_173 ;
goto exit;
}
V_450 = F_98 ( sizeof( struct V_449 ) , V_205 ) ;
if ( V_450 == NULL ) {
F_34 ( V_448 ) ;
V_454 = V_173 ;
goto exit;
}
F_99 ( V_448 , V_450 , V_455 ) ;
V_450 -> V_456 = ( T_4 ) V_180 -> V_190 ;
memcpy ( V_450 -> V_457 , V_180 -> V_458 , V_17 ) ;
memcpy ( V_450 -> V_157 , & V_180 -> V_191 , 16 ) ;
V_454 = F_100 ( V_452 , V_448 ) ;
exit:
return V_454 ;
}
static int F_101 ( struct V_1 * V_2 , T_4 * V_157 , T_4 V_155 , int V_459 )
{
T_4 V_460 ;
struct V_447 * V_461 ;
struct V_462 * V_463 ;
...
int V_454 = V_208 ;
F_24 ( L_57 , V_327 ) ;
V_461 = F_98 ( sizeof( struct V_447 ) , V_205 ) ;
if ( V_461 == NULL ) {
V_454 = V_173 ;
goto exit;
}
V_463 = F_98 ( sizeof( struct V_462 ) , V_205 ) ;
if ( V_463 == NULL ) {
F_34 ( V_461 ) ;
V_454 = V_173 ;
goto exit;
...
V_461 -> V_470 = 0 ;
F_102 ( & V_461 -> V_322 ) ;
V_454 = F_100 ( V_452 , V_461 ) ;
exit:
return V_454 ;
}
static int F_103 ( struct V_1 * V_2 , T_4 * V_157 , T_4 V_460 , int V_459 )
{
T_4 V_155 ;
switch ( V_460 ) {
case 5 :
...
return F_101 ( V_2 , V_157 , V_155 , V_459 ) ;
}
static int F_104 ( struct V_124 * V_125 , struct V_143 * V_144 , T_3 V_145 )
{
int V_126 = 0 ;
T_3 V_146 , V_147 , V_148 ;
struct V_149 * V_150 = NULL ;
...
F_24 ( L_92 , V_144 -> V_44 . V_153 . V_160 ) ;
goto exit;
}
...
memcpy ( & ( V_152 -> V_175 [ V_146 ] . V_176 [ 0 ] ) , V_150 -> V_167 , V_150 -> V_168 ) ;
V_152 -> V_177 [ V_146 ] = V_150 -> V_168 ;
F_103 ( V_2 , V_150 -> V_167 , V_150 -> V_168 , V_146 ) ;
} else {
F_24 ( L_31 ) ;
memcpy ( & ( V_152 -> V_175 [ V_146 ] . V_176 [ 0 ] ) , V_150 -> V_167 , V_150 -> V_168 ) ;
V_152 -> V_177 [ V_146 ] = V_150 -> V_168 ;
...
F_101 ( V_2 , V_144 -> V_44 . V_153 . V_157 , V_152 -> V_166 , V_144 -> V_44 . V_153 . V_160 ) ;
V_181 = F_33 ( V_2 ) ;
if ( V_181 ) {
V_181 -> V_187 = false ;
...
static int F_105 ( struct V_124 * V_125 , struct V_143 * V_144 , int V_345 )
{
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
...
F_24 ( L_104 , V_327 , V_345 ) ;
if ( F_20 ( V_8 , V_247 ) != true )
return - V_142 ;
memcpy ( & V_183 -> V_473 , V_144 -> V_44 . V_472 . V_474 , 2 ) ;
if ( ( V_183 -> V_473 > V_475 ) || ( V_183 -> V_473 <= 0 ) )
V_183 -> V_473 = V_475 ;
if ( F_106 ( V_2 , V_471 , ( V_345 - 12 - 2 ) ) == V_208 )
V_126 = 0 ;
else
V_126 = - V_142 ;
return V_126 ;
}
static int F_107 ( struct V_124 * V_125 )
{
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
F_24 ( L_57 , V_327 ) ;
...
static int F_110 ( struct V_124 * V_125 , struct V_143 * V_144 )
{
int V_126 = 0 ;
...
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
struct V_182 * V_183 = & V_2 -> V_184 ;
F_24 ( L_105 , V_144 -> V_44 . V_476 . V_477 , ( V_144 -> V_159 ) ) ;
if ( ! F_20 ( V_8 , ( V_114 | V_247 ) ) )
return - V_142 ;
if ( V_144 -> V_159 [ 0 ] == 0xff && V_144 -> V_159 [ 1 ] == 0xff &&
V_144 -> V_159 [ 2 ] == 0xff && V_144 -> V_159 [ 3 ] == 0xff &&
V_144 -> V_159 [ 4 ] == 0xff && V_144 -> V_159 [ 5 ] == 0xff )
...
static int F_112 ( struct V_124 * V_125 , struct V_143 * V_144 )
{
int V_126 = 0 ;
struct V_179 * V_180 = NULL ;
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
...
struct V_182 * V_183 = & V_2 -> V_184 ;
int V_110 = 0 ;
F_24 ( L_106 , ( V_144 -> V_159 ) ) ;
if ( F_20 ( V_8 , ( V_114 | V_247 ) ) != true )
return - V_142 ;
if ( V_144 -> V_159 [ 0 ] == 0xff && V_144 -> V_159 [ 1 ] == 0xff &&
V_144 -> V_159 [ 2 ] == 0xff && V_144 -> V_159 [ 3 ] == 0xff &&
V_144 -> V_159 [ 4 ] == 0xff && V_144 -> V_159 [ 5 ] == 0xff )
...
if ( V_180 ) {
F_53 ( & V_183 -> V_486 ) ;
if ( ! F_113 ( & V_180 -> V_487 ) ) {
F_114 ( & V_180 -> V_487 ) ;
V_183 -> V_488 -- ;
V_110 = F_115 ( V_2 , V_180 , true , V_489 ) ;
}
F_56 ( & V_183 -> V_486 ) ;
F_116 ( V_2 , V_110 ) ;
V_180 = NULL ;
...
static int F_117 ( struct V_124 * V_125 , struct V_143 * V_144 , int V_345 )
{
int V_126 = 0 ;
struct V_179 * V_180 = NULL ;
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
...
static int F_118 ( struct V_124 * V_125 , struct V_143 * V_144 )
{
int V_126 = 0 ;
struct V_179 * V_180 = NULL ;
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
...
static int F_119 ( struct V_124 * V_125 , struct V_143 * V_144 , int V_345 )
{
int V_126 = 0 ;
...
V_8 -> V_517 = NULL ;
if ( V_516 > 0 ) {
V_8 -> V_517 = F_27 ( V_516 ) ;
V_8 -> V_518 = V_516 ;
if ( V_8 -> V_517 == NULL ) {
F_24 ( L_111 , V_327 , __LINE__ ) ;
return - V_142 ;
}
memcpy ( V_8 -> V_517 , V_144 -> V_44 . V_472 . V_92 , V_516 ) ;
F_120 ( V_2 , V_222 , V_221 , true ) ;
V_271 -> V_519 = true ;
}
return V_126 ;
}
...
F_24 ( L_112 , V_327 , V_144 -> V_44 . V_444 . V_64 ) ;
V_90 = V_144 -> V_44 . V_444 . V_90 ;
if ( V_90 != 1 && V_90 != 2 )
V_90 = 0 ;
F_24 ( L_113 , V_327 , V_90 ) ;
V_525 -> V_527 = V_90 ;
return V_126 ;
}
...
V_144 -> V_159 [ 4 ] == 0xff && V_144 -> V_159 [ 5 ] == 0xff )
return - V_142 ;
V_126 = F_127 ( V_2 , V_144 -> V_159 ) ;
return V_126 ;
}
static int F_128 ( struct V_124 * V_125 , struct V_143 * V_144 , int V_345 )
{
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
if ( F_20 ( V_8 , V_247 ) != true )
return - V_142 ;
F_129 ( V_2 , V_144 -> V_44 . V_326 . V_437 ) ;
return V_126 ;
}
static int F_130 ( struct V_124 * V_125 , struct V_389 * V_33 )
{
struct V_143 * V_144 ;
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
...
break;
case V_529 :
V_126 = F_110 ( V_125 , V_144 ) ;
break;
case V_530 :
V_126 = F_112 ( V_125 , V_144 ) ;
break;
case V_531 :
V_126 = F_105 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_532 :
V_126 = F_104 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_533 :
V_126 = F_118 ( V_125 , V_144 ) ;
break;
case V_534 :
V_126 = F_119 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_535 :
...
break;
case V_538 :
V_126 = F_117 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_539 :
V_126 = F_128 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_540 :
...
F_34 ( V_8 -> V_549 ) ;
V_8 -> V_549 = NULL ;
V_8 -> V_549 = F_27 ( V_544 ) ;
if ( V_8 -> V_549 == NULL ) {
F_134 ( L_111 , V_327 , __LINE__ ) ;
V_126 = - V_142 ;
goto V_550;
}
...
V_126 = F_62 ( V_125 , V_21 , V_306 , V_542 ) ;
goto V_550;
}
V_550:
F_133 ( V_542 ) ;
...
static struct V_551 * F_135 ( struct V_124 * V_125 )
{
struct V_1 * V_2 = (struct V_1 * ) F_23 ( V_125 ) ;
...
int F_136 ( struct V_124 * V_125 , struct V_558 * V_559 , int V_43 )
{
...
#ifdef F_137
case V_563 :
V_126 = F_130 ( V_125 , & V_561 -> V_44 . V_47 ) ;
break;
#endif
case ( V_564 + 1 ) :
V_126 = F_138 ( V_125 , V_559 , V_43 ) ;
break;
default:
V_126 = - V_174 ;
break;
