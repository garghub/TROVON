...
( V_203 -> V_27 + V_203 -> V_26 ) == V_207 -> V_228 ) {
V_203 -> V_26 += V_207 -> V_229 << 12 ;
continue;
}
if ( V_198 == F_40 ( V_78 -> V_202 ) ) {
T_7 V_230 = ( V_204 - V_84 ) * sizeof( struct V_200 ) +
sizeof( struct V_62 ) ;
if ( ! V_197 || V_201 < V_230 )
return V_19 ;
V_202 = (struct V_200 * ) V_197 -> V_60 ;
}
V_202 -> V_27 = V_207 -> V_228 ;
V_202 -> V_26 = V_207 -> V_229 << V_231 ;
V_202 -> type = V_208 ;
V_203 = V_202 ++ ;
V_198 ++ ;
}
if ( V_198 > F_40 ( V_78 -> V_202 ) ) {
T_7 V_232 = V_198 - F_40 ( V_78 -> V_202 ) ;
F_38 ( V_78 , V_197 , V_232 ) ;
V_198 -= V_232 ;
}
V_78 -> V_233 = ( T_14 ) V_198 ;
return V_16 ;
}
static T_1 F_41 ( T_7 V_204 , struct V_62 * * V_197 ,
T_7 * V_201 )
{
T_1 V_8 ;
unsigned long V_26 ;
...
static T_1 F_42 ( struct V_77 * V_77 ,
void * V_3 , bool V_25 )
{
...
V_201 = 0 ;
V_241:
V_8 = F_43 ( V_17 , & V_237 , & V_234 , & V_236 ,
& V_239 , & V_235 ) ;
if ( V_8 != V_16 )
return V_8 ;
V_238 = V_204 ;
V_204 = V_234 / V_236 ;
if ( V_204 > V_238 &&
V_204 > F_40 ( V_77 -> V_202 ) ) {
T_7 V_232 = V_204 - F_40 ( V_77 -> V_202 ) ;
V_8 = F_41 ( V_232 , & V_197 , & V_201 ) ;
if ( V_8 != V_16 )
goto V_242;
F_4 ( V_23 , V_237 ) ;
goto V_241;
}
V_179 = V_25 ? V_243 : V_244 ;
memcpy ( & V_169 -> V_245 , V_179 , sizeof( T_21 ) ) ;
V_169 -> V_246 = ( unsigned long ) V_17 ;
V_169 -> V_206 = V_236 ;
V_169 -> V_247 = V_239 ;
V_169 -> V_209 = ( unsigned long ) V_237 ;
V_169 -> V_205 = V_234 ;
#ifdef F_44
V_169 -> V_248 = ( unsigned long ) V_17 >> 32 ;
V_169 -> V_249 = ( unsigned long ) V_237 >> 32 ;
#endif
V_8 = F_4 ( V_250 , V_3 , V_235 ) ;
if ( V_8 != V_16 ) {
if ( V_240 )
goto V_242;
V_240 = true ;
...
bool V_25 ;
V_12 = V_162 ;
V_256 = ( T_9 * ) ( unsigned long ) V_12 -> V_39 ;
V_3 = ( void * ) ( unsigned long ) V_12 -> V_178 ;
V_25 = V_12 -> V_25 ;
V_17 = V_256 ;
if ( V_17 -> V_85 . V_179 != V_180 )
...
F_19 ( V_77 ) ;
V_8 = F_4 ( V_21 , V_22 ,
sizeof( * V_253 ) , ( void * * ) & V_253 ) ;
if ( V_8 != V_16 ) {
F_2 ( V_17 , L_16 ) ;
goto V_187;
}
V_253 -> V_26 = 0x800 ;
V_8 = F_33 ( V_17 , V_253 -> V_26 , 8 ,
( unsigned long * ) & V_253 -> V_257 ) ;
if ( V_8 != V_16 ) {
F_2 ( V_17 , L_17 ) ;
goto V_187;
}
if ( V_85 -> V_258 != V_85 -> V_259 ) {
unsigned long V_260 = V_85 -> V_259 ;
V_8 = F_46 ( V_17 , & V_260 ,
V_85 -> V_261 , V_85 -> V_261 ,
V_85 -> V_258 ,
V_85 -> V_262 ) ;
if ( V_8 != V_16 ) {
F_2 ( V_17 , L_18 ) ;
...
V_85 -> V_258 = V_85 -> V_259 ;
V_85 -> V_259 = V_260 ;
}
V_8 = F_42 ( V_77 , V_3 , V_25 ) ;
if ( V_8 != V_16 ) {
F_2 ( V_17 , L_19 ) ;
goto V_187;
}
memset ( ( char * ) V_253 -> V_257 , 0x0 , V_253 -> V_26 ) ;
V_255 = (struct V_254 * ) V_253 -> V_257 ;
V_255 += 2 ;
V_255 -> V_263 = 0xffff ;
V_255 -> V_264 = 0x0000 ;
V_255 -> V_265 = 0x0000 ;
V_255 -> type = V_266 | V_267 ;
V_255 -> V_268 = V_269 ;
V_255 -> V_270 = 0 ;
V_255 -> V_271 = 1 ;
V_255 -> V_272 = 0xf ;
