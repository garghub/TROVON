...
unsigned long F_22 ( struct V_8 * V_33 )
{
...
{
if ( F_30 () )
return ( F_31 () & 0x7ffUL ) << V_44 ;
else
return ( F_31 () & 0x3ffffUL ) << V_44 ;
}
unsigned long F_32 ( struct V_45 * V_46 )
{
unsigned long V_47 = F_33 ( V_46 -> V_48 + F_29 () ) ;
if ( V_47 < V_46 -> V_48 )
return V_46 -> V_48 ;
return V_47 ;
}
