...
static void F_25 ( unsigned int V_63 , struct V_80 * V_81 )
{
T_1 V_26 ;
T_1 V_82 ;
T_1 V_56 ;
...
int V_84 = 0 ;
unsigned long V_5 ;
struct V_85 * V_86 = F_26 ( V_63 ) ;
struct V_2 * V_3 = F_27 ( V_81 ) ;
struct V_1 * V_7 = F_1 ( V_3 ) ;
F_28 ( V_86 , V_81 ) ;
F_4 ( & V_7 -> V_8 , V_5 ) ;
...
static int F_44 ( struct V_114 * V_76 )
{
int V_20 = 0 ;
int V_115 ;
struct V_116 * V_117 ;
...
return - V_119 ;
F_46 ( & V_7 -> V_8 ) ;
V_117 = F_47 ( V_76 , V_120 , 0 ) ;
if ( ! V_117 ) {
F_23 ( & V_76 -> V_77 , L_36 ) ;
return - V_22 ;
}
V_7 -> V_9 = F_48 ( & V_76 -> V_77 , V_117 -> V_121 ,
F_49 ( V_117 ) ) ;
if ( F_50 ( V_7 -> V_9 ) )
return F_51 ( V_7 -> V_9 ) ;
V_115 = F_52 ( V_76 , 0 ) ;
...
V_7 -> V_3 . V_127 = F_13 ;
V_7 -> V_3 . V_9 = 0 ;
V_7 -> V_3 . V_128 = V_76 -> V_96 ;
V_7 -> V_3 . V_129 = V_130 ;
V_7 -> V_3 . V_77 = & V_76 -> V_77 ;
V_7 -> V_3 . V_131 = V_132 ;
#if F_53 ( V_133 )
V_7 -> V_3 . V_134 = V_76 -> V_77 . V_134 ;
#endif
V_7 -> V_95 = V_135 ;
V_7 -> V_93 = F_54 ( V_135 ) ;
V_136 . V_96 = F_55 ( & V_76 -> V_77 ) ;
...
if ( V_20 )
goto V_139;
V_20 = F_58 ( & V_7 -> V_3 , F_55 ( & V_76 -> V_77 ) ,
0 , 0 , V_132 ) ;
if ( V_20 ) {
F_23 ( & V_76 -> V_77 , L_39 ) ;
goto V_140;
...
static int F_65 ( struct V_114 * V_76 )
{
struct V_1 * V_7 ;
V_7 = F_66 ( V_76 ) ;
F_63 ( & V_7 -> V_3 ) ;
