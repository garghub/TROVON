...
if ( V_7 < sizeof( * V_9 ) )
return V_7 ;
if ( ! F_6 ( NULL , & V_23 , V_21 ,
V_9 -> V_13 , sizeof( * V_9 ) , V_7 ) )
return F_7 ( T_1 , V_23 . V_24 , sizeof( * V_9 ) ) ;
...
F_12 ( V_2 , V_10 ) ;
V_9 = F_13 ( V_2 ) ;
if ( F_14 ( F_15 ( V_9 -> V_17 ) ) ) {
if ( F_16 ( V_9 -> V_17 , V_4 -> V_27 ) )
V_2 -> V_28 = V_29 ;
else
V_2 -> V_28 = V_30 ;
}
else if ( F_14 ( ! F_16 ( V_9 -> V_17 ,
V_4 -> V_14 ) ) )
V_2 -> V_28 = V_31 ;
if ( F_14 ( F_17 ( V_4 ) ) )
return F_3 ( V_32 ) ;
if ( F_18 ( F_19 ( V_9 -> V_13 ) >= V_33 ) )
return V_9 -> V_13 ;
V_26 = F_20 ( V_2 , 0 , sizeof( * V_26 ) , & V_25 ) ;
if ( V_26 && * V_26 == 0xFFFF )
return F_3 ( V_11 ) ;
return F_3 ( V_12 ) ;
}
int F_21 ( const struct V_1 * V_2 , unsigned char * V_34 )
{
const struct V_8 * V_9 = F_13 ( V_2 ) ;
