...
{
int V_63 ;
struct V_5 * V_93 = F_2 ( V_2 -> V_7 . V_8 ) ;
struct V_13 * V_14 ;
V_2 -> V_94 |= V_95 ;
V_2 -> V_94 |= V_96 ;
...
static int F_21 ( struct V_1 * V_2 , struct V_100 * V_55 ,
T_5 * V_101 , int V_102 )
{
struct V_13 * V_14 = F_3 ( V_2 ) ;
if ( ( V_14 -> V_98 ) &&
