...
static int F_51 ( struct V_2 * V_3 , struct V_126 * V_127 )
{
struct V_88 * V_89 = F_43 ( V_3 , V_127 -> V_128 , 0 ) ;
...
static int F_52 ( struct V_2 * V_3 , int V_129 )
{
struct V_1 * V_76 = F_1 ( V_3 ) ;
int V_12 ;
F_6 ( 1 , V_19 , V_3 , L_13 , V_129 ? L_14 : L_15 ) ;
if ( V_129 ) {
V_12 = F_34 ( V_76 ) ;
if ( V_12 < 0 )
return V_12 ;
...
{
F_54 ( V_3 -> V_130 , V_3 -> V_131 ) ;
return 0 ;
}
static int F_55 ( struct V_1 * V_76 )
{
struct V_4 * V_5 = F_13 ( & V_76 -> V_3 ) ;
const struct V_54 * V_132 = & V_76 -> V_77 -> V_133 ;
int V_12 ;
V_12 = F_23 ( V_5 , V_132 ) ;
if ( ! V_12 )
V_12 = F_24 ( V_5 , V_132 ) ;
...
if ( ! V_12 )
V_12 = F_9 ( V_5 , V_137 , 0 ) ;
if ( ! V_12 )
V_12 = F_9 ( V_5 , V_138 , 1 ) ;
if ( ! V_12 )
V_12 = F_9 ( V_5 , V_139 , 1 ) ;
if ( ! V_12 )
V_12 = F_9 ( V_5 , V_140 , 1 ) ;
return V_12 ;
}
static int F_64 ( struct V_1 * V_76 , int V_129 )
{
struct V_4 * V_5 = F_13 ( & V_76 -> V_3 ) ;
int V_12 ;
if ( V_129 && V_76 -> V_113 ) {
...
V_12 = F_9 ( V_5 , V_141 , V_129 ) ;
if ( V_12 < 0 )
return V_12 ;
return F_9 ( V_5 , V_142 , 1 ) ;
}
static int F_65 ( struct V_2 * V_3 , int V_129 )
{
struct V_1 * V_76 = F_1 ( V_3 ) ;
int V_12 = 0 ;
F_6 ( 1 , V_19 , V_3 , L_16 , V_129 ? L_14 : L_15 ) ;
F_44 ( & V_76 -> V_106 ) ;
if ( V_76 -> V_87 == ! V_129 ) {
V_12 = F_64 ( V_76 , V_129 ) ;
if ( ! V_12 )
V_76 -> V_87 = V_129 & 1 ;
}
F_45 ( & V_76 -> V_106 ) ;
...
static int F_66 ( int V_143 , int V_7 , const char * V_131 )
{
unsigned long V_13 = V_7 ? V_144 : V_145 ;
int V_12 ;
if ( ! F_32 ( V_143 ) )
return 0 ;
V_12 = F_67 ( V_143 , V_13 , V_131 ) ;
if ( ! V_12 )
F_68 ( V_143 , 0 ) ;
return V_12 ;
}
...
{
const struct V_148 * V_81 = & V_147 -> V_149 ;
int V_12 ;
...
struct V_154 * V_155 = & V_76 -> V_117 ;
int V_12 ;
V_12 = F_73 ( V_155 , 4 ) ;
if ( V_12 )
return V_12 ;
F_74 ( V_155 , V_152 , V_124 , - 208 , 127 , 1 , 0 ) ;
F_74 ( V_155 , V_152 , V_118 , - 127 , 127 , 1 , 0 ) ;
F_74 ( V_155 , V_152 , V_120 , - 127 , 127 , 1 , 0 ) ;
F_74 ( V_155 , V_152 , V_122 , - 32704 / V_123 ,
24612 / V_123 , 1 , 2 ) ;
if ( V_155 -> error ) {
V_12 = V_155 -> error ;
F_75 ( V_155 ) ;
...
V_76 -> V_3 . V_130 = V_155 ;
return 0 ;
}
static int F_76 ( struct V_4 * V_5 ,
const struct V_156 * V_80 )
{
struct V_146 * V_147 = V_5 -> V_27 . V_157 ;
struct V_2 * V_3 ;
struct V_1 * V_76 ;
int V_12 , V_40 ;
if ( V_147 == NULL ) {
...
V_76 = F_77 ( & V_5 -> V_27 , sizeof( struct V_1 ) , V_158 ) ;
if ( ! V_76 )
return - V_159 ;
F_78 ( & V_76 -> V_106 ) ;
V_76 -> V_87 = 0 ;
V_3 = & V_76 -> V_3 ;
F_79 ( V_3 , V_5 , & V_160 ) ;
F_80 ( V_3 -> V_131 , V_161 , sizeof( V_3 -> V_131 ) ) ;
V_3 -> V_162 = & V_163 ;
V_3 -> V_13 |= V_164 ;
V_76 -> V_128 . V_13 = V_165 ;
V_3 -> V_166 . type = V_167 ;
V_12 = F_81 ( & V_3 -> V_166 , 1 , & V_76 -> V_128 , 0 ) ;
if ( V_12 )
return V_12 ;
V_12 = F_71 ( V_76 , V_147 ) ;
if ( V_12 ) {
F_11 ( & V_5 -> V_27 , L_20 ) ;
goto V_168;
}
for ( V_40 = 0 ; V_40 < V_82 ; V_40 ++ )
V_76 -> V_83 [ V_40 ] . V_169 = V_170 [ V_40 ] ;
