...
static int F_81 ( const struct V_138 * V_127 )
{
F_82 ( L_17 , V_127 -> V_139 ) ;
return 1 ;
}
...
if ( F_84 ( V_141 ) )
return;
V_13 = F_85 ( sizeof( struct V_1 ) , V_142 ) ;
if ( ! V_13 )
return;
V_140 = F_86 () ;
if ( ! V_140 ) {
...
F_87 ( V_9 , & V_140 -> V_4 ,
& V_143 , V_144 ) ;
F_88 ( V_9 , & V_13 -> V_4 . V_4 , & V_145 ,
V_146 ) ;
F_89 ( V_140 , & V_13 -> V_4 ) ;
V_13 -> V_4 . type = V_89 ;
V_13 -> V_4 . V_147 = ( 1 << V_148 ) | ( 1 << V_149 ) ;
if ( F_90 ( V_9 ) )
V_13 -> V_4 . V_150 = ( 1 << 0 ) ;
else
V_13 -> V_4 . V_150 = ( 1 << 0 ) | ( 1 << 1 ) | ( 1 << 2 ) ;
if ( F_38 ( V_9 ) )
V_6 -> V_151 = 0 ;
else
V_6 -> V_151 = 1 ;
