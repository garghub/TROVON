...
static int F_43 ( struct V_119 * V_50 )
{
...
static int F_48 ( struct V_127 * V_128 , const struct V_129 * V_11 )
{
struct V_1 * V_2 ;
int V_6 ;
if ( ! F_49 ( V_128 -> V_130 , V_131 ) )
return - V_9 ;
if ( V_128 -> V_50 . V_124 ) {
V_6 = F_43 ( & V_128 -> V_50 ) ;
if ( V_6 )
...
V_2 = F_35 ( & V_128 -> V_50 , sizeof( * V_2 ) , V_106 ) ;
if ( ! V_2 )
return - V_107 ;
V_2 -> V_8 = V_128 ;
V_2 -> V_50 = & V_128 -> V_50 ;
V_2 -> V_33 = V_128 -> V_50 . V_126 ;
F_50 ( V_128 , V_2 ) ;
F_51 ( & V_2 -> V_7 ) ;
V_6 = F_9 ( V_2 ) ;
if ( V_6 ) {
...
static int F_52 ( struct V_127 * V_128 )
{
