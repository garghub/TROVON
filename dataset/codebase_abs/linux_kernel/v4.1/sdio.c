...
static int F_40 ( struct V_143 * V_32 , T_1 V_23 ,
struct V_12 * V_144 , int V_145 )
{
struct V_12 * V_5 ;
int V_80 ;
int V_146 = 10 ;
...
if ( ! V_145 ) {
V_80 = F_42 ( V_32 , V_23 , & V_147 ) ;
if ( V_80 )
goto V_80;
}
if ( F_38 ( V_32 ) ) {
V_80 = F_43 ( V_32 , V_151 ) ;
if ( V_80 )
goto V_80;
}
V_5 = F_44 ( V_32 , NULL ) ;
...
if ( ( V_147 & V_152 ) &&
F_45 ( V_32 , V_23 & V_147 , V_5 -> V_153 , NULL ) == 0 ) {
V_5 -> type = V_89 ;
if ( V_144 && ( V_144 -> type != V_89 ||
memcmp ( V_5 -> V_153 , V_144 -> V_153 , sizeof( V_5 -> V_153 ) ) != 0 ) ) {
F_46 ( V_5 ) ;
return - V_154 ;
}
} else {
V_5 -> type = V_81 ;
if ( V_144 && V_144 -> type != V_81 ) {
F_46 ( V_5 ) ;
return - V_154 ;
}
}
...
if ( ! V_145 && ( V_147 & V_23 & V_26 ) ) {
V_80 = F_47 ( V_32 , V_156 ,
V_23 ) ;
if ( V_80 == - V_157 ) {
F_48 ( V_32 ) ;
F_49 ( V_32 ) ;
F_50 ( V_32 , V_32 -> V_158 ) ;
F_46 ( V_5 ) ;
V_146 -- ;
goto V_150;
} else if ( V_80 ) {
...
if ( ! V_145 && ! F_38 ( V_32 ) ) {
V_80 = F_51 ( V_32 , & V_5 -> V_159 ) ;
if ( V_80 )
goto remove;
if ( V_144 )
V_144 -> V_159 = V_5 -> V_159 ;
}
if ( ! V_144 && V_5 -> type == V_89 ) {
V_80 = F_52 ( V_32 , V_5 ) ;
if ( V_80 )
return V_80 ;
F_53 ( V_5 ) ;
...
goto remove;
if ( V_144 ) {
int V_162 = ( V_5 -> V_19 . V_18 == V_144 -> V_19 . V_18 &&
V_5 -> V_19 . V_20 == V_144 -> V_19 . V_20 ) ;
F_46 ( V_5 ) ;
if ( ! V_162 )
return - V_154 ;
V_5 = V_144 ;
...
static void F_58 ( struct V_143 * V_32 )
{
int V_165 ;
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
...
static int F_59 ( struct V_143 * V_32 )
{
return F_54 ( V_32 -> V_5 ) ;
}
static void F_60 ( struct V_143 * V_32 )
{
int V_80 ;
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
if ( V_32 -> V_71 & V_167 ) {
V_80 = F_61 ( & V_32 -> V_5 -> V_163 ) ;
if ( V_80 < 0 ) {
F_62 ( & V_32 -> V_5 -> V_163 ) ;
goto V_10;
}
...
static int F_69 ( struct V_143 * V_32 )
{
int V_165 , V_80 = 0 ;
for ( V_165 = 0 ; V_165 < V_32 -> V_5 -> V_166 ; V_165 ++ ) {
struct V_1 * V_2 = V_32 -> V_5 -> V_1 [ V_165 ] ;
if ( V_2 && F_70 ( V_2 ) && V_2 -> V_163 . V_168 ) {
...
static int F_71 ( struct V_143 * V_32 )
{
if ( F_72 ( V_32 ) && F_73 ( V_32 ) ) {
F_63 ( V_32 ) ;
F_20 ( V_32 -> V_5 ) ;
F_65 ( V_32 ) ;
}
...
static int F_74 ( struct V_143 * V_32 )
{
int V_80 = 0 ;
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
...
if ( F_79 ( V_32 ) || ! F_72 ( V_32 ) ) {
F_48 ( V_32 ) ;
F_49 ( V_32 ) ;
F_50 ( V_32 , V_32 -> V_5 -> V_23 ) ;
V_80 = F_42 ( V_32 , 0 , NULL ) ;
if ( ! V_80 )
V_80 = F_40 ( V_32 , V_32 -> V_5 -> V_23 ,
V_32 -> V_5 ,
F_72 ( V_32 ) ) ;
...
if ( ! ( V_32 -> V_176 & V_177 ) ) {
F_80 ( V_32 -> V_178 ) ;
} else if ( V_32 -> V_71 & V_179 ) {
F_81 ( V_32 ) ;
V_32 -> V_107 -> V_180 ( V_32 , 1 ) ;
F_82 ( V_32 ) ;
}
}
F_65 ( V_32 ) ;
...
static int F_83 ( struct V_143 * V_32 )
{
int V_3 ;
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
...
F_49 ( V_32 ) ;
F_50 ( V_32 , V_32 -> V_5 -> V_23 ) ;
V_3 = F_42 ( V_32 , 0 , NULL ) ;
if ( V_3 )
goto V_10;
V_3 = F_40 ( V_32 , V_32 -> V_5 -> V_23 , V_32 -> V_5 ,
F_72 ( V_32 ) ) ;
if ( ! V_3 && V_32 -> V_175 )
F_84 ( V_32 ) ;
V_10:
...
static int F_85 ( struct V_143 * V_32 )
{
F_68 ( V_32 ) ;
return 0 ;
}
static int F_86 ( struct V_143 * V_32 )
{
F_75 ( V_32 , V_32 -> V_5 -> V_23 ) ;
return F_83 ( V_32 ) ;
}
int F_87 ( struct V_143 * V_32 )
{
int V_80 , V_165 , V_183 ;
T_1 V_23 , V_147 ;
struct V_12 * V_5 ;
F_6 ( ! V_32 ) ;
F_41 ( ! V_32 -> V_149 ) ;
V_80 = F_42 ( V_32 , 0 , & V_23 ) ;
if ( V_80 )
return V_80 ;
F_88 ( V_32 , & V_184 ) ;
if ( V_32 -> V_185 )
V_32 -> V_158 = V_32 -> V_185 ;
V_147 = F_89 ( V_32 , V_23 ) ;
if ( ! V_147 ) {
V_80 = - V_33 ;
goto V_80;
}
V_80 = F_40 ( V_32 , V_147 , NULL , 0 ) ;
if ( V_80 )
goto V_80;
V_5 = V_32 -> V_5 ;
if ( V_32 -> V_71 & V_167 ) {
...
V_183 = ( V_23 & 0x70000000 ) >> 28 ;
V_5 -> V_166 = 0 ;
for ( V_165 = 0 ; V_165 < V_183 ; V_165 ++ , V_5 -> V_166 ++ ) {
V_80 = F_5 ( V_32 -> V_5 , V_165 + 1 ) ;
if ( V_80 )
goto remove;
if ( V_32 -> V_71 & V_167 )
F_78 ( & V_5 -> V_1 [ V_165 ] -> V_163 ) ;
}
F_65 ( V_32 ) ;
V_80 = F_90 ( V_32 -> V_5 ) ;
if ( V_80 )
