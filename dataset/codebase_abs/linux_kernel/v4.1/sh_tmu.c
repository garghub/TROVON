...
V_2 -> V_17 ) ;
F_49 ( V_32 , 1 , 0x300 , 0xffffffff ) ;
V_18 = F_50 ( V_2 -> V_30 , F_25 ,
V_63 | V_64 | V_65 ,
F_51 ( & V_2 -> V_6 -> V_20 -> V_21 ) , V_2 ) ;
if ( V_18 ) {
...
static int F_52 ( struct V_1 * V_2 , const char * V_40 ,
bool V_66 , bool V_37 )
{
if ( V_66 ) {
V_2 -> V_6 -> V_67 = true ;
...
static int F_53 ( struct V_1 * V_2 , unsigned int V_17 ,
bool V_66 , bool V_37 ,
struct V_69 * V_6 )
{
if ( ! V_66 && ! V_37 )
...
V_2 -> V_39 = false ;
V_2 -> V_26 = 0 ;
return F_52 ( V_2 , F_51 ( & V_6 -> V_20 -> V_21 ) ,
V_66 , V_37 ) ;
}
static int F_55 ( struct V_69 * V_6 )
{
struct V_70 * V_71 ;
V_71 = F_56 ( V_6 -> V_20 , V_72 , 0 ) ;
if ( ! V_71 ) {
F_14 ( & V_6 -> V_20 -> V_21 , L_8 ) ;
return - V_73 ;
}
V_6 -> V_9 = F_57 ( V_71 -> V_14 , F_58 ( V_71 ) ) ;
if ( V_6 -> V_9 == NULL )
return - V_73 ;
return 0 ;
}
static int F_59 ( struct V_69 * V_6 )
{
struct V_74 * V_75 = V_6 -> V_20 -> V_21 . V_76 ;
V_6 -> V_7 = V_10 ;
V_6 -> V_77 = 3 ;
F_60 ( V_75 , L_9 , & V_6 -> V_77 ) ;
if ( V_6 -> V_77 != 2 && V_6 -> V_77 != 3 ) {
...
static int F_61 ( struct V_69 * V_6 , struct V_79 * V_20 )
{
unsigned int V_80 ;
int V_18 ;
V_6 -> V_20 = V_20 ;
F_62 ( & V_6 -> V_16 ) ;
if ( F_63 ( V_81 ) && V_20 -> V_21 . V_76 ) {
V_18 = F_59 ( V_6 ) ;
if ( V_18 < 0 )
return V_18 ;
} else if ( V_20 -> V_21 . V_82 ) {
const struct V_83 * V_84 = V_20 -> V_85 ;
struct V_86 * V_87 = V_20 -> V_21 . V_82 ;
V_6 -> V_7 = V_84 -> V_88 ;
V_6 -> V_77 = F_64 ( V_87 -> V_89 ) ;
} else {
F_14 ( & V_6 -> V_20 -> V_21 , L_11 ) ;
return - V_73 ;
}
V_6 -> V_19 = F_65 ( & V_6 -> V_20 -> V_21 , L_12 ) ;
if ( F_66 ( V_6 -> V_19 ) ) {
F_14 ( & V_6 -> V_20 -> V_21 , L_13 ) ;
return F_67 ( V_6 -> V_19 ) ;
}
V_18 = F_68 ( V_6 -> V_19 ) ;
if ( V_18 < 0 )
goto V_90;
...
V_6 -> V_92 = F_69 ( sizeof( * V_6 -> V_92 ) * V_6 -> V_77 ,
V_93 ) ;
if ( V_6 -> V_92 == NULL ) {
V_18 = - V_94 ;
goto V_95;
}
for ( V_80 = 0 ; V_80 < V_6 -> V_77 ; ++ V_80 ) {
V_18 = F_53 ( & V_6 -> V_92 [ V_80 ] , V_80 ,
V_80 == 0 , V_80 == 1 , V_6 ) ;
if ( V_18 < 0 )
goto V_95;
}
...
static int F_75 ( struct V_79 * V_20 )
{
struct V_69 * V_6 = F_76 ( V_20 ) ;
int V_18 ;
if ( ! F_77 ( V_20 ) ) {
F_78 ( & V_20 -> V_21 ) ;
F_79 ( & V_20 -> V_21 ) ;
...
static int F_82 ( struct V_79 * V_20 )
{
return - V_97 ;
}
