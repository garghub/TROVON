...
{
struct V_3 * V_4 ;
V_4 = F_42 ( sizeof( * V_4 ) , V_43 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_6 = V_6 ;
F_43 ( & V_4 -> V_2 ) ;
V_4 -> V_2 . V_44 = & V_6 -> V_2 ;
V_4 -> V_2 . V_45 = & V_46 ;
V_4 -> V_2 . type = & V_47 ;
return V_4 ;
}
struct V_5 * F_44 ( struct V_1 * V_44 ,
T_3 V_48 )
{
struct V_5 * V_6 ;
int V_49 ;
...
V_6 -> V_2 . V_45 = & V_46 ;
V_6 -> V_2 . V_44 = V_44 ;
V_6 -> V_2 . V_50 = V_44 -> V_50 ;
F_46 ( V_6 , & V_6 [ 1 ] ) ;
V_49 = F_47 ( & V_7 , 0 , 0 , V_43 ) ;
if ( V_49 < 0 ) {
F_13 ( V_44 ,
L_4 ) ;
F_48 ( V_6 ) ;
...
V_6 -> V_8 = V_49 ;
F_11 ( & V_6 -> V_2 , L_5 , V_49 ) ;
F_14 ( & V_6 -> V_2 , L_6 , V_6 , V_49 ) ;
return V_6 ;
}
...
struct V_3 * V_4 ;
T_4 V_53 [ 2 ] ;
F_14 ( & V_6 -> V_2 , L_7 , V_52 -> V_54 ) ;
V_13 = F_51 ( V_52 , L_8 , V_53 , 2 ) ;
if ( V_13 ) {
F_13 ( & V_6 -> V_2 ,
L_9 ,
V_52 -> V_54 , V_13 ) ;
