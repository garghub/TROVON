...
int F_93 ( struct V_9 * V_13 , unsigned int V_77 )
{
V_13 = V_13 -> V_61 ;
if ( V_13 -> V_3 -> V_78 )
return V_13 -> V_3 -> V_78 ( V_13 , V_77 ) ;
return - V_75 ;
}
int F_94 ( struct V_9 * V_13 , struct V_79 * V_80 )
{
struct V_9 * V_81 = NULL ;
#ifdef F_68
for (; V_13 ; V_13 = V_13 -> V_61 )
#endif
if ( V_13 -> V_3 && V_13 -> V_3 -> V_82 )
V_81 = V_13 ;
if ( ! V_81 )
return - V_75 ;
V_81 -> V_3 -> V_82 ( V_81 , V_80 ) ;
return 0 ;
}
