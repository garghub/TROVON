...
int V_30 ;
T_1 * V_61 ;
V_61 = F_33 ( V_59 , sizeof( * V_61 ) , V_9 ) ;
if ( ! V_61 )
return - V_10 ;
...
static int F_36 ( struct V_21 * V_14 , void * V_63 )
{
struct V_1 * V_2 ;
const struct V_3 * V_4 ;
T_1 * * V_6 = V_63 ;
...
int F_40 ( const char * V_4 , const char * * V_64 , T_2 V_65 )
{
struct V_3 V_66 ;
struct V_21 * V_14 ;
struct V_1 * V_2 ;
int V_60 ;
V_14 = F_41 ( & V_67 , NULL , V_4 ) ;
if ( ! V_14 ) {
F_42 ( V_68 L_1 , V_4 ) ;
return - V_69 ;
}
