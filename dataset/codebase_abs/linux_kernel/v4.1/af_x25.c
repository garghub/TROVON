...
* V_199 ++ = ( ( V_83 -> V_51 >> 8 ) & 0x0F ) | V_217 ;
* V_199 ++ = ( V_83 -> V_51 >> 0 ) & 0xFF ;
* V_199 ++ = V_218 ;
} else {
V_199 = F_100 ( V_2 , V_184 ) ;
* V_199 ++ = ( ( V_83 -> V_51 >> 8 ) & 0x0F ) | V_219 ;
* V_199 ++ = ( V_83 -> V_51 >> 0 ) & 0xFF ;
* V_199 ++ = V_218 ;
}
} else {
...
case V_268 : {
F_59 ( V_19 ) ;
V_8 = F_57 ( V_229 , & V_83 -> V_269 , sizeof( V_83 -> V_269 ) )
? - V_72 : 0 ;
F_60 ( V_19 ) ;
break;
}
