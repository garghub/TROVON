...
static int F_8 ( struct V_1 * V_2 , void * V_46 )
{
struct V_47 * V_48 = (struct V_47 * ) V_2 -> V_49 ;
...
static int F_10 ( struct V_1 * V_2 , void * V_46 )
{
struct V_47 * V_48 = (struct V_47 * ) V_2 -> V_49 ;
char V_97 [ 25 ] ;
int V_98 ;
...
static int F_12 ( struct V_1 * V_2 , void * V_46 )
{
struct V_47 * V_48 = (struct V_47 * ) V_2 -> V_49 ;
static V_16 V_121 [ 5 ] ;
...
V_124 =
F_13 ( V_48 -> V_127 , 0x0000 , - 1 , & V_121 , sizeof( V_121 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 , L_142 ) ;
return 0 ;
}
...
T_5 V_143 ;
char V_38 [ 28 + 1 ] ;
V_145 = F_15 ( sizeof( * V_145 ) , V_146 ) ;
if ( ! V_145 )
return - V_44 ;
V_124 = F_16 ( V_48 -> V_127 , V_147 , 0x0003 , - 1 ,
...
int V_124 ;
V_124 =
F_13 ( V_48 -> V_127 , 0x0004 , - 1 , & V_121 , sizeof( V_121 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 , L_168 ) ;
return 0 ;
}
...
T_6 * V_155 ;
char V_38 [ 28 + 1 ] ;
V_145 = F_15 ( sizeof( T_7 ) , V_146 ) ;
if ( V_145 == NULL )
return - V_44 ;
V_124 = F_16 ( V_48 -> V_127 , V_147 , 0x0005 , - 1 ,
NULL , 0 , V_145 , sizeof( * V_145 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 ,
L_173 ) ;
...
if ( ! V_145 )
return - V_44 ;
V_124 = F_16 ( V_157 , V_147 , 0xF000 , - 1 , NULL , 0 ,
V_145 , sizeof( * V_145 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 , L_180 ) ;
goto V_148;
...
V_124 = F_16 ( V_157 , V_147 , 0xF001 , - 1 , NULL , 0 ,
& V_145 , sizeof( V_145 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 ,
L_191 ) ;
...
V_124 = F_16 ( V_157 , V_147 , 0xF002 , - 1 , NULL , 0 ,
& V_145 , sizeof( V_145 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 , L_195 ) ;
return 0 ;
...
if ( ! V_145 )
return - V_44 ;
V_124 = F_16 ( V_157 , V_147 , 0xF003 , - 1 , NULL , 0 ,
V_145 , sizeof( * V_145 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 , L_197 ) ;
goto V_148;
...
V_124 = F_16 ( V_157 , V_147 , 0xF006 , - 1 , NULL , 0 ,
& V_145 , sizeof( V_145 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 ,
L_207 ) ;
...
int V_124 ;
char V_38 [ 16 + 1 ] ;
V_124 = F_13 ( V_157 , 0xF100 , - 1 , & V_121 , sizeof( V_121 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 , L_209 ) ;
return 0 ;
}
...
static int F_27 ( struct V_1 * V_2 , void * V_46 )
{
struct V_156 * V_157 = (struct V_156 * ) V_2 -> V_49 ;
F_2 ( V_2 , L_146 , F_28 ( & V_157 -> V_175 ) ) ;
return 0 ;
}
...
char V_38 [ 24 + 1 ] ;
V_124 = F_13 ( V_157 , 0xF101 , - 1 , & V_145 , sizeof( V_145 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 , L_218 ) ;
return 0 ;
}
...
char V_38 [ 64 + 1 ] ;
V_124 = F_13 ( V_157 , 0xF102 , - 1 , & V_145 , sizeof( V_145 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 , L_223 ) ;
return 0 ;
}
...
static T_1 * V_122 = ( T_1 * ) V_121 ;
int V_124 ;
V_124 = F_13 ( V_157 , 0xF103 , - 1 , & V_121 , sizeof( V_121 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 ,
L_228 ) ;
return 0 ;
...
static int F_32 ( struct V_1 * V_2 , void * V_46 )
{
struct V_156 * V_157 = (struct V_156 * ) V_2 -> V_49 ;
int V_124 ;
struct {
...
V_124 = F_13 ( V_157 , 0xF200 , - 1 , & V_145 , sizeof( V_145 ) ) ;
if ( V_124 < 0 ) {
F_5 ( V_2 , V_124 ,
L_242 ) ;
return 0 ;
...
F_57 ( L_301 , V_217 -> V_221 -> V_214 , V_218 ) ;
V_219 = F_58 ( V_218 , 0 , V_211 , V_217 ) ;
if ( ! V_219 ) {
F_59 ( L_302 ) ;
return;
}
F_54 ( V_219 , V_222 , V_217 ) ;
...
if ( V_212 )
F_54 ( V_219 , V_212 , V_217 ) ;
}
static int F_60 ( struct V_210 * V_211 ,
struct V_47 * V_48 )
{
struct V_210 * V_224 ;
struct V_156 * V_217 ;
F_57 ( L_303 , V_48 -> V_214 ) ;
V_224 = F_58 ( V_48 -> V_214 , 0 , V_211 , V_48 ) ;
if ( ! V_224 )
return - 1 ;
F_54 ( V_224 , V_225 , V_48 ) ;
F_61 (dev, &c->devices, list)
F_56 ( V_224 , V_217 ) ;
return 0 ;
}
static int T_12 F_62 ( void )
{
struct V_47 * V_48 ;
V_226 = F_63 ( L_304 , NULL ) ;
if ( ! V_226 )
return - 1 ;
F_61 (c, &i2o_controllers, list)
F_60 ( V_226 , V_48 ) ;
return 0 ;
}
static int T_13 F_64 ( void )
{
F_65 ( L_304 , NULL ) ;
return 0 ;
}
...
{
int V_227 ;
F_67 (KERN_INFO OSM_DESCRIPTION L_305 OSM_VERSION L_75 ) ;
V_227 = F_68 ( & V_228 ) ;
if ( V_227 )
return V_227 ;
V_227 = F_62 () ;
