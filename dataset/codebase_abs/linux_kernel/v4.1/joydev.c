...
static bool F_66 ( struct V_58 * V_42 )
{
F_67 ( V_124 , V_125 ) ;
F_68 ( V_126 > V_125 || V_127 > V_125 ) ;
F_69 ( V_124 , V_127 ) ;
F_70 ( V_32 , V_124 ) ;
F_70 ( V_27 , V_124 ) ;
F_70 ( V_128 , V_124 ) ;
if ( ! F_71 ( V_124 , V_42 -> V_129 , V_127 ) )
return false ;
F_69 ( V_124 , V_126 ) ;
F_70 ( V_130 , V_124 ) ;
F_70 ( V_131 , V_124 ) ;
if ( ! F_71 ( V_42 -> V_132 , V_124 , V_126 ) )
return false ;
F_69 ( V_124 , V_125 ) ;
F_70 ( V_133 , V_124 ) ;
F_70 ( V_134 , V_124 ) ;
F_70 ( V_135 , V_124 ) ;
if ( ! F_71 ( V_42 -> V_136 , V_124 , V_125 ) )
return false ;
if ( V_42 -> V_137 . V_138 == V_139 )
return false ;
return true ;
}
static bool F_72 ( struct V_140 * V_141 , struct V_58 * V_42 )
{
...
static int F_73 ( struct V_140 * V_141 , struct V_58 * V_42 ,
const struct V_144 * V_137 )
{
struct V_11 * V_11 ;
int V_67 , V_145 , V_146 , V_147 , V_148 ;
int error ;
V_147 = F_74 ( V_149 , V_150 , true ) ;
if ( V_147 < 0 ) {
error = V_147 ;
F_75 ( L_1 , error ) ;
return error ;
...
V_148 -= V_149 ;
F_79 ( & V_11 -> V_42 , L_2 , V_148 ) ;
V_11 -> V_24 . V_42 = F_80 ( V_42 ) ;
V_11 -> V_24 . V_92 = F_81 ( & V_11 -> V_42 ) ;
V_11 -> V_24 . V_141 = V_141 ;
V_11 -> V_24 . V_26 = V_11 ;
for ( V_67 = 0 ; V_67 < V_126 ; V_67 ++ )
if ( F_39 ( V_67 , V_42 -> V_132 ) ) {
...
if ( F_82 ( V_42 , V_145 ) == F_83 ( V_42 , V_145 ) ) {
V_11 -> V_3 [ V_67 ] . type = V_4 ;
V_11 -> abs [ V_67 ] = F_57 ( V_42 , V_145 ) ;
continue;
}
V_11 -> V_3 [ V_67 ] . type = V_5 ;
V_11 -> V_3 [ V_67 ] . V_153 = F_84 ( V_42 , V_145 ) ;
V_146 = ( F_82 ( V_42 , V_145 ) + F_83 ( V_42 , V_145 ) ) / 2 ;
V_11 -> V_3 [ V_67 ] . V_6 [ 0 ] = V_146 - F_85 ( V_42 , V_145 ) ;
V_11 -> V_3 [ V_67 ] . V_6 [ 1 ] = V_146 + F_85 ( V_42 , V_145 ) ;
V_146 = ( F_82 ( V_42 , V_145 ) - F_83 ( V_42 , V_145 ) ) / 2
- 2 * F_85 ( V_42 , V_145 ) ;
if ( V_146 ) {
...
V_11 -> V_42 . V_154 = F_86 ( V_155 , V_147 ) ;
V_11 -> V_42 . V_156 = & V_157 ;
V_11 -> V_42 . V_158 = & V_42 -> V_42 ;
V_11 -> V_42 . V_159 = F_14 ;
F_87 ( & V_11 -> V_42 ) ;
error = F_88 ( & V_11 -> V_24 ) ;
if ( error )
goto V_160;
F_89 ( & V_11 -> V_54 , & V_161 ) ;
V_11 -> V_54 . V_162 . V_158 = & V_11 -> V_42 . V_162 ;
error = F_90 ( & V_11 -> V_54 , V_11 -> V_42 . V_154 , 1 ) ;
if ( error )
goto V_163;
error = F_91 ( & V_11 -> V_42 ) ;
if ( error )
goto V_164;
return 0 ;
V_164:
