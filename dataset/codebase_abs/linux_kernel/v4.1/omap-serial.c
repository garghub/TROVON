...
V_2 -> V_4 . V_303 = & V_304 ;
if ( V_293 -> V_14 . V_286 )
V_101 = F_123 ( V_293 -> V_14 . V_286 , L_23 ) ;
else
V_101 = V_293 -> V_305 ;
if ( V_101 < 0 ) {
F_124 ( & V_293 -> V_14 , L_24 ,
V_101 ) ;
goto V_306;
}
V_2 -> V_4 . line = V_101 ;
if ( V_2 -> V_4 . line >= V_307 ) {
F_124 ( & V_293 -> V_14 , L_25 , V_2 -> V_4 . line ,
V_307 ) ;
V_101 = - V_308 ;
goto V_306;
}
...
F_136 ( & V_293 -> V_14 ) ;
F_137 ( & V_2 -> V_161 ) ;
F_129 ( V_2 -> V_14 , false ) ;
V_309:
V_306:
return V_101 ;
}
static int F_138 ( struct V_292 * V_14 )
{
struct V_1 * V_2 = F_139 ( V_14 ) ;
F_140 ( V_2 -> V_14 ) ;
F_136 ( V_2 -> V_14 ) ;
F_141 ( & V_266 , & V_2 -> V_4 ) ;
F_137 ( & V_2 -> V_161 ) ;
