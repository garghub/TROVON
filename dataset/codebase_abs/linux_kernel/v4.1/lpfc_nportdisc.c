...
V_46 = (struct V_45 * ) V_43 -> V_52 ;
V_48 = ( T_1 * ) V_46 -> V_54 ;
V_179 = ( T_7 * ) ( ( V_55 * ) V_48 + sizeof ( T_1 ) ) ;
V_4 -> V_122 &= ~ ( V_158 | V_177 ) ;
V_4 -> V_108 &= ~ V_183 ;
V_4 -> V_8 &= ~ V_184 ;
...
T_5 * V_198 ;
int V_86 ;
V_198 = ( T_5 * ) F_30 ( V_41 -> V_129 ,
V_130 ) ;
if ( ! V_198 )
F_3 ( V_2 , V_35 , V_199 ,
L_13 ) ;
else {
F_56 ( V_41 , V_2 -> V_136 , V_197 , V_198 ) ;
V_198 -> V_132 = V_133 ;
V_86 = F_32 ( V_41 , V_198 , V_134 ) ;
if ( V_86 == V_135 )
F_33 ( V_198 , V_41 -> V_129 ) ;
}
}
static T_1
F_57 ( struct V_1 * V_2 , struct V_3 * V_4 ,
void * V_200 , T_1 V_201 )
{
struct V_40 * V_41 ;
T_5 * V_198 = ( T_5 * ) V_200 ;
T_9 * V_202 ;
T_2 V_197 ;
V_41 = V_2 -> V_41 ;
if ( ! ( V_41 -> V_78 -> V_203 & V_204 ) &&
( V_201 == V_205 ) &&
( ! V_198 -> V_38 . V_202 . V_206 ) ) {
V_202 = & V_198 -> V_38 . V_202 ;
V_197 = V_198 -> V_38 . V_202 . V_58 . V_207 [ 0 ] ;
F_55 ( V_41 , V_2 , V_197 ) ;
}
F_3 ( V_2 , V_35 , V_36 ,
L_14
L_15 ,
V_4 -> V_37 , V_201 , V_4 -> V_71 , V_4 -> V_72 ,
V_4 -> V_8 ) ;
return V_4 -> V_71 ;
}
static T_1
...
{
struct V_79 * V_80 = F_22 ( V_2 ) ;
struct V_42 * V_43 = (struct V_42 * ) V_200 ;
F_9 ( V_80 -> V_139 ) ;
V_4 -> V_8 |= V_169 ;
F_15 ( V_80 -> V_139 ) ;
F_28 ( V_2 , V_171 , V_43 , V_4 , NULL ) ;
...
static T_1
F_78 ( struct V_1 * V_2 ,
struct V_3 * V_4 , void * V_200 , T_1 V_201 )
{
struct V_40 * V_41 ;
T_5 * V_198 = ( T_5 * ) V_200 ;
T_9 * V_202 = & V_198 -> V_38 . V_202 ;
T_2 V_197 ;
V_41 = V_2 -> V_41 ;
if ( ! ( V_41 -> V_78 -> V_203 & V_204 ) &&
! V_202 -> V_206 ) {
...
struct V_45 * V_219 ;
V_43 = (struct V_42 * ) V_200 ;
if ( ( V_202 = V_41 -> V_64 . V_234 ) ) {
if ( ( V_202 -> V_38 . V_202 . V_235 == V_236 ) &&
( V_4 == (struct V_3 * ) V_202 -> V_52 ) ) {
F_74 ( V_4 ) ;
V_202 -> V_52 = NULL ;
V_202 -> V_132 = V_133 ;
}
...
T_5 * V_198 = ( T_5 * ) V_200 ;
T_9 * V_202 = & V_198 -> V_38 . V_202 ;
T_1 V_238 = V_202 -> V_58 . V_207 [ 1 ] ;
if ( V_202 -> V_206 ) {
F_3 ( V_2 , V_35 , V_36 ,
L_24
L_25 ,
V_238 , V_202 -> V_206 , V_2 -> V_87 ,
V_202 -> V_58 . V_239 . V_136 ,
V_202 -> V_58 . V_239 . V_197 ) ;
if ( V_202 -> V_206 == V_240 ) {
V_4 -> V_125 = V_118 ;
F_29 ( V_2 , V_4 , V_116 ) ;
return V_4 -> V_71 ;
}
...
L_26
L_27 ,
V_201 , V_4 -> V_37 , V_252 , V_4 -> V_8 ) ;
F_52 ( V_2 , V_254 ,
L_28 ,
V_201 , V_252 , V_4 -> V_37 ) ;
F_147 = V_255 [ ( V_252 * V_256 ) + V_201 ] ;
V_86 = ( F_147 ) ( V_2 , V_4 , V_200 , V_201 ) ;
if ( V_253 ) {
F_3 ( V_2 , V_70 , V_36 ,
L_29 ,
