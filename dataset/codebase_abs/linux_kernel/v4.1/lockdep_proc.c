...
F_37 ( V_2 , V_117 -> V_105 ? F_39 ( V_117 -> V_120 , V_117 -> V_105 ) : 0 ) ;
}
static void F_40 ( struct V_1 * V_2 , struct V_101 * V_121 )
{
struct V_122 * V_123 ;
struct V_124 * V_106 ;
struct V_6 * V_7 ;
...
const char * V_127 ;
V_127 = F_7 ( V_123 , V_8 ) ;
snprintf ( V_10 , V_126 , L_1 , V_127 ) ;
} else {
snprintf ( V_10 , V_126 , L_1 , V_125 ) ;
}
F_43 () ;
V_126 = strlen ( V_10 ) ;
if ( V_7 -> V_12 > 1 ) {
snprintf ( V_10 + V_126 , 3 , L_2 , V_7 -> V_12 ) ;
V_126 += 2 ;
}
if ( V_7 -> V_13 ) {
snprintf ( V_10 + V_126 , 3 , L_3 , V_7 -> V_13 ) ;
V_126 += 2 ;
}
if ( V_106 -> V_128 . V_105 ) {
if ( V_106 -> V_129 . V_105 )
F_8 ( V_2 , L_62 , V_10 ) ;
else
F_8 ( V_2 , L_63 , V_10 ) ;
F_8 ( V_2 , L_64 , V_106 -> V_130 [ V_131 ] ) ;
F_38 ( V_2 , & V_106 -> V_108 ) ;
F_8 ( V_2 , L_65 , V_106 -> V_130 [ V_132 ] ) ;
F_38 ( V_2 , & V_106 -> V_128 ) ;
F_16 ( V_2 , L_11 ) ;
}
if ( V_106 -> V_129 . V_105 ) {
F_8 ( V_2 , L_66 , V_10 ) ;
F_8 ( V_2 , L_64 , V_106 -> V_130 [ V_133 ] ) ;
F_38 ( V_2 , & V_106 -> V_107 ) ;
F_8 ( V_2 , L_65 , V_106 -> V_130 [ V_134 ] ) ;
F_38 ( V_2 , & V_106 -> V_129 ) ;
F_16 ( V_2 , L_11 ) ;
}
...
if ( V_106 -> V_129 . V_105 )
V_126 += 2 ;
for ( V_29 = 0 ; V_29 < V_135 ; V_29 ++ ) {
char V_136 [ 32 ] ;
if ( V_7 -> V_137 [ V_29 ] == 0 )
break;
if ( ! V_29 )
F_34 ( V_2 , '-' , 40 - V_126 , V_126 ) ;
snprintf ( V_136 , sizeof( V_136 ) , L_67 ,
( void * ) V_7 -> V_137 [ V_29 ] ) ;
F_8 ( V_2 , L_68 ,
V_10 , V_106 -> V_137 [ V_29 ] ,
V_136 , ( void * ) V_7 -> V_137 [ V_29 ] ) ;
}
for ( V_29 = 0 ; V_29 < V_135 ; V_29 ++ ) {
char V_136 [ 32 ] ;
if ( V_7 -> V_138 [ V_29 ] == 0 )
...
( void * ) V_7 -> V_138 [ V_29 ] ) ;
F_8 ( V_2 , L_68 ,
V_10 , V_106 -> V_138 [ V_29 ] ,
V_136 , ( void * ) V_7 -> V_138 [ V_29 ] ) ;
}
if ( V_29 ) {
F_16 ( V_2 , L_11 ) ;
...
{
struct V_139 * V_121 = V_2 -> V_140 ;
struct V_101 * V_141 ;
if ( * V_4 == 0 )
return V_24 ;
V_141 = V_121 -> V_106 + ( * V_4 - 1 ) ;
if ( V_141 >= V_121 -> V_142 )
V_141 = NULL ;
return V_141 ;
}
...
int V_143 ;
struct V_6 * V_7 ;
struct V_139 * V_121 = F_51 ( sizeof( struct V_139 ) ) ;
if ( ! V_121 )
return - V_144 ;
V_143 = F_19 ( V_22 , & V_145 ) ;
if ( ! V_143 ) {
struct V_101 * V_141 = V_121 -> V_106 ;
struct V_1 * V_2 = V_22 -> V_146 ;
F_17 (class, &all_lock_classes, lock_entry) {
V_141 -> V_7 = V_7 ;
V_141 -> V_106 = F_52 ( V_7 ) ;
V_141 ++ ;
}
V_121 -> V_142 = V_141 ;
F_53 ( V_121 -> V_106 , V_121 -> V_142 - V_121 -> V_106 ,
sizeof( struct V_101 ) ,
F_33 , NULL ) ;
V_2 -> V_140 = V_121 ;
} else
...
static T_5 F_55 ( struct V_22 * V_22 , const char T_6 * V_112 ,
T_2 V_147 , T_1 * V_148 )
{
struct V_6 * V_7 ;
char V_109 ;
...
{
struct V_1 * V_150 = V_22 -> V_146 ;
F_54 ( V_150 -> V_140 ) ;
return F_59 ( V_21 , V_22 ) ;
}
static int T_7 F_60 ( void )
{
F_61 ( L_86 , V_151 , NULL , & V_152 ) ;
#ifdef F_12
F_61 ( L_87 , V_151 , NULL ,
& V_153 ) ;
#endif
F_61 ( L_88 , V_151 , NULL ,
& V_154 ) ;
#ifdef F_62
F_61 ( L_89 , V_151 | V_155 , NULL ,
& V_156 ) ;
#endif
return 0 ;
}
