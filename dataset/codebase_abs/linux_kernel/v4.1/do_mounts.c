...
V_64:
F_63 ( L_33 ) ;
F_32 ( L_34 , L_35 , NULL , V_92 , NULL ) ;
F_64 ( L_34 ) ;
}
static struct V_51 * F_65 ( struct V_93 * V_94 ,
...
if ( F_68 ( V_100 ) && V_101 )
V_97 = V_102 ;
return F_69 ( V_94 , V_46 , V_7 , V_97 ) ;
}
int T_1 F_70 ( void )
{
int V_48 = F_71 ( & V_103 ) ;
if ( V_48 )
return V_48 ;
if ( F_68 ( V_100 ) && ! V_39 [ 0 ] &&
( ! V_41 || strstr ( V_41 , L_36 ) ) ) {
V_48 = F_72 () ;
V_101 = true ;
} else {
V_48 = F_73 () ;
