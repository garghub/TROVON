...
return 0 ;
V_92:
V_20 -> V_21 . V_42 . V_94 ( & V_20 -> V_21 . V_42 , & V_20 -> V_88 ) ;
V_90:
V_20 -> V_21 . V_42 . V_94 ( & V_20 -> V_21 . V_42 , & V_20 -> V_83 ) ;
V_87:
F_31 ( & V_20 -> V_81 ) ;
V_82:
F_32 ( & V_20 -> V_21 ) ;
...
V_20 = F_41 ( sizeof( struct V_25 ) , V_105 ) ;
if ( V_20 == NULL ) {
F_42 ( V_2 -> V_2 ,
L_24 ) ;
return - V_106 ;
...
V_2 -> F_19 = F_19 ;
V_2 -> F_20 = F_20 ;
V_101 = F_43 ( V_2 , V_2 -> V_103 . V_107 ) ;
V_102 = F_43 ( V_2 , V_2 -> V_103 . V_108 ) ;
F_15 ( & V_2 -> V_45 ) ;
F_8 ( V_2 , V_31 ) ;
F_44 ( V_2 ) ;
switch ( V_2 -> V_109 ) {
...
V_20 -> V_43 -> V_115 = V_116 ;
if ( ! F_45 ( V_117 , V_2 -> V_20 -> V_43 ,
V_101 ,
& V_118 ) ) {
V_67 = - V_44 ;
goto V_114;
...
V_142 . V_49 = V_2 -> V_20 -> V_43 ;
V_142 . V_144 = true ;
F_48 ( V_141 . type , L_30 , V_145 ) ;
V_141 . V_146 = 0x60 ;
V_141 . V_147 = & V_142 ;
F_49 ( L_30 ) ;
V_96 = F_50 (
V_101 ,
& V_141 ) ;
if ( V_96 == NULL || V_96 -> V_2 . V_98 == NULL ) {
F_34 ( V_2 -> V_20 -> V_43 ) ;
V_67 = - V_148 ;
goto V_114;
}
if ( ! F_51 ( V_96 -> V_2 . V_98 -> V_99 ) ) {
F_39 ( V_96 ) ;
F_34 ( V_2 -> V_20 -> V_43 ) ;
V_67 = - V_148 ;
goto V_114;
...
V_67 = F_21 ( V_20 , V_157 , V_2 , V_2 -> V_2 ) ;
if ( V_67 < 0 )
goto V_114;
F_42 ( V_2 -> V_2 , L_36 ) ;
V_41:
