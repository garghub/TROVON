...
T_2 * V_19 = V_16 ;
V_273 = F_61 ( V_270 ) ;
if ( ! F_71 ( V_315 , & V_273 -> V_39 ) )
return - V_316 ;
V_314 = V_270 -> V_317 ;
return F_72 ( V_273 -> V_312 , & V_314 -> V_312 , * V_19 ) ;
}
static int F_73 ( const struct V_274 * V_275 ,
struct V_270 * V_270 , void * V_303 , void * V_16 )
{
struct V_272 * V_273 = F_61 ( V_270 ) ;
...
static int F_76 ( const struct V_274 * V_275 ,
struct V_270 * V_270 , void * V_303 , void * V_16 )
{
...
switch ( V_19 -> type ) {
case V_55 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_323 ) )
break;
return V_275 -> V_323 ( V_270 , V_303 , V_16 ) ;
case V_67 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_324 ) )
break;
return V_275 -> V_324 ( V_270 , V_303 , V_16 ) ;
case V_73 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_325 ) )
break;
return V_275 -> V_325 ( V_270 , V_303 , V_16 ) ;
case V_56 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_326 ) )
break;
return V_275 -> V_326 ( V_270 , V_303 , V_16 ) ;
case V_68 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_327 ) )
break;
return V_275 -> V_327 ( V_270 , V_303 , V_16 ) ;
case V_96 :
if ( F_77 ( ! V_284 || ! V_282 || ! V_275 -> V_328 ) )
break;
...
switch ( V_19 -> type ) {
case V_55 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_290 ) )
break;
...
return V_305 ;
case V_67 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_291 ) )
break;
return V_275 -> V_291 ( V_270 , V_303 , V_16 ) ;
case V_73 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_292 ) )
break;
return V_275 -> V_292 ( V_270 , V_303 , V_16 ) ;
case V_83 :
if ( F_77 ( ! V_284 || V_277 || ! V_275 -> V_296 ) )
break;
return V_275 -> V_296 ( V_270 , V_303 , V_16 ) ;
case V_91 :
if ( F_77 ( ! V_284 || V_277 || ! V_275 -> V_298 ) )
break;
return V_275 -> V_298 ( V_270 , V_303 , V_16 ) ;
case V_56 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_293 ) )
break;
V_19 -> V_57 . V_44 . V_301 = V_302 ;
...
return V_305 ;
case V_68 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_294 ) )
break;
return V_275 -> V_294 ( V_270 , V_303 , V_16 ) ;
case V_74 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_295 ) )
break;
return V_275 -> V_295 ( V_270 , V_303 , V_16 ) ;
case V_84 :
if ( F_77 ( ! V_287 || V_277 || ! V_275 -> V_297 ) )
break;
return V_275 -> V_297 ( V_270 , V_303 , V_16 ) ;
case V_92 :
if ( F_77 ( ! V_287 || V_277 || ! V_275 -> V_299 ) )
break;
return V_275 -> V_299 ( V_270 , V_303 , V_16 ) ;
case V_96 :
if ( F_77 ( ! V_284 || ! V_282 || ! V_275 -> V_300 ) )
break;
return V_275 -> V_300 ( V_270 , V_303 , V_16 ) ;
}
return - V_289 ;
}
static int F_79 ( const struct V_274 * V_275 ,
struct V_270 * V_270 , void * V_303 , void * V_16 )
{
struct V_42 * V_19 = V_16 ;
struct V_272 * V_273 = F_61 ( V_270 ) ;
...
switch ( V_19 -> type ) {
case V_55 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_330 ) )
break;
F_80 ( V_19 , V_57 . V_44 ) ;
...
return V_305 ;
case V_67 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_331 ) )
break;
F_80 ( V_19 , V_57 . V_69 ) ;
return V_275 -> V_331 ( V_270 , V_303 , V_16 ) ;
case V_73 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_332 ) )
break;
F_80 ( V_19 , V_57 . V_52 ) ;
return V_275 -> V_332 ( V_270 , V_303 , V_16 ) ;
case V_83 :
if ( F_77 ( ! V_284 || V_277 || ! V_275 -> V_333 ) )
break;
F_80 ( V_19 , V_57 . V_48 ) ;
return V_275 -> V_333 ( V_270 , V_303 , V_16 ) ;
case V_91 :
if ( F_77 ( ! V_284 || V_277 || ! V_275 -> V_334 ) )
break;
F_80 ( V_19 , V_57 . V_50 ) ;
return V_275 -> V_334 ( V_270 , V_303 , V_16 ) ;
case V_56 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_335 ) )
break;
F_80 ( V_19 , V_57 . V_44 ) ;
...
return V_305 ;
case V_68 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_336 ) )
break;
F_80 ( V_19 , V_57 . V_69 ) ;
return V_275 -> V_336 ( V_270 , V_303 , V_16 ) ;
case V_74 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_337 ) )
break;
F_80 ( V_19 , V_57 . V_52 ) ;
return V_275 -> V_337 ( V_270 , V_303 , V_16 ) ;
case V_84 :
if ( F_77 ( ! V_287 || V_277 || ! V_275 -> V_338 ) )
break;
F_80 ( V_19 , V_57 . V_48 ) ;
return V_275 -> V_338 ( V_270 , V_303 , V_16 ) ;
case V_92 :
if ( F_77 ( ! V_287 || V_277 || ! V_275 -> V_339 ) )
break;
F_80 ( V_19 , V_57 . V_50 ) ;
return V_275 -> V_339 ( V_270 , V_303 , V_16 ) ;
case V_96 :
if ( F_77 ( ! V_284 || ! V_282 || ! V_275 -> V_340 ) )
break;
F_80 ( V_19 , V_57 . V_54 ) ;
...
switch ( V_19 -> type ) {
case V_55 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_341 ) )
break;
F_80 ( V_19 , V_57 . V_44 ) ;
...
return V_305 ;
case V_67 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_342 ) )
break;
F_80 ( V_19 , V_57 . V_69 ) ;
return V_275 -> V_342 ( V_270 , V_303 , V_16 ) ;
case V_73 :
if ( F_77 ( ! V_284 || ! V_277 || ! V_275 -> V_343 ) )
break;
F_80 ( V_19 , V_57 . V_52 ) ;
return V_275 -> V_343 ( V_270 , V_303 , V_16 ) ;
case V_83 :
if ( F_77 ( ! V_284 || V_277 || ! V_275 -> V_344 ) )
break;
F_80 ( V_19 , V_57 . V_48 ) ;
return V_275 -> V_344 ( V_270 , V_303 , V_16 ) ;
case V_91 :
if ( F_77 ( ! V_284 || V_277 || ! V_275 -> V_345 ) )
break;
F_80 ( V_19 , V_57 . V_50 ) ;
return V_275 -> V_345 ( V_270 , V_303 , V_16 ) ;
case V_56 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_346 ) )
break;
F_80 ( V_19 , V_57 . V_44 ) ;
...
return V_305 ;
case V_68 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_347 ) )
break;
F_80 ( V_19 , V_57 . V_69 ) ;
return V_275 -> V_347 ( V_270 , V_303 , V_16 ) ;
case V_74 :
if ( F_77 ( ! V_287 || ! V_277 || ! V_275 -> V_348 ) )
break;
F_80 ( V_19 , V_57 . V_52 ) ;
return V_275 -> V_348 ( V_270 , V_303 , V_16 ) ;
case V_84 :
if ( F_77 ( ! V_287 || V_277 || ! V_275 -> V_349 ) )
break;
F_80 ( V_19 , V_57 . V_48 ) ;
return V_275 -> V_349 ( V_270 , V_303 , V_16 ) ;
case V_92 :
if ( F_77 ( ! V_287 || V_277 || ! V_275 -> V_350 ) )
break;
F_80 ( V_19 , V_57 . V_50 ) ;
return V_275 -> V_350 ( V_270 , V_303 , V_16 ) ;
case V_96 :
if ( F_77 ( ! V_284 || ! V_282 || ! V_275 -> V_351 ) )
break;
F_80 ( V_19 , V_57 . V_54 ) ;
...
static int F_102 ( const struct V_274 * V_275 ,
struct V_270 * V_270 , void * V_303 , void * V_16 )
{
struct V_272 * V_273 = F_61 ( V_270 ) ;
struct V_155 * V_19 = V_16 ;
struct V_313 * V_314 =
F_71 ( V_315 , & V_273 -> V_39 ) ? V_303 : NULL ;
if ( V_314 && V_314 -> V_390 )
return V_155 ( V_314 -> V_390 , V_19 ) ;
if ( V_273 -> V_390 )
return V_155 ( V_273 -> V_390 , V_19 ) ;
if ( V_275 -> V_391 )
return V_275 -> V_391 ( V_270 , V_303 , V_19 ) ;
return - V_316 ;
}
...
F_71 ( V_315 , & V_273 -> V_39 ) ? V_303 : NULL ;
if ( V_314 && V_314 -> V_390 )
return V_160 ( V_314 -> V_390 , V_19 ) ;
if ( V_273 -> V_390 )
return V_160 ( V_273 -> V_390 , V_19 ) ;
if ( V_275 -> V_392 )
...
F_71 ( V_315 , & V_273 -> V_39 ) ? V_303 : NULL ;
if ( V_314 && V_314 -> V_390 )
return V_165 ( V_314 -> V_390 , V_19 ) ;
if ( V_273 -> V_390 )
return V_165 ( V_273 -> V_390 , V_19 ) ;
if ( V_275 -> V_393 )
return V_275 -> V_393 ( V_270 , V_303 , V_19 ) ;
return - V_316 ;
}
...
struct V_395 V_251 ;
if ( V_314 && V_314 -> V_390 )
return F_106 ( V_314 -> V_390 , V_19 ) ;
if ( V_273 -> V_390 )
return F_106 ( V_273 -> V_390 , V_19 ) ;
if ( V_275 -> V_396 )
return V_275 -> V_396 ( V_270 , V_303 , V_19 ) ;
if ( V_275 -> V_397 == NULL )
return - V_316 ;
V_394 . V_169 = F_59 ( V_19 -> V_1 ) ;
V_394 . V_90 = 1 ;
V_394 . V_171 = & V_251 ;
V_251 . V_1 = V_19 -> V_1 ;
V_251 . V_167 = V_19 -> V_167 ;
if ( F_58 ( & V_394 , 1 ) ) {
int V_305 = V_275 -> V_397 ( V_270 , V_303 , & V_394 ) ;
if ( V_305 == 0 )
...
struct V_395 V_251 ;
if ( V_314 && V_314 -> V_390 )
return F_108 ( V_314 , V_314 -> V_390 , V_19 ) ;
if ( V_273 -> V_390 )
return F_108 ( NULL , V_273 -> V_390 , V_19 ) ;
if ( V_275 -> V_398 )
...
V_251 . V_167 = V_19 -> V_167 ;
if ( F_58 ( & V_394 , 1 ) )
return V_275 -> V_399 ( V_270 , V_303 , & V_394 ) ;
return - V_289 ;
}
...
if ( V_314 && V_314 -> V_390 )
return F_110 ( V_314 -> V_390 , V_19 ) ;
if ( V_273 -> V_390 )
return F_110 ( V_273 -> V_390 , V_19 ) ;
if ( V_275 -> V_397 == NULL )
return - V_316 ;
return F_58 ( V_19 , 0 ) ? V_275 -> V_397 ( V_270 , V_303 , V_19 ) :
- V_289 ;
}
...
V_19 -> V_170 = V_19 -> V_90 ;
if ( V_314 && V_314 -> V_390 )
return F_112 ( V_314 , V_314 -> V_390 , V_19 ) ;
if ( V_273 -> V_390 )
return F_112 ( NULL , V_273 -> V_390 , V_19 ) ;
if ( V_275 -> V_399 == NULL )
return - V_316 ;
...
V_19 -> V_170 = V_19 -> V_90 ;
if ( V_314 && V_314 -> V_390 )
return F_114 ( V_314 -> V_390 , V_19 ) ;
if ( V_273 -> V_390 )
return F_114 ( V_273 -> V_390 , V_19 ) ;
if ( V_275 -> V_400 == NULL )
return - V_316 ;
return F_58 ( V_19 , 0 ) ? V_275 -> V_400 ( V_270 , V_303 , V_19 ) :
- V_289 ;
}
...
int V_305 ;
if ( V_275 -> V_402 )
return V_275 -> V_402 ( V_270 , V_303 , V_19 ) ;
if ( F_116 ( V_19 -> type ) )
V_401 . V_179 = V_403 ;
else
V_401 . V_179 = V_404 ;
V_305 = V_275 -> V_405 ( V_270 , V_303 , & V_401 ) ;
if ( ! V_305 )
V_19 -> V_144 = V_401 . V_180 ;
return V_305 ;
}
...
if ( V_275 -> V_406 )
return V_275 -> V_406 ( V_270 , V_303 , V_19 ) ;
if ( F_116 ( V_19 -> type ) )
V_401 . V_179 = V_403 ;
else
V_401 . V_179 = V_404 ;
return V_275 -> V_407 ( V_270 , V_303 , & V_401 ) ;
}
...
if ( V_275 -> V_405 ) {
struct V_178 V_401 = { . type = V_19 -> type } ;
int V_305 ;
if ( F_116 ( V_19 -> type ) )
V_401 . V_179 = V_408 ;
else
...
if ( V_305 )
return V_305 ;
V_19 -> V_175 = V_401 . V_180 ;
}
V_19 -> V_176 . V_10 = 1 ;
V_19 -> V_176 . V_11 = 1 ;
if ( V_275 -> V_412 )
return V_275 -> V_412 ( V_270 , V_303 , V_19 ) ;
return 0 ;
}
...
if ( ! F_122 ( V_418 ) )
return - V_419 ;
if ( V_19 -> V_199 . type == V_420 ) {
if ( V_273 -> V_413 == NULL )
return - V_289 ;
F_123 (sd, vfd->v4l2_dev)
if ( V_19 -> V_199 . V_201 == V_417 ++ )
return F_124 ( V_416 , V_421 , V_422 , V_19 ) ;
return - V_289 ;
}
if ( V_275 -> V_423 && V_19 -> V_199 . type == V_424 &&
( V_275 -> V_425 || V_19 -> V_199 . V_201 == 0 ) )
return V_275 -> V_423 ( V_270 , V_303 , V_19 ) ;
return - V_289 ;
#else
return - V_316 ;
#endif
...
F_123 (sd, vfd->v4l2_dev)
if ( V_19 -> V_199 . V_201 == V_417 ++ )
return F_124 ( V_416 , V_421 , V_426 , V_19 ) ;
return - V_289 ;
}
if ( V_275 -> V_427 && V_19 -> V_199 . type == V_424 &&
( V_275 -> V_425 || V_19 -> V_199 . V_201 == 0 ) )
return V_275 -> V_427 ( V_270 , V_303 , V_19 ) ;
return - V_289 ;
#else
return - V_316 ;
#endif
...
if ( V_275 -> V_423 )
V_19 -> V_39 |= V_429 ;
F_5 ( V_19 -> V_14 , V_273 -> V_413 -> V_14 , sizeof( V_19 -> V_14 ) ) ;
if ( V_275 -> V_425 )
return V_275 -> V_425 ( V_270 , V_303 , V_16 ) ;
if ( V_19 -> V_199 . V_201 )
return - V_289 ;
return 0 ;
case V_420 :
...
if ( V_19 -> V_199 . V_201 != V_417 ++ )
continue;
if ( V_416 -> V_275 -> V_421 && V_416 -> V_275 -> V_421 -> V_426 )
V_19 -> V_39 |= V_428 ;
if ( V_416 -> V_275 -> V_421 && V_416 -> V_275 -> V_421 -> V_422 )
V_19 -> V_39 |= V_429 ;
F_5 ( V_19 -> V_14 , V_416 -> V_14 , sizeof( V_19 -> V_14 ) ) ;
return 0 ;
}
break;
}
...
struct V_270 * V_270 , void * V_303 , void * V_16 )
{
return F_128 ( V_303 , V_16 , V_270 -> V_430 & V_431 ) ;
}
static int F_129 ( const struct V_274 * V_275 ,
struct V_270 * V_270 , void * V_303 , void * V_16 )
{
return V_275 -> V_432 ( V_303 , V_16 ) ;
}
static int F_130 ( const struct V_274 * V_275 ,
struct V_270 * V_270 , void * V_303 , void * V_16 )
{
return V_275 -> V_433 ( V_303 , V_16 ) ;
}
...
return V_275 -> V_434 ( V_270 , V_303 , V_19 ) ;
}
...
if ( V_275 -> V_435 ) {
V_354 = V_275 -> V_435 ( V_270 , V_303 , V_19 ) ;
if ( V_354 != - V_316 )
return V_354 ;
}
if ( F_74 ( V_273 , V_436 ) ) {
...
if ( V_19 -> V_27 )
return - V_289 ;
V_354 = V_275 -> V_358 ( V_270 , V_303 , & V_437 ) ;
if ( V_354 )
return V_354 ;
V_19 -> V_35 = V_437 . V_35 | V_359 ;
V_19 -> V_101 = V_437 . V_101 ;
V_19 -> V_102 = V_437 . V_102 ;
...
{
if ( F_134 ( V_191 ) >= V_441 )
return false ;
return V_442 [ F_134 ( V_191 ) ] . V_443 == V_191 ;
}
struct V_444 * F_135 ( struct V_272 * V_445 , unsigned V_191 )
{
if ( F_134 ( V_191 ) >= V_441 )
return V_445 -> V_446 ;
if ( F_71 ( F_134 ( V_191 ) , V_445 -> V_447 ) )
return NULL ;
if ( V_445 -> V_448 && V_445 -> V_448 -> V_446 &&
( V_442 [ F_134 ( V_191 ) ] . V_39 & V_449 ) )
return V_445 -> V_448 -> V_446 ;
return V_445 -> V_446 ;
}
void F_136 ( const char * V_450 , unsigned int V_191 )
{
const char * V_451 , * type ;
if ( V_450 )
F_15 ( V_71 L_122 , V_450 ) ;
switch ( F_137 ( V_191 ) ) {
case 'd' :
type = L_123 ;
break;
...
F_7 ( L_125 , V_442 [ F_134 ( V_191 ) ] . V_14 ) ;
return;
default:
type = L_126 ;
break;
...
switch ( F_138 ( V_191 ) ) {
case V_452 : V_451 = L_127 ; break;
case V_453 : V_451 = L_128 ; break;
case V_454 : V_451 = L_129 ; break;
case V_453 | V_454 : V_451 = L_130 ; break;
default: V_451 = L_131 ; break;
}
F_7 ( L_132 ,
type , F_137 ( V_191 ) , V_451 , F_134 ( V_191 ) , V_191 ) ;
}
...
V_314 = V_270 -> V_317 ;
if ( F_133 ( V_191 ) ) {
V_457 = & V_442 [ F_134 ( V_191 ) ] ;
if ( ! F_71 ( F_134 ( V_191 ) , V_273 -> V_459 ) &&
! ( ( V_457 -> V_39 & V_460 ) && V_314 && V_314 -> V_390 ) )
goto V_461;
if ( V_314 && ( V_457 -> V_39 & V_462 ) ) {
V_305 = F_142 ( V_273 -> V_312 , V_314 -> V_312 ) ;
if ( V_305 )
goto V_461;
}
} else {
...
V_17 = F_138 ( V_191 ) == V_454 ;
if ( V_457 -> V_39 & V_464 ) {
typedef int (* F_143)( struct V_270 * V_270 , void * V_303 , void * V_19 );
const void * V_19 = V_273 -> V_276 ;
const F_143 * V_465 = V_19 + V_457 -> V_249 . V_86 ;
V_305 = (* V_465)( V_270 , V_303 , V_16 ) ;
} else if ( V_457 -> V_39 & V_466 ) {
V_305 = V_457 -> V_249 . V_467 ( V_275 , V_270 , V_303 , V_16 ) ;
} else if ( ! V_275 -> V_468 ) {
V_305 = - V_316 ;
} else {
V_305 = V_275 -> V_468 ( V_270 , V_303 ,
V_314 ? F_142 ( V_273 -> V_312 , V_314 -> V_312 ) >= 0 : 0 ,
V_191 , V_16 ) ;
}
V_461:
if ( V_458 & ( V_469 | V_470 ) ) {
if ( ! ( V_458 & V_471 ) &&
( V_191 == V_472 || V_191 == V_473 ) )
return V_305 ;
...
if ( ! ( V_458 & V_470 ) )
F_7 ( L_46 ) ;
else if ( F_138 ( V_191 ) == V_452 )
V_457 -> V_463 ( V_16 , V_17 ) ;
else {
F_7 ( L_135 ) ;
V_457 -> V_463 ( V_16 , V_17 ) ;
}
...
static int F_144 ( unsigned int V_191 , void * V_474 , T_4 * V_475 ,
void T_3 * * V_476 , void * * * V_477 )
{
int V_305 = 0 ;
switch ( V_191 ) {
case V_478 :
...
case V_472 :
case V_473 : {
struct V_116 * V_480 = V_474 ;
if ( F_26 ( V_480 -> type ) && V_480 -> V_128 > 0 ) {
if ( V_480 -> V_128 > V_481 ) {
V_305 = - V_289 ;
break;
}
* V_476 = ( void T_3 * ) V_480 -> V_126 . V_127 ;
* V_477 = ( void * * ) & V_480 -> V_126 . V_127 ;
* V_475 = sizeof( struct V_120 ) * V_480 -> V_128 ;
V_305 = 1 ;
}
break;
}
case V_482 :
case V_483 : {
struct V_262 * V_484 = V_474 ;
if ( V_484 -> V_265 ) {
if ( V_484 -> V_265 > 256 ) {
V_305 = - V_289 ;
break;
}
* V_476 = ( void T_3 * ) V_484 -> V_484 ;
* V_477 = ( void * * ) & V_484 -> V_484 ;
* V_475 = V_484 -> V_265 * 128 ;
V_305 = 1 ;
}
break;
}
...
case V_486 :
case V_487 : {
struct V_168 * V_394 = V_474 ;
if ( V_394 -> V_90 != 0 ) {
if ( V_394 -> V_90 > V_488 ) {
V_305 = - V_289 ;
break;
}
* V_476 = ( void T_3 * ) V_394 -> V_171 ;
* V_477 = ( void * * ) & V_394 -> V_171 ;
* V_475 = sizeof( struct V_395 )
* V_394 -> V_90 ;
V_305 = 1 ;
}
break;
...
char V_489 [ 128 ] ;
void * V_490 = NULL ;
void * V_474 = ( void * ) V_16 ;
long V_354 = - V_289 ;
bool V_491 ;
T_4 V_475 = 0 ;
void T_3 * V_476 = NULL ;
void * * V_477 = NULL ;
if ( F_138 ( V_191 ) != V_452 ) {
if ( F_146 ( V_191 ) <= sizeof( V_489 ) ) {
V_474 = V_489 ;
} else {
V_490 = F_147 ( F_146 ( V_191 ) , V_492 ) ;
if ( NULL == V_490 )
return - V_493 ;
V_474 = V_490 ;
}
...
unsigned int V_495 = F_146 ( V_191 ) ;
if ( F_133 ( V_191 ) ) {
T_2 V_39 = V_442 [ F_134 ( V_191 ) ] . V_39 ;
if ( V_39 & V_496 )
V_495 = ( V_39 & V_496 ) >> 16 ;
}
if ( F_148 ( V_474 , ( void T_3 * ) V_16 , V_495 ) )
goto V_497;
if ( V_495 < F_146 ( V_191 ) )
memset ( ( V_498 * ) V_474 + V_495 , 0 , F_146 ( V_191 ) - V_495 ) ;
} else {
memset ( V_474 , 0 , F_146 ( V_191 ) ) ;
}
}
V_354 = F_144 ( V_191 , V_474 , & V_475 , & V_476 , & V_477 ) ;
if ( V_354 < 0 )
goto V_497;
V_491 = V_354 ;
if ( V_491 ) {
V_490 = F_147 ( V_475 , V_492 ) ;
V_354 = - V_493 ;
if ( NULL == V_490 )
goto V_499;
V_354 = - V_494 ;
if ( F_148 ( V_490 , V_476 , V_475 ) )
goto V_499;
* V_477 = V_490 ;
}
V_354 = V_467 ( V_270 , V_191 , V_474 ) ;
if ( V_354 == - V_500 )
V_354 = - V_316 ;
if ( V_354 == 0 ) {
if ( V_191 == V_473 )
F_149 ( F_61 ( V_270 ) -> V_501 , V_474 ) ;
else if ( V_191 == V_472 )
F_150 ( F_61 ( V_270 ) -> V_501 , V_474 ) ;
}
if ( V_491 ) {
* V_477 = ( void V_502 * ) V_476 ;
if ( F_151 ( V_476 , V_490 , V_475 ) )
V_354 = - V_494 ;
goto V_499;
}
if ( V_354 < 0 && V_191 != V_503 )
goto V_497;
V_499:
switch ( F_138 ( V_191 ) ) {
case V_453 :
case ( V_454 | V_453 ) :
if ( F_151 ( ( void T_3 * ) V_16 , V_474 , F_146 ( V_191 ) ) )
V_354 = - V_494 ;
break;
}
V_497:
