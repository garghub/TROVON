...
const struct V_9 * V_10 = V_6 -> V_10 , * V_11 = V_6 -> V_11 ;
T_1 * V_12 = & V_4 -> V_13 [ V_8 -> V_14 ] ;
const struct V_15 * V_16 ;
switch ( V_8 -> V_17 ) {
case V_18 :
if ( V_10 == NULL || ( V_16 = F_3 ( V_10 ) ) == NULL )
goto V_19;
break;
case V_20 :
...
static int F_5 ( const struct V_28 * V_29 ,
const struct V_1 * V_2 ,
const struct V_30 * const V_31 [] )
{
struct V_7 * V_8 = F_2 ( V_2 ) ;
unsigned int V_32 ;
V_8 -> V_17 = F_6 ( F_7 ( V_31 [ V_33 ] ) ) ;
switch ( V_8 -> V_17 ) {
case V_18 :
case V_20 :
V_32 = V_24 ;
break;
default:
return F_8 ( V_29 , V_2 , V_31 ) ;
}
V_8 -> V_14 = F_9 ( V_31 [ V_34 ] ) ;
return F_10 ( V_29 , V_8 -> V_14 , NULL ,
V_35 , V_32 ) ;
}
static const struct V_36 *
F_11 ( const struct V_28 * V_29 ,
const struct V_30 * const V_31 [] )
{
if ( V_31 [ V_33 ] == NULL )
return F_12 ( - V_37 ) ;
