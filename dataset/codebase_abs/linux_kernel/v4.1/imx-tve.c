...
static long F_39 ( struct V_66 * V_67 , unsigned long V_45 ,
unsigned long * V_74 )
{
unsigned long div ;
div = * V_74 / V_45 ;
...
static int F_40 ( struct V_66 * V_67 , unsigned long V_45 ,
unsigned long V_68 )
{
struct V_2 * V_3 = F_38 ( V_67 , struct V_2 , V_69 ) ;
unsigned long div ;
...
V_3 -> V_69 . V_78 = & V_78 ;
V_3 -> V_61 = F_43 ( V_3 -> V_47 , & V_3 -> V_69 ) ;
if ( F_44 ( V_3 -> V_61 ) ) {
F_24 ( V_3 -> V_47 , L_7 ,
F_45 ( V_3 -> V_61 ) ) ;
...
F_50 ( & V_3 -> V_39 ,
& V_93 ) ;
F_51 ( V_86 , & V_3 -> V_39 , & V_94 ,
V_95 ) ;
F_52 ( & V_3 -> V_39 , & V_3 -> V_52 ) ;
return 0 ;
}
static bool F_53 ( struct V_96 * V_47 , unsigned int V_97 )
{
...
static int F_57 ( struct V_96 * V_47 , struct V_96 * V_104 , void * V_64 )
{
struct V_105 * V_106 = F_58 ( V_47 ) ;
...
int V_63 ;
int V_4 ;
V_3 = F_59 ( V_47 , sizeof( * V_3 ) , V_110 ) ;
if ( ! V_3 )
return - V_111 ;
V_3 -> V_47 = V_47 ;
F_60 ( & V_3 -> V_112 ) ;
...
V_75 = F_66 ( V_47 , V_109 ) ;
if ( F_44 ( V_75 ) )
return F_45 ( V_75 ) ;
V_114 . V_115 = V_3 ;
V_3 -> V_7 = F_67 ( V_47 , L_14 , V_75 ,
& V_114 ) ;
if ( F_44 ( V_3 -> V_7 ) ) {
F_24 ( V_47 , L_15 ,
F_45 ( V_3 -> V_7 ) ) ;
...
static void F_75 ( struct V_96 * V_47 , struct V_96 * V_104 ,
void * V_64 )
{
...
{
return F_79 ( & V_106 -> V_47 , & V_122 ) ;
}
static int F_80 ( struct V_105 * V_106 )
{
F_81 ( & V_106 -> V_47 , & V_122 ) ;
return 0 ;
}
