...
void F_68 ( struct V_1 * V_1 , int V_163 )
{
struct V_5 * V_111 = NULL ;
struct V_7 * V_8 = & V_1 -> V_9 ;
...
struct V_170 * V_171 ;
V_171 = F_75 ( & V_1 -> V_166 , V_167 -> V_16 . V_81 ) ;
F_17 ( & ( V_165 -> V_172 ) ) ;
F_76 ( V_1 , V_171 ) ;
F_22 ( & V_165 -> V_172 ) ;
}
...
inline void F_85 ( struct V_1 * V_2 , bool V_178 )
{
F_86 ( V_2 , V_178 ) ;
}
...
static struct V_170 * F_91 ( struct V_1 * V_2 , struct V_5 * V_6 )
{
int V_3 ;
struct V_170 * V_183 , * V_171 = NULL ;
struct V_184 * V_185 ;
struct V_164 * V_165 = & V_2 -> V_166 ;
V_171 = F_75 ( V_165 , V_6 -> V_16 . V_81 ) ;
if ( V_171 == NULL )
V_171 = F_92 ( V_165 , V_6 -> V_16 . V_81 ) ;
if ( V_171 ) {
F_52 ( L_22 , V_186 ) ;
V_171 -> V_66 = V_6 -> V_67 ;
V_171 -> V_187 = 0 ;
F_93 ( V_2 , V_188 , V_171 , true ) ;
...
if ( V_217 )
V_217 -> V_63 = false ;
V_216 = F_75 ( V_165 , V_15 -> V_16 . V_81 ) ;
if ( V_216 ) {
F_17 ( & ( V_165 -> V_172 ) ) ;
F_76 ( V_1 , V_216 ) ;
F_22 ( & V_165 -> V_172 ) ;
...
void F_105 ( struct V_1 * V_1 , struct V_170 * V_171 )
{
T_3 V_230 ;
T_1 V_231 ;
if ( V_171 == NULL )
...
#if F_104 ( V_220 )
if ( F_24 ( V_8 , V_169 ) ) {
V_171 = F_75 ( & V_1 -> V_166 , V_235 -> V_236 ) ;
if ( V_171 ) {
F_109 ( V_1 , V_171 ) ;
F_105 ( V_1 , V_171 ) ;
}
...
V_171 = F_92 ( & V_1 -> V_166 , V_235 -> V_236 ) ;
if ( V_171 == NULL ) {
...
struct V_164 * V_165 = & V_1 -> V_166 ;
struct V_5 * V_167 = & ( V_8 -> V_15 ) ;
V_171 = F_75 ( & V_1 -> V_166 , V_240 -> V_236 ) ;
if ( V_171 )
V_187 = V_171 -> V_187 ;
else
V_187 = V_240 -> V_187 ;
...
V_171 = F_75 ( & V_2 -> V_166 , V_433 -> V_436 ) ;
if ( V_171 == NULL )
return;
V_357 = & V_171 -> V_358 ;
...
if ( 0 == V_430 ) {
F_52 ( L_65 , V_431 ) ;
V_171 -> V_358 . V_440 |= F_131 ( ( T_1 ) V_431 ) ;
F_146 ( V_2 , ( T_1 ) V_431 , V_433 -> V_436 ) ;
}
}
}
void F_147 ( struct V_1 * V_2 , struct V_5 * V_167 )
{
struct V_7 * V_8 = & V_2 -> V_9 ;
F_17 ( & V_8 -> V_21 ) ;
F_114 ( V_2 , V_167 ) ;
...
void F_114 ( struct V_1 * V_2 , struct V_5 * V_167 )
{
struct V_7 * V_8 = & V_2 -> V_9 ;
int V_246 ;
struct V_5 * V_6 ;
