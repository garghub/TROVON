...
static int F_109 ( struct V_334 * V_335 )
{
struct V_16 * V_17 ;
struct V_1 * V_2 ;
const T_2 * V_32 ;
...
V_2 -> V_31 = & V_335 -> V_31 ;
V_2 -> V_90 = false ;
V_32 = F_114 ( V_335 -> V_31 . V_343 , L_13 , & V_29 ) ;
if ( V_32 && V_29 == sizeof( * V_32 ) ) {
V_2 -> V_55 = F_115 ( V_32 ) ;
} else {
F_84 ( & V_335 -> V_31 , L_14 ) ;
V_341 = - V_344 ;
goto V_345;
}
snprintf ( V_17 -> V_232 , V_346 , L_15 , V_2 -> V_55 ) ;
V_341 = F_116 ( V_335 , 0 ) ;
if ( V_341 < 0 )
goto V_345;
V_2 -> V_292 = V_341 ;
V_338 = F_117 ( V_335 , V_347 , 0 ) ;
if ( V_338 == NULL ) {
F_84 ( & V_335 -> V_31 , L_16 ) ;
V_341 = - V_344 ;
goto V_345;
}
V_339 = F_117 ( V_335 , V_347 , 1 ) ;
if ( V_339 == NULL ) {
F_84 ( & V_335 -> V_31 , L_16 ) ;
V_341 = - V_344 ;
goto V_345;
}
V_340 = F_117 ( V_335 , V_347 , 3 ) ;
if ( V_340 == NULL ) {
F_84 ( & V_335 -> V_31 , L_16 ) ;
V_341 = - V_344 ;
goto V_345;
}
V_2 -> V_348 = V_338 -> V_349 ;
V_2 -> V_350 = F_118 ( V_338 ) ;
V_2 -> V_351 = V_339 -> V_349 ;
V_2 -> V_352 = F_118 ( V_339 ) ;
V_2 -> V_353 = V_340 -> V_349 ;
V_2 -> V_354 = F_118 ( V_340 ) ;
if ( ! F_119 ( & V_335 -> V_31 , V_2 -> V_348 , V_2 -> V_350 ,
V_338 -> V_232 ) ) {
F_84 ( & V_335 -> V_31 , L_17 ,
V_338 -> V_232 ) ;
V_341 = - V_344 ;
goto V_345;
}
if ( ! F_119 ( & V_335 -> V_31 , V_2 -> V_351 , V_2 -> V_352 ,
V_339 -> V_232 ) ) {
V_341 = - V_344 ;
F_84 ( & V_335 -> V_31 , L_17 ,
V_339 -> V_232 ) ;
...
if ( ! F_119 ( & V_335 -> V_31 , V_2 -> V_353 ,
V_2 -> V_354 , V_340 -> V_232 ) ) {
V_341 = - V_344 ;
F_84 ( & V_335 -> V_31 , L_17 ,
V_340 -> V_232 ) ;
goto V_345;
}
V_2 -> V_9 = ( V_8 ) F_120 ( & V_335 -> V_31 , V_2 -> V_348 , V_2 -> V_350 ) ;
V_2 -> V_60 = ( V_8 ) F_120 ( & V_335 -> V_31 , V_2 -> V_351 , V_2 -> V_352 ) ;
V_2 -> V_224 = ( V_8 ) F_120 ( & V_335 -> V_31 , V_2 -> V_353 ,
V_2 -> V_354 ) ;
F_121 ( & V_2 -> V_7 ) ;
F_122 ( & V_2 -> V_44 ) ;
F_122 ( & V_2 -> V_27 ) ;
...
V_17 -> V_357 = & V_358 ;
V_17 -> V_359 = & V_360 ;
V_336 = F_124 ( V_335 -> V_31 . V_343 ) ;
if ( V_336 )
memcpy ( V_17 -> V_137 , V_336 , V_273 ) ;
else
F_125 ( V_17 ) ;
V_2 -> V_234 = F_126 ( V_335 -> V_31 . V_343 , L_18 , 0 ) ;
V_341 = F_127 ( & V_335 -> V_31 , F_128 ( 64 ) ) ;
if ( V_341 )
goto V_345;
F_88 ( V_17 ) ;
V_341 = F_129 ( V_17 ) ;
if ( V_341 )
goto V_345;
F_130 ( & V_335 -> V_31 , L_19 V_323 L_20 ) ;
return 0 ;
V_345:
F_131 ( V_17 ) ;
return V_341 ;
}
static int F_132 ( struct V_334 * V_335 )
{
struct V_16 * V_17 = F_133 ( V_335 ) ;
F_134 ( V_17 ) ;
F_131 ( V_17 ) ;
return 0 ;
}
