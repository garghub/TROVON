...
F_22 ( & V_14 -> V_48 , F_12 ) ;
F_23 ( V_12 ) ;
F_24 ( V_12 , V_61 , 0x0100 , 0x0100 ) ;
F_24 ( V_12 , V_62 , 0x0100 , 0x0100 ) ;
F_24 ( V_12 , V_63 , 0x0100 , 0x0100 ) ;
F_24 ( V_12 , V_64 , 0x0100 , 0x0100 ) ;
...
struct V_13 * V_14 ;
int V_73 ;
V_14 = F_26 ( & V_70 -> V_74 , sizeof( struct V_13 ) ,
V_75 ) ;
if ( V_14 == NULL )
return - V_76 ;
V_14 -> V_49 = F_27 ( V_70 , & V_77 ) ;
if ( F_28 ( V_14 -> V_49 ) )
return F_29 ( V_14 -> V_49 ) ;
F_30 ( V_70 , V_14 ) ;
V_73 = F_31 ( & V_70 -> V_74 ,
& V_78 , & V_79 , 1 ) ;
return V_73 ;
}
static int F_32 ( struct V_69 * V_80 )
{
F_33 ( & V_80 -> V_74 ) ;
return 0 ;
}
