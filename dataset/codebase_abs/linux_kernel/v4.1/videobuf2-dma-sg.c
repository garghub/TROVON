...
if ( V_2 -> V_26 ) {
F_71 ( V_2 -> V_44 -> V_64 , V_2 -> V_26 ) ;
V_2 -> V_26 = NULL ;
}
F_72 ( V_2 -> V_44 , V_21 , V_2 -> V_17 ) ;
V_2 -> V_29 = NULL ;
}
...
if ( F_9 ( V_2 -> V_29 ) )
F_70 ( V_2 ) ;
F_74 ( V_2 -> V_44 -> V_64 , V_2 -> V_44 ) ;
F_18 ( V_2 ) ;
}
static void * F_75 ( void * V_15 , struct V_75 * V_76 ,
...
static void * F_77 ( void * V_43 )
{
struct V_1 * V_2 = V_43 ;
return V_2 -> V_29 ;
}
void * F_78 ( struct V_77 * V_33 )
{
struct V_18 * V_19 ;
