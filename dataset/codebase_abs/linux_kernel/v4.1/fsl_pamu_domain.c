...
V_26 = F_53 ( V_42 -> V_77 , L_22 , & V_80 ) ;
if ( V_26 ) {
V_79 = V_80 / sizeof( T_4 ) ;
V_29 = F_48 ( V_9 , V_42 , V_26 , V_79 ) ;
} else {
F_5 ( L_23 ,
V_42 -> V_77 -> V_78 ) ;
V_29 = - V_40 ;
...
static int F_55 ( struct V_2 * V_48 , void * V_88 )
{
struct V_15 * V_43 = V_88 ;
struct V_1 * V_9 = F_1 ( V_48 ) ;
T_3 V_18 ;
unsigned long V_31 ;
...
static int F_56 ( struct V_1 * V_9 , void * V_88 )
{
struct V_89 * V_90 = V_88 ;
unsigned long V_31 ;
int V_29 ;
F_10 ( & V_9 -> V_51 , V_31 ) ;
memcpy ( & V_9 -> V_91 , V_90 ,
sizeof( struct V_89 ) ) ;
V_9 -> V_35 = F_57 ( V_90 -> V_92 ,
V_90 -> V_93 ) ;
if ( V_9 -> V_35 == ~ ( T_4 ) 0 ) {
F_5 ( L_26 ) ;
F_12 ( & V_9 -> V_51 , V_31 ) ;
...
static int F_58 ( struct V_1 * V_9 , bool V_94 )
{
struct V_8 * V_52 ;
unsigned long V_31 ;
int V_29 ;
...
static struct V_101 * F_62 ( struct V_41 * V_42 )
{
struct V_101 * V_102 ;
V_102 = F_63 ( V_42 ) ;
if ( ! V_102 )
...
static bool F_65 ( struct V_83 * V_84 )
{
T_4 V_103 ;
V_103 = F_66 ( V_84 -> V_104 + ( V_105 >> 2 ) ) ;
V_103 &= V_106 ;
return V_103 >= 0x204 ;
}
static struct V_101 * F_67 ( struct V_81 * V_82 )
{
struct V_81 * V_56 ;
struct V_101 * V_102 ;
...
static struct V_101 * F_68 ( struct V_81 * V_82 )
{
struct V_83 * V_84 ;
bool V_108 ;
...
V_108 = F_65 ( V_84 ) ;
if ( V_108 ) {
V_102 = F_69 ( & V_82 -> V_42 ) ;
if ( V_84 -> V_86 -> V_101 )
F_70 ( V_84 -> V_86 ) ;
} else {
if ( V_84 -> V_86 -> V_101 ) {
V_102 = F_62 ( V_84 -> V_86 ) ;
F_70 ( V_84 -> V_86 ) ;
} else {
V_102 = F_67 ( V_82 ) ;
}
...
static int F_78 ( struct V_2 * V_48 , T_4 V_110 )
{
struct V_1 * V_9 = F_1 ( V_48 ) ;
unsigned long V_31 ;
int V_29 ;
...
static T_4 F_82 ( struct V_2 * V_48 )
{
struct V_1 * V_9 = F_1 ( V_48 ) ;
return V_9 -> V_11 ;
}
