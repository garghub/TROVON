...
static int T_2 F_41 ( enum V_19 V_20 , unsigned long V_93 )
{
int V_53 ;
switch ( V_20 ) {
case V_94 :
...
static int T_2 F_44 ( unsigned long * V_98 , unsigned long * V_35 )
{
struct V_73 * V_74 ;
F_31 (memory, reg) {
* V_98 += V_74 -> V_52 ;
...
static void T_2 F_46 ( int V_20 , struct V_59 * V_99 ,
unsigned long V_55 )
{
T_5 V_41 ;
int V_32 ;
...
struct V_109 V_109 ;
int V_53 ;
V_53 = F_8 ( & V_109 , V_110 , sizeof( V_109 ) ) ;
if ( V_53 )
return V_53 ;
if ( V_109 . V_111 == 0 )
return 0 ;
...
return - V_23 ;
if ( V_109 . V_111 < F_20 () )
V_53 = F_8 ( V_77 , V_109 . V_111 , V_8 ) ;
else
V_53 = F_51 ( V_77 , ( void * ) V_109 . V_111 , V_8 ) ;
if ( V_53 || F_52 ( V_77 , V_77 -> V_99 . V_31 , 0 ) !=
V_109 . V_112 ) {
F_4 ( L_11 ) ;
...
if ( V_115 )
return - V_11 ;
V_116 = F_55 ( L_12 , 4 , 1 , 4 * sizeof( long ) ) ;
F_56 ( V_116 , & V_117 ) ;
F_57 ( V_116 , 6 ) ;
F_4 ( L_13 , V_113 . V_118 . V_119 . V_120 . V_121 ) ;
F_4 ( L_14 , ( unsigned long long ) V_113 . V_118 . V_119 . V_122 ) ;
F_4 ( L_15 , ( unsigned long long ) V_113 . V_118 . V_119 . V_123 ) ;
V_53 = F_58 () ;
if ( V_53 )
goto V_58;
V_53 = F_43 () ;
...
if ( V_53 )
goto V_58;
V_125 = F_59 ( L_12 , NULL ) ;
if ( ! V_125 ) {
V_53 = - V_23 ;
goto V_58;
}
V_126 = F_60 ( L_18 , V_127 , V_125 , NULL ,
& V_128 ) ;
if ( ! V_126 ) {
V_53 = - V_23 ;
goto V_129;
}
V_130 = F_60 ( L_19 , V_127 , V_125 ,
NULL , & V_131 ) ;
if ( ! V_130 ) {
V_53 = - V_23 ;
goto V_132;
}
V_133 = F_60 ( L_20 , V_127 , V_125 ,
NULL , & V_134 ) ;
if ( ! V_133 ) {
V_53 = - V_23 ;
goto V_135;
}
V_136 = F_60 ( L_21 , V_127 | V_137 , V_125 ,
NULL , & V_138 ) ;
if ( ! V_136 ) {
V_53 = - V_23 ;
goto V_139;
