...
int F_125 ( struct V_1 * V_2 , struct V_14 * * V_151 )
{
struct V_14 * V_18 ;
int V_59 = 0 ;
const int V_152 = F_50 ( V_2 -> V_4 ) ,
V_153 = F_48 ( V_2 -> V_6 ) ;
F_14 (evlist, evsel) {
if ( V_18 -> V_154 == NULL )
continue;
V_59 = F_126 ( V_18 , V_152 , V_153 , V_18 -> V_154 ) ;
if ( V_59 ) {
* V_151 = V_18 ;
break;
}
...
int F_127 ( struct V_1 * V_2 , const char * V_154 )
{
struct V_14 * V_18 ;
int V_59 = 0 ;
const int V_152 = F_50 ( V_2 -> V_4 ) ,
V_153 = F_48 ( V_2 -> V_6 ) ;
F_14 (evlist, evsel) {
V_59 = F_126 ( V_18 , V_152 , V_153 , V_154 ) ;
if ( V_59 )
break;
}
return V_59 ;
}
int F_128 ( struct V_1 * V_2 , T_1 V_155 , T_5 * V_156 )
{
char * V_154 ;
int V_80 = - 1 ;
T_1 V_7 ;
...
if ( V_7 == 0 ) {
if ( F_129 ( & V_154 , L_10 , V_156 [ V_7 ] ) < 0 )
return - 1 ;
} else {
char * V_157 ;
if ( F_129 ( & V_157 , L_11 , V_154 , V_156 [ V_7 ] ) < 0 )
goto V_158;
free ( V_154 ) ;
V_154 = V_157 ;
}
}
V_80 = F_127 ( V_2 , V_154 ) ;
V_158:
free ( V_154 ) ;
return V_80 ;
}
int F_130 ( struct V_1 * V_2 , T_5 V_13 )
{
return F_128 ( V_2 , 1 , & V_13 ) ;
}
...
{
struct V_14 * V_18 ;
int V_152 = F_50 ( V_2 -> V_4 ) ;
int V_153 = F_48 ( V_2 -> V_6 ) ;
int V_20 ;
F_139 (evlist, evsel) {
V_20 = V_18 -> V_4 ? V_18 -> V_4 -> V_146 : V_152 ;
F_140 ( V_18 , V_20 , V_153 ) ;
}
}
...
F_13 ( V_2 ) ;
F_14 (evlist, evsel) {
V_59 = F_144 ( V_18 , V_2 -> V_4 , V_2 -> V_6 ) ;
if ( V_59 < 0 )
goto V_173;
}
return 0 ;
...
int F_145 ( struct V_1 * V_2 , struct V_147 * V_147 ,
const char * V_174 [] , bool V_175 ,
void (* F_146)( int V_176 , T_7 * V_177 , void * V_178 ) )
{
int V_179 [ 2 ] , V_180 [ 2 ] ;
char V_181 ;
if ( F_147 ( V_179 ) < 0 ) {
...
F_150 ( V_179 [ 0 ] ) ;
F_150 ( V_180 [ 1 ] ) ;
F_66 ( V_180 [ 0 ] , V_186 , V_187 ) ;
F_150 ( V_179 [ 1 ] ) ;
V_80 = F_82 ( V_180 [ 0 ] , & V_181 , 1 ) ;
if ( V_80 != 1 ) {
if ( V_80 == - 1 )
perror ( L_15 ) ;
exit ( V_80 ) ;
}
F_151 ( V_174 [ 0 ] , ( char * * ) V_174 ) ;
if ( F_146 ) {
union V_188 V_131 ;
V_131 . V_189 = V_83 ;
if ( F_152 ( F_153 () , V_190 , V_131 ) )
perror ( V_174 [ 0 ] ) ;
} else
perror ( V_174 [ 0 ] ) ;
exit ( - 1 ) ;
...
F_150 ( V_179 [ 1 ] ) ;
F_150 ( V_180 [ 0 ] ) ;
if ( F_82 ( V_179 [ 0 ] , & V_181 , 1 ) == - 1 ) {
perror ( L_15 ) ;
goto V_183;
}
F_66 ( V_180 [ 1 ] , V_186 , V_187 ) ;
V_2 -> V_12 . V_197 = V_180 [ 1 ] ;
F_150 ( V_179 [ 0 ] ) ;
return 0 ;
V_183:
F_150 ( V_180 [ 0 ] ) ;
...
char V_181 = 0 ;
int V_80 ;
V_80 = F_156 ( V_2 -> V_12 . V_197 , & V_181 , 1 ) ;
if ( V_80 < 0 )
perror ( L_17 ) ;
F_150 ( V_2 -> V_12 . V_197 ) ;
return V_80 ;
}
return 0 ;
}
int F_157 ( struct V_1 * V_2 , union V_93 * V_94 ,
struct V_162 * V_96 )
{
struct V_14 * V_18 = F_89 ( V_2 , V_94 ) ;
if ( ! V_18 )
return - V_198 ;
return F_158 ( V_18 , V_94 , V_96 ) ;
}
T_1 F_159 ( struct V_1 * V_2 , T_8 * V_199 )
{
struct V_14 * V_18 ;
T_1 V_200 = 0 ;
F_14 (evlist, evsel) {
V_200 += fprintf ( V_199 , L_18 , V_18 -> V_25 ? L_19 : L_20 ,
F_160 ( V_18 ) ) ;
}
return V_200 + fprintf ( V_199 , L_21 ) ;
}
int F_161 ( struct V_1 * V_2 V_139 ,
int V_59 , char * V_201 , T_1 V_98 )
{
int V_200 , V_141 ;
char V_202 [ V_203 ] , * V_204 = F_162 ( V_59 , V_202 , sizeof( V_202 ) ) ;
switch ( V_59 ) {
case V_205 :
case V_206 :
V_200 = F_163 ( V_201 , V_98 ,
L_22
L_23 , V_204 ) ;
V_141 = F_164 () ;
V_200 += F_163 ( V_201 + V_200 , V_98 - V_200 , L_24 ) ;
if ( V_141 >= 2 ) {
V_200 += F_163 ( V_201 + V_200 , V_98 - V_200 ,
L_25 ) ;
}
V_200 += F_163 ( V_201 + V_200 , V_98 - V_200 ,
L_26 ) ;
...
break;
default:
F_163 ( V_201 , V_98 , L_29 , V_204 ) ;
break;
}
return 0 ;
}
int F_165 ( struct V_1 * V_2 , int V_59 , char * V_201 , T_1 V_98 )
{
char V_202 [ V_203 ] , * V_204 = F_162 ( V_59 , V_202 , sizeof( V_202 ) ) ;
int V_207 = V_2 -> V_117 / 1024 , V_208 , V_200 = 0 ;
switch ( V_59 ) {
case V_206 :
F_107 ( L_6 , & V_208 ) ;
V_200 += F_163 ( V_201 + V_200 , V_98 - V_200 ,
...
return;
F_17 (evlist, n, evsel) {
if ( V_18 -> V_30 == V_209 -> V_30 )
F_167 ( & V_18 -> V_21 , & V_210 ) ;
}
F_168 ( & V_210 , & V_2 -> V_10 ) ;
}
