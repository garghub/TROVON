...
int F_42 ( struct V_2 * V_3 , int V_70 )
{
int V_4 , V_34 = 0 ;
while ( ! F_28 ( & V_3 -> V_55 ) ) {
struct V_1 * V_7 ;
V_7 = F_43 ( V_3 -> V_55 . V_71 , struct V_1 , V_27 ) ;
V_34 = F_44 ( V_3 , V_7 -> V_4 ) ;
if ( V_34 )
return V_34 ;
F_45 ( & V_7 -> V_27 ) ;
F_17 ( V_7 ) ;
...
static int F_46 ( struct V_72 * V_73 , int V_4 )
{
...
F_48 (dr, n, done_tree, rb)
F_17 ( V_75 ) ;
}
static int F_49 ( struct V_2 * V_3 , void * V_58 , int * V_4 , int * V_33 ,
void * V_77 )
{
struct V_78 * V_51 = V_77 ;
int V_63 = F_50 ( V_51 -> V_63 ) , V_79 = V_3 -> V_20 - * V_33 ;
if ( V_63 > V_79 ) {
int V_80 = F_35 ( * V_33 , V_3 -> V_66 ) , V_34 ;
F_38 ( V_3 , V_58 + * V_33 , V_80 - * V_33 ) ;
V_34 = F_51 ( V_3 , * V_4 , V_58 , V_80 ) ;
if ( V_34 )
return V_34 ;
* V_4 = F_22 ( V_3 , * V_4 ) ;
* V_33 = 0 ;
...
V_87 = V_4 ;
while ( 1 ) {
V_82 = F_55 ( V_3 , V_4 , 0 , V_3 -> V_88 , 0 ) ;
if ( F_56 ( V_82 ) ) {
V_34 = F_57 ( V_82 ) ;
goto V_89;
}
F_58 (snod, &sleb->nodes, list) {
switch ( V_84 -> type ) {
case V_53 : {
struct V_35 * V_36 = V_84 -> V_77 ;
int V_90 = F_50 ( V_36 -> V_4 ) ;
V_34 = F_46 ( & V_73 , V_90 ) ;
if ( V_34 < 0 )
goto V_91;
if ( V_34 != 1 ) {
V_34 = F_49 ( V_3 , V_58 , & V_87 ,
& V_33 , V_84 -> V_77 ) ;
if ( V_34 )
goto V_91;
}
...
F_2 ( & V_3 -> V_8 ) ;
for ( V_61 = 0 ; V_61 < V_3 -> V_65 ; V_61 ++ )
F_58 (bud, &c->jheads[i].buds_list, list)
