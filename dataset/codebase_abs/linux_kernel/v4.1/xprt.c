...
static inline void F_35 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
F_24 ( & V_16 -> V_40 ) ;
...
static void
F_36 ( struct V_15 * V_16 , struct V_19 * V_20 )
{
if ( ! V_20 -> V_47 )
return;
V_20 -> V_47 = 0 ;
...
void F_62 ( struct V_15 * V_16 , unsigned int V_85 )
{
F_24 ( & V_16 -> V_40 ) ;
if ( V_85 != V_16 -> V_86 )
goto V_8;
if ( F_16 ( V_87 , & V_16 -> V_24 ) || ! F_63 ( V_16 ) )
goto V_8;
F_61 ( V_36 , & V_16 -> V_24 ) ;
if ( F_12 ( V_23 , & V_16 -> V_24 ) == 0 )
F_20 ( V_37 , & V_16 -> V_38 ) ;
...
void F_67 ( struct V_15 * V_16 , void * V_85 )
{
F_24 ( & V_16 -> V_40 ) ;
if ( V_16 -> V_25 != V_85 )
goto V_8;
...
struct V_19 * F_72 ( struct V_15 * V_16 , T_2 V_105 )
{
struct V_19 * V_106 ;
...
long V_109 = F_76 ( F_77 ( V_20 -> V_110 ) ) ;
if ( V_57 ) {
if ( V_20 -> V_27 == 1 )
F_78 ( V_65 , V_57 , V_109 ) ;
F_79 ( V_65 , V_57 , V_20 -> V_27 - 1 ) ;
}
}
void F_80 ( struct V_17 * V_18 , int V_111 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
struct V_15 * V_16 = V_20 -> V_51 ;
F_13 ( L_21 ,
V_18 -> V_28 , F_74 ( V_20 -> V_107 ) , V_111 ) ;
F_81 ( V_16 , V_20 -> V_107 , V_111 ) ;
V_16 -> V_92 . V_112 ++ ;
V_20 -> V_110 = F_82 ( F_83 () , V_20 -> V_113 ) ;
...
if ( ! V_20 -> V_117 && F_90 ( V_18 ) )
F_45 ( & V_16 -> V_54 , V_18 , F_85 ) ;
V_20 -> V_121 = V_16 -> V_86 ;
}
F_25 ( & V_16 -> V_40 ) ;
}
static void F_94 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
F_61 ( V_138 , & V_16 -> V_24 ) ;
F_45 ( & V_16 -> V_133 , V_18 , NULL ) ;
}
static void F_95 ( struct V_15 * V_16 )
{
if ( F_96 ( & V_16 -> V_133 ) == NULL )
F_18 ( V_138 , & V_16 -> V_24 ) ;
}
static bool F_97 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
bool V_90 = false ;
...
static struct V_19 * F_98 ( struct V_15 * V_16 , T_3 V_140 )
{
struct V_19 * V_20 = F_99 ( - V_31 ) ;
if ( ! F_100 ( & V_16 -> V_128 , 1 , V_16 -> V_141 ) )
goto V_8;
V_20 = F_101 ( sizeof( struct V_19 ) , V_140 ) ;
if ( V_20 != NULL )
goto V_8;
F_102 ( & V_16 -> V_128 ) ;
V_20 = F_99 ( - V_142 ) ;
...
static bool F_103 ( struct V_15 * V_16 , struct V_19 * V_20 )
{
if ( F_100 ( & V_16 -> V_128 , - 1 , V_16 -> V_143 ) ) {
F_104 ( V_20 ) ;
return true ;
}
return false ;
...
F_2 ( & V_16 -> V_139 ) ;
if ( ! F_65 ( & V_16 -> free ) ) {
V_20 = F_106 ( V_16 -> free . V_144 , struct V_19 , V_114 ) ;
F_107 ( & V_20 -> V_114 ) ;
goto V_145;
}
V_20 = F_98 ( V_16 , V_146 | V_147 ) ;
if ( ! F_108 ( V_20 ) )
goto V_145;
switch ( F_109 ( V_20 ) ) {
case - V_142 :
...
static void F_112 ( struct V_15 * V_16 , struct V_19 * V_20 )
{
F_2 ( & V_16 -> V_139 ) ;
if ( ! F_103 ( V_16 , V_20 ) ) {
memset ( V_20 , 0 , sizeof( * V_20 ) ) ;
F_113 ( & V_20 -> V_114 , & V_16 -> free ) ;
}
F_95 ( V_16 ) ;
F_6 ( & V_16 -> V_139 ) ;
}
...
{
struct V_19 * V_20 ;
while ( ! F_65 ( & V_16 -> free ) ) {
V_20 = F_115 ( & V_16 -> free , struct V_19 , V_114 ) ;
F_107 ( & V_20 -> V_114 ) ;
F_104 ( V_20 ) ;
}
}
struct V_15 * F_116 ( struct V_148 * V_148 , T_4 V_149 ,
unsigned int V_150 ,
unsigned int V_151 )
{
struct V_15 * V_16 ;
struct V_19 * V_20 ;
int V_152 ;
V_16 = F_101 ( V_149 , V_153 ) ;
if ( V_16 == NULL )
goto V_8;
F_117 ( V_16 , V_148 ) ;
for ( V_152 = 0 ; V_152 < V_150 ; V_152 ++ ) {
V_20 = F_101 ( sizeof( struct V_19 ) , V_153 ) ;
if ( ! V_20 )
goto V_154;
F_113 ( & V_20 -> V_114 , & V_16 -> free ) ;
}
...
static void F_110 ( struct V_17 * V_18 , struct V_15 * V_16 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
F_129 ( & V_20 -> V_114 ) ;
...
static void F_117 ( struct V_15 * V_16 , struct V_148 * V_148 )
{
F_118 ( & V_16 -> V_171 , 1 ) ;
F_137 ( & V_16 -> V_40 ) ;
F_137 ( & V_16 -> V_139 ) ;
...
V_16 -> V_49 = V_175 ;
V_16 -> V_176 = 0 ;
F_139 ( & V_16 -> V_177 , L_31 ) ;
F_139 ( & V_16 -> V_54 , L_32 ) ;
F_140 ( & V_16 -> V_35 , L_33 ) ;
F_140 ( & V_16 -> V_133 , L_34 ) ;
F_127 ( V_16 ) ;
V_16 -> V_155 = F_141 ( V_148 ) ;
}
struct V_15 * F_142 ( struct V_178 * args )
{
struct V_15 * V_16 ;
struct V_1 * V_3 ;
F_2 ( & V_6 ) ;
...
if ( args -> V_181 & V_182 )
V_16 -> V_118 = 0 ;
F_143 ( & V_16 -> V_38 , F_56 ) ;
if ( F_86 ( V_16 ) )
F_144 ( & V_16 -> V_57 , F_64 ,
( unsigned long ) V_16 ) ;
else
F_145 ( & V_16 -> V_57 ) ;
...
V_16 -> V_103 = F_147 ( args -> V_103 , V_153 ) ;
if ( V_16 -> V_103 == NULL ) {
F_146 ( V_16 ) ;
return F_99 ( - V_142 ) ;
}
