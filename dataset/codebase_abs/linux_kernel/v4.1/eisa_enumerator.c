...
if ( V_49 -> V_74 & V_75 ) {
F_16 ( 0x01 | F_17 ( F_31 ( V_47 ) + V_73 + 4 ) ,
F_31 ( V_47 ) + V_73 + 4 ) ;
}
return 0 ;
}
int F_32 ( unsigned long V_76 ,
