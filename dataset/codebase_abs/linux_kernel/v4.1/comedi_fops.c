...
void * F_65 ( struct V_21 * V_22 , T_2 V_60 )
{
V_22 -> V_74 = F_66 ( V_60 , V_75 ) ;
if ( V_22 -> V_74 )
V_22 -> V_67 |= V_76 ;
return V_22 -> V_74 ;
}
...
F_82 ( V_101 . V_105 , V_2 -> V_13 -> V_105 , V_91 ) ;
F_82 ( V_101 . V_90 , V_2 -> V_90 , V_91 ) ;
V_22 = F_37 ( V_33 ) ;
if ( V_22 )
...
V_101 . V_107 = - 1 ;
if ( F_80 ( V_86 , & V_101 , sizeof( V_101 ) ) )
return - V_89 ;
return 0 ;
}
...
struct V_21 * V_22 ;
V_109 = F_84 ( V_2 -> V_83 , sizeof( * V_109 ) , V_75 ) ;
if ( ! V_109 )
return - V_111 ;
for ( V_15 = 0 ; V_15 < V_2 -> V_83 ; V_15 ++ ) {
V_22 = & V_2 -> V_84 [ V_15 ] ;
...
V_81 = F_80 ( V_86 , V_109 , V_2 -> V_83 * sizeof( * V_109 ) ) ;
F_10 ( V_109 ) ;
return V_81 ? - V_89 : 0 ;
}
...
struct V_21 * V_22 ;
struct V_43 * V_44 ;
if ( F_76 ( & V_143 , V_86 , sizeof( V_143 ) ) )
return - V_89 ;
...
V_143 . V_148 = F_89 ( V_22 , V_143 . V_148 ) ;
F_90 ( V_22 , V_143 . V_148 ) ;
if ( F_64 ( V_22 ) &&
F_91 ( V_22 ) == 0 ) {
F_67 ( V_2 , V_22 ) ;
}
...
V_143 . V_149 =
F_92 ( V_22 , V_143 . V_149 ) ;
F_93 ( V_22 , V_143 . V_149 ) ;
}
V_150:
...
V_99:
if ( F_80 ( V_86 , & V_143 , sizeof( V_143 ) ) )
return - V_89 ;
return 0 ;
}
...
F_95 ( L_8 ,
V_155 [ 0 ] ) ;
F_95 ( L_9 , V_187 , __FILE__ ) ;
F_95 ( L_10 , V_154 -> V_156 ) ;
return 0 ;
}
return - V_65 ;
}
static int F_96 ( struct V_1 * V_2 , struct V_153 * V_154 ,
...
int V_15 = 0 ;
int V_81 = 0 ;
if ( F_76 ( & V_212 , V_86 , sizeof( V_212 ) ) )
return - V_89 ;
V_155 = F_102 ( V_214 , sizeof( unsigned int ) , V_75 ) ;
if ( ! V_155 ) {
V_81 = - V_111 ;
goto error;
}
V_213 = F_84 ( V_212 . V_215 , sizeof( * V_213 ) , V_75 ) ;
if ( ! V_213 ) {
V_81 = - V_111 ;
goto error;
}
if ( F_76 ( V_213 , V_212 . V_213 ,
...
if ( F_76 ( V_155 , V_213 [ V_15 ] . V_155 ,
...
V_81 = F_96 ( V_2 , V_213 + V_15 , V_155 , V_33 ) ;
if ( V_81 < 0 )
goto error;
if ( V_213 [ V_15 ] . V_154 & V_217 ) {
if ( F_80 ( V_213 [ V_15 ] . V_155 , V_155 ,
V_213 [ V_15 ] . V_156 * sizeof( unsigned int ) ) ) {
F_40 ( V_2 -> V_9 ,
L_23 ) ;
V_81 = - V_89 ;
...
if ( F_76 ( & V_154 , V_86 , sizeof( V_154 ) ) ) {
V_81 = - V_89 ;
goto error;
}
...
V_81 = F_96 ( V_2 , & V_154 , V_155 , V_33 ) ;
if ( V_81 < 0 )
goto error;
...
if ( F_109 ( V_79 ) )
return F_110 ( V_79 ) ;
V_81 = F_99 ( V_22 , V_78 -> V_220 , V_79 ) ;
if ( V_81 < 0 ) {
F_10 ( V_79 ) ;
return V_81 ;
}
...
V_81 = F_107 ( V_2 , V_22 , V_221 , & V_44 -> V_78 ) ;
if ( V_81 )
goto V_222;
...
V_22 = & V_2 -> V_84 [ V_78 . V_138 ] ;
if ( V_221 ) {
V_81 = F_107 ( V_2 , V_22 , V_221 , & V_78 ) ;
if ( V_81 )
return V_81 ;
}
...
static int F_114 ( struct V_1 * V_2 , unsigned long V_86 ,
void * V_33 )
{
struct V_21 * V_22 ;
if ( V_86 >= V_2 -> V_83 )
...
static long F_119 ( struct V_33 * V_33 , unsigned int V_78 ,
unsigned long V_86 )
{
...
break;
case V_238 :
V_233 = F_81 ( V_2 , (struct V_100 T_3 * ) V_86 ,
V_33 ) ;
break;
case V_239 :
V_233 = F_83 ( V_2 ,
...
break;
case V_240 :
V_233 = F_86 ( V_2 , ( void T_3 * ) V_86 ) ;
break;
case V_241 :
V_233 = F_120 ( V_2 , ( void T_3 * ) V_86 ) ;
break;
case V_242 :
V_233 = F_88 ( V_2 ,
...
break;
case V_244 :
V_233 = F_114 ( V_2 , V_86 , V_33 ) ;
break;
case V_245 :
V_233 = F_115 ( V_2 , V_86 , V_33 ) ;
break;
case V_246 :
V_233 = F_111 ( V_2 , (struct V_218 T_3 * ) V_86 , V_33 ) ;
break;
case V_247 :
V_233 = F_112 ( V_2 , (struct V_218 T_3 * ) V_86 ,
V_33 ) ;
break;
case V_248 :
V_233 = F_101 ( V_2 ,
...
break;
case V_249 :
V_233 = F_105 ( V_2 , (struct V_153 T_3 * ) V_86 ,
V_33 ) ;
break;
case V_250 :
...
static int F_125 ( struct V_33 * V_33 , struct V_253 * V_258 )
{
struct V_34 * V_35 = V_33 -> V_36 ;
struct V_1 * V_2 = V_35 -> V_2 ;
struct V_21 * V_22 ;
...
if ( F_128 ( V_258 , V_259 ,
F_129 ( F_130 ( V_58 -> V_269 ) ) ,
V_50 , V_270 ) ) {
V_45 = - V_196 ;
goto V_236;
}
...
static unsigned int F_132 ( struct V_33 * V_33 , T_4 * V_274 )
{
unsigned int V_68 = 0 ;
struct V_34 * V_35 = V_33 -> V_36 ;
struct V_1 * V_2 = V_35 -> V_2 ;
...
V_22 = F_37 ( V_33 ) ;
if ( V_22 && V_22 -> V_44 ) {
F_133 ( V_33 , & V_22 -> V_44 -> V_80 , V_274 ) ;
...
V_22 = F_38 ( V_33 ) ;
if ( V_22 && V_22 -> V_44 ) {
unsigned int V_277 = F_135 ( V_22 ) ;
F_133 ( V_33 , & V_22 -> V_44 -> V_80 , V_274 ) ;
F_92 ( V_22 , V_22 -> V_44 -> V_54 ) ;
if ( ! V_22 -> V_48 || ! F_62 ( V_22 ) ||
! ( V_22 -> V_44 -> V_78 . V_69 & V_152 ) ||
F_136 ( V_22 ) >= V_277 )
V_68 |= V_278 | V_279 ;
...
static T_1 F_137 ( struct V_33 * V_33 , const char T_3 * V_58 ,
T_2 V_280 , T_5 * V_281 )
{
struct V_21 * V_22 ;
struct V_43 * V_44 ;
...
V_282 = F_76 ( V_44 -> V_293 + V_44 -> V_144 ,
V_58 , V_156 ) ;
if ( V_282 ) {
V_156 -= V_282 ;
V_45 = - V_89 ;
...
static T_1 F_144 ( struct V_33 * V_33 , char T_3 * V_58 , T_2 V_280 ,
T_5 * V_281 )
{
struct V_21 * V_22 ;
struct V_43 * V_44 ;
...
V_35 = F_66 ( sizeof( * V_35 ) , V_75 ) ;
if ( ! V_35 )
return - V_111 ;
V_35 -> V_2 = V_2 ;
F_16 ( & V_2 -> V_5 ) ;
if ( ! V_2 -> V_12 && ! F_75 ( V_297 ) ) {
F_40 ( V_2 -> V_9 , L_38 ) ;
V_233 = - V_61 ;
goto V_197;
}
if ( V_2 -> V_12 && V_2 -> V_14 == 0 ) {
if ( ! F_147 ( V_2 -> V_13 -> V_10 ) ) {
V_233 = - V_298 ;
goto V_197;
}
if ( V_2 -> V_273 ) {
...
static int F_148 ( int V_299 , struct V_33 * V_33 , int V_300 )
{
struct V_34 * V_35 = V_33 -> V_36 ;
struct V_1 * V_2 = V_35 -> V_2 ;
return F_149 ( V_299 , V_33 , V_300 , & V_2 -> V_301 ) ;
}
static int F_150 ( struct V_296 * V_296 , struct V_33 * V_33 )
{
struct V_34 * V_35 = V_33 -> V_36 ;
struct V_1 * V_2 = V_35 -> V_2 ;
...
void F_151 ( struct V_1 * V_2 , struct V_21 * V_22 )
{
struct V_43 * V_44 = V_22 -> V_44 ;
unsigned int V_303 ;
int V_304 = 0 ;
...
F_57 ( & V_22 -> V_70 , V_69 ) ;
if ( V_304 )
F_153 ( & V_2 -> V_301 , V_308 , V_304 ) ;
}
struct V_1 * F_154 ( struct V_27 * V_309 )
{
struct V_1 * V_2 ;
struct V_27 * V_55 ;
unsigned V_15 ;
V_2 = F_66 ( sizeof( * V_2 ) , V_75 ) ;
if ( ! V_2 )
return F_155 ( - V_111 ) ;
F_1 ( V_2 ) ;
F_156 ( V_2 , V_309 ) ;
...
V_2 -> V_7 = V_15 ;
V_55 = F_157 ( V_19 , V_309 ,
F_24 ( V_20 , V_15 ) , NULL , L_40 , V_15 ) ;
if ( ! F_109 ( V_55 ) )
V_2 -> V_9 = F_158 ( V_55 ) ;
return V_2 ;
}
static void F_159 ( unsigned V_7 )
{
F_26 ( V_7 >= V_23 ) ;
F_22 ( F_21 ( V_7 ) ) ;
}
void F_160 ( struct V_27 * V_309 )
{
int V_7 ;
struct V_1 * V_2 ;
...
V_45 = F_167 ( F_24 ( V_20 , 0 ) ,
V_311 , L_46 ) ;
if ( V_45 )
return - V_199 ;
F_168 ( & V_313 , & V_314 ) ;
V_313 . V_315 = V_316 ;
V_45 = F_169 ( & V_313 . V_317 , L_46 ) ;
if ( V_45 ) {
F_170 ( F_24 ( V_20 , 0 ) ,
V_311 ) ;
return V_45 ;
}
if ( F_171 ( & V_313 , F_24 ( V_20 , 0 ) , V_311 ) ) {
F_170 ( F_24 ( V_20 , 0 ) ,
V_311 ) ;
return - V_199 ;
}
V_19 = F_172 ( V_316 , L_46 ) ;
if ( F_109 ( V_19 ) ) {
F_166 ( L_47 ) ;
F_173 ( & V_313 ) ;
F_170 ( F_24 ( V_20 , 0 ) ,
