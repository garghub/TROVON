...
static int F_7 ( struct V_9 * V_10 , unsigned * V_8 )
{
int V_13 ;
struct V_14 V_15 = {
. V_16 = & V_10 -> V_17 [ 0 ] ,
...
V_125 = & V_129 ;
F_1 ( V_10 -> V_1 ) ;
V_10 -> V_21 -> V_130 = V_131 ;
V_10 -> V_21 -> V_91 = V_132 ;
F_48 ( V_10 -> V_21 ) ;
V_10 -> V_46 = F_49 ( V_125 -> V_133 & 0x3 ) ;
V_10 -> V_31 = F_50 ( V_125 -> V_134
& 0x3 ) | ( V_125 -> V_135 ?
V_136 : 0 ) ;
V_13 = F_16 ( V_10 ) ;
if ( V_13 < 0 )
...
V_10 -> V_12 += 5 ;
V_53 -> V_96 = F_52 ( V_21 ) -> V_96 ;
V_53 -> V_49 . V_138 = & V_21 -> V_49 ;
V_53 -> V_139 = V_140 ;
V_13 = F_29 ( V_10 ) ;
if ( V_13 < 0 )
return V_13 ;
...
static int F_56 ( struct V_123 * V_21 )
{
struct V_52 * V_53 = F_57 ( V_21 ) ;
struct V_9 * V_10 = F_20 ( V_53 ) ;
if ( V_21 -> V_108 > 0 )
F_58 ( V_21 -> V_108 , V_53 ) ;
F_55 ( V_53 ) ;
