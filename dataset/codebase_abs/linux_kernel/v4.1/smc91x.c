...
V_309 = F_171 ( V_11 , V_277 , V_306 , V_28 ) ;
if ( F_172 ( V_309 ) )
return F_173 ( V_309 ) ;
if ( V_309 ) {
if ( V_308 )
...
static int F_176 ( struct V_282 * V_283 )
{
struct V_313 * V_314 = F_177 ( & V_283 -> V_11 ) ;
const struct V_315 * V_316 = NULL ;
struct V_12 * V_13 ;
struct V_10 * V_284 ;
struct V_287 * V_288 ;
unsigned int T_2 * V_205 ;
unsigned long V_256 = V_317 ;
unsigned long V_318 ;
int V_216 ;
V_284 = F_178 ( sizeof( struct V_12 ) ) ;
if ( ! V_284 ) {
V_216 = - V_292 ;
goto V_319;
}
F_179 ( V_284 , & V_283 -> V_11 ) ;
V_13 = F_5 ( V_284 ) ;
V_13 -> V_17 . V_28 = 0 ;
if ( V_314 ) {
memcpy ( & V_13 -> V_17 , V_314 , sizeof( V_13 -> V_17 ) ) ;
V_13 -> V_320 = F_180 ( V_13 -> V_17 . V_28 ) ;
}
#if F_181 ( V_321 )
V_316 = F_182 ( F_183 ( V_322 ) , & V_283 -> V_11 ) ;
if ( V_316 ) {
struct V_323 * V_324 = V_283 -> V_11 . V_325 ;
T_4 V_108 ;
V_216 = F_170 ( & V_283 -> V_11 , & V_13 -> V_326 ,
L_65 , 0 , 0 , 100 ) ;
if ( V_216 )
return V_216 ;
V_216 = F_170 ( & V_283 -> V_11 , & V_13 -> V_327 ,
L_66 , 0 , 0 , 100 ) ;
if ( V_216 )
return V_216 ;
if ( V_13 -> V_327 )
F_174 ( 750 , 1000 ) ;
if ( ! F_184 ( V_324 , L_67 , & V_108 ) ) {
if ( V_108 & 1 )
...
V_13 -> V_17 . V_28 |= ( V_332 ) ? V_329 : 0 ;
V_13 -> V_17 . V_28 |= ( V_333 ) ? V_330 : 0 ;
V_13 -> V_17 . V_28 |= ( V_334 ) ? V_29 : 0 ;
}
if ( ! V_13 -> V_17 . V_209 && ! V_13 -> V_17 . V_211 ) {
V_13 -> V_17 . V_209 = V_335 ;
V_13 -> V_17 . V_211 = V_336 ;
}
V_284 -> V_279 = ( unsigned char ) - 1 ;
V_288 = F_156 ( V_283 , V_289 , L_68 ) ;
if ( ! V_288 )
V_288 = F_185 ( V_283 , V_289 , 0 ) ;
if ( ! V_288 ) {
V_216 = - V_260 ;
goto V_337;
}
if ( ! F_165 ( V_288 -> V_290 , V_338 , V_48 ) ) {
V_216 = - V_299 ;
goto V_337;
}
V_284 -> V_182 = F_186 ( V_283 , 0 ) ;
if ( V_284 -> V_182 <= 0 ) {
V_216 = - V_260 ;
goto V_339;
}
V_318 = F_187 ( F_188 ( V_284 -> V_182 ) ) ;
if ( V_256 == - 1 || V_318 & V_340 )
V_256 = V_318 & V_340 ;
...
F_166 ( V_283 , V_284 ) ;
V_339:
F_167 ( V_288 -> V_290 , V_338 ) ;
V_337:
F_194 ( V_284 ) ;
V_319:
F_195 ( L_69 , V_48 , V_216 ) ;
return V_216 ;
}
