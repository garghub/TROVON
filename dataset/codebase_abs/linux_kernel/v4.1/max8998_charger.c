...
switch ( V_25 -> V_35 ) {
case 5 :
F_10 ( V_10 , V_36 , 0x0 << 4 , 0x3 << 4 ) ;
break;
case 6 :
F_10 ( V_10 , V_36 , 0x1 << 4 , 0x3 << 4 ) ;
break;
case 7 :
F_10 ( V_10 , V_36 , 0x2 << 4 , 0x3 << 4 ) ;
break;
case - 1 :
F_10 ( V_10 , V_36 , 0x3 << 4 , 0x3 << 4 ) ;
break;
case 0 :
F_11 ( V_8 -> V_22 ,
L_6 ) ;
