...
struct V_171 * V_172 ;
F_87 () ;
V_95 = ( V_23 -> V_191 + V_192 - V_23 -> V_193 )
% V_192 ;
if ( ! V_95 )
goto V_194;
V_172 = V_23 -> V_195 ;
if ( V_23 -> V_193 + V_95 > V_192 ) {
unsigned V_196 = V_192 - V_23 -> V_193 ;
memcpy ( V_172 , & V_23 -> V_197 [ V_23 -> V_193 ] , sizeof( * V_172 ) * V_196 ) ;
F_88 () ;
V_23 -> V_193 = 0 ;
V_95 -= V_196 ;
V_172 += V_196 ;
}
memcpy ( V_172 , & V_23 -> V_197 [ V_23 -> V_193 ] , sizeof( * V_172 ) * V_95 ) ;
F_88 () ;
V_23 -> V_193 += V_95 ;
F_87 () ;
if ( V_23 -> V_198 ) {
...
static int F_89 ( struct V_199 * V_200 , unsigned long V_101 ,
void * V_49 )
{
...
return V_204 ;
F_87 () ;
if ( ( V_23 -> V_191 + 1 ) % V_192 == V_23 -> V_193 ) {
F_88 () ;
V_23 -> V_198 ++ ;
return V_204 ;
}
memcpy ( & V_23 -> V_197 [ V_23 -> V_191 ] , V_171 , sizeof( * V_171 ) ) ;
F_88 () ;
V_23 -> V_191 = ( V_23 -> V_191 + 1 ) % V_192 ;
if ( V_171 -> V_179 & 1 )
F_86 ( V_21 ) ;
return V_205 ;
}
static void F_90 ( const struct V_206 * V_207 , void * V_208 )
{
int * V_209 = V_208 ;
T_7 V_210 ;
if ( * V_209 == - 1 )
...
(struct V_212 * ) V_207 ;
unsigned long V_213 =
( unsigned long ) & V_212 -> V_214 -
( unsigned long ) & V_212 -> type ;
unsigned long V_215 =
( unsigned long ) & V_212 -> V_216 -
( unsigned long ) & V_212 -> type ;
if ( V_212 -> V_67 == 0 )
return;
if ( V_212 -> V_217 > V_213 ) {
V_210 =
V_212 -> V_214 ;
} else if ( V_212 -> V_217 > V_215 ) {
V_210 = V_212 -> V_216 ;
} else {
* V_209 = - 1 ;
return;
...
{
int V_209 = 0 ;
F_92 ( F_90 , ( void * ) & V_209 ) ;
if ( V_209 < 1 )
return V_218 ;
return V_209 ;
}
static int F_93 ( struct V_20 * V_21 , T_1 V_219 )
{
struct V_22 * V_23 = V_21 -> V_24 ;
struct V_25 * V_16 ;
T_1 V_220 ;
...
if ( ! V_16 )
return - V_35 ;
F_15 ( V_16 , V_222 , & V_220 ) ;
if ( V_219 == 0 ) {
V_220 &= ~ V_223 ;
F_41 ( V_16 , V_222 ,
V_220 & ~ V_224 ) ;
F_15 ( V_16 , V_225 , & V_221 ) ;
V_221 &= ~ V_226 ;
V_221 |= V_227 ;
} else {
const int V_228 = 64 ;
const T_1 V_229 = V_23 -> V_209 ;
unsigned long long V_230 ;
V_230 = ( unsigned long long ) V_229 *
V_228 * 1000000 ;
F_94 ( V_230 , V_219 ) ;
if ( ! V_230 || V_230 > V_224 )
return - V_4 ;
V_220 = V_224 & V_230 ;
F_32 ( V_16 , V_222 ,
V_223 | V_220 ) ;
...
if ( ! V_16 )
return - V_35 ;
F_15 ( V_16 , V_222 , & V_233 ) ;
V_233 &= V_224 ;
if ( ! V_233 )
return 0 ;
V_232 = ( unsigned long long ) V_229 *
1000000 * V_228 ;
F_94 ( V_232 , V_233 ) ;
return ( int ) V_232 ;
}
...
static void F_102 ( struct V_11 * V_11 )
{
...
F_58 ( V_21 ) ;
F_103 ( V_21 -> V_16 ) ;
F_16 ( 1 , L_73 , V_21 -> V_240 ) ;
F_10 ( V_21 -> V_240 ) ;
F_104 ( V_21 ) ;
V_11 -> V_21 = NULL ;
}
static int F_105 ( struct V_11 * V_11 )
{
struct V_20 * V_21 ;
struct V_22 * V_23 ;
int V_96 ;
...
V_69 [ 1 ] . V_67 = V_245 ;
V_69 [ 1 ] . V_243 = true ;
V_21 = F_106 ( V_11 -> V_12 , F_107 ( V_69 ) , V_69 ,
sizeof( * V_23 ) ) ;
if ( F_65 ( ! V_21 ) )
return - V_115 ;
F_16 ( 0 , L_72 , V_21 , & V_11 -> V_16 [ 0 ] -> V_92 ) ;
...
V_21 -> V_251 = L_74 ;
V_21 -> V_252 = V_253 ;
V_21 -> V_240 = F_108 ( V_15 , L_75 ,
V_11 -> V_12 ) ;
V_21 -> F_49 = F_109 ( V_11 -> V_16 [ 0 ] ) ;
V_21 -> V_254 = NULL ;
V_96 = F_73 ( V_21 , V_11 ) ;
if ( F_65 ( V_96 < 0 ) )
goto V_255;
...
static int F_111 ( struct V_25 * V_16 , const struct V_258 * V_259 )
{
int V_96 , V_95 = 0 ;
struct V_11 * V_11 ;
F_112 ( & V_260 ) ;
...
static void F_114 ( struct V_25 * V_16 )
{
struct V_11 * V_11 ;
F_16 ( 0 , L_27 ) ;
F_112 ( & V_260 ) ;
