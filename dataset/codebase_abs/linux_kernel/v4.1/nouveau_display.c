...
T_4 V_185 ;
int V_29 ;
args -> V_182 = F_105 ( args -> V_186 * ( args -> V_183 / 8 ) , 256 ) ;
args -> V_187 = args -> V_182 * args -> V_188 ;
args -> V_187 = F_105 ( args -> V_187 , V_189 ) ;
if ( V_91 ( V_7 ) -> V_97 . V_100 . V_190 != 0 )
V_185 = V_191 ;
else
V_185 = V_192 ;
V_29 = F_106 ( V_7 , args -> V_187 , 0 , V_185 , 0 , 0 , & V_136 ) ;
if ( V_29 )
return V_29 ;
