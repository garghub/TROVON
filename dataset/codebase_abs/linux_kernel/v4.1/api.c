...
static struct V_1 * F_28 ( struct V_1 * V_2 )
{
struct V_5 * V_6 = ( void * ) V_2 ;
long V_28 ;
V_28 = F_32 (
...
static int F_41 ( struct V_45 * V_46 , T_1 type , T_1 V_9 )
{
const struct V_47 * V_48 = V_46 -> V_49 -> V_50 ;
if ( V_48 )
return V_48 -> V_51 ( V_46 , type , V_9 ) ;
switch ( F_42 ( V_46 ) ) {
case V_52 :
return F_43 ( V_46 ) ;
case V_53 :
...
{
const struct V_47 * type = V_46 -> V_49 -> V_50 ;
if ( type ) {
if ( V_46 -> exit )
V_46 -> exit ( V_46 ) ;
return;
...
{
const struct V_47 * V_48 = V_2 -> V_50 ;
unsigned int V_55 ;
V_55 = V_2 -> V_56 & ~ ( F_50 () - 1 ) ;
if ( V_48 )
return V_55 + V_48 -> V_57 ( V_2 , type , V_9 ) ;
switch ( V_2 -> V_14 & V_58 ) {
default:
F_45 () ;
case V_52 :
V_55 += F_51 ( V_2 ) ;
...
struct V_45 * F_54 ( struct V_1 * V_2 , T_1 type ,
T_1 V_9 )
{
struct V_45 * V_46 = NULL ;
unsigned int V_60 ;
int V_61 = - V_19 ;
V_60 = sizeof( * V_46 ) + F_49 ( V_2 , type , V_9 ) ;
V_46 = F_17 ( V_60 , V_18 ) ;
if ( V_46 == NULL )
goto V_62;
V_46 -> V_49 = V_2 ;
V_61 = F_41 ( V_46 , type , V_9 ) ;
if ( V_61 )
goto V_63;
if ( ! V_46 -> exit && V_2 -> V_64 && ( V_61 = V_2 -> V_64 ( V_46 ) ) )
goto V_65;
goto V_66;
V_65:
F_46 ( V_46 ) ;
...
struct V_45 * F_55 ( const char * V_67 , T_1 type , T_1 V_9 )
{
struct V_45 * V_46 ;
int V_61 ;
for (; ; ) {
struct V_1 * V_2 ;
V_2 = F_40 ( V_67 , type , V_9 ) ;
if ( F_22 ( V_2 ) ) {
V_61 = F_56 ( V_2 ) ;
goto V_61;
}
V_46 = F_54 ( V_2 , type , V_9 ) ;
if ( ! F_22 ( V_46 ) )
return V_46 ;
F_4 ( V_2 ) ;
V_61 = F_56 ( V_46 ) ;
...
int V_61 = - V_19 ;
V_71 = V_69 -> V_71 ;
V_72 = V_71 + sizeof( * V_46 ) + V_69 -> V_73 ( V_2 ) ;
V_70 = F_17 ( V_72 , V_18 ) ;
if ( V_70 == NULL )
goto V_62;
V_46 = (struct V_45 * ) ( V_70 + V_71 ) ;
V_46 -> V_49 = V_2 ;
V_61 = V_69 -> V_74 ( V_46 ) ;
if ( V_61 )
goto V_63;
...
struct V_1 * F_59 ( const char * V_67 ,
const struct V_47 * V_69 ,
T_1 type , T_1 V_9 )
{
...
return F_60 ( V_67 , type , V_9 ) ;
}
void * F_61 ( const char * V_67 ,
const struct V_47 * V_69 , T_1 type , T_1 V_9 )
{
void * V_46 ;
int V_61 ;
for (; ; ) {
struct V_1 * V_2 ;
V_2 = F_59 ( V_67 , V_69 , type , V_9 ) ;
if ( F_22 ( V_2 ) ) {
V_61 = F_56 ( V_2 ) ;
goto V_61;
}
...
void F_62 ( void * V_70 , struct V_45 * V_46 )
{
struct V_1 * V_2 ;
if ( F_12 ( ! V_70 ) )
return;
V_2 = V_46 -> V_49 ;
if ( ! V_46 -> exit && V_2 -> V_77 )
V_2 -> V_77 ( V_46 ) ;
F_46 ( V_46 ) ;
F_4 ( V_2 ) ;
F_63 ( V_70 ) ;
