...
V_144 = V_143 ;
#endif
if ( V_144 -> V_173 == V_144 -> V_175 &&
! F_69 ( V_112 , V_148 , 1 ) ) {
for (; V_138 < V_7 -> V_31 ; V_138 ++ ) {
if ( V_138 < V_132 ) {
V_133 [ V_138 ] = V_144 -> V_173 ;
V_131 [ V_138 ] = V_172 ;
} else {
V_140 = 1 ;
break;
...
do {
for ( V_30 = V_144 -> V_173 ; V_30 <= V_144 -> V_175 ; V_30 ++ ) {
if ( V_138 >= V_132 ) {
V_140 = 1 ;
break;
}
...
{
int V_113 = F_95 ( & V_178 ) ;
if ( V_113 )
return V_113 ;
return F_96 ( & V_179 , F_65 ) ;
}
