...
struct V_129 * V_14 = F_90 ( V_9 -> V_27 ) ;
struct V_13 * V_130 = F_91 ( V_9 -> V_27 ) ;
...
F_94 ( & V_130 -> V_25 [ V_3 ] [ V_76 ] . V_26 ) ;
V_32 = F_95 ( V_145 , V_132 ,
V_50 , & V_130 -> V_46 [ V_3 ] [ 0 ] ) ;
if ( V_32 < 0 )
goto V_125;
}
if ( V_142 [ V_3 ] . V_146 . V_144 ) {
F_94 ( & V_130 -> V_25 [ V_3 ] [ V_117 ] . V_26 ) ;
V_32 = F_95 ( V_145 , V_132 ,
...
for ( -- V_3 ; V_3 >= 0 ; V_3 -- ) {
if ( V_142 [ V_3 ] . V_143 . V_144 )
F_100 ( & V_130 -> V_46 [ V_3 ] [ 0 ] ) ;
if ( V_142 [ V_3 ] . V_146 . V_144 )
F_100 ( & V_130 -> V_46 [ V_3 ] [ 1 ] ) ;
}
return V_32 ;
}
...
static int F_103 ( struct V_148 * V_149 )
{
struct V_129 * V_129 = F_90 ( & V_149 -> V_27 ) ;
struct V_13 * V_130 ;
int V_32 ;
if ( ! V_129 )
return - V_75 ;
V_130 = F_104 ( & V_149 -> V_27 , sizeof( * V_130 ) , V_150 ) ;
if ( ! V_130 )
return - V_151 ;
V_32 = F_105 ( & V_149 -> V_27 , V_129 ) ;
if ( V_32 < 0 )
return - V_127 ;
V_130 -> V_18 = V_129 -> V_62 ;
F_106 ( V_149 , V_130 ) ;
V_32 = F_107 ( & V_149 -> V_27 , & V_152 ) ;
if ( V_32 < 0 )
goto V_153;
V_32 = F_108 ( & V_149 -> V_27 , & V_154 ,
V_142 , F_2 ( V_142 ) ) ;
if ( V_32 < 0 )
goto V_155;
return 0 ;
...
F_109 ( & V_149 -> V_27 ) ;
V_153:
F_110 ( & V_149 -> V_27 , V_129 ) ;
return 0 ;
}
static int F_111 ( struct V_148 * V_149 )
{
struct V_129 * V_129 = F_90 ( & V_149 -> V_27 ) ;
F_109 ( & V_149 -> V_27 ) ;
F_112 ( & V_149 -> V_27 ) ;
...
static int F_114 ( struct V_131 * V_27 )
{
struct V_13 * V_14 = F_91 ( V_27 ) ;
struct V_17 * V_18 = V_14 -> V_18 ;
int V_32 ;
if ( V_14 -> V_137 >= V_156 )
return 0 ;
