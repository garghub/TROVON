...
void F_47 ( void )
{
F_48 ( V_45 , F_40 ( & V_32 ) == 0 ) ;
F_49 () ;
}
int F_50 ( struct V_29 * V_30 , struct V_3 * V_4 )
{
int V_27 = 0 ;
if ( ! F_51 ( V_4 ) )
return - V_43 ;
...
static int F_54 ( struct V_29 * V_30 , void * V_47 )
{
struct V_3 * V_4 = V_47 ;
if ( ! F_55 ( V_30 , V_4 ) )
return 0 ;
return F_50 ( V_30 , V_4 ) ;
}
...
V_27 = F_58 ( V_4 -> V_24 , NULL , V_4 , F_54 ) ;
F_53 ( V_4 ) ;
}
V_48:
F_59 ( V_4 ) ;
...
static int F_60 ( struct V_3 * V_4 , void * V_47 )
{
...
int F_61 ( struct V_29 * V_30 )
{
return F_62 ( V_30 -> V_24 , NULL , V_30 , F_60 ) ;
}
...
struct V_3 * V_4 ;
for (; ; ) {
F_69 ( & V_30 -> V_9 -> V_23 . V_53 ) ;
if ( F_3 ( & V_30 -> V_9 -> V_23 . V_54 ) ) {
F_70 ( & V_30 -> V_9 -> V_23 . V_53 ) ;
break;
}
V_52 = F_71 ( V_30 -> V_9 -> V_23 . V_54 . V_55 ,
struct V_5 ,
V_17 . V_56 ) ;
V_4 = V_52 -> V_3 ;
F_7 ( V_4 ) ;
