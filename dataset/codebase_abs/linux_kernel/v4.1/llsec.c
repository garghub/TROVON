...
F_70 ( V_123 , V_2 -> V_3 . V_44 , & V_113 -> V_2 ) ;
V_131 = F_81 ( F_76 ( V_20 , V_137 ) , V_144 ) ;
if ( ! V_131 )
return - V_81 ;
F_82 ( V_141 , 2 ) ;
F_83 ( & V_141 [ 0 ] , F_84 ( V_127 ) , V_127 -> V_145 ) ;
V_138 = V_127 -> V_145 ;
V_134 = F_84 ( V_127 ) + V_127 -> V_145 ;
V_139 = F_85 ( V_127 ) - V_134 ;
if ( V_113 -> V_2 . V_24 & V_146 ) {
F_83 ( & V_141 [ 1 ] , V_134 , 0 ) ;
} else {
F_83 ( & V_141 [ 1 ] , V_134 , V_139 ) ;
V_138 += V_139 ;
V_139 = 0 ;
}
F_74 ( & V_129 , V_134 , V_139 ) ;
F_82 ( V_142 , 2 ) ;
F_83 ( & V_142 [ 0 ] , V_134 , V_139 ) ;
F_83 ( & V_142 [ 1 ] , F_86 ( V_127 , V_137 ) , V_137 ) ;
F_87 ( V_131 , 0 , NULL , NULL ) ;
F_88 ( V_131 , V_141 , V_138 ) ;
F_89 ( V_131 , & V_129 , V_142 , V_139 , V_123 ) ;
V_140 = F_90 ( V_131 ) ;
F_9 ( V_131 ) ;
return V_140 ;
}
...
int F_92 ( struct V_1 * V_2 , struct V_126 * V_127 )
{
struct V_112 V_113 ;
int V_140 , V_137 , V_147 ;
struct V_28 * V_20 ;
T_2 V_148 ;
V_147 = F_93 ( V_127 , & V_113 ) ;
...
V_20 = F_68 ( V_2 , & V_113 , & V_113 . V_155 , NULL ) ;
if ( ! V_20 ) {
V_140 = - V_156 ;
goto V_154;
}
F_14 ( & V_2 -> V_12 ) ;
F_16 ( & V_2 -> V_12 ) ;
V_148 = F_96 ( V_2 -> V_3 . V_35 ) ;
V_113 . V_2 . V_35 = F_97 ( V_148 ) ;
if ( V_148 == 0xFFFFFFFF ) {
F_17 ( & V_2 -> V_12 ) ;
F_11 ( V_20 ) ;
V_140 = - V_157 ;
...
V_2 -> V_3 . V_35 = F_98 ( V_148 + 1 ) ;
F_17 ( & V_2 -> V_12 ) ;
F_99 () ;
V_127 -> V_145 = F_100 ( V_127 , & V_113 ) ;
F_101 ( V_127 ) ;
V_140 = F_91 ( V_127 , V_2 , & V_113 , V_20 ) ;
F_11 ( V_20 ) ;
return V_140 ;
V_154:
F_14 ( & V_2 -> V_12 ) ;
...
V_139 = F_85 ( V_127 ) - V_134 ;
F_74 ( & V_129 , V_134 , V_139 ) ;
return F_105 ( & V_131 , & V_129 , & V_129 , V_139 ) ;
}
static int
F_106 ( struct V_126 * V_127 , const struct V_1 * V_2 ,
const struct V_112 * V_113 ,
struct V_28 * V_20 , T_4 V_100 )
{
T_5 V_123 [ 16 ] ;
...
F_83 ( & V_141 [ 1 ] , V_134 , V_139 - V_137 ) ;
V_138 += V_139 - V_137 ;
V_134 += V_139 - V_137 ;
V_139 = V_137 ;
}
...
F_87 ( V_131 , 0 , NULL , NULL ) ;
F_88 ( V_131 , V_141 , V_138 ) ;
F_89 ( V_131 , & V_129 , & V_129 , V_139 , V_123 ) ;
V_140 = F_107 ( V_131 ) ;
F_9 ( V_131 ) ;
F_108 ( V_127 , V_127 -> V_135 - V_137 ) ;
return V_140 ;
}
static int
...
return F_106 ( V_127 , V_2 , V_113 , V_20 , V_100 ) ;
}
static int
F_110 ( struct V_26 * V_17 ,
const struct V_62 * V_159 )
{
struct V_90 * V_91 ;
V_91 = F_59 ( V_17 , V_159 ) ;
if ( ! V_91 ) {
struct V_90 * V_160 ;
...
V_91 = F_59 ( V_17 , V_159 ) ;
if ( ! V_91 )
F_39 ( & V_160 -> V_91 . V_25 , & V_17 -> V_17 . V_9 ) ;
else
F_9 ( V_160 ) ;
F_112 ( & V_17 -> V_12 ) ;
}
...
int F_114 ( struct V_1 * V_2 , struct V_126 * V_127 )
{
struct V_112 V_113 ;
struct V_28 * V_20 ;
struct V_62 V_99 ;
...
F_14 ( & V_2 -> V_12 ) ;
F_95 () ;
V_20 = F_68 ( V_2 , & V_113 , & V_113 . V_167 , & V_99 ) ;
if ( ! V_20 ) {
V_165 = - V_156 ;
goto V_82;
}
V_17 = F_102 ( V_2 , & V_113 . V_167 ) ;
if ( ! V_17 ) {
V_165 = - V_79 ;
goto V_168;
}
if ( F_103 ( V_2 , V_113 . V_118 . type , 0 , & V_164 ) < 0 ) {
V_165 = - V_79 ;
goto V_168;
}
if ( ! ( V_164 . V_104 & F_69 ( V_113 . V_2 . V_24 ) ) &&
( V_113 . V_2 . V_24 == 0 && V_164 . V_103 &&
! V_17 -> V_17 . V_169 ) ) {
V_165 = - V_79 ;
goto V_168;
}
V_148 = F_116 ( V_113 . V_2 . V_35 ) ;
if ( V_148 == 0xffffffff ) {
V_165 = - V_157 ;
goto V_168;
}
V_165 = F_113 ( V_17 , & V_99 , V_148 ) ;
if ( V_165 )
goto V_168;
V_100 = V_17 -> V_17 . V_44 ;
F_99 () ;
V_165 = F_109 ( V_127 , V_2 , & V_113 , V_20 , V_100 ) ;
F_11 ( V_20 ) ;
return V_165 ;
V_168:
F_11 ( V_20 ) ;
