...
{
if ( V_297 == V_409 )
return F_110 ( & V_2 -> V_202 , V_68 , V_280 ) ;
else
return & V_2 -> V_171 [ V_280 ] ;
}
static struct V_272 *
F_111 ( struct V_1 * V_2 , struct V_407 * V_68 ,
enum V_408 V_297 )
{
if ( V_297 == V_409 )
return F_112 ( & V_2 -> V_202 , V_68 , V_318 ) ;
else
return & V_2 -> V_273 ;
}
static void
F_113 ( struct V_1 * V_2 , struct V_407 * V_68 ,
...
switch ( V_280 ) {
case V_61 :
for ( V_412 = 0 ; V_412 < F_114 ( V_413 ) ; V_412 ++ ) {
if ( V_410 -> V_87 == V_413 [ V_412 ] )
break;
}
if ( V_412 >= F_114 ( V_413 ) )
V_410 -> V_87 = V_88 ;
...
V_273 -> V_319 = F_115 ( T_3 , V_273 -> V_319 , 0 , V_419 -> V_63 - V_423 ) ;
V_273 -> V_323 = F_115 ( T_3 , V_273 -> V_323 , 0 , V_419 -> V_64 - V_424 ) ;
V_420 = ( V_419 -> V_63 - V_273 -> V_319 + 15 ) & ~ 15 ;
V_273 -> V_63 = F_115 ( T_3 , V_273 -> V_63 , V_423 , V_420 )
& ~ 15 ;
V_273 -> V_64 = F_115 ( T_3 , V_273 -> V_64 , V_424 ,
...
V_45 . V_63 = 1 ;
V_45 . V_64 = 1 ;
F_113 ( V_2 , V_68 , V_427 -> V_280 , & V_45 , V_427 -> V_297 ) ;
...
static int F_119 ( struct V_270 * V_395 , struct V_407 * V_68 ,
struct V_429 * V_430 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_44 * V_45 ;
...
F_116 ( V_2 , V_45 , & V_430 -> V_433 ) ;
break;
case V_435 :
V_430 -> V_433 = * F_111 ( V_2 , V_68 , V_430 -> V_297 ) ;
break;
default:
return - V_57 ;
}
...
static int F_120 ( struct V_270 * V_395 , struct V_407 * V_68 ,
struct V_429 * V_430 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_44 * V_45 ;
...
V_45 = F_8 ( V_2 , V_68 , V_61 , V_430 -> V_297 ) ;
F_116 ( V_2 , V_45 , & V_430 -> V_433 ) ;
* F_111 ( V_2 , V_68 , V_430 -> V_297 ) = V_430 -> V_433 ;
V_45 = F_8 ( V_2 , V_68 , V_318 , V_430 -> V_297 ) ;
F_113 ( V_2 , V_68 , V_318 , V_45 , V_430 -> V_297 ) ;
return 0 ;
}
static int F_121 ( struct V_270 * V_395 , struct V_407 * V_68 ,
struct V_275 * V_410 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_44 * V_45 ;
...
static int F_122 ( struct V_270 * V_395 , struct V_407 * V_68 ,
struct V_275 * V_410 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_44 * V_45 ;
...
if ( V_45 == NULL )
return - V_57 ;
F_113 ( V_2 , V_68 , V_410 -> V_280 , & V_410 -> V_45 , V_410 -> V_297 ) ;
* V_45 = V_410 -> V_45 ;
if ( V_410 -> V_280 == V_61 ) {
V_273 = F_111 ( V_2 , V_68 , V_410 -> V_297 ) ;
V_273 -> V_319 = 0 ;
V_273 -> V_323 = 0 ;
...
V_410 -> V_297 ) ;
* V_45 = V_410 -> V_45 ;
F_113 ( V_2 , V_68 , V_318 , V_45 ,
V_410 -> V_297 ) ;
V_45 = F_8 ( V_2 , V_68 , V_210 ,
V_410 -> V_297 ) ;
* V_45 = V_410 -> V_45 ;
F_113 ( V_2 , V_68 , V_210 , V_45 ,
V_410 -> V_297 ) ;
}
return 0 ;
}
static bool F_123 ( T_3 V_437 , T_3 V_438 , unsigned int V_439 )
{
...
if ( ! F_123 ( V_444 -> V_45 . V_87 ,
V_445 -> V_45 . V_87 , V_446 ) )
return - V_447 ;
return 0 ;
}
static int F_125 ( struct V_270 * V_395 , struct V_450 * V_401 )
{
struct V_275 V_45 ;
...
V_45 . V_45 . V_63 = 4096 ;
V_45 . V_45 . V_64 = 4096 ;
F_122 ( V_395 , V_401 ? V_401 -> V_280 : NULL , & V_45 ) ;
return 0 ;
}
