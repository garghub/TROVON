...
V_1 . V_231 = 0 ;
for ( V_78 = 0 ; V_78 < V_239 ; V_78 ++ )
F_105 ( & V_1 , F_107 ( F_108 ( & V_235 [ V_78 ] ) ) << V_136 ,
V_235 [ V_78 ] . V_237 , V_235 [ V_78 ] . V_236 ) ;
return V_1 . V_231 ;
}
...
static void F_112 ( unsigned long V_34 , struct V_121 * V_122 ,
T_5 V_116 , T_5 V_26 )
{
unsigned long V_124 , V_123 ;
V_124 = F_113 ( ( ( V_116 & ~ V_222 ) + V_26 ) ) >> V_136 ;
V_123 = F_58 ( V_116 , V_122 ) ;
F_59 ( V_122 , V_34 , V_116 , V_123 , V_124 ) ;
F_114 ( & V_122 -> V_132 , V_116 , V_124 , V_123 ) ;
}
void F_115 ( struct V_7 * V_8 , struct V_240 * V_230 ,
int V_241 )
{
...
T_5 V_243 = V_230 [ V_78 ] . V_233 ;
T_5 V_26 = V_230 [ V_78 ] . V_232 ;
F_112 ( V_8 -> V_34 , V_122 , V_243 , V_26 ) ;
}
F_48 ( & V_122 -> V_96 , V_54 ) ;
}
int F_116 ( struct V_7 * V_8 , int V_244 ,
...
V_245 = V_220 ;
for ( V_78 = 0 ; V_78 < V_241 ; V_78 ++ ) {
unsigned long V_248 = V_230 [ V_78 ] . V_233 ;
unsigned long V_249 = V_230 [ V_78 ] . V_232 ;
unsigned long V_250 ;
if ( F_87 ( V_237 ) ) {
unsigned long V_251 = V_237 ;
if ( V_251 > V_249 )
V_251 = V_249 ;
V_237 -= V_251 ;
V_249 -= V_251 ;
...
void * F_118 ( struct V_7 * V_8 , unsigned int V_220 ,
struct V_240 * V_230 , int * V_241 ,
unsigned int V_205 )
{
void * V_179 ;
...
if ( V_220 & ( 8UL - 1 ) )
return F_75 ( - V_36 ) ;
V_179 = F_63 ( V_220 , V_252 ) ;
if ( ! V_179 )
return F_75 ( - V_114 ) ;
V_33 = F_111 ( V_8 , V_179 , V_220 , V_230 , * V_241 , V_205 ) ;
if ( V_33 < 0 ) {
F_66 ( V_179 ) ;
return F_75 ( V_33 ) ;
}
...
void F_119 ( struct V_7 * V_8 , void * V_179 , unsigned int V_220 ,
struct V_240 * V_230 , int V_241 )
{
F_115 ( V_8 , V_230 , V_241 ) ;
F_66 ( V_179 ) ;
}
...
if ( ! V_254 )
return - V_148 ;
V_255 = F_122 ( V_254 , V_256 , L_49 ) ;
V_33 = - V_148 ;
if ( V_255 == V_256 )
goto V_100;
V_79 = F_123 ( V_254 , V_255 , L_50 , NULL ) ;
if ( ! V_79 )
goto V_100;
V_50 = 1 ;
V_51 = 0 ;
if ( F_124 ( V_257 , V_50 , & V_51 ) ) {
F_28 (KERN_INFO PFX L_51 ) ;
goto V_100;
}
F_28 ( V_258 L_52 , V_259 ) ;
if ( ! * V_79 ) {
