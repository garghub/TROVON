...
int F_15 ( struct V_23 * V_12 , struct V_1 * V_2 )
{
memset ( F_2 ( V_2 ) , 0 , sizeof( * F_2 ( V_2 ) ) ) ;
#ifdef F_16
F_2 ( V_2 ) -> V_5 |= V_24 ;
#endif
return F_17 ( V_12 , V_2 ) ;
}
static int F_18 ( struct V_23 * V_12 , struct V_1 * V_2 )
{
struct V_16 * V_17 = F_6 ( V_2 ) -> V_25 ;
#ifdef F_16
if ( ! V_17 ) {
F_2 ( V_2 ) -> V_5 |= V_26 ;
return F_19 ( V_12 , V_2 ) ;
}
#endif
return V_17 -> V_21 -> V_27 -> V_28 ( V_12 , V_2 ) ;
}
int F_20 ( struct V_23 * V_12 , struct V_1 * V_2 )
{
return F_21 ( V_29 , V_30 , V_12 , V_2 ,
