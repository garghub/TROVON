...
unsigned long V_18 ;
V_85:
for ( V_18 = 0 ; V_18 < V_40 ; V_18 ++ , V_79 += V_58 )
F_3 ( V_64 -> V_86 , V_79 ) ;
}
V_84:
if ( V_63 == V_78 )
...
int V_92 , enum V_62 V_63 ,
struct V_51 * V_52 )
{
struct V_90 * V_93 , * V_94 , * V_95 ;
unsigned long V_66 , V_96 , V_97 , V_47 ;
T_4 V_98 = 0 , V_99 ;
unsigned int V_100 ;
unsigned long V_101 ;
...
if ( ! V_116 )
break;
V_40 = F_53 ( V_115 , V_116 , V_58 ) ;
V_7 = ( ( V_115 - V_2 -> V_3 . V_25 )
>> V_29 ) ;
V_65 = V_2 -> V_37 + V_7 ;
V_115 &= V_74 ;
if ( V_64 -> V_77 )
F_39 ( V_64 , V_2 , V_115 , V_47 ,
V_40 , V_63 ) ;
for ( V_18 = 0 ; V_18 < V_40 ; V_18 ++ )
F_5 ( V_2 , V_65 + V_18 ) ;
