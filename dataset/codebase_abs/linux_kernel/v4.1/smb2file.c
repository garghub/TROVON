...
struct V_44 * V_45 = F_10 ( F_11 ( V_33 -> V_46 ) ) ;
struct V_47 * V_48 , * V_49 ;
T_5 V_50 = 1 + V_35 -> V_51 - V_35 -> V_52 ;
struct V_53 V_54 ;
F_12 ( & V_54 ) ;
V_39 = V_22 -> V_23 -> V_24 -> V_55 ;
if ( ! V_39 )
return - V_56 ;
V_37 = V_39 / sizeof( struct V_40 ) ;
V_5 = F_13 ( V_37 , sizeof( struct V_40 ) , V_18 ) ;
if ( ! V_5 )
return - V_15 ;
V_41 = V_5 ;
F_14 ( & V_45 -> V_57 ) ;
F_15 (li, tmp, &cfile->llist->locks, llist) {
if ( V_35 -> V_52 > V_48 -> V_58 ||
( V_35 -> V_52 + V_50 ) <
( V_48 -> V_58 + V_48 -> V_50 ) )
continue;
if ( V_59 -> V_60 != V_48 -> V_61 )
continue;
if ( V_45 -> V_62 ) {
F_16 ( & V_48 -> V_63 ) ;
F_17 ( V_48 ) ;
...
V_41 -> V_64 = F_18 ( V_48 -> V_50 ) ;
V_41 -> V_65 = F_18 ( V_48 -> V_58 ) ;
V_41 -> V_66 = F_19 ( V_67 ) ;
F_20 ( & V_48 -> V_63 , & V_54 ) ;
if ( ++ V_38 == V_37 ) {
V_36 = F_21 ( V_1 , V_22 ,
...
if ( V_38 ) {
V_36 = F_21 ( V_1 , V_22 , V_33 -> V_12 . V_29 ,
V_33 -> V_12 . V_30 , V_59 -> V_60 ,
V_38 , V_5 ) ;
if ( V_36 ) {
F_22 ( & V_54 , & V_33 -> V_63 -> V_68 ) ;
V_6 = V_36 ;
} else
F_23 ( & V_54 ) ;
}
...
static int
F_25 ( struct V_69 * V_70 , const unsigned int V_1 ,
struct V_40 * V_5 , unsigned int V_37 )
{
int V_6 = 0 , V_36 ;
struct V_32 * V_33 = V_70 -> V_33 ;
struct V_47 * V_48 ;
unsigned int V_38 = 0 ;
...
struct V_69 * V_70 ;
V_1 = F_28 () ;
V_39 = F_9 ( V_33 -> V_43 ) -> V_23 -> V_24 -> V_55 ;
if ( ! V_39 ) {
F_29 ( V_1 ) ;
return - V_56 ;
}
