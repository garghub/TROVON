...
if ( F_53 ( V_6 ) ) {
V_88 -> type = V_173 ;
V_89 -> V_90 = F_39 ( V_6 , 0x07 , 0xfff ) ;
V_89 -> V_97 = F_39 ( V_6 , 0x09 , 0xfff ) ;
V_89 -> V_109 = V_3 -> V_195 ( V_6 ) ;
V_89 -> V_102 = F_39 ( V_6 , 0x20 , 0x3ff ) ;
V_89 -> V_99 = F_39 ( V_6 , 0x22 , 0x3ff ) ;
V_89 -> V_100 = F_39 ( V_6 , 0x24 , 0x3ff ) ;
V_89 -> V_104 = F_39 ( V_6 , 0x2a , 0x1fff ) / 2 ;
V_89 -> V_106 = F_39 ( V_6 , 0x2e , 0x1fff ) / 2 ;
V_89 -> V_107 = F_39 ( V_6 , 0x32 , 0x1fff ) / 2 ;
V_89 -> V_196 = ( ( F_38 ( V_6 , 0x05 ) & 0x10 ) ? V_161 : 0 ) |
( ( F_38 ( V_6 , 0x05 ) & 0x20 ) ? V_159 : 0 ) ;
if ( V_89 -> V_165 == V_193 ) {
V_89 -> V_97 += F_39 ( V_6 , 0x0b , 0xfff ) ;
V_89 -> V_197 = F_39 ( V_6 , 0x2c , 0x1fff ) / 2 ;
V_89 -> V_198 = F_39 ( V_6 , 0x30 , 0x1fff ) / 2 ;
V_89 -> V_199 = F_39 ( V_6 , 0x34 , 0x1fff ) / 2 ;
}
F_88 ( V_6 , V_88 ) ;
} else {
...
static void F_95 ( struct V_5 * V_6 , bool V_203 )
{
F_40 ( V_6 , 0x01 , V_203 ? 0x00 : 0x78 ) ;
}
static void F_96 ( struct V_5 * V_6 , bool V_203 )
{
F_40 ( V_6 , 0x83 , V_203 ? 0xfe : 0xff ) ;
}
...
const struct V_81 * V_3 = V_2 -> V_3 ;
if ( F_52 ( V_6 ) ) {
F_51 ( V_6 , V_3 -> V_205 [ 0 ] ) ;
F_24 ( V_6 , 0x00 , 0x08 ) ;
F_24 ( V_6 , 0x01 , 0x06 ) ;
F_24 ( V_6 , 0xc8 , 0x00 ) ;
} else if ( F_53 ( V_6 ) ) {
F_40 ( V_6 , 0x00 , V_2 -> V_71 & 0x03 ) ;
F_51 ( V_6 , V_3 -> V_205 [ 1 ] ) ;
if ( F_1 ( V_2 ) ) {
F_24 ( V_6 , 0x00 , 0xff ) ;
F_24 ( V_6 , 0x01 , 0xfe ) ;
F_24 ( V_6 , 0xc8 , 0x40 ) ;
...
V_214 -> V_90 = V_2 -> V_88 . V_89 . V_90 ;
V_214 -> V_97 = V_2 -> V_88 . V_89 . V_97 ;
V_214 -> V_215 = V_216 ;
V_214 -> V_217 = V_218 ;
if ( V_2 -> V_88 . V_89 . V_17 & V_128 )
V_214 -> V_217 = ( V_2 -> V_88 . V_89 . V_97 <= 576 ) ?
V_219 : V_220 ;
}
...
F_106 ( V_222 ) = F_105 ( V_223 , V_224 , V_225 , V_222 , V_226 , V_227 ) ,
F_106 ( V_224 ) = F_105 ( V_225 , V_222 , V_223 , V_224 , V_227 , V_226 ) ,
F_106 ( V_227 ) = F_105 ( V_224 , V_223 , V_226 , V_227 , V_225 , V_222 ) ,
F_106 ( V_225 ) = F_105 ( V_227 , V_226 , V_222 , V_225 , V_224 , V_223 ) ,
F_106 ( V_226 ) = F_105 ( V_226 , V_227 , V_224 , V_223 , V_222 , V_225 ) ,
F_106 ( V_223 ) = F_105 ( V_222 , V_225 , V_227 , V_226 , V_223 , V_224 ) ,
} ;
...
{
struct V_1 * V_2 = F_2 ( V_6 ) ;
if ( V_214 -> V_168 != V_2 -> V_169 )
return - V_63 ;
F_103 ( V_2 , & V_214 -> V_214 ) ;
if ( V_214 -> V_237 == V_238 ) {
struct V_213 * V_239 ;
V_239 = F_109 ( V_6 , V_211 , V_214 -> V_168 ) ;
V_214 -> V_214 . V_68 = V_239 -> V_68 ;
} else {
V_214 -> V_214 . V_68 = V_2 -> V_214 -> V_68 ;
}
return 0 ;
}
...
if ( V_214 -> V_168 != V_2 -> V_169 )
return - V_63 ;
V_3 = V_67 ( V_2 , V_214 -> V_214 . V_68 ) ;
if ( V_3 == NULL )
V_3 = V_67 ( V_2 , V_240 ) ;
F_103 ( V_2 , & V_214 -> V_214 ) ;
V_214 -> V_214 . V_68 = V_3 -> V_68 ;
if ( V_214 -> V_237 == V_238 ) {
struct V_213 * V_239 ;
V_239 = F_109 ( V_6 , V_211 , V_214 -> V_168 ) ;
V_239 -> V_68 = V_214 -> V_214 . V_68 ;
} else {
V_2 -> V_214 = V_3 ;
F_107 ( V_2 ) ;
}
...
static int F_111 ( struct V_5 * V_6 , T_4 V_145 , bool * V_241 )
{
struct V_1 * V_2 = F_2 ( V_6 ) ;
const struct V_81 * V_3 = V_2 -> V_3 ;
const T_2 V_242 = F_14 ( V_6 , 0x43 ) ;
const T_2 V_243 = F_14 ( V_6 , 0x6b ) ;
const T_2 V_244 = F_14 ( V_6 , 0x70 ) ;
T_2 V_245 ;
T_2 V_246 ;
T_2 V_247 ;
if ( V_242 )
...
V_247 = F_14 ( V_6 , 0x70 ) & V_3 -> V_250 ;
if ( V_247 ) {
F_31 ( 1 , V_45 , V_6 , L_55 , V_46 , V_247 ) ;
F_15 ( V_6 , 0x71 , V_247 ) ;
F_60 ( V_6 ) ;
if ( V_241 )
* V_241 = true ;
...
static int F_112 ( struct V_5 * V_6 , struct V_251 * V_56 )
{
struct V_1 * V_2 = F_2 ( V_6 ) ;
T_2 * V_14 = NULL ;
...
if ( V_56 -> V_252 == 0 && V_56 -> V_253 == 0 ) {
V_56 -> V_253 = V_14 ? V_2 -> V_56 . V_253 : 0 ;
return 0 ;
}
if ( V_14 == NULL )
return - V_254 ;
if ( V_56 -> V_252 >= V_2 -> V_56 . V_253 )
return - V_63 ;
if ( V_56 -> V_252 + V_56 -> V_253 > V_2 -> V_56 . V_253 )
V_56 -> V_253 = V_2 -> V_56 . V_253 - V_56 -> V_252 ;
memcpy ( V_56 -> V_56 , V_14 + V_56 -> V_252 * 128 , V_56 -> V_253 * 128 ) ;
return 0 ;
}
...
static int F_114 ( struct V_5 * V_6 , struct V_251 * V_56 )
{
struct V_1 * V_2 = F_2 ( V_6 ) ;
const struct V_81 * V_3 = V_2 -> V_3 ;
int V_257 ;
...
F_32 ( V_2 , V_2 -> V_56 . V_57 ) ;
F_27 ( V_6 , V_3 -> V_258 , 0x0f , V_2 -> V_56 . V_57 ) ;
V_2 -> V_162 . V_259 = 16 ;
V_2 -> V_162 . V_260 = 9 ;
if ( ! V_2 -> V_56 . V_57 )
V_2 -> V_56 . V_253 = 0 ;
...
F_115 ( & V_2 -> V_55 ) ;
F_32 ( V_2 , 0 ) ;
F_27 ( V_6 , V_3 -> V_258 , 0x0f , 0x00 ) ;
V_257 = F_113 ( V_56 -> V_56 ) ;
if ( V_257 < 0 )
V_257 = 0xc0 ;
switch ( V_56 -> V_168 ) {
case V_74 :
V_2 -> V_262 [ 0 ] = V_56 -> V_56 [ V_257 ] ;
V_2 -> V_262 [ 1 ] = V_56 -> V_56 [ V_257 + 1 ] ;
break;
case V_75 :
F_26 ( V_6 , 0x70 , V_56 -> V_56 [ V_257 ] ) ;
F_26 ( V_6 , 0x71 , V_56 -> V_56 [ V_257 + 1 ] ) ;
break;
case V_76 :
F_26 ( V_6 , 0x72 , V_56 -> V_56 [ V_257 ] ) ;
F_26 ( V_6 , 0x73 , V_56 -> V_56 [ V_257 + 1 ] ) ;
break;
case V_77 :
F_26 ( V_6 , 0x74 , V_56 -> V_56 [ V_257 ] ) ;
F_26 ( V_6 , 0x75 , V_56 -> V_56 [ V_257 + 1 ] ) ;
break;
default:
return - V_63 ;
}
if ( V_3 -> type == V_263 ) {
F_26 ( V_6 , 0x76 , V_257 & 0xff ) ;
F_27 ( V_6 , 0x77 , 0x40 , ( V_257 & 0x100 ) >> 2 ) ;
} else {
F_27 ( V_6 , 0x71 , 0x01 , ( V_257 & 0x100 ) >> 8 ) ;
}
V_56 -> V_56 [ V_257 ] = V_2 -> V_262 [ 0 ] ;
V_56 -> V_56 [ V_257 + 1 ] = V_2 -> V_262 [ 1 ] ;
memcpy ( V_2 -> V_56 . V_56 , V_56 -> V_56 , 128 * V_56 -> V_253 ) ;
V_2 -> V_56 . V_253 = V_56 -> V_253 ;
V_2 -> V_162 = F_116 ( V_56 -> V_56 [ 0x15 ] ,
V_56 -> V_56 [ 0x16 ] ) ;
V_2 -> V_56 . V_57 |= 1 << V_56 -> V_168 ;
V_26 = F_30 ( V_6 , 128 * V_56 -> V_253 , V_2 -> V_56 . V_56 ) ;
if ( V_26 < 0 ) {
...
if ( F_25 ( V_6 , V_3 -> V_264 ) & V_2 -> V_56 . V_57 )
break;
F_117 ( 1 ) ;
}
if ( V_27 == 1000 ) {
...
V_267 [ V_27 ] = F_21 ( V_6 , V_27 ) ;
F_55 ( V_6 ,
L_65 ,
V_267 [ 0 ] , V_267 [ 1 ] , V_267 [ 2 ] , V_267 [ 3 ] , V_267 [ 4 ] , V_267 [ 5 ] , V_267 [ 6 ] , V_267 [ 7 ] ,
V_267 [ 8 ] , V_267 [ 9 ] , V_267 [ 10 ] , V_267 [ 11 ] , V_267 [ 12 ] , V_267 [ 13 ] ) ;
}
...
struct V_87 V_88 ;
struct V_150 V_151 ;
T_2 V_270 = F_14 ( V_6 , 0x02 ) ;
T_2 V_271 ;
T_2 V_272 ;
static const char * const V_273 [ 16 ] = {
L_66 , L_67 , L_68 , L_69 ,
L_68 , L_70 , L_68 , L_71 ,
L_68 , L_72 , L_73 ,
L_68 , L_68 , L_68 , L_68 , L_74
} ;
static const char * const V_274 [ 16 ] = {
L_75 , L_76 ,
L_77 , L_78 ,
L_79 , L_80 ,
L_81 , L_82 ,
...
static const char * const V_276 [ 4 ] = {
L_86 ,
L_87 ,
L_88 ,
L_89
...
F_55 ( V_6 , L_90 ) ;
F_55 ( V_6 , L_91 , F_71 ( V_6 ) ? L_92 : L_93 ) ;
V_271 = F_25 ( V_6 , V_3 -> V_264 ) ;
F_55 ( V_6 , L_94 ,
( ( V_271 & 0x01 ) ? L_95 : L_96 ) ,
( ( V_271 & 0x02 ) ? L_95 : L_96 ) ,
( ( V_271 & 0x04 ) ? L_95 : L_96 ) ,
( ( V_271 & 0x08 ) ? L_95 : L_96 ) ) ;
F_55 ( V_6 , L_97 , ! ! ( F_19 ( V_6 , 0x2a ) & 0x01 ) ?
L_98 : L_99 ) ;
F_55 ( V_6 , L_100 ) ;
V_272 = V_3 -> V_83 ( V_6 ) ;
F_55 ( V_6 , L_101 ,
( ( V_272 & 0x01 ) ? L_95 : L_96 ) ,
( ( V_272 & 0x02 ) ? L_95 : L_96 ) ,
( ( V_272 & 0x04 ) ? L_95 : L_96 ) ,
( ( V_272 & 0x08 ) ? L_95 : L_96 ) ) ;
F_55 ( V_6 , L_102 ,
F_72 ( V_6 ) ? L_103 : L_104 ) ;
F_55 ( V_6 , L_105 ,
F_73 ( V_6 ) ? L_103 : L_104 ) ;
F_55 ( V_6 , L_106 , F_75 ( V_6 ) ? L_103 : L_104 ) ;
F_55 ( V_6 , L_107 , F_76 ( V_6 ) ? L_103 : L_104 ) ;
F_55 ( V_6 , L_108 , F_78 ( V_6 ) ? L_103 : L_104 ) ;
F_55 ( V_6 , L_109 ,
( F_79 ( V_6 ) ) ? L_93 : L_92 ) ;
F_55 ( V_6 , L_110 ,
...
F_92 ( V_6 -> V_202 , L_115 ,
& V_88 , true ) ;
F_92 ( V_6 -> V_202 , L_116 ,
& V_2 -> V_88 , true ) ;
if ( F_77 ( V_6 ) )
return 0 ;
F_55 ( V_6 , L_117 ) ;
...
V_274 [ V_270 >> 4 ] ) ;
F_55 ( V_6 , L_120 ,
( V_270 & 0x02 ) ? L_121 : L_122 ,
( V_270 & 0x04 ) ? L_123 : L_124 ,
( ( V_270 & 0x04 ) ^ ( V_270 & 0x01 ) ) ?
L_98 : L_99 ) ;
F_55 ( V_6 , L_125 ,
V_273 [ F_43 ( V_6 , V_3 -> V_277 ) >> 4 ] ) ;
if ( ! F_53 ( V_6 ) )
return 0 ;
F_55 ( V_6 , L_126 , F_74 ( V_6 ) ? L_53 : L_127 ) ;
F_55 ( V_6 , L_128 ,
...
if ( F_74 ( V_6 ) ) {
bool V_278 = F_38 ( V_6 , 0x04 ) & 0x01 ;
bool V_279 = F_38 ( V_6 , 0x18 ) & 0x01 ;
bool V_280 = F_14 ( V_6 , 0x65 ) & 0x40 ;
F_55 ( V_6 , L_135 ,
V_278 ? L_136 : L_137 ,
V_279 ? L_138 : L_139 ,
V_280 ? L_140 : L_98 ) ;
...
F_55 ( V_6 , L_147 , V_276 [ ( F_38 ( V_6 , 0x0b ) & 0x60 ) >> 5 ] ) ;
F_119 ( V_6 ) ;
}
return 0 ;
}
...
struct V_1 * V_2 = F_2 ( V_6 ) ;
const struct V_81 * V_3 = V_2 -> V_3 ;
struct V_281 * V_228 = & V_2 -> V_228 ;
F_40 ( V_6 , 0x48 ,
( V_228 -> V_282 ? 0x80 : 0 ) |
( V_228 -> V_283 ? 0x40 : 0 ) ) ;
F_98 ( V_6 ) ;
if ( V_228 -> V_284 >= 0 &&
V_228 -> V_284 < V_2 -> V_169 ) {
V_2 -> V_71 = V_228 -> V_284 ;
F_100 ( V_6 ) ;
F_97 ( V_6 ) ;
}
F_15 ( V_6 , 0x0c , 0x42 ) ;
...
V_228 -> V_286 << 2 |
V_228 -> V_287 << 0 ) ;
F_16 ( V_6 , 0x05 , 0x0e , V_228 -> V_288 << 3 |
V_228 -> V_289 << 2 |
V_228 -> V_290 << 1 ) ;
F_107 ( V_2 ) ;
F_45 ( V_6 , 0x69 , 0x30 ) ;
F_15 ( V_6 , 0x06 , 0xa0 | V_228 -> V_291 << 2 |
V_228 -> V_292 << 1 | V_228 -> V_293 ) ;
F_15 ( V_6 , 0x14 , 0x40 | V_228 -> V_294 << 4 |
V_228 -> V_295 << 2 |
V_228 -> V_296 ) ;
F_45 ( V_6 , 0xba , ( V_228 -> V_297 << 1 ) | 0x01 ) ;
F_45 ( V_6 , 0xf3 , 0xdc ) ;
F_45 ( V_6 , 0xf9 , 0x23 ) ;
F_45 ( V_6 , 0x45 , 0x23 ) ;
F_45 ( V_6 , 0xc9 , 0x2d ) ;
...
F_24 ( V_6 , 0xb5 , 0x01 ) ;
if ( F_1 ( V_2 ) ) {
F_24 ( V_6 , 0x02 , V_228 -> V_298 ) ;
F_16 ( V_6 , 0x30 , 1 << 4 , V_228 -> V_299 << 4 ) ;
}
F_15 ( V_6 , 0x40 , 0xc0 | V_228 -> V_300 ) ;
F_15 ( V_6 , 0x46 , 0x98 ) ;
F_15 ( V_6 , 0x6e , V_3 -> V_248 ) ;
F_15 ( V_6 , 0x73 , V_3 -> V_250 ) ;
V_3 -> V_301 ( V_6 ) ;
return F_122 ( V_6 -> V_302 ) ;
}
...
if ( V_16 )
F_15 ( V_6 , V_303 , V_16 << 1 ) ;
return F_129 ( V_10 -> V_15 , F_14 ( V_6 , V_303 ) >> 1 ) ;
}
...
struct V_306 * V_308 ;
unsigned int V_17 ;
V_308 = V_2 -> V_24 [ V_35 ] -> V_309 . V_310 ;
V_307 = F_131 ( V_308 , NULL ) ;
if ( ! V_307 )
return - V_63 ;
F_132 ( V_307 , & V_305 ) ;
F_133 ( V_307 ) ;
V_17 = V_305 . V_311 . V_312 . V_17 ;
if ( V_17 & V_313 )
V_2 -> V_228 . V_292 = 1 ;
if ( V_17 & V_314 )
V_2 -> V_228 . V_291 = 1 ;
...
V_2 -> V_228 . V_300 = V_318 ;
V_2 -> V_228 . V_319 [ V_38 ] = 0x42 ;
V_2 -> V_228 . V_319 [ V_39 ] = 0x40 ;
V_2 -> V_228 . V_319 [ V_40 ] = 0x3e ;
V_2 -> V_228 . V_319 [ V_320 ] = 0x38 ;
V_2 -> V_228 . V_319 [ V_321 ] = 0x3c ;
V_2 -> V_228 . V_319 [ V_41 ] = 0x26 ;
V_2 -> V_228 . V_319 [ V_42 ] = 0x32 ;
V_2 -> V_228 . V_319 [ V_43 ] = 0x36 ;
V_2 -> V_228 . V_319 [ V_58 ] = 0x34 ;
V_2 -> V_228 . V_319 [ V_59 ] = 0x30 ;
V_2 -> V_228 . V_319 [ V_60 ] = 0x22 ;
V_2 -> V_228 . V_319 [ V_61 ] = 0x24 ;
V_2 -> V_228 . V_282 = 0 ;
V_2 -> V_228 . V_283 = 0 ;
V_2 -> V_228 . V_284 = - 1 ;
V_2 -> V_228 . V_288 = 1 ;
V_2 -> V_228 . V_287 = 1 ;
V_2 -> V_228 . V_233 = V_322 ;
V_2 -> V_228 . V_229 = V_323 ;
return 0 ;
}
static int F_134 ( struct V_9 * V_10 ,
const struct V_324 * V_135 )
{
static const struct V_87 V_325 =
V_326 ;
struct V_1 * V_2 ;
struct V_327 * V_134 ;
struct V_5 * V_6 ;
...
T_3 V_36 ;
int V_26 ;
if ( ! F_135 ( V_10 -> V_15 , V_328 ) )
return - V_21 ;
F_136 ( 1 , V_45 , V_10 , L_148 ,
V_10 -> V_16 << 1 ) ;
V_2 = F_137 ( & V_10 -> V_309 , sizeof( * V_2 ) , V_329 ) ;
if ( ! V_2 ) {
F_10 ( V_10 , L_149 ) ;
return - V_330 ;
}
...
V_2 -> V_191 = true ;
V_2 -> V_71 = ~ 0 ;
if ( F_138 ( V_331 ) && V_10 -> V_309 . V_310 ) {
const struct V_332 * V_333 ;
V_333 = F_139 ( V_334 , V_10 -> V_309 . V_310 ) ;
V_2 -> V_3 = V_333 -> V_14 ;
V_26 = F_130 ( V_2 ) ;
if ( V_26 < 0 ) {
F_10 ( V_10 , L_150 ) ;
...
} else if ( V_10 -> V_309 . V_335 ) {
struct V_281 * V_228 = V_10 -> V_309 . V_335 ;
V_2 -> V_3 = ( const struct V_81 * ) V_135 -> V_336 ;
V_2 -> V_228 = * V_228 ;
} else {
F_10 ( V_10 , L_151 ) ;
return - V_337 ;
...
for ( V_27 = 0 ; V_27 < V_2 -> V_3 -> V_48 ; ++ V_27 ) {
V_2 -> V_49 [ V_27 ] =
F_140 ( & V_10 -> V_309 , L_152 , V_27 ,
V_338 ) ;
if ( F_141 ( V_2 -> V_49 [ V_27 ] ) )
return F_142 ( V_2 -> V_49 [ V_27 ] ) ;
if ( V_2 -> V_49 [ V_27 ] )
F_143 ( V_10 , L_153 , V_27 ) ;
}
V_2 -> V_88 = V_325 ;
V_2 -> V_214 = V_67 ( V_2 , V_240 ) ;
V_6 = & V_2 -> V_6 ;
F_144 ( V_6 , V_10 , & V_339 ) ;
snprintf ( V_6 -> V_202 , sizeof( V_6 -> V_202 ) , L_154 ,
V_135 -> V_202 , F_145 ( V_10 -> V_15 ) ,
V_10 -> V_16 ) ;
V_6 -> V_17 |= V_340 ;
if ( V_2 -> V_3 -> type == V_263 ) {
...
if ( F_1 ( V_2 ) )
V_2 -> V_344 =
F_149 ( V_134 , & V_345 , NULL ) ;
V_2 -> V_346 =
F_149 ( V_134 , & V_347 , NULL ) ;
V_2 -> V_348 =
F_149 ( V_134 , & V_349 , NULL ) ;
V_6 -> V_302 = V_134 ;
if ( V_134 -> error ) {
V_26 = V_134 -> error ;
goto V_350;
...
V_2 -> V_82 -> V_351 = true ;
V_2 -> V_343 -> V_351 = true ;
if ( F_1 ( V_2 ) )
V_2 -> V_344 -> V_351 = true ;
V_2 -> V_346 -> V_351 = true ;
V_2 -> V_348 -> V_351 = true ;
if ( F_60 ( V_6 ) ) {
V_26 = - V_337 ;
goto V_350;
}
for ( V_27 = 1 ; V_27 < V_352 ; ++ V_27 ) {
if ( ! ( F_34 ( V_27 ) & V_2 -> V_3 -> V_62 ) )
continue;
V_2 -> V_24 [ V_27 ] =
F_127 ( V_6 , V_2 -> V_228 . V_319 [ V_27 ] ,
0xf2 + V_27 ) ;
...
V_2 -> V_354 [ V_27 ] . V_17 = V_355 ;
V_2 -> V_354 [ V_2 -> V_169 ] . V_17 = V_356 ;
V_26 = F_152 ( & V_6 -> V_357 , V_2 -> V_169 + 1 ,
V_2 -> V_354 , 0 ) ;
if ( V_26 )
goto V_358;
V_26 = F_121 ( V_6 ) ;
if ( V_26 )
goto V_359;
F_55 ( V_6 , L_159 , V_10 -> V_202 ,
V_10 -> V_16 << 1 , V_10 -> V_15 -> V_202 ) ;
V_26 = F_153 ( V_6 ) ;
if ( V_26 )
goto V_359;
return 0 ;
