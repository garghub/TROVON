...
struct V_98 *
F_50 ( struct V_99 * V_100 , T_2 V_101 )
{
struct V_73 * V_74 = F_51 ( V_100 , V_101 ) ;
...
struct V_84 *
F_54 ( struct V_99 * V_100 , T_2 V_108 ,
bool V_109 )
{
struct V_73 * V_74 = F_51 ( V_100 , V_108 ) ;
struct V_84 * V_5 = NULL ;
struct V_103 * V_104 ;
struct V_110 * V_111 = V_100 -> V_112 -> V_78 ;
struct V_7 * V_113 = F_55 ( V_111 ) ;
unsigned int V_114 ;
T_6 V_115 ;
if ( V_74 == NULL || V_74 -> V_2 == NULL ||
V_74 -> V_2 -> V_5 == NULL ) {
...
F_39 ( F_60 ( V_100 -> V_112 ) ,
V_74 , V_100 -> V_118 . V_58 ,
V_100 -> V_118 . V_59 , V_119 ,
V_120 , V_121 ) ;
if ( V_109 ) {
F_61 ( V_111 , V_100 ) ;
if ( F_62 ( V_100 ) )
...
struct V_91 *
F_66 ( struct V_99 * V_100 , T_2 V_108 ,
struct V_91 * V_124 )
{
struct V_73 * V_74 = F_51 ( V_100 , V_108 ) ;
struct V_91 * V_86 = F_67 ( - V_76 ) ;
if ( ! F_54 ( V_100 , V_108 , true ) )
goto V_106;
if ( V_74 && V_74 -> V_86 )
V_86 = V_74 -> V_86 ;
else
...
return V_85 -> V_89 ;
case 4 :
return F_69 ( V_85 , V_110 ) ;
default:
F_70 () ;
}
}
static bool F_71 ( T_4 V_126 , T_4 V_127 ,
T_4 V_128 , T_4 V_129 )
{
T_4 V_130 = F_28 ( V_126 , V_127 ) ;
T_4 V_131 = F_28 ( V_128 , V_129 ) ;
return ( V_130 == V_55 || V_130 > V_128 ) &&
( V_131 == V_55 || V_131 > V_126 ) ;
}
int F_72 ( struct V_67 * V_68 ,
struct V_12 * V_132 , int * V_133 ,
const struct V_134 * V_135 )
{
struct V_56 * V_57 , * V_136 ;
T_3 * V_27 ;
F_73 (err, n, &flo->error_list, list) {
if ( ! F_71 ( V_57 -> V_58 , V_57 -> V_59 ,
V_135 -> V_58 , V_135 -> V_59 ) )
continue;
V_27 = F_74 ( V_132 ,
24 + V_137 + V_80 ) ;
if ( F_16 ( ! V_27 ) )
return - V_138 ;
V_27 = F_75 ( V_27 , V_57 -> V_58 ) ;
V_27 = F_75 ( V_27 , V_57 -> V_59 ) ;
V_27 = F_76 ( V_27 , & V_57 -> V_63 ,
V_137 ) ;
V_27 = F_76 ( V_27 , & V_57 -> V_4 ,
V_80 ) ;
* V_27 ++ = F_77 ( V_57 -> V_60 ) ;
* V_27 ++ = F_77 ( V_57 -> V_62 ) ;
* V_133 += 1 ;
...
bool F_62 ( struct V_99 * V_100 )
{
struct V_73 * V_74 ;
struct V_103 * V_104 ;
int V_139 ;
for ( V_139 = 0 ; V_139 < F_79 ( V_100 ) ; V_139 ++ ) {
V_74 = F_51 ( V_100 , V_139 ) ;
if ( V_74 && V_74 -> V_2 ) {
V_104 = & V_74 -> V_2 -> V_3 ;
if ( ! F_56 ( V_104 ) )
return true ;
