...
void *
F_55 ( struct V_109 * V_112 , struct V_127 * V_128 )
{
...
& V_130 ) ;
if ( V_4 != 0 && V_49 -> V_50 -> V_133 )
V_4 = V_49 -> V_50 -> V_133 ( V_39 , V_41 , V_129 ,
& V_130 , V_43 ) ;
F_12 ( V_129 ) ;
V_47:
if ( V_4 != 0 ) {
...
int
F_58 ( struct V_111 * V_111 , struct V_109 * V_112 , const char * V_134 )
{
int V_4 = - V_51 ;
unsigned int V_39 ;
struct V_42 * V_43 = F_39 ( V_111 -> V_116 ) ;
...
F_5 ( V_30 , L_10 , V_134 ) ;
if ( V_43 -> V_131 & V_132 )
V_4 = F_19 ( V_39 , V_135 , V_43 , V_129 , V_134 ) ;
else if ( V_135 -> V_123 )
V_4 = F_59 ( V_39 , V_135 , V_129 , V_134 ,
V_43 -> V_124 ,
F_45 ( V_43 ) ) ;
if ( V_4 == 0 ) {
if ( V_135 -> V_123 )
V_4 = F_60 ( & V_136 , V_129 ,
V_111 -> V_116 , V_39 ) ;
else
V_4 = F_61 ( & V_136 , V_129 , NULL ,
