...
return - V_87 ;
if ( ( V_4 >= V_121 ) ||
! ( V_10 -> V_16 . V_53 & V_122 ) ||
( V_10 -> V_16 . V_53 & V_123 ) )
return - V_87 ;
F_47 ( V_2 , L_9 ,
V_115 -> V_21 , V_4 ) ;
...
F_65 ( V_106 , V_57 -> V_60 . V_108 [ V_4 ] +
V_129 ) ) {
F_47 ( V_2 ,
L_12 ,
...
V_59 = F_66 ( sizeof( struct V_58 ) , V_132 ) ;
if ( ! V_59 ) {
V_80 = - V_133 ;
goto V_127;
}
...
F_71 ( & V_10 -> V_16 , & V_57 -> V_60 . V_136 ) ;
V_127:
F_27 ( & V_57 -> V_62 ) ;
return V_80 ;
}
...
void F_73 ( struct V_40 * V_20 , T_1 * V_41 , T_2 V_4 )
{
struct V_1 * V_2 = F_8 ( V_20 ) ;
struct V_9 * V_10 = V_2 -> V_10 ;
struct V_56 * V_57 ;
...
V_12 -> V_145 = V_146 ;
F_81 ( & V_2 -> V_147 , V_12 ) ;
F_71 ( & V_10 -> V_16 , & V_2 -> V_136 ) ;
}
int F_82 ( struct V_56 * V_57 , T_2 V_4 ,
enum V_77 V_78 )
{
int V_80 ;
F_75 ( & V_57 -> V_60 . V_61 ) ;
...
void F_84 ( struct V_40 * V_20 , T_1 * V_41 , T_1 V_4 )
{
struct V_1 * V_2 = F_8 ( V_20 ) ;
struct V_9 * V_10 = V_2 -> V_10 ;
struct V_56 * V_57 ;
...
T_2 V_15 , V_4 ;
T_1 V_138 ;
V_15 = F_89 ( V_14 -> V_27 . V_34 . V_27 . V_154 . V_15 ) ;
V_4 = ( V_15 & V_155 ) >> 2 ;
V_138 = ( V_15 & V_156 ) >> 6 ;
F_75 ( & V_57 -> V_60 . V_61 ) ;
V_59 = F_39 ( V_57 , V_4 ) ;
...
if ( F_89 ( V_14 -> V_27 . V_34 . V_27 . V_154 . V_158 )
== V_159 && V_138 ) {
if ( F_78 ( V_103 ,
& V_59 -> V_90 ) ) {
goto V_157;
