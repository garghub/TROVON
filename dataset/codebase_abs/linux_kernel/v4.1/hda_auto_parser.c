...
if ( ( V_14 -> V_91 . V_151 & 0xffff0000 ) != ( V_148 -> V_150 << 16 ) )
continue;
if ( V_14 -> V_91 . V_152 != V_148 -> V_14 )
continue;
if ( F_50 ( V_14 , V_148 -> V_9 ) ) {
V_14 -> V_144 = V_148 -> V_153 ;
#ifdef F_52
V_14 -> V_130 = V_148 -> V_113 ;
F_26 ( V_14 , L_50 ,
...
if ( V_14 -> V_129 && V_155 ) {
while ( V_155 -> V_113 ) {
if ( ! strcmp ( V_14 -> V_129 , V_155 -> V_113 ) ) {
V_14 -> V_144 = V_155 -> V_126 ;
V_14 -> V_130 = V_155 -> V_113 ;
V_14 -> V_133 = V_147 ;
F_26 ( V_14 , L_53 ,
V_14 -> V_91 . V_92 , V_14 -> V_130 ) ;
return;
...
if ( V_157 ) {
V_158 = F_54 ( V_14 -> V_160 -> V_161 , V_157 ) ;
if ( V_158 ) {
V_126 = V_158 -> V_153 ;
#ifdef F_52
V_113 = V_158 -> V_113 ;
F_26 ( V_14 , L_54 ,
V_14 -> V_91 . V_92 , V_113 , V_158 -> V_162 ? L_36 : L_55 ) ;
#endif
}
}
if ( V_126 < 0 && V_157 ) {
for ( V_158 = V_157 ; V_158 -> V_150 || V_158 -> V_163 ; V_158 ++ ) {
unsigned int V_164 =
V_158 -> V_163 | ( V_158 -> V_150 << 16 ) ;
unsigned int V_165 = 0xffff0000 | V_158 -> V_162 ;
if ( ( V_14 -> V_91 . V_151 & V_165 ) == ( V_164 & V_165 ) ) {
V_126 = V_158 -> V_153 ;
#ifdef F_52
V_113 = V_158 -> V_113 ;
F_26 ( V_14 , L_56 ,
