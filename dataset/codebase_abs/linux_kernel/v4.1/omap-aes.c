...
static int F_56 ( struct V_49 * V_50 , int V_89 )
{
int V_95 = 0 ;
while ( V_50 ) {
if ( ! F_57 ( V_50 -> V_3 , 4 ) )
return - 1 ;
if ( ! F_57 ( V_50 -> V_28 , V_96 ) )
return - 1 ;
V_95 += V_50 -> V_28 ;
V_50 = F_58 ( V_50 ) ;
}
...
int V_99 ;
V_99 = F_60 ( V_2 -> V_89 ) ;
V_97 = ( void * ) F_61 ( V_100 , V_99 ) ;
V_98 = ( void * ) F_61 ( V_100 , V_99 ) ;
if ( ! V_97 || ! V_98 ) {
F_31 ( L_13 ) ;
return - 1 ;
}
V_2 -> V_101 = V_2 -> V_59 ;
F_33 ( V_97 , V_2 -> V_58 , 0 , V_2 -> V_89 , 0 ) ;
F_62 ( & V_2 -> V_102 , 1 ) ;
F_63 ( & V_2 -> V_102 , V_97 , V_2 -> V_89 ) ;
V_2 -> V_58 = & V_2 -> V_102 ;
F_62 ( & V_2 -> V_103 , 1 ) ;
F_63 ( & V_2 -> V_103 , V_98 , V_2 -> V_89 ) ;
V_2 -> V_59 = & V_2 -> V_103 ;
return 0 ;
}
...
F_65 ( & V_2 -> V_109 , V_9 ) ;
if ( V_19 )
V_67 = F_66 ( & V_2 -> V_110 , V_19 ) ;
if ( V_2 -> V_9 & V_92 ) {
F_67 ( & V_2 -> V_109 , V_9 ) ;
return V_67 ;
}
V_106 = F_68 ( & V_2 -> V_110 ) ;
V_105 = F_69 ( & V_2 -> V_110 ) ;
if ( V_105 )
V_2 -> V_9 |= V_92 ;
F_67 ( & V_2 -> V_109 , V_9 ) ;
if ( ! V_105 )
...
V_2 -> V_58 = V_19 -> V_113 ;
V_2 -> V_59 = V_19 -> V_114 ;
if ( F_56 ( V_2 -> V_58 , V_2 -> V_89 ) ||
F_56 ( V_2 -> V_59 , V_2 -> V_89 ) ) {
if ( F_59 ( V_2 ) )
F_31 ( L_14 ) ;
V_2 -> V_115 = 1 ;
} else {
...
V_14 = F_74 ( F_49 ( V_19 ) ) ;
V_108 -> V_116 &= V_117 ;
V_2 -> V_9 = ( V_2 -> V_9 & ~ V_117 ) | V_108 -> V_116 ;
V_2 -> V_14 = V_14 ;
V_14 -> V_2 = V_2 ;
V_11 = F_8 ( V_2 ) ;
if ( ! V_11 )
...
V_97 = F_76 ( & V_2 -> V_102 ) ;
V_98 = F_76 ( & V_2 -> V_103 ) ;
F_33 ( V_98 , V_2 -> V_101 , 0 , V_2 -> V_112 , 1 ) ;
V_99 = F_60 ( V_2 -> V_112 ) ;
F_77 ( ( unsigned long ) V_97 , V_99 ) ;
F_77 ( ( unsigned long ) V_98 , V_99 ) ;
}
F_53 ( V_2 , 0 ) ;
F_64 ( V_2 , NULL ) ;
F_50 ( L_16 ) ;
...
static int F_79 ( struct V_91 * V_19 , unsigned long V_116 )
{
struct V_35 * V_14 = F_74 (
F_49 ( V_19 ) ) ;
struct V_107 * V_108 = F_73 ( V_19 ) ;
struct V_1 * V_2 ;
F_50 ( L_17 , V_19 -> V_52 ,
! ! ( V_116 & V_25 ) ,
! ! ( V_116 & V_17 ) ) ;
if ( ! F_57 ( V_19 -> V_52 , V_96 ) ) {
F_31 ( L_18 ) ;
return - V_84 ;
}
V_2 = F_19 ( V_14 ) ;
...
static int F_80 ( struct V_120 * V_57 , const T_3 * V_16 ,
unsigned int V_15 )
{
struct V_35 * V_14 = F_74 ( V_57 ) ;
if ( V_15 != V_121 && V_15 != V_122 &&
V_15 != V_123 )
return - V_84 ;
F_50 ( L_19 , V_15 ) ;
...
V_57 -> V_125 . V_126 = sizeof( struct V_107 ) ;
return 0 ;
}
...
static T_4 F_91 ( int V_127 , void * V_128 )
{
struct V_1 * V_2 = V_128 ;
T_1 V_129 , V_13 ;
T_1 * V_113 , * V_114 ;
V_129 = F_1 ( V_2 , F_92 ( V_2 ) ) ;
if ( V_129 & V_130 ) {
F_3 ( V_2 , F_40 ( V_2 ) , 0x0 ) ;
F_72 ( ! V_2 -> V_58 ) ;
F_72 ( F_93 ( V_131 ) > V_2 -> V_58 -> V_28 ) ;
V_113 = F_76 ( V_2 -> V_58 ) + F_93 ( V_131 ) ;
for ( V_13 = 0 ; V_13 < V_132 ; V_13 ++ ) {
F_3 ( V_2 , F_42 ( V_2 , V_13 ) , * V_113 ) ;
F_35 ( & V_2 -> V_69 , 4 ) ;
if ( V_2 -> V_58 -> V_28 == F_93 ( V_131 ) ) {
...
V_129 &= ~ V_130 ;
F_3 ( V_2 , F_92 ( V_2 ) , V_129 ) ;
F_3 ( V_2 , F_40 ( V_2 ) , 0x4 ) ;
} else if ( V_129 & V_133 ) {
F_3 ( V_2 , F_40 ( V_2 ) , 0x0 ) ;
F_72 ( ! V_2 -> V_59 ) ;
F_72 ( F_93 ( V_53 ) > V_2 -> V_59 -> V_28 ) ;
V_114 = F_76 ( V_2 -> V_59 ) + F_93 ( V_53 ) ;
for ( V_13 = 0 ; V_13 < V_132 ; V_13 ++ ) {
* V_114 = F_1 ( V_2 , F_42 ( V_2 , V_13 ) ) ;
F_35 ( & V_2 -> V_70 , 4 ) ;
...
struct V_135 * V_44 , struct V_136 * V_137 )
{
struct V_138 * V_139 = V_44 -> V_140 ;
const struct V_141 * V_142 ;
int V_11 = 0 ;
V_142 = F_95 ( F_96 ( V_143 ) , V_44 ) ;
if ( ! V_142 ) {
F_29 ( V_44 , L_21 ) ;
V_11 = - V_84 ;
goto V_11;
}
V_11 = F_97 ( V_139 , 0 , V_137 ) ;
if ( V_11 < 0 ) {
F_29 ( V_44 , L_22 ) ;
V_11 = - V_84 ;
goto V_11;
...
{
struct V_135 * V_44 = & V_145 -> V_44 ;
struct V_136 * V_146 ;
int V_11 = 0 ;
V_146 = F_99 ( V_145 , V_147 , 0 ) ;
if ( ! V_146 ) {
F_29 ( V_44 , L_23 ) ;
V_11 = - V_119 ;
goto V_11;
...
struct V_150 * V_151 ;
struct V_136 V_137 ;
int V_11 = - V_40 , V_13 , V_152 , V_127 = - 1 ;
T_1 V_153 ;
V_2 = F_101 ( V_44 , sizeof( struct V_1 ) , V_154 ) ;
if ( V_2 == NULL ) {
F_29 ( V_44 , L_26 ) ;
goto V_155;
}
...
F_102 ( V_145 , V_2 ) ;
F_103 ( & V_2 -> V_109 ) ;
F_104 ( & V_2 -> V_110 , V_156 ) ;
V_11 = ( V_44 -> V_140 ) ? F_94 ( V_2 , V_44 , & V_137 ) :
F_98 ( V_2 , V_145 , & V_137 ) ;
if ( V_11 )
goto V_157;
V_2 -> V_4 = F_105 ( V_44 , & V_137 ) ;
if ( F_106 ( V_2 -> V_4 ) ) {
V_11 = F_107 ( V_2 -> V_4 ) ;
goto V_157;
}
...
F_18 ( V_2 ) ;
V_153 = F_1 ( V_2 , F_109 ( V_2 ) ) ;
F_90 ( V_44 ) ;
F_110 ( V_44 , L_27 ,
( V_153 & V_2 -> V_29 -> V_158 ) >> V_2 -> V_29 -> V_159 ,
( V_153 & V_2 -> V_29 -> V_160 ) >> V_2 -> V_29 -> V_161 ) ;
F_111 ( & V_2 -> V_39 , F_75 , ( unsigned long ) V_2 ) ;
F_111 ( & V_2 -> V_118 , F_78 , ( unsigned long ) V_2 ) ;
V_11 = F_25 ( V_2 ) ;
...
F_115 ( & V_2 -> V_163 ) ;
F_116 ( & V_37 ) ;
F_117 ( & V_2 -> V_163 , & V_164 ) ;
F_118 ( & V_37 ) ;
for ( V_13 = 0 ; V_13 < V_2 -> V_29 -> V_165 ; V_13 ++ ) {
for ( V_152 = 0 ; V_152 < V_2 -> V_29 -> V_166 [ V_13 ] . V_167 ; V_152 ++ ) {
V_151 = & V_2 -> V_29 -> V_166 [ V_13 ] . V_168 [ V_152 ] ;
F_50 ( L_30 , V_151 -> V_169 ) ;
F_115 ( & V_151 -> V_170 ) ;
V_11 = F_119 ( V_151 ) ;
if ( V_11 )
goto V_171;
V_2 -> V_29 -> V_166 [ V_13 ] . V_172 ++ ;
}
}
return 0 ;
V_171:
for ( V_13 = V_2 -> V_29 -> V_165 - 1 ; V_13 >= 0 ; V_13 -- )
for ( V_152 = V_2 -> V_29 -> V_166 [ V_13 ] . V_172 - 1 ; V_152 >= 0 ; V_152 -- )
F_120 (
& V_2 -> V_29 -> V_166 [ V_13 ] . V_168 [ V_152 ] ) ;
if ( ! V_2 -> V_68 )
F_32 ( V_2 ) ;
V_162:
F_121 ( & V_2 -> V_39 ) ;
...
static int F_123 ( struct V_144 * V_145 )
{
...
static int F_126 ( struct V_135 * V_44 )
{
F_90 ( V_44 ) ;
return 0 ;
}
static int F_127 ( struct V_135 * V_44 )
{
F_88 ( V_44 ) ;
return 0 ;
}
