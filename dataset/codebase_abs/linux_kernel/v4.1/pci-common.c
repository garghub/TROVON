...
static inline void F_73 ( struct V_28 * V_3 , int V_124 )
{
struct V_29 * V_119 , * V_125 = & V_3 -> V_29 [ V_124 ] ;
F_27 ( L_36 ,
F_51 ( V_3 ) , V_124 ,
( unsigned long long ) V_125 -> V_42 ,
( unsigned long long ) V_125 -> V_44 ,
( unsigned int ) V_125 -> V_41 ) ;
V_119 = F_68 ( V_3 , V_125 ) ;
if ( ! V_119 || ( V_119 -> V_41 & V_104 ) ||
F_69 ( V_119 , V_125 ) < 0 ) {
F_71 ( L_37 , V_124 ) ;
F_72 ( L_38 , F_51 ( V_3 ) ) ;
...
V_125 -> V_41 |= V_104 ;
V_125 -> V_44 -= V_125 -> V_42 ;
V_125 -> V_42 = 0 ;
}
}
static void T_8 F_74 ( int V_126 )
{
...
F_24 (dev) {
F_53 ( V_3 , V_107 , & V_106 ) ;
for ( V_124 = 0 ; V_124 <= V_39 ; V_124 ++ ) {
V_125 = & V_3 -> V_29 [ V_124 ] ;
if ( V_125 -> V_27 )
continue;
if ( ! V_125 -> V_41 || ( V_125 -> V_41 & V_104 ) )
continue;
if ( V_124 == V_39 )
V_127 = 1 ;
if ( V_125 -> V_41 & V_38 )
...
for ( V_34 = 0 ; V_34 < 3 ; V_34 ++ ) {
V_132 = & V_14 -> V_98 [ V_34 ] ;
if ( ! ( V_132 -> V_41 & V_37 ) )
continue;
F_27 ( L_46 , V_132 ) ;
if ( ( V_132 -> V_42 - V_30 ) <= 0xa0000 &&
( V_132 -> V_44 - V_30 ) >= 0xbffff )
break;
}
if ( V_34 >= 3 )
return;
...
F_12 (dev, &bus->devices, bus_list) {
int V_34 ;
for ( V_34 = 0 ; V_34 < V_135 ; V_34 ++ ) {
struct V_29 * V_125 = & V_3 -> V_29 [ V_34 ] ;
if ( V_125 -> V_27 || ! V_125 -> V_42 || ! V_125 -> V_41 )
continue;
F_27 ( L_51 , F_51 ( V_3 ) ) ;
F_27 ( L_52 ,
V_34 , ( unsigned long long ) V_125 -> V_42 ,
( unsigned long long ) V_125 -> V_44 ,
( unsigned int ) V_125 -> V_41 ) ;
if ( F_83 ( V_3 , V_34 ) == 0 )
continue;
...
F_27 ( L_62 , F_92 ( V_25 ) ) ;
F_86 ( V_14 , & V_137 ) ;
V_24 = F_93 ( V_14 -> V_27 , V_14 -> V_141 ,
V_14 -> V_142 , V_14 , & V_137 ) ;
if ( V_24 == NULL ) {
F_50 ( L_63 ,
V_14 -> V_7 ) ;
F_94 ( & V_137 ) ;
...
V_24 -> V_143 . V_42 = V_14 -> V_141 ;
V_14 -> V_24 = V_24 ;
V_14 -> V_144 = V_24 -> V_143 . V_44 ;
}
...
struct V_1 * V_14 , * V_26 ;
F_17 (hose, tmp, &hose_list, list_node)
if ( V_24 >= V_14 -> V_141 && V_24 <= V_14 -> V_144 )
return V_14 ;
return NULL ;
}
long F_97 ( long V_147 , unsigned long V_24 , unsigned long V_148 )
{
struct V_1 * V_14 ;
long V_149 = - V_150 ;
V_14 = F_96 ( V_24 ) ;
...
static int
F_98 ( struct V_23 * V_24 , unsigned int V_148 , int V_30 ,
int V_157 , T_6 * V_63 )
{
return V_158 ;
}
static int
F_99 ( struct V_23 * V_24 , unsigned int V_148 , int V_30 ,
int V_157 , T_6 V_63 )
{
return V_158 ;
}
static struct V_23 *
F_100 ( struct V_1 * V_14 , int V_159 )
{
...
V_24 . V_68 = V_159 ;
V_24 . V_140 = V_14 ;
V_24 . V_142 = V_14 ? V_14 -> V_142 : & V_160 ;
return & V_24 ;
}
int F_101 ( struct V_1 * V_14 , int V_24 , int V_148 ,
int V_161 )
{
return F_102 ( F_100 ( V_14 , V_24 ) , V_148 , V_161 ) ;
}
