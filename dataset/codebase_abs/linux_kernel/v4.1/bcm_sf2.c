...
V_2 -> V_140 |= ( ( 1 << 30 ) | ( 1 << 0 ) ) ;
V_125 = F_18 ( V_10 , V_141 ) ;
V_10 -> V_22 . V_142 = ( V_125 >> V_143 ) &
V_144 ;
V_10 -> V_22 . V_145 = ( V_125 & V_146 ) ;
V_125 = F_18 ( V_10 , V_147 ) ;
V_10 -> V_22 . V_148 = V_125 & V_149 ;
F_59 ( L_11 ,
V_10 -> V_22 . V_142 >> 8 , V_10 -> V_22 . V_142 & 0xff ,
V_10 -> V_22 . V_145 >> 8 , V_10 -> V_22 . V_145 & 0xff ,
V_10 -> V_132 , V_10 -> V_130 , V_10 -> V_131 ) ;
return 0 ;
V_135:
F_60 ( V_10 -> V_130 , V_10 ) ;
V_134:
V_124 = & V_10 -> V_132 ;
for ( V_5 = 0 ; V_5 < V_120 ; V_5 ++ ) {
if ( * V_124 )
...
static int F_62 ( struct V_1 * V_2 , T_6 * V_150 )
{
return 0 ;
}
static T_4 F_63 ( struct V_1 * V_2 , int V_3 )
{
struct V_9 * V_10 = F_3 ( V_2 ) ;
return V_10 -> V_22 . V_148 ;
}
static int F_64 ( struct V_1 * V_2 , int V_151 , int V_150 ,
int V_152 , T_9 V_13 )
{
struct V_9 * V_10 = F_3 ( V_2 ) ;
int V_71 = 0 ;
T_4 V_16 ;
V_16 = F_18 ( V_10 , V_153 ) ;
V_16 |= V_154 ;
F_19 ( V_10 , V_16 , V_153 ) ;
V_16 = 0x70 ;
V_16 <<= 2 ;
F_13 ( V_10 , V_150 , V_16 ) ;
V_16 = 0x80 << 8 | V_152 << 1 ;
V_16 <<= 2 ;
if ( V_151 )
V_71 = F_7 ( V_10 , V_16 ) ;
...
static int F_65 ( struct V_1 * V_2 , int V_150 , int V_152 )
{
switch ( V_150 ) {
case 0 :
case 30 :
return F_64 ( V_2 , 1 , V_150 , V_152 , 0 ) ;
default:
return 0xffff ;
}
}
static int F_66 ( struct V_1 * V_2 , int V_150 , int V_152 ,
T_9 V_13 )
{
switch ( V_150 ) {
case 0 :
case 30 :
F_64 ( V_2 , 0 , V_150 , V_152 , V_13 ) ;
break;
}
return 0 ;
}
static void F_67 ( struct V_1 * V_2 , int V_3 ,
struct V_53 * V_78 )
{
struct V_9 * V_10 = F_3 ( V_2 ) ;
T_4 V_155 = 0 , V_156 ;
...
if ( ! V_78 -> V_112 ) {
V_16 = F_18 ( V_10 , F_68 ( V_3 ) ) ;
V_16 &= ~ V_167 ;
F_19 ( V_10 , V_16 , F_68 ( V_3 ) ) ;
goto V_166;
}
V_16 = F_18 ( V_10 , F_68 ( V_3 ) ) ;
V_16 &= ~ V_168 ;
...
if ( V_78 -> V_182 == V_183 )
V_16 |= V_184 ;
F_13 ( V_10 , V_16 , F_69 ( V_3 ) ) ;
}
static void F_70 ( struct V_1 * V_2 , int V_3 ,
struct V_185 * V_186 )
{
struct V_9 * V_10 = F_3 ( V_2 ) ;
T_4 V_182 , V_173 , V_176 ;
T_4 V_16 ;
V_182 = F_7 ( V_10 , V_187 ) ;
V_173 = F_7 ( V_10 , V_188 ) ;
V_176 = F_7 ( V_10 , V_189 ) ;
V_176 >>= ( V_3 * V_190 ) ;
V_176 &= V_191 ;
V_186 -> V_112 = 0 ;
if ( V_3 == 7 ) {
V_186 -> V_112 = V_10 -> V_62 [ V_3 ] . V_112 ;
V_186 -> V_182 = 1 ;
} else {
V_186 -> V_112 = 1 ;
V_186 -> V_182 = ! ! ( V_182 & ( 1 << V_3 ) ) ;
}
V_16 = F_7 ( V_10 , F_69 ( V_3 ) ) ;
V_16 |= V_175 ;
if ( V_186 -> V_112 )
V_16 |= V_44 ;
else
...
static void F_73 ( struct V_1 * V_2 , int V_3 ,
struct V_195 * V_196 )
{
struct V_197 * V_70 = V_2 -> V_55 [ V_2 -> V_56 ] . V_198 ;
struct V_9 * V_10 = F_3 ( V_2 ) ;
struct V_195 V_199 ;
V_70 -> V_200 -> V_201 ( V_70 , & V_199 ) ;
V_196 -> V_72 = V_199 . V_72 ;
memset ( & V_196 -> V_202 , 0 , sizeof( V_196 -> V_202 ) ) ;
if ( V_199 . V_203 & V_204 )
memcpy ( & V_196 -> V_202 , V_199 . V_202 , sizeof( V_196 -> V_202 ) ) ;
if ( V_10 -> V_67 & ( 1 << V_3 ) )
V_196 -> V_203 = V_199 . V_203 ;
else
V_196 -> V_203 = 0 ;
}
static int F_74 ( struct V_1 * V_2 , int V_3 ,
struct V_195 * V_196 )
{
struct V_197 * V_70 = V_2 -> V_55 [ V_2 -> V_56 ] . V_198 ;
struct V_9 * V_10 = F_3 ( V_2 ) ;
...
V_10 -> V_67 &= ~ ( 1 << V_21 ) ;
return V_70 -> V_200 -> V_205 ( V_70 , V_196 ) ;
}
