...
V_194 += V_36 ;
V_148 -> V_196 = F_88 ( V_193 , V_194 - V_193 , V_141 ) ;
if ( ! V_148 -> V_196 )
return - V_83 ;
F_89 ( V_148 -> V_196 , '\\' ) ;
if ( ! * V_194 ++ || ! * V_194 )
return 0 ;
V_148 -> V_197 = F_90 ( V_194 , V_141 ) ;
if ( ! V_148 -> V_197 )
return - V_83 ;
return 0 ;
}
...
if ( V_214 < V_200 && V_214 [ 1 ] == V_139 ) {
V_214 [ 0 ] = V_139 ;
while ( ( V_214 = strchr ( V_214 , V_139 ) )
!= NULL && ( V_214 [ 1 ] == V_139 ) ) {
V_214 = ( char * ) & V_214 [ 2 ] ;
}
if ( V_214 ) {
...
F_11 ( V_148 -> V_343 ) ;
V_203 = strlen ( V_144 ) ;
V_148 -> V_343 = F_99 ( V_203 + 1 , V_141 ) ;
if ( V_148 -> V_343 == NULL ) {
F_97 ( L_54 ) ;
goto V_233;
}
...
return 0 ;
if ( ! F_113 ( F_114 ( V_2 ) , V_125 -> V_385 -> V_386 ) )
return 0 ;
if ( ! F_109 ( V_2 , V_375 ,
(struct V_96 * ) & V_148 -> V_351 ) )
return 0 ;
...
if ( V_391 )
return V_391 ;
V_391 = F_99 ( sizeof( struct V_1 ) , V_141 ) ;
if ( ! V_391 ) {
V_3 = - V_83 ;
goto V_392;
}
...
F_124 ( V_391 , F_125 ( V_125 -> V_385 -> V_386 ) ) ;
...
F_134 ( V_402 ) ;
V_391 -> V_133 = F_135 ( F_56 ,
V_391 , L_79 ) ;
if ( F_126 ( V_391 -> V_133 ) ) {
V_3 = F_127 ( V_391 -> V_133 ) ;
F_5 ( V_59 , L_80 , V_3 ) ;
F_136 ( V_402 ) ;
goto V_393;
}
...
if ( F_149 ( V_416 ) ) {
V_3 = V_416 ? F_127 ( V_416 ) : - V_140 ;
goto V_423;
}
V_411 = ( char * ) V_416 -> V_199 ;
V_139 = F_150 ( V_411 , V_416 -> V_424 , ':' ) ;
F_5 ( V_20 , L_90 , V_411 ) ;
if ( ! V_139 ) {
F_5 ( V_20 , L_91 ,
V_416 -> V_424 ) ;
...
V_148 -> V_338 = F_88 ( V_411 , V_36 , V_141 ) ;
if ( ! V_148 -> V_338 ) {
F_5 ( V_20 , L_93 ,
V_36 ) ;
V_3 = - V_83 ;
...
++ V_139 ;
V_148 -> V_343 = F_88 ( V_139 , V_36 , V_141 ) ;
if ( ! V_148 -> V_343 ) {
F_5 ( V_20 , L_96 ,
V_36 ) ;
V_3 = - V_83 ;
...
if ( V_390 -> V_338 ) {
V_8 -> V_404 = F_90 ( V_390 -> V_338 , V_141 ) ;
if ( ! V_8 -> V_404 )
goto V_427;
}
if ( V_390 -> V_343 ) {
V_8 -> V_343 = F_90 ( V_390 -> V_343 , V_141 ) ;
if ( ! V_8 -> V_343 )
goto V_427;
}
if ( V_390 -> V_349 ) {
V_8 -> V_421 = F_90 ( V_390 -> V_349 , V_141 ) ;
if ( ! V_8 -> V_421 )
goto V_427;
}
...
static int F_158 ( struct V_9 * V_10 , const char * V_136 )
{
if ( V_10 -> V_429 == V_16 )
return 0 ;
if ( strncmp ( V_10 -> V_430 , V_136 , V_431 ) )
return 0 ;
return 1 ;
}
static struct V_9 *
F_159 ( struct V_7 * V_8 , const char * V_136 )
{
struct V_4 * V_5 ;
struct V_9 * V_10 ;
F_2 ( & V_22 ) ;
...
V_10 -> V_8 = V_8 ;
if ( V_390 -> V_343 ) {
V_10 -> V_343 = F_90 ( V_390 -> V_343 , V_141 ) ;
if ( ! V_10 -> V_343 ) {
V_3 = - V_83 ;
goto V_435;
}
...
V_558 = F_35 ( V_560 + V_559 + 1 , V_141 ) ;
if ( V_558 == NULL )
return F_71 ( - V_83 ) ;
...
int V_3 ;
struct V_147 * V_390 ;
V_390 = F_35 ( sizeof( struct V_147 ) , V_141 ) ;
if ( ! V_390 )
return F_71 ( - V_83 ) ;
...
V_446 -> V_334 = V_2 -> V_49 -> V_575 ( V_10 , V_390 ) ;
V_446 -> V_332 = V_2 -> V_49 -> V_576 ( V_10 , V_390 ) ;
V_446 -> V_568 . V_577 = V_446 -> V_332 / V_578 ;
V_571:
#ifdef F_208
if ( V_567 == 0 ) {
int V_579 = F_199 ( V_408 , V_8 , V_390 , V_446 ,
false ) ;
if ( ! V_579 ) {
V_567 ++ ;
goto V_569;
...
F_216 ( V_590 , V_598 ,
NULL , 4 ) ;
V_590 -> V_599 = F_217 ( V_8 -> V_2 ) ;
V_590 -> V_600 = V_8 -> V_601 ;
V_592 = ( T_8 * ) V_590 ;
V_593 = ( T_9 * ) V_591 ;
V_592 -> V_602 = 0xFF ;
V_592 -> V_436 = F_218 ( V_603 ) ;
V_594 = & V_592 -> V_604 [ 0 ] ;
...
V_592 -> V_607 = F_218 ( V_608 ) ;
#ifdef F_84
if ( ( V_609 & V_610 ) &&
( V_8 -> V_150 == V_168 ) )
F_219 ( V_10 -> V_343 , V_8 -> V_2 -> V_611 ,
V_8 -> V_2 -> V_605 &
V_612 ? true : false ,
V_594 ) ;
else
#endif
V_3 = F_220 ( V_10 -> V_343 , V_8 -> V_2 -> V_611 ,
V_594 , V_466 ) ;
if ( V_3 ) {
F_5 ( V_20 , L_153 ,
V_21 , V_3 ) ;
...
V_592 -> V_623 . V_495 = F_185 ( F_222 (
V_592 -> V_623 . V_495 ) + V_596 ) ;
V_592 -> V_624 = F_218 ( V_596 ) ;
V_3 = F_223 ( V_408 , V_8 , V_590 , V_591 , & V_78 ,
0 ) ;
if ( ( V_3 == 0 ) && ( V_10 != NULL ) ) {
bool V_625 ;
V_10 -> V_429 = V_62 ;
...
V_594 += V_78 + 1 ;
V_595 -= ( V_78 + 1 ) ;
F_226 ( V_10 -> V_430 , V_589 , sizeof( V_10 -> V_430 ) ) ;
F_11 ( V_10 -> V_628 ) ;
V_10 -> V_628 = F_227 ( V_594 ,
V_595 , V_625 ,
V_466 ) ;
F_5 ( V_20 , L_157 , V_10 -> V_628 ) ;
if ( ( V_591 -> V_629 == 3 ) ||
( V_591 -> V_629 == 7 ) )
V_10 -> V_436 = F_228 ( V_593 -> V_630 ) ;
else
V_10 -> V_436 = 0 ;
F_5 ( V_20 , L_158 , V_10 -> V_436 ) ;
...
static void F_229 ( struct V_631 * V_122 )
{
struct V_445 * V_632 = F_22 ( V_122 , struct V_445 , V_633 ) ;
F_230 ( V_632 -> V_426 ) ;
F_11 ( V_632 ) ;
}
void
...
F_119 ( & V_446 -> V_529 ) ;
F_2 ( & V_446 -> V_531 ) ;
while ( ( V_637 = F_232 ( V_635 ) ) ) {
V_440 = F_233 ( V_637 , struct V_439 , V_638 ) ;
F_175 ( V_440 ) ;
...
static struct V_9 *
F_239 ( struct V_445 * V_446 , T_3 V_645 )
{
int V_3 ;
struct V_9 * V_646 = F_240 ( V_446 ) ;
struct V_7 * V_8 ;
struct V_9 * V_10 = NULL ;
struct V_147 * V_510 ;
V_510 = F_99 ( sizeof( * V_510 ) , V_141 ) ;
if ( V_510 == NULL )
return F_71 ( - V_83 ) ;
...
V_510 -> V_252 = V_646 -> V_252 ;
V_510 -> V_272 = V_646 -> V_272 ;
V_510 -> V_306 = V_646 -> V_306 ;
V_510 -> V_270 = ! V_646 -> V_514 ;
V_510 -> V_150 = V_646 -> V_8 -> V_150 ;
V_510 -> V_152 = V_646 -> V_8 -> V_152 ;
V_3 = F_238 ( V_510 , V_646 -> V_8 ) ;
if ( V_3 ) {
V_10 = F_71 ( V_3 ) ;
goto V_463;
}
...
static struct V_439 *
F_241 ( struct V_634 * V_635 , T_3 V_145 )
{
struct V_636 * V_637 = V_635 -> V_636 ;
struct V_439 * V_440 ;
while ( V_637 ) {
V_440 = F_233 ( V_637 , struct V_439 , V_638 ) ;
if ( F_242 ( V_440 -> V_585 , V_145 ) )
V_637 = V_637 -> V_647 ;
else if ( F_243 ( V_440 -> V_585 , V_145 ) )
V_637 = V_637 -> V_648 ;
else
return V_440 ;
}
...
static void
F_214 ( struct V_634 * V_635 , struct V_439 * V_649 )
{
struct V_636 * * V_65 = & ( V_635 -> V_636 ) , * V_650 = NULL ;
struct V_439 * V_440 ;
while ( * V_65 ) {
V_440 = F_233 ( * V_65 , struct V_439 , V_638 ) ;
V_650 = * V_65 ;
if ( F_242 ( V_440 -> V_585 , V_649 -> V_585 ) )
V_65 = & ( ( * V_65 ) -> V_647 ) ;
else
V_65 = & ( ( * V_65 ) -> V_648 ) ;
}
F_244 ( & V_649 -> V_638 , V_650 , V_65 ) ;
F_245 ( & V_649 -> V_638 , V_635 ) ;
}
struct V_439 *
...
F_2 ( & V_446 -> V_531 ) ;
V_440 = F_241 ( & V_446 -> V_532 , V_645 ) ;
if ( V_440 )
F_175 ( V_440 ) ;
F_3 ( & V_446 -> V_531 ) ;
if ( V_440 == NULL ) {
V_652 = F_99 ( sizeof( * V_440 ) , V_141 ) ;
if ( V_652 == NULL )
return F_71 ( - V_83 ) ;
V_652 -> V_585 = V_645 ;
V_652 -> V_586 = F_71 ( - V_572 ) ;
F_213 ( V_653 , & V_652 -> V_443 ) ;
F_213 ( V_442 , & V_652 -> V_443 ) ;
F_175 ( V_652 ) ;
F_2 ( & V_446 -> V_531 ) ;
V_440 = F_241 ( & V_446 -> V_532 , V_645 ) ;
if ( V_440 ) {
...
V_654:
V_651 = F_248 ( & V_440 -> V_443 , V_653 ,
V_134 ) ;
if ( V_651 ) {
F_166 ( V_440 ) ;
return F_71 ( - V_88 ) ;
}
if ( ! F_126 ( V_440 -> V_586 ) )
return V_440 ;
if ( F_23 ( V_38 , V_440 -> V_444 + V_655 ) ) {
F_166 ( V_440 ) ;
return F_71 ( - V_572 ) ;
}
if ( F_249 ( V_653 , & V_440 -> V_443 ) )
goto V_654;
}
V_440 -> V_586 = F_239 ( V_446 , V_645 ) ;
F_234 ( V_653 , & V_440 -> V_443 ) ;
F_250 ( & V_440 -> V_443 , V_653 ) ;
if ( F_126 ( V_440 -> V_586 ) ) {
F_166 ( V_440 ) ;
return F_71 ( - V_572 ) ;
}
...
V_529 . V_47 ) ;
struct V_634 * V_635 = & V_446 -> V_532 ;
struct V_636 * V_637 = F_232 ( V_635 ) ;
struct V_636 * V_5 ;
struct V_439 * V_440 ;
F_2 ( & V_446 -> V_531 ) ;
V_637 = F_232 ( V_635 ) ;
...
V_5 = V_637 ;
V_637 = F_251 ( V_5 ) ;
V_440 = F_233 ( V_5 , struct V_439 , V_638 ) ;
if ( F_168 ( V_587 , & V_440 -> V_443 ) ||
F_60 ( & V_440 -> V_441 ) != 0 ||
