...
static int F_21 ( struct V_41 * V_42 , int V_43 , void * V_7 )
{
struct V_6 * V_44 = V_7 ;
T_1 V_63 , * V_23 ;
struct V_16 * V_17 ;
...
F_23 ( V_42 , V_50 ) ;
F_24 ( V_42 , V_42 -> V_14 - V_51 ) ;
return V_63 ;
}
static int F_25 ( void * V_44 , int V_14 , T_1 * V_72 , void * V_7 )
{
struct V_6 * V_53 = V_7 ;
int V_63 ;
...
F_26 ( ( void * ) V_53 -> V_2 , V_53 -> V_44 , V_73 ) ;
} else if ( V_14 == 0 )
V_53 -> V_65 = 0 ;
else
return - 1 ;
...
static int F_27 ( void * V_44 , int V_14 , T_1 * V_72 , void * V_7 )
{
struct V_6 * V_53 = V_7 ;
if ( V_14 < V_73 )
return - 1 ;
...
static void F_28 ( struct V_74 * V_75 , void * V_7 )
{
struct V_6 * V_76 = V_7 ;
F_29 ( V_75 ,
L_7 ,
