...
{
struct V_70 * V_71 = F_42 ( V_69 , V_72 ) ;
struct V_1 * V_73 ;
F_43 ( & V_71 -> V_74 ) ;
F_44 (fout, &fn->fou_list, list) {
if ( V_1 -> V_75 == V_73 -> V_75 ) {
F_45 ( & V_71 -> V_74 ) ;
return - V_76 ;
}
}
F_46 ( & V_1 -> V_77 , & V_71 -> V_78 ) ;
F_45 ( & V_71 -> V_74 ) ;
return 0 ;
}
...
static int F_52 ( struct V_2 * V_3 , struct V_1 * V_1 , struct V_82 * V_83 )
{
F_53 ( V_3 ) -> V_84 = F_10 ;
V_1 -> V_12 = V_83 -> V_12 ;
...
static int F_54 ( struct V_2 * V_3 , struct V_1 * V_1 , struct V_82 * V_83 )
{
F_53 ( V_3 ) -> V_84 = F_17 ;
...
static int F_55 ( struct V_69 * V_69 , struct V_82 * V_83 ,
struct V_79 * * V_87 )
{
...
struct V_2 * V_3 ;
int V_51 ;
V_51 = F_56 ( V_69 , & V_83 -> V_85 , & V_2 ) ;
if ( V_51 < 0 )
goto error;
V_1 = F_57 ( sizeof( * V_1 ) , V_88 ) ;
if ( ! V_1 ) {
V_51 = - V_89 ;
goto error;
}
...
switch ( V_83 -> type ) {
case V_90 :
V_51 = F_52 ( V_3 , V_1 , V_83 ) ;
if ( V_51 )
goto error;
break;
case V_91 :
V_51 = F_54 ( V_3 , V_1 , V_83 ) ;
if ( V_51 )
goto error;
break;
default:
...
static int F_61 ( struct V_69 * V_69 , struct V_82 * V_83 )
{
struct V_70 * V_71 = F_42 ( V_69 , V_72 ) ;
...
V_83 -> V_85 . V_96 = V_81 ;
if ( V_98 -> V_99 [ V_100 ] ) {
T_2 V_96 = F_63 ( V_98 -> V_99 [ V_100 ] ) ;
if ( V_96 != V_81 && V_96 != V_101 )
return - V_92 ;
V_83 -> V_85 . V_96 = V_96 ;
}
if ( V_98 -> V_99 [ V_102 ] ) {
T_3 V_75 = F_64 ( V_98 -> V_99 [ V_102 ] ) ;
V_83 -> V_85 . V_86 = V_75 ;
}
if ( V_98 -> V_99 [ V_103 ] )
V_83 -> V_12 = F_63 ( V_98 -> V_99 [ V_103 ] ) ;
if ( V_98 -> V_99 [ V_104 ] )
V_83 -> type = F_63 ( V_98 -> V_99 [ V_104 ] ) ;
if ( V_98 -> V_99 [ V_105 ] )
V_83 -> V_28 |= V_33 ;
return 0 ;
}
static int F_65 ( struct V_5 * V_6 , struct V_97 * V_98 )
{
struct V_69 * V_69 = F_66 ( V_98 ) ;
struct V_82 V_83 ;
int V_51 ;
V_51 = F_62 ( V_98 , & V_83 ) ;
if ( V_51 )
return V_51 ;
return F_55 ( V_69 , & V_83 , NULL ) ;
}
static int F_67 ( struct V_5 * V_6 , struct V_97 * V_98 )
{
struct V_69 * V_69 = F_66 ( V_98 ) ;
struct V_82 V_83 ;
int V_51 ;
...
if ( V_51 )
return V_51 ;
return F_61 ( V_69 , & V_83 ) ;
}
static int F_68 ( struct V_1 * V_1 , struct V_5 * V_106 )
{
if ( F_69 ( V_106 , V_100 , V_1 -> V_2 -> V_3 -> V_80 ) ||
F_70 ( V_106 , V_102 , V_1 -> V_75 ) ||
F_69 ( V_106 , V_103 , V_1 -> V_12 ) ||
F_69 ( V_106 , V_104 , V_1 -> type ) )
return - 1 ;
if ( V_1 -> V_28 & V_33 )
if ( F_71 ( V_106 , V_105 ) )
return - 1 ;
...
static int F_72 ( struct V_1 * V_1 , T_5 V_107 , T_5 V_108 ,
T_5 V_28 , struct V_5 * V_6 , T_2 V_109 )
{
void * V_110 ;
V_110 = F_73 ( V_6 , V_107 , V_108 , & V_111 , V_28 , V_109 ) ;
if ( ! V_110 )
return - V_89 ;
if ( F_68 ( V_1 , V_6 ) < 0 )
goto V_112;
...
static int F_76 ( struct V_5 * V_6 , struct V_97 * V_98 )
{
struct V_69 * V_69 = F_66 ( V_98 ) ;
struct V_70 * V_71 = F_42 ( V_69 , V_72 ) ;
struct V_5 * V_106 ;
...
T_3 V_75 ;
int V_114 ;
V_114 = F_62 ( V_98 , & V_83 ) ;
if ( V_114 )
return V_114 ;
V_75 = V_83 . V_85 . V_86 ;
if ( V_75 == 0 )
return - V_92 ;
V_106 = F_77 ( V_115 , V_88 ) ;
if ( ! V_106 )
return - V_89 ;
V_114 = - V_116 ;
F_43 ( & V_71 -> V_74 ) ;
...
if ( V_114 < 0 )
goto V_120;
return F_78 ( V_106 , V_98 ) ;
V_120:
F_79 ( V_106 ) ;
return V_114 ;
}
static int F_80 ( struct V_5 * V_6 , struct V_121 * V_122 )
{
struct V_69 * V_69 = F_81 ( V_6 -> V_3 ) ;
struct V_70 * V_71 = F_42 ( V_69 , V_72 ) ;
struct V_1 * V_73 ;
int V_123 = 0 , V_114 ;
F_43 ( & V_71 -> V_74 ) ;
...
continue;
V_114 = F_72 ( V_73 , F_82 ( V_122 -> V_6 ) . V_107 ,
...
T_1 F_83 ( struct V_128 * V_129 )
{
return sizeof( struct V_11 ) ;
}
T_1 F_84 ( struct V_128 * V_129 )
{
T_1 V_7 ;
bool V_130 = false ;
V_7 = sizeof( struct V_11 ) + sizeof( struct V_13 ) ;
...
static void F_85 ( struct V_5 * V_6 , struct V_128 * V_129 ,
struct V_132 * V_133 , T_2 * V_12 , T_3 V_134 )
{
struct V_11 * V_135 ;
F_86 ( V_6 , sizeof( struct V_11 ) ) ;
F_9 ( V_6 ) ;
V_135 = F_8 ( V_6 ) ;
...
V_135 -> V_139 = 0 ;
F_87 ( ! ( V_129 -> V_28 & V_140 ) , V_6 ,
V_133 -> V_141 , V_133 -> V_142 , V_6 -> V_7 ) ;
* V_12 = V_143 ;
}
int F_88 ( struct V_5 * V_6 , struct V_128 * V_129 ,
T_2 * V_12 , struct V_132 * V_133 )
{
bool V_144 = ! ! ( V_129 -> V_28 & V_140 ) ;
int type = V_144 ? V_145 : V_146 ;
T_3 V_134 ;
V_6 = F_89 ( V_6 , V_144 , type ) ;
if ( F_90 ( V_6 ) )
return F_91 ( V_6 ) ;
V_134 = V_129 -> V_134 ? : F_92 ( F_93 ( V_6 -> V_147 ) ,
V_6 , 0 , 0 , false ) ;
F_85 ( V_6 , V_129 , V_133 , V_12 , V_134 ) ;
return 0 ;
}
int F_94 ( struct V_5 * V_6 , struct V_128 * V_129 ,
T_2 * V_12 , struct V_132 * V_133 )
{
bool V_144 = ! ! ( V_129 -> V_28 & V_140 ) ;
int type = V_144 ? V_145 : V_146 ;
...
{
int V_114 ;
V_114 = F_98 ( & V_155 , V_156 ) ;
if ( V_114 < 0 ) {
F_99 ( L_1 ) ;
return V_114 ;
}
V_114 = F_98 ( & V_157 , V_158 ) ;
if ( V_114 < 0 ) {
F_99 ( L_2 ) ;
F_100 ( & V_155 , V_156 ) ;
return V_114 ;
...
static T_6 int F_102 ( struct V_69 * V_69 )
{
struct V_70 * V_71 = F_42 ( V_69 , V_72 ) ;
F_103 ( & V_71 -> V_78 ) ;
F_104 ( & V_71 -> V_74 ) ;
...
static T_7 void F_105 ( struct V_69 * V_69 )
{
struct V_70 * V_71 = F_42 ( V_69 , V_72 ) ;
struct V_1 * V_1 , * V_63 ;
F_43 ( & V_71 -> V_74 ) ;
F_106 (fou, next, &fn->fou_list, list)
F_47 ( V_1 ) ;
F_45 ( & V_71 -> V_74 ) ;
}
