...
{
struct V_1 * V_1 = (struct V_1 * ) V_206 -> V_208 ;
int V_216 , V_193 , V_217 , V_218 , V_196 , V_219 , V_220 ;
F_52 ( & V_1 -> V_4 -> V_129 ) ;
...
static void T_9 F_93 ( int V_247 , struct V_110 * V_111 )
{
struct V_1 * V_1 = V_111 -> V_114 ;
int V_248 ;
...
goto V_274;
V_111 -> V_114 = V_1 ;
V_271 = F_58 ( V_1 -> V_145 + 1 ,
8 * V_63 ) ;
V_1 -> V_144 = F_96 ( V_271 * V_63 , V_254 ) ;
if ( ! V_1 -> V_144 )
goto V_275;
V_1 -> V_185 = V_185 ;
V_1 -> V_99 = floor ;
...
struct V_202 * V_4 ;
V_23 = - V_283 ;
V_282 = F_106 ( V_189 , V_284 , 0 ) ;
if ( ! V_282 ) {
F_107 ( V_185 , L_75 ) ;
return V_23 ;
}
V_5 = F_108 ( V_185 , V_282 -> V_285 , V_286 ) ;
V_23 = - V_240 ;
...
V_23 = F_114 ( V_111 , V_291 , NULL , NULL ,
0 ) ;
if ( V_23 )
goto V_289;
}
