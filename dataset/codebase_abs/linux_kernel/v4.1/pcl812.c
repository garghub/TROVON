...
if ( ! V_7 )
return - V_150 ;
V_104 = F_59 ( V_2 , V_119 -> V_124 [ 0 ] , 0x10 ) ;
if ( V_104 )
return V_104 ;
if ( V_51 -> V_151 ) {
...
if ( ! V_2 -> V_75 )
return - V_150 ;
if ( ( 1 << V_119 -> V_124 [ 1 ] ) & V_51 -> V_151 ) {
V_104 = F_61 ( V_119 -> V_124 [ 1 ] , F_34 , 0 ,
V_2 -> V_155 , V_2 ) ;
if ( V_104 == 0 )
V_2 -> V_98 = V_119 -> V_124 [ 1 ] ;
}
}
if ( V_2 -> V_98 && V_51 -> V_156 )
F_53 ( V_2 , V_119 -> V_124 [ 2 ] ) ;
switch ( V_51 -> V_122 ) {
case V_157 :
if ( V_119 -> V_124 [ 2 ] == 1 )
V_7 -> V_27 = 1 ;
