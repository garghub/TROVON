...
int F_150 ( struct V_1 * V_2 , int V_354 ,
struct V_335 * V_355 )
{
...
V_6 -> V_42 ( V_2 , - 1 ) ;
for ( V_32 = 1 ; V_32 < V_354 ; V_32 ++ ) {
V_6 -> V_42 ( V_2 , V_32 ) ;
V_6 -> V_45 ( V_2 , V_96 , - 1 , - 1 ) ;
V_6 -> V_45 ( V_2 , V_301 , 0x00 , - 1 ) ;
if ( V_356 != V_6 -> V_49 ( V_2 ) ||
V_357 != V_6 -> V_49 ( V_2 ) ) {
V_6 -> V_42 ( V_2 , - 1 ) ;
break;
}
...
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_360 * V_130 = & V_6 -> V_130 ;
int V_361 , V_362 ;
if ( V_130 -> V_119 == 0 || V_6 -> V_291 == 0 )
return true ;
V_361 = ( V_2 -> V_37 * V_130 -> V_363 ) / V_130 -> V_119 ;
V_362 = ( V_2 -> V_37 * V_6 -> V_289 ) / V_6 -> V_291 ;
return V_361 >= V_362 && V_130 -> V_363 >= V_6 -> V_289 ;
}
...
! ( V_6 -> V_34 & V_366 ) ) ;
if ( ! ( V_6 -> V_43 & V_367 ) ) {
V_365 = F_156 ( sizeof( * V_365 ) + V_2 -> V_37
+ V_2 -> V_128 * 3 , V_278 ) ;
if ( ! V_365 )
return - V_279 ;
V_365 -> V_140 = ( T_3 * ) ( V_365 + 1 ) ;
V_365 -> V_142 = V_365 -> V_140 + V_2 -> V_128 ;
V_365 -> V_195 = V_365 -> V_142 + V_2 -> V_128 ;
V_6 -> V_139 = V_365 ;
} else {
if ( ! V_6 -> V_139 )
return - V_279 ;
...
if ( ! V_130 -> V_144 && ( V_130 -> V_57 != V_368 ) ) {
switch ( V_2 -> V_128 ) {
case 8 :
V_130 -> V_144 = & V_369 ;
break;
...
V_130 -> V_132 = F_158 (
V_130 -> V_363 * F_132 ( 8 * V_130 -> V_119 ) , 8 ) ;
V_130 -> V_7 = F_159 ( V_2 , V_130 -> V_119 , V_130 -> V_132 ,
& V_130 -> V_144 ) ;
if ( ! V_130 -> V_7 ) {
F_106 ( L_46 ) ;
F_14 () ;
...
&& V_32 < F_160 ( V_130 -> V_144 -> V_173 ) ; V_32 ++ )
...
V_2 -> type = F_140 ( V_6 ) ? V_385 : V_386 ;
V_2 -> V_387 = ( V_6 -> V_43 & V_388 ) ? V_389 :
V_390 ;
V_2 -> V_391 = F_105 ;
V_2 -> V_392 = NULL ;
V_2 -> V_393 = NULL ;
...
V_2 -> V_407 = F_110 ;
V_2 -> V_408 = V_2 -> V_37 ;
V_2 -> V_409 = V_130 -> V_144 ;
V_2 -> V_410 = V_130 -> V_363 ;
V_2 -> V_411 = V_130 -> V_119 ;
if ( ! V_2 -> V_412 )
V_2 -> V_412 = F_158 ( V_2 -> V_410 * 3 , 4 ) ;
if ( V_6 -> V_43 & V_413 )
return 0 ;
return V_6 -> V_266 ( V_2 ) ;
}
int F_161 ( struct V_1 * V_2 , int V_354 )
{
int V_8 ;
if ( ! V_2 -> V_414 && F_162 () ) {
F_163 ( L_51 , V_10 ) ;
...
{
struct V_5 * V_6 = V_2 -> V_7 ;
if ( V_6 -> V_130 . V_57 == V_368 )
F_165 ( (struct V_415 * ) V_6 -> V_130 . V_7 ) ;
F_166 ( V_2 ) ;
F_126 ( V_6 -> V_65 ) ;
if ( ! ( V_6 -> V_43 & V_367 ) )
F_126 ( V_6 -> V_139 ) ;
if ( V_6 -> V_416 && V_6 -> V_416 -> V_43
& V_417 )
F_126 ( V_6 -> V_416 ) ;
}
