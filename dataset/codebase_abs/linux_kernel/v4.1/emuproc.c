...
F_1 ( V_2 , V_4 , L_130 , V_53 , V_54 ) ;
F_1 ( V_2 , V_4 , L_131 , V_55 , V_56 ) ;
}
#if 0
...
struct V_1 * V_2 = V_29 -> V_32 ;
unsigned int V_33 , V_57 , V_58 ;
V_33 = F_8 ( V_2 , V_59 , 0 ) ;
V_57 = ( V_33 >> 16 ) & 0x8 ;
for ( V_58 = 0 ; V_58 < 4 ; V_58 ++ ) {
V_57 = V_33 >> ( 16 + ( V_58 * 4 ) ) ;
if ( V_57 & 0x8 ) F_3 ( V_4 , L_132 , V_58 , V_9 [ V_57 & 0x7 ] ) ;
else F_3 ( V_4 , L_133 , V_58 ) ;
}
}
...
T_1 V_60 ;
struct V_1 * V_2 = V_29 -> V_32 ;
F_3 ( V_4 , L_134 , V_2 -> V_41 . V_61 ) ;
F_3 ( V_4 , L_135 ) ;
for ( V_60 = 0 ; V_60 < ( V_2 -> V_36 ? 1024 : 512 ) ; V_60 ++ ) {
T_1 V_62 , V_63 ;
V_62 = F_10 ( V_2 , V_60 * 2 ) ;
V_63 = F_10 ( V_2 , V_60 * 2 + 1 ) ;
if ( V_2 -> V_36 )
F_3 ( V_4 , L_136 ,
( V_63 >> 24 ) & 0x0f ,
( V_63 >> 12 ) & 0x7ff ,
...
void * V_64 ,
struct V_65 * V_65 , char T_3 * V_66 ,
T_4 V_67 , T_5 V_68 )
{
struct V_1 * V_2 = V_29 -> V_32 ;
unsigned int V_69 ;
...
long V_71 ;
unsigned int V_38 ;
if ( ! strcmp ( V_29 -> V_61 , L_137 ) ) {
V_69 = V_72 ;
V_70 = 1 ;
} else if ( ! strcmp ( V_29 -> V_61 , L_138 ) ) {
V_69 = V_73 ;
} else if ( ! strcmp ( V_29 -> V_61 , L_139 ) ) {
V_69 = V_2 -> V_36 ? V_74 : V_75 ;
} else {
V_69 = V_2 -> V_36 ? V_76 : V_77 ;
}
V_57 = F_12 ( V_67 + 8 , V_78 ) ;
if ( ! V_57 )
return - V_79 ;
for ( V_38 = 0 ; V_38 < ( ( V_68 & 3 ) + V_67 + 3 ) > > 2 ; V_38 ++ ) {
unsigned int V_33 ;
V_33 = F_2 ( V_2 , V_69 + V_38 + ( V_68 >> 2 ) , 0 ) ;
if ( V_70 && V_2 -> V_36 ) {
V_33 >>= 11 ;
V_33 |= F_2 ( V_2 , 0x100 + V_38 + ( V_68 >> 2 ) , 0 ) << 20 ;
}
V_57 [ V_38 ] = V_33 ;
}
if ( F_13 ( V_66 , ( ( char * ) V_57 ) + ( V_68 & 3 ) , V_67 ) )
V_71 = - V_80 ;
else
V_71 = V_67 ;
F_14 ( V_57 ) ;
...
int V_89 ;
F_3 ( V_4 , L_142 ) ;
for( V_89 = 0 ; V_89 < 0x40 ; V_89 += 1 ) {
F_6 ( V_2 , V_89 , & V_50 ) ;
F_3 ( V_4 , L_143 , V_89 , V_50 , ( V_50 >> 8 ) & 0x7f ) ;
}
}
...
int V_89 ;
F_3 ( V_4 , L_144 ) ;
for( V_89 = 0 ; V_89 < 0x40 ; V_89 += 4 ) {
F_18 ( & V_2 -> V_91 , V_90 ) ;
V_50 = F_19 ( V_2 -> V_92 + V_89 ) ;
F_20 ( & V_2 -> V_91 , V_90 ) ;
F_3 ( V_4 , L_145 , V_89 , V_50 ) ;
}
}
...
struct V_3 * V_4 , int V_94 , int V_69 , int V_100 , int V_83 )
{
struct V_1 * V_2 = V_29 -> V_32 ;
unsigned long V_50 ;
int V_89 , V_101 ;
...
F_3 ( V_4 , L_148 , V_94 ) ;
for( V_89 = V_69 ; V_89 < V_69 + V_100 ; V_89 ++ ) {
F_3 ( V_4 , L_149 , V_89 ) ;
for ( V_101 = 0 ; V_101 < V_83 ; V_101 ++ ) {
if( V_94 == 0 )
V_50 = F_24 ( V_2 , 0 , V_89 , V_101 ) ;
else
V_50 = F_24 ( V_2 , 0x20 , V_89 , V_101 ) ;
F_3 ( V_4 , L_150 , V_50 ) ;
}
F_3 ( V_4 , L_118 ) ;
}
