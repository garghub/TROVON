...
( unsigned long ) V_142 ) ;
F_103 ( & V_142 -> V_129 , V_190 ) ;
V_142 -> V_140 = - 1 ;
V_186 = F_104 ( V_180 , V_191 , 0 ) ;
if ( ! V_186 ) {
F_41 ( V_33 , L_24 ) ;
V_107 = - V_192 ;
goto V_193;
...
V_187 = F_105 ( V_186 ) ;
V_142 -> V_140 = F_106 ( V_180 , 0 ) ;
if ( V_142 -> V_140 < 0 ) {
F_41 ( V_33 , L_25 ) ;
V_107 = V_142 -> V_140 ;
goto V_193;
}
V_107 = F_107 ( V_142 -> V_140 , F_80 , V_195 , L_26 ,
V_142 ) ;
if ( V_107 ) {
F_41 ( V_33 , L_27 ) ;
goto V_193;
}
V_142 -> V_117 = F_108 ( & V_180 -> V_33 , L_28 ) ;
if ( F_109 ( V_142 -> V_117 ) ) {
F_41 ( V_33 , L_29 ) ;
V_107 = F_110 ( V_142 -> V_117 ) ;
goto V_196;
}
V_142 -> V_4 = F_111 ( V_142 -> V_174 , V_187 ) ;
if ( ! V_142 -> V_4 ) {
F_41 ( V_33 , L_30 ) ;
V_107 = - V_167 ;
goto V_197;
...
static int F_121 ( struct V_179 * V_180 )
{
