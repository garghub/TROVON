...
static void F_61 ( struct V_8 * V_9 , struct V_5 * V_6 )
{
...
V_51 = F_65 ( & V_6 -> F_11 [ V_74 ] , 0 , V_81 ) ;
if ( V_51 )
goto V_51;
}
V_6 -> V_82 = 0 ;
...
int F_73 ( struct V_5 * V_6 , char * V_30 )
{
int V_51 ;
V_6 -> V_30 = V_30 ;
V_6 -> V_90 = 0 ;
...
void F_75 ( struct V_5 * V_6 , int V_92 )
{
enum V_93 V_94 ;
T_7 * V_95 = & V_96 [ V_92 ] ;
V_94 = V_92 ? V_97 : V_98 ;
...
void F_80 ( struct V_5 * V_6 , int V_92 )
{
enum V_93 V_94 ;
V_94 = V_92 ? V_97 : V_98 ;
if ( ! F_81 ( V_94 , & V_6 -> V_27 ) )
F_82 ( & V_99 [ V_92 ] ) ;
}
long F_83 ( int V_92 , long V_59 )
{
long V_41 ;
unsigned long V_100 = V_68 ;
F_84 ( V_101 ) ;
T_7 * V_95 = & V_96 [ V_92 ] ;
F_85 ( V_95 , & V_101 , V_102 ) ;
V_41 = F_86 ( V_59 ) ;
F_87 ( V_95 , & V_101 ) ;
F_88 ( F_89 ( V_59 ) ,
F_89 ( V_68 - V_100 ) ) ;
...
long F_90 ( struct V_103 * V_103 , int V_92 , long V_59 )
{
long V_41 ;
unsigned long V_100 = V_68 ;
F_84 ( V_101 ) ;
...
int F_94 ( struct V_107 * V_108 , int V_109 ,
...
if ( F_95 ( V_110 , V_113 , sizeof( V_113 ) ) )
return - V_114 ;
F_96 ( V_115 L_22 ,
V_108 -> V_116 ) ;
* V_111 = 2 ;
