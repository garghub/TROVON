...
static void F_5 ( unsigned long V_20 , unsigned long V_21 )
{
int V_22 ;
...
static void F_10 ( unsigned long V_25 , unsigned long V_21 ,
unsigned long V_26 ,
struct V_27 * V_28 )
{
int V_29 = 0 ;
...
unsigned long V_42 ;
unsigned long V_43 ;
F_19 (cur, &dm_device.ha_region_list) {
V_28 = F_20 ( V_41 , struct V_27 , V_44 ) ;
V_42 = ( unsigned long ) F_6 ( V_28 -> V_20 ) ;
V_43 = ( unsigned long ) F_6 ( V_28 -> V_35 ) ;
...
static bool F_21 ( unsigned long V_20 , unsigned long V_45 )
{
struct V_40 * V_41 ;
struct V_27 * V_28 ;
...
static unsigned long F_23 ( unsigned long V_50 ,
unsigned long V_51 )
{
...
F_10 ( V_28 -> V_34 , V_21 , V_45 , V_28 ) ;
}
return V_28 -> V_35 - V_53 ;
}
return 0 ;
}
static unsigned long F_25 ( unsigned long V_50 ,
unsigned long V_45 ,
unsigned long V_54 ,
unsigned long V_55 )
{
...
goto V_58;
if ( V_55 != 0 ) {
V_56 = F_26 ( sizeof( struct V_27 ) , V_59 ) ;
if ( ! V_56 )
return 0 ;
F_27 ( & V_56 -> V_44 ) ;
F_28 ( & V_56 -> V_44 , & V_8 . V_48 ) ;
V_56 -> V_20 = V_54 ;
V_56 -> V_34 = V_54 ;
V_56 -> V_35 = V_50 ;
V_56 -> V_49 = V_54 + V_55 ;
...
F_15 ( L_2 ) ;
V_66 -> V_80 = V_81 ;
V_63 . V_67 . V_82 = F_31 ( & V_82 ) ;
F_32 ( V_66 -> V_83 -> V_84 , & V_63 ,
sizeof( struct V_62 ) ,
( unsigned long ) NULL ,
V_85 , 0 ) ;
}
static void F_33 ( struct V_65 * V_66 , struct V_86 * V_87 )
{
struct V_88 * V_89 ;
...
{
unsigned long V_93 ;
#define F_35 ( T_1 ) ((mb) << (20 - PAGE_SHIFT))
if ( V_94 < F_35 ( 128 ) )
V_93 = F_35 ( 8 ) + ( V_94 >> 1 ) ;
else if ( V_94 < F_35 ( 512 ) )
V_93 = F_35 ( 40 ) + ( V_94 >> 2 ) ;
else if ( V_94 < F_35 ( 2048 ) )
V_93 = F_35 ( 104 ) + ( V_94 >> 3 ) ;
else if ( V_94 < F_35 ( 8192 ) )
V_93 = F_35 ( 232 ) + ( V_94 >> 4 ) ;
else
V_93 = F_35 ( 488 ) + ( V_94 >> 5 ) ;
#undef F_35
return V_93 ;
}
static void F_17 ( struct V_65 * V_66 )
{
struct V_95 V_96 ;
struct V_97 V_3 ;
...
F_34 () ;
if ( V_96 . V_67 . V_82 != F_39 ( & V_82 ) )
return;
if ( V_100 != V_101 )
return;
V_101 = V_99 ;
F_32 ( V_66 -> V_83 -> V_84 , & V_96 ,
sizeof( struct V_95 ) ,
( unsigned long ) NULL ,
V_85 , 0 ) ;
}
...
static unsigned int F_42 ( struct V_65 * V_66 ,
unsigned int V_110 ,
struct V_112 * V_113 ,
int V_114 )
{
...
do {
V_113 -> V_67 . V_82 = F_31 ( & V_82 ) ;
V_29 = F_32 ( V_8 . V_83 -> V_84 ,
V_113 ,
V_113 -> V_67 . V_21 ,
( unsigned long ) NULL ,
V_85 , 0 ) ;
...
F_32 ( V_8 . V_83 -> V_84 , & V_63 ,
sizeof( struct V_131 ) ,
( unsigned long ) NULL ,
V_85 , 0 ) ;
V_66 -> V_80 = V_81 ;
}
static int F_51 ( void * V_134 )
{
...
V_138 . V_67 . V_82 = F_31 ( & V_82 ) ;
V_138 . V_144 . V_144 = V_145 ;
V_138 . V_146 = 1 ;
V_29 = F_32 ( V_66 -> V_83 -> V_84 , & V_138 ,
sizeof( struct V_137 ) ,
( unsigned long ) NULL ,
V_85 , 0 ) ;
if ( V_29 )
...
struct V_153 * V_154 ;
struct V_155 * V_156 ;
struct V_65 * V_66 = F_58 ( V_83 ) ;
struct V_157 * V_158 ;
struct V_159 * V_160 ;
union V_108 * V_161 ;
union V_108 * V_56 ;
memset ( V_162 , 0 , sizeof( V_162 ) ) ;
F_59 ( V_83 -> V_84 , V_162 ,
V_115 , & V_151 , & V_152 ) ;
if ( V_151 > 0 ) {
...
break;
case V_174 :
F_33 ( V_66 , (struct V_86 * ) V_154 ) ;
break;
default:
F_62 ( L_10 , V_156 -> type ) ;
}
}
}
static int F_63 ( struct V_150 * V_83 ,
...
struct V_178 V_179 ;
V_38 = V_180 ;
V_125 = F_64 ( V_115 , V_59 ) ;
if ( ! V_125 )
return - V_181 ;
V_29 = F_65 ( V_83 -> V_84 , V_182 , V_182 , NULL , 0 ,
F_57 , V_83 ) ;
if ( V_29 )
goto V_183;
V_8 . V_83 = V_83 ;
...
F_27 ( & V_8 . V_48 ) ;
F_66 ( & V_8 . V_9 ) ;
F_67 ( & V_8 . V_121 . V_167 , F_47 ) ;
F_67 ( & V_8 . V_69 . V_167 , F_29 ) ;
V_8 . V_57 = false ;
V_8 . V_185 =
F_68 ( F_51 , & V_8 , L_11 ) ;
if ( F_69 ( V_8 . V_185 ) ) {
...
V_138 . V_146 = 0 ;
V_29 = F_32 ( V_83 -> V_84 , & V_138 ,
sizeof( struct V_137 ) ,
( unsigned long ) NULL ,
V_85 , 0 ) ;
if ( V_29 )
goto V_189;
V_177 = F_16 ( & V_8 . V_140 , 5 * V_39 ) ;
if ( V_177 == 0 ) {
V_29 = - V_190 ;
goto V_189;
}
...
static int F_78 ( struct V_150 * V_83 )
{
struct V_65 * V_66 = F_58 ( V_83 ) ;
struct V_40 * V_41 , * V_198 ;
struct V_27 * V_28 ;
if ( V_66 -> V_107 != 0 )
F_60 ( L_12 , V_66 -> V_107 ) ;
F_79 ( & V_66 -> V_121 . V_167 ) ;
F_79 ( & V_66 -> V_69 . V_167 ) ;
F_76 ( V_83 -> V_84 ) ;
F_75 ( V_66 -> V_185 ) ;
F_77 ( V_125 ) ;
#ifdef F_30
...
F_80 ( & V_187 ) ;
#endif
F_81 (cur, tmp, &dm->ha_region_list) {
V_28 = F_20 ( V_41 , struct V_27 , V_44 ) ;
F_82 ( & V_28 -> V_44 ) ;
F_77 ( V_28 ) ;
}
