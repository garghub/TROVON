...
F_29 ( V_10 , V_35 ) ;
F_17 ( V_39 , V_32 ) ;
V_42 = F_30 ( & V_35 -> V_10 . V_51 , & V_10 -> V_51 ,
V_39 ) ;
if ( V_42 )
F_31 ( & V_35 -> V_10 , L_7 ,
V_39 , V_42 ) ;
V_42 = F_30 ( & V_10 -> V_51 , & V_35 -> V_10 . V_51 ,
L_8 ) ;
if ( V_42 )
F_31 ( V_10 , L_9 ,
V_42 ) ;
...
if ( type && type -> V_58 )
type -> V_58 ( V_10 ) ;
else if ( V_14 -> V_59 && V_14 -> V_59 -> V_60 )
V_14 -> V_59 -> V_60 ( V_10 ) ;
V_57:
#if V_61
if ( ! V_12 ) {
struct V_62 V_63 = { V_64 , NULL } ;
F_39 ( F_40 ( V_10 ) , V_65 , & V_63 ) ;
F_37 ( L_11 , F_38 ( V_10 ) , ( char * ) V_63 . V_66 ) ;
F_26 ( V_63 . V_66 ) ;
} else
F_37 ( L_12 , F_38 ( V_10 ) ) ;
#endif
...
if ( type && type -> V_67 )
type -> V_67 ( V_10 ) ;
else if ( V_14 -> V_59 && V_14 -> V_59 -> V_68 )
V_14 -> V_59 -> V_68 ( V_10 ) ;
F_33 ( V_10 ) ;
return 0 ;
}
