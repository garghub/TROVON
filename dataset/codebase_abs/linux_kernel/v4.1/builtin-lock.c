...
static int F_57 ( int V_120 , const char * * V_121 )
{
const char * V_122 [] = {
L_40 , L_41 , L_42 , L_43 , L_44 , L_45 ,
} ;
unsigned int V_123 , V_22 , V_124 , V_32 ;
const char * * V_125 ;
for ( V_22 = 0 ; V_22 < F_58 ( V_119 ) ; V_22 ++ ) {
if ( ! F_59 ( V_119 [ V_22 ] . V_24 ) ) {
F_9 ( L_46
L_47 ,
V_119 [ V_22 ] . V_24 ) ;
return 1 ;
...
V_123 = F_58 ( V_122 ) + V_120 - 1 ;
V_123 += 2 * F_58 ( V_119 ) ;
V_125 = calloc ( V_123 + 1 , sizeof( char * ) ) ;
if ( ! V_125 )
return - V_48 ;
for ( V_22 = 0 ; V_22 < F_58 ( V_122 ) ; V_22 ++ )
V_125 [ V_22 ] = F_60 ( V_122 [ V_22 ] ) ;
for ( V_124 = 0 ; V_124 < F_58 ( V_119 ) ; V_124 ++ ) {
V_125 [ V_22 ++ ] = L_48 ;
V_125 [ V_22 ++ ] = F_60 ( V_119 [ V_124 ] . V_24 ) ;
}
for ( V_124 = 1 ; V_124 < ( unsigned int ) V_120 ; V_124 ++ , V_22 ++ )
V_125 [ V_22 ] = V_121 [ V_124 ] ;
F_4 ( V_22 != V_123 ) ;
V_32 = F_61 ( V_22 , V_125 , NULL ) ;
free ( V_125 ) ;
return V_32 ;
}
int F_62 ( int V_120 , const char * * V_121 , const char * T_5 V_95 )
{
...
F_63 ( 'm' , L_51 , & V_93 ,
L_52 ) ,
F_63 ( 'f' , L_53 , & V_116 , L_54 ) ,
F_64 ()
} ;
const struct V_126 V_128 [] = {
F_65 ( 'i' , L_55 , & V_113 , L_56 , L_57 ) ,
F_66 ( 'v' , L_58 , & V_129 , L_59 ) ,
F_63 ( 'D' , L_60 , & V_130 , L_61 ) ,
F_64 ()
} ;
const struct V_126 V_131 [] = {
F_65 ( 'k' , L_62 , & V_25 , L_9 ,
L_63 ) ,
F_63 ( 'f' , L_53 , & V_116 , L_54 ) ,
F_64 ()
} ;
...
const char * const V_133 [] = { L_40 , L_65 , L_66 ,
L_67 , NULL } ;
const char * V_134 [] = {
NULL ,
NULL
...
for ( V_22 = 0 ; V_22 < V_90 ; V_22 ++ )
F_10 ( V_136 + V_22 ) ;
V_120 = F_67 ( V_120 , V_121 , V_128 , V_133 ,
V_134 , V_137 ) ;
if ( ! V_120 )
F_68 ( V_134 , V_128 ) ;
if ( ! strncmp ( V_121 [ 0 ] , L_69 , 3 ) ) {
return F_57 ( V_120 , V_121 ) ;
} else if ( ! strncmp ( V_121 [ 0 ] , L_65 , 6 ) ) {
V_77 = & V_138 ;
if ( V_120 ) {
V_120 = F_69 ( V_120 , V_121 ,
V_131 , V_135 , 0 ) ;
if ( V_120 )
F_68 ( V_135 , V_131 ) ;
}
V_91 = F_49 ( false ) ;
} else if ( ! strcmp ( V_121 [ 0 ] , L_66 ) ) {
return F_70 ( V_120 , V_121 , T_5 ) ;
} else if ( ! strcmp ( V_121 [ 0 ] , L_67 ) ) {
if ( V_120 ) {
V_120 = F_69 ( V_120 , V_121 ,
V_127 , V_132 , 0 ) ;
if ( V_120 )
