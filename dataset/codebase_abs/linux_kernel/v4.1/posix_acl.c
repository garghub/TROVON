...
static int
F_65 ( struct V_99 * V_99 , const char * V_100 ,
const void * V_79 , T_2 V_19 , int V_18 , int type )
{
struct V_2 * V_2 = F_63 ( V_99 ) ;
struct V_1 * V_8 = NULL ;
int V_65 ;
if ( ! F_16 ( V_2 ) )
return - V_67 ;
...
static T_2
F_67 ( struct V_99 * V_99 , char * V_105 , T_2 V_106 ,
const char * V_100 , T_2 V_107 , int type )
{
const char * V_108 ;
T_2 V_19 ;
if ( ! F_16 ( F_63 ( V_99 ) ) )
...
V_19 = strlen ( V_108 ) + 1 ;
if ( V_105 && V_19 <= V_106 )
memcpy ( V_105 , V_108 , V_19 ) ;
return V_19 ;
}
int F_68 ( struct V_2 * V_2 , struct V_1 * V_8 , int type )
{
int error ;
if ( type == V_3 ) {
error = F_27 ( V_8 , & V_2 -> V_102 ) ;
if ( error < 0 )
return 0 ;
if ( error == 0 )
V_8 = NULL ;
...
int F_69 ( struct V_2 * V_69 , struct V_2 * V_2 )
{
struct V_1 * V_70 , * V_8 ;
int error ;
error = F_41 ( V_69 , & V_2 -> V_102 , & V_70 , & V_8 ) ;
if ( error )
return error ;
F_10 ( V_2 , V_5 , V_70 ) ;
F_10 ( V_2 , V_3 , V_8 ) ;
