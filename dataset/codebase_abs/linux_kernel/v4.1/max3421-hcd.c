...
V_205 |= F_30 ( V_6 ) ;
if ( F_72 ( V_213 , & V_4 -> V_171 ) )
V_205 |= F_64 ( V_6 ) ;
if ( F_72 ( V_214 , & V_4 -> V_171 ) ) {
F_11 ( V_6 , V_57 ,
F_15 ( V_215 ) ) ;
V_205 = 1 ;
}
if ( F_72 ( V_216 , & V_4 -> V_171 ) )
V_205 |= F_41 ( V_6 ) ;
if ( F_72 ( V_217 , & V_4 -> V_171 ) ) {
for ( V_188 = 0 ; V_188 < F_76 ( V_4 -> V_218 ) ; ++ V_188 ) {
...
static int
F_84 ( struct V_5 * V_6 , struct V_60 * V_60 , T_7 V_230 )
{
struct V_9 * V_10 = F_6 ( V_6 -> V_11 . V_12 ) ;
struct V_4 * V_4 = F_2 ( V_6 ) ;
struct V_82 * V_82 ;
...
V_82 = V_60 -> V_85 -> V_86 ;
if ( ! V_82 ) {
V_82 = F_85 ( sizeof( struct V_82 ) , V_233 ) ;
if ( ! V_82 ) {
V_119 = - V_234 ;
goto V_235;
}
...
static int
F_88 ( struct V_5 * V_6 , struct V_60 * V_60 , int V_204 )
{
struct V_4 * V_4 = F_2 ( V_6 ) ;
unsigned long V_98 ;
int V_119 ;
F_31 ( & V_4 -> V_99 , V_98 ) ;
V_119 = F_89 ( V_6 , V_60 , V_204 ) ;
if ( V_119 == 0 ) {
F_78 ( V_216 , & V_4 -> V_171 ) ;
F_57 ( V_4 -> V_167 ) ;
}
F_37 ( & V_4 -> V_99 , V_98 ) ;
return V_119 ;
...
static void
F_90 ( struct V_5 * V_6 , struct V_95 * V_85 )
{
struct V_4 * V_4 = F_2 ( V_6 ) ;
unsigned long V_98 ;
F_31 ( & V_4 -> V_99 , V_98 ) ;
...
static inline void
F_97 ( struct V_238 * V_103 )
{
memset ( V_103 , 0 , sizeof( * V_103 ) ) ;
V_103 -> V_239 = V_240 ;
V_103 -> V_241 = 9 ;
V_103 -> V_242 = F_98 ( V_243 |
V_244 ) ;
V_103 -> V_245 = 1 ;
}
static void
F_99 ( struct V_5 * V_6 , T_3 V_246 , T_3 V_247 )
{
struct V_4 * V_4 = F_2 ( V_6 ) ;
T_3 V_248 , V_249 ;
-- V_246 ;
...
V_249 = V_246 / 4 ;
if ( V_247 )
V_4 -> V_218 [ V_249 ] |= V_248 ;
else
V_4 -> V_218 [ V_249 ] &= ~ V_248 ;
F_78 ( V_217 , & V_4 -> V_171 ) ;
F_57 ( V_4 -> V_167 ) ;
}
static int
F_100 ( struct V_5 * V_6 , T_2 V_250 , T_2 V_247 , T_2 V_251 ,
char * V_28 , T_2 V_252 )
{
struct V_9 * V_10 = F_6 ( V_6 -> V_11 . V_12 ) ;
struct V_4 * V_4 = F_2 ( V_6 ) ;
...
static int
F_104 ( struct V_5 * V_6 , struct V_60 * V_60 , T_7 V_230 )
{
return 0 ;
}
static void
F_105 ( struct V_5 * V_6 , struct V_60 * V_60 )
{
}
static int
...
V_286 = V_4 ;
F_82 ( & V_4 -> V_102 ) ;
V_4 -> V_17 = F_110 ( sizeof( * V_4 -> V_17 ) , V_287 ) ;
if ( ! V_4 -> V_17 ) {
F_26 ( & V_10 -> V_30 , L_24 ) ;
goto error;
}
V_4 -> V_24 = F_110 ( sizeof( * V_4 -> V_24 ) , V_287 ) ;
if ( ! V_4 -> V_24 ) {
F_26 ( & V_10 -> V_30 , L_25 ) ;
goto error;
}
V_4 -> V_167 = F_111 ( F_67 , V_6 ,
L_26 ) ;
if ( V_4 -> V_167 == F_112 ( - V_234 ) ) {
F_26 ( & V_10 -> V_30 ,
L_27 ) ;
goto error;
}
...
{
struct V_4 * V_4 = NULL , * * V_289 ;
struct V_5 * V_6 = NULL ;
unsigned long V_98 ;
for ( V_289 = & V_286 ; * V_289 ; V_289 = & ( * V_289 ) -> V_285 ) {
V_4 = * V_289 ;
V_6 = F_3 ( V_4 ) ;
