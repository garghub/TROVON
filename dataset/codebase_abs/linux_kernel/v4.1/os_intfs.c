...
F_20 ( & V_2 -> V_96 . V_105 ) ;
F_20 ( & V_2 -> V_96 . V_100 ) ;
F_20 ( & V_2 -> V_96 . V_97 . V_98 ) ;
}
static V_11 F_21 ( struct V_1 * V_2 )
{
V_11 V_106 = V_6 ;
struct V_7 * V_107 = & V_2 -> V_9 ;
struct V_62 * V_63 = & V_2 -> V_64 ;
struct V_108 * V_109 = & V_2 -> V_96 ;
...
V_11 F_24 ( struct V_1 * V_2 )
{
if ( ( F_25 ( & V_2 -> V_92 ) ) == V_91 )
return V_91 ;
V_2 -> V_92 . V_2 = V_2 ;
if ( ( F_26 ( & V_2 -> V_125 ) ) == V_91 )
return V_91 ;
if ( F_27 ( V_2 ) == V_91 )
return V_91 ;
F_28 ( & V_2 -> V_64 , V_2 ) ;
...
static void F_47 ( struct V_1 * V_2 , int V_128 )
{
