...
V_57 = F_17 ( & V_2 -> V_4 , V_49 ,
V_30 , V_60 -> V_58 ) ;
if ( V_60 -> V_6 || V_60 -> V_51 != V_57 -> V_51 )
return - V_56 ;
if ( V_60 -> V_55 == V_30 ) {
V_60 -> V_61 = V_18 ;
V_60 -> V_62 = V_20 ;
...
F_7 ( V_57 -> V_32 , & V_60 -> V_61 ,
& V_60 -> V_62 ) ;
F_7 ( V_57 -> V_33 , & V_60 -> V_63 ,
& V_60 -> V_64 ) ;
}
return 0 ;
}
...
{
struct V_1 * V_2 = F_13 ( V_23 ) ;
V_66 -> V_57 = * F_17 ( & V_2 -> V_4 , V_49 , V_66 -> V_55 ,
V_66 -> V_58 ) ;
return 0 ;
}
...
V_66 -> V_51 != V_54 )
V_66 -> V_51 = V_54 ;
V_66 -> V_32 = F_21 ( V_66 -> V_32 , V_18 , V_20 ) ;
V_66 -> V_33 = F_21 ( V_66 -> V_33 , V_18 , V_20 ) ;
break;
case V_31 :
V_57 = F_17 ( & V_2 -> V_4 , V_49 ,
V_30 , V_58 ) ;
...
V_66 -> V_32 = F_21 ( V_66 -> V_32 , V_15 , V_16 ) ;
F_7 ( V_57 -> V_33 , & V_15 , & V_16 ) ;
V_66 -> V_33 = F_21 ( V_66 -> V_33 , V_15 , V_16 ) ;
break;
}
V_66 -> V_68 = V_69 ;
V_66 -> V_70 = V_71 ;
}
static int F_22 ( struct V_22 * V_23 , struct V_48 * V_49 ,
struct V_65 * V_66 )
{
struct V_1 * V_2 = F_13 ( V_23 ) ;
struct V_25 * V_57 ;
F_20 ( V_2 , V_49 , V_66 -> V_55 , & V_66 -> V_57 , V_66 -> V_58 ) ;
V_57 = F_17 ( & V_2 -> V_4 , V_49 , V_66 -> V_55 ,
V_66 -> V_58 ) ;
* V_57 = V_66 -> V_57 ;
if ( V_66 -> V_55 == V_30 ) {
V_57 = F_17 ( & V_2 -> V_4 , V_49 ,
V_31 , V_66 -> V_58 ) ;
* V_57 = V_66 -> V_57 ;
F_20 ( V_2 , V_49 , V_31 , V_57 , V_66 -> V_58 ) ;
}
return 0 ;
}
struct V_1 * F_23 ( struct V_72 * V_5 , unsigned int V_6 )
{
struct V_22 * V_23 ;
struct V_1 * V_2 ;
int V_73 ;
V_2 = F_24 ( V_5 -> V_34 , sizeof( * V_2 ) , V_74 ) ;
if ( V_2 == NULL )
return F_25 ( - V_75 ) ;
V_2 -> V_4 . type = V_76 ;
V_2 -> V_4 . V_6 = V_6 ;
V_73 = F_26 ( V_5 , & V_2 -> V_4 , 2 ) ;
if ( V_73 < 0 )
return F_25 ( V_73 ) ;
V_23 = & V_2 -> V_4 . V_23 ;
F_27 ( V_23 , & V_77 ) ;
