...
V_26 = F_91 ( V_13 , V_28 , V_101 ) ;
if ( V_26 )
return V_26 ;
V_100 = F_92 ( V_13 -> V_85 , V_28 , V_101 ) ;
V_76 = V_101 ;
while ( 1 ) {
V_77 = F_93 ( V_13 , V_76 ) ;
if ( ! V_77 )
...
if ( V_77 ) {
V_15 = F_1 ( V_77 ) ;
if ( F_57 ( V_106 , & V_77 -> V_37 ) )
V_15 = F_41 ( V_15 ,
V_77 -> V_3 +
V_77 -> V_42 ) ;
} else {
V_15 = F_98 ( V_15 , F_16 ( V_13 ) -> V_7 -> V_107 ) ;
}
...
V_104 = F_99 ( T_1 , V_15 , V_105 ) ;
if ( V_77 && V_77 -> V_108 > V_104 )
V_104 = F_99 ( T_1 , V_77 -> V_108 , V_105 ) ;
F_16 ( V_13 ) -> V_103 = V_104 ;
V_26 = 0 ;
V_71:
if ( V_77 )
F_19 ( V_109 , & V_77 -> V_37 ) ;
F_26 ( & V_25 -> V_54 ) ;
return V_26 ;
}
int F_100 ( struct V_13 * V_13 , T_1 V_15 , T_1 V_110 ,
T_3 * V_64 , int V_4 )
{
struct V_63 * V_111 ;
struct V_1 * V_77 ;
...
if ( V_110 >= V_111 -> V_114 &&
V_110 < V_111 -> V_114 + V_111 -> V_4 ) {
V_113 = ( V_110 - V_111 -> V_114 ) >>
V_13 -> V_18 -> V_115 ;
V_112 = V_111 -> V_4 >>
V_13 -> V_18 -> V_115 ;
V_112 = F_99 ( int , V_4 - V_79 , V_112 - V_113 ) ;
memcpy ( V_64 + V_79 , V_111 -> V_116 + V_113 ,
V_112 ) ;
V_79 += ( int ) V_112 ;
if ( V_79 == V_4 )
goto V_71;
