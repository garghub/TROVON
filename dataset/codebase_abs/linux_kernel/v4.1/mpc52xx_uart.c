...
static void
F_119 ( struct V_8 * V_9 , int V_113 )
{
unsigned long V_114 ;
F_120 ( & V_9 -> V_115 , V_114 ) ;
if ( V_113 == - 1 )
V_97 -> V_13 ( V_9 , V_116 ) ;
else
V_97 -> V_13 ( V_9 , V_117 ) ;
F_121 ( & V_9 -> V_115 , V_114 ) ;
}
static int
...
static void
F_126 ( struct V_8 * V_9 , struct V_44 * V_45 ,
struct V_44 * V_46 )
{
unsigned long V_114 ;
...
V_97 -> V_13 ( V_9 , V_119 ) ;
V_97 -> V_13 ( V_9 , V_120 ) ;
V_97 -> V_153 ( V_9 , V_14 , V_15 ) ;
V_47 = V_97 -> V_154 ( V_9 , V_45 , V_46 ) ;
F_129 ( V_9 , V_45 -> V_128 , V_47 ) ;
if ( F_130 ( V_9 , V_45 -> V_128 ) )
F_118 ( V_9 ) ;
V_97 -> V_13 ( V_9 , V_123 ) ;
V_97 -> V_13 ( V_9 , V_124 ) ;
F_121 ( & V_9 -> V_115 , V_114 ) ;
...
{
return V_9 -> type == V_155 ? L_21 : NULL ;
}
static void
...
F_133 ( V_9 -> V_86 , sizeof( struct V_1 ) ) ;
}
static int
...
int V_72 ;
if ( V_9 -> V_114 & V_157 )
V_9 -> V_158 = F_135 ( V_9 -> V_86 ,
sizeof( struct V_1 ) ) ;
if ( ! V_9 -> V_158 )
return - V_159 ;
V_72 = F_136 ( V_9 -> V_86 , sizeof( struct V_1 ) ,
L_17 ) != NULL ? 0 : - V_160 ;
if ( V_72 )
goto V_161;
if ( V_97 -> V_162 ) {
...
static void
F_137 ( struct V_8 * V_9 , int V_114 )
{
if ( ( V_114 & V_164 )
&& ( F_134 ( V_9 ) == 0 ) )
V_9 -> type = V_155 ;
...
static int
F_138 ( struct V_8 * V_9 , struct V_165 * V_166 )
{
if ( V_166 -> type != V_167 && V_166 -> type != V_155 )
return - V_159 ;
if ( ( V_166 -> V_52 != V_9 -> V_52 ) ||
( V_166 -> V_168 != V_169 ) ||
( V_166 -> V_170 != V_9 -> V_48 ) ||
( V_166 -> V_171 != ( void * ) V_9 -> V_86 ) ||
( V_166 -> V_172 != 0 ) )
return - V_159 ;
return 0 ;
}
...
{
struct V_173 * V_174 = & V_9 -> V_18 -> V_9 ;
unsigned char V_175 , V_176 ;
unsigned short V_103 ;
while ( V_97 -> V_177 ( V_9 ) ) {
V_175 = V_97 -> V_178 ( V_9 ) ;
#ifdef F_140
if ( F_141 ( V_9 , V_175 ) ) {
V_9 -> V_179 = 0 ;
continue;
...
F_145 ( V_174 ) ;
F_146 ( & V_9 -> V_115 ) ;
return V_97 -> V_177 ( V_9 ) ;
}
static inline int
F_147 ( struct V_8 * V_9 )
{
struct V_197 * V_198 = & V_9 -> V_18 -> V_198 ;
if ( V_9 -> V_199 ) {
V_97 -> V_200 ( V_9 , V_9 -> V_199 ) ;
V_9 -> V_181 . V_201 ++ ;
V_9 -> V_199 = 0 ;
return 1 ;
}
if ( F_148 ( V_198 ) || F_149 ( V_9 ) ) {
F_115 ( V_9 ) ;
return 0 ;
}
while ( V_97 -> V_202 ( V_9 ) ) {
V_97 -> V_200 ( V_9 , V_198 -> V_203 [ V_198 -> V_204 ] ) ;
V_198 -> V_204 = ( V_198 -> V_204 + 1 ) & ( V_205 - 1 ) ;
V_9 -> V_181 . V_201 ++ ;
if ( F_148 ( V_198 ) )
break;
}
if ( F_150 ( V_198 ) < V_206 )
F_151 ( V_9 ) ;
if ( F_148 ( V_198 ) ) {
F_115 ( V_9 ) ;
return 0 ;
...
if ( V_103 & V_214 )
F_152 ( V_9 , ! ( V_103 & V_107 ) ) ;
if ( V_103 & V_215 )
F_153 ( V_9 , ! ( V_103 & V_105 ) ) ;
if ( ! ( -- V_207 ) )
V_209 = 0 ;
} while ( V_209 );
return V_216 ;
...
int * V_47 , int * V_190 , int * V_219 , int * V_220 )
{
unsigned char V_14 ;
F_155 ( L_22 , V_9 ) ;
V_14 = V_97 -> V_221 ( V_9 ) ;
...
* V_190 = V_14 & V_142 ? 'o' : 'e' ;
}
static void
F_156 ( struct V_224 * V_225 , const char * V_226 , unsigned int V_227 )
{
struct V_8 * V_9 = & V_228 [ V_225 -> V_229 ] ;
unsigned int V_230 , V_127 ;
V_97 -> V_126 ( V_9 ) ;
V_127 = 5000000 ;
while ( ! F_112 ( V_9 ) && -- V_127 )
F_127 ( 1 ) ;
...
static int T_6
F_157 ( struct V_224 * V_225 , char * V_232 )
{
struct V_8 * V_9 = & V_228 [ V_225 -> V_229 ] ;
...
F_155 ( L_24 , V_225 -> V_229 ) ;
return - V_159 ;
}
if ( ! V_50 ) {
F_155 ( L_25 , V_225 -> V_229 ) ;
return - V_159 ;
}
F_155 ( L_26 ,
V_225 -> V_229 , V_233 [ V_225 -> V_229 ] -> V_237 ) ;
V_93 = F_158 ( V_50 , 0 , & V_235 ) ;
if ( V_93 ) {
F_155 ( L_27 , V_225 -> V_229 ) ;
return V_93 ;
}
V_48 = F_159 ( V_50 ) ;
if ( V_48 == 0 ) {
...
V_9 -> V_158 = F_135 ( V_235 . V_240 , sizeof( struct V_1 ) ) ;
V_9 -> V_52 = F_37 ( V_50 , 0 ) ;
if ( V_9 -> V_158 == NULL )
return - V_159 ;
F_155 ( L_29 ,
( void * ) V_9 -> V_86 , V_9 -> V_158 ,
V_9 -> V_52 , V_9 -> V_48 ) ;
if ( V_232 )
F_161 ( V_232 , & V_47 , & V_190 , & V_219 , & V_220 ) ;
else
F_154 ( V_9 , & V_47 , & V_190 , & V_219 , & V_220 ) ;
F_155 ( L_30 ,
V_47 , V_219 , V_190 , V_220 ) ;
return F_162 ( V_9 , V_225 , V_47 , V_190 , V_219 , V_220 ) ;
}
static int T_6
F_163 ( void )
{
...
static int F_166 ( struct V_242 * V_243 )
{
int V_244 = - 1 ;
unsigned int V_48 ;
struct V_8 * V_9 = NULL ;
...
V_9 -> V_238 = & V_239 ;
V_9 -> V_88 = & V_243 -> V_88 ;
V_93 = F_158 ( V_243 -> V_88 . V_245 , 0 , & V_235 ) ;
if ( V_93 )
return V_93 ;
V_9 -> V_86 = V_235 . V_240 ;
if ( ! V_9 -> V_86 ) {
...
V_93 = F_167 ( & V_250 , V_9 ) ;
if ( V_93 )
return V_93 ;
F_168 ( V_243 , ( void * ) V_9 ) ;
return 0 ;
}
static int
F_169 ( struct V_242 * V_243 )
{
struct V_8 * V_9 = F_170 ( V_243 ) ;
if ( V_9 )
F_171 ( & V_250 , V_9 ) ;
return 0 ;
}
static int
F_172 ( struct V_242 * V_243 , T_8 V_18 )
{
struct V_8 * V_9 = F_170 ( V_243 ) ;
if ( V_9 )
F_173 ( & V_250 , V_9 ) ;
