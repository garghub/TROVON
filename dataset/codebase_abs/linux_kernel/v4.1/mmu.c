...
{
struct V_346 * V_413 = & V_34 -> V_35 . V_329 ;
V_413 -> V_318 = V_318 ;
V_413 -> V_321 = V_401 ;
V_413 -> F_301 = V_402 ;
if ( ! F_320 ( V_34 ) ) {
...
++ V_34 -> V_11 -> V_132 . V_418 ;
V_34 -> V_35 . V_189 . V_351 ( V_34 , V_49 , V_10 , V_416 ) ;
}
static bool F_332 ( T_1 V_419 , T_1 V_416 )
{
if ( ! F_22 ( V_419 ) )
return false ;
if ( ! F_22 ( V_416 ) )
...
static void F_333 ( struct V_33 * V_34 , bool V_421 ,
...
T_1 V_425 ;
int V_81 ;
if ( F_170 ( V_34 ) && * V_424 == 4 ) {
* V_345 &= ~ ( T_9 ) 7 ;
* V_424 = 8 ;
V_81 = F_335 ( V_34 -> V_11 , * V_345 , & V_425 , 8 ) ;
if ( V_81 )
V_425 = 0 ;
...
F_220 ( L_27 ,
V_345 , V_424 , V_49 -> V_91 . V_215 ) ;
V_426 = F_338 ( V_345 ) ;
V_427 = V_49 -> V_91 . V_188 ? 8 : 4 ;
...
static T_1 * F_339 ( struct V_48 * V_49 , T_9 V_345 , int * V_429 )
{
...
V_10 = & V_49 -> V_128 [ V_430 / sizeof( * V_10 ) ] ;
return V_10 ;
}
...
F_220 ( L_28 , V_161 , V_345 , V_424 ) ;
V_425 = F_334 ( V_34 , & V_345 , V_416 , & V_424 ) ;
F_69 ( V_34 ) ;
F_217 ( & V_34 -> V_11 -> V_201 ) ;
++ V_34 -> V_11 -> V_132 . V_433 ;
F_176 ( V_34 , V_434 ) ;
F_180 (vcpu->kvm, sp, gfn) {
if ( F_337 ( V_49 , V_345 , V_424 ) ||
F_336 ( V_49 ) ) {
V_421 |= ! ! F_171 ( V_34 -> V_11 , V_49 ,
& V_186 ) ;
++ V_34 -> V_11 -> V_132 . V_435 ;
continue;
}
V_10 = F_339 ( V_49 , V_345 , & V_432 ) ;
if ( ! V_10 )
continue;
V_423 = true ;
while ( V_432 -- ) {
...
& V_4 . V_215 ) && F_99 ( V_34 ) )
F_331 ( V_34 , V_49 , V_10 , & V_425 ) ;
if ( F_332 ( V_431 , * V_10 ) )
V_422 = true ;
++ V_10 ;
}
}
F_333 ( V_34 , V_421 , V_422 , V_423 ) ;
F_175 ( V_34 -> V_11 , & V_186 ) ;
F_176 ( V_34 , V_436 ) ;
F_218 ( & V_34 -> V_11 -> V_201 ) ;
}
...
{
F_174 ( V_186 ) ;
if ( F_18 ( F_343 ( V_34 -> V_11 ) >= V_437 ) )
return;
while ( F_343 ( V_34 -> V_11 ) < V_438 ) {
if ( ! F_214 ( V_34 -> V_11 , & V_186 ) )
break;
++ V_34 -> V_11 -> V_132 . V_439 ;
}
F_175 ( V_34 -> V_11 , & V_186 ) ;
}
...
int F_345 ( struct V_33 * V_34 , T_7 V_440 , T_4 V_305 ,
void * V_441 , int V_442 )
{
int V_81 , V_443 = V_444 ;
enum V_445 V_446 ;
V_81 = V_34 -> V_35 . V_189 . V_348 ( V_34 , V_440 , V_305 , false ) ;
if ( V_81 < 0 )
goto V_85;
if ( ! V_81 ) {
V_81 = 1 ;
...
if ( F_344 ( V_34 , V_440 ) )
V_443 = 0 ;
V_446 = F_346 ( V_34 , V_440 , V_443 , V_441 , V_442 ) ;
switch ( V_446 ) {
case V_447 :
return 1 ;
case V_448 :
...
{
V_34 -> V_35 . V_452 = & V_34 -> V_35 . V_189 ;
V_34 -> V_35 . V_189 . V_223 = V_313 ;
V_34 -> V_35 . V_189 . V_330 = V_330 ;
V_34 -> V_35 . V_329 . V_330 = V_453 ;
return F_351 ( V_34 ) ;
}
...
int V_102 ;
bool V_136 = false ;
V_454 = V_148 -> V_99 + V_148 -> V_154 - 1 ;
F_217 ( & V_11 -> V_201 ) ;
for ( V_102 = V_42 ;
V_102 < V_42 + V_104 ; ++ V_102 ) {
unsigned long * V_127 ;
unsigned long V_455 , V_90 ;
V_127 = V_148 -> V_35 . V_126 [ V_102 - V_42 ] ;
V_455 = F_78 ( V_454 , V_148 -> V_99 , V_102 ) ;
for ( V_90 = 0 ; V_90 <= V_455 ; ++ V_90 , ++ V_127 ) {
if ( * V_127 )
...
static bool F_360 ( struct V_11 * V_11 ,
unsigned long * V_127 )
{
T_1 * V_13 ;
struct V_129 V_130 ;
...
unsigned long V_455 , V_90 ;
F_217 ( & V_11 -> V_201 ) ;
V_127 = V_148 -> V_35 . V_126 [ 0 ] ;
V_455 = F_78 ( V_148 -> V_99 + V_148 -> V_154 - 1 ,
V_148 -> V_99 , V_42 ) ;
for ( V_90 = 0 ; V_90 <= V_455 ; ++ V_90 , ++ V_127 ) {
if ( * V_127 )
V_136 |= F_360 ( V_11 , V_127 ) ;
if ( F_357 () || F_358 ( & V_11 -> V_201 ) ) {
if ( V_136 ) {
F_107 ( V_11 ) ;
V_136 = false ;
...
static void F_365 ( struct V_11 * V_11 )
{
struct V_48 * V_49 , * V_457 ;
int V_458 = 0 ;
V_459:
F_366 (sp, node,
...
F_175 ( V_11 , & V_11 -> V_35 . V_461 ) ;
}
void F_367 ( struct V_11 * V_11 )
{
F_217 ( & V_11 -> V_201 ) ;
F_368 ( V_11 ) ;
V_11 -> V_35 . V_204 ++ ;
...
static bool F_369 ( struct V_11 * V_11 )
{
return F_14 ( ! F_370 ( & V_11 -> V_35 . V_461 ) ) ;
}
void F_371 ( struct V_11 * V_11 )
{
if ( F_14 ( F_5 ( V_11 ) == 0 ) ) {
F_372 ( V_462 L_29 ) ;
F_367 ( V_11 ) ;
...
F_373 ( struct V_463 * V_464 , struct V_465 * V_466 )
{
struct V_11 * V_11 ;
int V_467 = V_466 -> V_467 ;
unsigned long V_468 = 0 ;
F_217 ( & V_469 ) ;
F_374 (kvm, &vm_list, vm_list) {
int V_98 ;
F_174 ( V_186 ) ;
if ( ! V_467 -- )
break;
...
V_471:
F_218 ( & V_11 -> V_201 ) ;
F_376 ( & V_11 -> V_470 , V_98 ) ;
F_377 ( & V_11 -> V_472 , & V_472 ) ;
break;
}
F_218 ( & V_469 ) ;
return V_468 ;
...
static unsigned long
F_378 ( struct V_463 * V_464 , struct V_465 * V_466 )
{
return F_379 ( & V_164 ) ;
}
...
unsigned int F_386 ( struct V_11 * V_11 )
{
unsigned int V_475 ;
...
int F_387 ( struct V_33 * V_34 , T_1 V_221 , T_1 V_119 [ 4 ] )
{
struct V_219 V_220 ;
T_1 V_10 ;
int V_479 = 0 ;
