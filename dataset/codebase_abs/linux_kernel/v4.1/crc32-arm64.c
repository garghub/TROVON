...
static int F_23 ( struct V_7 * V_8 , T_2 * V_20 )
{
struct V_12 * V_13 = F_16 ( V_8 ) ;
F_22 ( ~ V_13 -> V_1 , V_20 ) ;
return 0 ;
...
static int F_25 ( T_1 V_1 , const T_2 * V_19 , unsigned int V_3 , T_2 * V_20 )
{
...
{
struct V_12 * V_13 = F_16 ( V_8 ) ;
return F_25 ( V_13 -> V_1 , V_19 , V_3 , V_20 ) ;
}
...
static int F_29 ( struct V_7 * V_8 , const T_2 * V_19 ,
unsigned int V_4 , T_2 * V_20 )
{
struct V_9 * V_10 = F_15 ( V_8 -> V_11 ) ;
return F_25 ( V_10 -> V_14 , V_19 , V_4 , V_20 ) ;
}
static int F_30 ( struct V_21 * V_11 )
{
struct V_9 * V_10 = F_31 ( V_11 ) ;
V_10 -> V_14 = 0 ;
return 0 ;
}
static int F_32 ( struct V_21 * V_11 )
{
struct V_9 * V_10 = F_31 ( V_11 ) ;
V_10 -> V_14 = ~ 0 ;
return 0 ;
