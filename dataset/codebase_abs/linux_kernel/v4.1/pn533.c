...
struct V_19 * V_20 = F_123 ( V_176 ) ;
int V_63 ;
F_29 ( & V_20 -> V_50 -> V_20 , L_38 , V_96 , V_259 ) ;
if ( V_20 -> V_177 ) {
F_30 ( & V_20 -> V_50 -> V_20 ,
L_39 ) ;
return - V_253 ;
