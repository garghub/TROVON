...
unsigned long V_202 )
{
return F_105 ( V_200 , V_201 , V_202 , & V_212 ) ;
}
...
if ( V_228 ) {
F_7 ( V_228 != & V_22 -> V_137 ) ;
V_23 = F_121 ( & V_228 -> V_138 , false , V_180 -> V_185 ) ;
if ( F_5 ( V_23 != 0 ) )
goto V_230;
F_56 ( & V_228 -> V_138 , true , V_139 ) ;
...
static void F_127 ( struct V_232 * V_88 )
{
struct V_79 * V_70 = F_128 ( V_88 ) ;
F_129 ( V_88 ) ;
F_130 ( V_70 ) ;
}
static int V_172 ( struct V_233 * V_234 , unsigned long V_235 ,
void * V_236 )
{
struct V_21 * V_22 =
F_131 ( V_234 , struct V_21 , V_170 ) ;
switch ( V_235 ) {
case V_237 :
case V_238 :
F_132 ( & V_22 -> V_94 ) ;
...
static int F_136 ( struct V_232 * V_88 , T_5 V_35 )
{
struct V_79 * V_70 = F_128 ( V_88 ) ;
struct V_21 * V_22 = F_88 ( V_70 ) ;
if ( V_22 -> V_47 != 0 ) {
...
static int F_139 ( struct V_232 * V_88 )
{
F_138 ( V_88 , V_245 ) ;
F_140 ( V_88 ) ;
return F_141 ( V_88 ) ;
...
{
struct V_232 * V_88 = F_143 ( V_247 ) ;
struct V_248 V_29 ;
V_29 . V_249 = 0 ;
return F_136 ( V_88 , V_29 ) ;
}
static int F_144 ( struct V_246 * V_247 )
{
struct V_232 * V_88 = F_143 ( V_247 ) ;
return F_139 ( V_88 ) ;
}
...
static void F_146 ( struct V_246 * V_247 )
{
struct V_232 * V_88 = F_143 ( V_247 ) ;
struct V_79 * V_70 = F_128 ( V_88 ) ;
struct V_21 * V_22 = F_88 ( V_70 ) ;
...
static int F_147 ( struct V_232 * V_88 , const struct V_251 * V_252 )
{
return F_148 ( V_88 , V_252 , & V_207 ) ;
}
static int T_6 F_149 ( void )
{
int V_23 ;
V_23 = F_150 ( & V_207 , & V_253 ) ;
if ( V_23 )
F_14 ( L_66 ) ;
return V_23 ;
}
