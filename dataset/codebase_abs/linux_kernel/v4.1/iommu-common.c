...
if ( V_32 > 0 )
V_43 = 0xffffffffffffffffl >> ( 64 - V_32 ) ;
if ( F_13 ( V_29 == 0 ) ) {
F_14 ( 1 ) ;
return V_44 ;
}
...
V_34 = F_20 ( V_2 -> V_47 , V_35 , V_15 , V_29 , V_42 ,
V_36 , V_43 ) ;
if ( V_34 == - 1 ) {
if ( F_21 ( V_38 == 0 ) ) {
V_37 -> V_25 = V_37 -> V_15 ;
...
static struct V_16 * F_23 ( struct V_1 * V_49 ,
unsigned long V_50 )
{
struct V_16 * V_17 ;
unsigned long V_51 = V_49 -> V_12 . V_15 ;
bool V_12 = ( ( V_49 -> V_4 & V_21 ) != 0 ) ;
if ( V_12 && V_50 >= V_51 ) {
V_17 = & V_49 -> V_12 ;
} else {
unsigned int V_39 = V_50 / V_49 -> V_22 ;
F_9 ( V_39 >= V_49 -> V_18 ) ;
V_17 = & V_49 -> V_23 [ V_39 ] ;
}
return V_17 ;
}
void F_24 ( struct V_1 * V_2 , T_2 V_52 ,
unsigned long V_29 , unsigned long V_50 )
{
struct V_16 * V_37 ;
unsigned long V_4 ;
unsigned long V_42 = V_2 -> V_11 ;
if ( V_50 == V_44 )
V_50 = ( V_52 - V_2 -> V_46 ) >> V_42 ;
V_37 = F_23 ( V_2 , V_50 ) ;
F_15 ( & ( V_37 -> V_24 ) , V_4 ) ;
F_25 ( V_2 -> V_47 , V_50 , V_29 ) ;
F_22 ( & ( V_37 -> V_24 ) , V_4 ) ;
}
