...
struct V_24 * V_25 ;
int V_33 ;
V_25 = F_16 ( sizeof( struct V_24 ) , V_47 , F_17 ( V_46 ) ) ;
if ( ! V_25 )
return NULL ;
V_25 -> V_26 = - 1 ;
for ( V_33 = 0 ; V_33 < V_34 . V_35 ; V_33 ++ ) {
F_18 ( V_33 , V_25 -> V_45 [ V_33 ] . V_48 ) ;
...
static struct V_37 *
F_27 ( struct V_22 * V_23 , int V_40 ,
struct V_9 * V_10 )
{
...
static struct V_37 *
F_29 ( struct V_22 * V_23 , int V_40 ,
struct V_9 * V_10 )
{
struct V_20 * V_21 = & V_10 -> V_14 ;
unsigned int V_61 = F_4 ( V_21 ) ;
switch ( V_61 & V_62 ) {
case V_63 :
switch ( V_61 ) {
case 0x000 :
...
static T_2 F_31 ( char * V_78 , T_1 V_15 )
{
T_1 V_10 = ( V_15 & V_79 ) |
( V_15 & V_80 ) >> 24 ;
return F_32 ( V_78 , V_15 , V_10 ) ;
}
