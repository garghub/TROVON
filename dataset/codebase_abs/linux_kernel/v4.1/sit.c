...
goto V_146;
return F_91 ( V_98 , V_87 , & V_148 , V_139 ) ;
}
return 1 ;
V_146:
F_63 ( V_87 ) ;
...
F_120 ( V_87 , V_118 ) ;
V_36 = F_121 ( NULL , V_102 , V_87 , V_164 . V_15 , V_164 . V_16 ,
V_133 , V_140 , V_119 , V_158 ,
! F_122 ( V_98 -> V_2 , F_18 ( V_4 ) ) ) ;
F_123 ( V_36 , & V_4 -> V_137 , V_4 -> V_132 ) ;
return V_189 ;
V_178:
F_109 ( V_87 ) ;
V_169:
...
static T_5 F_124 ( struct V_86 * V_87 , struct V_3 * V_4 )
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
const struct V_88 * V_156 = & V_98 -> V_13 . V_14 ;
...
goto V_45;
F_120 ( V_87 , V_145 ) ;
F_125 ( V_87 , V_4 , V_156 , V_145 ) ;
return V_189 ;
V_45:
V_4 -> V_137 . V_192 ++ ;
return V_189 ;
}
static T_5 F_126 ( struct V_86 * V_87 ,
struct V_3 * V_4 )
{
switch ( V_87 -> V_133 ) {
case F_80 ( V_194 ) :
...
V_161 = F_128 ( V_98 -> V_2 , V_98 -> V_13 . V_17 ) ;
if ( V_161 ) {
int V_167 = V_98 -> V_168 + sizeof( struct V_88 ) ;
...
static void F_129 ( struct V_1 * V_9 , struct V_22 * V_77 )
{
...
static int F_132 ( struct V_1 * V_9 ,
struct V_197 * V_30 )
{
struct V_94 V_31 ;
T_1 V_32 ;
...
return - V_78 ;
F_133 ( & V_31 , & V_30 -> V_31 , V_30 -> V_33 ) ;
if ( ! F_134 ( & V_31 , & V_30 -> V_31 ) )
return - V_78 ;
if ( V_30 -> V_34 )
V_32 = V_30 -> V_32 &
F_16 ( 0xffffffffUL <<
...
static int
F_135 ( struct V_3 * V_4 , struct V_198 * V_199 , int V_200 )
{
int V_36 = 0 ;
struct V_22 V_77 ;
struct V_59 V_58 ;
...
static int F_138 ( struct V_3 * V_4 , int V_220 )
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
int V_167 = V_98 -> V_168 + sizeof( struct V_88 ) ;
...
F_127 ( V_4 ) ;
V_4 -> V_132 = F_143 ( struct V_131 ) ;
if ( ! V_4 -> V_132 )
return - V_75 ;
V_98 -> V_221 = F_144 ( struct V_234 ) ;
if ( ! V_98 -> V_221 ) {
F_139 ( V_4 -> V_132 ) ;
return - V_75 ;
}
...
static int T_8 F_145 ( struct V_3 * V_4 )
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
...
static int F_146 ( struct V_235 * V_236 [] , struct V_235 * V_100 [] )
{
T_6 V_149 ;
if ( ! V_100 || ! V_100 [ V_237 ] )
return 0 ;
V_149 = F_147 ( V_100 [ V_237 ] ) ;
if ( V_149 != V_118 &&
V_149 != V_145 &&
V_149 != 0 )
return - V_78 ;
...
static void F_148 ( struct V_235 * V_100 [] ,
struct V_22 * V_13 )
{
...
return;
if ( V_100 [ V_238 ] )
V_13 -> V_17 = F_149 ( V_100 [ V_238 ] ) ;
if ( V_100 [ V_239 ] )
V_13 -> V_14 . V_15 = F_150 ( V_100 [ V_239 ] ) ;
if ( V_100 [ V_240 ] )
V_13 -> V_14 . V_16 = F_150 ( V_100 [ V_240 ] ) ;
if ( V_100 [ V_241 ] ) {
V_13 -> V_14 . V_119 = F_147 ( V_100 [ V_241 ] ) ;
if ( V_13 -> V_14 . V_119 )
V_13 -> V_14 . V_159 = F_80 ( V_211 ) ;
}
if ( V_100 [ V_242 ] )
V_13 -> V_14 . V_140 = F_147 ( V_100 [ V_242 ] ) ;
if ( ! V_100 [ V_243 ] || F_147 ( V_100 [ V_243 ] ) )
V_13 -> V_14 . V_159 = F_80 ( V_211 ) ;
if ( V_100 [ V_244 ] )
V_13 -> V_41 = F_151 ( V_100 [ V_244 ] ) ;
if ( V_100 [ V_237 ] )
V_13 -> V_14 . V_133 = F_147 ( V_100 [ V_237 ] ) ;
}
static bool F_152 ( struct V_235 * V_100 [] ,
struct F_119 * V_245 )
{
bool V_67 = false ;
...
if ( V_100 [ V_246 ] ) {
V_67 = true ;
V_245 -> type = F_153 ( V_100 [ V_246 ] ) ;
}
if ( V_100 [ V_247 ] ) {
V_67 = true ;
V_245 -> V_19 = F_153 ( V_100 [ V_247 ] ) ;
}
if ( V_100 [ V_248 ] ) {
V_67 = true ;
V_245 -> V_249 = F_151 ( V_100 [ V_248 ] ) ;
}
if ( V_100 [ V_250 ] ) {
V_67 = true ;
V_245 -> V_251 = F_151 ( V_100 [ V_250 ] ) ;
}
return V_67 ;
}
static bool F_154 ( struct V_235 * V_100 [] ,
struct V_197 * V_30 )
{
bool V_67 = false ;
...
static int F_156 ( struct V_2 * V_256 , struct V_3 * V_4 ,
...
int V_36 ;
V_49 = F_14 ( V_4 ) ;
if ( F_152 ( V_100 , & V_245 ) ) {
V_36 = F_157 ( V_49 , & V_245 ) ;
if ( V_36 < 0 )
return V_36 ;
}
F_148 ( V_100 , & V_49 -> V_13 ) ;
...
#ifdef F_13
if ( F_154 ( V_100 , & V_30 ) )
V_36 = F_132 ( V_49 , & V_30 ) ;
#endif
return V_36 ;
}
static int F_158 ( struct V_3 * V_4 , struct V_235 * V_236 [] ,
struct V_235 * V_100 [] )
{
struct V_1 * V_9 = F_14 ( V_4 ) ;
struct V_22 V_77 ;
...
#ifdef F_13
if ( F_154 ( V_100 , & V_30 ) )
return F_132 ( V_9 , & V_30 ) ;
#endif
return 0 ;
}
static T_9 F_159 ( const struct V_3 * V_4 )
{
return
F_160 ( 4 ) +
F_160 ( 4 ) +
...
static int F_161 ( struct V_86 * V_87 , const struct V_3 * V_4 )
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
struct V_22 * V_257 = & V_98 -> V_13 ;
if ( F_162 ( V_87 , V_238 , V_257 -> V_17 ) ||
F_163 ( V_87 , V_239 , V_257 -> V_14 . V_15 ) ||
F_163 ( V_87 , V_240 , V_257 -> V_14 . V_16 ) ||
F_164 ( V_87 , V_241 , V_257 -> V_14 . V_119 ) ||
F_164 ( V_87 , V_242 , V_257 -> V_14 . V_140 ) ||
F_164 ( V_87 , V_243 ,
! ! ( V_257 -> V_14 . V_159 & F_80 ( V_211 ) ) ) ||
F_164 ( V_87 , V_237 , V_257 -> V_14 . V_133 ) ||
F_165 ( V_87 , V_244 , V_257 -> V_41 ) )
goto V_258;
#ifdef F_13
if ( F_166 ( V_87 , V_252 ,
& V_98 -> V_30 . V_31 ) ||
...
static void F_168 ( struct V_3 * V_4 , struct V_261 * V_83 )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_10 * V_11 = F_3 ( V_2 , V_12 ) ;
if ( V_4 != V_11 -> V_29 )
...
static void T_10 F_170 ( struct V_2 * V_2 ,
struct V_261 * V_83 )
{
struct V_10 * V_11 = F_3 ( V_2 , V_12 ) ;
...
static int T_8 F_172 ( struct V_2 * V_2 )
{
struct V_10 * V_11 = F_3 ( V_2 , V_12 ) ;
struct V_1 * V_9 ;
int V_36 ;
...
V_36 = F_145 ( V_11 -> V_29 ) ;
if ( V_36 )
goto V_269;
F_12 ( V_11 -> V_29 , V_11 ) ;
V_36 = F_173 ( V_11 -> V_29 ) ;
if ( V_36 )
goto V_270;
V_9 = F_14 ( V_11 -> V_29 ) ;
...
static void T_10 F_174 ( struct V_2 * V_2 )
{
F_175 ( V_271 ) ;
F_176 () ;
F_170 ( V_2 , & V_271 ) ;
...
if ( V_36 < 0 )
return V_36 ;
V_36 = F_187 ( & V_272 , V_273 ) ;
if ( V_36 < 0 ) {
F_185 ( L_8 , V_277 ) ;
goto V_278;
}
V_36 = F_187 ( & V_274 , V_275 ) ;
if ( V_36 < 0 ) {
F_185 ( L_9 , V_277 ) ;
goto V_279;
}
