...
static void F_69 ( struct V_104 * V_102 )
{
F_57 ( false ) ;
}
...
V_4 = F_71 ( sizeof( struct V_4 ) , V_105 ) ;
if ( ! V_4 )
return - V_106 ;
V_4 -> V_107 . type = V_93 ? V_108 : V_109 ;
V_4 -> V_110 = V_111 ? NULL : F_21 ;
V_4 -> V_112 = F_27 ;
V_4 -> V_113 = F_29 ;
V_4 -> V_114 = F_23 ;
V_4 -> V_28 = V_11 ;
V_4 -> V_102 . V_115 = & V_82 -> V_102 ;
F_72 ( V_4 -> V_116 , L_48 , sizeof( V_4 -> V_116 ) ) ;
F_72 ( V_4 -> V_117 , V_118 , sizeof( V_4 -> V_117 ) ) ;
F_72 ( V_4 -> V_119 , V_120 ,
sizeof( V_4 -> V_119 ) ) ;
V_11 -> V_4 = V_4 ;
V_11 -> V_47 = V_45 ;
return 0 ;
}
static int T_2 F_73 ( int V_121 )
{
struct V_4 * V_4 ;
int V_50 = V_121 < 0 ? V_36 : V_60 + V_121 ;
struct V_27 * V_11 = & V_35 [ V_50 ] ;
V_4 = F_71 ( sizeof( struct V_4 ) , V_105 ) ;
if ( ! V_4 )
return - V_106 ;
V_4 -> V_107 . type = V_108 ;
V_4 -> V_110 = F_22 ;
V_4 -> V_112 = F_27 ;
V_4 -> V_113 = F_29 ;
V_4 -> V_28 = V_11 ;
V_4 -> V_102 . V_115 = & V_82 -> V_102 ;
if ( V_121 < 0 ) {
F_72 ( V_4 -> V_116 , L_49 , sizeof( V_4 -> V_116 ) ) ;
F_72 ( V_4 -> V_117 , V_122 , sizeof( V_4 -> V_117 ) ) ;
F_72 ( V_4 -> V_119 , V_123 ,
sizeof( V_4 -> V_119 ) ) ;
V_4 -> V_114 = F_23 ;
} else {
snprintf ( V_4 -> V_116 , sizeof( V_4 -> V_116 ) , L_50 , V_121 ) ;
snprintf ( V_4 -> V_117 , sizeof( V_4 -> V_117 ) , V_124 , V_121 + 1 ) ;
F_72 ( V_4 -> V_119 , V_123 ,
sizeof( V_4 -> V_119 ) ) ;
}
V_11 -> V_4 = V_4 ;
...
{
int V_13 ;
for ( V_13 = V_36 ; V_13 < V_103 ; V_13 ++ ) {
F_75 ( V_35 [ V_13 ] . V_4 ) ;
V_35 [ V_13 ] . V_4 = NULL ;
}
}
static void T_2 F_77 ( void )
{
int V_13 ;
for ( V_13 = 0 ; V_13 < V_103 ; V_13 ++ ) {
struct V_4 * V_4 = V_35 [ V_13 ] . V_4 ;
...
bool F_83 ( const struct V_4 * V_11 )
{
int V_13 ;
for ( V_13 = 0 ; V_13 < V_103 ; V_13 ++ )
...
static int T_2 F_88 ( struct V_104 * V_102 )
{
int error ;
V_82 = V_102 ;
if ( V_95 ) {
...
static int F_89 ( struct V_104 * V_102 )
{
F_81 () ;
F_84 () ;
F_57 ( false ) ;
...
if ( V_138 )
goto V_139;
V_137 = F_93 ( & V_140 , F_88 , NULL , 0 , NULL , 0 ) ;
if ( F_94 ( V_137 ) ) {
V_138 = F_95 ( V_137 ) ;
goto V_139;
}
