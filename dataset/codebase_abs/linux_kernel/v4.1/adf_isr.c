...
F_8 ( V_20 -> V_21 , V_20 -> V_22 , 0 ) ;
F_9 ( & V_20 -> V_23 ) ;
return V_24 ;
}
static T_2 F_10 ( int V_17 , void * V_25 )
{
struct V_1 * V_2 = V_25 ;
F_11 ( & F_4 ( V_2 ) , L_2 ,
V_2 -> V_26 ) ;
...
unsigned int V_35 , V_36 = F_13 () ;
V_33 = * ( V_4 -> V_12 . V_37 + V_11 ) ;
snprintf ( V_33 , V_38 ,
L_3 , V_2 -> V_26 , V_11 ) ;
V_32 = F_14 ( V_28 [ V_11 ] . V_39 ,
F_7 , 0 , V_33 , V_20 ) ;
if ( V_32 ) {
F_3 ( & F_4 ( V_2 ) ,
L_4 ,
...
F_15 ( V_28 [ V_11 ] . V_39 , F_16 ( V_35 ) ) ;
}
V_33 = * ( V_4 -> V_12 . V_37 + V_11 ) ;
snprintf ( V_33 , V_38 ,
L_5 , V_2 -> V_26 ) ;
V_32 = F_14 ( V_28 [ V_11 ] . V_39 , F_10 , 0 , V_33 , V_2 ) ;
if ( V_32 ) {
F_3 ( & F_4 ( V_2 ) ,
L_6 ,
V_28 [ V_11 ] . V_39 , V_33 ) ;
...
int V_11 ;
for ( V_11 = 0 ; V_11 < V_7 -> V_10 ; V_11 ++ ) {
F_15 ( V_28 [ V_11 ] . V_39 , NULL ) ;
F_18 ( V_28 [ V_11 ] . V_39 , & V_30 -> V_34 [ V_11 ] ) ;
}
F_15 ( V_28 [ V_11 ] . V_39 , NULL ) ;
F_18 ( V_28 [ V_11 ] . V_39 , V_2 ) ;
}
