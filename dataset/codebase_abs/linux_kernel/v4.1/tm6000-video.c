...
snprintf ( V_264 -> V_161 , sizeof( V_264 -> V_161 ) , L_45 , V_6 -> V_161 , V_266 ) ;
F_131 ( V_264 , V_6 ) ;
}
...
F_133 ( & V_6 -> V_197 , 6 ) ;
F_133 ( & V_6 -> V_208 , 2 ) ;
F_134 ( & V_6 -> V_208 , & V_269 ,
V_209 , 0 , 1 , 1 , 0 ) ;
F_134 ( & V_6 -> V_208 , & V_269 ,
V_211 , - 15 , 15 , 1 , 0 ) ;
F_134 ( & V_6 -> V_197 , & V_270 ,
V_202 , 0 , 255 , 1 , 54 ) ;
F_134 ( & V_6 -> V_197 , & V_270 ,
V_200 , 0 , 255 , 1 , 119 ) ;
F_134 ( & V_6 -> V_197 , & V_270 ,
...
if ( V_172 )
goto V_271;
F_130 ( V_6 , & V_6 -> V_264 , & V_272 , L_46 ) ;
V_6 -> V_264 . V_197 = & V_6 -> V_197 ;
F_136 ( & V_6 -> V_7 . V_8 ) ;
F_136 ( & V_6 -> V_7 . V_244 ) ;
V_172 = F_137 ( & V_6 -> V_264 , V_149 , V_273 ) ;
if ( V_172 < 0 ) {
F_138 ( V_274 L_47 ,
V_6 -> V_161 ) ;
goto V_271;
...
F_138 ( V_274 L_48 ,
V_6 -> V_161 , F_105 ( & V_6 -> V_264 ) ) ;
if ( V_6 -> V_275 . V_276 ) {
F_130 ( V_6 , & V_6 -> V_277 , & V_278 ,
L_49 ) ;
V_6 -> V_277 . V_197 = & V_6 -> V_208 ;
V_172 = F_137 ( & V_6 -> V_277 , V_241 ,
V_279 ) ;
if ( V_172 < 0 ) {
F_138 ( V_274 L_50 ,
V_6 -> V_161 ) ;
