...
sprintf ( V_64 , L_8 ,
V_62 , V_68 [ V_63 ] ) ;
F_30 ( & V_1 -> V_36 [ V_25 ] . V_49 [ V_63 ] . V_70 . V_49 ) ;
V_1 -> V_36 [ V_25 ] . V_49 [ V_63 ] . V_70 . V_49 . V_71 = V_64 ;
V_1 -> V_36 [ V_25 ] . V_49 [ V_63 ] . V_70 . V_49 . V_72 = V_73 ;
V_1 -> V_36 [ V_25 ] . V_49 [ V_63 ] . V_70 . V_74 = F_21 ;
V_1 -> V_36 [ V_25 ] . V_49 [ V_63 ] . V_51 = V_25 ;
V_1 -> V_36 [ V_25 ] . V_49 [ V_63 ] . V_53 = V_63 ;
V_5 = F_31 ( V_1 -> V_12 ,
& V_1 -> V_36 [ V_25 ] . V_49 [ V_63 ] . V_70 ) ;
if ( V_5 ) {
V_1 -> V_36 [ V_25 ] . V_49 [ V_63 ] . V_70 . V_49 . V_71 = NULL ;
F_32 ( V_64 ) ;
return V_5 ;
}
return 0 ;
...
F_35 ( V_1 -> V_12 ,
& V_82 . V_70 ) ;
F_35 ( V_1 -> V_12 , & V_83 . V_70 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_35 ; V_29 ++ )
for ( V_75 = 0 ; V_75 < V_80 ; V_75 ++ ) {
if ( ! V_1 -> V_36 [ V_29 ] . V_49 [ V_75 ] . V_70 . V_49 . V_71 )
continue;
F_35 ( V_1 -> V_12 ,
& V_1 -> V_36 [ V_29 ] . V_49 [ V_75 ] . V_70 ) ;
F_32 ( V_1 -> V_36 [ V_29 ] . V_49 [ V_75 ] . V_70 . V_49 . V_71 ) ;
}
F_32 ( V_1 -> V_36 ) ;
return V_5 ;
}
...
static void F_49 ( struct V_99 * V_100 , void * V_101 )
{
struct V_4 * V_1 = (struct V_4 * ) V_101 ;
if ( V_100 -> V_102 != V_1 -> V_8 ) {
F_6 ( V_1 -> V_12 ,
L_12 ,
( int ) V_100 -> V_102 ,
( int ) V_1 -> V_8 ) ;
...
V_1 -> V_103 = V_100 -> V_104 ;
if ( V_100 -> V_100 . V_15 > 0 )
V_1 -> V_17 = V_100 -> V_100 . V_1 [ 0 ] ;
else
V_1 -> V_17 = V_105 ;
if ( V_100 -> V_100 . V_15 > 1 ) {
V_1 -> V_18 = V_100 -> V_100 . V_15 - 1 ;
memcpy ( V_1 -> V_21 , V_100 -> V_100 . V_1 + 1 , V_1 -> V_18 ) ;
} else
V_1 -> V_18 = 0 ;
F_50 ( V_100 ) ;
F_51 ( & V_1 -> V_16 ) ;
