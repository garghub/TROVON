...
V_120 = V_115 -> V_121 ;
V_118 = F_64 ( V_120 , struct V_117 , V_120 ) ;
...
F_88 ( V_160 , V_3 ) ;
V_3 -> V_172 = F_89 ( & V_170 , & V_160 -> V_9 , V_3 ) ;
if ( ! V_3 -> V_172 ) {
F_11 ( & V_160 -> V_9 , L_40 ) ;
return - V_15 ;
}
for ( V_6 = 0 ; V_6 < V_92 ; V_6 ++ )
if ( V_41 [ V_6 ] )
F_90 ( V_3 -> V_172 , & V_41 [ V_6 ] -> V_115 ) ;
F_91 ( & V_160 -> V_9 , L_41 ) ;
return 0 ;
}
static int F_92 ( struct V_159 * V_160 )
{
struct V_2 * V_3 = F_93 ( V_160 ) ;
F_94 ( V_3 -> V_172 ) ;
return 0 ;
}
static int F_95 ( struct V_119 * V_120 , unsigned V_18 )
{
int V_173 = V_120 -> V_122 + V_18 ;
int V_40 = V_120 -> V_122 / V_120 -> V_174 ;
...
static int F_99 ( struct V_119 * V_120 , unsigned V_18 )
{
struct V_117 * V_175 = F_100 ( V_120 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
...
static int F_102 ( struct V_119 * V_120 , unsigned V_18 )
{
struct V_117 * V_175 = F_100 ( V_120 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
unsigned V_50 = 1 << V_18 ;
T_2 V_178 ;
V_178 = F_27 ( V_49 + V_179 ) ;
return ( V_178 & V_50 ) != 0 ;
}
static void F_103 ( struct V_119 * V_120 , unsigned V_18 ,
int V_147 )
{
struct V_117 * V_175 = F_100 ( V_120 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
unsigned V_50 = 1 << V_18 ;
F_25 ( V_50 , V_49 + ( V_147 ? V_180 : V_181 ) ) ;
}
...
static void F_105 ( struct V_16 * V_17 , struct V_119 * V_120 )
{
enum V_64 V_182 ;
int V_6 ;
struct V_117 * V_175 = F_100 ( V_120 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
for ( V_6 = 0 ; V_6 < V_120 -> V_174 ; V_6 ++ ) {
unsigned V_50 = F_20 ( V_6 ) ;
const char * V_183 ;
V_183 = F_106 ( V_120 , V_6 ) ;
if ( ! V_183 )
continue;
V_182 = V_175 -> V_104 -> V_184 ( V_49 , V_50 ) ;
F_8 ( V_17 , L_43 ,
V_183 , V_120 -> V_185 , V_6 ) ;
if ( V_182 == V_67 ) {
F_8 ( V_17 , L_44 ) ;
F_8 ( V_17 , L_45 ,
...
{
struct V_117 * V_175 = F_108 ( V_187 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
unsigned V_50 = 1 << V_187 -> V_188 ;
if ( V_49 )
F_25 ( V_50 , V_49 + V_51 ) ;
}
...
unsigned V_50 = 1 << V_187 -> V_188 ;
if ( V_49 )
F_25 ( V_50 , V_49 + V_189 ) ;
}
static int F_110 ( struct V_186 * V_187 , unsigned type )
{
switch ( type ) {
case V_190 :
case V_191 :
...
static int F_111 ( struct V_186 * V_187 , unsigned type )
{
struct V_117 * V_175 = F_108 ( V_187 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
unsigned V_50 = 1 << V_187 -> V_188 ;
switch ( type ) {
case V_192 :
F_112 ( V_187 -> V_193 , V_194 ) ;
F_25 ( V_50 , V_49 + V_195 ) ;
F_25 ( V_50 , V_49 + V_196 ) ;
break;
case V_197 :
F_112 ( V_187 -> V_193 , V_194 ) ;
F_25 ( V_50 , V_49 + V_195 ) ;
F_25 ( V_50 , V_49 + V_198 ) ;
break;
case V_199 :
F_112 ( V_187 -> V_193 , V_200 ) ;
...
case V_191 :
F_112 ( V_187 -> V_193 , V_194 ) ;
F_25 ( V_50 , V_49 + V_203 ) ;
return 0 ;
case V_190 :
default:
F_113 ( L_52 , F_114 ( V_187 -> V_193 ) ) ;
return - V_15 ;
}
F_25 ( V_50 , V_49 + V_204 ) ;
return 0 ;
}
static void F_115 ( struct V_186 * V_187 )
{
}
static int F_116 ( struct V_186 * V_187 )
{
struct V_117 * V_175 = F_108 ( V_187 ) ;
unsigned V_43 = V_187 -> V_188 ;
int V_101 ;
V_101 = F_117 ( & V_175 -> V_120 , V_43 ) ;
if ( V_101 )
F_11 ( V_175 -> V_120 . V_9 , L_53 ,
V_187 -> V_188 ) ;
return V_101 ;
}
static void F_118 ( struct V_186 * V_187 )
{
struct V_117 * V_175 = F_108 ( V_187 ) ;
unsigned V_43 = V_187 -> V_188 ;
F_119 ( & V_175 -> V_120 , V_43 ) ;
}
static int F_120 ( struct V_186 * V_187 , unsigned V_205 )
{
struct V_117 * V_175 = F_108 ( V_187 ) ;
unsigned V_40 = V_175 -> V_206 ;
unsigned V_50 = 1 << V_187 -> V_188 ;
if ( F_121 ( V_40 >= V_207 ) )
return - V_15 ;
if ( V_205 )
...
continue;
V_49 = V_41 [ V_6 ] -> V_42 ;
V_210 [ V_6 ] = F_27 ( V_49 + V_211 ) ;
F_25 ( V_210 [ V_6 ] , V_49 + V_51 ) ;
F_25 ( V_208 [ V_6 ] , V_49 + V_189 ) ;
if ( ! V_208 [ V_6 ] )
F_124 ( V_41 [ V_6 ] -> clock ) ;
else
F_125 ( V_212 L_54 ,
'A' + V_6 , V_208 [ V_6 ] ) ;
}
...
V_49 = V_41 [ V_6 ] -> V_42 ;
if ( ! V_208 [ V_6 ] )
F_127 ( V_41 [ V_6 ] -> clock ) ;
F_25 ( V_208 [ V_6 ] , V_49 + V_51 ) ;
F_25 ( V_210 [ V_6 ] , V_49 + V_189 ) ;
}
}
static void F_128 ( unsigned V_193 , struct V_213 * V_214 )
{
struct V_215 * V_120 = F_129 ( V_193 ) ;
struct V_119 * V_119 = F_130 ( V_214 ) ;
struct V_117 * V_175 = F_64 ( V_119 ,
struct V_117 , V_120 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
unsigned long V_216 ;
int V_217 ;
F_131 ( V_120 , V_214 ) ;
for (; ; ) {
V_216 = F_27 ( V_49 + V_218 ) & F_27 ( V_49 + V_211 ) ;
if ( ! V_216 ) {
if ( ! V_175 -> V_219 )
break;
V_175 = V_175 -> V_219 ;
...
struct V_117 * V_175 )
{
struct V_119 * V_221 = NULL ;
struct V_117 * V_222 = NULL ;
struct V_186 * V_187 = F_137 ( V_175 -> V_209 ) ;
int V_101 , V_6 ;
V_175 -> V_223 = F_138 ( V_187 ) ;
V_224 . V_225 = V_175 -> V_104 -> V_226 ;
F_25 ( ~ 0 , V_175 -> V_42 + V_51 ) ;
V_101 = F_139 ( & V_175 -> V_120 ,
& V_224 ,
0 ,
V_227 ,
V_191 ) ;
...
V_222 = F_64 ( V_221 , struct V_117 , V_120 ) ;
for ( V_6 = 0 ; V_6 < 2 ; V_6 ++ ) {
if ( V_222 -> V_219 ) {
V_222 = V_222 -> V_219 ;
} else {
...
static int F_142 ( struct V_159 * V_160 )
{
struct V_19 * V_20 = V_160 -> V_9 . V_161 ;
struct V_228 * V_229 ;
...
int V_101 = 0 ;
int V_193 , V_6 ;
int V_230 = F_143 ( V_20 , L_56 ) ;
T_3 V_174 ;
char * * V_231 ;
F_144 ( V_230 >= F_145 ( V_41 ) ) ;
if ( V_41 [ V_230 ] ) {
V_101 = - V_232 ;
goto V_233;
}
...
V_229 = F_147 ( V_160 , V_234 , 0 ) ;
V_118 -> V_42 = F_148 ( & V_160 -> V_9 , V_229 ) ;
if ( F_149 ( V_118 -> V_42 ) ) {
V_101 = F_150 ( V_118 -> V_42 ) ;
goto V_233;
}
V_118 -> V_104 = (struct V_163 * )
F_84 ( V_235 , & V_160 -> V_9 ) -> V_30 ;
V_118 -> V_209 = V_193 ;
V_118 -> V_206 = V_230 ;
V_118 -> clock = F_151 ( & V_160 -> V_9 , NULL ) ;
if ( F_149 ( V_118 -> clock ) ) {
F_11 ( & V_160 -> V_9 , L_57 ) ;
V_101 = F_150 ( V_118 -> clock ) ;
goto V_233;
}
V_101 = F_152 ( V_118 -> clock ) ;
if ( V_101 )
goto V_236;
V_101 = F_153 ( V_118 -> clock ) ;
if ( V_101 ) {
F_11 ( & V_160 -> V_9 , L_58 ) ;
goto V_237;
}
...
V_120 = & V_118 -> V_120 ;
V_120 -> V_161 = V_20 ;
V_120 -> V_185 = F_9 ( & V_160 -> V_9 ) ;
V_120 -> V_9 = & V_160 -> V_9 ;
V_120 -> V_239 = V_240 ;
V_120 -> V_122 = V_230 * V_44 ;
if ( ! F_154 ( V_20 , L_59 , & V_174 ) ) {
if ( V_174 >= V_44 )
F_155 ( L_60 ,
V_230 , V_44 , V_44 ) ;
else
...
V_231 = F_12 ( & V_160 -> V_9 , sizeof( char * ) * V_120 -> V_174 ,
V_27 ) ;
if ( ! V_231 ) {
V_101 = - V_28 ;
goto V_237;
...
for ( V_6 = 0 ; V_6 < V_120 -> V_174 ; V_6 ++ )
V_231 [ V_6 ] = F_87 ( V_27 , L_39 , V_230 + 'A' , V_6 ) ;
V_120 -> V_231 = ( const char * const * ) V_231 ;
V_115 = & V_118 -> V_115 ;
V_115 -> V_4 = V_120 -> V_185 ;
V_115 -> V_123 = V_230 ;
V_115 -> V_241 = V_115 -> V_122 = V_115 -> V_123 * V_44 ;
V_115 -> V_10 = V_120 -> V_174 ;
V_115 -> V_121 = V_120 ;
V_101 = F_156 ( V_120 ) ;
if ( V_101 )
goto V_242;
V_41 [ V_230 ] = V_118 ;
V_92 = F_157 ( V_92 , V_230 + 1 ) ;
V_101 = F_136 ( V_160 , V_118 ) ;
if ( V_101 )
goto V_243;
F_91 ( & V_160 -> V_9 , L_61 , V_118 -> V_42 ) ;
return 0 ;
V_243:
F_158 ( V_120 ) ;
V_242:
...
V_236:
V_233:
F_11 ( & V_160 -> V_9 , L_62 , V_101 , V_230 ) ;
return V_101 ;
}
