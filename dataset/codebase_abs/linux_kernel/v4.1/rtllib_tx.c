...
return;
if ( V_55 -> V_68 ) {
if ( ! F_22 ( V_14 , (struct V_69 * * ) ( & V_57 ) , V_59 -> V_62 ,
V_43 -> V_70 , V_71 , true ) ) {
F_4 ( V_14 -> V_24 , L_3 , V_25 ) ;
return;
}
...
if ( F_24 ( V_57 -> V_72 . V_80 . V_81 . V_82 ,
( V_57 -> V_83 + 1 ) % 4096 ) )
V_57 -> V_79 = true ;
else
goto V_78;
...
T_2 F_31 ( struct V_13 * V_14 , struct V_15 * V_43 ,
T_1 * V_136 )
{
T_2 V_137 = 0 ;
if ( F_21 ( V_136 ) )
...
if ( ! F_22 ( V_14 , (struct V_69 * * ) ( & V_138 ) , V_136 ,
V_43 -> V_70 , V_71 , true ) )
return 0 ;
V_137 = V_138 -> V_83 ;
...
static int F_32 ( struct V_15 * V_43 )
{
switch ( V_43 -> V_70 ) {
case 6 :
case 7 :
...
static T_1 F_33 ( struct V_13 * V_14 )
{
if ( V_14 -> V_118 & V_139 )
return V_14 -> V_140 ;
if ( V_14 -> V_141 )
...
int F_34 ( struct V_15 * V_43 , struct V_142 * V_24 )
{
...
T_1 V_159 [ V_160 ] , V_161 [ V_160 ] ;
int V_162 = V_14 -> V_99 . V_163 . V_164 ;
struct V_18 * V_19 = NULL ;
struct V_52 * V_53 ;
T_1 V_165 = false ;
T_1 V_166 = false ;
bool V_63 = false ;
F_36 ( & V_14 -> V_167 , V_147 ) ;
...
if ( F_38 ( V_14 -> V_173 == 0 ) ) {
if ( F_8 ( V_43 -> V_31 < V_12 + sizeof( T_2 ) ) ) {
F_37 ( V_14 -> V_24 , L_5 ,
V_43 -> V_31 ) ;
goto V_172;
}
memcpy ( V_159 , V_43 -> V_1 , V_160 ) ;
memcpy ( V_161 , V_43 -> V_1 + V_160 , V_160 ) ;
memset ( V_43 -> V_42 , 0 , sizeof( V_43 -> V_42 ) ) ;
V_150 = F_39 ( ( (struct V_45 * ) V_43 -> V_1 ) -> V_2 ) ;
if ( V_14 -> V_84 == V_174 ) {
...
memcpy ( F_40 ( V_35 -> V_41 [ 0 ] , V_43 -> V_31 ) , V_43 -> V_1 ,
V_43 -> V_31 ) ;
goto V_172;
}
if ( V_43 -> V_31 > 282 ) {
...
if ( V_14 -> V_84 == V_85 ) {
V_153 |= V_199 ;
memcpy ( & V_156 . V_62 , V_14 -> V_99 . V_200 ,
V_160 ) ;
memcpy ( & V_156 . V_201 , & V_161 , V_160 ) ;
if ( V_166 )
memcpy ( & V_156 . V_202 ,
V_14 -> V_99 . V_200 , V_160 ) ;
else
memcpy ( & V_156 . V_202 , & V_159 , V_160 ) ;
} else if ( V_14 -> V_84 == V_134 ) {
memcpy ( & V_156 . V_62 , V_159 , V_160 ) ;
memcpy ( & V_156 . V_201 , V_161 , V_160 ) ;
memcpy ( & V_156 . V_202 , V_14 -> V_99 . V_200 ,
V_160 ) ;
}
V_165 = F_21 ( V_156 . V_62 ) ;
...
V_53 -> V_219 = F_44 ( V_43 -> V_70 ) ;
} else {
V_155 -> V_70 = V_220 ;
V_53 -> V_219 = V_220 ;
}
F_45 ( V_155 , V_14 -> V_218 ) ;
if ( V_151 ) {
if ( V_14 -> V_222 )
V_53 -> V_223 = 1 ;
else
...
if ( ( V_162 ) && ( ! V_165 ) ) {
V_144 -> V_158 =
F_12 ( F_31 ( V_14 , V_155 ,
V_156 . V_62 ) ) ;
V_144 -> V_158 =
F_12 ( F_46 ( V_144 -> V_158 ) << 4 | V_39 ) ;
} else {
V_144 -> V_158 =
...
memcpy ( F_40 ( V_155 , V_152 ) , V_43 -> V_1 , V_152 ) ;
F_43 ( V_43 , V_152 ) ;
if ( V_151 )
F_3 ( V_14 , V_155 ,
V_17 ) ;
...
if ( ( V_162 ) && ( ! V_165 ) ) {
if ( V_14 -> V_225 [ F_44 ( V_43 -> V_70 ) + 1 ] == 0xFFF )
V_14 -> V_225 [ F_44 ( V_43 -> V_70 ) + 1 ] = 0 ;
else
V_14 -> V_225 [ F_44 ( V_43 -> V_70 ) + 1 ] ++ ;
} else {
...
F_48 ( & V_14 -> V_167 , V_147 ) ;
F_14 ( V_43 ) ;
if ( V_35 ) {
if ( V_14 -> V_169 & V_170 ) {
V_24 -> V_149 . V_231 ++ ;
V_24 -> V_149 . V_232 += F_46 ( V_35 -> V_178 ) ;
F_49 ( V_35 , V_14 ) ;
} else {
if ( (* V_14 -> V_168 )( V_35 , V_24 ) == 0 ) {
V_149 -> V_231 ++ ;
V_149 -> V_232 += F_46 ( V_35 -> V_178 ) ;
return 0 ;
}
F_7 ( V_35 ) ;
}
...
int F_51 ( struct V_15 * V_43 , struct V_142 * V_24 )
{
memset ( V_43 -> V_42 , 0 , sizeof( V_43 -> V_42 ) ) ;
return F_34 ( V_43 , V_24 ) ;
}
