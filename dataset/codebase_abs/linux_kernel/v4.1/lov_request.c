...
int F_48 ( struct V_69 * exp , struct V_66 * V_67 ,
...
static int F_51 ( void * V_65 , int V_30 )
{
struct V_66 * V_67 = V_65 ;
struct V_15 * V_68 ;
V_68 = F_43 ( V_67 , struct V_15 , V_18 ) ;
return F_50 ( V_68 -> V_41 , V_68 , V_30 ) ;
}
int F_52 ( struct V_69 * exp , struct V_66 * V_67 ,
struct V_84 * V_85 ,
struct V_1 * * V_70 )
{
struct V_1 * V_2 ;
...
int F_54 ( struct V_104 * V_105 , struct V_106 * V_107 ,
int V_108 )
{
if ( V_108 ) {
T_2 V_109 = F_55 ( & V_105 -> V_37 . V_34 ,
V_110 , 0 ) ;
if ( V_107 -> V_111 != V_112 )
F_56 ( V_107 -> V_111 , V_109 ) ;
if ( V_107 -> V_113 != V_112 )
F_56 ( V_107 -> V_113 , V_109 ) ;
F_57 ( & V_105 -> V_114 ) ;
...
return 0 ;
if ( F_16 ( & V_2 -> V_4 ) ) {
V_30 = F_54 ( V_2 -> V_117 , V_2 -> V_57 -> V_22 ,
F_16 ( & V_2 -> V_5 ) ) ;
}
F_41 ( V_2 ) ;
return V_30 ;
}
void F_61 ( struct V_106 * V_107 , struct V_106 * V_118 ,
int V_108 )
{
int V_119 = 0 , V_120 = 0 ;
T_3 V_121 ;
...
F_62 ( V_107 -> V_111 , V_118 -> V_111 ) ;
F_62 ( V_107 -> V_113 , V_118 -> V_113 ) ;
}
}
static int F_63 ( void * V_65 , int V_30 )
{
struct V_66 * V_67 = V_65 ;
struct V_15 * V_68 ;
struct V_1 * V_2 ;
...
F_59 ( & V_127 -> V_114 ) ;
V_128:
F_61 ( V_107 , V_118 , V_108 ) ;
F_66 ( V_126 ) ;
V_52:
if ( V_2 -> V_57 -> V_129 & V_131 &&
F_15 ( V_2 , 0 ) ) {
F_67 ( NULL , V_2 , V_2 -> V_3 !=
F_16 ( & V_2 -> V_5 ) ) ;
}
return 0 ;
}
int F_68 ( struct V_104 * V_105 , struct V_66 * V_67 ,
struct V_1 * * V_70 )
{
struct V_1 * V_2 ;
