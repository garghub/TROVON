...
F_9 ( & V_105 -> V_7 -> V_111 ) ;
V_20 = F_81 ( ( void * ) V_74 , V_134 , sizeof( * V_134 ) ) ;
if ( V_20 )
V_20 = - V_65 ;
return V_20 ;
}
...
F_82 ( struct V_139 * V_140 , void * V_17 ,
...
static struct V_162 * F_85 ( struct V_139 * V_140 ,
...
struct V_70 * V_70 ;
F_20 () ;
V_162 = F_86 ( V_140 -> V_165 , V_163 ) ;
if ( F_12 ( ! V_162 ) )
return NULL ;
V_70 = F_82 ( V_140 , V_17 , V_142 , NULL , & V_7 -> V_166 ) ;
if ( F_12 ( ! V_70 ) ) {
F_87 ( V_162 ) ;
return NULL ;
}
...
static int F_89 ( struct V_139 * V_140 , void * V_167 , int V_168 )
{
...
V_70 = F_82 ( V_140 , NULL ,
& V_180 ,
& V_181 ,
& V_17 -> V_146 ) ;
V_140 -> V_165 = F_90 ( V_70 ) ;
if ( F_12 ( ! V_140 -> V_165 ) )
return - V_69 ;
if ( F_12 ( ! F_85 ( V_140 , L_6 , V_7 ,
& V_182 ) ) )
return - V_69 ;
return 0 ;
}
static int F_91 ( struct V_169 * V_17 , char * V_183 )
{
F_20 () ;
if ( ! V_183 || ! * V_183 )
return 0 ;
...
* V_184 = 0 ;
if ( F_93 ( V_184 + 1 , 0 , & V_74 ) ) {
F_92 ( L_8 , V_183 , V_184 + 1 ) ;
return - V_48 ;
}
switch ( V_184 - V_183 ) {
case 13 :
...
V_17 -> V_146 . V_154 = F_94 ( F_95 () , V_74 ) ;
if ( ! F_96 ( V_17 -> V_146 . V_154 ) ) {
F_92 ( L_14 , V_183 , V_74 ) ;
return - V_48 ;
}
} else if ( ! memcmp ( V_183 , L_15 , 3 ) ) {
V_17 -> V_146 . V_156 = F_97 ( F_95 () , V_74 ) ;
if ( ! F_98 ( V_17 -> V_146 . V_156 ) ) {
F_92 ( L_14 , V_183 , V_74 ) ;
return - V_48 ;
}
} else {
...
static struct V_162 *
F_99 ( struct V_190 * V_191 , int V_192 ,
...
V_7 -> V_40 = V_197 ;
V_17 . V_6 = V_7 ;
V_196 = F_106 ( V_191 , V_192 , & V_17 , F_89 ) ;
...
{
F_20 () ;
if ( F_12 ( F_118 ( & V_7 -> V_199 ) ) ) {
F_25 ( L_20 , V_114 ) ;
F_119 ( V_7 ) ;
F_120 ( F_121 ( & V_7 -> V_22 . V_25 ) ||
F_121 ( & V_7 -> V_16 . V_82 ) ) ;
F_33 ( V_7 -> V_193 ) ;
F_33 ( V_7 ) ;
}
...
{
struct V_6 * V_7 = F_124 ( sizeof *V_7 , V_68 ) ;
if ( F_12 ( ! V_7 ) )
return NULL ;
F_20 () ;
F_125 ( & V_7 -> V_199 , 1 ) ;
...
static int F_132 ( struct V_6 * V_7 , struct V_213 * V_214 )
{
struct V_215 * * V_216 ;
int V_217 ;
F_20 () ;
if ( F_62 ( V_7 -> V_45 != V_50
|| F_133 ( V_218 , & V_7 -> V_192 ) ) )
return - V_55 ;
V_217 = F_134 ( V_214 , V_7 -> V_211 ) ;
if ( F_12 ( V_217 < 0 ) )
return V_217 ;
...
F_20 () ;
V_64 = V_7 -> V_202 ;
V_201 = F_137 ( V_64 , sizeof( * V_201 ) , V_68 ) ;
if ( ! V_201 )
return - V_69 ;
V_105 = V_201 ;
...
V_105 -> V_162 = F_85 ( V_7 -> V_140 , V_105 -> V_163 ,
V_105 ,
& V_227 ) ;
if ( F_12 ( ! V_105 -> V_162 ) ) {
F_122 ( V_201 , V_61 - 1 ) ;
...
static void F_122 ( struct V_104 * V_201 , unsigned V_64 )
{
struct V_104 * V_105 = V_201 ;
F_20 () ;
for (; V_64 ; -- V_64 , ++ V_105 ) {
F_120 ( F_138 ( & V_105 -> V_42 ) ||
F_121 ( & V_105 -> V_82 ) ) ;
if ( V_105 -> V_162 ) {
F_139 ( V_105 -> V_162 ) ;
F_87 ( V_105 -> V_162 ) ;
...
F_143 ( & V_77 -> V_7 -> V_111 , V_192 ) ;
}
static int F_144 ( struct V_1 * V_77 )
{
...
V_20 = F_145 ( V_12 -> V_12 ) ;
if ( F_39 ( ! V_20 ) ) {
V_105 -> V_12 = V_12 ;
V_105 -> V_108 = F_146 ( V_229 ) ;
V_105 -> V_109 = F_147 ( V_229 ) ;
} else {
break;
}
F_148 ( & V_105 -> V_82 ) ;
...
static int T_6 F_149 ( char * V_17 , unsigned V_18 ,
T_7 V_230 ,
void * V_231 )
{
...
#define F_150 ( T_9 ) 1
#define F_151 ( T_9 ) (val)
#define F_152 ( T_9 ) ((val) & USB_ENDPOINT_NUMBER_MASK)
#define F_153 ( type , T_9 ) do { \
...
goto V_242;
F_153 ( V_243 , V_229 -> V_244 ) ;
if ( V_229 -> V_245 )
F_153 ( STRING , V_229 -> V_245 ) ;
}
break;
case V_246 : {
...
static int T_6 F_154 ( unsigned V_64 , char * V_17 , unsigned V_18 ,
...
if ( ! V_17 )
return V_266 - V_18 ;
V_20 = F_149 ( V_17 , V_18 , V_230 , V_231 ) ;
if ( F_12 ( V_20 < 0 ) ) {
...
static int F_155 ( enum V_268 type ,
...
static int F_156 ( enum V_276 * V_277 ,
struct V_278 * V_134 )
{
...
static int T_6 F_157 ( char * V_17 , unsigned V_18 ,
enum V_276 type ,
T_10 V_285 ,
T_11 V_230 ,
void * V_231 ,
...
static int T_6 F_158 ( unsigned V_64 ,
...
return - V_48 ;
if ( F_159 ( V_134 -> V_287 ) > V_18 )
return - V_48 ;
V_20 = F_156 ( & type , V_134 ) ;
if ( F_12 ( V_20 < 0 ) ) {
F_18 ( L_39 ,
V_130 , V_20 ) ;
return V_20 ;
...
static int F_160 ( enum V_276 type ,
...
return - V_48 ;
V_28 = F_159 ( V_272 -> V_298 ) ;
type = F_159 ( V_272 -> V_299 ) ;
if ( type < V_300 ||
type > V_301 ) {
F_16 ( L_40 ,
type ) ;
...
V_295 = F_159 ( * ( T_12 * ) ( ( T_8 * ) V_17 + 10 + V_296 ) ) ;
...
V_271 . V_212 = 0 ;
V_271 . V_202 = 0 ;
V_20 = F_154 ( V_307 [ V_61 ] , V_17 , V_18 ,
F_155 , & V_271 ) ;
if ( V_20 < 0 )
goto error;
...
unsigned V_61 = 0 ;
F_163 ( V_272 ) ;
F_164 ( V_272 , struct V_215 * , V_205 ,
V_319 + 1 ) ;
F_164 ( V_272 , struct V_215 , V_321 , V_319 ) ;
F_164 ( V_272 , struct V_219 , V_221 ,
V_319 * ( V_318 + 1 ) ) ;
char * V_322 = F_40 ( F_165 ( V_272 ) , V_68 ) ;
if ( F_12 ( ! V_322 ) ) {
F_33 ( V_167 ) ;
return - V_69 ;
}
V_205 = F_166 ( V_322 , V_272 , V_205 ) ;
V_191 = F_166 ( V_322 , V_272 , V_321 ) ;
V_61 = V_319 ;
do {
* V_205 ++ = V_191 ++ ;
} while ( -- V_61 );
...
if ( F_12 ( V_18 < 3 ) )
goto V_324;
V_191 -> V_325 = F_167 ( V_17 ) ;
V_191 -> V_221 = V_223 ;
++ V_191 ;
V_17 += 2 ;
V_18 -= 2 ;
do {
T_1 V_28 = F_168 ( V_17 , V_18 ) ;
if ( F_12 ( V_28 == V_18 ) )
goto V_324;
if ( F_39 ( V_323 ) ) {
V_223 -> V_223 = V_17 ;
...
{
unsigned long V_192 ;
F_141 ( & V_7 -> V_22 . V_25 . V_26 , V_192 ) ;
F_169 ( V_7 , type ) ;
F_143 ( & V_7 -> V_22 . V_25 . V_26 , V_192 ) ;
}
static int F_172 ( struct V_6 * V_7 , T_8 V_337 )
{
int V_61 ;
...
static int F_173 ( enum V_268 type , T_8 * V_269 ,
struct V_232 * V_134 ,
void * V_231 )
{
...
return 0 ;
V_340 = F_172 ( V_77 -> V_7 , V_229 -> V_250 ) - 1 ;
if ( V_340 < 0 )
return V_340 ;
...
F_174 ( L_51 , V_229 , V_229 -> V_234 ) ;
return 0 ;
}
static int F_176 ( enum V_268 type , T_8 * V_269 ,
struct V_232 * V_134 ,
void * V_231 )
{
struct V_1 * V_77 = V_231 ;
...
int V_222 = F_177 ( V_77 -> V_351 , & V_77 -> V_4 ) ;
if ( F_12 ( V_222 < 0 ) )
return V_222 ;
...
static int F_178 ( enum V_276 type ,
struct V_278 * V_286 , void * V_17 ,
unsigned V_18 , void * V_231 )
{
struct V_1 * V_77 = V_231 ;
...
V_360 -> type = F_159 ( V_134 -> V_299 ) ;
V_360 -> V_364 = F_8 ( V_134 -> V_302 ) ;
V_360 -> V_106 = F_159 ( * ( T_12 * )
...
++ V_191 -> V_355 -> V_370 ;
F_182 ( & V_360 -> V_371 , & V_191 -> V_355 -> V_360 ) ;
}
break;
default:
F_16 ( L_32 , type ) ;
...
static inline struct V_372 * F_183 ( struct V_2 * V_3 ,
struct V_373 * V_374 )
{
...
if ( ! V_375 -> V_381 ) {
V_20 = F_132 ( V_77 -> V_7 , V_374 -> V_214 ) ;
if ( V_20 )
return F_100 ( V_20 ) ;
}
V_375 -> V_381 ++ ;
...
static int F_186 ( struct V_373 * V_374 ,
struct V_2 * V_3 )
{
struct V_1 * V_77 = F_1 ( V_3 ) ;
struct V_6 * V_7 = V_77 -> V_7 ;
const int V_382 = ! ! V_77 -> V_7 -> V_208 ;
const int V_383 = F_187 ( V_77 -> V_29 ) &&
V_77 -> V_7 -> V_209 ;
const int V_384 = F_188 ( V_77 -> V_29 ) &&
V_77 -> V_7 -> V_210 ;
int V_385 , V_386 , V_387 , V_20 , V_61 ;
F_163 ( V_272 ) ;
F_189 ( V_272 , struct V_89 , V_228 , V_7 -> V_202 ) ;
F_189 ( V_272 , struct V_232 * , V_388 ,
V_382 ? V_7 -> V_208 + 1 : 0 ) ;
F_189 ( V_272 , struct V_232 * , V_389 ,
V_383 ? V_7 -> V_209 + 1 : 0 ) ;
F_189 ( V_272 , struct V_232 * , V_390 ,
V_384 ? V_7 -> V_210 + 1 : 0 ) ;
F_189 ( V_272 , short , V_391 , V_7 -> V_212 ) ;
F_189 ( V_272 , struct V_352 , V_353 ,
V_374 -> V_214 -> V_392 ? V_7 -> V_212 : 0 ) ;
F_189 ( V_272 , char [ 16 ] , V_393 ,
V_374 -> V_214 -> V_392 ? V_7 -> V_212 : 0 ) ;
F_189 ( V_272 , struct V_394 , V_355 ,
V_374 -> V_214 -> V_392 ? V_7 -> V_212 : 0 ) ;
F_189 ( V_272 , struct V_359 , V_360 ,
V_7 -> V_303 ) ;
F_189 ( V_272 , char , V_361 ,
V_7 -> V_304 ) ;
F_189 ( V_272 , char , V_362 ,
V_7 -> V_305 ) ;
F_189 ( V_272 , char , V_206 , V_7 -> V_207 ) ;
char * V_322 ;
F_20 () ;
if ( F_12 ( ! ( V_382 | V_383 | V_384 ) ) )
return - V_347 ;
V_322 = F_124 ( F_165 ( V_272 ) , V_68 ) ;
if ( F_12 ( ! V_322 ) )
return - V_69 ;
V_7 -> V_363 = F_166 ( V_322 , V_272 , V_360 ) ;
V_7 -> V_365 =
F_166 ( V_322 , V_272 , V_361 ) ;
V_7 -> V_366 =
F_166 ( V_322 , V_272 , V_362 ) ;
memcpy ( F_166 ( V_322 , V_272 , V_206 ) , V_7 -> V_206 ,
V_7 -> V_207 ) ;
memset ( F_166 ( V_322 , V_272 , V_391 ) , 0xff , V_395 ) ;
for ( V_20 = V_7 -> V_202 ; V_20 ; -- V_20 ) {
struct V_89 * V_39 ;
V_39 = F_166 ( V_322 , V_272 , V_228 ) ;
V_39 [ V_20 ] . V_130 = - 1 ;
}
V_77 -> V_228 = F_166 ( V_322 , V_272 , V_228 ) ;
V_77 -> V_350 = F_166 ( V_322 , V_272 , V_391 ) ;
if ( F_39 ( V_382 ) ) {
V_77 -> V_4 . V_344 = F_166 ( V_322 , V_272 , V_388 ) ;
V_385 = F_154 ( V_7 -> V_208 ,
F_166 ( V_322 , V_272 , V_206 ) ,
V_396 ,
F_173 , V_77 ) ;
if ( F_12 ( V_385 < 0 ) ) {
V_20 = V_385 ;
...
if ( F_39 ( V_383 ) ) {
V_77 -> V_4 . V_343 = F_166 ( V_322 , V_272 , V_389 ) ;
V_386 = F_154 ( V_7 -> V_209 ,
F_166 ( V_322 , V_272 , V_206 ) + V_385 ,
V_396 - V_385 ,
F_173 , V_77 ) ;
if ( F_12 ( V_386 < 0 ) ) {
V_20 = V_386 ;
...
if ( F_39 ( V_384 ) ) {
V_77 -> V_4 . V_342 = F_166 ( V_322 , V_272 , V_390 ) ;
V_387 = F_154 ( V_7 -> V_210 ,
F_166 ( V_322 , V_272 , V_206 ) + V_385 + V_386 ,
V_396 - V_385 - V_386 ,
F_173 , V_77 ) ;
if ( F_12 ( V_387 < 0 ) ) {
V_20 = V_387 ;
...
V_20 = F_154 ( V_7 -> V_208 +
( V_383 ? V_7 -> V_209 : 0 ) +
( V_384 ? V_7 -> V_210 : 0 ) ,
F_166 ( V_322 , V_272 , V_206 ) , V_396 ,
F_176 , V_77 ) ;
if ( F_12 ( V_20 < 0 ) )
goto error;
V_77 -> V_4 . V_353 = F_166 ( V_322 , V_272 , V_353 ) ;
if ( V_374 -> V_214 -> V_392 )
for ( V_61 = 0 ; V_61 < V_7 -> V_212 ; ++ V_61 ) {
struct V_394 * V_134 ;
V_134 = V_77 -> V_4 . V_353 [ V_61 ] . V_355 =
F_166 ( V_322 , V_272 , V_355 ) +
V_61 * sizeof( struct V_394 ) ;
V_134 -> V_356 =
F_166 ( V_322 , V_272 , V_393 ) + V_61 * 16 ;
F_190 ( & V_134 -> V_360 ) ;
}
V_20 = F_158 ( V_7 -> V_316 ,
F_166 ( V_322 , V_272 , V_206 ) +
V_385 + V_386 + V_387 ,
...
struct V_2 * V_3 )
{
struct V_372 * V_375 = F_183 ( V_3 , V_374 ) ;
if ( F_23 ( V_375 ) )
return F_24 ( V_375 ) ;
return F_186 ( V_374 , V_3 ) ;
}
static void F_192 ( struct V_91 * V_92 )
{
...
break;
case V_407 :
V_20 = F_196 ( V_77 , F_8 ( V_402 -> V_282 ) ) ;
if ( F_12 ( V_20 < 0 ) )
return V_20 ;
if ( V_77 -> V_7 -> V_224 & V_225 )
...
F_141 ( & V_7 -> V_22 . V_25 . V_26 , V_192 ) ;
V_7 -> V_22 . V_23 = * V_402 ;
V_7 -> V_22 . V_23 . V_282 = F_197 ( V_20 ) ;
F_169 ( V_7 , V_62 ) ;
F_143 ( & V_7 -> V_22 . V_25 . V_26 , V_192 ) ;
return 0 ;
}
...
{
F_20 () ;
F_171 ( F_1 ( V_3 ) -> V_7 , V_331 ) ;
}
static void F_199 ( struct V_2 * V_3 )
{
F_20 () ;
F_171 ( F_1 ( V_3 ) -> V_7 , V_330 ) ;
}
static int F_196 ( struct V_1 * V_77 , T_8 V_130 )
{
...
static struct V_197 * F_200 ( const char * V_163 )
{
struct V_197 * V_379 ;
F_201 (dev, &ffs_devices, entry) {
...
static struct V_197 * F_202 ( void )
{
struct V_197 * V_379 ;
if ( F_203 ( & V_411 ) ) {
V_379 = F_204 ( & V_411 , struct V_197 , V_371 ) ;
if ( V_379 -> V_412 )
return V_379 ;
}
return NULL ;
}
static struct V_197 * F_205 ( const char * V_163 )
{
struct V_197 * V_379 ;
V_379 = F_202 () ;
if ( V_379 )
...
static inline struct V_372 * F_206 ( struct V_413 * V_414 )
{
return F_2 ( F_207 ( V_414 ) , struct V_372 ,
V_377 . V_415 ) ;
}
static void F_208 ( struct V_413 * V_414 )
{
struct V_372 * V_183 = F_206 ( V_414 ) ;
F_209 ( & V_183 -> V_377 ) ;
}
static void F_210 ( struct V_416 * V_3 )
{
struct V_372 * V_183 ;
V_183 = F_211 ( V_3 ) ;
F_184 () ;
...
static int F_213 ( struct V_416 * V_376 , const char * V_163 )
{
struct V_372 * V_183 ;
char * V_39 ;
const char * V_417 ;
...
static struct V_416 * F_216 ( void )
{
struct V_372 * V_183 ;
struct V_197 * V_379 ;
V_183 = F_124 ( sizeof( * V_183 ) , V_68 ) ;
if ( ! V_183 )
return F_100 ( - V_69 ) ;
V_183 -> V_377 . V_421 = F_213 ;
V_183 -> V_377 . V_422 = F_210 ;
F_184 () ;
V_379 = F_217 () ;
F_185 () ;
if ( F_23 ( V_379 ) ) {
...
static void F_220 ( struct V_373 * V_374 ,
struct V_2 * V_3 )
{
struct V_1 * V_77 = F_1 ( V_3 ) ;
struct V_6 * V_7 = V_77 -> V_7 ;
...
static struct V_2 * F_221 ( struct V_416 * V_376 )
{
struct V_1 * V_77 ;
F_20 () ;
V_77 = F_124 ( sizeof( * V_77 ) , V_68 ) ;
if ( F_12 ( ! V_77 ) )
return F_100 ( - V_69 ) ;
V_77 -> V_4 . V_163 = L_59 ;
V_77 -> V_4 . V_424 = F_191 ;
V_77 -> V_4 . V_425 = F_220 ;
V_77 -> V_4 . V_426 = F_193 ;
V_77 -> V_4 . V_427 = F_194 ;
V_77 -> V_4 . V_23 = F_195 ;
V_77 -> V_4 . V_428 = F_198 ;
V_77 -> V_4 . V_429 = F_199 ;
V_77 -> V_4 . V_430 = F_219 ;
return & V_77 -> V_4 ;
}
static struct V_197 * F_217 ( void )
{
struct V_197 * V_379 ;
int V_20 ;
if ( F_202 () )
return F_100 ( - V_72 ) ;
V_379 = F_124 ( sizeof( * V_379 ) , V_68 ) ;
if ( ! V_379 )
return F_100 ( - V_69 ) ;
if ( F_222 ( & V_411 ) ) {
V_20 = F_110 () ;
...
F_223 ( & V_379 -> V_371 , & V_411 ) ;
return V_379 ;
}
static int F_215 ( struct V_197 * V_379 , const char * V_163 )
{
struct V_197 * V_431 ;
V_431 = F_200 ( V_163 ) ;
if ( V_431 )
...
int F_224 ( struct V_197 * V_379 , const char * V_163 )
{
int V_20 ;
F_184 () ;
V_20 = F_215 ( V_379 , V_163 ) ;
F_185 () ;
return V_20 ;
}
int F_225 ( struct V_197 * V_379 )
{
int V_20 ;
V_20 = 0 ;
F_184 () ;
...
static void F_212 ( struct V_197 * V_379 )
{
F_226 ( & V_379 -> V_371 ) ;
if ( V_379 -> V_420 )
F_33 ( V_379 -> V_163 ) ;
...
static void * F_104 ( const char * V_193 )
{
struct V_197 * V_197 ;
F_20 () ;
F_184 () ;
...
goto V_118;
V_435 -> V_380 = false ;
if ( F_228 ( V_437 , & V_7 -> V_192 ) &&
V_435 -> V_438 )
V_435 -> V_438 ( V_7 ) ;
if ( ! V_435 -> V_183 || V_435 -> V_183 -> V_378
|| ! V_435 -> V_183 -> V_377 . V_415 . V_439 . V_440 )
goto V_118;
F_229 ( V_435 -> V_183 ->
...
static int F_21 ( struct V_42 * V_42 , unsigned V_441 )
{
return V_441
? F_39 ( F_230 ( V_42 ) ) ? 0 : - V_67
: F_231 ( V_42 ) ;
}
...
if ( F_12 ( ! V_17 ) )
return F_100 ( - V_69 ) ;
if ( F_12 ( F_232 ( V_17 , V_27 , V_18 ) ) ) {
F_33 ( V_17 ) ;
return F_100 ( - V_65 ) ;
}
F_16 ( L_60 ) ;
F_174 ( L_58 , V_17 , V_18 ) ;
return V_17 ;
}
