...
int V_13 = 0 ;
struct V_1 * V_6 ;
V_6 = F_46 ( & V_93 -> V_5 , sizeof( * V_6 ) , V_96 ) ;
if ( ! V_6 ) {
V_13 = - V_97 ;
goto V_98;
}
F_47 ( V_93 , V_6 ) ;
V_6 -> V_5 = & V_93 -> V_5 ;
V_6 -> V_11 = V_93 -> V_5 . V_99 ;
V_6 -> V_100 . V_101 = F_48 ( & V_93 -> V_5 ) ;
V_6 -> V_100 . type = V_102 ;
V_6 -> V_100 . V_103 = V_104 ;
V_6 -> V_100 . V_105 = F_49 ( V_104 ) ;
V_6 -> V_100 . V_106 = F_28 ;
V_95 . V_107 = V_6 ;
V_6 -> V_108 = F_50 ( & V_93 -> V_5 , & V_6 -> V_100 ,
& V_95 ) ;
if ( F_51 ( V_6 -> V_108 ) ) {
F_21 ( V_6 -> V_5 , L_6 ) ;
V_13 = F_52 ( V_6 -> V_108 ) ;
...
V_13 = F_53 ( & V_6 -> V_108 -> V_5 . V_84 , & V_109 ) ;
if ( V_13 ) {
F_21 ( V_6 -> V_5 , L_7 ) ;
goto V_110;
}
V_13 = F_54 ( & V_6 -> V_108 -> V_5 . V_84 ,
& V_111 ) ;
if ( V_13 ) {
F_21 ( V_6 -> V_5 ,
L_8 ) ;
...
return 0 ;
V_114:
F_55 ( & V_6 -> V_108 -> V_5 . V_84 ,
& V_111 ) ;
V_112:
F_56 ( & V_6 -> V_108 -> V_5 . V_84 , & V_109 ) ;
V_110:
F_57 ( V_6 -> V_108 ) ;
V_98:
return V_13 ;
