...
unsigned long V_120 = F_107 ( V_117 ) ;
unsigned long V_121 = V_122 ;
unsigned long V_123 ;
if ( F_108 ( V_121 , V_120 ) )
V_123 = 0 ;
else
V_123 = V_120 - V_121 ;
V_50 = F_109 ( V_4 -> V_63 ,
...
struct V_127 * V_128 , V_60 V_115 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_50 = 0 ;
F_29 ( & V_2 -> V_37 ) ;
if ( ! F_111 ( & V_128 -> V_129 . V_130 ) ) {
V_50 = - V_12 ;
} else if ( V_115 > V_4 -> V_124 ) {
V_128 -> V_115 = V_115 ;
F_112 ( & V_128 -> V_129 . V_130 , & V_4 -> V_66 ) ;
} else {
F_113 ( V_4 -> V_34 , & V_128 -> V_129 ) ;
}
F_30 ( & V_2 -> V_37 ) ;
return V_50 ;
}
void F_114 ( struct V_1 * V_2 , V_60 V_115 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
F_29 ( & V_2 -> V_37 ) ;
V_4 -> V_124 = F_115 ( V_115 , V_4 -> V_124 ) ;
while ( ! F_111 ( & V_4 -> V_66 ) ) {
struct V_127 * V_128 ;
V_128 = F_116 ( & V_4 -> V_66 ,
struct V_127 , V_129 . V_130 ) ;
if ( V_128 -> V_115 > V_4 -> V_124 )
break;
F_117 ( & V_128 -> V_129 . V_130 ) ;
F_113 ( V_4 -> V_34 , & V_128 -> V_129 ) ;
}
F_30 ( & V_2 -> V_37 ) ;
F_118 ( & V_4 -> V_63 ) ;
}
void F_119 ( struct V_131 * V_129 )
{
struct V_127 * V_128 = F_120 ( V_129 , struct V_127 , V_129 ) ;
V_128 -> V_132 ( V_128 ) ;
}
static int F_121 ( struct V_1 * V_2 , void * V_26 ,
struct V_78 * V_79 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_133 * args = V_26 ;
struct V_32 * V_33 ;
if ( args -> V_134 != V_135 )
return - V_12 ;
V_33 = V_4 -> V_33 ;
if ( ! V_33 )
return - V_91 ;
return V_33 -> V_35 -> V_136 ( V_33 , args -> V_137 , & args -> V_138 ) ;
}
static int F_122 ( struct V_1 * V_2 , void * V_26 ,
struct V_78 * V_79 )
{
struct V_139 * args = V_26 ;
if ( args -> V_61 & ~ V_140 ) {
F_105 ( L_29 , args -> V_61 ) ;
return - V_12 ;
}
return F_123 ( V_2 , V_79 , args -> V_19 ,
args -> V_61 , & args -> V_141 ) ;
}
static int F_124 ( struct V_1 * V_2 , void * V_26 ,
struct V_78 * V_79 )
{
...
int V_50 ;
if ( args -> V_145 & ~ V_146 ) {
F_105 ( L_30 , args -> V_145 ) ;
return - V_12 ;
}
V_144 = F_125 ( V_2 , V_79 , args -> V_141 ) ;
if ( ! V_144 )
return - V_147 ;
V_50 = F_126 ( V_144 , args -> V_145 , & F_127 ( args -> V_117 ) ) ;
F_128 ( V_144 ) ;
return V_50 ;
}
static int F_129 ( struct V_1 * V_2 , void * V_26 ,
struct V_78 * V_79 )
{
...
static int F_131 ( struct V_1 * V_2 , void * V_26 ,
struct V_78 * V_79 )
{
struct V_149 * args = V_26 ;
struct V_143 * V_144 ;
int V_50 = 0 ;
if ( args -> V_150 )
return - V_12 ;
...
if ( args -> V_150 ) {
F_105 ( L_31 , args -> V_150 ) ;
return - V_12 ;
}
return F_104 ( V_2 , args -> V_115 ,
& F_127 ( args -> V_117 ) ) ;
}
static int F_134 ( struct V_47 * V_2 )
{
struct V_1 * V_153 = F_135 ( V_2 ) ;
F_136 ( V_153 ) ;
return 0 ;
}
static int F_137 ( struct V_47 * V_2 )
{
struct V_1 * V_153 = F_135 ( V_2 ) ;
F_138 ( V_153 ) ;
return 0 ;
}
static int F_139 ( struct V_47 * V_2 , void * V_26 )
{
return V_2 -> V_49 == V_26 ;
}
static int F_140 ( struct V_47 * V_2 , struct V_154 * * V_155 ,
const char * V_15 )
{
struct V_51 * V_156 = V_2 -> V_49 ;
unsigned V_157 ;
for ( V_157 = 0 ; ; V_157 ++ ) {
struct V_51 * V_52 ;
V_52 = F_41 ( V_156 , V_15 , V_157 ) ;
if ( ! V_52 )
break;
F_141 ( V_2 , V_155 , F_139 , V_52 ) ;
}
return 0 ;
}
static int F_142 ( struct V_47 * V_2 , void * V_26 )
{
return V_2 == V_26 ;
}
static int F_143 ( struct V_47 * V_2 )
{
return F_144 ( & V_158 , F_145 ( V_2 ) ) ;
}
static void F_146 ( struct V_47 * V_2 )
{
F_147 ( F_148 ( F_145 ( V_2 ) ) ) ;
}
static int F_149 ( struct V_13 * V_14 )
{
struct V_154 * V_48 = NULL ;
#ifdef F_38
F_140 ( & V_14 -> V_2 , & V_48 , L_32 ) ;
F_140 ( & V_14 -> V_2 , & V_48 , L_33 ) ;
#else
...
int V_157 ;
F_82 ( L_36 ) ;
for ( V_157 = 0 ; V_157 < F_6 ( V_159 ) ; V_157 ++ ) {
struct V_47 * V_2 ;
V_2 = F_150 ( & V_55 ,
NULL , V_159 [ V_157 ] ) ;
if ( ! V_2 ) {
F_48 ( & V_14 -> V_2 , L_37 , V_159 [ V_157 ] ) ;
return - V_160 ;
}
F_141 ( & V_14 -> V_2 , & V_48 , F_142 , V_2 ) ;
}
#endif
V_14 -> V_2 . V_161 = F_151 ( 32 ) ;
return F_152 ( & V_14 -> V_2 , & V_162 , V_48 ) ;
}
static int F_153 ( struct V_13 * V_14 )
{
F_154 ( & V_14 -> V_2 , & V_162 ) ;
return 0 ;
}
