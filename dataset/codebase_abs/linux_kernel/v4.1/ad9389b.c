...
struct V_123 V_124 ;
struct V_1 * V_19 = F_1 ( V_3 ) ;
V_124 . V_121 = V_19 -> V_125 ;
F_50 ( V_3 , V_126 , ( void * ) & V_124 ) ;
}
...
F_56 ( V_19 -> V_128 , F_13 ( V_3 ) ? 0x1 : 0x0 ) ;
F_56 ( V_19 -> V_129 , F_14 ( V_3 ) ? 0x1 : 0x0 ) ;
F_56 ( V_19 -> V_130 , V_19 -> V_56 . V_62 ? 0x1 : 0x0 ) ;
F_21 ( V_19 -> V_52 ) ;
F_21 ( V_19 -> V_50 ) ;
}
...
F_12 ( 1 , V_20 , V_3 , L_79 , V_14 , V_131 ) ;
F_54 ( V_3 ) ;
F_57 ( & V_19 -> V_115 ) ;
memset ( & V_19 -> V_56 , 0 , sizeof( struct V_55 ) ) ;
F_27 ( V_3 , false ) ;
...
if ( V_107 )
return true ;
for ( V_13 = 0 ; V_13 < F_61 ( V_134 ) ; V_13 ++ )
if ( V_100 [ V_13 ] != V_134 [ V_13 ] )
return false ;
return true ;
}
...
struct V_116 V_117 ;
int V_107 ;
T_1 V_135 = F_4 ( V_3 , 0xc5 ) ;
F_12 ( 1 , V_20 , V_3 , L_80 ,
V_14 , V_127 - V_19 -> V_56 . V_118 ) ;
if ( ! ( V_135 & V_136 ) )
return false ;
V_107 = F_4 ( V_3 , 0xc4 ) ;
if ( V_107 >= V_137 ) {
...
static int F_63 ( struct V_9 * V_10 , const struct V_138 * V_49 )
{
const struct V_86 V_139 = V_140 ;
struct V_1 * V_19 ;
struct V_73 * V_74 = V_10 -> V_141 . V_142 ;
struct V_143 * V_7 ;
struct V_2 * V_3 ;
int V_144 = - V_145 ;
if ( ! F_64 ( V_10 -> V_146 , V_147 ) )
return - V_145 ;
F_65 ( 1 , V_20 , V_10 , L_86 ,
V_10 -> V_148 << 1 ) ;
V_19 = F_66 ( & V_10 -> V_141 , sizeof( * V_19 ) , V_149 ) ;
if ( ! V_19 )
return - V_150 ;
if ( V_74 == NULL ) {
F_67 ( V_10 , L_87 ) ;
...
V_19 -> V_50 -> V_163 = true ;
V_19 -> V_128 -> V_163 = true ;
V_19 -> V_129 -> V_163 = true ;
V_19 -> V_130 -> V_163 = true ;
V_19 -> V_52 -> V_163 = true ;
V_19 -> V_93 . V_41 = V_164 ;
V_144 = F_72 ( & V_3 -> V_165 , 1 , & V_19 -> V_93 , 0 ) ;
if ( V_144 )
goto V_162;
...
V_19 -> V_21 = F_73 ( V_10 -> V_146 , ( 0x7e >> 1 ) ) ;
if ( V_19 -> V_21 == NULL ) {
F_9 ( V_3 , L_90 ) ;
V_144 = - V_150 ;
goto V_166;
}
V_19 -> V_119 = F_74 ( V_3 -> V_71 ) ;
if ( V_19 -> V_119 == NULL ) {
F_9 ( V_3 , L_91 ) ;
V_144 = - V_150 ;
goto V_167;
}
F_75 ( & V_19 -> V_115 , F_47 ) ;
V_19 -> V_39 = V_139 ;
F_62 ( V_3 ) ;
F_29 ( V_3 , true ) ;
F_25 ( V_3 , L_92 , V_10 -> V_71 ,
V_10 -> V_148 << 1 , V_10 -> V_146 -> V_71 ) ;
return 0 ;
V_167:
F_76 ( V_19 -> V_21 ) ;
V_166:
