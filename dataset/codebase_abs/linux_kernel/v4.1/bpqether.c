...
static int F_58 ( struct V_1 * V_103 )
{
int V_104 ;
struct V_1 * V_105 ;
struct V_10 * V_11 ;
V_105 = F_59 ( sizeof( struct V_10 ) , L_7 , V_106 ,
F_56 ) ;
if ( ! V_105 )
return - V_107 ;
V_11 = F_6 ( V_105 ) ;
...
V_11 -> V_12 = V_103 ;
V_11 -> V_13 = V_105 ;
memcpy ( V_11 -> V_44 , V_108 , sizeof( V_109 ) ) ;
memcpy ( V_11 -> V_30 , V_108 , sizeof( V_109 ) ) ;
V_104 = F_61 ( V_105 ) ;
if ( V_104 )
goto error;
F_3 ( V_105 ) ;
...
static void F_64 ( struct V_1 * V_105 )
{
struct V_10 * V_11 = F_6 ( V_105 ) ;
F_63 ( V_11 -> V_12 ) ;
F_65 ( & V_11 -> V_81 ) ;
F_66 ( V_105 ) ;
}
static int F_67 ( struct V_110 * V_111 ,
unsigned long V_112 , void * V_22 )
{
...
F_80 () ;
while ( ! F_81 ( & V_80 ) ) {
V_11 = F_48 ( V_80 . V_125 , struct V_10 , V_81 ) ;
F_64 ( V_11 -> V_13 ) ;
}
F_82 () ;
}
