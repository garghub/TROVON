...
V_271 = F_148 ( V_108 -> V_92 . V_279 , & V_212 -> V_280 . V_38 , 1 ) ;
...
memset ( F_92 ( V_2 ) , 0 , sizeof( struct V_284 ) ) ;
...
static int F_159 ( struct V_286 * V_287 , unsigned long V_288 , void * V_289 )
{
struct V_40 * V_5 = F_160 ( V_289 ) ;
struct V_108 * V_108 = F_34 ( V_5 ) ;
struct V_56 * V_109 ;
switch ( V_288 ) {
case V_290 :
...
static void F_164 ( struct V_295 * V_296 ,
...
int F_166 ( struct V_295 * V_296 , int V_305 , void T_7 * V_306 , T_4 * V_307 , T_8 * V_308 )
{
...
F_164 ( V_296 , L_52 , V_5 ? V_5 -> V_183 : L_53 ) ;
if ( strcmp ( V_296 -> V_304 , L_50 ) == 0 )
V_160 = F_167 ( V_296 , V_305 , V_306 , V_307 , V_308 ) ;
else if ( strcmp ( V_296 -> V_304 , L_51 ) == 0 )
V_160 = F_168 ( V_296 , V_305 ,
V_306 , V_307 , V_308 ) ;
else if ( ( strcmp ( V_296 -> V_304 , L_54 ) == 0 ) ||
( strcmp ( V_296 -> V_304 , L_55 ) == 0 ) )
V_160 = F_169 ( V_296 , V_305 ,
V_306 , V_307 , V_308 ) ;
else
V_160 = - 1 ;
if ( V_305 && V_160 == 0 && V_5 && ( V_109 = F_22 ( V_5 ) ) != NULL ) {
if ( V_296 -> V_3 == & F_80 ( V_109 -> V_61 , V_249 ) )
V_109 -> V_61 -> V_248 =
