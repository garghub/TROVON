...
int F_18 ( T_3 V_40 , int type , T_1 V_8 )
{
T_2 V_34 ;
V_34 = F_13 ( V_40 , type , V_8 ) ;
return F_14 ( V_34 , V_8 ) ;
}
static int F_19 ( struct V_6 * V_7 , T_1 V_50 ,
T_4 * V_51 , int * V_52 )
{
...
static int F_20 ( T_1 V_50 , T_4 * V_51 )
{
struct V_6 * V_57 ;
unsigned long V_33 , V_7 ;
struct V_1 * V_2 ;
...
static int F_21 ( T_3 V_40 , T_1 V_50 ,
T_4 * V_51 )
{
struct V_41 V_42 = { V_43 , NULL } ;
struct V_6 * V_12 ;
...
V_12 = (struct V_6 * ) V_45 -> V_42 . V_46 ;
if ( V_12 -> type == V_58 )
F_19 ( V_12 , V_50 , V_51 , & V_9 ) ;
exit:
F_12 ( V_42 . V_46 ) ;
return V_9 ;
}
int F_22 ( T_3 V_40 , T_1 V_50 , T_4 * V_51 )
{
int V_9 ;
V_9 = F_21 ( V_40 , V_50 , V_51 ) ;
if ( V_9 == - 1 )
V_9 = F_20 ( V_50 , V_51 ) ;
return V_9 ;
}
