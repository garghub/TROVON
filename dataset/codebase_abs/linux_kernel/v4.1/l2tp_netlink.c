...
goto V_88;
if ( ( V_9 -> V_6 [ 0 ] &&
F_53 ( V_16 , V_12 , V_9 -> V_6 ) ) ||
( V_9 -> V_140 &&
F_54 ( V_16 , V_139 , V_9 -> V_140 ,
& V_9 -> V_141 [ 0 ] ) ) ||
( V_9 -> V_143 &&
F_54 ( V_16 , V_142 , V_9 -> V_143 ,
& V_9 -> V_144 [ 0 ] ) ) ||
...
static int F_58 ( struct V_15 * V_16 , struct V_117 * V_118 )
{
struct V_10 * V_10 = F_44 ( V_16 -> V_82 ) ;
struct V_1 * V_9 ;
struct V_7 * V_8 = NULL ;
...
int F_60 ( enum V_177 V_128 , const struct V_159 * V_178 )
{
int V_19 ;
V_19 = - V_41 ;
if ( V_128 >= V_129 )
