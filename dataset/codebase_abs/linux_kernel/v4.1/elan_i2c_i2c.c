...
static int F_26 ( struct V_1 * V_2 , enum V_64 * V_34 )
{
int error ;
T_1 V_65 ;
T_2 V_4 [ 3 ] ;
error = F_5 ( V_2 , V_66 , V_4 ) ;
if ( error ) {
F_6 ( & V_2 -> V_18 ,
L_20 ,
error ) ;
...
V_65 = F_13 ( ( T_3 * ) V_4 ) ;
F_27 ( & V_2 -> V_18 , L_21 , V_65 ) ;
* V_34 = ( V_65 & V_67 ) ? V_68 : V_69 ;
return 0 ;
}
...
const T_2 * V_75 , T_1 V_76 , int V_77 )
{
struct V_21 * V_18 = & V_2 -> V_18 ;
T_2 V_78 [ V_79 + 4 ] ;
T_2 V_4 [ 3 ] ;
...
V_78 [ 0 ] = V_81 ;
V_78 [ 1 ] = V_82 ;
memcpy ( & V_78 [ 2 ] , V_75 , V_79 ) ;
F_32 ( V_76 , & V_78 [ V_79 + 2 ] ) ;
V_13 = F_33 ( V_2 , V_78 , sizeof( V_78 ) ) ;
if ( V_13 != sizeof( V_78 ) ) {
error = V_13 < 0 ? V_13 : - V_15 ;
F_6 ( V_18 , L_27 , V_77 , error ) ;
return error ;
}
F_9 ( 20 ) ;
error = F_5 ( V_2 , V_66 , V_4 ) ;
...
static int F_40 ( struct V_1 * V_2 , T_2 * V_89 )
{
int V_5 ;
V_5 = F_10 ( V_2 , V_89 , V_90 ) ;
if ( V_5 < 0 ) {
