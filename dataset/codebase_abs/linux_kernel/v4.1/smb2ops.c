...
static int
F_79 ( const unsigned int V_50 , struct V_55 * V_56 ,
struct V_143 * V_144 )
{
return F_80 ( V_50 , V_56 , V_144 -> V_78 . V_85 ,
V_144 -> V_78 . V_86 ) ;
}
static int
F_81 ( const unsigned int V_50 , struct V_55 * V_56 ,
const char * V_210 , struct V_90 * V_91 ,
struct V_77 * V_78 , T_10 V_211 ,
struct V_212 * V_213 )
{
T_2 * V_93 ;
int V_13 ;
T_4 V_73 = V_74 ;
struct V_75 V_76 ;
V_93 = F_41 ( V_210 , V_91 ) ;
if ( ! V_93 )
return - V_94 ;
V_76 . V_56 = V_56 ;
V_76 . V_79 = V_80 | V_214 ;
V_76 . V_81 = V_82 ;
V_76 . V_83 = 0 ;
V_76 . V_78 = V_78 ;
V_76 . V_84 = false ;
...
struct V_212 * V_213 )
{
return F_82 ( V_50 , V_56 , V_78 -> V_85 ,
V_78 -> V_86 , 0 , V_213 ) ;
}
static int
...
static int
F_86 ( struct V_55 * V_56 , struct V_77 * V_78 ,
struct V_145 * V_146 )
{
if ( V_56 -> V_52 -> V_2 -> V_61 & V_219 )
return F_87 ( 0 , V_56 , V_146 -> V_220 ,
F_88 ( V_146 ) ) ;
return F_89 ( 0 , V_56 , V_78 -> V_85 ,
V_78 -> V_86 ,
F_90 ( V_146 ) ? 1 : 0 ) ;
}
static int
F_91 ( const unsigned int V_50 , struct V_55 * V_56 ,
struct V_221 * V_37 )
{
int V_13 ;
T_2 V_72 = 0 ;
...
return V_13 ;
V_37 -> V_222 = V_223 ;
V_13 = F_92 ( V_50 , V_56 , V_78 . V_85 , V_78 . V_86 ,
V_37 ) ;
F_38 ( V_50 , V_56 , V_78 . V_85 , V_78 . V_86 ) ;
return V_13 ;
}
static bool
F_93 ( struct V_143 * V_224 , struct V_143 * V_225 )
{
return V_224 -> V_78 . V_85 == V_225 -> V_78 . V_85 &&
V_224 -> V_78 . V_86 == V_225 -> V_78 . V_86 ;
}
static int
F_94 ( const unsigned int V_50 , struct V_143 * V_144 , T_1 V_226 ,
T_1 V_217 , T_8 type , int V_227 , int V_228 , bool V_229 )
{
if ( V_228 && ! V_227 )
type = V_230 ;
return F_95 ( V_50 , F_60 ( V_144 -> V_148 ) ,
V_144 -> V_78 . V_85 , V_144 -> V_78 . V_86 ,
V_231 -> V_232 , V_217 , V_226 , type , V_229 ) ;
}
static void
F_96 ( struct V_198 * V_198 , struct V_77 * V_78 )
{
memcpy ( V_78 -> V_220 , F_58 ( V_198 ) -> V_220 , V_233 ) ;
}
static void
F_97 ( struct V_198 * V_198 , struct V_77 * V_78 )
{
memcpy ( F_58 ( V_198 ) -> V_220 , V_78 -> V_220 , V_233 ) ;
}
static void
F_98 ( struct V_77 * V_78 )
{
F_99 ( V_78 -> V_220 , V_233 ) ;
}
static int
F_100 ( const unsigned int V_50 , struct V_55 * V_56 ,
const char * V_92 , char * * V_234 ,
struct V_90 * V_91 )
{
int V_13 ;
T_2 * V_93 ;
...
V_76 . V_78 = & V_78 ;
V_76 . V_84 = false ;
V_13 = F_35 ( V_50 , & V_76 , V_93 , & V_73 , NULL , & V_236 ) ;
if ( ! V_13 || ! V_236 ) {
F_42 ( V_93 ) ;
return - V_33 ;
}
...
static long F_103 ( struct V_247 * V_247 , struct V_55 * V_56 ,
T_11 V_226 , T_11 V_165 , bool V_248 )
{
struct V_198 * V_198 ;
struct V_145 * V_200 ;
struct V_143 * V_144 = V_247 -> V_249 ;
struct V_250 V_251 ;
long V_13 ;
unsigned int V_50 ;
V_50 = F_104 () ;
...
V_251 . V_253 = F_67 ( V_226 ) ;
V_251 . V_254 = F_67 ( V_226 + V_165 ) ;
V_13 = F_32 ( V_50 , V_56 , V_144 -> V_78 . V_85 ,
V_144 -> V_78 . V_86 , V_255 ,
true , ( char * ) & V_251 ,
sizeof( struct V_250 ) , NULL , NULL ) ;
F_106 ( V_50 ) ;
return V_13 ;
}
static long F_107 ( struct V_247 * V_247 , struct V_55 * V_56 ,
...
static long F_108 ( struct V_247 * V_247 , struct V_55 * V_56 ,
T_11 V_256 , T_11 V_165 , bool V_248 )
{
struct V_198 * V_198 ;
struct V_145 * V_200 ;
struct V_143 * V_144 = V_247 -> V_249 ;
...
if ( V_248 == true )
return 0 ;
else if ( F_105 ( V_198 ) >= V_256 + V_165 )
return 0 ;
else
return - V_252 ;
}
if ( ( V_248 == true ) || ( F_105 ( V_198 ) >= V_256 + V_165 ) ) {
if ( ( V_256 > 8192 ) || ( V_256 + V_165 + 8192 < F_105 ( V_198 ) ) )
return - V_252 ;
...
static long F_109 ( struct V_247 * V_247 , struct V_55 * V_56 , int V_257 ,
T_11 V_256 , T_11 V_165 )
{
if ( V_257 & V_258 )
return F_107 ( V_247 , V_56 , V_256 , V_165 ) ;
else if ( V_257 & V_259 ) {
if ( V_257 & V_260 )
return F_103 ( V_247 , V_56 , V_256 , V_165 , true ) ;
return F_103 ( V_247 , V_56 , V_256 , V_165 , false ) ;
} else if ( V_257 == V_260 )
return F_108 ( V_247 , V_56 , V_256 , V_165 , true ) ;
else if ( V_257 == 0 )
return F_108 ( V_247 , V_56 , V_256 , V_165 , false ) ;
return - V_252 ;
}
static void
F_110 ( struct V_1 * V_2 ,
struct V_145 * V_146 , bool V_261 )
{
if ( V_261 )
V_2 -> V_15 -> V_149 ( V_146 , V_262 ,
0 , NULL ) ;
else
...
static void
F_113 ( struct V_145 * V_146 , T_8 V_73 ,
unsigned int V_150 , bool * V_151 )
{
unsigned int V_276 = V_146 -> V_73 ;
F_112 ( V_146 , V_73 , V_150 , V_151 ) ;
if ( V_151 ) {
* V_151 = false ;
if ( V_276 == V_269 ) {
if ( V_146 -> V_73 == V_269 &&
( V_150 - V_146 -> V_150 > 0 ) )
* V_151 = true ;
else if ( V_146 -> V_73 == V_277 &&
( V_150 - V_146 -> V_150 > 1 ) )
* V_151 = true ;
else if ( V_146 -> V_73 == V_265 &&
( V_150 - V_146 -> V_150 > 1 ) )
* V_151 = true ;
...
static char *
F_117 ( T_3 * V_220 , T_3 V_73 )
{
struct V_281 * V_37 ;
V_37 = F_45 ( sizeof( struct V_281 ) , V_101 ) ;
if ( ! V_37 )
return NULL ;
V_37 -> V_282 . V_283 = F_67 ( * ( ( T_5 * ) V_220 ) ) ;
V_37 -> V_282 . V_284 = F_67 ( * ( ( T_5 * ) ( V_220 + 8 ) ) ) ;
V_37 -> V_282 . V_285 = F_116 ( V_73 ) ;
V_37 -> V_286 . V_187 = F_118 ( F_119
( struct V_281 , V_282 ) ) ;
V_37 -> V_286 . V_188 = F_66 ( sizeof( struct V_287 ) ) ;
V_37 -> V_286 . V_288 = F_118 ( F_119
( struct V_281 , V_289 ) ) ;
V_37 -> V_286 . V_290 = F_118 ( 4 ) ;
V_37 -> V_289 [ 0 ] = 'R' ;
V_37 -> V_289 [ 1 ] = 'q' ;
V_37 -> V_289 [ 2 ] = 'L' ;
V_37 -> V_289 [ 3 ] = 's' ;
...
static char *
F_120 ( T_3 * V_220 , T_3 V_73 )
{
struct V_291 * V_37 ;
V_37 = F_45 ( sizeof( struct V_291 ) , V_101 ) ;
if ( ! V_37 )
return NULL ;
V_37 -> V_282 . V_283 = F_67 ( * ( ( T_5 * ) V_220 ) ) ;
V_37 -> V_282 . V_284 = F_67 ( * ( ( T_5 * ) ( V_220 + 8 ) ) ) ;
...
V_37 -> V_286 . V_187 = F_118 ( F_119
( struct V_291 , V_282 ) ) ;
V_37 -> V_286 . V_188 = F_66 ( sizeof( struct V_292 ) ) ;
V_37 -> V_286 . V_288 = F_118 ( F_119
( struct V_291 , V_289 ) ) ;
V_37 -> V_286 . V_290 = F_118 ( 4 ) ;
V_37 -> V_289 [ 0 ] = 'R' ;
...
return V_263 ;
return F_33 ( V_293 -> V_282 . V_285 ) ;
}
static T_4
F_122 ( void * V_37 , unsigned int * V_150 )
{
