...
static int F_177 ( struct V_1 * V_4 , struct V_255 * V_256 )
{
int V_7 = 0 ;
struct V_2 * V_2 = F_178 ( V_256 ) ;
F_21 () ;
F_92 ( & V_65 ) ;
...
struct V_255 * F_181 ( struct V_2 * V_2 , struct V_32 * V_33 )
{
struct V_1 * V_4 ;
struct V_5 V_108 = {
. V_109 = V_33 -> V_132 ? : V_133 ,
...
int F_182 ( struct V_255 * V_256 , int V_259 , char T_8 * V_260 , unsigned int V_261 )
{
int V_209 , V_223 = 0 ;
struct V_183 V_80 ;
struct V_222 V_64 ;
...
struct V_2 * V_2 = F_178 ( V_256 ) ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_2 , F_183 ( V_256 ) -> V_262 ? : V_45 ) ;
if ( ! V_4 )
return - V_77 ;
if ( V_259 != V_263 ) {
if ( V_256 != V_4 -> V_217 && ! F_184 ( V_2 -> V_264 , V_265 ) )
return - V_26 ;
}
switch ( V_259 ) {
case V_263 :
if ( V_256 -> V_266 != V_267 ||
F_185 ( V_256 ) -> V_268 != V_269 )
return - V_270 ;
if ( V_261 < sizeof( int ) )
return - V_28 ;
return F_177 ( V_4 , V_256 ) ;
case V_271 :
return F_180 ( V_256 ) ;
case V_272 :
if ( V_261 < sizeof( V_80 ) )
return - V_28 ;
if ( F_186 ( & V_80 , V_260 , sizeof( V_80 ) ) )
return - V_273 ;
if ( V_80 . V_186 >= V_182 )
return - V_251 ;
F_21 () ;
V_209 = F_116 ( V_2 , V_4 , & V_80 , V_256 == V_4 -> V_217 ) ;
F_24 () ;
return V_209 ;
case V_274 :
if ( V_261 < sizeof( T_6 ) )
return - V_28 ;
if ( F_186 ( & V_200 , V_260 , sizeof( T_6 ) ) )
return - V_273 ;
F_21 () ;
...
return - V_28 ;
if ( F_186 ( & V_64 , V_260 , sizeof( V_64 ) ) )
return - V_273 ;
if ( V_223 == 0 )
V_223 = V_64 . V_250 ;
F_21 () ;
...
int F_188 ( struct V_255 * V_256 , int V_259 , char T_8 * V_260 ,
int T_8 * V_261 )
{
int V_287 ;
int V_288 ;
...
if ( F_187 ( V_287 , V_261 ) )
return - V_273 ;
V_287 = F_189 ( int , V_287 , sizeof( int ) ) ;
if ( V_287 < 0 )
return - V_28 ;
if ( F_190 ( V_287 , V_261 ) )
return - V_273 ;
if ( F_191 ( V_260 , & V_288 , V_287 ) )
return - V_273 ;
return 0 ;
}
int F_192 ( struct V_255 * V_256 , int V_290 , void T_8 * V_11 )
{
struct V_291 V_292 ;
struct V_293 V_294 ;
struct V_69 * V_80 ;
...
switch ( V_290 ) {
case V_295 :
if ( F_186 ( & V_294 , V_11 , sizeof( V_294 ) ) )
return - V_273 ;
...
F_37 ( & V_65 ) ;
if ( F_191 ( V_11 , & V_294 , sizeof( V_294 ) ) )
return - V_273 ;
return 0 ;
}
F_37 ( & V_65 ) ;
return - V_156 ;
case V_300 :
if ( F_186 ( & V_292 , V_11 , sizeof( V_292 ) ) )
return - V_273 ;
F_35 ( & V_65 ) ;
V_162 = F_119 ( V_4 , & V_292 . V_301 . V_225 , & V_292 . V_302 . V_225 ) ;
if ( V_162 ) {
V_292 . V_303 = V_162 -> V_95 . V_9 . V_96 ;
V_292 . V_304 = V_162 -> V_95 . V_9 . V_97 ;
V_292 . V_98 = V_162 -> V_95 . V_9 . V_98 ;
F_37 ( & V_65 ) ;
if ( F_191 ( V_11 , & V_292 , sizeof( V_292 ) ) )
return - V_273 ;
return 0 ;
}
F_37 ( & V_65 ) ;
...
int F_193 ( struct V_255 * V_256 , unsigned int V_290 , void T_8 * V_11 )
{
struct V_306 V_292 ;
struct V_307 V_294 ;
struct V_69 * V_80 ;
...
static inline int F_194 ( struct V_255 * V_256 , struct V_32 * V_33 )
{
F_195 ( F_63 ( F_143 ( V_33 ) -> V_82 ) , F_196 ( F_143 ( V_33 ) ) ,
V_308 ) ;
F_197 ( F_63 ( F_143 ( V_33 ) -> V_82 ) , F_196 ( F_143 ( V_33 ) ) ,
V_309 , V_33 -> V_121 ) ;
return F_198 ( V_256 , V_33 ) ;
}
...
V_80 -> V_86 ++ ;
V_80 -> V_85 += V_33 -> V_121 ;
if ( F_203 ( V_33 , sizeof( * V_310 ) + F_204 ( V_82 ) ) )
goto V_313;
V_310 = F_67 ( V_33 ) ;
V_310 -> V_314 -- ;
F_205 ( V_33 ) -> V_13 |= V_315 ;
return F_206 ( V_316 , V_317 , NULL , V_33 ,
V_33 -> V_82 , V_82 ,
F_194 ) ;
V_313:
F_80 ( V_33 ) ;
...
int V_318 = - 1 ;
int V_80 , V_66 ;
int V_319 = F_207 ( V_4 , V_33 -> V_82 ) ;
V_80 = V_67 -> V_94 ;
V_67 -> V_95 . V_9 . V_96 ++ ;
V_67 -> V_95 . V_9 . V_97 += V_33 -> V_121 ;
if ( F_123 ( & V_67 -> V_93 ) && V_319 >= 0 ) {
struct V_60 * V_320 ;
V_320 = F_122 ( V_4 , V_80 ) ;
if ( V_320 &&
...
if ( ( ! F_123 ( & V_67 -> V_93 ) || V_66 != V_319 ) &&
F_67 ( V_33 ) -> V_314 > V_67 -> V_95 . V_9 . V_100 [ V_66 ] ) {
if ( V_318 != - 1 ) {
struct V_32 * V_327 = F_208 ( V_33 , V_204 ) ;
if ( V_327 )
F_199 ( V_2 , V_4 , V_327 , V_67 , V_318 ) ;
}
V_318 = V_66 ;
}
}
...
if ( F_215 ( V_33 , V_345 , sizeof( V_335 ) , & V_335 ) < 0 )
return - V_206 ;
V_330 -> V_346 = V_347 ;
return 1 ;
}
...
struct V_1 * V_4 ;
struct V_60 * V_67 ;
struct V_349 * V_350 = (struct V_349 * ) F_143 ( V_33 ) ;
V_4 = F_1 ( V_2 , V_45 ) ;
if ( ! V_4 )
return - V_77 ;
F_35 ( & V_65 ) ;
V_67 = F_119 ( V_4 , & V_350 -> V_351 . V_352 , & V_350 -> V_353 . V_352 ) ;
if ( ! V_67 && V_33 -> V_82 ) {
int V_80 = F_207 ( V_4 , V_33 -> V_82 ) ;
if ( V_80 >= 0 )
V_67 = F_124 ( V_4 , & V_350 -> V_353 . V_352 ,
V_80 ) ;
}
if ( ! V_67 ) {
struct V_32 * V_327 ;
...
V_327 = F_136 ( sizeof( struct V_104 ) , V_204 ) ;
if ( ! V_327 ) {
F_37 ( & V_65 ) ;
return - V_46 ;
}
F_138 ( V_327 ) ;
F_139 ( V_327 , sizeof( struct V_104 ) ) ;
F_75 ( V_327 ) ;
V_354 = F_67 ( V_327 ) ;
V_354 -> V_167 = 0 ;
V_354 -> V_355 = 0 ;
...
V_7 = F_146 ( V_4 , V_80 , V_327 ) ;
F_37 ( & V_65 ) ;
return V_7 ;
}
if ( ! V_348 && ( V_330 -> V_359 & V_360 ) )
V_67 -> V_253 |= V_361 ;
V_7 = F_131 ( V_4 , V_33 , V_67 , V_330 ) ;
F_37 ( & V_65 ) ;
return V_7 ;
}
...
struct V_329 * V_330 ;
int V_7 ;
V_169 = F_218 ( V_33 , V_175 , V_75 , V_290 , sizeof( * V_330 ) , V_13 ) ;
if ( ! V_169 )
return - V_206 ;
V_330 = F_106 ( V_169 ) ;
V_330 -> V_362 = V_247 ;
...
V_330 -> V_371 = V_373 ;
V_330 -> V_359 = 0 ;
if ( F_219 ( V_33 , V_374 , & V_162 -> V_93 ) ||
F_219 ( V_33 , V_375 , & V_162 -> V_92 ) )
goto V_368;
V_7 = F_131 ( V_4 , V_33 , V_162 , V_330 ) ;
if ( V_7 < 0 && V_7 != - V_77 )
goto V_368;
F_220 ( V_33 , V_169 ) ;
return 0 ;
...
+ F_224 ( 4 )
+ F_224 ( 0 )
+ V_72 * F_225 ( sizeof( struct V_331 ) )
+ F_224 ( sizeof( struct V_334 ) )
;
return V_121 ;
}
...
if ( ! V_33 )
goto V_376;
V_7 = F_217 ( V_4 , V_33 , 0 , 0 , V_64 , V_290 , 0 ) ;
if ( V_7 < 0 )
goto V_376;
F_227 ( V_33 , V_2 , 0 , V_377 , NULL , V_204 ) ;
return;
V_376:
F_80 ( V_33 ) ;
if ( V_7 < 0 )
...
{
struct V_2 * V_2 = F_178 ( V_33 -> V_256 ) ;
struct V_1 * V_4 ;
struct V_60 * V_64 ;
