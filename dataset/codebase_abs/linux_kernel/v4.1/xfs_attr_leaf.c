...
return;
if ( V_46 )
V_8 -> V_10 . V_49 = F_16 ( V_46 -> V_50 . V_51 ) ;
F_17 ( V_30 , V_52 ) ;
}
static void
F_18 (
...
{
int V_62 ;
V_62 = F_21 ( V_56 , V_58 , V_59 , V_60 , V_61 ,
V_63 , & V_64 ) ;
if ( ! V_62 && V_56 )
F_22 ( V_56 , * V_61 , V_65 ) ;
return V_62 ;
...
STATIC int
F_23 ( int V_66 , int V_67 )
{
return F_24 ( V_67 ) == F_25 ( V_66 ) ;
}
int
F_26 ( T_4 * V_58 , int V_68 )
{
int V_69 ;
int V_70 ;
int V_71 ;
int V_72 ;
T_5 * V_32 = V_58 -> V_73 ;
V_69 = ( F_27 ( V_32 , V_58 -> V_74 . V_75 ) - V_68 ) >> 3 ;
switch ( V_58 -> V_74 . V_76 ) {
case V_77 :
V_70 = F_28 ( sizeof( V_78 ) , 8 ) >> 3 ;
return ( V_69 >= V_70 ) ? V_70 : 0 ;
case V_79 :
V_70 = F_28 ( sizeof( V_80 ) , 8 ) >> 3 ;
return ( V_69 >= V_70 ) ? V_70 : 0 ;
}
if ( V_68 <= F_29 ( V_58 ) )
...
V_72 = F_32 ( V_32 , V_58 -> V_84 . V_89 ) ;
break;
}
V_70 = F_33 ( V_72 , F_31 ( V_87 ) ) ;
V_70 = F_28 ( V_70 , 8 ) >> 3 ;
V_71 = F_27 ( V_32 , V_58 -> V_74 . V_75 ) -
F_31 ( V_90 ) ;
V_71 = V_71 >> 3 ;
if ( V_69 >= V_71 )
return V_71 ;
...
F_42 ( V_58 , sizeof( * V_9 ) , V_63 ) ;
V_9 = ( T_8 * ) V_92 -> V_99 . V_100 ;
V_9 -> V_15 = 0 ;
V_9 -> V_101 = F_2 ( sizeof( * V_9 ) ) ;
F_43 ( args -> V_102 , V_58 , V_103 | V_104 ) ;
}
void
F_44 ( T_7 * args , int V_105 )
{
T_10 * V_106 ;
T_11 * V_107 ;
int V_19 , V_69 , V_27 ;
...
for ( V_19 = 0 ; V_19 < V_117 ; V_107 = F_46 ( V_107 ) ,
V_26 += V_27 , V_19 ++ ) {
V_27 = F_54 ( V_107 ) ;
if ( V_107 -> V_109 != args -> V_109 )
continue;
...
( V_58 -> V_74 . V_76 != V_88 ) &&
! ( args -> V_119 & V_120 ) ) {
F_50 ( V_58 , args -> V_102 ) ;
} else {
F_42 ( V_58 , - V_27 , V_63 ) ;
V_58 -> V_74 . V_81 = F_26 ( V_58 , V_101 ) ;
ASSERT ( V_58 -> V_74 . V_81 ) ;
ASSERT ( V_101 > sizeof( T_8 ) ||
( args -> V_119 & V_120 ) ||
! ( V_32 -> V_82 & V_83 ) ||
V_58 -> V_74 . V_76 == V_88 ) ;
F_43 ( args -> V_102 , V_58 ,
V_103 | V_104 ) ;
}
F_34 ( V_32 , args -> V_102 ) ;
return 0 ;
...
ASSERT ( V_43 == 0 ) ;
error = F_63 ( args , V_43 , & V_30 ) ;
if ( error ) {
error = F_64 ( args , 0 , V_30 ) ;
V_30 = NULL ;
if ( error )
goto V_128;
F_42 ( V_58 , V_27 , V_63 ) ;
...
V_124 . V_134 = F_65 ( V_107 -> V_111 ,
V_107 -> V_109 ) ;
V_124 . V_112 = F_66 ( V_107 -> V_112 ) ;
error = F_67 ( V_30 , & V_124 ) ;
ASSERT ( error == - V_118 ) ;
...
int V_19 ;
F_74 ( args ) ;
V_125 = F_60 ( args -> V_2 -> V_17 , V_126 ) ;
if ( ! V_125 )
return - V_147 ;
...
if ( error )
goto V_128;
error = F_20 ( args -> V_102 , V_58 , 0 , - 1 , & V_158 ) ;
if ( error )
goto V_128;
error = F_77 ( args -> V_102 , V_58 , V_43 , - 1 , & V_159 , V_63 ) ;
if ( error )
goto V_128;
F_22 ( args -> V_102 , V_159 , V_65 ) ;
V_159 -> V_160 = V_158 -> V_160 ;
memcpy ( V_159 -> V_36 , V_158 -> V_36 , args -> V_2 -> V_17 ) ;
if ( F_10 ( & V_32 -> V_39 ) ) {
struct V_161 * V_8 = V_159 -> V_36 ;
V_8 -> V_43 = F_16 ( V_159 -> V_44 ) ;
}
F_78 ( args -> V_102 , V_159 , 0 , args -> V_2 -> V_17 - 1 ) ;
error = F_79 ( args , 0 , 1 , & V_158 , V_63 ) ;
if ( error )
goto V_128;
V_157 = V_158 -> V_36 ;
...
F_78 ( args -> V_102 , V_158 , 0 , args -> V_2 -> V_17 - 1 ) ;
error = 0 ;
V_128:
return error ;
}
...
int error ;
F_80 ( args ) ;
error = F_77 ( args -> V_102 , args -> V_58 , V_43 , - 1 , & V_30 ,
V_63 ) ;
if ( error )
return error ;
V_30 -> V_160 = & V_64 ;
F_22 ( args -> V_102 , V_30 , V_65 ) ;
V_35 = V_30 -> V_36 ;
...
V_37 . V_11 = V_12 ;
V_8 -> V_43 = F_16 ( V_30 -> V_44 ) ;
V_8 -> V_167 = F_16 ( V_58 -> V_168 ) ;
F_81 ( & V_8 -> V_41 , & V_32 -> V_39 . V_42 ) ;
...
F_78 ( args -> V_102 , V_30 , 0 , args -> V_2 -> V_17 - 1 ) ;
* V_61 = V_30 ;
return 0 ;
}
int
...
error = F_62 ( V_171 -> args , & V_43 ) ;
if ( error )
return error ;
error = F_63 ( V_171 -> args , V_43 , & V_174 -> V_30 ) ;
if ( error )
return error ;
V_174 -> V_43 = V_43 ;
V_174 -> V_11 = V_20 ;
F_84 ( V_171 , V_173 , V_174 ) ;
error = F_85 ( V_171 , V_173 , V_174 ) ;
if ( error )
return error ;
if ( V_171 -> V_175 ) {
F_86 ( V_171 -> args ) ;
error = F_68 ( V_173 -> V_30 , V_171 -> args ) ;
} else {
F_87 ( V_171 -> args ) ;
error = F_68 ( V_174 -> V_30 , V_171 -> args ) ;
}
V_173 -> V_134 = F_88 ( V_173 -> V_30 , NULL ) ;
V_174 -> V_134 = F_88 ( V_174 -> V_30 , NULL ) ;
return error ;
}
int
F_68 (
...
V_179 = F_92 ( V_30 , & V_37 , args , V_19 ) ;
goto V_182;
}
V_178 += V_37 . V_25 [ V_19 ] . V_27 ;
}
...
V_179 = F_92 ( V_30 , & V_37 , args , 0 ) ;
V_182:
F_7 ( args -> V_2 , V_35 , & V_37 ) ;
F_78 ( args -> V_102 , V_30 ,
F_94 ( V_35 , & V_35 -> V_9 ,
F_91 ( V_35 ) ) ) ;
return V_179 ;
}
...
V_185 -> V_190 = 0 ;
args -> V_191 = 1 ;
args -> V_192 = F_97 ( V_32 , args -> V_113 ) ;
args -> V_193 = args -> V_113 ;
}
F_78 ( args -> V_102 , V_30 ,
F_94 ( V_35 , F_98 ( V_35 , args -> V_180 ) ,
F_99 ( V_35 , args -> V_180 ) ) ) ;
...
V_37 -> V_16 += F_99 ( V_35 , args -> V_180 ) ;
return 0 ;
}
STATIC void
F_93 (
...
V_195 = ( V_148 * ) V_125 ;
V_196 = V_30 -> V_36 ;
memcpy ( V_30 -> V_36 , V_125 , F_91 ( V_195 ) ) ;
V_197 = * V_194 ;
V_194 -> V_13 = args -> V_2 -> V_17 ;
V_194 -> V_16 = 0 ;
V_194 -> V_15 = 0 ;
V_194 -> V_23 = 0 ;
V_194 -> V_25 [ 0 ] . V_26 = F_91 ( V_195 ) ;
V_194 -> V_25 [ 0 ] . V_27 = V_194 -> V_13 -
V_194 -> V_25 [ 0 ] . V_26 ;
F_7 ( args -> V_2 , V_196 , V_194 ) ;
F_101 ( args , V_195 , & V_197 , 0 ,
V_196 , V_194 , 0 , V_197 . V_15 ) ;
F_78 ( V_102 , V_30 , 0 , args -> V_2 -> V_17 - 1 ) ;
F_69 ( V_125 ) ;
}
static int
F_102 (
...
struct V_136 * V_202 ;
struct V_136 * V_203 ;
V_202 = F_71 ( V_198 -> V_36 ) ;
V_203 = F_71 ( V_200 -> V_36 ) ;
...
return F_102 ( V_198 , & V_204 , V_200 , & V_205 ) ;
}
STATIC void
F_84 (
struct V_170 * V_171 ,
...
F_104 ( args ) ;
V_213 = 0 ;
if ( F_102 ( V_206 -> V_30 , & V_204 , V_207 -> V_30 , & V_205 ) ) {
struct V_172 * V_214 ;
struct V_3 V_215 ;
V_214 = V_206 ;
V_206 = V_207 ;
...
V_171 -> V_175 = F_105 ( V_171 , V_206 , & V_204 ,
V_207 , & V_205 ,
& V_15 , & V_210 ) ;
if ( V_213 )
...
V_211 = V_205 . V_13 - F_91 ( V_208 ) ;
V_211 -= V_205 . V_15 * sizeof( V_181 ) ;
if ( V_212 > V_211 )
F_93 ( args , & V_205 , V_207 -> V_30 ) ;
F_101 ( args , V_208 , & V_204 ,
...
V_212 += V_15 * sizeof( V_181 ) ;
V_211 = V_204 . V_13 - F_91 ( V_208 ) ;
V_211 -= V_204 . V_15 * sizeof( V_181 ) ;
if ( V_212 > V_211 )
F_93 ( args , & V_204 , V_206 -> V_30 ) ;
F_101 ( args , V_209 , & V_205 , 0 , V_208 , & V_204 ,
V_204 . V_15 , V_15 ) ;
}
F_7 ( V_171 -> args -> V_2 , V_208 , & V_204 ) ;
F_7 ( V_171 -> args -> V_2 , V_209 , & V_205 ) ;
F_78 ( args -> V_102 , V_206 -> V_30 , 0 , args -> V_2 -> V_17 - 1 ) ;
F_78 ( args -> V_102 , V_207 -> V_30 , 0 , args -> V_2 -> V_17 - 1 ) ;
V_202 = F_71 ( V_208 ) ;
V_203 = F_71 ( V_209 ) ;
...
F_90 ( V_171 -> args , NULL ) ;
V_219 /= 2 ;
V_220 = V_171 -> args -> V_2 -> V_17 ;
V_137 = F_71 ( V_208 ) ;
for ( V_15 = V_180 = 0 ; V_15 < V_211 ; V_137 ++ , V_180 ++ , V_15 ++ ) {
#define F_106 ( T_13 ) (((A) < 0) ? -(A) : (A))
if ( V_15 == V_206 -> V_180 ) {
V_179 = V_210 + sizeof( * V_137 ) +
F_90 ( V_171 -> args , NULL ) ;
if ( F_106 ( V_219 - V_179 ) > V_220 )
break;
V_220 = F_106 ( V_219 - V_179 ) ;
V_210 = V_179 ;
V_221 = 1 ;
}
if ( V_15 == V_204 -> V_15 ) {
...
V_179 = V_210 + sizeof( * V_137 ) + F_99 ( V_208 ,
V_180 ) ;
if ( F_106 ( V_219 - V_179 ) > V_220 )
break;
V_220 = F_106 ( V_219 - V_179 ) ;
...
error = F_109 ( V_171 , & V_171 -> V_228 , V_224 ,
0 , & V_225 ) ;
if ( error )
return error ;
if ( V_225 ) {
...
if ( V_43 == 0 )
continue;
error = F_20 ( V_171 -> args -> V_102 , V_171 -> args -> V_58 ,
V_43 , - 1 , & V_30 ) ;
if ( error )
return error ;
...
error = F_109 ( V_171 , & V_171 -> V_226 , V_224 ,
0 , & V_225 ) ;
}
if ( error )
return error ;
...
V_230 = 0 ;
memset ( F_98 ( V_35 , args -> V_180 ) , 0 , V_177 ) ;
V_37 . V_16 -= V_177 ;
F_78 ( args -> V_102 , V_30 ,
F_94 ( V_35 , F_98 ( V_35 , args -> V_180 ) ,
V_177 ) ) ;
...
V_37 . V_15 -- ;
F_78 ( args -> V_102 , V_30 ,
F_94 ( V_35 , V_137 , V_179 + sizeof( V_181 ) ) ) ;
V_137 = & F_71 ( V_35 ) [ V_37 . V_15 ] ;
...
struct V_5 * V_238 ;
struct V_3 V_239 ;
V_238 = F_115 ( V_171 -> args -> V_2 -> V_17 , V_126 ) ;
memcpy ( V_238 , V_235 , F_91 ( V_235 ) ) ;
...
F_78 ( V_171 -> args -> V_102 , V_233 -> V_30 , 0 ,
...
if ( V_137 -> V_112 & V_142 ) {
V_138 = F_72 ( V_35 , V_240 ) ;
if ( V_138 -> V_109 != args -> V_109 )
continue;
if ( memcmp ( args -> V_110 , V_138 -> V_111 ,
args -> V_109 ) != 0 )
continue;
if ( ! F_23 ( args -> V_112 , V_137 -> V_112 ) )
continue;
args -> V_180 = V_240 ;
return - V_121 ;
} else {
V_185 = F_96 ( V_35 , V_240 ) ;
...
args -> V_193 = F_6 ( V_185 -> V_113 ) ;
args -> V_191 = F_6 ( V_185 -> V_190 ) ;
args -> V_192 = F_97 ( args -> V_58 -> V_73 ,
args -> V_193 ) ;
if ( args -> V_112 & V_122 ) {
...
V_179 *= sizeof( V_181 ) ;
V_248 = & F_71 ( V_245 ) [ V_247 ] ;
V_249 = & F_71 ( V_245 ) [ V_247 + V_15 ] ;
memmove ( V_249 , V_248 , V_179 ) ;
}
V_248 = & F_71 ( V_242 ) [ V_244 ] ;
V_249 = & F_71 ( V_245 ) [ V_247 ] ;
V_250 = V_247 ;
for ( V_19 = 0 ; V_19 < V_15 ; V_248 ++ , V_249 ++ , V_250 ++ , V_19 ++ ) {
ASSERT ( F_3 ( V_248 -> V_149 ) >= V_243 -> V_13 ) ;
V_179 = F_99 ( V_242 , V_244 + V_19 ) ;
#ifdef F_118
if ( V_248 -> V_112 & V_141 ) {
memset ( F_98 ( V_242 , V_244 + V_19 ) , 0 , V_179 ) ;
V_243 -> V_16 -= V_179 ;
V_243 -> V_15 -= 1 ;
V_249 -- ;
V_250 -- ;
...
<= args -> V_2 -> V_17 ) ;
memmove ( F_98 ( V_245 , V_250 ) ,
F_98 ( V_242 , V_244 + V_19 ) , V_179 ) ;
...
V_248 = & F_71 ( V_242 ) [ V_244 + V_15 ] ;
V_249 = & F_71 ( V_242 ) [ V_244 ] ;
memmove ( V_249 , V_248 , V_179 ) ;
V_179 = V_15 * sizeof( V_181 ) ;
V_248 = & F_71 ( V_242 ) [ V_243 -> V_15 ] ;
ASSERT ( ( ( char * ) V_248 + V_179 ) <=
( ( char * ) V_242 + args -> V_2 -> V_17 ) ) ;
memset ( V_248 , 0 , V_179 ) ;
}
V_246 -> V_25 [ 0 ] . V_26 = F_91 ( V_245 ) ;
...
V_138 = F_72 ( V_35 , V_180 ) ;
V_27 = F_119 ( V_138 -> V_109 ,
F_3 ( V_138 -> V_113 ) ) ;
} else {
V_185 = F_96 ( V_35 , V_180 ) ;
V_27 = F_120 ( V_185 -> V_109 ) ;
}
return V_27 ;
}
int
...
{
int V_27 ;
V_27 = F_119 ( args -> V_109 , args -> V_113 ) ;
if ( V_27 < F_121 ( args -> V_2 -> V_17 ) ) {
if ( V_252 )
* V_252 = 1 ;
return V_27 ;
}
...
#endif
F_123 ( args ) ;
error = F_20 ( args -> V_102 , args -> V_58 , args -> V_43 , - 1 , & V_30 ) ;
if ( error )
return error ;
V_35 = V_30 -> V_36 ;
V_137 = & F_71 ( V_35 ) [ args -> V_180 ] ;
...
F_78 ( args -> V_102 , V_30 ,
F_94 ( V_35 , V_185 , sizeof( * V_185 ) ) ) ;
}
return F_124 ( & args -> V_102 , args -> V_58 ) ;
}
int
F_125 (
struct V_145 * args )
...
#endif
F_128 ( args ) ;
error = F_20 ( args -> V_102 , args -> V_58 , args -> V_43 , - 1 , & V_158 ) ;
if ( error )
return error ;
if ( args -> V_188 != args -> V_43 ) {
error = F_20 ( args -> V_102 , args -> V_58 , args -> V_188 ,
- 1 , & V_159 ) ;
if ( error )
return error ;
} else {
...
V_208 = V_158 -> V_36 ;
V_253 = & F_71 ( V_208 ) [ args -> V_180 ] ;
V_209 = V_159 -> V_36 ;
V_254 = & F_71 ( V_209 ) [ args -> V_189 ] ;
#ifdef F_47
...
V_138 = F_72 ( V_208 , args -> V_180 ) ;
V_255 = V_138 -> V_109 ;
V_257 = ( char * ) V_138 -> V_111 ;
} else {
V_185 = F_96 ( V_208 , args -> V_180 ) ;
V_255 = V_185 -> V_109 ;
V_257 = ( char * ) V_185 -> V_110 ;
}
if ( V_254 -> V_112 & V_142 ) {
V_138 = F_72 ( V_209 , args -> V_189 ) ;
V_256 = V_138 -> V_109 ;
V_258 = ( char * ) V_138 -> V_111 ;
} else {
V_185 = F_96 ( V_209 , args -> V_189 ) ;
V_256 = V_185 -> V_109 ;
...
V_253 -> V_112 &= ~ V_141 ;
F_78 ( args -> V_102 , V_158 ,
F_94 ( V_208 , V_253 , sizeof( * V_253 ) ) ) ;
if ( args -> V_191 ) {
...
V_185 -> V_113 = F_8 ( args -> V_193 ) ;
F_78 ( args -> V_102 , V_158 ,
F_94 ( V_208 , V_185 , sizeof( * V_185 ) ) ) ;
}
V_254 -> V_112 |= V_141 ;
F_78 ( args -> V_102 , V_159 ,
F_94 ( V_209 , V_254 , sizeof( * V_254 ) ) ) ;
if ( ( V_254 -> V_112 & V_142 ) == 0 ) {
V_185 = F_96 ( V_209 , args -> V_189 ) ;
V_185 -> V_190 = 0 ;
V_185 -> V_113 = 0 ;
F_78 ( args -> V_102 , V_159 ,
F_94 ( V_209 , V_185 , sizeof( * V_185 ) ) ) ;
}
error = F_124 ( & args -> V_102 , args -> V_58 ) ;
return error ;
}
