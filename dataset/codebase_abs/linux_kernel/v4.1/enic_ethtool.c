...
V_102 -> V_113 . V_114 . V_115 = V_96 -> V_106 . V_116 ;
V_102 -> V_117 . V_114 . V_115 = ( V_118 ) ~ 0 ;
V_102 -> V_113 . V_114 . V_119 = V_96 -> V_106 . V_120 ;
V_102 -> V_117 . V_114 . V_119 = ( V_118 ) ~ 0 ;
V_102 -> V_113 . V_114 . V_121 = V_96 -> V_106 . V_122 [ 0 ] ;
V_102 -> V_117 . V_114 . V_121 = ( V_123 ) ~ 0 ;
V_102 -> V_113 . V_114 . V_124 = V_96 -> V_106 . V_122 [ 1 ] ;
V_102 -> V_117 . V_114 . V_124 = ( V_123 ) ~ 0 ;
V_102 -> V_125 = V_96 -> V_126 ;
return 0 ;
}
static int F_30 ( struct V_6 * V_127 , struct V_82 * V_83 ,
T_1 * V_84 )
{
struct V_1 * V_1 = F_5 ( V_127 ) ;
int V_86 = 0 ;
switch ( V_83 -> V_83 ) {
case V_128 :
V_83 -> V_41 = V_1 -> V_5 ;
...
static int F_33 ( struct V_6 * V_127 ,
const struct V_133 * V_134 , void * V_41 )
{
struct V_1 * V_1 = F_5 ( V_127 ) ;
int V_86 = 0 ;
switch ( V_134 -> V_135 ) {
...
static int F_34 ( struct V_6 * V_127 ,
...
static int F_36 ( struct V_6 * V_7 , T_1 * V_139 , T_2 * V_140 ,
T_2 * V_141 )
{
struct V_1 * V_1 = F_5 ( V_7 ) ;
if ( V_140 )
memcpy ( V_140 , V_1 -> V_142 , V_138 ) ;
if ( V_141 )
* V_141 = V_143 ;
return 0 ;
}
static int F_37 ( struct V_6 * V_7 , const T_1 * V_139 ,
const T_2 * V_140 , const T_2 V_141 )
{
struct V_1 * V_1 = F_5 ( V_7 ) ;
if ( ( V_141 != V_144 && V_141 != V_143 ) ||
V_139 )
return - V_76 ;
if ( V_140 )
memcpy ( V_1 -> V_142 , V_140 , V_138 ) ;
return F_38 ( V_1 ) ;
}
