...
V_30 = F_5 ( V_2 -> V_11 + V_35 ) ;
V_30 |= F_5 ( V_2 -> V_11 + V_35 ) << 8 ;
V_30 ^= 0x8000 ;
F_7 ( V_4 , & V_30 , 1 ) ;
if ( V_20 -> V_36 == V_37 &&
V_4 -> V_21 -> V_38 >= V_20 -> V_39 ) {
V_4 -> V_21 -> V_32 |= V_40 ;
break;
}
if ( ( V_22 -- ) <= 0 )
...
if ( F_18 ( & V_6 -> V_26 ) )
return - V_70 ;
V_30 [ V_55 ] = F_5 ( V_2 -> V_11 + V_35 ) ;
V_30 [ V_55 ] |= F_5 ( V_2 -> V_11 + V_35 ) << 8 ;
V_30 [ V_55 ] ^= 0x8000 ;
}
return V_54 -> V_67 ;
}
...
V_74 |= F_21 ( & V_20 -> V_81 ,
V_79 | V_77 ) ;
V_74 |= F_21 ( & V_20 -> V_82 , V_37 ) ;
V_74 |= F_21 ( & V_20 -> V_36 , V_37 | V_83 ) ;
if ( V_74 )
return 1 ;
V_74 |= F_22 ( V_20 -> V_78 ) ;
V_74 |= F_22 ( V_20 -> V_81 ) ;
...
V_20 -> V_89 ) ;
if ( V_20 -> V_36 == V_37 )
V_74 |= F_26 ( & V_20 -> V_39 , 0x00ffffff ) ;
else
V_74 |= F_23 ( & V_20 -> V_39 , 0 ) ;
if ( V_74 )
return 3 ;
if ( V_20 -> V_78 == V_79 ) {
V_75 = V_20 -> V_85 ;
...
V_96 = ( unsigned long long ) V_20 -> V_39 *
V_20 -> V_87 ;
V_97 = V_96 * F_28 ( V_4 ) ;
while ( V_97 > V_98 * 3 / 4 )
V_97 /= 2 ;
...
F_2 ( V_60 , V_2 -> V_11 + V_12 ) ;
F_2 ( 0x00 , V_2 -> V_11 + V_35 ) ;
F_2 ( 0x00 , V_2 -> V_11 + V_35 ) ;
F_2 ( ( V_98 - V_91 ) & 0xff , V_2 -> V_11 + V_35 ) ;
F_2 ( ( V_98 - V_91 ) >> 8 , V_2 -> V_11 + V_35 ) ;
V_56 = V_99 | V_62
| V_100 | V_101 ;
F_2 ( V_56 , V_2 -> V_11 + V_65 ) ;
V_57 = 100 ;
