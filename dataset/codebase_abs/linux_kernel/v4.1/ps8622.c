...
static struct V_51 * F_26 ( struct V_4 * V_5 )
{
struct V_1 * V_22 ;
V_22 = F_3 ( V_5 ) ;
return V_22 -> V_3 . V_52 ;
}
static enum V_53 F_27 ( struct V_4 * V_5 ,
bool V_54 )
{
return V_55 ;
}
...
{
struct V_64 * V_32 = & V_7 -> V_32 ;
struct V_65 * V_66 , * V_67 ;
struct V_1 * V_22 ;
int V_11 ;
V_22 = F_38 ( V_32 , sizeof( * V_22 ) , V_68 ) ;
if ( ! V_22 )
return - V_69 ;
V_66 = F_39 ( V_32 -> V_70 , NULL ) ;
if ( V_66 ) {
V_67 = F_40 ( V_66 ) ;
if ( V_67 ) {
V_22 -> V_42 = F_41 ( V_67 ) ;
...
V_22 -> V_7 = V_7 ;
V_22 -> V_41 = F_43 ( V_32 , L_10 ) ;
if ( F_44 ( V_22 -> V_41 ) ) {
F_45 ( V_32 , L_11 ) ;
V_22 -> V_41 = NULL ;
}
V_22 -> V_43 = F_46 ( V_32 , L_12 ) ;
if ( F_44 ( V_22 -> V_43 ) ) {
V_11 = F_47 ( V_22 -> V_43 ) ;
F_48 ( V_32 , L_13 , V_11 ) ;
return V_11 ;
}
V_11 = F_49 ( V_22 -> V_43 , 1 ) ;
if ( V_11 ) {
F_48 ( V_32 , L_14 ) ;
return V_11 ;
}
V_22 -> V_40 = F_46 ( V_32 , L_15 ) ;
if ( F_44 ( V_22 -> V_40 ) ) {
V_11 = F_47 ( V_22 -> V_40 ) ;
F_48 ( V_32 , L_16 , V_11 ) ;
return V_11 ;
}
V_11 = F_49 ( V_22 -> V_40 , 1 ) ;
if ( V_11 ) {
F_48 ( V_32 , L_17 ) ;
return V_11 ;
}
V_22 -> V_25 = V_63 -> V_72 ;
if ( F_50 ( V_32 -> V_70 , L_18 ,
& V_22 -> V_26 ) ) {
V_22 -> V_26 = V_22 -> V_25 ;
...
V_22 -> V_27 -> V_28 . V_74 = V_75 ;
V_22 -> V_27 -> V_28 . V_29 = V_75 ;
}
V_22 -> V_3 . V_76 = & V_77 ;
V_22 -> V_3 . V_70 = V_32 -> V_70 ;
V_11 = F_53 ( & V_22 -> V_3 ) ;
if ( V_11 ) {
F_13 ( L_24 ) ;
return V_11 ;
