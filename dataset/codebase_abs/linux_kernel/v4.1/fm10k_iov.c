...
if ( ! V_17 )
return - V_41 ;
V_2 -> V_24 . V_25 . V_42 ( V_2 , V_23 , V_23 ) ;
V_40 . V_30 = V_2 -> V_43 . V_44 & V_38 ;
V_40 . V_45 = V_37 ;
V_40 . V_46 = 1 ;
V_40 . V_47 = F_19 ( F_20 ( V_2 ) - 1 ) ;
V_40 . V_48 = F_21 ( V_2 , 0 ) ;
V_40 . V_49 = F_19 ( V_2 -> V_24 . V_50 - 1 ) ;
V_40 . V_51 = 1 ;
V_2 -> V_43 . V_25 . V_52 ( V_2 , & V_40 ) ;
for ( V_19 = 0 ; V_19 < V_23 ; V_19 ++ ) {
struct V_6 * V_7 = & V_17 -> V_7 [ V_19 ] ;
if ( V_19 == ( ( ~ V_2 -> V_43 . V_44 ) >> V_53 ) )
break;
V_2 -> V_24 . V_25 . V_54 ( V_2 , V_7 , V_19 ,
V_55 ) ;
V_7 -> V_56 = V_2 -> V_43 . V_57 ;
V_2 -> V_24 . V_25 . V_58 ( V_2 , V_7 ) ;
V_7 -> V_5 . V_25 . V_27 ( V_2 , & V_7 -> V_5 ) ;
}
return 0 ;
}
T_1 F_22 ( struct V_8 * V_9 , T_4 V_30 , T_4 V_59 )
{
struct V_16 * V_17 = V_9 -> V_17 ;
struct V_1 * V_2 = & V_9 -> V_2 ;
struct V_6 * V_7 ;
T_4 V_15 = ( V_30 - V_2 -> V_43 . V_44 ) & V_38 ;
if ( ! V_17 )
return V_60 ;
if ( V_15 >= V_17 -> V_23 )
return V_60 ;
...
int F_40 ( struct V_75 * V_76 , int V_15 , T_6 * V_43 )
{
struct V_8 * V_9 = F_41 ( V_76 ) ;
struct V_16 * V_17 = V_9 -> V_17 ;
struct V_1 * V_2 = & V_9 -> V_2 ;
struct V_6 * V_7 ;
if ( ! V_17 || V_15 >= V_17 -> V_23 )
return - V_77 ;
if ( ! F_42 ( V_43 ) && ! F_43 ( V_43 ) )
return - V_77 ;
V_7 = & V_17 -> V_7 [ V_15 ] ;
F_44 ( V_7 -> V_43 , V_43 ) ;
F_11 ( V_9 ) ;
...
int F_45 ( struct V_75 * V_76 , int V_15 , T_4 V_78 ,
T_6 V_79 )
{
struct V_8 * V_9 = F_41 ( V_76 ) ;
struct V_16 * V_17 = V_9 -> V_17 ;
...
V_7 -> V_81 = V_78 ;
F_11 ( V_9 ) ;
V_2 -> V_43 . V_25 . V_82 ( V_2 , V_83 , V_7 -> V_67 , false ) ;
V_2 -> V_24 . V_25 . V_58 ( V_2 , V_7 ) ;
F_13 ( V_9 ) ;
return 0 ;
}
int F_46 ( struct V_75 * V_76 , int V_15 ,
