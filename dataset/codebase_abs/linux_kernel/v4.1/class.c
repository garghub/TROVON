...
int F_26 ( struct V_13 * V_19 , struct V_32 * V_33 )
{
struct V_8 * V_9 ;
int error ;
F_6 ( L_4 , V_19 -> V_16 ) ;
V_9 = F_27 ( sizeof( * V_9 ) , V_34 ) ;
if ( ! V_9 )
return - V_35 ;
F_28 ( & V_9 -> V_36 , F_21 , F_24 ) ;
F_29 ( & V_9 -> V_37 ) ;
F_30 ( & V_9 -> V_38 ) ;
F_31 ( & V_9 -> V_39 , L_5 , V_33 ) ;
...
struct V_29 * V_55 , const struct V_56 * type )
{
struct V_27 * V_57 = NULL ;
if ( V_55 )
V_57 = & V_55 -> V_31 ;
F_43 ( & V_13 -> V_21 -> V_36 , & V_54 -> V_58 , V_57 ) ;
V_54 -> type = type ;
}
struct V_29 * F_44 ( struct V_53 * V_54 )
{
struct V_27 * V_59 ;
struct V_29 * V_30 ;
while ( 1 ) {
...
if ( ! V_59 )
return NULL ;
V_30 = F_22 ( V_59 , struct V_29 , V_31 ) ;
if ( ! V_54 -> type || V_54 -> type == V_30 -> type )
return V_30 ;
}
}
...
int F_48 ( struct V_13 * V_13 , struct V_29 * V_55 ,
void * V_60 , int (* F_49)( struct V_29 * , void * ) )
{
struct V_53 V_54 ;
struct V_29 * V_30 ;
int error = 0 ;
...
while ( ( V_30 = F_44 ( & V_54 ) ) ) {
error = F_49 ( V_30 , V_60 ) ;
if ( error )
break;
}
F_46 ( & V_54 ) ;
...
struct V_29 * F_51 ( struct V_13 * V_13 , struct V_29 * V_55 ,
const void * V_60 ,
int (* F_52)( struct V_29 * , const void * ) )
{
struct V_53 V_54 ;
struct V_29 * V_30 ;
if ( ! V_13 )
...
{
struct V_68 * V_69 ;
V_69 = F_22 ( V_4 , struct V_68 , V_4 ) ;
return snprintf ( V_5 , V_70 , L_10 , V_69 -> V_71 ) ;
}
struct V_72 * F_60 ( const char * V_16 )
{
struct V_72 * V_19 ;
V_19 = F_61 ( sizeof( struct V_72 ) , V_34 ) ;
if ( ! V_19 )
return NULL ;
V_19 -> V_2 = F_62 ( V_16 , & V_46 -> V_2 ) ;
if ( ! V_19 -> V_2 ) {
F_7 ( V_19 ) ;
return NULL ;
}
...
int F_65 ( struct V_72 * V_19 , struct V_29 * V_30 ,
struct V_29 * V_73 )
{
int error ;
error = F_66 ( V_19 -> V_2 , & V_30 -> V_2 , F_67 ( V_30 ) ) ;
if ( error )
return error ;
if ( V_73 ) {
error = F_66 ( & V_30 -> V_2 , & V_73 -> V_2 ,
L_11 ) ;
if ( error )
F_68 ( V_19 -> V_2 , F_67 ( V_30 ) ) ;
}
return error ;
}
void F_69 ( struct V_72 * V_19 , struct V_29 * V_30 ,
struct V_29 * V_73 )
{
if ( V_73 )
F_68 ( & V_30 -> V_2 , L_11 ) ;
