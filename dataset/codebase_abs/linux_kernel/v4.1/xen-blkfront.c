...
V_190 = F_129 ( V_69 , V_2 -> V_97 . V_216 , 1 , & V_23 ) ;
if ( V_190 < 0 ) {
F_130 ( ( unsigned long ) V_216 ) ;
V_2 -> V_97 . V_216 = NULL ;
goto V_238;
}
V_2 -> V_215 = V_23 ;
V_190 = F_131 ( V_69 , & V_2 -> V_217 ) ;
if ( V_190 )
goto V_238;
V_190 = F_132 ( V_2 -> V_217 , F_117 , 0 ,
L_37 , V_2 ) ;
if ( V_190 <= 0 ) {
F_126 ( V_69 , V_190 ,
L_38 ) ;
...
static int F_133 ( struct V_235 * V_69 ,
struct V_1 * V_2 )
{
...
V_190 = F_135 ( V_241 , V_69 -> V_243 , L_45 , L_46 ,
V_245 ) ;
if ( V_190 ) {
V_239 = L_47 ;
goto V_244;
...
static int F_139 ( struct V_235 * V_69 ,
const struct V_248 * V_9 )
{
int V_190 , V_159 , V_18 ;
struct V_1 * V_2 ;
V_190 = F_140 ( V_249 , V_69 -> V_243 ,
L_51 , L_52 , & V_159 ) ;
if ( V_190 != 1 ) {
V_190 = F_140 ( V_249 , V_69 -> V_243 , L_53 ,
L_52 , & V_159 ) ;
if ( V_190 != 1 ) {
...
type = F_142 ( V_249 , V_69 -> V_243 , L_56 , & V_250 ) ;
if ( F_143 ( type ) )
return - V_186 ;
...
V_2 -> V_30 = 0 ;
V_2 -> V_92 = V_213 ;
F_147 ( & V_2 -> V_54 , F_106 ) ;
for ( V_18 = 0 ; V_18 < V_4 ; V_18 ++ )
V_2 -> V_5 [ V_18 ] . V_6 . V_7 . V_8 . V_9 = V_18 + 1 ;
V_2 -> V_5 [ V_4 - 1 ] . V_6 . V_7 . V_8 . V_9 = 0x0fffffff ;
V_2 -> V_117 = F_148 ( strrchr ( V_69 -> V_243 , '/' ) + 1 , NULL , 0 ) ;
F_149 ( & V_69 -> V_69 , V_2 ) ;
V_190 = F_133 ( V_69 , V_2 ) ;
if ( V_190 ) {
F_7 ( V_2 ) ;
F_149 ( & V_69 -> V_69 , NULL ) ;
return V_190 ;
}
return 0 ;
}
static void F_150 ( struct V_254 * V_254 , int error )
{
struct V_255 * V_255 = V_254 -> V_256 ;
if ( error )
V_255 -> V_190 = error ;
if ( F_151 ( & V_255 -> V_257 ) ) {
V_255 -> V_254 -> V_258 = 0 ;
F_152 ( V_255 -> V_254 , V_255 -> V_190 ) ;
F_7 ( V_255 ) ;
}
F_153 ( V_254 ) ;
}
...
struct V_255 * V_255 ;
struct V_264 V_265 ;
V_259 = F_155 ( V_2 -> V_5 , sizeof( V_2 -> V_5 ) ,
V_19 | V_266 | V_237 ) ;
if ( ! V_259 )
return - V_27 ;
...
F_159 ( V_259 [ V_18 ] . V_11 , 0 ) ;
}
F_7 ( V_259 ) ;
F_108 ( & V_2 -> V_148 ) ;
while ( ( V_6 = F_160 ( V_2 -> V_141 ) ) != NULL ) {
if ( V_6 -> V_99 &
( V_112 | V_113 | V_100 | V_101 ) ) {
F_9 ( & V_6 -> V_267 , & V_265 ) ;
continue;
...
F_109 ( & V_2 -> V_148 ) ;
while ( ( V_254 = F_163 ( & V_261 ) ) != NULL ) {
if ( F_164 ( V_254 ) > V_211 ) {
V_257 = ( F_164 ( V_254 ) + V_211 - 1 ) / V_211 ;
V_255 = F_5 ( sizeof( * V_255 ) , V_19 ) ;
F_2 ( V_255 == NULL ) ;
F_165 ( & V_255 -> V_257 , V_257 ) ;
V_255 -> V_254 = V_254 ;
for ( V_18 = 0 ; V_18 < V_257 ; V_18 ++ ) {
V_120 = ( V_18 * V_211 * V_132 ) >> 9 ;
V_263 = F_166 ( ( unsigned int ) ( V_211 * V_132 ) >> 9 ,
( unsigned int ) F_167 ( V_254 ) - V_120 ) ;
V_260 = F_168 ( V_254 , V_19 ) ;
F_2 ( V_260 == NULL ) ;
F_169 ( V_260 , V_120 , V_263 ) ;
V_260 -> V_256 = V_255 ;
V_260 -> V_272 = F_150 ;
F_170 ( V_260 -> V_273 , V_260 ) ;
}
continue;
}
F_170 ( V_254 -> V_273 , V_254 ) ;
}
return 0 ;
}
static int F_171 ( struct V_235 * V_69 )
{
struct V_1 * V_2 = F_172 ( & V_69 -> V_69 ) ;
int V_190 ;
...
unsigned int V_278 ;
V_2 -> V_150 = 1 ;
V_190 = F_181 ( V_249 , V_2 -> V_32 -> V_279 ,
L_62 , L_41 , & V_153 ,
L_63 , L_41 , & V_154 ,
NULL ) ;
if ( ! V_190 ) {
...
switch ( V_2 -> V_92 ) {
case V_93 :
V_190 = F_140 ( V_249 , V_2 -> V_32 -> V_279 ,
L_66 , L_67 , & V_63 ) ;
if ( F_184 ( V_190 ) )
return;
F_86 ( V_251 L_68 ,
...
static void F_187 ( struct V_235 * V_69 ,
enum V_287 V_288 )
{
struct V_1 * V_2 = F_172 ( & V_69 -> V_69 ) ;
F_37 ( & V_69 -> V_69 , L_81 , V_288 ) ;
switch ( V_288 ) {
case V_289 :
case V_290 :
case V_247 :
...
static int F_188 ( struct V_235 * V_32 )
{
struct V_1 * V_2 = F_172 ( & V_32 -> V_69 ) ;
struct V_55 * V_64 = NULL ;
struct V_75 * V_295 ;
...
static int F_190 ( struct V_235 * V_69 )
{
struct V_1 * V_2 = F_172 ( & V_69 -> V_69 ) ;
return V_2 -> V_286 && V_2 -> V_32 ;
}
static int F_191 ( struct V_55 * V_64 , T_3 V_65 )
{
struct V_75 * V_295 = V_64 -> V_60 ;
struct V_1 * V_2 ;
int V_190 = 0 ;
F_174 ( & V_296 ) ;
V_2 = V_295 -> V_68 ;
...
static void F_192 ( struct V_75 * V_295 , T_3 V_65 )
{
struct V_1 * V_2 = V_295 -> V_68 ;
struct V_55 * V_64 ;
struct V_235 * V_32 ;
F_174 ( & V_296 ) ;
V_64 = F_176 ( V_295 , 0 ) ;
if ( ! V_64 ) {
F_120 ( 1 , L_84 , V_295 -> V_158 ) ;
goto V_298;
}
if ( V_64 -> V_277 )
goto V_195;
