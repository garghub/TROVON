...
static int F_49 ( struct V_29 * V_30 , T_4 * V_110 )
{
struct V_1 * V_2 = V_30 -> V_32 ;
T_1 V_111 = 0 ;
int V_5 = 0 ;
if ( V_30 -> V_55 . V_56 . V_112 ) {
V_5 = V_30 -> V_55 . V_56 . V_112 ( V_30 , & V_111 ) ;
if ( V_5 == 0 )
F_9 ( L_39 , V_111 ) ;
else
F_9 ( L_40 ) ;
...
V_5 = V_30 -> V_55 . V_120 ( V_30 , & V_109 ) ;
if ( F_7 ( V_5 ) )
goto V_20;
if ( V_2 -> V_109 <= ( V_118 - 100 ) )
V_119 = 0 ;
else if ( V_2 -> V_109 <= V_118 )
V_119 = ( 0xffff * 65 ) / 100 ;
else {
V_119 = V_2 -> V_109 - V_118 ;
V_119 /= 50 ;
V_119 += 78 ;
if ( V_119 > 100 )
V_119 = 100 ;
V_119 = ( 0xffff * V_119 ) / 100 ;
}
* V_111 = ( T_1 ) V_119 ;
F_9 ( L_41 , * V_111 ) ;
V_20:
...
static int F_52 ( struct V_29 * V_30 , T_3 * V_121 )
{
struct V_1 * V_2 = V_30 -> V_32 ;
T_3 V_122 ;
* V_121 = 0 ;
#if 1
V_122 = F_46 ( V_2 , 0x00fc ) ;
V_122 = ( V_122 << 8 ) | F_46 ( V_2 , 0x00fd ) ;
V_122 = ( V_122 << 8 ) | F_46 ( V_2 , 0x00fe ) ;
V_122 = ( V_122 << 8 ) | F_46 ( V_2 , 0x00ff ) ;
* V_121 = V_122 ;
F_9 ( L_42 , V_122 ) ;
#endif
return 0 ;
}
static int F_53 ( struct V_29 * V_30 , T_3 * V_123 )
{
struct V_1 * V_2 = V_30 -> V_32 ;
* V_123 = 0 ;
#if 1
* V_123 = F_46 ( V_2 , 0x00f4 ) ;
F_9 ( L_43 , * V_123 ) ;
#endif
return 0 ;
}
static int F_54 ( struct V_29 * V_30 , bool V_124 ,
...
struct V_29 * F_59 ( const struct V_133 * V_134 ,
struct V_135 * V_14 )
{
struct V_1 * V_2 = NULL ;
int V_5 ;
...
V_14 ? F_60 ( V_14 ) : 0 ,
V_134 ? V_134 -> V_11 : 0 ) ;
V_2 = F_61 ( sizeof( struct V_1 ) , V_136 ) ;
if ( V_2 == NULL )
goto V_20;
V_2 -> V_10 = V_134 ;
V_2 -> V_14 = V_14 ;
memcpy ( & V_2 -> V_137 . V_55 , & V_138 ,
sizeof( struct V_139 ) ) ;
V_2 -> V_137 . V_32 = V_2 ;
...
{
memset ( V_140 , 0xff , sizeof( V_140 ) ) ;
F_62 ( V_2 ) ;
}
...
V_142 &= ~ V_143 ;
F_63 ( L_5 ) ;
for ( V_92 = 0 ; V_92 < V_144 ; V_92 ++ ) {
F_5 ( V_2 , V_145 [ V_92 ] , & V_146 [ V_92 ] ) ;
if ( V_146 [ V_92 ] != V_140 [ V_92 ] ) {
F_63 ( L_52 , V_145 [ V_92 ] , V_146 [ V_92 ] ) ;
V_140 [ V_92 ] = V_146 [ V_92 ] ;
}
}
V_142 = V_141 ;
}
