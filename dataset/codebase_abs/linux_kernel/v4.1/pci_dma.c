...
unsigned long V_63 ;
int V_71 ;
V_71 = F_48 ( V_21 , V_29 , V_7 ) ;
V_21 = V_21 & V_32 ;
if ( F_29 ( V_2 , 0 , V_21 , V_71 * V_7 ,
V_14 | V_17 ) ) {
F_50 ( L_2 ) ;
...
T_1 V_75 ;
V_29 = F_30 ( V_29 ) ;
V_58 = F_54 ( V_74 , F_55 ( V_29 ) ) ;
if ( ! V_58 )
return NULL ;
V_28 = F_47 ( V_58 ) ;
memset ( ( void * ) V_28 , 0 , V_29 ) ;
V_75 = F_44 ( V_47 , V_58 , V_28 % V_7 ,
V_29 , V_76 , NULL ) ;
if ( F_56 ( V_47 , V_75 ) ) {
F_57 ( V_28 , F_55 ( V_29 ) ) ;
return NULL ;
}
F_49 ( V_29 / V_7 , & V_2 -> V_77 ) ;
if ( V_73 )
* V_73 = V_75 ;
return ( void * ) V_28 ;
}
...
struct V_1 * V_2 = F_45 ( F_46 ( V_47 ) ) ;
V_29 = F_30 ( V_29 ) ;
F_59 ( V_29 / V_7 , & V_2 -> V_77 ) ;
F_52 ( V_47 , V_73 , V_29 , V_76 , NULL ) ;
F_57 ( ( unsigned long ) V_28 , F_55 ( V_29 ) ) ;
}
static int F_60 ( struct V_54 * V_47 , struct V_78 * V_79 ,
int V_80 , enum V_59 V_81 ,
struct V_61 * V_62 )
{
int V_82 = 0 ;
struct V_78 * V_83 ;
...
struct V_58 * V_58 = F_62 ( V_83 ) ;
V_83 -> V_84 = F_44 ( V_47 , V_58 , V_83 -> V_49 ,
V_83 -> V_85 , V_81 , NULL ) ;
if ( ! F_56 ( V_47 , V_83 -> V_84 ) ) {
V_83 -> V_86 = V_83 -> V_85 ;
V_82 ++ ;
} else
goto V_87;
...
static void F_63 ( struct V_54 * V_47 , struct V_78 * V_79 ,
int V_80 , enum V_59 V_81 ,
struct V_61 * V_62 )
{
struct V_78 * V_83 ;
int V_35 ;
F_61 (sg, s, nr_elements, i) {
F_52 ( V_47 , V_83 -> V_84 , V_83 -> V_86 , V_81 , NULL ) ;
V_83 -> V_84 = 0 ;
V_83 -> V_86 = 0 ;
}
}
...
V_2 -> V_90 = ( unsigned long ) V_91 - V_92 ;
V_2 -> V_6 = V_2 -> V_90 >> V_31 ;
...
static int T_5 F_78 ( char * V_99 )
{
if ( ! strncmp ( V_99 , L_5 , 6 ) )
V_41 = 1 ;
return 0 ;
}
