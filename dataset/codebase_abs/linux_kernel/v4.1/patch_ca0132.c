...
for ( V_263 = 0 ; V_263 < V_23 -> V_476 ; V_263 ++ )
F_214 ( V_2 , V_23 -> V_477 [ V_263 ] ) ;
F_132 ( V_2 ) ;
F_143 ( V_2 ) ;
F_141 ( V_2 ) ;
F_136 ( V_2 ) ;
...
V_23 -> V_477 [ 1 ] = V_488 ;
V_23 -> V_476 = 2 ;
F_218 ( & V_23 -> V_329 , F_137 ) ;
F_210 ( V_2 ) ;
F_216 ( V_2 ) ;
V_35 = F_219 ( V_2 , & V_23 -> V_397 , NULL ) ;
if ( V_35 < 0 )
return V_35 ;
V_2 -> V_489 = V_490 ;
V_2 -> V_491 = 1 ;
