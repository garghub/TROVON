...
static int F_20 ( struct V_1 * V_2 , int V_57 )
{
int V_32 , V_89 ;
T_1 V_4 ;
...
static int F_22 ( struct V_1 * V_2 , int V_92 )
{
...
static T_4 F_23 ( struct V_101 * V_102 ,
struct V_103 * V_104 , const char * V_7 , T_5 V_105 )
{
T_6 V_106 ;
T_1 V_4 ;
int V_32 ;
struct V_18 * V_19 = F_24 ( V_102 ) ;
struct V_1 * V_2 = F_6 ( V_19 ) ;
if ( F_25 ( V_7 , 10 , & V_106 ) )
return - V_60 ;
if ( V_106 < V_107 ||
V_106 > V_108 )
return - V_60 ;
...
static T_4 F_26 ( struct V_101 * V_102 ,
struct V_103 * V_104 , char * V_7 )
{
struct V_1 * V_2 = F_6 ( F_24 ( V_102 ) ) ;
...
static int F_31 ( struct V_126 * V_5 ,
const struct V_120 * V_121 )
{
struct V_1 * V_2 ;
struct V_18 * V_19 ;
...
V_129 ) )
return - V_130 ;
V_19 = F_33 ( & V_5 -> V_102 , sizeof( * V_2 ) ) ;
if ( ! V_19 )
return - V_131 ;
V_2 = F_6 ( V_19 ) ;
V_2 -> V_5 = V_5 ;
V_2 -> V_21 = 0 ;
V_128 = F_34 ( & V_5 -> V_102 ) ;
if ( V_128 )
V_2 -> V_116 = * V_128 ;
V_32 = F_30 ( V_2 , V_121 ) ;
if ( V_32 )
...
V_19 -> V_133 = ( char * ) F_37 ( & V_5 -> V_102 ) ;
V_19 -> V_134 = V_135 ;
...
NULL ) ;
if ( V_32 ) {
F_35 ( & V_2 -> V_5 -> V_102 , L_4 ,
V_32 ) ;
return V_32 ;
}
V_32 = F_39 ( V_19 ) ;
if ( V_32 ) {
F_35 ( & V_2 -> V_5 -> V_102 , L_5 , V_32 ) ;
goto V_143;
}
F_40 ( V_2 -> V_144 ) ;
F_41 ( & V_2 -> V_145 ) ;
V_32 = F_42 ( V_19 ) ;
if ( V_32 ) {
F_35 ( & V_2 -> V_5 -> V_102 , L_6 , V_32 ) ;
goto V_146;
}
V_2 -> V_147 = F_43 ( V_5 -> V_13 ,
& V_5 -> V_102 ,
V_19 ,
0 , 0 , 0 ,
F_5 ,
...
static int F_49 ( struct V_126 * V_5 )
{
struct V_18 * V_19 = F_50 ( V_5 ) ;
struct V_1 * V_2 = F_6 ( V_19 ) ;
F_51 ( V_2 ) ;
F_45 ( V_2 -> V_147 ) ;
F_46 ( V_19 ) ;
...
{
return F_13 (
F_6 ( F_50 ( F_53 ( V_102 ) ) ) , true ) ;
}
static int F_54 ( struct V_101 * V_102 )
{
return F_13 (
F_6 ( F_50 ( F_53 ( V_102 ) ) ) , false ) ;
}
