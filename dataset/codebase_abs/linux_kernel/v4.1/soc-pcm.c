...
V_211 -> V_218 = V_2 -> V_17 -> V_218 ;
V_2 -> V_211 = V_211 ;
V_211 -> V_42 = V_2 ;
if ( V_2 -> V_17 -> V_96 ) {
if ( V_65 )
V_211 -> V_219 [ V_8 ] . V_20 -> V_42 = V_2 ;
if ( V_67 )
V_211 -> V_219 [ V_109 ] . V_20 -> V_42 = V_2 ;
goto V_88;
}
if ( V_2 -> V_17 -> V_95 ) {
V_2 -> V_86 . V_89 = F_111 ;
...
{
return V_38 -> V_211 -> V_219 [ V_3 ] . V_20 ;
}
enum V_228
...
static char * F_123 ( enum V_228 V_131 )
{
switch ( V_131 ) {
case V_171 :
return L_108 ;
...
V_3 ? L_120 : L_121 ) ;
V_125 += snprintf ( V_229 + V_125 , V_230 - V_125 , L_122 ,
...
F_15 ( V_55 ) ,
F_14 ( V_55 ) ) ;
V_125 += snprintf ( V_229 + V_125 , V_230 - V_125 , L_125 ) ;
if ( F_101 ( & V_33 -> V_37 [ V_3 ] . V_134 ) ) {
V_125 += snprintf ( V_229 + V_125 , V_230 - V_125 ,
L_126 ) ;
goto V_88;
...
static T_4 F_126 ( struct V_231 * V_231 , char T_6 * V_232 ,
T_5 V_169 , T_7 * V_233 )
{
struct V_1 * V_33 = V_231 -> V_42 ;
T_4 V_234 = V_235 , V_125 = 0 , V_43 = 0 ;
char * V_229 ;
V_229 = F_127 ( V_234 , V_129 ) ;
if ( ! V_229 )
return - V_130 ;
if ( V_33 -> V_5 -> V_45 -> V_65 . V_80 )
...
V_229 + V_125 , V_234 - V_125 ) ;
V_43 = F_128 ( V_232 , V_169 , V_233 , V_229 , V_125 ) ;
F_67 ( V_229 ) ;
return V_43 ;
}
