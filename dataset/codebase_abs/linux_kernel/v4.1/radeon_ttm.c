...
F_54 (ttm->sg->sgl, &sg_iter, ttm->sg->nents, 0 ) {
struct V_141 * V_141 = F_55 ( & V_152 ) ;
...
#if V_42
if ( V_6 -> V_26 & V_43 ) {
return F_68 ( V_3 , V_6 -> V_44 -> V_45 -> V_162 ,
V_16 , V_160 , V_161 ) ;
}
#endif
...
V_120 -> V_6 = V_6 ;
if ( F_70 ( & V_120 -> V_104 , V_3 , V_16 , V_160 , V_161 ) ) {
F_51 ( V_120 ) ;
return NULL ;
}
...
V_104 -> V_144 = F_73 ( 1 , sizeof( struct V_168 ) , V_145 ) ;
if ( ! V_104 -> V_144 )
return - V_147 ;
V_104 -> V_160 |= V_165 ;
V_104 -> V_166 = V_169 ;
