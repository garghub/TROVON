...
int F_38 ( struct V_133 * V_134 , struct V_31 * V_32 )
{
struct V_38 * V_68 = V_32 -> V_42 ;
T_1 V_135 = V_134 -> V_136 ;
if ( V_68 -> V_47 )
F_39 ( V_134 , L_46 , V_68 -> V_47 ) ;
if ( V_68 -> V_48 )
F_40 ( V_134 , L_47 ) ;
if ( V_68 -> V_56 & V_113 )
F_39 ( V_134 , L_48 , & V_68 -> V_34 ) ;
if ( V_68 -> V_56 & V_122 )
F_40 ( V_134 , L_49 ) ;
if ( V_68 -> V_56 & V_125 )
F_40 ( V_134 , L_50 ) ;
if ( V_68 -> V_56 & V_128 )
F_40 ( V_134 , L_51 ) ;
if ( ( V_68 -> V_56 & V_131 ) == 0 )
F_40 ( V_134 , L_52 ) ;
if ( V_68 -> V_98 != V_99 )
F_39 ( V_134 , L_53 , V_68 -> V_98 ) ;
if ( V_68 -> V_100 != V_101 )
F_39 ( V_134 , L_54 , V_68 -> V_100 ) ;
if ( V_68 -> V_96 != V_97 )
F_39 ( V_134 , L_55 ,
V_68 -> V_96 ) ;
...
V_140 ;
if ( F_45 ( V_32 , V_151 ) )
V_142 = & V_32 -> V_42 -> V_110 ;
F_46 ( & V_32 -> V_152 , V_142 ,
V_32 -> V_139 ,
V_32 -> V_140 ,
F_45 ( V_32 , V_153 ) ,
F_45 ( V_32 , V_154 ) ) ;
...
{
return V_32 -> V_53 . V_54 && V_32 -> V_53 . V_54 -> V_159 &&
V_32 -> V_156 . V_160 && V_32 -> V_156 . V_160 -> V_159 ;
}
int F_55 ( struct V_31 * V_32 , unsigned long V_161 )
{
int V_65 ;
unsigned long V_162 = V_32 -> V_42 -> V_98 * V_163 ;
V_65 = F_56 ( & V_32 -> V_53 ) ;
if ( V_65 < 0 )
return V_65 ;
while ( ! F_54 ( V_32 ) ) {
V_65 = - V_164 ;
if ( V_162 && F_57 ( V_165 , V_161 + V_162 ) )
return V_65 ;
F_15 ( L_58 ) ;
V_65 = F_58 ( V_32 -> V_144 ,
F_54 ( V_32 ) || ( V_32 -> V_145 < 0 ) ,
V_162 ) ;
if ( V_65 == - V_166 || V_65 == - V_167 )
return V_65 ;
if ( V_32 -> V_145 < 0 )
return V_32 -> V_145 ;
}
...
{
int V_46 ;
unsigned long V_161 = V_165 ;
F_15 ( L_59 ) ;
F_60 ( & V_32 -> V_143 ) ;
V_46 = F_55 ( V_32 , V_161 ) ;
F_61 ( & V_32 -> V_143 ) ;
return V_46 ;
}
