...
static void
F_61 ( struct V_5 * V_6 , T_1 V_63 , bool V_64 ,
bool V_65 )
{
...
static inline void F_64 ( struct V_5 * V_6 ,
enum V_23 V_24 )
{
struct V_10 * V_39 ;
enum V_1 V_2 ;
...
static bool F_65 ( struct V_5 * V_6 , T_1 V_63 )
{
int V_70 ;
for ( V_70 = 0 ; V_70 < F_66 ( V_71 ) ; V_70 ++ )
if ( V_63 == V_71 [ V_70 ] )
return true ;
return false ;
}
static bool F_67 ( struct V_5 * V_6 , T_1 V_63 )
{
int V_70 ;
for ( V_70 = 0 ; V_70 < F_66 ( V_72 ) ; V_70 ++ )
if ( V_63 == V_72 [ V_70 ] )
return true ;
return false ;
}
...
V_11 -> V_14 = F_69 ( 0xffff ) ;
V_11 -> V_20 = F_70 ( V_18 ) ;
V_11 -> V_21 = F_69 ( V_18 ) ;
}
if ( F_34 ( V_6 ) )
V_11 -> V_22 = V_75 ;
else if ( F_43 ( V_6 ) || F_44 ( V_6 ) || F_71 ( V_6 ) )
V_11 -> V_22 = V_76 ;
else
V_11 -> V_22 = 0 ;
V_11 -> V_13 = V_6 ;
V_11 -> V_2 = V_73 ;
F_72 ( & V_11 -> V_15 , F_36 , ( unsigned long ) V_11 ) ;
V_6 -> V_25 . V_24 |= ( 1 << V_73 ) ;
F_7 ( V_11 ) ;
}
static void F_73 ( struct V_45 * V_7 )
{
struct V_5 * V_6 = V_7 -> V_47 ;
...
void F_84 ( struct V_45 * V_7 )
{
F_56 ( V_7 ) ;
F_39 ( V_7 , false ) ;
}
int F_85 ( struct V_45 * V_7 ,
...
int V_70 , V_33 = 0 ;
for ( V_70 = 0 ; V_70 < F_66 ( V_112 ) ; V_70 ++ , V_111 ++ ) {
if ( V_111 -> V_113 == V_63 -> V_113 &&
( 1 << F_49 ( V_7 ) -> V_53 & V_111 -> V_114 ) )
break;
}
if ( V_70 == F_66 ( V_112 ) )
return - V_115 ;
...
switch ( V_111 -> V_116 ) {
case 8 :
V_63 -> V_117 = F_87 ( V_63 -> V_113 ) ;
break;
case 4 :
V_63 -> V_117 = F_88 ( V_63 -> V_113 ) ;
break;
case 2 :
V_63 -> V_117 = F_89 ( V_63 -> V_113 ) ;
break;
case 1 :
V_63 -> V_117 = F_90 ( V_63 -> V_113 ) ;
break;
default:
F_80 ( V_111 -> V_116 ) ;
V_33 = - V_115 ;
...
return - V_115 ;
if ( args -> V_126 == V_127 && ! F_93 ( V_128 ) )
return - V_129 ;
V_33 = F_94 ( & V_7 -> V_94 ) ;
if ( V_33 )
return V_33 ;
V_123 = F_95 ( V_108 -> V_130 , args -> V_126 ) ;
if ( F_96 ( V_123 ) ) {
F_77 ( & V_7 -> V_94 ) ;
return F_97 ( V_123 ) ;
}
...
static int F_99 ( struct V_45 * V_7 )
{
T_2 V_136 ;
F_100 ( V_7 -> V_137 , V_138 , & V_136 ) ;
return ( V_136 & V_139 ) == 0 ;
}
static int F_101 ( struct V_45 * V_7 )
{
F_102 ( V_7 -> V_137 , V_138 , V_140 ) ;
F_35 ( 20 ) ;
F_102 ( V_7 -> V_137 , V_138 , 0 ) ;
return F_103 ( F_99 ( V_7 ) , 500 ) ;
}
...
{
F_102 ( V_7 -> V_137 , V_138 , V_140 ) ;
return F_103 ( F_104 ( V_7 ) , 500 ) ;
}
static int F_106 ( struct V_45 * V_7 )
{
struct V_5 * V_6 = V_7 -> V_47 ;
int V_33 ;
F_102 ( V_7 -> V_137 , V_138 ,
V_141 | V_140 ) ;
V_33 = F_103 ( F_104 ( V_7 ) , 500 ) ;
if ( V_33 )
return V_33 ;
F_107 ( V_142 , F_88 ( V_142 ) | V_143 ) ;
F_108 ( V_142 ) ;
F_102 ( V_7 -> V_137 , V_138 ,
V_144 | V_140 ) ;
V_33 = F_103 ( F_104 ( V_7 ) , 500 ) ;
...
int V_33 ;
F_8 ( V_6 , V_150 , V_151 ) ;
V_33 = F_103 ( ( F_13 ( V_6 , V_150 ) & V_151 ) == 0 , 500 ) ;
F_39 ( V_7 , true ) ;
return V_33 ;
}
int F_111 ( struct V_45 * V_7 )
{
if ( F_49 ( V_7 ) -> V_53 >= 6 )
return F_110 ( V_7 ) ;
else if ( F_112 ( V_7 ) )
