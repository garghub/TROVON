...
static struct V_3 *
F_45 ( struct V_1 * V_2 , T_4 * V_120 )
{
struct V_3 * V_4 ;
if ( V_2 -> V_18 -> V_121 >= V_122 )
return NULL ;
V_4 = F_46 ( V_2 , V_120 , V_123 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_11 = V_12 ;
V_4 -> V_4 . V_124 = true ;
...
static void F_58 ( unsigned long V_136 )
{
struct V_3 * V_4 ;
T_3 V_15 = 0 ;
struct V_1 * V_2 ;
...
if ( V_4 -> V_2 -> V_18 -> V_138 )
return;
F_18 ( & V_4 -> V_65 ) ;
if ( F_59 ( V_113 , V_4 -> V_139 . V_140 ) ) {
F_10 ( V_4 -> V_2 ,
L_5 ,
V_4 -> V_4 . V_44 , V_141 [ V_4 -> V_11 ] ) ;
F_20 ( & V_4 -> V_65 ) ;
return;
}
if ( V_4 -> V_11 == V_12 ||
...
static inline void F_63 ( struct V_3 * V_4 , T_2 V_151 )
{
V_4 -> V_139 . V_140 = V_113 + F_64 ( V_151 ) ;
V_4 -> V_139 . V_136 = ( unsigned long ) V_4 ;
V_4 -> V_139 . V_152 = F_58 ;
V_4 -> V_145 = V_151 ;
F_65 ( & V_4 -> V_139 ) ;
}
...
V_4 -> V_11 = V_143 ;
F_63 ( V_4 , V_2 -> V_6 . V_7 . V_8 . V_156 ) ;
F_20 ( & V_4 -> V_65 ) ;
F_10 ( V_2 ,
L_9 ,
V_4 -> V_4 . V_44 ) ;
...
if ( V_169 != V_67 &&
( ! V_106 -> V_179 || ! V_106 -> V_137 ) ) {
F_10 ( V_2 , L_19 ) ;
return;
}
V_14 = F_79 ( F_80 ( V_106 -> V_176 ) ) ;
if ( V_169 == V_100 ||
( V_169 == V_67 && V_80 == 8 ) )
V_13 = F_79 ( F_81 ( V_106 -> V_176 ) ) ;
F_7 () ;
...
V_185 = V_76 -> V_6 . V_69 . V_6 . V_82 . V_187 ;
V_184 = ( T_4 * ) V_76 -> V_6 . V_69 . V_6 . V_82 . V_187 - ( T_4 * ) V_76 ;
if ( V_76 -> V_6 . V_69 . V_6 . V_82 . V_99 ==
V_100 ) {
V_185 += 4 ;
V_184 += 4 ;
}
F_84 ( V_185 , V_181 - V_184 , true , & V_106 ) ;
F_78 ( V_2 , V_76 , & V_106 ) ;
}
