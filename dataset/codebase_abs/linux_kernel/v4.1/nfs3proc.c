...
static int
F_20 ( struct V_13 * V_50 , struct V_51 * V_52 ,
...
static int F_26 ( struct V_13 * V_13 , struct V_79 * V_79 ,
...
static struct V_85 * F_27 ( void )
{
struct V_85 * V_86 ;
V_86 = F_28 ( sizeof( * V_86 ) , V_87 ) ;
if ( V_86 != NULL ) {
...
static int F_29 ( struct V_13 * V_50 , struct V_39 * V_39 , struct V_85 * V_86 )
{
int V_26 ;
V_26 = F_2 ( F_18 ( V_50 ) , & V_86 -> V_4 , 0 ) ;
F_30 ( V_50 , V_86 -> V_6 . V_57 ) ;
if ( V_26 == 0 )
V_26 = F_31 ( V_39 , V_86 -> V_6 . V_44 , V_86 -> V_6 . V_28 , NULL ) ;
return V_26 ;
}
...
static int
F_34 ( struct V_13 * V_50 , struct V_39 * V_39 , struct V_40 * V_41 ,
int V_5 )
{
...
V_86 -> V_43 . V_92 . V_98 [ 0 ] = F_35 ( V_99 ) ;
V_86 -> V_43 . V_92 . V_98 [ 1 ] = F_35 ( V_10 -> V_100 ) ;
}
V_26 = F_36 ( V_50 , & V_41 -> V_101 , & V_89 , & V_90 ) ;
if ( V_26 )
goto V_78;
for (; ; ) {
V_26 = F_29 ( V_50 , V_39 , V_86 ) ;
if ( V_26 != - V_102 )
break;
...
F_30 ( F_15 ( V_39 ) , V_86 -> V_6 . V_28 ) ;
F_10 ( L_16 , V_26 ) ;
if ( V_26 != 0 )
goto V_104;
}
V_26 = F_37 ( F_15 ( V_39 ) , V_90 , V_89 ) ;
V_104:
F_38 ( V_90 ) ;
F_38 ( V_89 ) ;
V_78:
...
static int
F_39 ( struct V_13 * V_50 , struct V_51 * V_52 )
{
struct V_109 V_43 = {
. V_44 = F_16 ( V_50 ) ,
. V_52 = * V_52 ,
...
static void
F_40 ( struct V_3 * V_4 , struct V_13 * V_50 )
{
V_4 -> V_21 = & V_22 [ V_111 ] ;
}
static void F_41 ( struct V_11 * V_12 , struct V_112 * V_86 )
{
F_42 ( V_12 ) ;
}
static int
F_43 ( struct V_11 * V_12 , struct V_13 * V_50 )
{
struct V_110 * V_6 ;
if ( F_5 ( V_12 , V_50 ) )
return 0 ;
...
static void
F_44 ( struct V_3 * V_4 , struct V_13 * V_50 )
{
V_4 -> V_21 = & V_22 [ V_114 ] ;
}
static void F_45 ( struct V_11 * V_12 , struct V_115 * V_86 )
{
F_42 ( V_12 ) ;
}
static int
F_46 ( struct V_11 * V_12 , struct V_13 * V_116 ,
struct V_13 * V_117 )
{
struct V_118 * V_6 ;
if ( F_5 ( V_12 , V_116 ) )
return 0 ;
V_6 = V_12 -> V_113 . V_25 ;
F_30 ( V_116 , V_6 -> V_119 ) ;
F_30 ( V_117 , V_6 -> V_120 ) ;
return 1 ;
}
static int
F_47 ( struct V_13 * V_13 , struct V_13 * V_50 , struct V_51 * V_52 )
{
struct V_121 V_43 = {
. V_122 = F_16 ( V_13 ) ,
. V_123 = F_16 ( V_50 ) ,
...
static int
F_48 ( struct V_13 * V_50 , struct V_39 * V_39 , struct V_79 * V_79 ,
...
static int
F_49 ( struct V_13 * V_50 , struct V_39 * V_39 , struct V_40 * V_41 )
{
struct V_88 * V_89 , * V_90 ;
struct V_85 * V_86 ;
int V_26 = - V_58 ;
...
static int
F_50 ( struct V_13 * V_50 , struct V_51 * V_52 )
{
struct V_36 * V_57 ;
struct V_53 V_43 = {
. V_44 = F_16 ( V_50 ) ,
...
static int
F_51 ( struct V_39 * V_39 , struct V_48 * V_64 ,
T_1 V_138 , struct V_79 * * V_83 , unsigned int V_139 , int V_140 )
{
struct V_13 * V_50 = F_15 ( V_39 ) ;
T_2 * V_141 = F_52 ( V_50 ) -> V_142 ;
struct V_143 V_43 = {
. V_44 = F_16 ( V_50 ) ,
. V_138 = V_138 ,
...
static int
F_54 ( struct V_13 * V_50 , struct V_39 * V_39 , struct V_40 * V_41 ,
T_3 V_147 )
{
struct V_88 * V_89 , * V_90 ;
struct V_85 * V_86 ;
...
static int F_61 ( struct V_11 * V_12 , struct V_165 * V_166 )
{
...
static void F_62 ( struct V_165 * V_166 ,
struct V_3 * V_4 )
{
V_4 -> V_21 = & V_22 [ V_169 ] ;
}
...
static int F_64 ( struct V_11 * V_12 , struct V_165 * V_166 )
{
struct V_13 * V_13 = V_166 -> V_13 ;
if ( V_166 -> V_167 != NULL )
return V_166 -> V_167 ( V_12 , V_166 ) ;
...
static void F_67 ( struct V_11 * V_12 , struct V_171 * V_86 )
{
F_42 ( V_12 ) ;
}
static int F_68 ( struct V_11 * V_12 , struct V_171 * V_86 )
{
if ( V_86 -> V_172 != NULL )
...
static void F_69 ( struct V_171 * V_86 , struct V_3 * V_4 )
{
V_4 -> V_21 = & V_22 [ V_173 ] ;
}
static int
F_70 ( struct V_174 * V_175 , int V_176 , struct V_177 * V_178 )
{
struct V_13 * V_13 = F_71 ( V_175 ) ;
return F_72 ( F_73 ( V_13 ) -> V_179 , V_176 , V_178 ) ;
}
static int F_74 ( struct V_13 * V_13 , T_4 V_5 )
{
return 0 ;
}
