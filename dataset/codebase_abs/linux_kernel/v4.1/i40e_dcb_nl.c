...
if ( ! ( V_13 -> V_63 & V_64 ) )
return;
if ( ( V_13 -> V_63 & V_65 ) && ! ( V_13 -> V_2 . V_66 . V_67 ) )
return;
V_15 = & V_2 -> V_19 ;
for ( V_38 = 0 ; V_38 < V_15 -> V_68 ; V_38 ++ ) {
V_61 = V_15 -> V_69 [ V_38 ] . V_70 ;
V_62 = ( 1 << V_15 -> V_21 . V_31 [ V_61 ] ) ;
if ( V_62 & V_57 -> V_71 . V_72 ) {
V_60 . V_73 = V_15 -> V_69 [ V_38 ] . V_73 ;
V_60 . V_74 = V_15 -> V_69 [ V_38 ] . V_75 ;
V_60 . V_70 = V_61 ;
F_9 ( V_9 , & V_60 ) ;
}
}
F_10 ( V_9 , V_76 , V_77 , 0 , 0 ) ;
}
...
{
int V_79 , V_80 ;
for ( V_79 = 0 ; V_79 < V_13 -> V_81 ; V_79 ++ ) {
if ( V_13 -> V_57 [ V_79 ] && V_13 -> V_57 [ V_79 ] -> V_58 ) {
V_80 = F_11 ( V_13 -> V_57 [ V_79 ] , V_69 ) ;
if ( V_80 )
F_14 ( & V_13 -> V_82 -> V_9 , L_1 ,
V_83 , V_13 -> V_57 [ V_79 ] -> V_84 ,
V_80 , V_69 -> V_73 ,
V_69 -> V_75 , V_69 -> V_70 ) ;
}
}
}
static bool F_15 ( struct V_14 * V_85 ,
struct V_78 * V_69 )
{
int V_38 ;
for ( V_38 = 0 ; V_38 < V_85 -> V_68 ; V_38 ++ ) {
if ( V_69 -> V_73 == V_85 -> V_69 [ V_38 ] . V_73 &&
V_69 -> V_75 == V_85 -> V_69 [ V_38 ] . V_75 &&
V_69 -> V_70 == V_85 -> V_69 [ V_38 ] . V_70 )
return true ;
}
return false ;
}
...
if ( ( V_13 -> V_63 & V_65 ) && ! ( V_13 -> V_2 . V_66 . V_67 ) )
return;
for ( V_38 = 0 ; V_38 < V_86 -> V_68 ; V_38 ++ ) {
V_69 = V_86 -> V_69 [ V_38 ] ;
if ( ! F_15 ( V_87 , & V_69 ) )
F_13 ( V_13 , & V_69 ) ;
}
