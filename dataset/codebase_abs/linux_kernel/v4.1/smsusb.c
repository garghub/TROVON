...
static int F_42 ( struct V_63 * V_64 , int V_43 )
{
struct V_81 V_82 ;
struct V_5 * V_6 ;
void * V_67 ;
...
V_82 . V_104 = F_17 ;
V_82 . V_4 = V_6 ;
F_44 ( V_6 -> V_25 , V_82 . V_75 , sizeof( V_82 . V_75 ) ) ;
V_67 = F_35 ( V_6 , V_43 ) ;
V_36 = F_45 ( & V_82 , & V_6 -> V_23 , V_67 ) ;
if ( V_36 < 0 ) {
F_2 ( L_28 , V_36 ) ;
F_31 ( V_64 ) ;
#ifdef F_36
...
V_99 )
V_36 = F_52 ( V_25 , F_11 ( V_25 ,
V_64 -> V_95 -> V_97 [ V_33 ] . V_91 . V_98 ) ) ;
else
V_36 = F_52 ( V_25 , F_20 ( V_25 ,
V_64 -> V_95 -> V_97 [ V_33 ] . V_91 . V_98 ) ) ;
}
...
if ( V_47 -> V_107 == V_115 ) {
snprintf ( V_75 , sizeof( V_75 ) , L_39 ,
...
static int F_56 ( struct V_63 * V_64 , T_3 V_60 )
{
struct V_5 * V_6 = F_32 ( V_64 ) ;
F_57 ( V_118 L_44 , V_119 , V_60 . V_120 ) ;
V_6 -> V_39 = V_121 ;
F_13 ( V_6 ) ;
return 0 ;
}
static int F_58 ( struct V_63 * V_64 )
{
int V_36 , V_33 ;
struct V_5 * V_6 = F_32 ( V_64 ) ;
struct V_46 * V_25 = F_43 ( V_64 ) ;
F_57 ( V_118 L_45 , V_119 ) ;
F_52 ( V_25 , F_11 ( V_25 , V_6 -> V_26 ) ) ;
F_52 ( V_25 , F_20 ( V_25 , V_6 -> V_100 ) ) ;
for ( V_33 = 0 ; V_33 < V_64 -> V_95 -> V_91 . V_96 ; V_33 ++ )
F_57 ( V_118 L_37 , V_33 ,
V_64 -> V_95 -> V_97 [ V_33 ] . V_91 . V_98 ,
V_64 -> V_95 -> V_97 [ V_33 ] . V_91 . V_112 ,
V_64 -> V_95 -> V_97 [ V_33 ] . V_91 . V_92 ) ;
if ( V_64 -> V_111 > 0 ) {
