...
unsigned int V_190 ;
F_129 (j) {
if ( F_5 ( V_3 ) . V_193 == F_5 ( V_190 ) . V_193 )
F_131 ( V_190 , & V_194 [ V_3 ] ) ;
}
}
F_129 (i) {
unsigned int V_190 ;
F_130 ( & F_132 ( V_195 , V_3 ) ) ;
if ( F_5 ( V_3 ) . V_196 == - 1 ) {
F_131 ( V_3 , & F_132 ( V_195 , V_3 ) ) ;
continue;
}
F_129 (j) {
if ( F_5 ( V_3 ) . V_196 ==
F_5 ( V_190 ) . V_196 )
F_131 ( V_190 , & F_132 ( V_195 , V_3 ) ) ;
}
}
}
int F_133 ( unsigned int V_46 , struct V_74 * V_197 )
{
int V_82 = F_41 ( V_46 , V_197 ) ;
if ( ! V_82 ) {
F_131 ( V_46 , & V_16 ) ;
while ( ! F_60 ( V_46 ) )
F_134 () ;
...
F_138 ( V_46 , & F_132 ( V_195 , V_3 ) ) ;
F_130 ( & F_132 ( V_195 , V_46 ) ) ;
V_206 = & F_5 ( V_46 ) ;
V_206 -> V_192 = 0 ;
V_206 -> V_196 = - 1 ;
F_142 () ;
...
static void * T_6 F_163 ( unsigned int V_46 , T_8 V_211 ,
T_8 V_212 )
{
const unsigned long V_213 = F_40 ( V_214 ) ;
#ifdef F_164
int V_215 = F_165 ( V_46 ) ;
void * V_216 ;
if ( ! F_166 ( V_215 ) || ! F_167 ( V_215 ) ) {
V_216 = F_168 ( V_211 , V_212 , V_213 ) ;
F_169 ( L_35 ,
V_46 , V_215 ) ;
F_170 ( L_36 ,
V_46 , V_211 , F_40 ( V_216 ) ) ;
} else {
V_216 = F_171 ( F_167 ( V_215 ) ,
V_211 , V_212 , V_213 ) ;
F_170 ( L_37
L_38 , V_46 , V_211 , V_215 , F_40 ( V_216 ) ) ;
}
return V_216 ;
#else
return F_168 ( V_211 , V_212 , V_213 ) ;
#endif
}
static void T_6 F_172 ( void * V_216 , T_8 V_211 )
{
F_173 ( F_40 ( V_216 ) , V_211 ) ;
}
static int T_6 F_174 ( unsigned int V_217 , unsigned int V_218 )
{
if ( F_165 ( V_217 ) == F_165 ( V_218 ) )
return V_219 ;
else
return V_220 ;
}
static void T_6 F_175 ( unsigned long V_221 )
{
T_9 * V_152 = F_176 ( V_221 ) ;
T_10 * V_222 ;
T_11 * V_223 ;
if ( F_177 ( * V_152 ) ) {
T_10 * V_224 ;
V_224 = F_168 ( V_225 , V_225 , V_225 ) ;
F_178 ( & V_12 , V_152 , V_224 ) ;
}
V_222 = F_179 ( V_152 , V_221 ) ;
if ( F_180 ( * V_222 ) ) {
T_11 * V_224 ;
V_224 = F_168 ( V_225 , V_225 , V_225 ) ;
F_181 ( & V_12 , V_222 , V_224 ) ;
}
V_223 = F_182 ( V_222 , V_221 ) ;
if ( ! F_183 ( * V_223 ) ) {
T_12 * V_224 ;
V_224 = F_168 ( V_225 , V_225 , V_225 ) ;
F_184 ( & V_12 , V_223 , V_224 ) ;
}
}
void T_6 F_185 ( void )
{
...
if ( V_226 < 0 )
F_25 ( L_41 , V_226 ) ;
V_33 = ( unsigned long ) V_232 - ( unsigned long ) V_233 ;
F_189 (cpu)
F_8 ( V_46 ) = V_33 + V_234 [ V_46 ] ;
V_6 = F_8 ( F_24 () ) ;
F_190 () ;
if ( V_7 == V_8 )
F_191 ( V_235 ) ;
