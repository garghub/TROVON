...
{
struct V_1 * V_2 ;
struct V_120 * V_121 , * V_122 , * V_123 ;
int * V_124 ;
int V_34 ;
...
V_122 = F_41 ( & V_119 -> V_2 , V_121 -> V_126 ,
F_42 ( V_121 ) ,
V_119 -> V_127 ) ;
if ( ! V_122 ) {
F_14 ( & V_119 -> V_2 , L_12 ) ;
...
V_2 = F_43 ( & V_119 -> V_2 , sizeof( struct V_1 ) ,
V_129 ) ;
if ( ! V_2 )
return - V_130 ;
V_2 -> V_91 = F_44 ( & V_119 -> V_2 , NULL ) ;
if ( F_45 ( V_2 -> V_91 ) )
return - V_74 ;
F_46 ( V_2 -> V_91 ) ;
V_2 -> V_5 = F_47 ( & V_119 -> V_2 , V_121 -> V_126 , F_42 ( V_121 ) ) ;
if ( ! V_2 -> V_5 ) {
F_14 ( & V_119 -> V_2 , L_13 ) ;
V_34 = - V_130 ;
goto V_131;
}
V_2 -> V_116 [ V_20 ] . V_132 =
( V_133 ) ( V_121 -> V_126 + V_134 ) ;
V_2 -> V_116 [ V_88 ] . V_132 =
( V_133 ) ( V_121 -> V_126 + V_135 ) ;
V_123 = F_40 ( V_119 , V_136 , 0 ) ;
if ( ! V_123 ) {
F_14 ( & V_119 -> V_2 , L_14 ) ;
V_34 = - V_137 ;
goto V_131;
}
V_124 = & V_2 -> V_138 [ V_20 ] ;
* V_124 = V_123 -> V_126 ;
V_2 -> V_116 [ V_20 ] . V_139 = V_124 ;
V_123 = F_40 ( V_119 , V_136 , 1 ) ;
if ( ! V_123 ) {
F_14 ( & V_119 -> V_2 , L_14 ) ;
V_34 = - V_137 ;
goto V_131;
}
V_124 = & V_2 -> V_138 [ V_88 ] ;
* V_124 = V_123 -> V_126 ;
V_2 -> V_116 [ V_88 ] . V_139 = V_124 ;
V_2 -> V_2 = & V_119 -> V_2 ;
F_48 ( & V_119 -> V_2 , V_2 ) ;
V_34 = F_49 ( & V_119 -> V_2 , & V_140 ,
& V_141 , 1 ) ;
if ( V_34 != 0 )
goto V_131;
V_34 = F_50 ( & V_119 -> V_2 ) ;
if ( V_34 ) {
F_14 ( & V_119 -> V_2 , L_15 , V_34 ) ;
goto V_142;
}
return 0 ;
V_142:
