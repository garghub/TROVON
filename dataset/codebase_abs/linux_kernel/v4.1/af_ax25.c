...
static int F_122 ( struct V_126 * V_1 , struct V_245 * V_246 , T_8 V_247 )
{
F_123 ( struct V_197 * , V_248 , V_246 -> V_249 ) ;
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_197 V_250 ;
struct V_34 * V_35 ;
T_4 V_251 , * V_252 ;
...
V_35 = F_125 ( V_2 , V_253 , V_246 -> V_256 & V_257 , & V_196 ) ;
if ( V_35 == NULL )
goto V_152;
F_126 ( V_35 , V_253 - V_247 ) ;
if ( F_127 ( F_128 ( V_35 , V_247 ) , V_246 , V_247 ) ) {
V_196 = - V_59 ;
F_35 ( V_35 ) ;
goto V_152;
}
...
F_130 ( V_35 , 1 + F_132 ( V_252 ) ) ;
V_254 = F_133 ( V_35 -> V_43 , & V_3 -> V_24 , & V_250 . V_204 ,
V_252 , V_72 , V_81 ) ;
F_134 ( V_35 , V_254 ) ;
* F_135 ( V_35 ) = V_265 ;
...
static int F_137 ( struct V_126 * V_1 , struct V_245 * V_246 , T_8 V_253 ,
int V_210 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_34 * V_35 ;
...
F_141 ( V_35 , 0 , V_246 , V_266 ) ;
if ( V_246 -> V_249 ) {
T_4 V_22 ;
T_3 V_268 ;
const unsigned char * V_269 = F_142 ( V_35 ) ;
F_123 ( struct V_197 * , V_250 , V_246 -> V_249 ) ;
memset ( V_250 , 0 , sizeof( struct V_193 ) ) ;
F_143 ( V_269 + 1 , V_35 -> V_43 - V_269 - 1 , & V_268 , NULL ,
& V_22 , NULL , NULL ) ;
V_250 -> V_199 = V_200 ;
...
static int F_145 ( struct V_126 * V_2 , int V_270 )
{
return - V_153 ;
}
...
V_290 . V_91 = V_3 -> V_91 ;
V_290 . V_291 = F_153 ( & V_3 -> V_291 ) / V_52 ;
V_290 . V_292 = F_153 ( & V_3 -> V_292 ) / V_52 ;
V_290 . V_293 = F_153 ( & V_3 -> V_293 ) / V_52 ;
V_290 . V_294 = F_153 ( & V_3 -> V_294 ) / ( 60 * V_52 ) ;
V_290 . V_90 = V_3 -> V_90 ;
V_290 . V_46 = V_3 -> V_46 ;
V_290 . V_295 = F_154 ( V_2 ) ;
V_290 . V_296 = F_147 ( V_2 ) ;
...
static void * F_156 ( struct V_319 * V_320 , T_9 * V_321 )
__acquires( V_5 )
{
F_6 ( & V_5 ) ;
return F_157 ( & V_20 , * V_321 ) ;
}
static void * F_158 ( struct V_319 * V_320 , void * V_322 , T_9 * V_321 )
{
return F_159 ( V_322 , & V_20 , V_321 ) ;
}
static void F_160 ( struct V_319 * V_320 , void * V_322 )
__releases( V_5 )
{
F_8 ( & V_5 ) ;
}
static int F_161 ( struct V_319 * V_320 , void * V_322 )
{
T_1 * V_3 = F_162 ( V_322 , struct T_1 , V_4 ) ;
char V_323 [ 11 ] ;
int V_57 ;
F_163 ( V_320 , L_3 ,
( long ) V_3 ,
V_3 -> T_2 == NULL ? L_4 : V_3 -> T_2 -> V_7 -> V_149 ,
F_164 ( V_323 , & V_3 -> V_24 ) ,
V_3 -> V_23 ? L_5 : L_6 ) ;
F_163 ( V_320 , L_7 , F_164 ( V_323 , & V_3 -> V_29 ) ) ;
for ( V_57 = 0 ; ( V_3 -> V_33 != NULL ) && ( V_57 < V_3 -> V_33 -> V_32 ) ; V_57 ++ ) {
F_163 ( V_320 , L_8 ,
F_164 ( V_323 , & V_3 -> V_33 -> V_67 [ V_57 ] ) ,
V_3 -> V_33 -> V_226 [ V_57 ] ? L_5 : L_6 ) ;
}
F_163 ( V_320 , L_9 ,
V_3 -> V_46 ,
V_3 -> V_297 , V_3 -> V_298 , V_3 -> V_299 ,
F_153 ( & V_3 -> V_291 ) / V_52 , V_3 -> V_86 / V_52 ,
F_153 ( & V_3 -> V_292 ) / V_52 , V_3 -> V_88 / V_52 ,
F_153 ( & V_3 -> V_293 ) / V_52 , V_3 -> V_93 / V_52 ,
F_153 ( & V_3 -> V_294 ) / ( 60 * V_52 ) ,
V_3 -> V_95 / ( 60 * V_52 ) ,
V_3 -> V_90 , V_3 -> V_91 ,
V_3 -> V_85 / V_52 ,
V_3 -> V_83 ,
...
static int F_167 ( struct V_324 * V_324 , struct V_325 * V_325 )
{
return F_168 ( V_325 , & V_326 ) ;
}
static int T_10 F_169 ( void )
{
int V_327 = F_170 ( & V_167 , 0 ) ;
if ( V_327 != 0 )
goto V_152;
F_171 ( & V_328 ) ;
F_172 ( & V_329 ) ;
F_173 ( & V_330 ) ;
F_174 ( L_12 , V_331 , V_15 . V_332 ,
& V_333 ) ;
F_174 ( L_13 , V_331 , V_15 . V_332 , & V_334 ) ;
F_174 ( L_14 , V_331 , V_15 . V_332 , & V_335 ) ;
V_152:
return V_327 ;
}
static void T_11 F_175 ( void )
{
F_176 ( L_12 , V_15 . V_332 ) ;
F_176 ( L_13 , V_15 . V_332 ) ;
F_176 ( L_14 , V_15 . V_332 ) ;
F_177 ( & V_330 ) ;
F_178 ( & V_329 ) ;
F_179 ( V_159 ) ;
F_180 ( & V_167 ) ;
