...
{
F_43 ( ( unsigned long ) V_35 -> V_16 ) ;
V_35 -> V_16 = NULL ;
V_35 -> V_2 = 0 ;
F_27 ( V_35 ) ;
}
static int F_44 ( struct V_1 * V_35 )
{
F_37 ( V_35 ) ;
F_24 ( & V_44 ) ;
F_45 ( & V_35 -> V_45 ) ;
...
V_35 -> V_53 = F_52 ( F_4 ( V_7 ) ,
V_49 , & V_61 , 256 ) ;
if ( F_53 ( V_35 -> V_53 ) )
return F_54 ( V_35 -> V_53 ) ;
if ( F_29 () )
V_34 = F_55 ( V_35 -> V_16 ) ;
else
V_34 = F_56 ( V_35 -> V_16 ) >> V_42 ;
V_5 = F_57 ( 1 , & V_59 ) ;
if ( V_5 < 0 )
return V_5 ;
V_35 -> V_52 = V_59 ;
...
V_5 = F_62 ( V_58 , V_55 -> V_60 , L_2 , L_3 , V_56 ) ;
if ( V_5 )
goto V_64;
V_5 = F_62 ( V_58 , V_55 -> V_60 , L_4 , L_5 ,
V_10 ) ;
if ( V_5 )
goto V_64;
V_5 = F_63 ( V_58 , 0 ) ;
...
{
struct V_1 * V_35 = F_48 ( & V_55 -> V_55 ) ;
F_37 ( V_35 ) ;
memset ( V_35 -> V_16 , 0 , V_43 ) ;
return F_49 ( V_55 , V_35 ) ;
}
...
return V_32 ;
V_35 = F_1 ( V_8 ) ;
V_35 -> V_49 = F_51 ( V_35 -> V_10 ) ;
}
if ( V_35 -> V_49 < 0 )
V_35 -> V_49 = 0 ;
else
F_73 ( V_35 -> V_49 ) ;
V_35 -> V_53 = F_52 ( V_8 , V_35 -> V_49 , V_83 , 256 ) ;
if ( F_53 ( V_35 -> V_53 ) ) {
V_32 = F_54 ( V_35 -> V_53 ) ;
F_24 ( & V_44 ) ;
F_45 ( & V_35 -> V_45 ) ;
