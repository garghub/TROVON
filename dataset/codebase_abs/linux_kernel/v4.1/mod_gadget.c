...
static int F_105 ( struct V_105 * V_30 ,
struct V_106 * V_82 )
{
struct V_6 * V_7 = F_106 ( V_30 ) ;
struct V_12 * V_13 = F_5 ( V_7 ) ;
if ( ! V_82 ||
! V_82 -> V_83 ||
V_82 -> V_107 < V_108 )
...
static int F_107 ( struct V_105 * V_30 )
{
struct V_6 * V_7 = F_106 ( V_30 ) ;
struct V_12 * V_13 = F_5 ( V_7 ) ;
F_103 ( V_13 , V_101 ) ;
...
static int F_108 ( struct V_105 * V_30 )
{
struct V_6 * V_7 = F_106 ( V_30 ) ;
struct V_12 * V_13 = F_5 ( V_7 ) ;
return F_109 ( V_13 ) ;
}
static int F_110 ( struct V_105 * V_30 , int V_109 )
{
struct V_6 * V_7 = F_106 ( V_30 ) ;
struct V_12 * V_13 = F_5 ( V_7 ) ;
unsigned long V_16 ;
...
static int F_111 ( struct V_105 * V_30 , int V_110 )
{
struct V_6 * V_7 = F_106 ( V_30 ) ;
if ( V_110 )
F_88 ( V_7 , V_44 ) ;
...
struct V_1 * V_2 ;
struct V_10 * V_11 = F_97 ( V_13 ) ;
int V_113 = F_115 ( V_13 , V_113 ) ;
int V_114 ;
int V_28 ;
V_7 = F_79 ( sizeof( struct V_6 ) , V_115 ) ;
if ( ! V_7 ) {
F_48 ( V_11 , L_16 ) ;
return - V_116 ;
}
V_2 = F_79 ( sizeof( struct V_1 ) * V_113 , V_115 ) ;
if ( ! V_2 ) {
F_48 ( V_11 , L_17 ) ;
V_28 = - V_116 ;
goto V_117;
}
F_116 ( V_13 , & V_7 -> V_99 , V_118 ) ;
V_7 -> V_99 . V_60 = L_18 ;
V_7 -> V_99 . V_119 = F_112 ;
V_7 -> V_99 . V_120 = F_113 ;
V_7 -> V_2 = V_2 ;
V_7 -> V_121 = V_113 ;
F_117 ( V_7 ) ;
V_7 -> V_30 . V_11 . V_122 = V_11 ;
V_7 -> V_30 . V_60 = L_19 ;
V_7 -> V_30 . V_123 = & V_124 ;
V_7 -> V_30 . V_107 = V_125 ;
F_118 ( & V_7 -> V_30 . V_126 ) ;
F_119 (uep, gpriv, i) {
V_2 -> V_7 = V_7 ;
V_2 -> V_9 = NULL ;
snprintf ( V_2 -> V_127 , V_128 , L_20 , V_114 ) ;
V_2 -> V_15 . V_60 = V_2 -> V_127 ;
V_2 -> V_15 . V_123 = & V_129 ;
F_118 ( & V_2 -> V_15 . V_126 ) ;
if ( F_120 ( V_2 ) ) {
V_7 -> V_30 . V_130 = & V_2 -> V_15 ;
F_121 ( & V_2 -> V_15 , 64 ) ;
}
else {
F_121 ( & V_2 -> V_15 , 512 ) ;
F_122 ( & V_2 -> V_15 . V_126 , & V_7 -> V_30 . V_126 ) ;
}
}
V_28 = F_123 ( V_11 , & V_7 -> V_30 ) ;
if ( V_28 )
goto V_131;
F_124 ( V_11 , L_21 ) ;
return 0 ;
