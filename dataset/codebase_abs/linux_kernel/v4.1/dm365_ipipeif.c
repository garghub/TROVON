...
switch ( V_204 -> V_160 | F_48 ( V_205 -> V_202 ) ) {
case V_35 | V_208 :
if ( ! ( V_206 & V_209 ) ) {
V_31 -> V_24 = V_183 ;
break;
...
if ( V_205 -> V_202 == & V_207 -> V_212 . V_136 . V_202 )
V_31 -> V_184 = V_213 ;
else if ( V_205 -> V_202 == & V_207 -> V_214 .
V_215 . V_136 . V_202 )
V_31 -> V_184 = V_216 ;
else
return - V_29 ;
...
unsigned int V_206 ;
int V_142 ;
V_142 = F_54 ( V_218 , & V_31 -> V_136 ) ;
if ( V_142 < 0 )
return V_142 ;
V_142 = F_55 ( & V_31 -> V_46 , V_218 ) ;
if ( V_142 ) {
F_56 ( L_4 ) ;
goto V_219;
}
V_31 -> V_46 . V_51 = V_51 ;
V_206 = 0 ;
V_142 = F_57 ( & V_31 -> V_46 . V_220 . V_202 , 0 ,
...
struct V_203 * V_223 = & V_31 -> V_223 [ 0 ] ;
struct V_201 * V_224 = & V_57 -> V_202 ;
static T_3 V_225 ;
struct V_226 * V_227 ;
int V_142 ;
V_227 = F_59 ( V_222 , V_228 , 3 ) ;
if ( ! V_227 )
return - V_229 ;
V_225 = F_60 ( V_227 ) ;
V_227 = F_61 ( V_227 -> V_230 , V_225 , V_227 -> V_231 ) ;
if ( ! V_227 )
return - V_211 ;
V_31 -> V_63 = F_62 ( V_227 -> V_230 , V_225 ) ;
if ( ! V_31 -> V_63 ) {
V_142 = - V_211 ;
goto V_219;
}
F_63 ( V_57 , & V_232 ) ;
V_57 -> V_233 = & V_234 ;
F_64 ( V_57 -> V_231 , L_5 , sizeof( V_57 -> V_231 ) ) ;
V_57 -> V_235 = 1 << 16 ;
F_65 ( V_57 , V_31 ) ;
V_57 -> V_206 |= V_236 | V_237 ;
V_223 [ V_35 ] . V_206 = V_238 ;
V_223 [ V_69 ] . V_206 = V_239 ;
V_31 -> V_24 = V_183 ;
V_31 -> V_184 = V_185 ;
V_224 -> V_240 = & V_241 ;
V_142 = F_66 ( V_224 , V_242 , V_223 , 0 ) ;
if ( V_142 )
goto V_219;
F_67 ( & V_31 -> V_149 , 2 ) ;
F_68 ( & V_31 -> V_149 , & V_243 ,
V_152 , 0 ,
V_244 , 1 , V_245 ) ;
F_69 ( & V_31 -> V_149 , & V_246 , NULL ) ;
F_70 ( & V_31 -> V_149 ) ;
V_57 -> V_247 = & V_31 -> V_149 ;
V_31 -> V_46 . V_240 = & V_248 ;
V_31 -> V_46 . type = V_249 ;
