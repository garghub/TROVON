...
static void F_53 ( struct V_9 * V_68 )
{
struct V_6 * V_7 = F_7 ( V_68 ) ;
struct V_1 * V_2 = V_7 -> V_2 ;
F_48 ( V_68 ) ;
...
static T_5 F_54 ( int V_143 , void * V_144 )
{
...
static struct V_9 * F_60 ( struct V_149 * V_150 ,
struct V_151 * V_152 )
{
...
if ( V_150 -> V_154 != 3 )
return NULL ;
F_61 (chan, &mdma->dma_dev.channels, device_node) {
struct V_6 * V_7 = F_7 ( V_68 ) ;
if ( ! ( V_150 -> args [ 1 ] & F_62 ( V_7 -> V_8 ) ) )
continue;
if ( F_63 ( V_68 ) ) {
...
T_1 V_5 ;
int V_121 ;
V_2 = F_70 ( & V_159 -> V_21 , sizeof( * V_2 ) , V_164 ) ;
if ( ! V_2 )
return - V_165 ;
F_71 ( V_159 , V_2 ) ;
V_163 = F_72 ( V_166 , & V_159 -> V_21 ) ;
V_2 -> V_110 = V_163 -> V_167 ;
V_161 = F_73 ( V_159 , V_168 , 0 ) ;
V_2 -> V_4 = F_74 ( & V_159 -> V_21 , V_161 ) ;
if ( F_75 ( V_2 -> V_4 ) )
return F_76 ( V_2 -> V_4 ) ;
V_2 -> V_156 = F_77 ( V_159 -> V_21 . V_169 ,
L_4 ) ;
if ( F_75 ( V_2 -> V_156 ) )
return F_76 ( V_2 -> V_156 ) ;
V_2 -> V_170 = F_78 ( & V_159 -> V_21 , L_5 ) ;
if ( F_75 ( V_2 -> V_170 ) )
return F_76 ( V_2 -> V_170 ) ;
V_121 = F_79 ( V_2 -> V_170 ) ;
if ( V_121 )
return V_121 ;
F_80 ( V_2 -> V_20 . V_171 ) ;
F_81 ( V_172 , V_2 -> V_20 . V_171 ) ;
F_81 ( V_173 , V_2 -> V_20 . V_171 ) ;
F_81 ( V_174 , V_2 -> V_20 . V_171 ) ;
F_81 ( V_175 , V_2 -> V_20 . V_171 ) ;
V_5 = F_1 ( V_2 , V_176 ) ;
V_2 -> V_177 = ( V_5 >> V_178 ) &
V_179 ;
V_2 -> V_180 =
...
F_82 ( V_159 -> V_21 . V_169 , L_6 ,
& V_2 -> V_177 ) ;
V_121 = F_82 ( V_159 -> V_21 . V_169 ,
L_7 ,
& V_2 -> V_55 ) ;
if ( V_121 )
goto V_185;
...
V_2 -> V_20 . V_192 = F_48 ;
V_2 -> V_20 . V_193 = F_52 ;
V_2 -> V_20 . V_194 = F_62 ( V_62 ) | F_62 ( V_56 ) ;
V_2 -> V_20 . V_195 = V_196 ;
for ( V_106 = 1 ; V_106 <= V_2 -> V_54 ; V_106 <<= 1 ) {
V_2 -> V_20 . V_197 |= F_62 ( V_106 ) ;
V_2 -> V_20 . V_198 |= F_62 ( V_106 ) ;
}
F_83 ( & V_2 -> V_20 . V_199 ) ;
for ( V_106 = 0 ; V_106 < V_2 -> V_177 ; V_106 ++ ) {
struct V_6 * V_7 = & V_2 -> V_199 [ V_106 ] ;
V_7 -> V_2 = V_2 ;
V_7 -> V_8 = V_106 ;
V_7 -> V_143 = F_84 ( V_159 , V_106 ) ;
if ( V_7 -> V_143 < 0 ) {
V_121 = V_7 -> V_143 ;
goto V_185;
}
V_121 = F_85 ( & V_159 -> V_21 , V_7 -> V_143 , F_54 ,
V_200 ,
F_86 ( & V_159 -> V_21 ) , V_7 ) ;
if ( V_121 < 0 )
goto V_185;
V_7 -> V_11 . V_201 = F_21 ;
F_87 ( & V_7 -> V_11 , & V_2 -> V_20 ) ;
}
V_2 -> V_75 = F_88 ( F_86 ( & V_159 -> V_21 ) , & V_159 -> V_21 ,
sizeof( struct V_23 ) ,
4 , 0 ) ;
if ( ! V_2 -> V_75 ) {
V_121 = - V_165 ;
...
if ( V_121 )
goto V_185;
V_121 = F_90 ( V_159 -> V_21 . V_169 , F_60 , V_2 ) ;
if ( V_121 )
goto V_202;
F_91 ( & V_159 -> V_21 , L_8 ,
V_2 -> V_177 , V_2 -> V_180 ) ;
...
static int F_94 ( struct V_158 * V_159 )
{
struct V_1 * V_2 = F_95 ( V_159 ) ;
struct V_6 * V_7 , * V_70 ;
F_96 ( V_159 -> V_21 . V_169 ) ;
F_92 ( & V_2 -> V_20 ) ;
F_97 (mchan, next, &mdma->dma_dev.channels,
vc.chan.device_node) {
F_38 ( & V_7 -> V_11 . V_68 . V_203 ) ;
F_98 ( V_7 -> V_143 ) ;
F_99 ( & V_159 -> V_21 , V_7 -> V_143 , V_7 ) ;
F_100 ( & V_7 -> V_11 . V_204 ) ;
}
F_93 ( V_2 -> V_170 ) ;
return 0 ;
}
