...
static int F_58 ( struct V_2 * V_3 , struct V_85 * V_86 , T_3 V_31 )
{
struct V_15 * V_16 ;
int V_73 ;
struct V_8 * V_9 = F_4 ( V_3 ) ;
...
goto V_65;
if ( V_86 -> V_93 ) {
F_59 ( struct V_50 * , V_94 , V_86 -> V_93 ) ;
V_73 = - V_55 ;
...
V_73 = - V_100 ;
V_16 = F_60 ( V_3 , 2 + V_101 + sizeof( struct V_35 ) +
4 + V_31 , 0 , V_102 ) ;
if ( ! V_16 )
goto error;
F_61 ( V_16 , 2 + V_101 ) ;
...
F_63 ( V_16 ) ;
* ( ( T_1 * ) F_64 ( V_16 , 4 ) ) = 0 ;
V_73 = F_65 ( F_64 ( V_16 , V_31 ) , V_86 , V_31 ) ;
if ( V_73 < 0 ) {
F_27 ( V_16 ) ;
goto error;
}
...
if ( V_91 )
V_88 = (struct V_87 * ) F_66 ( V_3 , 0 ) ;
F_67 () ;
if ( V_88 == NULL ) {
const struct V_107 * V_108 ;
V_108 = F_68 ( V_9 -> V_108 ) ;
if ( V_108 && V_108 -> V_109 . V_110 )
V_38 = V_108 -> V_109 . V_111 ;
V_88 = F_69 ( F_6 ( V_3 ) , V_90 , V_3 ,
V_38 , V_9 -> V_70 ,
V_9 -> V_80 , V_9 -> V_112 ,
V_3 -> V_113 , F_70 ( V_3 ) ,
V_3 -> V_13 ) ;
...
F_73 ( V_16 , & V_88 -> V_115 ) ;
goto V_116;
}
}
F_74 ( V_16 , & V_88 -> V_115 ) ;
V_116:
V_73 = F_75 ( V_3 , V_16 , & V_9 -> V_103 . V_104 ) ;
F_76 () ;
error:
if ( V_73 >= 0 )
V_73 = V_31 ;
...
static int F_77 ( struct V_2 * V_3 , struct V_85 * V_86 ,
T_3 V_31 , int V_119 , int V_75 , int * V_49 )
{
struct V_8 * V_9 = F_4 ( V_3 ) ;
T_3 V_120 = 0 ;
int V_121 = - V_122 ;
F_59 ( struct V_123 * , sin , V_86 -> V_93 ) ;
struct V_15 * V_16 ;
if ( V_75 & V_124 )
goto V_65;
V_16 = F_78 ( V_3 , V_75 , V_119 , & V_121 ) ;
if ( ! V_16 )
goto V_65;
V_120 = V_16 -> V_31 ;
if ( V_31 < V_120 ) {
...
V_121 = F_79 ( V_16 , 0 , V_86 , V_120 ) ;
if ( V_121 )
goto V_127;
F_80 ( V_86 , V_3 , V_16 ) ;
if ( sin ) {
sin -> V_128 = V_57 ;
sin -> V_129 . V_60 = F_81 ( V_16 ) -> V_130 ;
sin -> V_131 = 0 ;
