...
unsigned long V_55 ;
V_55 = V_38 -> V_55 ;
if ( V_88 -> V_90 . V_91 . V_92 & V_93 )
V_55 = F_30 ( V_55 , V_88 ) ;
else if ( ( V_38 -> V_62 & 0xffff ) != V_94 &&
! ( V_88 -> V_90 . V_91 . V_92 & V_95 ) &&
V_88 -> V_90 . V_91 . V_96 )
V_55 = ( unsigned long ) V_88 -> V_90 . V_91 . V_96 ;
if ( F_31 () ) {
unsigned long V_97 , V_98 ;
V_55 = F_32 ( V_55 , 1 , & V_97 , & V_98 ) ;
* V_66 = (struct V_99 T_2 * ) V_55 ;
if ( F_33 ( * V_66 , ( void T_2 * ) V_97 ,
V_98 ) < 0 )
return ( void T_2 * ) - 1L ;
}
V_55 -= V_89 ;
...
int F_34 ( int V_71 , struct V_87 * V_88 ,
...
if ( V_88 -> V_90 . V_91 . V_92 & V_95 ) {
V_100 = V_88 -> V_90 . V_91 . V_96 ;
} else {
if ( V_44 -> V_108 -> V_109 . V_110 )
V_100 = V_44 -> V_108 -> V_109 . V_110 +
V_111 -> V_112 ;
else
V_100 = & V_68 -> V_113 ;
}
F_4 {
F_5 ( F_6 ( V_100 ) , & V_68 -> V_114 ) ;
F_5 ( * ( ( V_115 * ) & V_106 ) , ( V_115 T_2 * ) V_68 -> V_113 ) ;
} F_7 ( V_3 ) ;
if ( V_3 )
return - V_7 ;
V_38 -> V_55 = ( unsigned long ) V_68 ;
V_38 -> V_59 = ( unsigned long ) V_88 -> V_90 . V_91 . V_116 ;
V_38 -> V_60 = V_71 ;
V_38 -> V_57 = 0 ;
V_38 -> V_58 = 0 ;
F_37 ( V_50 , V_94 ) ;
...
int F_38 ( int V_71 , struct V_87 * V_88 ,
T_8 * V_69 , struct V_37 * V_38 )
{
struct V_75 T_2 * V_68 ;
void T_2 * V_100 ;
