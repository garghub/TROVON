...
static void F_270 ( struct V_563 * V_563 )
{
struct V_618 * V_326 = F_271 ( V_563 ) ;
struct V_9 * V_10 = F_272 ( V_326 ) ;
if ( V_60 )
...
F_266 ( & V_10 -> V_121 ) ;
F_266 ( & V_10 -> V_560 ) ;
F_276 ( V_10 -> V_11 . V_396 , & V_10 -> main ) ;
F_265 ( V_10 -> V_11 . V_396 -> V_534 , V_10 ) ;
F_268 ( V_10 -> V_585 ) ;
F_269 ( F_243 ( V_10 -> V_11 . V_396 , 0 ) ,
F_244 ( V_10 -> V_11 . V_396 , 0 ) ) ;
...
static int F_277 ( struct V_563 * V_563 , T_13 V_251 )
{
struct V_618 * V_326 = F_271 ( V_563 ) ;
struct V_9 * V_10 = F_272 ( V_326 ) ;
struct V_519 V_620 ;
...
F_278 ( V_563 ) ;
if ( 0 != F_279 ( V_563 , F_280 ( V_563 , V_251 ) ) ) {
F_281 ( V_563 ) ;
V_10 -> V_251 . V_624 = 1 ;
}
return 0 ;
