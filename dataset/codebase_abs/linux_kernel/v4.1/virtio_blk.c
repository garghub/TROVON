...
if ( V_58 )
V_125 = 1 ;
V_31 -> V_47 = F_66 ( sizeof( * V_31 -> V_47 ) * V_125 , V_83 ) ;
if ( ! V_31 -> V_47 ) {
V_58 = - V_72 ;
goto V_128;
}
V_124 = F_66 ( sizeof( * V_124 ) * V_125 , V_83 ) ;
if ( ! V_124 )
goto V_129;
V_123 = F_66 ( sizeof( * V_123 ) * V_125 , V_83 ) ;
if ( ! V_123 )
goto V_130;
V_47 = F_66 ( sizeof( * V_47 ) * V_125 , V_83 ) ;
if ( ! V_47 )
goto V_131;
for ( V_122 = 0 ; V_122 < V_125 ; V_122 ++ ) {
V_123 [ V_122 ] = F_10 ;
snprintf ( V_31 -> V_47 [ V_122 ] . V_132 , V_133 , L_4 , V_122 ) ;
V_124 [ V_122 ] = V_31 -> V_47 [ V_122 ] . V_132 ;
}
V_58 = V_21 -> V_134 -> V_135 ( V_21 , V_125 , V_47 , V_123 , V_124 ) ;
if ( V_58 )
goto V_136;
for ( V_122 = 0 ; V_122 < V_125 ; V_122 ++ ) {
...
static int F_69 ( char * V_137 , int V_44 , char * V_105 , int V_138 )
{
const int V_139 = 'z' - 'a' + 1 ;
char * V_140 = V_105 + strlen ( V_137 ) ;
char * V_141 = V_105 + V_138 ;
char * V_142 ;
int V_143 ;
V_142 = V_141 - 1 ;
* V_142 = '\0' ;
...
memcpy ( V_105 , V_137 , strlen ( V_137 ) ) ;
return 0 ;
}
...
T_6 V_145 ;
int V_58 ;
V_58 = F_65 ( V_21 , V_146 ,
struct V_94 , V_147 ,
& V_145 ) ;
if ( V_58 )
V_145 = F_42 ( V_21 , V_148 ) ||
F_42 ( V_21 , V_149 ) ;
return V_145 ;
}
...
const char * V_105 , T_7 V_150 )
{
struct V_78 * V_49 = F_50 ( V_102 ) ;
struct V_30 * V_31 = V_49 -> V_80 ;
struct V_110 * V_21 = V_31 -> V_21 ;
int V_122 ;
F_21 ( ! F_42 ( V_31 -> V_21 , V_146 ) ) ;
for ( V_122 = F_74 ( V_151 ) ; -- V_122 >= 0 ; )
if ( F_75 ( V_105 , V_151 [ V_122 ] ) )
break;
if ( V_122 < 0 )
return - V_144 ;
F_76 ( V_21 , F_77 ( struct V_94 , V_147 ) , V_122 ) ;
F_71 ( V_21 ) ;
return V_150 ;
}
static T_3
...
struct V_78 * V_49 = F_50 ( V_102 ) ;
struct V_30 * V_31 = V_49 -> V_80 ;
T_6 V_145 = F_70 ( V_31 -> V_21 ) ;
F_21 ( V_145 >= F_74 ( V_151 ) ) ;
return snprintf ( V_105 , 40 , L_5 , V_151 [ V_145 ] ) ;
}
...
V_58 = F_83 ( & V_164 , 0 , F_48 ( 1 << V_165 ) ,
V_83 ) ;
if ( V_58 < 0 )
goto V_128;
V_44 = V_58 ;
V_58 = F_65 ( V_21 , V_166 ,
struct V_94 , V_167 ,
& V_61 ) ;
if ( V_58 || ! V_61 )
V_61 = 1 ;
...
V_31 -> V_174 . V_154 = V_178 ;
V_31 -> V_174 . V_45 = V_179 ;
V_31 -> V_174 . V_180 =
sizeof( struct V_1 ) +
sizeof( struct V_10 ) * V_61 ;
V_31 -> V_174 . V_181 = V_31 ;
V_31 -> V_174 . V_182 = V_31 -> V_125 ;
V_58 = F_86 ( & V_31 -> V_174 ) ;
if ( V_58 )
goto V_183;
V_32 = V_31 -> V_49 -> V_50 = F_87 ( & V_31 -> V_174 ) ;
if ( F_35 ( V_32 ) ) {
V_58 = - V_72 ;
goto V_184;
}
V_32 -> V_33 = V_31 ;
F_69 ( L_7 , V_44 , V_31 -> V_49 -> V_185 , V_186 ) ;
V_31 -> V_49 -> V_187 = V_187 ;
V_31 -> V_49 -> V_188 = F_47 ( V_44 ) ;
V_31 -> V_49 -> V_80 = V_31 ;
V_31 -> V_49 -> V_189 = & V_190 ;
V_31 -> V_49 -> V_191 = & V_21 -> V_102 ;
V_31 -> V_44 = V_44 ;
F_71 ( V_21 ) ;
if ( F_42 ( V_21 , V_192 ) )
F_88 ( V_31 -> V_49 , 1 ) ;
F_45 ( V_21 , struct V_94 , V_115 , & V_155 ) ;
if ( ( V_116 ) V_155 != V_155 ) {
F_54 ( & V_21 -> V_102 , L_2 ,
( unsigned long long ) V_155 ) ;
V_155 = ( V_116 ) - 1 ;
}
F_58 ( V_31 -> V_49 , V_155 ) ;
F_89 ( V_32 , V_31 -> V_61 - 2 ) ;
F_90 ( V_32 , V_193 ) ;
F_91 ( V_32 , - 1U ) ;
V_58 = F_65 ( V_21 , V_194 ,
struct V_94 , V_195 , & V_156 ) ;
if ( ! V_58 )
F_92 ( V_32 , V_156 ) ;
else
F_92 ( V_32 , - 1U ) ;
V_58 = F_65 ( V_21 , V_196 ,
struct V_94 , V_157 ,
& V_157 ) ;
if ( ! V_58 )
F_93 ( V_32 , V_157 ) ;
...
& V_161 ) ;
if ( ! V_58 && V_161 )
F_95 ( V_32 , V_157 * V_161 ) ;
V_58 = F_65 ( V_21 , V_197 ,
struct V_94 , V_159 ,
& V_159 ) ;
if ( ! V_58 && V_159 )
F_96 ( V_32 , V_157 * V_159 ) ;
V_58 = F_65 ( V_21 , V_197 ,
struct V_94 , V_158 ,
& V_158 ) ;
if ( ! V_58 && V_158 )
F_97 ( V_32 , V_157 * V_158 ) ;
F_98 ( V_21 ) ;
F_99 ( V_31 -> V_49 ) ;
V_58 = F_100 ( F_61 ( V_31 -> V_49 ) , & V_198 ) ;
if ( V_58 )
goto V_199;
if ( F_42 ( V_21 , V_146 ) )
...
F_102 ( V_31 -> V_49 -> V_50 ) ;
F_103 ( & V_31 -> V_174 ) ;
V_21 -> V_134 -> V_204 ( V_21 ) ;
V_203 = F_108 ( & F_61 ( V_31 -> V_49 ) -> V_119 . V_205 . V_206 ) ;
F_104 ( V_31 -> V_49 ) ;
V_21 -> V_134 -> V_202 ( V_21 ) ;
F_68 ( V_31 -> V_47 ) ;
F_68 ( V_31 ) ;
