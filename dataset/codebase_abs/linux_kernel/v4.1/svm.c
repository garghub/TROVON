...
static void * F_215 ( struct V_7 * V_10 , T_2 V_426 , struct V_163 * * V_427 )
{
struct V_163 * V_163 ;
F_216 () ;
V_163 = F_217 ( V_10 -> V_9 . V_278 , V_426 >> V_134 ) ;
if ( F_218 ( V_163 ) )
goto error;
* V_427 = V_163 ;
return F_219 ( V_163 ) ;
...
static void F_220 ( struct V_163 * V_163 )
{
F_221 ( V_163 ) ;
F_222 ( V_163 ) ;
}
...
V_97 = 0 ;
if ( F_224 ( V_10 -> V_9 . V_278 , V_426 , & V_97 , V_428 ) )
return V_420 ;
...
return V_420 ;
V_43 *= 4 ;
if ( F_224 ( V_10 -> V_9 . V_278 , V_10 -> V_17 . V_433 + V_43 , & V_363 , 4 ) )
return V_420 ;
...
V_1 -> V_2 . V_450 ,
V_452 ) ;
V_451 = F_215 ( V_10 , V_10 -> V_17 . V_1 , & V_163 ) ;
if ( ! V_451 )
return 1 ;
F_230 ( & V_10 -> V_9 ) ;
V_10 -> V_17 . V_1 = 0 ;
...
( void ) F_235 ( & V_10 -> V_9 , V_18 -> V_58 . V_271 ) ;
}
...
if ( F_224 ( V_10 -> V_9 . V_278 , V_43 , & V_363 , 4 ) )
return false ;
...
V_451 = F_215 ( V_10 , V_10 -> V_1 -> V_58 . V_454 , & V_163 ) ;
if ( ! V_451 )
return false ;
if ( ! F_239 ( V_451 ) ) {
...
V_18 -> V_58 . V_263 = F_231 ( & V_10 -> V_9 ) ;
V_18 -> V_58 . V_267 = V_10 -> V_9 . V_39 . V_267 ;
V_18 -> V_58 . V_306 = F_232 ( & V_10 -> V_9 ) ;
...
( void ) F_235 ( & V_10 -> V_9 , V_451 -> V_58 . V_271 ) ;
F_236 ( & V_10 -> V_9 ) ;
...
{
struct V_8 * V_9 = & V_10 -> V_9 ;
F_252 ( V_10 -> V_1 -> V_58 . V_84 , F_253 ( & V_10 -> V_9 , V_432 ) ,
F_253 ( & V_10 -> V_9 , V_457 ) ) ;
F_254 ( V_9 , F_253 ( & V_10 -> V_9 , V_457 ) ) ;
V_10 -> V_71 = F_34 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
{
F_256 ( V_10 -> V_1 -> V_58 . V_84 , F_253 ( & V_10 -> V_9 , V_457 ) ) ;
F_176 ( & V_10 -> V_9 , V_216 ) ;
return 1 ;
}
...
{
T_2 V_476 = F_260 ( & V_10 -> V_9 ) ;
T_1 V_145 = F_253 ( & V_10 -> V_9 , V_432 ) ;
if ( F_261 ( & V_10 -> V_9 , V_145 , V_476 ) == 0 ) {
V_10 -> V_71 = F_34 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
}
return 1 ;
...
if ( V_479 != V_496 )
V_481 = - 1 ;
if ( F_263 ( & V_10 -> V_9 , V_477 , V_481 , V_478 ,
V_79 , V_80 ) == V_498 ) {
...
F_254 ( & V_10 -> V_9 , V_10 -> V_1 -> V_2 . V_371 ) ;
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
return F_268 ( V_10 ) ;
V_308 = V_10 -> V_1 -> V_2 . V_371 & V_512 ;
V_514 = V_10 -> V_1 -> V_2 . V_407 - V_439 ;
if ( V_514 >= 16 ) {
if ( ! F_279 ( & V_10 -> V_9 , V_514 - 16 ) )
return 1 ;
V_97 = F_253 ( & V_10 -> V_9 , V_308 ) ;
F_280 ( & V_10 -> V_9 , V_514 - 16 , V_97 ) ;
} else {
if ( ! F_279 ( & V_10 -> V_9 , V_514 ) )
return 1 ;
F_281 ( & V_10 -> V_9 , V_514 , & V_97 ) ;
F_113 ( & V_10 -> V_9 , V_308 , V_97 ) ;
}
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
...
struct V_376 * V_376 = V_10 -> V_9 . V_377 ;
int V_141 ;
T_4 V_515 = F_277 ( & V_10 -> V_9 ) ;
V_141 = F_273 ( V_10 ) ;
if ( F_283 ( V_10 -> V_9 . V_278 ) )
return V_141 ;
if ( V_515 <= F_277 ( & V_10 -> V_9 ) )
return V_141 ;
V_376 -> V_380 = V_516 ;
return 0 ;
}
static T_2 F_284 ( struct V_8 * V_9 , T_2 V_517 )
{
struct V_1 * V_1 = F_8 ( F_4 ( V_9 ) ) ;
return V_1 -> V_2 . V_200 +
F_96 ( V_9 , V_517 ) ;
}
static int F_285 ( struct V_8 * V_9 , unsigned V_518 , T_2 * V_519 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
switch ( V_518 ) {
case V_520 : {
* V_519 = V_10 -> V_1 -> V_2 . V_200 +
F_96 ( V_9 , F_106 () ) ;
break;
}
case V_521 :
* V_519 = V_10 -> V_1 -> V_58 . V_465 ;
break;
#ifdef F_26
case V_522 :
* V_519 = V_10 -> V_1 -> V_58 . V_466 ;
break;
case V_523 :
* V_519 = V_10 -> V_1 -> V_58 . V_467 ;
break;
case V_303 :
* V_519 = V_10 -> V_1 -> V_58 . V_464 ;
break;
case V_524 :
* V_519 = V_10 -> V_1 -> V_58 . V_468 ;
break;
#endif
case V_525 :
* V_519 = V_10 -> V_1 -> V_58 . V_469 ;
break;
case V_526 :
* V_519 = V_10 -> V_471 ;
break;
...
break;
case V_528 :
* V_519 = V_10 -> V_1 -> V_58 . V_529 ;
break;
case V_159 :
* V_519 = V_10 -> V_1 -> V_58 . V_530 ;
break;
case V_160 :
* V_519 = V_10 -> V_1 -> V_58 . V_531 ;
break;
case V_161 :
* V_519 = V_10 -> V_1 -> V_58 . V_532 ;
break;
case V_162 :
* V_519 = V_10 -> V_1 -> V_58 . V_533 ;
break;
case V_132 :
* V_519 = V_10 -> V_17 . V_534 ;
break;
case V_535 :
* V_519 = V_10 -> V_17 . V_536 ;
break;
case V_537 :
* V_519 = 0x01000065 ;
break;
default:
return F_286 ( V_9 , V_518 , V_519 ) ;
}
return 0 ;
}
static int F_287 ( struct V_7 * V_10 )
{
T_1 V_518 = F_253 ( & V_10 -> V_9 , V_432 ) ;
T_2 V_519 ;
if ( F_285 ( & V_10 -> V_9 , V_518 , & V_519 ) ) {
F_288 ( V_518 ) ;
F_210 ( & V_10 -> V_9 , 0 ) ;
} else {
F_289 ( V_518 , V_519 ) ;
F_113 ( & V_10 -> V_9 , V_457 , V_519 & 0xffffffff ) ;
F_113 ( & V_10 -> V_9 , V_277 , V_519 >> 32 ) ;
V_10 -> V_71 = F_34 ( & V_10 -> V_9 ) + 2 ;
F_31 ( & V_10 -> V_9 ) ;
}
return 1 ;
}
static int F_290 ( struct V_8 * V_9 , T_2 V_519 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_538 , V_539 ;
if ( V_519 & ~ V_540 )
return 1 ;
V_539 = V_540 ;
if ( V_10 -> V_17 . V_536 & V_541 )
V_539 &= ~ ( V_542 | V_541 ) ;
V_10 -> V_17 . V_536 &= ~ V_539 ;
V_10 -> V_17 . V_536 |= ( V_519 & V_539 ) ;
V_538 = V_10 -> V_17 . V_536 & V_541 ;
if ( V_538 && ( V_9 -> V_39 . V_54 & V_59 ) )
return 1 ;
return 0 ;
}
static int F_291 ( struct V_8 * V_9 , struct V_543 * V_42 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
T_1 V_518 = V_42 -> V_145 ;
T_2 V_519 = V_42 -> V_519 ;
switch ( V_518 ) {
case V_520 :
F_292 ( V_9 , V_42 ) ;
break;
case V_521 :
V_10 -> V_1 -> V_58 . V_465 = V_519 ;
break;
#ifdef F_26
case V_522 :
V_10 -> V_1 -> V_58 . V_466 = V_519 ;
break;
case V_523 :
V_10 -> V_1 -> V_58 . V_467 = V_519 ;
break;
case V_303 :
V_10 -> V_1 -> V_58 . V_464 = V_519 ;
break;
case V_524 :
V_10 -> V_1 -> V_58 . V_468 = V_519 ;
break;
#endif
case V_525 :
V_10 -> V_1 -> V_58 . V_469 = V_519 ;
break;
case V_526 :
V_10 -> V_471 = V_519 ;
V_10 -> V_1 -> V_58 . V_471 = V_519 ;
break;
case V_527 :
V_10 -> V_470 = V_519 ;
V_10 -> V_1 -> V_58 . V_470 = V_519 ;
break;
case V_528 :
if ( ! F_84 ( V_544 ) ) {
F_293 ( V_9 , L_14 ,
...
break;
case V_132 :
V_10 -> V_17 . V_534 = V_519 ;
break;
case V_535 :
return F_290 ( V_9 , V_519 ) ;
case V_547 :
F_293 ( V_9 , L_15 , V_518 , V_519 ) ;
break;
default:
return F_294 ( V_9 , V_42 ) ;
}
return 0 ;
}
...
struct V_543 V_42 ;
T_1 V_518 = F_253 ( & V_10 -> V_9 , V_432 ) ;
T_2 V_519 = F_260 ( & V_10 -> V_9 ) ;
V_42 . V_519 = V_519 ;
V_42 . V_145 = V_518 ;
V_42 . V_548 = false ;
V_10 -> V_71 = F_34 ( & V_10 -> V_9 ) + 2 ;
if ( F_296 ( & V_10 -> V_9 , & V_42 ) ) {
F_297 ( V_518 , V_519 ) ;
F_210 ( & V_10 -> V_9 , 0 ) ;
} else {
F_298 ( V_518 , V_519 ) ;
...
L_81 , V_58 -> V_471 ) ;
F_55 ( L_63 ,
L_82 , V_58 -> V_270 , L_83 , V_58 -> V_529 ) ;
F_55 ( L_63 ,
L_84 , V_58 -> V_530 , L_85 , V_58 -> V_531 ) ;
F_55 ( L_63 ,
L_86 , V_58 -> V_532 ,
L_87 , V_58 -> V_533 ) ;
}
static void F_309 ( struct V_8 * V_9 , T_2 * V_553 , T_2 * V_554 )
{
...
if ( F_7 ( V_9 ) ) {
int V_417 ;
F_311 ( V_10 -> V_1 -> V_58 . V_84 , V_407 ,
V_10 -> V_1 -> V_2 . V_371 ,
V_10 -> V_1 -> V_2 . V_369 ,
V_10 -> V_1 -> V_2 . V_449 ,
V_10 -> V_1 -> V_2 . V_450 ,
...
V_407 != V_418 + V_215 &&
V_407 != V_408 && V_407 != V_558 &&
V_407 != V_424 && V_407 != V_425 )
F_33 ( V_77 L_89
L_90 ,
V_75 , V_10 -> V_1 -> V_2 . V_449 ,
V_407 ) ;
if ( V_407 >= F_313 ( V_559 )
|| ! V_559 [ V_407 ] ) {
F_100 ( 1 , L_91 , V_407 ) ;
F_176 ( V_9 , V_216 ) ;
return 1 ;
}
return V_559 [ V_407 ] ( V_10 ) ;
}
...
static inline void F_318 ( struct V_7 * V_10 , int V_563 )
{
struct V_11 * V_2 ;
V_2 = & V_10 -> V_1 -> V_2 ;
V_2 -> V_448 = V_563 ;
...
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_72 ( ! ( F_20 ( V_10 ) ) ) ;
F_320 ( V_9 -> V_39 . V_566 . V_78 ) ;
++ V_9 -> V_301 . V_567 ;
V_10 -> V_1 -> V_2 . V_90 = V_9 -> V_39 . V_566 . V_78 |
V_63 | V_64 ;
}
static void F_321 ( struct V_8 * V_9 , int V_568 , int V_569 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_322 ( struct V_8 * V_9 , bool V_570 )
{
return;
}
static int F_323 ( struct V_278 * V_278 )
{
return 0 ;
}
static void F_324 ( struct V_8 * V_9 , T_2 * V_571 )
{
return;
}
...
V_65 = V_65 && F_20 ( V_10 ) && F_214 ( V_10 ) ;
return V_65 ;
}
...
static void F_328 ( struct V_8 * V_9 , bool V_572 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( V_572 ) {
V_10 -> V_9 . V_39 . V_40 |= V_561 ;
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( ( V_10 -> V_9 . V_39 . V_40 & ( V_561 | V_506 ) )
== V_561 )
return;
V_10 -> V_354 = true ;
...
static int F_332 ( struct V_278 * V_278 , unsigned int V_50 )
{
return 0 ;
}
...
V_10 -> V_9 . V_39 . V_40 &= ~ ( V_561 | V_506 ) ;
F_185 ( V_473 , & V_10 -> V_9 ) ;
}
V_10 -> V_9 . V_39 . V_492 = false ;
F_233 ( & V_10 -> V_9 ) ;
...
F_338 ( & V_10 -> V_9 , V_577 , V_96 ) ;
} else
F_339 ( & V_10 -> V_9 , V_577 ) ;
break;
case V_495 :
F_340 ( & V_10 -> V_9 , V_577 , false ) ;
break;
default:
break;
}
...
F_343 ( V_10 -> V_1 -> V_2 . V_407 , V_9 , V_452 ) ;
...
static void F_347 ( struct V_8 * V_9 , unsigned long V_403 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_348 ( struct V_8 * V_9 , unsigned long V_403 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_401 = V_403 ;
F_3 ( V_10 -> V_1 , V_404 ) ;
...
static void
F_350 ( struct V_8 * V_9 , unsigned char * V_586 )
{
V_586 [ 0 ] = 0x0f ;
V_586 [ 1 ] = 0x01 ;
V_586 [ 2 ] = 0xd9 ;
}
static void F_351 ( void * V_587 )
{
* ( int * ) V_587 = 0 ;
}
...
static T_2 F_353 ( struct V_8 * V_9 , T_11 V_588 , bool V_589 )
{
return 0 ;
}
...
static void F_355 ( T_1 V_590 , struct V_591 * V_592 )
{
switch ( V_590 ) {
case 0x80000001 :
if ( V_17 )
...
if ( V_61 -> V_22 == V_618 ||
V_61 -> V_22 == V_619 ) {
V_616 = ( ( V_61 -> V_609 & 0xffff ) << 16 ) |
V_397 ;
V_617 = V_61 -> V_620 ;
} else {
V_616 = ( V_61 -> V_621 & 0xffff ) << 16 ;
V_617 = V_61 -> V_622 ;
}
if ( V_61 -> V_22 == V_623 ||
V_61 -> V_22 == V_619 )
...
static void F_365 ( struct V_8 * V_9 , int V_140 )
{
}
static int T_5 F_366 ( void )
{
return F_367 ( & V_628 , sizeof( struct V_7 ) ,
F_368 ( struct V_7 ) , V_629 ) ;
}
static void T_6 F_369 ( void )
{
F_370 () ;
}
