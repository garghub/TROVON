...
int F_31 ( struct V_5 * V_5 , struct V_55 * V_56 )
{
...
void F_32 ( struct V_5 * V_5 , int V_57 )
{
if ( ! V_44 )
return;
if ( V_57 & ( V_58 | V_59 | V_60 ) )
...
const struct V_7 * V_61 ,
struct V_7 * V_62 )
{
struct V_20 * V_21 ;
int V_25 ;
if ( ! V_44 || ! F_16 ( V_61 -> V_52 ) )
return 0 ;
V_21 = F_34 ( sizeof( * V_21 ) , V_28 ) ;
if ( ! V_21 )
return - V_63 ;
V_21 -> type = V_34 ;
V_25 = F_35 ( V_6 , V_61 , V_21 -> V_35 ) ;
if ( V_25 < 0 )
goto V_33;
V_62 -> V_64 = V_21 ;
V_62 -> V_65 = sizeof( * V_21 ) ;
V_62 -> V_52 = V_66 ;
return 0 ;
V_33:
F_15 ( V_21 ) ;
