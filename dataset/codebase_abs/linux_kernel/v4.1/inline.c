...
void * V_101 , int V_92 )
{
struct V_1 * V_100 = F_98 ( V_109 -> V_110 ) ;
const char * V_41 = V_109 -> V_111 . V_41 ;
int V_112 = V_109 -> V_111 . V_46 ;
int V_113 ;
struct V_104 * V_105 ;
V_113 = F_99 ( V_100 , V_1 , V_5 -> V_30 ,
V_101 , V_92 ,
V_41 , V_112 , & V_105 ) ;
if ( V_113 )
return V_113 ;
...
if ( V_113 )
return V_113 ;
F_100 ( V_100 , V_1 , V_105 , V_92 , & V_109 -> V_111 ,
V_41 , V_112 ) ;
...
int F_126 ( T_3 * V_50 , struct V_109 * V_109 ,
struct V_1 * V_1 )
{
int V_58 , V_92 ;
void * V_101 ;
...
if ( V_113 )
goto V_25;
V_113 = F_142 ( V_50 , V_100 , V_179 , V_30 ,
V_101 , V_92 , 0 ) ;
if ( V_113 )
goto V_25;
F_28 ( V_30 , L_9 ) ;
...
V_186 += ( char * ) F_8 ( & V_5 ) - V_5 . V_30 -> V_130 ;
