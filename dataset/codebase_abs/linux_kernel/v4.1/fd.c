...
{
int V_72 = F_45 ( V_25 , V_71 ) ;
if ( V_72 == 0 )
return 0 ;
if ( F_46 ( V_73 ) == F_47 ( V_25 ) )
V_72 = 0 ;
return V_72 ;
}
static int
F_48 ( struct V_25 * V_47 , struct V_26 * V_26 ,
struct V_10 * V_11 , const void * V_48 )
{
unsigned V_13 = ( unsigned long ) V_48 ;
struct V_49 * V_50 ;
...
static struct V_26 *
F_49 ( struct V_25 * V_47 , struct V_26 * V_26 , unsigned int V_27 )
{
return F_35 ( V_47 , V_26 , F_48 ) ;
}
static int F_50 ( struct V_9 * V_9 , struct V_62 * V_63 )
{
