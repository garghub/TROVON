...
static T_13 F_484 ( int V_1334 , void * V_3 )
{
struct V_17 * V_23 = V_3 ;
T_3 V_219 , V_220 ;
if ( ! V_23 )
...
F_498 ( & V_23 -> V_193 , V_1340 ) ;
F_498 ( & V_23 -> V_190 , V_1341 ) ;
...
#endif
F_499 ( & V_23 -> V_1337 , ( void (*) ( unsigned long ) )
...
{
int V_8 ;
for ( V_8 = 0 ; V_8 < F_224 ( V_1354 ) ; V_8 ++ ) {
...
F_503 ( V_23 -> V_163 , & V_1354 [ V_8 ] ) ;
}
static int F_164 ( struct V_17 * V_23 )
{
int V_155 , V_7 ;
if ( V_23 -> V_1356 ) {
F_504 ( V_23 -> V_163 , V_23 -> V_1356 ) ;
V_23 -> V_1356 = 0 ;
}
if ( V_23 -> V_37 & V_701 )
return - V_306 ;
...
V_1362 -> V_869 = F_505 ( V_202 -> V_203 ,
...
V_1375 -> V_869 = F_505 ( V_202 -> V_209 ,
sizeof( struct V_1365 ) ,
V_148 ) ;
if ( ! V_1375 -> V_869 ) {
V_155 = - V_476 ;
...
V_182 -> V_183 -> V_1381 = F_224 ( V_1380 ) ;
...
{
struct V_1382 * V_159 = F_341 ( V_166 ) ;
...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_513 ( sizeof( struct V_1382 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_476 ;
...
static int F_519 ( struct V_477 * V_1385 ,
...
F_522 ( V_1385 ) ;
V_557 = F_523 ( V_1385 , F_524 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_525 ( V_1385 , F_524 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_515 ) ;
goto V_1391;
}
F_526 ( V_1385 , V_23 ) ;
V_557 = F_527 ( V_1385 , V_1325 ) ;
if ( V_557 )
goto V_1391;
F_528 ( V_1385 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_529 ( V_1385 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_530 ( V_1385 , 0 ) ;
V_23 -> V_1392 = V_415 ;
V_137 = F_531 ( V_1385 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1389 ;
goto V_1393;
}
...
F_411 ( V_23 , 1 ) ;
V_557 = F_532 ( V_1385 -> V_1334 , F_484 , V_1395 , V_1325 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_519 , V_1385 -> V_1334 ) ;
goto V_1394;
}
F_515 ( V_167 , & V_1385 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1396 = F_473 ;
V_23 -> V_163 -> V_896 = F_500 ;
V_23 -> V_163 -> V_1397 = F_470 ;
#ifdef F_292
V_23 -> V_163 -> V_1398 = F_364 ;
V_23 -> V_163 -> V_1399 = F_369 ;
V_23 -> V_163 -> V_1400 = F_368 ;
V_23 -> V_163 -> V_1401 = F_370 ;
#endif
V_23 -> V_163 -> V_642 = - 20 ;
V_23 -> V_163 -> V_643 = - 85 ;
V_167 -> V_1383 = & V_1402 ;
...
V_167 -> V_1405 = & V_1406 ;
V_167 -> V_1407 = & V_1408 ;
V_557 = F_533 ( & V_1385 -> V_166 . V_1409 , & V_1410 ) ;
if ( V_557 ) {
F_46 ( L_520 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1411;
...
V_1412:
F_535 ( & V_1385 -> V_166 . V_1409 , & V_1410 ) ;
V_1411:
F_536 ( V_1385 -> V_1334 , V_23 ) ;
V_1394:
F_537 ( V_23 -> V_22 ) ;
V_1393:
F_538 ( V_1385 ) ;
...
static void F_540 ( struct V_477 * V_1385 )
{
struct V_17 * V_23 = F_541 ( V_1385 ) ;
...
static int F_544 ( struct V_477 * V_1385 , T_15 V_665 )
{
struct V_17 * V_23 = F_541 ( V_1385 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
...
F_546 ( V_1385 ) ;
F_539 ( V_1385 ) ;
F_547 ( V_1385 , F_548 ( V_1385 , V_665 ) ) ;
V_23 -> V_1414 = F_549 () ;
return 0 ;
}
static int F_550 ( struct V_477 * V_1385 )
{
struct V_17 * V_23 = F_541 ( V_1385 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
...
F_529 ( V_1385 , 0x40 , V_21 & 0xffff00ff ) ;
F_552 ( V_166 ) ;
V_23 -> V_1356 = F_549 () - V_23 -> V_1414 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_553 ( struct V_477 * V_1385 )
{
struct V_17 * V_23 = F_541 ( V_1385 ) ;
F_162 ( V_23 ) ;
F_539 ( V_1385 ) ;
...
V_432 = F_556 ( & V_1416 . V_1324 , & V_1417 ) ;
if ( V_432 ) {
F_46 ( L_531 ) ;
F_557 ( & V_1416 ) ;
return V_432 ;
