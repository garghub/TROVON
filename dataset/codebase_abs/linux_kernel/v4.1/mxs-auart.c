...
static int F_100 ( struct V_1 * V_2 , struct V_213 * V_12 )
{
enum V_214 V_34 ;
struct V_215 * V_216 ;
V_2 -> V_81 = F_101 ( V_12 , 0 ) ;
if ( F_102 ( V_2 -> V_81 ) )
return F_103 ( V_2 -> V_81 ) ;
if ( ! F_104 () || ! F_68 () ) {
...
V_216 = F_106 ( V_2 -> V_81 , V_34 ) ;
if ( V_216 && ( F_107 ( V_216 ) == V_218 ) )
V_2 -> V_94 [ V_34 ] = F_108 ( V_216 ) ;
else
V_2 -> V_94 [ V_34 ] = - V_27 ;
}
return 0 ;
...
if ( V_157 [ V_34 ] < 0 )
continue;
F_112 ( V_157 [ V_34 ] , V_220 ) ;
V_219 = F_113 ( V_157 [ V_34 ] , F_75 ,
...
while ( V_219 && ( -- V_34 >= 0 ) )
if ( V_157 [ V_34 ] >= 0 )
F_110 ( V_157 [ V_34 ] , V_2 ) ;
return V_219 ;
}
static int F_114 ( struct V_208 * V_209 )
{
const struct V_223 * V_224 =
F_115 ( V_225 , & V_209 -> V_12 ) ;
struct V_1 * V_2 ;
T_1 V_226 ;
int V_172 , V_157 ;
struct V_227 * V_228 ;
V_2 = F_116 ( & V_209 -> V_12 , sizeof( * V_2 ) , V_115 ) ;
if ( ! V_2 )
return - V_229 ;
...
return V_172 ;
if ( V_224 ) {
V_209 -> V_231 = V_224 -> V_232 ;
V_2 -> V_3 = V_209 -> V_231 -> V_233 ;
}
V_2 -> V_173 = F_117 ( & V_209 -> V_12 , NULL ) ;
if ( F_102 ( V_2 -> V_173 ) )
return F_103 ( V_2 -> V_173 ) ;
V_228 = F_118 ( V_209 , V_234 , 0 ) ;
if ( ! V_228 )
return - V_235 ;
V_2 -> V_10 . V_236 = V_228 -> V_237 ;
V_2 -> V_10 . V_40 = F_119 ( V_228 -> V_237 , F_120 ( V_228 ) ) ;
V_2 -> V_10 . V_238 = & V_239 ;
...
V_172 = F_123 ( & V_209 -> V_12 , V_157 , F_75 , 0 ,
F_37 ( & V_209 -> V_12 ) , V_2 ) ;
if ( V_172 )
return V_172 ;
F_124 ( V_209 , V_2 ) ;
V_172 = F_100 ( V_2 , & V_209 -> V_12 ) ;
if ( V_172 ) {
F_13 ( & V_209 -> V_12 , L_12 ) ;
return V_172 ;
}
V_172 = F_111 ( V_2 ) ;
if ( V_172 )
...
F_76 ( & V_2 -> V_10 ) ;
V_172 = F_125 ( & V_242 , & V_2 -> V_10 ) ;
if ( V_172 )
goto V_243;
V_226 = F_24 ( V_2 -> V_10 . V_40 + V_244 ) ;
F_126 ( & V_209 -> V_12 , L_13 ,
( V_226 >> 24 ) & 0xff ,
