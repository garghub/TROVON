...
void F_73 ( const struct V_60 * V_61 ,
struct V_1 * V_36 ,
struct V_1 * V_42 )
{
struct V_60 * V_147 ;
...
default:
F_38 ( & V_8 -> V_8 , L_13 ,
F_75 ( V_147 ) , V_147 -> V_153 ) ;
break;
}
}
}
void F_76 ( const struct V_60 * V_61 )
{
F_73 ( V_61 , NULL , NULL ) ;
}
static void F_77 ( const struct V_7 * V_62 ,
struct V_1 * V_59 ,
struct V_1 * V_42 )
{
struct V_60 * V_147 ;
...
void T_5 F_84 ( char * V_161 )
{
if ( ! strncmp ( V_161 , L_16 , 3 ) )
V_162 = V_163 ;
else if ( ! strncmp ( V_161 , L_17 , 2 ) )
V_162 = V_164 ;
}
static bool F_85 ( enum V_165 V_166 )
{
return V_166 >= V_164 ;
}
static int F_86 ( struct V_7 * V_8 , void * V_167 )
{
int V_20 ;
bool * V_168 = V_167 ;
...
static enum V_165 F_87 ( struct V_60 * V_61 ,
enum V_165 V_169 )
{
bool V_168 = false ;
if ( V_169 != V_170 )
return V_169 ;
F_88 ( V_61 , F_86 , & V_168 ) ;
if ( V_168 )
return V_171 ;
return V_169 ;
}
...
void F_89 ( struct V_60 * V_61 )
{
F_31 ( V_36 ) ;
struct V_1 * V_172 = NULL ;
int V_173 = 0 ;
enum V_155 V_156 = V_174 ;
F_31 ( V_42 ) ;
struct V_3 * V_45 ;
unsigned long V_107 = V_47 | V_48 |
V_49 | V_90 ;
...
V_180 = F_94 ( V_62 ) ;
if ( V_180 )
F_95 ( & V_62 -> V_8 , L_23 , V_180 ) ;
F_96 ( V_62 ) ;
}
void F_97 ( struct V_60 * V_61 )
{
struct V_7 * V_8 ;
F_31 ( V_172 ) ;
F_98 ( & V_182 ) ;
F_11 (dev, &bus->devices, bus_list)
if ( F_99 ( V_8 ) && F_100 ( V_8 ) )
F_70 ( V_8 -> V_148 ,
& V_172 ) ;
F_101 ( & V_182 ) ;
F_73 ( V_61 , & V_172 , NULL ) ;
F_90 ( ! F_32 ( & V_172 ) ) ;
}
