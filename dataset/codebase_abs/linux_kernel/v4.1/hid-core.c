...
static T_6
F_73 ( struct V_3 * V_116 , struct V_219 * V_217 ,
char * V_152 )
{
struct V_2 * V_206 = F_26 ( V_116 , struct V_2 , V_116 ) ;
return sprintf ( V_152 , L_36 , V_206 -> V_220 & 0xff ) ;
}
int F_74 ( struct V_2 * V_206 , unsigned int V_221 )
{
static const char * V_222 [] = { L_37 , L_38 , L_39 , L_37 ,
L_40 , L_41 , L_42 , L_43 ,
L_44
} ;
...
V_221 |= V_228 ;
if ( V_206 -> V_208 != V_229 )
V_221 &= ~ V_226 ;
if ( F_71 ( V_206 ) )
V_221 |= V_225 ;
if ( ( V_221 & V_230 ) && ! F_75 ( V_206 ,
V_221 & V_228 ) )
V_206 -> V_179 |= V_180 ;
if ( ( V_221 & V_226 ) && V_206 -> V_231 &&
! V_206 -> V_231 ( V_206 ,
V_221 & V_225 ) )
V_206 -> V_179 |= V_181 ;
if ( ( V_221 & V_232 ) && ! F_76 ( V_206 ) )
V_206 -> V_179 |= V_200 ;
if ( V_221 & V_233 )
V_206 -> V_179 |= V_234 ;
...
( V_221 & V_235 ) && V_206 -> V_236 )
V_206 -> V_236 ( V_206 ) ;
V_189 = 0 ;
if ( V_206 -> V_179 & V_180 )
V_189 += sprintf ( V_152 + V_189 , L_46 ) ;
if ( V_206 -> V_179 & V_181 )
V_189 += sprintf ( V_152 + V_189 , L_47 , V_189 ? L_48 : L_49 ,
V_206 -> V_237 ) ;
if ( V_206 -> V_179 & V_200 )
V_189 += sprintf ( V_152 + V_189 , L_50 , V_189 ? L_48 : L_49 ,
( (struct V_238 * ) V_206 -> V_238 ) -> V_237 ) ;
type = L_37 ;
for ( V_48 = 0 ; V_48 < V_206 -> V_34 ; V_48 ++ ) {
struct V_28 * V_239 = & V_206 -> V_29 [ V_48 ] ;
if ( V_239 -> type == V_39 &&
( V_239 -> V_23 & V_240 ) == V_141 &&
( V_239 -> V_23 & 0xffff ) < F_77 ( V_222 ) ) {
type = V_222 [ V_239 -> V_23 & 0xffff ] ;
break;
}
}
switch ( V_206 -> V_208 ) {
...
V_102 = F_78 ( & V_206 -> V_116 , & V_242 ) ;
if ( V_102 )
F_42 ( V_206 ,
L_54 , V_102 ) ;
V_102 = F_79 ( & V_206 -> V_116 , & V_243 ) ;
if ( V_102 )
F_42 ( V_206 ,
L_55 , V_102 ) ;
F_80 ( V_206 , L_56 ,
V_152 , V_208 , V_206 -> V_244 >> 8 , V_206 -> V_244 & 0xff ,
type , V_206 -> V_178 , V_206 -> V_245 ) ;
return 0 ;
}
void F_81 ( struct V_2 * V_206 )
{
F_82 ( & V_206 -> V_116 , & V_242 ) ;
F_83 ( & V_206 -> V_116 , & V_243 ) ;
if ( V_206 -> V_179 & V_180 )
F_84 ( V_206 ) ;
if ( V_206 -> V_179 & V_181 )
V_206 -> V_246 ( V_206 ) ;
...
static T_6 F_86 ( struct V_247 * V_248 , const char * V_152 ,
T_8 V_183 )
{
struct V_174 * V_175 = F_26 ( V_248 , struct V_174 , V_163 ) ;
struct V_249 * V_250 ;
V_53 V_208 , V_135 , V_137 ;
unsigned long V_251 = 0 ;
int V_102 ;
V_102 = sscanf ( V_152 , L_57 ,
& V_208 , & V_135 , & V_137 , & V_251 ) ;
if ( V_102 < 3 )
return - V_33 ;
V_250 = F_2 ( sizeof( * V_250 ) , V_10 ) ;
if ( ! V_250 )
return - V_36 ;
V_250 -> V_4 . V_208 = V_208 ;
V_250 -> V_4 . V_129 = V_210 ;
V_250 -> V_4 . V_135 = V_135 ;
V_250 -> V_4 . V_137 = V_137 ;
V_250 -> V_4 . V_251 = V_251 ;
F_87 ( & V_175 -> V_252 ) ;
F_3 ( & V_250 -> V_13 , & V_175 -> V_253 ) ;
F_88 ( & V_175 -> V_252 ) ;
V_102 = F_89 ( & V_175 -> V_163 ) ;
return V_102 ? : V_183 ;
}
static void F_90 ( struct V_174 * V_175 )
{
struct V_249 * V_250 , * V_41 ;
F_87 ( & V_175 -> V_252 ) ;
...
static const struct V_207 * F_93 ( struct V_2 * V_206 ,
struct V_174 * V_175 )
{
struct V_249 * V_250 ;
F_87 ( & V_175 -> V_252 ) ;
F_94 (dynid, &hdrv->dyn_list, list) {
if ( F_69 ( V_206 , & V_250 -> V_4 ) ) {
F_88 ( & V_175 -> V_252 ) ;
return & V_250 -> V_4 ;
}
}
F_88 ( & V_175 -> V_252 ) ;
return F_70 ( V_206 , V_175 -> V_254 ) ;
}
static int F_95 ( struct V_3 * V_116 , struct V_247 * V_248 )
{
struct V_174 * V_175 = F_26 ( V_248 , struct V_174 , V_163 ) ;
struct V_2 * V_206 = F_26 ( V_116 , struct V_2 , V_116 ) ;
return F_93 ( V_206 , V_175 ) != NULL ;
}
...
V_206 -> V_163 = V_175 ;
if ( V_175 -> V_259 ) {
V_102 = V_175 -> V_259 ( V_206 , V_4 ) ;
} else {
V_102 = F_38 ( V_206 ) ;
if ( ! V_102 )
V_102 = F_98 ( V_206 , V_260 ) ;
}
if ( V_102 ) {
F_23 ( V_206 ) ;
V_206 -> V_163 = NULL ;
...
static T_6 F_101 ( struct V_3 * V_116 , struct V_219 * V_155 ,
char * V_152 )
{
struct V_2 * V_206 = F_26 ( V_116 , struct V_2 , V_116 ) ;
int V_189 ;
V_189 = snprintf ( V_152 , V_261 , L_58 ,
V_206 -> V_208 , V_206 -> V_129 , V_206 -> V_135 , V_206 -> V_137 ) ;
return ( V_189 >= V_261 ) ? ( V_261 - 1 ) : V_189 ;
}
static int F_102 ( struct V_3 * V_116 , struct V_262 * V_263 )
{
struct V_2 * V_206 = F_26 ( V_116 , struct V_2 , V_116 ) ;
if ( F_103 ( V_263 , L_59 ,
V_206 -> V_208 , V_206 -> V_135 , V_206 -> V_137 ) )
return - V_36 ;
if ( F_103 ( V_263 , L_60 , V_206 -> V_178 ) )
return - V_36 ;
if ( F_103 ( V_263 , L_61 , V_206 -> V_245 ) )
return - V_36 ;
if ( F_103 ( V_263 , L_62 , V_206 -> V_264 ) )
return - V_36 ;
if ( F_103 ( V_263 , L_63 ,
V_206 -> V_208 , V_206 -> V_129 , V_206 -> V_135 , V_206 -> V_137 ) )
return - V_36 ;
...
bool F_104 ( struct V_2 * V_206 )
{
if ( V_206 -> V_223 & V_265 )
return false ;
if ( V_206 -> V_223 & V_266 )
return true ;
switch ( V_206 -> V_135 ) {
case V_267 :
if ( V_206 -> V_137 >= V_268 &&
V_206 -> V_137 <= V_269 )
return true ;
break;
case V_270 :
...
! strcmp ( V_206 -> V_178 , L_64 ) )
return true ;
break;
case V_274 :
if ( V_206 -> V_137 >= V_275 &&
V_206 -> V_137 <= V_276 )
return true ;
break;
case V_277 :
if ( V_206 -> V_137 >= V_278 &&
V_206 -> V_137 <= V_279 )
return true ;
break;
case V_280 :
if ( V_206 -> V_137 == V_281 &&
V_206 -> type == V_282 )
return true ;
break;
case V_283 :
if ( ( V_206 -> V_137 >= V_284 &&
V_206 -> V_137 <= V_285 ) ||
( V_206 -> V_137 >= V_286 &&
V_206 -> V_137 <= V_287 ) )
return true ;
break;
case V_288 :
if ( V_206 -> V_137 == V_289 &&
V_206 -> V_208 == V_229 &&
strncmp ( V_206 -> V_178 , L_65 , 22 ) == 0 )
return true ;
break;
}
if ( V_206 -> type == V_290 &&
F_70 ( V_206 , V_291 ) )
return true ;
return ! ! F_70 ( V_206 , V_292 ) ;
}
int F_105 ( struct V_2 * V_206 )
{
static T_9 V_4 = F_106 ( 0 ) ;
int V_102 ;
if ( F_45 ( V_206 -> V_114 & V_293 ) )
return - V_203 ;
if ( F_104 ( V_206 ) )
return - V_201 ;
...
V_102 = F_34 ( V_206 ) ;
if ( V_102 )
F_42 ( V_206 , L_67 , V_102 ) ;
}
F_107 ( & V_206 -> V_116 , L_68 , V_206 -> V_208 ,
V_206 -> V_135 , V_206 -> V_137 , F_108 ( & V_4 ) ) ;
F_109 ( V_206 , F_110 ( & V_206 -> V_116 ) ) ;
V_102 = F_111 ( & V_206 -> V_116 ) ;
if ( ! V_102 )
V_206 -> V_114 |= V_293 ;
else
F_112 ( V_206 ) ;
...
return F_114 ( V_102 ) ;
F_115 ( & V_206 -> V_116 ) ;
V_206 -> V_116 . V_297 = F_25 ;
V_206 -> V_116 . V_208 = & V_298 ;
F_23 ( V_206 ) ;
F_116 ( & V_206 -> V_299 ) ;
F_24 ( & V_206 -> V_176 ) ;
F_117 ( & V_206 -> V_300 ) ;
...
static void F_119 ( struct V_2 * V_206 )
{
if ( V_206 -> V_114 & V_293 ) {
F_120 ( & V_206 -> V_116 ) ;
F_112 ( V_206 ) ;
V_206 -> V_114 &= ~ V_293 ;
}
...
void F_121 ( struct V_2 * V_206 )
{
F_119 ( V_206 ) ;
F_122 ( & V_206 -> V_116 ) ;
}
int F_123 ( struct V_174 * V_175 , struct V_301 * V_302 ,
const char * V_303 )
{
int V_102 ;
V_175 -> V_163 . V_178 = V_175 -> V_178 ;
V_175 -> V_163 . V_208 = & V_298 ;
V_175 -> V_163 . V_302 = V_302 ;
V_175 -> V_163 . V_303 = V_303 ;
F_24 ( & V_175 -> V_253 ) ;
F_117 ( & V_175 -> V_252 ) ;
V_102 = F_124 ( & V_175 -> V_163 ) ;
if ( V_102 )
return V_102 ;
V_102 = F_125 ( & V_175 -> V_163 , & V_304 ) ;
if ( V_102 )
F_126 ( & V_175 -> V_163 ) ;
return V_102 ;
}
void F_127 ( struct V_174 * V_175 )
{
F_128 ( & V_175 -> V_163 , & V_304 ) ;
F_126 ( & V_175 -> V_163 ) ;
F_90 ( V_175 ) ;
}
...
for ( V_48 = 0 ; V_48 < F_130 ( V_307 ) ; V_48 ++ )
if ( V_306 -> V_308 -> V_309 [ V_48 ] )
return 1 ;
}
return 0 ;
}
