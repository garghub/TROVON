...
static int F_11 ( struct V_23 * V_2 ,
const struct V_24 * V_25 ,
const struct V_24 * V_26 , T_1 V_27 )
{
struct V_1 * V_28 ;
if ( ! ( V_25 -> V_27 & V_29 ) )
return 0 ;
V_28 = F_12 ( V_25 -> V_2 , struct V_1 , V_6 . V_2 ) ;
if ( ! V_28 -> V_30 )
return 0 ;
if ( V_27 & V_31 ) {
if ( V_28 -> V_32 )
...
V_2 -> V_37 = V_37 ;
V_2 -> V_41 = V_19 - 1 ;
V_2 -> V_15 = F_16 ( V_37 -> V_42 ,
V_19 * sizeof( * V_2 -> V_15 ) ,
V_43 ) ;
if ( V_2 -> V_15 == NULL )
return - V_44 ;
V_2 -> V_45 = F_16 ( V_37 -> V_42 , V_19 * sizeof( * V_2 -> V_45 ) ,
V_43 ) ;
if ( V_2 -> V_45 == NULL )
return - V_44 ;
for ( V_38 = 0 ; V_38 < V_19 - 1 ; ++ V_38 )
V_2 -> V_45 [ V_38 ] . V_27 = V_46 ;
V_2 -> V_45 [ V_19 - 1 ] . V_27 = V_29 ;
