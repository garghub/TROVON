...
V_64 = ( T_2 * ) ( ( long ) V_43 + V_56 -> V_77 ) ;
V_65 = ( T_3 * ) ( ( long ) V_43 + V_56 -> V_77 ) ;
V_66 = ( T_3 * ) ( ( long ) V_43 + V_56 -> V_78 ) ;
V_70 = V_56 -> V_70 ;
V_71 = V_56 -> V_71 ;
V_60 = false ;
while ( ( V_45 == V_46 ) && ( V_47 != V_79 ) ) {
switch ( V_47 ) {
case V_76 :
V_17 = F_8 ( V_2 , V_80 ) ;
if ( V_17 == V_80 )
...
break;
case V_94 :
V_64 = ( T_2 * ) ( ( long ) V_43 + V_56 -> V_95 ) ;
V_65 = ( T_3 * ) ( ( long ) V_43 + V_56 -> V_95 ) ;
V_47 = V_96 ;
break;
case V_88 :
if ( ! V_60 ) {
...
if ( V_40 -> V_111 == F_18 ( V_40 ) ) {
if ( V_40 -> V_112 != 0x80 ) {
V_47 = V_115 ;
break;
}
V_48 = F_22 ( V_40 -> V_116 ) ;
V_54 =
