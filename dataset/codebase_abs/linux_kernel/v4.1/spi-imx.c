...
V_128 -> V_187 , V_128 -> V_188 , V_159 ,
V_189 | V_190 ) ;
if ( ! V_180 )
goto V_191;
V_180 -> V_192 = F_62 ;
V_180 -> V_193 = ( void * ) V_19 ;
F_65 ( V_180 ) ;
}
if ( V_133 ) {
V_181 = F_64 ( V_14 -> V_147 ,
V_133 -> V_187 , V_133 -> V_188 , V_166 ,
V_189 | V_190 ) ;
if ( ! V_181 )
goto V_191;
V_181 -> V_192 = F_61 ;
V_181 -> V_193 = ( void * ) V_19 ;
F_65 ( V_181 ) ;
}
F_66 ( & V_19 -> V_170 ) ;
F_66 ( & V_19 -> V_171 ) ;
...
static int
F_80 ( struct V_13 * V_14 , struct V_200 * V_201 )
{
struct V_1 * V_19 = F_7 ( V_14 ) ;
int V_155 ;
V_155 = F_81 ( V_19 -> V_202 ) ;
if ( V_155 )
return V_155 ;
V_155 = F_81 ( V_19 -> V_203 ) ;
if ( V_155 ) {
F_82 ( V_19 -> V_202 ) ;
return V_155 ;
}
...
static int F_84 ( struct V_204 * V_205 )
{
struct V_206 * V_207 = V_205 -> V_150 . V_208 ;
const struct V_209 * V_210 =
F_85 ( V_211 , & V_205 -> V_150 ) ;
struct V_212 * V_213 =
F_86 ( & V_205 -> V_150 ) ;
struct V_13 * V_14 ;
struct V_1 * V_19 ;
struct V_151 * V_152 ;
int V_11 , V_155 , V_214 , V_130 ;
if ( ! V_207 && ! V_213 ) {
F_57 ( & V_205 -> V_150 , L_14 ) ;
return - V_156 ;
}
V_155 = F_87 ( V_207 , L_15 , & V_214 ) ;
if ( V_155 < 0 ) {
if ( V_213 )
V_214 = V_213 -> V_215 ;
else
...
V_14 = F_88 ( & V_205 -> V_150 ,
sizeof( struct V_1 ) + sizeof( int ) * V_214 ) ;
if ( ! V_14 )
return - V_216 ;
F_89 ( V_205 , V_14 ) ;
V_14 -> V_217 = F_90 ( 1 , 32 ) ;
V_14 -> V_218 = V_205 -> V_219 ;
V_14 -> V_215 = V_214 ;
V_19 = F_7 ( V_14 ) ;
V_19 -> V_146 . V_14 = V_14 ;
for ( V_11 = 0 ; V_11 < V_14 -> V_215 ; V_11 ++ ) {
int V_220 = F_91 ( V_207 , L_16 , V_11 ) ;
if ( ! F_46 ( V_220 ) && V_213 )
V_220 = V_213 -> V_87 [ V_11 ] ;
V_19 -> V_87 [ V_11 ] = V_220 ;
if ( ! F_46 ( V_220 ) )
continue;
V_155 = F_92 ( & V_205 -> V_150 , V_19 -> V_87 [ V_11 ] ,
V_221 ) ;
if ( V_155 ) {
F_57 ( & V_205 -> V_150 , L_17 ) ;
goto V_222;
}
}
V_19 -> V_146 . V_87 = F_45 ;
V_19 -> V_146 . V_223 = F_51 ;
V_19 -> V_146 . V_224 = F_76 ;
V_19 -> V_146 . V_14 -> V_225 = F_77 ;
V_19 -> V_146 . V_14 -> V_226 = F_79 ;
V_19 -> V_146 . V_14 -> V_227 = F_80 ;
V_19 -> V_146 . V_14 -> V_228 = F_83 ;
V_19 -> V_146 . V_14 -> V_229 = V_63 | V_62 | V_64 ;
F_60 ( & V_19 -> V_136 ) ;
V_19 -> V_3 = V_210 ? V_210 -> V_230 :
(struct V_231 * ) V_205 -> V_232 -> V_233 ;
V_152 = F_93 ( V_205 , V_234 , 0 ) ;
V_19 -> V_36 = F_94 ( & V_205 -> V_150 , V_152 ) ;
if ( F_95 ( V_19 -> V_36 ) ) {
...
V_155 = F_98 ( & V_205 -> V_150 , V_130 , F_49 , 0 ,
F_71 ( & V_205 -> V_150 ) , V_19 ) ;
if ( V_155 ) {
F_57 ( & V_205 -> V_150 , L_18 , V_130 , V_155 ) ;
goto V_222;
}
V_19 -> V_203 = F_99 ( & V_205 -> V_150 , L_19 ) ;
if ( F_95 ( V_19 -> V_203 ) ) {
V_155 = F_96 ( V_19 -> V_203 ) ;
goto V_222;
}
V_19 -> V_202 = F_99 ( & V_205 -> V_150 , L_20 ) ;
if ( F_95 ( V_19 -> V_202 ) ) {
V_155 = F_96 ( V_19 -> V_202 ) ;
goto V_222;
}
V_155 = F_100 ( V_19 -> V_202 ) ;
if ( V_155 )
goto V_222;
V_155 = F_100 ( V_19 -> V_203 ) ;
if ( V_155 )
goto V_235;
V_19 -> V_57 = F_101 ( V_19 -> V_202 ) ;
if ( V_19 -> V_3 == & V_236
&& F_54 ( & V_205 -> V_150 , V_19 , V_14 , V_152 ) )
F_57 ( & V_205 -> V_150 , L_21 ) ;
V_19 -> V_3 -> V_195 ( V_19 ) ;
V_19 -> V_3 -> V_135 ( V_19 , 0 ) ;
V_14 -> V_150 . V_208 = V_205 -> V_150 . V_208 ;
V_155 = F_102 ( & V_19 -> V_146 ) ;
if ( V_155 ) {
F_57 ( & V_205 -> V_150 , L_22 , V_155 ) ;
goto V_237;
}
F_103 ( & V_205 -> V_150 , L_23 ) ;
F_82 ( V_19 -> V_203 ) ;
F_82 ( V_19 -> V_202 ) ;
return V_155 ;
V_237:
