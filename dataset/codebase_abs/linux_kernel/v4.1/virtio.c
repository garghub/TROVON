...
int F_33 ( struct V_28 * V_30 )
{
F_28 ( V_30 -> V_31 && ! V_30 -> V_32 ) ;
V_30 -> V_30 . V_59 = & V_60 ;
return F_34 ( & V_30 -> V_30 ) ;
}
void F_35 ( struct V_28 * V_30 )
{
F_36 ( & V_30 -> V_30 ) ;
}
...
int V_45 ;
V_7 -> V_7 . V_59 = & V_60 ;
V_45 = F_38 ( & V_61 , 0 , 0 , V_62 ) ;
if ( V_45 < 0 )
goto V_63;
V_7 -> V_64 = V_45 ;
F_39 ( & V_7 -> V_7 , L_8 , V_7 -> V_64 ) ;
F_40 ( & V_7 -> V_39 ) ;
V_7 -> V_35 = false ;
V_7 -> V_36 = false ;
V_7 -> V_10 -> V_65 ( V_7 ) ;
...
struct V_28 * V_29 = F_10 ( V_7 -> V_7 . V_30 ) ;
F_20 ( V_7 ) ;
V_7 -> V_67 = V_7 -> V_10 -> V_11 ( V_7 ) & V_57 ;
if ( V_29 && V_29 -> V_68 )
return V_29 -> V_68 ( V_7 ) ;
return 0 ;
}
