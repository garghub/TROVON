...
for ( V_22 = 0 ; V_22 < V_52 -> V_54 ; V_22 ++ )
if ( V_52 -> V_58 [ V_22 ] )
V_53 ++ ;
...
struct V_19 * F_38 ( struct V_64 * V_52 )
{
struct V_51 * div ;
struct V_59 * V_65 ;
T_2 V_16 ;
...
V_2 = F_35 ( div , & V_39 ) ;
if ( F_33 ( V_2 ) )
return (struct V_19 * ) V_2 ;
V_19 = F_27 ( NULL , V_52 -> V_37 , div -> V_69 ,
...
V_73 /= 4 ;
V_53 = 0 ;
for ( V_22 = 0 ; V_22 < V_73 ; V_22 ++ ) {
F_41 ( V_71 , L_4 , V_22 , & V_10 ) ;
if ( V_10 )
V_53 ++ ;
}
if ( ! V_53 ) {
...
& V_40 , & V_39 , & V_17 ) )
goto V_75;
V_19 = F_27 ( NULL , V_71 -> V_37 , V_38 , V_7 , V_16 ,
V_17 , V_39 , V_40 , V_2 ,
NULL ) ;
if ( ! F_33 ( V_19 ) ) {
F_50 ( V_71 , V_76 , V_19 ) ;
