...
V_254 = V_251 ;
F_43 ( L_73 , V_251 ) ;
V_122 = F_52 ( & V_37 -> V_90 , V_42 , & V_254 ,
sizeof( V_254 ) , V_253 , sizeof( * V_253 ) ) ;
if ( V_122 < 0 ) {
F_24 ( V_37 -> V_51 , L_74 , V_251 ) ;
return V_122 ;
}
for ( V_255 = 0 ; V_255 < V_253 -> V_256 ; V_255 ++ ) {
F_13 ( V_37 -> V_51 ,
L_75 ,
V_255 , V_253 -> V_257 [ V_255 ] . V_45 ,
V_253 -> V_257 [ V_255 ] . V_223 ,
...
struct V_211 * V_212 ;
int V_260 ;
V_215 = F_101 ( V_52 , V_259 ) ;
if ( V_215 == NULL ) {
F_24 ( V_52 -> V_51 , L_77 ,
V_259 ) ;
return NULL ;
}
V_212 = F_102 ( V_215 , V_259 , NULL ) ;
if ( V_212 == NULL ) {
F_24 ( V_52 -> V_51 , L_78 ,
V_259 ) ;
return NULL ;
}
V_260 = F_103 ( V_212 , V_45 ) ;
if ( V_260 < 0 ) {
F_24 ( V_52 -> V_51 , L_79 ,
V_259 ) ;
F_104 ( V_212 ) ;
...
{
struct V_127 * V_128 = V_37 -> V_52 ;
T_1 V_255 , V_45 , V_223 ;
int V_122 = 0 ;
F_43 ( L_81 , V_261 ) ;
if ( V_37 -> V_253 . V_256 > V_261 ) {
F_24 ( V_37 -> V_51 ,
L_82 ,
V_261 ) ;
memset ( & V_37 -> V_253 , 0 , sizeof( V_37 -> V_253 ) ) ;
return - V_105 ;
}
V_122 = F_108 ( V_128 , 0 ) ;
if ( V_122 < 0 ) {
...
V_263 | V_264 ,
V_263 | V_264 ) ;
for ( V_255 = 0 ; V_255 < V_37 -> V_253 . V_256 ; V_255 ++ ) {
if ( V_37 -> V_253 . V_257 [ V_255 ] . V_258 == V_265
&& V_37 -> V_253 . V_257 [ V_255 ] . V_45 > V_266
&& V_37 -> V_253 . V_257 [ V_255 ] . V_45 <
V_266 + V_267 ) {
V_45 = V_37 -> V_253 . V_257 [ V_255 ] . V_45
- V_266 ;
V_223 = ( V_37 -> V_253 . V_257 [ V_255 ] . V_223 + 3 ) & ( ~ 3 ) ;
V_122 = F_109 ( V_128 , V_37 -> V_268 + V_45 ,
V_128 -> V_269 . V_270 + V_45 , V_223 ) ;
if ( V_122 < 0 ) {
F_24 ( V_37 -> V_51 ,
L_84 ) ;
memset ( & V_37 -> V_253 , 0 , sizeof( V_37 -> V_253 ) ) ;
...
- V_266 ;
V_223 = ( V_37 -> V_253 . V_257 [ V_255 ] . V_223 + 3 ) & ( ~ 3 ) ;
V_122 = F_112 ( V_128 , V_128 -> V_269 . V_270 + V_45 ,
V_37 -> V_268 + V_45 , V_223 ) ;
if ( V_122 < 0 ) {
F_24 ( V_37 -> V_51 ,
L_85 ) ;
return V_122 ;
...
int V_122 ;
F_13 ( V_37 -> V_51 , L_91 ) ;
V_122 = F_99 ( V_37 , V_274 , & V_37 -> V_253 ) ;
if ( V_122 < 0 )
return V_122 ;
F_121 ( V_37 -> V_52 ) ;
V_122 = F_107 ( V_37 ) ;
...
struct V_214 * V_215 ;
enum V_280 V_176 ;
for ( V_176 = V_281 ; V_176 < V_282 ; V_176 ++ ) {
...
if ( V_215 == NULL || V_215 -> V_251 == V_286 )
return false ;
else
return true ;
}
...
struct V_214 * V_215 ;
V_215 = F_101 ( V_37 -> V_52 , V_114 ) ;
if ( V_215 != NULL && V_215 -> V_251 == V_285 )
return true ;
else
return false ;
}
...
int F_139 ( struct V_36 * V_37 , T_2 * V_291 )
{
T_2 V_176 = 0 ;
while ( V_37 -> V_289 < V_292 ) {
V_176 = V_37 -> V_290 [ V_37 -> V_289 ] [ 0 ] ;
V_37 -> V_289 ++ ;
if ( V_291 [ 0 ] == V_176 ) {
...
F_13 ( V_51 , L_118 ,
V_309 ) ;
V_312 = F_60 ( V_309 , V_178 ) ;
if ( V_312 == NULL )
return - V_101 ;
memcpy ( V_312 -> V_177 , V_307 , V_306 ) ;
} else {
F_64 ( V_51 , L_119 ) ;
return 0 ;
}
...
F_67 ( V_312 ) ;
if ( V_177 )
F_152 ( V_37 -> V_52 -> V_317 ,
V_306 , ( void * ) V_177 , V_310 ) ;
return V_122 ;
}
static void F_153 ( struct V_146 * V_90 , struct V_81 * V_1 )
{
F_154 ( V_90 -> V_52 , V_1 -> V_318 , V_1 -> V_319 ) ;
F_155 ( V_90 -> V_52 , V_1 -> V_42 ) ;
}
static void F_156 ( struct V_146 * V_90 , const char * V_320 )
{
...
static void F_157 ( struct V_81 * V_1 , char * V_318 ,
T_7 V_319 )
{
memcpy ( V_1 -> V_318 , V_318 , V_319 ) ;
}
static T_5 F_158 ( T_5 V_42 , T_5 * V_324 )
{
V_42 &= ~ ( V_82 | V_4 ) ;
* V_324 = ( T_5 ) - 1 ;
return V_42 ;
}
int F_159 ( struct V_275 * V_51 , struct V_325 * V_75 )
{
struct V_157 V_158 ;
struct V_36 * V_37 ;
struct V_146 * V_90 ;
int V_122 ;
F_13 ( V_51 , L_122 ) ;
V_37 = F_160 ( V_51 , sizeof( * V_37 ) , V_178 ) ;
if ( V_37 == NULL )
return - V_101 ;
V_90 = & V_37 -> V_90 ;
V_90 -> V_51 = V_51 ;
V_90 -> V_326 . V_327 = F_153 ;
V_90 -> V_326 . V_328 = F_156 ;
V_90 -> V_326 . V_329 = F_157 ;
V_90 -> V_326 . V_330 = F_158 ;
V_122 = F_161 ( V_90 ) ;
if ( V_122 != 0 )
goto V_331;
F_162 ( & V_37 -> V_181 ) ;
F_163 ( & V_37 -> V_58 ) ;
V_332 . V_333 = V_37 ;
V_37 -> V_52 = F_164 ( V_51 , & V_332 , V_75 ) ;
if ( V_37 -> V_52 == NULL ) {
V_122 = - V_273 ;
goto V_334;
}
V_90 -> V_52 = V_37 -> V_52 ;
V_37 -> V_335 = F_165 ( V_37 -> V_52 -> V_317 ,
V_267 , & V_37 -> V_268 , V_178 ) ;
if ( V_37 -> V_335 == NULL ) {
V_122 = - V_101 ;
goto V_336;
}
F_166 ( V_37 -> V_52 ) ;
V_122 = F_142 ( V_37 , V_281 , 0 , L_123 ) ;
if ( V_122 < 0 )
goto V_337;
F_142 ( V_37 , V_283 , 0 , L_124 ) ;
V_122 = F_117 ( V_37 -> V_52 ) ;
if ( V_122 < 0 )
goto V_338;
F_137 ( V_37 ) ;
...
F_167 ( V_37 -> V_52 ) ;
V_337:
F_152 ( V_37 -> V_52 -> V_317 , V_267 ,
V_37 -> V_335 , V_37 -> V_268 ) ;
V_336:
F_168 ( V_37 -> V_52 ) ;
V_334:
F_169 ( V_90 ) ;
...
void F_170 ( struct V_275 * V_51 , struct V_325 * V_75 )
{
