...
V_56 -> V_59 = V_52 ;
V_56 -> V_57 . V_60 = F_30 ;
F_14 ( & V_56 -> V_2 -> V_35 , V_34 ) ;
V_15 = F_32 ( & V_56 -> V_2 -> V_38 ,
& V_56 -> V_57 ) ;
F_15 ( & V_56 -> V_2 -> V_35 , V_34 ) ;
return V_15 ;
} else {
struct V_63 V_64 ;
struct V_1 * V_65 ;
...
return - V_20 ;
F_14 ( & V_56 -> V_2 -> V_35 , V_34 ) ;
V_15 = F_37 ( & V_56 -> V_2 -> V_38 , & V_56 -> V_57 ) ;
F_15 ( & V_56 -> V_2 -> V_35 , V_34 ) ;
return V_15 ;
}
...
struct V_1 * F_49 ( const char * * V_19 )
{
struct V_1 * V_2 ;
V_2 = F_50 ( sizeof( * V_2 ) , V_73 ) ;
if ( ! V_2 )
return F_51 ( - V_72 ) ;
V_2 -> V_16 = 0 ;
V_2 -> V_19 = V_19 ;
...
static int F_54 ( struct V_8 * V_9 , void * V_74 , void * V_75 )
{
struct V_1 * * V_76 = V_74 ;
if ( F_55 ( ! V_76 || ! * V_76 ) )
return 0 ;
return * V_76 == V_75 ;
}
static void F_56 ( struct V_8 * V_9 , void * V_74 )
{
F_52 ( * (struct V_1 * * ) V_74 ) ;
}
struct V_1 * F_57 ( struct V_8 * V_9 ,
const char * * V_19 )
{
struct V_1 * * V_54 , * V_2 ;
V_54 = F_58 ( F_56 , sizeof( * V_54 ) , V_73 ) ;
if ( ! V_54 )
return F_51 ( - V_72 ) ;
V_2 = F_49 ( V_19 ) ;
if ( F_42 ( V_2 ) ) {
...
void F_61 ( struct V_8 * V_9 , struct V_1 * V_2 )
{
F_55 ( F_62 ( V_9 , F_56 ,
F_54 , V_2 ) ) ;
}
...
V_2 -> V_9 . V_78 = V_66 ;
V_2 -> V_9 . V_79 = F_47 ;
V_2 -> V_49 = V_2 -> V_49 ? V_2 -> V_49 : F_8 ( V_2 -> V_9 . V_77 ) ;
if ( F_64 ( V_2 -> V_49 ) ) {
F_20 ( & V_2 -> V_9 ,
L_13 ) ;
return - V_20 ;
}
F_65 ( & V_2 -> V_9 , L_14 , V_2 -> V_49 ) ;
if ( V_2 -> V_16 ) {
char V_12 [ 10 ] ;
char * V_80 ;
struct V_22 * V_23 ;
V_2 -> V_81 = F_50 ( sizeof( struct V_22 ) *
V_2 -> V_16 , V_73 ) ;
if ( ! V_2 -> V_81 ) {
V_15 = - V_72 ;
goto V_82;
...
V_80 = F_50 ( sizeof( char ) * ( strlen ( V_12 ) + 1 ) ,
V_73 ) ;
if ( ! V_80 ) {
...
V_23 -> V_2 = V_2 ;
V_23 -> V_25 = V_44 ;
V_23 -> V_85 [ 0 ] = & V_23 -> V_24 . V_11 ;
V_23 -> V_85 [ 1 ] = & V_23 -> V_26 . V_11 ;
V_23 -> V_85 [ 2 ] = NULL ;
V_23 -> V_83 . V_49 = V_80 ;
V_23 -> V_83 . V_85 = V_23 -> V_85 ;
F_66 ( & V_23 -> V_24 . V_11 ) ;
V_23 -> V_24 . V_11 . V_49 = L_16 ;
V_23 -> V_24 . V_11 . V_86 = 0444 ;
V_23 -> V_24 . V_87 = F_9 ;
F_66 ( & V_23 -> V_26 . V_11 ) ;
V_23 -> V_26 . V_11 . V_49 = L_17 ;
V_23 -> V_26 . V_11 . V_86 = 0444 ;
V_23 -> V_26 . V_87 = F_11 ;
}
}
if ( V_2 -> V_16 && V_2 -> V_5 ) {
...
;
V_2 -> V_88 = F_50 ( sizeof( struct V_89 * ) *
( V_44 + 1 ) , V_73 ) ;
if ( ! V_2 -> V_88 ) {
V_15 = - V_72 ;
goto V_90;
}
V_2 -> V_91 = F_50 ( sizeof( struct V_10 ) *
V_44 , V_73 ) ;
if ( ! V_2 -> V_91 ) {
V_15 = - V_72 ;
F_53 ( V_2 -> V_88 ) ;
...
V_49 = F_50 ( sizeof( char ) * ( strlen ( V_12 ) + 1 ) ,
V_73 ) ;
if ( ! V_49 ) {
for ( V_44 -- ; V_44 >= 0 ; V_44 -- ) {
F_53 ( V_2 -> V_91 [ V_44 ] . V_11 .
V_49 ) ;
}
F_53 ( V_2 -> V_91 ) ;
F_53 ( V_2 -> V_88 ) ;
...
strcpy ( V_49 , V_12 ) ;
F_66 ( & V_2 -> V_91 [ V_44 ] . V_11 ) ;
V_2 -> V_91 [ V_44 ] . V_11 . V_49 = V_49 ;
V_2 -> V_91 [ V_44 ] . V_11 . V_86 = 0000 ;
V_2 -> V_88 [ V_44 ] = & V_2 -> V_91 [ V_44 ]
. V_11 ;
}
V_2 -> V_92 . V_49 = V_93 ;
...
if ( V_2 -> V_16 ) {
V_2 -> V_94 . V_95 =
F_50 ( sizeof( struct V_96 * ) *
( V_2 -> V_16 + 2 ) , V_73 ) ;
if ( ! V_2 -> V_94 . V_95 ) {
V_15 = - V_72 ;
goto V_97;
}
V_2 -> V_94 . V_49 = F_8 ( & V_2 -> V_9 ) ;
V_2 -> V_94 . V_79 = F_48 ;
for ( V_44 = 0 ; V_44 < V_2 -> V_16 ; V_44 ++ )
V_2 -> V_94 . V_95 [ V_44 ] =
& V_2 -> V_81 [ V_44 ] . V_83 ;
...
if ( V_2 -> V_16 && V_2 -> V_5 ) {
for ( V_44 = 0 ; V_2 -> V_5 [ V_44 ] ; V_44 ++ )
F_53 ( V_2 -> V_91 [ V_44 ] . V_11 . V_49 ) ;
F_53 ( V_2 -> V_91 ) ;
F_53 ( V_2 -> V_88 ) ;
}
V_90:
for ( V_44 = 0 ; V_44 < V_2 -> V_16 ; V_44 ++ )
F_53 ( V_2 -> V_81 [ V_44 ] . V_83 . V_49 ) ;
V_84:
if ( V_2 -> V_16 )
F_53 ( V_2 -> V_81 ) ;
V_82:
...
#if F_44 ( V_70 )
if ( V_71 )
F_78 ( V_71 , & V_2 -> V_9 , NULL ) ;
#endif
F_68 ( & V_2 -> V_9 ) ;
}
static void F_79 ( struct V_8 * V_9 , void * V_74 )
{
F_74 ( * (struct V_1 * * ) V_74 ) ;
}
int F_80 ( struct V_8 * V_9 , struct V_1 * V_2 )
{
struct V_1 * * V_54 ;
int V_15 ;
V_54 = F_58 ( F_79 , sizeof( * V_54 ) , V_73 ) ;
if ( ! V_54 )
return - V_72 ;
V_15 = F_63 ( V_2 ) ;
if ( V_15 ) {
...
struct V_1 * F_82 ( struct V_8 * V_9 , int V_44 )
{
struct V_101 * V_102 ;
struct V_1 * V_2 ;
if ( ! V_9 -> V_103 ) {
...
F_27 ( & V_48 ) ;
F_28 (edev, &extcon_dev_list, entry) {
if ( V_2 -> V_9 . V_77 && V_2 -> V_9 . V_77 -> V_103 == V_102 ) {
F_29 ( & V_48 ) ;
return V_2 ;
}
}
