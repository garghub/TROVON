...
static char * F_24 ( const char * V_24 , T_2 V_13 )
{
char * V_25 = F_25 ( V_24 , V_13 , V_26 ) ;
char * V_27 ;
if ( ! V_25 )
return NULL ;
V_27 = strchr ( V_25 , '\n' ) ;
...
static struct V_38 * F_31 ( struct V_6 * V_7 , const char * V_40 )
{
int V_12 ;
for ( V_12 = 0 ; V_12 < V_7 -> V_37 . V_15 ; V_12 ++ ) {
struct V_38 * V_39 = F_8 ( & V_7 -> V_37 , V_12 ) ;
...
return - V_34 ;
F_7 ( & V_7 -> V_14 ) ;
V_22 = F_39 ( V_7 , & V_7 -> V_45 , V_18 , V_19 ) ;
F_9 ( & V_7 -> V_14 ) ;
return V_22 ;
}
...
const char * F_41 ( struct V_6 * V_7 , const char * V_40 )
{
struct V_38 * V_39 = F_31 ( V_7 , V_40 ) ;
return V_39 ? V_39 -> V_41 : NULL ;
}
int F_42 ( struct V_6 * V_7 , const char * V_40 )
{
const char * V_27 ;
int V_46 ;
F_7 ( & V_7 -> V_14 ) ;
...
int F_43 ( struct V_6 * V_7 , const char * V_40 , int * V_48 )
{
const char * V_27 ;
unsigned long V_41 ;
int V_46 ;
...
static inline int F_45 ( const char * V_49 , const char * V_50 )
{
...
static void F_50 ( char * V_5 , struct V_51 * V_52 ,
struct V_6 * * V_53 )
{
F_33 ( * V_53 , V_5 ) ;
}
...
{
F_35 ( ( * V_53 ) -> V_61 ) ;
( * V_53 ) -> V_61 = F_52 ( V_5 , V_26 ) ;
}
static void F_53 ( char * V_5 , struct V_51 * V_52 ,
struct V_6 * * V_53 )
{
F_35 ( ( * V_53 ) -> V_57 . V_62 ) ;
( * V_53 ) -> V_57 . V_62 = F_52 ( V_5 , V_26 ) ;
}
static int F_54 ( char * V_5 , struct V_51 * V_52 )
{
int V_12 ;
for ( V_12 = 0 ; V_12 < F_55 ( V_63 ) ; V_12 ++ ) {
if ( ! V_63 [ V_12 ] . V_64 )
continue;
if ( F_45 ( V_5 , V_63 [ V_12 ] . V_64 ) )
return V_12 ;
if ( V_63 [ V_12 ] . V_65 && F_45 ( V_5 , V_63 [ V_12 ] . V_65 ) )
return V_12 ;
}
return V_66 ;
}
static int F_56 ( char * V_5 , int V_67 , T_2 * V_68 ,
const void * * V_69 )
{
int V_13 ;
T_2 V_70 = * V_68 ;
const char * V_27 = * V_69 ;
while ( isspace ( * V_27 ) && V_70 ) {
V_27 ++ ;
V_70 -- ;
}
if ( ! V_70 )
...
int F_57 ( struct V_51 * V_52 , T_2 V_70 , const void * V_71 )
{
char V_5 [ 128 ] ;
struct V_6 * V_7 ;
int V_72 ;
V_72 = V_66 ;
V_7 = NULL ;
while ( F_56 ( V_5 , sizeof( V_5 ) - 1 , & V_70 , & V_71 ) ) {
if ( ! * V_5 || * V_5 == '#' || * V_5 == '\n' )
continue;
if ( * V_5 == '[' )
V_72 = F_54 ( V_5 , V_52 ) ;
else if ( V_63 [ V_72 ] . V_73 &&
( V_7 || V_72 <= V_74 ) )
V_63 [ V_72 ] . V_73 ( V_5 , V_52 , & V_7 ) ;
}
return 0 ;
}
...
F_59 ( & V_7 -> V_14 ) ;
#ifdef F_60
F_61 ( & V_7 -> V_28 , sizeof( struct V_29 ) , 32 ) ;
F_61 ( & V_7 -> V_37 , sizeof( struct V_38 ) , 32 ) ;
F_61 ( & V_7 -> V_45 , sizeof( struct V_16 ) , 16 ) ;
#endif
}
