...
char * V_94 ;
int error ;
V_94 = F_35 ( V_95 , L_39 , V_30 -> V_48 ) ;
if ( ! V_94 )
return - V_96 ;
F_33 ( & V_2 -> V_7 , L_40 , V_94 ) ;
error = F_36 ( & V_87 , V_94 , & V_2 -> V_7 ) ;
F_37 ( V_94 ) ;
if ( error ) {
F_3 ( & V_2 -> V_7 , L_41 ,
error ) ;
...
{
struct V_99 * V_100 = V_30 -> V_100 ;
unsigned int V_101 ;
T_3 V_102 ;
int V_103 ;
V_101 = V_25 [ V_104 + 1 ] & 0x0f ;
V_102 = ( ( V_25 [ V_104 + 1 ] & 0x30 ) << 4 ) |
V_25 [ V_104 ] ;
F_20 ( & V_30 -> V_2 -> V_7 ,
L_45 , V_101 , V_102 ) ;
for ( V_103 = 0 ; V_103 < V_105 && V_101 ; V_103 ++ ) {
if ( V_102 & 1 ) {
unsigned int V_106 , V_107 , V_108 , V_109 ;
T_2 * V_110 ;
V_110 = & V_25 [ V_111 + V_103 * 3 ] ;
V_106 = ( ( ( T_3 ) V_110 [ 0 ] & 0xf0 ) << 4 ) | V_110 [ 1 ] ;
V_107 = ( ( ( T_3 ) V_110 [ 0 ] & 0x0f ) << 8 ) | V_110 [ 2 ] ;
V_108 = V_25 [ V_112 + V_103 ] ;
V_109 = V_25 [ V_113 + V_103 ] ;
F_20 ( & V_30 -> V_2 -> V_7 , L_46 ,
V_103 , V_106 , V_107 , V_108 , V_109 ) ;
F_40 ( V_100 , V_103 ) ;
F_41 ( V_100 , V_114 , true ) ;
F_42 ( V_100 , V_115 , V_116 , V_106 ) ;
F_42 ( V_100 , V_115 , V_117 , V_107 ) ;
F_42 ( V_100 , V_115 , V_118 , V_108 ) ;
F_42 ( V_100 , V_115 , V_119 , V_109 ) ;
V_101 -- ;
}
V_102 >>= 1 ;
}
...
{
T_2 V_120 = F_45 ( V_25 ) ;
if ( F_47 ( V_25 [ V_121 ] != V_120 ) )
F_26 ( & V_30 -> V_2 -> V_7 ,
L_47 ,
V_8 , V_25 [ V_122 ] ,
V_120 , V_25 [ V_121 ] ) ;
else if ( F_47 ( V_25 [ V_122 ] != V_123 ) )
F_26 ( & V_30 -> V_2 -> V_7 ,
L_48 ,
V_8 , V_25 [ V_122 ] ) ;
else
...
static T_4 F_48 ( int V_35 , void * V_124 )
{
const T_2 V_125 [] = { 0x64 , 0x64 , 0x64 , 0x64 } ;
...
break;
case V_131 :
if ( memcmp ( V_30 -> V_25 , V_125 , sizeof( V_125 ) ) ) {
F_3 ( & V_2 -> V_7 ,
L_51 ,
V_46 , V_30 -> V_25 ) ;
} else {
...
static T_5 F_51 ( struct V_137 * V_7 ,
struct V_138 * V_139 ,
const char * V_25 , T_1 V_140 )
{
struct V_1 * V_2 = F_52 ( V_7 ) ;
struct V_29 * V_30 = F_53 ( V_2 ) ;
int error ;
error = F_54 ( & V_30 -> V_141 ) ;
if ( error )
return error ;
error = F_9 ( V_30 ) ;
F_55 ( & V_30 -> V_141 ) ;
...
static T_5 F_56 ( struct V_137 * V_7 ,
struct V_138 * V_139 ,
const char * V_25 , T_1 V_140 )
{
struct V_1 * V_2 = F_52 ( V_7 ) ;
...
static T_5 F_57 ( struct V_137 * V_7 ,
struct V_138 * V_139 , char * V_25 )
{
struct V_1 * V_2 = F_52 ( V_7 ) ;
struct V_29 * V_30 = F_53 ( V_2 ) ;
return sprintf ( V_25 , L_56 ,
V_30 -> V_78 == V_79 ?
L_57 : L_58 ) ;
}
static T_5 F_58 ( struct V_137 * V_7 ,
struct V_138 * V_142 ,
char * V_25 )
{
struct V_1 * V_2 = F_52 ( V_7 ) ;
struct V_29 * V_30 = F_53 ( V_2 ) ;
struct V_143 * V_139 =
F_59 ( V_142 , struct V_143 , V_142 ) ;
T_2 * V_144 = ( T_2 * ) ( ( char * ) V_30 + V_139 -> V_145 ) ;
unsigned int V_146 ;
unsigned int V_147 ;
if ( V_139 -> V_148 == 1 ) {
V_147 = * V_144 ;
...
return sprintf ( V_25 , L_59 , V_146 , V_147 ) ;
}
static void F_60 ( void * V_149 )
{
struct V_29 * V_30 = V_149 ;
F_61 ( & V_30 -> V_2 -> V_7 . V_150 , & V_151 ) ;
}
...
unsigned long V_156 ;
int error ;
if ( ! F_63 ( V_2 -> V_27 , V_157 ) ) {
F_3 ( & V_2 -> V_7 ,
L_60 , V_158 ) ;
return - V_159 ;
}
if ( F_64 ( V_2 -> V_27 , V_2 -> V_21 , 0 ,
V_160 , 0 , V_161 , & V_155 ) < 0 ) {
F_3 ( & V_2 -> V_7 , L_61 ) ;
return - V_159 ;
}
V_30 = F_65 ( & V_2 -> V_7 , sizeof( struct V_29 ) , V_95 ) ;
if ( ! V_30 )
return - V_96 ;
F_66 ( & V_30 -> V_141 ) ;
F_67 ( & V_30 -> V_38 ) ;
...
error = F_30 ( V_30 ) ;
if ( error ) {
F_3 ( & V_2 -> V_7 , L_62 , error ) ;
return error ;
}
V_30 -> V_100 = F_69 ( & V_2 -> V_7 ) ;
if ( ! V_30 -> V_100 ) {
F_3 ( & V_2 -> V_7 , L_63 ) ;
return - V_96 ;
}
V_30 -> V_100 -> V_162 = L_64 ;
V_30 -> V_100 -> V_153 . V_163 = V_164 ;
F_70 ( V_165 , V_30 -> V_100 -> V_166 ) ;
F_70 ( V_115 , V_30 -> V_100 -> V_167 ) ;
F_70 ( V_168 , V_30 -> V_100 -> V_167 ) ;
F_71 ( V_30 -> V_100 , V_169 , 0 , V_30 -> V_70 , 0 , 0 ) ;
F_71 ( V_30 -> V_100 , V_170 , 0 , V_30 -> V_72 , 0 , 0 ) ;
F_71 ( V_30 -> V_100 , V_171 , 0 , 255 , 0 , 0 ) ;
F_72 ( V_30 -> V_100 , V_169 , V_30 -> V_71 ) ;
F_72 ( V_30 -> V_100 , V_170 , V_30 -> V_73 ) ;
error = F_73 ( V_30 -> V_100 , V_105 ,
V_172 | V_173 ) ;
if ( error ) {
F_3 ( & V_2 -> V_7 ,
L_65 , error ) ;
...
F_71 ( V_30 -> V_100 , V_116 , 0 , V_30 -> V_70 , 0 , 0 ) ;
F_71 ( V_30 -> V_100 , V_117 , 0 , V_30 -> V_72 , 0 , 0 ) ;
F_71 ( V_30 -> V_100 , V_119 , 0 , 255 , 0 , 0 ) ;
F_71 ( V_30 -> V_100 , V_118 , 0 , 255 , 0 , 0 ) ;
F_72 ( V_30 -> V_100 , V_116 , V_30 -> V_71 ) ;
F_72 ( V_30 -> V_100 , V_117 , V_30 -> V_73 ) ;
F_74 ( V_30 -> V_100 , V_30 ) ;
error = F_75 ( V_30 -> V_100 ) ;
if ( error ) {
F_3 ( & V_2 -> V_7 ,
L_66 , error ) ;
return error ;
}
V_156 = V_2 -> V_7 . V_174 ? 0 : V_175 ;
error = F_76 ( & V_2 -> V_7 , V_2 -> V_35 ,
NULL , F_48 ,
V_156 | V_176 ,
V_2 -> V_162 , V_30 ) ;
if ( error ) {
...
if ( ! V_2 -> V_7 . V_174 )
F_77 ( & V_2 -> V_7 , true ) ;
error = F_78 ( & V_2 -> V_7 . V_150 , & V_151 ) ;
if ( error ) {
F_3 ( & V_2 -> V_7 , L_68 ,
error ) ;
return error ;
...
static int T_6 F_80 ( struct V_137 * V_7 )
{
struct V_1 * V_2 = F_52 ( V_7 ) ;
struct V_29 * V_30 = F_53 ( V_2 ) ;
...
if ( ! error )
break;
F_3 ( & V_2 -> V_7 , L_70 , error ) ;
}
if ( F_81 ( V_7 ) )
V_30 -> V_179 = ( F_82 ( V_2 -> V_35 ) == 0 ) ;
return 0 ;
}
static int T_6 F_83 ( struct V_137 * V_7 )
{
struct V_1 * V_2 = F_52 ( V_7 ) ;
struct V_29 * V_30 = F_53 ( V_2 ) ;
