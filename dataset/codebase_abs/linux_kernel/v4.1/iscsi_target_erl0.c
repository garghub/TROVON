...
F_19 ( & V_4 -> V_104 ) ;
if ( V_4 -> V_108 && V_4 -> V_109 )
F_41 ( V_110 , V_4 -> V_108 , 1 ) ;
if ( V_4 -> V_111 && V_4 -> V_112 )
F_41 ( V_110 , V_4 -> V_111 , 1 ) ;
V_106:
F_42 ( & V_4 -> V_113 ) ;
F_43 ( & V_4 -> V_114 ) ;
}
...
{
if ( V_4 -> V_123 > ( V_4 -> V_124 -> V_125 * 4 ) ) {
F_6 ( L_49
L_50 , V_4 -> V_123 ,
V_4 -> V_124 -> V_125 * 4 ) ;
return - 1 ;
...
F_34 ( L_51
L_52 , V_4 -> V_123 ) ;
if ( F_7 ( V_4 , V_4 -> V_123 , 0 ) < 0 )
return - 1 ;
if ( V_4 -> V_126 > ( V_127 + ( V_128 * 2 ) +
V_4 -> V_124 -> V_129 ) ) {
F_6 ( L_53 ,
V_4 -> V_126 ) ;
return - 1 ;
