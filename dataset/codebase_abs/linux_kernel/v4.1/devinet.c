...
if ( ! V_37 )
return - V_255 ;
V_254 = F_171 ( V_97 , V_256 , V_253 * 4 ) ;
if ( ! V_254 )
return - V_232 ;
for ( V_121 = 0 ; V_121 < V_253 ; V_121 ++ )
( ( T_1 * ) F_104 ( V_254 ) ) [ V_121 ] = V_37 -> V_41 . V_257 [ V_121 ] ;
return 0 ;
}
static int F_172 ( const struct V_11 * V_14 ,
const struct V_98 * V_254 )
{
struct V_98 * V_52 , * V_99 [ V_258 + 1 ] ;
int V_38 , V_259 ;
if ( V_14 && ! F_68 ( V_14 ) )
return - V_260 ;
V_38 = F_173 ( V_99 , V_258 , V_254 , V_261 ) ;
if ( V_38 < 0 )
return V_38 ;
if ( V_99 [ V_256 ] ) {
F_174 (a, tb[IFLA_INET_CONF], rem) {
int V_262 = F_175 ( V_52 ) ;
if ( F_176 ( V_52 ) < 4 )
return - V_79 ;
if ( V_262 <= 0 || V_262 > V_253 )
return - V_79 ;
}
}
return 0 ;
}
static int F_177 ( struct V_11 * V_14 , const struct V_98 * V_254 )
{
struct V_26 * V_37 = F_68 ( V_14 ) ;
struct V_98 * V_52 , * V_99 [ V_258 + 1 ] ;
int V_259 ;
if ( ! V_37 )
return - V_260 ;
if ( F_173 ( V_99 , V_258 , V_254 , NULL ) < 0 )
F_178 () ;
if ( V_99 [ V_256 ] ) {
F_174 (a, tb[IFLA_INET_CONF], rem)
...
{
int V_263 = F_149 ( sizeof( struct V_264 ) )
+ F_150 ( 4 ) ;
if ( type == - 1 || type == V_265 )
V_263 += F_150 ( 4 ) ;
...
struct V_269 * V_270 , T_1 V_58 ,
T_1 V_231 , int V_211 , unsigned int V_49 ,
int type )
{
struct V_56 * V_57 ;
struct V_264 * V_271 ;
V_57 = F_155 ( V_97 , V_58 , V_231 , V_211 , sizeof( struct V_264 ) ,
V_49 ) ;
if ( ! V_57 )
return - V_232 ;
V_271 = F_84 ( V_57 ) ;
V_271 -> V_272 = V_176 ;
if ( F_182 ( V_97 , V_273 , V_84 ) < 0 )
goto V_235;
if ( ( type == - 1 || type == V_265 ) &&
F_182 ( V_97 , V_265 ,
F_38 ( * V_270 , V_48 ) ) < 0 )
...
struct V_96 * V_97 ;
int V_38 = - V_82 ;
V_97 = F_165 ( F_180 ( type ) , V_277 ) ;
if ( ! V_97 )
goto V_104;
V_38 = F_181 ( V_97 , V_84 , V_270 , 0 , 0 ,
V_278 , 0 , type ) ;
if ( V_38 < 0 ) {
F_30 ( V_38 == - V_232 ) ;
F_166 ( V_97 ) ;
...
F_167 ( V_97 , V_1 , 0 , V_279 , NULL , V_277 ) ;
return;
V_104:
if ( V_38 < 0 )
F_168 ( V_1 , V_279 , V_38 ) ;
}
static int F_184 ( struct V_96 * V_280 ,
struct V_56 * V_57 )
{
struct V_1 * V_1 = F_82 ( V_280 -> V_88 ) ;
struct V_98 * V_99 [ V_281 + 1 ] ;
struct V_264 * V_271 ;
struct V_96 * V_97 ;
struct V_269 * V_270 ;
struct V_26 * V_37 ;
...
int V_84 ;
int V_38 ;
V_38 = F_83 ( V_57 , sizeof( * V_271 ) , V_99 , V_281 ,
V_282 ) ;
if ( V_38 < 0 )
goto V_104;
V_38 = V_79 ;
if ( ! V_99 [ V_273 ] )
goto V_104;
V_84 = F_185 ( V_99 [ V_273 ] ) ;
switch ( V_84 ) {
case V_283 :
V_270 = V_1 -> V_42 . V_284 ;
break;
case V_285 :
V_270 = V_1 -> V_42 . V_43 ;
break;
...
V_38 = - V_82 ;
V_97 = F_165 ( F_180 ( - 1 ) , V_277 ) ;
if ( ! V_97 )
goto V_104;
V_38 = F_181 ( V_97 , V_84 , V_270 ,
F_88 ( V_280 ) . V_58 ,
V_57 -> V_250 , V_278 , 0 ,
- 1 ) ;
if ( V_38 < 0 ) {
...
V_38 = F_186 ( V_97 , V_1 , F_88 ( V_280 ) . V_58 ) ;
V_104:
return V_38 ;
}
...
struct V_26 * V_37 ;
V_37 = F_126 ( V_14 ) ;
if ( V_37 && ! F_189 ( V_121 , V_37 -> V_41 . V_286 ) )
V_37 -> V_41 . V_257 [ V_121 ] = V_1 -> V_42 . V_43 -> V_257 [ V_121 ] ;
}
F_18 () ;
}
...
{
struct V_11 * V_14 ;
int V_287 = F_191 ( V_1 , V_48 ) ;
F_191 ( V_1 , V_288 ) = ! V_287 ;
F_192 ( V_1 , V_48 ) = V_287 ;
F_183 ( V_1 , V_265 ,
V_283 ,
V_1 -> V_42 . V_284 ) ;
F_183 ( V_1 , V_265 ,
...
static int F_194 ( struct V_1 * V_1 , struct V_269 * V_41 )
{
if ( V_41 == V_1 -> V_42 . V_43 )
return V_285 ;
else if ( V_41 == V_1 -> V_42 . V_284 )
return V_283 ;
else {
struct V_26 * V_27
...
static int F_195 ( struct V_289 * V_290 , int V_291 ,
void T_4 * V_292 ,
T_5 * V_293 , T_6 * V_294 )
{
int V_295 = * ( int * ) V_290 -> V_257 ;
int V_95 = F_196 ( V_290 , V_291 , V_292 , V_293 , V_294 ) ;
int V_296 = * ( int * ) V_290 -> V_257 ;
if ( V_291 ) {
struct V_269 * V_41 = V_290 -> V_297 ;
struct V_1 * V_1 = V_290 -> V_298 ;
int V_121 = ( int * ) V_290 -> V_257 - V_41 -> V_257 ;
int V_84 ;
F_197 ( V_121 , V_41 -> V_286 ) ;
if ( V_41 == V_1 -> V_42 . V_43 )
F_188 ( V_1 , V_121 ) ;
if ( V_121 == V_299 - 1 ||
V_121 == V_300 - 1 )
...
static int F_199 ( struct V_289 * V_290 , int V_291 ,
void T_4 * V_292 ,
T_5 * V_293 , T_6 * V_294 )
{
int * V_303 = V_290 -> V_257 ;
int V_3 = * V_303 ;
T_6 V_304 = * V_294 ;
int V_95 = F_196 ( V_290 , V_291 , V_292 , V_293 , V_294 ) ;
if ( V_291 && * V_303 != V_3 ) {
struct V_1 * V_1 = V_290 -> V_298 ;
if ( V_303 != & F_192 ( V_1 , V_48 ) ) {
if ( ! F_200 () ) {
* V_303 = V_3 ;
* V_294 = V_304 ;
return F_201 () ;
}
if ( V_303 == & F_191 ( V_1 , V_48 ) ) {
F_190 ( V_1 ) ;
} else {
struct V_269 * V_41 = V_290 -> V_297 ;
struct V_26 * V_27 =
...
static int F_202 ( struct V_289 * V_290 , int V_291 ,
void T_4 * V_292 ,
T_5 * V_293 , T_6 * V_294 )
{
int * V_303 = V_290 -> V_257 ;
...
static int F_203 ( struct V_1 * V_1 , char * V_305 ,
struct V_269 * V_306 )
{
int V_121 ;
struct V_307 * V_308 ;
char V_309 [ sizeof( L_6 ) + V_146 ] ;
V_308 = F_204 ( & V_310 , sizeof( * V_308 ) , V_28 ) ;
if ( ! V_308 )
goto V_40;
for ( V_121 = 0 ; V_121 < F_205 ( V_308 -> V_311 ) - 1 ; V_121 ++ ) {
V_308 -> V_311 [ V_121 ] . V_257 += ( char * ) V_306 - ( char * ) & V_269 ;
V_308 -> V_311 [ V_121 ] . V_297 = V_306 ;
V_308 -> V_311 [ V_121 ] . V_298 = V_1 ;
}
snprintf ( V_309 , sizeof( V_309 ) , L_7 , V_305 ) ;
V_308 -> V_312 = F_206 ( V_1 , V_309 , V_308 -> V_311 ) ;
if ( ! V_308 -> V_312 )
goto free;
V_306 -> V_44 = V_308 ;
return 0 ;
...
static void F_207 ( struct V_269 * V_41 )
{
struct V_307 * V_308 = V_41 -> V_44 ;
if ( ! V_308 )
return;
V_41 -> V_44 = NULL ;
F_208 ( V_308 -> V_312 ) ;
...
{
int V_38 ;
struct V_269 * V_313 , * V_314 ;
#ifdef F_213
struct V_289 * V_315 = V_316 ;
struct V_317 * V_318 ;
#endif
V_38 = - V_39 ;
V_313 = & V_269 ;
V_314 = & V_319 ;
if ( ! F_12 ( V_1 , & V_320 ) ) {
V_313 = F_204 ( V_313 , sizeof( V_269 ) , V_28 ) ;
if ( ! V_313 )
goto V_321;
V_314 = F_204 ( V_314 , sizeof( V_319 ) , V_28 ) ;
if ( ! V_314 )
goto V_322;
#ifdef F_213
V_315 = F_204 ( V_315 , sizeof( V_316 ) , V_28 ) ;
if ( ! V_315 )
goto V_323;
V_315 [ 0 ] . V_257 = & V_313 -> V_257 [ V_324 - 1 ] ;
V_315 [ 0 ] . V_297 = V_313 ;
V_315 [ 0 ] . V_298 = V_1 ;
#endif
}
#ifdef F_213
V_38 = F_203 ( V_1 , L_8 , V_313 ) ;
if ( V_38 < 0 )
goto V_325;
V_38 = F_203 ( V_1 , L_9 , V_314 ) ;
if ( V_38 < 0 )
goto V_326;
V_38 = - V_39 ;
V_318 = F_206 ( V_1 , L_10 , V_315 ) ;
if ( ! V_318 )
goto V_327;
V_1 -> V_42 . V_318 = V_318 ;
#endif
V_1 -> V_42 . V_284 = V_313 ;
V_1 -> V_42 . V_43 = V_314 ;
return 0 ;
#ifdef F_213
V_327:
...
#ifdef F_213
struct V_289 * V_315 ;
V_315 = V_1 -> V_42 . V_318 -> V_328 ;
F_208 ( V_1 -> V_42 . V_318 ) ;
F_207 ( V_1 -> V_42 . V_43 ) ;
F_207 ( V_1 -> V_42 . V_284 ) ;
F_26 ( V_315 ) ;
#endif
F_26 ( V_1 -> V_42 . V_43 ) ;
F_26 ( V_1 -> V_42 . V_284 ) ;
...
F_65 ( V_81 , & V_80 , 0 ) ;
F_220 ( & V_332 ) ;
F_221 ( V_330 , V_75 , F_106 , NULL , NULL ) ;
F_221 ( V_330 , V_71 , F_81 , NULL , NULL ) ;
F_221 ( V_330 , V_333 , NULL , F_161 , NULL ) ;
F_221 ( V_330 , V_334 , F_184 ,
F_187 , NULL ) ;
}
