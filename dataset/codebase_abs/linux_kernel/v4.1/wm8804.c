...
return - V_28 ;
F_7 ( V_8 ) ;
if ( F_8 ( V_7 , V_19 -> V_29 , V_26 , V_21 ) ) {
V_27 = F_9 ( V_7 , V_13 ) & 0x4 ;
...
static bool F_11 ( struct V_30 * V_31 , unsigned int V_29 )
{
switch ( V_29 ) {
case V_32 :
case V_33 :
...
{
return F_13 ( V_10 -> V_42 , V_32 , 0x0 ) ;
}
static int F_14 ( struct V_43 * V_44 , unsigned int V_45 )
{
struct V_6 * V_7 ;
...
static int F_18 ( struct V_71 * V_71 , unsigned int V_72 ,
unsigned int V_73 , unsigned int V_74 )
{
T_2 V_75 ;
unsigned long int V_76 , V_77 , V_78 , V_79 ;
int V_80 ;
for ( V_80 = 0 ; V_80 < F_19 ( V_81 ) ; V_80 ++ ) {
...
static int F_22 ( struct V_43 * V_44 , int V_89 ,
...
F_26 ( V_7 , V_96 , V_71 . V_88 & 0xff ) ;
F_26 ( V_7 , V_97 , ( V_71 . V_88 >> 8 ) & 0xff ) ;
F_26 ( V_7 , V_98 , V_71 . V_88 >> 16 ) ;
F_4 ( V_7 , V_13 , 0x1 , 0 ) ;
}
return 0 ;
}
...
break;
default:
F_15 ( V_44 -> V_31 , L_10 , V_107 ) ;
return - V_28 ;
}
return 0 ;
}
int F_29 ( struct V_30 * V_31 , struct V_42 * V_42 )
{
struct V_9 * V_10 ;
unsigned int V_110 , V_111 ;
int V_80 , V_93 ;
V_10 = F_30 ( V_31 , sizeof( * V_10 ) , V_112 ) ;
if ( ! V_10 )
return - V_113 ;
F_31 ( V_31 , V_10 ) ;
V_10 -> V_31 = V_31 ;
V_10 -> V_42 = V_42 ;
V_10 -> V_114 = F_32 ( V_31 , L_11 ,
V_115 ) ;
if ( F_33 ( V_10 -> V_114 ) ) {
V_93 = F_34 ( V_10 -> V_114 ) ;
F_15 ( V_31 , L_12 , V_93 ) ;
return V_93 ;
}
for ( V_80 = 0 ; V_80 < F_19 ( V_10 -> V_116 ) ; V_80 ++ )
V_10 -> V_116 [ V_80 ] . V_117 = V_118 [ V_80 ] ;
V_93 = F_35 ( V_31 , F_19 ( V_10 -> V_116 ) ,
V_10 -> V_116 ) ;
if ( V_93 ) {
F_15 ( V_31 , L_13 , V_93 ) ;
return V_93 ;
...
if ( V_10 -> V_114 )
F_38 ( V_10 -> V_114 , 1 ) ;
V_93 = F_39 ( V_42 , V_32 , & V_110 ) ;
if ( V_93 < 0 ) {
F_15 ( V_31 , L_16 , V_93 ) ;
goto V_125;
}
V_93 = F_39 ( V_42 , V_33 , & V_111 ) ;
if ( V_93 < 0 ) {
F_15 ( V_31 , L_16 , V_93 ) ;
goto V_125;
}
V_111 = ( V_111 << 8 ) | V_110 ;
if ( V_111 != 0x8805 ) {
F_15 ( V_31 , L_17 , V_111 ) ;
V_93 = - V_28 ;
goto V_125;
}
V_93 = F_39 ( V_42 , V_34 , & V_110 ) ;
if ( V_93 < 0 ) {
F_15 ( V_31 , L_18 ,
V_93 ) ;
goto V_125;
}
F_40 ( V_31 , L_19 , V_110 + 'A' ) ;
if ( ! V_10 -> V_114 ) {
V_93 = F_12 ( V_10 ) ;
if ( V_93 < 0 ) {
F_15 ( V_31 , L_20 , V_93 ) ;
...
return 0 ;
V_125:
F_45 ( F_19 ( V_10 -> V_116 ) , V_10 -> V_116 ) ;
return V_93 ;
}
...
{
struct V_9 * V_10 = F_50 ( V_31 ) ;
int V_93 ;
V_93 = F_37 ( F_19 ( V_10 -> V_116 ) ,
V_10 -> V_116 ) ;
if ( V_93 ) {
F_15 ( V_10 -> V_31 , L_15 , V_93 ) ;
return V_93 ;
}
F_51 ( V_10 -> V_42 ) ;
F_52 ( V_10 -> V_42 , V_13 , 0x8 , 0x0 ) ;
return 0 ;
}
static int F_53 ( struct V_30 * V_31 )
{
struct V_9 * V_10 = F_50 ( V_31 ) ;
F_52 ( V_10 -> V_42 , V_13 , 0x8 , 0x8 ) ;
F_45 ( F_19 ( V_10 -> V_116 ) ,
V_10 -> V_116 ) ;
return 0 ;
}
