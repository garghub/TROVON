...
if ( ! V_10 )
return - V_61 ;
V_10 -> V_3 = V_9 -> V_62 -> V_63 ;
V_56 = F_27 ( V_9 , V_64 , 0 ) ;
V_10 -> V_11 = F_28 ( & V_9 -> V_6 , V_56 ) ;
if ( F_29 ( V_10 -> V_11 ) )
return F_30 ( V_10 -> V_11 ) ;
V_10 -> V_65 = F_31 ( & V_9 -> V_6 , NULL ) ;
if ( F_29 ( V_10 -> V_65 ) ) {
F_32 ( & V_9 -> V_6 , L_1 ) ;
return F_30 ( V_10 -> V_65 ) ;
}
V_59 = F_33 ( V_10 -> V_65 ) ;
if ( V_59 )
return V_59 ;
...
F_32 ( & V_9 -> V_6 , L_2 , V_58 ) ;
V_59 = - V_69 ;
goto V_70;
}
V_32 |= V_71 ;
F_8 ( V_32 , ( V_10 -> V_11 + V_72 ) ) ;
if ( ( ( F_5 ( V_10 -> V_11 + V_72 ) ) & V_71 ) == 0 ) {
F_32 ( & V_9 -> V_6 , L_3 ) ;
V_59 = - V_73 ;
goto V_70;
}
...
if ( V_10 -> V_36 >= 0 )
F_39 ( & V_9 -> V_6 , 1 ) ;
V_33 = F_40 ( & V_9 -> V_6 , V_9 -> V_75 , & V_76 ,
V_77 ) ;
if ( F_29 ( V_33 ) ) {
V_59 = F_30 ( V_33 ) ;
goto V_70;
