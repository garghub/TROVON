...
struct V_12 * V_13 = F_5 ( V_11 ) ;
int V_97 ;
F_46 ( & V_13 -> V_103 , F_35 ) ;
V_97 = F_47 ( V_11 ) ;
if ( V_97 < 0 ) {
F_48 ( V_11 -> V_2 , L_3 , V_97 ) ;
return V_97 ;
}
V_13 -> V_15 = 0 ;
F_49 ( V_11 , V_116 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_117 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_118 , 0x0100 , 0x0100 ) ;
...
struct V_12 * V_13 ;
int V_97 ;
V_13 = F_51 ( & V_127 -> V_2 , sizeof( struct V_12 ) ,
V_128 ) ;
if ( V_13 == NULL )
return - V_129 ;
F_52 ( V_127 , V_13 ) ;
V_13 -> V_104 = F_53 ( V_127 , & V_130 ) ;
if ( F_54 ( V_13 -> V_104 ) ) {
V_97 = F_55 ( V_13 -> V_104 ) ;
F_48 ( & V_127 -> V_2 , L_4 ,
V_97 ) ;
return V_97 ;
}
V_97 = F_56 ( & V_127 -> V_2 , & V_131 ,
V_132 , F_17 ( V_132 ) ) ;
if ( V_97 != 0 )
F_48 ( & V_127 -> V_2 , L_5 , V_97 ) ;
return V_97 ;
}
...
struct V_12 * V_13 ;
int V_97 ;
V_13 = F_51 ( & V_134 -> V_2 , sizeof( struct V_12 ) ,
V_128 ) ;
if ( V_13 == NULL )
return - V_129 ;
F_60 ( V_134 , V_13 ) ;
V_13 -> V_104 = F_61 ( V_134 , & V_130 ) ;
if ( F_54 ( V_13 -> V_104 ) ) {
V_97 = F_55 ( V_13 -> V_104 ) ;
F_48 ( & V_134 -> V_2 , L_4 ,
V_97 ) ;
...
V_97 = F_56 ( & V_134 -> V_2 , & V_131 ,
V_132 , F_17 ( V_132 ) ) ;
if ( V_97 != 0 )
F_48 ( & V_134 -> V_2 , L_5 , V_97 ) ;
return V_97 ;
}
static int F_62 ( struct V_133 * V_137 )
{
F_58 ( & V_137 -> V_2 ) ;
return 0 ;
}
