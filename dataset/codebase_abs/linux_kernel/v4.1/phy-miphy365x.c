...
for ( V_100 = 0 ; V_100 < V_4 -> V_111 ; V_100 ++ )
if ( V_102 == V_4 -> V_112 [ V_100 ] -> V_95 -> V_28 . V_103 ) {
V_2 = V_4 -> V_112 [ V_100 ] ;
break;
}
if ( ! V_2 ) {
...
static int F_31 ( struct V_113 * V_114 )
{
struct V_101 * V_115 , * V_108 = V_114 -> V_28 . V_103 ;
struct V_3 * V_4 ;
struct V_116 * V_117 ;
struct V_95 * V_95 ;
int V_62 , V_118 = 0 ;
V_4 = F_32 ( & V_114 -> V_28 , sizeof( * V_4 ) , V_119 ) ;
if ( ! V_4 )
return - V_120 ;
V_4 -> V_111 = F_33 ( V_108 ) ;
V_4 -> V_112 = F_34 ( & V_114 -> V_28 , V_4 -> V_111 ,
sizeof( * V_4 -> V_112 ) , V_119 ) ;
if ( ! V_4 -> V_112 )
return - V_120 ;
V_4 -> V_7 = F_35 ( V_108 , L_15 ) ;
if ( F_36 ( V_4 -> V_7 ) ) {
F_10 ( V_4 -> V_28 , L_16 ) ;
return F_37 ( V_4 -> V_7 ) ;
}
...
F_40 (np, child) {
struct V_1 * V_2 ;
V_2 = F_32 ( & V_114 -> V_28 , sizeof( * V_2 ) ,
V_119 ) ;
if ( ! V_2 )
return - V_120 ;
V_4 -> V_112 [ V_118 ] = V_2 ;
V_95 = F_41 ( & V_114 -> V_28 , V_115 , & V_121 ) ;
if ( F_36 ( V_95 ) ) {
F_10 ( & V_114 -> V_28 , L_17 ) ;
return F_37 ( V_95 ) ;
}
V_4 -> V_112 [ V_118 ] -> V_95 = V_95 ;
V_62 = F_28 ( V_115 , V_2 ) ;
if ( V_62 )
return V_62 ;
F_42 ( V_95 , V_4 -> V_112 [ V_118 ] ) ;
V_118 ++ ;
V_62 = F_43 ( V_108 , L_15 , V_118 ,
& V_2 -> V_8 ) ;
if ( V_62 ) {
F_10 ( & V_114 -> V_28 , L_18 ) ;
return V_62 ;
}
}
V_117 = F_44 ( & V_114 -> V_28 , F_24 ) ;
return F_45 ( V_117 ) ;
}
