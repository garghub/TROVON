...
{
struct V_12 * V_52 = F_22 ( V_40 ) ;
int V_132 = V_88 -> V_111 - V_52 -> V_74 - V_40 -> V_84 ;
int V_76 ;
if ( V_131 )
...
if ( F_75 ( V_88 ) )
F_75 ( V_88 ) -> V_20 -> V_133 ( F_75 ( V_88 ) , NULL , V_88 , V_76 ) ;
if ( V_88 -> V_80 == F_76 ( V_134 ) ) {
if ( ! F_77 ( V_88 ) &&
( V_131 & F_76 ( V_135 ) ) && V_76 < V_132 ) {
memset ( F_78 ( V_88 ) , 0 , sizeof( * F_78 ( V_88 ) ) ) ;
F_79 ( V_88 , V_136 , V_137 , F_80 ( V_76 ) ) ;
return - V_56 ;
}
}
#if F_81 ( V_138 )
else if ( V_88 -> V_80 == F_76 ( V_139 ) ) {
struct V_140 * V_141 = (struct V_140 * ) F_75 ( V_88 ) ;
if ( V_141 && V_76 < F_74 ( F_75 ( V_88 ) ) &&
V_76 >= V_142 ) {
if ( ( V_52 -> V_37 . V_38 . V_39 &&
! F_21 ( V_52 -> V_37 . V_38 . V_39 ) ) ||
V_141 -> V_143 . V_144 == 128 ) {
V_141 -> V_145 |= V_146 ;
F_82 ( F_75 ( V_88 ) , V_147 , V_76 ) ;
}
}
if ( ! F_77 ( V_88 ) && V_76 >= V_142 &&
V_76 < V_132 ) {
F_83 ( V_88 , V_148 , 0 , V_76 ) ;
return - V_56 ;
}
}
#endif
...
const struct V_73 * V_149 , T_5 V_80 )
{
struct V_12 * V_52 = F_22 ( V_40 ) ;
const struct V_73 * V_150 ;
struct V_63 V_64 ;
T_5 V_66 , V_151 ;
T_3 V_131 ;
struct V_16 * V_79 ;
...
int V_51 ;
bool V_153 ;
V_150 = ( const struct V_73 * ) F_85 ( V_88 ) ;
V_153 = ( V_52 -> V_37 . V_38 . V_39 != 0 ) ;
V_9 = V_149 -> V_39 ;
if ( V_9 == 0 ) {
if ( ! F_75 ( V_88 ) ) {
V_40 -> V_94 . V_154 ++ ;
...
bool V_160 ;
int V_161 ;
V_159 = F_88 ( F_75 ( V_88 ) ,
& F_89 ( V_88 ) -> V_39 ) ;
if ( ! V_159 )
goto V_155;
V_157 = ( const struct V_156 * ) & V_159 -> V_162 ;
V_161 = F_90 ( V_157 ) ;
if ( V_161 == V_163 ) {
V_157 = & F_89 ( V_88 ) -> V_39 ;
V_161 = F_90 ( V_157 ) ;
}
if ( ( V_161 & V_164 ) == 0 )
V_160 = true ;
...
V_66 = F_92 ( ( const struct V_167 * ) V_150 ) ;
V_153 = false ;
}
}
F_37 ( & V_64 , V_80 , V_9 , V_149 -> V_10 ,
V_52 -> V_37 . V_81 , F_39 ( V_66 ) , V_52 -> V_37 . V_30 ) ;
if ( V_114 ( V_88 , V_52 , & V_80 , & V_64 ) < 0 )
goto V_155;
V_79 = V_153 ? F_13 ( V_52 , 0 , & V_64 . V_10 ) : NULL ;
if ( ! V_79 ) {
V_79 = F_40 ( V_52 -> V_49 , & V_64 ) ;
if ( F_41 ( V_79 ) ) {
V_40 -> V_94 . V_168 ++ ;
...
if ( F_73 ( V_40 , V_88 , V_79 , V_149 -> V_170 ) ) {
F_42 ( V_79 ) ;
goto V_155;
}
if ( V_52 -> V_171 > 0 ) {
...
V_151 = ( ( const struct V_167 * ) V_150 ) -> V_175 ;
#endif
else
V_151 = F_96 ( & V_79 -> V_9 ) ;
}
V_131 = V_149 -> V_170 ;
if ( V_88 -> V_80 == F_76 ( V_134 ) )
V_131 |= ( V_150 -> V_170 & F_76 ( V_135 ) ) ;
V_152 = F_97 ( V_79 -> V_9 . V_40 ) + sizeof( struct V_73 )
...
V_66 , V_151 , V_131 , ! F_59 ( V_52 -> V_49 , F_60 ( V_40 ) ) ) ;
...
F_24 ( V_29 , V_13 ) ;
V_13 -> V_37 . V_38 . V_151 = V_23 -> V_38 . V_151 ;
V_13 -> V_37 . V_38 . V_66 = V_23 -> V_38 . V_66 ;
V_13 -> V_37 . V_38 . V_170 = V_23 -> V_38 . V_170 ;
