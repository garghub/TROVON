...
V_133 = F_90 ( & V_49 -> V_98 , V_88 , V_64 , V_47 -> V_32 ,
...
int V_85 ;
V_85 = F_89 ( V_88 , NULL , V_2 , & V_49 , & V_125 , V_147 ) ;
if ( V_85 )
return V_85 ;
V_85 = F_95 ( F_77 ( V_88 ) , V_49 , V_125 ) ;
if ( ! V_85 ) {
F_88 ( V_147 [ 0 ] ) ;
F_88 ( V_147 [ 1 ] ) ;
} else {
...
V_85 = F_89 ( V_88 , V_15 , V_2 , & V_49 , & V_125 , V_147 ) ;
if ( V_85 ) {
V_2 -> V_56 = NULL ;
F_39 ( V_15 ) ;
return V_85 ;
...
static void F_99 ( struct V_148 * V_65 , const char * V_149 ,
int V_150 )
{
struct V_15 * V_88 = F_97 ( V_65 ) ;
struct V_21 * V_34 = F_30 ( V_88 ) ;
...
if ( F_91 ( V_2 ) )
return;
V_148 = F_100 ( V_65 , & V_2 -> V_11 ) ;
if ( ! V_148 ) {
V_85 = F_94 ( V_88 , V_2 ) ;
} else {
V_85 = F_96 ( V_88 , V_2 , V_148 ) ;
if ( V_85 == 1 && F_12 ( V_9 , F_97 ( V_148 ) ) )
F_54 ( V_9 , F_97 ( V_148 ) , V_2 -> V_40 ) ;
}
if ( V_148 != NULL )
F_101 ( V_148 ) ;
if ( V_85 ) {
...
static void F_107 ( struct V_148 * V_65 , struct V_8 * V_9 )
{
struct V_157 * V_158 = & V_9 -> V_69 ;
struct V_159 V_160 = { 0 } ;
struct V_21 * V_153 ;
...
F_27 ( V_39 , L_12 ,
V_9 , V_65 ) ;
V_153 = F_30 ( F_97 ( V_65 ) ) ;
V_167 = F_108 ( F_102 , V_65 ,
L_13 , V_153 -> V_80 ) ;
if ( F_91 ( V_167 ) ) {
F_109 ( L_14 , F_92 ( V_167 ) ) ;
F_105 ( V_158 , V_165 ) ;
return;
}
F_106 ( V_158 -> V_70 ,
F_85 ( V_158 ) || F_63 ( V_158 ) ,
& V_160 ) ;
}
static int F_110 ( void * V_152 )
{
struct V_148 * V_65 = (struct V_148 * ) V_152 ;
struct V_15 * V_88 = F_97 ( V_65 ) ;
struct V_21 * V_153 = F_30 ( V_88 ) ;
...
V_188:
F_99 ( V_65 , V_32 , V_180 ) ;
}
V_58 = F_116 ( V_177 -> V_189 ) ;
if ( V_58 == V_190 ) {
F_118 ( V_169 , 0 ) ;
while ( 1 ) {
F_106 ( V_158 -> V_70 ,
...
void F_121 ( struct V_15 * V_88 , void * V_194 )
{
struct V_21 * V_34 = F_30 ( V_88 ) ;
if ( F_25 ( V_194 == NULL ) )
return;
...
static int F_122 ( struct V_15 * V_88 , struct V_148 * V_148 )
{
struct V_171 V_172 ;
...
V_9 -> V_26 ++ ;
V_9 -> V_28 = 0 ;
V_9 -> V_25 = F_124 ( 2 * V_9 -> V_25 , V_156 -> V_202 ) ;
} else {
struct V_21 * V_34 = F_30 ( V_9 -> V_43 ) ;
V_9 -> V_27 ++ ;
V_9 -> V_28 ++ ;
if ( F_21 ( V_9 ) && F_85 ( V_158 ) ) {
F_32 ( & V_156 -> V_203 ) ;
...
int F_125 ( struct V_15 * V_88 , struct V_148 * * V_204 ,
int V_205 )
{
struct V_21 * V_34 = F_30 ( V_88 ) ;
struct V_8 * V_9 = V_34 -> V_79 ;
...
F_131 ( L_26 V_83 L_27 ,
F_64 ( & V_34 -> V_84 ) ) ;
V_85 = - V_120 ;
goto V_97;
}
V_65 = F_132 ( ( * V_204 ) -> V_211 ) ;
if ( F_25 ( V_9 -> V_43 != F_97 ( V_65 ) ) ) {
struct V_21 * V_212 = F_30 ( F_97 ( V_65 ) ) ;
F_131 ( L_28 V_83 L_29 V_83 L_27 ,
* V_204 ,
