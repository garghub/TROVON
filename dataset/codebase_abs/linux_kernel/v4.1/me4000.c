...
return - V_15 ;
V_158 = F_43 ( V_2 , & V_7 -> V_2 , V_163 ,
F_1 , 0 ) ;
if ( V_158 < 0 )
return V_158 ;
F_10 ( V_2 ) ;
if ( V_7 -> V_123 > 0 ) {
V_158 = F_44 ( V_7 -> V_123 , F_31 , V_164 ,
V_2 -> V_160 , V_2 ) ;
if ( V_158 == 0 )
V_2 -> V_123 = V_7 -> V_123 ;
}
...
if ( V_46 -> V_184 ) {
V_81 -> type = V_185 ;
V_81 -> V_167 = V_186 | V_169 | V_170 ;
V_81 -> V_172 = V_46 -> V_184 ;
V_81 -> V_173 = 0xFFFF ;
V_81 -> V_176 = & V_187 ;
V_81 -> V_188 = F_34 ;
V_158 = F_46 ( V_81 ) ;
...
if ( V_46 -> V_189 ) {
V_81 -> type = V_190 ;
V_81 -> V_167 = V_168 | V_186 ;
V_81 -> V_172 = V_46 -> V_189 ;
V_81 -> V_173 = 1 ;
V_81 -> V_176 = & V_191 ;
V_81 -> V_192 = F_35 ;
V_81 -> V_193 = F_37 ;
...
V_81 = & V_2 -> V_165 [ 3 ] ;
if ( V_46 -> V_194 ) {
unsigned long V_195 = F_3 ( V_7 , 3 ) ;
if ( ! V_195 )
return - V_15 ;
V_2 -> V_196 = F_47 ( V_195 , 0 , V_197 , 0 ) ;
if ( ! V_2 -> V_196 )
return - V_162 ;
F_48 ( V_81 , V_2 -> V_196 ) ;
} else {
...
{
return F_52 ( V_2 , & V_200 , V_199 -> V_201 ) ;
}
