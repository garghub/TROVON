...
static void T_1 F_42 ( T_4 (* F_43)( char * , T_4 ) )
{
char * V_89 , * V_90 ;
T_4 V_74 , V_14 ;
V_14 = strlen ( V_21 ) ;
V_90 = V_21 + V_14 ;
V_89 = V_21 + V_14 + 1 ;
V_74 = F_43 ( V_89 , V_91 - V_14 - 1 ) ;
if ( V_74 ) {
if ( * V_89 == '=' )
memmove ( V_21 , V_89 + 1 , V_74 ) ;
else
* V_90 = ' ' ;
}
}
static inline int F_44 ( const char * V_84 )
{
int V_5 ;
for ( V_5 = 0 ; V_84 [ V_5 ] ; V_5 ++ )
if ( V_84 [ V_5 ] & 0x80 )
return 1 ;
return 0 ;
}
