...
{
struct V_4 * V_4 = V_3 -> V_5 -> V_6 ;
struct V_32 * V_33 = F_25 ( V_4 ) ;
T_2 V_34 = F_26 ( V_4 ) ;
struct V_12 V_35 ;
struct V_7 V_8 ;
int V_15 , V_36 ;
if ( V_3 -> V_37 == V_34 >> V_38 )
V_36 = V_34 & ~ V_39 ;
else
V_36 = V_31 ;
V_8 . V_9 = V_3 ;
V_8 . V_40 = 0 ;
V_8 . V_10 = V_36 ;
F_6 ( & V_35 , V_17 | V_41 , & V_8 , 1 , V_36 ) ;
F_3 ( ! V_33 -> V_42 ) ;
F_27 ( V_3 ) ;
F_28 ( V_33 -> V_42 , F_8 ( V_3 ) , & V_35 , & V_15 ) ;
F_29 ( V_3 ) ;
return V_15 ;
}
static int F_30 ( struct V_3 * V_3 , struct V_43 * V_44 )
{
int V_14 ;
F_2 ( V_16 , L_4 , V_3 ) ;
V_14 = F_24 ( V_3 ) ;
...
static T_3
F_37 ( struct V_46 * V_47 , struct V_12 * V_48 , T_2 V_49 )
{
struct V_20 * V_20 = V_47 -> V_50 ;
T_3 V_51 ;
int V_15 = 0 ;
if ( F_38 ( V_48 ) == V_41 ) {
V_51 = F_28 ( V_20 -> V_22 , V_49 , V_48 , & V_15 ) ;
if ( V_51 ) {
...
V_51 = F_7 ( V_20 -> V_22 , V_49 , V_48 , & V_15 ) ;
}
return V_51 ? V_51 : V_15 ;
}
static int F_41 ( struct V_20 * V_21 , struct V_23 * V_5 ,
T_2 V_49 , unsigned V_36 , unsigned V_53 ,
...
T_2 V_49 , unsigned V_36 , unsigned V_59 ,
...
F_2 ( V_16 , L_5 , V_21 , V_5 ) ;
if ( F_46 ( V_59 < V_36 ) ) {
unsigned V_35 = V_49 & ( V_31 - 1 ) ;
F_10 ( V_3 , V_35 + V_59 , V_36 - V_59 ) ;
F_11 ( V_3 ) ;
}
if ( ! F_43 ( V_3 ) )
F_12 ( V_3 ) ;
