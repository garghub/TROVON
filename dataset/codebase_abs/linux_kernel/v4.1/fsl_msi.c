...
V_85 -> V_79 = F_64 ( V_99 . V_111 , F_65 ( & V_99 ) ) ;
if ( ! V_85 -> V_79 ) {
V_101 = - V_59 ;
F_33 ( & V_62 -> V_62 , L_21 ,
V_62 -> V_62 . V_31 -> V_63 ) ;
...
V_85 -> V_47 =
V_105 -> V_47 + ( V_99 . V_111 & 0xfffff ) ;
if ( F_63 ( V_62 -> V_62 . V_31 , 1 , & V_100 ) )
V_85 -> V_47 = V_105 -> V_47 +
( V_99 . V_111 & V_112 ) ;
else
V_85 -> V_47 = V_100 . V_111 & V_112 ;
}
V_85 -> V_50 = V_105 -> V_110 ;
if ( ( V_105 -> V_110 & V_77 ) == V_78
&& ( F_66 () == 0x0200 ) )
V_85 -> V_50 |= V_51 ;
...
F_69 ( & V_85 -> V_87 , & V_120 ) ;
if ( ! V_121 . V_122 ) {
V_121 . V_122 = F_30 ;
V_121 . V_123 = F_14 ;
} else if ( V_121 . V_122 != F_30 ) {
F_33 ( & V_62 -> V_62 , L_28 ) ;
V_101 = - V_124 ;
goto V_109;
}
