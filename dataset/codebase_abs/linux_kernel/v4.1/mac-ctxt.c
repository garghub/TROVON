...
V_96 . V_158 = F_35 ( V_180 |
V_191 ) ;
V_96 . V_195 . V_181 = F_35 ( V_4 -> V_16 . V_17 ) ;
V_96 . V_195 . V_182 =
F_35 ( F_51 ( V_4 -> V_16 . V_17 ) ) ;
V_96 . V_195 . V_196 = F_35 ( V_8 -> V_44 ) ;
return F_43 ( V_35 , & V_96 ) ;
}
static void F_54 ( void * V_1 , T_1 * V_2 , struct V_3 * V_4 )
{
struct V_197 * V_6 = V_1 ;
struct V_7 * V_8 = F_2 ( V_4 ) ;
...
V_35 -> V_40 , V_41 ,
F_54 , & V_6 ) ;
V_96 . V_200 . V_201 = F_35 ( V_6 . V_199 ? 1 : 0 ) ;
return F_43 ( V_35 , & V_96 ) ;
}
...
{
T_3 V_206 ;
struct V_207 * V_208 = (struct V_207 * ) V_204 ;
V_206 = V_208 -> V_209 . V_204 . V_210 - V_204 ;
while ( ( V_206 < ( V_205 - 2 ) ) &&
( V_204 [ V_206 ] != V_211 ) )
V_206 += V_204 [ V_206 + 1 ] + 2 ;
if ( ( V_206 < ( V_205 - 1 ) ) && ( V_204 [ V_206 ] == V_211 ) ) {
V_203 -> V_206 = F_35 ( V_206 ) ;
V_203 -> V_212 = F_35 ( ( T_3 ) V_204 [ V_206 + 1 ] ) ;
} else {
F_57 ( V_35 , L_10 ) ;
}
}
...
return - V_222 ;
V_219 = V_204 -> V_223 ;
V_203 . V_224 = F_35 ( ( T_3 ) V_8 -> V_44 ) ;
V_218 = F_59 ( V_204 ) ;
V_203 . V_225 . V_223 = F_42 ( ( T_2 ) V_219 ) ;
V_203 . V_225 . V_36 = V_8 -> V_62 . V_36 ;
V_203 . V_225 . V_226 = F_35 ( V_227 ) ;
V_221 = V_228 | V_229 ;
V_221 |=
F_60 ( V_35 , ( void * ) V_204 -> V_6 , V_218 , 0 ) <<
V_230 ;
V_203 . V_225 . V_221 = F_35 ( V_221 ) ;
V_35 -> V_231 =
F_61 ( V_35 , F_62 ( V_35 ) ,
V_35 -> V_231 ) ;
V_203 . V_225 . V_232 =
...
V_204 -> V_6 ,
V_219 ) ;
V_96 . V_223 [ 0 ] = sizeof( V_203 ) ;
V_96 . V_6 [ 0 ] = & V_203 ;
V_96 . V_236 [ 0 ] = 0 ;
V_96 . V_223 [ 1 ] = V_219 ;
V_96 . V_6 [ 1 ] = V_204 -> V_6 ;
V_96 . V_236 [ 1 ] = V_237 ;
return F_64 ( V_35 , & V_96 ) ;
}
...
F_47 ( V_4 -> type != V_11 &&
V_4 -> type != V_49 ) ;
V_204 = F_66 ( V_35 -> V_40 , V_4 , NULL ) ;
if ( ! V_204 )
return - V_238 ;
V_47 = F_58 ( V_35 , V_4 , V_204 ) ;
F_67 ( V_204 ) ;
return V_47 ;
}
static void F_68 ( void * V_1 , T_1 * V_2 ,
struct V_3 * V_4 )
{
...
V_96 . V_158 |= F_35 ( V_191 |
V_180 ) ;
F_69 ( V_35 , V_4 , & V_96 . V_252 . V_250 ,
V_112 == V_251 ) ;
...
static int F_75 ( struct V_34 * V_35 , struct V_3 * V_4 ,
T_3 V_112 , bool V_161 ,
const T_1 * V_111 )
{
switch ( V_4 -> type ) {
...
case V_20 :
return F_55 ( V_35 , V_4 , V_112 ) ;
case V_49 :
return F_53 ( V_35 , V_4 , V_112 ) ;
default:
break;
}
return - V_255 ;
}
int F_76 ( struct V_34 * V_35 , struct V_3 * V_4 )
{
struct V_7 * V_8 = F_2 ( V_4 ) ;
int V_47 ;
if ( F_77 ( V_8 -> V_256 , L_11 ,
V_4 -> V_129 , F_78 ( V_4 ) ) )
return - V_54 ;
V_47 = F_75 ( V_35 , V_4 , V_251 ,
true , NULL ) ;
if ( V_47 )
return V_47 ;
F_79 ( V_35 , V_4 ) ;
...
{
struct V_7 * V_8 = F_2 ( V_4 ) ;
if ( F_77 ( ! V_8 -> V_256 , L_12 ,
V_4 -> V_129 , F_78 ( V_4 ) ) )
return - V_54 ;
return F_75 ( V_35 , V_4 , V_257 ,
V_161 , V_111 ) ;
}
...
} else if ( ! F_85 ( & V_8 -> V_57 ) ) {
F_87 ( V_259 ) ;
F_88 ( V_35 -> V_259 , NULL ) ;
}
}
...
struct V_270 * V_96 )
{
struct V_271 * V_272 = F_90 ( V_269 ) ;
struct V_273 * V_204 = ( void * ) V_272 -> V_6 ;
struct V_274 * V_275 ;
struct V_3 * V_259 ;
struct V_3 * V_276 ;
T_2 V_52 ;
F_12 ( & V_35 -> V_39 ) ;
V_275 = & V_204 -> V_275 ;
V_35 -> V_277 = F_45 ( V_204 -> V_260 ) ;
V_52 = F_91 ( V_275 -> V_52 . V_52 ) & V_278 ;
F_92 ( V_35 ,
L_15 ,
V_52 , V_275 -> V_279 ,
F_50 ( V_204 -> V_280 ) ,
V_35 -> V_277 ,
F_45 ( V_275 -> V_281 ) ) ;
V_259 = F_93 ( V_35 -> V_259 ,
F_94 ( & V_35 -> V_39 ) ) ;
if ( F_95 ( V_259 && V_259 -> V_282 ) )
F_82 ( V_35 , V_259 , V_35 -> V_277 ,
( V_52 == V_283 ) ) ;
V_276 = F_93 ( V_35 -> V_284 ,
F_94 ( & V_35 -> V_39 ) ) ;
if ( F_95 ( V_276 ) ) {
struct V_7 * V_8 =
F_2 ( V_276 ) ;
...
if ( V_35 -> V_285 == 0 ) {
F_96 ( V_35 , V_8 , false ) ;
F_88 ( V_35 -> V_284 , NULL ) ;
}
}
return 0 ;
}
static void F_97 ( void * V_1 , T_1 * V_2 ,
struct V_3 * V_4 )
{
...
T_3 V_293 , V_294 ;
T_3 V_295 , V_296 ;
if ( V_8 -> V_44 != ( T_2 ) F_45 ( V_288 -> V_297 ) )
return;
V_295 = F_45 ( V_288 -> V_298 ) ;
V_296 =
F_45 ( V_288 -> V_299 ) ;
if ( F_45 ( V_288 -> V_299 ) >
V_300 )
...
V_302 ) )
return;
V_292 = F_100 ( V_35 -> V_301 ,
V_302 ) ;
V_290 = ( void * ) V_292 -> V_6 ;
V_293 = F_45 ( V_290 -> V_303 ) ;
V_294 =
F_45 ( V_290 -> V_304 ) ;
if ( ! F_101 ( V_35 , V_4 , V_292 ) )
return;
if ( V_296 >= V_294 ||
V_295 >= V_293 )
F_102 ( V_35 , V_292 , NULL ) ;
}
...
{
struct V_271 * V_272 = F_90 ( V_269 ) ;
struct V_287 * V_305 = ( void * ) V_272 -> V_6 ;
F_49 ( V_35 ,
L_16 ,
F_45 ( V_305 -> V_297 ) ,
F_45 ( V_305 -> V_298 ) ,
