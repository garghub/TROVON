...
static int F_10 ( struct V_5 * V_6 , const T_2 * V_13 ,
unsigned int V_14 )
{
struct V_1 * V_2 = F_9 ( V_6 ) ;
...
F_1 () ;
F_11 ( V_2 -> V_7 , ( const T_2 * ) V_2 -> V_19 , 1 ) ;
F_4 () ;
V_14 -= V_16 ;
V_18 += V_16 ;
}
...
static int F_12 ( struct V_5 * V_6 , T_2 * V_21 )
{
struct V_1 * V_2 = F_9 ( V_6 ) ;
const unsigned int V_15 = V_2 -> V_3 & 0x3f ;
...
F_11 ( V_2 -> V_7 , V_2 -> V_19 , 1 ) ;
F_4 () ;
V_25 [ 0 ] = F_14 ( V_2 -> V_7 [ 0 ] ) ;
V_25 [ 1 ] = F_14 ( V_2 -> V_7 [ 1 ] ) ;
V_25 [ 2 ] = F_14 ( V_2 -> V_7 [ 2 ] ) ;
V_25 [ 3 ] = F_14 ( V_2 -> V_7 [ 3 ] ) ;
V_25 [ 4 ] = F_14 ( V_2 -> V_7 [ 4 ] ) ;
F_6 ( V_2 ) ;
return 0 ;
}
static int F_15 ( struct V_5 * V_6 , void * V_21 )
{
struct V_1 * V_2 = F_9 ( V_6 ) ;
memcpy ( V_21 , V_2 , sizeof( * V_2 ) ) ;
return 0 ;
}
static int F_16 ( struct V_5 * V_6 , const void * V_27 )
{
struct V_1 * V_2 = F_9 ( V_6 ) ;
