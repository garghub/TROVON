...
V_23 = F_52 ( V_61 , & V_1 -> V_27 , & V_1 -> V_26 ,
& V_76 , V_1 -> V_4 -> V_77 ) ;
if ( V_23 ) {
...
V_73 = V_79 ;
V_75 = F_53 ( V_1 -> V_26 ) ;
V_1 -> V_7 [ 0 ] = F_54 ( V_1 -> V_27 . V_4 , V_3 ,
V_71 -> V_80 [ 0 ] , V_73 , F_20 ( V_75 ) , true ) ;
V_23 = F_55 ( V_1 -> V_7 [ 0 ] ) ;
if ( V_23 ) {
F_23 ( V_1 -> V_4 , L_10 ,
V_23 ) ;
...
if ( V_71 -> V_73 >= 0 && V_71 -> V_80 [ 1 ] > 0 ) {
V_1 -> V_7 [ 1 ] = F_54 ( V_1 -> V_27 . V_4 , V_3 ,
V_71 -> V_80 [ 1 ] ,
V_82 ,
F_20 ( V_75 ) , false ) ;
if ( F_48 ( V_1 -> V_7 [ 1 ] ) )
...
static struct V_84 * F_60 ( struct V_84 * V_5 ,
int V_85 )
{
struct V_84 * V_86 ;
int V_75 , V_23 ;
...
if ( ! V_86 )
return NULL ;
} while ( F_64 ( V_86 -> V_87 , L_13 ) );
}
return NULL ;
}
static int F_65 ( struct V_88 * V_4 , struct V_88 * V_89 , void * V_90 )
{
struct V_70 * V_71 = V_4 -> V_91 ;
struct V_36 * V_61 = V_90 ;
struct V_1 * V_1 ;
int V_23 ;
V_1 = F_66 ( V_4 , sizeof( * V_1 ) , V_92 ) ;
if ( ! V_1 )
return - V_93 ;
V_1 -> V_4 = V_4 ;
...
static void F_68 ( struct V_88 * V_4 , struct V_88 * V_89 ,
void * V_90 )
{
...
{
struct V_88 * V_4 = & V_95 -> V_4 ;
struct V_70 * V_71 = V_4 -> V_91 ;
int V_23 ;
if ( ! V_4 -> V_91 )
return - V_74 ;
if ( ! V_4 -> V_77 ) {
V_4 -> V_77 = F_60 ( V_4 -> V_5 -> V_77 ,
V_71 -> V_9 + 2 ) ;
if ( ! V_4 -> V_77 ) {
F_23 ( V_4 , L_15 ,
V_71 -> V_9 + 2 , V_4 -> V_5 -> V_77 -> V_96 ) ;
return - V_97 ;
}
}
V_23 = F_70 ( V_4 , F_71 ( 32 ) ) ;
if ( V_23 )
return V_23 ;
return F_72 ( V_4 , & V_98 ) ;
}
static int F_73 ( struct V_94 * V_95 )
{
F_74 ( & V_95 -> V_4 , & V_98 ) ;
return 0 ;
}
