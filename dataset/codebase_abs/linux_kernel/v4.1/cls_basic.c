...
static int F_26 ( struct V_3 * V_4 , unsigned long V_25 )
{
...
static int F_27 ( struct V_26 * V_26 , struct V_3 * V_4 ,
...
struct V_35 V_36 ;
F_28 ( & V_34 , V_37 , V_38 ) ;
V_32 = F_29 ( V_26 , V_4 , V_29 , V_30 , & V_34 , V_31 ) ;
if ( V_32 < 0 )
return V_32 ;
V_32 = F_30 ( V_4 , V_29 [ V_39 ] , & V_36 ) ;
if ( V_32 < 0 )
goto V_40;
if ( V_29 [ V_41 ] ) {
V_12 -> V_6 . V_42 = F_31 ( V_29 [ V_41 ] ) ;
F_32 ( V_4 , & V_12 -> V_6 , V_27 ) ;
}
F_33 ( V_4 , & V_12 -> V_14 , & V_34 ) ;
F_34 ( V_4 , & V_12 -> V_13 , & V_36 ) ;
V_12 -> V_4 = V_4 ;
return 0 ;
V_40:
F_15 ( & V_34 ) ;
...
static int F_35 ( struct V_26 * V_26 , struct V_1 * V_43 ,
...
V_32 = F_27 ( V_26 , V_4 , V_47 , V_27 , V_29 , V_44 [ V_53 ] , V_31 ) ;
if ( V_32 < 0 )
goto V_40;
* V_25 = ( unsigned long ) V_47 ;
if ( V_46 ) {
F_38 ( & V_46 -> V_24 , & V_47 -> V_24 ) ;
F_22 ( V_4 , & V_46 -> V_6 ) ;
F_23 ( & V_46 -> V_21 , F_13 ) ;
} else {
F_39 ( & V_47 -> V_24 , & V_9 -> V_19 ) ;
}
return 0 ;
V_40:
F_17 ( V_47 ) ;
...
static void F_40 ( struct V_3 * V_4 , struct V_54 * V_25 )
{
struct V_8 * V_9 = F_7 ( V_4 -> V_10 ) ;
struct V_11 * V_12 ;
F_8 (f, &head->flist, link) {
...
static int F_41 ( struct V_26 * V_26 , struct V_3 * V_4 , unsigned long V_59 ,
