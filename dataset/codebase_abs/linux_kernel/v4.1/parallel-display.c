...
static void F_39 ( struct V_41 * V_10 , struct V_41 * V_42 ,
void * V_43 )
{
struct V_6 * V_7 = F_40 ( V_10 ) ;
V_7 -> V_25 . V_14 -> V_55 ( & V_7 -> V_25 ) ;
V_7 -> V_3 . V_14 -> V_55 ( & V_7 -> V_3 ) ;
F_41 ( V_7 -> V_16 ) ;
}
static int F_42 ( struct V_56 * V_57 )
{
return F_43 ( & V_57 -> V_10 , & V_58 ) ;
}
