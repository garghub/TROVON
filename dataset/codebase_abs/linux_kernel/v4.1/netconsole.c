...
{
return snprintf ( V_25 , V_26 , L_7 , V_8 -> V_15 . V_22 ) ;
}
...
V_41 = F_43 ( V_25 , 10 , & V_8 -> V_15 . V_19 ) ;
if ( V_41 < 0 )
return V_41 ;
return F_39 ( V_25 , V_36 ) ;
}
...
V_41 = F_43 ( V_25 , 10 , & V_8 -> V_15 . V_20 ) ;
if ( V_41 < 0 )
return V_41 ;
return F_39 ( V_25 , V_36 ) ;
}
...
if ( F_46 ( V_25 , V_36 , ':' ) ) {
const char * V_42 ;
if ( F_47 ( V_25 , V_36 , V_8 -> V_15 . V_28 . V_29 . V_43 , - 1 , & V_42 ) > 0 ) {
if ( * V_42 && * V_42 != '\n' ) {
F_41 ( L_13 , * V_42 ) ;
return - V_38 ;
}
...
if ( F_46 ( V_25 , V_36 , ':' ) ) {
const char * V_42 ;
if ( F_47 ( V_25 , V_36 , V_8 -> V_15 . V_30 . V_29 . V_43 , - 1 , & V_42 ) > 0 ) {
if ( * V_42 && * V_42 != '\n' ) {
F_41 ( L_13 , * V_42 ) ;
return - V_38 ;
}
...
return - V_38 ;
memcpy ( V_8 -> V_15 . V_22 , V_22 , V_34 ) ;
return F_39 ( V_25 , V_36 ) ;
}
static void F_52 ( struct V_24 * V_9 )
{
F_19 ( F_23 ( V_9 ) ) ;
}
static T_3 F_53 ( struct V_24 * V_9 ,
struct V_45 * V_46 ,
char * V_25 )
{
T_3 V_47 = - V_38 ;
...
struct V_48 * V_49 =
F_24 ( V_46 , struct V_48 , V_46 ) ;
if ( V_49 -> V_50 )
V_47 = V_49 -> V_50 ( V_8 , V_25 ) ;
return V_47 ;
}
static T_3 F_54 ( struct V_24 * V_9 ,
struct V_45 * V_46 ,
const char * V_25 ,
T_5 V_36 )
{
...
F_55 ( & V_8 -> V_21 ) ;
if ( V_49 -> V_51 )
V_47 = V_49 -> V_51 ( V_8 , V_25 , V_36 ) ;
F_56 ( & V_8 -> V_21 ) ;
return V_47 ;
}
static struct V_24 * F_57 ( struct V_52 * V_53 ,
const char * V_16 )
{
unsigned long V_37 ;
struct V_7 * V_8 ;
...
F_5 ( & V_8 -> V_21 ) ;
F_16 ( V_8 -> V_15 . V_22 ) ;
F_58 ( & V_8 -> V_9 , V_16 , & V_54 ) ;
F_37 ( & V_39 , V_37 ) ;
F_59 ( & V_8 -> V_55 , & V_56 ) ;
F_38 ( & V_39 , V_37 ) ;
return & V_8 -> V_9 ;
}
static void F_60 ( struct V_52 * V_53 ,
struct V_24 * V_9 )
{
unsigned long V_37 ;
struct V_7 * V_8 = F_23 ( V_9 ) ;
...
static void F_67 ( struct V_70 * V_71 , const char * V_68 , unsigned int V_40 )
{
int V_72 , V_73 ;
unsigned long V_37 ;
struct V_7 * V_8 ;
...
F_64 (nt, &target_list, list) {
F_9 ( V_8 ) ;
if ( V_8 -> V_23 && F_69 ( V_8 -> V_15 . V_32 ) ) {
V_74 = V_68 ;
for ( V_73 = V_40 ; V_73 ; ) {
V_72 = F_70 ( V_73 , V_77 ) ;
F_71 ( & V_8 -> V_15 , V_74 , V_72 ) ;
V_74 += V_72 ;
V_73 -= V_72 ;
}
}
