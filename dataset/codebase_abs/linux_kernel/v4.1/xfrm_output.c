...
static int V_47 ( struct V_48 * V_46 , struct V_1 * V_2 )
{
return F_18 ( V_2 , 1 ) ;
}
static int F_23 ( struct V_48 * V_46 , struct V_1 * V_2 )
{
struct V_1 * V_49 ;
V_49 = F_24 ( V_2 , 0 ) ;
F_17 ( V_2 ) ;
...
int F_28 ( struct V_48 * V_46 , struct V_1 * V_2 )
{
struct V_15 * V_15 = F_29 ( F_2 ( V_2 ) -> V_7 ) ;
int V_11 ;
if ( F_30 ( V_2 ) )
...
return V_47 ( V_46 , V_2 ) ;
}
int F_32 ( struct V_12 * V_13 , struct V_1 * V_2 )
{
struct V_54 * V_55 ;
if ( V_13 -> V_56 . V_44 == V_57 )
V_55 = F_33 ( V_13 ,
F_34 ( F_2 ( V_2 ) -> V_42 -> V_44 ) ) ;
else
V_55 = V_13 -> V_55 ;
if ( V_55 == NULL )
return - V_58 ;
return V_55 -> V_59 -> V_60 ( V_13 , V_2 ) ;
}
void F_35 ( struct V_1 * V_2 , int V_61 )
{
unsigned int V_62 ;
struct V_63 * V_59 ;
if ( V_2 -> V_64 == F_36 ( V_65 ) )
V_62 = V_66 ;
else if ( V_2 -> V_64 == F_36 ( V_67 ) )
V_62 = V_68 ;
else
return;
V_59 = F_37 ( V_62 ) ;
