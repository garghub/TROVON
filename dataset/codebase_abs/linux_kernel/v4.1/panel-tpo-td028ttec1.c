...
{
struct V_83 * V_84 = V_77 -> V_8 . V_85 ;
struct V_1 * V_2 = F_20 ( & V_77 -> V_8 ) ;
struct V_11 * V_13 ;
V_13 = F_24 ( V_84 ) ;
if ( F_25 ( V_13 ) ) {
...
struct V_11 * V_12 ;
int V_14 ;
F_12 ( & V_77 -> V_8 , L_9 , V_86 ) ;
V_77 -> V_87 = 9 ;
V_77 -> V_88 = V_89 ;
V_14 = F_28 ( V_77 ) ;
if ( V_14 < 0 ) {
F_3 ( & V_77 -> V_8 , L_10 , V_14 ) ;
return V_14 ;
}
V_2 = F_29 ( & V_77 -> V_8 , sizeof( * V_2 ) , V_90 ) ;
if ( V_2 == NULL )
return - V_91 ;
F_30 ( & V_77 -> V_8 , V_2 ) ;
V_2 -> V_7 = V_77 ;
