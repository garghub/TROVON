...
if ( ! strcmp ( V_238 -> V_242 [ V_6 ] , V_214 -> V_243 -> V_244 ) )
V_240 = true ;
}
if ( ! V_240 )
return 0 ;
for ( V_239 = 0 ; V_239 < V_238 -> V_243 -> V_245 ; V_239 ++ ) {
enum V_215 V_246 ;
V_246 = V_238 -> V_243 -> V_247 [ V_239 ] ;
if ( F_86 ( V_238 , V_246 , & V_28 ) )
continue;
switch ( V_246 ) {
case V_248 :
...
static int F_87 ( struct V_1 * V_8 )
{
int V_28 ;
V_28 = F_14 ( V_8 -> V_30 ,
V_188 ,
...
if ( ( ( F_88 ( V_8 -> V_269 ) || F_89 ( V_8 -> V_269 ) ) &&
F_90 ( V_8 -> V_30 ) >= V_270 )
|| F_91 ( V_8 -> V_269 ) ) {
V_28 = F_13 ( V_8 -> V_30 , V_31 ,
...
static void F_92 ( struct V_213 * V_214 )
{
struct V_1 * V_8 = F_83 ( V_214 ) ;
F_93 ( V_281 , NULL ,
V_8 -> V_136 , F_84 ) ;
...
static T_5 F_95 ( struct V_1 * V_8 , char * V_283 )
{
return sprintf ( V_283 , L_76 , V_8 -> V_99 . V_183 ) ;
}
static T_5 F_96 ( struct V_1 * V_8 , const char * V_283 ,
T_6 V_284 )
{
unsigned long V_285 ;
T_5 V_28 ;
V_28 = F_97 ( V_283 , 10 , & V_285 ) ;
...
static T_5 F_98 ( struct V_1 * V_8 , char * V_283 )
{
return sprintf ( V_283 , L_76 , V_8 -> V_99 . V_134 ) ;
}
static T_5 F_99 ( struct V_1 * V_8 , const char * V_283 ,
T_6 V_284 )
{
unsigned long V_286 ;
T_5 V_28 ;
V_28 = F_97 ( V_283 , 10 , & V_286 ) ;
F_15 ( V_8 -> V_30 , L_78 ,
...
static T_5
F_100 ( struct V_287 * V_288 , struct V_289 * V_290 , char * V_283 )
{
struct V_291 * V_292 ;
struct V_1 * V_8 ;
...
static T_5
F_101 ( struct V_287 * V_288 , struct V_289 * V_290 , const char * V_283 ,
T_6 V_284 )
{
struct V_291 * V_292 ;
struct V_1 * V_8 ;
...
static T_5 F_106 ( struct V_236 * V_30 ,
struct V_297 * V_290 ,
char * V_283 )
{
int V_28 ;
...
return F_107 ( V_283 , V_298 , L_76 , ( V_186 & 0x7F ) ) ;
V_48:
return V_28 ;
}
static T_5 F_108 ( struct V_236 * V_30 ,
struct V_297 * V_290 ,
...
return F_107 ( V_283 , V_298 , L_76 , ( V_186 & 0xF ) ) ;
V_48:
return V_28 ;
}
...
return F_107 ( V_283 , V_298 , L_76 , ( V_186 & 0xF0 ) >> 4 ) ;
V_48:
return V_28 ;
}
...
if ( V_28 < 0 )
goto V_48;
return F_107 ( V_283 , V_298 , L_76 , ( V_186 & 0x1 ) ) ;
V_48:
return V_28 ;
}
...
return F_107 ( V_283 , V_298 , L_76 , ( ( V_186 & 0x10 ) >> 4 ) ) ;
V_48:
return V_28 ;
}
...
return F_107 ( V_283 , V_298 , L_76 , ( V_186 & 0x7 ) ) ;
V_48:
return V_28 ;
}
...
return F_107 ( V_283 , V_298 , L_76 , ( ( V_186 & 0x20 ) >> 5 ) ) ;
V_48:
return V_28 ;
}
...
|| F_91 ( V_8 -> V_269 ) ) {
for ( V_6 = 0 ; V_6 < F_5 ( V_300 ) ; V_6 ++ )
( void ) F_124 ( & V_8 -> V_136 -> V_30 ,
& V_300 [ V_6 ] ) ;
}
}
static int F_126 ( struct V_302 * V_303 )
{
struct V_1 * V_8 = F_127 ( V_303 ) ;
if ( ! V_8 -> V_39 . V_127 ) {
F_60 ( V_8 , V_172 ) ;
F_34 ( V_8 -> V_75 , & V_8 -> V_76 ) ;
}
...
static int F_128 ( struct V_302 * V_303 ,
T_7 V_304 )
{
struct V_1 * V_8 = F_127 ( V_303 ) ;
F_129 ( & V_8 -> V_167 ) ;
...
static int F_131 ( struct V_302 * V_303 )
{
int V_28 = 0 ;
struct V_1 * V_8 = F_127 ( V_303 ) ;
F_132 ( & V_8 -> V_4 ) ;
...
static int F_136 ( struct V_302 * V_303 )
{
...
int V_6 , V_52 ;
int V_28 = 0 ;
V_8 = F_137 ( & V_303 -> V_30 , sizeof( * V_8 ) , V_313 ) ;
if ( ! V_8 ) {
...
V_8 -> V_10 = V_309 ;
if ( V_306 ) {
V_28 = F_138 ( & V_303 -> V_30 , V_306 , V_8 -> V_10 ) ;
if ( V_28 ) {
...
V_8 -> V_79 = F_140 ( L_102 ) ;
V_312 . V_242 = V_315 ;
V_312 . V_241 = F_5 ( V_315 ) ;
V_312 . V_316 = V_8 ;
...
V_8 -> V_136 = F_144 ( V_8 -> V_30 , & V_318 , & V_312 ) ;
if ( F_145 ( V_8 -> V_136 ) ) {
F_17 ( V_8 -> V_30 , L_106 ) ;
V_28 = F_146 ( V_8 -> V_136 ) ;
goto V_317;
}
V_8 -> V_36 = F_20 ( V_8 -> V_10 -> V_11 -> V_155 ) ;
F_11 ( V_8 , true ) ;
...
V_52 = F_148 ( V_303 , V_319 [ V_6 ] . V_244 ) ;
V_28 = F_149 ( V_52 , V_319 [ V_6 ] . V_320 ,
V_321 | V_322 ,
V_319 [ V_6 ] . V_244 , V_8 ) ;
if ( V_28 != 0 ) {
F_17 ( V_8 -> V_30 , L_107 ,
...
V_52 = F_148 ( V_303 , V_324 [ 0 ] . V_244 ) ;
V_28 = F_150 ( V_52 , NULL , V_324 [ 0 ] . V_320 ,
V_321 | V_322 | V_325 ,
V_324 [ 0 ] . V_244 , V_8 ) ;
if ( V_28 != 0 ) {
F_17 ( V_8 -> V_30 , L_107 ,
