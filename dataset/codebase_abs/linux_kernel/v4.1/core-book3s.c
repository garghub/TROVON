...
if ( F_20 ( V_2 ) )
return V_45 ;
if ( F_19 ( V_2 ) && ( V_47 != V_48 ) )
return V_49 ;
return V_50 ;
}
static inline void F_4 ( struct V_1 * V_2 )
{
unsigned long V_15 = F_18 ( V_56 ) ;
int V_57 = V_15 & V_20 ;
int V_51 ;
V_2 -> V_16 = V_15 ;
if ( V_17 -> V_18 & V_25 )
...
V_51 = 0 ;
else if ( ! ( V_17 -> V_18 & V_52 ) && F_20 ( V_2 ) )
V_51 = 0 ;
else
V_51 = 1 ;
V_2 -> V_4 = V_51 ;
...
if ( ! ( V_7 & V_109 ) )
return;
V_105 -> V_106 . V_53 = F_18 ( V_54 ) ;
V_105 -> V_106 . V_110 = F_18 ( V_58 ) ;
V_105 -> V_106 . V_111 = F_18 ( V_34 ) ;
V_105 -> V_106 . V_7 = V_7 & V_112 ;
V_105 -> V_106 . V_113 = F_18 ( V_114 ) & V_115 ;
}
static unsigned long F_11 ( bool V_8 , struct V_9 * V_10 )
{
...
F_44 ( L_6 ,
F_18 ( V_131 ) , F_18 ( V_142 ) , F_18 ( V_56 ) ) ;
V_111 = V_110 = 0 ;
#ifdef F_39
V_111 = F_18 ( V_34 ) ;
if ( V_17 -> V_18 & V_25 )
...
if ( V_17 -> V_18 & V_89 ) {
F_44 ( L_7 ,
F_18 ( V_114 ) , F_18 ( V_143 ) ) ;
F_44 ( L_8 ,
F_18 ( V_144 ) , F_18 ( V_145 ) ) ;
}
#endif
F_44 ( L_9 ,
F_18 ( V_54 ) , V_111 , V_110 ) ;
F_46 ( V_18 ) ;
}
