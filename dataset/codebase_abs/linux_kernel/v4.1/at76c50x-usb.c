...
static inline int F_65 ( int V_215 )
{
V_215 += V_216 ;
V_215 = V_215 % 64 ;
if ( V_215 < 50 )
...
static void F_66 ( struct V_217 * V_217 )
{
...
if ( ! V_221 ) {
V_221 = F_69 ( sizeof( struct V_225 ) ) ;
if ( ! V_221 ) {
F_30 ( V_71 -> V_79 -> V_80 ,
L_80 ) ;
V_21 = - V_41 ;
...
F_70 ( V_221 , F_71 ( V_221 ) ) ;
F_72 ( V_221 , 0 ) ;
}
V_13 = F_73 ( V_221 ) ;
F_74 ( V_71 -> V_223 , V_71 -> V_10 , V_71 -> V_226 ,
F_75 ( V_221 , V_13 ) , V_13 , F_66 , V_71 ) ;
V_21 = F_76 ( V_71 -> V_223 , V_227 ) ;
if ( V_21 < 0 ) {
if ( V_21 == - V_228 )
F_13 ( V_229 ,
L_81 ) ;
...
static int F_78 ( struct V_9 * V_10 , struct V_230 * V_231 )
{
int V_21 ;
...
static void F_82 ( struct V_275 * V_276 )
{
struct V_70 * V_71 = F_83 ( V_276 , struct V_70 ,
V_277 ) ;
int V_21 = 0 ;
if ( V_71 -> V_278 )
return;
...
static void F_86 ( struct V_275 * V_276 )
{
struct V_70 * V_71 = F_83 ( V_276 , struct V_70 ,
V_281 ) ;
F_84 ( & V_71 -> V_279 ) ;
...
static inline int F_87 ( struct V_70 * V_71 )
{
T_4 V_282 ;
const T_1 * V_283 ;
...
V_284 -= V_282 ;
V_283 = F_90 ( V_293 , V_283 , V_284 ) ;
if ( V_283 && V_283 [ 1 ] > 0 )
V_210 = V_283 [ 2 ] ;
exit:
return F_91 ( V_210 , V_294 ) ;
}
static void F_92 ( unsigned long V_295 )
{
...
F_93 ( V_71 -> V_222 , V_305 ) ;
F_72 ( V_71 -> V_222 , F_58 ( V_28 -> V_306 ) ) ;
...
V_297 . V_308 |= V_310 ;
V_297 . V_311 = V_294 ;
V_297 . V_312 = F_87 ( V_71 ) ;
F_13 ( V_313 , L_122 ,
V_71 -> V_222 -> V_284 , V_71 -> V_222 -> V_314 ) ;
memcpy ( F_94 ( V_71 -> V_222 ) , & V_297 , sizeof( V_297 ) ) ;
F_95 ( V_71 -> V_79 , V_71 -> V_222 ) ;
V_71 -> V_222 = NULL ;
F_68 ( V_71 ) ;
}
static struct V_230 * F_96 ( struct V_9 * V_10 ,
enum V_1 V_1 )
{
int V_21 ;
char * V_315 ;
...
V_21 = F_97 ( & V_231 -> V_323 , V_231 -> V_322 , & V_10 -> V_38 ) ;
if ( V_21 < 0 ) {
...
static void F_102 ( struct V_217 * V_217 )
{
struct V_70 * V_71 = V_217 -> V_218 ;
struct V_340 * V_341 = F_103 ( V_71 -> V_342 ) ;
...
F_104 ( V_71 -> V_79 , V_71 -> V_342 ) ;
V_71 -> V_342 = NULL ;
F_105 ( V_71 -> V_79 ) ;
}
static void F_106 ( struct V_345 * V_79 ,
struct V_346 * V_347 ,
struct V_220 * V_221 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
struct V_348 * V_349 = V_71 -> V_350 ;
struct V_340 * V_341 = F_103 ( V_221 ) ;
...
if ( ! F_108 ( V_71 -> V_209 , V_351 -> V_209 ) ) {
memcpy ( V_71 -> V_209 , V_351 -> V_209 , V_75 ) ;
F_109 ( V_79 , & V_71 -> V_339 ) ;
F_107 ( V_221 ) ;
return;
}
}
...
L_140 , V_37 , V_353 ) ;
F_74 ( V_71 -> V_354 , V_71 -> V_10 , V_71 -> V_362 , V_349 ,
V_353 , F_102 , V_71 ) ;
V_21 = F_76 ( V_71 -> V_354 , V_227 ) ;
if ( V_21 ) {
...
static int F_113 ( struct V_345 * V_79 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
int V_21 ;
F_13 ( V_313 , L_136 , V_37 ) ;
...
static void F_114 ( struct V_345 * V_79 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
F_13 ( V_313 , L_136 , V_37 ) ;
F_115 ( & V_71 -> V_365 ) ;
...
static int F_118 ( struct V_345 * V_79 ,
struct V_366 * V_367 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
int V_21 = 0 ;
...
static void F_119 ( struct V_345 * V_79 ,
struct V_366 * V_367 )
{
F_13 ( V_313 , L_136 , V_37 ) ;
}
static void F_120 ( struct V_275 * V_276 )
{
struct V_70 * V_71 = F_83 ( V_276 , struct V_70 ,
V_365 . V_276 ) ;
int V_21 ;
...
V_71 -> V_273 = false ;
F_85 ( & V_71 -> V_279 ) ;
F_122 ( V_71 -> V_79 , false ) ;
F_105 ( V_71 -> V_79 ) ;
}
static int F_123 ( struct V_345 * V_79 ,
struct V_366 * V_367 ,
struct V_372 * V_373 )
{
...
static int F_124 ( struct V_345 * V_79 , T_2 V_379 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
F_13 ( V_313 , L_148 ,
...
static void F_125 ( struct V_345 * V_79 ,
struct V_366 * V_367 ,
struct V_383 * V_380 ,
T_2 V_379 )
{
...
static void F_126 ( struct V_345 * V_79 ,
unsigned int V_385 ,
...
static int F_128 ( struct V_345 * V_79 , enum V_391 V_85 ,
...
static struct V_70 * F_129 ( struct V_9 * V_10 )
{
struct V_345 * V_79 ;
struct V_70 * V_71 ;
V_79 = F_130 ( sizeof( struct V_70 ) , & V_404 ) ;
if ( ! V_79 ) {
F_131 (KERN_ERR DRIVER_NAME L_155
L_156 ) ;
return NULL ;
}
V_71 = V_79 -> V_71 ;
...
V_71 -> V_10 = V_10 ;
F_132 ( & V_71 -> V_279 ) ;
F_133 ( & V_71 -> V_277 , F_82 ) ;
F_133 ( & V_71 -> V_281 , F_86 ) ;
F_133 ( & V_71 -> V_339 , F_100 ) ;
F_134 ( & V_71 -> V_365 , F_120 ) ;
F_135 ( & V_71 -> V_219 , F_92 , 0 ) ;
V_71 -> V_122 = V_405 ;
V_71 -> V_259 = 0 ;
return V_71 ;
}
static int F_136 ( struct V_70 * V_71 ,
struct V_406 * V_407 )
{
...
V_409 -> V_421 ) ;
if ( ! V_410 && F_137 ( V_409 ) )
V_410 = V_409 ;
if ( ! V_411 && F_138 ( V_409 ) )
V_411 = V_409 ;
}
if ( ! V_410 || ! V_411 ) {
...
V_71 -> V_226 = F_139 ( V_71 -> V_10 , V_410 -> V_420 ) ;
V_71 -> V_362 = F_140 ( V_71 -> V_10 , V_411 -> V_420 ) ;
V_71 -> V_223 = F_141 ( 0 , V_40 ) ;
V_71 -> V_354 = F_141 ( 0 , V_40 ) ;
...
static int F_142 ( struct V_70 * V_71 ,
struct V_406 * V_407 )
{
struct V_80 * V_80 ;
T_4 V_284 ;
...
static int F_155 ( struct V_406 * V_407 ,
...
if ( V_64 != V_452
&& V_64 != V_235 ) {
F_98 ( V_334 , & V_407 -> V_38 ,
L_172 ) ;
V_21 = F_78 ( V_10 , V_231 ) ;
if ( V_21 < 0 ) {
F_14 ( & V_407 -> V_38 ,
L_173 ,
V_21 ) ;
...
static void F_160 ( struct V_406 * V_407 )
{
struct V_70 * V_71 ;
V_71 = F_161 ( V_407 ) ;
F_159 ( V_407 , NULL ) ;
...
F_148 ( V_71 ) ;
F_158 ( V_71 -> V_10 ) ;
F_162 ( & V_407 -> V_38 , L_177 ) ;
}
static int T_6 F_163 ( void )
{
int V_454 ;
F_131 (KERN_INFO DRIVER_DESC L_178 DRIVER_VERSION L_179 ) ;
F_132 ( & V_319 ) ;
V_454 = F_164 ( & V_455 ) ;
if ( V_454 < 0 )
F_131 (KERN_ERR DRIVER_NAME
L_180 , result) ;
F_165 ( L_181 , & V_56 ) ;
return V_454 ;
}
...
{
int V_73 ;
F_131 (KERN_INFO DRIVER_DESC L_178 DRIVER_VERSION L_182 ) ;
F_167 ( & V_455 ) ;
for ( V_73 = 0 ; V_73 < F_32 ( V_318 ) ; V_73 ++ )
F_168 ( V_318 [ V_73 ] . V_323 ) ;
F_169 ( V_56 ) ;
}
