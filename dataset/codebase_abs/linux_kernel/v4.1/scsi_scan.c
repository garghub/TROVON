...
T_1 F_87 ( struct V_224 * V_225 )
{
int V_226 ;
T_1 V_23 ;
V_23 = 0 ;
for ( V_226 = 0 ; V_226 < sizeof( V_23 ) ; V_226 += 2 )
V_23 = V_23 | ( ( ( T_1 ) V_225 -> V_224 [ V_226 ] << ( ( V_226 + 1 ) * 8 ) ) |
( ( T_1 ) V_225 -> V_224 [ V_226 + 1 ] << ( V_226 * 8 ) ) ) ;
return V_23 ;
}
void F_88 ( T_1 V_23 , struct V_224 * V_225 )
{
int V_226 ;
memset ( V_225 -> V_224 , 0 , sizeof( V_225 -> V_224 ) ) ;
for ( V_226 = 0 ; V_226 < sizeof( V_23 ) ; V_226 += 2 ) {
V_225 -> V_224 [ V_226 ] = ( V_23 >> 8 ) & 0xFF ;
V_225 -> V_224 [ V_226 + 1 ] = V_23 & 0xFF ;
V_23 = V_23 >> 16 ;
}
}
...
V_228 = ( 511 + 1 ) * sizeof( struct V_224 ) ;
V_99:
V_232 = F_3 ( V_228 , V_4 |
...
if ( F_91 ( V_232 -> V_224 ) +
sizeof( struct V_224 ) > V_228 ) {
V_228 = F_91 ( V_232 -> V_224 ) +
sizeof( struct V_224 ) ;
F_14 ( V_232 ) ;
goto V_99;
}
V_228 = F_91 ( V_232 -> V_224 ) ;
V_229 = ( V_228 / sizeof( struct V_224 ) ) ;
F_62 ( 3 , F_16 ( V_10 , V_13 ,
L_35 ) ) ;
for ( V_231 = & V_232 [ 1 ] ; V_231 <= & V_232 [ V_229 ] ; V_231 ++ ) {
V_23 = F_87 ( V_231 ) ;
...
{
struct V_12 * V_13 =
F_92 ( V_42 , V_46 , V_242 , V_23 , NULL ) ;
if ( F_102 ( V_13 ) )
return F_103 ( V_13 ) ;
F_83 ( V_13 ) ;
return 0 ;
...
{
F_105 ( V_28 ) ;
if ( V_28 -> V_243 && F_106 ( V_28 -> V_243 -> V_244 ) ) {
struct V_245 * V_246 = F_107 ( V_28 -> V_243 ) ;
if ( V_246 -> V_204 )
V_246 -> V_204 ( V_28 ) ;
F_108 ( V_28 -> V_243 -> V_244 ) ;
}
F_109 ( V_28 ) ;
}
static void F_110 ( struct V_74 * V_29 , unsigned int V_46 ,
...
void F_111 ( struct V_74 * V_29 , unsigned int V_46 ,
unsigned int V_45 , T_1 V_23 , int V_204 )
{
struct V_27 * V_5 = F_19 ( V_29 ) ;
if ( strncmp ( V_239 , L_41 , 4 ) == 0 )
...
static void F_115 ( struct V_27 * V_5 )
{
struct V_12 * V_13 ;
F_116 (sdev, shost) {
if ( V_13 -> V_47 == V_255 )
...
static struct V_1 * F_117 ( struct V_27 * V_5 )
{
struct V_1 * V_2 ;
unsigned long V_75 ;
...
static void F_122 ( struct V_27 * V_5 )
{
if ( V_5 -> V_65 -> V_258 ) {
...
F_113 ( V_5 , V_248 , V_248 ,
V_248 , 0 ) ;
}
}
static void F_123 ( void * V_262 , T_3 V_263 )
{
...
struct V_12 * F_127 ( struct V_27 * V_5 )
{
...
if ( ! F_96 ( V_5 ) )
goto V_37;
V_22 = F_51 ( & V_5 -> V_238 , 0 , V_5 -> V_247 ) ;
if ( ! V_22 )
goto V_37;
V_13 = F_18 ( V_22 , 0 , NULL ) ;
if ( V_13 )
...
{
F_59 ( V_13 -> V_45 != V_13 -> V_42 -> V_247 ) ;
F_34 ( V_13 ) ;
}
