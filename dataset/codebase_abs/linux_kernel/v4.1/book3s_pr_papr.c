...
static int F_23 ( struct V_1 * V_2 , T_2 V_65 )
{
long V_62 = F_24 ( V_2 , V_65 ) ;
F_11 ( V_2 , 3 , V_62 ) ;
return V_23 ;
}
int F_25 ( struct V_1 * V_2 , unsigned long V_65 )
{
int V_62 , V_66 ;
if ( V_65 <= V_67 &&
! F_26 ( V_65 / 4 , V_2 -> V_13 -> V_14 . V_68 ) )
return V_64 ;
switch ( V_65 ) {
case V_69 :
return F_3 ( V_2 ) ;
...
case V_87 :
if ( F_31 ( V_2 ) )
return F_23 ( V_2 , V_65 ) ;
break;
case V_88 :
if ( F_32 ( & V_2 -> V_13 -> V_14 . V_89 ) )
break;
V_66 = F_33 ( & V_2 -> V_13 -> V_90 ) ;
V_62 = F_34 ( V_2 ) ;
F_35 ( & V_2 -> V_13 -> V_90 , V_66 ) ;
if ( V_62 )
break;
F_11 ( V_2 , 3 , 0 ) ;
return V_23 ;
...
int V_11 ;
unsigned int V_91 ;
for ( V_11 = 0 ; V_92 [ V_11 ] ; ++ V_11 ) {
V_91 = V_92 [ V_11 ] ;
F_39 ( ! F_36 ( V_91 ) ) ;
F_40 ( V_91 / 4 , V_13 -> V_14 . V_68 ) ;
}
}
