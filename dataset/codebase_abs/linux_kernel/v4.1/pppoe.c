...
static int F_55 ( struct V_3 * V_3 , struct V_83 * V_37 )
{
struct V_37 * V_38 ;
V_38 = F_56 ( V_3 , V_84 , V_85 , & V_86 ) ;
if ( ! V_38 )
return - V_87 ;
F_57 ( V_37 , V_38 ) ;
V_37 -> V_88 = V_89 ;
...
static int F_62 ( struct V_83 * V_37 , struct V_103 * V_104 ,
int V_105 , int V_106 )
{
struct V_37 * V_38 = V_37 -> V_38 ;
...
if ( error < 0 )
goto V_112;
V_26 -> V_60 . V_114 = ( sizeof( struct V_69 ) +
V_33 -> V_115 ) ;
V_26 -> V_60 . V_116 = V_33 -> V_116 - sizeof( struct V_69 ) - 2 ;
V_26 -> V_60 . V_117 = V_38 ;
V_26 -> V_60 . V_90 = & V_118 ;
...
static int F_66 ( struct V_83 * V_37 , struct V_103 * V_120 ,
int * V_121 , int V_122 )
{
...
sizeof( struct V_5 ) ) ;
memcpy ( V_120 , & V_31 , V_71 ) ;
* V_121 = V_71 ;
return 0 ;
}
static int F_67 ( struct V_83 * V_37 , unsigned int V_125 ,
unsigned long V_126 )
{
struct V_37 * V_38 = V_37 -> V_38 ;
struct V_18 * V_26 = F_34 ( V_38 ) ;
...
break;
V_128 = - V_131 ;
if ( F_69 ( V_127 , ( int V_133 * ) V_126 ) )
break;
if ( V_127 < ( V_26 -> V_39 -> V_116
- sizeof( struct V_69 )
- V_132 ) )
V_128 = 0 ;
else
...
break;
V_128 = - V_107 ;
if ( V_26 -> V_62 . V_123 != V_124 ||
V_26 -> V_62 . V_108 != V_98 )
break;
...
static int F_71 ( struct V_83 * V_37 , struct V_140 * V_141 ,
T_2 V_142 )
{
struct V_54 * V_55 ;
struct V_37 * V_38 = V_37 -> V_38 ;
...
char * V_144 ;
F_26 ( V_38 ) ;
if ( F_59 ( V_38 , V_99 ) || ! ( V_38 -> V_40 & V_41 ) ) {
error = - V_137 ;
goto V_109;
}
V_143 . V_145 = 1 ;
V_143 . type = 1 ;
V_143 . V_81 = 0 ;
V_143 . V_1 = V_26 -> V_119 ;
V_33 = V_26 -> V_39 ;
error = - V_146 ;
if ( V_142 > ( V_33 -> V_116 + V_33 -> V_115 ) )
goto V_109;
V_55 = F_72 ( V_38 , V_142 + V_33 -> V_115 + 32 ,
0 , V_85 ) ;
if ( ! V_55 ) {
error = - V_87 ;
goto V_109;
}
F_73 ( V_55 , V_33 -> V_115 ) ;
F_74 ( V_55 ) ;
V_55 -> V_33 = V_33 ;
V_55 -> V_147 = V_38 -> V_148 ;
V_55 -> V_149 = F_75 ( V_150 ) ;
V_70 = (struct V_69 * ) F_76 ( V_55 , V_142 + sizeof( struct V_69 ) ) ;
V_144 = ( char * ) & V_70 -> V_151 [ 0 ] ;
error = F_77 ( V_144 , V_141 , V_142 ) ;
if ( error < 0 ) {
F_39 ( V_55 ) ;
goto V_109;
}
error = V_142 ;
F_78 ( V_55 , V_33 , V_150 ,
V_26 -> V_23 . V_8 , NULL , V_142 ) ;
memcpy ( V_70 , & V_143 , sizeof( struct V_69 ) ) ;
V_70 -> V_75 = F_79 ( V_142 ) ;
F_80 ( V_55 ) ;
V_109:
F_29 ( V_38 ) ;
return error ;
...
if ( ! V_33 )
goto abort;
if ( F_81 ( V_55 , sizeof( * V_70 ) + V_33 -> V_115 ) )
goto abort;
...
static int F_83 ( struct V_153 * V_60 , struct V_54 * V_55 )
{
struct V_37 * V_38 = (struct V_37 * ) V_60 -> V_117 ;
return F_37 ( V_38 , V_55 ) ;
}
static int F_84 ( struct V_83 * V_37 , struct V_140 * V_141 ,
T_2 V_142 , int V_106 )
{
struct V_37 * V_38 = V_37 -> V_38 ;
struct V_54 * V_55 ;
...
V_55 = F_85 ( V_38 , V_106 & ~ V_155 ,
V_106 & V_155 , & error ) ;
if ( error < 0 )
goto V_109;
if ( V_55 ) {
V_142 = F_86 ( T_2 , V_142 , V_55 -> V_71 ) ;
error = F_87 ( V_55 , 0 , V_141 , V_142 ) ;
if ( error == 0 ) {
F_88 ( V_55 ) ;
return V_142 ;
}
...
static int F_89 ( struct V_156 * V_157 , void * V_158 )
{
struct V_18 * V_26 ;
char * V_159 ;
if ( V_158 == V_160 ) {
...
static inline struct V_18 * F_92 ( struct V_2 * V_19 , T_3 V_161 )
{
struct V_18 * V_26 ;
int V_11 ;
for ( V_11 = 0 ; V_11 < V_36 ; V_11 ++ ) {
...
static void * F_93 ( struct V_156 * V_157 , T_3 * V_161 )
__acquires( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_94 ( V_157 ) ) ;
T_3 V_162 = * V_161 ;
F_13 ( & V_19 -> V_29 ) ;
return V_162 ? F_92 ( V_19 , -- V_162 ) : V_160 ;
}
static void * F_95 ( struct V_156 * V_157 , void * V_158 , T_3 * V_161 )
{
struct V_2 * V_19 = F_2 ( F_94 ( V_157 ) ) ;
struct V_18 * V_26 ;
++ * V_161 ;
...
static void F_96 ( struct V_156 * V_157 , void * V_158 )
__releases( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_94 ( V_157 ) ) ;
F_16 ( & V_19 -> V_29 ) ;
}
static int F_97 ( struct V_163 * V_163 , struct V_164 * V_164 )
{
return F_98 ( V_163 , V_164 , & V_165 ,
sizeof( struct V_166 ) ) ;
}
...
struct V_167 * V_168 ;
F_100 ( & V_19 -> V_29 ) ;
V_168 = F_101 ( L_3 , V_169 , V_3 -> V_170 , & V_171 ) ;
#ifdef F_102
if ( ! V_168 )
return - V_87 ;
#endif
