...
if ( V_241 )
return V_241 ;
V_2 -> V_46 = F_87 ( V_236 , 2 ) ;
V_7 -> V_10 = F_87 ( V_236 , 3 ) ;
F_27 ( V_2 -> V_68 ,
L_15 ,
V_2 -> V_243 , V_2 -> V_46 , V_7 -> V_10 ) ;
...
V_50 = & V_2 -> V_254 [ 2 ] ;
if ( V_4 -> V_184 ) {
V_241 = F_92 ( V_2 , V_50 , NULL , V_275 ) ;
if ( V_241 )
return V_241 ;
} else {
V_50 -> type = V_274 ;
...
static int F_93 ( struct V_236 * V_2 ,
const struct V_276 * V_237 )
{
return F_94 ( V_2 , & V_277 ,
V_237 -> V_278 ) ;
}
