...
static struct V_1 * F_64 ( struct V_124 * V_125 )
{
struct V_1 * V_4 = NULL ;
struct V_126 * V_127 = F_65 ( V_125 ) ;
struct V_2 * V_2 = F_66 ( V_125 ) ;
...
static struct V_1 * F_67 ( struct V_124 * V_125 , struct V_1 * V_4 )
{
struct V_126 * V_127 = F_65 ( V_125 ) ;
struct V_2 * V_2 = F_66 ( V_125 ) ;
F_68 (fl) {
...
static struct V_1 * F_69 ( struct V_124 * V_125 , T_5 V_131 )
{
struct V_1 * V_4 = F_64 ( V_125 ) ;
if ( V_4 )
while ( V_131 && ( V_4 = F_67 ( V_125 , V_4 ) ) != NULL )
-- V_131 ;
return V_131 ? NULL : V_4 ;
}
static void * F_70 ( struct V_124 * V_125 , T_5 * V_131 )
__acquires( T_6 )
{
F_5 () ;
return * V_131 ? F_69 ( V_125 , * V_131 - 1 ) : V_132 ;
}
static void * F_71 ( struct V_124 * V_125 , void * V_133 , T_5 * V_131 )
{
struct V_1 * V_4 ;
if ( V_133 == V_132 )
V_4 = F_64 ( V_125 ) ;
else
V_4 = F_67 ( V_125 , V_133 ) ;
++ * V_131 ;
return V_4 ;
}
static void F_72 ( struct V_124 * V_125 , void * V_133 )
__releases( T_6 )
{
F_7 () ;
}
static int F_73 ( struct V_124 * V_125 , void * V_133 )
{
struct V_126 * V_127 = F_65 ( V_125 ) ;
if ( V_133 == V_132 ) {
F_74 ( V_125 , L_2 ) ;
...
V_4 -> V_7 ,
( ( V_4 -> V_7 == V_8 ) ?
F_77 ( V_4 -> V_9 . V_10 , V_127 -> V_134 ) :
( ( V_4 -> V_7 == V_86 ) ?
F_78 ( F_79 ( V_125 ) , V_4 -> V_9 . V_87 ) :
0 ) ) ,
F_23 ( & V_4 -> V_6 ) ,
V_4 -> V_17 / V_53 ,
...
static int F_80 ( struct V_135 * V_135 , struct V_136 * V_136 )
{
struct V_124 * V_125 ;
struct V_126 * V_127 ;
int V_63 ;
V_63 = F_81 ( V_135 , V_136 , & V_137 ,
sizeof( struct V_126 ) ) ;
if ( ! V_63 ) {
V_125 = V_136 -> V_138 ;
V_127 = F_65 ( V_125 ) ;
F_82 () ;
V_127 -> V_134 = F_83 ( F_84 ( V_84 ) ) ;
F_85 () ;
}
return V_63 ;
}
static int F_86 ( struct V_135 * V_135 , struct V_136 * V_136 )
{
struct V_124 * V_125 = V_136 -> V_138 ;
struct V_126 * V_127 = F_65 ( V_125 ) ;
F_87 ( V_127 -> V_134 ) ;
return F_88 ( V_135 , V_136 ) ;
}
static int T_7 F_89 ( struct V_2 * V_2 )
{
if ( ! F_90 ( L_4 , V_139 , V_2 -> V_140 ,
& V_141 ) )
return - V_66 ;
return 0 ;
}
