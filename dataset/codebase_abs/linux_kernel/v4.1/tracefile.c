...
int F_95 ( void V_110 * V_125 , int V_126 )
{
char V_84 [ 32 ] ;
int V_44 ;
V_44 = F_79 ( V_84 , sizeof( V_84 ) , V_125 , V_126 ) ;
if ( V_44 < 0 )
return V_44 ;
return F_92 ( F_89 ( V_84 , NULL , 0 ) ) ;
}
int F_96 ( void )
{
int V_14 ;
...
V_111 = 0 ;
else if ( V_111 > F_101 ( F_102 ( V_99 ) ) )
V_111 = F_101 ( F_102 ( V_99 ) ) ;
V_100 = F_72 ( V_7 -> V_6 ) ;
V_44 = F_73 ( V_99 , ( V_109 const char V_110 * ) V_100 ,
V_7 -> V_21 , & V_111 ) ;
F_74 ( V_7 -> V_6 ) ;
...
F_106 ( & V_139 , V_145 ) ;
F_107 ( & V_31 -> V_33 , & V_139 ) ;
F_108 ( V_146 ) ;
F_109 ( F_45 ( 1 ) ) ;
F_110 ( & V_31 -> V_33 , & V_139 ) ;
}
F_100 ( & V_31 -> V_147 ) ;
return 0 ;
}
