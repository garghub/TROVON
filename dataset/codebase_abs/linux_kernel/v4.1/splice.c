...
T_2 V_62 , V_77 ;
int V_24 ;
if ( F_49 ( V_55 -> V_57 -> V_74 ) )
return F_50 ( V_55 , V_56 , V_2 , V_39 , V_10 ) ;
...
static T_1 F_53 ( struct V_54 * V_54 , const struct V_78 * V_79 ,
...
V_81 = F_54 () ;
F_55 ( F_56 () ) ;
V_83 = F_57 ( V_54 , ( const struct V_78 V_84 * ) V_79 , V_80 , & V_82 ) ;
F_55 ( V_81 ) ;
return V_83 ;
}
T_1 F_58 ( struct V_54 * V_54 , const char * V_4 , T_3 V_85 ,
T_2 V_82 )
{
T_5 V_81 ;
T_1 V_83 ;
V_81 = F_54 () ;
F_55 ( F_56 () ) ;
V_83 = F_59 ( V_54 , ( V_86 const char V_84 * ) V_4 , V_85 , & V_82 ) ;
F_55 ( V_81 ) ;
return V_83 ;
}
T_1 F_50 ( struct V_54 * V_55 , T_2 * V_56 ,
struct V_1 * V_2 , T_3 V_39 ,
unsigned int V_10 )
{
unsigned int V_23 ;
...
V_79 [ V_49 ] . V_92 = ( void V_84 * ) F_61 ( V_5 ) ;
V_79 [ V_49 ] . V_93 = V_69 ;
V_21 . V_36 [ V_49 ] = V_5 ;
V_21 . V_23 ++ ;
V_39 -= V_69 ;
...
V_83 = F_53 ( V_55 , V_79 , V_21 . V_23 , * V_56 ) ;
if ( V_83 < 0 ) {
error = V_83 ;
goto V_12;
}
...
static int F_67 ( struct V_1 * V_2 , struct V_94 * V_95 )
{
while ( ! V_2 -> V_31 ) {
if ( ! V_2 -> V_113 )
return 0 ;
...
static void F_69 ( struct V_1 * V_2 , struct V_94 * V_95 )
{
if ( V_95 -> V_112 )
F_65 ( V_2 ) ;
}
T_1 F_70 ( struct V_1 * V_2 , struct V_94 * V_95 ,
T_6 * V_107 )
{
int V_24 ;
F_68 ( V_95 ) ;
...
V_24 = F_67 ( V_2 , V_95 ) ;
if ( V_24 > 0 )
V_24 = F_66 ( V_2 , V_95 , V_107 ) ;
} while ( V_24 > 0 );
F_69 ( V_2 , V_95 ) ;
return V_95 -> V_110 ? V_95 -> V_110 : V_24 ;
}
T_1 F_71 ( struct V_1 * V_2 , struct V_54 * V_114 ,
...
F_22 ( V_2 ) ;
V_24 = F_70 ( V_2 , & V_95 , V_107 ) ;
F_27 ( V_2 ) ;
return V_24 ;
}
T_1
F_72 ( struct V_1 * V_2 , struct V_54 * V_114 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
struct V_94 V_95 = {
. V_103 = V_39 ,
...
int V_115 = V_2 -> V_32 ;
struct V_116 * V_117 = F_73 ( V_115 , sizeof( struct V_116 ) ,
V_8 ) ;
T_1 V_24 ;
if ( F_41 ( ! V_117 ) )
return - V_53 ;
...
F_32 ( V_117 ) ;
V_115 = V_2 -> V_32 ;
V_117 = F_73 ( V_115 , sizeof( struct V_116 ) ,
V_8 ) ;
if ( ! V_117 ) {
V_24 = - V_53 ;
break;
...
F_74 ( & V_119 , V_126 | V_127 , V_117 , V_120 ,
V_95 . V_103 - V_77 ) ;
V_24 = F_75 ( V_114 , & V_119 , & V_95 . V_82 ) ;
if ( V_24 <= 0 )
break;
V_95 . V_110 += V_24 ;
V_95 . V_103 -= V_24 ;
...
static int F_76 ( struct V_1 * V_2 , struct V_3 * V_4 ,
struct V_94 * V_95 )
{
int V_24 ;
void * V_128 ;
T_2 V_129 = V_95 -> V_82 ;
V_128 = F_77 ( V_4 -> V_5 ) ;
V_24 = F_78 ( V_95 -> V_96 . V_54 , V_128 + V_4 -> V_37 , V_95 -> V_39 , & V_129 ) ;
F_79 ( V_4 -> V_5 ) ;
return V_24 ;
}
...
{
T_1 V_24 ;
V_24 = F_71 ( V_2 , V_114 , V_56 , V_39 , V_10 , F_76 ) ;
if ( V_24 > 0 )
* V_56 += V_24 ;
return V_24 ;
}
T_1 F_81 ( struct V_1 * V_2 , struct V_54 * V_114 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
return F_71 ( V_2 , V_114 , V_56 , V_39 , V_10 , F_63 ) ;
}
static long F_82 ( struct V_1 * V_2 , struct V_54 * V_114 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
T_1 (* F_83)( struct V_1 * , struct V_54 * ,
T_2 * , T_3 , unsigned int );
if ( V_114 -> V_98 -> F_83 )
F_83 = V_114 -> V_98 -> F_83 ;
else
F_83 = F_80 ;
return F_83 ( V_2 , V_114 , V_56 , V_39 , V_10 ) ;
}
static long F_84 ( struct V_54 * V_55 , T_2 * V_56 ,
struct V_1 * V_2 , T_3 V_39 ,
unsigned int V_10 )
{
T_1 (* F_85)( struct V_54 * , T_2 * ,
struct V_1 * , T_3 , unsigned int );
int V_24 ;
if ( F_41 ( ! ( V_55 -> V_130 & V_131 ) ) )
return - V_132 ;
V_24 = F_86 ( V_133 , V_55 , V_56 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
if ( V_55 -> V_98 -> F_85 )
F_85 = V_55 -> V_98 -> F_85 ;
...
F_85 = F_50 ;
return F_85 ( V_55 , V_56 , V_2 , V_39 , V_10 ) ;
}
T_1 F_87 ( struct V_54 * V_55 , struct V_94 * V_95 ,
T_7 * V_107 )
{
struct V_1 * V_2 ;
long V_24 , V_134 ;
...
T_3 V_39 ;
int V_49 , V_10 , V_97 ;
V_135 = F_88 ( V_55 ) -> V_135 ;
if ( F_41 ( ! F_89 ( V_135 ) && ! F_90 ( V_135 ) ) )
return - V_100 ;
V_2 = V_29 -> V_136 ;
if ( F_41 ( ! V_2 ) ) {
V_2 = F_91 () ;
...
V_10 = V_95 -> V_10 ;
V_95 -> V_10 &= ~ V_44 ;
V_97 = V_95 -> V_10 & V_101 ;
while ( V_39 ) {
T_3 V_137 ;
T_2 V_82 = V_95 -> V_82 , V_76 = V_82 ;
V_24 = F_84 ( V_55 , & V_82 , V_2 , V_39 , V_10 ) ;
if ( F_41 ( V_24 <= 0 ) )
goto V_138;
V_137 = V_24 ;
V_95 -> V_103 = V_137 ;
...
{
struct V_54 * V_54 = V_95 -> V_96 . V_54 ;
return F_82 ( V_2 , V_54 , V_95 -> V_139 , V_95 -> V_103 ,
V_95 -> V_10 ) ;
}
long F_93 ( struct V_54 * V_55 , T_2 * V_56 , struct V_54 * V_114 ,
...
return - V_100 ;
V_24 = F_86 ( V_127 , V_114 , V_139 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
V_24 = F_87 ( V_55 , & V_95 , F_92 ) ;
if ( V_24 > 0 )
* V_56 = V_95 . V_82 ;
return V_24 ;
}
static long F_94 ( struct V_54 * V_55 , T_2 V_84 * V_143 ,
...
if ( V_145 == V_146 )
return - V_100 ;
return F_96 ( V_145 , V_146 , V_39 , V_10 ) ;
}
if ( V_145 ) {
if ( V_143 )
return - V_147 ;
...
if ( F_41 ( V_114 -> V_141 & V_142 ) )
return - V_100 ;
V_24 = F_86 ( V_127 , V_114 , & V_37 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
F_98 ( V_114 ) ;
V_24 = F_82 ( V_145 , V_114 , & V_37 , V_39 , V_10 ) ;
F_99 ( V_114 ) ;
if ( ! V_144 )
V_114 -> V_150 = V_37 ;
else if ( F_100 ( V_144 , & V_37 , sizeof( T_2 ) ) )
V_24 = - V_149 ;
return V_24 ;
}
if ( V_146 ) {
...
if ( ! ( V_55 -> V_130 & V_151 ) )
return - V_100 ;
if ( F_97 ( & V_37 , V_143 , sizeof( T_2 ) ) )
return - V_149 ;
} else {
V_37 = V_55 -> V_150 ;
}
V_24 = F_84 ( V_55 , & V_37 , V_146 , V_39 , V_10 ) ;
if ( ! V_143 )
V_55 -> V_150 = V_37 ;
else if ( F_100 ( V_143 , & V_37 , sizeof( T_2 ) ) )
V_24 = - V_149 ;
return V_24 ;
}
return - V_100 ;
}
static int F_101 ( const struct V_78 V_84 * V_152 ,
...
int V_49 ;
error = - V_149 ;
if ( F_97 ( & V_158 , V_152 , sizeof( V_158 ) ) )
break;
V_159 = V_158 . V_92 ;
V_39 = V_158 . V_93 ;
error = 0 ;
...
if ( V_157 > V_155 - V_32 )
V_157 = V_155 - V_32 ;
error = F_103 ( ( unsigned long ) V_159 , V_157 ,
0 , & V_36 [ V_32 ] ) ;
if ( F_41 ( error <= 0 ) )
break;
...
struct V_94 * V_95 )
{
int V_120 = F_105 ( V_4 -> V_5 , V_4 -> V_37 , V_95 -> V_39 , V_95 -> V_96 . V_128 ) ;
return V_120 == V_95 -> V_39 ? V_120 : - V_149 ;
}
static long F_106 ( struct V_54 * V_54 , const struct V_78 V_84 * V_164 ,
...
if ( ! V_2 )
return - V_132 ;
V_24 = F_107 ( V_133 , V_164 , V_165 ,
F_108 ( V_166 ) , & V_152 , & V_168 ) ;
if ( V_24 < 0 )
return V_24 ;
V_95 . V_103 = F_109 ( & V_168 ) ;
V_95 . V_39 = 0 ;
V_95 . V_10 = V_10 ;
...
if ( V_95 . V_103 ) {
F_22 ( V_2 ) ;
V_24 = F_70 ( V_2 , & V_95 , F_104 ) ;
F_27 ( V_2 ) ;
}
F_32 ( V_152 ) ;
return V_24 ;
}
static long F_110 ( struct V_54 * V_54 , const struct V_78 V_84 * V_152 ,
unsigned long V_165 , unsigned int V_10 )
{
struct V_1 * V_2 ;
struct V_5 * V_36 [ V_51 ] ;
...
if ( F_29 ( V_2 , & V_21 ) )
return - V_53 ;
V_21 . V_23 = F_101 ( V_152 , V_165 , V_21 . V_36 ,
V_21 . V_38 , false ,
V_21 . V_50 ) ;
if ( V_21 . V_23 <= 0 )
V_24 = V_21 . V_23 ;
...
static int F_96 ( struct V_1 * V_145 ,
struct V_1 * V_146 ,
T_3 V_39 , unsigned int V_10 )
{
...
bool V_173 = false ;
V_174:
V_24 = F_111 ( V_145 , V_10 ) ;
if ( V_24 )
return V_24 ;
V_24 = F_112 ( V_146 , V_10 ) ;
if ( V_24 )
return V_24 ;
F_113 ( V_145 , V_146 ) ;
do {
...
static int F_114 ( struct V_1 * V_145 ,
struct V_1 * V_146 ,
T_3 V_39 , unsigned int V_10 )
{
struct V_3 * V_170 , * V_171 ;
...
static long F_115 ( struct V_54 * V_55 , struct V_54 * V_114 , T_3 V_39 ,
unsigned int V_10 )
{
struct V_1 * V_145 = F_95 ( V_55 ) ;
struct V_1 * V_146 = F_95 ( V_114 ) ;
int V_24 = - V_100 ;
...
V_24 = F_112 ( V_146 , V_10 ) ;
if ( ! V_24 )
V_24 = F_114 ( V_145 , V_146 , V_39 , V_10 ) ;
}
}
return V_24 ;
}
