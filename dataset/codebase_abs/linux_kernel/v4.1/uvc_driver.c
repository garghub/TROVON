...
static int F_97 ( struct V_52 * V_53 , T_7 V_245 )
{
struct V_34 * V_35 = F_96 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_246 , L_113 ,
...
static int F_102 ( struct V_52 * V_53 , int V_249 )
{
struct V_34 * V_35 = F_96 ( V_53 ) ;
struct V_42 * V_43 ;
int V_116 = 0 ;
...
F_98 ( & V_35 -> V_231 ) ;
if ( V_35 -> V_248 )
V_116 = F_104 ( V_35 , V_250 ) ;
F_100 ( & V_35 -> V_231 ) ;
return V_116 ;
}
F_10 (stream, &dev->streams, list) {
if ( V_43 -> V_53 == V_53 ) {
V_116 = F_105 ( V_43 , V_249 ) ;
if ( V_116 < 0 )
F_106 ( & V_43 -> V_212 ,
...
static int F_109 ( char * V_50 , struct V_251 * V_252 )
{
if ( V_253 == V_254 )
...
static int F_110 ( const char * V_255 , struct V_251 * V_252 )
{
if ( strncasecmp ( V_255 , L_120 , strlen ( L_120 ) ) == 0 )
V_255 += strlen ( L_120 ) ;
if ( strcasecmp ( V_255 , L_121 ) == 0 )
V_253 = V_254 ;
else if ( strcasecmp ( V_255 , L_122 ) == 0 )
V_253 = V_256 ;
else
return - V_69 ;
return 0 ;
