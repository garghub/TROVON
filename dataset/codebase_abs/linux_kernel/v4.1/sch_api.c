...
struct V_271 * V_272 )
{
T_9 V_273 = F_169 ( V_97 ) ;
int V_28 ;
for (; V_270 ; V_270 = F_170 ( V_270 -> V_9 ) ) {
if ( V_270 -> V_273 != V_273 &&
V_270 -> V_273 != F_171 ( V_274 ) )
continue;
V_28 = V_270 -> V_275 ( V_97 , V_270 , V_272 ) ;
if ( V_28 >= 0 ) {
#ifdef F_172
if ( V_28 != V_276 && V_97 -> V_277 )
V_97 -> V_277 = F_173 ( V_97 -> V_277 , 0 ) ;
#endif
return V_28 ;
}
}
...
int F_174 ( struct V_96 * V_97 , const struct V_269 * V_270 ,
struct V_271 * V_272 )
{
int V_28 = 0 ;
#ifdef F_172
...
V_97 -> V_277 = F_173 ( V_97 -> V_277 , V_280 ) ;
goto V_279;
}
#endif
return V_28 ;
}
bool F_178 ( struct V_269 * V_270 , bool V_284 )
{
if ( V_270 -> V_34 -> V_186 ( V_270 , V_284 ) ) {
...
void F_180 ( struct V_269 T_10 * * V_285 )
{
struct V_269 * V_270 ;
while ( ( V_270 = F_127 ( * V_285 ) ) != NULL ) {
F_181 ( * V_285 , V_270 -> V_9 ) ;
F_178 ( V_270 , true ) ;
}
}
static int F_182 ( struct V_286 * V_219 , void * V_287 )
{
struct V_288 V_289 ;
F_183 ( V_113 , & V_289 ) ;
F_184 ( V_219 , L_6 ,
( T_2 ) V_290 , ( T_2 ) F_185 ( 1 ) ,
1000000 ,
( T_2 ) V_291 / ( T_2 ) F_186 ( F_187 ( V_289 ) ) ) ;
return 0 ;
}
static int F_188 ( struct V_292 * V_292 , struct V_293 * V_293 )
{
return F_189 ( V_293 , F_182 , NULL ) ;
}
static int T_11 F_190 ( struct V_147 * V_147 )
{
struct V_294 * V_295 ;
V_295 = F_191 ( L_7 , 0 , V_147 -> V_296 , & V_297 ) ;
if ( V_295 == NULL )
return - V_91 ;
return 0 ;
}
static void T_12 F_192 ( struct V_147 * V_147 )
{
F_193 ( L_7 , V_147 -> V_296 ) ;
}
static int T_11 F_190 ( struct V_147 * V_147 )
{
return 0 ;
...
F_1 ( & V_302 ) ;
F_1 ( & V_303 ) ;
F_197 ( V_304 , V_243 , F_137 , NULL , NULL ) ;
F_197 ( V_304 , V_210 , F_131 , NULL , NULL ) ;
F_197 ( V_304 , V_204 , F_131 , F_157 , NULL ) ;
F_197 ( V_304 , V_261 , F_160 , NULL , NULL ) ;
F_197 ( V_304 , V_262 , F_160 , NULL , NULL ) ;
F_197 ( V_304 , V_259 , F_160 , F_166 , NULL ) ;
return 0 ;
}
