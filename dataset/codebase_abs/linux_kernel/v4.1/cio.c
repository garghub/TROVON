...
int F_41 ( struct V_7 * V_8 , struct V_68 V_21 )
{
char V_69 [ 15 ] ;
int V_32 ;
int V_70 ;
...
static int F_59 ( struct V_68 V_21 , void * V_91 )
{
struct V_26 V_26 ;
if ( F_29 ( V_21 , & V_26 ) != 0 )
return - V_71 ;
...
struct V_78 V_99 ;
if ( F_78 ( & V_99 ) ) {
F_32 ( V_99 . V_21 , F_45 ( & V_81 ) ) ;
if ( F_73 ( & V_99 . V_21 , & V_21 ) )
return 0 ;
}
F_79 ( 100 ) ;
}
...
static int F_82 ( struct V_68 V_21 , struct V_26 * V_101 )
{
int V_102 ;
V_100 = 0 ;
V_103 = F_81 ;
...
static int F_84 ( struct V_68 V_21 , void * V_91 )
{
struct V_26 V_26 ;
if ( F_82 ( V_21 , & V_26 ) )
return - V_71 ;
...
struct V_105 V_105 ;
struct V_106 * V_106 ;
V_106 = (struct V_106 * ) & V_107 . V_108 ;
if ( ! V_106 -> V_109 )
return;
while ( F_86 ( & V_105 ) == 0 ) {
if ( V_105 . V_110 && V_105 . V_111 == V_112 )
F_87 ( & V_113 ) ;
}
}
...
static int F_102 ( struct V_68 V_21 , void * V_91 )
{
struct V_26 V_26 ;
struct V_123 * V_124 = V_91 ;
if ( F_82 ( V_21 , & V_26 ) )
return - V_71 ;
if ( ( V_26 . V_53 . V_73 == V_74 ) && V_26 . V_53 . V_92 &&
