...
V_34 -> V_99 = F_43 ( (struct V_92 * ) V_93 ) ;
V_34 -> V_37 = NULL ;
V_34 -> V_38 = 0 ;
...
T_1 F_44 ( struct V_33 * V_16 , struct V_101 * V_102 )
{
T_1 V_32 = V_6 ;
T_3 V_103 = 0 ;
struct V_92 * V_104 ;
...
memcpy ( V_104 , & V_102 -> V_118 , F_43 ( & V_102 -> V_118 ) ) ;
...
V_104 -> V_136 = F_45 ( V_16 , & V_102 -> V_118 . V_137 [ 0 ] , & V_104 -> V_137 [ 0 ] , V_102 -> V_118 . V_136 ) ;
V_106 -> V_142 = 0 ;
if ( V_112 -> V_143 ) {
T_2 V_144 ;
V_144 = F_46 ( V_16 , & V_102 -> V_118 . V_137 [ 0 ] , & V_104 -> V_137 [ 0 ] , V_102 -> V_118 . V_136 , V_104 -> V_136 ) ;
...
F_47 ( V_16 , & V_102 -> V_118 . V_137 [ 0 ] , & V_104 -> V_137 [ 0 ] ,
V_102 -> V_118 . V_136 , & V_104 -> V_136 ) ;
}
}
V_124 -> V_151 = F_48 ( V_102 -> V_118 . V_137 , V_102 -> V_118 . V_136 ) ;
if ( V_124 -> V_151 == V_152 )
V_16 -> V_17 . V_153 = 0 ;
else
V_16 -> V_17 . V_153 = V_16 -> V_19 . V_153 ;
F_24 ( L_12 , V_49 , V_16 -> V_17 . V_153 ) ;
V_34 -> V_99 = F_43 ( V_104 ) ;
F_42 ( & V_34 -> V_13 ) ;
V_34 -> V_21 = V_35 ;
...
T_1 F_49 ( struct V_33 * V_16 , T_2 V_154 , bool V_155 )
{
...
T_1 F_51 ( struct V_33 * V_16 , enum V_116 V_161 )
{
struct V_9 * V_66 ;
struct V_162 * V_163 ;
struct V_1 * V_2 = & V_16 -> V_43 ;
...
T_1 F_52 ( struct V_33 * V_16 , T_1 * V_166 , T_1 V_167 )
{
struct V_9 * V_66 ;
struct V_168 * V_169 ;
struct V_1 * V_2 = & V_16 -> V_43 ;
...
F_53 ( V_169 -> V_175 , V_173 -> V_176 ) ;
if ( F_30 ( V_70 , V_127 ) )
V_169 -> V_177 = ( unsigned char ) V_109 -> V_147 ;
else
F_54 ( V_109 , V_173 , V_169 -> V_177 , false ) ;
if ( V_167 )
...
T_1 F_55 ( struct V_33 * V_16 , T_1 * V_166 , T_1 V_184 , T_1 V_155 )
{
struct V_9 * V_66 ;
struct V_168 * V_169 ;
struct V_1 * V_2 = & V_16 -> V_43 ;
...
T_1 F_57 ( struct V_33 * V_16 , T_1 V_187 , T_1 * V_175 )
{
struct V_1 * V_2 = & V_16 -> V_43 ;
struct V_9 * V_66 ;
struct V_188 * V_189 ;
...
T_1 F_59 ( struct V_33 * V_16 , T_1 V_193 , T_1 V_155 )
{
struct V_9 * V_194 ;
struct V_195 * V_196 ;
struct V_1 * V_2 = & V_16 -> V_43 ;
...
if ( V_160 != F_61 ( V_16 , ( unsigned char * ) V_196 ) )
V_32 = V_31 ;
F_17 ( V_196 ) ;
}
if ( V_32 == V_6 )
...
static void F_65 ( struct V_33 * V_16 , T_1 * V_41 , int V_210 )
{
struct V_69 * V_70 ;
...
static void F_70 ( struct V_33 * V_16 , T_1 V_212 )
{
...
static void F_72 ( struct V_33 * V_16 , T_4 V_226 )
{
F_71 ( V_16 , V_227 , ( T_1 * ) ( & V_226 ) ) ;
}
T_1 F_73 ( struct V_33 * V_16 , T_4 V_226 )
{
struct V_9 * V_66 ;
struct V_23 * V_24 ;
struct V_1 * V_2 = & V_16 -> V_43 ;
...
static void F_74 ( struct V_33 * V_16 , T_1 V_229 )
{
F_71 ( V_16 , V_230 , ( T_1 * ) ( & V_229 ) ) ;
}
T_1 F_75 ( struct V_33 * V_16 , T_1 V_229 , T_1 V_155 )
{
struct V_9 * V_66 ;
struct V_23 * V_24 ;
struct V_1 * V_2 = & V_16 -> V_43 ;
...
switch ( V_247 -> V_26 ) {
case V_191 :
F_65 ( V_16 , V_247 -> V_41 , V_247 -> V_192 ) ;
break;
case V_27 :
F_86 ( V_16 ) ;
break;
case V_225 :
F_70 ( V_16 , ( T_1 ) V_247 -> V_192 ) ;
break;
case V_228 :
F_72 ( V_16 , V_247 -> V_192 ) ;
break;
case V_233 :
F_74 ( V_16 , V_247 -> V_192 ) ;
break;
#ifdef F_66
case V_246 :
F_78 ( V_16 ) ;
...
if ( ! V_166 ) {
V_166 = F_95 ( & V_16 -> V_239 , V_102 -> V_140 ) ;
if ( V_166 == NULL ) {
F_22 ( V_45 , V_58 , ( L_19 ) ) ;
goto V_252;
}
...
if ( V_249 == NULL ) {
V_249 = F_98 ( & V_70 -> V_253 ) ;
if ( V_249 == NULL ) {
F_22 ( V_45 , V_58 , ( L_20 ) ) ;
F_90 ( & V_70 -> V_253 . V_12 ) ;
goto V_252;
}
V_249 -> V_254 = V_86 ;
} else {
...
V_102 -> V_100 = F_43 ( V_102 ) ;
memcpy ( & ( V_249 -> V_118 ) , V_102 , V_102 -> V_100 ) ;
memcpy ( & V_250 -> V_118 , V_102 , ( F_43 ( V_102 ) ) ) ;
F_39 ( V_70 , V_255 ) ;
F_90 ( & V_70 -> V_253 . V_12 ) ;
}
V_252:
...
struct V_172 * V_166 = F_94 ( V_238 , V_171 -> V_175 ) ;
if ( V_166 == NULL ) {
F_22 ( V_45 , V_58 , ( L_21 ) ) ;
goto exit;
}
...
struct V_172 * V_166 = F_94 ( V_238 , V_257 -> V_175 ) ;
if ( V_166 == NULL ) {
F_22 ( V_45 , V_58 , ( L_22 ) ) ;
goto exit;
}
