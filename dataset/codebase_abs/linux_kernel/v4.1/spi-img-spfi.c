...
F_39 ( V_28 , V_30 , V_32 ) ;
if ( V_28 -> V_102 && V_28 -> V_102 ( V_28 , V_30 , V_32 ) )
...
static T_3 F_47 ( int V_104 , void * V_105 )
{
...
struct V_111 * V_112 ;
int V_37 ;
V_28 = F_49 ( & V_110 -> V_15 , sizeof( * V_2 ) ) ;
if ( ! V_28 )
return - V_113 ;
F_50 ( V_110 , V_28 ) ;
V_2 = F_17 ( V_28 ) ;
...
V_2 -> V_28 = V_28 ;
F_51 ( & V_2 -> V_44 ) ;
V_112 = F_52 ( V_110 , V_114 , 0 ) ;
V_2 -> V_4 = F_53 ( V_2 -> V_15 , V_112 ) ;
if ( F_54 ( V_2 -> V_4 ) ) {
V_37 = F_55 ( V_2 -> V_4 ) ;
goto V_115;
}
V_2 -> V_56 = V_112 -> V_116 ;
V_2 -> V_104 = F_56 ( V_110 , 0 ) ;
if ( V_2 -> V_104 < 0 ) {
V_37 = V_2 -> V_104 ;
goto V_115;
}
V_37 = F_57 ( V_2 -> V_15 , V_2 -> V_104 , F_47 ,
V_117 , F_36 ( V_2 -> V_15 ) , V_2 ) ;
if ( V_37 )
goto V_115;
V_2 -> V_118 = F_58 ( V_2 -> V_15 , L_6 ) ;
if ( F_54 ( V_2 -> V_118 ) ) {
V_37 = F_55 ( V_2 -> V_118 ) ;
goto V_115;
}
...
F_3 ( V_2 , V_106 , V_120 ) ;
V_28 -> V_121 = true ;
V_28 -> V_122 = V_110 -> V_123 ;
V_28 -> V_124 = V_80 | V_78 | V_125 | V_126 ;
if ( F_60 ( V_2 -> V_15 -> V_127 , L_8 ) )
V_28 -> V_124 |= V_128 | V_129 ;
V_28 -> V_15 . V_127 = V_110 -> V_15 . V_127 ;
V_28 -> V_130 = F_61 ( 32 ) | F_61 ( 8 ) ;
V_28 -> V_131 = F_41 ( V_2 -> V_85 ) / 4 ;
V_28 -> V_132 = F_41 ( V_2 -> V_85 ) / 512 ;
V_28 -> V_133 = F_34 ;
V_28 -> V_134 = F_37 ;
V_28 -> V_135 = F_45 ;
V_28 -> V_136 = F_30 ;
...
static int F_74 ( struct V_142 * V_15 )
{
...
static int F_76 ( struct V_142 * V_15 )
{
struct V_27 * V_28 = F_75 ( V_15 ) ;
struct V_1 * V_2 = F_17 ( V_28 ) ;
int V_37 ;
...
static int F_77 ( struct V_142 * V_15 )
{
struct V_27 * V_28 = F_75 ( V_15 ) ;
return F_78 ( V_28 ) ;
}
static int F_79 ( struct V_142 * V_15 )
{
struct V_27 * V_28 = F_75 ( V_15 ) ;
struct V_1 * V_2 = F_17 ( V_28 ) ;
int V_37 ;
