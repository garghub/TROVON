...
F_2 ( & V_2 -> V_12 ) ;
if ( V_6 -> V_124 . V_65 ) {
F_31 ( V_94 , L_11 , V_123 ) ;
V_2 -> V_125 = V_126 ;
goto exit;
}
if ( V_6 -> V_124 . V_34 & V_127 ) {
V_2 -> V_128 = V_6 -> V_124 . V_59 / 1000 ;
F_31 ( V_94 , L_12 , V_123 ,
V_2 -> V_128 ) ;
}
if ( V_6 -> V_124 . V_34 & V_129 )
V_2 -> V_130 = V_6 -> V_124 . V_59 / 1000 ;
switch ( V_6 -> V_124 . V_34 & V_131 ) {
case V_132 :
V_2 -> V_125 = V_133 ;
break;
case V_134 :
...
V_6 -> V_124 . V_65 = 0 ;
if ( ( V_6 -> V_124 . V_34 & V_138 ) == V_127 ) {
V_6 -> V_124 . V_34 = V_127 ;
V_6 -> V_124 . V_59 = V_2 -> V_128 * 1000 ;
} else {
V_6 -> V_124 . V_34 = V_129 ;
V_6 -> V_124 . V_59 = V_2 -> V_130 * 1000 ;
}
if ( ( V_2 -> V_125 & ( V_135 | V_133 ) ) ==
( V_135 | V_133 ) )
V_6 -> V_124 . V_34 |= V_136 ;
else if ( V_2 -> V_125 & V_135 )
V_6 -> V_124 . V_34 |= V_134 ;
else
V_6 -> V_124 . V_34 |= V_132 ;
exit:
F_5 ( & V_2 -> V_12 ) ;
return 0 ;
}
