...
T_2 V_15 , V_13 = V_24 ;
struct V_7 * V_8 ;
ASSERT ( F_30 ( V_11 -> V_28 . V_29 ) ) ;
V_53 = F_21 ( V_11 ) ;
if ( ! V_53 )
return V_24 ;
V_8 = F_31 ( V_1 -> V_43 , V_53 -> V_44 ) ;
if ( V_8 ) {
...
struct V_14 * V_11 )
{
F_39 ( V_11 -> V_12 -> V_43 , V_11 -> V_44 ) ;
}
int
F_40 (
T_1 * V_1 )
{
return F_41 ( & V_1 -> V_43 , V_65 * 10 ,
10 , F_9 ) ;
}
void
F_42 (
