...
V_108 = F_69 ( V_42 -> V_106 , F_25 ( V_42 -> V_55 ) ) ;
F_70 ( V_108 ) ;
return V_108 ;
}
...
struct V_110 * V_111 )
{
int V_112 = 0 , V_113 , V_114 , V_115 , V_116 ;
int V_117 = 0 ;
struct V_110 V_118 ;
void * V_104 = NULL ;
struct V_119 * V_120 = & V_2 -> V_73 ;
...
V_112 = * V_109 ;
if ( F_73 ( V_120 , V_111 , & V_113 , & V_112 ) == 0 ) {
if ( V_112 < * V_109 )
* V_109 = V_112 ;
goto V_33;
}
...
V_112 = V_113 = V_115 = 0 ;
V_116 = - 1 ;
V_114 = F_23 ( V_36 -> V_57 . V_58 . V_60 ) ;
while ( ( V_113 = F_74 ( V_104 , V_114 , V_115 ) ) != - 1 ) {
if ( V_113 == V_114 ) {
break;
}
if ( V_113 == V_115 ) {
...
V_42 -> V_61 = 0 ;
for( V_123 = 0 ; V_123 < F_25 ( V_42 -> V_55 ) ; V_123 ++ )
V_42 -> V_106 [ V_123 ] = 0 ;
}
...
V_103 = V_108 = V_101 = 0 ;
V_114 = F_23 ( V_36 -> V_57 . V_58 . V_60 ) ;
while ( ( V_101 = F_74 ( V_104 , V_114 , V_103 ) )
!= - 1 ) {
if ( ( V_101 < V_114 ) && ( V_101 == V_103 ) ) {
V_108 ++ ;
V_103 ++ ;
continue;
}
...
{
int V_34 ;
* V_90 = F_86 ( sizeof( struct V_89 ) , V_85 ) ;
if ( ! ( * V_90 ) ) {
V_34 = - V_82 ;
F_20 ( V_34 ) ;
goto V_33;
...
F_23 ( V_36 -> V_57 . V_58 . V_60 ) ,
V_2 -> V_20 ) ;
V_90 -> V_138 = V_2 -> V_139 ;
V_34 = F_93 ( V_63 , V_90 , V_2 -> V_20 ,
& V_136 , & V_137 ) ;
if ( V_34 == - V_92 ) {
V_134:
if ( F_82 ( V_2 , V_130 ) ==
...
V_2 -> V_139 = V_90 -> V_138 ;
V_42 -> V_61 = F_94 ( V_136 ) ;
V_36 -> V_57 . V_58 . V_60 = F_94 ( V_137 ) ;
V_36 -> V_57 . V_58 . V_59 = 0 ;
...
V_34 = F_91 ( V_2 , V_63 , V_90 ) ;
if ( V_34 < 0 ) {
if ( V_34 != - V_92 )
F_20 ( V_34 ) ;
goto V_33;
}
F_97 ( & V_2 -> V_141 . V_142 ) ;
V_33:
if ( V_63 )
F_44 ( V_2 , V_63 ) ;
F_27 ( V_66 ) ;
