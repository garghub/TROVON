...
static struct V_41 * F_30 ( char * V_42 , int V_46 ,
int V_47 ,
char * V_43 , T_10 V_48 )
{
char * T_1 ;
...
static void F_32 ( struct V_41 * V_36 )
{
struct V_38 * V_39 ;
V_39 = F_27 ( V_36 , struct V_38 , V_36 . V_36 ) ;
F_31 ( V_39 -> V_40 ) ;
F_31 ( V_39 -> V_36 . V_36 . V_42 ) ;
F_31 ( V_39 ) ;
}
static struct V_41 * F_33 ( unsigned V_53 ,
struct V_2 * V_24 ,
unsigned V_1 ,
int V_54 )
{
...
static struct V_41 * F_34 ( struct V_2 * V_24 ,
int V_54 )
{
int V_7 , V_15 ;
...
if ( ! V_15 )
return NULL ;
return F_30 ( V_42 , V_7 , V_54 , V_61 , V_15 ) ;
}
static struct V_41 *
F_35 ( struct V_2 * V_24 , int V_54 )
{
int V_7 , V_15 ;
char * V_42 = F_7 ( V_24 , & V_7 ) ;
...
static T_9 F_36 ( unsigned V_53 , struct V_41 * * V_62 ,
struct V_2 * V_24 , int V_54 )
{
unsigned V_63 ;
switch ( V_24 -> V_1 ) {
case V_64 :
* V_62 = F_33 ( V_53 , V_24 , V_24 -> V_1 , V_54 ) ;
return 1 ;
case V_65 :
for ( V_63 = 0 ; V_63 < F_37 ( V_66 ) ; V_63 ++ ) {
V_62 [ V_63 ] = F_33 ( V_53 , V_24 , V_66 [ V_63 ] ,
V_54 ) ;
if ( ! V_62 [ V_63 ] ) {
F_16 ( L_23
L_24 , V_53 , V_63 ) ;
...
static T_10 F_38 ( struct V_2 * V_24 )
{
switch ( V_24 -> V_1 ) {
case V_64 :
return 1 ;
...
static unsigned long F_39 ( void * T_2 )
{
struct V_23 * V_67 = F_40 ( T_2 ) ;
F_41 ( ! V_67 ) ;
return F_42 ( V_67 ) + F_43 ( T_2 ) ;
}
static int F_44 ( const void * V_68 , T_10 V_69 , const void * V_70 , T_10 V_71 )
{
if ( V_69 < V_71 )
return 1 ;
if ( V_71 > V_69 )
...
static int F_45 ( const void * V_72 , T_10 V_69 , unsigned V_68 , const void * V_73 ,
T_10 V_71 , unsigned V_70 )
{
int V_74 = F_44 ( V_72 , V_69 , V_73 , V_71 ) ;
if ( V_74 )
return V_74 ;
if ( V_68 > V_70 )
return 1 ;
...
static int F_46 ( struct V_75 * V_76 , const char * V_42 , int V_7 ,
unsigned V_1 )
{
...
V_83 = F_45 ( V_42 , V_7 , V_1 , V_82 -> V_42 , V_82 -> V_7 ,
V_82 -> V_1 ) ;
V_79 = * V_78 ;
if ( V_83 < 0 )
V_78 = & ( ( * V_78 ) -> V_85 ) ;
...
F_52 (pos, n, root, node)
F_31 ( V_89 ) ;
}
static T_9 F_53 ( struct V_2 * V_24 ,
T_10 V_90 ,
T_10 V_91 ,
T_10 V_92 ,
T_10 V_93 , void * V_11 )
...
static int F_54 ( struct V_41 * * * V_99 ,
struct V_41 * * * V_100 ,
struct V_41 * * * V_101 )
{
unsigned long V_102 ;
...
V_113 = F_56 ( V_118 -> V_20 ) ;
V_104 = F_57 ( V_118 -> V_97 ) ;
if ( V_127 < V_104 ) {
F_58 ( L_34 , V_104 ) ;
V_123 = - V_125 ;
goto V_126;
...
F_16 ( L_43 ,
V_110 , V_92 , V_107 ) ;
V_114 = F_61 ( V_109 + 1 , sizeof( * V_114 ) , V_27 ) ;
if ( ! V_114 ) {
V_123 = - V_88 ;
goto V_131;
}
V_115 = F_61 ( V_90 + 1 , sizeof( * V_115 ) ,
V_27 ) ;
if ( ! V_115 ) {
V_123 = - V_88 ;
goto V_133;
...
continue;
V_42 = F_7 ( V_24 , & V_7 ) ;
V_54 = F_46 ( & V_121 , V_42 , V_7 , V_24 -> V_1 ) ;
V_87 = F_36 ( V_90 , V_114 + V_108 ,
V_24 , V_54 ) ;
if ( V_87 <= 0 ) {
F_16 ( L_44 ,
V_90 , V_7 , V_42 ) ;
...
static T_9 F_64 ( struct V_135 * V_136 , struct V_137 * V_138 ,
...
static int F_68 ( struct V_145 * V_146 ,
struct V_147 * V_148 )
{
unsigned long V_123 ;
V_123 = F_20 ( V_160 ,
...
F_22 ( V_148 ) , V_161 ) ;
if ( V_123 )
F_65 ( V_146 , V_148 , V_123 ) ;
return V_123 ;
}
static int F_69 ( struct V_162 * V_24 ,
struct V_145 * V_146 )
{
T_14 V_163 ;
int V_63 ;
...
V_150 -> V_152 = F_70 ( V_24 ) ;
V_150 -> V_166 = F_73 ( 8 ) ;
V_150 -> V_153 = F_74 ( F_75 ( V_24 ) ) ;
V_150 -> V_155 = F_73 ( F_76 ( V_24 ) ) ,
V_150 -> V_167 = F_73 ( 1 ) ;
V_150 -> V_154 = F_73 ( V_163 ) ;
V_150 -> V_168 = F_73 ( 1 ) ;
return 0 ;
}
static unsigned long F_77 ( struct V_162 * V_24 , T_6 * V_141 )
{
unsigned long V_123 ;
struct V_145 * V_146 ;
struct V_147 * V_148 ;
struct V_169 * V_170 ;
F_60 ( sizeof( * V_146 ) > 4096 ) ;
F_60 ( sizeof( * V_148 ) > 4096 ) ;
V_146 = ( void * ) F_78 ( V_171 ) ;
V_148 = ( void * ) F_78 ( V_172 ) ;
F_67 ( V_146 , V_148 ) ;
V_123 = F_69 ( V_24 , V_146 ) ;
if ( V_123 )
goto V_173;
V_123 = F_68 ( V_146 , V_148 ) ;
if ( V_123 ) {
F_65 ( V_146 , V_148 , V_123 ) ;
goto V_173;
}
V_170 = & V_148 -> V_174 [ 0 ] ;
* V_141 = F_56 ( V_170 -> V_175 [ 0 ] . V_176 [ 0 ] ) ;
V_173:
F_79 ( V_171 ) ;
F_79 ( V_172 ) ;
return V_123 ;
}
static int F_80 ( struct V_162 * V_24 )
{
struct V_177 V_178 ;
unsigned V_1 ;
unsigned long V_102 ;
T_6 V_87 ;
if ( V_24 -> V_36 . type != V_24 -> V_179 -> type )
return - V_180 ;
if ( F_81 ( V_24 ) ||
F_82 ( V_24 ) ||
F_83 ( V_24 ) ) {
...
static T_6 F_87 ( struct V_162 * V_24 )
{
unsigned long V_123 ;
T_6 V_87 ;
V_123 = F_77 ( V_24 , & V_87 ) ;
if ( V_123 )
return 0 ;
return V_87 ;
}
static void F_88 ( struct V_162 * V_24 , T_6 V_193 )
{
T_15 V_194 ;
V_194 = F_89 ( & V_24 -> V_195 . V_196 , V_193 ) ;
F_90 ( V_193 - V_194 , & V_24 -> V_141 ) ;
}
static void F_91 ( struct V_162 * V_24 )
{
T_6 V_193 ;
V_193 = F_87 ( V_24 ) ;
F_88 ( V_24 , V_193 ) ;
}
static void F_92 ( struct V_162 * V_24 , int V_197 )
{
if ( V_197 & V_198 )
F_93 ( & V_24 -> V_195 . V_196 , F_87 ( V_24 ) ) ;
}
static void F_94 ( struct V_162 * V_24 , int V_197 )
{
F_91 ( V_24 ) ;
}
static int F_95 ( struct V_162 * V_24 , int V_197 )
{
if ( V_197 & V_199 )
F_92 ( V_24 , V_197 ) ;
return 0 ;
...
V_119 = F_98 ( L_61 , 4096 , 4096 , 0 , NULL ) ;
if ( ! V_119 )
return - V_88 ;
V_202 . V_203 |= V_204 ;
V_74 = F_54 ( & V_205 . V_62 ,
& V_206 . V_62 ,
& V_207 . V_62 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_99 ( & V_202 , V_202 . V_42 , - 1 ) ;
if ( V_74 )
return V_74 ;
return 0 ;
}
