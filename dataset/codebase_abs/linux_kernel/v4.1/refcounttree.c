...
F_264 ( & V_341 -> V_113 , V_344 ) ;
V_50 = F_265 ( V_341 , & V_78 , 1 ,
V_345 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_116;
...
V_53:
if ( ! V_50 ) {
V_50 = F_267 ( V_56 -> V_265 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
}
return V_50 ;
}
static int F_268 ( struct V_339 * V_340 , struct V_56 * V_347 ,
...
return - V_354 ;
V_353 = V_56 -> V_335 ;
error = F_269 ( V_347 , & V_353 , & V_351 , & V_352 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
error = F_270 ( V_347 , V_353 ,
& V_349 ) ;
if ( error ) {
F_56 ( error ) ;
goto V_53;
...
static inline int F_277 ( struct V_56 * V_347 , struct V_339 * V_356 )
{
if ( F_278 ( V_356 ) )
return - V_357 ;
if ( F_279 ( V_347 ) )
return - V_358 ;
return F_280 ( V_347 , V_359 | V_360 ) ;
}
static int F_281 ( struct V_339 * V_340 , struct V_56 * V_347 ,
struct V_339 * V_348 , bool V_326 )
{
struct V_56 * V_56 = F_262 ( V_340 ) ;
int error ;
if ( ! V_56 )
return - V_358 ;
error = F_277 ( V_347 , V_348 ) ;
if ( error )
return error ;
if ( V_347 -> V_77 != V_56 -> V_77 )
return - V_361 ;
if ( F_282 ( V_56 ) || F_283 ( V_56 ) )
return - V_362 ;
if ( ! F_284 ( V_56 -> V_335 ) )
return - V_362 ;
if ( V_326 ) {
if ( ! F_285 ( F_286 () , V_56 -> V_333 ) && ! F_287 ( V_363 ) )
return - V_362 ;
if ( ! F_288 ( V_56 -> V_334 ) && ! F_287 ( V_363 ) )
return - V_362 ;
}
if ( ! V_326 ) {
error = F_280 ( V_56 , V_364 ) ;
if ( error )
return error ;
}
F_23 ( & V_56 -> V_113 ) ;
F_289 ( V_347 ) ;
error = F_268 ( V_340 , V_347 , V_348 , V_326 ) ;
F_25 ( & V_56 -> V_113 ) ;
if ( ! error )
F_290 ( V_347 , V_348 ) ;
return error ;
}
int F_291 ( struct V_56 * V_56 ,
...
if ( ! V_1 ( F_13 ( V_56 -> V_77 ) ) )
return - V_354 ;
error = F_292 ( V_369 , V_365 , 0 , & V_367 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
V_348 = F_293 ( V_369 , V_366 , & V_368 , 0 ) ;
error = F_79 ( V_348 ) ;
if ( F_78 ( V_348 ) ) {
F_56 ( error ) ;
goto V_53;
