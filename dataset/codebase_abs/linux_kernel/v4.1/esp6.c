...
( ( V_55 ) F_35 ( V_18 ) -> V_50 . V_51 . V_54 << 32 ) ) ;
F_20 ( V_18 ) -> V_9 = V_9 ;
V_16 = F_44 ( V_12 ) ;
if ( V_16 == - V_56 )
goto error;
...
int V_29 = F_23 ( V_2 ) ;
int V_59 = sizeof( struct V_22 ) + F_2 ( V_2 ) ;
int V_60 = V_18 -> V_5 - V_59 ;
int V_61 = F_47 ( V_18 ) ;
int V_62 ;
T_2 V_63 [ 2 ] ;
F_19 ( F_20 ( V_18 ) -> V_9 ) ;
if ( F_48 ( V_16 ) )
goto V_64;
if ( F_49 ( V_18 , V_18 -> V_5 - V_29 - 2 , V_63 , 2 ) )
F_50 () ;
V_16 = - V_65 ;
V_62 = V_63 [ 0 ] ;
if ( V_62 + 2 + V_29 >= V_60 ) {
...
F_52 ( V_18 , V_18 -> V_5 - V_29 - V_62 - 2 ) ;
F_53 ( V_18 , V_59 ) ;
...
struct V_13 * V_12 ;
struct V_17 * V_26 ;
int V_60 = V_18 -> V_5 - sizeof( * V_23 ) - F_2 ( V_2 ) ;
int V_3 ;
int V_32 ;
int V_33 ;
int V_10 ;
...
V_11 = V_23 -> V_53 ;
F_36 ( V_24 , V_3 ) ;
F_37 ( V_18 , V_24 , sizeof( * V_23 ) + F_2 ( V_2 ) , V_60 ) ;
if ( ( V_21 -> V_41 . V_42 & V_43 ) ) {
F_36 ( V_25 , 3 ) ;
F_38 ( V_25 , & V_23 -> V_47 , sizeof( T_1 ) ) ;
...
L_2 ,
V_21 -> V_107 ? V_21 -> V_107 -> V_92 : L_3 ,
...
V_16 = F_77 (
V_2 , V_21 -> V_107 -> V_118 / 8 ) ;
if ( V_16 )
goto V_117;
}
V_97 -> V_119 = F_85 ( ( V_21 -> V_105 -> V_94 + 7 ) / 8 ) ;
...
case V_122 :
if ( V_21 -> V_123 . V_124 != V_90 )
V_21 -> V_41 . V_76 += V_125 +
( sizeof( struct V_75 ) - sizeof( struct V_126 ) ) ;
break;
case V_127 :
break;
case V_67 :
...
V_120 = F_5 ( F_27 ( V_2 ) , 4 ) ;
V_21 -> V_41 . V_128 = V_120 + 1 + F_23 ( V_2 ) ;
error:
return V_16 ;
}
...
{
if ( F_89 ( & V_129 , V_90 ) < 0 ) {
F_84 ( L_6 , V_130 ) ;
return - V_131 ;
}
if ( F_90 ( & V_132 , V_46 ) < 0 ) {
F_84 ( L_7 , V_130 ) ;
F_91 ( & V_129 , V_90 ) ;
return - V_131 ;
}
...
{
if ( F_93 ( & V_132 , V_46 ) < 0 )
F_84 ( L_8 , V_130 ) ;
if ( F_91 ( & V_129 , V_90 ) < 0 )
F_84 ( L_9 , V_130 ) ;
}
