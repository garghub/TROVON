...
( V_21 * V_2 -> V_20 +
V_22 * V_2 -> V_17 ) ;
V_2 -> V_131 = F_83 ( & V_93 -> V_57 , V_95 , & V_2 -> V_132 ,
V_103 ) ;
if ( V_2 -> V_131 == NULL ) {
V_94 = - V_104 ;
goto V_120;
...
F_14 ( V_2 , F_68 ( V_74 ) , V_2 -> V_132 +
sizeof( struct V_130 ) *
F_16 ( V_2 , V_74 ) ) ;
for ( V_74 = 0 ; V_74 < V_2 -> V_17 ; ++ V_74 )
F_14 ( V_2 , F_69 ( V_74 ) , V_2 -> V_132 +
sizeof( struct V_130 ) *
F_17 ( V_2 , V_74 ) ) ;
if ( F_42 ( V_2 , V_112 ) ) {
V_99 = V_133 ;
...
F_88 ( V_2 -> V_116 , V_2 ) ;
V_134:
F_89 ( & V_93 -> V_57 , V_95 , V_2 -> V_131 , V_2 -> V_132 ) ;
V_120:
