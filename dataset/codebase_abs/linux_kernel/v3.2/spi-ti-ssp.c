...
static int F_20 ( struct V_52 * V_20 )
{
if ( V_20 -> V_58 > 32 )
return - V_65 ;
return 0 ;
}
static int F_21 ( struct V_52 * V_20 , struct V_9 * V_51 )
{
struct V_1 * V_2 ;
struct V_11 * V_12 ;
int error = 0 ;
...
F_24 ( & V_51 -> V_55 , & V_2 -> V_50 ) ;
F_25 ( V_2 -> V_71 , & V_2 -> V_48 ) ;
V_70:
F_17 ( & V_2 -> V_49 ) ;
return error ;
}
static int T_4 F_26 ( struct V_72 * V_73 )
{
...
V_67 = F_27 ( V_4 , sizeof( struct V_1 ) ) ;
if ( ! V_67 ) {
F_23 ( V_4 , L_10 ) ;
return - V_79 ;
}
...
static int T_5 F_39 ( struct V_72 * V_73 )
{
struct V_1 * V_2 = F_40 ( V_73 ) ;
int error ;
V_2 -> V_64 = 1 ;
while ( ! F_15 ( & V_2 -> V_50 ) ) {
error = F_41 ( & V_2 -> V_62 ) ;
