...
static int F_77 ( struct V_32 * V_33 , struct V_85 * V_86 )
{
struct V_1 * V_9 ;
int V_68 , V_11 = 0 ;
unsigned long V_10 ;
...
static void F_78 ( struct V_32 * V_33 , struct V_85 * V_86 )
{
struct V_1 * V_9 ;
unsigned long V_10 ;
int V_37 = V_91 ;
...
static int F_86 ( int V_100 )
{
int V_63 ;
V_56 = F_87 ( V_100 * sizeof( V_57 ) , V_69 ) ;
if ( ! V_56 )
return - V_81 ;
V_57 = V_100 ;
for ( V_63 = 0 ; V_63 < V_57 ; V_63 ++ )
...
{
int V_68 = F_101 ( & V_123 ) ;
if ( V_68 ) {
F_9 ( V_64 L_42 ) ;
return V_68 ;
}
F_102 ( L_43 ) ;
V_68 = F_103 ( & ( V_123 . V_124 ) , & V_125 ) ;
if ( V_68 )
