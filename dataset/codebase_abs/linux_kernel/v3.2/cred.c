...
int F_69 ( struct V_1 * V_27 , T_2 V_63 )
{
return F_70 ( V_27 , V_63 ) ;
}
int F_71 ( struct V_1 * V_27 , const char * V_64 )
{
T_2 V_63 ;
int V_35 ;
V_35 = F_72 ( V_64 , strlen ( V_64 ) , & V_63 ) ;
if ( V_35 < 0 )
return V_35 ;
return F_69 ( V_27 , V_63 ) ;
}
int F_73 ( struct V_1 * V_27 , struct V_65 * V_65 )
{
V_27 -> V_44 = V_65 -> V_66 ;
V_27 -> V_45 = V_65 -> V_67 ;
return F_74 ( V_27 , V_65 ) ;
}
...
#ifdef F_76
if ( F_77 () && V_1 -> V_31 ) {
if ( ( unsigned long ) V_1 -> V_31 < V_68 )
return true ;
if ( ( * ( T_2 * ) V_1 -> V_31 & 0xffffff00 ) ==
( V_69 << 24 | V_69 << 16 | V_69 << 8 ) )
return true ;
}
#endif
return false ;
}
static void F_78 ( const struct V_1 * V_1 , const char * V_70 ,
...
void F_80 ( const struct V_1 * V_1 , const char * V_72 , unsigned line )
{
F_79 ( V_71 L_27 ) ;
F_79 ( V_71 L_28 , V_72 , line ) ;
F_78 ( V_1 , L_29 , V_20 ) ;
F_81 () ;
}
