...
{
if ( V_25 )
V_27 = F_23 ( V_25 , NULL , 0 ) ;
return 0 ;
}
int T_2 F_24 ( char * V_28 )
{
if ( F_19 ( V_29 ) ) {
unsigned long V_30 = F_23 ( V_28 , NULL , 0 ) ;
F_25 ( V_31 L_3 , V_30 ) ;
F_26 ( 0 ) ;
F_26 ( V_30 ) ;
}
...
unsigned char F_29 ( int V_33 )
{
if ( V_20 . V_34 )
return V_20 . V_34 ( V_33 ) ;
return 0xff ;
}
void F_30 ( unsigned char V_30 , int V_33 )
{
if ( V_20 . V_35 )
V_20 . V_35 ( V_33 , V_30 ) ;
}
