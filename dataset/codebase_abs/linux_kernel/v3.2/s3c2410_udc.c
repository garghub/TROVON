...
if ( ! V_61 )
return - V_228 ;
if ( ! V_140 || V_140 != V_61 -> V_140 || ! V_140 -> V_232 )
return - V_184 ;
F_6 ( V_90 , L_76 ,
V_140 -> V_140 . V_180 ) ;
if ( V_140 -> V_210 )
V_140 -> V_210 ( & V_61 -> V_142 ) ;
V_140 -> V_232 ( & V_61 -> V_142 ) ;
F_88 ( & V_61 -> V_142 . V_63 ) ;
V_61 -> V_140 = NULL ;
F_75 ( V_61 ) ;
return 0 ;
}
static int F_90 ( struct V_234 * V_235 )
{
struct V_60 * V_61 = & V_236 ;
struct V_237 * V_63 = & V_235 -> V_63 ;
int V_199 ;
int V_213 ;
F_91 ( V_63 , L_69 , V_76 ) ;
V_238 = F_92 ( NULL , L_77 ) ;
if ( F_93 ( V_238 ) ) {
F_94 ( V_63 , L_78 ) ;
return F_95 ( V_238 ) ;
}
F_96 ( V_238 ) ;
V_239 = F_92 ( NULL , L_79 ) ;
if ( F_93 ( V_239 ) ) {
F_94 ( V_63 , L_80 ) ;
return F_95 ( V_239 ) ;
}
...
F_97 ( 10 ) ;
F_91 ( V_63 , L_81 ) ;
if ( strncmp ( V_235 -> V_180 , L_82 , 7 ) == 0 ) {
F_98 ( V_63 , L_83 ) ;
V_236 . V_52 [ 1 ] . V_240 = V_241 ;
V_236 . V_52 [ 2 ] . V_240 = V_241 ;
V_236 . V_52 [ 3 ] . V_240 = V_241 ;
V_236 . V_52 [ 4 ] . V_240 = V_241 ;
}
F_99 ( & V_61 -> V_159 ) ;
V_207 = V_235 -> V_63 . V_242 ;
V_243 = V_244 ;
V_245 = V_246 ;
if ( ! F_100 ( V_243 , V_245 , V_247 ) )
return - V_229 ;
V_2 = F_101 ( V_243 , V_245 ) ;
if ( ! V_2 ) {
V_199 = - V_248 ;
goto V_249;
}
F_102 ( & V_61 -> V_142 . V_63 ) ;
V_61 -> V_142 . V_63 . V_250 = & V_235 -> V_63 ;
V_61 -> V_142 . V_63 . V_251 = V_235 -> V_63 . V_251 ;
V_200 = V_61 ;
F_103 ( V_235 , V_61 ) ;
F_75 ( V_61 ) ;
F_83 ( V_61 ) ;
...
V_199 = F_108 ( & V_235 -> V_63 , & V_61 -> V_142 ) ;
if ( V_199 )
goto V_261;
if ( V_262 ) {
V_61 -> V_263 = F_109 ( L_91 , V_264 ,
V_262 ,
V_61 , & V_265 ) ;
if ( ! V_61 -> V_263 )
F_110 ( V_63 , L_92 ) ;
...
static int F_115 ( struct V_234 * V_235 )
{
struct V_60 * V_61 = F_116 ( V_235 ) ;
unsigned int V_213 ;
F_91 ( & V_235 -> V_63 , L_69 , V_76 ) ;
F_117 ( & V_61 -> V_142 ) ;
if ( V_61 -> V_140 )
return - V_229 ;
F_118 ( V_61 -> V_263 ) ;
...
if ( ! F_93 ( V_238 ) && V_238 != NULL ) {
F_119 ( V_238 ) ;
F_120 ( V_238 ) ;
V_238 = NULL ;
}
F_91 ( & V_235 -> V_63 , L_94 , V_76 ) ;
return 0 ;
}
static int F_121 ( struct V_234 * V_235 , T_8 V_266 )
{
F_81 ( V_222 ) ;
return 0 ;
}
...
{
int V_199 ;
F_6 ( V_90 , L_95 , V_247 , V_267 ) ;
V_262 = F_124 ( V_247 , NULL ) ;
if ( F_93 ( V_262 ) ) {
F_9 ( V_230 L_96 ,
V_247 , F_95 ( V_262 ) ) ;
V_262 = NULL ;
