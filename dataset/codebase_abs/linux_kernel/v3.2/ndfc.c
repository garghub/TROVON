...
return - V_60 ;
V_38 . V_61 = V_36 ;
V_9 -> V_2 . V_62 = F_16 ( V_63 , L_1 ,
F_17 ( & V_9 -> V_64 -> V_65 ) , V_36 -> V_62 ) ;
if ( ! V_9 -> V_2 . V_62 ) {
V_39 = - V_66 ;
goto V_67;
}
...
static int T_4 F_22 ( struct V_68 * V_64 )
{
struct V_8 * V_9 ;
const T_5 * V_69 ;
T_6 V_4 ;
int V_67 , V_31 , V_70 ;
V_69 = F_23 ( V_64 -> V_65 . V_61 , L_2 , & V_31 ) ;
if ( V_69 == NULL || V_31 != 12 ) {
F_24 ( & V_64 -> V_65 , L_3 , V_31 ) ;
return - V_71 ;
}
V_70 = F_25 ( V_69 [ 0 ] ) ;
if ( V_70 >= V_72 ) {
F_24 ( & V_64 -> V_65 , L_4 , V_70 ) ;
return - V_73 ;
}
V_9 = & V_74 [ V_70 ] ;
V_9 -> V_13 = V_70 ;
...
V_9 -> V_64 = V_64 ;
F_28 ( & V_64 -> V_65 , V_9 ) ;
V_9 -> V_10 = F_29 ( V_64 -> V_65 . V_61 , 0 ) ;
if ( ! V_9 -> V_10 ) {
F_24 ( & V_64 -> V_65 , L_5 ) ;
return - V_77 ;
}
V_4 = F_3 ( V_9 -> V_13 ) ;
V_69 = F_23 ( V_64 -> V_65 . V_61 , L_6 , NULL ) ;
if ( V_69 )
V_4 |= F_30 ( V_69 ) ;
F_4 ( V_9 -> V_10 + V_11 , V_4 ) ;
V_69 = F_23 ( V_64 -> V_65 . V_61 , L_7 , NULL ) ;
if ( V_69 ) {
int V_78 = V_79 + ( V_9 -> V_13 << 2 ) ;
F_4 ( V_9 -> V_10 + V_78 , F_30 ( V_69 ) ) ;
}
V_67 = F_14 ( V_9 , V_64 -> V_65 . V_61 ) ;
if ( V_67 ) {
F_31 ( V_9 -> V_10 ) ;
return V_67 ;
}
...
static int T_7 F_32 ( struct V_68 * V_64 )
{
struct V_8 * V_9 = F_33 ( & V_64 -> V_65 ) ;
F_34 ( & V_9 -> V_2 ) ;
F_21 ( V_9 -> V_2 . V_62 ) ;
return 0 ;
}
