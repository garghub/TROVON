...
struct V_112 * V_113 = & F_51 ( V_2 ) -> V_114 [ V_41 ] ;
V_27 = F_52 ( V_113 -> V_115 . V_116 , V_22 -> V_106 ,
& V_22 -> V_117 [ V_41 ] ) ;
if ( V_27 )
return V_27 ;
}
...
int
F_53 ( struct V_17 * V_22 ,
T_2 V_118 , T_2 V_119 )
{
struct V_1 * V_2 = V_22 -> V_2 ;
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_120 * V_121 = V_120 ( V_22 -> V_122 ) ;
struct V_105 * V_106 = V_121 ? V_121 -> V_106 : V_6 -> V_123 ;
struct V_34 * V_124 = NULL , * V_125 = NULL ;
int V_27 , V_41 ;
F_13 ( V_2 , L_10 , V_22 -> V_13 , V_118 , V_119 ) ;
if ( V_6 -> V_89 >= V_126 )
...
if ( V_106 ) {
T_1 V_127 = ( V_6 -> V_128 == 0x50 ) ? 0x1400 : 0x0200 ;
T_3 V_129 = V_22 -> V_40 -> V_51 + V_127 ;
T_1 V_130 = V_22 -> V_40 -> V_48 ;
if ( V_130 != ~ 0 )
V_130 += V_127 ;
V_27 = F_35 ( V_2 , V_130 , V_129 , 0x4000 ,
0 , & V_22 -> V_131 ) ;
if ( V_27 )
return V_27 ;
F_49 ( V_106 , & V_22 -> V_106 , V_22 -> V_131 ) ;
}
if ( V_6 -> V_89 < V_90 ) {
F_54 ( V_6 -> V_132 , & V_22 -> V_132 , NULL ) ;
} else {
...
if ( V_27 )
return V_27 ;
V_27 = F_55 ( V_2 , V_132 , & V_22 -> V_132 ) ;
F_20 ( NULL , & V_132 ) ;
if ( V_27 )
return V_27 ;
for ( V_41 = 0 ; V_41 < V_2 -> V_133 . V_134 ; V_41 ++ ) {
struct V_34 * V_115 = NULL ;
struct V_112 * V_113 =
& F_51 ( V_2 ) -> V_114 [ V_41 ] ;
T_3 V_71 = V_113 -> V_115 . V_116 -> V_116 . V_71 ;
V_27 = F_40 ( V_22 , 0x3d , V_71 , 0xfff ,
V_79 ,
V_81 , & V_115 ) ;
if ( V_27 )
return V_27 ;
V_27 = F_43 ( V_22 , V_135 + V_41 , V_115 ) ;
F_20 ( NULL , & V_115 ) ;
if ( V_27 )
return V_27 ;
}
...
void
F_56 ( struct V_17 * V_22 )
{
struct V_1 * V_2 = V_22 -> V_2 ;
struct V_5 * V_6 = V_2 -> V_7 ;
int V_41 ;
F_13 ( V_2 , L_7 , V_22 -> V_13 ) ;
if ( V_6 -> V_89 >= V_90 && V_6 -> V_89 <= V_126 ) {
struct F_51 * V_139 = F_51 ( V_2 ) ;
for ( V_41 = 0 ; V_41 < V_2 -> V_133 . V_134 ; V_41 ++ ) {
struct V_112 * V_113 = & V_139 -> V_114 [ V_41 ] ;
F_57 ( V_113 -> V_115 . V_116 , & V_22 -> V_117 [ V_41 ] ) ;
}
}
F_49 ( NULL , & V_22 -> V_106 , V_22 -> V_131 ) ;
F_20 ( NULL , & V_22 -> V_131 ) ;
if ( F_58 ( & V_22 -> V_47 ) )
F_59 ( & V_22 -> V_47 ) ;
F_20 ( NULL , & V_22 -> V_40 ) ;
}
...
if ( V_38 -> V_50 != V_57 )
continue;
V_38 -> V_140 = F_61 ( V_38 -> V_32 ) ;
if ( ! V_38 -> V_140 ) {
F_62 ( V_2 ) ;
return - V_11 ;
}
for ( V_41 = 0 ; V_41 < V_38 -> V_32 ; V_41 += 4 )
V_38 -> V_140 [ V_41 / 4 ] = F_63 ( V_38 , V_41 ) ;
}
return 0 ;
}
void
...
continue;
for ( V_41 = 0 ; V_41 < V_38 -> V_32 ; V_41 += 4 )
F_21 ( V_38 , V_41 , V_38 -> V_140 [ V_41 / 4 ] ) ;
F_64 ( V_38 -> V_140 ) ;
V_38 -> V_140 = NULL ;
}
V_6 -> V_4 . V_37 . V_59 ( V_2 ) ;
}
int F_65 ( struct V_1 * V_2 , void * V_23 ,
struct V_141 * V_122 )
{
struct V_142 * V_143 = V_23 ;
struct V_17 * V_22 ;
int V_27 ;
if ( V_143 -> V_99 == ~ 0 )
return - V_21 ;
V_22 = F_66 ( V_122 , V_143 -> V_144 ) ;
if ( F_67 ( V_22 ) )
return F_68 ( V_22 ) ;
if ( F_69 ( V_22 , V_143 -> V_99 ) ) {
V_27 = - V_145 ;
goto V_146;
}
V_27 = F_44 ( V_22 , V_143 -> V_99 , V_143 -> V_3 ) ;
if ( V_27 ) {
F_45 ( V_2 , L_16 ,
V_27 , V_143 -> V_144 , V_143 -> V_99 ) ;
}
V_146:
F_70 ( & V_22 ) ;
return V_27 ;
}
int F_71 ( struct V_1 * V_2 , void * V_23 ,
struct V_141 * V_122 )
{
struct V_147 * V_148 = V_23 ;
struct V_17 * V_22 ;
int V_27 ;
V_22 = F_66 ( V_122 , V_148 -> V_144 ) ;
if ( F_67 ( V_22 ) )
return F_68 ( V_22 ) ;
F_72 ( V_22 ) ;
V_27 = F_73 ( V_22 , V_148 -> V_99 ) ;
F_70 ( & V_22 ) ;
return V_27 ;
}
T_1
F_63 ( struct V_34 * V_38 , T_1 V_71 )
{
struct V_5 * V_6 = V_38 -> V_2 -> V_7 ;
struct V_1 * V_2 = V_38 -> V_2 ;
unsigned long V_26 ;
if ( V_38 -> V_48 == ~ 0 || ! V_6 -> V_149 ) {
...
if ( V_6 -> V_60 != V_72 ) {
V_6 -> V_60 = V_72 ;
F_74 ( V_2 , 0x001700 , V_6 -> V_60 ) ;
}
V_150 = F_75 ( V_2 , 0x700000 + ( V_31 & 0xffff ) ) ;
F_11 ( & V_6 -> V_151 , V_26 ) ;
return V_150 ;
}
return F_76 ( V_2 , V_38 -> V_48 + V_71 ) ;
}
void
F_21 ( struct V_34 * V_38 , T_1 V_71 , T_1 V_150 )
{
struct V_5 * V_6 = V_38 -> V_2 -> V_7 ;
struct V_1 * V_2 = V_38 -> V_2 ;
unsigned long V_26 ;
...
F_74 ( V_2 , 0x700000 + ( V_31 & 0xffff ) , V_150 ) ;
F_11 ( & V_6 -> V_151 , V_26 ) ;
return;
}
F_77 ( V_2 , V_38 -> V_48 + V_71 , V_150 ) ;
}
