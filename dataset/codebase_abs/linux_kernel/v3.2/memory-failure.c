...
static struct V_1 * F_133 ( struct V_1 * V_2 , unsigned long V_135 , int * * V_136 )
{
int V_137 = F_134 ( V_2 ) ;
if ( F_88 ( V_2 ) )
...
return F_137 ( V_137 , V_138 , 0 ) ;
}
static int F_138 ( struct V_1 * V_2 , unsigned long V_29 , int V_68 )
{
int V_32 ;
if ( V_68 & V_119 )
return 1 ;
...
static int F_143 ( struct V_1 * V_1 , int V_68 )
{
int V_32 ;
unsigned long V_29 = F_30 ( V_1 ) ;
struct V_1 * V_95 = F_17 ( V_1 ) ;
F_79 ( V_139 ) ;
V_32 = F_138 ( V_1 , V_29 , V_68 ) ;
if ( V_32 < 0 )
return V_32 ;
if ( V_32 == 0 )
goto V_140;
...
F_144 ( & V_95 -> V_141 , & V_139 ) ;
V_32 = F_145 ( & V_139 , F_133 , V_142 , 0 ,
true ) ;
if ( V_32 ) {
...
int F_146 ( struct V_1 * V_1 , int V_68 )
{
int V_32 ;
unsigned long V_29 = F_30 ( V_1 ) ;
if ( F_88 ( V_1 ) )
return F_143 ( V_1 , V_68 ) ;
V_32 = F_138 ( V_1 , V_29 , V_68 ) ;
if ( V_32 < 0 )
return V_32 ;
if ( V_32 == 0 )
...
F_147 ( V_1 , V_145 +
F_148 ( V_1 ) ) ;
F_144 ( & V_1 -> V_141 , & V_139 ) ;
V_32 = F_149 ( & V_139 , F_133 , V_142 ,
0 , true ) ;
if ( V_32 ) {
F_150 ( & V_139 ) ;
F_29 ( L_40 ,
