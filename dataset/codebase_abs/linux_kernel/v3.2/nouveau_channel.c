...
struct V_1 *
F_37 ( struct V_1 * V_51 )
{
struct V_1 * V_2 = NULL ;
if ( F_38 ( V_51 && F_39 ( & V_51 -> V_52 ) ) )
F_20 ( V_51 , & V_2 ) ;
return V_2 ;
}
struct V_1 *
F_40 ( struct V_38 * V_39 , int V_56 )
{
struct V_46 * V_47 = V_46 ( V_39 ) ;
struct V_1 * V_2 ;
F_34 ( & V_47 -> V_55 ) ;
F_41 (chan, &fpriv->channels, list) {
if ( V_2 -> V_56 == V_56 ) {
V_2 = F_37 ( V_2 ) ;
F_36 ( & V_47 -> V_55 ) ;
F_18 ( & V_2 -> V_53 ) ;
...
F_50 ( NULL , & V_2 -> V_76 , V_2 ) ;
F_51 ( V_2 ) ;
F_52 ( V_2 ) ;
F_20 ( NULL , V_70 ) ;
}
void
F_28 ( struct V_1 * * V_70 )
{
F_22 ( & ( * V_70 ) -> V_53 ) ;
F_43 ( V_70 ) ;
}
static void
F_53 ( struct V_77 * V_51 )
{
struct V_1 * V_2 =
F_54 ( V_51 , struct V_1 , V_51 ) ;
F_23 ( V_2 ) ;
}
void
F_20 ( struct V_1 * V_2 ,
...
V_12 = F_58 ( V_2 , & V_62 , true ) ;
if ( ! V_12 ) {
V_12 = F_59 ( V_62 , false , false ) ;
F_60 ( & V_62 ) ;
}
if ( V_12 )
...
void
F_61 ( struct V_7 * V_8 , struct V_38 * V_39 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
...
V_12 = F_66 ( V_39 , V_2 -> V_102 -> V_103 ,
& V_84 -> V_104 ) ;
if ( V_12 == 0 )
F_67 ( & V_2 -> V_52 ) ;
F_28 ( & V_2 ) ;
...
static int
F_68 ( struct V_7 * V_8 , void * V_82 ,
struct V_38 * V_39 )
{
struct V_105 * V_106 = V_82 ;
struct V_1 * V_2 ;
V_2 = F_40 ( V_39 , V_106 -> V_88 ) ;
if ( F_62 ( V_2 ) )
return F_69 ( V_2 ) ;
F_63 ( & V_2 -> V_68 ) ;
F_64 ( & V_2 -> V_52 ) ;
