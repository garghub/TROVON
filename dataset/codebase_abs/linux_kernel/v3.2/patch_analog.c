...
static void F_26 ( struct V_5 * V_6 , const char * V_36 , int V_51 )
{
...
static void F_28 ( struct V_5 * V_6 , bool V_51 )
{
struct V_7 * V_8 = V_6 -> V_8 ;
if ( V_51 )
V_8 -> V_60 ++ ;
...
V_8 -> V_60 -- ;
F_26 ( V_6 , L_7 , V_8 -> V_60 == 0 ) ;
}
static int F_29 ( struct V_1 * V_2 ,
struct V_3 * V_4 )
{
static const char * const V_61 [] = { L_8 , L_9 , NULL } ;
int V_62 ;
V_4 -> type = V_63 ;
V_4 -> V_46 = 1 ;
...
static void F_56 ( struct V_5 * V_6 , T_1 V_102 ,
T_1 V_103 )
{
struct V_7 * V_8 = V_6 -> V_8 ;
if ( F_57 ( V_6 , V_102 ) & V_104 )
F_58 ( V_6 , V_102 , 0 , V_105 ,
! V_8 -> V_106 ? 0x00 : 0x02 ) ;
if ( F_57 ( V_6 , V_103 ) & V_104 )
F_58 ( V_6 , V_103 , 0 , V_105 ,
! V_8 -> V_106 ? 0x00 : 0x02 ) ;
}
...
static int F_64 ( struct V_5 * V_6 , T_2 V_108 )
{
F_60 ( V_6 ) ;
return 0 ;
}
...
V_115 = F_73 ( V_6 , 0x1a , 0 , V_41 , 0 ) ;
F_74 ( V_6 , 0x1b , V_41 , 0 ,
V_117 , V_115 ) ;
}
static void F_75 ( struct V_5 * V_6 )
{
struct V_7 * V_8 = V_6 -> V_8 ;
V_8 -> V_116 = F_69 ( V_6 , 0x1a ) ;
if ( V_8 -> V_118 )
V_8 -> V_116 = ! V_8 -> V_116 ;
F_72 ( V_6 ) ;
}
static void F_76 ( struct V_5 * V_6 , unsigned int V_113 )
{
if ( ( V_113 >> 26 ) != V_119 )
return;
F_75 ( V_6 ) ;
...
int V_121 ;
V_121 = F_79 ( V_6 , 0x1a , 0 , V_41 , 0 ,
V_117 ,
V_120 [ 0 ] ? 0 : V_117 ) ;
V_121 |= F_79 ( V_6 , 0x1a , 1 , V_41 , 0 ,
V_117 ,
V_120 [ 1 ] ? 0 : V_117 ) ;
if ( V_121 )
F_72 ( V_6 ) ;
...
static int F_82 ( struct V_5 * V_6 , T_1 V_49 )
{
unsigned int V_122 = F_83 ( V_6 , V_49 ) ;
return F_84 ( V_122 ) != V_123 ;
}
static int F_85 ( struct V_5 * V_6 )
{
struct V_7 * V_8 ;
int V_23 , V_124 ;
V_8 = F_86 ( sizeof( * V_8 ) , V_125 ) ;
if ( V_8 == NULL )
return - V_37 ;
V_6 -> V_8 = V_8 ;
V_23 = F_87 ( V_6 , 0x19 ) ;
...
F_88 ( V_8 , 0x18 , 0 , V_41 ) ;
V_8 -> V_26 . V_87 = 6 ;
V_8 -> V_26 . V_126 = F_89 ( V_127 ) ;
V_8 -> V_26 . V_88 = V_127 ;
V_8 -> V_26 . V_27 = V_128 ;
V_8 -> V_92 = 1 ;
V_8 -> V_76 = V_129 ;
...
V_8 -> V_26 . V_27 = 0 ;
V_8 -> V_9 = & V_159 ;
V_6 -> V_136 . V_160 = F_70 ;
V_6 -> V_136 . V_161 = F_71 ;
break;
case V_162 :
V_8 -> V_24 = 2 ;
V_8 -> V_25 [ 0 ] = V_163 ;
...
V_8 -> V_26 . V_27 = 0 ;
V_8 -> V_9 = & V_159 ;
V_6 -> V_136 . V_160 = F_80 ;
V_6 -> V_136 . V_161 = F_81 ;
break;
case V_165 :
V_8 -> V_24 = 3 ;
V_8 -> V_25 [ 0 ] = V_163 ;
...
V_8 -> V_26 . V_27 = 0 ;
V_8 -> V_9 = & V_156 ;
V_6 -> V_136 . V_160 = F_76 ;
V_6 -> V_136 . V_161 = F_77 ;
V_8 -> V_118 = 1 ;
break;
case V_166 :
V_8 -> V_25 [ 0 ] = V_153 ;
...
{
static const char * const V_61 [] = { L_13 , L_14 } ;
V_4 -> type = V_63 ;
V_4 -> V_46 = 1 ;
V_4 -> V_14 . V_15 . V_64 = 2 ;
...
static int F_93 ( struct V_1 * V_2 , struct V_10 * V_11 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
...
F_88 ( V_8 , 0x10 , 0 , V_41 ) ;
V_8 -> V_26 . V_87 = 2 ;
V_8 -> V_26 . V_126 = F_89 ( V_173 ) ;
V_8 -> V_26 . V_88 = V_173 ;
V_8 -> V_26 . V_27 = V_174 ;
V_8 -> V_92 = 1 ;
V_8 -> V_76 = V_175 ;
...
F_88 ( V_8 , 0x0d , 0 , V_41 ) ;
V_8 -> V_26 . V_87 = 2 ;
V_8 -> V_26 . V_126 = F_89 ( V_189 ) ;
V_8 -> V_26 . V_88 = V_189 ;
V_8 -> V_26 . V_27 = V_190 ;
V_8 -> V_92 = 1 ;
V_8 -> V_76 = V_191 ;
...
V_8 -> V_26 . V_27 = 0 ;
V_8 -> V_9 = & V_203 ;
V_6 -> V_136 . V_161 = F_100 ;
V_6 -> V_136 . V_160 = F_99 ;
F_102 ( V_6 , 0x11 , V_204 ,
( 0x17 << V_205 ) |
( 0x17 << V_206 ) |
( 0x05 << V_207 ) |
( 1 << V_208 ) ) ;
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
return F_104 ( V_6 , V_4 , V_8 -> V_144 ,
V_8 -> V_146 ) ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
return F_106 ( V_6 , V_11 , V_8 -> V_144 ,
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
int V_23 = F_108 ( V_6 , V_11 , V_8 -> V_144 ,
V_8 -> V_146 ,
& V_8 -> V_26 . V_87 ) ;
if ( V_23 >= 0 && V_8 -> V_147 )
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
unsigned int V_215 ;
V_215 = F_111 ( V_6 , 0x1d , 0 , V_216 ,
V_217 ) ;
if ( ! ( V_215 & 0x80 ) )
V_11 -> V_14 . V_15 . V_16 [ 0 ] = 0 ;
else {
V_215 = F_111 ( V_6 , 0x0b , 0 ,
V_218 , 0 ) ;
if ( V_215 < 3 )
V_215 ++ ;
else
...
static void F_115 ( struct V_5 * V_6 , unsigned int V_113 )
{
if ( ( V_113 >> 26 ) != V_220 )
return;
if ( F_69 ( V_6 , 0x11 ) )
...
static int F_116 ( struct V_7 * V_8 , int type , const char * V_36 ,
unsigned long V_219 )
{
struct V_31 * V_32 ;
F_117 ( & V_8 -> V_99 , sizeof( * V_32 ) , 32 ) ;
V_32 = F_118 ( & V_8 -> V_99 ) ;
if ( ! V_32 )
return - V_37 ;
* V_32 = V_223 [ type ] ;
V_32 -> V_36 = F_119 ( V_36 , V_125 ) ;
if ( ! V_32 -> V_36 )
return - V_37 ;
if ( F_120 ( V_219 ) )
V_32 -> V_224 = V_225 ;
...
static inline T_1 F_121 ( struct V_5 * V_6 , int V_226 )
{
...
static int F_123 ( T_1 V_49 )
{
static const T_1 V_229 [ 8 ] = {
0x11 , 0x14 , 0x15 , 0x12 , 0x17 , 0x16 , 0x24 , 0x25
} ;
int V_19 ;
for ( V_19 = 0 ; V_19 < F_89 ( V_229 ) ; V_19 ++ )
if ( V_229 [ V_19 ] == V_49 )
return V_19 ;
return 0 ;
}
...
V_226 = F_123 ( V_233 -> V_236 [ V_19 ] ) ;
V_8 -> V_234 [ V_19 ] = F_121 ( V_6 , V_226 ) ;
}
...
if ( ! V_238 )
continue;
V_49 = V_239 [ F_123 ( V_233 -> V_236 [ V_19 ] ) ] ;
if ( V_19 == 2 ) {
V_23 = F_116 ( V_8 , V_240 ,
L_21 ,
F_128 ( V_238 , 1 , 0 , V_41 ) ) ;
if ( V_23 < 0 )
return V_23 ;
V_23 = F_116 ( V_8 , V_240 ,
L_22 ,
F_128 ( V_238 , 2 , 0 , V_41 ) ) ;
if ( V_23 < 0 )
return V_23 ;
V_23 = F_116 ( V_8 , V_241 ,
L_23 ,
F_128 ( V_49 , 1 , 2 , V_204 ) ) ;
if ( V_23 < 0 )
return V_23 ;
V_23 = F_116 ( V_8 , V_241 ,
L_24 ,
F_128 ( V_49 , 2 , 2 , V_204 ) ) ;
if ( V_23 < 0 )
return V_23 ;
} else {
sprintf ( V_36 , L_25 , V_237 [ V_19 ] ) ;
V_23 = F_116 ( V_8 , V_240 , V_36 ,
F_128 ( V_238 , 3 , 0 , V_41 ) ) ;
if ( V_23 < 0 )
return V_23 ;
sprintf ( V_36 , L_26 , V_237 [ V_19 ] ) ;
V_23 = F_116 ( V_8 , V_241 , V_36 ,
F_128 ( V_49 , 3 , 2 , V_204 ) ) ;
if ( V_23 < 0 )
return V_23 ;
}
}
...
static int F_129 ( struct V_5 * V_6 , T_1 V_242 ,
const char * V_243 )
{
struct V_7 * V_8 = V_6 -> V_8 ;
T_1 V_49 ;
...
V_49 = V_239 [ V_226 ] ;
sprintf ( V_36 , L_26 , V_243 ) ;
if ( ( V_23 = F_116 ( V_8 , V_241 , V_36 ,
F_128 ( V_49 , 3 , 2 , V_204 ) ) ) < 0 )
return V_23 ;
return 0 ;
}
static int F_130 ( struct V_7 * V_8 , T_1 V_242 ,
const char * V_246 , int V_247 , int V_248 )
{
char V_36 [ 32 ] ;
int V_23 , V_226 ;
sprintf ( V_36 , L_25 , V_246 ) ;
V_226 = F_124 ( V_242 ) ;
if ( ( V_23 = F_116 ( V_8 , V_240 , V_36 ,
F_128 ( 0x20 , 3 , V_226 , V_204 ) ) ) < 0 )
return V_23 ;
sprintf ( V_36 , L_26 , V_246 ) ;
if ( ( V_23 = F_116 ( V_8 , V_249 , V_36 ,
F_128 ( 0x20 , 3 , V_226 , V_204 ) ) ) < 0 )
return V_23 ;
if ( V_248 ) {
T_1 V_250 ;
...
return F_116 ( V_8 , V_240 , V_36 ,
F_128 ( V_250 , 3 , V_226 , V_41 ) ) ;
}
}
return 0 ;
}
...
V_257 = F_132 ( V_6 , V_233 , V_19 ) ;
F_133 ( V_253 , V_257 ,
F_125 ( V_233 -> V_258 [ V_19 ] . V_242 ) ,
& V_255 ) ;
V_23 = F_130 ( V_8 , V_233 -> V_258 [ V_19 ] . V_242 ,
V_257 , V_255 ,
type == V_259 ) ;
if ( V_23 < 0 )
return V_23 ;
}
F_133 ( V_253 , L_28 , 9 , NULL ) ;
if ( ( V_23 = F_116 ( V_8 , V_240 ,
L_29 ,
F_128 ( 0x21 , 3 , 0x0 , V_41 ) ) ) < 0 )
return V_23 ;
if ( ( V_23 = F_116 ( V_8 , V_249 ,
L_30 ,
F_128 ( 0x21 , 3 , 0x0 , V_41 ) ) ) < 0 )
return V_23 ;
return 0 ;
...
int V_261 )
{
F_58 ( V_6 , V_49 , 0 , V_181 , V_260 ) ;
F_58 ( V_6 , V_49 , 0 , V_185 , V_262 ) ;
switch ( V_49 ) {
case 0x11 :
F_58 ( V_6 , 0x37 , 0 , V_112 , 0x00 ) ;
break;
case 0x14 :
F_58 ( V_6 , 0x30 , 0 , V_112 , 0x02 ) ;
break;
case 0x15 :
F_58 ( V_6 , 0x31 , 0 , V_112 , 0x00 ) ;
break;
case 0x17 :
F_58 ( V_6 , 0x32 , 0 , V_112 , 0x01 ) ;
break;
case 0x13 :
F_58 ( V_6 , 0x36 , 0 , V_112 , 0x01 ) ;
break;
}
}
...
if ( V_242 )
F_134 ( V_6 , V_242 , V_182 , 0 ) ;
V_242 = V_8 -> V_244 . V_264 [ 0 ] ;
if ( V_242 )
F_134 ( V_6 , V_242 , V_265 , 0 ) ;
}
...
switch ( V_49 ) {
case 0x15 :
F_58 ( V_6 , 0x33 , 0 , V_112 , 0x0 ) ;
break;
case 0x17 :
F_58 ( V_6 , 0x34 , 0 , V_112 , 0x0 ) ;
break;
}
F_58 ( V_6 , V_49 , 0 , V_181 ,
type == V_259 ? V_266 : V_267 ) ;
if ( V_49 != V_231 )
F_58 ( V_6 , V_49 , 0 , V_185 ,
V_268 ) ;
V_226 = F_123 ( V_49 ) ;
if ( V_251 [ V_226 ] )
F_58 ( V_6 , V_251 [ V_226 ] , 0 ,
V_185 ,
V_269 ) ;
}
}
...
struct V_7 * V_8 = V_6 -> V_8 ;
int V_23 ;
if ( ( V_23 = F_139 ( V_6 , & V_8 -> V_244 , NULL ) ) < 0 )
return V_23 ;
if ( ( V_23 = F_126 ( V_6 , & V_8 -> V_244 ) ) < 0 )
return V_23 ;
if ( ! V_8 -> V_244 . V_235 )
return 0 ;
if ( ( V_23 = F_127 ( V_8 , & V_8 -> V_244 ) ) < 0 ||
( V_23 = F_129 ( V_6 ,
V_8 -> V_244 . V_263 [ 0 ] ,
L_31 ) ) < 0 ||
( V_23 = F_129 ( V_6 , V_8 -> V_244 . V_264 [ 0 ] ,
L_32 ) ) < 0 ||
( V_23 = F_131 ( V_6 , & V_8 -> V_244 ) ) < 0 )
return V_23 ;
...
V_8 -> V_76 = V_308 ;
V_8 -> V_18 = V_309 ;
V_8 -> V_25 [ V_8 -> V_24 ++ ] = V_310 ;
V_8 -> V_21 [ V_8 -> V_20 ++ ] = V_311 ;
if ( V_8 -> V_26 . V_27 ) {
...
switch ( V_124 ) {
case V_280 :
V_6 -> V_136 . V_161 = F_140 ;
break;
case V_299 :
case V_300 :
V_6 -> V_136 . V_160 = F_115 ;
break;
}
#ifdef F_90
V_8 -> V_50 . V_134 = V_320 ;
#endif
V_8 -> V_40 = 0x04 ;
V_6 -> V_169 = 1 ;
V_6 -> V_170 = 1 ;
...
static int F_145 ( struct V_69 * V_70 ,
struct V_5 * V_6 ,
unsigned int V_73 ,
unsigned int V_74 ,
struct V_71 * V_72 )
{
F_50 ( V_6 , 0x05 + V_72 -> V_77 ,
V_73 , 0 , V_74 ) ;
return 0 ;
}
...
return V_23 ;
V_8 = V_6 -> V_8 ;
V_124 = F_91 ( V_6 , V_331 ,
V_332 , V_333 ) ;
switch ( V_124 ) {
case V_334 :
V_8 -> V_25 [ V_8 -> V_24 ++ ] = V_335 ;
V_6 -> V_136 . V_336 = F_147 ;
break;
case V_337 :
if ( V_6 -> V_338 == 0x17aa20fb ) {
V_8 -> V_26 . V_27 = 0 ;
} else
V_8 -> V_26 . V_27 = V_322 ;
V_8 -> V_9 = & V_339 ;
V_8 -> V_25 [ 0 ] = V_340 ;
V_8 -> V_21 [ V_8 -> V_20 ++ ] = V_341 ;
V_8 -> V_33 = 1 ;
break;
case V_342 :
V_8 -> V_26 . V_27 = 0 ;
...
unsigned int V_111 ;
V_111 = F_69 ( V_6 , 0x11 ) ;
F_74 ( V_6 , 0x16 , V_41 , 0 ,
V_117 , V_111 ? V_117 : 0 ) ;
F_58 ( V_6 , 0x16 , 0 , V_105 ,
V_111 ? 0x00 : 0x02 ) ;
}
...
unsigned int V_111 ;
V_111 = F_69 ( V_6 , 0x14 ) ;
F_58 ( V_6 , 0x0c , 0 , V_112 ,
V_111 ? 0 : 1 ) ;
}
static void F_153 ( struct V_5 * V_6 , unsigned int V_113 )
{
switch ( V_113 >> 26 ) {
case V_347 :
F_151 ( V_6 ) ;
...
if ( F_69 ( V_6 , 0x14 ) )
V_226 = 0 ;
else if ( F_69 ( V_6 , 0x1c ) )
V_226 = 4 ;
else
V_226 = 1 ;
F_58 ( V_6 , 0x0c , 0 , V_112 , V_226 ) ;
}
...
V_8 -> V_171 = 0 ;
#ifdef F_90
V_8 -> V_50 . V_134 = V_356 ;
#endif
V_6 -> V_136 = V_137 ;
V_124 = F_91 ( V_6 , V_357 ,
V_358 ,
V_359 ) ;
switch ( V_124 ) {
case V_360 :
V_8 -> V_25 [ 0 ] = V_361 ;
V_8 -> V_21 [ V_8 -> V_20 ++ ] = V_362 ;
V_8 -> V_26 . V_27 = 0 ;
V_6 -> V_136 . V_160 = F_157 ;
V_6 -> V_136 . V_161 = F_158 ;
F_102 ( V_6 , 0x20 , V_204 ,
( 0x17 << V_205 ) |
( 0x17 << V_206 ) |
( 0x05 << V_207 ) |
( 1 << V_208 ) ) ;
...
V_8 -> V_21 [ 0 ] = V_365 ;
V_8 -> V_26 . V_27 = 0 ;
V_6 -> V_136 . V_160 = F_153 ;
V_6 -> V_136 . V_161 = F_154 ;
F_102 ( V_6 , 0x20 , V_204 ,
( 0x17 << V_205 ) |
( 0x17 << V_206 ) |
( 0x05 << V_207 ) |
...
V_8 -> V_171 = 0 ;
#ifdef F_90
V_8 -> V_50 . V_134 = V_386 ;
#endif
V_8 -> V_40 = 0x04 ;
V_6 -> V_136 = V_137 ;
V_124 = F_91 ( V_6 , V_387 ,
V_388 , NULL ) ;
switch ( V_124 ) {
default:
case V_389 :
