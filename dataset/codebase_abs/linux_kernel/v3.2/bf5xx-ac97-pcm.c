...
V_65 -> V_63 -> V_77 = & V_78 ;
if ( ! V_65 -> V_63 -> V_79 )
V_65 -> V_63 -> V_79 = F_37 ( 32 ) ;
if ( V_76 -> V_80 -> V_81 . V_82 ) {
V_35 = F_32 ( V_25 ,
V_13 ) ;
if ( V_35 )
goto V_49;
}
if ( V_76 -> V_80 -> V_83 . V_82 ) {
V_35 = F_32 ( V_25 ,
V_84 ) ;
if ( V_35 )
goto V_49;
...
static int T_4 F_38 ( struct V_85 * V_86 )
{
return F_39 ( & V_86 -> V_63 , & V_87 ) ;
}
static int T_5 F_40 ( struct V_85 * V_86 )
{
F_41 ( & V_86 -> V_63 ) ;
return 0 ;
}
