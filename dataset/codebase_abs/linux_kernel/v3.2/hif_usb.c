...
static int F_84 ( struct V_13 * V_10 , T_4 V_106 )
{
int V_15 , V_67 ;
struct V_121 * V_122 = & V_10 -> V_123 -> V_124 [ 0 ] ;
struct V_125 * V_126 ;
V_15 = F_85 ( & V_10 -> V_108 , V_10 -> V_120 ,
& V_10 -> V_18 -> V_65 ) ;
if ( V_15 ) {
F_45 ( & V_10 -> V_18 -> V_65 ,
L_5 , V_10 -> V_120 ) ;
...
static void F_87 ( struct V_13 * V_10 )
{
F_78 ( V_10 ) ;
if ( V_10 -> V_108 )
F_86 ( V_10 -> V_108 ) ;
}
static int F_88 ( struct V_137 * V_123 )
{
struct V_138 * V_18 = F_89 ( V_123 ) ;
...
V_3 [ 19 ] = 0x2 ;
F_83 ( & V_18 -> V_65 , L_9 ) ;
V_141 = F_92 ( V_18 , F_10 ( V_18 , V_140 ) ,
V_3 , 31 , NULL , 2000 ) ;
F_3 ( V_3 ) ;
if ( V_141 )
return V_141 ;
...
static int F_94 ( struct V_137 * V_123 ,
...
static void F_101 ( struct V_138 * V_18 )
{
T_4 V_158 = 0xffffffff ;
void * V_47 ;
int V_15 ;
V_47 = F_102 ( & V_158 , 4 , V_16 ) ;
if ( ! V_47 )
return;
V_15 = F_92 ( V_18 , F_10 ( V_18 , V_19 ) ,
V_47 , 4 , NULL , V_115 ) ;
if ( V_15 )
F_45 ( & V_18 -> V_65 , L_11 ) ;
F_3 ( V_47 ) ;
}
static void F_103 ( struct V_137 * V_123 )
{
struct V_138 * V_18 = F_89 ( V_123 ) ;
struct V_13 * V_10 = F_58 ( V_123 ) ;
bool V_159 = ( V_18 -> V_160 == V_161 ) ? true : false ;
if ( ! V_10 )
return;
F_104 ( V_10 -> V_11 , V_159 ) ;
F_99 ( V_10 -> V_11 ) ;
F_87 ( V_10 ) ;
F_93 ( V_123 , NULL ) ;
...
static int F_105 ( struct V_137 * V_123 ,
T_6 V_162 )
{
struct V_13 * V_10 = F_58 ( V_123 ) ;
if ( ! ( V_10 -> V_26 & V_62 ) )
...
static int F_107 ( struct V_137 * V_123 )
{
struct V_13 * V_10 = F_58 ( V_123 ) ;
