...
F_3 ( L_15 , V_38 , V_33 -> V_5 [ V_38 ] . type ) ;
F_3 ( L_16 , V_38 , V_33 -> V_5 [ V_38 ] . V_49 ) ;
F_3 ( L_17 , V_38 , V_33 -> V_5 [ V_38 ] . V_50 ) ;
F_3 ( L_18 , V_38 , V_33 -> V_5 [ V_38 ] . V_47 ) ;
}
return 0 ;
}
...
F_3 ( L_19 , V_38 , V_33 -> V_53 [ V_38 ] . V_54 ) ;
F_3 ( L_20 , V_38 , V_33 -> V_53 [ V_38 ] . V_56 ) ;
F_3 ( L_21 , V_38 , V_33 -> V_53 [ V_38 ] . V_57 ) ;
F_3 ( L_22 , V_38 , V_33 -> V_53 [ V_38 ] . V_58 ) ;
F_3 ( L_23 , V_38 , V_33 -> V_53 [ V_38 ] . V_59 ) ;
F_3 ( L_24 , V_38 , V_33 -> V_53 [ V_38 ] . V_60 ) ;
}
return 0 ;
}
...
F_35 ( V_12 , V_64 , F_29 , NULL ) ;
F_35 ( V_12 , V_65 , F_31 , NULL ) ;
F_35 ( V_12 , V_66 , F_32 , V_5 ) ;
F_35 ( V_12 , V_67 , F_33 , V_5 ) ;
if( ! V_5 -> V_46 . V_47 )
V_5 -> V_46 . V_47 = V_68 ;
if( ! V_5 -> V_46 . V_52 )
V_5 -> V_46 . V_52 = 2 ;
...
int V_11 ;
F_3 ( L_34 ,
( unsigned long ) F_37 ( V_26 -> V_7 [ 2 ] ) >> 10 ,
V_89 ) ;
V_11 = F_38 ( V_26 , V_26 -> V_7 [ 2 ] , V_89 ) ;
...
F_37 ( V_26 -> V_7 [ 2 ] ) >> 10 ) ;
V_5 -> V_13 = F_37 ( V_26 -> V_7 [ 2 ] ) ;
break;
}
} while ( V_26 -> V_7 [ 2 ] -> V_29 >= 0x1000 );
F_3 ( L_37 , V_5 -> V_13 ) ;
if( ! V_5 -> V_13 ) {
F_39 ( & V_5 -> V_12 -> V_5 , L_38 ) ;
F_26 ( V_26 ) ;
return - V_90 ;
}
F_3 ( L_39 , V_5 -> V_13 >> 10 ) ;
V_5 -> V_14 = F_40 ( V_26 -> V_7 [ 2 ] -> V_88 ,
F_37 ( V_26 -> V_7 [ 2 ] ) ) ;
if( ! V_5 -> V_14 ) {
F_39 ( & V_5 -> V_12 -> V_5 , L_40 ,
V_26 -> V_7 [ 2 ] ) ;
F_26 ( V_26 ) ;
return - V_90 ;
}
...
if( V_94 == 1 ) {
V_72 = F_42 ( L_43 , & V_5 -> V_46 ) ;
} else if( V_94 == 2 ) {
V_72 = F_42 ( L_44 , & V_5 -> V_46 ) ;
} else {
for( V_38 = 0 ; V_38 < F_43 ( V_74 ) ; V_38 ++ ) {
F_3 ( L_45 , V_74 [ V_38 ] ) ;
V_72 = F_42 ( V_74 [ V_38 ] , & V_5 -> V_46 ) ;
if( V_72 )
break;
F_3 ( L_46 , V_74 [ V_38 ] ) ;
}
...
F_46 ( & V_5 -> V_12 -> V_5 , L_51 , V_72 -> V_98 , V_72 -> V_70 ) ;
return 0 ;
}
static int F_47 ( struct V_25 * V_5 )
{
F_3 ( L_52 ) ;
return 0 ;
}
