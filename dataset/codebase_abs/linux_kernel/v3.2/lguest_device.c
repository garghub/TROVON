...
V_30 = F_32 ( V_32 -> V_34 . V_44 , V_45 ,
V_14 , V_32 -> V_2 , F_24 , F_26 , V_37 ) ;
if ( ! V_30 ) {
V_40 = - V_43 ;
goto V_47;
}
F_33 ( V_32 -> V_34 . V_48 ) ;
V_40 = F_34 ( V_32 -> V_34 . V_48 , V_49 , V_50 ,
F_35 ( & V_14 -> V_51 ) , V_30 ) ;
if ( V_40 )
goto V_52;
V_30 -> V_33 = V_32 ;
...
static int F_42 ( struct V_13 * V_14 , unsigned V_54 ,
struct V_29 * V_55 [] ,
T_3 * V_56 [] ,
const char * V_57 [] )
{
struct V_38 * V_39 = F_10 ( V_14 ) ;
int V_15 ;
if ( V_54 > V_39 -> V_9 -> V_10 )
return - V_41 ;
for ( V_15 = 0 ; V_15 < V_54 ; ++ V_15 ) {
V_55 [ V_15 ] = F_25 ( V_14 , V_15 , V_56 [ V_15 ] , V_57 [ V_15 ] ) ;
if ( F_43 ( V_55 [ V_15 ] ) )
goto error;
}
return 0 ;
error:
F_40 ( V_14 ) ;
return F_44 ( V_55 [ V_15 ] ) ;
}
static void F_45 ( struct V_8 * V_58 ,
unsigned int V_18 )
{
struct V_38 * V_39 ;
V_39 = F_46 ( sizeof( * V_39 ) , V_42 ) ;
if ( ! V_39 ) {
F_29 ( V_59 L_2 ,
V_18 , V_58 -> type ) ;
return;
}
V_39 -> V_14 . V_51 . V_60 = V_61 ;
V_39 -> V_14 . V_62 . V_63 = V_58 -> type ;
V_39 -> V_14 . V_34 = & V_64 ;
V_39 -> V_9 = V_58 ;
if ( F_47 ( & V_39 -> V_14 ) != 0 ) {
F_29 ( V_65 L_3 ,
...
unsigned int V_15 ;
struct V_8 * V_58 ;
for ( V_15 = 0 ; V_15 < V_4 ; V_15 += F_8 ( V_58 ) ) {
V_58 = V_19 + V_15 ;
if ( V_58 -> type == 0 )
break;
F_29 ( L_4 , V_15 , F_8 ( V_58 ) ) ;
F_45 ( V_58 , V_15 ) ;
}
}
static int T_4 F_49 ( void )
{
if ( strcmp ( V_66 . V_37 , L_5 ) != 0 )
return 0 ;
V_61 = F_50 ( L_5 ) ;
if ( F_43 ( V_61 ) )
F_51 ( L_6 ) ;
