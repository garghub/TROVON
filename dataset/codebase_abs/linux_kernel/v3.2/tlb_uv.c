...
static void F_114 ( int V_4 , int V_55 )
{
int V_6 ;
T_9 V_269 ;
char * V_270 ;
...
struct V_13 * V_276 ;
struct V_10 * V_11 ;
V_269 = ( V_28 + 1 ) * sizeof( struct V_13 ) ;
V_271 = F_107 ( V_269 , V_216 , V_4 ) ;
V_276 = (struct V_13 * ) V_271 ;
F_108 ( ! V_276 ) ;
V_270 = ( char * ) V_276 + 31 ;
V_276 = (struct V_13 * ) ( ( ( unsigned long ) V_270 >> 5 ) << 5 ) ;
F_6 (cpu) {
if ( V_55 != F_84 ( V_6 ) )
continue;
V_11 = & F_8 ( V_10 , V_6 ) ;
V_11 -> V_30 = V_276 ;
V_11 -> V_194 = V_276 ;
V_11 -> V_29 = V_276 + ( V_28 - 1 ) ;
}
V_272 = F_110 ( F_109 ( V_276 ) ) ;
V_273 = F_115 ( V_276 ) ;
V_274 = ( ( unsigned long ) V_272 << V_277 ) | V_273 ;
V_275 = F_115 ( V_276 + ( V_28 - 1 ) ) ;
F_116 ( V_55 , V_274 ) ;
F_117 ( V_55 , V_273 ) ;
F_118 ( V_55 , V_275 ) ;
memset ( V_276 , 0 , sizeof( struct V_13 ) * V_28 ) ;
}
static void T_1 F_119 ( int V_3 , int V_278 , int V_254 )
{
int V_4 ;
int V_55 ;
unsigned long V_279 ;
...
V_281 = V_203 & V_285 ;
V_200 = F_29 ( V_286 ) ;
V_154 = ( V_200 >> V_287 ) & V_288 ;
V_200 = F_29 ( V_289 ) ;
V_282 = ( V_200 >> V_290 ) & V_291 ;
V_283 = V_292 [ V_154 ] ;
V_284 = V_283 * V_281 * V_282 ;
V_215 = V_284 / 1000 ;
} else {
V_200 = F_29 ( V_286 ) ;
V_200 = ( V_200 & V_293 ) >> V_294 ;
if ( V_200 & ( 1L << V_295 ) )
V_281 = 80 ;
else
V_281 = 10 ;
...
static int T_1 F_123 ( int V_254 ,
struct V_298 * V_299 ,
unsigned char * V_300 )
{
int V_6 ;
...
V_301 = V_11 -> V_306 & 1 ;
V_302 -> V_309 |= ( 1 << V_301 ) ;
V_304 = & V_302 -> V_301 [ V_301 ] ;
V_304 -> V_310 [ V_304 -> V_308 ] = V_6 ;
V_304 -> V_308 ++ ;
if ( V_304 -> V_308 > V_311 ) {
F_92 ( V_305 L_26 ,
V_304 -> V_308 ) ;
return 1 ;
}
...
static void F_126 ( struct V_10 * V_40 )
{
int V_6 ;
T_9 V_312 = sizeof( struct V_56 ) * F_76 () ;
V_40 -> V_58 = F_107 ( V_312 , V_216 , V_40 -> V_306 ) ;
memset ( V_40 -> V_58 , 0 , V_312 ) ;
F_6 (cpu) {
V_40 -> V_58 [ V_6 ] . V_55 = F_124 ( V_6 ) -> V_55 ;
V_40 -> V_58 [ V_6 ] . V_3 = F_124 ( V_6 ) -> V_307 ;
}
}
static void F_127 ( struct V_10 * V_78 )
{
int V_313 = sizeof( T_2 ) ;
V_78 -> V_70 = F_128 ( V_313 , V_216 , V_78 -> V_306 ) ;
}
static int F_129 ( struct V_303 * V_304 , struct V_298 * V_302 ,
struct V_10 * * V_314 ,
struct V_10 * * V_315 )
{
int V_19 ;
int V_6 ;
struct V_10 * V_11 ;
for ( V_19 = 0 ; V_19 < V_304 -> V_308 ; V_19 ++ ) {
V_6 = V_304 -> V_310 [ V_19 ] ;
V_11 = & F_8 ( V_10 , V_6 ) ;
V_11 -> V_6 = V_6 ;
if ( V_19 == 0 ) {
* V_314 = V_11 ;
...
V_11 -> V_54 = V_302 -> V_308 ;
V_11 -> V_51 = V_304 -> V_308 ;
V_11 -> V_41 = * V_314 ;
V_11 -> V_3 = V_302 -> V_3 ;
V_11 -> V_48 = * V_315 ;
V_11 -> V_103 = F_124 ( V_6 ) -> V_316 ;
if ( V_11 -> V_103 >= V_317 ) {
F_92 ( V_305 L_27 ,
V_11 -> V_103 ) ;
return 1 ;
...
static int T_1 F_130 ( int V_199 ,
struct V_298 * V_299 ,
unsigned char * V_300 )
{
int V_301 ;
...
if ( ( V_309 & 1 ) ) {
V_304 = & V_302 -> V_301 [ V_301 ] ;
if ( F_129 ( V_304 , V_302 , & V_40 , & V_78 ) )
return 1 ;
F_126 ( V_40 ) ;
}
V_301 ++ ;
...
static int T_1 F_131 ( int V_199 , int V_318 )
{
unsigned char * V_300 ;
void * V_271 ;
struct V_298 * V_299 ;
V_94 = F_121 () ;
V_271 = F_132 ( V_199 * sizeof( struct V_298 ) , V_216 ) ;
V_299 = (struct V_298 * ) V_271 ;
memset ( V_299 , 0 , V_199 * sizeof( struct V_298 ) ) ;
V_300 = F_133 ( ( V_199 + 7 ) / 8 , V_216 ) ;
if ( F_123 ( V_318 , V_299 , V_300 ) )
goto V_319;
if ( F_130 ( V_199 , V_299 , V_300 ) )
goto V_319;
F_88 ( V_299 ) ;
F_88 ( V_300 ) ;
F_122 () ;
...
return 0 ;
F_135 (cur_cpu) {
V_69 = & F_8 ( V_183 , V_320 ) ;
F_136 ( V_69 , V_216 , F_125 ( V_320 ) ) ;
}
V_199 = F_69 () ;
F_137 ( & V_124 ) ;
V_128 = F_79 ( V_217 ) ;
...
for ( V_3 = 0 ; V_3 < V_199 ; V_3 ++ ) {
V_321 = F_70 ( V_3 ) ;
if ( V_321 && ( F_71 ( V_3 ) < V_322 ) )
V_322 = F_71 ( V_3 ) ;
}
if ( F_131 ( V_199 , V_322 ) ) {
V_2 = 1 ;
return 0 ;
}
V_278 = V_323 ;
