...
static int F_20 ( struct V_1 * V_2 , T_2 V_81 )
{
F_17 ( V_2 , V_78 ) ;
return 0 ;
}
...
{
int V_82 = 0 ;
V_82 = F_23 ( V_2 , 7 , 9 , V_83 ) ;
if ( V_82 < 0 ) {
F_24 ( V_2 -> V_84 , L_2 , V_82 ) ;
return V_82 ;
}
V_82 = F_25 ( V_2 ) ;
if ( V_82 < 0 ) {
...
static T_3 int F_28 ( struct V_86 * V_87 ,
const struct V_88 * V_89 )
{
struct V_90 * V_91 ;
int V_82 ;
V_91 = F_29 ( sizeof( struct V_90 ) , V_92 ) ;
if ( V_91 == NULL )
return - V_93 ;
F_30 ( V_87 , V_91 ) ;
V_82 = F_31 ( & V_87 -> V_84 ,
...
static T_4 int F_33 ( struct V_86 * V_96 )
{
F_34 ( & V_96 -> V_84 ) ;
F_32 ( F_35 ( V_96 ) ) ;
return 0 ;
