...
if ( V_7 -> V_115 . V_205 == V_115 -> V_205 &&
V_7 -> V_115 . V_206 == V_115 -> V_206 )
return 0 ;
V_202 = V_115 -> V_206 ;
if ( ! ( V_115 -> V_207 & V_208 ) )
V_202 += V_7 -> V_115 . V_159 ;
if ( V_202 > V_7 -> V_115 . V_142 )
return - V_34 ;
F_43 ( & V_10 -> V_175 ) ;
V_181 = V_115 -> V_206 * V_7 -> V_113 . V_117
+ V_115 -> V_205 * ( V_7 -> V_115 . V_119 / 8 ) ;
V_203 = V_7 -> V_113 . V_144 + V_181 ;
F_8 ( V_7 -> V_19 , L_26 ,
V_10 -> V_167 , V_203 ) ;
F_52 ( & V_10 -> V_134 ) ;
F_53 ( V_10 -> V_11 -> V_133 ) ;
V_174 = F_54 ( & V_10 -> V_134 , V_209 / 10 ) ;
if ( V_174 <= 0 ) {
F_44 ( & V_10 -> V_175 ) ;
...
static struct V_111 * F_66 ( struct V_19 * V_17 , struct V_222 * V_223 )
{
struct V_111 * V_7 ;
struct V_6 * V_224 ;
int V_174 ;
...
if ( ! F_73 ( & V_7 -> V_115 , V_7 , V_238 , V_137 ,
V_236 , NULL , V_178 ) ) {
V_174 = - V_218 ;
goto V_239;
}
F_74 ( V_137 , V_236 , & V_7 -> V_241 ) ;
...
if ( ! V_260 || ! * V_260 )
return 0 ;
while ( ( V_259 = F_101 ( & V_260 , L_41 ) ) != NULL ) {
if ( ! * V_259 )
continue;
if ( ! strncmp ( V_259 , L_42 , 4 ) )
