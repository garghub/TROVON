...
static int F_59 ( struct V_34 * V_35 , long V_53 )
{
long V_14 ;
V_14 = F_60 ( V_11 ,
F_61 ( & V_35 -> V_36 -> V_3 ) == 1 , V_53 ) ;
if ( V_14 < 0 )
return V_14 ;
...
V_35 -> V_42 -> V_68 = F_69 ( V_35 -> V_42 ) ;
V_35 -> V_42 -> V_69 = F_70 ( V_35 -> V_42 ) ;
F_47 ( & V_35 -> V_41 ) ;
}
...
int F_78 ( struct V_34 * V_35 , struct V_34 * V_57 )
{
...
void F_79 ( struct V_34 * V_35 , struct V_34 * V_57 )
{
F_65 () ;
F_55 ( V_35 ) ;
F_57 ( V_35 ) ;
