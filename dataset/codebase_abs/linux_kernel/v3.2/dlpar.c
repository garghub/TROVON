...
F_26 ( V_13 ) ;
#ifdef F_22
V_47 = F_27 ( strrchr ( V_13 -> V_14 , '/' ) + 1 , V_13 -> V_34 -> V_52 ) ;
if ( V_47 )
F_28 ( V_13 , V_47 ) ;
#endif
F_29 ( V_13 -> V_34 ) ;
...
{
#ifdef F_22
struct V_12 * V_34 = V_13 -> V_34 ;
struct V_1 * V_2 = V_13 -> V_15 ;
while ( V_2 ) {
F_31 ( V_2 -> V_3 , V_13 -> V_52 ) ;
V_2 = V_2 -> V_16 ;
}
if ( V_13 -> V_52 )
F_31 ( V_13 -> V_52 -> V_3 , V_34 -> V_52 ) ;
#endif
F_25 ( V_53 , V_13 ) ;
F_32 ( V_13 ) ;
F_29 ( V_13 ) ;
...
{
int V_54 , V_25 ;
V_25 = F_14 ( F_12 ( L_7 ) , 2 , 2 , & V_54 ,
V_55 , V_19 ) ;
if ( V_25 || V_54 != V_56 )
return - 1 ;
V_25 = F_34 ( V_57 , V_19 , V_58 ) ;
if ( V_25 )
return V_25 ;
V_25 = F_34 ( V_59 , V_19 , V_60 ) ;
if ( V_25 ) {
F_34 ( V_57 , V_19 , V_61 ) ;
return V_25 ;
}
...
if ( V_25 || V_54 != V_62 )
return - 1 ;
V_25 = F_34 ( V_59 , V_19 , V_63 ) ;
if ( V_25 )
return V_25 ;
V_25 = F_34 ( V_57 , V_19 , V_61 ) ;
if ( V_25 ) {
F_34 ( V_59 , V_19 , V_60 ) ;
return V_25 ;
}
...
int V_65 , V_66 , V_67 ;
const T_1 * V_68 ;
V_68 = F_37 ( V_13 , L_8 , & V_65 ) ;
if ( ! V_68 )
return - V_69 ;
V_66 = V_65 / sizeof( T_1 ) ;
F_38 () ;
for ( V_67 = 0 ; V_67 < V_66 ; V_67 ++ ) {
F_39 (cpu) {
if ( F_40 ( V_64 ) != V_68 [ V_67 ] )
continue;
F_41 ( F_42 ( V_64 )
!= V_70 ) ;
F_43 () ;
...
static T_2 F_46 ( const char * V_73 , T_3 V_74 )
{
struct V_12 * V_13 ;
unsigned long V_19 ;
char * V_75 ;
...
static T_2 F_55 ( const char * V_73 , T_3 V_74 )
{
struct V_12 * V_13 ;
const T_1 * V_19 ;
int V_25 ;
