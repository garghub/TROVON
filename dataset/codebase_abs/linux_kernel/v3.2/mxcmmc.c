...
T_4 V_98 ;
F_65 ( L_16 ) ;
V_174 = F_66 ( V_172 , V_176 , 0 ) ;
V_117 = F_67 ( V_172 , 0 ) ;
if ( ! V_174 || V_117 < 0 )
return - V_45 ;
V_175 = F_68 ( V_174 -> V_143 , F_69 ( V_174 ) , V_172 -> V_177 ) ;
if ( ! V_175 )
return - V_178 ;
...
V_4 -> V_181 = & V_182 ;
V_4 -> V_164 = V_165 | V_183 ;
V_4 -> V_184 = 64 ;
V_4 -> V_185 = 2048 ;
V_4 -> V_186 = 65535 ;
V_4 -> V_187 = V_4 -> V_185 * V_4 -> V_186 ;
V_4 -> V_188 = V_4 -> V_187 ;
V_2 = F_51 ( V_4 ) ;
...
V_2 -> V_4 = V_4 ;
V_2 -> V_6 = V_172 -> V_43 . V_190 ;
F_72 ( & V_2 -> V_66 ) ;
F_1 ( V_2 ) ;
if ( V_2 -> V_6 && V_2 -> V_6 -> V_191 )
V_2 -> V_54 =
V_192 | V_193 ;
else
V_2 -> V_54 = 0 ;
...
V_4 -> V_199 = F_52 ( V_2 -> V_136 ) >> 16 ;
V_4 -> V_200 = F_52 ( V_2 -> V_136 ) >> 1 ;
F_12 ( 0x2db4 , V_2 -> V_17 + V_201 ) ;
F_24 ( V_2 -> V_54 , V_2 -> V_17 + V_69 ) ;
V_175 = F_66 ( V_172 , V_202 , 0 ) ;
if ( V_175 ) {
V_2 -> V_203 = V_175 -> V_143 ;
V_2 -> V_170 . V_204 = V_205 ;
V_2 -> V_170 . V_206 = V_207 ;
V_2 -> V_170 . V_208 = V_2 -> V_203 ;
F_76 ( V_98 ) ;
F_77 ( V_209 , V_98 ) ;
...
F_81 ( & V_2 -> V_114 , F_41 ) ;
V_152 = F_82 ( V_2 -> V_117 , F_46 , 0 , V_210 , V_2 ) ;
if ( V_152 )
goto V_211;
F_83 ( V_172 , V_4 ) ;
if ( V_2 -> V_6 && V_2 -> V_6 -> V_212 ) {
V_152 = V_2 -> V_6 -> V_212 ( & V_172 -> V_43 , F_57 ,
V_2 -> V_4 ) ;
if ( V_152 )
goto V_213;
}
