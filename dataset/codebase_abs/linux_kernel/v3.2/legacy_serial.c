...
V_70 = F_38 ( V_12 ) ;
if ( V_70 ) {
unsigned long V_3 = ( unsigned long ) V_70 -> V_71 -
#ifdef F_39
V_72 ;
#else
V_73 ;
...
struct V_29 * V_67 = & V_28 [ V_74 ] ;
struct V_11 * V_12 = V_26 [ V_74 ] . V_12 ;
if ( V_67 -> V_17 == V_48 )
F_35 ( V_74 , V_12 , V_67 ) ;
if ( V_67 -> V_14 == V_30 )
F_37 ( V_74 , V_12 , V_67 ) ;
...
F_16 ( L_23 , V_77 -> V_38 ) ;
V_65 = F_7 ( V_77 , L_44 , NULL ) ;
if ( ! V_65 ) {
F_16 ( L_45 ) ;
goto V_80;
}
V_21 = F_7 ( V_77 , L_2 , NULL ) ;
if ( V_21 )
V_34 = F_8 ( V_21 ) ;
if ( strcmp ( V_65 , L_25 ) != 0 )
goto V_80;
for ( V_74 = 0 ; V_74 < V_25 ; V_74 ++ ) {
if ( V_77 != V_26 [ V_74 ] . V_12 )
continue;
V_3 = V_74 ;
V_34 = V_26 [ V_74 ] . V_34 ;
break;
...
F_16 ( L_46 , V_3 ) ;
if ( V_34 ) {
static char T_8 V_81 [ 16 ] ;
sprintf ( V_81 , L_47 , V_34 ) ;
return F_44 ( L_48 , V_3 , V_81 ) ;
} else
return F_44 ( L_48 , V_3 , NULL ) ;
V_80:
F_16 ( L_49 ) ;
F_31 ( V_77 ) ;
return - V_75 ;
