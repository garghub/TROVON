...
if ( V_35 < 0 )
goto V_134;
V_35 = F_85 ( V_118 , V_141 , V_2 , & V_124 ) ;
if ( V_35 < 0 ) {
F_76 (KERN_ERR SFX L_23 ) ;
goto V_134;
}
strcpy ( V_118 -> V_142 , L_24 ) ;
F_86 ( V_118 -> V_143 , L_25 , sizeof( V_118 -> V_143 ) ) ;
snprintf ( V_118 -> V_144 , sizeof( V_118 -> V_144 ) ,
L_26 ,
V_118 -> V_143 , V_2 -> V_112 [ 0 ] . V_83 , V_2 -> V_37 ) ;
strcpy ( V_118 -> V_145 , V_118 -> V_143 ) ;
F_38 ( V_2 ) ;
V_2 -> V_111 = 1 ;
* V_121 = V_2 ;
return 0 ;
...
V_35 = F_88 ( V_152 [ V_120 ] , V_153 [ V_120 ] , V_154 , 0 , & V_118 ) ;
if ( V_35 < 0 ) {
