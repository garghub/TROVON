...
static int F_20 ( struct V_1 * V_2 , T_2 V_96 )
{
F_16 ( V_2 , V_70 ) ;
return 0 ;
}
...
struct V_35 * V_36 ;
int V_60 ;
V_36 = F_24 ( sizeof( * V_36 ) , V_101 ) ;
if ( V_36 == NULL ) {
F_6 ( & V_98 -> V_10 , L_7 ) ;
return - V_102 ;
}
if ( V_98 -> V_10 . V_103 )
memcpy ( & V_36 -> V_43 , V_98 -> V_10 . V_103 ,
sizeof( V_36 -> V_43 ) ) ;
F_25 ( V_98 , V_36 ) ;
V_60 = F_26 ( & V_98 -> V_10 ,
& V_104 , NULL , 0 ) ;
...
static int T_3 F_28 ( struct V_97 * V_98 )
{
struct V_35 * V_36 = F_29 ( V_98 ) ;
F_30 ( & V_98 -> V_10 ) ;
F_27 ( V_36 ) ;
return 0 ;
}
