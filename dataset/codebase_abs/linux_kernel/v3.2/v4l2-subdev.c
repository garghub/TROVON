...
#if F_2 ( V_5 )
case V_59 : {
struct V_60 * V_61 = V_31 ;
if ( V_61 -> V_62 != V_63 &&
V_61 -> V_62 != V_64 )
return - V_65 ;
if ( V_61 -> V_66 >= V_4 -> V_8 . V_9 )
return - V_65 ;
return F_26 ( V_4 , V_66 , V_67 , V_16 , V_61 ) ;
}
case V_68 : {
struct V_60 * V_61 = V_31 ;
if ( V_61 -> V_62 != V_63 &&
...
if ( V_61 -> V_66 >= V_4 -> V_8 . V_9 )
return - V_65 ;
return F_26 ( V_4 , V_66 , V_69 , V_16 , V_61 ) ;
}
case V_70 : {
...
V_72 -> V_62 != V_64 )
return - V_65 ;
if ( V_72 -> V_66 >= V_4 -> V_8 . V_9 )
return - V_65 ;
return F_26 ( V_4 , V_66 , V_73 , V_16 , V_72 ) ;
}
case V_74 : {
struct V_71 * V_72 = V_31 ;
if ( V_72 -> V_62 != V_63 &&
...
if ( V_72 -> V_66 >= V_4 -> V_8 . V_9 )
return - V_65 ;
return F_26 ( V_4 , V_66 , V_75 , V_16 , V_72 ) ;
}
case V_76 : {
struct V_77 * V_78 = V_31 ;
if ( V_78 -> V_66 >= V_4 -> V_8 . V_9 )
return - V_65 ;
return F_26 ( V_4 , V_66 , V_79 , V_16 ,
V_78 ) ;
}
case V_80 : {
struct V_81 * V_82 = V_31 ;
if ( V_82 -> V_66 >= V_4 -> V_8 . V_9 )
return - V_65 ;
return F_26 ( V_4 , V_66 , V_83 , V_16 ,
V_82 ) ;
}
case V_84 :
return F_26 ( V_4 , V_85 , V_86 , V_31 ) ;
case V_87 :
return F_26 ( V_4 , V_85 , V_88 , V_31 ) ;
case V_89 : {
struct V_90 * V_91 = V_31 ;
if ( V_91 -> V_66 >= V_4 -> V_8 . V_9 )
return - V_65 ;
return F_26 ( V_4 , V_66 , V_92 , V_16 ,
V_91 ) ;
}
#endif
default:
return F_26 ( V_4 , V_47 , V_93 , V_30 , V_31 ) ;
}
return 0 ;
}
...
static unsigned int F_31 ( struct V_13 * V_13 , T_1 * V_94 )
{
struct V_14 * V_15 = F_7 ( V_13 ) ;
struct V_3 * V_4 = F_8 ( V_15 ) ;
...
if ( ! ( V_4 -> V_41 & V_42 ) )
return V_95 ;
F_32 ( V_13 , & V_2 -> V_94 , V_94 ) ;
if ( F_33 ( V_2 ) )
return V_96 ;
return 0 ;
}
void F_34 ( struct V_3 * V_4 , const struct V_97 * V_98 )
{
F_35 ( & V_4 -> V_99 ) ;
F_36 ( ! V_98 ) ;
V_4 -> V_98 = V_98 ;
