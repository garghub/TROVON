...
F_49 ( V_37 , V_210 ) ;
V_174 = V_4 -> V_246 ( V_37 , V_31 ) ;
F_57 ( V_37 ) ;
return V_174 ;
}
static int F_98 ( struct V_36 * V_37 , T_2 V_31 , T_3 V_43 , int V_42 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
int V_247 , V_248 , V_5 , V_2 , V_158 ;
int V_249 ;
V_247 = F_11 ( V_4 , V_31 ) ;
V_248 = F_11 ( V_4 , V_31 + V_43 ) - 1 ;
if ( V_42 == V_46 )
V_249 = V_250 ;
else
V_249 = V_251 ;
...
V_4 -> V_109 ( V_37 , V_256 ) ;
while ( V_4 -> V_76 ( V_4 -> V_61 + V_90 )
& V_257 )
continue;
V_158 = V_4 -> V_76 ( V_4 -> V_61 + V_258 ) ;
if ( ! ( V_158 & V_249 ) )
F_29 ( V_92 L_42 ,
V_93 , V_158 ) ;
return 0 ;
}
for ( V_5 = V_247 ; V_5 < V_248 + 1 ; V_5 ++ ) {
V_2 = F_5 ( V_4 , V_5 ) ;
V_4 -> V_60 ( V_2 , V_4 -> V_61 + V_63 ) ;
V_2 = F_6 ( V_4 , V_5 ) ;
V_4 -> V_60 ( V_2 , V_4 -> V_61 + V_62 ) ;
V_4 -> V_60 ( V_5 , V_4 -> V_61 + V_254 ) ;
V_4 -> V_161 ( V_37 , V_42 , 0 , 0 ) ;
V_4 -> V_109 ( V_37 , V_256 ) ;
while ( V_4 -> V_76 ( V_4 -> V_61 + V_90 )
& V_257 )
...
static int F_99 ( struct V_36 * V_37 , T_2 V_31 , T_7 V_43 )
{
int V_174 ;
F_49 ( V_37 , V_256 ) ;
V_174 = F_98 ( V_37 , V_31 , V_43 , V_46 ) ;
F_57 ( V_37 ) ;
return V_174 ;
}
...
int V_174 ;
F_49 ( V_37 , V_256 ) ;
V_174 = F_98 ( V_37 , V_31 , V_43 , V_45 ) ;
F_57 ( V_37 ) ;
return V_174 ;
}
...
static void F_102 ( struct V_36 * V_37 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
T_2 V_31 = 0 ;
T_2 V_43 = V_37 -> V_178 ;
if ( V_4 -> V_252 & V_259 ) {
V_4 -> V_60 ( 0 , V_4 -> V_61 + V_254 ) ;
...
F_98 ( V_37 , V_31 , V_43 , V_45 ) ;
}
static int F_103 ( struct V_36 * V_37 , int V_42 , T_2 V_1 ,
T_3 V_43 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
int V_2 , V_5 , V_9 ;
...
static int F_104 ( struct V_36 * V_37 , T_2 V_193 ,
struct V_163 * V_164 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
int V_142 , V_174 = 0 , V_118 ;
...
V_169 , 0 , V_37 -> V_118 ) ;
F_103 ( V_37 , V_214 , V_193 , V_37 -> V_118 ) ;
F_47 ( V_37 , V_193 , 0 ) ;
if ( F_18 ( V_4 ) ) {
F_80 ( V_4 ) ;
F_47 ( V_37 , V_193 + V_4 -> V_58 , 0 ) ;
...
V_4 -> V_161 ( V_37 , V_262 , 0 , 0 ) ;
V_4 -> V_109 ( V_37 , V_263 ) ;
...
static int F_105 ( struct V_36 * V_37 , T_2 V_162 , T_3 V_43 ,
T_3 * V_179 , T_6 * V_141 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
struct V_163 V_164 = {
...
static int F_106 ( struct V_36 * V_37 , T_2 V_193 , T_3 V_43 ,
T_3 * V_179 , T_6 * V_141 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
unsigned char * V_264 = V_141 ;
int V_174 ;
struct V_163 V_164 ;
if ( V_43 < V_37 -> V_58 ) {
...
V_266 = 50 ;
if ( V_175 == V_269 ) {
V_162 += V_37 -> V_58 * V_266 ;
V_266 = V_270 - V_266 ;
}
if ( V_175 == V_271 ) {
if ( V_37 -> V_58 * V_266 < V_162 + V_43 )
return 0 ;
} else {
if ( V_37 -> V_58 * V_266 < V_43 )
return 0 ;
}
F_49 ( V_37 , V_261 ) ;
while ( V_43 > 0 && V_266 > 0 ) {
if ( ! V_265 ) {
struct V_272 * V_273 ;
V_43 -= sizeof( struct V_272 ) ;
if ( V_43 <= 0 ) {
V_174 = - V_274 ;
break;
}
V_273 = (struct V_272 * ) V_141 ;
V_273 -> V_247 = V_162 ;
V_273 -> V_152 = V_37 -> V_58 ;
V_273 -> V_275 = 0 ;
V_162 += V_37 -> V_58 ;
V_141 += sizeof( struct V_272 ) ;
* V_179 += sizeof( struct V_272 ) ;
} else {
T_3 V_276 ;
V_174 = V_265 ( V_37 , V_162 , V_43 , & V_276 , V_141 ) ;
V_141 += V_276 ;
V_43 -= V_276 ;
* V_179 += V_276 ;
if ( V_174 )
...
struct V_272 * V_141 , T_3 V_43 )
{
T_3 V_179 ;
int V_174 ;
V_174 = F_108 ( V_37 , 0 , V_43 , & V_179 , ( T_6 * ) V_141 , NULL , V_269 ) ;
return V_174 ? : V_179 ;
}
static int F_110 ( struct V_36 * V_37 , T_2 V_162 ,
T_3 V_43 , T_3 * V_179 , T_6 * V_141 )
{
return F_108 ( V_37 , V_162 , V_43 , V_179 , V_141 , F_105 , V_269 ) ;
}
...
T_3 V_179 ;
int V_174 ;
V_174 = F_108 ( V_37 , 0 , V_43 , & V_179 , ( T_6 * ) V_141 , NULL , V_271 ) ;
return V_174 ? : V_179 ;
}
static int F_112 ( struct V_36 * V_37 , T_2 V_162 ,
T_3 V_43 , T_3 * V_179 , T_6 * V_141 )
{
return F_108 ( V_37 , V_162 , V_43 , V_179 , V_141 , F_105 , V_271 ) ;
}
static int F_113 ( struct V_36 * V_37 , T_2 V_162 ,
T_3 V_43 , T_3 * V_179 , T_6 * V_141 )
{
return F_108 ( V_37 , V_162 , V_43 , V_179 , V_141 , F_106 , V_271 ) ;
}
...
F_29 ( V_97 L_50 ) ;
V_174 = F_108 ( V_37 , V_162 , V_43 , & V_179 , V_141 , F_107 , V_271 ) ;
return V_174 ? : V_179 ;
}
static void F_115 ( struct V_36 * V_37 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
unsigned int V_33 , V_281 , V_282 ;
V_33 = F_15 ( V_4 -> V_267 ) ;
V_281 = V_4 -> V_283 >> V_284 ;
V_282 = V_4 -> V_76 ( V_4 -> V_61 + V_285 ) >> 8 ;
switch ( V_33 ) {
case V_286 :
if ( F_10 ( V_4 ) )
V_4 -> V_252 |= V_287 ;
...
static void F_117 ( int V_293 , int V_294 )
{
...
static int F_118 ( int V_303 )
{
int V_178 = F_119 ( V_304 ) ;
char * V_305 ;
int V_38 ;
...
V_4 -> V_161 ( V_37 , V_262 , 0 , 0 ) ;
V_174 = V_4 -> V_109 ( V_37 , V_263 ) ;
F_29 ( V_110 L_66 , V_28 ,
V_4 -> V_26 [ V_28 ] , V_275 ? L_67 : L_68 ) ;
}
V_4 -> V_60 ( V_111 , V_4 -> V_61 + V_113 ) ;
return 0 ;
}
...
V_4 -> V_26 [ V_28 ] + 1 ;
V_31 += V_37 -> V_40 [ V_38 ] . V_239 << V_311 ;
V_311 ++ ;
} else {
V_37 -> V_39 -= 1 ;
V_37 -> V_40 [ V_38 ] . V_239 +=
...
V_37 -> V_40 [ V_38 ] . V_239 ) ;
for ( V_28 = 0 , V_37 -> V_178 = 0 ; V_28 < V_4 -> V_308 ; V_28 ++ ) {
...
static int F_122 ( struct V_36 * V_37 , int V_247 , int V_248 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
int V_38 , V_174 ;
int V_5 ;
...
T_2 V_1 ;
F_29 ( V_97 L_72 , V_247 , V_248 ) ;
for ( V_5 = V_247 ; V_5 <= V_248 ; V_5 ++ ) {
V_1 = F_13 ( V_4 , V_5 ) ;
if ( F_87 ( V_37 , V_1 , 0 ) )
continue;
...
int F_123 ( struct V_36 * V_37 , int V_28 ,
int V_26 , int V_314 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
...
V_174 = F_122 ( V_37 , F_90 ( V_315 , V_316 ) + 1 , F_124 ( V_315 , V_316 ) ) ;
if ( V_174 ) {
F_29 ( V_92 L_76
L_77 , V_93 ) ;
return V_174 ;
...
V_37 -> V_39 = V_4 -> V_308 << 1 ;
V_37 -> V_40 = F_127 ( sizeof( struct V_236 )
* ( V_4 -> V_308 << 1 ) , V_334 ) ;
if ( ! V_37 -> V_40 )
return - V_335 ;
}
...
if ( F_12 ( V_4 ) )
V_37 -> V_160 <<= 1 ;
V_4 -> V_30 = F_128 ( V_37 -> V_160 ) - 1 ;
V_4 -> V_57 = F_128 ( V_37 -> V_58 ) - 1 ;
...
static int F_129 ( struct V_36 * V_37 )
{
return F_49 ( V_37 , V_135 ) ;
}
static void F_130 ( struct V_36 * V_37 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
if ( V_4 -> V_81 == V_135 )
F_57 ( V_37 ) ;
...
int F_131 ( struct V_36 * V_37 , int V_337 )
{
int V_38 , V_174 ;
struct V_3 * V_4 = V_37 -> V_44 ;
if ( ! V_4 -> V_76 )
...
if ( ! V_4 -> V_199 ) {
V_4 -> V_199 = F_127 ( V_37 -> V_58 , V_334 ) ;
if ( ! V_4 -> V_199 ) {
F_29 ( V_92 L_85 ,
V_93 ) ;
return - V_335 ;
...
#ifdef F_132
V_4 -> V_194 = F_127 ( V_37 -> V_58 , V_334 ) ;
if ( ! V_4 -> V_194 ) {
F_133 ( V_4 -> V_199 ) ;
return - V_335 ;
}
...
if ( ! V_4 -> V_148 ) {
V_4 -> V_148 = F_127 ( V_37 -> V_118 , V_334 ) ;
if ( ! V_4 -> V_148 ) {
F_29 ( V_92 L_86 ,
V_93 ) ;
if ( V_4 -> V_252 & V_341 ) {
...
V_37 -> type = F_116 ( V_4 ) ? V_349 : V_350 ;
V_37 -> V_83 = V_351 ;
V_37 -> V_352 = F_92 ;
V_37 -> V_353 = NULL ;
V_37 -> V_354 = NULL ;
...
F_123 ( V_37 , V_38 , V_375 [ 2 * V_38 ] ,
V_375 [ ( 2 * V_38 ) + 1 ] ) ;
return 0 ;
}
void F_138 ( struct V_36 * V_37 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
F_139 ( V_37 ) ;
if ( V_4 -> V_217 ) {
