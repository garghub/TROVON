...
static void F_83 ( struct V_46 * V_46 , struct V_3 * V_3 , T_2 V_92 )
{
struct V_2 * V_2 ;
...
int F_89 ( struct V_1 * V_4 , struct V_213 * V_213 )
{
struct V_8 * V_8 = NULL ;
struct V_2 * V_2 ;
for ( V_2 = F_3 ( V_4 ) ; V_2 ; V_2 = F_5 ( V_2 ) ) {
...
if ( V_8 ) {
V_213 -> V_214 = V_8 -> V_155 ;
V_213 -> V_215 = V_8 -> V_86 ;
V_213 -> V_69 = V_8 -> V_156 ;
V_213 -> V_53 = V_8 -> V_157 ;
memcpy ( V_213 -> V_10 , V_8 -> V_10 . V_11 , V_104 ) ;
return 0 ;
}
return - 1 ;
}
int F_90 ( struct V_89 * V_90 , struct V_216 * V_14 )
{
struct V_3 * V_3 , * V_217 ;
...
V_218 = V_4 -> V_224 ( V_90 , V_219 ) ;
F_92 (bond, slave, i) {
struct V_8 * V_9 = F_4 ( V_3 ) . V_2 . V_8 ;
if ( V_9 && ( V_9 -> V_155 == V_220 ) ) {
V_218 -- ;
if ( V_218 < 0 )
break;
}
...
if ( V_9 )
V_225 = V_9 -> V_155 ;
if ( F_94 ( V_3 ) && V_9 && ( V_225 == V_220 ) ) {
V_222 = F_95 ( V_4 , V_90 , V_3 -> V_14 ) ;
break;
}
}
V_223:
...
void F_97 ( struct V_89 * V_90 , struct V_1 * V_4 ,
struct V_3 * V_3 )
{
if ( V_90 -> V_97 != V_98 )
return;
...
return;
F_80 ( & V_4 -> V_204 ) ;
F_83 ( (struct V_46 * ) V_90 -> V_227 , V_3 , V_90 -> V_228 ) ;
F_82 ( & V_4 -> V_204 ) ;
}
