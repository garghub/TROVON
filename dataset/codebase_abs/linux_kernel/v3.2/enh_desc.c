...
F_10 ( V_5 , ( V_74 == V_72 - 1 ) ) ;
if ( V_73 )
V_5 -> V_10 . V_47 . V_77 = 1 ;
V_5 ++ ;
}
}
static void F_11 ( struct V_4 * V_5 , unsigned int V_72 )
{
int V_74 ;
for ( V_74 = 0 ; V_74 < V_72 ; V_74 ++ ) {
V_5 -> V_10 . V_11 . V_75 = 0 ;
F_12 ( V_5 , ( V_74 == V_72 - 1 ) ) ;
V_5 ++ ;
}
}
...
{
int V_79 = V_5 -> V_10 . V_11 . V_80 ;
memset ( V_5 , 0 , F_19 ( struct V_4 , V_81 ) ) ;
F_20 ( V_5 , V_79 ) ;
}
static void F_21 ( struct V_4 * V_5 , int V_82 , int V_83 ,
int V_84 )
{
V_5 -> V_10 . V_11 . V_85 = V_82 ;
F_22 ( V_5 , V_83 ) ;
if ( F_23 ( V_84 ) )
V_5 -> V_10 . V_11 . V_86 = V_87 ;
}
static void F_24 ( struct V_4 * V_5 )
{
V_5 -> V_10 . V_11 . V_88 = 0 ;
}
static void F_25 ( struct V_4 * V_5 )
{
V_5 -> V_10 . V_11 . V_78 = 1 ;
V_5 -> V_10 . V_11 . V_88 = 1 ;
}
static int F_26 ( struct V_4 * V_5 )
{
return V_5 -> V_10 . V_47 . V_89 ;
}
