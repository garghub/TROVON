...
if ( V_21 && F_16 ( V_17 , V_23 , V_21 , V_24 ) < 0 )
F_1 ( L_10 , V_18 ) ;
}
...
struct V_58 * F_36 ( struct V_45 * V_46 ,
int V_27 , bool V_59 )
{
struct V_33 * V_34 ;
struct V_58 * V_60 ;
...
if ( V_59 ) {
int V_61 ;
snprintf ( V_60 -> V_62 , sizeof( V_60 -> V_62 ) ,
L_28 ) ;
if ( ! F_37 ( V_60 -> V_62 ) )
F_1 ( L_29 ) ;
V_61 = F_13 ( V_60 -> V_62 , V_63 ) ;
if ( V_61 < 0 )
F_1 ( L_9 , V_60 -> V_62 ) ;
V_17 = V_61 ;
}
...
int F_40 ( int V_27 , struct V_45 * V_46 )
{
struct V_58 * V_60 ;
V_60 = F_36 ( V_46 , V_27 , false ) ;
if ( ! V_60 )
return - V_64 ;
F_38 ( V_60 ) ;
return 0 ;
