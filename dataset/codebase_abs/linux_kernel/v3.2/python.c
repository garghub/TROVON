...
V_96 -> V_65 . V_74 = V_74 ;
if ( F_37 ( V_96 , V_50 , V_60 , V_100 , NULL ) < 0 ) {
F_38 ( V_101 ) ;
return NULL ;
}
F_39 ( V_102 ) ;
...
static T_1 * F_63 ( struct V_104 * V_105 ,
T_1 * args , T_1 * V_47 )
{
struct V_108 * V_107 = & V_105 -> V_107 ;
int V_100 = 0 ;
static char * V_48 [] = { L_59 , NULL } ;
if ( ! F_17 ( args , V_47 , L_60 , V_48 , & V_100 ) )
return NULL ;
if ( F_64 ( V_107 , V_100 ) < 0 ) {
F_38 ( V_101 ) ;
return NULL ;
}
F_39 ( V_102 ) ;
...
if ( V_55 -- == 0 )
break;
return F_23 ( L_68 , F_68 ( V_128 , struct V_62 , V_96 ) ) ;
}
...
T_1 * V_53 ;
int V_55 ;
T_1 * V_130 , * V_131 = F_71 ( L_67 , V_132 ) ;
if ( V_131 == NULL ||
F_12 () < 0 ||
F_69 () < 0 ||
F_40 () < 0 ||
...
return;
F_39 ( & V_129 ) ;
F_72 ( V_131 , L_72 , ( T_1 * ) & V_129 ) ;
F_39 ( & V_103 ) ;
F_72 ( V_131 , L_73 , ( T_1 * ) & V_103 ) ;
F_39 ( & V_61 ) ;
F_72 ( V_131 , L_74 , ( T_1 * ) & V_61 ) ;
F_39 ( & V_57 ) ;
F_72 ( V_131 , L_75 , ( T_1 * ) & V_57 ) ;
V_130 = F_73 ( V_131 ) ;
if ( V_130 == NULL )
goto error;
...
if ( V_53 == NULL )
goto error;
F_75 ( V_130 , V_133 [ V_55 ] . V_134 , V_53 ) ;
F_54 ( V_53 ) ;
}
error:
if ( F_76 () )
