...
static int F_112 ( struct V_30 * V_34 , T_7 V_218 )
{
struct V_219 * V_187 = F_113 ( V_34 ) ;
...
F_115 ( V_172 -> V_90 [ V_113 ] ) ;
F_116 ( V_172 -> V_23 [ V_113 ] ) ;
}
F_55 ( & V_172 -> V_89 ) ;
...
F_117 ( V_34 ) ;
F_118 ( V_34 ) ;
F_119 ( V_34 , F_120 ( V_34 , V_218 ) ) ;
return 0 ;
}
static int F_121 ( struct V_30 * V_34 )
{
struct V_219 * V_187 = F_113 ( V_34 ) ;
struct V_1 * V_172 = V_187 -> V_24 ;
struct V_220 * V_221 ;
...
F_19 ( V_2 -> V_34 , 0x44 , & V_231 ) ;
V_231 &= 0xff00ff00 ;
V_231 |= 0x000800aa ;
F_20 ( V_2 -> V_34 , 0x44 , V_231 ) ;
F_5 ( 0x80000001 , F_3 ( V_2 , V_37 ) ) ;
F_5 ( 0x00000000 , F_3 ( V_2 , V_149 ) ) ;
F_5 ( 0xffffffff , F_3 ( V_2 , V_232 ) ) ;
F_5 ( 0x00000000 , F_3 ( V_2 , V_233 ) ) ;
F_35 ( 0x10 , F_3 ( V_2 , V_234 ) ) ;
V_2 -> V_235 = F_14 ( V_2 , 0 , V_236 ) ;
V_2 -> V_237 = F_14 ( V_2 , 0 ,
V_238 ) ;
if ( V_2 -> V_54 ) {
F_42 ( V_2 ) ;
...
static void F_134 ( struct V_243 * V_244 ,
struct V_245 * V_246 )
{
struct V_1 * V_2 = V_244 -> V_24 ;
int V_113 ;
for ( V_113 = 0 ; V_113 < 256 ; V_113 += 4 )
F_135 ( V_246 , L_43 , V_113 , F_2 ( F_3 ( V_2 , V_113 ) ) ) ;
}
static void T_6 F_136 ( struct V_1 * V_2 )
{
struct V_243 * V_244 ;
if ( ! F_137 ( V_2 -> V_187 , L_44 , & V_244 ) )
F_138 ( V_244 , V_2 , F_134 ) ;
}
...
static int F_143 ( struct V_250 * V_184 )
{
struct V_1 * V_2 = V_184 -> V_251 ;
F_127 ( V_2 ) ;
return 0 ;
}
...
V_252 = 32 ;
F_125 ( V_34 ) ;
F_150 ( V_34 , V_259 , & V_254 ) ;
if ( ( V_254 & V_260 ) != V_260 ) {
V_254 |= V_260 ;
F_151 ( V_34 , V_259 , V_254 ) ;
}
F_125 ( V_34 ) ;
if ( F_139 ( V_2 ) ) {
F_127 ( V_2 ) ;
...
V_2 -> V_48 . V_261 = 0 ;
if ( V_2 -> V_19 == V_20 )
V_2 -> V_16 . V_17 . V_21 = V_262 ;
else
V_2 -> V_16 . V_17 . V_21 = V_263 ;
V_2 -> V_16 . V_17 . V_18 = V_262 ;
V_2 -> V_16 . V_17 . V_264 = V_150 ;
V_2 -> V_16 . V_17 . V_60 = V_148 ;
V_2 -> V_16 . V_17 . V_86 = V_232 ;
V_2 -> V_16 . V_17 . V_46 = V_149 ;
V_2 -> V_16 . V_45 . V_264 = 0x00 ;
...
V_2 -> V_230 = F_153 ( 0x10b9 , 0x7101 , NULL ) ;
if ( ! V_2 -> V_230 && V_2 -> V_19 == V_20 ) {
F_12 ( V_12 L_53 ) ;
F_127 ( V_2 ) ;
return - V_265 ;
}
F_16 ( L_54 ) ;
V_153 = F_154 ( V_187 , V_266 , V_2 , & V_213 ) ;
if ( V_153 < 0 ) {
F_127 ( V_2 ) ;
return V_153 ;
}
F_155 ( V_187 , & V_34 -> V_267 ) ;
for ( V_113 = 0 ; V_113 < V_50 ; V_113 ++ )
...
#ifdef F_130
V_2 -> V_223 = F_156 ( sizeof( * V_2 -> V_223 ) , V_258 ) ;
if ( ! V_2 -> V_223 )
F_12 ( V_163 L_56 ) ;
#endif
F_24 ( V_2 ) ;
...
static void T_8 F_162 ( struct V_30 * V_34 )
{
F_161 ( F_113 ( V_34 ) ) ;
F_160 ( V_34 , NULL ) ;
}
