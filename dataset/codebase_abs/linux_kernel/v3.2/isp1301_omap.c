...
static void F_56 ( struct V_2 * V_3 , T_1 V_134 )
{
T_1 V_135 , V_136 ;
...
F_30 ( V_33 , V_38 ) ;
case V_41 :
if ( V_3 -> V_9 . V_25 && ( V_136 & V_76 ) ) {
#ifdef F_55
F_36 ( V_3 , V_135 ) ;
F_37 ( V_3 , V_136 ) ;
#endif
F_53 ( V_3 ) ;
} else if ( ! ( V_135 & ( V_71 | V_69 ) ) )
V_136 |= V_77 ;
break;
case V_55 :
break;
...
{
T_1 V_139 = F_7 ( V_3 , V_140 ) ;
F_13 ( V_3 , V_140 , V_139 ) ;
return V_139 ;
}
static void
F_59 ( struct V_141 * V_29 )
{
struct V_2 * V_3 = F_60 ( V_29 , struct V_2 , V_29 ) ;
int V_142 ;
V_3 -> V_31 = 1 ;
do {
V_142 = F_61 ( V_143 , & V_3 -> V_30 ) ;
#ifdef F_55
...
if ( F_62 ( V_144 , & V_3 -> V_30 ) ) {
#ifdef F_64
F_32 ( V_3 , L_39 ) ;
if ( ! V_142 )
F_65 ( & V_3 -> V_145 , V_146 + V_147 ) ;
#endif
F_63 ( & V_3 -> V_7 -> V_18 ) ;
}
if ( V_3 -> V_30 )
...
static int T_7 F_72 ( struct V_149 * V_150 )
{
struct V_2 * V_3 ;
V_3 = F_73 ( V_150 ) ;
F_13 ( V_3 , V_151 , ~ 0 ) ;
...
static int
F_81 ( struct V_155 * V_9 , struct V_156 * V_19 )
{
...
static int
F_83 ( struct V_155 * V_9 , struct V_159 * V_25 )
{
struct V_2 * V_3 = F_60 ( V_9 , struct V_2 , V_9 ) ;
#ifndef F_55
T_2 V_33 ;
...
static int
F_85 ( struct V_155 * V_18 , unsigned V_1 )
{
if ( ! V_154 )
return - V_20 ;
if ( V_18 -> V_10 == V_51 )
...
static int T_8
F_88 ( struct V_149 * V_150 , const struct V_165 * V_166 )
{
int V_4 ;
struct V_2 * V_3 ;
if ( V_154 )
return 0 ;
V_3 = F_89 ( sizeof *V_3 , V_167 ) ;
if ( ! V_3 )
return 0 ;
F_90 ( & V_3 -> V_29 , F_59 ) ;
F_91 ( & V_3 -> V_145 ) ;
V_3 -> V_145 . V_168 = F_68 ;
V_3 -> V_145 . V_153 = ( unsigned long ) V_3 ;
F_92 ( V_150 , V_3 ) ;
V_3 -> V_7 = V_150 ;
V_4 = F_9 ( V_3 , V_169 ) ;
if ( V_4 != V_170 ) {
F_66 ( & V_150 -> V_18 , L_51 , V_4 ) ;
goto V_171;
}
V_4 = F_9 ( V_3 , V_172 ) ;
if ( V_4 != V_173 ) {
F_66 ( & V_150 -> V_18 , L_52 , V_4 ) ;
goto V_171;
}
V_3 -> V_148 = V_150 -> V_18 . V_174 ;
V_150 -> V_18 . V_174 = F_69 ;
V_4 = F_10 ( V_150 , V_175 ) ;
F_80 ( & V_150 -> V_18 , L_53 V_176 L_54 ,
V_4 >> 8 , V_4 & 0xff ) ;
F_13 ( V_3 , V_12 , V_177 ) ;
F_11 ( V_3 , V_178 , V_179 ) ;
F_13 ( V_3 , V_178 , ~ V_179 ) ;
F_11 ( V_3 , V_14 ,
V_80 | V_87 ) ;
F_13 ( V_3 , V_14 ,
~ ( V_80 | V_87 ) ) ;
...
V_3 -> V_183 |= V_185 ;
V_4 = F_49 ( V_150 -> V_95 , F_67 ,
V_3 -> V_183 , V_133 , V_3 ) ;
if ( V_4 < 0 ) {
F_66 ( & V_150 -> V_18 , L_57 ,
V_150 -> V_95 , V_4 ) ;
goto V_171;
}
V_3 -> V_9 . V_18 = & V_150 -> V_18 ;
V_3 -> V_9 . V_42 = V_133 ;
V_3 -> V_9 . V_186 = F_81 ,
V_3 -> V_9 . V_187 = F_83 ,
V_3 -> V_9 . V_188 = F_85 ,
...
#ifdef F_64
F_65 ( & V_3 -> V_145 , V_146 + V_147 ) ;
F_66 ( & V_150 -> V_18 , L_58 , V_191 ) ;
#endif
V_4 = F_96 ( & V_3 -> V_9 ) ;
if ( V_4 < 0 )
F_97 ( & V_150 -> V_18 , L_59 ,
V_4 ) ;
return 0 ;
V_171:
F_71 ( V_3 ) ;
