...
if ( V_124 && V_184 -> V_122 . V_40 == V_187 ) {
V_184 -> V_122 . V_40 = \
F_86 ( V_183 -> V_85 , V_184 -> V_122 . V_78 ,
V_124 , V_183 -> V_4 ? V_188 :
V_189 ) ;
if ( V_184 -> V_122 . V_40 == 0 )
return - V_190 ;
V_184 -> V_191 = 1 ;
}
if ( V_184 -> V_122 . V_192 && V_124 && ( V_124 % V_183 -> V_180 . V_193 == 0 ) ) {
V_184 -> V_194 = F_87 ( V_183 -> V_195 , V_196 ,
& V_184 -> V_197 ) ;
if ( V_184 -> V_194 == NULL ) {
if ( V_184 -> V_191 ) {
...
V_124 , V_183 -> V_4 ? V_188 :
V_189 ) ;
V_184 -> V_122 . V_40 = V_187 ;
V_184 -> V_191 = 0 ;
}
return - V_190 ;
}
memset ( V_184 -> V_194 , 0 , sizeof( * V_184 -> V_194 ) ) ;
V_184 -> V_194 -> V_198 = V_199 ;
V_184 -> V_194 -> V_117 = V_200 ;
if ( ! V_184 -> V_122 . V_123 )
V_184 -> V_194 -> V_117 |= V_201 ;
}
...
if ( V_184 -> V_194 ) {
V_184 -> V_154 -> V_198 = V_184 -> V_197 ;
} else {
V_184 -> V_154 -> V_198 = V_199 ;
if ( ! V_184 -> V_122 . V_123 )
V_184 -> V_154 -> V_117 |= V_201 ;
}
V_184 -> V_154 -> V_202 [ 0 ] = V_184 -> V_122 . V_40 ;
for ( V_79 = 1 ; V_79 < 5 ; V_79 ++ )
V_184 -> V_154 -> V_202 [ V_79 ] =
( V_184 -> V_122 . V_40 + V_79 * V_203 ) & ~ V_204 ;
if ( ! F_89 ( & V_183 -> V_152 . V_163 ) ) {
struct V_160 * V_205 ;
int V_2 = F_3 ( V_183 -> V_3 , V_183 -> V_4 ) ;
int V_206 ;
V_205 = F_78 ( V_183 -> V_152 . V_163 . V_207 ,
struct V_160 , V_163 ) ;
if ( V_205 -> V_194 )
V_205 -> V_194 -> V_198 = V_184 -> V_40 & V_208 ;
else
V_205 -> V_154 -> V_198 = V_184 -> V_40 & V_208 ;
F_90 () ;
if ( F_8 ( V_62 , F_19 ( V_2 ) ) )
goto V_133;
do {
F_9 ( V_26 , V_209 , V_209 ) ;
V_206 = F_8 ( V_48 , F_19 ( V_2 ) ) ;
} while ( ! F_8 ( V_26 , V_209 ) );
F_9 ( V_26 , V_209 , 0 ) ;
if ( V_206 )
goto V_133;
}
V_183 -> V_152 . V_154 -> V_210 . V_198 = V_184 -> V_40 ;
V_183 -> V_152 . V_154 -> V_210 . V_117 &= ~ V_120 ;
V_183 -> V_152 . V_154 -> V_9 |= V_211 ;
F_90 () ;
...
if ( V_184 -> V_122 . V_106 != - V_186 )
return - V_64 ;
if ( ( V_200 & V_184 -> V_154 -> V_117 ) != 0 )
return - V_213 ;
if ( V_184 -> V_194 ) {
if ( ( V_200 & V_184 -> V_194 -> V_117 ) != 0 )
return - V_213 ;
F_92 ( V_183 -> V_195 , V_184 -> V_194 , V_184 -> V_197 ) ;
V_184 -> V_194 = NULL ;
}
V_184 -> V_122 . V_106 = 0 ;
if ( V_184 -> V_191 ) {
F_88 ( V_183 -> V_85 , V_184 -> V_122 . V_40 , V_184 -> V_122 . V_124 ,
V_183 -> V_4 ? V_188 : V_189 ) ;
V_184 -> V_122 . V_40 = V_187 ;
V_184 -> V_191 = 0 ;
}
V_184 -> V_122 . V_106 = V_184 -> V_154 -> V_117 & V_120 ;
if ( ( V_214 & V_184 -> V_122 . V_106 ) != 0 )
V_184 -> V_122 . V_106 = - 1 ;
else if ( ( V_215 & V_184 -> V_122 . V_106 ) != 0 )
V_184 -> V_122 . V_106 = - 1 ;
else if ( ( V_216 & V_184 -> V_122 . V_106 ) != 0 )
V_184 -> V_122 . V_106 = - 1 ;
V_184 -> V_122 . V_217 = V_184 -> V_154 -> V_117 & V_119 ;
V_184 -> V_122 . V_217 >>= F_1 ( V_119 ) ;
V_184 -> V_122 . V_217 = V_184 -> V_122 . V_124 - V_184 -> V_122 . V_217 ;
V_184 -> V_122 . V_217 = V_184 -> V_122 . V_106 ? 0 : V_184 -> V_122 . V_217 ;
return V_184 -> V_122 . V_217 ;
}
...
struct V_160 * V_184 = \
F_78 ( V_183 -> V_152 . V_163 . V_198 ,
struct V_160 , V_163 ) ;
F_94 ( & V_184 -> V_163 ) ;
V_184 -> V_122 . V_106 = - V_218 ;
if ( V_184 -> V_122 . V_219 != NULL ) {
F_95 ( V_183 -> V_135 ) ;
V_184 -> V_122 . V_219 ( & V_183 -> V_180 , & V_184 -> V_122 ) ;
F_96 ( V_183 -> V_135 ) ;
}
}
return 0 ;
...
F_99 ( & V_24 -> V_225 . V_180 ) ;
V_24 -> V_102 -> V_226 ( V_89 ) ;
F_98 (ep, gadget) {
F_100 ( V_180 ) ;
}
if ( V_24 -> V_106 != NULL ) {
F_101 ( & V_24 -> V_225 . V_180 , V_24 -> V_106 ) ;
V_24 -> V_106 = NULL ;
}
return 0 ;
}
...
if ( V_164 )
goto V_133;
V_24 -> V_106 = F_104 ( & V_24 -> V_225 . V_180 , V_196 ) ;
if ( V_24 -> V_106 == NULL )
V_164 = - V_190 ;
F_96 ( V_24 -> V_135 ) ;
V_133:
...
static void F_105 ( struct V_220 * V_180 , struct V_121 * V_122 )
{
...
__acquires( V_183 -> V_135 )
{
struct V_149 * V_183 = & V_24 -> V_225 ;
struct V_121 * V_122 = NULL ;
T_8 V_228 = V_196 ;
int V_4 , V_3 , V_164 ;
F_85 ( L_63 , V_183 , V_227 ) ;
if ( V_183 == NULL || V_227 == NULL )
return - V_64 ;
F_95 ( V_183 -> V_135 ) ;
V_122 = F_104 ( & V_183 -> V_180 , V_228 ) ;
F_96 ( V_183 -> V_135 ) ;
if ( V_122 == NULL )
return - V_190 ;
V_122 -> V_219 = F_105 ;
V_122 -> V_124 = 2 ;
V_122 -> V_78 = F_107 ( V_122 -> V_124 , V_228 ) ;
if ( V_122 -> V_78 == NULL ) {
V_164 = - V_190 ;
goto V_229;
}
if ( ( V_227 -> V_126 & V_230 ) == V_231 ) {
* ( ( T_5 * ) V_122 -> V_78 ) = V_232 -> V_222 << 1 ;
V_164 = 0 ;
} else if ( ( V_227 -> V_126 & V_230 ) \
== V_233 ) {
V_4 = ( F_59 ( V_227 -> V_129 ) & V_182 ) ?
V_181 : V_60 ;
V_3 = F_59 ( V_227 -> V_129 ) & V_234 ;
* ( ( T_5 * ) V_122 -> V_78 ) = F_23 ( V_3 , V_4 ) ;
}
F_95 ( V_183 -> V_135 ) ;
V_164 = F_108 ( & V_183 -> V_180 , V_122 , V_228 ) ;
F_96 ( V_183 -> V_135 ) ;
if ( V_164 )
goto V_235;
return 0 ;
...
static void
F_109 ( struct V_220 * V_180 , struct V_121 * V_122 )
{
struct V_23 * V_24 = V_122 -> V_236 ;
unsigned long V_32 ;
F_85 ( L_63 , V_180 , V_122 ) ;
F_66 ( V_24 -> V_135 , V_32 ) ;
if ( V_24 -> V_237 )
...
struct V_149 * V_183 ;
F_85 ( L_64 , V_24 ) ;
V_183 = ( V_24 -> V_238 == V_181 ) ? & V_24 -> V_224 : & V_24 -> V_225 ;
V_24 -> V_106 -> V_236 = V_24 ;
V_24 -> V_106 -> V_219 = F_109 ;
F_95 ( V_183 -> V_135 ) ;
V_164 = F_108 ( & V_183 -> V_180 , V_24 -> V_106 , V_196 ) ;
F_96 ( V_183 -> V_135 ) ;
return V_164 ;
}
...
__acquires( V_183 -> V_135 )
{
struct V_160 * V_184 , * V_239 ;
struct V_149 * V_240 = V_183 ;
int V_241 ( V_164 ) ;
F_85 ( L_64 , V_183 ) ;
if ( F_89 ( & V_183 -> V_152 . V_163 ) )
return - V_64 ;
...
V_184 -> V_122 . V_124 )
V_240 = & V_232 -> V_225 ;
V_184 -> V_122 . V_219 ( & V_240 -> V_180 , & V_184 -> V_122 ) ;
F_96 ( V_183 -> V_135 ) ;
}
}
if ( V_164 == - V_213 )
...
do {
F_39 () ;
memcpy ( & V_122 , & V_183 -> V_152 . V_154 -> V_227 , sizeof( V_122 ) ) ;
} while ( ! F_38 () );
type = V_122 . V_126 ;
V_24 -> V_238 = ( type & V_244 ) ? V_181 : V_60 ;
...
V_24 -> V_238 = V_181 ;
F_95 ( V_24 -> V_135 ) ;
F_103 = V_24 -> V_102 -> V_227 ( & V_24 -> V_89 , & V_122 ) ;
F_96 ( V_24 -> V_135 ) ;
break;
}
if ( F_103 < 0 ) {
...
static int F_117 ( struct V_220 * V_180 ,
const struct V_261 * V_243 )
{
struct V_149 * V_183 = F_43 ( V_180 , struct V_149 , V_180 ) ;
int V_164 = 0 ;
unsigned long V_32 ;
F_85 ( L_63 , V_180 , V_243 ) ;
if ( V_180 == NULL || V_243 == NULL )
return - V_64 ;
F_66 ( V_183 -> V_135 , V_32 ) ;
V_183 -> V_243 = V_243 ;
if ( ! F_89 ( & V_183 -> V_152 . V_163 ) )
F_115 ( L_71 ) ;
V_183 -> V_4 = F_118 ( V_243 ) ? V_181 : V_60 ;
V_183 -> V_3 = F_119 ( V_243 ) ;
V_183 -> type = F_120 ( V_243 ) ;
V_183 -> V_180 . V_193 = F_121 ( V_243 ) ;
...
( V_183 -> V_180 . V_193 << F_1 ( V_265 ) ) & V_265 ;
V_183 -> V_152 . V_154 -> V_210 . V_198 |= V_199 ;
if ( V_183 -> V_3 )
V_164 |= F_22 ( V_183 -> V_3 , V_183 -> V_4 , V_183 -> type ) ;
F_67 ( V_183 -> V_135 , V_32 ) ;
return V_164 ;
}
static int F_122 ( struct V_220 * V_180 )
{
struct V_149 * V_183 = F_43 ( V_180 , struct V_149 , V_180 ) ;
int V_266 , V_164 = 0 ;
unsigned long V_32 ;
...
static struct V_121 * F_123 ( struct V_220 * V_180 , T_8 V_228 )
{
struct V_149 * V_183 = F_43 ( V_180 , struct V_149 , V_180 ) ;
struct V_160 * V_184 = NULL ;
F_85 ( L_74 , V_180 , V_228 ) ;
if ( V_180 == NULL ) {
F_103 ( L_65 ) ;
return NULL ;
}
V_184 = F_107 ( sizeof( struct V_160 ) , V_228 ) ;
if ( V_184 != NULL ) {
F_124 ( & V_184 -> V_163 ) ;
V_184 -> V_122 . V_40 = V_187 ;
V_184 -> V_154 = F_87 ( V_183 -> V_195 , V_228 ,
& V_184 -> V_40 ) ;
if ( V_184 -> V_154 == NULL ) {
F_74 ( V_184 ) ;
V_184 = NULL ;
...
static void F_125 ( struct V_220 * V_180 , struct V_121 * V_122 )
{
struct V_149 * V_183 = F_43 ( V_180 , struct V_149 , V_180 ) ;
...
F_66 ( V_183 -> V_135 , V_32 ) ;
if ( V_184 -> V_154 )
F_92 ( V_183 -> V_195 , V_184 -> V_154 , V_184 -> V_40 ) ;
F_74 ( V_184 ) ;
F_56 ( F_83 ( V_183 ) , L_77 , 0 ) ;
F_67 ( V_183 -> V_135 , V_32 ) ;
}
static int F_126 ( struct V_220 * V_180 , struct V_121 * V_122 ,
T_8 T_7 V_228 )
{
struct V_149 * V_183 = F_43 ( V_180 , struct V_149 , V_180 ) ;
struct V_160 * V_184 = F_43 ( V_122 , struct V_160 , V_122 ) ;
int V_164 = 0 ;
unsigned long V_32 ;
F_85 ( L_78 , V_180 , V_122 , V_228 ) ;
if ( V_180 == NULL || V_122 == NULL || V_183 -> V_243 == NULL )
return - V_64 ;
F_66 ( V_183 -> V_135 , V_32 ) ;
if ( V_183 -> type == V_212 ) {
if ( V_122 -> V_124 )
V_183 = ( V_232 -> V_238 == V_60 ) ?
& V_232 -> V_224 : & V_232 -> V_225 ;
if ( ! F_89 ( & V_183 -> V_152 . V_163 ) ) {
F_93 ( V_183 ) ;
V_164 = - V_267 ;
...
static int F_128 ( struct V_220 * V_180 , struct V_121 * V_122 )
{
struct V_149 * V_183 = F_43 ( V_180 , struct V_149 , V_180 ) ;
struct V_160 * V_184 = F_43 ( V_122 , struct V_160 , V_122 ) ;
unsigned long V_32 ;
...
V_183 -> V_243 == NULL || F_89 ( & V_184 -> V_163 ) ||
...
static int F_129 ( struct V_220 * V_180 , int V_63 )
{
struct V_149 * V_183 = F_43 ( V_180 , struct V_149 , V_180 ) ;
int V_266 , V_164 = 0 ;
unsigned long V_32 ;
F_85 ( L_74 , V_180 , V_63 ) ;
if ( V_180 == NULL || V_183 -> V_243 == NULL )
return - V_64 ;
F_66 ( V_183 -> V_135 , V_32 ) ;
#ifndef F_130
...
static int F_131 ( struct V_220 * V_180 )
{
struct V_149 * V_183 = F_43 ( V_180 , struct V_149 , V_180 ) ;
unsigned long V_32 ;
F_85 ( L_64 , V_180 ) ;
...
static void F_132 ( struct V_220 * V_180 )
{
struct V_149 * V_183 = F_43 ( V_180 , struct V_149 , V_180 ) ;
unsigned long V_32 ;
F_85 ( L_64 , V_180 ) ;
...
if ( V_24 -> V_287 == NULL )
return - V_190 ;
V_24 -> V_195 = F_141 ( L_90 , & V_24 -> V_89 . V_86 ,
sizeof( struct V_162 ) ,
64 , V_203 ) ;
if ( V_24 -> V_195 == NULL ) {
F_142 ( V_24 -> V_287 ) ;
...
goto V_133;
F_67 ( V_24 -> V_135 , V_32 ) ;
V_24 -> V_224 . V_180 . V_243 = & V_292 ;
V_164 = F_144 ( & V_24 -> V_224 . V_180 ) ;
if ( V_164 )
return V_164 ;
V_24 -> V_225 . V_180 . V_243 = & V_293 ;
V_164 = F_144 ( & V_24 -> V_225 . V_180 ) ;
if ( V_164 )
return V_164 ;
F_66 ( V_24 -> V_135 , V_32 ) ;
V_24 -> V_89 . V_294 = & V_24 -> V_225 . V_180 ;
...
V_164 = F_17 ( V_24 -> V_224 . V_152 . V_40 ) ;
if ( V_164 )
F_135 ( & V_24 -> V_89 . V_86 ) ;
V_133:
F_67 ( V_24 -> V_135 , V_32 ) ;
...
struct V_23 * V_24 ;
int V_164 = 0 ;
F_85 ( L_96 , V_86 , V_303 , V_102 -> V_100 ) ;
