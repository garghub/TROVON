...
F_165 ( V_5 , V_186 -> V_286 . V_287 . V_289 ) ;
...
F_167 () ;
#else
F_168 ( ( char * ) F_169 ( & V_272 ) ) ;
#endif
}
static int F_170 ( int * V_292 , int * V_293 )
{
T_13 V_294 , V_295 , V_296 , V_297 , V_89 , V_163 , V_167 ;
T_5 V_58 ;
V_167 = F_171 () ;
F_172 ( V_167 + 1 , & V_294 , & V_295 , & V_296 , & V_297 ) ;
* V_292 = V_294 >> 16 ;
* V_293 = V_294 & 0xffff ;
F_9 ( V_26 L_12 , * V_292 , * V_293 ) ;
F_172 ( V_167 + 2 , & V_89 , & V_163 , & V_296 , & V_297 ) ;
V_58 = F_163 ( V_298 ) ;
F_173 ( V_163 , ( T_7 ) V_58 , ( T_7 ) ( V_58 >> 32 ) ) ;
F_147 () ;
V_27 . V_28 = L_13 ;
V_231 = V_299 ;
return 0 ;
}
void T_14 F_174 ( void )
{
int V_3 ;
struct V_300 V_301 ;
...
V_301 . V_101 = 0 ;
V_301 . V_304 = V_305 ;
V_301 . V_306 = F_163 ( V_302 ) >> V_307 ;
if ( F_176 ( V_308 , & V_301 ) )
F_13 () ;
...
static int T_15 F_177 ( struct V_220 * V_309 ,
...
static void T_1 F_179 ( void )
{
int V_211 ;
int V_292 , V_293 ;
V_211 = F_170 ( & V_292 , & V_293 ) ;
if ( V_211 < 0 )
return;
F_174 () ;
if ( F_17 ( V_315 ) )
