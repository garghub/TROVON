...
F_502 ( V_182 -> V_183 , & V_23 -> V_474 -> V_166 ) ;
if ( F_503 ( V_182 -> V_183 ) )
V_155 = - V_303 ;
V_6:
return V_155 ;
}
...
static T_12 F_506 ( struct V_1002 * V_498 ,
struct V_165 * V_166 )
{
F_74 ( L_526 ) ;
F_237 ( V_498 ) ;
...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_507 ( sizeof( struct V_1379 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_473 ;
V_23 -> V_159 = F_339 ( V_23 -> V_157 ) ;
V_23 -> V_159 -> V_163 = F_508 ( V_23 -> V_157 ) ;
...
F_509 ( V_23 -> V_157 , & V_23 -> V_474 -> V_166 ) ;
V_155 = F_510 ( V_23 -> V_157 ) ;
if ( V_155 ) {
F_511 ( V_23 -> V_157 , 1 ) ;
V_23 -> V_157 = NULL ;
return V_155 ;
...
static int T_14 F_513 ( struct V_474 * V_1382 ,
...
struct V_17 * V_23 ;
int V_7 ;
V_167 = F_507 ( sizeof( struct V_17 ) , 0 ) ;
if ( V_167 == NULL ) {
V_554 = - V_473 ;
goto V_6;
}
V_23 = F_339 ( V_167 ) ;
V_23 -> V_163 = F_508 ( V_167 ) ;
V_23 -> V_167 = V_167 ;
V_23 -> V_474 = V_1382 ;
V_12 = V_1385 ;
F_300 ( & V_23 -> V_42 ) ;
...
F_516 ( V_1382 ) ;
V_554 = F_517 ( V_1382 , F_518 ( 32 ) ) ;
if ( ! V_554 )
V_554 = F_519 ( V_1382 , F_518 ( 32 ) ) ;
if ( V_554 ) {
F_4 (KERN_WARNING DRV_NAME L_528 ) ;
goto V_1388;
}
F_520 ( V_1382 , V_23 ) ;
V_554 = F_521 ( V_1382 , V_1324 ) ;
if ( V_554 )
goto V_1388;
F_522 ( V_1382 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_523 ( V_1382 , 0x40 , V_21 & 0xffff00ff ) ;
V_412 = F_524 ( V_1382 , 0 ) ;
V_23 -> V_1389 = V_412 ;
V_137 = F_525 ( V_1382 , 0 ) ;
if ( ! V_137 ) {
V_554 = - V_1386 ;
goto V_1390;
}
...
F_408 ( V_23 , 1 ) ;
V_554 = F_526 ( V_1382 -> V_1333 , F_478 , V_1392 , V_1324 , V_23 ) ;
if ( V_554 ) {
F_46 ( L_532 , V_1382 -> V_1333 ) ;
goto V_1391;
}
F_509 ( V_167 , & V_1382 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
...
V_167 -> V_1407 = F_527 ( V_1382 , 0 ) ;
V_167 -> V_1408 = V_167 -> V_1407 + F_524 ( V_1382 , 0 ) - 1 ;
V_554 = F_528 ( & V_1382 -> V_166 . V_1409 , & V_1410 ) ;
if ( V_554 ) {
F_46 ( L_533 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1411;
...
F_512 ( V_23 -> V_167 ) ;
V_1412:
F_530 ( & V_1382 -> V_166 . V_1409 , & V_1410 ) ;
V_1411:
F_531 ( V_1382 -> V_1333 , V_23 ) ;
V_1391:
F_532 ( V_23 -> V_22 ) ;
V_1390:
F_533 ( V_1382 ) ;
...
static void T_16 F_535 ( struct V_474 * V_1382 )
{
struct V_17 * V_23 = F_536 ( V_1382 ) ;
...
static int F_539 ( struct V_474 * V_1382 , T_17 V_661 )
{
struct V_17 * V_23 = F_536 ( V_1382 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
...
F_541 ( V_1382 ) ;
F_534 ( V_1382 ) ;
F_542 ( V_1382 , F_543 ( V_1382 , V_661 ) ) ;
V_23 -> V_1414 = F_544 () ;
return 0 ;
}
static int F_545 ( struct V_474 * V_1382 )
{
struct V_17 * V_23 = F_536 ( V_1382 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_554 ;
...
F_523 ( V_1382 , 0x40 , V_21 & 0xffff00ff ) ;
F_547 ( V_166 ) ;
V_23 -> V_1353 = F_544 () - V_23 -> V_1414 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_548 ( struct V_474 * V_1382 )
{
struct V_17 * V_23 = F_536 ( V_1382 ) ;
F_160 ( V_23 ) ;
F_534 ( V_1382 ) ;
...
V_429 = F_551 ( & V_1416 . V_1323 , & V_1417 ) ;
if ( V_429 ) {
F_46 ( L_544 ) ;
F_552 ( & V_1416 ) ;
return V_429 ;
