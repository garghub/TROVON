...
static int F_137 ( struct V_16 * V_147 , struct V_19 * V_20 )
{
struct V_187 * V_188 ;
int V_82 = 0 ;
F_138 ( V_20 ) ;
V_188 = V_20 -> V_187 ;
if ( V_188 && F_139 ( & V_188 -> V_189 ) > 1 )
V_82 = - V_134 ;
F_140 ( V_20 ) ;
return V_82 ;
}
static void F_141 ( struct V_16 * V_147 , struct V_19 * V_20 )
{
struct V_187 * V_188 ;
F_138 ( V_20 ) ;
V_188 = V_20 -> V_187 ;
