...
V_2 -> V_43 = - 1 ;
V_2 -> V_45 = - 1 ;
if ( ( V_2 -> V_86 = F_60 ( V_17 + 4 , 12 , L_16 ) ) == NULL ) {
F_19 ( V_28 L_17 , V_17 + 4 ) ;
return - V_97 ;
}
if ( F_61 ( V_43 , F_41 , 0 , L_16 , ( void * ) V_2 ) ) {
F_19 ( V_28 L_18 , V_43 ) ;
return - V_97 ;
}
V_2 -> V_43 = V_43 ;
...
if ( V_95 < 0 )
return V_95 ;
return F_64 ( V_91 , V_98 , V_2 , & V_93 ) ;
}
int F_65 ( struct V_90 * V_91 , struct V_1 * V_2 ,
int V_88 , struct V_99 * * V_100 )
{
struct V_99 * V_101 ;
int V_95 ;
V_95 = F_66 ( V_91 , L_20 , V_88 , 1 , 1 , & V_101 ) ;
if ( V_95 < 0 )
return V_95 ;
F_67 ( V_101 , V_102 , & V_103 ) ;
F_67 ( V_101 , V_104 , & V_105 ) ;
V_101 -> V_106 = V_2 ;
V_101 -> V_107 = V_108 ;
sprintf ( V_101 -> V_109 , F_58 ( V_2 ) ) ;
V_2 -> V_101 = V_101 ;
F_68 ( V_101 , V_110 ,
F_69 () ,
64 * 1024 , 64 * 1024 ) ;
...
static int F_70 ( struct V_111 * V_112 , struct V_113 * V_114 )
{
static char * V_115 [ 9 ] = {
L_21 , L_22 , L_23 , L_24 ,
L_25 , L_26 , L_27 , L_28
...
V_114 -> type = V_116 ;
V_114 -> V_66 = 1 ;
V_114 -> V_59 . V_117 . V_118 = 8 ;
if ( V_114 -> V_59 . V_117 . V_119 > 7 )
V_114 -> V_59 . V_117 . V_119 = 7 ;
strcpy ( V_114 -> V_59 . V_117 . V_109 , V_115 [ V_114 -> V_59 . V_117 . V_119 ] ) ;
return 0 ;
}
static int F_71 ( struct V_111 * V_112 , struct V_120 * V_121 )
{
struct V_1 * V_2 = F_72 ( V_112 ) ;
V_121 -> V_59 . V_117 . V_119 [ 0 ] = F_13 ( V_2 , V_122 ) & 7 ;
return 0 ;
}
static int F_73 ( struct V_111 * V_112 , struct V_120 * V_121 )
{
struct V_1 * V_2 = F_72 ( V_112 ) ;
unsigned long V_18 ;
unsigned char V_123 , V_124 ;
int V_125 ;
if ( V_121 -> V_59 . V_117 . V_119 [ 0 ] > 8 )
return - V_44 ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
V_123 = F_13 ( V_2 , V_122 ) ;
V_124 = ( V_121 -> V_59 . V_117 . V_119 [ 0 ] & 7 ) | ( V_123 & ~ 15 ) ;
V_125 = V_124 != V_123 ;
if ( V_125 )
...
static int F_74 ( struct V_111 * V_112 , struct V_113 * V_114 )
{
int V_126 = ( V_112 -> V_127 >> 16 ) & 0xff ;
V_114 -> type = V_126 == 1 ? V_128 : V_129 ;
V_114 -> V_66 = 1 ;
V_114 -> V_59 . integer . V_130 = 0 ;
V_114 -> V_59 . integer . V_131 = V_126 ;
return 0 ;
}
static int F_75 ( struct V_111 * V_112 , struct V_120 * V_121 )
{
struct V_1 * V_2 = F_72 ( V_112 ) ;
unsigned long V_18 ;
int V_11 = V_112 -> V_127 & 0xff ;
int V_132 = ( V_112 -> V_127 >> 8 ) & 0xff ;
int V_126 = ( V_112 -> V_127 >> 16 ) & 0xff ;
int V_133 = ( V_112 -> V_127 >> 24 ) & 0xff ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
V_121 -> V_59 . integer . V_59 [ 0 ] = ( F_13 ( V_2 , V_11 ) >> V_132 ) & V_126 ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
if ( V_133 )
V_121 -> V_59 . integer . V_59 [ 0 ] = V_126 - V_121 -> V_59 . integer . V_59 [ 0 ] ;
return 0 ;
}
static int F_76 ( struct V_111 * V_112 , struct V_120 * V_121 )
{
struct V_1 * V_2 = F_72 ( V_112 ) ;
unsigned long V_18 ;
int V_11 = V_112 -> V_127 & 0xff ;
...
int V_125 ;
unsigned char V_123 , V_124 ;
V_124 = ( V_121 -> V_59 . integer . V_59 [ 0 ] & V_126 ) ;
if ( V_133 )
V_124 = V_126 - V_124 ;
V_124 <<= V_132 ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
V_123 = F_13 ( V_2 , V_11 ) ;
V_124 = ( V_123 & ~ ( V_126 << V_132 ) ) | V_124 ;
V_125 = V_124 != V_123 ;
if ( V_125 )
F_11 ( V_2 , V_11 , V_124 ) ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
...
static int F_77 ( struct V_111 * V_112 , struct V_113 * V_114 )
{
int V_126 = ( V_112 -> V_127 >> 24 ) & 0xff ;
V_114 -> type = V_126 == 1 ? V_128 : V_129 ;
V_114 -> V_66 = 2 ;
V_114 -> V_59 . integer . V_130 = 0 ;
V_114 -> V_59 . integer . V_131 = V_126 ;
...
static int F_78 ( struct V_111 * V_112 , struct V_120 * V_121 )
{
struct V_1 * V_2 = F_72 ( V_112 ) ;
unsigned long V_18 ;
int V_134 = V_112 -> V_127 & 0xff ;
int V_135 = ( V_112 -> V_127 >> 8 ) & 0xff ;
int V_136 = ( V_112 -> V_127 >> 16 ) & 0x07 ;
int V_137 = ( V_112 -> V_127 >> 19 ) & 0x07 ;
int V_126 = ( V_112 -> V_127 >> 24 ) & 0xff ;
int V_133 = ( V_112 -> V_127 >> 22 ) & 1 ;
...
if ( V_134 != V_135 ) {
if ( V_135 < 0xa0 )
V_139 = F_13 ( V_2 , V_135 ) ;
else
V_139 = F_10 ( V_2 , V_135 ) ;
} else
V_139 = V_138 ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
V_121 -> V_59 . integer . V_59 [ 0 ] = ( V_138 >> V_136 ) & V_126 ;
V_121 -> V_59 . integer . V_59 [ 1 ] = ( V_139 >> V_137 ) & V_126 ;
if ( V_133 ) {
V_121 -> V_59 . integer . V_59 [ 0 ] = V_126 - V_121 -> V_59 . integer . V_59 [ 0 ] ;
V_121 -> V_59 . integer . V_59 [ 1 ] = V_126 - V_121 -> V_59 . integer . V_59 [ 1 ] ;
}
return 0 ;
}
static int F_79 ( struct V_111 * V_112 , struct V_120 * V_121 )
{
struct V_1 * V_2 = F_72 ( V_112 ) ;
unsigned long V_18 ;
int V_134 = V_112 -> V_127 & 0xff ;
...
int V_133 = ( V_112 -> V_127 >> 22 ) & 1 ;
int V_125 ;
unsigned char V_140 , V_141 , V_142 , V_143 ;
V_140 = V_121 -> V_59 . integer . V_59 [ 0 ] & V_126 ;
V_141 = V_121 -> V_59 . integer . V_59 [ 1 ] & V_126 ;
if ( V_133 ) {
V_140 = V_126 - V_140 ;
V_141 = V_126 - V_141 ;
}
...
if ( V_135 < 0xa0 )
V_143 = F_13 ( V_2 , V_135 ) ;
else
V_143 = F_10 ( V_2 , V_135 ) ;
V_140 = ( V_142 & ~ ( V_126 << V_136 ) ) | V_140 ;
V_141 = ( V_143 & ~ ( V_126 << V_137 ) ) | V_141 ;
V_125 = V_140 != V_142 || V_141 != V_143 ;
if ( V_125 ) {
if ( V_134 < 0xa0 )
...
V_142 = F_10 ( V_2 , V_134 ) ;
V_140 = ( V_142 & ~ ( ( V_126 << V_136 ) | ( V_126 << V_137 ) ) ) | V_140 | V_141 ;
V_125 = V_140 != V_142 ;
if ( V_125 ) {
if ( V_134 < 0xa0 )
F_11 ( V_2 , V_134 , V_140 ) ;
...
int F_80 ( struct V_90 * V_91 , struct V_1 * V_2 )
{
unsigned int V_144 ;
int V_95 ;
...
if ( F_81 ( ! V_2 || ! V_91 ) )
return - V_44 ;
strcpy ( V_91 -> V_145 , F_58 ( V_2 ) ) ;
for ( V_144 = 0 ; V_144 < F_82 ( V_146 ) ; V_144 ++ ) {
if ( ( V_95 = F_83 ( V_91 , F_84 ( & V_146 [ V_144 ] , V_2 ) ) ) < 0 )
return V_95 ;
}
