...
static int F_72 ( struct V_2 * V_3 , void * V_165 )
{
struct V_5 * V_6 = (struct V_5 * ) V_3 -> V_7 ;
struct V_8 * V_9 = V_6 -> V_10 -> V_9 ;
T_3 * V_68 = V_9 -> V_69 ;
...
static int F_75 ( struct V_2 * V_3 , void * V_165 )
{
struct V_5 * V_6 = (struct V_5 * ) V_3 -> V_7 ;
struct V_8 * V_9 = V_6 -> V_10 -> V_9 ;
T_3 * V_68 = V_9 -> V_69 ;
bool V_281 = false ;
if ( F_28 ( V_9 ) )
V_281 = F_29 ( V_282 ) & V_283 ;
else if ( F_76 ( V_9 ) || F_77 ( V_9 ) || F_78 ( V_9 ) )
V_281 = F_29 ( V_284 ) & V_285 ;
else if ( F_79 ( V_9 ) )
V_281 = F_29 ( V_286 ) & V_287 ;
else if ( F_80 ( V_9 ) )
V_281 = F_29 ( V_288 ) & V_289 ;
F_4 ( V_3 , L_177 ,
V_281 ? L_178 : L_179 ) ;
return 0 ;
}
static int F_81 ( struct V_2 * V_3 , void * V_165 )
{
struct V_5 * V_6 = (struct V_5 * ) V_3 -> V_7 ;
struct V_8 * V_9 = V_6 -> V_10 -> V_9 ;
T_3 * V_68 = V_9 -> V_69 ;
...
F_4 ( V_3 , L_181 , V_291 ) ;
F_4 ( V_3 , L_182 , V_292 ) ;
F_4 ( V_3 , L_183 , V_291 + V_292 ) ;
return 0 ;
}
static int F_85 ( struct V_2 * V_3 , void * V_165 )
{
struct V_5 * V_6 = (struct V_5 * ) V_3 -> V_7 ;
struct V_8 * V_9 = V_6 -> V_10 -> V_9 ;
T_3 * V_68 = V_9 -> V_69 ;
...
V_294 = F_29 ( V_297 ) ;
F_4 ( V_3 , L_187 , V_293 * 50 , V_294 * 100 ) ;
}
F_13 ( & V_9 -> V_74 ) ;
return 0 ;
}
...
if ( V_73 )
return V_73 ;
F_4 ( V_3 , L_188 , ( unsigned long ) F_29 ( 0x112f4 ) ) ;
F_13 ( & V_9 -> V_74 ) ;
return 0 ;
}
static int F_90 ( struct V_2 * V_3 , void * V_165 )
{
struct V_5 * V_6 = (struct V_5 * ) V_3 -> V_7 ;
struct V_8 * V_9 = V_6 -> V_10 -> V_9 ;
T_3 * V_68 = V_9 -> V_69 ;
...
return V_73 ;
if ( V_302 -> V_303 )
F_91 ( V_3 , V_302 -> V_303 , V_304 ) ;
F_13 ( & V_9 -> V_74 ) ;
return 0 ;
}
static int F_92 ( struct V_2 * V_3 , void * V_4 )
{
struct V_5 * V_6 = (struct V_5 * ) V_3 -> V_7 ;
struct V_8 * V_9 = V_6 -> V_10 -> V_9 ;
T_3 * V_68 = V_9 -> V_69 ;
...
struct V_307 * V_308 ;
int V_73 ;
V_73 = F_12 ( & V_9 -> V_309 . V_310 ) ;
if ( V_73 )
return V_73 ;
V_306 = V_68 -> V_311 ;
V_308 = F_93 ( V_306 -> V_312 . V_308 ) ;
F_4 ( V_3 , L_189 ,
V_308 -> V_44 . V_313 ,
V_308 -> V_44 . V_314 ,
V_308 -> V_44 . V_315 ,
...
F_13 ( & V_9 -> V_309 . V_310 ) ;
return 0 ;
}
static int F_94 ( struct V_2 * V_3 , void * V_165 )
{
struct V_5 * V_6 = (struct V_5 * ) V_3 -> V_7 ;
struct V_8 * V_9 = V_6 -> V_10 -> V_9 ;
T_3 * V_68 = V_9 -> V_69 ;
...
static int F_95 ( struct V_2 * V_3 , void * V_4 )
{
struct V_5 * V_6 = (struct V_5 * ) V_3 -> V_7 ;
struct V_8 * V_9 = V_6 -> V_10 -> V_9 ;
struct V_87 * V_68 = V_9 -> V_69 ;
...
L_194 ,
F_32 ( & V_68 -> V_76 . V_330 ) ) ;
if ( V_329 > sizeof( V_328 ) )
V_329 = sizeof( V_328 ) ;
return F_98 ( V_325 , V_326 , V_327 , V_328 , V_329 ) ;
}
static T_10
F_99 ( struct V_321 * V_322 ,
...
return - V_86 ;
if ( F_100 ( V_328 , V_325 , V_331 ) )
return - V_333 ;
V_328 [ V_331 ] = 0 ;
V_332 = F_101 ( V_328 , NULL , 0 ) ;
}
F_102 ( L_195 , V_332 ) ;
F_103 ( V_9 , V_332 ) ;
return V_331 ;
...
static int
F_113 ( struct V_338 * V_10 ,
struct V_339 * V_340 ,
const void * V_341 )
{
struct V_5 * V_6 ;
V_6 = F_114 ( sizeof( struct V_5 ) , V_342 ) ;
if ( V_6 == NULL ) {
F_115 ( V_340 ) ;
return - V_343 ;
}
...
V_6 -> V_65 = ( void * ) V_341 ;
F_111 ( & V_10 -> V_345 ) ;
F_116 ( & V_6 -> V_64 , & V_10 -> V_346 ) ;
F_13 ( & V_10 -> V_345 ) ;
return 0 ;
}
static int F_117 ( struct V_339 * V_347 , struct V_338 * V_10 )
{
...
if ( F_119 ( V_340 ) )
return F_120 ( V_340 ) ;
return F_113 ( V_10 , V_340 , & V_350 ) ;
}
static int F_121 ( struct V_320 * V_320 , struct V_321 * V_321 )
{
...
int F_122 ( struct V_320 * V_320 , struct V_321 * V_321 )
{
struct V_8 * V_9 = V_320 -> V_324 ;
struct V_87 * V_68 = V_9 -> V_69 ;
if ( ! F_33 ( V_9 ) )
...
static int F_123 ( struct V_339 * V_347 , struct V_338 * V_10 )
{
struct V_8 * V_9 = V_10 -> V_9 ;
struct V_339 * V_340 ;
V_340 = F_118 ( L_201 ,
...
if ( F_119 ( V_340 ) )
return F_120 ( V_340 ) ;
return F_113 ( V_10 , V_340 , & V_352 ) ;
}
static int F_124 ( struct V_339 * V_347 , struct V_338 * V_10 )
{
struct V_8 * V_9 = V_10 -> V_9 ;
struct V_339 * V_340 ;
V_340 = F_118 ( L_202 ,
...
if ( F_119 ( V_340 ) )
return F_120 ( V_340 ) ;
return F_113 ( V_10 , V_340 , & V_353 ) ;
}
static int F_125 ( struct V_339 * V_347 , struct V_338 * V_10 )
{
struct V_8 * V_9 = V_10 -> V_9 ;
struct V_339 * V_340 ;
V_340 = F_118 ( L_203 ,
...
if ( F_119 ( V_340 ) )
return F_120 ( V_340 ) ;
return F_113 ( V_10 , V_340 , & V_354 ) ;
}
int F_126 ( struct V_338 * V_10 )
{
int V_73 ;
V_73 = F_117 ( V_10 -> V_355 , V_10 ) ;
if ( V_73 )
return V_73 ;
V_73 = F_123 ( V_10 -> V_355 , V_10 ) ;
if ( V_73 )
return V_73 ;
V_73 = F_124 ( V_10 -> V_355 , V_10 ) ;
if ( V_73 )
return V_73 ;
V_73 = F_125 ( V_10 -> V_355 , V_10 ) ;
if ( V_73 )
return V_73 ;
return F_127 ( V_356 ,
V_357 ,
...
void F_128 ( struct V_338 * V_10 )
{
F_129 ( V_356 ,
V_357 , V_10 ) ;
F_129 ( (struct V_358 * ) & V_352 ,
1 , V_10 ) ;
F_129 ( (struct V_358 * ) & V_350 ,
1 , V_10 ) ;
F_129 ( (struct V_358 * ) & V_353 ,
1 , V_10 ) ;
F_129 ( (struct V_358 * ) & V_354 ,
1 , V_10 ) ;
}
