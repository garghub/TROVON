...
struct V_96 * V_97 = V_20 -> V_24 ;
struct V_86 * V_82 = V_20 -> V_82 ;
int V_61 = 0 ;
if ( ! V_83 -> V_84 -> V_98 )
V_83 -> V_84 -> V_98 = & V_99 ;
if ( ! V_83 -> V_84 -> V_100 )
V_83 -> V_84 -> V_100 = F_44 ( 64 ) ;
...
static T_5 int F_45 ( struct V_105 * V_106 )
{
return F_46 ( & V_106 -> V_84 ,
& V_107 ) ;
}
static int T_6 F_47 ( struct V_105 * V_106 )
{
F_48 ( & V_106 -> V_84 ) ;
return 0 ;
}
