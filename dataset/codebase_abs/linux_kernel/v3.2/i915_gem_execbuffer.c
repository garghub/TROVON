...
static int
F_83 ( struct V_39 * V_40 , void * V_137 ,
struct V_77 * V_78 ,
struct V_120 * args ,
struct V_67 * V_96 )
{
...
V_44 = F_74 ( V_96 , args -> V_144 ) ;
if ( V_44 )
return V_44 ;
switch ( args -> V_86 & V_145 ) {
case V_146 :
case V_147 :
V_4 = & V_58 -> V_4 [ V_148 ] ;
break;
...
V_143 = args -> V_86 & V_153 ;
switch ( V_143 ) {
case V_154 :
case V_155 :
case V_156 :
if ( V_4 == & V_58 -> V_4 [ V_148 ] &&
V_143 != V_58 -> V_157 ) {
if ( F_34 ( V_40 ) -> V_81 < 4 )
return - V_45 ;
if ( F_34 ( V_40 ) -> V_81 > 5 &&
...
V_140 = F_87 ( args -> V_159 * sizeof( * V_140 ) ,
V_28 ) ;
if ( V_140 == NULL ) {
V_44 = - V_100 ;
goto V_160;
...
if ( F_55 ( V_140 ,
(struct V_139 T_3 * ) ( V_71 )
args -> V_161 ,
sizeof( * V_140 ) * args -> V_159 ) ) {
V_44 = - V_63 ;
goto V_160;
}
}
...
F_35 ( & V_76 ) ;
for ( V_70 = 0 ; V_70 < args -> V_144 ; V_70 ++ ) {
struct V_1 * V_2 ;
V_2 = F_16 ( F_57 ( V_40 , V_78 ,
V_96 [ V_70 ] . V_33 ) ) ;
if ( & V_2 -> V_9 == NULL ) {
...
V_138 -> V_9 . V_11 |= V_134 ;
V_44 = F_72 ( V_4 , & V_76 ) ;
if ( V_44 )
goto V_93;
V_106 = F_82 ( V_4 ) ;
for ( V_70 = 0 ; V_70 < F_90 ( V_4 -> V_109 ) ; V_70 ++ ) {
...
F_92 ( V_4 , V_106 ) ;
V_141 = V_138 -> V_48 + args -> V_121 ;
V_142 = args -> V_122 ;
if ( V_140 ) {
for ( V_70 = 0 ; V_70 < args -> V_159 ; V_70 ++ ) {
V_44 = F_93 ( V_40 , & V_140 [ V_70 ] ,
...
V_44 = V_4 -> V_166 ( V_4 , V_141 , V_142 ) ;
if ( V_44 )
goto V_93;
}
F_77 ( & V_76 , V_4 , V_106 ) ;
...
int
F_94 ( struct V_39 * V_40 , void * V_137 ,
struct V_77 * V_78 )
{
struct V_167 * args = V_137 ;
struct V_120 V_168 ;
struct V_169 * V_85 = NULL ;
struct V_67 * V_170 = NULL ;
int V_44 , V_70 ;
if ( args -> V_144 < 1 ) {
F_17 ( L_18 , args -> V_144 ) ;
return - V_45 ;
}
V_85 = F_52 ( sizeof( * V_85 ) , args -> V_144 ) ;
V_170 = F_52 ( sizeof( * V_170 ) , args -> V_144 ) ;
if ( V_85 == NULL || V_170 == NULL ) {
F_17 ( L_22 ,
args -> V_144 ) ;
F_53 ( V_85 ) ;
F_53 ( V_170 ) ;
...
for ( V_70 = 0 ; V_70 < args -> V_144 ; V_70 ++ ) {
V_170 [ V_70 ] . V_33 = V_85 [ V_70 ] . V_33 ;
V_170 [ V_70 ] . V_73 = V_85 [ V_70 ] . V_73 ;
V_170 [ V_70 ] . V_72 = V_85 [ V_70 ] . V_72 ;
V_170 [ V_70 ] . V_91 = V_85 [ V_70 ] . V_91 ;
V_170 [ V_70 ] . V_49 = V_85 [ V_70 ] . V_49 ;
if ( F_34 ( V_40 ) -> V_81 < 4 )
V_170 [ V_70 ] . V_86 = V_87 ;
else
V_170 [ V_70 ] . V_86 = 0 ;
}
V_168 . V_172 = args -> V_172 ;
V_168 . V_144 = args -> V_144 ;
V_168 . V_121 = args -> V_121 ;
V_168 . V_122 = args -> V_122 ;
V_168 . V_164 = args -> V_164 ;
V_168 . V_165 = args -> V_165 ;
V_168 . V_159 = args -> V_159 ;
V_168 . V_161 = args -> V_161 ;
V_168 . V_86 = V_147 ;
V_44 = F_83 ( V_40 , V_137 , V_78 , & V_168 , V_170 ) ;
if ( ! V_44 ) {
for ( V_70 = 0 ; V_70 < args -> V_144 ; V_70 ++ )
V_85 [ V_70 ] . V_49 = V_170 [ V_70 ] . V_49 ;
V_44 = F_95 ( (struct V_171 T_3 * )
( V_71 ) args -> V_172 ,
V_85 ,
sizeof( * V_85 ) * args -> V_144 ) ;
if ( V_44 ) {
...
int
F_96 ( struct V_39 * V_40 , void * V_137 ,
struct V_77 * V_78 )
{
struct V_120 * args = V_137 ;
struct V_67 * V_170 = NULL ;
int V_44 ;
if ( args -> V_144 < 1 ) {
F_17 ( L_26 , args -> V_144 ) ;
return - V_45 ;
}
V_170 = F_87 ( sizeof( * V_170 ) * args -> V_144 ,
V_28 | V_173 | V_174 ) ;
if ( V_170 == NULL )
V_170 = F_52 ( sizeof( * V_170 ) ,
args -> V_144 ) ;
if ( V_170 == NULL ) {
F_17 ( L_22 ,
args -> V_144 ) ;
...
V_44 = F_83 ( V_40 , V_137 , V_78 , args , V_170 ) ;
if ( ! V_44 ) {
V_44 = F_95 ( (struct V_171 T_3 * )
( V_71 ) args -> V_172 ,
V_170 ,
