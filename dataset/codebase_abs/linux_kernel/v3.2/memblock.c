...
int T_2 __weak F_25 ( T_1 V_42 , T_1 V_8 ,
T_1 V_43 , T_1 V_10 )
{
return 1 ;
}
...
static int T_2 F_45 ( struct V_1 * type , T_1 V_5 )
{
...
int T_4 F_46 ( T_1 V_5 )
{
return F_45 ( & V_2 . V_4 , V_5 ) != - 1 ;
}
int T_2 F_47 ( T_1 V_5 )
{
return F_45 ( & V_2 . V_3 , V_5 ) != - 1 ;
}
int T_2 F_48 ( T_1 V_11 , T_1 V_6 )
{
int V_63 = F_45 ( & V_2 . V_3 , V_11 ) ;
if ( V_63 == - 1 )
return 0 ;
...
int T_2 F_49 ( T_1 V_11 , T_1 V_6 )
{
return F_5 ( & V_2 . V_4 , V_11 , V_6 ) >= 0 ;
}
void T_2 F_50 ( T_1 V_65 )
{
V_2 . V_25 = V_65 ;
}
static void T_2 F_51 ( struct V_1 * V_70 , char * V_71 )
{
unsigned long long V_11 , V_6 ;
int V_12 ;
F_52 ( L_7 , V_71 , V_70 -> V_13 ) ;
...
return;
F_52 ( L_9 ) ;
F_52 ( L_10 , ( unsigned long long ) V_2 . V_62 ) ;
F_51 ( & V_2 . V_3 , L_1 ) ;
F_51 ( & V_2 . V_4 , L_2 ) ;
}
void T_4 F_54 ( void )
...
static int T_4 F_56 ( char * V_66 )
{
if ( V_66 && strstr ( V_66 , L_11 ) )
V_72 = 1 ;
return 0 ;
}
static int F_57 ( struct V_76 * V_77 , void * V_78 )
{
...
static int F_59 ( struct V_80 * V_80 , struct V_81 * V_81 )
{
return F_60 ( V_81 , F_57 , V_80 -> V_82 ) ;
}
static int T_4 F_61 ( void )
{
struct V_83 * V_84 = F_62 ( L_15 , NULL ) ;
if ( ! V_84 )
return - V_85 ;
F_63 ( L_1 , V_86 , V_84 , & V_2 . V_3 , & V_87 ) ;
F_63 ( L_2 , V_86 , V_84 , & V_2 . V_4 , & V_87 ) ;
return 0 ;
}
