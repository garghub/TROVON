...
int F_54 ( struct V_1 * V_2 , T_2 V_125 )
{
unsigned int V_31 ;
F_55 ( V_2 -> V_105 , V_126 ) ;
V_2 -> V_44 |= V_127 ;
for ( V_31 = 0 ; V_31 < V_2 -> V_128 -> V_129 ; V_31 ++ )
F_56 ( V_2 -> V_130 [ V_31 ] ) ;
return 0 ;
}
...
if ( ! V_2 -> V_61 [ V_31 ] )
continue;
V_22 = V_2 -> V_83 -> V_131 ( V_2 , V_31 , V_2 -> V_61 [ V_31 ] ) ;
if ( V_22 < 0 ) {
F_26 ( V_65 L_76 , V_31 ) ;
return - V_12 ;
}
...
V_2 -> V_44 |= V_78 ;
V_2 -> V_44 &= ~ V_127 ;
F_55 ( V_2 -> V_105 , V_132 ) ;
return 0 ;
}
struct V_1 * F_58 ( struct V_133 * V_105 , struct V_134 * V_128 ,
struct V_135 * V_83 ,
int V_136 )
{
struct V_1 * V_2 ;
if ( F_16 ( ! V_105 || ! V_128 || ! V_83 ) )
return NULL ;
V_2 = F_59 ( sizeof( * V_2 ) + V_136 , V_137 ) ;
if ( ! V_2 ) {
F_26 ( V_65 L_77 ) ;
return NULL ;
}
...
V_2 -> V_105 = V_105 ;
V_105 -> V_71 = V_2 ;
strcpy ( V_105 -> V_140 , V_128 -> V_141 ) ;
sprintf ( V_105 -> V_142 , L_78 , V_128 -> V_141 ) ;
F_45 ( V_2 ) ;
return V_2 ;
}
