...
if ( V_4 -> V_50 )
F_32 ( V_4 -> V_50 ) ;
F_33 ( & V_49 -> V_3 . V_51 , & V_52 ) ;
F_34 ( V_49 , NULL ) ;
F_35 ( V_4 ) ;
return 0 ;
}
static int T_1 F_36 ( struct V_48 * V_49 )
{
struct V_1 * V_4 ;
int V_53 , V_54 , V_55 , V_56 , V_7 ;
V_4 = F_37 ( sizeof( struct V_1 ) , V_57 ) ;
if ( ! V_4 )
return - V_58 ;
V_4 -> V_12 = F_38 ( V_49 , V_59 , 0 ) -> V_60 ;
F_39 ( & V_4 -> V_8 ) ;
F_34 ( V_49 , V_4 ) ;
V_7 = F_12 ( V_4 -> V_12 , V_61 ) ;
if ( V_7 < 0 ) {
V_53 = V_7 ;
goto error;
}
...
F_41 ( L_9 ,
V_54 , V_55 , V_56 ) ;
V_53 = F_42 ( & V_49 -> V_3 . V_51 , & V_52 ) ;
if ( V_53 )
goto error;
V_4 -> V_50 = F_43 ( & V_49 -> V_3 ) ;
if ( F_19 ( V_4 -> V_50 ) ) {
V_53 = F_20 ( V_4 -> V_50 ) ;
V_4 -> V_50 = NULL ;
goto error;
