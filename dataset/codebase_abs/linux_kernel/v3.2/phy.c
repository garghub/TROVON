...
break;
case V_235 : {
struct V_15 T_1 * V_236 ;
struct V_182 * V_237 = V_182 -> V_237 ;
V_236 = V_3 -> V_38 ;
V_237 -> V_238 = F_4 ( & V_236 -> V_238 ) ;
V_237 -> V_239 = F_4 ( & V_236 -> V_240 ) ;
V_237 -> V_241 = F_4 ( & V_236 -> V_241 ) ;
V_237 -> V_242 = F_4 ( & V_236 -> V_243 ) ;
break;
}
default:
F_22 ( & V_17 -> V_89 -> V_230 ,
