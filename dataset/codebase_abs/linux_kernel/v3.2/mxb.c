...
static int F_29 ( struct V_79 * V_79 , void * V_80 , struct V_105 * V_106 )
{
struct V_11 * V_12 = ( (struct V_83 * ) V_80 ) -> V_12 ;
struct V_1 * V_1 = (struct V_1 * ) V_12 -> V_32 ;
if ( V_106 -> V_95 ) {
...
F_24 ( L_20 , V_106 -> V_95 ) ;
memset ( V_106 , 0 , sizeof( * V_106 ) ) ;
F_30 ( V_106 -> V_16 , L_21 , sizeof( V_106 -> V_16 ) ) ;
V_106 -> type = V_53 ;
V_106 -> V_107 = V_108 | V_109 |
V_110 | V_111 | V_112 ;
V_106 -> V_113 = V_1 -> V_59 ;
return F_31 ( V_12 , V_29 , V_114 , V_106 ) ;
}
static int F_32 ( struct V_79 * V_79 , void * V_80 , struct V_105 * V_106 )
{
struct V_11 * V_12 = ( (struct V_83 * ) V_80 ) -> V_12 ;
struct V_1 * V_1 = (struct V_1 * ) V_12 -> V_32 ;
if ( V_106 -> V_95 ) {
...
V_1 -> V_59 = V_106 -> V_113 ;
return F_31 ( V_12 , V_29 , V_115 , V_106 ) ;
}
static int F_33 ( struct V_79 * V_79 , void * V_80 , struct V_116 * V_117 )
{
struct V_11 * V_12 = ( (struct V_83 * ) V_80 ) -> V_12 ;
struct V_1 * V_1 = (struct V_1 * ) V_12 -> V_32 ;
if ( V_1 -> V_57 ) {
...
static int F_34 ( struct V_79 * V_79 , void * V_80 , struct V_116 * V_117 )
{
struct V_11 * V_12 = ( (struct V_83 * ) V_80 ) -> V_12 ;
struct V_1 * V_1 = (struct V_1 * ) V_12 -> V_32 ;
...
static int F_37 ( struct V_79 * V_79 , void * V_80 , struct V_123 * V_124 )
{
struct V_11 * V_12 = ( (struct V_83 * ) V_80 ) -> V_12 ;
struct V_1 * V_1 = (struct V_1 * ) V_12 -> V_32 ;
if ( V_124 -> V_95 > V_96 ) {
...
F_24 ( L_28 , V_124 -> V_95 ) ;
memcpy ( V_124 , & V_125 [ V_93 [ V_1 -> V_57 ] ] , sizeof( struct V_123 ) ) ;
return 0 ;
}
static int F_38 ( struct V_79 * V_79 , void * V_80 , struct V_123 * V_124 )
{
F_6 ( L_29 , V_124 -> V_95 ) ;
return 0 ;
}
static int F_39 ( struct V_79 * V_79 , void * V_80 , struct V_126 * V_127 )
{
struct V_11 * V_12 = ( (struct V_83 * ) V_80 ) -> V_12 ;
return F_31 ( V_12 , V_41 , V_128 , V_127 ) ;
}
static int F_40 ( struct V_79 * V_79 , void * V_80 , struct V_126 * V_127 )
{
struct V_11 * V_12 = ( (struct V_83 * ) V_80 ) -> V_12 ;
return F_31 ( V_12 , V_41 , V_129 , V_127 ) ;
}
static long F_41 ( struct V_79 * V_79 , void * V_80 , bool V_130 ,
int V_131 , void * V_132 )
{
struct V_11 * V_12 = ( (struct V_83 * ) V_80 ) -> V_12 ;
struct V_1 * V_1 = (struct V_1 * ) V_12 -> V_32 ;
switch ( V_131 ) {
...
static int F_42 ( struct V_11 * V_12 , struct V_137 * V_138 )
{
struct V_1 * V_1 ;
F_24 ( L_34 , V_12 ) ;
F_43 ( V_12 , & V_120 ) ;
...
V_120 . V_139 . F_22 = F_22 ;
V_120 . V_139 . F_23 = F_23 ;
V_120 . V_139 . F_25 = F_25 ;
V_120 . V_139 . F_26 = F_26 ;
V_120 . V_139 . F_27 = F_27 ;
V_120 . V_139 . F_28 = F_28 ;
V_120 . V_139 . F_29 = F_29 ;
V_120 . V_139 . F_32 = F_32 ;
V_120 . V_139 . F_33 = F_33 ;
V_120 . V_139 . F_34 = F_34 ;
V_120 . V_139 . F_37 = F_37 ;
V_120 . V_139 . F_38 = F_38 ;
#ifdef F_45
V_120 . V_139 . F_39 = F_39 ;
V_120 . V_139 . F_40 = F_40 ;
#endif
V_120 . V_139 . F_41 = F_41 ;
if ( F_46 ( & V_1 -> V_140 , V_12 , L_35 , V_141 ) ) {
F_47 ( L_36 ) ;
F_44 ( V_12 ) ;
return - 1 ;
}
if ( F_48 ( V_12 ) ) {
if ( F_46 ( & V_1 -> V_142 , V_12 , L_35 , V_143 ) ) {
F_47 ( L_37 ) ;
}
}
F_19 ( L_38 , V_17 ) ;
...
static int F_51 ( struct V_11 * V_12 , struct V_144 * V_145 )
{
struct V_1 * V_1 = (struct V_1 * ) V_12 -> V_32 ;
if ( V_146 == V_145 -> V_86 ) {
T_1 V_37 = V_146 ;
F_6 ( L_39 ) ;
F_21 ( V_12 , V_147 , 0x00404050 ) ;
F_15 ( V_1 , V_41 , V_148 , 0 ) ;
F_16 ( V_1 , V_41 , V_42 , V_37 ) ;
} else {
T_1 V_37 = V_38 ;
F_6 ( L_40 ) ;
F_21 ( V_12 , V_147 , 0x00404050 ) ;
F_15 ( V_1 , V_41 , V_148 , 1 ) ;
F_16 ( V_1 , V_41 , V_42 , V_37 ) ;
}
return 0 ;
}
