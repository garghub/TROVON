...
F_32 ( V_5 , V_131 ) ;
F_83 ( V_5 ) ;
V_5 -> V_21 = F_138 ( V_130 -> V_21 , F_139 ( V_5 -> V_225 ) , V_227 , 0 ) ;
if ( ! V_5 -> V_21 ) {
...
F_34 ( V_2 , V_5 , V_166 ) ;
if ( ! V_5 -> V_234 )
V_5 -> V_234 = F_140 ( V_5 -> V_225 ) ;
F_141 ( V_130 -> V_149 , V_5 -> V_234 , & V_5 -> V_15 ) ;
V_5 -> V_23 = F_142 ( V_227 ) ;
V_5 -> V_24 = ( ( F_143 ( V_227 ) & 0x7F ) ) << 1 ;
V_230 = V_130 -> V_235 / V_130 -> V_236 ;
V_5 -> V_237 = F_144 ( V_227 ) * V_230 ;
V_230 = V_130 -> V_238 / V_130 -> V_236 ;
V_5 -> V_20 = V_130 -> V_239 [ F_144 ( V_227 ) * V_230 ] ;
...
V_5 -> V_237 , V_5 -> V_20 , V_5 -> V_234 , V_5 -> V_15 ,
V_5 -> V_24 ) ;
F_31 ( V_5 , V_143 ) ;
F_3 ( V_5 , V_2 , V_5 -> V_21 ) ;
return 0 ;
...
static inline void F_147 ( struct V_251 * V_13 ,
unsigned int V_252 , unsigned int V_108 ,
unsigned int V_253 )
{
struct V_254 * V_255 = (struct V_254 * ) ( V_13 + 1 ) ;
F_148 ( V_13 , V_252 , 0 , 0 ) ;
V_13 -> V_58 = F_35 ( F_149 ( V_256 ) | ( 1 << 23 ) ) ;
V_13 -> V_108 = F_35 ( F_150 ( V_108 >> 5 ) ) ;
V_13 -> V_257 = F_35 ( F_151 ( V_253 >> 5 ) ) ;
V_13 -> V_258 = F_35 ( F_45 ( V_252 - sizeof( V_13 -> V_259 ) , 16 ) ) ;
V_255 -> V_260 = F_35 ( F_149 ( V_261 ) ) ;
V_255 -> V_7 = F_35 ( V_108 ) ;
}
static int F_152 ( struct V_133 * V_44 , unsigned int V_29 ,
struct V_262 * V_263 , unsigned int V_22 ,
unsigned int V_264 ,
struct V_265 * V_266 ,
unsigned int V_267 )
{
struct V_268 * V_269 = V_44 -> V_269 ;
struct V_1 * V_2 ;
struct V_251 * V_13 ;
struct V_254 * V_255 ;
struct V_270 * V_271 ;
unsigned int V_253 = V_22 * V_272 + V_269 -> V_273 ;
unsigned int V_108 = V_272 * V_264 ;
unsigned int V_252 = F_153 ( sizeof( struct V_251 ) +
sizeof( struct V_254 ) + V_108 , 16 ) ;
unsigned int V_88 ;
V_2 = F_39 ( V_252 , 0 , V_75 ) ;
if ( ! V_2 ) {
F_82 ( L_47 ,
V_44 , V_22 , V_264 ) ;
return - V_160 ;
}
V_13 = (struct V_251 * ) V_2 -> V_30 ;
F_1 ( V_2 , V_274 , NULL ) ;
F_147 ( V_13 , V_252 , V_108 , V_253 ) ;
V_255 = (struct V_254 * ) ( V_13 + 1 ) ;
V_271 = (struct V_270 * ) ( V_255 + 1 ) ;
for ( V_88 = 0 ; V_88 < V_264 ; V_88 ++ , V_271 ++ , V_267 += V_275 ) {
if ( ! V_263 && ! V_266 )
F_154 ( V_271 ) ;
else
F_155 ( V_271 , V_263 , V_266 , V_267 ) ;
}
F_28 ( V_44 -> V_45 [ V_29 ] , V_2 ) ;
return 0 ;
}
static int F_156 ( struct V_4 * V_5 , struct V_262 * V_263 ,
unsigned int V_22 , unsigned int V_264 ,
struct V_265 * V_266 )
{
unsigned int V_88 , V_81 ;
int V_187 = 0 ;
for ( V_88 = 0 ; V_88 < V_264 ; V_88 += V_81 , V_22 += V_81 ) {
V_81 = V_264 - V_88 ;
if ( V_81 > V_276 )
V_81 = V_276 ;
V_187 = F_152 ( V_5 -> V_44 , V_5 -> V_29 , V_263 ,
V_22 , V_81 , V_266 , 4 * V_88 ) ;
if ( V_187 < 0 )
break;
}
return V_187 ;
}
static void F_157 ( struct V_277 * V_278 , unsigned int V_279 ,
unsigned int V_22 , unsigned int V_264 )
{
unsigned int V_88 , V_81 ;
int V_187 ;
...
if ( V_81 > V_276 )
V_81 = V_276 ;
V_187 = F_152 ( V_278 -> V_44 , V_278 -> V_29 , NULL ,
V_22 , V_81 , NULL , 0 ) ;
if ( V_187 < 0 )
break;
}
...
if ( ! V_2 )
return - V_160 ;
V_13 = (struct V_282 * ) V_2 -> V_30 ;
F_16 ( V_13 , V_5 -> V_48 ) ;
F_17 ( V_13 ) = F_35 ( F_19 ( V_284 , V_5 -> V_48 ) ) ;
V_13 -> V_285 = F_159 ( F_160 ( V_281 ) | F_161 ( V_5 -> V_20 ) ) ;
V_13 -> V_286 = F_159 ( 0 ) ;
V_13 -> V_287 = F_20 ( 0x3 << 8 ) ;
V_13 -> V_95 = F_20 ( V_280 << 8 ) ;
F_15 ( V_2 , V_274 , V_5 -> V_29 ) ;
F_21 ( 1 << V_42 | 1 << V_43 ,
L_48 , V_5 , V_5 -> V_48 , V_280 ) ;
F_28 ( V_5 -> V_44 -> V_45 [ V_5 -> V_29 ] , V_2 ) ;
return 0 ;
}
static int F_162 ( struct V_4 * V_5 , unsigned int V_48 ,
int V_288 , int V_289 , int V_281 )
{
struct V_1 * V_2 ;
struct V_282 * V_13 ;
if ( ! V_288 && ! V_289 )
...
V_13 = (struct V_282 * ) V_2 -> V_30 ;
F_16 ( V_13 , V_48 ) ;
F_17 ( V_13 ) = F_35 ( F_19 ( V_284 , V_48 ) ) ;
V_13 -> V_285 = F_159 ( F_160 ( V_281 ) | F_161 ( V_5 -> V_20 ) ) ;
V_13 -> V_286 = F_159 ( 0 ) ;
V_13 -> V_287 = F_20 ( 0x3 << 4 ) ;
V_13 -> V_95 = F_20 ( ( ( V_288 ? V_291 : 0 ) |
( V_289 ? V_292 : 0 ) ) << 4 ) ;
F_15 ( V_2 , V_274 , V_5 -> V_29 ) ;
F_21 ( 1 << V_42 | 1 << V_43 ,
L_49 , V_5 , V_5 -> V_48 , V_288 , V_289 ) ;
F_28 ( V_5 -> V_44 -> V_45 [ V_5 -> V_29 ] , V_2 ) ;
return 0 ;
}
...
V_187 = F_166 ( V_44 , V_130 -> V_297 -> V_298 . V_299 ,
V_130 -> V_297 -> V_298 . V_299 + V_130 -> V_297 -> V_298 . V_300 - 1 ,
V_130 -> V_301 , V_130 -> V_301 ) ;
if ( V_187 < 0 )
return V_187 ;
V_269 = V_44 -> V_269 ;
V_293 = V_269 -> V_302 << V_303 ;
F_167 ( V_294 ) ;
F_168 ( V_130 -> V_45 [ 0 ] , V_293 , V_294 ) ;
V_44 -> V_304 = F_162 ;
V_44 -> V_305 = F_158 ;
V_44 -> V_306 = F_156 ;
V_44 -> V_307 = F_157 ;
F_40 ( L_51 ,
V_44 , V_44 -> V_308 . V_309 , V_44 -> V_308 . V_310 ,
V_44 -> V_308 . V_311 , V_44 -> V_308 . V_312 ) ;
F_40 ( L_52
L_53 ,
V_44 , V_269 -> V_313 , V_269 -> V_314 , V_269 -> V_302 ,
V_269 -> V_315 , V_269 -> V_316 , V_130 -> V_301 ,
V_269 -> V_317 , V_130 -> V_301 ) ;
F_40 ( L_54 ,
V_44 , V_44 -> V_318 , V_269 -> V_316 , V_44 -> V_319 ,
V_269 -> V_317 ) ;
return 0 ;
}
...
struct V_228 * V_229 ;
int V_88 , V_240 ;
V_44 = F_170 ( sizeof( * V_130 ) , V_130 -> V_320 ) ;
if ( ! V_44 ) {
F_40 ( L_55 , V_130 ) ;
return NULL ;
}
F_40 ( L_56 ,
V_44 , V_130 -> V_321 , V_130 -> V_320 ,
V_130 -> V_45 [ 0 ] -> V_231 , V_130 -> V_236 , V_130 -> V_235 ,
V_130 -> V_238 , V_130 -> V_122 ) ;
for ( V_88 = 0 ; V_88 < V_130 -> V_238 ; V_88 ++ )
F_21 ( 1 << V_322 ,
L_57 ,
V_44 , V_88 , V_130 -> V_239 [ V_88 ] ) ;
memcpy ( F_72 ( V_44 ) , V_130 , sizeof( * V_130 ) ) ;
V_44 -> V_50 = V_323 ;
V_44 -> V_324 = V_130 -> V_324 ;
V_44 -> V_45 = V_130 -> V_45 ;
V_44 -> V_320 = V_130 -> V_320 ;
...
V_44 -> V_329 = V_330 ;
V_44 -> V_331 = V_332 ;
V_44 -> V_333 = sizeof( struct V_190 ) ;
V_44 -> V_334 = & V_335 ;
...
V_240 = F_172 ( V_44 , V_337 , V_338 ,
& V_339 , V_340 ) ;
if ( V_240 )
goto V_336;
for ( V_88 = 0 ; V_88 < V_44 -> V_320 ; V_88 ++ ) {
V_229 = F_136 ( V_130 -> V_45 [ V_88 ] ) ;
V_44 -> V_341 [ V_88 ] -> V_29 = V_229 -> V_29 ;
}
return V_44 ;
V_336:
F_173 ( V_44 ) ;
...
static int F_175 ( void * V_55 , const T_2 * V_342 ,
...
if ( ! V_2 )
goto V_347;
F_176 ( V_2 , & V_342 [ 1 ] , V_7 ) ;
} else {
if ( F_30 ( * ( V_348 * ) V_342 != * ( V_348 * ) V_344 -> V_349 ) ) {
F_40 ( L_61 ,
V_344 -> V_349 , F_177 ( * V_342 ) ,
F_177 ( * ( V_350 * ) V_344 -> V_349 ) ,
V_344 -> V_351 ) ;
return 0 ;
}
V_2 = F_178 ( V_344 , V_352 , V_352 ) ;
if ( F_30 ( ! V_2 ) )
goto V_347;
}
V_70 = (struct V_134 * ) V_2 -> V_57 ;
V_345 = V_70 -> V_353 . V_354 ;
F_21 ( 1 << V_42 ,
L_62 ,
V_44 , V_345 , V_70 -> V_353 . V_355 , F_79 ( V_70 -> V_353 . V_355 ) , V_2 ) ;
if ( V_356 [ V_345 ] )
V_356 [ V_345 ] ( V_44 , V_2 ) ;
else {
F_82 ( L_63 , V_345 ) ;
F_93 ( V_2 ) ;
}
...
static int F_179 ( void * V_55 , enum V_357 V_49 )
{
struct V_133 * V_44 = V_55 ;
switch ( V_49 ) {
case V_358 :
...
{
int V_240 ;
F_181 ( V_362 L_70 , V_363 ) ;
V_240 = F_182 ( & V_335 , & V_340 ) ;
if ( V_240 < 0 )
return V_240 ;
F_183 ( V_364 , & V_365 ) ;
return 0 ;
