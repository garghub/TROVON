...
V_8 = F_48 ( sizeof( * V_8 ) , V_91 ) ;
if ( ! V_8 )
return - V_92 ;
F_49 ( & V_8 -> V_53 ) ;
V_3 = & V_8 -> V_3 ;
F_50 ( V_3 -> V_81 , V_93 , sizeof( V_3 -> V_81 ) ) ;
F_51 ( V_3 , V_10 , & V_94 ) ;
V_3 -> V_95 = & V_96 ;
V_3 -> V_97 |= V_98 ;
F_52 ( & V_8 -> V_7 , 3 ) ;
...
V_13 = F_57 ( & V_10 -> V_83 , V_49 ,
V_8 -> V_50 ) ;
if ( V_13 )
goto V_104;
V_8 -> V_105 . V_97 = V_106 ;
V_3 -> V_107 . type = V_108 ;
V_13 = F_58 ( & V_3 -> V_107 , 1 , & V_8 -> V_105 , 0 ) ;
if ( V_13 < 0 )
goto V_109;
V_13 = F_45 ( V_10 , V_8 ) ;
if ( ! V_13 )
