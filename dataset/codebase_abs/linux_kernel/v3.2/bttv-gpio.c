...
F_13 ( L_2 , V_15 -> V_25 , F_3 ( & V_6 -> V_2 ) ) ;
F_14 ( & V_6 -> V_26 , & V_15 -> V_27 ) ;
return 0 ;
}
int F_15 ( struct V_14 * V_15 )
{
struct V_9 * V_6 , * V_28 ;
F_16 (sub, save, &core->subs, list) {
F_17 ( & V_6 -> V_26 ) ;
F_18 ( & V_6 -> V_2 ) ;
}
return 0 ;
}
int F_19 ( struct V_5 * V_6 , char * V_8 )
{
V_6 -> V_4 . V_22 = & V_23 ;
...
void F_23 ( struct V_14 * V_15 , T_1 V_29 , T_1 V_30 )
{
struct V_31 * V_32 = F_24 ( V_15 , struct V_31 , V_33 ) ;
unsigned long V_34 ;
T_1 V_35 ;
F_25 ( & V_32 -> V_36 , V_34 ) ;
V_35 = F_26 ( V_37 ) ;
...
void F_30 ( struct V_14 * V_15 , T_1 V_38 )
{
struct V_31 * V_32 = F_24 ( V_15 , struct V_31 , V_33 ) ;
F_27 ( V_38 , V_39 ) ;
}
void F_31 ( struct V_14 * V_15 , T_1 V_29 , T_1 V_40 )
{
struct V_31 * V_32 = F_24 ( V_15 , struct V_31 , V_33 ) ;
unsigned long V_34 ;
T_1 V_35 ;
