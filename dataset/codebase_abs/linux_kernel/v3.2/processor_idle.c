...
if ( ! V_16 -> V_129 && F_41 () ) {
if ( V_117 -> V_130 >= 0 ) {
return V_117 -> V_33 [ V_117 -> V_130 ] . F_64 ( V_115 ,
V_117 , V_117 -> V_130 ) ;
} else {
F_9 () ;
F_4 () ;
...
return - V_49 ;
F_73 () ;
F_74 ( & V_14 -> V_19 . V_115 ) ;
F_40 ( V_14 ) ;
if ( V_14 -> V_51 . V_19 ) {
F_69 ( V_14 ) ;
V_148 = F_75 ( & V_14 -> V_19 . V_115 ) ;
}
F_76 () ;
return V_148 ;
}
...
F_79 () ;
F_80 (cpu) {
V_149 = F_81 ( V_124 , V_136 ) ;
if ( ! V_149 || ! V_149 -> V_51 . V_135 )
continue;
F_74 ( & V_149 -> V_19 . V_115 ) ;
}
F_71 ( V_14 ) ;
F_80 (cpu) {
V_149 = F_81 ( V_124 , V_136 ) ;
...
int F_91 ( struct V_13 * V_14 ,
struct V_40 * V_41 )
{
if ( F_1 () )
return 0 ;
if ( V_14 -> V_51 . V_19 ) {
F_92 ( & V_14 -> V_19 . V_115 ) ;
V_158 -- ;
if ( V_158 == 0 )
F_90 ( & V_140 ) ;
}
