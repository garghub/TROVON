...
union V_11 * F_15 ( struct V_29 * V_30 )
{
unsigned long V_31 ;
union V_11 * V_12 ;
...
V_34 = F_18 ( V_30 ) ;
V_33 = F_19 ( V_34 ) ;
V_12 = F_20 ( V_33 , union V_11 , V_23 ) ;
F_21 ( & V_12 -> V_23 . V_26 . V_24 ) ;
...
V_49 = F_29 ( & V_15 -> V_56 , & V_51 -> V_57 [ 0 ] ) ;
if ( V_51 -> V_58 == V_59 ) {
if ( V_49 != NULL ) {
if ( F_30 ( V_51 -> V_60 ) ) {
...
union V_11 * F_34 ( struct V_8 * V_9 ,
union V_11 * V_73 )
{
...
union V_11 * F_38 ( struct V_8 * V_15 ,
union V_11 * V_73 )
{
V_3 * V_80 , * V_81 ;
T_3 V_82 ;
...
static T_1 F_41 ( union V_11 * V_73 , V_3 V_93 ,
struct V_94 * V_95 )
{
...
static T_1 F_42 ( struct V_8 * V_15 ,
union V_11 * V_73 ,
struct V_48 * * V_85 )
{
...
V_3 * V_106 = F_43 ( V_104 ) ;
V_3 * V_107 = F_44 ( & V_15 -> V_108 ) ;
V_3 * V_109 = NULL ;
T_1 V_110 = F_30 ( V_102 -> V_111 ) ;
if ( ( F_45 ( V_104 , V_112 ) == true ) ||
( F_45 ( V_104 , V_113 ) == true ) ) {
...
return V_20 ;
V_109 = V_102 -> V_114 ;
} else if ( F_45 ( V_104 , V_117 ) == true ) {
if ( memcmp ( V_102 -> V_116 , V_102 -> V_114 , V_115 ) )
return V_20 ;
V_109 = V_102 -> V_116 ;
} else if ( F_45 ( V_104 , V_118 ) == true ) {
if ( V_110 ) {
if ( ! F_30 ( V_102 -> V_116 ) )
return V_20 ;
} else {
...
* V_85 = F_29 ( V_87 , V_109 ) ;
if ( * V_85 == NULL ) {
if ( F_45 ( V_104 , V_119 ) == true )
V_15 -> V_120 . V_121 ++ ;
return V_20 ;
}
return V_101 ;
...
V_3 * V_107 = F_44 ( & V_15 -> V_108 ) ;
T_1 V_110 = F_30 ( V_102 -> V_111 ) ;
if ( ( F_45 ( V_104 , V_117 ) == true )
&& ( F_45 ( V_104 , V_122 ) == true ) ) {
if ( ( F_51 ( V_81 ) ) == V_123 )
return V_20 ;
if ( ( F_51 ( V_81 ) & V_124 ) ==
V_124 ) {
...
struct V_86 * V_87 = & V_15 -> V_56 ;
struct V_103 * V_104 = & V_15 -> V_105 ;
unsigned char * V_106 = F_43 ( V_104 ) ;
if ( F_45 ( V_104 , V_118 ) == true ) {
if ( memcmp ( V_102 -> V_116 , V_106 , V_115 ) )
return V_20 ;
* V_85 = F_29 ( V_87 , V_102 -> V_114 ) ;
if ( * V_85 == NULL )
return V_20 ;
}
return V_38 ;
...
if ( F_41 ( V_73 , V_93 , & V_85 -> V_135 . V_136 ) ==
V_20 )
return V_20 ;
if ( V_102 -> V_137 ) {
