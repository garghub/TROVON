...
F_8 ( L_3 ,
V_23 -> V_28 , V_23 -> V_29 , V_23 -> V_30 ) ;
if ( V_18 -> V_31 . V_32 )
V_18 -> V_31 . V_32 ( V_18 , 1 ) ;
switch ( V_23 -> V_28 ) {
case V_33 :
switch ( V_23 -> V_30 ) {
case 6000000 :
...
V_7 [ 2 ] = 0x03 ;
V_7 [ 3 ] = V_26 / 50 ;
V_7 [ 4 ] = ( ( V_23 -> V_29 / 1000 ) >> 16 ) & 0xff ;
V_7 [ 5 ] = ( ( V_23 -> V_29 / 1000 ) >> 8 ) & 0xff ;
V_7 [ 6 ] = ( ( V_23 -> V_29 / 1000 ) >> 0 ) & 0xff ;
V_7 [ 7 ] = 0xc1 ;
V_7 [ 8 ] = 0x01 ;
...
struct V_40 * V_14 , struct V_41 * V_11 )
{
struct V_1 * V_2 = NULL ;
int V_6 ;
T_1 V_4 ;
V_2 = F_12 ( sizeof( struct V_1 ) , V_42 ) ;
if ( V_2 == NULL )
return NULL ;
V_2 -> V_11 = V_11 ;
V_2 -> V_14 = V_14 ;
