...
if ( ( V_58 != F_31 ( V_109 , V_110 ) ) &&
( V_58 != F_31 ( V_109 , V_111 ) ) ) {
F_4 ( & V_5 -> V_6 , L_9 ) ;
V_58 = - V_112 ;
goto error;
}
F_32 ( & V_5 -> V_6 , L_10 ,
V_58 & 7 ) ;
V_33 = F_33 ( sizeof( struct V_32 ) , V_113 ) ;
if ( ! V_33 ) {
F_4 ( & V_5 -> V_6 , L_11 ) ;
return - V_114 ;
}
...
static int F_37 ( struct V_5 * V_118 )
{
struct V_32 * V_33 = F_38 ( V_118 ) ;
F_39 ( & V_118 -> V_6 ) ;
F_36 ( V_33 ) ;
return 0 ;
}
