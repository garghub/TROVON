...
V_118 -> V_164 = V_163 -> V_92 ;
if ( V_62 -> V_120 . V_71 [ 0 ] . V_25 & V_165 )
V_118 -> V_164 = V_163 -> V_166 ;
...
V_161 - V_159 : V_161 ) ;
V_118 -> V_97 = 0 ;
V_13 = F_75 ( & V_118 -> V_97 , F_102 ( V_118 -> V_164 ) ,
F_103 ( V_118 -> V_99 ) ) ;
if ( V_13 < 0 )
return V_13 ;
V_118 -> V_167 = F_101 ( V_13 ) ;
V_118 -> V_168 = 0 ;
return 0 ;
}
...
static int F_107 ( struct V_8 * V_9 , struct V_84 * V_170 ,
struct V_171 * V_172 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
struct V_43 * V_44 ;
...
continue;
V_85 = (struct V_84 * ) V_44 -> V_89 ;
if ( F_109 ( ! memcmp ( V_85 -> V_173 , V_170 -> V_90 , V_15 ) ) )
{
V_82 = 1 ;
break;
}
...
int F_110 ( struct V_8 * V_9 , const T_1 * V_174 , unsigned int V_175 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
struct V_171 V_172 ;
const struct V_176 * V_70 ;
struct V_43 * V_44 ;
int V_177 = 0 ;
T_4 V_178 ;
int V_179 ;
...
T_1 V_75 ;
if ( V_175 < V_180 + 10 +
V_160 + sizeof( struct V_176 ) )
return - V_115 ;
memset ( & V_172 , 0 , sizeof( V_172 ) ) ;
V_70 = (struct V_176 * )
( V_174 + ( V_175 - sizeof( struct V_176 ) ) ) ;
if ( V_70 -> V_181 & V_182 ) {
if ( V_11 -> V_183 &&
( V_70 -> V_181 & V_184 ) ) {
V_172 . V_185 |= V_186 ;
...
V_172 . V_187 = V_188 [ F_111 ( & V_11 -> V_16 ) - 1 ] . V_189 ;
V_172 . V_190 = V_191 ;
V_172 . signal = F_3 ( V_9 , V_70 -> V_192 ) ;
V_75 = F_112 ( V_174 , V_70 ) ;
for ( V_3 = 0 ; V_3 < V_11 -> V_190 . V_193 ; V_3 ++ )
if ( V_75 == V_11 -> V_190 . V_194 [ V_3 ] . V_92 )
V_172 . V_195 = V_3 ;
V_175 -= V_180 + sizeof( struct V_176 ) ;
V_174 += V_180 ;
if ( ! V_177 &&
F_107 ( V_9 , (struct V_84 * ) V_174 , & V_172 )
&& ! V_11 -> V_28 )
return 0 ;
V_178 = F_113 ( ( T_4 * ) V_174 ) ;
V_179 = F_114 ( V_178 ) ^ F_115 ( V_178 ) ;
V_44 = F_116 ( V_175 + ( V_179 ? 2 : 0 ) ) ;
if ( V_44 == NULL )
return - V_146 ;
if ( V_179 ) {
F_117 ( V_44 , 2 ) ;
}
memcpy ( F_118 ( V_44 , V_175 ) , V_174 , V_175 ) ;
memcpy ( F_119 ( V_44 ) , & V_172 , sizeof( V_172 ) ) ;
F_120 ( V_9 , V_44 ) ;
return 0 ;
}
...
V_11 -> type = V_197 ;
V_11 -> V_31 = NULL ;
F_60 ( & V_11 -> V_16 , 0 , 0 , V_197 ) ;
F_31 ( & V_11 -> V_16 , NULL ) ;
F_83 ( V_11 ) ;
}
static int F_123 ( struct V_8 * V_9 , T_2 V_201 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
struct V_202 * V_203 = & V_9 -> V_203 ;
F_16 ( & V_11 -> V_21 ) ;
V_11 -> V_52 = V_203 -> V_52 -> V_92 ;
F_17 ( & V_11 -> V_21 ) ;
return F_56 ( & V_11 -> V_16 , V_203 -> V_52 -> V_92 ) ;
}
...
T_3 V_206 ;
unsigned long V_25 ;
struct V_10 * V_11 = F_129 ( V_205 , struct V_10 , V_207 ) ;
F_27 ( & V_11 -> V_21 , V_25 ) ;
V_206 = F_103 ( * ( T_4 * ) ( V_11 -> V_208 + 4 ) ) ;
F_28 ( & V_11 -> V_21 , V_25 ) ;
if ( V_206 & V_209 ) {
F_124 ( V_11 ) ;
} else {
...
F_34 ( & V_34 ) ;
F_131 (ha, mc_list) {
F_55 ( F_6 ( V_11 ) , L_14 , V_213 -> V_14 ) ;
F_132 ( & V_34 , V_213 -> V_14 ) ;
}
return V_34 . V_214 | ( ( T_5 ) V_34 . V_215 << 32 ) ;
}
...
F_134 ( & V_34 ) ;
F_27 ( & V_11 -> V_21 , V_25 ) ;
V_11 -> V_183 = ! ! ( * V_217 & V_222 ) ;
V_11 -> V_28 = ! ! ( * V_217 & V_223 ) ;
V_11 -> V_48 = V_34 ;
F_28 ( & V_11 -> V_21 , V_25 ) ;
F_35 ( & V_11 -> V_16 , & V_34 ) ;
if ( V_216 & V_223 ) {
...
V_227 = F_137 ( V_225 -> V_233 ) ;
F_16 ( & V_11 -> V_21 ) ;
V_11 -> V_227 = V_227 ;
F_17 ( & V_11 -> V_21 ) ;
if ( V_226 & V_234 ) {
F_16 ( & V_11 -> V_21 ) ;
V_11 -> V_49 = V_225 -> V_235 ;
F_17 ( & V_11 -> V_21 ) ;
F_57 ( V_11 , V_225 -> V_235 ) ;
}
}
static T_5 F_138 ( struct V_8 * V_9 , struct V_196 * V_31 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
return F_139 ( & V_11 -> V_16 ) ;
}
struct V_8 * F_140 ( struct V_236 * V_157 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
V_9 = F_141 ( sizeof( struct V_10 ) , & V_237 ) ;
if ( ! V_9 ) {
F_55 ( & V_157 -> V_238 , L_17 ) ;
return NULL ;
}
V_11 = F_4 ( V_9 ) ;
...
V_11 -> V_9 = V_9 ;
V_11 -> type = V_197 ;
memcpy ( V_11 -> V_239 , V_188 , sizeof( V_188 ) ) ;
memcpy ( V_11 -> V_71 , V_91 , sizeof( V_91 ) ) ;
V_11 -> V_190 . V_193 = F_2 ( V_91 ) ;
V_11 -> V_190 . V_194 = V_11 -> V_71 ;
V_11 -> V_190 . V_240 = F_2 ( V_188 ) ;
V_11 -> V_190 . V_239 = V_11 -> V_239 ;
V_9 -> V_23 -> V_241 [ V_191 ] = & V_11 -> V_190 ;
V_9 -> V_25 = V_242 |
V_243 |
V_244 ;
V_9 -> V_23 -> V_245 =
...
F_146 ( V_11 ) ;
F_147 ( V_11 ) ;
F_148 ( & V_11 -> V_207 , F_128 ) ;
F_149 ( V_9 , & V_157 -> V_238 ) ;
return V_9 ;
}
static void F_150 ( struct V_204 * V_205 )
{
struct V_10 * V_11 =
F_129 ( V_205 , struct V_10 , V_47 . V_251 . V_205 ) ;
struct V_43 * V_47 ;
unsigned long V_252 ;
int V_53 , V_54 ;
if ( ! F_125 ( V_42 , & V_11 -> V_25 ) )
...
V_53 = V_11 -> V_47 . V_53 ;
V_54 = V_11 -> V_47 . V_54 ;
V_252 = V_11 -> V_47 . V_57 +
F_151 ( V_53 * 1024 / 1000 ) * 3 ;
F_17 ( & V_11 -> V_21 ) ;
if ( V_53 > 0 && F_152 ( V_252 ) ) {
F_55 ( F_6 ( V_11 ) , L_18
L_19
L_20 ,
V_53 , V_54 ) ;
...
V_253:
F_153 ( V_24 , & V_11 -> V_47 . V_251 ,
V_254 ) ;
}
static void F_147 ( struct V_10 * V_11 )
{
F_154 ( & V_11 -> V_47 . V_251 , F_150 ) ;
}
...
{
F_55 ( F_6 ( V_11 ) , L_3 ) ;
F_155 ( & V_11 -> V_47 . V_251 ) ;
F_83 ( V_11 ) ;
}
static void F_156 ( struct V_204 * V_205 )
{
struct V_10 * V_11 =
F_129 ( V_205 , struct V_10 , V_255 . V_256 . V_205 ) ;
struct V_17 * V_16 = & V_11 -> V_16 ;
int V_257 ;
int V_13 ;
if ( ! F_125 ( V_42 , & V_11 -> V_25 ) )
...
V_258:
F_153 ( V_24 , & V_11 -> V_255 . V_256 ,
V_261 ) ;
}
static void F_146 ( struct V_10 * V_11 )
{
F_154 ( & V_11 -> V_255 . V_256 , F_156 ) ;
}
...
{
F_55 ( F_6 ( V_11 ) , L_3 ) ;
F_155 ( & V_11 -> V_255 . V_256 ) ;
F_157 ( & V_11 -> V_16 , V_262 ) ;
}
