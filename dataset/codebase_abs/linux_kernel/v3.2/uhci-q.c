...
F_65 ( V_2 ) ;
V_35 = V_2 -> V_67 + 10 ;
V_17 -> V_173 = V_35 + ( ( V_53 -> V_96 - V_35 ) &
( V_53 -> V_97 - 1 ) ) ;
} else {
V_103 = V_17 -> V_173 - V_2 -> V_174 ;
if ( V_103 <= 0 || V_103 >= V_42 )
return - V_152 ;
V_53 -> V_96 = V_17 -> V_173 & ( V_53 -> V_97 - 1 ) ;
V_103 = F_72 ( V_2 , V_53 ) ;
if ( V_103 )
return V_103 ;
}
...
if ( F_106 ( V_2 -> V_174 + V_42 ,
V_17 -> V_173 + V_17 -> V_170 *
V_17 -> V_159 ) )
return - V_171 ;
V_7 = V_139 | V_177 ;
V_126 = ( V_17 -> V_76 & V_133 ) | F_87 ( V_17 -> V_76 ) ;
for ( V_103 = 0 ; V_103 < V_17 -> V_170 ; V_103 ++ ) {
V_32 = F_17 ( V_2 ) ;
if ( ! V_32 )
return - V_148 ;
F_26 ( V_32 , V_19 ) ;
F_25 ( V_2 , V_32 , V_7 , V_126 |
F_85 ( V_17 -> V_178 [ V_103 ] . V_179 ) ,
V_17 -> V_131 +
V_17 -> V_178 [ V_103 ] . V_180 ) ;
}
V_32 -> V_7 |= F_4 ( V_2 , V_8 ) ;
V_35 = V_17 -> V_173 ;
F_37 (td, &urbp->td_list, list) {
...
if ( F_21 ( & V_53 -> V_56 ) ) {
V_53 -> V_181 = & V_17 -> V_178 [ 0 ] ;
V_53 -> V_175 = V_17 -> V_173 ;
}
V_53 -> V_81 = V_87 ;
if ( ! V_53 -> V_110 )
F_75 ( V_2 , V_53 ) ;
...
F_28 ( V_32 ) ;
F_20 ( V_2 , V_32 ) ;
V_53 -> V_175 += V_53 -> V_97 ;
++ V_53 -> V_181 ;
}
return 0 ;
}
static int F_108 ( struct V_186 * V_187 ,
struct V_17 * V_17 , T_4 V_188 )
{
int V_66 ;
...
goto V_69;
if ( V_17 -> V_190 -> V_20 )
V_53 = V_17 -> V_190 -> V_20 ;
else {
V_53 = F_38 ( V_2 , V_17 -> V_135 , V_17 -> V_190 ) ;
if ( ! V_53 )
goto V_191;
}
V_19 -> V_53 = V_53 ;
...
static int F_112 ( struct V_186 * V_187 , struct V_17 * V_17 , int V_7 )
{
struct V_1 * V_2 = F_109 ( V_187 ) ;
unsigned long V_28 ;
struct V_9 * V_53 ;
...
struct V_17 * V_195 = F_7 ( V_19 -> V_13 . V_47 ,
struct V_18 , V_13 ) -> V_17 ;
V_53 -> V_181 = & V_195 -> V_178 [ 0 ] ;
V_53 -> V_175 = V_195 -> V_173 ;
}
F_29 ( & V_19 -> V_13 ) ;
...
F_65 ( V_2 ) ;
V_2 -> V_183 = V_2 -> V_67 ;
for ( V_103 = 0 ; V_103 < V_202 - 1 ; ++ V_103 ) {
