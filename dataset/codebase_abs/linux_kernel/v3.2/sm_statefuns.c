...
V_298 = F_103 ( V_297 -> V_285 ) ;
} else {
V_298 = V_10 -> V_291 - 1 ;
}
if ( F_152 ( V_299 , V_298 + 1 ) &&
! ( V_10 -> V_296 ) ) {
...
F_26 ( V_2 -> V_51 , V_35 ) ;
V_308 = F_103 ( V_305 -> V_310 ) ;
F_69 ( L_8 , V_133 , V_308 ) ;
if ( F_156 ( & V_10 -> V_96 . V_311 , V_308 ) < 0 )
goto V_251;
F_157 (skip, chunk) {
if ( F_2 ( V_307 -> V_312 ) >= V_10 -> V_86 . V_94 )
goto V_251;
}
F_10 ( V_12 , V_313 , F_121 ( V_308 ) ) ;
...
if ( ! F_159 ( V_10 , V_317 -> V_324 ) )
return V_325 ;
V_321 = F_2 ( V_317 -> V_326 ) ;
if ( V_321 != V_10 -> V_327 && ! F_160 ( V_10 , V_321 ) )
return V_328 ;
V_320 = F_2 ( V_2 -> V_5 -> V_6 ) - sizeof( V_329 ) ;
V_319 = F_161 ( F_2 ( V_317 -> V_324 ) ) ;
if ( V_320 != V_319 -> V_330 )
return V_257 ;
V_323 = V_317 -> V_319 ;
F_26 ( V_2 -> V_51 , V_320 ) ;
V_322 = F_162 ( V_323 , V_320 , V_18 ) ;
if ( ! V_322 )
goto V_55;
...
struct V_13 * V_14 ;
V_14 = F_167 ( V_10 , F_2 ( V_317 -> V_326 ) ,
V_334 , V_18 ) ;
if ( ! V_14 )
return - V_335 ;
F_10 ( V_12 , V_19 ,
...
if ( F_39 ( V_63 , V_10 ) )
goto V_346;
abort = F_169 ( V_10 , V_2 , V_345 , V_119 ) ;
if ( ! abort )
goto V_55;
if ( V_10 ) {
...
return F_126 ( V_8 , V_10 , V_11 , V_12 , V_356 ,
sizeof( V_356 ) ) ;
}
static T_2 F_139 (
const struct V_7 * V_8 ,
...
static struct V_392 * F_131 ( struct V_1 * V_2 )
{
struct V_392 * V_393 ;
unsigned int V_35 ;
T_1 V_394 ;
...
F_18 ( F_19 () ) ) ;
V_33 = F_208 ( & V_66 -> V_33 , V_66 , V_397 , V_398 ) ;
...
V_308 = F_103 ( V_258 -> V_308 ) ;
F_69 ( L_23 , V_308 ) ;
if ( ! V_2 -> V_409 ) {
struct V_153 * V_154 ;
V_2 -> V_409 = 1 ;
V_154 = F_71 (
F_211 ( F_212 ( V_2 -> V_51 ) -> V_410 ) ) ;
if ( V_154 && V_154 -> V_411 ( V_2 -> V_51 ) && V_10 -> V_96 . V_412 ) {
F_10 ( V_12 , V_413 ,
F_121 ( V_308 ) ) ;
}
}
V_403 = F_156 ( & V_10 -> V_96 . V_311 , V_308 ) ;
if ( V_403 < 0 ) {
return V_248 ;
} else if ( V_403 > 0 ) {
F_10 ( V_12 , V_414 , F_121 ( V_308 ) ) ;
return V_252 ;
}
...
F_10 ( V_12 , V_429 , F_121 ( V_308 ) ) ;
V_181 = F_89 ( V_10 , V_2 , V_430 ,
& V_258 -> V_312 ,
sizeof( V_258 -> V_312 ) ,
sizeof( T_22 ) ) ;
if ( V_181 )
...
if ( V_408 && F_216 ( V_406 , F_217 ( & V_10 -> V_431 -> V_432 , V_407 ) ) ) {
return V_257 ;
}
