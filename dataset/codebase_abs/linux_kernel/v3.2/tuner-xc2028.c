...
goto V_121;
V_114 = 0 ;
V_59 = F_22 ( V_53 , V_10 | V_110 . type , & V_114 ) ;
if ( V_59 < 0 ) {
F_11 ( L_83 ,
V_59 ) ;
goto V_121;
...
F_2 ( L_84 ) ;
V_59 = F_22 ( V_53 , V_10 | V_11 | V_110 . type , & V_114 ) ;
if ( V_59 == - V_70 )
V_59 = F_22 ( V_53 , ( V_10 | V_11 | V_110 . type ) & ~ V_12 ,
& V_114 ) ;
if ( V_59 < 0 && V_59 != - V_70 ) {
F_11 ( L_85 ,
V_59 ) ;
...
V_2 -> V_51 . V_118 = 0 ;
V_59 = F_22 ( V_53 , V_110 . type , & V_110 . V_78 ) ;
if ( V_59 == - V_70 )
V_59 = F_22 ( V_53 , V_110 . type & ~ V_12 , & V_110 . V_78 ) ;
if ( V_59 < 0 )
goto V_121;
V_122:
...
V_59 = F_26 ( V_53 , V_110 . type | V_110 . V_118 , & V_110 . V_78 ,
...
static int F_29 ( struct V_52 * V_53 , T_1 * V_126 )
{
struct V_1 * V_2 = V_53 -> V_54 ;
T_1 V_127 , signal = 0 ;
int V_59 ;
...
static int F_32 ( struct V_52 * V_53 , T_5 V_129 ,
enum V_130 V_131 ,
unsigned int type ,
T_2 V_108 ,
T_1 V_9 )
...
V_132 = 2750000 ;
if ( ( V_2 -> V_51 . type & V_19 ) && V_129 < 470000000 )
V_132 -= 500000 ;
#if 1
...
V_129 / 1000000 , ( V_129 % 1000000 ) / 1000 ) ;
V_59 = 0 ;
V_94:
F_31 ( & V_2 -> V_128 ) ;
return V_59 ;
...
if ( V_2 -> V_65 . V_139 )
type |= V_22 ;
return F_32 ( V_53 , ( 625l * V_57 -> V_136 ) / 10 ,
V_134 , type , 0 , 0 ) ;
}
if ( ! V_57 -> V_108 )
V_57 -> V_108 = V_140 ;
...
type |= V_12 ;
V_57 -> V_108 |= F_6 () ;
return F_32 ( V_53 , 62500l * V_57 -> V_136 ,
V_133 , type , V_57 -> V_108 , 0 ) ;
}
...
T_1 V_144 = 0 ;
F_2 ( L_39 , V_7 ) ;
switch( V_53 -> V_145 . V_146 . type ) {
case V_147 :
V_142 = V_57 -> V_148 . V_149 . V_150 ;
if ( V_142 == V_151 )
type |= V_17 ;
break;
case V_152 :
...
switch ( V_142 ) {
case V_143 :
if ( V_57 -> V_136 < 470000000 )
V_2 -> V_65 . V_153 = 0 ;
else
V_2 -> V_65 . V_154 = 1 ;
type |= ( V_2 -> V_65 . V_153 && V_2 -> V_65 . V_154 ) ? V_19 : V_20 ;
type |= V_12 ;
break;
case V_155 :
if ( V_57 -> V_136 < 470000000 )
...
V_2 -> V_65 . V_154 = 0 ;
type |= ( V_2 -> V_65 . V_153 && V_2 -> V_65 . V_154 ) ? V_19 : V_18 ;
type |= V_12 ;
break;
case V_151 :
type |= V_16 ;
...
if ( V_53 -> V_145 . V_146 . type != V_152 ) {
...
if ( V_2 -> V_65 . V_144 ) {
V_144 = V_2 -> V_65 . V_144 ;
if ( type == V_26 || V_2 -> V_74 < 0x0302 )
V_144 += 200 ;
}
return F_32 ( V_53 , V_57 -> V_136 ,
V_135 , type , 0 , V_144 ) ;
}
...
static int F_40 ( struct V_52 * V_53 , T_5 * V_136 )
{
struct V_1 * V_2 = V_53 -> V_54 ;
F_2 ( L_39 , V_7 ) ;
* V_136 = V_2 -> V_136 ;
...
static int F_41 ( struct V_52 * V_53 , void * V_163 )
{
struct V_1 * V_2 = V_53 -> V_54 ;
...
memcpy ( & V_53 -> V_145 . V_173 , & V_174 ,
sizeof( V_174 ) ) ;
F_13 ( L_107 , L_108 ) ;
if ( V_166 -> V_65 )
F_41 ( V_53 , V_166 -> V_65 ) ;
F_31 ( & V_162 ) ;
return V_53 ;
V_121:
F_31 ( & V_162 ) ;
