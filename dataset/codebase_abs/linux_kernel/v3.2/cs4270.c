...
struct V_12 * V_13 = F_4 ( V_2 ) ;
int V_3 , V_34 ;
V_3 = F_9 ( V_2 , V_76 ) | V_77 ;
if ( V_3 < 0 )
return V_3 ;
V_34 = F_10 ( V_2 , V_76 , V_3 ) ;
if ( V_34 < 0 )
return V_34 ;
F_24 ( F_19 ( V_13 -> V_72 ) ,
V_13 -> V_72 ) ;
...
V_3 = F_9 ( V_2 , V_76 ) ;
V_3 &= ~ V_77 ;
return F_10 ( V_2 , V_76 , V_3 ) ;
}
static int F_29 ( struct V_78 * V_78 ,
...
F_31 ( & V_78 -> V_20 , L_10 ,
V_78 -> V_81 ) ;
F_31 ( & V_78 -> V_20 , L_11 , V_34 & 0xF ) ;
V_13 = F_32 ( sizeof( struct V_12 ) , V_83 ) ;
if ( ! V_13 ) {
F_6 ( & V_78 -> V_20 , L_12 ) ;
return - V_84 ;
}
...
static int F_36 ( struct V_78 * V_78 )
{
F_37 ( & V_78 -> V_20 ) ;
F_35 ( F_38 ( V_78 ) ) ;
return 0 ;
