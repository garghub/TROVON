...
struct V_36 * V_37 ;
int V_4 , V_38 ;
V_37 = F_18 ( V_1 -> V_7 . V_8 , V_1 -> V_7 . V_39 ) ;
V_35 = F_19 ( V_37 , V_1 -> V_7 . V_35 ) ;
if ( ! V_35 ) {
F_4 ( V_40 , L_15 ) ;
return - V_41 ;
}
V_38 = F_20 ( V_35 -> V_42 [ 0 ] . V_43 . V_44 ) ;
...
if ( V_38 < V_56 )
V_38 = V_56 ;
V_35 -> V_42 [ 0 ] . V_43 . V_44 = F_22 ( V_38 ) ;
V_55 = F_24 ( V_7 -> V_8 , V_7 -> V_39 , 1 ) ;
if ( V_55 < 0 )
F_4 ( V_40 | V_49 , L_18 , V_55 ) ;
return V_55 ;
}
...
static int F_28 ( struct V_7 * V_7 ,
T_3 * V_17 ,
int V_11 )
{
int V_55 = - V_71 ;
if ( V_11 == 1 && V_17 [ 0 ] == 0x80 ) {
F_29 ( V_7 -> V_72 , V_73 , 1 ) ;
F_30 ( V_7 -> V_72 ) ;
V_55 = 0 ;
}
if ( V_11 == 1 && V_17 [ 0 ] == 0x88 ) {
F_29 ( V_7 -> V_72 , V_73 , 0 ) ;
F_30 ( V_7 -> V_72 ) ;
V_55 = 0 ;
}
return V_55 ;
}
static int F_31 ( struct V_7 * V_7 ,
...
{
F_4 ( V_30 , L_37 ) ;
return F_33 ( V_37 , V_59 , & V_75 , sizeof( struct V_1 ) ,
V_85 ) ;
}
static void F_34 ( struct V_36 * V_37 )
{
struct V_7 * V_7 = F_35 ( V_37 ) ;
struct V_1 * V_1 = (struct V_1 * ) V_7 ;
F_4 ( V_30 , L_38 ) ;
if ( V_1 -> V_15 -> V_86 )
V_1 -> V_15 -> V_86 ( V_1 ) ;
