...
V_44 = V_2 -> V_44 ;
V_2 -> V_55 += V_39 >> V_52 ;
F_42 ( V_2 , V_8 -> V_40 , V_8 -> V_23 , V_39 >> V_52 ) ;
if ( F_43 ( V_2 , V_10 , V_38 ) < 0 ) {
F_44 ( V_43 >> V_52 ) ;
V_43 = 0 ;
}
V_2 -> V_44 = V_44 ;
...
V_67 = F_49 ( V_68 ) ;
V_66 += V_39 - V_38 ;
if ( V_66 > V_67 && ! F_50 ( V_69 ) )
goto V_70;
}
if ( ! F_51 ( V_2 , ( V_39 - V_38 ) >> V_52 ) )
goto V_71;
if ( V_8 -> V_40 & V_53 ) {
...
static unsigned long F_54 ( unsigned long V_3 ,
...
goto V_79;
V_76 = F_55 ( NULL , 0 , 0 , 0 , V_14 , 1 ) ;
if ( V_76 )
goto V_79;
V_76 = F_43 ( V_2 , V_14 , V_39 ) ;
if ( V_76 )
goto V_79;
if ( V_38 >= V_39 ) {
V_76 = F_43 ( V_2 , V_3 + V_39 , V_38 - V_39 ) ;
if ( V_76 && V_38 != V_39 )
goto V_79;
V_38 = V_39 ;
}
V_8 = F_46 ( V_3 , V_38 , V_39 , & V_72 ) ;
if ( F_56 ( V_8 ) ) {
V_76 = F_57 ( V_8 ) ;
goto V_79;
}
...
unsigned long F_60 ( unsigned long V_3 ,
...
if ( V_38 == V_8 -> V_54 - V_3 ) {
if ( F_59 ( V_8 , V_39 - V_38 ) ) {
int V_90 = ( V_39 - V_38 ) >> V_52 ;
if ( F_62 ( V_8 , V_8 -> V_51 , V_3 + V_39 ,
V_8 -> V_50 , NULL ) ) {
V_76 = - V_48 ;
goto V_79;
}
V_2 -> V_55 += V_90 ;
F_42 ( V_2 , V_8 -> V_40 , V_8 -> V_23 , V_90 ) ;
if ( V_8 -> V_40 & V_57 ) {
V_2 -> V_58 += V_90 ;
F_45 ( V_8 , V_3 + V_38 ,
V_3 + V_39 ) ;
