...
static void F_16 ( struct V_13 * V_14 , T_1 V_48 )
{
struct V_17 * V_18 = V_14 -> V_19 ;
...
F_13 ( L_4 , V_48 ) ;
if ( F_9 ( V_14 ) )
return F_16 ( V_14 , V_48 ) ;
if ( F_4 ( V_14 ) ) {
T_1 V_41 = F_11 ( V_14 ) ;
T_2 V_45 ;
V_45 = V_48 * 0xfe / V_41 + 1 ;
V_48 /= V_45 ;
F_18 ( V_14 -> V_46 , V_47 , V_45 ) ;
}
V_49 = F_6 ( V_35 ) ;
if ( F_5 ( V_14 ) -> V_32 < 4 )
V_48 <<= 1 ;
...
void F_19 ( struct V_13 * V_14 , T_1 V_48 )
{
struct V_17 * V_18 = V_14 -> V_19 ;
V_18 -> V_50 = V_48 ;
if ( V_18 -> V_51 )
