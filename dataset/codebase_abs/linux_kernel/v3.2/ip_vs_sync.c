...
F_34 ( & V_41 -> V_85 . V_54 , & V_39 -> V_54 . V_86 ) ;
F_34 ( & V_41 -> V_85 . V_56 , & V_39 -> V_56 . V_86 ) ;
F_34 ( & V_41 -> V_85 . V_57 , & V_39 -> V_57 . V_86 ) ;
} else
#endif
{
...
static inline int
F_37 ( struct V_35 * V_35 , int V_43 , union F_29 * V_94 ,
struct V_95 * V_64 ,
...
static void F_43 ( struct V_35 * V_35 , struct V_95 * V_101 ,
...
F_13 ( V_101 -> V_69 ) ;
if ( ! V_39 ) {
V_70 = F_46 ( V_35 , type , V_57 , V_53 , V_101 -> V_56 ,
...
V_39 = F_47 ( V_101 , V_57 , V_53 , V_45 , V_70 , V_82 ) ;
if ( V_70 )
F_48 ( & V_70 -> V_108 ) ;
if ( ! V_39 ) {
if ( V_101 -> V_69 )
...
static void F_55 ( struct V_35 * V_35 , const char * V_116 ,
const V_77 V_117 )
{
...
F_38 ( V_35 , V_44 , V_41 -> V_50 ,
( const union V_97 * ) & V_41 -> V_54 ,
V_41 -> V_51 ,
( const union V_97 * ) & V_41 -> V_56 ,
V_41 -> V_52 , & V_101 ) ;
F_43 ( V_35 , & V_101 , V_45 , V_59 , V_41 -> V_50 , V_44 ,
(union V_97 * ) & V_41 -> V_57 , V_41 -> V_53 ,
0 , 0 , V_61 ) ;
}
}
static inline int F_58 ( T_1 * V_64 , unsigned int V_123 ,
T_3 * V_124 ,
struct V_60 * V_61 )
{
struct V_60 * V_125 ;
...
static int F_59 ( T_1 * V_64 , unsigned int V_123 , unsigned int * V_128 ,
...
static inline int F_60 ( struct V_35 * V_35 , T_1 * V_64 , T_1 * V_132 )
{
struct V_60 V_61 ;
union F_29 * V_41 ;
struct V_118 * V_119 ;
...
switch ( V_135 & ~ V_136 ) {
case V_87 :
if ( F_58 ( V_64 , V_123 , & V_124 , & V_61 ) )
return - 50 ;
break;
case V_89 :
if ( F_59 ( V_64 , V_123 , & V_68 , & V_69 ,
V_137 , & V_124 ,
V_138 ) )
return - 60 ;
break;
case V_90 :
if ( F_59 ( V_64 , V_123 , & V_65 , & V_96 ,
V_73 , & V_124 ,
V_139 ) )
return - 70 ;
break;
...
V_45 = F_61 ( V_41 -> V_78 . V_45 ) & V_140 ;
V_45 |= V_121 ;
V_59 = F_56 ( V_41 -> V_78 . V_59 ) ;
if ( ! ( V_45 & V_91 ) ) {
V_119 = F_57 ( V_41 -> V_78 . V_50 ) ;
if ( ! V_119 ) {
F_40 ( 3 , L_17 ,
V_41 -> V_78 . V_50 ) ;
V_133 = 30 ;
...
if ( F_37 ( V_35 , V_43 , V_41 , & V_101 , V_69 ,
V_68 , V_96 , V_65 ) ) {
V_133 = 50 ;
goto V_134;
}
if ( V_43 == V_44 )
F_43 ( V_35 , & V_101 , V_45 , V_59 , V_41 -> V_78 . V_50 , V_43 ,
(union V_97 * ) & V_41 -> V_78 . V_57 , V_41 -> V_78 . V_53 ,
F_61 ( V_41 -> V_78 . V_83 ) , F_61 ( V_41 -> V_78 . V_82 ) ,
( V_124 & V_127 ? & V_61 : NULL )
) ;
#ifdef F_32
else
F_43 ( V_35 , & V_101 , V_45 , V_59 , V_41 -> V_85 . V_50 , V_43 ,
(union V_97 * ) & V_41 -> V_85 . V_57 , V_41 -> V_85 . V_53 ,
F_61 ( V_41 -> V_85 . V_83 ) , F_61 ( V_41 -> V_85 . V_82 ) ,
( V_124 & V_127 ? & V_61 : NULL )
) ;
#endif
return 0 ;
...
static void F_62 ( struct V_35 * V_35 , T_1 * V_116 ,
const V_77 V_117 )
{
struct V_8 * V_9 = F_22 ( V_35 ) ;
...
V_141 -> V_23 = F_56 ( V_141 -> V_23 ) ;
if ( V_117 != V_141 -> V_23 ) {
F_40 ( 2 , L_22 ) ;
return;
}
if ( V_9 -> V_142 != 0 && V_141 -> V_21 != V_9 -> V_142 ) {
F_40 ( 7 , L_23 , V_141 -> V_21 ) ;
return;
}
...
V_41 = (union F_29 * ) V_64 ;
V_23 = F_56 ( V_41 -> V_78 . V_80 ) & V_81 ;
V_132 = V_64 + V_23 ;
if ( V_132 > V_116 + V_117 ) {
F_30 ( L_25 ) ;
return;
}
if ( F_56 ( V_41 -> V_78 . V_80 ) >> V_143 ) {
F_30 ( L_26 ,
F_56 ( V_41 -> V_78 . V_80 ) >> V_143 ) ;
return;
}
V_133 = F_60 ( V_35 , V_64 , V_132 ) ;
if ( V_133 < 0 ) {
F_30 ( L_27 ,
V_133 ) ;
return;
...
F_55 ( V_35 , V_116 , V_117 ) ;
return;
}
}
static void F_63 ( struct V_144 * V_145 , T_4 V_146 )
{
struct V_147 * V_148 = F_64 ( V_145 ) ;
F_65 ( V_145 ) ;
V_148 -> V_149 = V_146 ? 1 : 0 ;
F_66 ( V_145 ) ;
}
static void F_67 ( struct V_144 * V_145 , T_4 V_150 )
{
struct V_147 * V_148 = F_64 ( V_145 ) ;
F_65 ( V_145 ) ;
V_148 -> V_151 = V_150 ;
...
static int F_68 ( struct V_144 * V_145 , char * V_152 )
{
struct V_153 * V_154 ;
struct V_147 * V_148 = F_64 ( V_145 ) ;
struct V_35 * V_35 = F_69 ( V_145 ) ;
V_154 = F_70 ( V_35 , V_152 ) ;
if ( ! V_154 )
return - V_155 ;
...
static int F_71 ( struct V_35 * V_35 , int V_32 )
{
struct V_8 * V_9 = F_22 ( V_35 ) ;
struct V_153 * V_154 ;
int V_159 ;
if ( V_32 == V_33 ) {
V_154 = F_70 ( V_35 , V_9 -> V_160 ) ;
if ( ! V_154 )
return - V_155 ;
...
V_164 - 20 ) / V_49 ;
V_9 -> V_17 = V_164 +
V_49 * F_72 ( V_159 , V_165 ) ;
F_40 ( 7 , L_28
L_29 , V_9 -> V_17 ) ;
} else if ( V_32 == V_166 ) {
V_154 = F_70 ( V_35 , V_9 -> V_167 ) ;
if ( ! V_154 )
return - V_155 ;
...
static int
F_73 ( struct V_144 * V_145 , struct V_169 * V_170 , char * V_152 )
{
struct V_35 * V_35 = F_69 ( V_145 ) ;
struct V_171 V_172 ;
struct V_153 * V_154 ;
...
F_65 ( V_145 ) ;
V_173 = F_74 ( V_145 , & V_172 ) ;
F_66 ( V_145 ) ;
return V_173 ;
}
static int F_75 ( struct V_176 * V_144 , char * V_152 )
{
struct V_35 * V_35 = F_69 ( V_144 -> V_145 ) ;
struct V_153 * V_154 ;
T_5 V_170 ;
struct V_177 sin ;
V_154 = F_70 ( V_35 , V_152 ) ;
...
static struct V_176 * F_77 ( struct V_35 * V_35 )
{
struct V_8 * V_9 = F_22 ( V_35 ) ;
struct V_176 * V_144 ;
int V_186 ;
V_186 = F_78 ( V_187 , V_188 , V_189 , & V_144 ) ;
if ( V_186 < 0 ) {
F_27 ( L_34 ) ;
return F_79 ( V_186 ) ;
}
F_80 ( V_144 -> V_145 , V_35 ) ;
V_186 = F_68 ( V_144 -> V_145 , V_9 -> V_160 ) ;
if ( V_186 < 0 ) {
F_27 ( L_35 ) ;
goto error;
}
...
static struct V_176 * F_82 ( struct V_35 * V_35 )
{
struct V_8 * V_9 = F_22 ( V_35 ) ;
struct V_176 * V_144 ;
int V_186 ;
...
static int
F_83 ( struct V_176 * V_144 , const char * V_116 , const V_77 V_193 )
{
...
V_200 . V_202 = V_193 ;
V_42 = F_85 ( V_144 , & V_195 , & V_200 , 1 , ( V_77 ) ( V_193 ) ) ;
F_86 ( 7 ) ;
return V_42 ;
}
static void
F_87 ( struct V_176 * V_144 , struct V_24 * V_195 )
{
int V_203 ;
V_203 = V_195 -> V_23 ;
V_195 -> V_23 = F_28 ( V_195 -> V_23 ) ;
if ( F_83 ( V_144 , ( char * ) V_195 , V_203 ) != V_203 )
F_27 ( L_40 ) ;
}
static int
F_88 ( struct V_176 * V_144 , char * V_116 , const V_77 V_117 )
{
...
V_42 = F_89 ( V_144 , & V_195 , & V_200 , 1 , V_117 , 0 ) ;
if ( V_42 < 0 )
return - 1 ;
F_86 ( 7 ) ;
return V_42 ;
}
static int F_90 ( void * V_129 )
{
...
if ( V_10 )
F_14 ( V_10 ) ;
F_81 ( V_205 -> V_144 -> V_145 ) ;
F_13 ( V_205 ) ;
return 0 ;
}
static int F_94 ( void * V_129 )
{
struct V_204 * V_205 = V_129 ;
struct V_8 * V_9 = F_22 ( V_205 -> V_35 ) ;
int V_42 ;
...
V_9 -> V_167 , V_9 -> V_142 ) ;
while ( ! F_92 () ) {
F_95 ( * F_96 ( V_205 -> V_144 -> V_145 ) ,
! F_97 ( & V_205 -> V_144 -> V_145 -> V_206 )
|| F_92 () ) ;
while ( ! F_97 ( & ( V_205 -> V_144 -> V_145 -> V_206 ) ) ) {
V_42 = F_88 ( V_205 -> V_144 , V_205 -> V_207 ,
V_9 -> V_168 ) ;
if ( V_42 <= 0 ) {
F_27 ( L_44 ) ;
break;
...
F_98 () ;
F_62 ( V_205 -> V_35 , V_205 -> V_207 , V_42 ) ;
F_99 () ;
}
}
F_81 ( V_205 -> V_144 -> V_145 ) ;
...
int F_100 ( struct V_35 * V_35 , int V_59 , char * V_208 , T_1 V_21 )
{
struct V_204 * V_205 ;
...
int (* F_101)( void * V_129 );
int V_186 = - V_100 ;
F_40 ( 7 , L_45 , V_212 , F_102 ( V_213 ) ) ;
F_40 ( 7 , L_46 ,
sizeof( struct F_25 ) ) ;
if ( V_59 == V_33 ) {
if ( V_9 -> V_214 )
return - V_215 ;
F_103 ( V_9 -> V_160 , V_208 ,
sizeof( V_9 -> V_160 ) ) ;
V_9 -> V_22 = V_21 ;
V_210 = & V_9 -> V_214 ;
V_72 = L_47 ;
...
V_205 -> V_144 = V_144 ;
V_205 -> V_207 = V_207 ;
V_211 = F_106 ( F_101 , V_205 , V_72 , V_9 -> V_220 ) ;
if ( F_104 ( V_211 ) ) {
V_186 = F_105 ( V_211 ) ;
goto V_221;
}
...
int F_108 ( struct V_35 * V_35 , int V_59 )
{
struct V_8 * V_9 = F_22 ( V_35 ) ;
int V_133 = - V_126 ;
F_40 ( 7 , L_45 , V_212 , F_102 ( V_213 ) ) ;
...
F_102 ( V_9 -> V_216 ) ) ;
V_9 -> V_32 &= ~ V_166 ;
V_133 = F_109 ( V_9 -> V_216 ) ;
V_9 -> V_216 = NULL ;
}
F_110 () ;
return V_133 ;
}
int T_6 F_111 ( struct V_35 * V_35 )
{
struct V_8 * V_9 = F_22 ( V_35 ) ;
F_112 ( & V_9 -> V_223 , L_51 , & V_224 ) ;
F_113 ( & V_9 -> V_12 ) ;
F_114 ( & V_9 -> V_11 ) ;
F_114 ( & V_9 -> V_34 ) ;
V_9 -> V_225 . V_179 = V_44 ;
V_9 -> V_225 . V_182 = F_115 ( V_226 ) ;
V_9 -> V_225 . V_180 . V_181 = F_116 ( V_227 ) ;
return 0 ;
}
void F_117 ( struct V_35 * V_35 )
{
int V_133 ;
struct V_8 * V_9 = F_22 ( V_35 ) ;
F_118 ( & V_9 -> V_223 ) ;
V_133 = F_108 ( V_35 , V_33 ) ;
if ( V_133 && V_133 != - V_222 )
F_27 ( L_52 ) ;
V_133 = F_108 ( V_35 , V_166 ) ;
if ( V_133 && V_133 != - V_222 )
F_27 ( L_53 ) ;
F_119 ( & V_9 -> V_223 ) ;
}
