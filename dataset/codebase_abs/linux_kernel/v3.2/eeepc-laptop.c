...
static void F_125 ( struct V_140 * V_24 , T_5 V_75 )
{
struct V_15 * V_16 = F_126 ( V_24 ) ;
T_7 V_9 ;
if ( V_75 > V_141 )
return;
V_9 = V_16 -> V_142 [ V_75 % 128 ] ++ ;
F_127 ( V_24 , V_75 , V_9 ) ;
F_128 ( V_24 -> V_143 . V_144 ,
F_129 ( & V_24 -> V_25 ) , V_75 ,
V_9 ) ;
...
F_130 ( V_16 -> V_139 , V_75 ,
1 , true ) ;
}
} else {
F_130 ( V_16 -> V_139 , V_75 , 1 , true ) ;
}
}
...
{
F_133 ( V_16 , V_152 , L_56 ) ;
F_133 ( V_16 , V_153 , L_57 ) ;
F_133 ( V_16 , V_154 , L_58 ) ;
F_133 ( V_16 , V_49 , L_59 ) ;
}
static int T_8 F_135 ( struct V_15 * V_16 )
{
unsigned int V_155 ;
int V_14 ;
...
F_134 ( V_16 ) ;
F_118 ( L_66 , V_16 -> V_20 ) ;
return 0 ;
}
static void T_8 F_138 ( struct V_15 * V_16 )
{
if ( F_8 ( V_16 , V_159 ) == 0 )
F_6 ( V_16 , V_159 , 1 ) ;
}
static int T_8 F_139 ( struct V_140 * V_24 )
{
struct V_15 * V_16 ;
int V_14 ;
F_137 ( V_160 L_7 ) ;
...
static int F_143 ( struct V_140 * V_24 , int type )
{
struct V_15 * V_16 = F_126 ( V_24 ) ;
F_114 ( V_16 ) ;
F_79 ( V_16 ) ;
