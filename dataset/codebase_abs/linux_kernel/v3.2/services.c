...
if ( V_244 ) {
V_228 . type = V_244 -> V_156 ;
}
if ( V_233 )
F_67 ( & V_1 , & V_228 , V_41 -> type ,
V_42 -> type , V_27 , V_233 ) ;
if ( V_147 & V_247 ) {
for ( V_242 = V_1 . V_252 ; V_242 ; V_242 = V_242 -> V_59 ) {
if ( ( V_242 -> V_70 == V_41 -> V_70 ) &&
( V_242 -> type == V_42 -> type ) &&
( V_242 -> V_27 == V_27 ) ) {
V_228 . V_70 = V_242 -> V_164 ;
break;
}
}
}
...
const struct V_253 * V_253 , T_3 * V_239 )
{
return F_68 ( V_194 , V_195 , V_27 , V_247 ,
V_253 ? V_253 -> V_15 : NULL , V_239 , true ) ;
}
...
T_3 * V_239 )
{
return F_68 ( V_194 , V_195 , V_27 , V_248 , NULL ,
V_239 , false ) ;
}
...
if ( ! V_56 )
goto V_114;
V_178 = F_55 ( args -> V_258 , NULL , V_56 ,
...
goto V_114;
V_178 = - V_14 ;
V_216 = F_57 ( args -> V_258 -> V_219 . V_113 ,
F_20 ( args -> V_259 , V_203 , V_48 -> V_67 - 1 ) ) ;
if ( ! V_216 )
goto V_260;
V_48 -> V_67 = V_216 -> V_21 ;
V_178 = - V_14 ;
V_70 = F_57 ( args -> V_258 -> V_220 . V_113 ,
F_20 ( args -> V_259 , V_204 , V_48 -> V_70 - 1 ) ) ;
if ( ! V_70 )
goto V_260;
V_48 -> V_70 = V_70 -> V_21 ;
V_178 = - V_14 ;
V_214 = F_57 ( args -> V_258 -> V_221 . V_113 ,
F_20 ( args -> V_259 , V_205 , V_48 -> type - 1 ) ) ;
if ( ! V_214 )
goto V_260;
V_48 -> type = V_214 -> V_21 ;
if ( args -> V_259 -> V_39 && args -> V_258 -> V_39 ) {
V_178 = F_81 ( args -> V_259 , args -> V_258 , V_48 ) ;
if ( V_178 )
goto V_260;
} else if ( args -> V_259 -> V_39 && ! args -> V_258 -> V_39 ) {
F_82 ( V_48 ) ;
} else if ( ! args -> V_259 -> V_39 && args -> V_258 -> V_39 ) {
V_256 = args -> V_258 -> V_261 [ V_262 ] ;
while ( V_256 && V_256 -> V_206 [ 0 ] != V_263 )
V_256 = V_256 -> V_59 ;
V_178 = - V_14 ;
if ( ! V_256 ) {
F_4 ( V_181 L_32
...
V_78 = & V_256 -> V_40 [ 0 ] . V_78 ;
V_178 = F_83 ( V_48 , V_78 ) ;
if ( V_178 )
goto V_260;
}
if ( ! F_59 ( args -> V_258 , V_48 ) ) {
V_178 = F_78 ( & V_218 ) ;
if ( V_178 )
goto V_260;
}
...
{
V_264 = F_13 ( & V_1 . V_265 ,
V_266 ) ;
V_267 = F_13 ( & V_1 . V_265 ,
V_268 ) ;
}
int F_85 ( void * V_156 , T_2 V_201 )
{
struct V_1 V_269 , V_270 ;
struct V_183 V_271 , V_272 ;
struct V_5 * V_273 , * V_4 = NULL ;
struct V_255 args ;
T_3 V_191 ;
T_1 V_274 ;
int V_178 = 0 ;
struct V_275 V_276 = { V_156 , V_201 } , * V_277 = & V_276 ;
if ( ! V_179 ) {
F_86 () ;
V_178 = F_87 ( & V_1 , V_277 ) ;
if ( V_178 ) {
F_88 () ;
return V_178 ;
}
...
#endif
V_178 = F_87 ( & V_270 , V_277 ) ;
if ( V_178 )
return V_178 ;
V_270 . V_201 = V_201 ;
if ( V_1 . V_39 && ! V_270 . V_39 )
F_4 ( V_22 L_35 ) ;
else if ( ! V_1 . V_39 && V_270 . V_39 )
F_4 ( V_22 L_36 ) ;
V_178 = F_90 ( & V_270 , & V_272 ) ;
if ( V_178 ) {
F_4 ( V_181 L_37 ) ;
F_89 ( & V_270 ) ;
return V_178 ;
}
V_178 = F_1 ( & V_270 , V_278 , & V_4 , & V_274 ) ;
if ( V_178 )
goto V_24;
V_178 = F_97 ( & V_270 ) ;
if ( V_178 ) {
...
F_98 ( & V_183 ) ;
V_178 = F_99 ( & V_183 , F_76 , & V_272 ) ;
if ( V_178 )
goto V_24;
args . V_259 = & V_1 ;
args . V_258 = & V_270 ;
V_178 = F_99 ( & V_272 , F_79 , & args ) ;
if ( V_178 ) {
F_4 ( V_181 L_39
L_40
L_41 ) ;
...
memcpy ( & V_269 , & V_1 , sizeof V_1 ) ;
F_100 ( & V_271 , & V_183 ) ;
F_101 ( & V_180 ) ;
memcpy ( & V_1 , & V_270 , sizeof V_1 ) ;
F_100 ( & V_183 , & V_272 ) ;
F_84 () ;
V_273 = V_29 ;
V_29 = V_4 ;
...
int F_105 ( T_5 V_279 , T_1 V_280 , T_3 * V_239 )
{
struct V_165 * V_48 ;
int V_178 = 0 ;
F_39 ( & V_180 ) ;
V_48 = V_1 . V_261 [ V_281 ] ;
while ( V_48 ) {
if ( V_48 -> V_282 . V_280 . V_279 == V_279 &&
V_48 -> V_282 . V_280 . V_283 <= V_280 &&
V_48 -> V_282 . V_280 . V_284 >= V_280 )
break;
V_48 = V_48 -> V_59 ;
}
if ( V_48 ) {
...
int F_106 ( char * V_15 , T_3 * V_286 )
{
int V_178 = 0 ;
struct V_165 * V_48 ;
F_39 ( & V_180 ) ;
V_48 = V_1 . V_261 [ V_287 ] ;
while ( V_48 ) {
if ( strcmp ( V_15 , V_48 -> V_282 . V_15 ) == 0 )
break;
V_48 = V_48 -> V_59 ;
}
if ( V_48 ) {
...
static int F_107 ( T_3 * V_289 , T_3 * V_290 , T_3 * V_118 )
{
int V_10 , V_291 = 0 ;
for ( V_10 = 0 ; V_10 < 4 ; V_10 ++ )
if ( V_290 [ V_10 ] != ( V_289 [ V_10 ] & V_118 [ V_10 ] ) ) {
V_291 = 1 ;
break;
}
return ! V_291 ;
...
goto V_114;
V_290 = * ( ( T_3 * ) V_293 ) ;
V_48 = V_1 . V_261 [ V_296 ] ;
while ( V_48 ) {
if ( V_48 -> V_282 . V_135 . V_290 == ( V_290 & V_48 -> V_282 . V_135 . V_118 ) )
break;
V_48 = V_48 -> V_59 ;
}
break;
...
case V_297 :
V_178 = - V_14 ;
if ( V_294 != sizeof( V_298 ) * 2 )
goto V_114;
V_48 = V_1 . V_261 [ V_299 ] ;
while ( V_48 ) {
if ( F_107 ( V_293 , V_48 -> V_282 . V_300 . V_290 ,
V_48 -> V_282 . V_300 . V_118 ) )
break;
V_48 = V_48 -> V_59 ;
}
break;
...
T_3 * V_305 )
{
struct V_40 * V_306 , V_307 ;
T_3 * V_308 = NULL , * V_309 , V_206 ;
T_3 V_310 = 0 , V_311 = V_312 ;
struct V_215 * V_67 ;
struct V_49 * V_70 ;
struct V_140 * V_313 , * V_142 ;
...
F_56 ( & V_307 ) ;
V_178 = - V_14 ;
V_306 = F_40 ( & V_183 , V_302 ) ;
if ( ! V_306 )
goto V_210;
V_178 = - V_14 ;
V_67 = F_57 ( V_1 . V_219 . V_113 , V_303 ) ;
if ( ! V_67 )
goto V_210;
V_307 . V_67 = V_67 -> V_21 ;
V_178 = - V_17 ;
V_308 = F_2 ( V_311 , sizeof( * V_308 ) , V_16 ) ;
if ( ! V_308 )
goto V_210;
...
V_307 . type = V_11 + 1 ;
if ( F_110 ( V_306 , V_67 , & V_307 ) )
continue;
V_178 = F_62 ( & V_183 , & V_307 , & V_206 ) ;
if ( V_178 )
goto V_210;
if ( V_310 < V_311 ) {
V_308 [ V_310 ++ ] = V_206 ;
...
V_178 = - V_17 ;
V_311 += V_312 ;
V_309 = F_2 ( V_311 , sizeof( * V_309 ) , V_16 ) ;
if ( ! V_309 )
goto V_210;
memcpy ( V_309 , V_308 , V_310 * sizeof( * V_309 ) ) ;
F_6 ( V_308 ) ;
V_308 = V_309 ;
V_308 [ V_310 ++ ] = V_206 ;
}
...
V_178 = - V_17 ;
V_309 = F_2 ( V_310 , sizeof( * V_309 ) , V_227 ) ;
if ( ! V_309 ) {
F_6 ( V_308 ) ;
goto V_114;
}
for ( V_10 = 0 , V_11 = 0 ; V_10 < V_310 ; V_10 ++ ) {
struct V_32 V_314 ;
V_178 = F_111 ( V_302 , V_308 [ V_10 ] ,
V_246 ,
V_315 , V_316 ,
& V_314 ) ;
if ( ! V_178 )
V_309 [ V_11 ++ ] = V_308 [ V_10 ] ;
F_112 () ;
}
V_178 = 0 ;
F_6 ( V_308 ) ;
...
struct V_165 * V_48 ;
int V_178 , V_322 = 0 ;
while ( V_318 [ 0 ] == '/' && V_318 [ 1 ] == '/' )
V_318 ++ ;
F_39 ( & V_180 ) ;
V_320 = F_7 ( V_319 ) ;
* V_206 = V_263 ;
for ( V_321 = V_1 . V_321 ; V_321 ; V_321 = V_321 -> V_59 ) {
V_322 = strcmp ( V_317 , V_321 -> V_317 ) ;
if ( V_322 <= 0 )
break;
}
V_178 = - V_323 ;
if ( ! V_321 || V_322 )
goto V_114;
for ( V_48 = V_321 -> V_324 ; V_48 ; V_48 = V_48 -> V_59 ) {
V_201 = strlen ( V_48 -> V_282 . V_15 ) ;
if ( ( ! V_48 -> V_325 . V_320 || V_320 == V_48 -> V_325 . V_320 ) &&
( strncmp ( V_48 -> V_282 . V_15 , V_318 , V_201 ) == 0 ) )
break;
}
V_178 = - V_323 ;
if ( ! V_48 )
...
struct V_165 * V_48 ;
F_39 ( & V_180 ) ;
V_48 = V_1 . V_261 [ V_327 ] ;
while ( V_48 ) {
if ( strcmp ( V_317 , V_48 -> V_282 . V_15 ) == 0 )
break;
V_48 = V_48 -> V_59 ;
}
if ( V_48 ) {
* V_326 = V_48 -> V_325 . V_326 ;
if ( ! V_48 -> V_206 [ 0 ] ) {
...
V_178 = F_113 ( V_317 , L_42 , V_328 , V_206 ) ;
if ( V_178 ) {
* V_326 = V_329 ;
V_178 = 0 ;
} else {
...
int F_115 ( int * V_201 , char * * * V_91 , int * * V_331 )
{
int V_10 , V_178 ;
F_39 ( & V_180 ) ;
* V_91 = NULL ;
...
goto V_24;
V_178 = - V_17 ;
* V_331 = F_2 ( * V_201 , sizeof( int ) , V_16 ) ;
if ( ! * V_331 )
goto V_24;
for ( V_10 = 0 ; V_10 < * V_201 ; V_10 ++ ) {
T_2 V_333 ;
( * V_331 ) [ V_10 ] = V_1 . V_334 [ V_10 ] -> V_335 ;
V_333 = strlen ( F_20 ( & V_1 , V_336 , V_10 ) ) + 1 ;
V_178 = - V_17 ;
( * V_91 ) [ V_10 ] = F_48 ( sizeof( char ) * V_333 , V_16 ) ;
if ( ! ( * V_91 ) [ V_10 ] )
goto V_24;
strncpy ( ( * V_91 ) [ V_10 ] , F_20 ( & V_1 , V_336 , V_10 ) , V_333 ) ;
( * V_91 ) [ V_10 ] [ V_333 - 1 ] = 0 ;
}
V_178 = 0 ;
V_114:
...
F_101 ( & V_180 ) ;
V_178 = - V_340 ;
V_337 = V_1 . V_332 . V_144 ;
if ( V_201 != V_337 )
goto V_114;
for ( V_10 = 0 ; V_10 < V_201 ; V_10 ++ ) {
if ( ! ! V_331 [ V_10 ] != V_1 . V_334 [ V_10 ] -> V_335 ) {
F_37 ( V_115 -> V_116 , V_16 ,
V_341 ,
L_43 ,
F_20 ( & V_1 , V_336 , V_10 ) ,
! ! V_331 [ V_10 ] ,
V_1 . V_334 [ V_10 ] -> V_335 ,
F_117 ( V_115 ) ,
F_118 ( V_115 ) ) ;
}
if ( V_331 [ V_10 ] )
V_1 . V_334 [ V_10 ] -> V_335 = 1 ;
else
V_1 . V_334 [ V_10 ] -> V_335 = 0 ;
}
for ( V_339 = V_1 . V_342 ; V_339 ; V_339 = V_339 -> V_59 ) {
V_178 = F_119 ( & V_1 , V_339 ) ;
if ( V_178 )
goto V_114;
}
V_191 = ++ V_192 ;
...
{
int V_178 , V_343 = 0 , * V_344 = NULL , V_10 ;
char * * V_345 = NULL ;
struct V_346 * V_347 ;
struct V_338 * V_339 ;
V_178 = F_115 ( & V_343 , & V_345 , & V_344 ) ;
if ( V_178 )
goto V_114;
for ( V_10 = 0 ; V_10 < V_343 ; V_10 ++ ) {
V_347 = F_57 ( V_217 -> V_332 . V_113 , V_345 [ V_10 ] ) ;
if ( V_347 )
V_347 -> V_335 = V_344 [ V_10 ] ;
}
for ( V_339 = V_217 -> V_342 ; V_339 ; V_339 = V_339 -> V_59 ) {
V_178 = F_119 ( V_217 , V_339 ) ;
if ( V_178 )
goto V_114;
}
V_114:
...
int F_121 ( T_3 V_206 , T_3 V_348 , T_3 * V_186 )
{
struct V_40 * V_349 ;
struct V_40 * V_350 ;
struct V_40 V_351 ;
...
V_178 = - V_14 ;
V_350 = F_40 ( & V_183 , V_348 ) ;
if ( ! V_350 ) {
F_4 ( V_181 L_17 ,
V_182 , V_348 ) ;
goto V_210;
}
V_351 . V_67 = V_349 -> V_67 ;
V_351 . V_70 = V_349 -> V_70 ;
V_351 . type = V_349 -> type ;
V_178 = F_122 ( & V_351 , V_350 ) ;
if ( V_178 )
goto V_210;
if ( ! F_59 ( & V_1 , & V_351 ) ) {
V_178 = F_78 ( & V_351 ) ;
if ( V_178 ) {
if ( ! F_22 ( & V_351 , & V_56 , & V_201 ) ) {
F_37 ( V_115 -> V_116 , V_16 , V_117 ,
L_44 , V_56 ) ;
F_6 ( V_56 ) ;
}
...
V_178 = - V_14 ;
V_357 = F_40 ( & V_183 , V_354 ) ;
if ( ! V_357 ) {
F_4 ( V_181 L_17 ,
V_182 , V_354 ) ;
goto V_114;
}
V_178 = ( F_124 ( V_356 , V_357 ) ? 0 : - V_230 ) ;
if ( V_178 )
goto V_114;
* V_355 = V_354 ;
V_114:
...
static int F_125 ( void * V_12 , void * V_92 , void * args )
{
struct V_100 * V_155 = V_92 ;
char * V_15 = V_12 , * * V_359 = args ;
int V_21 = V_155 -> V_21 - 1 ;
V_359 [ V_21 ] = F_46 ( V_15 , V_16 ) ;
if ( ! V_359 [ V_21 ] )
return - V_17 ;
return 0 ;
}
int F_126 ( char * * * V_359 , int * V_360 )
{
int V_178 ;
F_39 ( & V_180 ) ;
V_178 = - V_17 ;
* V_360 = V_1 . V_143 . V_144 ;
* V_359 = F_2 ( * V_360 , sizeof( * * V_359 ) , V_16 ) ;
if ( ! * V_359 )
goto V_114;
V_178 = F_21 ( V_1 . V_143 . V_113 , F_125 ,
* V_359 ) ;
if ( V_178 ) {
int V_10 ;
for ( V_10 = 0 ; V_10 < * V_360 ; V_10 ++ )
F_6 ( ( * V_359 ) [ V_10 ] ) ;
F_6 ( * V_359 ) ;
}
V_114:
...
int F_128 ( char * V_361 , char * * * V_25 , int * V_362 )
{
int V_178 , V_10 ;
struct V_100 * V_363 ;
F_39 ( & V_180 ) ;
V_178 = - V_14 ;
V_363 = F_57 ( V_1 . V_143 . V_113 , V_361 ) ;
if ( ! V_363 ) {
F_4 ( V_181 L_45 ,
V_182 , V_361 ) ;
goto V_114;
...
V_178 = - V_17 ;
* V_362 = V_363 -> V_96 . V_144 ;
* V_25 = F_2 ( * V_362 , sizeof( * * V_25 ) , V_16 ) ;
if ( ! * V_25 )
goto V_114;
if ( V_363 -> V_112 ) {
V_178 = F_21 ( V_363 -> V_112 -> V_96 . V_113 ,
F_127 , * V_25 ) ;
if ( V_178 )
goto V_24;
}
V_178 = F_21 ( V_363 -> V_96 . V_113 , F_127 ,
* V_25 ) ;
if ( V_178 )
goto V_24;
V_114:
...
int F_131 ( unsigned int V_364 )
{
int V_178 ;
F_39 ( & V_180 ) ;
V_178 = F_13 ( & V_1 . V_265 , V_364 ) ;
F_41 ( & V_180 ) ;
return V_178 ;
}
void F_132 ( void * V_365 )
{
struct V_366 * V_367 = V_365 ;
if ( V_367 ) {
F_60 ( & V_367 -> V_368 ) ;
F_6 ( V_367 ) ;
}
}
int F_133 ( T_3 V_369 , T_3 V_72 , char * V_370 , void * * V_365 )
{
struct V_366 * V_371 ;
struct V_49 * V_372 ;
struct V_122 * V_373 ;
...
V_371 = F_134 ( sizeof( struct V_366 ) , V_227 ) ;
if ( ! V_371 )
return - V_17 ;
F_56 ( & V_371 -> V_368 ) ;
F_39 ( & V_180 ) ;
...
case V_379 :
V_178 = - V_14 ;
V_374 = F_57 ( V_1 . V_219 . V_113 , V_370 ) ;
if ( ! V_374 )
goto V_114;
V_371 -> V_368 . V_67 = V_374 -> V_21 ;
break;
case V_377 :
case V_380 :
V_178 = - V_14 ;
V_372 = F_57 ( V_1 . V_220 . V_113 , V_370 ) ;
if ( ! V_372 )
goto V_114;
V_371 -> V_368 . V_70 = V_372 -> V_21 ;
break;
case V_378 :
case V_381 :
V_178 = - V_14 ;
V_373 = F_57 ( V_1 . V_221 . V_113 , V_370 ) ;
if ( ! V_373 )
goto V_114;
V_371 -> V_368 . type = V_373 -> V_21 ;
break;
case V_384 :
case V_385 :
case V_386 :
case V_387 :
V_178 = F_135 ( V_370 , & V_371 -> V_368 , V_16 ) ;
if ( V_178 )
goto V_114;
break;
}
...
int F_136 ( struct V_389 * V_367 )
{
int V_10 ;
for ( V_10 = 0 ; V_10 < V_367 -> V_390 ; V_10 ++ ) {
struct V_391 * V_392 = & V_367 -> V_393 [ V_10 ] ;
switch ( V_392 -> type ) {
case V_376 :
case V_377 :
case V_378 :
...
int F_137 ( T_3 V_206 , T_3 V_369 , T_3 V_72 , void * V_365 ,
struct V_116 * V_394 )
{
struct V_40 * V_395 ;
struct V_52 * V_79 ;
...
int V_363 = 0 ;
if ( ! V_367 ) {
F_37 ( V_394 , V_16 , V_117 ,
L_46 ) ;
return - V_323 ;
}
F_39 ( & V_180 ) ;
if ( V_367 -> V_388 < V_192 ) {
F_37 ( V_394 , V_16 , V_117 ,
L_47 ) ;
V_363 = - V_396 ;
goto V_114;
}
V_395 = F_40 ( & V_183 , V_206 ) ;
if ( ! V_395 ) {
F_37 ( V_394 , V_16 , V_117 ,
L_48 ,
V_206 ) ;
...
switch ( V_72 ) {
case V_382 :
V_363 = ( V_395 -> V_67 == V_367 -> V_368 . V_67 ) ;
break;
case V_383 :
V_363 = ( V_395 -> V_67 != V_367 -> V_368 . V_67 ) ;
break;
...
switch ( V_72 ) {
case V_382 :
V_363 = ( V_395 -> V_70 == V_367 -> V_368 . V_70 ) ;
break;
case V_383 :
V_363 = ( V_395 -> V_70 != V_367 -> V_368 . V_70 ) ;
break;
...
switch ( V_72 ) {
case V_382 :
V_363 = ( V_395 -> type == V_367 -> V_368 . type ) ;
break;
case V_383 :
V_363 = ( V_395 -> type != V_367 -> V_368 . type ) ;
break;
...
V_79 = ( ( V_369 == V_384 ||
V_369 == V_386 ) ?
& V_395 -> V_78 . V_79 [ 0 ] : & V_395 -> V_78 . V_79 [ 1 ] ) ;
switch ( V_72 ) {
case V_382 :
V_363 = F_14 ( & V_367 -> V_368 . V_78 . V_79 [ 0 ] ,
V_79 ) ;
break;
case V_383 :
V_363 = ! F_14 ( & V_367 -> V_368 . V_78 . V_79 [ 0 ] ,
...
break;
case V_397 :
V_363 = ( F_15 ( & V_367 -> V_368 . V_78 . V_79 [ 0 ] ,
V_79 ) &&
! F_14 ( & V_367 -> V_368 . V_78 . V_79 [ 0 ] ,
V_79 ) ) ;
break;
case V_398 :
V_363 = F_15 ( & V_367 -> V_368 . V_78 . V_79 [ 0 ] ,
...
static int F_138 ( T_3 V_401 , T_3 V_194 , T_3 V_195 ,
T_1 V_361 , T_3 V_25 , T_3 * V_402 )
{
int V_24 = 0 ;
...
{
T_3 * V_407 ;
V_407 = F_48 ( sizeof( * V_407 ) , V_16 ) ;
if ( V_407 == NULL )
return;
V_406 -> V_408 = F_143 ( V_16 ) ;
if ( V_406 -> V_408 == NULL ) {
F_6 ( V_407 ) ;
return;
}
* V_407 = V_206 ;
V_406 -> V_408 -> free = F_6 ;
V_406 -> V_408 -> V_156 = V_407 ;
V_406 -> V_193 |= V_409 ;
}
int F_144 ( struct V_405 * V_406 ,
T_3 * V_206 )
{
int V_178 ;
struct V_40 * V_212 ;
...
F_39 ( & V_180 ) ;
if ( V_406 -> V_193 & V_409 )
* V_206 = * ( T_3 * ) V_406 -> V_408 -> V_156 ;
else if ( V_406 -> V_193 & V_411 )
* V_206 = V_406 -> V_65 . V_412 ;
else if ( V_406 -> V_193 & V_413 ) {
V_178 = - V_414 ;
V_212 = F_40 ( & V_183 , V_415 ) ;
if ( V_212 == NULL )
goto V_114;
F_56 ( & V_410 ) ;
V_410 . V_67 = V_212 -> V_67 ;
V_410 . V_70 = V_212 -> V_70 ;
V_410 . type = V_212 -> type ;
F_145 ( & V_410 , V_406 ) ;
if ( V_406 -> V_193 & V_416 ) {
V_178 = F_146 ( & V_410 . V_78 . V_79 [ 0 ] . V_417 ,
V_406 -> V_65 . V_418 . V_417 ) ;
if ( V_178 )
goto V_114;
memcpy ( & V_410 . V_78 . V_79 [ 1 ] . V_417 ,
& V_410 . V_78 . V_79 [ 0 ] . V_417 ,
sizeof( V_410 . V_78 . V_79 [ 0 ] . V_417 ) ) ;
}
V_178 = - V_414 ;
if ( ! F_147 ( & V_1 , & V_410 ) )
goto V_419;
V_178 = F_62 ( & V_183 , & V_410 , V_206 ) ;
if ( V_178 )
goto V_419;
F_142 ( V_406 , * V_206 ) ;
F_148 ( & V_410 . V_78 . V_79 [ 0 ] . V_417 ) ;
} else
* V_206 = V_226 ;
F_41 ( & V_180 ) ;
return 0 ;
...
int F_149 ( T_3 V_206 , struct V_405 * V_406 )
{
int V_178 ;
struct V_40 * V_212 ;
if ( ! V_179 )
...
goto V_114;
V_178 = - V_17 ;
V_406 -> V_292 = F_46 ( F_20 ( & V_1 , V_205 , V_212 -> type - 1 ) ,
V_16 ) ;
if ( V_406 -> V_292 == NULL )
goto V_114;
V_406 -> V_65 . V_412 = V_206 ;
V_406 -> V_193 |= V_420 | V_411 ;
F_150 ( V_212 , V_406 ) ;
V_178 = F_151 ( V_212 , V_406 ) ;
V_114:
F_41 ( & V_180 ) ;
return V_178 ;
}
int F_152 ( void * * V_156 , T_2 * V_201 )
{
int V_178 ;
struct V_275 V_277 ;
if ( ! V_179 )
...
V_277 . V_201 = * V_201 ;
F_39 ( & V_180 ) ;
V_178 = F_154 ( & V_1 , & V_277 ) ;
F_41 ( & V_180 ) ;
if ( V_178 )
return V_178 ;
* V_201 = ( unsigned long ) V_277 . V_156 - ( unsigned long ) * V_156 ;
return 0 ;
}
