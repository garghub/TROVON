...
{
struct V_18 * V_19 = F_42 ( V_156 ) ;
static const T_1 V_254 [ V_84 ] = { 255 , 255 , 255 , 255 , 255 , 255 } ;
int V_4 = - V_241 ;
if ( V_237 -> V_255 . V_256 != V_257 )
goto V_42;
if ( ! memcmp ( V_254 , V_237 -> V_255 . V_258 , V_84 ) ) {
} else
...
V_259 = F_100 ( V_235 , V_259 ,
V_238 + V_265 ,
& V_261 , V_266 ) ;
V_261 . V_262 = V_267 ;
V_261 . V_264 . V_15 . V_59 = 1 ;
V_261 . V_264 . V_15 . V_249 = V_19 -> V_113 [ V_3 ] . V_128 . V_12 . V_14 ;
V_259 = F_101 ( V_235 , V_259 ,
V_238 + V_265 ,
& V_261 ,
V_19 -> V_113 [ V_3 ] . V_128 . V_129 ) ;
V_261 . V_262 = V_268 ;
V_261 . V_264 . V_243 = V_19 -> V_113 [ V_3 ] . V_102 ;
V_259 = F_100 ( V_235 , V_259 ,
V_238 + V_265 ,
& V_261 , V_269 ) ;
V_261 . V_262 = V_270 ;
V_261 . V_264 . V_239 . V_240 = V_19 -> V_113 [ V_3 ] . V_109 . V_111 ;
V_261 . V_264 . V_239 . V_242 = 0 ;
V_259 = F_100 ( V_235 , V_259 ,
V_238 + V_265 ,
& V_261 , V_271 ) ;
V_261 . V_262 = V_272 ;
...
V_261 . V_264 . V_15 . V_249 = 0 ;
V_259 = F_101 ( V_235 , V_259 ,
V_238 + V_265 ,
& V_261 , NULL ) ;
}
V_237 -> V_15 . V_249 = ( V_259 - V_238 ) ;
V_237 -> V_15 . V_59 = 0 ;
return 0 ;
}
...
static int F_104 ( struct V_155 * V_156 , struct V_234 * V_235 ,
union V_236 * V_237 , char * V_238 )
{
struct V_18 * V_19 = F_42 ( V_156 ) ;
if ( V_237 -> V_15 . V_249 > sizeof( V_19 -> V_278 ) )
return - V_279 ;
F_88 ( V_19 -> V_278 , V_238 , V_237 -> V_15 . V_249 ) ;
return 0 ;
}
...
if ( V_4 )
goto V_42;
V_301 = F_112 ( T_2 , V_300 , V_237 -> V_303 . V_249 ) ;
V_301 = F_112 ( T_1 , V_301 , 100 ) ;
V_237 -> V_303 . V_249 = V_301 ;
...
if ( V_4 )
goto V_42;
V_237 -> V_311 . V_245 = ! V_309 ;
V_237 -> V_311 . V_59 = V_312 ;
V_42:
return V_4 ;
}
static int F_114 ( struct V_205 * V_207 )
{
struct V_155 * V_156 ;
struct V_18 * V_19 ;
...
V_207 -> V_316 = V_317 ;
V_207 -> V_318 = 1 ;
V_156 = F_115 ( sizeof( struct V_18 ) ) ;
if ( ! V_156 )
goto V_319;
V_156 -> V_320 = & V_321 ;
V_156 -> V_322 = 5 * V_323 ;
...
F_88 ( V_19 -> V_278 , L_28 , sizeof( V_19 -> V_278 ) ) ;
F_122 ( & V_19 -> V_60 ) ;
F_123 ( & V_19 -> V_63 ) ;
F_124 ( V_156 ) ;
return 0 ;
...
static int F_126 ( struct V_205 * V_206 )
{
struct V_155 * V_156 = V_206 -> V_233 ;
