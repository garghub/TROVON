...
#ifdef F_35
{
unsigned int V_76 = V_2 -> V_3 ;
unsigned int V_77 ;
static int V_78 [ 4 ] = {
V_79 , V_80 , V_81 , V_82
} ;
if ( F_36 ( V_2 -> V_32 ) != V_78 [ V_19 ] ) {
F_37 ( & V_22 -> V_22 , L_5 ,
F_36 ( V_2 -> V_32 ) , V_78 [ V_19 ] ) ;
return - V_83 ;
}
V_77 = ( V_84 | V_85 | V_46 |
V_4 ) ;
...
if ( V_22 -> V_62 != V_92 ) {
V_2 -> V_93 = F_38 ( V_20 , 1 << F_39 ( V_2 -> V_93 ) ) ;
}
}
return F_40 ( V_2 , V_8 ) ;
}
...
V_100 = F_52 ( V_12 -> V_15 . V_101 , struct V_2 ,
V_6 ) ;
F_12 ( V_100 ) ;
F_53 ( & V_12 -> V_14 ) ;
F_43 ( V_100 ) ;
...
F_15 ( & V_12 -> V_14 , V_13 ) ;
if ( ! F_23 ( & V_12 -> V_15 ) ) {
V_100 = F_52 ( V_12 -> V_15 . V_104 , struct V_2 ,
V_6 ) ;
F_12 ( V_100 ) ;
F_20 ( V_100 , V_12 ) ;
} else {
