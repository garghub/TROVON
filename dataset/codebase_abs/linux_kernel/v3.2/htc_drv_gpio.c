...
bool V_56 ;
F_36 ( V_2 ) ;
V_56 = F_2 ( V_2 -> V_6 , V_2 -> V_6 -> V_57 ) ==
V_2 -> V_6 -> V_58 ;
F_37 ( V_2 ) ;
return V_56 ;
}
void F_38 ( struct V_59 * V_31 )
{
...
{
if ( V_2 -> V_6 -> V_61 . V_62 & V_63 )
F_41 ( V_2 -> V_31 -> V_53 ) ;
}
void F_42 ( struct V_59 * V_31 )
{
struct V_1 * V_2 = V_31 -> V_2 ;
struct V_5 * V_6 = V_2 -> V_6 ;
struct V_22 * V_23 = F_6 ( V_6 ) ;
...
T_2 V_64 ;
if ( ! V_6 -> V_65 )
V_6 -> V_65 = F_43 ( V_31 , V_6 ) ;
V_26 = F_44 ( V_6 , V_6 -> V_65 , V_6 -> V_66 , false ) ;
if ( V_26 ) {
F_10 ( V_23 ,
L_7 ,
V_26 , V_6 -> V_65 -> V_67 ) ;
}
F_45 ( V_6 , V_2 -> V_68 , V_2 -> V_69 ,
& V_2 -> V_68 ) ;
F_46 ( V_70 ) ;
F_47 ( V_2 ) ;
F_48 ( V_2 -> V_71 ) ;
