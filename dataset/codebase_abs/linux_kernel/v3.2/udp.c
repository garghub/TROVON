...
static void F_168 ( struct V_6 * * V_276 , unsigned int V_34 ,
...
V_7 = V_276 [ V_278 ] ;
if ( F_87 ( V_279 == NULL ) )
V_279 = ( V_278 == V_277 ) ? V_74 : F_169 ( V_74 , V_280 ) ;
if ( ! V_279 ) {
F_121 ( & V_7 -> V_233 ) ;
F_120 ( F_5 ( V_7 ) , V_267 ,
F_76 ( V_7 ) ) ;
...
static int F_170 ( struct V_1 * V_1 , struct V_73 * V_74 ,
struct V_85 * V_86 ,
T_2 V_47 , T_2 V_55 ,
struct V_20 * V_21 )
{
...
while ( V_7 ) {
V_276 [ V_34 ++ ] = V_7 ;
V_7 = F_56 ( V_1 , F_172 ( V_7 ) , V_86 -> V_91 ,
V_55 , V_86 -> V_92 , V_47 , V_57 ) ;
if ( F_40 ( V_34 == F_173 ( V_276 ) ) ) {
if ( ! V_7 )
break;
F_168 ( V_276 , V_34 , V_74 , ~ 0 ) ;
V_34 = 0 ;
}
}
for ( V_278 = 0 ; V_278 < V_34 ; V_278 ++ )
...
static inline int F_175 ( struct V_73 * V_74 , struct V_85 * V_86 ,
int V_281 )
{
...
if ( ! F_135 ( V_74 ) )
V_74 -> V_126 = F_177 ( V_76 -> V_47 , V_76 -> V_55 ,
V_74 -> V_119 , V_281 , 0 ) ;
return 0 ;
}
int F_178 ( struct V_73 * V_74 , struct V_20 * V_21 ,
int V_281 )
{
struct V_6 * V_7 ;
struct V_85 * V_86 ;
unsigned short V_157 ;
struct V_160 * V_161 = F_179 ( V_74 ) ;
T_2 V_47 , V_55 ;
struct V_1 * V_1 = F_52 ( V_74 -> V_77 ) ;
if ( ! F_180 ( V_74 , sizeof( struct V_85 ) ) )
goto V_269;
V_86 = F_67 ( V_74 ) ;
...
goto V_285;
if ( V_281 == V_130 ) {
if ( V_157 < sizeof( * V_86 ) || F_181 ( V_74 , V_157 ) )
goto V_285;
V_86 = F_67 ( V_74 ) ;
}
if ( F_175 ( V_74 , V_86 , V_281 ) )
goto V_286;
if ( V_161 -> V_211 & ( V_212 | V_287 ) )
return F_170 ( V_1 , V_74 , V_86 ,
V_47 , V_55 , V_21 ) ;
...
int F_183 ( struct V_73 * V_74 )
{
return F_178 ( V_74 , & V_20 , V_130 ) ;
}
...
int F_185 ( struct V_6 * V_7 , int V_290 , int V_291 ,
char V_239 * V_292 , unsigned int V_197 ,
int (* F_186)( struct V_6 * ) )
{
struct V_116 * V_117 = F_6 ( V_7 ) ;
int V_293 ;
int V_90 = 0 ;
...
if ( V_197 < sizeof( int ) )
return - V_178 ;
if ( F_187 ( V_293 , ( int V_239 * ) V_292 ) )
return - V_294 ;
switch ( V_291 ) {
case V_295 :
if ( V_293 != 0 ) {
...
int F_188 ( struct V_6 * V_7 , int V_290 , int V_291 ,
char V_239 * V_292 , unsigned int V_197 )
{
if ( V_290 == V_308 || V_290 == V_309 )
return F_185 ( V_7 , V_290 , V_291 , V_292 , V_197 ,
F_82 ) ;
return F_189 ( V_7 , V_290 , V_291 , V_292 , V_197 ) ;
}
int F_190 ( struct V_6 * V_7 , int V_290 , int V_291 ,
char V_239 * V_292 , unsigned int V_197 )
{
if ( V_290 == V_308 || V_290 == V_309 )
return F_185 ( V_7 , V_290 , V_291 , V_292 , V_197 ,
F_82 ) ;
return F_191 ( V_7 , V_290 , V_291 , V_292 , V_197 ) ;
}
int F_192 ( struct V_6 * V_7 , int V_290 , int V_291 ,
char V_239 * V_292 , int V_239 * V_197 )
{
struct V_116 * V_117 = F_6 ( V_7 ) ;
int V_293 , V_119 ;
if ( F_187 ( V_119 , V_197 ) )
return - V_294 ;
V_119 = F_193 (unsigned int, len, sizeof(int)) ;
if ( V_119 < 0 )
return - V_178 ;
switch ( V_291 ) {
case V_295 :
...
return - V_294 ;
if ( F_194 ( V_292 , & V_293 , V_119 ) )
return - V_294 ;
return 0 ;
}
int F_195 ( struct V_6 * V_7 , int V_290 , int V_291 ,
char V_239 * V_292 , int V_239 * V_197 )
{
if ( V_290 == V_308 || V_290 == V_309 )
return F_192 ( V_7 , V_290 , V_291 , V_292 , V_197 ) ;
return F_196 ( V_7 , V_290 , V_291 , V_292 , V_197 ) ;
}
int F_197 ( struct V_6 * V_7 , int V_290 , int V_291 ,
char V_239 * V_292 , int V_239 * V_197 )
{
if ( V_290 == V_308 || V_290 == V_309 )
return F_192 ( V_7 , V_290 , V_291 , V_292 , V_197 ) ;
return F_198 ( V_7 , V_290 , V_291 , V_292 , V_197 ) ;
}
unsigned int F_199 ( struct V_310 * V_310 , struct V_311 * V_6 , T_7 * V_312 )
{
unsigned int V_31 = F_200 ( V_310 , V_6 , V_312 ) ;
...
static struct V_6 * F_201 ( struct V_319 * V_320 , int V_321 )
{
struct V_6 * V_7 ;
struct V_322 * V_323 = V_320 -> V_324 ;
struct V_1 * V_1 = F_202 ( V_320 ) ;
...
static struct V_6 * F_204 ( struct V_319 * V_320 , struct V_6 * V_7 )
{
struct V_322 * V_323 = V_320 -> V_324 ;
struct V_1 * V_1 = F_202 ( V_320 ) ;
do {
...
return F_201 ( V_320 , V_323 -> V_325 + 1 ) ;
}
return V_7 ;
}
static struct V_6 * F_205 ( struct V_319 * V_320 , T_8 V_327 )
{
struct V_6 * V_7 = F_201 ( V_320 , 0 ) ;
if ( V_7 )
while ( V_327 && ( V_7 = F_204 ( V_320 , V_7 ) ) != NULL )
-- V_327 ;
return V_327 ? NULL : V_7 ;
}
static void * F_206 ( struct V_319 * V_320 , T_8 * V_327 )
{
struct V_322 * V_323 = V_320 -> V_324 ;
V_323 -> V_325 = V_328 ;
return * V_327 ? F_205 ( V_320 , * V_327 - 1 ) : V_329 ;
}
static void * F_207 ( struct V_319 * V_320 , void * V_330 , T_8 * V_327 )
{
struct V_6 * V_7 ;
if ( V_330 == V_329 )
V_7 = F_205 ( V_320 , 0 ) ;
else
V_7 = F_204 ( V_320 , V_330 ) ;
++ * V_327 ;
return V_7 ;
}
static void F_208 ( struct V_319 * V_320 , void * V_330 )
{
struct V_322 * V_323 = V_320 -> V_324 ;
if ( V_323 -> V_325 <= V_323 -> V_20 -> V_31 )
F_21 ( & V_323 -> V_20 -> V_72 [ V_323 -> V_325 ] . V_17 ) ;
}
int F_209 ( struct V_331 * V_331 , struct V_310 * V_310 )
{
struct V_332 * V_333 = F_210 ( V_331 ) -> V_84 ;
struct V_322 * V_82 ;
int V_90 ;
V_90 = F_211 ( V_331 , V_310 , & V_333 -> V_334 ,
sizeof( struct V_322 ) ) ;
if ( V_90 < 0 )
return V_90 ;
...
int F_212 ( struct V_1 * V_1 , struct V_332 * V_333 )
{
struct V_336 * V_337 ;
int V_265 = 0 ;
V_333 -> V_334 . V_321 = F_206 ;
V_333 -> V_334 . V_131 = F_207 ;
V_333 -> V_334 . V_338 = F_208 ;
V_337 = F_213 ( V_333 -> V_339 , V_340 , V_1 -> V_341 ,
V_333 -> V_342 , V_333 ) ;
if ( ! V_337 )
V_265 = - V_266 ;
return V_265 ;
}
void F_214 ( struct V_1 * V_1 , struct V_332 * V_333 )
{
F_215 ( V_1 , V_333 -> V_339 ) ;
}
static void F_216 ( struct V_6 * V_343 , struct V_319 * V_344 ,
int V_325 , int * V_119 )
{
...
F_129 ( V_343 ) ,
F_218 ( V_343 ) ,
0 , 0L , 0 , F_219 ( V_343 ) , 0 , F_220 ( V_343 ) ,
F_221 ( & V_343 -> V_69 ) , V_343 ,
F_221 ( & V_343 -> V_233 ) , V_119 ) ;
}
int F_222 ( struct V_319 * V_320 , void * V_330 )
{
if ( V_330 == V_329 )
F_217 ( V_320 , L_12 ,
L_13
...
struct V_322 * V_323 = V_320 -> V_324 ;
int V_119 ;
F_216 ( V_330 , V_320 , V_323 -> V_325 , & V_119 ) ;
F_217 ( V_320 , L_16 , 127 - V_119 , L_8 ) ;
}
return 0 ;
}
static int T_9 F_223 ( struct V_1 * V_1 )
{
return F_212 ( V_1 , & V_347 ) ;
}
static void T_10 F_224 ( struct V_1 * V_1 )
{
F_214 ( V_1 , & V_347 ) ;
}
int T_11 F_225 ( void )
...
static int T_11 F_229 ( char * V_349 )
{
if ( ! V_349 )
return 0 ;
V_350 = F_230 ( V_349 , & V_349 , 0 ) ;
if ( V_350 && V_350 < V_351 )
V_350 = V_351 ;
return 1 ;
}
void T_11 F_231 ( struct V_20 * V_352 , const char * V_339 )
{
unsigned int V_278 ;
if ( ! V_353 )
V_352 -> V_72 = F_232 ( V_339 ,
2 * sizeof( struct V_3 ) ,
V_350 ,
21 ,
0 ,
...
V_352 -> V_72 = F_233 ( V_351 *
2 * sizeof( struct V_3 ) , V_354 ) ;
if ( ! V_352 -> V_72 )
F_234 ( V_339 ) ;
V_352 -> log = F_235 ( V_351 ) ;
V_352 -> V_31 = V_351 - 1 ;
}
V_352 -> V_70 = V_352 -> V_72 + ( V_352 -> V_31 + 1 ) ;
for ( V_278 = 0 ; V_278 <= V_352 -> V_31 ; V_278 ++ ) {
F_236 ( & V_352 -> V_72 [ V_278 ] . V_41 , V_278 ) ;
V_352 -> V_72 [ V_278 ] . V_34 = 0 ;
F_237 ( & V_352 -> V_72 [ V_278 ] . V_17 ) ;
}
for ( V_278 = 0 ; V_278 <= V_352 -> V_31 ; V_278 ++ ) {
F_236 ( & V_352 -> V_70 [ V_278 ] . V_41 , V_278 ) ;
V_352 -> V_70 [ V_278 ] . V_34 = 0 ;
F_237 ( & V_352 -> V_70 [ V_278 ] . V_17 ) ;
}
}
...
int F_241 ( struct V_73 * V_74 )
{
const struct V_75 * V_76 ;
struct V_85 * V_86 ;
if ( ! F_180 ( V_74 , sizeof( * V_86 ) ) )
return - V_178 ;
V_76 = F_50 ( V_74 ) ;
V_86 = F_67 ( V_74 ) ;
...
struct V_73 * F_242 ( struct V_73 * V_74 , V_50 V_360 )
{
struct V_73 * V_361 = F_243 ( - V_178 ) ;
unsigned int V_362 ;
int V_124 ;
T_4 V_126 ;
...
goto V_98;
if ( F_244 ( V_74 , V_360 | V_364 ) ) {
int type = F_68 ( V_74 ) -> V_365 ;
if ( F_40 ( type & ~ ( V_366 | V_367 ) ||
! ( type & ( V_366 ) ) ) )
goto V_98;
F_68 ( V_74 ) -> V_368 = F_245 ( V_74 -> V_119 , V_362 ) ;
V_361 = NULL ;
goto V_98;
}
V_124 = F_246 ( V_74 ) ;
...
V_124 += V_74 -> V_128 ;
* ( V_369 * ) ( V_74 -> V_84 + V_124 ) = F_247 ( V_126 ) ;
V_74 -> V_132 = V_133 ;
V_361 = F_248 ( V_74 , V_360 ) ;
V_98:
return V_361 ;
}
