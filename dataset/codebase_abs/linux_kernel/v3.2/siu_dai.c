...
V_2 -> V_14 = 0 ;
F_4 ( V_6 + V_12 , 0x301 ) ;
F_4 ( V_6 + V_15 , 0x40400000 ) ;
F_4 ( V_6 + V_16 , 0 ) ;
F_4 ( V_6 + V_17 , 0 ) ;
F_4 ( V_6 + V_18 , 1 ) ;
F_4 ( V_6 + V_19 , 0 ) ;
F_4 ( V_6 + V_20 , 0x44440000 ) ;
F_4 ( V_6 + V_21 , 0x0c0c0000 ) ;
F_4 ( V_6 + V_22 , V_2 -> V_23 . V_24 ) ;
F_4 ( V_6 + V_25 , V_2 -> V_26 . V_24 ) ;
}
...
static void F_12 ( struct V_38 * V_38 )
{
struct V_3 * V_4 = V_5 ;
T_1 T_2 * V_6 = V_4 -> V_7 ;
T_1 V_43 ;
...
F_4 ( V_46 , V_28 -> V_60 [ V_45 ] ) ;
V_46 = V_4 -> V_57 + ( 0x0600 / sizeof( T_1 ) ) ;
for ( V_45 = 0 ; V_45 < V_61 ; V_45 ++ , V_46 ++ )
F_4 ( V_46 , 0 ) ;
F_4 ( V_6 + V_62 , V_2 -> V_14 ) ;
V_2 -> V_14 = 0x0 ;
F_4 ( V_6 + V_63 , 0 ) ;
F_4 ( V_6 + V_64 , 0xc0000000 ) ;
V_45 = 0x10000 ;
while ( -- V_45 && F_11 ( V_6 + V_64 ) != 0x80000000 )
F_14 () ;
if ( ! V_45 )
return - V_65 ;
F_4 ( V_6 + V_66 , 0x00400000 ) ;
F_4 ( V_6 + V_63 , 0xc0000000 ) ;
return 0 ;
}
...
int F_21 ( int V_87 , struct V_1 * * V_2 , struct V_88 * V_9 )
{
struct V_79 * V_10 = V_9 -> V_10 ;
struct V_67 * V_68 ;
int V_89 ;
* V_2 = F_22 ( sizeof( * * V_2 ) , V_90 ) ;
if ( ! * V_2 )
return - V_91 ;
...
struct V_97 * V_98 )
{
struct V_3 * V_4 = F_28 ( V_98 ) ;
struct V_99 * V_100 = V_96 -> V_101 ;
struct V_1 * V_2 = F_29 ( V_96 ) ;
int V_89 ;
F_2 ( V_96 -> V_8 -> V_9 -> V_10 , L_6 , V_11 ,
V_4 -> V_32 , V_2 ) ;
F_30 ( V_96 , & V_102 ) ;
V_89 = F_31 ( V_100 , V_103 ) ;
if ( F_32 ( V_89 < 0 ) )
return V_89 ;
F_1 ( V_2 ) ;
return 0 ;
...
V_2 -> V_106 &= ~ V_108 ;
if ( ! V_2 -> V_106 ) {
F_34 ( V_2 -> V_23 . V_109 || V_2 -> V_26 . V_109 ) ;
F_15 ( V_2 ) ;
F_6 ( V_2 ) ;
}
}
...
static int F_37 ( struct V_97 * V_98 , int V_121 ,
...
V_124 = F_38 ( V_98 -> V_10 , V_126 ) ;
if ( F_39 ( V_124 ) ) {
F_19 ( V_98 -> V_10 , L_15 , V_11 ,
F_40 ( V_124 ) ) ;
return F_40 ( V_124 ) ;
}
V_125 = F_38 ( V_98 -> V_10 , V_127 ) ;
if ( F_39 ( V_125 ) ) {
V_89 = F_40 ( V_125 ) ;
F_19 ( V_98 -> V_10 , L_16 , V_89 ) ;
goto V_133;
}
V_89 = F_41 ( V_124 , V_125 ) ;
if ( V_89 < 0 ) {
F_19 ( V_98 -> V_10 , L_17 , V_89 ) ;
goto V_134;
}
V_89 = F_42 ( V_124 , V_122 ) ;
if ( V_89 < 0 )
F_19 ( V_98 -> V_10 , L_18 , V_89 ) ;
V_134:
F_43 ( V_125 ) ;
V_133:
F_43 ( V_124 ) ;
...
static int T_3 F_44 ( struct V_135 * V_136 )
{
const struct V_137 * V_138 ;
struct V_139 * V_140 , * V_141 ;
struct V_3 * V_4 ;
int V_89 ;
V_4 = F_45 ( sizeof( * V_4 ) , V_90 ) ;
if ( ! V_4 )
return - V_91 ;
V_5 = V_4 ;
V_4 -> V_10 = & V_136 -> V_10 ;
V_89 = F_46 ( & V_138 , L_19 , & V_136 -> V_10 ) ;
if ( V_89 )
goto V_142;
memcpy ( & V_4 -> V_28 , V_138 -> V_143 , V_138 -> V_144 ) ;
F_47 ( V_138 ) ;
V_140 = F_48 ( V_136 , V_145 , 0 ) ;
if ( ! V_140 ) {
V_89 = - V_114 ;
goto V_146;
}
V_141 = F_49 ( V_140 -> V_147 , F_50 ( V_140 ) ,
V_136 -> V_148 ) ;
if ( ! V_141 ) {
F_19 ( & V_136 -> V_10 , L_20 ) ;
V_89 = - V_65 ;
goto V_149;
}
V_89 = - V_91 ;
V_4 -> V_49 = F_51 ( V_140 -> V_147 , V_150 ) ;
if ( ! V_4 -> V_49 )
goto V_151;
V_4 -> V_53 = F_51 ( V_140 -> V_147 + V_152 , V_153 ) ;
if ( ! V_4 -> V_53 )
goto V_154;
V_4 -> V_57 = F_51 ( V_140 -> V_147 + V_155 , V_156 ) ;
if ( ! V_4 -> V_57 )
goto V_157;
V_4 -> V_7 = F_51 ( V_140 -> V_147 + V_158 , F_50 ( V_140 ) -
V_158 ) ;
if ( ! V_4 -> V_7 )
goto V_159;
F_52 ( & V_136 -> V_10 , V_4 ) ;
V_89 = F_53 ( & V_136 -> V_10 , & V_160 , 1 ) ;
if ( V_89 < 0 )
goto V_161;
V_89 = F_54 ( & V_136 -> V_10 , & V_162 ) ;
if ( V_89 < 0 )
goto V_163;
F_55 ( & V_136 -> V_10 ) ;
return V_89 ;
...
static int T_4 F_59 ( struct V_135 * V_136 )
{
struct V_3 * V_4 = F_60 ( & V_136 -> V_10 ) ;
struct V_139 * V_140 ;
F_61 ( & V_136 -> V_10 ) ;
F_62 ( & V_136 -> V_10 ) ;
F_56 ( & V_136 -> V_10 ) ;
