...
V_8 -> V_439 = 16 ;
V_8 -> V_440 = 1 ;
V_29 = F_172 ( V_10 -> V_432 , V_10 -> V_30 -> V_2 ) ;
if ( V_29 )
goto V_441;
}
return 0 ;
V_441:
F_173 ( V_30 -> V_429 [ V_158 ] -> V_432 ) ;
V_430:
while ( -- V_158 >= 0 ) {
...
void F_175 ( struct V_9 * V_10 , int V_442 )
{
int V_443 = 5 ;
...
V_355 = V_24 -> V_446 ;
V_22 = F_179 ( V_10 -> V_432 , V_355 , V_89 , 0 ,
NULL ) ;
if ( ! F_180 ( V_22 ) ) {
V_2 -> V_22 = V_22 ;
F_181 ( V_22 ) ;
...
F_184 ( V_448 , & V_10 -> V_449 ,
F_185 ( V_116 ) ) ;
}
int F_186 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 ) {
F_187 ( V_2 -> V_22 , V_450 ) ;
return 1 ;
}
return 0 ;
}
...
void F_199 ( struct V_455 * V_456 )
{
struct V_9 * V_10 =
F_200 ( V_456 , struct V_9 , V_449 . V_456 ) ;
int V_158 ;
if ( V_10 -> V_36 & V_457 ) {
F_97 ( L_54 ) ;
return;
...
if ( ! V_10 -> V_61 -> V_170 )
return - V_34 ;
if ( V_356 != V_460 && V_356 )
return - V_17 ;
if ( ! F_152 ( V_10 ) ) {
if ( V_355 != V_460 && V_355 )
return - V_17 ;
V_40 = V_89 ;
} else {
if ( V_89 != V_460 && V_89 )
...
if ( V_2 ) {
struct V_461 * V_462 = & V_2 -> V_24 -> V_48 ;
V_462 -> V_463 |= 1 << V_2 -> V_40 ;
V_462 -> V_84 |= V_85 ;
} else
V_29 = - V_17 ;
}
...
void F_202 ( struct V_455 * V_456 )
{
struct V_9 * V_10 =
F_200 ( V_456 , struct V_9 , V_465 ) ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
unsigned long V_13 ;
F_189 ( & V_10 -> V_458 ) ;
...
V_10 -> V_468 = 0 ;
V_10 -> V_18 = & V_30 -> V_18 ;
V_10 -> V_469 = V_467 -> V_469 ;
V_10 -> V_470 = V_467 -> V_470 ;
V_10 -> V_471 = V_467 -> V_471 ;
V_10 -> V_13 |= V_467 -> V_13 ;
V_10 -> V_61 = V_467 -> V_472 ;
V_10 -> V_473 = V_474 ;
return V_10 ;
}
...
{
if ( V_10 -> V_61 -> V_478 )
V_10 -> V_61 -> V_478 ( V_10 ) ;
F_43 ( V_10 ) ;
}
int F_211 ( struct V_21 * V_22 , struct V_9 * V_10 )
{
F_61 ( V_22 ) ;
F_66 ( V_22 , V_10 -> V_24 . V_1 ) ;
return 0 ;
}
int F_212 ( struct V_52 * V_53 , struct V_9 * V_10 )
{
int V_29 = 0 ;
F_163 ( V_10 , V_53 ) ;
