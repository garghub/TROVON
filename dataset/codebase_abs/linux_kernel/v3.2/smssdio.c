...
if ( V_16 -> V_24 > V_6 -> V_7 -> V_8 )
V_3 = V_16 -> V_24 - V_6 -> V_7 -> V_8 ;
else
V_3 = 0 ;
} else {
V_14 = V_6 -> V_18 ;
...
struct V_30 V_31 ;
V_29 = V_28 -> V_32 ;
V_6 = F_16 ( sizeof( struct V_5 ) , V_33 ) ;
if ( ! V_6 )
return - V_34 ;
V_6 -> V_7 = V_7 ;
