...
void F_63 ( struct V_12 * V_13 , enum V_62 V_63 )
{
F_47 ( 4 , L_9 ,
V_13 -> V_3 . V_8 , V_13 -> V_3 . V_6 , V_63 ) ;
if ( V_13 -> V_63 >= V_63 )
return;
if ( ! F_64 ( & V_13 -> V_11 ) )
return;
V_13 -> V_63 = V_63 ;
if ( ! F_65 ( V_64 , & V_13 -> V_25 ) ) {
F_11 ( & V_13 -> V_11 ) ;
}
}
static void V_26 ( struct V_65 * V_66 )
{
struct V_12 * V_13 ;
enum V_62 V_63 ;
int V_4 ;
V_13 = F_66 ( V_66 , struct V_12 , V_25 ) ;
F_67 ( V_13 -> V_29 ) ;
V_63 = V_13 -> V_63 ;
...
static void F_75 ( struct V_65 * V_77 )
{
unsigned long V_78 ;
F_76 ( 4 , L_12 ) ;
F_12 ( F_73 , F_74 ,
...
static void F_89 ( struct V_82 * V_83 , struct V_82 * V_84 , int V_85 )
{
struct V_1 V_86 ;
struct V_12 * V_13 ;
if ( V_85 ) {
...
static void T_2
F_91 ( struct V_95 * V_96 , T_3 V_97 )
{
struct V_98 V_99 ;
if ( V_100 . V_101 ) {
...
static T_1
F_98 ( struct V_10 * V_11 , struct V_42 * V_43 ,
char * V_44 )
{
struct V_95 * V_96 = F_96 ( V_11 ) ;
int V_4 ;
if ( ! V_96 )
return 0 ;
F_29 ( & V_96 -> V_111 ) ;
...
int V_4 ;
unsigned long V_115 ;
V_4 = F_100 ( V_44 , 16 , & V_115 ) ;
if ( V_4 )
return V_4 ;
F_29 ( & V_96 -> V_111 ) ;
switch ( V_115 ) {
case 0 :
V_4 = V_96 -> V_113 ? F_101 ( V_96 , 0 ) : 0 ;
break;
case 1 :
V_4 = V_96 -> V_113 ? 0 : F_101 ( V_96 , 1 ) ;
break;
default:
V_4 = - V_116 ;
}
...
static int T_2 F_102 ( int V_117 )
{
T_3 V_97 ;
int V_4 ;
struct V_95 * V_96 ;
...
static int F_108 ( struct V_119 * V_120 , unsigned long V_121 ,
void * V_122 )
{
int V_4 , V_34 ;
switch ( V_121 ) {
...
static int F_133 ( struct V_145 * V_146 , void * V_77 )
{
struct V_147 * V_148 = F_134 ( V_146 ) ;
if ( V_148 -> V_149 )
return V_148 -> V_149 () ;
return 0 ;
}
...
if ( ! V_152 )
continue;
F_143 ( V_38 , & V_152 -> V_154 ) ;
}
}
static T_1 F_144 ( struct V_155 * V_155 , const char T_5 * V_44 ,
T_4 V_114 , T_6 * V_156 )
{
int V_4 ;
F_145 () ;
...
{
return V_13 == F_96 ( V_13 -> V_11 . V_46 ) -> V_112 ;
}
static int F_149 ( struct V_10 * V_11 , struct V_145 * V_146 )
{
struct V_12 * V_13 = F_5 ( V_11 ) ;
struct V_147 * V_52 = F_134 ( V_146 ) ;
struct V_161 * V_39 ;
...
static int F_153 ( struct V_10 * V_11 , struct V_166 * V_167 )
{
struct V_12 * V_13 = F_5 ( V_11 ) ;
int V_4 ;
V_4 = F_154 ( V_167 , L_23 , V_13 -> V_45 ) ;
if ( V_4 )
return V_4 ;
V_4 = F_154 ( V_167 , L_24 , V_13 -> V_45 ) ;
return V_4 ;
}
...
int F_161 ( struct V_147 * V_173 )
{
V_173 -> V_146 . V_48 = & V_20 ;
return F_162 ( & V_173 -> V_146 ) ;
}
void F_163 ( struct V_147 * V_173 )
{
F_164 ( & V_173 -> V_146 ) ;
}
