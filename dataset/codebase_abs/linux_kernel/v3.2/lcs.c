...
V_256 = F_186 ( V_19 -> V_26 . V_77 ) ;
V_256 = F_186 ( V_19 -> V_27 . V_77 ) ;
if ( V_264 == V_166 ) {
V_19 -> V_15 = V_275 ;
}
if ( V_256 )
...
static T_3
F_201 ( struct V_281 * V_282 , const char * V_159 ,
T_4 V_33 )
{
int V_283 ;
V_283 = F_202 ( V_284 ,
...
goto V_265;
V_284 = F_204 ( L_139 ) ;
V_20 = F_125 ( V_284 ) ? F_126 ( V_284 ) : 0 ;
if ( V_20 )
goto V_288;
V_20 = F_205 ( & V_287 ) ;
if ( V_20 )
