...
static int T_6 F_170 ( struct V_119 * V_119 )
{
#ifdef F_171
int V_7 ;
V_7 = F_172 ( V_119 , & V_256 ) ;
if ( V_7 < 0 ) {
F_173 ( L_4 ) ;
goto V_257;
}
V_7 = F_174 ( V_119 , & V_258 ) ;
if ( V_7 < 0 ) {
F_173 ( L_5 ) ;
goto V_259;
}
...
static void F_176 ( struct V_119 * V_119 )
{
#ifdef F_171
F_177 ( V_119 , & V_258 ) ;
F_175 ( V_119 , & V_256 ) ;
...
static void T_7 F_178 ( struct V_260 * V_261 )
{
struct V_119 * V_119 ;
F_179 (net, net_exit_list, exit_list)
F_176 ( V_119 ) ;
}
