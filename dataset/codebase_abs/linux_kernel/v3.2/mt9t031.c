...
static T_3 F_17 ( T_2 * V_16 , T_2 V_17 , T_2 V_18 )
{
unsigned int V_19 ;
if ( * V_16 < V_17 + V_17 / 2 ) {
* V_16 = V_17 ;
...
V_19 = F_18 ( V_18 , * V_16 + V_17 / 2 ) / V_17 ;
if ( V_19 > 8 )
V_19 = 8 ;
* V_16 = V_17 * V_19 ;
return V_19 ;
...
struct V_20 * V_21 , T_3 V_22 , T_3 V_23 )
{
...
const T_3 V_26 = V_27 ,
V_28 = V_29 ;
V_24 = F_18 ( V_22 , ( T_3 ) 3 ) ;
V_25 = F_18 ( V_23 , ( T_3 ) 3 ) ;
switch ( V_24 ) {
case 1 :
V_21 -> V_30 &= ~ 1 ;
break;
...
break;
case 3 :
V_21 -> V_30 = V_21 -> V_30 > F_20 ( V_31 , 6 ) ?
( V_21 -> V_30 / 6 ) * 6 : F_20 ( V_31 , 6 ) ;
}
V_21 -> V_32 &= ~ 1 ;
F_21 ( & V_3 -> V_33 , L_1 ,
...
if ( V_7 < 0 )
return V_7 ;
V_7 = F_7 ( V_3 , V_36 , V_26 ) ;
if ( V_7 >= 0 )
V_7 = F_7 ( V_3 , V_37 , V_28 ) ;
...
V_21 -> V_30 , V_21 -> V_32 ) ;
if ( V_7 >= 0 )
V_7 = F_7 ( V_3 , V_40 , V_21 -> V_30 ) ;
if ( V_7 >= 0 )
V_7 = F_7 ( V_3 , V_41 , V_21 -> V_32 ) ;
if ( V_7 >= 0 )
V_7 = F_7 ( V_3 , V_42 , V_21 -> V_34 - 1 ) ;
if ( V_7 >= 0 )
V_7 = F_7 ( V_3 , V_43 ,
V_21 -> V_35 + V_1 -> V_44 - 1 ) ;
if ( V_7 >= 0 && F_22 ( V_1 -> V_45 ) == V_46 ) {
V_1 -> V_47 = V_21 -> V_35 + V_1 -> V_44 + V_28 ;
V_7 = F_11 ( V_3 , V_1 -> V_47 ) ;
}
if ( V_7 >= 0 )
V_7 = F_10 ( V_3 , V_11 , 1 ) ;
if ( V_7 >= 0 ) {
...
static int F_23 ( struct V_13 * V_14 , struct V_48 * V_49 )
{
struct V_20 V_21 = V_49 -> V_50 ;
struct V_2 * V_3 = F_16 ( V_14 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
V_21 . V_34 = F_24 ( V_21 . V_34 , 2 ) ;
V_21 . V_35 = F_24 ( V_21 . V_35 , 2 ) ;
F_25 ( & V_21 . V_30 , & V_21 . V_34 ,
V_31 , V_51 , V_52 ) ;
F_25 ( & V_21 . V_32 , & V_21 . V_35 ,
V_53 , V_54 , V_55 ) ;
return F_19 ( V_3 , & V_21 , V_1 -> V_22 , V_1 -> V_23 ) ;
}
static int F_26 ( struct V_13 * V_14 , struct V_48 * V_49 )
{
struct V_2 * V_3 = F_16 ( V_14 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
V_49 -> V_50 = V_1 -> V_21 ;
...
static int F_27 ( struct V_13 * V_14 , struct V_57 * V_49 )
{
V_49 -> V_58 . V_30 = V_31 ;
V_49 -> V_58 . V_32 = V_53 ;
V_49 -> V_58 . V_34 = V_52 ;
...
V_22 = F_17 ( & V_21 . V_34 , V_64 -> V_34 , V_52 ) ;
V_23 = F_17 ( & V_21 . V_35 , V_64 -> V_35 , V_55 ) ;
V_64 -> V_65 = V_66 ;
V_64 -> V_67 = V_68 ;
return F_19 ( V_3 , & V_21 , V_22 , V_23 ) ;
}
...
F_21 ( & V_3 -> V_33 , L_3 , V_6 ) ;
V_6 = F_7 ( V_3 , V_98 , V_6 ) ;
if ( V_6 < 0 )
return - V_12 ;
} else {
...
static int F_38 ( struct V_103 * V_33 )
{
struct V_104 * V_105 = F_39 ( V_33 ) ;
struct V_13 * V_14 = F_40 ( V_105 ) ;
struct V_2 * V_3 = F_16 ( V_14 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
int V_7 ;
T_3 V_24 , V_25 ;
V_24 = F_18 ( V_1 -> V_22 , ( T_3 ) 3 ) ;
V_25 = F_18 ( V_1 -> V_23 , ( T_3 ) 3 ) ;
V_7 = F_7 ( V_3 , V_38 ,
( ( V_24 - 1 ) << 4 ) | ( V_1 -> V_22 - 1 ) ) ;
if ( V_7 < 0 )
return V_7 ;
...
static int F_41 ( struct V_13 * V_14 , int V_106 )
{
struct V_2 * V_3 = F_16 ( V_14 ) ;
struct V_104 * V_105 = F_42 ( V_3 ) ;
if ( V_106 )
...
static int F_47 ( struct V_13 * V_14 , T_4 * V_111 )
{
struct V_2 * V_3 = F_16 ( V_14 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
* V_111 = V_1 -> V_44 ;
...
static int F_48 ( struct V_13 * V_14 , unsigned int V_112 ,
enum V_113 * V_65 )
{
if ( V_112 )
return - V_75 ;
