...
if ( V_101 -> V_66 != 0 )
return - V_27 ;
memcpy ( V_101 , & V_102 , sizeof( struct V_100 ) ) ;
return 0 ;
}
...
static int F_25 ( struct V_61 * V_61 , void * V_32 ,
struct V_103 * V_104 )
{
struct V_22 * V_2 = ( (struct V_31 * ) V_32 ) -> V_2 ;
struct V_1 * V_1 = (struct V_1 * ) V_2 -> V_24 ;
...
if ( V_104 -> type != V_105 )
return - V_27 ;
if ( F_26 ( V_1 -> V_106 ) >= 0x2623 ) {
V_104 -> V_107 = V_108 ;
V_104 -> V_109 [ 0 ] [ 23 ] = V_108 ;
}
return 0 ;
}
static int F_27 ( struct V_61 * V_61 , void * V_32 ,
struct V_110 * V_93 )
{
struct V_22 * V_2 = ( (struct V_31 * ) V_32 ) -> V_2 ;
struct V_1 * V_1 = (struct V_1 * ) V_2 -> V_24 ;
...
static T_5 F_30 ( struct V_61 * V_61 , const char T_6 * V_23 , T_7 V_121 , T_8 * V_122 )
{
struct V_31 * V_32 = V_61 -> V_119 ;
struct V_22 * V_2 = V_32 -> V_2 ;
struct V_1 * V_1 = (struct V_1 * ) V_2 -> V_24 ;
...
int V_124 ;
F_3 ( 2 , L_36 , V_120 ) ;
if ( F_26 ( V_1 -> V_106 ) < 0x2623 || ! V_1 -> V_113 || V_121 != sizeof V_123 )
return - V_27 ;
if ( F_31 ( & V_123 , V_23 , V_121 ) )
return - V_125 ;
...
memcpy ( V_47 , V_57 , sizeof( struct V_49 ) * 2 ) ;
F_35 ( V_1 -> V_2 , V_136 , 0x00000000 ) ;
F_35 ( V_1 -> V_2 , V_137 , 0x03000700 ) ;
F_35 ( V_1 -> V_2 , V_138 , ( V_139 | V_140 | V_141 | V_142 ) ) ;
return 0 ;
}
...
V_35 -> V_29 . F_27 = F_27 ;
V_35 -> V_29 . F_28 = F_28 ;
if ( F_39 ( & V_1 -> V_147 , V_2 , L_43 , V_148 ) ) {
F_38 ( L_44 ) ;
F_40 ( V_2 ) ;
return - V_130 ;
}
if ( F_39 ( & V_1 -> V_149 , V_2 , L_43 , V_150 ) )
F_38 ( L_45 ) ;
return 0 ;
}
...
{
struct V_22 * V_2 = V_1 -> V_2 ;
F_42 ( & V_1 -> V_147 , V_1 -> V_2 ) ;
F_42 ( & V_1 -> V_149 , V_1 -> V_2 ) ;
F_40 ( V_2 ) ;
return 0 ;
}
static int F_43 ( struct V_22 * V_2 , struct V_49 * V_151 )
{
struct V_1 * V_1 = (struct V_1 * ) V_2 -> V_24 ;
if ( V_151 -> V_126 & V_152 ) {
V_1 -> V_153 = V_154 ;
F_44 ( V_1 , V_1 -> V_153 ) ;
}
else if ( V_151 -> V_126 & V_155 ) {
V_1 -> V_153 = V_156 ;
F_44 ( V_1 , V_1 -> V_153 ) ;
}
else
