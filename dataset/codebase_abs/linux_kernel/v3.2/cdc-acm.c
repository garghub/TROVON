...
F_96 ( & V_1 -> V_81 ) ;
F_97 ( & V_1 -> V_96 ) ;
V_1 -> V_202 = F_98 ( V_143 , V_163 -> V_203 ) ;
V_1 -> V_204 = F_99 ( V_163 ) ;
if ( V_1 -> V_204 )
V_1 -> V_205 = V_163 -> V_205 ;
F_100 ( & V_1 -> V_58 ) ;
V_1 -> V_58 . V_206 = & V_207 ;
V_4 = F_84 ( V_143 , V_165 , V_99 , & V_1 -> V_208 ) ;
if ( ! V_4 ) {
F_13 ( & V_39 -> V_7 , L_47 ) ;
goto V_209;
}
...
for ( V_14 = 0 ; V_14 < V_19 ; V_14 ++ ) {
struct V_16 * V_216 = & ( V_1 -> V_17 [ V_14 ] ) ;
V_216 -> V_25 = F_101 ( 0 , V_99 ) ;
if ( V_216 -> V_25 == NULL ) {
F_13 ( & V_39 -> V_7 ,
L_53 ) ;
goto V_217;
...
if ( F_99 ( V_164 ) )
F_102 ( V_216 -> V_25 , V_143 ,
F_105 ( V_143 , V_164 -> V_203 ) ,
NULL , V_1 -> V_111 , F_37 , V_216 , V_164 -> V_205 ) ;
else
F_103 ( V_216 -> V_25 , V_143 ,
F_105 ( V_143 , V_164 -> V_203 ) ,
NULL , V_1 -> V_111 , F_37 , V_216 ) ;
V_216 -> V_25 -> V_214 |= V_215 ;
V_216 -> V_80 = V_1 ;
}
F_106 ( V_39 , V_1 ) ;
V_14 = F_107 ( & V_39 -> V_7 , & V_218 ) ;
if ( V_14 < 0 )
goto V_217;
if ( V_154 ) {
V_1 -> V_41 = F_108 ( V_154 -> V_219 - 4 , V_99 ) ;
if ( ! V_1 -> V_41 )
goto V_220;
V_1 -> V_42 = V_154 -> V_219 - 4 ;
memcpy ( V_1 -> V_41 , ( T_3 * ) & V_154 -> V_221 ,
V_154 -> V_219 - 4 ) ;
V_1 -> V_43 = V_154 -> V_222 ;
V_14 = F_107 ( & V_39 -> V_7 , & V_223 ) ;
if ( V_14 < 0 ) {
F_54 ( V_1 -> V_41 ) ;
goto V_220;
}
...
F_110 ( V_143 , V_162 -> V_203 ) ,
V_1 -> V_210 , V_165 , F_23 , V_1 ,
V_162 -> V_205 ? V_162 -> V_205 : 0xff ) ;
V_1 -> V_98 -> V_214 |= V_215 ;
V_1 -> V_98 -> V_27 = V_1 -> V_208 ;
F_111 ( & V_39 -> V_7 , L_54 , V_108 ) ;
F_48 ( V_1 , V_1 -> V_101 ) ;
V_1 -> line . V_130 = F_75 ( 9600 ) ;
V_1 -> line . V_138 = 8 ;
F_78 ( V_1 , & V_1 -> line ) ;
F_112 ( & V_225 , V_160 , V_1 ) ;
F_106 ( V_160 , V_1 ) ;
F_113 ( V_159 ) ;
...
F_79 ( V_1 ) ;
V_211:
F_81 ( V_143 , V_165 , V_1 -> V_210 , V_1 -> V_208 ) ;
V_209:
F_54 ( V_1 ) ;
V_201:
return - V_148 ;
...
F_109 ( & V_1 -> V_9 -> V_7 , & V_218 ) ;
V_1 -> V_7 = NULL ;
F_106 ( V_1 -> V_9 , NULL ) ;
F_106 ( V_1 -> V_31 , NULL ) ;
F_115 ( V_1 ) ;
F_79 ( V_1 ) ;
F_81 ( V_143 , V_1 -> V_165 , V_1 -> V_210 ,
V_1 -> V_208 ) ;
F_82 ( V_1 ) ;
if ( ! V_1 -> V_172 )
F_118 ( & V_225 , V_39 == V_1 -> V_9 ?
V_1 -> V_31 : V_1 -> V_9 ) ;
if ( V_1 -> V_58 . V_97 == 0 ) {
F_50 ( V_1 ) ;
F_46 ( & V_89 ) ;
...
static int F_119 ( struct V_38 * V_39 , T_4 V_226 )
{
struct V_1 * V_1 = F_20 ( V_39 ) ;
int V_227 ;
if ( F_120 ( V_226 ) ) {
...
static int F_124 ( struct V_38 * V_39 )
{
struct V_1 * V_1 = F_20 ( V_39 ) ;
struct V_47 * V_48 ;
F_43 ( & V_1 -> V_96 ) ;
...
V_107 -> type = V_238 ,
V_107 -> V_239 = V_240 ,
V_107 -> V_21 = V_241 | V_242 ;
V_107 -> V_243 = V_244 ;
V_107 -> V_243 . V_132 = V_245 | V_246 | V_247 |
V_248 | V_141 ;
F_127 ( V_107 , & V_249 ) ;
V_6 = F_128 ( V_107 ) ;
if ( V_6 ) {
...
F_132 (KERN_INFO KBUILD_MODNAME L_57 DRIVER_DESC L_58 ) ;
return 0 ;
}
