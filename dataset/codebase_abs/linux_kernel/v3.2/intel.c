...
if ( V_2 -> V_8 < 4 )
return 1 ;
F_40 ( 4 , 0 , & V_51 , & V_52 , & V_53 , & V_54 ) ;
if ( V_51 & 0x1f )
return ( V_51 >> 26 ) + 1 ;
else
return 1 ;
}
static void T_1 F_41 ( struct V_1 * V_2 )
{
#define F_42 0x00200000
#define F_43 0x00400000
#define F_44 0x80000000
#define F_45 0x00000001
#define F_46 0x00000002
#define F_47 0x00000020
...
static void T_1 F_48 ( struct V_1 * V_2 )
{
unsigned int V_66 = 0 ;
F_1 ( V_2 ) ;
F_26 ( V_2 ) ;
...
static unsigned int T_1 F_54 ( struct V_1 * V_2 , unsigned int V_89 )
{
