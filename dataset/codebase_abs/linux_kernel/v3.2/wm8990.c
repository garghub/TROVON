...
static int F_29 ( struct V_1 * V_2 , T_4 V_151 )
{
F_25 ( V_2 , V_134 ) ;
return 0 ;
}
...
static T_5 int F_36 ( struct V_162 * V_163 ,
const struct V_164 * V_165 )
{
struct V_72 * V_73 ;
int V_12 ;
V_73 = F_37 ( sizeof( struct V_72 ) , V_166 ) ;
if ( V_73 == NULL )
return - V_167 ;
F_38 ( V_163 , V_73 ) ;
V_12 = F_39 ( & V_163 -> V_135 ,
& V_168 , & V_169 , 1 ) ;
if ( V_12 < 0 )
F_40 ( V_73 ) ;
return V_12 ;
}
static T_6 int F_41 ( struct V_162 * V_170 )
{
F_42 ( & V_170 -> V_135 ) ;
F_40 ( F_43 ( V_170 ) ) ;
return 0 ;
