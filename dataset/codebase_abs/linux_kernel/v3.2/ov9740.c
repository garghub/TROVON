...
F_29 ( & V_2 -> V_14 , L_7
L_8 ,
V_26 -> V_113 , V_26 -> V_103 , V_26 -> V_116 , V_26 -> V_118 ) ;
V_111:
return V_5 ;
}
...
{
struct V_1 * V_2 = F_9 ( V_23 ) ;
struct V_123 * V_124 = F_31 ( V_2 ) ;
V_122 -> V_9 = V_125 | V_126 |
V_127 | V_128 |
V_129 ;
V_122 -> type = V_130 ;
V_122 -> V_9 = F_32 ( V_124 , V_122 ) ;
return 0 ;
}
...
V_26 = F_34 ( sizeof( struct V_25 ) , V_133 ) ;
if ( ! V_26 ) {
F_4 ( & V_2 -> V_14 , L_10 ) ;
return - V_134 ;
}
F_35 ( & V_26 -> V_135 , V_2 , & V_136 ) ;
F_36 ( & V_26 -> V_97 , 13 ) ;
F_37 ( & V_26 -> V_97 , & V_137 ,
V_99 , 0 , 1 , 1 , 0 ) ;
F_37 ( & V_26 -> V_97 , & V_137 ,
V_100 , 0 , 1 , 1 , 0 ) ;
V_26 -> V_135 . V_138 = & V_26 -> V_97 ;
if ( V_26 -> V_97 . error ) {
int V_111 = V_26 -> V_97 . error ;
F_38 ( V_26 ) ;
return V_111 ;
}
V_5 = F_27 ( V_2 ) ;
