...
* V_15 ++ = ( T_1 ) ( V_53 >> 8 ) ;
* V_15 ++ = ( T_1 ) V_53 ;
* V_15 ++ = ( F_18 ( 0 , & V_6 -> V_5 [ 1 ] , 5 ) << 1 ) | 0x01 ;
...
V_28 -> V_61 = & V_52 -> V_74 ;
if ( V_71 )
V_28 -> V_63 = V_71 + F_22 ( struct V_52 , V_74 ) ;
F_20 ( V_28 , & V_2 -> V_60 ) ;
}
V_28 = & V_2 -> V_28 ;
memset ( V_28 , 0 , sizeof( * V_28 ) ) ;
...
V_28 -> V_61 = & V_52 -> V_80 ;
if ( V_71 )
V_28 -> V_63 = V_71 + F_22 ( struct V_52 , V_80 ) ;
} else {
V_28 -> V_61 = V_2 -> V_77 ;
V_28 -> V_63 = V_2 -> V_78 ;
V_28 -> V_62 = & V_52 -> V_80 ;
if ( V_71 )
V_28 -> V_64 = V_71 + F_22 ( struct V_52 , V_80 ) ;
}
F_20 ( V_28 , & V_2 -> V_60 ) ;
if ( V_68 || V_70 == V_72 ) {
V_28 = & V_2 -> V_81 ;
...
V_28 -> V_62 = V_52 -> V_5 ;
if ( V_71 )
V_28 -> V_64 = V_71 + F_22 ( struct V_52 , V_5 ) ;
V_28 -> V_65 = 1 ;
F_20 ( V_28 , & V_2 -> V_60 ) ;
}
}
static int
F_23 ( struct V_1 * V_2 , struct V_54 * V_28 ,
unsigned long V_12 )
{
...
static int
F_26 ( struct V_1 * V_2 , struct V_54 * V_28 ,
unsigned long V_12 )
{
struct V_82 * V_3 = V_2 -> V_3 ;
int V_5 ;
...
if ( V_2 -> V_84 -> V_85 ) {
T_4 V_79 = F_25 ( 0 , V_28 -> V_62 , V_28 -> V_4 ) ;
F_27 ( & V_52 -> V_80 ) ;
if ( V_52 -> V_80 != V_79 ) {
F_16 ( & V_3 -> V_48 , L_14
L_15 ,
...
static void
F_28 ( struct V_1 * V_2 , struct V_20 * V_21 ,
struct V_92 * V_6 , T_2 V_93 )
{
struct V_82 * V_3 = V_2 -> V_3 ;
...
V_12 = F_29 ( ( unsigned int ) ( V_12 / 1000 ) ) + 1 ;
...
V_28 -> V_4 ) ;
if ( V_70 == V_72 )
V_5 = F_23 ( V_2 , V_28 , V_12 ) ;
else
V_5 = F_26 ( V_2 , V_28 , V_12 ) ;
if ( V_5 < 0 )
break;
V_6 -> V_111 += V_28 -> V_4 ;
V_107 -= V_28 -> V_4 ;
...
static void F_39 ( struct V_117 * V_84 , struct V_50 * V_51 )
{
struct V_1 * V_2 = F_40 ( V_84 ) ;
int V_5 = - V_49 ;
int V_118 = 5 ;
struct V_20 V_119 ;
#ifdef F_41
...
if ( V_5 == 0 && V_51 -> V_6 ) {
F_28 ( V_2 , V_51 -> V_21 , V_51 -> V_6 , V_51 -> V_6 -> V_123 ) ;
...
static void F_50 ( struct V_117 * V_84 , struct V_133 * V_134 )
{
struct V_1 * V_2 = F_40 ( V_84 ) ;
...
static int F_53 ( struct V_117 * V_84 )
{
struct V_1 * V_2 = F_40 ( V_84 ) ;
if ( V_2 -> V_136 && V_2 -> V_136 -> V_144 )
return ! ! V_2 -> V_136 -> V_144 ( V_84 -> V_145 ) ;
return - V_42 ;
}
static int F_54 ( struct V_117 * V_84 )
{
struct V_1 * V_2 = F_40 ( V_84 ) ;
if ( V_2 -> V_136 && V_2 -> V_136 -> V_146 )
return ! ! V_2 -> V_136 -> V_146 ( V_84 -> V_145 ) ;
return - V_42 ;
}
static T_5
F_55 ( int V_147 , void * V_84 )
{
struct V_1 * V_2 = F_40 ( V_84 ) ;
T_4 V_148 = F_56 ( V_2 -> V_136 -> V_149 , ( T_4 ) 100 ) ;
F_57 ( V_84 , F_58 ( V_148 ) ) ;
return V_150 ;
}
static int F_59 ( struct V_82 * V_3 )
{
void * V_77 ;
struct V_117 * V_84 ;
struct V_1 * V_2 ;
int V_5 ;
if ( V_3 -> V_121 -> V_55 & V_151 )
return - V_49 ;
if ( V_3 -> V_127 != V_152 )
V_3 -> V_127 = V_153 ;
V_3 -> V_154 = 8 ;
...
V_5 = - V_155 ;
V_77 = F_60 ( V_156 , V_157 ) ;
if ( ! V_77 )
goto V_158;
memset ( V_77 , 0xff , V_156 ) ;
V_84 = F_61 ( sizeof( * V_2 ) , & V_3 -> V_48 ) ;
if ( ! V_84 )
goto V_158;
V_84 -> V_159 = & V_160 ;
V_84 -> V_161 = V_156 ;
V_84 -> V_162 = V_163 ;
V_84 -> V_164 = V_163 * V_156 ;
V_84 -> V_165 = V_163 ;
V_84 -> V_166 = V_167 ;
V_84 -> V_168 = 400000 ;
V_84 -> V_169 = V_3 -> V_101 ;
V_2 = F_40 ( V_84 ) ;
V_2 -> V_84 = V_84 ;
V_2 -> V_3 = V_3 ;
V_2 -> V_77 = V_77 ;
V_2 -> V_136 = F_62 ( V_3 ) ;
if ( V_2 -> V_136 )
V_84 -> V_170 = V_2 -> V_136 -> V_171 ;
if ( ! V_84 -> V_170 ) {
F_47 ( & V_3 -> V_48 , L_37 ) ;
V_84 -> V_170 = V_172 | V_173 ;
}
...
F_63 ( & V_3 -> V_48 , V_84 ) ;
V_2 -> V_6 = F_60 ( sizeof( * V_2 -> V_6 ) , V_157 ) ;
if ( ! V_2 -> V_6 )
goto V_174;
if ( V_3 -> V_121 -> V_48 . V_145 -> V_175 ) {
struct V_94 * V_48 = V_3 -> V_121 -> V_48 . V_145 ;
V_2 -> V_8 = V_48 ;
V_2 -> V_78 = F_64 ( V_48 , V_77 ,
V_156 , V_72 ) ;
V_2 -> V_9 = F_64 ( V_48 , V_2 -> V_6 ,
sizeof( * V_2 -> V_6 ) , V_67 ) ;
F_7 ( V_2 -> V_8 ,
V_2 -> V_9 , sizeof( * V_2 -> V_6 ) ,
V_67 ) ;
...
F_20 ( & V_2 -> V_5 , & V_2 -> V_11 ) ;
V_2 -> V_5 . V_61 = V_2 -> V_77 ;
V_2 -> V_5 . V_63 = V_2 -> V_78 ;
V_2 -> V_5 . V_62 = & V_2 -> V_6 -> V_5 ;
V_2 -> V_5 . V_64 = V_2 -> V_9 + F_22 ( struct V_52 , V_5 ) ;
V_2 -> V_5 . V_65 = 1 ;
if ( V_2 -> V_136 && V_2 -> V_136 -> V_176 ) {
V_5 = V_2 -> V_136 -> V_176 ( & V_3 -> V_48 , F_55 , V_84 ) ;
if ( V_5 != 0 )
goto V_177;
}
if ( V_2 -> V_136 )
V_84 -> V_166 |= V_2 -> V_136 -> V_166 ;
V_5 = F_65 ( V_84 ) ;
if ( V_5 != 0 )
goto V_178;
F_66 ( & V_3 -> V_48 , L_38 ,
...
static int T_6 F_73 ( struct V_82 * V_3 )
{
struct V_117 * V_84 = F_74 ( & V_3 -> V_48 ) ;
struct V_1 * V_2 ;
if ( V_84 ) {
V_2 = F_40 ( V_84 ) ;
