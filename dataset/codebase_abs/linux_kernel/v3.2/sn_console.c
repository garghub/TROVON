...
F_61 ( & V_14 . V_32 . V_40 ) ;
V_14 . V_32 . V_93 = ( char * ) 1 ;
V_14 . V_32 . type = V_94 ;
V_14 . V_32 . V_95 = V_96 ;
V_14 . V_32 . V_97 = & V_98 ;
V_14 . V_32 . line = 0 ;
if ( F_62 ( & V_88 , & V_14 . V_32 ) < 0 ) {
F_31 ( V_31 L_16 , V_99 ) ;
}
if ( ! V_14 . V_56 ) {
F_51 ( & V_14 ) ;
...
const char * V_5 , int V_100 )
{
const char * V_101 ;
while ( ( V_101 = memchr ( V_5 , '\n' , V_100 ) ) != NULL ) {
F_69 ( V_5 , V_101 - V_5 ) ;
F_69 ( L_17 , 2 ) ;
V_100 -= V_101 + 1 - V_5 ;
V_5 = V_101 + 1 ;
...
static void
F_70 ( struct V_102 * V_103 , const char * V_5 , unsigned V_100 )
{
...
F_40 ( ! V_8 -> V_56 ) ;
if ( ! V_8 -> V_32 . V_33 ) {
F_68 ( V_8 -> V_15 -> V_27 , V_5 , V_100 ) ;
return;
}
if ( F_71 ( & V_8 -> V_32 . V_40 ) ) {
int V_105 = V_8 -> V_32 . V_33 -> V_55 . V_49 ;
int V_106 = V_8 -> V_32 . V_33 -> V_55 . V_48 ;
int V_107 , V_108 = 0 ;
for ( V_107 = 0 ; V_107 < 150 ; F_72 ( 125 ) , V_107 ++ ) {
if ( ! F_71 ( & V_8 -> V_32 . V_40 )
|| V_104 ) {
if ( ! V_104 ) {
F_36 ( & V_8 -> V_32 . V_40 ,
...
if ( ( V_105 != V_8 -> V_32 . V_33 -> V_55 . V_49 )
|| ( V_106 !=
...
static int F_73 ( struct V_102 * V_103 , char * V_109 )
{
return 0 ;
}
static void T_3
F_74 ( struct V_102 * V_103 , const char * V_5 , unsigned V_100 )
{
F_68 ( V_14 . V_15 -> V_27 , V_5 , V_100 ) ;
}
int T_3 F_75 ( void )
{
if ( ! F_58 ( L_11 ) )
