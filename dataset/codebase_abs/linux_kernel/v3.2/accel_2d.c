...
V_88 , V_89 , V_38 ,
V_88 , V_89 , V_41 ,
V_74 -> V_100 , V_74 -> V_101 , V_74 -> V_102 , V_74 -> V_103 , V_74 -> V_104 , V_74 -> V_105 ) ;
F_16 ( V_82 ) ;
}
void F_17 ( struct V_71 * V_72 ,
const struct V_73 * V_106 )
{
if ( F_18 ( V_72 -> V_107 != V_108 ) )
return;
if ( V_106 -> V_104 == 8 || V_106 -> V_105 == 8 ||
( V_72 -> V_27 & V_109 ) )
return F_14 ( V_72 , V_106 ) ;
F_13 ( V_72 , V_106 ) ;
}
...
int F_22 ( struct V_81 * V_82 , void * V_118 , struct V_119 * V_120 )
{
struct V_1 * V_2 = V_82 -> V_87 ;
...
if ( V_122 -> V_16 > V_133 )
return - V_129 ;
V_126 = F_23 ( V_82 , V_120 , V_122 -> V_134 ) ;
if ( V_126 == NULL )
return - V_135 ;
