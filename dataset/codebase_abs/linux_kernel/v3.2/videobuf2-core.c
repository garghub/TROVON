...
V_5 = F_2 ( V_4 , V_6 , V_8 , V_4 -> V_9 [ V_6 ] ,
V_4 -> V_10 [ V_6 ] ) ;
if ( F_3 ( V_5 ) )
goto free;
...
free:
for (; V_6 > 0 ; -- V_6 )
F_2 ( V_4 , V_6 , V_14 , V_2 -> V_11 [ V_6 - 1 ] . V_5 ) ;
return - V_15 ;
}
...
unsigned int V_6 ;
for ( V_6 = 0 ; V_6 < V_2 -> V_7 ; ++ V_6 ) {
F_2 ( V_4 , V_6 , V_14 , V_2 -> V_11 [ V_6 ] . V_5 ) ;
...
if ( V_84 > V_2 -> V_7 )
return NULL ;
return F_2 ( V_4 , V_84 , V_85 , V_2 -> V_11 [ V_84 ] . V_5 ) ;
}
...
if ( V_84 > V_2 -> V_7 )
return NULL ;
return F_2 ( V_4 , V_84 , V_86 , V_2 -> V_11 [ V_84 ] . V_5 ) ;
}
...
return V_30 ;
for ( V_6 = 0 ; V_6 < V_2 -> V_7 ; ++ V_6 ) {
if ( V_2 -> V_12 [ V_6 ] . V_26 . V_51 == V_11 [ V_6 ] . V_26 . V_51
...
static int F_45 ( struct V_1 * V_2 , const struct V_41 * V_42 )
{
struct V_3 * V_4 = V_2 -> V_3 ;
int V_30 ;
switch ( V_4 -> V_29 ) {
...
int F_48 ( struct V_3 * V_4 , struct V_41 * V_42 )
{
struct V_1 * V_2 ;
int V_30 ;
if ( V_4 -> V_73 ) {
...
static int F_49 ( struct V_3 * V_4 , int V_101 )
{
for (; ; ) {
int V_30 ;
if ( ! V_4 -> V_75 ) {
...
return V_30 ;
F_32 ( & V_4 -> V_88 , V_52 ) ;
* V_2 = F_53 ( & V_4 -> V_90 , struct V_1 , V_89 ) ;
F_54 ( & ( * V_2 ) -> V_89 ) ;
F_35 ( & V_4 -> V_88 , V_52 ) ;
return 0 ;
}
...
F_56 ( V_4 -> V_92 , ! F_57 ( & V_4 -> V_91 ) ) ;
return 0 ;
}
int F_58 ( struct V_3 * V_4 , struct V_41 * V_42 , bool V_101 )
{
struct V_1 * V_2 = NULL ;
int V_30 ;
if ( V_4 -> V_73 ) {
...
V_30 = F_52 ( V_4 , & V_2 , V_101 ) ;
if ( V_30 < 0 ) {
F_5 ( 1 , L_56 ) ;
return V_30 ;
}
V_30 = F_13 ( V_4 , V_105 , V_2 ) ;
if ( V_30 ) {
F_5 ( 1 , L_57 ) ;
return V_30 ;
}
...
F_60 ( & V_4 -> V_91 , 0 ) ;
F_61 ( & V_4 -> V_92 ) ;
for ( V_106 = 0 ; V_106 < V_4 -> V_22 ; ++ V_106 )
V_4 -> V_25 [ V_106 ] -> V_33 = V_34 ;
}
int F_62 ( struct V_3 * V_4 , enum V_108 type )
{
struct V_1 * V_2 ;
int V_30 ;
if ( V_4 -> V_73 ) {
...
F_63 (vb, &q->queued_list, queued_entry)
F_43 ( V_2 ) ;
V_30 = F_13 ( V_4 , V_109 , V_4 , F_57 ( & V_4 -> V_91 ) ) ;
if ( V_30 ) {
F_5 ( 1 , L_65 ) ;
F_59 ( V_4 ) ;
return V_30 ;
...
int F_64 ( struct V_3 * V_4 , enum V_108 type )
{
if ( V_4 -> V_73 ) {
F_5 ( 1 , L_67 ) ;
return - V_74 ;
...
static int F_65 ( struct V_3 * V_4 , unsigned long V_21 ,
...
int F_66 ( struct V_3 * V_4 , struct V_112 * V_113 )
{
unsigned long V_21 = V_113 -> V_114 << V_115 ;
struct V_116 * V_117 ;
struct V_1 * V_2 ;
unsigned int V_20 , V_6 ;
int V_30 ;
...
if ( ! ( V_113 -> V_118 & V_121 ) ) {
F_5 ( 1 , L_74 ) ;
return - V_43 ;
}
}
V_30 = F_65 ( V_4 , V_21 , & V_20 , & V_6 ) ;
if ( V_30 )
return V_30 ;
V_2 = V_4 -> V_25 [ V_20 ] ;
V_117 = & V_2 -> V_11 [ V_6 ] ;
V_30 = V_4 -> V_66 -> V_69 ( V_117 -> V_5 , V_113 ) ;
if ( V_30 )
return V_30 ;
F_5 ( 3 , L_75 , V_20 , V_6 ) ;
return 0 ;
}
unsigned long F_67 ( struct V_3 * V_4 ,
unsigned long V_122 ,
unsigned long V_123 ,
unsigned long V_124 ,
unsigned long V_52 )
{
unsigned long V_21 = V_124 << V_115 ;
struct V_1 * V_2 ;
unsigned int V_20 , V_6 ;
int V_30 ;
if ( V_4 -> V_29 != V_35 ) {
...
unsigned int F_68 ( struct V_3 * V_4 , struct V_125 * V_125 , T_1 * V_126 )
{
unsigned long V_52 ;
unsigned int V_30 ;
struct V_1 * V_2 = NULL ;
if ( V_4 -> V_22 == 0 && V_4 -> V_73 == NULL ) {
if ( ! F_38 ( V_4 -> type ) && ( V_4 -> V_64 & V_127 ) ) {
V_30 = F_69 ( V_4 , 1 ) ;
if ( V_30 )
return V_128 ;
}
if ( F_38 ( V_4 -> type ) && ( V_4 -> V_64 & V_129 ) ) {
V_30 = F_69 ( V_4 , 0 ) ;
if ( V_30 )
return V_128 ;
return V_130 | V_131 ;
...
if ( F_50 ( & V_4 -> V_40 ) )
return V_128 ;
F_70 ( V_125 , & V_4 -> V_92 , V_126 ) ;
F_32 ( & V_4 -> V_88 , V_52 ) ;
if ( ! F_50 ( & V_4 -> V_90 ) )
V_2 = F_53 ( & V_4 -> V_90 , struct V_1 ,
V_89 ) ;
F_35 ( & V_4 -> V_88 , V_52 ) ;
if ( V_2 && ( V_2 -> V_33 == V_59
|| V_2 -> V_33 == V_57 ) ) {
return ( F_38 ( V_4 -> type ) ) ? V_130 | V_131 :
V_132 | V_133 ;
}
return 0 ;
}
...
static int F_69 ( struct V_3 * V_4 , int V_134 )
{
struct V_135 * V_73 ;
int V_106 , V_30 ;
unsigned int V_76 = 0 ;
if ( ( V_134 && ! ( V_4 -> V_64 & V_127 ) ) ||
( ! V_134 && ! ( V_4 -> V_64 & V_129 ) ) )
F_77 () ;
if ( ! V_4 -> V_66 -> V_85 )
return - V_74 ;
...
V_76 = 1 ;
F_5 ( 3 , L_76 ,
( V_134 ) ? L_77 : L_78 , V_76 , V_4 -> V_136 ) ;
V_73 = F_10 ( sizeof( struct V_135 ) , V_32 ) ;
if ( V_73 == NULL )
return - V_15 ;
V_73 -> V_52 = V_4 -> V_136 ;
V_73 -> V_71 . V_76 = V_76 ;
...
for ( V_106 = 0 ; V_106 < V_4 -> V_22 ; V_106 ++ ) {
V_73 -> V_25 [ V_106 ] . V_85 = F_29 ( V_4 -> V_25 [ V_106 ] , 0 ) ;
if ( V_73 -> V_25 [ V_106 ] . V_85 == NULL )
goto V_138;
V_73 -> V_25 [ V_106 ] . V_139 = F_78 ( V_4 -> V_25 [ V_106 ] , 0 ) ;
}
if ( V_134 ) {
for ( V_106 = 0 ; V_106 < V_4 -> V_22 ; V_106 ++ ) {
...
if ( V_30 )
goto V_138;
V_73 -> V_25 [ V_106 ] . V_140 = 1 ;
}
V_30 = F_62 ( V_4 , V_4 -> type ) ;
if ( V_30 )
goto V_138;
}
V_4 -> V_73 = V_73 ;
...
static T_2 F_79 ( struct V_3 * V_4 , char T_3 * V_141 , T_2 V_76 ,
T_4 * V_142 , int V_143 , int V_134 )
{
struct V_135 * V_73 ;
struct V_144 * V_145 ;
int V_30 , V_17 ;
F_5 ( 3 , L_80 ,
V_134 ? L_77 : L_78 , ( long ) * V_142 , V_76 ,
V_143 ? L_81 : L_82 ) ;
if ( ! V_141 )
return - V_43 ;
if ( ! V_4 -> V_73 ) {
...
V_73 -> V_42 . V_17 = V_17 ;
V_30 = F_58 ( V_4 , & V_73 -> V_42 , V_143 ) ;
F_5 ( 5 , L_84 , V_30 ) ;
if ( V_30 )
goto V_146;
V_73 -> V_147 += 1 ;
V_2 = V_4 -> V_25 [ V_17 ] ;
V_145 -> V_139 = F_80 ( V_2 , 0 ) ;
V_145 -> V_140 = 0 ;
}
if ( V_145 -> V_148 + V_76 > V_145 -> V_139 ) {
V_76 = V_145 -> V_139 - V_145 -> V_148 ;
F_5 ( 5 , L_85 , V_76 ) ;
}
F_5 ( 3 , L_86 ,
V_76 , V_17 , V_145 -> V_148 ) ;
if ( V_134 )
V_30 = F_81 ( V_141 , V_145 -> V_85 + V_145 -> V_148 , V_76 ) ;
else
V_30 = F_82 ( V_145 -> V_85 + V_145 -> V_148 , V_141 , V_76 ) ;
if ( V_30 ) {
F_5 ( 3 , L_87 ) ;
V_30 = - V_149 ;
goto V_146;
...
V_145 -> V_148 += V_76 ;
* V_142 += V_76 ;
if ( V_145 -> V_148 == V_145 -> V_139 ||
( ! V_134 && ( V_73 -> V_52 & V_150 ) ) ) {
if ( V_134 && ( V_73 -> V_52 & V_151 ) &&
V_73 -> V_147 == 1 ) {
F_5 ( 3 , L_88 ) ;
V_4 -> V_73 = V_73 ;
return F_76 ( V_4 ) ;
...
V_73 -> V_42 . V_29 = V_4 -> V_29 ;
V_73 -> V_42 . V_17 = V_17 ;
V_73 -> V_42 . V_48 = V_145 -> V_148 ;
V_30 = F_48 ( V_4 , & V_73 -> V_42 ) ;
F_5 ( 5 , L_89 , V_30 ) ;
if ( V_30 )
goto V_146;
V_145 -> V_148 = 0 ;
V_145 -> V_140 = 1 ;
V_145 -> V_139 = V_4 -> V_25 [ 0 ] -> V_12 [ 0 ] . V_13 ;
V_73 -> V_152 += 1 ;
...
T_2 F_83 ( struct V_3 * V_4 , char T_3 * V_141 , T_2 V_76 ,
T_4 * V_142 , int V_101 )
{
return F_79 ( V_4 , V_141 , V_76 , V_142 , V_101 , 1 ) ;
}
T_2 F_84 ( struct V_3 * V_4 , char T_3 * V_141 , T_2 V_76 ,
T_4 * V_142 , int V_101 )
{
return F_79 ( V_4 , V_141 , V_76 , V_142 , V_101 , 0 ) ;
}
