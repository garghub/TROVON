...
if ( F_71 ( V_4 ) && V_4 -> V_9 -> V_30 . V_120 )
F_64 ( V_4 , 0 ) ;
}
static void
F_72 ( struct V_3 * V_4 , enum V_96 V_96 )
{
int V_38 ;
F_14 ( V_4 , 0 ) ;
V_4 -> V_9 -> V_46 = 255 ;
...
static void
F_74 ( struct V_3 * V_4 , enum V_96 V_96 )
{
struct V_88 * V_88 ;
V_88 = (struct V_88 * ) & V_131 . V_88 ;
if ( F_65 ( & V_88 -> V_42 ) ==
...
static void
F_87 ( struct V_3 * V_4 , enum V_96 V_96 )
{
F_88 ( V_4 ) ;
V_4 -> V_9 -> V_29 = V_87 ;
F_12 ( V_4 , V_96 ) ;
