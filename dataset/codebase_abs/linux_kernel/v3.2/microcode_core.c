...
static int F_33 ( struct V_38 * V_50 )
{
int V_4 , V_8 = V_50 -> V_42 ;
if ( ! F_25 ( V_8 ) )
return 0 ;
F_30 ( L_6 , V_8 ) ;
V_4 = F_34 ( & V_50 -> V_51 , & V_52 ) ;
if ( V_4 )
return V_4 ;
if ( F_31 ( V_8 ) == V_21 ) {
F_35 ( & V_50 -> V_51 , & V_52 ) ;
...
static int F_36 ( struct V_38 * V_50 )
{
int V_8 = V_50 -> V_42 ;
if ( ! F_25 ( V_8 ) )
return 0 ;
...
static T_7 int
F_38 ( struct V_53 * V_54 , unsigned long V_55 , void * V_56 )
{
unsigned int V_8 = ( unsigned long ) V_56 ;
struct V_38 * V_50 ;
V_50 = F_39 ( V_8 ) ;
switch ( V_55 ) {
case V_57 :
