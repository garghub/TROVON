...
V_47 = - V_166 ;
if ( V_83 -> V_167 & V_168 && ! F_75 ( V_2 , V_169 ) )
goto V_155;
...
static void F_84 ( struct V_1 * V_2 , long V_175 )
{
F_85 ( V_2 , 0 , NULL ) ;
F_86 ( V_2 ) ;
}
...
static int F_88 ( struct V_1 * V_2 , struct V_176 * V_177 , int V_178 )
{
struct V_20 * V_21 = F_2 ( V_2 ) ;
...
goto V_36;
V_180 = F_89 ( F_6 ( V_2 ) , V_146 -> V_143 . V_144 ) ;
V_179 = - V_182 ;
...
static int F_91 ( struct V_121 * V_122 , struct V_1 * V_2 , struct V_108 * V_109 ,
...
* V_178 = sizeof( * sin ) ;
if ( V_81 & V_188 ) {
V_47 = F_92 ( V_2 , V_109 , V_123 ) ;
goto V_36;
}
V_27 = F_93 ( V_2 , V_81 , V_186 , & V_47 ) ;
if ( ! V_27 )
goto V_36;
V_187 = V_27 -> V_123 ;
if ( V_123 < V_187 ) {
...
V_47 = F_94 ( V_27 , 0 , V_109 -> V_114 , V_187 ) ;
if ( V_47 )
goto V_155;
F_95 ( V_109 , V_2 , V_27 ) ;
if ( sin ) {
...
static int F_99 ( struct V_1 * V_2 , char T_7 * V_195 , int V_154 )
{
if ( V_154 > sizeof( struct F_13 ) )
V_154 = sizeof( struct F_13 ) ;
if ( F_100 ( & F_16 ( V_2 ) -> V_30 , V_195 , V_154 ) )
return - V_97 ;
return 0 ;
}
static int F_101 ( struct V_1 * V_2 , char T_7 * V_195 , int T_7 * V_154 )
{
...
V_179 = - V_97 ;
if ( F_102 ( V_123 , V_154 ) ||
F_103 ( V_195 , & F_16 ( V_2 ) -> V_30 , V_123 ) )
goto V_36;
V_179 = 0 ;
V_36: return V_179 ;
}
...
return F_99 ( V_2 , V_195 , V_154 ) ;
}
return - V_199 ;
}
static int F_105 ( struct V_1 * V_2 , int V_196 , int V_197 ,
char T_7 * V_195 , unsigned int V_154 )
{
if ( V_196 != V_200 )
return F_106 ( V_2 , V_196 , V_197 , V_195 , V_154 ) ;
return F_104 ( V_2 , V_196 , V_197 , V_195 , V_154 ) ;
}
static int F_107 ( struct V_1 * V_2 , int V_196 , int V_197 ,
char T_7 * V_195 , unsigned int V_154 )
{
if ( V_196 != V_200 )
...
return F_101 ( V_2 , V_195 , V_154 ) ;
}
return - V_199 ;
}
static int F_110 ( struct V_1 * V_2 , int V_196 , int V_197 ,
char T_7 * V_195 , int T_7 * V_154 )
{
if ( V_196 != V_200 )
return F_111 ( V_2 , V_196 , V_197 , V_195 , V_154 ) ;
return F_109 ( V_2 , V_196 , V_197 , V_195 , V_154 ) ;
}
static int F_112 ( struct V_1 * V_2 , int V_196 , int V_197 ,
char T_7 * V_195 , int T_7 * V_154 )
{
if ( V_196 != V_200 )
return F_113 ( V_2 , V_196 , V_197 , V_195 , V_154 ) ;
return F_109 ( V_2 , V_196 , V_197 , V_195 , V_154 ) ;
}
static int F_114 ( struct V_1 * V_2 , int V_201 , unsigned long V_202 )
{
switch ( V_201 ) {
case V_203 : {
int V_204 = F_115 ( V_2 ) ;
return F_102 ( V_204 , ( int T_7 * ) V_202 ) ;
}
case V_205 : {
struct V_26 * V_27 ;
int V_204 = 0 ;
F_116 ( & V_2 -> V_206 . V_12 ) ;
V_27 = F_117 ( & V_2 -> V_206 ) ;
if ( V_27 != NULL )
V_204 = V_27 -> V_123 ;
F_118 ( & V_2 -> V_206 . V_12 ) ;
return F_102 ( V_204 , ( int T_7 * ) V_202 ) ;
}
default:
#ifdef F_119
return F_120 ( V_2 , V_201 , ( void T_7 * ) V_202 ) ;
#else
return - V_207 ;
#endif
}
}
static int F_121 ( struct V_1 * V_2 , unsigned int V_201 , unsigned long V_202 )
{
switch ( V_201 ) {
case V_203 :
case V_205 :
...
default:
#ifdef F_119
return F_122 ( V_2 , V_201 , F_123 ( V_202 ) ) ;
#else
return - V_207 ;
#endif
}
}
static struct V_1 * F_124 ( struct V_208 * V_209 )
{
struct V_1 * V_2 ;
struct V_210 * V_211 = F_125 ( V_209 ) ;
for ( V_211 -> V_212 = 0 ; V_211 -> V_212 < V_11 ;
++ V_211 -> V_212 ) {
struct V_18 * V_19 ;
F_126 (sk, node, &state->h->ht[state->bucket])
if ( F_6 ( V_2 ) == F_127 ( V_209 ) )
goto V_25;
}
V_2 = NULL ;
V_25:
...
static struct V_1 * F_128 ( struct V_208 * V_209 , struct V_1 * V_2 )
{
struct V_210 * V_211 = F_125 ( V_209 ) ;
do {
V_2 = F_24 ( V_2 ) ;
...
static struct V_1 * F_129 ( struct V_208 * V_209 , T_8 V_214 )
{
struct V_1 * V_2 = F_124 ( V_209 ) ;
if ( V_2 )
while ( V_214 && ( V_2 = F_128 ( V_209 , V_2 ) ) != NULL )
-- V_214 ;
return V_214 ? NULL : V_2 ;
}
void * F_130 ( struct V_208 * V_209 , T_8 * V_214 )
{
struct V_210 * V_211 = F_125 ( V_209 ) ;
F_18 ( & V_211 -> V_4 -> V_12 ) ;
return * V_214 ? F_129 ( V_209 , * V_214 - 1 ) : V_215 ;
}
void * F_131 ( struct V_208 * V_209 , void * V_216 , T_8 * V_214 )
{
struct V_1 * V_2 ;
if ( V_216 == V_215 )
V_2 = F_124 ( V_209 ) ;
else
V_2 = F_128 ( V_209 , V_216 ) ;
++ * V_214 ;
return V_2 ;
}
void F_132 ( struct V_208 * V_209 , void * V_216 )
{
struct V_210 * V_211 = F_125 ( V_209 ) ;
F_25 ( & V_211 -> V_4 -> V_12 ) ;
}
static void F_133 ( struct V_208 * V_209 , struct V_1 * V_217 , int V_113 )
{
...
F_115 ( V_217 ) ,
F_135 ( V_217 ) ,
0 , 0L , 0 , F_136 ( V_217 ) , 0 , F_137 ( V_217 ) ,
F_138 ( & V_217 -> V_222 ) , V_217 , F_138 ( & V_217 -> V_74 ) ) ;
}
static int F_139 ( struct V_208 * V_209 , void * V_216 )
{
if ( V_216 == V_215 )
F_134 ( V_209 , L_5
L_6
...
F_133 ( V_209 , V_216 , F_125 ( V_209 ) -> V_212 ) ;
return 0 ;
}
int F_140 ( struct V_223 * V_224 , struct V_225 * V_225 ,
struct V_3 * V_4 , const struct V_226 * V_227 )
{
int V_47 ;
struct V_210 * V_113 ;
V_47 = F_141 ( V_224 , V_225 , V_227 , sizeof( struct V_210 ) ) ;
if ( V_47 < 0 )
return V_47 ;
V_113 = F_125 ( (struct V_208 * ) V_225 -> V_228 ) ;
V_113 -> V_4 = V_4 ;
return 0 ;
}
static int F_142 ( struct V_223 * V_223 , struct V_225 * V_225 )
{
return F_140 ( V_223 , V_225 , & V_35 , & V_229 ) ;
}
static T_10 int F_143 ( struct V_13 * V_13 )
{
if ( ! F_144 ( V_13 , L_8 , V_230 , & V_231 ) )
return - V_232 ;
return 0 ;
}
