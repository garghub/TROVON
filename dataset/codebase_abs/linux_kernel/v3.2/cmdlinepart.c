...
if ( ! V_24 )
F_7 ( V_38 ) ;
for( V_37 = V_30 ; V_37 ; V_37 = V_37 -> V_29 )
{
if ( ( ! V_28 ) || ( ! strcmp ( V_37 -> V_28 , V_28 ) ) )
{
for( V_36 = 0 , V_10 = 0 ; V_36 < V_37 -> V_4 ; V_36 ++ )
{
if ( V_37 -> V_8 [ V_36 ] . V_10 == V_11 )
V_37 -> V_8 [ V_36 ] . V_10 = V_10 ;
else
V_10 = V_37 -> V_8 [ V_36 ] . V_10 ;
if ( V_37 -> V_8 [ V_36 ] . V_9 == V_17 )
V_37 -> V_8 [ V_36 ] . V_9 = V_32 -> V_9 - V_10 ;
if ( V_10 + V_37 -> V_8 [ V_36 ] . V_9 > V_32 -> V_9 )
{
...
V_10 += V_37 -> V_8 [ V_36 ] . V_9 ;
}
* V_33 = F_10 ( V_37 -> V_8 ,
sizeof( * V_37 -> V_8 ) * V_37 -> V_4 ,
V_23 ) ;
if ( ! * V_33 )
return - V_39 ;
return V_37 -> V_4 ;
