...
V_33 = F_74 ( V_8 -> V_22 . V_145 , F_46 ,
V_166 | V_167 ,
V_8 -> V_163 , V_8 ) ;
if ( V_33 )
return V_33 ;
V_33 = F_74 ( V_8 -> V_22 . V_146 , F_49 ,
V_166 | V_167 ,
V_8 -> V_165 , V_8 ) ;
if ( V_33 ) {
F_71 ( V_8 -> V_22 . V_145 , V_8 ) ;
...
static int F_79 ( struct V_7 * V_8 , const void * V_171 , unsigned int V_26 )
{
struct V_15 * V_17 ;
unsigned long V_16 ;
int V_33 ;
...
if ( ! V_17 )
return - V_173 ;
memcpy ( V_17 , V_171 , V_26 ) ;
V_33 = F_16 ( V_8 , V_17 , V_16 ) ;
if ( ! V_33 )
V_33 = V_26 ;
return V_33 ;
}
static int F_80 ( struct V_7 * V_8 , void * V_171 , unsigned int V_26 )
{
struct V_15 * V_17 ;
...
static int F_81 ( struct V_7 * V_8 , const void * V_171 ,
unsigned int V_26 )
{
...
static int F_85 ( struct V_7 * V_8 , unsigned long V_185 )
{
unsigned long V_186 ;
int V_27 = 1000 ;
F_3 ( V_183 , L_37 ,
V_185 , V_8 -> V_74 , V_8 -> V_75 ) ;
while ( V_27 -- > 0 ) {
unsigned long V_70 ;
V_70 = F_31 ( V_8 -> V_34 ,
& V_186 ,
...
static int F_89 ( struct V_7 * V_8 , void * V_171 , unsigned int V_26 )
{
struct V_15 * V_184 ;
unsigned long V_70 , V_102 ;
int V_33 , V_176 ;
...
V_187 = V_17 -> V_60 & V_180 ;
if ( ( V_184 == NULL && ! ( V_17 -> V_60 & V_181 ) ) ||
( V_184 != NULL && ( V_17 -> V_60 & V_181 ) ) ) {
if ( ! V_184 )
V_102 = F_5 ( V_8 , V_102 ) ;
V_33 = F_86 ( V_8 , V_102 ) ;
if ( V_33 )
...
memcpy ( V_171 ,
( V_8 -> V_22 . V_23 == V_142 ?
V_17 -> V_44 . V_45 : V_17 -> V_44 . V_66 . V_178 ) , V_187 ) ;
V_171 += V_187 ;
V_176 += V_187 ;
if ( V_17 -> V_60 & V_182 )
break;
...
static int F_90 ( struct V_7 * V_8 , const void * V_171 ,
unsigned int V_26 )
{
if ( V_26 > V_8 -> V_22 . V_150 )
V_26 = V_8 -> V_22 . V_150 ;
return F_81 ( V_8 , V_171 , V_26 ) ;
}
static int F_91 ( struct V_7 * V_8 , void * V_171 , unsigned int V_26 )
{
if ( ! V_8 -> V_189 ) {
...
if ( V_26 > V_8 -> V_189 )
V_26 = V_8 -> V_189 ;
memcpy ( V_171 , V_8 -> V_137 + V_8 -> V_190 , V_26 ) ;
V_8 -> V_190 += V_26 ;
V_8 -> V_189 -= V_26 ;
return V_26 ;
}
int F_92 ( struct V_7 * V_8 , const void * V_171 , unsigned int V_26 )
{
unsigned long V_54 ;
int V_33 ;
if ( ! V_171 )
...
V_33 = V_8 -> V_134 -> V_192 ( V_8 , V_171 , V_26 ) ;
F_48 ( & V_8 -> V_96 , V_54 ) ;
return V_33 ;
}
int F_93 ( struct V_7 * V_8 , void * V_171 , unsigned int V_26 )
{
unsigned long V_54 ;
int V_33 ;
if ( ! V_171 )
...
V_33 = V_8 -> V_134 -> V_193 ( V_8 , V_171 , V_26 ) ;
F_48 ( & V_8 -> V_96 , V_54 ) ;
return V_33 ;
}
static long F_94 ( struct V_121 * V_122 , unsigned long V_194 )
{
struct V_195 * V_126 = & V_122 -> V_126 ;
unsigned long V_109 , V_196 , V_197 , V_27 ;
int V_198 ;
V_27 = V_126 -> V_27 ;
V_196 = V_126 -> V_199 ;
V_198 = 0 ;
V_200:
V_109 = F_95 ( V_126 -> V_127 , V_27 , V_196 , V_194 , 0 ) ;
V_197 = V_109 + V_194 ;
if ( F_82 ( V_197 >= V_27 ) ) {
if ( F_88 ( V_198 < 1 ) ) {
V_27 = V_196 ;
...
static T_5 F_98 ( T_5 V_201 , T_5 V_202 , T_5 V_203 )
{
return ( ( V_202 << V_204 ) |
( V_201 << V_205 ) |
V_203 ) ;
}
static T_5 F_99 ( T_5 V_206 , unsigned long * V_207 )
{
T_5 V_208 = V_206 >> V_204 ;
V_206 &= ~ V_209 ;
* V_207 = V_208 * 3 ;
return ( V_206 >> ( 13ULL + ( V_208 * 3ULL ) ) ) ;
}
static struct V_123 * F_100 ( struct V_121 * V_122 ,
unsigned long V_194 )
{
long V_210 ;
V_210 = F_94 ( V_122 , V_194 ) ;
if ( F_82 ( V_210 < 0 ) )
return NULL ;
return V_122 -> V_129 + V_210 ;
}
static T_5 F_101 ( unsigned int V_211 )
{
T_5 V_212 ;
V_212 = F_97 () ;
if ( V_211 & V_213 ) {
...
static int F_102 ( unsigned long V_111 , long V_226 )
{
int V_227 = 0 ;
do {
unsigned long V_102 = ( V_111 + V_117 ) & V_228 ;
V_226 -= ( V_102 - V_111 ) ;
V_111 = V_102 ;
V_227 ++ ;
} while ( V_226 > 0 );
...
static void F_103 ( struct V_229 * V_230 , unsigned long V_231 ,
unsigned long V_10 , unsigned long V_226 )
{
do {
unsigned long V_232 , V_102 = V_231 + V_117 ;
T_5 V_233 ;
V_230 -> V_129 [ V_230 -> V_234 ] . V_235 = V_230 -> V_212 | V_231 ;
V_232 = V_117 ;
if ( V_10 )
V_232 = V_117 - V_10 ;
if ( V_232 > V_226 )
V_232 = V_226 ;
V_233 = F_98 ( V_230 -> V_234 ,
F_97 () , V_10 ) ;
V_10 = 0 ;
if ( V_233 == V_230 -> V_236 ) {
V_230 -> V_237 [ V_230 -> V_238 - 1 ] . V_239 += V_232 ;
} else {
V_230 -> V_237 [ V_230 -> V_238 ] . V_240 = V_233 ;
V_230 -> V_237 [ V_230 -> V_238 ] . V_239 = V_232 ;
V_230 -> V_238 ++ ;
}
V_230 -> V_236 = V_233 + V_232 ;
V_230 -> V_234 ++ ;
V_226 -= V_232 ;
V_231 = V_102 ;
} while ( V_226 > 0 );
}
static int F_104 ( struct V_241 * V_242 )
{
unsigned long V_111 = F_105 ( F_106 ( V_242 ) ) << V_205 ;
long V_226 = V_242 -> V_243 ;
if ( ( V_242 -> V_244 | V_226 ) & ( 8UL - 1 ) )
return - V_245 ;
return F_102 ( V_111 + V_242 -> V_244 , V_226 ) ;
}
static int F_107 ( struct V_241 * V_242 , int V_246 )
{
int V_227 ;
int V_78 ;
V_227 = 0 ;
for ( V_78 = 0 ; V_78 < V_246 ; V_78 ++ ) {
int V_33 = F_104 ( V_242 + V_78 ) ;
if ( V_33 < 0 )
return V_33 ;
V_227 += V_33 ;
}
...
struct V_241 * V_242 , int V_246 ,
struct V_247 * V_237 , int V_248 ,
unsigned int V_211 )
{
unsigned long V_78 , V_194 , V_54 ;
struct V_123 * V_111 ;
struct V_229 V_1 ;
struct V_121 * V_122 ;
int V_33 ;
...
V_111 = F_100 ( V_122 , V_194 ) ;
F_48 ( & V_122 -> V_96 , V_54 ) ;
if ( ! V_111 )
return - V_116 ;
V_1 . V_129 = V_122 -> V_129 ;
V_1 . V_237 = V_237 ;
V_1 . V_212 = F_101 ( V_211 ) ;
V_1 . V_236 = ~ ( T_5 ) 0 ;
V_1 . V_234 = ( V_111 - V_122 -> V_129 ) ;
V_1 . V_238 = 0 ;
for ( V_78 = 0 ; V_78 < V_246 ; V_78 ++ )
F_103 ( & V_1 , F_105 ( F_106 ( & V_242 [ V_78 ] ) ) << V_205 ,
V_242 [ V_78 ] . V_244 , V_242 [ V_78 ] . V_243 ) ;
return V_1 . V_238 ;
}
int F_109 ( struct V_7 * V_8 ,
void * V_171 , unsigned int V_226 ,
struct V_247 * V_237 , int V_248 ,
unsigned int V_211 )
{
unsigned long V_194 , V_231 , V_54 ;
struct V_123 * V_111 ;
struct V_229 V_1 ;
struct V_121 * V_122 ;
if ( ( V_211 & ~ V_249 ) || ( V_248 < 1 ) )
return - V_36 ;
V_231 = F_55 ( V_171 ) ;
if ( ( V_231 | V_226 ) & ( 8UL - 1 ) )
return - V_245 ;
V_194 = F_102 ( V_231 , V_226 ) ;
V_122 = & V_8 -> V_122 ;
F_47 ( & V_122 -> V_96 , V_54 ) ;
V_111 = F_100 ( V_122 , V_194 ) ;
F_48 ( & V_122 -> V_96 , V_54 ) ;
...
V_1 . V_234 = ( V_111 - V_122 -> V_129 ) ;
V_1 . V_238 = 0 ;
F_103 ( & V_1 , ( V_231 & V_228 ) , ( V_231 & ~ V_228 ) , V_226 ) ;
F_17 ( V_1 . V_238 != 1 ) ;
return V_1 . V_238 ;
}
...
{
struct V_195 * V_126 = & V_122 -> V_126 ;
unsigned long V_78 , V_207 , V_201 , V_194 ;
struct V_123 * V_111 ;
V_194 = F_111 ( ( ( V_206 & ~ V_228 ) + V_26 ) ) >> V_205 ;
V_201 = F_99 ( V_206 , & V_207 ) ;
V_111 = V_122 -> V_129 + V_201 ;
F_17 ( V_201 > V_126 -> V_27 ||
( V_201 + V_194 ) > V_126 -> V_27 ) ;
for ( V_78 = 0 ; V_78 < V_194 ; V_78 ++ ) {
if ( V_111 -> V_206 )
F_112 ( V_34 , V_206 + ( V_78 << V_207 ) ,
V_111 -> V_206 ) ;
V_111 -> V_235 = 0 ;
F_113 ( V_201 + V_78 , V_126 -> V_127 ) ;
}
}
void F_114 ( struct V_7 * V_8 , struct V_247 * V_237 ,
int V_248 )
{
struct V_121 * V_122 = & V_8 -> V_122 ;
unsigned long V_54 ;
int V_78 ;
F_47 ( & V_122 -> V_96 , V_54 ) ;
for ( V_78 = 0 ; V_78 < V_248 ; V_78 ++ ) {
T_5 V_250 = V_237 [ V_78 ] . V_240 ;
T_5 V_26 = V_237 [ V_78 ] . V_239 ;
F_110 ( V_8 -> V_34 , V_122 , V_250 , V_26 ) ;
}
F_48 ( & V_122 -> V_96 , V_54 ) ;
}
int F_115 ( struct V_7 * V_8 , int V_251 ,
void * V_171 , unsigned int V_226 , unsigned long V_244 ,
struct V_247 * V_237 , int V_248 )
{
unsigned int V_252 ;
unsigned long V_112 ;
...
V_252 = V_226 ;
for ( V_78 = 0 ; V_78 < V_248 ; V_78 ++ ) {
unsigned long V_255 = V_237 [ V_78 ] . V_240 ;
unsigned long V_256 = V_237 [ V_78 ] . V_239 ;
unsigned long V_257 ;
if ( F_82 ( V_244 ) ) {
unsigned long V_258 = V_244 ;
if ( V_258 > V_256 )
V_258 = V_256 ;
V_244 -= V_258 ;
V_256 -= V_258 ;
...
void * F_117 ( struct V_7 * V_8 , unsigned int V_226 ,
struct V_247 * V_237 , int * V_248 ,
unsigned int V_211 )
{
void * V_171 ;
...
if ( V_226 & ( 8UL - 1 ) )
return F_69 ( - V_36 ) ;
V_171 = F_60 ( V_226 , V_115 ) ;
if ( ! V_171 )
return F_69 ( - V_116 ) ;
V_33 = F_109 ( V_8 , V_171 , V_226 , V_237 , * V_248 , V_211 ) ;
if ( V_33 < 0 ) {
F_62 ( V_171 ) ;
return F_69 ( V_33 ) ;
}
...
void F_118 ( struct V_7 * V_8 , void * V_171 , unsigned int V_226 ,
struct V_247 * V_237 , int V_248 )
{
F_114 ( V_8 , V_237 , V_248 ) ;
F_62 ( V_171 ) ;
}
...
if ( ! V_260 )
return - V_138 ;
V_261 = F_121 ( V_260 , V_262 , L_49 ) ;
V_33 = - V_138 ;
if ( V_261 == V_262 )
goto V_100;
V_79 = F_122 ( V_260 , V_261 , L_50 , NULL ) ;
if ( ! V_79 )
goto V_100;
V_50 = 1 ;
V_51 = 0 ;
if ( F_123 ( V_263 , V_50 , & V_51 ) ) {
F_28 (KERN_INFO PFX L_51 ) ;
goto V_100;
}
F_28 ( V_264 L_52 , V_265 ) ;
if ( ! * V_79 ) {
