...
struct V_11 * V_12 = V_11 ( V_8 ) ;
int V_6 ;
#if F_30 ( V_80 ) || F_30 ( V_81 )
V_12 -> V_19 =
F_4 ( & V_12 -> V_13 , & V_82 ) ;
#else
V_12 -> V_19 =
F_31 ( & V_12 -> V_13 , V_82 . V_83 ) ;
#endif
if ( ! V_12 -> V_19 )
return - V_14 ;
V_6 = F_2 ( V_12 -> V_19 ,
...
static void F_35 ( struct V_7 * V_8 , enum V_95 V_96 )
{
F_34 (
V_8 , V_93 ,
( V_96 == V_97 ) ? V_98 : V_94 ) ;
...
struct V_11 * V_12 = V_11 ( V_8 ) ;
unsigned V_99 =
( V_12 -> V_100 == 0 && V_12 -> V_101 == 0 ) ?
~ V_30 : ~ 0 ;
return F_8 ( V_8 , V_99 ) ;
}
static int F_37 ( struct V_7 * V_8 )
{
return F_3 ( V_8 , & V_102 , V_103 ) ;
}
...
static void F_39 ( struct V_7 * V_8 , enum V_95 V_96 )
{
int V_4 ;
switch ( V_96 ) {
case V_108 :
...
{
return F_3 ( V_8 , & V_109 , V_110 ) ;
}
static void F_42 ( struct V_7 * V_8 , enum V_95 V_96 )
{
struct V_11 * V_12 = V_11 ( V_8 ) ;
if ( V_12 -> V_101 < 3 && V_12 -> V_100 == 0 )
return;
F_43 (
V_8 , V_111 ,
( V_96 == V_97 ) ? V_112 : V_113 ) ;
}
...
if ( V_12 -> V_101 < 3 && V_12 -> V_100 == 0 )
return;
F_45 ( V_8 , V_111 , V_114 ) ;
F_43 ( V_8 , V_111 , V_113 ) ;
}
static int F_46 ( struct V_7 * V_8 )
{
struct V_11 * V_12 = V_11 ( V_8 ) ;
unsigned V_99 =
( V_12 -> V_100 == 0 && V_12 -> V_101 <= 2 ) ?
~ V_30 : ~ 0 ;
return F_8 ( V_8 , V_99 ) ;
}
static int F_47 ( struct V_7 * V_8 )
{
return F_3 ( V_8 , & V_115 , V_116 ) ;
}
int F_48 ( struct V_7 * V_8 , T_2 V_117 )
{
struct V_11 * V_12 = V_11 ( V_8 ) ;
T_1 V_118 = F_49 ( V_117 ) ;
int V_41 ;
V_12 -> V_100 = F_50 ( V_117 ) ;
V_12 -> V_101 = F_51 ( V_117 ) ;
for ( V_41 = 0 ; V_41 < F_52 ( V_119 ) ; V_41 ++ )
if ( V_119 [ V_41 ] . V_120 == V_118 )
V_12 -> type = & V_119 [ V_41 ] ;
if ( V_12 -> type ) {
F_13 ( V_8 , V_121 , V_8 -> V_34 , L_16 ,
( V_8 -> V_72 -> V_122 ==
V_123 )
? V_12 -> type -> V_124 : V_12 -> type -> V_125 ,
'A' + V_12 -> V_100 , V_12 -> V_101 ) ;
return 0 ;
} else {
F_10 ( V_8 , V_121 , V_8 -> V_34 , L_17 ,
V_118 ) ;
return - V_126 ;
}
}
