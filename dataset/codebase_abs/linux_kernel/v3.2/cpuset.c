...
static int F_119 ( struct V_135 * V_136 , struct V_2 * V_3 ,
struct V_6 * V_36 )
{
...
static int F_120 ( struct V_2 * V_138 , struct V_6 * V_7 )
{
return F_121 ( V_7 ) ;
}
...
static void F_123 ( struct V_2 * V_3 , struct V_6 * V_36 )
{
int V_123 ;
struct V_1 * V_9 = F_1 ( V_3 ) ;
V_123 = F_69 ( V_36 , V_139 ) ;
F_124 ( V_123 ) ;
F_80 ( V_36 , & V_141 ) ;
F_27 ( V_9 , V_36 ) ;
}
static void F_125 ( struct V_135 * V_136 , struct V_2 * V_3 ,
struct V_2 * V_142 , struct V_6 * V_36 )
{
struct V_99 * V_100 ;
struct V_1 * V_9 = F_1 ( V_3 ) ;
...
static int F_126 ( struct V_2 * V_138 , struct V_145 * V_146 , T_6 V_117 )
{
int V_94 = 0 ;
struct V_1 * V_9 = F_1 ( V_138 ) ;
...
static int F_128 ( struct V_2 * V_138 , struct V_145 * V_146 , T_3 V_117 )
{
int V_94 = 0 ;
struct V_1 * V_9 = F_1 ( V_138 ) ;
T_7 type = V_146 -> V_147 ;
...
static int F_129 ( struct V_2 * V_138 , struct V_145 * V_146 ,
const char * V_93 )
{
int V_94 = 0 ;
struct V_1 * V_9 = F_1 ( V_138 ) ;
...
T_8 V_162 ;
F_75 ( & V_98 ) ;
V_162 = F_131 ( V_161 , V_97 , V_9 -> V_30 ) ;
F_76 ( & V_98 ) ;
return V_162 ;
}
static T_8 F_132 ( char * V_161 , struct V_1 * V_9 )
{
T_8 V_162 ;
F_75 ( & V_98 ) ;
V_162 = F_133 ( V_161 , V_97 , V_9 -> V_33 ) ;
F_76 ( & V_98 ) ;
return V_162 ;
}
...
* V_166 ++ = '\n' ;
V_94 = F_136 ( V_93 , V_164 , V_165 , V_161 , V_166 - V_161 ) ;
V_124:
F_137 ( ( unsigned long ) V_161 ) ;
return V_94 ;
}
static T_6 F_138 ( struct V_2 * V_3 , struct V_145 * V_146 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
T_7 type = V_146 -> V_147 ;
switch ( type ) {
...
static T_3 F_140 ( struct V_2 * V_3 , struct V_145 * V_146 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
T_7 type = V_146 -> V_147 ;
switch ( type ) {
...
{
int V_123 ;
V_123 = F_142 ( V_3 , V_136 , V_168 , F_143 ( V_168 ) ) ;
if ( V_123 )
return V_123 ;
if ( ! V_3 -> V_32 )
...
static void F_156 ( struct V_1 * V_175 )
{
F_45 ( V_176 ) ;
struct V_1 * V_57 ;
struct V_1 * V_58 ;
struct V_2 * V_3 ;
static T_1 V_177 ;
F_50 ( (struct V_178 * ) & V_175 -> V_56 , & V_176 ) ;
while ( ! F_47 ( & V_176 ) ) {
V_57 = F_48 ( & V_176 , struct V_1 , V_56 ) ;
F_49 ( V_176 . V_59 ) ;
F_38 (cont, &cp->css.cgroup->children, sibling) {
V_58 = F_1 ( V_3 ) ;
F_50 ( & V_58 -> V_56 , & V_176 ) ;
}
...
static int F_158 ( struct V_179 * V_180 ,
...
const struct V_1 * V_9 ;
int V_192 ;
if ( F_174 () || ( V_191 & V_193 ) )
return 1 ;
F_175 ( ! ( V_191 & V_194 ) ) ;
if ( F_176 ( V_190 , V_103 -> V_33 ) )
return 1 ;
if ( F_81 ( F_82 ( V_108 ) ) )
return 1 ;
if ( V_191 & V_194 )
...
V_9 = F_172 ( F_4 ( V_103 ) ) ;
F_88 ( V_103 ) ;
V_192 = F_176 ( V_190 , V_9 -> V_33 ) ;
F_76 ( & V_98 ) ;
return V_192 ;
}
int F_177 ( int V_190 , T_13 V_191 )
{
if ( F_174 () || ( V_191 & V_193 ) )
return 1 ;
if ( F_176 ( V_190 , V_103 -> V_33 ) )
...
static int F_179 ( int * V_195 )
{
int V_190 ;
V_190 = F_180 ( * V_195 , V_103 -> V_33 ) ;
if ( V_190 == V_196 )
V_190 = F_181 ( V_103 -> V_33 ) ;
* V_195 = V_190 ;
return V_190 ;
}
int F_182 ( void )
...
V_103 -> V_199 =
F_183 ( & V_103 -> V_33 ) ;
return F_179 ( & V_103 -> V_199 ) ;
}
int F_185 ( const struct V_6 * V_200 ,
...
static int F_188 ( struct V_211 * V_212 , void * V_213 )
{
struct V_214 * V_214 ;
struct V_6 * V_36 ;
char * V_93 ;
...
static int F_194 ( struct V_219 * V_219 , struct V_163 * V_163 )
{
struct V_214 * V_214 = F_195 ( V_219 ) -> V_214 ;
return F_196 ( V_163 , F_188 , V_214 ) ;
}
void F_197 ( struct V_211 * V_212 , struct V_6 * V_7 )
{
F_198 ( V_212 , L_12 ) ;
F_199 ( V_212 , & V_7 -> V_33 ) ;
F_198 ( V_212 , L_13 ) ;
F_198 ( V_212 , L_14 ) ;
F_200 ( V_212 , & V_7 -> V_33 ) ;
F_198 ( V_212 , L_13 ) ;
}
