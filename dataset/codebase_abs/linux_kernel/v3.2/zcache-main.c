...
static T_4 F_69 ( struct V_97 * V_98 ,
struct V_99 * V_100 ,
char * V_78 )
{
...
if ( ! F_71 ( V_104 ) )
return - V_105 ;
V_103 = F_72 ( V_78 , 10 , & V_102 ) ;
if ( V_103 || ( V_102 == 0 ) || ( V_102 > ( V_13 / 8 ) * 7 ) )
return - V_64 ;
V_101 = V_102 ;
return V_41 ;
}
static T_4 F_73 ( struct V_97 * V_98 ,
struct V_99 * V_100 ,
char * V_78 )
{
...
F_81 () ;
V_117 = & F_82 ( V_125 ) ;
while ( V_117 -> V_70 < F_83 ( V_117 -> V_126 ) ) {
F_84 () ;
V_119 = F_85 ( V_123 ,
V_90 ) ;
if ( F_38 ( V_119 == NULL ) ) {
...
F_81 () ;
V_117 = & F_82 ( V_125 ) ;
if ( V_117 -> V_70 < F_83 ( V_117 -> V_126 ) )
V_117 -> V_126 [ V_117 -> V_70 ++ ] = V_119 ;
else
F_86 ( V_123 , V_119 ) ;
}
F_84 () ;
V_121 = F_85 ( V_124 , V_90 ) ;
if ( F_38 ( V_121 == NULL ) ) {
V_127 ++ ;
goto V_54;
}
...
{
F_88 ( ( unsigned long ) V_20 ) ;
}
static struct V_118 * F_89 ( struct V_68 * V_69 )
{
...
{
int V_63 = 0 ;
unsigned char * V_150 = F_82 ( V_151 ) ;
unsigned char * V_152 = F_82 ( V_153 ) ;
char * V_62 ;
F_2 ( ! F_58 () ) ;
...
if ( V_117 -> V_121 ) {
F_86 ( V_124 , V_117 -> V_121 ) ;
V_117 -> V_121 = NULL ;
}
if ( V_117 -> V_47 ) {
F_88 ( ( unsigned long ) V_117 -> V_47 ) ;
V_117 -> V_47 = NULL ;
}
break;
default:
