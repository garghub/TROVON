...
F_11 ( L_14 \
L_15 , V_24 ,
V_74 -> V_64 , V_74 -> V_80 , V_74 -> V_81 ,
V_74 -> V_82 , V_74 -> V_79 , V_74 -> V_78 , V_74 -> V_77 ) ;
V_2 -> V_64 = V_83 ;
if ( ! V_2 -> V_22 ) {
V_6 = - V_23 ;
goto error;
...
for ( V_19 = 0 , V_76 = 0xff ; V_19 < F_23 ( V_94 ) ; V_19 ++ ) {
if ( V_74 -> V_64 == V_94 [ V_19 ] . V_64 &&
V_74 -> V_80 == V_94 [ V_19 ] . V_80 &&
V_74 -> V_95 == V_94 [ V_19 ] . V_96 ) {
V_76 = V_94 [ V_19 ] . V_4 ;
F_11 ( L_20 , V_24 , V_76 ) ;
break;
}
...
V_21 . args [ 0x01 ] = 0 ;
V_21 . args [ 0x02 ] = V_76 ;
V_21 . args [ 0x03 ] = ( V_74 -> V_81 >> 16 ) & 0xff ;
V_21 . args [ 0x04 ] = ( V_74 -> V_81 >> 8 ) & 0xff ;
V_21 . args [ 0x05 ] = ( V_74 -> V_81 >> 0 ) & 0xff ;
V_21 . args [ 0x06 ] = ( ( V_74 -> V_82 / 1000 ) >> 8 ) & 0xff ;
V_21 . args [ 0x07 ] = ( ( V_74 -> V_82 / 1000 ) >> 0 ) & 0xff ;
V_21 . args [ 0x08 ] = ( V_98 . V_99 . V_100 >> 8 ) & 0xff ;
V_21 . args [ 0x09 ] = ( V_98 . V_99 . V_100 >> 0 ) & 0xff ;
V_21 . args [ 0x0a ] = V_77 ;
V_21 . args [ 0x0b ] = V_79 ;
V_21 . args [ 0x0c ] = V_78 ;
V_21 . args [ 0x0d ] = 0x00 ;
...
goto error;
V_18 = V_7 [ 0 ] & 0x3f ;
for ( V_19 = 0 ; V_19 < F_23 ( V_94 ) ; V_19 ++ ) {
if ( V_18 == V_94 [ V_19 ] . V_4 ) {
V_74 -> V_80 = V_94 [ V_19 ] . V_80 ;
V_74 -> V_95 = V_94 [ V_19 ] . V_96 ;
V_74 -> V_64 = V_94 [ V_19 ] . V_64 ;
}
}
switch ( ( V_7 [ 1 ] >> 0 ) & 0x01 ) {
case 0 :
...
if ( ! V_18 ) {
V_2 -> V_22 = 1 ;
for ( V_19 = 0 ; V_19 < F_23 ( V_109 ) ; V_19 ++ ) {
V_6 = F_7 ( V_2 , V_109 [ V_19 ] . V_3 ,
V_109 [ V_19 ] . V_4 , V_109 [ V_19 ] . V_17 ) ;
if ( V_6 )
goto error;
}
V_21 . args [ 0x00 ] = V_112 ;
V_21 . args [ 0x01 ] = 0 ;
V_21 . args [ 0x02 ] = 0 ;
V_21 . V_5 = 0x03 ;
V_6 = F_9 ( V_2 , & V_21 ) ;
...
V_2 -> V_22 = 0 ;
V_6 = F_26 ( & V_105 , V_106 , V_2 -> V_14 -> V_113 . V_114 ) ;
if ( V_6 ) {
F_27 ( L_22
L_23 \
L_24 ,
...
for ( V_19 = 0 ; V_19 < F_23 ( V_110 ) ; V_19 ++ ) {
V_6 = F_7 ( V_2 , V_110 [ V_19 ] . V_3 ,
V_110 [ V_19 ] . V_4 , V_110 [ V_19 ] . V_17 ) ;
if ( V_6 )
goto V_115;
}
...
V_102 -= ( V_2 -> V_11 . V_118 - 1 ) ) {
V_5 = V_102 ;
if ( V_5 > ( V_2 -> V_11 . V_118 - 1 ) )
V_5 = ( V_2 -> V_11 . V_118 - 1 ) ;
V_6 = F_1 ( V_2 , 0xfa ,
( T_1 * ) & V_105 -> V_119 [ V_103 - V_102 ] , V_5 ) ;
if ( V_6 ) {
F_27 ( L_27 , V_6 ) ;
if ( V_6 )
goto V_115;
...
V_99 ( L_30 , V_98 . V_99 . V_116 ) ;
V_6 = F_4 ( V_2 , 0x81 , V_7 , 2 ) ;
if ( V_6 )
goto error;
V_21 . args [ 0x00 ] = V_121 ;
V_21 . args [ 0x01 ] = ( ( V_2 -> V_11 . V_122 / 1000 ) >> 8 ) & 0xff ;
V_21 . args [ 0x02 ] = ( ( V_2 -> V_11 . V_122 / 1000 ) >> 0 ) & 0xff ;
V_21 . args [ 0x03 ] = V_7 [ 0 ] ;
V_21 . args [ 0x04 ] = V_7 [ 1 ] ;
V_21 . args [ 0x05 ] = V_2 -> V_11 . V_111 ;
V_21 . args [ 0x06 ] = V_2 -> V_11 . V_123 ;
V_21 . args [ 0x07 ] = 0x00 ;
V_21 . V_5 = 0x08 ;
V_6 = F_9 ( V_2 , & V_21 ) ;
if ( V_6 )
...
goto error;
for ( V_19 = 0 ; V_19 < F_23 ( V_109 ) ; V_19 ++ ) {
V_6 = F_7 ( V_2 , V_109 [ V_19 ] . V_3 , V_109 [ V_19 ] . V_4 ,
V_109 [ V_19 ] . V_17 ) ;
if ( V_6 )
goto error;
}
...
struct V_26 * F_34 ( const struct V_134 * V_135 ,
struct V_136 * V_14 )
{
int V_6 ;
struct V_1 * V_2 = NULL ;
T_1 V_18 ;
V_2 = F_35 ( sizeof( struct V_1 ) , V_137 ) ;
if ( V_2 == NULL ) {
V_6 = - V_138 ;
goto error;
}
V_2 -> V_14 = V_14 ;
memcpy ( & V_2 -> V_11 , V_135 , sizeof( struct V_134 ) ) ;
...
if ( V_6 || V_18 != 0x01 )
goto error;
memcpy ( & V_2 -> V_27 . V_139 , & V_98 , sizeof( struct V_140 ) ) ;
V_2 -> V_27 . V_29 = V_2 ;
return & V_2 -> V_27 ;
error:
F_11 ( L_4 , V_24 , V_6 ) ;
