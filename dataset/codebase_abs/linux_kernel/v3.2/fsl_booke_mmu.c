...
T_1 V_8 )
{
unsigned int V_46 = F_5 ( V_45 ) & ~ 1U ;
unsigned int V_47 = F_16 ( V_11 | V_8 ) & ~ 1U ;
unsigned long V_48 = ( F_17 ( V_49 ) >> 16 ) & 0xf ;
V_48 = V_48 * 2 + 10 ;
if ( V_46 > V_47 )
V_46 = V_47 ;
if ( V_46 > V_48 )
...
unsigned long F_18 ( unsigned long V_45 , int V_50 )
{
int V_51 ;
unsigned long V_11 = V_52 ;
T_1 V_8 = V_53 ;
unsigned long V_54 = 0 ;
for ( V_51 = 0 ; V_45 && V_51 < V_50 ; V_51 ++ ) {
unsigned long V_55 ;
V_55 = F_15 ( V_45 , V_11 , V_8 ) ;
F_4 ( V_51 , V_11 , V_8 , V_55 , V_56 , 0 ) ;
V_45 -= V_55 ;
V_54 += V_55 ;
V_11 += V_55 ;
V_8 += V_55 ;
...
unsigned long T_2 F_19 ( unsigned long V_57 )
{
return V_2 [ V_7 - 1 ] . V_3 - V_52 + 1 ;
}
void T_2 F_20 ( void )
{
F_21 () ;
...
unsigned long V_45 ;
int V_51 ;
V_45 = F_23 ( ( T_1 ) V_58 , ( T_1 ) V_59 ) ;
V_58 = F_18 ( V_45 , V_60 ) ;
F_24 ( L_1 ) ;
for ( V_51 = 0 ; V_51 < V_7 - 1 ; V_51 ++ )
F_25 ( L_2 , F_1 ( V_51 ) >> 20 ) ;
F_25 ( L_3 , F_1 ( V_7 - 1 ) >> 20 ,
( unsigned int ) ( ( V_59 - V_58 ) >> 20 ) ) ;
F_26 ( V_53 + V_58 ) ;
}
void F_27 ( T_1 V_61 ,
T_1 V_62 )
