...
struct V_139 * V_140 ;
V_140 = F_48 ( sizeof( struct V_139 ) , V_145 ) ;
if ( V_140 ) {
V_140 -> V_154 = V_173 ;
V_140 -> V_174 = F_45 ;
}
...
static void F_60 ( struct V_172 * V_172 )
{
struct V_31 * V_32 = F_61 ( V_172 , struct V_31 , V_172 ) ;
if ( V_32 -> V_176 . V_122 > 0 )
F_62 ( V_32 ) ;
if ( V_32 -> V_103 )
F_63 ( V_32 -> V_103 ) ;
F_52 ( V_32 -> V_143 ) ;
...
static void F_65 ( struct V_177 * V_178 )
{
struct V_179 * V_180 = F_61 ( V_178 , struct V_179 ,
V_181 . V_178 ) ;
F_66 ( & V_180 -> V_32 -> V_176 . V_182 ) ;
}
static void F_67 ( struct V_177 * V_178 )
{
struct V_31 * V_32 = F_61 ( V_178 , struct V_31 ,
V_183 . V_178 ) ;
...
F_72 ( V_40 ) ;
F_64 ( L_5 , V_175 ) ;
F_73 ( & V_32 -> V_172 , F_60 ) ;
}
static int F_74 ( struct V_45 * V_40 , int V_166 )
{
struct V_31 * V_32 = V_40 -> V_125 ;
V_32 -> V_171 -- ;
if ( V_32 -> V_169 && ( V_32 -> V_171 == 0 ) )
F_75 ( & V_32 -> V_183 , V_147 ) ;
...
F_78 ( L_8 , V_190 -> V_24 , V_190 -> V_27 ) ;
return 1 ;
}
static void F_79 ( struct V_15 * V_16 )
{
const struct V_192 V_159 = { 11 , 5 , 0 } ;
const struct V_192 V_160 = { 5 , 6 , 0 } ;
const struct V_192 V_161 = { 0 , 5 , 0 } ;
V_16 -> V_193 = 16 ;
V_16 -> V_159 = V_159 ;
V_16 -> V_160 = V_160 ;
V_16 -> V_161 = V_161 ;
...
static int F_82 ( struct V_45 * V_40 )
{
struct V_31 * V_32 = V_40 -> V_125 ;
int V_124 ;
T_3 * V_194 ;
...
static int F_84 ( int V_44 , struct V_45 * V_40 )
{
struct V_31 * V_32 = V_40 -> V_125 ;
char * V_195 ;
struct V_35 * V_35 ;
...
if ( ! V_35 )
return 0 ;
V_195 = ( char * ) V_35 -> V_39 ;
V_195 = F_2 ( V_195 ) ;
V_195 = F_4 ( V_195 , V_44 ) ;
V_195 = F_3 ( V_195 ) ;
V_195 = F_83 ( V_195 ) ;
F_16 ( V_32 , V_35 , V_195 -
( char * ) V_35 -> V_39 ) ;
V_32 -> V_44 = V_44 ;
return 0 ;
}
static int F_85 ( struct V_31 * V_32 , struct V_45 * V_40 )
{
int V_33 = - V_38 ;
int V_196 = V_40 -> V_41 . V_42 ;
int V_197 ;
unsigned char * V_198 = V_40 -> V_127 ;
unsigned char * V_199 ;
unsigned char * V_200 = 0 ;
F_64 ( L_11 ) ;
V_197 = V_40 -> V_41 . V_118 * V_40 -> V_16 . V_27 ;
if ( F_86 ( V_197 ) > V_196 ) {
V_199 = F_87 ( V_197 ) ;
if ( ! V_199 ) {
F_51 ( L_12 ) ;
...
if ( V_40 -> V_127 ) {
memcpy ( V_199 , V_198 , V_196 ) ;
F_63 ( V_40 -> V_127 ) ;
}
V_40 -> V_127 = V_199 ;
V_40 -> V_41 . V_42 = F_86 ( V_197 ) ;
V_40 -> V_41 . V_58 = ( unsigned long ) V_199 ;
V_40 -> V_201 = V_202 ;
if ( V_203 )
V_200 = F_88 ( V_197 ) ;
if ( ! V_200 )
...
struct V_45 * V_40 ,
char * V_204 , T_10 V_205 )
{
int V_110 ;
const struct V_189 * V_206 = NULL ;
int V_124 = 0 ;
char * V_143 ;
int V_207 = 3 ;
if ( V_40 -> V_32 )
F_90 ( & V_40 -> V_208 ) ;
V_143 = F_48 ( V_209 , V_145 ) ;
if ( ! V_143 ) {
V_124 = - V_38 ;
goto error;
}
F_71 ( & V_40 -> V_186 ) ;
memset ( & V_40 -> V_184 , 0 , sizeof( V_40 -> V_184 ) ) ;
while ( V_207 -- ) {
V_110 = F_47 ( V_32 , V_143 , V_209 ) ;
if ( V_110 >= V_209 )
F_91 ( V_143 , & V_40 -> V_184 ) ;
if ( V_40 -> V_184 . V_210 > 0 ) {
V_32 -> V_143 = V_143 ;
V_32 -> V_150 = V_110 ;
break;
}
...
if ( V_40 -> V_184 . V_210 == 0 ) {
if ( V_205 >= V_209 ) {
F_91 ( V_204 , & V_40 -> V_184 ) ;
if ( V_40 -> V_184 . V_210 > 0 ) {
memcpy ( V_143 , V_204 , V_205 ) ;
V_32 -> V_143 = V_143 ;
V_32 -> V_150 = V_205 ;
F_51 ( L_16 ) ;
}
...
if ( V_40 -> V_184 . V_210 > 0 ) {
for ( V_110 = 0 ; V_110 < V_40 -> V_184 . V_210 ; V_110 ++ ) {
if ( F_77 ( & V_40 -> V_184 . V_185 [ V_110 ] , V_40 ) )
F_92 ( & V_40 -> V_184 . V_185 [ V_110 ] ,
& V_40 -> V_186 ) ;
else {
if ( V_110 == 0 )
V_40 -> V_184 . V_211
...
V_206 = F_93 ( & V_40 -> V_184 ,
& V_40 -> V_186 ) ;
}
if ( V_206 == NULL ) {
struct V_189 V_213 = { 0 } ;
for ( V_110 = 0 ; V_110 < V_214 ; V_110 ++ ) {
if ( F_77 ( (struct V_189 * )
& V_215 [ V_110 ] , V_40 ) )
F_92 ( & V_215 [ V_110 ] ,
& V_40 -> V_186 ) ;
}
...
if ( ( V_206 != NULL ) && ( V_32 -> V_171 == 0 ) ) {
F_95 ( & V_40 -> V_16 , V_206 ) ;
F_79 ( & V_40 -> V_16 ) ;
memcpy ( & V_40 -> V_41 , & V_217 , sizeof( V_217 ) ) ;
V_40 -> V_41 . V_118 = V_40 -> V_16 . V_24 *
( V_40 -> V_16 . V_193 / 8 ) ;
V_124 = F_85 ( V_32 , V_40 ) ;
} else
V_124 = - V_57 ;
error:
...
static T_8 F_97 ( struct V_218 * V_219 ,
struct V_220 * V_221 , char * V_1 ) {
struct V_45 * V_45 = F_98 ( V_219 ) ;
struct V_31 * V_32 = V_45 -> V_125 ;
return snprintf ( V_1 , V_59 , L_17 ,
F_14 ( & V_32 -> V_120 ) ) ;
}
static T_8 F_99 ( struct V_218 * V_219 ,
struct V_220 * V_221 , char * V_1 ) {
struct V_45 * V_45 = F_98 ( V_219 ) ;
struct V_31 * V_32 = V_45 -> V_125 ;
return snprintf ( V_1 , V_59 , L_17 ,
...
struct V_218 * V_219 = F_61 ( V_225 , struct V_218 , V_225 ) ;
struct V_45 * V_45 = F_98 ( V_219 ) ;
struct V_31 * V_32 = V_45 -> V_125 ;
if ( V_32 -> V_143 == NULL )
return 0 ;
...
struct V_45 * V_45 = F_98 ( V_219 ) ;
struct V_31 * V_32 = V_45 -> V_125 ;
if ( ( V_230 != V_209 ) || ( V_229 != 0 ) )
return 0 ;
F_89 ( V_32 , V_45 , V_228 , V_230 ) ;
if ( V_32 -> V_143 && ( memcmp ( V_228 , V_32 -> V_143 , V_230 ) == 0 ) ) {
F_78 ( L_19 ) ;
F_82 ( V_45 ) ;
return V_230 ;
} else
...
static T_8 F_104 ( struct V_218 * V_219 ,
struct V_220 * V_231 ,
...
0x60 , 0xFE , 0xC6 , 0x97 ,
0x16 , 0x3D , 0x47 , 0xF2 } ;
V_111 = F_49 ( V_32 -> V_146 , F_107 ( V_32 -> V_146 , 0 ) ,
V_233 ,
( V_234 | V_235 ) , 0 , 0 ,
...
static int F_114 ( struct V_237 * V_238 ,
...
if ( ! F_117 ( V_32 , V_261 , V_262 ) ) {
V_33 = - V_38 ;
F_51 ( L_32 ) ;
goto error;
}
V_40 = F_118 ( 0 , & V_238 -> V_32 ) ;
if ( ! V_40 ) {
V_33 = - V_38 ;
F_51 ( L_33 ) ;
goto error;
...
for ( V_110 = 0 ; V_110 < F_123 ( V_264 ) ; V_110 ++ ) {
V_33 = F_124 ( V_40 -> V_32 , & V_264 [ V_110 ] ) ;
if ( V_33 ) {
F_51 ( L_37 , V_33 ) ;
goto V_265;
}
}
V_33 = F_125 ( V_40 -> V_32 , & V_266 ) ;
if ( V_33 ) {
F_51 ( L_38 , V_33 ) ;
goto V_265;
}
...
return 0 ;
V_265:
for ( V_110 -= 1 ; V_110 >= 0 ; V_110 -- )
F_126 ( V_40 -> V_32 , & V_264 [ V_110 ] ) ;
error:
if ( V_32 ) {
if ( V_40 ) {
if ( V_40 -> V_164 . V_105 != 0 )
...
static void F_127 ( struct V_237 * V_238 )
{
struct V_31 * V_32 ;
struct V_45 * V_40 ;
int V_110 ;
...
{
struct V_179 * V_180 = V_35 -> V_269 ;
struct V_31 * V_32 = V_180 -> V_32 ;
unsigned long V_201 ;
if ( V_35 -> V_270 ) {
if ( ! ( V_35 -> V_270 == - V_271 ||
V_35 -> V_270 == - V_272 ||
...
V_35 -> V_102 = V_32 -> V_176 . V_50 ;
F_134 ( & V_32 -> V_176 . V_208 , V_201 ) ;
F_135 ( & V_180 -> V_276 , & V_32 -> V_176 . V_277 ) ;
V_32 -> V_176 . V_278 ++ ;
F_136 ( & V_32 -> V_176 . V_208 , V_201 ) ;
if ( V_141 )
F_75 ( & V_180 -> V_181 , 0 ) ;
else
F_66 ( & V_32 -> V_176 . V_182 ) ;
}
static void F_62 ( struct V_31 * V_32 )
{
int V_122 = V_32 -> V_176 . V_122 ;
struct V_136 * V_175 ;
struct V_179 * V_180 ;
struct V_35 * V_35 ;
int V_111 ;
...
F_18 ( L_44 ) ;
while ( V_122 -- ) {
V_111 = F_137 ( & V_32 -> V_176 . V_182 ) ;
if ( V_111 )
break;
F_134 ( & V_32 -> V_176 . V_208 , V_201 ) ;
V_175 = V_32 -> V_176 . V_277 . V_279 ;
F_138 ( V_175 ) ;
F_136 ( & V_32 -> V_176 . V_208 , V_201 ) ;
V_180 = F_139 ( V_175 , struct V_179 , V_276 ) ;
V_35 = V_180 -> V_35 ;
F_140 ( V_35 -> V_32 , V_32 -> V_176 . V_50 ,
V_35 -> V_39 , V_35 -> V_280 ) ;
F_141 ( V_35 ) ;
F_52 ( V_175 ) ;
}
}
static int F_117 ( struct V_31 * V_32 , int V_122 , T_10 V_50 )
{
int V_110 = 0 ;
struct V_35 * V_35 ;
struct V_179 * V_180 ;
char * V_1 ;
F_142 ( & V_32 -> V_176 . V_208 ) ;
V_32 -> V_176 . V_50 = V_50 ;
F_121 ( & V_32 -> V_176 . V_277 ) ;
while ( V_110 < V_122 ) {
V_180 = F_109 ( sizeof( struct V_179 ) , V_145 ) ;
if ( ! V_180 )
break;
V_180 -> V_32 = V_32 ;
F_120 ( & V_180 -> V_181 ,
...
V_180 -> V_35 = V_35 ;
V_1 = F_144 ( V_32 -> V_146 , V_262 , V_145 ,
& V_35 -> V_280 ) ;
if ( ! V_1 ) {
F_52 ( V_180 ) ;
F_141 ( V_35 ) ;
...
F_147 ( & V_32 -> V_176 . V_182 , V_110 ) ;
V_32 -> V_176 . V_122 = V_110 ;
V_32 -> V_176 . V_278 = V_110 ;
F_18 ( L_45 , V_110 , ( int ) V_50 ) ;
return V_110 ;
}
...
unsigned long V_201 ;
V_111 = F_148 ( & V_32 -> V_176 . V_182 , V_283 ) ;
if ( V_111 ) {
F_105 ( & V_32 -> V_275 , 1 ) ;
F_64 ( L_46 ,
V_111 , V_32 -> V_176 . V_278 ) ;
goto error;
}
F_134 ( & V_32 -> V_176 . V_208 , V_201 ) ;
F_149 ( F_150 ( & V_32 -> V_176 . V_277 ) ) ;
V_276 = V_32 -> V_176 . V_277 . V_279 ;
F_138 ( V_276 ) ;
V_32 -> V_176 . V_278 -- ;
F_136 ( & V_32 -> V_176 . V_208 , V_201 ) ;
V_180 = F_139 ( V_276 , struct V_179 , V_276 ) ;
V_35 = V_180 -> V_35 ;
error:
return V_35 ;
}
