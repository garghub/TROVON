...
case V_130 :
V_2 -> V_63 = & F_9 ;
V_2 -> V_131 = F_38 ( V_132 ) ;
V_101 = V_132 ;
break;
case V_133 :
V_2 -> V_63 = & F_10 ;
V_2 -> V_131 = F_38 ( V_134 ) ;
V_101 = V_134 ;
break;
default:
F_39 ( L_3 ) ;
...
V_2 -> V_136 = F_41 ( V_2 -> V_131 ,
sizeof( struct V_137 ) , V_126 ) ;
if ( ! V_2 -> V_136 ) {
V_5 = - V_127 ;
goto V_138;
}
V_2 -> V_101 = F_41 ( V_2 -> V_131 ,
sizeof( struct V_118 * ) , V_126 ) ;
if ( ! V_2 -> V_101 ) {
V_5 = - V_127 ;
goto V_139;
}
V_2 -> V_121 = F_41 ( V_2 -> V_131 ,
sizeof( struct V_61 * ) , V_126 ) ;
if ( ! V_2 -> V_121 ) {
V_5 = - V_127 ;
goto V_140;
}
for ( V_124 = 0 ; V_124 < V_2 -> V_131 ; V_124 ++ , V_101 ++ , V_120 ++ ) {
V_2 -> V_101 [ V_124 ] = V_101 ;
V_2 -> V_136 [ V_124 ] . V_141 = V_101 -> V_141 ;
V_2 -> V_136 [ V_124 ] . V_15 = V_124 ;
V_2 -> V_136 [ V_124 ] . V_142 = V_101 -> V_114 ;
if ( V_124 == V_20 || V_124 == V_22 ) {
V_2 -> V_136 [ V_124 ] . V_143 = & V_144 ;
V_2 -> V_136 [ V_124 ] . V_142 = V_110 *
V_145 ;
} else if ( V_124 == V_24 ) {
if ( F_37 ( V_65 ) == V_130 )
V_2 -> V_136 [ V_124 ] . V_143 = & V_146 ;
else
V_2 -> V_136 [ V_124 ] . V_143 = & V_144 ;
} else {
if ( F_37 ( V_65 ) == V_130 )
V_2 -> V_136 [ V_124 ] . V_143 = & V_147 ;
else
V_2 -> V_136 [ V_124 ] . V_143 = & V_148 ;
}
V_2 -> V_136 [ V_124 ] . type = V_149 ;
V_2 -> V_136 [ V_124 ] . V_150 = V_151 ;
V_121 = F_42 ( & V_2 -> V_136 [ V_124 ] ,
V_65 -> V_13 , V_120 , V_2 ) ;
if ( F_43 ( V_121 ) ) {
F_5 ( V_65 -> V_13 ,
L_4 ,
...
int V_124 ;
for ( V_124 = 0 ; V_124 < V_2 -> V_131 ; V_124 ++ )
F_45 ( V_2 -> V_121 [ V_124 ] ) ;
F_40 ( V_2 -> V_121 ) ;
F_40 ( V_2 -> V_101 ) ;
F_40 ( V_2 -> V_136 ) ;
