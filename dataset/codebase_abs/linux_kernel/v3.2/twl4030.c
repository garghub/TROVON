...
static int F_64 ( struct V_1 * V_2 , T_2 V_204 )
{
F_41 ( V_2 , V_126 ) ;
return 0 ;
}
...
{
struct V_9 * V_10 ;
V_10 = F_67 ( sizeof( struct V_9 ) , V_205 ) ;
if ( V_10 == NULL ) {
F_40 ( L_19 ) ;
return - V_206 ;
}
...
static int T_3 F_72 ( struct V_208 * V_209 )
{
struct V_40 * V_41 = V_209 -> V_35 . V_83 ;
if ( ! V_41 ) {
F_54 ( & V_209 -> V_35 , L_20 ) ;
return - V_116 ;
}
return F_73 ( & V_209 -> V_35 , & V_210 ,
V_211 , F_74 ( V_211 ) ) ;
}
static int T_4 F_75 ( struct V_208 * V_209 )
{
F_76 ( & V_209 -> V_35 ) ;
return 0 ;
}
