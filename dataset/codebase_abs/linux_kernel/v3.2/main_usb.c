...
V_1 -> V_237 = F_63 ( ( sizeof( V_248 ) * V_1 -> V_8 ) , V_242 ) ;
if ( V_1 -> V_237 == NULL ) {
...
V_1 -> V_252 = NULL ;
V_1 -> V_253 = 0 ;
memset ( V_1 -> V_237 , 0 , ( sizeof( V_248 ) * V_1 -> V_8 ) ) ;
...
V_235 -> V_247 = FALSE ;
F_65 ( V_1 -> V_249 , V_1 -> V_250 , V_235 ) ;
V_1 -> V_253 ++ ;
V_235 ++ ;
}
...
F_74 ( V_1 ) ;
F_75 ( & V_1 -> V_286 , ( void * ) V_287 , ( unsigned long ) V_1 ) ;
F_75 ( & V_1 -> V_288 , ( void * ) V_289 , ( unsigned long ) V_1 ) ;
F_75 ( & V_1 -> V_290 , ( void * ) V_291 , ( unsigned long ) V_1 ) ;
F_76 ( & ( V_1 -> V_64 . V_292 ) ) ;
V_1 -> V_293 = 100 ;
V_1 -> V_294 = V_295 ;
V_1 -> V_296 = TRUE ;
...
F_79 ( ( void * ) V_1 , V_314 , NULL ) ;
}
else {
F_79 ( ( void * ) V_1 , V_315 , NULL ) ;
}
F_80 ( V_1 -> V_184 ) ;
V_1 -> V_198 |= V_199 ;
{
...
static void T_15 F_87 ( struct V_193 * V_194 )
{
T_1 V_196 = F_36 ( V_194 ) ;
if ( ! V_196 )
return;
...
static int F_94 ( struct V_336 * V_180 , struct V_206 * V_184 )
{
T_1 V_1 = F_46 ( V_184 ) ;
...
static inline T_16 F_98 ( int V_228 , unsigned char * V_47 )
{
int V_343 = - 1 ;
while( -- V_228 >= 0 ) {
...
static unsigned char * F_99 ( const unsigned char * V_347 ,
...
static int F_100 ( unsigned char * string ,
unsigned char * V_351 ,
unsigned char * V_352 )
{
...
static unsigned char * F_101 ( T_1 V_1 )
{
...
if( F_100 ( L_39 , V_373 , V_360 ) == TRUE ) {
...
{
memset ( V_373 , 0 , sizeof( V_373 ) ) ;
if( F_100 ( L_44 , V_373 , V_360 ) == TRUE ) {
V_1 -> V_374 . V_376 = ( int ) F_107 ( V_373 , NULL , 10 ) ;
}
memset ( V_373 , 0 , sizeof( V_373 ) ) ;
if( F_100 ( L_45 , V_373 , V_360 ) == TRUE ) {
V_1 -> V_374 . V_294 = ( int ) F_107 ( V_373 , NULL , 10 ) ;
}
}
F_57 ( V_360 ) ;
return V_364 ;
}
static void F_72 ( struct V_206 * V_184 ) {
T_1 V_1 = ( T_1 ) F_46 ( V_184 ) ;
T_7 V_63 = & ( V_1 -> V_64 ) ;
T_16 V_377 [ 2 ] ;
int V_58 ;
...
F_109 (ha, dev) {
int V_392 = F_98 ( V_3 , V_379 -> V_393 ) >> 26 ;
V_377 [ V_392 >> 5 ] |= F_110 ( 1 << ( V_392 & 31 ) ) ;
}
for ( V_58 = 0 ; V_58 < 4 ; V_58 ++ ) {
F_111 ( V_1 , V_58 , * ( ( V_77 ) & V_377 [ 0 ] + V_58 ) ) ;
F_111 ( V_1 , V_58 + 4 , * ( ( V_77 ) & V_377 [ 1 ] + V_58 ) ) ;
}
V_1 -> V_383 &= ~ ( V_387 ) ;
V_1 -> V_383 |= ( V_385 | V_386 ) ;
}
...
static struct V_338 * F_112 ( struct V_206 * V_184 ) {
T_1 V_1 = ( T_1 ) F_46 ( V_184 ) ;
return & V_1 -> V_339 ;
}
static int F_113 ( struct V_206 * V_184 , struct V_394 * V_395 , int V_396 ) {
T_1 V_1 = ( T_1 ) F_46 ( V_184 ) ;
T_7 V_63 = & ( V_1 -> V_64 ) ;
T_18 V_397 ;
...
switch( V_396 ) {
case V_401 :
V_205 = F_114 ( V_184 , NULL , ( char * ) & ( V_399 -> V_402 . V_231 ) , NULL ) ;
break;
case V_403 :
V_205 = - V_404 ;
break;
case V_405 :
#ifdef F_77
V_205 = F_115 ( V_184 , NULL , & ( V_399 -> V_402 . V_406 ) , NULL ) ;
#else
V_205 = - V_404 ;
#endif
break;
case V_407 :
V_205 = F_116 ( V_184 , NULL , & ( V_399 -> V_402 . V_408 ) , NULL ) ;
break;
case V_409 :
V_205 = F_117 ( V_184 , NULL , & ( V_399 -> V_402 . V_408 ) , NULL ) ;
break;
case V_410 :
{
char V_411 [ V_412 + 1 ] ;
if ( V_399 -> V_402 . V_411 . V_228 > V_412 ) {
V_205 = - V_413 ;
break;
}
if ( F_118 ( V_411 , V_399 -> V_402 . V_411 . V_414 ,
V_399 -> V_402 . V_411 . V_228 ) ) {
V_205 = - V_400 ;
break;
}
V_205 = F_119 ( V_184 , NULL ,
& ( V_399 -> V_402 . V_411 ) , V_411 ) ;
}
break;
case V_415 :
{
char V_411 [ V_412 + 1 ] ;
if ( V_399 -> V_402 . V_411 . V_414 ) {
V_205 = F_120 ( V_184 , NULL ,
& ( V_399 -> V_402 . V_411 ) , V_411 ) ;
if ( F_121 ( V_399 -> V_402 . V_411 . V_414 ,
V_411 ,
V_399 -> V_402 . V_411 . V_228 ) )
V_205 = - V_400 ;
}
...
break;
case V_416 :
V_205 = F_122 ( V_184 , NULL , & ( V_399 -> V_402 . V_417 ) , NULL ) ;
break;
case V_418 :
V_205 = F_123 ( V_184 , NULL , & ( V_399 -> V_402 . V_417 ) , NULL ) ;
break;
case V_419 :
F_6 ( V_69 , V_70 L_49 ) ;
V_205 = - V_404 ;
...
break;
case V_421 :
V_205 = F_124 ( V_184 , NULL , & ( V_399 -> V_402 . V_422 ) , NULL ) ;
break;
case V_423 :
V_205 = F_125 ( V_184 , NULL , & ( V_399 -> V_402 . V_422 ) , NULL ) ;
break;
case V_424 :
V_205 = F_126 ( V_184 , NULL , & ( V_399 -> V_402 . V_425 ) , NULL ) ;
break;
case V_426 :
V_205 = F_127 ( V_184 , NULL , & ( V_399 -> V_402 . V_425 ) , NULL ) ;
break;
case V_427 :
V_205 = F_128 ( V_184 , NULL , & ( V_399 -> V_402 . V_428 ) , NULL ) ;
break;
case V_429 :
V_205 = F_129 ( V_184 , NULL , & ( V_399 -> V_402 . V_428 ) , NULL ) ;
break;
case V_430 :
V_205 = F_130 ( V_184 , NULL , & ( V_399 -> V_402 . V_431 ) , NULL ) ;
break;
case V_432 :
V_205 = F_131 ( V_184 , NULL , & ( V_399 -> V_402 . V_431 ) , NULL ) ;
break;
case V_433 :
{
char V_309 [ V_434 ] ;
if ( V_399 -> V_402 . V_435 . V_414 ) {
if ( V_399 -> V_402 . V_435 . V_228 > V_434 ) {
V_205 = - V_413 ;
break;
}
memset ( V_309 , 0 , V_434 ) ;
if ( F_118 ( V_309 ,
V_399 -> V_402 . V_435 . V_414 ,
V_399 -> V_402 . V_435 . V_228 ) ) {
V_205 = - V_400 ;
break;
}
} else if ( V_399 -> V_402 . V_435 . V_228 != 0 ) {
V_205 = - V_436 ;
break;
}
V_205 = F_132 ( V_184 , NULL , & ( V_399 -> V_402 . V_435 ) , V_309 ) ;
}
break;
case V_437 :
if ( ! F_133 ( V_438 ) ) {
...
{
char V_309 [ V_434 ] ;
V_205 = F_134 ( V_184 , NULL , & ( V_399 -> V_402 . V_435 ) , V_309 ) ;
if ( V_205 != 0 ) break;
if ( V_399 -> V_402 . V_435 . V_414 ) {
if ( F_121 ( V_399 -> V_402 . V_435 . V_414 ,
V_309 ,
V_399 -> V_402 . V_435 . V_228 ) )
V_205 = - V_400 ;
}
...
break;
case V_442 :
V_205 = F_135 ( V_184 , NULL , & ( V_399 -> V_402 . V_443 ) , NULL ) ;
break;
case V_444 :
V_205 = F_136 ( V_184 , NULL , & ( V_399 -> V_402 . V_443 ) , NULL ) ;
break;
case V_445 :
{
struct V_446 V_447 ;
V_205 = F_137 ( V_184 , NULL , & ( V_399 -> V_402 . V_47 ) , ( char * ) & V_447 ) ;
if ( F_121 ( V_399 -> V_402 . V_47 . V_414 , & V_447 , sizeof( struct V_446 ) ) )
V_205 = - V_400 ;
}
break;
case V_448 :
V_205 = F_138 ( V_184 , NULL , & ( V_399 -> V_402 . V_449 ) , NULL ) ;
break;
case V_450 :
V_205 = F_139 ( V_184 , NULL , & ( V_399 -> V_402 . V_449 ) , NULL ) ;
break;
case V_451 :
V_205 = F_140 ( V_184 , NULL , & ( V_399 -> V_402 . V_452 ) , NULL ) ;
break;
case V_453 :
F_6 ( V_69 , V_70 L_52 ) ;
V_205 = - V_404 ;
...
case V_454 :
{
char V_360 [ V_455 * ( sizeof( struct V_456 ) + sizeof( struct V_457 ) ) ] ;
if ( V_399 -> V_402 . V_47 . V_414 ) {
V_205 = F_141 ( V_184 , NULL , & ( V_399 -> V_402 . V_47 ) , V_360 ) ;
if ( V_205 == 0 ) {
if ( F_121 ( V_399 -> V_402 . V_47 . V_414 ,
V_360 ,
( V_399 -> V_402 . V_47 . V_228 * ( sizeof( struct V_456 ) + sizeof( struct V_457 ) ) )
) )
V_205 = - V_400 ;
}
}
...
case V_461 :
F_6 ( V_69 , V_70 L_55 ) ;
V_205 = F_143 ( V_184 , NULL , & ( V_399 -> V_402 . V_462 ) , NULL ) ;
break;
case V_463 :
F_6 ( V_69 , V_70 L_56 ) ;
V_205 = F_144 ( V_184 , NULL , & ( V_399 -> V_402 . V_462 ) , NULL ) ;
break;
case V_464 :
F_6 ( V_69 , V_70 L_57 ) ;
V_205 = F_145 ( V_184 , NULL , & ( V_399 -> V_402 . V_47 ) , V_399 -> V_402 . V_47 . V_414 ) ;
break;
case V_465 :
F_6 ( V_69 , V_70 L_58 ) ;
V_205 = F_146 ( V_184 , NULL , & ( V_399 -> V_402 . V_47 ) , V_399 -> V_402 . V_47 . V_414 ) ;
break;
case V_466 :
{
char V_467 [ sizeof( struct V_468 ) + V_469 + 1 ] ;
F_6 ( V_69 , V_70 L_59 ) ;
if( V_399 -> V_402 . V_435 . V_414 ) {
memset ( V_467 , 0 , sizeof( struct V_468 ) + V_469 + 1 ) ;
if( V_399 -> V_402 . V_435 . V_228 > ( sizeof( struct V_468 ) + V_469 ) ) {
V_205 = - V_413 ;
break;
}
if( F_118 ( V_467 , V_399 -> V_402 . V_435 . V_414 , V_399 -> V_402 . V_435 . V_228 ) ) {
V_205 = - V_400 ;
break;
}
} else if( V_399 -> V_402 . V_435 . V_228 != 0 ) {
...
V_205 = F_147 ( V_184 , NULL , & ( V_399 -> V_402 . V_435 ) , V_467 ) ;
}
break;
case V_470 :
F_6 ( V_69 , V_70 L_60 ) ;
V_205 = F_148 ( V_184 , NULL , & ( V_399 -> V_402 . V_435 ) , NULL ) ;
break;
case V_471 :
F_6 ( V_69 , V_70 L_61 ) ;
V_205 = F_149 ( V_184 , NULL , & ( V_399 -> V_402 . V_47 ) , V_399 -> V_402 . V_47 . V_414 ) ;
break;
#endif
case V_472 :
if ( ! ( V_1 -> V_198 & V_199 ) ) {
...
if ( F_150 ( 0 , ( void * ) & ( V_63 -> V_478 ) ) ) {
return - V_479 ;
}
V_205 = F_151 ( V_1 , V_395 ) ;
F_152 ( 0 , ( void * ) & ( V_63 -> V_478 ) ) ;
break;
case V_480 :
if ( ! ( V_1 -> V_198 & V_199 ) ) {
V_205 = - V_400 ;
...
break;
case V_482 :
return F_155 ( V_184 , ( void * ) V_395 -> V_483 ) ;
default:
V_205 = - V_404 ;
...
F_7 ( & V_1 -> V_71 ) ;
if ( V_1 -> V_319 &&
memcmp ( V_63 -> V_485 , V_63 -> V_321 , V_322 + V_323 ) ) {
F_79 ( ( void * ) V_1 , V_320 , NULL ) ;
} else {
V_1 -> V_319 = FALSE ;
V_63 -> V_331 = V_332 ;
...
static int F_155 ( struct V_206 * V_184 , void * V_488 )
{
T_16 V_489 ;
if ( F_118 ( & V_489 , V_488 , sizeof( V_489 ) ) )
return - V_400 ;
switch ( V_489 ) {
case V_490 : {
struct V_491 V_492 = { V_490 } ;
strncpy ( V_492 . V_493 , V_494 , sizeof( V_492 . V_493 ) - 1 ) ;
strncpy ( V_492 . V_495 , V_210 , sizeof( V_492 . V_495 ) - 1 ) ;
if ( F_121 ( V_488 , & V_492 , sizeof( V_492 ) ) )
return - V_400 ;
return 0 ;
}
}
...
{
F_44 (KERN_NOTICE DEVICE_FULL_DRV_NAM L_64 DEVICE_VERSION) ;
return F_157 ( & V_496 ) ;
}
