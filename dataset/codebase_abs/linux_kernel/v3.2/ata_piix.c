...
static int T_6 F_75 ( struct V_8 * V_9 ,
const struct V_157 * V_158 )
{
struct V_18 * V_11 = & V_9 -> V_11 ;
struct V_128 V_159 [ 2 ] ;
const struct V_128 * V_160 [] = { & V_159 [ 0 ] , & V_159 [ 1 ] } ;
...
int V_100 ;
F_76 ( & V_9 -> V_11 , V_165 ) ;
if ( ! V_166 && V_158 -> V_153 >= V_167 )
return - V_168 ;
if ( F_72 ( V_9 ) ) {
V_137 [ V_158 -> V_153 ] . V_3 |=
V_169 |
V_170 ;
F_62 ( & V_9 -> V_11 , L_46
L_47 ) ;
}
V_159 [ 0 ] = V_137 [ V_158 -> V_153 ] ;
V_159 [ 1 ] = V_137 [ V_158 -> V_153 ] ;
V_164 = V_159 [ 0 ] . V_3 ;
V_100 = F_77 ( V_9 ) ;
if ( V_100 )
return V_100 ;
V_13 = F_78 ( V_11 , sizeof( * V_13 ) , V_171 ) ;
if ( ! V_13 )
return - V_112 ;
F_79 ( V_9 , V_151 , & V_13 -> V_27 ) ;
...
if ( V_164 & V_172 )
V_13 -> V_130 = F_61 ( V_9 , V_159 ,
V_173 [ V_158 -> V_153 ] ) ;
V_100 = F_80 ( V_9 , V_160 , & V_10 ) ;
if ( V_100 )
return V_100 ;
V_10 -> V_14 = V_13 ;
if ( V_164 & V_172 ) {
F_58 ( V_10 , V_173 [ V_158 -> V_153 ] ) ;
V_100 = F_66 ( V_10 ) ;
if ( V_100 )
return V_100 ;
...
F_81 ( V_9 , 1 ) ;
if ( F_55 ( V_9 ) ) {
V_10 -> V_143 [ 0 ] -> V_176 = 0 ;
V_10 -> V_143 [ 0 ] -> V_52 = 0 ;
V_10 -> V_143 [ 1 ] -> V_176 = 0 ;
V_10 -> V_143 [ 1 ] -> V_52 = 0 ;
}
V_10 -> V_3 |= V_177 ;
F_82 ( V_9 ) ;
return F_83 ( V_10 , V_178 , V_162 ) ;
}
