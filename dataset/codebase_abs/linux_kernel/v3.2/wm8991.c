...
F_29 ( V_6 , V_148 ,
F_30 ( V_148 ) ) ;
F_31 ( & V_6 -> V_118 , V_149 ,
F_30 ( V_149 ) ) ;
F_32 ( & V_6 -> V_118 , V_150 ,
F_30 ( V_150 ) ) ;
return 0 ;
}
static T_5 int F_33 ( struct V_151 * V_152 ,
const struct V_153 * V_154 )
{
struct V_136 * V_137 ;
int V_9 ;
V_137 = F_34 ( sizeof *V_137 , V_155 ) ;
if ( ! V_137 )
return - V_156 ;
V_137 -> V_138 = V_157 ;
F_35 ( V_152 , V_137 ) ;
V_9 = F_36 ( & V_152 -> V_139 ,
& V_158 , & V_159 , 1 ) ;
if ( V_9 < 0 )
F_37 ( V_137 ) ;
return V_9 ;
}
static T_6 int F_38 ( struct V_151 * V_160 )
{
F_39 ( & V_160 -> V_139 ) ;
F_37 ( F_40 ( V_160 ) ) ;
return 0 ;
