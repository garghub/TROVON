...
static int F_164 ( T_6 * V_211 , int V_212 ,
void T_4 * V_213 ,
T_5 * V_214 , T_7 * V_215 )
{
int * V_222 = V_211 -> V_202 ;
int V_3 = * V_222 ;
T_7 V_223 = * V_215 ;
int V_117 = F_161 ( V_211 , V_212 , V_213 , V_214 , V_215 ) ;
if ( V_212 && * V_222 != V_3 ) {
struct V_1 * V_1 = V_211 -> V_220 ;
if ( V_222 != & F_158 ( V_1 , V_48 ) ) {
if ( ! F_165 () ) {
* V_222 = V_3 ;
* V_215 = V_223 ;
return F_166 () ;
}
if ( V_222 == & F_157 ( V_1 , V_48 ) ) {
F_156 ( V_1 ) ;
} else if ( * V_222 ) {
struct V_218 * V_41 = V_211 -> V_219 ;
struct V_29 * V_30 =
...
static int F_168 ( struct V_1 * V_1 , char * V_224 ,
struct V_218 * V_225 )
{
int V_199 ;
struct V_226 * V_227 ;
...
V_227 = F_170 ( & V_231 , sizeof( * V_227 ) , V_31 ) ;
if ( ! V_227 )
goto V_40;
for ( V_199 = 0 ; V_199 < F_171 ( V_227 -> V_232 ) - 1 ; V_199 ++ ) {
V_227 -> V_232 [ V_199 ] . V_202 += ( char * ) V_225 - ( char * ) & V_218 ;
V_227 -> V_232 [ V_199 ] . V_219 = V_225 ;
V_227 -> V_232 [ V_199 ] . V_220 = V_1 ;
}
V_227 -> V_224 = F_172 ( V_224 , V_31 ) ;
if ( ! V_227 -> V_224 )
goto free;
V_229 [ F_169 ] . V_230 = V_227 -> V_224 ;
V_227 -> V_233 = F_173 ( V_1 , V_229 ,
V_227 -> V_232 ) ;
if ( ! V_227 -> V_233 )
goto V_234;
V_225 -> V_44 = V_227 ;
...
static void F_174 ( struct V_218 * V_41 )
{
struct V_226 * V_227 = V_41 -> V_44 ;
if ( V_227 == NULL )
return;
V_41 -> V_44 = NULL ;
F_175 ( V_227 -> V_233 ) ;
...
{
int V_94 ;
struct V_218 * V_235 , * V_236 ;
#ifdef F_179
struct T_6 * V_237 = V_238 ;
struct V_239 * V_240 ;
#endif
V_94 = - V_164 ;
V_235 = & V_218 ;
V_236 = & V_241 ;
if ( ! F_12 ( V_1 , & V_242 ) ) {
V_235 = F_170 ( V_235 , sizeof( V_218 ) , V_31 ) ;
if ( V_235 == NULL )
goto V_243;
V_236 = F_170 ( V_236 , sizeof( V_241 ) , V_31 ) ;
if ( V_236 == NULL )
goto V_244;
#ifdef F_179
V_237 = F_170 ( V_237 , sizeof( V_238 ) , V_31 ) ;
if ( V_237 == NULL )
goto V_245;
V_237 [ 0 ] . V_202 = & V_235 -> V_202 [ V_246 - 1 ] ;
V_237 [ 0 ] . V_219 = V_235 ;
V_237 [ 0 ] . V_220 = V_1 ;
#endif
}
#ifdef F_179
V_94 = F_168 ( V_1 , L_9 , V_235 ) ;
if ( V_94 < 0 )
goto V_247;
V_94 = F_168 ( V_1 , L_10 , V_236 ) ;
if ( V_94 < 0 )
goto V_248;
V_94 = - V_164 ;
V_240 = F_173 ( V_1 , V_249 , V_237 ) ;
if ( V_240 == NULL )
goto V_250;
V_1 -> V_42 . V_240 = V_240 ;
#endif
V_1 -> V_42 . V_251 = V_235 ;
V_1 -> V_42 . V_43 = V_236 ;
return 0 ;
#ifdef F_179
V_250:
...
#ifdef F_179
struct T_6 * V_237 ;
V_237 = V_1 -> V_42 . V_240 -> V_252 ;
F_175 ( V_1 -> V_42 . V_240 ) ;
F_174 ( V_1 -> V_42 . V_43 ) ;
F_174 ( V_1 -> V_42 . V_251 ) ;
F_26 ( V_237 ) ;
#endif
F_26 ( V_1 -> V_42 . V_43 ) ;
F_26 ( V_1 -> V_42 . V_251 ) ;
...
F_185 ( & V_255 ) ;
F_186 ( & V_256 ) ;
F_187 ( V_254 , V_75 , F_84 , NULL , NULL ) ;
F_187 ( V_254 , V_71 , F_71 , NULL , NULL ) ;
F_187 ( V_254 , V_257 , NULL , F_136 , NULL ) ;
}
