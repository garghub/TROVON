...
if ( ! V_53 )
return NULL ;
if ( V_51 && ( V_11 & V_85 ) != V_86 )
V_42 = 0 ;
V_75 = F_57 ( V_53 , V_9 , V_42 ) ;
if ( ! V_75 )
V_75 = F_57 ( V_53 , V_9 , V_42 ^ V_82 ) ;
if ( V_75 )
F_30 ( & V_75 -> V_62 ) ;
F_59 ( V_53 ) ;
return V_75 ;
...
static void
F_64 ( struct V_89 * V_90 , struct V_91 * V_92 )
{
...
V_75 -> V_11 |= V_107 ;
if ( V_100 -> V_108 == 0 || V_100 -> V_108 > V_75 -> V_108 )
V_75 -> V_11 &= ~ V_109 ;
V_75 -> V_108 = V_100 -> V_108 ;
V_75 -> V_110 = V_100 -> V_110 ;
F_66 ( & V_75 -> V_111 ) ;
F_62 ( V_75 ) ;
F_68 ( & V_75 -> V_111 ) ;
if ( V_101 )
...
static int
F_77 ( struct V_52 * V_53 , struct V_99 * V_100 ,
struct V_74 * * V_116 )
{
struct V_74 * V_75 ;
unsigned V_117 ;
...
if ( ( ! ( V_117 & V_119 ) ||
V_117 & V_120 ) &&
! F_2 ( V_53 -> V_2 , & V_100 -> V_4 . V_118 ) )
return - V_121 ;
} else
#endif
{
V_117 = F_80 ( V_53 -> V_2 , V_100 -> V_4 . V_45 ) ;
...
V_75 -> V_64 = V_53 -> V_42 ;
V_75 -> V_84 = V_53 -> V_51 ;
F_83 ( V_53 -> V_39 , & V_75 -> V_4 , & V_100 -> V_4 ) ;
V_75 -> V_42 = V_100 -> V_42 ;
F_8 ( & V_75 -> V_128 , 0 ) ;
F_8 ( & V_75 -> V_129 , 0 ) ;
F_8 ( & V_75 -> V_130 , 0 ) ;
F_8 ( & V_75 -> V_62 , 1 ) ;
...
static int
F_86 ( struct V_52 * V_53 , struct V_99 * V_100 )
{
struct V_74 * V_75 ;
union V_41 V_9 ;
T_1 V_82 = V_100 -> V_42 ;
...
V_131 = F_77 ( V_53 , V_100 , & V_75 ) ;
}
F_85 ( 2 ) ;
return V_131 ;
}
static int
F_88 ( struct V_52 * V_53 , struct V_99 * V_100 )
{
struct V_74 * V_75 ;
union V_41 V_9 ;
T_1 V_82 = V_100 -> V_42 ;
...
static int
F_92 ( struct V_52 * V_53 , struct V_99 * V_100 )
{
struct V_74 * V_75 ;
T_1 V_82 = V_100 -> V_42 ;
F_78 ( 2 ) ;
V_75 = F_57 ( V_53 , & V_100 -> V_4 , V_82 ) ;
if ( V_75 == NULL ) {
F_87 ( 1 , L_19 , V_56 ) ;
return - V_134 ;
}
...
F_133 ( V_188 , L_46 , V_207 . V_94 ,
V_207 . V_95 , V_207 . V_96 ,
( unsigned long long ) V_207 . V_97 ,
( unsigned long long ) V_207 . V_98 ) ;
F_135 ( V_188 ,
L_47 ) ;
F_133 ( V_188 , L_48 ,
...
{
struct V_2 * V_2 = F_140 ( V_188 ) ;
struct V_91 * V_171 = & F_40 ( V_2 ) -> V_171 ;
...
V_97 = V_138 -> V_216 . V_97 ;
V_98 = V_138 -> V_216 . V_98 ;
} while ( F_147 ( & V_138 -> V_215 , V_214 ) );
F_133 ( V_188 , L_51 ,
V_16 , V_138 -> V_216 . V_94 , V_138 -> V_216 . V_95 ,
V_138 -> V_216 . V_96 , ( T_9 ) V_97 ,
( T_9 ) V_98 ) ;
}
F_66 ( & V_171 -> V_93 ) ;
F_133 ( V_188 , L_52 ,
V_171 -> V_216 . V_94 , V_171 -> V_216 . V_95 ,
V_171 -> V_216 . V_96 ,
( unsigned long long ) V_171 -> V_216 . V_97 ,
( unsigned long long ) V_171 -> V_216 . V_98 ) ;
F_67 ( & V_213 , V_171 ) ;
F_68 ( & V_171 -> V_93 ) ;
F_135 ( V_188 ,
L_53 ) ;
...
V_100 -> V_4 . V_45 = V_234 -> V_4 ;
V_100 -> V_42 = V_234 -> V_42 ;
V_100 -> V_102 = V_234 -> V_102 ;
V_100 -> V_103 = V_234 -> V_103 ;
V_100 -> V_108 = V_234 -> V_108 ;
V_100 -> V_110 = V_234 -> V_110 ;
}
static int
...
break;
case V_266 :
V_131 = F_86 ( V_53 , & V_100 ) ;
break;
case V_267 :
V_131 = F_88 ( V_53 , & V_100 ) ;
break;
case V_268 :
V_131 = F_92 ( V_53 , & V_100 ) ;
break;
default:
V_131 = - V_121 ;
}
...
static void
F_162 ( struct V_269 * V_90 , struct V_52 * V_92 )
{
V_90 -> V_57 = V_92 -> V_57 ;
V_90 -> V_4 = V_92 -> V_4 . V_45 ;
V_90 -> V_42 = V_92 -> V_42 ;
V_90 -> V_51 = V_92 -> V_51 ;
F_163 ( V_90 -> V_144 , V_92 -> V_114 -> V_164 , sizeof( V_90 -> V_144 ) ) ;
V_90 -> V_11 = V_92 -> V_11 ;
V_90 -> V_148 = V_92 -> V_148 / V_149 ;
V_90 -> V_147 = V_92 -> V_147 ;
V_90 -> V_113 = V_92 -> V_113 ;
F_64 ( & V_90 -> V_76 , & V_92 -> V_76 ) ;
}
static inline int
...
V_274 . V_102 = F_14 ( & V_75 -> V_102 ) ;
V_274 . V_103 = F_14 ( & V_75 -> V_103 ) ;
...
return - V_307 ;
F_64 ( & V_216 , V_76 ) ;
F_173 ( V_303 , V_308 , V_216 . V_94 ) ;
F_173 ( V_303 , V_309 , V_216 . V_95 ) ;
F_173 ( V_303 , V_310 , V_216 . V_96 ) ;
F_174 ( V_303 , V_311 , V_216 . V_97 ) ;
F_174 ( V_303 , V_312 , V_216 . V_98 ) ;
...
F_173 ( V_303 , V_364 ,
F_14 ( & V_75 -> V_102 ) & V_85 ) ;
F_173 ( V_303 , V_365 , F_14 ( & V_75 -> V_103 ) ) ;
...
return - V_121 ;
memset ( V_100 , 0 , sizeof( * V_100 ) ) ;
F_192 ( & V_100 -> V_4 , V_352 , sizeof( V_100 -> V_4 ) ) ;
V_100 -> V_42 = F_190 ( V_349 ) ;
if ( V_344 ) {
...
return - V_121 ;
V_100 -> V_102 = F_191 ( V_378 )
& V_85 ;
V_100 -> V_103 = F_191 ( V_379 ) ;
V_100 -> V_108 = F_191 ( V_380 ) ;
V_100 -> V_110 = F_191 ( V_381 ) ;
}
return 0 ;
}
...
if ( ! V_14 -> V_171 . V_77 )
return - V_125 ;
F_84 ( & V_14 -> V_171 . V_93 ) ;
F_231 ( V_2 , L_63 , 0 , & V_435 ) ;
F_231 ( V_2 , L_64 , 0 , & V_436 ) ;
F_231 ( V_2 , L_65 , 0 ,
& V_437 ) ;
if ( F_221 ( V_2 ) )
goto V_438;
