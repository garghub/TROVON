...
V_272 -> V_278 . V_297 ( & V_272 -> V_278 , error ) ;
}
...
V_64 -> V_90 = V_8 ; V_64 -> V_82 = V_298 ;
V_8 = V_64 -> V_88 ; V_298 = V_64 -> V_80 ;
while ( V_298 != 0 ) {
...
V_64 -> V_88 = V_8 ; V_64 -> V_80 = V_298 ;
V_8 = V_64 -> V_87 ; V_298 = V_64 -> V_79 ;
while ( V_298 != 0 ) {
...
V_64 -> V_87 = V_8 ; V_64 -> V_79 = V_298 ;
V_8 = V_64 -> V_89 ; V_298 = V_64 -> V_81 ;
while ( V_298 != 0 ) {
...
static void F_76 ( struct V_301 * V_302 )
{
struct V_303 * V_304 = F_77 ( V_302 ) ;
struct V_1 * V_2 = F_78 ( V_304 , struct V_1 , V_302 ) ;
unsigned long V_231 ;
int V_300 = 0 ;
T_1 V_305 = 0 ;
F_64 ( & V_2 -> V_283 , V_231 ) ;
...
V_2 -> V_286 -- ;
if ( ( V_2 -> V_306 == V_2 -> V_299 ) && V_2 -> V_225 )
V_300 = 1 ;
V_2 -> V_306 = V_2 -> V_299 ;
F_65 ( & V_2 -> V_283 , V_231 ) ;
if ( V_300 ) {
...
F_37 ( L_37
L_38 ,
V_2 -> V_11 , V_305 , V_2 -> V_286 , V_2 -> V_225 ,
V_2 -> V_299 , V_2 -> V_307 . V_308 , V_2 -> V_307 . V_309 ,
V_300 ) ;
F_37 ( L_39 , V_270 ) ;
for ( V_8 = 0 ; V_8 < V_72 ; ++ V_8 ) {
...
F_80 ( & V_2 -> V_302 , V_311 ) ;
}
static T_9 F_81 ( int V_312 , void * V_35 )
{
...
F_10 ( L_41
L_42 ,
V_2 -> V_11 , V_313 , V_2 -> V_45 , V_313 & V_2 -> V_45 , V_64 -> V_83 ,
V_64 -> V_83 , V_64 -> V_84 , V_64 -> V_85 , V_64 -> V_86 ,
V_64 -> V_79 , V_64 -> V_80 , V_64 -> V_81 , V_64 -> V_82 ) ;
if ( ( V_313 & V_2 -> V_45 ) == 0 )
return V_315 ;
F_7 ( V_2 , V_13 , V_313 & V_2 -> V_45 ) ;
if ( V_313 & V_138 )
F_4 ( V_2 , V_150 , F_1 ( V_2 , V_150 ) ) ;
if ( V_313 & V_139 )
F_7 ( V_2 , V_316 ,
F_3 ( V_2 , V_316 ) | V_317 ) ;
V_314 = V_313 & ( V_129 | V_124 ) ;
if ( V_314 ) {
T_1 V_318 = F_1 ( V_2 , V_150 ) ;
F_37 ( V_319 L_43 ,
V_2 -> V_11 , ! ! ( V_313 & V_129 ) ,
! ! ( V_313 & V_124 ) ,
V_318 , ! ! ( V_318 & V_151 ) ) ;
if ( ! ! ( V_318 & V_151 ) )
F_4 ( V_2 , V_150 , V_151 ) ;
F_7 ( V_2 , V_13 , V_313 & ( V_129 |
V_124 ) ) ;
}
V_314 = V_313 & ( V_134 | V_130 |
V_120 | V_125 ) ;
if ( V_314 ) {
F_37 ( V_319 L_44 ,
V_2 -> V_11 , ! ! ( V_313 & V_134 ) ,
! ! ( V_313 & V_130 ) ,
! ! ( V_313 & V_120 ) ,
! ! ( V_313 & V_125 ) ) ;
F_13 ( V_2 , 1 ) ;
...
int V_8 ;
for ( V_8 = 0 ; V_8 < V_72 ; ++ V_8 ) {
struct V_323 * V_324 = & V_64 -> V_73 [ V_8 ] ;
if ( V_2 -> V_224 [ V_8 ] ) {
F_74 ( V_2 -> V_224 [ V_8 ] ,
( V_324 -> V_226 & F_33 ( V_227 ) ) ? - V_59 : 0 ) ;
F_73 ( V_2 , V_8 ) ;
}
}
F_64 ( & V_2 -> V_283 , V_231 ) ;
while ( ( V_322 = F_83 ( & V_2 -> V_307 ) ) ) {
V_272 = F_78 ( V_322 , struct V_271 , V_278 ) ;
F_65 ( & V_2 -> V_283 , V_231 ) ;
F_74 ( V_272 , - V_59 ) ;
F_64 ( & V_2 -> V_283 , V_231 ) ;
}
...
static int F_84 ( struct V_325 * V_326 , const T_5 * V_174 ,
unsigned int V_254 )
{
struct V_327 * V_279 = F_85 ( V_326 ) ;
...
if ( V_254 == V_330 ) {
T_1 V_331 [ V_332 ] ;
int V_4 = F_87 ( V_331 , V_174 ) ;
if ( F_88 ( V_4 == 0 ) && ( V_279 -> V_333 & V_334 ) ) {
V_279 -> V_333 |= V_335 ;
return - V_233 ;
}
}
...
struct V_1 * V_2 = V_188 -> V_2 ;
int V_275 = - V_285 ;
if ( V_2 -> V_225 + F_23 ( V_272 -> V_191 , V_265 ) <= V_284 )
V_275 = F_61 ( V_272 ) ;
if ( V_275 == - V_285 ) {
unsigned long V_231 ;
F_64 ( & V_2 -> V_283 , V_231 ) ;
V_275 = F_90 ( & V_2 -> V_307 , V_272 ) ;
F_65 ( & V_2 -> V_283 , V_231 ) ;
}
return V_275 ;
}
static int F_91 ( struct V_271 * V_272 , T_5 V_193 ,
T_5 type , T_5 V_178 )
{
struct V_187 * V_188 = F_62 ( V_272 -> V_278 . V_279 ) ;
struct V_189 * V_190 = F_63 ( V_272 ) ;
unsigned V_177 ;
V_177 = F_92 ( F_93 ( V_272 ) ) ;
if ( V_272 -> V_337 && V_178 != V_204 ) {
if ( type == V_213 )
V_177 = V_338 ;
else if ( type == V_222 )
V_177 = V_330 ;
...
V_190 -> V_178 = V_178 ;
V_190 -> type = type ;
V_190 -> V_176 = V_272 -> V_337 ;
V_190 -> V_177 = V_177 ;
return F_89 ( V_272 ) ;
}
static int F_94 ( struct V_1 * V_2 )
{
struct V_321 * V_322 , * V_340 ;
struct V_271 * V_272 ;
unsigned long V_231 ;
int V_275 = 0 ;
while ( V_2 -> V_225 < V_284 ) {
F_64 ( & V_2 -> V_283 , V_231 ) ;
V_340 = F_95 ( & V_2 -> V_307 ) ;
V_322 = F_83 ( & V_2 -> V_307 ) ;
F_65 ( & V_2 -> V_283 , V_231 ) ;
if ( ! V_322 )
break;
if ( V_340 )
V_340 -> V_297 ( V_340 , - V_341 ) ;
V_272 = F_78 ( V_322 , struct V_271 , V_278 ) ;
V_275 = F_89 ( V_272 ) ;
if ( V_275 )
break;
...
static int F_96 ( struct V_271 * V_272 , T_5 V_193 ,
T_5 type , T_5 V_178 )
{
int V_275 ;
struct V_187 * V_188 = F_62 ( V_272 -> V_278 . V_279 ) ;
struct V_1 * V_2 = V_188 -> V_2 ;
V_275 = F_91 ( V_272 , V_193 , type , V_178 ) ;
if ( V_275 )
return V_275 ;
if ( V_2 -> V_225 < V_284 && V_2 -> V_307 . V_308 )
F_94 ( V_2 ) ;
return - V_341 ;
}
static inline int F_97 ( struct V_271 * V_272 )
{
return F_96 ( V_272 , V_197 ,
V_213 , V_204 ) ;
}
...
static int F_121 ( struct V_327 * V_279 )
{
struct V_342 * V_343 = V_279 -> V_344 ;
struct V_345 * V_346 = F_122 ( V_343 ) ;
struct V_187 * V_188 = F_62 ( V_279 ) ;
V_188 -> V_2 = V_346 -> V_2 ;
V_279 -> V_347 . V_348 = sizeof( struct V_189 ) ;
return 0 ;
}
static int F_123 ( struct V_1 * V_2 , struct V_349 * V_248 )
{
struct V_345 * V_343 ;
int V_275 ;
V_343 = F_124 ( sizeof( struct V_345 ) , V_350 ) ;
if ( ! V_343 )
return - V_351 ;
snprintf ( V_343 -> V_343 . V_352 , V_353 , L_46 , V_248 -> V_11 ) ;
snprintf ( V_343 -> V_343 . V_354 , V_353 , L_47 ,
V_248 -> V_355 , V_2 -> V_11 ) ;
V_343 -> V_343 . V_356 = 300 ;
V_343 -> V_343 . V_357 = V_358 | V_359 ;
V_343 -> V_343 . V_360 = V_248 -> V_361 ;
V_343 -> V_343 . V_362 = sizeof( struct V_187 ) ;
V_343 -> V_343 . V_363 = 0 ;
V_343 -> V_343 . V_364 = & V_365 ;
V_343 -> V_343 . V_366 = V_367 ;
V_343 -> V_343 . V_368 . V_369 = V_248 -> V_369 ;
V_343 -> V_343 . V_370 = F_121 ;
V_343 -> V_2 = V_2 ;
F_125 ( & V_343 -> V_371 , & V_2 -> V_372 ) ;
V_275 = F_126 ( & V_343 -> V_343 ) ;
if ( V_275 ) {
F_127 ( & V_343 -> V_371 ) ;
F_128 ( V_343 ) ;
}
...
{
struct V_345 * V_25 , * V_253 ;
F_130 (a, n, &dev->alg_list, entry) {
F_127 ( & V_25 -> V_371 ) ;
F_131 ( & V_25 -> V_343 ) ;
F_128 ( V_25 ) ;
}
...
{
int V_8 , V_275 ;
for ( V_8 = 0 ; V_8 < F_30 ( V_373 ) ; ++ V_8 ) {
V_275 = F_123 ( V_2 , & V_373 [ V_8 ] ) ;
if ( V_275 )
goto V_281;
}
return 0 ;
...
static void F_133 ( unsigned long V_35 )
{
struct V_1 * V_2 = (struct V_1 * ) V_35 ;
F_75 ( V_2 , 0 ) ;
if ( V_2 -> V_225 < V_284 && V_2 -> V_307 . V_308 )
...
static int T_10 F_134 ( struct V_374 * V_54 , const struct V_375 * V_376 )
{
int V_275 , V_8 ;
struct V_1 * V_2 ;
char V_11 [ 8 ] ;
...
return V_275 ;
F_136 ( V_54 ) ;
V_275 = F_137 ( V_54 , F_138 ( 32 ) ) ;
if ( V_275 )
goto V_377;
snprintf ( V_11 , sizeof( V_11 ) , L_48 ,
F_139 ( & V_378 ) - 1 ) ;
V_275 = F_140 ( V_54 , V_11 ) ;
if ( V_275 )
goto V_377;
if ( F_141 ( V_54 , 0 ) < V_379 ||
F_141 ( V_54 , 1 ) < V_380 ||
F_141 ( V_54 , 2 ) < V_381 ) {
F_10 ( L_49 ,
F_31 ( V_54 ) ) ;
...
V_2 = F_124 ( sizeof( struct V_1 ) + sizeof( struct V_342 ) ,
V_350 ) ;
if ( ! V_2 ) {
V_275 = - V_351 ;
goto V_382;
...
V_50 = F_144 ( V_54 , V_8 ) ;
V_236 = F_141 ( V_54 , V_8 ) ;
V_2 -> V_5 [ V_8 ] = F_145 ( V_50 , V_236 ) ;
if ( ! V_2 -> V_5 [ V_8 ] )
goto V_383;
}
V_2 -> V_65 = F_146 ( V_54 , sizeof( struct V_63 ) ,
& V_2 -> V_67 ) ;
if ( ! V_2 -> V_65 ) {
F_10 ( L_50 ) ;
goto V_383;
...
V_2 -> V_54 = V_54 ;
V_2 -> V_312 = V_54 -> V_312 ;
for ( V_8 = 0 ; V_8 < V_72 ; ++ V_8 )
V_2 -> V_224 [ V_8 ] = NULL ;
F_147 ( V_54 , V_2 ) ;
F_148 ( & V_2 -> V_310 , F_133 , ( unsigned long ) V_2 ) ;
F_149 ( & V_2 -> V_307 , 1 ) ;
V_275 = F_150 ( V_2 -> V_312 , F_81 , V_384 , V_2 -> V_11 , V_2 ) ;
if ( V_275 ) {
F_10 ( L_51 , V_2 -> V_312 , V_275 ) ;
V_2 -> V_312 = 0 ;
goto V_385;
}
V_275 = F_69 ( V_2 ) ;
...
F_12 ( V_2 ) ;
V_386:
F_152 ( V_2 -> V_312 , V_2 -> V_11 ) ;
F_153 ( & V_2 -> V_310 ) ;
V_385:
F_154 ( V_54 , sizeof( struct V_63 ) ,
V_2 -> V_65 , V_2 -> V_67 ) ;
V_383:
for ( V_8 = 0 ; V_8 < 3 ; ++ V_8 )
if ( V_2 -> V_5 [ V_8 ] )
...
static void T_11 F_158 ( struct V_374 * V_54 )
{
int V_8 ;
struct V_1 * V_2 ;
V_2 = F_159 ( V_54 ) ;
