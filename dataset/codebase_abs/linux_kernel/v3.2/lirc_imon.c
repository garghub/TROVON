...
static T_1 F_25 ( struct V_13 * V_13 , const char * V_42 ,
T_2 V_43 , T_3 * V_44 )
{
int V_45 ;
int V_46 ;
...
static int F_58 ( struct V_14 * V_71 , T_5 V_139 )
{
...
{
int V_140 ;
F_9 (KERN_INFO MOD_NAME L_50 MOD_DESC L_51 MOD_VERSION L_26 ) ;
V_140 = F_61 ( & V_18 ) ;
if ( V_140 ) {
F_8 ( L_52 , V_9 , V_140 ) ;
return - V_19 ;
