...
} else if ( V_138 -> V_115 . V_163 & V_180 ) {
V_66 [ V_93 ] |= F_54 ( V_72 ) ;
...
V_37 -> V_197 [ V_61 ] = V_37 -> V_45 [ V_61 ] ;
} else {
V_74 = F_50 ( V_58 , & V_138 ) ;
if ( V_74 ) {
F_53 ( V_58 -> V_68 , L_38 , V_103 ) ;
...
V_66 [ V_93 ] = V_37 -> V_41 [ V_61 ] ;
V_37 -> V_207 [ V_61 ] = V_37 -> V_45 [ V_61 ] ;
} else {
V_74 = F_50 ( V_58 , & V_138 ) ;
if ( V_74 ) {
F_53 ( V_58 -> V_68 , L_38 , V_103 ) ;
...
static unsigned F_55 ( unsigned V_60 , unsigned V_272 )
{
unsigned V_273 ;
V_273 = F_8 ( 1U , V_60 >> V_272 ) ;
if ( V_272 > 0 )
V_273 = F_56 ( V_273 ) ;
return V_273 ;
}
static void F_57 ( unsigned V_274 , unsigned V_275 , unsigned V_276 ,
unsigned V_277 , unsigned V_278 , unsigned V_279 , unsigned V_1 ,
unsigned V_280 , unsigned V_17 , unsigned V_19 ,
unsigned * V_281 , unsigned * V_282 )
{
unsigned V_283 , V_38 , V_272 ;
unsigned V_284 , V_62 , V_285 , V_60 ;
unsigned V_8 ;
unsigned V_286 , V_287 ;
unsigned V_288 = V_276 - V_275 + 1 ;
* V_281 = - 1 ;
V_8 = F_4 ( V_1 ) ;
V_277 = F_55 ( V_277 , 0 ) ;
V_278 = F_55 ( V_278 , 0 ) ;
V_279 = F_55 ( V_279 , 0 ) ;
for( V_38 = 0 , V_283 = 0 , V_272 = V_275 ; V_38 < V_288 ; V_38 ++ , V_272 ++ ) {
V_284 = F_55 ( V_277 , V_38 ) ;
V_286 = F_5 ( V_1 , V_284 ) ;
V_286 = F_58 ( V_286 , V_280 ) ;
V_62 = F_55 ( V_278 , V_38 ) ;
V_287 = F_6 ( V_1 , V_62 ) ;
V_287 = F_58 ( V_287 , V_17 ) ;
V_285 = F_55 ( V_279 , V_38 ) ;
V_60 = V_286 * V_287 * V_8 ;
if ( V_274 )
V_60 *= V_274 ;
else
V_60 *= V_285 ;
...
{
struct V_36 * V_37 = V_58 -> V_37 ;
T_1 V_274 , V_276 , V_275 , V_277 , V_278 , V_279 ;
T_1 V_293 , V_294 , V_281 , V_282 , V_295 , V_296 ;
...
case V_310 :
default:
F_12 ( V_58 -> V_68 , L_41 , F_64 ( V_293 ) ) ;
return - V_35 ;
}
V_1 = F_65 ( V_294 ) ;
if ( ! F_3 ( V_1 , V_58 -> V_5 ) ) {
...
& V_16 , & V_17 , & V_18 , & V_19 ) ) {
F_12 ( V_58 -> V_68 , L_43 ,
V_69 , __LINE__ , F_67 ( V_293 ) ) ;
return - V_35 ;
}
if ( ! F_18 ( V_63 , V_16 ) ) {
F_12 ( V_58 -> V_68 , L_44 ,
V_69 , __LINE__ , V_63 , V_16 , F_67 ( V_293 ) ) ;
return - V_35 ;
}
if ( ! F_18 ( V_64 , V_19 ) ) {
F_12 ( V_58 -> V_68 , L_45 ,
V_69 , __LINE__ , V_64 , V_19 , F_67 ( V_293 ) ) ;
return - V_35 ;
}
if ( ! F_18 ( V_292 , V_19 ) ) {
F_12 ( V_58 -> V_68 , L_46 ,
V_69 , __LINE__ , V_292 , V_19 , F_67 ( V_293 ) ) ;
return - V_35 ;
}
V_295 = F_33 ( V_58 , V_93 + 2 ) << 8 ;
V_296 = F_33 ( V_58 , V_93 + 3 ) << 8 ;
V_293 = F_33 ( V_58 , V_93 + 4 ) ;
V_294 = F_33 ( V_58 , V_93 + 5 ) ;
V_275 = F_68 ( V_293 ) ;
V_276 = F_69 ( V_294 ) ;
if ( V_297 == 1 ) {
V_298 = F_70 ( V_294 ) ;
...
F_57 ( V_274 , V_275 , V_276 , V_277 , V_278 , V_279 , V_1 ,
V_16 , V_17 , V_19 ,
& V_281 , & V_282 ) ;
if ( ( V_281 + V_295 ) > F_13 ( V_290 ) ) {
F_12 ( V_58 -> V_68 , L_47 ,
V_277 , V_278 , V_1 , V_295 , V_281 , F_13 ( V_290 ) ) ;
...
unsigned V_93 ;
unsigned V_38 ;
unsigned V_311 , V_312 , V_103 ;
int V_74 ;
T_1 V_313 ;
V_37 = (struct V_36 * ) V_58 -> V_37 ;
V_66 = V_58 -> V_66 -> V_67 ;
V_93 = V_92 -> V_93 + 1 ;
V_313 = F_33 ( V_58 , V_93 ) ;
switch ( V_92 -> V_105 ) {
case V_314 :
{
int V_315 ;
...
V_66 [ V_93 + 0 ] = V_313 + ( T_1 ) ( V_138 -> V_115 . V_116 & 0xffffffff ) ;
V_66 [ V_93 + 1 ] = V_61 + ( F_73 ( V_138 -> V_115 . V_116 ) & 0xff ) ;
}
break;
case V_316 :
if ( V_58 -> V_5 >= V_306 || V_92 -> V_100 ) {
F_32 ( L_51 ) ;
return - V_35 ;
}
break;
...
if ( ! V_58 -> V_161 ) {
if ( V_138 -> V_115 . V_163 & V_164 )
V_66 [ V_93 + 1 + ( V_38 * 7 ) + 0 ] |= F_60 ( V_300 ) ;
else if ( V_138 -> V_115 . V_163 & V_180 )
...
V_292 = ( T_1 ) ( ( V_138 -> V_115 . V_116 >> 8 ) & 0xffffffff ) ;
V_291 = V_138 -> V_198 ;
V_74 = F_59 ( V_58 , V_93 + ( V_38 * 7 ) + 1 ,
V_290 , V_291 ,
V_64 + F_33 ( V_58 , V_93 + 1 + ( V_38 * 7 ) + 2 ) ,
V_292 + F_33 ( V_58 , V_93 + 1 + ( V_38 * 7 ) + 3 ) ,
V_138 -> V_115 . V_163 ) ;
if ( V_74 )
return V_74 ;
V_66 [ V_93 + 1 + ( V_38 * 7 ) + 2 ] += V_64 ;
V_66 [ V_93 + 1 + ( V_38 * 7 ) + 3 ] += V_292 ;
break;
case V_337 :
V_74 = F_50 ( V_58 , & V_138 ) ;
if ( V_74 ) {
...
V_283 = F_33 ( V_58 , V_93 + 1 + ( V_38 * 7 ) + 0 ) ;
V_60 = F_33 ( V_58 , V_93 + 1 + ( V_38 * 7 ) + 1 ) + 1 ;
if ( V_58 -> V_75 && ( V_60 + V_283 ) > F_13 ( V_138 -> V_198 ) ) {
F_12 ( V_58 -> V_68 , L_66 ,
V_60 + V_283 , F_13 ( V_138 -> V_198 ) ) ;
V_66 [ V_93 + 1 + ( V_38 * 7 ) + 1 ] = F_13 ( V_138 -> V_198 ) ;
}
...
break;
case V_355 :
if ( V_58 -> V_5 >= V_306 || V_58 -> V_5 == V_356 ) {
F_32 ( L_72 ) ;
return - V_35 ;
}
if ( V_92 -> V_100 ) {
...
int V_74 ;
if ( V_58 -> V_37 == NULL ) {
V_37 = F_76 ( sizeof( * V_37 ) , V_357 ) ;
if ( V_37 == NULL )
return - V_358 ;
F_9 ( V_37 ) ;
if ( V_58 -> V_75 -> V_5 < V_306 ) {
V_37 -> V_25 = V_58 -> V_75 -> V_359 . V_360 . V_361 ;
V_37 -> V_23 = V_58 -> V_75 -> V_359 . V_360 . V_362 ;
V_37 -> V_32 = V_58 -> V_75 -> V_359 . V_360 . V_363 ;
} else if ( V_58 -> V_75 -> V_5 <= V_364 ) {
V_37 -> V_25 = V_58 -> V_75 -> V_359 . V_365 . V_361 ;
V_37 -> V_23 = V_58 -> V_75 -> V_359 . V_365 . V_362 ;
V_37 -> V_32 = V_58 -> V_75 -> V_359 . V_365 . V_363 ;
}
V_58 -> V_37 = V_37 ;
}
do {
...
V_58 -> V_114 = F_76 ( sizeof( struct V_107 ) , V_357 ) ;
if ( V_58 -> V_114 == NULL ) {
return - V_358 ;
}
return 0 ;
}
static void F_79 ( struct V_57 * V_366 , int error )
{
unsigned V_38 ;
F_77 ( V_366 -> V_114 ) ;
for ( V_38 = 0 ; V_38 < V_366 -> V_367 ; V_38 ++ ) {
F_77 ( V_366 -> V_96 [ V_38 ] . V_117 ) ;
F_77 ( V_366 -> V_96 [ V_38 ] . V_368 [ 0 ] ) ;
F_77 ( V_366 -> V_96 [ V_38 ] . V_368 [ 1 ] ) ;
}
F_77 ( V_366 -> V_96 ) ;
F_77 ( V_366 -> V_369 ) ;
}
int F_80 ( struct V_370 * V_68 , void * V_371 , struct V_372 * V_373 ,
unsigned V_5 , T_1 * V_66 , int * V_374 )
{
struct V_57 V_366 ;
struct V_94 * V_95 ;
struct V_375 V_376 ;
...
memset ( & V_366 , 0 , sizeof( struct V_57 ) ) ;
V_366 . V_373 = V_373 ;
V_366 . V_68 = & V_68 -> V_377 -> V_68 ;
V_366 . V_75 = NULL ;
V_366 . V_5 = V_5 ;
V_366 . V_66 = & V_376 ;
V_366 . V_37 = V_37 ;
V_376 . V_67 = V_66 ;
V_74 = F_82 ( & V_366 , V_371 ) ;
if ( V_74 ) {
F_32 ( L_75 ) ;
F_79 ( & V_366 , V_74 ) ;
return V_74 ;
...
V_95 = & V_366 . V_96 [ V_366 . V_97 ] ;
V_366 . V_66 -> V_99 = V_95 -> V_99 ;
* V_374 = V_366 . V_66 -> V_99 ;
V_74 = F_75 ( & V_366 ) ;
if ( V_74 ) {
F_32 ( L_77 ) ;
F_79 ( & V_366 , V_74 ) ;
