...
static int T_1 F_9 ( struct V_10 * V_11 )
{
...
static int T_1 F_25 ( struct V_10 * V_11 )
{
struct V_1 * V_2 = V_11 -> V_12 ;
...
static int F_30 ( struct V_10 * V_11 , T_3 V_80 )
{
if ( V_11 ) {
struct V_1 * V_2 = V_11 -> V_12 ;
F_31 ( V_11 , V_81 ) ;
...
static int T_1 F_33 ( int V_87 , struct V_1 * V_2 ,
struct V_88 * V_89 )
{
if ( F_34 ( V_89 ) < 0 ) {
F_11 ( V_75 L_13 ) ;
...
static int F_43 ( int V_87 , struct V_10 * * V_96 )
{
struct V_10 * V_11 ;
struct V_1 * V_2 ;
int V_71 ;
V_71 = F_44 ( V_76 [ V_87 ] , V_46 [ V_87 ] , V_97 ,
sizeof( struct V_1 ) , & V_11 ) ;
if ( V_71 < 0 )
return V_71 ;
strcpy ( V_11 -> V_98 , L_18 ) ;
...
static int T_1 F_46 ( struct V_10 * V_11 , int V_87 )
{
...
V_108 , 0 , & V_104 ) ) < 0 )
return V_71 ;
if ( ( V_71 = F_53 ( V_104 , 1 , 2 ) ) < 0 )
return V_71 ;
if ( ( V_71 = F_54 ( V_104 , 0 , 1 , & V_2 -> V_38 ) ) < 0 )
return V_71 ;
}
if ( V_93 [ V_87 ] >= 0x300 && V_93 [ V_87 ] < 0x340 ) {
if ( ( V_71 = F_55 ( V_11 , 0 , V_109 ,
V_93 [ V_87 ] ,
V_110 , - 1 ,
& V_2 -> V_39 ) ) < 0 )
return V_71 ;
}
sprintf ( V_11 -> V_111 , L_23 ,
V_11 -> V_21 , V_2 -> V_5 , V_99 , V_100 ) ;
if ( V_101 >= 0 )
sprintf ( V_11 -> V_111 + strlen ( V_11 -> V_111 ) , L_24 , V_101 ) ;
return F_56 ( V_11 ) ;
}
static int T_1 F_57 ( struct V_88 * V_89 ,
const struct V_112 * V_46 )
{
static int V_87 ;
int V_71 ;
struct V_10 * V_11 ;
...
static void T_4 F_62 ( struct V_88 * V_89 )
{
F_59 ( F_63 ( V_89 ) ) ;
F_61 ( V_89 , NULL ) ;
}
static int F_64 ( struct V_88 * V_89 , T_3 V_80 )
{
return F_30 ( F_63 ( V_89 ) , V_80 ) ;
}
static int F_65 ( struct V_88 * V_89 )
{
return F_32 ( F_63 ( V_89 ) ) ;
}
static int T_1 F_66 ( struct V_117 * V_118 ,
const struct V_119 * V_46 )
{
static int V_87 ;
struct V_88 * V_89 ;
int V_71 ;
struct V_10 * V_11 ;
V_89 = F_67 ( V_118 , V_46 -> V_120 [ 0 ] . V_46 , NULL ) ;
if ( V_89 == NULL ) {
...
static void T_4 F_69 ( struct V_117 * V_118 )
{
F_59 ( F_70 ( V_118 ) ) ;
F_68 ( V_118 , NULL ) ;
}
static int F_71 ( struct V_117 * V_118 , T_3 V_80 )
{
return F_30 ( F_70 ( V_118 ) , V_80 ) ;
}
static int F_72 ( struct V_117 * V_118 )
{
return F_32 ( F_70 ( V_118 ) ) ;
}
static int T_1 F_73 ( struct V_121 * V_89 ,
unsigned int V_87 )
{
if ( ! V_115 [ V_87 ] )
return 0 ;
...
static int T_1 F_75 ( struct V_121 * V_89 ,
unsigned int V_87 )
{
struct V_10 * V_11 ;
int V_71 ;
...
static int T_4 F_77 ( struct V_121 * V_123 ,
unsigned int V_87 )
{
F_59 ( F_78 ( V_123 ) ) ;
F_76 ( V_123 , NULL ) ;
...
static int F_79 ( struct V_121 * V_87 , unsigned int V_124 ,
T_3 V_80 )
{
return F_30 ( F_78 ( V_87 ) , V_80 ) ;
}
static int F_80 ( struct V_121 * V_87 , unsigned int V_124 )
{
return F_32 ( F_78 ( V_87 ) ) ;
}
static int T_5 F_81 ( void )
{
int V_71 ;
V_71 = F_82 ( & V_125 , V_114 ) ;
#ifdef F_74
if ( ! V_71 )
V_126 = 1 ;
V_71 = F_83 ( & V_127 ) ;
