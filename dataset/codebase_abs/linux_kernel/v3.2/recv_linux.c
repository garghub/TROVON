...
#ifdef F_11
V_53 -> V_61 = ( V_62 ) ( V_48 -> V_5 . V_6 . V_63 -
V_48 -> V_5 . V_6 . V_64 ) ;
#else
V_53 -> V_61 = ( V_62 ) V_48 -> V_5 . V_6 . V_63 ;
#endif
V_53 -> V_26 = V_48 -> V_5 . V_6 . V_26 ;
if ( ( V_55 -> V_65 == 1 ) && ( V_55 -> V_66 == 1 ) )
V_53 -> V_67 = V_68 ;
else
V_53 -> V_67 = V_69 ;
V_53 -> V_70 = V_2 -> V_46 ;
V_53 -> V_71 = F_12 ( V_53 , V_2 -> V_46 ) ;
F_13 ( V_53 ) ;
...
V_11 -> V_18 = false ;
if ( V_11 -> V_13 == false )
F_16 ( V_2 , V_50 -> V_74 , 0 ,
( unsigned char * ) V_11 ) ;
}
static void F_17 ( void * V_75 )
{
struct V_76 * V_77 =
(struct V_76 * ) V_75 ;
F_18 ( V_77 ) ;
}
void F_19 ( struct V_76 * V_77 )
{
struct V_1 * V_2 = V_77 -> V_2 ;
F_20 ( & ( V_77 -> V_78 ) , V_2 -> V_46 ,
F_17 , V_77 ) ;
}
