...
static int F_201 ( struct V_1 * V_2 , struct V_424 * V_425 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
struct V_403 * V_426 ;
...
static int F_203 ( struct V_1 * V_2 , struct V_424 * V_425 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
...
static int F_204 ( struct V_1 * V_2 , struct V_430 * V_402 ,
T_2 * V_195 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
...
V_67 = F_206 ( V_15 , V_58 , ( V_433 * ) & V_133 [ V_58 ] ) ;
if ( ! V_67 )
memcpy ( V_195 , V_133 + V_402 -> V_19 , V_402 -> V_134 ) ;
F_207 ( V_133 ) ;
return V_67 ;
}
static int F_208 ( struct V_1 * V_2 , struct V_430 * V_434 ,
T_2 * V_195 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
...
V_133 = F_205 ( V_436 , V_85 ) ;
if ( ! V_133 )
return - V_103 ;
V_67 = F_206 ( V_15 , V_435 , ( V_433 * ) V_133 ) ;
if ( ! V_67 && V_436 > 4 )
V_67 = F_206 ( V_15 ,
V_435 + V_436 - 4 ,
( V_433 * ) & V_133 [ V_436 - 4 ] ) ;
...
static void F_211 ( struct V_1 * V_2 , struct V_437 * V_438 )
{
V_438 -> V_364 = 0 ;
V_438 -> V_439 = 0 ;
...
static int F_213 ( struct V_1 * V_2 , void T_9 * V_441 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
T_6 V_363 ;
int V_138 ;
if ( F_214 ( & V_363 , V_441 , sizeof( V_363 ) ) )
return - V_442 ;
switch ( V_363 ) {
case V_443 : {
int V_58 ;
...
if ( ! F_77 ( V_140 ) )
return - V_141 ;
if ( F_214 ( & V_445 , V_441 , sizeof( V_445 ) ) )
return - V_442 ;
if ( V_445 . V_128 >= V_107 )
return - V_142 ;
if ( ! F_212 ( V_445 . V_447 , 0 , V_428 ) ||
! F_212 ( V_445 . V_448 , 0 , 255 ) ||
! F_212 ( V_445 . V_418 [ 0 ] , V_423 ,
V_410 ) ||
! F_212 ( V_445 . V_418 [ 1 ] , V_423 ,
V_410 ) ||
! F_212 ( V_445 . V_418 [ 2 ] , V_449 ,
V_450 ) ||
! F_212 ( V_445 . V_412 [ 0 ] , V_421 ,
V_406 ) ||
! F_212 ( V_445 . V_412 [ 1 ] , V_421 ,
V_408 ) ||
! F_212 ( V_445 . V_414 , V_420 ,
V_419 ) )
return - V_142 ;
if ( ( V_15 -> V_51 & V_145 ) &&
...
if ( F_216 ( V_441 , & V_445 , sizeof( V_445 ) ) )
return - V_442 ;
break;
}
case V_458 : {
...
if ( V_15 -> V_51 & V_145 )
return - V_146 ;
if ( F_214 ( & V_460 , V_441 , sizeof( V_460 ) ) )
return - V_442 ;
if ( V_460 . V_139 < 1 ||
...
if ( F_216 ( V_441 , & V_460 , sizeof( V_460 ) ) )
return - V_442 ;
break;
}
case V_463 : {
...
if ( F_214 ( & V_445 , V_441 , sizeof( V_445 ) ) )
return - V_442 ;
V_464 = F_217 ( V_441 + sizeof( V_445 ) , V_445 . V_134 ) ;
if ( F_218 ( V_464 ) )
return F_219 ( V_464 ) ;
...
if ( F_220 ( V_15 ) )
return - V_146 ;
if ( F_214 ( & V_469 , V_441 , sizeof( V_469 ) ) )
return - V_442 ;
if ( V_469 . V_470 != V_93 )
return - V_142 ;
if ( V_469 . V_169 [ 0 ] < 81 )
...
if ( F_216 ( V_441 , & V_469 , sizeof( V_469 ) ) )
return - V_442 ;
break;
}
case V_487 : {
...
V_138 =
F_223 ( V_491 , V_445 . V_154 / 8 , V_500 / 8 ,
V_133 ) ;
if ( V_138 )
return V_138 ;
if ( F_216 ( V_441 , V_133 , V_500 ) )
return - V_442 ;
V_441 += V_500 ;
V_445 . V_154 += V_500 ;
V_445 . V_134 -= V_500 ;
...
static int F_225 ( struct V_1 * V_2 , struct V_510 * V_84 , int V_363 )
{
struct V_511 * V_195 = F_226 ( V_84 ) ;
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
switch ( V_363 ) {
case V_512 :
...
( V_195 -> V_514 & 0x1f00 ) &&
! ( V_195 -> V_514 & 0xe0e0 ) )
V_195 -> V_514 = F_228 ( V_195 -> V_514 >> 8 ,
V_195 -> V_514 & 0x1f ) ;
case V_515 :
return F_229 ( & V_16 -> V_38 . V_370 , V_195 , V_363 ) ;
case V_516 :
return F_213 ( V_2 , V_84 -> V_517 ) ;
default:
return - V_288 ;
}
}
static int F_230 ( struct V_1 * V_2 , int V_518 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
int V_138 ;
...
static void F_234 ( struct V_1 * V_2 , T_6 V_455 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
if ( V_15 -> V_97 . V_130 > 0 ) {
...
static T_6 F_236 ( struct V_1 * V_2 , T_6 V_455 )
{
if ( V_455 & V_524 )
V_455 |= V_526 ;
else
...
static int F_237 ( struct V_1 * V_2 , T_6 V_455 )
{
T_6 V_527 = V_2 -> V_455 ^ V_455 ;
if ( V_527 & V_524 )
F_234 ( V_2 , V_455 ) ;
return 0 ;
}
...
static void F_246 ( struct V_533 * V_534 )
{
struct V_15 * V_15 = F_247 ( V_534 , struct V_15 ,
V_229 . V_534 ) ;
...
static void F_255 ( struct V_533 * V_534 )
{
struct V_15 * V_15 = F_247 ( V_534 , struct V_15 ,
V_552 ) ;
int V_58 ;
...
static int F_260 ( struct V_15 * V_15 , int V_536 , int V_222 )
{
int V_58 , V_138 = 0 ;
if ( F_80 ( V_15 ) &&
...
static void F_271 ( struct V_533 * V_534 )
{
struct V_15 * V_15 = F_247 ( V_534 , struct V_15 ,
V_559 ) ;
int V_67 = 0 ;
...
F_162 ( & V_15 -> V_223 ) ;
F_123 ( V_15 ) ;
F_258 ( V_224 , & V_15 -> V_559 ) ;
F_164 ( & V_15 -> V_223 ) ;
}
F_272 ( V_15 , L_46 ) ;
if ( ! F_274 ( V_15 , 0xa0 , 4 , V_560 ) )
F_272 ( V_15 , L_47 ,
V_560 [ 0 ] , V_560 [ 1 ] ,
V_560 [ 2 ] , V_560 [ 3 ] ) ;
}
static T_10 F_275 ( struct V_561 * V_53 ,
T_11 V_27 )
{
...
static T_10 F_277 ( struct V_561 * V_53 )
{
struct V_15 * V_15 = F_276 ( V_53 ) ;
if ( ! F_264 ( V_15 ) )
return V_565 ;
...
static void F_278 ( struct V_561 * V_53 )
{
struct V_15 * V_15 = F_276 ( V_53 ) ;
F_272 ( V_15 , L_48 ,
F_12 ( V_15 , V_566 ) ) ;
...
while ( ( V_67 = F_282 ( V_25 -> V_53 , V_571 , V_572 ) ) > 0 )
V_572 = V_67 ;
if ( V_67 < 0 )
F_30 ( V_25 -> V_53 ) ;
...
static int T_12 F_286 ( struct V_561 * V_53 ,
...
F_298 ( & V_15 -> V_252 ) ;
F_299 ( & V_15 -> V_596 ) ;
F_300 ( & V_15 -> V_552 , F_255 ) ;
F_300 ( & V_15 -> V_559 , F_271 ) ;
...
F_310 ( V_15 ) ;
if ( F_80 ( V_15 ) ) {
F_309 ( V_233 , & V_15 -> V_580 ) ;
F_311 ( V_15 ) ;
}
if ( V_612 > 1 && F_281 ( V_15 ) == 0 )
V_15 -> V_51 |= V_52 ;
else if ( V_612 > 0 && F_312 ( V_53 ) == 0 )
V_15 -> V_51 |= V_54 ;
F_279 ( V_15 ) ;
V_67 = F_136 ( & V_15 -> V_28 [ 0 ] -> V_2 . V_237 ,
& V_613 ) ;
F_35 (adapter, i)
F_234 ( V_15 -> V_28 [ V_58 ] , V_15 -> V_28 [ V_58 ] -> V_455 ) ;
F_283 ( V_15 , V_575 ) ;
return 0 ;
V_599:
F_313 ( V_15 -> V_339 ) ;
...
static void T_14 F_316 ( struct V_561 * V_53 )
{
struct V_15 * V_15 = F_276 ( V_53 ) ;
if ( V_15 ) {
int V_58 ;
