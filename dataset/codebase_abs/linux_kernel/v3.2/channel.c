...
F_21 ( & V_41 -> V_40 ) ;
F_21 ( & V_41 -> V_39 ) ;
F_22 ( ( unsigned long ) V_52 ,
F_9 ( V_42 + V_43 ) ) ;
F_20 ( V_50 ) ;
return V_56 ;
}
static int F_23 ( void * V_87 , T_2 V_88 ,
struct V_49 * * V_89 ,
T_2 * V_90 )
{
int V_91 ;
...
int V_54 = 0 ;
int V_55 ;
V_125 = F_28 ( & V_8 . V_125 ) ;
F_29 ( & V_8 . V_125 ) ;
V_54 = F_23 ( V_87 , V_88 , & V_89 , & V_122 ) ;
if ( V_54 )
return V_54 ;
F_13 ( & V_89 -> V_68 ) ;
...
int F_32 ( struct V_1 * V_2 , T_2 V_119 )
{
struct V_129 * V_69 ;
struct V_49 * V_130 ;
unsigned long V_53 ;
int V_54 , V_55 ;
V_130 = F_12 ( sizeof( * V_130 ) +
sizeof( struct V_129 ) , V_59 ) ;
if ( ! V_130 )
return - V_61 ;
F_13 ( & V_130 -> V_68 ) ;
V_69 = (struct V_129 * ) V_130 -> V_69 ;
V_69 -> V_70 . V_71 = V_131 ;
...
F_16 ( & V_2 -> V_133 , V_53 ) ;
V_69 = & V_2 -> V_134 . V_69 ;
V_69 -> V_70 . V_71 = V_135 ;
V_69 -> V_7 = V_2 -> V_5 . V_7 ;
V_54 = F_17 ( V_69 , sizeof( struct V_132 ) ) ;
F_31 ( V_54 != 0 ) ;
if ( V_2 -> V_66 )
F_32 ( V_2 ,
V_2 -> V_66 ) ;
F_21 ( & V_2 -> V_40 ) ;
F_21 ( & V_2 -> V_39 ) ;
F_22 ( ( unsigned long ) V_2 -> V_62 ,
F_9 ( V_2 -> V_63 * V_136 ) ) ;
}
int F_34 ( struct V_1 * V_2 , const void * V_137 ,
T_2 V_138 , V_108 V_139 ,
enum V_140 type , T_2 V_53 )
{
struct V_141 V_142 ;
T_2 V_143 = sizeof( struct V_141 ) + V_138 ;
T_2 V_144 = F_35 ( V_143 , sizeof( V_108 ) ) ;
struct V_145 V_146 [ 3 ] ;
V_108 V_147 = 0 ;
int V_54 ;
V_142 . type = type ;
V_142 . V_53 = V_53 ;
V_142 . V_148 = sizeof( struct V_141 ) >> 3 ;
V_142 . V_149 = ( V_150 ) ( V_144 >> 3 ) ;
V_142 . V_151 = V_139 ;
F_36 ( V_146 , 3 ) ;
F_37 ( & V_146 [ 0 ] , & V_142 , sizeof( struct V_141 ) ) ;
F_37 ( & V_146 [ 1 ] , V_137 , V_138 ) ;
F_37 ( & V_146 [ 2 ] , & V_147 ,
V_144 - V_143 ) ;
V_54 = F_38 ( & V_2 -> V_40 , V_146 , 3 ) ;
...
sizeof( struct V_152 ) ) ;
V_143 = V_155 + V_138 ;
V_144 = F_35 ( V_143 , sizeof( V_108 ) ) ;
V_142 . type = V_157 ;
V_142 . V_53 = V_158 ;
V_142 . V_159 = V_155 >> 3 ;
V_142 . V_160 = ( V_150 ) ( V_144 >> 3 ) ;
V_142 . V_161 = V_139 ;
V_142 . V_111 = V_92 ;
for ( V_91 = 0 ; V_91 < V_92 ; V_91 ++ ) {
V_142 . V_113 [ V_91 ] . V_162 = V_153 [ V_91 ] . V_162 ;
V_142 . V_113 [ V_91 ] . V_163 = V_153 [ V_91 ] . V_163 ;
V_142 . V_113 [ V_91 ] . V_93 = V_153 [ V_91 ] . V_93 ;
}
F_36 ( V_146 , 3 ) ;
F_37 ( & V_146 [ 0 ] , & V_142 , V_155 ) ;
F_37 ( & V_146 [ 1 ] , V_137 , V_138 ) ;
F_37 ( & V_146 [ 2 ] , & V_147 ,
V_144 - V_143 ) ;
V_54 = F_38 ( & V_2 -> V_40 , V_146 , 3 ) ;
...
struct V_164 * V_165 ,
void * V_137 , T_2 V_138 , V_108 V_139 )
{
int V_54 ;
struct V_166 V_142 ;
T_2 V_155 ;
...
struct V_145 V_146 [ 3 ] ;
V_108 V_147 = 0 ;
T_2 V_102 = F_42 ( V_165 -> V_163 ,
V_165 -> V_162 ) ;
if ( ( V_102 < 0 ) || ( V_102 > V_167 ) )
return - V_77 ;
V_155 = sizeof( struct V_166 ) -
( ( V_167 - V_102 ) *
sizeof( V_108 ) ) ;
V_143 = V_155 + V_138 ;
V_144 = F_35 ( V_143 , sizeof( V_108 ) ) ;
...
V_142 . V_161 = V_139 ;
V_142 . V_111 = 1 ;
V_142 . V_113 . V_162 = V_165 -> V_162 ;
V_142 . V_113 . V_163 = V_165 -> V_163 ;
memcpy ( V_142 . V_113 . V_116 , V_165 -> V_116 ,
V_102 * sizeof( V_108 ) ) ;
F_36 ( V_146 , 3 ) ;
F_37 ( & V_146 [ 0 ] , & V_142 , V_155 ) ;
F_37 ( & V_146 [ 1 ] , V_137 , V_138 ) ;
...
int F_43 ( struct V_1 * V_2 , void * V_137 ,
T_2 V_138 , T_2 * V_168 , V_108 * V_139 )
{
struct V_141 V_142 ;
T_2 V_143 ;
T_2 V_169 ;
...
* V_168 = 0 ;
* V_139 = 0 ;
V_54 = F_44 ( & V_2 -> V_39 , & V_142 ,
sizeof( struct V_141 ) ) ;
if ( V_54 != 0 )
return 0 ;
V_143 = V_142 . V_149 << 3 ;
V_169 = V_143 - ( V_142 . V_148 << 3 ) ;
* V_168 = V_169 ;
if ( V_169 > V_138 ) {
F_45 ( L_1 ,
V_138 , V_169 ) ;
...
* V_139 = V_142 . V_151 ;
V_54 = F_46 ( & V_2 -> V_39 , V_137 , V_169 ,
( V_142 . V_148 << 3 ) ) ;
return 0 ;
}
int F_47 ( struct V_1 * V_2 , void * V_137 ,
T_2 V_138 , T_2 * V_168 ,
V_108 * V_139 )
{
struct V_141 V_142 ;
...
* V_139 = V_142 . V_151 ;
V_54 = F_46 ( & V_2 -> V_39 , V_137 , V_143 , 0 ) ;
return 0 ;
}
