...
V_18 = F_87 ( & V_2 -> V_6 , V_222 , V_175 , V_103 , V_229 , V_230 ) ;
return V_18 ;
}
...
if ( ! V_47 )
return;
V_47 -> V_249 = 0xffa28000 ;
V_47 -> V_250 = 0x1000 ;
if ( ! ( F_113 ( V_47 -> V_249 , V_47 -> V_250 , L_31 ) ) )
F_114 ( L_32 ) ;
V_47 -> V_251 = F_115 ( ( unsigned long ) V_47 -> V_249 , V_47 -> V_250 ) ;
if ( ! V_47 -> V_251 ) {
F_116 ( L_33 ) ;
V_18 = - V_51 ;
goto V_252;
...
V_135 -> V_6 . V_253 = V_254 ;
V_135 -> V_6 . V_255 = ( V_256 ) V_47 -> V_249
+ V_257
+ V_48 * V_258 ;
V_135 -> V_6 . V_7 = V_47 -> V_251 + V_257
+ V_48 * V_258 ;
sprintf ( V_135 -> V_49 , L_34 , V_48 ) ;
V_135 -> V_6 . V_113 = 64 ;
V_135 -> V_6 . V_259 = & V_260 ;
V_135 -> V_6 . line = V_48 ;
V_135 -> V_6 . V_128 = V_261 ;
...
for ( V_48 = 0 ; V_48 < 6 ; V_48 ++ ) {
V_248 -> V_33 = V_48 ;
V_248 -> V_137 = ( V_48 & 0x1 ) ? V_86 : V_76 ;
V_248 -> V_135 = & V_47 -> V_6 [ V_48 / 2 ] ;
V_248 -> V_251 = V_47 -> V_251 + V_263 +
V_48 * V_264 ;
V_248 ++ ;
}
V_245 = V_47 ;
