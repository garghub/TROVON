...
static int T_7 F_37 ( struct V_85 * V_86 )
{
int V_87 , V_11 ;
char V_88 [ 12 ] ;
if ( V_57 != NULL ) {
...
V_14 [ V_87 ] . V_28 = NULL ;
V_14 [ V_87 ] . V_70 = 0 ;
F_38 ( & V_14 [ V_87 ] . V_15 , 1 ) ;
V_14 [ V_87 ] . V_91 = NULL ;
V_14 [ V_87 ] . V_17 = NULL ;
V_14 [ V_87 ] . V_21 = 0 ;
}
F_1 () ;
V_11 = F_39 ( F_40 ( V_92 , 0 ) , V_90 ,
V_78 ) ;
if ( V_11 ) {
F_5 ( V_31 L_15
L_16 , V_78 , V_92 ) ;
...
V_94 -> V_95 = & V_96 ;
V_94 -> V_97 = V_98 ;
V_11 = F_42 ( V_94 , F_40 ( V_92 , 0 ) , V_90 ) ;
if ( V_11 ) {
F_5 ( V_31 L_17 , V_78 ) ;
goto V_99;
}
for ( V_87 = V_37 ; V_87 < ( V_100 + 1 ) ; V_87 ++ ) {
V_14 [ V_87 ] . V_17 = F_43 ( V_57 ,
V_101 , V_102 ) ;
...
V_14 [ V_87 ] . V_28 = F_44 ( V_14 [ V_87 ] . V_17 ,
...
V_14 [ V_87 ] . V_27 = V_104 ;
V_14 [ V_87 ] . V_28 = F_47 ( V_14 [ V_87 ] . V_27 , V_110 ) ;
if ( V_14 [ V_87 ] . V_28 == NULL ) {
F_5 ( V_31 L_20
L_23 ) ;
V_11 = - V_105 ;
...
V_14 [ V_87 ] . V_91 = F_51 ( V_112 , NULL ,
F_40 ( V_92 , V_87 ) , NULL , V_88 , V_75 ) ;
if ( F_49 ( V_14 [ V_87 ] . V_91 ) ) {
F_5 ( V_29 L_28 ,
V_78 ) ;
V_11 = F_50 ( V_14 [ V_87 ] . V_91 ) ;
goto V_114;
}
}
return 0 ;
...
F_56 ( V_94 ) ;
V_99:
F_57 ( F_40 ( V_92 , 0 ) , V_90 ) ;
V_93:
V_89:
return V_11 ;
}
static int T_8 F_58 ( struct V_85 * V_115 )
{
int V_87 ;
for ( V_87 = 0 ; V_87 < V_90 ; V_87 ++ )
F_52 ( V_112 , F_40 ( V_92 , V_87 ) ) ;
