...
F_76 ( & V_141 ) ;
V_137 = 0 ;
for ( V_214 = 0 ; V_215 [ V_214 ] [ 0 ] [ 0 ] ; V_214 ++ ) {
F_70 ( V_215 [ V_214 ] [ 0 ] ,
V_215 [ V_214 ] [ 1 ] ,
V_215 [ V_214 ] [ 2 ] ,
V_215 [ V_214 ] [ 3 ] ) ;
...
static int F_77 ( struct V_216 * V_217 , unsigned long V_218 ,
void * V_219 )
{
if ( V_101 && V_102 ) {
switch ( V_218 ) {
...
static void F_78 ( struct V_224 * V_225 )
{
if ( V_225 -> V_226 != V_224 )
return;
if ( V_3 ) {
F_72 ( V_212
L_11
...
F_89 ( & V_249 ) ;
F_72 ( V_212 L_20 V_135
L_21 ) ;
return - V_251 ;
}
F_90 ( & V_252 ) ;
if ( V_3 )
F_72 ( V_253 L_20 V_135
L_22 , V_224 ,
V_3 -> V_225 -> V_254 ) ;
else
F_72 ( V_253 L_20 V_135
