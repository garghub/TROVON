...
V_49 = V_115 -> V_187 -> V_288 ( V_115 , 64 ) ;
if ( V_49 < 0 )
F_86 ( V_286 L_83 ,
...
F_99 ( & V_115 -> V_116 -> V_118 ) ;
for ( V_290 = 0 ; V_290 < F_26 ( V_45 ) ; V_290 ++ ) {
struct V_75 * V_7 = F_164 ( V_290 ) ;
if ( V_7 ) {
F_170 ( V_7 ) ;
F_53 ( V_7 ) ;
}
...
if ( F_194 () )
return - V_156 ;
V_238 = F_62 ( sizeof( struct V_218 ) , V_291 ) ;
V_242 = F_62 ( sizeof( struct V_190 ) , V_291 ) ;
V_211 = F_62 ( sizeof( struct V_190 ) , V_291 ) ;
