...
void T_3 F_37 ( struct V_108 * V_109 )
{
F_38 ( & V_110 , V_109 ) ;
}
...
if ( F_40 () ) {
V_112 = V_12 ;
V_11 &= ~ ( V_113 | V_114 | V_115 | V_116 ) ;
F_41 ( V_117 , F_42 ( V_117 ) ) ;
if ( ( V_111 = F_43 ( V_118 , 32 ) ) )
return V_111 ;
F_13 () ;
F_44 ( & V_119 ) ;
F_44 ( & V_120 ) ;
