...
if ( V_24 == NULL )
goto V_265;
V_137 = F_273 ( V_11 , V_192 , V_24 , V_245 ) ;
if ( V_137 == - V_263 ) {
F_227 ( V_24 ) ;
goto V_258;
} else if ( V_137 )
...
static void
F_283 ( struct V_267 * V_140 , unsigned long V_268 )
{
unsigned long V_269 = V_72 - V_140 -> V_141 ;
V_269 = F_30 ( V_269 , 2UL * V_268 ) ;
V_140 -> V_200 = ( 7 * V_140 -> V_200 + 256 ) / 8 ;
V_140 -> V_270 = ( 7 * V_140 -> V_270 + 256 * V_269 ) / 8 ;
V_140 -> V_201 = ( V_140 -> V_270 + 128 ) / V_140 -> V_200 ;
}
static void
...
{
T_3 V_271 = 0 ;
T_3 V_272 = F_137 ( V_170 ) ;
if ( V_15 -> V_273 ) {
if ( V_15 -> V_273 < F_43 ( V_170 ) )
V_271 = F_43 ( V_170 ) - V_15 -> V_273 ;
else
V_271 = V_15 -> V_273 - F_43 ( V_170 ) ;
}
V_15 -> V_274 <<= 1 ;
if ( F_179 ( V_11 -> V_35 ) )
V_15 -> V_274 |= ( V_272 < V_275 ) ;
else
V_15 -> V_274 |= ( V_271 > V_276 ) ;
}
static void
...
return;
V_278 = V_277 = F_8 ( V_15 ) ;
if ( V_15 -> V_171 [ 0 ] + V_15 -> V_171 [ 1 ] >= 4 )
F_287 ( V_15 ) ;
if ( V_15 -> V_165 && ( V_15 -> V_165 -> V_85 & V_279 ) )
V_278 = 0 ;
...
{
struct V_14 * V_280 = V_11 -> V_188 ;
F_35 ( V_11 , V_15 , L_29 ) ;
F_169 ( V_11 , 1 ) ;
if ( F_6 ( V_280 ) != F_6 ( V_15 ) )
V_15 -> V_3 -> V_108 = 0 ;
F_55 ( ! F_117 ( V_15 ) ) ;
F_113 ( V_11 , V_15 , 1 ) ;
V_15 -> V_73 = 0 ;
...
V_15 -> V_273 = F_43 ( V_170 ) + F_137 ( V_170 ) ;
if ( V_15 == V_11 -> V_188 ) {
if ( F_163 ( V_15 ) ) {
if ( F_190 ( V_170 ) > V_281 ||
V_11 -> V_34 > 1 ) {
F_152 ( V_11 , V_15 ) ;
F_157 ( V_15 ) ;
F_292 ( V_11 -> V_35 ) ;
...
F_150 ( V_170 , V_72 + V_11 -> V_282 [ F_42 ( V_170 ) ] ) ;
...
{
struct V_14 * V_15 = V_11 -> V_188 ;
if ( V_11 -> V_180 > V_11 -> V_283 )
V_11 -> V_283 = V_11 -> V_180 ;
if ( V_11 -> V_13 == 1 )
return;
if ( V_11 -> V_182 <= V_284 &&
V_11 -> V_180 <= V_284 )
...
if ( V_37 ) {
struct V_1 * V_157 ;
F_213 ( V_170 ) -> V_140 . V_141 = V_286 ;
if ( F_117 ( V_15 ) )
V_157 = V_15 -> V_157 ;
else
V_157 = F_1 ( V_15 -> V_3 ,
F_3 ( V_15 ) , F_6 ( V_15 ) ) ;
V_157 -> V_140 . V_141 = V_286 ;
if ( ! F_73 ( V_170 -> V_287 + V_11 -> V_282 [ 1 ] , V_286 ) )
V_11 -> V_228 = V_286 ;
}
#ifdef F_282
V_15 -> V_3 -> V_140 . V_141 = V_286 ;
#endif
if ( V_11 -> V_188 == V_15 ) {
const bool V_288 = F_102 ( & V_15 -> V_98 ) ;
if ( F_37 ( V_15 ) ) {
F_34 ( V_11 , V_15 ) ;
F_302 ( V_15 ) ;
}
if ( F_297 ( V_11 , V_15 ) ) {
unsigned long V_289 = V_11 -> V_12 ;
if ( ! V_11 -> V_12 )
V_289 = V_11 -> V_197 ;
V_15 -> V_73 = V_72 + V_289 ;
F_303 ( V_15 ) ;
F_35 ( V_11 , V_15 , L_32 ) ;
}
...
static int F_307 ( struct V_145 * V_146 , int V_292 )
{
struct V_10 * V_11 = V_146 -> V_178 -> V_179 ;
struct V_174 * V_175 = V_147 ;
struct V_23 * V_24 ;
...
struct V_14 * V_15 = F_123 ( V_170 ) ;
if ( V_15 ) {
const int V_292 = F_130 ( V_170 ) ;
F_55 ( ! V_15 -> V_208 [ V_292 ] ) ;
V_15 -> V_208 [ V_292 ] -- ;
...
{
struct V_10 * V_11 = (struct V_10 * ) V_297 ;
struct V_14 * V_15 ;
unsigned long V_152 ;
int V_190 = 1 ;
F_19 ( V_11 , L_36 ) ;
...
if ( V_135 < 0 )
return NULL ;
V_11 = F_331 ( sizeof( * V_11 ) , V_306 | V_246 , V_146 -> V_100 ) ;
if ( ! V_11 ) {
F_223 ( & V_303 ) ;
F_325 ( & V_304 , V_135 ) ;
F_226 ( & V_303 ) ;
...
F_85 ( & V_3 -> V_133 , & V_11 -> V_134 ) ;
#endif
for ( V_135 = 0 ; V_135 < V_309 ; V_135 ++ )
V_11 -> V_167 [ V_135 ] = V_310 ;
...
V_11 -> V_35 = V_146 ;
F_332 ( & V_11 -> V_189 ) ;
V_11 -> V_189 . V_311 = F_318 ;
V_11 -> V_189 . V_297 = ( unsigned long ) V_11 ;
F_333 ( & V_11 -> V_36 , F_317 ) ;
V_11 -> V_226 = V_226 ;
V_11 -> V_282 [ 0 ] = V_282 [ 0 ] ;
V_11 -> V_282 [ 1 ] = V_282 [ 1 ] ;
V_11 -> V_87 = V_87 ;
V_11 -> V_88 = V_88 ;
V_11 -> V_39 [ 0 ] = V_312 ;
V_11 -> V_39 [ 1 ] = V_313 ;
...
static T_7
F_339 ( unsigned int * V_315 , const char * V_316 , T_8 V_22 )
{
char * V_154 = ( char * ) V_316 ;
* V_315 = F_340 ( V_154 , & V_154 , 10 ) ;
return V_22 ;
}
