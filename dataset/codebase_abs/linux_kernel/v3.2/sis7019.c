...
return - V_184 ;
V_25 -> V_173 = 0 ;
V_152 = F_75 ( 500 ) + V_186 ;
while ( F_76 ( V_186 , V_152 ) ) {
V_20 = F_9 ( V_26 + V_153 ) ;
if ( V_20 & V_146 )
V_25 -> V_173 |= V_174 ;
if ( V_20 & V_147 )
...
F_10 ( V_189 , V_26 + V_190 ) ;
F_10 ( V_189 | V_191 |
V_192 |
V_193 |
V_194 , V_26 + V_190 ) ;
F_10 ( 0 , V_26 + V_195 ) ;
F_10 ( V_196 , V_26 + V_197 ) ;
F_10 ( 0 , V_26 + V_198 ) ;
F_10 ( 0 , V_26 + V_199 ) ;
F_10 ( 0 , V_26 + V_200 ) ;
F_10 ( 0 , V_26 + V_201 ) ;
F_10 ( 0 , V_26 + V_202 ) ;
for ( V_49 = 0 ; V_49 < 64 ; V_49 ++ ) {
F_37 ( V_49 , F_78 ( V_181 , V_49 ) ) ;
F_37 ( V_203 | V_204 |
V_205 , F_79 ( V_181 , V_49 ) ) ;
}
F_10 ( 0xffff0000 , V_26 + V_206 ) ;
F_10 ( 0 , V_26 + V_207 ) ;
F_10 ( V_208 |
V_209 , V_26 + V_180 ) ;
return 0 ;
}
static int F_80 ( struct V_210 * V_44 , T_7 V_211 )
{
struct V_212 * V_134 = F_81 ( V_44 ) ;
...
F_85 ( V_25 -> V_45 [ V_49 ] , V_181 , 4096 ) ;
V_181 += 4096 ;
}
F_72 ( V_44 ) ;
F_86 ( V_44 ) ;
F_87 ( V_44 , F_88 ( V_44 , V_211 ) ) ;
return 0 ;
}
static int F_89 ( struct V_210 * V_44 )
{
struct V_212 * V_134 = F_81 ( V_44 ) ;
struct V_24 * V_25 = V_134 -> V_56 ;
void T_2 * V_181 = V_25 -> V_181 ;
...
if ( F_92 ( V_44 -> V_22 , F_8 , V_215 ,
V_216 , V_25 ) ) {
F_61 ( V_158 L_7 , V_44 -> V_22 ) ;
goto error;
}
for ( V_49 = 0 ; V_49 < 4 ; V_49 ++ ) {
F_93 ( V_181 , V_25 -> V_45 [ V_49 ] , 4096 ) ;
V_181 += 4096 ;
}
...
int V_49 ;
for ( V_49 = 0 ; V_49 < V_177 ; V_49 ++ ) {
V_25 -> V_45 [ V_49 ] = F_98 ( 4096 , V_218 ) ;
if ( ! V_25 -> V_45 [ V_49 ] )
return - V_58 ;
}
memset ( V_25 -> V_45 [ 0 ] , 0 , 4096 ) ;
...
static int T_6 F_99 ( struct V_212 * V_134 ,
struct V_210 * V_44 )
{
struct V_24 * V_25 = V_134 -> V_56 ;
struct V_1 * V_1 ;
static struct V_219 V_170 = {
. V_220 = F_73 ,
} ;
int V_116 ;
int V_49 ;
...
V_25 -> V_44 = V_44 ;
V_25 -> V_22 = - 1 ;
V_25 -> V_27 = F_104 ( V_44 , 0 ) ;
V_116 = F_105 ( V_44 , L_1 ) ;
if ( V_116 ) {
F_61 ( V_158 L_10 ) ;
goto V_222;
}
V_116 = - V_184 ;
V_25 -> V_181 = F_106 ( F_104 ( V_44 , 1 ) , 0x4000 ) ;
if ( ! V_25 -> V_181 ) {
F_61 ( V_158 L_11 ) ;
goto V_223;
}
...
V_1 = & V_25 -> V_34 [ V_49 ] ;
V_1 -> V_104 = V_49 ;
V_1 -> V_4 = F_107 ( V_25 -> V_181 , V_49 ) ;
V_1 -> V_64 = F_108 ( V_25 -> V_181 , V_49 ) ;
}
V_1 = & V_25 -> V_37 ;
V_1 -> V_8 = V_103 ;
V_1 -> V_104 = V_224 ;
V_1 -> V_4 = F_109 ( V_25 -> V_181 , V_1 -> V_104 ) ;
V_116 = F_110 ( V_134 , V_225 , V_25 , & V_170 ) ;
if ( V_116 )
goto V_223;
F_111 ( V_134 , & V_44 -> V_23 ) ;
return 0 ;
V_223:
F_68 ( V_25 ) ;
V_222:
...
static int T_6 F_112 ( struct V_210 * V_44 ,
...
if ( ! V_187 )
V_187 = V_174 ;
V_116 = F_113 ( V_230 , V_231 , V_232 , sizeof( * V_25 ) , & V_134 ) ;
if ( V_116 < 0 )
goto V_221;
strcpy ( V_134 -> V_233 , L_1 ) ;
strcpy ( V_134 -> V_234 , L_1 ) ;
V_116 = F_99 ( V_134 , V_44 ) ;
if ( V_116 )
goto V_235;
V_25 = V_134 -> V_56 ;
V_116 = F_64 ( V_25 ) ;
...
if ( V_116 )
goto V_235;
snprintf ( V_134 -> V_236 , sizeof( V_134 -> V_236 ) ,
L_14 ,
V_134 -> V_234 , F_114 ( V_25 -> V_114 [ 0 ] ) ,
V_25 -> V_27 , V_25 -> V_22 ) ;
V_116 = F_115 ( V_134 ) ;
if ( V_116 )
goto V_235;
...
static void T_8 F_118 ( struct V_210 * V_44 )
{
F_117 ( F_81 ( V_44 ) ) ;
F_116 ( V_44 , NULL ) ;
}
