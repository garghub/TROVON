...
{
F_45 ( V_2 -> V_105 , ( V_2 -> V_106 <= 0 ) , V_87 ) ;
F_62 ( & V_2 -> V_107 ) ;
F_63 ( & V_2 -> V_82 ) ;
V_2 -> V_106 = 0 ;
}
...
if ( V_2 -> V_106 <= 0 )
return;
V_110 = F_54 ( V_2 , V_2 -> V_111 , V_2 -> V_106 ) ;
if ( V_110 > 0 ) {
F_6 ( L_47 , V_21 , V_110 ) ;
V_2 -> V_106 = 0 ;
} else if ( V_110 == - V_61 ) {
...
{
struct V_1 * V_2 =
F_53 ( V_94 , struct V_1 , V_107 . V_94 ) ;
unsigned long V_3 ;
#ifdef F_4
static long V_112 = 0 ;
if ( V_112 == 0 )
...
#endif
F_10 ( & V_2 -> V_12 , V_3 ) ;
F_6 ( L_49 , V_21 , V_2 -> V_106 ) ;
if ( ! F_2 ( V_2 ) ) {
F_70 ( & V_2 -> V_107 , V_113 ) ;
goto V_114;
}
F_68 ( V_2 ) ;
if ( V_2 -> V_106 > 0 )
...
int V_119 = F_75 ( V_27 , F_72 ( V_2 -> V_40 ) ) ;
F_55 ( V_2 -> V_106 < 0 ) ;
memcpy ( V_2 -> V_111 + V_2 -> V_106 , V_116 , V_119 ) ;
V_2 -> V_106 += V_119 ;
V_117 += V_119 ;
V_116 += V_119 ;
V_27 -= V_119 ;
...
V_124 -> type = V_133 ;
V_124 -> V_134 = V_135 ;
V_124 -> V_134 . V_136 = V_137 | V_138 | V_139 | V_140 ;
V_124 -> V_134 . V_141 = 9600 ;
V_124 -> V_134 . V_142 = 9600 ;
V_124 -> V_3 = V_143 ;
F_82 ( V_124 , & V_144 ) ;
for ( V_24 = 0 ; V_24 < V_99 ; V_24 ++ ) {
struct V_1 * V_2 = & V_101 [ V_24 ] ;
int V_89 = 1 ;
...
if ( F_84 ( V_124 ) )
F_85 ( L_55 ) ;
F_17 ( V_145 L_56 , V_99 ) ;
return 0 ;
}
static void F_86 ( struct V_146 * V_146 , const char * V_26 ,
unsigned int V_27 )
{
struct V_1 * V_2 = & V_101 [ V_146 -> V_10 ] ;
char V_64 [ V_96 ] V_55 ;
unsigned int V_24 = 0 , V_110 = 0 ;
int V_89 , V_147 = 0 ;
F_58 () ;
if ( ! F_2 ( V_2 ) )
return;
...
struct V_1 * V_2 ;
int V_89 ;
if ( V_146 -> V_10 < 0 || V_146 -> V_10 >= V_99 )
return - 1 ;
V_2 = & V_101 [ V_146 -> V_10 ] ;
F_56 ( V_2 ) ;
V_89 = F_51 ( V_2 ) ;
if ( V_89 < 0 )
return V_89 ;
