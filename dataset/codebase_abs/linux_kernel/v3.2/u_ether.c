...
F_71 ( & V_12 -> V_68 ) ;
V_12 -> V_9 = V_9 ;
strcpy ( V_9 -> V_28 , L_17 ) ;
if ( F_62 ( V_123 , V_9 -> V_123 ) )
F_72 ( & V_125 -> V_12 ,
L_18 , L_19 ) ;
if ( F_62 ( V_129 , V_12 -> V_130 ) )
F_72 ( & V_125 -> V_12 ,
L_18 , L_20 ) ;
if ( V_126 )
memcpy ( V_126 , V_12 -> V_130 , V_127 ) ;
V_9 -> V_131 = & V_132 ;
F_73 ( V_9 , & V_133 ) ;
F_74 ( V_9 ) ;
V_12 -> V_2 = V_125 ;
...
{
struct V_11 * V_12 = V_128 ;
int V_135 = 0 ;
if ( ! V_12 )
return F_85 ( - V_136 ) ;
V_91 -> V_93 -> V_65 = V_12 ;
V_135 = F_61 ( V_91 -> V_93 ) ;
if ( V_135 != 0 ) {
F_13 ( V_12 , L_24 ,
V_91 -> V_93 -> V_28 , V_135 ) ;
goto V_137;
}
V_91 -> V_43 -> V_65 = V_12 ;
V_135 = F_61 ( V_91 -> V_43 ) ;
if ( V_135 != 0 ) {
F_13 ( V_12 , L_24 ,
V_91 -> V_43 -> V_28 , V_135 ) ;
goto V_138;
}
if ( V_135 == 0 )
V_135 = F_37 ( V_12 , V_91 , F_1 ( V_12 -> V_2 ) ) ;
if ( V_135 == 0 ) {
V_12 -> V_114 = V_91 -> V_139 ;
