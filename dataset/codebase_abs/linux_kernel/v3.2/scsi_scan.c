...
static void F_35 ( struct V_71 * V_28 )
{
...
int F_37 ( const struct V_71 * V_28 )
{
return V_28 -> type == & V_75 ;
}
static struct V_21 * F_38 ( struct V_71 * V_29 ,
int V_46 , T_1 V_45 )
{
...
static struct V_21 * F_40 ( struct V_71 * V_29 ,
int V_46 , T_1 V_45 )
{
struct V_27 * V_5 = F_18 ( V_29 ) ;
...
V_22 -> V_81 = 1 ;
V_28 -> V_29 = F_23 ( V_29 ) ;
F_42 ( V_28 , L_4 , V_5 -> V_82 , V_46 , V_45 ) ;
V_28 -> V_83 = & V_84 ;
V_28 -> type = & V_75 ;
V_22 -> V_45 = V_45 ;
V_22 -> V_46 = V_46 ;
...
{
struct V_21 * V_22 =
F_47 ( V_32 , struct V_21 , V_98 . V_32 ) ;
F_48 ( & V_22 -> V_28 ) ;
F_49 ( & V_22 -> V_28 ) ;
F_30 ( V_22 ) ;
}
...
static void F_53 ( unsigned char * V_101 , int V_102 )
{
int V_103 = 0 ;
...
static int F_54 ( struct V_12 * V_13 , unsigned char * V_104 ,
int V_105 , int * V_106 )
{
unsigned char V_15 [ V_16 ] ;
...
static int F_61 ( struct V_12 * V_13 , unsigned char * V_104 ,
int * V_106 , int V_129 )
{
int V_26 ;
V_13 -> V_130 = F_62 ( V_104 ,
F_63 ( V_131 , V_13 -> V_115 , 36 ) ,
V_36 ) ;
if ( V_13 -> V_130 == NULL )
return V_132 ;
...
if ( * V_106 & V_176 )
V_13 -> V_177 = 1 ;
V_26 = F_66 ( V_13 , V_178 ) ;
if ( V_26 ) {
V_26 = F_66 ( V_13 , V_179 ) ;
if ( V_26 ) {
F_56 ( V_80 , V_13 ,
L_20 ,
F_67 ( V_13 -> V_47 ) ) ;
...
if ( ! V_129 && F_69 ( V_13 ) != 0 )
return V_132 ;
return V_188 ;
}
static unsigned char * F_70 ( unsigned char * V_189 , unsigned char * V_190 ,
...
V_198 = F_61 ( V_13 , V_14 , & V_106 , V_5 -> V_206 ) ;
if ( V_198 == V_188 ) {
if ( V_106 & V_207 ) {
V_13 -> V_153 = 0 ;
F_15 ( V_13 , V_14 ) ;
...
if ( ( F_71 ( V_22 , V_23 , NULL , NULL , V_197 ,
NULL ) != V_188 ) &&
! V_208 )
return;
}
int F_79 ( struct V_216 * V_217 )
{
int V_218 ;
unsigned int V_23 ;
V_23 = 0 ;
...
void F_80 ( unsigned int V_23 , struct V_216 * V_217 )
{
int V_218 ;
...
static int F_81 ( struct V_21 * V_22 , int V_106 ,
int V_197 )
{
char V_219 [ 64 ] ;
unsigned char V_15 [ V_16 ] ;
...
F_71 ( V_22 , V_23 , NULL , & V_13 , 1 , V_24 ) ;
F_88 ( V_5 ) ;
}
F_89 ( & V_5 -> V_235 ) ;
F_90 ( V_22 ) ;
...
{
struct V_12 * V_13 =
F_82 ( V_42 , V_46 , V_236 , V_23 , NULL ) ;
if ( F_92 ( V_13 ) )
return F_93 ( V_13 ) ;
F_75 ( V_13 ) ;
return 0 ;
}
void F_94 ( struct V_71 * V_28 )
{
struct V_237 * V_238 ;
if ( ! V_28 -> V_239 )
return;
V_238 = F_95 ( V_28 -> V_239 ) ;
if ( F_96 ( V_238 -> V_240 ) ) {
if ( V_238 -> V_197 )
V_238 -> V_197 ( V_28 ) ;
F_97 ( V_238 -> V_240 ) ;
...
static void F_98 ( struct V_71 * V_29 , unsigned int V_46 ,
...
F_84 ( V_22 ) ;
if ( V_23 != V_242 ) {
F_71 ( V_22 , V_23 , NULL , NULL , V_197 , NULL ) ;
goto V_243;
}
V_198 = F_71 ( V_22 , 0 , & V_106 , NULL , V_197 , NULL ) ;
if ( V_198 == V_188 || V_198 == V_204 ) {
if ( F_81 ( V_22 , V_106 , V_197 ) != 0 )
F_78 ( V_22 , V_106 ,
V_22 -> V_89 , V_197 ) ;
}
V_243:
...
void F_99 ( struct V_71 * V_29 , unsigned int V_46 ,
unsigned int V_45 , unsigned int V_23 , int V_197 )
{
struct V_27 * V_5 = F_18 ( V_29 ) ;
if ( strncmp ( V_233 , L_50 , 4 ) == 0 )
...
F_1 () ;
if ( F_86 ( V_5 ) && F_87 ( V_5 ) == 0 ) {
F_98 ( V_29 , V_46 , V_45 , V_23 , V_197 ) ;
F_88 ( V_5 ) ;
}
F_89 ( & V_5 -> V_235 ) ;
}
...
F_100 ( V_5 , V_46 , V_45 , V_23 , V_197 ) ;
F_88 ( V_5 ) ;
}
F_89 ( & V_5 -> V_235 ) ;
return 0 ;
...
F_101 ( V_5 , V_242 , V_242 ,
V_242 , 0 ) ;
}
}
static int F_111 ( void * V_254 )
{
...
V_256 = F_113 ( F_111 , V_2 , L_54 , V_5 -> V_82 ) ;
if ( F_92 ( V_256 ) )
F_111 ( V_2 ) ;
}
...
if ( ! F_86 ( V_5 ) )
goto V_37;
V_22 = F_40 ( & V_5 -> V_232 , 0 , V_5 -> V_241 ) ;
if ( ! V_22 )
goto V_37;
V_13 = F_17 ( V_22 , 0 , NULL ) ;
if ( V_13 )
...
{
F_51 ( V_13 -> V_45 != V_13 -> V_42 -> V_241 ) ;
F_29 ( V_13 ) ;
}
