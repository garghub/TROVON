...
#endif
F_35 ( & V_67 ) ;
if ( ( V_26 = F_36 ( V_2 , V_58 , V_19 ) ) ) {
F_37 ( V_68 L_8 ) ;
goto V_69;
}
if ( F_28 ( V_2 , V_70 ) ) {
F_38 ( V_10 , V_2 ) ;
V_26 = F_39 ( V_2 , & V_2 -> V_71 , V_72 ) ;
if ( V_26 )
goto V_69;
}
if ( ( V_26 = F_39 ( V_2 , & V_2 -> V_73 , V_74 ) ) )
goto V_75;
if ( V_2 -> V_19 -> V_76 ) {
...
F_41 ( & V_2 -> V_80 , & V_19 -> V_81 ) ;
F_42 ( L_9 ,
V_19 -> V_22 , V_19 -> V_82 , V_19 -> V_83 , V_19 -> V_84 ,
V_19 -> V_85 , F_43 ( V_10 ) , V_2 -> V_73 -> V_86 ) ;
F_44 ( & V_67 ) ;
return 0 ;
V_78:
F_45 ( & V_2 -> V_73 ) ;
...
int F_47 ( struct V_59 * V_19 , struct V_17 * V_18 )
{
...
V_10 = NULL ;
while ( ( V_10 =
F_50 ( V_87 -> V_64 , V_87 -> V_62 , V_87 -> V_92 ,
V_87 -> V_93 , V_10 ) ) != NULL ) {
...
void F_52 ( struct V_59 * V_19 , struct V_17 * V_18 )
{
struct V_1 * V_2 , * V_96 ;
F_23 ( L_7 ) ;
if ( V_19 -> V_90 & V_70 ) {
...
F_54 (dev, tmp, &driver->device_list, driver_item)
F_55 ( V_2 ) ;
}
F_42 ( L_10 ) ;
}
