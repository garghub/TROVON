...
if ( V_19 -> V_6 & V_121 )
F_54 ( & V_12 -> V_122 , & V_123 ) ;
if ( V_19 -> V_6 & V_124 )
F_54 ( & V_12 -> V_122 , & V_125 ) ;
if ( V_19 -> V_6 & V_60 )
F_54 ( & V_12 -> V_122 , & V_126 ) ;
if ( V_19 -> V_6 & V_57 )
F_55 ( V_12 , & V_127 . V_128 ) ;
F_55 ( V_12 , & V_129 ) ;
F_54 ( & V_12 -> V_122 , & V_130 ) ;
}
...
{
struct V_32 * V_12 = & V_2 -> V_12 ;
struct V_102 * V_4 = F_58 ( V_12 -> V_136 ) ;
struct V_18 * V_19 ;
int V_11 ;
V_19 = F_59 ( sizeof( struct V_18 ) , V_137 ) ;
if ( ! V_19 ) {
V_11 = - V_138 ;
goto exit;
}
...
F_56 ( V_2 ) ;
V_11 = F_62 ( & V_12 -> V_122 , & V_130 ) ;
if ( V_11 )
goto V_142;
if ( V_2 -> V_6 & V_7 ) {
V_11 = F_63 ( V_12 , & V_129 ) ;
if ( V_11 )
goto V_143;
}
if ( V_19 -> V_6 & V_57 ) {
...
if ( V_19 -> V_6 & V_60 ) {
V_11 = F_62 ( & V_12 -> V_122 , & V_126 ) ;
if ( V_11 )
goto V_143;
}
if ( V_19 -> V_6 & V_124 ) {
V_11 = F_62 ( & V_12 -> V_122 ,
& V_125 ) ;
if ( V_11 )
goto V_143;
}
if ( V_19 -> V_6 & V_121 ) {
V_11 = F_62 ( & V_12 -> V_122 , & V_123 ) ;
if ( V_11 )
goto V_143;
}
V_19 -> V_144 = F_64 ( V_12 ) ;
if ( F_65 ( V_19 -> V_144 ) ) {
V_11 = F_66 ( V_19 -> V_144 ) ;
goto V_143;
}
return 0 ;
V_143:
...
static void F_70 ( struct V_1 * V_2 , unsigned int V_145 )
{
struct V_18 * V_19 = F_14 ( V_2 ) ;
