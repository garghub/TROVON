...
struct V_115 * V_115 ;
struct V_10 * V_11 = V_9 -> V_12 ;
V_50 = F_49 ( sizeof( struct V_1 ) , V_116 ) ;
if ( ! V_50 )
return;
V_115 = F_49 ( sizeof( struct V_115 ) , V_116 ) ;
if ( ! V_115 ) {
F_28 ( V_50 ) ;
return;
}
...
F_50 ( V_9 , & V_115 -> V_4 ,
& V_117 , V_118 ) ;
F_51 ( V_9 , & V_50 -> V_4 . V_4 , & V_119 ,
V_120 ) ;
F_52 ( V_115 , & V_50 -> V_4 ) ;
V_50 -> V_4 . type = V_68 ;
V_50 -> V_4 . V_121 = ( 1 << V_122 |
1 << V_123 |
1 << V_124 ) ;
V_50 -> V_4 . V_125 = ( 1 << 0 ) | ( 1 << 1 ) ;
V_3 -> V_126 = 1 ;
V_3 -> V_127 = 0 ;
F_53 ( & V_50 -> V_4 . V_4 , & V_128 ) ;
F_54 ( V_3 , & V_129 ) ;
F_55 ( V_3 ) ;
if ( F_38 ( V_9 ) )
V_3 -> V_130 = V_131 ;
