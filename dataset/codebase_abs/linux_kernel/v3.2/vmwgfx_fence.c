...
{
struct V_32 * V_110 =
F_2 ( V_1 , struct V_32 , V_1 ) ;
struct V_67 * V_68 =
F_56 ( F_74 ( V_110 -> V_89 ) ) ;
T_2 V_111 = V_110 -> V_111 ;
F_5 ( V_110 -> V_112 . V_113 ) ;
F_5 ( V_110 ) ;
F_55 ( V_68 , V_111 ) ;
}
static void F_77 ( struct V_114 * V_112 )
{
struct V_32 * V_110 =
F_2 ( V_112 , struct V_32 , V_112 ) ;
F_35 ( & V_110 -> V_1 , F_76 ) ;
}
...
struct V_88 * V_89 = V_110 -> V_89 ;
struct V_76 * V_77 = V_110 -> V_112 . V_77 ;
unsigned long V_33 ;
F_32 ( & V_110 -> V_1 ) ;
F_24 ( & V_89 -> V_115 , V_33 ) ;
if ( F_38 ( V_110 -> V_116 != NULL ) ) {
struct V_117 V_118 ;
F_79 ( & V_118 ) ;
* V_110 -> V_116 = V_118 . V_116 ;
* V_110 -> V_119 = V_118 . V_119 ;
}
F_30 ( & V_110 -> V_112 . V_120 , & V_77 -> V_121 ) ;
F_44 ( & V_77 -> V_122 ) ;
...
F_20 ( V_113 -> V_125 ) ;
int V_37 ;
V_37 = F_58 ( V_68 , V_111 , false , V_63 ) ;
if ( F_17 ( V_37 != 0 ) )
return V_37 ;
V_110 = F_16 ( sizeof( * V_110 ) , V_25 ) ;
if ( F_17 ( V_110 == NULL ) ) {
F_55 ( V_68 , V_111 ) ;
return - V_69 ;
}
V_110 -> V_112 . V_113 = V_113 ;
V_110 -> V_112 . V_77 = V_77 ;
V_110 -> V_112 . V_10 = F_77 ;
V_110 -> V_16 . V_47 = F_78 ;
V_110 -> V_16 . V_23 = F_80 ;
V_110 -> V_16 . type = V_126 ;
V_110 -> V_3 = F_31 ( V_3 ) ;
V_110 -> V_89 = V_5 -> V_22 -> V_89 ;
V_110 -> V_111 = V_111 ;
V_110 -> V_116 = V_116 ;
V_110 -> V_119 = V_119 ;
F_28 ( & V_110 -> V_1 ) ;
...
int F_84 ( struct V_88 * V_89 , void * V_90 ,
struct V_76 * V_77 )
{
struct V_24 * V_22 = F_74 ( V_89 ) ;
struct V_127 * V_92 =
(struct V_127 * ) V_90 ;
struct V_2 * V_3 = NULL ;
struct F_62 * V_128 = F_62 ( V_77 ) ;
struct V_129 T_6 * V_130 =
(struct V_129 T_6 * ) ( unsigned long )
V_92 -> V_131 ;
T_2 V_99 ;
unsigned long V_33 ;
struct V_132 * V_113 ;
...
F_26 ( V_3 == NULL ) ;
F_24 ( & V_89 -> V_115 , V_33 ) ;
V_37 = ( V_77 -> V_135 < sizeof( * V_113 ) ) ? - V_42 : 0 ;
if ( F_38 ( V_37 == 0 ) )
V_77 -> V_135 -= sizeof( * V_113 ) ;
F_25 ( & V_89 -> V_115 , V_33 ) ;
if ( F_17 ( V_37 != 0 ) ) {
F_85 ( L_8 ) ;
goto V_136;
...
V_113 -> V_75 . type = V_138 ;
V_113 -> V_75 . V_125 = sizeof( * V_113 ) ;
V_113 -> V_139 = V_92 -> V_139 ;
if ( V_92 -> V_55 & V_140 )
V_37 = F_83 ( V_77 , V_3 ,
& V_113 -> V_75 ,
& V_113 -> V_116 ,
