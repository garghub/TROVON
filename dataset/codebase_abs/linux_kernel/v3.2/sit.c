...
static int F_55 ( struct V_89 * V_90 , T_4 V_101 )
{
const struct V_91 * V_24 = ( const struct V_91 * ) V_90 -> V_102 ;
const int type = F_56 ( V_90 ) -> type ;
const int V_103 = F_56 ( V_90 ) -> V_103 ;
struct V_13 * V_19 ;
int V_80 ;
switch ( type ) {
default:
...
goto V_77;
if ( F_57 ( V_113 , V_19 -> V_114 + V_115 ) )
V_19 -> V_116 ++ ;
else
V_19 -> V_116 = 1 ;
V_19 -> V_114 = V_113 ;
...
static inline void F_58 ( const struct V_91 * V_24 , struct V_89 * V_90 )
{
if ( F_59 ( V_24 -> V_117 ) )
F_60 ( F_49 ( V_90 ) ) ;
}
...
struct V_13 * V_118 ;
if ( ! F_62 ( V_90 , sizeof( struct V_119 ) ) )
goto V_77;
V_24 = F_63 ( V_90 ) ;
F_34 () ;
...
static inline
T_1 F_72 ( const struct V_97 * V_127 , struct V_13 * V_118 )
{
T_1 V_128 = 0 ;
#ifdef F_16
if ( F_73 ( V_127 , & V_118 -> V_40 . V_41 ,
V_118 -> V_40 . V_43 ) ) {
...
V_132 = ( F_74 ( V_127 -> V_99 [ V_129 ] ) << V_130 ) >>
V_118 -> V_40 . V_44 ;
V_131 = V_130 - V_118 -> V_40 . V_44 ;
if ( V_131 > 0 )
V_132 |= F_74 ( V_127 -> V_99 [ V_129 + 1 ] ) >>
( 32 - V_131 ) ;
V_128 = V_118 -> V_40 . V_42 | F_19 ( V_132 ) ;
}
#else
if ( V_127 -> V_133 [ 0 ] == F_67 ( 0x2002 ) ) {
memcpy ( & V_128 , & V_127 -> V_133 [ 1 ] , 4 ) ;
}
#endif
return V_128 ;
}
static T_5 F_75 ( struct V_89 * V_90 ,
struct V_2 * V_3 )
{
...
V_139 = F_82 ( F_53 ( V_3 ) , & V_143 , NULL ,
V_128 , V_134 -> V_25 ,
0 , 0 ,
V_155 , F_83 ( V_117 ) ,
V_118 -> V_23 . V_27 ) ;
...
if ( V_136 ) {
V_144 = F_86 ( & V_139 -> V_128 ) - sizeof( struct V_91 ) ;
if ( V_144 < 68 ) {
V_3 -> V_12 . V_159 ++ ;
F_85 ( V_139 ) ;
goto V_146;
...
if ( V_118 -> V_23 . V_24 . V_26 && F_77 ( V_90 ) )
F_77 ( V_90 ) -> V_161 -> V_162 ( F_77 ( V_90 ) , V_144 ) ;
if ( V_90 -> V_67 > V_144 ) {
F_87 ( V_90 , V_163 , 0 , V_144 ) ;
F_85 ( V_139 ) ;
goto V_146;
}
}
...
V_141 = F_89 ( V_140 ) + sizeof( struct V_91 ) ;
if ( F_90 ( V_90 ) < V_141 || F_91 ( V_90 ) ||
( F_92 ( V_90 ) && ! F_93 ( V_90 , 0 ) ) ) {
struct V_89 * V_164 = F_94 ( V_90 , V_141 ) ;
if ( ! V_164 ) {
F_85 ( V_139 ) ;
V_3 -> V_12 . V_165 ++ ;
F_95 ( V_90 ) ;
...
if ( V_90 -> V_167 )
F_96 ( V_164 , V_90 -> V_167 ) ;
F_95 ( V_90 ) ;
V_90 = V_164 ;
V_135 = F_49 ( V_90 ) ;
}
V_90 -> V_168 = V_90 -> V_121 ;
F_97 ( V_90 , sizeof( struct V_91 ) ) ;
F_65 ( V_90 ) ;
memset ( & ( F_66 ( V_90 ) -> V_169 ) , 0 , sizeof( F_66 ( V_90 ) -> V_169 ) ) ;
F_66 ( V_90 ) -> V_29 = 0 ;
F_98 ( V_90 ) ;
F_99 ( V_90 , & V_139 -> V_128 ) ;
V_24 = F_63 ( V_90 ) ;
V_24 -> V_170 = 4 ;
V_24 -> V_171 = sizeof( struct V_91 ) >> 2 ;
V_24 -> V_137 = V_136 ;
V_24 -> V_122 = V_155 ;
V_24 -> V_117 = F_100 ( V_117 , F_76 ( V_135 ) ) ;
...
if ( V_24 -> V_26 ) {
struct V_138 * V_139 = F_82 ( F_53 ( V_3 ) , & V_143 , NULL ,
V_24 -> V_26 , V_24 -> V_25 ,
0 , 0 ,
V_155 ,
F_83 ( V_24 -> V_117 ) ,
...
V_140 = F_104 ( F_53 ( V_3 ) , V_118 -> V_23 . V_27 ) ;
if ( V_140 ) {
...
static int
F_105 ( struct V_2 * V_3 , struct V_176 * V_177 , int V_178 )
{
int V_80 = 0 ;
struct V_32 V_79 ;
struct V_60 V_59 ;
...
F_106 ( & V_40 . V_41 , & V_19 -> V_40 . V_41 ) ;
...
V_79 . V_24 . V_171 != 5 || ( V_79 . V_24 . V_137 & F_67 ( ~ V_188 ) ) )
goto V_184;
if ( V_79 . V_24 . V_112 )
V_79 . V_24 . V_137 |= F_67 ( V_188 ) ;
