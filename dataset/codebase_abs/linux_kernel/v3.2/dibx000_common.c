...
{
T_2 V_43 [ 4 ] ;
struct V_10 V_58 = { . V_11 = V_2 -> V_12 , . V_14 = V_43 , . V_15 = 4 } ;
F_16 ( V_2 , V_43 , 0 , 0 ) ;
F_4 ( V_2 -> V_16 , & V_58 , 1 ) ;
V_2 -> V_38 = 0xff ;
F_13 ( V_2 , V_50 ) ;
...
struct V_59 * V_60 , const char * V_61 ,
struct V_1 * V_2 )
{
strncpy ( V_16 -> V_61 , V_61 , sizeof( V_16 -> V_61 ) ) ;
V_16 -> V_60 = V_60 ;
V_16 -> V_62 = NULL ;
F_23 ( V_16 , V_2 ) ;
if ( F_24 ( V_16 ) < 0 )
...
V_2 -> V_16 = V_16 ;
V_2 -> V_12 = V_12 >> 1 ;
if ( V_31 == V_64 || V_31 == V_65 )
V_2 -> V_22 = 1024 ;
else
V_2 -> V_22 = 768 ;
V_2 -> V_53 . V_66 . V_67 = V_2 -> V_16 -> V_66 . V_67 ;
if ( F_22
( & V_2 -> V_53 , & V_68 ,
L_6 , V_2 ) != 0 )
F_20 ( V_57
L_7 ) ;
V_2 -> V_54 . V_66 . V_67 = V_2 -> V_16 -> V_66 . V_67 ;
if ( F_22
( & V_2 -> V_54 , & V_69 ,
L_8 , V_2 ) != 0 )
F_20 ( V_57
L_9 ) ;
V_2 -> V_55 . V_66 . V_67 = V_2 -> V_16 -> V_66 . V_67 ;
if ( F_22
( & V_2 -> V_55 , & V_70 ,
L_10 , V_2 ) != 0 )
F_20 ( V_57
L_9 ) ;
V_2 -> V_56 . V_66 . V_67 = V_2 -> V_16 -> V_66 . V_67 ;
if ( F_22
( & V_2 -> V_56 , & V_71 ,
L_11 , V_2 ) != 0 )
F_20 ( V_57
...
struct V_72 V_73 ;
V_73 = F_30 () ;
return ( V_73 . V_74 * 10000 ) + ( V_73 . V_75 / 100000 ) ;
}
