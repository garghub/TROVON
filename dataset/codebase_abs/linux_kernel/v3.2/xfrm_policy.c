...
static void F_197 ( struct V_31 * V_31 )
{
F_198 () ;
F_196 ( V_31 ) ;
}
static void F_199 ( struct V_31 * V_31 )
{
F_200 () ;
F_196 ( V_31 ) ;
}
...
struct V_229 * V_230 = (struct V_229 * ) V_35 ;
T_3 V_347 , V_348 ;
V_347 = F_201 ( V_35 -> V_256 ) ;
V_230 -> V_349 = V_347 ;
V_347 = F_202 ( V_35 -> V_91 , V_347 ) ;
V_348 = F_201 ( V_230 -> V_231 ) ;
V_230 -> V_348 = V_348 ;
if ( V_347 > V_348 )
V_347 = V_348 ;
F_203 ( V_35 , V_350 , V_347 ) ;
...
struct V_229 * V_352 ;
T_3 V_353 ;
if ( ! F_204 ( V_35 -> V_241 , ( (struct V_229 * ) V_35 ) -> V_354 ) ||
( V_35 -> V_245 && ! F_205 ( V_35 -> V_245 ) ) )
return 0 ;
V_352 = NULL ;
do {
struct V_229 * V_230 = (struct V_229 * ) V_35 ;
...
return 0 ;
V_353 = F_201 ( V_35 -> V_256 ) ;
if ( V_230 -> V_349 != V_353 ) {
V_352 = V_230 ;
V_230 -> V_349 = V_353 ;
}
if ( ! F_204 ( V_230 -> V_231 , V_230 -> V_355 ) )
return 0 ;
V_353 = F_201 ( V_230 -> V_231 ) ;
...
for (; ; ) {
V_35 = & V_352 -> V_7 . V_35 ;
V_353 = F_202 ( V_35 -> V_91 , V_353 ) ;
if ( V_353 > V_352 -> V_348 )
V_353 = V_352 -> V_348 ;
F_203 ( V_35 , V_350 , V_353 ) ;
if ( V_352 == V_351 )
break;
...
static unsigned int F_206 ( const struct V_30 * V_35 )
{
return F_207 ( V_35 -> V_241 ) ;
}
static unsigned int F_208 ( const struct V_30 * V_35 )
{
unsigned int V_353 = F_209 ( V_35 , V_350 ) ;
return V_353 ? : F_201 ( V_35 -> V_241 ) ;
}
static struct V_356 * F_210 ( const struct V_30 * V_35 , const void * V_9 )
{
return F_211 ( V_35 -> V_241 , V_9 ) ;
}
...
static void T_6 F_217 ( struct V_31 * V_31 )
{
struct V_33 * V_34 ;
F_69 ( & V_358 ) ;
V_34 = V_33 [ V_28 ] ;
...
static int F_218 ( struct V_368 * V_369 , unsigned long V_370 , void * V_371 )
{
...
static int T_6 F_219 ( struct V_31 * V_31 )
{
int V_374 ;
if ( F_220 ( ( void V_375 * * ) V_31 -> V_376 . V_377 ,
sizeof( struct V_378 ) ,
F_221 ( struct V_378 ) ) < 0 )
return - V_205 ;
V_374 = F_222 ( V_31 ) ;
if ( V_374 < 0 )
F_223 ( ( void V_375 * * ) V_31 -> V_376 . V_377 ) ;
return V_374 ;
}
...
static void F_232 ( struct V_31 * V_31 )
{
struct V_168 V_169 ;
unsigned int V_379 ;
int V_58 ;
F_233 ( & V_31 -> V_91 . V_140 ) ;
#ifdef F_106
V_169 . V_170 = - 1 ;
V_169 . V_171 = - 1 ;
V_169 . V_172 = 0 ;
...
static int T_6 F_234 ( struct V_31 * V_31 )
{
int V_374 ;
V_374 = F_219 ( V_31 ) ;
if ( V_374 < 0 )
...
static void T_7 F_238 ( struct V_31 * V_31 )
{
F_239 ( V_31 ) ;
F_232 ( V_31 ) ;
F_237 ( V_31 ) ;
...
static void F_243 ( struct V_52 * V_53 ,
struct V_393 * V_394 )
{
...
switch( V_2 -> V_27 ) {
case V_28 :
F_244 ( V_394 , L_3 , & V_2 -> V_11 . V_398 ) ;
if ( V_2 -> V_12 != 32 )
F_244 ( V_394 , L_4 ,
V_2 -> V_12 ) ;
F_244 ( V_394 , L_5 , & V_2 -> V_9 . V_398 ) ;
if ( V_2 -> V_10 != 32 )
F_244 ( V_394 , L_6 ,
V_2 -> V_10 ) ;
break;
case V_29 :
F_244 ( V_394 , L_7 , V_2 -> V_11 . V_399 ) ;
if ( V_2 -> V_12 != 128 )
F_244 ( V_394 , L_4 ,
V_2 -> V_12 ) ;
F_244 ( V_394 , L_8 , V_2 -> V_9 . V_399 ) ;
if ( V_2 -> V_10 != 128 )
F_244 ( V_394 , L_6 ,
V_2 -> V_10 ) ;
break;
...
void F_245 ( struct V_52 * V_53 , int V_400 ,
...
if ( V_394 == NULL )
return;
F_247 ( V_401 , V_171 , V_172 , V_394 ) ;
F_244 ( V_394 , L_10 , V_400 ) ;
F_243 ( V_53 , V_394 ) ;
F_248 ( V_394 ) ;
}
...
static int F_249 ( const struct V_1 * V_402 ,
const struct V_1 * V_403 )
{
if ( V_402 -> V_19 == V_404 ) {
if ( V_403 -> V_27 == V_402 -> V_27 &&
F_250 ( & V_403 -> V_9 , & V_402 -> V_9 ,
V_402 -> V_27 ) == 0 &&
F_250 ( & V_403 -> V_11 , & V_402 -> V_11 ,
V_402 -> V_27 ) == 0 &&
...
static struct V_52 * F_251 ( const struct V_1 * V_2 ,
T_4 V_58 , T_4 type )
{
...
static int F_252 ( const struct V_405 * V_157 , const struct V_203 * V_406 )
{
int V_181 = 0 ;
if ( V_406 -> V_211 == V_157 -> V_211 && V_406 -> V_43 . V_19 == V_157 -> V_19 &&
( V_157 -> V_316 == 0 || V_406 -> V_316 == V_157 -> V_316 ) ) {
switch ( V_406 -> V_211 ) {
case V_212 :
case V_213 :
if ( F_250 ( & V_406 -> V_43 . V_9 , & V_157 -> V_407 ,
V_157 -> V_408 ) == 0 &&
F_250 ( & V_406 -> V_11 , & V_157 -> V_409 ,
V_157 -> V_408 ) == 0 ) {
V_181 = 1 ;
}
break;
...
static int F_253 ( struct V_52 * V_79 ,
...
if ( ! F_252 ( V_411 , & V_79 -> V_202 [ V_115 ] ) )
continue;
V_413 ++ ;
...
static int F_254 ( const struct V_405 * V_157 , int V_410 )
{
int V_115 , V_412 ;
if ( V_410 < 1 || V_410 > V_224 )
return - V_179 ;
for ( V_115 = 0 ; V_115 < V_410 ; V_115 ++ ) {
if ( ( F_250 ( & V_157 [ V_115 ] . V_407 , & V_157 [ V_115 ] . V_414 ,
V_157 [ V_115 ] . V_408 ) == 0 ) &&
( F_250 ( & V_157 [ V_115 ] . V_409 , & V_157 [ V_115 ] . V_415 ,
V_157 [ V_115 ] . V_408 ) == 0 ) )
return - V_179 ;
...
V_157 [ V_115 ] . V_316 == V_157 [ V_412 ] . V_316 &&
...
struct V_405 * V_411 ;
if ( ( V_165 = F_254 ( V_157 , V_410 ) ) < 0 )
goto V_62;
if ( ( V_79 = F_251 ( V_2 , V_58 , type ) ) == NULL ) {
V_165 = - V_167 ;
goto V_62;
}
...
if ( ( V_165 = F_253 ( V_79 , V_157 , V_410 ) ) < 0 )
goto V_424;
if ( V_419 ) {
F_257 ( V_422 , V_419 ) ;
F_258 ( V_422 , V_419 ) ;
}
F_259 ( V_2 , V_58 , type , V_157 , V_410 , V_325 ) ;
F_24 ( V_79 ) ;
return 0 ;
V_62:
return V_165 ;
