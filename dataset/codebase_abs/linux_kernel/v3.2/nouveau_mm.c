...
int
F_15 ( struct V_1 * V_2 , T_1 V_11 , T_1 V_9 , T_1 V_26 )
{
struct V_3 * F_9 ;
if ( V_26 ) {
F_16 ( & V_2 -> V_27 ) ;
...
F_9 = F_18 ( sizeof( * F_9 ) , V_10 ) ;
if ( ! F_9 )
return - V_24 ;
F_9 -> V_11 = F_13 ( V_11 , V_2 -> V_23 ) ;
F_9 -> V_9 = F_14 ( V_11 + V_9 , V_2 -> V_23 ) - F_9 -> V_11 ;
F_7 ( & F_9 -> V_5 , & V_2 -> V_28 ) ;
F_7 ( & F_9 -> V_6 , & V_2 -> free ) ;
V_2 -> V_29 ++ ;
return 0 ;
}
int
...
{
struct V_3 * F_9 , * V_30 =
F_20 ( & V_2 -> V_28 , struct V_3 , V_5 ) ;
int V_28 = 0 ;
F_12 (node, &mm->nodes, nl_entry) {
if ( V_28 ++ == V_2 -> V_29 ) {
F_21 ( V_31 L_1 ) ;
F_12 (node, &mm->nodes, nl_entry) {
F_21 ( V_31 L_2 ,
