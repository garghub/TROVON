...
int V_21 ,
int (* F_63)( struct V_1 * V_2 , int V_44 ,
struct V_45 * V_46 ,
int V_21 ) )
{
if ( ! V_21 && F_8 ( F_64 ( V_2 , NULL , V_41 ) ) ) {
F_34 ( V_2 , V_41 ) ;
return 0 ;
} else
return F_63 ( V_2 , V_44 , NULL , V_21 ) ;
}
static inline int
F_65 ( struct V_1 * V_2 , int V_44 ,
...
return F_63 ( V_2 , V_44 , V_46 , V_21 ) ;
}
static inline int
F_66 ( struct V_1 * V_2 ,
int (* F_63)( struct V_1 * V_2 ) )
{
if ( F_8 ( F_64 ( V_2 , NULL , V_41 ) ) ) {
F_34 ( V_2 , V_41 ) ;
return 1 ;
}
return F_63 ( V_2 ) ;
...
{
if ( F_8 ( F_64 ( V_2 , V_41 , NULL ) ) )
F_61 ( V_41 ) ;
else
F_63 ( V_2 ) ;
}
void T_1 F_68 ( struct V_1 * V_2 )
{
F_69 () ;
F_62 ( V_2 , V_54 , 0 , F_52 ) ;
}
...
int
F_71 ( struct V_1 * V_2 , struct V_45 * V_46 ,
int V_21 )
{
F_69 () ;
return F_65 ( V_2 , V_48 , V_46 ,
V_21 , F_52 ) ;
}
int T_1 F_72 ( struct V_1 * V_2 )
{
return F_66 ( V_2 , F_58 ) ;
}
void T_1 F_73 ( struct V_1 * V_2 )
{
F_67 ( V_2 , F_59 ) ;
}
...
void F_77 ( struct V_1 * V_2 , const char * V_56 )
{
V_2 -> V_4 = NULL ;
F_78 ( & V_2 -> V_34 ) ;
F_79 ( & V_2 -> V_35 ) ;
...
struct V_3 * F_86 ( struct V_1 * V_2 )
{
if ( ! F_2 ( V_2 ) )
return NULL ;
return F_27 ( V_2 ) -> V_8 ;
