...
static void F_147 ( struct V_107 * V_108 )
{
...
static void F_150 ( struct V_107 * V_108 , struct V_26 * V_30 ,
unsigned long V_59 , void * V_114 )
{
F_146 ( V_108 , V_30 , V_59 , V_114 ) ;
F_147 ( V_108 ) ;
}
static struct V_107 * F_151 ( unsigned long V_40 ,
...
if ( F_55 ( ! V_40 ) )
return NULL ;
V_113 = F_154 ( sizeof( * V_113 ) , V_45 & V_49 , V_44 ) ;
if ( F_55 ( ! V_113 ) )
return NULL ;
V_40 += V_7 ;
...
struct V_107 * F_158 ( unsigned long V_40 , unsigned long V_59 )
{
return F_151 ( V_40 , 1 , V_59 , V_62 , V_63 ,
- 1 , V_106 , F_156 ( 0 ) ) ;
}
...
static struct V_107 * F_160 ( const void * V_2 )
{
struct V_26 * V_30 ;
...
struct V_107 * F_161 ( const void * V_2 )
{
struct V_26 * V_30 ;
V_30 = F_100 ( ( unsigned long ) V_2 ) ;
if ( V_30 && V_30 -> V_59 & V_112 ) {
...
static void F_162 ( const void * V_2 , int V_121 )
{
struct V_107 * V_113 ;
if ( ! V_2 )
return;
if ( ( V_7 - 1 ) & ( unsigned long ) V_2 ) {
F_163 ( 1 , V_122 L_3 , V_2 ) ;
return;
}
V_113 = F_161 ( V_2 ) ;
if ( F_55 ( ! V_113 ) ) {
...
F_164 ( V_2 , V_113 -> V_40 ) ;
if ( V_121 ) {
int V_97 ;
for ( V_97 = 0 ; V_97 < V_113 -> V_123 ; V_97 ++ ) {
...
void * F_170 ( struct V_12 * * V_13 , unsigned int V_105 ,
...
static void * F_171 ( struct V_107 * V_113 , T_6 V_45 ,
T_5 V_11 , int V_44 , void * V_114 )
{
const int V_94 = 0 ;
struct V_12 * * V_13 ;
unsigned int V_123 , V_126 , V_97 ;
T_6 V_127 = ( V_45 & V_49 ) | V_128 ;
V_123 = ( V_113 -> V_40 - V_7 ) >> V_73 ;
V_126 = ( V_123 * sizeof( struct V_12 * ) ) ;
V_113 -> V_123 = V_123 ;
if ( V_126 > V_7 ) {
V_13 = F_172 ( V_126 , 1 , V_127 | V_129 ,
V_130 , V_44 , V_114 ) ;
V_113 -> V_59 |= V_124 ;
} else {
...
F_175 ( V_45 , V_94 ,
L_5 ,
( V_113 -> V_123 * V_7 ) , V_113 -> V_40 ) ;
F_166 ( V_113 -> V_2 ) ;
return NULL ;
}
void * F_176 ( unsigned long V_40 , unsigned long V_41 ,
...
V_40 = F_153 ( V_40 ) ;
if ( ! V_40 || ( V_40 >> V_73 ) > V_125 )
goto V_133;
V_113 = F_151 ( V_40 , V_41 , V_135 | V_116 ,
V_17 , V_3 , V_44 , V_45 , V_114 ) ;
if ( ! V_113 )
goto V_133;
V_2 = F_171 ( V_113 , V_45 , V_11 , V_44 , V_114 ) ;
if ( ! V_2 )
return NULL ;
F_147 ( V_113 ) ;
F_177 ( V_2 , V_134 , 3 , V_45 ) ;
return V_2 ;
V_133:
F_175 ( V_45 , 0 ,
L_6 ,
...
static void * F_172 ( unsigned long V_40 , unsigned long V_41 ,
T_6 V_45 , T_5 V_11 ,
int V_44 , void * V_114 )
{
return F_176 ( V_40 , V_41 , V_62 , V_63 ,
V_45 , V_11 , V_44 , V_114 ) ;
}
void * F_178 ( unsigned long V_40 , T_6 V_45 , T_5 V_11 )
{
return F_172 ( V_40 , 1 , V_45 , V_11 , - 1 ,
F_156 ( 0 ) ) ;
}
static inline void * F_179 ( unsigned long V_40 ,
int V_44 , T_6 V_59 )
{
return F_172 ( V_40 , 1 , V_59 , V_130 ,
V_44 , F_156 ( 0 ) ) ;
}
void * F_180 ( unsigned long V_40 )
{
return F_179 ( V_40 , - 1 , V_106 | V_129 ) ;
}
...
void * F_183 ( unsigned long V_40 , int V_44 )
{
return F_172 ( V_40 , 1 , V_106 | V_129 , V_130 ,
V_44 , F_156 ( 0 ) ) ;
}
void * F_184 ( unsigned long V_40 , int V_44 )
{
return F_179 ( V_40 , V_44 ,
V_106 | V_129 | V_128 ) ;
}
void * F_185 ( unsigned long V_40 )
{
return F_172 ( V_40 , 1 , V_106 | V_129 , V_138 ,
- 1 , F_156 ( 0 ) ) ;
}
void * F_186 ( unsigned long V_40 )
{
return F_172 ( V_40 , 1 , V_139 , V_130 ,
- 1 , F_156 ( 0 ) ) ;
}
...
struct V_107 * V_113 ;
void * V_19 ;
V_19 = F_172 ( V_40 , 1 , V_139 | V_128 , V_130 ,
- 1 , F_156 ( 0 ) ) ;
if ( V_19 ) {
V_113 = F_160 ( V_19 ) ;
V_113 -> V_59 |= V_137 ;
...
static int F_188 ( char * V_140 , char * V_2 , unsigned long V_105 )
{
struct V_12 * V_33 ;
int V_141 = 0 ;
while ( V_105 ) {
unsigned long V_98 , V_142 ;
...
V_33 = F_34 ( V_2 ) ;
if ( V_33 ) {
void * V_143 = F_189 ( V_33 , V_144 ) ;
memcpy ( V_140 , V_143 + V_98 , V_142 ) ;
F_190 ( V_143 , V_144 ) ;
} else
...
static int F_191 ( char * V_140 , char * V_2 , unsigned long V_105 )
{
struct V_12 * V_33 ;
int V_141 = 0 ;
while ( V_105 ) {
...
long F_192 ( char * V_140 , char * V_2 , unsigned long V_105 )
{
struct V_107 * V_35 ;
char * V_145 , * V_146 = V_140 ;
unsigned long V_147 = V_105 ;
unsigned long V_28 ;
...
long F_195 ( char * V_140 , char * V_2 , unsigned long V_105 )
{
struct V_107 * V_35 ;
char * V_145 ;
...
int F_196 ( struct V_149 * V_150 , void * V_2 ,
unsigned long V_151 )
{
struct V_107 * V_113 ;
...
if ( ! ( V_113 -> V_59 & V_137 ) )
return - V_156 ;
if ( V_154 + ( V_151 << V_73 ) > V_113 -> V_40 - V_7 )
return - V_156 ;
V_2 += V_151 << V_73 ;
do {
struct V_12 * V_12 = F_34 ( V_2 ) ;
int V_19 ;
V_19 = F_197 ( V_150 , V_152 , V_12 ) ;
if ( V_19 )
return V_19 ;
V_152 += V_7 ;
V_2 += V_7 ;
...
static int F_198 ( T_2 * V_4 , T_10 V_159 , unsigned long V_2 , void * V_160 )
{
T_2 * * * V_33 = V_160 ;
if ( V_33 ) {
* ( * V_33 ) = V_4 ;
...
struct V_107 * F_199 ( T_8 V_40 , T_2 * * V_161 )
{
struct V_107 * V_113 ;
V_113 = F_159 ( V_40 , V_118 ,
F_156 ( 0 ) ) ;
if ( V_113 == NULL )
return NULL ;
if ( F_200 ( & V_6 , ( unsigned long ) V_113 -> V_2 ,
V_40 , F_198 , V_161 ? & V_161 : NULL ) ) {
F_201 ( V_113 ) ;
return NULL ;
}
return V_113 ;
}
void F_201 ( struct V_107 * V_113 )
{
struct V_107 * V_19 ;
V_19 = F_161 ( V_113 -> V_2 ) ;
F_16 ( V_19 != V_113 ) ;
F_64 ( V_113 ) ;
}
static struct V_26 * F_202 ( struct V_27 * V_28 )
{
return V_28 ? F_45 ( V_28 , struct V_26 , V_27 ) : NULL ;
}
static bool F_203 ( unsigned long V_3 ,
struct V_26 * * V_162 ,
struct V_26 * * V_163 )
{
struct V_27 * V_28 = V_29 . V_27 ;
...
if ( V_30 -> va_end > V_3 ) {
* V_162 = V_30 ;
* V_163 = F_202 ( F_50 ( & ( * V_162 ) -> V_27 ) ) ;
} else {
* V_163 = V_30 ;
* V_162 = F_202 ( F_59 ( & ( * V_163 ) -> V_27 ) ) ;
}
return true ;
}
static unsigned long F_204 ( struct V_26 * * V_162 ,
struct V_26 * * V_163 ,
unsigned long V_41 )
{
const unsigned long V_164 = V_63 & ~ ( V_41 - 1 ) ;
unsigned long V_2 ;
if ( * V_162 )
V_2 = F_205 ( ( * V_162 ) -> va_start & ~ ( V_41 - 1 ) , V_164 ) ;
else
V_2 = V_164 ;
while ( * V_163 && ( * V_163 ) -> va_end > V_2 ) {
* V_162 = * V_163 ;
* V_163 = F_202 ( F_50 ( & ( * V_162 ) -> V_27 ) ) ;
}
return V_2 ;
}
struct V_107 * * F_206 ( const unsigned long * V_165 ,
const T_8 * V_166 , int V_167 ,
T_8 V_41 )
{
const unsigned long V_168 = F_58 ( V_62 , V_41 ) ;
const unsigned long V_164 = V_63 & ~ ( V_41 - 1 ) ;
struct V_26 * * V_169 , * V_37 , * V_9 ;
struct V_107 * * V_170 ;
int V_113 , V_171 , V_172 , V_173 ;
unsigned long V_174 , V_17 , V_3 , V_175 ;
bool V_46 = false ;
F_16 ( V_41 & ~ V_48 || ! F_53 ( V_41 ) ) ;
for ( V_172 = 0 , V_113 = 0 ; V_113 < V_167 ; V_113 ++ ) {
V_17 = V_165 [ V_113 ] ;
V_3 = V_17 + V_166 [ V_113 ] ;
F_16 ( ! F_207 ( V_165 [ V_113 ] , V_41 ) ) ;
F_16 ( ! F_207 ( V_166 [ V_113 ] , V_41 ) ) ;
if ( V_17 > V_165 [ V_172 ] )
V_172 = V_113 ;
for ( V_171 = 0 ; V_171 < V_167 ; V_171 ++ ) {
unsigned long V_176 = V_165 [ V_171 ] ;
unsigned long V_177 = V_176 + V_166 [ V_171 ] ;
if ( V_171 == V_113 )
continue;
F_16 ( V_176 >= V_17 && V_176 < V_3 ) ;
F_16 ( V_177 <= V_3 && V_177 > V_17 ) ;
}
}
V_175 = V_165 [ V_172 ] + V_166 [ V_172 ] ;
if ( V_164 - V_168 < V_175 ) {
F_4 ( true ) ;
return NULL ;
}
V_170 = F_141 ( sizeof( V_170 [ 0 ] ) * V_167 , V_106 ) ;
V_169 = F_141 ( sizeof( V_169 [ 0 ] ) * V_167 , V_106 ) ;
if ( ! V_169 || ! V_170 )
goto V_178;
for ( V_113 = 0 ; V_113 < V_167 ; V_113 ++ ) {
V_169 [ V_113 ] = F_141 ( sizeof( struct V_26 ) , V_106 ) ;
V_170 [ V_113 ] = F_141 ( sizeof( struct V_107 ) , V_106 ) ;
if ( ! V_169 [ V_113 ] || ! V_170 [ V_113 ] )
goto V_178;
}
V_50:
F_57 ( & V_51 ) ;
...
V_17 = V_165 [ V_113 ] ;
V_3 = V_17 + V_166 [ V_113 ] ;
if ( ! F_203 ( V_64 , & V_9 , & V_37 ) ) {
V_174 = V_164 - V_175 ;
goto V_58;
}
V_174 = F_204 ( & V_9 , & V_37 , V_41 ) - V_3 ;
while ( true ) {
F_16 ( V_9 && V_9 -> va_end <= V_174 + V_3 ) ;
F_16 ( V_37 && V_37 -> va_end > V_174 + V_3 ) ;
if ( V_174 + V_175 < V_168 + V_175 ) {
F_60 ( & V_51 ) ;
if ( ! V_46 ) {
F_61 () ;
V_46 = true ;
...
if ( V_9 && V_9 -> va_start < V_174 + V_3 ) {
V_174 = F_204 ( & V_9 , & V_37 , V_41 ) - V_3 ;
V_173 = V_113 ;
continue;
}
if ( V_37 && V_37 -> va_end > V_174 + V_17 ) {
V_9 = V_37 ;
V_37 = F_202 ( F_50 ( & V_9 -> V_27 ) ) ;
V_174 = F_204 ( & V_9 , & V_37 , V_41 ) - V_3 ;
V_173 = V_113 ;
continue;
}
V_113 = ( V_113 + V_167 - 1 ) % V_167 ;
if ( V_113 == V_173 )
break;
V_17 = V_165 [ V_113 ] ;
V_3 = V_17 + V_166 [ V_113 ] ;
F_203 ( V_174 + V_3 , & V_9 , & V_37 ) ;
}
V_58:
for ( V_113 = 0 ; V_113 < V_167 ; V_113 ++ ) {
struct V_26 * V_30 = V_169 [ V_113 ] ;
V_30 -> va_start = V_174 + V_165 [ V_113 ] ;
V_30 -> va_end = V_30 -> va_start + V_166 [ V_113 ] ;
F_46 ( V_30 ) ;
}
V_64 = V_174 + V_165 [ V_172 ] ;
F_60 ( & V_51 ) ;
for ( V_113 = 0 ; V_113 < V_167 ; V_113 ++ )
F_150 ( V_170 [ V_113 ] , V_169 [ V_113 ] , V_135 ,
F_206 ) ;
F_64 ( V_169 ) ;
return V_170 ;
V_178:
...
void F_208 ( struct V_107 * * V_170 , int V_167 )
{
int V_97 ;
for ( V_97 = 0 ; V_97 < V_167 ; V_97 ++ )
F_201 ( V_170 [ V_97 ] ) ;
F_64 ( V_170 ) ;
}
static void * F_209 ( struct V_179 * V_180 , T_11 * V_181 )
__acquires( &vmlist_lock
static void * F_210 ( struct V_179 * V_180 , void * V_33 , T_11 * V_181 )
{
struct V_107 * V_182 = V_33 ;
++ * V_181 ;
return V_182 -> V_9 ;
}
static void F_211 ( struct V_179 * V_180 , void * V_33 )
__releases( &vmlist_lock
static void F_212 ( struct V_179 * V_180 , struct V_107 * V_182 )
{
if ( V_183 ) {
unsigned int V_14 , * V_184 = V_180 -> V_115 ;
if ( ! V_184 )
return;
memset ( V_184 , 0 , V_185 * sizeof( unsigned int ) ) ;
for ( V_14 = 0 ; V_14 < V_182 -> V_123 ; V_14 ++ )
V_184 [ F_213 ( V_182 -> V_13 [ V_14 ] ) ] ++ ;
F_214 (nr, N_HIGH_MEMORY)
if ( V_184 [ V_14 ] )
F_215 ( V_180 , L_7 , V_14 , V_184 [ V_14 ] ) ;
}
}
static int F_216 ( struct V_179 * V_180 , void * V_33 )
{
struct V_107 * V_182 = V_33 ;
F_215 ( V_180 , L_8 ,
V_182 -> V_2 , V_182 -> V_2 + V_182 -> V_40 , V_182 -> V_40 ) ;
if ( V_182 -> V_114 )
F_215 ( V_180 , L_9 , V_182 -> V_114 ) ;
if ( V_182 -> V_123 )
F_215 ( V_180 , L_10 , V_182 -> V_123 ) ;
if ( V_182 -> V_186 )
F_215 ( V_180 , L_11 , ( unsigned long long ) V_182 -> V_186 ) ;
if ( V_182 -> V_59 & V_118 )
F_215 ( V_180 , L_12 ) ;
if ( V_182 -> V_59 & V_135 )
F_215 ( V_180 , L_13 ) ;
...
static int F_218 ( struct V_188 * V_188 , struct V_189 * V_189 )
{
unsigned int * V_190 = NULL ;
int V_19 ;
if ( V_183 ) {
V_190 = F_219 ( V_185 * sizeof( unsigned int ) , V_106 ) ;
if ( V_190 == NULL )
return - V_15 ;
}
V_19 = F_220 ( V_189 , & V_191 ) ;
if ( ! V_19 ) {
struct V_179 * V_180 = V_189 -> V_192 ;
V_180 -> V_115 = V_190 ;
} else
F_64 ( V_190 ) ;
return V_19 ;
