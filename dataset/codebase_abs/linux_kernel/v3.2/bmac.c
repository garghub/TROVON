...
V_31 -> V_111 [ V_45 ] = V_121 = F_50 ( V_130 + 2 ) ;
if ( V_121 != NULL )
F_51 ( V_121 , 2 ) ;
}
...
V_175 &= ~ V_178 ;
F_11 ( V_26 , V_83 , V_175 ) ;
for( V_45 = 0 ; V_45 < 4 ; V_45 ++ ) V_184 [ V_45 ] = 0 ;
F_75 (ha, dev) {
...
memset ( V_28 , 0 , V_150 ) ;
memcpy ( V_28 , V_26 -> V_79 , 6 ) ;
memcpy ( V_28 + 6 , V_26 -> V_79 , 6 ) ;
F_52 ( V_121 , V_26 ) ;
}
F_34 ( & V_31 -> V_101 , V_99 ) ;
}
static int T_7 F_85 ( struct V_97 * V_37 , const struct V_211 * V_212 )
{
...
struct V_25 * V_26 ;
int V_50 = ( ( int ) V_212 -> V_28 ) != 0 ;
if ( F_86 ( V_37 ) != 3 || F_87 ( V_37 ) != 3 ) {
F_26 ( V_217 L_19 ) ;
return - V_218 ;
}
V_216 = F_88 ( F_17 ( V_37 ) ,
L_20 , NULL ) ;
if ( V_216 == NULL ) {
V_216 = F_88 ( F_17 ( V_37 ) ,
L_21 , NULL ) ;
...
F_14 ( V_26 ) ;
F_11 ( V_26 , V_87 , V_109 ) ;
V_214 = V_18 [ 0 ] == 0 && V_18 [ 1 ] == 0xA0 ;
for ( V_213 = 0 ; V_213 < 6 ; ++ V_213 )
V_26 -> V_79 [ V_213 ] = V_214 ? F_84 ( V_18 [ V_213 ] ) : V_18 [ V_213 ] ;
F_14 ( V_26 ) ;
F_11 ( V_26 , V_87 , V_109 ) ;
V_26 -> V_224 = & V_225 ;
V_26 -> V_226 = & V_227 ;
...
V_31 -> V_230 = (struct V_231 * ) ( V_31 -> V_139 + V_110 + 1 ) ;
F_99 ( V_31 -> V_230 ) ;
F_100 ( & V_31 -> V_103 ) ;
V_215 = F_101 ( V_26 -> V_104 , F_77 , 0 , L_26 , V_26 ) ;
if ( V_215 ) {
F_26 ( V_217 L_27 , V_26 -> V_104 ) ;
goto V_232;
}
V_215 = F_101 ( V_31 -> V_105 , F_60 , 0 , L_28 , V_26 ) ;
if ( V_215 ) {
F_26 ( V_217 L_27 , V_31 -> V_105 ) ;
goto V_233;
}
V_215 = F_101 ( V_31 -> V_106 , F_54 , 0 , L_29 , V_26 ) ;
if ( V_215 ) {
F_26 ( V_217 L_27 , V_31 -> V_106 ) ;
goto V_234;
}
F_33 ( V_26 -> V_104 ) ;
F_16 ( V_36 , F_17 ( V_31 -> V_37 ) , 0 , 0 ) ;
...
F_26 ( V_236 L_31 ,
V_26 -> V_237 , ( V_50 ? L_32 : L_33 ) , V_26 -> V_79 ) ;
F_42 ( ( L_34 , V_26 -> V_29 ) ) ;
F_26 ( L_3 ) ;
return 0 ;
V_235:
...
static int T_8 F_113 ( struct V_97 * V_37 )
{
struct V_25 * V_26 = F_29 ( V_37 ) ;
struct V_30 * V_31 = F_15 ( V_26 ) ;
F_114 ( V_26 ) ;
