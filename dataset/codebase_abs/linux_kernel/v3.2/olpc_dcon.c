...
static T_5 F_51 ( struct V_73 * V_16 ,
struct V_74 * V_75 , const char * V_76 , T_6 V_77 )
{
unsigned long V_78 ;
int V_79 ;
...
static int F_52 ( struct V_82 * V_16 )
{
struct V_1 * V_2 = F_53 ( V_16 ) ;
...
static int F_54 ( struct V_82 * V_16 )
{
struct V_1 * V_2 = F_53 ( V_16 ) ;
return V_2 -> V_34 ;
}
...
static int F_57 ( struct V_86 * V_94 ,
...
static int F_58 ( struct V_102 * V_5 , struct V_103 * V_104 )
{
F_59 ( V_104 -> type , L_30 , V_105 ) ;
return 0 ;
}
static int F_60 ( struct V_102 * V_5 , const struct V_106 * V_107 )
{
struct V_1 * V_2 ;
int V_8 , V_108 , V_109 ;
if ( ! V_14 )
...
V_123 . V_84 = V_2 -> V_34 ;
V_2 -> V_124 = F_69 ( L_36 , & V_118 -> V_16 ,
V_2 , & V_125 , & V_123 ) ;
if ( F_70 ( V_2 -> V_124 ) ) {
F_7 ( & V_5 -> V_16 , L_37 ,
F_71 ( V_2 -> V_124 ) ) ;
...
static int F_79 ( struct V_102 * V_5 )
{
...
static int F_86 ( struct V_102 * V_5 , T_7 V_129 )
{
struct V_1 * V_2 = F_80 ( V_5 ) ;
if ( ! V_2 -> V_40 ) {
F_39 ( V_2 , V_66 ) ;
...
static int F_87 ( struct V_102 * V_5 )
{
struct V_1 * V_2 = F_80 ( V_5 ) ;
if ( ! V_2 -> V_40 ) {
F_8 ( V_2 , 0 ) ;
