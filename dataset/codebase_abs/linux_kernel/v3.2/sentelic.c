...
struct V_35 * V_68 = V_2 -> V_37 ;
unsigned char * V_62 = V_2 -> V_62 ;
unsigned char V_69 = 0 , V_70 = 0 , V_71 = 0 ;
int V_72 , V_73 ;
if ( V_2 -> V_74 < 4 )
return V_75 ;
switch ( V_2 -> V_62 [ 0 ] >> V_76 ) {
case V_77 :
F_40 ( & V_2 -> V_4 . V_16 -> V_17 ,
L_14 ) ;
break;
case V_78 :
if ( ( V_68 -> V_58 & V_59 ) != V_59 )
V_62 [ 0 ] &= ~ F_41 ( 0 ) ;
case V_79 :
if ( V_62 [ 3 ] != 0 ) {
if ( V_62 [ 3 ] & F_41 ( 0 ) )
...
F_42 ( V_17 , V_81 , V_70 - V_71 ) ;
F_43 ( V_17 , V_82 , V_70 ) ;
F_43 ( V_17 , V_83 , V_71 ) ;
F_43 ( V_17 , V_84 , V_62 [ 0 ] & 1 ) ;
F_43 ( V_17 , V_85 , ( V_62 [ 0 ] >> 2 ) & 1 ) ;
F_43 ( V_17 , V_86 , ( V_62 [ 0 ] >> 1 ) & 1 ) ;
V_72 = V_62 [ 1 ] ? ( int ) V_62 [ 1 ] - ( int ) ( ( V_62 [ 0 ] << 4 ) & 0x100 ) : 0 ;
V_73 = V_62 [ 2 ] ? ( int ) ( ( V_62 [ 0 ] << 3 ) & 0x100 ) - ( int ) V_62 [ 2 ] : 0 ;
F_42 ( V_17 , V_87 , V_72 ) ;
F_42 ( V_17 , V_88 , V_73 ) ;
break;
}
...
int F_46 ( struct V_2 * V_2 , bool V_94 )
{
int V_95 ;
if ( F_3 ( V_2 , V_96 , & V_95 ) )
return - V_25 ;
if ( V_95 != 0x01 )
return - V_97 ;
if ( V_94 ) {
...
F_53 ( V_2 ,
L_21 ,
V_103 >> 4 , V_103 & 0x0F , V_26 , V_61 , V_29 & 7 ) ;
V_2 -> V_37 = V_102 = F_54 ( sizeof( struct V_35 ) , V_104 ) ;
if ( ! V_102 )
return - V_105 ;
V_102 -> V_103 = V_103 ;
V_102 -> V_26 = V_26 ;
V_102 -> V_29 = V_29 ;
V_102 -> V_58 |= V_59 ;
F_55 ( V_85 , V_2 -> V_17 -> V_106 ) ;
F_55 ( V_82 , V_2 -> V_17 -> V_106 ) ;
F_55 ( V_83 , V_2 -> V_17 -> V_106 ) ;
F_55 ( V_80 , V_2 -> V_17 -> V_107 ) ;
F_55 ( V_81 , V_2 -> V_17 -> V_107 ) ;
V_2 -> V_108 = F_39 ;
V_2 -> V_109 = F_48 ;
V_2 -> V_110 = F_51 ;
V_2 -> V_111 = F_47 ;
...
if ( error )
goto V_113;
error = F_56 ( & V_2 -> V_4 . V_16 -> V_17 . V_100 ,
& V_101 ) ;
if ( error ) {
F_19 ( & V_2 -> V_4 . V_16 -> V_17 ,
L_22 , error ) ;
