...
static int F_24 ( struct V_1 * V_2 , T_3 V_107 )
{
F_22 ( V_2 , V_104 ) ;
F_13 ( V_2 , V_37 , 0 ) ;
return 0 ;
...
int V_22 ;
T_2 * V_108 = V_2 -> V_109 ;
for ( V_22 = 0 ; V_22 < F_3 ( V_110 ) ; V_22 ++ ) {
if ( V_22 == V_111 )
continue;
if ( V_108 [ V_22 ] != V_110 [ V_22 ] )
F_13 ( V_2 , V_22 , V_108 [ V_22 ] ) ;
}
F_22 ( V_2 , V_102 ) ;
if ( V_28 -> V_21 )
F_12 ( V_2 , V_37 , 0x20 , 0x20 ) ;
...
int V_45 = 0 , V_22 ;
V_28 -> V_52 = V_53 ;
V_45 = F_27 ( V_2 , 7 , 9 , V_112 ) ;
if ( V_45 < 0 ) {
F_28 ( V_2 -> V_16 , L_14 , V_45 ) ;
return V_45 ;
}
for ( V_22 = 0 ; V_22 < F_3 ( V_113 ) ; V_22 ++ )
F_12 ( V_2 , V_113 [ V_22 ] , 0x100 , 0x100 ) ;
V_45 = F_13 ( V_2 , V_111 , 0 ) ;
if ( V_45 < 0 ) {
F_28 ( V_2 -> V_16 , L_15 ) ;
return V_45 ;
}
...
static T_4 int F_31 ( struct V_115 * V_116 ,
const struct V_117 * V_118 )
{
struct V_27 * V_28 ;
int V_45 ;
V_28 = F_32 ( sizeof( struct V_27 ) , V_119 ) ;
if ( V_28 == NULL )
return - V_120 ;
F_33 ( V_116 , V_28 ) ;
V_45 = F_34 ( & V_116 -> V_16 ,
& V_121 , & V_122 , 1 ) ;
if ( V_45 < 0 )
F_35 ( V_28 ) ;
return V_45 ;
}
static T_5 int F_36 ( struct V_115 * V_123 )
{
F_37 ( & V_123 -> V_16 ) ;
F_35 ( F_38 ( V_123 ) ) ;
return 0 ;
