...
if ( F_13 ( V_3 , V_28 , V_29 ,
V_72 ) ) {
F_6 ( V_3 ) ;
V_26 -> V_73 . V_74 ++ ;
return V_43 ;
}
} else if ( F_14 ( V_3 ) < V_28 ) {
struct V_2 * V_75 = V_3 ;
V_3 = F_15 ( V_3 , V_28 ) ;
F_6 ( V_75 ) ;
if ( V_3 == NULL ) {
...
if ( V_35 )
memcpy ( F_16 ( V_3 , V_37 ) , V_35 , V_37 ) ;
memcpy ( F_16 ( V_3 , V_36 ) , & V_5 , V_36 ) ;
if ( V_34 == V_32 ) {
memcpy ( F_17 ( V_3 , V_54 ) , & V_5 . V_22 , V_54 ) ;
}
V_26 -> V_73 . V_76 ++ ;
...
static struct V_2 * F_22 ( struct V_2 * V_3 ,
struct V_84 * V_85 )
{
struct V_25 * V_26 ;
T_3 * V_27 ;
