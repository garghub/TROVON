...
if ( ! F_17 ( V_111 , & V_90 -> V_41 ) )
F_19 ( L_48
L_49
L_50 , V_90 -> V_36 ) ;
F_25 ( V_111 , & V_90 -> V_41 ) ;
V_115 ++ ;
...
static int F_60 ( struct V_6 * V_7 , struct V_133 * V_133 , union V_134 * V_135 )
{
struct V_5 * V_9 = V_7 -> V_128 ;
struct V_38 * V_38 = & V_9 -> V_18 ;
V_38 -> V_136 -> V_137 ( V_38 , V_133 ) ;
return V_138 ;
}
static int F_61 ( struct V_6 * V_7 , T_4 type ,
char * V_139 , unsigned V_140 )
{
struct V_5 * V_9 = V_7 -> V_128 ;
unsigned V_141 = 1 ;
unsigned V_142 = 0 ;
...
if ( F_17 ( V_146 , & V_9 -> V_18 . V_147 ) )
V_144 = V_9 -> V_18 . V_148 ;
else
V_144 = V_9 -> V_18 . V_26 ;
if ( V_144 >= V_9 -> V_18 . V_149 ) {
V_143 = 1 ;
V_144 = V_9 -> V_18 . V_149 ;
} else {
for ( V_3 = 0 ; V_3 < V_9 -> V_18 . V_19 ; V_3 ++ )
if ( ! F_17 ( V_40 , & V_9 -> V_15 [ V_3 ] . V_27 . V_41 ) )
V_143 = 1 ;
...
( unsigned long long ) V_9 -> V_18 . V_149 ) ;
break;
case V_150 :
for ( V_3 = 0 ; V_3 < V_9 -> V_18 . V_19 ; V_3 ++ ) {
if ( ( V_9 -> V_61 & V_64 ) &&
...
V_9 -> V_18 . V_53 . V_68 ) ;
if ( V_9 -> V_61 & V_72 ) {
struct V_151 * V_152 = V_9 -> V_18 . V_128 ;
F_62 ( L_84 ,
V_152 ? V_152 -> V_153 * 2 : 0 ) ;
}
if ( V_9 -> V_61 & V_78 )
F_62 ( L_85 ,
...
static int F_64 ( struct V_6 * V_7 , T_5 V_154 , void * V_155 )
{
struct V_5 * V_9 = V_7 -> V_128 ;
unsigned V_3 ;
int V_35 = 0 ;
...
static void F_65 ( struct V_6 * V_7 , struct V_156 * V_157 )
{
struct V_5 * V_9 = V_7 -> V_128 ;
unsigned V_158 = V_9 -> V_18 . V_52 << 9 ;
struct V_151 * V_152 = V_9 -> V_18 . V_128 ;
F_66 ( V_157 , V_158 ) ;
F_67 ( V_157 , V_158 * ( V_152 -> V_19 - V_152 -> V_159 ) ) ;
}
