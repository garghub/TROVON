...
V_12 = ( V_7 - V_6 -> V_7 + V_6 -> V_14 - 1 ) / V_6 -> V_14 ;
* V_10 = V_12 ;
V_12 <<= V_6 -> V_15 ;
V_13 = ( ( 1 << V_6 -> V_16 ) - 1 ) << V_6 -> V_15 ;
return F_7 ( V_11 , V_6 -> V_17 , V_12 , V_13 ) ;
}
...
T_1 V_21 ;
int V_18 ;
V_18 = F_9 ( V_11 , V_6 -> V_19 , & V_21 ) ;
if ( V_18 )
return V_18 ;
return ! ! ( V_21 & ( 1 << V_6 -> V_20 ) ) ;
}
static int F_15 ( struct V_2 * V_3 , unsigned V_10 )
{
struct V_5 * V_6 = F_5 ( V_3 ) ;
int V_18 ;
...
V_12 |= V_23 ;
V_13 |= V_24 ;
V_18 = F_7 ( V_22 , V_6 -> V_17 , V_12 , V_13 ) ;
if ( V_18 )
return V_18 ;
return F_7 ( V_22 , V_6 -> V_17 , V_12 , V_13 ) ;
}
...
if ( V_7 < V_25 ) {
V_12 = ( V_25 - V_7 + V_6 -> V_14 - 1 ) / V_6 -> V_14 ;
V_12 |= 0x4 ;
} else {
V_12 = ( V_7 - V_25 + V_6 -> V_14 - 1 ) / V_6 -> V_14 ;
}
* V_10 = V_12 ;
V_12 <<= V_6 -> V_15 ;
V_13 = ( ( 1 << V_6 -> V_16 ) - 1 ) << V_6 -> V_15 ;
...
V_12 <<= V_6 -> V_15 ;
V_13 = ( ( 1 << V_6 -> V_16 ) - 1 ) << V_6 -> V_15 ;
V_18 = F_7 ( V_11 , V_6 -> V_17 , V_12 , V_13 ) ;
if ( V_18 )
return V_18 ;
V_18 = F_11 ( V_11 , V_6 -> V_26 ,
1 << V_6 -> V_27 ) ;
return V_18 ;
}
...
static inline struct V_5 * F_24 ( int V_29 )
{
struct V_5 * V_30 ;
int V_31 ;
for ( V_31 = 0 ; V_31 < F_23 ( V_5 ) ; V_31 ++ ) {
V_30 = & V_5 [ V_31 ] ;
...
static int T_3 F_31 ( struct V_33 * V_34 )
{
struct V_2 * V_3 = F_32 ( V_34 ) ;
F_33 ( V_3 ) ;
return 0 ;
}
