...
static void F_83 ( struct V_236 * V_242 , int V_243 )
{
if ( V_243 )
F_82 ( V_242 , L_120 ) ;
}
static void F_84 ( struct V_236 * V_242 , const char * V_12 )
{
static const char * V_244 = L_121 ;
if ( strncmp ( V_244 , V_12 , strlen ( V_244 ) ) == 0 )
F_82 ( V_242 , L_122 ) ;
}
static int F_85 ( struct V_236 * V_242 , struct V_8 * V_9 )
{
struct V_18 * V_14 , * exp ;
int V_245 = 0 ;
for ( V_14 = V_9 -> V_137 ; V_14 ; V_14 = V_14 -> V_11 ) {
...
F_82 ( V_242 , L_128 , V_14 -> V_46 , V_14 -> V_12 ) ;
}
F_82 ( V_242 , L_119 ) ;
return V_245 ;
}
...
V_13 = V_14 -> V_8 -> V_12 ;
F_82 ( V_242 , L_132 , V_247 ? L_15 : L_133 , V_13 ) ;
V_247 = 0 ;
}
F_82 ( V_242 , L_134 ) ;
}
static void F_87 ( struct V_236 * V_242 , struct V_8 * V_9 )
{
if ( V_9 -> V_234 [ 0 ] ) {
F_82 ( V_242 , L_57 ) ;
F_82 ( V_242 , L_135 ,
...
static void F_88 ( struct V_236 * V_242 , const char * V_249 )
{
char * V_250 ;
T_11 * V_61 ;
struct V_50 V_51 ;
V_61 = fopen ( V_249 , L_136 ) ;
if ( ! V_61 )
goto V_251;
...
goto V_252;
V_250 = F_8 ( malloc ( V_242 -> V_60 ) ) ;
if ( fread ( V_250 , 1 , V_242 -> V_60 , V_61 ) != V_242 -> V_60 )
goto V_253;
if ( memcmp ( V_250 , V_242 -> V_13 , V_242 -> V_60 ) != 0 )
goto V_253;
free ( V_250 ) ;
fclose ( V_61 ) ;
return;
...
static void F_89 ( const char * V_249 , unsigned int V_45 )
{
unsigned long V_49 , V_60 = 0 ;
void * V_61 = F_22 ( V_249 , & V_49 ) ;
char * line ;
if ( ! V_61 )
return;
while ( ( line = F_27 ( & V_60 , V_61 , V_49 ) ) ) {
char * V_122 , * V_4 , * V_174 , * V_20 , * V_254 ;
unsigned int V_46 ;
struct V_8 * V_9 ;
struct V_18 * V_14 ;
...
* V_20 ++ = '\0' ;
if ( V_20 && ( ( V_254 = strchr ( V_20 , '\t' ) ) != NULL ) )
* V_254 = '\0' ;
...
static int F_90 ( struct V_18 * V_67 )
{
if ( ! V_256 )
return 1 ;
...
static void F_91 ( const char * V_249 )
{
struct V_236 V_237 = { } ;
struct V_18 * V_18 ;
int V_257 ;
for ( V_257 = 0 ; V_257 < V_23 ; V_257 ++ ) {
V_18 = V_24 [ V_257 ] ;
while ( V_18 ) {
if ( F_90 ( V_18 ) )
F_82 ( & V_237 , L_139 ,
...
int main ( int V_258 , char * * V_259 )
{
struct V_8 * V_9 ;
struct V_236 V_237 = { } ;
char * V_260 = NULL , * V_261 = NULL ;
char * V_262 = NULL ;
int V_263 ;
int V_245 ;
struct V_264 * V_265 ;
struct V_264 * V_266 = NULL ;
while ( ( V_263 = F_92 ( V_258 , V_259 , L_140 ) ) != - 1 ) {
switch ( V_263 ) {
case 'i' :
V_260 = V_267 ;
break;
...
F_83 ( & V_237 , ! V_256 ) ;
F_84 ( & V_237 , V_9 -> V_12 ) ;
V_245 |= F_85 ( & V_237 , V_9 ) ;
F_86 ( & V_237 , V_9 , V_10 ) ;
F_93 ( & V_237 , V_9 ) ;
F_87 ( & V_237 , V_9 ) ;
sprintf ( V_249 , L_141 , V_9 -> V_12 ) ;
F_88 ( & V_237 , V_249 ) ;
}
if ( V_262 )
F_91 ( V_262 ) ;
