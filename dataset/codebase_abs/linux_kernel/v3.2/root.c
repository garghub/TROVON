...
static int F_35 ( struct V_28 * V_29 , struct V_8 * V_8 , struct V_30 * V_31
)
{
F_36 ( V_8 -> V_22 , V_31 ) ;
V_31 -> V_32 = V_33 . V_32 + F_37 () ;
return 0 ;
}
static struct V_8 * F_38 ( struct V_34 * V_35 , struct V_8 * V_8 , struct V_36 * V_37 )
{
if ( ! F_39 ( V_35 , V_8 , V_37 ) ) {
return NULL ;
}
return F_40 ( V_35 , V_8 , V_37 ) ;
}
static int F_41 ( struct V_38 * V_39 ,
void * V_40 , T_2 V_41 )
{
unsigned int V_42 = V_39 -> V_43 ;
int V_44 ;
if ( V_42 < V_45 ) {
int error = F_42 ( V_39 , V_40 , V_41 ) ;
if ( error <= 0 )
return error ;
V_39 -> V_43 = V_45 ;
}
V_44 = F_43 ( V_39 , V_40 , V_41 ) ;
return V_44 ;
}
