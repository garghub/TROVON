...
{
struct V_1 * V_2 ;
if ( F_42 ( NULL , V_68 , NULL ) )
F_43 (KERN_ERR __FILE__ L_33
L_34 ) ;
...
static unsigned int T_1 F_45 ( struct V_1 * V_2 ,
char * V_69 )
{
const unsigned int * V_70 ;
V_70 = F_13 ( V_2 , V_69 , NULL ) ;
if ( V_70 )
return * V_70 ;
F_46 ( L_36 ,
V_69 , V_2 -> V_71 , V_72 ) ;
...
if ( ( V_76 + V_74 + V_75 ) > 0x1000 ) {
F_7 ( L_41 ,
V_54 , V_2 -> V_71 ) ;
F_16 ( V_73 ) ;
continue;
}
F_6 ( & F_49 ( V_73 ) -> V_77 , ( V_76 << 16 ) | V_74 ) ;
V_76 += V_74 ;
F_6 ( & F_49 ( V_73 ) -> V_78 , ( V_76 << 16 ) | V_75 ) ;
V_76 += V_75 ;
F_6 ( & F_49 ( V_73 ) -> V_79 , 0x80 ) ;
F_6 ( & F_49 ( V_73 ) -> V_79 , 0x01 ) ;
F_6 ( & F_49 ( V_73 ) -> V_80 , 0x80 ) ;
F_6 ( & F_49 ( V_73 ) -> V_80 , 0x01 ) ;
F_16 ( V_73 ) ;
}
}
void T_1 F_50 ( void )
