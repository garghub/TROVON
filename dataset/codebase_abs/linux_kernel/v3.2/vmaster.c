...
V_2 -> V_10 = F_12 ;
V_2 -> V_33 = F_13 ;
if ( V_2 -> V_45 [ 0 ] . V_47 & V_48 )
V_2 -> V_39 . V_40 = F_14 ;
V_2 -> V_49 = V_44 ;
V_2 -> V_41 = F_15 ;
F_19 ( & V_44 -> V_42 , & V_43 -> V_50 ) ;
return 0 ;
}
...
return V_5 ;
V_53 = V_28 -> V_29 ;
if ( V_31 -> V_14 . integer . V_14 [ 0 ] == V_53 )
return 0 ;
...
struct V_27 * V_28 = F_11 ( V_35 ) ;
struct V_1 * V_2 , * V_54 ;
F_24 (slave, n, &master->slaves, list) {
struct V_34 * V_55 = V_2 -> V_46 ;
struct V_56 V_57 = V_55 -> V_42 ;
memcpy ( V_55 , & V_2 -> V_2 , sizeof( * V_55 ) ) ;
memcpy ( V_55 -> V_45 , V_2 -> V_2 . V_45 ,
V_55 -> V_12 * sizeof( * V_55 -> V_45 ) ) ;
V_55 -> V_42 = V_57 ;
F_3 ( V_2 ) ;
}
F_3 ( V_28 ) ;
}
struct V_34 * F_25 ( char * V_58 ,
...
V_39 [ 0 ] == V_64 ||
V_39 [ 0 ] == V_65 ) ) {
V_46 -> V_45 [ 0 ] . V_47 |= V_66 ;
memcpy ( V_28 -> V_39 , V_39 , sizeof( V_28 -> V_39 ) ) ;
V_46 -> V_39 . V_67 = V_28 -> V_39 ;
}
return V_46 ;
}
