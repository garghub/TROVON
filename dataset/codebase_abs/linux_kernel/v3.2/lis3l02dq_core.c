...
static T_7 F_21 ( struct V_58 * V_28 ,
struct V_59 * V_60 ,
char * V_61 )
{
...
static T_7 F_23 ( struct V_58 * V_28 ,
struct V_59 * V_60 ,
const char * V_61 ,
T_8 V_20 )
{
...
static int T_10 F_36 ( struct V_101 * V_102 )
{
int V_12 ;
struct V_8 * V_9 ;
struct V_4 * V_5 ;
...
if ( V_102 -> V_1 && F_44 ( F_45 ( V_102 -> V_1 ) ) > 0 ) {
V_12 = F_46 ( V_9 -> V_22 -> V_1 ,
& V_117 ,
& F_27 ,
V_118 ,
L_11 ,
...
static T_11 int F_58 ( void )
{
return F_59 ( & V_122 ) ;
}
static T_12 void F_60 ( void )
{
F_61 ( & V_122 ) ;
}
