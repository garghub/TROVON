...
F_59 ( & V_2 -> V_143 ) ;
if ( V_2 -> V_3 >= V_4 )
F_82 ( & V_2 -> V_144 . V_145 ) ;
F_59 ( & V_2 -> V_146 . V_105 ) ;
F_59 ( & V_2 -> V_67 . V_105 ) ;
F_59 ( & V_2 -> V_147 ) ;
F_83 ( & V_2 -> V_148 . V_145 ) ;
F_84 ( & V_2 -> V_146 . V_149 ) ;
F_85 ( & V_2 -> V_150 . V_151 ) ;
F_85 ( & V_2 -> V_150 . V_152 ) ;
V_17 = F_86 ( V_2 ) ;
if ( V_17 )
return V_17 ;
F_69 ( V_2 ) ;
...
V_2 -> V_157 = F_90 ( V_2 -> V_46 , 2 ) ;
V_2 -> V_158 = F_91 ( V_2 -> V_46 , 2 ) ;
V_2 -> V_159 = F_92 ( V_2 -> V_157 , V_2 -> V_158 ) ;
if ( V_2 -> V_159 == NULL ) {
return - V_84 ;
}
...
if ( F_93 ( V_2 -> V_46 , V_5 ) & V_161 ) {
V_2 -> V_162 = F_91 ( V_2 -> V_46 , V_5 ) ;
V_2 -> V_98 = F_94 ( V_2 -> V_46 , V_5 , V_2 -> V_162 ) ;
break;
}
}
if ( V_2 -> V_98 == NULL )
F_57 ( L_26 ) ;
F_95 ( V_2 -> V_46 , V_2 , NULL , F_67 ) ;
F_96 ( V_2 -> V_46 ,
F_70 ,
NULL ,
F_77 ) ;
...
F_99 ( V_2 ) ;
F_104 ( V_2 -> V_46 ) ;
F_95 ( V_2 -> V_46 , NULL , NULL , NULL ) ;
if ( V_2 -> V_98 )
F_105 ( V_2 -> V_46 , V_2 -> V_98 ) ;
V_2 -> V_98 = NULL ;
F_106 ( V_2 -> V_159 ) ;
V_2 -> V_159 = NULL ;
}
...
if ( V_24 -> V_122 == V_125 )
return 0 ;
F_107 (connector, &dev->mode_config.connector_list, head) {
F_108 ( V_168 , V_171 ) ;
}
F_107 (crtc, &dev->mode_config.crtc_list, head) {
struct V_172 * V_173 = F_109 ( V_166 -> V_174 ) ;
struct V_175 * V_176 ;
if ( V_173 == NULL || V_173 -> V_177 == NULL ) {
continue;
}
V_176 = F_110 ( V_173 -> V_177 ) ;
if ( ! F_111 ( V_2 , V_176 ) ) {
...
int F_142 ( struct V_195 * V_196 )
{
return 0 ;
}
void F_143 ( struct V_195 * V_196 )
{
unsigned V_5 ;
for ( V_5 = 0 ; V_5 < V_187 ; V_5 ++ ) {
F_144 ( V_188 [ V_5 ] . V_185 ,
