...
! ( V_29 -> V_37 && V_29 -> V_38 ) &&
! ( V_29 -> V_39 && V_29 -> V_40 && V_29 -> V_36 ) ) {
F_3 ( V_12 L_4 ) ;
return ( - V_41 ) ;
}
if ( ! V_29 -> V_39 && ! V_29 -> V_35 && V_29 -> V_42 ) {
F_3 ( V_12 L_5
L_6 ) ;
V_29 -> V_42 = NULL ;
}
...
memcpy ( V_8 -> V_13 , V_29 , sizeof( struct V_10 ) ) ;
V_8 -> V_18 = 1 ;
V_8 -> V_50 = F_17 ( & V_51 , V_8 , L_7 , V_8 -> V_26 ) ;
if ( F_18 ( V_8 -> V_50 ) ) {
V_31 = F_19 ( V_8 -> V_50 ) ;
F_20 ( & V_8 -> V_8 ,
L_8 ,
