...
static T_2 F_38 ( struct V_73 * V_74 )
{
return V_80 | V_81 | V_82 ;
}
static int F_39 ( unsigned long V_83 , unsigned int V_84 ,
...
static int F_40 ( struct V_1 * V_2 , unsigned int * V_89 )
{
struct V_90 * V_91 = V_2 -> V_91 ;
unsigned long V_83 = F_41 ( V_2 -> V_77 ) ;
...
{
struct V_1 * V_2 = F_44 ( V_102 ) ;
unsigned long V_26 ;
unsigned int V_89 ;
int V_105 ;
int V_10 ;
V_105 = F_41 ( V_2 -> V_77 ) - V_2 -> V_94 ;
...
F_47 ( V_2 -> V_5 , L_26 , V_89 ) ;
}
return 0 ;
}
static inline int F_48 ( struct V_1 * V_2 )
{
V_2 -> V_108 . V_109 = F_43 ;
...
V_112 = F_53 ( V_2 -> V_5 -> V_7 , V_111 ) ;
if ( ! F_54 ( V_112 ) ) {
F_23 ( V_2 -> V_5 , L_27 , V_111 , V_112 ) ;
goto V_113;
}
V_10 = F_55 ( V_112 , L_28 ) ;
if ( V_10 ) {
...
F_47 ( V_2 -> V_5 , L_32 , V_93 ) ;
F_7 ( V_2 -> V_5 , L_33 , V_115 ) ;
return 0 ;
}
static void
F_59 ( struct V_119 * V_120 , struct V_1 * V_2 )
{
struct V_90 * V_91 = V_2 -> V_91 ;
if ( ! V_120 )
return;
V_91 -> V_121 = - 1 ;
F_60 ( V_120 , L_34 , & V_91 -> V_98 ) ;
F_60 ( V_120 , L_35 , & V_91 -> V_117 ) ;
F_60 ( V_120 , L_36 ,
( T_2 * ) & V_91 -> V_95 ) ;
}
static void
...
V_2 = F_62 ( sizeof( struct V_1 ) , V_125 ) ;
if ( ! V_2 ) {
F_23 ( & V_4 -> V_5 , L_38 ) ;
return - V_126 ;
}
V_2 -> V_91 = F_63 ( & V_4 -> V_5 , sizeof( * V_91 ) , V_125 ) ;
if ( ! V_2 -> V_91 ) {
V_10 = - V_126 ;
goto V_127;
}
...
F_59 ( V_4 -> V_5 . V_7 , V_2 ) ;
F_64 ( V_2 -> V_74 . V_128 , L_39 , sizeof( V_2 -> V_74 . V_128 ) ) ;
...
F_35 ( V_2 -> V_77 ) ;
V_123 = F_69 ( V_4 , V_137 , 0 ) ;
if ( V_123 == NULL ) {
F_23 ( & V_4 -> V_5 , L_43 ) ;
V_10 = - V_136 ;
goto V_138;
}
V_2 -> V_139 = F_70 ( V_123 -> V_140 , F_71 ( V_123 ) ,
V_4 -> V_128 ) ;
if ( V_2 -> V_139 == NULL ) {
F_23 ( & V_4 -> V_5 , L_44 ) ;
V_10 = - V_47 ;
...
V_2 -> V_17 = F_72 ( V_123 -> V_140 , F_71 ( V_123 ) ) ;
if ( V_2 -> V_17 == NULL ) {
F_23 ( & V_4 -> V_5 , L_45 ) ;
V_10 = - V_47 ;
goto V_141;
...
if ( V_10 != 0 )
goto V_143;
V_2 -> V_144 = V_10 = F_73 ( V_4 , 0 ) ;
if ( V_10 <= 0 ) {
F_23 ( & V_4 -> V_5 , L_47 ) ;
goto V_143;
}
V_10 = F_74 ( V_2 -> V_144 , F_25 , 0 ,
F_75 ( & V_4 -> V_5 ) , V_2 ) ;
if ( V_10 != 0 ) {
...
F_77 ( & V_2 -> V_74 ) ;
F_78 ( V_4 , V_2 ) ;
F_47 ( & V_4 -> V_5 , L_51 , F_75 ( & V_2 -> V_74 . V_5 ) ) ;
F_36 ( V_2 -> V_77 ) ;
return 0 ;
V_147:
F_50 ( V_2 ) ;
...
static int F_87 ( struct V_148 * V_5 )
{
...
static int F_88 ( struct V_148 * V_5 )
{
struct V_3 * V_4 = F_2 ( V_5 ) ;
struct V_1 * V_2 = F_85 ( V_4 ) ;
V_2 -> V_68 = 0 ;
