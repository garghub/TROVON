...
static T_12 F_100 ( struct V_198 * V_199 ,
unsigned long V_200 )
{
static T_12 V_201 = ~ 0 ;
T_12 V_202 =
( V_200 * sizeof( void * ) + V_203 - 1 ) & V_204 ;
if ( F_15 ( V_201 == ~ 0 ) ) {
V_201 = V_199 -> V_205 +
...
F_38 ( V_199 -> V_206 , V_3 -> V_207 ) ;
F_10 ( V_6 ) ;
}
int F_102 ( struct V_11 * V_12 ,
struct V_1 * V_6 ,
T_12 V_35 , struct V_208 * V_209 ,
bool V_210 ,
void (* F_103) ( struct V_2 * V_3 ) )
{
struct V_211 * V_159 = & V_12 -> V_159 ;
struct V_212 * V_206 = V_159 -> V_199 -> V_206 ;
T_12 V_207 ;
int V_21 ;
F_14 ( ! F_103 ) ;
V_207 =
F_100 ( V_159 -> V_199 ,
( V_35 + V_203 - 1 ) >> V_213 ) ;
V_21 = F_48 ( V_206 , V_207 , false , false ) ;
if ( F_15 ( V_21 != 0 ) ) {
F_103 ( & V_6 -> V_4 ) ;
return V_21 ;
}
...
union V_216 * V_53 =
(union V_216 * ) V_49 ;
struct V_217 * V_177 = & V_53 -> V_177 ;
struct V_218 * V_178 = & V_53 -> V_178 ;
struct V_5 * V_215 ;
struct V_2 * V_63 ;
struct V_64 * V_65 = V_64 ( V_51 -> V_66 ) ;
int V_21 ;
V_215 = F_95 ( sizeof( * V_215 ) , V_22 ) ;
if ( F_15 ( V_215 == NULL ) )
return - V_23 ;
V_21 = F_47 ( & V_65 -> V_67 , true ) ;
if ( F_15 ( V_21 != 0 ) ) {
...
V_21 = F_102 ( V_12 , & V_215 -> V_7 , V_177 -> V_35 ,
& V_219 , true ,
& F_105 ) ;
if ( F_15 ( V_21 != 0 ) )
goto V_220;
V_63 = F_64 ( & V_215 -> V_7 . V_4 ) ;
...
V_178 -> V_169 = V_215 -> V_4 . V_60 . V_61 ;
V_178 -> V_223 = V_215 -> V_7 . V_4 . V_224 ;
V_178 -> V_225 = V_215 -> V_4 . V_60 . V_61 ;
V_178 -> V_226 = 0 ;
}
V_222:
F_62 ( & V_63 ) ;
...
int V_21 ;
F_113 ( L_19 , V_234 ) ;
V_233 = F_1 ( V_9 , struct V_232 , V_9 ) ;
V_21 = F_114 ( V_12 , V_233 -> V_235 ) ;
F_115 ( V_21 != 0 ) ;
}
...
void (* V_19) ( struct V_8 * V_9 ) )
{
struct V_8 * V_9 = & V_233 -> V_9 ;
int V_21 ;
V_21 = F_18 ( V_12 , V_9 , & V_12 -> V_236 ,
V_237 , false , V_19 , NULL ) ;
if ( F_15 ( V_21 != 0 ) ) {
if ( V_19 == NULL )
F_10 ( V_233 ) ;
else
...
V_21 = F_117 ( V_12 , & V_233 -> V_235 ) ;
if ( V_21 ) {
F_11 ( & V_9 ) ;
return V_21 ;
}
F_113 ( L_20 , V_234 ) ;
F_21 ( & V_233 -> V_9 , F_112 ) ;
return 0 ;
}
static void F_118 ( struct V_8 * V_9 )
{
struct V_238 * V_233 =
F_1 ( V_9 , struct V_238 , V_233 . V_9 ) ;
struct V_11 * V_12 = V_9 -> V_12 ;
F_10 ( V_233 ) ;
F_38 ( F_39 ( V_12 ) ,
V_239 ) ;
...
struct V_45 * V_4 = * V_46 ;
struct V_238 * V_233 =
F_1 ( V_4 , struct V_238 , V_4 ) ;
struct V_8 * V_9 = & V_233 -> V_233 . V_9 ;
* V_46 = NULL ;
F_11 ( & V_9 ) ;
}
...
struct V_8 * V_9 ;
struct V_238 * V_233 ;
struct V_240 * V_53 = (struct V_240 * ) V_49 ;
struct V_54 * V_55 = F_43 ( V_51 ) -> V_55 ;
int V_21 = 0 ;
V_9 = F_22 ( V_12 , & V_12 -> V_236 , V_53 -> V_235 ) ;
if ( F_15 ( V_9 == NULL ) )
return - V_56 ;
if ( V_9 -> V_19 != & F_118 ) {
V_21 = - V_56 ;
...
V_233 = F_1 ( V_9 , struct V_238 , V_233 . V_9 ) ;
if ( V_233 -> V_4 . V_55 != V_55 ) {
V_21 = - V_56 ;
goto V_57;
}
F_44 ( V_55 , V_233 -> V_4 . V_60 . V_61 , V_62 ) ;
V_57:
F_11 ( & V_9 ) ;
return V_21 ;
}
...
V_9 = & V_233 -> V_233 . V_9 ;
V_233 -> V_4 . V_58 = false ;
V_233 -> V_4 . V_55 = NULL ;
V_21 = F_116 ( V_12 , & V_233 -> V_233 , F_118 ) ;
if ( F_15 ( V_21 != 0 ) )
goto V_69;
V_63 = F_2 ( V_9 ) ;
V_21 = F_49 ( V_55 , & V_233 -> V_4 , false , V_237 ,
& F_119 , NULL ) ;
if ( F_15 ( V_21 != 0 ) ) {
F_11 ( & V_63 ) ;
goto V_70;
...
struct V_54 * V_55 ,
T_4 * V_241 , struct V_8 * * V_57 )
{
struct V_238 * V_233 ;
struct V_8 * V_9 ;
int V_21 ;
V_9 = F_22 ( V_12 , & V_12 -> V_236 , * V_241 ) ;
if ( F_15 ( V_9 == NULL ) )
return - V_56 ;
if ( V_9 -> V_19 != & F_118 ) {
V_21 = - V_56 ;
