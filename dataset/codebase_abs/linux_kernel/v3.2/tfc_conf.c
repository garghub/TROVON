...
return NULL ;
if ( F_29 ( V_1 + 5 , 10 , & V_49 ) || V_49 > V_50 )
return NULL ;
V_48 = F_9 ( V_2 , struct V_47 , V_51 ) ;
...
V_32 -> V_52 = V_48 ;
F_30 ( & V_32 -> V_53 ) ;
V_17 = F_31 ( & V_54 -> V_55 , V_2 , & V_32 -> V_28 ,
V_32 , V_56 ) ;
if ( V_17 < 0 ) {
F_20 ( V_32 ) ;
return NULL ;
}
V_32 -> V_57 = F_32 ( L_12 , 0 , 1 ) ;
if ( ! V_32 -> V_57 ) {
F_20 ( V_32 ) ;
return NULL ;
}
F_33 ( & V_58 ) ;
F_34 ( & V_32 -> V_59 , & V_48 -> V_60 ) ;
F_35 ( & V_58 ) ;
return & V_32 -> V_28 ;
}
...
struct V_31 * F_41 ( struct V_63 * V_64 )
{
struct V_47 * V_48 ;
struct V_31 * V_32 ;
...
char * V_20 )
{
return sprintf ( V_20 , L_16 V_69 L_17
L_18 V_70 L_19 , F_45 () -> V_71 , F_45 () -> V_72 ) ;
}
...
static T_6 F_53 ( struct V_74 * V_74 , T_3 V_75 )
{
return 0 ;
}
...
V_76 -> V_55 = V_79 ;
V_76 -> V_55 . V_80 = 1 ;
F_59 ( V_76 ) -> V_81 . V_82 = V_83 ;
F_59 ( V_76 ) -> V_84 . V_82 = NULL ;
F_59 ( V_76 ) -> V_85 . V_82 = NULL ;
F_59 ( V_76 ) -> V_86 . V_82 = NULL ;
F_59 ( V_76 ) -> V_87 . V_82 = NULL ;
F_59 ( V_76 ) -> V_88 . V_82 =
V_89 ;
F_59 ( V_76 ) -> V_90 . V_82 = NULL ;
F_59 ( V_76 ) -> V_91 . V_82 = NULL ;
F_59 ( V_76 ) -> V_92 . V_82 = NULL ;
V_17 = F_60 ( V_76 ) ;
if ( V_17 < 0 ) {
F_3 ( L_22
L_23 ) ;
