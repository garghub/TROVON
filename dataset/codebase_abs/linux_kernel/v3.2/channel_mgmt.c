...
F_11 ( & V_25 -> V_21 , F_13 ) ;
F_16 ( & V_22 . V_29 , V_28 ) ;
F_17 (channel, &vmbus_connection.chn_list, listentry) {
if ( ! F_18 ( V_16 -> V_30 . V_31 . V_32 ,
V_25 -> V_30 . V_31 . V_32 ) &&
! F_18 ( V_16 -> V_30 . V_31 . V_33 ,
V_25 -> V_30 . V_31 . V_33 ) ) {
V_26 = false ;
break;
}
...
F_16 ( & V_22 . V_60 , V_28 ) ;
F_17 (msginfo, &vmbus_connection.chn_msg_list,
msglistentry) {
V_57 =
