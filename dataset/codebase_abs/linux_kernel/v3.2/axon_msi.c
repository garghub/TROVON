...
static int F_36 ( struct V_29 * V_55 , unsigned int V_51 ,
T_3 V_56 )
{
F_37 ( V_51 , V_55 -> V_34 ) ;
F_38 ( V_51 , & V_57 , V_58 ) ;
...
int V_65 , V_66 ;
F_3 ( L_20 , V_2 -> V_33 ) ;
V_4 = F_42 ( sizeof( struct V_3 ) , V_67 ) ;
if ( ! V_4 ) {
F_14 ( V_68 L_21 ,
V_2 -> V_33 ) ;
goto V_69;
...
V_4 -> V_7 = F_45 ( V_2 , V_65 , V_66 ) ;
if ( ! F_46 ( V_4 -> V_7 ) ) {
F_14 ( V_68 L_23 ,
V_2 -> V_33 ) ;
goto V_70;
}
V_4 -> V_21 = F_47 ( & V_60 -> V_28 , V_71 ,
& V_4 -> V_72 , V_67 ) ;
if ( ! V_4 -> V_21 ) {
F_14 ( V_68 L_24 ,
V_2 -> V_33 ) ;
...
V_79 . V_82 = F_24 ;
F_1 ( V_2 , V_4 ) ;
F_14 ( V_83 L_28 , V_2 -> V_33 ) ;
return 0 ;
V_73:
F_53 ( & V_60 -> V_28 , V_71 , V_4 -> V_21 ,
V_4 -> V_72 ) ;
V_70:
F_54 ( V_4 ) ;
V_69:
...
static int F_59 ( void * V_54 , T_5 * V_6 )
{
* V_6 = 0 ;
return 0 ;
}
...
char V_86 [ 8 ] ;
T_5 V_87 ;
V_87 = F_60 ( V_2 , F_20 ( V_2 , L_29 , NULL ) ) ;
if ( V_87 == V_88 ) {
F_3 ( L_30 ) ;
return;
}
V_4 -> V_85 = F_61 ( V_87 , 0x4 ) ;
if ( ! V_4 -> V_85 ) {
F_3 ( L_31 ) ;
return;
}
snprintf ( V_86 , sizeof( V_86 ) , L_32 , F_62 ( V_2 ) ) ;
if ( ! F_63 ( V_86 , 0600 , V_89 ,
V_4 , & V_90 ) ) {
F_3 ( L_33 ) ;
return;
}
