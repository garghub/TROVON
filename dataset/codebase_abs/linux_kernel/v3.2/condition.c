...
if ( ! V_101 -> V_125 [ V_186 ] )
goto V_33;
V_111 = & V_101 -> V_111 [ V_186 ] ;
switch ( V_1 ) {
case V_187 :
case V_196 :
case V_205 :
...
case V_190 :
case V_199 :
V_11 = F_54 ( V_111 -> V_120 ) ;
break;
case V_191 :
case V_200 :
V_11 = F_55 ( V_111 -> V_120 ) ;
break;
case V_192 :
case V_201 :
V_11 = V_111 -> V_118 & V_215 ;
break;
case V_193 :
case V_202 :
V_11 = F_54 ( V_111 -> V_123 ) ;
break;
case V_194 :
case V_203 :
V_11 = F_55 ( V_111 -> V_123 ) ;
break;
case V_195 :
case V_204 :
case V_208 :
...
V_129 [ 0 ] = V_41 -> V_217 [ 0 ] ;
V_130 [ 0 ] = V_41 -> V_217 [ 1 ] ;
}
if ( V_50 == V_93 ) {
const struct V_79 * V_41 = V_80 ++ ;
if ( V_41 -> V_218 ) {
...
if ( ( V_129 [ 0 ] <= V_41 -> V_217 [ 1 ] &&
V_130 [ 0 ] >= V_41 -> V_217 [ 0 ] ) == V_42 )
continue;
}
goto V_33;
}
