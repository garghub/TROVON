...
static T_3
F_67 ( struct V_110 * V_111 , const char T_4 * V_112 , T_1 V_113 )
{
struct V_114 * V_115 = F_68 ( V_111 -> V_116 . V_67 -> V_103 ) ;
struct V_62 * V_62 = (struct V_62 * ) V_115 -> V_117 ;
struct V_92 V_118 , * V_93 = & V_62 -> V_97 ;
struct V_78 * V_79 ;
struct V_77 * V_83 = NULL ;
T_1 V_119 ;
int V_11 ;
if ( V_113 != sizeof( V_118 ) )
return - V_120 ;
if ( F_69 ( & V_118 , V_112 , V_113 ) != 0 )
return - V_121 ;
F_57 ( & V_62 -> V_70 ) ;
V_11 = V_113 ;
V_93 -> V_106 = V_118 . V_106 ;
if ( ! ( V_118 . V_106 & V_107 ) ) {
F_70 ( & V_62 -> V_71 ) ;
goto V_38;
}
V_11 = - V_42 ;
V_119 = F_66 ( V_118 . V_99 , V_98 ) ;
if ( V_119 == 0 || V_119 == V_98 )
goto V_38;
switch ( V_118 . V_100 ) {
case V_74 :
V_79 = & V_62 -> V_72 ;
...
case V_109 :
if ( V_93 -> V_101 == V_109
&& V_93 -> V_100 == V_118 . V_100
&& V_93 -> V_108 == V_118 . V_108 ) {
memcpy ( V_93 -> V_99 , V_118 . V_99 , V_119 ) ;
V_93 -> V_99 [ V_119 ] = '\0' ;
F_70 ( & V_62 -> V_71 ) ;
}
V_83 = F_53 ( V_79 , V_118 . V_108 ) ;
break;
case V_102 :
if ( V_93 -> V_101 == V_102
&& V_93 -> V_100 == V_118 . V_100
&& F_66 ( V_93 -> V_99 , V_98 ) == V_119
&& memcmp ( V_93 -> V_99 , V_118 . V_99 , V_119 ) == 0 ) {
V_93 -> V_108 = V_118 . V_108 ;
F_70 ( & V_62 -> V_71 ) ;
}
V_83 = F_52 ( V_79 , V_118 . V_99 , V_119 ) ;
break;
default:
goto V_38;
}
if ( V_83 != NULL )
F_54 ( V_83 , V_118 . V_99 , V_119 , V_118 . V_108 ) ;
V_11 = V_113 ;
V_38:
F_62 ( & V_62 -> V_70 ) ;
return V_11 ;
...
struct V_62 * V_62 = F_72 ( V_93 , struct V_62 , V_97 ) ;
if ( V_91 -> V_122 >= 0 )
return;
F_57 ( & V_62 -> V_70 ) ;
V_93 -> V_106 = V_123 ;
...
{
const unsigned char * V_124 , * V_125 = ( const unsigned char * ) V_5 + V_7 ;
unsigned int V_126 = V_127 ;
for ( V_124 = V_5 ; V_124 < V_125 ; V_124 ++ ) {
V_126 *= V_128 ;
V_126 ^= ( unsigned int ) * V_124 ;
}
return V_126 ;
}
int F_32 ( const struct V_47 * V_48 , const char * V_1 , T_1 V_2 , T_2 * V_49 )
