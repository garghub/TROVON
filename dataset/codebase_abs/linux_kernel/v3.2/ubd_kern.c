...
V_70 = F_37 ( V_27 -> V_12 , V_30 , 0 ) ;
if ( V_70 < 0 )
return V_70 ;
V_32 = F_38 ( V_77 , & V_70 , & V_71 , & V_31 , \
...
V_12 = V_31 ;
V_44:
return F_40 ( V_12 , V_69 ) ;
}
static int F_41 ( int V_70 , void * V_78 , int V_79 , int V_80 )
{
int V_32 ;
V_32 = F_42 ( V_70 , V_79 ) ;
if ( V_32 < 0 )
...
static int F_43 ( char * V_12 , T_1 V_74 , T_4 V_73 )
{
unsigned long V_81 ;
...
static int F_45 ( char * V_83 , char * V_84 , char * V_50 )
{
...
static int F_47 ( char * V_12 , struct V_28 * V_28 , int V_48 ,
char * * V_90 , int * V_91 ,
...
if ( V_90 == NULL )
return V_70 ;
V_32 = F_38 ( V_77 , & V_70 , & V_71 , & V_31 , & V_73 ,
& V_74 , & V_95 , & V_72 , V_91 ) ;
if ( V_32 && ( * V_90 != NULL ) ) {
F_18 ( V_52 L_37
L_38 , V_12 , - V_32 ) ;
...
V_96 = F_45 ( * V_90 , V_31 ,
V_12 ) ;
if ( V_96 && ! F_43 ( * V_90 , V_74 ,
V_73 ) ) {
F_18 ( V_52 L_39 ,
* V_90 ) ;
V_32 = F_49 ( V_12 , V_70 , * V_90 ,
V_95 , V_72 , & V_74 ) ;
if ( V_32 ) {
F_18 ( V_52 L_40 , - V_32 ) ;
goto V_101;
...
* V_90 = V_31 ;
V_32 = F_43 ( * V_90 , V_74 , V_73 ) ;
if ( V_32 )
goto V_101;
}
F_50 ( V_71 , V_74 , V_95 , V_72 , * V_91 ,
V_92 , V_93 ) ;
return V_70 ;
V_101:
F_39 ( V_70 ) ;
...
static int F_51 ( char * V_102 , char * V_31 ,
struct V_28 V_29 ,
...
int V_32 , V_70 ;
V_29 . V_104 = 1 ;
V_70 = F_47 ( V_102 , & V_29 , 0 , NULL , NULL , NULL , NULL , NULL ) ;
if ( V_70 < 0 ) {
V_32 = V_70 ;
F_18 ( V_52 L_41 ,
V_102 , - V_32 ) ;
...
V_32 = F_52 ( V_70 , V_102 , V_31 , V_95 , V_103 ,
V_91 , V_92 ,
V_93 ) ;
if ( ! V_32 )
return V_70 ;
...
V_70 = F_47 ( V_27 -> V_12 , & V_27 -> V_28 , V_27 -> V_48 ,
...
V_32 = - V_112 ;
V_27 -> V_50 . V_105 = F_57 ( V_27 -> V_50 . V_109 ) ;
if( V_27 -> V_50 . V_105 == NULL ) {
F_18 ( V_52 L_45 ) ;
goto error;
}
F_58 () ;
V_32 = F_41 ( V_27 -> V_70 , V_27 -> V_50 . V_105 ,
V_27 -> V_50 . V_76 ,
V_27 -> V_50 . V_109 ) ;
if( V_32 < 0 )
goto error;
V_29 = V_27 -> V_28 ;
V_29 . V_45 = 0 ;
V_32 = F_47 ( V_27 -> V_50 . V_12 , & V_29 , V_27 -> V_48 , NULL ,
NULL , NULL , NULL , NULL ) ;
...
static void F_59 ( struct V_113 * V_66 )
{
struct V_26 * V_27 = F_60 ( V_66 ) ;
F_61 ( V_27 -> V_64 ) ;
* V_27 = ( (struct V_26 ) V_114 ) ;
}
static int F_62 ( int V_34 , T_5 V_74 , int V_115 ,
struct V_116 * * V_117 )
{
struct V_116 * V_118 ;
V_118 = F_63 ( 1 << V_119 ) ;
...
V_43 [ V_115 ] . V_124 . V_66 . V_127 = F_59 ;
F_65 ( & V_43 [ V_115 ] . V_124 . V_66 , & V_43 [ V_115 ] ) ;
F_66 ( & V_43 [ V_115 ] . V_124 ) ;
...
F_73 ( V_27 -> V_64 , V_131 ) ;
V_32 = F_62 ( V_39 , V_27 -> V_74 , V_3 , & V_133 [ V_3 ] ) ;
if( V_32 ) {
* V_25 = L_50 ;
goto V_134;
}
...
F_17 ( & V_37 ) ;
if( V_27 -> V_12 == NULL ) {
F_77 ( V_20 , V_74 , V_80 , L_53 , 1 ) ;
goto V_44;
}
F_77 ( V_20 , V_74 , V_80 , V_27 -> V_12 , 0 ) ;
if( V_27 -> V_50 . V_12 != NULL ) {
F_77 ( V_20 , V_74 , V_80 , L_54 , 0 ) ;
F_77 ( V_20 , V_74 , V_80 , V_27 -> V_50 . V_12 , 1 ) ;
}
else F_77 ( V_20 , V_74 , V_80 , L_53 , 1 ) ;
V_44:
F_19 ( & V_37 ) ;
return V_80 ;
}
static int F_78 ( char * * V_20 , int * V_139 , int * V_140 )
{
int V_3 ;
V_3 = F_13 ( V_20 ) ;
* V_139 = 0 ;
...
V_145 = F_90 ( 0 , 0 ) ;
V_68 = F_91 ( V_145 + V_111 - sizeof( void * ) ,
& V_58 ) ;
if( V_68 < 0 ) {
F_18 ( V_52
L_61
...
V_32 = F_92 ( V_61 , V_58 , V_146 , F_33 ,
V_147 , L_56 , V_43 ) ;
if( V_32 != 0 )
F_18 ( V_52 L_63 , - V_32 ) ;
return 0 ;
}
static int F_93 ( struct V_148 * V_149 , T_7 V_97 )
{
...
V_27 -> V_142 ++ ;
F_94 ( V_118 , ! V_27 -> V_28 . V_45 ) ;
V_44:
F_19 ( & V_151 ) ;
return V_32 ;
}
static int F_95 ( struct V_116 * V_118 , T_7 V_97 )
{
struct V_26 * V_27 = V_118 -> V_129 ;
F_17 ( & V_151 ) ;
if( -- V_27 -> V_142 == 0 )
...
static void F_96 ( T_1 V_152 , int V_60 , unsigned long * V_153 ,
...
static void F_98 ( struct V_53 * V_54 , unsigned long * V_105 ,
T_1 V_76 , T_1 V_109 )
{
...
else F_96 ( V_54 -> V_79 , V_54 -> V_60 , & V_54 -> V_158 ,
& V_54 -> V_154 , V_105 , V_76 ,
V_54 -> V_155 , V_109 ) ;
}
static void F_100 ( struct V_161 * V_54 , struct V_53 * V_162 ,
...
V_162 -> error = 0 ;
V_162 -> V_158 = 0 ;
V_162 -> V_159 = ( F_101 ( V_54 ) == V_167 ) ? V_160 : V_168 ;
V_162 -> V_169 [ 0 ] = 0 ;
V_162 -> V_169 [ 1 ] = V_27 -> V_50 . V_110 ;
V_162 -> V_170 = F_102 ( V_164 ) + V_163 ;
V_162 -> V_95 = 1 << 9 ;
if( V_27 -> V_50 . V_12 != NULL )
F_98 ( V_162 , V_27 -> V_50 . V_105 ,
...
if( V_66 -> V_173 == 0 ) {
struct V_161 * V_54 = F_103 ( V_172 ) ;
if( V_54 == NULL )
return;
V_66 -> V_161 = V_54 ;
V_66 -> V_174 = F_104 ( V_54 ) ;
V_66 -> V_175 = 0 ;
V_66 -> V_173 = F_105 ( V_172 , V_54 , V_66 -> V_130 ) ;
}
V_54 = V_66 -> V_161 ;
while( V_66 -> V_175 < V_66 -> V_173 ) {
struct V_176 * V_130 = & V_66 -> V_130 [ V_66 -> V_175 ] ;
V_162 = F_106 ( sizeof( struct V_53 ) ,
V_177 ) ;
if( V_162 == NULL ) {
if( F_107 ( & V_66 -> V_62 ) )
...
V_130 -> V_79 , V_130 -> V_60 , F_109 ( V_130 ) ) ;
V_3 = F_110 ( V_58 , & V_162 ,
sizeof( struct V_53 * ) ) ;
...
static int F_111 ( struct V_148 * V_149 , struct V_178 * V_179 )
{
struct V_26 * V_27 = V_149 -> V_150 -> V_129 ;
V_179 -> V_180 = 128 ;
V_179 -> V_181 = 32 ;
V_179 -> V_182 = V_27 -> V_74 / ( 128 * 32 * 512 ) ;
return 0 ;
}
static int F_112 ( struct V_148 * V_149 , T_7 V_97 ,
...
struct V_186 V_187 ;
case V_188 :
memset ( & F_78 , 0 , V_185 * 2 ) ;
F_78 [ V_189 ] = V_27 -> V_74 / ( 128 * 32 * 512 ) ;
F_78 [ V_190 ] = 128 ;
F_78 [ V_191 ] = 32 ;
if( F_113 ( ( char V_192 * ) V_184 , ( char * ) & F_78 ,
sizeof( F_78 ) ) )
return - V_193 ;
return 0 ;
case V_194 :
if( F_114 ( & V_187 , ( char V_192 * ) V_184 , sizeof( V_187 ) ) )
return - V_193 ;
V_187 . V_195 = 255 ;
V_187 . V_196 = 255 ;
V_187 . V_197 = 255 ;
V_187 . V_198 = 255 ;
if( F_113 ( ( char V_192 * ) V_184 , & V_187 , sizeof( V_187 ) ) )
return - V_193 ;
return 0 ;
}
return - V_36 ;
...
if( V_54 -> V_154 == - 1 )
return 0 ;
V_3 = F_42 ( V_54 -> V_166 [ 1 ] , V_54 -> V_154 ) ;
if( V_3 < 0 ) {
F_18 ( L_68 , - V_3 ) ;
return 1 ;
}
V_3 = F_110 ( V_54 -> V_166 [ 1 ] , & V_54 -> V_155 ,
sizeof( V_54 -> V_155 ) ) ;
...
char * V_78 ;
unsigned long V_80 ;
int V_3 , V_199 , V_200 , V_23 , V_1 ;
int V_32 ;
T_1 V_5 ;
V_199 = V_54 -> V_60 / V_54 -> V_95 ;
V_200 = 0 ;
do {
V_1 = F_1 ( V_200 , ( unsigned char * ) & V_54 -> V_158 ) ;
V_23 = V_200 ;
while( ( V_23 < V_199 ) &&
...
V_200 * V_54 -> V_95 ;
V_80 = ( V_23 - V_200 ) * V_54 -> V_95 ;
V_78 = & V_54 -> V_170 [ V_200 * V_54 -> V_95 ] ;
V_32 = F_42 ( V_54 -> V_166 [ V_1 ] , V_5 ) ;
if( V_32 < 0 ) {
F_18 ( L_70 , - V_32 ) ;
V_54 -> error = 1 ;
return;
...
V_3 = F_110 ( V_54 -> V_166 [ V_1 ] , V_78 , V_80 ) ;
if( V_3 != V_80 ) {
F_18 ( L_73
L_72 , - V_3 , V_54 -> V_166 [ V_1 ] ) ;
V_54 -> error = 1 ;
