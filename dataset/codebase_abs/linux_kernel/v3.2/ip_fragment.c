...
V_107 += F_67 ( & F_65 ( V_44 ) -> V_5 [ V_93 ] ) ;
V_106 -> V_73 = V_106 -> V_110 = V_44 -> V_110 - V_107 ;
V_44 -> V_110 -= V_106 -> V_73 ;
...
F_68 ( V_44 , V_44 -> V_112 - F_69 ( V_44 ) ) ;
for ( V_65 = V_44 -> V_72 ; V_65 ; V_65 = V_65 -> V_72 ) {
V_44 -> V_110 += V_65 -> V_73 ;
V_44 -> V_73 += V_65 -> V_73 ;
if ( V_44 -> V_88 != V_65 -> V_88 )
V_44 -> V_88 = V_90 ;
else if ( V_44 -> V_88 == V_113 )
V_44 -> V_111 = F_70 ( V_44 -> V_111 , V_65 -> V_111 ) ;
V_44 -> V_31 += V_65 -> V_31 ;
}
...
const struct V_45 * V_25 ;
V_13 V_73 ;
if ( V_30 -> V_20 != F_71 ( V_120 ) )
return V_30 ;
if ( ! F_78 ( V_30 , sizeof( struct V_45 ) ) )
return V_30 ;
V_25 = F_30 ( V_30 ) ;
if ( V_25 -> V_80 < 5 || V_25 -> V_121 != 4 )
return V_30 ;
if ( ! F_78 ( V_30 , V_25 -> V_80 * 4 ) )
return V_30 ;
V_25 = F_30 ( V_30 ) ;
V_73 = F_48 ( V_25 -> V_114 ) ;
if ( V_30 -> V_73 < V_73 || V_73 < ( V_25 -> V_80 * 4 ) )
return V_30 ;
if ( F_79 ( F_30 ( V_30 ) ) ) {
V_30 = F_80 ( V_30 , V_103 ) ;
if ( V_30 ) {
if ( F_51 ( V_30 , V_73 ) )
return V_30 ;
memset ( F_46 ( V_30 ) , 0 , sizeof( struct V_122 ) ) ;
if ( F_74 ( V_30 , V_26 ) )
return NULL ;
V_30 -> V_123 = 0 ;
}
...
V_125 = V_128 ;
if ( ! F_82 ( V_3 , & V_129 ) ) {
V_125 = F_83 ( V_125 , sizeof( V_128 ) , V_130 ) ;
if ( V_125 == NULL )
goto V_131;
V_125 [ 0 ] . V_112 = & V_3 -> V_4 . V_5 . V_118 ;
V_125 [ 1 ] . V_112 = & V_3 -> V_4 . V_5 . V_132 ;
V_125 [ 2 ] . V_112 = & V_3 -> V_4 . V_5 . V_68 ;
}
V_127 = F_84 ( V_3 , V_133 , V_125 ) ;
if ( V_127 == NULL )
goto V_134;
V_3 -> V_4 . V_135 = V_127 ;
return 0 ;
...
V_3 -> V_4 . V_5 . V_132 = 192 * 1024 ;
V_3 -> V_4 . V_5 . V_68 = V_138 ;
F_91 ( & V_3 -> V_4 . V_5 ) ;
return F_81 ( V_3 ) ;
}
