...
{
if ( V_9 . V_57 < 0 )
return sprintf ( V_30 , L_8 ) ;
return sprintf ( V_30 , L_9 , ( V_9 . V_57 ) ? L_10 : L_11 ) ;
}
...
if ( strncmp ( V_30 , L_10 , sizeof( L_10 ) - 1 ) == 0 )
V_5 = 1 ;
else if ( strncmp ( V_30 , L_11 , sizeof( L_11 ) - 1 ) == 0 )
V_5 = 0 ;
else {
F_36 ( L_13 ) ;
return - V_65 ;
