...
{
struct V_20 * V_21 = V_11 -> V_21 -> V_20 ;
struct V_22 * V_23 = V_11 -> V_23 ;
int V_14 = 0 ;
if ( ! V_21 -> V_24 -> V_25 )
V_21 -> V_24 -> V_25 = & V_26 ;
if ( ! V_21 -> V_24 -> V_27 )
V_21 -> V_24 -> V_27 = F_9 ( 32 ) ;
if ( V_23 -> V_28 [ V_29 ] . V_2 ) {
V_14 = F_10 ( V_23 ,
V_29 ) ;
if ( V_14 )
goto V_30;
}
if ( V_23 -> V_28 [ V_31 ] . V_2 ) {
V_14 = F_10 ( V_23 ,
V_31 ) ;
if ( V_14 )
goto V_30;
...
static int T_1 F_11 ( struct V_32 * V_33 )
{
return F_12 ( & V_33 -> V_24 , & V_34 ) ;
}
