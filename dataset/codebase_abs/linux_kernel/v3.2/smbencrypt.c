...
int
F_23 ( const unsigned char * V_39 , unsigned char * V_19 ,
...
T_1 V_43 [ 129 ] ;
if ( V_39 )
V_42 = F_24 ( V_43 , V_39 , 128 , V_41 ) ;
else {
V_42 = 0 ;
* V_43 = 0 ;
}
V_6 = F_13 ( V_19 , ( unsigned char * ) V_43 , V_42 * sizeof( T_1 ) ) ;
memset ( V_43 , 0 , 129 * sizeof( T_1 ) ) ;
return V_6 ;
}
int
F_25 ( unsigned char * V_39 , unsigned char * V_22 , unsigned char * V_23 ,
const struct V_40 * V_41 )
{
int V_6 ;
...
memset ( V_19 , '\0' , 16 ) ;
memset ( V_21 , '\0' , 21 ) ;
V_6 = F_23 ( V_39 , V_19 , V_41 ) ;
if ( V_6 ) {
F_26 ( 1 , L_10 , V_32 , V_6 ) ;
return V_6 ;
}
memcpy ( V_21 , V_19 , 16 ) ;
V_6 = F_12 ( V_21 , V_22 , V_23 ) ;
