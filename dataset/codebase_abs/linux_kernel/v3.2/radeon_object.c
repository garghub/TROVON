...
int F_70 ( struct V_3 * V_4 , T_1 * V_109 , bool V_113 )
{
int V_40 ;
V_40 = F_71 ( & V_4 -> V_2 , true , V_113 , false , 0 ) ;
if ( F_14 ( V_40 != 0 ) )
return V_40 ;
F_72 ( & V_4 -> V_2 . V_42 -> V_114 ) ;
if ( V_109 )
* V_109 = V_4 -> V_2 . V_104 . V_109 ;
if ( V_4 -> V_2 . V_115 )
V_40 = F_73 ( & V_4 -> V_2 , true , true , V_113 ) ;
F_74 ( & V_4 -> V_2 . V_42 -> V_114 ) ;
F_75 ( & V_4 -> V_2 ) ;
return V_40 ;
}
int F_65 ( struct V_3 * V_4 , bool V_113 )
{
int V_40 ;
V_40 = F_71 ( & V_4 -> V_2 , true , V_113 , false , 0 ) ;
if ( F_14 ( V_40 != 0 ) ) {
if ( V_40 != - V_58 )
F_21 ( V_4 -> V_5 -> V_59 , L_11 , V_4 ) ;
return V_40 ;
}
return 0 ;
}
