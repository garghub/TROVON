...
struct V_86 * V_87 = F_49 ( V_2 ) ;
if ( V_2 -> V_88 == V_89 ) {
F_50 ( V_90 L_2 ,
& V_87 -> V_91 , F_51 ( V_87 -> V_92 ) ,
V_87 -> V_93 , V_13 -> V_94 , V_13 -> V_95 ) ;
}
#if F_52 ( V_96 ) || F_52 ( V_97 )
else if ( V_2 -> V_88 == V_98 ) {
struct V_99 * V_100 = F_53 ( V_2 ) ;
F_50 ( V_90 L_3 ,
& V_100 -> V_101 , F_51 ( V_87 -> V_92 ) ,
V_87 -> V_93 , V_13 -> V_94 , V_13 -> V_95 ) ;
}
#endif
...
V_29 -> V_46 <= V_121 ) {
V_29 -> V_85 = 0 ;
V_29 -> V_58 = F_17 ( F_62 ( V_13 ) , V_18 ) ;
} else {
V_29 -> V_58 = F_17 ( V_29 -> V_58 << 1 , V_18 ) ;
}
F_60 ( V_2 , V_116 , V_29 -> V_58 , V_18 ) ;
...
void F_65 ( struct V_1 * V_2 , struct V_129 * V_130 )
{
F_5 ( F_6 ( V_2 ) , V_115 ) ;
}
