...
static struct V_24 *
F_13 ( struct V_1 * V_1 , struct V_16 * V_17 ,
unsigned int V_18 , enum V_19 V_20 )
{
switch ( V_20 ) {
case V_21 :
...
static int F_15 ( struct V_2 * V_4 , int V_26 )
{
const T_3 V_27 = V_28 ;
...
int V_13 ;
if ( ! V_26 )
return F_9 ( V_1 , V_27 , 0 ) ;
V_29 = F_16 ( V_25 -> V_31 , V_23 -> V_31 ) ;
V_30 = F_16 ( V_25 -> V_32 , V_23 -> V_32 ) ;
V_13 = F_6 ( V_6 , V_33 , V_29 - 1 ) ;
if ( V_13 < 0 )
return V_13 ;
V_13 = F_6 ( V_6 , V_34 , V_30 - 1 ) ;
if ( V_13 < 0 )
return V_13 ;
V_13 = F_6 ( V_6 , V_35 , V_25 -> V_36 ) ;
if ( V_13 < 0 )
return V_13 ;
V_13 = F_6 ( V_6 , V_37 , V_25 -> V_38 ) ;
if ( V_13 < 0 )
return V_13 ;
V_13 = F_6 ( V_6 , V_39 , V_25 -> V_31 - 1 ) ;
if ( V_13 < 0 )
return V_13 ;
V_13 = F_6 ( V_6 , V_40 , V_25 -> V_32 - 1 ) ;
if ( V_13 < 0 )
return V_13 ;
return F_9 ( V_1 , 0 , V_27 ) ;
}
...
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
V_23 -> V_23 = * F_11 ( V_1 , V_17 , V_23 -> V_18 ,
V_23 -> V_20 ) ;
return 0 ;
}
...
unsigned int V_29 ;
unsigned int V_30 ;
V_56 = F_13 ( V_1 , V_17 , V_23 -> V_18 ,
V_23 -> V_20 ) ;
V_31 = F_21 (unsigned int, ALIGN(format->format.width, 2),
max(__crop->width / 8, MT9T001_WINDOW_HEIGHT_MIN + 1),
__crop->width) ;
V_32 = F_21 (unsigned int, ALIGN(format->format.height, 2),
max(__crop->height / 8, MT9T001_WINDOW_HEIGHT_MIN + 1),
__crop->height) ;
V_29 = F_16 ( V_56 -> V_31 , V_31 ) ;
V_30 = F_16 ( V_56 -> V_32 , V_32 ) ;
V_55 = F_11 ( V_1 , V_17 , V_23 -> V_18 ,
V_23 -> V_20 ) ;
...
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
V_25 -> V_58 = * F_13 ( V_1 , V_17 , V_25 -> V_18 ,
V_25 -> V_20 ) ;
return 0 ;
}
...
struct V_24 * V_56 ;
struct V_24 V_58 ;
V_58 . V_36 = F_24 ( F_25 ( V_25 -> V_58 . V_36 , 2 ) ,
V_59 ,
V_60 ) ;
V_58 . V_38 = F_24 ( F_25 ( V_25 -> V_58 . V_38 , 2 ) ,
V_61 ,
V_62 ) ;
V_58 . V_31 = F_24 ( F_25 ( V_25 -> V_58 . V_31 , 2 ) ,
V_63 + 1 ,
V_64 + 1 ) ;
V_58 . V_32 = F_24 ( F_25 ( V_25 -> V_58 . V_32 , 2 ) ,
V_65 + 1 ,
V_66 + 1 ) ;
V_58 . V_31 = F_26 ( V_58 . V_31 , V_67 - V_58 . V_36 ) ;
V_58 . V_32 = F_26 ( V_58 . V_32 , V_68 - V_58 . V_38 ) ;
V_56 = F_13 ( V_1 , V_17 , V_25 -> V_18 , V_25 -> V_20 ) ;
if ( V_58 . V_31 != V_56 -> V_31 || V_58 . V_32 != V_56 -> V_32 ) {
V_55 = F_11 ( V_1 , V_17 , V_25 -> V_18 ,
V_25 -> V_20 ) ;
V_55 -> V_31 = V_58 . V_31 ;
V_55 -> V_32 = V_58 . V_32 ;
}
...
if ( V_13 < 0 )
return V_13 ;
return F_6 ( V_6 , V_95 , V_73 -> V_88 << 2 ) ;
case V_96 :
...
break;
case V_100 :
V_13 = F_6 ( V_6 , V_101 , V_73 -> V_88 ) ;
if ( V_13 < 0 )
return V_13 ;
V_13 = F_6 ( V_6 , V_102 , V_73 -> V_88 ) ;
if ( V_13 < 0 )
return V_13 ;
V_13 = F_6 ( V_6 , V_103 , V_73 -> V_88 ) ;
if ( V_13 < 0 )
return V_13 ;
return F_6 ( V_6 , V_104 , V_73 -> V_88 ) ;
case V_105 :
return F_6 ( V_6 , V_98 ,
V_106 |
V_1 -> V_99 ) ;
...
static int F_30 ( struct V_2 * V_4 , struct V_16 * V_17 )
{
struct V_15 * V_23 ;
struct V_24 * V_25 ;
V_25 = F_14 ( V_17 , 0 ) ;
...
F_32 ( & V_6 -> V_115 , L_1 ,
V_6 -> V_117 ) ;
V_13 = F_6 ( V_6 , V_118 , 1 ) ;
if ( V_13 < 0 )
return V_13 ;
V_13 = F_6 ( V_6 , V_118 , 0 ) ;
if ( V_13 < 0 )
return V_13 ;
V_13 = F_6 ( V_6 , V_14 , 0 ) ;
if ( V_13 < 0 )
...
if ( V_13 < 0 )
return V_13 ;
V_1 = F_37 ( sizeof( * V_1 ) , V_130 ) ;
if ( ! V_1 )
return - V_131 ;
F_38 ( & V_1 -> V_80 , F_39 ( V_132 ) +
F_39 ( V_133 ) + 2 ) ;
F_40 ( & V_1 -> V_80 , & V_134 ,
V_90 , V_135 ,
V_136 , 1 ,
...
F_40 ( & V_1 -> V_80 , & V_134 ,
V_138 , 1 , 1 , 1 , 1 ) ;
for ( V_82 = 0 ; V_82 < F_39 ( V_132 ) ; ++ V_82 )
F_41 ( & V_1 -> V_80 , & V_132 [ V_82 ] , NULL ) ;
for ( V_82 = 0 ; V_82 < F_39 ( V_133 ) ; ++ V_82 )
V_1 -> V_74 [ V_82 ] = F_41 ( & V_1 -> V_80 ,
& V_133 [ V_82 ] , NULL ) ;
F_42 ( F_39 ( V_133 ) , V_1 -> V_74 ) ;
...
F_44 ( & V_1 -> V_4 , V_6 , & V_143 ) ;
V_1 -> V_4 . V_144 = & V_145 ;
V_1 -> V_4 . V_146 |= V_147 ;
V_1 -> V_18 . V_146 = V_148 ;
V_13 = F_45 ( & V_1 -> V_4 . V_149 , 1 , & V_1 -> V_18 , 0 ) ;
V_142:
if ( V_13 < 0 ) {
F_46 ( & V_1 -> V_80 ) ;
F_47 ( & V_1 -> V_4 . V_149 ) ;
