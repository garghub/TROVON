...
int V_9 )
{
struct V_28 * V_29 = & V_6 -> V_12 [ V_9 ] ;
struct V_30 * V_31 = & V_8 -> V_32 [ V_9 ] ;
struct V_10 * V_11 = F_6 ( V_29 ) ;
T_1 V_33 = V_34 ;
T_1 V_35 = V_34 ;
int V_36 = - 1 ;
if ( V_37 ) {
...
{
struct V_30 * V_61 = & V_8 -> V_32 [ V_41 ] ;
...
struct V_28 * V_69 = & V_6 -> V_12 [ V_41 ] ;
