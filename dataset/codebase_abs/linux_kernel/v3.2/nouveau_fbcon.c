...
int V_122 ;
int V_13 ;
V_6 = F_66 ( sizeof( struct V_5 ) , V_123 ) ;
if ( ! V_6 )
return - V_89 ;
V_6 -> V_9 = V_9 ;
V_11 -> V_6 = V_6 ;
V_6 -> V_47 . V_124 = & V_125 ;
...
F_70 ( & V_6 -> V_47 ) ;
if ( V_11 -> V_126 <= 32 * 1024 * 1024 )
V_122 = 8 ;
else if ( V_11 -> V_126 <= 64 * 1024 * 1024 )
V_122 = 16 ;
else
V_122 = 32 ;
F_71 ( & V_6 -> V_47 , V_122 ) ;
...
{
struct V_10 * V_11 = V_9 -> V_12 ;
V_11 -> V_6 -> V_127 = V_11 -> V_6 -> V_47 . V_48 -> V_17 ;
V_11 -> V_6 -> V_47 . V_48 -> V_17 |= V_18 ;
}
void F_74 ( struct V_8 * V_9 )
{
struct V_10 * V_11 = V_9 -> V_12 ;
V_11 -> V_6 -> V_47 . V_48 -> V_17 = V_11 -> V_6 -> V_127 ;
}
