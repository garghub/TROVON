...
F_47 ( V_140 . type , L_9 , V_143 ) ;
V_140 . V_138 = V_138 ;
V_140 . V_144 = V_137 ;
V_142 = F_48 ( V_135 , & V_140 ) ;
if ( ! V_142 )
return - V_110 ;
if ( ! V_142 -> V_145 ) {
F_49 ( V_142 ) ;
...
F_50 ( & V_142 -> V_146 , & V_142 -> V_145 -> V_147 ) ;
return 0 ;
}
static int F_51 ( struct V_141 * V_142 ,
const struct V_148 * V_149 )
{
struct V_136 * V_137 = V_142 -> V_11 . V_144 ;
struct V_1 * V_1 ;
T_1 V_150 ;
V_1 = F_52 ( sizeof( struct V_1 ) , V_115 ) ;
if ( ! V_1 )
return - V_116 ;
F_53 ( & V_1 -> V_25 ) ;
V_1 -> V_8 = V_142 ;
F_54 ( V_142 , V_1 ) ;
if ( F_1 ( V_1 , V_5 , & V_150 ) != 0 ) {
F_39 (KERN_ERR PFX L_10 ) ;
goto V_151;
}
F_47 ( V_1 -> V_94 . V_39 , L_11 , V_152 ) ;
V_1 -> V_94 . V_153 = V_154 ;
V_1 -> V_94 . V_155 = F_37 ;
V_1 -> V_94 . exit = F_45 ;
V_1 -> V_94 . V_137 = F_55 ( V_137 ) ;
if ( F_56 ( & V_1 -> V_94 ) ) {
goto V_151;
}
F_39 (KERN_DEBUG PFX L_12 ) ;
return 0 ;
V_151:
F_57 ( V_1 ) ;
return - V_110 ;
...
{
struct V_136 * V_156 , * V_11 = NULL ;
struct V_157 * V_158 ;
V_158 = F_59 ( V_135 ) ;
if ( V_158 == NULL )
return - V_110 ;
V_156 = F_60 ( V_158 ) ;
while ( ( V_11 = F_61 ( V_156 , V_11 ) ) != NULL ) {
if ( F_62 ( V_11 , L_13 ) ) {
const T_5 * V_138 ;
F_39 (KERN_DEBUG PFX L_14 ) ;
V_138 = F_63 ( V_11 , L_15 , NULL ) ;
if ( ! V_138 )
return - V_110 ;
return F_46 ( V_135 , V_11 , ( * V_138 ) >> 1 ) ;
}
}
if ( ! F_62 ( V_156 , L_16 ) )
return - V_110 ;
F_39 (KERN_DEBUG PFX L_17 ) ;
if ( F_46 ( V_135 , NULL , 0x46 ) == 0 )
return 0 ;
return F_46 ( V_135 , NULL , 0x47 ) ;
}
static int F_64 ( struct V_141 * V_142 )
{
struct V_1 * V_1 = F_65 ( V_142 ) ;
F_66 ( & V_1 -> V_94 ) ;
F_67 ( V_1 -> V_94 . V_137 ) ;
F_57 ( V_1 -> V_107 ) ;
F_57 ( V_1 ) ;
