static T_1 unsigned char F_1 ( int V_1 )
{
unsigned char V_2 = 0 ;
switch ( V_1 ) {
case 5 :
...
static T_1 unsigned char F_2 ( int V_3 )
{
unsigned char V_2 = 0 ;
switch ( V_3 ) {
case 0 :
...
static T_1 unsigned char F_3 ( int V_4 )
{
unsigned char V_2 = 0 ;
switch ( V_4 ) {
case 5 :
...
static int F_7 ( char T_2 * V_5 )
{
if ( F_4 ( V_5 ) )
return - V_9 ;
return F_5 ( V_5 + V_10 ) ;
}
static int F_8 ( char T_2 * V_5 , int V_11 )
{
unsigned char V_2 ;
int V_6 = 500000 ;
do {
...
static int T_1 F_11 ( char T_2 * V_5 , int V_16 ,
char * V_17 , int V_18 )
{
int V_19 = 0 ;
if ( F_8 ( V_5 , V_16 ) ) {
...
static int T_1 F_12 ( char T_2 * V_5 )
{
F_9 ( 1 , V_5 + V_20 ) ;
F_13 ( 10 ) ;
F_9 ( 0 , V_5 + V_20 ) ;
...
static int T_1 F_14 ( char T_2 * V_5 , const int * V_22 )
{
if ( F_8 ( V_5 , V_23 ) < 0 ) {
F_10 ( V_24 L_2 , V_23 ) ;
return - V_15 ;
...
static int F_15 ( char T_2 * V_5 , unsigned char V_27 )
{
if ( F_8 ( V_5 , V_28 ) ) {
F_10 ( V_14 L_2 , V_28 ) ;
return - V_15 ;
...
static int F_16 ( char T_2 * V_5 , int V_29 )
{
int V_6 = 10 ;
do {
if ( F_8 ( V_5 , V_30 ) ) {
...
static int T_1 F_17 ( char T_2 * V_5 , int V_29 ,
char T_2 * V_31 , int V_32 )
{
if ( F_8 ( V_5 , V_33 ) ) {
F_10 ( V_14 L_6 ,
V_33 ) ;
...
static void T_1 F_19 ( char T_2 * V_5 , int * V_22 ,
long V_34 , long V_35 ,
long V_36 , int V_37 )
{
V_22 [ 0 ] = 0 ;
...
static int T_1 F_21 ( char T_2 * V_5 ,
char T_2 * V_31 , int V_39 )
{
char V_40 [ 15 ] ;
char V_41 [ 2 ] ;
...
static int T_1 F_23 ( struct V_50 * V_51 )
{
...
static int T_1 F_25 ( struct V_61 * V_62 , unsigned int V_39 )
{
if ( ! V_63 [ V_39 ] )
return 0 ;
if ( V_46 [ V_39 ] == V_38 ) {
...
static int T_1 F_26 ( struct V_61 * V_62 , unsigned int V_39 )
{
...
char T_2 * * V_5 ;
char T_2 * V_31 ;
V_42 = F_27 ( V_60 [ V_39 ] , V_72 [ V_39 ] , V_73 , sizeof( V_5 ) ,
& V_53 ) ;
if ( V_42 < 0 )
return V_42 ;
V_5 = V_53 -> V_74 ;
...
static int T_3 F_43 ( struct V_61 * V_62 , unsigned int V_39 )
{
struct V_52 * V_53 = F_44 ( V_62 ) ;
char T_2 * * V_5 = V_53 -> V_74 ;
if ( F_16 ( * V_5 , 0 ) < 0 )
F_10 ( V_24 L_45 ) ;
F_41 ( V_46 [ V_39 ] , 0x10 ) ;
F_41 ( V_48 [ V_39 ] , 4 ) ;
