...
F_43 ( V_109 -> V_47 ) ;
V_109 -> V_47 = NULL ;
F_3 ( L_41 , V_109 -> V_186 ) ;
}
V_109 -> V_187 -> V_190 ( V_109 ) ;
}
static void
F_116 ( struct V_170 * V_191 ,
struct V_185 * V_109 )
{
F_117 ( & V_109 -> V_116 , & V_191 -> V_192 ) ;
if ( V_109 -> V_173 && F_27 ( & V_109 -> V_173 -> V_193 ) )
F_118 ( V_109 -> V_173 , & V_191 -> V_192 ) ;
F_108 ( V_191 ) ;
V_191 -> V_194 = 1 ;
F_119 ( V_109 ) ;
}
static enum V_195
F_120 ( struct V_185 * V_196 ,
...
V_196 -> V_187 = V_198 ;
V_196 -> V_47 = F_96 ( V_47 ) ;
F_3 ( L_42 , V_5 ,
V_35 -> V_90 , V_196 -> args . V_157 , V_196 -> args . V_67 , V_199 ) ;
V_200 = V_8 -> V_9 -> V_201 ( V_196 , V_199 ) ;
if ( V_200 == V_202 ) {
F_43 ( V_196 -> V_47 ) ;
V_196 -> V_47 = NULL ;
} else
...
static void
F_122 ( struct V_170 * V_191 , struct V_76 * V_204 , int V_199 )
{
struct V_185 * V_109 ;
const struct V_197 * V_198 = V_191 -> V_205 ;
struct V_46 * V_47 = V_191 -> V_174 ;
V_191 -> V_174 = NULL ;
while ( ! F_27 ( V_204 ) ) {
enum V_195 V_200 ;
V_109 = F_66 ( V_204 -> V_79 , struct V_185 , V_206 ) ;
F_41 ( & V_109 -> V_206 ) ;
V_200 = F_120 ( V_109 , V_198 , V_47 , V_199 ) ;
if ( V_200 == V_202 )
F_116 ( V_191 , V_109 ) ;
}
F_43 ( V_47 ) ;
...
int
F_123 ( struct V_170 * V_191 )
{
F_45 ( V_204 ) ;
int V_155 ;
V_155 = F_124 ( V_191 , & V_204 ) ;
if ( V_155 != 0 ) {
F_43 ( V_191 -> V_174 ) ;
V_191 -> V_174 = NULL ;
return V_155 ;
}
F_122 ( V_191 , & V_204 , V_191 -> V_207 ) ;
return 0 ;
}
static void F_125 ( struct V_208 * V_109 )
{
struct V_170 V_171 ;
F_43 ( V_109 -> V_47 ) ;
V_109 -> V_47 = NULL ;
F_3 ( L_41 , V_109 -> V_186 ) ;
F_126 ( & V_171 , V_109 -> V_35 ) ;
while ( ! F_27 ( & V_109 -> V_116 ) ) {
struct V_172 * V_173 = F_127 ( V_109 -> V_116 . V_79 ) ;
F_128 ( V_173 ) ;
F_129 ( & V_171 , V_173 ) ;
}
F_130 ( & V_171 ) ;
}
void F_131 ( struct V_208 * V_109 )
{
if ( F_93 ( ! V_109 -> V_186 ) ) {
F_132 ( V_109 ) ;
V_109 -> V_187 -> V_188 ( & V_109 -> V_189 , V_109 ) ;
...
static enum V_195
F_135 ( struct V_208 * V_209 ,
const struct V_197 * V_198 ,
struct V_46 * V_47 )
{
struct V_35 * V_35 = V_209 -> V_35 ;
struct V_7 * V_8 = F_20 ( V_35 ) ;
enum V_195 V_200 ;
V_209 -> V_187 = V_198 ;
V_209 -> V_47 = F_96 ( V_47 ) ;
F_3 ( L_44 ,
V_5 , V_35 -> V_90 , V_209 -> args . V_157 , V_209 -> args . V_67 ) ;
V_200 = V_8 -> V_9 -> V_210 ( V_209 ) ;
if ( V_200 == V_202 ) {
F_43 ( V_209 -> V_47 ) ;
V_209 -> V_47 = NULL ;
} else {
...
static void
F_136 ( struct V_170 * V_191 , struct V_76 * V_204 )
{
struct V_208 * V_109 ;
const struct V_197 * V_198 = V_191 -> V_205 ;
struct V_46 * V_47 = V_191 -> V_174 ;
...
while ( ! F_27 ( V_204 ) ) {
enum V_195 V_200 ;
V_109 = F_66 ( V_204 -> V_79 , struct V_208 , V_206 ) ;
F_41 ( & V_109 -> V_206 ) ;
V_200 = F_135 ( V_109 , V_198 , V_47 ) ;
if ( V_200 == V_202 )
F_133 ( V_191 , V_109 ) ;
}
F_43 ( V_47 ) ;
...
int
F_137 ( struct V_170 * V_191 )
{
F_45 ( V_204 ) ;
int V_155 ;
V_155 = F_138 ( V_191 , & V_204 ) ;
if ( V_155 != 0 ) {
F_43 ( V_191 -> V_174 ) ;
V_191 -> V_174 = NULL ;
return V_155 ;
...
static void F_139 ( struct V_35 * V_35 , struct V_76 * V_212 )
{
struct V_46 * V_47 ;
F_2 (lseg, &NFS_I(inode)->layout->plh_segs, pls_list) {
if ( V_47 -> V_82 . V_74 == V_154 &&
F_40 ( V_213 , & V_47 -> V_52 ) )
F_14 ( & V_47 -> V_49 , V_212 ) ;
}
}
void F_140 ( struct V_46 * V_47 )
{
if ( V_47 -> V_82 . V_74 == V_154 ) {
F_3 ( L_45 , V_5 ) ;
...
void
F_115 ( struct V_185 * V_196 )
{
struct V_85 * V_86 = F_28 ( V_196 -> V_35 ) ;
T_6 V_214 = V_196 -> V_215 + V_196 -> V_167 . V_157 ;
bool V_216 = false ;
F_5 ( & V_86 -> V_87 . V_45 ) ;
...
if ( ! F_55 ( V_213 , & V_196 -> V_47 -> V_52 ) ) {
F_96 ( V_196 -> V_47 ) ;
}
if ( V_214 > V_86 -> V_44 -> V_217 )
V_86 -> V_44 -> V_217 = V_214 ;
F_6 ( & V_86 -> V_87 . V_45 ) ;
F_3 ( L_48 ,
V_5 , V_196 -> V_47 , V_86 -> V_44 -> V_217 ) ;
if ( V_216 )
F_141 ( V_196 -> V_35 ) ;
}
void F_142 ( struct V_218 * V_109 )
{
...
int
F_143 ( struct V_35 * V_35 , bool V_220 )
{
struct V_218 * V_109 ;
...
if ( ! F_40 ( V_133 , & V_86 -> V_134 ) )
goto V_221;
if ( F_55 ( V_222 , & V_86 -> V_134 ) ) {
if ( ! V_220 ) {
V_24 = - V_106 ;
goto V_221;
}
V_24 = F_144 ( & V_86 -> V_134 , V_222 ,
V_223 , V_224 ) ;
if ( V_24 )
goto V_221;
}
...
F_145 ( V_222 , & V_86 -> V_134 ) ;
F_6 ( & V_35 -> V_45 ) ;
F_146 ( & V_86 -> V_134 , V_222 ) ;
goto V_221;
}
F_139 ( V_35 , & V_109 -> V_225 ) ;
V_214 = V_86 -> V_44 -> V_217 ;
V_86 -> V_44 -> V_217 = 0 ;
memcpy ( & V_109 -> args . V_96 . V_109 , V_86 -> V_44 -> V_95 . V_109 ,
sizeof( V_86 -> V_44 -> V_95 . V_109 ) ) ;
F_6 ( & V_35 -> V_45 ) ;
V_109 -> args . V_35 = V_35 ;
V_109 -> V_226 = F_91 ( V_86 -> V_44 -> V_41 ) ;
F_147 ( & V_109 -> V_227 ) ;
V_109 -> args . V_228 = F_20 ( V_35 ) -> V_229 ;
V_109 -> V_167 . V_227 = & V_109 -> V_227 ;
V_109 -> args . V_230 = V_214 - 1 ;
V_109 -> V_167 . V_12 = F_20 ( V_35 ) ;
V_24 = F_148 ( V_109 , V_220 ) ;
V_4:
if ( V_24 )
F_141 ( V_35 ) ;
F_3 ( L_50 , V_5 , V_24 ) ;
