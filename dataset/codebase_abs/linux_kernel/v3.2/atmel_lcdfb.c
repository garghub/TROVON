...
if ( V_2 -> V_29 )
return;
memset ( & V_22 , 0 , sizeof( struct V_28 ) ) ;
V_22 . type = V_30 ;
V_22 . V_31 = 0xff ;
V_18 = F_8 ( L_1 , & V_2 -> V_32 -> V_33 , V_2 ,
& V_34 , & V_22 ) ;
if ( F_9 ( V_18 ) ) {
F_10 ( & V_2 -> V_32 -> V_33 , L_2 ,
F_11 ( V_18 ) ) ;
return;
}
V_2 -> V_29 = V_18 ;
...
F_37 ( V_33 , L_6 , V_4 -> V_12 , V_4 -> V_80 ) ;
F_37 ( V_33 , L_7 , F_38 ( V_4 -> V_78 ) ) ;
F_37 ( V_33 , L_8 , V_4 -> V_10 ) ;
F_37 ( V_33 , L_9 , V_75 ) ;
if ( F_38 ( V_4 -> V_78 ) > V_75 ) {
F_10 ( V_33 , L_10 , F_38 ( V_4 -> V_78 ) ) ;
return - V_79 ;
}
...
static int T_3 F_65 ( struct V_174 * V_32 )
{
struct V_64 * V_33 = & V_32 -> V_33 ;
struct V_5 * V_6 ;
struct V_1 * V_2 ;
struct V_1 * V_175 ;
struct V_71 V_73 ;
...
F_37 ( V_33 , L_26 , V_77 ) ;
V_152 = - V_70 ;
V_6 = F_66 ( sizeof( struct V_1 ) , V_33 ) ;
if ( ! V_6 ) {
F_10 ( V_33 , L_27 ) ;
goto V_179;
}
...
V_2 -> V_6 = V_6 ;
V_2 -> V_32 = V_32 ;
strcpy ( V_6 -> V_58 . V_185 , V_2 -> V_32 -> V_186 ) ;
V_6 -> V_187 = V_188 ;
V_6 -> V_154 = V_2 -> V_154 ;
V_6 -> V_189 = & V_190 ;
...
if ( F_17 () || F_18 ()
|| F_19 () ) {
V_2 -> V_173 = F_67 ( V_33 , L_29 ) ;
if ( F_9 ( V_2 -> V_173 ) ) {
V_152 = F_11 ( V_2 -> V_173 ) ;
goto V_184;
}
}
V_2 -> V_76 = F_67 ( V_33 , L_30 ) ;
if ( F_9 ( V_2 -> V_76 ) ) {
V_152 = F_11 ( V_2 -> V_76 ) ;
goto V_193;
}
F_61 ( V_2 ) ;
V_152 = F_68 ( & V_6 -> V_4 , V_6 , NULL , V_6 -> V_191 . V_194 ,
...
V_177 = F_69 ( V_32 , V_197 , 0 ) ;
if ( ! V_177 ) {
F_10 ( V_33 , L_32 ) ;
V_152 = - V_198 ;
goto V_196;
}
V_2 -> V_199 = F_70 ( V_32 , 0 ) ;
if ( V_2 -> V_199 < 0 ) {
F_10 ( V_33 , L_33 ) ;
V_152 = V_2 -> V_199 ;
goto V_196;
}
V_178 = F_69 ( V_32 , V_197 , 1 ) ;
if ( V_178 ) {
V_6 -> V_58 . V_60 = V_178 -> V_200 ;
V_6 -> V_58 . V_65 = F_71 ( V_178 ) ;
if ( ! F_72 ( V_6 -> V_58 . V_60 ,
V_6 -> V_58 . V_65 , V_32 -> V_186 ) ) {
V_152 = - V_201 ;
goto V_196;
}
V_6 -> V_66 = F_73 ( V_6 -> V_58 . V_60 , V_6 -> V_58 . V_65 ) ;
if ( ! V_6 -> V_66 )
goto V_202;
} else {
V_152 = F_28 ( V_2 ) ;
if ( V_152 < 0 ) {
F_10 ( V_33 , L_34 , V_152 ) ;
goto V_196;
}
}
V_6 -> V_58 . V_203 = V_177 -> V_200 ;
V_6 -> V_58 . V_204 = F_71 ( V_177 ) ;
if ( ! F_72 ( V_6 -> V_58 . V_203 ,
V_6 -> V_58 . V_204 , V_32 -> V_186 ) ) {
V_152 = - V_201 ;
goto V_205;
}
V_2 -> V_206 = F_73 ( V_6 -> V_58 . V_203 , V_6 -> V_58 . V_204 ) ;
if ( ! V_2 -> V_206 ) {
F_10 ( V_33 , L_35 ) ;
goto V_207;
}
F_15 ( V_2 ) ;
V_152 = F_74 ( V_2 -> V_199 , F_54 , 0 , V_32 -> V_186 , V_6 ) ;
if ( V_152 ) {
F_10 ( V_33 , L_36 , V_152 ) ;
goto V_208;
}
F_75 ( & V_2 -> V_164 , F_56 ) ;
V_152 = F_58 ( V_2 ) ;
if ( V_152 < 0 ) {
F_10 ( V_33 , L_37 , V_152 ) ;
goto V_209;
}
F_35 ( & V_6 -> V_4 , V_6 ) ;
V_152 = F_76 ( V_6 , & V_6 -> V_4 ) ;
if ( V_152 ) {
F_14 ( V_33 , L_38 ) ;
goto V_210;
}
...
F_83 ( V_2 -> V_206 ) ;
V_207:
F_84 ( V_6 -> V_58 . V_203 , V_6 -> V_58 . V_204 ) ;
V_205:
if ( V_178 )
F_83 ( V_6 -> V_66 ) ;
else
...
V_202:
if ( V_178 )
F_84 ( V_6 -> V_58 . V_60 , V_6 -> V_58 . V_65 ) ;
V_196:
F_63 ( V_2 ) ;
F_85 ( V_2 -> V_76 ) ;
V_193:
...
static int T_4 F_87 ( struct V_174 * V_32 )
{
struct V_64 * V_33 = & V_32 -> V_33 ;
struct V_5 * V_6 = F_88 ( V_33 ) ;
struct V_1 * V_2 ;
if ( ! V_6 || ! V_6 -> V_56 )
return 0 ;
V_2 = V_6 -> V_56 ;
...
static int F_90 ( struct V_174 * V_32 , T_5 V_213 )
{
struct V_5 * V_6 = F_91 ( V_32 ) ;
struct V_1 * V_2 = V_6 -> V_56 ;
F_2 ( V_2 , V_141 , ~ 0UL ) ;
V_2 -> V_214 = F_3 ( V_2 , V_25 ) ;
F_2 ( V_2 , V_26 , 0 ) ;
if ( V_2 -> V_183 )
V_2 -> V_183 ( 0 ) ;
F_23 ( V_2 ) ;
...
static int F_92 ( struct V_174 * V_32 )
{
struct V_5 * V_6 = F_91 ( V_32 ) ;
struct V_1 * V_2 = V_6 -> V_56 ;
F_61 ( V_2 ) ;
