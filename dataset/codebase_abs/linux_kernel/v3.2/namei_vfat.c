...
static int F_80 ( struct V_18 * V_157 , struct V_1 * V_158 ,
struct V_18 * V_159 , struct V_1 * V_160 )
{
struct V_161 * V_162 ;
struct V_111 * V_163 ;
struct V_18 * V_164 , * V_165 ;
struct V_34 V_166 , V_35 ;
struct V_103 V_104 ;
T_4 V_167 , V_168 ;
int V_36 , V_101 , V_169 , V_170 = 0 ;
struct V_148 * V_149 = V_157 -> V_56 ;
V_166 . V_38 = V_35 . V_38 = V_162 = NULL ;
V_164 = V_158 -> V_6 ;
V_165 = V_160 -> V_6 ;
F_52 ( V_149 ) ;
V_36 = F_47 ( V_157 , & V_158 -> V_151 , & V_166 ) ;
if ( V_36 )
goto V_152;
V_101 = F_59 ( V_164 -> V_154 ) ;
V_169 = ( V_101 && V_157 != V_159 ) ;
if ( V_169 ) {
...
V_168 = F_82 ( V_165 ) -> V_153 ;
F_73 ( V_165 ) ;
} else {
V_36 = F_40 ( V_159 , & V_160 -> V_151 , V_101 , 0 ,
& V_104 , & V_35 ) ;
if ( V_36 )
goto V_152;
V_168 = V_35 . V_153 ;
...
F_45 ( V_164 ) ;
if ( V_169 ) {
int V_128 = F_82 ( V_159 ) -> V_173 ;
V_163 -> V_128 = F_38 ( V_128 ) ;
V_163 -> V_137 = F_38 ( V_128 >> 16 ) ;
F_84 ( V_162 , V_164 ) ;
if ( F_43 ( V_159 ) ) {
V_36 = F_85 ( V_162 ) ;
if ( V_36 )
...
V_36 = F_70 ( V_157 , & V_166 ) ;
V_166 . V_38 = NULL ;
if ( V_36 )
goto V_174;
V_157 -> V_7 ++ ;
V_157 -> V_143 = V_157 -> V_144 = V_104 ;
if ( F_43 ( V_157 ) )
( void ) F_44 ( V_157 ) ;
else
F_45 ( V_157 ) ;
...
V_172:
F_73 ( V_164 ) ;
F_83 ( V_164 , V_166 . V_153 ) ;
if ( V_165 ) {
F_83 ( V_165 , V_168 ) ;
if ( V_170 )
V_170 |= F_44 ( V_165 ) ;
} else {
int V_175 = F_70 ( V_159 , & V_35 ) ;
if ( V_170 )
V_170 |= V_175 ;
V_35 . V_38 = NULL ;
}
...
static void F_87 ( struct V_148 * V_149 )
{
F_11 ( V_149 ) -> V_177 = & V_178 ;
if ( F_11 ( V_149 ) -> V_57 . V_179 != 's' )
V_149 -> V_180 = & V_181 ;
else
V_149 -> V_180 = & V_182 ;
}
static int F_88 ( struct V_148 * V_149 , void * V_183 , int V_184 )
{
return F_89 ( V_149 , V_183 , V_184 , 1 , F_87 ) ;
}
static struct V_1 * F_90 ( struct V_185 * V_186 ,
int V_10 , const char * V_187 ,
void * V_183 )
{
return F_91 ( V_186 , V_10 , V_187 , V_183 , F_88 ) ;
}
