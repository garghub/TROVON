...
V_99 = (struct V_98 * ) F_42 ( V_60 ) ;
error = F_35 ( & V_19 , V_99 , NULL ) ;
if ( ! error ) {
error = ( V_20 & V_95 ) ?
F_39 ( & V_19 , & V_60 , V_100 - 1 ) :
F_53 ( & V_19 , & V_60 , V_100 - 1 ) ;
}
V_91:
...
while ( V_19 -> V_104 ) {
if ( V_19 -> V_104 -> V_105 )
F_31 ( ( unsigned long ) V_19 -> V_104 -> V_105 ) ;
V_103 = V_19 -> V_104 ;
V_19 -> V_104 = V_19 -> V_104 -> V_106 ;
F_14 ( V_103 ) ;
}
V_19 -> V_46 = NULL ;
}
...
return - V_13 ;
V_19 -> V_46 = NULL ;
V_108 = V_19 -> V_104 = NULL ;
V_17 = V_22 -> V_26 ;
while ( V_17 ) {
V_103 = F_58 ( sizeof( * V_19 -> V_104 ) , V_14 ) ;
if ( ! V_103 ) {
F_71 ( V_19 ) ;
return - V_15 ;
}
...
V_108 -> V_106 = V_103 ;
V_108 = V_103 ;
V_103 -> V_105 = (struct V_47 * )
F_26 ( V_44 | V_45 ) ;
if ( ! V_103 -> V_105 ) {
F_71 ( V_19 ) ;
return - V_15 ;
}
error = F_17 ( V_17 , V_103 -> V_105 , NULL ) ;
if ( error ) {
F_71 ( V_19 ) ;
return error ;
}
V_17 = V_103 -> V_105 -> V_56 ;
}
V_19 -> V_51 = 0 ;
V_19 -> V_46 = V_19 -> V_104 -> V_105 ;
return 0 ;
}
...
F_19 ( L_11 ) ;
F_43 ( & V_9 , & V_66 , V_109 , L_28 ) ;
return V_42 ;
}
static int F_79 ( void * V_68 )
{
struct V_112 * V_70 = V_68 ;
while ( 1 ) {
F_45 ( V_70 -> V_72 , F_46 ( & V_70 -> V_73 ) ||
F_47 () ) ;
if ( F_47 () ) {
...
unsigned V_114 = 0 , V_115 = 0 , V_116 = 0 ,
V_117 = 0 , V_118 , V_119 , V_120 = 0 ;
unsigned long V_121 ;
unsigned char * * V_86 = NULL ;
struct V_112 * V_68 = NULL ;
struct V_69 * V_87 = NULL ;
V_85 = F_54 () - 1 ;
V_85 = F_55 ( V_85 , 1 , V_88 ) ;
V_86 = F_56 ( sizeof( * V_86 ) * V_122 ) ;
if ( ! V_86 ) {
F_19 ( V_30 L_13 ) ;
V_42 = - V_15 ;
goto V_89;
...
for ( V_74 = 0 ; V_74 < V_85 ; V_74 ++ )
memset ( & V_68 [ V_74 ] , 0 , F_57 ( struct V_112 , V_72 ) ) ;
V_87 = F_58 ( sizeof( * V_87 ) , V_14 ) ;
if ( ! V_87 ) {
F_19 ( V_30 L_15 ) ;
V_42 = - V_15 ;
...
V_121 = ( V_52 () - F_70 () ) >> 1 ;
V_121 = F_55 ( V_121 , V_96 , V_122 ) ;
for ( V_71 = 0 ; V_71 < V_121 ; V_71 ++ ) {
V_86 [ V_71 ] = ( void * ) F_26 ( V_71 < V_96 ?
V_44 | V_45 :
V_44 ) ;
if ( ! V_86 [ V_71 ] ) {
if ( V_71 < V_96 ) {
...
goto V_91;
for(; ; ) {
for ( V_71 = 0 ; ! V_113 && V_71 < V_118 ; V_71 ++ ) {
V_42 = F_73 ( V_19 , V_86 [ V_114 ] , & V_39 ) ;
if ( V_42 ) {
if ( V_19 -> V_46 &&
...
for ( V_74 = 0 ; V_117 && V_74 < V_85 ; V_74 ++ ) {
V_68 [ V_74 ] . V_82 = * ( T_2 * ) V_86 [ V_115 ] ;
if ( F_62 ( ! V_68 [ V_74 ] . V_82 ||
V_68 [ V_74 ] . V_82 >
F_63 ( V_90 ) ) ) {
F_19 ( V_30
...
V_119 = F_82 ( V_68 [ V_74 ] . V_82 + V_81 ,
V_37 ) ;
if ( V_119 > V_117 ) {
if ( V_113 > 1 ) {
V_42 = - 1 ;
...
error = F_76 ( & V_60 ) ;
if ( error < V_37 )
return error < 0 ? error : - V_101 ;
V_99 = (struct V_98 * ) F_42 ( V_60 ) ;
error = F_72 ( & V_19 , V_107 ) ;
if ( error )
goto V_11;
if ( ! error )
error = F_73 ( & V_19 , V_99 , NULL ) ;
if ( ! error ) {
error = ( * V_107 & V_95 ) ?
F_75 ( & V_19 , & V_60 , V_99 -> V_100 - 1 ) :
F_81 ( & V_19 , & V_60 , V_99 -> V_100 - 1 ) ;
}
F_74 ( & V_19 ) ;
V_11:
if ( ! error )
