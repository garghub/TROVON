...
V_54 -> V_52 -> V_61 = & V_62 ;
if ( ! V_54 -> V_52 -> V_63 )
V_54 -> V_52 -> V_63 = F_35 ( 32 ) ;
if ( V_60 -> V_64 -> V_65 . V_66 ) {
V_23 = F_30 ( V_3 ,
V_19 ) ;
if ( V_23 )
goto V_40;
}
if ( V_60 -> V_64 -> V_67 . V_66 ) {
V_23 = F_30 ( V_3 ,
V_68 ) ;
if ( V_23 )
goto V_40;
...
static int T_3 F_36 ( struct V_69 * V_70 )
{
return F_37 ( & V_70 -> V_52 , & V_71 ) ;
}
static int T_4 F_38 ( struct V_69 * V_70 )
{
F_39 ( & V_70 -> V_52 ) ;
return 0 ;
}
