...
static inline struct V_1 * F_22 ( struct V_20 * V_21 )
{
...
{
struct V_30 * V_31 = F_26 ( V_27 ) ;
struct V_32 * V_33 = V_31 -> V_33 ;
int V_13 ;
F_27 ( V_33 , V_34 ) ;
F_28 ( V_33 , F_29 ( V_27 ) &
V_34 ) ;
V_13 = F_30 ( V_33 , V_28 , V_29 ) ;
F_31 ( V_27 , F_32 ( V_33 ) &
V_35 ) ;
return V_13 ;
}
static void F_33 ( struct V_36 * V_16 ,
struct V_32 * V_33 ,
int V_13 ,
int (* F_34)( struct V_37 * V_38 ,
struct V_39 * V_40 ,
struct V_39 * V_41 ,
unsigned int V_42 ) )
{
...
V_38 . V_46 = V_16 -> V_46 ;
V_38 . V_47 = V_48 ;
V_13 = F_34 ( & V_38 , V_16 -> V_40 , V_16 -> V_41 , V_16 -> V_49 ) ;
...
struct V_1 * V_2 = F_22 ( F_120 ( V_21 ) ) ;
V_44 -> V_18 = V_16 -> V_50 . V_18 ;
V_16 -> V_50 . V_18 = V_18 ;
return F_10 ( V_2 , & V_16 -> V_50 ) ;
}
...
{
struct V_24 * V_31 = F_24 ( V_23 ) ;
struct V_94 * V_138 = F_24 ( V_23 ) ;
struct V_123 * V_139 = F_24 ( V_23 ) ;
...
{
struct V_30 * V_31 = F_26 ( & V_21 -> V_50 ) ;
return V_31 -> V_33 ;
}
