...
V_81 = - V_176 ;
V_2 = F_95 ( V_130 ) ;
if ( V_2 -> V_97 == V_177 || V_2 -> V_97 == V_178 ) {
...
if ( ( F_99 ( V_64 -> V_96 ) ) || ( F_2 ( V_64 -> V_96 ) ) ) {
...
static int F_107 ( struct V_130 * V_130 , char * V_201 , int V_202 )
{
int V_119 ;
struct V_1 * V_2 ;
struct V_123 * V_124 ;
...
V_119 = F_108 ( V_201 , V_202 ) ;
V_167:
F_57 ( V_116 ) ;
F_58 ( V_116 ) ;
return V_119 ;
}
static void * F_109 ( struct V_130 * V_130 , struct V_140 * V_141 )
{
int V_151 = 0 ;
char * V_204 = F_110 () ;
...
void
F_114 ( struct V_130 * V_130 , struct V_140 * V_141 , void * V_206 )
{
...
static int F_116 ( struct V_64 * V_129 , struct V_130 * V_130 ,
...
static int
F_117 ( struct V_64 * V_129 , struct V_130 * V_130 , const char * V_208 )
{
F_10 ( V_111 , L_27 , V_129 -> V_120 ,
V_130 -> V_136 . V_57 , V_208 ) ;
return F_116 ( V_129 , V_130 , V_23 , V_208 ) ;
}
static int
F_118 ( struct V_130 * V_160 , struct V_64 * V_129 ,
struct V_130 * V_130 )
{
int V_119 ;
char * V_57 ;
...
V_119 = F_116 ( V_129 , V_130 , V_17 , V_57 ) ;
F_111 ( V_57 ) ;
if ( ! V_119 ) {
F_120 ( V_164 , V_160 -> V_134 ) ;
F_68 ( V_129 ) ;
}
V_209:
F_41 ( V_164 ) ;
...
static int
F_121 ( struct V_64 * V_129 , struct V_130 * V_130 , int V_3 , T_1 V_20 )
{
int V_119 ;
char * V_57 ;
F_10 ( V_111 ,
L_29 , V_129 -> V_120 ,
V_130 -> V_136 . V_57 , V_3 , F_122 ( V_20 ) , F_123 ( V_20 ) ) ;
if ( ! F_124 ( V_20 ) )
return - V_95 ;
V_57 = F_110 () ;
if ( ! V_57 )
return - V_113 ;
if ( F_7 ( V_3 ) )
sprintf ( V_57 , L_30 , F_122 ( V_20 ) , F_123 ( V_20 ) ) ;
else if ( F_8 ( V_3 ) )
sprintf ( V_57 , L_31 , F_122 ( V_20 ) , F_123 ( V_20 ) ) ;
else if ( F_6 ( V_3 ) )
* V_57 = 0 ;
else if ( F_5 ( V_3 ) )
* V_57 = 0 ;
...
V_119 = F_116 ( V_129 , V_130 , V_3 , V_57 ) ;
F_111 ( V_57 ) ;
return V_119 ;
}
int F_120 ( struct V_123 * V_124 , struct V_64 * V_64 )
{
int V_115 ;
T_1 V_20 ;
T_7 V_210 ;
