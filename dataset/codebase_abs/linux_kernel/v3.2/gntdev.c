...
static int F_20 ( T_1 * V_30 , T_2 V_31 ,
...
F_21 ( V_34 >= V_6 -> V_9 ) ;
V_40 = F_22 ( V_30 ) . V_41 ;
F_23 ( & V_6 -> V_14 [ V_34 ] , V_40 , V_26 ,
V_6 -> V_13 [ V_34 ] . V_42 ,
V_6 -> V_13 [ V_34 ] . V_43 ) ;
F_24 ( & V_6 -> V_15 [ V_34 ] , V_40 , V_26 ,
- 1 ) ;
return 0 ;
}
...
F_26 ( F_27 ( V_6 -> V_17 [ V_11 ] ) ) ;
F_23 ( & V_6 -> V_14 [ V_11 ] , V_32 , V_6 -> V_26 ,
V_6 -> V_13 [ V_11 ] . V_42 ,
V_6 -> V_13 [ V_11 ] . V_43 ) ;
F_24 ( & V_6 -> V_15 [ V_11 ] , V_32 ,
V_6 -> V_26 , - 1 ) ;
}
} else {
for ( V_11 = 0 ; V_11 < V_6 -> V_9 ; V_11 ++ ) {
...
T_1 * V_46 ;
T_3 V_40 = 0 ;
F_21 ( F_28 ( V_6 -> V_17 [ V_11 ] ) ) ;
V_46 = F_29 ( V_45 , & V_44 ) ;
V_40 = F_22 ( V_46 ) . V_41 ;
F_23 ( & V_6 -> V_16 [ V_11 ] , V_40 ,
V_6 -> V_26 |
V_47 |
V_39 ,
V_6 -> V_13 [ V_11 ] . V_42 ,
...
V_18 = F_30 ( V_6 -> V_14 , V_29 ? V_6 -> V_16 : NULL ,
V_6 -> V_17 , V_6 -> V_9 ) ;
if ( V_18 )
return V_18 ;
for ( V_11 = 0 ; V_11 < V_6 -> V_9 ; V_11 ++ ) {
...
static int F_31 ( struct V_5 * V_6 , int V_50 , int V_17 )
{
int V_11 , V_18 = 0 ;
...
V_18 = F_32 ( V_53 , & V_18 , 1 ) ;
if ( V_18 )
return - V_54 ;
V_6 -> V_25 . V_26 &= ~ V_51 ;
} else if ( V_52 >= V_50 && V_52 < V_50 + V_17 ) {
T_5 * V_53 = F_33 ( V_6 -> V_17 [ V_52 ] ) ;
V_53 [ V_6 -> V_25 . V_32 & ( V_55 - 1 ) ] = 0 ;
F_34 ( V_6 -> V_17 [ V_52 ] ) ;
V_6 -> V_25 . V_26 &= ~ V_51 ;
}
}
V_18 = F_35 ( V_6 -> V_15 + V_50 , V_6 -> V_17 + V_50 , V_17 ) ;
if ( V_18 )
return V_18 ;
...
static int F_18 ( struct V_5 * V_6 , int V_50 , int V_17 )
{
int V_56 , V_18 = 0 ;
...
V_18 = F_31 ( V_6 , V_50 , V_56 ) ;
V_50 += V_56 ;
V_17 -= V_56 ;
}
return V_18 ;
}
static void F_36 ( struct V_57 * V_35 )
{
...
{
struct V_1 * V_2 = F_40 ( V_60 , struct V_1 , V_60 ) ;
struct V_5 * V_6 ;
...
continue;
V_65 = F_42 ( V_63 , V_6 -> V_35 -> V_36 ) ;
V_66 = F_43 ( V_64 , V_6 -> V_35 -> V_68 ) ;
F_3 ( L_11 ,
V_6 -> V_8 , V_6 -> V_9 ,
...
V_6 -> V_8 , V_6 -> V_9 ,
V_6 -> V_35 -> V_36 , V_6 -> V_35 -> V_68 ) ;
V_18 = F_18 ( V_6 , 0 , V_6 -> V_9 ) ;
F_44 ( V_18 ) ;
}
F_45 ( & V_2 -> V_67 ) ;
}
static int F_48 ( struct V_69 * V_69 , struct V_70 * V_71 )
{
struct V_1 * V_2 ;
int V_72 = 0 ;
...
static int F_54 ( struct V_69 * V_69 , struct V_70 * V_71 )
{
...
struct V_5 * V_6 ;
int V_18 ;
if ( F_60 ( & V_80 , V_79 , sizeof( V_80 ) ) != 0 )
return - V_54 ;
...
if ( ! V_6 )
return V_18 ;
if ( F_61 ( F_62 ( V_80 . V_9 , & V_24 ) > V_81 ) ) {
F_3 ( L_15 ) ;
F_14 ( V_6 ) ;
return V_18 ;
}
if ( F_60 ( V_6 -> V_13 , & V_79 -> V_82 ,
...
F_45 ( & V_2 -> V_67 ) ;
if ( F_32 ( V_79 , & V_80 , sizeof( V_80 ) ) != 0 )
return - V_54 ;
return 0 ;
}
...
static long F_66 ( struct V_1 * V_2 , void T_4 * V_79 )
{
struct V_89 V_80 ;
struct V_5 * V_6 ;
int V_90 ;
if ( F_60 ( & V_80 , V_79 , sizeof( V_80 ) ) )
return - V_54 ;
if ( V_80 . V_91 & ~ ( V_51 | V_27 ) )
return - V_49 ;
F_41 ( & V_2 -> V_67 ) ;
F_4 (map, &priv->maps, next) {
T_6 V_92 = V_6 -> V_8 << V_37 ;
T_6 V_64 = ( V_6 -> V_8 + V_6 -> V_9 ) << V_37 ;
if ( V_80 . V_8 >= V_92 && V_80 . V_8 < V_64 )
goto V_93;
}
V_90 = - V_84 ;
goto V_94;
...
V_6 -> V_25 . V_26 = V_80 . V_91 ;
V_6 -> V_25 . V_32 = V_80 . V_8 - ( V_6 -> V_8 << V_37 ) ;
V_6 -> V_25 . V_28 = V_80 . V_96 ;
V_90 = 0 ;
V_94:
F_45 ( & V_2 -> V_67 ) ;
return V_90 ;
}
static long F_67 ( struct V_70 * V_71 ,
...
switch ( V_97 ) {
case V_100 :
return F_59 ( V_2 , V_99 ) ;
case V_101 :
return F_63 ( V_2 , V_99 ) ;
case V_102 :
return F_64 ( V_2 , V_99 ) ;
case V_103 :
return F_66 ( V_2 , V_99 ) ;
default:
F_3 ( L_18 , V_2 , V_97 ) ;
return - V_104 ;
}
...
static int F_68 ( struct V_70 * V_71 , struct V_57 * V_35 )
{
struct V_1 * V_2 = V_71 -> V_77 ;
int V_8 = V_35 -> V_105 ;
...
struct V_5 * V_6 ;
int V_11 , V_18 = - V_49 ;
if ( ( V_35 -> V_106 & V_107 ) && ! ( V_35 -> V_106 & V_108 ) )
return - V_49 ;
F_3 ( L_19 ,
V_8 , V_9 , V_35 -> V_36 , V_35 -> V_105 ) ;
F_41 ( & V_2 -> V_67 ) ;
...
if ( V_29 && V_6 -> V_35 )
goto V_94;
if ( V_29 && V_2 -> V_62 != V_35 -> V_109 ) {
F_69 ( V_110 L_20 ) ;
goto V_94;
}
F_37 ( & V_6 -> V_20 ) ;
V_35 -> V_87 = & V_88 ;
V_35 -> V_106 |= V_111 | V_112 ;
if ( V_29 )
V_35 -> V_106 |= V_113 | V_114 ;
V_35 -> V_58 = V_6 ;
if ( V_29 )
V_6 -> V_35 = V_35 ;
if ( V_6 -> V_26 ) {
...
F_45 ( & V_2 -> V_67 ) ;
if ( V_29 ) {
V_18 = F_70 ( V_35 -> V_109 , V_35 -> V_36 ,
V_35 -> V_68 - V_35 -> V_36 ,
F_20 , V_6 ) ;
if ( V_18 ) {
F_69 ( V_110 L_21 ) ;
...
if ( ! V_29 ) {
for ( V_11 = 0 ; V_11 < V_9 ; V_11 ++ ) {
V_18 = F_71 ( V_35 , V_35 -> V_36 + V_11 * V_55 ,
V_6 -> V_17 [ V_11 ] ) ;
if ( V_18 )
goto V_116;
}
