...
static void F_89 ( struct V_84 * V_175 )
{
F_5 ( F_41 ( V_175 , struct V_176 , V_85 ) ) ;
}
int F_90 ( struct V_177 * V_178 ,
const struct V_52 * V_54 ,
const struct V_26 * V_27 )
{
int V_44 = - V_45 ;
...
T_1 V_174 ;
T_1 V_158 ;
struct V_176 * V_179 , * V_155 = NULL ;
struct V_180 * V_181 ;
struct V_182 * V_183 ;
if ( V_178 == NULL )
return 0 ;
V_174 = V_136 ;
V_140 = F_91 ( V_174 , V_50 ) ;
if ( V_140 == NULL ) {
V_44 = - V_21 ;
goto V_184;
}
...
memcpy ( V_155 -> V_155 . V_185 , V_140 , V_174 ) ;
V_155 -> V_155 . V_186 = V_158 ;
V_155 -> V_155 . V_81 = sizeof( struct V_187 ) ;
F_5 ( V_140 ) ;
V_140 = NULL ;
V_181 = F_92 ( V_178 ) ;
V_179 = F_93 ( V_181 -> V_188 , F_94 ( V_178 ) ) ;
if ( V_181 -> V_189 ) {
V_183 = F_95 ( V_178 ) ;
if ( V_179 )
V_183 -> V_190 -= V_179 -> V_155 . V_186 ;
V_183 -> V_190 += V_155 -> V_155 . V_186 ;
V_183 -> V_191 ( V_178 , V_183 -> V_192 ) ;
}
F_96 ( V_181 -> V_188 , V_155 ) ;
if ( V_179 )
F_45 ( & V_179 -> V_85 , F_89 ) ;
return 0 ;
V_184:
F_5 ( V_140 ) ;
F_5 ( V_155 ) ;
...
V_140 = NULL ;
V_196 = F_98 ( V_194 ) ;
V_155 = F_99 ( & V_196 -> V_155 , V_155 ) ;
if ( V_155 )
F_45 ( & V_155 -> V_85 , F_89 ) ;
return 0 ;
V_197:
F_5 ( V_140 ) ;
F_5 ( V_155 ) ;
...
static int F_100 ( struct V_176 * * V_198 )
{
int V_199 = 0 ;
struct V_176 * V_155 = * V_198 ;
if ( V_155 -> V_155 . V_200 || V_155 -> V_155 . V_201 || V_155 -> V_155 . V_202 || V_155 -> V_155 . V_203 ) {
T_2 V_204 ;
T_2 V_205 ;
unsigned char * V_47 ;
int V_16 ;
int V_206 ;
V_205 = V_155 -> V_155 . V_81 - sizeof( struct V_187 ) ;
V_47 = & V_155 -> V_155 . V_185 [ V_205 ] ;
V_204 = V_47 [ 1 ] ;
if ( V_155 -> V_155 . V_200 > V_155 -> V_155 . V_81 )
V_155 -> V_155 . V_200 -= V_204 ;
if ( V_155 -> V_155 . V_201 > V_155 -> V_155 . V_81 )
V_155 -> V_155 . V_201 -= V_204 ;
if ( V_155 -> V_155 . V_202 > V_155 -> V_155 . V_81 )
V_155 -> V_155 . V_202 -= V_204 ;
if ( V_155 -> V_155 . V_203 > V_155 -> V_155 . V_81 )
V_155 -> V_155 . V_203 -= V_204 ;
V_155 -> V_155 . V_81 = 0 ;
memmove ( V_47 , V_47 + V_204 ,
V_155 -> V_155 . V_186 - V_205 - V_204 ) ;
V_16 = 0 ;
V_206 = 0 ;
while ( V_16 < V_155 -> V_155 . V_186 )
if ( V_155 -> V_155 . V_185 [ V_16 ] != V_207 ) {
V_16 += V_155 -> V_155 . V_185 [ V_16 + 1 ] ;
V_206 = V_16 ;
} else
V_16 ++ ;
V_199 = V_155 -> V_155 . V_186 ;
V_155 -> V_155 . V_186 = ( V_206 + 3 ) & ~ 3 ;
V_199 -= V_155 -> V_155 . V_186 ;
} else {
* V_198 = NULL ;
V_199 = V_155 -> V_155 . V_186 ;
...
void F_101 ( struct V_177 * V_178 )
{
int V_199 ;
struct V_176 * V_155 ;
struct V_180 * V_181 ;
V_181 = F_92 ( V_178 ) ;
V_155 = F_93 ( V_181 -> V_188 , 1 ) ;
if ( V_155 == NULL || V_155 -> V_155 . V_81 == 0 )
return;
V_199 = F_100 ( & V_181 -> V_188 ) ;
if ( V_181 -> V_189 && V_199 > 0 ) {
struct V_182 * V_183 = F_95 ( V_178 ) ;
V_183 -> V_190 -= V_199 ;
V_183 -> V_191 ( V_178 , V_183 -> V_192 ) ;
}
}
void F_102 ( struct V_193 * V_194 )
{
struct V_176 * V_155 ;
struct V_195 * V_196 ;
V_196 = F_98 ( V_194 ) ;
...
int F_104 ( struct V_177 * V_178 , struct V_26 * V_27 )
{
struct V_176 * V_155 ;
int V_210 = - V_208 ;
F_47 () ;
V_155 = F_105 ( F_92 ( V_178 ) -> V_188 ) ;
if ( V_155 && V_155 -> V_155 . V_81 )
V_210 = F_103 ( V_155 -> V_155 . V_185 +
V_155 -> V_155 . V_81 -
sizeof( struct V_187 ) ,
V_27 ) ;
F_49 () ;
...
int V_44 ;
struct V_187 * V_211 ;
struct V_212 * V_155 = & F_107 ( V_43 ) -> V_155 ;
...
V_174 = V_44 ;
V_158 = ( V_174 + 3 ) & ~ 3 ;
V_213 = V_158 - V_155 -> V_186 ;
V_44 = F_108 ( V_43 , F_109 ( V_43 ) + V_213 ) ;
if ( V_44 < 0 )
return V_44 ;
if ( V_213 > 0 ) {
V_211 = F_86 ( V_43 ) ;
F_110 ( V_43 , V_213 ) ;
memmove ( ( char * ) V_211 - V_213 , V_211 , V_211 -> V_214 << 2 ) ;
F_111 ( V_43 ) ;
V_211 = F_86 ( V_43 ) ;
} else if ( V_213 < 0 ) {
V_211 = F_86 ( V_43 ) ;
memset ( V_211 + 1 , V_207 , V_155 -> V_186 ) ;
} else
V_211 = F_86 ( V_43 ) ;
if ( V_155 -> V_186 > 0 )
memset ( V_155 , 0 , sizeof( * V_155 ) ) ;
V_155 -> V_186 = V_158 ;
V_155 -> V_81 = sizeof( struct V_187 ) ;
V_155 -> V_215 = 1 ;
memcpy ( V_211 + 1 , V_140 , V_174 ) ;
if ( V_158 > V_174 )
memset ( ( char * ) ( V_211 + 1 ) + V_174 , 0 , V_158 - V_174 ) ;
if ( V_213 != 0 ) {
V_211 -> V_214 = 5 + ( V_158 >> 2 ) ;
V_211 -> V_216 = F_64 ( V_43 -> V_141 ) ;
}
F_112 ( V_211 ) ;
return 0 ;
}
...
return V_44 ;
V_211 = F_86 ( V_43 ) ;
V_47 = ( unsigned char * ) V_211 + V_155 -> V_81 ;
memset ( V_47 , V_217 , V_47 [ 1 ] ) ;
V_155 -> V_81 = 0 ;
V_155 -> V_215 = 1 ;
F_112 ( V_211 ) ;
return 0 ;
