...
static void F_34 ( struct V_2 * V_8 ,
T_4 V_46 )
{
T_1 V_47 ;
if ( ! ( V_8 -> V_28 & V_48 ) )
...
void F_42 ( unsigned long V_38 , void * V_56 )
{
struct V_2 * V_8 , * V_57 ;
unsigned long V_34 ;
int V_58 ;
...
switch ( V_38 ) {
case V_59 :
F_43 (dev, tmp, &clockevents_released, list)
F_27 ( & V_8 -> V_41 ) ;
V_58 = * ( ( int * ) V_56 ) ;
F_43 (dev, tmp, &clockevent_devices, list) {
if ( F_44 ( V_58 , V_8 -> V_45 ) &&
F_45 ( V_8 -> V_45 ) == 1 &&
! F_46 ( V_8 ) ) {
F_30 ( V_8 -> V_10 != V_44 ) ;
F_27 ( & V_8 -> V_41 ) ;
