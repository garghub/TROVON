...
{
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_108 * V_109 = & V_5 -> V_30 ;
struct V_23 * V_24 ;
int V_7 ;
T_1 V_26 , V_25 = V_107 -> V_110 ;
V_5 -> V_19 = V_22 ;
if ( V_2 -> V_111 . V_112 . type == V_113 ) {
switch ( V_107 -> V_114 . V_115 . V_116 ) {
case V_117 :
case V_118 :
V_24 = & V_109 -> V_119 ;
break;
...
#endif
V_26 = 6000000 ;
} else if ( V_2 -> V_111 . V_112 . type == V_123 ) {
switch ( V_107 -> V_114 . V_124 . V_125 ) {
case V_126 :
V_26 = 6000000 ;
V_24 = & V_109 -> V_127 ;
break;
...
} else if ( V_2 -> V_111 . V_112 . type == V_132 ) {
V_24 = & V_109 -> V_133 ;
V_26 = 8000000 ;
} else {
F_51 ( L_18 ) ;
...
if ( V_2 -> V_111 . V_134 . V_3 )
V_2 -> V_111 . V_134 . V_3 ( V_2 ) ;
V_7 = F_50 ( V_2 , V_24 , V_25 , V_26 ) ;
if ( F_3 ( V_7 ) )
goto V_11;
V_5 -> V_110 = V_25 ;
V_5 -> V_125 = ( V_2 -> V_111 . V_112 . type == V_123 ) ?
V_107 -> V_114 . V_124 . V_125 : 0 ;
V_11:
return V_7 ;
}
...
char * V_19 ;
int V_7 ;
T_1 V_25 = V_107 -> V_110 * 125 *
( ( V_107 -> V_19 == V_136 ) ? 1 : 1000 ) / 2 ;
V_5 -> V_19 = V_20 ;
if ( V_107 -> V_19 == V_136 ) {
V_24 = & V_109 -> V_137 ;
V_19 = L_19 ;
} else if ( V_107 -> V_30 & V_138 ) {
V_24 = & V_109 -> V_139 ;
V_19 = L_20 ;
} else if ( V_107 -> V_30 & V_140 ) {
V_24 = & V_109 -> V_141 ;
V_19 = L_21 ;
} else if ( V_107 -> V_30 & V_142 ) {
V_24 = & V_109 -> V_143 ;
V_19 = L_22 ;
} else if ( V_107 -> V_30 & V_144 ) {
V_24 = & V_109 -> V_145 ;
V_19 = L_23 ;
} else if ( V_107 -> V_30 & V_146 ) {
V_24 = & V_109 -> V_147 ;
V_19 = L_24 ;
} else if ( V_107 -> V_30 & V_148 ) {
V_24 = & V_109 -> V_149 ;
V_19 = L_25 ;
} else if ( V_107 -> V_30 & V_150 ) {
V_24 = & V_109 -> V_151 ;
V_19 = L_26 ;
} else {
V_24 = & V_109 -> V_145 ;
...
static int F_56 ( struct V_1 * V_2 , T_1 * V_110 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
* V_110 = V_5 -> V_110 ;
return 0 ;
}
static int F_57 ( struct V_1 * V_2 , T_1 * V_125 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
* V_125 = V_5 -> V_125 ;
return 0 ;
...
default:
F_39 ( L_51 ,
V_17 [ V_154 ] , F_63 ( V_5 -> V_99 . V_100 ) ,
V_5 -> V_99 . V_155 ) ;
return - V_104 ;
}
F_39 ( L_52 , V_153 ,
F_63 ( V_5 -> V_99 . V_100 ) , V_5 -> V_99 . V_155 ) ;
return 0 ;
}
...
{
struct V_4 * V_5 = V_2 -> V_6 ;
V_5 -> V_158 = ( V_157 ) ? V_157 -> V_158 : V_159 ;
V_5 -> V_13 = ( V_157 ) ? V_157 -> V_13 : V_40 ;
V_5 -> V_95 = ( V_157 ) ? V_157 -> V_95 : 0 ;
V_5 -> V_160 = ( V_157 ) ?
V_157 -> V_160 : V_161 ;
V_5 -> V_8 = ( V_157 ) ?
V_157 -> V_8 : V_162 ;
...
static inline int F_65 ( struct V_156 * V_157 )
{
return ( ( V_163 == - 1 ) ?
( ( V_157 ) && ( V_157 -> V_164 ) ) :
( V_163 ) ) ? 1 : 0 ;
}
static int F_66 ( struct V_1 * V_2 , void * V_165 )
{
struct V_156 * V_157 = (struct V_156 * ) V_165 ;
F_64 ( V_2 , V_157 ) ;
if ( F_65 ( V_157 ) )
F_44 ( V_2 ) ;
if ( ( V_157 ) && ( V_157 -> V_109 ) )
F_60 ( V_2 , V_157 -> V_109 ) ;
return 0 ;
}
struct V_1 * F_67 ( struct V_1 * V_2 , T_2 V_155 ,
struct V_166 * V_167 ,
struct V_156 * V_157 )
{
struct V_4 * V_5 = NULL ;
...
V_2 -> V_6 = V_5 ;
if ( V_157 ) {
if ( V_157 -> V_158 != V_170 )
V_5 -> V_158 = V_157 -> V_158 ;
if ( V_157 -> V_13 )
V_5 -> V_13 = V_157 -> V_13 ;
if ( V_157 -> V_95 )
V_5 -> V_95 = V_157 -> V_95 ;
if ( V_157 -> V_160 )
V_5 -> V_160 = V_157 -> V_160 ;
if ( V_157 -> V_8 )
V_5 -> V_8 = V_157 -> V_8 ;
if ( V_157 -> V_109 )
F_60 ( V_2 , V_157 -> V_109 ) ;
