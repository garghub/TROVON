...
struct V_41 * F_65 (
char * type , void * V_99 , const struct V_100 * V_20 )
{
struct V_41 * V_42 ;
struct V_16 * V_87 ;
int V_25 ;
...
int V_48 , int V_49 , int V_47 , int V_115 )
{
struct V_16 * V_17 ;
struct V_41 * V_87 ;
enum V_32 V_111 ;
...
int F_83 ( T_3 V_124 , enum V_125 V_126 )
{
struct V_127 * V_128 ;
struct V_129 * V_14 ;
struct V_130 * V_131 ;
...
int V_133 ;
int V_25 ;
V_133 = F_84 ( sizeof( struct V_130 ) ) + \
F_84 ( 0 ) ;
V_128 = F_85 ( V_133 , V_134 ) ;
if ( ! V_128 )
return - V_8 ;
V_132 = F_86 ( V_128 , 0 , V_135 ++ ,
& V_136 , 0 ,
V_137 ) ;
if ( ! V_132 ) {
F_87 ( V_128 ) ;
...
V_131 -> V_124 = V_124 ;
V_131 -> V_126 = V_126 ;
V_25 = F_90 ( V_128 , V_132 ) ;
if ( V_25 < 0 ) {
F_87 ( V_128 ) ;
return V_25 ;
}
V_25 = F_91 ( V_128 , 0 , V_139 . V_4 , V_134 ) ;
if ( V_25 )
F_72 ( V_140 L_26 , V_25 ) ;
return V_25 ;
}
