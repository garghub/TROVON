...
{
struct V_26 * V_4 ;
const unsigned int V_85 = 0x4b189680 ;
F_44 ( V_86 ) ; F_44 ( V_87 ) ; F_44 ( V_88 ) ;
V_89 ;
unsigned int V_35 ;
V_4 = ( void * ) F_12 ( V_58 ) ;
if ( ! V_4 )
...
F_45 ( V_86 , & V_85 ) ;
if ( ( V_4 -> V_35 >> 23 ) == 0 )
F_46 ( V_87 , ( long ) V_4 -> V_35 , 64 , long ) ;
else
F_45 ( V_87 , & V_4 -> V_35 ) ;
F_47 ( V_88 , V_86 , V_87 ) ;
F_48 ( V_35 , V_88 , 32 , 0 ) ;
