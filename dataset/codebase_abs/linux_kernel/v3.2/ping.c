...
static int F_44 ( void * V_126 , char * V_127 ,
...
F_16 () ;
if ( F_45 ( V_127 + sizeof( struct V_94 ) ,
...
static int F_46 ( struct V_10 * V_11 , struct V_131 * V_132 ,
struct V_136 * V_137 )
{
struct V_89 * V_90 = F_47 ( & V_11 -> V_138 ) ;
V_132 -> V_134 = F_48 ( ( char * ) & V_132 -> V_95 ,
sizeof( struct V_94 ) , V_132 -> V_134 ) ;
V_132 -> V_95 . V_139 = F_49 ( V_132 -> V_134 ) ;
memcpy ( F_50 ( V_90 ) , & V_132 -> V_95 , sizeof( struct V_94 ) ) ;
V_90 -> V_140 = V_141 ;
return F_51 ( V_11 , V_137 ) ;
}
static int F_52 ( struct V_142 * V_143 , struct V_10 * V_11 , struct V_144 * V_145 ,
T_4 V_146 )
{
struct V_1 * V_1 = F_8 ( V_11 ) ;
struct V_136 V_137 ;
...
return - V_159 ;
if ( F_53 ( ( V_123 * ) & V_150 , V_145 -> V_160 ,
sizeof( struct V_94 ) ) )
return - V_135 ;
if ( ! F_40 ( V_150 . type , V_150 . V_87 ) )
return - V_67 ;
if ( V_145 -> V_161 ) {
...
V_149 . V_169 = 0 ;
V_66 = F_54 ( V_11 , & V_149 . V_169 ) ;
if ( V_66 )
return V_66 ;
if ( V_145 -> V_170 ) {
V_66 = F_55 ( F_8 ( V_11 ) , V_145 , & V_149 ) ;
if ( V_66 )
return V_66 ;
if ( V_149 . V_167 )
free = 1 ;
...
F_62 ( & V_137 , V_149 . V_168 , V_11 -> V_181 , V_156 ,
V_182 , V_11 -> V_183 ,
F_63 ( V_11 ) , V_155 , V_31 , 0 , 0 ) ;
F_64 ( V_11 , F_65 ( & V_137 ) ) ;
V_152 = F_66 ( V_1 , & V_137 , V_11 ) ;
if ( F_67 ( V_152 ) ) {
V_66 = F_68 ( V_152 ) ;
V_152 = NULL ;
if ( V_66 == - V_184 )
...
V_132 . V_134 = 0 ;
V_66 = F_70 ( V_11 , & V_137 , F_44 , & V_132 , V_146 ,
0 , & V_149 , & V_152 , V_145 -> V_157 ) ;
if ( V_66 )
F_71 ( V_11 ) ;
else
V_66 = F_46 ( V_11 , & V_132 , & V_137 ) ;
F_39 ( V_11 ) ;
V_79:
F_72 ( V_152 ) ;
if ( free )
...
static int F_76 ( struct V_142 * V_143 , struct V_10 * V_11 , struct V_144 * V_145 ,
T_4 V_146 , int V_194 , int V_195 , int * V_61 )
{
struct V_16 * V_17 = F_6 ( V_11 ) ;
...
* V_61 = sizeof( * sin ) ;
if ( V_195 & V_197 )
return F_77 ( V_11 , V_145 , V_146 ) ;
V_90 = F_78 ( V_11 , V_195 , V_194 , & V_66 ) ;
if ( ! V_90 )
goto V_79;
V_196 = V_90 -> V_146 ;
if ( V_196 > V_146 ) {
...
V_66 = F_79 ( V_90 , 0 , V_145 -> V_160 , V_196 ) ;
if ( V_66 )
goto V_199;
F_80 ( V_145 , V_11 , V_90 ) ;
if ( sin ) {
sin -> V_164 = V_165 ;
sin -> V_70 = 0 ;
sin -> V_68 . V_69 = F_81 ( V_90 ) -> V_31 ;
...
static int F_84 ( struct V_10 * V_11 , struct V_89 * V_90 )
{
F_3 ( L_20 ,
...
struct V_10 * V_11 ;
struct V_1 * V_1 = F_42 ( V_90 -> V_97 ) ;
struct V_92 * V_93 = F_81 ( V_90 ) ;
struct V_94 * V_95 = F_50 ( V_90 ) ;
T_1 V_31 = V_93 -> V_31 ;
T_1 V_32 = V_93 -> V_32 ;
F_3 ( L_22 ,
V_90 , F_34 ( V_95 -> V_99 . V_100 . V_101 ) , F_34 ( V_95 -> V_99 . V_100 . V_102 ) ) ;
F_88 ( V_90 , V_90 -> V_40 - ( V_123 * ) V_95 ) ;
...
static struct V_10 * F_90 ( struct V_202 * V_43 , int V_203 )
{
struct V_10 * V_11 ;
struct V_204 * V_205 = V_43 -> V_206 ;
struct V_1 * V_1 = F_91 ( V_43 ) ;
...
static struct V_10 * F_95 ( struct V_202 * V_43 , struct V_10 * V_11 )
{
struct V_204 * V_205 = V_43 -> V_206 ;
struct V_1 * V_1 = F_91 ( V_43 ) ;
do {
V_11 = F_96 ( V_11 ) ;
} while ( V_11 && ( ! F_94 ( F_8 ( V_11 ) , V_1 ) ) );
if ( ! V_11 )
return F_90 ( V_43 , V_205 -> V_207 + 1 ) ;
return V_11 ;
}
static struct V_10 * F_97 ( struct V_202 * V_43 , T_5 V_210 )
{
struct V_10 * V_11 = F_90 ( V_43 , 0 ) ;
if ( V_11 )
while ( V_210 && ( V_11 = F_95 ( V_43 , V_11 ) ) != NULL )
-- V_210 ;
return V_210 ? NULL : V_11 ;
}
static void * F_98 ( struct V_202 * V_43 , T_5 * V_210 )
{
struct V_204 * V_205 = V_43 -> V_206 ;
V_205 -> V_207 = 0 ;
F_22 ( & V_6 . V_20 ) ;
return * V_210 ? F_97 ( V_43 , * V_210 - 1 ) : V_211 ;
}
static void * F_99 ( struct V_202 * V_43 , void * V_212 , T_5 * V_210 )
{
struct V_10 * V_11 ;
if ( V_212 == V_211 )
V_11 = F_97 ( V_43 , 0 ) ;
else
V_11 = F_95 ( V_43 , V_212 ) ;
++ * V_210 ;
return V_11 ;
}
static void F_100 ( struct V_202 * V_43 , void * V_212 )
{
F_23 ( & V_6 . V_20 ) ;
}
static void F_101 ( struct V_10 * V_213 , struct V_202 * V_214 ,
int V_207 , int * V_146 )
{
struct V_16 * V_147 = F_6 ( V_213 ) ;
T_6 V_215 = V_147 -> V_85 ;
T_6 V_216 = V_147 -> V_36 ;
...
F_103 ( V_213 ) ,
F_104 ( V_213 ) ,
0 , 0L , 0 , F_105 ( V_213 ) , 0 , F_106 ( V_213 ) ,
F_107 ( & V_213 -> V_57 ) , V_213 ,
F_107 ( & V_213 -> V_219 ) , V_146 ) ;
}
static int F_108 ( struct V_202 * V_43 , void * V_212 )
{
if ( V_212 == V_211 )
F_102 ( V_43 , L_26 ,
L_27
...
struct V_204 * V_205 = V_43 -> V_206 ;
int V_146 ;
F_101 ( V_212 , V_43 , V_205 -> V_207 , & V_146 ) ;
F_102 ( V_43 , L_30 , 127 - V_146 , L_31 ) ;
}
return 0 ;
}
static int F_109 ( struct V_220 * V_220 , struct V_221 * V_221 )
{
return F_110 ( V_220 , V_221 , & V_222 ,
sizeof( struct V_204 ) ) ;
}
...
struct V_223 * V_224 ;
int V_225 = 0 ;
V_224 = F_112 ( V_1 , L_32 , V_226 , & V_227 ) ;
if ( ! V_224 )
V_225 = - V_228 ;
return V_225 ;
}
...
static int T_8 F_115 ( struct V_1 * V_1 )
{
return F_111 ( V_1 ) ;
}
static void T_9 F_116 ( struct V_1 * V_1 )
{
F_113 ( V_1 ) ;
}
int T_10 F_117 ( void )
...
void T_10 F_121 ( void )
{
int V_21 ;
for ( V_21 = 0 ; V_21 < V_208 ; V_21 ++ )
F_122 ( & V_6 . V_8 [ V_21 ] , V_21 ) ;
F_123 ( & V_6 . V_20 ) ;
}
