...
V_111 = F_84 ( V_111 , 800u , 3u * 8000u ) ;
V_7 -> V_113 = V_111 ;
...
case V_135 :
if ( V_39 == V_58 )
* V_23 = F_86 ( V_7 -> V_19 -> V_136 ( V_7 , V_127 ) ) ;
else if ( V_39 == V_55 )
V_7 -> V_19 -> V_137 ( V_7 , V_127 , F_87 ( * V_23 ) ) ;
else
V_8 = V_38 ;
break;
case V_138 :
