...
return V_3 ;
case V_149 :
if ( F_50 ( ( void V_150 * ) V_140 , & V_151 ,
sizeof( struct V_152 ) ) )
return - V_153 ;
return 0 ;
}
...
static int F_51 ( struct V_137 * V_138 , T_3 V_139 ,
unsigned int V_80 , unsigned long V_140 )
{
int V_155 ;
F_52 ( & V_156 ) ;
V_155 = F_48 ( V_138 , V_139 , V_80 , V_140 ) ;
F_53 ( & V_156 ) ;
return V_155 ;
}
static int F_54 ( struct V_137 * V_138 , T_3 V_139 )
{
struct V_1 * V_2 = V_138 -> V_141 -> V_142 ;
struct V_10 T_1 * V_11 = V_2 -> V_10 ;
int V_67 , V_3 = 0 ;
...
int V_155 ;
F_52 ( & V_156 ) ;
V_155 = F_54 ( V_138 , V_139 ) ;
F_53 ( & V_156 ) ;
return V_155 ;
}
static int F_57 ( struct V_170 * V_171 , T_3 V_139 )
{
...
static unsigned int F_58 ( struct V_170 * V_171 ,
unsigned int V_172 )
{
struct V_1 * V_2 = V_171 -> V_142 ;
...
static void F_61 ( struct V_175 * V_33 , int V_176 )
{
...
static int F_63 ( struct V_175 * V_33 , int V_31 )
{
...
F_68 ( & V_33 -> V_179 . V_180 , V_2 ) ;
if ( V_33 -> V_34 == NULL )
F_69 ( V_183 , V_178 , 0 , 1 ) ;
V_2 -> V_25 = V_26 ;
V_2 -> V_10 = (struct V_10 T_1 * )
F_70 ( F_71 ( V_33 , 0 ) , 0x200 ) ;
if ( V_2 -> V_10 == NULL ) {
F_34 ( L_5 , L_42 ) ;
V_8 = - V_184 ;
goto V_185;
...
V_2 -> V_186 = F_73 ( V_33 , 0 ) ;
V_2 -> V_187 = F_73 ( V_33 , 1 ) ;
V_2 -> V_72 = - 1 ;
V_2 -> V_125 = - 1 ;
V_2 -> V_44 = 36 ;
V_2 -> V_46 = 18 ;
...
static int T_4 F_79 ( struct V_175 * V_33 , const struct V_190 * V_191 )
{
struct V_170 * V_171 ;
int V_31 , V_8 ;
V_31 = V_192 ++ ;
...
if ( V_8 )
return V_8 ;
V_171 = V_30 [ V_31 ] = F_80 ( 1 ) ;
if ( V_171 == NULL )
return - V_184 ;
V_171 -> V_32 = F_81 ( F_18 , & V_116 ) ;
if ( V_171 -> V_32 == NULL ) {
F_82 ( V_171 ) ;
return - V_184 ;
}
