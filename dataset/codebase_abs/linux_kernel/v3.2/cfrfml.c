...
static int F_21 ( struct V_5 * V_6 , struct V_25 * V_27 )
{
F_13 ( F_18 ( V_27 ) < V_6 -> V_21 ) ;
F_22 ( V_27 ) -> V_8 = V_6 -> V_14 . V_2 . V_40 ;
F_22 ( V_27 ) -> V_41 = V_20 ;
F_22 ( V_27 ) -> V_9 = & V_6 -> V_14 . V_9 ;
return V_6 -> V_14 . V_2 . V_42 -> V_18 ( V_6 -> V_14 . V_2 . V_42 , V_27 ) ;
}
...
F_13 ( V_33 -> V_42 != NULL ) ;
F_13 ( V_33 -> V_42 -> V_18 != NULL ) ;
if ( ! F_23 ( & V_6 -> V_14 , & V_28 ) )
return V_28 ;
V_28 = - V_30 ;
if ( F_18 ( V_27 ) <= V_20 - 1 )
goto V_36;
...
V_28 = F_15 ( V_27 , V_44 , 6 ) ;
if ( V_28 < 0 )
goto V_36;
while ( F_18 ( V_46 ) > V_6 -> V_21 + V_20 ) {
V_43 = 1 ;
V_28 = - V_30 ;
if ( F_24 ( V_46 , & V_43 , 1 ) < 0 )
goto V_36;
V_45 = F_25 ( V_46 , V_6 -> V_21 ) ;
if ( V_45 == NULL )
goto V_36;
V_28 = F_21 ( V_6 , V_46 ) ;
if ( V_28 != 0 )
