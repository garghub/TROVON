...
struct V_1 * F_41 ( int V_65 )
{
struct V_1 * V_2 ;
V_2 = F_42 ( sizeof( * V_2 ) , V_66 ) ;
if ( V_2 == NULL ) {
F_23 ( L_4 ) ;
return NULL ;
}
...
struct V_1 * V_2 , char * V_70 )
{
if ( V_2 == NULL )
return;
F_51 ( V_69 , L_5 , V_70 , V_2 -> V_3 ) ;
F_51 ( V_69 , L_6 , V_70 , F_2 ( & V_2 -> V_4 ) ) ;
F_51 ( V_69 , L_7 , V_70 , V_2 -> V_52 ) ;
F_51 ( V_69 , L_8 , V_70 , V_2 -> V_53 ) ;
F_51 ( V_69 , L_9 , V_70 , V_2 -> V_54 ) ;
}
