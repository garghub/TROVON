...
V_26:
V_4 = V_12 -> V_35 [ 0 ] . V_23 ;
if ( V_13 < V_4 )
V_20 += V_14 ( V_2 , ( char * ) V_12 -> V_35 [ 0 ] . V_24 + V_13 , V_4 - V_13 ) ;
V_25:
return V_20 ;
}
int F_12 ( struct V_11 * V_12 , struct V_36 * V_6 )
{
struct V_1 V_2 ;
V_2 . V_6 = V_6 ;
V_2 . V_7 = sizeof( struct V_37 ) ;
V_2 . V_5 = V_6 -> V_4 - V_2 . V_7 ;
if ( F_13 ( V_6 ) )
goto V_38;
V_2 . V_10 = F_14 ( V_6 -> V_39 , V_2 . V_7 , V_6 -> V_10 ) ;
