...
if ( V_33 < 0 )
return V_33 ;
snprintf ( V_8 -> V_40 -> V_68 , sizeof( V_8 -> V_40 -> V_68 ) ,
L_14 , V_2 -> V_47 . V_48 ) ;
V_33 = F_12 ( V_8 ) ;
if ( V_33 )
return V_33 ;
V_8 -> V_17 -> V_69 . V_70 = V_71 ;
return V_33 ;
}
...
{
F_27 ( V_8 , F_28 ( V_88 ) ) ;
memset ( V_8 -> V_17 -> V_34 , 0 , F_28 ( V_88 ) ) ;
return 0 ;
}
...
static void F_31 ( struct V_89 * V_40 )
{
F_8 ( L_21 ) ;
F_32 ( V_40 ) ;
}
int F_33 ( struct V_90 * V_91 )
{
...
int V_105 ;
F_8 ( L_24 ) ;
V_105 = F_37 ( & V_104 -> V_106 , & V_107 ) ;
if ( V_105 ) {
F_13 ( L_25 ) ;
return V_105 ;
}
V_105 = F_38 ( & V_104 -> V_106 ,
V_108 , F_39 ( V_108 ) ) ;
if ( V_105 ) {
F_13 ( L_26 ) ;
F_40 ( & V_104 -> V_106 ) ;
