...
static T_5 F_128 ( struct V_19 * V_20 , T_5 V_21 )
{
struct V_11 * V_12 = F_11 ( V_20 ) ;
int V_200 ;
if ( V_21 & V_22 ) {
...
static int F_130 ( struct V_19 * V_20 , T_5 V_21 )
{
...
static struct V_19 * T_6 F_132 ( struct V_205 * V_20 )
{
int V_14 , V_114 ;
struct V_19 * V_60 ;
struct V_11 * V_12 ;
V_60 = F_133 ( sizeof( struct V_11 ) ) ;
if ( ! V_60 ) {
F_53 ( V_129 L_22 ,
V_194 ) ;
return F_134 ( - V_206 ) ;
...
V_12 -> V_47 . V_209 = F_10 ;
V_114 = - V_206 ;
V_12 -> V_87 = F_137 ( struct V_86 ) ;
if ( V_12 -> V_87 == NULL )
goto exit;
V_12 -> V_75 = 0 ;
for ( V_14 = 0 ; V_14 < V_183 ; V_14 ++ ) {
...
V_60 -> V_212 = & V_213 ;
F_139 ( V_60 , & V_12 -> V_24 , F_97 , 64 ) ;
V_60 -> V_21 = V_214 | V_215 |
V_216 ;
V_60 -> V_217 = V_214 | V_22 | V_204 ;
V_60 -> V_21 |= V_60 -> V_217 ;
F_140 ( V_60 , & V_218 ) ;
F_141 ( V_60 , & V_20 -> V_20 ) ;
V_12 -> V_60 = V_60 ;
F_142 ( V_60 ) ;
return V_60 ;
V_211:
...
static int T_6 F_145 ( struct V_205 * V_20 ,
const struct V_219 * V_3 )
{
int V_114 ;
struct V_19 * V_60 ;
struct V_11 * V_220 ;
...
if ( F_146 ( V_60 ) ) {
V_114 = F_147 ( V_60 ) ;
F_148 ( V_20 , V_114 , L_25 ) ;
return V_114 ;
}
V_220 = F_11 ( V_60 ) ;
F_149 ( & V_20 -> V_20 , V_220 ) ;
V_114 = F_150 ( V_220 -> V_60 ) ;
if ( V_114 ) {
F_53 ( V_129 L_26 ,
V_194 , V_114 ) ;
goto V_221;
}
V_114 = F_151 ( V_220 -> V_60 ) ;
if ( V_114 ) {
F_152 ( V_220 -> V_60 ) ;
F_53 ( V_129 L_27 ,
V_194 , V_114 ) ;
...
V_221:
F_144 ( V_60 ) ;
F_149 ( & V_20 -> V_20 , NULL ) ;
return V_114 ;
}
static void F_153 ( int V_16 , void * V_30 )
{
if ( V_16 != V_18 )
F_154 ( V_16 , 0 , ( unsigned long ) V_30 ) ;
}
static void F_155 ( struct V_11 * V_220 )
{
F_45 ( & V_220 -> V_62 ) ;
F_69 ( & V_220 -> V_91 ) ;
F_142 ( V_220 -> V_60 ) ;
...
F_47 ( & V_220 -> V_62 ) ;
if ( V_220 -> V_60 -> V_61 )
F_156 ( V_220 -> V_60 -> V_61 , V_220 -> V_60 ) ;
V_220 -> V_222 = V_220 -> V_60 -> V_61 = 0 ;
F_153 ( V_220 -> V_223 , V_220 -> V_25 . V_51 ) ;
F_153 ( V_220 -> V_224 , V_220 -> V_34 . V_51 ) ;
V_220 -> V_223 = V_18 ;
V_220 -> V_224 = V_18 ;
V_220 -> V_25 . V_51 = NULL ;
V_220 -> V_34 . V_51 = NULL ;
}
static int F_157 ( struct V_205 * V_20 )
{
struct V_11 * V_220 = F_158 ( & V_20 -> V_20 ) ;
F_159 ( & V_20 -> V_20 , L_28 , V_20 -> V_225 ) ;
F_155 ( V_220 ) ;
return 0 ;
}
static int F_160 ( struct V_205 * V_20 , T_7 V_226 [] )
{
char * V_227 , * V_228 , * V_229 ;
int V_14 ;
V_229 = V_227 = F_161 ( V_202 , V_20 -> V_225 , L_29 , NULL ) ;
if ( F_146 ( V_229 ) )
return F_147 ( V_229 ) ;
for ( V_14 = 0 ; V_14 < V_230 ; V_14 ++ ) {
V_226 [ V_14 ] = F_162 ( V_227 , & V_228 , 16 ) ;
if ( ( V_227 == V_228 ) || ( * V_228 != ( ( V_14 == V_230 - 1 ) ? '\0' : ':' ) ) ) {
F_163 ( V_229 ) ;
return - V_127 ;
}
V_227 = V_228 + 1 ;
...
static T_8 F_164 ( int V_61 , void * V_231 )
{
struct V_19 * V_20 = V_231 ;
struct V_11 * V_12 = F_11 ( V_20 ) ;
unsigned long V_82 ;
F_165 ( & V_12 -> V_91 , V_82 ) ;
if ( F_17 ( F_21 ( V_20 ) ) ) {
F_49 ( V_20 ) ;
if ( F_46 ( & V_12 -> V_34 ) )
F_12 ( & V_12 -> V_24 ) ;
}
F_166 ( & V_12 -> V_91 , V_82 ) ;
return V_232 ;
}
static int F_167 ( struct V_205 * V_20 , struct V_11 * V_220 )
{
struct V_233 * V_234 ;
struct V_235 * V_236 ;
int V_114 ;
struct V_19 * V_60 = V_220 -> V_60 ;
V_220 -> V_223 = V_18 ;
V_220 -> V_224 = V_18 ;
V_220 -> V_34 . V_51 = NULL ;
V_220 -> V_25 . V_51 = NULL ;
V_60 -> V_61 = 0 ;
V_114 = F_160 ( V_20 , V_60 -> V_237 ) ;
if ( V_114 ) {
F_148 ( V_20 , V_114 , L_30 , V_20 -> V_225 ) ;
goto V_221;
}
V_234 = (struct V_233 * ) F_168 ( V_238 | V_239 ) ;
if ( ! V_234 ) {
V_114 = - V_206 ;
F_148 ( V_20 , V_114 , L_31 ) ;
goto V_221;
}
F_169 ( V_234 ) ;
F_170 ( & V_220 -> V_25 , V_234 , V_80 ) ;
V_114 = F_171 ( V_20 , F_63 ( V_234 ) ) ;
if ( V_114 < 0 ) {
F_172 ( ( unsigned long ) V_234 ) ;
goto V_221;
}
V_220 -> V_223 = V_114 ;
V_236 = (struct V_235 * ) F_168 ( V_238 | V_239 ) ;
if ( ! V_236 ) {
V_114 = - V_206 ;
F_148 ( V_20 , V_114 , L_32 ) ;
goto V_221;
}
F_169 ( V_236 ) ;
F_170 ( & V_220 -> V_34 , V_236 , V_80 ) ;
V_114 = F_171 ( V_20 , F_63 ( V_236 ) ) ;
if ( V_114 < 0 ) {
F_172 ( ( unsigned long ) V_236 ) ;
goto V_221;
}
V_220 -> V_224 = V_114 ;
V_114 = F_173 ( V_20 , & V_220 -> V_222 ) ;
if ( V_114 )
goto V_221;
V_114 = F_174 ( V_220 -> V_222 , F_164 ,
0 , V_60 -> V_240 , V_60 ) ;
if ( V_114 < 0 )
goto V_221;
V_60 -> V_61 = V_114 ;
...
static int F_175 ( struct V_205 * V_20 ,
struct V_11 * V_220 )
{
const char * V_241 ;
struct V_242 V_243 ;
int V_114 ;
V_114 = F_167 ( V_20 , V_220 ) ;
if ( V_114 )
goto V_147;
V_244:
V_114 = F_176 ( & V_243 ) ;
if ( V_114 ) {
F_148 ( V_20 , V_114 , L_33 ) ;
goto V_245;
}
V_114 = F_177 ( V_243 , V_20 -> V_225 , L_34 , L_35 ,
V_220 -> V_223 ) ;
if ( V_114 ) {
V_241 = L_36 ;
goto V_246;
}
V_114 = F_177 ( V_243 , V_20 -> V_225 , L_37 , L_35 ,
V_220 -> V_224 ) ;
if ( V_114 ) {
V_241 = L_38 ;
goto V_246;
}
V_114 = F_177 ( V_243 , V_20 -> V_225 ,
L_39 , L_35 , V_220 -> V_222 ) ;
if ( V_114 ) {
V_241 = L_40 ;
goto V_246;
}
V_114 = F_177 ( V_243 , V_20 -> V_225 , L_41 , L_35 ,
1 ) ;
if ( V_114 ) {
V_241 = L_42 ;
goto V_246;
}
V_114 = F_177 ( V_243 , V_20 -> V_225 , L_43 , L_19 , 1 ) ;
if ( V_114 ) {
V_241 = L_44 ;
goto V_246;
}
V_114 = F_177 ( V_243 , V_20 -> V_225 , L_18 , L_19 , 1 ) ;
if ( V_114 ) {
V_241 = L_45 ;
goto V_246;
}
V_114 = F_177 ( V_243 , V_20 -> V_225 , L_20 , L_19 , 1 ) ;
if ( V_114 ) {
V_241 = L_46 ;
goto V_246;
}
...
if ( V_114 == - V_247 )
goto V_244;
F_148 ( V_20 , V_114 , L_47 ) ;
goto V_245;
}
return 0 ;
V_246:
F_178 ( V_243 , 1 ) ;
F_148 ( V_20 , V_114 , L_48 , V_241 ) ;
V_245:
F_155 ( V_220 ) ;
V_147:
return V_114 ;
...
static void F_184 ( struct V_205 * V_20 ,
enum V_251 V_252 )
{
struct V_11 * V_12 = F_158 ( & V_20 -> V_20 ) ;
struct V_19 * V_60 = V_12 -> V_60 ;
F_159 ( & V_20 -> V_20 , L_28 , F_185 ( V_252 ) ) ;
switch ( V_252 ) {
case V_253 :
case V_254 :
case V_255 :
...
static int F_189 ( struct V_19 * V_20 , int V_263 )
{
switch ( V_263 ) {
case V_264 :
return F_190 ( V_265 ) ;
...
void * V_12 = F_11 ( V_20 ) ;
int V_14 ;
for ( V_14 = 0 ; V_14 < F_190 ( V_265 ) ; V_14 ++ )
V_23 [ V_14 ] = * ( unsigned long * ) ( V_12 + V_265 [ V_14 ] . V_78 ) ;
}
static void F_192 ( struct V_19 * V_20 , T_5 V_267 , T_7 * V_23 )
{
int V_14 ;
switch ( V_267 ) {
case V_264 :
...
struct V_11 * V_220 = F_11 ( V_60 ) ;
return sprintf ( V_271 , L_51 , V_220 -> V_174 ) ;
}
static T_9 F_195 ( struct V_113 * V_20 ,
struct V_269 * V_270 ,
const char * V_271 , T_10 V_79 )
{
struct V_19 * V_60 = F_194 ( V_20 ) ;
...
static T_9 F_197 ( struct V_113 * V_20 ,
struct V_269 * V_270 , char * V_271 )
{
struct V_19 * V_60 = F_194 ( V_20 ) ;
struct V_11 * V_220 = F_11 ( V_60 ) ;
return sprintf ( V_271 , L_51 , V_220 -> V_54 ) ;
}
static T_9 F_198 ( struct V_113 * V_20 ,
struct V_269 * V_270 ,
const char * V_271 , T_10 V_79 )
{
struct V_19 * V_60 = F_194 ( V_20 ) ;
...
static T_9 F_199 ( struct V_113 * V_20 ,
struct V_269 * V_270 , char * V_271 )
{
struct V_19 * V_60 = F_194 ( V_20 ) ;
struct V_11 * V_220 = F_11 ( V_60 ) ;
return sprintf ( V_271 , L_51 , V_220 -> V_39 ) ;
}
static int F_151 ( struct V_19 * V_60 )
{
int V_14 ;
int V_114 ;
for ( V_14 = 0 ; V_14 < F_190 ( V_278 ) ; V_14 ++ ) {
...
static int T_11 F_203 ( struct V_205 * V_20 )
{
struct V_11 * V_220 = F_158 ( & V_20 -> V_20 ) ;
F_159 ( & V_20 -> V_20 , L_28 , V_20 -> V_225 ) ;
F_152 ( V_220 -> V_60 ) ;
