...
#ifdef F_90
if ( F_91 ( V_146 -> V_163 ) . V_186 != V_34 -> V_8 -> V_52 )
return V_178 ;
#endif
F_86 () ;
...
& V_189 ) ;
F_94 ( V_32 -> V_137 ) ;
F_30 ( L_95 , V_32 -> V_190 ) ;
F_23 ( V_32 -> V_190 ) ;
F_95 ( V_32 ) ;
V_8 -> V_32 = NULL ;
}
static int F_96 ( struct V_8 * V_8 )
{
struct V_31 * V_32 ;
struct V_33 * V_34 ;
int V_142 , V_22 , V_23 ;
...
if ( F_74 ( V_142 < 0 ) )
return V_142 ;
V_32 = F_97 ( sizeof( * V_34 ) , V_23 , V_22 , V_8 -> V_52 ) ;
if ( F_74 ( ! V_32 ) )
return - V_141 ;
F_14 ( L_91 __FILE__ L_94 ,
V_127 , V_32 , & V_8 -> V_13 [ 0 ] -> V_137 ) ;
...
V_32 -> V_196 = L_96 ;
V_32 -> V_197 = V_198 ;
V_32 -> V_190 = F_82 ( V_12 , L_97 , V_32 -> V_199 ) ;
V_32 -> V_200 = F_98 ( V_8 -> V_13 [ 0 ] ) ;
V_32 -> V_201 = NULL ;
V_32 -> V_202 = F_85 ;
V_142 = F_78 ( V_32 , V_8 ) ;
if ( F_74 ( V_142 < 0 ) )
...
static int T_4 F_101 ( struct V_17 * V_13 ,
...
static void T_5 F_104 ( struct V_17 * V_13 )
{
struct V_8 * V_8 ;
F_14 ( __FILE__ L_54 , V_127 ) ;
F_102 ( & V_206 ) ;
...
{
int V_209 ;
F_106 ( L_91 __FILE__ L_54 , V_127 ) ;
F_107 () ;
V_209 = F_108 ( & V_210 ) ;
if ( V_209 >= 0 )
return 0 ;
