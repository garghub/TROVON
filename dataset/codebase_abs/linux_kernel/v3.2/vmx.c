...
V_205 = F_69 ( V_206 ) ;
V_205 &= ~ ( V_207 | V_208 ) ;
V_205 |= F_130 ( V_3 , V_207 | V_208 ) ;
F_76 ( V_206 , V_205 ) ;
F_89 ( V_3 ) ;
V_3 -> V_95 . V_209 = V_207 ;
if ( F_90 ( V_3 ) )
V_3 -> V_95 . V_209 &=
~ F_4 ( V_3 ) -> V_210 ;
F_76 ( V_211 , ~ V_3 -> V_95 . V_209 ) ;
}
static inline unsigned long F_131 ( struct V_7 * V_212 )
{
return ( V_212 -> V_213 & ~ V_212 -> V_210 ) |
( V_212 -> V_214 & V_212 -> V_210 ) ;
}
static inline unsigned long F_132 ( struct V_7 * V_212 )
{
return ( V_212 -> V_215 & ~ V_212 -> V_216 ) |
( V_212 -> V_217 & V_212 -> V_216 ) ;
}
static void F_133 ( struct V_2 * V_3 )
{
F_134 ( V_3 ) ;
F_82 ( V_206 , V_207 | V_208 ) ;
F_89 ( V_3 ) ;
V_3 -> V_95 . V_209 = 0 ;
F_76 ( V_211 , ~ V_3 -> V_95 . V_209 ) ;
if ( F_90 ( V_3 ) ) {
struct V_7 * V_7 = F_4 ( V_3 ) ;
V_7 -> V_213 = ( V_7 -> V_213 & ~ V_207 ) |
( V_3 -> V_95 . V_205 & V_207 ) ;
F_76 ( V_218 , F_131 ( V_7 ) ) ;
} else
F_76 ( V_218 , V_3 -> V_95 . V_205 ) ;
}
static unsigned long F_135 ( struct V_2 * V_3 )
{
unsigned long V_219 , V_220 ;
if ( ! F_136 ( V_221 , ( T_9 * ) & V_3 -> V_95 . V_96 ) ) {
F_137 ( V_221 , ( T_9 * ) & V_3 -> V_95 . V_96 ) ;
V_219 = F_69 ( V_222 ) ;
if ( F_1 ( V_3 ) -> V_115 . V_116 ) {
V_219 &= V_223 ;
V_220 = F_1 ( V_3 ) -> V_115 . V_220 ;
V_219 |= V_220 & ~ V_223 ;
}
F_1 ( V_3 ) -> V_219 = V_219 ;
}
return F_1 ( V_3 ) -> V_219 ;
}
static void F_138 ( struct V_2 * V_3 , unsigned long V_219 )
{
F_137 ( V_221 , ( T_9 * ) & V_3 -> V_95 . V_96 ) ;
F_139 ( V_224 , ( T_9 * ) & V_3 -> V_95 . V_96 ) ;
F_1 ( V_3 ) -> V_219 = V_219 ;
if ( F_1 ( V_3 ) -> V_115 . V_116 ) {
F_1 ( V_3 ) -> V_115 . V_220 = V_219 ;
V_219 |= V_225 | V_226 ;
}
F_76 ( V_222 , V_219 ) ;
}
...
int V_245 = 0 ;
if ( F_149 ( V_133 ) )
V_245 = V_3 -> V_95 . V_246 ;
if ( F_150 ( V_3 , V_133 , V_245 ) != V_247 )
F_123 ( V_248 , V_3 ) ;
return;
}
if ( F_149 ( V_133 ) ) {
...
static void F_152 ( struct V_1 * V_58 , int V_252 , int V_253 )
{
struct V_71 V_254 ;
V_254 = V_58 -> V_63 [ V_253 ] ;
V_58 -> V_63 [ V_253 ] = V_58 -> V_63 [ V_252 ] ;
V_58 -> V_63 [ V_252 ] = V_254 ;
}
...
if ( V_64 >= 0 )
F_152 ( V_58 , V_64 , V_191 ++ ) ;
V_64 = F_48 ( V_58 , V_259 ) ;
if ( V_64 >= 0 && V_58 -> V_260 )
F_152 ( V_58 , V_64 , V_191 ++ ) ;
V_64 = F_48 ( V_58 , V_261 ) ;
...
static void F_157 ( struct V_2 * V_3 , T_2 V_269 )
{
}
static void F_158 ( struct V_2 * V_3 , T_5 V_270 )
{
if ( F_90 ( V_3 ) ) {
struct V_7 * V_7 ;
F_1 ( V_3 ) -> V_8 . V_268 = V_270 ;
V_7 = F_4 ( V_3 ) ;
F_80 ( V_267 , V_270 +
( F_44 ( V_7 , V_271 ) ?
V_7 -> V_266 : 0 ) ) ;
...
static void F_159 ( struct V_2 * V_3 , T_10 V_272 )
{
T_5 V_270 = F_72 ( V_267 ) ;
F_80 ( V_267 , V_270 + V_272 ) ;
if ( F_90 ( V_3 ) ) {
F_1 ( V_3 ) -> V_8 . V_268 += V_272 ;
}
}
static T_5 F_160 ( struct V_2 * V_3 , T_5 V_273 )
{
return V_273 - F_161 () ;
}
static bool F_162 ( struct V_2 * V_3 )
{
struct V_274 * V_275 = F_163 ( V_3 , 1 , 0 ) ;
return V_275 && ( V_275 -> V_276 & ( 1 << ( V_277 & 31 ) ) ) ;
}
...
int V_76 ;
F_207 (cpu) {
F_203 ( F_59 ( V_196 , V_76 ) ) ;
F_59 ( V_196 , V_76 ) = NULL ;
}
}
...
T_13 V_438 ;
V_437 = V_436 ( V_12 ) ;
V_438 = V_437 -> V_439 [ 0 ] . V_438 +
V_12 -> V_439 -> V_439 [ 0 ] . V_440 - 3 ;
return V_438 << V_13 ;
}
return V_12 -> V_95 . V_435 ;
}
static void F_217 ( int V_92 , struct V_407 * V_408 )
{
struct V_409 * V_410 = & V_101 [ V_92 ] ;
...
F_95 ( V_147 L_13
L_14 ) ;
F_219 ( & V_3 -> V_12 -> V_441 , V_3 -> V_442 ) ;
F_220 ( V_3 -> V_12 , 0xfeffd000 ) ;
V_3 -> V_442 = F_221 ( & V_3 -> V_12 -> V_441 ) ;
}
F_83 ( V_58 ) ;
...
F_217 ( V_425 , & V_58 -> V_115 . V_426 ) ;
F_217 ( V_427 , & V_58 -> V_115 . V_428 ) ;
F_217 ( V_429 , & V_58 -> V_115 . V_181 ) ;
F_217 ( V_430 , & V_58 -> V_115 . V_177 ) ;
V_444:
F_222 ( V_3 ) ;
}
static void F_223 ( struct V_2 * V_3 , T_5 V_158 )
{
struct V_1 * V_58 = F_1 ( V_3 ) ;
...
F_223 ( V_3 , V_3 -> V_95 . V_158 | V_161 ) ;
}
...
F_65 ( F_1 ( V_3 ) ) ;
if ( V_84 ) {
if ( ! F_228 ( V_3 -> V_95 . V_453 . V_454 ) )
return;
F_67 ( F_229 ( V_3 -> V_95 . V_453 . V_454 ) ) ;
}
}
static void F_134 ( struct V_2 * V_3 )
{
T_9 V_209 = V_3 -> V_95 . V_209 ;
V_3 -> V_95 . V_205 &= ~ V_209 ;
V_3 -> V_95 . V_205 |= F_69 ( V_206 ) & V_209 ;
}
...
V_3 -> V_95 . V_459 |= F_69 ( V_421 ) & V_458 ;
}
...
return;
if ( F_231 ( V_3 ) && F_234 ( V_3 ) && ! F_108 ( V_3 ) ) {
...
static void F_235 ( unsigned long * V_466 ,
unsigned long V_205 ,
struct V_2 * V_3 )
{
...
static void F_238 ( struct V_2 * V_3 , unsigned long V_205 )
{
struct V_1 * V_58 = F_1 ( V_3 ) ;
unsigned long V_466 ;
if ( V_403 )
...
V_466 = ( V_205 & ~ V_472 ) | V_473 ;
if ( V_58 -> V_115 . V_116 && ( V_205 & V_474 ) )
F_215 ( V_3 ) ;
if ( ! V_58 -> V_115 . V_116 && ! ( V_205 & V_474 ) )
F_218 ( V_3 ) ;
#ifdef F_73
if ( V_3 -> V_95 . V_158 & V_162 ) {
if ( ! F_231 ( V_3 ) && ( V_205 & V_467 ) )
F_224 ( V_3 ) ;
if ( F_231 ( V_3 ) && ! ( V_205 & V_467 ) )
F_226 ( V_3 ) ;
}
...
static T_5 F_229 ( unsigned long V_454 )
{
T_5 V_69 ;
V_69 = V_475 |
V_476 << V_477 ;
...
static void F_239 ( struct V_2 * V_3 , unsigned long V_455 )
{
unsigned long V_479 ;
T_5 V_69 ;
V_479 = V_455 ;
...
static int F_236 ( struct V_2 * V_3 , unsigned long V_459 )
{
...
T_2 V_106 ;
if ( V_58 -> V_115 . V_116
&& ( V_92 == V_490 || V_92 == V_425
|| V_92 == V_427 || V_92 == V_430
|| V_92 == V_429 )
&& ! V_424 ) {
switch ( V_92 ) {
case V_490 : V_408 = & V_58 -> V_115 . V_172 ; break;
...
V_489 -> V_99 = V_408 -> V_99 ;
V_489 -> V_102 = V_408 -> V_102 ;
V_489 -> V_104 = V_408 -> V_104 ;
V_106 = V_408 -> V_106 ;
if ( V_92 == V_490
...
V_491:
if ( ( V_106 & V_492 ) && ! V_424 )
V_106 = 0 ;
V_489 -> type = V_106 & 15 ;
V_489 -> V_169 = ( V_106 >> 4 ) & 1 ;
V_489 -> V_412 = ( V_106 >> 5 ) & 3 ;
...
static T_5 F_243 ( struct V_2 * V_3 , int V_92 )
{
struct V_488 V_169 ;
if ( F_1 ( V_3 ) -> V_115 . V_116 ) {
F_241 ( V_3 , & V_169 , V_92 ) ;
return V_169 . V_102 ;
}
...
F_1 ( V_3 ) -> V_500 = F_244 ( V_3 ) ;
}
return F_1 ( V_3 ) -> V_500 ;
}
static T_2 F_248 ( struct V_488 * V_489 )
{
T_2 V_106 ;
if ( V_489 -> V_498 )
V_106 = 1 << 16 ;
...
F_78 ( V_410 -> V_99 , V_489 -> V_99 ) ;
V_58 -> V_115 . V_172 . V_99 = V_489 -> V_99 ;
V_58 -> V_115 . V_172 . V_102 = V_489 -> V_102 ;
V_58 -> V_115 . V_172 . V_104 = V_489 -> V_104 ;
V_58 -> V_115 . V_172 . V_106 = F_248 ( V_489 ) ;
return;
}
F_76 ( V_410 -> V_102 , V_489 -> V_102 ) ;
F_79 ( V_410 -> V_104 , V_489 -> V_104 ) ;
F_78 ( V_410 -> V_99 , V_489 -> V_99 ) ;
...
struct V_488 V_507 ;
unsigned int V_508 ;
F_241 ( V_3 , & V_507 , V_499 ) ;
V_508 = V_507 . V_99 & V_413 ;
if ( V_507 . V_498 )
return false ;
...
struct V_488 V_512 ;
unsigned int V_513 ;
F_241 ( V_3 , & V_512 , V_514 ) ;
V_513 = V_512 . V_99 & V_413 ;
if ( V_512 . V_498 )
return true ;
...
if ( ! V_512 . V_169 )
return false ;
if ( V_512 . V_412 != V_513 )
return false ;
if ( ! V_512 . V_493 )
return false ;
return true ;
}
static bool F_258 ( struct V_2 * V_3 , int V_92 )
{
struct V_488 V_489 ;
unsigned int V_515 ;
F_241 ( V_3 , & V_489 , V_92 ) ;
V_515 = V_489 . V_99 & V_413 ;
if ( V_489 . V_498 )
return true ;
if ( ! V_489 . V_169 )
return false ;
...
V_520 = F_221 ( & V_12 -> V_441 ) ;
V_518 = F_216 ( V_12 ) >> V_13 ;
V_519 = F_264 ( V_12 , V_518 , 0 , V_389 ) ;
if ( V_519 < 0 )
goto V_521;
V_164 = V_522 + V_523 ;
V_519 = F_265 ( V_12 , V_518 ++ , & V_164 ,
V_524 , sizeof( T_3 ) ) ;
if ( V_519 < 0 )
goto V_521;
V_519 = F_264 ( V_12 , V_518 ++ , 0 , V_389 ) ;
...
if ( F_267 ( V_12 -> V_95 . V_527 ) )
return 1 ;
V_93 = 0 ;
V_525 = V_12 -> V_95 . V_481 >> V_13 ;
V_520 = F_221 ( & V_12 -> V_441 ) ;
V_519 = F_264 ( V_12 , V_525 , 0 , V_389 ) ;
if ( V_519 < 0 )
goto V_521;
for ( V_60 = 0 ; V_60 < V_528 ; V_60 ++ ) {
V_254 = ( V_60 << 22 ) + ( V_529 | V_530 | V_531 |
V_532 | V_533 | V_534 ) ;
V_519 = F_265 ( V_12 , V_525 ,
& V_254 , V_60 * sizeof( V_254 ) , sizeof( V_254 ) ) ;
if ( V_519 < 0 )
goto V_521;
}
...
V_536 . V_539 = V_540 ;
V_536 . V_415 = 0 ;
V_536 . V_541 = 0xfee00000ULL ;
V_536 . V_542 = V_389 ;
V_519 = F_271 ( V_12 , & V_536 , 0 ) ;
if ( V_519 )
goto V_521;
...
static void F_278 ( struct V_1 * V_58 )
{
if ( ! V_402 )
return;
F_275 ( & V_544 ) ;
...
static void F_279 ( unsigned long * V_255 , T_2 V_59 )
{
int V_547 = sizeof( unsigned long ) ;
if ( ! F_17 () )
return;
if ( V_59 <= 0x1fff ) {
F_139 ( V_59 , V_255 + 0x000 / V_547 ) ;
F_139 ( V_59 , V_255 + 0x800 / V_547 ) ;
} else if ( ( V_59 >= 0xc0000000 ) && ( V_59 <= 0xc0001fff ) ) {
V_59 &= 0x1fff ;
F_139 ( V_59 , V_255 + 0x400 / V_547 ) ;
F_139 ( V_59 , V_255 + 0xc00 / V_547 ) ;
}
}
static void F_280 ( T_2 V_59 , bool V_548 )
{
if ( ! V_548 )
F_279 ( V_263 , V_59 ) ;
F_279 ( V_262 , V_59 ) ;
...
static void F_285 ( struct V_1 * V_58 )
{
V_58 -> V_3 . V_95 . V_458 = V_567 ;
if ( V_84 )
V_58 -> V_3 . V_95 . V_458 |= V_568 ;
if ( F_90 ( & V_58 -> V_3 ) )
V_58 -> V_3 . V_95 . V_458 &=
~ F_4 ( & V_58 -> V_3 ) -> V_216 ;
F_76 ( V_569 , ~ V_58 -> V_3 . V_95 . V_458 ) ;
}
static T_2 F_286 ( struct V_1 * V_58 )
{
T_2 V_570 = V_24 . V_25 ;
...
{
F_289 ( 0xffull << 49 | 0x6ull ) ;
}
static int F_290 ( struct V_1 * V_58 )
{
#ifdef F_73
unsigned long V_571 ;
#endif
...
if ( F_17 () )
F_80 ( V_264 , F_53 ( V_263 ) ) ;
F_80 ( V_576 , - 1ull ) ;
F_79 ( V_577 ,
V_24 . V_51 ) ;
F_79 ( V_468 , F_286 ( V_58 ) ) ;
if ( F_21 () ) {
F_79 ( V_578 ,
F_287 ( V_58 ) ) ;
}
...
static int F_293 ( struct V_2 * V_3 )
{
struct V_1 * V_58 = F_1 ( V_3 ) ;
T_5 V_59 ;
int V_93 ;
...
V_58 -> V_115 . V_116 = 0 ;
V_58 -> V_595 = 0 ;
V_58 -> V_3 . V_95 . V_350 [ V_596 ] = F_294 () ;
F_295 ( & V_58 -> V_3 , 0 ) ;
...
F_76 ( V_448 , V_58 -> V_3 . V_95 . V_599 << 12 ) ;
}
F_268 ( V_427 ) ;
F_268 ( V_425 ) ;
F_268 ( V_430 ) ;
...
if ( F_38 ( V_58 -> V_3 . V_12 ) )
F_80 ( V_609 ,
F_300 ( V_58 -> V_3 . V_12 -> V_95 . V_538 ) ) ;
if ( V_58 -> V_42 != 0 )
F_78 ( V_610 , V_58 -> V_42 ) ;
V_58 -> V_3 . V_95 . V_205 = V_611 | V_612 | V_613 ;
F_238 ( & V_58 -> V_3 , F_301 ( V_3 ) ) ;
F_236 ( & V_58 -> V_3 , 0 ) ;
F_223 ( & V_58 -> V_3 , 0 ) ;
F_129 ( & V_58 -> V_3 ) ;
F_89 ( & V_58 -> V_3 ) ;
...
static bool F_302 ( struct V_2 * V_3 )
{
return F_4 ( V_3 ) -> V_57 &
V_280 ;
}
...
struct V_1 * V_58 = F_1 ( V_3 ) ;
T_15 V_615 ;
int V_616 = V_3 -> V_95 . V_617 . V_133 ;
F_306 ( V_616 ) ;
++ V_3 -> V_192 . V_618 ;
if ( V_58 -> V_115 . V_116 ) {
int V_245 = 0 ;
if ( V_3 -> V_95 . V_617 . V_619 )
V_245 = V_3 -> V_95 . V_246 ;
if ( F_150 ( V_3 , V_616 , V_245 ) != V_247 )
F_123 ( V_248 , V_3 ) ;
return;
}
V_615 = V_616 | V_17 ;
...
static int F_308 ( struct V_2 * V_3 )
{
...
static bool F_309 ( struct V_2 * V_3 )
{
if ( ! F_41 () )
return F_1 ( V_3 ) -> V_595 ;
if ( F_1 ( V_3 ) -> V_623 )
return false ;
return F_71 ( V_228 ) & V_626 ;
}
static void F_310 ( struct V_2 * V_3 , bool V_627 )
{
struct V_1 * V_58 = F_1 ( V_3 ) ;
if ( ! F_41 () ) {
if ( V_58 -> V_595 != V_627 ) {
...
static int F_311 ( struct V_2 * V_3 )
{
if ( F_90 ( V_3 ) && F_302 ( V_3 ) ) {
struct V_7 * V_7 ;
if ( F_1 ( V_3 ) -> V_8 . V_628 )
return 0 ;
F_147 ( V_3 ) ;
V_7 = F_4 ( V_3 ) ;
V_7 -> V_629 = V_630 ;
...
return ( F_69 ( V_222 ) & V_632 ) &&
! ( F_71 ( V_228 ) &
( V_229 | V_231 ) ) ;
}
static int F_220 ( struct V_12 * V_12 , unsigned int V_11 )
{
int V_93 ;
struct V_535 V_633 = {
. V_539 = V_634 ,
...
int V_635 , T_2 V_636 )
{
if ( ( ( V_635 == V_315 ) || ( V_635 == V_637 ) ) && V_636 == 0 )
if ( F_314 ( V_3 , 0 ) == V_247 )
return 1 ;
switch ( V_635 ) {
case V_110 :
if ( V_3 -> V_111 &
...
{
struct V_1 * V_58 = F_1 ( V_3 ) ;
struct V_646 * V_646 = V_3 -> V_647 ;
T_2 V_14 , V_648 , V_241 ;
unsigned long V_649 , V_234 , V_650 ;
T_2 V_651 ;
enum V_652 V_653 ;
V_651 = V_58 -> V_654 ;
V_14 = V_58 -> V_655 ;
...
if ( ( V_651 & V_656 ) &&
! F_12 ( V_14 ) ) {
V_3 -> V_647 -> V_657 = V_658 ;
V_3 -> V_647 -> V_659 . V_660 = V_661 ;
V_3 -> V_647 -> V_659 . V_662 = 2 ;
V_3 -> V_647 -> V_659 . V_164 [ 0 ] = V_651 ;
V_3 -> V_647 -> V_659 . V_164 [ 1 ] = V_14 ;
return 0 ;
}
if ( ( V_14 & V_15 ) == V_625 )
return 1 ;
...
if ( F_323 ( V_3 ) )
F_324 ( V_3 , V_649 ) ;
return F_325 ( V_3 , V_649 , V_241 , NULL , 0 ) ;
}
if ( V_58 -> V_115 . V_116 &&
F_313 ( V_3 , V_14 & V_16 ,
V_241 ) ) {
...
if ( ! ( V_3 -> V_111 &
( V_638 | V_357 ) ) ) {
V_3 -> V_95 . V_650 = V_650 | V_667 ;
F_315 ( V_3 , V_110 ) ;
return 1 ;
}
V_646 -> V_668 . V_95 . V_650 = V_650 | V_667 ;
V_646 -> V_668 . V_95 . V_360 = F_69 ( V_358 ) ;
case V_114 :
V_58 -> V_3 . V_95 . V_246 =
F_71 ( V_235 ) ;
V_646 -> V_657 = V_669 ;
V_234 = F_143 ( V_3 ) ;
V_646 -> V_668 . V_95 . V_670 = F_69 ( V_448 ) + V_234 ;
V_646 -> V_668 . V_95 . V_671 = V_648 ;
break;
default:
V_646 -> V_657 = V_672 ;
V_646 -> V_673 . V_671 = V_648 ;
V_646 -> V_673 . V_241 = V_241 ;
break;
}
return 0 ;
}
...
{
V_3 -> V_647 -> V_657 = V_675 ;
return 0 ;
}
static int F_329 ( struct V_2 * V_3 )
{
unsigned long V_676 ;
int V_390 , V_677 , string ;
unsigned V_678 ;
V_676 = F_69 ( V_665 ) ;
string = ( V_676 & 16 ) != 0 ;
V_677 = ( V_676 & 8 ) != 0 ;
++ V_3 -> V_192 . V_679 ;
if ( string || V_677 )
return F_314 ( V_3 , 0 ) == V_247 ;
V_678 = V_676 >> 16 ;
V_390 = ( V_676 & 7 ) + 1 ;
F_142 ( V_3 ) ;
return F_330 ( V_3 , V_390 , V_678 ) ;
}
static void
F_331 ( struct V_2 * V_3 , unsigned char * V_680 )
{
V_680 [ 0 ] = 0x0f ;
V_680 [ 1 ] = 0x01 ;
V_680 [ 2 ] = 0xc1 ;
}
static int F_332 ( struct V_2 * V_3 , unsigned long V_681 )
{
if ( F_1 ( V_3 ) -> V_8 . V_485 &&
( ( V_681 & F_171 ) != F_171 ) )
return 1 ;
if ( F_90 ( V_3 ) ) {
if ( F_333 ( V_3 , ( V_681 & V_3 -> V_95 . V_209 ) |
( V_3 -> V_95 . V_205 & ~ V_3 -> V_95 . V_209 ) ) )
return 1 ;
F_76 ( V_218 , V_681 ) ;
return 0 ;
} else
return F_333 ( V_3 , V_681 ) ;
}
static int F_334 ( struct V_2 * V_3 , unsigned long V_681 )
{
if ( F_90 ( V_3 ) ) {
if ( F_335 ( V_3 , ( V_681 & V_3 -> V_95 . V_458 ) |
( V_3 -> V_95 . V_459 & ~ V_3 -> V_95 . V_458 ) ) )
return 1 ;
F_76 ( V_423 , V_681 ) ;
return 0 ;
} else
return F_335 ( V_3 , V_681 ) ;
}
static void F_336 ( struct V_2 * V_3 )
{
if ( F_90 ( V_3 ) ) {
F_76 ( V_218 ,
F_69 ( V_218 ) & ~ V_207 ) ;
...
F_238 ( V_3 , F_130 ( V_3 , ~ V_207 ) ) ;
}
static int F_337 ( struct V_2 * V_3 )
{
unsigned long V_676 , V_681 ;
int V_682 ;
int V_348 ;
int V_683 ;
V_676 = F_69 ( V_665 ) ;
...
switch ( ( V_676 >> 4 ) & 3 ) {
case 0 :
V_681 = F_338 ( V_3 , V_348 ) ;
F_339 ( V_682 , V_681 ) ;
switch ( V_682 ) {
case 0 :
V_683 = F_332 ( V_3 , V_681 ) ;
F_340 ( V_3 , V_683 ) ;
return 1 ;
case 3 :
V_683 = F_341 ( V_3 , V_681 ) ;
F_340 ( V_3 , V_683 ) ;
return 1 ;
case 4 :
V_683 = F_334 ( V_3 , V_681 ) ;
F_340 ( V_3 , V_683 ) ;
return 1 ;
case 8 : {
T_6 V_684 = F_342 ( V_3 ) ;
T_6 V_685 = F_338 ( V_3 , V_348 ) ;
V_683 = F_295 ( V_3 , V_685 ) ;
F_340 ( V_3 , V_683 ) ;
if ( F_20 ( V_3 -> V_12 ) )
return 1 ;
if ( V_684 <= V_685 )
return 1 ;
V_3 -> V_647 -> V_657 = V_686 ;
return 0 ;
}
} ;
break;
...
break;
case 3 :
V_681 = ( V_676 >> V_687 ) & 0x0f ;
F_339 ( 0 , ( F_301 ( V_3 ) & ~ 0xful ) | V_681 ) ;
F_344 ( V_3 , V_681 ) ;
F_142 ( V_3 ) ;
return 1 ;
default:
...
if ( V_688 & V_689 ) {
if ( V_3 -> V_111 & V_357 ) {
V_3 -> V_647 -> V_668 . V_95 . V_650 = V_3 -> V_95 . V_650 ;
V_3 -> V_647 -> V_668 . V_95 . V_360 = V_688 ;
V_3 -> V_647 -> V_668 . V_95 . V_670 =
F_69 ( V_448 ) +
F_69 ( V_353 ) ;
V_3 -> V_647 -> V_668 . V_95 . V_671 = V_110 ;
V_3 -> V_647 -> V_657 = V_669 ;
return 0 ;
} else {
V_3 -> V_95 . V_360 &= ~ V_689 ;
V_3 -> V_95 . V_650 |= V_690 ;
F_76 ( V_358 , V_3 -> V_95 . V_360 ) ;
F_315 ( V_3 , V_110 ) ;
return 1 ;
}
...
if ( V_676 & V_692 ) {
unsigned long V_681 ;
if ( ! F_349 ( V_3 , V_688 , & V_681 ) )
F_299 ( V_3 , V_348 , V_681 ) ;
} else
F_350 ( V_3 , V_688 , V_3 -> V_95 . V_350 [ V_348 ] ) ;
F_142 ( V_3 ) ;
return 1 ;
}
static void F_351 ( struct V_2 * V_3 , unsigned long V_681 )
{
F_76 ( V_358 , V_681 ) ;
}
static int F_352 ( struct V_2 * V_3 )
{
F_353 ( V_3 ) ;
return 1 ;
}
...
{
T_2 V_276 = V_3 -> V_95 . V_350 [ V_693 ] ;
T_5 V_164 ;
if ( F_174 ( V_3 , V_276 , & V_164 ) ) {
F_355 ( V_276 ) ;
F_356 ( V_3 , 0 ) ;
return 1 ;
}
F_357 ( V_276 , V_164 ) ;
V_3 -> V_95 . V_350 [ V_694 ] = V_164 & - 1u ;
...
{
T_2 V_276 = V_3 -> V_95 . V_350 [ V_693 ] ;
T_5 V_164 = ( V_3 -> V_95 . V_350 [ V_694 ] & - 1u )
| ( ( T_5 ) ( V_3 -> V_95 . V_350 [ V_596 ] & - 1u ) << 32 ) ;
if ( F_176 ( V_3 , V_276 , V_164 ) != 0 ) {
F_359 ( V_276 , V_164 ) ;
F_356 ( V_3 , 0 ) ;
return 1 ;
}
...
static int F_361 ( struct V_2 * V_3 )
{
F_123 ( V_695 , V_3 ) ;
return 1 ;
}
...
{
unsigned long V_676 = F_69 ( V_665 ) ;
F_369 ( V_3 , V_676 ) ;
F_142 ( V_3 ) ;
return 1 ;
}
...
{
T_5 V_699 = F_373 ( V_3 ) ;
T_2 V_64 = F_338 ( V_3 , V_693 ) ;
if ( F_374 ( V_3 , V_64 , V_699 ) == 0 )
F_142 ( V_3 ) ;
return 1 ;
}
...
T_2 V_241 = 0 ;
T_3 V_706 ;
int V_707 , type , V_708 ;
V_708 = ( V_58 -> V_654 & V_656 ) ;
type = ( V_58 -> V_654 & V_709 ) ;
V_676 = F_69 ( V_665 ) ;
V_707 = ( T_2 ) V_676 >> 30 ;
if ( V_707 == V_710 && V_708 ) {
switch ( type ) {
case V_625 :
V_3 -> V_95 . V_711 = false ;
F_310 ( V_3 , true ) ;
break;
case V_22 :
case V_620 :
...
type != V_625 ) )
F_142 ( V_3 ) ;
if ( F_380 ( V_3 , V_706 , V_707 ,
V_240 , V_241 ) == V_714 ) {
V_3 -> V_647 -> V_657 = V_658 ;
V_3 -> V_647 -> V_659 . V_660 = V_715 ;
V_3 -> V_647 -> V_659 . V_662 = 0 ;
return 0 ;
}
...
V_716 = ( V_676 >> 7 ) & 0x3 ;
if ( V_716 != 0x3 && V_716 != 0x1 && V_716 != 0 ) {
F_54 ( V_74 L_20 ) ;
F_54 ( V_74 L_21 ,
( long unsigned int ) F_72 ( V_717 ) ,
F_69 ( V_718 ) ) ;
F_54 ( V_74 L_22 ,
( long unsigned int ) V_676 ) ;
V_3 -> V_647 -> V_657 = V_719 ;
V_3 -> V_647 -> V_720 . V_721 = V_722 ;
return 0 ;
}
V_70 = F_72 ( V_717 ) ;
F_322 ( V_70 , V_676 ) ;
return F_325 ( V_3 , V_70 , V_676 & 0x3 , NULL , 0 ) ;
}
static T_5 F_382 ( T_5 V_723 , int V_724 )
{
int V_60 ;
T_5 V_89 = 0 ;
for ( V_60 = 51 ; V_60 > V_394 . V_725 ; V_60 -- )
V_89 |= ( 1ULL << V_60 ) ;
if ( V_724 > 2 )
V_89 |= 0xf8 ;
else if ( V_724 == 2 ) {
...
static void F_383 ( struct V_2 * V_3 , T_5 V_723 ,
int V_724 )
{
F_54 ( V_74 L_23 , V_452 , V_723 , V_724 ) ;
F_384 ( ( V_723 & 0x7 ) == 0x2 ) ;
F_384 ( ( V_723 & 0x7 ) == 0x6 ) ;
if ( ! F_24 () )
F_384 ( ( V_723 & 0x7 ) == 0x4 ) ;
if ( ( V_723 & 0x7 ) ) {
T_5 V_726 = V_723 & F_382 ( V_723 , V_724 ) ;
if ( V_726 != 0 ) {
F_54 ( V_74 L_24 ,
V_452 , V_726 ) ;
F_384 ( 1 ) ;
}
if ( V_724 == 1 || ( V_724 == 2 && ( V_723 & ( 1ULL << 7 ) ) ) ) {
T_5 V_727 = ( V_723 & 0x38 ) >> 3 ;
if ( V_727 == 2 || V_727 == 3 ||
V_727 == 7 ) {
F_54 ( V_74 L_25 ,
V_452 , V_727 ) ;
...
T_1 V_70 ;
V_70 = F_72 ( V_717 ) ;
V_93 = F_386 ( V_3 , V_70 , true ) ;
if ( F_267 ( V_93 == 1 ) )
return F_387 ( V_3 , V_70 , 0 , NULL , 0 ) ==
V_247 ;
if ( F_77 ( ! V_93 ) )
return 1 ;
F_54 ( V_74 L_26 ) ;
F_54 ( V_74 L_27 , V_70 ) ;
V_729 = F_388 ( V_3 , V_70 , V_728 ) ;
for ( V_60 = V_730 ; V_60 > V_730 - V_729 ; -- V_60 )
F_383 ( V_3 , V_728 [ V_60 - 1 ] , V_60 ) ;
V_3 -> V_647 -> V_657 = V_719 ;
V_3 -> V_647 -> V_720 . V_721 = V_731 ;
return 0 ;
}
...
while ( ! F_262 ( V_3 ) ) {
if ( V_734
&& ( F_246 ( & V_58 -> V_3 ) & V_632 ) )
return F_362 ( & V_58 -> V_3 ) ;
V_683 = F_314 ( V_3 , 0 ) ;
if ( V_683 == V_735 ) {
V_93 = 0 ;
goto V_521;
...
static struct V_75 * F_397 ( struct V_1 * V_58 )
{
struct V_737 * V_738 ;
F_398 (item, &vmx->nested.vmcs02_pool, list)
if ( V_738 -> V_739 == V_58 -> V_8 . V_740 ) {
F_399 ( & V_738 -> V_741 , & V_58 -> V_8 . V_742 ) ;
return & V_738 -> V_743 ;
}
if ( V_58 -> V_8 . V_744 >= F_400 ( V_745 , 1 ) ) {
V_738 = F_401 ( V_58 -> V_8 . V_742 . V_746 ,
struct V_737 , V_741 ) ;
V_738 -> V_739 = V_58 -> V_8 . V_740 ;
F_399 ( & V_738 -> V_741 , & V_58 -> V_8 . V_742 ) ;
return & V_738 -> V_743 ;
}
V_738 = (struct V_737 * )
F_402 ( sizeof( struct V_737 ) , V_399 ) ;
if ( ! V_738 )
return NULL ;
V_738 -> V_743 . V_72 = F_202 () ;
if ( ! V_738 -> V_743 . V_72 ) {
F_403 ( V_738 ) ;
return NULL ;
}
F_55 ( & V_738 -> V_743 ) ;
V_738 -> V_739 = V_58 -> V_8 . V_740 ;
F_125 ( & ( V_738 -> V_741 ) , & ( V_58 -> V_8 . V_742 ) ) ;
V_58 -> V_8 . V_744 ++ ;
return & V_738 -> V_743 ;
}
static void F_404 ( struct V_1 * V_58 , T_1 V_739 )
{
struct V_737 * V_738 ;
F_398 (item, &vmx->nested.vmcs02_pool, list)
if ( V_738 -> V_739 == V_739 ) {
F_205 ( & V_738 -> V_743 ) ;
F_60 ( & V_738 -> V_741 ) ;
F_403 ( V_738 ) ;
V_58 -> V_8 . V_744 -- ;
...
static void F_405 ( struct V_1 * V_58 )
{
struct V_737 * V_738 , * V_369 ;
F_192 (item, n, &vmx->nested.vmcs02_pool, list) {
if ( V_58 -> V_75 != & V_738 -> V_743 )
F_205 ( & V_738 -> V_743 ) ;
F_60 ( & V_738 -> V_741 ) ;
F_403 ( V_738 ) ;
}
V_58 -> V_8 . V_744 = 0 ;
if ( V_58 -> V_75 != & V_58 -> V_747 )
F_205 ( & V_58 -> V_747 ) ;
}
...
static void F_409 ( struct V_1 * V_58 )
{
if ( ! V_58 -> V_8 . V_485 )
return;
V_58 -> V_8 . V_485 = false ;
if ( V_58 -> V_8 . V_740 != - 1ull ) {
F_410 ( V_58 -> V_8 . V_748 ) ;
F_9 ( V_58 -> V_8 . V_748 ) ;
V_58 -> V_8 . V_740 = - 1ull ;
V_58 -> V_8 . V_9 = NULL ;
}
...
int V_750 = V_749 & 3 ;
int V_751 = ( V_749 >> 7 ) & 7 ;
bool V_752 = V_749 & ( 1u << 10 ) ;
int V_753 = ( V_749 >> 15 ) & 7 ;
int V_754 = ( V_749 >> 18 ) & 0xf ;
bool V_755 = ! ( V_749 & ( 1u << 22 ) ) ;
int V_756 = ( V_749 >> 23 ) & 0xf ;
bool V_757 = ! ( V_749 & ( 1u << 27 ) ) ;
if ( V_752 ) {
F_315 ( V_3 , V_21 ) ;
return 1 ;
}
* V_93 = F_243 ( V_3 , V_753 ) ;
if ( V_757 )
* V_93 += F_338 ( V_3 , V_756 ) ;
if ( V_755 )
* V_93 += F_338 ( V_3 , V_754 ) << V_750 ;
* V_93 += V_676 ;
if ( V_751 == 1 )
* V_93 &= 0xffffffff ;
return 0 ;
}
static void F_413 ( struct V_2 * V_3 )
{
F_138 ( V_3 , F_135 ( V_3 )
& ~ ( V_758 | V_759 | V_760 |
V_761 | V_762 | V_763 ) ) ;
}
static void F_414 ( struct V_2 * V_3 )
{
F_138 ( V_3 , ( F_135 ( V_3 )
& ~ ( V_759 | V_760 | V_761 |
V_762 | V_763 ) )
...
static void F_415 ( struct V_2 * V_3 ,
T_2 V_764 )
{
if ( F_1 ( V_3 ) -> V_8 . V_740 == - 1ull ) {
F_414 ( V_3 ) ;
return;
}
F_138 ( V_3 , ( F_135 ( V_3 )
...
if ( ! F_408 ( V_3 ) )
return 1 ;
if ( F_412 ( V_3 , F_69 ( V_665 ) ,
F_71 ( V_767 ) , & V_66 ) )
return 1 ;
if ( F_417 ( & V_3 -> V_95 . V_768 , V_66 , & V_739 ,
sizeof( V_739 ) , & V_766 ) ) {
F_418 ( V_3 , & V_766 ) ;
return 1 ;
}
if ( ! F_419 ( V_739 , V_389 ) ) {
F_415 ( V_3 , V_769 ) ;
F_142 ( V_3 ) ;
return 1 ;
}
if ( V_739 == V_58 -> V_8 . V_740 ) {
F_410 ( V_58 -> V_8 . V_748 ) ;
F_9 ( V_58 -> V_8 . V_748 ) ;
V_58 -> V_8 . V_740 = - 1ull ;
V_58 -> V_8 . V_9 = NULL ;
...
{
return F_422 ( V_3 , true ) ;
}
static int F_423 ( struct V_2 * V_3 )
{
return F_422 ( V_3 , false ) ;
}
static inline int F_424 ( unsigned long V_4 )
{
if ( 0x1 & V_4 )
return V_771 ;
return ( V_4 >> 13 ) & 0x3 ;
}
static inline int F_425 ( unsigned long V_4 )
{
return ( ( ( V_4 >> 10 ) & 0x3 ) == 1 ) ;
}
static inline bool F_426 ( struct V_2 * V_3 ,
...
static int F_428 ( struct V_2 * V_3 )
{
unsigned long V_4 ;
T_5 V_776 ;
unsigned long V_676 = F_69 ( V_665 ) ;
T_2 V_749 = F_71 ( V_767 ) ;
T_4 V_66 = 0 ;
if ( ! F_408 ( V_3 ) ||
! F_427 ( V_3 ) )
return 1 ;
V_4 = F_338 ( V_3 , ( ( ( V_749 ) >> 28 ) & 0xf ) ) ;
if ( ! F_426 ( V_3 , V_4 , & V_776 ) ) {
F_415 ( V_3 , V_777 ) ;
F_142 ( V_3 ) ;
return 1 ;
}
if ( V_749 & ( 1u << 10 ) ) {
F_299 ( V_3 , ( ( ( V_749 ) >> 3 ) & 0xf ) ,
V_776 ) ;
} else {
if ( F_412 ( V_3 , V_676 ,
V_749 , & V_66 ) )
return 1 ;
F_429 ( & V_3 -> V_95 . V_768 , V_66 ,
& V_776 , ( F_108 ( V_3 ) ? 8 : 4 ) , NULL ) ;
}
F_413 ( V_3 ) ;
F_142 ( V_3 ) ;
return 1 ;
...
V_749 , & V_66 ) )
return 1 ;
if ( F_417 ( & V_3 -> V_95 . V_768 , V_66 ,
& V_776 , ( F_108 ( V_3 ) ? 8 : 4 ) , & V_766 ) ) {
F_418 ( V_3 , & V_766 ) ;
return 1 ;
}
}
...
V_749 , & V_782 ) )
return 1 ;
if ( F_429 ( & V_3 -> V_95 . V_768 , V_782 ,
( void * ) & F_1 ( V_3 ) -> V_8 . V_740 ,
sizeof( T_5 ) , & V_766 ) ) {
F_418 ( V_3 , & V_766 ) ;
return 1 ;
}
...
static bool F_433 ( struct V_2 * V_3 ,
struct V_7 * V_7 , T_2 V_657 )
{
T_2 V_311 = V_3 -> V_95 . V_350 [ V_693 ] ;
T_1 V_783 ;
...
if ( V_311 < 1024 * 8 ) {
unsigned char V_785 ;
F_434 ( V_3 -> V_12 , V_783 + V_311 / 8 , & V_785 , 1 ) ;
return 1 & ( V_785 >> ( V_311 & 7 ) ) ;
} else
return 1 ;
}
static bool F_435 ( struct V_2 * V_3 ,
struct V_7 * V_7 )
{
unsigned long V_676 = F_69 ( V_665 ) ;
int V_682 = V_676 & 15 ;
int V_348 = ( V_676 >> 8 ) & 15 ;
unsigned long V_681 = F_338 ( V_3 , V_348 ) ;
switch ( ( V_676 >> 4 ) & 3 ) {
case 0 :
switch ( V_682 ) {
case 0 :
...
return 1 ;
case V_817 :
return F_435 ( V_3 , V_7 ) ;
case V_818 :
return F_44 ( V_7 , V_301 ) ;
case V_819 :
return 1 ;
case V_820 :
case V_784 :
return F_433 ( V_3 , V_7 , V_657 ) ;
case V_821 :
return 1 ;
case V_822 :
return F_44 ( V_7 , V_296 ) ;
case V_823 :
...
static void F_438 ( struct V_2 * V_3 , T_5 * V_831 , T_5 * V_832 )
{
* V_831 = F_69 ( V_665 ) ;
* V_832 = F_71 ( V_792 ) ;
}
...
{
struct V_1 * V_58 = F_1 ( V_3 ) ;
T_2 V_657 = V_58 -> V_657 ;
T_2 V_833 = V_58 -> V_654 ;
if ( V_58 -> V_416 && V_424 )
return F_390 ( V_3 ) ;
if ( V_58 -> V_8 . V_628 )
F_123 ( V_695 , V_3 ) ;
if ( ! F_90 ( V_3 ) && ( V_657 == V_809 ||
V_657 == V_813 ) )
V_58 -> V_8 . V_628 = 1 ;
else
V_58 -> V_8 . V_628 = 0 ;
if ( F_90 ( V_3 ) && F_436 ( V_3 ) ) {
F_147 ( V_3 ) ;
return 1 ;
}
if ( V_657 & V_834 ) {
V_3 -> V_647 -> V_657 = V_835 ;
V_3 -> V_647 -> V_836 . V_837
= V_657 ;
return 0 ;
}
if ( F_77 ( V_58 -> V_793 ) ) {
...
if ( F_311 ( V_3 ) ) {
V_58 -> V_595 = 0 ;
} else if ( V_58 -> V_621 > 1000000000LL &&
V_3 -> V_95 . V_838 ) {
F_54 ( V_147 L_31
L_32 ,
V_452 , V_3 -> V_839 ) ;
...
if ( V_657 < V_840
&& V_841 [ V_657 ] )
return V_841 [ V_657 ] ( V_3 ) ;
else {
V_3 -> V_647 -> V_657 = V_719 ;
V_3 -> V_647 -> V_720 . V_721 = V_657 ;
}
return 0 ;
}
...
static void F_440 ( struct V_1 * V_58 )
{
T_2 V_655 ;
if ( ! ( V_58 -> V_657 == V_826
|| V_58 -> V_657 == V_794 ) )
return;
V_58 -> V_655 = F_71 ( V_792 ) ;
V_655 = V_58 -> V_655 ;
if ( F_16 ( V_655 ) )
F_316 () ;
if ( ( V_655 & V_15 ) == V_625 &&
...
V_58 -> V_621 +=
F_444 ( F_445 ( F_446 () , V_58 -> V_848 ) ) ;
}
static void F_447 ( struct V_1 * V_58 ,
T_2 V_654 ,
int V_849 ,
int V_850 )
{
...
bool V_846 ;
V_846 = V_654 & V_656 ;
V_58 -> V_3 . V_95 . V_711 = false ;
F_379 ( & V_58 -> V_3 ) ;
F_378 ( & V_58 -> V_3 ) ;
if ( ! V_846 )
return;
F_123 ( V_695 , & V_58 -> V_3 ) ;
V_845 = V_654 & V_851 ;
type = V_654 & V_709 ;
switch ( type ) {
case V_625 :
V_58 -> V_3 . V_95 . V_711 = true ;
F_310 ( & V_58 -> V_3 , false ) ;
break;
case V_250 :
V_58 -> V_3 . V_95 . V_246 =
F_71 ( V_849 ) ;
case V_18 :
if ( V_654 & V_712 ) {
T_2 V_683 = F_71 ( V_850 ) ;
F_170 ( & V_58 -> V_3 , V_845 , V_683 ) ;
} else
F_315 ( & V_58 -> V_3 , V_845 ) ;
break;
case V_620 :
V_58 -> V_3 . V_95 . V_246 =
F_71 ( V_849 ) ;
case V_22 :
F_448 ( & V_58 -> V_3 , V_845 ,
type == V_620 ) ;
break;
default:
break;
...
static void F_449 ( struct V_1 * V_58 )
{
if ( F_90 ( & V_58 -> V_3 ) )
return;
F_447 ( V_58 , V_58 -> V_654 ,
V_235 ,
V_713 ) ;
}
static void F_450 ( struct V_2 * V_3 )
{
if ( F_90 ( V_3 ) )
return;
F_447 ( F_1 ( V_3 ) ,
...
static void F_451 ( struct V_1 * V_58 )
{
int V_60 , V_852 ;
struct V_853 * V_854 ;
V_854 = F_452 ( & V_852 ) ;
...
static void T_16 F_453 ( struct V_2 * V_3 )
{
struct V_1 * V_58 = F_1 ( V_3 ) ;
if ( F_90 ( V_3 ) && ! V_58 -> V_8 . V_628 ) {
struct V_7 * V_7 = F_4 ( V_3 ) ;
if ( V_7 -> V_855 &
V_656 ) {
F_79 ( V_251 ,
...
if ( V_58 -> V_416 && V_424 )
return;
if ( F_136 ( V_349 , ( unsigned long * ) & V_3 -> V_95 . V_460 ) )
F_76 ( V_351 , V_3 -> V_95 . V_350 [ V_349 ] ) ;
if ( F_136 ( V_352 , ( unsigned long * ) & V_3 -> V_95 . V_460 ) )
F_76 ( V_353 , V_3 -> V_95 . V_350 [ V_352 ] ) ;
if ( V_3 -> V_111 & V_638 )
F_141 ( V_3 , 0 ) ;
F_451 ( V_58 ) ;
V_58 -> V_858 = V_58 -> V_75 -> V_77 ;
asm(
"push %%"R"dx; push %%"R"bp;"
"push %%"R"cx \n\t"
"push %%"R"cx \n\t"
...
| ( 1 << V_457 ) ) ;
V_3 -> V_95 . V_460 = 0 ;
V_58 -> V_654 = F_71 ( V_859 ) ;
if ( F_90 ( V_3 ) ) {
struct V_7 * V_7 = F_4 ( V_3 ) ;
V_7 -> V_855 = V_58 -> V_654 ;
if ( V_58 -> V_654 & V_656 ) {
V_7 -> V_857 =
F_71 ( V_713 ) ;
V_7 -> V_856 =
...
V_58 -> V_75 -> V_77 = 1 ;
V_58 -> V_657 = F_71 ( V_791 ) ;
F_454 ( V_58 -> V_657 , V_3 , V_860 ) ;
F_440 ( V_58 ) ;
F_443 ( V_58 ) ;
F_449 ( V_58 ) ;
}
static void F_455 ( struct V_2 * V_3 )
{
struct V_1 * V_58 = F_1 ( V_3 ) ;
F_278 ( V_58 ) ;
F_409 ( V_58 ) ;
...
static struct V_2 * F_458 ( struct V_12 * V_12 , unsigned int V_862 )
{
int V_683 ;
struct V_1 * V_58 = F_459 ( V_861 , V_399 ) ;
int V_76 ;
if ( ! V_58 )
return F_460 ( - V_400 ) ;
F_274 ( V_58 ) ;
V_683 = F_461 ( & V_58 -> V_3 , V_12 , V_862 ) ;
if ( V_683 )
goto V_863;
V_58 -> V_63 = F_402 ( V_389 , V_399 ) ;
V_683 = - V_400 ;
if ( ! V_58 -> V_63 ) {
goto V_864;
}
V_58 -> V_75 = & V_58 -> V_747 ;
V_58 -> V_75 -> V_72 = F_202 () ;
if ( ! V_58 -> V_75 -> V_72 )
goto V_865;
if ( ! V_197 )
F_122 ( F_53 ( F_59 ( V_196 , F_58 () ) ) ) ;
F_55 ( V_58 -> V_75 ) ;
if ( ! V_197 )
F_128 () ;
V_76 = F_462 () ;
...
static void T_11 F_464 ( void * V_867 )
{
struct V_24 V_377 ;
* ( int * ) V_867 = 0 ;
if ( F_196 ( & V_377 ) < 0 )
...
static int F_466 ( void )
{
return V_476 + 1 ;
}
static T_5 F_467 ( struct V_2 * V_3 , T_13 V_868 , bool V_869 )
{
T_5 V_93 ;
if ( V_869 )
V_93 = V_870 << V_871 ;
else if ( V_3 -> V_12 -> V_95 . V_872 &&
! ( V_3 -> V_12 -> V_95 . V_873 & V_874 ) )
V_93 = F_468 ( V_3 , V_868 ) <<
V_871 ;
else
V_93 = ( V_875 << V_871 )
| V_876 ;
...
static void F_470 ( struct V_2 * V_3 )
{
struct V_274 * V_275 ;
struct V_1 * V_58 = F_1 ( V_3 ) ;
T_2 V_570 ;
...
V_570 = F_71 ( V_578 ) ;
if ( V_570 & V_50 ) {
V_275 = F_163 ( V_3 , 0x80000001 , 0 ) ;
if ( V_275 && ( V_275 -> V_879 & V_54 ( V_880 ) ) )
V_58 -> V_260 = true ;
else {
V_570 &= ~ V_50 ;
F_79 ( V_578 ,
...
static void F_471 ( T_2 V_881 , struct V_274 * V_120 )
{
if ( V_881 == 1 && V_8 )
V_120 -> V_276 |= V_54 ( V_277 ) ;
}
static void F_472 ( struct V_2 * V_3 , struct V_7 * V_7 )
{
struct V_1 * V_58 = F_1 ( V_3 ) ;
T_2 V_570 ;
F_78 ( V_882 , V_7 -> V_883 ) ;
F_78 ( V_433 , V_7 -> V_884 ) ;
F_78 ( V_431 , V_7 -> V_885 ) ;
F_78 ( V_886 , V_7 -> V_887 ) ;
F_78 ( V_888 , V_7 -> V_889 ) ;
F_78 ( V_890 , V_7 -> V_891 ) ;
F_78 ( V_600 , V_7 -> V_892 ) ;
F_78 ( V_417 , V_7 -> V_893 ) ;
F_79 ( V_894 , V_7 -> V_895 ) ;
F_79 ( V_447 , V_7 -> V_896 ) ;
F_79 ( V_446 , V_7 -> V_897 ) ;
F_79 ( V_898 , V_7 -> V_899 ) ;
F_79 ( V_900 , V_7 -> V_901 ) ;
F_79 ( V_902 , V_7 -> V_903 ) ;
F_79 ( V_602 , V_7 -> V_904 ) ;
F_79 ( V_419 , V_7 -> V_905 ) ;
F_79 ( V_505 , V_7 -> V_906 ) ;
F_79 ( V_503 , V_7 -> V_907 ) ;
F_79 ( V_908 , V_7 -> V_909 ) ;
F_79 ( V_434 , V_7 -> V_910 ) ;
F_79 ( V_432 , V_7 -> V_911 ) ;
F_79 ( V_912 , V_7 -> V_913 ) ;
F_79 ( V_914 , V_7 -> V_915 ) ;
F_79 ( V_916 , V_7 -> V_917 ) ;
F_79 ( V_603 , V_7 -> V_918 ) ;
F_79 ( V_420 , V_7 -> V_919 ) ;
F_76 ( V_920 , V_7 -> V_921 ) ;
F_76 ( V_448 , V_7 -> V_922 ) ;
F_76 ( V_445 , V_7 -> V_923 ) ;
F_76 ( V_924 , V_7 -> V_925 ) ;
F_76 ( V_335 , V_7 -> V_926 ) ;
F_76 ( V_336 , V_7 -> V_927 ) ;
F_76 ( V_601 , V_7 -> V_928 ) ;
F_76 ( V_418 , V_7 -> V_929 ) ;
F_76 ( V_506 , V_7 -> V_930 ) ;
F_76 ( V_504 , V_7 -> V_931 ) ;
F_80 ( V_605 , V_7 -> V_932 ) ;
F_79 ( V_251 ,
V_7 -> V_933 ) ;
F_79 ( V_243 ,
V_7 -> V_934 ) ;
...
F_79 ( V_228 ,
V_7 -> V_936 ) ;
F_79 ( V_237 , V_7 -> V_937 ) ;
F_79 ( V_339 , V_7 -> V_938 ) ;
F_76 ( V_358 , V_7 -> V_939 ) ;
F_76 ( V_222 , V_7 -> V_940 ) ;
F_76 ( V_604 ,
V_7 -> V_941 ) ;
F_76 ( V_342 , V_7 -> V_942 ) ;
F_76 ( V_341 , V_7 -> V_943 ) ;
F_80 ( V_576 , - 1ull ) ;
F_79 ( V_577 ,
( V_24 . V_51 |
V_7 -> V_57 ) ) ;
...
F_79 ( V_468 , V_570 ) ;
F_89 ( V_3 ) ;
V_3 -> V_95 . V_209 &= ~ V_7 -> V_210 ;
F_76 ( V_211 , ~ V_3 -> V_95 . V_209 ) ;
F_79 ( V_122 ,
V_7 -> V_948 | V_24 . V_393 ) ;
F_79 ( V_121 , V_7 -> V_949 |
( V_24 . V_344 & ~ V_289 ) ) ;
if ( V_7 -> V_949 & V_288 )
F_80 ( V_345 , V_7 -> V_950 ) ;
else if ( V_24 . V_344 & V_288 )
F_80 ( V_345 , V_58 -> V_3 . V_95 . V_346 ) ;
F_285 ( V_58 ) ;
if ( V_7 -> V_55 & V_271 )
F_80 ( V_267 ,
V_58 -> V_8 . V_268 + V_7 -> V_266 ) ;
else
F_80 ( V_267 , V_58 -> V_8 . V_268 ) ;
if ( V_402 ) {
F_78 ( V_610 , V_58 -> V_42 ) ;
F_227 ( V_3 ) ;
}
if ( V_7 -> V_949 & V_127 )
V_3 -> V_95 . V_158 = V_7 -> V_951 ;
if ( V_7 -> V_949 & V_289 )
V_3 -> V_95 . V_158 |= ( V_161 | V_162 ) ;
else
V_3 -> V_95 . V_158 &= ~ ( V_161 | V_162 ) ;
F_223 ( V_3 , V_3 -> V_95 . V_158 ) ;
F_238 ( V_3 , V_7 -> V_213 ) ;
F_76 ( V_218 , F_131 ( V_7 ) ) ;
F_236 ( V_3 , V_7 -> V_215 ) ;
...
F_341 ( V_3 , V_7 -> V_479 ) ;
F_222 ( V_3 ) ;
F_299 ( V_3 , V_349 , V_7 -> V_952 ) ;
F_299 ( V_3 , V_352 , V_7 -> V_953 ) ;
}
static int F_422 ( struct V_2 * V_3 , bool V_954 )
{
struct V_7 * V_7 ;
struct V_1 * V_58 = F_1 ( V_3 ) ;
int V_76 ;
...
if ( ( V_7 -> V_55 & V_26 ) &&
! F_419 ( V_7 -> V_255 , V_389 ) ) {
F_415 ( V_3 , V_957 ) ;
return 1 ;
}
if ( F_45 ( V_7 , V_30 ) &&
! F_419 ( V_7 -> V_946 , V_389 ) ) {
F_415 ( V_3 , V_957 ) ;
return 1 ;
}
if ( V_7 -> V_958 > 0 ||
...
if ( ( ( V_7 -> V_961 & F_171 ) != F_171 ) ||
( ( V_7 -> V_962 & F_172 ) != F_172 ) ) {
F_415 ( V_3 ,
V_963 ) ;
return 1 ;
}
if ( ( ( V_7 -> V_213 & F_171 ) != F_171 ) ||
( ( V_7 -> V_215 & F_172 ) != F_172 ) ) {
F_474 ( V_3 , V_7 ,
V_821 , V_964 ) ;
return 1 ;
}
...
F_476 ( struct V_2 * V_3 , struct V_7 * V_7 )
{
return
( F_69 ( V_206 ) & V_3 -> V_95 . V_209 ) |
( V_7 -> V_213 & V_7 -> V_210 ) |
( F_69 ( V_218 ) & ~ ( V_7 -> V_210 |
V_3 -> V_95 . V_209 ) ) ;
}
static inline unsigned long
F_477 ( struct V_2 * V_3 , struct V_7 * V_7 )
{
return
( F_69 ( V_421 ) & V_3 -> V_95 . V_458 ) |
( V_7 -> V_215 & V_7 -> V_216 ) |
( F_69 ( V_423 ) & ~ ( V_7 -> V_216 |
V_3 -> V_95 . V_458 ) ) ;
}
void F_478 ( struct V_2 * V_3 , struct V_7 * V_7 )
{
V_7 -> V_213 = F_476 ( V_3 , V_7 ) ;
V_7 -> V_215 = F_477 ( V_3 , V_7 ) ;
F_349 ( V_3 , 7 , ( unsigned long * ) & V_7 -> V_939 ) ;
V_7 -> V_952 = F_338 ( V_3 , V_349 ) ;
V_7 -> V_953 = F_338 ( V_3 , V_352 ) ;
V_7 -> V_940 = F_69 ( V_222 ) ;
V_7 -> V_883 = F_70 ( V_882 ) ;
V_7 -> V_884 = F_70 ( V_433 ) ;
V_7 -> V_885 = F_70 ( V_431 ) ;
V_7 -> V_887 = F_70 ( V_886 ) ;
V_7 -> V_889 = F_70 ( V_888 ) ;
V_7 -> V_891 = F_70 ( V_890 ) ;
V_7 -> V_892 = F_70 ( V_600 ) ;
V_7 -> V_893 = F_70 ( V_417 ) ;
V_7 -> V_895 = F_71 ( V_894 ) ;
V_7 -> V_896 = F_71 ( V_447 ) ;
V_7 -> V_897 = F_71 ( V_446 ) ;
V_7 -> V_899 = F_71 ( V_898 ) ;
V_7 -> V_901 = F_71 ( V_900 ) ;
V_7 -> V_903 = F_71 ( V_902 ) ;
V_7 -> V_904 = F_71 ( V_602 ) ;
V_7 -> V_905 = F_71 ( V_419 ) ;
V_7 -> V_906 = F_71 ( V_505 ) ;
V_7 -> V_907 = F_71 ( V_503 ) ;
V_7 -> V_909 = F_71 ( V_908 ) ;
V_7 -> V_910 = F_71 ( V_434 ) ;
V_7 -> V_911 = F_71 ( V_432 ) ;
V_7 -> V_913 = F_71 ( V_912 ) ;
V_7 -> V_915 = F_71 ( V_914 ) ;
V_7 -> V_917 = F_71 ( V_916 ) ;
V_7 -> V_918 = F_71 ( V_603 ) ;
V_7 -> V_919 = F_71 ( V_420 ) ;
V_7 -> V_921 = F_69 ( V_920 ) ;
V_7 -> V_922 = F_69 ( V_448 ) ;
V_7 -> V_923 = F_69 ( V_445 ) ;
V_7 -> V_925 = F_69 ( V_924 ) ;
V_7 -> V_926 = F_69 ( V_335 ) ;
V_7 -> V_927 = F_69 ( V_336 ) ;
V_7 -> V_928 = F_69 ( V_601 ) ;
V_7 -> V_929 = F_69 ( V_418 ) ;
V_7 -> V_930 = F_69 ( V_506 ) ;
V_7 -> V_931 = F_69 ( V_504 ) ;
V_7 -> V_937 = F_71 ( V_237 ) ;
V_7 -> V_936 =
F_71 ( V_228 ) ;
V_7 -> V_941 =
F_69 ( V_604 ) ;
V_7 -> V_932 = F_72 ( V_605 ) ;
if ( V_7 -> V_949 & V_387 )
V_7 -> V_950 = F_72 ( V_345 ) ;
V_7 -> V_938 = F_71 ( V_339 ) ;
V_7 -> V_942 = F_69 ( V_342 ) ;
V_7 -> V_943 = F_69 ( V_341 ) ;
V_7 -> V_629 = F_71 ( V_791 ) ;
V_7 -> V_676 = F_69 ( V_665 ) ;
V_7 -> V_631 = F_71 ( V_792 ) ;
V_7 -> V_967 = F_71 ( V_664 ) ;
V_7 -> V_855 =
F_71 ( V_859 ) ;
V_7 -> V_857 =
F_71 ( V_713 ) ;
V_7 -> V_856 = F_71 ( V_235 ) ;
V_7 -> V_749 = F_71 ( V_767 ) ;
if ( ! ( V_7 -> V_629 & V_834 ) )
V_7 -> V_933 &= ~ V_17 ;
}
void F_479 ( struct V_2 * V_3 , struct V_7 * V_7 )
{
if ( V_7 -> V_948 & V_128 )
V_3 -> V_95 . V_158 = V_7 -> V_968 ;
if ( V_7 -> V_948 & V_284 )
V_3 -> V_95 . V_158 |= ( V_161 | V_162 ) ;
else
V_3 -> V_95 . V_158 &= ~ ( V_161 | V_162 ) ;
F_223 ( V_3 , V_3 -> V_95 . V_158 ) ;
F_299 ( V_3 , V_349 , V_7 -> V_947 ) ;
F_299 ( V_3 , V_352 , V_7 -> V_969 ) ;
F_333 ( V_3 , V_7 -> V_961 ) ;
F_89 ( V_3 ) ;
V_3 -> V_95 . V_209 = ( V_3 -> V_117 ? V_207 : 0 ) ;
F_76 ( V_211 , ~ V_3 -> V_95 . V_209 ) ;
V_3 -> V_95 . V_458 = ~ F_69 ( V_569 ) ;
F_335 ( V_3 , V_7 -> V_962 ) ;
F_341 ( V_3 , V_7 -> V_970 ) ;
F_222 ( V_3 ) ;
if ( V_402 ) {
...
F_79 ( V_339 , V_7 -> V_971 ) ;
F_76 ( V_342 , V_7 -> V_972 ) ;
F_76 ( V_341 , V_7 -> V_973 ) ;
F_76 ( V_504 , V_7 -> V_974 ) ;
F_76 ( V_506 , V_7 -> V_975 ) ;
F_76 ( V_418 , V_7 -> V_976 ) ;
F_76 ( V_336 , V_7 -> V_977 ) ;
F_76 ( V_335 , V_7 -> V_978 ) ;
F_78 ( V_882 , V_7 -> V_979 ) ;
F_78 ( V_433 , V_7 -> V_980 ) ;
F_78 ( V_431 , V_7 -> V_981 ) ;
F_78 ( V_886 , V_7 -> V_982 ) ;
F_78 ( V_888 , V_7 -> V_983 ) ;
F_78 ( V_890 , V_7 -> V_984 ) ;
F_78 ( V_417 , V_7 -> V_985 ) ;
if ( V_7 -> V_948 & V_388 )
F_80 ( V_345 , V_7 -> V_986 ) ;
if ( V_7 -> V_948 & V_132 )
F_80 ( V_144 ,
V_7 -> V_987 ) ;
}
...
static void F_474 ( struct V_2 * V_3 ,
struct V_7 * V_7 ,
T_2 V_707 , unsigned long V_988 )
{
F_479 ( V_3 , V_7 ) ;
V_7 -> V_629 = V_707 | V_834 ;
V_7 -> V_676 = V_988 ;
F_413 ( V_3 ) ;
}
static int F_481 ( struct V_2 * V_3 ,
struct V_989 * V_990 ,
enum V_991 V_992 )
{
return V_993 ;
}
static int T_11 F_482 ( void )
{
int V_519 , V_60 ;
F_483 ( V_125 , & V_163 ) ;
for ( V_60 = 0 ; V_60 < V_591 ; ++ V_60 )
F_484 ( V_60 , V_62 [ V_60 ] ) ;
V_573 = ( unsigned long * ) F_485 ( V_399 ) ;
if ( ! V_573 )
return - V_400 ;
V_575 = ( unsigned long * ) F_485 ( V_399 ) ;
if ( ! V_575 ) {
V_519 = - V_400 ;
goto V_521;
}
V_263 = ( unsigned long * ) F_485 ( V_399 ) ;
if ( ! V_263 ) {
V_519 = - V_400 ;
goto V_994;
}
V_262 = ( unsigned long * ) F_485 ( V_399 ) ;
if ( ! V_262 ) {
V_519 = - V_400 ;
goto V_995;
}
...
memset ( V_263 , 0xff , V_389 ) ;
memset ( V_262 , 0xff , V_389 ) ;
F_487 ( 0 , V_545 ) ;
V_519 = F_488 ( & V_996 , sizeof( struct V_1 ) ,
F_489 ( struct V_1 ) , V_997 ) ;
if ( V_519 )
goto V_998;
F_280 ( V_185 , false ) ;
F_280 ( V_187 , false ) ;
...
return 0 ;
V_998:
F_493 ( ( unsigned long ) V_262 ) ;
V_995:
F_493 ( ( unsigned long ) V_263 ) ;
V_994:
F_493 ( ( unsigned long ) V_575 ) ;
V_521:
F_493 ( ( unsigned long ) V_573 ) ;
return V_519 ;
}
static void T_12 F_494 ( void )
{
F_493 ( ( unsigned long ) V_263 ) ;
F_493 ( ( unsigned long ) V_262 ) ;
F_493 ( ( unsigned long ) V_575 ) ;
