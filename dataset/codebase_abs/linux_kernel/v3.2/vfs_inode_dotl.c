...
V_1 -> V_5 = V_113 -> V_153 ;
F_72 ( V_1 , V_113 -> V_154 ) ;
V_83 = V_113 -> V_17 & V_155 ;
V_83 |= V_1 -> V_3 & ~ V_155 ;
V_1 -> V_3 = V_83 ;
F_73 ( V_1 , V_113 -> V_156 ) ;
V_1 -> V_157 = V_113 -> V_158 ;
} else {
if ( V_113 -> V_141 & V_159 ) {
V_1 -> V_142 . V_132 = V_113 -> V_143 ;
V_1 -> V_142 . V_134 = V_113 -> V_144 ;
}
...
if ( V_113 -> V_141 & V_167 )
V_1 -> V_166 = F_20 ( V_113 -> V_36 ) ;
...
static int
F_77 ( struct V_1 * V_77 , struct V_6 * V_6 ,
const char * V_172 )
{
int V_81 ;
T_1 V_82 ;
...
V_82 = F_1 ( V_77 ) ;
V_81 = F_78 ( V_87 , V_84 , ( char * ) V_172 , V_82 , & V_20 ) ;
if ( V_81 < 0 ) {
F_38 ( V_96 , L_13 , V_81 ) ;
goto error;
}
...
static int
F_79 ( struct V_6 * V_174 , struct V_1 * V_77 ,
struct V_6 * V_6 )
{
int V_81 ;
char * V_84 ;
struct V_6 * V_106 ;
struct V_25 * V_87 , * V_175 ;
struct V_30 * V_31 ;
F_38 ( V_96 , L_14 ,
V_77 -> V_29 , V_174 -> V_95 . V_84 ,
V_6 -> V_95 . V_84 ) ;
V_31 = F_36 ( V_77 ) ;
V_106 = F_4 ( V_77 ) ;
V_87 = F_39 ( V_106 ) ;
...
return F_40 ( V_175 ) ;
V_84 = ( char * ) V_6 -> V_95 . V_84 ;
V_81 = F_80 ( V_87 , V_175 , ( char * ) V_6 -> V_95 . V_84 ) ;
if ( V_81 < 0 ) {
F_38 ( V_96 , L_15 , V_81 ) ;
return V_81 ;
}
...
if ( F_29 ( V_26 ) )
return F_40 ( V_26 ) ;
F_81 ( V_26 , V_174 -> V_115 ) ;
}
F_82 ( V_174 -> V_115 ) ;
F_47 ( V_6 , V_174 -> V_115 ) ;
return V_81 ;
}
static int
...
F_38 ( V_96 ,
L_16 , V_77 -> V_29 ,
V_6 -> V_95 . V_84 , V_78 , F_83 ( V_176 ) , F_84 ( V_176 ) ) ;
if ( ! F_85 ( V_176 ) )
return - V_177 ;
V_31 = F_36 ( V_77 ) ;
V_106 = F_4 ( V_77 ) ;
...
V_84 = ( char * ) V_6 -> V_95 . V_84 ;
V_81 = F_86 ( V_87 , V_84 , V_83 , V_176 , V_82 , & V_20 ) ;
if ( V_81 < 0 )
goto error;
F_44 ( V_77 ) ;
if ( V_31 -> V_100 == V_108 || V_31 -> V_100 == V_109 ) {
...
static void *
F_87 ( struct V_6 * V_6 , struct V_79 * V_80 )
{
int V_28 ;
struct V_25 * V_26 ;
char * V_178 = F_88 () ;
...
int F_81 ( struct V_25 * V_26 , struct V_1 * V_1 )
{
T_5 V_181 ;
struct V_14 * V_15 ;
struct V_30 * V_31 ;
