...
{
return F_58 ( V_2 , & V_2 -> V_19 . V_104 , V_2 -> V_19 . V_17 ) ;
}
...
V_23 -> V_58 ( V_2 , V_222 , & V_202 , 0 , V_86 ) ;
...
V_247 -> V_250 = V_2 -> V_90 [ V_198 ] ;
V_247 -> V_251 = V_2 -> V_90 [ V_157 ] ;
V_247 -> V_252 = V_2 -> V_90 [ V_218 ] ;
...
V_2 -> V_90 [ V_198 ] = V_247 -> V_250 ;
V_2 -> V_90 [ V_157 ] = V_247 -> V_251 ;
V_2 -> V_90 [ V_218 ] = V_247 -> V_252 ;
...
F_20 ( V_2 , V_247 -> V_202 , V_86 ) ;
F_20 ( V_2 , V_247 -> V_219 , V_77 ) ;
F_20 ( V_2 , V_247 -> V_256 , V_126 ) ;
V_171 = F_52 ( V_2 , V_247 -> V_257 , V_163 ) ;
if ( V_171 != V_76 )
return V_171 ;
V_171 = F_52 ( V_2 , V_247 -> V_254 , V_255 ) ;
if ( V_171 != V_76 )
return V_171 ;
V_171 = F_52 ( V_2 , V_247 -> V_202 , V_86 ) ;
if ( V_171 != V_76 )
return V_171 ;
V_171 = F_52 ( V_2 , V_247 -> V_219 , V_77 ) ;
if ( V_171 != V_76 )
return V_171 ;
V_171 = F_52 ( V_2 , V_247 -> V_256 , V_126 ) ;
if ( V_171 != V_76 )
return V_171 ;
return V_76 ;
}
...
V_247 -> V_268 = V_2 -> V_90 [ V_198 ] ;
V_247 -> V_269 = V_2 -> V_90 [ V_157 ] ;
V_247 -> V_270 = V_2 -> V_90 [ V_218 ] ;
...
V_2 -> V_90 [ V_198 ] = V_247 -> V_268 ;
V_2 -> V_90 [ V_157 ] = V_247 -> V_269 ;
V_2 -> V_90 [ V_218 ] = V_247 -> V_270 ;
...
V_171 = F_52 ( V_2 , V_247 -> V_278 , V_163 ) ;
if ( V_171 != V_76 )
return V_171 ;
V_171 = F_52 ( V_2 , V_247 -> V_254 , V_255 ) ;
if ( V_171 != V_76 )
...
if ( V_171 != V_76 )
return V_171 ;
V_171 = F_52 ( V_2 , V_247 -> V_276 , V_37 ) ;
if ( V_171 != V_76 )
return V_171 ;
V_171 = F_52 ( V_2 , V_247 -> V_277 , V_172 ) ;
if ( V_171 != V_76 )
return V_171 ;
return V_76 ;
}
...
V_23 -> V_38 ( V_2 , V_176 ) ;
T_1 V_284 ;
V_171 = F_50 ( V_2 , V_258 , & V_283 ) ;
if ( V_171 != V_76 )
return V_171 ;
V_171 = F_50 ( V_2 , V_259 , & V_282 ) ;
if ( V_171 != V_76 )
return V_171 ;
if ( V_280 != V_285 ) {
...
V_259 = 0xffff ;
if ( V_283 . type & 8 )
V_171 = F_100 ( V_2 , V_258 , V_259 ,
V_260 , & V_283 ) ;
else
V_171 = F_97 ( V_2 , V_258 , V_259 ,
V_260 , & V_283 ) ;
if ( V_171 != V_76 )
return V_171 ;
if ( V_280 == V_288 || V_280 == V_289 )
...
V_2 -> V_27 = V_2 -> V_22 ;
V_2 -> V_19 . type = V_179 ;
V_79 = F_101 ( V_2 , V_258 , V_280 ,
V_281 , V_43 ) ;
if ( V_79 == V_76 )
V_2 -> V_22 = V_2 -> V_27 ;
return ( V_79 == V_89 ) ? V_291 : V_292 ;
}
static void F_103 ( struct V_1 * V_2 , unsigned V_32 ,
...
{
V_105 V_303 = 0 ;
V_2 -> V_23 -> V_225 ( V_2 , V_304 , & V_303 ) ;
V_2 -> V_90 [ V_198 ] = ( T_1 ) V_303 ;
V_2 -> V_90 [ V_218 ] = V_303 >> 32 ;
return V_76 ;
}
...
{
T_3 V_308 ;
V_308 = V_2 -> V_23 -> V_267 ( V_2 , 0 ) ;
V_308 &= ~ V_290 ;
V_2 -> V_23 -> V_279 ( V_2 , 0 , V_308 ) ;
return V_76 ;
}
...
if ( ! F_139 ( V_316 ) )
return F_15 ( V_2 ) ;
if ( V_315 & V_317 [ V_316 ] )
return F_13 ( V_2 , 0 ) ;
switch ( V_316 ) {
case 0 : {
V_105 V_320 ;
if ( ( ( V_315 & V_321 ) && ! ( V_315 & V_322 ) ) ||
( ( V_315 & V_323 ) && ! ( V_315 & V_324 ) ) )
return F_13 ( V_2 , 0 ) ;
V_320 = V_2 -> V_23 -> V_267 ( V_2 , 4 ) ;
V_2 -> V_23 -> V_225 ( V_2 , V_226 , & V_224 ) ;
if ( ( V_315 & V_321 ) && ( V_224 & V_325 ) &&
! ( V_320 & V_326 ) )
return F_13 ( V_2 , 0 ) ;
break;
}
...
if ( V_224 & V_228 )
V_327 = V_328 ;
else if ( V_2 -> V_23 -> V_267 ( V_2 , 4 ) & V_326 )
V_327 = V_329 ;
else if ( V_2 -> V_23 -> V_267 ( V_2 , 0 ) & V_321 )
V_327 = V_330 ;
if ( V_315 & V_327 )
return F_13 ( V_2 , 0 ) ;
break;
...
return F_15 ( V_2 ) ;
V_320 = V_2 -> V_23 -> V_267 ( V_2 , 4 ) ;
if ( ( V_320 & V_334 ) && ( V_333 == 4 || V_333 == 5 ) )
return F_15 ( V_2 ) ;
if ( F_142 ( V_2 ) )
return F_12 ( V_2 ) ;
return V_76 ;
...
V_105 V_315 = V_2 -> V_14 . V_15 ;
int V_333 = V_2 -> V_11 ;
if ( ( V_333 == 6 || V_333 == 7 ) && ( V_315 & 0xffffffff00000000ULL ) )
return F_13 ( V_2 , 0 ) ;
return F_143 ( V_2 ) ;
}
...
{
V_105 V_336 = V_2 -> V_90 [ V_198 ] ;
if ( V_336 & 0xffff000000000000ULL )
return F_13 ( V_2 , 0 ) ;
return F_145 ( V_2 ) ;
}
static int F_147 ( struct V_1 * V_2 )
{
V_105 V_320 = V_2 -> V_23 -> V_267 ( V_2 , 4 ) ;
if ( V_320 & V_337 && V_2 -> V_23 -> V_69 ( V_2 ) )
return F_15 ( V_2 ) ;
return V_76 ;
}
...
if ( ( ! ( V_320 & V_339 ) && V_2 -> V_23 -> V_69 ( V_2 ) ) ||
( V_338 > 3 ) )
return F_13 ( V_2 , 0 ) ;
return V_76 ;
}
...
if ( ! F_94 ( V_2 , V_2 -> V_14 . V_104 , V_2 -> V_19 . V_17 ) )
return F_13 ( V_2 , 0 ) ;
return V_76 ;
}
...
if ( ! F_94 ( V_2 , V_2 -> V_19 . V_104 , V_2 -> V_14 . V_17 ) )
return F_13 ( V_2 , 0 ) ;
return V_76 ;
}
static unsigned F_151 ( struct V_1 * V_2 )
{
unsigned V_61 ;
...
F_38 ( V_2 , V_103 ,
V_103 == & V_2 -> V_19 &&
V_2 -> V_342 && ( V_2 -> V_111 == 0xb6 || V_2 -> V_111 == 0xb7 ) ) ;
break;
case V_343 :
V_79 = F_152 ( V_2 , V_103 , 1 , false ) ;
break;
case V_344 :
V_2 -> V_345 . V_17 = ( V_2 -> V_74 & V_117 ) ? 1 : V_2 -> V_94 ;
V_346:
* V_103 = V_2 -> V_345 ;
V_2 -> V_347 = V_103 ;
if ( ( V_2 -> V_74 & V_348 ) && V_103 == & V_2 -> V_19 )
F_42 ( V_2 ) ;
V_103 -> V_118 = V_103 -> V_104 ;
break;
case V_349 :
...
break;
case V_356 :
V_79 = F_152 ( V_2 , V_103 , F_151 ( V_2 ) , true ) ;
break;
case V_357 :
V_2 -> V_345 . V_17 = 2 ;
goto V_346;
...
goto V_346;
case V_359 :
V_79 = F_152 ( V_2 , V_103 , 2 , false ) ;
break;
case V_360 :
V_79 = F_152 ( V_2 , V_103 , F_151 ( V_2 ) , false ) ;
break;
case V_361 :
V_103 -> type = V_127 ;
V_103 -> V_17 = ( V_2 -> V_74 & V_117 ) ? 1 : V_2 -> V_94 ;
...
F_154 ( V_103 -> V_212 , V_103 -> V_17 , V_2 ) ;
break;
case V_363 :
V_2 -> V_345 . V_17 = V_2 -> V_94 + 2 ;
goto V_346;
case V_364 :
V_103 -> V_104 = V_255 ;
break;
...
int F_155 ( struct V_1 * V_2 , void * V_371 , int V_372 )
{
int V_79 = V_76 ;
int V_35 = V_2 -> V_35 ;
...
bool V_377 = false ;
struct V_378 V_378 ;
V_2 -> V_345 . type = V_179 ;
V_2 -> V_347 = NULL ;
V_2 -> V_27 = V_2 -> V_22 ;
V_2 -> V_63 . V_87 = V_2 -> V_27 ;
V_2 -> V_63 . V_85 = V_2 -> V_63 . V_87 + V_372 ;
if ( V_372 > 0 )
memcpy ( V_2 -> V_63 . V_78 , V_371 , V_372 ) ;
switch ( V_35 ) {
case V_72 :
case V_173 :
case V_193 :
...
if ( V_2 -> V_109 & 8 )
V_2 -> V_94 = 8 ;
V_378 = V_380 [ V_2 -> V_111 ] ;
if ( V_2 -> V_111 == 0x0f ) {
V_2 -> V_342 = 1 ;
V_2 -> V_111 = F_40 ( T_4 , V_2 ) ;
V_378 = V_381 [ V_2 -> V_111 ] ;
}
V_2 -> V_74 = V_378 . V_96 ;
while ( V_2 -> V_74 & V_382 ) {
switch ( V_2 -> V_74 & V_382 ) {
case V_383 :
V_2 -> V_124 = F_40 ( T_4 , V_2 ) ;
-- V_2 -> V_27 ;
V_375 = ( V_2 -> V_124 >> 3 ) & 7 ;
V_378 = V_378 . V_384 . V_385 [ V_375 ] ;
break;
case V_386 :
V_2 -> V_124 = F_40 ( T_4 , V_2 ) ;
-- V_2 -> V_27 ;
V_375 = ( V_2 -> V_124 >> 3 ) & 7 ;
if ( ( V_2 -> V_124 >> 6 ) == 3 )
V_378 = V_378 . V_384 . V_387 -> V_388 [ V_375 ] ;
else
V_378 = V_378 . V_384 . V_387 -> V_389 [ V_375 ] ;
break;
case V_390 :
V_375 = V_2 -> V_124 & 7 ;
V_378 = V_378 . V_384 . V_385 [ V_375 ] ;
...
if ( V_2 -> V_9 && V_377 )
return V_291 ;
V_376 = V_377 ? 0x66 : V_2 -> V_9 ;
switch ( V_376 ) {
case 0x00 : V_378 = V_378 . V_384 . V_392 -> V_393 ; break;
case 0x66 : V_378 = V_378 . V_384 . V_392 -> V_394 ; break;
case 0xf2 : V_378 = V_378 . V_384 . V_392 -> V_395 ; break;
case 0xf3 : V_378 = V_378 . V_384 . V_392 -> V_396 ; break;
}
break;
default:
return V_291 ;
}
V_2 -> V_74 &= ~ ( V_105 ) V_382 ;
V_2 -> V_74 |= V_378 . V_96 ;
}
V_2 -> V_397 = V_378 . V_384 . V_397 ;
V_2 -> V_398 = V_378 . V_398 ;
V_2 -> V_4 = V_378 . V_4 ;
if ( V_2 -> V_74 == 0 || ( V_2 -> V_74 & V_399 ) )
return V_291 ;
if ( ! ( V_2 -> V_74 & V_400 ) && V_2 -> V_401 )
return V_291 ;
if ( V_35 == V_36 && ( V_2 -> V_74 & V_402 ) )
V_2 -> V_94 = 8 ;
if ( V_2 -> V_74 & V_403 ) {
if ( V_35 == V_36 )
V_2 -> V_94 = 8 ;
...
V_2 -> V_94 = 16 ;
if ( V_2 -> V_74 & V_110 ) {
V_79 = F_39 ( V_2 , & V_2 -> V_345 ) ;
if ( ! V_2 -> V_33 )
F_9 ( V_2 , V_2 -> V_125 ) ;
} else if ( V_2 -> V_74 & V_404 )
V_79 = F_41 ( V_2 , & V_2 -> V_345 ) ;
if ( V_79 != V_76 )
goto V_140;
if ( ! V_2 -> V_33 )
F_9 ( V_2 , V_126 ) ;
V_2 -> V_345 . V_60 . V_139 . V_32 = V_34 ( V_2 ) ;
if ( V_2 -> V_345 . type == V_127 && V_2 -> V_20 != 8 )
V_2 -> V_345 . V_60 . V_139 . V_71 = ( T_1 ) V_2 -> V_345 . V_60 . V_139 . V_71 ;
V_79 = F_153 ( V_2 , & V_2 -> V_14 , ( V_2 -> V_74 >> V_405 ) & V_406 ) ;
if ( V_79 != V_76 )
goto V_140;
V_79 = F_153 ( V_2 , & V_2 -> V_196 , ( V_2 -> V_74 >> V_407 ) & V_406 ) ;
if ( V_79 != V_76 )
goto V_140;
V_79 = F_153 ( V_2 , & V_2 -> V_19 , ( V_2 -> V_74 >> V_408 ) & V_406 ) ;
V_140:
if ( V_2 -> V_347 && V_2 -> V_347 -> type == V_127 && V_2 -> V_138 )
V_2 -> V_347 -> V_60 . V_139 . V_71 += V_2 -> V_27 ;
return ( V_79 != V_76 ) ? V_291 : V_292 ;
}
...
V_105 V_221 ;
int V_79 = V_76 ;
int V_411 = V_2 -> V_19 . type ;
V_2 -> V_146 . V_148 = 0 ;
if ( V_2 -> V_35 == V_36 && ( V_2 -> V_74 & V_412 ) ) {
V_79 = F_15 ( V_2 ) ;
goto V_140;
}
if ( V_2 -> V_178 && ( ! ( V_2 -> V_74 & V_413 ) || V_2 -> V_19 . type != V_127 ) ) {
V_79 = F_15 ( V_2 ) ;
goto V_140;
}
if ( ( V_2 -> V_74 & V_414 ) == V_415 && V_2 -> V_14 . type != V_127 ) {
V_79 = F_15 ( V_2 ) ;
goto V_140;
}
if ( ( V_2 -> V_74 & V_112 )
&& ( ( V_23 -> V_267 ( V_2 , 0 ) & V_416 )
|| ! ( V_23 -> V_267 ( V_2 , 4 ) & V_417 ) ) ) {
V_79 = F_15 ( V_2 ) ;
goto V_140;
}
...
if ( F_28 ( V_2 -> V_418 ) && V_2 -> V_4 ) {
V_79 = F_1 ( V_2 , V_2 -> V_4 ,
V_419 ) ;
if ( V_79 != V_76 )
goto V_140;
}
if ( ( V_2 -> V_74 & V_420 ) && V_23 -> V_69 ( V_2 ) ) {
V_79 = F_13 ( V_2 , 0 ) ;
goto V_140;
}
if ( ( V_2 -> V_74 & V_421 ) && ! ( V_2 -> V_35 & V_422 ) ) {
V_79 = F_15 ( V_2 ) ;
goto V_140;
}
if ( V_2 -> V_398 ) {
...
if ( ( V_2 -> V_14 . type == V_127 ) && ! ( V_2 -> V_74 & V_424 ) ) {
...
if ( ( V_2 -> V_74 & V_425 ) == V_426 )
goto V_427;
if ( ( V_2 -> V_19 . type == V_127 ) && ! ( V_2 -> V_74 & V_428 ) ) {
...
case 0x6c :
case 0x6d :
V_2 -> V_14 . V_104 = V_2 -> V_90 [ V_218 ] ;
goto V_432;
case 0x6e :
case 0x6f :
V_2 -> V_19 . V_104 = V_2 -> V_90 [ V_218 ] ;
goto V_433;
break;
case 0x70 ... 0x7f :
...
case 0xef :
V_433:
V_23 -> V_434 ( V_2 , V_2 -> V_14 . V_17 , V_2 -> V_19 . V_104 ,
& V_2 -> V_14 . V_104 , 1 ) ;
V_2 -> V_19 . type = V_179 ;
break;
case 0xf4 :
...
goto V_140;
V_2 -> V_19 . type = V_411 ;
if ( ( V_2 -> V_74 & V_414 ) == V_436 )
F_103 ( V_2 , V_34 ( V_2 ) ,
V_133 , & V_2 -> V_14 ) ;
if ( ( V_2 -> V_74 & V_425 ) == V_437 )
F_103 ( V_2 , V_255 , V_135 ,
& V_2 -> V_19 ) ;
if ( V_2 -> V_9 && ( V_2 -> V_74 & String ) ) {
...
break;
case 0x21 :
V_23 -> V_332 ( V_2 , V_2 -> V_11 , & V_2 -> V_19 . V_104 ) ;
break;
case 0x22 :
...
break;
case 0x23 :
if ( V_23 -> V_443 ( V_2 , V_2 -> V_11 , V_2 -> V_14 . V_104 &
( ( V_2 -> V_35 == V_36 ) ?
~ 0ULL : ~ 0U ) ) < 0 ) {
F_13 ( V_2 , 0 ) ;
V_79 = V_45 ;
...
break;
case 0x30 :
V_221 = ( T_1 ) V_2 -> V_90 [ V_198 ]
| ( ( V_105 ) V_2 -> V_90 [ V_218 ] << 32 ) ;
if ( V_23 -> V_444 ( V_2 , V_2 -> V_90 [ V_157 ] , V_221 ) ) {
F_13 ( V_2 , 0 ) ;
V_79 = V_45 ;
goto V_140;
}
...
V_2 -> V_90 [ V_198 ] = ( T_1 ) V_221 ;
V_2 -> V_90 [ V_218 ] = V_221 >> 32 ;
}
V_79 = V_76 ;
break;
case 0x40 ... 0x4f :
