...
static T_1 F_68 ( const struct V_147 * V_148 , int V_145 )
{
unsigned long V_146 ;
V_146 = F_59 ( V_148 , 4 , V_145 - 4 , 0 ) ;
return V_146 ? F_28 ( ( unsigned short ) V_146 ) : F_28 ( 0xFFFF ) ;
}
static int F_69 ( struct V_65 * V_65 , struct V_160 * V_1 , int V_161 ,
int V_162 )
{
struct V_1 * V_2 ;
int V_163 = - V_164 ;
...
goto V_44;
V_163 = - V_130 ;
V_2 = F_70 ( V_65 , V_168 , V_43 , & V_169 ) ;
if ( ! V_2 )
goto V_44;
V_163 = 0 ;
V_1 -> V_170 = & V_171 ;
...
static int F_73 ( struct V_160 * V_1 )
{
...
static int F_78 ( struct V_1 * V_2 , struct V_5 * V_26 )
{
int V_60 ;
F_4 ( & V_4 ) ;
for ( V_26 -> V_14 = V_173 ;
...
static int F_81 ( struct V_160 * V_1 , struct V_178 * V_179 , int V_180 )
{
...
static int F_83 ( struct V_160 * V_1 , struct V_178 * V_179 ,
int V_180 , int V_61 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_12 * V_13 = F_10 ( V_2 ) ;
...
static T_5 int F_85 ( struct V_147 * V_148 )
{
...
static int F_92 ( struct V_147 * V_148 , struct V_33 * V_34 ,
...
F_93 ( V_148 , F_94 (unsigned int, origlen,
(rt->dev->hard_header_len +
ddp_dl->header_length + (len_hops & 1023))) ) ;
V_206 -> V_214 = F_28 ( V_207 ) ;
if ( F_95 ( V_148 ) < 22 ) {
struct V_147 * V_215 = F_96 ( V_148 , 32 ) ;
F_87 ( V_148 ) ;
V_148 = V_215 ;
} else
V_148 = F_97 ( V_148 , V_91 ) ;
if ( V_148 == NULL )
goto V_216;
if ( F_98 ( V_83 -> V_34 , V_148 , & V_79 , NULL ) == V_217 )
return V_201 ;
return V_218 ;
V_212:
F_87 ( V_148 ) ;
...
static int F_99 ( struct V_147 * V_148 , struct V_33 * V_34 ,
...
if ( ! F_45 ( F_46 ( V_34 ) , & V_100 ) )
goto V_216;
if ( ! ( V_148 = F_100 ( V_148 , V_91 ) ) )
goto V_44;
if ( ! F_101 ( V_148 , sizeof( * V_206 ) ) )
goto V_216;
V_206 = F_102 ( V_148 ) ;
V_207 = F_27 ( V_206 -> V_214 ) ;
V_208 = V_148 -> V_145 ;
F_93 ( V_148 , F_94 (unsigned int, skb->len, len_hops & 1023 ) ) ;
if ( V_148 -> V_145 < sizeof( * V_206 ) || V_148 -> V_145 < ( V_207 & 1023 ) ) {
F_103 ( L_12
L_13 , V_207 & 1023 , V_148 -> V_145 ) ;
goto V_216;
}
if ( V_206 -> V_223 &&
F_68 ( V_148 , V_207 & 1023 ) != V_206 -> V_223 )
goto V_216;
if ( ! V_206 -> V_211 )
...
if ( ! V_8 ) {
return F_92 ( V_148 , V_34 , V_206 , V_207 , V_208 ) ;
}
if ( F_85 ( V_148 ) )
return F_86 ( V_148 ) ;
...
static int F_105 ( struct V_147 * V_148 , struct V_33 * V_34 ,
struct V_219 * V_220 , struct V_33 * V_221 )
{
if ( ! F_45 ( F_46 ( V_34 ) , & V_100 ) )
goto V_225;
...
if ( ! ( V_148 = F_100 ( V_148 , V_91 ) ) )
return 0 ;
V_206 = (struct V_205 * ) F_107 ( V_148 , sizeof( * V_206 ) - 4 ) ;
V_206 -> V_213 = F_106 ( V_148 ) [ 0 ] ;
V_206 -> V_226 = F_106 ( V_148 ) [ 1 ] ;
...
F_89 ( V_148 ) ;
return F_99 ( V_148 , V_34 , V_220 , V_221 ) ;
V_225:
F_87 ( V_148 ) ;
return 0 ;
}
static int F_108 ( struct V_229 * V_230 , struct V_160 * V_1 , struct V_231 * V_232 ,
T_7 V_145 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_12 * V_13 = F_10 ( V_2 ) ;
...
V_239 += V_34 -> V_248 ;
F_77 ( V_2 ) ;
V_148 = F_110 ( V_2 , V_239 , ( V_61 & V_240 ) , & V_181 ) ;
F_75 ( V_2 ) ;
if ( ! V_148 )
goto V_44;
V_148 -> V_2 = V_2 ;
F_111 ( V_148 , V_245 -> V_246 ) ;
F_111 ( V_148 , V_34 -> V_248 ) ;
V_148 -> V_34 = V_34 ;
F_109 ( V_2 , L_16 , V_2 ) ;
V_206 = (struct V_205 * ) F_112 ( V_148 , sizeof( struct V_205 ) ) ;
...
F_109 ( V_2 , L_17 , V_2 , V_145 ) ;
V_181 = F_113 ( F_112 ( V_148 , V_145 ) , V_232 -> V_250 , V_145 ) ;
if ( V_181 ) {
F_87 ( V_148 ) ;
V_181 = - V_114 ;
goto V_44;
...
V_206 -> V_223 = F_68 ( V_148 , V_145 + sizeof( * V_206 ) ) ;
if ( V_206 -> V_213 == V_20 &&
! ( V_83 -> V_61 & V_94 ) && ! ( V_34 -> V_61 & V_62 ) ) {
struct V_147 * V_252 = F_114 ( V_148 , V_43 ) ;
if ( V_252 ) {
V_236 = 1 ;
F_109 ( V_2 , L_18 , V_2 ) ;
F_98 ( V_34 , V_252 , & V_233 -> V_16 , NULL ) ;
}
}
...
F_98 ( V_34 , V_148 , & V_233 -> V_16 , NULL ) ;
}
F_109 ( V_2 , L_21 , V_2 , V_145 ) ;
V_44:
F_77 ( V_2 ) ;
return V_181 ? : V_145 ;
}
static int F_116 ( struct V_229 * V_230 , struct V_160 * V_1 , struct V_231 * V_232 ,
T_7 V_239 , int V_61 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
...
V_181 = F_118 ( V_148 , V_149 , V_232 -> V_250 , V_256 ) ;
if ( ! V_181 ) {
if ( V_26 ) {
V_26 -> V_86 = V_87 ;
...
static int F_120 ( struct V_160 * V_1 , unsigned int V_103 , unsigned long V_104 )
{
int V_163 = - V_259 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
switch ( V_103 ) {
case V_261 : {
long V_262 = V_2 -> V_263 - F_121 ( V_2 ) ;
if ( V_262 < 0 )
V_262 = 0 ;
V_163 = F_122 ( V_262 , ( int T_2 * ) V_260 ) ;
break;
}
case V_264 : {
struct V_147 * V_148 = F_123 ( & V_2 -> V_32 ) ;
long V_262 = 0 ;
if ( V_148 )
...
case V_265 :
V_163 = F_124 ( V_2 , V_260 ) ;
break;
case V_266 :
V_163 = F_125 ( V_2 , V_260 ) ;
break;
case V_141 :
case V_139 :
V_163 = - V_120 ;
...
static int F_128 ( struct V_160 * V_1 , unsigned int V_103 , unsigned long V_104 )
{
if ( V_103 == V_135 )
return F_120 ( V_1 , V_103 , ( unsigned long ) F_129 ( V_104 ) ) ;
return - V_259 ;
}
static int T_8 F_130 ( void )
{
int V_163 = F_131 ( & V_169 , 0 ) ;
if ( V_163 != 0 )
goto V_44;
( void ) F_132 ( & V_267 ) ;
V_245 = F_133 ( V_268 , F_99 ) ;
if ( ! V_245 )
F_52 ( V_269 ) ;
F_134 ( & V_270 ) ;
F_134 ( & V_271 ) ;
