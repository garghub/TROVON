...
static int T_4 F_33 ( struct V_21 * V_22 )
{
struct V_17 * V_18 = NULL ;
int V_19 = 0 ;
struct V_70 * V_71 ;
V_18 = F_34 ( sizeof( struct V_17 ) , V_72 ) ;
if ( ! V_18 )
return - V_73 ;
if ( ! F_35 ( & V_18 -> V_48 . V_74 , V_72 ) ) {
F_36 ( V_18 ) ;
return - V_73 ;
}
V_18 -> V_38 = V_22 -> V_38 ;
strcpy ( F_37 ( V_22 ) , V_75 ) ;
strcpy ( F_38 ( V_22 ) , V_76 ) ;
V_22 -> V_77 = V_18 ;
V_19 = F_8 ( V_22 ) ;
if ( V_19 ) {
return 0 ;
...
return 0 ;
#endif
F_40 ( ( V_18 -> V_45 >= V_79 ) || ( V_18 -> V_45 < 0 ) ) ;
...
V_71 = F_41 ( V_18 -> V_45 ) ;
if ( F_42 ( & V_22 -> V_2 . V_83 , & V_71 -> V_83 , L_21 ) ) {
V_19 = - V_84 ;
goto V_82;
}
#ifdef F_43
...
static int F_56 ( struct V_21 * V_22 , int type )
{
struct V_17 * V_18 = NULL ;
if ( ! V_22 || ! F_9 ( V_22 ) )
return - V_5 ;
...
F_54 ( V_18 , V_22 ) ;
F_52 ( & V_22 -> V_2 . V_83 , L_21 ) ;
if ( V_18 -> V_86 ) {
F_52 ( & V_22 -> V_2 . V_83 , L_24 ) ;
F_52 ( & V_18 -> V_86 -> V_22 . V_83 , L_26 ) ;
F_53 ( V_18 -> V_86 ) ;
V_18 -> V_86 = NULL ;
}
...
static
int F_60 ( T_5 V_38 , struct V_21 * * V_22 )
{
T_5 V_96 ;
struct V_21 * V_97 ;
if ( F_61 ( V_38 , & V_96 ) ) {
...
if ( F_63 ( V_22 , V_97 , V_38 , V_98 ) ) {
return - V_39 ;
}
return 0 ;
}
static void F_64 ( T_5 V_38 ,
T_3 V_53 , void * V_99 )
{
struct V_17 * V_18 ;
