...
static int F_21 ( struct V_21 * V_22 , unsigned int V_35 )
{
struct V_10 * V_11 = F_13 ( V_22 ) ;
switch ( V_35 ) {
case V_36 :
...
static unsigned int F_22 ( struct V_21 * V_22 )
{
struct V_10 * V_11 = F_13 ( V_22 ) ;
int V_7 ;
V_7 = F_5 ( V_11 -> V_2 , V_11 -> V_25 ) ;
...
static int T_1 F_23 ( struct V_1 * V_39 ,
...
unsigned char V_6 ;
int V_7 ;
V_11 = F_24 ( sizeof( struct V_10 ) , V_45 ) ;
if ( ! V_11 ) {
F_15 ( & V_39 -> V_28 , L_2 ) ;
return - V_46 ;
}
...
static int T_2 F_32 ( struct V_1 * V_39 )
{
