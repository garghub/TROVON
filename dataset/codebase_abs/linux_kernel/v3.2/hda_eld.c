...
void F_19 ( int V_56 , char * V_10 , int V_76 )
{
int V_11 , V_78 ;
for ( V_11 = 0 , V_78 = 0 ; V_11 < F_16 ( V_83 ) ; V_11 ++ ) {
if ( V_56 & ( 1 << V_11 ) )
...
static void F_21 ( int V_11 , struct V_8 * V_9 ,
struct V_86 * V_87 )
{
char V_10 [ V_79 ] ;
F_22 ( V_87 , L_20 ,
V_11 , V_9 -> V_17 , V_82 [ V_9 -> V_17 ] ) ;
F_22 ( V_87 , L_21 , V_11 , V_9 -> V_14 ) ;
F_15 ( V_9 -> V_12 , V_10 , sizeof( V_10 ) ) ;
F_22 ( V_87 , L_22 , V_11 , V_9 -> V_12 , V_10 ) ;
if ( V_9 -> V_17 == V_19 ) {
...
F_22 ( V_87 , L_33 , V_41 -> V_93 ) ;
F_22 ( V_87 , L_34 , V_41 -> V_64 ) ;
if ( ! V_41 -> V_64 )
return;
F_22 ( V_87 , L_35 , V_41 -> V_62 ) ;
F_22 ( V_87 , L_36 ,
V_84 [ V_41 -> V_53 ] ) ;
F_22 ( V_87 , L_37 , V_41 -> V_44 ,
V_91 [ V_41 -> V_44 ] ) ;
F_22 ( V_87 , L_38 , V_41 -> V_50 ,
V_92 [ V_41 -> V_50 ] ) ;
F_22 ( V_87 , L_39 , V_41 -> V_58 ) ;
F_22 ( V_87 , L_40 , V_41 -> V_59 ) ;
F_22 ( V_87 , L_41 , ( long long ) V_41 -> V_57 ) ;
F_22 ( V_87 , L_42 , V_41 -> V_51 ) ;
F_22 ( V_87 , L_43 , V_41 -> V_52 ) ;
F_22 ( V_87 , L_44 , V_41 -> V_55 ) ;
F_19 ( V_41 -> V_56 , V_10 , sizeof( V_10 ) ) ;
F_22 ( V_87 , L_45 , V_41 -> V_56 , V_10 ) ;
F_22 ( V_87 , L_46 , V_41 -> V_54 ) ;
for ( V_11 = 0 ; V_11 < V_41 -> V_54 ; V_11 ++ )
F_21 ( V_11 , V_41 -> V_63 + V_11 , V_87 ) ;
}
...
long long V_5 ;
unsigned int V_96 ;
while ( ! F_25 ( V_87 , line , sizeof( line ) ) ) {
if ( sscanf ( line , L_47 , V_94 , & V_5 ) != 2 )
continue;
if ( ! strcmp ( V_94 , L_48 ) )
V_41 -> V_93 = V_5 ;
...
V_41 -> V_56 = V_5 ;
else if ( ! strcmp ( V_94 , L_56 ) )
V_41 -> V_54 = V_5 ;
else if ( ! strncmp ( V_94 , L_57 , 3 ) ) {
V_95 = V_94 + 4 ;
V_96 = V_94 [ 3 ] - '0' ;
...
int F_26 ( struct V_1 * V_2 , struct V_40 * V_68 ,
int V_98 )
{
char V_94 [ 32 ] ;
struct V_88 * V_89 ;
int V_99 ;
snprintf ( V_94 , sizeof( V_94 ) , L_64 , V_2 -> V_100 , V_98 ) ;
V_99 = F_27 ( V_2 -> V_101 -> V_102 , V_94 , & V_89 ) ;
if ( V_99 < 0 )
return V_99 ;
F_28 ( V_89 , V_68 , F_23 ) ;
V_89 -> V_103 . V_104 . V_105 = F_24 ;
V_89 -> V_106 |= V_107 ;
V_68 -> V_108 = V_89 ;
return 0 ;
}
void F_29 ( struct V_1 * V_2 , struct V_40 * V_68 )
{
if ( ! V_2 -> V_101 -> V_109 && V_68 -> V_108 ) {
F_30 ( V_2 -> V_101 -> V_102 , V_68 -> V_108 ) ;
V_68 -> V_108 = NULL ;
}
}
void F_31 ( struct V_40 * V_68 ,
struct V_110 * V_111 )
{
T_2 V_12 ;
T_3 V_112 ;
...
V_111 -> V_12 &= V_12 ;
V_111 -> V_112 &= V_112 ;
V_111 -> V_113 = F_32 ( V_111 -> V_113 , V_113 ) ;
V_111 -> V_114 = F_32 ( V_111 -> V_114 , V_114 ) ;
}
