...
static struct V_21 * F_57 ( const char * V_154 , int remove )
{
struct V_148 * V_149 ;
struct V_21 * V_22 = NULL ;
bool V_155 = ( remove == V_156 ) ;
F_47 (t, &pktgen_threads, th_list) {
V_22 = F_58 ( V_149 , V_154 , V_155 ) ;
if ( V_22 ) {
if ( remove ) {
F_46 ( V_149 ) ;
V_22 -> V_157 = 1 ;
...
static void F_59 ( const char * V_154 )
{
struct V_21 * V_22 = NULL ;
const int V_159 = 10 , V_160 = 125 ;
int V_60 = 0 ;
F_51 ( & V_151 ) ;
F_60 ( L_217 , V_161 , V_154 ) ;
while ( 1 ) {
V_22 = F_57 ( V_154 , REMOVE ) ;
if ( V_22 == NULL )
break;
F_53 ( & V_151 ) ;
F_60 ( L_218 ,
...
static void F_61 ( struct V_162 * V_163 )
{
struct V_148 * V_149 ;
F_47 (t, &pktgen_threads, th_list) {
struct V_21 * V_22 ;
...
if ( V_22 -> V_50 != V_163 )
continue;
F_62 ( V_22 -> V_164 -> V_122 , V_165 ) ;
V_22 -> V_164 = F_63 ( V_163 -> V_122 , 0600 ,
V_165 ,
& V_166 ,
V_22 ) ;
if ( ! V_22 -> V_164 )
...
static struct V_162 * F_67 ( struct V_21 * V_22 ,
const char * V_154 )
{
char V_175 [ V_176 + 5 ] ;
int V_60 ;
...
V_175 [ V_60 ] = 0 ;
return F_68 ( & V_171 , V_175 ) ;
}
static int F_69 ( struct V_21 * V_22 , const char * V_154 )
{
struct V_162 * V_50 ;
int V_14 ;
if ( V_22 -> V_50 ) {
...
static void F_80 ( struct V_21 * V_22 , T_1 V_199 )
{
T_1 V_200 , V_201 ;
T_8 V_202 ;
struct V_203 V_149 ;
F_81 ( & V_149 . V_204 , V_205 , V_206 ) ;
F_82 ( & V_149 . V_204 , V_199 ) ;
V_202 = F_83 ( F_84 ( & V_149 . V_204 ) ) ;
if ( V_202 <= 0 ) {
V_22 -> V_207 = F_85 ( V_199 , V_22 -> V_29 ) ;
return;
}
V_200 = F_1 () ;
if ( V_202 < 100000 ) {
...
do {
F_87 ( V_209 ) ;
F_88 ( & V_149 . V_204 , V_206 ) ;
if ( ! F_89 ( & V_149 . V_204 ) )
V_149 . V_210 = NULL ;
if ( F_90 ( V_149 . V_210 ) )
F_91 () ;
F_92 ( & V_149 . V_204 ) ;
} while ( V_149 . V_210 && V_22 -> V_86 && ! F_93 ( V_208 ) );
F_94 ( V_211 ) ;
V_201 = F_1 () ;
}
V_22 -> V_88 += F_83 ( F_95 ( V_201 , V_200 ) ) ;
V_22 -> V_207 = F_85 ( V_199 , V_22 -> V_29 ) ;
}
static inline void F_96 ( struct V_21 * V_22 )
{
V_22 -> V_212 = 0 ;
V_22 -> V_212 += V_22 -> V_59 * sizeof( V_213 ) ;
V_22 -> V_212 += F_97 ( V_22 ) ;
V_22 -> V_212 += F_98 ( V_22 ) ;
}
static inline int F_99 ( const struct V_21 * V_22 , int V_214 )
{
return ! ! ( V_22 -> V_215 [ V_214 ] . V_37 & V_216 ) ;
}
static inline int F_100 ( struct V_21 * V_22 )
{
...
static void F_102 ( struct V_21 * V_22 , int V_214 )
{
struct V_218 * V_219 = V_22 -> V_215 [ V_214 ] . V_219 ;
if ( ! V_219 ) {
V_219 = F_103 ( & V_171 , V_220 ,
( V_221 * ) & V_22 -> V_99 ,
( V_221 * ) & V_22 -> V_98 ,
V_222 ,
V_22 -> V_223 ,
...
V_22 -> V_62 = F_101 () & ( 4096 - 1 ) ;
}
if ( ( V_22 -> V_37 & V_84 ) && ( V_22 -> V_65 != 0xffff ) ) {
V_22 -> V_65 = F_101 () & ( 4096 - 1 ) ;
}
...
if ( ! ( V_22 -> V_37 & V_38 ) ) {
V_227 = F_20 ( V_22 -> V_141 ) ;
V_228 = F_20 ( V_22 -> V_142 ) ;
if ( V_227 < V_228 ) {
T_7 V_149 ;
if ( V_22 -> V_37 & V_71 )
V_149 = F_101 () % ( V_228 - V_227 ) + V_227 ;
else {
...
if ( V_22 -> V_32 && F_99 ( V_22 , V_214 ) ) {
V_22 -> V_99 = V_22 -> V_215 [ V_214 ] . V_99 ;
} else {
V_227 = F_20 ( V_22 -> V_138 ) ;
V_228 = F_20 ( V_22 -> V_139 ) ;
if ( V_227 < V_228 ) {
T_7 V_149 ;
V_231 V_232 ;
if ( V_22 -> V_37 & V_72 ) {
...
static int F_112 ( struct V_234 * V_235 , struct V_21 * V_22 )
{
...
int V_150 ;
T_11 * V_245 ;
V_244 = V_219 -> V_225 . V_226 - F_118 ( V_235 ) ;
if ( V_244 > 0 ) {
V_150 = F_119 ( V_235 , V_244 , 0 , V_246 ) ;
if ( V_150 < 0 ) {
F_50 ( L_229 ,
V_150 ) ;
goto V_14;
...
F_120 ( V_235 , V_247 ) ;
V_150 = F_112 ( V_235 , V_22 ) ;
if ( V_150 ) {
F_50 ( L_230 , V_150 ) ;
goto V_14;
}
V_245 = ( T_11 * ) F_121 ( V_235 , V_247 ) ;
memcpy ( V_245 , V_22 -> V_143 , 12 ) ;
...
static void F_123 ( V_231 * V_249 , struct V_21 * V_22 )
{
unsigned V_60 ;
for ( V_60 = 0 ; V_60 < V_22 -> V_59 ; V_60 ++ )
...
static inline T_10 F_124 ( unsigned int V_250 , unsigned int V_251 ,
unsigned int V_252 )
{
return F_125 ( V_250 | ( V_251 << 12 ) | ( V_252 << 13 ) ) ;
}
static void F_126 ( struct V_21 * V_22 , struct V_234 * V_235 ,
int V_253 )
{
struct V_254 V_255 ;
struct V_256 * V_257 ;
V_257 = (struct V_256 * ) F_127 ( V_235 , sizeof( * V_257 ) ) ;
V_253 -= sizeof( * V_257 ) ;
if ( V_22 -> V_28 <= 0 ) {
memset ( F_127 ( V_235 , V_253 ) , 0 , V_253 ) ;
} else {
int V_258 = V_22 -> V_28 ;
int V_60 , V_114 ;
int V_259 ;
...
if ( V_114 > 0 ) {
memset ( F_127 ( V_235 , V_114 ) , 0 , V_114 ) ;
V_253 = V_258 * V_261 ;
}
V_60 = 0 ;
...
V_70 = V_22 -> V_70 ;
V_22 -> V_136 = F_130 ( V_70 , V_262 | V_263 , 0 ) ;
if ( ! V_22 -> V_136 )
break;
}
F_131 ( V_22 -> V_136 ) ;
F_132 ( V_235 , V_60 , V_22 -> V_136 ) ;
F_133 ( V_235 ) -> V_258 [ V_60 ] . V_264 = 0 ;
if ( V_60 == ( V_258 - 1 ) )
F_134 ( & F_133 ( V_235 ) -> V_258 [ V_60 ] ,
( V_253 < V_261 ? V_253 : V_261 ) ) ;
else
F_134 ( & F_133 ( V_235 ) -> V_258 [ V_60 ] , V_259 ) ;
V_253 -= F_135 ( & F_133 ( V_235 ) -> V_258 [ V_60 ] ) ;
V_235 -> V_114 += F_135 ( & F_133 ( V_235 ) -> V_258 [ V_60 ] ) ;
V_235 -> V_265 += F_135 ( & F_133 ( V_235 ) -> V_258 [ V_60 ] ) ;
V_60 ++ ;
F_133 ( V_235 ) -> V_266 = V_60 ;
}
}
...
static struct V_234 * F_137 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
...
V_70 = F_129 () ;
V_235 = F_138 ( V_285 + V_22 -> V_130 + 64
...
F_141 ( V_235 -> V_15 ) ;
F_139 ( V_235 , V_253 ) ;
V_245 = ( T_11 * ) F_121 ( V_235 , 14 ) ;
V_249 = ( V_231 * ) F_127 ( V_235 , V_22 -> V_59 * sizeof( T_7 ) ) ;
if ( V_22 -> V_59 )
F_123 ( V_249 , V_22 ) ;
if ( V_22 -> V_62 != 0xffff ) {
if ( V_22 -> V_65 != 0xffff ) {
V_279 = ( T_10 * ) F_127 ( V_235 , sizeof( T_10 ) ) ;
* V_279 = F_124 ( V_22 -> V_65 ,
V_22 -> V_67 ,
V_22 -> V_66 ) ;
V_280 = ( T_10 * ) F_127 ( V_235 , sizeof( T_10 ) ) ;
* V_280 = F_125 ( V_283 ) ;
}
V_277 = ( T_10 * ) F_127 ( V_235 , sizeof( T_10 ) ) ;
* V_277 = F_124 ( V_22 -> V_62 ,
V_22 -> V_64 ,
V_22 -> V_63 ) ;
V_278 = ( T_10 * ) F_127 ( V_235 , sizeof( T_10 ) ) ;
* V_278 = F_125 ( V_276 ) ;
}
V_235 -> V_287 = V_235 -> V_288 ;
V_235 -> V_289 = V_235 -> V_287 + sizeof( struct V_274 ) ;
F_127 ( V_235 , sizeof( struct V_274 ) + sizeof( struct V_271 ) ) ;
F_142 ( V_235 , V_281 ) ;
...
memcpy ( V_245 , V_22 -> V_143 , 12 ) ;
* ( T_10 * ) & V_245 [ 12 ] = V_243 ;
V_253 = V_22 -> V_130 - 14 - 20 - 8 -
V_22 -> V_212 ;
if ( V_253 < sizeof( struct V_256 ) )
V_253 = sizeof( struct V_256 ) ;
V_272 -> V_291 = F_125 ( V_22 -> V_101 ) ;
V_272 -> V_292 = F_125 ( V_22 -> V_100 ) ;
V_272 -> V_114 = F_125 ( V_253 + 8 ) ;
V_272 -> V_293 = 0 ;
V_275 -> V_294 = 5 ;
V_275 -> V_9 = 4 ;
V_275 -> V_295 = 32 ;
...
V_275 -> V_250 = F_125 ( V_22 -> V_299 ) ;
V_22 -> V_299 ++ ;
V_275 -> V_300 = 0 ;
V_273 = 20 + 8 + V_253 ;
V_275 -> V_301 = F_125 ( V_273 ) ;
V_275 -> V_293 = 0 ;
V_275 -> V_293 = F_145 ( ( void * ) V_275 , V_275 -> V_294 ) ;
V_235 -> V_243 = V_243 ;
V_235 -> V_302 = ( V_235 -> V_287 - V_247 -
V_22 -> V_212 ) ;
V_235 -> V_163 = V_50 ;
V_235 -> V_303 = V_304 ;
F_126 ( V_22 , V_235 , V_253 ) ;
#ifdef F_21
if ( ! F_117 ( V_22 , V_235 , V_243 ) )
return NULL ;
#endif
return V_235 ;
}
...
static struct V_234 * F_148 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
struct V_234 * V_235 = NULL ;
T_11 * V_245 ;
...
F_127 ( V_235 , sizeof( struct V_312 ) + sizeof( struct V_271 ) ) ;
F_142 ( V_235 , V_281 ) ;
V_235 -> V_290 = V_22 -> V_36 ;
V_275 = F_149 ( V_235 ) ;
V_272 = F_144 ( V_235 ) ;
...
V_272 -> V_291 = F_125 ( V_22 -> V_101 ) ;
V_272 -> V_292 = F_125 ( V_22 -> V_100 ) ;
V_272 -> V_114 = F_125 ( V_253 + sizeof( struct V_271 ) ) ;
V_272 -> V_293 = 0 ;
...
V_275 -> V_314 = 32 ;
V_275 -> V_315 = F_125 ( sizeof( struct V_271 ) + V_253 ) ;
V_275 -> V_316 = V_296 ;
F_40 ( & V_275 -> V_298 , & V_22 -> V_97 ) ;
F_40 ( & V_275 -> V_297 , & V_22 -> V_96 ) ;
V_235 -> V_302 = ( V_235 -> V_287 - V_247 -
V_22 -> V_212 ) ;
V_235 -> V_243 = V_243 ;
V_235 -> V_163 = V_50 ;
...
static struct V_234 * F_151 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
if ( V_22 -> V_37 & V_38 )
return F_148 ( V_50 , V_22 ) ;
else
return F_137 ( V_50 , V_22 ) ;
}
...
static void F_152 ( struct V_148 * V_149 )
{
struct V_21 * V_22 ;
int V_318 = 0 ;
F_153 () ;
...
static int F_154 ( const struct V_148 * V_149 )
{
const struct V_21 * V_22 ;
F_47 (pkt_dev, &t->if_list, list)
if ( V_22 -> V_86 )
...
static void F_158 ( struct V_21 * V_22 , int V_266 )
{
T_12 V_322 , V_323 , V_324 ;
char * V_325 = V_22 -> V_104 ;
T_1 V_326 = F_95 ( V_22 -> V_87 ,
V_22 -> V_92 ) ;
T_1 V_25 = F_159 ( V_22 -> V_88 ) ;
V_325 += sprintf ( V_325 , L_235 ,
( unsigned long long ) F_23 ( V_326 ) ,
( unsigned long long ) F_23 ( F_95 ( V_326 , V_25 ) ) ,
( unsigned long long ) F_23 ( V_25 ) ,
( unsigned long long ) V_22 -> V_90 ,
V_22 -> V_130 , V_266 ) ;
V_324 = F_160 ( V_22 -> V_90 * V_132 ,
F_83 ( V_326 ) ) ;
V_322 = V_324 * 8 * V_22 -> V_130 ;
V_323 = V_322 ;
F_22 ( V_323 , 1000000 ) ;
...
{
int V_266 = V_22 -> V_235 ? F_133 ( V_22 -> V_235 ) -> V_266 : - 1 ;
if ( ! V_22 -> V_86 ) {
F_13 ( L_237 ,
V_22 -> V_31 ) ;
return - V_125 ;
...
static struct V_21 * F_162 ( struct V_148 * V_149 )
{
...
F_46 ( V_149 ) ;
F_165 (q, n, &t->if_list) {
V_330 = F_166 ( V_329 , struct V_21 , V_331 ) ;
if ( ! V_330 -> V_157 )
continue;
F_122 ( V_330 -> V_235 ) ;
V_330 -> V_235 = NULL ;
...
static void F_169 ( struct V_148 * V_149 )
{
F_62 ( V_149 -> V_332 -> V_333 , V_165 ) ;
}
static void F_170 ( struct V_21 * V_22 )
{
T_1 V_334 = F_1 () ;
F_91 () ;
V_22 -> V_88 += F_83 ( F_95 ( F_1 () , V_334 ) ) ;
}
static void F_171 ( struct V_21 * V_22 )
{
T_1 V_334 = F_1 () ;
while ( F_172 ( & ( V_22 -> V_235 -> V_335 ) ) != 1 ) {
if ( F_93 ( V_208 ) )
break;
if ( F_173 () )
F_170 ( V_22 ) ;
...
T_13 (* F_176)( struct V_234 * , struct V_162 * )
= V_50 -> V_336 -> V_337 ;
struct V_338 * V_339 ;
V_248 V_281 ;
int V_150 ;
if ( F_128 ( ! F_71 ( V_50 ) || ! F_177 ( V_50 ) ) ) {
F_161 ( V_22 ) ;
return;
}
if ( F_128 ( V_22 -> V_29 == V_131 ) ) {
V_22 -> V_207 = F_85 ( F_1 () , V_340 ) ;
return;
}
if ( ! V_22 -> V_235 || ( V_22 -> V_341 &&
++ V_22 -> V_342 >= V_22 -> V_30 ) ) {
F_122 ( V_22 -> V_235 ) ;
V_22 -> V_235 = F_151 ( V_50 , V_22 ) ;
if ( V_22 -> V_235 == NULL ) {
F_50 ( L_238 ) ;
F_91 () ;
V_22 -> V_342 -- ;
...
F_80 ( V_22 , V_22 -> V_207 ) ;
V_281 = F_178 ( V_22 -> V_235 ) ;
V_339 = F_179 ( V_50 , V_281 ) ;
F_180 ( V_339 ) ;
if ( F_128 ( F_181 ( V_339 ) ) ) {
V_150 = V_345 ;
V_22 -> V_341 = 0 ;
goto V_346;
}
F_182 ( & ( V_22 -> V_235 -> V_335 ) ) ;
V_150 = (* F_176)( V_22 -> V_235 , V_50 ) ;
switch ( V_150 ) {
case V_347 :
F_183 ( V_339 ) ;
V_22 -> V_341 = 1 ;
...
static int F_186 ( void * V_352 )
{
F_187 ( V_353 ) ;
struct V_148 * V_149 = V_352 ;
struct V_21 * V_22 = NULL ;
int V_354 = V_149 -> V_354 ;
F_45 ( F_105 () != V_354 ) ;
F_188 ( & V_149 -> V_355 ) ;
F_189 ( & V_149 -> V_356 ) ;
F_60 ( L_240 , V_354 , F_190 ( V_208 ) ) ;
F_87 ( V_209 ) ;
F_191 () ;
while ( ! F_192 () ) {
V_22 = F_162 ( V_149 ) ;
if ( F_128 ( ! V_22 && V_149 -> V_152 == 0 ) ) {
if ( V_357 )
break;
F_193 ( V_149 -> V_355 ,
V_149 -> V_152 != 0 ,
...
if ( V_149 -> V_152 & V_319 ) {
F_163 ( V_149 ) ;
V_149 -> V_152 &= ~ ( V_319 ) ;
}
if ( V_149 -> V_152 & V_321 ) {
F_152 ( V_149 ) ;
V_149 -> V_152 &= ~ ( V_321 ) ;
}
...
F_60 ( L_241 , V_149 -> V_332 -> V_333 ) ;
F_163 ( V_149 ) ;
F_60 ( L_242 , V_149 -> V_332 -> V_333 ) ;
F_168 ( V_149 ) ;
F_60 ( L_243 , V_149 -> V_332 -> V_333 ) ;
F_169 ( V_149 ) ;
while ( ! F_192 () ) {
F_87 ( V_209 ) ;
F_91 () ;
...
static struct V_21 * F_58 ( struct V_148 * V_149 ,
...
if ( strncmp ( V_325 -> V_31 , V_154 , V_114 ) == 0 ) {
if ( V_325 -> V_31 [ V_114 ] ) {
if ( V_155 || V_325 -> V_31 [ V_114 ] != '@' )
continue;
}
V_22 = V_325 ;
break;
...
static int F_52 ( struct V_148 * V_149 , const char * V_154 )
{
struct V_21 * V_22 ;
int V_14 ;
int V_70 = F_197 ( V_149 -> V_354 ) ;
V_22 = F_57 ( V_154 , V_156 ) ;
if ( V_22 ) {
F_50 ( L_246 ) ;
return - V_361 ;
}
V_22 = F_198 ( sizeof( struct V_21 ) , V_262 , V_70 ) ;
if ( ! V_22 )
return - V_363 ;
strcpy ( V_22 -> V_31 , V_154 ) ;
V_22 -> V_215 = F_199 ( V_145 * sizeof( struct V_364 ) ,
V_70 ) ;
if ( V_22 -> V_215 == NULL ) {
F_200 ( V_22 ) ;
return - V_363 ;
...
V_22 -> V_65 = 0xffff ;
V_22 -> V_70 = - 1 ;
V_14 = F_69 ( V_22 , V_154 ) ;
if ( V_14 )
goto V_368;
if ( V_22 -> V_50 -> V_133 & V_134 )
V_22 -> V_30 = V_369 ;
V_22 -> V_164 = F_63 ( V_154 , 0600 , V_165 ,
& V_166 , V_22 ) ;
if ( ! V_22 -> V_164 ) {
F_50 ( L_247 ,
V_370 , V_154 ) ;
...
static int T_14 F_202 ( int V_354 )
{
struct V_148 * V_149 ;
struct V_373 * V_374 ;
struct V_375 * V_325 ;
V_149 = F_198 ( sizeof( struct V_148 ) , V_262 ,
F_197 ( V_354 ) ) ;
if ( ! V_149 ) {
F_50 ( L_248 ) ;
return - V_363 ;
...
F_211 ( V_325 , V_354 ) ;
V_149 -> V_332 = V_325 ;
V_374 = F_63 ( V_149 -> V_332 -> V_333 , 0600 , V_165 ,
& V_378 , V_149 ) ;
if ( ! V_374 ) {
F_50 ( L_247 ,
V_370 , V_149 -> V_332 -> V_333 ) ;
F_212 ( V_325 ) ;
F_209 ( & V_149 -> V_376 ) ;
F_200 ( V_149 ) ;
return - V_125 ;
...
static void F_215 ( struct V_148 * V_149 ,
struct V_21 * V_22 )
{
struct V_328 * V_329 , * V_113 ;
struct V_21 * V_325 ;
F_165 (q, n, &t->if_list) {
V_325 = F_166 ( V_329 , struct V_21 , V_331 ) ;
if ( V_325 == V_22 )
F_209 ( & V_325 -> V_331 ) ;
}
}
static int F_167 ( struct V_148 * V_149 ,
struct V_21 * V_22 )
{
F_60 ( L_251 , V_22 ) ;
if ( V_22 -> V_86 ) {
...
int V_150 = 0 ;
F_35 ( L_253 , V_9 ) ;
V_165 = F_217 ( V_370 , V_171 . V_379 ) ;
if ( ! V_165 )
return - V_177 ;
V_374 = F_218 ( V_380 , 0600 , V_165 , & V_381 ) ;
if ( V_374 == NULL ) {
F_50 ( L_254 , V_380 ) ;
V_150 = - V_125 ;
goto V_382;
...
static void T_15 F_224 ( void )
{
struct V_148 * V_149 ;
struct V_328 * V_329 , * V_113 ;
V_357 = true ;
F_165 (q, n, &pktgen_threads) {
V_149 = F_166 ( V_329 , struct V_148 , V_376 ) ;
F_212 ( V_149 -> V_332 ) ;
F_200 ( V_149 ) ;
}
F_222 ( & V_383 ) ;
