...
static T_2 F_24 ( int V_52 , void * V_73 )
{
struct V_6 * V_7 = V_73 ;
...
static T_3 void F_26 ( struct V_6 * V_7 ,
...
static int T_3 F_30 ( struct V_91 * V_92 ,
...
V_31 = F_39 ( - 1 , 0 , V_13 [ V_7 -> V_14 ] , V_104 ) ;
if ( V_31 < 0 ) {
F_19 ( & V_92 -> V_33 , L_9 ) ;
V_7 -> V_31 = - 1 ;
goto V_69;
...
static void T_5 F_47 ( struct V_91 * V_92 )
{
int V_107 ;
struct V_6 * V_7 = F_48 ( V_92 ) ;
if ( V_7 -> V_31 != - 1 ) {
F_49 ( V_92 -> V_52 , V_7 ) ;
F_41 ( V_7 -> V_31 , V_13 [ V_7 -> V_14 ] ) ;
}
V_107 = F_42 ( & V_7 -> V_2 ) ;
if ( V_107 )
F_33 ( & V_92 -> V_33 , L_13 ) ;
...
static int F_50 ( struct V_91 * V_92 , T_6 V_108 )
{
T_4 V_76 ;
struct V_6 * V_7 = F_48 ( V_92 ) ;
unsigned long V_51 ;
