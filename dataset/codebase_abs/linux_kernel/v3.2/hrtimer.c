...
V_51 = V_19 -> V_51 & V_101 ;
F_101 ( V_19 , V_4 , V_51 , V_98 ) ;
return 1 ;
}
return 0 ;
}
int F_105 ( struct V_18 * V_19 , T_2 V_102 ,
unsigned long V_103 , const enum V_55 V_56 ,
int V_70 )
{
...
int V_104 , V_105 ;
V_4 = F_6 ( V_19 , & V_20 ) ;
V_104 = F_103 ( V_19 , V_4 ) ;
V_25 = F_20 ( V_19 , V_4 , V_56 & V_106 ) ;
if ( V_56 & V_107 ) {
V_102 = F_33 ( V_102 , V_25 -> V_108 () ) ;
#ifdef F_106
V_102 = F_33 ( V_102 , V_4 -> V_79 ) ;
#endif
}
F_107 ( V_19 , V_102 , V_103 ) ;
F_89 ( V_19 ) ;
V_105 = F_99 ( V_19 , V_25 ) ;
if ( V_105 && V_25 -> V_21 == & F_68 ( V_36 ) )
F_72 ( V_19 , V_25 , V_70 ) ;
F_95 ( V_19 , & V_20 ) ;
return V_104 ;
}
int F_108 ( struct V_18 * V_19 , T_2 V_102 ,
unsigned long V_103 , const enum V_55 V_56 )
{
return F_105 ( V_19 , V_102 , V_103 , V_56 , 1 ) ;
}
int
F_109 ( struct V_18 * V_19 , T_2 V_102 , const enum V_55 V_56 )
{
return F_105 ( V_19 , V_102 , 0 , V_56 , 1 ) ;
}
...
V_19 = F_65 ( V_65 , struct V_18 , V_67 ) ;
V_93 . V_29 = F_69 ( V_19 ) ;
V_93 = F_18 ( V_93 , V_4 -> V_108 () ) ;
if ( V_93 . V_29 < V_109 . V_29 )
V_109 . V_29 = V_93 . V_29 ;
}
}
F_9 ( & V_21 -> V_22 , V_20 ) ;
if ( V_109 . V_29 < 0 )
...
int F_117 ( const T_1 V_113 , struct V_8 * V_114 )
{
struct V_3 * V_21 ;
int V_4 = F_1 ( V_113 ) ;
V_21 = & F_114 ( V_36 ) ;
* V_114 = F_118 ( V_21 -> V_12 [ V_4 ] . V_79 ) ;
return 0 ;
}
...
enum V_115 ( * V_116 ) ( struct V_18 * ) ;
int V_117 ;
F_40 ( ! F_88 () ) ;
F_57 ( V_19 ) ;
F_101 ( V_19 , V_4 , V_101 , 0 ) ;
F_93 ( V_19 ) ;
V_116 = V_19 -> V_49 ;
F_25 ( & V_21 -> V_22 ) ;
F_120 ( V_19 , V_90 ) ;
...
F_26 ( & V_21 -> V_22 ) ;
if ( V_117 != V_118 ) {
F_122 ( V_19 -> V_51 != V_101 ) ;
F_99 ( V_19 , V_4 ) ;
}
F_39 ( ! ( V_19 -> V_51 & V_101 ) ) ;
V_19 -> V_51 &= ~ V_101 ;
}
void F_123 ( struct V_119 * V_120 )
{
struct V_3 * V_21 = & F_68 ( V_36 ) ;
T_2 V_30 , V_90 , V_121 , V_93 ;
int V_61 , V_122 = 0 ;
F_122 ( ! V_21 -> V_27 ) ;
V_21 -> V_123 ++ ;
V_120 -> V_124 . V_29 = V_62 ;
V_121 = V_90 = F_124 () ;
V_125:
V_30 . V_29 = V_62 ;
F_26 ( & V_21 -> V_22 ) ;
...
V_21 -> V_128 ++ ;
V_21 -> V_69 = 1 ;
V_93 = F_18 ( V_90 , V_121 ) ;
if ( V_93 . V_29 > V_21 -> V_129 . V_29 )
V_21 -> V_129 = V_93 ;
if ( V_93 . V_29 > 100 * V_130 )
V_30 = F_27 ( V_90 , 100 * V_130 ) ;
else
V_30 = F_5 ( V_90 , V_93 ) ;
F_66 ( V_30 , 1 ) ;
F_126 ( V_78 L_6 ,
...
static void F_129 ( struct V_135 * V_136 )
{
F_128 () ;
}
...
static enum V_115 F_133 ( struct V_18 * V_19 )
{
struct V_138 * V_139 =
F_65 ( V_19 , struct V_138 , V_19 ) ;
...
void F_135 ( struct V_138 * V_142 , struct V_140 * V_141 )
{
V_142 -> V_19 . V_49 = F_133 ;
V_142 -> V_141 = V_141 ;
}
static int T_6 F_136 ( struct V_138 * V_139 , enum V_55 V_56 )
{
F_135 ( V_139 , V_84 ) ;
do {
F_137 ( V_143 ) ;
F_138 ( & V_139 -> V_19 , V_56 ) ;
if ( ! F_139 ( & V_139 -> V_19 ) )
V_139 -> V_141 = NULL ;
if ( F_7 ( V_139 -> V_141 ) )
F_140 () ;
F_36 ( & V_139 -> V_19 ) ;
V_56 = V_111 ;
} while ( V_139 -> V_141 && ! F_141 ( V_84 ) );
F_142 ( V_144 ) ;
return V_139 -> V_141 == NULL ;
}
static int F_143 ( struct V_18 * V_19 , struct V_8 T_7 * V_145 )
{
struct V_8 V_146 ;
T_2 V_41 ;
V_41 = F_112 ( V_19 ) ;
...
return 0 ;
V_146 = F_118 ( V_41 ) ;
if ( F_144 ( V_145 , & V_146 , sizeof( * V_145 ) ) )
return - V_147 ;
return 1 ;
}
long T_6 F_145 ( struct V_148 * V_117 )
{
struct V_138 V_139 ;
struct V_8 T_7 * V_145 ;
int V_104 = 0 ;
F_49 ( & V_139 . V_19 , V_117 -> V_149 . V_57 ,
V_111 ) ;
F_146 ( & V_139 . V_19 , V_117 -> V_149 . V_26 ) ;
if ( F_136 ( & V_139 , V_111 ) )
goto V_100;
V_145 = V_117 -> V_149 . V_145 ;
if ( V_145 ) {
V_104 = F_143 ( & V_139 . V_19 , V_145 ) ;
if ( V_104 <= 0 )
goto V_100;
}
V_104 = - V_150 ;
...
long F_147 ( struct V_8 * V_151 , struct V_8 T_7 * V_145 ,
...
if ( F_148 ( V_84 ) )
V_152 = 0 ;
F_49 ( & V_139 . V_19 , V_57 , V_56 ) ;
F_107 ( & V_139 . V_19 , F_4 ( * V_151 ) , V_152 ) ;
if ( F_136 ( & V_139 , V_56 ) )
goto V_100;
if ( V_56 == V_111 ) {
V_104 = - V_154 ;
...
V_117 = & F_149 () -> V_148 ;
V_117 -> V_116 = F_145 ;
V_117 -> V_149 . V_57 = V_139 . V_19 . V_4 -> V_57 ;
V_117 -> V_149 . V_145 = V_145 ;
V_117 -> V_149 . V_26 = F_69 ( & V_139 . V_19 ) ;
V_104 = - V_150 ;
V_100:
F_52 ( & V_139 . V_19 ) ;
return V_104 ;
...
static void F_153 ( struct V_17 * V_155 ,
struct V_17 * V_25 )
{
struct V_18 * V_19 ;
struct V_64 * V_67 ;
while ( ( V_67 = F_64 ( & V_155 -> V_66 ) ) ) {
V_19 = F_65 ( V_67 , struct V_18 , V_67 ) ;
F_122 ( F_24 ( V_19 ) ) ;
F_57 ( V_19 ) ;
F_101 ( V_19 , V_155 , V_156 , 0 ) ;
V_19 -> V_4 = V_25 ;
F_99 ( V_19 , V_25 ) ;
V_19 -> V_51 &= ~ V_156 ;
}
}
static void F_154 ( int V_157 )
{
struct V_3 * V_155 , * V_25 ;
int V_61 ;
F_122 ( F_155 ( V_157 ) ) ;
F_156 ( V_157 ) ;
F_157 () ;
V_155 = & F_22 ( V_36 , V_157 ) ;
V_25 = & F_68 ( V_36 ) ;
F_26 ( & V_25 -> V_22 ) ;
F_158 ( & V_155 -> V_22 , V_158 ) ;
for ( V_61 = 0 ; V_61 < V_63 ; V_61 ++ ) {
F_153 ( & V_155 -> V_12 [ V_61 ] ,
& V_25 -> V_12 [ V_61 ] ) ;
}
F_25 ( & V_155 -> V_22 ) ;
F_25 ( & V_25 -> V_22 ) ;
...
static int T_8 F_160 ( struct V_159 * V_160 ,
...
void T_5 F_163 ( void )
{
F_160 ( & V_172 , ( unsigned long ) V_163 ,
( void * ) ( long ) F_21 () ) ;
F_164 ( & V_172 ) ;
#ifdef F_17
F_165 ( V_71 , F_129 ) ;
...
F_49 ( & V_139 . V_19 , clock , V_56 ) ;
F_107 ( & V_139 . V_19 , * V_26 , V_93 ) ;
F_135 ( & V_139 , V_84 ) ;
F_138 ( & V_139 . V_19 , V_56 ) ;
if ( ! F_139 ( & V_139 . V_19 ) )
V_139 . V_141 = NULL ;
