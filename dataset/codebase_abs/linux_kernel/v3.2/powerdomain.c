...
int F_41 ( struct V_1 * V_3 , T_1 V_57 , T_1 V_55 )
{
int V_46 = - V_8 ;
if ( ! V_3 )
return - V_8 ;
if ( V_3 -> V_19 < ( V_57 + 1 ) )
return - V_11 ;
if ( ! ( V_3 -> V_58 [ V_57 ] & ( 1 << V_55 ) ) )
return - V_8 ;
F_12 ( L_13
L_14 , V_3 -> V_2 , V_57 , V_55 ) ;
if ( V_39 && V_39 -> F_41 )
V_46 = V_39 -> F_41 ( V_3 , V_57 , V_55 ) ;
return V_46 ;
}
int F_42 ( struct V_1 * V_3 , T_1 V_57 , T_1 V_55 )
{
int V_46 = - V_8 ;
if ( ! V_3 )
return - V_8 ;
if ( V_3 -> V_19 < ( V_57 + 1 ) )
return - V_11 ;
if ( ! ( V_3 -> V_27 [ V_57 ] & ( 1 << V_55 ) ) )
return - V_8 ;
F_12 ( L_13
L_15 , V_3 -> V_2 , V_57 , V_55 ) ;
if ( V_39 && V_39 -> F_42 )
V_46 = V_39 -> F_42 ( V_3 , V_57 , V_55 ) ;
return V_46 ;
}
...
int F_45 ( struct V_1 * V_3 , T_1 V_57 )
{
int V_46 = - V_8 ;
if ( ! V_3 )
return V_46 ;
...
V_57 = 1 ;
if ( V_39 && V_39 -> F_45 )
V_46 = V_39 -> F_45 ( V_3 , V_57 ) ;
return V_46 ;
}
int F_15 ( struct V_1 * V_3 , T_1 V_57 )
{
int V_46 = - V_8 ;
if ( ! V_3 )
return V_46 ;
...
V_57 = 1 ;
if ( V_39 && V_39 -> F_15 )
V_46 = V_39 -> F_15 ( V_3 , V_57 ) ;
return V_46 ;
}
int F_46 ( struct V_1 * V_3 , T_1 V_57 )
{
int V_46 = - V_8 ;
if ( ! V_3 )
return V_46 ;
...
{
if ( V_48 != NULL && V_48 -> V_3 . V_12 != NULL ) {
F_10 ( V_48 -> V_3 . V_12 ) ;
return F_51 ( V_48 -> V_3 . V_12 ) ;
}
return - V_8 ;
}
int F_53 ( void )
...
return 1 ;
for ( V_5 = 0 ; V_5 < V_3 -> V_19 ; V_5 ++ )
if ( V_3 -> V_27 [ V_5 ] & V_67 )
return 1 ;
}
for ( V_5 = 0 ; V_5 < V_3 -> V_19 ; V_5 ++ )
if ( V_3 -> V_58 [ V_5 ] & V_67 )
return 1 ;
return 0 ;
}
