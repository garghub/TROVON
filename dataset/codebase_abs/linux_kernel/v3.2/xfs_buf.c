...
struct V_220 V_221 ;
if ( F_19 ( F_194 ( V_117 ) ) ) {
F_195 ( V_222 , & V_18 -> V_192 ) ;
F_196 () ;
} else {
F_197 ( V_222 , & V_18 -> V_192 ) ;
}
if ( F_5 ( & V_18 -> V_190 ) )
V_217 = V_223 ;
F_198 ( V_217 ) ;
F_186 ( V_18 , & V_219 , V_203 ) ;
F_199 ( NULL , & V_219 , F_192 ) ;
F_200 ( & V_221 ) ;
while ( ! F_5 ( & V_219 ) ) {
struct V_1 * V_2 ;
...
struct V_220 V_221 ;
F_203 ( V_126 ) ;
F_195 ( V_210 , & V_18 -> V_192 ) ;
V_224 = F_186 ( V_18 , & V_225 , 0 ) ;
F_199 ( NULL , & V_225 , F_192 ) ;
F_200 ( & V_221 ) ;
while ( ! F_5 ( & V_225 ) ) {
...
if ( V_116 ) {
while ( ! F_5 ( & V_226 ) ) {
V_2 = F_152 ( & V_226 , struct V_1 , V_28 ) ;
F_10 ( & V_2 -> V_28 ) ;
F_70 ( V_2 ) ;
F_81 ( V_2 ) ;
}
