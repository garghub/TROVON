...
return ! ! ( V_16 -> V_40 == F_22 ( V_50 ) ) ;
}
bool F_23 ( void * V_49 )
{
struct V_15 * V_16 = V_49 ;
return ! ! ( V_16 -> V_40 == F_22 ( V_51 ) ) ;
}
static void F_24 ( struct V_52 * V_53 )
{
struct V_15 * V_16 ;
int V_24 ;
V_16 = F_25 ( V_53 , struct V_15 , V_54 ) ;
for ( V_24 = 0 ; V_24 < V_16 -> V_21 -> V_55 ; V_24 ++ ) {
struct V_14 * V_23 = V_16 -> V_23 [ V_24 ] ;
if ( V_23 != NULL && V_23 -> V_2 -> V_56 != NULL )
V_23 -> V_2 -> V_56 ( V_23 ) ;
}
F_26 ( & V_16 -> V_57 , F_27 ( V_58 + V_59 ) ) ;
}
static void F_28 ( unsigned long V_60 )
{
struct V_15 * V_16 = ( void * ) V_60 ;
F_29 ( & V_16 -> V_54 ) ;
}
static int F_30 ( struct V_18 * V_61 , void * V_62 )
{
if ( V_61 -> V_62 != NULL && ! strcmp ( V_61 -> V_62 -> V_12 , V_62 ) )
return 1 ;
return 0 ;
}
static struct V_18 * F_31 ( struct V_18 * V_19 , char * V_62 )
{
if ( F_30 ( V_19 , V_62 ) ) {
F_32 ( V_19 ) ;
return V_19 ;
}
return F_33 ( V_19 , V_62 , F_30 ) ;
}
static struct V_6 * F_34 ( struct V_18 * V_61 )
{
struct V_18 * V_63 ;
V_63 = F_31 ( V_61 , L_8 ) ;
if ( V_63 != NULL ) {
...
static struct V_46 * F_37 ( struct V_18 * V_61 )
{
struct V_18 * V_63 ;
V_63 = F_31 ( V_61 , L_9 ) ;
if ( V_63 != NULL ) {
...
{
static int V_67 ;
struct V_68 * V_21 = V_66 -> V_61 . V_69 ;
struct V_46 * V_61 ;
struct V_15 * V_16 ;
int V_24 ;
if ( ! V_67 ++ )
...
V_16 -> V_35 = - 1 ;
V_16 -> V_37 = - 1 ;
for ( V_24 = 0 ; V_24 < V_21 -> V_55 ; V_24 ++ ) {
struct V_6 * V_7 ;
struct V_14 * V_23 ;
V_7 = F_34 ( V_21 -> V_22 [ V_24 ] . V_6 ) ;
if ( V_7 == NULL ) {
F_11 ( V_25 L_12
L_13 , V_61 -> V_12 , V_24 ) ;
continue;
}
V_23 = F_10 ( V_16 , V_24 , & V_66 -> V_61 , V_7 ) ;
if ( F_43 ( V_23 ) ) {
F_11 ( V_25 L_14
L_15 , V_61 -> V_12 , V_24 ,
F_44 ( V_23 ) ) ;
...
F_46 ( & V_16 -> V_54 , F_24 ) ;
F_47 ( & V_16 -> V_57 ) ;
V_16 -> V_57 . V_75 = ( unsigned long ) V_16 ;
V_16 -> V_57 . V_76 = F_28 ;
V_16 -> V_57 . V_77 = F_27 ( V_58 + V_59 ) ;
F_48 ( & V_16 -> V_57 ) ;
}
return 0 ;
}
