...
struct V_1 * V_2 ;
int V_4 ;
struct V_17 * V_18 = F_18 ( sizeof( * V_2 ) ) ;
if ( V_18 == NULL )
return - V_39 ;
V_2 = F_12 ( V_18 ) ;
V_2 -> V_40 = F_19 ( & V_8 -> V_37 , L_1 ) ;
if ( ! F_20 ( V_2 -> V_40 ) ) {
V_4 = F_21 ( V_2 -> V_40 ) ;
if ( V_4 )
goto V_41;
...
F_22 ( V_8 , V_18 ) ;
V_2 -> V_8 = V_8 ;
V_18 -> V_42 = F_23 ( V_8 ) -> V_42 ;
V_18 -> V_37 . V_43 = & V_8 -> V_37 ;
V_18 -> V_44 = V_45 ;
V_18 -> V_46 = V_47 ;
V_18 -> V_48 = F_24 ( V_47 ) ;
V_18 -> V_49 = & V_50 ;
V_2 -> V_51 [ 0 ] . V_5 = & V_2 -> V_5 [ 0 ] ;
V_2 -> V_51 [ 0 ] . V_52 = 2 ;
V_2 -> V_51 [ 0 ] . V_53 = 1 ;
V_2 -> V_51 [ 1 ] . V_5 = & V_2 -> V_5 [ 1 ] ;
V_2 -> V_51 [ 1 ] . V_52 = 2 ;
V_2 -> V_51 [ 1 ] . V_53 = 1 ;
V_2 -> V_51 [ 2 ] . V_10 = & V_2 -> V_10 [ 0 ] ;
V_2 -> V_51 [ 2 ] . V_52 = 2 ;
F_25 ( & V_2 -> V_9 ) ;
F_26 ( & V_2 -> V_51 [ 0 ] , & V_2 -> V_9 ) ;
F_26 ( & V_2 -> V_51 [ 1 ] , & V_2 -> V_9 ) ;
F_26 ( & V_2 -> V_51 [ 2 ] , & V_2 -> V_9 ) ;
if ( V_36 && V_36 -> V_54 ) {
V_2 -> V_30 = V_36 -> V_54 ;
V_2 -> V_7 = V_55 ;
} else {
