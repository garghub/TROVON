...
V_35 = F_11 ( V_2 , V_36 , V_37 , V_38 ) ;
if ( V_35 == - 1 ) {
V_34 -> V_40 = 0 ;
return 0 ;
}
V_34 -> V_41 = F_12 ( V_2 , V_35 , V_36 ) ;
V_34 -> V_40 = 1 ;
return 0 ;
}
void F_13 ( struct V_1 * V_2 , struct V_42 * V_43 )
{
F_14 ( V_2 , V_43 ) ;
}
...
struct V_1 * F_17 ( struct V_44 * V_44 , unsigned int V_45 )
{
struct V_8 * V_9 ;
struct V_1 * V_2 ;
int V_46 ;
...
V_2 = & V_9 -> V_2 ;
V_46 = F_19 ( V_2 , V_44 , V_45 ) ;
if ( V_46 )
goto V_51;
V_2 -> V_26 . V_52 = ( void * ) F_20 ( V_48 | V_53 ) ;
if ( ! V_2 -> V_26 . V_52 )
goto V_54;
return V_2 ;
V_54:
...
{
struct V_8 * V_9 = F_7 ( V_2 ) ;
F_25 ( ( unsigned long ) V_2 -> V_26 . V_52 ) ;
F_21 ( V_2 ) ;
F_22 ( V_47 , V_9 ) ;
}
...
if ( V_4 )
return V_4 ;
return F_28 ( NULL , sizeof( struct V_8 ) , 0 , V_55 ) ;
}
