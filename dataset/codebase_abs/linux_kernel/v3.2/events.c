...
int F_88 ( struct V_86 * V_87 , struct V_88 * V_89 )
{
int V_63 ;
struct V_90 V_91 ;
V_91 . type = V_92 ;
...
int F_90 ( struct V_86 * V_87 , struct V_88 * V_89 ,
...
static int F_97 ( unsigned int V_109 ,
unsigned int V_110 )
{
struct V_111 V_112 ;
int V_113 ;
...
V_118 . V_120 = V_82 ;
V_118 . V_39 = V_39 ;
V_63 = F_45 ( V_121 , & V_118 ) ;
if ( V_63 < 0 )
continue;
if ( V_118 . V_118 != V_122 )
continue;
if ( V_118 . V_13 . V_15 == V_15 && V_118 . V_107 == V_6 ) {
V_63 = V_39 ;
break;
}
}
...
T_4 V_127 ,
unsigned long V_128 ,
const char * V_129 , void * V_130 )
{
int V_2 , V_131 ;
V_2 = F_95 ( V_5 ) ;
if ( V_2 < 0 )
return V_2 ;
V_131 = F_102 ( V_2 , V_127 , V_128 , V_129 , V_130 ) ;
if ( V_131 != 0 ) {
F_100 ( V_2 ) ;
return V_131 ;
}
...
T_4 V_127 ,
unsigned long V_128 , const char * V_129 , void * V_130 )
{
int V_2 , V_131 ;
V_2 = F_99 ( V_15 , V_6 ) ;
if ( V_2 < 0 )
...
void F_106 ( unsigned int V_2 , void * V_130 )
{
F_107 ( V_2 , V_130 ) ;
F_100 ( V_2 ) ;
}
...
T_5 F_109 ( int V_2 , void * V_130 )
{
struct V_27 * V_28 = V_41 ;
int V_6 = F_110 () ;
unsigned long * V_135 = F_7 ( V_31 , V_6 ) ;
int V_36 ;
unsigned long V_22 ;
static F_111 ( V_136 ) ;
struct V_45 * V_137 ;
...
int V_138 ;
V_137 = F_7 ( V_46 , V_36 ) ;
V_138 = ( F_114 () && V_36 == V_6 )
? F_115 ( F_114 () )
: V_137 -> V_139 ;
F_76 ( L_12 , V_36 ,
V_138 , V_137 -> V_49 ,
( int ) ( sizeof( V_137 -> V_48 ) * 2 ) ,
V_137 -> V_48 ) ;
}
V_137 = F_7 ( V_46 , V_6 ) ;
F_76 ( L_13 ) ;
...
V_36 % 8 == 0 ? L_15 : L_16 ) ;
F_76 ( L_19 , V_6 ) ;
for ( V_36 = ( V_119 / V_47 ) - 1 ; V_36 >= 0 ; V_36 -- )
F_76 ( L_14 , ( int ) ( sizeof( V_135 [ 0 ] ) * 2 ) ,
V_135 [ V_36 ] ,
V_36 % 8 == 0 ? L_15 : L_16 ) ;
F_76 ( L_20 ) ;
for ( V_36 = F_116 ( V_28 -> V_32 ) - 1 ; V_36 >= 0 ; V_36 -- ) {
unsigned long V_138 = V_28 -> V_30 [ V_36 ]
& ~ V_28 -> V_32 [ V_36 ]
& V_135 [ V_36 ] ;
F_76 ( L_14 , ( int ) ( sizeof( V_28 -> V_32 [ 0 ] ) * 2 ) ,
V_138 , V_36 % 8 == 0 ? L_15 : L_16 ) ;
}
F_76 ( L_21 ) ;
...
F_121 () ;
#endif
V_146 = F_122 ( & V_45 -> V_48 , 0 ) ;
V_142 = F_46 ( V_148 ) ;
V_143 = F_46 ( V_149 ) ;
V_140 = V_142 ;
for ( V_36 = 0 ; V_146 != 0 ; V_36 ++ ) {
unsigned long V_150 ;
unsigned long V_151 ;
V_151 = F_123 ( V_146 , V_140 ) ;
if ( V_151 == 0 ) {
V_140 = 0 ;
V_144 = 0 ;
continue;
...
int V_39 , V_2 ;
struct V_37 * V_38 ;
V_152 = F_123 ( V_150 , V_144 ) ;
if ( V_152 == 0 )
break;
V_144 = F_124 ( V_152 ) ;
V_39 = ( V_140 * V_47 ) + V_144 ;
V_2 = V_8 [ V_39 ] ;
if ( V_2 != - 1 ) {
V_38 = F_25 ( V_2 ) ;
if ( V_38 )
...
V_145 = F_46 ( V_147 ) ;
F_126 ( V_147 , 0 ) ;
} while ( V_145 != 1 || V_45 -> V_49 );
V_67:
F_48 () ;
}
void F_127 ( struct V_153 * V_154 )
{
struct V_153 * V_155 = F_128 ( V_154 ) ;
F_129 () ;
F_130 () ;
F_118 () ;
F_131 () ;
...
static int F_137 ( unsigned V_2 , unsigned V_156 )
{
struct V_157 V_158 ;
int V_5 = F_10 ( V_2 ) ;
if ( ! F_39 ( V_5 ) )
...
V_158 . V_39 = V_5 ;
V_158 . V_107 = V_156 ;
if ( F_45 ( V_160 , & V_158 ) >= 0 )
F_22 ( V_5 , V_156 ) ;
return 0 ;
}
static int F_138 ( struct V_34 * V_60 , const struct V_161 * V_162 ,
bool V_163 )
{
unsigned V_156 = F_139 ( V_162 ) ;
return F_137 ( V_60 -> V_2 , V_156 ) ;
}
int F_140 ( unsigned int V_2 )
{
int V_164 , V_5 = F_10 ( V_2 ) ;
struct V_27 * V_40 = V_41 ;
if ( ! F_39 ( V_5 ) )
return 1 ;
V_164 = F_47 ( V_5 , V_40 -> V_32 ) ;
F_35 ( V_5 , V_40 -> V_30 ) ;
if ( ! V_164 )
F_42 ( V_5 ) ;
return 1 ;
...
F_76 ( V_170 L_28 , V_2 , V_166 . V_18 ) ;
F_75 ( V_2 ) ;
}
}
...
V_175 . V_176 = 1 ;
V_175 . V_173 = V_173 ;
F_152 ( V_175 . V_177 , & V_5 ) ;
if ( F_153 ( V_178 , & V_175 ) != 0 )
F_80 () ;
}
}
void F_154 ( int V_2 )
