...
{
int V_254 ;
V_254 = F_84 ( V_253 , & V_4 -> V_195 ) ;
if ( V_254 < 0 )
goto error;
V_254 = F_85 ( & V_4 -> V_171 , V_253 ) ;
if ( V_254 < 0 )
goto error;
return 0 ;
error:
...
struct V_245 * V_255 = & V_227 -> V_163 ;
int V_254 ;
F_87 ( V_227 , & V_256 ) ;
V_227 -> V_257 = & V_258 ;
F_88 ( V_227 -> V_244 , L_17 , sizeof( V_227 -> V_244 ) ) ;
V_227 -> V_259 = 1 << 16 ;
F_89 ( V_227 , V_4 ) ;
V_227 -> V_248 |= V_260 ;
V_162 [ V_170 ] . V_248 = V_261 ;
V_162 [ V_28 ] . V_248 = V_262 ;
V_255 -> V_263 = & V_264 ;
V_254 = F_90 ( V_255 , V_265 , V_162 , 0 ) ;
if ( V_254 < 0 )
return V_254 ;
F_70 ( V_227 , NULL ) ;
V_4 -> V_171 . type = V_266 ;
V_4 -> V_171 . V_263 = & V_267 ;
V_4 -> V_171 . V_268 = 32 ;
V_4 -> V_171 . V_269 = 1 ;
V_4 -> V_171 . V_270 = 0x1ffe0 ;
V_4 -> V_171 . V_2 = V_4 -> V_2 ;
V_4 -> V_171 . V_271 = F_91 ( 4096 * 4096 ) * 3 ;
V_254 = F_92 ( & V_4 -> V_171 , L_18 ) ;
if ( V_254 < 0 )
goto V_272;
V_254 = F_93 ( & V_4 -> V_195 . V_163 , V_170 ,
...
{
struct V_3 * V_274 = & V_2 -> V_206 ;
struct V_3 * V_275 = & V_2 -> V_276 ;
int V_254 ;
V_274 -> V_2 = V_2 ;
V_274 -> V_137 = 1 ;
V_274 -> V_9 = V_277 ;
V_274 -> V_278 = V_279 ;
V_274 -> V_139 = & V_2 -> V_280 ;
V_274 -> V_243 = V_242 ;
F_97 ( & V_274 -> V_202 ) ;
V_254 = F_86 ( V_274 ) ;
if ( V_254 < 0 )
