...
int F_22 ( T_2 * V_8 , struct V_51 * V_52 )
{
struct V_49 * V_53 = NULL ;
struct V_34 * V_35 = (struct V_34 * ) F_23 ( V_52 ) ;
struct V_54 * V_55 = & ( V_35 -> V_56 ) ;
int V_57 = 0 ;
if ( F_24 ( V_35 ) == false ) {
V_57 = 0 ;
goto V_58;
...
if ( ( ! F_26 ( V_35 , V_8 , & V_53 -> V_59 ) ) ) {
V_57 = 0 ;
goto V_58;
}
V_35 -> V_60 . V_61 ( V_35 , V_62 ) ;
V_53 -> V_8 = V_8 ;
if ( F_27 ( V_35 , V_53 ) == true ) {
F_21 ( V_8 ) ;
V_53 -> V_8 = NULL ;
}
V_55 -> V_63 ++ ;
V_55 -> V_64 += V_53 -> V_59 . V_65 ;
return V_57 ;
V_58:
if ( V_53 )
F_28 ( V_55 , V_53 ) ;
