...
const char * V_69 = F_15 ( V_76 ) ;
F_22 ( V_19 , V_69 , stdout ) ;
F_26 ( V_19 , NULL , false , true , 0 , 0 , stdout ) ;
fprintf ( stdout , L_17 ) ;
}
if ( V_77 == V_78 &&
V_79 == V_80 ) {
...
signal ( V_87 , F_21 ) ;
V_2 = F_30 ( V_88 , V_89 , V_90 , false , & V_91 ) ;
if ( V_2 == NULL )
return - V_21 ;
if ( V_44 ) {
V_71 = F_31 ( V_2 , V_44 , V_46 ) ;
if ( V_71 )
goto V_92;
}
if ( V_24 <= 0 )
F_32 ( V_2 , stdout , V_93 ) ;
if ( V_53 )
F_33 ( & V_55 ) ;
V_71 = F_18 ( V_2 ) ;
if ( V_71 )
...
if ( V_71 )
goto V_92;
V_84 = V_2 -> V_94 . V_95 [ V_96 ] ;
V_86 = F_35 ( V_84 ) ;
if ( V_84 == NULL ||
( V_84 -> V_48 -> V_49 &&
( V_86 -> V_97 == NULL ||
V_86 -> V_97 -> V_33 == 0 ) ) ) {
const struct V_48 * V_98 = V_84 -> V_48 ;
F_19 (
L_21
L_22
L_23 ,
...
static int
F_43 ( const struct V_102 * T_5 V_50 , const char * V_103 ,
int V_104 )
{
char * V_105 , * V_106 ;
char * V_107 ;
...
int F_44 ( int V_117 , const char * * V_118 , const char * T_6 V_50 )
{
V_117 = F_45 ( V_117 , V_118 , V_119 , V_120 , 0 ) ;
if ( V_121 )
V_24 = 0 ;
else if ( V_122 )
V_24 = 1 ;
...
if ( V_117 )
F_50 ( V_120 , V_119 ) ;
F_51 ( & V_131 , V_15 . V_132 , L_38 , stdout ) ;
F_51 ( & V_133 , V_15 . V_134 , L_39 , stdout ) ;
F_51 ( & V_135 , V_15 . V_136 , L_40 , stdout ) ;
return F_29 () ;
}
