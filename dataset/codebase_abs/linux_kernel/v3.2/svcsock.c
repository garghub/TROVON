...
V_20 -> V_25 = V_36 ;
V_22 -> V_37 = V_34 -> V_38 ;
F_15 ( & V_22 -> V_39 , & V_34 -> V_40 ) ;
V_20 -> V_31 = F_13 ( sizeof( * V_22 ) ) ;
}
break;
}
}
int F_16 ( struct V_1 * V_2 , struct V_41 * V_42 ,
...
if ( V_58 == V_49 )
V_56 = 0 ;
V_48 = F_17 ( V_2 , * V_50 , V_52 , V_49 , V_56 ) ;
if ( V_48 > 0 )
V_59 += V_48 ;
if ( V_48 != V_49 )
goto V_62;
...
static int F_18 ( struct V_9 * V_10 , struct V_41 * V_42 )
{
struct V_14 * V_15 =
F_7 ( V_10 -> V_16 , struct V_14 , V_17 ) ;
...
unsigned long V_70 ;
unsigned long V_71 ;
F_19 (char buf[RPC_MAX_ADDRBUFLEN]) ;
if ( V_10 -> V_72 == V_73 ) {
struct V_74 V_75 = {
. V_76 = & V_10 -> V_77 ,
. V_78 = V_10 -> V_79 ,
...
F_10 ( V_10 , V_20 ) ;
if ( F_20 ( V_2 , & V_75 , 0 ) < 0 )
goto V_62;
}
V_70 = ( ( unsigned long ) V_42 -> V_64 [ 0 ] . V_83 ) & ( V_63 - 1 ) ;
V_71 = 0 ;
V_59 = F_16 ( V_2 , V_42 , V_10 -> V_84 [ 0 ] , V_71 ,
V_10 -> V_84 [ 0 ] , V_70 ) ;
V_62:
F_8 ( L_6 ,
V_15 , V_42 -> V_60 [ 0 ] . V_83 , V_42 -> V_60 [ 0 ] . V_61 ,
V_42 -> V_59 , V_59 , F_21 ( V_10 , V_85 , sizeof( V_85 ) ) ) ;
return V_59 ;
}
static int F_22 ( struct V_14 * V_15 , char * V_85 , int V_86 )
{
...
int F_25 ( struct V_95 * V_96 , char * V_85 , const T_1 V_97 ,
const char * V_98 )
{
...
return 0 ;
F_26 ( & V_96 -> V_100 ) ;
F_27 (svsk, &serv->sv_permsocks, sk_xprt.xpt_list) {
int V_101 = F_22 ( V_15 , V_85 + V_59 , V_97 - V_59 ) ;
if ( V_101 < 0 ) {
V_59 = V_101 ;
break;
}
...
struct V_1 * V_2 = V_15 -> V_65 ;
int V_103 , V_104 ;
V_104 = F_33 ( V_2 , V_105 , ( unsigned long ) & V_103 ) ;
return ( V_104 >= 0 ) ? V_103 : V_104 ;
}
static int F_34 ( struct V_9 * V_10 , struct V_106 * V_107 , int V_108 ,
int V_97 )
{
struct V_14 * V_15 =
F_7 ( V_10 -> V_16 , struct V_14 , V_17 ) ;
...
int V_59 ;
V_10 -> V_110 = 0 ;
V_59 = F_35 ( V_15 -> V_65 , & V_75 , V_107 , V_108 , V_97 ,
V_75 . V_82 ) ;
F_8 ( L_12 ,
...
int V_114 ;
if ( V_52 == 0 )
return F_34 ( V_10 , V_107 , V_108 , V_97 ) ;
...
V_114 = F_34 ( V_10 , & V_107 [ V_113 ] , V_108 - V_113 , V_97 ) ;
V_107 [ V_113 ] . V_61 = V_111 ;
V_107 [ V_113 ] . V_83 = V_112 ;
return V_114 ;
}
static void F_37 ( struct V_1 * V_2 , unsigned int V_115 ,
unsigned int V_116 )
{
#if 0
mm_segment_t oldfs;
...
static void F_40 ( struct V_2 * V_3 , int V_120 )
{
...
F_8 ( L_13 ,
V_15 , V_3 , V_120 ,
F_42 ( V_123 , & V_15 -> V_17 . V_124 ) ) ;
F_43 ( V_125 , & V_15 -> V_17 . V_124 ) ;
F_44 ( & V_15 -> V_17 ) ;
}
if ( V_122 && F_45 ( V_122 ) )
F_46 ( V_122 ) ;
...
if ( V_15 ) {
F_8 ( L_14 ,
V_15 , V_3 , F_42 ( V_123 , & V_15 -> V_17 . V_124 ) ) ;
F_44 ( & V_15 -> V_17 ) ;
}
if ( V_122 && F_45 ( V_122 ) ) {
F_8 ( L_15 ,
...
T_1 V_59 ;
int V_104 ;
if ( F_57 ( V_132 , & V_15 -> V_17 . V_124 ) )
F_37 ( V_15 -> V_65 ,
( V_96 -> V_133 + 3 ) * V_96 -> V_134 ,
( V_96 -> V_133 + 3 ) * V_96 -> V_134 ) ;
F_51 ( V_125 , & V_15 -> V_17 . V_124 ) ;
V_12 = NULL ;
V_104 = F_35 ( V_15 -> V_65 , & V_75 , NULL ,
0 , 0 , V_135 | V_109 ) ;
if ( V_104 >= 0 )
V_12 = F_58 ( V_15 -> V_18 , 0 , 1 , & V_104 ) ;
if ( V_12 == NULL ) {
if ( V_104 != - V_136 ) {
F_8 ( L_16 , - V_104 ) ;
F_43 ( V_125 , & V_15 -> V_17 . V_124 ) ;
...
V_10 -> V_144 = F_59 ( F_63 ( V_10 ) ) ;
if ( F_64 ( V_12 ) ) {
F_65 () ;
if ( F_66 ( & V_10 -> V_142 , V_12 ) ) {
F_67 () ;
F_9 ( V_15 -> V_18 , V_12 ) ;
return 0 ;
}
...
unsigned long V_153 ;
F_43 ( V_127 , & V_15 -> V_65 -> V_56 ) ;
V_153 = F_73 ( & V_15 -> V_17 . V_154 ) + V_96 -> V_134 ;
if ( V_153 * 2 > F_74 ( V_15 -> V_18 ) )
return 0 ;
F_51 ( V_127 , & V_15 -> V_65 -> V_56 ) ;
return 1 ;
}
static struct V_151 * F_75 ( struct V_151 * V_152 )
{
F_5 () ;
return NULL ;
}
...
int V_56 )
{
return F_77 ( V_96 , V_73 , V_155 , V_157 , V_158 , V_56 ) ;
}
static void F_78 ( struct V_14 * V_15 , struct V_95 * V_96 )
{
int V_104 , V_159 , V_160 , V_161 = 1 ;
F_79 ( & V_162 , & V_15 -> V_17 , V_96 ) ;
F_51 ( V_163 , & V_15 -> V_17 . V_124 ) ;
V_15 -> V_18 -> V_164 = F_40 ;
V_15 -> V_18 -> V_119 = F_47 ;
F_37 ( V_15 -> V_65 ,
3 * V_15 -> V_17 . V_131 -> V_134 ,
3 * V_15 -> V_17 . V_131 -> V_134 ) ;
F_43 ( V_125 , & V_15 -> V_17 . V_124 ) ;
F_43 ( V_132 , & V_15 -> V_17 . V_124 ) ;
switch ( V_15 -> V_18 -> V_4 ) {
case V_5 :
V_159 = V_24 ;
V_160 = V_26 ;
...
if ( ! V_2 )
return NULL ;
F_51 ( V_169 , & V_15 -> V_17 . V_124 ) ;
V_104 = F_86 ( V_2 , & V_173 , V_175 ) ;
if ( V_104 < 0 ) {
if ( V_104 == - V_176 )
F_62 ( V_143 L_25 ,
V_96 -> V_177 ) ;
else if ( V_104 != - V_136 && F_61 () )
F_62 ( V_143 L_26 ,
V_96 -> V_177 , - V_104 ) ;
return NULL ;
}
...
V_107 . V_61 = V_190 ;
if ( ( V_59 = F_34 ( V_10 , & V_107 , 1 , V_190 ) ) < 0 )
goto error;
V_15 -> V_186 += V_59 ;
if ( V_59 < V_190 ) {
F_8 ( L_31
...
int V_212 ;
F_8 ( L_41 ,
V_15 , F_42 ( V_125 , & V_15 -> V_17 . V_124 ) ,
...
V_59 = F_36 ( V_10 , V_210 , V_212 , V_190 , V_52 ) ;
if ( V_59 >= 0 )
V_15 -> V_186 += V_59 ;
if ( V_59 != V_190 ) {
...
struct V_95 * V_96 = V_15 -> V_17 . V_131 ;
int V_153 ;
if ( F_42 ( V_222 , & V_152 -> V_124 ) )
return 1 ;
V_153 = F_73 ( & V_152 -> V_154 ) + V_96 -> V_134 ;
if ( F_49 ( V_15 -> V_18 ) >= V_153 )
return 1 ;
F_43 ( V_127 , & V_15 -> V_65 -> V_56 ) ;
return 0 ;
}
...
int V_56 )
{
return F_77 ( V_96 , V_216 , V_155 , V_157 , V_158 , V_56 ) ;
}
...
F_79 ( & V_224 , & V_15 -> V_17 , V_96 ) ;
F_43 ( V_163 , & V_15 -> V_17 . V_124 ) ;
if ( V_3 -> V_167 == V_168 ) {
F_8 ( L_50 ) ;
F_43 ( V_222 , & V_15 -> V_17 . V_124 ) ;
V_3 -> V_164 = F_81 ;
F_43 ( V_169 , & V_15 -> V_17 . V_124 ) ;
} else {
F_8 ( L_51 ) ;
...
F_27 (svsk, &serv->sv_permsocks, sk_xprt.xpt_list)
F_43 ( V_132 , & V_15 -> V_17 . V_124 ) ;
F_27 (svsk, &serv->sv_tempsocks, sk_xprt.xpt_list)
F_43 ( V_132 , & V_15 -> V_17 . V_124 ) ;
F_29 ( & V_96 -> V_100 ) ;
}
...
return F_22 ( V_15 , V_239 , V_59 ) ;
}
static struct V_151 * F_77 ( struct V_95 * V_96 ,
int V_250 ,
struct V_155 * V_155 ,
