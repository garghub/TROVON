...
if ( V_1 -> V_21 )
return - V_278 ;
V_21 -> V_21 . V_279 = NULL ;
V_1 -> V_21 = V_21 ;
V_1 -> V_18 . V_280 . V_21 = & V_21 -> V_21 ;
V_277 = F_100 ( & V_1 -> V_18 . V_280 ) ;
if ( V_277 ) {
F_16 ( L_19 , V_277 ) ;
goto error;
}
...
if ( V_277 ) {
F_16 ( L_20 , V_277 ) ;
F_101 ( & V_1 -> V_18 . V_280 ) ;
goto error;
}
F_5 ( V_1 , V_281 | V_282 , V_7 ) ;
...
struct V_1 * V_1 = V_276 ;
unsigned long V_262 ;
if ( V_21 != V_1 -> V_21 || ! V_21 -> V_283 )
return - V_61 ;
F_85 ( & V_1 -> V_17 , V_262 ) ;
if ( V_1 -> V_18 . V_19 != V_20 )
F_9 ( V_1 ) ;
F_86 ( & V_1 -> V_17 , V_262 ) ;
F_4 ( V_1 , V_281 | V_282 , V_7 ) ;
V_21 -> V_283 ( & V_1 -> V_18 ) ;
V_1 -> V_18 . V_280 . V_21 = NULL ;
F_56 ( V_1 ) ;
F_12 ( V_1 ) ;
...
static int F_103 ( struct V_275 * V_284 )
{
struct V_1 * V_1 = F_104 ( V_284 ) ;
return F_2 ( V_1 , V_285 ) & 0x03FF ;
}
static int F_105 ( struct V_275 * V_18 , int V_286 )
{
...
static int T_5 F_106 ( struct V_287 * V_288 )
{
struct V_1 * V_1 = F_107 ( & V_288 -> V_280 ) ;
F_108 ( & V_1 -> V_18 ) ;
F_109 ( & V_1 -> V_257 ) ;
F_110 ( V_1 -> V_5 ) ;
F_111 ( F_112 ( V_288 , 0 ) , V_1 ) ;
...
static void F_116 ( struct V_263 * V_23 , struct V_266 * V_290 )
{
}
static int T_6 F_117 ( struct V_287 * V_288 )
{
...
int V_33 = 0 ;
int V_178 ;
V_292 = F_118 ( V_288 , V_295 , 0 ) ;
if ( ! V_292 ) {
V_33 = - V_112 ;
F_16 ( L_21 ) ;
goto V_296;
}
V_293 = F_118 ( V_288 , V_297 , 0 ) ;
if ( ! V_293 ) {
V_33 = - V_112 ;
F_119 ( & V_288 -> V_280 ,
L_22 ) ;
...
V_5 = F_120 ( V_292 -> V_298 , F_121 ( V_292 ) ) ;
if ( V_5 == NULL ) {
V_33 = - V_75 ;
F_16 ( L_23 ) ;
goto V_296;
}
if ( V_288 -> V_280 . V_299 == NULL ) {
F_119 ( & V_288 -> V_280 , L_24 ) ;
V_33 = - V_112 ;
goto V_296;
}
...
V_1 -> V_51 = V_288 -> V_280 . V_299 ;
V_1 -> V_160 = V_293 -> V_262 & V_300 ;
F_122 ( & V_1 -> V_17 ) ;
F_123 ( & V_288 -> V_280 , V_1 ) ;
V_1 -> V_18 . V_301 = & V_302 ;
F_124 ( & V_1 -> V_18 . V_280 ) ;
F_125 ( & V_1 -> V_18 . V_280 , L_26 ) ;
V_1 -> V_18 . V_303 = 1 ;
V_1 -> V_18 . V_280 . V_304 = & V_288 -> V_280 ;
V_1 -> V_18 . V_280 . V_305 = V_288 -> V_280 . V_305 ;
V_1 -> V_18 . V_280 . V_306 = V_288 -> V_280 . V_306 ;
V_1 -> V_18 . V_307 = V_308 ;
F_126 ( & V_1 -> V_257 ) ;
V_1 -> V_257 . V_309 = F_84 ;
V_1 -> V_257 . V_310 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
V_33 = F_127 ( V_293 -> V_298 , F_81 , V_311 ,
V_308 , V_1 ) ;
if ( V_33 < 0 ) {
F_16 ( L_27 , V_33 ) ;
goto V_296;
...
#ifdef F_113
if ( V_1 -> V_51 -> V_52 ) {
snprintf ( V_294 , sizeof( V_294 ) , L_28 , V_288 -> V_312 ) ;
V_1 -> V_289 = F_128 ( & V_288 -> V_280 , V_294 ) ;
if ( F_129 ( V_1 -> V_289 ) ) {
F_119 ( & V_288 -> V_280 , L_29 ,
V_294 ) ;
V_33 = F_130 ( V_1 -> V_289 ) ;
goto V_313;
}
F_131 ( V_1 -> V_289 ) ;
}
...
F_56 ( V_1 ) ;
V_33 = F_132 ( & V_288 -> V_280 , & V_1 -> V_18 ) ;
if ( V_33 )
goto V_318;
F_133 ( & V_288 -> V_280 , L_30 , V_319 ) ;
return 0 ;
V_318:
F_92 ( & V_1 -> V_23 [ 0 ] . V_23 , V_1 -> V_205 ) ;
V_317:
