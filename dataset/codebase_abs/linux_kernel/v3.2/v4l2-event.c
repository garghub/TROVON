...
if ( V_2 -> V_5 == 1 ) {
if ( V_2 -> V_32 ) {
V_2 -> V_32 ( & V_11 -> V_9 , V_26 ) ;
V_29 = false ;
}
} else if ( V_2 -> V_33 ) {
struct V_10 * V_34 =
V_2 -> V_31 + F_1 ( V_2 , 0 ) ;
V_2 -> V_33 ( & V_11 -> V_9 , & V_34 -> V_9 ) ;
}
}
V_11 = V_2 -> V_31 + F_1 ( V_2 , V_2 -> V_20 ) ;
V_11 -> V_9 . type = V_26 -> type ;
if ( V_29 )
V_11 -> V_9 . V_35 = V_26 -> V_35 ;
...
void F_19 ( struct V_37 * V_13 , const struct V_8 * V_26 )
{
struct V_6 * V_7 ;
unsigned long V_12 ;
struct V_27 V_36 ;
...
static void F_23 ( struct V_8 * V_38 , const struct V_8 * V_39 )
{
T_1 V_40 = V_38 -> V_35 . V_41 . V_42 ;
V_38 -> V_35 . V_41 = V_39 -> V_35 . V_41 ;
V_38 -> V_35 . V_41 . V_42 |= V_40 ;
}
static void F_24 ( const struct V_8 * V_38 , struct V_8 * V_39 )
{
V_39 -> V_35 . V_41 . V_42 |= V_38 -> V_35 . V_41 . V_42 ;
}
int F_25 ( struct V_6 * V_7 ,
struct V_43 * V_44 , unsigned V_5 )
{
struct V_1 * V_2 , * V_45 ;
struct V_46 * V_41 = NULL ;
unsigned long V_12 ;
unsigned V_47 ;
if ( V_44 -> type == V_48 )
return - V_49 ;
...
V_5 = 1 ;
if ( V_44 -> type == V_50 ) {
V_41 = F_26 ( V_7 -> V_51 , V_44 -> V_25 ) ;
if ( V_41 == NULL )
return - V_49 ;
}
V_2 = F_27 ( sizeof( * V_2 ) + sizeof( struct V_10 ) * V_5 , V_52 ) ;
if ( ! V_2 )
return - V_53 ;
for ( V_47 = 0 ; V_47 < V_5 ; V_47 ++ )
V_2 -> V_31 [ V_47 ] . V_2 = V_2 ;
V_2 -> type = V_44 -> type ;
V_2 -> V_25 = V_44 -> V_25 ;
V_2 -> V_12 = V_44 -> V_12 ;
V_2 -> V_7 = V_7 ;
...
F_3 ( & V_7 -> V_13 -> V_14 , V_12 ) ;
V_45 = F_13 ( V_7 , V_44 -> type , V_44 -> V_25 ) ;
if ( ! V_45 )
F_28 ( & V_2 -> V_18 , & V_7 -> V_54 ) ;
F_5 ( & V_7 -> V_13 -> V_14 , V_12 ) ;
if ( V_45 )
F_29 ( V_2 ) ;
else if ( V_41 )
...
F_3 ( & V_7 -> V_13 -> V_14 , V_12 ) ;
V_2 = F_13 ( V_7 , V_44 -> type , V_44 -> V_25 ) ;
if ( V_2 != NULL ) {
for ( V_47 = 0 ; V_47 < V_2 -> V_20 ; V_47 ++ ) {
F_8 ( & V_2 -> V_31 [ F_1 ( V_2 , V_47 ) ] . V_18 ) ;
V_7 -> V_17 -- ;
}
F_8 ( & V_2 -> V_18 ) ;
}
F_5 ( & V_7 -> V_13 -> V_14 , V_12 ) ;
if ( V_2 && V_2 -> type == V_50 ) {
struct V_46 * V_41 = F_26 ( V_7 -> V_51 , V_2 -> V_25 ) ;
if ( V_41 )
F_33 ( V_41 , V_2 ) ;
}
F_29 ( V_2 ) ;
