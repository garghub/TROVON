...
V_101 , 0 , V_31 -> V_102 , & V_142 ) ;
if ( error < 0 )
F_6 ( V_151 L_75 ,
V_101 ) ;
}
if ( V_152 > 0 && V_152 != V_149 ) {
struct V_153 * V_154 = NULL ;
struct V_155 * V_156 ;
if ( F_64 ( V_74 , V_152 , V_152 - 8 ,
2 , & V_154 , & V_156 ) < 0 )
F_6 ( V_151 L_76 ,
V_152 ) ;
}
...
static int T_1 F_66 ( struct V_157 * V_158 , unsigned int V_159 )
{
#ifdef F_39
if ( V_160 )
return 0 ;
...
static int T_1 F_67 ( struct V_157 * V_158 , unsigned int V_159 )
{
static long V_161 [] = { 0x530 , 0xe80 , 0xf40 , 0x604 , - 1 } ;
static long V_162 [] = { 0x330 , 0x300 , 0x310 , 0x320 , - 1 } ;
static int V_163 [] = { 11 , 9 , 10 , 7 , - 1 } ;
static int V_164 [] = { 10 , 5 , 9 , 7 , - 1 } ;
static int V_165 [] = { 3 , 1 , 0 , - 1 } ;
static int V_166 [] [ 2 ] = { { 1 , - 1 } , { 0 , - 1 } , { - 1 , - 1 } ,
{ 0 , - 1 } } ;
int error ;
struct V_30 * V_31 ;
struct V_73 * V_74 ;
error = F_68 ( V_23 , V_167 , V_168 ,
...
static int T_2 F_73 ( struct V_157 * V_158 ,
unsigned int V_172 )
{
F_58 ( F_74 ( V_158 ) ) ;
F_72 ( V_158 , NULL ) ;
...
struct V_176 * V_178 ;
struct V_176 * V_179 ;
V_177 = F_76 ( V_74 , V_175 -> V_180 [ 0 ] . V_167 , NULL ) ;
if ( V_177 == NULL )
return - V_12 ;
V_178 = F_76 ( V_74 , V_175 -> V_180 [ 1 ] . V_167 , NULL ) ;
if ( V_178 == NULL )
return - V_12 ;
V_179 = F_76 ( V_74 , V_175 -> V_180 [ 2 ] . V_167 , NULL ) ;
if ( V_179 == NULL )
return - V_12 ;
V_75 = F_77 ( V_177 ) ;
if ( V_75 < 0 ) {
...
V_143 = F_78 ( V_177 , 1 ) ;
V_152 = F_78 ( V_177 , 2 ) + 8 ;
V_91 -> V_105 = F_78 ( V_179 , 0 ) - 1 ;
V_91 -> V_95 = F_79 ( V_179 , 0 ) + 1 ;
V_98 = F_80 ( V_177 , 0 ) ;
V_99 = F_81 ( V_177 , 0 ) ;
V_100 = F_81 ( V_177 , 1 ) ;
if ( V_101 > 0 ) {
...
static int T_1 F_82 ( struct V_173 * V_181 ,
const struct V_174 * V_175 )
{
struct V_73 * V_74 ;
int V_75 ;
...
if ( ! V_104 )
return - V_107 ;
V_75 = F_68 ( V_23 , V_167 , V_168 ,
sizeof( struct V_30 ) , & V_74 ) ;
if ( V_75 < 0 )
return V_75 ;
V_74 -> V_169 = F_56 ;
V_31 = V_74 -> V_114 ;
V_75 = F_75 ( V_31 , V_181 , V_175 ) ;
if ( V_75 ) {
F_58 ( V_74 ) ;
return V_75 ;
}
...
static void T_2 F_84 ( struct V_173 * V_181 )
{
F_58 ( F_85 ( V_181 ) ) ;
F_83 ( V_181 , NULL ) ;
V_160 = 0 ;
