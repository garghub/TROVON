...
void * F_71 ( struct V_184 * V_21 , T_8 V_73 ,
T_3 * V_282 )
{
struct V_46 * V_47 ;
V_47 = F_16 ( V_21 , struct V_46 , V_48 ) ;
return F_72 ( V_47 , V_73 , V_282 ) ;
}
void F_73 ( struct V_184 * V_21 , T_8 V_73 , void * V_283 ,
T_3 V_282 )
{
struct V_46 * V_47 ;
V_47 = F_16 ( V_21 , struct V_46 , V_48 ) ;
F_74 ( V_47 , V_73 , V_283 , V_282 ) ;
}
...
F_78 ( & V_47 -> V_48 , L_36 , V_278 ) ;
if ( V_278 == 0 ) {
F_8 ( & V_47 -> V_48 , L_37
L_38 ) ;
return - V_66 ;
}
V_2 -> V_285 = F_72 ( V_47 , V_286 ,
& V_2 -> V_287 ) ;
if ( V_2 -> V_285 == NULL ) {
F_8 ( & V_47 -> V_48 , L_39
L_40 ) ;
...
memset ( V_2 -> V_285 , 0 , V_286 ) ;
V_284 = V_278 * ( 512 * 1024 ) ;
F_14 ( V_2 -> V_287 - V_284 , V_2 -> V_19 + V_288 ) ;
V_45 = F_7 ( V_2 -> V_19 + V_289 ) ;
V_45 |= V_290 ;
F_14 ( V_45 , V_2 -> V_19 + V_289 ) ;
return 0 ;
}
...
V_45 &= ~ V_290 ;
F_14 ( V_45 , V_2 -> V_19 + V_289 ) ;
F_14 ( 0 , V_2 -> V_19 + V_288 ) ;
F_74 ( V_47 , V_286 , V_2 -> V_285 ,
V_2 -> V_287 ) ;
}
static int F_80 ( struct V_46 * V_47 , const struct V_291 * V_292 )
{
int V_116 , V_6 ;
T_1 V_293 ;
...
struct V_238 * V_297 ;
struct V_260 * V_261 ;
V_16 = F_81 ( sizeof( struct V_15 ) , V_205 ) ;
if ( V_16 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_294 = F_81 ( sizeof( struct V_1 ) , V_205 ) ;
if ( V_294 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_293 = F_7 ( V_294 -> V_19 + V_302 ) & 0x0000FFFF ;
if ( V_293 != V_303 ) {
F_8 ( & V_47 -> V_48 , L_45 ) ;
V_116 = - V_301 ;
goto V_304;
...
F_17 ( & V_16 -> V_306 ) ;
for ( V_6 = 0 ; V_6 < V_307 ; V_6 ++ ) {
V_295 = F_35 ( sizeof( struct V_114 ) ,
V_205 ) ;
if ( V_295 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_48 ) ;
...
V_295 -> V_309 = 0 ;
V_295 -> V_82 = V_6 ;
V_295 -> V_310 = V_83 | V_85 | V_87 |
V_94 | V_89 | V_91 ;
V_295 -> V_311 = V_171 | V_142 | V_144 |
V_105 | V_107 | V_109 | V_111 ;
V_295 -> V_312 = V_147 | V_149 | V_151 | V_153 ;
memset ( & V_295 -> V_117 , 0 ,
sizeof( struct V_122 ) ) ;
V_295 -> V_120 = NULL ;
F_54 ( & V_295 -> V_193 ,
& V_16 -> V_306 ) ;
...
F_17 ( & V_16 -> V_313 ) ;
for ( V_6 = 0 ; V_6 < V_314 ; V_6 ++ ) {
V_296 = F_35 ( sizeof( struct V_69 ) ,
V_205 ) ;
if ( V_296 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_49 ) ;
...
V_296 -> V_309 = 0 ;
V_296 -> V_82 = V_6 ;
V_296 -> V_310 = V_85 | V_87 | V_89 |
V_91 ;
if ( V_6 == 0 || V_6 == 4 )
V_296 -> V_310 |= V_83 ;
V_296 -> V_311 = V_171 | V_142 | V_144 |
V_105 | V_107 | V_109 | V_111 ;
F_54 ( & V_296 -> V_193 ,
& V_16 -> V_313 ) ;
}
F_17 ( & V_16 -> V_316 ) ;
for ( V_6 = 0 ; V_6 < V_317 ; V_6 ++ ) {
V_297 = F_35 ( sizeof( struct V_238 ) ,
V_205 ) ;
if ( V_297 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_50 ) ;
...
V_16 -> V_342 = F_71 ;
V_16 -> V_343 = F_73 ;
V_293 = F_7 ( V_294 -> V_19 + V_344 ) ;
F_78 ( & V_47 -> V_48 , L_52 ,
( V_293 & V_345 ) ? L_53 : L_54 ) ;
F_78 ( & V_47 -> V_48 , L_55 ,
F_70 ( V_16 ) ) ;
if ( F_77 ( V_16 , V_47 ) )
F_8 ( & V_47 -> V_48 , L_56 ) ;
...
F_79 ( V_16 , V_47 ) ;
V_324:
F_89 (pos, &ca91cx42_bridge->lm_resources) {
V_261 = F_55 ( V_258 , struct V_260 , V_193 ) ;
F_62 ( V_258 ) ;
F_33 ( V_261 ) ;
}
V_318:
F_89 (pos, &ca91cx42_bridge->dma_resources) {
V_297 = F_55 ( V_258 , struct V_238 , V_193 ) ;
F_62 ( V_258 ) ;
F_33 ( V_297 ) ;
}
V_315:
F_89 (pos, &ca91cx42_bridge->slave_resources) {
V_296 = F_55 ( V_258 , struct V_69 , V_193 ) ;
F_62 ( V_258 ) ;
F_33 ( V_296 ) ;
}
V_308:
F_89 (pos, &ca91cx42_bridge->master_resources) {
V_295 = F_55 ( V_258 , struct V_114 ,
V_193 ) ;
F_62 ( V_258 ) ;
F_33 ( V_295 ) ;
}
