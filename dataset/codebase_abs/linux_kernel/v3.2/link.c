...
static int
F_23 ( const int V_33 , struct V_34 * V_35 ,
...
void *
F_41 ( struct V_89 * V_92 , struct V_101 * V_102 )
{
...
if ( ! V_103 )
goto V_81;
F_14 ( 1 , L_8 , V_103 , V_91 ) ;
V_4 = - V_93 ;
if ( V_39 -> V_51 & V_105 )
V_4 = F_23 ( V_33 , V_35 , V_103 , & V_104 ,
V_39 -> V_50 ,
V_39 -> V_51 &
V_52 ) ;
if ( ( V_4 != 0 ) && ( V_35 -> V_106 -> V_107 & V_108 ) )
V_4 = F_42 ( V_33 , V_35 , V_103 , & V_104 ,
V_39 -> V_50 ) ;
F_12 ( V_103 ) ;
V_81:
if ( V_4 != 0 ) {
...
int
F_45 ( struct V_91 * V_91 , struct V_89 * V_92 , const char * V_109 )
{
int V_4 = - V_99 ;
int V_33 ;
struct V_38 * V_39 = F_32 ( V_91 -> V_94 ) ;
...
F_14 ( 1 , L_10 , V_109 ) ;
if ( V_39 -> V_51 & V_105 )
V_4 = F_18 ( V_33 , V_80 , V_103 , V_109 ,
V_39 ) ;
else if ( V_80 -> V_98 )
V_4 = F_46 ( V_33 , V_80 , V_103 , V_109 ,
V_39 -> V_50 ) ;
if ( V_4 == 0 ) {
if ( V_80 -> V_98 )
V_4 = F_47 ( & V_110 , V_103 ,
V_91 -> V_94 , V_33 ) ;
else
V_4 = F_48 ( & V_110 , V_103 , NULL ,
V_91 -> V_94 , V_33 , NULL ) ;
if ( V_4 != 0 ) {
F_14 ( 1 , L_11 ,
V_4 ) ;
...
void F_50 ( struct V_89 * V_92 , struct V_101 * V_102 , void * V_112 )
{
char * V_113 = F_51 ( V_102 ) ;
if ( ! F_3 ( V_113 ) )
F_12 ( V_113 ) ;
}
