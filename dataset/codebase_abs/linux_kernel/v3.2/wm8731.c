...
break;
case V_76 :
if ( V_2 -> V_55 . V_77 == V_78 ) {
V_20 = F_23 ( F_3 ( V_4 -> V_79 ) ,
V_4 -> V_79 ) ;
if ( V_20 != 0 )
return V_20 ;
F_24 ( V_2 ) ;
}
V_73 = F_14 ( V_2 , V_80 ) & 0xff7f ;
F_16 ( V_2 , V_80 , V_73 | 0x0040 ) ;
break;
case V_78 :
F_16 ( V_2 , V_80 , 0xffff ) ;
F_25 ( F_3 ( V_4 -> V_79 ) ,
V_4 -> V_79 ) ;
V_2 -> V_81 = 1 ;
break;
...
static int F_26 ( struct V_1 * V_2 , T_2 V_82 )
{
F_22 ( V_2 , V_78 ) ;
return 0 ;
}
...
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_20 = 0 , V_6 ;
V_20 = F_29 ( V_2 , 7 , 9 , V_4 -> V_83 ) ;
if ( V_20 < 0 ) {
F_30 ( V_2 -> V_11 , L_2 , V_20 ) ;
return V_20 ;
}
for ( V_6 = 0 ; V_6 < F_3 ( V_4 -> V_79 ) ; V_6 ++ )
V_4 -> V_79 [ V_6 ] . V_84 = V_85 [ V_6 ] ;
V_20 = F_31 ( V_2 -> V_11 , F_3 ( V_4 -> V_79 ) ,
V_4 -> V_79 ) ;
if ( V_20 != 0 ) {
F_30 ( V_2 -> V_11 , L_3 , V_20 ) ;
return V_20 ;
}
V_20 = F_23 ( F_3 ( V_4 -> V_79 ) ,
V_4 -> V_79 ) ;
if ( V_20 != 0 ) {
F_30 ( V_2 -> V_11 , L_4 , V_20 ) ;
goto V_86;
}
V_20 = F_32 ( V_2 ) ;
if ( V_20 < 0 ) {
F_30 ( V_2 -> V_11 , L_5 , V_20 ) ;
goto V_87;
}
F_22 ( V_2 , V_76 ) ;
F_5 ( V_2 , V_88 , 0x100 , 0 ) ;
F_5 ( V_2 , V_89 , 0x100 , 0 ) ;
F_5 ( V_2 , V_90 , 0x100 , 0 ) ;
F_5 ( V_2 , V_91 , 0x100 , 0 ) ;
F_5 ( V_2 , V_92 , 0x8 , 0 ) ;
F_33 ( V_2 , V_93 ,
F_3 ( V_93 ) ) ;
F_25 ( F_3 ( V_4 -> V_79 ) , V_4 -> V_79 ) ;
return 0 ;
V_87:
F_25 ( F_3 ( V_4 -> V_79 ) , V_4 -> V_79 ) ;
V_86:
F_34 ( F_3 ( V_4 -> V_79 ) , V_4 -> V_79 ) ;
return V_20 ;
}
...
static int T_3 F_36 ( struct V_94 * V_95 )
{
struct V_3 * V_4 ;
int V_20 ;
V_4 = F_37 ( sizeof( struct V_3 ) , V_96 ) ;
if ( V_4 == NULL )
return - V_97 ;
V_4 -> V_83 = V_98 ;
F_38 ( V_95 , V_4 ) ;
...
static int T_4 F_41 ( struct V_94 * V_95 )
{
F_42 ( & V_95 -> V_11 ) ;
F_40 ( F_43 ( V_95 ) ) ;
return 0 ;
}
static T_3 int F_44 ( struct V_101 * V_102 ,
...
F_45 ( V_102 , V_4 ) ;
V_4 -> V_83 = V_105 ;
V_20 = F_39 ( & V_102 -> V_11 ,
& V_99 , & V_100 , 1 ) ;
if ( V_20 < 0 )
F_40 ( V_4 ) ;
return V_20 ;
}
static T_4 int F_46 ( struct V_101 * V_106 )
{
F_42 ( & V_106 -> V_11 ) ;
F_40 ( F_47 ( V_106 ) ) ;
return 0 ;
