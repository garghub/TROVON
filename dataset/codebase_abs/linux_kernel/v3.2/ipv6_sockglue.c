...
V_43 = F_48 ( V_2 , V_170 . V_172 , & V_170 . V_173 ) ;
break;
}
case V_174 :
case V_175 :
...
V_43 = F_50 ( V_2 , V_170 . V_172 , & V_170 . V_176 ) ;
break;
}
case V_177 :
case V_178 :
...
V_43 = F_51 ( V_194 , V_193 , V_2 , & V_192 ) ;
break;
}
case V_200 :
{
...
V_35 != V_221 ) {
F_21 ( V_2 ) ;
V_239 = F_60 ( V_2 , V_243 , V_35 , V_36 ,
V_37 ) ;
F_57 ( V_2 ) ;
}
#endif
...
if ( ! V_246 )
return 0 ;
V_245 = F_65 (unsigned int, len, ipv6_optlen(hdr)) ;
if ( F_66 ( V_36 , V_246 , V_245 ) )
return - V_44 ;
return V_245 ;
}
...
if ( V_245 < F_52 ( 0 ) )
return - V_125 ;
if ( F_41 ( & V_203 , V_36 , F_52 ( 0 ) ) )
return - V_44 ;
if ( V_203 . V_251 . V_184 != V_56 )
return - V_62 ;
F_21 ( V_2 ) ;
V_239 = F_69 ( V_2 , & V_203 ,
...
F_57 ( V_2 ) ;
if ( V_252 ) {
int V_239 = F_71 ( V_2 , & V_143 , V_252 ) ;
F_33 ( V_252 ) ;
if ( V_239 )
return V_239 ;
} else {
...
V_39 -> V_139 . V_138 ;
V_39 -> V_166 ? F_42 ( & V_255 . V_140 , & V_39 -> V_61 ) :
F_42 ( & V_255 . V_140 , & ( V_39 -> V_139 . V_140 ) ) ;
F_72 ( & V_143 , V_242 , V_134 , sizeof( V_255 ) , & V_255 ) ;
}
if ( V_39 -> V_84 . V_85 . V_90 ) {
int V_256 = V_39 -> V_158 ;
F_72 ( & V_143 , V_242 , V_257 , sizeof( V_256 ) , & V_256 ) ;
}
...
V_39 -> V_166 ? F_42 ( & V_255 . V_140 , & V_39 -> V_61 ) :
F_42 ( & V_255 . V_140 , & ( V_39 -> V_139 . V_140 ) ) ;
F_72 ( & V_143 , V_242 , V_87 , sizeof( V_255 ) , & V_255 ) ;
}
if ( V_39 -> V_84 . V_85 . V_92 ) {
int V_256 = V_39 -> V_158 ;
F_72 ( & V_143 , V_242 , V_91 , sizeof( V_256 ) , & V_256 ) ;
}
}
V_245 -= V_143 . V_152 ;
return F_73 ( V_245 , V_37 ) ;
}
case V_211 :
{
struct V_258 * V_259 ;
...
V_259 = F_75 ( V_2 ) ;
if ( V_259 )
V_262 . V_263 = F_76 ( V_259 ) ;
F_77 () ;
if ( ! V_262 . V_263 )
return - V_60 ;
if ( F_73 ( V_245 , V_37 ) )
return - V_44 ;
if ( F_66 ( V_36 , & V_262 , V_245 ) )
return - V_44 ;
return 0 ;
break;
}
...
V_245 = F_65 (unsigned int, sizeof(int), len) ;
if( F_73 ( V_245 , V_37 ) )
return - V_44 ;
if( F_66 ( V_36 , & V_41 , V_245 ) )
return - V_44 ;
return 0 ;
}
...
if( V_34 != V_242 )
return - V_12 ;
V_239 = F_67 ( V_2 , V_34 , V_35 , V_36 , V_37 , 0 ) ;
#ifdef F_59
...
return - V_44 ;
F_21 ( V_2 ) ;
V_239 = F_80 ( V_2 , V_243 , V_35 , V_36 ,
& V_245 ) ;
F_57 ( V_2 ) ;
if ( V_239 >= 0 )
V_239 = F_73 ( V_245 , V_37 ) ;
}
#endif
return V_239 ;
}
...
F_79 ) ;
V_239 = F_67 ( V_2 , V_34 , V_35 , V_36 , V_37 ,
V_268 ) ;
#ifdef F_59
if ( V_239 == - V_12 && V_35 != V_141 ) {
int V_245 ;
