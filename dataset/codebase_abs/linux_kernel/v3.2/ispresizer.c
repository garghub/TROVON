...
{
int V_251 ;
V_251 = F_82 ( V_250 , & V_3 -> V_112 ) ;
if ( V_251 < 0 )
goto error;
V_251 = F_83 ( & V_3 -> V_195 , V_250 ) ;
if ( V_251 < 0 )
goto error;
V_251 = F_83 ( & V_3 -> V_186 , V_250 ) ;
if ( V_251 < 0 )
goto error;
return 0 ;
error:
...
struct V_240 * V_252 = V_3 -> V_252 ;
struct V_239 * V_253 = & V_208 -> V_113 ;
int V_251 ;
V_3 -> V_129 = V_247 ;
F_85 ( V_208 , & V_254 ) ;
V_208 -> V_255 = & V_256 ;
F_86 ( V_208 -> V_214 , L_9 , sizeof( V_208 -> V_214 ) ) ;
V_208 -> V_257 = 1 << 16 ;
F_87 ( V_208 , V_3 ) ;
V_208 -> V_243 |= V_258 ;
V_252 [ V_12 ] . V_243 = V_259 ;
V_252 [ V_115 ] . V_243 = V_260 ;
V_253 -> V_261 = & V_262 ;
V_251 = F_88 ( V_253 , V_263 , V_252 , 0 ) ;
if ( V_251 < 0 )
return V_251 ;
F_74 ( V_208 , NULL ) ;
V_3 -> V_195 . type = V_205 ;
V_3 -> V_195 . V_261 = & V_264 ;
V_3 -> V_195 . V_18 = F_6 ( V_3 ) ;
V_3 -> V_195 . V_265 = F_89 ( 4096 * 4096 ) * 2 * 3 ;
V_3 -> V_195 . V_266 = 32 ;
V_3 -> V_186 . type = V_206 ;
V_3 -> V_186 . V_261 = & V_264 ;
V_3 -> V_186 . V_18 = F_6 ( V_3 ) ;
V_3 -> V_186 . V_265 = F_89 ( 4096 * 4096 ) * 2 * 3 ;
V_3 -> V_186 . V_266 = 32 ;
V_251 = F_90 ( & V_3 -> V_195 , L_10 ) ;
if ( V_251 < 0 )
goto V_267;
V_251 = F_90 ( & V_3 -> V_186 , L_10 ) ;
if ( V_251 < 0 )
goto V_268;
V_251 = F_91 ( & V_3 -> V_195 . V_203 . V_113 , 0 ,
& V_3 -> V_112 . V_113 , V_12 , 0 ) ;
if ( V_251 < 0 )
goto V_269;
V_251 = F_91 ( & V_3 -> V_112 . V_113 , V_115 ,
