...
V_4 -> V_9 = F_39 ( V_70 -> V_78 , F_40 ( V_70 ) ) ;
if ( V_4 -> V_9 == NULL ) {
F_29 ( V_46 , L_9 ) ;
V_47 = - V_35 ;
goto V_77;
}
V_70 = F_38 ( V_68 , V_79 , 0 ) ;
if ( V_70 == NULL ) {
F_29 ( V_46 , L_10 ) ;
V_47 = - V_35 ;
goto V_80;
}
V_47 = F_41 ( V_70 -> V_78 , F_8 , 0 , L_11 , V_4 ) ;
if ( V_47 ) {
F_29 ( V_46 , L_12 ) ;
goto V_80;
}
...
F_48 ( & V_4 -> V_3 , & V_88 ) ;
V_4 -> V_3 . V_89 = V_90 ;
F_49 ( V_4 -> V_3 . V_91 , L_11 , sizeof V_4 -> V_3 . V_91 ) ;
V_4 -> V_32 = F_11 ( V_92 ) ;
F_50 ( V_4 -> V_32 == NULL ) ;
F_51 ( V_46 , & V_4 -> V_3 ) ;
F_18 ( V_46 , L_27 ) ;
...
static int T_5 F_56 ( struct V_67 * V_68 )
{
...
{
int V_47 ;
static const char V_93 [] V_94 = V_95 \
L_30
L_31 ;
F_59 ( V_93 ) ;
V_47 = F_60 ( & V_96 ) ;
