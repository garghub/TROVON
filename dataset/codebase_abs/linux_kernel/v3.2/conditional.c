...
{
F_7 ( V_2 -> V_12 ) ;
V_2 -> V_12 = (struct V_37 * * )
F_13 ( V_2 -> V_38 . V_39 * sizeof( struct V_37 * ) , V_40 ) ;
if ( ! V_2 -> V_12 )
return - V_41 ;
return 0 ;
}
...
V_44 = V_42 ;
V_2 = V_43 ;
if ( ! V_44 -> V_47 || V_44 -> V_47 > V_2 -> V_38 . V_39 )
return - V_48 ;
V_46 = V_2 -> V_49 [ V_50 ] ;
...
static int F_18 ( struct V_37 * V_52 )
{
...
T_2 V_57 ;
int V_31 ;
V_44 = F_20 ( sizeof( struct V_37 ) , V_40 ) ;
if ( ! V_44 )
return - V_41 ;
