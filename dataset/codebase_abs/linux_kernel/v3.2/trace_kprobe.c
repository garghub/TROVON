...
static T_2
int F_133 ( struct V_151 * V_50 , enum V_186 type )
{
...
struct V_151 * V_61 = & V_39 -> V_61 ;
int V_54 ;
F_38 ( & V_61 -> V_62 -> V_191 ) ;
if ( F_25 ( V_39 ) ) {
V_61 -> V_50 . V_192 = & V_193 ;
V_61 -> V_62 -> V_194 = F_122 ;
} else {
V_61 -> V_50 . V_192 = & V_195 ;
V_61 -> V_62 -> V_194 = F_119 ;
}
if ( F_125 ( V_39 ) < 0 )
return - V_55 ;
...
if ( ! V_199 )
return 0 ;
V_145 = F_142 ( L_66 , 0644 , V_199 ,
NULL , & V_201 ) ;
if ( ! V_145 )
F_53 ( L_67
L_68 ) ;
V_145 = F_142 ( L_69 , 0444 , V_199 ,
NULL , & V_202 ) ;
if ( ! V_145 )
F_53 ( L_67
L_70 ) ;
...
static T_10 int F_143 ( int V_203 , int V_204 , int V_205 ,
int V_206 , int V_207 , int V_208 )
{
return V_203 + V_204 + V_205 + V_206 + V_207 + V_208 ;
}
