...
static int F_223 ( struct V_287 * V_288 , unsigned int V_43 ,
struct V_289 * V_290 , T_7 V_291 )
{
struct V_28 * V_29 ;
int V_96 ;
unsigned V_182 ;
...
return - 1 ;
F_234 ( V_55 -> V_311 , & V_290 ) ;
V_290 . V_55 &= ~ V_312 ;
V_290 . V_55 |= F_232 ( V_29 -> V_41 ) ;
V_290 . V_298 &= ~ V_313 ;
V_290 . V_298 |= F_231 ( V_182 ) ;
F_235 ( V_55 -> V_311 , & V_290 ) ;
return 0 ;
}
static int F_236 ( struct V_287 * V_314 , int V_43 , int V_315 )
{
struct V_160 * V_161 ;
int V_54 ;
V_161 = F_237 ( V_314 ) ;
...
static int F_239 ( struct V_287 * V_314 , struct V_311 * V_317 , int V_43 )
{
struct V_144 * V_145 = & V_318 ;
struct V_289 V_290 ;
int V_230 ;
V_230 = F_223 ( V_314 , V_43 , & V_290 , - 1 ) ;
if ( V_230 < 0 )
return V_230 ;
F_240 ( V_43 , V_317 ) ;
F_241 ( V_43 , & V_290 ) ;
...
F_242 ( V_94 , & V_314 -> V_314 , L_65 , V_43 ) ;
return 0 ;
}
int F_243 ( struct V_287 * V_314 , int V_315 , int type )
{
int V_26 , V_230 , V_295 , V_54 = 0 ;
unsigned int V_43 , V_285 ;
struct V_311 * V_317 ;
struct V_160 * V_161 = NULL ;
if ( type == V_319 && V_315 > 1 )
return 1 ;
V_26 = F_244 ( & V_314 -> V_314 ) ;
V_285 = V_283 ;
V_295 = 0 ;
...
F_246 ( V_43 , V_161 , V_54 , V_295 ) ;
}
V_320:
V_230 = F_239 ( V_314 , V_317 , V_43 ) ;
if ( V_230 < 0 )
goto error;
V_295 ++ ;
}
...
int V_230 ;
struct V_289 V_290 ;
V_230 = F_223 ( NULL , V_43 , & V_290 , - 1 ) ;
if ( V_230 < 0 )
return V_230 ;
F_250 ( V_43 , & V_290 ) ;
F_117 ( V_43 , & V_321 , V_153 ,
L_18 ) ;
return 0 ;
}
...
if ( F_163 ( V_55 , V_68 , & V_182 ) )
return - 1 ;
F_253 ( V_55 -> V_322 , & V_290 ) ;
V_290 . V_55 &= ~ V_312 ;
V_290 . V_55 |= F_232 ( V_29 -> V_41 ) ;
V_290 . V_298 &= ~ V_313 ;
V_290 . V_298 |= F_231 ( V_182 ) ;
F_254 ( V_55 -> V_322 , & V_290 ) ;
return 0 ;
}
int F_255 ( unsigned int V_43 , unsigned int V_323 )
{
struct V_144 * V_145 = & V_324 ;
struct V_289 V_290 ;
int V_230 ;
if ( V_178 ) {
struct V_160 * V_161 = F_256 ( V_323 ) ;
int V_54 ;
if ( ! V_161 )
return - 1 ;
V_54 = F_121 ( V_161 , V_43 , 1 ) ;
...
V_230 = F_223 ( NULL , V_43 , & V_290 , V_323 ) ;
if ( V_230 < 0 )
return V_230 ;
F_254 ( F_257 ( V_43 ) , & V_290 ) ;
F_114 ( V_43 , V_151 ) ;
if ( F_63 ( F_21 ( V_43 ) ) )
F_116 ( V_145 ) ;
F_117 ( V_43 , V_145 , V_153 , L_18 ) ;
...
struct V_325 V_290 ;
F_259 ( V_43 , & V_290 ) ;
V_290 . V_298 &= ~ ( V_326 | V_327 ) ;
V_290 . V_296 &= ~ ( V_328 ) ;
V_290 . V_298 |= F_260 ( V_41 ) | F_261 ( V_182 ) ;
V_290 . V_296 |= F_262 ( V_182 ) ;
F_263 ( V_43 , & V_290 ) ;
}
static int
...
int F_265 ( unsigned int V_43 , struct V_287 * V_314 )
{
struct V_28 * V_29 ;
int V_96 ;
if ( V_292 )
...
F_117 ( V_43 , & V_336 ,
V_153 , L_18 ) ;
F_242 ( V_94 , & V_314 -> V_314 , L_66 , V_43 ) ;
}
return V_96 ;
}
static int
...
unsigned long V_59 ;
F_40 ( & V_60 , V_59 ) ;
V_339 . V_205 = F_35 ( V_159 , 1 ) ;
F_42 ( & V_60 , V_59 ) ;
return V_339 . V_206 . V_340 + 1 ;
}
...
{
int V_341 ;
if ( V_342 > ( V_142 * V_343 ) )
V_342 = V_142 * V_343 ;
V_341 = V_283 + 8 * V_343 ;
#if F_84 ( V_344 ) || F_84 ( V_345 )
V_341 += V_283 * 16 ;
#endif
if ( V_341 < V_342 )
V_342 = V_341 ;
...
int F_272 ( struct V_346 * V_314 , int V_43 ,
struct V_118 * V_119 )
{
int V_26 ;
if ( ! F_90 ( V_43 ) ) {
...
V_26 = V_314 ? F_244 ( V_314 ) : F_16 ( 0 ) ;
return F_134 ( V_43 , V_26 , V_119 ) ;
}
static int T_1 F_273 ( int V_159 , int V_347 )
{
union V_199 V_200 ;
static T_6 V_348 = V_349 ;
T_6 V_209 ;
unsigned long V_59 ;
int V_14 = 0 ;
if ( F_274 ( V_348 ) )
V_50 -> V_203 ( & V_204 , & V_348 ) ;
F_40 ( & V_60 , V_59 ) ;
V_200 . V_205 = F_35 ( V_159 , 0 ) ;
F_42 ( & V_60 , V_59 ) ;
if ( V_347 >= F_144 () ) {
F_49 ( V_104 L_70
L_71 , V_159 , V_347 , V_200 . V_206 . V_207 ) ;
V_347 = V_200 . V_206 . V_207 ;
}
if ( V_50 -> V_208 ( & V_348 , V_347 ) ) {
for ( V_14 = 0 ; V_14 < F_144 () ; V_14 ++ ) {
if ( ! V_50 -> V_208 ( & V_348 , V_14 ) )
break;
}
if ( V_14 == F_144 () )
F_9 ( L_72 ) ;
F_49 ( V_104 L_73
L_74 , V_159 , V_347 , V_14 ) ;
V_347 = V_14 ;
}
V_50 -> V_210 ( V_347 , & V_209 ) ;
F_147 ( V_348 , V_348 , V_209 ) ;
if ( V_200 . V_206 . V_207 != V_347 ) {
V_200 . V_206 . V_207 = V_347 ;
F_40 ( & V_60 , V_59 ) ;
...
static T_7 T_1 F_275 ( T_7 V_323 )
{
if ( ( V_212 . V_213 == V_214 ) &&
! F_149 ( V_215 [ V_216 ] ) )
return F_273 ( V_34 , V_323 ) ;
else
return V_323 ;
}
static T_7 T_1 F_275 ( T_7 V_323 )
...
F_277 ( V_350 , 256 ) ;
for ( V_14 = 0 ; V_14 < V_34 ; V_14 ++ ) {
F_278 ( F_1 ( V_14 ) , V_350 ) ;
}
if ( ! F_74 ( V_323 , V_350 ) )
return V_323 ;
return F_279 ( V_350 , 256 ) ;
}
...
V_352 = F_72 ( V_159 , V_61 , V_143 ) ;
if ( V_352 == - 1 )
continue;
V_43 = F_87 ( V_352 , V_159 , V_61 ) ;
if ( ( V_159 > 0 ) && ( V_43 > 16 ) )
continue;
V_353 = F_283 ( V_43 ) ;
if ( ! F_284 ( V_353 ) || F_285 ( V_353 ) )
V_68 = V_353 -> V_228 ;
else
V_68 = V_50 -> V_183 () ;
if ( V_178 )
F_167 ( V_353 , V_68 , false ) ;
else
F_165 ( V_353 , V_68 , false ) ;
}
}
static struct V_354 * T_1 F_286 ( int V_34 )
{
unsigned long V_355 ;
struct V_354 * V_47 ;
char * V_356 ;
...
if ( V_34 <= 0 )
return NULL ;
V_355 = V_357 + sizeof( struct V_354 ) ;
V_355 *= V_34 ;
V_356 = F_287 ( V_355 ) ;
V_47 = ( void * ) V_356 ;
V_356 += sizeof( struct V_354 ) * V_34 ;
for ( V_14 = 0 ; V_14 < V_34 ; V_14 ++ ) {
V_47 [ V_14 ] . V_246 = V_356 ;
V_47 [ V_14 ] . V_59 = V_358 | V_359 ;
snprintf ( V_356 , V_357 , L_77 , V_14 ) ;
V_356 += V_357 ;
}
V_360 = V_47 ;
return V_47 ;
...
void T_1 F_288 ( void )
{
unsigned long V_361 , V_101 = V_362 ;
struct V_354 * V_363 ;
int V_14 ;
V_363 = F_286 ( V_34 ) ;
for ( V_14 = 0 ; V_14 < V_34 ; V_14 ++ ) {
...
V_365:
#endif
V_361 = ( unsigned long ) F_289 ( V_366 ) ;
V_361 = F_290 ( V_361 ) ;
}
F_291 ( V_101 , V_361 ) ;
F_8 ( V_15 , L_81 ,
F_292 ( V_101 ) + ( V_361 & ~ V_367 ) ,
V_361 ) ;
V_101 ++ ;
V_363 -> V_368 = V_361 ;
V_363 -> V_369 = V_361 + V_370 - 1 ;
V_363 ++ ;
}
F_269 () ;
}
...
return - 1 ;
V_112 = F_3 ( V_159 ) ;
if ( F_295 ( V_113 > V_112 -> V_373 ) )
return - 1 ;
return V_113 - V_112 -> V_114 ;
}
static T_1 int F_296 ( unsigned long V_374 )
{
if ( V_34 >= V_375 ) {
F_49 ( V_104 L_84
L_85 , V_375 , V_34 ) ;
...
void T_1 F_297 ( int V_323 , T_3 V_374 , T_3 V_114 )
{
int V_101 = 0 ;
int V_340 ;
struct V_6 * V_112 ;
...
return;
V_101 = V_34 ;
V_2 [ V_101 ] . V_3 . type = V_376 ;
V_2 [ V_101 ] . V_3 . V_59 = V_377 ;
V_2 [ V_101 ] . V_3 . V_5 = V_374 ;
F_291 ( V_362 + V_101 , V_374 ) ;
V_2 [ V_101 ] . V_3 . V_4 = F_275 ( V_323 ) ;
V_2 [ V_101 ] . V_3 . V_378 = F_280 ( V_101 ) ;
V_340 = F_268 ( V_101 ) ;
V_112 = F_3 ( V_101 ) ;
V_112 -> V_114 = V_114 ;
V_112 -> V_373 = V_114 + V_340 - 1 ;
V_2 [ V_101 ] . V_37 = V_340 ;
if ( V_112 -> V_373 >= V_116 )
V_116 = V_112 -> V_373 + 1 ;
F_49 ( V_93 L_88
L_89 , V_101 , F_1 ( V_101 ) ,
F_62 ( V_101 ) , F_2 ( V_101 ) ,
V_112 -> V_114 , V_112 -> V_373 ) ;
V_34 ++ ;
}
void T_1 F_298 ( void )
{
