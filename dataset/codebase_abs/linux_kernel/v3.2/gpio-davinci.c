...
static int F_33 ( struct V_44 * V_14 , unsigned V_52 )
{
struct V_1 T_1 * V_6 = F_2 ( V_14 -> V_5 ) ;
T_3 V_18 = ( T_3 ) F_23 ( V_14 ) ;
if ( V_52 & ~ ( V_48 | V_49 ) )
...
F_38 ( V_66 ) ;
for ( V_2 = 0 , V_65 = 0 ; V_2 < V_26 ; V_65 ++ , V_2 += 32 ) {
V_36 [ V_65 ] . V_9 . V_70 = F_31 ;
V_36 [ V_65 ] . V_60 = V_28 -> V_63
? - V_32
: ( V_28 -> V_71 + V_2 ) ;
}
if ( V_28 -> V_63 ) {
static struct V_72 V_73 ;
V_36 [ 0 ] . V_9 . V_70 = F_32 ;
V_67 = F_39 ( 0 ) ;
V_5 = V_68 ;
V_73 = * F_40 ( V_5 ) ;
V_73 . V_74 = L_6 ;
...
F_41 ( V_5 , & V_73 ) ;
F_42 ( V_5 , ( void * ) F_43 ( V_2 ) ) ;
F_44 ( V_5 , ( V_7 void * ) V_6 ) ;
F_45 ( V_5 , V_76 ) ;
}
goto V_77;
}
for ( V_2 = 0 , V_5 = F_46 ( 0 ) , V_65 = 0 ;
V_2 < V_26 ;
V_65 ++ , V_68 ++ ) {
unsigned V_24 ;
V_6 = F_1 ( V_2 ) ;
