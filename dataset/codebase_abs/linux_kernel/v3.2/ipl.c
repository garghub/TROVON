...
static T_4 F_112 ( struct V_42 * V_43 ,
struct V_44 * V_45 , char * V_46 )
{
return sprintf ( V_46 , L_3 , V_205 . V_198 -> V_180 ) ;
}
static T_4 F_113 ( struct V_42 * V_43 ,
struct V_44 * V_45 ,
const char * V_64 , T_5 V_51 )
{
...
static void T_3 F_119 ( char * V_115 , char * V_214 , int V_215 )
{
int V_216 , V_217 ;
V_217 = 0 ;
...
if ( ! V_87 )
return 1 ;
F_119 ( V_182 , V_218 , 127 ) ;
V_182 [ 127 ] = 0 ;
V_199 . V_198 = & V_219 ;
return 1 ;
}
static int T_3 F_121 ( char * V_218 )
{
if ( ! V_87 )
return 1 ;
F_119 ( V_184 , V_218 , 127 ) ;
V_184 [ 127 ] = 0 ;
V_202 . V_198 = & V_219 ;
return 1 ;
}
static int T_3 F_122 ( char * V_218 )
{
if ( ! V_87 )
return 1 ;
F_119 ( V_186 , V_218 , 127 ) ;
V_186 [ 127 ] = 0 ;
V_204 . V_198 = & V_219 ;
return 1 ;
}
static int T_3 F_123 ( char * V_218 )
{
if ( ! V_87 )
return 1 ;
F_119 ( V_188 , V_218 , 127 ) ;
V_188 [ 127 ] = 0 ;
V_205 . V_198 = & V_219 ;
return 1 ;
}
...
void F_130 ( struct V_238 * V_239 )
{
F_131 ( & V_240 ) ;
F_132 ( & V_239 -> V_241 , & V_242 ) ;
F_133 ( & V_240 ) ;
}
void F_134 ( struct V_238 * V_239 )
{
F_131 ( & V_240 ) ;
F_135 ( & V_239 -> V_241 ) ;
F_133 ( & V_240 ) ;
...
#endif
F_138 (reset, &rcall, list)
V_239 -> V_201 () ;
}
void F_139 ( void (* F_140)( void * ) , void * V_88 )
{
struct V_243 * V_244 ;
V_244 = (struct V_243 * ) ( unsigned long ) F_141 () ;
