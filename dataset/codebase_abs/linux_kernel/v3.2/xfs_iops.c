...
ASSERT ( ( V_114 & ( V_148 | V_128 | V_129 | V_150 | V_163 |
V_164 | V_165 | V_166 |
V_167 | V_168 ) ) == 0 ) ;
V_161 = V_137 ;
if ( ! ( V_113 & V_169 ) )
...
if ( error )
goto V_174;
if ( V_112 -> V_171 > V_1 -> V_172 ) {
error = F_103 ( V_1 , V_112 -> V_171 , V_1 -> V_172 ) ;
if ( error )
goto V_174;
}
F_96 ( V_1 , V_137 ) ;
V_161 &= ~ V_137 ;
if ( V_1 -> V_172 != V_1 -> V_3 . V_175 && V_112 -> V_171 > V_1 -> V_3 . V_175 ) {
error = F_104 ( V_1 , V_1 -> V_3 . V_175 , V_112 -> V_171 , 0 ,
V_176 ) ;
if ( error )
goto V_174;
}
F_105 ( V_2 ) ;
error = - F_106 ( V_2 -> V_177 , V_112 -> V_171 ,
V_178 ) ;
if ( error )
goto V_174;
V_116 = F_81 ( V_82 , V_179 ) ;
error = F_82 ( V_116 , 0 , F_107 ( V_82 ) , 0 ,
V_180 ,
V_181 ) ;
if ( error )
goto V_140;
F_108 ( V_2 , V_112 -> V_171 ) ;
V_162 = V_182 ;
V_161 |= V_137 ;
F_84 ( V_1 , V_137 ) ;
F_88 ( V_116 , V_1 , 0 ) ;
...
if ( V_112 -> V_171 > V_1 -> V_172 ) {
V_1 -> V_3 . V_175 = V_112 -> V_171 ;
V_1 -> V_172 = V_112 -> V_171 ;
} else if ( V_112 -> V_171 <= V_1 -> V_172 ||
( V_112 -> V_171 == 0 && V_1 -> V_3 . V_173 ) ) {
error = F_110 ( & V_116 , V_1 , V_112 -> V_171 ) ;
if ( error )
goto V_183;
F_111 ( V_1 , V_184 ) ;
}
...
{
int error ;
struct V_190 * V_191 = * V_186 ;
T_10 V_192 = 0 ;
T_11 V_193 , V_194 , V_195 ;
if ( V_188 -> V_196 == - 1LL )
return 0 ;
V_193 = F_114 ( V_188 -> V_197 ) ;
V_194 = F_114 ( V_188 -> V_196 ) ;
V_195 = F_114 ( V_188 -> V_198 ) ;
if ( V_188 -> V_199 & V_200 )
V_192 |= V_201 ;
else if ( V_188 -> V_199 & V_202 ) {
V_192 |= V_203 ;
V_194 = 0 ;
}
if ( V_188 -> V_199 & V_204 )
V_192 |= V_205 ;
error = F_115 ( V_191 , V_193 , V_194 ,
V_195 , V_192 ) ;
if ( error > 0 ) {
error = 0 ;
* V_189 = 1 ;
...
struct V_187 V_207 ;
int error ;
error = F_117 ( V_191 , V_208 ) ;
if ( error )
return error ;
V_207 . V_197 = F_118 ( V_206 ) ;
if ( V_195 == V_209 )
V_207 . V_198 = - 1LL ;
else
V_207 . V_198 = F_118 ( V_195 ) ;
V_207 . V_210 = ! V_191 -> V_211 ? V_212 :
V_191 -> V_211 + 1 ;
V_207 . V_210 = F_119 ( V_213 , V_207 . V_210 ,
( V_214 * 16 / sizeof( struct V_187 ) ) ) ;
V_207 . V_215 = V_216 | V_217 ;
if ( V_191 -> V_218 & V_219 )
V_207 . V_215 |= V_220 ;
if ( ! ( V_191 -> V_218 & V_221 ) )
V_207 . V_215 |= V_222 ;
error = F_120 ( V_1 , & V_207 , F_113 , V_191 ) ;
if ( error )
return - error ;
return 0 ;
}
...
struct V_22 * V_1 )
{
if ( V_1 -> V_3 . V_223 & V_224 )
V_2 -> V_225 |= V_226 ;
else
V_2 -> V_225 &= ~ V_226 ;
if ( V_1 -> V_3 . V_223 & V_227 )
V_2 -> V_225 |= V_228 ;
else
V_2 -> V_225 &= ~ V_228 ;
if ( V_1 -> V_3 . V_223 & V_229 )
V_2 -> V_225 |= V_230 ;
else
V_2 -> V_225 &= ~ V_230 ;
if ( V_1 -> V_3 . V_223 & V_231 )
V_2 -> V_225 |= V_232 ;
else
V_2 -> V_225 &= ~ V_232 ;
}
...
V_2 -> V_237 = V_1 -> V_3 . V_238 ;
F_126 ( V_2 , V_1 -> V_3 . V_175 ) ;
...
case V_58 :
V_2 -> V_240 = & V_249 ;
if ( ! ( V_1 -> V_108 . V_250 & V_251 ) )
V_2 -> V_177 -> V_244 = & V_245 ;
break;
default:
V_2 -> V_240 = & V_241 ;
F_127 ( V_2 , V_2 -> V_102 , V_2 -> V_236 ) ;
break;
}
if ( ! F_128 ( V_1 ) ) {
F_129 ( V_2 ) ;
