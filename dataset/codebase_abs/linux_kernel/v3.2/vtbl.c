...
V_54 -> V_36 = F_5 ( 0 ) ;
V_54 -> V_65 = F_5 ( V_51 ) ;
V_54 -> V_66 = F_26 ( ++ V_50 -> V_67 ) ;
V_7 = F_27 ( V_2 , V_56 -> V_68 , V_54 ) ;
if ( V_7 )
goto V_69;
V_7 = F_28 ( V_2 , V_17 , V_56 -> V_68 , 0 , V_2 -> V_19 ) ;
if ( V_7 )
goto V_69;
V_7 = F_29 ( V_2 , V_50 , V_56 -> V_68 , V_56 -> V_70 ,
V_54 , 0 ) ;
F_30 ( V_56 ) ;
F_31 ( V_2 , V_54 ) ;
return V_7 ;
...
V_80 [ V_79 -> V_65 ] = F_36 ( V_2 -> V_19 ) ;
if ( ! V_80 [ V_79 -> V_65 ] ) {
V_7 = - V_58 ;
goto V_60;
}
V_7 = F_37 ( V_2 , V_80 [ V_79 -> V_65 ] , V_79 -> V_68 , 0 ,
V_2 -> V_19 ) ;
if ( V_7 == V_82 || F_38 ( V_7 ) )
V_79 -> V_83 = 1 ;
else if ( V_7 )
goto V_60;
}
...
F_39 ( L_15 ,
V_76 -> V_27 , V_76 -> V_64 - V_76 -> V_93 ) ;
V_25 -> V_94 = 1 ;
continue;
}
V_25 -> V_64 = V_76 -> V_64 ;
V_25 -> V_92 =
( long long ) ( V_25 -> V_64 - 1 ) * V_25 -> V_86 ;
V_25 -> V_92 += V_76 -> V_95 ;
V_25 -> V_91 = V_76 -> V_95 ;
}
V_25 = F_44 ( sizeof( struct V_9 ) , V_57 ) ;
...
V_25 -> V_35 = 1 ;
V_25 -> V_37 = V_84 ;
V_25 -> V_28 = sizeof( V_96 ) - 1 ;
memcpy ( V_25 -> V_30 , V_96 , V_25 -> V_28 + 1 ) ;
V_25 -> V_86 = V_2 -> V_41 ;
V_25 -> V_64 = V_25 -> V_34 ;
V_25 -> V_91 = V_25 -> V_34 ;
V_25 -> V_92 =
( long long ) V_25 -> V_64 * ( V_2 -> V_41 - V_25 -> V_36 ) ;
V_25 -> V_27 = V_13 ;
V_25 -> V_97 = 1 ;
F_2 ( ! V_2 -> V_12 [ V_6 ] ) ;
...
{
int V_7 ;
if ( V_76 -> V_101 >= V_25 -> V_34 ) {
V_7 = 1 ;
goto V_40;
}
if ( V_76 -> V_93 > V_25 -> V_34 ) {
V_7 = 2 ;
goto V_40;
}
if ( V_76 -> V_37 != V_25 -> V_37 ) {
V_7 = 3 ;
goto V_40;
}
if ( V_76 -> V_64 > V_25 -> V_34 ) {
V_7 = 4 ;
goto V_40;
}
if ( V_76 -> V_36 != V_25 -> V_36 ) {
V_7 = 5 ;
goto V_40;
}
return 0 ;
...
struct V_75 * V_76 ;
struct V_9 * V_25 ;
if ( V_50 -> V_102 > V_103 + V_2 -> V_11 ) {
F_16 ( L_19 ,
V_50 -> V_102 , V_103 , V_2 -> V_11 ) ;
return - V_48 ;
}
if ( V_50 -> V_104 >= V_2 -> V_11 + V_103 &&
V_50 -> V_104 < V_105 ) {
F_16 ( L_20 ,
V_50 -> V_104 ) ;
return - V_48 ;
}
for ( V_6 = 0 ; V_6 < V_2 -> V_11 + V_103 ; V_6 ++ ) {
F_13 () ;
V_76 = F_45 ( V_50 , V_6 ) ;
V_25 = V_2 -> V_12 [ V_6 ] ;
if ( ! V_25 ) {
...
V_2 -> V_17 = F_33 ( V_2 , V_50 , V_76 ) ;
if ( F_24 ( V_2 -> V_17 ) )
return F_25 ( V_2 -> V_17 ) ;
}
V_2 -> V_98 = V_2 -> V_45 - V_2 -> V_99 ;
