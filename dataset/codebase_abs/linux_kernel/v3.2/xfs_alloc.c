...
V_110 = F_125 ( sizeof( struct V_242 ) , V_247 ) ;
if ( ! V_110 ) {
F_126 ( V_66 -> V_153 , V_67 , V_3 , V_4 ) ;
F_127 ( V_66 ) ;
return;
}
V_110 -> V_67 = V_67 ;
...
F_128 ( & V_110 -> V_249 ) ;
V_110 -> V_51 = V_51 ;
F_129 ( V_66 -> V_153 , V_67 , V_3 , V_4 ) ;
V_75 = F_84 ( V_66 -> V_153 , V_110 -> V_67 ) ;
F_130 ( & V_75 -> V_219 ) ;
V_245 = & V_75 -> V_221 . V_244 ;
while ( * V_245 ) {
V_246 = * V_245 ;
V_243 = F_131 ( V_246 , struct V_242 , V_244 ) ;
if ( V_110 -> V_3 < V_243 -> V_3 ) {
V_245 = & ( * V_245 ) -> V_250 ;
ASSERT ( V_110 -> V_3 + V_110 -> V_248 <= V_243 -> V_3 ) ;
} else if ( V_110 -> V_3 > V_243 -> V_3 ) {
V_245 = & ( * V_245 ) -> V_251 ;
ASSERT ( V_3 >= V_243 -> V_3 + V_243 -> V_248 ) ;
} else {
ASSERT ( 0 ) ;
}
}
F_132 ( & V_110 -> V_244 , V_246 , V_245 ) ;
F_133 ( & V_110 -> V_244 , & V_75 -> V_221 ) ;
F_134 ( & V_110 -> V_249 , & V_66 -> V_252 ) ;
F_135 ( & V_75 -> V_219 ) ;
F_85 ( V_75 ) ;
}
int
...
V_245 = V_75 -> V_221 . V_244 ;
while ( V_245 ) {
V_243 = F_131 ( V_245 , struct V_242 , V_244 ) ;
if ( V_3 < V_243 -> V_3 ) {
if ( V_3 + V_4 > V_243 -> V_3 )
V_253 = - 1 ;
V_245 = V_245 -> V_250 ;
} else if ( V_3 > V_243 -> V_3 ) {
if ( V_3 < V_243 -> V_3 + V_243 -> V_248 )
V_253 = - 1 ;
V_245 = V_245 -> V_251 ;
} else {
V_253 = ( V_243 -> V_248 == V_4 ) ? 1 : - 1 ;
break;
}
}
F_135 ( & V_75 -> V_219 ) ;
...
if ( V_148 )
goto V_258;
if ( V_255 < V_48 && V_256 > V_254 ) {
goto V_258;
} else if ( V_255 >= V_48 && V_256 <= V_254 ) {
F_138 ( & V_243 -> V_244 , & V_75 -> V_221 ) ;
V_243 -> V_248 = 0 ;
return false ;
} else if ( V_254 < V_256 ) {
V_243 -> V_3 = V_254 ;
} else if ( V_255 < V_48 ) {
V_243 -> V_248 = V_48 - V_243 -> V_3 ;
} else {
ASSERT ( 0 ) ;
}
F_139 ( V_65 , V_75 -> V_259 , V_48 , V_49 ) ;
return true ;
V_258:
F_135 ( & V_75 -> V_219 ) ;
F_65 ( V_65 , V_138 ) ;
F_140 ( V_65 , V_75 -> V_259 , V_48 , V_49 ) ;
F_130 ( & V_75 -> V_219 ) ;
return false ;
}
void
...
while ( V_245 ) {
struct V_242 * V_243 =
F_131 ( V_245 , struct V_242 , V_244 ) ;
T_1 V_255 = V_243 -> V_3 ;
T_1 V_256 = V_255 + V_243 -> V_248 ;
if ( V_48 + V_49 <= V_255 ) {
V_245 = V_245 -> V_250 ;
...
if ( ! F_136 ( V_65 , V_75 , V_243 , V_48 , V_49 ,
V_148 ) )
goto V_132;
}
F_135 ( & V_75 -> V_219 ) ;
...
struct V_244 * V_245 ;
ASSERT ( V_4 > 0 ) ;
F_130 ( & args -> V_75 -> V_219 ) ;
V_132:
V_48 = V_3 ;
V_49 = V_4 ;
V_245 = args -> V_75 -> V_221 . V_244 ;
while ( V_245 && V_49 >= args -> V_21 ) {
struct V_242 * V_243 =
F_131 ( V_245 , struct V_242 , V_244 ) ;
T_1 V_254 = V_48 + V_49 ;
T_1 V_255 = V_243 -> V_3 ;
...
if ( V_255 - V_48 >= args -> V_40 ) {
V_254 = V_255 ;
} else if ( V_254 - V_256 >= args -> V_40 * 4 ) {
V_48 = V_256 ;
} else if ( V_255 - V_48 >= args -> V_21 ) {
V_254 = V_255 ;
} else {
goto V_260;
}
...
{
if ( V_243 -> V_248 ) {
F_143 ( V_65 , V_243 -> V_67 , V_243 -> V_3 ,
V_243 -> V_248 ) ;
F_138 ( & V_243 -> V_244 , & V_75 -> V_221 ) ;
}
F_144 ( & V_243 -> V_249 ) ;
...
V_75 = F_84 ( V_65 , V_243 -> V_67 ) ;
F_130 ( & V_75 -> V_219 ) ;
V_67 = V_243 -> V_67 ;
}
if ( V_262 && V_243 -> V_248 &&
! ( V_243 -> V_51 & V_264 ) )
V_243 -> V_51 = V_257 ;
else
F_142 ( V_65 , V_75 , V_243 ) ;
}
if ( V_75 ) {
F_135 ( & V_75 -> V_219 ) ;
F_85 ( V_75 ) ;
...
struct V_261 * V_266 )
{
return F_149 ( V_7 , struct V_242 , V_249 ) -> V_67 -
F_149 ( V_266 , struct V_242 , V_249 ) -> V_67 ;
}
