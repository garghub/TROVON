...
F_13 ( V_2 ) ;
return - V_189 ;
} else if ( V_17 -> V_187 == V_190 ) {
struct V_191 * V_192 ;
for ( V_192 = V_17 -> V_193 ; V_192 ; V_192 = V_192 -> V_194 ) {
if ( V_192 -> V_195 != 0x91 )
continue;
if ( V_192 -> V_196 < 10 )
continue;
...
F_100 ( L_15 ,
F_99 ( V_17 ) , V_192 -> V_197 [ 2 ] , V_192 -> V_197 [ 3 ] ) ;
V_2 -> V_26 = ( V_192 -> V_197 [ 4 ] << 0 ) |
( V_192 -> V_197 [ 5 ] << 8 ) |
( V_192 -> V_197 [ 6 ] << 16 ) ;
F_100 ( L_16 ,
F_99 ( V_17 ) , V_2 -> V_26 ) ;
V_2 -> V_76 = V_192 -> V_197 [ 7 ] * 115200 ;
if ( V_2 -> V_76 == 0 )
V_2 -> V_76 = 115200 ;
F_100 ( L_17 ,
F_99 ( V_17 ) , V_2 -> V_76 ,
V_192 -> V_197 [ 7 ] , V_192 -> V_197 [ 8 ] | ( V_192 -> V_197 [ 9 ] << 8 ) ) ;
} else {
F_13 ( V_2 ) ;
return - V_198 ;
}
...
V_204 -> type = V_211 ;
V_204 -> V_212 = V_213 ;
V_204 -> V_155 = V_214 | V_215 ;
V_204 -> V_216 = V_217 ;
V_204 -> V_216 . V_60 = V_218 | V_68 | V_96 | V_219 | V_100 ;
V_204 -> V_216 . V_220 = 4800 ;
V_204 -> V_216 . V_221 = 4800 ;
F_110 ( V_204 , & V_222 ) ;
V_4 = F_111 ( V_204 ) ;
if ( V_4 )
goto V_156;
