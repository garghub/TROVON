...
if ( V_16 -> V_146 + V_1 -> V_34 . V_147 ==
V_1 -> V_34 . V_60 ) {
if ( ! ( V_1 -> V_74 -> V_122 . V_148 & V_149 ) )
V_1 -> V_74 -> V_122 . V_148 |= V_149 ;
* ( V_150 * ) & V_1 -> V_74 -> V_122 . V_151 = 0 ;
F_64 ( V_16 , V_1 -> V_74 , V_129 ) ;
}
return 0 ;
}
...
T_18 * V_110 ;
V_110 = & V_1 -> V_34 ;
if ( V_110 -> V_154 == V_155 )
return 0 ;
error = F_77 ( V_1 , NULL , V_110 -> V_154 , 0 , 0 , & V_1 -> V_74 ) ;
if ( error )
return error ;
ASSERT ( V_1 -> V_74 != NULL ) ;
ASSERT ( V_110 -> V_156 != V_155 ) ;
error = F_77 ( V_1 , NULL , V_110 -> V_156 , 0 , 0 , & V_1 -> V_73 ) ;
if ( error ) {
F_78 ( V_1 -> V_74 ) ;
return error ;
}
...
V_150 * V_162 ;
ASSERT ( F_69 ( V_1 -> V_74 , V_22 ) ) ;
V_162 = ( V_150 * ) & V_1 -> V_74 -> V_122 . V_151 ;
if ( ! ( V_1 -> V_74 -> V_122 . V_148 & V_149 ) ) {
V_1 -> V_74 -> V_122 . V_148 |= V_149 ;
* V_162 = 0 ;
}
V_161 = * V_162 ;
if ( ( V_159 = F_81 ( V_161 ) ) == - 1 )
V_79 = 0 ;
else {
V_160 = V_161 - ( 1ULL << V_159 ) ;
V_79 = ( V_1 -> V_34 . V_60 * ( ( V_160 << 1 ) + 1ULL ) ) >>
( V_159 + 1 ) ;
