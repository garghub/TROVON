...
static int T_7 F_17 ( struct V_75 * V_76 )
{
struct V_48 * V_49 ;
struct V_77 * V_78 ;
int V_60 ;
V_49 = F_18 ( sizeof( * V_49 ) , V_79 ) ;
if ( ! V_49 )
return - V_80 ;
F_19 ( V_76 , V_49 ) ;
V_78 = F_20 ( V_76 , V_81 , 0 ) ;
if ( ! V_78 ) {
F_21 ( & V_76 -> V_82 , L_25 ) ;
V_60 = - V_83 ;
goto V_84;
}
V_49 -> V_65 = F_22 ( V_78 -> V_85 , F_23 ( V_78 ) ) ;
if ( ! V_49 -> V_65 ) {
F_21 ( & V_76 -> V_82 , L_26 ) ;
V_60 = - V_80 ;
goto V_84;
}
V_49 -> V_86 = F_24 ( V_76 , 0 ) ;
V_60 = F_25 ( V_49 -> V_86 , F_14 ,
V_87 | V_88 ,
L_27 , V_49 ) ;
if ( V_60 ) {
F_21 ( & V_76 -> V_82 , L_28 ) ;
...
V_49 -> V_62 = F_24 ( V_76 , 1 ) ;
V_60 = F_25 ( V_49 -> V_62 , F_14 ,
V_87 | V_88 ,
L_29 , V_49 ) ;
if ( V_60 ) {
F_21 ( & V_76 -> V_82 , L_30 ) ;
...
static int T_8 F_29 ( struct V_75 * V_76 )
{
struct V_48 * V_49 = F_30 ( V_76 ) ;
F_26 ( V_49 -> V_62 , V_49 ) ;
F_26 ( V_49 -> V_86 , V_49 ) ;
F_27 ( V_49 -> V_65 ) ;
F_28 ( V_49 ) ;
