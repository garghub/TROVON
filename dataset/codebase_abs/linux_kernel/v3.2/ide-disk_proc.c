...
{
return F_8 ( V_34 , F_5 , F_9 ( V_33 ) -> V_35 ) ;
}
...
{
return F_8 ( V_34 , F_10 , F_9 ( V_33 ) -> V_35 ) ;
}
...
T_3 * V_39 = ( T_3 * ) V_20 ;
int V_40 ;
for ( V_40 = 0 ; V_40 < V_36 / 2 ; V_40 ++ ) {
F_6 ( V_26 , L_4 , F_15 ( V_39 [ V_40 ] ) ,
( V_40 % 8 ) == 7 ? '\n' : ' ' ) ;
}
}
F_16 ( V_20 ) ;
...
{
return F_8 ( V_34 , F_17 , F_9 ( V_33 ) -> V_35 ) ;
}
static int F_19 ( struct V_25 * V_26 , void * V_27 )
{
return F_13 ( V_26 , V_26 -> V_28 , V_42 ) ;
}
static int F_20 ( struct V_33 * V_33 , struct V_34 * V_34 )
{
return F_8 ( V_34 , F_19 , F_9 ( V_33 ) -> V_35 ) ;
}
