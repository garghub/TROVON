...
V_126 = F_42 ( V_125 -> V_134 , F_43 ( V_125 ) ,
V_120 -> V_135 ) ;
if ( ! V_126 ) {
F_14 ( & V_120 -> V_2 , L_12 ) ;
return - V_136 ;
}
V_2 = F_44 ( sizeof( struct V_1 ) , V_137 ) ;
if ( ! V_2 ) {
V_34 = - V_138 ;
goto V_139;
}
...
F_47 ( V_2 -> V_93 ) ;
V_2 -> V_5 = F_48 ( V_125 -> V_134 , F_43 ( V_125 ) ) ;
if ( ! V_2 -> V_5 ) {
F_14 ( & V_120 -> V_2 , L_13 ) ;
V_34 = - V_138 ;
goto V_144;
...
V_2 -> V_80 [ V_20 ] . V_145 =
( V_146 ) ( V_125 -> V_134 + V_147 ) ;
V_2 -> V_80 [ V_90 ] . V_145 =
( V_146 ) ( V_125 -> V_134 + V_148 ) ;
V_127 = F_41 ( V_120 , V_149 , 0 ) ;
if ( ! V_127 ) {
F_14 ( & V_120 -> V_2 , L_14 ) ;
V_34 = - V_150 ;
goto V_151;
}
V_2 -> V_80 [ V_20 ] . V_152 = V_127 -> V_134 ;
V_127 = F_41 ( V_120 , V_149 , 1 ) ;
if ( ! V_127 ) {
F_14 ( & V_120 -> V_2 , L_14 ) ;
V_34 = - V_150 ;
goto V_151;
}
V_2 -> V_80 [ V_90 ] . V_152 = V_127 -> V_134 ;
V_2 -> V_2 = & V_120 -> V_2 ;
F_49 ( & V_120 -> V_2 , V_2 ) ;
V_34 = F_50 ( & V_120 -> V_2 , & V_153 ) ;
if ( V_34 != 0 )
goto V_151;
return 0 ;
V_151:
...
F_54 ( V_2 ) ;
V_139:
F_55 ( V_125 -> V_134 , F_43 ( V_125 ) ) ;
return V_34 ;
}
static int F_56 ( struct V_119 * V_120 )
{
struct V_1 * V_2 = F_57 ( & V_120 -> V_2 ) ;
struct V_124 * V_125 ;
F_58 ( & V_120 -> V_2 ) ;
F_52 ( V_2 -> V_93 ) ;
F_53 ( V_2 -> V_93 ) ;
