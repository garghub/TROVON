...
static void F_132 ( struct V_230 * V_125 , unsigned short V_241 )
{
struct V_27 * V_28 = V_125 -> V_259 ;
F_133 ( V_241 , V_28 -> V_260 ) ;
return;
}
static void F_134 ( struct V_230 * V_125 , unsigned short V_241 )
{
struct V_27 * V_28 = V_125 -> V_259 ;
unsigned long V_58 ;
...
static V_453 F_243 ( struct V_230 * V_125 , V_453 V_199 )
{
struct V_27 * V_28 = V_125 -> V_259 ;
if ( ! F_53 ( V_28 , V_171 ) )
V_199 &= ~ V_524 ;
...
static int F_244 ( struct V_230 * V_125 , V_453 V_199 )
{
struct V_27 * V_28 = V_125 -> V_259 ;
...
static int V_573 ( void * V_591 )
{
struct V_27 * V_28 ;
int V_4 = 0 ;
V_28 = (struct V_27 * ) V_591 ;
F_17 ( V_28 , 2 , L_196 ) ;
F_20 ( V_28 , 2 , & V_28 , sizeof( void * ) ) ;
if ( ! F_284 ( V_28 , V_261 ) )
return 0 ;
...
static void F_287 ( struct V_563 * V_124 )
{
struct V_27 * V_28 = F_256 ( & V_124 -> V_125 ) ;
...
static int F_288 ( struct V_563 * V_124 )
{
struct V_27 * V_28 = F_256 ( & V_124 -> V_125 ) ;
if ( V_28 -> V_125 )
F_289 ( V_28 -> V_125 ) ;
...
static int F_290 ( struct V_563 * V_124 )
{
struct V_27 * V_28 = F_256 ( & V_124 -> V_125 ) ;
int V_4 = 0 ;
if ( V_124 -> V_71 == V_592 )
...
static int F_292 ( struct V_593 * V_594 ,
unsigned long V_595 , void * V_591 )
{
struct V_251 * V_252 = (struct V_251 * ) V_591 ;
struct V_230 * V_125 = (struct V_230 * ) V_252 -> V_596 -> V_125 ;
struct V_29 * V_2 ;
struct V_27 * V_28 ;
if ( F_293 ( V_125 ) != & V_597 )
return V_598 ;
V_28 = F_167 ( V_125 ) ;
F_17 ( V_28 , 3 , L_202 ) ;
if ( ! V_28 )
...
static int F_294 ( struct V_593 * V_594 ,
unsigned long V_595 , void * V_591 )
{
struct V_257 * V_252 = (struct V_257 * ) V_591 ;
struct V_230 * V_125 = (struct V_230 * ) V_252 -> V_601 -> V_125 ;
struct V_29 * V_2 ;
struct V_27 * V_28 ;
V_28 = F_167 ( V_125 ) ;
if ( ! V_28 )
