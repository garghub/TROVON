...
V_56 = V_51 . V_57 ;
while ( V_56 != & V_51 ) {
struct V_5 * V_6 = F_32 ( V_56 , struct V_5 , V_39 ) ;
if ( ! ( V_6 -> V_9 & V_10 ) &&
...
F_25 ( V_53 L_11 ,
V_23 -> V_58 , V_6 -> V_8 , V_6 -> V_20 , V_23 -> V_20 ) ;
return - V_33 ;
}
...
static struct V_5 * F_13 ( char * V_8 , int V_61 )
{
struct V_5 * V_6 ;
F_2 ( & V_7 ) ;
F_3 (ops, &opslist, list) {
