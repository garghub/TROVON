...
{
struct V_28 * V_29 ;
if ( ( V_29 = F_34 ( V_93 , L_6 , NULL ) ) == NULL )
return - V_9 ;
V_29 -> V_59 = V_94 | V_95 | V_96 ;
if ( F_35 ( V_29 ) < 0 ) {
F_36 ( V_29 ) ;
return - V_9 ;
}
...
{
struct V_28 * V_29 ;
if ( ( V_29 = F_34 ( V_93 , L_11 , NULL ) ) == NULL )
return - V_9 ;
V_29 -> V_59 = V_94 | V_95 | V_96 ;
if ( F_35 ( V_29 ) < 0 ) {
F_36 ( V_29 ) ;
...
return 0 ;
V_58 = F_49 ( V_102 -> V_105 , V_92 , V_102 -> V_104 -> V_22 ) ;
if ( V_58 == NULL )
return - V_9 ;
V_102 -> V_106 = V_58 ;
return 0 ;
...
return;
F_63 ( & V_29 -> V_111 ) ;
V_114 = V_29 -> V_20 == NULL ? V_92 : V_29 -> V_20 -> V_58 ;
F_14 ( ! V_114 ) ;
F_8 ( V_114 , V_29 -> V_58 ) ;
V_29 -> V_58 = NULL ;
}
...
V_114 = V_29 -> V_20 == NULL ? V_92 : V_29 -> V_20 -> V_58 ;
F_11 ( & V_60 ) ;
V_58 = F_68 ( V_29 -> V_22 , V_29 -> V_59 , V_114 ) ;
if ( ! V_58 ) {
F_12 ( & V_60 ) ;
return - V_9 ;
}
...
V_29 -> V_58 = V_58 ;
if ( V_29 -> V_20 )
F_70 ( & V_29 -> V_111 , & V_29 -> V_20 -> V_110 ) ;
F_12 ( & V_60 ) ;
return 0 ;
}
static void F_71 ( struct V_28 * V_29 , struct V_4 * V_5 )
{
F_5 (buffer,
L_16
...
{
struct V_28 * V_29 ;
V_29 = F_34 ( V_93 , L_1 , NULL ) ;
if ( V_29 == NULL )
return - V_9 ;
V_29 -> V_36 . V_72 . V_53 = F_71 ;
if ( F_35 ( V_29 ) < 0 ) {
F_36 ( V_29 ) ;
return - V_9 ;
}
