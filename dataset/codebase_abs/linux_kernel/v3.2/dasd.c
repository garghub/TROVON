...
if ( F_30 ( V_2 ) )
return F_102 ( V_2 ) ;
F_122 ( V_337 , & V_2 -> V_189 ) ;
if ( V_2 -> V_42 -> V_338 )
V_40 = V_2 -> V_42 -> V_338 ( V_2 ) ;
F_177 ( V_2 , V_339 ) ;
F_12 ( & V_336 ) ;
F_172 ( F_144 ( V_56 ) ) ;
V_40 = 0 ;
...
V_191 = V_96 -> V_187 ;
V_191 -> V_343 = V_344 ;
if ( F_267 ( V_340 , V_341 ) ) {
V_342 = ( unsigned long * ) ( V_96 -> V_19 ) ;
V_191 -> V_345 = ( V_346 ) ( V_347 ) V_342 ;
V_191 -> V_189 = V_348 ;
V_342 = F_268 ( V_342 , V_340 , V_341 ) ;
} else {
V_191 -> V_345 = ( V_346 ) ( V_347 ) V_340 ;
V_191 -> V_189 = 0 ;
}
V_191 -> V_349 = V_341 ;
V_96 -> V_106 = V_2 ;
...
void * V_340 , int V_341 )
{
int V_316 ;
struct V_95 * V_96 ;
V_96 = F_266 ( V_2 , V_340 , V_341 ,
V_183 ) ;
if ( F_30 ( V_96 ) )
return F_102 ( V_96 ) ;
V_316 = F_193 ( V_96 ) ;
F_130 ( V_96 , V_96 -> V_350 ) ;
return V_316 ;
}
char * F_270 ( struct V_226 * V_226 )
{
struct V_351 * V_351 = NULL ;
char * V_352 = NULL ;
if ( F_271 ( & V_226 -> V_230 ) && ( V_226 -> V_230 . V_353 . V_354 == 0x01 ) ) {
if ( V_226 -> V_230 . V_353 . V_355 )
V_351 = F_272 ( (struct V_355 * ) ( unsigned long )
V_226 -> V_230 . V_353 . V_355 ) ;
if ( V_351 && V_351 -> V_356 == 64 && V_351 -> V_189 )
switch ( V_351 -> V_189 & 0x07 ) {
case 1 :
V_352 = V_351 -> V_357 . V_358 . V_352 ;
break;
case 2 :
V_352 = V_351 -> V_357 . V_359 . V_352 ;
break;
default:
break;
}
} else if ( V_226 -> V_360 . V_361 . V_362 . V_363 ) {
V_352 = V_226 -> V_364 ;
}
return V_352 ;
}
