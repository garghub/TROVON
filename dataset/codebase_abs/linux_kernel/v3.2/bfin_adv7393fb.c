...
static int F_64 ( struct V_126 * V_86 , int V_127 )
{
...
static int F_66 ( struct V_126 * V_86 , int V_127 )
{
struct V_1 * V_2 = F_65 ( V_86 ) ;
F_31 ( V_2 -> V_39 , V_48 ) ;
F_13 () ;
...
static int
F_67 ( struct V_129 * V_104 , struct V_126 * V_86 )
{
switch ( V_104 -> V_101 ) {
case 16 :
V_104 -> V_94 . V_130 = V_86 -> V_104 . V_94 . V_130 ;
V_104 -> V_96 . V_130 = V_86 -> V_104 . V_96 . V_130 ;
V_104 -> V_97 . V_130 = V_86 -> V_104 . V_97 . V_130 ;
...
static int
F_68 ( struct V_129 * V_104 , struct V_126 * V_86 )
{
int V_133 ;
V_84 V_134 ;
struct V_1 * V_2 = F_65 ( V_86 ) ;
if ( ! V_104 || ! V_86 )
return - V_49 ;
if ( V_104 -> V_135 - V_86 -> V_104 . V_135 ) {
return - V_49 ;
}
V_133 = V_104 -> V_136 - V_86 -> V_104 . V_136 ;
if ( V_133 ) {
F_34 ( L_29 , V_53 , V_133 ) ;
V_134 = V_2 -> V_7 -> V_12 ;
V_134 += ( V_86 -> V_105 . V_91 * V_133 ) ;
V_2 -> V_7 -> V_12 = ( unsigned long ) V_134 ;
V_2 -> V_9 -> V_12 = ( unsigned long ) V_134 + V_2 -> V_29 ;
}
return 0 ;
}
static int F_69 ( int V_137 , struct V_126 * V_86 )
{
struct V_1 * V_2 = F_65 ( V_86 ) ;
switch ( V_137 ) {
case V_138 :
...
int F_70 ( struct V_126 * V_86 , struct V_142 * V_143 )
{
if ( V_144 )
return 0 ;
else
...
static int F_71 ( T_7 V_145 , T_7 V_94 , T_7 V_96 ,
T_7 V_97 , T_7 V_131 ,
struct V_126 * V_86 )
{
if ( V_145 >= V_113 )
...
V_41 = ( V_94 << V_86 -> V_104 . V_94 . V_130 ) |
( V_96 << V_86 -> V_104 . V_96 . V_130 ) |
( V_97 << V_86 -> V_104 . V_97 . V_130 ) ;
V_41 &= 0xFFFF ;
( ( V_84 * ) ( V_86 -> V_110 ) ) [ V_145 ] = V_41 ;
}
return 0 ;
}
...
static int F_76 ( struct V_149 * V_73 )
{
...
static int F_78 ( struct V_149 * V_73 )
{
struct V_1 * V_2 = F_77 ( V_73 ) ;
F_31 ( V_2 -> V_39 , V_45 ) ;
if ( V_2 -> V_118 ) {
