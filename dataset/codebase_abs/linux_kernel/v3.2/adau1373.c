...
static int F_38 ( struct V_6 * V_7 , T_2 V_138 )
{
...
static int T_3 F_41 ( struct V_139 * V_140 ,
const struct V_141 * V_28 )
{
struct V_14 * V_14 ;
int V_107 ;
V_14 = F_42 ( sizeof( * V_14 ) , V_142 ) ;
if ( ! V_14 )
return - V_143 ;
F_43 ( & V_140 -> V_104 , V_14 ) ;
V_107 = F_44 ( & V_140 -> V_104 , & V_144 ,
V_145 , F_33 ( V_145 ) ) ;
if ( V_107 < 0 )
F_45 ( V_14 ) ;
return V_107 ;
