...
void F_80 ( struct V_4 * V_5 , struct V_1 * V_2 , int V_92 )
{
F_90 ( V_5 , V_2 ) ;
V_2 -> V_5 = V_5 ;
if ( V_2 -> V_77 & V_74 ) {
...
void F_94 ( struct V_4 * V_5 , struct V_1 * V_2 , int V_92 )
{
unsigned long V_103 ;
F_95 ( V_5 -> V_89 , V_103 ) ;
F_80 ( V_5 , V_2 , V_92 ) ;
...
struct V_6 * V_7 = V_5 -> V_8 ;
if ( V_7 -> V_9 -> V_104 )
return V_7 -> V_9 -> V_104 ( V_5 , V_2 ) ;
return NULL ;
}
struct V_1 * F_98 ( struct V_4 * V_5 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
if ( V_7 -> V_9 -> V_105 )
...
int F_99 ( struct V_4 * V_5 , struct V_1 * V_2 , T_3 V_106 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
if ( V_7 -> V_9 -> V_107 )
return V_7 -> V_9 -> V_107 ( V_5 , V_2 , V_106 ) ;
V_2 -> V_108 [ 0 ] = NULL ;
return 0 ;
}
void F_100 ( struct V_4 * V_5 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
if ( V_7 -> V_9 -> V_109 )
V_7 -> V_9 -> V_109 ( V_2 ) ;
}
int F_101 ( struct V_4 * V_5 , int V_110 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
if ( V_7 -> V_9 -> V_111 )
return V_7 -> V_9 -> V_111 ( V_5 , V_110 ) ;
return V_112 ;
}
...
void F_108 ( struct V_4 * V_5 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
if ( F_77 ( V_2 ) ) {
V_5 -> V_86 [ F_78 ( V_2 ) ] -- ;
if ( ( V_2 -> V_77 & V_83 ) &&
V_7 -> V_9 -> V_115 )
V_7 -> V_9 -> V_115 ( V_5 , V_2 ) ;
}
}
static T_4
F_109 ( struct V_46 * V_40 , struct V_116 * V_117 , char * V_118 )
{
struct V_119 * V_59 = F_110 ( V_117 ) ;
struct V_6 * V_7 ;
T_4 error ;
if ( ! V_59 -> V_120 )
return - V_114 ;
V_7 = F_32 ( V_40 , struct V_6 , V_40 ) ;
F_38 ( & V_7 -> V_42 ) ;
error = V_7 -> V_9 ? V_59 -> V_120 ( V_7 , V_118 ) : - V_121 ;
F_39 ( & V_7 -> V_42 ) ;
return error ;
}
static T_4
F_111 ( struct V_46 * V_40 , struct V_116 * V_117 ,
const char * V_118 , T_5 V_122 )
{
struct V_119 * V_59 = F_110 ( V_117 ) ;
struct V_6 * V_7 ;
T_4 error ;
...
V_7 = F_32 ( V_40 , struct V_6 , V_40 ) ;
F_38 ( & V_7 -> V_42 ) ;
error = V_7 -> V_9 ? V_59 -> V_123 ( V_7 , V_118 , V_122 ) : - V_121 ;
F_39 ( & V_7 -> V_42 ) ;
return error ;
}
...
struct V_6 * V_7 = V_5 -> V_8 ;
int error ;
error = F_113 ( & V_7 -> V_40 , & V_5 -> V_40 , L_9 , L_10 ) ;
if ( ! error ) {
struct V_119 * V_117 = V_7 -> V_24 -> V_124 ;
if ( V_117 ) {
while ( V_117 -> V_117 . V_25 ) {
if ( F_114 ( & V_7 -> V_40 , & V_117 -> V_117 ) )
break;
V_117 ++ ;
}
}
F_115 ( & V_7 -> V_40 , V_125 ) ;
V_7 -> V_126 = 1 ;
}
return error ;
}
...
F_17 ( & V_28 ) ;
F_45 ( F_12 ( V_7 -> V_26 ) ) ;
F_67 ( & V_7 -> V_129 , & V_130 ) ;
F_18 ( & V_28 ) ;
if ( ! strcmp ( V_7 -> V_26 , V_34 ) ||
( ! * V_34 &&
! strcmp ( V_7 -> V_26 , V_53 ) ) )
V_128 = L_12 ;
F_35 ( V_131 L_13 , V_7 -> V_26 ,
V_128 ) ;
}
void F_120 ( struct V_24 * V_7 )
{
struct V_132 * V_133 , * V_64 ;
if ( V_7 -> V_9 . V_134 ) {
F_121 ( & V_135 ) ;
F_122 (g, p) {
F_123 ( V_64 ) ;
if ( V_64 -> V_136 )
V_7 -> V_9 . V_134 ( V_64 -> V_136 ) ;
F_124 ( V_64 ) ;
} F_125 ( V_133 , V_64 ) ;
F_126 ( & V_135 ) ;
}
...
static int F_128 ( struct V_4 * V_5 , struct V_24 * V_137 )
{
struct V_6 * V_138 , * V_7 ;
void * V_31 ;
int V_39 ;
V_7 = F_24 ( V_5 , V_137 ) ;
if ( ! V_7 )
...
int F_130 ( struct V_4 * V_5 , const char * V_25 )
{
char V_26 [ V_140 ] ;
struct V_24 * V_7 ;
if ( ! V_5 -> V_8 )
return - V_141 ;
F_131 ( V_26 , V_25 , sizeof( V_26 ) ) ;
V_7 = F_16 ( F_132 ( V_26 ) ) ;
if ( ! V_7 ) {
F_35 ( V_52 L_15 , V_26 ) ;
return - V_51 ;
...
return F_128 ( V_5 , V_7 ) ;
}
T_4 F_133 ( struct V_4 * V_5 , const char * V_25 ,
T_5 V_142 )
{
int V_19 ;
if ( ! V_5 -> V_8 )
...
T_4 F_134 ( struct V_4 * V_5 , char * V_25 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
struct V_24 * V_143 ;
struct V_24 * V_144 ;
int V_145 = 0 ;
if ( ! V_5 -> V_8 || ! F_135 ( V_5 ) )
return sprintf ( V_25 , L_17 ) ;
V_143 = V_7 -> V_24 ;
F_17 ( & V_28 ) ;
F_13 (__e, &elv_list, list) {
if ( ! strcmp ( V_143 -> V_26 , V_144 -> V_26 ) )
V_145 += sprintf ( V_25 + V_145 , L_18 , V_143 -> V_26 ) ;
else
V_145 += sprintf ( V_25 + V_145 , L_19 , V_144 -> V_26 ) ;
}
F_18 ( & V_28 ) ;
V_145 += sprintf ( V_145 + V_25 , L_20 ) ;
return V_145 ;
}
struct V_1 * F_136 ( struct V_4 * V_5 ,
struct V_1 * V_2 )
{
struct V_63 * V_146 = F_137 ( & V_2 -> V_63 ) ;
if ( V_146 )
return F_138 ( V_146 ) ;
return NULL ;
}
struct V_1 * F_139 ( struct V_4 * V_5 ,
struct V_1 * V_2 )
{
struct V_63 * V_147 = F_140 ( & V_2 -> V_63 ) ;
if ( V_147 )
return F_138 ( V_147 ) ;
return NULL ;
}
