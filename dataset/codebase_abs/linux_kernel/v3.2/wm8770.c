...
static int F_21 ( struct V_6 * V_7 , T_2 V_75 )
{
F_18 ( V_7 , V_72 ) ;
return 0 ;
}
...
V_38 -> V_80 [ 0 ] . V_81 = V_82 ;
V_38 -> V_80 [ 1 ] . V_81 = V_83 ;
V_38 -> V_80 [ 2 ] . V_81 = V_84 ;
for ( V_39 = 0 ; V_39 < F_11 ( V_38 -> V_73 ) ; V_39 ++ ) {
V_66 = F_26 ( V_38 -> V_73 [ V_39 ] . V_85 ,
& V_38 -> V_80 [ V_39 ] ) ;
if ( V_66 ) {
F_13 ( V_7 -> V_51 ,
L_6 ,
...
F_2 ( V_7 , V_96 , 0x100 , 0x100 ) ;
F_2 ( V_7 , V_97 , 0x100 , 0x100 ) ;
...
F_18 ( V_7 , V_72 ) ;
for ( V_39 = 0 ; V_39 < F_11 ( V_38 -> V_73 ) ; ++ V_39 )
F_32 ( V_38 -> V_73 [ V_39 ] . V_85 ,
& V_38 -> V_80 [ V_39 ] ) ;
F_30 ( F_11 ( V_38 -> V_73 ) , V_38 -> V_73 ) ;
return 0 ;
}
static int T_3 F_33 ( struct V_101 * V_102 )
{
struct V_37 * V_38 ;
int V_66 ;
V_38 = F_34 ( sizeof( struct V_37 ) , V_103 ) ;
if ( ! V_38 )
return - V_104 ;
V_38 -> V_77 = V_105 ;
F_35 ( V_102 , V_38 ) ;
V_66 = F_36 ( & V_102 -> V_51 ,
& V_106 , & V_107 , 1 ) ;
if ( V_66 < 0 )
F_37 ( V_38 ) ;
return V_66 ;
}
static int T_4 F_38 ( struct V_101 * V_102 )
{
F_39 ( & V_102 -> V_51 ) ;
F_37 ( F_40 ( V_102 ) ) ;
return 0 ;
