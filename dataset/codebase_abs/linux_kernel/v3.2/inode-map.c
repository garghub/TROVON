...
F_26 ( V_83 ) ;
V_83 = true ;
V_17 = F_50 ( V_3 , V_76 , V_12 ) ;
if ( V_17 )
goto V_91;
goto V_27;
}
F_51 ( V_77 ) -> V_92 = 0 ;
V_17 = F_52 ( V_76 , V_3 , V_77 ) ;
F_11 ( V_17 ) ;
if ( F_53 ( V_77 ) > 0 ) {
V_17 = F_54 ( V_3 , V_76 , V_12 , V_77 ) ;
if ( V_17 )
goto V_93;
}
F_18 ( & V_3 -> V_36 ) ;
...
F_58 ( V_77 , V_82 ) ;
V_17 = F_59 ( V_3 , V_76 , V_12 ) ;
V_93:
F_60 ( V_77 ) ;
V_91:
F_61 ( V_3 , V_76 -> V_87 , V_76 -> V_89 ) ;
V_29:
V_76 -> V_87 = V_79 ;
V_76 -> V_89 = V_80 ;
F_21 ( V_12 ) ;
...
static int F_62 ( struct V_2 * V_3 , T_1 * V_23 )
{
struct V_11 * V_12 ;
int V_17 ;
struct V_13 * V_94 ;
...
V_95 . type = - 1 ;
V_95 . V_25 = ( T_1 ) - 1 ;
V_17 = F_5 ( NULL , V_3 , & V_95 , V_12 , 0 , 0 ) ;
if ( V_17 < 0 )
goto error;
F_26 ( V_17 == 0 ) ;
if ( V_12 -> V_31 [ 0 ] > 0 ) {
...
int V_17 ;
F_4 ( & V_3 -> V_97 ) ;
if ( F_64 ( V_3 -> V_34 < V_24 ) ) {
V_17 = F_62 ( V_3 ,
& V_3 -> V_34 ) ;
if ( V_17 )
goto V_29;
}
if ( F_64 ( V_3 -> V_34 >= V_43 ) ) {
V_17 = - V_46 ;
goto V_29;
}
* V_23 = ++ V_3 -> V_34 ;
