...
F_70 ( & V_161 , F_74 ( V_166 ) ,
V_167 ) ;
return 0 ;
}
static void T_4 F_75 ( unsigned long * V_152 , unsigned long * V_153 ,
unsigned long * V_154 , unsigned long * V_155 )
{
struct V_168 * V_169 ;
F_76 (np, NULL, L_6 ) {
T_1 V_66 ;
if ( F_77 ( V_169 , L_7 , & V_66 ) )
continue;
if ( F_78 ( V_169 , L_8 ) )
* V_152 = V_66 ;
else if ( F_78 ( V_169 , L_9 ) )
* V_153 = V_66 ;
else if ( F_78 ( V_169 , L_10 ) )
* V_154 = V_66 ;
else if ( F_78 ( V_169 , L_11 ) )
* V_155 = V_66 ;
}
}
int T_4 F_79 ( void )
...
F_75 ( & V_152 , & V_153 , & V_154 , & V_155 ) ;
return F_61 ( V_152 , V_153 , V_154 , V_155 ) ;
}
int T_4 F_80 ( void )
{
unsigned long V_152 , V_153 , V_154 , V_155 ;
F_75 ( & V_152 , & V_153 , & V_154 , & V_155 ) ;
return F_72 ( V_152 , V_153 , V_154 , V_155 ) ;
}
