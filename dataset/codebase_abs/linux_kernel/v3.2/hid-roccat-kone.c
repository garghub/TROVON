...
if ( V_21 == NULL )
return - V_24 ;
memcpy ( V_21 , V_19 , V_20 ) ;
V_22 = F_6 ( V_17 , F_10 ( V_17 , 0 ) ,
V_31 ,
V_26 | V_27 | V_32 ,
V_18 , 0 , V_21 , V_20 , V_29 ) ;
F_8 ( V_21 ) ;
...
static int F_20 ( struct V_16 * V_17 , int * V_48 )
{
int V_38 ;
V_15 V_19 ;
...
static T_3 F_23 ( struct V_51 * V_52 , struct V_53 * V_54 ,
struct V_55 * V_56 , char * V_21 ,
T_4 V_57 , T_5 V_58 ) {
struct V_59 * V_60 =
F_24 ( V_54 , struct V_59 , V_54 ) -> V_61 -> V_61 ;
struct V_1 * V_2 = F_25 ( F_26 ( V_60 ) ) ;
...
static T_3 F_29 ( struct V_51 * V_52 , struct V_53 * V_54 ,
struct V_55 * V_56 , char * V_21 ,
T_4 V_57 , T_5 V_58 ) {
struct V_59 * V_60 =
F_24 ( V_54 , struct V_59 , V_54 ) -> V_61 -> V_61 ;
struct V_1 * V_2 = F_25 ( F_26 ( V_60 ) ) ;
struct V_16 * V_17 = F_30 ( F_31 ( V_60 ) ) ;
...
static T_3 F_32 ( struct V_51 * V_52 ,
...
static int F_39 ( struct V_16 * V_17 , int V_42 )
{
unsigned char V_12 ;
V_12 = V_42 ;
...
static T_3 F_43 ( struct V_59 * V_60 ,
struct V_67 * V_56 , char * V_21 )
{
struct V_1 * V_2 =
F_25 ( F_26 ( V_60 -> V_61 -> V_61 ) ) ;
...
V_38 = F_18 ( V_17 , & V_2 -> V_6 [ V_37 ] , V_37 + 1 ) ;
if ( V_38 )
return V_38 ;
}
V_38 = F_16 ( V_17 , & V_2 -> V_34 ) ;
...
{
struct V_79 * V_80 = F_31 ( V_78 -> V_60 . V_61 ) ;
struct V_16 * V_17 = F_30 ( V_80 ) ;
struct V_1 * V_2 ;
int V_38 ;
if ( V_80 -> V_81 -> V_82 . V_83
== V_84 ) {
V_2 = F_48 ( sizeof( * V_2 ) , V_23 ) ;
if ( ! V_2 ) {
F_15 ( V_78 , L_5 ) ;
return - V_24 ;
}
...
static int F_53 ( struct V_77 * V_78 , const struct V_88 * V_89 )
{
int V_38 ;
V_38 = F_54 ( V_78 ) ;
if ( V_38 ) {
...
static void F_59 ( struct V_1 const * V_2 ,
struct V_92 const * V_10 )
{
struct V_8 V_9 ;
switch ( V_10 -> V_10 ) {
...
static int F_60 ( struct V_77 * V_78 , struct V_99 * V_100 ,
T_6 * V_19 , int V_20 )
{
struct V_1 * V_2 = F_25 ( V_78 ) ;
