...
V_4 -> V_5 + V_65 ) ;
V_23 = F_48 ( V_25 -> V_62 , V_68 ,
V_3 , V_25 -> V_69 , F_21 , F_42 , V_50 ) ;
if ( ! V_23 ) {
V_52 = - V_53 ;
goto V_73;
}
...
static int T_7 F_62 ( struct V_17 * V_17 ,
...
V_4 = F_64 ( sizeof( struct V_1 ) , V_54 ) ;
if ( V_4 == NULL )
return - V_53 ;
V_4 -> V_3 . V_32 . V_96 = & V_17 -> V_32 ;
V_4 -> V_3 . V_32 . V_97 = F_61 ;
V_4 -> V_3 . V_98 = & V_99 ;
V_4 -> V_17 = V_17 ;
F_50 ( & V_4 -> V_77 ) ;
F_65 ( & V_4 -> V_39 ) ;
...
static void T_8 F_76 ( struct V_17 * V_17 )
{
struct V_1 * V_4 = F_77 ( V_17 ) ;
F_78 ( & V_4 -> V_3 ) ;
F_55 ( & V_4 -> V_3 ) ;
F_70 ( V_17 , NULL ) ;
F_73 ( V_17 , V_4 -> V_5 ) ;
...
static int F_79 ( struct V_17 * V_17 , T_9 V_107 )
{
F_80 ( V_17 ) ;
F_81 ( V_17 , V_108 ) ;
return 0 ;
