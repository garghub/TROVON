...
if ( V_21 == NULL )
return - V_122 ;
if ( V_135 -> V_25 . V_142 . V_139 != V_67 ) {
F_15 ( L_28 , V_30 ,
...
return - V_122 ;
V_21 = F_21 ( V_48 ) ;
V_135 -> V_25 . V_142 . V_139 = V_138 [ 0 ] . V_66 ;
V_135 -> V_25 . V_142 . V_36 = V_143 ;
...
for ( V_78 = 0 ; V_157 [ V_21 -> V_88 ] [ V_78 ] . V_7 != - 1 ; V_78 ++ ) {
V_148 =
F_1 ( V_21 -> V_2 , 1 , V_157 [ V_21 -> V_88 ] [ V_78 ] . V_4 ,
0 , V_157 [ V_21 -> V_88 ] [ V_78 ] . V_158 ,
V_157 [ V_21 -> V_88 ] [ V_78 ] . V_7 ) ;
if ( V_148 < 0 ) {
F_3 ( & V_21 -> V_2 -> V_11 ,
L_33 , V_78 ) ;
goto V_151;
...
F_70 ( V_80 -> V_167 , V_21 -> V_2 ,
V_162 ,
V_80 -> V_9 ,
V_80 -> V_100 ,
F_68 , V_80 ) ;
if ( V_80 -> V_32 != 0 ) {
V_82 -> V_8 = F_71 ( V_80 -> V_167 ,
V_168 ) ;
if ( V_82 -> V_8 )
F_3 ( & V_21 -> V_2 -> V_11 ,
L_40 ,
...
int V_162 ;
int V_169 ;
struct V_79 * V_80 = V_21 -> V_162 ;
V_162 = F_69 ( V_21 -> V_2 , V_21 -> V_166 ) ;
F_15 ( L_42 , V_30 , V_21 -> V_166 ) ;
V_80 -> V_32 = 1 ;
V_80 -> V_165 = 0 ;
V_80 -> V_167 = F_73 ( 0 , V_10 ) ;
if ( ! V_80 -> V_167 ) {
...
V_80 -> V_100 ,
F_68 , V_80 ) ;
F_15 ( L_44 , V_80 -> V_167 ) ;
V_169 = F_71 ( V_80 -> V_167 , V_10 ) ;
if ( V_169 ) {
...
V_21 -> V_63 . V_64 [ V_170 ] . V_92 = V_93 ;
V_21 -> V_63 . V_64 [ V_170 ] . V_95 = 0 ;
}
V_21 -> V_91 = 1 ;
return 0 ;
}
...
for ( V_78 = 0 ; V_157 [ V_21 -> V_88 ] [ V_78 ] . V_7 != - 1 ; V_78 ++ ) {
V_176 =
F_1 ( V_2 , 1 , V_157 [ V_21 -> V_88 ] [ V_78 ] . V_4 ,
0 , V_157 [ V_21 -> V_88 ] [ V_78 ] . V_158 ,
V_157 [ V_21 -> V_88 ] [ V_78 ] . V_7 ) ;
if ( V_176 < 0 ) {
F_3 ( & V_21 -> V_2 -> V_11 ,
...
for ( V_78 = 0 ; V_78 < V_193 -> V_206 . V_207 ; ++ V_78 ) {
V_195 = & V_193 -> V_195 [ V_78 ] . V_206 ;
