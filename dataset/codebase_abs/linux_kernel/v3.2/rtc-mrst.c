...
static int T_3
F_27 ( struct V_9 * V_10 , struct V_61 * V_62 , int V_63 )
{
int V_64 = 0 ;
unsigned char V_38 ;
if ( V_36 . V_10 )
...
static void T_4 F_42 ( struct V_9 * V_10 )
{
struct V_36 * V_37 = F_13 ( V_10 ) ;
struct V_61 * V_62 ;
F_41 () ;
...
static int F_44 ( struct V_9 * V_10 , T_5 V_76 )
{
struct V_36 * V_37 = F_13 ( V_10 ) ;
unsigned char V_77 ;
F_14 ( & V_6 ) ;
V_37 -> V_78 = V_77 = F_4 ( V_44 ) ;
if ( V_77 & ( V_56 | V_46 ) ) {
unsigned char V_50 ;
if ( F_45 ( V_10 ) )
V_50 = V_3 & ~ V_46 ;
...
{
return F_44 ( V_10 , V_80 ) ;
}
static int F_48 ( struct V_9 * V_10 )
{
struct V_36 * V_37 = F_13 ( V_10 ) ;
unsigned char V_77 = V_37 -> V_78 ;
if ( V_77 & V_3 ) {
unsigned char V_50 ;
if ( V_37 -> V_79 ) {
F_49 ( V_37 -> V_39 ) ;
...
static int T_3 F_50 ( struct V_82 * V_83 )
{
return F_27 ( & V_83 -> V_10 ,
F_51 ( V_83 , V_84 , 0 ) ,
F_52 ( V_83 , 0 ) ) ;
}
static int T_4 F_53 ( struct V_82 * V_83 )
{
F_42 ( & V_83 -> V_10 ) ;
return 0 ;
}
