...
if ( V_37 ) {
F_9 ( L_8
L_9 , V_38 -> V_2 , V_39 -> V_2 ) ;
return V_37 ;
}
if ( F_36 ( & V_15 -> V_40 ) == 1 ) {
F_9 ( L_10
L_11 , V_38 -> V_2 , V_39 -> V_2 ) ;
...
{
unsigned long V_21 ;
if ( ! V_3 || ! V_26 || ! V_26 -> V_46 )
return - V_7 ;
if ( ( F_36 ( & V_3 -> V_47 ) > 1 ) && V_20 )
return 0 ;
F_41 ( & V_3 -> V_12 , V_21 ) ;
V_26 -> V_46 ( V_3 ) ;
F_48 ( V_3 -> V_6 . V_8 ) ;
...
int V_46 ( struct V_1 * V_3 , struct V_50 * V_50 )
{
if ( ! V_50 )
return - V_7 ;
return F_47 ( V_3 ) ;
}
int V_48 ( struct V_1 * V_3 , struct V_50 * V_50 )
{
if ( ! V_50 )
return - V_7 ;
return F_49 ( V_3 ) ;
}
int F_52 ( struct V_1 * V_3 , struct V_51 * V_52 )
{
if ( F_53 () || F_54 () )
return 0 ;
if ( ! V_52 )
...
int F_55 ( struct V_1 * V_3 , struct V_51 * V_52 )
{
if ( F_53 () || F_54 () )
return 0 ;
if ( ! V_52 )
