...
void F_68 ( void )
__releases( V_100 . V_68 )
__acquires( V_100 . V_68 )
{
unsigned long T_4 V_101 ( ( F_69 ( 8 ) ) ) ;
unsigned long T_5 V_101 ( ( F_69 ( 8 ) ) ) ;
if ( ! V_102 )
return;
F_70 ( T_5 , 6 , 6 ) ;
T_4 = 1UL << ( 31 - V_103 ) ;
...
F_72 () ;
F_59 ( V_100 . V_68 ) ;
} while ( V_100 . V_26 . V_44 . V_33 . V_45 != 0 );
F_71 ( T_5 , 6 , 6 ) ;
}
static int
F_73 ( struct V_72 V_21 , void * V_104 )
{
if ( F_30 ( V_21 , & V_100 . V_26 ) != 0 )
return - V_77 ;
if ( ( V_100 . V_26 . V_53 . V_78 == V_79 ) &&
V_100 . V_26 . V_53 . V_105 &&
( V_100 . V_26 . V_53 . V_25 == V_106 ) ) {
V_107 = V_21 . V_23 ;
return 1 ;
}
return 0 ;
...
for ( V_63 = 0 ; V_63 < 3 ; V_63 ++ ) {
V_26 -> V_53 . V_57 = 0 ;
V_108 = F_32 ( V_21 , V_26 ) ;
if ( V_108 )
return ( V_108 == 3 ? - V_24 : - V_47 ) ;
...
struct V_83 V_109 ;
if ( F_61 ( & V_109 ) ) {
F_36 ( V_109 . V_21 , (struct V_67 * ) & V_85 . V_67 ) ;
if ( F_84 ( & V_109 . V_21 , & V_21 ) )
return 0 ;
}
F_88 ( 100 ) ;
}
...
static int F_91 ( struct V_72 V_21 , struct V_26 * V_111 )
{
int V_112 ;
V_110 = 0 ;
V_113 = F_90 ;
V_112 = F_30 ( V_21 , V_111 ) ;
V_113 = NULL ;
F_92 () ;
if ( V_110 )
return - V_66 ;
...
static int F_93 ( struct V_72 V_21 , void * V_104 )
{
struct V_26 V_26 ;
if ( F_91 ( V_21 , & V_26 ) )
return - V_77 ;
...
struct V_115 V_115 ;
struct V_116 * V_116 ;
V_116 = (struct V_116 * ) & V_85 . V_117 ;
if ( ! V_116 -> V_118 )
return;
while ( F_95 ( & V_115 ) == 0 ) {
if ( V_115 . V_119 && V_115 . V_120 == V_121 )
F_96 ( & V_122 ) ;
}
}
...
static int F_110 ( struct V_72 V_21 , void * V_104 )
{
struct V_26 V_26 ;
struct V_132 * V_133 = V_104 ;
if ( F_91 ( V_21 , & V_26 ) )
return - V_77 ;
if ( ( V_26 . V_53 . V_78 == V_79 ) && V_26 . V_53 . V_105 &&
( V_26 . V_53 . V_25 == V_133 -> V_134 . V_135 ) &&
( V_21 . V_22 == V_133 -> V_134 . V_22 ) ) {
V_133 -> V_21 = V_21 ;
V_133 -> V_112 = 0 ;
return 1 ;
}
...
static int F_111 ( struct V_136 * V_134 ,
struct V_72 * V_21 )
{
struct V_132 V_133 ;
V_133 . V_134 = * V_134 ;
...
void F_112 ( struct V_136 * V_134 )
{
struct V_72 V_21 ;
F_113 ( NULL , NULL ) ;
if ( F_111 ( V_134 , & V_21 ) != 0 )
F_114 ( L_19 ) ;
F_115 ( * ( ( V_43 * ) & V_21 ) ) ;
}
int T_1 F_116 ( struct V_137 * V_138 )
{
struct V_72 V_21 ;
struct V_26 V_26 ;
...
if ( ! V_26 . V_53 . V_105 )
return - V_24 ;
V_138 -> V_135 = V_26 . V_53 . V_25 ;
V_138 -> V_140 = V_26 . V_53 . V_141 ;
return 0 ;
}
int F_117 ( struct V_7 * V_8 , struct V_142 * V_142 , T_6 V_19 , T_6 V_30 )
{
int V_108 ;
union V_31 * V_31 = & F_7 ( V_8 ) -> V_31 ;
memset ( V_31 , 0 , sizeof( union V_31 ) ) ;
V_31 -> V_143 . V_34 = ( V_35 ) ( V_36 ) V_8 ;
V_31 -> V_143 . V_30 = V_30 >> 4 ;
V_31 -> V_143 . V_144 = 1 ;
V_31 -> V_143 . V_19 = V_19 ? V_19 : V_8 -> V_19 ;
V_31 -> V_143 . V_142 = ( V_35 ) ( V_36 ) V_142 ;
V_108 = F_17 ( V_8 -> V_21 , V_31 ) ;
switch ( V_108 ) {
case 0 :
return 0 ;
case 1 :
