...
enum V_60 V_61 , const char * V_62 , unsigned long V_63 ,
const char * V_64 , unsigned long V_65 )
{
struct V_1 * V_2 = F_21 ( V_59 ,
struct V_1 , V_66 ) ;
...
return;
V_71 = V_2 -> V_47 + V_56 ;
V_70 = F_27 ( V_65 , V_15 - V_56 ) ;
V_69 = F_27 ( V_63 , V_15 - V_56 - V_70 ) ;
V_68 = V_65 - V_70 ;
V_67 = V_63 - V_69 ;
memcpy ( V_71 , V_62 + V_67 , V_69 ) ;
memcpy ( V_71 + V_69 , V_64 + V_68 , V_70 ) ;
if ( V_61 != V_72 ) {
if ( ! V_2 -> V_11 -> V_49 )
F_16 ( V_40 L_10 ) ;
else
...
{
struct V_1 * V_2 = & V_76 ;
T_4 V_77 = F_29 ( V_11 -> V_78 , V_15 ) ;
int V_79 ;
if ( ! strcmp ( V_11 -> V_80 , V_28 ) )
V_2 -> V_81 = V_11 -> V_82 ;
if ( V_11 -> V_82 != V_2 -> V_81 || V_2 -> V_81 < 0 )
return;
if ( V_11 -> V_78 < V_11 -> V_13 * 2 ) {
F_16 ( V_40 L_11 ,
V_11 -> V_82 ) ;
return;
}
...
if ( V_11 -> V_78 > V_83 ) {
F_16 ( V_40 L_13 ,
V_11 -> V_82 , V_83 / 1024 / 1024 ) ;
return;
}
V_2 -> V_4 = F_30 ( F_31 ( V_77 ,
V_84 ) ) ;
if ( ! V_2 -> V_4 ) {
F_16 ( V_40 L_14 ) ;
return;
...
V_2 -> V_11 = V_11 ;
V_2 -> V_30 = ( int ) V_11 -> V_78 / V_15 ;
F_24 ( V_2 ) ;
F_16 ( V_85 L_16 , V_11 -> V_82 ) ;
}
