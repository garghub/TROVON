...
static T_2 F_24 ( int V_65 , void * V_66 )
{
struct V_1 * V_2 = V_66 ;
unsigned long V_67 = F_9 ( V_68 ) ;
F_23 ( V_2 ) ;
if ( V_67 & V_69 )
F_21 ( V_2 ) ;
if ( V_67 & V_70 )
...
{
struct V_3 * V_4 = V_2 -> V_4 ;
unsigned int V_72 = 0 , V_17 = 0 ;
unsigned long V_67 = 0 ;
if ( V_4 -> V_38 && V_4 -> V_37 ) {
V_67 |= V_73 | V_74 | V_75 | V_76 ;
V_67 |= F_26 ( V_4 -> V_38 ) |
F_27 ( V_4 -> V_37 ) ;
}
if ( V_4 -> V_20 ) {
...
if ( V_4 -> V_17 > V_17 )
V_17 = V_4 -> V_17 ;
V_2 -> V_63 = ( ( 2 << V_17 ) - 1 ) & ~ V_72 ;
if ( V_17 )
V_67 |= V_79 | V_80 | F_28 ( V_17 ) ;
F_20 ( V_68 , V_67 | V_81 ) ;
F_20 ( V_59 , V_60 ) ;
F_20 ( V_82 , V_4 -> V_83 ) ;
}
...
static int F_34 ( struct V_85 * V_58 )
{
struct V_86 * V_87 = F_35 ( V_58 ) ;
struct V_1 * V_2 = F_36 ( V_87 ) ;
F_33 ( V_2 -> V_84 ) ;
if ( F_37 ( & V_87 -> V_58 ) )
F_38 ( V_2 -> V_65 ) ;
return 0 ;
}
static int F_39 ( struct V_85 * V_58 )
{
struct V_86 * V_87 = F_35 ( V_58 ) ;
struct V_1 * V_2 = F_36 ( V_87 ) ;
struct V_5 * V_5 = V_2 -> V_5 ;
...
static int T_3 F_43 ( struct V_86 * V_87 )
{
struct V_3 * V_4 = V_87 -> V_58 . V_90 ;
struct V_1 * V_2 ;
struct V_5 * V_5 ;
struct V_91 * V_92 ;
int V_65 , error ;
...
V_92 = F_46 ( V_87 , V_95 , 0 ) ;
if ( V_92 == NULL ) {
F_44 ( & V_87 -> V_58 , L_3 ) ;
return - V_94 ;
}
V_2 = F_47 ( sizeof( struct V_1 ) , V_96 ) ;
V_5 = F_48 () ;
if ( ! V_2 || ! V_5 ) {
F_44 ( & V_87 -> V_58 , L_4 ) ;
error = - V_97 ;
...
V_2 -> V_5 = V_5 ;
V_2 -> V_65 = V_65 ;
V_92 = F_49 ( V_92 -> V_99 , F_50 ( V_92 ) , V_87 -> V_100 ) ;
if ( V_92 == NULL ) {
F_44 ( & V_87 -> V_58 , L_5 ) ;
error = - V_101 ;
goto V_98;
}
V_2 -> V_102 = F_51 ( V_92 -> V_99 , F_50 ( V_92 ) ) ;
if ( V_2 -> V_102 == NULL ) {
F_44 ( & V_87 -> V_58 , L_6 ) ;
error = - V_94 ;
goto V_103;
}
V_2 -> V_84 = F_52 ( & V_87 -> V_58 , NULL ) ;
if ( F_53 ( V_2 -> V_84 ) ) {
F_44 ( & V_87 -> V_58 , L_7 ) ;
error = F_54 ( V_2 -> V_84 ) ;
goto V_104;
}
V_5 -> V_100 = V_87 -> V_100 ;
V_5 -> V_105 . V_106 = V_107 ;
V_5 -> V_108 = F_29 ;
V_5 -> V_109 = F_32 ;
V_5 -> V_58 . V_110 = & V_87 -> V_58 ;
V_5 -> V_6 = V_2 -> V_15 ;
V_5 -> V_111 = sizeof( V_2 -> V_15 [ 0 ] ) ;
V_5 -> V_112 = F_55 ( V_2 -> V_15 ) ;
F_56 ( V_5 , V_2 ) ;
V_5 -> V_113 [ 0 ] = F_57 ( V_114 ) | F_57 ( V_115 ) ;
F_58 ( V_5 , V_51 , V_52 ) ;
F_1 ( V_2 ) ;
if ( ( V_4 -> V_20 && V_2 -> V_23 [ 0 ] != - 1 ) ||
( V_4 -> V_26 && V_2 -> V_23 [ 1 ] != - 1 ) ) {
V_5 -> V_113 [ 0 ] |= F_57 ( V_116 ) ;
}
error = F_59 ( V_65 , F_24 , 0 ,
V_87 -> V_100 , V_2 ) ;
if ( error ) {
F_44 ( & V_87 -> V_58 , L_8 ) ;
goto V_117;
...
F_65 ( V_2 -> V_102 ) ;
V_103:
F_66 ( V_92 -> V_99 , F_50 ( V_92 ) ) ;
V_98:
F_67 ( V_5 ) ;
F_68 ( V_2 ) ;
return error ;
}
static int T_4 F_69 ( struct V_86 * V_87 )
{
struct V_1 * V_2 = F_36 ( V_87 ) ;
struct V_91 * V_92 ;
F_63 ( V_2 -> V_65 , V_87 ) ;
