...
F_44 ( V_92 , V_141 ,
F_10 ( V_141 ) ) ;
F_45 ( V_92 , V_142 , F_10 ( V_142 ) ) ;
return 0 ;
V_139:
while ( -- V_22 >= 0 )
F_46 ( V_67 -> V_99 [ V_22 ] , V_67 ) ;
return V_68 ;
}
...
static int T_2 F_48 ( struct V_143 * V_144 )
{
struct V_145 * V_146 = F_49 ( V_144 -> V_118 . V_147 ) ;
struct V_66 * V_67 ;
struct V_148 * V_149 ;
int V_22 , V_68 ;
V_67 = F_50 ( sizeof( struct V_66 ) , V_150 ) ;
if ( V_67 == NULL )
return - V_151 ;
V_67 -> V_146 = V_146 ;
...
F_51 ( V_144 , V_67 ) ;
for ( V_22 = 0 ; V_22 < 4 ; V_22 ++ ) {
V_149 = F_52 ( V_144 , V_156 , V_22 ) ;
if ( ! V_149 ) {
F_41 ( & V_144 -> V_118 , L_7 ) ;
goto V_139;
}
V_67 -> V_99 [ V_22 ] = V_149 -> V_157 + V_146 -> V_158 ;
strncpy ( V_67 -> V_41 [ V_22 ] , V_149 -> V_41 , V_159 ) ;
}
V_68 = F_53 ( & V_144 -> V_118 , & V_160 ,
V_161 , F_10 ( V_161 ) ) ;
if ( V_68 ) {
F_41 ( & V_144 -> V_118 , L_8 ) ;
goto V_139;
}
return V_68 ;
V_139:
...
static int T_3 F_55 ( struct V_143 * V_144 )
{
struct V_66 * V_67 = F_56 ( V_144 ) ;
F_57 ( & V_144 -> V_118 ) ;
F_51 ( V_144 , NULL ) ;
F_54 ( V_67 ) ;
return 0 ;
}
static T_4 int F_58 ( void )
{
return F_59 ( & V_162 ) ;
}
