...
V_54 = F_21 ( V_2 ) ;
if ( V_54 ) {
F_19 (KERN_WARNING NAME L_18 ) ;
return V_54 ;
}
F_11 ( V_2 ) ;
if ( F_24 ( V_5 ) < 0 ) {
F_19 (KERN_ERR NAME L_19 ) ;
return - V_75 ;
}
if ( ! V_5 -> V_6 . V_76 ) {
F_15 ( & V_77 ) ;
...
static struct V_1 * T_5 F_25 ( const char * V_80 ,
unsigned long V_81 , int V_82 , struct V_83 * V_6 )
{
struct V_1 * V_2 ;
int V_54 ;
V_2 = F_26 ( V_80 , V_6 , V_82 ) ;
if ( V_2 == NULL )
return NULL ;
if ( ! F_27 ( V_81 , 8 , V_2 -> V_5 . V_84 ) ) {
F_19 (KERN_ERR NAME L_20 ,
base, base + 8 - 1 ) ;
goto V_85;
}
V_2 -> V_81 = V_81 ;
...
static int T_5 F_30 ( struct V_86 * V_87 )
{
struct V_1 * V_2 ;
struct V_88 * V_89 ;
V_89 = F_31 ( V_87 , V_90 , 0 ) ;
if ( ! V_89 ) {
F_6 ( & V_87 -> V_6 , L_21 ) ;
return - V_75 ;
}
V_2 = F_25 ( L_22 , V_89 -> V_91 , 0 , & V_87 -> V_6 ) ;
if ( ! V_2 )
return - V_32 ;
F_32 ( & V_87 -> V_6 , L_23 ,
V_2 -> V_5 . V_84 ) ;
...
static int T_6 F_36 ( struct V_86 * V_87 )
{
struct V_1 * V_2 ;
V_2 = F_37 ( V_87 ) ;
F_33 ( V_87 , NULL ) ;
