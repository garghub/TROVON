...
F_21 ( V_6 , V_73 ) ;
V_6 -> V_157 = V_117 == V_130 ;
return 0 ;
}
int F_28 ( struct V_5 * V_6 , T_4 V_117 , T_4 V_158 )
{
struct V_67 * V_73 ;
struct V_71 * V_72 ;
struct V_159 * V_160 ;
...
unsigned int V_14 ;
void * V_105 ;
T_7 V_171 = F_9 ( V_6 -> V_25 -> V_119 . V_172 -> V_173 ) ;
V_73 = F_12 ( V_6 , V_101 , sizeof( * V_160 ) +
...
memset ( V_160 -> V_175 , 0 , sizeof( V_160 -> V_175 ) ) ;
V_160 -> V_117 = F_9 ( V_117 ) ;
V_160 -> V_158 = F_9 ( V_158 ) ;
V_160 -> V_171 = V_171 ;
if ( V_6 -> V_145 == V_176 ) {
T_7 * V_177 = ( T_7 * ) F_17 ( V_73 , 2 ) ;
* V_177 = F_9 ( 0x0c ) ;
}
V_162 = ( void * ) F_17 ( V_73 , sizeof( * V_162 ) ) ;
for ( V_14 = 0 ; V_14 < V_6 -> V_178 ; V_14 ++ ) {
if ( V_6 -> V_162 [ V_14 ] . V_171 != V_171 )
continue;
memcpy ( V_162 , & V_6 -> V_162 [ V_14 ] . V_179 ,
sizeof( struct V_161 ) ) ;
break;
}
if ( V_14 == V_6 -> V_178 )
goto V_180;
if ( V_6 -> V_145 == V_176 )
V_164 = ( void * ) F_17 ( V_73 , sizeof( V_164 -> V_181 ) ) ;
else
V_164 = ( void * ) F_17 ( V_73 , sizeof( V_164 -> V_182 ) ) ;
for ( V_14 = 0 ; V_14 < V_6 -> V_183 -> V_184 ; V_14 ++ ) {
T_7 * V_185 = ( void * ) ( V_6 -> V_183 -> V_9 +
V_6 -> V_183 -> V_186 * V_14 ) ;
if ( * V_185 != V_171 )
continue;
if ( V_6 -> V_145 == V_176 ) {
memcpy ( & V_164 -> V_181 . V_187 ,
( void * ) V_185 + sizeof( T_7 ) ,
V_6 -> V_183 -> V_186 ) ;
} else {
struct V_188 * V_189 =
( void * ) V_185 ;
V_164 -> V_182 . V_190 = 0x38 ;
V_164 -> V_182 . V_191 = V_164 -> V_182 . V_192 =
V_189 -> V_191 ;
V_164 -> V_182 . V_193 = V_164 -> V_182 . V_194 =
V_189 -> V_193 ;
V_164 -> V_182 . V_195 = V_164 -> V_182 . V_196 =
V_189 -> V_195 ;
V_164 -> V_182 . V_197 = V_164 -> V_182 . V_198 =
V_189 -> V_197 ;
}
break;
}
if ( V_14 == V_6 -> V_183 -> V_184 )
goto V_180;
V_105 = ( void * ) ( V_6 -> V_199 -> V_9 + V_6 -> V_199 -> V_81 ) ;
for ( V_14 = 0 ; V_14 < V_6 -> V_199 -> V_184 ; V_14 ++ ) {
if ( * ( ( T_7 * ) V_105 ) != V_171 ) {
V_105 += V_6 -> V_199 -> V_186 ;
continue;
}
if ( V_6 -> V_145 == V_176 ) {
memcpy ( & V_164 -> V_181 . V_199 ,
( void * ) V_105 + sizeof( T_7 ) ,
V_6 -> V_199 -> V_186 ) ;
} else {
struct V_200 * V_201 = & V_164 -> V_182 ;
struct V_202 * V_199 =
( void * ) V_6 -> V_199 -> V_9 ;
V_105 += sizeof( T_7 ) ;
V_201 -> V_203 = 8 ;
memset ( V_201 -> V_199 , 0 , sizeof( * V_201 -> V_199 ) ) ;
memcpy ( V_201 -> V_199 , V_105 ,
sizeof( struct V_204 ) *
F_29 ( ( T_2 ) 8 , V_199 -> V_205 ) ) ;
}
break;
}
if ( V_14 == V_6 -> V_199 -> V_184 )
goto V_180;
...
struct V_67 * V_73 ;
struct V_211 * V_212 ;
V_73 = F_12 ( V_6 , V_101 , sizeof( * V_212 ) ,
V_213 , V_103 ) ;
if ( F_13 ( ! V_73 ) )
return - V_66 ;
...
struct V_217 * V_218 ;
T_2 V_219 ;
V_73 = F_12 ( V_6 , V_101 , sizeof( * V_218 ) ,
V_220 , V_103 ) ;
if ( F_13 ( ! V_73 ) )
return - V_66 ;
...
unsigned int V_14 ;
T_4 V_117 ;
if ( V_6 -> V_25 -> V_119 . V_77 & V_233 &&
! V_6 -> V_234 )
V_117 = V_235 | V_236 | V_237 |
V_238 | V_239 ;
else
V_117 = V_240 ;
V_73 = F_12 ( V_6 , V_101 , sizeof( * V_232 ) ,
V_241 , V_103 ) ;
if ( ! V_73 )
return - V_66 ;
V_232 = (struct V_231 * ) F_17 ( V_73 , sizeof( * V_232 ) ) ;
V_232 -> V_117 = F_9 ( V_117 ) ;
V_232 -> V_97 = F_9 ( V_6 -> V_97 ) ;
for ( V_14 = 0 ; V_14 < F_36 ( V_232 -> V_242 ) ; V_14 ++ ) {
V_232 -> V_242 [ V_14 ] . V_243 =
F_9 ( V_6 -> V_25 -> V_119 . V_244 ) ;
...
struct V_67 * V_73 ;
struct V_252 * V_253 ;
V_73 = F_12 ( V_6 , V_101 , sizeof( * V_253 ) ,
V_254 , V_65 ) ;
if ( F_13 ( ! V_73 ) )
return - V_66 ;
...
struct V_67 * V_73 ;
struct V_261 * V_262 ;
V_73 = F_12 ( V_6 , V_101 , sizeof( * V_262 ) ,
V_263 , V_65 ) ;
if ( F_13 ( ! V_73 ) )
return - V_66 ;
...
V_262 -> V_265 = V_257 ;
if ( V_106 )
memcpy ( V_262 -> V_266 , V_106 , V_109 ) ;
else
memset ( V_262 -> V_266 , ~ 0 , V_109 ) ;
switch ( V_257 ) {
case V_267 :
case V_268 :
V_262 -> V_269 = F_39 ( T_2 , 16 , V_13 ) ;
...
struct V_67 * V_73 ;
bool V_283 = false ;
V_73 = F_12 ( V_6 , V_101 , sizeof( * V_282 ) ,
V_284 , V_65 ) ;
if ( ! V_73 )
return - V_66 ;
V_282 = (struct V_281 * ) F_17 ( V_73 , sizeof( * V_282 ) ) ;
V_283 = ! ( V_6 -> V_131 & V_285 ) &&
( V_6 -> V_286 > 0 &&
V_6 -> V_286 <= V_287 ) ;
if ( V_283 ) {
V_282 -> V_288 = F_9 ( 1 ) ;
