...
if ( V_97 ) {
V_51 -> V_99 . V_97 = V_97 ;
V_51 -> V_99 . V_100 = F_32 ;
if ( F_43 ( V_10 , & V_51 -> V_99 ) < 0 ) {
F_3 ( V_10 , L_19 , V_74 ) ;
return - 1 ;
}
if ( F_44 ( V_51 -> V_99 . V_10 ,
& V_101 ) < 0 ) {
F_3 ( V_10 , L_20 ) ;
F_45 ( & V_51 -> V_99 ) ;
return - 1 ;
...
struct V_94 * V_95 ,
const char * V_13 , T_6 V_102 )
{
struct V_1 * V_2 = F_36 ( V_10 ) ;
int V_4 ;
unsigned long V_5 ;
V_4 = F_38 ( V_13 , 10 , & V_5 ) ;
F_19 ( & V_2 -> V_52 ) ;
V_2 -> V_25 = ! V_5 ;
F_21 ( & V_2 -> V_52 ) ;
return V_102 ;
}
static int T_7 F_48 ( struct V_103 * V_9 ,
const struct V_104 * V_74 )
{
struct V_105 * V_106 = V_9 -> V_10 . V_107 ;
struct V_108 * V_26 ;
struct V_1 * V_2 ;
int V_51 ;
int V_5 , V_109 ;
unsigned long V_110 ;
T_2 V_7 [ 2 ] ;
if ( ! V_106 || ! V_106 -> V_37 || ! V_106 -> V_38 ) {
F_3 ( & V_9 -> V_10 , L_22 ) ;
return - V_96 ;
}
if ( V_106 -> V_37 > 8 ) {
...
V_109 = F_39 ( V_2 , V_51 + 1 , & V_9 -> V_10 ,
V_106 -> V_116 [ V_51 ] ) ;
if ( V_109 < 0 )
goto V_117;
}
V_2 -> V_25 = true ;
V_109 = F_44 ( & V_9 -> V_10 , & V_118 ) ;
if ( V_109 < 0 )
goto V_117;
V_26 -> V_97 = V_106 -> V_97 ? : L_28 ;
snprintf ( V_2 -> V_119 , sizeof( V_2 -> V_119 ) ,
L_29 , F_54 ( & V_9 -> V_10 ) ) ;
V_26 -> V_119 = V_2 -> V_119 ;
V_26 -> V_120 [ 0 ] = F_55 ( V_121 ) | F_55 ( V_27 ) ;
F_56 ( V_28 , V_26 -> V_122 ) ;
for ( V_5 = 0 ; V_5 < V_123 ; V_5 ++ ) {
F_56 ( V_106 -> V_24 [ V_5 ] , V_26 -> V_124 ) ;
V_2 -> V_24 [ V_5 ] = V_106 -> V_24 [ V_5 ] ;
}
F_57 ( V_125 , V_26 -> V_124 ) ;
if ( V_106 -> V_126 )
F_56 ( V_127 , V_26 -> V_120 ) ;
V_109 = F_58 ( V_26 ) ;
if ( V_109 ) {
F_59 ( & V_9 -> V_10 , L_30 ) ;
goto V_128;
}
V_109 = F_60 ( V_9 -> V_57 , NULL , F_22 ,
...
V_117:
while ( -- V_51 >= 0 )
if ( V_2 -> V_51 [ V_51 ] . V_98 ) {
F_65 ( V_2 -> V_51 [ V_51 ] . V_99 . V_10 ,
& V_101 ) ;
F_45 ( & V_2 -> V_51 [ V_51 ] . V_99 ) ;
}
V_113:
F_66 ( V_26 ) ;
F_67 ( V_2 ) ;
...
static int T_8 F_68 ( struct V_103 * V_9 )
{
...
F_71 ( V_9 -> V_57 , V_2 ) ;
F_64 ( V_2 -> V_26 ) ;
F_65 ( & V_2 -> V_9 -> V_10 , & V_118 ) ;
for ( V_5 = 0 ; V_5 < 3 ; V_5 ++ )
if ( V_2 -> V_51 [ V_5 ] . V_98 ) {
F_65 ( V_2 -> V_51 [ V_5 ] . V_99 . V_10 , & V_101 ) ;
F_45 ( & V_2 -> V_51 [ V_5 ] . V_99 ) ;
}
F_67 ( V_2 ) ;
return 0 ;
}
static int F_72 ( struct V_93 * V_10 )
{
struct V_103 * V_9 = F_73 ( V_10 ) ;
struct V_1 * V_2 = F_69 ( V_9 ) ;
int V_5 ;
F_74 ( V_9 -> V_57 , 0 ) ;
F_75 ( V_9 -> V_57 ) ;
...
for ( V_5 = 0 ; V_5 < 3 ; V_5 ++ )
if ( V_2 -> V_51 [ V_5 ] . V_98 )
F_76 ( & V_2 -> V_51 [ V_5 ] . V_99 ) ;
return 0 ;
}
static int F_77 ( struct V_93 * V_10 )
{
struct V_103 * V_9 = F_73 ( V_10 ) ;
struct V_1 * V_2 = F_69 ( V_9 ) ;
int V_5 ;
