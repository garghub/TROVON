...
V_151 -> V_162 += V_148 -> V_163 ;
V_151 -> V_164 += V_148 -> V_163 ;
V_6 -> V_59 = V_151 -> V_162 ;
if ( ! F_73 ( V_151 -> V_162 , F_74 ( V_151 ) ,
F_75 ( & V_146 -> V_35 ) ) ) {
V_123 = - V_165 ;
goto V_161;
}
V_6 -> V_7 = F_76 ( V_151 -> V_162 , F_74 ( V_151 ) ) ;
if ( ! V_6 -> V_7 ) {
...
F_78 ( & V_6 -> V_116 ) ;
F_79 ( & V_6 -> V_117 ) ;
F_79 ( & V_29 [ V_2 -> V_30 - 1 ] . V_11 ) ;
V_6 -> V_55 = F_80 ( V_2 -> V_113 ,
sizeof( struct V_42 ) ,
V_110 ) ;
if ( V_6 -> V_55 == NULL )
goto V_166;
...
F_52 ( V_6 -> V_55 ) ;
V_166:
F_85 ( V_151 -> V_162 , F_74 ( V_151 ) ) ;
F_86 ( V_6 -> V_7 ) ;
V_161:
return V_123 ;
}
static int T_5 F_87 ( struct V_145 * V_146 )
{
struct V_1 * V_2 ;
struct V_5 * V_6 ;
struct V_42 * V_55 ;
...
static int F_89 ( struct V_144 * V_35 )
{
