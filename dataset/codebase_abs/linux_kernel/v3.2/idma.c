...
int V_48 = 0 ;
if ( ! V_90 -> V_89 -> V_100 )
V_90 -> V_89 -> V_100 = & V_101 ;
if ( ! V_90 -> V_89 -> V_102 )
V_90 -> V_89 -> V_102 = F_40 ( 32 ) ;
if ( V_98 -> V_103 -> V_104 . V_105 )
V_48 = F_37 ( V_82 ,
V_86 ) ;
return V_48 ;
}
void F_41 ( void * V_4 , T_1 V_72 )
{
F_32 ( & V_2 . V_14 ) ;
V_2 . V_4 = V_4 ;
V_2 . V_3 = V_72 ;
}
static int T_5 F_42 ( struct V_106 * V_107 )
{
return F_43 ( & V_107 -> V_89 , & V_108 ) ;
}
static int T_6 F_44 ( struct V_106 * V_107 )
{
F_45 ( & V_107 -> V_89 ) ;
return 0 ;
}
