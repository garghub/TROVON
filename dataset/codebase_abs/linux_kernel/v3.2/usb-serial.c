...
F_100 ( V_119 ) ) ;
V_16 -> V_156 = V_125 ;
V_16 -> V_157 = V_119 -> V_158 ;
V_16 -> V_96 = F_101 ( V_125 , V_102 ) ;
if ( ! V_16 -> V_96 ) {
F_70 ( & V_36 -> V_24 ,
L_32 ) ;
goto V_150;
}
F_102 ( V_16 -> V_88 , V_24 ,
F_103 ( V_24 ,
V_119 -> V_158 ) ,
V_16 -> V_96 , V_125 ,
V_3 -> type -> V_159 , V_16 ) ;
...
if ( F_104 ( & V_16 -> V_95 , V_160 , V_102 ) )
goto V_150;
V_125 = V_3 -> type -> V_161 ;
if ( ! V_125 )
V_125 = F_100 ( V_119 ) ;
V_16 -> V_161 = V_125 ;
V_16 -> V_162 = V_119 -> V_158 ;
V_16 -> V_97 = F_101 ( V_125 , V_102 ) ;
if ( ! V_16 -> V_97 ) {
F_70 ( & V_36 -> V_24 ,
L_33 ) ;
goto V_150;
}
F_102 ( V_16 -> V_89 , V_24 ,
F_105 ( V_24 ,
V_119 -> V_158 ) ,
V_16 -> V_97 , V_125 ,
V_3 -> type -> V_163 , V_16 ) ;
for ( V_12 = 0 ; V_12 < F_61 ( V_16 -> V_90 ) ; ++ V_12 ) {
F_106 ( V_12 , & V_16 -> V_164 ) ;
...
void F_115 ( struct V_101 * V_36 )
{
int V_11 ;
struct V_1 * V_3 = F_116 ( V_36 ) ;
...
int F_121 ( struct V_101 * V_104 , T_1 V_180 )
{
struct V_1 * V_3 = F_116 ( V_104 ) ;
struct V_18 * V_16 ;
int V_11 , V_181 = 0 ;
V_3 -> V_182 = 1 ;
if ( V_3 -> type -> V_183 ) {
V_181 = V_3 -> type -> V_183 ( V_3 , V_180 ) ;
if ( V_181 < 0 ) {
V_3 -> V_182 = 0 ;
goto V_184;
}
...
int F_122 ( struct V_101 * V_104 )
{
struct V_1 * V_3 = F_116 ( V_104 ) ;
int V_185 ;
V_3 -> V_182 = 0 ;
if ( V_3 -> type -> V_186 )
V_185 = V_3 -> type -> V_186 ( V_3 ) ;
else
V_185 = F_123 ( V_3 ) ;
return V_185 ;
}
...
V_202 ;
V_188 -> V_38 = V_203 ;
V_188 -> V_38 . V_204 = V_205 | V_206 | V_207
| V_208 | V_209 ;
V_188 -> V_38 . V_210 = 9600 ;
V_188 -> V_38 . V_211 = 9600 ;
F_128 ( V_188 , & V_212 ) ;
V_187 = F_129 ( V_188 ) ;
if ( V_187 ) {
F_127 ( V_189 L_48 ,
...
static void F_139 ( struct V_47 * V_93 )
{
F_140 ( V_93 , V_44 ) ;
F_140 ( V_93 , V_55 ) ;
F_140 ( V_93 , V_50 ) ;
