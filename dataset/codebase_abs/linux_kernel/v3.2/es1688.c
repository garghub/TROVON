...
static int T_1 F_3 ( struct V_5 * V_6 ,
...
static int T_1 F_9 ( struct V_5 * V_6 , unsigned int V_3 )
{
struct V_7 * V_8 = V_6 -> V_9 ;
struct V_24 * V_25 ;
struct V_26 * V_27 ;
...
static int T_1 F_18 ( struct V_1 * V_2 , unsigned int V_3 )
{
struct V_5 * V_6 ;
int error ;
...
static int T_2 F_23 ( struct V_1 * V_2 , unsigned int V_3 )
{
F_22 ( F_24 ( V_2 ) ) ;
F_21 ( V_2 , NULL ) ;
return 0 ;
}
static int T_1 F_25 ( struct V_5 * V_6 , unsigned int V_3 ,
struct V_39 * V_40 ,
...
static int T_1 F_32 ( struct V_39 * V_40 ,
const struct V_41 * V_42 )
{
struct V_5 * V_6 ;
...
static void T_2 F_34 ( struct V_39 * V_40 )
{
F_22 ( F_35 ( V_40 ) ) ;
F_33 ( V_40 , NULL ) ;
V_48 = 0 ;
