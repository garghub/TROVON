...
long F_7 ( unsigned long V_22 , unsigned long V_23 ,
void T_1 * V_24 , void T_1 * V_25 )
{
long V_7 ;
if ( ! V_23 )
V_23 = F_8 ( & V_15 -> V_16 . V_17 . V_17 ) ;
V_15 -> V_16 . V_26 = 1 ;
V_7 = F_9 ( V_22 , V_23 , & V_15 -> V_16 . V_17 , 0 , V_24 ,
V_25 ) ;
V_15 -> V_16 . V_26 = 0 ;
return V_7 ;
}
void F_10 ( struct V_1 * V_27 )
{
if ( ( V_27 -> V_16 . V_20 . V_21 == 0 ) || ( V_27 -> V_9 == NULL ) )
return;
F_1 ( V_27 , V_13 , ( void T_1 * ) V_27 -> V_16 . V_20 . V_21 ) ;
}
