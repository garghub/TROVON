...
if ( ! V_12 )
return - V_79 ;
if ( ! F_29 ( & V_9 -> V_9 , V_75 -> V_80 ,
F_30 ( V_75 ) , F_31 ( & V_9 -> V_9 ) ) )
return - V_81 ;
V_12 -> V_16 = F_32 ( & V_9 -> V_9 , V_75 -> V_80 ,
F_30 ( V_75 ) ) ;
if ( ! V_12 -> V_16 )
return - V_81 ;
V_64 = V_14 -> V_64 ? : 20 ;
...
if ( V_14 -> V_87 != 1 ) {
V_8 -> V_36 = V_71 ;
V_8 -> V_102 = F_40 ( V_78 , L_5 ,
F_31 ( & V_9 -> V_9 ) , V_71 ) ;
} else {
V_8 -> V_36 = - 1 ;
V_8 -> V_102 = F_41 ( F_31 ( & V_9 -> V_9 ) ,
V_78 ) ;
}
if ( ! V_8 -> V_102 ) {
F_42 ( V_8 ) ;
