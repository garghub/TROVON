...
static struct V_1 * F_24 ( struct V_40 * V_8 ,
...
struct V_40 * F_44 ( const char * V_75 , int V_76 ,
...
struct V_40 * F_45 ( const char * V_75 , int V_76 ,
struct V_33 * * V_67 , int V_46 ,
void * V_77 , int V_78 ,
struct V_11 * V_14 ,
int V_22 , int V_79 )
...
static int F_49 ( struct V_40 * V_8 )
{
struct V_40 * V_84 [ 1 ] ;
V_84 [ 0 ] = V_8 ;
F_53 ( V_84 , 1 ) ;
...
static int F_50 ( struct V_40 * V_8 )
{
F_37 ( L_30 , V_8 -> V_64 ) ;
V_8 -> V_9 . V_88 = & V_89 ;
V_8 -> V_9 . V_54 = & V_55 ;
...
struct V_99 * F_71 ( struct V_1 * V_2 )
{
if ( ! V_2 -> V_63 )
return NULL ;
return F_72 ( V_2 -> V_41 [ 0 ] ) ;
}
void T_3 * F_73 ( struct V_1 * V_2 )
{
if ( V_2 -> V_63 != 1 )
return NULL ;
