...
V_86 -> V_9 |= V_16 -> V_127 ;
if ( V_21 -> V_128 -> V_129 == 1 &&
V_120 -> V_64 -> V_72 == F_20 ( V_73 ) )
V_124 = - 1 ;
else
...
struct V_82 * V_83 = V_81 ;
struct V_15 * V_16 = & V_83 -> V_84 ;
struct V_134 * V_135 = & V_69 -> V_136 . V_135 ;
struct V_137 * V_138 = F_37 ( V_21 -> V_128 ) ;
T_2 V_139 = V_69 -> V_136 . V_140 ;
int V_141 = 0 ;
int V_142 ;
int V_143 ;
int V_12 ;
...
V_16 -> V_52 = V_53 ;
V_142 = F_39 ( V_138 , 10 , 60 , 1 , 1 ) ;
V_16 -> V_36 = F_39 ( V_138 , 0 , 60 , 1 , 1 ) + V_142 ;
V_16 -> V_116 = V_16 -> V_36 + 2 * V_142 ;
V_16 -> V_37 = F_8 ( 1 , 1 ) ;
if ( V_21 -> V_125 ) {
V_16 -> V_46 = 16 ;
V_16 -> V_99 = 0 ;
...
if ( V_13 [ V_12 ] . V_9 & V_11 )
V_156 |= V_155 ;
if ( ( V_139 & V_156 ) != V_156 )
continue;
V_16 -> V_18 [ V_12 ] . V_50 =
V_135 -> V_159 [ V_13 [ V_12 ] . V_6 - 1 ] ;
...
V_83 -> V_94 . V_160 = V_83 -> V_161 ;
V_83 -> V_94 . V_58 = V_83 -> V_58 ;
return V_92 . V_162 ( V_78 , V_80 , V_69 , & V_83 -> V_94 ) ;
}
static void
...
{
struct V_20 * V_21 = V_78 ;
F_36 ( V_78 , V_80 , V_69 , V_81 , V_21 -> V_128 -> V_163 . V_164 ) ;
}
static void
F_41 ( void * V_78 , struct V_79 * V_80 ,
struct V_61 * V_69 , void * V_81 ,
T_1 V_165 , enum V_132 V_133 )
{
F_36 ( V_78 , V_80 , V_69 , V_81 , V_133 ) ;
}
static void *
F_42 ( void * V_78 , struct V_61 * V_69 , T_3 V_166 )
{
struct V_79 * V_80 ;
struct V_82 * V_83 ;
struct V_20 * V_21 = V_78 ;
struct V_167 * V_128 = V_21 -> V_128 ;
int V_129 = 0 ;
int V_12 ;
for ( V_12 = 0 ; V_12 < V_168 ; V_12 ++ ) {
V_80 = V_128 -> V_169 -> V_170 [ V_12 ] ;
if ( V_80 && V_80 -> V_171 > V_129 )
V_129 = V_80 -> V_171 ;
}
V_83 = F_43 ( sizeof( struct V_15 ) , V_166 ) ;
if ( ! V_83 )
return NULL ;
V_83 -> V_161 = F_43 ( sizeof( struct V_172 ) * V_129 , V_166 ) ;
if ( ! V_83 -> V_161 )
goto error;
V_83 -> V_58 = F_44 ( V_173 * V_129 , V_166 ) ;
if ( ! V_83 -> V_58 )
goto V_174;
return V_83 ;
V_174:
...
static void
F_46 ( void * V_78 , struct V_61 * V_69 , void * V_81 )
{
struct V_82 * V_83 = V_81 ;
F_45 ( V_83 -> V_58 ) ;
F_45 ( V_83 -> V_161 ) ;
...
static void *
F_47 ( struct V_167 * V_128 , struct V_175 * V_176 )
{
return V_92 . V_177 ( V_128 , V_176 ) ;
}
static void
F_48 ( void * V_78 )
{
...
F_49 ( void )
{
int V_178 , V_12 , V_179 ;
T_4 V_180 [ V_8 ] ;
memset ( V_58 , 0xff , sizeof( V_58 ) ) ;
for ( V_178 = 0 ; V_178 < V_173 ; V_178 ++ ) {
for ( V_12 = 0 ; V_12 < V_8 ; V_12 ++ ) {
F_50 ( V_180 , sizeof( V_180 ) ) ;
V_179 = ( V_12 + V_180 [ V_12 ] ) % V_8 ;
while ( V_58 [ V_178 ] [ V_179 ] != 0xff )
V_179 = ( V_179 + 1 ) % V_8 ;
V_58 [ V_178 ] [ V_179 ] = V_12 ;
}
}
}
int T_5
