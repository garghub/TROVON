...
continue;
V_18 = F_5 ( sizeof( struct V_3 ) , V_24 ) ;
if ( V_18 == NULL ) {
V_20 = - 1 ;
goto V_25;
}
V_18 -> V_14 = V_14 ;
V_18 -> V_6 = & V_9 [ V_19 ] ;
F_6 ( & V_18 -> V_26 , & V_14 -> V_27 . V_26 ) ;
V_17 = F_7 ( V_9 [ V_19 ] . V_28 , V_29 , V_12 ,
& V_30 , V_18 ) ;
if ( ! V_17 ) {
F_8 ( L_1 ,
V_12 -> V_28 , V_9 [ V_19 ] . V_28 ) ;
F_9 ( & V_18 -> V_26 ) ;
F_10 ( V_18 ) ;
V_20 = - 1 ;
goto V_25;
...
int V_20 ;
F_13 ( & V_14 -> V_27 . V_26 ) ;
sprintf ( V_28 , L_2 , V_33 ) ;
V_14 -> V_32 = F_14 ( V_28 , V_12 ) ;
if ( ! V_14 -> V_32 ) {
F_8 ( L_3 , V_28 ) ;
return - 1 ;
}
...
V_18 = F_17 ( V_36 , struct V_3 , V_26 ) ;
