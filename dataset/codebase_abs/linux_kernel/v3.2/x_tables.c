...
struct V_137 * V_138 ;
int V_5 ;
V_138 = F_94 ( sizeof( * V_138 ) , V_92 ) ;
if ( V_138 == NULL )
return - V_56 ;
V_5 = F_95 ( V_128 , & V_145 ) ;
if ( V_5 < 0 ) {
F_55 ( V_138 ) ;
return V_5 ;
}
...
static void * F_96 ( struct V_121 * V_122 , T_7 * V_123 )
{
return F_88 ( V_122 , V_123 , true ) ;
}
static void * F_97 ( struct V_121 * V_122 , void * V_126 , T_7 * V_131 )
{
return F_87 ( V_122 , V_126 , V_131 , true ) ;
}
static int F_98 ( struct V_121 * V_122 , void * V_126 )
{
const struct V_137 * V_138 = V_122 -> V_105 ;
...
static int F_99 ( struct V_127 * V_127 , struct V_128 * V_128 )
{
struct V_121 * V_122 ;
struct V_137 * V_138 ;
int V_5 ;
...
struct V_147 * F_100 ( const struct V_100 * V_42 , T_8 * V_148 )
{
unsigned int V_44 = V_42 -> V_149 ;
T_3 V_10 , V_150 = F_101 ( V_44 ) ;
T_3 V_151 ;
struct V_147 * V_152 ;
int V_5 ;
V_152 = F_94 ( sizeof( * V_152 ) * V_150 , V_92 ) ;
if ( V_152 == NULL )
return F_15 ( - V_56 ) ;
...
void F_103 ( const struct V_100 * V_42 , struct V_147 * V_152 )
{
F_104 ( V_152 , F_101 ( V_42 -> V_149 ) ) ;
F_55 ( V_152 ) ;
}
int F_105 ( struct V_101 * V_101 , T_1 V_3 )
{
#ifdef F_106
char V_29 [ V_157 ] ;
struct V_158 * V_159 ;
...
F_108 ( V_29 , V_160 , sizeof( V_29 ) ) ;
V_159 = F_109 ( V_29 , 0440 , V_101 -> V_161 , & V_162 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_159 )
goto V_116;
F_107 ( V_29 , V_23 [ V_3 ] , sizeof( V_29 ) ) ;
F_108 ( V_29 , V_163 , sizeof( V_29 ) ) ;
V_159 = F_109 ( V_29 , 0440 , V_101 -> V_161 , & V_164 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_159 )
goto V_165;
F_107 ( V_29 , V_23 [ V_3 ] , sizeof( V_29 ) ) ;
F_108 ( V_29 , V_166 , sizeof( V_29 ) ) ;
V_159 = F_109 ( V_29 , 0440 , V_101 -> V_161 , & V_167 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_159 )
goto V_168;
#endif
...
void F_111 ( struct V_101 * V_101 , T_1 V_3 )
{
#ifdef F_106
char V_29 [ V_157 ] ;
F_107 ( V_29 , V_23 [ V_3 ] , sizeof( V_29 ) ) ;
...
static int T_9 F_112 ( struct V_101 * V_101 )
{
int V_10 ;
for ( V_10 = 0 ; V_10 < V_169 ; V_10 ++ )
F_113 ( & V_101 -> V_6 . V_120 [ V_10 ] ) ;
return 0 ;
}
...
int V_170 ;
F_50 (i) {
F_115 ( & F_116 ( V_171 , V_10 ) ) ;
}
V_6 = F_94 ( sizeof( struct V_51 ) * V_169 , V_92 ) ;
if ( ! V_6 )
return - V_56 ;
for ( V_10 = 0 ; V_10 < V_169 ; V_10 ++ ) {
F_117 ( & V_6 [ V_10 ] . V_7 ) ;
#ifdef F_118
F_117 ( & V_6 [ V_10 ] . V_102 ) ;
V_6 [ V_10 ] . V_53 = NULL ;
#endif
F_113 ( & V_6 [ V_10 ] . V_2 ) ;
F_113 ( & V_6 [ V_10 ] . V_13 ) ;
