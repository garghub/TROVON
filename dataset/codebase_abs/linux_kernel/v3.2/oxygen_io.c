...
void F_25 ( struct V_1 * V_2 , T_1 V_31 , unsigned int V_17 )
{
unsigned int V_18 ;
V_18 = 10 ;
while ( ( F_1 ( V_2 , V_32 ) & V_33 )
&& V_18 > 0 ) {
F_21 ( 4 ) ;
-- V_18 ;
}
...
void F_26 ( struct V_1 * V_2 , T_1 V_38 , T_1 V_39 , T_1 V_17 )
{
F_27 ( 1 ) ;
F_7 ( V_2 , V_40 , V_39 ) ;
F_7 ( V_2 , V_41 , V_17 ) ;
...
static void F_28 ( struct V_1 * V_2 , unsigned int V_44 , T_1 V_17 )
{
...
void F_30 ( struct V_1 * V_2 , T_1 V_17 )
{
F_28 ( V_2 , 0 , V_17 ) ;
}
T_2 F_31 ( struct V_1 * V_2 , unsigned int V_16 )
{
unsigned int V_49 ;
F_7 ( V_2 , V_50 ,
V_16 | V_51 ) ;
...
void F_32 ( struct V_1 * V_2 , unsigned int V_16 , T_2 V_5 )
{
unsigned int V_49 ;
F_9 ( V_2 , V_54 , V_5 ) ;
F_7 ( V_2 , V_50 ,
