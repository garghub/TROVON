...
{
int V_144 ;
switch ( V_2 -> V_10 -> V_145 . V_146 ) {
case V_147 :
break;
case V_148 :
V_2 -> V_10 -> V_145 . V_149 = 7 ;
V_2 -> V_10 -> V_145 . V_150 = 6 ;
V_2 -> V_10 -> V_145 . V_151 = 8 ;
V_2 -> V_152 . V_153 = V_154 ;
F_60 ( V_2 -> V_10 ) ;
F_61 ( V_2 ) ;
V_144 = V_2 -> V_118 [ V_121 ] ;
F_62 ( V_2 -> V_10 , V_144 ) ;
break;
default:
F_63 ( 1 ) ;
...
V_2 -> V_156 |= V_157 ;
V_10 = F_65 ( sizeof( struct V_53 ) , V_158 ) ;
if ( ! V_10 )
return - V_159 ;
V_10 -> V_160 . V_24 = V_24 ;
V_10 -> V_160 . V_161 = V_25 ;
V_10 -> V_162 |= V_163 ;
V_10 -> V_164 . V_165 = F_27 ;
V_10 -> V_164 . V_166 = F_34 ;
V_10 -> V_164 . V_167 = F_39 ;
V_10 -> V_164 . V_168 = F_40 ;
V_10 -> V_164 . V_169 = F_42 ;
V_10 -> V_164 . V_170 = F_43 ;
V_2 -> V_10 = V_10 ;
V_55 = F_28 ( V_10 ) ;
V_55 -> V_171 = & V_10 -> V_164 ;
V_55 -> V_172 = & V_173 ;
V_55 -> V_10 = V_10 ;
V_55 -> V_12 = V_2 -> V_12 ;
V_55 -> V_2 = V_2 ;
...
F_67 ( & V_2 -> V_178 ) ;
F_67 ( & V_2 -> V_179 ) ;
F_68 ( & V_2 -> V_180 , V_181 ,
( unsigned long ) V_2 ) ;
F_68 ( & V_2 -> V_182 , V_183 ,
( unsigned long ) V_2 ) ;
F_69 ( & V_2 -> V_184 , V_185 ) ;
F_70 ( & V_2 -> V_186 , V_187 ) ;
F_70 ( & V_2 -> V_188 , V_189 ) ;
F_71 ( & V_2 -> F_16 . V_190 , V_191 ,
( unsigned long ) V_2 ) ;
F_72 ( V_55 , & V_79 ) ;
V_55 -> V_192 = V_79 << 2 ;
V_26 = F_73 ( V_10 ) ;
...
V_2 -> V_196 . V_197 [ V_67 ] = NULL ;
F_74 ( V_10 ) ;
F_57 ( V_2 ) ;
F_58 ( V_2 ) ;
if ( V_155 && strncmp ( V_155 , V_198 , 5 ) == 0 ) {
V_10 -> V_145 . V_146 = V_148 ;
F_59 ( V_2 ) ;
}
return 0 ;
V_194:
...
if ( V_2 -> V_10 -> V_100 . V_101 & V_126 )
V_12 -> V_13 -> V_225 [ V_128 ] =
& V_2 -> V_127 [ V_128 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_136 )
V_12 -> V_13 -> V_225 [ V_137 ] =
& V_2 -> V_127 [ V_137 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_226 ) {
if ( V_2 -> V_10 -> V_100 . V_101 & V_126 )
F_49 ( V_2 ,
& V_2 -> V_127 [ V_128 ] . V_227 ) ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_136 )
F_49 ( V_2 ,
& V_2 -> V_127 [ V_137 ] . V_227 ) ;
}
F_77 ( V_12 , V_55 -> V_228 ) ;
}
...
if ( V_26 )
return - V_125 ;
V_2 -> V_232 = F_80 ( V_230 . V_233 ) ;
V_2 -> V_234 = F_80 ( V_230 . V_235 ) ;
snprintf ( V_12 -> V_13 -> V_236 , V_237 , L_16 ,
V_2 -> V_232 ,
V_2 -> V_234 ) ;
F_22 ( V_2 -> V_8 , L_17 ,
V_2 -> V_232 ,
...
struct V_240 * V_57 ;
char V_241 [ 64 ] ;
error = F_64 ( V_2 , V_24 , V_155 , V_25 ) ;
if ( error != 0 )
goto V_242;
V_10 = V_2 -> V_10 ;
V_55 = F_28 ( V_10 ) ;
...
if ( error != 0 )
goto V_243;
error = F_82 ( & V_55 -> V_244 , V_2 -> V_12 -> V_13 ,
F_23 ) ;
if ( error )
goto V_245;
V_57 = & V_55 -> V_244 ;
...
goto V_252;
if ( ! F_88 ( V_57 ) ) {
error = F_89 ( V_12 -> V_13 , V_57 -> V_253 ) ;
if ( error )
goto V_254;
}
error = F_90 ( V_2 -> V_10 ) ;
...
V_2 -> V_45 ,
V_2 -> V_47 ) ;
F_91 ( V_2 -> V_10 , V_241 , sizeof( V_241 ) ) ;
F_92 ( V_12 -> V_13 , L_22 , V_241 ) ;
F_93 ( V_2 ) ;
F_94 ( V_2 ) ;
return 0 ;
V_254:
...
int F_95 ( struct V_255 * V_256 , struct V_257 * V_8 ,
T_1 V_24 , char * V_155 , T_2 V_25 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_26 ;
V_12 = F_96 ( sizeof( struct V_1 ) , & V_258 ) ;
if ( ! V_12 )
return - V_159 ;
V_2 = V_12 -> V_2 ;
V_2 -> V_12 = V_12 ;
...
void F_101 ( struct V_255 * V_256 , bool V_261 )
{
if ( V_256 -> V_259 ) {
if ( V_261 )
V_256 -> V_259 -> V_10 -> V_162 |= V_262 ;
F_9 ( V_256 -> V_259 ) ;
F_99 ( V_256 -> V_259 ) ;
F_100 ( V_256 -> V_259 -> V_12 ) ;
}
}
void F_102 ( struct V_255 * V_256 )
{
F_103 ( V_256 -> V_259 , V_263 ) ;
}
int F_104 ( struct V_255 * V_256 )
{
...
if ( V_26 )
return V_26 ;
V_26 = F_18 ( V_2 , V_2 -> V_10 -> V_160 . V_24 ,
V_2 -> V_10 -> V_160 . V_161 ) ;
return V_26 ;
}
