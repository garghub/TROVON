...
F_20 ( & V_51 -> V_115 ) ;
F_55 ( V_51 , V_124 ) ;
if ( V_51 -> V_63 -> V_39 -> V_125 )
V_51 -> V_63 -> V_39 -> V_125 ( V_51 ) ;
F_89 ( V_28 ) ;
V_51 -> V_73 -> V_126 = NULL ;
F_90 ( V_51 -> V_73 ) ;
F_20 ( V_28 ) ;
}
...
static int F_98 ( struct V_27 * V_28 , void * V_129 )
{
if ( F_99 ( V_28 ) )
F_93 ( F_23 ( V_28 ) ) ;
return 0 ;
}
void F_100 ( struct V_27 * V_28 )
{
if ( F_99 ( V_28 ) ) {
F_93 ( F_23 ( V_28 ) ) ;
return;
...
F_101 ( V_28 ) ;
F_102 ( V_28 , NULL , F_98 ) ;
F_20 ( V_28 ) ;
}
int F_103 ( struct V_76 * V_130 )
{
V_130 -> V_131 = & V_85 ;
return F_104 ( V_130 ) ;
}
int F_105 ( struct V_132 * V_133 )
{
V_133 -> V_134 = & V_86 ;
return F_106 ( V_133 ) ;
}
int F_107 ( struct V_13 * V_14 )
{
int error , V_3 ;
if ( V_14 -> V_39 -> V_135 ) {
for ( V_3 = 0 ; V_14 -> V_39 -> V_135 [ V_3 ] ; V_3 ++ ) {
error = F_83 ( & V_14 -> V_136 ,
V_14 -> V_39 -> V_135 [ V_3 ] ) ;
if ( error )
return error ;
}
...
V_51 -> V_52 . type = & V_78 ;
F_111 ( & V_51 -> V_52 , L_24 ,
V_51 -> V_63 -> V_138 , V_51 -> V_20 , V_51 -> V_21 , V_51 -> V_22 ) ;
F_110 ( & V_51 -> V_115 ) ;
V_51 -> V_115 . V_55 = F_101 ( & V_51 -> V_52 ) ;
V_51 -> V_115 . V_134 = & V_86 ;
F_111 ( & V_51 -> V_115 , L_24 ,
V_51 -> V_63 -> V_138 , V_51 -> V_20 , V_51 -> V_21 , V_51 -> V_22 ) ;
V_51 -> V_139 = V_57 -> V_139 ;
F_112 ( & V_51 -> V_52 ) ;
F_24 ( V_14 -> V_64 , V_61 ) ;
F_113 ( & V_51 -> V_67 , & V_57 -> V_140 ) ;
F_113 ( & V_51 -> V_66 , & V_14 -> V_141 ) ;
F_26 ( V_14 -> V_64 , V_61 ) ;
}
int F_114 ( const struct V_27 * V_28 )
{
