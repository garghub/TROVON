...
for ( V_48 = 0 ; V_48 < V_112 ; V_48 ++ ) {
if ( V_2 -> V_62 == V_63 ) {
V_114 [ V_48 ] . V_54 [ 0 ] . V_116 [ 0 ] . V_117 . V_118 . V_119 . V_120
= F_32 ;
V_64 . V_65 = 0 ;
} else {
V_114 [ V_48 ] . V_54 [ 0 ] . V_116 [ 0 ] . V_117 . V_118 . V_119 . V_120
...
for ( V_48 = 0 ; V_48 < V_114 [ 0 ] . V_122 ; V_48 ++ ) {
if ( V_48 == 1 )
V_110 = V_123 ;
V_4 . V_15 = V_124 + V_110 ;
V_6 = F_1 ( V_2 , & V_4 ) ;
if ( V_6 )
goto error;
switch ( V_37 ) {
case 0 :
V_41 [ V_48 ] . V_125 = 28800 ;
break;
case 1 :
V_41 [ V_48 ] . V_125 = 20480 ;
break;
case 2 :
V_41 [ V_48 ] . V_125 = 28000 ;
break;
case 3 :
V_41 [ V_48 ] . V_125 = 25000 ;
break;
} ;
F_27 ( L_27 , V_61 , V_48 ,
V_37 , V_41 [ V_48 ] . V_125 ) ;
V_4 . V_15 = V_126 + V_110 ;
V_6 = F_1 ( V_2 , & V_4 ) ;
if ( V_6 )
goto error;
V_41 [ V_48 ] . V_127 = V_37 << 8 ;
V_4 . V_15 = V_128 + V_110 ;
V_6 = F_1 ( V_2 , & V_4 ) ;
if ( V_6 )
goto error;
V_41 [ V_48 ] . V_127 += V_37 ;
F_27 ( L_28 , V_61 , V_48 ,
V_41 [ 0 ] . V_127 ) ;
V_4 . V_15 = V_129 + V_110 ;
V_6 = F_1 ( V_2 , & V_4 ) ;
if ( V_6 )
goto error;
V_64 . V_130 [ V_48 ] = V_37 << 8 ;
V_4 . V_15 = V_131 + V_110 ;
V_6 = F_1 ( V_2 , & V_4 ) ;
if ( V_6 )
goto error;
V_64 . V_130 [ V_48 ] += V_37 ;
F_27 ( L_29 , V_61 , V_48 ,
V_64 . V_130 [ V_48 ] ) ;
V_4 . V_15 = V_132 + V_110 ;
V_6 = F_1 ( V_2 , & V_4 ) ;
if ( V_6 )
goto error;
switch ( V_37 ) {
...
V_41 [ V_48 ] . V_150 = V_37 ;
F_27 ( L_31 , V_61 , V_48 , V_37 ) ;
}
error:
if ( V_6 )
F_6 ( L_32 , V_6 ) ;
if ( F_51 ( V_2 -> V_96 . V_97 ) == V_151 &&
( ( F_51 ( V_2 -> V_96 . V_98 ) ==
V_152 ) ||
( F_51 ( V_2 -> V_96 . V_98 ) ==
V_153 ) ) ) {
...
int V_6 ;
T_1 V_157 ;
struct V_3 V_4 = { V_19 , 0 , 0 , 0 , 0 , 1 , & V_157 } ;
V_6 = F_1 ( V_2 , & V_4 ) ;
if ( V_6 )
return V_6 ;
F_27 ( L_34 , V_61 , V_157 ) ;
if ( V_157 == 0x02 )
* V_156 = 0 ;
else
* V_156 = 1 ;
...
return V_6 ;
if ( ( V_159 -> V_160 != V_7 [ 6 ] || V_7 [ 0 ] ) &&
! memcmp ( & V_7 [ 12 ] , V_159 -> V_161 , 4 ) ) {
F_57 ( L_35 , V_61 ) ;
F_58 ( V_36 -> V_162 , V_159 -> V_163 , 0 ) ;
V_159 -> V_160 = V_7 [ 6 ] ;
return V_6 ;
}
...
if ( V_6 )
goto error;
memcpy ( V_159 -> V_161 , & V_7 [ 12 ] , 4 ) ;
if ( V_7 [ 14 ] == ( T_1 ) ~ V_7 [ 15 ] ) {
if ( V_7 [ 12 ] == ( T_1 ) ~ V_7 [ 13 ] ) {
V_159 -> V_163 = V_7 [ 12 ] << 8 | V_7 [ 14 ] ;
} else {
V_159 -> V_163 = V_7 [ 12 ] << 16 |
V_7 [ 13 ] << 8 | V_7 [ 14 ] ;
}
} else {
V_159 -> V_163 = V_7 [ 12 ] << 24 | V_7 [ 13 ] << 16 |
V_7 [ 14 ] << 8 | V_7 [ 15 ] ;
}
F_58 ( V_36 -> V_162 , V_159 -> V_163 , 0 ) ;
} else {
F_57 ( L_37 , V_61 ) ;
V_159 -> V_161 [ 2 ] = V_159 -> V_161 [ 3 ] ;
}
V_159 -> V_160 = V_7 [ 6 ] ;
error:
if ( V_6 )
...
V_44 -> V_164 [ 0 ] . V_116 = F_60 ( V_165 , & V_41 [ V_44 -> V_89 ] ,
& V_44 -> V_80 -> V_166 ) ;
return V_44 -> V_164 [ 0 ] . V_116 == NULL ? - V_149 : 0 ;
}
static int F_61 ( struct V_78 * V_44 )
{
int V_6 ;
F_27 ( L_10 , V_61 ) ;
switch ( V_41 [ V_44 -> V_89 ] . V_150 ) {
case V_134 :
case V_137 :
V_6 = F_60 ( V_167 , V_44 -> V_164 [ 0 ] . V_116 , & V_44 -> V_80 -> V_166 ,
& V_168 ,
V_64 . V_130 [ V_44 -> V_89 ] )
== NULL ? - V_149 : 0 ;
break;
case V_135 :
case V_139 :
V_6 = F_60 ( V_169 , V_44 -> V_164 [ 0 ] . V_116 , & V_44 -> V_80 -> V_166 ,
& V_170 ) == NULL ? - V_149 : 0 ;
break;
case V_138 :
V_6 = F_60 ( V_171 , V_44 -> V_164 [ 0 ] . V_116 , 0xc0 ,
& V_44 -> V_80 -> V_166 ,
& V_172 ) == NULL ? - V_149 : 0 ;
break;
case V_140 :
V_6 = F_60 ( V_173 , V_44 -> V_164 [ 0 ] . V_116 ,
& V_44 -> V_80 -> V_166 ,
& V_174 ) == NULL ? - V_149 : 0 ;
break;
case V_142 :
V_6 = F_60 ( V_175 , V_44 -> V_164 [ 0 ] . V_116 ,
& V_44 -> V_80 -> V_166 ,
& V_176 ) == NULL ? - V_149 : 0 ;
break;
case V_143 :
...
break;
case V_133 :
V_6 = F_60 ( V_178 , V_44 -> V_164 [ 0 ] . V_116 , 0xc0 ,
& V_44 -> V_80 -> V_166 ,
V_179 ) == NULL ? - V_149 : 0 ;
break;
case V_146 :
V_6 = F_60 ( V_180 , V_44 -> V_164 [ 0 ] . V_116 ,
& V_44 -> V_80 -> V_166 ,
& V_181 ) == NULL ? - V_149 : 0 ;
break;
case V_145 :
V_6 = F_60 ( V_182 , V_44 -> V_164 [ 0 ] . V_116 ,
& V_44 -> V_80 -> V_166 ,
0xc0 , & V_183 ) == NULL ? - V_149 : 0 ;
break;
case V_136 :
default:
V_6 = - V_149 ;
F_6 ( L_41 ,
V_41 [ V_44 -> V_89 ] . V_150 ) ;
}
return V_6 ;
}
static int F_62 ( struct V_184 * V_185 ,
const struct V_186 * V_89 )
{
int V_6 = 0 ;
struct V_35 * V_36 = NULL ;
struct V_1 * V_2 = F_63 ( V_185 ) ;
T_1 V_48 ;
F_27 ( L_42 , V_61 ,
V_185 -> V_187 -> V_155 . V_188 ) ;
if ( V_185 -> V_187 -> V_155 . V_188 == 0 ) {
V_6 = F_53 ( V_2 ) ;
if ( V_6 )
return V_6 ;
for ( V_48 = 0 ; V_48 < V_112 ; V_48 ++ ) {
V_6 = F_64 ( V_185 , & V_114 [ V_48 ] ,
V_189 , & V_36 , V_190 ) ;
if ( ! V_6 )
break;
if ( V_6 != - V_149 )
