...
struct V_44 * V_44 , const T_2 V_45 [] )
{
struct V_11 V_46 , * V_11 ;
struct V_44 * V_47 ;
struct V_1 * V_48 ;
struct V_7 * V_49 , * V_50 ;
int V_51 = sizeof( * V_11 ) ;
int V_52 = sizeof( * V_49 ) ;
...
V_11 -> V_21 = V_22 ;
V_11 -> V_57 = V_71 ;
memcpy ( V_11 -> V_72 , V_34 -> V_38 , V_63 ) ;
V_11 -> V_73 =
( T_2 ) F_42 ( & V_34 -> V_74 ) ;
if ( F_42 ( & V_32 -> V_75 ) &&
V_53 + sizeof( * V_11 ) >
