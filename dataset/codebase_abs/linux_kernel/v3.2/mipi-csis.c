...
for ( V_8 = 0 ; V_8 < V_98 ; V_8 ++ )
V_11 -> V_99 [ V_8 ] . V_100 = V_101 [ V_8 ] ;
V_49 = F_50 ( & V_34 -> V_35 , V_98 ,
V_11 -> V_99 ) ;
if ( V_49 )
goto V_97;
V_49 = F_51 ( V_11 -> V_74 , F_38 , 0 ,
F_52 ( & V_34 -> V_35 ) , V_11 ) ;
if ( V_49 ) {
F_21 ( & V_34 -> V_35 , L_11 ) ;
goto V_102;
...
F_53 ( & V_11 -> V_4 , & V_103 ) ;
V_11 -> V_4 . V_104 = V_105 ;
F_54 ( V_11 -> V_4 . V_91 , F_52 ( & V_34 -> V_35 ) , sizeof( V_11 -> V_4 . V_91 ) ) ;
V_11 -> V_27 = & V_9 [ 0 ] ;
V_11 -> V_106 [ V_72 ] . V_51 = V_107 ;
V_11 -> V_106 [ V_71 ] . V_51 = V_108 ;
V_49 = F_55 ( & V_11 -> V_4 . V_109 ,
V_110 , V_11 -> V_106 , 0 ) ;
if ( V_49 < 0 )
goto V_111;
F_56 ( & V_11 -> V_4 , V_34 ) ;
...
F_60 ( V_98 , V_11 -> V_99 ) ;
V_97:
F_61 ( V_11 -> clock [ V_95 ] ) ;
F_15 ( V_11 ) ;
V_94:
F_62 ( V_11 -> V_92 ) ;
V_93:
F_63 ( V_81 -> V_90 , F_44 ( V_81 ) ) ;
V_85:
F_64 ( V_11 ) ;
return V_49 ;
}
static int F_65 ( struct V_45 * V_35 , bool V_112 )
{
struct V_32 * V_33 = V_35 -> V_36 ;
struct V_78 * V_34 = F_66 ( V_35 ) ;
struct V_2 * V_4 = F_67 ( V_34 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
int V_49 = 0 ;
...
static int F_69 ( struct V_45 * V_35 , bool V_112 )
{
struct V_32 * V_33 = V_35 -> V_36 ;
struct V_78 * V_34 = F_66 ( V_35 ) ;
struct V_2 * V_4 = F_67 ( V_34 ) ;
...
{
return F_65 ( V_35 , false ) ;
}
static int F_72 ( struct V_45 * V_35 )
{
return F_69 ( V_35 , false ) ;
}
static int F_73 ( struct V_45 * V_35 )
{
return F_65 ( V_35 , true ) ;
}
static int F_74 ( struct V_45 * V_35 )
{
return F_69 ( V_35 , true ) ;
}
static int T_4 F_75 ( struct V_78 * V_34 )
{
struct V_2 * V_4 = F_67 ( V_34 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
struct V_79 * V_116 = V_11 -> V_81 ;
F_76 ( & V_34 -> V_35 ) ;
F_71 ( & V_34 -> V_35 ) ;
F_61 ( V_11 -> clock [ V_95 ] ) ;
F_77 ( & V_34 -> V_35 ) ;
...
F_59 ( V_11 -> V_74 , V_11 ) ;
F_62 ( V_11 -> V_92 ) ;
F_63 ( V_116 -> V_90 , F_44 ( V_116 ) ) ;
F_64 ( V_11 ) ;
return 0 ;
}
static int T_5 F_79 ( void )
{
return F_80 ( & V_117 , F_39 ) ;
}
