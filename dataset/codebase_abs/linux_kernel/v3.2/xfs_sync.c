...
{
int error = 0 ;
while ( F_60 ( & V_14 -> V_56 ) > 0 )
F_19 ( 100 ) ;
F_57 ( V_14 ) ;
F_61 ( F_60 ( & V_14 -> V_56 ) != 0 ) ;
error = F_62 ( V_14 ) ;
if ( error )
F_63 ( V_14 , L_1
L_2 ) ;
...
struct V_60 * V_61 )
{
struct V_13 * V_14 = F_70 ( F_71 ( V_61 ) ,
struct V_13 , V_58 ) ;
int error ;
if ( ! ( V_14 -> V_62 & V_63 ) ) {
...
V_30 = 0 ;
V_20 = 0 ;
while ( ( V_16 = F_107 ( V_14 , V_30 , V_71 ) ) ) {
...
if ( ! V_24 [ V_26 ] )
continue;
error = F_96 ( V_24 [ V_26 ] , V_16 , V_17 ) ;
if ( error && V_19 != V_11 )
V_19 = error ;
}
* V_85 -= V_25 ;
