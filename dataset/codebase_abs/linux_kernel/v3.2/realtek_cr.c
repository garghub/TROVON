...
int V_57 ;
T_1 V_6 [ 16 ] ;
V_57 = F_14 ( V_2 , V_3 , V_6 , 16 , & ( V_66 -> V_68 ) ) ;
if ( V_57 < 0 )
return - V_61 ;
F_4 ( L_5 , V_66 -> V_68 ) ;
...
static int F_17 ( struct V_1 * V_2 , T_1 * V_55 , T_2 V_56 )
{
int V_57 ;
T_2 V_54 = 0xFE47 ;
T_1 V_58 [ 12 ] = { 0 } ;
F_4 ( L_3 , V_83 , V_54 , V_56 ) ;
V_58 [ 0 ] = 0xF0 ;
V_58 [ 1 ] = 0x0E ;
V_58 [ 2 ] = ( T_1 ) ( V_54 >> 8 ) ;
V_58 [ 3 ] = ( T_1 ) V_54 ;
...
static int F_18 ( struct V_1 * V_2 , int V_84 , int V_85 )
{
int V_57 ;
T_1 V_82 ;
...
if ( F_23 ( V_66 , 0x0138 , 0x3882 ) )
F_21 ( V_82 , 2 ) ;
if ( F_23 ( V_66 , 0x0159 , 0x5889 ) ||
F_23 ( V_66 , 0x0138 , 0x3880 ) ) {
F_21 ( V_82 , 0 ) ;
F_21 ( V_82 , 7 ) ;
}
V_57 = F_17 ( V_2 , & V_82 , 1 ) ;
...
T_1 V_87 ;
F_4 ( L_7 , V_60 ) ;
if ( ( F_26 ( V_66 ) != 0x0158 ) || ( F_27 ( V_66 ) != 0x5895 ) ) {
F_4 ( L_9 ) ;
} else {
...
{
F_4 ( L_14 , V_60 , F_30 ( V_66 ) ) ;
V_66 -> V_89 = V_90 + F_31 ( 1000 * V_91 ) ;
F_32 ( & V_66 -> V_92 , V_66 -> V_89 ) ;
F_4 ( L_8 , V_60 ) ;
}
...
L_16 , V_60 ,
F_34 ( & V_2 -> V_97 -> V_98 ) ,
F_34 ( & V_2 -> V_97 -> V_99 . V_100 . V_101 ) ) ;
if ( F_34 ( & V_2 -> V_97 -> V_98 ) > 0 ) {
F_4 ( L_17 ,
V_60 ) ;
F_35 ( V_66 , V_96 ) ;
F_36 ( & V_2 -> V_97 -> V_99 , true ) ;
F_37 ( V_2 -> V_97 ) ;
F_4 ( L_18
L_19 ,
V_60 ,
...
static inline int F_38 ( struct V_102 * V_103 )
{
...
void F_39 ( struct V_102 * V_103 , struct V_1 * V_2 )
{
struct V_65 * V_66 = (struct V_65 * ) ( V_2 -> V_67 ) ;
static int V_106 = 1 ;
...
V_66 -> V_123 = 0 ;
F_35 ( V_66 , V_93 ) ;
V_57 = F_14 ( V_2 , 0 , V_6 , 16 , & ( V_66 -> V_68 ) ) ;
if ( V_57 != V_88 ) {
F_4 ( L_28 ) ;
return - V_61 ;
}
...
int F_51 ( struct V_126 * V_127 , T_3 V_128 )
{
...
V_66 = F_57 ( sizeof( struct V_65 ) , V_132 ) ;
if ( ! V_66 )
return - V_133 ;
V_2 -> V_67 = V_66 ;
V_2 -> V_134 = F_48 ;
...
V_66 -> V_63 = F_57 ( V_130 , V_132 ) ;
if ( ! V_66 -> V_63 )
goto V_136;
for ( V_131 = 0 ; V_131 <= ( int ) ( V_66 -> V_135 ) ; V_131 ++ ) {
V_57 = F_15 ( V_2 , ( T_1 ) V_131 ) ;
if ( V_57 < 0 )
goto V_136;
}
if ( F_58 ( V_66 , 0x5888 ) || F_58 ( V_66 , 0x5889 ) ||
F_58 ( V_66 , 0x5901 ) )
F_59 ( V_66 ) ;
if ( F_60 ( V_66 ) == 16 ) {
if ( F_61 ( V_66 ) )
