...
F_82 ( V_104 , L_35 , V_81 -> V_6 , V_133 ) ;
F_38 ( V_2 , V_58 ) ;
if ( V_2 -> V_163 != V_167 ) {
F_38 ( V_2 , V_26 ) ;
...
F_95 ( V_133 ) ;
V_162:
F_96 ( V_2 -> V_10 -> V_19 , V_81 ) ;
V_160:
F_97 ( V_2 -> V_10 ) ;
V_158:
V_157:
while ( -- V_136 >= 0 )
F_98 ( V_2 -> V_156 [ V_136 ] ) ;
V_154:
while ( -- V_40 >= 0 ) {
...
static int T_6 F_103 ( struct V_127 * V_104 )
{
struct V_80 * V_81 = F_104 ( V_104 ) ;
struct V_1 * V_2 = F_47 ( V_81 ) ;
int V_40 ;
int V_136 ;
F_105 ( V_81 ) ;
...
static int T_6 F_108 ( struct V_125 * V_126 )
{
return F_103 ( & V_126 -> V_104 ) ;
}
