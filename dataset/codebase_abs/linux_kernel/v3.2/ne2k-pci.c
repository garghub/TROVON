...
strcpy ( V_118 -> V_121 , V_24 ) ;
strcpy ( V_118 -> V_20 , V_122 ) ;
strcpy ( V_118 -> V_123 , F_43 ( V_1 ) ) ;
}
static void T_3 F_44 ( struct V_1 * V_2 )
{
...
static int F_49 ( struct V_1 * V_2 , T_4 V_124 )
{
struct V_5 * V_6 = F_45 ( V_2 ) ;
F_50 ( V_6 ) ;
F_51 ( V_2 ) ;
F_48 ( V_2 ) ;
F_52 ( V_2 , F_53 ( V_2 , V_124 ) ) ;
return 0 ;
}
