...
if ( ! V_44 )
return - V_59 ;
V_5 -> V_4 . V_60 = F_23 ( V_61 , L_3 , ( V_62 ) V_42 -> V_63 ,
V_44 -> V_60 ) ;
if ( ! V_5 -> V_4 . V_60 ) {
V_43 = - V_64 ;
goto V_65;
...
static int T_3 F_28 ( struct V_67 * V_68 )
{
struct V_1 * V_5 ;
struct V_41 V_42 ;
const T_4 * V_69 ;
...
if ( ! V_5 )
return - V_64 ;
V_43 = F_30 ( V_68 -> V_8 . V_66 , 0 , & V_42 ) ;
if ( V_43 ) {
F_8 ( & V_68 -> V_8 , L_4 ) ;
goto V_71;
}
V_43 = F_31 ( V_42 . V_63 , & V_5 -> V_17 ) ;
if ( V_43 ) {
F_8 ( & V_68 -> V_8 , L_5 ) ;
goto V_71;
}
V_69 = F_32 ( V_68 -> V_8 . V_66 , L_6 ,
& V_70 ) ;
if ( ! V_69 || V_70 != sizeof( V_72 ) ) {
F_8 ( & V_68 -> V_8 , L_7 ) ;
V_43 = - V_73 ;
goto V_71;
}
V_5 -> V_22 = * V_69 ;
V_69 = F_32 ( V_68 -> V_8 . V_66 , L_8 , & V_70 ) ;
if ( ! V_69 || V_70 != sizeof( V_72 ) ) {
F_8 ( & V_68 -> V_8 , L_9 ) ;
V_43 = - V_73 ;
goto V_71;
...
V_5 -> V_23 = * V_69 ;
V_69 = F_32 ( V_68 -> V_8 . V_66 ,
L_10 , & V_70 ) ;
if ( V_69 && ( V_70 / sizeof( V_72 ) ) > 0 ) {
V_5 -> V_54 = V_70 / sizeof( V_72 ) ;
if ( V_5 -> V_54 >= V_31 ) {
F_8 ( & V_68 -> V_8 , L_11 ) ;
goto V_71;
}
for ( V_36 = 0 ; V_36 < V_5 -> V_54 ; V_36 ++ )
V_5 -> V_25 [ V_36 ] = F_33 ( V_69 [ V_36 ] ) ;
} else {
V_5 -> V_54 = 1 ;
}
for ( V_36 = 0 ; V_36 < V_5 -> V_54 ; V_36 ++ ) {
V_5 -> V_6 [ V_36 ] = - 1 ;
V_6 = F_34 ( V_68 -> V_8 . V_66 , V_36 ) ;
if ( V_6 >= 0 ) {
V_43 = F_35 ( V_6 , F_36 ( & V_68 -> V_8 ) ) ;
if ( V_43 ) {
F_8 ( & V_68 -> V_8 ,
L_12 , V_36 ) ;
goto V_74;
...
F_8 ( & V_68 -> V_8 , L_13 , V_36 ) ;
goto V_74;
}
}
V_69 = F_32 ( V_68 -> V_8 . V_66 , L_14 , NULL ) ;
if ( V_69 )
V_5 -> V_47 = F_38 ( V_69 ) ;
else
V_5 -> V_47 = 50 ;
V_69 = F_32 ( V_68 -> V_8 . V_66 , L_15 , & V_70 ) ;
if ( V_69 && V_70 == sizeof( V_72 ) )
V_5 -> V_27 = F_38 ( V_69 ) ;
else
V_5 -> V_27 = V_28 |
V_37 ;
V_5 -> V_32 = F_39 ( & V_68 -> V_8 , V_42 . V_63 ,
F_40 ( & V_42 ) ) ;
if ( ! V_5 -> V_32 ) {
V_43 = - V_64 ;
goto V_74;
...
V_5 -> V_8 = & V_68 -> V_8 ;
V_5 -> V_16 = V_20 ;
V_43 = F_21 ( V_5 , V_68 -> V_8 . V_66 , & V_42 ) ;
if ( V_43 )
goto V_74;
F_41 ( & V_68 -> V_8 , V_5 ) ;
return 0 ;
...
static int T_5 F_43 ( struct V_67 * V_68 )
{
struct V_1 * V_5 = F_44 ( & V_68 -> V_8 ) ;
int V_36 ;
F_45 ( & V_5 -> V_4 ) ;
F_27 ( V_5 -> V_4 . V_60 ) ;
for ( V_36 = 0 ; V_36 < V_5 -> V_54 ; V_36 ++ ) {
