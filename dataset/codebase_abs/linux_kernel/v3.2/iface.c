...
struct V_114 * V_115 =
F_61 ( V_6 -> V_37 . V_38 . V_116 ) ;
F_29 ( V_6 ,
V_117 ) ;
F_62 ( V_6 -> V_37 . V_38 . V_116 , NULL ) ;
F_63 () ;
F_64 ( V_115 ) ;
F_65 (vlan, tmpsdata, &sdata->u.ap.vlans,
u.vlan.list)
F_66 ( V_60 -> V_2 ) ;
F_18 ( ! F_67 ( & V_6 -> V_37 . V_38 . V_62 ) ) ;
V_30 -> V_118 -= F_68 ( & V_6 -> V_37 . V_38 . V_119 ) ;
F_69 ( & V_6 -> V_37 . V_38 . V_119 ) ;
}
if ( V_99 )
V_30 -> V_68 -- ;
switch ( V_6 -> V_7 . type ) {
...
V_162 = ( void * ) & V_101 -> V_169 ;
F_106 ( & V_6 -> V_7 , V_162 -> V_170 ,
V_162 -> V_171 ) ;
} else if ( F_107 ( V_166 -> V_150 ) &&
V_166 -> V_37 . V_173 . V_174 == V_175 ) {
int V_148 = V_101 -> V_148 ;
F_37 ( & V_30 -> V_176 ) ;
V_53 = F_108 ( V_6 , V_166 -> V_16 ) ;
if ( V_53 ) {
...
V_6 -> V_2 -> V_156 = & V_157 ;
V_6 -> V_189 . V_28 = type ;
V_6 -> V_190 = F_122 ( V_191 ) ;
V_6 -> V_192 = false ;
V_6 -> V_2 -> type = V_193 ;
F_123 ( & V_6 -> V_121 ) ;
F_124 ( & V_6 -> V_120 , F_101 ) ;
switch ( type ) {
case V_67 :
type = V_24 ;
V_6 -> V_7 . type = type ;
V_6 -> V_7 . V_188 = true ;
case V_24 :
F_123 ( & V_6 -> V_37 . V_38 . V_119 ) ;
F_125 ( & V_6 -> V_37 . V_38 . V_62 ) ;
break;
case V_66 :
type = V_63 ;
V_6 -> V_7 . type = type ;
...
F_48 ( V_6 , false ) ;
F_86 ( V_6 -> V_2 ) ;
V_17 = F_132 ( V_30 , V_6 , V_198 , V_188 ) ;
if ( V_17 )
type = V_6 -> V_7 . type ;
F_121 ( V_6 , type ) ;
...
if ( F_137 ( V_210 ) + F_138 ( V_210 ) != F_139 ( V_210 ) ) {
F_4 ( V_11 L_5 ) ;
break;
}
...
int F_140 ( struct V_29 * V_30 , const char * V_12 ,
...
int V_17 , V_103 ;
F_10 () ;
V_32 = F_141 ( sizeof( * V_6 ) + V_30 -> V_74 . V_224 ,
V_12 , F_99 , V_30 -> V_74 . V_147 , 1 ) ;
if ( ! V_32 )
return - V_90 ;
F_142 ( V_32 , F_143 ( V_30 -> V_74 . V_75 ) ) ;
...
+ V_228 ;
V_32 -> V_229 = V_230 ;
V_17 = F_144 ( V_32 , V_32 -> V_12 ) ;
if ( V_17 < 0 )
goto V_231;
F_136 ( V_30 , V_32 , type ) ;
memcpy ( V_32 -> V_34 , V_32 -> V_76 , V_20 ) ;
F_145 ( V_32 , F_146 ( V_30 -> V_74 . V_75 ) ) ;
V_6 = F_147 ( V_32 ) ;
...
void F_155 ( struct V_29 * V_30 )
{
struct V_5 * V_6 , * V_102 ;
F_156 ( V_243 ) ;
F_10 () ;
F_37 ( & V_30 -> V_218 ) ;
F_65 (sdata, tmp, &local->interfaces, list) {
F_45 ( & V_6 -> V_61 ) ;
if ( F_89 ( & V_6 -> V_7 ) )
F_153 ( V_6 ) ;
F_157 ( V_6 -> V_2 , & V_243 ) ;
...
return 0 ;
#ifdef F_3
F_160 ( V_30 -> V_74 . V_75 , L_6 , V_244 ) ;
#endif
V_30 -> V_74 . V_81 . V_40 &= ~ V_245 ;
return V_246 ;
}
static T_1 F_161 ( struct V_29 * V_30 )
{
if ( V_30 -> V_74 . V_81 . V_40 & V_245 )
return 0 ;
#ifdef F_3
F_160 ( V_30 -> V_74 . V_75 , L_7 ) ;
#endif
F_162 ( V_30 , false ) ;
V_30 -> V_74 . V_81 . V_40 |= V_245 ;
return V_246 ;
}
T_1 F_38 ( struct V_29 * V_30 )
{
struct V_5 * V_6 ;
int V_247 = 0 ;
...
if ( V_249 )
return F_159 ( V_30 , L_8 ) ;
if ( V_248 )
return F_159 ( V_30 , L_9 ) ;
if ( V_163 )
return F_159 ( V_30 , L_10 ) ;
if ( ! V_247 )
return F_161 ( V_30 ) ;
else
return F_159 ( V_30 , L_11 ) ;
return 0 ;
}
void F_167 ( struct V_29 * V_30 )
{
T_1 V_264 ;
F_37 ( & V_30 -> V_218 ) ;
V_264 = F_38 ( V_30 ) ;
...
static int F_168 ( struct V_265 * V_266 ,
unsigned long V_88 ,
void * V_32 )
{
struct V_1 * V_2 = V_32 ;
