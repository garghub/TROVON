...
struct V_60 * V_60 = F_14 ( V_6 ) ;
int V_59 ;
F_11 ( V_109 L_3 , V_110 ) ;
V_59 = F_29 ( V_6 , 7 , 9 , V_60 -> V_111 ) ;
if ( V_59 < 0 ) {
F_30 ( V_6 -> V_112 , L_4 , V_59 ) ;
return V_59 ;
}
F_4 ( V_6 , V_113 , 0 ) ;
F_31 ( V_6 , 0x0A , 0 ) ;
...
struct V_60 * V_60 ;
int V_59 ;
if ( ! F_36 ( V_127 -> V_130 , V_131 ) )
return - V_47 ;
V_60 = F_37 ( sizeof( struct V_60 ) , V_132 ) ;
if ( V_60 == NULL )
return - V_133 ;
F_38 ( V_127 , V_60 ) ;
V_60 -> V_111 = V_134 ;
V_59 = F_39 ( & V_127 -> V_112 ,
& V_135 , & V_136 , 1 ) ;
if ( V_59 < 0 )
F_40 ( V_60 ) ;
return V_59 ;
}
static int T_4 F_41 ( struct V_126 * V_127 )
{
F_42 ( & V_127 -> V_112 ) ;
F_40 ( F_43 ( V_127 ) ) ;
return 0 ;
