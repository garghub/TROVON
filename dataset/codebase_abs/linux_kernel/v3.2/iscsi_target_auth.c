...
F_21 ( & V_56 , ( void * ) & V_24 -> V_66 , strlen ( V_24 -> V_66 ) ) ;
...
if ( type == V_62 )
V_34 = ( unsigned char ) F_24 ( ( char * ) & V_43 [ 2 ] ,
& V_39 , 0 ) ;
else
V_34 = ( unsigned char ) F_24 ( V_43 , & V_39 , 0 ) ;
F_4 ( L_37 , V_34 ) ;
if ( F_16 ( V_36 , L_38 , V_60 ,
V_22 , & type ) < 0 ) {
F_10 ( L_39 ) ;
goto V_61;
}
...
F_20 ( V_52 ) ;
* V_38 = sprintf ( V_37 , L_46 , V_24 -> V_69 ) ;
* V_38 += 1 ;
F_4 ( L_47 , V_24 -> V_69 ) ;
F_5 ( V_42 , V_40 , V_41 ) ;
* V_38 += sprintf ( V_37 + * V_38 , L_48 ,
V_42 ) ;
* V_38 += 1 ;
F_4 ( L_49 , V_42 ) ;
V_57 = 0 ;
