...
F_37 ( L_5 , V_2 -> V_158 ) ;
V_23 = F_38 ( V_2 , sizeof( struct V_151 ) ) ;
if ( V_23 < 0 ) {
F_37 ( L_6 ) ;
return - V_159 ;
}
...
if ( V_161 [ V_11 ] . V_162 != V_150 -> V_163 )
continue;
if ( V_161 [ V_11 ] . V_164 != V_150 -> V_165 )
continue;
if ( V_122 -> V_166 [ 0 ] || V_122 -> V_166 [ 1 ] ) {
if ( V_150 -> V_167 -> V_168 != V_122 -> V_166 [ 0 ] ||
F_40 ( V_150 -> V_169 ) != V_122 -> V_166 [ 1 ] ) {
continue;
}
}
...
F_37 ( L_9 ,
V_150 -> V_167 -> V_168 , F_40 ( V_150 -> V_169 ) ,
F_43 ( V_150 -> V_169 ) , V_13 ) ;
V_2 -> V_13 = V_13 ;
...
static int T_1 F_50 ( struct V_149 * V_2 ,
const struct V_188 * V_189 )
{
return F_51 ( V_2 , V_172 . V_173 ) ;
}
static void T_2 F_52 ( struct V_149 * V_2 )
{
F_53 ( V_2 ) ;
}
