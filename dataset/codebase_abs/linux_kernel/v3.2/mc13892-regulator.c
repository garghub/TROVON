...
F_11 ( V_6 ) ;
V_16 [ V_66 ] . V_67 . V_68 -> V_69
= F_17 ;
V_16 [ V_66 ] . V_67 . V_68 -> V_70
= F_19 ;
for ( V_48 = 0 ; V_48 < V_45 -> V_49 ; V_48 ++ ) {
V_47 = & V_45 -> V_50 [ V_48 ] ;
V_2 -> V_50 [ V_48 ] = F_24 (
& V_16 [ V_47 -> V_14 ] . V_67 ,
& V_41 -> V_42 , V_47 -> V_47 , V_2 ) ;
if ( F_25 ( V_2 -> V_50 [ V_48 ] ) ) {
F_26 ( & V_41 -> V_42 , L_5 ,
V_16 [ V_48 ] . V_67 . V_71 ) ;
V_7 = F_27 ( V_2 -> V_50 [ V_48 ] ) ;
goto V_35;
}
}
F_28 ( V_41 , V_2 ) ;
...
static int T_3 F_31 ( struct V_40 * V_41 )
{
struct V_1 * V_2 = F_32 ( V_41 ) ;
struct V_44 * V_45 =
F_22 ( & V_41 -> V_42 ) ;
int V_48 ;
F_28 ( V_41 , NULL ) ;
