...
V_27 = F_49 ( V_2 , V_2 -> V_66 , V_58 , 0 , V_53 ) ;
if ( V_27 ) {
F_50 ( & V_2 -> V_65 ) ;
goto V_64;
}
...
if ( V_27 )
return V_27 ;
return F_51 ( V_2 , V_26 , V_10 , NULL , 0 , 0 , V_68 ) ;
}
V_40 = F_32 ( V_2 , V_20 ) ;
if ( ! V_40 )
return - V_21 ;
...
int F_57 ( struct V_1 * V_2 , int V_80 , int V_81 ,
struct V_39 * V_40 )
{
...
V_6 = F_36 ( V_40 -> V_6 ) ;
V_10 = F_36 ( V_40 -> V_10 ) ;
F_58 ( L_22 , V_6 , V_10 , V_80 , V_81 ) ;
if ( V_40 -> V_43 == V_74 ) {
V_53 = F_36 ( V_40 -> V_53 ) ;
V_82 = F_54 ( V_53 , V_2 -> V_73 ) ;
} else
V_53 = V_82 =
...
if ( V_40 -> V_43 == V_70 )
V_82 = V_53 =
F_59 ( V_2 , V_2 -> V_66 , V_53 ) ;
F_60 () ;
V_42 = F_41 ( V_56 , V_2 -> V_66 , V_53 ) ;
F_60 () ;
if ( V_53 > 0 ) {
V_40 -> V_77 = 1 ;
V_40 -> V_53 = F_52 ( V_53 ) ;
...
if ( V_53 > 0 ) {
V_27 = F_49 ( V_2 , V_2 -> V_66 , V_81 , 0 , V_82 ) ;
if ( V_27 ) {
if ( V_27 == - V_62 )
V_27 = V_89 ;
goto V_88;
...
int F_62 ( struct V_1 * V_2 , struct V_94 * V_95 )
{
...
V_105 = F_65 ( V_95 , F_66 ( V_2 , V_101 ) ) ;
if ( ! V_105 )
continue;
F_67 (rb, seb, &sv->root, u.rb) {
if ( V_107 -> V_10 >= V_26 -> V_111 )
F_68 ( V_105 , V_107 , & V_95 -> V_113 ) ;
