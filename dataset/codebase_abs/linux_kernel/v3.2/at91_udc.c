...
struct V_10 * V_11 = & V_198 ;
unsigned long V_9 ;
if ( ! V_39 || V_39 != V_11 -> V_39 || ! V_39 -> V_201 )
return - V_94 ;
F_2 ( & V_11 -> V_12 , V_9 ) ;
V_11 -> V_36 = 0 ;
F_23 ( V_11 , V_68 , ~ 0 ) ;
...
static void F_103 ( struct V_202 * V_189 )
{
...
static int T_7 F_105 ( struct V_202 * V_203 )
{
struct V_188 * V_189 = & V_203 -> V_189 ;
struct V_10 * V_11 ;
int V_199 ;
struct V_204 * V_205 ;
if ( ! V_189 -> V_206 ) {
...
if ( ( V_203 -> V_204 [ 0 ] . V_9 != V_208 )
|| ( V_203 -> V_204 [ 1 ] . V_9 != V_209 ) ) {
F_27 ( L_103 ) ;
return - V_174 ;
}
V_205 = F_106 ( V_203 , V_208 , 0 ) ;
if ( ! V_205 )
return - V_210 ;
if ( ! F_107 ( V_205 -> V_211 , F_108 ( V_205 ) , V_33 ) ) {
F_27 ( L_104 ) ;
return - V_200 ;
}
V_11 = & V_198 ;
V_11 -> V_95 . V_189 . V_212 = V_189 ;
V_11 -> V_130 = * (struct V_213 * ) V_189 -> V_206 ;
V_11 -> V_203 = V_203 ;
V_11 -> V_36 = 0 ;
F_109 ( & V_11 -> V_12 ) ;
if ( F_63 () ) {
if ( V_11 -> V_130 . V_135 <= 0 ) {
F_27 ( L_105 ) ;
V_199 = - V_174 ;
goto V_214;
}
V_199 = F_110 ( V_11 -> V_130 . V_135 , L_106 ) ;
if ( V_199 ) {
F_27 ( L_107 ) ;
goto V_214;
}
F_111 ( V_11 -> V_130 . V_135 ,
V_11 -> V_130 . V_131 ) ;
}
if ( F_65 () || F_67 () ) {
V_11 -> V_4 [ 0 ] . V_15 = 64 ;
...
V_11 -> V_123 = F_112 ( V_205 -> V_211 , F_108 ( V_205 ) ) ;
if ( ! V_11 -> V_123 ) {
V_199 = - V_215 ;
goto V_216;
}
F_56 ( V_11 ) ;
V_11 -> V_126 = F_113 ( V_189 , L_108 ) ;
V_11 -> V_127 = F_113 ( V_189 , L_109 ) ;
if ( F_114 ( V_11 -> V_126 ) || F_114 ( V_11 -> V_127 ) ) {
F_27 ( L_110 ) ;
V_199 = - V_174 ;
goto V_217;
}
V_199 = F_115 ( & V_11 -> V_95 . V_189 ) ;
if ( V_199 < 0 ) {
F_116 ( & V_11 -> V_95 . V_189 ) ;
goto V_217;
}
F_59 ( V_11 -> V_126 ) ;
F_23 ( V_11 , V_134 , V_141 ) ;
...
F_61 ( V_11 -> V_126 ) ;
V_11 -> V_218 = F_117 ( V_203 , 0 ) ;
V_199 = F_118 ( V_11 -> V_218 , F_85 ,
0 , V_33 , V_11 ) ;
if ( V_199 < 0 ) {
F_27 ( L_111 , V_11 -> V_218 ) ;
goto V_219;
}
if ( V_11 -> V_130 . V_191 > 0 ) {
V_199 = F_110 ( V_11 -> V_130 . V_191 , L_112 ) ;
if ( V_199 < 0 ) {
F_27 ( L_113 ) ;
goto V_220;
}
F_119 ( V_11 -> V_130 . V_191 ) ;
V_11 -> V_35 = F_93 ( V_11 -> V_130 . V_191 ) ^
V_11 -> V_130 . V_190 ;
if ( V_11 -> V_130 . V_221 ) {
F_120 ( & V_11 -> V_194 , F_92 ) ;
F_121 ( & V_11 -> V_195 , F_96 ,
( unsigned long ) V_11 ) ;
F_95 ( & V_11 -> V_195 ,
V_196 + V_197 ) ;
} else {
if ( F_118 ( V_11 -> V_130 . V_191 , F_89 ,
0 , V_33 , V_11 ) ) {
F_27 ( L_114 ,
V_11 -> V_130 . V_191 ) ;
V_199 = - V_200 ;
...
return 0 ;
V_223:
if ( V_11 -> V_130 . V_191 > 0 && ! V_11 -> V_130 . V_221 )
F_125 ( V_11 -> V_130 . V_191 , V_11 ) ;
V_222:
if ( V_11 -> V_130 . V_191 > 0 )
F_126 ( V_11 -> V_130 . V_191 ) ;
V_220:
F_125 ( V_11 -> V_218 , V_11 ) ;
V_219:
F_127 ( & V_11 -> V_95 . V_189 ) ;
V_217:
F_128 ( V_11 -> V_123 ) ;
V_216:
if ( F_63 () )
F_126 ( V_11 -> V_130 . V_135 ) ;
V_214:
F_129 ( V_205 -> V_211 , F_108 ( V_205 ) ) ;
F_27 ( L_117 , V_33 , V_199 ) ;
return V_199 ;
}
static int T_8 F_130 ( struct V_202 * V_203 )
{
struct V_10 * V_11 = F_104 ( V_203 ) ;
struct V_204 * V_205 ;
unsigned long V_9 ;
F_27 ( L_118 ) ;
F_131 ( & V_11 -> V_95 ) ;
...
static int F_133 ( struct V_202 * V_203 , T_9 V_224 )
{
struct V_10 * V_11 = F_104 ( V_203 ) ;
int V_225 = V_11 -> V_39 && F_134 ( & V_203 -> V_189 ) ;
unsigned long V_9 ;
...
F_136 ( V_11 -> V_218 ) ;
V_11 -> V_226 = V_225 ;
if ( V_11 -> V_130 . V_191 > 0 && ! V_11 -> V_130 . V_221 && V_225 )
F_136 ( V_11 -> V_130 . V_191 ) ;
return 0 ;
}
static int F_137 ( struct V_202 * V_203 )
{
struct V_10 * V_11 = F_104 ( V_203 ) ;
unsigned long V_9 ;
if ( V_11 -> V_130 . V_191 > 0 && ! V_11 -> V_130 . V_221 &&
V_11 -> V_226 )
F_138 ( V_11 -> V_130 . V_191 ) ;
if ( V_11 -> V_226 )
F_138 ( V_11 -> V_218 ) ;
else {
F_2 ( & V_11 -> V_12 , V_9 ) ;
