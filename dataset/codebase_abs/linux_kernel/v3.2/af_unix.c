...
static int F_193 ( struct V_87 * V_11 , int V_139 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
struct V_11 * V_55 ;
...
static int F_194 ( struct V_87 * V_11 , unsigned int V_232 , unsigned long V_233 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
long V_234 = 0 ;
int V_89 ;
...
case V_235 :
V_234 = F_195 ( V_12 ) ;
V_89 = F_196 ( V_234 , ( int V_236 * ) V_233 ) ;
break;
case V_237 :
{
struct V_3 * V_4 ;
...
static unsigned int F_199 ( struct V_239 * V_239 , struct V_87 * V_11 , T_3 * V_49 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
unsigned int V_240 ;
F_200 ( V_239 , F_184 ( V_12 ) , V_49 ) ;
V_240 = 0 ;
if ( V_12 -> V_58 )
V_240 |= V_241 ;
if ( V_12 -> V_71 == V_72 )
...
static unsigned int F_201 ( struct V_239 * V_239 , struct V_87 * V_11 ,
T_3 * V_49 )
{
...
if ( V_55 ) {
if ( F_6 ( V_55 ) != V_12 ) {
F_200 ( V_239 , & F_31 ( V_55 ) -> V_56 , V_49 ) ;
if ( F_8 ( V_55 ) )
V_246 = 0 ;
}
F_60 ( V_55 ) ;
...
static struct V_11 * F_207 ( struct V_252 * V_253 , T_4 V_254 )
{
struct V_255 * V_256 = V_253 -> V_257 ;
T_4 V_258 = 0 ;
struct V_11 * V_16 ;
for ( V_16 = F_202 ( & V_256 -> V_41 ) ; V_16 ; V_16 = F_205 ( & V_256 -> V_41 , V_16 ) ) {
if ( F_33 ( V_16 ) != F_208 ( V_253 ) )
continue;
if ( V_258 == V_254 )
return V_16 ;
++ V_258 ;
...
static void * F_209 ( struct V_252 * V_253 , T_4 * V_254 )
__acquires( V_31 )
{
F_26 ( & V_31 ) ;
return * V_254 ? F_207 ( V_253 , * V_254 - 1 ) : V_259 ;
}
static void * F_210 ( struct V_252 * V_253 , void * V_260 , T_4 * V_254 )
{
struct V_255 * V_256 = V_253 -> V_257 ;
struct V_11 * V_12 = V_260 ;
++ * V_254 ;
if ( V_260 == V_259 )
V_12 = F_202 ( & V_256 -> V_41 ) ;
else
V_12 = F_205 ( & V_256 -> V_41 , V_12 ) ;
while ( V_12 && ( F_33 ( V_12 ) != F_208 ( V_253 ) ) )
V_12 = F_205 ( & V_256 -> V_41 , V_12 ) ;
return V_12 ;
}
static void F_211 ( struct V_252 * V_253 , void * V_260 )
__releases( V_31 )
{
F_27 ( & V_31 ) ;
}
static int F_212 ( struct V_252 * V_253 , void * V_260 )
{
if ( V_260 == V_259 )
F_213 ( V_253 , L_4
L_5 ) ;
...
for ( ; V_41 < V_23 ; V_41 ++ )
F_216 ( V_253 , V_37 -> V_19 -> V_38 -> V_28 [ V_41 ] ) ;
}
F_13 ( V_16 ) ;
F_216 ( V_253 , '\n' ) ;
}
...
static int F_218 ( struct V_40 * V_40 , struct V_239 * V_239 )
{
return F_219 ( V_40 , V_239 , & V_265 ,
sizeof( struct V_255 ) ) ;
}
...
int V_267 = - 1 ;
struct V_3 * V_268 ;
F_228 ( sizeof( struct V_269 ) > sizeof( V_268 -> V_270 ) ) ;
V_267 = F_229 ( & V_99 , 1 ) ;
if ( V_267 != 0 ) {
F_51 ( V_271 L_8 ,
V_272 ) ;
