...
char * V_63 ;
int V_64 , V_65 , V_66 = F_21 ( V_17 , & V_63 , NULL ) ;
if ( ! V_66 )
goto V_32;
V_18 -> V_60 . V_61 . V_62 [ V_46 ] = V_63 ;
if ( isspace ( * V_63 ) )
goto V_32;
for ( V_64 = V_65 = 0 ; V_65 < V_66 - 2 ; V_65 ++ ) {
if ( ! V_63 [ V_65 ] )
V_64 ++ ;
}
if ( * V_63 == ':' ) {
...
T_3 V_72 = 0 ;
int V_73 = F_38 ( V_46 ) ;
if ( ! F_16 ( V_17 , & V_72 , NULL ) )
goto V_32;
V_18 -> V_69 . V_74 [ V_73 ] . V_75 = V_72 ;
}
if ( ! F_13 ( V_17 , V_67 , NULL ) )
goto V_32;
if ( ! F_13 ( V_17 , V_68 , NULL ) )
...
if ( ! F_13 ( V_17 , V_68 , NULL ) )
goto V_32;
if ( F_14 ( V_17 , & V_18 -> V_84 , L_9 ) )
V_18 -> V_84 |= V_18 -> V_45 & V_85 ;
else
V_18 -> V_84 = V_85 ;
if ( ! F_14 ( V_17 , & ( V_18 -> V_86 . V_87 . V_88 [ 0 ] ) , NULL ) )
goto V_32;
if ( ! F_14 ( V_17 , & ( V_18 -> V_86 . V_82 . V_88 [ 0 ] ) , NULL ) )
goto V_32;
if ( ! F_14 ( V_17 , & ( V_18 -> V_86 . V_89 . V_88 [ 0 ] ) , NULL ) )
goto V_32;
if ( ! F_14 ( V_17 , & V_76 . V_88 [ 0 ] , NULL ) )
goto V_32;
if ( F_13 ( V_17 , V_59 , L_10 ) ) {
if ( ! F_14 ( V_17 , & ( V_18 -> V_86 . V_87 . V_88 [ 1 ] ) , NULL ) )
goto V_32;
if ( ! F_14 ( V_17 , & ( V_18 -> V_86 . V_82 . V_88 [ 1 ] ) , NULL ) )
goto V_32;
if ( ! F_14 ( V_17 , & ( V_18 -> V_86 . V_89 . V_88 [ 1 ] ) , NULL ) )
goto V_32;
if ( ! F_14 ( V_17 , & ( V_76 . V_88 [ 1 ] ) , NULL ) )
goto V_32;
if ( ! F_13 ( V_17 , V_68 , NULL ) )
goto V_32;
}
if ( F_13 ( V_17 , V_59 , L_11 ) ) {
if ( ! F_14 ( V_17 , & ( V_18 -> V_86 . V_90 . V_88 [ 0 ] ) , NULL ) )
goto V_32;
if ( ! F_14 ( V_17 , & ( V_18 -> V_86 . V_90 . V_88 [ 1 ] ) , NULL ) )
goto V_32;
}
if ( ! F_37 ( V_17 , V_18 ) )
goto V_32;
...
static int F_43 ( struct V_16 * V_17 , const char * * V_92 )
{
int error = - V_93 ;
if ( ! F_14 ( V_17 , & V_17 -> V_94 , L_15 ) ) {
...
if ( ! F_20 ( V_17 , V_92 , L_18 ) )
* V_92 = NULL ;
return 0 ;
}
static bool F_44 ( int V_95 , int V_96 )
{
int V_97 , V_98 ;
V_98 = V_95 & V_99 ;
V_97 = V_95 & V_100 ;
if ( V_98 == V_101 && V_97 > V_96 )
return 0 ;
return 1 ;
}
static bool F_45 ( struct V_43 * V_44 , int V_96 )
{
int V_46 ;
for ( V_46 = 0 ; V_46 < V_44 -> V_47 [ V_48 ] -> V_49 ; V_46 ++ ) {
if ( ! F_44 ( F_46 ( V_44 , V_46 ) , V_96 ) )
return 0 ;
if ( ! F_44 ( F_47 ( V_44 , V_46 ) , V_96 ) )
return 0 ;
}
return 1 ;
}
...
struct V_9 * F_49 ( void * V_102 , T_1 V_23 , const char * * V_92 )
{
struct V_9 * V_18 = NULL ;
int error ;
struct V_16 V_17 = {
