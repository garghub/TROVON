...
return 0 ;
if ( memcmp ( V_7 -> V_23 , V_31 -> V_28 -> V_172 , V_109 ) != 0 &&
...
F_53 ( V_31 , V_7 -> V_24 , V_180 ) ;
return - 1 ;
}
if ( * V_170 && ! ( V_8 & V_19 ) && V_31 -> V_178 &&
F_54 ( V_31 -> V_178 , V_7 -> V_24 ) ) {
* V_170 = NULL ;
}
return 0 ;
}
static int F_55 ( T_2 * V_31 , struct V_2 * V_3 )
{
...
if ( ( V_8 & ( V_18 | V_19 ) ) ==
V_18 &&
memcmp ( V_7 -> V_23 , V_28 -> V_172 , V_109 ) == 0 &&
memcmp ( V_7 -> V_25 , V_28 -> V_172 , V_109 ) == 0 ) {
...
void F_61 ( struct V_27 * V_28 , struct V_2 * V_3 ,
struct V_4 * V_5 )
{
struct V_29 * V_30 ;
T_2 * V_31 ;
...
| V_209 | V_210 ;
F_63 ( V_28 , V_7 -> V_24 , & V_204 ) ;
}
#endif
F_64 ( V_31 -> V_178 , V_7 , V_5 ) ;
if ( V_31 -> V_155 == V_211 ) {
F_24 ( V_28 , V_3 , V_5 ) ;
return;
}
...
F_68 ( V_3 , V_3 -> V_13 - V_109 ,
V_3 -> V_9 + V_109 ,
V_109 ) ;
F_70 ( V_3 , V_3 -> V_13 - V_109 ) ;
}
V_28 -> V_94 . V_95 ++ ;
