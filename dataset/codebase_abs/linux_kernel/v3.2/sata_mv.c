...
struct V_536 * V_537 = V_534 -> V_537 + V_114 ;
...
struct V_546 * V_547 ;
int V_86 , V_429 ;
F_194 ( & V_126 -> V_152 , V_548 ) ;
if ( F_48 ( V_126 -> V_549 != 2 ) ) {
F_131 ( & V_126 -> V_152 , L_58 ) ;
return - V_146 ;
}
V_547 = F_195 ( V_126 , V_550 , 0 ) ;
if ( V_547 == NULL )
return - V_146 ;
V_543 = V_126 -> V_152 . V_551 ;
V_86 = V_543 -> V_86 ;
V_16 = F_196 ( & V_126 -> V_152 , V_544 , V_86 ) ;
...
V_18 -> V_492 = V_509 ;
V_16 -> V_552 = NULL ;
V_18 -> V_6 = F_197 ( & V_126 -> V_152 , V_547 -> V_121 ,
F_198 ( V_547 ) ) ;
V_18 -> V_6 -= V_8 ;
#if F_199 ( V_553 )
...
if ( V_429 )
goto V_120;
F_204 ( & V_126 -> V_152 , L_60 ,
( unsigned ) V_192 , V_16 -> V_86 ) ;
V_429 = F_205 ( V_16 , F_206 ( V_126 , 0 ) , F_134 ,
V_555 , & V_556 ) ;
if ( ! V_429 )
return 0 ;
V_120:
...
static int T_8 F_209 ( struct V_541 * V_126 )
{
struct V_15 * V_16 = F_210 ( V_126 ) ;
#if F_199 ( V_553 )
struct V_17 * V_18 = V_16 -> V_19 ;
#endif
F_211 ( V_16 ) ;
...
static int F_212 ( struct V_541 * V_126 , T_9 V_557 )
{
struct V_15 * V_16 = F_210 ( V_126 ) ;
if ( V_16 )
return F_213 ( V_16 , V_557 ) ;
else
return 0 ;
}
static int F_214 ( struct V_541 * V_126 )
{
struct V_15 * V_16 = F_210 ( V_126 ) ;
int V_558 ;
if ( V_16 ) {
...
static int F_216 ( struct V_125 * V_126 )
{
int V_429 ;
if ( ! F_217 ( V_126 , F_218 ( 64 ) ) ) {
V_429 = F_219 ( V_126 , F_218 ( 64 ) ) ;
if ( V_429 ) {
V_429 = F_219 ( V_126 , F_218 ( 32 ) ) ;
if ( V_429 ) {
F_131 ( & V_126 -> V_152 ,
L_62 ) ;
return V_429 ;
...
V_429 = F_217 ( V_126 , F_218 ( 32 ) ) ;
if ( V_429 ) {
F_131 ( & V_126 -> V_152 , L_63 ) ;
return V_429 ;
}
V_429 = F_219 ( V_126 , F_218 ( 32 ) ) ;
if ( V_429 ) {
...
struct V_17 * V_18 = V_16 -> V_19 ;
T_3 V_559 ;
const char * V_560 , * V_561 ;
F_221 ( V_126 , V_562 , & V_559 ) ;
if ( V_559 == 0 )
V_560 = L_65 ;
else if ( V_559 == 0x01 )
V_560 = L_66 ;
...
V_561 = L_67 ;
F_204 ( & V_126 -> V_152 , L_71 ,
V_561 , ( unsigned ) V_192 , V_16 -> V_86 ,
V_560 , ( V_399 & V_18 -> V_170 ) ? L_72 : L_73 ) ;
}
static int F_222 ( struct V_125 * V_126 ,
const struct V_563 * V_564 )
{
unsigned int V_492 = ( unsigned int ) V_564 -> V_565 ;
...
if ( V_429 )
return V_429 ;
V_429 = F_224 ( V_126 , 1 << V_566 , V_329 ) ;
if ( V_429 == - V_567 )
F_225 ( V_126 ) ;
if ( V_429 )
return V_429 ;
V_16 -> V_552 = F_226 ( V_126 ) ;
V_18 -> V_6 = V_16 -> V_552 [ V_566 ] ;
V_429 = F_216 ( V_126 ) ;
if ( V_429 )
return V_429 ;
V_429 = F_188 ( V_18 , & V_126 -> V_152 ) ;
...
F_227 ( V_21 , V_566 , - 1 , L_74 ) ;
F_227 ( V_21 , V_566 , V_210 , L_75 ) ;
}
V_429 = F_187 ( V_16 ) ;
if ( V_429 )
return V_429 ;
if ( V_568 && F_228 ( V_126 ) == 0 )
V_18 -> V_170 |= V_399 ;
F_37 ( V_126 , 0x68 ) ;
F_220 ( V_16 ) ;
F_229 ( V_126 ) ;
F_230 ( V_126 ) ;
return F_205 ( V_16 , V_126 -> V_396 , F_134 , V_555 ,
F_25 ( V_18 ) ? & V_569 : & V_556 ) ;
}
static int F_231 ( struct V_125 * V_126 )
{
struct V_15 * V_16 = F_232 ( V_126 ) ;
int V_429 ;
V_429 = F_233 ( V_126 ) ;
if ( V_429 )
return V_429 ;
