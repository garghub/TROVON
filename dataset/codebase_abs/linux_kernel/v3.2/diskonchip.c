...
static inline int T_5 F_51 ( struct V_46 * V_47 , struct V_154 * V_155 )
{
struct V_49 * V_50 = V_47 -> V_51 ;
struct V_27 * V_28 = V_50 -> V_51 ;
int V_45 = 0 ;
...
int V_145 , V_162 ;
V_53 = F_52 ( V_47 -> V_105 , V_163 ) ;
if ( ! V_53 ) {
F_9 ( V_141 L_25 ) ;
return 0 ;
}
if ( ! ( V_162 = F_50 ( V_47 , V_53 , L_26 , 1 ) ) )
goto V_164;
...
V_161 = F_55 ( 32768U , V_47 -> V_148 - V_158 ) ;
if ( V_157 -> V_169 == 0x00 ) {
V_157 -> V_169 = 0xff ;
while ( V_160 > V_161 ) {
V_160 >>= 1 ;
V_161 = F_55 ( 32768U , ( V_161 << 1 ) + V_158 ) ;
V_157 -> V_169 -- ;
}
...
V_145 = F_56 ( V_28 -> V_151 , V_28 -> V_153 ) ;
V_145 <<= V_50 -> V_152 ;
V_145 += V_47 -> V_148 ;
if ( V_172 == 1 ) {
V_155 [ 0 ] . V_173 = L_35 ;
...
static inline int T_5 F_58 ( struct V_46 * V_47 , struct V_154 * V_155 )
{
struct V_49 * V_50 = V_47 -> V_51 ;
struct V_27 * V_28 = V_50 -> V_51 ;
int V_45 = 0 ;
...
static int T_5 F_59 ( struct V_46 * V_47 )
{
int V_45 , V_159 ;
struct V_49 * V_50 = V_47 -> V_51 ;
struct V_27 * V_28 = V_50 -> V_51 ;
...
if ( ( V_45 = F_60 ( V_47 , NULL ) ) )
return V_45 ;
F_61 ( V_47 , NULL , 0 ) ;
if ( ! V_210 )
F_61 ( V_47 , V_155 , V_159 ) ;
return 0 ;
}
...
static int T_5 F_66 ( unsigned long V_224 )
{
unsigned char V_66 ;
struct V_46 * V_47 ;
struct V_49 * V_225 ;
...
struct V_49 * V_225 ;
struct V_27 * V_28 ;
for ( V_47 = V_249 ; V_47 ; V_47 = V_271 ) {
V_225 = V_47 -> V_51 ;
V_28 = V_225 -> V_51 ;
V_271 = V_28 -> V_250 ;
F_71 ( V_47 ) ;
...
{
int V_5 , V_45 = 0 ;
V_140 = F_75 ( 10 , 0x409 , V_18 , 1 , V_15 ) ;
if ( ! V_140 ) {
F_9 ( V_141 L_70 ) ;
return - V_257 ;
}
