...
{
F_11 ( L_29 ) ;
( void ) F_69 ( V_2 , false , true , 0 , false , 10 * V_172 ) ;
F_32 ( V_2 -> V_64 , false ) ;
F_32 ( V_2 -> V_60 , false ) ;
V_2 -> V_65 = false ;
}
...
int V_30 = 0 ;
struct V_67 V_174 ;
struct V_18 V_175 , V_176 ;
struct V_143 * V_154 ;
F_89 ( & V_2 -> V_167 ) ;
if ( V_2 -> V_64 == NULL )
goto V_168;
if ( V_173 && V_28 != V_2 -> V_66 )
goto V_168;
F_78 ( & V_174 ) ;
V_175 . V_23 = ( void * ) ( unsigned long )
V_59 ;
V_175 . V_14 = F_12 ( V_2 -> V_64 ) ;
F_6 ( & V_175 . V_24 , & V_174 ) ;
V_176 . V_23 = V_175 . V_23 ;
V_176 . V_14 = F_12 ( V_2 -> V_60 ) ;
F_6 ( & V_176 . V_24 , & V_174 ) ;
do {
V_30 = F_79 ( & V_174 ) ;
} while ( V_30 == - V_42 );
if ( F_10 ( V_30 != 0 ) ) {
...
int F_90 ( struct V_179 * V_180 , void * V_181 ,
struct V_141 * V_142 )
{
struct V_1 * V_2 = F_91 ( V_180 ) ;
struct V_182 * V_183 = (struct V_182 * ) V_181 ;
struct V_184 * V_185 = V_184 ( V_142 -> V_186 ) ;
int V_30 ;
if ( F_10 ( V_183 -> V_187 != V_188 ) ) {
F_11 ( L_30 ) ;
F_11 ( L_31
L_32 ) ;
return - V_7 ;
}
V_30 = F_92 ( & V_185 -> V_189 , true ) ;
if ( F_10 ( V_30 != 0 ) )
return V_30 ;
V_30 = F_75 ( V_142 , V_2 ,
( void T_20 * ) ( unsigned long ) V_183 -> V_190 ,
NULL , V_183 -> V_165 , V_183 -> V_166 ,
( void T_20 * ) ( unsigned long ) V_183 -> V_156 ) ;
if ( F_10 ( V_30 != 0 ) )
goto V_168;
F_93 ( V_2 ) ;
V_168:
