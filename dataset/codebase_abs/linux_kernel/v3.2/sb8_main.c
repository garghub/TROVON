...
int F_41 ( struct V_22 * V_23 , int V_114 , struct V_115 * * V_116 )
{
struct V_117 * V_118 = V_23 -> V_118 ;
struct V_115 * V_119 ;
int V_11 ;
T_3 V_120 = 64 * 1024 ;
if ( V_116 )
* V_116 = NULL ;
if ( ( V_11 = F_42 ( V_118 , L_1 , V_114 , 1 , 1 , & V_119 ) ) < 0 )
return V_11 ;
sprintf ( V_119 -> V_121 , L_2 , V_23 -> V_122 >> 8 , V_23 -> V_122 & 0xff ) ;
V_119 -> V_123 = V_124 ;
V_119 -> V_125 = V_23 ;
F_43 ( V_119 , V_96 , & V_126 ) ;
F_43 ( V_119 , V_127 , & V_128 ) ;
if ( V_23 -> V_56 > 3 || V_23 -> V_52 >= 0 )
V_120 = 128 * 1024 ;
F_44 ( V_119 , V_129 ,
F_45 () ,
