...
static int F_74 ( struct V_5 * V_6 , struct V_98 * V_99 )
{
struct V_3 * V_4 = V_6 -> V_4 ;
struct V_1 * V_137 ;
F_52 ( L_28 , V_6 -> V_20 ) ;
V_137 = F_75 ( sizeof( struct V_1 ) , V_138 ) ;
if ( NULL == V_137 ) {
F_11 ( L_29 ) ;
return - V_139 ;
}
F_76 ( & V_137 -> V_129 , V_6 -> V_140 ) ;
V_137 -> V_4 = V_4 ;
V_137 -> type = V_6 -> type ;
V_137 -> V_13 = V_4 -> V_13 ++ ;
...
int F_78 ( struct V_98 * V_99 )
{
int V_142 ;
struct V_143 * V_140 = F_79 ( V_99 ) ;
struct V_5 * V_6 = F_80 ( V_140 ) ;
struct V_3 * V_4 = V_6 -> V_4 ;
F_48 ( & V_4 -> V_100 ) ;
if ( F_81 ( V_4 ) ) {
F_82 ( L_30 ,
