...
V_6 -> V_28 = V_19 -> V_28 ;
F_16 ( & V_6 -> V_8 ) ;
V_6 -> V_29 = F_17 ( V_2 -> V_30 , V_31 ) ;
F_15 ( V_6 -> V_29 , V_6 ) ;
V_6 -> V_32 = F_17 ( V_2 -> V_30 , V_33 ) ;
F_15 ( V_6 -> V_32 , V_6 ) ;
V_6 -> V_34 = F_17 ( V_2 -> V_30 , V_35 ) ;
F_15 ( V_6 -> V_34 , V_6 ) ;
F_18 ( V_6 -> V_20 ) ;
F_19 ( V_6 ) ;
F_20 ( V_6 -> V_20 , - 1 , V_36 ,
F_21 ( V_36 ) ,
NULL , 0 ) ;
if ( V_7 < 0 )
goto V_37;
F_22 ( V_6 -> V_20 , V_19 -> V_38 ) ;
return V_7 ;
V_37:
F_23 ( V_6 -> V_20 ) ;
F_24 ( V_6 -> V_34 ) ;
...
static int F_27 ( struct V_39 * V_20 )
{
...
static int F_29 ( struct V_39 * V_20 )
{
struct V_1 * V_2 = F_28 ( V_20 , struct V_1 , V_20 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_40 ;
...
static int F_30 ( struct V_39 * V_20 )
{
struct V_1 * V_2 = F_28 ( V_20 , struct V_1 , V_20 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( F_31 ( V_20 ) )
...
static int F_33 ( struct V_39 * V_20 )
{
struct V_1 * V_2 = F_28 ( V_20 , struct V_1 , V_20 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( F_31 ( V_20 ) )
