...
{
if ( V_7 -> V_11 && V_7 -> V_17 && V_7 -> V_19 )
return true ;
if ( ! V_7 -> V_11 ) {
* V_47 = - V_48 ;
return false ;
}
F_5 ( ! ( V_7 -> V_17 && V_7 -> V_19 ) ) ;
* V_47 = - V_49 ;
return false ;
}
...
void F_20 ( struct V_1 * V_52 ,
void (* F_21)( struct V_1 * V_53 ) ,
void (* F_22)( struct V_1 * V_53 ) )
{
struct V_6 * V_7 ;
V_7 = F_12 ( V_52 -> V_25 , struct V_6 , V_39 ) ;
F_23 ( V_52 == NULL || V_52 -> V_25 == NULL ) ;
V_7 -> F_21 = F_21 ;
V_7 -> F_22 = F_22 ;
}
