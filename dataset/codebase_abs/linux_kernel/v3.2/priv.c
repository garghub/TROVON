...
{
int V_73 = ( V_2 -> V_4 . V_5 -> V_6 & 0xf0000000 ) >> 28 ;
int V_74 = ( V_2 -> V_4 . V_5 -> V_6 & 0x0fff0000 ) >> 16 ;
int V_3 = ( V_2 -> V_4 . V_5 -> V_6 & 0xf000 ) >> 12 ;
int V_7 = V_2 -> V_4 . V_5 -> V_6 & 0x0fff ;
T_1 V_75 = V_74 + V_73 ? V_2 -> V_4 . V_13 [ V_73 ] : 0 ;
T_1 V_76 = V_7 + V_3 ? V_2 -> V_4 . V_13 [ V_3 ] : 0 ;
struct V_77 * V_78 ;
unsigned long V_79 ;
V_2 -> V_11 . V_80 ++ ;
if ( V_76 & 0xf0 )
return - V_72 ;
if ( V_2 -> V_4 . V_5 -> V_27 . V_30 & V_81 )
return - V_72 ;
V_79 = ( unsigned long ) F_29 ( V_2 , V_75 ) ;
F_30 ( & V_82 -> V_83 -> V_84 ) ;
V_78 = F_31 ( V_82 -> V_83 , V_79 ) ;
if ( ! V_78 ) {
F_32 ( & V_82 -> V_83 -> V_84 ) ;
return F_2 ( V_2 , V_16 ) ;
}
V_2 -> V_4 . V_5 -> V_27 . V_30 &= ~ ( 3ul << 44 ) ;
if ( ! ( V_78 -> V_85 & V_86 ) && ( V_78 -> V_85 & V_87 ) )
V_2 -> V_4 . V_5 -> V_27 . V_30 |= ( 1ul << 44 ) ;
if ( ! ( V_78 -> V_85 & V_86 ) && ! ( V_78 -> V_85 & V_87 ) )
V_2 -> V_4 . V_5 -> V_27 . V_30 |= ( 2ul << 44 ) ;
F_32 ( & V_82 -> V_83 -> V_84 ) ;
return 0 ;
}
int F_33 ( struct V_1 * V_2 )
{
if ( ( V_2 -> V_4 . V_5 -> V_69 & 0x00ff ) == 0x01 )
return F_28 ( V_2 ) ;
return - V_72 ;
}
