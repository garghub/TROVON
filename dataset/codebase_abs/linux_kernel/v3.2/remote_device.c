...
static enum V_23 F_88 ( struct V_80 * V_81 ,
struct V_3 * V_4 )
{
struct V_104 * V_9 = V_4 -> V_105 ;
enum V_23 V_26 ;
...
return V_116 ;
V_4 -> V_117 = F_89 ( V_119 , F_87 ( V_81 ) ,
V_9 -> V_120 ) ;
V_4 -> V_118 = 1 ;
return V_27 ;
}
static enum V_23 F_90 ( struct V_3 * V_4 ,
T_1 V_34 )
{
struct V_35 * V_21 = & V_4 -> V_21 ;
enum V_36 V_37 = V_21 -> V_38 ;
...
static enum V_23 F_91 ( struct V_80 * V_81 ,
struct V_3 * V_4 )
{
struct V_1 * V_2 = V_81 -> V_1 ;
struct V_104 * V_9 = V_4 -> V_105 ;
enum V_23 V_26 ;
if ( V_9 -> V_121 && F_71 ( V_9 -> V_121 ) )
V_26 = F_88 ( V_81 , V_4 ) ;
else
V_26 = F_85 ( V_81 , V_4 ) ;
if ( V_26 != V_27 ) {
...
void F_92 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
F_93 ( V_123 ) ;
F_2 ( & V_2 -> V_8 -> V_9 ,
L_3 , V_10 , V_4 ) ;
...
static struct V_3 *
F_95 ( struct V_1 * V_2 , struct V_80 * V_81 )
{
struct V_3 * V_4 ;
int V_28 ;
for ( V_28 = 0 ; V_28 < V_124 ; V_28 ++ ) {
V_4 = & V_2 -> V_125 [ V_28 ] ;
if ( ! F_96 ( V_126 , & V_4 -> V_13 ) )
break;
}
if ( V_28 >= V_124 ) {
...
if ( F_97 ( ! F_65 ( & V_4 -> V_100 ) , L_16 ) )
return NULL ;
if ( F_97 ( ! F_65 ( & V_4 -> V_101 ) , L_17 ) )
return NULL ;
return V_4 ;
}
void F_98 ( struct V_82 * V_82 )
{
...
enum V_23 F_100 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
enum V_23 V_26 ;
unsigned long V_13 ;
F_2 ( & V_2 -> V_8 -> V_9 ,
L_1 , V_10 , V_4 ) ;
F_101 ( & V_2 -> V_129 , V_13 ) ;
V_4 -> V_105 -> V_130 = NULL ;
F_3 ( V_12 , & V_4 -> V_13 ) ;
F_102 ( & V_2 -> V_129 , V_13 ) ;
F_92 ( V_2 , V_4 ) ;
F_3 ( V_127 , & V_4 -> V_13 ) ;
F_101 ( & V_2 -> V_129 , V_13 ) ;
V_26 = F_15 ( V_4 , 50 ) ;
F_102 ( & V_2 -> V_129 , V_13 ) ;
if ( F_97 ( V_26 != V_27 , L_18 ) )
;
else
F_103 ( V_2 , V_4 ) ;
return V_26 ;
}
void F_104 ( struct V_104 * V_9 )
{
struct V_1 * V_2 = F_105 ( V_9 ) ;
struct V_3 * V_4 = V_9 -> V_130 ;
F_2 ( & V_2 -> V_8 -> V_9 ,
L_19 ,
V_10 , V_9 , V_4 , V_4 -> V_80 ) ;
F_100 ( V_2 , V_4 ) ;
}
int F_106 ( struct V_104 * V_105 )
{
struct V_1 * V_1 = F_105 ( V_105 ) ;
struct V_80 * V_80 ;
struct V_131 * V_131 ;
struct V_132 * V_133 ;
struct V_134 * V_135 ;
...
F_107 ( V_1 ) ;
V_133 = V_105 -> V_137 ;
V_135 = F_108 ( & V_133 -> V_138 , struct V_134 ,
V_139 ) ;
V_131 = F_109 ( V_135 ) ;
V_80 = V_131 -> V_80 ;
F_110 ( & V_80 -> V_140 ) ;
...
V_136 -> V_105 = V_105 ;
V_136 -> V_80 = V_80 ;
F_115 ( & V_136 -> V_101 , & V_80 -> V_144 ) ;
F_3 ( V_17 , & V_136 -> V_13 ) ;
V_26 = F_91 ( V_80 , V_136 ) ;
F_2 ( & V_1 -> V_8 -> V_9 ,
L_1 ,
V_10 , V_136 ) ;
if ( V_26 == V_27 ) {
