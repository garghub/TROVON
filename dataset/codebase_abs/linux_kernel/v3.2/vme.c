...
struct V_5 * F_12 ( struct V_1 * V_49 ,
T_3 V_50 , T_4 V_31 )
{
struct V_4 * V_21 ;
...
struct V_5 * F_20 ( struct V_1 * V_49 ,
T_3 V_50 , T_4 V_31 , T_5 V_32 )
{
struct V_4 * V_21 ;
...
T_6 F_24 ( struct V_5 * V_6 , void * V_74 , T_1 V_75 ,
T_7 V_76 )
{
struct V_4 * V_21 = F_3 ( V_6 ) ;
struct V_9 * V_64 ;
...
T_6 F_25 ( struct V_5 * V_6 , void * V_74 ,
T_1 V_75 , T_7 V_76 )
{
struct V_4 * V_21 = F_3 ( V_6 ) ;
struct V_9 * V_64 ;
...
unsigned int V_81 , unsigned int V_82 , T_7 V_76 )
{
struct V_4 * V_21 = F_3 ( V_6 ) ;
struct V_9 * V_64 ;
if ( V_21 -> V_83 == NULL ) {
...
struct V_5 * F_28 ( struct V_1 * V_49 ,
T_8 V_84 )
{
struct V_4 * V_21 ;
...
static int F_55 ( struct V_4 * V_21 )
{
int V_140 ;
int V_141 = - 1 ;
F_14 ( & V_142 ) ;
...
static void F_57 ( struct V_4 * V_21 )
{
struct V_1 * V_49 ;
struct V_1 * V_148 ;
F_14 ( & V_142 ) ;
V_143 &= ~ ( 1 << V_21 -> V_144 ) ;
F_58 (vdev, tmp, &bridge->devices, bridge_list) {
F_59 ( & V_49 -> V_149 ) ;
F_59 ( & V_49 -> V_150 ) ;
F_60 ( & V_49 -> V_3 ) ;
}
...
F_66 ( & V_49 -> V_3 , L_58 , V_152 -> V_22 , V_21 -> V_144 ,
V_49 -> V_144 ) ;
V_154 = F_67 ( & V_49 -> V_3 ) ;
if ( V_154 )
goto V_161;
if ( V_49 -> V_3 . V_157 ) {
F_56 ( & V_49 -> V_149 , & V_152 -> V_145 ) ;
F_56 ( & V_49 -> V_150 , & V_21 -> V_145 ) ;
} else
F_60 ( & V_49 -> V_3 ) ;
}
return 0 ;
...
F_19 ( V_49 ) ;
V_156:
F_58 (vdev, tmp, &drv->devices, drv_list) {
F_59 ( & V_49 -> V_149 ) ;
F_59 ( & V_49 -> V_150 ) ;
F_60 ( & V_49 -> V_3 ) ;
}
...
static int F_68 ( struct V_151 * V_152 , unsigned int V_153 )
{
struct V_4 * V_21 ;
int V_154 = 0 ;
F_14 ( & V_142 ) ;
F_69 (bridge, &vme_bus_list, bus_list) {
...
int F_70 ( struct V_151 * V_152 , unsigned int V_153 )
{
int V_154 ;
V_152 -> V_162 . V_22 = V_152 -> V_22 ;
V_152 -> V_162 . V_159 = & V_160 ;
F_30 ( & V_152 -> V_145 ) ;
V_154 = F_71 ( & V_152 -> V_162 ) ;
if ( V_154 )
return V_154 ;
V_154 = F_68 ( V_152 , V_153 ) ;
if ( V_154 )
F_72 ( & V_152 -> V_162 ) ;
return V_154 ;
}
void F_73 ( struct V_151 * V_152 )
{
struct V_1 * V_3 , * V_163 ;
F_14 ( & V_142 ) ;
F_58 (dev, dev_tmp, &drv->devices, drv_list) {
F_59 ( & V_3 -> V_149 ) ;
F_59 ( & V_3 -> V_150 ) ;
F_60 ( & V_3 -> V_3 ) ;
}
...
static int F_74 ( struct V_2 * V_3 , struct V_164 * V_152 )
{
struct V_151 * V_165 ;
