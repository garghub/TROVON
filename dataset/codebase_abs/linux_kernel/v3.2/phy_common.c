...
void F_62 ( struct V_1 * V_2 , bool V_114 )
{
T_1 V_103 ;
F_63 ( V_2 -> V_4 . type != V_11 &&
V_2 -> V_4 . type != V_15 ) ;
switch ( V_2 -> V_2 -> V_115 ) {
#ifdef F_64
case V_116 :
V_103 = F_65 ( V_2 -> V_2 -> V_117 , V_118 ) ;
if ( V_114 )
V_103 |= V_119 ;
else
V_103 &= ~ V_119 ;
F_66 ( V_2 -> V_2 -> V_117 , V_118 , V_103 ) ;
break;
#endif
#ifdef F_67
case V_120 :
V_103 = F_68 ( V_2 -> V_2 -> V_121 , V_122 ) ;
if ( V_114 )
V_103 |= V_123 ;
else
V_103 &= ~ V_123 ;
F_69 ( V_2 -> V_2 -> V_121 , V_122 , V_103 ) ;
break;
#endif
}
}
struct V_124 F_70 ( int V_125 )
{
static const T_1 V_126 [] = {
...
T_5 V_128 = 1 ;
T_1 V_129 = 0 ;
struct V_124 V_130 = { . V_127 = 39797 , . V_131 = 0 , } ;
while ( V_125 > ( 180 << 16 ) )
V_125 -= ( 360 << 16 ) ;
while ( V_125 < - ( 180 << 16 ) )
V_125 += ( 360 << 16 ) ;
...
for ( V_127 = 0 ; V_127 <= 17 ; V_127 ++ ) {
if ( V_125 > V_129 ) {
V_103 = V_130 . V_127 - ( V_130 . V_131 >> V_127 ) ;
V_130 . V_131 += V_130 . V_127 >> V_127 ;
V_130 . V_127 = V_103 ;
V_129 += V_126 [ V_127 ] ;
} else {
V_103 = V_130 . V_127 + ( V_130 . V_131 >> V_127 ) ;
