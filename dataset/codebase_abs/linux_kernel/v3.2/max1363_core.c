const struct V_1
* F_1 ( unsigned long * V_2 , const struct V_3 * V_4 )
{
int V_5 ;
if ( V_2 )
...
static T_3 F_14 ( struct V_47 * V_48 ,
struct V_49 * V_50 ,
char * V_51 )
{
struct V_16 * V_17 = F_7 ( F_15 ( V_48 ) ) ;
return sprintf ( V_51 , L_1 , V_52 [ V_17 -> V_53 ] ) ;
}
static T_3 F_16 ( struct V_47 * V_48 ,
struct V_49 * V_50 ,
const char * V_51 ,
T_4 V_54 )
{
struct V_25 * V_26 = F_15 ( V_48 ) ;
struct V_16 * V_17 = F_7 ( V_26 ) ;
int V_5 , V_31 ;
unsigned long V_29 ;
bool V_55 = false ;
V_31 = F_17 ( V_51 , 10 , & V_29 ) ;
if ( V_31 )
return - V_46 ;
for ( V_5 = 0 ; V_5 < F_18 ( V_52 ) ; V_5 ++ )
if ( V_29 == V_52 [ V_5 ] ) {
V_55 = true ;
break;
}
...
struct V_16 * V_17 = F_7 ( V_26 ) ;
if ( F_20 ( V_56 ) == V_57 )
* V_29 = V_17 -> V_58 [ F_21 ( V_56 ) ] ;
else
* V_29 = V_17 -> V_59 [ F_21 ( V_56 ) ] ;
return 0 ;
}
...
switch ( F_20 ( V_56 ) ) {
case V_57 :
V_17 -> V_58 [ F_21 ( V_56 ) ] = V_29 ;
break;
case V_60 :
V_17 -> V_59 [ F_21 ( V_56 ) ] = V_29 ;
break;
}
return 0 ;
}
static T_6 F_23 ( int V_61 , void * V_62 )
{
...
F_11 ( V_17 -> V_12 , & V_65 , 1 ) ;
V_2 = V_65 ;
F_25 (loc, &mask, 8 )
F_26 ( V_26 , V_68 [ V_64 ] , V_63 ) ;
...
static int F_28 ( struct V_16 * V_17 , int V_73 )
{
T_1 * V_15 ;
int V_31 , V_5 = 3 , V_74 ;
unsigned long V_75 ;
...
static inline int F_33 ( int V_84 , int V_85 )
{
int V_31 = 0 ;
if ( V_84 < 4 ) {
if ( V_85 & ~ 0x0F ) {
...
static int T_9 F_38 ( struct V_11 * V_12 ,
...
V_17 -> V_97 = V_97 ;
F_44 ( V_12 , V_26 ) ;
V_17 -> V_39 = & V_101 [ V_95 -> V_102 ] ;
V_17 -> V_12 = V_12 ;
V_26 -> V_103
= F_45 ( F_46 ( V_10 ) * sizeof( long ) *
...
. V_9 , V_10 ) ;
V_26 -> V_48 . V_105 = & V_12 -> V_48 ;
V_26 -> V_106 = V_95 -> V_106 ;
V_26 -> V_107 = V_17 -> V_39 -> V_107 ;
...
static T_10 int F_61 ( void )
{
return F_62 ( & V_118 ) ;
}
static T_11 void F_63 ( void )
{
F_64 ( & V_118 ) ;
}
