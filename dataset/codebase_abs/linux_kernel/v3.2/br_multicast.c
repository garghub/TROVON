...
break;
case V_203 :
V_195 -> V_99 = ~ F_149 ( F_73 ( & V_101 -> V_89 ,
& V_101 -> V_36 ,
V_195 -> V_45 ,
V_110 , 0 ) ) ;
if ( F_150 ( V_195 ) )
...
V_189 = (struct V_102 * ) F_151 ( V_195 ) ;
F_21 ( V_32 ) -> V_199 = 1 ;
...
int F_152 ( struct V_29 * V_30 , struct V_123 * V_64 ,
struct V_31 * V_32 )
{
F_21 ( V_32 ) -> V_34 = 0 ;
F_21 ( V_32 ) -> V_199 = 0 ;
...
static void F_153 ( unsigned long V_51 )
{
...
F_90 ( & V_30 -> V_147 ,
F_99 , 0 ) ;
F_90 ( & V_30 -> V_151 , F_153 ,
( unsigned long ) V_30 ) ;
}
void F_156 ( struct V_29 * V_30 )
{
V_30 -> V_153 = 0 ;
if ( V_30 -> V_33 )
return;
...
int F_161 ( struct V_29 * V_30 , unsigned long V_212 )
{
int V_66 = - V_213 ;
F_158 ( & V_30 -> V_52 ) ;
if ( ! F_34 ( V_30 -> V_53 ) )
...
int F_162 ( struct V_123 * V_27 , unsigned long V_212 )
{
...
int F_163 ( struct V_29 * V_30 , unsigned long V_212 )
{
struct V_123 * V_64 ;
int V_66 = 0 ;
struct V_14 * V_15 ;
...
int F_165 ( struct V_29 * V_30 , unsigned long V_212 )
{
int V_66 = - V_213 ;
V_19 V_40 ;
struct V_14 * V_15 ;
