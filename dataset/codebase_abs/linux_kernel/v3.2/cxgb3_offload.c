...
struct V_283 * V_175 ;
struct V_217 * V_300 ;
V_296 = F_117 ( V_273 ) -> V_18 ;
V_297 = F_117 ( V_274 ) -> V_18 ;
if ( ! F_124 ( V_296 ) )
return;
if ( ! F_124 ( V_297 ) ) {
F_24 ( V_301 L_16
...
V_175 = F_132 ( V_2 , F_117 ( V_274 ) , V_297 ) ;
if ( ! V_175 ) {
F_24 ( V_233 L_20 ,
V_285 ) ;
return;
...
V_318:
F_158 ( F_134 ( V_18 ) ) ;
F_159 ( V_18 -> V_315 , NULL ) ;
V_314:
F_142 ( V_91 ) ;
return V_308 ;
}
static void F_160 ( struct V_322 * V_323 )
{
...
V_325 = F_134 ( V_2 ) ;
F_18 () ;
F_159 ( V_2 -> V_315 , NULL ) ;
F_163 ( & V_325 -> V_322 , F_160 ) ;
if ( V_91 -> V_219 )
F_121 ( V_91 -> V_219 ) ;
F_142 ( V_91 ) ;
}
...
static inline int F_166 ( struct V_3 * V_3 )
{
int type = 0 ;
