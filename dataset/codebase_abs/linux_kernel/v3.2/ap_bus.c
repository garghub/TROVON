...
void F_127 ( struct V_40 * V_41 , struct V_93 * V_94 )
{
struct V_93 * V_148 ;
F_33 ( & V_41 -> V_56 ) ;
if ( ! F_123 ( & V_94 -> V_91 ) ) {
...
static enum F_112 F_128 ( struct V_150 * V_129 )
{
F_52 ( & V_75 ) ;
return V_151 ;
}
static void F_129 ( struct V_40 * V_41 )
{
int V_28 ;
V_41 -> V_47 = V_49 ;
F_64 ( V_41 -> V_45 , & V_99 ) ;
...
static void F_130 ( unsigned long V_39 )
{
unsigned long V_71 ;
struct V_40 * V_41 ;
if ( F_1 () )
...
F_143 ( & V_159 ) ;
if ( ! V_107 ) {
V_107 = F_144 ( F_134 , NULL , L_18 ) ;
V_28 = F_145 ( V_107 ) ? F_146 ( V_107 ) : 0 ;
if ( V_28 )
V_107 = NULL ;
}
else
...
V_28 = F_158 ( & V_104 , V_161 [ V_13 ] ) ;
if ( V_28 )
goto V_162;
}
V_139 = F_159 ( L_22 ) ;
V_28 = F_145 ( V_139 ) ? F_146 ( V_139 ) : 0 ;
if ( V_28 )
goto V_162;
V_74 = F_49 ( L_15 ) ;
if ( ! V_74 ) {
...
static int F_167 ( struct V_50 * V_51 , void * V_81 )
{
return 1 ;
}
void F_168 ( void )
