...
if ( F_32 ( V_10 , V_80 , V_4 , V_41 , 64 ) < 0 ) {
F_15 ( 1 , L_17 ) ;
return - V_23 ;
}
if ( V_81 ) {
...
L_38 } ;
char * V_138 = V_39 -> V_140 [ 0 ] . V_128 -> V_141 . F_8 . V_138 ;
F_50 ( V_138 , V_97 , 128 ) ;
...
V_16 -> V_75 = 1 ;
V_16 -> V_84 = 4 ;
V_39 -> V_140 [ 0 ] . V_128 = F_53 ( V_142 , & V_143 ,
& V_39 -> V_2 -> V_144 ) ;
if ( V_39 -> V_140 [ 0 ] . V_128 ) {
F_8 ( L_39 ) ;
V_16 -> V_90 = 4 ;
V_16 -> V_89 = 4 ;
V_16 -> V_88 = 0xc0 ;
...
V_16 -> V_84 = 4 ;
V_39 -> V_140 [ 0 ] . V_128 = F_53 ( V_145 , & V_146 ,
& V_39 -> V_2 -> V_144 ) ;
if ( V_39 -> V_140 [ 0 ] . V_128 ) {
F_8 ( L_40 ) ;
V_16 -> V_90 = 4 ;
...
V_16 -> V_84 = 5 ;
V_39 -> V_140 [ 0 ] . V_128 = F_53 ( V_147 , & V_148 ,
& V_39 -> V_2 -> V_144 ) ;
if ( V_39 -> V_140 [ 0 ] . V_128 ) {
F_8 ( L_41 ) ;
V_16 -> V_90 = 4 ;
...
V_107: if ( V_6 ) {
if ( V_39 -> V_140 [ 0 ] . V_128 ) {
F_54 ( V_39 -> V_140 [ 0 ] . V_128 ) ;
V_39 -> V_140 [ 0 ] . V_128 = NULL ;
}
V_39 -> V_2 -> V_95 . V_149 . V_150 . V_151 = NULL ;
return - V_25 ;
}
V_39 -> V_140 [ 0 ] . V_128 -> V_141 . V_152 = F_48 ;
V_6 = F_49 ( V_39 ) ;
return V_6 ;
}
...
{
struct V_15 * V_16 = V_39 -> V_2 -> V_17 ;
char * V_153 [] = { L_35 , L_43 , L_44 , L_45 } ;
int V_6 = 0 ;
switch ( V_16 -> V_53 ) {
case V_54 :
if ( F_53 ( V_154 , V_39 -> V_140 [ 0 ] . V_128 , 0xc0 ,
& V_39 -> V_2 -> V_144 , 1 ) )
V_6 = V_16 -> V_53 ;
break;
case V_59 :
if ( F_53 ( V_155 , V_39 -> V_140 [ 0 ] . V_128 , & V_156 ,
& V_39 -> V_2 -> V_144 ) )
V_6 = V_16 -> V_53 ;
break;
case V_60 :
if ( F_53 ( V_157 , V_39 -> V_140 [ 0 ] . V_128 , 0xc0 ,
& V_39 -> V_2 -> V_144 , V_158 ) )
V_6 = V_16 -> V_53 ;
break;
default:
break;
...
return - V_23 ;
if ( V_67 )
V_6 = F_6 ( V_10 , V_159 , V_4 , V_13 , V_14 ) ;
else
...
{
struct V_1 * V_24 = F_58 ( V_164 ) ;
int V_6 = 0 ;
F_59 ( V_24 ) ;
F_60 ( V_24 , V_164 -> V_167 -> V_97 . V_168 , 1 ) ;
if ( V_24 -> V_169 != V_170 ) {
V_6 = F_61 ( V_24 ) ;
F_8 ( L_49 ) ;
return - V_25 ;
...
if ( 0 == F_62 ( V_164 , & V_171 ,
V_172 , NULL , V_173 ) ) {
F_8 ( L_50 ) ;
return 0 ;
}
if ( 0 == F_62 ( V_164 , & V_174 ,
V_172 , NULL , V_173 ) ) {
F_8 ( L_50 ) ;
return 0 ;
}
