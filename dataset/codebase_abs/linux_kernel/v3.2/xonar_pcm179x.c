...
if ( V_101 <= 96000 && ( V_101 > 48000 || V_13 -> V_36 ) ) {
V_102 |= F_30 ( V_93 ) ;
V_4 = V_89 ;
} else {
V_102 |= F_30 ( V_94 ) ;
...
break;
case 2 :
V_121 = ( V_121 | V_72 ) & ~ V_70 ;
break;
}
F_24 ( V_2 , V_46 , V_121 ) ;
V_13 -> V_25 = V_121 & V_72 ;
F_48 ( V_2 ) ;
F_60 ( & V_2 -> V_119 ) ;
return V_121 != V_122 ;
}
...
{
int V_135 ;
V_135 = F_74 ( V_2 -> V_49 , F_75 ( & V_137 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
V_135 = F_73 ( V_2 ) ;
if ( V_135 < 0 )
...
{
int V_135 ;
V_135 = F_74 ( V_2 -> V_49 , F_75 ( & V_138 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
V_135 = F_73 ( V_2 ) ;
if ( V_135 < 0 )
