...
static int F_77 ( struct V_1 * V_2 , T_4 V_87 )
{
F_31 ( V_2 , V_67 ) ;
return 0 ;
}
...
static int T_5 F_79 ( struct V_211 * V_212 ,
...
V_9 = F_80 ( sizeof( struct V_8 ) , V_218 ) ;
if ( V_9 == NULL )
return - V_209 ;
V_9 -> V_13 = V_212 ;
F_81 ( & V_9 -> V_17 ) ;
...
static int T_6 F_91 ( struct V_211 * V_212 )
{
struct V_8 * V_9 = F_92 ( V_212 ) ;
if ( F_13 ( V_9 -> V_12 ) )
F_18 ( V_9 -> V_2 , 0 ) ;
if ( V_9 -> V_44 >= 0 )
F_89 ( V_9 -> V_44 ) ;
