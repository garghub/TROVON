...
F_84 ( V_4 -> V_135 , & V_137 ) ;
V_4 -> V_135 -> V_14 = F_85 ( V_133 , V_132 ) ;
V_4 -> V_135 -> V_138 = V_137 . V_138 ;
V_41 = F_86 ( V_4 -> V_135 , V_4 -> V_135 -> V_14 , 1 ) ;
if ( V_41 )
goto V_139;
if ( V_4 -> V_3 -> V_7 . V_140 == V_141 ) {
if ( V_4 -> V_100 == V_102 )
sprintf ( V_134 , L_22 , F_26 ( & V_3 -> V_14 ) ) ;
if ( V_4 -> V_100 == V_101 )
sprintf ( V_134 , L_23 , F_26 ( & V_3 -> V_14 ) ) ;
} else if ( V_4 -> V_3 -> V_7 . V_140 == V_142 ) {
sprintf ( V_134 , L_24 , F_26 ( & V_3 -> V_14 ) ) ;
} else {
V_41 = - V_66 ;
goto V_139;
}
V_4 -> V_55 = F_87 ( V_143 , NULL , V_4 -> V_135 -> V_14 ,
NULL , L_25 , V_134 ) ;
if ( F_42 ( V_4 -> V_55 ) ) {
V_41 = F_43 ( V_4 -> V_55 ) ;
F_10 ( L_26 , V_41 ) ;
...
static int F_89 ( struct V_2 * V_3 , int V_144 )
{
struct V_1 * V_4 ;
int V_41 ;
F_10 ( L_27 , V_3 ) ;
...
if ( ! V_144 && ( F_90 ( & V_4 -> V_13 ) > 2 ) ) {
F_10 ( L_28 ) ;
V_41 = - V_21 ;
goto V_129;
}
F_91 ( V_143 , V_4 -> V_135 -> V_14 ) ;
F_88 ( V_4 -> V_135 ) ;
V_4 -> V_135 = NULL ;
V_41 = 0 ;
V_129:
...
V_147 = F_95 ( L_31 , 4 , 1 , 4 * sizeof( long ) ) ;
if ( ! V_147 )
return - V_32 ;
V_41 = F_96 ( V_147 , & V_148 ) ;
if ( V_41 )
goto V_149;
F_97 ( V_147 , 6 ) ;
V_143 = F_98 ( V_150 , L_31 ) ;
if ( F_42 ( V_143 ) ) {
V_41 = F_43 ( V_143 ) ;
goto V_149;
}
...
if ( V_41 )
goto V_151;
V_41 = F_100 ( & V_14 , 0 , V_152 , L_31 ) ;
if ( V_41 ) {
F_25 ( L_32
L_33 , V_41 ) ;
goto V_153;
}
V_136 = F_85 ( F_82 ( V_14 ) , 0 ) ;
F_101 ( L_34 , V_20 ) ;
return 0 ;
V_153:
F_102 ( & V_18 ) ;
