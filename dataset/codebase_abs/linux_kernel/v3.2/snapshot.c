...
V_104 = 0 ;
if ( V_24 < V_38 )
V_24 = F_104 (unsigned long, pages, max_size) ;
F_105 ( V_116 - V_24 ) ;
V_126 = F_94 ( V_111 / 2 ) ;
...
static unsigned int F_107 ( unsigned int V_134 )
{
...
static unsigned int
F_107 ( unsigned int V_134 ) { return 0 ; }
static int F_108 ( unsigned int V_101 , unsigned int V_134 )
{
struct V_46 * V_46 ;
...
static inline int F_109 ( int V_7 )
{
V_93 = F_3 ( V_136 | V_137 , V_7 ) ;
return V_93 ? 0 : - V_42 ;
}
static inline unsigned int
F_110 ( struct V_31 * V_32 , unsigned int V_134 )
{
...
static inline int F_109 ( int V_7 ) { return 0 ; }
static inline unsigned int
F_110 ( struct V_31 * V_32 , unsigned int V_81 ) { return 0 ; }
static int
F_111 ( struct V_31 * V_95 , struct V_31 * V_94 ,
...
if ( ! F_108 ( V_101 , V_134 ) ) {
F_57 ( V_139 L_12 ) ;
return - V_42 ;
}
if ( F_111 ( & V_95 , & V_94 , V_101 , V_134 ) ) {
F_57 ( V_139 L_13 ) ;
return - V_42 ;
}
F_113 ( NULL ) ;
...
{
memcpy ( & V_141 -> V_142 , F_115 () , sizeof( struct V_143 ) ) ;
V_141 -> V_144 = V_145 ;
return 0 ;
}
static char * F_116 ( struct V_140 * V_141 )
{
if ( V_141 -> V_144 != V_145 )
return L_15 ;
if ( strcmp ( V_141 -> V_142 . V_146 , F_115 () -> V_146 ) )
return L_16 ;
if ( strcmp ( V_141 -> V_142 . V_147 , F_115 () -> V_147 ) )
return L_17 ;
if ( strcmp ( V_141 -> V_142 . V_148 , F_115 () -> V_148 ) )
return L_18 ;
if ( strcmp ( V_141 -> V_142 . V_149 , F_115 () -> V_149 ) )
return L_19 ;
return NULL ;
}
unsigned long F_117 ( void )
{
return V_96 + V_97 + 1 ;
}
static int F_118 ( struct V_140 * V_141 )
{
...
static inline void
F_119 ( unsigned long * V_152 , struct V_31 * V_32 )
{
int V_153 ;
...
static int F_123 ( struct V_31 * V_32 )
{
struct V_46 * V_46 ;
unsigned long V_55 , V_82 ;
F_33 (zone) {
...
static void
F_125 ( struct V_31 * V_85 , struct V_31 * V_86 )
{
unsigned long V_55 ;
F_22 ( V_86 ) ;
V_55 = F_51 ( V_86 ) ;
...
static int F_126 ( struct V_140 * V_141 )
{
char * V_157 ;
V_157 = F_116 ( V_141 ) ;
...
static int F_128 ( unsigned long * V_152 , struct V_31 * V_32 )
{
int V_153 ;
for ( V_153 = 0 ; V_153 < V_3 / sizeof( long ) ; V_153 ++ ) {
if ( F_90 ( V_152 [ V_153 ] == V_62 ) )
...
static unsigned int F_130 ( struct V_31 * V_32 )
{
unsigned long V_55 ;
unsigned int V_79 = 0 ;
F_22 ( V_32 ) ;
...
static int
F_131 ( struct V_31 * V_32 , unsigned int * V_159 )
{
unsigned int V_138 ;
...
static void *
F_132 ( struct V_11 * V_11 , struct V_19 * V_20 )
{
struct V_162 * V_163 ;
void * V_156 ;
if ( F_59 ( V_11 ) && F_5 ( V_11 ) ) {
...
static inline int F_137 ( void ) { return 0 ; }
static unsigned int
F_130 ( struct V_31 * V_32 ) { return 0 ; }
static inline int
F_131 ( struct V_31 * V_32 , unsigned int * V_159 )
{
return 0 ;
...
static inline int F_135 ( void ) { return 1 ; }
static inline void F_136 ( void ) {}
static int
F_138 ( struct V_31 * V_170 , struct V_31 * V_32 )
{
unsigned int V_101 , V_134 ;
...
static void * F_139 ( struct V_31 * V_32 , struct V_19 * V_20 )
{
struct V_163 * V_163 ;
struct V_11 * V_11 ;
...
error = F_128 ( V_93 , & V_94 ) ;
if ( error )
return error ;
if ( V_155 -> V_33 == V_97 + 1 ) {
error = F_138 ( & V_95 , & V_94 ) ;
if ( error )
return error ;
F_19 ( & V_20 , V_136 , V_10 ) ;
F_22 ( & V_95 ) ;
V_98 = NULL ;
V_155 -> V_93 = F_139 ( & V_95 , & V_20 ) ;
V_155 -> V_176 = 0 ;
if ( F_142 ( V_155 -> V_93 ) )
return F_143 ( V_155 -> V_93 ) ;
}
} else {
F_134 () ;
F_144 ( V_155 -> V_93 ) ;
...
int F_147 ( struct V_154 * V_155 )
{
return ! ( ! V_96 || ! F_135 () ||
V_155 -> V_33 <= V_97 + V_96 ) ;
}
static inline void
F_148 ( struct V_11 * V_177 , struct V_11 * V_178 , void * V_152 )
{
void * V_179 , * V_180 ;
...
return - V_42 ;
while ( V_163 ) {
F_148 ( V_163 -> F_88 , V_163 -> V_165 , V_152 ) ;
V_163 = V_163 -> V_18 ;
}
F_12 ( V_152 , V_58 ) ;
return 0 ;
