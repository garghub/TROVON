...
static void F_34 ( struct V_2 * V_44 , unsigned int V_14 )
{
struct V_28 * V_29 ;
V_29 = F_35 ( sizeof( * V_29 ) , V_45 ) ;
if ( ! V_29 ) {
F_36 ( V_46 L_1 ,
V_14 , V_44 -> type ) ;
return;
...
static int F_40 ( struct V_51 * V_47 , void * V_56 )
{
struct V_7 * V_8 = F_41 ( V_47 ) ;
struct V_28 * V_29 = F_6 ( V_8 ) ;
...
static void F_45 ( unsigned int V_60 ,
...
static T_5 int F_57 ( T_2 V_81 , const char * V_15 , int V_82 )
{
char V_83 [ 17 ] ;
