...
T_6 V_107 = 0 ;
struct V_27 * V_8 = V_2 -> V_8 ;
unsigned long V_153 = F_80 ( V_8 ) ;
unsigned long V_154 ;
if ( F_46 ( ! V_152 || ! V_153 ) )
return;
F_81 ( V_154 ) ;
V_141 = V_2 -> V_19 . V_110 . V_143 -> V_144 () ;
V_151 = V_155 -> V_156 ( V_8 ) ;
if ( F_28 ( V_152 > V_151 ) ) {
...
static void F_84 ( struct V_1 * V_2 , T_1 V_157 )
{
int V_158 = F_22 ( F_1 ( V_2 , V_159 ) ) ;
if ( F_22 ( V_157 ) ) {
if ( ! V_158 ) {
F_39 ( L_31
L_32 , V_2 -> V_8 -> V_67 ) ;
V_2 -> V_8 -> V_32 -> V_9 . V_160 ++ ;
}
} else if ( V_158 )
V_2 -> V_8 -> V_32 -> V_9 . V_160 -- ;
}
static int F_85 ( struct V_1 * V_2 , T_1 V_161 , T_1 V_5 )
{
int V_162 = 0 ;
F_86 ( V_161 , V_5 ) ;
switch ( V_161 ) {
...
case V_174 :
if ( F_26 ( V_2 ) ) {
F_85 ( V_2 , V_97 , 0x40000 | ( V_5 & 0xff ) ) ;
} else
V_162 = 1 ;
break;
default:
...
static int F_88 ( struct V_126 * V_134 ,
...
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
if ( V_2 )
F_85 ( V_8 -> V_9 . V_2 , V_163 , 0 ) ;
}
void F_90 ( struct V_27 * V_8 )
{
if ( ! V_8 -> V_9 . V_2 )
return;
F_87 ( & V_8 -> V_9 . V_2 -> V_19 . V_110 ) ;
if ( V_8 -> V_9 . V_2 -> V_4 )
F_91 ( ( unsigned long ) V_8 -> V_9 . V_2 -> V_4 ) ;
F_92 ( V_8 -> V_9 . V_2 ) ;
}
T_6 F_93 ( struct V_27 * V_8 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
if ( ! V_2 )
return 0 ;
...
void F_94 ( struct V_27 * V_8 , T_6 V_129 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
if ( ! V_2 )
return;
...
void F_95 ( struct V_27 * V_8 , unsigned long V_175 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
if ( ! V_2 )
return;
F_41 ( V_2 , ( ( V_175 & 0x0f ) << 4 )
| ( F_1 ( V_2 , V_58 ) & 4 ) ) ;
}
T_6 F_96 ( struct V_27 * V_8 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
T_6 V_52 ;
if ( ! V_2 )
...
void F_97 ( struct V_27 * V_8 , T_6 V_176 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
if ( ! V_2 ) {
V_176 |= V_177 ;
...
if ( F_26 ( V_2 ) ) {
T_1 V_178 = F_16 ( V_2 ) ;
T_1 V_179 = ( ( V_178 & ~ 0xf ) << 16 ) | ( 1 << ( V_178 & 0xf ) ) ;
F_2 ( V_2 , V_63 , V_179 ) ;
}
...
F_2 ( V_2 , V_42 + 0x10 * V_166 , 0 ) ;
F_2 ( V_2 , V_51 + 0x10 * V_166 , 0 ) ;
F_2 ( V_2 , V_79 + 0x10 * V_166 , 0 ) ;
}
V_2 -> V_41 = false ;
F_74 ( V_2 ) ;
F_76 ( & V_2 -> V_19 . V_142 , 0 ) ;
...
bool F_101 ( struct V_27 * V_8 )
{
return V_8 -> V_9 . V_2 && F_13 ( V_8 -> V_9 . V_2 ) ;
}
int F_102 ( struct V_27 * V_8 )
{
return F_101 ( V_8 ) && F_14 ( V_8 -> V_9 . V_2 ) ;
}
static bool F_103 ( struct V_183 * V_184 )
{
struct V_1 * V_2 = F_69 ( V_184 , struct V_1 ,
V_19 ) ;
return F_20 ( V_2 ) ;
}
int F_104 ( struct V_27 * V_8 )
{
struct V_1 * V_185 = V_8 -> V_9 . V_2 ;
if ( V_185 && F_15 ( V_185 ) && F_17 ( V_185 , V_18 ) )
return F_105 ( & V_185 -> V_19 . V_142 ) ;
return 0 ;
}
static int F_106 ( struct V_1 * V_2 , int V_15 )
{
T_1 V_161 = F_1 ( V_2 , V_15 ) ;
int V_48 , V_186 , V_50 ;
if ( F_13 ( V_2 ) && ! ( V_161 & V_16 ) ) {
V_48 = V_161 & V_17 ;
V_186 = V_161 & V_25 ;
V_50 = V_161 & V_187 ;
return F_36 ( V_2 , V_186 , V_48 , 1 , V_50 ) ;
}
return 0 ;
}
void F_107 ( struct V_27 * V_8 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
if ( V_2 )
F_106 ( V_2 , V_159 ) ;
}
int F_108 ( struct V_27 * V_8 )
{
struct V_1 * V_2 ;
ASSERT ( V_8 != NULL ) ;
F_39 ( L_46 , V_8 -> V_67 ) ;
V_2 = F_109 ( sizeof( * V_2 ) , V_188 ) ;
if ( ! V_2 )
goto V_189;
V_8 -> V_9 . V_2 = V_2 ;
V_2 -> V_4 = ( void * ) F_110 ( V_188 ) ;
if ( ! V_2 -> V_4 ) {
F_50 ( V_89 L_47 ,
V_8 -> V_67 ) ;
goto V_190;
...
V_2 -> V_8 = V_8 ;
F_111 ( & V_2 -> V_19 . V_110 , V_191 ,
V_147 ) ;
V_2 -> V_19 . V_110 . V_192 = V_193 ;
V_2 -> V_19 . V_194 = & V_195 ;
V_2 -> V_19 . V_32 = V_8 -> V_32 ;
V_2 -> V_19 . V_8 = V_8 ;
V_2 -> V_133 = V_196 ;
V_8 -> V_9 . V_10 = V_196 ;
F_99 ( V_8 ) ;
F_112 ( & V_2 -> V_127 , & V_197 ) ;
return 0 ;
V_190:
F_92 ( V_2 ) ;
V_189:
...
int F_114 ( struct V_27 * V_8 )
{
T_1 V_199 = F_1 ( V_8 -> V_9 . V_2 , V_159 ) ;
int V_200 = 0 ;
if ( ! F_13 ( V_8 -> V_9 . V_2 ) )
V_200 = 1 ;
if ( ( V_199 & V_16 ) == 0 &&
...
void F_116 ( struct V_27 * V_8 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
if ( V_2 && F_105 ( & V_2 -> V_19 . V_142 ) > 0 ) {
if ( F_106 ( V_2 , V_18 ) )
F_117 ( & V_2 -> V_19 . V_142 ) ;
}
}
int F_118 ( struct V_27 * V_8 )
{
int V_48 = F_113 ( V_8 ) ;
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
if ( V_48 == - 1 )
...
T_1 V_129 ;
void * V_202 ;
if ( ! F_24 ( V_8 -> V_32 ) || ! V_8 -> V_9 . V_2 -> V_203 )
return;
V_202 = F_123 ( V_8 -> V_9 . V_2 -> V_204 , V_205 ) ;
V_129 = * ( T_1 * ) ( V_202 + F_124 ( V_8 -> V_9 . V_2 -> V_203 ) ) ;
F_125 ( V_202 , V_205 ) ;
F_41 ( V_8 -> V_9 . V_2 , V_129 & 0xff ) ;
}
void F_126 ( struct V_27 * V_8 )
{
T_1 V_129 , V_52 ;
int V_206 , V_207 ;
struct V_1 * V_2 ;
...
V_202 = F_123 ( V_8 -> V_9 . V_2 -> V_204 , V_205 ) ;
* ( T_1 * ) ( V_202 + F_124 ( V_8 -> V_9 . V_2 -> V_203 ) ) = V_129 ;
F_125 ( V_202 , V_205 ) ;
}
void F_127 ( struct V_27 * V_8 , T_7 V_203 )
{
if ( ! F_24 ( V_8 -> V_32 ) )
return;
V_8 -> V_9 . V_2 -> V_203 = V_203 ;
}
int F_128 ( struct V_27 * V_8 , T_1 V_208 , T_6 V_129 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
T_1 V_161 = ( V_208 - V_209 ) << 4 ;
if ( ! F_24 ( V_8 -> V_32 ) || ! F_26 ( V_2 ) )
return 1 ;
if ( V_208 == 0x830 )
F_85 ( V_2 , V_99 , ( T_1 ) ( V_129 >> 32 ) ) ;
return F_85 ( V_2 , V_161 , ( T_1 ) V_129 ) ;
}
int F_129 ( struct V_27 * V_8 , T_1 V_208 , T_6 * V_129 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
T_1 V_161 = ( V_208 - V_209 ) << 4 , V_210 , V_211 = 0 ;
if ( ! F_24 ( V_8 -> V_32 ) || ! F_26 ( V_2 ) )
return 1 ;
if ( F_70 ( V_2 , V_161 , 4 , & V_210 ) )
return 1 ;
if ( V_208 == 0x830 )
...
int F_130 ( struct V_27 * V_8 , T_1 V_161 , T_6 V_129 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
if ( ! F_24 ( V_8 -> V_32 ) )
return 1 ;
...
int F_131 ( struct V_27 * V_8 , T_1 V_161 , T_6 * V_129 )
{
struct V_1 * V_2 = V_8 -> V_9 . V_2 ;
T_1 V_210 , V_211 = 0 ;
if ( ! F_24 ( V_8 -> V_32 ) )
