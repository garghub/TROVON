...
int V_222 ;
if ( ! V_11 || V_11 -> V_173 < V_215 || ! F_119
|| ! V_11 -> V_223 || ! V_11 -> V_224 )
return - V_172 ;
if ( ! V_5 )
return - V_10 ;
if ( V_5 -> V_11 )
...
V_11 -> V_11 . V_16 ) ;
if ( V_5 -> V_208 ) {
V_222 = F_121 ( V_5 -> V_208 , & V_5 -> V_78 ) ;
if ( V_222 ) {
F_19 ( V_5 -> V_90 , L_75 ) ;
goto V_228;
}
...
if ( ! V_5 )
return - V_10 ;
if ( ! V_11 || V_11 != V_5 -> V_11 || ! V_11 -> V_229 )
return - V_172 ;
F_123 ( V_5 , V_11 ) ;
F_108 ( V_5 ) ;
F_98 ( V_5 , 0 ) ;
...
if ( F_59 ( F_37 ( V_45 ) ) )
goto V_236;
V_233 . V_232 [ V_48 ] = F_9 ( V_45 , V_156 ) ;
}
V_234 = ! F_37 ( V_45 ) ;
while ( ! F_37 ( V_45 ) ) {
V_48 = F_9 ( V_45 , V_156 ) ;
...
F_42 ( V_45 , L_78 ,
V_233 . V_231 . V_237 , V_233 . V_231 . V_238 ,
F_127 ( V_233 . V_231 . V_239 ) , F_127 ( V_233 . V_231 . V_240 ) ,
F_127 ( V_233 . V_231 . V_241 ) ) ;
if ( F_59 ( V_234 ) )
goto V_236;
if ( V_233 . V_231 . V_237 & V_150 )
F_40 ( V_5 , V_181 ) ;
else
F_40 ( V_5 , V_182 ) ;
F_33 ( V_45 , V_57 | V_63 ) ;
F_66 ( & V_45 -> V_148 , V_145 ) ;
V_48 = V_5 -> V_11 -> V_224 ( & V_5 -> V_78 , & V_233 . V_231 ) ;
F_69 ( & V_45 -> V_148 , V_145 ) ;
if ( V_48 < 0 )
goto V_236;
V_12:
...
F_42 ( V_45 , L_79 ,
F_9 ( V_45 , V_56 ) , V_48 ) ;
F_33 ( V_45 , V_59 | V_242 ) ;
F_40 ( V_5 , V_189 ) ;
goto V_12;
}
static void F_128 ( struct V_4 * V_5 , int V_243 , int V_244 )
{
T_1 V_245 ;
struct V_44 * V_45 = & V_5 -> V_44 [ 0 ] ;
...
V_245 = F_9 ( V_45 , V_56 ) ;
F_42 ( V_45 , L_80 ,
F_41 ( V_5 ) , V_47 , V_245 , F_9 ( V_45 , V_69 ) ,
( V_243 << 1 | V_244 ) ) ;
if ( V_245 & V_60 ) {
F_42 ( V_45 , L_81 ) ;
F_74 ( V_45 , - V_246 ) ;
...
V_47 . V_241 = 0 ;
F_40 ( V_5 , V_179 ) ;
V_5 -> V_11 -> V_224 ( & V_5 -> V_78 , & V_47 ) ;
F_33 ( & V_5 -> V_44 [ 0 ] , V_251 ) ;
}
...
static void F_131 ( int V_254 , struct V_4 * V_5 )
{
int V_48 ;
struct V_44 * V_45 ;
T_1 V_255 = F_3 ( V_5 , V_36 ) & V_256 ;
T_1 V_257 = F_3 ( V_5 , V_37 ) & V_258 ;
if ( V_255 & V_259 ) {
V_5 -> V_44 [ 0 ] . V_39 . V_68 ++ ;
F_29 ( V_5 , V_36 , F_132 ( 0 , V_259 ) ) ;
F_128 ( V_5 , ! ! ( V_255 & V_260 ) ,
! ! ( V_255 & V_261 ) ) ;
}
V_255 >>= 2 ;
for ( V_48 = 1 ; V_255 != 0 && V_48 < 16 ; V_255 >>= 2 , V_48 ++ ) {
if ( ! ( V_255 & V_259 ) )
continue;
F_29 ( V_5 , V_36 , F_132 ( V_48 , V_259 ) ) ;
...
for ( V_48 = 16 ; V_257 != 0 && V_48 < 24 ; V_257 >>= 2 , V_48 ++ ) {
F_29 ( V_5 , V_37 , F_132 ( V_48 - 16 , V_259 ) ) ;
if ( ! ( V_257 & V_259 ) )
continue;
F_56 ( V_48 >= F_133 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_133 ( V_5 -> V_44 ) ) {
...
V_5 -> V_39 . V_41 ++ ;
if ( V_5 -> V_78 . V_173 != V_174
&& V_5 -> V_11 && V_5 -> V_11 -> V_263 )
V_5 -> V_11 -> V_263 ( & V_5 -> V_78 ) ;
F_43 ( V_5 ) ;
}
...
memset ( & V_5 -> V_39 , 0 , sizeof V_5 -> V_39 ) ;
F_74 ( V_45 , - V_235 ) ;
F_33 ( V_45 , V_242 | V_63 ) ;
F_43 ( V_5 ) ;
}
static T_5 F_138 ( int V_254 , void * V_269 )
{
struct V_4 * V_5 = V_269 ;
T_1 V_255 = F_3 ( V_5 , V_36 ) ;
T_1 V_257 = F_3 ( V_5 , V_37 ) ;
T_1 V_109 = F_3 ( V_5 , V_17 ) ;
T_1 V_270 ;
F_139 ( V_5 -> V_90 , L_88
L_89 , V_255 , V_257 , V_109 ) ;
V_270 = V_257 & 0xf8000000 ;
if ( F_59 ( V_270 & V_262 ) )
F_134 ( V_5 ) ;
if ( F_59 ( V_270 & V_264 ) )
F_135 ( V_5 ) ;
...
if ( F_59 ( V_270 & V_268 ) )
F_137 ( V_5 ) ;
if ( ( V_255 & V_256 ) | ( V_257 & V_258 ) )
F_131 ( V_254 , V_5 ) ;
return V_271 ;
}
static int T_2 F_140 ( struct V_272 * V_273 )
{
struct V_274 * V_275 ;
struct V_4 * V_5 = & V_276 ;
int V_222 = 0 , V_277 ;
V_275 = F_141 ( V_273 , V_278 , 0 ) ;
if ( ! V_275 )
return - V_279 ;
V_5 -> V_254 = F_142 ( V_273 , 0 ) ;
if ( V_5 -> V_254 < 0 )
return V_5 -> V_254 ;
V_5 -> V_90 = & V_273 -> V_90 ;
V_5 -> V_196 = V_273 -> V_90 . V_280 ;
V_5 -> V_208 = F_143 () ;
V_277 = V_5 -> V_196 -> V_197 ;
if ( F_99 ( V_277 ) ) {
V_222 = F_144 ( V_277 , L_90 ) ;
if ( V_222 == 0 )
F_145 ( V_277 ,
V_5 -> V_196 -> V_198 ) ;
}
if ( V_222 ) {
F_19 ( & V_273 -> V_90 , L_91 ,
V_277 , V_222 ) ;
return V_222 ;
}
V_5 -> V_212 = F_146 ( & V_273 -> V_90 , NULL ) ;
if ( F_16 ( V_5 -> V_212 ) ) {
V_222 = F_147 ( V_5 -> V_212 ) ;
goto V_281;
}
V_222 = - V_282 ;
V_5 -> V_275 = F_148 ( V_275 -> V_283 , F_149 ( V_275 ) ) ;
if ( ! V_5 -> V_275 ) {
F_19 ( & V_273 -> V_90 , L_92 ) ;
goto V_284;
}
F_150 ( & V_5 -> V_78 . V_90 ) ;
V_5 -> V_78 . V_90 . V_285 = & V_273 -> V_90 ;
V_5 -> V_78 . V_90 . V_286 = NULL ;
V_5 -> V_207 = 0 ;
V_221 = V_5 ;
F_151 ( V_273 , V_5 ) ;
F_113 ( V_5 ) ;
F_49 ( V_5 ) ;
V_222 = F_152 ( V_5 -> V_254 , F_138 ,
V_287 , V_14 , V_5 ) ;
if ( V_222 != 0 ) {
F_19 ( V_5 -> V_90 , L_93 ,
V_14 , V_288 , V_222 ) ;
...
V_222 = F_153 ( & V_273 -> V_90 , & V_5 -> V_78 ) ;
if ( V_222 )
goto V_290;
F_14 ( V_5 ) ;
return 0 ;
...
static int T_6 F_157 ( struct V_272 * V_269 )
{
struct V_4 * V_5 = F_158 ( V_269 ) ;
int V_277 = V_5 -> V_196 -> V_197 ;
F_159 ( & V_5 -> V_78 ) ;
F_160 ( V_5 -> V_11 ) ;
F_154 ( V_5 -> V_254 , V_5 ) ;
F_20 ( V_5 ) ;
...
static void F_163 ( struct V_272 * V_269 )
{
struct V_4 * V_5 = F_158 ( V_269 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_108 ( V_5 ) ;
}
static int F_164 ( struct V_272 * V_269 , T_7 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_158 ( V_269 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
V_5 -> V_245 = F_9 ( V_45 , V_56 ) ;
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
...
static int F_165 ( struct V_272 * V_269 )
{
int V_48 ;
struct V_4 * V_5 = F_158 ( V_269 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
F_35 ( V_45 , V_56 , V_5 -> V_245 & ( V_59 | V_61 ) ) ;
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
...
if ( ! F_168 () && ! F_169 () )
return - V_10 ;
F_170 ( V_294 L_95 , V_14 , V_15 ) ;
return F_171 ( & V_295 , F_140 ) ;
}
