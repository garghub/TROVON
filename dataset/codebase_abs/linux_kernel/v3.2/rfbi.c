...
V_133 ) ;
F_59 ( V_134 ) ;
F_60 ( V_34 -> V_40 -> V_41 , true ) ;
F_61 ( V_34 -> V_40 -> V_41 , V_34 -> V_135 . V_114 ) ;
...
int F_65 ( struct V_33 * V_34 )
{
V_4 . V_34 [ V_34 -> V_116 . V_4 . V_117 ] = V_34 ;
V_34 -> V_136 = V_137 ;
return 0 ;
}
static int F_66 ( struct V_138 * V_7 )
{
T_1 V_139 ;
struct V_140 * V_141 ;
struct V_142 * V_142 ;
...
V_4 . V_7 = V_7 ;
F_67 ( & V_4 . V_9 , 1 ) ;
V_141 = F_68 ( V_4 . V_7 , V_143 , 0 ) ;
if ( ! V_141 ) {
F_38 ( L_21 ) ;
V_6 = - V_93 ;
goto V_144;
}
V_4 . V_5 = F_69 ( V_141 -> V_145 , F_70 ( V_141 ) ) ;
if ( ! V_4 . V_5 ) {
F_38 ( L_22 ) ;
V_6 = - V_146 ;
goto V_144;
...
goto V_147;
F_72 ( 10 ) ;
V_142 = F_73 ( & V_7 -> V_8 , L_23 ) ;
if ( F_74 ( V_142 ) ) {
F_38 ( L_24 ) ;
V_6 = F_75 ( V_142 ) ;
goto V_148;
}
V_4 . V_47 = F_76 ( V_142 ) / 1000 ;
F_77 ( V_142 ) ;
V_139 = F_3 ( V_124 ) ;
F_78 ( & V_7 -> V_8 , L_25 ,
F_79 ( V_139 , 7 , 4 ) , F_79 ( V_139 , 3 , 0 ) ) ;
F_9 () ;
return 0 ;
V_148:
F_9 () ;
...
static int F_82 ( struct V_138 * V_7 )
{
F_80 ( & V_7 -> V_8 ) ;
F_81 ( V_4 . V_5 ) ;
return 0 ;
}
static int F_83 ( struct V_149 * V_8 )
{
F_84 () ;
F_85 () ;
return 0 ;
}
static int F_86 ( struct V_149 * V_8 )
{
int V_6 ;
V_6 = F_87 () ;
if ( V_6 < 0 )
