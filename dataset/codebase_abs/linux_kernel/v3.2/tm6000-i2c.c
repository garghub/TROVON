...
F_2 ( V_38 L_9 , V_28 [ V_31 ] . V_5 [ V_32 ] ) ;
F_8 ( 2 , L_10 ,
V_31 == V_29 - 2 ? L_5 : L_6 ,
V_28 [ V_31 + 1 ] . V_6 ) ;
if ( V_28 [ V_31 ] . V_6 == 2 ) {
...
{
int V_31 , V_7 ;
unsigned char * V_42 = V_2 -> V_43 ;
unsigned char V_44 [ 17 ] ;
V_2 -> V_45 . V_3 = 0xa0 >> 1 ;
V_2 -> V_46 = 0 ;
V_44 [ 16 ] = '\0' ;
for ( V_31 = 0 ; V_31 < sizeof( V_2 -> V_43 ) ; ) {
* V_42 = V_31 ;
V_7 = F_5 ( V_2 , 0xa0 , V_31 , V_42 , 1 ) ;
if ( V_7 < 1 ) {
if ( V_42 == V_2 -> V_43 )
goto V_47;
else {
...
V_42 ++ ;
if ( 0 == ( V_31 % 16 ) )
F_2 ( V_51 L_14 , V_2 -> V_49 , V_31 ) ;
F_2 ( V_38 L_9 , V_2 -> V_43 [ V_31 ] ) ;
if ( ( V_2 -> V_43 [ V_31 ] >= ' ' ) && ( V_2 -> V_43 [ V_31 ] <= 'z' ) )
V_44 [ V_31 % 16 ] = V_2 -> V_43 [ V_31 ] ;
else
V_44 [ V_31 % 16 ] = '.' ;
V_31 ++ ;
if ( 0 == ( V_31 % 16 ) ) {
...
static T_4 F_11 ( struct V_25 * V_52 )
{
return V_53 ;
}
...
V_2 -> V_26 . V_54 = V_55 ;
V_2 -> V_26 . V_56 = & V_57 ;
V_2 -> V_26 . V_2 . V_58 = & V_2 -> V_59 -> V_2 ;
F_13 ( V_2 -> V_26 . V_49 , V_2 -> V_49 , sizeof( V_2 -> V_26 . V_49 ) ) ;
V_2 -> V_26 . V_30 = V_2 ;
F_14 ( & V_2 -> V_26 , & V_2 -> V_60 ) ;
V_7 = F_15 ( & V_2 -> V_26 ) ;
if ( V_7 )
return V_7 ;
V_2 -> V_45 . V_61 = & V_2 -> V_26 ;
F_13 ( V_2 -> V_45 . V_49 , L_18 , V_62 ) ;
F_10 ( V_2 ) ;
return 0 ;
}
