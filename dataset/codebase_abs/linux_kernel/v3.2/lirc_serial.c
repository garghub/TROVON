...
unsigned long V_108 ;
F_25 ( & V_76 ) ;
F_35 ( & V_11 [ type ] . V_109 , V_108 ) ;
F_3 ( V_84 , F_1 ( V_84 ) & ( ~ V_85 ) ) ;
F_3 ( V_83 , F_1 ( V_83 ) | V_86 ) ;
F_36 ( & V_11 [ type ] . V_109 , V_108 ) ;
return 0 ;
}
...
static T_4 F_38 ( struct V_110 * V_110 , const char * V_111 ,
T_5 V_112 , T_6 * V_113 )
{
int V_36 , V_114 ;
unsigned long V_108 ;
long V_115 = 0 ;
int * V_116 ;
if ( ! ( V_11 [ type ] . V_117 & V_118 ) )
return - V_119 ;
V_114 = V_112 / sizeof( int ) ;
if ( V_112 % sizeof( int ) || V_114 % 2 == 0 )
return - V_32 ;
V_116 = F_39 ( V_111 , V_112 ) ;
if ( F_40 ( V_116 ) )
return F_41 ( V_116 ) ;
F_35 ( & V_11 [ type ] . V_109 , V_108 ) ;
if ( type == V_95 ) {
...
for ( V_36 = 0 ; V_36 < V_114 ; V_36 ++ ) {
if ( V_36 % 2 )
V_11 [ type ] . F_42 ( V_116 [ V_36 ] - V_115 ) ;
else
V_115 = V_11 [ type ] . F_43 ( V_116 [ V_36 ] ) ;
}
V_12 () ;
F_36 ( & V_11 [ type ] . V_109 , V_108 ) ;
F_44 ( V_116 ) ;
...
static long F_45 ( struct V_110 * V_120 , unsigned int V_121 , unsigned long V_122 )
{
int V_102 ;
T_7 V_5 ;
switch ( V_121 ) {
case V_123 :
if ( ! ( V_11 [ type ] . V_117 & V_124 ) )
return - V_125 ;
V_102 = F_46 ( F_47
( V_11 [ type ] . V_117 & V_124 ) ,
( T_7 * ) V_122 ) ;
if ( V_102 )
return V_102 ;
break;
...
break;
default:
return F_49 ( V_120 , V_121 , V_122 ) ;
}
return 0 ;
}
static int T_8 F_50 ( struct V_134 * V_135 )
{
return 0 ;
}
static int T_9 F_51 ( struct V_134 * V_135 )
{
return 0 ;
}
...
{
int V_102 ;
V_102 = F_57 ( & V_52 , sizeof( int ) , V_137 ) ;
if ( V_102 < 0 )
return - V_138 ;
V_102 = F_58 ( & V_139 ) ;
if ( V_102 ) {
...
if ( V_102 < 0 )
goto V_151;
V_152 . V_117 = V_11 [ type ] . V_117 ;
V_152 . V_135 = & V_141 -> V_135 ;
V_152 . V_153 = F_66 ( & V_152 ) ;
if ( V_152 . V_153 < 0 ) {
F_24 (KERN_ERR LIRC_DRIVER_NAME
L_32 ) ;
V_102 = - V_154 ;
