...
struct V_7 * V_38 ;
int V_39 ;
V_38 = F_5 ( V_3 , V_12 , & V_31 -> V_40 . V_41 ) ;
V_39 = V_38 -> error ;
if ( V_39 )
F_9 ( V_38 ) ;
else
...
unsigned int V_42 , T_2 V_43 )
{
const struct V_5 * V_44 = F_4 ( V_2 ) ;
T_1 V_45 = 0 ;
switch ( V_2 -> V_46 ) {
case V_47 :
if ( V_28 != V_48 && V_28 != V_49 )
break;
if ( ! F_24 ( & V_44 -> V_17 , & V_44 -> V_16 ,
V_2 -> V_50 - V_42 , V_43 ,
F_25 ( V_2 -> V_45 ,
F_26 ( V_2 , 0 ,
V_42 , 0 ) ) ) ) {
...
unsigned int V_42 , unsigned int V_50 ,
T_2 V_43 )
{
const struct V_5 * V_44 = F_4 ( V_2 ) ;
T_3 V_53 ;
...
switch ( V_2 -> V_46 ) {
case V_47 :
if ( V_50 == V_2 -> V_50 - V_42 )
return F_23 ( V_2 , V_28 , V_42 , V_43 ) ;
case V_52 :
V_53 = F_26 ( V_2 , 0 , V_42 , 0 ) ;
V_2 -> V_45 = ~ F_27 ( F_24 ( & V_44 -> V_17 ,
& V_44 -> V_16 ,
V_2 -> V_50 - V_42 ,
V_43 ,
F_25 ( 0 , V_53 ) ) ) ;
V_2 -> V_46 = V_52 ;
return F_30 ( V_2 , V_42 + V_50 ) ;
}
return V_45 ;
}
int T_4 F_31 ( void )
