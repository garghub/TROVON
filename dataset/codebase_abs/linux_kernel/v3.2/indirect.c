...
if ( F_10 ( ! F_55 ( & V_35 -> V_112 ) ) ) {
F_56 ( & V_6 -> V_113 ) ;
F_57 ( V_6 ) ;
F_58 ( & V_6 -> V_113 ) ;
}
V_58 = F_59 ( V_93 , V_95 , V_6 ,
V_6 -> V_11 -> V_114 , V_97 ,
V_98 , V_99 ,
V_115 , NULL , NULL , 0 ) ;
} else {
V_58 = F_60 ( V_93 , V_95 , V_6 , V_97 ,
V_98 , V_99 , V_115 ) ;
if ( F_10 ( ( V_93 & V_106 ) && V_58 < 0 ) ) {
T_7 V_116 = F_61 ( V_6 ) ;
T_7 V_117 = V_98 + F_48 ( V_97 , V_99 ) ;
if ( V_117 > V_116 )
F_62 ( V_6 ) ;
}
}
if ( V_58 == - V_87 && F_63 ( V_6 -> V_11 , & V_105 ) )
goto V_110;
if ( V_104 ) {
int V_25 ;
V_47 = F_49 ( V_6 , 2 ) ;
...
int F_66 ( struct V_6 * V_6 , T_9 V_119 )
{
struct V_34 * V_35 = F_7 ( V_6 ) ;
T_9 V_120 = ~ ( ( T_9 ) F_3 ( V_6 -> V_11 ) - 1 ) ;
int V_121 ;
if ( V_119 < V_14 )
return 0 ;
V_119 -= V_14 ;
if ( V_35 -> V_122 &&
( V_119 & V_120 ) == V_35 -> V_123 ) {
V_35 -> V_122 ++ ;
return 0 ;
}
V_35 -> V_123 = V_119 & V_120 ;
V_35 -> V_122 = 1 ;
V_121 = F_67 ( V_119 ) ;
return ( V_121 / F_4 ( V_6 -> V_11 ) ) + 1 ;
}
int F_68 ( struct V_6 * V_6 , int V_124 , int V_125 )
{
int V_126 ;
if ( V_125 ) {
return F_69 ( V_124 ,
...
static T_5 * F_70 ( struct V_6 * V_6 )
{
T_5 * V_127 ;
V_127 = F_49 ( V_6 , F_71 ( V_6 ) ) ;
if ( ! F_50 ( V_127 ) )
return V_127 ;
F_72 ( V_6 -> V_11 , F_51 ( V_127 ) ) ;
return V_127 ;
}
static int F_73 ( T_5 * V_47 , struct V_6 * V_6 )
{
if ( ! F_74 ( V_47 ) )
return 0 ;
if ( F_75 ( V_47 , V_128 + 1 ) )
return 0 ;
if ( ! F_76 ( V_47 , F_71 ( V_6 ) ) )
return 0 ;
return 1 ;
}
static inline int F_77 ( T_2 * V_1 , T_2 * V_129 )
{
while ( V_1 < V_129 )
if ( * V_1 ++ )
return 0 ;
...
goto V_131;
for ( V_1 = V_39 ; ( V_1 > V_24 ) && F_77 ( ( T_2 * ) V_1 -> V_3 -> V_31 , V_1 -> V_1 ) ; V_1 -- )
;
...
static int F_79 ( T_5 * V_47 , struct V_6 * V_6 ,
struct V_2 * V_3 ,
T_4 V_132 ,
unsigned long V_46 , T_2 * V_133 ,
T_2 * V_134 )
{
T_2 * V_1 ;
int V_66 = V_72 | V_135 ;
int V_25 ;
if ( F_80 ( V_6 -> V_65 ) || F_81 ( V_6 -> V_65 ) )
V_66 |= V_136 ;
if ( ! F_82 ( F_83 ( V_6 -> V_11 ) , V_132 ,
V_46 ) ) {
F_21 ( V_6 , L_15
L_16 ,
( unsigned long long ) V_132 , V_46 ) ;
return 1 ;
}
if ( F_73 ( V_47 , V_6 ) ) {
if ( V_3 ) {
...
for ( V_1 = V_133 ; V_1 < V_134 ; V_1 ++ )
* V_1 = 0 ;
F_26 ( V_47 , V_6 , NULL , V_132 , V_46 , V_66 ) ;
return 0 ;
V_137:
F_72 ( V_6 -> V_11 , V_25 ) ;
return V_25 ;
}
static void F_85 ( T_5 * V_47 , struct V_6 * V_6 ,
struct V_2 * V_138 ,
T_2 * V_133 , T_2 * V_134 )
{
T_4 V_132 = 0 ;
...
V_139 = V_1 ;
V_46 = 1 ;
} else if ( V_140 == V_132 + V_46 ) {
V_46 ++ ;
} else {
V_25 = F_79 ( V_47 , V_6 , V_138 ,
V_132 , V_46 ,
V_139 , V_1 ) ;
if ( V_25 )
break;
...
if ( ! V_25 && V_46 > 0 )
V_25 = F_79 ( V_47 , V_6 , V_138 , V_132 ,
V_46 , V_139 , V_1 ) ;
if ( V_25 < 0 )
return;
if ( V_138 ) {
F_30 ( V_138 , L_8 ) ;
if ( ( F_86 ( V_6 ) == NULL ) || F_87 ( V_138 ) )
F_34 ( V_47 , V_6 , V_138 ) ;
else
F_21 ( V_6 ,
L_18
L_19 ,
( unsigned long long ) V_138 -> V_37 ) ;
}
}
static void F_88 ( T_5 * V_47 , struct V_6 * V_6 ,
struct V_2 * V_141 ,
T_2 * V_133 , T_2 * V_134 , int V_23 )
{
T_4 V_140 ;
T_2 * V_1 ;
if ( F_89 ( V_47 ) )
...
L_20
L_21 ,
( unsigned long ) V_140 , V_23 ) ;
break;
}
V_3 = F_90 ( V_6 -> V_11 , V_140 ) ;
if ( ! V_3 ) {
F_91 ( V_6 , V_140 ,
L_22 ) ;
continue;
...
F_30 ( V_141 , L_24 ) ;
F_85 ( V_47 , V_6 , V_141 , V_133 , V_134 ) ;
}
}
...
if ( F_50 ( V_47 ) )
return;
V_146 = ( V_6 -> V_108 + V_68 - 1 )
>> F_93 ( V_6 -> V_11 ) ;
V_147 = ( F_83 ( V_6 -> V_11 ) -> V_149 + V_68 - 1 )
>> F_93 ( V_6 -> V_11 ) ;
if ( V_6 -> V_108 % V_150 != 0 ) {
V_148 = V_150 -
( V_6 -> V_108 & ( V_150 - 1 ) ) ;
V_25 = F_94 ( V_47 ,
V_144 , V_6 -> V_108 , V_148 , 0 ) ;
if ( V_25 )
goto V_151;
}
if ( V_146 != V_147 ) {
V_17 = F_2 ( V_6 , V_146 , V_8 , NULL ) ;
if ( V_17 == 0 )
goto V_151;
}
if ( F_52 ( V_47 , V_6 ) )
...
F_85 ( V_47 , V_6 , NULL , V_28 + V_8 [ 0 ] ,
V_28 + V_14 ) ;
goto V_154;
}
V_39 = F_78 ( V_6 , V_17 , V_8 , V_24 , & V_140 ) ;
if ( V_140 ) {
if ( V_39 == V_24 ) {
F_88 ( V_47 , V_6 , NULL ,
& V_140 , & V_140 + 1 , ( V_24 + V_17 - 1 ) - V_39 ) ;
* V_39 -> V_1 = 0 ;
} else {
F_30 ( V_39 -> V_3 , L_9 ) ;
F_88 ( V_47 , V_6 , V_39 -> V_3 ,
V_39 -> V_1 ,
V_39 -> V_1 + 1 , ( V_24 + V_17 - 1 ) - V_39 ) ;
}
}
while ( V_39 > V_24 ) {
F_88 ( V_47 , V_6 , V_39 -> V_3 , V_39 -> V_1 + 1 ,
( T_2 * ) V_39 -> V_3 -> V_31 + V_142 ,
( V_24 + V_17 - 1 ) - V_39 ) ;
F_30 ( V_39 -> V_3 , L_14 ) ;
F_45 ( V_39 -> V_3 ) ;
V_39 -- ;
...
V_140 = V_28 [ V_19 ] ;
if ( V_140 ) {
F_88 ( V_47 , V_6 , NULL , & V_140 , & V_140 + 1 , 1 ) ;
V_28 [ V_19 ] = 0 ;
}
case V_19 :
V_140 = V_28 [ V_20 ] ;
if ( V_140 ) {
F_88 ( V_47 , V_6 , NULL , & V_140 , & V_140 + 1 , 2 ) ;
V_28 [ V_20 ] = 0 ;
}
case V_20 :
V_140 = V_28 [ V_21 ] ;
if ( V_140 ) {
F_88 ( V_47 , V_6 , NULL , & V_140 , & V_140 + 1 , 3 ) ;
V_28 [ V_21 ] = 0 ;
}
case V_21 :
;
