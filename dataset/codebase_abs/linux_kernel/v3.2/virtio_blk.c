...
T_3 V_99 , V_100 ;
V_5 -> V_101 -> V_102 ( V_5 , F_38 ( struct V_79 , V_99 ) ,
& V_99 , sizeof( V_99 ) ) ;
if ( ( V_103 ) V_99 != V_99 ) {
F_47 ( & V_5 -> V_88 , L_1 ,
...
V_100 = V_99 * F_48 ( V_31 ) ;
F_49 ( V_100 , V_104 , V_97 , sizeof( V_97 ) ) ;
F_49 ( V_100 , V_105 , V_98 , sizeof( V_98 ) ) ;
F_50 ( & V_5 -> V_88 ,
L_2 ,
( unsigned long long ) V_99 ,
F_48 ( V_31 ) ,
...
static void F_52 ( struct V_96 * V_5 )
{
struct V_3 * V_4 = V_5 -> V_6 ;
F_53 ( V_106 , & V_4 -> V_95 ) ;
}
static int T_4 F_54 ( struct V_96 * V_5 )
{
struct V_3 * V_4 ;
struct V_30 * V_31 ;
int V_63 , V_84 ;
T_3 V_107 ;
T_5 V_108 , V_109 , V_58 , V_110 ;
T_6 V_111 ;
T_7 V_112 , V_113 ;
V_63 = F_55 ( & V_114 , 0 , F_41 ( 1 << V_115 ) ,
V_65 ) ;
if ( V_63 < 0 )
goto V_34;
V_84 = V_63 ;
V_63 = F_37 ( V_5 , V_116 ,
F_38 ( struct V_79 , V_117 ) ,
& V_58 ) ;
if ( V_63 || ! V_58 )
V_58 = 1 ;
V_58 += 2 ;
V_5 -> V_6 = V_4 = F_56 ( sizeof( * V_4 ) +
...
V_4 -> V_5 = V_5 ;
V_4 -> V_58 = V_58 ;
F_59 ( V_4 -> V_46 , V_4 -> V_58 ) ;
F_60 ( & V_4 -> V_95 , F_45 ) ;
V_4 -> V_2 = F_61 ( V_5 , F_1 , L_3 ) ;
if ( F_27 ( V_4 -> V_2 ) ) {
V_63 = F_28 ( V_4 -> V_2 ) ;
goto V_120;
}
V_4 -> V_27 = F_62 ( 1 , sizeof( struct V_7 ) ) ;
if ( ! V_4 -> V_27 ) {
V_63 = - V_118 ;
goto V_121;
}
V_4 -> V_28 = F_63 ( 1 << V_85 ) ;
if ( ! V_4 -> V_28 ) {
V_63 = - V_118 ;
goto V_122;
}
V_31 = V_4 -> V_28 -> V_29 = F_64 ( F_19 , & V_4 -> V_11 ) ;
if ( ! V_31 ) {
V_63 = - V_118 ;
goto V_123;
}
V_31 -> V_55 = V_4 ;
if ( V_84 < 26 ) {
sprintf ( V_4 -> V_28 -> V_124 , L_4 , 'a' + V_84 % 26 ) ;
} else if ( V_84 < ( 26 + 1 ) * 26 ) {
sprintf ( V_4 -> V_28 -> V_124 , L_5 ,
'a' + V_84 / 26 - 1 , 'a' + V_84 % 26 ) ;
} else {
const unsigned int V_125 = ( V_84 / 26 - 1 ) / 26 - 1 ;
const unsigned int V_126 = ( V_84 / 26 - 1 ) % 26 ;
const unsigned int V_127 = V_84 % 26 ;
sprintf ( V_4 -> V_28 -> V_124 , L_6 ,
'a' + V_125 , 'a' + V_126 , 'a' + V_127 ) ;
}
V_4 -> V_28 -> V_128 = V_128 ;
V_4 -> V_28 -> V_129 = F_40 ( V_84 ) ;
V_4 -> V_28 -> V_61 = V_4 ;
V_4 -> V_28 -> V_130 = & V_131 ;
V_4 -> V_28 -> V_132 = & V_5 -> V_88 ;
V_4 -> V_84 = V_84 ;
if ( F_34 ( V_5 , V_133 ) )
F_65 ( V_31 , V_38 ) ;
if ( F_34 ( V_5 , V_134 ) )
...
V_5 -> V_101 -> V_102 ( V_5 , F_38 ( struct V_79 , V_99 ) ,
& V_107 , sizeof( V_107 ) ) ;
if ( ( V_103 ) V_107 != V_107 ) {
F_47 ( & V_5 -> V_88 , L_1 ,
( unsigned long long ) V_107 ) ;
V_107 = ( V_103 ) - 1 ;
}
F_51 ( V_4 -> V_28 , V_107 ) ;
F_67 ( V_31 , V_4 -> V_58 - 2 ) ;
F_68 ( V_31 , V_135 ) ;
F_69 ( V_31 , - 1U ) ;
V_63 = F_37 ( V_5 , V_136 ,
F_38 ( struct V_79 , V_137 ) ,
& V_108 ) ;
if ( ! V_63 )
F_70 ( V_31 , V_108 ) ;
else
...
& V_113 ) ;
if ( ! V_63 && V_113 )
F_73 ( V_31 , V_109 * V_113 ) ;
V_63 = F_37 ( V_5 , V_139 ,
F_38 ( struct V_79 , V_111 ) ,
& V_111 ) ;
if ( ! V_63 && V_111 )
F_74 ( V_31 , V_109 * V_111 ) ;
V_63 = F_37 ( V_5 , V_139 ,
F_38 ( struct V_79 , V_110 ) ,
& V_110 ) ;
if ( ! V_63 && V_110 )
F_75 ( V_31 , V_109 * V_110 ) ;
F_76 ( V_4 -> V_28 ) ;
V_63 = F_77 ( F_78 ( V_4 -> V_28 ) , & V_140 ) ;
if ( V_63 )
goto V_141;
return 0 ;
V_141:
...
static void T_8 F_85 ( struct V_96 * V_5 )
{
struct V_3 * V_4 = V_5 -> V_6 ;
int V_84 = V_4 -> V_84 ;
F_86 ( & V_4 -> V_95 ) ;
