...
void * V_32 = NULL ;
T_5 V_4 = V_33 | V_34 ;
V_32 = F_25 ( V_15 , V_31 , V_4 ) ;
if ( V_32 ) {
F_26 ( V_32 , V_31 , 1 , V_4 ) ;
return V_32 ;
}
if ( F_27 ( V_15 , V_35 ) )
V_32 = F_28 ( V_31 , V_15 ) ;
...
static void F_30 ( void * V_32 )
{
if ( F_31 ( V_32 ) ) {
F_32 ( V_32 ) ;
} else {
struct V_10 * V_10 = F_33 ( V_32 ) ;
T_4 V_16 =
...
static int T_1 F_37 ( unsigned long V_11 , int V_15 )
{
struct V_1 * V_13 , * V_2 ;
struct V_28 * V_29 ;
unsigned long V_16 ;
...
int T_1 F_41 ( unsigned long V_17 ,
unsigned long V_18 ,
int V_15 )
{
...
int T_1 F_46 ( unsigned long V_17 ,
...
static int T_1 F_47 ( struct V_43 * V_44 ,
...
unsigned short F_58 ( T_6 V_67 ,
unsigned short V_68 , unsigned short V_69 )
{
int type = F_59 ( V_67 ) ;
unsigned long V_12 = F_60 ( V_67 ) ;
...
unsigned short F_64 ( T_6 V_67 , unsigned short V_3 )
{
int type = F_59 ( V_67 ) ;
unsigned long V_12 = F_60 ( V_67 ) ;
unsigned long V_61 = V_12 / V_70 ;
...
int F_66 ( int type , unsigned long V_78 )
{
void * V_79 ;
unsigned long V_80 ;
unsigned long V_63 ;
