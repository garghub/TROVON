...
static int F_73 ( struct V_1 * V_2 , T_1 * V_98 ,
T_1 * V_99 , T_1 * V_100 )
{
struct V_5 * V_6 = F_2 ( V_2 , struct V_5 ,
V_2 ) ;
int V_101 = 0 , V_31 = 0 , V_25 = 0 ;
int V_102 = 0 ;
if ( ( V_6 -> V_17 . V_103 . V_104 == V_105 ) &&
( V_6 -> V_17 . V_103 . V_106 == 2048 ) )
V_101 = 4 ;
else
V_101 = 1 ;
for ( V_31 = 0 ; V_31 < V_101 ; V_31 ++ ) {
if ( memcmp ( V_99 , V_100 , 3 ) != 0 ) {
V_25 = F_71 ( V_99 , V_100 , V_98 ) ;
if ( V_25 < 0 )
return V_25 ;
V_102 += V_25 ;
}
...
static int F_74 ( struct V_1 * V_2 , const T_1 * V_98 ,
T_1 * V_107 )
{
struct V_5 * V_6 = F_2 ( V_2 , struct V_5 ,
V_2 ) ;
return F_75 ( V_6 -> V_9 , V_98 , V_107 ) ;
}
static void F_76 ( struct V_1 * V_2 , int V_104 )
{
struct V_5 * V_6 = F_2 ( V_2 , struct V_5 ,
V_2 ) ;
struct V_16 * V_108 = V_2 -> V_18 ;
unsigned int V_109 = ( V_108 -> V_26 & V_27 ) ? 1 : 0 ;
F_77 ( V_6 -> V_9 , V_104 , V_109 , V_6 -> V_17 . V_103 . V_106 ) ;
}
static int F_78 ( struct V_1 * V_2 , struct V_16 * V_108 )
{
struct V_16 * V_110 = V_2 -> V_18 ;
struct V_5 * V_6 = F_2 ( V_2 , struct V_5 ,
V_2 ) ;
unsigned long V_111 = V_112 ;
int V_21 = V_113 , V_114 = V_110 -> V_114 ;
if ( V_114 == V_115 )
V_111 += ( V_116 * 400 ) / 1000 ;
else
V_111 += ( V_116 * 20 ) / 1000 ;
F_3 ( V_6 -> V_9 ,
V_10 , ( V_117 & 0xFF ) ) ;
while ( F_79 ( V_112 , V_111 ) ) {
...
static int T_9 F_83 ( struct V_121 * V_55 )
{
struct V_5 * V_6 ;
struct V_122 * V_123 ;
int V_124 ;
int V_31 , V_125 ;
V_123 = V_55 -> V_56 . V_126 ;
if ( V_123 == NULL ) {
F_28 ( & V_55 -> V_56 , L_7 ) ;
return - V_127 ;
}
V_6 = F_84 ( sizeof( struct V_5 ) , V_128 ) ;
if ( ! V_6 )
return - V_129 ;
F_85 ( V_55 , V_6 ) ;
F_86 ( & V_6 -> V_130 . V_131 ) ;
F_87 ( & V_6 -> V_130 . V_132 ) ;
V_6 -> V_55 = V_55 ;
V_6 -> V_9 = V_123 -> V_133 ;
V_6 -> V_59 = V_123 -> V_59 ;
V_6 -> V_2 . V_18 = & V_6 -> V_17 ;
V_6 -> V_2 . V_134 = F_88 ( & V_55 -> V_56 ) ;
V_6 -> V_2 . V_135 = V_136 ;
V_6 -> V_17 . V_26 = V_123 -> V_137 ;
V_6 -> V_17 . V_26 |= V_138 ;
F_40 ( V_6 -> V_9 , V_139 , 0 ) ;
if ( ! F_89 ( V_6 -> V_59 , V_140 ,
V_55 -> V_56 . V_141 -> V_134 ) ) {
V_124 = - V_142 ;
goto V_143;
}
V_6 -> V_17 . V_19 = F_90 ( V_6 -> V_59 , V_140 ) ;
if ( ! V_6 -> V_17 . V_19 ) {
V_124 = - V_129 ;
goto V_144;
}
V_6 -> V_17 . V_130 = & V_6 -> V_130 ;
...
V_6 -> V_17 . V_160 = F_43 ;
if ( V_123 -> V_161 == V_162 )
V_6 -> V_17 . V_103 . V_104 = V_163 ;
else if ( ( V_123 -> V_161 == V_164 ) ||
( V_123 -> V_161 == V_165 ) ) {
V_6 -> V_17 . V_103 . V_69 = 3 ;
V_6 -> V_17 . V_103 . V_106 = 512 ;
V_6 -> V_17 . V_103 . V_166 = F_74 ;
V_6 -> V_17 . V_103 . V_167 = F_76 ;
V_6 -> V_17 . V_103 . V_168 = F_73 ;
V_6 -> V_17 . V_103 . V_104 = V_105 ;
}
...
if ( V_123 -> V_161 == V_165 ) {
if ( V_6 -> V_17 . V_26 & V_27 )
V_125 = 2 ;
else {
V_125 = 1 ;
V_6 -> V_17 . V_170 = & V_171 ;
}
V_172 . V_173 = 3 * ( V_6 -> V_2 . V_67 / 16 ) ;
for ( V_31 = 0 ; V_31 < V_172 . V_173 ; V_31 ++ )
V_172 . V_174 [ V_31 ] = V_31 + V_125 ;
V_172 . V_175 -> V_125 = V_125 + V_172 . V_173 ;
V_172 . V_175 -> V_176 = V_6 -> V_2 . V_67 -
( V_125 + V_172 . V_173 ) ;
V_6 -> V_17 . V_103 . V_177 = & V_172 ;
}
if ( F_96 ( & V_6 -> V_2 ) ) {
V_124 = - V_169 ;
goto V_144;
...
static int F_100 ( struct V_121 * V_55 )
{
struct V_1 * V_2 = F_101 ( V_55 ) ;
struct V_5 * V_6 = F_2 ( V_2 , struct V_5 ,
V_2 ) ;
F_85 ( V_55 , NULL ) ;
if ( V_6 -> V_57 != - 1 )
