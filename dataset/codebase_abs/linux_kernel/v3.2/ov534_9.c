...
int V_93 = V_90 ;
int V_94 ;
V_94 = V_1 -> V_46 . V_66 ? 2048 : 2040 ;
do {
V_90 = F_31 ( V_93 , V_94 ) ;
if ( V_17 [ 0 ] != 12 || V_90 < 12 ) {
F_6 ( V_95 , L_13 ) ;
goto V_96;
}
if ( V_17 [ 1 ] & V_97 ) {
...
V_91 = ( V_17 [ 5 ] << 24 ) | ( V_17 [ 4 ] << 16 )
| ( V_17 [ 3 ] << 8 ) | V_17 [ 2 ] ;
V_92 = V_17 [ 1 ] & V_99 ;
if ( V_91 != V_29 -> V_100 || V_92 != V_29 -> V_101 ) {
if ( V_1 -> V_102 == V_103 )
F_32 ( V_1 , V_104 ,
NULL , 0 ) ;
V_29 -> V_100 = V_91 ;
...
switch ( V_110 -> V_112 ) {
case 0 :
strcpy ( ( char * ) V_110 -> V_113 , L_16 ) ;
return 0 ;
case 1 :
strcpy ( ( char * ) V_110 -> V_113 , L_17 ) ;
return 0 ;
case 2 :
strcpy ( ( char * ) V_110 -> V_113 , L_18 ) ;
return 0 ;
}
break;
}
...
static int F_34 ( struct V_114 * V_115 , const struct V_44 * V_45 )
{
return F_35 ( V_115 , V_45 , & V_116 , sizeof( struct V_29 ) ,
V_117 ) ;
}
