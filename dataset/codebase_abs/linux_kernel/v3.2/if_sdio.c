...
{
struct V_82 * V_6 = V_2 -> V_6 ;
struct V_18 * V_19 = V_2 -> V_19 ;
struct V_83 * V_84 = V_6 -> V_2 -> V_84 ;
int V_4 ;
F_29 ( V_6 ) ;
V_4 = F_47 ( V_6 ) ;
if ( V_4 )
...
T_2 V_90 ;
V_6 -> V_2 -> V_91 |= V_92 ;
V_90 = F_48 ( V_6 , V_93 , & V_4 ) ;
if ( V_4 )
goto V_94;
V_90 |= V_95 ;
F_49 ( V_6 , V_90 , V_93 , & V_4 ) ;
if ( V_4 )
goto V_94;
}
V_2 -> V_48 = F_2 ( V_6 , V_96 , & V_4 ) ;
if ( V_4 )
goto V_94;
V_2 -> V_48 |= F_2 ( V_6 , V_96 + 1 , & V_4 ) << 8 ;
if ( V_4 )
goto V_94;
V_2 -> V_48 |= F_2 ( V_6 , V_96 + 2 , & V_4 ) << 16 ;
if ( V_4 )
goto V_94;
F_31 ( V_6 ) ;
V_4 = F_42 ( V_2 ) ;
...
F_7 ( L_24 ) ;
if ( F_51 ( V_19 , V_101 , & V_100 , sizeof( V_100 ) ,
V_102 , ( unsigned long ) & V_100 ) )
F_52 ( V_19 -> V_77 , L_25 ) ;
}
V_19 -> V_103 = 1 ;
return 0 ;
...
T_2 type , T_2 * V_104 , T_1 V_60 )
{
int V_4 ;
struct V_1 * V_2 ;
struct V_54 * V_55 , * V_105 ;
T_1 V_17 ;
unsigned long V_20 ;
F_57 ( V_22 , L_26 , type , V_60 ) ;
V_2 = V_19 -> V_2 ;
...
memset ( & V_100 , 0 , sizeof( V_100 ) ) ;
F_7 ( L_28 ) ;
V_4 = F_51 ( V_19 , V_111 , & V_100 , sizeof( V_100 ) ,
V_102 , ( unsigned long ) & V_100 ) ;
if ( V_4 )
F_60 ( V_19 -> V_77 , L_29 ) ;
F_22 ( 200 ) ;
...
static void V_97 ( struct V_82 * V_6 )
{
int V_4 ;
struct V_1 * V_2 ;
T_2 V_116 ;
...
static int F_77 ( struct V_82 * V_6 ,
...
V_2 -> V_110 = F_79 ( L_37 ) ;
F_80 ( & V_2 -> V_56 , F_27 ) ;
for ( V_21 = 0 ; V_21 < F_81 ( V_80 ) ; V_21 ++ ) {
...
static void F_88 ( struct V_82 * V_6 )
{
struct V_1 * V_2 ;
struct V_54 * V_55 ;
F_6 ( V_22 ) ;
...
memset ( & V_100 , 0 , sizeof( V_100 ) ) ;
F_7 ( L_41 ) ;
if ( F_51 ( V_2 -> V_19 , V_143 ,
& V_100 , sizeof( V_100 ) , V_102 ,
( unsigned long ) & V_100 ) )
F_90 ( L_42 ) ;
}
F_7 ( L_43 ) ;
...
static int F_92 ( struct V_131 * V_77 )
{
struct V_82 * V_6 = F_93 ( V_77 ) ;
int V_4 ;
...
if ( V_4 )
return V_4 ;
return F_98 ( V_6 , V_148 ) ;
}
static int F_100 ( struct V_131 * V_77 )
{
struct V_82 * V_6 = F_93 ( V_77 ) ;
struct V_1 * V_2 = F_75 ( V_6 ) ;
int V_4 ;
F_95 ( V_77 , L_47 , F_96 ( V_6 ) ) ;
V_4 = F_101 ( V_2 -> V_19 ) ;
return V_4 ;
}
