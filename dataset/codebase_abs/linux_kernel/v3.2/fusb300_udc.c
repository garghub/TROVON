...
if ( V_1 -> V_174 )
return - V_196 ;
V_174 -> V_174 . V_197 = NULL ;
V_1 -> V_174 = V_174 ;
V_1 -> V_73 . V_198 . V_174 = & V_174 -> V_174 ;
V_194 = F_119 ( & V_1 -> V_73 . V_198 ) ;
if ( V_194 ) {
F_12 ( L_31 , V_194 ) ;
goto error;
}
V_194 = F_118 ( & V_1 -> V_73 ) ;
if ( V_194 ) {
F_12 ( L_32 , V_194 ) ;
F_120 ( & V_1 -> V_73 . V_198 ) ;
goto error;
}
return 0 ;
error:
V_1 -> V_174 = NULL ;
V_1 -> V_73 . V_198 . V_174 = NULL ;
return V_194 ;
}
static int F_121 ( struct V_191 * V_174 )
{
struct V_1 * V_1 = V_193 ;
if ( V_174 != V_1 -> V_174 || ! V_174 -> V_199 )
return - V_55 ;
V_174 -> V_199 ( & V_1 -> V_73 ) ;
V_1 -> V_73 . V_198 . V_174 = NULL ;
F_116 ( V_1 ) ;
F_120 ( & V_1 -> V_73 . V_198 ) ;
V_1 -> V_174 = NULL ;
...
static int F_122 ( struct V_192 * V_200 , int V_201 )
{
return 0 ;
}
static int T_7 F_123 ( struct V_202 * V_203 )
{
struct V_1 * V_1 = F_124 ( & V_203 -> V_198 ) ;
F_125 ( & V_1 -> V_73 ) ;
F_126 ( V_1 -> V_4 ) ;
F_127 ( F_128 ( V_203 , 0 ) , V_1 ) ;
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_1 -> V_101 ) ;
F_43 ( V_1 ) ;
return 0 ;
}
static int T_8 F_129 ( struct V_202 * V_203 )
{
struct V_204 * V_205 , * V_206 , * V_207 ;
void T_9 * V_4 = NULL ;
struct V_1 * V_1 = NULL ;
struct V_5 * V_42 [ V_122 ] ;
int V_80 = 0 ;
int V_59 ;
V_205 = F_130 ( V_203 , V_208 , 0 ) ;
if ( ! V_205 ) {
V_80 = - V_195 ;
F_12 ( L_33 ) ;
goto V_209;
}
V_206 = F_130 ( V_203 , V_210 , 0 ) ;
if ( ! V_206 ) {
V_80 = - V_195 ;
F_131 ( & V_203 -> V_198 ,
L_34 ) ;
...
V_4 = F_132 ( V_205 -> V_211 , F_133 ( V_205 ) ) ;
if ( V_4 == NULL ) {
V_80 = - V_212 ;
F_12 ( L_36 ) ;
goto V_209;
...
F_134 ( & V_1 -> V_49 ) ;
F_135 ( & V_203 -> V_198 , V_1 ) ;
V_1 -> V_73 . V_213 = & V_214 ;
F_136 ( & V_1 -> V_73 . V_198 ) ;
F_137 ( & V_1 -> V_73 . V_198 , L_39 ) ;
V_1 -> V_73 . V_215 = 1 ;
V_1 -> V_73 . V_198 . V_216 = & V_203 -> V_198 ;
V_1 -> V_73 . V_198 . V_217 = V_203 -> V_198 . V_217 ;
V_1 -> V_73 . V_198 . V_218 = V_203 -> V_198 . V_218 ;
V_1 -> V_73 . V_219 = V_220 ;
V_1 -> V_4 = V_4 ;
V_80 = F_138 ( V_206 -> V_211 , F_110 , V_221 ,
V_220 , V_1 ) ;
if ( V_80 < 0 ) {
F_12 ( L_40 , V_80 ) ;
goto V_209;
}
V_80 = F_138 ( V_207 -> V_211 , F_110 ,
V_221 , V_220 , V_1 ) ;
if ( V_80 < 0 ) {
F_12 ( L_41 , V_80 ) ;
goto V_209;
...
goto V_227;
F_116 ( V_1 ) ;
V_80 = F_139 ( & V_203 -> V_198 , & V_1 -> V_73 ) ;
if ( V_80 )
goto V_228;
F_140 ( & V_203 -> V_198 , L_42 , V_229 ) ;
return 0 ;
V_228:
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_1 -> V_101 ) ;
V_227:
F_127 ( V_206 -> V_211 , V_1 ) ;
V_209:
if ( V_1 ) {
if ( V_1 -> V_101 )
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 ,
