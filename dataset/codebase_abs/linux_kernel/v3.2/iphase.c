...
F_78 ( V_33 , V_262 ) ;
F_79 (printk(L_72, skb->len);
xdump(skb->data, skb->len, L_73);
printk(L_74);)
F_65 (printk(L_75);)
V_41 -> V_342 ( V_41 , V_33 ) ;
F_66 ( & V_41 -> V_300 -> V_343 ) ;
V_152 -> V_329 ++ ;
}
V_339:
...
if ( V_41 -> V_53 . V_347 . V_55 == V_348 ) return 0 ;
V_152 = F_31 ( V_41 -> V_9 ) ;
if ( V_41 -> V_53 . V_347 . V_55 == V_56 ) {
if ( V_152 -> V_186 & V_188 ) {
F_9 ( L_77 ) ;
return - V_289 ;
}
}
V_345 = V_152 -> V_111 + V_349 * V_152 -> V_113 ;
V_345 += V_41 -> V_58 ;
* V_345 = V_41 -> V_58 << 6 ;
if ( ( V_41 -> V_53 . V_347 . V_55 == V_56 ) ||
...
V_346 = V_152 -> V_111 + V_112 * V_152 -> V_113 ;
V_346 += V_41 -> V_58 ;
* V_346 = V_114 ;
}
...
static int F_81 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
struct V_281 T_13 * V_282 ;
...
T_4 * V_345 ;
T_4 * V_353 ;
int V_31 , V_354 , V_355 ;
T_3 V_356 ;
T_3 * V_357 ;
V_152 = F_31 ( V_9 ) ;
V_351 = F_82 ( V_152 -> V_311 , V_358 ,
& V_152 -> V_359 ) ;
if ( ! V_351 ) {
F_9 (KERN_ERR DEV_LABEL L_79 ) ;
goto V_360;
}
V_152 -> V_308 . V_318 = (struct V_283 * ) V_351 ;
V_152 -> V_308 . V_336 = V_152 -> V_308 . V_318 ;
V_152 -> V_308 . V_309 = V_152 -> V_308 . V_318 ;
V_152 -> V_308 . V_317 = (struct V_283 * ) ( ( unsigned long ) V_351 + sizeof( struct V_283 ) * V_338 ) ;
F_50 ( V_152 -> V_359 & 0xfffff000 ,
V_152 -> V_319 + V_337 ) ;
F_47 (printk(L_80,
...
F_16 ( 0 , V_152 -> V_279 + V_361 ) ;
F_16 ( V_362 , V_152 -> V_279 + V_363 ) ;
F_16 ( V_364 >> 16 , V_152 -> V_279 + V_365 ) ;
F_16 ( V_152 -> V_179 , V_152 -> V_279 + V_366 ) ;
V_152 -> V_293 = V_152 -> V_111 + V_364 * V_152 -> V_113 ;
V_282 = V_152 -> V_293 ;
F_83 ( V_282 , 0 , sizeof( * V_282 ) ) ;
V_282 ++ ;
V_350 = V_152 -> V_184 ;
for( V_31 = 1 ; V_31 <= V_152 -> V_177 ; V_31 ++ )
{
F_83 ( V_282 , 0 , sizeof( * V_282 ) ) ;
V_282 -> V_303 = V_350 >> 16 ;
V_282 -> V_304 = V_350 & 0x0000ffff ;
V_282 ++ ;
V_350 += V_152 -> V_179 ;
}
F_47 (printk(L_82, buf_desc_ptr);)
V_31 = V_367 * V_152 -> V_113 ;
F_16 ( V_31 >> 16 , V_152 -> V_279 + V_368 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_369 ) ;
F_16 ( V_31 + V_152 -> V_177 * sizeof( T_3 ) ,
V_152 -> V_279 + V_370 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_371 ) ;
F_16 ( V_31 + V_152 -> V_177 * sizeof( T_3 ) ,
V_152 -> V_279 + V_280 ) ;
V_356 = F_61 ( V_152 -> V_279 + V_369 ) ;
V_357 = ( T_3 * ) ( V_152 -> V_111 + V_356 ) ;
for( V_31 = 1 ; V_31 <= V_152 -> V_177 ; V_31 ++ )
{
* V_357 = ( T_3 ) V_31 ;
V_357 ++ ;
...
V_31 = ( V_372 * V_152 -> V_113 ) & 0xffff ;
F_16 ( V_31 , V_152 -> V_279 + V_373 ) ;
F_16 ( V_31 + V_152 -> V_70 * sizeof( T_3 ) , V_152 -> V_279 + V_374 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_292 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_288 ) ;
V_31 = ( V_375 * V_152 -> V_113 ) & 0xffff ;
F_16 ( V_31 , V_152 -> V_279 + V_376 ) ;
F_16 ( V_31 + V_377 * sizeof( V_378 ) ,
V_152 -> V_279 + V_379 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_380 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_381 ) ;
V_152 -> V_275 . V_278 = F_61 ( V_152 -> V_279 + V_369 ) & 0xffff ;
V_152 -> V_275 . V_277 = F_61 ( V_152 -> V_279 + V_370 ) & 0xffff ;
V_152 -> V_275 . V_382 = F_61 ( V_152 -> V_279 + V_371 ) & 0xffff ;
V_152 -> V_275 . V_276 = F_61 ( V_152 -> V_279 + V_280 ) & 0xffff ;
V_152 -> V_275 . V_291 = F_61 ( V_152 -> V_279 + V_373 ) & 0xffff ;
V_152 -> V_275 . V_290 = F_61 ( V_152 -> V_279 + V_374 ) & 0xffff ;
V_152 -> V_275 . V_287 = F_61 ( V_152 -> V_279 + V_292 ) & 0xffff ;
V_152 -> V_275 . V_383 = F_61 ( V_152 -> V_279 + V_288 ) & 0xffff ;
F_47 (printk(L_84,
iadev->rfL.pcq_st, iadev->rfL.pcq_ed, iadev->rfL.pcq_rd,
iadev->rfL.pcq_wr);)
V_31 = V_112 * V_152 -> V_113 ;
F_16 ( ( V_31 >> 3 ) , V_152 -> V_279 + V_384 ) ;
V_353 = ( T_4 * ) ( V_152 -> V_111 + V_31 ) ;
V_354 = V_385 * V_152 -> V_113 ;
...
V_31 = V_349 * V_152 -> V_113 ;
F_16 ( ( ( V_31 >> 3 ) & 0xfff8 ) | V_355 , V_152 -> V_279 + V_386 ) ;
V_345 = ( T_4 * ) ( V_152 -> V_111 + V_349 * V_152 -> V_113 ) ;
V_354 = V_387 * V_152 -> V_113 ;
for( V_31 = 0 ; V_31 < V_354 ; V_31 ++ )
{
* V_345 = ( V_31 << 6 ) | 15 ;
V_345 ++ ;
...
F_16 ( V_31 >> 3 , V_152 -> V_279 + V_388 ) ;
V_31 = V_116 * V_152 -> V_113 ;
V_352 = (struct V_352 * ) ( V_152 -> V_111 + V_31 ) ;
V_354 = V_385 * V_152 -> V_113 ;
memset ( ( char * ) V_352 , 0 , V_354 * sizeof( * V_352 ) ) ;
for( V_31 = 0 ; V_31 < V_354 ; V_31 ++ ) {
V_352 -> V_87 = 0x0003 ;
V_352 -> V_96 = 0x5eb1 ;
V_352 ++ ;
}
F_16 ( 0xff00 , V_152 -> V_279 + V_389 ) ;
F_16 ( 0 , V_152 -> V_279 + V_390 ) ;
F_16 ( 0x1 , V_152 -> V_279 + V_391 ) ;
F_16 ( 0xF6F8 , V_152 -> V_279 + V_392 ) ;
V_31 = ( V_354 >> 6 ) & 0xFF ;
V_354 += 2 * ( V_354 - 1 ) ;
V_31 |= ( ( V_354 << 2 ) & 0xFF00 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_393 ) ;
for( V_31 = 0 ; V_31 < V_152 -> V_39 ; V_31 ++ )
...
F_84 ( & V_152 -> V_307 ) ;
V_152 -> V_394 = NULL ;
V_152 -> V_295 = F_85 ( 4 * V_152 -> V_70 , V_395 ) ;
if ( ! V_152 -> V_295 ) {
...
V_152 -> V_326 = 1 ;
V_152 -> V_329 = 0 ;
F_16 ( V_397 , V_152 -> V_279 + V_361 ) ;
return 0 ;
V_396:
F_86 ( V_152 -> V_311 , V_358 , V_152 -> V_308 . V_318 ,
V_152 -> V_359 ) ;
V_360:
return - V_398 ;
}
static void F_87 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
unsigned short V_62 ;
unsigned long V_158 ;
...
if ( V_62 & V_72 ) {
F_10 (printk(L_86);)
F_88 ( & V_152 -> V_399 , V_158 ) ;
F_40 ( V_152 ) ;
F_89 ( & V_152 -> V_399 , V_158 ) ;
...
static void F_91 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
struct V_283 * V_283 , * V_334 ;
struct V_32 * V_33 ;
...
V_152 = F_31 ( V_9 ) ;
F_88 ( & V_152 -> V_399 , V_158 ) ;
V_283 = V_152 -> V_402 . V_336 ;
V_335 = F_7 ( V_152 -> V_319 + V_403 ) &
( sizeof( struct V_283 ) * V_338 - 1 ) ;
V_334 = (struct V_283 * ) ( V_152 -> V_402 . V_318 + ( V_335 >> 4 ) ) ;
while ( V_283 != V_334 )
{
V_33 = F_34 ( & V_152 -> V_404 ) ;
if ( ! V_33 ) break;
if ( ! ( ( V_283 - V_152 -> V_402 . V_318 ) % ( 2 * sizeof( struct V_283 ) ) ) ) {
...
if ( ++ V_283 == V_152 -> V_402 . V_317 )
V_283 = V_152 -> V_402 . V_318 ;
}
V_152 -> V_402 . V_336 = V_283 ;
F_89 ( & V_152 -> V_399 , V_158 ) ;
}
...
if ( V_41 -> V_53 . V_54 . V_55 == V_348 ) return 0 ;
V_152 = F_31 ( V_41 -> V_9 ) ;
if ( V_152 -> V_186 & V_188 ) {
if ( V_41 -> V_53 . V_54 . V_55 == V_56 ) {
F_9 ( L_77 ) ;
...
if ( V_41 -> V_53 . V_54 . V_411 >
( V_152 -> V_175 - sizeof( struct V_340 ) ) ) {
F_9 ( L_93 ,
V_41 -> V_53 . V_54 . V_411 , V_152 -> V_175 ) ;
V_41 -> V_412 = NULL ;
F_41 ( V_12 ) ;
return - V_289 ;
}
...
if ( V_12 -> V_22 > ( V_152 -> V_81 / 6 ) ) V_12 -> V_36 = V_415 / 10 ;
else if ( V_12 -> V_22 > ( V_152 -> V_81 / 130 ) ) V_12 -> V_36 = V_415 ;
else if ( V_12 -> V_22 <= 170 ) V_12 -> V_36 = 16 * V_415 ;
else V_12 -> V_36 = 2700 * V_415 / V_12 -> V_22 ;
if ( V_12 -> V_22 < V_152 -> V_23 )
F_84 ( & V_12 -> V_162 ) ;
if ( V_12 -> V_22 < V_152 -> V_23 ) {
struct V_416 * V_417 = F_93 ( V_41 ) ;
if ( V_41 -> V_53 . V_54 . V_411 != 0 ) {
if ( V_12 -> V_22 > 60000 )
V_417 -> V_418 = V_41 -> V_53 . V_54 . V_411 * 5 ;
else if ( V_12 -> V_22 > 2000 )
V_417 -> V_418 = V_41 -> V_53 . V_54 . V_411 * 4 ;
else
V_417 -> V_418 = V_41 -> V_53 . V_54 . V_411 * 3 ;
}
else
V_417 -> V_418 = 24576 ;
}
V_407 = (struct V_47 * ) V_152 -> V_49 ;
V_408 = (struct V_50 * ) V_152 -> V_52 ;
V_407 += V_41 -> V_58 ;
V_408 += V_41 -> V_58 ;
memset ( ( V_98 ) V_407 , 0 , sizeof( * V_407 ) ) ;
memset ( ( V_98 ) V_408 , 0 , sizeof( * V_408 ) ) ;
V_408 -> V_419 = ( V_41 -> V_58 >> 12 ) & 0x000f ;
V_408 -> V_420 = ( V_41 -> V_58 & 0x0fff ) << 4 ;
if ( V_41 -> V_53 . V_54 . V_55 == V_421 )
{
V_407 -> type = V_422 ;
V_407 -> V_62 = V_423 ;
V_407 -> V_424 = F_18 ( V_152 -> V_81 ) ;
if ( V_41 -> V_53 . V_54 . V_22 > 0 )
V_407 -> V_424 = F_18 ( V_41 -> V_53 . V_54 . V_22 ) ;
F_94 (printk(L_94,
...
if ( V_41 -> V_53 . V_54 . V_425 > 0 ) {
int V_426 = V_152 -> V_121 + V_152 -> V_427 + V_41 -> V_53 . V_54 . V_425 ;
if ( V_426 > V_152 -> V_81 )
return - V_142 ;
V_79 . V_82 = V_41 -> V_53 . V_54 . V_425 ;
V_152 -> V_121 += V_41 -> V_53 . V_54 . V_425 ;
}
else V_79 . V_82 = 0 ;
...
} else if ( V_41 -> V_53 . V_54 . V_55 == V_410 ) {
if ( V_152 -> V_186 & V_188 ) {
F_9 ( L_92 ) ;
return - V_289 ;
}
...
static int F_95 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
struct V_433 * V_282 ;
unsigned int V_434 ;
...
V_152 -> V_402 . V_318 = (struct V_283 * ) V_351 ;
V_152 -> V_402 . V_336 = V_152 -> V_402 . V_318 ;
V_152 -> V_402 . V_309 = V_152 -> V_402 . V_318 ;
V_152 -> V_402 . V_317 = (struct V_283 * ) ( ( unsigned long ) V_351 + sizeof( struct V_283 ) * V_338 ) ;
F_50 ( V_152 -> V_440 & 0xfffff000 ,
V_152 -> V_319 + V_403 ) ;
F_16 ( 0xffff , V_152 -> V_14 + V_74 ) ;
F_16 ( 0 , V_152 -> V_14 + V_68 ) ;
F_16 ( V_441 , V_152 -> V_14 + V_442 ) ;
V_152 -> V_49 = V_152 -> V_17 + V_443 * V_152 -> V_113 ;
V_152 -> V_52 = V_152 -> V_17 + V_444 * V_152 -> V_113 ;
V_152 -> V_69 = V_152 -> V_17 + V_445 * V_152 -> V_113 ;
F_16 ( V_446 , V_152 -> V_14 + V_447 ) ;
V_282 = (struct V_433 * ) ( V_152 -> V_17 + V_446 ) ;
...
memset ( ( V_98 ) V_282 , 0 , sizeof( * V_282 ) ) ;
V_282 -> V_296 = V_448 ;
V_282 -> V_303 = V_434 >> 16 ;
V_282 -> V_304 = V_434 & 0x0000ffff ;
V_282 ++ ;
V_434 += V_152 -> V_175 ;
}
V_152 -> V_449 = F_4 ( V_152 -> V_39 * sizeof( struct V_450 ) , V_395 ) ;
if ( ! V_152 -> V_449 ) {
...
{
struct V_340 * V_451 ;
V_451 = F_4 ( sizeof( * V_451 ) , V_395 | V_452 ) ;
if( ! V_451 ) {
F_9 (KERN_ERR DEV_LABEL L_102 ) ;
goto V_453;
}
V_152 -> V_449 [ V_31 ] . V_451 = V_451 ;
V_152 -> V_449 [ V_31 ] . V_286 = F_71 ( V_152 -> V_311 ,
V_451 , sizeof( * V_451 ) , V_405 ) ;
}
V_152 -> V_18 = F_4 ( V_152 -> V_39 *
sizeof( struct V_5 ) , V_395 ) ;
if ( ! V_152 -> V_18 ) {
F_9 (KERN_ERR DEV_LABEL L_101 ) ;
goto V_454;
}
V_31 = V_455 * V_152 -> V_113 ;
F_16 ( V_31 >> 16 , V_152 -> V_14 + V_456 ) ;
F_16 ( V_31 , V_152 -> V_14 + V_271 ) ;
F_16 ( V_31 , V_152 -> V_14 + V_457 ) ;
F_16 ( V_31 + V_152 -> V_39 * sizeof( T_3 ) , V_152 -> V_14 + V_15 ) ;
V_152 -> V_16 = V_31 + V_152 -> V_39 * sizeof( T_3 ) ;
F_16 ( V_31 + 2 * V_152 -> V_39 * sizeof( T_3 ) ,
V_152 -> V_14 + V_272 ) ;
V_435 = F_61 ( V_152 -> V_14 + V_271 ) ;
V_436 = ( T_3 * ) ( V_152 -> V_17 + V_435 ) ;
for( V_31 = 1 ; V_31 <= V_152 -> V_39 ; V_31 ++ )
{
* V_436 = ( T_3 ) V_31 ;
V_436 ++ ;
}
V_31 = V_458 * V_152 -> V_113 ;
F_16 ( V_31 , V_152 -> V_14 + V_459 ) ;
F_16 ( V_31 + 2 * V_152 -> V_39 * sizeof( T_3 ) ,
V_152 -> V_14 + V_460 ) ;
F_16 ( V_31 , V_152 -> V_14 + V_461 ) ;
F_16 ( V_31 , V_152 -> V_14 + V_462 ) ;
V_152 -> V_27 . V_463 = F_61 ( V_152 -> V_14 + V_459 ) & 0xffff ;
V_152 -> V_27 . V_464 = F_61 ( V_152 -> V_14 + V_460 ) & 0xffff ;
V_152 -> V_27 . V_465 = F_61 ( V_152 -> V_14 + V_462 ) & 0xffff ;
V_152 -> V_27 . V_29 = F_61 ( V_152 -> V_14 + V_271 ) & 0xffff ;
V_152 -> V_27 . V_28 = F_61 ( V_152 -> V_14 + V_272 ) & 0xffff ;
V_152 -> V_27 . V_38 = F_61 ( V_152 -> V_14 + V_457 ) & 0xffff ;
V_437 = F_61 ( V_152 -> V_14 + V_459 ) ;
V_438 = ( T_3 * ) ( V_152 -> V_17 + V_437 ) ;
for( V_31 = 1 ; V_31 <= V_152 -> V_39 ; V_31 ++ )
{
* V_438 = ( T_3 ) 0 ;
V_438 ++ ;
...
F_47 (printk(L_103);)
#if 1
F_16 ( 0 , V_152 -> V_14 + V_466 ) ;
#else
V_439 = ( V_152 -> V_17 + V_146 * V_152 -> V_113 ) >> 17 ;
F_47 (printk(L_104, tmp16);)
F_16 ( V_439 , V_152 -> V_14 + V_466 ) ;
#endif
F_47 (printk(L_105,
readw(iadev->seg_reg+CBR_PTR_BASE));)
V_439 = ( V_146 * V_152 -> V_113 ) >> 1 ;
F_16 ( V_439 , V_152 -> V_14 + V_467 ) ;
F_47 (printk(L_106, tmp16,
readw(iadev->seg_reg+CBR_TAB_BEG));)
F_16 ( V_439 , V_152 -> V_14 + V_468 + 1 ) ;
V_439 = ( V_146 * V_152 -> V_113 + V_152 -> V_70 * 6 - 2 ) >> 1 ;
F_16 ( V_439 , V_152 -> V_14 + V_468 ) ;
F_47 (printk(L_107,
iadev->seg_reg, readw(iadev->seg_reg+CBR_PTR_BASE));)
F_47 (printk(L_108,
readw(iadev->seg_reg+CBR_TAB_BEG), readw(iadev->seg_reg+CBR_TAB_END),
readw(iadev->seg_reg+CBR_TAB_END+1));)
F_83 ( V_152 -> V_17 + V_146 * V_152 -> V_113 ,
0 , V_152 -> V_70 * 6 ) ;
V_152 -> V_141 = V_152 -> V_144 = V_152 -> V_70 * 3 ;
V_152 -> V_145 = 0 ;
V_152 -> V_140 = V_469 / V_152 -> V_144 ;
V_152 -> V_147 = 0 ;
V_355 = 0 ;
V_31 = 8 * 1024 ;
while ( V_31 != V_152 -> V_70 ) {
...
V_31 = V_443 * V_152 -> V_113 ;
F_16 ( V_355 | ( ( V_31 >> 8 ) & 0xfff8 ) , V_152 -> V_14 + V_470 ) ;
V_31 = V_444 * V_152 -> V_113 ;
F_16 ( ( V_31 >> 8 ) & 0xfffe , V_152 -> V_14 + V_471 ) ;
V_31 = V_472 * V_152 -> V_113 ;
F_16 ( ( V_31 & 0xffff ) >> 11 , V_152 -> V_14 + V_473 ) ;
V_31 = V_474 * V_152 -> V_113 ;
F_16 ( ( V_31 >> 7 ) & 0xffff , V_152 -> V_14 + V_475 ) ;
memset ( ( V_98 ) ( V_152 -> V_17 + V_472 * V_152 -> V_113 ) ,
0 , V_152 -> V_70 * 8 ) ;
V_31 = V_445 * V_152 -> V_113 ;
F_16 ( ( V_31 >> 11 ) & 0xffff , V_152 -> V_14 + V_476 ) ;
V_31 = V_477 * V_152 -> V_113 ;
F_16 ( ( V_31 >> 7 ) & 0xffff , V_152 -> V_14 + V_478 ) ;
V_31 = V_445 * V_152 -> V_113 ;
memset ( ( V_98 ) ( V_152 -> V_17 + V_31 ) , 0 , V_152 -> V_70 * 4 ) ;
V_407 = (struct V_47 * ) V_152 -> V_49 ;
V_408 = (struct V_50 * ) V_152 -> V_52 ;
V_152 -> V_57 = F_4 ( sizeof( long ) * V_152 -> V_70 , V_395 ) ;
if ( ! V_152 -> V_57 ) {
F_9 ( L_109 ) ;
goto V_479;
}
...
memset ( ( V_98 ) V_407 , 0 , sizeof( * V_407 ) ) ;
memset ( ( V_98 ) V_408 , 0 , sizeof( * V_408 ) ) ;
V_152 -> V_57 [ V_31 ] = F_4 ( sizeof( struct V_480 ) ,
V_395 ) ;
if ( ! V_152 -> V_57 [ V_31 ] )
goto V_481;
V_152 -> V_57 [ V_31 ] -> V_66 = 0 ;
V_152 -> V_57 [ V_31 ] -> V_67 = 0 ;
V_152 -> V_57 [ V_31 ] -> V_59 = V_482 ;
V_407 ++ ;
V_408 ++ ;
}
if ( V_152 -> V_186 & V_188 ) {
F_16 ( V_483 , V_152 -> V_14 + V_484 ) ;
F_16 ( ( V_149 | ( 0x23 << 2 ) ) , V_152 -> V_14 + V_151 ) ;
}
else {
F_16 ( F_18 ( V_152 -> V_81 ) , V_152 -> V_14 + V_484 ) ;
F_16 ( ( V_149 | V_150 | ( 0x23 << 2 ) ) , V_152 -> V_14 + V_151 ) ;
}
F_16 ( 0 , V_152 -> V_14 + V_485 ) ;
F_16 ( 0 , V_152 -> V_14 + V_486 ) ;
F_16 ( 0xaa00 , V_152 -> V_14 + V_487 ) ;
V_152 -> V_400 = 0 ;
F_97 ( & V_152 -> V_401 ) ;
F_97 ( & V_152 -> V_488 ) ;
F_84 ( & V_152 -> V_404 ) ;
F_1 ( & V_152 -> V_26 ) ;
F_16 ( V_489 , V_152 -> V_14 + V_490 ) ;
F_84 ( & V_152 -> V_156 ) ;
F_16 ( V_491 , V_152 -> V_14 + V_492 ) ;
...
V_453:
while ( -- V_31 >= 0 ) {
struct V_450 * V_274 = V_152 -> V_449 + V_31 ;
F_74 ( V_152 -> V_311 , V_274 -> V_286 ,
sizeof( * V_274 -> V_451 ) , V_405 ) ;
F_41 ( V_274 -> V_451 ) ;
}
F_41 ( V_152 -> V_449 ) ;
V_396:
F_86 ( V_152 -> V_311 , V_358 , V_152 -> V_402 . V_318 ,
V_152 -> V_440 ) ;
V_360:
return - V_398 ;
}
static T_14 F_98 ( int V_494 , void * V_495 )
{
struct V_273 * V_9 ;
T_2 * V_152 ;
unsigned int V_62 ;
...
V_9 = V_495 ;
V_152 = F_31 ( V_9 ) ;
while( ( V_62 = F_7 ( V_152 -> V_194 + V_497 ) & 0x7f ) )
{
V_496 = 1 ;
...
if ( V_62 & V_501 )
{
F_50 ( V_501 , V_152 -> V_194 + V_497 ) ;
F_91 ( V_9 ) ;
}
if ( V_62 & ( V_502 | V_503 | V_504 ) )
{
if ( V_62 & V_502 )
F_51 ( V_152 ) ;
}
...
static int F_100 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
int V_31 ;
T_8 V_505 ;
T_4 V_506 ;
V_152 = F_31 ( V_9 ) ;
V_505 = F_101 ( F_102 ( F_7 (
V_152 -> V_194 + V_507 ) ) ) ;
V_506 = F_103 ( F_104 ( F_7 ( V_152 -> V_194 + V_508 ) ) ) ;
F_47 (printk(L_113, mac1, mac2);)
for ( V_31 = 0 ; V_31 < V_509 ; V_31 ++ )
V_9 -> V_510 [ V_31 ] = V_505 >> ( 8 * ( V_509 - 1 - V_31 ) ) ;
for ( V_31 = 0 ; V_31 < V_511 ; V_31 ++ )
V_9 -> V_510 [ V_31 + V_509 ] = V_506 >> ( 8 * ( V_511 - 1 - V_31 ) ) ;
return 0 ;
}
static int F_105 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
int V_31 , error = 1 ;
...
V_31 * 4 , & V_311 [ V_31 ] ) ) != V_512 )
return error ;
F_50 ( 0 , V_152 -> V_194 + V_513 ) ;
for( V_31 = 0 ; V_31 < 64 ; V_31 ++ )
if ( ( error = F_107 ( V_152 -> V_311 ,
V_31 * 4 , V_311 [ V_31 ] ) ) != V_512 )
return error ;
F_15 ( 5 ) ;
return 0 ;
}
static int T_15 F_108 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
unsigned long V_514 ;
void T_13 * V_515 ;
unsigned short V_516 ;
int error , V_31 ;
F_47 (printk(L_114);)
V_9 -> V_517 . V_518 = 0 ;
V_9 -> V_517 . V_519 = V_520 ;
V_152 = F_31 ( V_9 ) ;
V_514 = F_109 ( V_152 -> V_311 , 0 ) ;
V_152 -> V_494 = V_152 -> V_311 -> V_494 ;
error = F_110 ( V_152 -> V_311 , V_521 , & V_516 ) ;
if ( error ) {
...
V_152 -> V_522 = F_111 ( V_152 -> V_311 , 0 ) ;
if ( V_152 -> V_522 == 0x100000 ) {
V_152 -> V_70 = 4096 ;
V_9 -> V_517 . V_519 = V_523 ;
V_152 -> V_113 = 4 ;
}
else if ( V_152 -> V_522 == 0x40000 ) {
V_152 -> V_70 = 1024 ;
V_152 -> V_113 = 1 ;
}
else {
F_9 ( L_117 , V_152 -> V_522 ) ;
return - V_289 ;
}
F_47 (printk (DEV_LABEL L_118, iadev->pci_map_size);)
F_112 ( V_152 -> V_311 ) ;
F_15 ( 10 ) ;
V_515 = F_113 ( V_514 , V_152 -> V_522 ) ;
if ( ! V_515 )
{
F_9 ( V_524 L_119 ,
V_9 -> V_525 ) ;
...
V_152 -> V_526 = V_152 -> V_522 / 2 ;
V_152 -> V_514 = V_514 ;
V_152 -> V_515 = V_515 ;
V_152 -> V_194 = V_515 + V_527 ;
V_152 -> V_14 = V_515 + V_528 ;
V_152 -> V_279 = V_515 + V_529 ;
V_152 -> V_195 = V_515 + V_530 ;
V_152 -> V_319 = V_515 + V_530 ;
V_152 -> V_531 = V_515 + V_532 ;
V_152 -> V_17 = V_515 + V_533 ;
V_152 -> V_111 = V_515 + V_534 ;
F_47 (printk(L_121,
...
F_9 ( L_122 ) ;
for ( V_31 = 0 ; V_31 < V_535 ; V_31 ++ )
F_9 ( L_123 , V_31 ? L_124 : L_125 , V_9 -> V_510 [ V_31 ] ) ;
F_9 ( L_74 ) ;
if ( F_105 ( V_9 ) ) {
F_114 ( V_152 -> V_515 ) ;
F_9 ( L_126 ) ;
...
if ( ! V_152 -> V_197 )
return;
V_152 -> V_536 += F_61 ( V_152 -> V_279 + V_537 ) & 0xffff ;
V_152 -> V_536 += ( F_61 ( V_152 -> V_279 + V_538 ) & 0xffff ) << 16 ;
V_152 -> V_539 += F_61 ( V_152 -> V_279 + V_540 ) & 0xffff ;
V_152 -> V_541 += F_61 ( V_152 -> V_279 + V_542 ) & 0xffff ;
V_152 -> V_543 += F_61 ( V_152 -> V_14 + V_544 ) & 0xffff ;
V_152 -> V_543 += ( F_61 ( V_152 -> V_14 + V_545 ) & 0xffff ) << 16 ;
return;
}
static void F_116 ( unsigned long V_546 ) {
unsigned long V_158 ;
static T_5 V_547 [ 8 ] = { 0 , 0 , 0 , 0 , 0 , 0 , 0 , 0 } ;
T_5 V_31 ;
static T_8 V_548 ;
for ( V_31 = 0 ; V_31 < V_549 ; V_31 ++ ) {
if ( V_550 [ V_31 ] ) {
V_548 = F_7 ( V_550 [ V_31 ] -> V_194 + V_551 ) ;
if ( V_547 [ V_31 ] == 0 ) {
V_547 [ V_31 ] ++ ;
V_548 &= ( ~ V_552 ) ;
F_50 ( V_548 , V_550 [ V_31 ] -> V_194 + V_551 ) ;
F_115 ( V_550 [ V_31 ] ) ;
}
else {
V_547 [ V_31 ] = 0 ;
V_548 |= V_552 ;
F_50 ( V_548 , V_550 [ V_31 ] -> V_194 + V_551 ) ;
F_88 ( & V_550 [ V_31 ] -> V_399 , V_158 ) ;
if ( V_550 [ V_31 ] -> V_400 )
F_90 ( & V_550 [ V_31 ] -> V_401 ) ;
F_40 ( V_550 [ V_31 ] ) ;
F_89 ( & V_550 [ V_31 ] -> V_399 , V_158 ) ;
}
}
}
F_117 ( & V_553 , V_37 + V_415 / 4 ) ;
return;
}
static void F_118 ( struct V_273 * V_9 , unsigned char V_554 ,
unsigned long V_165 )
{
F_50 ( V_554 , F_31 ( V_9 ) -> V_195 + V_165 ) ;
}
static unsigned char F_119 ( struct V_273 * V_9 , unsigned long V_165 )
{
...
static void F_121 ( T_2 * V_152 )
{
F_41 ( V_152 -> V_295 ) ;
F_86 ( V_152 -> V_311 , V_358 , V_152 -> V_308 . V_318 ,
V_152 -> V_359 ) ;
}
static int T_15 F_122 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
int error ;
unsigned char V_195 ;
...
F_10 (printk(L_127);)
V_152 = F_31 ( V_9 ) ;
if ( F_123 ( V_152 -> V_494 , & F_98 , V_555 , V_524 , V_9 ) ) {
F_9 (KERN_ERR DEV_LABEL L_128 ,
dev->number, iadev->irq) ;
error = - V_556 ;
goto V_360;
}
if ( ( error = F_124 ( V_152 -> V_311 ,
V_521 ,
V_557 | V_558 ) ) )
{
...
V_548 = F_7 ( V_152 -> V_194 + V_551 ) ;
V_548 = ( V_548 & ( V_552 | V_561 ) )
| V_562
| V_563
| V_564
| V_565
...
goto V_575;
V_548 = F_7 ( V_152 -> V_194 + V_551 ) ;
F_50 ( V_548 | V_561 , V_152 -> V_194 + V_551 ) ;
F_47 (printk(L_132,
readl(iadev->reg+IPHASE5575_BUS_CONTROL_REG));)
V_195 = 0 ;
F_47 (
...
F_120 ( V_152 ) ;
V_560:
F_125 ( V_152 -> V_494 , V_9 ) ;
V_360:
return error ;
}
static void F_126 ( struct V_40 * V_41 )
{
F_127 ( V_577 ) ;
T_4 * V_345 ;
T_2 * V_152 ;
...
struct V_578 V_579 , V_580 ;
unsigned long V_581 , V_158 ;
V_152 = F_31 ( V_41 -> V_9 ) ;
V_12 = F_29 ( V_41 ) ;
if ( ! V_12 ) return;
F_10 (printk(L_136,
ia_vcc->vc_desc_cnt,vcc->vci);)
F_128 ( V_157 , & V_41 -> V_158 ) ;
F_84 ( & V_579 ) ;
F_84 ( & V_580 ) ;
if ( V_41 -> V_53 . V_54 . V_55 != V_348 ) {
V_152 -> V_400 ++ ;
F_129 ( & V_152 -> V_488 , & V_577 , V_582 ) ;
F_130 ( 50 ) ;
F_131 ( & V_152 -> V_488 , & V_577 ) ;
F_88 ( & V_152 -> V_399 , V_158 ) ;
...
if ( V_41 -> V_53 . V_347 . V_55 != V_348 ) {
V_345 = ( T_4 * ) ( V_152 -> V_111 + V_112 * V_152 -> V_113 ) ;
V_345 += V_41 -> V_58 ;
* V_345 = V_114 ;
V_345 = ( T_4 * ) ( V_152 -> V_111 + V_349 * V_152 -> V_113 ) ;
V_345 += V_41 -> V_58 ;
* V_345 = ( V_41 -> V_58 << 6 ) | 15 ;
if ( V_41 -> V_53 . V_347 . V_55 == V_56 ) {
struct V_352 T_13 * V_352 =
...
V_12 = NULL ;
V_41 -> V_412 = NULL ;
F_128 ( V_583 , & V_41 -> V_158 ) ;
return;
}
static int F_133 ( struct V_40 * V_41 )
{
struct V_12 * V_12 ;
int error ;
if ( ! F_37 ( V_584 , & V_41 -> V_158 ) )
{
F_10 (printk(L_138);)
V_41 -> V_412 = NULL ;
}
if ( V_41 -> V_58 != V_585 && V_41 -> V_586 != V_587 )
{
F_10 (printk(L_139);)
F_134 ( V_583 , & V_41 -> V_158 ) ;
}
if ( V_41 -> V_53 . V_588 != V_589 )
return - V_289 ;
F_10 (printk(DEV_LABEL L_140,
vcc->dev->number, vcc->vpi, vcc->vci);)
V_12 = F_4 ( sizeof( * V_12 ) , V_395 ) ;
if ( ! V_12 ) return - V_398 ;
V_41 -> V_412 = V_12 ;
if ( ( error = F_80 ( V_41 ) ) )
{
F_10 (printk(L_141);)
...
static int F_135 ( struct V_40 * V_41 , struct V_590 * V_53 , int V_158 )
{
F_10 (printk(L_144);)
return 0 ;
}
static int F_136 ( struct V_273 * V_9 , unsigned int V_591 , void T_16 * V_546 )
{
T_17 V_592 ;
T_2 * V_152 ;
int V_31 , V_593 ;
...
F_10 (printk(L_145);)
if ( V_591 != V_595 ) {
if ( ! V_9 -> V_195 -> V_596 ) return - V_289 ;
return V_9 -> V_195 -> V_596 ( V_9 , V_591 , V_546 ) ;
}
if ( F_137 ( & V_592 , V_546 , sizeof V_592 ) ) return - V_597 ;
V_593 = V_592 . V_62 ;
if ( ( V_593 < 0 ) || ( V_593 > V_549 ) )
V_593 = 0 ;
V_152 = V_550 [ V_593 ] ;
switch ( V_592 . V_591 ) {
case V_598 :
...
switch ( V_592 . V_599 ) {
case V_600 :
if ( ! F_138 ( V_601 ) ) return - V_602 ;
if ( F_139 ( V_592 . V_603 , V_152 , sizeof( T_2 ) ) )
return - V_597 ;
V_592 . V_62 = 0 ;
break;
case V_604 :
if ( ! F_138 ( V_601 ) ) return - V_602 ;
V_594 = ( T_4 T_16 * ) V_592 . V_603 ;
for( V_31 = 0 ; V_31 < 0x80 ; V_31 += 2 , V_594 ++ )
if( F_140 ( ( T_4 ) ( F_7 ( V_152 -> V_14 + V_31 ) & 0xffff ) , V_594 ) ) return - V_597 ;
V_592 . V_62 = 0 ;
V_592 . V_164 = 0x80 ;
break;
case V_605 :
...
V_594 = ( T_4 T_16 * ) V_592 . V_603 ;
for( V_31 = 0 ; V_31 < 0x80 ; V_31 += 2 , V_594 ++ )
if( F_140 ( ( T_4 ) ( F_7 ( V_152 -> V_279 + V_31 ) & 0xffff ) , V_594 ) ) return - V_597 ;
V_592 . V_62 = 0 ;
V_592 . V_164 = 0x80 ;
break;
case V_606 :
...
T_20 * V_275 ;
if ( ! F_138 ( V_601 ) ) return - V_602 ;
V_607 = F_4 ( sizeof( * V_607 ) , V_395 ) ;
if ( ! V_607 ) return - V_398 ;
V_27 = & V_607 -> V_608 ;
V_275 = & V_607 -> V_609 ;
...
if ( F_139 ( V_592 . V_603 , V_607 , sizeof( T_18 ) ) ) {
F_41 ( V_607 ) ;
return - V_597 ;
}
F_41 ( V_607 ) ;
...
{
V_592 . V_62 = 0 ;
F_9 ( L_147 , ( long ) F_141 ( & V_152 -> V_156 ) ) ;
...
{
struct V_611 * V_300 ;
V_300 = & F_142 ( V_612 [ V_593 ] ) -> V_613 ;
F_9 ( L_149 , F_143 ( & V_300 -> V_614 ) ) ;
F_9 ( L_150 , F_143 ( & V_300 -> V_615 ) ) ;
F_9 ( L_151 , F_143 ( & V_300 -> V_616 ) ) ;
F_9 ( L_152 , F_143 ( & V_300 -> V_617 ) ) ;
F_9 ( L_153 , F_143 ( & V_300 -> V_618 ) ) ;
F_9 ( L_154 , F_143 ( & V_300 -> V_619 ) ) ;
F_9 ( L_155 , F_143 ( & V_300 -> V_620 ) ) ;
F_9 ( L_156 , F_143 ( & V_300 -> V_621 ) ) ;
F_9 ( L_157 , F_143 ( & V_300 -> V_622 ) ) ;
}
V_592 . V_62 = 0 ;
break;
case 0x9 :
...
static int F_144 ( struct V_40 * V_41 , int V_625 , int V_626 ,
void T_16 * V_627 , int V_628 )
{
F_10 (printk(L_159);)
return - V_289 ;
}
static int F_145 ( struct V_40 * V_41 , int V_625 , int V_626 ,
void T_16 * V_627 , unsigned int V_628 )
{
F_10 (printk(L_160);)
return - V_289 ;
}
...
F_16 ( V_152 -> V_27 . V_38 , V_152 -> V_14 + V_457 ) ;
* ( T_4 * ) ( V_152 -> V_17 + V_152 -> V_27 . V_465 ) = V_274 ;
V_152 -> V_27 . V_465 += 2 ;
if ( V_152 -> V_27 . V_465 > V_152 -> V_27 . V_464 )
V_152 -> V_27 . V_465 = V_152 -> V_27 . V_463 ;
V_630 = V_33 -> V_164 + sizeof( struct V_340 ) ;
V_630 = ( ( V_630 + 47 ) / 48 ) * 48 ;
F_146 (printk(L_166, total_len, total_len - skb->len);)
V_341 = V_152 -> V_449 [ V_274 - 1 ] . V_451 ;
F_146 (printk(L_167,
...
printk(L_74);)
V_282 = V_152 -> V_17 + V_446 ;
V_282 += V_274 ;
V_282 -> V_296 = V_448 | V_634 | V_635 | V_636 ;
F_16 ( V_72 , V_152 -> V_14 + V_75 ) ;
V_282 -> V_294 = V_41 -> V_58 ;
V_282 -> V_314 = V_630 ;
if ( V_41 -> V_53 . V_54 . V_55 == V_56 )
F_14 ( V_41 , V_152 ) ;
V_284 = V_152 -> V_402 . V_309 ;
...
V_284 -> V_315 = V_637 ;
V_284 -> V_638 = 0 ;
if ( ++ V_284 == V_152 -> V_402 . V_317 )
V_284 = V_152 -> V_402 . V_318 ;
V_284 -> V_310 = V_152 -> V_449 [ V_274 - 1 ] . V_286 ;
V_284 -> V_313 = ( ( V_282 -> V_303 << 16 ) |
V_282 -> V_304 ) + V_630 - sizeof( struct V_340 ) ;
V_284 -> V_314 = sizeof( struct V_340 ) ;
V_284 -> V_315 = V_316 ;
V_284 -> V_638 = V_152 -> V_27 . V_465 ;
if ( ++ V_284 == V_152 -> V_402 . V_317 )
V_284 = V_152 -> V_402 . V_318 ;
V_152 -> V_402 . V_309 = V_284 ;
F_69 ( V_33 ) = V_41 -> V_58 ;
F_70 ( & V_152 -> V_404 , V_33 ) ;
F_66 ( & V_41 -> V_300 -> V_631 ) ;
V_152 -> V_493 ++ ;
F_50 ( 2 , V_152 -> V_319 + V_639 ) ;
#if 0
...
static int F_148 ( struct V_40 * V_41 , struct V_32 * V_33 )
{
T_2 * V_152 ;
unsigned long V_158 ;
V_152 = F_31 ( V_41 -> V_9 ) ;
...
static int F_149 ( struct V_273 * V_9 , T_21 * V_641 , char * V_642 )
{
int V_643 = * V_641 , V_644 ;
char * V_645 ;
T_2 * V_152 = F_31 ( V_9 ) ;
if( ! V_643 -- ) {
if ( V_152 -> V_186 == V_188 ) {
V_644 = sprintf ( V_642 , L_172 ) ;
return V_644 ;
}
if ( V_152 -> V_186 == V_189 )
V_644 = sprintf ( V_642 , L_173 ) ;
else if ( V_152 -> V_186 == V_190 )
V_644 = sprintf ( V_642 , L_174 ) ;
else if ( V_152 -> V_186 == V_646 )
V_644 = sprintf ( V_642 , L_175 ) ;
else
V_644 = sprintf ( V_642 , L_176 ) ;
V_645 = V_642 + V_644 ;
if ( V_152 -> V_522 == 0x40000 )
V_644 += sprintf ( V_645 , L_177 ) ;
else
V_644 += sprintf ( V_645 , L_178 ) ;
V_645 = V_642 + V_644 ;
if ( ( V_152 -> V_171 & V_172 ) == V_173 )
V_644 += sprintf ( V_645 , L_179 ) ;
else if ( ( V_152 -> V_171 & V_172 ) == V_181 )
V_644 += sprintf ( V_645 , L_180 ) ;
else
V_644 += sprintf ( V_645 , L_181 ) ;
return V_644 ;
}
if ( ! V_643 ) {
return sprintf ( V_642 , L_182
L_183
L_184
L_185
L_186
...
V_152 -> V_329 , V_152 -> V_493 ,
V_152 -> V_536 , V_152 -> V_543 ,
V_152 -> V_541 , V_152 -> V_539 ) ;
}
return 0 ;
}
static int T_15 F_150 ( struct V_647 * V_648 ,
const struct V_649 * V_650 )
{
struct V_273 * V_9 ;
T_2 * V_152 ;
int V_409 ;
V_152 = F_85 ( sizeof( * V_152 ) , V_395 ) ;
if ( ! V_152 ) {
V_409 = - V_398 ;
goto V_360;
}
...
V_9 = F_152 ( V_524 , & V_648 -> V_9 , & V_653 , - 1 , NULL ) ;
if ( ! V_9 ) {
V_409 = - V_398 ;
goto V_654;
}
...
static void T_22 F_156 ( struct V_647 * V_648 )
{
struct V_273 * V_9 = F_157 ( V_648 ) ;
T_2 * V_152 = F_31 ( V_9 ) ;
F_118 ( V_9 , F_119 ( V_9 , V_658 ) & ~ ( V_659 ) ,
V_658 ) ;
F_15 ( 1 ) ;
if ( V_9 -> V_195 && V_9 -> V_195 -> V_660 )
V_9 -> V_195 -> V_660 ( V_9 ) ;
F_125 ( V_152 -> V_494 , V_9 ) ;
V_549 -- ;
V_550 [ V_549 ] = NULL ;
...
static int T_23 F_158 ( void )
{
int V_409 ;
V_409 = F_159 ( & V_661 ) ;
if ( V_409 >= 0 ) {
V_553 . V_662 = V_37 + 3 * V_415 ;
F_160 ( & V_553 ) ;
} else
F_9 (KERN_ERR DEV_LABEL L_198 ) ;
return V_409 ;
}
static void T_24 F_161 ( void )
{
F_162 ( & V_661 ) ;
F_163 ( & V_553 ) ;
}
