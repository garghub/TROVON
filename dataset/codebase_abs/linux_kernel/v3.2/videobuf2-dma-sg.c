...
F_18 ( V_40 , V_12 , V_2 ) , 0 ) ;
V_2 -= F_18 ( V_40 , V_12 , V_2 ) ;
}
return V_4 ;
V_39:
F_8 ( V_27 L_3 ,
...
F_23 ( ! V_4 ) ;
if ( ! V_4 -> V_7 )
V_4 -> V_7 = F_24 ( V_4 -> V_16 ,
V_4 -> V_10 . V_11 ,
- 1 ,
V_41 ) ;
return V_4 -> V_7 + V_4 -> V_9 ;
}
static unsigned int F_25 ( void * V_29 )
{
struct V_3 * V_4 = V_29 ;
return F_26 ( & V_4 -> V_23 ) ;
}
static int F_27 ( void * V_29 , struct V_42 * V_43 )
{
struct V_3 * V_4 = V_29 ;
