...
F_73 ( V_18 , V_100 . V_121 ) ;
V_18 -> V_122 = V_100 . V_123 ;
V_18 -> V_124 = V_100 . V_125 ;
V_18 -> V_126 = V_100 . V_127 ;
V_18 -> V_128 = V_100 . V_129 ;
V_18 -> V_130 = V_100 . ctime ;
V_18 -> V_89 = V_100 . V_131 ;
V_18 -> V_132 = V_100 . V_133 ;
return 0 ;
}
int F_74 ( struct V_2 * V_59 , struct V_4 * V_4 , int V_65 ,
struct V_134 * V_135 )
{
struct V_2 * V_2 ;
char * V_10 ;
...
goto V_137;
V_43 = F_76 ( V_10 ,
V_65 & V_138 , V_65 & V_139 , V_65 & V_140 ,
V_65 & V_141 , V_65 & V_142 , V_65 & V_143 ,
V_65 & V_144 , V_65 & V_145 , V_65 & V_146 ) ;
if ( V_43 < 0 )
error = V_43 ;
else
error = F_69 ( V_2 , V_10 ) ;
...
int F_81 ( struct V_4 * V_148 , struct V_2 * V_18 , struct V_4 * V_97 )
{
char * V_149 , * V_150 ;
int V_31 ;
if ( ( V_149 = F_10 ( V_97 ) ) == NULL )
return - V_23 ;
V_150 = F_10 ( V_148 ) ;
if ( V_150 == NULL ) {
F_8 ( V_149 ) ;
...
int F_85 ( struct V_2 * V_18 , struct V_4 * V_4 , const char * V_148 )
{
char * V_56 ;
int V_31 ;
if ( ( V_56 = F_10 ( V_4 ) ) == NULL )
return - V_23 ;
V_31 = F_86 ( V_56 , V_148 ) ;
F_8 ( V_56 ) ;
return V_31 ;
}
int F_87 ( struct V_2 * V_18 , struct V_4 * V_4 , int V_65 )
{
char * V_56 ;
int V_31 ;
if ( ( V_56 = F_10 ( V_4 ) ) == NULL )
...
int F_91 ( struct V_2 * V_59 , struct V_4 * V_4 , int V_65 , T_7 V_152 )
{
struct V_2 * V_2 ;
char * V_10 ;
int V_31 ;
...
goto V_137;
F_72 ( V_2 , V_65 , V_152 ) ;
V_31 = F_92 ( V_10 , V_65 , F_93 ( V_152 ) , F_94 ( V_152 ) ) ;
if ( ! V_31 )
goto V_26;
V_31 = F_69 ( V_2 , V_10 ) ;
F_8 ( V_10 ) ;
...
int F_95 ( struct V_2 * V_153 , struct V_4 * V_97 ,
struct V_2 * V_154 , struct V_4 * V_148 )
{
char * V_149 , * V_150 ;
int V_31 ;
if ( ( V_149 = F_10 ( V_97 ) ) == NULL )
return - V_23 ;
if ( ( V_150 = F_10 ( V_148 ) ) == NULL ) {
F_8 ( V_149 ) ;
return - V_23 ;
}
V_31 = F_96 ( V_149 , V_150 ) ;
F_8 ( V_149 ) ;
F_8 ( V_150 ) ;
return V_31 ;
}
int F_97 ( struct V_2 * V_18 , int V_155 )
{
char * V_10 ;
int V_66 = 0 , V_67 = 0 , V_156 = 0 , V_31 ;
if ( V_155 & V_157 )
return - V_158 ;
if ( V_155 & V_159 ) V_66 = 1 ;
if ( V_155 & V_160 ) V_67 = 1 ;
if ( V_155 & V_161 ) V_156 = 1 ;
V_10 = F_12 ( V_18 ) ;
if ( V_10 == NULL )
return - V_23 ;
if ( F_98 ( V_18 -> V_120 ) || F_99 ( V_18 -> V_120 ) ||
F_100 ( V_18 -> V_120 ) || F_101 ( V_18 -> V_120 ) )
V_31 = 0 ;
else
V_31 = F_102 ( V_10 , V_66 , V_67 , V_156 ) ;
F_8 ( V_10 ) ;
if ( ! V_31 )
V_31 = F_103 ( V_18 , V_155 ) ;
return V_31 ;
}
int F_104 ( struct V_4 * V_4 , struct V_162 * V_163 )
{
struct V_2 * V_2 = V_4 -> V_164 ;
struct V_165 V_166 ;
char * V_10 ;
int V_31 ;
int V_43 = F_1 ( V_2 ) -> V_43 ;
V_31 = F_105 ( V_2 , V_163 ) ;
if ( V_31 )
return V_31 ;
if ( V_9 )
V_163 -> V_167 &= ~ V_168 ;
V_166 . V_167 = 0 ;
if ( V_163 -> V_167 & V_169 ) {
V_166 . V_167 |= V_170 ;
V_166 . V_171 = V_163 -> V_171 ;
}
if ( V_163 -> V_167 & V_172 ) {
V_166 . V_167 |= V_173 ;
V_166 . V_174 = V_163 -> V_174 ;
}
if ( V_163 -> V_167 & V_175 ) {
V_166 . V_167 |= V_176 ;
V_166 . V_177 = V_163 -> V_177 ;
}
if ( V_163 -> V_167 & V_168 ) {
V_166 . V_167 |= V_178 ;
V_166 . V_179 = V_163 -> V_179 ;
}
if ( V_163 -> V_167 & V_180 ) {
V_166 . V_167 |= V_181 ;
V_166 . V_182 = V_163 -> V_182 ;
}
if ( V_163 -> V_167 & V_183 ) {
V_166 . V_167 |= V_184 ;
V_166 . V_185 = V_163 -> V_185 ;
}
if ( V_163 -> V_167 & V_186 ) {
V_166 . V_167 |= V_187 ;
V_166 . V_188 = V_163 -> V_188 ;
}
if ( V_163 -> V_167 & V_189 ) {
V_166 . V_167 |= V_190 ;
}
if ( V_163 -> V_167 & V_191 ) {
V_166 . V_167 |= V_192 ;
}
V_10 = F_10 ( V_4 ) ;
if ( V_10 == NULL )
return - V_23 ;
V_31 = F_106 ( V_10 , & V_166 , V_43 ) ;
F_8 ( V_10 ) ;
if ( V_31 )
return V_31 ;
if ( ( V_163 -> V_167 & V_168 ) &&
V_163 -> V_179 != F_107 ( V_2 ) ) {
int error ;
error = F_108 ( V_2 , V_163 -> V_179 ) ;
if ( V_31 )
return V_31 ;
}
F_109 ( V_2 , V_163 ) ;
...
static void * F_111 ( struct V_4 * V_4 , struct V_134 * V_135 )
{
char * V_19 = F_11 () ;
if ( V_19 ) {
char * V_193 = F_10 ( V_4 ) ;
...
static void F_113 ( struct V_4 * V_4 , struct V_134 * V_135 , void * V_195 )
{
char * V_17 = F_114 ( V_135 ) ;
if ( ! F_7 ( V_17 ) )
F_8 ( V_17 ) ;
}
static int F_115 ( struct V_27 * V_28 , void * V_196 , int V_197 )
{
struct V_2 * V_198 ;
char * V_199 , * V_200 = V_196 ;
int V_31 ;
V_28 -> V_201 = 1024 ;
V_28 -> V_202 = 10 ;
V_28 -> V_203 = V_41 ;
...
V_31 = - V_23 ;
V_28 -> V_16 = V_199 =
F_16 ( strlen ( V_8 ) + strlen ( V_200 ) + 2 , V_24 ) ;
if ( V_199 == NULL )
goto V_25;
sprintf ( V_199 , L_6 , V_8 , V_200 ) ;
V_198 = F_21 ( V_28 ) ;
if ( ! V_198 )
goto V_25;
V_31 = F_69 ( V_198 , V_199 ) ;
if ( V_31 )
goto V_137;
if ( F_116 ( V_198 -> V_120 ) ) {
char * V_10 = F_15 ( V_199 ) ;
if ( F_7 ( V_10 ) )
V_31 = F_75 ( V_10 ) ;
else
V_31 = F_69 ( V_198 , V_10 ) ;
F_18 ( V_10 ) ;
if ( V_31 )
goto V_137;
}
V_31 = - V_23 ;
V_28 -> V_210 = F_117 ( V_198 ) ;
if ( V_28 -> V_210 == NULL )
goto V_137;
return 0 ;
V_137:
...
static struct V_4 * F_118 ( struct V_211 * type ,
int V_93 , const char * V_212 ,
void * V_213 )
{
return F_119 ( type , V_93 , V_213 , F_115 ) ;
}
static void F_120 ( struct V_27 * V_17 )
{
F_121 ( V_17 ) ;
F_18 ( V_17 -> V_16 ) ;
}
