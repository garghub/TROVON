...
static int F_19 ( struct V_20 * V_21 , struct V_33 * V_34 )
{
struct V_8 * V_9 = F_15 ( V_21 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
...
{
struct V_7 * V_7 = F_3 ( V_170 -> V_171 , struct V_7 , V_172 ) ;
...
return 0 ;
case V_175 :
if ( F_9 ( V_9 , V_132 , V_170 -> V_19 * 2 ) < 0 )
return - V_127 ;
return 0 ;
case V_176 :
if ( F_10 ( V_9 , V_136 , V_170 -> V_19 << 7 ,
0x80 ) < 0 )
return - V_127 ;
V_7 -> V_88 = V_170 -> V_19 ;
return 0 ;
...
{
struct V_8 * V_9 = F_15 ( V_21 ) ;
struct V_179 * V_180 = F_38 ( V_9 ) ;
V_178 -> V_181 =
V_182 | V_183 |
V_184 | V_185 |
V_186 | V_187 ;
V_178 -> type = V_188 ;
V_178 -> V_181 = F_39 ( V_180 , V_178 ) ;
return 0 ;
}
...
if ( F_39 ( V_180 , V_178 ) &
V_182 )
return F_9 ( V_9 , V_189 , 1 << 4 ) ;
else
return F_9 ( V_9 , V_189 , 0 ) ;
}
...
V_192 = F_5 ( V_9 , V_194 ) ;
V_193 = F_5 ( V_9 , V_195 ) ;
if ( V_192 != 0x51 || V_193 != 0x10 ) {
V_12 = - V_163 ;
F_42 ( & V_9 -> V_14 , L_8 ,
V_192 , V_193 ) ;
goto V_196;
}
V_12 = F_9 ( V_9 , V_197 , V_191 -> V_198 << 7 ) ;
if ( V_12 < 0 )
goto V_196;
F_42 ( & V_9 -> V_14 , L_9 ,
V_192 , V_193 ) ;
...
struct V_7 * V_7 ;
struct V_179 * V_180 = F_38 ( V_9 ) ;
struct V_201 * V_202 = F_44 ( V_9 -> V_14 . V_203 ) ;
struct V_190 * V_204 ;
int V_12 ;
...
V_7 = F_47 ( sizeof( struct V_7 ) , V_206 ) ;
if ( ! V_7 )
return - V_207 ;
F_48 ( & V_7 -> V_10 , V_9 , & V_208 ) ;
F_49 ( & V_7 -> V_172 , 4 ) ;
F_50 ( & V_7 -> V_172 , & V_209 ,
V_173 , 0 , 1 , 1 , 0 ) ;
F_50 ( & V_7 -> V_172 , & V_209 ,
V_174 , 0 , 1 , 1 , 0 ) ;
F_50 ( & V_7 -> V_172 , & V_209 ,
...
F_50 ( & V_7 -> V_172 , & V_209 ,
V_176 , 0 , 1 , 1 , 1 ) ;
V_7 -> V_10 . V_210 = & V_7 -> V_172 ;
if ( V_7 -> V_172 . error ) {
int V_211 = V_7 -> V_172 . error ;
F_51 ( V_7 ) ;
return V_211 ;
}
V_7 -> V_110 = V_110 ;
...
V_7 -> V_4 = & V_23 [ 0 ] ;
V_7 -> V_47 = 1024 ;
V_7 -> V_94 = ( V_204 -> V_212 / V_106 * V_108 ) /
