...
static int F_47 ( struct V_1 * V_2 , T_1 V_194 )
{
F_42 ( V_2 , V_178 ) ;
return 0 ;
}
...
static int F_49 ( struct V_195 * V_196 ,
const struct V_197 * V_198 )
{
struct V_59 * V_60 ;
int V_159 ;
V_60 = F_50 ( sizeof( struct V_59 ) , V_199 ) ;
if ( NULL == V_60 )
return - V_200 ;
F_51 ( V_196 , V_60 ) ;
V_159 = F_52 ( & V_196 -> V_121 , & V_201 ,
V_202 , F_31 ( V_202 ) ) ;
if ( V_159 < 0 )
F_53 ( V_60 ) ;
return V_159 ;
}
static T_2 int F_54 ( struct V_195 * V_203 )
{
F_55 ( & V_203 -> V_121 ) ;
F_53 ( F_56 ( V_203 ) ) ;
return 0 ;
