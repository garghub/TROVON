...
int F_80 ( struct V_78 * V_79 , struct V_86 * V_87 , void * V_126 )
{
struct V_107 * V_107 = F_75 ( V_79 -> V_114 ) ;
struct V_88 * V_89 ;
struct V_127 * V_128 [ V_129 + 1 ] ;
struct V_48 * V_35 ;
struct V_25 * V_26 ;
const T_4 * V_37 ;
int V_108 ;
F_81 () ;
V_108 = F_82 ( V_87 , sizeof( * V_89 ) , V_128 , V_129 , NULL ) ;
if ( V_108 < 0 )
return V_108 ;
V_89 = F_61 ( V_87 ) ;
if ( V_89 -> V_97 == 0 ) {
...
if ( ! V_128 [ V_100 ] || F_85 ( V_128 [ V_100 ] ) != V_61 ) {
F_83 ( L_8 ) ;
return - V_71 ;
}
V_37 = F_86 ( V_128 [ V_100 ] ) ;
if ( ! F_50 ( V_37 ) ) {
F_83 ( L_9 ) ;
return - V_71 ;
}
...
F_20 ( & V_26 -> V_7 -> V_29 ) ;
V_108 = F_79 ( V_26 , V_37 , V_89 -> V_99 , V_87 -> V_131 ) ;
F_26 ( & V_26 -> V_7 -> V_29 ) ;
return V_108 ;
}
...
int F_89 ( struct V_78 * V_79 , struct V_86 * V_87 , void * V_126 )
{
struct V_107 * V_107 = F_75 ( V_79 -> V_114 ) ;
struct V_88 * V_89 ;
struct V_25 * V_26 ;
...
V_132 = F_91 ( V_87 , sizeof( * V_89 ) , V_100 ) ;
if ( V_132 == NULL || F_85 ( V_132 ) != V_61 ) {
F_83 ( L_13 ) ;
return - V_71 ;
}
V_37 = F_86 ( V_132 ) ;
