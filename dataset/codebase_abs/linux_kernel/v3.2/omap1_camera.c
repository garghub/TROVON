...
T_2 V_76 , V_78 ;
int V_41 ;
V_41 = F_68 ( V_129 , V_134 , V_197 , & V_194 ) ;
if ( ! V_41 ) {
V_196 = F_93 ( & V_194 , V_198 ) ;
if ( ! V_196 ) {
F_59 ( V_34 ,
L_31 ,
V_194 . V_97 , V_198 ) ;
...
V_194 . V_97 = V_196 ;
V_41 = F_68 ( V_129 , V_134 , V_204 , & V_194 ) ;
if ( V_41 < 0 && V_41 != - V_199 ) {
F_9 ( V_34 , L_32 ,
V_196 , V_41 ) ;
return V_41 ;
}
...
struct V_27 * V_28 ;
V_28 = F_34 ( V_13 -> V_184 . V_212 . V_69 , struct V_27 ,
V_31 . V_212 ) ;
F_95 ( V_209 , & V_28 -> V_31 . V_91 , V_210 ) ;
...
if ( ! V_2 ) {
F_79 ( & V_216 -> V_34 , L_38 ) ;
V_219 = - V_174 ;
goto V_223;
}
V_2 -> V_218 = V_218 ;
V_2 -> V_113 = V_113 ;
V_2 -> V_202 = V_216 -> V_34 . V_224 ;
if ( V_2 -> V_202 ) {
...
if ( V_219 < 0 ) {
F_79 ( & V_216 -> V_34 , L_43 ) ;
V_219 = - V_112 ;
goto V_231;
}
F_9 ( & V_216 -> V_34 , L_44 , V_2 -> V_53 ) ;
...
if ( V_219 ) {
F_79 ( & V_216 -> V_34 , L_45 ) ;
goto V_236;
}
V_2 -> V_237 . V_238 = V_227 ;
V_2 -> V_237 . V_239 = & V_240 ;
V_2 -> V_237 . V_22 = V_2 ;
V_2 -> V_237 . V_241 . V_34 = & V_216 -> V_34 ;
V_2 -> V_237 . V_242 = V_216 -> V_243 ;
V_219 = F_113 ( & V_2 -> V_237 ) ;
if ( V_219 )
goto V_244;
F_104 ( & V_216 -> V_34 , L_46 ) ;
return 0 ;
V_244:
F_114 ( V_2 -> V_99 , V_2 ) ;
V_236:
...
{
struct V_19 * V_237 = F_7 ( & V_216 -> V_34 ) ;
