...
return V_22 ;
V_313:
F_177 ( V_21 -> V_310 -> V_311 ) ;
V_312:
F_178 ( V_21 -> V_310 , V_247 ) ;
V_309:
return V_22 ;
}
static int F_179 ( struct V_306 * V_306 , struct V_247 * V_247 )
{
struct V_279 * V_21 ;
struct V_20 * V_49 ;
struct V_173 * V_174 ;
...
static long F_181 ( struct V_247 * V_247 , unsigned int V_261 , unsigned long V_319 )
{
struct V_173 * V_174 ;
...
V_174 = V_247 -> V_301 ;
if ( V_261 == V_321 )
return F_182 ( V_322 , V_320 ) ;
if ( V_261 == V_323 )
return F_182 ( 1 , V_320 ) ;
...
if ( F_43 ( V_176 >= 2 ) )
return - V_211 ;
return F_183 ( V_49 -> V_21 -> V_310 , V_261 , V_319 ) ;
}
#endif
if ( ( ( V_261 >> 8 ) & 0xff ) != 'P' )
return - V_7 ;
...
return F_131 ( V_174 ) ;
case V_329 :
if ( F_184 ( V_221 , V_320 ) )
return - V_208 ;
if ( ( V_221 = F_132 ( V_174 , V_221 ) ) < 0 )
return V_221 ;
return F_182 ( V_221 , V_320 ) ;
case V_330 :
V_221 = F_133 ( V_174 ) ;
if ( V_221 < 0 )
return V_221 ;
...
static T_7 F_185 ( struct V_247 * V_247 , char V_193 * V_202 , T_6 V_357 , T_12 * V_358 )
{
struct V_173 * V_174 ;
struct V_20 * V_49 ;
V_174 = V_247 -> V_301 ;
...
static T_7 F_186 ( struct V_247 * V_247 , const char V_193 * V_202 , T_6 V_357 , T_12 * V_358 )
{
struct V_173 * V_174 ;
struct V_20 * V_49 ;
long V_220 ;
...
static int F_187 ( struct V_20 * V_49 )
{
struct V_50 * V_51 = V_49 -> V_51 ;
if ( F_69 ( & V_49 -> V_112 ) )
...
static unsigned int F_191 ( struct V_247 * V_247 , T_13 * V_222 )
{
struct V_173 * V_174 ;
unsigned int V_138 ;
struct V_20 * V_259 = NULL , * V_260 = NULL ;
...
static int F_193 ( struct V_247 * V_247 , struct V_365 * V_366 )
{
struct V_173 * V_174 ;
...
static void F_195 ( struct V_375 * V_376 ,
struct V_377 * V_168 )
{
...
static void F_197 ( struct V_378 * V_250 )
{
...
static void F_198 ( struct V_375 * V_376 ,
struct V_377 * V_168 )
{
struct V_378 * V_250 = V_376 -> V_301 ;
...
while ( ! F_199 ( V_168 , line , sizeof( line ) ) ) {
F_114 ( & V_250 -> V_55 . V_283 ) ;
memset ( & V_383 , 0 , sizeof( V_383 ) ) ;
V_186 = F_200 ( V_280 , line , sizeof( V_280 ) ) ;
...
V_186 = F_200 ( V_380 , V_186 , sizeof( V_380 ) ) ;
V_383 . V_121 = F_201 ( V_380 , NULL , 10 ) ;
V_186 = F_200 ( V_380 , V_186 , sizeof( V_380 ) ) ;
V_383 . V_115 = F_201 ( V_380 , NULL , 10 ) ;
...
static void F_203 ( struct V_279 * V_21 )
{
int V_151 ;
...
if ( V_250 -> V_251 == 0 )
continue;
if ( ( V_376 = F_204 ( V_21 -> V_310 , L_50 , V_250 -> V_384 ) ) != NULL ) {
V_376 -> V_385 = V_386 ;
V_376 -> V_387 = V_388 | V_389 | V_390 ;
V_376 -> V_28 . V_391 . V_392 = F_195 ;
V_376 -> V_28 . V_391 . V_393 = F_198 ;
V_376 -> V_301 = V_250 ;
if ( F_205 ( V_376 ) < 0 ) {
F_206 ( V_376 ) ;
V_376 = NULL ;
...
static void F_207 ( struct V_279 * V_21 )
{
int V_151 ;
for ( V_151 = 0 ; V_151 < 2 ; ++ V_151 ) {
struct V_378 * V_250 = & V_21 -> V_178 [ V_151 ] ;
F_206 ( V_250 -> V_55 . V_394 ) ;
V_250 -> V_55 . V_394 = NULL ;
F_197 ( V_250 ) ;
}
}
static void F_208 ( struct V_279 * V_21 , int V_395 )
{
char V_304 [ 128 ] ;
...
static int F_210 ( struct V_279 * V_21 )
{
V_21 -> V_55 . V_399 = 0 ;
...
static int F_213 ( struct V_279 * V_21 )
{
if ( V_21 -> V_55 . V_399 ) {
...
static int F_216 ( struct V_279 * V_21 )
{
F_213 ( V_21 ) ;
F_207 ( V_21 ) ;
return 0 ;
}
static int T_14 F_217 ( void )
{
int V_3 ;
int V_22 ;
