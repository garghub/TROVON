...
static int T_4 F_15 ( struct V_98 * V_18 ,
struct V_6 * V_7 )
{
...
if ( V_7 -> V_8 == V_108 ) {
V_102 = F_20 ( ( V_35 -> V_114 & 0xff00 ) >> 8 ,
( V_35 -> V_114 & 0xff ) ) ;
if ( V_102 ) {
V_94 = F_21 ( & V_100 -> V_115 ,
...
static int T_4 F_23 ( struct V_98 * V_18 )
{
...
struct V_13 * V_101 ;
F_25 (boot_kobj, tmp_kobj,
&boot_kset->kobj_list, list) {
V_101 = V_100 -> V_12 ;
if ( V_101 -> V_7 -> V_8 == V_108 )
F_26 ( & V_100 -> V_115 , L_20 ) ;
} ;
}
...
if ( V_127 )
return;
for ( V_62 = 0 ; V_62 < F_31 ( V_128 ) && ! V_91 ; V_62 ++ ) {
F_32 ( V_128 [ V_62 ] . V_129 , 0 , & V_126 ) ;
V_91 = (struct V_98 * ) V_126 ;
}
}
static void T_4 F_30 ( void )
{
