...
static int F_32 ( struct V_22 * V_5 , T_2 V_63 )
{
struct V_2 * V_3 = V_5 -> V_23 ;
...
static int T_1 F_39 ( int V_1 , struct V_66 * V_9 )
{
struct V_2 * V_3 ;
struct V_22 * V_5 ;
int V_10 ;
...
static int T_1 F_44 ( struct V_66 * V_9 , unsigned int V_1 )
{
return V_67 [ V_1 ] && ! F_18 ( V_1 ) ;
}
static int T_1 F_45 ( struct V_66 * V_9 , unsigned int V_1 )
{
int V_10 ;
...
static int T_3 F_49 ( struct V_66 * V_9 , unsigned int V_1 )
{
F_42 ( F_50 ( V_9 ) ) ;
F_43 ( V_9 , NULL ) ;
return 0 ;
...
static int T_1 F_53 ( struct V_4 * V_77 ,
...
static void T_3 F_55 ( struct V_4 * V_77 )
{
F_42 ( F_56 ( V_77 ) ) ;
F_54 ( V_77 , NULL ) ;
}
static int F_57 ( struct V_4 * V_77 , T_2 V_63 )
{
