...
V_5 = F_2 ( V_3 ) ;
V_6 = V_5 -> V_6 ;
strncpy ( V_45 -> V_553 , L_92 , sizeof( V_45 -> V_553 ) - 1 ) ;
snprintf ( V_45 -> V_554 , sizeof( V_45 -> V_554 ) - 1 ,
L_93 , ( V_6 -> V_212 >> 16 ) & 0xff ,
( V_6 -> V_212 >> 8 ) & 0xff ,
V_6 -> V_212 & 0xff ) ;
}
int F_139 ( struct V_2 * V_3 , struct V_555 * V_556 , int V_248 )
{
...
case V_563 :
if ( ! F_140 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_141 ( V_6 , V_257 -> V_150 . V_135 . V_136 , 1 ) ;
break;
case V_564 :
if ( ! F_140 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_142 ( V_6 , V_257 -> V_150 . V_135 . V_136 , 1 , 0 ) ;
break;
case V_565 :
if ( ! F_140 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_109 ( V_3 ,
...
case V_567 :
if ( ! F_140 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_144 ( & V_6 -> V_104 -> V_465 ,
...
case V_569 :
if ( ! F_140 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_146 ( V_6 -> V_104 , V_6 -> V_3 ,
V_257 -> V_150 . V_135 . V_136 ) ;
break;
#endif
#ifdef F_147
