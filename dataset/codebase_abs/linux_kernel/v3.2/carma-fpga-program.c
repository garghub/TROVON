...
{
struct V_126 * V_127 = V_121 -> V_33 . V_127 ;
struct V_78 * V_122 ;
struct V_1 * V_2 ;
T_11 V_128 ;
T_2 V_129 ;
...
F_90 ( V_138 , V_128 ) ;
F_90 ( V_139 , V_128 ) ;
V_2 -> V_55 = F_91 ( V_128 , F_74 , NULL ) ;
if ( ! V_2 -> V_55 ) {
F_19 ( & V_121 -> V_33 , L_36 ) ;
V_49 = - V_140 ;
goto V_141;
}
V_2 -> V_13 = F_92 ( V_127 , 0 ) ;
if ( ! V_2 -> V_13 ) {
...
V_129 = F_21 ( V_2 -> V_13 + V_145 ) ;
if ( V_129 != 0x02 && V_129 != 0x03 ) {
F_19 ( & V_121 -> V_33 , L_40 ) ;
V_49 = - V_140 ;
goto V_144;
}
V_129 = F_10 ( V_2 -> V_13 + V_146 ) ;
V_2 -> V_92 = ( V_129 & ( 1 << 18 ) ) ? V_147 : V_148 ;
V_2 -> V_88 = F_95 ( V_127 , 0 ) ;
if ( V_2 -> V_88 == V_149 ) {
F_19 ( & V_121 -> V_33 , L_41 ) ;
V_49 = - V_140 ;
goto V_144;
}
V_49 = F_96 ( V_2 -> V_88 , F_49 , V_150 , V_133 , V_2 ) ;
if ( V_49 ) {
...
F_99 ( V_2 -> V_33 , L_45 ,
( V_129 & ( 1 << 17 ) ) ? L_46 : L_47 ,
( V_129 & ( 1 << 16 ) ) ? L_48 : L_49 ,
( V_129 & ( 1 << 18 ) ) ? L_50 : L_51 ) ;
return 0 ;
V_153:
F_77 ( & V_2 -> V_98 ) ;
V_152:
