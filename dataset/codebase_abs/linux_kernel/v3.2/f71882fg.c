...
int V_81 , V_99 ;
T_2 V_115 , V_2 ;
V_12 = F_93 ( sizeof( struct V_11 ) , V_116 ) ;
if ( ! V_12 )
return - V_117 ;
...
V_12 -> V_137 = F_97 ( & V_96 -> V_19 ) ;
if ( F_98 ( V_12 -> V_137 ) ) {
V_81 = F_99 ( V_12 -> V_137 ) ;
V_12 -> V_137 = NULL ;
goto V_124;
}
return 0 ;
...
static int T_6 F_103 ( int V_138 , unsigned short * V_139 ,
struct V_112 * V_113 )
{
T_1 V_140 ;
int V_81 = F_5 ( V_138 ) ;
...
static int T_6 F_107 ( unsigned short V_139 ,
...
if ( V_81 )
goto V_171;
V_81 = F_110 ( V_169 , & V_166 , 1 ) ;
if ( V_81 ) {
F_7 ( L_21 ) ;
goto V_171;
}
V_81 = F_111 ( V_169 , V_113 ,
sizeof( struct V_112 ) ) ;
if ( V_81 ) {
F_7 ( L_22 ) ;
goto V_171;
...
if ( F_103 ( 0x2e , & V_139 , & V_113 ) &&
F_103 ( 0x4e , & V_139 , & V_113 ) )
goto exit;
V_81 = F_115 ( & V_172 ) ;
if ( V_81 )
goto exit;
V_81 = F_107 ( V_139 , & V_113 ) ;
if ( V_81 )
goto V_173;
return 0 ;
V_173:
