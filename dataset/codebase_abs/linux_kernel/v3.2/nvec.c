...
V_2 -> V_33 = V_94 -> V_33 ;
V_2 -> V_74 = V_94 -> V_74 ;
V_97 = F_64 ( V_90 , V_100 , 0 ) ;
if ( ! V_97 ) {
F_9 ( & V_90 -> V_23 , L_40 ) ;
return - V_101 ;
}
V_98 = F_65 ( V_97 -> V_102 , F_66 ( V_97 ) , V_90 -> V_103 ) ;
if ( ! V_98 ) {
F_9 ( & V_90 -> V_23 , L_41 ) ;
return - V_104 ;
}
V_68 = F_67 ( V_98 -> V_102 , F_66 ( V_98 ) ) ;
if ( ! V_68 ) {
F_9 ( & V_90 -> V_23 , L_42 ) ;
return - V_35 ;
}
V_97 = F_64 ( V_90 , V_105 , 0 ) ;
if ( ! V_97 ) {
F_9 ( & V_90 -> V_23 , L_43 ) ;
V_91 = - V_101 ;
goto V_106;
...
F_76 ( & V_2 -> V_50 , F_37 ) ;
F_76 ( & V_2 -> V_40 , F_29 ) ;
V_2 -> V_39 = F_77 ( L_48 , V_107 , 2 ) ;
V_47 = F_78 ( V_2 -> V_60 , F_45 , 0 , L_48 , V_2 ) ;
if ( V_47 ) {
F_9 ( V_2 -> V_23 , L_49 ) ;
goto V_108;
}
...
static int T_6 F_84 ( struct V_89 * V_90 )
{
struct V_1 * V_2 = F_85 ( V_90 ) ;
F_18 ( V_2 , V_88 , 3 ) ;
F_86 ( V_2 -> V_23 ) ;
F_87 ( V_2 -> V_60 , & F_45 ) ;
F_82 ( V_2 -> V_68 ) ;
...
static int F_90 ( struct V_89 * V_90 , T_7 V_54 )
{
struct V_1 * V_2 = F_85 ( V_90 ) ;
struct V_15 * V_9 ;
F_15 ( V_2 -> V_23 , L_55 ) ;
...
static int F_91 ( struct V_89 * V_90 )
{
struct V_1 * V_2 = F_85 ( V_90 ) ;
F_15 ( V_2 -> V_23 , L_57 ) ;
F_51 ( V_2 ) ;
