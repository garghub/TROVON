...
V_2 -> V_90 . V_89 = F_50 ( V_6 ,
V_2 -> V_21 -> V_23 . V_72 -> V_121 ) ;
if ( V_2 -> V_90 . V_89 )
V_2 -> V_90 . V_122 = F_50 ( L_10 ,
V_2 -> V_90 . V_89 ) ;
F_54 ( V_2 ) ;
}
...
return;
sprintf ( V_6 , L_9 , V_2 -> T_8 ) ;
if ( ! F_60 ( V_89 -> V_123 , V_89 , V_89 -> V_123 , V_6 ) )
F_61 ( V_124 L_11
L_12 , V_6 ) ;
}
