...
if ( F_19 ( & V_9 -> V_32 ) )
goto V_27;
V_2 -> V_33 = V_2 -> V_34 + sizeof( * V_9 ) ;
F_14 ( V_2 ) -> V_35 = F_20 ( struct V_8 , V_36 ) ;
V_10 = F_21 ( V_9 -> V_37 ) ;
if ( V_10 || V_9 -> V_36 != V_38 ) {
if ( V_10 + sizeof( struct V_8 ) > V_2 -> V_18 ) {
F_13 ( V_13 ,
V_12 , V_39 ) ;
goto V_23;
}
if ( F_22 ( V_2 , V_10 + sizeof( struct V_8 ) ) ) {
F_13 ( V_13 , V_12 , V_40 ) ;
goto V_23;
}
V_9 = F_17 ( V_2 ) ;
...
F_24 () ;
F_25 ( V_2 ) ;
return F_26 ( V_41 , V_42 , V_2 , V_4 , NULL ,
F_1 ) ;
V_27:
F_13 ( V_13 , V_12 , V_40 ) ;
V_23:
...
{
return F_26 ( V_41 , V_60 , V_2 , V_2 -> V_4 , NULL ,
F_27 ) ;
}
...
if ( V_36 != V_76 )
goto V_75;
if ( ! F_16 ( V_2 , ( F_30 ( V_2 ) +
V_74 + 1 - V_2 -> V_77 ) ) )
goto V_75;
V_73 = (struct V_72 * ) ( F_30 ( V_2 ) + V_74 ) ;
switch ( V_73 -> V_78 ) {
case V_79 :
case V_80 :
case V_81 :
