...
V_66 &= ~ ( V_68 | V_69 ) ;
V_66 |= V_70 ;
V_67 = F_48 ( V_66 , F_49 ( V_64 ) ) ;
if ( ! V_67 ) {
F_6 ( L_28 , V_11 , __LINE__ ) ;
goto V_71;
}
V_5 = F_50 ( V_2 -> V_72 , V_67 , V_64 , V_65 ,
V_73 | V_74 |
V_75 | V_76 ) ;
if ( V_5 ) {
F_6 ( L_29 ,
...
static void F_52 ( struct V_42 * V_43 , T_4 V_64 , void * V_78 ,
T_5 V_65 )
{
struct V_1 * V_2 = F_31 ( V_43 ) ;
F_53 ( V_2 -> V_72 , V_65 , V_64 ) ;
F_51 ( ( unsigned long ) V_78 , F_49 ( V_64 ) ) ;
}
static T_5 F_54 ( struct V_42 * V_43 , struct V_79 * V_79 ,
unsigned long V_80 , T_4 V_64 , enum V_81 V_82 ,
struct V_83 * V_84 )
{
struct V_1 * V_2 = F_31 ( V_43 ) ;
int V_5 ;
T_5 V_30 ;
void * V_85 = F_55 ( V_79 ) + V_80 ;
V_5 = F_50 ( V_2 -> V_72 , ( unsigned long ) V_85 , V_64 ,
& V_30 ,
V_74 | V_73 |
V_75 | V_76 ) ;
if ( V_5 ) {
...
static T_5 F_56 ( struct V_42 * V_43 , struct V_79 * V_79 ,
unsigned long V_80 , T_4 V_64 ,
enum V_81 V_82 ,
struct V_83 * V_84 )
{
struct V_1 * V_2 = F_31 ( V_43 ) ;
...
T_4 V_64 , enum V_81 V_82 , struct V_83 * V_84 )
{
struct V_1 * V_2 = F_31 ( V_43 ) ;
int V_5 ;
V_5 = F_53 ( V_2 -> V_72 , V_91 , V_64 ) ;
if ( V_5 ) {
F_6 ( L_31 ,
V_11 , __LINE__ , V_5 ) ;
}
...
int V_94 , enum V_81 V_82 , struct V_83 * V_84 )
{
#if F_59 ( V_95 )
F_3 ( L_32 ) ;
return - V_12 ;
...
int V_97 ;
F_60 (sgl, sg, nents, i) {
int V_5 = F_50 ( V_2 -> V_72 , F_61 ( V_96 ) ,
