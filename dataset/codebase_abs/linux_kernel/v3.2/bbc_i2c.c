...
if ( ! V_2 )
return NULL ;
V_2 -> V_29 = F_26 ( & V_4 -> V_50 [ 0 ] , 0 , 0x2 , L_2 ) ;
if ( ! V_2 -> V_29 )
goto V_51;
V_2 -> V_32 = F_26 ( & V_4 -> V_50 [ 1 ] , 0 , 0x1 , L_3 ) ;
if ( ! V_2 -> V_32 )
goto V_51;
V_2 -> V_27 = 0 ;
F_27 ( & V_2 -> V_28 ) ;
if ( F_28 ( V_4 -> V_52 . V_53 [ 0 ] , F_22 ,
V_54 , L_4 , V_2 ) )
goto V_51;
V_2 -> V_11 = V_11 ;
V_2 -> V_4 = V_4 ;
F_29 ( & V_2 -> V_55 ) ;
V_49 = 0 ;
for ( V_48 = V_4 -> V_18 . V_19 -> V_56 ;
V_48 && V_49 < 8 ;
V_48 = V_48 -> V_57 , V_49 ++ ) {
struct V_3 * V_58 ;
V_58 = F_30 ( V_48 ) ;
V_2 -> V_8 [ V_49 ] . V_9 = V_58 ;
V_2 -> V_8 [ V_49 ] . V_10 = 0 ;
}
F_18 ( V_30 , V_2 -> V_29 + 0x0 ) ;
...
V_51:
if ( V_2 -> V_32 )
F_32 ( & V_4 -> V_50 [ 1 ] , V_2 -> V_32 , 1 ) ;
if ( V_2 -> V_29 )
F_32 ( & V_4 -> V_50 [ 0 ] , V_2 -> V_29 , 2 ) ;
F_6 ( V_2 ) ;
return NULL ;
}
...
V_60 = F_34 ( V_2 ) ;
if ( V_60 ) {
F_35 ( V_4 -> V_52 . V_53 [ 0 ] , V_2 ) ;
if ( V_2 -> V_32 )
F_32 ( & V_4 -> V_50 [ 0 ] , V_2 -> V_32 , 1 ) ;
if ( V_2 -> V_29 )
F_32 ( & V_4 -> V_50 [ 1 ] , V_2 -> V_29 , 2 ) ;
F_6 ( V_2 ) ;
} else {
F_36 ( & V_4 -> V_18 , V_2 ) ;
}
