...
static int T_3 F_9 ( struct V_10 * V_11 )
{
int error ;
...
static int T_3 F_10 ( struct V_10 * V_11 , T_1 V_23 )
{
return F_5 ( V_11 -> V_2 , V_23 , V_24 ,
V_25 , V_26 ) ;
}
static int T_3 F_11 ( struct V_10 * V_11 , T_1 V_27 )
{
return F_5 ( V_11 -> V_2 , V_27 , V_28 ,
V_29 , V_30 ) ;
}
static int T_3 F_12 ( struct V_10 * V_11 ,
...
static T_5 F_19 ( int V_6 , void * V_70 )
{
F_15 ( V_70 ) ;
return V_71 ;
}
...
static int T_3 F_30 ( struct V_10 * V_11 ,
...
static void T_3 F_31 ( struct V_10 * V_11 ,
struct V_76 * V_92 )
{
V_92 -> V_93 = V_94 ;
V_92 -> V_95 = V_94 L_1 ;
...
static int T_3 F_34 ( struct V_10 * V_11 )
{
struct V_76 * V_92 ;
int error ;
V_92 = F_35 () ;
...
static int T_3 F_39 ( struct V_10 * V_11 )
{
struct V_72 * V_77 ;
int error ;
V_77 = F_40 () ;
...
static int T_3 F_43 ( struct V_1 * V_2 ,
const struct V_115 * V_96 )
{
const struct V_116 * V_117 = V_2 -> V_70 . V_118 ;
const struct V_78 * V_79 ;
struct V_10 * V_11 ;
int V_119 ;
int error ;
if ( ! F_44 ( V_2 -> V_120 , V_121 ) ) {
F_45 ( & V_2 -> V_70 , L_2 ) ;
return - V_122 ;
}
V_119 = F_6 ( V_2 , V_123 ) ;
if ( V_119 != V_124 ) {
F_45 ( & V_2 -> V_70 , L_3 , V_119 ) ;
return - V_125 ;
}
V_11 = F_46 ( sizeof( struct V_10 ) , V_126 ) ;
if ( ! V_11 )
return - V_104 ;
V_11 -> V_2 = V_2 ;
if ( V_117 ) {
...
static int T_6 F_52 ( struct V_1 * V_2 )
{
...
static int F_57 ( struct V_132 * V_70 )
{
