...
static int F_32 ( struct V_1 * V_1 , struct V_1 * V_32 )
{
T_2 V_24 = F_7 ( V_66 ) ;
if ( V_32 == & V_6 ) {
V_24 &= ~ V_67 ;
...
static void F_33 ( T_2 div , T_2 * V_71 , T_2 * V_72 )
{
...
static unsigned long F_36 ( struct V_1 * V_1 )
{
T_2 V_24 = F_7 ( V_77 ) ;
V_24 &= ( V_1 == & V_78 ) ? V_79 :
V_80 ;
...
static int F_37 ( struct V_1 * V_1 , unsigned long V_33 )
{
unsigned long V_39 = F_13 ( V_1 -> V_32 ) ;
T_2 V_24 = F_7 ( V_77 ) ;
...
static unsigned long F_38 ( struct V_1 * V_1 , unsigned long V_33 )
{
unsigned long V_39 = F_13 ( V_1 -> V_32 ) ;
if ( V_33 * 7 <= V_39 + V_39 / 20 )
return V_39 / 7 ;
...
static int F_42 ( struct V_1 * V_1 , unsigned long V_33 )
{
unsigned long V_39 = F_13 ( V_1 -> V_32 ) ;
struct V_81 * V_82 ;
...
static unsigned long F_43 ( struct V_1 * V_1 , unsigned long V_33 )
{
unsigned long V_39 = F_13 ( V_1 -> V_32 ) ;
T_2 div = V_39 / V_33 ;
...
static int F_44 ( struct V_1 * V_1 , struct V_1 * V_32 )
{
struct V_104 * V_105 ;
int V_83 , V_84 ;
T_2 V_24 ;
...
F_53 (np, NULL, L_1 ) {
T_2 V_33 ;
if ( F_54 ( V_126 , L_2 , & V_33 ) )
continue;
if ( F_55 ( V_126 , L_3 ) )
V_4 = V_33 ;
else if ( F_55 ( V_126 , L_4 ) )
V_3 = V_33 ;
else if ( F_55 ( V_126 , L_5 ) )
V_2 = V_33 ;
}
for ( V_83 = 0 ; V_83 < F_40 ( V_129 ) ; V_83 ++ )
F_56 ( & V_129 [ V_83 ] ) ;
...
F_58 ( & V_158 , 49500000 ) ;
F_58 ( & V_159 , 49500000 ) ;
V_126 = F_60 ( NULL , NULL , L_6 ) ;
V_127 = F_61 ( V_126 , 0 ) ;
F_62 ( ! V_127 ) ;
V_128 = F_63 ( V_126 , 0 ) ;
F_64 ( & V_160 , V_127 , V_128 ) ;
return 0 ;
}
