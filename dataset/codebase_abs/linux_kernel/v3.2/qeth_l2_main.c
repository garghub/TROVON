...
& V_7 -> V_126 . V_128 , & V_7 -> V_126 . V_129 , & V_50 ) ;
if ( ! V_71 ) {
* V_121 = 1 ;
break;
}
...
case V_82 :
V_71 -> V_130 = V_131 ;
V_71 -> V_132 = F_62 ( V_71 , V_71 -> V_2 ) ;
V_71 -> V_133 = V_134 ;
if ( V_71 -> V_132 == F_63 ( V_135 ) )
* ( ( V_136 * ) V_71 -> V_137 ) = ++ V_7 -> V_138 . V_139 ;
V_87 = V_71 -> V_87 ;
F_64 ( V_71 ) ;
break;
case V_140 :
...
sizeof( struct V_75 ) ) ;
V_87 = V_71 -> V_87 ;
V_7 -> V_141 . V_142 ( V_71 ) ;
break;
}
default:
F_67 ( V_71 ) ;
F_14 ( V_7 , 3 , L_23 ) ;
F_48 ( V_143 , 3 , V_50 , V_144 ) ;
continue;
}
V_122 ++ ;
V_120 -- ;
V_7 -> V_145 . V_146 ++ ;
V_7 -> V_145 . V_147 += V_87 ;
}
return V_122 ;
}
static int F_68 ( struct V_148 * V_149 , int V_120 )
{
struct V_6 * V_7 = F_69 ( V_149 , struct V_6 , V_149 ) ;
int V_122 = 0 ;
struct V_150 * V_151 ;
int V_121 ;
int V_152 = V_120 ;
...
V_151 = & V_7 -> V_123 . V_124 -> V_125 [ V_7 -> V_126 . V_127 ] ;
if ( ! ( V_7 -> V_126 . V_159 &&
F_72 ( V_7 , V_151 -> V_151 ,
...
F_131 ( V_7 -> V_2 , & V_7 -> V_149 , F_68 , V_239 ) ;
...
return - V_12 ;
F_14 ( V_7 , 2 , L_73 ) ;
if ( ( F_183 == NULL ) || ( V_142 == NULL ) )
return - V_30 ;
V_7 -> V_141 . F_183 = F_183 ;
V_7 -> V_141 . V_142 = V_142 ;
return 0 ;
}
...
return;
F_14 ( V_7 , 2 , L_74 ) ;
V_7 -> V_141 . F_183 = NULL ;
V_7 -> V_141 . V_142 = NULL ;
return;
}
