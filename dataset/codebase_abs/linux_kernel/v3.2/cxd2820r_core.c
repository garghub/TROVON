...
static int F_62 ( struct V_22 * V_23 , int V_69 )
{
struct V_1 * V_2 = V_23 -> V_24 ;
F_11 ( L_11 , V_29 , V_69 ) ;
return F_9 ( V_2 , 0xdb , V_69 ? 1 : 0 , 0x1 ) ;
}
struct V_22 * F_63 ( const struct V_70 * V_18 ,
struct V_71 * V_3 , struct V_22 * V_23 )
{
int V_7 ;
struct V_1 * V_2 = NULL ;
T_1 V_21 ;
...
goto error;
V_2 -> V_3 = V_3 ;
memcpy ( & V_2 -> V_18 , V_18 , sizeof( struct V_70 ) ) ;
F_65 ( & V_2 -> V_43 ) ;
V_2 -> V_42 = - 1 ;
...
if ( V_7 || V_21 != 0xe1 )
goto error;
memcpy ( & V_2 -> V_23 [ 0 ] . V_51 , & V_73 [ 0 ] ,
sizeof( struct V_74 ) ) ;
memcpy ( & V_2 -> V_23 [ 1 ] . V_51 , & V_73 [ 1 ] ,
sizeof( struct V_74 ) ) ;
V_2 -> V_23 [ 0 ] . V_24 = V_2 ;
V_2 -> V_23 [ 1 ] . V_24 = V_2 ;
return & V_2 -> V_23 [ 0 ] ;
