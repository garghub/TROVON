...
static int T_2
F_22 ( struct V_3 * V_4 , const char * V_64 )
{
struct V_65 * V_66 = V_4 -> V_66 ;
struct V_67 * V_68 = & V_4 -> V_67 ;
struct V_69 * V_70 ;
void * V_71 ;
V_70 = F_23 ( V_66 , V_72 , V_64 ) ;
if ( ! V_70 ) {
F_7 ( L_6 , V_64 ) ;
return - V_73 ;
}
V_71 = F_24 ( V_70 -> V_74 , F_25 ( V_70 ) ) ;
if ( ! V_71 ) {
F_7 ( L_7 , V_64 ) ;
return - V_75 ;
}
...
struct V_69 * V_70 ;
int V_58 ;
V_70 = F_23 ( V_66 , V_82 , V_64 ) ;
if ( ! V_70 ) {
F_7 ( L_6 , V_64 ) ;
return - V_73 ;
}
V_58 = F_29 ( V_70 -> V_74 , V_80 , 0 , V_64 , V_4 ) ;
if ( V_58 ) {
F_7 ( L_9 , V_64 ) ;
return V_58 ;
}
...
static bool F_32 ( struct V_27 * V_87 , void * V_44 )
{
struct V_3 * V_4 = V_44 ;
...
static int T_2 F_40 ( struct V_3 * V_4 )
{
struct V_67 * V_68 = & V_4 -> V_67 ;
int V_36 ;
V_36 = F_22 ( V_4 , V_76 ) ;
...
if ( V_36 )
goto V_107;
V_68 -> clock = F_41 ( & V_4 -> V_66 -> V_40 , NULL ) ;
if ( F_42 ( V_68 -> clock ) ) {
F_7 ( L_12 ) ;
V_36 = - V_108 ;
goto V_109;
...
static int T_2 F_45 ( struct V_3 * V_4 )
{
int V_36 ;
struct V_110 V_111 = {
. V_112 = 80 ,
...
{
if ( V_4 -> V_37 )
F_52 ( V_4 -> V_40 , V_131 , V_121 , V_52 ) ;
}
...
if ( F_48 ( V_132 ) ) {
T_5 V_133 ;
V_133 = F_49 ( V_40 , ( void * ) V_132 , V_121 ,
V_43 ) ;
if ( F_50 ( V_40 , V_133 ) ) {
if ( V_124 < V_121 ) {
F_7 ( L_13 ) ;
...
struct V_127 * V_40 = V_4 -> V_40 ;
if ( V_130 == V_132 )
F_52 ( V_40 , V_131 , V_121 , V_43 ) ;
}
static void F_56 ( struct V_3 * V_4 )
{
struct V_127 * V_40 = V_4 -> V_40 ;
if ( V_4 -> V_134 && F_48 ( V_4 -> V_134 ) )
F_57 ( V_40 , V_4 -> V_135 ,
V_4 -> V_134 ,
V_4 -> V_136 ) ;
F_58 ( V_4 -> V_137 ) ;
...
struct V_7 * V_8 = & V_4 -> V_7 ;
struct V_127 * V_40 = V_4 -> V_40 ;
V_4 -> V_137 = F_60 ( V_42 , V_138 ) ;
if ( V_4 -> V_137 == NULL )
goto V_139;
V_4 -> V_41 = F_60 ( V_42 , V_138 ) ;
if ( V_4 -> V_41 == NULL )
goto V_139;
V_4 -> V_135 = V_8 -> V_22 + V_8 -> V_23 ;
V_4 -> V_134 = F_61 ( V_40 , V_4 -> V_135 ,
& V_4 -> V_136 , V_138 ) ;
if ( ! V_4 -> V_134 )
goto V_139;
V_4 -> V_140 = V_4 -> V_134 ;
...
static void F_62 ( struct V_9 * V_10 , int V_144 , unsigned int V_145 )
{
...
struct V_146 * V_147 = V_10 -> V_148 ;
struct V_3 * V_4 = V_147 -> V_148 ;
return F_65 ( V_4 , V_4 -> V_29 ) ;
}
static void F_66 ( struct V_9 * V_10 , int V_28 )
{
struct V_146 * V_147 = V_10 -> V_148 ;
struct V_3 * V_4 = V_147 -> V_148 ;
...
static void F_69 ( struct V_9 * V_10 , T_6 * V_153 , int V_154 )
{
struct V_146 * V_147 = V_10 -> V_148 ;
struct V_3 * V_4 = V_147 -> V_148 ;
F_70 ( L_16 , V_154 ) ;
...
static void F_72 ( struct V_9 * V_10 , const T_6 * V_153 , int V_154 )
{
struct V_146 * V_147 = V_10 -> V_148 ;
struct V_3 * V_4 = V_147 -> V_148 ;
F_70 ( L_16 , V_154 ) ;
...
static T_6 F_74 ( struct V_9 * V_10 )
{
struct V_146 * V_147 = V_10 -> V_148 ;
struct V_3 * V_4 = V_147 -> V_148 ;
T_6 * V_153 = V_4 -> V_41 ;
...
static int F_76 ( struct V_9 * V_10 , struct V_146 * V_147 ,
T_6 * V_153 , int V_162 )
{
struct V_3 * V_4 = V_147 -> V_148 ;
struct V_7 * V_157 = & V_4 -> V_7 ;
...
V_142 = V_4 -> V_142 ;
V_143 = V_4 -> V_143 ;
V_36 = F_77 ( V_4 , V_141 , V_143 ) ;
F_51 ( V_4 , V_153 , V_10 -> V_19 ,
V_4 -> V_140 , V_4 -> V_141 ,
V_157 -> V_22 ,
V_140 , V_141 ) ;
if ( V_36 ) {
...
V_36 = F_79 ( V_4 , V_141 , V_143 ) ;
if ( V_36 )
F_7 ( L_23 , V_36 ) ;
if ( ! V_4 -> V_25 ) {
F_55 ( V_4 , V_147 -> V_171 , V_10 -> V_12 ,
V_4 -> V_142 , V_4 -> V_143 ,
V_157 -> V_23 ,
V_142 , V_143 ) ;
V_172:
F_55 ( V_4 , V_153 , V_10 -> V_19 ,
V_4 -> V_140 , V_4 -> V_141 ,
V_157 -> V_22 ,
V_140 , V_141 ) ;
}
}
static int F_80 ( struct V_9 * V_10 , struct V_146 * V_147 ,
int V_162 , int V_173 )
{
struct V_3 * V_4 = V_147 -> V_148 ;
F_70 ( L_24 , V_162 ) ;
...
static int
F_81 ( struct V_9 * V_10 , struct V_146 * V_147 , int V_162 )
{
return - V_178 ;
}
static int F_82 ( struct V_9 * V_10 , T_7 V_179 )
{
struct V_146 * V_147 = V_10 -> V_148 ;
struct V_3 * V_4 = V_147 -> V_148 ;
int V_180 , V_36 = 0 ;
...
static int T_2 F_84 ( struct V_3 * V_4 )
{
...
static int T_2 F_85 ( struct V_3 * V_4 )
{
...
static int T_2 F_87 ( struct V_3 * V_4 )
{
struct V_127 * V_40 = V_4 -> V_40 ;
struct V_197 * V_202 = & V_4 -> V_199 ;
struct V_9 * V_10 = & V_4 -> V_10 ;
...
V_213 ;
F_86 ( V_40 , L_29 ) ;
F_86 ( V_40 , L_30 , V_215 ) ;
F_86 ( V_40 , L_31 , V_204 ) ;
F_86 ( V_40 , L_32 , V_214 ) ;
V_210 = V_4 -> V_29 ;
V_147 -> V_188 ( V_10 , 0 ) ;
F_86 ( V_40 , L_33 ) ;
for ( V_180 = 0 ; V_180 < V_215 ; V_180 ++ ) {
V_162 = V_180 * V_213 ;
F_86 ( V_40 , L_34 , V_180 ) ;
V_147 -> V_174 ( V_10 , V_217 , - 1 , V_162 ) ;
V_147 -> V_174 ( V_10 , V_218 , - 1 , - 1 ) ;
V_163 = V_147 -> V_193 ( V_10 , V_147 ) ;
if ( V_163 & V_194 )
F_88 ( V_40 , L_35 , V_219 ) ;
}
...
V_162 = V_205 * V_202 -> V_200 ;
V_206 = V_162 * V_10 -> V_19 ;
F_86 ( V_40 , L_37 , V_162 ) ;
V_147 -> V_174 ( V_10 , V_190 , 0x00 , V_162 ) ;
V_147 -> V_220 . V_221 ( V_10 , V_147 , V_207 ) ;
V_147 -> V_174 ( V_10 , V_192 , - 1 , - 1 ) ;
V_163 = V_147 -> V_193 ( V_10 , V_147 ) ;
if ( V_163 & V_194 )
F_88 ( V_40 , L_38 , V_219 ) ;
}
V_147 -> V_188 ( V_10 , V_210 ) ;
return 0 ;
}
static int T_2 F_89 ( struct V_3 * V_4 )
{
struct V_127 * V_40 = V_4 -> V_40 ;
struct V_146 * V_147 = & V_4 -> V_203 ;
struct V_9 * V_10 = & V_4 -> V_10 ;
...
static int T_2 F_90 ( struct V_3 * V_4 )
{
F_84 ( V_4 ) ;
if ( F_91 ( V_4 ) )
return F_89 ( V_4 ) ;
...
static int T_2 F_92 ( struct V_3 * V_4 )
{
int V_36 ;
F_56 ( V_4 ) ;
V_36 = F_93 ( V_4 ) ;
...
static int T_2 F_99 ( struct V_3 * V_4 )
{
struct V_92 * V_93 = V_4 -> V_93 ;
struct V_9 * V_10 = & V_4 -> V_10 ;
struct V_146 * V_147 = & V_4 -> V_203 ;
...
V_147 -> V_176 = F_69 ;
V_147 -> V_191 = F_72 ;
V_147 -> V_220 . V_231 = F_76 ;
V_147 -> V_220 . V_232 = F_78 ;
V_147 -> V_220 . V_233 = F_80 ;
V_147 -> V_220 . V_234 = F_81 ;
V_147 -> V_235 = F_95 ;
V_147 -> V_236 = & V_237 ;
V_147 -> V_225 = F_82 ;
V_147 -> V_185 |= V_238 ;
V_147 -> V_220 . V_239 = V_240 ;
V_147 -> V_220 . V_241 = 1 ;
V_147 -> V_220 . V_242 = & V_243 ;
V_4 -> V_7 . V_22 = 1024 ;
V_4 -> V_7 . V_23 = 128 ;
V_36 = F_59 ( V_4 ) ;
if ( V_36 )
goto V_244;
V_36 = F_100 ( V_10 , V_93 -> V_99 ) ;
if ( V_36 ) {
F_7 ( L_45 ) ;
goto V_244;
}
V_36 = F_101 ( V_10 , NULL , NULL ,
V_93 -> V_245 , V_93 -> V_246 ) ;
if ( V_36 )
goto V_244;
return 0 ;
V_244:
...
static int T_2 F_102 ( struct V_65 * V_66 )
{
struct V_92 * V_93 = V_66 -> V_40 . V_247 ;
struct V_3 * V_4 ;
int V_36 ;
V_4 = F_60 ( sizeof( * V_4 ) , V_248 ) ;
if ( ! V_4 ) {
F_7 ( L_46 ) ;
return - V_75 ;
}
...
static int T_8 F_104 ( struct V_65 * V_66 )
{
struct V_3 * V_4 = F_105 ( V_66 ) ;
F_97 ( V_4 ) ;
F_43 ( V_4 ) ;
F_103 ( V_66 , NULL ) ;
F_58 ( V_4 ) ;
