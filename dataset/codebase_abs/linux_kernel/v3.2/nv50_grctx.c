...
F_3 ( V_2 , V_33 , V_34 ) ;
F_3 ( V_2 , V_35 , V_36 ) ;
F_4 ( V_2 , V_37 , V_29 , V_38 ) ;
F_4 ( V_2 , V_22 , TRUE , V_39 ) ;
F_5 ( V_2 , V_15 ) ;
F_3 ( V_2 , V_33 , V_29 ) ;
F_7 ( V_2 , V_40 , V_32 ) ;
F_7 ( V_2 , V_41 , V_14 ) ;
F_4 ( V_2 , V_40 , V_32 , V_15 ) ;
F_3 ( V_2 , V_28 , V_29 ) ;
F_3 ( V_2 , V_35 , V_42 ) ;
F_5 ( V_2 , V_39 ) ;
F_3 ( V_2 , V_43 , V_29 ) ;
...
if ( V_60 & ( 1 << ( V_56 + 16 ) ) ) {
F_9 ( V_2 , 0x407000 + ( V_56 << 8 ) , 3 ) ;
if ( V_4 -> V_7 == 0x50 )
F_15 ( V_2 , 0x407000 + ( V_56 << 8 ) , 0x1b74f820 ) ;
else if ( V_4 -> V_7 != 0xa5 )
F_15 ( V_2 , 0x407000 + ( V_56 << 8 ) , 0x3b74f821 ) ;
else
F_15 ( V_2 , 0x407000 + ( V_56 << 8 ) , 0x7b74f821 ) ;
F_15 ( V_2 , 0x407004 + ( V_56 << 8 ) , 0x89058001 ) ;
if ( V_4 -> V_7 == 0x50 ) {
F_9 ( V_2 , 0x407010 + ( V_56 << 8 ) , 1 ) ;
} else if ( V_4 -> V_7 < 0xa0 ) {
F_9 ( V_2 , 0x407010 + ( V_56 << 8 ) , 2 ) ;
F_15 ( V_2 , 0x407010 + ( V_56 << 8 ) , 0x00001000 ) ;
F_15 ( V_2 , 0x407014 + ( V_56 << 8 ) , 0x0000001f ) ;
} else {
F_9 ( V_2 , 0x407010 + ( V_56 << 8 ) , 3 ) ;
F_15 ( V_2 , 0x407010 + ( V_56 << 8 ) , 0x00001000 ) ;
if ( V_4 -> V_7 != 0xa5 )
F_15 ( V_2 , 0x407014 + ( V_56 << 8 ) , 0x000000ff ) ;
else
F_15 ( V_2 , 0x407014 + ( V_56 << 8 ) , 0x000001ff ) ;
}
F_9 ( V_2 , 0x407080 + ( V_56 << 8 ) , 4 ) ;
if ( V_4 -> V_7 != 0xa5 )
F_15 ( V_2 , 0x407080 + ( V_56 << 8 ) , 0x027c10fa ) ;
else
F_15 ( V_2 , 0x407080 + ( V_56 << 8 ) , 0x827c10fa ) ;
if ( V_4 -> V_7 == 0x50 )
F_15 ( V_2 , 0x407084 + ( V_56 << 8 ) , 0x000000c0 ) ;
else
F_15 ( V_2 , 0x407084 + ( V_56 << 8 ) , 0x400000c0 ) ;
F_15 ( V_2 , 0x407088 + ( V_56 << 8 ) , 0xb7892080 ) ;
if ( V_4 -> V_7 < 0xa0 )
F_9 ( V_2 , 0x407094 + ( V_56 << 8 ) , 1 ) ;
else if ( ! F_16 ( V_4 -> V_7 ) )
F_9 ( V_2 , 0x407094 + ( V_56 << 8 ) , 3 ) ;
else {
F_9 ( V_2 , 0x407094 + ( V_56 << 8 ) , 4 ) ;
F_15 ( V_2 , 0x4070a0 + ( V_56 << 8 ) , 1 ) ;
}
}
}
...
if ( V_60 & ( 1 << V_56 ) ) {
if ( V_4 -> V_7 < 0xa0 )
V_59 = 0x408000 + ( V_56 << 12 ) ;
else
V_59 = 0x408000 + ( V_56 << 11 ) ;
if ( V_4 -> V_7 < 0xa0 )
V_58 = V_59 + 0xc00 ;
else
V_58 = V_59 + 0x80 ;
F_9 ( V_2 , V_58 + 0x00 , 1 ) ;
F_15 ( V_2 , V_58 + 0x00 , 0x0000ff0a ) ;
F_9 ( V_2 , V_58 + 0x08 , 1 ) ;
for ( V_57 = 0 ; V_57 < ( V_4 -> V_7 < 0xa0 ? 2 : 4 ) ; V_57 ++ ) {
if ( ! ( V_60 & ( 1 << ( V_57 + 24 ) ) ) ) continue;
if ( V_4 -> V_7 < 0xa0 )
V_58 = V_59 + 0x200 + ( V_57 << 7 ) ;
else
V_58 = V_59 + 0x100 + ( V_57 << 7 ) ;
F_9 ( V_2 , V_58 , 0x20 ) ;
F_15 ( V_2 , V_58 + 0x00 , 0x01800000 ) ;
F_15 ( V_2 , V_58 + 0x04 , 0x00160000 ) ;
F_15 ( V_2 , V_58 + 0x08 , 0x01800000 ) ;
F_15 ( V_2 , V_58 + 0x18 , 0x0003ffff ) ;
switch ( V_4 -> V_7 ) {
case 0x50 :
F_15 ( V_2 , V_58 + 0x1c , 0x00080000 ) ;
break;
case 0x84 :
F_15 ( V_2 , V_58 + 0x1c , 0x00880000 ) ;
break;
case 0x86 :
F_15 ( V_2 , V_58 + 0x1c , 0x018c0000 ) ;
break;
case 0x92 :
case 0x96 :
case 0x98 :
F_15 ( V_2 , V_58 + 0x1c , 0x118c0000 ) ;
break;
case 0x94 :
F_15 ( V_2 , V_58 + 0x1c , 0x10880000 ) ;
break;
case 0xa0 :
case 0xa5 :
F_15 ( V_2 , V_58 + 0x1c , 0x310c0000 ) ;
break;
case 0xa3 :
case 0xa8 :
case 0xaa :
case 0xac :
case 0xaf :
F_15 ( V_2 , V_58 + 0x1c , 0x300c0000 ) ;
break;
}
F_15 ( V_2 , V_58 + 0x40 , 0x00010401 ) ;
if ( V_4 -> V_7 == 0x50 )
F_15 ( V_2 , V_58 + 0x48 , 0x00000040 ) ;
else
F_15 ( V_2 , V_58 + 0x48 , 0x00000078 ) ;
F_15 ( V_2 , V_58 + 0x50 , 0x000000bf ) ;
F_15 ( V_2 , V_58 + 0x58 , 0x00001210 ) ;
if ( V_4 -> V_7 == 0x50 )
F_15 ( V_2 , V_58 + 0x5c , 0x00000080 ) ;
else
F_15 ( V_2 , V_58 + 0x5c , 0x08000080 ) ;
if ( V_4 -> V_7 >= 0xa0 )
F_15 ( V_2 , V_58 + 0x68 , 0x0000003e ) ;
}
if ( V_4 -> V_7 < 0xa0 )
F_9 ( V_2 , V_59 + 0x300 , 0x4 ) ;
else
F_9 ( V_2 , V_59 + 0x300 , 0x5 ) ;
if ( V_4 -> V_7 == 0x50 )
F_15 ( V_2 , V_59 + 0x304 , 0x00007070 ) ;
else if ( V_4 -> V_7 < 0xa0 )
F_15 ( V_2 , V_59 + 0x304 , 0x00027070 ) ;
else if ( ! F_16 ( V_4 -> V_7 ) )
F_15 ( V_2 , V_59 + 0x304 , 0x01127070 ) ;
else
F_15 ( V_2 , V_59 + 0x304 , 0x05127070 ) ;
if ( V_4 -> V_7 < 0xa0 )
F_9 ( V_2 , V_59 + 0x318 , 1 ) ;
else
F_9 ( V_2 , V_59 + 0x320 , 1 ) ;
if ( V_4 -> V_7 == 0x50 )
F_15 ( V_2 , V_59 + 0x318 , 0x0003ffff ) ;
else if ( V_4 -> V_7 < 0xa0 )
F_15 ( V_2 , V_59 + 0x318 , 0x03ffffff ) ;
else
F_15 ( V_2 , V_59 + 0x320 , 0x07ffffff ) ;
if ( V_4 -> V_7 < 0xa0 )
F_9 ( V_2 , V_59 + 0x324 , 5 ) ;
else
F_9 ( V_2 , V_59 + 0x328 , 4 ) ;
if ( V_4 -> V_7 < 0xa0 ) {
F_9 ( V_2 , V_59 + 0x340 , 9 ) ;
V_58 = V_59 + 0x340 ;
} else if ( ! F_16 ( V_4 -> V_7 ) ) {
F_9 ( V_2 , V_59 + 0x33c , 0xb ) ;
V_58 = V_59 + 0x344 ;
} else {
F_9 ( V_2 , V_59 + 0x33c , 0xd ) ;
V_58 = V_59 + 0x344 ;
}
F_15 ( V_2 , V_58 + 0x0 , 0x00120407 ) ;
F_15 ( V_2 , V_58 + 0x4 , 0x05091507 ) ;
if ( V_4 -> V_7 == 0x84 )
F_15 ( V_2 , V_58 + 0x8 , 0x05100202 ) ;
else
F_15 ( V_2 , V_58 + 0x8 , 0x05010202 ) ;
F_15 ( V_2 , V_58 + 0xc , 0x00030201 ) ;
if ( V_4 -> V_7 == 0xa3 )
F_9 ( V_2 , V_59 + 0x36c , 1 ) ;
F_9 ( V_2 , V_59 + 0x400 , 2 ) ;
F_15 ( V_2 , V_59 + 0x404 , 0x00000040 ) ;
F_9 ( V_2 , V_59 + 0x40c , 2 ) ;
F_15 ( V_2 , V_59 + 0x40c , 0x0d0c0b0a ) ;
F_15 ( V_2 , V_59 + 0x410 , 0x00141210 ) ;
if ( V_4 -> V_7 < 0xa0 )
V_58 = V_59 + 0x800 ;
else
V_58 = V_59 + 0x500 ;
F_9 ( V_2 , V_58 , 6 ) ;
F_15 ( V_2 , V_58 + 0x0 , 0x000001f0 ) ;
F_15 ( V_2 , V_58 + 0x4 , 0x00000001 ) ;
F_15 ( V_2 , V_58 + 0x8 , 0x00000003 ) ;
if ( V_4 -> V_7 == 0x50 || F_18 ( V_4 -> V_7 ) )
F_15 ( V_2 , V_58 + 0xc , 0x00008000 ) ;
F_15 ( V_2 , V_58 + 0x14 , 0x00039e00 ) ;
F_9 ( V_2 , V_58 + 0x1c , 2 ) ;
if ( V_4 -> V_7 == 0x50 )
F_15 ( V_2 , V_58 + 0x1c , 0x00000040 ) ;
else
F_15 ( V_2 , V_58 + 0x1c , 0x00000100 ) ;
F_15 ( V_2 , V_58 + 0x20 , 0x00003800 ) ;
if ( V_4 -> V_7 >= 0xa0 ) {
F_9 ( V_2 , V_59 + 0x54c , 2 ) ;
if ( ! F_16 ( V_4 -> V_7 ) )
F_15 ( V_2 , V_59 + 0x54c , 0x003fe006 ) ;
else
F_15 ( V_2 , V_59 + 0x54c , 0x003fe007 ) ;
F_15 ( V_2 , V_59 + 0x550 , 0x003fe000 ) ;
}
if ( V_4 -> V_7 < 0xa0 )
V_58 = V_59 + 0xa00 ;
else
...
F_9 ( V_2 , V_58 , 2 ) ;
if ( V_4 -> V_7 < 0xa0 )
F_15 ( V_2 , V_58 , 0x0077f005 ) ;
else if ( V_4 -> V_7 == 0xa5 )
F_15 ( V_2 , V_58 , 0x6cf7f007 ) ;
else if ( V_4 -> V_7 == 0xa8 )
F_15 ( V_2 , V_58 , 0x6cfff007 ) ;
else if ( V_4 -> V_7 == 0xac )
F_15 ( V_2 , V_58 , 0x0cfff007 ) ;
else
F_15 ( V_2 , V_58 , 0x0cf7f007 ) ;
if ( V_4 -> V_7 == 0x50 )
F_15 ( V_2 , V_58 + 0x4 , 0x00007fff ) ;
else if ( V_4 -> V_7 < 0xa0 )
F_15 ( V_2 , V_58 + 0x4 , 0x003f7fff ) ;
else
F_15 ( V_2 , V_58 + 0x4 , 0x02bf7fff ) ;
F_9 ( V_2 , V_58 + 0x2c , 1 ) ;
if ( V_4 -> V_7 == 0x50 ) {
F_9 ( V_2 , V_58 + 0x50 , 9 ) ;
F_15 ( V_2 , V_58 + 0x54 , 0x000003ff ) ;
F_15 ( V_2 , V_58 + 0x58 , 0x00000003 ) ;
F_15 ( V_2 , V_58 + 0x5c , 0x00000003 ) ;
F_15 ( V_2 , V_58 + 0x60 , 0x000001ff ) ;
F_15 ( V_2 , V_58 + 0x64 , 0x0000001f ) ;
F_15 ( V_2 , V_58 + 0x68 , 0x0000000f ) ;
F_15 ( V_2 , V_58 + 0x6c , 0x0000000f ) ;
} else if ( V_4 -> V_7 < 0xa0 ) {
F_9 ( V_2 , V_58 + 0x50 , 1 ) ;
F_9 ( V_2 , V_58 + 0x70 , 1 ) ;
} else {
...
static void
F_19 ( struct V_1 * V_2 , int V_61 , T_1 V_62 ) {
int V_56 ;
if ( V_62 && V_2 -> V_63 == V_64 )
for ( V_56 = 0 ; V_56 < V_61 ; V_56 ++ )
F_20 ( V_2 -> V_65 , 4 * ( V_2 -> V_55 + V_56 ) , V_62 ) ;
V_2 -> V_55 += V_61 ;
}
static void
F_17 ( struct V_1 * V_2 )
...
V_2 -> V_55 = V_59 ;
if ( F_16 ( V_4 -> V_7 ) )
F_9 ( V_2 , 0x404800 , V_61 ) ;
else
F_9 ( V_2 , 0x405400 , V_61 ) ;
}
static void
F_21 ( struct V_1 * V_2 , int V_61 , T_1 V_62 ) {
int V_56 ;
if ( V_62 && V_2 -> V_63 == V_64 )
for ( V_56 = 0 ; V_56 < V_61 ; V_56 ++ )
F_20 ( V_2 -> V_65 , 4 * ( V_2 -> V_55 + ( V_56 << 3 ) ) , V_62 ) ;
V_2 -> V_55 += V_61 << 3 ;
}
static void
F_11 ( struct V_1 * V_2 )
...
F_25 ( V_2 ) ;
F_26 ( V_2 ) ;
if ( ( V_2 -> V_55 - V_58 ) / 8 > V_66 )
V_66 = ( V_2 -> V_55 - V_58 ) / 8 ;
V_2 -> V_55 = V_58 + 0x1 ;
F_27 ( V_2 ) ;
F_28 ( V_2 ) ;
F_29 ( V_2 ) ;
