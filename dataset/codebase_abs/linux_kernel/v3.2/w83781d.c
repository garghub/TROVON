...
static int
F_71 ( struct V_15 * V_16 , T_6 V_31 , T_6 V_134 )
{
struct V_49 * V_104 = V_16 -> V_104 ;
int V_132 ;
struct V_49 * V_133 ;
...
int V_4 ;
F_9 ( & V_16 -> V_19 ) ;
if ( F_75 ( V_140 , V_16 -> V_141 + V_142 + V_142 / 2 )
|| ! V_16 -> V_143 ) {
F_53 ( V_8 , L_29 ) ;
for ( V_4 = 0 ; V_4 <= 8 ; V_4 ++ ) {
...
static T_2
F_83 ( struct V_7 * V_8 , struct V_9 * V_160 , char * V_11 )
{
struct V_15 * V_16 = F_7 ( V_8 ) ;
...
F_86 ( V_31 & 0xff , V_16 -> V_165 + V_166 ) ;
V_131 = F_87 ( V_16 -> V_165 + V_167 ) ;
if ( V_164 ) {
F_86 ( ( V_31 & 0xff ) + 1 ,
V_16 -> V_165 + V_166 ) ;
V_131 =
( V_131 << 8 ) + F_87 ( V_16 -> V_165 +
V_167 ) ;
}
if ( V_31 & 0xff00 ) {
F_86 ( V_117 ,
V_16 -> V_165 + V_166 ) ;
F_86 ( 0 , V_16 -> V_165 + V_167 ) ;
}
return V_131 ;
}
static void
F_88 ( struct V_15 * V_16 , T_6 V_31 , T_6 V_134 )
{
int V_164 ;
V_164 = ( ( ( V_31 & 0xff00 ) == 0x100 )
|| ( ( V_31 & 0xff00 ) == 0x200 ) )
...
F_86 ( V_134 & 0xff , V_16 -> V_165 + V_167 ) ;
if ( V_31 & 0xff00 ) {
F_86 ( V_117 ,
V_16 -> V_165 + V_166 ) ;
F_86 ( 0 , V_16 -> V_165 + V_167 ) ;
...
F_9 ( & V_16 -> V_125 ) ;
if ( V_104 )
F_71 ( V_16 , V_31 , V_134 ) ;
else
F_88 ( V_16 , V_31 , V_134 ) ;
F_13 ( & V_16 -> V_125 ) ;
return 0 ;
}
static int T_7
F_89 ( struct V_168 * V_162 )
{
int V_53 , V_31 ;
struct V_15 * V_16 ;
struct V_169 * V_131 ;
V_131 = F_90 ( V_162 , V_170 , 0 ) ;
if ( ! F_91 ( V_131 -> V_171 + V_166 , 2 ,
L_17 ) ) {
V_53 = - V_64 ;
goto exit;
}
...
F_93 ( & V_162 -> V_8 , & V_174 ) ;
F_66 ( V_16 ) ;
V_172:
F_94 ( V_131 -> V_171 + V_166 , 2 ) ;
exit:
return V_53 ;
}
static int T_8
F_95 ( struct V_168 * V_162 )
{
struct V_15 * V_16 = F_84 ( V_162 ) ;
F_68 ( V_16 -> V_129 ) ;
F_65 ( & V_162 -> V_8 . V_70 , & V_71 ) ;
F_65 ( & V_162 -> V_8 . V_70 , & V_130 ) ;
F_93 ( & V_162 -> V_8 , & V_174 ) ;
F_94 ( V_16 -> V_165 + V_166 , 2 ) ;
F_66 ( V_16 ) ;
return 0 ;
}
static int T_9
F_96 ( unsigned short V_54 )
{
int V_2 , V_175 , V_176 = 0 ;
int V_177 ;
for ( V_177 = V_54 ; V_177 < V_54 + V_178 ; V_177 ++ ) {
if ( ! F_91 ( V_177 , 1 , L_17 ) ) {
F_97 ( L_31 , V_177 ) ;
goto V_179;
}
}
...
V_2 = ~ V_175 & 0x7f ;
F_86 ( V_2 , V_54 + V_166 ) ;
if ( F_87 ( V_54 + V_166 ) != ( V_2 | 0x80 ) ) {
F_86 ( V_175 , V_54 + V_166 ) ;
F_97 ( L_32 , 3 ) ;
goto V_179;
}
F_86 ( V_115 , V_54 + V_166 ) ;
V_2 = F_87 ( V_54 + V_167 ) ;
if ( V_2 & 0x80 ) {
F_97 ( L_32 , 4 ) ;
goto V_179;
}
F_86 ( V_117 , V_54 + V_166 ) ;
V_175 = F_87 ( V_54 + V_167 ) ;
F_86 ( V_118 , V_54 + V_166 ) ;
V_2 = F_87 ( V_54 + V_167 ) ;
...
F_86 ( V_119 , V_54 + V_166 ) ;
V_2 = F_87 ( V_54 + V_167 ) ;
if ( V_2 < 0x03 || V_2 > 0x77 ) {
F_97 ( L_32 , 6 ) ;
goto V_179;
}
if ( F_87 ( V_54 + V_166 ) & 0x80 ) {
F_97 ( L_32 , 7 ) ;
goto V_179;
}
F_86 ( V_117 , V_54 + V_166 ) ;
V_175 = F_87 ( V_54 + V_167 ) ;
F_86 ( V_175 & 0xf8 , V_54 + V_167 ) ;
F_86 ( V_120 , V_54 + V_166 ) ;
V_2 = F_87 ( V_54 + V_167 ) ;
if ( ( V_2 & 0xfe ) == 0x10
|| V_2 == 0x30 )
V_176 = 1 ;
...
int V_53 ;
V_162 = F_101 ( L_17 , V_54 ) ;
if ( ! V_162 ) {
V_53 = - V_67 ;
F_102 ( L_36 ) ;
goto exit;
}
V_53 = F_103 ( V_162 , & V_131 , 1 ) ;
if ( V_53 ) {
F_102 ( L_37 , V_53 ) ;
goto V_182;
}
