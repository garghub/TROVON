...
break;
case V_8 :
if ( ( ! V_13 . V_26 && ! F_3 ( V_13 . V_22 , V_23 , V_23 / 2 ) ) ||
F_3 ( V_13 . V_22 , V_23 , V_23 / 2 ) )
V_3 -> V_43 = V_45 ;
else
V_3 -> V_43 = V_46 ;
break;
...
case V_8 :
if ( V_3 -> V_43 == V_45 ) {
V_7 = V_3 -> V_47 & V_50 ? 1 : 0 ;
V_16 = V_3 -> V_47 & ~ V_50 ;
} else {
V_7 = 0 ;
V_16 = V_3 -> V_47 & 0xffffff ;
}
F_4 ( 1 , L_5 ,
V_16 , V_7 ) ;
break;
