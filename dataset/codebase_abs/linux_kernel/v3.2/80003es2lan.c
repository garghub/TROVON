...
V_136 |= V_151 ;
F_21 ( V_149 , V_136 ) ;
V_136 = F_55 ( V_2 , V_152 , 0x0001 ) ;
V_136 &= ~ 0x00100000 ;
F_50 ( V_2 , V_152 , 0x0001 , V_136 ) ;
...
if ( V_5 )
return V_5 ;
V_5 = F_32 ( V_2 , V_172 , & V_83 ) ;
if ( V_5 )
return V_5 ;
V_83 &= ~ V_173 ;
V_5 = F_33 ( V_2 , V_172 , V_83 ) ;
if ( V_5 )
return V_5 ;
V_159 = F_4 ( V_174 ) ;
V_159 &= ~ ( V_175 ) ;
F_21 ( V_174 , V_159 ) ;
V_5 = F_32 ( V_2 , V_176 , & V_83 ) ;
if ( V_5 )
return V_5 ;
if ( ! F_60 ( V_2 ) ) {
V_83 |= V_177 ;
V_5 = F_33 ( V_2 , V_176 , V_83 ) ;
if ( V_5 )
return V_5 ;
V_5 = F_32 ( V_2 , V_178 , & V_83 ) ;
if ( V_5 )
return V_5 ;
V_83 &= ~ V_179 ;
V_5 = F_33 ( V_2 , V_178 , V_83 ) ;
if ( V_5 )
return V_5 ;
}
V_5 = F_32 ( V_2 , V_180 , & V_83 ) ;
if ( V_5 )
return V_5 ;
V_83 |= V_181 ;
V_5 = F_33 ( V_2 , V_180 , V_83 ) ;
if ( V_5 )
return V_5 ;
return 0 ;
}
...
V_128 &= ~ ( V_183 | V_184 ) ;
F_21 ( V_133 , V_128 ) ;
V_5 = F_53 ( V_2 , F_61 ( 0x34 , 4 ) ,
0xFFFF ) ;
if ( V_5 )
return V_5 ;
V_5 = F_52 ( V_2 , F_61 ( 0x34 , 9 ) ,
& V_136 ) ;
if ( V_5 )
return V_5 ;
V_136 |= 0x3F ;
V_5 = F_53 ( V_2 , F_61 ( 0x34 , 9 ) ,
V_136 ) ;
if ( V_5 )
return V_5 ;
V_5 = F_52 ( V_2 ,
...
F_21 ( V_149 , V_188 ) ;
do {
V_5 = F_32 ( V_2 , V_178 , & V_136 ) ;
if ( V_5 )
return V_5 ;
V_5 = F_32 ( V_2 , V_178 , & V_189 ) ;
if ( V_5 )
return V_5 ;
V_78 ++ ;
} while ( ( V_136 != V_189 ) && ( V_78 < V_193 ) );
if ( V_126 == V_194 )
V_136 |= V_179 ;
else
V_136 &= ~ V_179 ;
V_5 = F_33 ( V_2 , V_178 , V_136 ) ;
return 0 ;
}
...
static T_1 F_52 ( struct V_1 * V_2 , T_2 V_82 ,
T_3 * V_83 )
{
T_2 V_196 ;
T_1 V_5 = 0 ;
...
static T_1 F_53 ( struct V_1 * V_2 , T_2 V_82 ,
T_3 V_83 )
{
T_2 V_196 ;
T_1 V_5 = 0 ;
