...
F_5 ( V_12 , L_9 ,
V_10 -> V_16 ,
F_19 ( V_28 -> V_12 -> V_22 ) ? L_10 : L_11 ,
V_10 -> V_4 . V_18 -> V_47 , V_10 -> V_4 . V_21 -> V_47 ) ;
return 0 ;
V_15:
if ( V_10 -> V_4 . V_21 )
...
ERROR ( V_12 , L_12 , V_3 -> V_47 , V_3 , V_25 ) ;
return V_25 ;
}
static void
F_21 ( struct V_27 * V_28 , struct V_2 * V_3 )
{
if ( F_19 ( V_28 -> V_12 -> V_22 ) )
F_22 ( V_3 -> V_45 ) ;
F_22 ( V_3 -> V_40 ) ;
...
V_10 = F_28 ( sizeof *V_10 , V_53 ) ;
if ( ! V_10 )
return - V_54 ;
V_10 -> V_16 = V_16 ;
V_10 -> V_4 . V_55 = F_11 ;
V_10 -> V_4 . V_56 = F_13 ;
V_10 -> V_4 . V_5 . V_47 = L_13 ;
V_10 -> V_4 . V_5 . V_57 = V_58 ;
V_10 -> V_4 . V_5 . V_59 = F_15 ;
V_10 -> V_4 . V_5 . V_60 = F_21 ;
V_10 -> V_4 . V_5 . V_61 = F_4 ;
V_10 -> V_4 . V_5 . V_62 = F_9 ;
V_10 -> V_4 . V_5 . V_63 = F_10 ;
