...
break;
case V_95 :
V_3 = F_7 ( V_2 , V_42 ) & 0xFFCF ;
V_7 = F_8 ( V_2 , V_42 , V_3 | ( div << 4 ) ) ;
break;
}
return V_7 ;
}
static int F_24 ( struct V_1 * V_2 , T_2 V_96 )
{
...
static T_3 int F_32 ( struct V_103 * V_104 ,
...
static T_4 int F_37 ( struct V_103 * V_112 )
{
F_38 ( & V_112 -> V_66 ) ;
F_36 ( F_39 ( V_112 ) ) ;
return 0 ;
