...
void F_71 ( unsigned long V_134 , const void * V_135 , unsigned long V_97 )
{
while ( V_97 ) {
V_97 -= 1 ;
F_72 ( * ( const char * ) V_135 , V_134 ) ;
V_135 += 1 ;
}
}
void F_73 ( unsigned long V_134 , const void * V_135 , unsigned long V_97 )
{
while ( V_97 ) {
V_97 -= 2 ;
F_74 ( * ( const short * ) V_135 , V_134 ) ;
V_135 += 2 ;
}
}
void F_75 ( unsigned long V_134 , const void * V_135 , unsigned long V_97 )
{
while ( V_97 ) {
V_97 -= 4 ;
F_76 ( * ( const long * ) V_135 , V_134 ) ;
V_135 += 4 ;
}
}
void F_77 ( unsigned long V_134 , void * V_136 , unsigned long V_97 )
{
while ( V_97 ) {
V_97 -= 1 ;
* ( unsigned char * ) V_136 = F_78 ( V_134 ) ;
V_136 += 1 ;
}
}
void F_79 ( unsigned long V_134 , void * V_136 , unsigned long V_97 )
{
while ( V_97 ) {
V_97 -= 2 ;
* ( unsigned short * ) V_136 = F_80 ( V_134 ) ;
V_136 += 2 ;
}
}
void F_81 ( unsigned long V_134 , void * V_136 , unsigned long V_97 )
{
while ( V_97 ) {
V_97 -= 4 ;
* ( unsigned long * ) V_136 = F_82 ( V_134 ) ;
V_136 += 4 ;
}
}
