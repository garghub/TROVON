...
static int F_26 ( struct V_40 * V_41 , void * V_42 )
{
...
{
return F_29 ( V_45 , F_26 , V_44 -> V_46 ) ;
}
static int F_30 ( struct V_44 * V_44 , struct V_45 * V_45 )
{
V_45 -> V_47 = V_44 -> V_46 ;
return 0 ;
}
static T_4 F_31 ( struct V_45 * V_45 ,
const char T_5 * V_48 ,
T_6 V_49 , T_7 * V_50 )
{
struct V_51 * V_52 = V_45 -> V_47 ;
...
int V_9 ;
int V_57 = 0 ;
V_54 = F_32 ( V_49 , ( sizeof( V_53 ) - 1 ) ) ;
if ( F_33 ( V_53 , V_48 , V_54 ) )
return - V_58 ;
V_53 [ V_54 ] = 0 ;
...
static inline void F_36 ( struct V_3 * V_3 )
{
}
static inline void F_40 ( void )
{
}
static int T_8 F_41 ( struct V_3 * V_3 )
{
int V_9 = 0 ;
int V_57 ;
for ( V_57 = 0 ; V_57 < F_42 ( V_79 ) ; V_57 ++ ) {
V_9 = F_3 ( V_3 ,
V_79 [ V_57 ] . V_80 ,
V_79 [ V_57 ] . V_81 ) ;
if ( V_9 )
...
static int T_8 F_44 ( struct V_11 * V_83 ,
...
int V_9 ;
int V_57 ;
V_3 = F_45 ( sizeof( struct V_3 ) , V_89 ) ;
if ( ! V_3 ) {
F_6 ( & V_83 -> V_2 , L_33 ) ;
return - V_69 ;
}
...
if ( V_9 )
goto V_82;
V_9 = F_50 ( V_83 -> V_33 , NULL , F_22 ,
V_98 , L_42 , V_3 ) ;
F_51 ( V_83 -> V_33 ) ;
if ( V_9 )
goto V_99;
V_9 = F_52 ( & V_83 -> V_2 , & V_100 ) ;
if ( V_9 )
goto V_101;
for ( V_57 = 0 ; V_57 < F_42 ( V_102 ) ; V_57 ++ ) {
V_102 [ V_57 ] . V_88 = V_87 ;
V_102 [ V_57 ] . V_103 = sizeof( struct V_86 ) ;
}
V_9 = F_53 ( & V_83 -> V_2 , 0 , V_102 ,
F_42 ( V_102 ) , NULL , 0 ) ;
F_36 ( V_3 ) ;
return 0 ;
V_101:
...
static int T_9 F_56 ( struct V_11 * V_83 )
{
struct V_3 * V_3 = F_57 ( V_83 ) ;
F_58 ( & V_83 -> V_2 ) ;
F_40 () ;
F_54 ( V_3 -> V_15 ) ;
F_59 ( V_83 -> V_33 , V_3 ) ;
