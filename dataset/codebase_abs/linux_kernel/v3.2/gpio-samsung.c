...
int F_76 ( unsigned int V_62 , unsigned int V_53 )
{
struct V_1 * V_2 = F_77 ( V_62 ) ;
unsigned long V_28 ;
int V_26 ;
int V_41 ;
if ( ! V_2 )
...
F_28 ( V_2 , V_28 ) ;
V_41 = F_78 ( V_2 , V_26 , V_53 ) ;
F_29 ( V_2 , V_28 ) ;
return V_41 ;
}
int F_79 ( unsigned int V_100 , unsigned int V_101 ,
unsigned int V_15 )
{
int V_41 ;
for (; V_101 > 0 ; V_101 -- , V_100 ++ ) {
V_41 = F_76 ( V_100 , V_15 ) ;
if ( V_41 != 0 )
return V_41 ;
}
return 0 ;
}
int F_80 ( unsigned int V_100 , unsigned int V_101 ,
...
unsigned F_82 ( unsigned int V_62 )
{
struct V_1 * V_2 = F_77 ( V_62 ) ;
unsigned long V_28 ;
unsigned V_41 = 0 ;
...
int F_81 ( unsigned int V_62 , T_1 V_4 )
{
struct V_1 * V_2 = F_77 ( V_62 ) ;
unsigned long V_28 ;
int V_26 , V_41 ;
...
V_26 = V_62 - V_2 -> V_2 . V_6 ;
F_28 ( V_2 , V_28 ) ;
V_41 = F_84 ( V_2 , V_26 , V_4 ) ;
F_29 ( V_2 , V_28 ) ;
return V_41 ;
}
T_1 F_85 ( unsigned int V_62 )
{
struct V_1 * V_2 = F_77 ( V_62 ) ;
unsigned long V_28 ;
int V_26 ;
...
void F_87 ( unsigned int V_62 , unsigned int V_102 )
{
int V_41 ;
F_88 ( V_102 ) ;
if ( ! V_102 ) {
...
void F_89 ( unsigned int V_62 , unsigned int V_102 )
{
F_90 ( V_62 , L_7 ) ;
F_91 ( V_62 , V_102 ) ;
F_92 ( V_62 ) ;
}
unsigned int F_93 ( unsigned int V_62 )
{
struct V_1 * V_2 = F_77 ( V_62 ) ;
unsigned long V_103 = V_62 - V_2 -> V_2 . V_6 ;
return F_2 ( V_2 -> V_6 + 0x04 ) & ( 1 << V_103 ) ;
}
T_5 F_94 ( unsigned int V_62 )
{
struct V_1 * V_2 = F_77 ( V_62 ) ;
unsigned int V_3 ;
void T_2 * V_5 ;
...
V_104 = V_104 >> V_7 ;
V_104 &= 0x3 ;
return ( V_9 T_5 ) V_104 ;
}
int F_95 ( unsigned int V_62 , T_5 V_104 )
{
struct V_1 * V_2 = F_77 ( V_62 ) ;
unsigned int V_3 ;
void T_2 * V_5 ;
...
unsigned int F_96 ( unsigned int V_106 , unsigned int V_107 )
{
unsigned long V_28 ;
unsigned long V_108 ;
F_39 ( V_28 ) ;
