...
V_7 = F_34 ( V_6 . V_18 , sizeof( V_7 [ 0 ] ) , V_51 ) ;
if ( ! V_7 ) {
V_11 = - V_17 ;
goto V_50;
}
...
if ( V_11 < 0 )
goto V_54;
if ( F_35 ( V_48 , & V_6 , sizeof( V_6 ) ) ) {
V_11 = - V_49 ;
goto V_54;
}
if ( F_35 ( V_48 -> V_7 , V_7 ,
...
static long F_38 ( struct V_42 * V_43 , unsigned int V_63 ,
unsigned long V_48 )
{
struct V_8 * V_9 = V_43 -> V_45 ;
switch ( V_63 ) {
...
static int F_41 ( struct V_42 * V_43 , struct V_68 * V_69 )
{
struct V_8 * V_9 = V_43 -> V_45 ;
struct V_1 * V_2 ;
...
V_2 -> V_4 ++ ;
V_40 = F_43 ( V_69 , V_69 -> V_72 + V_10 * V_25 ,
V_2 -> V_26 ) ;
if ( V_40 )
goto V_78;
