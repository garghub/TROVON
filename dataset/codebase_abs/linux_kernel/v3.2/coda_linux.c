...
void F_7 ( struct V_59 * V_59 , struct V_28 * V_60 )
{
unsigned int V_61 ;
V_60 -> V_40 = - 1 ;
V_60 -> V_42 = ( V_62 ) - 1 ;
V_60 -> V_45 = ( V_63 ) - 1 ;
V_60 -> V_49 = ( V_64 ) - 1 ;
V_60 -> V_52 . V_53 = ( V_65 ) - 1 ;
V_60 -> V_52 . V_66 = ( V_65 ) - 1 ;
V_60 -> V_55 . V_53 = ( V_65 ) - 1 ;
V_60 -> V_55 . V_66 = ( V_65 ) - 1 ;
V_60 -> V_57 . V_53 = ( V_65 ) - 1 ;
V_60 -> V_57 . V_66 = ( V_65 ) - 1 ;
V_60 -> V_31 = V_32 ;
V_60 -> V_67 = - 1 ;
V_60 -> V_68 = - 1 ;
V_60 -> V_69 = - 1 ;
...
if ( V_61 & V_76 ) {
V_60 -> V_42 = ( V_62 ) V_59 -> V_77 ;
}
if ( V_61 & V_78 ) {
V_60 -> V_45 = ( V_63 ) V_59 -> V_79 ;
}
if ( V_61 & V_80 ) {
V_60 -> V_49 = V_59 -> V_81 ;
}
