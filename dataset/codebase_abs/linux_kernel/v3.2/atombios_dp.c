...
static void F_32 ( struct V_146 * V_147 ,
struct V_126 * V_127 )
{
...
V_151 )
V_148 = V_152 ;
else if ( V_127 -> V_153 == V_154 ) {
T_1 V_155 = F_10 ( V_39 , V_156 ) ;
if ( V_155 & 1 )
V_148 = V_152 ;
}
F_34 ( V_147 ,
V_157 ,
V_148 ) ;
if ( ( V_127 -> V_153 == V_154 ) &&
( V_148 == V_152 ) ) {
F_9 ( V_39 , V_158 , 1 ) ;
}
}
void F_35 ( struct V_126 * V_127 ,
struct V_159 * V_59 )
{
struct V_39 * V_39 = F_33 ( V_127 ) ;
struct V_41 * V_42 ;
...
{
T_1 V_79 [ V_80 ] ;
struct V_41 * V_166 = V_39 -> V_43 ;
if ( ! F_37 ( V_39 , V_79 ) )
return false ;
if ( F_16 ( V_79 , V_166 -> V_163 ) )
return false ;
return true ;
}
static void F_39 ( struct V_167 * V_168 )
{
F_40 ( V_168 -> V_147 ,
V_169 ,
0 , V_168 -> V_101 [ 0 ] ) ;
F_6 ( V_168 -> V_39 , V_170 ,
V_168 -> V_101 , V_168 -> V_163 , 0 ) ;
}
static void F_41 ( struct V_167 * V_168 , int V_171 )
{
int V_172 = 0 ;
if ( F_3 ( V_168 -> V_12 ) || ! V_168 -> V_173 ) {
switch ( V_171 ) {
case V_174 :
V_172 = V_175 ;
break;
...
F_29 ( V_168 -> V_12 , V_180 ,
V_168 -> V_136 , V_168 -> V_181 , V_172 ) ;
}
F_9 ( V_168 -> V_39 , V_182 , V_171 ) ;
}
static int F_42 ( struct V_167 * V_168 )
{
T_1 V_155 ;
if ( V_168 -> V_118 [ 0 ] >= 0x11 )
F_9 ( V_168 -> V_39 ,
V_183 , V_184 ) ;
if ( V_168 -> V_118 [ 3 ] & 0x1 )
F_9 ( V_168 -> V_39 ,
V_185 , V_186 ) ;
else
F_9 ( V_168 -> V_39 ,
V_185 , 0 ) ;
F_32 ( V_168 -> V_147 , V_168 -> V_127 ) ;
V_155 = V_168 -> V_163 ;
if ( V_168 -> V_118 [ 0 ] >= 0x11 )
V_155 |= V_187 ;
F_9 ( V_168 -> V_39 , V_188 , V_155 ) ;
V_155 = F_24 ( V_168 -> V_136 ) ;
F_9 ( V_168 -> V_39 , V_189 , V_155 ) ;
if ( F_3 ( V_168 -> V_12 ) || ! V_168 -> V_173 )
F_34 ( V_168 -> V_147 ,
V_190 , 0 ) ;
else
F_29 ( V_168 -> V_12 , V_191 ,
V_168 -> V_136 , V_168 -> V_181 , 0 ) ;
F_9 ( V_168 -> V_39 ,
V_182 ,
V_192 ) ;
return 0 ;
...
F_29 ( V_168 -> V_12 , V_194 ,
V_168 -> V_136 , V_168 -> V_181 , 0 ) ;
return 0 ;
}
static int F_44 ( struct V_167 * V_168 )
{
bool V_195 ;
T_1 V_196 ;
int V_84 ;
F_41 ( V_168 , V_174 ) ;
memset ( V_168 -> V_101 , 0 , 4 ) ;
F_39 ( V_168 ) ;
F_7 ( 400 ) ;
V_195 = false ;
V_168 -> V_197 = 0 ;
...
F_45 ( V_168 -> V_198 * 4 ) ;
if ( ! F_37 ( V_168 -> V_39 , V_168 -> V_79 ) )
break;
if ( F_15 ( V_168 -> V_79 , V_168 -> V_163 ) ) {
V_195 = true ;
break;
}
for ( V_84 = 0 ; V_84 < V_168 -> V_163 ; V_84 ++ ) {
if ( ( V_168 -> V_101 [ V_84 ] & V_109 ) == 0 )
break;
}
if ( V_84 == V_168 -> V_163 ) {
F_12 ( L_19 ) ;
...
V_168 -> V_197 = 0 ;
V_196 = V_168 -> V_101 [ 0 ] & V_112 ;
F_19 ( V_168 -> V_79 , V_168 -> V_163 , V_168 -> V_101 ) ;
F_39 ( V_168 ) ;
}
if ( ! V_195 ) {
F_12 ( L_21 ) ;
...
if ( ! F_37 ( V_168 -> V_39 , V_168 -> V_79 ) )
break;
if ( F_16 ( V_168 -> V_79 , V_168 -> V_163 ) ) {
V_199 = true ;
break;
}
if ( V_168 -> V_197 > 5 ) {
...
void F_47 ( struct V_146 * V_147 ,
struct V_126 * V_127 )
{
struct V_9 * V_10 = V_147 -> V_10 ;
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_201 * V_201 = F_48 ( V_147 ) ;
struct V_202 * V_166 ;
struct V_39 * V_39 ;
struct V_41 * V_42 ;
struct V_167 V_168 ;
int V_15 ;
T_1 V_155 , V_203 , V_204 ;
if ( ! V_201 -> V_205 )
return;
V_166 = V_201 -> V_205 ;
V_39 = F_33 ( V_127 ) ;
...
V_168 . V_173 = true ;
V_15 = F_2 ( V_16 , V_138 ) ;
if ( F_49 ( V_12 -> V_20 . V_21 , V_15 , & V_203 , & V_204 ) ) {
if ( V_204 > 1 ) {
V_168 . V_173 = false ;
}
}
...
V_168 . V_181 |= V_211 ;
V_168 . V_198 = F_10 ( V_39 , V_212 ) ;
V_155 = F_10 ( V_39 , V_124 ) ;
if ( F_50 ( V_12 ) && ( V_155 & V_213 ) )
V_168 . V_200 = true ;
else
V_168 . V_200 = false ;
memcpy ( V_168 . V_118 , V_42 -> V_118 , 8 ) ;
V_168 . V_12 = V_12 ;
V_168 . V_147 = V_147 ;
V_168 . V_127 = V_127 ;
V_168 . V_39 = V_39 ;
V_168 . V_163 = V_42 -> V_163 ;
V_168 . V_136 = V_42 -> V_136 ;
if ( F_42 ( & V_168 ) )
goto V_214;
if ( F_44 ( & V_168 ) )
goto V_214;
