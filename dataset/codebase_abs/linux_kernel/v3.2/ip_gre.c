...
F_89 ( V_59 , V_125 ) ;
F_60 ( V_59 ) ;
memset ( & ( F_65 ( V_59 ) -> V_167 ) , 0 , sizeof( F_65 ( V_59 ) -> V_167 ) ) ;
F_65 ( V_59 ) -> V_39 &= ~ ( V_168 | V_169 |
V_170 ) ;
F_90 ( V_59 ) ;
...
V_35 -> V_80 = ( ( const struct V_91 * ) V_89 ) -> V_173 ;
#endif
else
V_35 -> V_80 = F_92 ( & V_122 -> V_126 ) ;
}
( ( T_2 * ) ( V_35 + 1 ) ) [ 0 ] = V_94 -> V_34 . V_174 ;
( ( T_2 * ) ( V_35 + 1 ) ) [ 1 ] = ( V_3 -> type == V_30 ) ?
F_8 ( V_29 ) : V_59 -> V_86 ;
if ( V_94 -> V_34 . V_174 & ( V_68 | V_67 | V_69 ) ) {
T_1 * V_175 = ( T_1 * ) ( ( ( T_5 * ) V_35 ) + V_94 -> V_128 - 4 ) ;
if ( V_94 -> V_34 . V_174 & V_69 ) {
++ V_94 -> V_176 ;
* V_175 = F_76 ( V_94 -> V_176 ) ;
V_175 -- ;
}
if ( V_94 -> V_34 . V_174 & V_68 ) {
* V_175 = V_94 -> V_34 . V_144 ;
V_175 -- ;
}
if ( V_94 -> V_34 . V_174 & V_67 ) {
* V_175 = 0 ;
* ( T_6 * ) V_175 = F_93 ( ( void * ) ( V_35 + 1 ) , V_59 -> V_116 - sizeof( struct V_61 ) ) ;
}
}
F_94 ( V_59 ) ;
V_7 = F_58 ( V_3 -> V_7 ) ;
...
int V_128 = V_178 ;
int V_56 = V_179 ;
int V_180 = sizeof( struct V_61 ) + 4 ;
V_94 = F_11 ( V_3 ) ;
V_35 = & V_94 -> V_34 . V_35 ;
if ( V_35 -> V_37 ) {
struct V_118 V_119 ;
...
if ( V_123 ) {
V_128 = V_123 -> V_148 + V_123 -> V_182 ;
V_56 = V_123 -> V_56 ;
}
V_3 -> V_183 = V_94 -> V_34 . V_19 ;
if ( V_94 -> V_34 . V_174 & ( V_67 | V_68 | V_69 ) ) {
if ( V_94 -> V_34 . V_174 & V_67 )
V_180 += 4 ;
if ( V_94 -> V_34 . V_174 & V_68 )
V_180 += 4 ;
...
V_3 -> V_182 = V_180 + V_128 ;
V_56 -= V_3 -> V_148 + V_180 ;
if ( V_56 < 68 )
V_56 = 68 ;
V_94 -> V_128 = V_180 ;
return V_56 ;
...
goto V_196;
V_187 = - V_197 ;
if ( V_63 . V_35 . V_171 != 4 || V_63 . V_35 . V_86 != V_172 ||
V_63 . V_35 . V_64 != 5 || ( V_63 . V_35 . V_147 & F_8 ( ~ V_151 ) ) ||
( ( V_63 . V_108 | V_63 . V_174 ) & ( V_71 | V_70 ) ) )
goto V_196;
if ( V_63 . V_35 . V_80 )
...
V_3 -> V_214 = F_114 ;
V_3 -> type = V_31 ;
V_3 -> V_182 = V_178 + sizeof( struct V_61 ) + 4 ;
V_3 -> V_56 = V_179 - sizeof( struct V_61 ) - 4 ;
V_3 -> V_39 = V_215 ;
V_3 -> V_183 = 0 ;
V_3 -> V_216 = 4 ;
V_3 -> V_217 |= V_218 ;
