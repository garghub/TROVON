...
static unsigned int F_4 ( int V_16 , int V_18 )
{
unsigned int V_31 = 0 ;
if ( V_16 >= V_26 )
V_31 = 1 ;
...
static void F_5 ( int V_32 , struct V_11 * V_1 )
{
if ( V_32 >= V_19 )
V_1 -> V_25 = V_1 -> V_21 + V_19 ;
}
static void F_6 ( int V_33 , struct V_11 * V_1 )
{
if ( F_7 ( V_33 ) )
V_1 -> V_25 = V_1 -> V_21 + V_19 ;
}
static void F_8 ( struct V_11 * V_34 , T_1 V_35 ,
unsigned int V_36 )
{
}
static void F_9 ( struct V_11 * V_1 )
{
if ( F_7 ( V_1 -> V_25 ) )
V_1 -> V_25 = 0 ;
}
static int F_10 ( int V_37 )
{
int V_31 = 0 ;
if ( F_7 ( V_37 >= V_19 ) )
V_31 = V_38 ;
