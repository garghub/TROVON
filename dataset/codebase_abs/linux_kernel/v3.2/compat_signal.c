...
if ( ! F_2 ( V_31 , V_93 , sizeof( * V_93 ) ) )
goto V_95;
if ( F_7 ( & V_94 , & V_93 -> V_102 . V_103 , sizeof( V_94 ) ) )
goto V_95;
F_30 ( & V_94 , ~ V_99 ) ;
F_31 ( & V_94 ) ;
if ( F_22 ( V_57 , & V_93 -> V_102 . V_104 ) )
goto V_95;
if ( F_28 ( V_57 , V_93 -> V_92 ) )
goto V_95;
V_3 = F_6 ( V_61 , & V_93 -> V_102 . V_105 . V_61 ) ;
V_101 . V_61 = F_34 ( V_61 ) ;
V_3 |= F_6 ( V_101 . V_63 , & V_93 -> V_102 . V_105 . V_63 ) ;
V_3 |= F_6 ( V_101 . V_64 , & V_93 -> V_102 . V_105 . V_64 ) ;
if ( V_3 )
goto V_95;
F_17 ( V_65 ) ;
F_18 ( ( T_10 V_32 T_2 * ) & V_101 , NULL , V_57 -> V_66 [ 15 ] ) ;
F_17 ( V_62 ) ;
return V_57 -> V_66 [ 2 ] ;
V_95:
F_32 ( V_100 , V_58 ) ;
...
F_35 ( struct V_39 * V_106 , struct V_56 * V_57 , T_7 V_107 )
{
unsigned long V_108 ;
V_108 = ( unsigned long ) F_36 ( V_57 -> V_66 [ 15 ] ) ;
if ( F_37 ( V_108 ) && ! F_37 ( ( V_108 - V_107 ) & - 8UL ) )
return ( void T_2 * ) - 1UL ;
if ( V_106 -> V_46 . V_47 & V_109 ) {
if ( ! F_38 ( V_108 ) )
V_108 = V_58 -> V_110 + V_58 -> V_111 ;
}
else if ( ! F_39 ( V_57 ) &&
! ( V_106 -> V_46 . V_47 & V_112 ) &&
V_106 -> V_46 . V_43 ) {
V_108 = ( unsigned long ) V_106 -> V_46 . V_43 ;
}
return ( void T_2 * ) ( ( V_108 - V_107 ) & - 8ul ) ;
}
static inline int F_40 ( int V_35 )
{
if ( F_23 () -> V_113
&& F_23 () -> V_113 -> V_114
&& V_35 < 32 )
return F_23 () -> V_113 -> V_114 [ V_35 ] ;
else
return V_35 ;
}
static int F_41 ( int V_35 , struct V_39 * V_106 ,
T_15 * V_94 , struct V_56 * V_57 )
{
T_14 T_2 * V_93 = F_35 ( V_106 , V_57 , sizeof( T_14 ) ) ;
...
goto V_115;
if ( V_106 -> V_46 . V_47 & V_112 ) {
V_57 -> V_66 [ 14 ] = ( V_86 ) V_106 -> V_46 . V_43 | V_87 ;
} else {
V_57 -> V_66 [ 14 ] = ( V_86 ) V_93 -> V_116 | V_87 ;
if ( F_3 ( V_117 | V_118 ,
( V_119 V_32 T_2 * ) ( V_93 -> V_116 ) ) )
goto V_115;
}
...
V_57 -> V_70 . V_45 |= V_75 ;
V_57 -> V_70 . V_74 = ( V_32 V_86 ) V_106 -> V_46 . V_42 ;
V_57 -> V_66 [ 2 ] = F_40 ( V_35 ) ;
V_57 -> V_66 [ 3 ] = ( V_32 V_86 ) & V_93 -> V_96 ;
V_57 -> V_66 [ 4 ] = V_58 -> V_77 . V_120 ;
V_57 -> V_66 [ 5 ] = V_58 -> V_77 . V_121 ;
if ( F_3 ( V_57 -> V_66 [ 2 ] , ( int V_32 T_2 * ) & V_93 -> V_122 ) )
goto V_115;
return 0 ;
V_115:
F_42 ( V_35 , V_58 ) ;
...
static int F_43 ( int V_35 , struct V_39 * V_106 , T_3 * V_123 ,
T_15 * V_94 , struct V_56 * V_57 )
{
int V_3 = 0 ;
T_16 T_2 * V_93 = F_35 ( V_106 , V_57 , sizeof( T_16 ) ) ;
if ( ! F_2 ( V_4 , V_93 , sizeof( T_16 ) ) )
goto V_115;
if ( V_93 == ( void T_2 * ) - 1UL )
goto V_115;
if ( F_1 ( & V_93 -> V_123 , V_123 ) )
goto V_115;
V_3 |= F_3 ( V_124 , & V_93 -> V_102 . V_125 ) ;
V_3 |= F_3 ( 0 , & V_93 -> V_102 . V_126 ) ;
V_3 |= F_3 ( V_58 -> V_110 , & V_93 -> V_102 . V_105 . V_61 ) ;
V_3 |= F_3 ( F_38 ( V_57 -> V_66 [ 15 ] ) ,
& V_93 -> V_102 . V_105 . V_64 ) ;
V_3 |= F_3 ( V_58 -> V_111 , & V_93 -> V_102 . V_105 . V_63 ) ;
V_3 |= F_19 ( V_57 , & V_93 -> V_102 . V_104 ) ;
V_3 |= F_27 ( V_57 , V_93 -> V_92 ) ;
V_3 |= F_4 ( & V_93 -> V_102 . V_103 , V_94 , sizeof( * V_94 ) ) ;
if ( V_3 )
goto V_115;
if ( V_106 -> V_46 . V_47 & V_112 ) {
V_57 -> V_66 [ 14 ] = ( V_86 ) V_106 -> V_46 . V_43 ;
} else {
V_57 -> V_66 [ 14 ] = ( V_86 ) V_93 -> V_116 ;
V_3 |= F_3 ( V_117 | V_127 ,
( V_119 V_32 T_2 * ) ( V_93 -> V_116 ) ) ;
}
...
V_57 -> V_66 [ 15 ] = ( V_32 V_86 ) V_93 ;
V_57 -> V_70 . V_45 |= V_75 ;
V_57 -> V_70 . V_74 = ( V_86 ) V_106 -> V_46 . V_42 ;
V_57 -> V_66 [ 2 ] = F_40 ( V_35 ) ;
V_57 -> V_66 [ 3 ] = ( V_32 V_86 ) & V_93 -> V_123 ;
V_57 -> V_66 [ 4 ] = ( V_32 V_86 ) & V_93 -> V_102 ;
return 0 ;
V_115:
F_42 ( V_35 , V_58 ) ;
return - V_5 ;
}
int F_44 ( unsigned long V_35 , struct V_39 * V_106 ,
T_3 * V_123 , T_15 * V_128 , struct V_56 * V_57 )
{
T_15 V_129 ;
int V_44 ;
if ( V_106 -> V_46 . V_47 & V_130 )
V_44 = F_43 ( V_35 , V_106 , V_123 , V_128 , V_57 ) ;
else
V_44 = F_41 ( V_35 , V_106 , V_128 , V_57 ) ;
if ( V_44 )
return V_44 ;
F_45 ( & V_129 , & V_58 -> V_129 , & V_106 -> V_46 . V_48 ) ;
if ( ! ( V_106 -> V_46 . V_47 & V_131 ) )
F_46 ( & V_129 , V_35 ) ;
F_31 ( & V_129 ) ;
return 0 ;
}
