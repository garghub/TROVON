...
int F_16 ( T_1 V_2 , const struct V_1 * V_6 )
{
if ( V_2 >= F_5 ( V_9 ) )
return - V_10 ;
F_7 ( & V_12 ) ;
...
static void * F_22 ( struct V_30 * V_31 , T_3 * V_32 )
{
F_7 ( & V_12 ) ;
if ( * V_32 >= F_5 ( V_9 ) )
return NULL ;
...
static void * F_23 ( struct V_30 * V_33 , void * V_34 , T_3 * V_32 )
{
( * V_32 ) ++ ;
if ( * V_32 >= F_5 ( V_9 ) )
return NULL ;
...
static void F_24 ( struct V_30 * V_33 , void * V_34 )
{
F_12 ( & V_12 ) ;
}
static int F_25 ( struct V_30 * V_33 , void * V_34 )
{
T_3 * V_32 = V_34 ;
const struct V_1 * V_6 ;
struct V_1 * V_4 ;
...
F_10 ( & V_12 ) ) ;
if ( ! V_6 )
V_35 = F_26 ( V_33 , L_1 , * V_32 ) ;
else
V_35 = F_26 ( V_33 , L_2 , * V_32 , V_6 -> V_5 ) ;
if ( V_35 < 0 )
return V_35 ;
F_2 (t, &nf_loggers_l[*pos], list[*pos]) {
V_35 = F_26 ( V_33 , L_3 , V_4 -> V_5 ) ;
if ( V_35 < 0 )
return V_35 ;
...
return F_26 ( V_33 , L_5 ) ;
}
static int F_27 ( struct V_37 * V_37 , struct V_38 * V_38 )
{
return F_28 ( V_38 , & V_39 ) ;
}
static int F_29 ( T_4 * V_40 , int V_41 ,
...
V_40 -> V_52 = V_6 -> V_5 ;
V_48 = F_31 ( V_40 , V_41 , V_42 , V_43 , V_44 ) ;
F_12 ( & V_12 ) ;
}
return V_48 ;
}
static T_7 int F_32 ( void )
{
int V_8 ;
for ( V_8 = V_13 ; V_8 < V_14 ; V_8 ++ ) {
