...
T_1 V_16 ;
F_8 ( L_4 ) ;
if ( V_29 -> V_43 . V_44 . type == V_45 ) {
switch ( V_42 -> V_46 . V_47 . V_48 ) {
case V_49 :
case V_50 :
V_16 = 0 ;
break;
...
} else if ( V_29 -> V_43 . V_44 . type == V_53 ) {
switch ( V_42 -> V_46 . V_54 . V_55 ) {
case V_56 :
V_16 = 6 ;
break;
case V_57 :
...
V_20 = F_10 ( V_29 , V_42 -> V_59 , V_16 ) ;
if ( F_9 ( V_20 ) )
goto V_25;
V_2 -> V_59 = V_42 -> V_59 ;
V_2 -> V_55 = ( V_29 -> V_43 . V_44 . type == V_53 ) ?
V_42 -> V_46 . V_54 . V_55 : 0 ;
V_25:
return V_20 ;
}
static int F_13 ( struct V_28 * V_29 , T_2 * V_60 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
int V_61 , V_62 , V_20 ;
* V_60 = 0 ;
V_20 = F_11 ( V_2 , & V_61 , & V_62 ) ;
if ( F_9 ( V_20 ) )
goto V_25;
F_14 ( L_8 , V_61 ? L_9 : L_10 ,
V_62 ? L_11 : L_10 ) ;
if ( ( V_61 ) || ( V_62 ) )
* V_60 |= V_63 ;
V_25:
...
static int F_15 ( struct V_28 * V_29 , T_3 * V_64 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
T_1 V_65 , V_66 ;
int V_20 ;
...
if ( F_9 ( V_20 ) )
goto V_25;
V_20 = F_1 ( V_2 , V_67 , & V_65 ) ;
if ( F_9 ( V_20 ) )
goto V_25;
V_20 = F_1 ( V_2 , V_68 , & V_66 ) ;
if ( F_9 ( V_20 ) )
goto V_25;
* V_64 = V_65 | ( ( V_66 & 0x07 ) << 8 ) ;
V_25:
V_20 = F_2 ( V_2 , 0x00 , 0x00 ) ;
F_9 ( V_20 ) ;
return V_20 ;
}
static int F_16 ( struct V_28 * V_29 , T_2 * V_59 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
* V_59 = V_2 -> V_59 ;
return 0 ;
}
static int F_17 ( struct V_28 * V_29 , T_2 * V_55 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
* V_55 = V_2 -> V_55 ;
return 0 ;
...
struct V_28 * F_20 ( struct V_28 * V_29 ,
struct V_69 * V_7 ,
struct V_70 * V_5 )
{
struct V_1 * V_2 = NULL ;
