...
static T_1 int F_27 ( struct V_55 * V_56 )
{
...
V_16 = F_28 ( sizeof( struct V_15 ) , V_60 ) ;
if ( ! V_16 ) {
F_5 ( & V_56 -> V_21 , L_29 ) ;
return - V_61 ;
}
V_16 -> V_34 = V_34 ;
V_40 = F_29 ( & V_16 -> V_20 , & V_56 -> V_21 ) ;
if ( V_40 )
goto V_62;
V_14 -> V_21 = & V_56 -> V_21 ;
F_30 ( V_56 , V_14 ) ;
...
static int T_2 F_35 ( struct V_55 * V_56 )
{
struct V_13 * V_14 = F_36 ( V_56 ) ;
struct V_15 * V_16 = F_2 ( V_14 ) ;
struct V_33 * V_34 = V_16 -> V_34 ;
if ( V_16 -> V_35 & V_51 )
F_37 ( & V_49 ,
