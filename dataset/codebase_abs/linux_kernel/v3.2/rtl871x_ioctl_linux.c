...
V_26 -> V_29 . V_30 . V_32 )
return - V_154 ;
if ( V_26 -> V_164 [ 0 ] == 0xff && V_26 -> V_164 [ 1 ] == 0xff &&
V_26 -> V_164 [ 2 ] == 0xff && V_26 -> V_164 [ 3 ] == 0xff &&
V_26 -> V_164 [ 4 ] == 0xff && V_26 -> V_164 [ 5 ] == 0xff ) {
...
static int F_37 ( struct V_6 * V_7 , char * V_191 ,
...
static int F_46 ( struct V_141 * V_142 , struct V_50 * V_4 ,
union V_8 * V_9 , char * V_5 )
{
struct V_6 * V_7 = (struct V_6 * ) F_26 ( V_142 ) ;
struct V_10 * V_11 = & V_7 -> V_12 ;
if ( F_32 ( V_11 , V_185 ) == true )
V_9 -> V_95 = V_234 ;
else if ( F_32 ( V_11 ,
V_219 | V_236 ) == true )
V_9 -> V_95 = V_97 ;
else if ( F_32 ( V_11 , V_237 ) == true )
V_9 -> V_95 = V_96 ;
else
V_9 -> V_95 = V_230 ;
return 0 ;
}
static int F_47 ( struct V_141 * V_142 ,
struct V_50 * V_4 ,
union V_8 * V_9 , char * V_214 )
{
struct V_6 * V_7 = (struct V_6 * ) F_26 ( V_142 ) ;
...
int V_296 ;
int V_297 ;
V_296 = F_52 ( V_142 , V_51 , & V_295 , V_214 ) ;
if ( 0 != V_296 )
V_297 = 0 ;
else
...
static int F_55 ( struct V_141 * V_142 ,
struct V_50 * V_51 ,
union V_8 * V_285 ,
char * V_214 )
{
...
enum V_312 V_313 ;
if ( F_32 ( V_11 , V_314 ) == true )
return - V_315 ;
if ( F_32 ( V_11 , V_316 ) == true )
return V_143 ;
if ( V_307 -> V_14 != V_15 )
return - V_154 ;
V_313 = V_7 -> V_36 . V_148 ;
F_56 ( & V_304 -> V_317 , V_308 ) ;
V_310 = F_57 ( V_304 ) ;
V_11 -> V_318 = F_58 ( V_310 ) ;
while ( 1 ) {
if ( F_59 ( V_310 , V_11 -> V_318 ) == true )
break;
V_53 = F_60 ( V_11 -> V_318 ,
struct V_52 , V_319 ) ;
V_11 -> V_318 = F_58 ( V_11 -> V_318 ) ;
...
F_61 ( & V_304 -> V_317 , V_308 ) ;
if ( ! V_143 ) {
if ( ! F_62 ( V_7 , V_313 ) )
V_143 = - V_171 ;
else {
if ( ! F_63 ( V_7 , V_307 -> V_16 ) )
V_143 = - 1 ;
}
}
return V_143 ;
...
V_327 = F_69 ( V_7 , & V_339 ) ;
F_61 ( & V_11 -> V_317 , V_308 ) ;
}
} else
V_327 = F_70 ( V_7 ) ;
if ( V_327 == false )
...
V_343 = F_58 ( V_310 ) ;
while ( 1 ) {
if ( F_59 ( V_310 , V_343 ) == true )
break;
if ( ( V_55 - V_344 ) < V_345 ) {
V_143 = - V_346 ;
break;
}
V_53 = F_60 ( V_343 , struct V_52 , V_319 ) ;
...
{
struct V_6 * V_7 = (struct V_6 * ) F_26 ( V_142 ) ;
return F_37 ( V_7 , V_214 , V_9 -> V_74 . V_76 ) ;
}
...
T_3 V_2 ;
T_3 V_408 ;
F_90 ( V_2 , ( T_3 V_409 * ) V_9 -> V_74 . V_290 ) ;
V_408 = F_91 ( V_7 , V_2 ) ;
F_92 ( V_408 , ( T_3 V_409 * ) V_9 -> V_74 . V_290 ) ;
...
V_286 = V_61 -> V_76 ;
V_420 = NULL ;
V_420 = ( T_1 * ) F_29 ( V_286 ) ;
if ( V_420 == NULL ) {
V_143 = - V_171 ;
goto V_422;
}
if ( F_51 ( V_420 , V_61 -> V_290 , V_286 ) ) {
V_143 = - V_291 ;
goto V_422;
}
...
if ( V_421 == 0x00 ) {
if ( F_54 ( V_61 -> V_290 , V_420 , V_286 ) )
V_143 = - V_291 ;
}
if ( V_327 ) {
V_143 = - V_291 ;
...
V_438 -> V_75 = 0 ;
if ( V_438 -> V_76 >= 32 ) {
if ( F_51 ( V_74 , V_438 -> V_290 , 32 ) )
return - V_154 ;
} else
return - V_154 ;
F_56 ( & ( V_11 -> V_305 . V_317 ) , V_308 ) ;
V_310 = F_57 ( V_304 ) ;
V_343 = F_58 ( V_310 ) ;
while ( 1 ) {
if ( F_59 ( V_310 , V_343 ) == true )
...
F_28 ( V_166 L_49 ,
( T_1 * ) V_74 ) ;
F_61 ( & ( V_11 -> V_305 . V_317 ) ,
V_308 ) ;
return - V_154 ;
}
F_28 ( V_166 L_50 , V_245 ) ;
if ( ! memcmp ( V_245 , V_53 -> V_18 . V_19 , V_20 ) ) {
V_440 = F_99 ( & V_53 -> V_18 . V_79 [ 12 ] ,
...
F_61 ( & ( V_11 -> V_305 . V_317 ) , V_308 ) ;
if ( V_438 -> V_76 >= 34 ) {
if ( F_54 ( ( T_1 V_409 * ) V_438 -> V_290 + 32 ,
( T_1 * ) & V_438 -> V_75 , 1 ) )
return - V_154 ;
}
return 0 ;
...
if ( ( V_7 -> V_328 ) || ( V_438 == NULL ) )
return - V_154 ;
if ( F_51 ( & V_7 -> V_441 , V_438 -> V_290 , sizeof( int ) ) )
return - V_154 ;
return 0 ;
}
...
struct V_288 * V_438 = & V_9 -> V_74 ;
T_3 V_443 = 0 ;
if ( F_51 ( ( void * ) & V_443 , V_438 -> V_290 , 4 ) )
return - V_291 ;
if ( ( V_7 -> V_328 ) || ( V_438 == NULL ) )
return - V_154 ;
if ( V_443 == 0 )
...
static int F_105 ( struct V_141 * V_142 , T_1 V_89 , T_3 V_117 )
{
struct V_6 * V_7 = (struct V_6 * ) F_26 ( V_142 ) ;
switch ( V_89 ) {
case V_449 :
...
static int F_106 ( struct V_141 * V_142 , T_3 V_456 , T_3 V_321 )
{
struct V_6 * V_7 = (struct V_6 * ) F_26 ( V_142 ) ;
switch ( V_456 ) {
case V_457 :
...
static int F_107 ( struct V_141 * V_142 , struct V_288 * V_61 )
{
struct V_25 * V_26 ;
int V_143 = 0 ;
struct V_6 * V_7 = (struct V_6 * ) F_26 ( V_142 ) ;
...
return - V_154 ;
V_26 = (struct V_25 * ) F_29 ( V_61 -> V_76 ) ;
if ( V_26 == NULL )
return - V_171 ;
if ( F_51 ( V_26 , V_61 -> V_290 , V_61 -> V_76 ) ) {
F_36 ( ( T_1 * ) V_26 ) ;
return - V_291 ;
}
switch ( V_26 -> V_71 ) {
case V_459 :
V_143 = F_105 ( V_142 , V_26 -> V_29 . V_460 . V_89 ,
V_26 -> V_29 . V_460 . V_117 ) ;
break;
case V_461 :
V_143 = F_37 ( V_7 , ( char * ) V_26 -> V_29 . V_121 . V_74 ,
...
break;
case V_462 :
V_143 = F_106 ( V_142 , V_26 -> V_29 . V_323 . V_456 ,
...
if ( V_143 == 0 && F_54 ( V_61 -> V_290 , V_26 , V_61 -> V_76 ) )
V_143 = - V_291 ;
F_36 ( ( T_1 * ) V_26 ) ;
return V_143 ;
}
int F_108 ( struct V_141 * V_142 , struct V_463 * V_464 , int V_71 )
{
struct V_465 * V_466 = (struct V_465 * ) V_464 ;
switch ( V_71 ) {
case V_467 :
return F_107 ( V_142 , & V_466 -> V_29 . V_74 ) ;
default:
return - V_178 ;
}
return 0 ;
}
static struct V_468 * F_109 ( struct V_141 * V_142 )
{
struct V_6 * V_7 = (struct V_6 * ) F_26 ( V_142 ) ;
