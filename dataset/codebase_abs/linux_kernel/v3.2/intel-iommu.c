...
struct V_48 * V_49 ;
F_79 ( & V_146 , V_58 ) ;
while ( ! F_192 ( & V_56 -> V_77 ) ) {
V_144 = F_193 ( V_56 -> V_77 . V_222 ,
struct V_142 , V_223 ) ;
F_194 ( & V_144 -> V_223 ) ;
F_194 ( & V_144 -> V_224 ) ;
if ( V_144 -> V_147 )
...
static struct V_55 * F_196 ( struct V_172 * V_173 , int V_107 )
{
...
F_199 ( & V_144 -> V_223 , & V_56 -> V_77 ) ;
F_199 ( & V_144 -> V_224 , & V_229 ) ;
F_80 ( & V_146 , V_58 ) ;
}
}
V_227:
...
static int F_201 ( struct V_172 * V_173 ,
unsigned long long V_185 ,
unsigned long long V_186 )
{
struct V_55 * V_56 ;
int V_86 ;
V_56 = F_196 ( V_173 , V_54 ) ;
if ( ! V_56 )
return - V_108 ;
if ( V_56 == V_232 && V_233 ) {
F_42 ( L_28 ,
F_198 ( V_173 ) , V_185 , V_186 ) ;
return 0 ;
}
F_42 ( V_35
L_29 ,
...
static inline int F_204 ( struct V_238 * V_239 ,
struct V_172 * V_173 )
{
if ( V_173 -> V_147 . V_225 . V_49 == V_240 )
return 0 ;
return F_201 ( V_173 , V_239 -> V_241 ,
V_239 -> V_242 ) ;
}
static inline void F_205 ( void )
{
struct V_172 * V_173 ;
int V_86 ;
V_173 = F_206 ( V_243 << 8 , NULL ) ;
if ( ! V_173 )
return;
F_42 ( V_35 L_33 ) ;
V_86 = F_201 ( V_173 , 0 , 16 * 1024 * 1024 - 1 ) ;
if ( V_86 )
F_42 ( V_141 L_34
L_35 ) ;
}
...
static int T_1 F_207 ( unsigned long V_102 ,
...
static int T_1 F_208 ( int V_246 )
{
struct V_68 * V_69 ;
struct V_48 * V_49 ;
int V_97 , V_86 = 0 ;
...
return 0 ;
F_210 (nid) {
F_211 ( V_97 , F_207 , & V_86 ) ;
if ( V_86 )
return V_86 ;
}
return 0 ;
}
static int F_212 ( struct V_172 * V_173 )
{
struct V_142 * V_144 ;
if ( F_213 ( ! V_247 ) )
return 0 ;
...
static int F_215 ( struct V_172 * V_173 , int V_248 )
{
if ( ( V_247 & V_249 ) && F_216 ( V_173 ) )
return 1 ;
if ( ( V_247 & V_250 ) && F_217 ( V_173 ) )
return 1 ;
if ( ! ( V_247 & V_251 ) )
return 0 ;
if ( ! F_177 ( V_173 ) ) {
...
return V_256 >= F_219 ( & V_173 -> V_147 ) ;
}
return 1 ;
}
static int T_1 F_220 ( int V_246 )
{
struct V_172 * V_173 = NULL ;
int V_86 ;
V_86 = F_208 ( V_246 ) ;
...
if ( F_215 ( V_173 , 1 ) ) {
F_42 ( V_35 L_37 ,
V_246 ? L_38 : L_39 , F_198 ( V_173 ) ) ;
V_86 = F_214 ( V_232 , V_173 ,
V_246 ? V_192 :
V_193 ) ;
if ( V_86 )
return V_86 ;
...
static struct V_46 * F_233 ( struct V_265 * V_147 ,
struct V_55 * V_56 ,
unsigned long V_266 , V_31 V_256 )
{
struct V_172 * V_173 = F_234 ( V_147 ) ;
struct V_46 * V_46 = NULL ;
V_256 = F_235 ( V_31 , F_236 ( V_56 -> V_107 ) , V_256 ) ;
if ( ! V_37 && V_256 > F_237 ( 32 ) ) {
V_46 = F_238 ( & V_56 -> V_187 , V_266 ,
F_157 ( F_237 ( 32 ) ) , 1 ) ;
if ( V_46 )
return V_46 ;
}
V_46 = F_238 ( & V_56 -> V_187 , V_266 , F_157 ( V_256 ) , 1 ) ;
if ( F_172 ( ! V_46 ) ) {
F_42 ( V_141 L_48 ,
V_266 , F_198 ( V_173 ) ) ;
return NULL ;
...
static struct V_55 * F_239 ( struct V_172 * V_173 )
{
struct V_55 * V_56 ;
int V_86 ;
V_56 = F_196 ( V_173 ,
...
static inline struct V_55 * F_240 ( struct V_172 * V_147 )
{
struct V_142 * V_144 ;
...
static int F_241 ( struct V_172 * V_173 )
{
return V_173 -> V_147 . V_225 . V_49 == V_240 ;
}
static int F_242 ( struct V_265 * V_147 )
{
struct V_172 * V_173 ;
int V_143 ;
...
static V_218 F_244 ( struct V_265 * V_268 , T_6 V_269 ,
T_5 V_82 , int V_270 , V_23 V_256 )
{
struct V_172 * V_173 = F_234 ( V_268 ) ;
struct V_55 * V_56 ;
T_6 V_271 ;
struct V_46 * V_46 ;
int V_30 = 0 ;
...
V_46 = F_233 ( V_268 , V_56 , F_10 ( V_82 ) , V_256 ) ;
if ( ! V_46 )
goto error;
...
error:
if ( V_46 )
F_246 ( & V_56 -> V_187 , V_46 ) ;
F_42 ( V_141 L_53 ,
F_198 ( V_173 ) , V_82 , ( unsigned long long ) V_269 , V_270 ) ;
return 0 ;
}
static V_218 F_247 ( struct V_265 * V_147 , struct V_12 * V_12 ,
unsigned long V_92 , T_5 V_82 ,
enum V_278 V_270 ,
struct V_279 * V_280 )
{
return F_244 ( V_147 , F_183 ( V_12 ) + V_92 , V_82 ,
V_270 , F_234 ( V_147 ) -> V_256 ) ;
}
...
F_246 ( & V_258 [ V_64 ] . V_56 [ V_281 ] -> V_187 , V_46 ) ;
}
V_258 [ V_64 ] . V_222 = 0 ;
}
V_284 = 0 ;
...
static void F_249 ( struct V_55 * V_287 , struct V_46 * V_46 )
{
unsigned long V_58 ;
int V_222 , V_57 ;
struct V_48 * V_49 ;
...
V_258 [ V_57 ] . V_222 ++ ;
if ( ! V_282 ) {
F_250 ( & V_289 , V_290 + F_251 ( 10 ) ) ;
V_282 = 1 ;
}
V_284 ++ ;
F_80 ( & V_286 , V_58 ) ;
}
static void F_252 ( struct V_265 * V_147 , V_218 V_291 ,
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_253 ( & V_56 -> V_187 , F_157 ( V_291 ) ) ;
if ( F_254 ( ! V_46 , L_54 ,
...
static void * F_255 ( struct V_265 * V_268 , T_5 V_82 ,
...
if ( ! F_242 ( V_268 ) )
V_58 &= ~ ( V_293 | V_294 ) ;
else if ( V_268 -> V_257 < F_219 ( V_268 ) ) {
if ( V_268 -> V_257 < F_237 ( 32 ) )
V_58 |= V_293 ;
else
V_58 |= V_294 ;
}
V_41 = ( void * ) F_257 ( V_58 , V_105 ) ;
if ( ! V_41 )
return NULL ;
memset ( V_41 , 0 , V_82 ) ;
* V_292 = F_244 ( V_268 , F_258 ( V_41 ) , V_82 ,
V_275 ,
V_268 -> V_257 ) ;
if ( * V_292 )
return V_41 ;
F_259 ( ( unsigned long ) V_41 , V_105 ) ;
return NULL ;
}
static void F_260 ( struct V_265 * V_268 , T_5 V_82 , void * V_41 ,
V_218 V_292 )
{
int V_105 ;
V_82 = F_180 ( V_82 ) ;
V_105 = F_256 ( V_82 ) ;
F_252 ( V_268 , V_292 , V_82 , V_275 , NULL ) ;
F_259 ( ( unsigned long ) V_41 , V_105 ) ;
}
static void F_261 ( struct V_265 * V_268 , struct V_208 * V_295 ,
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_253 ( & V_56 -> V_187 , F_157 ( V_295 [ 0 ] . V_217 ) ) ;
if ( F_254 ( ! V_46 , L_56 ,
...
static int F_262 ( struct V_265 * V_297 ,
struct V_208 * V_295 , int V_296 , int V_270 )
{
int V_64 ;
struct V_208 * V_209 ;
F_263 (sglist, sg, nelems, i) {
F_62 ( ! F_184 ( V_209 ) ) ;
...
static int F_264 ( struct V_265 * V_268 , struct V_208 * V_295 , int V_296 ,
...
F_62 ( V_270 == V_273 ) ;
if ( F_242 ( V_268 ) )
return F_262 ( V_268 , V_295 , V_296 , V_270 ) ;
V_56 = F_240 ( V_173 ) ;
if ( ! V_56 )
return 0 ;
V_49 = F_61 ( V_56 ) ;
...
V_46 = F_233 ( V_268 , V_56 , F_10 ( V_82 ) ,
V_173 -> V_256 ) ;
if ( ! V_46 ) {
V_295 -> V_219 = 0 ;
return 0 ;
...
static int F_265 ( struct V_265 * V_147 , V_218 V_299 )
{
return ! V_299 ;
}
...
static void T_1 F_272 ( void )
{
F_271 ( V_45 ) ;
F_271 ( V_44 ) ;
F_271 ( V_47 ) ;
}
static void F_273 ( struct V_172 * V_173 )
{
struct V_68 * V_69 ;
T_3 V_302 ;
int V_303 ;
V_303 = F_274 ( V_173 -> V_73 , F_275 ( 0 , 0 ) , 0xb0 , & V_302 ) ;
if ( V_303 ) {
F_276 ( & V_173 -> V_147 , L_63 ) ;
return;
}
V_302 &= 0xffff0000 ;
V_69 = F_197 ( V_173 ) ;
if ( F_277 ( ! V_69 || V_69 -> V_260 - V_302 != 0xa000 ,
V_304 ,
L_64 ) )
V_173 -> V_147 . V_225 . V_49 = V_240 ;
}
static void T_1 F_278 ( void )
{
struct V_68 * V_69 ;
F_75 (drhd) {
if ( ! V_69 -> V_80 ) {
...
unsigned long V_111 ;
F_70 (iommu, drhd) {
V_49 -> V_306 = F_223 ( sizeof( T_3 ) * V_307 ,
V_42 ) ;
if ( ! V_49 -> V_306 )
goto V_308;
}
...
static void T_1 F_286 ( void )
{
F_287 ( & V_317 ) ;
}
static inline void F_286 ( void ) {}
static void T_1 F_288 ( struct V_238 * V_239 )
{
F_199 ( & V_239 -> V_318 , & V_319 ) ;
}
int T_1 F_289 ( struct V_320 * V_321 )
{
struct V_322 * V_239 ;
struct V_238 * V_323 ;
V_323 = F_223 ( sizeof( * V_323 ) , V_166 ) ;
if ( ! V_323 )
return - V_108 ;
V_323 -> V_324 = V_321 ;
...
static int T_1
F_290 ( struct V_238 * V_323 )
{
struct V_322 * V_239 ;
int V_86 ;
V_239 = (struct V_322 * ) V_323 -> V_324 ;
V_86 = F_291 ( ( void * ) ( V_239 + 1 ) ,
...
int T_1 F_292 ( struct V_320 * V_324 )
{
struct V_325 * V_326 ;
struct V_327 * V_328 ;
V_326 = F_293 ( V_324 , struct V_325 , V_321 ) ;
V_328 = F_223 ( sizeof( * V_328 ) , V_166 ) ;
if ( ! V_328 )
return - V_108 ;
V_328 -> V_324 = V_324 ;
V_328 -> V_80 = V_326 -> V_58 & 0x1 ;
F_199 ( & V_328 -> V_318 , & V_329 ) ;
return 0 ;
}
static int T_1 F_294 ( struct V_327 * V_328 )
{
int V_303 ;
struct V_325 * V_326 ;
if ( V_328 -> V_80 )
return 0 ;
V_326 = F_293 ( V_328 -> V_324 , struct V_325 , V_321 ) ;
V_303 = F_291 ( ( void * ) ( V_326 + 1 ) ,
...
int V_86 = 0 ;
F_297 (rmrr, rmrr_n, &dmar_rmrr_units, list) {
V_86 = F_290 ( V_239 ) ;
if ( V_86 )
return V_86 ;
}
F_297 (atsr, atsr_n, &dmar_atsr_units, list) {
V_86 = F_294 ( V_326 ) ;
if ( V_86 )
return V_86 ;
}
...
static int F_298 ( struct V_335 * V_336 ,
...
static void F_307 ( struct V_48 * V_49 ,
struct V_172 * V_173 )
{
struct V_172 * V_106 , * V_91 ;
if ( ! V_49 || ! V_173 )
...
static void F_243 ( struct V_55 * V_56 ,
struct V_172 * V_173 )
{
struct V_142 * V_144 ;
struct V_48 * V_49 ;
...
return;
F_79 ( & V_146 , V_58 ) ;
F_308 (entry, tmp, &domain->devices) {
V_144 = F_193 ( V_347 , struct V_142 , V_223 ) ;
...
static void F_309 ( struct V_55 * V_56 )
{
struct V_142 * V_144 ;
struct V_48 * V_49 ;
...
static int F_209 ( struct V_55 * V_56 , int V_188 )
{
int V_189 ;
F_154 ( & V_56 -> V_187 , V_175 ) ;
F_138 ( & V_56 -> V_167 ) ;
...
static int F_313 ( struct V_353 * V_56 )
{
struct V_55 * V_55 ;
V_55 = F_311 () ;
if ( ! V_55 ) {
...
static void F_314 ( struct V_353 * V_56 )
{
struct V_55 * V_55 = V_56 -> V_354 ;
V_56 -> V_354 = NULL ;
F_143 ( V_55 ) ;
}
static int F_315 ( struct V_353 * V_56 ,
struct V_265 * V_147 )
{
struct V_55 * V_55 = V_56 -> V_354 ;
struct V_172 * V_173 = F_234 ( V_147 ) ;
...
return F_214 ( V_55 , V_173 , V_193 ) ;
}
static void F_316 ( struct V_353 * V_56 ,
struct V_265 * V_147 )
{
struct V_55 * V_55 = V_56 -> V_354 ;
struct V_172 * V_173 = F_234 ( V_147 ) ;
...
if ( V_359 & V_361 )
V_30 |= V_28 ;
if ( ( V_359 & V_362 ) && V_55 -> V_67 )
V_30 |= V_29 ;
V_82 = V_190 << V_358 ;
V_352 = V_46 + V_82 ;
if ( V_55 -> V_352 < V_352 ) {
V_23 V_186 ;
V_186 = F_318 ( V_55 -> V_107 ) + 1 ;
if ( V_186 < V_352 ) {
F_42 ( V_141 L_78
L_79 ,
...
static int F_319 ( struct V_353 * V_56 ,
unsigned long V_46 , int V_358 )
{
struct V_55 * V_55 = V_56 -> V_354 ;
T_5 V_82 = V_190 << V_358 ;
int V_105 ;
...
static T_6 F_320 ( struct V_353 * V_56 ,
unsigned long V_46 )
{
struct V_55 * V_55 = V_56 -> V_354 ;
struct V_25 * V_26 ;
...
static int F_321 ( struct V_353 * V_56 ,
unsigned long V_52 )
{
struct V_55 * V_55 = V_56 -> V_354 ;
if ( V_52 == V_364 )
...
static void T_8 F_322 ( struct V_172 * V_147 )
{
F_42 ( V_35 L_80 ) ;
V_121 = 1 ;
if ( V_147 -> V_367 == 0x07 ) {
...
static void T_8 F_323 ( struct V_172 * V_147 )
{
unsigned short V_368 ;
if ( F_324 ( V_147 , V_369 , & V_368 ) )
return;
if ( ! ( V_368 & V_370 ) ) {
F_42 ( V_35 L_82 ) ;
V_36 = 0 ;
...
static void T_1 F_229 ( void )
{
struct V_172 * V_173 ;
T_9 V_371 ;
V_173 = F_325 ( V_372 , 0x3a3e , NULL ) ;
if ( ! V_173 )
return;
F_326 ( V_173 ) ;
V_173 = F_325 ( V_372 , 0x342e , NULL ) ;
if ( ! V_173 )
return;
if ( F_327 ( V_173 , 0x188 , & V_371 ) ) {
F_326 ( V_173 ) ;
return;
}
F_326 ( V_173 ) ;
