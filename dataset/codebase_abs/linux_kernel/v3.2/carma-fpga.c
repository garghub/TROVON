...
F_10 ( & V_4 -> V_68 ) ;
F_96 ( & V_4 -> V_69 ) ;
V_4 -> V_128 . V_169 = V_170 ;
V_4 -> V_128 . V_171 = V_107 ;
V_4 -> V_128 . V_172 = & V_173 ;
V_11 = F_97 ( V_165 , 0 , & V_168 ) ;
if ( V_11 ) {
...
V_4 -> V_156 = F_98 ( & V_168 ) ;
V_4 -> V_51 = F_99 ( V_165 , 0 ) ;
if ( ! V_4 -> V_51 ) {
...
V_4 -> V_90 = F_103 ( V_165 , 0 ) ;
if ( V_4 -> V_90 == V_182 ) {
F_21 ( & V_163 -> V_21 , L_42 ) ;
V_11 = - V_174 ;
goto V_183;
}
F_31 ( V_98 , V_4 -> V_51 + V_184 ) ;
...
V_166 = V_4 -> V_128 . V_166 ;
F_92 ( V_166 , V_4 ) ;
V_11 = F_105 ( & V_166 -> V_187 , & V_188 ) ;
if ( V_11 ) {
...
struct V_83 * V_166 = V_4 -> V_128 . V_166 ;
F_112 ( & V_166 -> V_187 , & V_188 ) ;
F_71 ( V_4 ) ;
F_54 ( V_4 ) ;
F_107 ( & V_4 -> V_128 ) ;
F_108 ( V_4 -> V_90 ) ;
