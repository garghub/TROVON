...
static int F_24 ( unsigned int V_100 , unsigned int V_101 ,
struct V_102 * V_103 )
{
unsigned long long V_104 ;
unsigned int V_105 , V_106 , V_107 ;
F_25 ( L_5 , V_100 , V_101 ) ;
V_101 *= 4 ;
V_106 = V_101 / V_100 ;
if ( V_106 < 6 ) {
V_100 >>= 1 ;
...
static int F_28 ( struct V_39 * V_40 , int V_112 ,
...
static int F_31 ( struct V_1 * V_2 , T_2 V_130 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
V_4 -> V_129 ( V_2 , V_84 ) ;
return 0 ;
...
if ( V_22 -> V_131 > V_132 ) {
F_36 ( V_2 -> V_11 , L_9 , V_22 -> V_131 ) ;
V_22 -> V_131 = 0 ;
}
if ( V_22 -> V_30 )
V_4 -> V_129 = F_23 ;
}
V_115 = F_37 ( V_2 , 7 , 9 , V_4 -> V_133 ) ;
if ( V_115 < 0 ) {
F_36 ( V_2 -> V_11 , L_10 , V_115 ) ;
return V_115 ;
}
V_115 = F_38 ( V_2 ) ;
if ( V_115 < 0 ) {
...
V_4 -> V_129 ( V_2 , V_82 ) ;
V_78 = F_16 ( V_2 , V_134 ) ;
F_14 ( V_2 , V_134 , V_78 | 0x100 ) ;
V_78 = F_16 ( V_2 , V_135 ) ;
F_14 ( V_2 , V_135 , V_78 | 0x100 ) ;
V_78 = F_16 ( V_2 , V_136 ) ;
F_14 ( V_2 , V_136 , V_78 | 0x100 ) ;
V_78 = F_16 ( V_2 , V_137 ) ;
F_14 ( V_2 , V_137 , V_78 | 0x100 ) ;
V_78 = F_16 ( V_2 , V_138 ) ;
F_14 ( V_2 , V_138 , V_78 | 0x100 ) ;
V_78 = F_16 ( V_2 , V_139 ) ;
F_14 ( V_2 , V_139 , V_78 | 0x100 ) ;
V_78 = F_16 ( V_2 , V_140 ) ;
...
static T_3 int F_41 ( struct V_145 * V_146 ,
const struct V_147 * V_148 )
{
struct V_3 * V_4 ;
int V_115 ;
V_4 = F_42 ( sizeof( struct V_3 ) , V_149 ) ;
if ( V_4 == NULL )
return - V_150 ;
F_43 ( V_146 , V_4 ) ;
V_4 -> V_133 = V_151 ;
V_115 = F_44 ( & V_146 -> V_11 ,
& V_152 , & V_153 , 1 ) ;
if ( V_115 < 0 )
F_45 ( V_4 ) ;
return V_115 ;
}
static T_4 int F_46 ( struct V_145 * V_154 )
{
F_47 ( & V_154 -> V_11 ) ;
F_45 ( F_48 ( V_154 ) ) ;
return 0 ;
