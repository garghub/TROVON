...
struct V_125 * V_126 = (struct V_125 * ) ( F_19 ( V_15 ) +
V_123 ) ;
struct V_122 * V_127 = (struct V_122 * ) ( V_126 + 1 ) ;
if ( V_121 ) {
V_58 -> V_65 = V_13 -> V_47 . V_67 ;
F_58 ( V_58 ) ;
V_127 -> V_68 = V_13 -> V_47 . V_67 ;
F_58 ( V_127 ) ;
} else {
V_58 -> V_68 = V_13 -> V_68 . V_67 ;
F_58 ( V_58 ) ;
V_127 -> V_65 = V_13 -> V_68 . V_67 ;
F_58 ( V_127 ) ;
}
...
struct V_134 * V_126 = (struct V_134 * ) ( F_19 ( V_15 ) +
V_123 ) ;
struct V_133 * V_127 = (struct V_133 * ) ( V_126 + 1 ) ;
if ( V_121 ) {
V_58 -> V_65 = V_13 -> V_47 . V_64 ;
V_127 -> V_68 = V_13 -> V_47 . V_64 ;
} else {
V_58 -> V_68 = V_13 -> V_68 . V_64 ;
V_127 -> V_65 = V_13 -> V_68 . V_64 ;
}
...
V_126 -> V_136 = ~ F_68 ( & V_58 -> V_65 , & V_58 -> V_68 ,
V_15 -> V_30 - V_123 ,
V_8 , 0 ) ;
V_15 -> V_137 = F_19 ( V_15 ) - V_15 -> V_138 + V_123 ;
...
L_28 ) ;
V_108 += V_150 -> V_124 * 4 ;
F_18 ( V_132 , V_150 , & V_127 ) ;
V_13 = V_41 -> V_157 ( V_132 , V_15 , & V_127 , V_108 , 1 ) ;
if ( ! V_13 )
return V_102 ;
V_62 . V_67 = V_58 -> V_65 ;
return F_70 ( V_132 , V_15 , & V_62 , V_150 -> V_43 , V_13 ,
V_41 , V_108 , V_124 ) ;
}
...
return V_102 ;
F_34 ( 11 , V_63 , V_41 , V_15 , V_108 ,
L_30 ) ;
V_108 += sizeof( struct V_133 ) ;
F_18 ( V_63 , V_150 , & V_127 ) ;
V_13 = V_41 -> V_157 ( V_63 , V_15 , & V_127 , V_108 , 1 ) ;
if ( ! V_13 )
return V_102 ;
F_84 ( & V_62 . V_64 , & V_58 -> V_65 ) ;
return F_70 ( V_63 , V_15 , & V_62 , V_150 -> V_135 , V_13 ,
...
static inline int F_86 ( const struct V_14 * V_15 , int V_162 )
{
...
struct V_177 * V_178 = F_92 ( V_15 -> V_174 ) ;
...
if ( F_14 ( V_13 ) )
return F_87 ( V_51 , V_15 , V_40 , V_13 , V_58 . V_30 ) ;
if ( F_50 ( V_36 ) &&
( V_41 -> V_43 == V_5 ||
V_41 -> V_43 == V_4 ||
V_41 -> V_43 == V_6 ) ) {
...
static unsigned int
F_95 ( unsigned int V_110 , struct V_14 * V_15 ,
...
int (* F_96)( struct V_14 * ) )
{
return F_90 ( V_110 , V_15 , V_63 ) ;
}
static unsigned int
F_101 ( unsigned int V_110 , struct V_14 * V_15 ,
const struct V_183 * V_184 , const struct V_183 * V_142 ,
int (* F_96)( struct V_14 * ) )
{
unsigned int V_141 ;
F_98 () ;
V_141 = F_90 ( V_110 , V_15 , V_63 ) ;
F_99 () ;
return V_141 ;
}
static int
F_102 ( struct V_14 * V_15 , int * V_146 , unsigned int V_110 )
{
struct V_36 * V_36 = NULL ;
struct V_122 * V_58 ;
struct V_125 V_147 , * V_148 ;
...
V_108 += 2 * sizeof( V_143 ) ;
V_141 = F_103 ( V_15 , V_13 , V_41 , V_108 , V_110 ) ;
V_142:
F_35 ( V_13 ) ;
return V_141 ;
}
static int
F_104 ( struct V_14 * V_15 , int * V_146 , unsigned int V_110 )
{
struct V_36 * V_36 = NULL ;
struct V_133 * V_58 ;
struct V_134 V_147 , * V_148 ;
...
V_108 += sizeof( struct V_133 ) ;
F_18 ( V_63 , V_150 , & V_127 ) ;
V_13 = V_41 -> V_87 ( V_63 , V_15 , & V_127 , V_108 , 1 ) ;
if ( ! V_13 )
return V_102 ;
F_5 ( V_13 , V_15 ) ;
...
V_6 == V_150 -> V_135 )
V_108 += 2 * sizeof( V_143 ) ;
V_141 = F_105 ( V_15 , V_13 , V_41 , V_108 , V_110 ) ;
F_35 ( V_13 ) ;
return V_141 ;
}
static unsigned int
F_106 ( unsigned int V_110 , struct V_14 * V_15 , int V_51 )
{
struct V_36 * V_36 ;
struct V_57 V_58 ;
struct V_81 * V_41 ;
...
if ( F_80 ( V_58 . V_43 == V_8 ) ) {
int V_146 ;
int V_141 = F_104 ( V_15 , & V_146 , V_110 ) ;
if ( V_146 )
return V_141 ;
F_18 ( V_51 , F_19 ( V_15 ) , & V_58 ) ;
}
...
if ( F_80 ( V_58 . V_43 == V_7 ) ) {
int V_146 ;
int V_141 = F_102 ( V_15 , & V_146 , V_110 ) ;
if ( V_146 )
return V_141 ;
F_18 ( V_51 , F_19 ( V_15 ) , & V_58 ) ;
}
...
if ( ! F_6 ( V_36 ) -> V_182 )
return V_102 ;
return F_102 ( V_15 , & V_203 , V_110 ) ;
}
static unsigned int
F_118 ( unsigned int V_110 , struct V_14 * V_15 ,
const struct V_183 * V_184 , const struct V_183 * V_142 ,
int (* F_96)( struct V_14 * ) )
{
int V_203 ;
...
if ( ! F_6 ( V_36 ) -> V_182 )
return V_102 ;
return F_104 ( V_15 , & V_203 , V_110 ) ;
}
static int T_6 F_119 ( struct V_36 * V_36 )
{
struct V_18 * V_19 ;
V_19 = F_120 ( V_36 , V_204 ) ;
if ( V_19 == NULL )
return - V_205 ;
V_19 -> V_182 = 0 ;
V_19 -> V_36 = V_36 ;
