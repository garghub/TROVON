...
static struct V_48 * F_19 ( struct V_1 * V_2 ,
struct V_60 * V_61 )
{
struct V_48 * V_49 ;
...
static T_2
F_24 ( struct V_1 * V_2 , struct V_48 * V_49 , char * V_75 )
{
char * V_76 = V_75 ;
V_76 += sprintf ( V_76 , L_5 , V_49 -> V_50 , V_49 -> V_52 ,
( V_49 -> V_50 & V_77 ) ? 1 : 0 ) ;
return V_76 - V_75 ;
}
static T_2
F_25 ( struct V_1 * V_2 , char * V_75 , T_2 V_78 )
{
char * V_76 = V_75 ;
F_26 ( V_79 ) ;
F_26 ( V_80 ) ;
...
int V_98 ;
T_1 * V_76 = V_2 -> V_99 ;
for ( V_98 = 0 ; V_98 < ( V_100 / sizeof( T_1 ) ) ; V_98 ++ ) {
V_76 [ V_98 ] = F_2 ( V_2 , V_98 * sizeof( T_1 ) ) ;
F_12 ( V_2 -> V_22 , L_6 , V_63 , V_98 , V_76 [ V_98 ] ) ;
}
F_28 ( V_76 [ 0 ] != V_101 ) ;
}
...
T_1 * V_76 = V_2 -> V_99 ;
for ( V_98 = 0 ; V_98 < ( V_100 / sizeof( T_1 ) ) ; V_98 ++ ) {
F_3 ( V_2 , V_76 [ V_98 ] , V_98 * sizeof( T_1 ) ) ;
F_12 ( V_2 -> V_22 , L_6 , V_63 , V_98 , V_76 [ V_98 ] ) ;
}
F_28 ( V_76 [ 0 ] != V_101 ) ;
}
...
V_61 -> V_12 = V_49 -> V_52 & V_102 ;
V_61 -> V_68 = V_49 -> V_50 & V_54 ;
V_61 -> V_62 = V_49 -> V_50 & V_58 ;
V_61 -> V_69 = V_49 -> V_52 & V_103 ;
V_61 -> V_70 = V_49 -> V_52 & V_104 ;
V_61 -> V_71 = V_49 -> V_52 & V_105 ;
}
