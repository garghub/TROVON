...
unsigned int F_7 ( unsigned char * V_1 ,
...
int F_29 ( struct V_27 * V_28 , unsigned int V_56 )
{
int V_57 ;
int V_85 = F_35 ( V_56 ) ;
if ( F_36 ( V_56 ) )
...
int F_39 ( struct V_27 * V_28 , char V_56 )
{
return F_29 ( V_28 , V_56 ) ;
}
static void F_40 ( struct V_91 * V_92 )
{
if ( V_92 -> V_93 ) {
while ( V_92 -> V_94 -- )
F_41 ( V_92 -> V_93 [ V_92 -> V_94 ] ) ;
F_42 ( V_92 -> V_93 ) ;
V_92 -> V_93 = NULL ;
}
#if 0
...
int F_43 ( struct V_91 * V_92 , struct V_96 * V_95 ,
unsigned V_56 , unsigned V_97 , struct V_9 * V_10 ,
int V_98 , T_3 V_16 , T_4 V_99 )
{
return F_44 ( V_92 , V_95 , V_56 , V_97 , V_10 , V_98 , V_16 , V_99 ) ;
}
int F_45 ( struct V_91 * V_92 , int V_29 )
{
long V_34 ;
int V_100 ;
int V_94 = V_92 -> V_94 ;
...
V_16 , V_107 ) ;
V_57 =
F_43 ( & V_28 -> V_32 -> V_109 , V_28 -> V_32 -> V_84 , V_56 , 0 ,
...
F_22 ( L_19 ) ;
F_51 ( & V_28 -> V_32 -> V_109 ) ;
}
}
V_57 = F_45 ( & V_28 -> V_32 -> V_109 , V_29 ) ;
...
int F_53 ( struct V_27 * V_28 , unsigned int V_56 ,
void * V_112 , unsigned int V_16 ,
unsigned int * V_108 , int V_29 )
{
int V_57 ;
F_54 ( V_28 -> V_32 -> V_83 , V_28 -> V_32 -> V_84 , V_56 ,
...
V_57 =
F_53 ( V_28 , V_56 , V_112 , V_113 , V_108 ,
V_29 ) ;
}
return V_57 ;
}
int F_56 ( struct V_27 * V_28 , unsigned int V_56 ,
...
V_57 =
F_53 ( V_28 , V_56 , V_115 , V_113 , V_108 ,
V_29 ) ;
if ( V_57 == V_60 ) {
if ( F_36 ( V_56 ) ) {
...
V_118 = * V_5 ;
V_57 =
F_53 ( V_28 , V_56 , V_112 + V_118 , V_113 ,
V_108 , V_29 ) ;
if ( V_108 )
V_118 += * V_108 ;
else
...
int F_59 ( struct V_27 * V_28 , T_2 * V_35 )
{
unsigned int V_56 = F_60 ( V_28 ) ;
struct V_119 * V_120 ;
struct V_24 V_33 ;
int V_57 ;
if ( ! V_35 )
...
F_61 ( V_28 -> V_32 -> V_122 , V_28 -> V_32 -> V_84 , V_56 ,
V_35 , 2 , F_13 , & V_33 , 1 ) ;
V_57 = F_15 ( V_28 , V_28 -> V_32 -> V_122 , 50 ) ;
return F_27 ( V_28 , V_56 , 2 , V_57 ,
V_28 -> V_32 -> V_122 -> V_39 ) ;
}
void F_62 ( struct V_20 * V_21 , struct V_27 * V_28 )
{
int V_57 ;
#ifdef F_63
if ( V_28 -> V_123 . V_124 ) {
...
V_21 -> V_57 = V_129 ;
memcpy ( V_21 -> V_130 ,
( unsigned char * ) & ( V_28 -> V_130 [ F_66 ( V_21 ) ] ) ,
sizeof( struct V_142 ) ) ;
}
return;
V_140:
