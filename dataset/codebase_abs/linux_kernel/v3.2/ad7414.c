...
int V_28 ;
int V_29 ;
if ( ! F_23 ( V_3 -> V_30 , V_31 |
V_32 ) ) {
V_29 = - V_33 ;
goto exit;
}
V_9 = F_24 ( sizeof( struct V_6 ) , V_34 ) ;
if ( ! V_9 ) {
V_29 = - V_35 ;
goto exit;
}
...
return 0 ;
V_41:
F_33 ( & V_3 -> V_8 . V_37 , & V_38 ) ;
V_39:
F_34 ( V_9 ) ;
exit:
return V_29 ;
}
static int T_5 F_35 ( struct V_2 * V_3 )
{
struct V_6 * V_9 = F_9 ( V_3 ) ;
F_36 ( V_9 -> V_40 ) ;
F_33 ( & V_3 -> V_8 . V_37 , & V_38 ) ;
