...
T_11 V_332 , T_12 V_190 , struct V_3 * V_4 )
{
struct V_333 * V_334 ;
struct V_335 * V_336 ;
struct V_337 * V_338 ;
...
static T_15 F_261 ( struct V_1 * V_2 )
{
T_1 V_471 ;
V_471 = F_57 ( V_2 -> V_73 ) ;
if ( ! ( V_471 & V_2 -> V_72 ) )
...
static T_15 V_248 ( int V_70 , void * V_103 )
{
struct V_7 * V_8 = V_103 ;
struct V_1 * V_2 = V_8 -> V_2 ;
if ( F_261 ( V_2 ) == V_472 )
...
static T_15 V_247 ( int V_70 , void * V_103 )
{
struct V_7 * V_8 = V_103 ;
struct V_1 * V_2 = V_8 -> V_2 ;
F_2 ( 0xffffffff , V_2 -> V_65 ) ;
...
static T_15 V_246 ( int V_70 , void * V_103 )
{
struct V_7 * V_8 = V_103 ;
F_263 ( & V_8 -> V_22 ) ;
return V_473 ;
...
static T_17 F_307 ( struct V_29 * V_30 ,
T_18 V_55 )
{
struct V_1 * V_2 = F_187 ( V_30 ) ;
struct V_17 * V_18 = V_2 -> V_18 ;
...
static T_17 F_308 ( struct V_29 * V_30 )
{
...
struct V_552 * V_553 , const char * V_554 , T_20 V_438 )
{
...
struct V_579 * V_553 ,
char * V_554 , T_21 V_376 , T_20 V_14 )
{
...
struct V_579 * V_553 , char * V_554 , T_21 V_376 , T_20 V_14 )
{
struct V_137 * V_45 = F_269 ( V_578 , struct V_137 , V_578 ) ;
struct V_1 * V_2 = F_315 ( V_45 ) ;
struct V_581 * V_582 ;
