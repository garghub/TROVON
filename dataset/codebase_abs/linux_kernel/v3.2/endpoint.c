...
static const char * F_52 ( int V_41 )
{
switch ( V_41 ) {
case - V_128 :
return L_7 ;
...
static int F_53 ( struct V_2 * V_3 , struct V_92 * V_44 )
{
unsigned int V_9 ;
int V_41 ;
if ( V_3 -> V_8 -> V_7 -> V_12 )
...
V_3 -> V_42 . V_50 = F_31 ;
F_59 ( V_140 -> V_146 , V_8 ) ;
F_60 ( & V_142 -> V_147 , & V_3 -> V_143 ) ;
V_3 -> V_148 |= V_142 -> V_148 ;
V_3 -> V_149 = V_142 -> V_149 ;
V_3 -> V_150 ++ ;
V_3 -> V_78 = V_142 -> V_78 ;
}
int F_61 ( struct V_38 * V_39 , int V_151 )
{
