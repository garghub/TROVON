...
V_29 = F_162 ( & V_2 -> V_38 -> V_370 , V_367 , 0 , F_163 ( V_367 ) ,
V_371 ) ;
V_30 = F_164 ( & V_2 -> V_38 -> V_370 , V_29 ) ;
if ( V_30 ) {
F_9 ( V_2 -> V_17 ,
L_42 ,
V_30 ) ;
...
V_355 -> V_363 = F_33 ( F_34 ( V_29 ) ) ;
V_355 -> V_364 = F_33 ( F_35 ( V_29 ) ) ;
V_355 -> V_272 = F_33 ( F_163 ( V_367 ) ) ;
F_36 ( & V_259 -> V_29 [ V_358 ] , V_43 , V_29 ) ;
F_37 ( & V_259 -> V_29 [ V_358 ] , V_44 , F_163 ( V_367 ) ) ;
}
V_355 -> V_272 |= F_33 ( V_365 ) ;
return V_366 ;
V_368:
...
static T_8 F_165 ( struct V_283 * V_34 ,
struct V_67 * V_17 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
struct V_5 T_2 * V_6 =
V_2 -> V_7 ;
struct V_258 * V_259 ;
T_1 V_372 = V_34 -> V_272 ;
struct V_342 * V_343 ;
if ( F_28 ( F_166 ( & V_2 -> V_273 ) < 2 ) )
return V_361 ;
V_259 = & V_2 -> V_262 [ V_2 -> V_373 ] ;
...
V_343 -> V_313 = V_2 -> V_375 ;
V_343 -> V_199 = V_376 ;
V_343 -> V_199 |= V_2 -> V_377 ;
V_343 -> V_263 = V_2 -> V_373 ;
V_343 -> V_378 = F_45 ( ( V_65 ) V_372 ) ;
V_259 -> V_34 = V_34 ;
if ( V_2 -> V_210 == V_211 &&
V_34 -> V_302 == V_379 )
F_156 ( V_34 , V_343 ) ;
...
& V_6 -> V_10 . V_381 ,
V_2 -> V_373 ) ;
F_86 ( V_2 , V_382 , V_16 , V_17 ,
L_45 ,
V_2 -> V_373 , V_34 -> V_272 ) ;
F_167 ( & V_2 -> V_273 ) ;
return V_366 ;
}
...
{
V_2 -> V_383 =
( T_1 ) ( V_380 * sizeof( struct V_342 ) ) ;
V_2 -> V_384 =
F_169 ( V_2 -> V_38 ,
( V_385 ) V_2 -> V_383 ,
& V_2 -> V_386 ) ;
if ( ( V_2 -> V_384 == NULL ) ||
F_34 ( V_2 -> V_386 ) & ( V_2 -> V_383 - 1 ) ) {
F_9 ( V_2 -> V_17 , L_46 ) ;
return - V_387 ;
}
V_2 -> V_388 = V_321 * sizeof( struct V_307 ) ;
V_2 -> V_322 =
F_169 ( V_2 -> V_38 ,
( V_385 ) V_2 -> V_388 ,
& V_2 -> V_389 ) ;
if ( ( V_2 -> V_322 == NULL ) ||
F_34 ( V_2 -> V_389 ) & ( V_2 -> V_388 - 1 ) ) {
F_9 ( V_2 -> V_17 , L_47 ) ;
F_170 ( V_2 -> V_38 , ( V_385 ) V_2 -> V_383 ,
V_2 -> V_384 ,
V_2 -> V_386 ) ;
return - V_387 ;
}
F_100 ( V_390 , & V_2 -> V_199 ) ;
return 0 ;
}
static void F_171 ( struct V_1 * V_2 )
{
if ( ! F_93 ( V_390 , & V_2 -> V_199 ) ) {
F_64 ( V_2 -> V_17 , L_48 ) ;
return;
}
F_170 ( V_2 -> V_38 ,
...
V_2 -> V_322 , V_2 -> V_389 ) ;
V_2 -> V_322 = NULL ;
F_101 ( V_390 , & V_2 -> V_199 ) ;
}
static int F_172 ( struct V_1 * V_2 )
{
V_2 -> V_391 =
V_2 -> V_253 * sizeof( struct V_392 ) ;
if ( V_2 -> V_391 < V_393 )
V_2 -> V_394 = V_393 ;
else
V_2 -> V_394 = V_2 -> V_391 * 2 ;
V_2 -> V_276 =
F_173 ( V_2 -> V_278 * sizeof( struct V_27 ) ,
V_395 ) ;
if ( V_2 -> V_276 == NULL ) {
F_9 ( V_2 -> V_17 , L_49 ) ;
return - V_387 ;
...
V_2 -> V_398 = V_2 -> V_397 ;
V_2 -> V_399 =
V_244 * sizeof( struct V_392 ) ;
if ( V_2 -> V_399 < V_393 )
V_2 -> V_400 = V_393 ;
else
V_2 -> V_400 = V_2 -> V_399 * 2 ;
V_2 -> V_401 =
F_169 ( V_2 -> V_38 ,
V_2 -> V_400 ,
& V_2 -> V_402 ) ;
...
V_2 -> V_403 = V_2 -> V_401 ;
V_2 -> V_404 = V_2 -> V_402 ;
F_100 ( V_405 , & V_2 -> V_199 ) ;
return 0 ;
}
static void F_174 ( struct V_1 * V_2 )
{
if ( ! F_93 ( V_405 , & V_2 -> V_199 ) ) {
F_64 ( V_2 -> V_17 , L_48 ) ;
return;
}
F_175 ( V_2 -> V_276 ) ;
...
V_2 -> V_412 = F_34 ( V_2 -> V_411 ) ;
V_2 -> V_413 = F_35 ( V_2 -> V_411 ) ;
V_406 = V_2 -> V_403 ;
for ( V_12 = 0 ; V_12 < ( V_408 * V_244 ) ; V_12 ++ ) {
V_406 -> V_250 =
F_33 ( V_2 -> V_413 ) ;
V_406 -> V_251 =
F_33 ( V_2 -> V_412 +
...
V_2 -> V_274 = 0 ;
F_100 ( V_414 , & V_2 -> V_199 ) ;
return 0 ;
}
static void F_177 ( struct V_1 * V_2 )
{
if ( ! F_93 ( V_414 , & V_2 -> V_199 ) ) {
F_64 ( V_2 -> V_17 , L_48 ) ;
return;
}
if ( V_2 -> V_410 != NULL ) {
...
int V_12 ;
struct V_27 * V_28 ;
struct V_246 * V_415 = V_2 -> V_254 ;
for ( V_12 = 0 ; V_12 < V_2 -> V_278 ; V_12 ++ ) {
V_28 = & V_2 -> V_276 [ V_12 ] ;
V_415 -> V_250 = V_28 -> V_42 ;
V_415 -> V_251 = V_28 -> V_41 ;
V_415 ++ ;
}
V_2 -> V_277 = 0 ;
V_2 -> V_36 = 0 ;
...
struct V_258 * V_259 ;
int V_12 ;
struct V_342 * V_416 = V_2 -> V_384 ;
for ( V_12 = 0 ; V_12 < V_380 ; V_12 ++ ) {
V_259 = & V_2 -> V_262 [ V_12 ] ;
V_259 -> V_34 = NULL ;
V_259 -> V_374 = V_416 ;
V_416 ++ ;
V_259 -> V_354 = F_173 ( 512 , V_395 ) ;
if ( V_259 -> V_354 == NULL )
return - 1 ;
}
return 0 ;
...
{
if ( V_2 -> V_17 -> V_417 == V_418 ) {
V_2 -> V_253 = V_419 ;
V_2 -> V_35 = V_418 ;
} else if ( V_2 -> V_17 -> V_417 == V_420 ) {
V_2 -> V_253 = V_421 ;
V_2 -> V_35 = V_420 ;
} else {
F_9 ( V_2 -> V_17 , L_54 ,
V_2 -> V_17 -> V_417 , V_418 , V_420 ) ;
return - V_387 ;
}
V_2 -> V_278 =
V_2 -> V_253 * V_408 ;
...
V_8 = V_2 -> V_74 . V_492 ;
F_21 ( V_2 , & V_6 -> V_493 , V_8 ) ;
V_8 = ( 0xFFFF << 16 ) | V_2 -> V_74 . V_494 ;
if ( F_1 ( V_2 , V_495 ,
( V_14 | ( V_2 -> V_15 )
* 2 ) << 13 ) ) {
V_214 = - 1 ;
...
V_526 = ( T_5 ) ( ( V_8 >> 4 ) & V_527 ) ;
V_525 = F_16 ( V_2 , & V_6 -> V_157 ) ;
switch ( V_8 & V_528 ) {
case V_529 :
V_2 -> V_15 = 0 ;
V_2 -> V_375 = V_530 | V_526 ;
V_2 -> V_377 = V_531 ;
V_2 -> V_87 = V_532 ;
if ( V_525 & V_155 )
...
V_2 -> V_83 = V_2 -> V_74 . V_538 >> 8 ;
}
static void F_192 ( struct V_67 * V_17 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
struct V_539 * V_38 = V_2 -> V_38 ;
F_64 ( V_17 ,
L_65 ,
V_540 , V_2 -> V_73 , V_2 -> V_541 ,
V_2 -> V_210 == V_211 ? L_66 : L_67 ,
V_2 -> V_542 ) ;
F_64 ( V_17 , L_68 ,
F_93 ( V_209 , & V_2 -> V_199 ) ? L_69 : L_70 ) ;
F_64 ( V_17 , L_71 ,
( ( V_2 -> V_543 == 64 ) ? L_72 : L_73 ) ,
( ( V_2 -> V_544 ) ? L_74 : L_75 ) ) ;
F_64 ( V_17 , L_76 ,
V_2 -> V_7 ) ;
F_64 ( V_17 , L_77 , V_38 -> V_327 ) ;
F_78 ( V_2 , V_545 , V_17 , L_78 , V_17 -> V_70 ) ;
}
static int F_193 ( struct V_1 * V_2 , int V_546 )
{
struct V_67 * V_17 = V_2 -> V_17 ;
int V_260 = 0 ;
F_147 ( V_17 ) ;
F_148 ( V_17 ) ;
F_101 ( V_547 , & V_2 -> V_199 ) ;
F_101 ( V_198 , & V_2 -> V_199 ) ;
F_24 ( V_2 ) ;
F_194 ( V_2 -> V_38 -> V_327 , V_17 ) ;
if ( V_2 -> V_548 && F_93 ( V_549 , & V_2 -> V_199 ) ) {
F_64 ( V_2 -> V_17 , L_79 ) ;
F_101 ( V_549 , & V_2 -> V_199 ) ;
F_195 ( V_2 -> V_38 ) ;
}
F_196 ( & V_2 -> V_206 ) ;
F_197 ( & V_2 -> V_324 ) ;
...
F_64 ( V_17 , L_85 ) ;
F_100 ( V_549 , & V_2 -> V_199 ) ;
V_551 &= ~ V_552 ;
}
}
V_30 = F_200 ( V_2 -> V_38 -> V_327 , F_145 ,
V_551 , V_17 -> V_125 , V_17 ) ;
if ( V_30 ) {
F_9 ( V_17 ,
L_86 ,
V_2 -> V_38 -> V_327 ) ;
...
static int F_202 ( struct V_1 * V_2 , int V_556 )
{
if ( F_193 ( V_2 , V_556 ) || F_198 ( V_2 ) ) {
F_9 ( V_2 -> V_17 ,
L_90 ) ;
F_203 () ;
F_204 ( V_2 -> V_17 ) ;
...
static int F_206 ( struct V_67 * V_17 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
while ( ! F_93 ( V_547 , & V_2 -> V_199 ) )
F_189 ( 50 ) ;
F_193 ( V_2 , V_557 ) ;
return 0 ;
}
static int F_207 ( struct V_67 * V_17 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
return F_198 ( V_2 ) ;
}
static int F_208 ( struct V_67 * V_17 , void * V_69 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
struct V_5 T_2 * V_6 =
V_2 -> V_7 ;
struct V_558 * V_68 = V_69 ;
unsigned long V_23 ;
if ( F_209 ( V_17 ) )
return - V_559 ;
if ( ! F_210 ( V_68 -> V_560 ) )
return - V_561 ;
memcpy ( V_17 -> V_70 , V_68 -> V_560 , V_17 -> V_562 ) ;
F_12 ( & V_2 -> V_24 , V_23 ) ;
F_21 ( V_2 , & V_6 -> V_502 ,
( V_503 << 16 ) ) ;
F_21 ( V_2 , & V_6 -> V_504 ,
...
static void F_211 ( struct V_67 * V_17 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
F_9 ( V_17 , L_91 ) ;
F_147 ( V_17 ) ;
F_149 ( V_2 -> V_337 , & V_2 -> V_563 , 0 ) ;
}
static void F_212 ( struct V_201 * V_202 )
{
struct V_1 * V_2 =
...
F_124 ( & V_259 -> V_29 [ 0 ] , V_44 ) ,
V_269 ) ;
for ( V_564 = 1 ; V_564 < V_259 -> V_267 ; V_564 ++ ) {
F_125 ( V_2 -> V_38 ,
F_123 ( & V_259 -> V_29 [ V_564 ] ,
V_43 ) ,
F_124 ( & V_259 -> V_29 [ V_564 ] ,
V_44 ) ,
V_269 ) ;
}
F_32 ( V_259 -> V_34 ) ;
...
static void F_213 ( struct V_201 * V_202 )
{
struct V_1 * V_2 =
F_97 ( V_202 , struct V_1 , V_563 . V_202 ) ;
F_202 ( V_2 , V_557 ) ;
}
...
V_2 -> V_544 = 0 ;
V_2 -> V_542 = ( T_5 ) F_215 ( V_2 -> V_38 -> V_569 ) ;
}
static void F_216 ( unsigned long V_570 )
{
struct V_1 * V_2 = (struct V_1 * ) V_570 ;
F_149 ( V_2 -> V_337 , & V_2 -> V_203 , 0 ) ;
}
static int T_9 F_217 ( struct V_539 * V_38 ,
const struct V_571 * V_572 )
{
struct V_67 * V_17 = NULL ;
struct V_1 * V_2 = NULL ;
static int V_573 ;
int V_574 ( V_575 ) , V_30 ;
V_30 = F_218 ( V_38 ) ;
if ( V_30 ) {
F_47 ( L_98 , F_112 ( V_38 ) ) ;
goto V_576;
}
V_30 = F_219 ( V_38 , V_540 ) ;
if ( V_30 ) {
F_47 ( L_99 , F_112 ( V_38 ) ) ;
goto V_577;
}
F_220 ( V_38 ) ;
if ( ! F_221 ( V_38 , F_222 ( 64 ) ) ) {
V_575 = 1 ;
V_30 = F_223 ( V_38 , F_222 ( 64 ) ) ;
} else if ( ! ( V_30 = F_221 ( V_38 , F_222 ( 32 ) ) ) ) {
V_575 = 0 ;
V_30 = F_223 ( V_38 , F_222 ( 32 ) ) ;
}
if ( V_30 ) {
F_47 ( L_100 , F_112 ( V_38 ) ) ;
goto V_578;
}
V_17 = F_224 ( sizeof( struct V_1 ) ) ;
if ( ! V_17 ) {
F_47 ( L_101 , F_112 ( V_38 ) ) ;
V_30 = - V_387 ;
goto V_578;
}
F_225 ( V_17 , & V_38 -> V_370 ) ;
F_226 ( V_38 , V_17 ) ;
V_2 = F_108 ( V_17 ) ;
V_2 -> V_73 = V_573 ;
V_2 -> V_17 = V_17 ;
V_2 -> V_38 = V_38 ;
V_2 -> V_210 = V_572 -> V_579 ;
V_2 -> V_200 = V_196 ;
if ( V_548 )
V_2 -> V_548 = 1 ;
V_2 -> V_237 = F_227 ( V_580 , V_581 ) ;
if ( V_575 )
V_17 -> V_582 |= V_583 ;
if ( V_2 -> V_210 == V_211 )
V_17 -> V_582 |= V_584 | V_585 ;
V_2 -> V_7 = F_228 ( V_38 , 1 ) ;
if ( ! V_2 -> V_7 ) {
...
F_191 ( V_2 ) ;
if ( V_2 -> V_15 ) {
V_17 -> V_417 = V_2 -> V_74 . V_170 . V_592 ;
F_44 ( V_17 , V_2 -> V_74 . V_593 . V_594 ) ;
} else {
V_17 -> V_417 = V_2 -> V_74 . V_169 . V_592 ;
F_44 ( V_17 , V_2 -> V_74 . V_595 . V_594 ) ;
}
memcpy ( V_17 -> V_596 , V_17 -> V_70 , V_17 -> V_562 ) ;
V_17 -> V_597 = V_380 ;
F_214 ( V_2 ) ;
if ( V_2 -> V_544 )
F_233 ( V_38 , ( int ) 0x4e , ( V_65 ) 0x0036 ) ;
V_30 = F_234 ( V_17 ) ;
if ( V_30 ) {
...
F_148 ( V_17 ) ;
F_147 ( V_17 ) ;
V_2 -> V_337 = F_235 ( V_17 -> V_125 ) ;
F_236 ( & V_2 -> V_338 , F_212 ) ;
F_236 ( & V_2 -> V_563 , F_213 ) ;
F_236 ( & V_2 -> V_203 , F_96 ) ;
F_237 ( & V_2 -> V_206 ) ;
V_2 -> V_206 . V_598 = F_216 ;
...
static void T_10 F_242 ( struct V_539 * V_38 )
{
struct V_67 * V_17 = F_243 ( V_38 ) ;
struct V_1 * V_2 = F_108 ( V_17 ) ;
F_244 ( V_17 ) ;
F_24 ( V_2 ) ;
if ( V_2 -> V_337 ) {
...
static int T_11 F_247 ( void )
{
return F_248 ( & V_602 ) ;
}
static void T_12 F_249 ( void )
{
F_250 ( & V_602 ) ;
}
