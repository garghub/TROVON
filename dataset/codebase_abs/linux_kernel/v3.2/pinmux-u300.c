...
T_1 V_16 , V_17 , V_18 ;
int V_19 ;
for ( V_19 = 0 ; V_19 < F_2 ( V_20 ) ; V_19 ++ ) {
if ( V_15 )
V_17 = V_21 [ V_3 ] . V_18 -> V_22 ;
else
V_17 = 0 ;
V_18 = V_21 [ V_3 ] . V_18 -> V_18 ;
if ( V_18 != 0 ) {
V_16 = F_8 ( V_14 -> V_23 + V_20 [ V_19 ] ) ;
V_16 &= ~ V_18 ;
V_16 |= V_17 ;
F_9 ( V_16 , V_14 -> V_23 + V_20 [ V_19 ] ) ;
}
}
}
...
static int T_2 F_16 ( struct V_27 * V_28 )
{
int V_29 ;
struct V_13 * V_14 ;
struct V_30 * V_31 ;
V_14 = F_17 ( & V_28 -> V_32 , sizeof( * V_14 ) , V_33 ) ;
if ( ! V_14 )
return - V_34 ;
V_14 -> V_32 = & V_28 -> V_32 ;
V_31 = F_18 ( V_28 , V_35 , 0 ) ;
if ( ! V_31 ) {
V_29 = - V_36 ;
goto V_37;
}
V_14 -> V_38 = V_31 -> V_39 ;
V_14 -> V_40 = F_19 ( V_31 ) ;
if ( F_20 ( V_14 -> V_38 , V_14 -> V_40 ,
V_12 ) == NULL ) {
V_29 = - V_34 ;
goto V_41;
}
V_14 -> V_23 = F_21 ( V_14 -> V_38 , V_14 -> V_40 ) ;
if ( ! V_14 -> V_23 ) {
V_29 = - V_34 ;
goto V_42;
}
V_14 -> V_43 = F_22 ( & V_44 , & V_28 -> V_32 , V_14 ) ;
if ( ! V_14 -> V_43 ) {
F_23 ( & V_28 -> V_32 , L_2 ) ;
V_29 = - V_5 ;
goto V_45;
