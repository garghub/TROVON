...
V_36 = F_61 ( V_102 , L_24 ) ;
} else {
V_36 = F_61 ( V_102 , L_25 ) ;
}
}
...
if ( ! V_36 )
V_36 = sprintf ( V_102 -> V_8 . V_11 , L_37 , V_198 + 1 ) ;
F_61 ( V_102 , L_27 ) ;
F_22 ( V_86 L_38 ,
...
{
return F_79 ( V_3 , V_4 , V_168 , V_220 , L_45 ) ;
}
static int F_84 ( struct V_2 * V_3 , int V_4 , void * V_168 )
{
return F_79 ( V_3 , V_4 , V_168 , V_221 , L_46 ) ;
}
...
if ( ! V_36 )
sprintf ( V_226 [ V_145 ] , L_49 , V_145 ) ;
}
...
V_52 -> V_78 ) ;
F_103 ( V_28 , L_69 , V_37 -> V_103 -> V_251 ) ;
