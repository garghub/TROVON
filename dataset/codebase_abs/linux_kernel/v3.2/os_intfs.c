...
{
F_17 ( & V_2 -> V_97 . V_98 . V_99 ,
5000 ) ;
F_17 ( & V_2 -> V_97 . V_100 , 2000 ) ;
}
...
{
V_11 V_106 = V_6 ;
struct V_7 * V_107 = & V_2 -> V_9 ;
struct V_62 * V_63 = & V_2 -> V_64 ;
struct V_108 * V_109 = & V_2 -> V_97 ;
struct V_110 * V_111 = & V_2 -> V_102 ;
V_63 -> V_112 = V_107 -> V_21 ;
V_63 -> V_113 = V_107 -> V_22 ;
V_63 -> V_22 = V_107 -> V_22 ;
V_63 -> V_114 = V_107 -> V_114 ;
V_63 -> V_115 = V_107 -> V_23 ;
V_109 -> V_116 = 1 ;
{
int V_117 ;
struct V_118 * V_119 = & V_109 -> V_120 ;
V_119 -> V_48 = false ;
for ( V_117 = 0 ; V_117 < 16 ; V_117 ++ )
V_119 -> V_121 [ V_117 ] = false ;
}
V_111 -> V_122 = V_107 -> V_37 ;
V_111 -> V_123 = V_107 -> V_38 ;
V_111 -> V_124 = V_92 ;
F_21 ( V_2 ) ;
F_22 ( V_2 ) ;
return V_106 ;
...
{
if ( ( F_24 ( & V_2 -> V_93 ) ) == V_92 )
return V_92 ;
V_2 -> V_93 . V_2 = V_2 ;
if ( ( F_25 ( & V_2 -> V_125 ) ) == V_92 )
return V_92 ;
if ( F_26 ( V_2 ) == V_92 )
return V_92 ;
F_27 ( & V_2 -> V_64 , V_2 ) ;
F_28 ( & V_2 -> V_67 , V_2 ) ;
memset ( ( unsigned char * ) & V_2 -> V_102 , 0 ,
sizeof( struct V_110 ) ) ;
F_29 ( & ( V_2 -> V_102 . V_103 ) , V_2 -> V_4 ,
V_126 , V_2 ) ;
F_30 ( & V_2 -> V_127 ) ;
V_2 -> V_127 . V_2 = V_2 ;
F_31 ( V_2 ) ;
F_32 ( V_2 ) ;
F_33 ( & ( V_2 -> V_128 . V_129 ) , 0 ) ;
F_34 ( V_2 ) ;
if ( F_20 ( V_2 ) != V_6 )
return V_92 ;
F_35 ( V_2 ) ;
...
static void F_47 ( struct V_1 * V_2 , int V_130 )
{
T_2 V_131 = 0xf4000500 ;
if ( V_130 ) {
V_131 |= 0x200 ;
}
F_48 ( V_2 , V_131 ) ;
...
if ( V_52 == NULL )
memcpy ( V_4 -> V_58 ,
V_2 -> V_135 . V_136 , V_60 ) ;
else {
F_51 ( 200 ) ;
F_52 ( V_2 , ( V_11 * ) V_4 -> V_58 ) ;
memcpy ( V_2 -> V_135 . V_136 ,
V_4 -> V_58 , V_60 ) ;
}
if ( F_10 ( V_2 ) != V_6 )
goto V_134;
if ( V_2 -> V_137 . V_138 == NULL )
goto V_134;
else
V_2 -> V_137 . V_138 ( V_2 ) ;
