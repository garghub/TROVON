...
{
V_178 -> V_180 = V_181 -> V_182 ;
return 0 ;
}
static int F_86 ( struct V_181 * V_181 , struct V_178 * V_178 )
{
return 0 ;
}
static T_6 F_87 ( struct V_178 * V_178 , char T_7 * V_179 ,
T_8 V_160 , T_9 * V_183 )
{
return 0 ;
}
static T_6 F_88 ( struct V_178 * V_178 , const char T_7 * V_179 ,
T_8 V_160 , T_9 * V_183 )
{
struct V_109 * V_110 ;
struct V_1 * V_2 ;
...
V_2 = F_49 ( V_110 ) ;
V_39 = F_89 ( V_160 , sizeof( V_8 ) - 1 ) ;
if ( F_90 ( V_8 , V_179 , V_39 ) )
return - V_185 ;
V_8 [ V_39 ] = '\0' ;
if ( V_39 > 0 && V_8 [ V_39 - 1 ] == '\n' )
V_8 [ V_39 - 1 ] = '\0' ;
if ( strncmp ( V_8 , L_112 , 5 ) == 0 ) {
if ( F_91 ( V_8 + 7 , 10 , & V_67 ) )
return - V_186 ;
...
V_98 |= V_76 ;
F_92 ( V_2 , V_98 , V_184 ) ;
F_93 ( V_189 L_115 , V_67 ) ;
} else if ( strncmp ( V_8 , L_116 , 5 ) == 0 ) {
unsigned long V_190 ;
if ( F_91 ( V_8 + 5 , 16 , & V_190 ) )
return - V_186 ;
F_93 ( V_189 L_117 , V_8 + 6 , V_190 ) ;
V_98 = F_3 ( V_2 , & V_2 -> V_161 -> V_53 ) ;
V_98 &= ~ V_54 ;
V_98 |= V_190 << 24 ;
F_92 ( V_2 , V_98 , & V_2 -> V_161 -> V_53 ) ;
} else if ( strncmp ( V_8 , L_118 , 7 ) == 0 ) {
if ( F_91 ( V_8 + 8 , 10 , & V_67 ) )
return - V_186 ;
V_4 = F_3 ( V_2 , & V_2 -> V_5 -> V_6 ) ;
if ( V_67 > F_11 ( V_4 ) ) {
F_4 ( V_2 , L_119 , V_67 ) ;
...
V_2 -> V_192 = F_94 ( V_86 -> V_193 , V_194 ) ;
if ( ! V_2 -> V_192 )
return;
if ( ! F_95 ( L_122 , V_195 , V_2 -> V_192 , V_86 ,
& V_196 ) )
goto V_197;
if ( ! F_95 ( L_123 , V_195 , V_2 -> V_192 , V_86 ,
& V_198 ) )
goto V_197;
if ( ! F_95 ( L_124 , V_195 , V_2 -> V_192 , V_86 ,
& V_199 ) )
goto V_197;
if ( ! F_95 ( L_125 , V_195 | V_200 , V_2 -> V_192 , V_86 ,
& V_201 ) )
goto V_197;
return;
V_197:
