...
static int F_155 ( struct V_212 * V_213 ,
const struct F_27 * const * V_224 ,
struct V_229 * V_230 , void * V_242 ,
int V_243 , bool V_244 )
{
struct V_24 * V_69 = & V_213 -> V_69 ;
const struct F_27 * V_245 ;
...
int F_159 ( struct V_212 * V_213 ,
const struct F_27 * const * V_224 ,
struct V_229 * V_230 , void * V_242 , int V_249 )
{
return F_155 ( V_213 , V_224 , V_230 , V_242 , V_249 , 0 ) ;
}
...
struct V_113 * V_114 ;
unsigned int V_253 , V_245 ;
V_245 = 0 ;
F_161 (qc->sg, sg, qc->n_elem, si) {
T_6 V_254 , V_86 ;
T_6 V_255 , V_256 ;
V_254 = ( T_6 ) F_162 ( V_114 ) ;
V_255 = F_163 ( V_114 ) ;
while ( V_255 ) {
V_86 = V_254 & 0xffff ;
V_256 = V_255 ;
if ( ( V_86 + V_255 ) > 0x10000 )
V_256 = 0x10000 - V_86 ;
V_251 [ V_245 ] . V_254 = F_164 ( V_254 ) ;
V_251 [ V_245 ] . V_257 = F_164 ( V_256 & 0xffff ) ;
F_32 ( L_46 , V_245 , V_254 , V_256 ) ;
V_245 ++ ;
V_255 -= V_256 ;
V_254 += V_256 ;
}
}
V_251 [ V_245 - 1 ] . V_257 |= F_164 ( V_258 ) ;
}
...
V_251 [ V_245 ] . V_254 = F_164 ( V_254 ) ;
if ( V_259 == 0 ) {
V_251 [ V_245 ] . V_257 = F_164 ( 0x8000 ) ;
V_259 = 0x8000 ;
V_251 [ ++ V_245 ] . V_254 = F_164 ( V_254 + 0x8000 ) ;
}
V_251 [ V_245 ] . V_257 = F_164 ( V_259 ) ;
F_32 ( L_46 , V_245 , V_254 , V_256 ) ;
V_245 ++ ;
V_255 -= V_256 ;
V_254 += V_256 ;
...
V_263 = V_2 -> V_5 -> V_266 ( V_2 ) ;
F_32 ( L_47 , V_2 -> V_64 , V_263 ) ;
if ( ! ( V_263 & V_267 ) )
return F_94 ( V_2 ) ;
V_2 -> V_5 -> V_268 ( V_82 ) ;
V_264 = true ;
...
V_265 = F_96 ( V_2 , V_82 , V_264 ) ;
if ( F_41 ( V_82 -> V_125 ) && F_169 ( V_82 -> V_40 . V_102 ) )
F_64 ( V_111 , L_48 , V_263 ) ;
return V_265 ;
}
T_3 V_248 ( int V_166 , void * V_167 )
{
return F_99 ( V_166 , V_167 , F_170 ) ;
}
...
T_1 V_263 ;
V_263 = V_2 -> V_5 -> V_266 ( V_2 ) ;
if ( V_82 -> V_125 == V_272 && ( V_263 & V_269 ) ) {
V_82 -> V_125 = V_270 ;
V_271 = true ;
}
V_2 -> V_5 -> V_268 ( V_82 ) ;
...
{
void T_2 * V_273 = V_2 -> V_3 . V_274 ;
if ( ! V_273 )
return;
F_23 ( F_2 ( V_273 + V_275 ) , V_273 + V_275 ) ;
}
...
T_1 V_276 ;
F_176 () ;
F_177 ( V_2 -> V_277 , V_2 -> V_3 . V_274 + V_278 ) ;
V_276 = F_2 ( V_2 -> V_3 . V_274 + V_279 ) ;
V_276 &= ~ ( V_280 | V_281 ) ;
if ( ! V_72 )
V_276 |= V_280 ;
F_23 ( V_276 , V_2 -> V_3 . V_274 + V_279 ) ;
...
T_1 V_276 ;
V_276 = F_2 ( V_2 -> V_3 . V_274 + V_279 ) ;
F_23 ( V_276 | V_281 , V_2 -> V_3 . V_274 + V_279 ) ;
}
void F_179 ( struct V_81 * V_82 )
{
struct V_1 * V_2 = V_82 -> V_2 ;
void T_2 * V_273 = V_2 -> V_3 . V_274 ;
F_23 ( F_2 ( V_273 + V_279 ) & ~ V_281 ,
V_273 + V_279 ) ;
F_8 ( V_2 ) ;
}
T_1 F_180 ( struct V_1 * V_2 )
{
return F_2 ( V_2 -> V_3 . V_274 + V_275 ) ;
}
int F_181 ( struct V_1 * V_2 )
{
if ( V_2 -> V_282 || V_2 -> V_283 ) {
V_2 -> V_252 =
F_182 ( V_2 -> V_216 -> V_69 , V_284 ,
& V_2 -> V_277 , V_226 ) ;
if ( ! V_2 -> V_252 )
return - V_227 ;
}
...
int F_184 ( struct V_212 * V_213 )
{
unsigned long V_244 = F_128 ( V_213 , 4 ) ;
T_1 V_286 ;
if ( V_244 == 0 )
return - V_287 ;
V_286 = F_185 ( V_244 + 0x02 ) ;
F_186 ( V_286 & 0x60 , V_244 + 0x02 ) ;
V_286 = F_185 ( V_244 + 0x02 ) ;
if ( V_286 & 0x80 )
return - V_238 ;
return 0 ;
}
static void F_187 ( struct V_215 * V_216 , const char * V_288 )
{
int V_172 ;
F_139 ( V_216 -> V_69 , L_49 , V_288 ) ;
for ( V_172 = 0 ; V_172 < 2 ; V_172 ++ ) {
V_216 -> V_219 [ V_172 ] -> V_282 = 0 ;
V_216 -> V_219 [ V_172 ] -> V_283 = 0 ;
}
}
void F_188 ( struct V_215 * V_216 )
{
struct V_24 * V_217 = V_216 -> V_69 ;
struct V_212 * V_213 = F_131 ( V_217 ) ;
int V_172 , V_171 ;
...
V_171 = F_189 ( V_213 , V_289 ) ;
if ( V_171 )
F_187 ( V_216 , L_51 ) ;
if ( ! V_171 ) {
V_171 = F_190 ( V_213 , V_289 ) ;
if ( V_171 )
F_187 ( V_216 ,
L_52 ) ;
}
...
for ( V_172 = 0 ; V_172 < 2 ; V_172 ++ ) {
struct V_1 * V_2 = V_216 -> V_219 [ V_172 ] ;
void T_2 * V_244 = V_216 -> V_221 [ 4 ] + 8 * V_172 ;
if ( F_132 ( V_2 ) )
continue;
V_2 -> V_3 . V_274 = V_244 ;
if ( ( ! ( V_2 -> V_42 & V_290 ) ) &&
...
int F_191 ( struct V_212 * V_213 ,
const struct F_27 * const * V_224 ,
struct V_229 * V_230 , void * V_242 ,
int V_243 )
{
return F_155 ( V_213 , V_224 , V_230 , V_242 , V_243 , 1 ) ;
}
