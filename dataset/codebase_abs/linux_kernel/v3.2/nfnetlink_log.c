...
V_69 . V_81 = V_38 -> V_82 ;
V_69 . V_83 = V_62 ;
F_51 ( V_8 -> V_38 , V_84 , sizeof( V_69 ) , & V_69 ) ;
if ( V_66 )
F_51 ( V_8 -> V_38 , V_85 , V_67 , V_66 ) ;
if ( V_64 ) {
#ifndef F_52
F_53 ( V_8 -> V_38 , V_86 ,
F_54 ( V_64 -> V_87 ) ) ;
...
F_54 ( V_64 -> V_87 ) ) ;
F_53 ( V_8 -> V_38 , V_86 ,
F_54 ( F_55 ( V_64 ) -> V_90 -> V_91 -> V_87 ) ) ;
} else {
F_53 ( V_8 -> V_38 , V_86 ,
F_54 ( V_64 -> V_87 ) ) ;
if ( V_38 -> V_92 && V_38 -> V_92 -> V_93 )
F_53 ( V_8 -> V_38 , V_89 ,
F_54 ( V_38 -> V_92 -> V_93 -> V_87 ) ) ;
}
#endif
}
if ( V_65 ) {
...
F_54 ( V_65 -> V_87 ) ) ;
F_53 ( V_8 -> V_38 , V_94 ,
F_54 ( F_55 ( V_65 ) -> V_90 -> V_91 -> V_87 ) ) ;
} else {
F_53 ( V_8 -> V_38 , V_94 ,
F_54 ( V_65 -> V_87 ) ) ;
if ( V_38 -> V_92 && V_38 -> V_92 -> V_96 )
F_53 ( V_8 -> V_38 , V_95 ,
F_54 ( V_38 -> V_92 -> V_96 -> V_87 ) ) ;
}
#endif
}
if ( V_38 -> V_97 )
F_53 ( V_8 -> V_38 , V_98 , F_54 ( V_38 -> V_97 ) ) ;
if ( V_64 && V_38 -> V_91 &&
V_38 -> V_99 != V_38 -> V_100 ) {
struct V_101 V_102 ;
int V_103 = F_56 ( V_38 , V_102 . V_104 ) ;
if ( V_103 > 0 ) {
V_102 . V_105 = F_50 ( V_103 ) ;
F_51 ( V_8 -> V_38 , V_106 , sizeof( V_102 ) , & V_102 ) ;
}
}
if ( V_64 && F_57 ( V_38 ) ) {
F_58 ( V_8 -> V_38 , V_107 , F_50 ( V_38 -> V_91 -> type ) ) ;
F_58 ( V_8 -> V_38 , V_108 ,
F_50 ( V_38 -> V_91 -> V_109 ) ) ;
F_51 ( V_8 -> V_38 , V_110 , V_38 -> V_91 -> V_109 ,
F_59 ( V_38 ) ) ;
}
if ( V_38 -> V_111 . V_112 ) {
struct V_113 V_114 ;
struct V_115 V_116 = F_60 ( V_38 -> V_111 ) ;
V_114 . V_117 = F_61 ( V_116 . V_118 ) ;
V_114 . V_119 = F_61 ( V_116 . V_120 ) ;
F_51 ( V_8 -> V_38 , V_121 , sizeof( V_114 ) , & V_114 ) ;
}
if ( V_38 -> V_122 ) {
F_62 ( & V_38 -> V_122 -> V_123 ) ;
if ( V_38 -> V_122 -> V_124 && V_38 -> V_122 -> V_124 -> V_125 ) {
struct V_125 * V_125 = V_38 -> V_122 -> V_124 -> V_125 ;
T_5 V_126 = F_54 ( V_125 -> V_127 -> V_128 ) ;
T_5 V_129 = F_54 ( V_125 -> V_127 -> V_130 ) ;
F_63 ( & V_38 -> V_122 -> V_123 ) ;
F_53 ( V_8 -> V_38 , V_131 , V_126 ) ;
F_53 ( V_8 -> V_38 , V_132 , V_129 ) ;
} else
F_63 ( & V_38 -> V_122 -> V_123 ) ;
}
if ( V_8 -> V_48 & V_133 )
F_53 ( V_8 -> V_38 , V_134 , F_54 ( V_8 -> V_135 ++ ) ) ;
if ( V_8 -> V_48 & V_136 )
F_53 ( V_8 -> V_38 , V_137 ,
F_54 ( F_64 ( & V_138 ) ) ) ;
if ( V_60 ) {
...
V_140 = (struct V_139 * ) F_69 ( V_8 -> V_38 , F_67 ( V_60 ) ) ;
V_140 -> V_143 = V_144 ;
V_140 -> V_145 = V_141 ;
if ( F_70 ( V_38 , 0 , F_71 ( V_140 ) , V_60 ) )
F_72 () ;
}
...
+ F_67 ( sizeof( T_3 ) )
+ F_67 ( V_67 )
+ F_67 ( sizeof( struct V_101 ) )
+ F_67 ( sizeof( struct V_113 ) ) ;
if ( V_149 && F_57 ( V_38 ) ) {
V_141 += F_67 ( V_38 -> V_91 -> V_109 )
+ F_67 ( sizeof( T_2 ) )
+ F_67 ( sizeof( T_2 ) ) ;
}
F_18 ( & V_8 -> V_23 ) ;
if ( V_8 -> V_48 & V_133 )
V_141 += F_67 ( sizeof( T_3 ) ) ;
if ( V_8 -> V_48 & V_136 )
V_141 += F_67 ( sizeof( T_3 ) ) ;
V_27 = V_8 -> V_27 ;
...
if ( V_8 -> V_38 &&
V_141 > F_66 ( V_8 -> V_38 ) - sizeof( struct V_55 ) ) {
F_31 ( V_8 ) ;
}
if ( ! V_8 -> V_38 ) {
...
static void * F_99 ( struct V_206 * V_135 , T_7 * V_7 )
__acquires( T_8 )
{
F_7 () ;
return F_98 ( V_135 -> V_207 , * V_7 ) ;
}
...
static int F_105 ( struct V_210 * V_210 , struct V_125 * V_125 )
{
return F_106 ( V_125 , & V_211 ,
sizeof( struct V_202 ) ) ;
}
