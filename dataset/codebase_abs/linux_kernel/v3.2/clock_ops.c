...
char * * V_6 ;
int error ;
F_4 ( V_2 , L_5 , V_24 , V_27 ) ;
V_30 = F_35 ( V_26 , struct V_29 , V_26 ) ;
switch ( V_27 ) {
case V_31 :
if ( V_2 -> V_32 )
break;
...
static void F_36 ( struct V_1 * V_2 , const char * V_6 )
{
struct V_5 * V_5 ;
V_5 = F_2 ( V_2 , V_6 ) ;
if ( ! F_3 ( V_5 ) ) {
...
static void F_38 ( struct V_1 * V_2 , const char * V_6 )
{
struct V_5 * V_5 ;
V_5 = F_2 ( V_2 , V_6 ) ;
if ( ! F_3 ( V_5 ) ) {
