...
V_285 = ! F_20 ( V_2 ,
V_141 ) ;
F_49 ( V_2 -> V_134 . V_99 , V_285 ) ;
}
if ( V_2 -> V_135 . V_99 ) {
V_285 = ! F_20 ( V_2 , V_143 ) ;
F_49 ( V_2 -> V_135 . V_99 , V_285 ) ;
}
if ( V_2 -> V_136 . V_99 ) {
V_285 = ! F_20 ( V_2 , V_145 ) ;
F_49 ( V_2 -> V_136 . V_99 , V_285 ) ;
}
if ( V_2 -> V_137 . V_99 ) {
V_285 = ! F_20 ( V_2 , V_147 ) ;
F_49 ( V_2 -> V_137 . V_99 , V_285 ) ;
}
if ( V_2 -> V_138 . V_99 ) {
V_285 = ! F_20 ( V_2 , V_149 ) ;
F_49 ( V_2 -> V_138 . V_99 , V_285 ) ;
}
if ( ! F_37 ( V_2 -> V_72 . V_14 ) )
F_24 ( V_2 -> V_66 , & V_2 -> V_67 ) ;
return 0 ;
...
if ( V_269 -> V_281 && ! F_168 ( V_269 -> V_281 ) ) {
F_51 ( L_58 ) ;
return - V_42 ;
}
if ( V_269 -> V_286 ) {
V_114 = V_269 -> V_286 ( V_179 ) ;
if ( V_114 )
return V_114 ;
}
return F_155 ( V_179 ) ;
...
V_266 = & V_7 -> V_266 ;
V_266 -> remove = F_163 ;
V_266 -> V_7 . V_288 = V_7 -> V_288 ;
V_266 -> V_7 . V_6 = V_7 -> V_6 ;
V_266 -> V_7 . V_289 = & V_290 ;
V_16 = F_170 ( V_266 ,
F_167 ,
NULL , 0 , NULL , 0 ) ;
if ( F_109 ( V_16 ) )
