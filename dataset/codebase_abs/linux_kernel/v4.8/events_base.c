...
F_96 ( & V_67 ) ;
F_35 ( V_5 , V_11 -> V_13 ) ;
F_143 ( V_6 , F_39 ( V_11 -> V_13 ) ) ;
F_144 ( V_6 ) ;
}
static int F_145 ( unsigned V_6 , unsigned V_144 )
{
struct V_145 V_146 ;
int V_5 = F_21 ( V_6 ) ;
int V_54 ;
...
static int F_147 ( struct V_49 * V_50 , const struct V_148 * V_149 ,
bool V_150 )
{
unsigned V_144 = F_148 ( V_149 , V_151 ) ;
return F_145 ( V_50 -> V_6 , V_144 ) ;
}
...
static void F_156 ( unsigned int V_13 )
{
struct V_93 V_94 ;
int V_20 , V_6 , V_5 ;
...
V_162 . V_163 = 1 ;
V_162 . V_160 = V_160 ;
F_162 ( V_162 . V_164 , & V_5 ) ;
if ( F_163 ( V_165 , & V_162 ) != 0 )
F_67 () ;
}
}
void F_164 ( int V_6 )
...
int V_53 ;
struct V_180 V_181 ;
V_33 = ( void * ) F_185 ( V_8 | V_182 ) ;
V_181 . V_183 = F_186 ( V_33 ) ;
V_53 = F_69 ( V_184 , & V_181 ) ;
if ( V_53 != 0 ) {
F_187 ( ( unsigned long ) V_33 ) ;
V_33 = NULL ;
} else
F_78 = F_32 ;
}
