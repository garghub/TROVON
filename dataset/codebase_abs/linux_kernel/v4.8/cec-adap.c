...
V_5 -> V_180 [ sizeof( V_5 -> V_180 ) - 1 ] = '\0' ;
if ( V_5 -> V_6 > V_2 -> V_181 ) {
F_31 ( 1 , L_19 , V_2 -> V_181 ) ;
return - V_96 ;
}
if ( V_5 -> V_182 != V_183 &&
( V_5 -> V_182 & 0xff000000 ) != 0 )
return - V_96 ;
if ( V_5 -> V_164 != V_184 &&
V_5 -> V_164 != V_165 )
return - V_96 ;
...
for ( V_4 = 0 ; V_4 < V_5 -> V_6 ; V_4 ++ ) {
const T_1 V_185 = F_66 ( V_5 -> V_186 [ 0 ] ) ;
T_1 * V_186 = V_5 -> V_186 [ V_4 ] ;
bool V_187 = false ;
V_5 -> V_3 [ V_4 ] = V_119 ;
if ( V_178 & ( 1 << V_5 -> V_157 [ V_4 ] ) ) {
F_31 ( 1 , L_21 ) ;
return - V_96 ;
}
V_178 |= 1 << V_5 -> V_157 [ V_4 ] ;
if ( ( V_178 & ( 1 << V_144 ) ) &&
( V_178 & ( 1 << V_146 ) ) ) {
F_31 ( 1 , L_22 ) ;
return - V_96 ;
...
memset ( V_186 + V_4 + 1 , 0 , V_185 - V_4 - 1 ) ;
}
if ( V_5 -> V_164 >= V_165 ) {
if ( V_5 -> V_6 > 2 ) {
F_31 ( 1 , L_27 ) ;
...
V_5 -> V_157 [ V_4 ] = 0 ;
V_5 -> V_189 [ V_4 ] = 0 ;
memset ( V_5 -> V_186 [ V_4 ] , 0 ,
sizeof( V_5 -> V_186 [ V_4 ] ) ) ;
}
...
static int F_55 ( struct V_1 * V_2 , unsigned int V_191 )
{
struct V_23 V_24 = { } ;
const struct V_114 * V_115 = & V_2 -> V_5 ;
const T_1 * V_186 = V_115 -> V_186 [ V_191 ] ;
bool V_187 = false ;
unsigned int V_113 ;
if ( V_2 -> V_5 . V_164 < V_165 )
return 0 ;
V_24 . V_24 [ 0 ] = ( V_115 -> V_3 [ V_191 ] << 4 ) | 0x0f ;
V_24 . V_70 = 4 ;
V_24 . V_24 [ 1 ] = V_192 ;
V_24 . V_24 [ 2 ] = V_2 -> V_5 . V_164 ;
V_24 . V_24 [ 3 ] = V_115 -> V_189 [ V_191 ] ;
for ( V_113 = 0 ; V_113 < F_66 ( V_115 -> V_186 [ 0 ] ) ; V_113 ++ ) {
V_24 . V_24 [ V_24 . V_70 ++ ] = V_186 [ V_113 ] ;
if ( ( V_186 [ V_113 ] & V_193 ) == 0 ) {
if ( V_187 )
break;
V_187 = true ;
}
...
static int F_56 ( struct V_1 * V_2 , unsigned int V_191 )
{
const struct V_114 * V_115 = & V_2 -> V_5 ;
struct V_23 V_24 = { } ;
V_24 . V_24 [ 0 ] = ( V_115 -> V_3 [ V_191 ] << 4 ) | 0x0f ;
...
struct V_23 * V_24 , T_1 V_194 )
{
struct V_23 V_195 = { } ;
if ( V_24 -> V_24 [ 1 ] == V_110 )
return 0 ;
F_70 ( & V_195 , V_24 ) ;
F_71 ( & V_195 , V_24 -> V_24 [ 1 ] , V_194 ) ;
return F_48 ( V_2 , & V_195 , false ) ;
}
...
bool V_107 )
{
bool V_198 = F_42 ( V_24 ) ;
T_1 V_199 = F_40 ( V_24 ) ;
T_1 V_200 = F_39 ( V_24 ) ;
T_1 V_201 = F_2 ( V_2 , V_199 ) ;
int V_191 = F_1 ( V_2 , V_199 ) ;
bool V_202 = V_200 == 0xf ;
struct V_23 V_203 = { } ;
F_31 ( 1 , L_31 , V_24 -> V_70 , V_24 -> V_24 ) ;
if ( V_2 -> V_75 -> V_204 ) {
if ( V_2 -> V_75 -> V_204 ( V_2 , V_24 ) != - V_205 )
return 0 ;
}
switch ( V_24 -> V_24 [ 1 ] ) {
case V_206 :
...
switch ( V_24 -> V_24 [ 1 ] ) {
case V_217 : {
T_4 V_218 = ( V_24 -> V_24 [ 2 ] << 8 ) | V_24 -> V_24 [ 3 ] ;
if ( ! V_202 )
V_2 -> V_118 [ V_200 ] = V_218 ;
F_31 ( 1 , L_32 ,
F_54 ( V_218 ) , V_200 ) ;
break;
}
...
break;
default:
F_75 ( V_2 -> V_221 , V_222 , V_24 -> V_24 [ 2 ] , 0 ) ;
break;
}
#endif
break;
...
break;
case V_206 :
F_77 ( & V_203 , V_2 -> V_5 . V_164 ) ;
return F_48 ( V_2 , & V_203 , false ) ;
case V_210 :
if ( V_201 == V_223 && V_199 == 15 )
return 0 ;
F_68 ( & V_203 , V_2 -> V_42 , V_201 ) ;
return F_48 ( V_2 , & V_203 , false ) ;
case V_207 :
if ( V_2 -> V_5 . V_182 == V_183 )
return F_72 ( V_2 , V_24 ) ;
F_78 ( & V_203 , V_2 -> V_5 . V_182 ) ;
return F_48 ( V_2 , & V_203 , false ) ;
case V_208 :
if ( V_201 == V_223 )
return 0 ;
...
case V_211 : {
if ( V_2 -> V_5 . V_180 [ 0 ] == 0 )
return F_72 ( V_2 , V_24 ) ;
F_79 ( & V_203 , V_2 -> V_5 . V_180 ) ;
return F_48 ( V_2 , & V_203 , false ) ;
}
case V_212 :
if ( V_2 -> V_5 . V_164 >= V_165 )
return F_55 ( V_2 , V_191 ) ;
return 0 ;
default:
if ( ! V_198 && ! V_107 && ! V_2 -> V_224 &&
! V_2 -> V_225 && V_24 -> V_24 [ 1 ] != V_110 )
return F_72 ( V_2 , V_24 ) ;
break;
}
V_214:
...
int F_82 ( struct V_226 * V_227 , void * V_228 )
{
struct V_1 * V_2 = F_83 ( V_227 -> V_229 ) ;
struct V_44 * V_45 ;
F_5 ( & V_2 -> V_16 ) ;
F_84 ( V_227 , L_33 , V_2 -> V_64 ) ;
F_84 ( V_227 , L_34 , V_2 -> V_65 ) ;
F_84 ( V_227 , L_35 ,
F_54 ( V_2 -> V_42 ) ) ;
F_84 ( V_227 , L_36 , V_2 -> V_5 . V_6 ) ;
F_84 ( V_227 , L_37 , V_2 -> V_5 . V_43 ) ;
if ( V_2 -> V_225 )
F_84 ( V_227 , L_38 ,
V_2 -> V_213 ? L_39 : L_11 ) ;
if ( V_2 -> V_230 )
