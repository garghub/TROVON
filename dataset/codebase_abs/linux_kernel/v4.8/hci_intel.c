...
F_62 ( V_11 , L_35 ) ;
F_13 ( V_106 , & V_11 -> V_107 ) ;
}
snprintf ( V_76 , sizeof( V_76 ) , L_36 ,
F_75 ( V_72 -> V_98 ) ) ;
V_7 = F_77 ( & V_74 , V_76 , & V_11 -> V_35 ) ;
if ( V_7 < 0 ) {
F_5 ( V_11 , L_37 ,
V_7 ) ;
F_55 ( V_17 ) ;
...
F_13 ( V_111 , & V_5 -> V_8 ) ;
V_7 = F_78 ( V_11 , 0x00 , 128 , V_74 -> V_96 ) ;
if ( V_7 < 0 ) {
F_5 ( V_11 , L_41 , V_7 ) ;
goto V_110;
}
V_7 = F_78 ( V_11 , 0x03 , 256 , V_74 -> V_96 + 128 ) ;
if ( V_7 < 0 ) {
F_5 ( V_11 , L_42 ,
V_7 ) ;
goto V_110;
}
V_7 = F_78 ( V_11 , 0x02 , 256 , V_74 -> V_96 + 388 ) ;
if ( V_7 < 0 ) {
F_5 ( V_11 , L_43 ,
V_7 ) ;
goto V_110;
...
F_9 ( V_11 , L_44 , ( V_75 - V_74 -> V_96 ) ,
V_74 -> V_108 ) ;
if ( V_77 % 4 )
continue;
V_7 = F_78 ( V_11 , 0x01 , V_77 , V_75 ) ;
if ( V_7 < 0 ) {
F_5 ( V_11 , L_45 ,
V_7 ) ;
goto V_110;
...
F_23 ( & V_42 ) ;
F_82 ( V_11 , V_76 ) ;
V_17 = F_63 ( V_11 , V_117 , 0 , NULL , V_66 ) ;
if ( F_64 ( V_17 ) )
return F_65 ( V_17 ) ;
F_55 ( V_17 ) ;
if ( V_84 ) {
...
static void F_88 ( struct V_54 * V_11 , int V_119 )
{
struct V_2 * V_3 = F_84 ( V_11 ) ;
struct V_4 * V_5 = V_3 -> V_6 ;
F_9 ( V_11 , L_54 , V_119 ) ;
...
return - V_127 ;
V_5 -> V_53 = F_92 ( V_3 -> V_11 , V_5 -> V_53 , V_96 , V_125 ,
V_128 ,
F_93 ( V_128 ) ) ;
if ( F_64 ( V_5 -> V_53 ) ) {
int V_7 = F_65 ( V_5 -> V_53 ) ;
F_5 ( V_3 -> V_11 , L_57 , V_7 ) ;
V_5 -> V_53 = NULL ;
return V_7 ;
}
return V_125 ;
...
static int F_99 ( struct V_129 * V_35 )
{
...
static int F_101 ( struct V_129 * V_35 )
{
struct V_32 * V_33 = F_100 ( V_35 ) ;
F_22 ( & V_33 -> V_36 ) ;
if ( V_33 -> V_3 )
...
static int F_102 ( struct V_129 * V_35 )
{
struct V_32 * V_33 = F_100 ( V_35 ) ;
if ( F_41 ( V_35 ) )
F_103 ( V_33 -> V_30 ) ;
...
static int F_104 ( struct V_129 * V_35 )
{
struct V_32 * V_33 = F_100 ( V_35 ) ;
if ( F_41 ( V_35 ) )
F_105 ( V_33 -> V_30 ) ;
...
static int F_106 ( struct V_130 * V_34 )
{
struct V_32 * V_33 ;
...
F_108 ( & V_33 -> V_36 ) ;
V_33 -> V_34 = V_34 ;
V_33 -> V_46 = F_109 ( & V_34 -> V_35 , L_59 , V_131 ) ;
if ( F_64 ( V_33 -> V_46 ) ) {
...
V_133 = F_109 ( & V_34 -> V_35 , L_62 , V_134 ) ;
if ( F_64 ( V_133 ) ) {
F_110 ( & V_34 -> V_35 , L_63 ) ;
goto V_135;
}
V_33 -> V_30 = F_112 ( V_133 ) ;
if ( V_33 -> V_30 < 0 ) {
...
F_114 ( V_34 , V_33 ) ;
F_22 ( & V_42 ) ;
F_115 ( & V_33 -> V_43 , & V_136 ) ;
F_23 ( & V_42 ) ;
F_21 ( & V_34 -> V_35 , L_65 ,
F_116 ( V_33 -> V_46 ) , V_33 -> V_30 ) ;
return 0 ;
}
static int F_117 ( struct V_130 * V_34 )
{
