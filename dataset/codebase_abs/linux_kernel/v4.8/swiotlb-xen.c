...
T_2 V_58 ;
V_54 &= ~ ( V_59 | V_60 ) ;
V_56 = F_42 ( V_53 , V_22 , V_30 , V_54 , V_55 ) ;
if ( ! V_56 )
return V_56 ;
if ( V_53 && V_53 -> V_5 )
V_4 = F_1 ( V_53 , V_54 ) ;
...
if ( F_20 ( V_57 , V_45 ,
F_43 ( V_4 ) , V_30 ) != 0 ) {
F_44 ( V_53 , V_22 , V_56 , ( T_2 ) V_57 , V_55 ) ;
return NULL ;
}
}
memset ( V_56 , 0 , V_22 ) ;
...
void
F_45 ( struct V_1 * V_53 , T_4 V_22 , void * V_61 ,
...
F_11 ( V_57 , V_22 ) )
F_46 ( V_57 , V_45 ) ;
F_44 ( V_53 , V_22 , V_61 , ( T_2 ) V_57 , V_55 ) ;
}
T_2 F_47 ( struct V_1 * V_2 , struct V_62 * V_62 ,
unsigned long V_15 , T_4 V_22 ,
enum V_63 V_64 ,
unsigned long V_55 )
{
T_3 V_65 , V_57 = F_48 ( V_62 ) + V_15 ;
T_2 V_58 = F_3 ( V_57 ) ;
F_49 ( V_64 == V_66 ) ;
if ( F_50 ( V_2 , V_58 , V_22 ) &&
! F_11 ( V_57 , V_22 ) &&
! F_51 ( V_2 , V_57 , V_58 ) &&
! V_67 ) {
F_52 ( V_2 , V_62 , V_58 , V_15 , V_22 , V_64 , V_55 ) ;
return V_58 ;
}
F_53 ( V_2 , V_58 , V_22 , V_67 ) ;
V_65 = F_54 ( V_2 , V_52 , V_57 , V_22 , V_64 ) ;
if ( V_65 == V_68 )
return V_69 ;
F_52 ( V_2 , F_55 ( V_65 >> V_33 ) ,
V_58 , V_65 & ~ V_70 , V_22 , V_64 , V_55 ) ;
V_58 = F_3 ( V_65 ) ;
if ( ! F_50 ( V_2 , V_58 , V_22 ) ) {
...
static void F_57 ( struct V_1 * V_53 , T_2 V_58 ,
...
void F_61 ( struct V_1 * V_53 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 ,
unsigned long V_55 )
{
F_57 ( V_53 , V_58 , V_22 , V_64 , V_55 ) ;
}
static void
F_62 ( struct V_1 * V_53 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 ,
enum V_72 V_73 )
{
T_3 V_7 = F_6 ( V_58 ) ;
F_49 ( V_64 == V_66 ) ;
if ( V_73 == V_74 )
F_63 ( V_53 , V_58 , V_22 , V_64 ) ;
if ( F_12 ( V_58 ) )
F_64 ( V_53 , V_7 , V_22 , V_64 , V_73 ) ;
if ( V_73 == V_75 )
F_65 ( V_53 , V_58 , V_22 , V_64 ) ;
if ( V_64 != V_71 )
return;
F_59 ( F_60 ( V_7 ) , V_22 ) ;
}
void
F_66 ( struct V_1 * V_53 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 )
{
F_62 ( V_53 , V_58 , V_22 , V_64 , V_74 ) ;
}
void
F_67 ( struct V_1 * V_53 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 )
{
F_62 ( V_53 , V_58 , V_22 , V_64 , V_75 ) ;
}
int
F_68 ( struct V_1 * V_53 , struct V_76 * V_77 ,
int V_78 , enum V_63 V_64 ,
unsigned long V_55 )
{
struct V_76 * V_79 ;
int V_18 ;
...
if ( V_65 == V_68 ) {
F_71 ( V_53 , L_12 ) ;
F_72 ( V_53 , V_77 , V_18 , V_64 ,
V_55 ) ;
F_73 ( V_77 ) = 0 ;
return 0 ;
}
F_52 ( V_53 , F_55 ( V_65 >> V_33 ) ,
V_58 ,
V_65 & ~ V_70 ,
V_79 -> V_16 ,
V_64 ,
...
void
F_72 ( struct V_1 * V_53 , struct V_76 * V_77 ,
int V_78 , enum V_63 V_64 ,
unsigned long V_55 )
{
struct V_76 * V_79 ;
...
F_49 ( V_64 == V_66 ) ;
F_69 (sgl, sg, nelems, i)
F_57 ( V_53 , V_79 -> V_80 , F_73 ( V_79 ) , V_64 , V_55 ) ;
}
static void
F_74 ( struct V_1 * V_53 , struct V_76 * V_77 ,
int V_78 , enum V_63 V_64 ,
enum V_72 V_73 )
{
struct V_76 * V_79 ;
...
void
F_75 ( struct V_1 * V_53 , struct V_76 * V_79 ,
int V_78 , enum V_63 V_64 )
{
F_74 ( V_53 , V_79 , V_78 , V_64 , V_74 ) ;
}
void
F_76 ( struct V_1 * V_53 , struct V_76 * V_79 ,
int V_78 , enum V_63 V_64 )
{
F_74 ( V_53 , V_79 , V_78 , V_64 , V_75 ) ;
}
int
...
int
F_78 ( struct V_1 * V_53 , T_6 V_81 )
{
return F_8 ( V_25 - 1 ) <= V_81 ;
}
int
