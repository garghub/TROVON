...
V_88 = F_37 ( V_87 , V_41 -> V_82 , L_22 , L_23 , V_89 ) ;
if ( V_88 ) {
V_85 = L_24 ;
goto V_95;
}
V_88 = F_37 ( V_87 , V_41 -> V_82 , L_25 ,
L_23 , V_89 ) ;
if ( V_88 ) {
V_85 = L_26 ;
goto V_95;
}
V_88 = F_37 ( V_87 , V_41 -> V_82 , L_27 ,
L_23 , V_89 ) ;
if ( V_88 ) {
V_85 = L_28 ;
goto V_95;
}
V_88 = F_37 ( V_87 , V_41 -> V_82 ,
L_29 ,
L_23 , 1 ) ;
if ( V_88 ) {
V_85 = L_30 ;
...
if ( V_88 )
F_39 ( L_46 ) ;
V_90 = F_40 ( V_81 , V_41 -> V_82 , L_47 , NULL ) ;
if ( F_41 ( V_90 ) ) {
V_88 = F_18 ( V_90 ) ;
F_34 ( V_41 , V_88 , L_48 ) ;
goto V_94;
...
{
struct V_76 * V_77 = F_23 ( & V_41 -> V_41 ) ;
F_39 ( L_57 , V_41 -> V_111 , F_54 ( V_110 ) ) ;
V_77 -> V_110 = V_110 ;
switch ( V_110 ) {
case V_93 :
F_24 ( V_77 , V_107 ) ;
...
* V_114 = ~ 0UL ;
* V_115 = 0 ;
V_120 = F_40 ( V_81 , V_41 -> V_82 , L_59 , NULL ) ;
if ( F_41 ( V_120 ) )
return;
V_116 = V_120 ;
...
int V_65 ;
V_122 = V_116 = F_40 ( V_81 , V_41 -> V_82 , L_61 , NULL ) ;
if ( F_41 ( V_122 ) )
return F_18 ( V_122 ) ;
...
int V_88 = 0 ;
char * V_130 ;
unsigned V_131 = strlen ( V_41 -> V_111 ) +
sizeof( L_66 ) ;
if ( V_40 -> V_134 . V_130 ) {
F_74 ( L_67 ) ;
return - V_132 ;
...
char * V_139 ;
unsigned int V_51 ;
V_139 = F_40 ( V_81 , V_77 -> V_41 -> V_82 , L_19 , & V_51 ) ;
if ( F_41 ( V_139 ) )
return;
if ( V_51 == sizeof( L_70 ) - 1 && ! memcmp ( V_139 , L_70 , V_51 ) ) {
F_35 ( V_77 -> V_41 , V_77 -> V_31 ) ;
F_25 ( V_77 ) ;
}
F_30 ( V_139 ) ;
}
...
const T_3 V_152 = 11 ;
if ( V_69 == 1 ) {
V_150 = F_33 ( strlen ( V_41 -> V_111 ) + 1 , V_91 ) ;
if ( ! V_150 ) {
F_34 ( V_41 , - V_92 ,
L_82 ) ;
return - V_92 ;
}
strcpy ( V_150 , V_41 -> V_111 ) ;
} else {
V_151 = strlen ( V_41 -> V_111 ) + V_152 ;
...
snprintf ( V_150 , V_151 , L_83 , V_41 -> V_111 ,
V_5 -> V_17 ) ;
}
...
unsigned int V_153 ;
int V_88 , V_135 ;
V_88 = F_45 ( V_81 , V_41 -> V_111 , L_93 , L_41 ,
& V_153 ) ;
if ( V_88 == - V_124 ) {
V_88 = 0 ;
V_153 = 0 ;
...
if ( F_45 ( V_81 , V_41 -> V_111 , L_22 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
V_40 -> V_157 = ! ! V_135 ;
V_40 -> V_158 = 0 ;
V_40 -> V_159 = 0 ;
if ( F_45 ( V_81 , V_41 -> V_111 , L_25 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
if ( V_135 )
V_40 -> V_158 |= F_96 ( V_160 ) ;
if ( F_45 ( V_81 , V_41 -> V_111 , L_96 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
if ( V_135 )
V_40 -> V_159 |= F_96 ( V_160 ) ;
if ( F_45 ( V_81 , V_41 -> V_111 , L_27 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
if ( V_135 )
V_40 -> V_158 |= F_96 ( V_161 ) ;
if ( F_45 ( V_81 , V_41 -> V_111 , L_97 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
if ( V_135 )
...
if ( F_45 ( V_81 , V_41 -> V_111 , L_100 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
V_40 -> V_162 = ! V_135 ;
if ( F_45 ( V_81 , V_41 -> V_111 , L_29 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
V_40 -> V_163 = ! ! V_135 ;
return 0 ;
