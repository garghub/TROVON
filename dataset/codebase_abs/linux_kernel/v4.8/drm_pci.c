...
F_33 ( V_10 , V_2 ) ;
F_23 ( V_2 ) ;
V_46 = F_34 ( V_2 , V_43 -> V_50 ) ;
if ( V_46 )
goto V_51;
F_35 ( L_4 ,
V_45 -> V_52 , V_45 -> V_53 , V_45 -> V_54 , V_45 -> V_55 ,
V_45 -> V_56 , F_36 ( V_10 ) , V_2 -> V_57 -> V_58 ) ;
if ( ! F_21 ( V_2 , V_33 ) )
F_37 ( & V_2 -> V_59 , & V_45 -> V_59 ) ;
return 0 ;
V_51:
F_27 ( V_2 ) ;
F_38 ( V_10 ) ;
...
int F_40 ( struct V_44 * V_45 , struct V_60 * V_61 )
{
struct V_41 * V_10 = NULL ;
const struct V_42 * V_62 ;
int V_63 ;
F_19 ( L_3 ) ;
if ( V_45 -> V_64 & V_33 )
return F_41 ( V_61 ) ;
F_42 ( & V_45 -> V_59 ) ;
for ( V_63 = 0 ; V_61 -> V_65 [ V_63 ] . V_66 != 0 ; V_63 ++ ) {
V_62 = & V_61 -> V_65 [ V_63 ] ;
V_10 = NULL ;
while ( ( V_10 =
F_43 ( V_62 -> V_66 , V_62 -> V_67 , V_62 -> V_68 ,
V_62 -> V_69 , V_10 ) ) != NULL ) {
if ( ( V_10 -> V_70 & V_62 -> V_71 ) != V_62 -> V_70 )
continue;
F_44 ( V_10 ) ;
F_30 ( V_10 , V_62 , V_45 ) ;
}
...
int F_45 ( struct V_1 * V_2 , T_3 * V_72 )
{
struct V_41 * V_73 ;
T_3 V_74 , V_75 ;
* V_72 = 0 ;
...
F_35 ( L_5 , V_73 -> V_66 , V_73 -> V_67 , V_74 , V_75 ) ;
return 0 ;
}
int F_47 ( struct V_1 * V_2 , T_3 * V_89 )
{
struct V_41 * V_73 ;
T_3 V_74 ;
* V_89 = 0 ;
...
F_46 ( V_73 , V_79 , & V_74 ) ;
* V_89 = ( V_74 & V_90 ) >> 4 ;
F_35 ( L_6 , V_73 -> V_66 , V_73 -> V_67 , V_74 ) ;
return 0 ;
}
int F_40 ( struct V_44 * V_45 , struct V_60 * V_61 )
{
...
void F_48 ( struct V_44 * V_45 , struct V_60 * V_61 )
{
struct V_1 * V_2 , * V_91 ;
F_19 ( L_3 ) ;
if ( V_45 -> V_64 & V_33 ) {
...
F_50 (dev, tmp, &driver->legacy_dev_list,
legacy_dev_list) {
F_51 ( & V_2 -> V_59 ) ;
F_52 ( V_2 ) ;
}
