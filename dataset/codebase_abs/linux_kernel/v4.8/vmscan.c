...
{
if ( F_208 ( V_267 ) && V_2 -> V_188 &&
( V_2 -> V_188 > V_268 ||
V_2 -> V_154 < V_155 - 2 ) )
return true ;
return false ;
}
static inline bool F_209 ( struct V_13 * V_14 ,
unsigned long V_127 ,
unsigned long V_39 ,
struct V_1 * V_2 )
{
...
if ( V_2 -> V_127 - V_127 )
V_275 = true ;
} while ( F_209 ( V_14 , V_2 -> V_127 - V_127 ,
V_2 -> V_39 - V_39 , V_2 ) );
return V_275 ;
}
...
unsigned long V_284 ;
bool V_285 ;
V_284 = F_199 ( V_7 ) + ( 2UL << V_2 -> V_188 ) ;
V_285 = F_217 ( V_7 , 0 , V_284 , V_2 -> V_185 ) ;
if ( F_218 ( V_7 , V_2 -> V_188 ) )
return V_285 ;
if ( F_210 ( V_7 , V_2 -> V_188 , 0 , V_2 -> V_185 ) == V_286 )
return false ;
return V_285 ;
}
static void F_219 ( struct V_287 * V_287 , struct V_1 * V_2 )
{
struct V_288 * V_247 ;
struct V_7 * V_7 ;
unsigned long V_289 ;
...
if ( V_220 ) {
V_2 -> V_57 |= V_293 ;
V_2 -> V_185 = F_220 ( V_2 -> V_57 ) ;
}
F_221 (zone, z, zonelist,
...
static unsigned long F_224 ( struct V_287 * V_287 ,
struct V_1 * V_2 )
{
int V_295 = V_2 -> V_154 ;
...
F_225 () ;
if ( F_1 ( V_2 ) )
F_152 ( V_299 , V_2 -> V_185 , 1 ) ;
do {
F_226 ( V_2 -> V_57 , V_2 -> V_3 ,
V_2 -> V_154 ) ;
V_2 -> V_39 = 0 ;
F_219 ( V_287 , V_2 ) ;
V_296 += V_2 -> V_39 ;
...
return true ;
V_304 = V_122 > V_302 / 2 ;
if ( ! V_304 && F_231 ( & V_14 -> V_306 ) ) {
V_14 -> V_307 = F_28 ( V_14 -> V_307 ,
(enum V_308 ) V_305 ) ;
F_232 ( & V_14 -> V_306 ) ;
}
return V_304 ;
}
static bool F_233 ( T_2 V_57 , struct V_287 * V_287 ,
T_10 * V_309 )
{
struct V_288 * V_247 ;
struct V_7 * V_7 ;
...
unsigned long F_237 ( struct V_287 * V_287 , int V_188 ,
T_2 V_57 , T_10 * V_309 )
{
unsigned long V_127 ;
struct V_1 V_2 = {
. V_258 = V_58 ,
. V_57 = ( V_57 = F_238 ( V_57 ) ) ,
. V_185 = F_220 ( V_57 ) ,
. V_188 = V_188 ,
. V_309 = V_309 ,
. V_154 = V_155 ,
...
if ( F_233 ( V_57 , V_287 , V_309 ) )
return 1 ;
F_239 ( V_188 ,
V_2 . V_150 ,
V_57 ,
V_2 . V_185 ) ;
V_127 = F_224 ( V_287 , & V_2 ) ;
F_240 ( V_127 ) ;
return V_127 ;
}
...
static bool F_251 ( struct V_7 * V_7 , int V_188 , int V_318 )
{
unsigned long V_319 = F_199 ( V_7 ) ;
if ( ! F_217 ( V_7 , V_188 , V_319 , V_318 ) )
return false ;
F_252 ( V_210 , & V_7 -> V_163 -> V_29 ) ;
F_252 ( V_148 , & V_7 -> V_163 -> V_29 ) ;
return true ;
}
static bool F_253 ( T_9 * V_14 , int V_188 , int V_318 )
{
int V_303 ;
if ( F_231 ( & V_14 -> V_312 ) )
F_254 ( & V_14 -> V_312 ) ;
for ( V_303 = 0 ; V_303 <= V_318 ; V_303 ++ ) {
struct V_7 * V_7 = V_14 -> V_199 + V_303 ;
if ( ! F_178 ( V_7 ) )
continue;
if ( ! F_251 ( V_7 , V_188 , V_318 ) )
return false ;
}
return true ;
}
...
if ( ! F_178 ( V_7 ) )
continue;
V_2 -> V_258 += F_245 ( F_199 ( V_7 ) , V_58 ) ;
}
F_211 ( V_14 , V_2 ) ;
if ( V_2 -> V_188 && V_2 -> V_127 >= 2UL << V_2 -> V_188 )
V_2 -> V_188 = 0 ;
return V_2 -> V_39 >= V_2 -> V_258 ;
}
static int F_256 ( T_9 * V_14 , int V_188 , int V_318 )
{
int V_303 ;
unsigned long V_289 ;
unsigned long V_290 ;
...
V_2 . V_185 = V_318 ;
if ( V_220 ) {
for ( V_303 = V_177 - 1 ; V_303 >= 0 ; V_303 -- ) {
V_7 = V_14 -> V_199 + V_303 ;
if ( ! F_178 ( V_7 ) )
continue;
V_2 . V_185 = V_303 ;
...
for ( V_303 = V_318 ; V_303 >= 0 ; V_303 -- ) {
V_7 = V_14 -> V_199 + V_303 ;
if ( ! F_178 ( V_7 ) )
continue;
if ( F_251 ( V_7 , V_2 . V_188 , V_318 ) )
goto V_59;
}
F_250 ( V_14 , & V_2 ) ;
...
if ( F_261 ( V_63 ) || F_258 () )
return;
F_262 ( & V_14 -> V_306 , & V_325 , V_326 ) ;
if ( F_253 ( V_14 , V_323 , V_318 ) ) {
F_263 ( V_14 ) ;
F_264 ( V_14 , V_322 , V_318 ) ;
V_324 = F_265 ( V_204 / 10 ) ;
if ( V_324 ) {
V_14 -> V_307 = F_245 ( V_14 -> V_307 , V_318 ) ;
V_14 -> V_327 = F_245 ( V_14 -> V_327 , V_323 ) ;
}
F_266 ( & V_14 -> V_306 , & V_325 ) ;
F_262 ( & V_14 -> V_306 , & V_325 , V_326 ) ;
}
if ( ! V_324 &&
...
T_9 * V_14 = ( T_9 * ) V_332 ;
struct V_333 * V_334 = V_63 ;
struct V_274 V_274 = {
. V_283 = 0 ,
} ;
const struct V_335 * V_335 = F_271 ( V_14 -> V_212 ) ;
F_272 ( V_32 ) ;
if ( ! F_273 ( V_335 ) )
F_274 ( V_334 , V_335 ) ;
V_63 -> V_274 = & V_274 ;
V_334 -> V_29 |= V_336 | V_64 | V_337 ;
F_275 () ;
...
void F_278 ( struct V_7 * V_7 , int V_188 , enum V_308 V_318 )
{
T_9 * V_14 ;
int V_247 ;
if ( ! F_178 ( V_7 ) )
return;
if ( ! F_222 ( V_7 , V_32 | V_294 ) )
return;
V_14 = V_7 -> V_163 ;
V_14 -> V_307 = F_245 ( V_14 -> V_307 , V_318 ) ;
V_14 -> V_327 = F_245 ( V_14 -> V_327 , V_188 ) ;
if ( ! F_231 ( & V_14 -> V_306 ) )
return;
for ( V_247 = 0 ; V_247 <= V_318 ; V_247 ++ ) {
V_7 = V_14 -> V_199 + V_247 ;
if ( ! F_178 ( V_7 ) )
continue;
if ( F_251 ( V_7 , V_188 , V_318 ) )
...
F_279 ( V_14 -> V_212 , F_234 ( V_7 ) , V_188 ) ;
F_232 ( & V_14 -> V_306 ) ;
}
unsigned long F_280 ( unsigned long V_258 )
{
struct V_274 V_274 ;
struct V_1 V_2 = {
. V_258 = V_258 ,
...
struct V_287 * V_287 = F_281 ( F_282 () , V_2 . V_57 ) ;
struct V_333 * V_332 = V_63 ;
unsigned long V_127 ;
V_332 -> V_29 |= V_336 ;
F_272 ( V_2 . V_57 ) ;
V_274 . V_283 = 0 ;
...
static int F_283 ( struct V_339 * V_340 , unsigned long V_341 ,
void * V_342 )
{
int V_46 ;
if ( V_341 == V_343 || V_341 == V_344 ) {
F_284 (nid, N_MEMORY) {
T_9 * V_14 = F_247 ( V_46 ) ;
const struct V_335 * V_345 ;
V_345 = F_271 ( V_14 -> V_212 ) ;
if ( F_285 ( V_346 , V_345 ) < V_347 )
F_274 ( V_14 -> F_270 , V_345 ) ;
}
}
return V_348 ;
}
...
if ( V_14 -> F_270 )
return 0 ;
V_14 -> F_270 = F_287 ( F_270 , V_14 , L_4 , V_46 ) ;
if ( F_288 ( V_14 -> F_270 ) ) {
F_67 ( V_349 == V_350 ) ;
F_27 ( L_5 , V_46 ) ;
V_53 = F_289 ( V_14 -> F_270 ) ;
V_14 -> F_270 = NULL ;
}
return V_53 ;
}
void F_290 ( int V_46 )
{
struct V_333 * F_270 = F_247 ( V_46 ) -> F_270 ;
if ( F_270 ) {
F_291 ( F_270 ) ;
F_247 ( V_46 ) -> F_270 = NULL ;
}
}
...
static inline unsigned long F_295 ( struct V_13 * V_14 )
{
unsigned long V_351 = F_14 ( V_14 , V_352 ) ;
unsigned long V_353 = F_14 ( V_14 , V_16 ) +
F_14 ( V_14 , V_15 ) ;
return ( V_353 > V_351 ) ? ( V_353 - V_351 ) : 0 ;
}
static unsigned long F_296 ( struct V_13 * V_14 )
{
unsigned long V_354 ;
unsigned long V_42 = 0 ;
if ( V_355 & V_356 )
V_354 = F_14 ( V_14 , V_357 ) ;
else
V_354 = F_295 ( V_14 ) ;
if ( ! ( V_355 & V_358 ) )
V_42 += F_14 ( V_14 , V_359 ) ;
if ( F_71 ( V_42 > V_354 ) )
V_42 = V_354 ;
return V_354 - V_42 ;
}
static int F_297 ( struct V_13 * V_14 , T_2 V_57 , unsigned int V_188 )
{
const unsigned long V_183 = 1 << V_188 ;
struct V_333 * V_332 = V_63 ;
struct V_274 V_274 ;
int V_318 = F_220 ( V_57 ) ;
struct V_1 V_2 = {
. V_258 = F_245 ( V_183 , V_58 ) ,
. V_57 = ( V_57 = F_238 ( V_57 ) ) ,
. V_188 = V_188 ,
...
F_31 () ;
V_332 -> V_29 |= V_336 | V_64 ;
F_272 ( V_57 ) ;
V_274 . V_283 = 0 ;
V_332 -> V_274 = & V_274 ;
if ( F_296 ( V_14 ) > V_14 -> V_361 ) {
do {
F_211 ( V_14 , & V_2 ) ;
} while ( V_2 . V_127 < V_183 && -- V_2 . V_154 >= 0 );
}
V_332 -> V_274 = NULL ;
V_63 -> V_29 &= ~ ( V_336 | V_64 ) ;
F_277 () ;
return V_2 . V_127 >= V_183 ;
}
int F_298 ( struct V_13 * V_14 , T_2 V_57 , unsigned int V_188 )
{
int V_53 ;
if ( F_296 ( V_14 ) <= V_14 -> V_361 &&
F_198 ( V_14 -> V_212 , V_362 ) <= V_14 -> V_363 )
return V_364 ;
if ( ! F_10 ( V_14 ) )
return V_364 ;
if ( ! F_299 ( V_57 ) || ( V_63 -> V_29 & V_336 ) )
return V_365 ;
if ( F_300 ( V_14 -> V_212 , V_366 ) && V_14 -> V_212 != F_282 () )
return V_365 ;
if ( F_301 ( V_367 , & V_14 -> V_29 ) )
return V_365 ;
V_53 = F_297 ( V_14 , V_57 , V_188 ) ;
F_252 ( V_367 , & V_14 -> V_29 ) ;
if ( ! V_53 )
F_98 ( V_368 ) ;
return V_53 ;
}
...
{
return ! F_302 ( F_53 ( V_61 ) ) && ! F_303 ( V_61 ) ;
}
void F_304 ( struct V_61 * * V_369 , int V_183 )
{
struct V_22 * V_22 ;
...
int V_371 = 0 ;
int V_303 ;
for ( V_303 = 0 ; V_303 < V_183 ; V_303 ++ ) {
struct V_61 * V_61 = V_369 [ V_303 ] ;
struct V_13 * V_372 = F_305 ( V_61 ) ;
V_370 ++ ;
if ( V_372 != V_14 ) {
if ( V_14 )
F_164 ( & V_14 -> V_195 ) ;
...
continue;
if ( F_92 ( V_61 ) ) {
enum V_23 V_24 = F_306 ( V_61 ) ;
F_89 ( F_110 ( V_61 ) , V_61 ) ;
F_91 ( V_61 ) ;
F_163 ( V_61 , V_22 , V_373 ) ;
F_168 ( V_61 , V_22 , V_24 ) ;
V_371 ++ ;
}
}
