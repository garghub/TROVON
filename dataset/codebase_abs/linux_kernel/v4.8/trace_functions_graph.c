...
static void F_50 ( struct V_56 * V_57 , int V_47 )
{
F_51 ( V_57 , L_3 , V_58 , V_47 ) ;
}
static void F_52 ( struct V_56 * V_57 , T_2 V_59 )
{
char V_60 [ V_61 ] ;
char V_62 [ 11 ] ;
int V_63 = 0 ;
...
F_54 ( V_57 , ' ' ) ;
F_51 ( V_57 , L_5 , V_60 , V_62 ) ;
for ( V_65 = 0 ; V_65 < V_63 - ( V_63 / 2 ) ; V_65 ++ )
F_54 ( V_57 , ' ' ) ;
}
static void F_55 ( struct V_56 * V_57 , struct V_67 * V_38 )
{
F_54 ( V_57 , ' ' ) ;
F_56 ( V_57 , V_38 ) ;
}
static void
F_57 ( struct V_56 * V_57 , T_2 V_59 , int V_47 , struct V_68 * V_45 )
{
T_2 V_69 ;
T_2 * V_70 ;
if ( ! V_45 )
...
V_77 = F_60 ( V_73 , V_73 -> V_47 ) ;
if ( V_77 )
V_33 = F_61 ( V_77 , NULL ) ;
else {
F_62 ( V_73 -> V_36 -> V_35 , V_73 -> V_47 ,
NULL , NULL ) ;
V_33 = F_63 ( V_73 -> V_36 -> V_35 , V_73 -> V_47 ,
NULL , NULL ) ;
}
if ( ! V_33 )
return NULL ;
...
static void F_65 ( T_1 V_80 , struct V_56 * V_57 )
{
unsigned long V_81 ;
V_81 = F_66 ( V_80 , V_82 ) ;
V_81 /= 1000 ;
...
static void
F_67 ( struct V_72 * V_73 , unsigned long V_83 ,
...
F_68 ( V_25 , 0 , V_57 , V_27 | V_95 ) ;
if ( type == V_39 )
F_58 ( V_57 , L_11 ) ;
else
F_58 ( V_57 , L_12 ) ;
F_68 ( V_25 , 0 , V_57 , V_27 | V_96 ) ;
F_54 ( V_57 , '\n' ) ;
}
void
F_69 ( unsigned long long V_97 , struct V_56 * V_57 )
{
unsigned long V_98 = F_66 ( V_97 , 1000 ) ;
char V_99 [ 21 ] ;
char V_100 [ 5 ] ;
int V_64 ;
int V_65 ;
...
V_64 = strlen ( V_99 ) ;
if ( V_64 < 7 ) {
T_4 V_101 = F_70 ( T_4 , sizeof( V_100 ) , 8UL - V_64 ) ;
snprintf ( V_100 , V_101 , L_15 , V_98 ) ;
F_51 ( V_57 , L_16 , V_100 ) ;
V_64 += strlen ( V_100 ) + 1 ;
}
F_58 ( V_57 , L_17 ) ;
...
static void
F_68 ( struct V_24 * V_25 , unsigned long long V_97 ,
...
F_68 ( V_25 , V_97 , V_57 , V_27 ) ;
for ( V_65 = 0 ; V_65 < V_30 -> V_4 * V_111 ; V_65 ++ )
F_54 ( V_57 , ' ' ) ;
F_51 ( V_57 , L_23 , ( void * ) V_30 -> V_3 ) ;
return F_73 ( V_57 ) ;
}
static enum V_106
...
F_68 ( V_25 , 0 , V_57 , V_27 | V_104 ) ;
for ( V_65 = 0 ; V_65 < V_30 -> V_4 * V_111 ; V_65 ++ )
F_54 ( V_57 , ' ' ) ;
F_51 ( V_57 , L_24 , ( void * ) V_30 -> V_3 ) ;
if ( F_75 ( V_57 ) )
return V_112 ;
return V_113 ;
}
static void
F_76 ( struct V_72 * V_73 , struct V_56 * V_57 ,
...
struct V_24 * V_25 = V_73 -> V_25 ;
int V_47 = V_73 -> V_47 ;
F_57 ( V_57 , V_51 -> V_59 , V_47 , V_45 ) ;
if ( type )
F_67 ( V_73 , V_83 , type , V_47 , V_51 -> V_59 , V_27 ) ;
if ( ! ( V_25 -> V_88 & V_89 ) )
return;
if ( V_27 & V_90 )
F_65 ( V_73 -> V_91 , V_57 ) ;
...
static int
F_77 ( struct V_72 * V_73 , T_3 V_27 ,
...
static int
F_78 ( struct V_72 * V_73 , T_3 V_27 , int V_4 )
{
int V_47 = V_73 -> V_47 ;
int * V_114 ;
struct V_68 * V_45 = V_73 -> V_75 ;
...
static enum V_106
F_79 ( struct V_37 * V_116 , struct V_56 * V_57 ,
...
int V_47 = V_73 -> V_47 ;
if ( F_77 ( V_73 , V_27 , V_30 -> V_3 , V_30 -> V_4 ) )
return V_118 ;
F_76 ( V_73 , V_57 , V_39 , V_30 -> V_3 , V_27 ) ;
V_117 = F_59 ( V_73 , V_116 ) ;
if ( V_117 )
V_2 = F_72 ( V_73 , V_116 , V_117 , V_57 , V_27 ) ;
else
V_2 = F_74 ( V_73 , V_116 , V_57 , V_47 , V_27 ) ;
if ( V_45 ) {
if ( V_57 -> V_119 ) {
V_45 -> V_79 = 1 ;
V_45 -> V_47 = V_47 ;
...
static enum V_106
F_80 ( struct V_17 * V_18 , struct V_56 * V_57 ,
...
F_51 ( V_57 , L_26 , ( void * ) V_18 -> V_3 ) ;
if ( V_27 & V_122 )
F_51 ( V_57 , L_27 ,
V_18 -> V_22 ) ;
F_67 ( V_73 , V_18 -> V_3 , V_55 ,
V_47 , V_59 , V_27 ) ;
return F_73 ( V_57 ) ;
}
static enum V_106
F_81 ( struct V_56 * V_57 , struct V_67 * V_51 ,
struct V_72 * V_73 , T_3 V_27 )
{
struct V_24 * V_25 = V_73 -> V_25 ;
...
enum V_106
F_85 ( struct V_72 * V_73 , T_3 V_27 )
{
struct V_37 * V_116 ;
struct V_68 * V_45 = V_73 -> V_75 ;
...
F_86 ( V_116 , V_38 ) ;
V_132 = * V_116 ;
return F_79 ( & V_132 , V_57 , V_73 , V_27 ) ;
}
case V_55 : {
struct V_54 * V_116 ;
F_86 ( V_116 , V_38 ) ;
return F_80 ( & V_116 -> V_2 , V_57 , V_38 , V_73 , V_27 ) ;
}
case V_133 :
case V_134 :
return V_128 ;
default:
return F_81 ( V_57 , V_38 , V_73 , V_27 ) ;
}
return V_118 ;
}
static enum V_106
...
{
return F_85 ( V_73 , V_135 . V_136 ) ;
}
static enum V_106
F_88 ( struct V_72 * V_73 , int V_27 ,
struct V_125 * V_33 )
{
return F_87 ( V_73 ) ;
}
static void F_89 ( struct V_137 * V_57 , T_3 V_27 )
{
...
if ( V_27 & V_93 )
V_138 += 17 ;
F_90 ( V_57 , L_33 , V_138 , V_63 ) ;
F_90 ( V_57 , L_34 , V_138 , V_63 ) ;
F_90 ( V_57 , L_35 , V_138 , V_63 ) ;
F_90 ( V_57 , L_36 , V_138 , V_63 ) ;
F_90 ( V_57 , L_37 , V_138 , V_63 ) ;
}
...
static void F_94 ( struct V_137 * V_57 )
{
F_95 ( V_57 , V_135 . V_136 ) ;
}
void F_95 ( struct V_137 * V_57 , T_3 V_27 )
{
...
int V_47 ;
V_73 -> V_75 = NULL ;
V_140 = ( F_99 () || F_100 () ) ? V_141 : V_142 ;
V_45 = F_101 ( sizeof( * V_45 ) , V_140 ) ;
if ( ! V_45 )
goto V_143;
V_45 -> V_71 = F_102 ( struct V_109 , V_140 ) ;
if ( ! V_45 -> V_71 )
goto V_144;
F_103 (cpu) {
...
static int
F_108 ( struct V_24 * V_25 , T_3 V_145 , T_3 V_146 , int V_147 )
{
if ( V_146 == V_115 )
V_41 = ! V_147 ;
if ( V_146 == V_148 )
...
static T_6
F_111 ( struct V_150 * V_151 , const char T_7 * V_152 , T_4 V_153 ,
T_8 * V_154 )
{
unsigned long V_136 ;
int V_2 ;
V_2 = F_112 ( V_152 , V_153 , 10 , & V_136 ) ;
if ( V_2 )
return V_2 ;
V_48 = V_136 ;
* V_154 += V_153 ;
...
static T_6
F_113 ( struct V_150 * V_151 , char T_7 * V_152 , T_4 V_153 ,
T_8 * V_154 )
{
char V_155 [ 15 ] ;
int V_156 ;
V_156 = sprintf ( V_155 , L_50 , V_48 ) ;
return F_114 ( V_152 , V_153 , V_154 , V_155 , V_156 ) ;
}
static T_9 int F_115 ( void )
{
struct V_157 * V_158 ;
V_158 = F_116 () ;
if ( F_117 ( V_158 ) )
return 0 ;
F_118 ( L_51 , 0644 , V_158 ,
NULL , & V_159 ) ;
return 0 ;
}
