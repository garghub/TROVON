...
{
return F_46 ( F_30 ( V_29 -> V_96 ) -> V_94 , V_97 ) ;
}
int
F_47 ( const unsigned char * V_13 , int V_98 , bool V_99 )
{
int V_100 ;
if ( V_98 > V_101 ) {
if ( V_99 )
...
if ( V_13 [ V_100 ] < ' ' || V_13 [ V_100 ] == ':'
|| ( V_13 [ V_100 ] > 0x7e && V_13 [ V_100 ] < 0xa0 ) )
return - V_103 ;
}
return 0 ;
}
int
F_48 ( unsigned char * V_104 , struct V_29 * V_29 )
{
T_1 V_98 = F_49 ( V_29 -> V_105 . V_98 , V_101 ) ;
* V_104 ++ = V_98 ;
memcpy ( V_104 , V_29 -> V_105 . V_13 , V_98 ) ;
return V_98 ;
}
