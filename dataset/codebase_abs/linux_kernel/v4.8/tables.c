...
if ( V_97 . V_88 != V_78 -> V_69 ) {
F_6 ( L_28 ,
V_95 , V_97 . V_99 ) ;
continue;
}
if ( F_17 ( V_97 . V_86 , V_78 -> V_69 ) ) {
F_6 ( L_29 ,
V_95 , V_97 . V_99 ) ;
continue;
}
F_3 ( L_30 ,
V_78 -> V_79 , V_95 , V_97 . V_99 , V_78 -> V_69 ) ;
V_101 += V_78 -> V_69 ;
...
T_9 V_88 = V_102 [ V_91 ] . V_88 ;
T_9 V_107 = V_103 + V_93 ;
T_9 V_108 , V_109 ;
char * V_110 ;
V_93 += V_88 ;
while ( V_88 ) {
...
V_109 = V_112 - V_108 ;
V_110 = F_24 ( V_107 & V_111 ,
V_109 + V_108 ) ;
memcpy ( V_110 + V_108 , V_106 , V_109 ) ;
F_25 ( V_110 , V_109 + V_108 ) ;
V_106 += V_109 ;
V_107 += V_109 ;
V_88 -= V_109 ;
}
...
V_78 = F_27 ( V_103 + V_114 ,
V_118 ) ;
if ( V_114 + V_78 -> V_69 > V_101 ) {
F_28 ( V_78 , V_118 ) ;
F_21 ( 1 ) ;
return V_117 ;
}
...
V_116 = V_78 -> V_69 ;
if ( F_31 ( V_78 -> V_79 , V_125 ) ||
F_31 ( V_78 -> V_79 , V_126 ) ) {
F_28 ( V_78 , V_118 ) ;
goto V_122;
}
if ( F_29 ( V_115 , V_123 ) ) {
...
T_5 * V_116 )
{
return F_26 ( V_113 , V_16 ,
V_116 ) ;
}
T_10
F_34 ( struct V_56 * V_113 ,
struct V_56 * * V_127 )
{
if ( ! V_113 || ! V_127 )
return V_128 ;
...
static int T_2 F_39 ( char * V_135 )
{
if ( ! V_135 )
return - V_68 ;
if ( F_40 ( V_135 , 0 , & V_75 ) )
return - V_68 ;
F_41 ( L_36 , V_75 ) ;
return 0 ;
}
...
static int T_2 F_43 ( char * V_136 )
{
F_3 ( L_37 ) ;
V_137 = TRUE ;
return 0 ;
