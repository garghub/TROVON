...
{
struct V_101 * V_115 = V_45 -> V_42 . V_116 ;
struct V_6 * V_7 ;
T_5 V_117 = 0 ;
struct V_4 * V_5 ;
int V_68 ;
F_48 ( V_47 ) ;
V_7 = F_49 ( & V_45 -> V_42 , sizeof( * V_7 ) , V_118 ) ;
if ( ! V_7 )
return - V_119 ;
V_7 -> V_102 = F_50 ( V_45 -> V_42 . V_116 ) ;
V_7 -> V_42 = & V_45 -> V_42 ;
V_7 -> V_28 = V_120 ;
if ( F_51 ( V_7 -> V_102 , L_14 ) )
V_7 -> V_28 = V_29 ;
V_68 = F_23 ( V_7 , V_45 ) ;
if ( V_68 )
return V_68 ;
...
if ( V_68 )
return V_68 ;
V_68 = F_52 ( V_115 , 0 , 0xff , & V_47 , & V_117 ) ;
if ( V_68 )
return V_68 ;
V_68 = F_53 ( & V_45 -> V_42 , & V_47 ) ;
if ( V_68 )
goto error;
V_68 = F_45 ( V_7 , & V_47 , V_117 ) ;
if ( V_68 )
goto error;
V_5 = F_54 ( & V_45 -> V_42 , 0 ,
& V_121 , V_7 , & V_47 ) ;
if ( ! V_5 ) {
V_68 = - V_119 ;
goto error;
