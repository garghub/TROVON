...
int F_4 ( T_2 V_3 , struct V_7 * V_8 )
{
T_1 V_1 , V_2 ;
do {
V_1 = F_3 ( V_3 , V_8 , & V_2 ) ;
...
static inline T_1 F_6 ( T_2 V_11 , T_2 V_12 , T_2 V_13 , T_1 * V_2 )
{
register T_2 T_3 V_14 ( L_1 ) = V_12 ;
register T_2 T_4 V_14 ( L_2 ) = V_13 ;
T_1 V_1 ;
asm volatile (
...
int F_7 ( T_2 V_11 , T_2 V_12 , T_2 V_13 )
{
T_1 V_1 , V_2 ;
do {
V_1 = F_6 ( V_11 , V_12 , V_13 , & V_2 ) ;
if ( V_1 == 2 )
F_8 ( V_9 ) ;
} while ( V_1 == 2 );
if ( V_1 )
...
{
register T_2 T_6 V_14 ( L_1 ) = V_3 ;
register T_2 T_7 V_14 ( L_2 ) = V_4 ;
int V_1 = - V_18 ;
T_2 V_19 ;
asm volatile (
