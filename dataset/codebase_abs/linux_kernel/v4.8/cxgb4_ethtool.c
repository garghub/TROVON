...
return - V_278 ;
V_235 -> V_279 = V_280 ;
for ( V_36 = V_235 -> V_281 & ~ 3 ; ! V_259 && V_36 < V_235 -> V_281 + V_235 -> V_282 ; V_36 += 4 )
V_259 = F_71 ( V_12 , V_36 , ( T_1 * ) & V_131 [ V_36 ] ) ;
if ( ! V_259 )
memcpy ( V_31 , V_131 + V_235 -> V_281 , V_235 -> V_282 ) ;
F_77 ( V_131 ) ;
return V_259 ;
}
static int F_78 ( struct V_1 * V_2 , struct V_277 * V_283 ,
T_2 * V_31 )
{
T_2 * V_131 ;
int V_259 = 0 ;
T_1 V_284 , V_285 , * V_33 ;
struct V_12 * V_12 = F_2 ( V_2 ) ;
if ( V_283 -> V_279 != V_280 )
return - V_137 ;
V_284 = V_283 -> V_281 & ~ 3 ;
V_285 = ( V_283 -> V_282 + ( V_283 -> V_281 & 3 ) + 3 ) & ~ 3 ;
if ( V_12 -> V_138 > 0 ) {
T_1 V_286 = 1024 + V_12 -> V_138 * V_276 ;
if ( V_284 < V_286 ||
V_284 + V_285 > V_286 + V_276 )
return - V_287 ;
}
if ( V_284 != V_283 -> V_281 || V_285 != V_283 -> V_282 ) {
V_131 = F_76 ( V_285 ) ;
if ( ! V_131 )
return - V_278 ;
V_259 = F_71 ( V_12 , V_284 , ( T_1 * ) V_131 ) ;
if ( ! V_259 && V_285 > 4 )
V_259 = F_71 ( V_12 ,
V_284 + V_285 - 4 ,
( T_1 * ) & V_131 [ V_285 - 4 ] ) ;
if ( V_259 )
goto V_288;
memcpy ( V_131 + ( V_283 -> V_281 & 3 ) , V_31 , V_283 -> V_282 ) ;
} else {
V_131 = V_31 ;
}
...
if ( V_259 )
goto V_288;
for ( V_33 = ( T_1 * ) V_131 ; ! V_259 && V_285 ; V_285 -= 4 , V_33 ++ ) {
V_259 = F_73 ( V_12 , V_284 , * V_33 ) ;
V_284 += 4 ;
}
if ( ! V_259 )
...
static int F_80 ( struct V_1 * V_289 , struct V_290 * V_291 )
{
int V_221 ;
const struct V_292 * V_293 ;
struct V_12 * V_13 = F_2 ( V_289 ) ;
unsigned int V_224 = V_294 + 1 ;
T_1 V_295 ;
unsigned int V_296 ;
T_2 V_297 = 0 ;
V_295 = F_28 ( V_13 , V_298 ) ;
V_296 = F_81 ( V_295 ) ;
if ( V_295 & V_299 )
V_297 = 1 ;
if ( V_297 && ( V_296 != V_13 -> V_138 ) ) {
F_82 ( V_13 -> V_300 ,
L_4 ) ;
return - V_11 ;
}
V_291 -> V_31 [ sizeof( V_291 -> V_31 ) - 1 ] = '\0' ;
V_221 = F_83 ( & V_293 , V_291 -> V_31 , V_13 -> V_300 ) ;
if ( V_221 < 0 )
return V_221 ;
if ( V_13 -> V_254 & V_255 )
V_224 = V_13 -> V_224 ;
V_221 = F_84 ( V_13 , V_224 , V_293 -> V_31 , V_293 -> V_245 , 1 ) ;
F_85 ( V_293 ) ;
if ( ! V_221 )
F_86 ( V_13 -> V_300 ,
L_5 , V_291 -> V_31 ) ;
...
static int F_87 ( struct V_1 * V_2 , struct V_301 * V_302 )
{
V_302 -> V_303 = V_304 |
V_305 |
V_306 ;
...
static int F_89 ( struct V_1 * V_2 , T_1 * V_33 , T_2 * V_311 , T_2 * V_312 )
{
const struct V_32 * V_122 = F_34 ( V_2 ) ;
unsigned int V_313 = V_122 -> V_310 ;
if ( V_312 )
* V_312 = V_314 ;
if ( ! V_33 )
return 0 ;
while ( V_313 -- )
V_33 [ V_313 ] = V_122 -> V_315 [ V_313 ] ;
return 0 ;
}
static int F_90 ( struct V_1 * V_2 , const T_1 * V_33 , const T_2 * V_311 ,
const T_2 V_312 )
{
unsigned int V_36 ;
struct V_32 * V_122 = F_34 ( V_2 ) ;
if ( V_311 ||
( V_312 != V_316 && V_312 != V_314 ) )
return - V_11 ;
if ( ! V_33 )
return 0 ;
if ( V_122 -> V_12 -> V_254 & V_255 ) {
for ( V_36 = 0 ; V_36 < V_122 -> V_310 ; V_36 ++ )
V_122 -> V_315 [ V_36 ] = V_33 [ V_36 ] ;
return F_91 ( V_122 , V_122 -> V_315 ) ;
}
return - V_287 ;
}
static int F_92 ( struct V_1 * V_2 , struct V_317 * V_16 ,
T_1 * V_318 )
{
const struct V_32 * V_122 = F_34 ( V_2 ) ;
switch ( V_16 -> V_319 ) {
case V_320 : {
unsigned int V_95 = V_122 -> V_321 ;
V_16 -> V_31 = 0 ;
switch ( V_16 -> V_322 ) {
case V_323 :
if ( V_95 & V_324 )
V_16 -> V_31 = V_325 | V_326 |
V_327 | V_328 ;
else if ( V_95 & V_329 )
V_16 -> V_31 = V_325 | V_326 ;
break;
