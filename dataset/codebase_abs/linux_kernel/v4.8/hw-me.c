...
static unsigned char F_38 ( struct V_6 * V_7 )
{
T_1 V_28 ;
char V_50 , V_51 ;
V_28 = F_10 ( V_7 ) ;
...
static T_2 F_41 ( const struct V_6 * V_7 )
{
...
int V_23 ;
int V_55 ;
F_37 ( V_7 -> V_7 , V_64 , F_43 ( V_58 ) ) ;
V_55 = F_44 ( V_7 ) ;
F_37 ( V_7 -> V_7 , L_8 , V_55 ) ;
V_63 = F_45 ( V_61 ) ;
if ( V_55 < 0 || V_63 > V_55 )
return - V_65 ;
F_7 ( V_7 , * ( ( T_1 * ) V_58 ) ) ;
...
if ( V_54 > V_68 )
return - V_56 ;
F_37 ( V_7 -> V_7 , L_9 , V_54 ) ;
return ( int ) V_54 ;
}
static int F_47 ( struct V_6 * V_7 , unsigned char * V_72 ,
unsigned long V_73 )
{
T_1 * V_62 = ( T_1 * ) V_72 ;
T_1 V_28 ;
...
T_1 V_11 ;
V_11 = F_1 ( V_2 , V_74 ) ;
F_9 ( V_7 -> V_7 , L_10 , V_74 , V_11 ) ;
V_11 |= V_75 ;
F_12 ( V_7 -> V_7 , L_10 , V_74 , V_11 ) ;
F_3 ( V_2 , V_74 , V_11 ) ;
}
...
static T_1 F_56 ( struct V_6 * V_7 , bool V_98 )
{
T_1 V_11 = F_14 ( V_7 ) ;
V_11 |= V_36 ;
if ( V_98 )
...
{
struct V_1 * V_2 = F_6 ( V_7 ) ;
unsigned long V_100 = F_33 ( V_101 ) ;
unsigned long V_102 = F_33 ( V_78 ) ;
int V_22 ;
T_1 V_11 ;
V_11 = F_14 ( V_7 ) ;
if ( V_11 & V_36 ) {
...
static int F_69 ( struct V_6 * V_7 , bool V_111 )
{
struct V_1 * V_2 = F_6 ( V_7 ) ;
int V_22 ;
T_1 V_28 ;
...
V_28 = F_10 ( V_7 ) ;
if ( ( V_28 & V_41 ) == 0 )
F_70 ( V_7 -> V_7 , L_24 , V_28 ) ;
if ( ( V_28 & V_42 ) == V_42 )
F_70 ( V_7 -> V_7 , L_25 , V_28 ) ;
if ( ! V_111 ) {
F_25 ( V_7 ) ;
if ( V_2 -> V_32 ) {
V_22 = F_59 ( V_7 ) ;
...
return V_114 ;
V_2 -> V_106 = V_28 & V_14 ;
F_37 ( V_7 -> V_7 , L_26 , V_2 -> V_106 ) ;
F_11 ( V_7 , V_28 ) ;
return V_115 ;
}
T_3 F_72 ( int V_112 , void * V_113 )
{
struct V_6 * V_7 = (struct V_6 * ) V_113 ;
struct V_116 V_117 ;
T_4 V_118 ;
...
V_118 = F_77 ( V_7 ) ;
while ( V_118 > 0 ) {
F_37 ( V_7 -> V_7 , L_31 , V_118 ) ;
V_119 = F_78 ( V_7 , & V_117 , & V_118 ) ;
if ( V_119 == - V_124 )
break;
...
if ( V_7 -> V_79 != V_80 &&
V_7 -> V_79 != V_83 ) {
V_119 = F_80 ( V_7 , & V_117 ) ;
V_7 -> V_125 = F_79 ( V_7 ) ;
}
F_81 ( V_7 , & V_117 ) ;
V_123:
F_37 ( V_7 -> V_7 , L_33 , V_119 ) ;
F_31 ( & V_7 -> V_45 ) ;
return V_126 ;
}
...
static bool F_83 ( struct V_18 * V_19 )
{
T_1 V_11 ;
unsigned int V_128 ;
V_128 = F_84 ( F_85 ( V_19 -> V_128 ) , 0 ) ;
F_86 ( V_19 -> V_129 , V_128 , V_31 , & V_11 ) ;
F_19 ( & V_19 -> V_7 , L_5 , V_31 , V_11 ) ;
return ( V_11 & 0xf0000 ) == 0xf0000 ;
}
struct V_6 * F_87 ( struct V_18 * V_19 ,
const struct V_130 * V_21 )
{
struct V_6 * V_7 ;
struct V_1 * V_2 ;
V_7 = F_88 ( sizeof( struct V_6 ) +
sizeof( struct V_1 ) , V_131 ) ;
if ( ! V_7 )
return NULL ;
V_2 = F_6 ( V_7 ) ;
F_89 ( V_7 , & V_19 -> V_7 , & V_132 ) ;
V_2 -> V_21 = V_21 ;
return V_7 ;
}
