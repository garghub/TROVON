...
struct V_2 * V_3 = F_5 ( V_14 ) ;
struct V_1 * V_7 = V_12 -> V_10 -> V_25 ;
if ( F_3 ( V_7 == NULL ) )
return;
F_12 ( & V_3 -> V_26 ) ;
F_3 ( ! V_7 -> V_10 . V_15 ) ;
...
struct V_9 * V_25 ;
enum V_4 V_39 ;
V_25 = F_23 ( V_36 -> V_13 . V_17 ) ;
for ( V_39 = V_37 ; V_39 <= V_38 ; V_39 ++ ) {
V_7 = & V_3 -> V_6 [ V_39 ] ;
if ( V_25 [ V_39 ] . V_15 == 0 )
continue;
if ( memcmp ( & V_36 -> V_40 ,
...
sizeof( V_36 -> V_40 ) ) == 0 ) {
F_18 ( L_8 ,
V_12 -> V_13 . V_13 . V_5 , V_12 -> V_13 . V_23 , V_7 -> V_23 ,
V_25 [ V_39 ] . V_15 ,
V_7 -> V_27 ) ;
return V_7 ;
}
...
{
struct V_9 * V_25 ;
struct V_11 * V_12 = F_25 ( V_36 -> V_13 . V_12 ) ;
enum V_4 V_39 = V_7 -> V_5 ;
V_25 = F_23 ( V_36 -> V_13 . V_17 ) ;
if ( V_25 [ V_39 ] . V_15 == 0 )
V_25 [ V_39 ] . V_20 =
V_36 -> V_40 ;
...
if ( ! F_30 ( V_3 , V_44 ) )
return false ;
V_43 = F_31 ( F_32 ( V_7 -> V_5 ) ) ;
V_20 -> V_45 = V_43 ;
V_20 -> V_46 = F_31 ( F_33 ( V_7 -> V_5 ) ) ;
V_20 -> V_47 = F_31 ( F_34 ( V_7 -> V_5 ) ) ;
F_35 ( V_3 , V_44 ) ;
return V_43 & V_48 ;
}
...
struct V_1 * V_7 )
{
F_37 ( F_33 ( V_7 -> V_5 ) , V_7 -> V_10 . V_20 . V_46 ) ;
F_37 ( F_34 ( V_7 -> V_5 ) , V_7 -> V_10 . V_20 . V_47 ) ;
}
...
{
F_38 ( V_3 ) ;
F_37 ( F_32 ( V_7 -> V_5 ) , V_7 -> V_10 . V_20 . V_45 ) ;
F_43 ( F_32 ( V_7 -> V_5 ) ) ;
F_44 ( 150 ) ;
F_37 ( F_32 ( V_7 -> V_5 ) , V_7 -> V_10 . V_20 . V_45 ) ;
F_43 ( F_32 ( V_7 -> V_5 ) ) ;
...
struct V_1 * V_7 )
{
struct V_24 * V_14 = & V_3 -> V_54 ;
struct V_11 * V_12 ;
F_46 (dev, crtc) {
if ( V_12 -> V_10 -> V_25 == V_7 )
F_47 ( V_3 , V_12 -> V_16 ) ;
}
F_37 ( F_32 ( V_7 -> V_5 ) , 0 ) ;
F_43 ( F_32 ( V_7 -> V_5 ) ) ;
...
static struct V_1 *
F_48 ( struct V_11 * V_12 , struct V_35 * V_36 ,
struct V_55 * V_56 )
{
struct V_2 * V_3 = F_5 ( V_12 -> V_13 . V_14 ) ;
struct V_1 * V_7 ;
...
{
T_1 V_43 ;
V_43 = F_31 ( F_50 ( V_7 -> V_5 ) ) ;
F_37 ( F_50 ( V_7 -> V_5 ) , V_43 & ~ V_62 ) ;
F_43 ( F_50 ( V_7 -> V_5 ) ) ;
}
...
static struct V_1 *
F_61 ( struct V_11 * V_12 , struct V_35 * V_36 ,
struct V_55 * V_56 )
{
struct V_2 * V_3 = F_5 ( V_12 -> V_13 . V_14 ) ;
struct V_1 * V_7 ;
int clock = V_36 -> V_102 ;
memset ( & V_36 -> V_40 , 0 ,
sizeof( V_36 -> V_40 ) ) ;
if ( V_56 -> type == V_103 ) {
T_1 V_43 ;
...
T_1 V_43 ;
V_43 = F_31 ( V_113 ) ;
V_43 &= ~ ( F_69 ( V_7 -> V_5 ) | F_70 ( V_7 -> V_5 ) |
F_71 ( V_7 -> V_5 ) ) ;
V_43 |= V_7 -> V_10 . V_20 . V_114 << ( V_7 -> V_5 * 6 ) ;
F_37 ( V_113 , V_43 ) ;
F_43 ( V_113 ) ;
}
...
return false ;
V_122 = false ;
V_43 = F_31 ( V_116 [ V_7 -> V_5 ] . V_119 ) ;
if ( ! ( V_43 & V_120 ) )
goto V_31;
V_43 = F_31 ( V_113 ) ;
V_20 -> V_114 = ( V_43 >> ( V_7 -> V_5 * 6 ) ) & 0x3f ;
if ( V_43 & F_69 ( V_7 -> V_5 ) ) {
...
struct V_123 V_124 ;
unsigned int V_153 , V_87 , V_39 ;
unsigned int V_133 , V_134 , V_135 ;
F_81 ( & V_124 ) ;
for ( V_87 = 0 ; V_87 < F_89 ( V_152 ) ; V_87 ++ ) {
for ( V_153 = 0 ; V_153 < F_89 ( V_147 ) ; V_153 ++ ) {
for ( V_39 = 0 ; V_39 < V_152 [ V_87 ] . V_151 ; V_39 ++ ) {
unsigned int V_81 = V_152 [ V_87 ] . V_150 [ V_39 ] ;
...
static struct V_1 *
F_90 ( struct V_11 * V_12 , struct V_35 * V_36 ,
struct V_55 * V_56 )
{
struct V_1 * V_7 ;
...
memset ( & V_36 -> V_40 , 0 ,
sizeof( V_36 -> V_40 ) ) ;
V_36 -> V_40 . V_114 = V_114 ;
V_36 -> V_40 . V_117 = V_117 ;
V_36 -> V_40 . V_118 = V_118 ;
if ( V_56 -> type == V_107 )
V_7 = F_22 ( V_12 , V_36 ,
V_162 ,
V_162 ) ;
...
static struct V_1 *
F_109 ( struct V_11 * V_12 , struct V_35 * V_36 ,
struct V_55 * V_56 )
{
struct V_2 * V_3 = F_5 ( V_12 -> V_13 . V_14 ) ;
struct V_1 * V_7 ;
...
int V_39 ;
V_201 = V_215 [ 0 ] ;
for ( V_39 = 0 ; V_39 < F_89 ( V_215 ) ; ++ V_39 ) {
if ( V_215 [ V_39 ] . clock == clock ) {
V_201 = V_215 [ V_39 ] ;
break;
}
}
...
V_36 -> V_40 . V_173 = V_201 . V_211 ;
V_36 -> V_40 . V_175 = F_113 ( V_201 . V_210 ) ;
V_36 -> V_40 . V_177 = V_201 . V_213 ;
if ( V_201 . V_214 )
V_36 -> V_40 . V_179 =
V_178 ;
V_36 -> V_40 . V_183 =
...
V_36 -> V_40 . V_183 |=
F_115 ( V_205 ) ;
V_36 -> V_40 . V_185 = V_206 ;
V_36 -> V_40 . V_187 = 5 << V_216 ;
V_36 -> V_40 . V_190 =
F_116 ( V_217 )
| V_188 ;
V_36 -> V_40 . V_192 = V_168 ;
V_36 -> V_40 . V_197 =
V_196 | V_207 ;
V_199 = F_117 ( & V_56 -> V_13 ) ;
V_39 = (enum V_4 ) V_199 -> V_166 ;
V_7 = F_1 ( V_3 , V_39 ) ;
F_18 ( L_12 ,
V_12 -> V_13 . V_13 . V_5 , V_12 -> V_13 . V_23 , V_7 -> V_23 ) ;
F_24 ( V_7 , V_36 ) ;
...
V_223 = V_222 -> V_223 ;
for ( V_39 = 0 ; V_223 [ V_39 ] . V_5 >= 0 ; V_39 ++ ) {
F_3 ( V_39 != V_223 [ V_39 ] . V_5 ) ;
V_3 -> V_6 [ V_39 ] . V_5 = V_223 [ V_39 ] . V_5 ;
V_3 -> V_6 [ V_39 ] . V_23 = V_223 [ V_39 ] . V_23 ;
V_3 -> V_6 [ V_39 ] . V_21 = * V_223 [ V_39 ] . V_21 ;
V_3 -> V_6 [ V_39 ] . V_228 = V_223 [ V_39 ] . V_228 ;
}
V_3 -> V_222 = V_222 ;
V_3 -> V_8 = V_39 ;
F_125 ( & V_3 -> V_26 ) ;
...
if ( F_3 ( ! V_222 ) )
return NULL ;
return V_222 -> V_230 ( V_12 , V_36 , V_56 ) ;
}
