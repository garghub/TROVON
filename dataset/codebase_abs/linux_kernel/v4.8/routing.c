...
break;
case V_54 :
if ( ! F_22 ( V_28 , sizeof( struct V_55 ) ) )
goto V_18;
F_33 ( V_2 , V_28 ) ;
V_38 = V_53 ;
goto V_18;
...
if ( ! V_34 )
goto V_18;
V_4 = F_30 ( V_2 , V_57 -> V_15 ) ;
if ( ! V_4 )
goto V_18;
if ( F_25 ( V_28 , V_47 ) < 0 )
goto V_18;
V_57 = (struct V_56 * ) V_28 -> V_40 ;
F_31 ( V_57 -> V_48 , V_57 -> V_15 ) ;
F_31 ( V_57 -> V_15 , V_34 -> V_49 -> V_50 ) ;
V_57 -> V_41 = V_44 ;
V_57 -> V_51 = V_52 ;
V_37 = F_32 ( V_28 , V_4 , NULL ) ;
if ( V_37 != - 1 )
...
if ( V_60 -> V_62 >= V_63 )
goto V_18;
F_31 ( V_60 -> V_64 [ V_60 -> V_62 ] ,
V_31 -> V_32 ) ;
V_60 -> V_62 ++ ;
}
if ( F_40 ( V_2 , V_36 -> V_48 ) )
...
if ( ! V_12 )
return V_12 ;
if ( ! ( V_6 == V_83 && F_45 ( & V_2 -> V_84 ) ) )
return V_12 ;
F_3 () ;
V_81 = F_42 ( V_4 ) ;
if ( V_81 )
V_77 = F_4 ( V_81 -> V_12 ) ;
F_46 (cand, &orig_node->ifinfo_list, list) {
if ( ! F_5 ( & V_78 -> V_13 ) )
continue;
V_76 = F_4 ( V_78 -> V_12 ) ;
if ( ! V_76 )
...
V_103 = ( T_2 ) F_45 ( & V_2 -> V_104 . V_105 ) ;
} else {
V_4 = F_53 ( V_2 , NULL , V_100 ,
V_101 ) ;
if ( ! V_4 )
goto V_18;
if ( F_54 ( V_4 -> V_15 , V_90 -> V_92 ) )
goto V_18;
V_102 = V_4 -> V_15 ;
V_103 = ( T_2 ) F_45 ( & V_4 -> V_106 ) ;
}
F_31 ( V_90 -> V_92 , V_102 ) ;
V_90 -> V_107 = V_103 ;
V_38 = true ;
V_18:
if ( V_34 )
...
int V_110 ;
if ( ! F_22 ( V_28 , V_91 + V_47 ) )
return false ;
if ( F_25 ( V_28 , sizeof( * V_90 ) ) < 0 )
return false ;
V_90 = (struct V_89 * ) V_28 -> V_40 ;
...
V_108 = ( T_2 ) F_45 ( & V_2 -> V_104 . V_105 ) ;
if ( ! F_40 ( V_2 , V_90 -> V_92 ) ) {
V_4 = F_30 ( V_2 ,
V_90 -> V_92 ) ;
if ( ! V_4 )
return false ;
V_108 = ( T_2 ) F_45 ( & V_4 -> V_106 ) ;
F_35 ( V_4 ) ;
}
...
V_125 = F_30 ( V_2 , V_127 -> V_15 ) ;
if ( ! V_125 )
goto V_18;
V_28 -> V_128 = V_127 -> V_128 + 256 ;
if ( ! F_40 ( V_2 , V_127 -> V_92 ) &&
F_72 ( V_28 , V_6 , V_125 ) ) {
V_38 = V_53 ;
goto V_18;
}
...
if ( F_24 ( V_31 -> V_33 ) )
goto V_18;
if ( F_40 ( V_2 , V_31 -> V_33 ) )
goto V_18;
V_133 = (struct V_132 * ) V_28 -> V_40 ;
if ( F_40 ( V_2 , V_133 -> V_15 ) )
goto V_18;
if ( V_133 -> V_51 < 2 )
goto V_18;
V_4 = F_30 ( V_2 , V_133 -> V_15 ) ;
if ( ! V_4 )
goto V_18;
F_10 ( & V_4 -> V_136 ) ;
