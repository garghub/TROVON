...
static int F_11 ( struct V_22 * V_23 , bool V_49 )
{
int V_50 ;
T_2 V_51 ;
V_50 = F_1 ( V_23 -> V_1 , V_23 -> V_2 ) ;
if ( V_50 )
return V_50 ;
F_3 ( V_37 , V_23 -> V_1 + V_4 ) ;
F_3 ( V_23 -> V_38 , V_23 -> V_1 + V_8 ) ;
F_3 ( V_52 , V_23 -> V_1 + V_4 ) ;
V_51 = F_7 ( V_23 -> V_1 + V_8 ) ;
V_51 &= ~ V_53 ;
V_51 |= V_54 ;
if ( ! V_49 )
V_51 |= V_55 ;
F_3 ( V_51 , V_23 -> V_1 + V_8 ) ;
F_4 ( V_23 -> V_1 ) ;
return 0 ;
}
int F_12 ( struct V_56 * V_57 )
{
struct V_22 * V_23 ;
struct V_22 V_58 ;
struct V_59 * V_59 = F_13 ( V_57 -> V_18 . V_60 ) ;
bool V_49 = F_14 ( V_59 ) ;
if ( F_9 ( & V_58 , V_57 -> V_18 . V_61 ) )
return - V_10 ;
V_23 = F_15 ( V_57 -> V_18 . V_62 , sizeof( * V_23 ) , V_63 ) ;
if ( ! V_23 )
return - V_64 ;
memcpy ( V_23 , & V_58 , sizeof( V_58 ) ) ;
V_57 -> V_18 . V_65 = F_8 ;
V_57 -> V_18 . V_24 = V_23 ;
return F_11 ( V_23 , V_49 ) ;
}
