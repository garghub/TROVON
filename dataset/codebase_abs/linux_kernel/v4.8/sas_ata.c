...
V_28 -> V_112 = V_113 ;
V_30 -> V_67 = V_28 ;
V_28 -> V_98 . V_114 = F_20 ( V_30 -> V_88 . V_99 ) ;
V_28 -> V_98 . V_115 = F_21 ( V_30 -> V_88 . V_99 ) ;
if ( V_30 -> V_50 )
F_6 ( V_30 -> V_50 , V_28 ) ;
...
F_25 ( V_33 -> V_56 . V_59 , & V_30 -> V_118 ) ;
return true ;
}
static struct V_79 * F_26 ( struct V_32 * V_33 )
{
return F_13 ( V_33 -> V_39 -> V_40 -> V_77 . V_78 -> V_81 ) ;
}
int F_27 ( struct V_32 * V_33 , struct V_119 * V_120 )
{
if ( V_120 -> V_121 & V_86 )
...
int V_128 ;
V_33 -> V_127 = V_124 ;
V_128 = F_28 ( V_33 -> V_129 , V_120 -> V_130 ,
& V_33 -> V_56 . V_131 ) ;
if ( V_128 ) {
F_2 ( L_4
L_5 , F_29 ( V_33 -> V_129 -> V_132 ) ,
V_120 -> V_130 , V_128 ) ;
return V_128 ;
}
memcpy ( V_33 -> V_133 , & V_33 -> V_56 . V_131 . V_134 . V_59 ,
sizeof( struct V_135 ) ) ;
V_33 -> V_56 . V_57 = F_30 ( V_33 ) ;
}
return 0 ;
}
static int F_31 ( struct V_32 * V_33 , struct V_119 * V_120 )
{
int V_128 ;
if ( V_33 -> V_127 != V_126 )
return 1 ;
V_128 = F_27 ( V_33 , V_120 ) ;
if ( V_128 )
return 0 ;
else
return 1 ;
...
struct V_137 * V_120 = F_33 ( V_33 ) ;
struct V_119 * V_119 = & V_136 -> V_136 . V_119 [ V_120 -> V_138 ] ;
V_128 = F_34 ( V_136 , V_120 -> V_138 ) ;
F_35 ( V_120 ) ;
if ( V_128 == - V_139 )
return V_128 ;
if ( V_128 != V_140 )
...
static int F_37 ( const char * V_144 , const struct V_32 * V_145 ,
const char * V_146 , ... )
{
...
V_150 . V_152 = & args ;
V_151 = F_38 ( L_6 ,
V_144 , V_46 -> V_153 , F_39 ( V_33 ) , & V_150 ) ;
va_end ( args ) ;
return V_151 ;
}
static int F_40 ( struct V_43 * V_44 , unsigned int * V_57 ,
unsigned long V_154 )
{
int V_70 = 0 , V_128 ;
struct V_137 * V_120 ;
...
F_41 = F_32 ;
F_35 ( V_120 ) ;
V_70 = F_43 ( V_44 , V_154 , F_41 ) ;
if ( V_70 && V_70 != - V_158 )
F_37 ( V_159 , V_33 , L_8 , V_70 ) ;
* V_57 = V_33 -> V_56 . V_57 ;
V_46 -> V_160 = V_161 ;
return V_70 ;
}
...
{
struct V_79 * V_72 = F_26 ( V_28 -> V_33 ) ;
unsigned long V_42 ;
int V_128 ;
F_4 ( & V_28 -> V_162 , V_42 ) ;
if ( V_28 -> V_112 & V_163 ||
...
static void F_46 ( struct V_45 * V_46 , struct V_166 * V_167 )
{
struct V_32 * V_33 = V_46 -> V_74 ;
struct V_79 * V_80 = F_26 ( V_33 ) ;
if ( V_80 -> V_116 -> V_168 )
...
unsigned long V_42 ;
F_4 ( & V_40 -> V_52 , V_42 ) ;
if ( F_51 ( V_169 , & V_33 -> V_49 ) )
V_40 -> V_170 -- ;
F_7 ( & V_40 -> V_52 , V_42 ) ;
}
int F_52 ( struct V_32 * V_171 )
{
struct V_37 * V_40 = V_171 -> V_39 -> V_40 ;
struct V_75 * V_78 = V_40 -> V_77 . V_78 ;
struct V_45 * V_46 ;
int V_172 ;
F_53 ( & V_171 -> V_56 . V_173 , V_40 -> V_33 , & V_174 ) ;
V_46 = F_54 ( & V_171 -> V_56 . V_173 ,
& V_175 ,
V_78 ) ;
if ( ! V_46 ) {
F_2 ( L_11 ) ;
...
if ( V_33 -> V_127 == V_126 )
return V_185 ;
F_25 ( ( const V_97 * ) V_59 , & V_88 ) ;
return F_60 ( & V_88 ) ;
}
void F_61 ( struct V_186 * V_39 )
{
struct V_32 * V_33 , * V_187 ;
F_62 ( & V_39 -> V_40 -> V_188 ) ;
F_63 (dev, &port->disco_list, disco_list_node) {
if ( ! F_64 ( V_33 ) )
continue;
F_65 ( V_33 -> V_56 . V_46 ) ;
}
F_66 ( & V_39 -> V_40 -> V_188 ) ;
F_67 (dev, n, &port->disco_list, disco_list_node) {
if ( ! F_64 ( V_33 ) )
continue;
F_68 ( V_33 ) ;
if ( F_69 ( F_70 ( V_33 ) ) )
F_71 ( V_33 , V_21 , - V_142 ) ;
}
}
static void F_72 ( struct V_186 * V_39 , const char * V_189 )
{
struct V_32 * V_33 , * V_187 ;
F_67 (dev, n, &port->dev_list, dev_list_node) {
if ( ! F_64 ( V_33 ) )
continue;
F_68 ( V_33 ) ;
if ( F_69 ( F_70 ( V_33 ) ) )
F_71 ( V_33 , V_189 , - V_142 ) ;
}
}
...
return - V_142 ;
V_33 -> V_56 . V_57 = F_30 ( V_33 ) ;
F_78 ( V_33 , V_33 -> V_148 ) ;
V_128 = F_79 ( V_33 ) ;
if ( V_128 )
return V_128 ;
F_80 ( V_33 -> V_39 , V_197 ) ;
return 0 ;
}
static void F_81 ( void * V_198 , T_2 V_199 )
{
struct V_32 * V_33 = V_198 ;
struct V_45 * V_46 = V_33 -> V_56 . V_46 ;
struct V_37 * V_40 = V_33 -> V_39 -> V_40 ;
F_37 ( V_157 , V_33 , L_12 ) ;
F_82 ( V_40 -> V_77 . V_78 , V_46 ) ;
F_83 ( V_33 ) ;
}
void F_84 ( struct V_75 * V_78 )
{
struct V_37 * V_38 = F_85 ( V_78 ) ;
F_86 ( V_200 ) ;
int V_80 ;
F_87 ( V_38 ) ;
F_88 ( & V_38 -> V_201 ) ;
...
void F_94 ( struct V_75 * V_78 , struct V_206 * V_207 ,
struct V_206 * V_208 )
{
...
F_95 ( V_212 ) ;
V_211 = NULL ;
F_67 (cmd, n, work_q, eh_entry) {
struct V_32 * V_145 = F_96 ( V_210 ) ;
if ( ! F_64 ( V_145 ) || F_97 ( V_210 ) )
continue;
if ( V_211 && V_211 != V_145 )
continue;
V_211 = V_145 ;
F_98 ( & V_210 -> V_213 , & V_212 ) ;
}
if ( ! F_99 ( & V_212 ) ) {
struct V_45 * V_46 = V_211 -> V_56 . V_46 ;
F_37 ( V_157 , V_211 , L_13 ) ;
F_100 ( V_78 , V_46 , & V_212 ) ;
while ( ! F_99 ( & V_212 ) )
F_101 ( V_212 . V_214 ) ;
}
} while ( V_211 );
