...
V_129 = V_135 -> V_143 . V_144 ( V_16 , V_127 ) ;
V_138:
F_92 () ;
V_63:
...
static int F_93 ( struct V_126 * V_127 , int V_145 )
{
...
static int T_4 F_95 ( struct V_39 * V_39 )
{
struct V_40 * V_41 = F_33 ( V_39 , V_42 ) ;
int V_32 ;
V_41 -> V_47 = V_50 ;
...
static void T_5 F_97 ( struct V_39 * V_39 )
{
F_98 ( V_39 ) ;
}
...
if ( V_32 < 0 )
goto V_156;
for ( V_77 = 0 ; V_77 < F_105 ( V_157 ) ; V_77 ++ )
F_106 ( & V_157 [ V_77 ] ) ;
F_107 ( F_68 ) ;
return 0 ;
V_156:
