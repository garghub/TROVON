...
int F_83 ( const struct V_144 * V_145 , unsigned char * * V_152 )
{
unsigned char * V_153 = * V_152 ;
unsigned char * V_140 ;
unsigned char V_154 ;
...
V_140 = V_153 + V_154 ;
while ( V_154 < V_156 ) {
for ( V_157 = 0 ; V_42 -> V_52 [ V_157 ] != V_140 [ 0 ] ; )
if ( V_42 -> V_52 [ V_157 ] == V_59 ||
++ V_157 == V_51 ) {
V_155 = V_154 ;
goto V_159;
}
V_136 = V_140 [ 1 ] ;
if ( V_136 > ( V_156 - V_154 ) ) {
V_155 = V_154 + 1 ;
goto V_159;
}
switch ( V_140 [ 0 ] ) {
...
break;
case V_57 :
if ( ! V_145 || ! ( V_145 -> V_163 -> V_26 & V_164 ) ) {
V_155 = V_154 ;
goto V_159;
}
if ( V_136 != V_142 ) {
...
void F_85 ( struct V_144 * V_145 , int error , T_1 V_165 )
{
if ( F_82 ( V_145 ) -> V_166 == V_167 || error != - V_168 )
return;
if ( V_165 )
F_86 ( V_145 , V_169 , V_170 , 0 ) ;
else
F_86 ( V_145 , V_169 , V_171 , 0 ) ;
}
static int F_87 ( unsigned char * V_130 , T_1 V_172 ,
...
T_1 V_172 ;
T_1 V_156 ;
struct V_175 * V_176 , * V_153 = NULL ;
struct V_177 * V_178 ;
struct V_179 * V_180 ;
if ( ! V_174 )
return 0 ;
V_172 = V_126 ;
V_130 = F_89 ( V_172 , V_38 ) ;
if ( ! V_130 ) {
V_33 = - V_11 ;
goto V_181;
}
V_33 = F_87 ( V_130 , V_172 , V_42 , V_17 ) ;
if ( V_33 < 0 )
goto V_181;
V_172 = V_33 ;
V_156 = ( V_172 + 3 ) & ~ 3 ;
V_153 = F_21 ( sizeof( * V_153 ) + V_156 , V_38 ) ;
if ( ! V_153 ) {
V_33 = - V_11 ;
goto V_181;
}
memcpy ( V_153 -> V_153 . V_182 , V_130 , V_172 ) ;
V_153 -> V_153 . V_149 = V_156 ;
V_153 -> V_153 . V_69 = sizeof( struct V_146 ) ;
F_3 ( V_130 ) ;
V_130 = NULL ;
V_178 = F_90 ( V_174 ) ;
V_176 = F_91 ( V_178 -> V_183 ,
F_92 ( V_174 ) ) ;
if ( V_178 -> V_184 ) {
V_180 = F_93 ( V_174 ) ;
if ( V_176 )
V_180 -> V_185 -= V_176 -> V_153 . V_149 ;
V_180 -> V_185 += V_153 -> V_153 . V_149 ;
V_180 -> V_186 ( V_174 , V_180 -> V_187 ) ;
}
F_94 ( V_178 -> V_183 , V_153 ) ;
if ( V_176 )
F_95 ( V_176 , V_73 ) ;
return 0 ;
V_181:
...
static int F_99 ( struct V_175 * * V_193 )
{
int V_194 = 0 ;
struct V_175 * V_153 = * V_193 ;
if ( V_153 -> V_153 . V_195 || V_153 -> V_153 . V_196 || V_153 -> V_153 . V_197 || V_153 -> V_153 . V_198 ) {
T_3 V_199 ;
T_3 V_200 ;
unsigned char * V_32 ;
int V_6 ;
int V_201 ;
V_200 = V_153 -> V_153 . V_69 - sizeof( struct V_146 ) ;
V_32 = & V_153 -> V_153 . V_182 [ V_200 ] ;
V_199 = V_32 [ 1 ] ;
if ( V_153 -> V_153 . V_195 > V_153 -> V_153 . V_69 )
V_153 -> V_153 . V_195 -= V_199 ;
if ( V_153 -> V_153 . V_196 > V_153 -> V_153 . V_69 )
V_153 -> V_153 . V_196 -= V_199 ;
if ( V_153 -> V_153 . V_197 > V_153 -> V_153 . V_69 )
V_153 -> V_153 . V_197 -= V_199 ;
if ( V_153 -> V_153 . V_198 > V_153 -> V_153 . V_69 )
V_153 -> V_153 . V_198 -= V_199 ;
V_153 -> V_153 . V_69 = 0 ;
memmove ( V_32 , V_32 + V_199 ,
V_153 -> V_153 . V_149 - V_200 - V_199 ) ;
V_6 = 0 ;
V_201 = 0 ;
while ( V_6 < V_153 -> V_153 . V_149 )
if ( V_153 -> V_153 . V_182 [ V_6 ] != V_202 ) {
V_6 += V_153 -> V_153 . V_182 [ V_6 + 1 ] ;
V_201 = V_6 ;
} else
V_6 ++ ;
V_194 = V_153 -> V_153 . V_149 ;
V_153 -> V_153 . V_149 = ( V_201 + 3 ) & ~ 3 ;
V_194 -= V_153 -> V_153 . V_149 ;
} else {
* V_193 = NULL ;
V_194 = V_153 -> V_153 . V_149 ;
...
struct V_177 * V_178 ;
V_178 = F_90 ( V_174 ) ;
V_153 = F_91 ( V_178 -> V_183 , 1 ) ;
if ( ! V_153 || V_153 -> V_153 . V_69 == 0 )
return;
V_194 = F_99 ( & V_178 -> V_183 ) ;
if ( V_178 -> V_184 && V_194 > 0 ) {
struct V_179 * V_180 = F_93 ( V_174 ) ;
V_180 -> V_185 -= V_194 ;
V_180 -> V_186 ( V_174 , V_180 -> V_187 ) ;
}
}
void F_101 ( struct V_188 * V_189 )
{
struct V_175 * V_153 ;
struct V_190 * V_191 ;
V_191 = F_97 ( V_189 ) ;
...
int F_103 ( struct V_173 * V_174 , struct V_16 * V_17 )
{
struct V_175 * V_153 ;
int V_205 = - V_203 ;
F_44 () ;
V_153 = F_104 ( F_90 ( V_174 ) -> V_183 ) ;
if ( V_153 && V_153 -> V_153 . V_69 )
V_205 = F_102 ( V_153 -> V_153 . V_182 +
V_153 -> V_153 . V_69 -
sizeof( struct V_146 ) ,
V_17 ) ;
F_46 () ;
...
int V_33 ;
struct V_146 * V_147 ;
struct V_206 * V_153 = & F_106 ( V_145 ) -> V_153 ;
...
V_172 = V_33 ;
V_156 = ( V_172 + 3 ) & ~ 3 ;
V_207 = V_156 - V_153 -> V_149 ;
V_33 = F_107 ( V_145 , F_108 ( V_145 ) + V_207 ) ;
if ( V_33 < 0 )
return V_33 ;
if ( V_207 > 0 ) {
V_147 = F_82 ( V_145 ) ;
F_109 ( V_145 , V_207 ) ;
memmove ( ( char * ) V_147 - V_207 , V_147 , V_147 -> V_151 << 2 ) ;
F_110 ( V_145 ) ;
V_147 = F_82 ( V_145 ) ;
} else if ( V_207 < 0 ) {
V_147 = F_82 ( V_145 ) ;
memset ( V_147 + 1 , V_202 , V_153 -> V_149 ) ;
} else
V_147 = F_82 ( V_145 ) ;
if ( V_153 -> V_149 > 0 )
memset ( V_153 , 0 , sizeof( * V_153 ) ) ;
V_153 -> V_149 = V_156 ;
V_153 -> V_69 = sizeof( struct V_146 ) ;
V_153 -> V_208 = 1 ;
memcpy ( V_147 + 1 , V_130 , V_172 ) ;
if ( V_156 > V_172 )
memset ( ( char * ) ( V_147 + 1 ) + V_172 , 0 , V_156 - V_172 ) ;
if ( V_207 != 0 ) {
V_147 -> V_151 = 5 + ( V_156 >> 2 ) ;
V_147 -> V_209 = F_63 ( V_145 -> V_131 ) ;
}
F_111 ( V_147 ) ;
return 0 ;
}
...
return V_33 ;
V_147 = F_82 ( V_145 ) ;
V_32 = ( unsigned char * ) V_147 + V_153 -> V_69 ;
memset ( V_32 , V_210 , V_32 [ 1 ] ) ;
V_153 -> V_69 = 0 ;
V_153 -> V_208 = 1 ;
F_111 ( V_147 ) ;
return 0 ;
