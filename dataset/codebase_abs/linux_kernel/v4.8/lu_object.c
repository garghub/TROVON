...
static void F_149 ( struct V_195 * V_196 )
{
int V_73 ;
if ( ! V_196 -> V_198 )
return;
...
static int F_151 ( struct V_195 * V_196 )
{
int V_73 ;
F_138 ( V_196 -> V_198 ) ;
for ( V_73 = 0 ; V_73 < F_46 ( V_190 ) ; ++ V_73 ) {
...
static int F_154 ( struct V_195 * V_196 )
{
V_196 -> V_198 = F_155 ( F_46 ( V_190 ) , sizeof( V_196 -> V_198 [ 0 ] ) ,
V_210 ) ;
if ( F_56 ( V_196 -> V_198 ) )
return F_151 ( V_196 ) ;
return - V_53 ;
}
int F_156 ( struct V_195 * V_196 , T_5 V_211 )
{
int V_212 ;
...
{
return F_56 ( V_196 -> V_209 == V_194 ) ? 0 : F_151 ( V_196 ) ;
}
int F_160 ( struct V_1 * V_2 , T_5 V_211 )
{
int V_50 ;
V_2 -> V_219 = NULL ;
V_50 = F_156 ( & V_2 -> V_87 , V_211 ) ;
if ( F_56 ( V_50 == 0 ) )
F_158 ( & V_2 -> V_87 ) ;
return V_50 ;
}
...
static void F_163 ( struct V_37 * V_115 ,
...
static unsigned long F_168 ( struct V_229 * V_230 ,
struct V_231 * V_232 )
{
struct V_9 * V_63 ;
struct V_9 * V_233 ;
...
static unsigned long F_170 ( struct V_229 * V_230 ,
struct V_231 * V_232 )
{
struct V_9 * V_63 ;
struct V_9 * V_233 ;
...
V_238 -= V_240 ;
F_172 ( & V_63 -> V_165 , & V_58 ) ;
}
F_173 ( & V_58 , V_169 . V_60 ) ;
F_111 ( & V_167 ) ;
...
static T_5 F_169 ( struct V_245 * V_221 , int V_246 )
{
struct V_247 V_248 ;
F_181 ( V_221 , V_246 , & V_248 ) ;
if ( V_246 == V_32 )
return ( T_5 ) ( ( V_248 . V_249 > 0 ) ? V_248 . V_249 : 0 ) ;
return ( T_5 ) V_248 . V_250 ;
}
int F_182 ( const struct V_9 * V_63 , struct V_251 * V_252 )
{
struct V_220 V_221 ;
memset ( & V_221 , 0 , sizeof( V_221 ) ) ;
F_163 ( V_63 -> V_26 , & V_221 , 1 ) ;
F_183 ( V_252 , L_32 ,
V_221 . V_225 ,
V_221 . V_226 ,
V_221 . V_228 ,
F_184 ( V_63 -> V_26 ) ,
V_221 . V_227 ,
F_169 ( V_63 -> V_31 , V_57 ) ,
F_169 ( V_63 -> V_31 , V_109 ) ,
F_169 ( V_63 -> V_31 , V_108 ) ,
F_169 ( V_63 -> V_31 , V_119 ) ,
F_169 ( V_63 -> V_31 , V_112 ) ,
F_169 ( V_63 -> V_31 , V_78 ) ,
F_169 ( V_63 -> V_31 , V_32 ) ) ;
return 0 ;
}
int F_185 ( struct V_253 * V_254 )
{
int V_50 ;
struct V_253 * V_255 = V_254 ;
for ( V_50 = 0 ; V_255 -> V_256 ; ++ V_255 ) {
* V_255 -> V_256 = F_186 ( V_255 -> V_257 ,
V_255 -> V_258 ,
0 , 0 , NULL ) ;
if ( ! * V_255 -> V_256 ) {
V_50 = - V_53 ;
