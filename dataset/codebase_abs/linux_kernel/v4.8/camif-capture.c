...
unsigned int V_96 [] , struct V_97 * V_98 [] )
{
struct V_1 * V_2 = F_52 ( V_88 ) ;
struct V_4 * V_66 = & V_2 -> V_6 ;
const struct V_99 * V_100 = V_2 -> V_20 ;
unsigned int V_101 ;
if ( V_100 == NULL )
return - V_21 ;
V_101 = ( V_66 -> V_11 * V_66 -> V_102 * V_100 -> V_103 ) / 8 ;
if ( * V_95 )
return V_96 [ 0 ] < V_101 ? - V_21 : 0 ;
* V_95 = 1 ;
V_96 [ 0 ] = V_101 ;
F_9 ( L_7 , V_96 [ 0 ] ) ;
return 0 ;
...
V_100 = F_90 ( V_2 , NULL , V_5 -> V_80 ) ;
if ( ! V_100 )
return - V_21 ;
F_84 ( V_5 -> V_141 , V_100 -> V_138 , sizeof( V_5 -> V_141 ) ) ;
V_5 -> V_142 = V_100 -> V_143 ;
...
{
struct V_1 * V_2 = F_68 ( V_109 ) ;
struct V_145 * V_146 = & V_5 -> V_100 . V_146 ;
struct V_4 * V_66 = & V_2 -> V_6 ;
const struct V_99 * V_100 = V_2 -> V_20 ;
V_146 -> V_147 = V_66 -> V_11 * V_100 -> V_148 ;
V_146 -> V_149 = V_2 -> V_104 ;
V_146 -> V_142 = V_100 -> V_143 ;
V_146 -> V_13 = V_66 -> V_11 ;
V_146 -> V_68 = V_66 -> V_102 ;
V_146 -> V_150 = V_151 ;
V_146 -> V_152 = V_153 ;
return 0 ;
}
...
V_146 -> V_147 = V_146 -> V_13 * V_100 -> V_148 ;
V_146 -> V_149 = ( V_146 -> V_13 * V_146 -> V_68 * V_100 -> V_103 ) / 8 ;
V_146 -> V_142 = V_100 -> V_143 ;
V_146 -> V_152 = V_153 ;
V_146 -> V_150 = V_151 ;
F_9 ( L_14 ,
...
{
struct V_1 * V_2 = F_68 ( V_109 ) ;
return F_92 ( V_2 , & V_5 -> V_100 . V_146 , NULL ) ;
}
...
if ( F_100 ( & V_2 -> V_108 ) )
return - V_120 ;
V_59 = F_92 ( V_2 , & V_5 -> V_100 . V_146 , & V_100 ) ;
if ( V_59 < 0 )
return V_59 ;
V_2 -> V_20 = V_100 ;
V_2 -> V_104 = V_146 -> V_149 ;
V_6 -> V_11 = V_146 -> V_13 ;
V_6 -> V_102 = V_146 -> V_68 ;
...
V_2 -> V_111 = V_77 ;
F_9 ( L_16 ,
V_6 -> V_11 , V_6 -> V_102 , V_2 -> V_104 , V_100 -> V_138 ,
V_146 -> V_13 * V_146 -> V_68 * V_100 -> V_103 , V_100 -> V_103 ,
...
V_199 -> V_203 . V_68 = V_2 -> V_6 . V_102 ;
return 0 ;
case V_204 :
...
struct V_246 * V_247 = & V_100 -> V_180 ;
if ( V_100 -> V_176 == V_248 ) {
V_247 = F_146 ( V_19 , V_243 , V_100 -> V_172 ) ;
V_100 -> V_180 = * V_247 ;
return 0 ;
}
F_77 ( & V_15 -> V_113 ) ;
...
V_100 -> V_172 , V_247 -> V_182 , V_247 -> V_13 , V_247 -> V_68 ) ;
V_247 -> V_150 = V_151 ;
V_247 -> V_152 = V_153 ;
F_77 ( & V_15 -> V_113 ) ;
