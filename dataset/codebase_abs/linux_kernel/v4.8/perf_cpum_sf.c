...
V_115 . V_133 . V_134 = V_38 -> V_73 . V_135 ;
if ( V_38 -> V_73 . V_136 )
V_115 . V_133 . V_137 |= V_138 ;
if ( V_38 -> V_73 . V_139 )
V_115 . V_133 . V_137 |= V_140 ;
if ( V_38 -> V_73 . V_141 )
V_115 . V_133 . V_137 |= V_142 ;
switch ( V_38 -> V_73 . V_143 ) {
case 0x0 :
V_115 . V_133 . V_137 |= V_144 ;
break;
case 0x1 :
V_115 . V_133 . V_137 |= V_145 ;
break;
case 0x2 :
V_115 . V_133 . V_137 |= V_146 ;
break;
case 0x3 :
V_115 . V_133 . V_137 |= V_147 ;
break;
}
if ( V_38 -> V_73 . V_148 || V_38 -> V_73 . V_149 != ( V_150 ) V_38 -> V_73 . V_151 )
V_117 -> V_121 = 1 ;
V_123 = 0 ;
if ( F_75 ( V_64 , & V_115 , V_117 ) )
goto V_80;
if ( F_79 ( V_64 , & V_125 , & V_115 ) ) {
V_123 = 1 ;
V_64 -> V_104 -> V_152 ( V_64 , 0 ) ;
}
F_80 ( V_64 ) ;
V_80:
return V_123 ;
}
static void F_81 ( struct V_63 * V_64 , V_46 V_153 )
{
F_82 ( V_153 , & V_64 -> V_153 ) ;
}
static int F_83 ( struct V_154 * V_155 ,
unsigned int V_54 )
{
if ( F_84 ( V_54 & V_83 ) )
if ( V_155 -> V_73 . V_156 != 0x0001 )
return 0 ;
if ( V_54 & V_88 )
if ( V_155 -> V_44 . V_156 < 0x8001 )
return 0 ;
return 1 ;
}
...
if ( F_71 ( ! ( V_54 & V_83 ) ) )
return 0 ;
if ( V_155 -> V_73 . V_157 || V_155 -> V_73 . V_139 )
return 0 ;
return 1 ;
}
...
struct V_154 * V_155 )
{
if ( F_84 ( V_38 -> V_158 & V_83 ) )
V_38 -> V_73 = V_155 -> V_73 ;
if ( V_38 -> V_158 & V_88 )
memcpy ( & V_38 -> V_44 , & V_155 -> V_44 , V_38 -> V_32 ) ;
}
...
L_29
L_30 , V_160 -> V_161 ,
V_155 -> V_73 . V_156 , & V_155 -> V_73 ,
( V_54 & V_88 )
? V_155 -> V_44 . V_156 : 0xFFFF ,
( V_54 & V_88 )
? & V_155 -> V_44 : NULL ) ;
}
static void F_89 ( struct V_63 * V_64 , unsigned long * V_1 ,
...
V_38 -> V_158 = V_54 & V_162 ;
V_39 = F_26 ( & V_64 -> V_65 ) ;
V_160 = (struct V_159 * ) F_12 ( * V_1 ) ;
V_155 = (struct V_154 * ) * V_1 ;
while ( ( unsigned long * ) V_155 < ( unsigned long * ) V_160 ) {
if ( ! V_155 -> V_73 . V_156 )
break;
F_81 ( V_64 , F_33 ( & V_64 -> V_65 ) ) ;
if ( F_83 ( V_155 , V_54 ) ) {
if ( ! * V_123 ) {
if ( F_85 ( V_155 , V_54 ) ) {
F_87 ( V_38 , V_155 ) ;
...
static void F_90 ( struct V_63 * V_64 , int V_163 )
{
struct V_34 * V_35 = & V_64 -> V_65 ;
struct V_159 * V_160 ;
unsigned long * V_1 ;
unsigned long long V_164 , V_165 , V_17 , V_166 ;
int V_167 ;
if ( V_163 && F_91 ( V_35 ) )
V_163 = 0 ;
V_1 = ( unsigned long * ) F_56 ( V_35 ) ;
V_167 = V_164 = V_165 = V_17 = 0 ;
while ( ! V_167 ) {
V_160 = (struct V_159 * ) F_12 ( * V_1 ) ;
if ( ! V_160 -> V_161 ) {
V_167 = 1 ;
...
L_32 ,
V_1 , V_160 -> V_123 ,
( V_160 -> V_161 ) ? F_92 ( V_160 ) : 0ULL ) ;
F_89 ( V_64 , V_1 , & V_164 ) ;
V_17 ++ ;
do {
V_166 = V_160 -> V_54 & ~ V_168 ;
V_166 |= V_16 ;
} while ( ! F_93 ( & V_160 -> V_54 , & V_160 -> V_123 ,
V_160 -> V_54 , V_160 -> V_123 ,
V_166 , 0ULL ) );
V_1 ++ ;
if ( F_6 ( V_1 ) )
V_1 = F_7 ( V_1 ) ;
...
static void F_95 ( struct V_63 * V_64 , int V_54 )
{
struct V_6 * V_7 = F_40 ( & V_6 ) ;
if ( F_96 ( ! ( V_64 -> V_65 . V_169 & V_170 ) ) )
return;
if ( V_54 & V_171 )
F_96 ( ! ( V_64 -> V_65 . V_169 & V_172 ) ) ;
F_97 ( V_64 -> V_104 ) ;
V_64 -> V_65 . V_169 = 0 ;
V_7 -> F_3 . V_108 = 1 ;
if ( F_19 ( & V_64 -> V_65 ) )
...
static void F_99 ( struct V_63 * V_64 , int V_54 )
{
struct V_6 * V_7 = F_40 ( & V_6 ) ;
if ( V_64 -> V_65 . V_169 & V_170 )
return;
F_97 ( V_64 -> V_104 ) ;
V_7 -> F_3 . V_108 = 0 ;
V_7 -> F_3 . V_110 = 0 ;
V_64 -> V_65 . V_169 |= V_170 ;
if ( ( V_54 & V_173 ) && ! ( V_64 -> V_65 . V_169 & V_172 ) ) {
F_90 ( V_64 , 1 ) ;
V_64 -> V_65 . V_169 |= V_172 ;
}
F_98 ( V_64 -> V_104 ) ;
}
static int F_100 ( struct V_63 * V_64 , int V_54 )
{
struct V_6 * V_7 = F_40 ( & V_6 ) ;
int V_55 ;
if ( V_7 -> V_54 & V_174 )
...
static void F_102 ( struct V_180 V_180 ,
...
static int F_104 ( unsigned int V_77 , int V_54 )
{
if ( ! F_61 ( & V_66 ) )
return 0 ;
F_105 () ;
...
static int F_107 ( unsigned int V_77 )
{
return F_104 ( V_77 , V_57 ) ;
}
static int F_108 ( unsigned int V_77 )
{
return F_104 ( V_77 , V_59 ) ;
}
static int F_109 ( char * V_191 , const struct V_192 * V_193 )
{
if ( ! F_110 () )
return - V_62 ;
return sprintf ( V_191 , L_38 , V_29 , V_30 ) ;
}
static int F_111 ( const char * V_194 , const struct V_192 * V_193 )
{
int V_19 ;
...
V_26 = V_30 ;
if ( strchr ( V_194 , ',' ) )
V_19 = ( sscanf ( V_194 , L_38 , & V_25 , & V_26 ) == 2 ) ? 0 : - V_22 ;
else
V_19 = F_112 ( V_194 , 10 , & V_26 ) ;
...
static void T_3 F_115 ( unsigned int V_195 )
{
F_41 ( L_41
L_42 , V_195 ) ;
}
...
if ( V_28 . V_33 != sizeof( struct V_197 ) ) {
F_115 ( V_198 ) ;
return - V_22 ;
}
if ( V_28 . V_86 ) {
