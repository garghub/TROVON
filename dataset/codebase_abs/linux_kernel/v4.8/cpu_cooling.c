...
snprintf ( V_94 , sizeof( V_94 ) , L_9 ,
V_7 -> V_2 ) ;
V_37 = F_67 ( V_91 , V_94 , V_7 ,
V_98 ) ;
if ( F_23 ( V_37 ) )
goto V_108;
V_7 -> V_23 = V_7 -> V_11 [ 0 ] ;
...
struct V_67 *
F_71 ( const struct V_61 * V_92 )
{
return F_58 ( NULL , V_92 , 0 , NULL ) ;
}
struct V_67 *
F_72 ( struct V_90 * V_91 ,
...
struct V_67 *
F_73 ( const struct V_61 * V_92 , T_1 V_29 ,
T_5 V_93 )
{
