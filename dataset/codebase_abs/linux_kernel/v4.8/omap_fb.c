...
if ( V_33 -> V_54 & F_17 ( V_64 ) )
V_36 ^= V_60 ;
if ( V_33 -> V_54 & F_17 ( V_65 ) )
V_36 ^= V_62 ;
if ( V_36 & V_59 )
F_18 ( V_52 , V_53 ) ;
if ( V_36 & V_62 )
...
if ( V_36 & V_60 )
V_24 += V_52 - 1 ;
F_19 ( V_22 -> V_18 , V_36 , V_24 , V_25 , & V_35 -> V_30 ) ;
V_35 -> V_66 = V_67 ;
V_35 -> V_68 = F_20 ( V_22 -> V_18 , V_36 ) ;
} else {
switch ( V_33 -> V_54 & V_55 ) {
case 0 :
case F_17 ( V_57 ) :
...
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ ) {
struct V_22 * V_22 = & V_16 -> V_17 [ V_6 ] ;
V_72 = F_26 ( V_22 -> V_18 , & V_22 -> V_30 , true ) ;
if ( V_72 )
goto V_75;
F_27 ( V_22 -> V_18 , V_76 ) ;
}
...
if ( ! V_78 )
return F_31 ( V_81 , F_32 ( * V_78 ) ,
V_84 ) ;
F_33 (connector, connector_list, head) {
if ( V_83 != V_78 ) {
...
void F_34 ( struct V_10 * V_11 , struct V_90 * V_91 )
{
struct V_15 * V_16 = F_4 ( V_11 ) ;
int V_6 , V_19 = F_7 ( V_11 -> V_9 ) ;
F_35 ( V_91 , L_4 , V_11 -> V_46 , V_11 -> V_48 ,
( char * ) & V_11 -> V_9 ) ;
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ ) {
struct V_22 * V_22 = & V_16 -> V_17 [ V_6 ] ;
F_35 ( V_91 , L_5 ,
...
struct V_10 * F_37 ( struct V_79 * V_56 ,
struct V_12 * V_92 , const struct V_93 * V_94 )
{
struct V_95 * V_96 [ 4 ] ;
struct V_10 * V_11 ;
int V_72 ;
V_72 = F_38 ( V_92 , V_94 -> V_9 ,
V_96 , V_94 -> V_97 ) ;
if ( V_72 )
return F_39 ( V_72 ) ;
V_11 = F_40 ( V_56 , V_94 , V_96 ) ;
if ( F_41 ( V_11 ) ) {
...
struct V_10 * F_40 ( struct V_79 * V_56 ,
...
if ( V_101 > ( F_44 ( V_96 [ V_6 ] ) - V_94 -> V_103 [ V_6 ] ) ) {
F_16 ( V_56 -> V_56 , L_10 ,
