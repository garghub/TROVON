...
static int F_35 ( struct V_54 * V_55 , struct V_12 * V_69 )
{
int V_70 = 0 ;
int V_71 = F_36 ( V_69 ) ;
if ( ! ( V_55 -> V_72 & V_73 ) ) {
...
L_32 ) ;
V_70 = 1 ;
} else if ( F_37 ( V_55 ) && ! F_38 ( V_76 ) &&
F_24 ( V_69 ) == V_53 ) {
F_27 ( V_60 L_33
L_34 , V_76 -> V_77 , V_76 -> V_78 ) ;
F_39 ( V_79 , V_55 , V_80 , V_55 -> V_81 ) ;
V_70 = 1 ;
}
F_21 ( ( char * ) V_69 , V_42 , 0 ) ;
return V_70 ;
}
int F_40 ( struct V_54 * V_55 )
{
struct V_12 * V_82 ;
if ( V_68 ) {
V_82 = F_25 ( V_55 ) ;
F_33 () ;
if ( V_82 && F_35 ( V_55 , V_82 ) )
return 1 ;
}
return 0 ;
}
