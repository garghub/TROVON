...
switch ( V_495 -> type ) {
case V_496 :
V_495 -> V_497 . V_498 = sizeof( struct V_499 ) ;
if ( V_495 -> V_497 . V_498 != V_493 -> V_497 . V_498 )
return - V_72 ;
memcpy ( & V_495 -> V_497 . V_500 , & V_493 -> V_497 . V_500 ,
sizeof( struct V_501 ) ) ;
memcpy ( & V_495 -> V_497 . V_423 , & V_493 -> V_497 . V_423 ,
sizeof( struct V_501 ) ) ;
break;
case V_502 :
V_495 -> V_503 . V_498 = sizeof( struct V_504 ) ;
if ( V_495 -> V_503 . V_498 != V_493 -> V_503 . V_498 )
return - V_72 ;
memcpy ( & V_495 -> V_503 . V_500 , & V_493 -> V_503 . V_500 ,
sizeof( struct V_505 ) ) ;
memcpy ( & V_495 -> V_503 . V_423 , & V_493 -> V_503 . V_423 ,
sizeof( struct V_505 ) ) ;
break;
case V_506 :
V_495 -> V_507 . V_498 = sizeof( struct V_508 ) ;
if ( V_495 -> V_507 . V_498 != V_493 -> V_507 . V_498 )
return - V_72 ;
memcpy ( & V_495 -> V_507 . V_500 , & V_493 -> V_507 . V_500 ,
sizeof( struct V_509 ) ) ;
memcpy ( & V_495 -> V_507 . V_423 , & V_493 -> V_507 . V_423 ,
sizeof( struct V_509 ) ) ;
break;
case V_510 :
case V_511 :
V_495 -> V_512 . V_498 = sizeof( struct V_513 ) ;
if ( V_495 -> V_512 . V_498 != V_493 -> V_512 . V_498 )
return - V_72 ;
memcpy ( & V_495 -> V_512 . V_500 , & V_493 -> V_512 . V_500 ,
sizeof( struct V_514 ) ) ;
memcpy ( & V_495 -> V_512 . V_423 , & V_493 -> V_512 . V_423 ,
sizeof( struct V_514 ) ) ;
break;
default:
return - V_72 ;
...
T_4 V_519 ;
T_4 V_520 ;
V_519 = F_120 ( F_121 ( V_63 ) , V_122 ) + sizeof( V_63 . V_122 ) ;
V_520 = F_120 ( F_121 ( V_65 ) , V_521 ) + sizeof( V_65 . V_521 ) ;
if ( V_259 -> V_286 < V_519 )
return - V_72 ;
if ( V_259 -> V_289 < V_520 )
return - V_70 ;
if ( V_259 -> V_286 > sizeof( V_63 ) &&
! F_174 ( V_259 , sizeof( V_63 ) ,
...
V_518 . V_32 = V_32 ;
V_518 . V_122 = V_63 . V_122 ;
V_518 . V_525 = V_63 . V_525 ;
V_518 . V_526 = V_57 ;
V_518 . V_527 = V_63 . V_527 ;
V_518 . V_278 = V_528 ;
V_203 -> V_337 . V_366 = 0 ;
F_57 ( & V_203 -> V_337 . V_367 ) ;
V_43 = V_27 -> V_76 -> V_529 ( V_27 , & V_518 , V_260 ) ;
if ( F_55 ( V_43 ) ) {
V_73 = F_56 ( V_43 ) ;
goto V_530;
}
...
V_43 -> V_527 = V_518 . V_527 ;
V_43 -> V_32 = V_32 ;
V_43 -> V_27 = V_27 ;
V_43 -> V_76 = V_27 -> V_76 ;
V_43 -> V_526 = V_518 . V_526 ;
F_77 ( & V_43 -> V_179 , 0 ) ;
F_99 ( & V_27 -> V_179 ) ;
F_99 ( & V_32 -> V_179 ) ;
V_43 -> V_28 = & V_203 -> V_337 . V_28 ;
...
V_65 . V_122 = V_518 . V_122 ;
V_65 . V_525 = V_518 . V_525 ;
V_65 . V_521 = V_43 -> V_532 ;
V_65 . V_282 = V_520 ;
V_73 = F_125 ( V_259 ,
& V_65 , V_65 . V_282 ) ;
if ( V_73 )
...
T_4 V_520 ;
int V_16 ;
V_519 = F_120 ( F_121 ( V_63 ) , V_41 ) + sizeof( V_63 . V_41 ) ;
V_520 = F_120 ( F_121 ( V_65 ) , V_288 ) + sizeof( V_65 . V_288 ) ;
if ( V_259 -> V_286 < V_519 )
return - V_72 ;
if ( V_259 -> V_289 < V_520 )
return - V_70 ;
...
return - V_72 ;
V_43 = V_2 -> V_23 ;
V_203 = F_7 ( V_2 , struct V_516 , V_337 . V_28 ) ;
V_16 = F_175 ( V_43 ) ;
if ( ! V_16 )
V_2 -> V_12 = 0 ;
F_12 ( V_2 ) ;
...
T_4 V_519 ;
int V_16 ;
V_519 = F_120 ( F_121 ( V_63 ) , V_536 ) + sizeof( V_63 . V_536 ) ;
if ( V_259 -> V_286 < V_519 )
return - V_72 ;
if ( V_259 -> V_286 > sizeof( V_63 ) &&
! F_174 ( V_259 , sizeof( V_63 ) ,
...
if ( ! V_63 . V_386 )
return - V_72 ;
if ( V_63 . V_386 > ( V_537 | V_538 ) )
return - V_72 ;
V_43 = F_40 ( V_63 . V_41 , V_57 -> V_68 ) ;
if ( ! V_43 )
return - V_72 ;
V_535 . V_536 = V_63 . V_536 ;
V_535 . V_539 = V_63 . V_539 ;
V_16 = V_43 -> V_76 -> V_540 ( V_43 , & V_535 , V_63 . V_386 , V_260 ) ;
F_41 ( V_43 ) ;
return V_16 ;
}
...
struct V_542 V_385 = {} ;
struct V_44 * V_341 ;
struct V_40 * * V_543 = NULL ;
T_6 * V_544 = NULL ;
struct V_40 * V_43 = NULL ;
int V_444 , V_545 , V_546 ;
T_6 V_547 ;
T_6 V_548 ;
T_4 V_549 ;
T_4 V_520 ;
V_549 = F_120 ( F_121 ( V_63 ) , V_550 ) + sizeof( V_63 . V_550 ) ;
V_520 = F_120 ( F_121 ( V_65 ) , V_551 ) + sizeof( V_65 . V_551 ) ;
if ( V_259 -> V_286 < V_549 )
return - V_72 ;
if ( V_259 -> V_289 < V_520 )
return - V_70 ;
V_73 = F_128 ( & V_63 , V_259 , V_549 ) ;
if ( V_73 )
return V_73 ;
V_259 -> V_552 += V_549 ;
V_259 -> V_286 -= V_549 ;
...
return - V_72 ;
V_547 = 1 << V_63 . V_550 ;
V_548 = V_547 * sizeof( V_304 ) ;
if ( V_547 == 1 )
V_548 += sizeof( V_304 ) ;
if ( V_259 -> V_286 < V_548 )
return - V_72 ;
if ( V_259 -> V_286 > V_548 &&
! F_174 ( V_259 , V_548 ,
V_259 -> V_286 - V_548 ) )
return - V_343 ;
V_544 = F_179 ( V_547 , sizeof( * V_544 ) ,
V_17 ) ;
if ( ! V_544 )
return - V_175 ;
V_73 = F_128 ( V_544 , V_259 ,
V_547 * sizeof( V_304 ) ) ;
if ( V_73 )
goto V_104;
V_543 = F_179 ( V_547 , sizeof( * V_543 ) , V_17 ) ;
if ( ! V_543 ) {
V_73 = - V_175 ;
goto V_104;
}
for ( V_546 = 0 ; V_546 < V_547 ;
V_546 ++ ) {
V_43 = F_40 ( V_544 [ V_546 ] , V_57 -> V_68 ) ;
if ( ! V_43 ) {
V_73 = - V_72 ;
goto V_554;
}
...
F_1 ( V_2 , 0 , V_57 -> V_68 , & V_555 ) ;
F_31 ( & V_2 -> V_9 ) ;
V_385 . V_550 = V_63 . V_550 ;
V_385 . V_331 = V_543 ;
V_341 = V_59 -> V_556 ( V_59 , & V_385 , V_260 ) ;
if ( F_55 ( V_341 ) ) {
V_73 = F_56 ( V_341 ) ;
goto V_523;
}
V_341 -> V_331 = V_543 ;
V_341 -> V_550 = V_385 . V_550 ;
V_341 -> V_28 = V_2 ;
V_2 -> V_23 = V_341 ;
V_341 -> V_76 = V_59 ;
F_77 ( & V_341 -> V_179 , 0 ) ;
for ( V_444 = 0 ; V_444 < V_547 ; V_444 ++ )
F_99 ( & V_543 [ V_444 ] -> V_179 ) ;
V_73 = F_14 ( & V_46 , V_2 ) ;
if ( V_73 )
goto V_557;
V_65 . V_558 = V_2 -> V_20 ;
V_65 . V_551 = V_341 -> V_551 ;
V_65 . V_282 = V_520 ;
V_73 = F_125 ( V_259 ,
& V_65 , V_65 . V_282 ) ;
if ( V_73 )
...
struct V_40 * * V_331 ;
T_4 V_519 ;
V_519 = F_120 ( F_121 ( V_63 ) , V_558 ) + sizeof( V_63 . V_558 ) ;
if ( V_259 -> V_286 < V_519 )
return - V_72 ;
if ( V_259 -> V_286 > sizeof( V_63 ) &&
! F_174 ( V_259 , sizeof( V_63 ) ,
...
if ( V_73 )
return V_73 ;
V_259 -> V_552 += sizeof( V_63 ) ;
V_259 -> V_286 -= sizeof( V_63 ) ;
if ( V_63 . V_287 )
return - V_72 ;
if ( ! F_138 ( V_335 ) )
return - V_336 ;
if ( V_63 . V_566 . V_239 >= V_567 )
return - V_72 ;
if ( ( V_63 . V_566 . V_239 & V_568 ) &&
( ( V_63 . V_566 . type == V_569 ) ||
( V_63 . V_566 . type == V_570 ) ) )
return - V_72 ;
if ( V_63 . V_566 . V_571 > V_572 )
return - V_72 ;
if ( V_63 . V_566 . V_498 > V_259 -> V_286 ||
V_63 . V_566 . V_498 >
( V_63 . V_566 . V_571 * sizeof( struct V_492 ) ) )
return - V_72 ;
if ( V_63 . V_566 . V_288 [ 0 ] ||
V_63 . V_566 . V_288 [ 1 ] )
return - V_72 ;
if ( V_63 . V_566 . V_571 ) {
V_564 = F_76 ( sizeof( * V_564 ) + V_63 . V_566 . V_498 ,
V_17 ) ;
if ( ! V_564 )
return - V_175 ;
memcpy ( V_564 , & V_63 . V_566 , sizeof( * V_564 ) ) ;
V_73 = F_128 ( V_564 + 1 , V_259 ,
V_63 . V_566 . V_498 ) ;
if ( V_73 )
goto V_573;
} else {
...
V_566 = F_76 ( sizeof( * V_566 ) + V_63 . V_566 . V_498 , V_17 ) ;
if ( ! V_566 ) {
V_73 = - V_175 ;
goto V_184;
}
V_566 -> type = V_564 -> type ;
V_566 -> V_575 = V_564 -> V_575 ;
V_566 -> V_571 = V_564 -> V_571 ;
V_566 -> V_576 = V_564 -> V_576 ;
V_566 -> V_239 = V_564 -> V_239 ;
V_566 -> V_498 = sizeof( * V_566 ) ;
V_493 = V_564 + 1 ;
V_495 = V_566 + 1 ;
for ( V_444 = 0 ; V_444 < V_566 -> V_571 &&
V_63 . V_566 . V_498 > F_120 ( struct V_492 , V_288 ) &&
V_63 . V_566 . V_498 >=
( (struct V_492 * ) V_493 ) -> V_498 ; V_444 ++ ) {
V_73 = F_172 ( V_493 , V_495 ) ;
if ( V_73 )
goto V_104;
V_566 -> V_498 +=
( (union V_494 * ) V_495 ) -> V_498 ;
V_63 . V_566 . V_498 -= ( (struct V_492 * ) V_493 ) -> V_498 ;
V_493 += ( (struct V_492 * ) V_493 ) -> V_498 ;
V_495 += ( (union V_494 * ) V_495 ) -> V_498 ;
}
if ( V_63 . V_566 . V_498 || ( V_444 != V_566 -> V_571 ) ) {
F_183 ( L_3 ,
V_444 , V_63 . V_566 . V_498 ) ;
V_73 = - V_72 ;
goto V_104;
}
V_562 = F_184 ( V_48 , V_566 , V_577 ) ;
if ( F_55 ( V_562 ) ) {
V_73 = F_56 ( V_562 ) ;
goto V_104;
}
...
static int F_187 ( struct V_56 * V_57 ,
struct V_58 * V_59 ,
struct V_582 * V_63 ,
struct V_66 * V_67 )
{
...
if ( ! V_203 )
return - V_175 ;
F_1 ( & V_203 -> V_337 . V_28 , V_63 -> V_3 , V_57 -> V_68 , & V_586 ) ;
F_31 ( & V_203 -> V_337 . V_28 . V_9 ) ;
if ( V_63 -> V_350 == V_587 ) {
V_111 . V_588 . V_589 . V_189 = F_49 ( V_63 -> V_54 , V_57 -> V_68 , & V_327 ) ;
if ( ! V_111 . V_588 . V_589 . V_189 ) {
V_16 = - V_72 ;
goto V_73;
}
V_203 -> V_377 = F_7 ( V_327 , struct V_202 , V_28 ) ;
F_99 ( & V_203 -> V_377 -> V_218 ) ;
V_111 . V_588 . V_589 . V_32 = F_35 ( V_63 -> V_30 , V_57 -> V_68 , 0 ) ;
if ( ! V_111 . V_588 . V_589 . V_32 ) {
V_16 = - V_72 ;
goto V_590;
}
}
...
V_111 . V_111 . V_525 = V_63 -> V_525 ;
V_111 . V_111 . V_122 = V_63 -> V_122 ;
V_111 . V_111 . V_593 = V_63 -> V_593 ;
V_203 -> V_337 . V_366 = 0 ;
F_57 ( & V_203 -> V_337 . V_367 ) ;
V_52 = V_27 -> V_76 -> V_594 ( V_27 , & V_111 , V_67 ) ;
if ( F_55 ( V_52 ) ) {
V_16 = F_56 ( V_52 ) ;
goto V_184;
}
...
V_52 -> V_592 = V_111 . V_592 ;
if ( V_63 -> V_350 == V_587 ) {
V_52 -> V_588 . V_589 . V_32 = V_111 . V_588 . V_589 . V_32 ;
V_52 -> V_588 . V_589 . V_189 = V_111 . V_588 . V_589 . V_189 ;
F_99 ( & V_111 . V_588 . V_589 . V_32 -> V_179 ) ;
F_99 ( & V_111 . V_588 . V_589 . V_189 -> V_179 ) ;
}
F_99 ( & V_27 -> V_179 ) ;
F_77 ( & V_52 -> V_179 , 0 ) ;
...
V_65 . V_525 = V_111 . V_111 . V_525 ;
V_65 . V_122 = V_111 . V_111 . V_122 ;
if ( V_63 -> V_350 == V_587 )
V_65 . V_595 = V_52 -> V_588 . V_589 . V_596 ;
if ( F_62 ( ( void T_3 * ) ( unsigned long ) V_63 -> V_74 ,
& V_65 , sizeof V_65 ) ) {
V_16 = - V_71 ;
goto V_181;
...
if ( F_52 ( & V_63 , V_60 , sizeof V_63 ) )
return - V_71 ;
V_597 . V_74 = V_63 . V_74 ;
V_597 . V_3 = V_63 . V_3 ;
V_597 . V_350 = V_351 ;
V_597 . V_25 = V_63 . V_25 ;
V_597 . V_525 = V_63 . V_525 ;
V_597 . V_122 = V_63 . V_122 ;
V_597 . V_593 = V_63 . V_593 ;
F_54 ( & V_67 , V_60 + sizeof V_63 ,
( unsigned long ) V_63 . V_74 + sizeof V_65 ,
V_61 - sizeof V_63 - sizeof( struct V_251 ) ,
V_62 - sizeof V_65 ) ;
V_16 = F_187 ( V_57 , V_59 , & V_597 , & V_67 ) ;
if ( V_16 )
return V_16 ;
return V_61 ;
}
T_2 V_582 ( struct V_56 * V_57 ,
struct V_58 * V_59 ,
const char T_3 * V_60 , int V_61 , int V_62 )
{
struct V_582 V_63 ;
...
V_61 - sizeof V_63 - sizeof( struct V_251 ) ,
V_62 - sizeof V_65 ) ;
V_16 = F_187 ( V_57 , V_59 , & V_63 , & V_67 ) ;
if ( V_16 )
return V_16 ;
return V_61 ;
}
T_2 F_190 ( struct V_56 * V_57 ,
struct V_58 * V_59 ,
const char T_3 * V_60 , int V_61 ,
int V_62 )
{
...
if ( ! V_52 )
return - V_72 ;
V_111 . V_525 = V_63 . V_525 ;
V_111 . V_593 = V_63 . V_593 ;
V_16 = V_52 -> V_76 -> V_599 ( V_52 , & V_111 , V_63 . V_386 , & V_67 ) ;
F_48 ( V_52 ) ;
return V_16 ? V_16 : V_61 ;
}
T_2 F_191 ( struct V_56 * V_57 ,
struct V_58 * V_59 ,
const char T_3 * V_60 ,
int V_61 , int V_62 )
{
...
if ( ! V_52 )
return - V_72 ;
V_16 = F_192 ( V_52 , & V_111 ) ;
F_48 ( V_52 ) ;
if ( V_16 )
return V_16 ;
memset ( & V_65 , 0 , sizeof V_65 ) ;
V_65 . V_525 = V_111 . V_525 ;
V_65 . V_122 = V_111 . V_122 ;
V_65 . V_593 = V_111 . V_593 ;
if ( F_62 ( ( void T_3 * ) ( unsigned long ) V_63 . V_74 ,
& V_65 , sizeof V_65 ) )
return - V_71 ;
return V_61 ;
}
T_2 F_193 ( struct V_56 * V_57 ,
struct V_58 * V_59 ,
const char T_3 * V_60 , int V_61 ,
int V_62 )
{
...
return - V_72 ;
V_52 = V_2 -> V_23 ;
V_203 = F_7 ( V_2 , struct V_602 , V_28 ) ;
V_350 = V_52 -> V_350 ;
V_16 = F_188 ( V_52 ) ;
if ( ! V_16 )
V_2 -> V_12 = 0 ;
...
return V_16 ;
if ( V_350 == V_587 ) {
V_603 = F_7 ( V_203 , struct V_584 , V_337 ) ;
F_101 ( & V_603 -> V_377 -> V_218 ) ;
}
F_20 ( & V_51 , V_2 ) ;
F_53 ( & V_57 -> V_9 ) ;
F_83 ( & V_2 -> V_182 ) ;
...
if ( V_63 . V_288 )
return - V_72 ;
V_65 . V_282 = F_120 ( F_121 ( V_65 ) , V_606 ) ;
if ( V_259 -> V_289 < V_65 . V_282 )
return - V_70 ;
V_73 = V_59 -> V_607 ( V_59 , & V_111 , V_260 ) ;
if ( V_73 )
return V_73 ;
F_69 ( V_57 , V_59 , & V_65 . V_281 , & V_111 ) ;
if ( V_259 -> V_289 < V_65 . V_282 + sizeof( V_65 . V_606 ) )
goto V_608;
#ifdef F_59
V_65 . V_606 . V_609 = V_111 . V_606 . V_609 ;
V_65 . V_606 . V_610 . V_611 =
V_111 . V_606 . V_610 . V_611 ;
V_65 . V_606 . V_610 . V_612 =
V_111 . V_606 . V_610 . V_612 ;
V_65 . V_606 . V_610 . V_613 =
V_111 . V_606 . V_610 . V_613 ;
#endif
V_65 . V_282 += sizeof( V_65 . V_606 ) ;
if ( V_259 -> V_289 < V_65 . V_282 + sizeof( V_65 . V_614 ) )
goto V_608;
V_65 . V_614 = V_111 . V_614 ;
V_65 . V_282 += sizeof( V_65 . V_614 ) ;
if ( V_259 -> V_289 < V_65 . V_282 + sizeof( V_65 . V_615 ) )
goto V_608;
V_65 . V_615 = V_111 . V_615 ;
V_65 . V_282 += sizeof( V_65 . V_615 ) ;
if ( V_259 -> V_289 < V_65 . V_282 + sizeof( V_65 . V_616 ) )
goto V_608;
V_65 . V_616 = V_111 . V_99 ;
V_65 . V_282 += sizeof( V_65 . V_616 ) ;
V_608:
