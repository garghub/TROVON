...
if ( ! V_103 -> V_264 )
return - V_265 ;
V_14 = F_155 ( V_103 , sizeof( * V_14 ) , V_266 ) ;
if ( ! V_14 )
return - V_267 ;
V_261 = F_156 ( V_268 , V_103 -> V_264 ) ;
if ( V_261 )
V_259 = (struct V_115 * ) V_261 -> V_269 ;
V_14 -> V_5 = F_157 ( V_103 -> V_264 , L_14 ) ;
if ( ! V_259 || V_14 -> V_5 >= V_259 -> V_270 ||
V_14 -> V_5 < 0 ) {
F_158 ( V_103 , L_15 ,
V_103 -> V_264 -> V_271 ) ;
return - V_22 ;
...
F_160 ( & V_14 -> V_23 ) ;
F_161 ( & V_14 -> V_98 ) ;
V_263 = F_162 ( V_102 , V_272 , 0 ) ;
V_14 -> V_273 = F_163 ( V_103 , V_263 ) ;
if ( F_146 ( V_14 -> V_273 ) )
return F_152 ( V_14 -> V_273 ) ;
V_263 = F_162 ( V_102 , V_274 , 0 ) ;
if ( V_263 == NULL ) {
F_158 ( V_103 , L_16 ) ;
return - V_19 ;
}
...
if ( V_71 )
return V_71 ;
V_71 = F_164 ( V_103 , V_263 -> V_275 , F_32 ,
0 , F_85 ( V_103 ) , V_14 ) ;
if ( V_71 ) {
...
static int F_176 ( struct V_77 * V_103 )
{
struct V_13 * V_14 = F_173 ( V_103 ) ;
struct V_29 * V_30 ;
unsigned long V_11 ;
...
static int F_177 ( struct V_77 * V_103 )
{
struct V_13 * V_14 = F_173 ( V_103 ) ;
bool V_28 = F_28 ( V_101 , & V_14 -> V_32 ) ;
int V_71 ;
if ( F_44 ( V_278 , & V_14 -> V_32 ) )
return 0 ;
V_71 = F_23 ( V_14 , V_28 ) ;
if ( V_71 < 0 || ! F_24 ( V_14 ) )
return V_71 ;
