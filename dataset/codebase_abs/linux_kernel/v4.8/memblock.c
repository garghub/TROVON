...
T_3 T_5 F_90 ( unsigned long V_102 )
{
...
V_104 = F_92 ( V_35 ) ;
V_105 = F_93 ( V_35 ) ;
V_104 = F_94 (unsigned long, start_pfn, limit_pfn) ;
V_105 = F_94 (unsigned long, end_pfn, limit_pfn) ;
V_103 += V_105 - V_104 ;
}
return F_95 ( V_103 ) ;
}
...
{
struct V_4 * type = & V_5 . V_6 ;
int V_109 = F_101 ( type , F_95 ( V_110 ) ) ;
if ( V_109 == - 1 )
return - 1 ;
