...
if ( V_25 )
F_14 ( & V_40 -> V_27 , V_25 ) ;
if ( F_87 && F_87 ( V_40 , V_20 ) ) {
V_40 -> V_26 [ V_20 ] = 1 ;
return V_40 -> V_26 [ V_20 ] ;
}
if ( ( V_40 -> V_36 & F_89 ( V_20 ) ) && V_40 -> V_135 ) {
...
if ( V_81 -> V_30 ) {
V_81 -> V_137 = 1 ;
V_133 += F_86 ( V_81 -> V_22 [ V_20 ] , V_25 , F_87 ) ;
V_81 -> V_137 = 0 ;
}
}
...
struct V_84 * V_25 ,
bool (* F_87)( struct V_13 * V_94 ,
enum V_19 ) )
{
return F_85 ( V_40 , V_25 , V_32 ,
F_91 , F_87 ) ;
}
static int F_92 ( struct V_13 * V_40 ,
struct V_84 * V_25 ,
bool (* F_87)( struct V_13 * V_94 ,
enum V_19 ) )
{
...
int F_93 ( struct V_138 * V_139 , int V_140 ,
struct V_76 * * V_25 ,
bool (* F_87)( struct V_13 * ,
enum V_19 ) )
{
...
if ( V_140 == V_142 )
V_52 = F_91 ( V_139 -> V_143 , & V_80 ,
F_87 ) ;
else
V_52 = F_92 ( V_139 -> V_144 , & V_80 ,
F_87 ) ;
F_95 ( V_80 . V_145 ) ;
V_50 = F_83 ( V_25 , & V_80 ) ;
if ( V_50 )
...
if ( F_98 ( V_146 ) ) {
if ( V_14 -> V_67 & V_147 ) {
V_50 = F_99 ( V_14 -> V_148 , false ) ;
if ( V_50 != 0 )
F_100 ( V_14 -> V_2 -> V_8 ,
L_12 ,
V_14 -> V_17 , V_50 ) ;
}
return F_101 ( V_14 -> V_148 ) ;
} else {
if ( V_14 -> V_67 & V_147 ) {
V_50 = F_99 ( V_14 -> V_148 , true ) ;
if ( V_50 != 0 )
F_100 ( V_14 -> V_2 -> V_8 ,
L_13 ,
V_14 -> V_17 , V_50 ) ;
}
return F_102 ( V_14 -> V_148 , V_14 -> V_64 ) ;
}
}
...
int V_152 , V_99 ;
F_88 ( V_14 , V_153 ) ;
V_152 = F_92 ( V_14 , NULL , NULL ) ;
V_99 = F_91 ( V_14 , NULL , NULL ) ;
...
static int F_112 ( struct V_13 * V_154 ,
struct V_13 * V_155 ,
bool V_156 )
{
int * V_157 ;
...
static void F_113 ( struct V_13 * V_161 ,
struct V_84 * V_25 ,
bool V_156 )
{
struct V_13 * V_14 ;
F_18 (w, list, power_list)
if ( F_112 ( V_161 , V_14 , V_156 ) < 0 ) {
F_14 ( & V_161 -> V_162 , & V_14 -> V_162 ) ;
return;
}
F_14 ( & V_161 -> V_162 , V_25 ) ;
}
static void F_114 ( struct V_35 * V_3 ,
...
static void F_118 ( struct V_35 * V_3 ,
struct V_84 * V_171 )
{
struct V_1 * V_2 ;
struct V_13 * V_14 ;
...
unsigned int V_69 = 0 ;
unsigned int V_62 = 0 ;
V_14 = F_119 ( V_171 , struct V_13 , V_162 ) ;
V_61 = V_14 -> V_61 ;
V_2 = V_14 -> V_2 ;
F_18 (w, pending, power_list) {
F_120 ( V_61 != V_14 -> V_61 || V_2 != V_14 -> V_2 ) ;
V_14 -> V_83 = V_14 -> V_86 ;
...
F_114 ( V_3 , V_14 , V_164 ) ;
F_114 ( V_3 , V_14 , V_166 ) ;
}
if ( V_61 >= 0 ) {
F_6 ( V_2 -> V_8 , V_3 -> V_6 ,
L_24 ,
...
F_18 (w, pending, power_list) {
F_114 ( V_3 , V_14 , V_165 ) ;
F_114 ( V_3 , V_14 , V_167 ) ;
}
}
...
for ( V_94 = 0 ; V_94 < F_123 ( V_158 ) ; V_94 ++ )
if ( V_157 [ V_94 ] == V_173 )
V_176 -> V_177 ( V_176 ,
V_94 ,
V_174 ) ;
...
static void F_126 ( struct V_35 * V_3 )
{
...
static void F_127 ( void * V_45 , T_5 V_188 )
{
...
static void F_129 ( void * V_45 , T_5 V_188 )
{
struct V_1 * V_172 = V_45 ;
int V_50 ;
if ( V_172 -> V_98 == V_193 &&
...
static void F_131 ( struct V_13 * V_194 ,
bool V_83 , bool V_30 )
{
if ( ! V_30 )
return;
...
static void F_132 ( struct V_13 * V_14 , bool V_83 ,
struct V_84 * V_195 ,
struct V_84 * V_196 )
{
struct V_23 * V_81 ;
...
F_133 ( V_14 , V_83 ) ;
F_76 (w, path)
F_131 ( V_81 -> V_33 , V_83 , V_81 -> V_30 ) ;
if ( ! V_14 -> V_28 ) {
F_110 (w, path)
F_131 ( V_81 -> V_34 , V_83 ,
V_81 -> V_30 ) ;
}
if ( V_83 )
F_113 ( V_14 , V_195 , true ) ;
else
F_113 ( V_14 , V_196 , false ) ;
}
...
static int F_136 ( struct V_35 * V_3 , int V_146 )
{
struct V_13 * V_14 ;
struct V_1 * V_172 ;
F_17 ( V_195 ) ;
...
F_114 ( V_3 , V_14 , V_169 ) ;
}
F_18 (w, &up_list, power_list) {
F_114 ( V_3 , V_14 , V_168 ) ;
}
F_121 ( V_3 , & V_196 , V_146 , false ) ;
F_126 ( V_3 ) ;
F_121 ( V_3 , & V_195 , V_146 , true ) ;
F_18 (d, &card->dapm_list, list) {
if ( V_172 != & V_3 -> V_2 )
F_141 ( F_129 , V_172 ,
& V_199 ) ;
...
static T_6 F_144 ( struct V_208 * V_208 ,
char T_7 * V_209 ,
T_4 V_210 , T_8 * V_211 )
{
...
F_25 ( & V_3 -> V_5 ) ;
V_50 = F_146 ( V_209 , V_210 , V_211 , V_10 , V_50 ) ;
F_9 ( V_10 ) ;
return V_50 ;
}
static T_6 F_147 ( struct V_208 * V_208 , char T_7 * V_209 ,
T_4 V_210 , T_8 * V_211 )
{
...
break;
default:
F_115 ( 1 , L_54 , V_2 -> V_98 ) ;
V_96 = L_55 ;
break;
}
return F_146 ( V_209 , V_210 , V_211 , V_96 ,
strlen ( V_96 ) ) ;
}
...
if ( ! V_215 )
return;
V_2 -> V_216 = F_149 ( L_56 , V_215 ) ;
if ( ! V_2 -> V_216 ) {
F_100 ( V_2 -> V_8 ,
L_57 ) ;
return;
}
V_172 = F_150 ( L_58 , 0444 ,
V_2 -> V_216 , V_2 ,
& V_217 ) ;
if ( ! V_172 )
F_100 ( V_2 -> V_8 ,
...
static inline void F_151 ( struct V_13 * V_14 )
{
}
static inline void F_152 ( struct V_1 * V_2 )
{
}
static void F_154 ( struct V_23 * V_81 ,
...
static int F_155 ( struct V_35 * V_3 ,
...
F_94 ( & V_3 -> V_5 , V_141 ) ;
V_3 -> V_184 = V_184 ;
V_50 = F_155 ( V_3 , V_42 , V_219 , V_49 ) ;
V_3 -> V_184 = NULL ;
F_25 ( & V_3 -> V_5 ) ;
if ( V_50 > 0 )
F_158 ( V_3 ) ;
...
static int F_159 ( struct V_35 * V_3 ,
...
static T_6 F_161 ( struct V_222 * V_223 ,
char * V_10 )
{
struct V_1 * V_2 = F_162 ( V_223 ) ;
struct V_13 * V_14 ;
int V_210 = 0 ;
char * V_224 = L_63 ;
if ( ! V_223 -> V_3 )
...
static T_6 F_164 ( struct V_7 * V_8 ,
struct V_232 * V_233 , char * V_10 )
{
struct V_234 * V_235 = F_165 ( V_8 ) ;
int V_94 , V_210 = 0 ;
F_24 ( & V_235 -> V_3 -> V_5 ) ;
for ( V_94 = 0 ; V_94 < V_235 -> V_236 ; V_94 ++ ) {
struct V_222 * V_223 = V_235 -> V_237 [ V_94 ] -> V_88 ;
V_210 += F_161 ( V_223 , V_10 + V_210 ) ;
}
F_25 ( & V_235 -> V_3 -> V_5 ) ;
return V_210 ;
}
static void F_166 ( struct V_23 * V_81 )
{
F_95 ( & V_81 -> V_238 [ V_31 ] ) ;
F_95 ( & V_81 -> V_238 [ V_32 ] ) ;
F_95 ( & V_81 -> V_82 ) ;
F_95 ( & V_81 -> V_25 ) ;
F_9 ( V_81 ) ;
}
...
F_122 (w, next_w, &dapm->card->widgets, list) {
if ( V_14 -> V_2 != V_2 )
continue;
F_167 ( V_14 ) ;
}
...
{
struct V_13 * V_14 = F_172 ( V_2 , V_243 , true ) ;
F_1 ( V_2 ) ;
if ( ! V_14 ) {
...
if ( ! V_2 -> V_3 || ! V_2 -> V_3 -> V_4 )
return 0 ;
return F_136 ( V_2 -> V_3 , V_221 ) ;
}
int F_175 ( struct V_1 * V_2 )
{
int V_50 ;
F_94 ( & V_2 -> V_3 -> V_5 , V_141 ) ;
V_50 = F_174 ( V_2 ) ;
F_25 ( & V_2 -> V_3 -> V_5 ) ;
return V_50 ;
}
...
V_50 = F_177 ( V_2 , V_254 , V_255 , V_251 ) ;
if ( V_50 )
return V_50 ;
...
F_178 ( & V_81 -> V_25 , & V_2 -> V_3 -> V_52 ) ;
F_145 (dir)
F_178 ( & V_81 -> V_238 [ V_20 ] , & V_80 [ V_20 ] -> V_126 [ V_20 ] ) ;
F_145 (dir) {
F_176 ( V_80 [ V_20 ] ) ;
F_12 ( V_80 [ V_20 ] , L_75 ) ;
}
...
F_94 ( & V_2 -> V_3 -> V_5 , V_266 ) ;
for ( V_94 = 0 ; V_94 < V_264 ; V_94 ++ ) {
V_265 = F_179 ( V_2 , V_258 ) ;
if ( V_265 < 0 ) {
F_74 ( V_2 -> V_8 , L_82 ,
V_258 -> V_33 ,
...
const struct V_257 * V_258 )
{
struct V_13 * V_33 = F_172 ( V_2 ,
V_258 -> V_33 ,
true ) ;
struct V_13 * V_34 = F_172 ( V_2 ,
V_258 -> V_34 ,
true ) ;
struct V_23 * V_81 ;
int V_210 = 0 ;
...
V_271 |= V_272 ;
V_50 = F_155 ( V_3 , V_42 , V_105 [ 0 ] , V_49 ) ;
V_3 -> V_184 = NULL ;
}
F_25 ( & V_3 -> V_5 ) ;
if ( V_50 > 0 )
...
switch ( V_14 -> V_53 ) {
case V_204 :
V_14 -> V_148 = F_198 ( V_2 -> V_8 , V_14 -> V_17 ) ;
if ( F_199 ( V_14 -> V_148 ) ) {
V_50 = F_200 ( V_14 -> V_148 ) ;
F_74 ( V_2 -> V_8 , L_92 ,
V_14 -> V_17 , V_50 ) ;
return NULL ;
}
...
case V_205 :
#ifdef F_201
V_14 -> V_149 = F_202 ( V_2 -> V_8 , V_14 -> V_17 ) ;
if ( F_199 ( V_14 -> V_149 ) ) {
V_50 = F_200 ( V_14 -> V_149 ) ;
F_74 ( V_2 -> V_8 , L_92 ,
V_14 -> V_17 , V_50 ) ;
return NULL ;
}
...
V_14 -> V_17 = F_203 ( V_40 -> V_17 , V_12 ) ;
if ( V_14 -> V_17 == NULL ) {
F_9 ( V_14 ) ;
return NULL ;
}
...
int V_50 ;
if ( F_120 ( ! V_288 ) ||
F_120 ( F_11 ( & V_14 -> V_126 [ V_32 ] ) ||
F_11 ( & V_14 -> V_126 [ V_31 ] ) ) )
return - V_123 ;
V_285 = F_119 ( & V_14 -> V_126 [ V_32 ] ,
struct V_23 ,
V_238 [ V_32 ] ) ;
V_286 = F_119 ( & V_14 -> V_126 [ V_31 ] ,
struct V_23 ,
V_238 [ V_31 ] ) ;
V_33 = V_285 -> V_33 -> V_296 ;
V_34 = V_286 -> V_34 -> V_296 ;
if ( V_288 -> V_297 ) {
V_9 = F_206 ( V_288 -> V_297 ) - 1 ;
} else {
F_100 ( V_14 -> V_2 -> V_8 , L_93 ,
V_288 -> V_297 ) ;
V_9 = 0 ;
}
...
F_207 ( F_208 ( V_289 , V_298 ) , V_9 ) ;
F_209 ( V_289 , V_299 ) -> V_279 =
V_288 -> V_300 ;
F_209 ( V_289 , V_299 ) -> V_63 =
V_288 -> V_301 ;
F_209 ( V_289 , V_302 ) -> V_279
= V_288 -> V_303 ;
F_209 ( V_289 , V_302 ) -> V_63
= V_288 -> V_304 ;
memset ( & V_292 , 0 , sizeof( V_292 ) ) ;
V_295 = F_29 ( sizeof( * V_295 ) , V_12 ) ;
if ( ! V_295 ) {
V_50 = - V_51 ;
goto V_99;
}
...
case V_164 :
V_292 . V_140 = V_305 ;
if ( V_33 -> V_306 -> V_307 && V_33 -> V_306 -> V_307 -> V_308 ) {
V_50 = V_33 -> V_306 -> V_307 -> V_308 ( & V_292 , V_33 ) ;
if ( V_50 < 0 ) {
F_74 ( V_33 -> V_8 ,
L_94 , V_50 ) ;
goto V_99;
...
V_50 = F_210 ( & V_292 , V_289 , V_33 ) ;
if ( V_50 < 0 )
goto V_99;
V_292 . V_140 = V_142 ;
if ( V_34 -> V_306 -> V_307 && V_34 -> V_306 -> V_307 -> V_308 ) {
V_50 = V_34 -> V_306 -> V_307 -> V_308 ( & V_292 , V_34 ) ;
if ( V_50 < 0 ) {
F_74 ( V_34 -> V_8 ,
L_94 , V_50 ) ;
goto V_99;
...
V_50 = F_211 ( V_34 , 0 ,
V_142 ) ;
if ( V_50 != 0 && V_50 != - V_309 )
F_100 ( V_34 -> V_8 , L_95 , V_50 ) ;
V_50 = 0 ;
break;
case V_166 :
V_50 = F_211 ( V_34 , 1 ,
V_142 ) ;
if ( V_50 != 0 && V_50 != - V_309 )
F_100 ( V_34 -> V_8 , L_96 , V_50 ) ;
V_50 = 0 ;
V_33 -> V_213 -- ;
if ( V_33 -> V_306 -> V_307 && V_33 -> V_306 -> V_307 -> V_310 ) {
V_292 . V_140 = V_305 ;
V_33 -> V_306 -> V_307 -> V_310 ( & V_292 , V_33 ) ;
}
V_34 -> V_213 -- ;
if ( V_34 -> V_306 -> V_307 && V_34 -> V_306 -> V_307 -> V_310 ) {
V_292 . V_140 = V_142 ;
V_34 -> V_306 -> V_307 -> V_310 ( & V_292 , V_34 ) ;
}
break;
default:
F_115 ( 1 , L_20 , V_146 ) ;
...
V_313 = F_217 ( V_3 -> V_8 , V_127 ,
sizeof( char * ) , V_12 ) ;
if ( ! V_313 )
return - V_51 ;
V_312 = F_218 ( V_3 -> V_8 , V_12 , L_97 ,
V_33 -> V_17 , V_34 -> V_17 ) ;
if ( ! V_312 ) {
V_50 = - V_51 ;
goto V_316;
...
V_313 [ V_210 ] = F_219 ( V_3 -> V_8 ,
V_288 -> V_317 ,
strlen ( V_288 -> V_317 ) + 1 ,
V_12 ) ;
if ( ! V_313 [ V_210 ] ) {
V_50 = - V_51 ;
goto V_318;
...
F_220 ( V_3 -> V_8 , V_14 ) ;
V_320:
F_220 ( V_3 -> V_8 , ( void * ) V_59 . V_103 ) ;
V_319:
F_220 ( V_3 -> V_8 , ( void * ) V_57 ) ;
V_318:
F_220 ( V_3 -> V_8 , V_312 ) ;
V_316:
for ( V_210 = 0 ; V_210 < V_127 ; V_210 ++ )
F_220 ( V_3 -> V_8 , ( void * ) V_313 [ V_210 ] ) ;
F_220 ( V_3 -> V_8 , V_313 ) ;
return V_50 ;
}
...
struct V_13 V_59 ;
struct V_13 * V_14 ;
F_120 ( V_2 -> V_8 != V_139 -> V_8 ) ;
memset ( & V_59 , 0 , sizeof( V_59 ) ) ;
V_59 . V_61 = V_106 ;
if ( V_139 -> V_306 -> V_322 . V_317 ) {
V_59 . V_53 = V_284 ;
V_59 . V_17 = V_139 -> V_306 -> V_322 . V_317 ;
V_59 . V_212 = V_139 -> V_306 -> V_322 . V_317 ;
F_82 ( V_139 -> V_8 , L_101 ,
V_59 . V_17 ) ;
V_14 = F_33 ( V_2 , & V_59 ) ;
if ( ! V_14 ) {
F_74 ( V_2 -> V_8 , L_102 ,
V_139 -> V_306 -> V_322 . V_317 ) ;
return - V_51 ;
}
V_14 -> V_296 = V_139 ;
V_139 -> V_143 = V_14 ;
}
if ( V_139 -> V_306 -> V_323 . V_317 ) {
V_59 . V_53 = V_283 ;
V_59 . V_17 = V_139 -> V_306 -> V_323 . V_317 ;
V_59 . V_212 = V_139 -> V_306 -> V_323 . V_317 ;
F_82 ( V_139 -> V_8 , L_101 ,
V_59 . V_17 ) ;
V_14 = F_33 ( V_2 , & V_59 ) ;
if ( ! V_14 ) {
F_74 ( V_2 -> V_8 , L_102 ,
V_139 -> V_306 -> V_323 . V_317 ) ;
return - V_51 ;
}
V_14 -> V_296 = V_139 ;
V_139 -> V_144 = V_14 ;
...
int F_222 ( struct V_35 * V_3 )
{
struct V_13 * V_324 , * V_14 ;
struct V_13 * V_325 , * V_34 ;
struct V_138 * V_139 ;
...
if ( ! V_14 -> V_212 || ! strstr ( V_14 -> V_212 , V_324 -> V_212 ) )
continue;
if ( V_324 -> V_53 == V_284 ) {
V_325 = V_324 ;
V_34 = V_14 ;
...
F_82 ( V_139 -> V_8 , L_103 , V_325 -> V_17 , V_34 -> V_17 ) ;
F_35 ( V_14 -> V_2 , V_325 , V_34 , NULL , NULL ) ;
}
}
return 0 ;
}
static void F_223 ( struct V_35 * V_3 ,
struct V_234 * V_235 )
{
struct V_138 * V_326 = V_235 -> V_326 ;
struct V_13 * V_34 , * V_33 ;
int V_94 ;
for ( V_94 = 0 ; V_94 < V_235 -> V_236 ; V_94 ++ ) {
struct V_138 * V_327 = V_235 -> V_237 [ V_94 ] ;
if ( V_327 -> V_143 && V_326 -> V_143 ) {
V_33 = V_326 -> V_143 ;
V_34 = V_327 -> V_143 ;
F_82 ( V_235 -> V_8 , L_104 ,
V_326 -> V_88 -> V_17 , V_33 -> V_17 ,
V_327 -> V_88 -> V_17 , V_34 -> V_17 ) ;
F_35 ( & V_3 -> V_2 , V_33 , V_34 ,
NULL , NULL ) ;
}
if ( V_327 -> V_144 && V_326 -> V_144 ) {
V_33 = V_327 -> V_144 ;
V_34 = V_326 -> V_144 ;
F_82 ( V_235 -> V_8 , L_104 ,
V_327 -> V_88 -> V_17 , V_33 -> V_17 ,
V_326 -> V_88 -> V_17 , V_34 -> V_17 ) ;
F_35 ( & V_3 -> V_2 , V_33 , V_34 ,
NULL , NULL ) ;
}
}
}
static void F_224 ( struct V_138 * V_139 , int V_140 ,
int V_146 )
{
struct V_13 * V_14 ;
unsigned int V_247 ;
...
void F_225 ( struct V_35 * V_3 )
{
struct V_234 * V_235 ;
F_18 (rtd, &card->rtd_list, list) {
if ( V_235 -> V_332 -> V_333 || V_235 -> V_332 -> V_289 )
continue;
F_223 ( V_3 , V_235 ) ;
}
}
static void F_226 ( struct V_234 * V_235 , int V_140 ,
int V_146 )
{
int V_94 ;
F_224 ( V_235 -> V_326 , V_140 , V_146 ) ;
for ( V_94 = 0 ; V_94 < V_235 -> V_236 ; V_94 ++ )
F_224 ( V_235 -> V_237 [ V_94 ] , V_140 , V_146 ) ;
F_136 ( V_235 -> V_3 , V_146 ) ;
}
void F_227 ( struct V_234 * V_235 , int V_140 ,
int V_146 )
{
struct V_35 * V_3 = V_235 -> V_3 ;
F_94 ( & V_3 -> V_5 , V_141 ) ;
F_226 ( V_235 , V_140 , V_146 ) ;
F_25 ( & V_3 -> V_5 ) ;
}
int F_228 ( struct V_1 * V_2 ,
const char * V_243 )
{
return F_173 ( V_2 , V_243 , 1 ) ;
}
int F_195 ( struct V_1 * V_2 , const char * V_243 )
{
int V_50 ;
F_94 ( & V_2 -> V_3 -> V_5 , V_141 ) ;
V_50 = F_173 ( V_2 , V_243 , 1 ) ;
F_25 ( & V_2 -> V_3 -> V_5 ) ;
return V_50 ;
}
...
int F_233 ( struct V_1 * V_2 , const char * V_243 )
{
int V_50 ;
F_94 ( & V_2 -> V_3 -> V_5 , V_141 ) ;
V_50 = F_173 ( V_2 , V_243 , 0 ) ;
...
const char * V_243 )
{
struct V_13 * V_14 = F_172 ( V_2 , V_243 , false ) ;
if ( ! V_14 ) {
F_74 ( V_2 -> V_8 , L_106 , V_243 ) ;
return - V_123 ;
}
