...
V_14 -> V_363 [ 2 ] & 0xf ;
V_401 -> V_111 . V_418 . V_422 = V_14 -> V_363 [ 12 ] ;
V_401 -> V_111 . V_418 . V_423 = V_14 -> V_363 [ 13 ] ;
...
if ( V_396 & V_445 )
V_441 = F_96 ( V_395 -> V_446 ) ;
memcpy ( V_14 -> V_363 , & V_395 -> V_452 + V_441 , V_450 ) ;
}
V_438 = ( T_1 * ) V_14 -> V_363 ;
...
&& V_8 -> V_466 > 1 ) {
V_461 = F_143 () ;
if ( V_461 < V_8 -> V_133 . V_467 ) {
V_459 = V_8 -> V_133 . V_468 ;
V_459 += V_461 ;
return V_459 -> V_469 ;
}
}
V_460 = F_144 ( 1 , & V_8 -> V_470 ) ;
V_460 = ( V_460 % V_8 -> V_466 ) ;
return V_460 ;
}
static void
F_145 ( struct V_12 * V_8 , struct V_141 * V_471 ,
struct V_141 * V_372 )
{
struct V_31 * V_32 =
(struct V_31 * ) V_471 -> V_130 ;
...
return;
V_45 = V_41 -> V_26 -> V_6 ;
V_32 -> V_48 = ( V_372 -> V_84 . V_111 . V_473 [ 4 ] & V_474 ) ;
V_32 -> V_128 = V_372 -> V_84 . V_475 ;
V_32 -> V_152 = V_372 -> V_101 & V_476 ;
#ifdef F_102
if ( V_32 -> V_242 ) {
struct V_222 * V_15 = NULL ;
...
case V_487 :
case V_488 :
V_41 -> V_48 = F_117 ( V_489 , 0 ) ;
V_401 = F_134 ( V_8 ) ;
if ( ! V_401 )
break;
V_401 -> V_111 . V_490 . V_405 =
V_430 ;
V_401 -> V_111 . V_490 . V_407 =
( V_32 -> V_128 == V_487 ) ?
V_491 : V_492 ;
if ( V_40 && F_133 ( V_40 ) ) {
memcpy ( & V_401 -> V_111 . V_490 . V_411 ,
& V_40 -> V_236 ,
sizeof( struct V_237 ) ) ;
memcpy ( & V_401 -> V_111 . V_490 . V_412 ,
& V_40 -> V_413 ,
sizeof( struct V_237 ) ) ;
}
V_401 -> V_5 = V_5 ;
...
if ( ( V_40 -> V_512 < V_5 -> V_515 ) &&
F_24 ( V_49 , V_40 -> V_514 +
F_147 ( V_516 ) ) ) {
F_20 ( V_45 -> V_51 , V_43 ) ;
V_472 = V_40 -> V_512 * V_517
/ 100 ;
V_472 = V_472 ? V_472 : 1 ;
V_40 -> V_512 += V_472 ;
if ( V_40 -> V_512 > V_5 -> V_515 )
V_40 -> V_512 = V_5 -> V_515 ;
V_40 -> V_514 = V_49 ;
F_21 ( V_45 -> V_51 , V_43 ) ;
}
}
...
{
int V_47 , V_520 ;
for ( V_47 = 0 , V_520 = 0 ; V_47 < sizeof( struct V_92 ) ;
V_47 += sizeof( T_1 ) , V_520 ++ ) {
( ( T_1 * ) V_97 ) [ V_520 ] = F_91 ( ( ( T_1 * ) V_92 ) [ V_520 ] ) ;
}
}
static void
...
& V_32 -> V_92 -> V_524 ) ;
V_522 = & V_92 -> V_525 [ 0 ] ;
memcpy ( V_522 , V_13 -> V_14 , V_13 -> V_526 ) ;
if ( V_13 -> V_526 < V_527 ) {
V_522 += V_13 -> V_526 ;
memset ( V_522 , 0 , ( V_527 - V_13 -> V_526 ) ) ;
}
V_92 -> V_528 = V_529 ;
V_523 = ( V_8 -> V_115 == V_456 ) ;
V_521 -> V_84 . V_111 . V_216 . V_530 = 0 ;
if ( F_84 ( V_13 ) ) {
if ( V_207 == V_296 ) {
V_201 -> V_531 = V_532 ;
V_201 -> V_533 = V_534 ;
...
V_340 = F_92 ( V_13 ) ;
if ( V_340 < V_5 -> V_535 )
V_521 -> V_84 . V_111 . V_216 . V_530 = V_340 ;
else
V_521 -> V_84 . V_111 . V_216 . V_530 =
V_5 -> V_535 ;
}
V_92 -> V_538 = V_539 ;
V_8 -> V_540 ++ ;
...
V_521 -> V_84 . V_457 = V_40 -> V_546 ;
if ( V_523 )
V_521 -> V_84 . V_457 =
V_8 -> V_133 . V_547 [ V_40 -> V_546 ] ;
if ( V_40 -> V_548 & V_549 )
V_521 -> V_84 . V_550 = 1 ;
else
V_521 -> V_84 . V_550 = 0 ;
V_521 -> V_84 . V_126 = ( V_40 -> V_548 & 0x0f ) ;
V_521 -> V_130 = V_32 ;
V_521 -> V_551 = F_145 ;
V_521 -> V_84 . V_552 = V_32 -> V_553 ;
V_521 -> V_5 = V_5 ;
}
static int
...
F_151 ( V_410 , & V_92 -> V_524 ) ;
V_92 -> V_444 = V_554 ;
if ( V_5 -> V_8 -> V_115 == 3 &&
! ( V_5 -> V_8 -> V_116 & V_117 ) )
F_149 ( V_555 -> V_119 . V_120 . V_121 , V_92 ) ;
V_555 -> V_531 = V_544 ;
V_555 -> V_457 = V_143 -> V_546 ;
if ( V_5 -> V_8 -> V_115 == V_456 ) {
V_555 -> V_457 =
V_5 -> V_8 -> V_133 . V_547 [ V_143 -> V_546 ] ;
}
V_555 -> V_550 = ( V_143 -> V_548 & V_549 ) ? 1 : 0 ;
V_555 -> V_126 = ( V_143 -> V_548 & 0x0f ) ;
V_555 -> V_533 = 0 ;
V_555 -> V_111 . V_216 . V_217 = 0 ;
if ( V_32 -> V_553 > 0xff ) {
V_555 -> V_552 = 0 ;
} else
V_555 -> V_552 = V_32 -> V_553 ;
if ( V_5 -> V_8 -> V_115 == V_456 )
F_14 ( V_5 -> V_8 , V_32 ) ;
return 1 ;
}
int
F_153 ( struct V_12 * V_8 , V_189 V_556 )
{
V_8 -> F_135 = F_135 ;
V_8 -> F_150 = F_150 ;
switch ( V_556 ) {
...
struct V_12 * V_8 = V_5 -> V_8 ;
int V_353 , V_563 = 0 ;
static char V_564 [ 384 ] ;
memset ( V_564 , 0 , 384 ) ;
if ( V_8 && V_8 -> V_209 ) {
strncpy ( V_564 , V_8 -> V_565 , 256 ) ;
V_353 = strlen ( V_564 ) ;
snprintf ( V_564 + V_353 ,
384 - V_353 ,
L_88 ,
V_8 -> V_209 -> V_566 -> V_567 ,
V_8 -> V_209 -> V_568 ,
V_8 -> V_209 -> V_569 ) ;
V_353 = strlen ( V_564 ) ;
if ( V_8 -> V_570 [ 0 ] ) {
...
V_563 = F_156 ( V_8 ) ;
if ( V_563 != 0 )
snprintf ( V_564 + V_353 , 384 - V_353 ,
L_90 , V_563 ) ;
}
return V_564 ;
}
...
{
unsigned long V_571 =
( V_49 + F_147 ( V_8 -> V_572 ) ) ;
if ( ! F_56 ( & V_8 -> V_147 . V_148 [ V_573 ] . V_574 ) )
F_158 ( & V_8 -> V_575 ,
V_571 ) ;
}
...
void F_160 ( unsigned long V_522 )
{
struct V_12 * V_8 = (struct V_12 * ) V_522 ;
if ( V_8 -> V_576 & V_577 ) {
F_161 ( V_8 ,
& V_8 -> V_147 . V_148 [ V_573 ] , V_578 ) ;
if ( V_8 -> V_576 & V_579 )
F_157 ( V_8 ) ;
}
}
...
if ( ! V_143 || ! F_133 ( V_143 ) )
goto V_582;
if ( F_27 ( & V_143 -> V_478 ) >= V_143 -> V_512 )
goto V_582;
V_32 = F_81 ( V_8 , V_143 ) ;
if ( V_32 == NULL ) {
F_22 ( V_8 ) ;
...
V_14 -> V_26 ? V_14 -> V_26 -> V_410 : ( V_588 ) - 1 ,
V_5 -> V_485 , V_143 -> V_232 ,
V_8 -> V_115 == V_456 ?
V_32 -> V_100 . V_150 : 0xffff ,
V_32 -> V_100 . V_84 . V_457 ,
V_32 -> V_100 . V_84 . V_486 ,
V_32 -> V_100 . V_84 . V_552 ,
( T_1 )
( V_14 -> V_382 -> V_553 / 1000 ) ) ;
goto V_586;
}
if ( V_8 -> V_576 & V_577 ) {
F_161 ( V_8 ,
...
struct V_31 * V_32 ;
T_2 * V_41 , * V_592 ;
int V_264 = V_593 , V_128 = 0 ;
struct V_145 * V_594 ;
int V_595 , V_596 ;
unsigned long V_43 , V_597 ;
F_166 ( V_519 ) ;
V_128 = F_167 ( V_14 ) ;
if ( V_128 != 0 && V_128 != V_593 )
return V_128 ;
F_20 ( & V_8 -> V_64 , V_43 ) ;
if ( V_8 -> V_598 & V_599 ) {
F_21 ( & V_8 -> V_64 , V_43 ) ;
...
L_105
L_106 ,
V_593 , V_14 -> V_26 -> V_447 , V_14 -> V_26 -> V_410 ) ;
return V_593 ;
}
V_84 = & V_32 -> V_100 ;
if ( ! ( V_84 -> V_101 & V_601 ) ) {
...
V_41 = & V_84 -> V_84 ;
V_592 = & V_591 -> V_84 ;
V_592 -> V_111 . V_605 . V_606 = V_607 ;
V_592 -> V_111 . V_605 . V_608 = V_41 -> V_457 ;
if ( V_8 -> V_115 == V_456 )
V_592 -> V_111 . V_605 . V_609 = V_84 -> V_150 ;
else
V_592 -> V_111 . V_605 . V_609 = V_41 -> V_486 ;
V_592 -> V_123 = 1 ;
V_592 -> V_126 = V_41 -> V_126 ;
V_591 -> V_610 = V_84 -> V_610 ;
V_591 -> V_101 |= V_611 ;
if ( V_84 -> V_101 & V_389 )
V_591 -> V_101 |= V_389 ;
if ( F_169 ( V_8 ) )
...
V_591 -> V_5 = V_5 ;
if ( V_8 -> V_115 == V_456 ) {
V_595 = V_615 + V_84 -> V_610 ;
V_594 = & V_8 -> V_147 . V_148 [ V_595 ] ;
F_20 ( & V_594 -> V_616 , V_597 ) ;
V_596 = F_170 ( V_8 , V_594 -> V_617 ,
V_591 , 0 ) ;
F_21 ( & V_594 -> V_616 , V_597 ) ;
} else {
V_596 = F_170 ( V_8 , V_573 ,
V_591 , 0 ) ;
}
F_21 ( & V_8 -> V_64 , V_43 ) ;
if ( V_596 == V_618 ) {
...
L_135
L_136 ,
F_173 ( V_554 ) , V_633 , V_634 ,
V_40 -> V_546 , V_40 -> V_536 , V_142 -> V_150 ,
V_142 -> V_101 ) ;
V_128 = F_177 ( V_8 , V_573 ,
V_142 , V_635 , V_32 -> V_553 ) ;
if ( ( V_128 != V_637 ) ||
( V_635 -> V_84 . V_475 != V_129 ) ) {
if ( V_128 != V_637 ||
V_635 -> V_84 . V_475 != V_484 )
F_39 ( V_5 , V_20 , V_95 ,
L_137
L_138 ,
F_173 ( V_554 ) ,
V_633 , V_634 ,
V_635 -> V_84 . V_475 ,
V_635 -> V_84 . V_111 . V_473 [ 4 ] ,
V_142 -> V_101 ) ;
if ( V_128 == V_637 ) {
if ( V_635 -> V_84 . V_475 == V_484 )
...
static int
F_180 ( struct V_4 * V_5 , T_4 V_633 ,
T_6 V_634 , T_8 V_641 )
{
struct V_12 * V_8 = V_5 -> V_8 ;
unsigned long V_640 ;
int V_642 ;
V_642 = F_181 ( V_5 , V_633 , V_634 , V_641 ) ;
if ( V_642 )
F_182 ( V_5 ,
& V_8 -> V_147 . V_148 [ V_8 -> V_147 . V_643 ] ,
V_633 , V_634 , V_641 ) ;
V_640 = F_147 ( 2 * V_5 -> V_619 * 1000 ) + V_49 ;
...
struct V_1 * V_38 ;
struct V_39 * V_40 ;
unsigned V_633 = V_14 -> V_26 -> V_447 ;
T_6 V_634 = V_14 -> V_26 -> V_410 ;
struct V_647 V_419 ;
int V_128 ;
V_38 = F_1 ( V_14 -> V_26 ) ;
if ( ! V_38 || ! V_38 -> V_40 ) {
...
F_184 ( V_45 , F_185 () ,
sizeof( V_419 ) , ( char * ) & V_419 , V_649 ) ;
V_128 = F_175 ( V_5 , V_38 , V_633 , V_634 ,
V_623 ) ;
F_39 ( V_5 , V_20 , V_95 ,
L_147
L_148 , V_633 , V_634 , V_128 ) ;
if ( V_128 == V_593 )
V_128 = F_180 ( V_5 , V_633 , V_634 ,
V_644 ) ;
return V_128 ;
}
static int
...
struct V_647 V_419 ;
int V_653 ;
int V_264 = V_593 , V_128 , V_47 ;
V_419 . V_405 = V_406 ;
V_419 . V_407 = V_654 ;
V_419 . V_410 = 0 ;
memcpy ( V_419 . V_411 , & V_5 -> V_655 , sizeof( struct V_237 ) ) ;
memcpy ( V_419 . V_412 , & V_5 -> V_656 , sizeof( struct V_237 ) ) ;
F_184 ( V_45 , F_185 () ,
sizeof( V_419 ) , ( char * ) & V_419 , V_649 ) ;
V_128 = F_167 ( V_14 ) ;
if ( V_128 != 0 && V_128 != V_593 )
return V_128 ;
for ( V_47 = 0 ; V_47 < V_657 ; V_47 ++ ) {
V_653 = 0 ;
F_70 ( V_45 -> V_51 ) ;
...
if ( ! V_653 )
continue;
V_128 = F_175 ( V_5 , V_143 -> V_79 -> V_660 ,
V_47 , 0 , V_624 ) ;
if ( V_128 != V_593 ) {
F_39 ( V_5 , V_20 , V_95 ,
L_152 ,
...
return - V_667 ;
if ( V_8 -> V_9 ) {
F_197 ( V_79 -> V_668 , V_666 . V_234 . V_235 ) ;
F_20 ( & V_8 -> V_669 , V_43 ) ;
V_665 = F_198 ( V_8 ,
& V_8 -> V_670 ,
& V_5 -> V_655 ,
...
return - V_671 ;
F_20 ( & V_8 -> V_669 , V_43 ) ;
F_65 ( & V_665 -> V_672 , & V_8 -> V_670 ) ;
}
V_665 -> V_11 = V_79 -> V_660 ;
V_665 -> V_673 = true ;
F_21 ( & V_8 -> V_669 , V_43 ) ;
V_3 -> V_7 = V_665 ;
} else {
...
V_664 = F_200 ( & V_8 -> V_664 ) ;
V_662 = V_8 -> V_674 ;
V_80 = V_5 -> V_675 + 2 ;
if ( ( V_664 * ( V_5 -> V_675 + 2 ) ) < V_662 )
return 0 ;
if ( V_662 >= V_8 -> V_676 - V_677 ) {
F_39 ( V_5 , V_369 , V_95 ,
L_156
L_157 , V_662 ) ;
return 0 ;
...
struct V_10 *
F_199 ( struct V_12 * V_8 , struct V_237 * V_678 ,
struct V_237 * V_666 , T_6 V_410 ,
bool V_679 )
{
struct V_10 * V_680 ;
int V_681 ;
if ( F_86 ( ! V_8 ) || ! V_678 || ! V_666 ||
! ( V_8 -> V_9 ) )
return NULL ;
if ( V_679 )
V_681 = V_682 ;
...
V_681 = V_96 ;
V_680 = F_204 ( V_8 -> V_683 , V_681 ) ;
if ( ! V_680 )
return NULL ;
F_78 ( & V_680 -> V_672 ) ;
V_680 -> V_11 = NULL ;
memcpy ( & V_680 -> V_684 . V_678 , V_678 ,
sizeof( struct V_237 ) ) ;
memcpy ( & V_680 -> V_684 . V_666 , V_666 ,
sizeof( struct V_237 ) ) ;
V_680 -> V_684 . V_410 = V_410 ;
V_680 -> V_387 = false ;
V_680 -> V_390 = V_8 -> V_685 ;
V_680 -> V_673 = false ;
return V_680 ;
}
void
...
{
struct V_10 * V_680 ;
if ( F_86 ( ! V_8 ) || ! V_151 || ! V_678 || ! V_666 ||
! V_8 -> V_9 )
return NULL ;
F_188 (lun_info, list, listentry) {
if ( ( memcmp ( & V_680 -> V_684 . V_678 , V_678 ,
sizeof( struct V_237 ) ) == 0 ) &&
( memcmp ( & V_680 -> V_684 . V_666 , V_666 ,
sizeof( struct V_237 ) ) == 0 ) &&
( V_680 -> V_684 . V_410 == V_410 ) )
return V_680 ;
}
...
bool
F_206 ( struct V_12 * V_8 , struct V_237 * V_678 ,
struct V_237 * V_666 , T_6 * V_686 ,
struct V_237 * V_687 ,
struct V_237 * V_688 ,
T_6 * V_689 ,
T_1 * V_690 )
...
if ( ( ( F_207 ( V_678 -> V_234 . V_235 ) == 0 ) ||
( memcmp ( & V_680 -> V_684 . V_678 , V_678 ,
sizeof( struct V_237 ) ) == 0 ) ) &&
( ( F_207 ( V_666 -> V_234 . V_235 ) == 0 ) ||
( memcmp ( & V_680 -> V_684 . V_666 , V_666 ,
sizeof( struct V_237 ) ) == 0 ) ) &&
( V_680 -> V_387 ) ) {
V_684 = & V_680 -> V_684 ;
...
* V_686 = V_684 -> V_410 ;
memcpy ( V_678 , & V_684 -> V_678 ,
sizeof( struct V_237 ) ) ;
memcpy ( V_666 , & V_684 -> V_666 ,
sizeof( struct V_237 ) ) ;
break;
}
}
...
bool
F_208 ( struct V_12 * V_8 , struct V_237 * V_678 ,
struct V_237 * V_666 , T_6 V_410 , V_189 V_698 )
{
struct V_10 * V_680 ;
unsigned long V_43 ;
if ( F_86 ( ! V_8 ) || ! V_678 || ! V_666 ||
...
return false ;
F_20 ( & V_8 -> V_669 , V_43 ) ;
V_680 = F_198 ( V_8 , & V_8 -> V_670 , V_678 ,
V_666 , V_410 ) ;
if ( V_680 ) {
if ( ! V_680 -> V_387 )
V_680 -> V_387 = true ;
...
V_680 = F_199 ( V_8 , V_678 , V_666 , V_410 ,
false ) ;
if ( V_680 ) {
V_680 -> V_387 = true ;
V_680 -> V_390 = V_698 ;
V_680 -> V_673 = false ;
F_65 ( & V_680 -> V_672 , & V_8 -> V_670 ) ;
F_21 ( & V_8 -> V_669 , V_43 ) ;
return true ;
}
F_21 ( & V_8 -> V_669 , V_43 ) ;
...
bool
F_209 ( struct V_12 * V_8 , struct V_237 * V_678 ,
struct V_237 * V_666 , T_6 V_410 )
{
struct V_10 * V_680 ;
unsigned long V_43 ;
