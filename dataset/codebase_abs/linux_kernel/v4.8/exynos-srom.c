...
static void F_18 ( void T_2 * V_43 ,
struct V_1 * V_4 ,
unsigned int V_44 )
{
for (; V_44 > 0 ; -- V_44 , ++ V_4 )
V_4 -> V_45 = F_19 ( V_43 + V_4 -> V_7 ) ;
}
static void F_20 ( void T_2 * V_43 ,
const struct V_1 * V_4 ,
unsigned int V_44 )
{
for (; V_44 > 0 ; -- V_44 , ++ V_4 )
F_21 ( V_4 -> V_45 , V_43 + V_4 -> V_7 ) ;
}
static int F_22 ( struct V_35 * V_36 )
{
struct V_8 * V_9 = F_23 ( V_36 ) ;
F_18 ( V_9 -> V_22 , V_9 -> V_40 ,
F_7 ( V_41 ) ) ;
return 0 ;
}
