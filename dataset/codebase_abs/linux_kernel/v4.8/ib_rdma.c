...
void * F_94 ( struct V_112 * V_56 , unsigned long V_113 ,
...
if ( V_3 -> V_95 )
V_38 = F_95 ( V_3 , V_18 , V_56 , V_113 , V_116 ) ;
else
V_38 = F_96 ( V_3 , V_56 , V_113 , V_116 ) ;
if ( V_38 )
V_3 = NULL ;
V_92:
if ( ! V_38 )
...
struct V_28 * F_100 ( struct V_1 * V_3 ,
int V_46 )
{
struct V_28 * V_37 ;
V_37 = F_101 ( sizeof( * V_37 ) , V_7 ) ;
if ( ! V_37 )
return F_81 ( - V_8 ) ;
V_37 -> V_46 = V_46 ;
F_102 ( & V_37 -> V_94 ) ;
