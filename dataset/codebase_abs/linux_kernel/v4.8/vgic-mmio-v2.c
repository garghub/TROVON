...
V_36 = V_31 -> V_26 ? F_14 ( V_31 -> V_26 ) : 0 ;
V_31 -> V_37 = F_15 ( V_2 -> V_7 , V_36 ) ;
F_16 ( & V_31 -> V_32 ) ;
F_10 ( V_2 -> V_7 , V_31 ) ;
}
}
...
static void F_20 ( struct V_1 * V_2 , struct V_38 * V_39 )
{
if ( V_40 . type == V_41 )
F_21 ( V_2 , V_39 ) ;
else
...
static void F_23 ( struct V_1 * V_2 , struct V_38 * V_39 )
{
if ( V_40 . type == V_41 )
F_24 ( V_2 , V_39 ) ;
else
...
unsigned int F_28 ( struct V_52 * V_53 )
{
V_53 -> V_54 = V_55 ;
V_53 -> V_56 = F_29 ( V_55 ) ;
F_30 ( & V_53 -> V_53 , & V_57 ) ;
...
int F_31 ( struct V_59 * V_53 , struct V_60 * V_61 )
{
...
return F_32 ( V_2 , & V_53 , V_72 , V_73 , V_19 ) ;
}
int F_36 ( struct V_1 * V_2 , bool V_72 ,
int V_73 , T_2 * V_19 )
{
struct V_52 V_53 = {
. V_54 = V_55 ,
