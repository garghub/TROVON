...
for ( V_23 = 0 ; V_23 < V_29 ; ++ V_23 )
F_72 ( & V_2 -> V_26 [ V_23 ] ) ;
V_2 -> V_71 . V_155 = V_156 ;
V_2 -> V_71 . V_157 = false ;
V_2 -> V_71 . V_158 = false ;
V_2 -> V_71 . V_159 = false ;
V_2 -> V_3 = V_86 ;
V_2 -> V_19 = V_160 ;
}
...
V_2 -> V_91 . V_98 = V_99 ;
V_2 -> V_69 = 0 ;
V_2 -> V_65 = F_74 ( V_161 , V_162 ) ;
if ( ! V_2 -> V_65 ) {
V_66 = - V_163 ;
goto V_164;
}
V_2 -> V_96 = F_74 ( V_89 , V_162 ) ;
if ( ! V_2 -> V_96 ) {
V_66 = - V_163 ;
goto V_165;
}
V_2 -> V_101 = F_74 ( V_89 , V_162 ) ;
if ( ! V_2 -> V_101 ) {
V_66 = - V_163 ;
goto V_166;
}
V_2 -> V_19 . V_24 = V_160 . V_24 ;
V_2 -> V_95 = V_2 -> V_96 ;
V_2 -> V_94 = V_64 ;
F_75 ( & V_2 -> V_30 ) ;
V_2 -> V_76 . V_167 = F_31 ;
...
F_21 ( V_111 , & V_2 -> V_6 ) ;
F_21 ( V_103 , & V_2 -> V_6 ) ;
V_2 -> V_7 = F_77 ( V_2 -> V_3 -> V_171 , V_172 ) ;
if ( ! V_2 -> V_7 ) {
F_29 ( V_2 -> V_3 , L_29 ,
V_4 ) ;
V_66 = - V_163 ;
...
F_78 ( & V_2 -> V_47 ) ;
F_79 ( & V_2 -> V_36 ) ;
V_2 -> V_36 . V_174 = ( unsigned long ) V_2 ;
V_2 -> V_36 . V_175 = F_1 ;
F_79 ( & V_2 -> V_176 ) ;
V_2 -> V_176 . V_174 = ( unsigned long ) V_2 ;
V_2 -> V_176 . V_175 = F_50 ;
F_79 ( & V_2 -> V_74 ) ;
V_2 -> V_74 . V_174 = ( unsigned long ) V_2 ;
V_2 -> V_74 . V_175 = F_65 ;
V_66 = V_2 -> V_42 -> V_177 ( V_2 -> V_42 ) ;
if ( V_66 ) {
F_29 ( V_2 -> V_3 ,
L_30 ,
V_4 , V_66 ) ;
...
static void F_87 ( struct V_184 * V_174 [] , struct V_2 * V_2 )
{
int V_23 ;
if ( ! V_174 ) {
F_88 ( L_32 ) ;
...
V_23 = V_185 ;
if ( V_174 [ V_23 ] ) {
T_4 V_38 = F_89 ( V_174 [ V_23 ] ) ;
V_2 -> V_19 . V_38 = V_38 * V_46 / 1000 ;
if ( V_2 -> V_19 . V_38 == 0 )
V_2 -> V_19 . V_38 = 1 ;
else if ( V_2 -> V_19 . V_38 > V_186 )
V_2 -> V_19 . V_38 = V_186 ;
}
V_23 = V_187 ;
if ( V_174 [ V_23 ] )
V_2 -> V_19 . V_24 = F_89 ( V_174 [ V_23 ] ) ;
V_23 = V_188 ;
if ( V_174 [ V_23 ] )
V_2 -> V_19 . V_20 = F_89 ( V_174 [ V_23 ] ) ;
V_23 = V_189 ;
if ( V_174 [ V_23 ] )
V_2 -> V_19 . V_21 = F_89 ( V_174 [ V_23 ] ) ;
V_23 = V_190 ;
if ( V_174 [ V_23 ] )
V_2 -> V_19 . V_139 = F_89 ( V_174 [ V_23 ] ) ;
V_23 = V_191 ;
if ( V_174 [ V_23 ] )
V_2 -> V_19 . V_70 = F_89 ( V_174 [ V_23 ] ) ;
}
static int F_90 ( struct V_124 * V_86 , struct V_184 * V_192 [] ,
struct V_184 * V_174 [] )
{
F_87 ( V_174 , F_67 ( V_86 ) ) ;
F_91 ( V_86 ) ;
return 0 ;
}
...
static int F_96 ( struct V_198 * V_199 , struct V_124 * V_86 ,
struct V_184 * V_192 [] , struct V_184 * V_174 [] )
{
struct V_2 * V_2 = NULL ;
...
V_2 = F_104 ( V_206 , struct V_2 , V_183 ) ;
F_105 ( V_2 -> V_3 ) ;
}
F_61 () ;
}
