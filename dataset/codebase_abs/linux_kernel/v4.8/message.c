...
struct V_244 * V_20 = NULL ;
unsigned int V_245 ;
int V_246 = 0 ;
memset ( V_233 , 0x00 , sizeof( struct V_232 ) ) ;
V_233 -> V_247 = false ;
while ( V_235 > 0 ) {
V_245 = V_234 [ 0 ] ;
if ( ! V_245 ) {
...
switch ( V_234 [ 2 ] ) {
case V_250 :
if ( V_245 < sizeof( struct V_236 ) )
goto V_248;
if ( V_237 ) {
F_29 ( & V_131 -> V_16 , L_34 ) ;
goto V_248;
}
V_237 = (struct V_236 * ) V_234 ;
break;
case V_251 :
if ( V_245 < sizeof( struct V_252 ) )
goto V_248;
V_233 -> V_252 =
(struct V_252 * ) V_234 ;
break;
case V_253 :
if ( V_245 != sizeof( struct V_238 ) )
goto V_248;
if ( V_239 )
return - V_45 ;
V_239 = (struct V_238 * ) V_234 ;
break;
case V_254 :
if ( V_245 < sizeof( struct V_255 ) )
goto V_248;
V_233 -> V_255 =
(struct V_255 * ) V_234 ;
break;
case V_256 :
if ( V_245 != sizeof( struct V_240 ) )
goto V_248;
if ( V_241 )
return - V_45 ;
V_241 = (struct V_240 * ) V_234 ;
break;
case V_257 :
if ( V_245 < sizeof( struct V_258 ) )
goto V_248;
V_233 -> V_258 =
(struct V_258 * ) V_234 ;
break;
case V_259 :
if ( V_245 < sizeof( struct V_260 ) )
goto V_248;
V_233 -> V_260 =
(struct V_260 * ) V_234 ;
break;
case V_261 :
if ( V_245 < sizeof( struct V_244 * ) )
goto V_248;
if ( V_20 )
return - V_45 ;
V_20 = (struct V_244 * ) V_234 ;
break;
case V_262 :
if ( V_245 < sizeof( struct V_242 * ) )
goto V_248;
if ( V_243 )
return - V_45 ;
V_243 = (struct V_242 * ) V_234 ;
break;
case V_263 :
if ( V_245 < sizeof( struct V_264 ) )
goto V_248;
V_233 -> V_264 = (struct V_264 * ) V_234 ;
break;
case V_265 :
if ( V_245 < sizeof( struct V_266 ) )
goto V_248;
V_233 -> V_266 = (struct V_266 * ) V_234 ;
break;
case V_267 :
if ( V_245 < sizeof( struct V_268 ) )
break;
V_233 -> V_268 =
(struct V_268 * ) V_234 ;
break;
