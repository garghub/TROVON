...
V_79 -> V_85 ? L_20 : L_21 ) ;
if ( V_79 -> V_85 &&
! F_27 ( V_86 , & V_10 -> V_18 -> V_87 ) )
F_28 ( V_10 , 0 , 0 ) ;
F_28 ( V_10 , ! ! V_79 -> V_85 , 0 ) ;
break;
case V_88 :
...
int F_31 ( struct V_9 * V_10 , struct V_14 * V_15 )
{
int V_39 ;
struct V_11 * V_12 = ( void * ) & V_10 -> V_13 ;
F_32 ( ( sizeof( ( (struct V_9 * ) 0 ) -> V_13 )
< sizeof( struct V_11 ) ) ) ;
V_39 = F_8 ( V_10 , V_15 ) ;
if ( V_39 < 0 )
return V_39 ;
V_39 = F_33 ( V_10 , V_12 -> V_54 -> V_89 ) ;
if ( V_39 < 0 ) {
F_16 ( V_12 -> V_13 , NULL ) ;
...
static int F_34 ( struct V_9 * V_10 , struct V_14 * V_15 )
{
int V_39 = F_31 ( V_10 , V_15 ) ;
if ( ! V_39 && ( V_10 -> V_18 -> V_90 [ 0 ] & 0x02 ) )
F_35 ( V_10 -> V_18 ) ;
return V_39 ;
}
static int F_36 ( struct V_9 * V_10 , struct V_91 * V_92 )
{
if ( V_92 -> V_36 < V_93 || ! ( V_92 -> V_13 [ 0 ] & 0x02 ) )
return 1 ;
F_37 ( V_92 ) ;
F_38 ( F_39 ( V_92 ) -> V_94 , V_10 -> V_18 -> V_90 ) ;
return 1 ;
}
