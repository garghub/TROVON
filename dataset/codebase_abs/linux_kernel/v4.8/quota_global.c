...
static int F_114 ( struct V_36 * V_37 , struct V_163 * V_164 )
{
int type = V_164 -> type ;
struct V_31 * V_65 = F_11 ( V_37 , type ) -> V_34 ;
int V_81 = 0 ;
F_115 ( F_8 ( & V_27 , * V_164 ) , type ) ;
if ( ! F_116 ( V_37 , type ) ) {
V_81 = - V_165 ;
goto V_74;
}
...
if ( V_81 < 0 )
goto V_166;
V_81 = F_117 ( & V_65 -> V_35 , V_164 ) ;
F_63 ( V_65 , 0 ) ;
V_166:
F_53 ( V_65 , 0 ) ;
V_74:
if ( V_81 && V_81 != - V_167 && V_81 != - V_165 )
F_24 ( V_81 ) ;
return V_81 ;
}
static int F_118 ( struct V_1 * V_1 )
{
unsigned long V_168 = ( 1 << ( V_8 + V_9 ) ) |
( 1 << ( V_8 + V_15 ) ) |
( 1 << ( V_8 + V_13 ) ) |
( 1 << ( V_8 + V_18 ) ) |
( 1 << ( V_8 + V_20 ) ) |
...
static int F_120 ( struct V_36 * V_37 , int type )
{
T_6 * V_68 ;
int V_81 = 0 ;
struct V_31 * V_32 = F_11 ( V_37 , type ) -> V_34 ;
...
static struct V_1 * F_122 ( struct V_36 * V_37 , int type )
{
struct V_149 * V_1 =
F_123 ( V_171 , V_172 ) ;
if ( ! V_1 )
