...
V_4 . V_12 [ 0 ] = V_308 ;
V_4 . V_12 [ 1 ] = V_306 -> V_309 ;
V_4 . V_12 [ 2 ] = 0x40 ;
V_4 . V_12 [ 3 ] = V_307 ? 2 : 1 ;
V_4 . V_12 [ 8 ] = 16 ;
if ( ( V_21 = V_20 -> V_17 ( V_2 , & V_4 ) ) )
return V_21 ;
V_306 -> V_310 = V_4 . V_27 [ 1 ] ;
V_306 -> V_311 = V_4 . V_27 [ 5 ] & 0xf ;
V_306 -> V_312 = V_4 . V_27 [ 6 ] ;
V_306 -> V_313 = V_4 . V_27 [ 7 ] ;
if ( V_306 -> V_309 == V_218 ) {
V_306 -> V_314 . V_219 = ( ( V_4 . V_27 [ 8 ] << 24 ) |
( V_4 . V_27 [ 9 ] << 16 ) |
( V_4 . V_27 [ 10 ] << 8 ) |
( V_4 . V_27 [ 11 ] ) ) ;
V_306 -> V_315 . V_219 = ( ( V_4 . V_27 [ 12 ] << 24 ) |
( V_4 . V_27 [ 13 ] << 16 ) |
( V_4 . V_27 [ 14 ] << 8 ) |
( V_4 . V_27 [ 15 ] ) ) ;
} else {
V_306 -> V_315 . V_220 . V_223 = V_4 . V_27 [ 13 ] ;
V_306 -> V_315 . V_220 . V_222 = V_4 . V_27 [ 14 ] ;
V_306 -> V_315 . V_220 . V_221 = V_4 . V_27 [ 15 ] ;
V_306 -> V_314 . V_220 . V_223 = V_4 . V_27 [ 9 ] ;
V_306 -> V_314 . V_220 . V_222 = V_4 . V_27 [ 10 ] ;
V_306 -> V_314 . V_220 . V_221 = V_4 . V_27 [ 11 ] ;
}
return 0 ;
}
...
F_82 ( V_333 ) ;
V_21 = F_83 ( V_331 , V_333 , NULL , V_325 , V_224 , V_199 ) ;
if ( V_21 ) {
F_84 ( V_333 ) ;
break;
}
...
V_333 -> V_14 = 60 * V_15 ;
V_334 = V_333 -> V_334 ;
if ( F_85 ( V_331 , V_2 -> V_97 , V_333 , 0 ) ) {
...
static int F_87 ( struct V_1 * V_2 , T_9 T_10 * V_325 ,
int V_219 , int V_326 )
{
int V_21 ;
if ( V_2 -> V_98 == V_100 )
...
return - V_346 ;
if ( F_89 ( & V_343 , V_341 , sizeof( V_343 ) ) )
return - V_329 ;
V_344 = V_343 . V_347 ;
...
return - V_205 ;
V_2 -> V_180 = V_348 ? 1 : 0 ;
if ( V_2 -> V_173 != 1 && ! V_348 && ! F_99 ( V_350 ) )
return - V_207 ;
...
T_11 V_217 , V_359 ;
int V_21 ;
if ( F_89 ( & V_331 , V_341 , sizeof( V_331 ) ) )
return - V_329 ;
V_217 = V_331 . V_309 ;
...
return V_21 ;
V_359 = V_331 . V_309 ;
F_60 ( & V_331 . V_314 , & V_359 , V_217 ) ;
F_60 ( & V_331 . V_315 , & V_331 . V_309 , V_217 ) ;
...
struct V_141 V_142 ;
int V_21 ;
if ( F_89 ( & V_142 , V_341 , sizeof( V_142 ) ) )
return - V_329 ;
V_21 = V_2 -> V_16 -> V_150 ( V_2 , V_151 , & V_142 ) ;
if ( V_21 )
return V_21 ;
...
T_11 V_344 ;
int V_21 ;
if ( F_89 ( & V_144 , V_341 , sizeof( V_144 ) ) )
return - V_329 ;
V_344 = V_144 . V_155 ;
if ( V_344 != V_156 && V_344 != V_218 )
return - V_62 ;
...
if ( ! F_21 ( V_363 ) )
return - V_346 ;
if ( F_89 ( & V_220 , V_341 , sizeof( V_220 ) ) )
return - V_329 ;
...
if ( ! F_21 ( V_363 ) )
return - V_346 ;
if ( F_89 ( & V_366 , V_341 , sizeof( V_366 ) ) )
return - V_329 ;
...
if ( ! F_21 ( V_363 ) )
return - V_346 ;
if ( F_89 ( & V_369 , V_341 , sizeof( V_369 ) ) )
return - V_329 ;
...
static int F_116 ( struct V_1 * V_2 , int V_51 )
{
struct V_19 * V_20 = V_2 -> V_16 ;
struct V_3 V_4 ;
struct V_372 V_373 ;
...
int F_118 ( struct V_1 * V_2 , long * V_380 )
{
struct V_143 V_381 ;
T_1 V_18 ;
T_13 V_366 ;
...
+ sizeof( V_366 . V_391 ) ) ) {
* V_380 = F_119 ( V_366 . V_391 ) ;
} else {
* V_380 = F_119 ( V_366 . V_387 ) +
F_119 ( V_366 . V_389 ) ;
if ( V_366 . V_392 )
* V_380 -= ( F_119 ( V_366 . V_392 ) + 7 ) ;
}
return 0 ;
V_384:
V_381 . V_155 = V_156 ;
...
+ sizeof( V_366 . V_394 ) ) {
* V_394 = F_119 ( V_366 . V_394 ) ;
return 0 ;
}
V_395:
V_21 = F_118 ( V_2 , V_394 ) ;
if ( V_21 ) {
* V_394 = 0 ;
return V_21 ;
} else {
...
static T_15 int F_121 ( struct V_1 * V_2 ,
void T_10 * V_348 ,
struct V_3 * V_4 ,
int V_12 )
{
...
if ( F_89 ( & V_220 , (struct V_362 T_10 * ) V_348 , sizeof( V_220 ) ) )
return - V_329 ;
V_219 = F_122 ( V_220 . V_401 , V_220 . V_402 , V_220 . V_403 ) ;
if ( V_219 < 0 )
return - V_62 ;
V_4 -> V_27 = F_123 ( V_316 , V_199 ) ;
if ( V_4 -> V_27 == NULL )
return - V_200 ;
...
struct V_404 V_405 ;
int V_219 ;
if ( F_89 ( & V_405 , (struct V_404 T_10 * ) V_348 ,
sizeof( V_405 ) ) )
return - V_329 ;
if ( V_405 . V_347 == V_156 )
V_219 = F_122 ( V_405 . V_216 . V_220 . V_223 ,
...
return - V_62 ;
return F_87 ( V_2 , V_405 . V_183 , V_219 , V_405 . V_326 ) ;
}
...
struct V_305 V_331 ;
T_5 V_217 , V_359 ;
if ( F_89 ( & V_331 , (struct V_305 T_10 * ) V_348 , sizeof( V_331 ) ) )
return - V_329 ;
V_217 = V_331 . V_309 ;
if ( ! ( ( V_217 == V_156 ) ||
( V_217 == V_218 ) ) )
...
struct V_411 V_412 ;
F_18 ( V_345 , L_102 ) ;
if ( F_89 ( & V_412 , (struct V_411 T_10 * ) V_348 , sizeof( V_412 ) ) )
return - V_329 ;
V_4 -> V_12 [ 0 ] = V_413 ;
...
int V_21 ;
F_18 ( V_345 , L_103 ) ;
if ( F_89 ( & V_415 , (struct V_368 T_10 * ) V_348 ,
sizeof( V_415 ) ) )
return - V_329 ;
V_4 -> V_27 = V_27 ;
V_4 -> V_22 = 24 ;
...
return - V_346 ;
F_18 ( V_345 , L_107 ) ;
if ( F_89 ( & V_230 , ( T_6 T_10 * ) V_348 , sizeof( V_230 ) ) )
return - V_329 ;
V_21 = F_63 ( V_2 , & V_230 ) ;
if ( V_21 )
return V_21 ;
...
static T_15 int F_135 ( struct V_1 * V_2 ,
void T_10 * V_348 )
{
int V_21 ;
long V_427 = 0 ;
F_18 ( V_345 , L_109 ) ;
V_21 = F_118 ( V_2 , & V_427 ) ;
if ( V_21 )
return V_21 ;
...
static int F_136 ( struct V_1 * V_2 , unsigned int V_12 ,
unsigned long V_348 )
{
struct V_3 V_4 ;
...
case V_398 :
case V_400 :
return F_121 ( V_2 , V_428 , & V_4 , V_12 ) ;
case V_429 :
return F_124 ( V_2 , V_428 ) ;
case V_360 :
return F_125 ( V_2 , V_428 ) ;
case V_364 :
return F_126 ( V_2 , V_428 , & V_4 ) ;
case V_430 :
return F_127 ( V_2 , V_428 , & V_4 ) ;
case V_370 :
case V_371 :
return F_128 ( V_2 , V_428 , & V_4 , V_12 ) ;
case V_423 :
case V_431 :
return F_129 ( V_2 , & V_4 , V_12 ) ;
case V_432 :
case V_425 :
return F_130 ( V_2 , & V_4 , V_12 ) ;
case V_433 :
return F_131 ( V_2 , V_428 , & V_4 ) ;
case V_434 :
return F_133 ( V_2 , V_428 ) ;
case V_435 :
return F_134 ( V_2 , V_428 ) ;
case V_436 :
return F_135 ( V_2 , V_428 ) ;
}
return - V_267 ;
}
int F_137 ( struct V_1 * V_2 , struct V_170 * V_171 ,
T_4 V_172 , unsigned int V_12 , unsigned long V_348 )
{
void T_10 * V_341 = ( void T_10 * ) V_348 ;
int V_21 ;
V_21 = F_138 ( V_171 , V_172 , V_12 , V_341 ) ;
if ( V_21 != - V_267 )
return V_21 ;
switch ( V_12 ) {
case V_437 :
...
case V_444 :
return F_96 ( V_2 , V_348 ) ;
case V_445 :
return F_97 ( V_2 , V_348 ) ;
case V_446 :
return F_98 ( V_2 , V_171 ) ;
case V_447 :
return F_101 ( V_2 , V_348 ) ;
case V_448 :
return F_102 ( V_2 , V_348 ) ;
case V_449 :
return F_103 ( V_2 ) ;
case V_450 :
return F_104 ( V_2 , V_341 ) ;
case V_451 :
...
case V_370 :
return F_113 ( V_2 , V_341 ) ;
case V_371 :
return F_114 ( V_2 , V_341 ) ;
case V_423 :
case V_431 :
case V_432 :
case V_425 :
...
static int F_139 ( const char * V_142 , int V_454 , char * V_197 ,
int * V_455 , enum V_456 V_457 )
{
const int V_458 = sizeof( V_459 . V_197 ) ;
struct V_1 * V_2 ;
int V_21 ;
V_21 = F_140 ( V_197 + * V_455 , V_458 - * V_455 , V_142 ) ;
if ( ! V_21 )
return 1 ;
* V_455 += V_21 ;
F_141 (cdi, &cdrom_list, list) {
switch ( V_457 ) {
case V_460 :
V_21 = F_140 ( V_197 + * V_455 , V_458 - * V_455 ,
L_110 , V_2 -> V_54 ) ;
break;
case V_461 :
V_21 = F_140 ( V_197 + * V_455 , V_458 - * V_455 ,
...
if ( F_139 ( L_114 , 0 , V_197 , & V_455 , V_460 ) )
goto V_470;
if ( F_139 ( L_115 , 0 , V_197 , & V_455 , V_461 ) )
goto V_470;
if ( F_139 ( L_116 , 0 , V_197 , & V_455 , V_463 ) )
goto V_470;
if ( F_139 ( L_117 ,
...
goto V_470;
if ( ! F_140 ( V_197 + V_455 , V_458 - V_455 , L_134 ) )
goto V_470;
V_471:
F_24 ( & V_102 ) ;
return F_143 ( V_466 , V_31 , V_27 , V_467 , V_468 ) ;
V_470:
F_10 ( L_135 ) ;
goto V_471;
}
...
static int F_145 ( struct V_465 * V_466 , int V_31 ,
void T_10 * V_27 , T_16 * V_467 , T_17 * V_468 )
{
int V_21 ;
V_21 = F_146 ( V_466 , V_31 , V_27 , V_467 , V_468 ) ;
if ( V_31 ) {
V_88 = ! ! V_459 . V_88 ;
V_90 = ! ! V_459 . V_90 ;
V_352 = ! ! V_459 . V_352 ;
...
static int T_18 F_150 ( void )
{
F_19 () ;
return 0 ;
}
static void T_19 F_151 ( void )
{
F_10 ( L_136 ) ;
F_148 () ;
}
