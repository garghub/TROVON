...
V_278 = F_214 ( V_276 ) ;
V_277 = ( void * ) V_278 ;
V_278 += sizeof( struct V_275 ) * V_177 ;
F_22 (i) {
...
V_289:
#endif
V_285 = ( unsigned long ) F_216 ( V_290 ) ;
V_285 = F_217 ( V_285 ) ;
}
F_218 ( V_33 , V_285 ) ;
F_14 ( V_23 , L_102 ,
F_219 ( V_33 ) + ( V_285 & ~ V_291 ) ,
V_285 ) ;
V_33 ++ ;
V_287 -> V_292 = V_285 ;
...
int F_225 ( int V_266 , T_1 V_298 , T_1 V_11 ,
struct V_250 * V_211 )
{
bool V_299 = ! ! V_125 ;
struct V_6 * V_9 ;
...
F_218 ( V_286 + V_33 , V_298 ) ;
if ( F_223 ( V_33 ) ) {
F_226 ( V_286 + V_33 ) ;
return - V_305 ;
}
V_2 [ V_33 ] . V_3 . V_4 = F_198 ( V_33 , V_266 ) ;
V_2 [ V_33 ] . V_3 . V_306 = F_203 ( V_33 ) ;
V_167 = F_194 ( V_33 ) ;
V_10 = V_11 + V_167 - 1 ;
F_22 (ioapic) {
V_9 = F_3 ( V_8 ) ;
...
{
memset ( V_52 , 0 , sizeof( * V_52 ) ) ;
V_52 -> V_78 = V_40 -> V_307 ;
V_52 -> V_150 = V_40 -> V_308 ;
...
int F_233 ( struct V_14 * V_121 , unsigned int V_309 ,
unsigned int V_310 , void * V_236 )
{
int V_218 , V_8 , V_12 ;
struct V_210 * V_211 ;
struct V_72 * V_72 ;
...
if ( ! V_102 || V_310 > 1 )
return - V_300 ;
V_72 = F_97 ( V_121 , V_309 ) ;
if ( ! V_72 )
return - V_300 ;
V_8 = F_234 ( V_121 ) ;
V_12 = V_102 -> V_113 ;
if ( F_100 ( V_121 , ( V_311 ) V_12 ) > 0 )
return - V_301 ;
V_46 = F_17 ( sizeof( * V_46 ) , V_38 ) ;
if ( ! V_46 )
return - V_62 ;
V_102 -> V_312 = & V_46 -> V_52 ;
V_218 = F_235 ( V_121 , V_309 , V_310 , V_102 ) ;
if ( V_218 < 0 ) {
F_20 ( V_46 ) ;
return V_218 ;
}
F_236 ( & V_46 -> V_64 ) ;
V_72 -> V_313 = V_102 -> V_113 ;
...
F_176 ( V_53 ) ;
if ( V_102 -> V_312 )
F_232 ( V_211 , V_46 , V_102 -> V_312 ) ;
F_86 ( V_309 , V_46 -> V_76 ) ;
if ( V_309 < F_7 () )
V_206 -> V_56 ( V_309 ) ;
F_142 ( V_53 ) ;
F_14 ( V_23 , V_87
...
V_309 , V_46 -> V_76 , V_46 -> V_103 , V_211 -> V_221 ) ;
return 0 ;
}
void F_237 ( struct V_14 * V_121 , unsigned int V_309 ,
unsigned int V_310 )
{
struct V_72 * V_72 ;
struct V_58 * V_46 ;
