...
int F_24 ( T_2 V_15 , struct V_16 * V_20 , const struct V_5 * V_46 )
{
struct V_1 * V_2 ;
struct V_47 V_48 ;
struct V_76 * V_77 ;
...
F_28 ( & F_29 ( V_20 ) -> V_82 ) ;
F_30 (rd, &HFS_I(dir)->open_dir_list, list) {
if ( V_48 . V_83 -> V_84 ( V_48 . V_58 , ( void * ) & V_77 -> V_3 ) < 0 )
V_77 -> V_29 -> V_85 -- ;
}
F_31 ( & F_29 ( V_20 ) -> V_82 ) ;
V_73 = F_17 ( & V_48 ) ;
...
int F_32 ( T_2 V_15 , struct V_16 * V_86 , const struct V_5 * V_87 ,
struct V_16 * V_88 , const struct V_5 * V_89 )
{
struct V_1 * V_2 ;
...
int V_51 ;
F_11 ( V_52 , L_5 ,
V_15 , V_86 -> V_61 , V_87 -> V_6 ,
V_88 -> V_61 , V_89 -> V_6 ) ;
V_2 = V_86 -> V_38 ;
V_51 = F_12 ( F_8 ( V_2 ) -> V_57 , & V_90 ) ;
if ( V_51 )
return V_51 ;
V_91 = V_90 ;
F_1 ( V_2 , V_90 . V_58 , V_86 -> V_61 , V_87 ) ;
V_51 = F_13 ( & V_90 ) ;
if ( V_51 )
goto V_78;
if ( V_90 . V_92 > sizeof( V_49 ) || V_90 . V_92 < 0 ) {
V_51 = - V_74 ;
goto V_78;
}
F_26 ( V_90 . V_79 , & V_49 , V_90 . V_80 ,
V_90 . V_92 ) ;
F_1 ( V_2 , V_91 . V_58 , V_88 -> V_61 , V_89 ) ;
V_51 = F_13 ( & V_91 ) ;
if ( V_51 != - V_62 ) {
if ( ! V_51 )
V_51 = - V_63 ;
