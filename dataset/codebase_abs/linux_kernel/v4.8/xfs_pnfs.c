...
if ( F_21 ( error ) )
return error ;
V_31 = F_22 ( V_15 , ( V_45 ) V_13 + V_23 ) ;
V_30 = F_23 ( V_15 , V_13 ) ;
V_36 = F_24 ( V_5 ) ;
error = F_25 ( V_5 , V_30 , V_31 - V_30 ,
& V_29 , & V_35 , V_33 ) ;
F_5 ( V_5 , V_36 ) ;
if ( error )
goto V_43;
...
int error = 0 ;
F_8 ( V_5 , V_51 ) ;
error = F_25 ( V_5 , F_23 ( V_5 -> V_27 , V_55 - 1 ) , 1 ,
& V_29 , & V_35 , 0 ) ;
F_5 ( V_5 , V_51 ) ;
if ( error )
return error ;
...
error = F_33 ( V_15 , & F_34 ( V_15 ) -> V_76 , 0 , 0 , 0 , & V_62 ) ;
if ( error )
goto V_75;
F_8 ( V_5 , V_77 ) ;
F_35 ( V_62 , V_5 , V_77 ) ;
