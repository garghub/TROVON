...
unsigned int V_56 [] , struct V_57 * V_58 [] )
{
...
static int F_103 ( struct V_106 * V_106 )
{
struct V_5 * V_6 = F_59 ( V_106 ) ;
...
static unsigned int F_105 ( struct V_106 * V_106 , T_3 * V_183 )
{
struct V_49 * V_50 = F_63 ( V_106 -> V_181 ) ;
return F_106 ( & V_50 -> V_88 , V_106 , V_183 ) ;
}
static int F_107 ( struct V_106 * V_106 , struct V_184 * V_185 )
{
struct V_49 * V_50 = F_63 ( V_106 -> V_181 ) ;
return F_108 ( & V_50 -> V_88 , V_185 ) ;
}
int F_109 ( struct V_5 * V_6 , const char * V_113 )
{
const char * V_186 ;
int V_43 ;
switch ( V_6 -> type ) {
...
V_43 = F_110 ( & V_6 -> V_6 . V_29 , 1 , & V_6 -> V_26 ) ;
if ( V_43 < 0 )
return V_43 ;
F_111 ( & V_6 -> V_76 ) ;
F_112 ( & V_6 -> V_47 ) ;
...
int F_117 ( struct V_5 * V_6 , struct V_199 * V_200 )
{
int V_43 ;
V_6 -> V_6 . V_201 = V_200 ;
V_43 = F_118 ( & V_6 -> V_6 , V_194 , - 1 ) ;
if ( V_43 < 0 )
F_119 ( V_6 -> V_70 -> V_71 ,
L_7 , V_43 ) ;
return V_43 ;
