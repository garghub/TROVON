...
static int F_93 ( const struct V_2 * V_3 ,
unsigned int * V_218 )
{
struct V_224 V_225 = { 0 , V_226 } ;
int V_227 ;
V_227 = F_94 ( V_3 -> V_4 , & V_225 , 1 ) ;
if ( V_227 )
return V_227 ;
* V_218 = V_225 . V_228 ;
return 0 ;
...
int V_28 ;
V_8 = V_3 -> V_10 ;
F_72 ( sizeof( struct V_229 ) > V_77 ) ;
for ( V_28 = 0 ; V_28 < V_3 -> V_11 ; ++ V_28 , ++ V_8 ) {
V_8 -> V_63 = ( void * ) F_106 ( V_230 ,
F_92 ( V_77 ) ) ;
V_8 -> V_76 = 0 ;
...
static T_2 F_107 ( struct V_2 * V_3 )
{
struct V_231 V_7 ;
struct V_232 * V_233 ;
struct V_1 * V_4 ;
...
F_108 ( V_4 , L_31 ,
V_233 -> V_123 , V_233 -> V_125 ) ;
F_104 ( V_3 -> V_4 , V_85 , V_235 , V_234 ) ;
exit:
return V_236 ;
}
static int F_109 ( struct V_250 * V_251 , const struct V_252 * V_33 )
{
struct V_2 * V_3 ;
struct V_2 V_253 ;
...
if ( F_110 ( V_251 ) )
return error ;
if ( F_111 ( V_251 , F_112 ( 64 ) ) == 0 &&
F_113 ( V_251 , F_112 ( 64 ) ) == 0 ) {
F_71 ( V_191 L_32 ) ;
} else if ( F_111 ( V_251 , F_112 ( 32 ) ) == 0 &&
F_113 ( V_251 , F_112 ( 32 ) ) == 0 ) {
F_71 ( V_191 L_33 ) ;
} else {
F_71 ( V_74 L_34 ) ;
goto V_256;
...
if ( ( F_115 ( V_251 , V_28 ) & V_259 ) )
continue;
if ( F_116 ( V_251 , V_28 ) < V_260 )
continue;
break;
}
if ( V_28 == V_258 ) {
...
V_3 -> V_18 = F_117 ( V_251 , V_28 , V_260 ) ;
if ( ! V_3 -> V_18 ) {
F_71 ( V_74
L_38 ,
V_28 , V_260 ) ;
...
V_90 ;
V_197 . V_198 =
F_46 ( V_197 . V_264 , V_265 ) ;
V_188 = F_119 ( & V_197 , sizeof( struct V_2 ) ) ;
if ( ! V_188 ) {
F_71 ( V_74 L_41 ) ;
goto V_261;
}
...
if ( ! V_271 &&
F_93 ( V_3 , & V_3 -> V_218 ) == 0 ) {
F_71 ( V_191 L_45 ) ;
V_3 -> V_222 = 1 ;
} else if ( ! V_272 && F_124 ( V_251 ) == 0 ) {
F_71 ( V_191 L_46 ) ;
V_3 -> V_221 = 1 ;
...
F_71 ( V_159 L_48 ,
V_3 -> V_49 ? L_28 : L_29 ) ;
error = F_125 ( V_3 -> V_218 , F_87 , V_66 ,
L_35 , V_3 ) ;
if ( error ) {
F_71 ( V_74
L_49 , error ) ;
...
error = F_126 ( V_188 , & V_251 -> V_4 ) ;
if ( error ) {
F_71 ( V_74
L_50 , error ) ;
goto V_270;
}
F_127 ( & V_251 -> V_4 , L_51 ,
...
static void F_131 ( struct V_250 * V_4 )
{
struct V_187 * V_188 = F_132 ( V_4 ) ;
struct V_2 * V_3 = F_61 ( V_188 ) ;
F_130 ( V_3 ) ;
}
static void F_133 ( struct V_250 * V_251 )
{
struct V_187 * V_188 = F_132 ( V_251 ) ;
struct V_2 * V_3 = F_61 ( V_188 ) ;
F_134 ( V_188 ) ;
F_130 ( V_3 ) ;
F_99 ( V_3 ) ;
