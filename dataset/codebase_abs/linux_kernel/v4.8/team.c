...
if ( V_18 ) {
struct V_338 V_339 ;
V_34 = F_303 ( V_5 -> V_3 , & V_339 ) ;
if ( ! V_34 ) {
V_5 -> V_23 . V_329 = V_339 . V_340 . V_329 ;
V_5 -> V_23 . V_331 = V_339 . V_340 . V_331 ;
goto V_341;
}
}
V_5 -> V_23 . V_329 = 0 ;
...
static int F_306 ( struct V_343 * V_344 ,
unsigned long V_345 , void * V_282 )
{
