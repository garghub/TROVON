...
int F_21 ( struct V_114 * V_115 )
{
int V_116 , V_117 , V_72 = 0 ;
T_1 T_4 , T_5 , V_113 = 0 ;
struct V_5 * V_6 = NULL ;
if ( ! F_22 ( & V_115 -> V_118 -> V_119 . V_120 ) ) {
F_23 ( V_115 ) ;
return 0 ;
}
F_24 ( V_115 , & V_116 , & V_117 ) ;
T_4 = V_115 -> V_121 -> V_122 . V_123 . V_124 [ V_116 ] ;
T_5 = V_115 -> V_121 -> V_122 . V_123 . V_124 [ V_117 ] ;
V_115 -> V_125 . V_126 ++ ;
F_25 ( V_115 , 3 , L_3 , T_4 , T_5 ) ;
F_26 ( V_115 , T_4 , T_5 ) ;
if ( V_116 == V_117 || V_116 & 1 || V_117 & 1 || T_5 & ~ V_127 )
return F_27 ( V_115 , V_128 ) ;
if ( T_4 & 0xffff ) {
V_113 = 3 ;
goto V_84;
}
...
F_32 ( ( unsigned long ) V_6 ) ;
V_115 -> V_121 -> V_122 . V_123 . V_124 [ V_117 + 1 ] = V_113 ? 4 : 0 ;
F_33 ( V_115 , V_113 ) ;
return V_72 ;
}
