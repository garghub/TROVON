...
{
return F_100 ( V_239 , F_97 , F_101 ( V_238 ) ) ;
}
static T_11 * F_102 ( T_1 * V_6 )
{
return V_240 ;
}
static const struct V_241 * F_103 ( T_1 * V_6 )
{
return NULL ;
}
static unsigned int F_104 ( T_6 * V_242 )
{
const struct V_243 * V_244 = V_245 ;
while ( V_244 -> V_246 ) {
if ( strcmp ( V_244 -> V_246 , ( char * ) & V_242 [ V_247 ] ) == 0 &&
( V_244 -> V_248 == NULL ||
strstr ( ( char * ) & V_242 [ V_249 ] , V_244 -> V_248 ) ) )
return V_244 -> V_250 ;
V_244 ++ ;
}
return 0 ;
...
F_108 ( V_116 , 15 ) ;
V_6 -> V_8 |= V_9 ;
V_6 -> V_10 = V_210 | F_104 ( V_242 ) ;
if ( ( V_6 -> V_10 & V_252 ) &&
V_251 [ 4 ] == '1' && V_251 [ 6 ] <= '2' )
V_6 -> V_10 |= ( V_162 |
V_168 ) ;
else if ( ( V_6 -> V_10 & V_253 ) &&
V_251 [ 4 ] == '1' && V_251 [ 6 ] <= '2' )
V_6 -> V_10 |= V_162 ;
...
static void F_114 ( struct V_257 * V_7 )
{
struct V_1 * V_30 = F_115 ( V_7 , V_1 ) ;
struct V_135 * V_121 = & V_30 -> V_121 ;
T_1 * V_6 = V_30 -> V_6 ;
struct V_2 * V_258 = V_30 -> V_3 ;
F_12 ( V_71 , L_33 ) ;
F_116 ( V_30 -> V_152 ) ;
if ( V_121 -> V_193 == V_6 )
F_117 ( V_121 ) ;
...
static int F_119 ( struct V_260 * V_261 , T_12 V_262 )
{
struct V_1 * V_30 ;
int V_99 = - V_263 ;
F_2 ( & V_264 ) ;
V_30 = F_1 ( V_261 -> V_265 ) ;
if ( ! V_30 )
goto V_266;
V_99 = F_120 ( & V_30 -> V_121 , V_261 , V_262 ) ;
if ( V_99 < 0 )
F_7 ( V_30 ) ;
V_266:
F_6 ( & V_264 ) ;
...
static void F_121 ( struct V_2 * V_3 , T_12 V_262 )
{
struct V_1 * V_30 = F_3 ( V_3 , V_1 ) ;
F_2 ( & V_264 ) ;
F_122 ( & V_30 -> V_121 , V_262 ) ;
F_7 ( V_30 ) ;
F_6 ( & V_264 ) ;
}
static int F_123 ( struct V_135 * V_136 , unsigned long V_267 )
{
struct V_173 V_174 ;
char V_75 [ 16 ] ;
int V_54 ;
char V_268 ;
if ( F_124 ( & V_268 , ( void V_269 * ) V_267 , sizeof( char ) ) )
return - V_270 ;
F_83 ( & V_174 , V_75 , sizeof( V_75 ) , V_180 ) ;
V_54 = F_84 ( V_136 , & V_174 , V_271 , 0 ) ;
if ( V_54 )
return V_54 ;
V_75 [ 11 ] = ( V_75 [ 11 ] & 0xf0 ) | ( V_268 & 0x0f ) ;
return F_125 ( V_136 , & V_174 ) ;
}
static int F_126 ( struct V_135 * V_136 , unsigned long V_267 )
{
struct V_173 V_174 ;
char V_75 [ 16 ] ;
int V_54 ;
...
return V_54 ;
V_268 = V_75 [ 11 ] & 0x0f ;
if ( F_127 ( ( void V_269 * ) V_267 , & V_268 , sizeof( char ) ) )
return - V_270 ;
return 0 ;
}
static int F_128 ( struct V_260 * V_261 , T_12 V_262 ,
unsigned int V_26 , unsigned long V_267 )
{
struct V_1 * V_30 = F_3 ( V_261 -> V_265 , V_1 ) ;
int V_56 ;
switch ( V_26 ) {
case V_272 :
return F_123 ( & V_30 -> V_121 , V_267 ) ;
case V_273 :
return F_126 ( & V_30 -> V_121 , V_267 ) ;
default:
break;
}
V_56 = F_129 ( V_30 -> V_6 , V_261 , V_26 , V_267 ) ;
if ( V_56 == - V_274 )
V_56 = F_130 ( & V_30 -> V_121 , V_261 , V_262 , V_26 , V_267 ) ;
return V_56 ;
}
static int F_131 ( struct V_260 * V_261 , T_12 V_262 ,
unsigned int V_26 , unsigned long V_267 )
{
int V_275 ;
F_2 ( & V_264 ) ;
V_275 = F_128 ( V_261 , V_262 , V_26 , V_267 ) ;
F_6 ( & V_264 ) ;
return V_275 ;
}
...
F_12 ( V_144 , L_59 ,
V_6 -> V_277 , V_6 -> V_198 ) ;
if ( ! strstr ( L_60 , V_6 -> V_277 ) )
goto V_46;
if ( V_6 -> V_198 != V_278 && V_6 -> V_198 != V_208 )
goto V_46;
V_6 -> V_128 = V_128 ;
V_6 -> V_279 = F_44 ;
...
goto V_281;
F_138 ( V_258 , V_6 ) ;
V_30 -> V_7 . V_282 = & V_6 -> V_283 ;
V_30 -> V_7 . V_284 = F_114 ;
F_139 ( & V_30 -> V_7 , L_62 , F_140 ( & V_6 -> V_283 ) ) ;
if ( F_141 ( & V_30 -> V_7 ) )
goto V_285;
V_30 -> V_6 = V_6 ;
V_30 -> V_256 = & V_286 ;
V_30 -> V_3 = V_258 ;
V_258 -> V_259 = & V_30 -> V_256 ;
V_6 -> V_31 = V_30 ;
V_258 -> V_287 = 1 ;
V_258 -> V_80 = V_288 | V_289 ;
if ( F_105 ( V_6 ) ) {
F_8 ( & V_30 -> V_7 ) ;
goto V_46;
}
F_75 ( V_6 , & V_15 ) ;
V_258 -> V_290 = & V_291 ;
V_258 -> V_80 |= V_289 | V_292 ;
F_142 ( & V_6 -> V_283 , V_258 ) ;
return 0 ;
V_285:
F_118 ( V_258 ) ;
V_281:
