...
V_19 = F_60 ( V_2 , V_4 , 300 , F_61 ,
NULL ) ;
if ( V_19 )
F_21 ( V_4 ) ;
return V_19 ;
}
static void F_64 ( struct V_1 * V_2 , void * V_14 ,
struct V_3 * V_15 )
{
T_1 * V_138 ;
int V_19 ;
...
V_19 = F_60 ( V_2 , V_4 , 300 , F_64 ,
NULL ) ;
if ( V_19 )
F_21 ( V_4 ) ;
return V_19 ;
}
void F_66 ( struct V_1 * V_2 , void * V_14 ,
struct V_3 * V_15 )
{
T_1 V_140 ;
int V_19 ;
...
switch ( V_109 -> V_19 ) {
case V_145 :
V_99 -> V_143 [ 0 ] = V_109 -> V_112 ;
V_99 -> V_143 [ 1 ] = V_109 -> V_113 ;
break;
case V_146 :
V_99 -> V_143 [ 0 ] = V_147 ;
V_99 -> V_143 [ 1 ] = V_148 ;
...
if ( ! F_58 ( V_2 ) )
F_53 ( V_4 ) ;
V_19 = F_60 ( V_2 , V_4 , 300 ,
F_67 , NULL ) ;
if ( V_19 )
F_21 ( V_4 ) ;
return V_19 ;
}
void F_68 ( struct V_1 * V_2 , void * V_14 ,
struct V_3 * V_15 )
{
struct V_108 * V_109 ;
int V_19 ;
...
if ( V_19 )
return V_19 ;
return F_59 ( V_2 , V_44 ,
V_149 ) ;
}
int F_71 ( struct V_1 * V_2 , T_1 V_59 )
{
int V_19 ;
V_19 = F_70 ( V_2 ) ;
if ( V_19 )
return V_19 ;
return F_72 ( V_2 , 300 , F_66 , NULL ) ;
}
static int F_73 ( struct V_1 * V_2 , T_1 V_59 )
{
int V_19 ;
V_19 = F_59 ( V_2 , V_60 , V_59 ) ;
if ( V_19 )
return V_19 ;
return F_59 ( V_2 , V_44 ,
V_150 ) ;
}
int F_74 ( struct V_1 * V_2 , T_1 V_59 )
{
int V_19 ;
V_19 = F_73 ( V_2 , V_59 ) ;
if ( V_19 )
return V_19 ;
return F_72 ( V_2 , 300 , F_68 , NULL ) ;
}
void F_75 ( struct V_1 * V_2 , void * V_14 ,
struct V_3 * V_15 )
{
T_1 V_59 ;
int V_19 ;
