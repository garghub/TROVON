...
int F_22 ( struct V_2 * V_3 , struct V_83 * V_84 ,
...
V_33 = F_23 ( & V_37 -> V_106 -> V_107 . V_108 ) ;
if ( ( V_33 == V_109 ) ||
( V_33 == V_68 ) ) {
V_94 = V_110 ;
V_78 = V_25 ;
...
static T_8 F_25 ( struct V_112 * V_112 , char T_9 * V_113 ,
...
V_90 = strlen ( V_117 ) ;
return F_26 ( V_113 , V_114 , V_115 , V_117 , V_90 ) ;
}
...
V_126 |
V_127 ) ;
F_35 ( V_37 , V_3 , V_3 -> V_118 ) ;
F_29 ( V_38 ) -> V_125 ( V_38 ) ;
F_31 ( V_37 ) -> F_36 ( V_37 ) ;
}
...
F_31 ( V_37 ) -> F_32 ( V_37 ) ;
F_29 ( V_38 ) -> F_37 ( V_38 , & V_3 -> V_128 ) ;
F_31 ( V_37 ) -> F_36 ( V_37 ) ;
V_3 -> V_118 = V_118 ;
return 0 ;
}
static T_8 F_38 ( struct V_112 * V_112 ,
...
if ( F_28 ( V_124 ) )
return - V_131 ;
V_90 = F_39 ( V_114 , sizeof( V_82 ) - 1 ) ;
if ( F_40 ( V_82 , V_113 , V_90 ) )
return - V_132 ;
V_82 [ V_90 ] = '\0' ;
...
static T_8 F_41 ( struct V_112 * V_112 ,
char T_9 * V_113 ,
T_10 V_114 , T_11 * V_115 )
{
struct V_2 * V_3 = V_112 -> V_116 ;
...
return F_26 ( V_113 , V_114 , V_115 , V_82 , V_90 ) ;
}
...
static T_8 F_44 ( struct V_112 * V_112 ,
char T_9 * V_113 ,
T_10 V_114 , T_11 * V_115 )
{
struct V_2 * V_3 = V_112 -> V_116 ;
...
static struct V_139 * F_50 ( const char * V_140 ,
struct V_139 * V_141 ,
T_13 V_117 ,
struct V_142 * V_82 ,
int * V_143 )
{
struct V_139 * V_144 ;
V_144 = F_51 ( V_140 , V_117 , V_141 , V_82 ,
& V_145 ) ;
* V_143 = 1 ;
return V_144 ;
}
static int F_52 ( struct V_139 * V_139 )
{
F_53 ( V_139 ) ;
return 0 ;
}
