...
struct V_8 * V_9 = F_3 ( V_7 ) ;
struct V_30 * V_31 = V_9 -> V_31 ;
struct V_56 * V_57 = F_29 ( V_7 ) ;
struct V_13 * V_14 ;
unsigned long V_23 ;
int V_16 ;
int V_39 ;
V_16 = F_30 ( V_5 , 0 , & V_23 ) ;
if ( V_16 )
return V_16 ;
V_23 = F_31 ( V_23 ) ;
if ( ! F_6 ( V_7 ) )
return - V_20 ;
if ( V_57 && V_57 -> V_58 -> V_59 )
V_57 -> V_58 -> V_59 ( V_57 ) ;
V_14 = V_9 -> V_22 ;
F_32 ( & V_14 -> V_60 , V_14 -> V_50 ) ;
F_33 ( & V_14 -> V_61 ) ;
if ( F_34 ( & V_14 -> V_62 ) ) {
V_16 = - V_24 ;
goto V_21;
...
if ( V_49 -> V_22 != V_14 )
continue;
for ( V_63 = 0 ; V_63 < V_49 -> V_34 ; V_63 ++ ) {
struct V_35 * V_36 ;
V_36 = V_49 -> V_37 [ V_63 ] ;
if ( V_36 -> V_64 ( V_36 ) ) {
V_16 = - V_24 ;
...
V_16 = F_35 ( V_7 , V_23 , V_9 -> V_22 -> type ) ;
if ( V_16 ) {
F_22 ( V_2 , L_9 ) ;
goto V_21;
}
...
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_8 * V_9 = F_3 ( V_7 ) ;
return snprintf ( V_5 , V_10 , L_10 , V_9 -> V_22 -> V_65 ) ;
}
...
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_8 * V_9 = F_3 ( V_7 ) ;
return snprintf ( V_5 , V_10 , L_11 , V_9 -> V_22 -> V_66 ) ;
}
...
if ( V_16 )
return V_16 ;
return snprintf ( V_5 , V_10 , L_12 , ( unsigned ) V_68 ) ;
}
...
for ( V_39 = 0 ; V_39 < V_31 -> V_40 ; V_39 ++ ) {
int V_33 ;
for ( V_33 = 0 ; V_33 < F_46 ( V_69 ) ; V_33 ++ ) {
V_16 = F_47 ( V_31 -> V_41 [ V_39 ] -> V_2 ,
& V_69 [ V_33 ] ) ;
if ( V_16 ) {
F_22 ( V_31 -> V_2 , L_14
L_15 ) ;
...
void F_48 ( struct V_30 * V_31 )
{
int V_39 , V_33 ;
F_23 ( L_16 ) ;
for ( V_39 = 0 ; V_39 < V_31 -> V_40 ; V_39 ++ ) {
for ( V_33 = 0 ; V_33 < F_46 ( V_69 ) ; V_33 ++ )
F_49 ( V_31 -> V_41 [ V_39 ] -> V_2 ,
& V_69 [ V_33 ] ) ;
}
}
