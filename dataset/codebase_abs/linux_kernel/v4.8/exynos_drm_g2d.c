...
V_13 -> V_29 [ V_24 ] = V_30 ;
F_6 ( & V_6 [ V_10 ] . V_31 , & V_2 -> V_32 ) ;
}
return 0 ;
V_23:
F_7 ( F_3 ( V_9 -> V_17 ) , V_18 ,
V_2 -> V_16 ,
V_2 -> V_19 , V_2 -> V_14 ) ;
return V_11 ;
}
...
if ( F_12 ( & V_35 -> V_37 ) )
goto V_38;
V_36 = F_19 ( V_35 -> V_37 . V_39 ,
struct V_5 , V_31 ) ;
V_36 -> V_25 -> V_40 [ V_36 -> V_25 -> V_41 ] = V_6 -> V_27 ;
V_38:
F_6 ( & V_6 -> V_31 , & V_35 -> V_37 ) ;
if ( V_6 -> V_42 )
F_6 ( & V_6 -> V_42 -> V_43 . V_44 , & V_35 -> V_45 ) ;
}
static void F_20 ( struct V_46 * V_17 ,
unsigned long V_47 ,
bool V_48 )
{
struct V_49 * V_50 =
...
return;
V_53:
F_23 ( F_3 ( V_17 ) , V_50 -> V_56 -> V_57 ,
V_50 -> V_56 -> V_58 , V_59 ) ;
V_52 = F_24 ( V_50 -> V_60 ) ;
if ( ! F_25 ( V_52 ) ) {
int V_24 ;
for ( V_24 = 0 ; V_24 < F_26 ( V_50 -> V_60 ) ; V_24 ++ )
F_27 ( V_52 [ V_24 ] ) ;
}
F_28 ( V_50 -> V_60 ) ;
F_29 ( V_50 -> V_60 ) ;
...
static T_1 * F_31 ( struct V_46 * V_17 ,
unsigned long V_62 ,
unsigned long V_63 ,
struct V_64 * V_65 ,
unsigned long * V_47 )
...
V_2 = F_34 ( V_35 -> V_4 ) ;
F_35 (g2d_userptr, &g2d_priv->userptr_list, list) {
if ( V_50 -> V_62 == V_62 ) {
if ( V_50 -> V_63 == V_63 ) {
F_36 ( & V_50 -> V_54 ) ;
...
V_11 = F_41 ( V_70 , V_72 , true , true , V_50 -> V_60 ) ;
if ( V_11 != V_72 ) {
F_32 ( L_5 ) ;
if ( V_11 < 0 )
goto V_78;
...
V_50 -> V_56 = V_56 ;
if ( ! F_44 ( F_3 ( V_17 ) , V_56 -> V_57 , V_56 -> V_58 ,
V_59 ) ) {
F_32 ( L_7 ) ;
V_11 = - V_21 ;
goto V_82;
...
static void F_45 ( struct V_46 * V_17 ,
struct V_1 * V_2 ,
struct V_64 * V_65 )
{
struct V_66 * V_67 = V_65 -> V_68 ;
...
F_46 (g2d_userptr, n, &g2d_priv->userptr_list, list)
if ( V_50 -> V_55 )
F_20 ( V_17 ,
( unsigned long ) V_50 ,
true ) ;
...
static enum V_88 F_47 ( int V_89 )
{
enum V_88 V_90 ;
switch ( V_89 ) {
case V_91 :
...
static unsigned long F_48 ( unsigned int V_111 )
{
unsigned long V_112 ;
switch ( V_111 ) {
case V_113 :
...
static bool F_49 ( struct V_121 * V_122 ,
enum V_88 V_90 ,
unsigned long V_63 )
{
int V_123 , V_124 ;
...
if ( V_11 < 0 )
return;
F_58 ( V_6 -> V_27 , V_2 -> V_148 + V_149 ) ;
F_58 ( V_150 , V_2 -> V_148 + V_151 ) ;
}
static struct V_145 * F_59 ( struct V_1 * V_2 )
{
struct V_145 * V_146 ;
if ( F_12 ( & V_2 -> V_152 ) )
return NULL ;
V_146 = F_14 ( & V_2 -> V_152 ,
struct V_145 , V_31 ) ;
F_15 ( & V_146 -> V_31 ) ;
return V_146 ;
}
...
return;
F_11 ( & V_2 -> V_33 ) ;
F_35 (node, &runqueue_node->run_cmdlist, list)
F_54 ( V_2 , V_6 , V_146 -> V_65 ) ;
F_61 ( & V_146 -> V_147 , & V_2 -> V_32 ) ;
F_13 ( & V_2 -> V_33 ) ;
F_62 ( V_2 -> V_153 , V_146 ) ;
}
...
{
struct V_1 * V_2 = F_65 ( V_155 , struct V_1 ,
V_156 ) ;
F_11 ( & V_2 -> V_157 ) ;
F_66 ( V_2 -> V_4 ) ;
F_67 ( & V_2 -> V_146 -> F_67 ) ;
...
static void F_68 ( struct V_1 * V_2 , T_2 V_160 )
{
...
if ( F_12 ( & V_146 -> V_45 ) )
return;
V_162 = F_14 ( & V_146 -> V_45 ,
struct V_161 , V_43 . V_44 ) ;
F_69 ( & V_164 ) ;
V_162 -> V_42 . V_165 = V_164 . V_165 ;
V_162 -> V_42 . V_166 = V_164 . V_166 ;
V_162 -> V_42 . V_160 = V_160 ;
F_70 ( V_17 , & V_162 -> V_43 ) ;
}
static T_3 F_71 ( int V_167 , void * V_168 )
{
struct V_1 * V_2 = V_168 ;
T_2 V_169 ;
V_169 = F_72 ( V_2 -> V_148 + V_170 ) ;
if ( V_169 )
F_58 ( V_169 , V_2 -> V_148 + V_170 ) ;
if ( V_169 & V_171 ) {
T_2 V_160 = F_72 ( V_2 -> V_148 + V_172 ) ;
V_160 = ( V_160 & V_173 ) >>
V_174 ;
F_68 ( V_2 , V_160 ) ;
F_58 ( 0 , V_2 -> V_148 + V_175 ) ;
if ( ! ( V_169 & V_176 ) ) {
F_58 ( V_177 ,
V_2 -> V_148 + V_151 ) ;
}
...
return 0 ;
V_23:
F_4 ( V_4 , L_13 , V_25 -> V_40 [ V_181 ] ) ;
return - V_74 ;
}
int F_75 ( struct V_46 * V_17 , void * V_40 ,
struct V_64 * V_133 )
{
...
int F_76 ( struct V_46 * V_17 , void * V_40 ,
struct V_64 * V_133 )
{
struct V_66 * V_67 = V_133 -> V_68 ;
struct V_34 * V_35 = V_67 -> V_35 ;
...
V_162 = F_37 ( sizeof( * V_6 -> V_42 ) , V_20 ) ;
if ( ! V_162 ) {
V_11 = - V_21 ;
goto V_23;
}
...
V_11 = F_77 ( V_17 , V_133 , & V_162 -> V_43 , & V_162 -> V_42 . V_43 ) ;
if ( V_11 ) {
F_9 ( V_162 ) ;
goto V_23;
}
...
V_11 = F_74 ( V_4 , V_6 , V_195 -> V_209 , false ) ;
if ( V_11 < 0 )
goto V_212;
...
V_11 = F_74 ( V_4 , V_6 , V_195 -> V_210 , true ) ;
if ( V_11 < 0 )
goto V_212;
V_11 = F_50 ( V_2 , V_6 , V_17 , V_133 ) ;
if ( V_11 < 0 )
goto V_214;
}
...
static void F_87 ( struct V_46 * V_17 , struct V_3 * V_4 )
{
F_88 ( V_17 , V_4 ) ;
}
static int F_89 ( struct V_46 * V_17 , struct V_3 * V_4 ,
struct V_64 * V_133 )
{
struct V_66 * V_67 = V_133 -> V_68 ;
struct V_34 * V_35 ;
V_35 = F_37 ( sizeof( * V_35 ) , V_20 ) ;
if ( ! V_35 )
return - V_21 ;
V_35 -> V_4 = V_4 ;
V_67 -> V_35 = V_35 ;
...
return;
F_11 ( & V_2 -> V_33 ) ;
F_46 (node, n, &g2d_priv->inuse_cmdlist, list) {
F_54 ( V_2 , V_6 , V_133 ) ;
F_17 ( & V_6 -> V_31 , & V_2 -> V_32 ) ;
}
F_13 ( & V_2 -> V_33 ) ;
...
F_99 ( V_4 ) ;
V_226 = F_100 ( V_224 , V_230 , 0 ) ;
V_2 -> V_148 = F_101 ( V_4 , V_226 ) ;
if ( F_25 ( V_2 -> V_148 ) ) {
V_11 = F_98 ( V_2 -> V_148 ) ;
goto V_231;
}
V_2 -> V_167 = F_102 ( V_224 , 0 ) ;
if ( V_2 -> V_167 < 0 ) {
F_4 ( V_4 , L_23 ) ;
V_11 = V_2 -> V_167 ;
goto V_231;
}
V_11 = F_103 ( V_4 , V_2 -> V_167 , F_71 , 0 ,
L_24 , V_2 ) ;
if ( V_11 < 0 ) {
F_4 ( V_4 , L_25 ) ;
goto V_231;
