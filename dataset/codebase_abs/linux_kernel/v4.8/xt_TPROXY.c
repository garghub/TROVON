...
return F_38 ( V_65 -> V_19 , V_10 , V_67 -> V_15 , V_67 -> V_45 , V_67 -> V_58 , V_67 -> V_59 ) ;
}
static unsigned int
F_40 ( struct V_9 * V_10 , const struct V_64 * V_65 )
{
const struct V_69 * V_67 = V_65 -> V_68 ;
return F_38 ( V_65 -> V_19 , V_10 , V_67 -> V_15 . V_70 , V_67 -> V_45 , V_67 -> V_58 , V_67 -> V_59 ) ;
}
static inline const struct V_43 *
F_41 ( struct V_9 * V_10 , const struct V_43 * V_11 ,
...
static struct V_1 *
F_44 ( struct V_9 * V_10 , int V_77 , int V_42 ,
const struct V_64 * V_65 ,
struct V_1 * V_2 )
{
const struct V_78 * V_47 = F_45 ( V_10 ) ;
struct V_29 V_48 , * V_20 ;
const struct V_69 * V_67 = V_65 -> V_68 ;
...
if ( V_20 -> V_49 && ! V_20 -> V_50 && ! V_20 -> V_51 && ! V_20 -> V_52 ) {
struct V_1 * V_53 ;
V_53 = F_26 ( V_65 -> V_19 , V_10 , V_42 , V_20 , V_77 ,
& V_47 -> V_22 ,
F_41 ( V_10 , & V_67 -> V_15 . V_79 , & V_47 -> V_12 ) ,
V_20 -> V_54 ,
...
static unsigned int
F_46 ( struct V_9 * V_10 , const struct V_64 * V_65 )
{
const struct V_78 * V_47 = F_45 ( V_10 ) ;
const struct V_69 * V_67 = V_65 -> V_68 ;
struct V_60 V_48 , * V_20 ;
...
int V_42 = 0 ;
int V_77 ;
V_77 = F_47 ( V_10 , & V_42 , - 1 , NULL , NULL ) ;
if ( V_77 < 0 ) {
F_23 ( L_5 ) ;
return V_61 ;
}
...
V_2 = F_26 ( V_65 -> V_19 , V_10 , V_42 , V_20 , V_77 ,
& V_47 -> V_22 , & V_47 -> V_12 ,
V_20 -> V_54 , V_20 -> V_55 ,
V_65 -> V_26 , V_36 ) ;
V_15 = F_41 ( V_10 , & V_67 -> V_15 . V_79 , & V_47 -> V_12 ) ;
V_45 = V_67 -> V_45 ? V_67 -> V_45 : V_20 -> V_55 ;
if ( V_2 && V_2 -> V_3 == V_4 )
V_2 = F_44 ( V_10 , V_77 , V_42 , V_65 , V_2 ) ;
else if ( ! V_2 )
V_2 = F_26 ( V_65 -> V_19 , V_10 , V_42 , V_20 ,
V_77 , & V_47 -> V_22 , V_15 ,
V_20 -> V_54 , V_45 ,
V_65 -> V_26 , V_32 ) ;
if ( V_2 && F_1 ( V_2 ) ) {
...
static int F_48 ( const struct V_80 * V_65 )
{
const struct V_81 * V_82 = V_65 -> V_83 ;
if ( ( V_82 -> V_84 == V_31 || V_82 -> V_84 == V_37 ) &&
! ( V_82 -> V_85 & V_86 ) )
return 0 ;
F_49 ( L_9
L_10 ) ;
...
static int F_50 ( const struct V_80 * V_65 )
{
const struct V_88 * V_82 = V_65 -> V_83 ;
if ( ( V_82 -> V_84 == V_31 || V_82 -> V_84 == V_37 )
&& ! ( V_82 -> V_85 & V_89 ) )
return 0 ;
F_49 ( L_9
