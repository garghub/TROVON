...
const T_3 V_112 = F_24 ( V_99 ) ;
static struct V_98 V_113 [] = {
{
. V_100 = V_101 ,
. V_102 = V_103 ,
. V_104 = V_105 ,
...
if ( V_117 )
break;
V_2 -> V_118 = F_26 ( V_2 , V_119 ) ;
F_27 ( V_2 -> V_120 , V_121 , V_122 ,
V_114 , V_113 ) ;
break;
case V_80 :
case V_81 :
...
F_27 ( V_2 -> V_120 , V_121 , V_122 ,
V_112 , V_99 ) ;
F_27 ( V_2 -> V_118 , V_123 , V_124 , & V_116 ) ;
V_116 . V_125 = false ;
V_116 . V_126 = false ;
V_116 . V_127 = true ;
F_27 ( V_2 -> V_118 , V_123 , V_128 , & V_116 ) ;
V_116 . V_126 = true ;
F_27 ( V_2 -> V_118 , V_123 , V_128 , & V_116 ) ;
break;
case V_129 :
...
static int F_32 ( void * V_136 , int V_137 , int V_138 , int V_139 )
{
int V_140 ;
int V_141 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) V_136 ;
V_140 = ( ( F_33 ( V_24 ) ) & ( ~ 0x00000002 ) ) ;
V_140 |= ( V_137 ? 0x00020002 : 0x00020000 ) ;
F_22 ( V_24 , V_140 ) ;
V_140 = ( ( F_33 ( V_63 ) ) & ( ~ 0x0000a000 ) ) ;
V_140 |= ( V_138 ? 0x00008000 : 0 ) ;
F_22 ( V_63 , V_140 ) ;
if ( V_139 )
V_141 = ( V_140 & 0x00004000 ) ? 1 : 0 ;
F_22 ( V_63 , V_140 | 0x00002000 ) ;
F_34 ( 1 ) ;
F_22 ( V_63 , V_140 ) ;
return V_141 ;
}
...
static T_1 V_144 [ 256 ] ;
if ( V_2 -> V_17 [ 0 ] . V_145 == 0 ) {
V_2 -> V_17 [ 0 ] . V_18 . V_146 = 0xa0 >> 1 ;
...
case V_96 :
case V_97 :
V_2 -> V_120 = F_39 ( & V_2 -> V_159 ,
& V_2 -> V_17 [ 2 ] . V_160 ,
L_19 , 0x88 >> 1 , NULL ) ;
if ( V_2 -> V_120 ) {
V_2 -> V_120 -> V_161 = V_132 ;
F_27 ( V_2 -> V_120 , V_121 , V_162 ) ;
}
break;
}
switch ( V_2 -> V_14 ) {
...
F_2 ( V_7 L_24 ,
V_168 . V_173 , V_165 ) ;
V_117 = F_42 ( & V_164 , V_165 , & V_2 -> V_4 -> V_2 ) ;
if ( V_117 != 0 )
F_2 ( V_34 L_25
L_26
L_27 , V_165 ) ;
