...
int F_86 ( struct V_16 * V_17 , unsigned int V_20 )
{
...
static T_3 unsigned long F_89 ( unsigned int V_99 )
{
...
for ( V_30 = 0 ; V_30 < F_91 ( V_102 ) ; V_30 ++ )
V_102 [ V_30 ] = F_89 ( V_30 ) ;
for ( V_30 = 0 ; V_30 < F_91 ( V_57 ) ; V_30 ++ ) {
