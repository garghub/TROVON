...
int F_44 ( struct V_91 * V_52 , char * V_151 )
{
return F_45 ( V_52 , V_151 , & V_152 ) ;
}
void F_46 ( struct V_91 * V_52 , char * V_151 )
{
F_47 ( V_151 ) ;
}
int F_48 ( struct V_50 * V_51 , struct V_153 * V_42 )
{
struct V_92 * V_65 = V_51 -> V_65 ;
struct V_154 * V_155 = F_49 ( V_65 -> V_133 ) ;
