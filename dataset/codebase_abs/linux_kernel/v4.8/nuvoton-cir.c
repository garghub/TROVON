...
if ( ( V_164 == V_57 ) && ( V_37 + 1 < V_2 -> V_160 ) ) {
F_43 ( L_61 ) ;
F_61 ( V_2 -> V_167 ) ;
}
}
...
F_43 ( L_65 , V_168 ) ;
V_169 = V_2 -> V_160 ;
if ( V_169 + V_168 > V_161 ) {
F_56 ( V_2 ) ;
V_169 = 0 ;
}
for ( V_37 = 0 ; V_37 < V_168 ; V_37 ++ ) {
V_5 = F_16 ( V_2 , V_75 ) ;
V_2 -> V_30 [ V_169 + V_37 ] = V_5 ;
}
V_2 -> V_160 += V_168 ;
F_43 ( L_66 , V_159 , V_2 -> V_160 ) ;
F_56 ( V_2 ) ;
}
static void F_65 ( T_1 V_170 , T_1 V_127 )
{
F_43 ( L_67 ,
V_170 , V_127 ,
V_170 & V_171 ? L_68 : L_69 ,
V_170 & V_172 ? L_70 : L_69 ,
V_170 & V_173 ? L_71 : L_69 ,
V_170 & V_174 ? L_72 : L_69 ,
V_170 & V_175 ? L_73 : L_69 ,
V_170 & V_176 ? L_74 : L_69 ,
V_170 & V_177 ? L_75 : L_69 ,
V_170 & V_178 ? L_76 : L_69 ,
V_170 & ~ ( V_171 | V_172 | V_173 |
V_174 | V_175 | V_176 |
V_177 | V_178 ) ? L_77 : L_69 ) ;
}
...
static T_6 F_67 ( int V_179 , void * V_180 )
{
...
static int F_72 ( struct V_184 * V_104 , const struct V_185 * V_186 )
{
struct V_1 * V_2 ;
struct V_31 * V_167 ;
int V_52 = - V_54 ;
...
V_167 -> V_199 = L_83 ;
V_167 -> V_200 = L_84 ;
V_167 -> V_201 . V_202 = V_203 ;
V_167 -> V_201 . V_204 = V_205 ;
V_167 -> V_201 . V_206 = V_2 -> V_97 ;
V_167 -> V_201 . V_207 = V_2 -> V_101 ;
V_167 -> V_27 . V_208 = & V_104 -> V_27 ;
V_167 -> V_209 = V_10 ;
V_167 -> V_210 = V_211 ;
V_167 -> V_212 = F_84 ( 100 ) ;
V_167 -> V_213 = F_59 ( V_214 ) ;
#if 0
...
static void F_93 ( struct V_184 * V_104 )
{
struct V_1 * V_2 = F_94 ( V_104 ) ;
F_95 ( & V_2 -> V_167 -> V_27 , & V_217 ) ;
F_69 ( V_2 ) ;
F_50 ( V_2 ) ;
F_91 ( V_2 -> V_167 ) ;
}
static int F_96 ( struct V_184 * V_104 , T_7 V_218 )
{
struct V_1 * V_2 = F_94 ( V_104 ) ;
unsigned long V_35 ;
F_43 ( L_87 , V_159 ) ;
...
static int F_97 ( struct V_184 * V_104 )
{
struct V_1 * V_2 = F_94 ( V_104 ) ;
F_43 ( L_87 , V_159 ) ;
F_48 ( V_2 ) ;
...
static void F_98 ( struct V_184 * V_104 )
{
struct V_1 * V_2 = F_94 ( V_104 ) ;
F_50 ( V_2 ) ;
}
