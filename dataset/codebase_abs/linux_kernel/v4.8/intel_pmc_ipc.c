...
V_73 = V_75 + V_85 ;
V_73 -> V_77 = V_2 . V_86 + V_87 ;
V_73 -> V_80 = V_73 -> V_77 + V_88 - 1 ;
V_14 = F_41 ( V_50 , V_75 , F_14 ( V_75 ) ) ;
if ( V_14 ) {
F_13 ( V_2 . V_21 , L_16 ) ;
goto V_70;
}
V_14 = F_45 ( V_50 , & V_89 , sizeof( V_89 ) ) ;
if ( V_14 ) {
F_13 ( V_2 . V_21 , L_17 ) ;
goto V_70;
}
...
V_73 = V_92 + V_93 ;
V_73 -> V_77 = V_2 . V_94 ;
V_73 -> V_80 = V_73 -> V_77 + V_2 . V_95 - 1 ;
V_73 = V_92 + V_96 ;
V_73 -> V_77 = V_2 . V_97 ;
V_73 -> V_80 = V_73 -> V_77 + V_2 . V_98 - 1 ;
V_14 = F_41 ( V_50 , V_92 ,
F_14 ( V_92 ) ) ;
if ( V_14 ) {
F_13 ( V_2 . V_21 ,
...
{
struct V_72 * V_73 , * V_101 ;
void T_7 * V_102 ;
int V_103 ;
V_73 = F_51 ( V_50 , V_104 ,
V_105 ) ;
if ( ! V_73 ) {
F_13 ( & V_50 -> V_21 , L_22 ) ;
return - V_106 ;
...
V_103 = V_116 ;
if ( ! F_54 ( V_73 -> V_77 , V_103 , V_50 -> V_117 ) ) {
F_13 ( & V_50 -> V_21 , L_33 ) ;
return - V_57 ;
}
V_102 = F_30 ( V_73 -> V_77 , V_103 ) ;
if ( ! V_102 ) {
F_13 ( & V_50 -> V_21 , L_34 ) ;
F_55 ( V_73 -> V_77 , V_103 ) ;
return - V_56 ;
}
V_2 . V_6 = V_102 ;
V_2 . V_86 = V_73 -> V_77 + V_118 ;
V_2 . V_119 = V_120 ;
...
if ( F_29 ( V_2 . V_45 , F_20 , V_126 ,
L_4 , & V_2 ) ) {
F_13 ( & V_50 -> V_21 , L_6 ) ;
V_14 = - V_57 ;
goto V_127;
}
V_14 = F_58 ( & V_50 -> V_21 . V_128 , & V_129 ) ;
if ( V_14 ) {
F_13 ( & V_50 -> V_21 , L_41 ,
V_14 ) ;
goto V_130;
...
V_115 ) ;
if ( V_73 )
F_55 ( V_73 -> V_77 , V_116 ) ;
return V_14 ;
}
static int F_59 ( struct V_66 * V_50 )
{
struct V_72 * V_73 ;
F_60 ( & V_50 -> V_21 . V_128 , & V_129 ) ;
F_31 ( V_2 . V_45 , & V_2 ) ;
F_48 ( V_2 . V_90 ) ;
F_48 ( V_2 . V_71 ) ;
F_48 ( V_2 . V_99 ) ;
