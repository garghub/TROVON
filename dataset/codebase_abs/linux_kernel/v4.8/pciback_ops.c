...
if ( ! F_30 ( V_53 , ( unsigned long * ) & V_25 -> V_49 -> V_50 )
&& F_30 ( V_54 , & V_25 -> V_50 ) ) {
F_33 ( & V_55 ) ;
}
}
...
* V_27 = V_25 -> V_49 -> V_27 ;
F_36 () ;
V_2 = F_37 ( V_25 , V_27 -> V_60 , V_27 -> V_61 , V_27 -> V_62 ) ;
if ( V_2 == NULL )
V_27 -> V_63 = V_64 ;
else {
V_5 = F_2 ( V_2 ) ;
...
#ifdef F_9
case V_69 :
V_27 -> V_63 = F_15 ( V_25 , V_2 , V_27 ) ;
break;
case V_70 :
V_27 -> V_63 = F_22 ( V_25 , V_2 , V_27 ) ;
break;
case V_71 :
V_59 = V_27 -> V_34 ;
V_27 -> V_63 = F_23 ( V_25 , V_2 , V_27 ) ;
break;
case V_72 :
V_27 -> V_63 = F_28 ( V_25 , V_2 , V_27 ) ;
break;
#endif
default:
V_27 -> V_63 = V_73 ;
...
if ( ! V_27 -> V_63 && V_2 && V_5 ) {
if ( ( V_5 -> V_10 != V_58 ) )
F_1 ( V_2 , 0 ) ;
}
V_25 -> V_49 -> V_27 . V_63 = V_27 -> V_63 ;
V_25 -> V_49 -> V_27 . V_34 = V_27 -> V_34 ;
#ifdef F_9
if ( V_27 -> V_20 == V_71 && V_27 -> V_63 == 0 ) {
unsigned int V_36 ;
...
T_2 F_45 ( int V_13 , void * V_75 )
{
struct V_24 * V_25 = V_75 ;
F_29 ( V_25 ) ;
return V_76 ;
}
static T_2 V_18 ( int V_13 , void * V_75 )
{
