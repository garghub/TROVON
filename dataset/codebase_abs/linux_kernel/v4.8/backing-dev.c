...
int F_131 ( struct V_5 * V_6 , struct V_34 * V_152 )
{
int V_153 ;
V_153 = F_123 ( V_6 , NULL , L_19 , F_129 ( V_152 -> V_154 ) ,
F_130 ( V_152 -> V_154 ) ) ;
if ( V_153 )
return V_153 ;
V_6 -> V_152 = V_152 ;
...
void F_143 ( struct V_86 * V_80 , int V_157 )
{
T_8 * V_158 = & V_159 [ V_157 ] ;
enum V_160 V_161 ;
V_161 = V_157 ? V_162 : V_163 ;
if ( F_53 ( V_161 , & V_80 -> V_27 ) )
F_115 ( & V_164 [ V_157 ] ) ;
F_144 () ;
if ( F_145 ( V_158 ) )
F_146 ( V_158 ) ;
}
void F_147 ( struct V_86 * V_80 , int V_157 )
{
enum V_160 V_161 ;
V_161 = V_157 ? V_162 : V_163 ;
if ( ! F_148 ( V_161 , & V_80 -> V_27 ) )
F_66 ( & V_164 [ V_157 ] ) ;
}
long F_149 ( int V_157 , long V_59 )
{
long V_41 ;
unsigned long V_165 = V_68 ;
F_150 ( V_166 ) ;
T_8 * V_158 = & V_159 [ V_157 ] ;
F_151 ( V_158 , & V_166 , V_167 ) ;
V_41 = F_152 ( V_59 ) ;
F_153 ( V_158 , & V_166 ) ;
F_154 ( F_155 ( V_59 ) ,
F_155 ( V_68 - V_165 ) ) ;
...
long F_156 ( struct V_168 * V_169 , int V_157 , long V_59 )
{
long V_41 ;
unsigned long V_165 = V_68 ;
F_150 ( V_166 ) ;
T_8 * V_158 = & V_159 [ V_157 ] ;
if ( F_117 ( & V_164 [ V_157 ] ) == 0 ||
! F_39 ( V_170 , & V_169 -> V_91 ) ) {
F_157 () ;
V_41 = V_59 - ( V_68 - V_165 ) ;
if ( V_41 < 0 )
V_41 = 0 ;
goto V_171;
}
...
int F_159 ( struct V_172 * V_173 , int V_174 ,
void T_9 * V_175 , T_3 * V_176 , T_10 * V_177 )
{
char V_178 [] = L_21 ;
if ( * V_177 || * V_176 < sizeof( V_178 ) ) {
* V_176 = 0 ;
return 0 ;
}
if ( F_160 ( V_175 , V_178 , sizeof( V_178 ) ) )
return - V_179 ;
F_161 ( L_22 ,
V_173 -> V_180 ) ;
* V_176 = 2 ;
