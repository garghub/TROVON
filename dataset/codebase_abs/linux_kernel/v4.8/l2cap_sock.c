...
static struct V_206 * F_107 ( struct V_16 * V_17 ,
unsigned long V_210 ,
...
int V_21 ;
F_59 ( V_17 ) ;
V_207 = F_108 ( V_15 , V_210 + V_20 , V_211 , & V_21 ) ;
F_57 ( V_17 ) ;
if ( ! V_207 )
return F_109 ( V_21 ) ;
V_207 -> V_212 = V_15 -> V_213 ;
F_110 ( V_207 ) -> V_214 . V_17 = V_17 ;
return V_207 ;
}
...
F_71 ( F_6 ( V_15 ) -> V_17 ) ;
if ( F_6 ( V_15 ) -> V_176 ) {
F_119 ( F_6 ( V_15 ) -> V_176 ) ;
F_6 ( V_15 ) -> V_176 = NULL ;
}
F_120 ( & V_15 -> V_216 ) ;
F_120 ( & V_15 -> V_217 ) ;
}
static void F_121 ( struct V_206 * V_207 , void * V_218 ,
int * V_219 )
{
F_122 ( struct V_18 * , V_19 , V_218 ) ;
memset ( V_19 , 0 , sizeof( struct V_18 ) ) ;
V_19 -> V_220 = V_23 ;
V_19 -> V_25 = F_110 ( V_207 ) -> V_214 . V_5 ;
F_14 ( & V_19 -> V_34 , & F_110 ( V_207 ) -> V_214 . V_221 ) ;
...
struct V_2 * V_15 ;
struct V_16 * V_17 ;
V_15 = F_125 ( V_231 , V_235 , V_233 , & V_236 , V_234 ) ;
if ( ! V_15 )
return NULL ;
F_126 ( V_2 , V_15 ) ;
...
static int F_131 ( struct V_231 * V_231 , struct V_1 * V_2 , int V_241 ,
int V_234 )
{
struct V_2 * V_15 ;
F_7 ( L_15 , V_2 ) ;
...
if ( V_21 < 0 )
return V_21 ;
V_21 = F_136 ( V_204 , & V_245 ) ;
if ( V_21 < 0 ) {
F_137 ( L_16 ) ;
goto error;
}
V_21 = F_138 ( & V_246 , L_17 , & V_200 ,
NULL ) ;
if ( V_21 < 0 ) {
F_137 ( L_18 ) ;
F_139 ( V_204 ) ;
