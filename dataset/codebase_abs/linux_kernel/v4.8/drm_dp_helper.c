...
static struct V_31 * F_42 ( struct V_75 * V_127 )
{
return F_43 ( V_127 , struct V_31 , V_128 ) ;
}
static void F_44 ( struct V_75 * V_127 , unsigned int V_115 )
{
F_14 ( & F_42 ( V_127 ) -> V_44 ) ;
}
static int F_45 ( struct V_75 * V_127 , unsigned int V_115 )
{
return F_46 ( & F_42 ( V_127 ) -> V_44 ) ;
}
static void F_47 ( struct V_75 * V_127 , unsigned int V_115 )
{
F_17 ( & F_42 ( V_127 ) -> V_44 ) ;
}
void F_48 ( struct V_31 * V_32 )
{
F_49 ( & V_32 -> V_44 ) ;
V_32 -> V_128 . V_129 = & V_130 ;
V_32 -> V_128 . V_120 = V_32 ;
V_32 -> V_128 . V_131 = 3 ;
V_32 -> V_128 . F_44 = F_44 ;
V_32 -> V_128 . F_45 = F_45 ;
V_32 -> V_128 . F_47 = F_47 ;
}
...
if ( ! V_32 -> V_128 . V_129 )
F_48 ( V_32 ) ;
V_32 -> V_128 . V_132 = V_133 ;
V_32 -> V_128 . V_134 = V_135 ;
V_32 -> V_128 . V_136 . V_137 = V_32 -> V_136 ;
V_32 -> V_128 . V_136 . V_138 = V_32 -> V_136 -> V_138 ;
F_51 ( V_32 -> V_128 . V_139 , V_32 -> V_139 ? V_32 -> V_139 : F_52 ( V_32 -> V_136 ) ,
sizeof( V_32 -> V_128 . V_139 ) ) ;
V_42 = F_53 ( V_32 ) ;
if ( V_42 )
return V_42 ;
V_42 = F_54 ( & V_32 -> V_128 ) ;
if ( V_42 ) {
F_55 ( V_32 ) ;
return V_42 ;
}
...
void F_56 ( struct V_31 * V_32 )
{
F_55 ( V_32 ) ;
F_57 ( & V_32 -> V_128 ) ;
}
int F_58 ( const T_1 V_140 [ V_141 ] )
{
static const T_5 V_142 [] = {
F_59 ( 330 ) ,
F_59 ( 275 ) ,
F_59 ( 165 ) ,
F_59 ( 110 ) ,
