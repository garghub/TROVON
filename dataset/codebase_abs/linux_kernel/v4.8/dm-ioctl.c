...
static bool F_102 ( unsigned V_139 , unsigned V_42 )
{
if ( V_139 == V_42 ||
( V_139 == V_140 && V_42 == V_141 ) )
return true ;
return false ;
}
static int F_103 ( struct V_40 * V_41 , T_2 V_52 )
{
int V_88 ;
struct V_11 * V_12 ;
...
if ( ! V_14 )
return - V_47 ;
V_88 = F_104 ( & V_35 , F_97 ( V_41 ) , V_41 -> V_86 , V_14 ) ;
if ( V_88 )
goto V_143;
F_105 ( V_14 ) ;
...
if ( F_109 ( V_14 ) == V_145 ) {
F_110 ( V_14 , F_111 ( V_35 ) ) ;
V_88 = F_112 ( V_14 , V_35 ) ;
if ( V_88 ) {
F_39 ( L_24 ) ;
goto V_144;
}
} else if ( ! F_102 ( F_109 ( V_14 ) , F_111 ( V_35 ) ) ) {
F_39 ( L_25 ) ;
V_88 = - V_48 ;
goto V_144;
}
...
struct V_149 * V_150 ;
struct V_151 * V_152 ;
V_152 = F_48 ( V_41 , V_52 , & V_57 ) ;
F_116 (tmp, dm_table_get_devices(table))
V_147 ++ ;
V_59 = sizeof( * V_152 ) + ( sizeof( * V_152 -> V_16 ) * V_147 ) ;
if ( V_57 < V_59 ) {
V_41 -> V_45 |= V_65 ;
return;
}
...
V_152 -> V_16 [ V_147 ++ ] = F_51 ( V_150 -> V_153 -> V_154 -> V_155 ) ;
V_41 -> V_54 = V_41 -> V_58 + V_59 ;
}
static int F_117 ( struct V_40 * V_41 , T_2 V_52 )
{
struct V_17 * V_14 ;
struct V_28 * V_29 ;
int V_30 ;
...
V_29 = F_61 ( V_14 , V_41 , & V_30 ) ;
if ( V_29 )
F_115 ( V_29 , V_41 , V_52 ) ;
F_32 ( V_14 , V_30 ) ;
F_15 ( V_14 ) ;
return 0 ;
}
static int F_118 ( struct V_40 * V_41 , T_2 V_52 )
{
struct V_17 * V_14 ;
struct V_28 * V_29 ;
int V_30 ;
...
static int F_119 ( struct V_17 * V_14 , unsigned V_156 , char * * V_157 ,
char * V_158 , unsigned V_159 )
{
int V_88 ;
if ( * * V_157 != '@' )
return 2 ;
if ( ! strcasecmp ( V_157 [ 0 ] , L_26 ) ) {
if ( V_156 != 1 ) {
F_120 ( L_27 ) ;
return - V_48 ;
}
...
V_88 = F_122 ( V_14 , V_156 , V_157 , V_158 , V_159 ) ;
if ( V_88 < 2 )
return V_88 ;
F_120 ( L_28 , V_157 [ 0 ] ) ;
return - V_48 ;
}
static int F_123 ( struct V_40 * V_41 , T_2 V_52 )
{
int V_88 , V_156 ;
char * * V_157 ;
struct V_17 * V_14 ;
struct V_28 * V_29 ;
struct V_125 * V_126 ;
struct V_160 * V_161 = ( void * ) V_41 + V_41 -> V_58 ;
T_2 V_159 ;
char * V_158 = F_48 ( V_41 , V_52 , & V_159 ) ;
int V_30 ;
V_14 = F_76 ( V_41 ) ;
if ( ! V_14 )
return - V_47 ;
if ( V_161 < (struct V_160 * ) V_41 -> V_94 ||
F_79 ( V_161 -> V_162 , ( void * ) V_41 + V_52 ) ) {
F_39 ( L_29 ) ;
V_88 = - V_48 ;
goto V_66;
}
V_88 = F_124 ( & V_156 , & V_157 , V_161 -> V_162 ) ;
if ( V_88 ) {
F_39 ( L_30 ) ;
goto V_66;
}
...
V_88 = F_119 ( V_14 , V_156 , V_157 , V_158 , V_159 ) ;
if ( V_88 <= 1 )
goto V_163;
V_29 = F_30 ( V_14 , & V_30 ) ;
if ( ! V_29 )
...
V_126 = F_126 ( V_29 , V_161 -> V_165 ) ;
if ( ! F_127 ( V_126 ) ) {
F_39 ( L_32 ) ;
V_88 = - V_48 ;
} else if ( V_126 -> type -> V_162 )
V_88 = V_126 -> type -> V_162 ( V_126 , V_156 , V_157 ) ;
else {
F_39 ( L_33 ) ;
V_88 = - V_48 ;
}
...
if ( V_88 == 1 ) {
V_41 -> V_45 |= V_166 ;
if ( F_128 ( V_158 , V_159 ) )
V_41 -> V_45 |= V_65 ;
else
V_41 -> V_54 = V_41 -> V_58 + strlen ( V_158 ) + 1 ;
V_88 = 0 ;
}
F_15 ( V_14 ) ;
return V_88 ;
}
static T_5 F_129 ( unsigned int V_167 , int * V_168 )
{
static struct {
int V_167 ;
int V_45 ;
...
if ( F_130 ( V_167 >= F_131 ( V_170 ) ) )
return NULL ;
* V_168 = V_170 [ V_167 ] . V_45 ;
return V_170 [ V_167 ] . V_169 ;
}
static int F_132 ( unsigned int V_167 , struct V_40 T_6 * V_188 )
{
V_68 V_76 [ 3 ] ;
int V_88 = 0 ;
if ( F_133 ( V_76 , V_188 -> V_76 , sizeof( V_76 ) ) )
return - V_189 ;
if ( ( V_190 != V_76 [ 0 ] ) ||
( V_191 < V_76 [ 1 ] ) ) {
F_39 ( L_34
...
V_190 , V_191 ,
V_192 ,
V_76 [ 0 ] , V_76 [ 1 ] , V_76 [ 2 ] , V_167 ) ;
V_88 = - V_48 ;
}
V_76 [ 0 ] = V_190 ;
V_76 [ 1 ] = V_191 ;
V_76 [ 2 ] = V_192 ;
if ( F_134 ( V_188 -> V_76 , V_76 , sizeof( V_76 ) ) )
return - V_189 ;
return V_88 ;
}
static void F_135 ( struct V_40 * V_41 , T_2 V_52 , int V_193 )
{
if ( V_193 & V_194 )
memset ( V_41 , 0 , V_52 ) ;
if ( V_193 & V_195 )
...
static int F_137 ( struct V_40 T_6 * V_188 , struct V_40 * V_196 ,
int V_168 ,
struct V_40 * * V_41 , int * V_193 )
{
struct V_40 * V_197 ;
int V_198 ;
const T_2 V_199 = sizeof( * V_196 ) - sizeof( V_196 -> V_94 ) ;
if ( F_133 ( V_196 , V_188 , V_199 ) )
return - V_189 ;
if ( V_196 -> V_54 < V_199 )
return - V_48 ;
V_198 = V_196 -> V_45 & V_200 ;
* V_193 = V_198 ? V_194 : 0 ;
if ( V_168 & V_173 ) {
V_197 = V_196 ;
V_197 -> V_54 = V_199 ;
...
V_197 = NULL ;
if ( V_196 -> V_54 <= V_202 )
V_197 = F_17 ( V_196 -> V_54 , V_203 | V_204 | V_205 | V_206 ) ;
if ( ! V_197 ) {
unsigned V_207 ;
V_207 = F_138 () ;
V_197 = F_139 ( V_196 -> V_54 , V_203 | V_208 | V_209 , V_210 ) ;
F_140 ( V_207 ) ;
}
if ( ! V_197 ) {
if ( V_198 && F_141 ( V_188 , V_196 -> V_54 ) )
return - V_189 ;
return - V_23 ;
}
* V_193 |= V_195 ;
if ( F_133 ( V_197 , V_188 , V_196 -> V_54 ) )
goto V_25;
V_201:
if ( V_197 -> V_54 != V_196 -> V_54 ) {
F_120 ( L_36 ) ;
goto V_25;
}
if ( V_198 && F_141 ( V_188 , V_196 -> V_54 ) )
...
return 0 ;
V_25:
F_135 ( V_197 , V_196 -> V_54 , * V_193 ) ;
return - V_189 ;
}
static int F_142 ( T_7 V_167 , struct V_40 * V_41 )
{
V_41 -> V_45 &= ~ V_65 ;
V_41 -> V_45 &= ~ V_51 ;
V_41 -> V_45 &= ~ V_200 ;
...
static int F_143 ( T_7 V_211 , struct V_40 T_6 * V_188 )
{
int V_88 = 0 ;
int V_168 ;
int V_193 ;
unsigned int V_167 ;
struct V_40 * V_212 ( V_41 ) ;
T_5 V_169 = NULL ;
T_2 V_213 ;
struct V_40 V_196 ;
if ( ! F_144 ( V_214 ) )
return - V_215 ;
if ( F_145 ( V_211 ) != V_216 )
return - V_217 ;
V_167 = F_146 ( V_211 ) ;
V_88 = F_132 ( V_167 , V_188 ) ;
if ( V_88 )
return V_88 ;
if ( V_167 == V_171 )
return 0 ;
V_169 = F_129 ( V_167 , & V_168 ) ;
if ( ! V_169 ) {
F_39 ( L_39 , V_211 ) ;
return - V_217 ;
}
V_88 = F_137 ( V_188 , & V_196 , V_168 , & V_41 , & V_193 ) ;
if ( V_88 )
return V_88 ;
V_213 = V_41 -> V_54 ;
V_88 = F_142 ( V_167 , V_41 ) ;
if ( V_88 )
goto V_66;
V_41 -> V_54 = sizeof( * V_41 ) ;
V_88 = V_169 ( V_41 , V_213 ) ;
if ( F_130 ( V_41 -> V_45 & V_65 ) &&
F_130 ( V_168 & V_173 ) )
F_120 ( L_40 , V_167 ) ;
if ( ! V_88 && F_134 ( V_188 , V_41 , V_41 -> V_54 ) )
V_88 = - V_189 ;
V_66:
F_135 ( V_41 , V_213 , V_193 ) ;
return V_88 ;
}
static long F_147 ( struct V_218 * V_218 , T_7 V_211 , T_8 V_219 )
{
return ( long ) F_143 ( V_211 , (struct V_40 T_6 * ) V_219 ) ;
}
static long F_148 ( struct V_218 * V_218 , T_7 V_211 , T_8 V_219 )
{
return ( long ) F_147 ( V_218 , V_211 , ( T_8 ) F_149 ( V_219 ) ) ;
}
int T_9 F_150 ( void )
{
int V_88 ;
...
int F_155 ( struct V_17 * V_14 , char * V_13 , char * V_15 )
{
int V_88 = 0 ;
struct V_11 * V_12 ;
if ( ! V_14 )
