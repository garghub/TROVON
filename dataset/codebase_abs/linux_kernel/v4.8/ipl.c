...
return;
V_30 |= V_33 ;
V_214 = ( void * ) ( unsigned long ) V_180 . V_234 ;
V_111 = ( void * ) V_235 ;
memmove ( V_111 , V_214 , V_159 ) ;
V_180 . V_234 = V_235 ;
}
void F_138 ( struct V_236 * V_237 )
{
F_139 ( & V_238 ) ;
F_140 ( & V_237 -> V_239 , & V_240 ) ;
F_141 ( & V_238 ) ;
}
void F_142 ( struct V_236 * V_237 )
{
F_139 ( & V_238 ) ;
F_143 ( & V_237 -> V_239 ) ;
F_141 ( & V_238 ) ;
...
{
struct V_241 * V_242 ;
V_242 = (struct V_241 * ) ( unsigned long ) F_148 () ;
V_242 -> V_243 = V_180 . V_243 ;
F_149 ( 0 ) ;
F_150 ( 0 , 28 ) ;
V_180 . V_244 . V_245 = V_246 | V_247 ;
V_180 . V_244 . V_20 =
( unsigned long ) V_248 ;
V_180 . V_249 . V_245 = V_246 | V_247 ;
V_180 . V_249 . V_20 =
( unsigned long ) V_250 ;
F_144 () ;
}
