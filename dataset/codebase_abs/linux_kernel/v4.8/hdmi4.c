...
if ( V_2 . V_67 ) {
V_1 = F_58 ( & V_2 . V_49 , & V_2 . V_9 , & V_2 . V_68 ,
V_2 . V_34 . V_35 . V_38 ) ;
if ( V_1 ) {
F_15 ( L_12 , V_1 ) ;
V_2 . V_69 ( & V_2 . V_3 -> V_4 ) ;
V_2 . V_67 = false ;
}
}
F_59 ( & V_2 . V_70 , V_63 ) ;
...
bool V_80 )
{
V_2 . V_34 . V_81 = V_80 ? V_82 : V_83 ;
return 0 ;
}
static void F_73 ( struct V_84 * V_3 )
{
struct V_21 * V_61 = & V_2 . V_62 ;
V_61 -> V_4 = & V_3 -> V_4 ;
V_61 -> V_85 = V_86 ;
...
static void F_75 ( struct V_84 * V_3 )
{
struct V_21 * V_61 = & V_2 . V_62 ;
F_76 ( V_61 ) ;
}
static int F_77 ( struct V_84 * V_3 )
{
struct V_94 * V_95 = V_3 -> V_4 . V_96 ;
struct V_94 * V_97 ;
int V_1 ;
V_97 = F_78 ( V_95 ) ;
if ( ! V_97 )
return 0 ;
V_1 = F_79 ( V_3 , V_97 , & V_2 . V_44 ) ;
if ( V_1 )
goto V_98;
F_80 ( V_97 ) ;
return 0 ;
...
static int F_81 ( struct V_99 * V_4 ,
void (* F_82)( struct V_99 * V_4 ) )
{
struct V_59 * V_60 = F_83 ( V_4 ) ;
int V_100 = 0 ;
F_40 ( & V_60 -> V_54 ) ;
if ( ! F_84 ( & V_60 -> V_34 ) || ! V_60 -> V_72 ) {
V_100 = - V_101 ;
goto V_61;
}
V_60 -> V_69 = F_82 ;
...
static int F_85 ( struct V_99 * V_4 )
{
struct V_59 * V_60 = F_83 ( V_4 ) ;
F_40 ( & V_60 -> V_54 ) ;
V_60 -> V_69 = NULL ;
...
static int F_86 ( struct V_99 * V_4 )
{
struct V_59 * V_60 = F_83 ( V_4 ) ;
unsigned long V_63 ;
F_4 ( ! F_84 ( & V_60 -> V_34 ) ) ;
...
static void F_87 ( struct V_99 * V_4 )
{
struct V_59 * V_60 = F_83 ( V_4 ) ;
unsigned long V_63 ;
F_4 ( ! F_84 ( & V_60 -> V_34 ) ) ;
...
static int F_88 ( struct V_99 * V_4 ,
struct V_102 * V_103 )
{
struct V_59 * V_60 = F_83 ( V_4 ) ;
int V_100 ;
...
V_100 = F_58 ( & V_60 -> V_49 , & V_60 -> V_9 , V_103 ,
V_60 -> V_34 . V_35 . V_38 ) ;
if ( ! V_100 ) {
V_60 -> V_67 = true ;
V_60 -> V_68 = * V_103 ;
...
static int F_89 ( struct V_99 * V_4 )
{
struct V_104 V_105 = {
. V_4 = V_4 ,
. V_106 = F_90 () ,
...
& V_105 , sizeof( V_105 ) ) ;
if ( F_13 ( V_2 . V_109 ) )
return F_14 ( V_2 . V_109 ) ;
return 0 ;
}
static int F_93 ( struct V_99 * V_4 , struct V_99 * V_111 , void * V_7 )
{
struct V_84 * V_3 = F_94 ( V_4 ) ;
int V_1 ;
int V_6 ;
V_2 . V_3 = V_3 ;
F_95 ( & V_3 -> V_4 , & V_2 ) ;
...
static void F_108 ( struct V_99 * V_4 , struct V_99 * V_111 , void * V_7 )
{
struct V_84 * V_3 = F_94 ( V_4 ) ;
if ( V_2 . V_109 )
F_109 ( V_2 . V_109 ) ;
...
static int F_110 ( struct V_84 * V_3 )
{
return F_111 ( & V_3 -> V_4 , & V_113 ) ;
}
static int F_112 ( struct V_84 * V_3 )
{
F_113 ( & V_3 -> V_4 , & V_113 ) ;
return 0 ;
}
static int F_114 ( struct V_99 * V_4 )
{
F_115 () ;
return 0 ;
}
static int F_116 ( struct V_99 * V_4 )
{
int V_1 ;
V_1 = F_117 () ;
if ( V_1 < 0 )
