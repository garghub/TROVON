...
static int F_107 ( unsigned int V_150 )
{
struct V_10 * V_10 ;
unsigned int V_182 ;
F_97 ( & V_183 ) ;
F_90 (cci_pmu, &cci_pmu_list, entry) {
if ( ! F_108 ( V_150 , & V_10 -> V_160 ) )
continue;
V_182 = F_109 ( V_184 , V_150 ) ;
if ( V_182 >= V_185 )
continue;
F_110 ( V_182 , & V_10 -> V_160 ) ;
}
F_72 ( & V_183 ) ;
return 0 ;
}
static inline const struct V_48 * F_111 ( struct V_49 * V_50 )
{
const struct V_186 * V_187 = F_112 ( V_188 ,
V_50 -> V_2 . V_189 ) ;
if ( ! V_187 )
return NULL ;
if ( V_187 -> V_190 )
...
static bool F_113 ( int V_191 , int * V_102 , int V_100 )
{
int V_69 ;
...
static struct V_10 * F_114 ( struct V_49 * V_50 )
{
struct V_10 * V_10 ;
...
V_10 = F_116 ( & V_50 -> V_2 , sizeof( * V_10 ) , V_192 ) ;
if ( ! V_10 )
return F_115 ( - V_193 ) ;
V_10 -> V_36 = V_36 ;
V_10 -> V_102 = F_117 ( & V_50 -> V_2 , F_118 ( V_36 ) ,
sizeof( * V_10 -> V_102 ) , V_192 ) ;
if ( ! V_10 -> V_102 )
return F_115 ( - V_193 ) ;
V_10 -> V_71 . V_76 = F_117 ( & V_50 -> V_2 ,
F_118 ( V_36 ) ,
sizeof( * V_10 -> V_71 . V_76 ) ,
V_192 ) ;
if ( ! V_10 -> V_71 . V_76 )
return F_115 ( - V_193 ) ;
V_10 -> V_71 . V_17 = F_117 ( & V_50 -> V_2 ,
F_89 ( F_118 ( V_36 ) ) ,
...
struct V_194 * V_195 ;
struct V_10 * V_10 ;
int V_69 , V_126 , V_191 ;
V_10 = F_114 ( V_50 ) ;
if ( F_120 ( V_10 ) )
return F_121 ( V_10 ) ;
V_195 = F_122 ( V_50 , V_196 , 0 ) ;
V_10 -> V_84 = F_123 ( & V_50 -> V_2 , V_195 ) ;
if ( F_120 ( V_10 -> V_84 ) )
return - V_193 ;
V_10 -> V_100 = 0 ;
for ( V_69 = 0 ; V_69 < F_118 ( V_10 -> V_36 ) ; V_69 ++ ) {
V_191 = F_124 ( V_50 , V_69 ) ;
if ( V_191 < 0 )
break;
if ( F_113 ( V_191 , V_10 -> V_102 , V_10 -> V_100 ) )
continue;
V_10 -> V_102 [ V_10 -> V_100 ++ ] = V_191 ;
}
if ( V_69 < F_118 ( V_10 -> V_36 ) ) {
F_105 ( & V_50 -> V_2 , L_16 ,
V_69 , F_118 ( V_10 -> V_36 ) ) ;
return - V_144 ;
}
F_125 ( & V_10 -> V_71 . V_122 ) ;
F_126 ( & V_10 -> V_129 ) ;
F_127 ( & V_10 -> V_127 , 0 ) ;
F_110 ( F_128 () , & V_10 -> V_160 ) ;
V_126 = F_104 ( V_10 , V_50 ) ;
if ( V_126 )
return V_126 ;
F_97 ( & V_183 ) ;
F_129 ( & V_10 -> V_197 , & V_198 ) ;
F_72 ( & V_183 ) ;
F_130 ( L_17 , V_10 -> V_36 -> V_163 ) ;
return 0 ;
}
static int F_131 ( struct V_49 * V_50 )
{
if ( ! F_132 () )
return - V_99 ;
return F_133 ( V_50 -> V_2 . V_189 , NULL , NULL , & V_50 -> V_2 ) ;
}
...
static inline void F_137 ( struct V_202 * V_203 , T_3 V_204 , T_6 V_205 )
{
V_203 -> V_203 = V_206 | V_204 ;
V_203 -> V_205 = V_205 ;
}
static inline bool F_138 ( struct V_202 * V_203 )
{
return ! ! ( V_203 -> V_203 & V_206 ) ;
}
static inline bool F_139 ( struct V_202 * V_203 , T_6 V_205 )
{
return V_203 -> V_205 == ( V_205 & V_207 ) ;
}
static int F_140 ( struct V_208 * V_209 , int type )
{
int V_69 ;
bool V_210 ;
struct V_208 * V_211 ;
V_211 = F_141 ( V_209 , L_19 , 0 ) ;
for ( V_69 = 0 ; V_69 < V_212 ; V_69 ++ ) {
V_210 = V_213 [ V_69 ] . type == type ;
if ( V_210 && V_211 == V_213 [ V_69 ] . V_209 )
return V_69 ;
}
return - V_99 ;
}
int F_142 ( struct V_208 * V_209 )
{
return F_140 ( V_209 , V_214 ) ;
}
...
struct V_208 * V_215 ;
F_144 (cpu) {
V_215 = F_145 ( V_150 , NULL ) ;
if ( F_146 ( ! V_215 , L_20 ) )
continue;
V_203 = F_140 ( V_215 , V_216 ) ;
if ( V_203 < 0 )
continue;
F_137 ( & V_202 [ V_150 ] , V_203 , F_147 ( V_150 ) ) ;
}
F_144 (cpu) {
F_146 ( ! F_138 ( & V_202 [ V_150 ] ) ,
L_21 ,
V_150 ) ;
}
}
static void T_10 F_148 ( unsigned int V_203 , bool V_217 )
{
void T_11 * V_84 = V_213 [ V_203 ] . V_84 ;
F_35 ( V_217 ? V_218 : 0 , V_84 + V_219 ) ;
while ( F_10 ( V_41 + V_220 ) & 0x1 )
;
}
int T_10 F_149 ( T_6 V_205 )
{
int V_150 ;
bool V_221 ;
for ( V_150 = 0 ; V_150 < V_185 ; V_150 ++ ) {
V_221 = F_138 ( & V_202 [ V_150 ] ) ;
if ( V_221 && F_139 ( & V_202 [ V_150 ] , V_205 ) ) {
F_148 ( V_202 [ V_150 ] . V_203 , false ) ;
return 0 ;
}
}
return - V_99 ;
}
T_12 void T_13 F_150 ( void )
{
asm volatile ("\n"
" .arch armv7-a\n"
...
int T_10 F_153 ( struct V_208 * V_209 , bool V_217 )
{
int V_203 ;
if ( ! V_209 )
return - V_99 ;
V_203 = F_140 ( V_209 , V_214 ) ;
if ( F_154 ( V_203 < 0 , L_22 ,
V_209 -> V_222 ) )
return - V_99 ;
F_148 ( V_203 , V_217 ) ;
return 0 ;
}
int T_10 F_155 ( T_3 V_203 , bool V_217 )
{
if ( V_203 >= V_212 || V_213 [ V_203 ] . type == V_223 )
return - V_99 ;
if ( V_213 [ V_203 ] . type == V_216 )
return - V_224 ;
F_148 ( V_203 , V_217 ) ;
return 0 ;
}
static int F_156 ( struct V_208 * V_225 )
{
struct V_226 const * V_227 ;
int V_126 , V_69 , V_228 = 0 , V_229 = 0 ;
struct V_208 * V_230 ;
struct V_194 V_195 ;
const char * V_231 ;
bool V_232 ;
V_227 = F_112 ( V_233 , V_225 ) -> V_190 ;
if ( ! V_227 )
return - V_99 ;
V_212 = V_227 -> V_228 + V_227 -> V_229 ;
V_213 = F_157 ( V_212 , sizeof( * V_213 ) , V_192 ) ;
if ( ! V_213 )
return - V_193 ;
F_158 (np, cp) {
if ( ! F_112 ( V_234 , V_230 ) )
continue;
V_69 = V_228 + V_229 ;
if ( V_69 >= V_212 )
break;
...
V_232 = strcmp ( V_231 , L_25 ) == 0 ;
if ( ! V_232 && strcmp ( V_231 , L_26 ) ) {
F_146 ( 1 , L_27 ,
V_230 -> V_222 ) ;
continue;
}
V_126 = F_160 ( V_230 , 0 , & V_195 ) ;
if ( ! V_126 ) {
V_213 [ V_69 ] . V_84 = F_161 ( V_195 . V_176 , F_162 ( & V_195 ) ) ;
V_213 [ V_69 ] . V_235 = V_195 . V_176 ;
}
if ( V_126 || ! V_213 [ V_69 ] . V_84 ) {
F_146 ( 1 , L_28 , V_69 ) ;
continue;
}
if ( V_232 ) {
if ( F_22 ( V_228 >= V_227 -> V_228 ) )
continue;
V_213 [ V_69 ] . type = V_216 ;
++ V_228 ;
} else {
if ( F_22 ( V_229 >= V_227 -> V_229 ) )
continue;
V_213 [ V_69 ] . type = V_214 ;
++ V_229 ;
}
V_213 [ V_69 ] . V_209 = V_230 ;
}
F_143 () ;
F_163 ( & V_41 ) ;
F_163 ( & V_236 ) ;
F_163 ( & V_213 ) ;
F_163 ( & V_202 ) ;
F_164 ( V_213 , sizeof( * V_213 ) * V_212 ) ;
F_130 ( L_29 ) ;
return 0 ;
}
static inline int F_156 ( struct V_208 * V_225 )
{
return 0 ;
}
...
struct V_208 * V_225 ;
struct V_194 V_195 ;
V_225 = F_166 ( NULL , V_233 ) ;
if( ! V_225 || ! F_167 ( V_225 ) )
return - V_99 ;
V_126 = F_160 ( V_225 , 0 , & V_195 ) ;
if ( ! V_126 ) {
V_41 = F_161 ( V_195 . V_176 , F_162 ( & V_195 ) ) ;
V_236 = V_195 . V_176 ;
}
if ( V_126 || ! V_41 ) {
F_146 ( 1 , L_30 ) ;
