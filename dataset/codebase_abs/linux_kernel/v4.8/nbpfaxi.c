...
int V_19 ;
F_117 ( & V_181 -> V_8 , V_11 -> V_191 , V_11 ) ;
for ( V_19 = 0 ; V_19 < V_11 -> V_35 -> V_190 ; V_19 ++ ) {
struct V_1 * V_2 = V_11 -> V_2 + V_19 ;
F_117 ( & V_181 -> V_8 , V_2 -> V_168 , V_2 ) ;
F_118 ( & V_2 -> V_172 ) ;
}
F_119 ( V_181 -> V_8 . V_185 ) ;
F_113 ( & V_11 -> V_12 ) ;
F_114 ( V_11 -> V_197 ) ;
return 0 ;
}
...
{
struct V_10 * V_11 = F_116 ( F_121 ( V_8 ) ) ;
F_114 ( V_11 -> V_197 ) ;
return 0 ;
}
