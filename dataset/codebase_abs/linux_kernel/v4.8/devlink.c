...
if ( ! V_45 || ! V_45 -> V_151 )
return - V_109 ;
V_66 = V_45 -> V_151 ( V_2 , & V_149 ) ;
if ( V_66 )
return V_66 ;
V_56 = F_47 ( V_69 , V_70 ) ;
if ( ! V_56 )
return - V_93 ;
V_66 = F_91 ( V_56 , V_2 , V_152 ,
V_16 -> V_94 , V_16 -> V_95 , 0 , V_149 ) ;
if ( V_66 ) {
F_48 ( V_56 ) ;
return V_66 ;
}
...
if ( ! V_16 -> V_5 [ V_150 ] )
return - V_10 ;
V_149 = F_24 ( V_16 -> V_5 [ V_150 ] ) ;
if ( V_45 && V_45 -> V_153 )
return V_45 -> V_153 ( V_2 , V_149 ) ;
return - V_109 ;
}
struct V_2 * F_94 ( const struct V_130 * V_45 , T_4 V_154 )
{
struct V_2 * V_2 ;
V_2 = F_95 ( sizeof( * V_2 ) + V_154 , V_70 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_45 = V_45 ;
F_3 ( V_2 , & V_155 ) ;
...
int F_97 ( struct V_2 * V_2 , struct V_158 * V_11 )
{
F_34 ( & V_48 ) ;
V_2 -> V_11 = V_11 ;
F_98 ( & V_2 -> V_159 , & V_160 ) ;
F_45 ( V_2 , V_67 ) ;
F_36 ( & V_48 ) ;
return 0 ;
}
void F_99 ( struct V_2 * V_2 )
{
F_34 ( & V_48 ) ;
F_45 ( V_2 , V_68 ) ;
F_100 ( & V_2 -> V_159 ) ;
...
static void F_105 ( struct V_17 * V_17 ,
enum V_106 type ,
void * V_79 )
{
V_17 -> type = type ;
...
void F_107 ( struct V_17 * V_17 ,
struct V_84 * V_85 )
{
return F_105 ( V_17 ,
V_83 , V_85 ) ;
}
void F_108 ( struct V_17 * V_17 )
{
return F_105 ( V_17 ,
V_74 , NULL ) ;
}
void F_109 ( struct V_17 * V_17 ,
T_1 V_89 )
{
V_17 -> V_87 = true ;
V_17 -> V_89 = V_89 ;
...
int F_110 ( struct V_2 * V_2 , unsigned int V_24 ,
T_1 V_115 , T_2 V_22 ,
T_2 V_23 , T_2 V_42 ,
T_2 V_43 )
{
...
V_21 -> V_42 = V_42 ;
V_21 -> V_43 = V_43 ;
F_98 ( & V_21 -> V_159 , & V_2 -> V_157 ) ;
V_162:
F_36 ( & V_48 ) ;
return V_66 ;
}
void F_111 ( struct V_2 * V_2 , unsigned int V_24 )
{
struct V_21 * V_21 ;
F_34 ( & V_48 ) ;
V_21 = F_19 ( V_2 , V_24 ) ;
