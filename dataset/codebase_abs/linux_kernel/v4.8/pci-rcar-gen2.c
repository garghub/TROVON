...
struct V_80 * V_81 )
{
const int V_82 = 3 , V_83 = 2 ;
int V_84 ;
V_79 -> V_81 = V_81 ;
V_79 -> V_85 = F_21 ( V_81 ) ;
V_79 -> V_86 = V_79 -> V_85 + V_82 + V_83 ;
V_79 -> V_87 = F_22 ( V_81 , L_6 , & V_84 ) ;
if ( ! V_79 -> V_87 )
return - V_88 ;
V_79 -> V_89 = V_79 -> V_87 + V_84 / sizeof( V_90 ) ;
return 0 ;
}
static int F_23 ( struct V_8 * V_91 ,
struct V_80 * V_86 )
{
struct V_92 V_87 ;
struct V_78 V_79 ;
...
if ( V_93 )
return - V_94 ;
V_91 -> V_56 = ( unsigned long ) V_87 . V_95 ;
V_91 -> V_63 = ( unsigned long ) V_87 . V_96 ;
V_91 -> V_41 = ( unsigned long ) V_87 . V_97 ;
if ( ! ( V_87 . V_98 & V_99 ) ) {
F_9 ( V_91 -> V_21 , L_7 ) ;
return - V_94 ;
}
if ( V_91 -> V_56 ) {
T_4 V_100 = 1 << ( F_25 ( V_91 -> V_56 ) - 1 ) ;
if ( V_100 < V_91 -> V_41 ) {
F_9 ( V_91 -> V_21 , L_8 ) ;
return - V_94 ;
}
...
{
struct V_103 * V_66 , * V_59 ;
struct V_8 * V_9 ;
void T_1 * V_18 ;
struct V_104 V_105 ;
void * V_106 [ 1 ] ;
V_66 = F_27 ( V_102 , V_107 , 0 ) ;
V_18 = F_28 ( & V_102 -> V_21 , V_66 ) ;
if ( F_29 ( V_18 ) )
return F_30 ( V_18 ) ;
V_59 = F_27 ( V_102 , V_107 , 1 ) ;
if ( ! V_59 || ! V_59 -> V_60 )
return - V_108 ;
if ( V_59 -> V_60 & 0xFFFF )
return - V_94 ;
V_9 = F_31 ( & V_102 -> V_21 ,
sizeof( struct V_8 ) , V_109 ) ;
if ( ! V_9 )
return - V_110 ;
V_9 -> V_59 = * V_59 ;
V_9 -> V_66 = V_66 ;
V_9 -> V_23 = F_32 ( V_102 , 0 ) ;
V_9 -> V_18 = V_18 ;
V_9 -> V_21 = & V_102 -> V_21 ;
if ( V_9 -> V_23 < 0 ) {
F_9 ( & V_102 -> V_21 , L_9 ) ;
...
struct V_103 V_13 ;
int V_30 ;
V_30 = F_33 ( V_102 -> V_21 . V_111 , & V_13 ) ;
if ( V_30 < 0 ) {
F_9 ( & V_102 -> V_21 , L_10 ) ;
return V_30 ;
}
V_9 -> V_13 = V_13 . V_60 ;
if ( V_13 . V_89 != V_13 . V_60 )
F_34 ( & V_102 -> V_21 , L_11 ) ;
V_30 = F_23 ( V_9 , V_102 -> V_21 . V_111 ) ;
if ( V_30 < 0 ) {
F_9 ( & V_102 -> V_21 , L_12 ) ;
return V_30 ;
}
} else {
V_9 -> V_13 = V_102 -> V_112 ;
}
V_106 [ 0 ] = V_9 ;
memset ( & V_105 , 0 , sizeof( V_105 ) ) ;
V_105 . V_113 = F_35 ( V_106 ) ;
V_105 . V_114 = 1 ;
V_105 . V_10 = V_106 ;
V_105 . V_115 = F_5 ;
V_105 . V_116 = & V_117 ;
V_105 . V_118 = F_12 ;
F_36 ( & V_102 -> V_21 , & V_105 ) ;
return 0 ;
}
