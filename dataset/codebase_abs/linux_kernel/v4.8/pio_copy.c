...
static inline void F_10 ( struct V_3 * V_4 , unsigned int V_30 )
{
unsigned int V_31 ;
if ( V_30 == 0 )
return;
...
T_1 V_33 , V_34 ;
V_33 = * ( T_1 * ) V_32 ;
V_34 = V_4 -> V_26 . V_18 | ( V_33 << F_9 ( V_4 -> V_27 ) ) ;
F_2 ( V_34 , V_8 ) ;
V_4 -> V_26 . V_18 = V_33 >> F_6 ( V_4 -> V_27 ) ;
}
static inline void F_12 ( union V_16 V_26 , void T_3 * V_8 )
{
F_2 ( V_26 . V_18 , V_8 ) ;
}
static inline int F_13 ( struct V_3 * V_4 , void T_3 * V_8 )
{
if ( V_4 -> V_27 ) {
...
static inline void F_14 ( T_4 * V_8 , const T_4 * V_32 , V_20 V_35 )
{
switch ( V_35 ) {
case 7 :
* V_8 ++ = * V_32 ++ ;
...
unsigned int V_24 )
{
F_14 ( & V_4 -> V_26 . V_36 [ 0 ] , V_6 , V_24 ) ;
V_4 -> V_27 = V_24 ;
}
static inline void F_7 ( struct V_3 * V_4 ,
const void * V_6 , unsigned int V_24 )
{
F_14 ( & V_4 -> V_26 . V_36 [ V_4 -> V_27 ] , V_6 , V_24 ) ;
V_4 -> V_27 += V_24 ;
}
static inline void F_10 ( struct V_3 * V_4 , unsigned int V_30 )
{
...
F_14 ( & V_4 -> V_26 . V_36 [ V_4 -> V_27 ] , V_32 , V_37 ) ;
F_2 ( V_4 -> V_26 . V_18 , V_8 ) ;
F_14 ( & V_4 -> V_26 . V_36 [ 0 ] , V_32 + V_37 , V_4 -> V_27 ) ;
}
static inline void F_12 ( union V_16 V_26 , void * V_8 )
{
F_2 ( V_26 . V_18 , V_8 ) ;
}
static inline int F_13 ( struct V_3 * V_4 , void * V_8 )
{
if ( V_4 -> V_27 ) {
T_1 V_38 = 0 ;
F_14 ( & V_4 -> V_26 . V_36 [ V_4 -> V_27 ] , ( T_4 * ) & V_38 ,
8 - V_4 -> V_27 ) ;
F_2 ( V_4 -> V_26 . V_18 , V_8 ) ;
return 1 ;
}
...
static void F_16 ( struct V_3 * V_4 , const void * V_6 , T_2 V_24 )
{
...
void F_18 ( struct V_3 * V_4 , const void * V_6 , T_2 V_24 )
{
