...
static void F_66 ( struct V_1 * V_1 , T_1 V_166 )
{
struct V_18 * V_18 = (struct V_18 * ) V_1 ;
T_3 V_167 = F_58 ( V_18 -> V_125 ) ;
T_3 V_168 = V_18 -> V_125 -> V_169 - V_18 -> V_110 ;
T_3 V_170 = V_18 -> V_125 -> V_171 + V_18 -> V_110 ;
T_5 V_172 ;
if ( V_166 < V_173 ) {
if ( V_167 > V_168 )
return;
V_172 = V_167 + V_18 -> V_110 ;
if ( V_172 > V_168 )
V_172 = V_168 ;
if ( V_172 < V_170 )
V_172 = V_170 ;
F_67 ( V_18 -> V_125 , V_172 ) ;
...
static void F_68 ( struct V_1 * V_1 , T_1 V_166 )
{
struct V_18 * V_18 = (struct V_18 * ) V_1 ;
T_3 V_175 = F_58 ( V_18 -> V_81 ) ;
if ( V_166 < V_173 && V_175 < V_18 -> V_81 -> V_169 )
F_67 ( V_18 -> V_81 , V_175 + 1 ) ;
if ( V_166 > V_174 && V_175 > V_18 -> V_81 -> V_171 )
F_67 ( V_18 -> V_81 , V_175 - 1 ) ;
}
...
return;
V_166 = F_70 ( & V_18 -> V_166 ) ;
if ( V_18 -> V_36 == V_82 )
F_68 ( V_1 , V_166 ) ;
else
F_66 ( V_1 , V_166 ) ;
}
static void V_112 ( struct V_176 * V_111 )
{
struct V_18 * V_18 = F_45 ( V_111 , struct V_18 , V_111 ) ;
struct V_1 * V_1 = & V_18 -> V_1 ;
T_3 V_177 = F_58 ( V_18 -> V_138 ) ;
F_65 ( & V_1 -> V_165 ) ;
F_71 ( V_178 , L_43 , V_177 ) ;
V_1 -> V_7 = 0 ;
F_36 ( V_1 , V_177 ) ;
F_63 ( & V_1 -> V_165 ) ;
}
...
{
struct V_18 * V_18 = (struct V_18 * ) V_1 ;
if ( ! ( V_18 -> V_66 & V_181 ) && V_180 == 1 ) {
F_73 ( V_1 -> V_182 , V_183 , 1 ) ;
F_74 ( V_1 -> V_182 ) ;
F_73 ( V_1 -> V_182 , V_183 , 0 ) ;
F_74 ( V_1 -> V_182 ) ;
return 0 ;
}
return - V_95 ;
...
V_185 = ( V_18 -> V_162 * 100 ) /
( V_18 -> V_163 *
V_1 -> V_188 [ 0 ] -> V_189 [ 0 ] . V_3 ) ;
if ( V_185 >= 85 )
V_184 = - 3 ;
else if ( V_185 < 75 )
V_184 = 2 ;
...
T_3 V_190 = V_18 -> V_138 -> V_191 . V_17 ;
V_18 -> V_164 = 0 ;
V_184 += V_190 ;
if ( V_184 < V_18 -> V_138 -> V_171 )
V_184 = V_18 -> V_138 -> V_171 ;
else if ( V_184 > V_18 -> V_138 -> V_169 )
V_184 = V_18 -> V_138 -> V_169 ;
if ( V_184 != V_190 ) {
V_18 -> V_138 -> V_191 . V_17 = V_184 ;
F_76 ( & V_18 -> V_111 ) ;
}
}
} else {
...
struct V_18 * V_18 = (struct V_18 * ) V_1 ;
int V_166 , V_192 ;
static const T_2 V_193 [] = {
0xff , 0xff , 0x00 , 0xc4 , 0xc4 , 0x96
} ;
V_192 = ( V_18 -> V_88 & 0x03 ) == 0 ;
if ( V_180 >= 64 && memcmp ( V_179 , V_193 , 6 ) == 0 ) {
V_166 = ( ( V_179 [ 35 ] >> 2 ) & 3 ) |
( V_179 [ 20 ] << 2 ) |
( V_179 [ 19 ] << 10 ) ;
V_166 += ( ( V_179 [ 35 ] >> 4 ) & 3 ) |
...
( V_179 [ 33 ] << 10 ) ;
V_166 >>= 9 ;
F_78 ( & V_18 -> V_166 , V_166 ) ;
if ( V_192 )
F_75 ( V_1 , V_179 ) ;
F_79 ( V_1 , V_194 , NULL , 0 ) ;
V_180 -= 64 ;
if ( V_180 == 0 )
return;
V_179 += 64 ;
...
F_79 ( V_1 , V_197 , V_179 , V_180 ) ;
}
}
static int F_80 ( struct V_144 * V_145 ,
const struct V_99 * V_26 )
{
return F_81 ( V_145 , V_26 , & V_198 , sizeof( struct V_18 ) ,
V_199 ) ;
}
