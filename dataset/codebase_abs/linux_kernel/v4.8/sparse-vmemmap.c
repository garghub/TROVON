...
T_6 * T_2 F_41 ( unsigned long V_35 , int V_1 )
{
T_6 * V_42 = F_42 ( V_35 ) ;
if ( F_43 ( * V_42 ) ) {
void * V_37 = F_3 ( V_38 , V_1 ) ;
...
struct V_6 * T_2 F_46 ( unsigned long V_44 , int V_45 )
{
unsigned long V_30 ;
unsigned long V_31 ;
struct V_6 * V_46 ;
V_46 = F_47 ( V_44 * V_47 ) ;
V_30 = ( unsigned long ) V_46 ;
V_31 = ( unsigned long ) ( V_46 + V_47 ) ;
if ( F_48 ( V_30 , V_31 , V_45 ) )
return NULL ;
return V_46 ;
}
void T_7 F_49 ( struct V_6 * * V_48 ,
unsigned long V_49 ,
unsigned long V_50 ,
