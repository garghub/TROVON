...
V_64 ) )
F_32 ( V_30 -> V_55 , V_58 -> V_65 ) ;
V_61 = F_33 ( V_8 ( V_7 ) , V_16 ) ;
if ( V_61 < 0 )
return V_61 ;
V_61 = F_34 ( V_8 ( V_7 ) ) ;
if ( V_61 < 0 )
...
V_73 = V_8 ( V_7 ) -> V_48 - 1 ;
F_16 ( V_25 -> V_27 , L_5 , V_73 ) ;
V_70 . V_74 = F_37 ( F_38 ( V_68 ) ) ;
V_70 . V_75 = F_39 ( V_68 ) ;
V_70 . V_76 = F_40 ( V_68 ) ;
V_70 . V_77 = V_73 ;
V_70 . V_7 = V_3 -> V_7 ;
V_71 = F_30 ( V_25 , V_70 . V_7 ) ;
if ( V_71 )
F_41 ( V_25 -> V_27 , V_71 , & V_70 ) ;
return 0 ;
}
...
static int F_99 ( struct V_150 * V_151 )
{
struct V_6 * V_12 = F_13 ( V_151 -> V_27 ) ;
struct V_30 * V_30 = F_14 ( V_12 ) ;
int V_72 ;
if ( V_12 -> V_21 ) {
V_72 = F_100 ( V_151 , V_12 ) ;
if ( V_72 < 0 ) {
F_98 ( V_151 -> V_27 , L_11 ) ;
return V_72 ;
}
V_30 -> V_151 = V_151 ;
}
...
int F_101 ( struct V_152 * V_27 )
{
int V_72 ;
struct V_6 * V_12 = F_13 ( V_27 ) ;
struct V_30 * V_30 = F_14 ( V_12 ) ;
F_102 ( & V_30 -> V_153 ) ;
V_72 = F_103 ( V_27 , & V_154 ) ;
if ( V_72 ) {
F_98 ( V_27 , L_12 , V_72 ) ;
return V_72 ;
}
V_72 = F_104 ( V_27 , & V_155 ,
V_156 ,
F_105 ( V_156 ) ) ;
if ( V_72 ) {
F_98 ( V_27 , L_13 , V_72 ) ;
