...
if ( ! V_26 )
return - V_165 ;
memcpy ( V_26 , V_157 -> V_166 , sizeof( * V_26 ) ) ;
if ( ! F_72 ( V_161 , L_5 , & V_19 ) )
V_26 -> V_19 = V_19 ;
if ( V_163 )
V_26 -> V_167 = V_163 -> V_167 ;
} else if ( ! V_26 ) {
F_67 ( & V_154 -> V_134 , L_6 ) ;
return - V_41 ;
}
V_10 = F_71 ( & V_154 -> V_134 , sizeof( struct V_9 ) , V_164 ) ;
if ( ! V_10 )
return - V_165 ;
V_10 -> V_168 = V_154 -> V_168 ;
V_10 -> V_26 = V_26 ;
...
if ( V_10 -> V_26 -> V_171 && V_10 -> V_26 -> V_171 -> free )
V_10 -> V_26 -> V_171 -> free ( V_10 -> V_168 ) ;
F_79 ( V_10 ) ;
F_80 ( V_10 -> V_172 ) ;
return 0 ;
}
