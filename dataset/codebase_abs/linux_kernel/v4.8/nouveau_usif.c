...
struct V_1 * V_7 ;
int V_44 = - V_45 ;
if ( ! ( V_44 = F_14 ( V_44 , & V_11 , & V_12 , args -> V_14 , 0 , 0 , true ) ) ) {
...
V_43 = V_11 ;
V_44 = - V_45 ;
if ( ! ( V_7 = F_15 ( sizeof( * V_7 ) , V_48 ) ) )
return - V_49 ;
F_12 ( & V_7 -> V_35 , 0 ) ;
if ( ! ( V_44 = F_14 ( V_44 , & V_11 , & V_12 , V_43 -> V_14 , 0 , 0 , true ) ) ) {
...
if ( F_20 ( & V_7 -> V_35 , 1 ) )
return 0 ;
V_7 -> V_24 = F_15 ( sizeof( * V_7 -> V_24 ) + V_7 -> V_25 , V_48 ) ;
...
struct V_59 * V_60 ;
int V_44 = - V_45 ;
if ( ! ( V_60 = F_15 ( sizeof( * V_60 ) , V_48 ) ) )
return - V_49 ;
F_17 ( & V_60 -> V_8 , & V_6 -> V_62 ) ;
if ( ! ( V_44 = F_14 ( V_44 , & V_11 , & V_12 , args -> V_14 , 0 , 0 , true ) ) ) {
...
int
F_24 ( struct V_2 * V_3 , void T_2 * V_64 , T_1 V_38 )
{
struct V_5 * V_6 = V_5 ( V_3 ) ;
struct V_39 * V_40 = & V_6 -> V_26 ;
void * V_11 = F_15 ( V_38 , V_48 ) ;
T_1 V_12 = V_38 ;
union {
struct V_65 V_14 ;
} * V_37 = V_11 ;
...
if ( V_44 = - V_49 , ! V_37 )
goto V_53;
if ( V_44 = - V_67 , F_25 ( V_37 , V_64 , V_12 ) )
goto V_53;
if ( ! ( V_44 = F_14 ( - V_45 , & V_11 , & V_12 , V_37 -> V_14 , 0 , 0 , true ) ) ) {
V_66 = V_37 -> V_14 . V_66 ;
...
F_26 ( & V_6 -> V_69 ) ;
if ( V_37 -> V_14 . V_22 ) {
if ( V_44 = - V_70 , V_37 -> V_14 . V_22 == 0xff )
