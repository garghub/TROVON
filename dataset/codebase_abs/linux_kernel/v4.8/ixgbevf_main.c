...
F_166 ( V_2 ) ;
V_264 = V_10 -> V_194 . V_266 . V_267 ( V_10 , V_40 -> V_268 + V_269 + V_270 ) ;
if ( V_264 )
F_10 ( & V_2 -> V_13 -> V_14 ,
L_22 , V_40 -> V_268 ) ;
...
int V_212 ;
F_180 ( & V_2 -> V_272 ) ;
V_212 = V_10 -> V_194 . V_266 . V_273 ( V_10 , V_105 , 0 , true ) ;
F_181 ( & V_2 -> V_272 ) ;
if ( V_212 == V_274 )
return - V_275 ;
if ( V_212 == V_276 )
...
int V_212 ;
F_180 ( & V_2 -> V_272 ) ;
V_212 = V_10 -> V_194 . V_266 . V_273 ( V_10 , V_105 , 0 , false ) ;
F_181 ( & V_2 -> V_272 ) ;
F_8 ( V_105 , V_2 -> V_108 ) ;
return V_212 ;
}
...
struct V_279 * V_280 ;
F_188 (ha, netdev) {
V_10 -> V_194 . V_266 . V_281 ( V_10 , ++ V_44 , V_280 -> V_282 ) ;
F_164 ( 200 ) ;
}
} else {
V_10 -> V_194 . V_266 . V_281 ( V_10 , 0 , NULL ) ;
}
return V_44 ;
}
...
V_289 : V_290 ;
F_180 ( & V_2 -> V_272 ) ;
V_10 -> V_194 . V_266 . V_291 ( V_10 , V_284 ) ;
V_10 -> V_194 . V_266 . V_292 ( V_10 , V_40 ) ;
F_185 ( V_40 ) ;
F_181 ( & V_2 -> V_272 ) ;
}
...
V_212 = V_10 -> V_194 . V_266 . V_332 ( V_10 , V_326 [ V_331 ] ) ;
if ( ! V_212 )
break;
V_331 ++ ;
}
...
V_10 -> V_194 . V_266 . V_333 ( V_10 , 0 , V_10 -> V_194 . V_282 , 0 ) ;
else
V_10 -> V_194 . V_266 . V_333 ( V_10 , 0 , V_10 -> V_194 . V_334 , 0 ) ;
F_181 ( & V_2 -> V_272 ) ;
F_7 () ;
F_8 ( V_3 , & V_2 -> V_4 ) ;
F_190 ( V_2 ) ;
...
struct V_9 * V_10 = & V_2 -> V_10 ;
struct V_51 * V_40 = V_2 -> V_40 ;
if ( V_10 -> V_194 . V_266 . V_340 ( V_10 ) ) {
F_139 ( V_10 , L_25 ) ;
} else {
V_10 -> V_194 . V_266 . V_341 ( V_10 ) ;
F_202 ( V_2 ) ;
}
...
V_10 -> V_296 . V_266 . V_369 ( V_10 ) ;
V_10 -> V_194 . V_370 = 2 ;
V_10 -> V_194 . V_371 = 2 ;
F_247 ( & V_2 -> V_272 ) ;
V_212 = V_10 -> V_194 . V_266 . V_340 ( V_10 ) ;
if ( V_212 ) {
F_248 ( & V_13 -> V_14 ,
L_33 ) ;
} else {
V_212 = V_10 -> V_194 . V_266 . V_341 ( V_10 ) ;
if ( V_212 ) {
F_48 ( L_34 , V_212 ) ;
goto V_372;
}
F_202 ( V_2 ) ;
V_212 = V_10 -> V_194 . V_266 . V_373 ( V_10 , V_10 -> V_194 . V_282 ) ;
if ( V_212 )
...
T_10 V_212 ;
F_180 ( & V_2 -> V_272 ) ;
V_212 = V_10 -> V_194 . V_266 . V_384 ( V_10 , & V_382 , & V_383 , false ) ;
F_181 ( & V_2 -> V_272 ) ;
...
V_413 . V_409 -> V_422 = F_291 ( F_292 ( F_293 ( V_32 ) ,
F_294 ( V_416 . V_415 -> V_422 ) ) ) ;
V_398 |= V_423 ;
V_413 . V_409 -> V_424 = 0 ;
V_406 -> V_425 |= V_426 |
V_427 |
...
* V_407 = ( V_416 . V_415 -> V_430 * 4 ) + V_418 ;
V_417 = V_32 -> V_33 - V_418 ;
F_295 ( & V_416 . V_415 -> V_422 , F_296 ( V_417 ) ) ;
V_406 -> V_68 = F_100 ( V_32 ) -> V_68 ;
V_406 -> V_67 += ( V_406 -> V_68 - 1 ) * * V_407 ;
V_399 = ( * V_407 - V_418 ) << V_431 ;
V_399 |= F_100 ( V_32 ) -> V_432 << V_433 ;
V_399 |= ( 1u << V_434 ) ;
V_397 = V_416 . V_412 - V_413 . V_412 ;
V_397 |= ( V_413 . V_412 - V_32 -> V_146 ) << V_435 ;
V_397 |= V_406 -> V_425 & V_436 ;
F_284 ( V_29 , V_397 ,
V_398 , V_399 ) ;
return 1 ;
}
...
F_298 ( V_32 , & V_437 , V_438 , NULL , NULL ) ;
return V_437 == F_299 ( V_32 ) ;
}
...
goto V_439;
switch ( V_32 -> V_440 ) {
case F_301 ( struct V_414 , V_422 ) :
V_398 = V_420 ;
case F_301 ( struct V_441 , V_422 ) :
break;
case F_301 ( struct V_442 , V_443 ) :
if ( ( ( V_406 -> V_111 == F_71 ( V_444 ) ) &&
( F_302 ( V_32 ) -> V_111 == V_438 ) ) ||
( ( V_406 -> V_111 == F_71 ( V_445 ) ) &&
F_297 ( V_32 ) ) ) {
V_398 = V_446 ;
break;
}
...
F_304 ( V_32 ) ;
V_439:
V_397 |= F_304 ( V_32 ) << V_435 ;
V_397 |= V_406 -> V_425 & V_436 ;
F_284 ( V_29 , V_397 , V_398 , 0 ) ;
}
static T_11 F_305 ( T_1 V_425 )
{
T_11 V_447 = F_41 ( V_448 |
V_449 |
V_450 ) ;
if ( V_425 & V_451 )
V_447 |= F_41 ( V_452 ) ;
...
T_1 V_425 , unsigned int V_417 )
{
T_11 V_454 = F_41 ( V_417 << V_455 ) ;
if ( V_425 & V_427 )
V_454 |= F_41 ( V_456 ) ;
if ( V_425 & V_428 )
V_454 |= F_41 ( V_457 ) ;
...
struct V_30 * V_31 ;
union V_55 * V_56 ;
struct V_459 * V_460 = & F_100 ( V_32 ) -> V_461 [ 0 ] ;
unsigned int V_462 = V_32 -> V_462 ;
unsigned int V_136 = F_308 ( V_32 ) ;
unsigned int V_417 = V_32 -> V_33 - V_407 ;
T_1 V_425 = V_406 -> V_425 ;
T_11 V_447 ;
T_6 V_60 = V_29 -> V_73 ;
V_56 = F_39 ( V_29 , V_60 ) ;
F_306 ( V_56 , V_425 , V_417 ) ;
V_447 = F_305 ( V_425 ) ;
V_34 = F_309 ( V_29 -> V_14 , V_32 -> V_146 , V_136 , V_35 ) ;
if ( F_78 ( V_29 -> V_14 , V_34 ) )
goto V_463;
F_27 ( V_406 , V_33 , V_136 ) ;
F_310 ( V_406 , V_34 , V_34 ) ;
V_56 -> V_124 . V_464 = F_81 ( V_34 ) ;
for (; ; ) {
while ( F_16 ( V_136 > V_465 ) ) {
V_56 -> V_124 . V_466 =
V_447 | F_41 ( V_465 ) ;
V_60 ++ ;
V_56 ++ ;
...
if ( F_44 ( ! V_462 ) )
break;
V_56 -> V_124 . V_466 = V_447 | F_41 ( V_136 ) ;
V_60 ++ ;
V_56 ++ ;
if ( V_60 == V_29 -> V_44 ) {
V_56 = F_39 ( V_29 , 0 ) ;
...
V_136 = F_311 ( V_460 ) ;
V_462 -= V_136 ;
V_34 = F_312 ( V_29 -> V_14 , V_460 , 0 , V_136 ,
V_35 ) ;
if ( F_78 ( V_29 -> V_14 , V_34 ) )
goto V_463;
V_31 = & V_29 -> V_62 [ V_60 ] ;
...
V_447 |= F_41 ( V_136 ) | F_41 ( V_467 ) ;
V_56 -> V_124 . V_466 = V_447 ;
V_406 -> V_74 = V_75 ;
F_82 () ;
V_406 -> V_36 = V_56 ;
V_60 ++ ;
...
#endif
T_2 V_407 = 0 ;
T_2 * V_470 = F_318 ( V_32 , 0 , 0 , NULL ) ;
if ( ! V_470 || F_319 ( V_470 ) ) {
F_22 ( V_32 ) ;
return V_471 ;
}
V_29 = V_2 -> V_29 [ V_32 -> V_472 ] ;
#if V_118 > V_465
for ( V_469 = 0 ; V_469 < F_100 ( V_32 ) -> V_143 ; V_469 ++ )
V_44 += F_317 ( F_100 ( V_32 ) -> V_461 [ V_469 ] . V_136 ) ;
#else
...
V_406 -> V_425 = V_425 ;
V_406 -> V_111 = F_322 ( V_32 ) ;
V_468 = F_286 ( V_29 , V_406 , & V_407 ) ;
if ( V_468 < 0 )
goto V_476;
else if ( ! V_468 )
F_300 ( V_29 , V_406 ) ;
F_307 ( V_29 , V_406 , V_407 ) ;
F_315 ( V_29 , V_477 ) ;
return V_471 ;
V_476:
F_22 ( V_406 -> V_32 ) ;
...
static int F_323 ( struct V_51 * V_40 , void * V_478 )
{
struct V_1 * V_2 = F_30 ( V_40 ) ;
struct V_9 * V_10 = & V_2 -> V_10 ;
struct V_479 * V_282 = V_478 ;
int V_212 ;
if ( ! F_204 ( V_282 -> V_480 ) )
return - V_481 ;
F_180 ( & V_2 -> V_272 ) ;
V_212 = V_10 -> V_194 . V_266 . V_333 ( V_10 , 0 , V_282 -> V_480 , 0 ) ;
F_181 ( & V_2 -> V_272 ) ;
if ( V_212 )
return - V_482 ;
F_224 ( V_10 -> V_194 . V_282 , V_282 -> V_480 ) ;
F_224 ( V_40 -> V_156 , V_282 -> V_480 ) ;
return 0 ;
}
static int F_324 ( struct V_51 * V_40 , int V_483 )
{
struct V_1 * V_2 = F_30 ( V_40 ) ;
struct V_9 * V_10 = & V_2 -> V_10 ;
int V_484 = V_483 + V_269 + V_270 ;
int V_485 = V_486 ;
int V_264 ;
...
break;
default:
if ( V_2 -> V_10 . V_194 . type != V_488 )
V_485 = V_487 ;
break;
}
if ( ( V_483 < 68 ) || ( V_484 > V_485 ) )
return - V_489 ;
V_264 = V_10 -> V_194 . V_266 . V_267 ( V_10 , V_484 ) ;
if ( V_264 )
return - V_489 ;
F_139 ( V_10 , L_50 ,
V_40 -> V_268 , V_483 ) ;
...
static int F_326 ( struct V_359 * V_13 , T_12 V_4 )
{
...
return V_490 ;
#endif
if ( ! F_3 ( V_491 , & V_2 -> V_4 ) )
F_331 ( V_13 ) ;
return 0 ;
}
static int F_332 ( struct V_359 * V_13 )
{
struct V_51 * V_40 = F_327 ( V_13 ) ;
struct V_1 * V_2 = F_30 ( V_40 ) ;
T_1 V_212 ;
...
static void F_337 ( struct V_359 * V_13 )
{
F_326 ( V_13 , V_492 ) ;
}
static struct V_493 * F_338 ( struct V_51 * V_40 ,
struct V_493 * V_38 )
{
struct V_1 * V_2 = F_30 ( V_40 ) ;
unsigned int V_494 ;
...
int V_60 ;
F_251 ( V_2 ) ;
V_38 -> V_495 = V_2 -> V_38 . V_312 - V_2 -> V_38 . V_313 ;
for ( V_60 = 0 ; V_60 < V_2 -> V_205 ; V_60 ++ ) {
V_37 = V_2 -> V_103 [ V_60 ] ;
do {
V_494 = F_339 ( & V_37 -> V_69 ) ;
V_70 = V_37 -> V_38 . V_70 ;
V_39 = V_37 -> V_38 . V_39 ;
} while ( F_340 ( & V_37 -> V_69 , V_494 ) );
V_38 -> V_496 += V_70 ;
V_38 -> V_497 += V_39 ;
}
for ( V_60 = 0 ; V_60 < V_2 -> V_207 ; V_60 ++ ) {
...
V_506 |
V_507 ) ;
V_500 = F_290 ( V_32 ) - F_289 ( V_32 ) ;
if ( F_16 ( V_500 > V_508 ) )
return V_82 & ~ ( V_503 |
V_504 |
V_506 |
V_507 ) ;
if ( V_32 -> V_509 && ! ( V_82 & V_510 ) )
V_82 &= ~ V_506 ;
return V_82 ;
}
...
static int F_344 ( struct V_359 * V_13 , const struct V_514 * V_515 )
{
struct V_51 * V_40 ;
struct V_1 * V_2 = NULL ;
struct V_9 * V_10 = NULL ;
const struct V_516 * V_517 = V_518 [ V_515 -> V_519 ] ;
int V_212 , V_520 ;
bool V_521 = false ;
V_212 = F_345 ( V_13 ) ;
if ( V_212 )
...
F_342 ( V_40 ) ;
memcpy ( & V_10 -> V_194 . V_266 , V_517 -> V_531 , sizeof( V_10 -> V_194 . V_266 ) ) ;
V_10 -> V_194 . type = V_517 -> V_194 ;
memcpy ( & V_10 -> V_296 . V_266 , & V_532 ,
sizeof( struct V_533 ) ) ;
V_212 = F_246 ( V_2 ) ;
if ( V_212 )
goto V_534;
...
V_40 -> V_535 |= V_538 |
F_354 ;
V_40 -> V_82 = V_40 -> V_535 ;
if ( V_520 )
V_40 -> V_82 |= V_539 ;
V_40 -> V_540 |= V_40 -> V_82 | V_510 ;
V_40 -> V_541 |= V_503 ;
V_40 -> V_542 |= V_40 -> V_540 ;
V_40 -> V_82 |= V_543 |
V_544 |
V_505 ;
V_40 -> V_545 |= V_546 ;
...
static void F_362 ( struct V_359 * V_13 )
{
struct V_51 * V_40 = F_327 ( V_13 ) ;
struct V_1 * V_2 ;
bool V_521 ;
...
static T_14 F_365 ( struct V_359 * V_13 ,
T_15 V_4 )
{
struct V_51 * V_40 = F_327 ( V_13 ) ;
struct V_1 * V_2 = F_30 ( V_40 ) ;
...
static T_14 F_366 ( struct V_359 * V_13 )
{
struct V_51 * V_40 = F_327 ( V_13 ) ;
struct V_1 * V_2 = F_30 ( V_40 ) ;
if ( F_334 ( V_13 ) ) {
...
static void F_367 ( struct V_359 * V_13 )
{
struct V_51 * V_40 = F_327 ( V_13 ) ;
struct V_1 * V_2 = F_30 ( V_40 ) ;
if ( F_283 ( V_40 ) )
