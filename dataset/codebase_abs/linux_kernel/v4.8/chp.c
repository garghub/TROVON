...
V_27 -> V_2 = V_2 ;
V_27 -> V_4 = 1 ;
V_27 -> V_42 . V_43 = & V_65 [ V_2 . V_16 ] -> V_28 ;
V_27 -> V_42 . V_66 = V_67 ;
V_27 -> V_42 . V_68 = F_35 ;
F_43 ( & V_27 -> V_49 ) ;
V_46 = F_37 ( V_27 ) ;
...
F_44 ( & V_27 -> V_42 , L_15 , V_2 . V_16 , V_2 . V_10 ) ;
V_46 = F_45 ( & V_27 -> V_42 ) ;
if ( V_46 ) {
F_46 ( 0 , L_16 ,
...
F_22 ( & V_65 [ V_2 . V_16 ] -> V_71 ) ;
if ( V_65 [ V_2 . V_16 ] -> V_72 ) {
V_46 = F_19 ( V_27 ) ;
if ( V_46 ) {
F_48 ( & V_27 -> V_42 ) ;
F_23 ( & V_65 [ V_2 . V_16 ] -> V_71 ) ;
goto V_70;
}
}
V_65 [ V_2 . V_16 ] -> V_73 [ V_2 . V_10 ] = V_27 ;
F_23 ( & V_65 [ V_2 . V_16 ] -> V_71 ) ;
goto V_70;
V_69:
F_36 ( V_27 ) ;
...
struct V_74 * F_49 ( struct V_1 V_2 )
{
struct V_26 * V_27 ;
struct V_74 * V_57 ;
V_27 = F_2 ( V_2 ) ;
if ( ! V_27 )
return NULL ;
V_57 = F_50 ( sizeof( struct V_74 ) , V_63 ) ;
if ( ! V_57 )
return NULL ;
F_22 ( & V_27 -> V_49 ) ;
memcpy ( V_57 , & V_27 -> V_57 , sizeof( struct V_74 ) ) ;
F_23 ( & V_27 -> V_49 ) ;
return V_57 ;
}
static void F_51 ( struct V_75 * V_76 , struct V_75 * V_77 ,
int V_78 )
{
struct V_1 V_2 ;
if ( V_78 ) {
...
int F_56 ( struct V_89 * V_90 , struct V_91 * V_92 )
{
int V_9 ;
int V_93 ;
for ( V_9 = 0 ; V_9 < 8 ; V_9 ++ ) {
...
V_104 = F_58 ( V_2 ) ;
F_22 ( & V_99 ) ;
if ( ! F_63 ( V_102 . V_105 , V_104 ) )
V_59 = V_106 ;
else if ( F_63 ( V_102 . V_107 , V_104 ) )
V_59 = V_108 ;
else if ( F_63 ( V_102 . V_109 , V_104 ) )
V_59 = V_110 ;
else
V_59 = V_111 ;
F_23 ( & V_99 ) ;
...
static enum V_112 F_64 ( struct V_1 V_2 )
{
return V_113 [ V_2 . V_16 ] [ V_2 . V_10 ] ;
}
static void F_65 ( struct V_1 V_2 , enum V_112 V_114 )
{
V_113 [ V_2 . V_16 ] [ V_2 . V_10 ] = V_114 ;
}
static enum V_112 F_66 ( struct V_1 * V_2 )
{
...
static void F_68 ( struct V_117 * V_118 )
{
struct V_1 V_2 ;
enum V_112 V_115 ;
int V_59 ;
