...
void F_79 ( struct V_1 * V_2 , T_3 V_128 , int V_129 )
{
unsigned long V_102 ;
...
V_155 = V_20 + V_53 -> V_62 . V_115 + V_109 ;
...
struct V_3 * V_4 ;
F_22 ( L_18 ,
( unsigned long long ) V_183 -> V_15 , V_183 -> V_184 ,
F_113 ( V_183 -> V_184 ) , V_183 -> V_185 ,
F_73 ( V_183 -> V_186 . V_187 ) ) ;
F_36 ( V_188 ) ;
V_4 = & V_2 -> V_6 [ F_114 ( & V_2 -> V_7 ) ] ;
F_31 ( V_2 -> V_69 -> V_70 , & V_4 -> V_12 -> V_62 , 1 ,
V_71 ) ;
if ( V_183 -> V_184 == V_189 ) {
F_106 ( V_78 , V_4 , V_183 -> V_185 , V_162 ) ;
} else {
if ( F_55 ( V_78 ) || F_115 ( V_78 ) )
F_59 ( V_78 , L_19 ,
& V_78 -> V_79 ,
V_183 -> V_184 ,
F_113 ( V_183 -> V_184 ) ) ;
