...
struct V_5 * V_6 = V_34 -> V_6 ;
* V_69 = 1 ;
V_70 [ 0 ] = ( V_34 -> V_48 -> V_74 * V_6 -> V_44 * V_6 -> V_45 ) >> 3 ;
return 0 ;
}
...
F_4 ( 2 , L_3 ,
V_38 , V_38 -> V_64 . V_65 . V_66 ,
V_6 -> V_44 , V_6 -> V_45 , V_34 -> V_48 -> V_74 , V_34 -> V_48 -> V_89 ,
...
( V_136 -> V_48 . V_137 . V_44 * V_34 -> V_48 -> V_74 ) >> 3 ;
...
V_136 -> V_48 . V_137 . V_139 =
( V_136 -> V_48 . V_137 . V_44 * V_48 -> V_74 ) >> 3 ;
V_136 -> V_48 . V_137 . V_140 =
V_136 -> V_48 . V_137 . V_45 * V_136 -> V_48 . V_137 . V_139 ;
V_136 -> V_48 . V_137 . V_141 = V_142 ;
return 0 ;
...
F_102 ( & V_34 -> V_101 ) ;
F_103 ( & V_34 -> V_94 . V_61 ) ;
F_103 ( & V_34 -> V_214 . V_61 ) ;
V_146 = F_104 ( V_224 -> V_215 , F_88 ,
V_237 , V_6 -> V_89 , V_34 ) ;
if ( V_146 < 0 ) {
F_83 ( V_238 L_27 ,
...
F_106 ( & V_6 -> V_114 , & V_6 -> V_131 , NULL ) ;
...
V_259 = F_107 ( & V_6 -> V_263 , & V_6 -> V_264 ,
& V_254 , NULL ) ;
if ( V_259 != NULL ) {
V_6 -> V_23 = V_259 ;
V_259 -> V_265 = V_266 ;
...
F_111 ( L_31 ) ;
V_6 -> V_271 = F_112 ( & V_6 -> V_264 , & V_270 ) ;
}
case V_272 :
F_111 ( L_32 ) ;
}
...
if ( V_146 < 0 )
goto V_292;
F_117 ( V_6 , V_34 -> V_82 , & V_34 -> V_223 ,
& V_295 , L_33 ) ;
F_118 ( & V_34 -> V_223 , V_34 ) ;
V_34 -> V_223 . V_296 = & V_6 -> V_114 ;
V_34 -> V_223 . V_297 = & V_34 -> V_147 ;
V_146 = F_119 ( & V_34 -> V_223 , V_165 ,
V_298 [ V_6 -> V_299 ] ) ;
if ( V_146 < 0 ) {
F_83 ( V_238 L_34 ,
V_6 -> V_89 ) ;
...
F_83 ( V_235 L_35 ,
V_6 -> V_89 , F_120 ( & V_34 -> V_223 ) ) ;
F_117 ( V_6 , V_34 -> V_82 , & V_34 -> V_222 ,
& V_300 , L_36 ) ;
F_118 ( & V_34 -> V_222 , V_34 ) ;
V_34 -> V_222 . V_297 = & V_34 -> V_148 ;
V_146 = F_119 ( & V_34 -> V_222 , V_167 ,
V_301 [ V_6 -> V_299 ] ) ;
if ( V_146 < 0 ) {
F_83 ( V_238 L_37 ,
V_6 -> V_89 ) ;
...
F_83 ( V_235 L_38 ,
V_6 -> V_89 , F_120 ( & V_34 -> V_222 ) ) ;
if ( V_6 -> V_105 . V_106 . type == V_171 ) {
F_117 ( V_6 , V_34 -> V_82 , & V_34 -> V_221 ,
& V_302 , L_39 ) ;
F_118 ( & V_34 -> V_221 , V_34 ) ;
V_34 -> V_221 . V_296 = & V_6 -> V_131 ;
V_146 = F_119 ( & V_34 -> V_221 , V_163 ,
V_303 [ V_6 -> V_299 ] ) ;
if ( V_146 < 0 ) {
F_83 ( V_238 L_40 ,
V_6 -> V_89 ) ;
...
F_83 ( V_235 L_38 ,
V_6 -> V_89 , F_120 ( & V_34 -> V_221 ) ) ;
}
if ( V_6 -> V_105 . V_160 != V_84 ) {
V_6 -> V_304 = F_121 ( V_305 , V_6 , L_41 ) ;
if ( F_122 ( V_6 -> V_304 ) ) {
V_146 = F_123 ( V_6 -> V_304 ) ;
F_83 ( V_238 L_42 ,
V_6 -> V_89 , V_146 ) ;
}
}
...
static void F_128 ( struct V_224 * V_224 )
{
struct V_33 * V_34 = F_129 ( V_224 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
if ( V_6 -> V_304 ) {
F_130 ( V_6 -> V_304 ) ;
V_6 -> V_304 = NULL ;
...
static int F_134 ( struct V_224 * V_224 , T_4 V_307 )
{
struct V_33 * V_34 = F_129 ( V_224 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
unsigned long V_100 ;
...
F_132 ( V_6 ) ;
F_136 ( V_224 ) ;
if ( 0 != F_137 ( V_224 , F_138 ( V_224 , V_307 ) ) ) {
F_133 ( V_224 ) ;
V_34 -> V_307 . V_308 = 1 ;
}
return 0 ;
}
static int F_139 ( struct V_224 * V_224 )
{
struct V_33 * V_34 = F_129 ( V_224 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
unsigned long V_100 ;
