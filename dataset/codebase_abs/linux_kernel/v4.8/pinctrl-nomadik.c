...
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
return V_58 -> V_68 -> V_178 [ V_177 ] . V_142 ;
}
static int F_95 ( struct V_81 * V_82 , unsigned V_177 ,
...
V_71 < V_182 -> V_45 . V_46 + V_182 -> V_45 . V_133 )
return V_182 ;
}
return NULL ;
}
...
static int F_99 ( struct V_184 * * V_185 , unsigned * V_186 ,
...
static int F_100 ( struct V_184 * * V_185 ,
unsigned * V_186 ,
unsigned * V_187 , const char * V_188 ,
...
if ( * V_187 == * V_186 )
return - V_190 ;
V_196 = F_101 ( V_194 , V_195 * sizeof( * V_196 ) ,
V_144 ) ;
if ( ! V_196 )
return - V_145 ;
...
static int F_102 ( int V_199 , int V_31 , unsigned long * V_200 )
{
int V_152 = 0 ;
if ( V_201 [ V_199 ] . V_202 == NULL )
* V_200 = V_201 [ V_199 ] . V_200 ;
else {
if ( V_31 < V_201 [ V_199 ] . V_203 ) {
* V_200 = V_201 [ V_199 ] . V_200 |
V_201 [ V_199 ] . V_202 [ V_31 ] ;
}
}
return V_152 ;
}
static const char * F_103 ( struct V_81 * V_82 , const char * V_204 )
{
int V_60 , V_205 ;
struct V_57 * V_58 = F_27 ( V_82 ) ;
...
return V_58 -> V_68 -> V_179 [ V_60 ] . V_142 ;
return NULL ;
}
...
int V_60 , V_31 , V_152 ;
for ( V_60 = 0 ; V_60 < F_79 ( V_201 ) ; V_60 ++ ) {
V_152 = F_70 ( V_135 ,
V_201 [ V_60 ] . V_209 , & V_31 ) ;
if ( V_152 != - V_102 ) {
if ( F_102 ( V_60 , V_31 , & V_208 ) == 0 ) {
* V_194 |= V_208 ;
V_207 = 1 ;
}
}
...
struct V_209 * V_210 ;
struct V_134 * V_211 ;
V_152 = F_106 ( V_135 , L_42 , & V_189 ) ;
if ( V_152 >= 0 ) {
const char * V_188 ;
V_152 = F_107 ( V_135 , L_43 ) ;
if ( V_152 < 0 )
goto exit;
V_152 = F_108 ( V_82 , V_185 ,
V_186 ,
V_187 , V_152 ) ;
if ( V_152 < 0 )
goto exit;
F_109 (np, L_43 , prop, group) {
V_152 = F_99 ( V_185 , V_186 , V_187 ,
V_188 , V_189 ) ;
if ( V_152 < 0 )
goto exit;
}
}
V_207 = F_104 ( V_135 , & V_194 ) ;
V_211 = F_110 ( V_135 , L_44 , 0 ) ;
if ( V_211 )
V_207 |= F_104 ( V_211 , & V_194 ) ;
if ( V_207 ) {
const char * V_212 ;
const char * V_71 ;
...
V_212 = F_103 ( V_82 , V_71 ) ;
V_152 = F_100 ( V_185 , V_186 ,
V_187 ,
V_212 , & V_194 , 1 ) ;
if ( V_152 < 0 )
goto exit;
...
* V_187 = 0 ;
F_112 (np_config, np) {
V_152 = F_105 ( V_82 , V_135 , V_185 ,
& V_186 , V_187 ) ;
if ( V_152 < 0 ) {
F_113 ( V_82 , * V_185 , * V_187 ) ;
return V_152 ;
}
}
return 0 ;
...
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
return V_58 -> V_68 -> V_214 [ V_189 ] . V_142 ;
}
...
static int F_117 ( struct V_81 * V_82 , unsigned V_189 ,
unsigned V_188 )
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
...
if ( V_217 -> V_218 < 0 )
return - V_102 ;
F_17 ( V_58 -> V_67 , L_46 , V_217 -> V_142 , V_217 -> V_181 ) ;
V_33 = ( ( V_217 -> V_218 & V_83 ) == V_83 ) ;
if ( V_33 ) {
F_34 ( & V_103 , V_101 ) ;
memset ( V_14 , 0xff , sizeof( V_14 ) ) ;
for ( V_60 = 0 ; V_60 < V_217 -> V_181 ; V_60 ++ )
V_14 [ V_217 -> V_179 [ V_60 ] / V_146 ] &= ~ F_3 ( V_217 -> V_179 [ V_60 ] ) ;
F_22 ( V_14 ) ;
}
for ( V_60 = 0 ; V_60 < V_217 -> V_181 ; V_60 ++ ) {
struct V_1 * V_2 ;
unsigned V_37 ;
V_2 = F_96 ( V_217 -> V_179 [ V_60 ] ) ;
if ( ! V_2 ) {
F_20 ( V_58 -> V_67 ,
L_47 ,
V_217 -> V_179 [ V_60 ] , V_217 -> V_142 , V_60 ) ;
goto V_219;
}
F_17 ( V_58 -> V_67 , L_48 , V_217 -> V_179 [ V_60 ] , V_217 -> V_218 ) ;
F_23 ( V_2 -> V_80 ) ;
V_37 = V_217 -> V_179 [ V_60 ] % V_146 ;
F_13 ( V_2 , V_37 ) ;
F_12 ( V_2 , V_37 ,
( V_217 -> V_218 & V_83 ) , V_33 ) ;
F_25 ( V_2 -> V_80 ) ;
...
unsigned V_37 ;
T_6 V_208 ;
int V_18 , V_14 , V_227 , V_31 , V_60 ;
bool V_27 , V_228 , V_229 ;
V_2 = F_96 ( V_71 ) ;
if ( ! V_2 ) {
F_20 ( V_58 -> V_67 ,
L_59 , V_71 ) ;
...
V_229 = F_128 ( V_208 ) ;
if ( V_229 ) {
int V_230 = F_129 ( V_208 ) ;
int V_231 = F_130 ( V_208 ) ;
int V_232 = F_131 ( V_208 ) ;
V_228 = true ;
if ( V_230 )
V_18 = V_230 - 1 ;
if ( V_231 )
...
L_60 ,
V_71 ,
V_230 ? V_224 [ V_18 ] : L_61 ,
V_231 ? ( V_227 ? L_62 : L_63 )
: L_61 ,
V_232 ? ( V_31 ? L_64 : L_65 ) : L_61 ) ;
}
F_17 ( V_2 -> V_45 . V_53 ,
L_66 ,
V_71 , V_208 , V_224 [ V_18 ] , V_225 [ V_14 ] ,
V_227 ? L_67 : L_63 ,
V_227 ? ( V_31 ? L_64 : L_65 ) : L_30 ,
V_27 ? L_68 : L_69 ) ;
F_23 ( V_2 -> V_80 ) ;
V_37 = V_71 % V_146 ;
if ( V_228 )
...
static int F_132 ( struct V_233 * V_67 )
{
struct V_57 * V_58 ;
V_58 = F_133 ( V_67 ) ;
if ( ! V_58 )
return - V_102 ;
return F_134 ( V_58 -> V_234 ) ;
}
static int F_135 ( struct V_233 * V_67 )
{
struct V_57 * V_58 ;
V_58 = F_133 ( V_67 ) ;
if ( ! V_58 )
return - V_102 ;
return F_136 ( V_58 -> V_234 ) ;
}
...
struct V_134 * V_243 ;
struct V_1 * V_2 ;
V_243 = F_110 ( V_135 , L_70 , V_60 ) ;
if ( V_243 ) {
F_92 ( & V_137 -> V_67 ,
L_71 ,
V_60 , V_243 -> V_142 ) ;
V_2 = F_66 ( V_243 , V_137 ) ;
if ( F_75 ( V_2 ) )
F_20 ( & V_137 -> V_67 ,
L_72
L_73 ) ;
...
V_237 = F_110 ( V_135 , L_74 , 0 ) ;
if ( V_237 )
V_58 -> V_65 = F_143 ( V_237 , 0 ) ;
if ( ! V_58 -> V_65 ) {
if ( V_238 == V_240 ) {
F_92 ( & V_137 -> V_67 ,
L_75
...
V_58 -> V_234 = F_144 ( & V_137 -> V_67 , & V_244 , V_58 ) ;
if ( F_75 ( V_58 -> V_234 ) ) {
F_20 ( & V_137 -> V_67 , L_78 ) ;
return F_81 ( V_58 -> V_234 ) ;
}
F_88 ( V_137 , V_58 ) ;
