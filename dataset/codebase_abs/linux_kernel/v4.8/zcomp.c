...
* F_25 ( V_6 -> V_16 , V_22 ) = V_2 ;
break;
case V_25 :
case V_26 :
V_2 = * F_25 ( V_6 -> V_16 , V_22 ) ;
if ( ! F_2 ( V_2 ) )
F_1 ( V_2 ) ;
* F_25 ( V_6 -> V_16 , V_22 ) = NULL ;
break;
default:
break;
}
...
unsigned long V_21 , void * V_30 )
{
unsigned long V_22 = ( unsigned long ) V_30 ;
struct V_5 * V_6 = F_28 ( V_29 , F_29 ( * V_6 ) , V_31 ) ;
return F_23 ( V_6 , V_21 , V_22 ) ;
}
...
int V_32 ;
V_6 -> V_31 . V_33 = F_27 ;
V_6 -> V_16 = F_31 ( struct V_1 * ) ;
if ( ! V_6 -> V_16 )
return - V_34 ;
F_32 () ;
F_33 (cpu) {
V_32 = F_23 ( V_6 , V_23 , V_22 ) ;
if ( V_32 == V_24 )
goto V_35;
}
F_34 ( & V_6 -> V_31 ) ;
...
struct V_5 * F_39 ( const char * V_36 )
{
struct V_5 * V_6 ;
int error ;
if ( ! F_10 ( V_36 ) )
return F_40 ( - V_37 ) ;
V_6 = F_41 ( sizeof( struct V_5 ) , V_7 ) ;
if ( ! V_6 )
return F_40 ( - V_34 ) ;
V_6 -> V_8 = V_36 ;
error = F_30 ( V_6 ) ;
