...
F_79 ( V_2 , V_16 , 0 ) ;
if ( F_1 ( V_2 ) )
F_132 ( & V_2 -> V_112 , V_6 , V_175 -> V_235 ) ;
V_108 = F_97 ( V_2 , V_19 ) ;
F_14 ( & V_16 -> V_67 ) ;
V_16 -> V_111 = V_173 -> V_175 -> V_111 ;
V_16 -> V_194 = true ;
...
static int F_136 ( struct V_237 * V_238 , int V_12 )
{
...
static void F_138 ( struct V_237 * V_238 , int V_12 ,
...
static bool F_139 ( struct V_237 * V_238 , int V_12 )
{
struct V_1 * V_2 = F_116 ( V_238 , struct V_1 , V_112 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_15 * V_16 = F_9 ( V_4 , V_12 ) ;
...
static void F_142 ( struct V_211 * V_121 )
{
...
struct V_211 * V_121 ;
int V_44 ;
V_44 = F_144 ( V_2 -> V_71 , V_69 , V_215 , & V_121 ,
true , false ) ;
if ( V_44 < 0 )
return V_44 ;
...
static int F_145 ( struct V_1 * V_2 , int V_12 )
{
char V_249 [ 32 ] = L_24 ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_15 * V_16 ;
...
if ( V_4 -> V_184 )
return F_143 ( V_2 , V_4 , V_12 , V_249 ) ;
V_16 = F_3 ( V_4 , V_12 ) ;
V_251 = ! F_146 ( V_2 , V_16 -> V_6 ) ;
if ( V_251 )
strncat ( V_249 , L_26 ,
sizeof( V_249 ) - strlen ( V_249 ) - 1 ) ;
V_204 = F_147 ( V_2 , V_16 -> V_6 , V_249 ,
V_251 ) ;
if ( V_204 < 0 )
return V_204 ;
...
if ( ! V_17 || ! V_17 -> V_17 )
break;
V_44 = F_150 ( V_17 -> V_17 , V_12 , & V_4 -> V_110 ) ;
if ( V_44 < 0 )
return V_44 ;
}
return 0 ;
...
static void F_156 ( struct V_3 * V_4 , int V_253 )
{
F_157 ( & V_4 -> V_223 , sizeof( struct V_15 ) , V_253 ) ;
F_157 ( & V_4 -> V_225 , sizeof( struct V_158 ) , V_253 ) ;
}
...
{
struct V_3 * V_4 ;
V_4 = F_170 ( sizeof( * V_4 ) , V_259 ) ;
if ( ! V_4 )
return - V_46 ;
V_4 -> V_116 = V_260 ;
F_152 ( & V_4 -> V_30 ) ;
F_171 ( & V_2 -> V_112 , & V_4 -> V_110 ) ;
V_4 -> V_110 . V_116 . V_261 = F_137 ;
V_4 -> V_110 . V_116 . V_262 = F_138 ;
V_4 -> V_110 . V_116 . V_263 = F_139 ;
V_4 -> V_110 . V_116 . V_264 = F_136 ,
V_2 -> V_4 = V_4 ;
F_156 ( V_4 , 4 ) ;
V_2 -> V_256 = V_265 ;
return 0 ;
...
return;
F_8 ( V_2 , L_27 , V_119 ) ;
F_173 ( V_2 , V_119 , V_4 -> V_21 , V_4 -> V_168 ) ;
}
...
return;
V_269 |= V_274 ;
F_177 ( & V_2 -> V_112 , V_273 ) ;
F_73 ( V_2 , V_270 , 0 ,
V_273 , V_269 ) ;
}
static void F_178 ( struct V_1 * V_2 , T_1 V_275 ,
unsigned int V_276 )
{
if ( V_276 == V_141 ) {
F_174 ( V_2 , false ) ;
...
F_179 ( V_2 , V_275 , V_276 ) ;
}
static void F_180 ( void * V_277 , int V_278 )
{
...
if ( F_181 ( V_2 -> V_71 ) != V_280 )
return;
if ( F_182 ( & ( V_2 ) -> V_112 . V_281 ) )
return;
F_183 ( & V_2 -> V_78 -> V_112 ) ;
F_54 ( V_2 , V_6 ) ;
}
...
V_4 -> V_282 . V_277 = V_2 ;
F_185 () ;
V_4 -> V_282 . V_283 = F_180 ;
F_164 ( & V_4 -> V_282 ) ;
}
static int F_186 ( struct V_1 * V_2 , T_1 V_19 ,
T_1 V_6 , T_3 V_154 , int V_155 )
{
F_63 ( V_2 , V_19 , V_6 ) ;
...
F_174 ( V_2 , true ) ;
F_176 ( V_2 ) ;
if ( ! F_189 ( V_2 ) && ! F_190 ( V_2 ) )
V_2 -> V_112 . V_285 = 1 ;
V_2 -> V_256 . V_286 = F_178 ;
V_2 -> V_255 = true ;
V_2 -> V_287 = 0 ;
V_2 -> V_288 = 1 ;
V_4 -> V_116 . V_236 = F_186 ;
V_4 -> V_116 . F_79 = F_187 ;
V_44 = F_127 ( V_2 ) ;
if ( V_44 < 0 ) {
F_160 ( V_2 ) ;
return V_44 ;
