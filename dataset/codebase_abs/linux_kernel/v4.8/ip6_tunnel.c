...
V_185 . V_220 = V_119 ;
V_137 = F_141 ( V_215 ) ;
if ( V_25 -> V_30 . V_33 & V_221 )
V_185 . V_212 |= F_66 ( ( T_6 ) V_215 -> V_127 << V_222 )
& V_223 ;
if ( V_25 -> V_30 . V_33 & V_224 )
V_185 . V_199 = V_62 -> V_225 ;
if ( F_142 ( V_62 , V_226 ) )
return - 1 ;
F_143 ( V_62 , V_119 ) ;
...
V_137 = F_74 ( V_65 ) ;
if ( V_25 -> V_30 . V_33 & V_221 )
V_185 . V_212 |= ( * ( T_7 * ) V_65 & V_223 ) ;
if ( V_25 -> V_30 . V_33 & V_227 )
...
int V_234 ;
memcpy ( V_8 -> V_235 , & V_37 -> V_31 , sizeof( struct V_1 ) ) ;
memcpy ( V_8 -> V_236 , & V_37 -> V_32 , sizeof( struct V_1 ) ) ;
V_185 -> V_100 = V_37 -> V_31 ;
V_185 -> V_99 = V_37 -> V_32 ;
V_185 -> V_237 = V_37 -> V_148 ;
V_185 -> V_212 = 0 ;
if ( ! ( V_37 -> V_33 & V_221 ) )
V_185 -> V_212 |= V_223 & V_37 -> V_238 ;
if ( ! ( V_37 -> V_33 & V_227 ) )
V_185 -> V_212 |= V_239 & V_37 -> V_238 ;
...
V_8 -> V_33 &= ~ V_240 ;
V_25 -> V_241 = 0 ;
V_25 -> V_210 = V_25 -> V_191 + V_25 -> V_241 ;
V_234 = V_25 -> V_210 + sizeof( struct V_64 ) ;
if ( V_37 -> V_33 & V_149 ) {
int V_242 = ( F_80 ( & V_37 -> V_32 ) &
( V_145 | V_147 ) ) ;
...
return;
if ( V_116 -> V_128 . V_8 ) {
V_8 -> V_243 = V_116 -> V_128 . V_8 -> V_243 +
V_234 ;
V_8 -> V_103 = V_116 -> V_128 . V_8 -> V_103 - V_234 ;
if ( ! ( V_25 -> V_30 . V_33 & V_216 ) )
V_8 -> V_103 -= 8 ;
if ( V_8 -> V_103 < V_110 )
V_8 -> V_103 = V_110 ;
...
static void
F_155 ( struct V_36 * V_37 , const struct V_244 * V_218 )
{
...
case V_249 :
if ( V_8 == V_27 -> V_60 ) {
if ( F_158 ( & V_37 , V_246 -> V_250 . V_251 , sizeof( V_37 ) ) ) {
V_46 = - V_252 ;
break;
}
F_155 ( & V_248 , & V_37 ) ;
V_25 = F_35 ( V_22 , & V_248 , 0 ) ;
if ( F_59 ( V_25 ) )
V_25 = F_21 ( V_8 ) ;
} else {
...
if ( F_159 ( V_246 -> V_250 . V_251 , & V_37 , sizeof( V_37 ) ) ) {
V_46 = - V_252 ;
}
break;
case V_253 :
...
break;
F_155 ( & V_248 , & V_37 ) ;
V_25 = F_35 ( V_22 , & V_248 , V_247 == V_253 ) ;
if ( V_247 == V_254 ) {
if ( ! F_59 ( V_25 ) ) {
if ( V_25 -> V_8 != V_8 ) {
V_46 = - V_58 ;
...
V_25 = F_21 ( V_8 ) ;
if ( V_8 == V_27 -> V_60 )
V_46 = F_154 ( V_25 , & V_248 ) ;
else
V_46 = F_151 ( V_25 , & V_248 ) ;
}
if ( ! F_59 ( V_25 ) ) {
V_46 = 0 ;
F_156 ( & V_37 , & V_25 -> V_30 ) ;
...
int F_162 ( struct V_7 * V_8 , int V_260 )
{
struct V_21 * V_261 = F_21 ( V_8 ) ;
if ( V_261 -> V_30 . V_101 == V_119 ) {
if ( V_260 < 68 )
return - V_258 ;
} else {
if ( V_260 < V_110 )
...
int F_164 ( const struct V_262 * V_132 ,
unsigned int V_263 )
{
if ( V_263 >= V_264 )
return - V_265 ;
return ! F_165 ( ( const struct V_262 * * )
& V_266 [ V_263 ] ,
NULL , V_132 ) ? 0 : - 1 ;
}
int F_166 ( const struct V_262 * V_132 ,
unsigned int V_263 )
{
int V_151 ;
if ( V_263 >= V_264 )
return - V_265 ;
V_151 = ( F_165 ( ( const struct V_262 * * )
& V_266 [ V_263 ] ,
...
{
int V_210 ;
memset ( & V_25 -> V_269 , 0 , sizeof( V_25 -> V_269 ) ) ;
V_210 = F_168 ( V_268 ) ;
if ( V_210 < 0 )
return V_210 ;
V_25 -> V_269 . type = V_268 -> type ;
V_25 -> V_269 . V_270 = V_268 -> V_270 ;
V_25 -> V_269 . V_271 = V_268 -> V_271 ;
V_25 -> V_269 . V_33 = V_268 -> V_33 ;
V_25 -> V_191 = V_210 ;
V_25 -> V_210 = V_25 -> V_191 + V_25 -> V_241 ;
return 0 ;
}
...
V_234 = V_25 -> V_210 + sizeof( struct V_64 ) ;
V_8 -> type = V_275 ;
V_8 -> V_243 = V_288 + V_234 ;
V_8 -> V_103 = V_289 - V_234 ;
if ( ! ( V_25 -> V_30 . V_33 & V_216 ) )
V_8 -> V_103 -= 8 ;
return 0 ;
V_287:
...
static int F_177 ( struct V_290 * V_291 [] , struct V_290 * V_72 [] )
{
T_5 V_101 ;
if ( ! V_72 || ! V_72 [ V_292 ] )
return 0 ;
V_101 = F_178 ( V_72 [ V_292 ] ) ;
if ( V_101 != V_135 &&
V_101 != V_119 &&
V_101 != 0 )
return - V_258 ;
...
static void F_179 ( struct V_290 * V_72 [] ,
struct V_36 * V_30 )
{
...
return;
if ( V_72 [ V_293 ] )
V_30 -> V_148 = F_180 ( V_72 [ V_293 ] ) ;
if ( V_72 [ V_294 ] )
V_30 -> V_31 = F_181 ( V_72 [ V_294 ] ) ;
if ( V_72 [ V_295 ] )
V_30 -> V_32 = F_181 ( V_72 [ V_295 ] ) ;
if ( V_72 [ V_296 ] )
V_30 -> V_213 = F_178 ( V_72 [ V_296 ] ) ;
if ( V_72 [ V_297 ] )
V_30 -> V_108 = F_178 ( V_72 [ V_297 ] ) ;
if ( V_72 [ V_298 ] )
V_30 -> V_238 = F_182 ( V_72 [ V_298 ] ) ;
if ( V_72 [ V_299 ] )
V_30 -> V_33 = F_180 ( V_72 [ V_299 ] ) ;
if ( V_72 [ V_292 ] )
V_30 -> V_101 = F_178 ( V_72 [ V_292 ] ) ;
}
static bool F_183 ( struct V_290 * V_72 [] ,
struct V_267 * V_268 )
{
bool V_151 = false ;
...
if ( V_72 [ V_300 ] ) {
V_151 = true ;
V_268 -> type = F_184 ( V_72 [ V_300 ] ) ;
}
if ( V_72 [ V_301 ] ) {
V_151 = true ;
V_268 -> V_33 = F_184 ( V_72 [ V_301 ] ) ;
}
if ( V_72 [ V_302 ] ) {
V_151 = true ;
V_268 -> V_270 = F_185 ( V_72 [ V_302 ] ) ;
}
if ( V_72 [ V_303 ] ) {
V_151 = true ;
V_268 -> V_271 = F_185 ( V_72 [ V_303 ] ) ;
}
return V_151 ;
}
static int F_186 ( struct V_22 * V_304 , struct V_7 * V_8 ,
struct V_290 * V_291 [] , struct V_290 * V_72 [] )
{
struct V_22 * V_22 = F_27 ( V_8 ) ;
struct V_21 * V_305 , * V_25 ;
struct V_267 V_268 ;
V_305 = F_21 ( V_8 ) ;
if ( F_183 ( V_72 , & V_268 ) ) {
int V_46 = F_167 ( V_305 , & V_268 ) ;
if ( V_46 < 0 )
return V_46 ;
}
F_179 ( V_72 , & V_305 -> V_30 ) ;
V_25 = F_35 ( V_22 , & V_305 -> V_30 , 0 ) ;
if ( ! F_59 ( V_25 ) )
return - V_58 ;
return F_26 ( V_8 ) ;
}
static int F_187 ( struct V_7 * V_8 , struct V_290 * V_291 [] ,
struct V_290 * V_72 [] )
{
struct V_21 * V_25 = F_21 ( V_8 ) ;
struct V_36 V_37 ;
...
static void F_188 ( struct V_7 * V_8 , struct V_306 * V_307 )
{
struct V_22 * V_22 = F_27 ( V_8 ) ;
struct V_26 * V_27 = F_10 ( V_22 , V_28 ) ;
if ( V_8 != V_27 -> V_60 )
...
struct V_36 * V_308 = & V_153 -> V_30 ;
if ( F_193 ( V_62 , V_293 , V_308 -> V_148 ) ||
F_194 ( V_62 , V_294 , & V_308 -> V_31 ) ||
F_194 ( V_62 , V_295 , & V_308 -> V_32 ) ||
F_195 ( V_62 , V_296 , V_308 -> V_213 ) ||
F_195 ( V_62 , V_297 , V_308 -> V_108 ) ||
F_196 ( V_62 , V_298 , V_308 -> V_238 ) ||
F_193 ( V_62 , V_299 , V_308 -> V_33 ) ||
F_195 ( V_62 , V_292 , V_308 -> V_101 ) )
goto V_309;
if ( F_197 ( V_62 , V_300 ,
V_153 -> V_269 . type ) ||
F_198 ( V_62 , V_302 ,
...
if ( V_8 -> V_47 == & V_48 )
F_189 ( V_8 , & V_311 ) ;
for ( V_38 = 0 ; V_38 < V_312 ; V_38 ++ ) {
V_25 = F_18 ( V_27 -> V_313 [ V_38 ] ) ;
while ( V_25 ) {
if ( ! F_98 ( F_27 ( V_25 -> V_8 ) , V_22 ) )
F_189 ( V_25 -> V_8 , & V_311 ) ;
V_25 = F_18 ( V_25 -> V_42 ) ;
}
}
F_203 ( & V_311 ) ;
...
if ( V_46 < 0 )
goto V_318;
V_46 = F_211 ( & V_319 , V_320 ) ;
if ( V_46 < 0 ) {
F_212 ( L_11 , V_321 ) ;
goto V_322;
}
V_46 = F_211 ( & V_323 , V_324 ) ;
if ( V_46 < 0 ) {
F_212 ( L_12 , V_321 ) ;
goto V_325;
}
...
{
F_217 ( & V_48 ) ;
if ( F_214 ( & V_319 , V_320 ) )
F_218 ( L_13 , V_321 ) ;
if ( F_214 ( & V_323 , V_324 ) )
F_218 ( L_14 , V_321 ) ;
F_215 ( & V_317 ) ;
}
