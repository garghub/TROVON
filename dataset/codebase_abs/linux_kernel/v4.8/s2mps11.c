...
{
struct V_88 * V_89 ;
V_89 = F_21 ( V_74 -> V_50 . V_90 -> V_85 , L_4 ) ;
if ( ! V_89 ) {
F_8 ( & V_74 -> V_50 , L_5 ) ;
return - V_62 ;
}
V_75 ( & V_74 -> V_50 , V_89 , V_76 , V_87 ) ;
if ( V_8 -> V_52 == V_54 )
F_16 ( V_74 , V_76 , V_8 ) ;
F_22 ( V_89 ) ;
return 0 ;
...
{
struct V_101 * V_102 = F_25 ( V_74 -> V_50 . V_90 ) ;
...
V_87 = F_17 ( V_113 ) ;
V_108 = V_113 ;
F_28 ( V_114 < F_17 ( V_113 ) ) ;
break;
case V_53 :
V_87 = F_17 ( V_115 ) ;
V_108 = V_115 ;
F_28 ( V_114 < F_17 ( V_115 ) ) ;
break;
case V_54 :
V_87 = F_17 ( V_116 ) ;
V_108 = V_116 ;
F_28 ( V_114 < F_17 ( V_116 ) ) ;
break;
case V_117 :
V_87 = F_17 ( V_118 ) ;
V_108 = V_118 ;
F_28 ( V_114 < F_17 ( V_118 ) ) ;
break;
case V_60 :
V_87 = F_17 ( V_119 ) ;
V_108 = V_119 ;
F_28 ( V_114 < F_17 ( V_119 ) ) ;
break;
default:
F_8 ( & V_74 -> V_50 , L_6 ,
V_8 -> V_52 ) ;
...
V_76 = F_30 ( sizeof( * V_76 ) * V_87 , V_109 ) ;
if ( ! V_76 )
return - V_110 ;
for ( V_78 = 0 ; V_78 < V_87 ; V_78 ++ )
V_76 [ V_78 ] . V_86 = V_108 [ V_78 ] . V_86 ;
V_36 = F_20 ( V_74 , V_76 , V_8 , V_87 ) ;
if ( V_36 )
goto V_122;
V_120:
F_31 ( V_74 , V_8 ) ;
V_106 . V_50 = & V_74 -> V_50 ;
V_106 . V_49 = V_102 -> V_123 ;
V_106 . V_111 = V_8 ;
V_106 . V_124 = V_125 ;
V_106 . V_126 = true ;
for ( V_78 = 0 ; V_78 < V_87 ; V_78 ++ ) {
struct V_3 * V_127 ;
if ( V_104 ) {
V_106 . V_84 = V_104 -> V_108 [ V_78 ] . V_128 ;
V_106 . V_85 = V_104 -> V_108 [ V_78 ] . V_129 ;
} else {
V_106 . V_84 = V_76 [ V_78 ] . V_84 ;
V_106 . V_85 = V_76 [ V_78 ] . V_85 ;
}
V_106 . V_130 = V_8 -> V_57 [ V_78 ] ;
V_127 = F_32 ( & V_74 -> V_50 ,
& V_108 [ V_78 ] , & V_106 ) ;
if ( F_33 ( V_127 ) ) {
V_36 = F_34 ( V_127 ) ;
F_8 ( & V_74 -> V_50 , L_8 ,
