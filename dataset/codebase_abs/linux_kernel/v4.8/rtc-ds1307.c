...
V_57 [ 5 ] = 0 ;
V_57 [ 6 ] = 0 ;
V_57 [ 7 ] = V_26 & ~ ( V_31 | V_77 ) ;
V_57 [ 8 ] = V_76 & ~ ( V_29 | V_78 ) ;
V_9 = V_20 -> V_68 ( V_2 ,
V_73 , 9 , V_57 ) ;
if ( V_9 < 0 ) {
F_5 ( V_11 , L_18 ) ;
...
static int F_28 ( struct V_35 * V_11 , unsigned int V_74 )
{
struct V_1 * V_2 = F_25 ( V_11 ) ;
struct V_20 * V_20 = F_14 ( V_2 ) ;
int V_9 ;
...
V_41 [ 6 ] |= V_89 ;
V_41 [ 0 ] &= ~ V_84 ;
V_9 = V_20 -> V_68 ( V_2 , V_83 , 10 , V_41 ) ;
if ( V_9 < 0 )
return V_9 ;
if ( ! V_37 -> V_74 )
return 0 ;
...
static int F_32 ( struct V_35 * V_11 , unsigned int V_74 )
{
struct V_1 * V_2 = F_25 ( V_11 ) ;
struct V_20 * V_20 = F_14 ( V_2 ) ;
int V_80 ;
...
struct V_153 * V_154 = F_70 ( V_2 -> V_11 . V_155 ) ;
bool V_156 = false ;
bool V_157 = false ;
unsigned char * V_57 ;
struct V_158 * V_159 = F_71 ( & V_2 -> V_11 ) ;
struct V_36 V_160 ;
unsigned long V_161 ;
T_9 V_162 = F_13 ;
...
V_20 -> V_23 = F_79 ( & V_2 -> V_11 , V_2 -> V_117 ,
V_167 , V_200 ) ;
if ( F_45 ( V_20 -> V_23 ) ) {
...
if ( V_108 -> V_204 ) {
V_20 -> V_205 = F_63 ( & V_2 -> V_11 ,
sizeof( struct V_94 ) ,
V_137 ) ;
if ( ! V_20 -> V_205 ) {
F_5 ( & V_2 -> V_11 , L_42 ) ;
} else {
V_20 -> V_205 -> V_95 . V_117 = L_43 ;
V_20 -> V_205 -> V_95 . V_206 = V_207 | V_208 ;
F_83 ( V_20 -> V_205 ) ;
V_20 -> V_205 -> V_209 = F_33 ;
V_20 -> V_205 -> V_210 = F_35 ;
V_20 -> V_205 -> V_211 = V_108 -> V_204 ;
V_20 -> V_98 = V_108 -> V_98 ;
V_148 = F_84 ( & V_2 -> V_11 . V_93 ,
V_20 -> V_205 ) ;
if ( V_148 ) {
F_5 ( & V_2 -> V_11 ,
L_44 ,
...
{
struct V_20 * V_20 = F_14 ( V_2 ) ;
if ( F_86 ( V_212 , & V_20 -> V_71 ) )
F_87 ( & V_2 -> V_11 . V_93 , V_20 -> V_205 ) ;
return 0 ;
}
