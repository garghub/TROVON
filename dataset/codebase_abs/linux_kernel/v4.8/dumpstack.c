...
if ( ! V_30 ) {
if ( ! V_15 )
V_30 = ( unsigned long * ) F_8 () ;
else
V_30 = ( unsigned long * ) V_15 -> V_28 . V_29 ;
}
for ( V_31 = 0 ; V_31 < 20 ; V_31 ++ ) {
if ( ( ( V_32 ) V_30 & ( V_23 - 1 ) ) == 0 )
break;
if ( ( V_31 * sizeof( long ) % 32 ) == 0 )
F_10 ( L_3 , V_31 == 0 ? L_4 : L_5 ) ;
F_10 ( L_6 , * V_30 ++ ) ;
}
F_10 ( L_5 ) ;
...
{
struct V_33 * V_12 = & V_33 ( V_9 -> V_12 ) ;
char * V_34 ;
V_34 = F_2 ( V_9 ) ? L_9 : L_10 ;
F_10 ( L_11 , V_34 , ( void * ) V_9 -> V_12 . V_35 , ( void * ) V_9 -> V_12 . V_13 ) ;
if ( ! F_2 ( V_9 ) )
F_10 ( L_12 , ( void * ) V_9 -> V_12 . V_13 ) ;
F_10 ( L_5 ) ;
F_10 ( L_13
L_14 , V_12 -> V_36 , V_12 -> V_37 , V_12 -> V_31 , V_12 -> V_38 ,
V_12 -> V_39 , V_12 -> V_40 , V_12 -> V_41 , V_12 -> V_42 , V_12 -> V_43 , V_12 -> V_44 , V_12 -> V_45 ) ;
F_10 ( L_15 , V_12 -> V_46 , V_12 -> V_47 ) ;
F_10 ( L_16 , V_34 ,
...
void F_19 ( struct V_8 * V_9 , const char * V_49 )
{
static int V_50 ;
F_20 () ;
F_21 () ;
...
F_24 ( & V_51 ) ;
F_25 ( 1 ) ;
F_10 ( L_18 , V_49 , V_9 -> V_52 & 0xffff ,
V_9 -> V_52 >> 17 , ++ V_50 ) ;
#ifdef F_26
F_10 ( L_19 ) ;
#endif
...
F_10 ( L_21 ) ;
F_10 ( L_5 ) ;
F_29 ( V_53 , V_49 , V_9 , 0 , V_9 -> V_52 & 0xffff , V_54 ) ;
F_30 () ;
F_17 ( V_9 ) ;
F_25 ( 0 ) ;
F_31 ( V_55 , V_56 ) ;
