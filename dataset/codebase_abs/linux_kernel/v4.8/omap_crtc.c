...
struct V_65 * V_44 )
{
if ( V_44 -> V_66 && V_44 -> V_67 ) {
T_3 V_68 = V_44 -> V_67 -> V_68 /
sizeof( struct V_69 ) ;
if ( V_68 < 2 )
return - V_13 ;
}
...
V_71 = (struct V_69 * )
V_2 -> V_44 -> V_67 -> V_40 ;
V_68 = V_2 -> V_44 -> V_67 -> V_68 /
sizeof( * V_71 ) ;
}
F_59 ( V_3 -> V_4 , V_71 , V_68 ) ;
}
if ( V_2 -> V_44 -> V_66 ) {
struct V_69 * V_71 = NULL ;
T_3 V_68 = 0 ;
...
static bool F_61 ( struct V_17 * V_18 ,
struct V_72 * V_73 )
{
struct V_74 * V_75 = V_18 -> V_76 ;
return V_73 == V_75 -> V_77 ||
V_73 == V_18 -> V_78 . V_79 ;
}
...
V_82 = F_63 ( V_44 -> V_44 , V_84 ) ;
if ( F_64 ( V_82 ) )
return F_65 ( V_82 ) ;
return F_66 ( V_84 , V_82 ,
V_73 , V_80 ) ;
}
return - V_13 ;
}
static int F_67 ( struct V_1 * V_2 ,
const struct V_65 * V_44 ,
struct V_72 * V_73 ,
T_4 * V_80 )
{
struct V_17 * V_18 = V_2 -> V_18 ;
if ( F_61 ( V_18 , V_73 ) ) {
return F_68 ( & V_2 -> V_85 -> V_37 ,
V_73 , V_80 ) ;
}
return - V_13 ;
}
...
struct V_83 * V_84 , enum V_7 V_4 , int V_14 )
{
struct V_1 * V_2 = NULL ;
struct V_3 * V_3 ;
int V_23 ;
F_25 ( L_4 , V_87 [ V_4 ] ) ;
V_3 = F_74 ( sizeof( * V_3 ) , V_88 ) ;
if ( ! V_3 )
return NULL ;
V_2 = & V_3 -> V_37 ;
F_75 ( & V_3 -> V_8 ) ;
V_3 -> V_4 = V_4 ;
V_3 -> V_28 = V_87 [ V_4 ] ;
V_3 -> V_51 . V_89 = F_1 ( V_2 ) ;
V_3 -> V_51 . V_47 = F_38 ;
V_3 -> V_49 . V_89 =
F_76 ( V_4 ) ;
V_3 -> V_49 . V_47 = F_35 ;
F_50 ( V_18 , & V_3 -> V_49 ) ;
V_23 = F_77 ( V_18 , V_2 , V_84 , NULL ,
& V_90 , NULL ) ;
if ( V_23 < 0 ) {
F_48 ( V_3 ) ;
return NULL ;
...
if ( F_79 ( V_4 ) ) {
T_3 V_92 = 256 ;
F_80 ( V_2 , 0 , false , V_92 ) ;
F_81 ( V_2 , V_92 ) ;
}
F_82 ( V_2 -> V_85 , & V_2 -> V_37 ) ;
V_29 [ V_4 ] = V_3 ;
return V_2 ;
}
