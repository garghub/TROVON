...
F_74 ( & V_29 -> V_87 , F_66 , ( unsigned long ) V_29 ) ;
F_10 ( & V_29 -> V_75 ) ;
F_18 ( & V_29 -> V_70 ) ;
F_18 ( & V_29 -> V_69 ) ;
V_29 -> V_73 = * V_5 ;
...
int
F_77 ( T_1 V_6 , T_1 V_7 , bool V_115 )
{
struct V_67 * V_29 ;
struct V_67 * V_44 ;
struct V_45 V_116 ;
...
F_20 ( & V_29 -> V_71 , & V_116 ) ;
}
V_117 = F_44 ( & V_42 . V_114 ) &&
! F_44 ( & V_116 ) ;
F_15 ( V_40 ) ;
...
int
F_81 ( int V_118 , struct V_119 * V_120 )
{
struct V_4 * V_5 ;
struct V_18 * V_19 ;
V_5 = (struct V_4 * ) V_120 -> V_121 ;
switch ( V_118 ) {
default:
return - V_17 ;
case V_122 :
...
return 0 ;
case V_126 :
V_19 = (struct V_18 * ) V_120 -> V_127 ;
if ( ! V_5 || ! V_19 )
return - V_17 ;
return F_23 ( V_120 -> V_124 , V_5 , V_19 ) ;
case V_128 :
if ( ! V_5 )
return - V_17 ;
return F_68 ( V_5 ) ;
...
if ( ! V_5 || ! V_19 )
return - V_17 ;
return F_79 ( V_120 -> V_124 , V_5 , V_19 ) ;
}
}
int
F_82 ( void )
