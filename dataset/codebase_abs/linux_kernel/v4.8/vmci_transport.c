...
static int F_123 ( struct V_65 * V_66 ,
...
return - V_203 ;
V_2 = 0 ;
V_99 = F_124 ( & V_66 -> V_64 , V_88 , V_198 , & V_2 ) ;
if ( ! V_99 )
return V_2 ;
...
V_2 = F_125 ( V_99 , sizeof( * V_32 ) , V_194 , V_199 ) ;
if ( V_2 )
goto V_90;
if ( V_194 -> V_206 ) {
F_126 ( struct V_22 * , V_207 , V_194 -> V_206 ) ;
F_6 ( V_207 , V_32 -> V_23 . V_58 , V_32 -> V_23 . V_108 ) ;
V_194 -> V_208 = sizeof( * V_207 ) ;
}
V_2 = V_199 ;
V_90:
F_127 ( & V_66 -> V_64 , V_99 ) ;
return V_2 ;
}
static bool F_128 ( T_2 V_102 , T_2 V_103 )
{
if ( V_102 == V_17 ) {
return V_103 == V_209 ;
}
...
static int F_129 ( struct V_65 * V_66 )
{
int V_2 ;
bool V_141 = false ;
...
return F_132 ( F_63 ( V_66 ) -> V_84 , V_194 , V_195 , 0 ) ;
}
static T_8 F_133 (
struct V_65 * V_66 ,
struct V_193 * V_194 ,
T_6 V_195 )
{
return F_134 ( F_63 ( V_66 ) -> V_84 , V_194 , V_195 , 0 ) ;
}
static T_9 F_135 ( struct V_65 * V_66 )
{
return F_136 ( F_63 ( V_66 ) -> V_84 ) ;
}
static T_9 F_137 ( struct V_65 * V_66 )
{
return F_138 ( F_63 ( V_66 ) -> V_84 ) ;
}
static T_4 F_139 ( struct V_65 * V_66 )
{
return F_63 ( V_66 ) -> V_86 ;
}
static bool F_140 ( struct V_65 * V_66 )
{
...
static T_4 F_143 ( struct V_65 * V_66 )
{
return F_63 ( V_66 ) -> V_147 ;
}
static void F_144 ( struct V_65 * V_66 , T_4 V_212 )
{
...
static void F_146 ( struct V_65 * V_66 ,
T_4 V_212 )
{
if ( V_212 < F_63 ( V_66 ) -> V_148 )
F_63 ( V_66 ) -> V_148 = V_212 ;
