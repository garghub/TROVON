...
V_211 = V_201 ;
return ( V_133 * V_134 * V_208 >> 3 ) + V_211 ;
}
...
F_72 ( V_168 == NULL ) ;
if ( F_81 ( V_167 ) ) {
F_77 ( & V_171 -> V_25 -> V_202 , L_4 , V_219 ) ;
return - V_220 ;
}
V_218 = F_82 ( V_150 -> type ) ?
V_99 : V_101 ;
V_168 -> V_108 = F_50 ( V_171 , V_170 -> V_156 , V_218 ) ;
V_168 -> V_133 = V_170 -> V_120 ;
V_168 -> V_134 = V_170 -> V_119 ;
if ( V_168 -> V_108 -> V_1 != V_100 ) {
if ( V_171 -> V_25 -> V_26 -> V_203 &&
V_218 == V_99 && V_171 -> V_96 == V_97 )
...
if ( V_218 == V_99 ) {
V_215 = F_83 ( & V_171 -> V_22 ,
V_221 ) ;
if ( V_215 )
F_84 ( V_215 , V_168 -> V_108 -> V_12 ) ;
V_171 -> V_222 = false ;
}
if ( ! V_171 -> V_222 &&
( ( V_171 -> V_96 == V_102 && V_218 == V_101 ) ||
( V_171 -> V_96 == V_97 && V_218 == V_99 ) ) ) {
V_171 -> V_223 . V_120 = V_170 -> V_120 ;
V_171 -> V_223 . V_119 = V_170 -> V_119 ;
}
if ( V_171 -> V_96 == V_102 &&
V_218 == V_101 &&
...
V_170 -> V_156 == V_207 &&
V_171 -> V_104 > 2 ) {
V_217 . V_120 = V_171 -> V_73 . V_133 / 2 ;
V_217 . V_119 = V_171 -> V_73 . V_134 / 2 ;
F_85 ( V_171 , & V_217 ) ;
}
return 0 ;
}
...
struct V_216 * V_224 )
{
int V_225 , V_226 , V_104 , V_227 , V_2 ;
V_225 = V_10 -> V_73 . V_133 / V_224 -> V_120 ;
V_226 = V_10 -> V_73 . V_134 / V_224 -> V_119 ;
V_104 = V_225 > V_226 ? V_225 : V_226 ;
...
V_224 -> V_120 = F_89 ( V_10 -> V_73 . V_133 / V_10 -> V_104 , 2 ) ;
V_224 -> V_119 = F_89 ( V_10 -> V_73 . V_134 / V_10 -> V_104 , 2 ) ;
V_10 -> V_223 . V_120 = V_224 -> V_120 ;
V_10 -> V_223 . V_119 = V_224 -> V_119 ;
V_10 -> V_223 . V_228 = 0 ;
V_10 -> V_223 . V_229 = 0 ;
V_10 -> V_222 = true ;
return 0 ;
}
static int F_90 ( struct V_216 * V_230 , struct V_216 * V_231 )
{
if ( V_230 -> V_228 < V_231 -> V_228 || V_230 -> V_229 < V_231 -> V_229 )
return 0 ;
if ( V_230 -> V_228 + V_230 -> V_120 > V_231 -> V_228 + V_231 -> V_120 )
return 0 ;
if ( V_230 -> V_229 + V_230 -> V_119 > V_231 -> V_229 + V_231 -> V_119 )
return 0 ;
return 1 ;
}
...
V_232 . V_229 = 0 ;
V_232 . V_228 = 0 ;
V_232 . V_120 = V_10 -> V_73 . V_133 ;
V_232 . V_119 = V_10 -> V_73 . V_134 ;
V_224 -> V_120 = F_89 ( V_224 -> V_120 , V_190 ) ;
V_224 -> V_119 = F_89 ( V_224 -> V_119 , V_191 ) ;
V_224 -> V_228 = F_89 ( V_224 -> V_228 , 2 ) ;
V_224 -> V_229 = F_89 ( V_224 -> V_229 , 2 ) ;
if ( ! F_90 ( V_224 , & V_232 ) )
return - V_4 ;
V_10 -> V_223 . V_228 = V_224 -> V_228 ;
V_10 -> V_223 . V_229 = V_224 -> V_229 ;
V_10 -> V_223 . V_120 = V_224 -> V_120 ;
V_10 -> V_223 . V_119 = V_224 -> V_119 ;
V_10 -> V_222 = true ;
return 0 ;
...
case V_238 :
case V_239 :
V_234 -> V_224 . V_120 = V_10 -> V_73 . V_133 ;
V_234 -> V_224 . V_119 = V_10 -> V_73 . V_134 ;
V_234 -> V_224 . V_228 = 0 ;
V_234 -> V_224 . V_229 = 0 ;
break;
case V_240 :
case V_241 :
case V_242 :
V_234 -> V_224 . V_120 = V_10 -> V_223 . V_120 ;
V_234 -> V_224 . V_119 = V_10 -> V_223 . V_119 ;
V_234 -> V_224 . V_228 = V_10 -> V_223 . V_228 ;
V_234 -> V_224 . V_229 = V_10 -> V_223 . V_229 ;
break;
default:
return - V_4 ;
}
...
{
struct V_9 * V_10 = F_6 ( V_83 -> V_94 ) ;
struct V_216 * V_243 = & V_234 -> V_224 ;
int V_89 = - V_4 ;
if ( V_234 -> type != V_164 )
return - V_4 ;
if ( V_234 -> V_235 == V_240 ) {
if ( V_10 -> V_96 != V_102 )
return - V_4 ;
if ( V_10 -> V_25 -> V_26 -> V_192 )
V_89 = F_85 ( V_10 , V_243 ) ;
} else if ( V_234 -> V_235 == V_236 ) {
if ( V_10 -> V_96 != V_97 )
return - V_4 ;
if ( V_10 -> V_25 -> V_26 -> V_192 )
V_89 = F_91 ( V_10 , V_243 ) ;
}
return V_89 ;
}
static int F_94 ( struct V_19 * V_244 )
{
struct V_9 * V_10 = F_4 ( V_244 ) ;
struct V_62 * V_25 = V_10 -> V_25 ;
unsigned long V_152 ;
switch ( V_244 -> V_60 ) {
case V_221 :
F_95 ( & V_25 -> V_245 , V_152 ) ;
V_244 -> V_246 = F_7 ( V_10 ) ;
F_96 ( & V_25 -> V_245 , V_152 ) ;
break;
}
return 0 ;
}
static int F_97 ( struct V_9 * V_10 , int * V_247 )
{
switch ( V_10 -> V_25 -> V_26 -> V_27 ) {
case V_28 :
return 0 ;
...
if ( V_10 -> V_73 . V_108 -> V_12 > * V_247 )
* V_247 = V_10 -> V_73 . V_108 -> V_12 ;
return 0 ;
}
static int F_98 ( struct V_19 * V_244 )
{
struct V_9 * V_10 = F_4 ( V_244 ) ;
unsigned long V_152 ;
int V_89 = 0 ;
F_95 ( & V_10 -> V_25 -> V_245 , V_152 ) ;
if ( V_244 -> V_60 == V_221 )
V_89 = F_97 ( V_10 , & V_244 -> V_246 ) ;
F_96 ( & V_10 -> V_25 -> V_245 , V_152 ) ;
return V_89 ;
}
static int F_99 ( struct V_19 * V_244 )
{
struct V_9 * V_10 = F_4 ( V_244 ) ;
unsigned long V_152 ;
F_95 ( & V_10 -> V_25 -> V_245 , V_152 ) ;
switch ( V_244 -> V_60 ) {
case V_248 :
V_10 -> V_249 = V_244 -> V_246 ;
break;
case V_250 :
V_10 -> V_251 = V_244 -> V_246 ;
break;
case V_221 :
V_10 -> V_12 = V_244 -> V_246 ;
break;
}
F_96 ( & V_10 -> V_25 -> V_245 , V_152 ) ;
return 0 ;
...
{
unsigned int V_252 = ~ 0x27 ;
struct V_19 * V_244 ;
int V_89 ;
F_100 ( & V_10 -> V_22 , 3 ) ;
if ( V_10 -> V_96 == V_97 ) {
F_101 ( & V_10 -> V_22 , & V_253 ,
V_248 ,
0 , 3 , 1 , V_254 ) ;
F_101 ( & V_10 -> V_22 , & V_253 ,
V_250 ,
...
struct V_62 * V_25 = V_10 -> V_25 ;
struct V_63 * V_258 , * V_259 ;
unsigned long V_260 , V_261 , V_152 ;
F_95 ( & V_10 -> V_25 -> V_245 , V_152 ) ;
V_258 = F_32 ( V_10 -> V_24 . V_65 ) ;
V_259 = F_105 ( V_10 -> V_24 . V_65 ) ;
V_260 = F_106 ( V_258 , 0 ) ;
V_261 = F_106 ( V_259 , 0 ) ;
F_107 ( V_25 -> V_36 ) ;
F_108 ( V_25 -> V_36 ) ;
...
F_118 ( V_25 -> V_36 , 1 , 1 , V_264 ) ;
F_118 ( V_25 -> V_36 , 1 , 2 , V_265 ) ;
F_118 ( V_25 -> V_36 , 1 , 3 , V_266 ) ;
F_118 ( V_25 -> V_36 , 2 , 1 , V_267 ) ;
F_118 ( V_25 -> V_36 , 2 , 2 , V_268 ) ;
F_118 ( V_25 -> V_36 , 2 , 3 , V_269 ) ;
F_118 ( V_25 -> V_36 , 3 , 1 , V_270 ) ;
F_118 ( V_25 -> V_36 , 3 , 2 , V_271 ) ;
F_118 ( V_25 -> V_36 , 3 , 3 , V_272 ) ;
F_11 ( V_25 -> V_36 , V_10 -> V_249 ) ;
F_13 ( V_25 -> V_36 , V_10 -> V_249 ) ;
F_119 ( V_25 -> V_36 , 1 , 0 ) ;
F_119 ( V_25 -> V_36 , 2 , 1 ) ;
F_119 ( V_25 -> V_36 , 3 , 1 ) ;
F_120 ( V_25 -> V_36 , 1 ) ;
...
F_125 ( V_25 -> V_36 , V_274 ) ;
F_116 ( V_25 -> V_36 , V_260 ) ;
F_115 ( V_25 -> V_36 , V_261 ) ;
}
F_126 ( V_25 -> V_36 ) ;
F_96 ( & V_10 -> V_25 -> V_245 , V_152 ) ;
}
...
V_276 . V_279 = 0 ;
V_276 . V_280 = 0 ;
V_277 = V_10 -> V_109 . V_133 * V_10 -> V_109 . V_134 ;
if ( V_10 -> V_96 == V_97 ) {
V_64 = F_32 ( V_10 -> V_24 . V_65 ) ;
V_108 = V_10 -> V_73 . V_108 ;
if ( V_10 -> V_73 . V_133 % 2 && V_108 -> V_199 > 0 )
V_278 = V_10 -> V_73 . V_134 ;
} else {
V_108 = V_10 -> V_109 . V_108 ;
V_64 = F_105 ( V_10 -> V_24 . V_65 ) ;
}
V_276 . V_281 = F_106 ( V_64 , 0 ) ;
if ( V_108 -> V_177 == 2 ) {
V_276 . V_279 = V_276 . V_281 + V_277 - V_278 ;
} else if ( V_108 -> V_177 == 3 ) {
V_276 . V_279 = V_276 . V_281 + V_277 ;
if ( V_108 -> V_1 == V_207 )
V_276 . V_280 = V_276 . V_279 + V_277 / 4 ;
else
V_276 . V_280 = V_276 . V_279 + V_277 / 2 ;
}
F_128 ( V_25 -> V_36 , & V_276 ) ;
}
...
V_10 -> V_96 == V_102 )
V_276 += V_10 -> V_73 . V_74 ;
F_130 ( V_25 -> V_36 , V_276 ) ;
}
static inline void F_131 ( void T_2 * V_50 ,
unsigned int V_282 )
{
F_132 ( V_50 , V_282 , V_33 ) ;
}
static inline void F_133 ( void T_2 * V_50 ,
unsigned int V_282 )
{
F_132 ( V_50 , V_282 , V_34 ) ;
}
...
F_140 ( V_25 -> V_36 , 1 ) ;
F_27 ( V_25 -> V_36 ) ;
F_24 ( V_25 -> V_36 , V_10 -> V_249 ) ;
F_26 ( V_25 -> V_36 , V_10 -> V_249 ) ;
F_141 ( V_25 -> V_36 ,
V_10 -> V_249 ) ;
...
V_283 = F_144 ( V_10 -> V_73 . V_71 , 16 ) ;
} else {
F_131 ( V_25 -> V_36 ,
V_10 -> V_109 . V_108 -> V_1 ) ;
V_283 = F_144 ( V_10 -> V_73 . V_71 , 32 ) ;
}
F_145 ( V_25 -> V_36 , V_283 ) ;
}
...
F_160 ( V_25 -> V_36 , 3 ) ;
F_161 ( V_25 -> V_36 , 3 ) ;
F_162 ( V_25 -> V_36 , V_10 -> V_223 . V_120 ) ;
F_163 ( V_25 -> V_36 , V_10 -> V_223 . V_119 ) ;
F_164 ( V_25 -> V_36 , V_10 -> V_73 . V_108 -> V_1 ,
V_10 -> V_73 . V_133 ) ;
F_165 ( V_25 -> V_36 , V_10 -> V_223 . V_228 ,
V_10 -> V_223 . V_229 ) ;
F_147 ( V_10 ) ;
F_149 ( V_10 ) ;
...
if ( V_10 -> V_73 . V_108 -> V_1 == V_98 ||
V_10 -> V_73 . V_108 -> V_1 == V_285 ||
V_10 -> V_73 . V_108 -> V_1 == V_212 )
...
unsigned int V_290 [] , struct V_291 * V_292 [] )
{
struct V_9 * V_10 = F_179 ( V_167 ) ;
struct V_113 * V_168 = NULL ;
unsigned int V_71 , V_293 = * V_288 ;
...
static int F_190 ( struct V_166 * V_298 , unsigned int V_293 )
{
...
V_259 -> V_324 = V_258 -> V_324 ;
V_259 -> V_325 . V_326 = V_258 -> V_325 . V_326 ;
V_259 -> V_152 &= ~ V_327 ;
V_259 -> V_152 |=
V_258 -> V_152 & V_327 ;
F_207 ( V_258 , V_319 ) ;
if ( V_316 -> V_96 == V_97 )
F_183 ( & V_259 -> V_325 , 0 , V_317 ) ;
F_207 ( V_259 , V_319 ) ;
...
T_1 V_287 ;
F_196 ( & V_25 -> V_245 ) ;
V_287 = F_217 ( V_25 -> V_36 ) ;
if ( V_287 & V_340 ) {
F_218 ( V_25 -> V_36 ) ;
V_339 = true ;
F_219 ( V_25 -> V_299 , L_6 ) ;
}
V_287 = F_220 ( V_25 -> V_36 ) ;
F_221 ( V_25 -> V_36 , V_287 ) ;
V_25 -> V_287 |= V_287 ;
V_316 = F_197 ( V_25 -> V_106 ) ;
if ( ! V_316 )
goto V_341;
...
snprintf ( V_25 -> V_369 -> V_155 , sizeof( V_25 -> V_369 -> V_155 ) ,
L_16 , V_140 ) ;
...
F_247 ( V_25 -> V_106 ) ;
F_248 ( & V_25 -> V_202 ) ;
if ( ! F_253 ( & V_348 -> V_299 ) ) {
for ( V_2 = V_25 -> V_26 -> V_353 - 1 ; V_2 >= 0 ; V_2 -- )
F_254 ( V_25 -> V_354 [ V_2 ] ) ;
}
return 0 ;
}
static int F_255 ( struct V_291 * V_299 )
{
struct V_62 * V_25 = F_256 ( V_299 ) ;
int V_2 ;
for ( V_2 = V_25 -> V_26 -> V_353 - 1 ; V_2 >= 0 ; V_2 -- )
F_254 ( V_25 -> V_354 [ V_2 ] ) ;
return 0 ;
}
static int F_257 ( struct V_291 * V_299 )
{
struct V_62 * V_25 = F_256 ( V_299 ) ;
unsigned long V_152 ;
int V_2 , V_89 ;
...
static int F_259 ( struct V_291 * V_299 )
{
if ( F_260 ( V_299 ) )
return 0 ;
return F_255 ( V_299 ) ;
}
static int F_261 ( struct V_291 * V_299 )
{
if ( F_260 ( V_299 ) )
return 0 ;
return F_257 ( V_299 ) ;
}
static void * F_227 ( struct V_291 * V_299 )
{
struct V_371 * V_372 = NULL ;
const struct V_373 * V_374 ;
if ( ! F_262 ( V_375 ) || ! V_299 -> V_376 )
return & V_377 ;
V_374 = F_263 ( V_378 , V_299 -> V_376 ) ;
if ( V_374 )
