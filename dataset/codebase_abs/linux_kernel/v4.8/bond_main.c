...
V_26 = F_147 ( V_15 , V_11 -> V_16 -> V_230 ) ;
if ( V_26 ) {
F_55 ( V_19 , L_38 , V_26 ) ;
goto V_231;
}
F_59 ( V_208 -> V_232 , V_15 -> V_86 ) ;
if ( ! V_11 -> V_52 . V_94 ||
F_20 ( V_11 ) != V_4 ) {
...
V_26 = F_148 ( V_15 ) ;
if ( V_26 ) {
F_55 ( V_19 , L_40 , V_15 -> V_59 ) ;
goto V_234;
}
V_15 -> V_160 |= V_235 ;
F_149 ( V_208 -> V_16 , & V_208 -> V_236 ) ;
if ( F_16 ( V_11 ) ) {
...
if ( F_34 ( V_11 ) && V_11 -> V_52 . V_243 [ 0 ] ) {
...
if ( ! V_11 -> V_52 . V_94 ||
F_20 ( V_11 ) != V_4 ) {
F_59 ( V_210 . V_97 , V_208 -> V_232 ) ;
V_210 . V_98 = V_15 -> type ;
F_60 ( V_15 , & V_210 ) ;
}
V_233:
F_147 ( V_15 , V_208 -> V_229 ) ;
V_231:
F_123 ( V_208 ) ;
V_224:
if ( ! F_19 ( V_11 ) ) {
...
V_15 -> V_59 ) ;
V_252 = F_160 ( V_11 -> V_69 ) ;
F_171 ( V_11 -> V_256 , NULL ) ;
if ( ! V_251 && ( ! V_11 -> V_52 . V_94 ||
F_20 ( V_11 ) != V_4 ) ) {
if ( F_174 ( V_19 -> V_86 , V_22 -> V_232 ) &&
F_19 ( V_11 ) )
F_140 ( V_19 , L_63 ,
...
F_20 ( V_11 ) != V_4 ) {
F_59 ( V_210 . V_97 , V_22 -> V_232 ) ;
V_210 . V_98 = V_15 -> type ;
F_60 ( V_15 , & V_210 ) ;
}
F_147 ( V_15 , V_22 -> V_229 ) ;
V_15 -> V_160 &= ~ V_235 ;
F_123 ( V_22 ) ;
return 0 ;
}
...
V_270:
if ( V_11 -> V_52 . V_117 )
F_42 ( V_11 -> V_73 , & V_11 -> V_269 , V_111 ) ;
if ( V_119 ) {
if ( ! F_41 () )
return;
...
static bool F_192 ( struct V_10 * V_11 , T_7 V_271 )
{
struct V_14 * V_272 ;
struct V_24 * V_25 ;
bool V_169 = false ;
if ( V_271 == F_193 ( V_11 -> V_16 , 0 , V_271 ) )
return true ;
F_66 () ;
F_194 (bond->dev, upper, iter) {
if ( V_271 == F_193 ( V_272 , 0 , V_271 ) ) {
V_169 = true ;
break;
}
}
...
struct V_24 * V_25 ;
if ( V_284 == V_285 ) {
V_277 = F_82 ( sizeof( * V_277 ) * ( V_286 + 1 ) , V_171 ) ;
if ( ! V_277 )
return F_203 ( - V_128 ) ;
...
V_277 = F_202 ( V_272 , V_285 , V_286 + 1 ) ;
if ( F_205 ( V_277 ) ) {
if ( F_206 ( V_277 ) )
return V_277 ;
continue;
...
if ( F_207 ( V_272 ) ) {
V_277 [ V_286 ] . V_280 = F_208 ( V_272 ) ;
V_277 [ V_286 ] . V_283 = F_209 ( V_272 ) ;
}
return V_277 ;
}
return NULL ;
...
F_55 ( V_11 -> V_16 , L_83 , & V_289 [ V_212 ] ) ;
V_277 = NULL ;
...
continue;
V_295:
V_210 = F_193 ( V_288 -> V_294 . V_16 , V_289 [ V_212 ] , 0 ) ;
F_214 ( V_288 ) ;
F_195 ( V_22 -> V_16 , V_293 , V_289 [ V_212 ] ,
V_210 , V_277 ) ;
F_84 ( V_277 ) ;
...
int V_316 )
{
int V_317 = F_156 ( V_11 -> V_52 . V_239 ) ;
return F_230 ( V_116 ,
V_315 - V_317 ,
...
V_270:
if ( V_11 -> V_52 . V_239 )
F_42 ( V_11 -> V_73 , & V_11 -> V_318 ,
F_156 ( V_11 -> V_52 . V_239 ) ) ;
}
...
F_77 ( V_300 , V_265 ) ;
F_89 (bond, slave, iter) {
if ( ! V_295 && ! V_321 && F_64 ( V_22 ) )
V_321 = V_22 ;
if ( V_295 && ! V_208 && F_64 ( V_22 ) )
V_208 = V_22 ;
...
V_270:
if ( V_11 -> V_52 . V_239 )
F_42 ( V_11 -> V_73 , & V_11 -> V_318 , V_317 ) ;
if ( V_119 || V_322 ) {
if ( ! F_41 () )
return;
if ( V_119 )
...
F_135 ( & V_11 -> V_72 ,
F_39 ) ;
F_135 ( & V_11 -> V_367 , V_368 ) ;
F_135 ( & V_11 -> V_269 , F_191 ) ;
if ( F_20 ( V_11 ) == V_4 )
F_135 ( & V_11 -> V_318 , F_237 ) ;
else
F_135 ( & V_11 -> V_318 , F_231 ) ;
F_135 ( & V_11 -> V_369 , V_370 ) ;
...
return - V_128 ;
if ( V_11 -> V_52 . V_373 )
F_42 ( V_11 -> V_73 , & V_11 -> V_367 , 0 ) ;
}
if ( V_11 -> V_52 . V_117 )
F_42 ( V_11 -> V_73 , & V_11 -> V_269 , 0 ) ;
if ( V_11 -> V_52 . V_239 ) {
F_42 ( V_11 -> V_73 , & V_11 -> V_318 , 0 ) ;
V_11 -> F_107 = F_217 ;
}
if ( F_20 ( V_11 ) == V_7 ) {
F_42 ( V_11 -> V_73 , & V_11 -> V_369 , 0 ) ;
V_11 -> F_107 = V_374 ;
F_269 ( V_11 , 1 ) ;
}
if ( F_167 ( V_11 ) )
...
static struct V_375 * F_179 ( struct V_14 * V_19 ,
struct V_375 * V_383 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_375 V_384 ;
...
return - V_398 ;
V_26 = F_186 ( V_19 , & V_387 ) ;
if ( V_26 == 0 &&
F_277 ( V_388 , & V_387 , sizeof( V_190 ) ) )
return - V_398 ;
return V_26 ;
case V_399 :
case V_400 :
...
F_55 ( V_19 , L_102 , V_15 ) ;
if ( ! V_15 )
return - V_259 ;
F_55 ( V_19 , L_103 , V_15 -> V_59 ) ;
switch ( V_386 ) {
case V_404 :
case V_405 :
...
struct V_24 * V_25 ;
int V_26 = 0 ;
F_55 ( V_19 , L_104 , V_11 , V_421 ) ;
F_12 (bond, slave, iter) {
F_55 ( V_19 , L_105 ,
V_22 , V_22 -> V_16 -> V_47 -> V_422 ) ;
V_26 = F_147 ( V_22 -> V_16 , V_421 ) ;
if ( V_26 ) {
F_55 ( V_19 , L_106 , V_26 ,
V_22 -> V_16 -> V_59 ) ;
goto V_27;
}
}
...
if ( V_23 == V_22 )
break;
V_423 = F_147 ( V_23 -> V_16 , V_19 -> V_230 ) ;
if ( V_423 ) {
F_55 ( V_19 , L_107 ,
...
return - V_426 ;
F_12 (bond, slave, iter) {
F_55 ( V_19 , L_109 , V_22 , V_22 -> V_16 -> V_59 ) ;
V_26 = F_60 ( V_22 -> V_16 , V_210 ) ;
if ( V_26 ) {
F_55 ( V_19 , L_106 , V_26 , V_22 -> V_16 -> V_59 ) ;
goto V_27;
}
}
...
{
F_42 ( V_11 -> V_73 , & V_11 -> V_371 , V_111 ) ;
}
...
int F_168 ( struct V_10 * V_11 , struct V_22 * V_433 )
{
struct V_22 * V_22 ;
struct V_24 * V_25 ;
...
#endif
V_435 = F_82 ( F_305 ( struct V_434 , V_439 [ V_11 -> V_194 ] ) ,
V_127 ) ;
if ( ! V_435 ) {
V_169 = - V_128 ;
F_306 ( L_111 ) ;
...
F_307 ( L_112 ) ;
F_308 ( V_435 , V_440 ) ;
V_436 = F_35 ( V_11 -> V_441 ) ;
if ( V_436 ) {
F_171 ( V_11 -> V_441 , NULL ) ;
F_308 ( V_436 , V_440 ) ;
}
goto V_99;
}
...
struct V_434 * V_444 ;
unsigned int V_442 ;
V_444 = F_67 ( V_11 -> V_441 ) ;
V_442 = V_444 ? F_110 ( V_444 -> V_442 ) : 0 ;
if ( F_298 ( V_442 ) ) {
...
F_325 ( V_32 , V_33 ? : V_34 ) ;
return 0 ;
}
static void F_326 ( struct V_14 * V_19 ,
struct V_454 * V_455 )
{
F_327 ( V_455 -> V_456 , V_457 , sizeof( V_455 -> V_456 ) ) ;
F_327 ( V_455 -> V_458 , V_459 , sizeof( V_455 -> V_458 ) ) ;
snprintf ( V_455 -> V_460 , sizeof( V_455 -> V_460 ) , L_115 ,
V_461 ) ;
}
static void F_328 ( struct V_14 * V_19 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
if ( V_11 -> V_73 )
F_329 ( V_11 -> V_73 ) ;
...
static int F_337 ( struct V_476 * V_52 )
{
...
T_7 V_271 ;
if ( ! F_345 ( V_506 [ V_212 ] , - 1 , ( T_4 * ) & V_271 , - 1 , NULL ) ||
! F_346 ( V_271 ) ) {
F_341 ( L_142 ,
V_506 [ V_212 ] ) ;
V_239 = 0 ;
} else {
if ( F_216 ( V_507 , V_271 ) == - 1 )
V_507 [ V_505 ++ ] = V_271 ;
else
F_341 ( L_143 ,
& V_271 ) ;
...
F_348 ( L_150 , V_506 [ V_212 ] ) ;
F_348 ( L_151 ) ;
} else if ( V_495 ) {
F_307 ( L_152 ) ;
}
if ( V_243 && ! F_349 ( V_192 ) ) {
F_341 ( L_153 ,
V_243 , F_1 ( V_192 ) ) ;
V_243 = NULL ;
}
...
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_520 * V_521 = F_352 ( F_212 ( V_19 ) , V_522 ) ;
F_55 ( V_19 , L_161 ) ;
V_11 -> V_73 = F_353 ( V_19 -> V_59 ) ;
if ( ! V_11 -> V_73 )
return - V_128 ;
F_354 ( V_19 ) ;
F_355 ( & V_11 -> V_475 , & V_521 -> V_523 ) ;
F_356 ( V_11 ) ;
F_357 ( V_11 ) ;
if ( F_358 ( V_19 -> V_86 ) &&
V_19 -> V_87 == V_524 )
...
int F_360 ( struct V_393 * V_393 , const char * V_59 )
{
struct V_14 * V_19 ;
struct V_10 * V_11 ;
struct V_525 * V_526 ;
...
static int T_13 F_365 ( struct V_393 * V_393 )
{
struct V_520 * V_521 = F_352 ( V_393 , V_522 ) ;
V_521 -> V_393 = V_393 ;
F_366 ( & V_521 -> V_523 ) ;
F_367 ( V_521 ) ;
F_368 ( V_521 ) ;
...
static void T_14 F_369 ( struct V_393 * V_393 )
{
struct V_520 * V_521 = F_352 ( V_393 , V_522 ) ;
struct V_10 * V_11 , * V_532 ;
F_370 ( V_533 ) ;
F_371 ( V_521 ) ;
F_129 () ;
F_372 (bond, tmp_bond, &bn->dev_list, bond_list)
F_373 ( V_11 -> V_16 , & V_533 ) ;
F_374 ( & V_533 ) ;
F_44 () ;
F_375 ( V_521 ) ;
}
static int T_15 F_376 ( void )
{
int V_212 ;
int V_26 ;
F_340 ( L_164 , V_534 ) ;
