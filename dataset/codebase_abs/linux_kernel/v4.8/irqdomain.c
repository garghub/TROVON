...
V_47 = F_54 ( - 1 , 1 , V_42 , F_12 ( V_18 ) , NULL ) ;
if ( V_47 <= 0 ) {
F_19 ( L_19 ) ;
return 0 ;
}
...
V_81 = ( V_56 == V_42 ) && ( V_56 < V_16 -> V_21 ) ;
F_73 ( V_70 , L_46 ,
( V_42 < V_16 -> V_20 ) ? L_47 : L_48 ,
V_81 ? L_49 : L_30 ) ;
F_73 ( V_70 , L_50 , V_74 -> V_41 . V_16 -> V_5 ) ;
}
F_79 ( & V_74 -> V_79 , V_72 ) ;
}
return 0 ;
...
int F_84 ( struct V_9 * V_58 , struct V_17 * V_90 ,
...
int F_85 ( struct V_9 * V_58 , struct V_17 * V_90 ,
const T_3 * V_91 , unsigned int V_92 ,
...
struct V_9 * V_16 ;
if ( V_10 )
V_16 = F_89 ( V_7 , V_10 , V_14 , V_15 ) ;
else
V_16 = F_90 ( V_7 , V_14 , V_15 ) ;
if ( V_16 ) {
V_16 -> V_101 = V_101 ;
V_16 -> V_72 |= V_72 ;
}
...
static struct V_41 * F_93 ( struct V_9 * V_16 ,
struct V_41 * V_103 )
{
struct V_41 * V_41 ;
...
static int F_96 ( struct V_9 * V_16 ,
...
V_41 = F_37 ( V_47 + V_56 ) ;
V_41 -> V_16 = V_16 ;
for ( V_101 = V_16 -> V_101 ; V_101 ; V_101 = V_101 -> V_101 ) {
...
struct V_41 * F_68 ( struct V_9 * V_16 ,
unsigned int V_47 )
{
struct V_41 * V_41 ;
...
int F_97 ( struct V_9 * V_16 , unsigned int V_47 ,
T_1 V_42 , struct V_80 * V_52 ,
void * V_106 )
{
struct V_41 * V_41 = F_68 ( V_16 , V_47 ) ;
if ( ! V_41 )
return - V_107 ;
V_41 -> V_42 = V_42 ;
...
void F_98 ( struct V_9 * V_16 , unsigned int V_47 ,
T_1 V_42 , struct V_80 * V_52 ,
void * V_106 , T_4 V_83 ,
void * V_109 , const char * V_110 )
{
F_97 ( V_16 , V_47 , V_42 , V_52 , V_106 ) ;
...
void F_102 ( struct V_9 * V_16 , unsigned int V_47 ,
unsigned int V_78 )
{
struct V_41 * V_41 ;
int V_56 ;
for ( V_56 = 0 ; V_56 < V_78 ; V_56 ++ ) {
V_41 = F_68 ( V_16 , V_47 + V_56 ) ;
if ( V_41 )
F_101 ( V_41 ) ;
}
F_103 ( V_16 , V_47 , V_78 ) ;
}
void F_104 ( struct V_9 * V_16 , unsigned int V_47 ,
unsigned int V_78 )
{
int V_56 ;
for ( V_56 = 0 ; V_56 < V_78 ; V_56 ++ ) {
...
F_102 ( V_16 , V_47 , V_78 ) ;
}
static bool F_106 ( struct V_9 * V_16 )
{
return V_16 -> V_72 & V_111 ;
}
static void F_107 ( struct V_9 * V_16 ,
unsigned int V_53 ,
unsigned int V_78 )
{
V_16 -> V_14 -> free ( V_16 , V_53 , V_78 ) ;
if ( F_106 ( V_16 ) ) {
F_108 ( ! V_16 -> V_101 ) ;
F_107 ( V_16 -> V_101 , V_53 ,
V_78 ) ;
}
}
int F_109 ( struct V_9 * V_16 ,
unsigned int V_53 ,
unsigned int V_78 , void * V_112 )
{
int V_48 = 0 ;
struct V_9 * V_101 = V_16 -> V_101 ;
bool V_113 = F_106 ( V_16 ) ;
F_108 ( V_113 && ! V_101 ) ;
if ( V_113 )
...
if ( V_48 < 0 )
return V_48 ;
V_48 = V_16 -> V_14 -> V_114 ( V_16 , V_53 , V_78 , V_112 ) ;
if ( V_48 < 0 && V_113 )
F_107 ( V_101 , V_53 , V_78 ) ;
return V_48 ;
}
int F_110 ( struct V_9 * V_16 , int V_53 ,
...
if ( F_96 ( V_16 , V_47 , V_78 ) ) {
F_19 ( L_55 , V_47 ) ;
V_48 = - V_89 ;
goto V_116;
}
F_16 ( & V_22 ) ;
V_48 = F_109 ( V_16 , V_47 , V_78 , V_112 ) ;
if ( V_48 < 0 ) {
F_18 ( & V_22 ) ;
goto V_117;
}
...
V_16 = V_16 -> V_101 ;
if ( V_16 )
return F_109 ( V_16 , V_53 ,
V_78 , V_112 ) ;
return - V_115 ;
}
void F_103 ( struct V_9 * V_16 ,
unsigned int V_53 , unsigned int V_78 )
{
if ( ! F_106 ( V_16 ) && V_16 -> V_101 )
F_107 ( V_16 -> V_101 , V_53 ,
V_78 ) ;
}
