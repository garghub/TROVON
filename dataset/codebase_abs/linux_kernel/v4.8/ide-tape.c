...
static void F_114 ( struct V_252 * V_10 )
{
struct V_1 * V_6 = F_115 ( V_10 , V_1 ) ;
T_1 * V_9 = V_6 -> V_9 ;
struct V_2 * V_253 = V_6 -> V_3 ;
F_34 ( V_6 -> V_122 ) ;
V_9 -> V_85 &= ~ V_86 ;
V_9 -> V_11 = NULL ;
F_116 ( V_254 , F_117 ( V_255 , V_6 -> V_215 ) ) ;
F_116 ( V_254 ,
F_117 ( V_255 , V_6 -> V_215 + 128 ) ) ;
V_8 [ V_6 -> V_215 ] = NULL ;
V_253 -> V_168 = NULL ;
F_118 ( V_253 ) ;
F_57 ( V_6 ) ;
}
static int F_119 ( struct V_256 * V_257 , void * V_258 )
{
T_1 * V_9 = ( T_1 * ) V_257 -> V_259 ;
T_2 * V_6 = V_9 -> V_11 ;
F_120 ( V_257 , L_53 , V_6 -> V_59 ) ;
return 0 ;
}
static int F_121 ( struct V_213 * V_213 , struct V_166 * V_166 )
{
return F_122 ( V_166 , F_119 , F_123 ( V_213 ) ) ;
}
static T_11 * F_124 ( T_1 * V_9 )
{
return V_260 ;
}
static const struct V_261 * F_125 ( T_1 * V_9 )
{
return V_262 ;
}
static int F_126 ( struct V_263 * V_264 , T_12 V_265 )
{
struct V_1 * V_6 ;
F_2 ( & V_211 ) ;
...
static void F_127 ( struct V_2 * V_3 , T_12 V_265 )
{
...
static int F_128 ( struct V_263 * V_264 , T_12 V_265 ,
unsigned int V_24 , unsigned long V_148 )
{
...
int V_39 ;
F_2 ( & V_211 ) ;
V_39 = F_129 ( V_9 , V_264 , V_24 , V_148 ) ;
if ( V_39 == - V_267 )
V_39 = F_76 ( V_9 , V_24 , V_148 ) ;
F_6 ( & V_211 ) ;
return V_39 ;
}
static int F_130 ( T_1 * V_9 )
{
T_2 * V_6 ;
struct V_2 * V_253 ;
int V_215 ;
...
V_6 -> V_10 . V_278 = F_114 ;
F_135 ( & V_6 -> V_10 , L_57 , F_136 ( & V_9 -> V_277 ) ) ;
if ( F_137 ( & V_6 -> V_10 ) )
goto V_279;
V_6 -> V_9 = V_9 ;
V_6 -> V_251 = & V_280 ;
...
F_6 ( & V_7 ) ;
F_105 ( V_9 , V_6 , V_215 ) ;
F_138 ( V_254 , & V_9 -> V_277 ,
F_117 ( V_255 , V_215 ) , NULL , L_57 , V_6 -> V_59 ) ;
F_138 ( V_254 , & V_9 -> V_277 ,
F_117 ( V_255 , V_215 + 128 ) , NULL ,
L_58 , V_6 -> V_59 ) ;
V_253 -> V_281 = & V_282 ;
F_139 ( V_253 ) ;
return 0 ;
...
static int T_14 F_144 ( void )
{
int error = 1 ;
V_254 = F_145 ( V_285 , L_60 ) ;
if ( F_146 ( V_254 ) ) {
V_254 = NULL ;
F_17 ( V_42 L_61 ) ;
error = - V_224 ;
...
if ( F_147 ( V_255 , L_59 , & V_286 ) ) {
F_17 ( V_42 L_62
L_63 ) ;
error = - V_224 ;
goto V_287;
}
error = F_148 ( & V_280 . V_284 ) ;
if ( error )
goto V_288;
return 0 ;
V_288:
