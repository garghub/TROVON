...
static struct V_13 * F_35 ( struct V_2 * V_3 ,
struct V_11 * V_12 ,
struct V_1 * V_7 )
{
struct V_13 * V_80 , * V_81 ;
V_80 = F_23 ( V_7 -> V_5 , V_7 -> V_6 , V_7 -> V_29 ) ;
if ( V_80 && V_80 -> V_15 == V_3 -> V_79 -> V_15 ) {
V_81 = F_36 ( V_3 -> V_79 ,
V_80 -> V_17 ) ;
if ( V_81 )
return V_81 ;
...
V_7 -> type == V_34 )
break;
V_80 = F_23 ( V_7 -> V_5 , V_7 -> V_6 ,
V_7 -> V_29 ) ;
if ( V_80 && V_80 -> V_15 == V_3 -> V_79 -> V_15 )
return F_36 ( V_3 -> V_79 ,
V_80 -> V_17 ) ;
}
return NULL ;
}
...
struct V_13 * V_13 , * V_84 = NULL ;
int V_36 ;
F_7 (file, func, insn) {
if ( V_7 -> type != V_34 )
continue;
V_13 = F_35 ( V_3 , V_12 , V_7 ) ;
if ( ! V_13 )
continue;
if ( V_83 ) {
V_36 = F_33 ( V_3 , V_12 , V_83 , V_84 ,
V_13 ) ;
if ( V_36 )
return V_36 ;
}
...
if ( V_83 ) {
V_36 = F_33 ( V_3 , V_12 , V_83 , V_84 , NULL ) ;
if ( V_36 )
return V_36 ;
}
return 0 ;
...
static unsigned int F_44 ( unsigned long V_86 )
{
...
int F_55 ( int V_103 , const char * * V_104 )
{
struct V_2 V_3 ;
int V_36 , V_100 = 0 ;
const struct V_105 V_106 [] = {
F_56 ( 'f' , L_39 , & V_93 , L_40 ) ,
F_57 () ,
} ;
V_103 = F_58 ( V_103 , V_104 , V_106 , V_107 , 0 ) ;
if ( V_103 != 1 )
F_59 ( V_107 , V_106 ) ;
V_108 = V_104 [ 0 ] ;
V_3 . V_40 = F_60 ( V_108 ) ;
...
F_15 ( & V_3 . V_10 ) ;
F_61 ( V_3 . V_43 ) ;
V_3 . V_14 = F_62 ( V_3 . V_40 , L_42 ) ;
V_3 . V_79 = F_62 ( V_3 . V_40 , L_43 ) ;
V_3 . V_82 = false ;
V_3 . V_91 = F_62 ( V_3 . V_40 , L_44 ) ;
V_36 = F_40 ( & V_3 ) ;
if ( V_36 < 0 )
goto V_73;
V_100 += V_36 ;
