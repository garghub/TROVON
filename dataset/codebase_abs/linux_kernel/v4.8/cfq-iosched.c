...
if ( F_91 () < V_246 -> V_261 )
V_246 = NULL ;
F_92 ( V_55 -> V_51 , V_55 , L_22 , V_246 ) ;
return V_246 ;
}
static inline int
...
if ( ! V_51 -> V_265 ) {
struct V_63 * V_69 = F_297 ( V_246 ) ;
F_298 ( & V_69 -> V_65 . V_67 -> V_304 ) ;
V_51 -> V_265 = V_69 ;
}
return true ;
}
static int F_299 ( struct V_252 * V_48 , int V_305 )
{
struct V_50 * V_51 = V_48 -> V_71 -> V_72 ;
struct V_54 * V_55 ;
if ( ! V_51 -> V_77 )
...
static void F_301 ( struct V_54 * V_55 )
{
...
static void F_303 ( struct V_50 * V_51 , struct V_54 * V_55 )
{
...
static void F_304 ( struct V_64 * V_65 )
{
...
if ( F_68 ( V_69 , false ) ) {
F_303 ( V_51 , F_68 ( V_69 , false ) ) ;
F_69 ( V_69 , NULL , false ) ;
}
if ( F_68 ( V_69 , true ) ) {
F_303 ( V_51 , F_68 ( V_69 , true ) ) ;
F_69 ( V_69 , NULL , true ) ;
}
}
static void F_306 ( struct V_54 * V_55 , struct V_63 * V_69 )
{
struct V_249 * V_250 = V_251 ;
int V_307 ;
if ( ! F_307 ( V_55 ) )
return;
V_307 = F_308 ( V_69 -> V_86 ) ;
switch ( V_307 ) {
default:
F_309 ( V_308 L_28 , V_307 ) ;
case V_309 :
V_55 -> V_86 = F_310 ( V_250 ) ;
V_55 -> V_307 = F_311 ( V_250 ) ;
break;
case V_310 :
V_55 -> V_86 = F_312 ( V_69 -> V_86 ) ;
V_55 -> V_307 = V_310 ;
break;
case V_311 :
V_55 -> V_86 = F_312 ( V_69 -> V_86 ) ;
...
static void F_314 ( struct V_63 * V_69 , struct V_73 * V_73 )
{
...
if ( V_55 ) {
F_152 ( V_55 ) ;
V_55 = F_315 ( V_51 , V_297 , V_69 , V_73 ) ;
...
static void F_317 ( struct V_50 * V_51 , struct V_54 * V_55 ,
T_9 V_314 , bool V_70 )
{
F_106 ( & V_55 -> V_131 ) ;
F_106 ( & V_55 -> V_240 ) ;
...
static void F_321 ( struct V_63 * V_69 , struct V_73 * V_73 )
{
struct V_50 * V_51 = F_70 ( V_69 ) ;
struct V_54 * V_55 ;
T_1 V_315 ;
F_322 () ;
V_315 = F_323 ( V_73 ) -> V_36 . V_315 ;
F_324 () ;
...
static inline void F_321 ( struct V_63 * V_69 , struct V_73 * V_73 ) { }
static struct V_54 * *
F_325 ( struct V_2 * V_3 , int V_307 , int V_86 )
{
switch ( V_307 ) {
case V_310 :
...
static struct V_54 *
F_315 ( struct V_50 * V_51 , bool V_70 , struct V_63 * V_69 ,
struct V_73 * V_73 )
{
int V_307 = F_308 ( V_69 -> V_86 ) ;
int V_86 = F_312 ( V_69 -> V_86 ) ;
struct V_54 * * V_184 = NULL ;
struct V_54 * V_55 ;
struct V_2 * V_3 ;
F_322 () ;
V_3 = F_155 ( V_51 , F_323 ( V_73 ) ) ;
if ( ! V_3 ) {
V_55 = & V_51 -> V_318 ;
goto V_213;
}
...
V_184 = F_325 ( V_3 , V_307 , V_86 ) ;
V_55 = * V_184 ;
if ( V_55 )
goto V_213;
}
V_55 = F_328 ( V_306 , V_319 | V_320 ,
V_51 -> V_68 -> V_140 ) ;
if ( ! V_55 ) {
V_55 = & V_51 -> V_318 ;
goto V_213;
}
F_317 ( V_51 , V_55 , V_251 -> V_314 , V_70 ) ;
F_306 ( V_55 , V_69 ) ;
F_158 ( V_55 , V_3 ) ;
F_92 ( V_51 , V_55 , L_30 ) ;
if ( V_184 ) {
...
static void
F_329 ( struct V_321 * V_172 , T_2 V_322 )
{
...
V_172 -> V_274 = F_330 ( V_172 -> V_324 + 128 ,
V_172 -> V_273 ) ;
}
static void
F_331 ( struct V_50 * V_51 , struct V_54 * V_55 ,
struct V_63 * V_69 )
{
if ( F_61 ( V_55 ) ) {
F_329 ( & V_69 -> V_172 , V_51 -> V_52 ) ;
F_329 ( & V_55 -> V_236 -> V_172 ,
V_51 -> V_52 ) ;
}
#ifdef F_332
F_329 ( & V_55 -> V_3 -> V_172 , V_51 -> V_270 ) ;
#endif
}
static void
F_333 ( struct V_50 * V_51 , struct V_54 * V_55 ,
struct V_115 * V_246 )
{
T_4 V_325 = 0 ;
...
static bool
F_337 ( struct V_50 * V_51 , struct V_54 * V_233 ,
struct V_115 * V_246 )
{
struct V_54 * V_55 ;
V_55 = V_51 -> V_262 ;
...
static void F_338 ( struct V_50 * V_51 , struct V_54 * V_55 )
{
...
static void
F_339 ( struct V_50 * V_51 , struct V_54 * V_55 ,
struct V_115 * V_246 )
{
struct V_63 * V_69 = F_297 ( V_246 ) ;
V_51 -> V_255 ++ ;
if ( V_246 -> V_125 & V_126 )
V_55 -> V_256 ++ ;
F_331 ( V_51 , V_55 , V_69 ) ;
F_333 ( V_51 , V_55 , V_246 ) ;
F_334 ( V_51 , V_55 , V_69 ) ;
V_55 -> V_327 = F_99 ( V_246 ) + F_226 ( V_246 ) ;
if ( V_55 == V_51 -> V_262 ) {
if ( F_249 ( V_55 ) ) {
if ( F_340 ( V_246 ) > V_335 ||
V_51 -> V_77 > 1 ) {
F_240 ( V_51 , V_55 ) ;
F_243 ( V_55 ) ;
F_341 ( V_51 -> V_68 ) ;
...
if ( V_55 )
F_152 ( V_55 ) ;
V_55 = F_315 ( V_51 , V_70 , V_69 , V_73 ) ;
F_69 ( V_69 , V_55 , V_70 ) ;
} else {
