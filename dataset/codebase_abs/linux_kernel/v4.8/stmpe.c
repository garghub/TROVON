...
struct V_1 * V_1 ;
int V_6 ;
V_110 = F_68 ( V_7 -> V_9 , sizeof( * V_110 ) , V_149 ) ;
if ( ! V_110 )
return - V_150 ;
F_61 ( V_110 , V_107 ) ;
if ( F_69 ( V_107 , L_25 , NULL ) == NULL )
V_7 -> V_69 = - 1 ;
V_1 = F_68 ( V_7 -> V_9 , sizeof( struct V_1 ) , V_149 ) ;
if ( ! V_1 )
return - V_150 ;
F_70 ( & V_1 -> V_91 ) ;
F_70 ( & V_1 -> V_17 ) ;
...
V_1 -> V_152 = F_71 ( V_7 -> V_9 , L_26 ) ;
if ( ! F_72 ( V_1 -> V_152 ) ) {
V_6 = F_73 ( V_1 -> V_152 ) ;
if ( V_6 )
F_60 ( V_7 -> V_9 , L_27 ) ;
}
V_1 -> V_153 = F_71 ( V_7 -> V_9 , L_28 ) ;
if ( ! F_72 ( V_1 -> V_153 ) ) {
V_6 = F_73 ( V_1 -> V_153 ) ;
if ( V_6 )
F_60 ( V_7 -> V_9 , L_29 ) ;
...
if ( V_6 )
return V_6 ;
V_6 = F_78 ( V_7 -> V_9 , V_1 -> V_69 , NULL ,
...
static int F_82 ( struct V_159 * V_9 )
{
struct V_1 * V_1 = F_83 ( V_9 ) ;
if ( V_1 -> V_69 >= 0 && F_84 ( V_9 ) )
F_85 ( V_1 -> V_69 ) ;
return 0 ;
}
static int F_86 ( struct V_159 * V_9 )
{
struct V_1 * V_1 = F_83 ( V_9 ) ;
if ( V_1 -> V_69 >= 0 && F_84 ( V_9 ) )
F_87 ( V_1 -> V_69 ) ;
