...
F_22 ( F_20 ( V_13 ) ) ) ;
F_10 ( V_13 , V_3 , V_6 ) ;
if ( F_23 ( V_41 , V_13 , V_47 ) )
goto V_48;
if ( V_13 -> V_35 > F_24 ( F_20 ( V_13 ) ) )
goto V_48;
F_25 ( V_13 , V_3 ) ;
#if F_26 ( V_49 )
if ( V_3 -> V_50 ) {
struct V_51 * V_52 = F_27 ( V_3 ) ;
V_13 -> V_53 = F_28 ( V_3 ) ;
V_15 -> V_54 = F_3 ( V_13 -> V_35 ) ;
F_29 ( V_15 ) ;
if ( F_30 ( V_13 , V_13 -> V_53 , F_31 ( V_13 -> V_9 ) ,
V_52 -> V_55 , V_52 -> V_56 , V_13 -> V_35 ) < 0 )
goto V_48;
F_32 ( V_13 ) ;
} else
#endif
F_33 ( V_41 , V_13 -> V_57 , V_13 ) ;
return;
V_48:
F_34 ( V_13 ) ;
}
void F_35 ( struct V_2 * V_58 , int V_59 , int V_5 )
{
struct V_12 * V_60 = F_2 ( V_58 ) ;
T_2 V_61 ;
if ( V_58 -> V_62 || V_60 -> V_7 & F_3 ( V_8 ) )
return;
if ( F_36 ( V_58 ) ) {
F_37 ( V_58 , V_63 , V_59 , 0 ) ;
return;
}
if ( V_60 -> V_9 == V_10 || V_60 -> V_9 == V_64 )
V_61 = V_60 -> V_9 ;
else
V_61 = 0 ;
if ( F_6 ( V_58 , V_5 , F_5 ( V_58 ) , V_61 ) == 0 )
F_37 ( V_58 , V_63 , V_59 , 0 ) ;
}
