...
if ( ! V_86 )
goto V_100;
if ( ( V_8 -> V_101 & V_102 ) && V_89 )
V_4 = false ;
if ( ! V_85 )
V_85 = V_103 ;
V_88 = V_104 + F_35 ( V_85 ) + 1 ;
do {
V_90 = F_36 ( V_104 , V_88 ) ;
if ( V_87 ) {
V_5 = F_1 ( V_2 , & V_3 , V_4 ) ;
if ( V_5 )
goto V_100;
...
break;
if ( V_8 -> V_105 -> V_106 ) {
if ( ! V_8 -> V_105 -> V_106 ( V_8 ) )
break;
V_91 = true ;
}
if ( F_3 ( V_8 ) )
break;
if ( ! V_87 && ! V_8 -> V_105 -> V_106 ) {
F_12 ( V_85 ) ;
goto V_100;
}
if ( V_90 &&
...
int F_41 ( struct V_20 * V_8 , T_1 V_9 , int * V_109 )
{
struct V_47 V_48 = { NULL } ;
struct V_6 V_7 = { 0 } ;
struct V_49 V_50 = { 0 } ;
struct V_51 V_52 ;
struct V_110 * V_111 = & V_8 -> V_111 ;
const T_2 * V_112 ;
int V_113 , V_5 = 0 ;
T_2 * V_114 ;
...
V_112 = V_117 ;
V_113 = sizeof( V_117 ) ;
} else if ( V_111 -> V_115 == V_118 ) {
V_112 = V_119 ;
V_113 = sizeof( V_119 ) ;
} else
return - V_68 ;
V_114 = F_22 ( V_113 , V_65 ) ;
if ( ! V_114 )
return - V_66 ;
V_48 . V_7 = & V_7 ;
V_48 . V_50 = & V_50 ;
...
T_2 * V_122 ;
int V_33 , V_5 ;
static T_2 V_123 [ 8 ] = { 0x55 , 0xaa , 0 , 0 , 0 , 0 , 0 , 0 } ;
static T_2 V_124 [ 4 ] = { 0x5a , 0 , 0 , 0 } ;
V_114 = F_43 ( V_46 , V_65 ) ;
if ( ! V_114 )
return - V_66 ;
if ( V_46 == 8 )
V_122 = V_123 ;
...
V_50 . V_57 = 1 ;
F_19 ( & V_50 , V_2 ) ;
F_18 ( & V_52 , V_114 , V_46 ) ;
F_20 ( V_8 , & V_48 ) ;
V_5 = 0 ;
if ( V_9 == V_126 ) {
for ( V_33 = 0 ; V_33 < V_46 / 4 ; V_33 ++ )
if ( ( V_122 [ V_33 ] ^ V_114 [ V_33 ] ) != 0xff ) {
V_5 = - V_121 ;
break;
}
}
...
int F_44 ( struct V_1 * V_2 , T_2 V_115 )
{
int V_128 ;
if ( V_115 == V_116 )
V_128 = 8 ;
...
return - V_68 ;
F_42 ( V_2 , V_2 -> V_8 , V_125 , V_128 ) ;
return F_42 ( V_2 , V_2 -> V_8 , V_126 , V_128 ) ;
}
...
{
return ( V_2 && V_2 -> V_62 . V_133 > V_134 ) ;
}
