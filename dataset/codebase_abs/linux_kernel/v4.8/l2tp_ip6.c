...
V_121 . V_117 = F_81 ( V_125 . V_137 , V_121 . V_117 ) ;
V_119 = F_82 ( V_3 , & V_121 , V_112 ) ;
if ( F_83 ( V_119 ) ) {
V_56 = F_84 ( V_119 ) ;
goto V_106;
}
if ( V_125 . V_136 < 0 )
V_125 . V_136 = F_85 ( V_52 , & V_121 , V_119 ) ;
if ( V_125 . V_138 < 0 )
...
static int F_90 ( struct V_2 * V_3 , struct V_107 * V_108 , T_2 V_31 ,
...
* V_48 = sizeof( * V_84 ) ;
if ( V_91 & V_165 )
return F_91 ( V_3 , V_108 , V_31 , V_48 ) ;
V_15 = F_92 ( V_3 , V_91 , V_163 , & V_56 ) ;
if ( ! V_15 )
goto V_106;
V_164 = V_15 -> V_31 ;
if ( V_31 < V_164 ) {
