...
int V_13 ;
V_19 -> V_71 = V_9 ;
V_70 = F_41 ( V_9 , sizeof( * V_70 ) , V_72 ) ;
if ( V_70 == NULL )
return - V_65 ;
V_12 = V_70 ;
...
struct V_1 * V_7 )
{
struct V_101 * V_102 = V_100 -> V_21 . V_103 ;
struct V_104 * V_105 ;
const T_4 * V_106 ;
int V_9 = 0 ;
T_1 V_6 ;
F_53 (node, L_4 , prop, cur, val) {
V_7 -> V_16 [ V_9 ] = V_6 ;
V_7 -> V_28 [ V_9 ] = V_107 ;
V_7 -> V_30 [ V_9 ] = V_108 ;
V_7 -> V_24 [ V_9 ] = 16 ;
...
V_19 = F_57 ( & V_100 -> V_21 , sizeof( * V_19 ) ) ;
if ( V_19 == NULL ) {
F_56 ( & V_100 -> V_21 , L_9 ) ;
return - V_65 ;
}
...
V_7 -> V_4 = F_58 ( V_100 ) ;
F_52 ( V_100 , V_7 ) ;
V_19 -> V_21 . V_110 = & V_100 -> V_21 ;
V_19 -> V_66 = F_59 ( & V_100 -> V_21 ) ;
V_19 -> V_68 = V_111 ;
V_19 -> V_112 = & V_113 ;
F_10 ( V_19 ) ;
F_3 ( V_7 , V_114 , V_115 ) ;
F_60 ( & V_7 -> V_93 ) ;
V_109 = F_40 ( V_19 , V_7 -> V_9 ) ;
if ( V_109 < 0 )
return V_109 ;
V_109 = F_31 ( V_19 ,
& F_22 ,
...
static int T_5 F_66 ( struct V_20 * V_21 )
{
struct V_18 * V_19 = F_67 ( V_21 ) ;
struct V_1 * V_7 = F_11 ( V_19 ) ;
struct V_120 * V_121 ;
unsigned int V_122 ;
V_121 = F_58 ( F_68 ( V_21 ) ) ;
if ( ! F_69 ( V_121 -> V_21 ) ) {
V_122 = F_1 ( V_7 , V_37 ) ;
V_122 &= ~ ( V_38 ) ;
F_3 ( V_7 , V_37 , ( V_122 |
...
static int T_5 F_70 ( struct V_20 * V_21 )
{
struct V_18 * V_19 = F_67 ( V_21 ) ;
struct V_1 * V_7 = F_11 ( V_19 ) ;
unsigned int V_124 ;
