...
unsigned int V_94 = V_109 -> V_110 . V_117 + 1 ;
unsigned long V_118 ;
T_3 V_119 [ 2 ] , V_120 [ 2 ] ;
bool V_121 = false ;
bool V_122 = false ;
...
V_119 [ 0 ] = F_32 ( V_116 , 0 ) ;
V_120 [ 0 ] = F_32 ( V_116 , 1 ) ;
if ( V_112 -> V_118 & V_125 ) {
V_14 -> V_76 = true ;
if ( V_121 ) {
V_119 [ 1 ] = V_119 [ 0 ] + 0x40 ;
V_120 [ 1 ] = V_120 [ 0 ] + 0x40 ;
} else {
V_119 [ 1 ] = V_119 [ 0 ] + V_116 -> V_126 [ 0 ] ;
V_120 [ 1 ] = V_120 [ 0 ] + V_116 -> V_126 [ 0 ] ;
}
} else {
V_14 -> V_76 = false ;
V_119 [ 1 ] = 0 ;
...
F_33 ( & V_6 -> V_127 , V_118 ) ;
V_9 = ( V_14 -> V_76 ? ~ 0 : 0 ) ;
F_6 ( V_6 , V_37 , V_9 , V_128 ) ;
V_9 = ( V_122 ? V_129 : V_130 ) ;
V_9 |= ( V_121 ? V_131 : V_132 ) ;
F_6 ( V_6 , V_37 , V_9 , V_133 ) ;
F_4 ( V_6 , V_38 , F_34 ( V_116 -> V_126 [ 0 ] ) |
F_35 ( V_116 -> V_75 ) ) ;
F_4 ( V_6 , V_39 , F_34 ( V_116 -> V_126 [ 0 ] ) |
F_35 ( V_116 -> V_75 / 2 ) ) ;
F_4 ( V_6 , V_48 , V_109 -> V_134 . V_135 ) ;
F_4 ( V_6 , V_49 , V_109 -> V_134 . V_136 ) ;
F_4 ( V_6 , V_46 ,
F_36 ( V_109 -> V_134 . V_137 ) ) ;
F_4 ( V_6 , V_47 , V_109 -> V_134 . V_138 ) ;
F_4 ( V_6 , V_52 , V_109 -> V_113 . V_135 ) ;
F_4 ( V_6 , V_50 , V_109 -> V_113 . V_137 ) ;
if ( V_14 -> V_76 ) {
F_4 ( V_6 , V_53 , V_109 -> V_113 . V_136 / 2 ) ;
F_4 ( V_6 , V_51 , V_109 -> V_113 . V_138 / 2 ) ;
} else {
F_4 ( V_6 , V_53 , V_109 -> V_113 . V_136 ) ;
F_4 ( V_6 , V_51 , V_109 -> V_113 . V_138 ) ;
}
F_4 ( V_6 , V_54 , V_109 -> V_139 ) ;
F_4 ( V_6 , V_55 , V_109 -> V_140 ) ;
F_4 ( V_6 , V_45 , V_141 ) ;
F_4 ( V_6 , V_41 , V_119 [ 0 ] ) ;
F_4 ( V_6 , V_42 , V_119 [ 1 ] ) ;
F_4 ( V_6 , V_43 , V_120 [ 0 ] ) ;
F_4 ( V_6 , V_44 , V_120 [ 1 ] ) ;
F_20 ( V_14 , V_112 -> V_142 ) ;
F_21 ( V_14 , V_112 -> V_142 ) ;
F_22 ( V_14 , V_107 -> V_143 , V_94 , true ) ;
F_18 ( V_14 ) ;
F_26 ( V_14 ) ;
F_37 ( & V_6 -> V_127 , V_118 ) ;
F_10 ( V_14 ) ;
F_12 ( V_14 ) ;
}
...
V_145 = V_109 -> V_139 == ( 1 << 15 ) ;
V_146 = V_109 -> V_140 == ( 1 << 15 ) ;
V_149 = V_109 -> V_113 . V_137 ;
V_150 = V_109 -> V_113 . V_138 ;
V_151 = F_32 ( V_116 , 0 )
+ ( V_109 -> V_134 . V_137 * V_116 -> V_161 >> 3 )
+ ( V_109 -> V_134 . V_138 * V_116 -> V_126 [ 0 ] ) ;
V_147 = 0 ;
V_148 = 0 ;
if ( V_112 -> V_118 & V_125 )
V_14 -> V_76 = true ;
...
F_41 ( V_152 ) , V_162 ) ;
F_8 ( V_6 , F_42 ( V_64 ) ,
V_116 -> V_126 [ 0 ] / ( V_116 -> V_161 >> 3 ) ) ;
if ( V_14 -> V_79 == V_80 &&
V_64 == V_163 ) {
V_9 = F_43 ( V_112 -> V_142 ) ;
V_9 |= F_44 ( V_112 -> V_164 ) ;
F_8 ( V_6 , V_165 , V_9 ) ;
}
V_9 = F_45 ( V_109 -> V_134 . V_135 ) ;
V_9 |= F_46 ( V_109 -> V_134 . V_136 ) ;
V_9 |= F_47 ( V_145 ) ;
V_9 |= F_48 ( V_146 ) ;
...
F_84 ( V_213 , & V_188 -> V_118 ) ;
if ( ! F_85 ( V_214 , & V_188 -> V_118 ) )
return 0 ;
...
return;
F_33 ( & V_6 -> V_127 , V_118 ) ;
F_22 ( V_188 , V_107 -> V_143 , 0 , false ) ;
F_37 ( & V_6 -> V_127 , V_118 ) ;
}
...
struct V_5 * V_6 = & V_14 -> V_66 ;
if ( F_85 ( V_214 , & V_14 -> V_118 ) )
return;
F_93 ( V_14 -> V_190 ) ;
F_94 ( V_113 , true ) ;
F_19 ( V_14 , false ) ;
F_9 ( V_6 , V_15 , ~ 0 , V_216 ) ;
if ( F_85 ( V_213 , & V_14 -> V_118 ) ) {
F_9 ( V_6 , V_18 , ~ 0 , V_182 ) ;
F_9 ( V_6 , V_17 , ~ 0 , V_215 ) ;
}
F_60 ( V_14 ) ;
F_19 ( V_14 , true ) ;
F_95 ( V_214 , & V_14 -> V_118 ) ;
}
...
V_136 = V_112 -> V_142 ;
F_40 ( L_24 ,
V_112 -> V_164 , V_112 -> V_142 , V_112 -> V_219 ,
( V_112 -> V_118 & V_125 ) ? 1 : 0 ) ;
