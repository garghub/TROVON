...
static void F_53 ( struct V_45 * V_6 ,
struct V_81 * V_7 )
{
if ( ! V_7 ) {
V_6 -> V_7 = & V_82 ;
...
struct V_45 * F_58 ( const char * V_76 ,
struct V_58 * V_60 ,
T_2 V_95 ,
T_2 V_46 ,
struct V_81 * V_7 ,
...
V_105 = - V_30 ;
if ( ! F_64 ( ! V_6 -> V_4 [ 0 ] ) ) {
V_58 = F_49 ( V_6 , V_6 -> V_4 [ 0 ] , 0 ) ;
if ( V_58 && ! F_64 ( ! V_6 -> V_62 ) ) {
F_47 ( V_6 -> V_4 [ 0 ] , V_58 ) ;
V_105 = 0 ;
}
}
...
T_2 F_72 ( struct V_3 * V_4 , T_2 V_23 )
{
void * V_110 , * V_111 ;
T_2 V_112 , V_113 ;
...
static int F_79 ( struct V_119 * V_119 , struct V_26 * V_27 )
{
struct V_3 * V_4 = V_119 -> V_120 ;
F_20 ( & V_4 -> V_50 ) ;
V_27 -> V_96 = V_4 ;
return F_80 ( V_119 , V_27 ) ;
}
static int F_81 ( struct V_26 * V_27 , struct V_1 * V_2 )
{
struct V_3 * V_4 = V_27 -> V_96 ;
return F_10 ( V_4 , V_2 ) ;
}
static unsigned int F_82 ( struct V_26 * V_27 , T_4 * V_121 )
{
...
return V_123 ;
if ( V_27 -> V_124 & V_125 ) {
F_83 ( V_27 , & V_4 -> V_64 , V_121 ) ;
if ( ! F_29 ( V_4 ) )
V_122 |= V_126 | V_127 ;
}
return V_122 ;
}
static int F_84 ( struct V_119 * V_119 , struct V_26 * V_27 )
{
struct V_3 * V_4 = V_27 -> V_96 ;
F_27 ( & V_4 -> V_50 , F_28 ) ;
return 0 ;
...
static int F_86 ( struct V_3 * V_4 , T_2 V_128 )
{
T_2 V_95 = V_4 -> V_6 -> V_95 ;
T_2 V_46 = V_4 -> V_6 -> V_46 ;
T_2 V_130 = V_4 -> V_52 ;
...
static T_2 F_89 ( struct V_3 * V_4 ,
T_2 V_128 ,
T_2 V_138 )
{
...
V_143 = V_132 ;
if ( F_91 ( V_141 -> V_144 . V_4 , V_142 , V_132 ) ) {
V_141 -> error = - V_145 ;
V_143 = 0 ;
}
...
static T_6 F_92 ( struct V_26 * V_27 , T_7 * V_147 ,
T_8 V_148 ,
T_5 * V_141 )
{
struct V_3 * V_4 = V_27 -> V_96 ;
...
if ( ! F_86 ( V_4 , * V_147 ) )
break;
V_140 = F_88 ( * V_147 , V_4 ) ;
V_132 = F_87 ( V_140 , V_4 ) ;
if ( ! V_132 )
break;
V_132 = F_95 ( V_141 -> V_138 , V_132 ) ;
V_143 = V_148 ( V_140 , V_4 , V_132 , V_141 ) ;
if ( V_141 -> error < 0 )
break;
if ( V_143 ) {
F_85 ( V_4 , V_140 , V_143 ) ;
* V_147 = F_89 ( V_4 , V_140 , V_143 ) ;
}
} while ( V_141 -> V_138 && V_143 );
F_96 ( F_94 ( V_27 ) ) ;
return V_141 -> V_146 ;
}
static T_6 F_97 ( struct V_26 * V_27 ,
char T_9 * V_149 ,
T_2 V_138 ,
T_7 * V_147 )
{
...
V_141 . V_146 = 0 ;
V_141 . V_138 = V_138 ;
V_141 . V_144 . V_4 = V_149 ;
V_141 . error = 0 ;
return F_92 ( V_27 , V_147 , F_90 , & V_141 ) ;
}
static void F_98 ( struct V_3 * V_150 , int V_67 )
{
V_150 -> V_67 += V_67 ;
if ( V_150 -> V_67 >= V_150 -> V_6 -> V_95 ) {
F_75 ( V_150 -> V_6 , V_150 -> V_51 , 1 ) ;
V_150 -> V_67 %= V_150 -> V_6 -> V_95 ;
}
}
static void F_99 ( struct V_151 * V_152 ,
struct V_153 * V_4 )
{
struct V_3 * V_150 ;
V_150 = (struct V_3 * ) F_100 ( V_4 -> V_12 ) ;
F_98 ( V_150 , V_4 -> V_154 ) ;
}
static void F_101 ( struct V_155 * V_156 , unsigned int V_38 )
{
}
static T_6 F_102 ( struct V_26 * V_157 ,
T_7 * V_147 ,
struct V_151 * V_152 ,
T_2 V_158 ,
unsigned int V_107 ,
...
struct V_3 * V_150 = V_157 -> V_96 ;
unsigned int V_95 = V_150 -> V_6 -> V_95 ;
T_10 V_165 = ( T_10 ) * V_147 ;
T_11 V_29 = ( T_11 ) V_150 -> V_6 -> V_29 ;
T_2 V_140 = ( T_2 ) F_103 ( V_165 , V_29 ) ;
T_2 V_129 = V_140 / V_95 ;
T_2 V_48 = V_150 -> V_48 [ V_129 ] ;
T_2 V_166 = V_129 * V_95 + V_95 - V_48 ;
struct V_12 * V_167 [ V_168 ] ;
...
T_6 V_143 ;
if ( V_150 -> V_52 == V_150 -> V_53 )
return 0 ;
if ( F_104 ( V_152 , & V_156 ) )
return - V_91 ;
if ( V_158 > ( V_95 - V_140 % V_95 ) )
V_158 = V_95 - V_140 % V_95 ;
V_163 = V_150 -> V_6 -> V_29 >> V_16 ;
V_160 = ( V_140 / V_20 ) % V_163 ;
V_161 = V_140 & ~ V_175 ;
V_164 = F_105 (unsigned int, subbuf_pages, spd.nr_pages_max) ;
for ( V_162 = 0 ; V_156 . V_164 < V_164 ; V_156 . V_164 ++ ) {
unsigned int V_176 , V_177 , V_154 ;
unsigned int V_178 = V_140 + V_162 ;
if ( ! V_158 )
break;
V_176 = F_105 (unsigned long, len, PAGE_SIZE - poff) ;
V_154 = V_176 ;
V_156 . V_167 [ V_156 . V_164 ] = V_150 -> V_40 [ V_160 ] ;
V_156 . V_170 [ V_156 . V_164 ] . V_69 = V_161 ;
V_177 = V_178 + V_176 ;
if ( V_177 >= V_166 ) {
V_176 = V_166 - V_178 ;
V_154 = V_176 + V_48 ;
}
V_156 . V_170 [ V_156 . V_164 ] . V_158 = V_176 ;
V_156 . V_170 [ V_156 . V_164 ] . V_154 = V_154 ;
V_158 -= V_176 ;
V_162 += V_176 ;
V_161 = 0 ;
V_160 = ( V_160 + 1 ) % V_163 ;
...
if ( ! V_156 . V_164 )
goto V_179;
V_143 = * V_159 = F_106 ( V_152 , & V_156 ) ;
if ( V_143 < 0 || V_143 < V_162 )
goto V_179;
if ( V_140 + V_143 == V_166 )
V_143 += V_48 ;
V_179:
F_107 ( & V_156 ) ;
return V_143 ;
}
static T_6 F_108 ( struct V_26 * V_157 ,
T_7 * V_147 ,
struct V_151 * V_152 ,
T_2 V_158 ,
unsigned int V_107 )
...
V_180 = 0 ;
while ( V_158 && ! V_180 ) {
V_143 = F_102 ( V_157 , V_147 , V_152 , V_158 , V_107 , & V_159 ) ;
if ( V_143 < 0 )
break;
else if ( ! V_143 ) {
if ( V_107 & V_181 )
