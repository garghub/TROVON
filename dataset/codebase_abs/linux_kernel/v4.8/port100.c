...
F_29 ( V_25 -> V_49 ) ;
V_25 -> V_49 -> V_39 = V_20 ;
V_25 -> V_49 -> V_50 = sizeof( V_20 ) ;
V_45 = F_23 ( V_25 -> V_49 , V_51 ) ;
V_25 -> V_52 = ! V_45 ;
F_30 ( & V_25 -> V_47 ) ;
if ( ! V_45 )
F_31 ( & V_25 -> V_48 ) ;
...
V_25 -> V_49 -> V_39 = V_54 -> V_2 ;
V_25 -> V_49 -> V_50 = V_54 -> V_17 ;
...
static void F_50 ( struct V_28 * V_28 )
{
struct V_24 * V_25 = V_28 -> V_29 ;
if ( V_25 -> V_52 ) {
V_25 -> V_52 = false ;
...
{
struct V_24 * V_25 = F_52 ( V_76 ) ;
F_26 ( V_25 ) ;
F_29 ( V_25 -> V_38 ) ;
}
static struct V_53 * F_53 ( struct V_24 * V_25 , unsigned int V_77 )
{
struct V_53 * V_58 ;
...
static int F_55 ( struct V_24 * V_25 , T_1 V_80 )
{
struct V_53 * V_58 ;
struct V_53 * V_62 ;
int V_45 ;
...
static T_5 F_58 ( struct V_24 * V_25 )
{
struct V_53 * V_58 ;
struct V_53 * V_62 ;
T_5 V_82 ;
...
V_82 = F_59 ( * ( V_84 * ) V_62 -> V_2 ) ;
F_38 ( V_62 ) ;
return V_82 ;
}
static T_2 F_60 ( struct V_24 * V_25 )
{
struct V_53 * V_58 ;
struct V_53 * V_62 ;
T_2 V_85 ;
...
static int F_61 ( struct V_75 * V_76 , bool V_88 )
{
struct V_24 * V_25 = F_52 ( V_76 ) ;
...
static int F_62 ( struct V_75 * V_76 , T_1 V_90 )
{
struct V_24 * V_25 = F_52 ( V_76 ) ;
struct V_53 * V_58 ;
struct V_53 * V_62 ;
...
if ( V_90 >= V_91 )
return - V_92 ;
V_58 = F_53 ( V_25 , sizeof( struct V_93 ) ) ;
if ( ! V_58 )
return - V_69 ;
...
static int F_63 ( struct V_75 * V_76 , int V_96 )
{
struct V_24 * V_25 = F_52 ( V_76 ) ;
struct V_97 * V_98 ;
struct V_53 * V_58 ;
...
static int F_64 ( struct V_75 * V_76 , int type ,
int V_96 )
{
if ( type == V_105 )
return F_62 ( V_76 , V_96 ) ;
if ( type == V_106 )
return F_63 ( V_76 , V_96 ) ;
return - V_92 ;
}
static void F_65 ( struct V_24 * V_25 , void * V_74 ,
struct V_53 * V_62 )
{
...
struct V_107 * V_108 ;
V_87 V_116 ;
V_108 = F_45 ( sizeof( struct V_107 ) , V_51 ) ;
if ( ! V_108 )
return - V_69 ;
V_108 -> V_63 = V_109 ;
V_108 -> V_114 = V_74 ;
...
static int F_69 ( struct V_75 * V_76 , T_1 V_90 )
{
struct V_24 * V_25 = F_52 ( V_76 ) ;
struct V_53 * V_58 ;
struct V_53 * V_62 ;
...
if ( V_90 >= V_91 )
return - V_92 ;
V_58 = F_53 ( V_25 , sizeof( struct V_118 ) ) ;
if ( ! V_58 )
return - V_69 ;
...
static int F_70 ( struct V_75 * V_76 , int V_96 )
{
struct V_24 * V_25 = F_52 ( V_76 ) ;
struct V_97 * V_98 ;
struct V_53 * V_58 ;
...
static int F_71 ( struct V_75 * V_76 , int type ,
int V_96 )
{
if ( type == V_105 )
return F_69 ( V_76 , V_96 ) ;
if ( type == V_106 )
return F_70 ( V_76 , V_96 ) ;
return - V_92 ;
}
static bool F_72 ( struct V_24 * V_25 , T_1 V_124 )
{
T_1 V_82 ;
switch ( V_25 -> V_125 ) {
case V_126 :
...
static void F_73 ( struct V_24 * V_25 , void * V_74 ,
struct V_53 * V_62 )
{
T_8 V_32 ;
struct V_107 * V_108 = V_74 ;
...
V_32 = F_66 ( V_131 -> V_32 ) ;
if ( V_108 -> V_132 &&
! F_72 ( V_25 , V_131 -> V_133 ) ) {
F_67 ( V_62 ) ;
V_62 = F_39 ( - V_112 ) ;
goto exit;
}
...
static int F_75 ( struct V_75 * V_76 ,
struct V_139 * V_140 ,
T_2 V_116 ,
T_7 V_109 , void * V_74 )
{
...
struct V_53 * V_58 ;
int V_45 ;
V_45 = F_71 ( V_76 , V_105 ,
V_141 ) ;
if ( V_45 )
return V_45 ;
V_45 = F_71 ( V_76 , V_106 ,
V_142 ) ;
if ( V_45 )
return V_45 ;
V_108 = F_45 ( sizeof( struct V_107 ) , V_51 ) ;
...
static int F_76 ( struct V_75 * V_76 , T_2 V_116 ,
T_7 V_109 , void * V_74 )
{
struct V_24 * V_25 = F_52 ( V_76 ) ;
struct V_53 * V_58 ;
...
if ( ! V_58 )
return - V_69 ;
return F_74 ( V_76 , V_58 , V_116 , V_109 , V_74 ) ;
}
static int F_77 ( struct V_150 * V_35 ,
...
T_5 V_160 ;
int V_5 ;
V_25 = F_78 ( & V_35 -> V_25 , sizeof( struct V_24 ) , V_51 ) ;
if ( ! V_25 )
return - V_69 ;
F_79 ( & V_25 -> V_47 ) ;
V_25 -> V_161 = F_80 ( F_81 ( V_35 ) ) ;
V_25 -> V_35 = V_35 ;
F_82 ( V_35 , V_25 ) ;
V_157 = V_158 = 0 ;
V_154 = V_35 -> V_162 ;
...
V_25 -> V_38 = F_85 ( 0 , V_51 ) ;
V_25 -> V_49 = F_85 ( 0 , V_51 ) ;
if ( ! V_25 -> V_38 || ! V_25 -> V_49 ) {
F_19 ( & V_35 -> V_25 , L_15 ) ;
V_45 = - V_69 ;
goto error;
}
F_86 ( V_25 -> V_38 , V_25 -> V_161 ,
F_87 ( V_25 -> V_161 , V_157 ) ,
NULL , 0 , NULL , V_25 ) ;
F_86 ( V_25 -> V_49 , V_25 -> V_161 ,
F_88 ( V_25 -> V_161 , V_158 ) ,
NULL , 0 , F_50 , V_25 ) ;
V_25 -> V_78 = V_60 +
V_167 ;
V_25 -> V_79 = V_23 ;
...
static void F_99 ( struct V_150 * V_35 )
{
struct V_24 * V_25 ;
V_25 = F_100 ( V_35 ) ;
F_82 ( V_35 , NULL ) ;
