...
static int F_60 ( int V_116 , const struct V_1 * V_2 ,
const bool V_123 )
{
T_2 V_124 , V_125 ;
int V_126 ;
...
static long F_75 ( unsigned int V_96 ,
const char T_4 * V_12 )
{
...
F_74 ( & V_5 -> V_64 -> V_65 ) ;
if ( V_96 & V_100 )
F_79 ( & V_5 -> signal -> V_72 ) ;
V_137:
F_47 ( V_135 ) ;
return V_53 ;
}
static inline long F_75 ( unsigned int V_96 ,
const char T_4 * V_12 )
{
return - V_22 ;
}
static long F_80 ( unsigned int V_138 , unsigned int V_96 ,
...
return F_70 () ;
case V_141 :
return F_75 ( V_96 , V_139 ) ;
default:
return - V_22 ;
}
}
long F_81 ( unsigned long V_63 , char T_4 * V_12 )
{
unsigned int V_138 ;
char T_4 * V_139 ;
switch ( V_63 ) {
...
return F_80 ( V_138 , 0 , V_139 ) ;
}
long F_82 ( struct V_3 * V_4 , unsigned long V_142 ,
void T_4 * V_126 )
{
struct V_55 * V_12 ;
struct V_143 * V_78 ;
...
F_25 ( V_4 ) ;
F_74 ( & V_4 -> V_64 -> V_65 ) ;
if ( F_84 ( V_126 , V_78 -> V_12 , F_85 ( V_78 ) ) )
V_53 = - V_92 ;
F_26 ( V_4 ) ;
return V_53 ;
V_95:
