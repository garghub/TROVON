...
V_2 -> V_122 = F_123 ( V_90 , L_42 ) ;
V_2 -> V_193 = & V_194 ;
V_2 -> V_195 = & V_196 ;
F_124 ( V_2 , & V_5 -> V_62 , F_42 , 64 ) ;
F_125 ( & V_5 -> V_82 ) ;
F_125 ( & V_5 -> V_67 ) ;
V_5 -> V_2 = V_2 ;
V_5 -> V_112 = 64 ;
V_5 -> V_197 = F_126 ( V_198 , 0xff ) ;
memcpy ( V_2 -> V_104 , V_89 -> V_104 , sizeof( V_89 -> V_104 ) ) ;
snprintf ( V_5 -> V_199 , V_183 , V_200 ,
V_182 , V_22 ) ;
V_137 = F_127 ( V_2 , V_5 -> V_199 , F_95 ,
V_201 ) ;
if ( F_18 ( V_137 ) ) {
if ( F_49 ( V_5 ) )
F_120 ( & V_90 -> V_2 , L_43 ) ;
...
static int F_133 ( struct V_180 * V_90 )
{
struct V_1 * V_2 = F_134 ( V_90 ) ;
F_135 ( V_2 ) ;
F_132 ( V_2 ) ;
return 0 ;
}
