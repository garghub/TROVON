...
F_106 ( V_9 , V_247 + V_78 * 3 + 0 , V_244 [ V_78 ] >> 8 ) ;
F_106 ( V_9 , V_247 + V_78 * 3 + 1 , V_245 [ V_78 ] >> 8 ) ;
F_106 ( V_9 , V_247 + V_78 * 3 + 2 , V_246 [ V_78 ] >> 8 ) ;
}
return 0 ;
}
int F_121 ( struct V_233 * V_5 , int V_248 )
{
return 0 ;
}
enum V_249
F_117 ( struct V_233 * V_5 , bool V_250 )
{
T_3 V_214 ;
struct V_94 * V_52 = V_5 -> V_52 ;
struct V_8 * V_9 = F_23 ( V_52 ) ;
struct V_1 * V_2 = F_115 ( V_5 ) ;
V_214 = F_108 ( V_9 , V_251 ) ;
return ( ( F_115 ( V_5 ) -> V_235 < V_214 &&
V_2 -> V_238 ) ?
V_252 : V_253 ) ;
}
void F_122 ( struct V_254 * V_248 )
{
V_248 -> V_255 = V_248 -> V_256 + 50 ;
V_248 -> V_257 = V_248 -> V_255 + 50 ;
V_248 -> V_258 = V_248 -> V_257 + 50 ;
V_248 -> V_259 = V_248 -> V_260 + 50 ;
V_248 -> V_261 = V_248 -> V_259 + 50 ;
V_248 -> V_262 = V_248 -> V_261 + 50 ;
V_248 -> clock = ( T_1 ) V_248 -> V_258 * ( T_1 ) V_248 -> V_262 / 100 * 6 ;
V_248 -> V_263 = F_123 ( V_248 ) ;
}
...
struct V_94 * V_52 = V_5 -> V_52 ;
struct V_8 * V_9 = F_23 ( V_52 ) ;
struct V_254 * V_248 = NULL ;
struct V_254 * V_264 ;
struct V_254 V_265 = { F_125 ( L_26 ,
...
V_248 = F_127 ( V_52 , & V_265 ) ;
if ( ! V_248 )
return 0 ;
V_248 -> V_256 = V_2 -> V_236 ;
V_248 -> V_260 = V_2 -> V_237 ;
F_122 ( V_248 ) ;
if ( F_84 ( V_9 ,
V_248 -> V_256 * V_266 ,
V_248 -> V_260 ) ) {
...
T_5 V_302 = V_235 -> V_6 . V_248 . V_256 ;
T_5 V_303 = V_235 -> V_6 . V_248 . V_260 ;
...
{
F_37 ( & V_9 -> V_335 ) ;
F_160 ( ! V_9 -> V_337 && V_9 -> V_338 ) ;
if ( ! V_2 -> V_336 && V_2 -> V_278 ) {
V_9 -> V_338 = V_118 ;
V_2 -> V_336 = true ;
V_9 -> V_337 ++ ;
}
...
bool F_161 ( struct V_8 * V_9 ,
struct V_46 * V_6 )
{
struct V_1 * V_2 = F_24 ( V_6 ) ;
bool V_31 ;
F_37 ( & V_9 -> V_335 ) ;
V_31 = ! V_2 -> V_278 || V_9 -> V_337 == 1 ;
F_39 ( & V_9 -> V_335 ) ;
return V_31 ;
}
