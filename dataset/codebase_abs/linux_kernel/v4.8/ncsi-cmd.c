...
{
struct V_22 * V_23 ;
V_23 = (struct V_22 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
...
{
struct V_25 * V_23 ;
V_23 = (struct V_25 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
...
{
struct V_28 * V_23 ;
V_23 = (struct V_28 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
...
{
struct V_30 * V_23 ;
V_23 = (struct V_30 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
F_2 ( & V_23 -> V_23 . V_24 , V_8 ) ;
return 0 ;
}
...
{
struct V_31 * V_23 ;
V_23 = (struct V_31 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
...
{
struct V_34 * V_23 ;
V_23 = (struct V_34 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
...
{
struct V_36 * V_23 ;
V_23 = (struct V_36 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
...
{
struct V_41 * V_23 ;
V_23 = (struct V_41 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
...
struct V_42 * V_23 ;
int V_4 ;
V_23 = (struct V_42 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
for ( V_4 = 0 ; V_4 < 6 ; V_4 ++ )
...
{
struct V_45 * V_23 ;
V_23 = (struct V_45 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
V_23 -> V_32 = F_5 ( V_8 -> V_33 [ 0 ] ) ;
F_2 ( & V_23 -> V_23 . V_24 , V_8 ) ;
return 0 ;
...
{
struct V_46 * V_23 ;
V_23 = (struct V_46 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
V_23 -> V_32 = F_5 ( V_8 -> V_33 [ 0 ] ) ;
F_2 ( & V_23 -> V_23 . V_24 , V_8 ) ;
return 0 ;
...
{
struct V_47 * V_23 ;
V_23 = (struct V_47 * ) F_7 ( V_21 , sizeof( * V_23 ) ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
V_23 -> V_32 = V_8 -> V_27 [ 0 ] ;
F_2 ( & V_23 -> V_23 . V_24 , V_8 ) ;
return 0 ;
...
V_66 = (struct V_65 * ) F_29 ( V_59 -> V_23 , sizeof( * V_66 ) ) ;
V_66 -> V_74 = F_4 ( V_64 ) ;
F_30 ( V_66 -> V_75 ) ;
F_30 ( V_66 -> V_76 ) ;
V_59 -> V_77 = true ;
