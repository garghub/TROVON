...
if ( F_40 ( V_47 + V_48 > V_51 -> V_48 ) ) {
F_2 ( & V_5 -> V_2 , 1 , L_9 ) ;
return - V_52 ;
}
if ( V_49 == V_53 ) {
unsigned int V_54 = F_41 ( V_48 + ( V_47 & ( 512 - 1 ) ) , 512 ) ;
if ( F_40 ( F_42 ( & V_51 -> V_55 , V_47 / 512 , V_54 ) ) )
return - V_56 ;
return F_43 ( V_28 , V_51 -> V_57 + V_47 , V_48 ) ;
} else {
F_44 ( V_51 -> V_57 + V_47 , V_28 , V_48 ) ;
F_45 ( F_14 ( V_5 -> V_2 . V_14 ) ) ;
}
return 0 ;
}
int F_46 ( struct V_1 * V_2 , struct V_50 * V_51 )
{
struct V_58 * V_59 = & V_51 -> V_59 ;
struct V_3 * V_5 = & V_51 -> V_60 ;
V_51 -> V_48 = F_47 ( V_59 ) ;
if ( ! F_48 ( V_2 , V_59 -> V_61 , F_47 ( V_59 ) ,
F_12 ( V_2 ) ) ) {
F_49 ( V_2 , L_10 , V_59 ) ;
return - V_31 ;
}
V_5 -> V_62 = F_38 ;
if ( F_50 ( V_2 , & V_51 -> V_55 ) )
return - V_33 ;
F_51 ( F_14 ( V_5 -> V_2 . V_14 ) , & V_51 -> V_55 ,
& V_51 -> V_59 ) ;
V_51 -> V_57 = F_52 ( V_2 , V_59 -> V_61 , F_47 ( V_59 ) ,
V_63 ) ;
return F_53 ( V_51 -> V_57 ) ;
}
void F_54 ( struct V_1 * V_2 , struct V_50 * V_51 )
{
struct V_58 * V_59 = & V_51 -> V_59 ;
F_55 ( V_2 , V_51 -> V_57 ) ;
F_56 ( V_2 , & V_51 -> V_55 ) ;
F_57 ( V_2 , V_59 -> V_61 , F_47 ( V_59 ) ) ;
}
