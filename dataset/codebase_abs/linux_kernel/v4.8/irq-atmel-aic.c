...
static void T_4 F_23 ( struct V_30 * V_41 )
{
F_24 ( V_41 ) ;
}
static void T_4 F_25 ( struct V_30 * V_41 )
{
F_26 ( V_41 ) ;
}
static void T_4 F_27 ( struct V_30 * V_41 )
{
F_24 ( V_41 ) ;
F_26 ( V_41 ) ;
}
static int T_4 F_28 ( struct V_30 * V_42 ,
struct V_30 * V_43 )
{
struct V_7 * V_6 ;
struct V_25 * V_26 ;
if ( V_5 )
return - V_44 ;
V_26 = F_29 ( V_42 , & V_45 , L_1 ,
V_46 , V_47 ) ;
if ( F_30 ( V_26 ) )
return F_31 ( V_26 ) ;
V_5 = V_26 ;
V_6 = F_16 ( V_26 , 0 ) ;
V_6 -> V_48 [ 0 ] . V_2 . V_49 = V_12 ;
V_6 -> V_48 [ 0 ] . V_2 . V_50 = V_23 ;
V_6 -> V_48 [ 0 ] . V_2 . V_51 = V_21 ;
