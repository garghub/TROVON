...
T_4 V_48 = F_90 ( V_7 ) + ( V_172 << V_49 ) ;
V_12 . V_50 -> V_51 ( V_48 , V_173 , V_69 ) ;
V_173 ++ ;
}
}
F_32 () ;
}
static void F_91 ( unsigned int V_174 ,
unsigned int V_3 ,
struct V_1 * * V_2 ,
unsigned int V_69 )
{
int V_8 , V_173 ;
for ( V_8 = 0 , V_173 = V_174 ; V_8 < V_3 ; V_8 ++ , V_173 ++ ) {
...
int V_142 = - V_46 ;
if ( V_12 . V_167 ) {
int V_175 = V_12 . V_81 / V_11 ;
int V_176 = V_12 . V_128 ;
F_93 ( V_175 , V_176 - V_175 ) ;
V_12 . V_167 = false ;
}
if ( V_82 == 1 && type == V_72 )
...
void F_93 ( unsigned int V_174 , unsigned int V_3 )
{
unsigned int V_8 ;
for ( V_8 = V_174 ; V_8 < ( V_174 + V_3 ) ; V_8 ++ ) {
...
{
int V_142 ;
V_142 = F_97 ( V_12 . V_83 -> V_180 , & V_12 . V_181 , V_11 ,
V_11 , V_182 , 0 ,
V_183 , V_12 . V_83 ) ;
return V_142 ;
}
...
int V_142 ;
T_1 V_184 ;
F_56 ( V_12 . V_83 , V_185 , & V_184 ) ;
if ( ! ( V_184 & 0x1 ) ) {
F_96 () ;
V_12 . V_186 = 1 ;
F_99 ( V_12 . V_83 , V_185 , ( V_12 . V_181 . V_175 & 0xffffffff ) | 0x1 ) ;
} else {
V_184 &= ~ 1 ;
V_12 . V_186 = 1 ;
V_12 . V_181 . V_175 = V_184 ;
V_12 . V_181 . V_176 = V_184 + V_11 ;
V_142 = F_100 ( & V_187 , & V_12 . V_181 ) ;
if ( V_142 )
V_12 . V_186 = 0 ;
}
}
...
T_1 V_188 , V_189 ;
int V_142 ;
F_56 ( V_12 . V_83 , V_190 + 4 , & V_188 ) ;
F_56 ( V_12 . V_83 , V_190 , & V_189 ) ;
if ( ! ( V_189 & 0x1 ) ) {
F_96 () ;
V_12 . V_186 = 1 ;
F_99 ( V_12 . V_83 , V_190 + 4 ,
F_102 ( V_12 . V_181 . V_175 ) ) ;
F_99 ( V_12 . V_83 , V_190 , ( V_12 . V_181 . V_175 & 0xffffffff ) | 0x1 ) ;
} else {
T_9 V_191 ;
V_189 &= ~ 0x1 ;
V_191 = ( ( T_9 ) V_188 << 32 ) | V_189 ;
V_12 . V_186 = 1 ;
V_12 . V_181 . V_175 = V_191 ;
V_12 . V_181 . V_176 = V_191 + V_11 ;
V_142 = F_100 ( & V_187 , & V_12 . V_181 ) ;
if ( V_142 )
V_12 . V_186 = 0 ;
}
...
if ( V_82 == 6 )
return;
V_12 . V_181 . V_192 = L_12 ;
V_12 . V_181 . V_69 = V_193 ;
if ( V_127 || V_82 >= 4 ) {
F_101 () ;
} else {
F_98 () ;
...
if ( V_12 . V_181 . V_175 )
V_12 . V_194 = F_104 ( V_12 . V_181 . V_175 , V_11 ) ;
if ( ! V_12 . V_194 )
F_81 ( & V_12 . V_13 -> V_42 ,
L_13 ) ;
}
...
{
struct V_197 * V_198 ;
V_198 = F_111 ( V_199 , V_85 , NULL ) ;
if ( V_198 && F_112 ( V_198 -> V_200 ) != 0 ) {
V_198 = F_111 ( V_199 ,
V_85 , V_198 ) ;
}
if ( ! V_198 )
...
int F_113 ( struct V_197 * V_201 , struct V_197 * V_202 ,
struct V_23 * V_24 )
{
int V_8 , V_203 ;
for ( V_8 = 0 ; V_204 [ V_8 ] . V_192 != NULL ; V_8 ++ ) {
if ( V_202 ) {
if ( V_202 -> V_85 ==
V_204 [ V_8 ] . V_205 ) {
V_12 . V_13 = F_114 ( V_202 ) ;
V_12 . V_50 =
V_204 [ V_8 ] . V_206 ;
break;
}
} else if ( F_110 ( V_204 [ V_8 ] . V_205 ) ) {
V_12 . V_50 =
V_204 [ V_8 ] . V_206 ;
break;
}
...
if ( V_12 . V_209 ++ )
return 1 ;
V_12 . V_83 = F_114 ( V_201 ) ;
F_27 ( & V_201 -> V_42 , L_14 , V_204 [ V_8 ] . V_192 ) ;
V_203 = V_12 . V_50 -> V_210 ;
if ( F_115 ( V_12 . V_13 , F_116 ( V_203 ) ) )
F_81 ( & V_12 . V_13 -> V_42 ,
L_15 , V_203 ) ;
else
F_117 ( V_12 . V_13 ,
