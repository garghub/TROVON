...
V_66 -> V_80 , V_66 -> V_81 , V_76 . V_77 , 0 ) ;
if ( V_11 < 0 ) {
...
goto V_126;
V_19 -> V_129 = V_130 ;
V_19 -> V_129 . V_131 = & V_19 -> V_125 ;
V_19 -> V_129 . V_113 = & V_19 -> V_113 ;
V_19 -> V_129 . V_67 = & V_19 -> V_67 ;
F_55 ( & V_19 -> V_129 , V_19 ) ;
error = F_56 ( & V_19 -> V_129 , V_132 , - 1 ) ;
if ( error ) {
F_21 ( & V_97 -> V_2 ,
L_26 ) ;
goto V_133;
...
F_6 ( V_19 ) ;
F_57 ( V_97 , NULL ) ;
F_8 ( & V_97 -> V_2 , L_28 , V_134 ) ;
}
static int F_64 ( struct V_135 * V_136 ,
unsigned int * V_137 , unsigned int * V_138 ,
unsigned int V_139 [] , struct V_140 * V_141 [] )
{
if ( V_136 -> V_142 + * V_137 < 3 )
* V_137 = 3 - V_136 -> V_142 ;
if ( * V_138 )
return V_139 [ 0 ] < V_76 . V_77 ? - V_143 : 0 ;
* V_138 = 1 ;
V_139 [ 0 ] = V_76 . V_77 ;
return 0 ;
}
static int F_65 ( struct V_144 * V_78 )
{
struct V_1 * V_19 = F_66 ( V_78 -> V_135 ) ;
unsigned long V_6 = V_76 . V_77 ;
if ( F_67 ( V_78 , 0 ) < V_6 ) {
...
static void F_69 ( struct V_144 * V_78 )
{
struct V_1 * V_19 = F_66 ( V_78 -> V_135 ) ;
struct V_61 * V_145 = (struct V_61 * ) V_78 ;
F_27 ( & V_19 -> V_68 ) ;
F_70 ( & V_145 -> V_71 , & V_19 -> V_69 ) ;
F_29 ( & V_19 -> V_68 ) ;
}
static void F_71 ( struct V_1 * V_19 ,
enum V_146 V_147 )
{
struct V_61 * V_145 , * V_148 ;
F_27 ( & V_19 -> V_68 ) ;
F_72 (buf, node, &sur40->buf_list, list) {
F_36 ( & V_145 -> V_78 . V_79 , V_147 ) ;
F_31 ( & V_145 -> V_71 ) ;
}
F_29 ( & V_19 -> V_68 ) ;
}
static int F_73 ( struct V_135 * V_149 , unsigned int V_58 )
{
struct V_1 * V_19 = F_66 ( V_149 ) ;
V_19 -> V_83 = 0 ;
return 0 ;
}
static void F_74 ( struct V_135 * V_149 )
{
struct V_1 * V_19 = F_66 ( V_149 ) ;
F_75 ( V_149 ) ;
V_19 -> V_83 = - 1 ;
...
static int F_76 ( struct V_150 * V_150 , void * V_151 ,
struct V_152 * V_153 )
{
struct V_1 * V_19 = F_77 ( V_150 ) ;
F_78 ( V_153 -> V_154 , V_155 , sizeof( V_153 -> V_154 ) ) ;
F_78 ( V_153 -> V_156 , V_120 , sizeof( V_153 -> V_156 ) ) ;
F_49 ( V_19 -> V_7 , V_153 -> V_157 , sizeof( V_153 -> V_157 ) ) ;
V_153 -> V_158 = V_159 |
V_160 |
V_161 ;
...
static int F_80 ( struct V_150 * V_150 , void * V_151 , unsigned int V_48 )
{
return ( V_48 == 0 ) ? 0 : - V_143 ;
}
static int F_81 ( struct V_150 * V_150 , void * V_151 , unsigned int * V_48 )
{
* V_48 = 0 ;
return 0 ;
}
...
struct V_168 * V_169 )
{
V_169 -> V_170 . V_171 = V_76 ;
return 0 ;
}
static int F_83 ( struct V_150 * V_150 , void * V_151 ,
struct V_172 * V_169 )
{
if ( V_169 -> V_4 != 0 )
return - V_143 ;
...
static int F_84 ( struct V_150 * V_150 , void * V_151 ,
struct V_176 * V_169 )
{
if ( ( V_169 -> V_4 != 0 ) || ( V_169 -> V_177 != V_174 ) )
return - V_143 ;
V_169 -> type = V_178 ;
V_169 -> V_179 . V_180 = V_76 . V_180 ;
V_169 -> V_179 . V_181 = V_76 . V_181 ;
return 0 ;
}
static int F_85 ( struct V_150 * V_150 , void * V_151 ,
struct V_182 * V_169 )
{
if ( ( V_169 -> V_4 > 1 ) || ( V_169 -> V_177 != V_174 )
|| ( V_169 -> V_180 != V_76 . V_180 )
|| ( V_169 -> V_181 != V_76 . V_181 ) )
return - V_143 ;
V_169 -> type = V_183 ;
V_169 -> V_179 . V_184 = 60 / ( V_169 -> V_4 + 1 ) ;
V_169 -> V_179 . V_185 = 1 ;
return 0 ;
}
