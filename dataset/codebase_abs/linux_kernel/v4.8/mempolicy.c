...
struct V_68 *
F_175 ( T_7 V_178 , int V_196 , struct V_57 * V_58 ,
...
F_107 ( V_4 ) ;
V_68 = F_178 ( V_178 , V_196 , V_195 , V_77 ) ;
V_124:
if ( F_151 ( ! V_68 && F_179 ( V_200 ) ) )
goto V_201;
return V_68 ;
}
struct V_68 * F_180 ( T_7 V_178 , unsigned V_196 )
{
struct V_1 * V_4 = & V_9 ;
struct V_68 * V_68 ;
unsigned int V_200 ;
...
int F_181 ( struct V_57 * V_204 , struct V_57 * V_205 )
{
...
bool F_184 ( struct V_1 * V_207 , struct V_1 * V_208 )
{
if ( ! V_207 || ! V_208 )
return false ;
...
static struct V_209 *
F_185 ( struct V_210 * V_211 , unsigned long V_88 , unsigned long V_65 )
{
struct V_212 * V_186 = V_211 -> V_213 . V_212 ;
while ( V_186 ) {
struct V_209 * V_3 = F_186 ( V_186 , struct V_209 , V_180 ) ;
if ( V_88 >= V_3 -> V_65 )
V_186 = V_186 -> V_214 ;
...
struct V_212 * V_94 = F_187 ( V_186 ) ;
if ( ! V_94 )
break;
V_30 = F_186 ( V_94 , struct V_209 , V_180 ) ;
if ( V_30 -> V_65 <= V_88 )
break;
V_186 = V_94 ;
}
return F_186 ( V_186 , struct V_209 , V_180 ) ;
}
static void F_188 ( struct V_210 * V_211 , struct V_209 * V_54 )
{
...
while ( * V_3 ) {
V_216 = * V_3 ;
V_180 = F_186 ( V_216 , struct V_209 , V_180 ) ;
...
F_189 ( & V_54 -> V_180 , V_216 , V_3 ) ;
F_190 ( & V_54 -> V_180 , & V_211 -> V_213 ) ;
F_18 ( L_4 , V_54 -> V_88 , V_54 -> V_65 ,
V_54 -> V_34 ? V_54 -> V_34 -> V_8 : 0 ) ;
}
struct V_1 *
F_191 ( struct V_210 * V_211 , unsigned long V_217 )
{
struct V_1 * V_4 = NULL ;
struct V_209 * V_218 ;
...
return NULL ;
F_192 ( & V_211 -> V_219 ) ;
V_218 = F_185 ( V_211 , V_217 , V_217 + 1 ) ;
if ( V_218 ) {
F_145 ( V_218 -> V_34 ) ;
V_4 = V_218 -> V_34 ;
}
...
static void F_194 ( struct V_209 * V_186 )
{
F_84 ( V_186 -> V_34 ) ;
F_25 ( V_220 , V_186 ) ;
}
...
static void F_200 ( struct V_210 * V_211 , struct V_209 * V_186 )
{
F_18 ( L_5 , V_186 -> V_88 , V_186 -> V_65 ) ;
F_201 ( & V_186 -> V_180 , & V_211 -> V_213 ) ;
F_194 ( V_186 ) ;
}
...
V_231:
F_205 ( & V_211 -> V_219 ) ;
V_186 = F_185 ( V_211 , V_88 , V_65 ) ;
while ( V_186 && V_186 -> V_88 < V_65 ) {
struct V_212 * V_114 = F_206 ( & V_186 -> V_180 ) ;
if ( V_186 -> V_88 >= V_88 ) {
if ( V_186 -> V_65 <= V_65 )
F_200 ( V_211 , V_186 ) ;
else
...
* F_17 = * V_186 -> V_34 ;
F_22 ( & F_17 -> V_41 , 1 ) ;
F_202 ( V_230 , V_65 , V_186 -> V_65 , F_17 ) ;
V_186 -> V_65 = V_88 ;
F_188 ( V_211 , V_230 ) ;
V_230 = NULL ;
F_17 = NULL ;
...
if ( ! V_114 )
break;
V_186 = F_186 ( V_114 , struct V_209 , V_180 ) ;
}
if ( V_54 )
F_188 ( V_211 , V_54 ) ;
F_207 ( & V_211 -> V_219 ) ;
...
return;
F_205 ( & V_3 -> V_219 ) ;
V_114 = F_213 ( & V_3 -> V_213 ) ;
while ( V_114 ) {
V_186 = F_186 ( V_114 , struct V_209 , V_180 ) ;
V_114 = F_206 ( & V_186 -> V_180 ) ;
F_200 ( V_3 , V_186 ) ;
}
F_207 ( & V_3 -> V_219 ) ;
}
