...
V_38 -> V_127 = false ;
V_38 -> V_210 = false ;
V_38 -> V_247 = ( V_2 -> V_444 & V_445 ) ? true : false ;
V_38 -> V_229 = true ;
V_38 -> V_253 = ( V_2 -> V_444 & V_446 ) ? true : false ;
V_38 -> V_256 = ( V_2 -> V_444 & V_447 ) ? true : false ;
V_38 -> V_259 = ( V_2 -> V_444 & V_448 ) ? true : false ;
V_38 -> V_230 = false ;
V_65 = F_118 ( V_2 ) ;
if ( V_65 )
return V_65 ;
...
T_3 V_284 ;
if ( V_451 >= V_455 ) {
F_134 ( V_450 , L_22 , V_451 ) ;
} else {
V_94 = F_117 ( V_38 -> V_98 [ V_451 ] . V_101 ) ;
V_76 = ( F_9 ( V_456 ) &
V_457 ) >>
V_458 ;
V_284 = F_31 ( V_2 , ( T_3 ) V_76 ) ;
F_134 ( V_450 , L_23 , V_38 -> V_215 ? L_24 : L_25 ) ;
F_134 ( V_450 , L_26 , V_38 -> V_216 ? L_24 : L_25 ) ;
F_134 ( V_450 , L_27 ,
V_451 , V_94 , V_284 ) ;
}
}
...
static T_1 F_143 ( struct V_1 * V_2 , bool V_459 )
{
struct V_37 * V_38 = F_7 ( V_2 ) ;
struct V_32 * V_460 = F_6 ( & V_38 -> V_197 ) ;
if ( V_459 )
return V_460 -> V_263 [ 0 ] . V_94 ;
else
return V_460 -> V_263 [ V_460 -> V_265 - 1 ] . V_94 ;
}
static T_1 F_144 ( struct V_1 * V_2 , bool V_459 )
{
struct V_37 * V_38 = F_7 ( V_2 ) ;
...
if ( V_65 )
return V_65 ;
V_2 -> V_8 . V_9 . V_464 = V_465 ;
V_2 -> V_8 . V_9 . V_466 = V_465 ;
...
if ( V_463 == 0 )
return 0 ;
F_153 ( & V_2 -> V_8 . V_9 . V_207 . V_472 , V_473 ) ;
F_154 ( & V_2 -> V_8 . V_474 ) ;
V_65 = F_130 ( V_2 ) ;
if ( V_65 )
goto V_475;
...
static bool F_165 ( void * V_462 )
{
return true ;
}
static int F_166 ( void * V_462 )
{
return 0 ;
}
static int F_167 ( void * V_462 )
{
return 0 ;
}
...
case 230 :
F_170 ( L_32 ) ;
V_2 -> V_8 . V_9 . V_207 . V_490 = false ;
V_488 = true ;
break;
case 231 :
F_170 ( L_33 ) ;
V_2 -> V_8 . V_9 . V_207 . V_490 = true ;
V_488 = true ;
break;
default:
break;
...
if ( V_488 )
F_171 ( & V_2 -> V_8 . V_9 . V_207 . V_472 ) ;
return 0 ;
}
static int F_172 ( void * V_462 ,
enum V_491 V_464 )
{
return 0 ;
}
static int F_173 ( void * V_462 ,
enum V_492 V_464 )
{
return 0 ;
}
...
{
V_2 -> V_8 . V_9 . V_207 . V_202 . V_494 = V_495 ;
V_2 -> V_8 . V_9 . V_207 . V_202 . V_68 = & V_496 ;
}
