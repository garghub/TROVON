...
V_19 = F_92 ( V_195 , struct V_18 , V_37 ) ;
F_2 ( L_27 , V_19 ) ;
V_199 = F_12 ( V_19 , struct V_198 , V_207 ) ;
V_201 = V_199 -> V_208 ;
F_135 ( V_201 , V_209 , V_210 ,
...
V_212 = F_77 ( & V_19 -> V_40 , struct V_211 , V_213 ) ;
F_138 ( & V_212 -> V_213 ) ;
V_212 -> V_214 ( V_212 ) ;
}
F_7 ( & V_19 -> V_42 ) ;
...
V_34 -> V_136 -- ;
F_41 ( & V_34 -> V_73 ) ;
while ( ( V_216 = F_114 ( V_19 ) ) != NULL )
F_82 ( V_216 ) ;
F_137 ( V_19 ) ;
F_19 ( V_19 ) ;
}
void F_136 ( struct V_18 * V_19 )
{
F_25 ( V_98 , & V_19 -> V_26 ) ;
if ( F_64 ( V_43 , & V_19 -> V_26 ) )
return;
...
static int F_140 ( struct V_33 * V_34 , struct V_194 * V_218 , struct V_32 * V_32 )
{
struct V_18 * V_19 ;
int V_219 = 0 ;
F_4 ( & V_34 -> V_73 ) ;
...
struct V_18 * V_220 ;
int V_144 ;
for ( V_144 = 0 ; V_144 < V_34 -> V_221 ; V_144 ++ ) {
...
F_140 ( V_34 , & V_34 -> V_137 , V_32 ) ) {
F_143 ( V_34 , V_32 ) ;
F_145 ( V_222 ++ ) ;
}
}
static void F_146 ( struct V_223 * V_224 , int V_225 )
{
struct V_215 * V_216 =
F_12 ( V_224 , struct V_215 , V_226 ) ;
struct V_18 * V_19 = V_216 -> V_19 ;
F_4 ( & V_19 -> V_42 ) ;
F_25 ( V_100 , & V_19 -> V_26 ) ;
if ( V_225 || F_13 ( V_189 , & V_19 -> V_26 ) ) {
F_7 ( & V_19 -> V_42 ) ;
F_2 ( L_29 ) ;
F_19 ( V_19 ) ;
F_147 ( V_216 ) ;
...
F_2 ( L_30 ) ;
V_216 -> V_19 = NULL ;
F_40 ( & V_216 -> V_226 . V_227 , & V_19 -> V_39 ) ;
F_7 ( & V_19 -> V_42 ) ;
F_60 ( V_19 ) ;
F_19 ( V_19 ) ;
}
static struct V_223 * V_183 ( struct V_228 * V_229 )
{
struct V_80 * V_81 = F_12 ( V_229 , struct V_80 , V_163 ) ;
struct V_215 * V_216 ;
if ( V_81 -> V_156 . V_125 || ! F_13 ( V_230 , & V_81 -> V_95 ) )
return NULL ;
if ( V_81 -> V_124 ) {
V_216 = V_81 -> V_124 ;
V_81 -> V_124 = NULL ;
...
T_1 V_231 ;
T_1 V_232 ;
V_232 = sizeof( struct V_215 ) + V_81 -> V_156 . V_14 ;
V_216 = F_148 ( V_232 , V_151 ) ;
if ( V_216 == NULL )
return NULL ;
V_216 -> V_226 . V_22 = V_81 -> V_140 ;
V_216 -> V_233 = V_81 -> V_234 ;
memcpy ( & V_216 -> V_235 , & V_81 -> V_82 , V_81 -> V_85 ) ;
V_216 -> V_236 = V_81 -> V_85 ;
V_216 -> V_237 = V_81 -> V_86 ;
V_216 -> V_238 = V_81 -> V_156 . V_14 >> 2 ;
V_216 -> V_239 = V_81 -> V_240 ;
V_231 = V_81 -> V_156 . V_14 - V_81 -> V_156 . V_119 [ 0 ] . V_120 ;
memcpy ( V_216 -> args , V_81 -> V_156 . V_119 [ 0 ] . V_157 - V_231 ,
V_216 -> V_238 << 2 ) ;
}
F_35 ( V_81 -> V_96 ) ;
V_216 -> V_19 = V_81 -> V_96 ;
F_25 ( V_241 , & V_81 -> V_95 ) ;
V_216 -> V_226 . V_242 = F_146 ;
F_149 ( V_81 ) ;
return & V_216 -> V_226 ;
}
static int F_115 ( struct V_80 * V_81 )
{
struct V_215 * V_216 = V_81 -> V_124 ;
V_81 -> V_156 . V_119 [ 0 ] . V_157 = V_216 -> args + ( V_216 -> V_239 >> 2 ) ;
V_81 -> V_156 . V_119 [ 0 ] . V_120 = ( V_216 -> V_238 << 2 ) - V_216 -> V_239 ;
V_81 -> V_156 . V_125 = 0 ;
V_81 -> V_156 . V_14 = V_216 -> V_238 << 2 ;
V_81 -> V_234 = V_216 -> V_233 ;
memcpy ( & V_81 -> V_82 , & V_216 -> V_235 , V_216 -> V_236 ) ;
V_81 -> V_85 = V_216 -> V_236 ;
V_81 -> V_240 = V_216 -> V_239 ;
V_81 -> V_86 = V_216 -> V_237 ;
V_81 -> V_243 = V_81 -> V_148 ;
return ( V_216 -> V_238 << 2 ) - V_216 -> V_239 ;
}
static struct V_215 * F_114 ( struct V_18 * V_19 )
{
...
F_4 ( & V_19 -> V_42 ) ;
if ( ! F_75 ( & V_19 -> V_39 ) ) {
V_216 = F_92 ( V_19 -> V_39 . V_196 ,
struct V_215 ,
V_226 . V_227 ) ;
F_9 ( & V_216 -> V_226 . V_227 ) ;
F_150 ( V_216 ) ;
} else
...
struct V_32 * V_32 , const T_2 V_244 ,
const unsigned short V_46 )
{
struct V_18 * V_19 ;
struct V_18 * V_245 = NULL ;
...
continue;
if ( V_244 != V_246 && V_244 != V_19 -> V_87 . V_247 )
continue;
...
char * V_248 , int V_249 )
{
int V_14 ;
V_14 = snprintf ( V_248 , V_249 , L_31 ,
V_19 -> V_23 -> V_6 ,
F_46 ( V_19 ) ) ;
if ( V_14 >= V_249 )
return - V_250 ;
...
int F_153 ( struct V_33 * V_34 , char * V_11 , const int V_251 )
{
struct V_18 * V_19 ;
int V_14 , V_252 ;
char * V_248 ;
...
V_252 = 0 ;
F_5 (xprt, &serv->sv_permsocks, xpt_list) {
V_14 = F_152 ( V_19 , V_248 , V_251 - V_252 ) ;
if ( V_14 < 0 ) {
* V_11 = '\0' ;
V_252 = V_14 ;
}
...
static void * F_154 ( struct V_253 * V_254 , T_3 * V_248 )
{
unsigned int V_255 = ( unsigned int ) * V_248 ;
struct V_33 * V_34 = V_254 -> V_256 ;
F_2 ( L_32 , V_255 ) ;
if ( ! V_255 )
return V_257 ;
return ( V_255 > V_34 -> V_221 ? NULL : & V_34 -> V_128 [ V_255 - 1 ] ) ;
}
static void * F_155 ( struct V_253 * V_254 , void * V_150 , T_3 * V_248 )
{
...
unsigned int V_255 = ( V_103 - & V_34 -> V_128 [ 0 ] ) ;
if ( V_255 < V_34 -> V_221 - 1 )
V_103 = & V_34 -> V_128 [ V_255 + 1 ] ;
else
V_103 = NULL ;
}
++ * V_248 ;
...
static void F_156 ( struct V_253 * V_254 , void * V_150 )
{
}
static int F_157 ( struct V_253 * V_254 , void * V_150 )
{
struct V_102 * V_103 = V_150 ;
if ( V_150 == V_257 ) {
F_158 ( V_254 , L_34 ) ;
...
( unsigned long ) F_160 ( & V_103 -> V_106 . V_166 ) ) ;
return 0 ;
}
int F_161 ( struct V_33 * V_34 , struct V_258 * V_258 )
{
int V_78 ;
V_78 = F_162 ( V_258 , & V_259 ) ;
if ( ! V_78 )
( (struct V_253 * ) V_258 -> V_260 ) -> V_256 = V_34 ;
return V_78 ;
}
