...
if ( ! V_77 )
return 0 ;
if ( ! F_34 ( V_45 -> V_78 -> V_79 . V_80 ) )
return 0 ;
if ( ! F_35 ( V_45 -> V_78 -> V_79 . V_80 -> V_81 -> V_82 ) )
return 0 ;
...
V_45 -> V_91 |= V_92 ;
V_86 = ! F_5 ( V_39 -> V_16 , V_40 -> V_89 ) || ! F_39 ( V_39 -> V_93 , V_40 -> V_94 ) ;
if ( ( V_86 ||
...
F_38 ( V_88 ) ) {
V_25 = F_40 ( V_45 , V_39 , V_40 ) ;
if ( V_25 < 0 )
return V_25 ;
}
}
V_39 -> V_104 &= ~ F_41 ( V_105 ) ;
if ( F_22 ( ! F_23 ( V_39 ) ) )
return - V_12 ;
return 0 ;
}
...
int F_44 ( struct V_46 * V_46 , const char * V_106 )
{
if ( ! strcmp ( V_106 , V_50 ) ) {
if ( ! F_7 ( V_109 ) )
return - V_12 ;
...
static inline void F_45 ( struct V_4 * V_39 , const struct V_4 * V_40 )
{
T_3 V_87 = F_37 ( V_40 -> V_10 , 0 ) ;
...
int F_46 ( struct V_4 * V_39 , const struct V_4 * V_40 , int V_108 )
{
switch ( V_108 ) {
case V_112 :
case V_113 :
...
static int F_49 ( struct V_22 * V_117 )
{
int V_118 , V_25 = 0 ;
F_9 () ;
...
int F_50 ( struct V_22 * V_117 )
{
return F_49 ( V_117 ) ;
}
int F_51 ( struct V_22 * V_117 , int V_120 )
{
return F_49 ( V_117 ) ;
}
int F_52 ( struct V_22 * V_117 , int V_121 )
{
return F_49 ( V_117 ) ;
}
static int F_53 ( unsigned long V_7 )
{
struct V_4 * V_39 ;
if ( ! F_13 ( F_54 () , V_37 ) )
return - V_12 ;
...
int F_59 ( int V_123 , unsigned long V_124 , unsigned long V_125 ,
...
return - V_122 ;
if ( V_124 == V_140 )
F_60 ( V_39 -> V_42 , V_125 ) ;
else
F_57 ( V_39 -> V_42 , V_125 ) ;
return F_58 ( V_39 ) ;
}
default:
return - V_143 ;
...
int F_61 ( struct V_144 * V_145 , long V_146 )
{
int V_147 = 0 ;
...
int F_63 ( struct V_78 * V_78 , unsigned long V_154 ,
