...
static int F_119 ( struct V_14 * V_112 , int V_355 ,
struct V_356 * V_357 ,
const T_12 * V_319 , struct V_166 * V_167 )
{
struct V_276 * V_358 = V_3 ;
...
++ V_357 -> V_363 ;
if ( F_55 ( V_357 -> V_363 == 0 ) ||
F_55 ( V_345 -> V_347 [ 0 ] . V_351 != V_350 ) ) {
F_121 ( 1 ) ;
return 0 ;
}
F_84 ( V_112 , V_355 ,
V_345 -> V_265 , V_345 -> V_267 ) ;
for ( V_360 = & V_358 -> V_4 -> V_364 -> V_365 ; V_360 ; V_360 = V_360 -> V_366 ) {
...
if ( ! F_132 ( V_357 ) )
return 0 ;
for ( V_360 = V_3 -> V_4 -> V_364 -> V_365 . V_366 ;
...
static struct V_36 * F_140 ( struct V_276 * V_388 ,
struct V_36 * V_389 )
{
struct V_36 * V_353 = V_388 -> V_4 -> V_129 ;
if ( V_353 )
return V_353 ;
return V_389 ;
}
static struct V_36 * F_141 ( struct V_36 * V_390 ,
struct V_36 * V_389 )
{
struct V_36 * V_353 ;
V_353 = V_390 -> V_333 ;
...
static void F_142 ( struct V_14 * V_112 , struct V_391 * V_392 ,
T_1 V_393 , int V_254 )
{
V_112 -> V_393 = V_393 ;
...
V_254 ++ ;
V_254 ++ ;
V_51 = V_254 > V_408 ? V_408 : V_254 ;
if ( ! F_119 ( V_112 , V_51 , & V_357 , V_249 -> V_319 , V_249 -> V_167 ) )
goto V_409;
V_403 = 1 ;
V_228 = F_75 () ;
F_77 ( V_321 ) ;
...
V_405 = V_269 = F_80 ( V_269 , V_43 ) ;
V_407 = F_146 ( V_254 - 1 , sizeof( * V_407 ) , V_108 ) ;
if ( ! V_407 )
goto V_410;
for ( V_95 = 0 , V_37 = F_140 ( V_3 , V_389 ) ; V_37 != NULL ;
V_37 = F_141 ( V_37 , V_389 ) ) {
unsigned long V_411 ;
V_411 = F_71 ( V_37 , V_249 -> V_204 ) ;
V_407 [ V_95 ++ ] = V_411 ;
V_404 += V_411 ;
}
V_269 += V_404 ;
