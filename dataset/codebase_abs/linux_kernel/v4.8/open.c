...
const struct V_86 * V_86 )
{
struct V_1 * V_1 = F_68 ( V_17 -> V_1 , NULL , V_4 -> V_38 ) ;
if ( F_69 ( V_1 ) )
return F_70 ( V_1 ) ;
V_4 -> V_40 = * V_17 ;
return F_45 ( V_4 , F_62 ( V_1 ) , NULL , V_86 ) ;
}
...
struct V_4 * F_87 ( struct V_4 * V_144 )
{
struct V_4 * V_4 ;
int V_145 ;
V_4 = F_73 () ;
...
return V_4 ;
V_4 -> V_38 = V_144 -> V_38 ;
V_145 = F_67 ( & V_144 -> V_40 , V_4 , V_144 -> V_146 ) ;
if ( V_145 ) {
F_76 ( V_4 ) ;
return F_75 ( V_145 ) ;
}
...
long F_88 ( int V_147 , const char T_2 * V_140 , int V_118 , T_3 V_48 )
{
struct V_119 V_120 ;
...
V_34 = F_90 ( V_118 ) ;
if ( V_34 >= 0 ) {
struct V_4 * V_36 = F_80 ( V_147 , V_148 , & V_120 ) ;
if ( F_69 ( V_36 ) ) {
F_91 ( V_34 ) ;
V_34 = F_70 ( V_36 ) ;
} else {
...
int F_94 ( struct V_4 * V_5 , T_8 V_149 )
{
int V_145 = 0 ;
if ( ! F_95 ( V_5 ) ) {
F_96 ( V_150 L_1 ) ;
...
if ( V_5 -> V_63 -> V_151 )
V_145 = V_5 -> V_63 -> V_151 ( V_5 , V_149 ) ;
...
int F_99 ( struct V_18 * V_18 , struct V_4 * V_5 )
{
if ( ! ( V_5 -> V_38 & V_39 ) && F_100 ( V_18 ) > V_44 )
return - V_152 ;
return 0 ;
}
