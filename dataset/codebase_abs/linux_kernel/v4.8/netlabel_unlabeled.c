...
int T_3 F_89 ( T_1 V_15 )
{
T_1 V_19 ;
struct V_123 * V_124 ;
if ( V_15 == 0 )
return - V_51 ;
V_124 = F_90 ( sizeof( * V_124 ) , V_91 ) ;
if ( V_124 == NULL )
return - V_29 ;
V_124 -> V_15 = 1 << V_15 ;
V_124 -> V_20 = F_91 ( V_124 -> V_15 ,
sizeof( struct V_17 ) ,
V_91 ) ;
if ( V_124 -> V_20 == NULL ) {
F_6 ( V_124 ) ;
...
int F_93 ( const struct V_85 * V_86 ,
T_4 V_126 ,
struct V_127 * V_128 )
{
struct V_3 * V_4 ;
