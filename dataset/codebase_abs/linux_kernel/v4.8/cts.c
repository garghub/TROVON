...
int V_21 = F_16 ( V_6 ) ;
T_1 V_22 [ V_21 * 2 ] V_23 ( ( F_17 ( F_18 ( V_24 ) ) ) ) ;
struct V_25 * V_26 ;
unsigned int V_27 ;
int V_28 ;
V_27 = V_4 -> V_27 ;
V_28 = V_2 -> V_29 - V_27 ;
V_26 = F_19 ( V_4 -> V_26 , V_2 -> V_30 , V_27 - V_21 ) ;
F_20 ( V_22 + V_21 , V_26 , 0 , V_21 , 0 ) ;
memset ( V_22 , 0 , V_21 ) ;
F_20 ( V_22 , V_2 -> V_31 , V_27 , V_28 , 0 ) ;
F_20 ( V_22 , V_26 , 0 , V_21 + V_28 , 1 ) ;
F_21 ( V_22 , sizeof( V_22 ) ) ;
F_22 ( V_20 , V_2 -> V_32 . V_33 &
V_34 ,
F_13 , V_2 ) ;
F_23 ( V_20 , V_26 , V_26 , V_21 , V_2 -> V_35 ) ;
return F_24 ( V_20 ) ;
}
static void F_25 ( struct V_16 * V_17 , int V_13 )
{
struct V_1 * V_2 = V_17 -> V_18 ;
if ( V_13 )
goto V_36;
...
V_2 -> V_32 . V_40 ,
V_2 -> V_32 . V_18 ) ;
F_23 ( V_20 , V_2 -> V_31 , V_2 -> V_30 , V_38 ,
V_2 -> V_35 ) ;
return F_24 ( V_20 ) ;
}
V_27 = V_39 * V_21 ;
...
F_20 ( V_22 + V_21 , V_26 , 0 , V_21 , 0 ) ;
V_41 = F_1 ( V_2 ) ;
F_29 ( V_22 + V_21 , V_41 , V_21 ) ;
memset ( V_22 , 0 , V_21 ) ;
F_20 ( V_22 , V_2 -> V_31 , V_27 , V_28 , 0 ) ;
F_29 ( V_22 + V_21 , V_22 , V_28 ) ;
...
V_34 ,
F_13 , V_2 ) ;
F_23 ( V_20 , V_26 , V_26 , V_21 , V_41 ) ;
return F_30 ( V_20 ) ;
}
static void F_31 ( struct V_16 * V_17 , int V_13 )
{
struct V_1 * V_2 = V_17 -> V_18 ;
if ( V_13 )
goto V_36;
...
F_20 ( V_41 , V_2 -> V_31 , V_27 - 2 * V_21 ,
V_21 , 0 ) ;
F_23 ( V_20 , V_2 -> V_31 , V_2 -> V_30 ,
V_27 , V_2 -> V_35 ) ;
return F_30 ( V_20 ) ? :
...
static int F_47 ( struct V_49 * V_50 , struct V_51 * * V_52 )
{
struct V_44 * V_45 ;
struct V_42 * V_43 ;
struct V_53 * V_54 ;
...
if ( F_37 ( V_57 ) )
return F_38 ( V_57 ) ;
V_43 = F_50 ( sizeof( * V_43 ) + sizeof( * V_45 ) , V_61 ) ;
if ( ! V_43 )
return - V_62 ;
V_45 = F_35 ( V_43 ) ;
F_51 ( V_45 , F_52 ( V_43 ) ) ;
V_13 = F_53 ( V_45 , V_57 , 0 ,
F_54 ( V_54 -> type ,
V_54 -> V_59 ) ) ;
if ( V_13 )
goto V_63;
V_56 = F_55 ( V_45 ) ;
V_13 = - V_60 ;
if ( F_56 ( V_56 ) != V_56 -> V_32 . V_64 )
goto V_65;
if ( strncmp ( V_56 -> V_32 . V_66 , L_1 , 4 ) )
goto V_65;
V_13 = F_57 ( F_52 ( V_43 ) , L_2 ,
& V_56 -> V_32 ) ;
if ( V_13 )
goto V_65;
...
V_43 -> V_56 . V_32 . V_70 |= F_18 ( V_24 ) - 1 ;
V_43 -> V_56 . V_71 = V_56 -> V_32 . V_64 ;
V_43 -> V_56 . V_72 = F_58 ( V_56 ) ;
V_43 -> V_56 . V_73 = F_59 ( V_56 ) ;
V_43 -> V_56 . V_74 = F_60 ( V_56 ) ;
