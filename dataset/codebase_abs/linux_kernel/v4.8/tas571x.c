...
{
struct V_1 * V_2 ;
struct V_90 * V_58 = & V_19 -> V_58 ;
const struct V_91 * V_92 ;
int V_20 , V_23 ;
V_2 = F_37 ( V_58 , sizeof( * V_2 ) , V_38 ) ;
if ( ! V_2 )
return - V_40 ;
F_38 ( V_19 , V_2 ) ;
V_92 = F_39 ( V_93 , V_58 ) ;
...
V_2 -> V_7 = ( void * ) V_89 -> V_95 ;
V_2 -> V_86 = F_40 ( V_58 , L_2 ) ;
if ( F_29 ( V_2 -> V_86 ) && F_41 ( V_2 -> V_86 ) != - V_96 ) {
F_31 ( V_58 , L_3 ,
F_41 ( V_2 -> V_86 ) ) ;
return F_41 ( V_2 -> V_86 ) ;
}
F_42 ( V_2 -> V_7 -> V_97 > V_98 ) ;
for ( V_20 = 0 ; V_20 < V_2 -> V_7 -> V_97 ; V_20 ++ )
V_2 -> V_99 [ V_20 ] . V_100 = V_2 -> V_7 -> V_101 [ V_20 ] ;
V_23 = F_43 ( V_58 , V_2 -> V_7 -> V_97 ,
V_2 -> V_99 ) ;
if ( V_23 ) {
F_31 ( V_58 , L_4 , V_23 ) ;
return V_23 ;
}
V_23 = F_44 ( V_2 -> V_7 -> V_97 ,
V_2 -> V_99 ) ;
if ( V_23 ) {
F_31 ( V_58 , L_5 , V_23 ) ;
return V_23 ;
}
V_2 -> V_73 = F_45 ( V_58 , NULL , V_19 ,
V_2 -> V_7 -> V_102 ) ;
if ( F_29 ( V_2 -> V_73 ) )
return F_41 ( V_2 -> V_73 ) ;
V_2 -> V_87 = F_46 ( V_58 , L_6 , V_103 ) ;
if ( F_29 ( V_2 -> V_87 ) ) {
F_31 ( V_58 , L_7 ,
F_41 ( V_2 -> V_87 ) ) ;
return F_41 ( V_2 -> V_87 ) ;
}
V_2 -> V_104 = F_46 ( V_58 , L_8 ,
V_105 ) ;
if ( F_29 ( V_2 -> V_104 ) ) {
F_31 ( V_58 , L_9 ,
F_41 ( V_2 -> V_104 ) ) ;
...
V_23 = F_47 ( V_2 -> V_73 , V_106 , 0 ) ;
if ( V_23 )
return V_23 ;
memcpy ( & V_2 -> V_107 , & V_108 , sizeof( V_2 -> V_107 ) ) ;
V_2 -> V_107 . V_109 = V_2 -> V_7 -> V_109 ;
V_2 -> V_107 . V_110 = V_2 -> V_7 -> V_110 ;
if ( V_2 -> V_7 -> V_8 == 2 ) {
...
F_33 ( V_2 -> V_73 , true ) ;
F_32 ( V_2 -> V_87 , 1 ) ;
return F_48 ( & V_19 -> V_58 , & V_2 -> V_107 ,
& V_111 , 1 ) ;
}
