...
F_20 ( V_31 , L_3 , V_18 ) ;
F_10 ( V_1 , 0x90 ,
V_32 [ V_18 ] , sizeof V_32 [ 0 ] ) ;
}
static void F_21 ( struct V_1 * V_1 )
{
struct V_33 * V_33 = (struct V_33 * ) V_1 ;
T_1 V_34 [ 8 ] = {
0x87 , 0x00 , 0x88 , 0x00 , 0x89 , 0x00 , 0x80 , 0x00 } ;
T_3 V_35 , V_36 , V_37 ;
V_37 = V_33 -> V_38 -> V_18 ;
V_35 = V_37 + V_33 -> V_39 -> V_18 ;
if ( V_35 > 0x40 )
V_35 = 0x40 ;
else if ( V_35 < 0x10 )
V_35 = 0x10 ;
V_36 = V_37 + V_33 -> V_40 -> V_18 ;
if ( V_36 > 0x40 )
V_36 = 0x40 ;
else if ( V_36 < 0x10 )
V_36 = 0x10 ;
...
{
struct V_33 * V_33 = (struct V_33 * ) V_1 ;
F_6 ( V_1 , V_41 [ V_33 -> V_42 ] . V_70 ,
sizeof V_41 [ V_33 -> V_42 ] . V_70 ) ;
F_6 ( V_1 , V_41 [ V_33 -> V_42 ] . V_70 ,
sizeof V_41 [ V_33 -> V_42 ] . V_70 ) ;
if ( V_33 -> V_42 == V_48 ) {
F_13 ( 20 ) ;
...
int V_10 )
{
struct V_33 * V_33 V_93 = (struct V_33 * ) V_1 ;
int V_94 ;
if ( V_92 [ 0 ] == 0x5a ) {
#if F_31 ( V_88 )
if ( V_10 > 20 ) {
T_1 V_95 = ( V_92 [ 20 ] & 0x80 ) ? 1 : 0 ;
if ( V_33 -> V_89 != V_95 ) {
F_32 ( V_1 -> V_90 ,
V_91 , V_95 ) ;
F_33 ( V_1 -> V_90 ) ;
...
V_92 += 2 ;
V_10 -= 2 ;
if ( V_92 [ 0 ] == 0xff && V_92 [ 1 ] == 0xd8 )
V_94 = V_96 ;
else if ( V_92 [ V_10 - 2 ] == 0xff && V_92 [ V_10 - 1 ] == 0xd9 )
V_94 = V_97 ;
else
V_94 = V_98 ;
F_35 ( V_1 , V_94 , V_92 , V_10 ) ;
}
...
V_37 = 0x10 ;
V_33 -> V_38 -> V_18 = V_37 ;
V_33 -> V_39 -> V_18 = V_35 - V_37 ;
V_33 -> V_40 -> V_18 = V_36 - V_37 ;
break;
}
return 0 ;
}
...
F_41 ( V_116 , & V_118 ,
V_110 , 0 , 1 , 1 , 0 ) ;
V_33 -> V_44 = F_41 ( V_116 , & V_118 ,
V_104 , 0 , 1 , 1 , 1 ) ;
V_33 -> V_38 = F_41 ( V_116 , & V_118 ,
V_120 , 0x10 , 0x40 , 1 , 0x20 ) ;
V_33 -> V_40 = F_41 ( V_116 , & V_118 ,
V_121 , - 0x30 , 0x30 , 1 , 0 ) ;
V_33 -> V_39 = F_41 ( V_116 , & V_118 ,
V_122 , - 0x30 , 0x30 , 1 , 0 ) ;
F_41 ( V_116 , & V_118 ,
V_111 , 0 , 15 , 1 , 6 ) ;
F_42 ( V_116 , & V_118 ,
...
F_43 ( 4 , & V_33 -> V_44 , 0 , true ) ;
return 0 ;
}
static int F_44 ( struct V_125 * V_126 ,
const struct V_21 * V_22 )
{
return F_45 ( V_126 , V_22 , & V_127 , sizeof( struct V_33 ) ,
V_128 ) ;
}
