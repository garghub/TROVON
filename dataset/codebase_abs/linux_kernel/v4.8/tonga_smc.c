...
struct V_72 * V_73 )
{
enum V_52 V_74 = F_23 ( V_53 ) ;
struct V_75 * V_76 = & V_2 -> V_77 . V_76 [ V_74 ] ;
const struct V_78 * V_45 = NULL ;
T_4 V_79 ;
T_1 V_80 ;
if ( V_76 -> V_42 == NULL )
return - V_6 ;
V_79 = V_76 -> V_81 ;
V_45 = ( const struct V_78 * ) V_76 -> V_42 -> V_15 ;
V_80 = F_22 ( V_45 -> V_45 . V_48 ) ;
if ( ( V_53 == V_65 ) ||
( V_53 == V_67 ) ) {
V_79 += F_22 ( V_45 -> V_82 ) << 2 ;
V_80 = F_22 ( V_45 -> V_83 ) << 2 ;
}
V_73 -> V_84 = ( V_85 ) F_22 ( V_45 -> V_45 . V_47 ) ;
V_73 -> V_74 = ( V_85 ) V_53 ;
V_73 -> V_86 = F_25 ( V_79 ) ;
V_73 -> V_87 = F_26 ( V_79 ) ;
V_73 -> V_88 = 0 ;
...
{
struct V_92 * V_93 = (struct V_92 * ) V_2 -> V_94 . V_95 ;
struct V_96 * V_97 ;
T_1 V_98 ;
F_28 ( V_99 , 0 ) ;
F_18 ( V_2 , V_100 , V_93 -> V_101 ) ;
F_18 ( V_2 , V_102 , V_93 -> V_103 ) ;
V_97 = (struct V_96 * ) V_93 -> V_45 ;
V_97 -> V_104 = 0 ;
V_97 -> V_105 = 1 ;
if ( ! V_2 -> V_77 . V_106 )
return 0 ;
if ( F_24 ( V_2 , V_69 ,
& V_97 -> V_73 [ V_97 -> V_104 ++ ] ) ) {
F_15 ( L_6 ) ;
return - V_6 ;
}
if ( F_24 ( V_2 , V_58 ,
...
F_18 ( V_2 , V_107 , V_93 -> V_108 ) ;
F_18 ( V_2 , V_109 , V_93 -> V_110 ) ;
V_98 = V_111 |
V_112 |
V_113 |
V_114 |
...
{
struct V_92 * V_93 ;
T_1 V_139 = ( ( sizeof( struct V_96 ) / 4096 ) + 1 ) * 4096 ;
T_1 V_140 = 200 * 4096 ;
struct V_141 * * V_142 = & V_2 -> V_94 . V_142 ;
struct V_141 * * V_143 = & V_2 -> V_94 . V_143 ;
T_4 V_81 ;
void * V_144 ;
void * V_145 ;
int V_146 ;
V_93 = F_35 ( sizeof( struct V_92 ) , V_147 ) ;
if ( NULL == V_93 )
return - V_148 ;
if ( V_2 -> V_77 . V_106 )
F_36 ( V_2 ) ;
...
V_146 = F_38 ( V_2 -> V_94 . V_142 , false ) ;
if ( V_146 ) {
F_39 ( & V_2 -> V_94 . V_142 ) ;
F_15 ( L_25 ) ;
return - V_6 ;
}
V_146 = F_40 ( V_2 -> V_94 . V_142 , V_151 , & V_81 ) ;
if ( V_146 ) {
F_41 ( V_2 -> V_94 . V_142 ) ;
F_39 ( & V_2 -> V_94 . V_142 ) ;
F_15 ( L_26 ) ;
...
F_41 ( V_2 -> V_94 . V_142 ) ;
V_93 -> V_110 = F_26 ( V_81 ) ;
V_93 -> V_108 = F_25 ( V_81 ) ;
V_93 -> V_45 = V_144 ;
V_146 = F_38 ( V_2 -> V_94 . V_143 , false ) ;
if ( V_146 ) {
F_39 ( & V_2 -> V_94 . V_143 ) ;
F_39 ( & V_2 -> V_94 . V_142 ) ;
F_15 ( L_28 ) ;
...
V_146 = F_40 ( V_2 -> V_94 . V_143 , V_151 , & V_81 ) ;
if ( V_146 ) {
F_41 ( V_2 -> V_94 . V_143 ) ;
F_39 ( & V_2 -> V_94 . V_143 ) ;
F_39 ( & V_2 -> V_94 . V_142 ) ;
...
F_41 ( V_2 -> V_94 . V_143 ) ;
V_93 -> V_103 = F_26 ( V_81 ) ;
V_93 -> V_101 = F_25 ( V_81 ) ;
V_2 -> V_94 . V_153 = & V_154 ;
return 0 ;
}
