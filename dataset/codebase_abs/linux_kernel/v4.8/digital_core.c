...
V_114 = & V_3 -> V_76 [ V_3 -> V_77 ] ;
F_16 ( & V_3 -> V_110 ) ;
V_16 = V_114 -> V_115 ( V_3 , V_114 -> V_57 ) ;
if ( V_16 )
F_41 ( V_3 ) ;
}
static void F_45 ( struct V_2 * V_3 , T_3 V_57 ,
T_5 V_115 )
{
struct V_113 * V_114 ;
if ( V_3 -> V_75 >= V_116 )
return;
V_114 = & V_3 -> V_76 [ V_3 -> V_75 ++ ] ;
V_114 -> V_57 = V_57 ;
V_114 -> V_115 = V_115 ;
}
static int F_46 ( struct V_108 * V_108 , T_6 V_117 ,
T_6 V_118 )
{
...
F_38 ( L_9 , V_117 ,
V_118 , V_3 -> V_121 ) ;
V_119 = V_3 -> V_121 & V_117 ;
V_120 = V_3 -> V_121 & V_118 ;
if ( ! V_119 && ! V_120 ) {
F_24 ( L_10 ) ;
return - V_100 ;
}
...
static void F_48 ( struct V_108 * V_108 )
{
struct V_2 * V_3 = F_47 ( V_108 ) ;
F_14 ( & V_3 -> V_110 ) ;
if ( ! V_3 -> V_75 ) {
...
static int F_51 ( struct V_108 * V_108 )
{
struct V_2 * V_3 = F_47 ( V_108 ) ;
F_10 ( V_3 , 0 ) ;
return 0 ;
...
struct V_71 * V_72 ,
T_8 V_139 , T_8 * V_140 , T_9 V_141 )
{
struct V_2 * V_3 = F_47 ( V_108 ) ;
int V_16 ;
V_16 = F_53 ( V_3 , V_72 , V_139 , V_140 , V_141 ) ;
if ( ! V_16 )
V_3 -> V_123 = V_90 ;
return V_16 ;
}
static int F_54 ( struct V_108 * V_108 )
{
struct V_2 * V_3 = F_47 ( V_108 ) ;
F_11 ( V_3 ) ;
V_3 -> V_123 = 0 ;
...
static int F_55 ( struct V_108 * V_108 ,
...
static void F_56 ( struct V_108 * V_108 ,
struct V_71 * V_72 ,
T_3 V_142 )
{
struct V_2 * V_3 = F_47 ( V_108 ) ;
...
static int F_57 ( struct V_108 * V_143 , struct V_1 * V_5 )
{
struct V_2 * V_3 = F_47 ( V_143 ) ;
return F_58 ( V_3 , V_5 ) ;
}
static void F_59 ( struct V_2 * V_3 , void * V_36 ,
struct V_1 * V_30 )
{
struct V_144 * V_145 = V_36 ;
int V_16 ;
if ( F_18 ( V_30 ) ) {
V_16 = F_60 ( V_30 ) ;
V_30 = NULL ;
...
V_145 -> V_147 ( V_145 -> V_33 , V_30 , V_16 ) ;
F_20 ( V_145 ) ;
}
static int F_63 ( struct V_108 * V_108 , struct V_71 * V_72 ,
struct V_1 * V_5 , T_10 V_147 ,
void * V_33 )
{
struct V_2 * V_3 = F_47 ( V_108 ) ;
struct V_144 * V_145 ;
int V_16 ;
V_145 = F_27 ( sizeof( struct V_144 ) , V_8 ) ;
if ( ! V_145 ) {
F_24 ( L_17 ) ;
return - V_53 ;
}
...
struct V_2 * F_67 ( struct V_148 * V_19 ,
T_6 V_107 ,
T_6 V_149 ,
int V_6 , int V_7 )
{
...
! V_19 -> V_20 || ( V_19 -> V_51 && ! V_19 -> V_150 ) )
return NULL ;
...
V_3 -> V_6 = V_6 + V_157 ;
V_3 -> V_7 = V_7 + V_158 ;
V_3 -> V_108 = F_71 ( & V_159 , V_3 -> V_121 ,
V_3 -> V_6 ,
V_3 -> V_7 ) ;
if ( ! V_3 -> V_108 ) {
F_24 ( L_18 ) ;
...
{
return F_76 ( V_3 -> V_108 ) ;
}
void F_77 ( struct V_2 * V_3 )
{
struct V_24 * V_25 , * V_161 ;
F_78 ( V_3 -> V_108 ) ;
F_14 ( & V_3 -> V_110 ) ;
V_3 -> V_75 = 0 ;
F_16 ( & V_3 -> V_110 ) ;
...
F_79 ( & V_3 -> V_35 ) ;
F_79 ( & V_3 -> V_26 ) ;
F_80 (cmd, n, &ddev->cmd_queue, queue) {
F_17 ( & V_25 -> V_29 ) ;
if ( V_25 -> V_32 )
V_25 -> V_32 ( V_3 , V_25 -> V_33 , F_81 ( - V_162 ) ) ;
F_20 ( V_25 -> V_34 ) ;
F_20 ( V_25 ) ;
}
}
