...
static int F_73 ( struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
struct V_16 * V_204 ;
int V_21 = 0 , V_42 = 0 ;
int V_205 = V_2 -> V_20 ;
V_2 -> V_29 = F_74 ( sizeof( * V_2 -> V_29 ) * V_2 -> V_20 ,
V_73 ) ;
if ( ! V_2 -> V_29 )
return - V_74 ;
V_2 -> V_19 = 0 ;
...
static void F_76 ( struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
int V_209 ;
...
V_2 -> V_19 ) ;
if ( V_2 -> V_25 )
F_78 ( V_2 -> V_11 -> V_11 . V_70 , V_2 -> V_206 ,
V_2 -> V_25 , V_2 -> V_102 ) ;
F_75 ( V_2 -> V_29 ) ;
}
static int F_79 ( struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
struct V_99 * V_210 ;
int V_21 = 0 , V_42 = 0 ;
int V_211 = V_2 -> V_120 ;
V_2 -> V_122 = F_74 ( sizeof( * V_2 -> V_122 ) * V_2 -> V_120 ,
V_73 ) ;
if ( ! V_2 -> V_122 )
return - V_74 ;
V_2 -> V_116 = 0 ;
...
static void F_80 ( struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
F_40 ( V_11 , 1 ) ;
F_81 ( V_2 -> V_117 != V_2 -> V_96 ) ;
if ( V_2 -> V_118 )
F_78 ( V_2 -> V_11 -> V_11 . V_70 , V_2 -> V_212 ,
V_2 -> V_118 , V_2 -> V_98 ) ;
F_75 ( V_2 -> V_122 ) ;
}
...
if ( V_183 )
return V_183 ;
V_183 = F_82 ( V_11 -> V_149 , F_58 , 0 , V_11 -> V_213 , V_11 ) ;
if ( V_183 ) {
F_83 ( & V_11 -> V_11 , L_8 ) ;
return - V_214 ;
}
...
static int F_89 ( struct V_13 * V_11 , int V_152 )
{
int V_217 ;
struct V_1 * V_2 = F_9 ( V_11 ) ;
...
int V_219 ;
V_219 = V_2 -> V_96 ;
V_2 -> V_96 = ( V_219 + 1 ) % V_2 -> V_120 ;
F_81 ( V_2 -> V_96 == V_2 -> V_117 ) ;
V_2 -> V_116 ++ ;
return V_219 ;
}
static int F_92 ( struct V_220 * V_39 , int V_130 )
{
struct V_1 * V_2 =
...
static int F_96 ( struct V_14 * V_15 , struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
struct V_131 * V_124 = & V_11 -> V_124 ;
struct V_99 * V_110 ;
...
V_110 -> V_121 = V_222 ;
V_110 -> V_26 = F_13 ( NULL , V_15 -> V_5 , V_222 , V_126 ) ;
F_97 ( V_15 ) ;
F_14 () ;
V_110 -> V_30 = V_31 | V_224 | V_225 |
V_226 | V_227 | V_228 ;
F_98 () ;
F_3 ( V_2 , V_8 , V_229 | V_108 ) ;
V_124 -> V_230 += V_222 ;
V_124 -> V_231 ++ ;
F_99 ( V_11 ) ;
...
static int F_103 ( struct V_237 * V_238 , int V_185 , int V_239 )
{
...
F_3 ( V_2 , V_233 , ( V_185 << 16 ) | ( V_239 << 21 ) | V_241 ) ;
...
static int F_105 ( struct V_237 * V_238 , int V_185 , int V_239 ,
T_5 V_244 )
{
struct V_1 * V_2 = V_238 -> V_240 ;
if ( F_101 ( V_2 ) ) {
...
F_3 ( V_2 , V_233 , ( V_185 << 16 ) | ( V_239 << 21 ) |
V_245 | ( V_244 & 0xffff ) ) ;
if ( F_101 ( V_2 ) ) {
F_7 ( V_2 -> V_11 , L_10 ) ;
return - V_236 ;
...
static int F_106 ( struct V_13 * V_11 , struct V_246 * V_247 ,
int V_182 )
{
if ( V_11 -> V_95 != NULL )
return F_107 ( V_11 -> V_95 , V_247 , V_182 ) ;
return - V_248 ;
}
static int F_69 ( struct V_13 * V_11 ,
struct V_181 * V_182 )
{
int V_183 ;
V_183 = F_108 ( V_11 -> V_95 ) ;
if ( V_183 == 0 )
V_183 = F_109 ( V_11 -> V_95 , V_182 ) ;
return V_183 ;
}
static void F_110 ( struct V_13 * V_11 ,
struct V_249 * V_250 )
{
F_111 ( V_250 -> V_251 , V_252 , sizeof( V_250 -> V_251 ) ) ;
F_111 ( V_250 -> V_253 , V_254 , sizeof( V_250 -> V_253 ) ) ;
F_111 ( V_250 -> V_255 , L_12 , sizeof( V_250 -> V_255 ) ) ;
F_111 ( V_250 -> V_256 , L_12 , sizeof( V_250 -> V_256 ) ) ;
}
static int F_112 ( struct V_257 * V_258 )
{
struct V_1 * V_2 = NULL ;
...
int V_183 ;
F_113 ( V_264 L_13 ) ;
V_261 = F_114 ( & V_258 -> V_11 , NULL ) ;
if ( F_66 ( V_261 ) ) {
F_83 ( & V_258 -> V_11 , L_14 ) ;
return - V_243 ;
}
F_115 ( V_261 ) ;
V_11 = F_116 ( sizeof( struct V_1 ) ) ;
if ( ! V_11 ) {
V_183 = - V_74 ;
goto V_265;
}
...
V_2 -> V_11 = V_11 ;
V_2 -> V_261 = V_261 ;
V_260 = F_118 ( V_258 , V_266 , 0 ) ;
V_2 -> V_4 = F_119 ( & V_258 -> V_11 , V_260 ) ;
if ( F_66 ( V_2 -> V_4 ) ) {
V_183 = - V_74 ;
goto V_267;
}
V_260 = F_118 ( V_258 , V_268 , 0 ) ;
F_81 ( ! V_260 ) ;
V_11 -> V_149 = V_260 -> V_55 ;
V_11 -> V_269 = & V_270 ;
V_11 -> V_271 = 2 * V_38 ;
V_11 -> V_272 = 0 ;
V_11 -> V_273 = & V_274 ;
F_120 ( & V_2 -> V_127 , F_48 ) ;
if ( V_258 -> V_11 . V_275 )
V_41 = F_121 ( V_258 -> V_11 . V_275 ) ;
if ( V_41 && F_33 ( V_41 ) ) {
F_122 ( V_11 -> V_83 , V_41 ) ;
} else {
F_31 ( V_11 , V_11 -> V_83 ) ;
if ( ! F_33 ( V_11 -> V_83 ) ) {
F_123 ( & V_258 -> V_11 , L_15 ) ;
F_124 ( V_11 ) ;
}
}
V_2 -> V_20 = V_276 ;
V_2 -> V_120 = V_277 ;
V_2 -> V_278 = F_125 ( & V_258 -> V_11 ) ;
if ( V_2 -> V_278 ) {
if ( V_2 -> V_278 -> V_279 )
V_2 -> V_20 = V_2 -> V_278 -> V_279 ;
if ( V_2 -> V_278 -> V_280 )
V_2 -> V_120 = V_2 -> V_278 -> V_280 ;
V_2 -> V_281 = V_2 -> V_278 -> V_282 ;
V_2 -> V_185 = V_2 -> V_278 -> V_185 ;
V_2 -> V_188 = V_2 -> V_278 -> V_177 ;
V_2 -> V_189 = V_2 -> V_278 -> V_179 ;
V_2 -> V_186 = V_2 -> V_278 -> V_283 ;
if ( V_2 -> V_278 -> V_284 )
V_2 -> V_278 -> V_284 () ;
} else if ( V_258 -> V_11 . V_275 ) {
F_126 ( V_258 -> V_11 . V_275 , L_16 ,
& V_2 -> V_281 ) ;
V_263 = F_127 ( V_258 -> V_11 . V_275 , L_17 , 0 ) ;
if ( ! V_263 ) {
F_83 ( & V_258 -> V_11 , L_18 ) ;
V_183 = - V_218 ;
goto V_267;
}
F_126 ( V_263 , L_19 , & V_2 -> V_185 ) ;
V_2 -> V_186 = F_128 ( V_258 -> V_11 . V_275 ) ;
F_129 ( V_263 ) ;
}
F_81 ( V_2 -> V_281 > 2 ) ;
F_130 ( V_11 , & V_2 -> V_39 , F_92 , V_2 -> V_20 ) ;
memset ( & V_2 -> V_35 , 0 , sizeof( struct V_285 ) ) ;
F_131 ( & V_2 -> V_35 ) ;
V_2 -> V_35 . V_286 = F_16 ;
...
V_2 -> V_184 -> V_287 = F_103 ;
V_2 -> V_184 -> V_288 = F_105 ;
snprintf ( V_2 -> V_184 -> V_289 , V_290 , L_21 ,
V_258 -> V_213 , V_258 -> V_289 ) ;
V_2 -> V_184 -> V_70 = & V_258 -> V_11 ;
V_2 -> V_184 -> V_291 = 0xffffffff ;
V_183 = F_133 ( V_2 -> V_184 ) ;
if ( V_183 )
goto V_292;
F_134 ( V_11 , & V_258 -> V_11 ) ;
F_72 ( V_2 ) ;
V_183 = F_135 ( V_11 ) ;
if ( V_183 )
goto V_293;
...
static int F_140 ( struct V_257 * V_258 )
{
struct V_13 * V_11 = F_141 ( V_258 ) ;
struct V_1 * V_2 = F_9 ( V_11 ) ;
if ( V_2 -> V_61 ) {
F_78 ( V_2 -> V_11 -> V_11 . V_70 , V_71 ,
V_2 -> V_61 , V_2 -> V_72 ) ;
V_2 -> V_61 = NULL ;
}
if ( V_11 -> V_95 )
...
static void F_145 ( struct V_257 * V_258 )
{
struct V_13 * V_11 = F_141 ( V_258 ) ;
F_38 ( V_11 ) ;
}
static int F_146 ( struct V_257 * V_258 )
{
return - V_294 ;
}
static int F_147 ( struct V_257 * V_258 , T_6 V_295 )
{
return - V_294 ;
}
