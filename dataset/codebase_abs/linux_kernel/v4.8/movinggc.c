...
if ( 0 ) {
V_48: if ( ! F_46 ( V_19 -> V_49 ) )
F_8 ( V_19 -> V_49 ) ;
F_13 ( & V_6 -> V_7 , V_19 ) ;
}
F_47 ( & V_10 ) ;
}
static bool F_48 ( struct V_54 * V_55 , struct V_54 * V_56 )
{
return F_49 ( V_55 ) < F_49 ( V_56 ) ;
}
static unsigned F_50 ( struct V_57 * V_58 )
{
struct V_54 * V_23 ;
return ( V_23 = F_51 ( & V_58 -> V_59 ) ) ? F_49 ( V_23 ) : 0 ;
}
...
if ( F_57 ( V_23 ) == V_68 ||
! F_49 ( V_23 ) ||
F_49 ( V_23 ) == V_58 -> V_64 . V_65 ||
F_58 ( & V_23 -> V_69 ) )
continue;
if ( ! F_59 ( & V_58 -> V_59 ) ) {
V_62 += F_49 ( V_23 ) ;
F_60 ( & V_58 -> V_59 , V_23 , F_48 ) ;
} else if ( F_48 ( V_23 , F_51 ( & V_58 -> V_59 ) ) ) {
V_62 -= F_50 ( V_58 ) ;
V_62 += F_49 ( V_23 ) ;
V_58 -> V_59 . V_70 [ 0 ] = V_23 ;
F_61 ( & V_58 -> V_59 , 0 , F_48 ) ;
}
}
while ( V_62 > V_63 ) {
F_62 ( & V_58 -> V_59 , V_23 , F_48 ) ;
V_62 -= F_49 ( V_23 ) ;
}
while ( F_62 ( & V_58 -> V_59 , V_23 , F_48 ) )
F_63 ( V_23 , 1 ) ;
}
F_64 ( & V_6 -> V_61 ) ;
V_6 -> V_7 . V_71 = V_72 ;
