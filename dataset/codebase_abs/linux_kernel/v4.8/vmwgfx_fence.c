...
struct V_85 * V_86 = F_74 ( V_83 ) -> V_86 ;
int V_26 ;
T_3 V_102 = ( ( T_3 ) V_101 -> V_103 * V_104 ) ;
...
V_83 = V_121 -> V_83 ;
F_4 ( & V_98 -> V_122 , V_8 ) ;
if ( F_15 ( V_119 -> V_123 != NULL ) ) {
struct V_124 V_125 ;
F_94 ( & V_125 ) ;
* V_119 -> V_123 = V_125 . V_123 ;
* V_119 -> V_126 = V_125 . V_126 ;
}
F_95 ( V_98 , V_119 -> V_121 ) ;
V_119 -> V_121 = NULL ;
F_6 ( & V_98 -> V_122 , V_8 ) ;
}
...
struct V_57 * V_119 ;
struct V_1 * V_7 = F_1 ( V_3 ) ;
V_119 = F_37 ( sizeof( * V_119 ) , V_50 ) ;
if ( F_38 ( V_119 == NULL ) )
return - V_77 ;
V_119 -> V_121 = V_121 ;
V_119 -> V_43 . V_65 = F_93 ;
V_119 -> V_43 . V_49 = F_96 ;
V_119 -> V_43 . type = V_128 ;
V_119 -> V_3 = F_76 ( V_3 ) ;
V_119 -> V_98 = V_7 -> V_13 -> V_98 ;
V_119 -> V_123 = V_123 ;
V_119 -> V_126 = V_126 ;
F_97 ( V_3 , & V_119 -> V_43 ) ;
return 0 ;
}
static int F_100 ( struct V_82 * V_83 ,
struct V_2 * V_3 ,
T_2 V_34 ,
T_3 V_129 ,
bool V_75 )
...
int V_26 ;
V_121 = F_37 ( sizeof( * V_121 ) , V_50 ) ;
if ( F_38 ( V_121 == NULL ) ) {
F_101 ( L_6 ) ;
V_26 = - V_77 ;
goto V_131;
}
V_121 -> V_121 . V_4 . type = V_132 ;
V_121 -> V_121 . V_4 . V_133 = sizeof( * V_121 ) ;
V_121 -> V_121 . V_129 = V_129 ;
V_26 = F_102 ( V_98 , V_83 , & V_121 -> V_4 , & V_121 -> V_121 . V_4 ) ;
if ( F_38 ( V_26 != 0 ) ) {
F_101 ( L_7 ) ;
F_47 ( V_121 ) ;
goto V_131;
...
(struct V_136 * ) V_99 ;
struct V_2 * V_3 = NULL ;
struct F_74 * V_137 = F_74 ( V_83 ) ;
struct V_138 T_4 * V_139 =
(struct V_138 T_4 * ) ( unsigned long )
V_101 -> V_140 ;
T_2 V_108 ;
int V_26 ;
if ( V_101 -> V_108 ) {
