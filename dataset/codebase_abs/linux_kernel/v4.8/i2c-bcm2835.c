...
if ( F_23 ( V_2 -> V_67 ) ) {
if ( F_24 ( V_2 -> V_67 ) != - V_68 )
F_12 ( & V_58 -> V_44 , L_3 ) ;
return F_24 ( V_2 -> V_67 ) ;
}
V_54 = F_26 ( V_58 -> V_44 . V_69 , L_4 ,
& V_62 ) ;
if ( V_54 < 0 ) {
F_27 ( & V_58 -> V_44 ,
L_5 ) ;
...
F_1 ( V_2 , V_73 , V_63 ) ;
V_61 = F_21 ( V_58 , V_74 , 0 ) ;
if ( ! V_61 ) {
F_12 ( & V_58 -> V_44 , L_7 ) ;
return - V_72 ;
}
V_2 -> V_61 = V_61 -> V_75 ;
V_54 = F_30 ( V_2 -> V_61 , F_7 , V_76 ,
F_31 ( & V_58 -> V_44 ) , V_2 ) ;
if ( V_54 ) {
F_12 ( & V_58 -> V_44 , L_8 ) ;
return - V_72 ;
...
V_50 -> V_78 = V_79 ;
V_50 -> V_80 = V_81 ;
F_33 ( V_50 -> V_82 , L_9 , sizeof( V_50 -> V_82 ) ) ;
V_50 -> V_83 = & V_84 ;
V_50 -> V_44 . V_85 = & V_58 -> V_44 ;
V_50 -> V_44 . V_69 = V_58 -> V_44 . V_69 ;
V_50 -> V_86 = & V_87 ;
F_1 ( V_2 , V_30 , 0 ) ;
V_54 = F_34 ( V_50 ) ;
if ( V_54 )
