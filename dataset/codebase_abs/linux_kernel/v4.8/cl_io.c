...
F_75 ( & V_103 -> V_144 ) ;
F_76 () ;
F_12 ( F_9 ( & V_103 -> V_145 ) ) ;
F_71 ( & V_103 -> V_145 , & V_140 -> V_123 ) ;
++ V_140 -> V_112 ;
F_77 ( & V_103 -> V_146 , & V_103 -> V_147 , L_3 , V_140 ) ;
F_78 ( V_103 ) ;
}
void F_79 ( const struct V_8 * V_9 , struct V_114 * V_140 ,
struct V_102 * V_103 )
{
F_12 ( V_140 -> V_112 > 0 ) ;
F_8 ( V_140 -> V_141 == V_142 ) ;
...
F_76 () ;
-- V_140 -> V_112 ;
F_81 ( & V_103 -> V_146 , & V_103 -> V_147 , L_3 , V_140 ) ;
F_82 ( V_9 , V_103 ) ;
}
void F_83 ( struct V_114 * V_148 , struct V_114 * V_149 ,
struct V_102 * V_103 )
{
F_12 ( V_149 -> V_112 > 0 ) ;
F_8 ( V_148 -> V_141 == V_142 ) ;
F_8 ( V_149 -> V_141 == V_142 ) ;
F_27 ( & V_103 -> V_145 , & V_148 -> V_123 ) ;
-- V_149 -> V_112 ;
++ V_148 -> V_112 ;
F_84 ( & V_103 -> V_146 , & V_103 -> V_147 , L_3 ,
V_149 , V_148 ) ;
}
void F_85 ( struct V_114 * V_148 , struct V_114 * V_149 ,
struct V_102 * V_103 )
{
F_12 ( V_149 -> V_112 > 0 ) ;
F_8 ( V_148 -> V_141 == V_142 ) ;
F_8 ( V_149 -> V_141 == V_142 ) ;
F_37 ( & V_103 -> V_145 , & V_148 -> V_123 ) ;
-- V_149 -> V_112 ;
++ V_148 -> V_112 ;
F_84 ( & V_103 -> V_146 , & V_103 -> V_147 , L_3 ,
V_149 , V_148 ) ;
}
void F_86 ( struct V_114 * V_150 , struct V_114 * V_151 )
{
struct V_102 * V_103 ;
struct V_102 * V_152 ;
F_8 ( V_150 -> V_141 == V_142 ) ;
F_8 ( V_151 -> V_141 == V_142 ) ;
F_87 (page, tmp, list)
F_83 ( V_151 , V_150 , V_103 ) ;
}
...
-- V_140 -> V_112 ;
F_88 ( V_9 , V_5 , V_103 ) ;
F_81 ( & V_103 -> V_146 , & V_103 -> V_147 , L_3 ,
V_140 ) ;
F_82 ( V_9 , V_103 ) ;
}
}
void F_89 ( const struct V_8 * V_9 , struct V_114 * V_140 )
{
struct V_102 * V_103 ;
struct V_102 * V_68 ;
F_8 ( V_140 -> V_141 == V_142 ) ;
F_87 (page, temp, plist)
F_79 ( V_9 , V_140 , V_103 ) ;
F_12 ( V_140 -> V_112 == 0 ) ;
}
...
static void F_91 ( const struct V_8 * V_9 , struct V_4 * V_5 ,
struct V_114 * V_140 )
{
struct V_102 * V_103 ;
F_8 ( V_140 -> V_141 == V_142 ) ;
...
void F_93 ( const struct V_8 * V_9 ,
struct V_4 * V_5 , struct V_107 * V_108 )
{
F_60 ( V_9 , V_5 , & V_108 -> V_111 ) ;
F_60 ( V_9 , V_5 , & V_108 -> V_122 ) ;
}
void F_94 ( const struct V_8 * V_9 ,
struct V_4 * V_5 , struct V_107 * V_108 )
{
F_91 ( V_9 , V_5 , & V_108 -> V_111 ) ;
F_91 ( V_9 , V_5 , & V_108 -> V_122 ) ;
}
void F_61 ( const struct V_8 * V_9 , struct V_107 * V_108 )
{
F_89 ( V_9 , & V_108 -> V_122 ) ;
F_89 ( V_9 , & V_108 -> V_111 ) ;
}
void F_95 ( struct V_107 * V_108 , struct V_102 * V_103 )
{
F_58 ( V_108 ) ;
...
void F_97 ( struct V_153 * V_154 , struct V_155 * V_18 ,
struct V_156 * V_157 ,
const struct V_158 * V_136 )
{
F_71 ( & V_18 -> V_159 , & V_154 -> V_160 ) ;
V_18 -> V_161 = V_157 ;
V_18 -> V_162 = V_136 ;
V_18 -> V_163 = V_154 ;
}
static void F_98 ( const struct V_8 * V_9 , struct V_153 * V_154 )
{
unsigned V_164 ;
F_12 ( F_9 ( & V_154 -> V_165 ) ) ;
F_12 ( V_154 -> V_166 == 0 ) ;
F_8 ( F_9 ( & V_154 -> V_160 ) ) ;
F_8 ( F_99 ( V_154 -> V_167 > 0 , V_154 -> V_168 ) ) ;
if ( V_154 -> V_168 ) {
for ( V_164 = 0 ; V_164 < V_154 -> V_167 ; ++ V_164 ) {
struct V_37 * V_38 = V_154 -> V_168 [ V_164 ] . V_169 ;
if ( V_38 ) {
F_100 ( & V_38 -> V_52 ,
& V_154 -> V_168 [ V_164 ] . V_170 ,
L_4 , V_154 ) ;
F_101 ( V_9 , V_38 ) ;
}
}
...
static int F_102 ( const struct V_8 * V_9 , struct V_153 * V_154 ,
struct V_102 * V_103 )
{
struct V_156 * V_157 ;
struct V_100 * V_18 ;
...
V_157 = F_103 ( V_18 -> V_171 -> V_52 . V_105 ) ;
if ( V_157 -> V_172 -> V_173 ) {
V_40 = V_157 -> V_172 -> V_173 ( V_9 , V_157 , V_154 ) ;
if ( V_40 != 0 )
break;
}
}
...
void F_104 ( const struct V_8 * V_9 , struct V_153 * V_154 , int V_129 )
{
struct V_155 * V_18 ;
while ( ! F_9 ( & V_154 -> V_160 ) ) {
V_18 = F_105 ( V_154 -> V_160 . V_22 ,
struct V_155 , V_159 ) ;
F_11 ( & V_18 -> V_159 ) ;
if ( V_18 -> V_162 -> V_174 )
V_18 -> V_162 -> V_174 ( V_9 , V_18 , V_129 ) ;
}
F_98 ( V_9 , V_154 ) ;
}
struct V_153 * F_106 ( const struct V_8 * V_9 , struct V_102 * V_103 ,
enum V_119 V_120 , int V_175 )
{
struct V_153 * V_154 ;
F_8 ( V_175 > 0 ) ;
V_154 = F_51 ( sizeof( * V_154 ) , V_95 ) ;
if ( V_154 ) {
int V_40 ;
V_154 -> V_176 = V_120 ;
F_15 ( & V_154 -> V_165 ) ;
F_15 ( & V_154 -> V_160 ) ;
V_154 -> V_168 = F_107 ( V_175 , sizeof( V_154 -> V_168 [ 0 ] ) ,
V_95 ) ;
if ( V_154 -> V_168 ) {
V_154 -> V_167 = V_175 ;
V_40 = F_102 ( V_9 , V_154 , V_103 ) ;
} else {
V_40 = - V_96 ;
}
if ( V_40 != 0 ) {
F_104 ( V_9 , V_154 , V_40 ) ;
V_154 = F_108 ( V_40 ) ;
}
} else {
V_154 = F_108 ( - V_96 ) ;
...
void F_109 ( const struct V_8 * V_9 ,
struct V_153 * V_154 , struct V_102 * V_103 )
{
struct V_37 * V_38 ;
struct V_177 * V_178 ;
int V_164 ;
F_12 ( F_9 ( & V_103 -> V_179 ) ) ;
F_12 ( ! V_103 -> V_180 ) ;
F_110 ( V_181 , V_9 , V_103 , L_5 ,
V_154 , V_154 -> V_176 , V_154 -> V_166 ) ;
F_71 ( & V_103 -> V_179 , & V_154 -> V_165 ) ;
++ V_154 -> V_166 ;
V_103 -> V_180 = V_154 ;
V_38 = F_18 ( V_103 -> V_182 ) ;
for ( V_164 = 0 , V_178 = V_154 -> V_168 ; V_38 != V_178 -> V_169 ; ++ V_164 , ++ V_178 ) {
if ( ! V_178 -> V_169 ) {
V_178 -> V_169 = V_38 ;
F_111 ( V_38 ) ;
F_112 ( & V_38 -> V_52 , & V_178 -> V_170 ,
L_4 , V_154 ) ;
break;
}
}
F_12 ( V_164 < V_154 -> V_167 ) ;
}
void F_113 ( const struct V_8 * V_9 , struct V_102 * V_103 )
{
struct V_153 * V_154 = V_103 -> V_180 ;
F_12 ( ! F_9 ( & V_103 -> V_179 ) ) ;
F_12 ( V_154 -> V_166 > 0 ) ;
F_11 ( & V_103 -> V_179 ) ;
-- V_154 -> V_166 ;
...
int F_114 ( const struct V_8 * V_9 , struct V_153 * V_154 )
{
int V_164 ;
int V_40 ;
const struct V_155 * V_18 ;
for ( V_164 = 0 ; V_164 < V_154 -> V_167 ; ++ V_164 )
F_12 ( V_154 -> V_168 [ V_164 ] . V_169 ) ;
V_40 = 0 ;
F_32 (slice, &req->crq_layers, crs_linkage) {
if ( V_18 -> V_162 -> V_183 ) {
V_40 = V_18 -> V_162 -> V_183 ( V_9 , V_18 ) ;
if ( V_40 != 0 )
break;
}
}
...
void F_115 ( const struct V_8 * V_9 , struct V_153 * V_154 ,
struct V_184 * V_185 , T_4 V_186 )
{
const struct V_155 * V_18 ;
struct V_102 * V_103 ;
int V_164 ;
F_12 ( ! F_9 ( & V_154 -> V_165 ) ) ;
V_103 = F_105 ( V_154 -> V_165 . V_139 , struct V_102 , V_179 ) ;
for ( V_164 = 0 ; V_164 < V_154 -> V_167 ; ++ V_164 ) {
F_32 (slice, &req->crq_layers, crs_linkage) {
const struct V_100 * V_39 ;
const struct V_37 * V_38 ;
V_39 = F_55 ( V_103 ,
V_18 -> V_161 -> V_187 . V_106 ) ;
V_38 = V_39 -> V_171 ;
if ( V_18 -> V_162 -> V_188 )
V_18 -> V_162 -> V_188 ( V_9 , V_18 , V_38 ,
V_185 + V_164 , V_186 ) ;
}
}
}
...
void F_65 ( struct V_125 * V_126 , int V_191 ,
void (* F_118)( const struct V_8 * , struct V_125 * ) )
{
memset ( V_126 , 0 , sizeof( * V_126 ) ) ;
F_119 ( & V_126 -> V_189 ) ;
F_117 ( & V_126 -> V_192 , V_191 ) ;
F_117 ( & V_126 -> V_190 , V_191 > 0 ) ;
V_126 -> V_193 = 0 ;
V_126 -> V_194 = F_118 ;
F_12 ( F_118 ) ;
}
...
long V_124 )
{
struct V_195 V_196 = F_120 ( F_121 ( V_124 ) ,
NULL , NULL , NULL ) ;
int V_129 ;
F_12 ( V_124 >= 0 ) ;
V_129 = F_122 ( V_126 -> V_189 ,
F_123 ( & V_126 -> V_192 ) == 0 ,
& V_196 ) ;
if ( V_129 < 0 ) {
F_124 ( L_6 ,
V_129 , F_123 ( & V_126 -> V_192 ) ) ;
V_196 = (struct V_195 ) { 0 } ;
( void ) F_122 ( V_126 -> V_189 ,
F_123 ( & V_126 -> V_192 ) == 0 ,
& V_196 ) ;
} else {
V_129 = V_126 -> V_193 ;
}
F_12 ( F_123 ( & V_126 -> V_192 ) == 0 ) ;
while ( F_125 ( F_123 ( & V_126 -> V_190 ) != 0 ) ) {
F_126 () ;
}
return V_129 ;
}
...
int V_197 )
{
if ( V_126 -> V_193 == 0 && V_197 < 0 )
V_126 -> V_193 = V_197 ;
F_12 ( F_123 ( & V_126 -> V_192 ) > 0 ) ;
if ( F_127 ( & V_126 -> V_192 ) ) {
F_12 ( V_126 -> V_194 ) ;
V_126 -> V_194 ( V_9 , V_126 ) ;
}
}
