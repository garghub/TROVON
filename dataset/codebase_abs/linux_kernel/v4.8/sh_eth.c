...
static T_6 F_107 ( struct V_1 * V_2 , T_1 * V_278 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_37 * V_38 = V_6 -> V_38 ;
T_1 * V_279 ;
...
F_113 ( V_329 ) ;
F_113 ( V_330 ) ;
if ( V_6 -> V_8 [ V_331 ] != V_9 ) {
if ( V_278 ) {
unsigned int V_36 ;
F_110 ( V_331 ) ;
for ( V_36 = 0 ; V_36 < V_332 * 2 ; V_36 ++ )
* V_278 ++ = F_6 (
V_6 -> V_333 +
V_6 -> V_8 [ V_331 ] +
V_36 * 4 ) ;
...
static void F_115 ( struct V_1 * V_2 , struct V_334 * V_335 ,
void * V_278 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_335 -> V_336 = V_337 ;
F_116 ( & V_6 -> V_338 -> V_119 ) ;
F_107 ( V_2 , V_278 ) ;
F_117 ( & V_6 -> V_338 -> V_119 ) ;
}
...
static int F_122 ( struct V_1 * V_245 , int V_340 )
{
switch ( V_340 ) {
case V_341 :
return V_342 ;
...
static void F_124 ( struct V_1 * V_2 , T_1 V_345 , T_10 * V_3 )
{
switch ( V_345 ) {
case V_341 :
memcpy ( V_3 , * V_346 ,
...
V_348 -> V_349 = V_350 ;
V_348 -> V_351 = V_352 ;
V_348 -> V_353 = V_6 -> V_98 ;
V_348 -> V_354 = V_6 -> V_100 ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_54 ;
if ( V_348 -> V_354 > V_352 ||
V_348 -> V_353 > V_350 ||
V_348 -> V_354 < V_355 ||
V_348 -> V_353 < V_356 )
return - V_357 ;
if ( V_348 -> V_358 || V_348 -> V_359 )
return - V_357 ;
if ( F_127 ( V_2 ) ) {
F_128 ( V_2 ) ;
F_129 ( V_2 ) ;
...
V_6 -> V_98 = V_348 -> V_353 ;
V_6 -> V_100 = V_348 -> V_354 ;
if ( F_127 ( V_2 ) ) {
V_54 = F_51 ( V_2 ) ;
if ( V_54 < 0 ) {
F_27 ( V_2 , L_13 ,
...
static void
F_145 ( struct V_1 * V_2 , unsigned long * V_372 , int T_7 )
{
T_1 V_373 = F_5 ( V_2 , T_7 ) ;
if ( V_373 ) {
* V_372 += V_373 ;
F_1 ( V_2 , 0 , T_7 ) ;
}
}
static struct V_374 * F_59 ( struct V_1 * V_2 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( F_9 ( V_6 ) )
return & V_2 -> V_182 ;
if ( ! V_6 -> V_365 )
return & V_2 -> V_182 ;
F_145 ( V_2 , & V_2 -> V_182 . V_375 , V_291 ) ;
F_145 ( V_2 , & V_2 -> V_182 . V_376 , V_292 ) ;
F_145 ( V_2 , & V_2 -> V_182 . V_219 , V_293 ) ;
if ( F_8 ( V_6 ) ) {
...
static int F_149 ( struct V_1 * V_2 , struct V_377 * V_378 , int V_379 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_255 * V_256 = V_6 -> V_256 ;
if ( ! F_127 ( V_2 ) )
...
if ( ! V_256 )
return - V_275 ;
return F_150 ( V_256 , V_378 , V_379 ) ;
}
static void * F_151 ( struct V_5 * V_6 ,
int V_179 )
{
return F_152 ( V_6 , V_327 ) + ( V_179 / 8 * 4 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
void * V_8 = F_152 ( V_6 , V_331 ) ;
int V_36 ;
T_10 V_389 [ V_81 ] ;
for ( V_36 = 0 ; V_36 < V_332 ; V_36 ++ , V_8 += 8 ) {
F_161 ( V_8 , V_389 ) ;
if ( F_163 ( V_10 , V_389 ) )
return V_36 ;
}
...
int V_54 ;
struct V_87 * V_88 ;
struct V_412 * V_338 = V_6 -> V_338 ;
struct V_413 * V_119 = & V_6 -> V_338 -> V_119 ;
V_88 = F_182 ( V_119 , sizeof( struct V_87 ) , V_132 ) ;
if ( ! V_88 )
return - V_133 ;
V_88 -> V_10 = V_6 -> V_10 + V_6 -> V_8 [ V_285 ] ;
V_88 -> V_90 = V_411 -> V_414 ;
V_88 -> V_85 . V_415 = & V_416 ;
V_6 -> V_270 = F_183 ( & V_88 -> V_85 ) ;
if ( ! V_6 -> V_270 )
return - V_133 ;
V_6 -> V_270 -> V_362 = L_19 ;
V_6 -> V_270 -> V_263 = V_119 ;
snprintf ( V_6 -> V_270 -> V_271 , V_268 , L_20 ,
V_338 -> V_362 , V_338 -> V_271 ) ;
if ( V_119 -> V_264 ) {
V_54 = F_184 ( V_6 -> V_270 , V_119 -> V_264 ) ;
} else {
if ( V_411 -> V_417 > 0 )
V_6 -> V_270 -> V_244 [ V_411 -> V_418 ] = V_411 -> V_417 ;
V_54 = F_185 ( V_6 -> V_270 ) ;
}
if ( V_54 )
goto V_419;
return 0 ;
...
static const T_2 * F_186 ( int V_420 )
{
const T_2 * V_8 = NULL ;
switch ( V_420 ) {
case V_421 :
...
static struct V_410 * F_187 ( struct V_413 * V_119 )
{
struct V_261 * V_262 = V_119 -> V_264 ;
struct V_410 * V_429 ;
const char * V_430 ;
V_429 = F_182 ( V_119 , sizeof( * V_429 ) , V_132 ) ;
if ( ! V_429 )
return NULL ;
V_429 -> V_16 = F_188 ( V_262 ) ;
V_430 = F_189 ( V_262 ) ;
if ( V_430 )
...
static inline struct V_410 * F_187 ( struct V_413 * V_119 )
{
return NULL ;
}
static int F_191 ( struct V_412 * V_338 )
{
struct V_431 * V_432 ;
struct V_410 * V_411 = F_192 ( & V_338 -> V_119 ) ;
const struct V_433 * V_271 = F_193 ( V_338 ) ;
struct V_5 * V_6 ;
struct V_1 * V_2 ;
int V_54 , V_434 ;
V_432 = F_194 ( V_338 , V_435 , 0 ) ;
V_2 = F_195 ( sizeof( struct V_5 ) ) ;
if ( ! V_2 )
return - V_133 ;
F_196 ( & V_338 -> V_119 ) ;
F_116 ( & V_338 -> V_119 ) ;
...
goto V_436;
V_2 -> V_244 = V_54 ;
F_198 ( V_2 , & V_338 -> V_119 ) ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_100 = V_437 ;
V_6 -> V_98 = V_438 ;
V_6 -> V_10 = F_199 ( & V_338 -> V_119 , V_432 ) ;
if ( F_96 ( V_6 -> V_10 ) ) {
V_54 = F_97 ( V_6 -> V_10 ) ;
goto V_436;
}
...
F_200 ( & V_6 -> V_248 ) ;
V_6 -> V_338 = V_338 ;
if ( V_338 -> V_119 . V_264 )
V_411 = F_187 ( & V_338 -> V_119 ) ;
if ( ! V_411 ) {
F_201 ( & V_338 -> V_119 , L_23 ) ;
V_54 = - V_357 ;
goto V_436;
}
...
V_6 -> V_38 = (struct V_37 * ) F_202 ( & V_338 -> V_119 ) ;
V_6 -> V_8 = F_186 ( V_6 -> V_38 -> V_420 ) ;
if ( ! V_6 -> V_8 ) {
F_201 ( & V_338 -> V_119 , L_24 ,
V_6 -> V_38 -> V_420 ) ;
V_54 = - V_357 ;
goto V_436;
}
...
if ( V_6 -> V_38 -> V_303 ) {
struct V_431 * V_450 ;
V_450 = F_194 ( V_338 , V_435 , 1 ) ;
V_6 -> V_333 = F_199 ( & V_338 -> V_119 , V_450 ) ;
if ( F_96 ( V_6 -> V_333 ) ) {
V_54 = F_97 ( V_6 -> V_333 ) ;
goto V_436;
}
...
if ( V_6 -> V_38 -> V_135 )
F_1 ( V_2 , 0x1 , V_136 ) ;
V_54 = F_181 ( V_6 , V_411 ) ;
if ( V_54 ) {
F_201 ( & V_2 -> V_119 , L_26 ) ;
goto V_436;
}
F_206 ( V_2 , & V_6 -> V_252 , F_85 , 64 ) ;
V_54 = F_207 ( V_2 ) ;
if ( V_54 )
goto V_455;
F_208 ( V_2 , L_27 ,
...
static int F_214 ( struct V_412 * V_338 )
{
struct V_1 * V_2 = F_215 ( V_338 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_216 ( V_2 ) ;
F_211 ( & V_6 -> V_252 ) ;
F_178 ( V_6 ) ;
...
static int F_217 ( struct V_413 * V_119 )
{
struct V_1 * V_2 = F_218 ( V_119 ) ;
int V_54 = 0 ;
if ( F_127 ( V_2 ) ) {
F_128 ( V_2 ) ;
V_54 = F_146 ( V_2 ) ;
...
static int F_220 ( struct V_413 * V_119 )
{
return 0 ;
}
