...
F_8 ( V_267 & 0x3f , V_4 , V_289 ) ;
F_8 ( V_267 >> 6 , V_4 , V_290 ) ;
F_122 ( V_4 , V_232 ) ;
F_8 ( V_246 , V_4 , V_218 ) ;
F_49 ( & V_8 -> V_93 , V_91 ) ;
}
...
{
F_148 ( V_8 -> V_55 , V_295 ) ;
}
static int F_149 ( struct V_127 * V_8 )
{
return F_150 ( V_8 -> V_55 , V_295 , L_25 )
!= NULL ? 0 : - V_112 ;
}
...
static int F_152 ( struct V_127 * V_8 , struct V_297 * V_298 )
{
int V_125 = 0 ;
...
static void
F_156 ( struct V_303 * V_304 , const char * V_305 , unsigned int V_105 )
{
...
F_160 ( & V_4 -> V_8 , V_305 , V_105 , F_155 ) ;
while ( F_5 ( V_4 , V_18 ) & V_173 )
F_89 () ;
if ( ! V_4 -> V_167 -> V_312 )
F_8 ( V_246 , V_4 , V_218 ) ;
...
static int T_10 F_164 ( struct V_303 * V_304 , char * V_316 )
{
struct V_3 * V_4 ;
int V_266 = 38400 ;
int V_313 = 8 ;
...
F_163 ( V_4 , & V_266 , & V_30 , & V_313 ) ;
}
return F_167 ( & V_4 -> V_8 , V_304 , V_266 , V_30 , V_313 , V_317 ) ;
}
static void F_168 ( struct V_127 * V_8 , int V_183 )
{
while ( F_169 ( V_8 -> V_9 + V_321 ) & V_126 )
F_89 () ;
if ( V_8 -> V_10 == V_11 )
F_170 ( V_183 , V_8 -> V_9 + V_322 ) ;
else
F_171 ( V_183 , V_8 -> V_9 + V_322 ) ;
while ( F_169 ( V_8 -> V_9 + V_321 ) & V_173 )
F_89 () ;
}
static void F_172 ( struct V_303 * V_323 , const char * V_305 , unsigned V_324 )
{
struct V_325 * V_2 = V_323 -> V_89 ;
F_160 ( & V_2 -> V_8 , V_305 , V_324 , F_168 ) ;
}
static int T_10 F_173 ( struct V_325 * V_46 ,
const char * V_326 )
{
if ( ! V_46 -> V_8 . V_9 )
return - V_319 ;
V_46 -> V_323 -> V_327 = F_172 ;
return 0 ;
}
static int F_174 ( int V_307 , struct V_46 * V_2 )
{
struct V_328 * V_329 ;
static bool V_330 = false ;
static bool V_331 = false ;
int V_125 = V_307 ;
if ( ! F_175 ( V_332 ) )
return V_125 ;
V_329 = V_2 -> V_87 ;
if ( ! V_329 )
return V_125 ;
V_125 = F_176 ( V_329 , L_26 ) ;
if ( V_125 < 0 ) {
V_331 = true ;
V_125 = V_307 ;
} else {
V_330 = true ;
if ( V_125 >= F_177 ( V_306 ) || V_306 [ V_125 ] != NULL ) {
F_67 ( V_2 , L_27 , V_125 ) ;
V_125 = V_307 ;
}
}
...
int V_242 ;
bool V_333 = false ;
for ( V_242 = 0 ; V_242 < F_177 ( V_306 ) ; V_242 ++ ) {
if ( V_306 [ V_242 ] == V_4 )
V_306 [ V_242 ] = NULL ;
else if ( V_306 [ V_242 ] )
V_333 = true ;
...
static int F_181 ( struct V_46 * V_2 , struct V_3 * V_4 ,
struct V_335 * V_336 , int V_307 )
{
void T_1 * V_337 ;
V_337 = F_182 ( V_2 , V_336 ) ;
if ( F_29 ( V_337 ) )
return F_30 ( V_337 ) ;
V_307 = F_174 ( V_307 , V_2 ) ;
V_4 -> V_246 = 0 ;
V_4 -> V_8 . V_2 = V_2 ;
V_4 -> V_8 . V_55 = V_336 -> V_338 ;
V_4 -> V_8 . V_9 = V_337 ;
V_4 -> V_8 . V_61 = V_4 -> V_61 ;
V_4 -> V_8 . V_91 = V_339 ;
V_4 -> V_8 . line = V_307 ;
...
V_125 = F_185 ( & V_334 , & V_4 -> V_8 ) ;
if ( V_125 )
F_178 ( V_4 ) ;
return V_125 ;
}
static int F_186 ( struct V_1 * V_2 , const struct V_340 * V_341 )
{
struct V_3 * V_4 ;
struct V_342 * V_167 = V_341 -> V_89 ;
int V_343 , V_125 ;
V_343 = F_180 () ;
if ( V_343 < 0 )
return V_343 ;
V_4 = F_187 ( & V_2 -> V_2 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_49 ;
V_4 -> V_238 = F_188 ( & V_2 -> V_2 , NULL ) ;
if ( F_29 ( V_4 -> V_238 ) )
return F_30 ( V_4 -> V_238 ) ;
V_4 -> V_6 = V_167 -> V_6 ;
V_4 -> V_167 = V_167 ;
V_4 -> V_61 = V_167 -> V_344 ( V_2 ) ;
V_4 -> V_8 . V_10 = V_167 -> V_345 ? V_11 : V_346 ;
V_4 -> V_8 . V_195 = V_2 -> V_195 [ 0 ] ;
V_4 -> V_8 . V_252 = & V_347 ;
snprintf ( V_4 -> type , sizeof( V_4 -> type ) , L_30 , F_2 ( V_2 ) ) ;
V_125 = F_181 ( & V_2 -> V_2 , V_4 , & V_2 -> V_348 , V_343 ) ;
if ( V_125 )
return V_125 ;
F_189 ( V_2 , V_4 ) ;
return F_183 ( V_4 ) ;
...
{
struct V_3 * V_4 = F_191 ( V_2 ) ;
F_192 ( & V_334 , & V_4 -> V_8 ) ;
F_178 ( V_4 ) ;
return 0 ;
}
static int F_193 ( struct V_46 * V_2 )
{
struct V_3 * V_4 = F_194 ( V_2 ) ;
if ( ! V_4 )
return - V_300 ;
return F_195 ( & V_334 , & V_4 -> V_8 ) ;
}
...
if ( ! V_4 )
return - V_300 ;
return F_197 ( & V_334 , & V_4 -> V_8 ) ;
}
static int F_198 ( struct V_349 * V_350 )
{
struct V_3 * V_4 ;
struct V_335 * V_351 ;
int V_343 , V_125 ;
int V_352 ;
if ( V_350 -> V_2 . V_87 ) {
struct V_328 * V_329 = V_350 -> V_2 . V_87 ;
V_125 = F_42 ( V_329 , L_31 , & V_352 ) ;
if ( V_125 )
return V_125 ;
} else {
V_352 = 115200 ;
...
if ( V_343 < 0 )
return V_343 ;
V_4 = F_187 ( & V_350 -> V_2 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_49 ;
V_125 = F_199 ( V_350 , 0 ) ;
...
V_4 -> V_167 = & V_353 ;
V_4 -> V_61 = 32 ;
V_4 -> V_8 . V_10 = V_353 . V_345 ? V_11 : V_346 ;
V_4 -> V_8 . V_252 = & V_354 ;
V_4 -> V_291 = V_352 ;
snprintf ( V_4 -> type , sizeof( V_4 -> type ) , L_33 ) ;
V_351 = F_200 ( V_350 , V_355 , 0 ) ;
V_125 = F_181 ( & V_350 -> V_2 , V_4 , V_351 , V_343 ) ;
if ( V_125 )
return V_125 ;
F_201 ( V_350 , V_4 ) ;
return F_183 ( V_4 ) ;
}
static int F_202 ( struct V_349 * V_350 )
{
struct V_3 * V_4 = F_203 ( V_350 ) ;
F_192 ( & V_334 , & V_4 -> V_8 ) ;
F_178 ( V_4 ) ;
return 0 ;
}
static int T_10 F_204 ( void )
{
F_205 ( V_356 L_34 ) ;
if ( F_206 ( & V_357 ) )
F_207 ( L_35 ) ;
