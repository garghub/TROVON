...
static void F_167 ( struct V_263 * V_264 )
{
...
F_170 ( & V_24 -> V_44 ) ;
F_171 ( & V_267 -> V_269 ) ;
F_172 ( & V_24 -> V_20 , & V_267 -> F_172 ) ;
F_151 ( & V_24 -> F_151 ,
& V_267 -> F_151 ) ;
F_173 ( & V_24 -> V_270 ) ;
V_267 -> V_105 -- ;
F_174 ( & V_267 -> V_269 ) ;
F_175 ( & V_24 -> V_264 , F_167 ) ;
}
...
static int F_176 ( struct V_150 * V_2 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_1 * V_40 ;
struct V_23 * V_24 ;
...
static int F_178 ( struct V_272 * V_272 , struct V_150 * V_2 ,
int V_273 , int V_274 )
{
struct V_266 * V_267 = F_179 ( V_272 , V_275 ) ;
struct V_2 * V_3 ;
struct V_23 * V_24 ;
switch ( V_2 -> type ) {
case V_175 :
...
static T_7 int F_185 ( struct V_272 * V_272 )
{
struct V_266 * V_267 = F_179 ( V_272 , V_275 ) ;
F_186 ( & V_267 -> V_281 ) ;
F_187 ( & V_267 -> V_269 ) ;
...
static T_8 void F_188 ( struct V_272 * V_272 )
{
struct V_266 * V_267 = F_179 ( V_272 , V_275 ) ;
