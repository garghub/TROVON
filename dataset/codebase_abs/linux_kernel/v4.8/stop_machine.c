...
static int F_29 ( int V_38 , struct V_7 * V_39 ,
int V_40 , struct V_7 * V_41 )
{
struct V_5 * V_42 = F_30 ( & V_5 , V_38 ) ;
struct V_5 * V_43 = F_30 ( & V_5 , V_40 ) ;
int V_30 ;
F_31 ( & V_44 , V_38 , V_40 ) ;
F_32 ( & V_42 -> V_15 ) ;
F_33 ( & V_43 -> V_15 , V_45 ) ;
...
static bool F_41 ( const struct V_48 * V_48 ,
T_1 V_16 , void * V_17 ,
struct V_1 * V_2 )
{
struct V_7 * V_8 ;
...
static int F_45 ( const struct V_48 * V_48 ,
T_1 V_16 , void * V_17 )
{
struct V_1 V_2 ;
F_1 ( & V_2 , F_46 ( V_48 ) ) ;
if ( ! F_41 ( V_48 , V_16 , V_17 , & V_2 ) )
return - V_18 ;
F_15 ( & V_2 . V_4 ) ;
return V_2 . V_19 ;
}
int F_47 ( const struct V_48 * V_48 , T_1 V_16 , void * V_17 )
{
int V_19 ;
F_48 ( & V_51 ) ;
V_19 = F_45 ( V_48 , V_16 , V_17 ) ;
F_49 ( & V_51 ) ;
return V_19 ;
}
int F_50 ( const struct V_48 * V_48 , T_1 V_16 , void * V_17 )
{
int V_19 ;
if ( ! F_51 ( & V_51 ) )
return - V_52 ;
...
static int F_76 ( T_1 V_16 , void * V_27 , const struct V_48 * V_57 )
{
struct V_20 V_21 = {
. V_16 = V_16 ,
. V_27 = V_27 ,
...
F_16 ( & V_21 , V_36 ) ;
return F_47 ( V_33 , F_19 , & V_21 ) ;
}
int F_80 ( T_1 V_16 , void * V_27 , const struct V_48 * V_57 )
{
int V_19 ;
F_81 () ;
V_19 = F_76 ( V_16 , V_27 , V_57 ) ;
F_82 () ;
return V_19 ;
}
