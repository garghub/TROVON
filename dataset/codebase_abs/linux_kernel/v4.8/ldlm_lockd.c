...
L_39 , V_145 . V_150 ) ;
V_148 = F_89 ( V_152 , & V_145 , L_40 , V_145 . V_151 ) ;
if ( F_90 ( V_148 ) ) {
F_26 ( L_41 ,
...
char * V_167 )
{
return sprintf ( V_167 , L_43 , V_168 ) ;
}
...
if ( V_20 )
goto V_29;
V_177 = F_113 ( L_45 , NULL , V_174 ) ;
if ( ! V_177 ) {
V_20 = - V_35 ;
goto V_29;
}
V_178 = F_113 ( L_46 , NULL , V_174 ) ;
if ( ! V_178 ) {
V_20 = - V_35 ;
goto V_29;
}
...
V_66 -> V_217 = F_120 ( int , V_203 ,
F_121 ( int , V_199 ,
V_205 ) ) ;
V_66 -> V_158 = V_66 -> V_217 ;
}
