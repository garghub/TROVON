...
static void F_51 ( struct V_1 * V_2 , unsigned int V_28 ,
unsigned int V_161 )
{
struct V_61 * V_61 = V_2 -> V_62 ;
switch ( V_28 ) {
...
static struct V_1 * F_54 ( int V_164 )
{
struct V_1 * V_2 ;
if ( V_165 [ V_164 ] . V_145 != 0 ) {
...
static void F_58 ( struct V_1 * V_2 , int V_173 )
{
F_56 ( V_2 ) ;
F_3 ( V_173 , V_2 -> V_5 + V_8 ) ;
}
static void T_3 F_59 ( struct V_174 * V_175 , const char * V_176 ,
unsigned V_177 )
{
struct V_178 * V_79 = V_175 -> V_16 ;
F_60 ( & V_79 -> V_2 , V_176 , V_177 , F_58 ) ;
}
static int T_3 F_61 ( struct V_178 * V_179 ,
const char * V_180 )
{
if ( ! V_179 -> V_2 . V_5 )
return - V_181 ;
V_179 -> V_175 -> V_182 = F_59 ;
return 0 ;
}
static void F_62 ( struct V_174 * V_183 , const char * V_176 ,
unsigned int V_184 )
{
struct V_1 * V_2 = & V_165 [ V_183 -> V_185 ] ;
unsigned long V_42 ;
...
V_72 = F_63 ( & V_2 -> V_43 , V_42 ) ;
else
F_13 ( & V_2 -> V_43 , V_42 ) ;
V_186 = F_2 ( V_2 -> V_5 + V_135 ) ;
F_3 ( V_186 , V_2 -> V_5 + V_32 ) ;
V_187 = F_2 ( V_2 -> V_5 + V_81 ) ;
V_187 &= ~ V_82 ;
V_187 |= V_90 ;
F_3 ( V_187 , V_2 -> V_5 + V_81 ) ;
F_60 ( V_2 , V_176 , V_184 , F_58 ) ;
F_56 ( V_2 ) ;
F_3 ( V_187 , V_2 -> V_5 + V_81 ) ;
F_3 ( V_186 , V_2 -> V_5 + V_93 ) ;
if ( V_72 )
F_14 ( & V_2 -> V_43 , V_42 ) ;
}
static int T_3 F_64 ( struct V_174 * V_183 , char * V_190 )
{
struct V_1 * V_2 = & V_165 [ V_183 -> V_185 ] ;
int V_47 = 9600 ;
int V_191 = 8 ;
int V_22 = 'n' ;
int V_192 = 'n' ;
if ( V_183 -> V_185 < 0 || V_183 -> V_185 >= V_166 )
return - V_140 ;
if ( ! V_2 -> V_5 ) {
F_65 ( L_4 V_193 L_5 ,
V_183 -> V_185 ) ;
...
if ( V_190 )
F_66 ( V_190 , & V_47 , & V_22 , & V_191 , & V_192 ) ;
return F_67 ( V_2 , V_183 , V_47 , V_22 , V_191 , V_192 ) ;
}
...
static int F_70 ( struct V_179 * V_179 )
{
struct V_1 * V_2 = F_71 ( V_179 ) ;
struct V_195 * V_196 ;
struct V_179 * V_197 ;
int V_198 = 0 ;
V_196 = F_72 ( & V_2 -> V_28 -> V_2 ) ;
if ( V_196 ) {
V_197 = V_196 -> V_79 ;
V_198 = F_73 ( V_197 ) ;
F_74 ( V_196 ) ;
...
static int F_76 ( struct V_179 * V_179 )
{
struct V_1 * V_2 = F_71 ( V_179 ) ;
unsigned long V_42 = 0 ;
T_1 V_71 ;
...
return F_77 ( & V_199 , V_2 ) ;
}
static int F_78 ( struct V_201 * V_202 )
{
int V_203 , V_164 , V_40 ;
struct V_1 * V_2 ;
struct V_204 * V_205 ;
struct V_61 * V_206 ;
V_206 = F_79 ( & V_202 -> V_79 , sizeof( * V_206 ) ,
V_207 ) ;
if ( ! V_206 )
return - V_147 ;
V_206 -> V_163 = F_80 ( & V_202 -> V_79 , L_6 ) ;
if ( F_81 ( V_206 -> V_163 ) ) {
V_206 -> V_163 = F_80 ( & V_202 -> V_79 , L_7 ) ;
if ( ! F_81 ( V_206 -> V_163 ) )
F_35 ( & V_202 -> V_79 , L_8 ) ;
}
if ( F_81 ( V_206 -> V_163 ) ) {
F_35 ( & V_202 -> V_79 , L_9 ) ;
return F_82 ( V_206 -> V_163 ) ;
}
V_206 -> V_63 = F_80 ( & V_202 -> V_79 , L_10 ) ;
if ( F_81 ( V_206 -> V_63 ) ) {
V_206 -> V_63 = F_80 ( & V_202 -> V_79 , L_11 ) ;
if ( ! F_81 ( V_206 -> V_63 ) )
F_35 ( & V_202 -> V_79 , L_12 ) ;
}
if ( F_81 ( V_206 -> V_63 ) ) {
F_35 ( & V_202 -> V_79 , L_13 ) ;
return F_82 ( V_206 -> V_63 ) ;
}
V_203 = F_83 ( V_206 -> V_163 ) ;
if ( V_203 ) {
F_35 ( & V_202 -> V_79 , L_14 ) ;
return V_203 ;
}
V_203 = F_83 ( V_206 -> V_63 ) ;
if ( V_203 ) {
F_35 ( & V_202 -> V_79 , L_15 ) ;
goto V_208;
}
V_205 = F_84 ( V_202 , V_209 , 0 ) ;
if ( ! V_205 ) {
V_203 = - V_181 ;
goto V_210;
}
...
if ( F_87 ( V_206 -> V_63 ,
& V_206 -> V_212 ) )
F_20 ( & V_202 -> V_79 , L_16 ) ;
#endif
V_164 = F_88 ( V_202 -> V_79 . V_214 , L_17 ) ;
if ( V_164 < 0 )
V_164 = 0 ;
V_2 = F_54 ( V_164 ) ;
if ( ! V_2 ) {
F_35 ( & V_202 -> V_79 , L_18 ) ;
V_203 = - V_181 ;
goto V_215;
}
V_2 -> V_145 = V_205 -> V_216 ;
V_2 -> V_40 = V_40 ;
V_2 -> V_79 = & V_202 -> V_79 ;
V_2 -> V_63 = F_89 ( V_206 -> V_63 ) ;
V_2 -> V_62 = V_206 ;
V_206 -> V_2 = V_2 ;
F_90 ( V_202 , V_2 ) ;
V_203 = F_91 ( & V_199 , V_2 ) ;
if ( V_203 ) {
F_35 ( & V_202 -> V_79 ,
L_19 , V_203 ) ;
goto V_215;
...
{
struct V_1 * V_2 = F_95 ( V_202 ) ;
struct V_61 * V_206 = V_2 -> V_62 ;
int V_203 ;
#ifdef F_86
F_92 ( V_206 -> V_63 ,
& V_206 -> V_212 ) ;
#endif
V_203 = F_96 ( & V_199 , V_2 ) ;
V_2 -> V_145 = 0 ;
F_93 ( V_206 -> V_63 ) ;
F_93 ( V_206 -> V_163 ) ;
return V_203 ;
