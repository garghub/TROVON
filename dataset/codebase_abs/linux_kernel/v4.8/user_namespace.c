...
bool F_75 ( const struct V_2 * V_107 )
{
struct V_2 * V_15 ;
for ( V_15 = F_76 () ; V_15 ; V_15 = V_15 -> V_31 ) {
if ( V_15 == V_107 )
return true ;
}
return false ;
}
static inline struct V_2 * F_77 ( struct V_108 * V_15 )
{
return F_78 ( V_15 , struct V_2 , V_15 ) ;
}
static struct V_108 * F_79 ( struct V_109 * V_110 )
{
struct V_2 * V_3 ;
F_80 () ;
V_3 = F_81 ( F_82 ( V_110 ) -> V_3 ) ;
F_83 () ;
return V_3 ? & V_3 -> V_15 : NULL ;
}
static void F_84 ( struct V_108 * V_15 )
{
F_85 ( F_77 ( V_15 ) ) ;
}
static int F_86 ( struct V_111 * V_111 , struct V_108 * V_15 )
{
struct V_2 * V_3 = F_77 ( V_15 ) ;
struct V_1 * V_1 ;
if ( V_3 == F_76 () )
return - V_91 ;
if ( ! F_87 ( V_112 ) )
