...
F_37 ( & V_2 -> V_5 , V_46 , F_12 ( V_11 ) ) ;
}
static struct V_10 * F_38 ( struct V_50 * V_50 ,
...
struct V_8 * V_27 = F_39 ( V_51 ) -> V_56 ;
if ( V_51 == V_52 )
V_46 = NULL ;
else
V_46 = V_51 -> V_57 ;
...
return V_64 ;
V_72:
V_64 = F_38 ( F_46 ( V_2 -> V_4 -> V_30 . V_22 ) ,
& V_2 -> V_5 , V_62 , V_46 ) ;
if ( V_64 )
V_64 -> V_19 |= V_20 ;
goto V_73;
...
void F_51 ( struct V_1 * V_2 , T_2 V_79 )
{
...
if ( V_84 > V_83 )
break;
if ( V_84 == V_83 && F_57 ( V_89 , V_85 ) )
break;
}
F_37 ( & V_2 -> V_6 , V_46 , F_12 ( V_11 ) ) ;
}
...
static void F_58 ( struct V_1 * V_2 , T_5 V_83 )
{
struct V_8 * V_46 , * V_29 ;
struct V_10 * V_47 ;
struct V_10 * V_11 ;
...
V_84 = V_47 -> V_86 ;
V_85 = V_47 -> V_89 ;
if ( V_84 == V_83 && V_85 == F_54 ( V_82 , V_84 ) ) {
F_55 ( V_82 , V_84 ) ;
F_22 ( V_46 , V_6 ) ;
F_11 ( & V_16 , V_46 ) ;
V_11 = F_5 ( V_46 ) ;
...
void F_59 ( struct V_1 * V_2 , T_5 V_83 , T_5 V_89 )
{
struct V_81 * V_82 ;
V_82 = & V_2 -> V_4 -> V_87 -> V_82 ;
if ( F_57 ( V_89 , F_54 ( V_82 , V_83 ) ) )
return;
F_60 ( V_82 , V_83 , V_89 ) ;
F_58 ( V_2 , V_83 ) ;
}
...
{
return F_61 ( V_2 , & V_2 -> V_6 , V_91 ) ;
}
static T_5 F_65 ( struct V_1 * V_2 , T_5 V_91 )
{
return F_61 ( V_2 , & V_2 -> V_5 , V_91 ) ;
}
...
if ( V_9 != NULL ) {
V_49 = F_5 ( V_9 ) -> V_48 ;
if ( ! F_49 ( V_49 , F_48 ( & V_4 -> V_77 . V_78 ) ) )
return;
}
