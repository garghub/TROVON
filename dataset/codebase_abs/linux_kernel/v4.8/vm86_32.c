...
static void F_57 ( struct V_1 * V_2 , int V_65 ,
...
goto V_108;
if ( V_65 == 0x21 && F_55 ( F_58 ( V_2 ) , & V_11 -> V_83 ) )
goto V_108;
V_105 = ( unsigned long T_1 * ) ( V_65 << 2 ) ;
if ( F_59 ( V_106 , V_105 ) )
goto V_108;
if ( ( V_106 >> 16 ) == V_107 )
goto V_108;
...
{
int V_65 ;
for ( V_65 = V_146 ; V_65 <= V_147 ; V_65 ++ )
if ( V_140 [ V_65 ] . V_7 == V_145 )
F_76 ( V_65 ) ;
}
