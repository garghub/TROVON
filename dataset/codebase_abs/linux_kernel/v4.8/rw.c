...
if ( V_108 > V_27 )
V_28 = V_108 ;
V_28 = V_6 ( V_28 , ( unsigned long ) ( ( V_99 - 1 ) >> V_109 ) ) ;
...
if ( V_96 != 0 )
F_7 ( F_12 ( V_22 ) , V_96 ) ;
if ( V_84 == V_28 + 1 && V_84 == ( V_99 >> V_109 ) )
F_11 ( V_22 , V_117 ) ;
F_24 ( V_59 , L_15 ,
V_84 , V_28 , V_4 -> V_79 ) ;
if ( V_84 != V_28 + 1 ) {
...
if ( F_40 ( V_34 -> V_110 , V_34 -> V_111 ,
V_34 -> V_112 , V_34 -> V_110 ,
V_125 ) <= V_8 -> V_127 )
V_34 -> V_104 = V_125 ;
F_55 ( V_34 ) ;
}
