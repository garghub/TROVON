...
static int F_160 ( struct V_158 * V_13 )
{
int V_285 ;
if ( V_286 > V_287 )
V_286 = V_287 ;
...
F_163 ( V_32 , V_297 , 0 , V_74 ) ;
V_32 -> V_301 . V_302 = F_45 ( F_59 ( V_303 ) |
F_164 ( 0 ) ) ;
V_32 -> V_81 = F_45 ( F_165 ( V_304 ) |
F_166 ( F_6 ( V_12 -> V_15 ) ) |
F_167 ( ! F_6 ( V_12 -> V_15 ) ) ) ;
V_32 -> V_134 = F_45 ( F_168 ( V_134 >> 5 ) ) ;
V_32 -> V_305 = F_45 ( F_169 ( V_298 >> 5 ) ) ;
V_32 -> V_306 = F_45 ( F_52 ( V_297 - sizeof( V_32 -> V_301 ) , 16 ) ) ;
V_300 -> V_307 = F_45 ( F_165 ( V_308 ) ) ;
V_300 -> V_3 = F_45 ( V_134 ) ;
}
static struct V_1 *
F_170 ( struct V_158 * V_13 ,
struct V_309 * V_310 ,
unsigned int V_25 , unsigned int V_311 ,
unsigned int V_74 )
{
unsigned int V_298 = ( V_25 << V_312 ) + V_310 -> V_313 ;
unsigned int V_134 = V_311 << V_312 ;
unsigned int V_297 = F_171 ( sizeof( struct V_296 ) +
sizeof( struct V_299 ) + V_134 , 16 ) ;
struct V_1 * V_2 = F_48 ( V_297 , 0 , V_98 ) ;
if ( ! V_2 ) {
F_88 ( L_53 ,
V_314 , V_310 -> V_257 -> V_267 , V_25 , V_311 ) ;
return NULL ;
}
F_162 ( V_13 , (struct V_296 * ) V_2 -> V_33 , V_297 , V_134 ,
V_298 , V_74 ) ;
return V_2 ;
}
static int F_172 ( struct V_309 * V_310 , struct V_7 * V_8 ,
struct V_315 * V_316 ,
unsigned int V_25 , unsigned int V_311 ,
struct V_317 * * V_318 ,
unsigned int * V_319 )
{
struct V_158 * V_13 = V_8 -> V_13 ;
struct V_1 * V_2 = F_170 ( V_13 , V_310 , V_25 , V_311 ,
V_8 -> V_74 ) ;
struct V_296 * V_32 ;
struct V_299 * V_300 ;
struct V_320 * V_321 ;
...
V_321 = (struct V_320 * ) ( V_300 + 1 ) ;
for ( V_322 = 0 ; V_322 < V_311 ; V_322 ++ , V_321 ++ )
F_173 ( V_321 , V_316 , V_318 , V_319 ) ;
F_129 ( V_2 , V_323 ) ;
F_129 ( V_2 , V_324 ) ;
F_27 ( V_2 , V_75 , V_8 -> V_46 ) ;
F_92 ( & V_8 -> V_168 ) ;
...
static int F_174 ( struct V_309 * V_310 , struct V_7 * V_8 ,
struct V_315 * V_316 )
{
unsigned int V_325 = V_316 -> V_25 ;
unsigned int V_311 = V_316 -> V_311 ;
unsigned int V_322 , V_105 ;
int V_218 = 0 ;
struct V_317 * V_326 = V_316 -> V_327 ;
unsigned int V_328 = 0 ;
V_316 -> V_329 = V_8 -> V_46 ;
for ( V_322 = 0 ; V_322 < V_311 ; V_322 += V_105 , V_325 += V_105 ) {
V_105 = V_311 - V_322 ;
if ( V_105 > V_330 )
V_105 = V_330 ;
V_218 = F_172 ( V_310 , V_8 , V_316 , V_325 , V_105 ,
& V_326 , & V_328 ) ;
if ( V_218 < 0 )
break;
}
...
static struct V_309 * F_180 ( struct V_158 * V_13 )
{
return (struct V_309 * ) ( * ( (struct V_11 * )
( F_5 ( V_13 ) ) ) -> V_345 ) ;
}
static int F_181 ( struct V_158 * V_13 )
{
struct V_11 * V_12 = F_5 ( V_13 ) ;
struct V_256 * V_257 = V_13 -> V_45 [ 0 ] ;
struct V_346 V_347 ;
unsigned int V_348 ;
int V_322 ;
if ( ! V_12 -> V_349 -> V_350 . V_190 ) {
F_182 ( L_56 , V_257 -> V_267 ) ;
return - V_351 ;
}
V_13 -> V_57 |= V_352 ;
V_348 = V_12 -> V_349 -> V_350 . V_190 >> V_312 ;
memset ( & V_347 , 0 , sizeof( struct V_346 ) ) ;
for ( V_322 = 0 ; V_322 < 4 ; V_322 ++ )
V_347 . V_353 [ V_322 ] = ( V_12 -> V_354 >> ( V_322 << 3 ) )
& 0xF ;
...
for ( V_322 = 0 ; V_322 < V_12 -> V_275 ; V_322 ++ )
F_23 ( 1 << V_365 ,
L_59 ,
V_13 , V_322 , V_12 -> V_276 [ V_322 ] ) ;
...
V_13 -> V_370 = V_371 ;
V_13 -> V_372 = V_373 ;
V_13 -> V_374 = sizeof( struct V_223 ) ;
V_13 -> V_375 = & V_376 ;
...
V_285 = F_189 ( V_13 , V_379 , V_380 ,
& V_381 , V_382 ) ;
if ( V_285 )
goto V_378;
for ( V_322 = 0 ; V_322 < V_13 -> V_364 ; V_322 ++ ) {
V_363 = F_157 ( V_12 -> V_45 [ V_322 ] ) ;
V_13 -> V_383 [ V_322 ] -> V_46 = V_363 -> V_46 ;
}
return V_13 ;
V_378:
F_190 ( V_13 ) ;
