...
T_1 V_118 , V_119 , V_120 , V_121 , V_122 , V_123 ;
T_1 V_153 = V_147 -> V_154 [ 0 ] ;
T_1 V_155 = ( T_1 ) V_152 -> V_156 + V_148 * V_153 ;
F_20 ( L_31 ,
V_1 + 1 , V_148 , V_149 , V_153 , ( T_1 ) V_152 -> V_156 ) ;
F_20 ( L_32 ,
V_155 , V_147 -> V_37 , V_147 -> V_39 , V_150 ,
F_76 ( V_147 -> V_5 ) ) ;
V_118 = F_40 ( V_1 ) ;
V_119 = F_41 ( V_1 ) ;
V_120 = F_42 ( V_1 ) ;
...
F_13 ( V_155 , V_10 + V_119 ) ;
F_13 ( ( V_149 << 16 ) | V_153 , V_10 + V_120 ) ;
F_13 ( V_153 , V_10 + V_121 ) ;
F_13 ( V_149 * V_153 , V_10 + V_122 ) ;
...
F_20 ( L_33 ,
V_1 + 1 , V_161 , V_162 ) ;
F_13 ( V_160 , V_10 + F_47 ( V_1 ) ) ;
F_13 ( ( V_157 - 1 ) << 16 | ( V_149 - 1 ) , V_10 + F_48 ( V_1 ) ) ;
F_13 ( V_161 << 16 | V_162 , V_10 + F_49 ( V_1 ) ) ;
...
static void F_81 ( T_1 V_150 , T_2 V_168 , T_2 * V_169 ,
T_2 * V_170 , T_2 * V_171 )
{
bool V_172 = F_80 ( V_150 ) ;
if ( V_172 && V_168 < 255 )
* V_169 = V_173 ;
else if ( V_172 )
* V_169 = V_174 ;
...
T_1 V_178 , T_1 y0 ,
T_1 V_159 , T_1 V_149 , T_1 V_150 )
{
T_2 V_126 = 0 ;
T_2 V_168 = 255 ;
T_1 V_179 = V_178 + V_159 - 1 ;
T_1 y1 = y0 + V_149 - 1 ;
T_1 V_12 ;
T_2 V_170 ;
T_2 V_171 ;
T_2 V_169 ;
F_81 ( V_150 , V_168 , & V_169 , & V_170 ,
& V_171 ) ;
F_13 ( V_178 << 16 | y0 , V_10 + F_51 ( V_126 ) ) ;
F_13 ( V_179 << 16 | y1 , V_10 + F_52 ( V_126 ) ) ;
V_12 = ( V_1 + 1 ) << V_180 | F_11 ( V_181 ) |
V_170 << V_182 |
V_171 << V_183 |
V_168 << V_184 |
V_169 << V_185 ;
...
{
T_2 V_126 = 0 ;
F_6 ( V_10 + F_53 ( V_126 ) , V_181 ,
F_8 ( 1 ) , 0 ) ;
F_6 ( V_10 + V_23 , F_83 ( V_126 ) ,
V_186 , 0 ) ;
}
static void F_86 ( struct V_187 * V_188 ,
struct V_146 * V_147 , int V_189 ,
int V_190 , unsigned int V_191 ,
unsigned int V_192 , T_1 V_193 ,
T_1 V_194 , T_1 V_195 , T_1 V_196 )
{
struct V_16 * V_17 = V_188 -> V_17 ;
void T_3 * V_10 = V_17 -> V_10 ;
...
T_1 V_149 ;
F_20 ( L_34 ,
V_1 + 1 , V_193 , V_194 , V_195 , V_196 ,
V_189 , V_190 , V_191 , V_192 ) ;
V_159 = V_195 ;
V_149 = V_196 ;
F_74 ( V_10 , V_147 , V_1 , V_194 , V_149 , V_150 ) ;
F_78 ( V_10 , V_1 , V_147 -> V_37 , V_193 , V_159 , V_149 ) ;
F_82 ( V_10 , V_1 , V_189 , V_190 , V_159 , V_149 , V_150 ) ;
}
...
if ( V_150 == V_9 )
return - V_143 ;
V_199 = F_91 ( V_130 -> V_130 , V_96 ) ;
if ( F_92 ( V_199 ) )
return F_93 ( V_199 ) ;
if ( V_195 != V_191 || V_196 != V_192 ) {
F_3 ( L_36 ) ;
return - V_143 ;
}
if ( V_193 + V_195 > V_147 -> V_37 ||
V_194 + V_196 > V_147 -> V_39 )
return - V_143 ;
if ( V_189 < 0 || V_190 < 0 )
return - V_143 ;
if ( V_189 + V_191 > V_199 -> V_131 . V_38 ||
V_190 + V_192 > V_199 -> V_131 . V_40 )
return - V_143 ;
return 0 ;
}
...
struct V_197 * V_133 )
{
struct V_197 * V_130 = V_138 -> V_130 ;
struct V_187 * V_188 = F_95 ( V_138 ) ;
F_86 ( V_188 , V_130 -> V_147 , V_130 -> V_189 , V_130 -> V_190 ,
V_130 -> V_191 , V_130 -> V_192 ,
V_130 -> V_193 >> 16 , V_130 -> V_194 >> 16 ,
V_130 -> V_195 >> 16 , V_130 -> V_196 >> 16 ) ;
}
static void F_96 ( struct V_137 * V_138 ,
struct V_197 * V_133 )
{
struct V_187 * V_188 = F_95 ( V_138 ) ;
F_87 ( V_188 ) ;
}
static int F_97 ( struct V_90 * V_91 , struct V_187 * V_188 ,
enum V_200 type )
{
const T_1 * V_201 ;
T_1 V_202 ;
int V_33 = 0 ;
V_202 = F_1 ( V_188 -> V_1 , & V_201 ) ;
if ( V_33 )
return V_33 ;
V_33 = F_98 ( V_91 , & V_188 -> V_10 , 1 , & V_203 ,
V_201 , V_202 , type , NULL ) ;
if ( V_33 ) {
F_3 ( L_37 , V_188 -> V_1 ) ;
return V_33 ;
}
F_99 ( & V_188 -> V_10 , & V_204 ) ;
return 0 ;
}
static int F_100 ( struct V_205 * V_206 , struct V_16 * V_17 )
{
struct V_207 * V_208 ;
struct V_209 * V_91 = & V_206 -> V_91 ;
struct V_139 * V_210 = V_206 -> V_91 . V_141 ;
V_208 = F_101 ( V_206 , V_211 , 0 ) ;
V_17 -> V_10 = F_102 ( V_91 , V_208 ) ;
if ( F_92 ( V_17 -> V_10 ) ) {
F_3 ( L_38 ) ;
return F_93 ( V_17 -> V_10 ) ;
}
V_17 -> V_73 = F_103 ( V_91 , NULL ) ;
if ( F_92 ( V_17 -> V_73 ) )
return F_93 ( V_17 -> V_73 ) ;
V_17 -> V_82 =
F_104 ( V_210 , L_39 ) ;
if ( F_92 ( V_17 -> V_82 ) ) {
F_3 ( L_40 ) ;
return F_93 ( V_17 -> V_82 ) ;
}
V_17 -> V_99 = F_105 ( V_206 , 0 ) ;
if ( V_17 -> V_99 < 0 ) {
F_3 ( L_41 ) ;
return - V_212 ;
}
V_17 -> V_74 = F_106 ( V_91 , L_42 ) ;
if ( F_92 ( V_17 -> V_74 ) ) {
F_3 ( L_43 ) ;
return F_93 ( V_17 -> V_74 ) ;
}
V_17 -> V_72 = F_106 ( V_91 , L_44 ) ;
if ( F_92 ( V_17 -> V_72 ) ) {
F_3 ( L_45 ) ;
return F_93 ( V_17 -> V_72 ) ;
}
V_17 -> V_34 = F_106 ( V_91 , L_46 ) ;
if ( F_92 ( V_17 -> V_34 ) ) {
F_3 ( L_47 ) ;
return F_93 ( V_17 -> V_34 ) ;
}
return 0 ;
}
...
int V_33 ;
int V_6 ;
V_215 = F_108 ( V_91 -> V_91 , sizeof( * V_215 ) , V_216 ) ;
if ( ! V_215 ) {
F_3 ( L_48 ) ;
return - V_217 ;
}
...
V_36 -> V_17 = V_17 ;
V_36 -> V_107 = V_218 ;
V_33 = F_100 ( V_206 , V_17 ) ;
if ( V_33 )
return V_33 ;
for ( V_6 = 0 ; V_6 < V_128 ; V_6 ++ ) {
V_188 = & V_215 -> V_188 [ V_6 ] ;
V_188 -> V_1 = V_6 ;
V_188 -> V_17 = V_17 ;
type = V_6 == V_219 ? V_220 :
V_221 ;
V_33 = F_97 ( V_91 , V_188 , type ) ;
if ( V_33 )
return V_33 ;
}
V_33 = F_68 ( V_91 , & V_36 -> V_10 , & V_215 -> V_188 [ V_219 ] . V_10 ) ;
if ( V_33 )
return V_33 ;
V_33 = F_110 ( V_91 -> V_91 , V_17 -> V_99 , F_35 ,
...
static void F_111 ( struct V_90 * V_91 )
{
struct V_205 * V_206 = V_91 -> V_213 ;
struct V_214 * V_215 = F_112 ( V_206 ) ;
