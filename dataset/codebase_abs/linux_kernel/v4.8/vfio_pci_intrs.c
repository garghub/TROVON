...
struct V_30 * V_7 ;
int V_14 , V_15 ;
if ( V_44 < 0 || V_44 >= V_4 -> V_24 )
return - V_19 ;
V_14 = V_37 ? V_4 -> V_37 [ V_44 ] . V_44 : V_9 -> V_14 + V_44 ;
if ( V_4 -> V_6 [ V_44 ] . V_7 ) {
...
if ( V_27 < 0 )
return 0 ;
V_4 -> V_6 [ V_44 ] . V_31 = F_24 ( V_22 , L_2 ,
V_37 ? L_3 : L_4 , V_44 ,
F_25 ( V_9 ) ) ;
...
if ( V_50 >= V_4 -> V_24 || V_50 + V_51 > V_4 -> V_24 )
return - V_19 ;
...
unsigned V_51 , T_3 V_10 , void * V_55 )
{
if ( V_54 != V_62 || V_50 != 0 || V_51 > 1 )
return - V_19 ;
return F_53 ( & V_4 -> V_63 ,
V_51 , V_10 , V_55 ) ;
}
...
unsigned V_51 , T_3 V_10 , void * V_55 )
{
if ( V_54 != V_64 || V_50 != 0 || V_51 > 1 )
return - V_19 ;
return F_53 ( & V_4 -> V_65 ,
V_51 , V_10 , V_55 ) ;
}
