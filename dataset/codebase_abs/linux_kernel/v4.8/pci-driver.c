...
static void F_49 ( struct V_32 * V_32 )
{
F_50 ( V_32 ) ;
F_48 ( V_32 ) ;
F_51 ( V_58 , V_32 ) ;
...
static int F_56 ( struct V_4 * V_38 , T_4 V_60 )
{
struct V_32 * V_32 = F_34 ( V_38 ) ;
struct V_1 * V_2 = V_32 -> V_19 ;
if ( V_2 && V_2 -> V_61 ) {
...
static int F_59 ( struct V_4 * V_38 , T_4 V_60 )
{
struct V_32 * V_32 = F_34 ( V_38 ) ;
struct V_1 * V_2 = V_32 -> V_19 ;
if ( V_2 && V_2 -> V_65 ) {
...
static int F_62 ( struct V_4 * V_38 )
{
struct V_32 * V_32 = F_34 ( V_38 ) ;
struct V_1 * V_2 = V_32 -> V_19 ;
F_51 ( V_69 , V_32 ) ;
return V_2 && V_2 -> V_70 ?
V_2 -> V_70 ( V_32 ) : F_53 ( V_32 ) ;
}
static void F_63 ( struct V_32 * V_32 )
{
F_51 ( V_69 , V_32 ) ;
if ( ! F_64 ( V_32 ) )
F_65 ( V_32 , V_53 , false ) ;
}
static void F_66 ( struct V_32 * V_32 )
{
if ( ! F_64 ( V_32 ) )
F_67 ( V_32 ) ;
}
static bool F_68 ( struct V_32 * V_32 )
{
struct V_1 * V_2 = V_32 -> V_19 ;
bool V_71 = V_2 && ( V_2 -> V_61 || V_2 -> V_65 || V_2 -> V_70
|| V_2 -> V_68 ) ;
F_69 ( V_71 && V_2 -> V_19 . V_72 , L_5 ,
...
return F_71 ( F_34 ( V_38 ) ) ;
}
static void F_72 ( struct V_4 * V_38 )
{
F_73 ( F_34 ( V_38 ) ) ;
F_74 ( V_38 ) ;
}
...
F_57 ( V_2 -> V_72 -> V_90 , error ) ;
if ( error )
return error ;
}
if ( ! V_32 -> V_63 && ! F_64 ( V_32 ) )
F_78 ( V_32 ) ;
if ( V_32 -> V_7 == V_79 )
F_79 ( V_32 , V_80 , 0 ) ;
F_51 ( V_67 , V_32 ) ;
...
int F_97 ( struct V_1 * V_2 , struct V_100 * V_101 ,
const char * V_102 )
{
...
static int F_107 ( struct V_4 * V_38 , struct V_112 * V_113 )
{
struct V_32 * V_33 ;
if ( ! V_38 )
return - V_37 ;
V_33 = F_34 ( V_38 ) ;
if ( F_108 ( V_113 , L_9 , V_33 -> V_7 ) )
return - V_13 ;
if ( F_108 ( V_113 , L_10 , V_33 -> V_3 , V_33 -> V_4 ) )
return - V_13 ;
if ( F_108 ( V_113 , L_11 , V_33 -> V_34 ,
V_33 -> V_35 ) )
return - V_13 ;
if ( F_108 ( V_113 , L_12 , F_109 ( V_33 ) ) )
return - V_13 ;
if ( F_108 ( V_113 , L_13 ,
V_33 -> V_3 , V_33 -> V_4 ,
V_33 -> V_34 , V_33 -> V_35 ,
