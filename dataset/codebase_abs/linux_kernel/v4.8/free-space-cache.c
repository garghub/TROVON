...
{
struct V_91 * V_88 , * V_102 ;
int V_16 ;
F_111 (entry, next, bitmap_list, list) {
...
F_53 ( V_37 , V_3 , V_1 ) ;
if ( V_28 ) {
F_15 ( & V_37 -> V_54 -> V_149 ) ;
F_15 ( & V_28 -> V_32 ) ;
if ( ! V_16 && F_45 ( & V_28 -> V_150 ) )
V_28 -> V_33 = V_119 ;
else if ( V_16 )
V_28 -> V_33 = V_151 ;
F_17 ( & V_28 -> V_32 ) ;
F_17 ( & V_37 -> V_54 -> V_149 ) ;
V_57 -> V_1 = NULL ;
F_11 ( V_1 ) ;
}
return V_16 ;
}
static int F_137 ( struct V_2 * V_3 , struct V_1 * V_1 ,
struct V_93 * V_94 ,
struct V_27 * V_28 ,
struct V_64 * V_57 ,
struct V_36 * V_37 ,
...
if ( V_16 )
goto V_107;
F_141 ( & F_18 ( V_1 ) -> V_136 , 0 , F_59 ( V_1 ) - 1 ,
& V_148 ) ;
F_83 ( V_57 , V_37 -> V_44 ) ;
F_44 ( & V_94 -> V_156 ) ;
F_15 ( & V_94 -> V_99 ) ;
...
goto V_158;
F_94 ( V_57 ) ;
V_16 = F_142 ( V_3 , V_1 , V_57 -> V_69 , V_57 -> V_66 ,
0 , F_59 ( V_1 ) , & V_148 ) ;
if ( V_16 )
goto V_158;
if ( V_28 && ( V_28 -> V_29 & V_153 ) )
...
F_70 ( V_57 ) ;
F_134 ( & F_18 ( V_1 ) -> V_136 , 0 ,
F_59 ( V_1 ) - 1 , & V_148 , V_62 ) ;
V_57 -> V_124 = V_124 ;
V_57 -> V_104 = V_104 ;
V_16 = F_143 ( V_1 , 0 , ( T_1 ) - 1 ) ;
if ( V_16 )
goto V_107;
return 0 ;
V_107:
...
static inline unsigned long F_145 ( T_1 V_160 , T_2 V_161 ,
T_1 V_6 )
{
ASSERT ( V_6 >= V_160 ) ;
V_6 -= V_160 ;
return ( unsigned long ) ( F_146 ( V_6 , V_161 ) ) ;
}
static inline unsigned long F_147 ( T_1 V_85 , T_2 V_161 )
{
return ( unsigned long ) ( F_146 ( V_85 , V_161 ) ) ;
}
static inline T_1 F_148 ( struct V_93 * V_94 ,
T_1 V_6 )
{
T_1 V_160 ;
T_1 V_162 ;
V_162 = V_163 * V_94 -> V_161 ;
V_160 = V_6 - V_94 -> V_135 ;
V_160 = F_149 ( V_160 , V_162 ) ;
V_160 *= V_162 ;
V_160 += V_94 -> V_135 ;
return V_160 ;
}
static int F_150 ( struct V_164 * V_3 , T_1 V_6 ,
struct V_96 * V_130 , int V_86 )
{
struct V_96 * * V_165 = & V_3 -> V_96 ;
struct V_96 * V_166 = NULL ;
struct V_91 * V_167 ;
while ( * V_165 ) {
V_166 = * V_165 ;
V_167 = F_100 ( V_166 , struct V_91 , V_101 ) ;
if ( V_6 < V_167 -> V_6 ) {
V_165 = & ( * V_165 ) -> V_168 ;
...
F_152 ( V_130 , V_166 , V_165 ) ;
F_153 ( V_130 , V_3 ) ;
return 0 ;
}
static struct V_91 *
F_154 ( struct V_93 * V_94 ,
T_1 V_6 , int V_171 , int V_172 )
{
...
if ( V_88 -> V_6 + V_163 * V_94 -> V_161 > V_6 )
return V_88 ;
...
{
F_156 ( V_94 , V_167 ) ;
V_94 -> V_122 -= V_167 -> V_85 ;
}
static int F_103 ( struct V_93 * V_94 ,
struct V_91 * V_167 )
{
int V_16 = 0 ;
ASSERT ( V_167 -> V_85 || V_167 -> V_86 ) ;
V_16 = F_150 ( & V_94 -> V_100 , V_167 -> V_6 ,
& V_167 -> V_101 , ( V_167 -> V_86 != NULL ) ) ;
if ( V_16 )
return V_16 ;
V_94 -> V_122 += V_167 -> V_85 ;
V_94 -> V_173 ++ ;
...
{
struct V_27 * V_28 = V_94 -> V_174 ;
T_1 V_175 ;
T_1 V_176 ;
T_1 V_177 ;
T_1 V_75 = V_28 -> V_8 . V_6 ;
T_1 V_178 = V_163 * V_94 -> V_161 ;
T_1 V_179 = F_149 ( V_75 + V_178 - 1 , V_178 ) ;
V_179 = F_159 ( T_1 , V_179 , 1 ) ;
ASSERT ( V_94 -> V_109 <= V_179 ) ;
if ( V_75 < V_180 )
V_175 = V_181 ;
else
V_175 = V_181 * F_146 ( V_75 , V_180 ) ;
V_176 = ( V_94 -> V_109 + 1 ) * V_94 -> V_161 ;
if ( V_176 >= V_175 ) {
V_94 -> V_182 = 0 ;
return;
}
V_177 = V_175 - V_176 ;
V_177 = F_160 ( T_1 , V_177 , V_175 >> 1 ) ;
V_94 -> V_182 =
F_146 ( V_177 , sizeof( struct V_91 ) ) ;
}
...
V_135 = F_145 ( V_167 -> V_6 , V_94 -> V_161 , V_6 ) ;
V_183 = F_147 ( V_85 , V_94 -> V_161 ) ;
ASSERT ( V_135 + V_183 <= V_163 ) ;
F_162 ( V_167 -> V_86 , V_135 , V_183 ) ;
V_167 -> V_85 -= V_85 ;
}
static void F_163 ( struct V_93 * V_94 ,
struct V_91 * V_167 , T_1 V_6 ,
T_1 V_85 )
{
F_161 ( V_94 , V_167 , V_6 , V_85 ) ;
V_94 -> V_122 -= V_85 ;
}
...
V_76 = F_145 ( V_184 -> V_6 , V_94 -> V_161 ,
F_159 ( T_1 , * V_6 , V_184 -> V_6 ) ) ;
V_188 = F_147 ( * V_85 , V_94 -> V_161 ) ;
...
if ( V_186 ) {
* V_6 = ( T_1 ) ( V_76 * V_94 -> V_161 ) + V_184 -> V_6 ;
* V_85 = ( T_1 ) ( V_186 ) * V_94 -> V_161 ;
return 0 ;
}
* V_85 = ( T_1 ) ( V_187 ) * V_94 -> V_161 ;
V_184 -> V_191 = * V_85 ;
return - 1 ;
}
static struct V_91 *
...
if ( ! V_94 -> V_100 . V_96 )
goto V_107;
V_88 = F_154 ( V_94 , F_148 ( V_94 , * V_6 ) , 0 , 1 ) ;
if ( ! V_88 )
goto V_107;
...
static void F_170 ( struct V_93 * V_94 ,
struct V_91 * V_167 , T_1 V_6 )
{
V_167 -> V_6 = F_148 ( V_94 , V_6 ) ;
V_167 -> V_85 = 0 ;
F_171 ( & V_167 -> V_112 ) ;
F_103 ( V_94 , V_167 ) ;
V_94 -> V_109 ++ ;
...
static void F_172 ( struct V_93 * V_94 ,
struct V_91 * V_184 )
{
F_101 ( V_94 , V_184 ) ;
F_61 ( V_184 -> V_86 ) ;
...
static T_7 int F_173 ( struct V_93 * V_94 ,
struct V_91 * V_184 ,
T_1 * V_6 , T_1 * V_85 )
{
T_1 V_194 ;
...
int V_16 ;
V_98:
V_194 = V_184 -> V_6 + ( T_1 ) ( V_163 * V_94 -> V_161 ) - 1 ;
V_195 = * V_6 ;
V_196 = V_94 -> V_161 ;
...
static T_1 F_174 ( struct V_93 * V_94 ,
struct V_91 * V_167 , T_1 V_6 ,
T_1 V_85 )
{
T_1 V_199 = 0 ;
T_1 V_194 ;
V_194 = V_167 -> V_6 + ( T_1 ) ( V_163 * V_94 -> V_161 ) ;
V_199 = F_128 ( V_194 - V_6 , V_85 ) ;
F_164 ( V_94 , V_167 , V_6 , V_199 ) ;
V_167 -> V_191 = 0 ;
return V_199 ;
}
static bool F_175 ( struct V_93 * V_94 ,
struct V_91 * V_167 )
{
struct V_27 * V_28 = V_94 -> V_174 ;
bool V_200 = false ;
#ifdef F_176
if ( F_177 ( V_28 -> V_22 -> V_201 ,
V_28 ) )
V_200 = true ;
#endif
if ( ! V_200 && V_94 -> V_173 < V_94 -> V_182 ) {
if ( V_167 -> V_85 <= V_28 -> V_202 * 4 ) {
if ( V_94 -> V_173 * 2 <= V_94 -> V_182 )
return false ;
} else {
return false ;
}
}
if ( ( ( V_163 * V_94 -> V_161 ) >> 1 ) > V_28 -> V_8 . V_6 )
return false ;
return true ;
}
static int F_178 ( struct V_93 * V_94 ,
struct V_91 * V_167 )
{
struct V_91 * V_184 ;
...
V_85 = V_167 -> V_85 ;
V_6 = V_167 -> V_6 ;
if ( ! V_94 -> V_110 -> F_175 ( V_94 , V_167 ) )
return 0 ;
if ( V_94 -> V_110 == & V_205 )
V_28 = V_94 -> V_174 ;
V_98:
...
if ( V_88 -> V_6 == F_148 ( V_94 , V_6 ) ) {
V_204 = F_174 ( V_94 , V_88 ,
V_6 , V_85 ) ;
V_85 -= V_204 ;
V_6 += V_204 ;
}
...
V_206:
V_184 = F_154 ( V_94 , F_148 ( V_94 , V_6 ) ,
1 , 0 ) ;
if ( ! V_184 ) {
ASSERT ( V_203 == 0 ) ;
goto V_207;
}
V_204 = F_174 ( V_94 , V_184 , V_6 , V_85 ) ;
V_85 -= V_204 ;
V_6 += V_204 ;
V_203 = 0 ;
if ( ! V_85 ) {
...
unsigned long V_76 ;
unsigned long V_212 ;
const T_1 V_194 = V_167 -> V_6 + V_167 -> V_85 ;
const T_1 V_213 = F_148 ( V_94 , V_194 ) ;
T_1 V_85 ;
V_86 = F_154 ( V_94 , V_213 , 1 , 0 ) ;
if ( ! V_86 )
return false ;
V_76 = F_145 ( V_86 -> V_6 , V_94 -> V_161 , V_194 ) ;
V_212 = F_168 ( V_86 -> V_86 , V_163 , V_76 ) ;
if ( V_212 == V_76 )
return false ;
V_85 = ( V_212 - V_76 ) * V_94 -> V_161 ;
V_167 -> V_85 += V_85 ;
if ( V_208 )
...
unsigned long V_214 ;
T_1 V_85 ;
V_213 = F_148 ( V_94 , V_167 -> V_6 ) ;
if ( V_213 == V_167 -> V_6 ) {
if ( V_167 -> V_6 == 0 )
return false ;
V_213 = F_148 ( V_94 , V_167 -> V_6 - 1 ) ;
}
V_86 = F_154 ( V_94 , V_213 , 1 , 0 ) ;
if ( ! V_86 )
return false ;
V_76 = F_145 ( V_86 -> V_6 , V_94 -> V_161 , V_167 -> V_6 ) - 1 ;
V_212 = 0 ;
V_214 = ( unsigned long ) - 1 ;
F_182 (j, bitmap->bitmap, BITS_PER_BITMAP) {
if ( V_212 > V_76 )
break;
V_214 = V_212 ;
}
...
V_85 = ( V_76 + 1 ) * V_94 -> V_161 ;
else
V_85 = ( V_76 - V_214 ) * V_94 -> V_161 ;
V_167 -> V_6 -= V_85 ;
V_167 -> V_85 += V_85 ;
if ( V_208 )
F_163 ( V_94 , V_86 , V_167 -> V_6 , V_85 ) ;
else
F_161 ( V_94 , V_86 , V_167 -> V_6 , V_85 ) ;
if ( ! V_86 -> V_85 )
F_172 ( V_94 , V_86 ) ;
return true ;
}
static void F_183 ( struct V_93 * V_94 ,
struct V_91 * V_167 ,
bool V_208 )
{
ASSERT ( ! V_167 -> V_86 ) ;
ASSERT ( F_184 ( & V_167 -> V_101 ) ) ;
if ( V_94 -> V_109 > 0 ) {
bool V_215 ;
bool V_216 = false ;
V_215 = F_180 ( V_94 , V_167 , V_208 ) ;
if ( V_94 -> V_109 > 0 )
V_216 = F_181 ( V_94 , V_167 ,
V_208 ) ;
if ( V_215 || V_216 )
F_179 ( V_94 , V_167 , V_208 ) ;
}
}
int F_185 ( struct V_93 * V_94 ,
T_1 V_6 , T_1 V_85 )
{
struct V_91 * V_167 ;
int V_16 = 0 ;
V_167 = F_109 ( V_103 , V_62 ) ;
if ( ! V_167 )
return - V_52 ;
V_167 -> V_6 = V_6 ;
V_167 -> V_85 = V_85 ;
F_186 ( & V_167 -> V_101 ) ;
F_15 ( & V_94 -> V_99 ) ;
if ( F_179 ( V_94 , V_167 , true ) )
goto V_217;
V_16 = F_178 ( V_94 , V_167 ) ;
if ( V_16 < 0 ) {
goto V_107;
} else if ( V_16 ) {
V_16 = 0 ;
...
V_217:
F_183 ( V_94 , V_167 , true ) ;
V_16 = F_103 ( V_94 , V_167 ) ;
if ( V_16 )
F_102 ( V_103 , V_167 ) ;
V_107:
F_17 ( & V_94 -> V_99 ) ;
if ( V_16 ) {
F_187 ( V_218 L_12 , V_16 ) ;
ASSERT ( V_16 != - V_170 ) ;
}
return V_16 ;
}
int F_188 ( struct V_27 * V_28 ,
T_1 V_6 , T_1 V_85 )
{
struct V_93 * V_94 = V_28 -> V_114 ;
struct V_91 * V_167 ;
...
if ( ! V_85 )
goto V_220;
V_167 = F_154 ( V_94 , V_6 , 0 , 0 ) ;
if ( ! V_167 ) {
V_167 = F_154 ( V_94 , F_148 ( V_94 , V_6 ) ,
1 , 0 ) ;
if ( ! V_167 ) {
F_138 ( V_219 ) ;
goto V_220;
...
F_101 ( V_94 , V_167 ) ;
if ( V_6 == V_167 -> V_6 ) {
T_1 V_221 = F_128 ( V_85 , V_167 -> V_85 ) ;
V_167 -> V_85 -= V_221 ;
V_167 -> V_6 += V_221 ;
if ( V_167 -> V_85 ) {
V_16 = F_103 ( V_94 , V_167 ) ;
...
T_1 V_222 = V_167 -> V_85 + V_167 -> V_6 ;
V_167 -> V_85 = V_6 - V_167 -> V_6 ;
V_16 = F_103 ( V_94 , V_167 ) ;
F_138 ( V_16 ) ;
if ( V_16 )
goto V_220;
...
F_17 ( & V_94 -> V_99 ) ;
V_16 = F_189 ( V_28 , V_6 + V_85 ,
V_222 - ( V_6 + V_85 ) ) ;
F_138 ( V_16 ) ;
goto V_107;
}
}
V_16 = F_173 ( V_94 , V_167 , & V_6 , & V_85 ) ;
if ( V_16 == - V_198 ) {
V_219 = true ;
goto V_98;
}
...
int V_183 = 0 ;
for ( V_97 = F_98 ( & V_94 -> V_100 ) ; V_97 ; V_97 = F_99 ( V_97 ) ) {
V_167 = F_100 ( V_97 , struct V_91 , V_101 ) ;
if ( V_167 -> V_85 >= V_85 && ! V_28 -> V_223 )
V_183 ++ ;
F_191 ( V_28 -> V_22 ,
L_13 ,
V_167 -> V_6 , V_167 -> V_85 ,
( V_167 -> V_86 ) ? L_14 : L_15 ) ;
}
F_19 ( V_28 -> V_22 , L_16 ,
...
void F_192 ( struct V_27 * V_28 )
{
struct V_93 * V_94 = V_28 -> V_114 ;
F_193 ( & V_94 -> V_99 ) ;
V_94 -> V_161 = V_28 -> V_202 ;
V_94 -> V_135 = V_28 -> V_8 . V_17 ;
V_94 -> V_174 = V_28 ;
V_94 -> V_110 = & V_205 ;
F_171 ( & V_94 -> V_224 ) ;
F_194 ( & V_94 -> V_156 ) ;
V_94 -> V_182 = ( V_225 / 2 ) / sizeof( struct V_91 ) ;
}
static int
F_195 (
struct V_27 * V_28 ,
...
V_86 = ( V_88 -> V_86 != NULL ) ;
if ( ! V_86 ) {
F_179 ( V_94 , V_88 , false ) ;
F_183 ( V_94 , V_88 , false ) ;
}
F_150 ( & V_94 -> V_100 ,
...
struct V_91 * V_167 ;
struct V_96 * V_130 ;
while ( ( V_130 = F_197 ( & V_94 -> V_100 ) ) != NULL ) {
V_167 = F_100 ( V_130 , struct V_91 , V_101 ) ;
if ( ! V_167 -> V_86 ) {
F_101 ( V_94 , V_167 ) ;
F_102 ( V_103 , V_167 ) ;
} else {
...
struct V_125 * V_228 ;
F_15 ( & V_94 -> V_99 ) ;
while ( ( V_228 = V_28 -> V_133 . V_102 ) !=
& V_28 -> V_133 ) {
V_128 = F_117 ( V_228 , struct V_127 ,
V_134 ) ;
F_138 ( V_128 -> V_28 != V_28 ) ;
F_195 ( V_28 , V_128 ) ;
F_198 ( & V_94 -> V_99 ) ;
}
F_196 ( V_94 ) ;
...
T_1 F_200 ( struct V_27 * V_28 ,
T_1 V_6 , T_1 V_85 , T_1 V_229 ,
T_1 * V_191 )
{
struct V_93 * V_94 = V_28 -> V_114 ;
struct V_91 * V_88 = NULL ;
T_1 V_230 = V_85 + V_229 ;
T_1 V_16 = 0 ;
T_1 V_231 = 0 ;
T_1 V_232 = 0 ;
F_15 ( & V_94 -> V_99 ) ;
V_88 = F_169 ( V_94 , & V_6 , & V_230 ,
V_28 -> V_233 , V_191 ) ;
if ( ! V_88 )
goto V_107;
V_16 = V_6 ;
...
V_231 = V_88 -> V_6 ;
V_88 -> V_6 = V_6 + V_85 ;
F_138 ( V_88 -> V_85 < V_85 + V_232 ) ;
V_88 -> V_85 -= V_85 + V_232 ;
if ( ! V_88 -> V_85 )
F_102 ( V_103 , V_88 ) ;
else
F_103 ( V_94 , V_88 ) ;
...
V_94 = V_28 -> V_114 ;
F_15 ( & V_94 -> V_99 ) ;
V_16 = F_195 ( V_28 , V_128 ) ;
F_17 ( & V_94 -> V_99 ) ;
F_48 ( V_28 ) ;
return V_16 ;
}
static T_1 F_203 ( struct V_27 * V_28 ,
struct V_127 * V_128 ,
struct V_91 * V_88 ,
T_1 V_85 , T_1 V_234 ,
T_1 * V_191 )
...
struct V_93 * V_94 = V_28 -> V_114 ;
int V_235 ;
T_1 V_195 = V_128 -> V_226 ;
T_1 V_196 = V_85 ;
T_1 V_16 = 0 ;
V_195 = V_234 ;
V_196 = V_85 ;
V_235 = F_166 ( V_94 , V_88 , & V_195 , & V_196 , true ) ;
if ( V_235 ) {
if ( V_196 > * V_191 )
* V_191 = V_196 ;
return 0 ;
...
int V_16 ;
V_76 = F_145 ( V_88 -> V_6 , V_94 -> V_161 ,
F_159 ( T_1 , V_6 , V_88 -> V_6 ) ) ;
V_239 = F_147 ( V_85 , V_94 -> V_161 ) ;
V_240 = F_147 ( V_238 , V_94 -> V_161 ) ;
if ( V_88 -> V_191 &&
V_88 -> V_191 < V_237 )
return - V_50 ;
V_98:
...
if ( ! V_186 ) {
V_88 -> V_191 = ( T_1 ) V_187 * V_94 -> V_161 ;
return - V_50 ;
}
if ( ! V_241 ) {
V_135 = V_76 ;
...
V_241 += V_186 ;
if ( V_128 -> V_236 < V_186 * V_94 -> V_161 )
V_128 -> V_236 = V_186 * V_94 -> V_161 ;
if ( V_241 < V_239 || V_128 -> V_236 < V_237 ) {
V_76 = V_189 + 1 ;
goto V_98;
}
V_128 -> V_226 = V_135 * V_94 -> V_161 + V_88 -> V_6 ;
...
if ( ! V_88 )
return - V_50 ;
while ( V_88 -> V_86 || V_88 -> V_85 < V_238 ) {
...
if ( V_244 < V_85 || V_245 < V_237 )
return - V_50 ;
V_128 -> V_226 = V_242 -> V_6 ;
V_130 = & V_242 -> V_101 ;
do {
int V_16 ;
V_88 = F_100 ( V_130 , struct V_91 , V_101 ) ;
V_130 = F_99 ( & V_88 -> V_101 ) ;
if ( V_88 -> V_86 || V_88 -> V_85 < V_238 )
continue;
F_157 ( & V_88 -> V_101 , & V_94 -> V_100 ) ;
V_16 = F_150 ( & V_128 -> V_3 , V_88 -> V_6 ,
& V_88 -> V_101 , 0 ) ;
V_246 += V_88 -> V_85 ;
ASSERT ( ! V_16 ) ;
} while ( V_130 && V_88 != V_243 );
V_128 -> V_236 = V_245 ;
F_206 ( V_28 , V_128 , V_246 , 0 ) ;
return 0 ;
}
static T_7 int
...
struct V_91 * V_88 = NULL ;
int V_16 = - V_50 ;
T_1 V_213 = F_148 ( V_94 , V_6 ) ;
if ( V_94 -> V_109 == 0 )
return - V_50 ;
if ( ! F_45 ( V_104 ) )
V_88 = F_209 ( V_104 , struct V_91 , V_112 ) ;
if ( ! V_88 || V_88 -> V_6 != V_213 ) {
V_88 = F_154 ( V_94 , V_213 , 1 , 0 ) ;
if ( V_88 && F_45 ( & V_88 -> V_112 ) )
F_210 ( & V_88 -> V_112 , V_104 ) ;
}
F_118 (entry, bitmaps, list) {
if ( V_88 -> V_85 < V_85 )
continue;
V_16 = F_205 ( V_28 , V_88 , V_128 , V_6 ,
V_85 , V_237 , V_238 ) ;
if ( ! V_16 )
return 0 ;
}
...
T_1 V_237 ;
int V_16 ;
if ( F_212 ( V_3 -> V_22 , V_247 ) ) {
V_237 = V_238 = V_85 + V_229 ;
} else if ( V_28 -> V_29 & V_248 ) {
V_237 = V_85 ;
V_238 = V_28 -> V_202 ;
} else {
V_237 = F_127 ( V_85 , ( V_85 + V_229 ) >> 2 ) ;
V_238 = V_28 -> V_202 ;
}
F_15 ( & V_94 -> V_99 ) ;
if ( V_94 -> V_122 < V_85 ) {
...
F_213 ( V_28 , V_6 , V_85 , V_229 ,
V_238 ) ;
V_16 = F_207 ( V_28 , V_128 , & V_104 , V_6 ,
V_85 + V_229 ,
V_237 , V_238 ) ;
if ( V_16 )
V_16 = F_208 ( V_28 , V_128 , & V_104 ,
V_6 , V_85 + V_229 ,
V_237 , V_238 ) ;
...
static int F_216 ( struct V_27 * V_28 ,
T_1 * V_251 , T_1 V_135 , T_1 V_85 ,
T_1 V_252 , T_1 V_253 ,
struct V_131 * V_132 )
{
struct V_254 * V_255 = V_28 -> V_255 ;
...
F_17 ( & V_28 -> V_32 ) ;
F_17 ( & V_255 -> V_32 ) ;
V_16 = F_217 ( V_22 -> V_201 ,
V_135 , V_85 , & V_257 ) ;
if ( ! V_16 )
* V_251 += V_257 ;
F_44 ( & V_94 -> V_156 ) ;
F_189 ( V_28 , V_252 , V_253 ) ;
F_218 ( & V_132 -> V_112 ) ;
F_54 ( & V_94 -> V_156 ) ;
if ( V_256 ) {
F_15 ( & V_255 -> V_32 ) ;
...
static int F_219 ( struct V_27 * V_28 ,
T_1 * V_251 , T_1 V_135 , T_1 V_194 , T_1 V_260 )
{
struct V_93 * V_94 = V_28 -> V_114 ;
struct V_91 * V_88 ;
struct V_96 * V_130 ;
...
V_85 = F_128 ( V_141 + V_177 , V_194 ) - V_135 ;
if ( V_85 < V_260 ) {
F_17 ( & V_94 -> V_99 ) ;
F_54 ( & V_94 -> V_156 ) ;
goto V_102;
...
F_54 ( & V_94 -> V_156 ) ;
V_16 = F_216 ( V_28 , V_251 , V_135 , V_85 ,
V_141 , V_177 , & V_132 ) ;
if ( V_16 )
break;
V_102:
...
static int F_222 ( struct V_27 * V_28 ,
T_1 * V_251 , T_1 V_135 , T_1 V_194 , T_1 V_260 )
{
struct V_93 * V_94 = V_28 -> V_114 ;
struct V_91 * V_88 ;
...
V_85 = V_260 ;
V_263 = F_166 ( V_94 , V_88 , & V_135 , & V_85 , false ) ;
if ( V_263 || V_135 >= V_194 ) {
F_17 ( & V_94 -> V_99 ) ;
F_54 ( & V_94 -> V_156 ) ;
V_264 = true ;
goto V_102;
...
V_102:
if ( V_264 ) {
V_6 += V_163 * V_94 -> V_161 ;
} else {
V_135 += V_85 ;
if ( V_135 >= V_6 + V_163 * V_94 -> V_161 )
V_6 += V_163 * V_94 -> V_161 ;
}
if ( F_220 ( V_261 ) ) {
V_16 = - V_262 ;
...
void F_223 ( struct V_27 * V_265 )
{
F_202 ( & V_265 -> V_266 ) ;
}
void F_224 ( struct V_27 * V_28 )
{
struct V_267 * V_268 ;
struct V_269 * V_270 ;
bool V_271 ;
F_15 ( & V_28 -> V_32 ) ;
V_271 = ( F_225 ( & V_28 -> V_266 ) &&
V_28 -> V_272 ) ;
F_17 ( & V_28 -> V_32 ) ;
if ( V_271 ) {
F_226 ( V_28 -> V_22 -> V_273 ) ;
V_268 = & V_28 -> V_22 -> V_274 . V_275 ;
F_227 ( & V_268 -> V_32 ) ;
V_270 = F_228 ( V_268 , V_28 -> V_8 . V_17 ,
1 ) ;
F_229 ( ! V_270 ) ;
F_230 ( V_268 , V_270 ) ;
F_231 ( & V_268 -> V_32 ) ;
F_232 ( V_28 -> V_22 -> V_273 ) ;
F_233 ( V_270 ) ;
F_233 ( V_270 ) ;
F_112 ( V_28 -> V_114 ) ;
}
...
T_1 * V_257 , T_1 V_135 , T_1 V_194 , T_1 V_260 )
{
int V_16 ;
* V_257 = 0 ;
F_15 ( & V_28 -> V_32 ) ;
...
F_223 ( V_28 ) ;
F_17 ( & V_28 -> V_32 ) ;
V_16 = F_219 ( V_28 , V_257 , V_135 , V_194 , V_260 ) ;
if ( V_16 )
goto V_107;
V_16 = F_222 ( V_28 , V_257 , V_135 , V_194 , V_260 ) ;
V_107:
F_224 ( V_28 ) ;
return V_16 ;
}
...
int F_240 ( struct V_113 * V_22 , struct V_2 * V_3 )
{
struct V_93 * V_94 = V_3 -> V_277 ;
struct V_4 * V_5 ;
struct V_1 * V_1 ;
int V_16 = 0 ;
T_1 V_280 = F_241 ( & V_3 -> V_281 ) ;
if ( ! F_212 ( V_3 -> V_22 , V_282 ) )
return 0 ;
if ( F_238 ( V_22 ) )
return 0 ;
V_5 = F_43 () ;
...
V_16 = F_137 ( V_3 , V_1 , V_94 , NULL , & V_57 ,
V_37 , V_5 , 0 ) ;
if ( ! V_16 ) {
V_285 = false ;
...
int F_244 ( struct V_27 * V_265 ,
T_1 V_6 , T_1 V_85 , bool V_86 )
{
struct V_93 * V_94 = V_265 -> V_114 ;
struct V_91 * V_167 = NULL , * V_184 ;
void * V_286 = NULL ;
T_1 V_204 ;
int V_16 ;
V_98:
...
V_288 = V_6 ;
V_289 = V_94 -> V_161 ;
V_16 = F_166 ( V_94 , V_167 , & V_288 , & V_289 , false ) ;
if ( ! V_16 ) {
if ( V_288 == V_6 ) {
V_16 = 1 ;
goto V_107;
...
V_97 = F_155 ( & V_83 -> V_101 ) ;
continue;
}
V_167 = V_83 ;
goto V_287;
}
V_97 = F_99 ( & V_167 -> V_101 ) ;
while ( V_97 ) {
V_83 = F_100 ( V_97 , struct V_91 ,
V_101 ) ;
if ( V_6 + V_85 < V_83 -> V_6 )
...
if ( V_6 > V_167 -> V_6 && V_6 < V_167 -> V_6 + V_167 -> V_85 )
V_16 = 1 ;
V_107:
F_17 ( & V_94 -> V_99 ) ;
return V_16 ;
