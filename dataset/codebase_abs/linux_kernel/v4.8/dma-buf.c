...
F_35 ( ! V_4 ) ;
if ( V_4 -> V_11 -> V_101 )
V_58 = V_4 -> V_11 -> V_101 ( V_4 , V_57 ) ;
return V_58 ;
}
void * F_59 ( struct V_3 * V_4 , unsigned long V_102 )
{
F_35 ( ! V_4 ) ;
return V_4 -> V_11 -> V_79 ( V_4 , V_102 ) ;
}
...
{
F_35 ( ! V_4 ) ;
return V_4 -> V_11 -> V_80 ( V_4 , V_102 ) ;
}
void F_62 ( struct V_3 * V_4 , unsigned long V_102 ,
void * V_103 )
{
F_35 ( ! V_4 ) ;
if ( V_4 -> V_11 -> V_105 )
...
void F_67 ( struct V_3 * V_4 , void * V_103 )
{
if ( F_35 ( ! V_4 ) )
return;
F_3 ( ! V_4 -> V_112 ) ;
...
static int F_68 ( struct V_115 * V_116 , void * V_117 )
{
int V_58 ;
struct V_3 * V_118 ;
struct V_92 * V_119 ;
...
F_72 ( V_116 , L_5 ,
V_118 -> V_22 ,
V_118 -> V_2 -> V_122 , V_118 -> V_2 -> V_87 ,
F_73 ( V_118 -> V_2 ) ,
V_118 -> V_85 ) ;
F_70 ( V_116 , L_6 ) ;
V_121 = 0 ;
...
F_70 ( V_116 , L_7 ) ;
F_72 ( V_116 , L_8 , F_74 ( V_119 -> V_94 ) ) ;
V_121 ++ ;
}
F_72 ( V_116 , L_9 ,
V_121 ) ;
...
F_72 ( V_116 , L_10 , V_120 , V_22 ) ;
F_6 ( & V_13 . V_14 ) ;
return 0 ;
}
static int F_75 ( struct V_1 * V_1 , struct V_2 * V_2 )
{
return F_76 ( V_2 , F_68 , NULL ) ;
}
static int F_77 ( void )
{
struct V_123 * V_124 ;
int V_125 = 0 ;
V_124 = F_78 ( L_11 , NULL ) ;
if ( F_42 ( V_124 ) )
return F_43 ( V_124 ) ;
V_126 = V_124 ;
V_124 = F_79 ( L_12 , V_127 , V_126 ,
NULL , & V_128 ) ;
if ( F_42 ( V_124 ) ) {
F_80 ( L_13 ) ;
F_81 ( V_126 ) ;
