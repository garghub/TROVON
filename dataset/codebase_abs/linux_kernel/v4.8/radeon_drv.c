...
static int F_19 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_20 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
return F_21 ( V_22 , true , true , false ) ;
}
static int F_22 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_20 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
return F_23 ( V_22 , true , true ) ;
}
static int F_24 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_20 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
return F_21 ( V_22 , false , true , true ) ;
}
static int F_25 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_20 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
return F_23 ( V_22 , false , true ) ;
}
static int F_26 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_20 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
int V_16 ;
...
F_29 ( V_22 ) ;
F_30 ( V_2 , V_26 ) ;
V_16 = F_21 ( V_22 , false , false , false ) ;
F_31 ( V_2 ) ;
F_32 ( V_2 ) ;
F_33 ( V_2 ) ;
if ( F_4 () )
...
static int F_35 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_20 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
int V_16 ;
...
F_41 (crtc, &drm_dev->mode_config.crtc_list, head) {
if ( V_35 -> V_36 ) {
F_42 ( L_2 ) ;
return - V_23 ;
}
