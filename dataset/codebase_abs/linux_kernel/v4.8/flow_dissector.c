...
T_5 F_38 ( struct V_13 * V_14 )
{
struct V_142 V_152 ;
F_19 () ;
memset ( & V_152 , 0 , sizeof( V_152 ) ) ;
F_9 ( V_14 , & V_160 , & V_152 ,
NULL , 0 , 0 , 0 ,
V_72 ) ;
return F_33 ( & V_152 , V_138 ) ;
}
...
T_5 V_155 ;
F_19 () ;
V_155 = F_35 ( V_14 , & V_152 , V_138 ) ;
F_40 ( V_14 , V_155 , F_41 ( & V_152 ) ) ;
}
T_7 F_42 ( const struct V_13 * V_14 , T_5 V_161 )
{
struct V_142 V_152 ;
return F_35 ( V_14 , & V_152 , V_161 ) ;
}
T_7 F_43 ( struct V_13 * V_14 , const struct V_162 * V_163 )
{
struct V_142 V_152 ;
memset ( & V_152 , 0 , sizeof( V_152 ) ) ;
memcpy ( & V_152 . V_147 . V_70 . V_149 , & V_163 -> V_56 ,
sizeof( V_152 . V_147 . V_70 . V_149 ) ) ;
memcpy ( & V_152 . V_147 . V_70 . V_151 , & V_163 -> V_164 ,
sizeof( V_152 . V_147 . V_70 . V_151 ) ) ;
V_152 . V_148 . V_57 = V_69 ;
V_152 . V_20 . V_149 = V_163 -> V_165 ;
V_152 . V_20 . V_151 = V_163 -> V_166 ;
V_152 . V_103 . V_103 = V_163 -> V_167 ;
V_152 . V_168 . V_73 = ( V_150 T_5 ) V_163 -> V_169 ;
V_152 . V_159 . V_16 = V_163 -> V_170 ;
F_40 ( V_14 , F_34 ( & V_152 ) ,
F_41 ( & V_152 ) ) ;
return V_14 -> V_155 ;
}
T_7 F_44 ( struct V_13 * V_14 , const struct V_171 * V_172 )
{
struct V_142 V_152 ;
memset ( & V_152 , 0 , sizeof( V_152 ) ) ;
V_152 . V_147 . V_55 . V_149 = V_172 -> V_56 ;
V_152 . V_147 . V_55 . V_151 = V_172 -> V_164 ;
V_152 . V_148 . V_57 = V_54 ;
V_152 . V_20 . V_149 = V_172 -> V_173 ;
V_152 . V_20 . V_151 = V_172 -> V_174 ;
V_152 . V_103 . V_103 = V_172 -> V_175 ;
V_152 . V_159 . V_16 = V_172 -> V_176 ;
F_40 ( V_14 , F_34 ( & V_152 ) ,
F_41 ( & V_152 ) ) ;
return V_14 -> V_155 ;
}
T_5 F_45 ( const struct V_13 * V_14 , void * V_17 ,
...
const T_2 * V_178 ;
T_2 V_179 ;
V_178 = F_8 ( V_14 , V_19 + 12 , sizeof( V_179 ) ,
V_17 , V_18 , & V_179 ) ;
if ( ! V_178 )
return V_19 ;
V_19 += F_46 ( T_5 , sizeof( struct V_180 ) , ( * V_178 & 0xF0 ) >> 2 ) ;
break;
}
case V_181 :
case V_182 :
V_19 += sizeof( struct V_183 ) ;
break;
case V_184 :
V_19 += sizeof( struct V_185 ) ;
break;
case V_186 :
V_19 += sizeof( struct V_187 ) ;
break;
case V_188 :
V_19 += sizeof( struct V_189 ) ;
break;
case V_190 :
V_19 += sizeof( struct V_191 ) ;
break;
case V_192 :
V_19 += sizeof( struct V_193 ) ;
break;
}
return V_19 ;
}
T_5 F_47 ( const struct V_13 * V_14 )
{
struct V_142 V_152 ;
if ( ! F_36 ( V_14 , & V_152 , 0 ) )
return 0 ;
return F_45 ( V_14 , V_14 -> V_17 , & V_152 , F_7 ( V_14 ) ) ;
}
T_7 F_48 ( const struct V_162 * V_163 , struct V_142 * V_152 )
{
memset ( V_152 , 0 , sizeof( * V_152 ) ) ;
memcpy ( & V_152 -> V_147 . V_70 . V_149 , & V_163 -> V_56 ,
sizeof( V_152 -> V_147 . V_70 . V_149 ) ) ;
...
T_7 F_49 ( const struct V_171 * V_172 , struct V_142 * V_152 )
{
memset ( V_152 , 0 , sizeof( * V_152 ) ) ;
V_152 -> V_147 . V_55 . V_149 = V_172 -> V_56 ;
V_152 -> V_147 . V_55 . V_151 = V_172 -> V_164 ;
