...
int V_28 , int V_30 )
{
unsigned long V_73 [ 8 ] ;
int V_45 = 0 , V_74 = 0 , V_75 ;
...
V_73 [ V_74 ] = V_80 | V_81 | V_33 [ V_45 ] ;
V_73 [ V_74 + 1 ] = F_33 ( V_24 [ V_45 ] , V_28 , V_30 ) ;
V_74 += 2 ;
if ( V_74 == 8 ) {
V_75 = F_47 ( V_82 , V_73 ,
...
if ( V_74 ) {
V_73 [ V_74 ] = V_83 ;
V_75 = F_47 ( V_82 , V_73 , V_73 [ 0 ] , V_73 [ 1 ] ,
...
unsigned long V_67 , V_92 , V_24 = 0 , V_65 , V_33 ;
V_67 = V_66 [ V_28 ] . V_67 ;
V_87 = 1U << ( V_93 - V_67 ) ;
...
static void F_54 ( unsigned long V_98 , int V_71 )
{
unsigned long V_24 ;
unsigned long V_45 , V_74 , V_75 ;
unsigned long V_32 = 0 ;
struct V_99 * V_100 = F_55 ( & V_99 ) ;
int V_76 = ! F_45 ( V_77 ) ;
unsigned long V_73 [ 9 ] ;
unsigned long V_65 , V_85 , V_67 , V_92 , V_33 ;
T_1 V_101 ;
int V_28 , V_30 ;
if ( V_76 )
F_46 ( & V_78 , V_32 ) ;
...
V_73 [ V_74 ] = V_80 | V_81 | V_33 ;
V_73 [ V_74 + 1 ] = F_33 ( V_24 , V_28 ,
V_30 ) ;
V_74 += 2 ;
if ( V_74 == 8 ) {
V_75 = F_47 ( V_82 , V_73 ,
...
static int T_2 F_59 ( char * V_102 )
{
if ( strcmp ( V_102 , L_18 ) == 0 &&
F_12 ( V_79 ) ) {
F_60 ( V_103 L_19 ) ;
V_104 &= ~ V_79 ;
}
...
static int T_2 F_62 ( char * V_102 )
{
char * V_115 ;
V_115 = F_63 ( V_102 ) ;
if ( strcasecmp ( V_115 , L_20 ) == 0 || strcasecmp ( V_115 , L_18 ) == 0 ) {
F_60 ( V_103 L_21 ) ;
V_116 = 0 ;
return 1 ;
}
V_116 = 1 ;
F_60 ( V_103 L_22 ) ;
if ( strcasecmp ( V_115 , L_23 ) == 0 || strcasecmp ( V_115 , L_24 ) == 0 )
return 1 ;
return 0 ;
}
static void F_64 ( struct V_117 * V_117 , int V_118 ,
unsigned long V_119 )
{
int V_45 , V_58 ;
unsigned long V_120 , V_3 ;
V_120 = F_65 () ;
V_3 = F_7 ( ( unsigned long ) F_66 ( V_117 ) ) ;
for ( V_45 = 0 ; V_45 < ( 1 << V_118 ) ; V_45 ++ , V_3 += V_121 ) {
for ( V_58 = 0 ; V_58 < V_121 ; V_58 += V_120 )
F_67 ( V_122 , V_119 , V_3 + V_58 , 0 ) ;
}
}
void F_68 ( struct V_117 * V_117 , int V_118 )
{
if ( F_11 () )
return;
if ( ! V_116 || ! F_12 ( V_123 ) )
return;
F_64 ( V_117 , V_118 , V_124 ) ;
}
void F_69 ( void )
{
F_70 ( & V_125 ) ;
...
void F_73 ( unsigned long V_127 , unsigned long * args )
{
unsigned long V_32 ;
unsigned int * V_128 ;
if ( V_127 == V_129 )
...
void F_78 ( long V_127 , unsigned long V_132 ,
unsigned long * V_133 )
{
unsigned long V_32 ;
unsigned int * V_128 ;
...
goto V_131;
( * V_128 ) ++ ;
F_79 ( V_127 , V_132 , V_133 ) ;
F_80 () ;
( * V_128 ) -- ;
V_131:
F_77 ( V_32 ) ;
}
int F_81 ( struct V_134 * V_135 )
{
int V_75 ;
unsigned long V_133 [ V_136 ] ;
V_75 = F_47 ( V_137 , V_133 ) ;
V_135 -> V_138 = V_133 [ 0 ] ;
V_135 -> V_139 = V_133 [ 1 ] ;
