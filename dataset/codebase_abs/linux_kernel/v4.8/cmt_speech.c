...
static int F_101 ( struct V_147 * V_148 , struct V_149 * V_150 )
{
struct V_151 * V_152 = V_148 -> V_153 ;
struct V_154 * V_154 ;
V_154 = F_102 ( V_152 -> V_96 ) ;
F_103 ( V_154 ) ;
V_150 -> V_154 = V_154 ;
return 0 ;
}
static int F_104 ( int V_155 , struct V_156 * V_156 , int V_157 )
{
struct V_151 * V_152 = V_156 -> V_158 ;
if ( F_105 ( V_155 , V_156 , V_157 , & V_152 -> V_18 ) < 0 )
return - V_86 ;
return 0 ;
}
static unsigned int F_106 ( struct V_156 * V_156 , T_3 * V_17 )
{
struct V_151 * V_152 = V_156 -> V_158 ;
unsigned int V_83 = 0 ;
F_107 ( V_156 , & V_8 . V_17 , V_17 ) ;
F_69 ( & V_152 -> V_9 ) ;
if ( ! F_17 ( & V_152 -> V_23 ) )
V_83 = V_159 | V_160 ;
else if ( ! F_17 ( & V_152 -> V_25 ) )
V_83 = V_159 | V_160 ;
F_70 ( & V_152 -> V_9 ) ;
return V_83 ;
}
static T_4 F_108 ( struct V_156 * V_156 , char T_5 * V_48 , T_2 V_161 ,
T_6 * V_162 )
{
struct V_151 * V_152 = V_156 -> V_158 ;
T_1 V_21 ;
T_4 V_163 ;
if ( V_161 < sizeof( V_21 ) )
return - V_100 ;
for (; ; ) {
F_77 ( V_17 ) ;
F_69 ( & V_152 -> V_9 ) ;
if ( ! F_17 ( & V_152 -> V_23 ) ) {
V_21 = F_11 ( & V_152 -> V_23 ) ;
} else if ( ! F_17 ( & V_152 -> V_25 ) ) {
V_21 = F_11 ( & V_152 -> V_25 ) ;
V_152 -> V_26 -- ;
} else {
V_21 = 0 ;
}
...
F_109 ( & V_152 -> V_17 , & V_17 ,
V_127 ) ;
F_110 () ;
F_82 ( & V_152 -> V_17 , & V_17 ) ;
}
V_163 = F_111 ( V_21 , ( T_1 T_5 * ) V_48 ) ;
if ( ! V_163 )
V_163 = sizeof( V_21 ) ;
V_11:
return V_163 ;
}
static T_4 F_112 ( struct V_156 * V_156 , const char T_5 * V_48 ,
T_2 V_161 , T_6 * V_162 )
{
struct V_151 * V_152 = V_156 -> V_158 ;
T_1 V_21 ;
...
V_163 = V_161 ;
V_138 = F_65 ( V_152 -> V_32 , V_21 ) ;
if ( V_138 < 0 )
V_163 = V_138 ;
return V_163 ;
}
static long F_114 ( struct V_156 * V_156 , unsigned int V_28 ,
unsigned long V_168 )
{
struct V_151 * V_152 = V_156 -> V_158 ;
int V_120 = 0 ;
...
case V_169 : {
unsigned int V_70 ;
V_70 = F_64 ( V_152 -> V_32 ) ;
if ( F_115 ( ( void T_5 * ) V_168 , & V_70 , sizeof( V_70 ) ) )
V_120 = - V_167 ;
break;
}
case V_170 : {
unsigned int V_70 ;
if ( F_116 ( & V_70 , ( void T_5 * ) V_168 , sizeof( V_70 ) ) ) {
V_120 = - V_167 ;
break;
}
if ( V_70 > 1 ) {
...
F_68 ( V_152 -> V_32 , ! ! V_70 ) ;
break;
}
case V_171 : {
unsigned int V_172 = V_173 ;
if ( F_115 ( ( void T_5 * ) V_168 , & V_172 , sizeof( V_172 ) ) )
V_120 = - V_167 ;
break;
}
case V_174 : {
struct V_116 V_117 ;
if ( F_116 ( & V_117 , ( void T_5 * ) V_168 ,
sizeof( V_117 ) ) )
V_120 = - V_167 ;
else
V_120 = F_85 ( V_152 -> V_32 , & V_117 ) ;
break;
}
default:
V_120 = - V_175 ;
...
static int F_117 ( struct V_156 * V_156 , struct V_147 * V_148 )
{
if ( V_148 -> V_176 < V_148 -> V_177 )
return - V_100 ;
if ( F_118 ( V_148 ) != 1 )
return - V_100 ;
V_148 -> V_178 |= V_179 | V_180 | V_181 ;
V_148 -> V_182 = & V_183 ;
V_148 -> V_153 = V_156 -> V_158 ;
return 0 ;
}
static int F_119 ( struct V_184 * V_162 , struct V_156 * V_156 )
{
int V_83 = 0 ;
unsigned long V_185 ;
F_69 ( & V_8 . V_9 ) ;
...
static int F_124 ( struct V_184 * V_162 , struct V_156 * V_156 )
{
struct V_151 * V_152 = V_156 -> V_158 ;
F_98 ( V_152 -> V_32 ) ;
F_69 ( & V_152 -> V_9 ) ;
