...
static void F_42 ( struct V_14 * V_15 , struct V_23 * V_60 ,
int * V_61 )
{
struct V_13 * V_17 ;
while ( ! F_16 ( V_60 ) ) {
...
static int F_43 ( struct V_14 * V_15 , struct V_23 * V_60 ,
...
int V_27 ;
unsigned V_64 ;
V_27 = F_43 ( V_15 , V_60 , F_38 ,
& V_20 -> V_65 ) ;
if ( V_27 )
return V_27 ;
V_27 = F_43 ( V_20 -> V_29 -> V_26 , & V_20 -> V_25 ,
F_40 , & V_20 -> V_66 ) ;
if ( V_27 ) {
F_42 ( V_15 , V_60 , & V_20 -> V_65 ) ;
return V_27 ;
}
V_20 -> V_57 = 0 ;
V_64 = F_27 ( V_20 ) ;
...
F_42 ( V_15 , V_60 , & V_20 -> V_65 ) ;
F_42 ( V_20 -> V_29 -> V_26 , & V_20 -> V_25 ,
& V_20 -> V_66 ) ;
V_27 = - V_67 ;
}
return V_27 ;
}
static int F_46 ( struct V_47 * V_44 , struct V_68 * V_68 )
{
int V_38 = V_44 -> V_69 ;
struct V_19 * V_20 ;
int V_27 ;
...
static int F_50 ( struct V_19 * V_81 )
{
int V_82 ;
F_29 ( & V_81 -> V_40 ) ;
...
static void F_51 ( struct V_47 * V_44 , struct V_68 * V_68 )
{
...
static int F_58 ( struct V_47 * V_44 , unsigned char V_87 )
{
struct V_19 * V_20 = V_44 -> V_59 ;
unsigned long V_86 ;
int V_27 ;
F_20 ( L_16 ,
V_20 -> V_38 , V_44 , V_87 , F_59 ( 0 ) ) ;
F_56 ( & V_20 -> V_40 , V_86 ) ;
...
static int F_64 ( struct V_47 * V_44 , int V_90 )
{
struct V_19 * V_20 = V_44 -> V_59 ;
int V_27 = 0 ;
struct V_78 * V_79 ;
...
static struct V_13 * F_65 ( struct V_14 * V_15 )
{
...
static void F_66 ( struct V_13 * V_17 , struct V_14 * V_15 )
{
if ( ! V_17 )
return;
F_4 ( V_17 -> V_10 ) ;
...
static void F_67 ( struct V_14 * V_15 , struct V_13 * V_17 )
{
...
static int F_76 ( struct V_107 * V_108 , char * V_109 )
{
struct V_92 * V_93 = & V_92 ;
int V_27 ;
V_93 -> V_20 = NULL ;
...
F_70 ( L_26 , V_42 ) ;
F_3 ( & V_93 -> V_105 ) ;
return F_80 ( V_93 -> V_96 ) ;
}
F_68 ( V_93 -> V_96 ) ;
return 0 ;
}
static void F_81 ( struct V_107 * V_108 ,
...
static struct V_111 * F_82 ( struct V_107 * V_108 , int * V_69 )
{
...
if ( V_20 -> V_20 . V_11 == 0 && ! V_20 -> V_73 )
F_3 ( & V_20 -> V_22 ) ;
F_42 ( V_79 -> V_46 , & V_20 -> V_45 , NULL ) ;
F_42 ( V_79 -> V_46 , & V_20 -> V_51 , NULL ) ;
F_42 ( V_79 -> V_26 , & V_20 -> V_25 , NULL ) ;
V_20 -> V_65 = V_20 -> V_48 =
