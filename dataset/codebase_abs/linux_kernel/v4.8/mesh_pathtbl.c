...
V_77 -> V_6 = 0 ;
F_66 ( & V_77 -> V_28 ) ;
V_77 -> V_80 . V_30 = ( unsigned long ) V_77 ;
V_77 -> V_80 . V_81 = V_82 ;
V_77 -> V_9 = V_8 ;
F_11 ( & V_77 -> V_59 ) ;
F_67 ( & V_77 -> V_80 ) ;
...
if ( F_71 ( V_56 ) )
return F_70 ( - V_83 ) ;
if ( F_72 ( & V_34 -> V_60 . V_61 . V_84 , 1 , V_85 ) == 0 )
return F_70 ( - V_86 ) ;
...
static const T_2 V_92 [ V_32 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
struct V_4 * V_5 ;
struct V_67 V_68 ;
int V_66 ;
V_66 = F_46 ( & V_14 -> V_20 , & V_68 , V_16 ) ;
...
F_42 ( & V_5 -> V_59 ) ;
F_79 ( & V_5 -> V_80 ) ;
F_80 ( & V_34 -> V_60 . V_61 . V_84 ) ;
F_80 ( & V_14 -> V_18 ) ;
F_81 ( V_5 , V_100 ) ;
}
static void F_82 ( struct V_13 * V_14 , struct V_4 * V_5 )
{
F_83 ( & V_14 -> V_20 , & V_5 -> V_88 , V_58 ) ;
F_6 ( V_14 , V_5 ) ;
}
...
if ( V_104 -> V_6 & V_7 ) {
F_33 ( V_34 , L_5 , V_104 -> V_56 ) ;
F_27 ( V_104 , V_49 , V_50 ) ;
V_49 = V_104 ;
V_50 = true ;
} else {
F_33 ( V_34 ,
L_6 ,
V_104 -> V_56 , V_104 -> V_6 ) ;
}
}
F_93 (gate, &tbl->known_gates, gate_list) {
F_33 ( V_34 , L_7 , V_104 -> V_56 ) ;
F_90 ( V_104 ) ;
}
F_26 () ;
return ( V_49 == V_5 ) ? - V_105 : 0 ;
}
void F_94 ( struct V_57 * V_34 ,
struct V_23 * V_24 )
{
F_37 ( V_24 ) ;
V_34 -> V_60 . V_61 . V_106 . V_107 ++ ;
}
...
F_100 ( & V_111 -> V_20 , & V_58 ) ;
F_100 ( & V_112 -> V_20 , & V_58 ) ;
...
void F_102 ( struct V_57 * V_34 )
{
F_101 ( V_34 , V_34 -> V_60 . V_61 . V_62 ) ;
F_101 ( V_34 , V_34 -> V_60 . V_61 . V_63 ) ;
}
