...
return error ;
if ( V_35 != V_28 ) {
long V_120 = ( long ) * V_11 ;
ASSERT ( * V_11 >= V_17 && * V_11 <= V_18 ) ;
if ( V_113 )
F_49 ( V_2 , V_121 , - V_120 ) ;
else
F_49 ( V_2 , V_112 , - V_120 ) ;
}
* V_21 = V_35 ;
return 0 ;
}
...
if ( V_84 -> V_125 == V_126 )
return 0 ;
error = F_59 ( V_1 , NULL , V_84 -> V_125 , 0 , 0 , & V_1 -> V_89 ) ;
if ( error )
return error ;
ASSERT ( V_1 -> V_89 != NULL ) ;
ASSERT ( V_84 -> V_127 != V_126 ) ;
error = F_59 ( V_1 , NULL , V_84 -> V_127 , 0 , 0 , & V_1 -> V_99 ) ;
if ( error ) {
F_60 ( V_1 -> V_89 ) ;
return error ;
}
...
T_16 * V_133 ;
ASSERT ( F_53 ( V_1 -> V_89 , V_57 ) ) ;
V_133 = ( T_16 * ) & F_63 ( V_1 -> V_89 ) -> V_134 ;
if ( ! ( V_1 -> V_89 -> V_97 . V_135 & V_136 ) ) {
V_1 -> V_89 -> V_97 . V_135 |= V_136 ;
* V_133 = 0 ;
}
V_132 = * V_133 ;
if ( ( V_130 = F_64 ( V_132 ) ) == - 1 )
V_129 = 0 ;
else {
V_131 = V_132 - ( 1ULL << V_130 ) ;
V_129 = ( V_1 -> V_15 . V_16 * ( ( V_131 << 1 ) + 1ULL ) ) >>
( V_130 + 1 ) ;
if ( V_129 >= V_1 -> V_15 . V_16 )
V_129 = F_14 ( V_129 , V_1 -> V_15 . V_16 ) ;
if ( V_129 + V_11 > V_1 -> V_15 . V_16 )
V_129 = V_1 -> V_15 . V_16 - V_11 ;
}
* V_133 = V_132 + 1 ;
F_47 ( V_2 , V_1 -> V_89 , V_105 ) ;
* V_128 = V_129 ;
