...
void F_79 ( struct V_1 * V_8 )
{
F_60 ( V_8 , false ) ;
V_8 -> V_286 = false ;
}
int F_80 ( struct V_1 * V_8 ,
struct V_281 * V_287 )
{
if ( ! V_8 -> V_286 ) {
F_55 ( V_8 -> V_57 , L_13 ) ;
...
{
int V_49 ;
for ( V_49 = 0 ; V_49 < F_46 ( V_292 ) ; V_49 ++ ) {
V_8 -> V_248 [ V_49 ] = F_85 ( V_291 ,
V_292 [ V_49 ] ) ;
...
{
F_90 ( V_8 -> V_248 [ V_293 ] ) ;
F_90 ( V_8 -> V_248 [ V_294 ] ) ;
}
static enum V_295 F_92 ( struct V_5 * V_7 ,
bool V_296 )
{
struct V_1 * V_8 = F_3 ( V_7 ) ;
return F_93 ( V_8 -> V_297 ) ?
V_298 : V_299 ;
}
static void F_94 ( struct V_5 * V_7 )
{
struct V_1 * V_8 = F_3 ( V_7 ) ;
F_95 ( V_8 -> V_297 , NULL , NULL ) ;
F_96 ( V_7 ) ;
}
...
if ( ! V_8 -> V_301 )
return - V_302 ;
V_300 = F_98 ( V_7 , V_8 -> V_301 ) ;
if ( ! V_300 )
return - V_302 ;
V_8 -> V_250 = ! F_99 ( V_300 ) ;
F_100 ( V_7 , V_300 ) ;
V_247 = F_101 ( V_7 , V_300 ) ;
F_102 ( V_7 , V_300 ) ;
F_103 ( V_300 ) ;
return V_247 ;
}
...
struct V_1 * V_8 = F_3 ( V_7 ) ;
F_23 ( V_8 -> V_57 , L_18 ,
V_87 -> V_303 , V_87 -> V_91 , V_87 -> V_304 ,
! ! ( V_87 -> V_89 & V_90 ) , V_87 -> clock * 1000 ) ;
if ( V_8 -> V_4 . V_305 ) {
struct V_86 V_306 ;
F_105 ( & V_306 , V_87 ) ;
if ( ! F_106 ( V_8 -> V_4 . V_305 , V_87 ,
& V_306 ) )
return V_307 ;
}
if ( V_87 -> clock < 27000 )
...
static struct V_310 * F_108 ( struct V_5 * V_7 )
{
struct V_1 * V_8 = F_3 ( V_7 ) ;
return V_8 -> V_4 . V_311 ;
}
static void F_109 ( bool V_312 , struct V_313 * V_57 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
if ( V_8 && V_8 -> V_4 . V_311 && V_8 -> V_4 . V_311 -> V_57 )
F_111 ( V_8 -> V_4 . V_311 -> V_57 ) ;
}
static int F_112 ( struct V_2 * V_4 )
{
struct V_1 * V_8 = F_1 ( V_4 ) ;
int V_247 ;
V_247 = F_113 ( V_4 -> V_311 -> V_57 , & V_8 -> V_7 ,
& V_314 ,
V_315 ) ;
if ( V_247 ) {
F_55 ( V_8 -> V_57 , L_19 , V_247 ) ;
return V_247 ;
}
F_114 ( & V_8 -> V_7 , & V_316 ) ;
V_8 -> V_7 . V_317 = V_318 ;
...
if ( V_4 -> V_305 ) {
V_4 -> V_305 -> V_311 = V_4 -> V_311 ;
V_247 = F_116 ( V_4 -> V_311 -> V_57 , V_4 -> V_305 ) ;
if ( V_247 ) {
F_55 ( V_8 -> V_57 ,
L_21 , V_247 ) ;
return V_247 ;
...
struct V_1 * V_8 = F_1 ( V_4 ) ;
F_23 ( V_8 -> V_57 , L_22 ,
V_306 -> V_324 , V_306 -> V_303 ) ;
F_23 ( V_8 -> V_57 , L_23 ,
V_306 -> V_325 , V_306 -> V_326 ,
V_306 -> V_327 ) ;
F_23 ( V_8 -> V_57 , L_24 ,
V_306 -> V_328 , V_306 -> V_91 ) ;
F_23 ( V_8 -> V_57 , L_25 ,
V_306 -> V_329 , V_306 -> V_330 ,
V_306 -> V_331 ) ;
F_23 ( V_8 -> V_57 , L_26 ,
V_306 -> V_332 , V_306 -> V_89 ) ;
F_105 ( & V_8 -> V_87 , V_306 ) ;
}
...
struct V_333 * V_334 )
{
struct V_313 * V_57 = & V_334 -> V_57 ;
struct V_290 * V_291 = V_57 -> V_335 ;
struct V_290 * V_336 , * V_337 , * V_338 , * V_339 , * V_340 ;
struct V_333 * V_341 ;
struct V_342 * V_342 ;
struct V_343 * V_344 ;
int V_247 ;
V_247 = F_84 ( V_8 , V_291 ) ;
if ( V_247 ) {
F_55 ( V_57 , L_27 , V_247 ) ;
return V_247 ;
}
V_336 = F_124 ( V_291 -> V_345 , NULL ,
L_28 ) ;
if ( ! V_336 ) {
F_55 ( V_57 , L_29 ) ;
return - V_263 ;
...
V_8 -> V_297 = & V_341 -> V_57 ;
V_342 = F_126 ( V_291 , L_31 ) ;
V_247 = F_127 ( V_291 , L_31 , 1 ,
& V_8 -> V_26 ) ;
if ( F_86 ( V_342 ) )
V_247 = F_87 ( V_342 ) ;
if ( V_247 ) {
...
V_8 -> V_25 = V_342 ;
V_344 = F_128 ( V_334 , V_348 , 0 ) ;
V_8 -> V_10 = F_129 ( V_57 , V_344 ) ;
if ( F_86 ( V_8 -> V_10 ) )
...
static int F_138 ( struct V_313 * V_57 , void * V_349 ,
struct V_350 * V_351 ,
struct V_352 * V_353 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
...
static int F_139 ( struct V_313 * V_57 , void * V_349 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
...
static void F_140 ( struct V_313 * V_57 , void * V_349 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_46 , V_191 ) ;
F_79 ( V_8 ) ;
}
int F_141 ( struct V_313 * V_57 , void * V_349 , bool V_21 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
...
static int F_142 ( struct V_313 * V_57 , void * V_349 , T_5 * V_360 , T_6 V_46 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_46 , V_191 ) ;
memcpy ( V_360 , V_8 -> V_7 . V_361 , F_143 ( sizeof( V_8 -> V_7 . V_361 ) , V_46 ) ) ;
return 0 ;
}
static void F_144 ( struct V_313 * V_57 )
{
struct V_362 V_363 = {
. V_364 = & V_365 ,
. V_366 = 2 ,
...
static int F_147 ( struct V_333 * V_334 )
{
struct V_1 * V_8 ;
struct V_313 * V_57 = & V_334 -> V_57 ;
int V_247 ;
V_8 = F_148 ( V_57 , sizeof( * V_8 ) , V_370 ) ;
if ( ! V_8 )
return - V_371 ;
V_8 -> V_57 = V_57 ;
V_247 = F_123 ( V_8 , V_334 ) ;
if ( V_247 )
return V_247 ;
V_8 -> V_288 = F_149 ( V_57 , L_49 ) ;
if ( F_86 ( V_8 -> V_288 ) ) {
...
static int F_153 ( struct V_333 * V_334 )
{
struct V_1 * V_8 = F_154 ( V_334 ) ;
F_152 ( & V_8 -> V_4 ) ;
F_91 ( V_8 ) ;
return 0 ;
}
static int F_155 ( struct V_313 * V_57 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_91 ( V_8 ) ;
F_23 ( V_57 , L_55 ) ;
...
static int F_156 ( struct V_313 * V_57 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
int V_247 = 0 ;
V_247 = F_88 ( V_8 ) ;
...
V_247 = F_158 ( V_375 [ V_49 ] ) ;
if ( V_247 < 0 ) {
F_159 ( L_58 ,
V_375 [ V_49 ] -> V_376 . V_324 , V_247 ) ;
goto V_269;
}
}
return 0 ;
