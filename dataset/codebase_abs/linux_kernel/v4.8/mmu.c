...
static bool F_115 ( struct V_106 * V_106 , T_1 * V_14 , bool V_139 )
{
T_1 V_10 = * V_14 ;
if ( ! F_41 ( V_10 ) &&
! ( V_139 && F_39 ( V_10 ) ) )
...
V_140 |= F_115 ( V_106 , V_14 , V_139 ) ;
return V_140 ;
}
static bool F_118 ( struct V_106 * V_106 , T_1 * V_14 )
{
T_1 V_10 = * V_14 ;
F_98 ( L_10 , V_14 , * V_14 ) ;
V_10 &= ~ V_32 ;
...
bool V_140 = false ;
F_117 (rmap_head, &iter, sptep)
V_140 |= F_118 ( V_106 , V_14 ) ;
return V_140 ;
}
static bool F_120 ( struct V_106 * V_106 , T_1 * V_14 )
{
T_1 V_10 = * V_14 ;
F_98 ( L_11 , V_14 , * V_14 ) ;
V_10 |= V_32 ;
...
static inline void F_159 ( struct V_106 * V_106 , int V_172 )
{
V_106 -> V_36 . V_173 += V_172 ;
F_160 ( & V_174 , V_172 ) ;
}
...
{
return V_15 & ( ( 1 << V_177 ) - 1 ) ;
}
static void F_166 ( struct V_11 * V_12 ,
struct V_48 * V_49 , T_1 * V_178 )
{
if ( ! V_178 )
return;
F_97 ( V_12 , V_178 , & V_49 -> V_179 ) ;
}
static void F_167 ( struct V_48 * V_49 ,
T_1 * V_178 )
{
F_100 ( V_178 , & V_49 -> V_179 ) ;
}
...
F_172 ( & V_49 -> V_176 , & V_12 -> V_106 -> V_36 . V_180 ) ;
F_159 ( V_12 -> V_106 , + 1 ) ;
return V_49 ;
}
...
static void F_177 ( struct V_11 * V_12 , T_6 V_183 )
{
}
...
static int F_179 ( struct V_184 * V_185 , struct V_48 * V_49 ,
int V_98 )
{
int V_102 ;
if ( V_49 -> V_186 )
for ( V_102 = 0 ; V_102 < V_185 -> V_172 ; V_102 ++ )
if ( V_185 -> V_80 [ V_102 ] . V_49 == V_49 )
return 0 ;
V_185 -> V_80 [ V_185 -> V_172 ] . V_49 = V_49 ;
V_185 -> V_80 [ V_185 -> V_172 ] . V_98 = V_98 ;
V_185 -> V_172 ++ ;
return ( V_185 -> V_172 == V_187 ) ;
}
static inline void F_180 ( struct V_48 * V_49 , int V_98 )
{
-- V_49 -> V_182 ;
F_3 ( ( int ) V_49 -> V_182 < 0 ) ;
F_181 ( V_98 , V_49 -> V_181 ) ;
}
static int F_182 ( struct V_48 * V_49 ,
struct V_184 * V_185 )
{
int V_102 , V_64 , V_188 = 0 ;
F_183 (i, sp->unsync_child_bitmap, 512 ) {
struct V_48 * V_189 ;
T_1 V_190 = V_49 -> V_133 [ V_102 ] ;
if ( ! F_22 ( V_190 ) || F_23 ( V_190 ) ) {
F_180 ( V_49 , V_102 ) ;
continue;
}
V_189 = F_35 ( V_190 & V_43 ) ;
if ( V_189 -> V_182 ) {
if ( F_179 ( V_185 , V_189 , V_102 ) )
return - V_191 ;
V_64 = F_182 ( V_189 , V_185 ) ;
if ( ! V_64 ) {
F_180 ( V_49 , V_102 ) ;
continue;
} else if ( V_64 > 0 ) {
...
if ( ! V_49 -> V_182 )
return 0 ;
F_179 ( V_185 , V_49 , V_192 ) ;
return F_182 ( V_49 , V_185 ) ;
}
...
struct V_194 * V_195 )
{
if ( V_49 -> V_91 . V_196 != ! ! F_188 ( V_12 ) ) {
F_189 ( V_12 -> V_106 , V_49 , V_195 ) ;
return false ;
}
if ( V_12 -> V_36 . V_197 . V_198 ( V_12 , V_49 ) == 0 ) {
F_189 ( V_12 -> V_106 , V_49 , V_195 ) ;
return false ;
}
return true ;
...
if ( ! V_204 -> V_186 )
continue;
F_3 ( V_204 -> V_91 . V_41 != V_42 ) ;
V_64 |= F_197 ( V_12 , V_204 , V_195 ) ;
}
return V_64 ;
}
...
{
int V_207 ;
for ( V_207 = V_102 + 1 ; V_207 < V_185 -> V_172 ; V_207 ++ ) {
struct V_48 * V_49 = V_185 -> V_80 [ V_207 ] . V_49 ;
unsigned V_98 = V_185 -> V_80 [ V_207 ] . V_98 ;
int V_41 = V_49 -> V_91 . V_41 ;
V_206 -> V_98 [ V_41 - 1 ] = V_98 ;
if ( V_41 == V_42 )
break;
V_206 -> V_208 [ V_41 - 2 ] = V_49 ;
}
return V_207 ;
}
...
if ( V_185 -> V_172 == 0 )
return 0 ;
F_3 ( V_185 -> V_80 [ 0 ] . V_98 != V_192 ) ;
V_49 = V_185 -> V_80 [ 0 ] . V_49 ;
V_41 = V_49 -> V_91 . V_41 ;
F_3 ( V_41 == V_42 ) ;
V_206 -> V_208 [ V_41 - 2 ] = V_49 ;
V_206 -> V_208 [ V_41 - 1 ] = NULL ;
return F_200 ( V_185 , V_206 , 0 ) ;
}
static void F_202 ( struct V_205 * V_206 )
{
struct V_48 * V_49 ;
unsigned int V_41 = 0 ;
do {
unsigned int V_98 = V_206 -> V_98 [ V_41 ] ;
V_49 = V_206 -> V_208 [ V_41 ] ;
if ( ! V_49 )
return;
F_3 ( V_98 == V_192 ) ;
F_180 ( V_49 , V_98 ) ;
...
F_204 ( V_195 ) ;
bool V_140 = false ;
while ( F_184 ( V_208 , & V_209 ) ) {
bool V_210 = false ;
F_205 (pages, sp, parents, i)
V_210 |= F_127 ( V_12 , V_49 -> V_15 ) ;
if ( V_210 ) {
F_114 ( V_12 -> V_106 ) ;
V_140 = false ;
}
F_205 (pages, sp, parents, i) {
V_140 |= F_197 ( V_12 , V_49 , & V_195 ) ;
F_202 ( & V_206 ) ;
}
if ( F_206 () || F_207 ( & V_12 -> V_106 -> V_211 ) ) {
F_190 ( V_12 , & V_195 , false , V_140 ) ;
F_208 ( & V_12 -> V_106 -> V_211 ) ;
V_140 = false ;
}
}
F_190 ( V_12 , & V_195 , false , V_140 ) ;
...
bool V_140 = false ;
F_204 ( V_195 ) ;
V_91 = V_12 -> V_36 . V_197 . V_217 ;
V_91 . V_41 = V_41 ;
V_91 . V_92 = V_92 ;
if ( V_91 . V_92 )
V_91 . V_196 = 0 ;
V_91 . V_16 = V_16 ;
if ( ! V_12 -> V_36 . V_197 . V_218
&& V_12 -> V_36 . V_197 . V_219 <= V_220 ) {
V_215 = V_213 >> ( V_19 + ( V_221 * V_41 ) ) ;
V_215 &= ( 1 << ( ( V_222 - V_221 ) * V_41 ) ) - 1 ;
V_91 . V_215 = V_215 ;
}
F_213 (vcpu->kvm, sp, gfn) {
if ( ! V_216 && V_49 -> V_186 )
V_216 = true ;
if ( V_49 -> V_91 . V_223 != V_91 . V_223 )
continue;
if ( V_49 -> V_186 ) {
if ( ! F_187 ( V_12 , V_49 , & V_195 ) )
break;
F_3 ( ! F_191 ( & V_195 ) ) ;
F_193 ( V_201 , V_12 ) ;
}
...
++ V_12 -> V_106 -> V_137 . V_225 ;
V_49 = F_169 ( V_12 , V_92 ) ;
V_49 -> V_15 = V_15 ;
V_49 -> V_91 = V_91 ;
F_215 ( & V_49 -> V_175 ,
& V_12 -> V_106 -> V_36 . V_226 [ F_165 ( V_15 ) ] ) ;
if ( ! V_92 ) {
...
F_114 ( V_12 -> V_106 ) ;
if ( V_41 > V_42 && V_216 )
V_140 |= F_198 ( V_12 , V_15 , & V_195 ) ;
}
V_49 -> V_203 = V_12 -> V_106 -> V_36 . V_203 ;
F_216 ( V_49 -> V_133 ) ;
F_214 ( V_49 , true ) ;
F_190 ( V_12 , & V_195 , false , V_140 ) ;
return V_49 ;
}
static void F_217 ( struct V_227 * V_151 ,
struct V_11 * V_12 , T_1 V_228 )
{
V_151 -> V_228 = V_228 ;
V_151 -> V_229 = V_12 -> V_36 . V_197 . V_230 ;
V_151 -> V_41 = V_12 -> V_36 . V_197 . V_231 ;
if ( V_151 -> V_41 == V_232 &&
V_12 -> V_36 . V_197 . V_219 < V_232 &&
! V_12 -> V_36 . V_197 . V_218 )
-- V_151 -> V_41 ;
if ( V_151 -> V_41 == V_233 ) {
V_151 -> V_229
= V_12 -> V_36 . V_197 . V_234 [ ( V_228 >> 30 ) & 3 ] ;
V_151 -> V_229 &= V_43 ;
-- V_151 -> V_41 ;
if ( ! V_151 -> V_229 )
V_151 -> V_41 = 0 ;
...
static bool F_218 ( struct V_227 * V_151 )
{
if ( V_151 -> V_41 < V_42 )
return false ;
V_151 -> V_90 = F_219 ( V_151 -> V_228 , V_151 -> V_41 ) ;
V_151 -> V_14 = ( ( T_1 * ) F_220 ( V_151 -> V_229 ) ) + V_151 -> V_90 ;
return true ;
}
static void F_221 ( struct V_227 * V_151 ,
T_1 V_10 )
{
...
V_151 -> V_229 = V_10 & V_43 ;
-- V_151 -> V_41 ;
}
static void F_222 ( struct V_227 * V_151 )
{
...
struct V_48 * V_189 ;
V_189 = F_35 ( * V_14 & V_43 ) ;
if ( V_189 -> V_91 . V_16 == V_236 )
return;
F_168 ( V_189 , V_14 ) ;
F_114 ( V_12 -> V_106 ) ;
}
...
T_1 * V_14 ;
struct V_134 V_135 ;
while ( ( V_14 = F_109 ( & V_49 -> V_179 , & V_135 ) ) )
F_168 ( V_49 , V_14 ) ;
}
...
struct V_205 V_206 ;
struct V_184 V_209 ;
if ( V_208 -> V_91 . V_41 == V_42 )
return 0 ;
while ( F_184 ( V_208 , & V_209 ) ) {
struct V_48 * V_49 ;
F_205 (pages, sp, parents, i) {
F_189 ( V_106 , V_49 , V_195 ) ;
F_202 ( & V_206 ) ;
V_238 ++ ;
}
}
...
F_230 ( V_49 ) ;
++ V_106 -> V_137 . V_239 ;
V_64 = F_229 ( V_106 , V_49 , V_195 ) ;
F_227 ( V_106 , V_49 ) ;
F_228 ( V_106 , V_49 ) ;
if ( ! V_49 -> V_91 . V_240 && ! V_49 -> V_91 . V_92 )
F_86 ( V_106 , V_49 ) ;
if ( V_49 -> V_186 )
F_185 ( V_106 , V_49 ) ;
if ( ! V_49 -> V_241 ) {
V_64 ++ ;
F_231 ( & V_49 -> V_176 , V_195 ) ;
F_159 ( V_106 , - 1 ) ;
} else {
F_231 ( & V_49 -> V_176 , & V_106 -> V_36 . V_180 ) ;
if ( ! V_49 -> V_91 . V_240 && ! F_196 ( V_106 , V_49 ) )
F_232 ( V_106 ) ;
}
V_49 -> V_91 . V_240 = 1 ;
return V_64 ;
...
struct V_194 * V_195 )
{
struct V_48 * V_49 , * V_242 ;
if ( F_191 ( V_195 ) )
return;
F_114 ( V_106 ) ;
F_233 (sp, nsp, invalid_list, link) {
F_3 ( ! V_49 -> V_91 . V_240 || V_49 -> V_241 ) ;
F_161 ( V_49 ) ;
}
}
...
{
struct V_48 * V_49 ;
if ( F_191 ( & V_106 -> V_36 . V_180 ) )
return false ;
V_49 = F_235 ( & V_106 -> V_36 . V_180 ,
struct V_48 , V_176 ) ;
F_189 ( V_106 , V_49 , V_195 ) ;
return true ;
}
void F_236 ( struct V_106 * V_106 , unsigned int V_243 )
{
F_204 ( V_195 ) ;
F_237 ( & V_106 -> V_211 ) ;
if ( V_106 -> V_36 . V_173 > V_243 ) {
while ( V_106 -> V_36 . V_173 > V_243 )
if ( ! F_234 ( V_106 , & V_195 ) )
break;
F_192 ( V_106 , & V_195 ) ;
V_243 = V_106 -> V_36 . V_173 ;
}
V_106 -> V_36 . V_244 = V_243 ;
F_238 ( & V_106 -> V_211 ) ;
}
...
int V_254 , int V_41 , T_2 V_15 , T_3 V_21 ,
...
if ( F_249 ( V_12 , V_14 , V_246 , V_41 , V_15 , V_21 , V_247 ,
true , V_248 ) ) {
if ( V_254 )
V_257 = true ;
F_193 ( V_201 , V_12 ) ;
...
static int F_260 ( struct V_11 * V_12 , int V_261 , int V_262 ,
int V_41 , T_2 V_15 , T_3 V_21 , bool V_263 )
{
struct V_227 V_151 ;
struct V_48 * V_49 ;
int V_257 = 0 ;
T_2 V_264 ;
if ( ! F_261 ( V_12 -> V_36 . V_197 . V_230 ) )
return 0 ;
F_262 (vcpu, (u64)gfn << PAGE_SHIFT, iterator) {
if ( V_151 . V_41 == V_41 ) {
V_257 = F_251 ( V_12 , V_151 . V_14 , V_265 ,
V_261 , V_41 , V_15 , V_21 , V_263 ,
V_262 ) ;
...
if ( ! F_22 ( * V_151 . V_14 ) ) {
T_1 V_267 = V_151 . V_228 ;
V_267 &= F_263 ( V_151 . V_41 ) ;
V_264 = V_267 >> V_19 ;
V_49 = F_212 ( V_12 , V_264 , V_151 . V_228 ,
V_151 . V_41 - 1 , 1 , V_265 ) ;
F_223 ( V_12 , V_151 . V_14 , V_49 ) ;
}
}
return V_257 ;
}
static void F_264 ( unsigned long V_268 , struct V_269 * V_270 )
{
T_7 V_271 ;
V_271 . V_272 = V_273 ;
V_271 . V_274 = 0 ;
V_271 . V_275 = V_276 ;
V_271 . V_277 = ( void V_278 * ) V_268 ;
V_271 . V_279 = V_19 ;
F_265 ( V_273 , & V_271 , V_270 ) ;
}
...
static bool F_274 ( struct V_11 * V_12 , T_6 V_183 , T_2 V_15 ,
T_3 V_21 , unsigned V_16 , int * V_287 )
{
if ( F_14 ( F_275 ( V_21 ) ) ) {
* V_287 = F_266 ( V_12 , V_15 , V_21 ) ;
return true ;
}
if ( F_14 ( F_15 ( V_21 ) ) )
F_276 ( V_12 , V_183 , V_15 , V_16 ) ;
return false ;
}
static bool F_277 ( T_4 V_288 )
{
if ( F_14 ( V_288 & V_289 ) )
return false ;
if ( ! ( V_288 & V_290 ) ||
...
static bool F_280 ( struct V_11 * V_12 , T_6 V_183 , int V_41 ,
T_4 V_288 )
{
struct V_227 V_151 ;
struct V_48 * V_49 ;
...
exit:
F_282 ( V_12 , V_183 , V_288 , V_151 . V_14 ,
V_10 , V_64 ) ;
F_56 ( V_12 ) ;
return V_64 ;
}
static int F_283 ( struct V_11 * V_12 , T_6 V_292 , T_4 V_288 ,
T_2 V_15 , bool V_263 )
{
int V_81 ;
int V_41 ;
...
if ( F_280 ( V_12 , V_292 , V_41 , V_288 ) )
return 0 ;
V_293 = V_12 -> V_106 -> V_171 ;
F_38 () ;
if ( F_284 ( V_12 , V_263 , V_15 , V_292 , & V_21 , V_261 , & V_262 ) )
return 0 ;
if ( F_274 ( V_12 , V_292 , V_15 , V_21 , V_265 , & V_81 ) )
return V_81 ;
F_237 ( & V_12 -> V_106 -> V_211 ) ;
if ( F_285 ( V_12 -> V_106 , V_293 ) )
goto V_294;
F_286 ( V_12 ) ;
if ( F_18 ( ! V_117 ) )
F_268 ( V_12 , & V_15 , & V_21 , & V_41 ) ;
V_81 = F_260 ( V_12 , V_261 , V_262 , V_41 , V_15 , V_21 , V_263 ) ;
F_238 ( & V_12 -> V_106 -> V_211 ) ;
return V_81 ;
V_294:
F_238 ( & V_12 -> V_106 -> V_211 ) ;
F_252 ( V_21 ) ;
...
if ( ! F_261 ( V_12 -> V_36 . V_197 . V_230 ) )
return;
if ( V_12 -> V_36 . V_197 . V_231 == V_232 &&
( V_12 -> V_36 . V_197 . V_219 == V_232 ||
V_12 -> V_36 . V_197 . V_218 ) ) {
T_8 V_295 = V_12 -> V_36 . V_197 . V_230 ;
F_237 ( & V_12 -> V_106 -> V_211 ) ;
V_49 = F_35 ( V_295 ) ;
-- V_49 -> V_241 ;
if ( ! V_49 -> V_241 && V_49 -> V_91 . V_240 ) {
F_189 ( V_12 -> V_106 , V_49 , & V_195 ) ;
F_192 ( V_12 -> V_106 , & V_195 ) ;
}
F_238 ( & V_12 -> V_106 -> V_211 ) ;
V_12 -> V_36 . V_197 . V_230 = V_296 ;
return;
}
F_237 ( & V_12 -> V_106 -> V_211 ) ;
for ( V_102 = 0 ; V_102 < 4 ; ++ V_102 ) {
T_8 V_295 = V_12 -> V_36 . V_197 . V_234 [ V_102 ] ;
if ( V_295 ) {
V_295 &= V_43 ;
V_49 = F_35 ( V_295 ) ;
-- V_49 -> V_241 ;
...
V_12 -> V_36 . V_197 . V_234 [ V_102 ] = V_296 ;
}
F_192 ( V_12 -> V_106 , & V_195 ) ;
F_238 ( & V_12 -> V_106 -> V_211 ) ;
V_12 -> V_36 . V_197 . V_230 = V_296 ;
...
F_237 ( & V_12 -> V_106 -> V_211 ) ;
F_286 ( V_12 ) ;
V_49 = F_212 ( V_12 , 0 , 0 , V_232 , 1 , V_265 ) ;
++ V_49 -> V_241 ;
F_238 ( & V_12 -> V_106 -> V_211 ) ;
V_12 -> V_36 . V_197 . V_230 = F_36 ( V_49 -> V_133 ) ;
} else if ( V_12 -> V_36 . V_197 . V_231 == V_233 ) {
for ( V_102 = 0 ; V_102 < 4 ; ++ V_102 ) {
T_8 V_295 = V_12 -> V_36 . V_197 . V_234 [ V_102 ] ;
F_162 ( F_261 ( V_295 ) ) ;
F_237 ( & V_12 -> V_106 -> V_211 ) ;
...
V_102 << 30 , V_220 , 1 , V_265 ) ;
V_295 = F_36 ( V_49 -> V_133 ) ;
++ V_49 -> V_241 ;
F_238 ( & V_12 -> V_106 -> V_211 ) ;
V_12 -> V_36 . V_197 . V_234 [ V_102 ] = V_295 | V_258 ;
}
V_12 -> V_36 . V_197 . V_230 = F_36 ( V_12 -> V_36 . V_197 . V_234 ) ;
} else
F_102 () ;
return 0 ;
}
...
T_2 V_297 ;
int V_102 ;
V_297 = V_12 -> V_36 . V_197 . V_301 ( V_12 ) >> V_19 ;
if ( F_288 ( V_12 , V_297 ) )
return 1 ;
if ( V_12 -> V_36 . V_197 . V_219 == V_232 ) {
T_8 V_295 = V_12 -> V_36 . V_197 . V_230 ;
F_162 ( F_261 ( V_295 ) ) ;
F_237 ( & V_12 -> V_106 -> V_211 ) ;
F_286 ( V_12 ) ;
V_49 = F_212 ( V_12 , V_297 , 0 , V_232 ,
0 , V_265 ) ;
V_295 = F_36 ( V_49 -> V_133 ) ;
++ V_49 -> V_241 ;
F_238 ( & V_12 -> V_106 -> V_211 ) ;
V_12 -> V_36 . V_197 . V_230 = V_295 ;
return 0 ;
}
V_300 = V_258 ;
if ( V_12 -> V_36 . V_197 . V_231 == V_232 )
...
T_8 V_295 = V_12 -> V_36 . V_197 . V_234 [ V_102 ] ;
F_162 ( F_261 ( V_295 ) ) ;
if ( V_12 -> V_36 . V_197 . V_219 == V_233 ) {
V_299 = V_12 -> V_36 . V_197 . V_304 ( V_12 , V_102 ) ;
if ( ! ( V_299 & V_258 ) ) {
V_12 -> V_36 . V_197 . V_234 [ V_102 ] = 0 ;
continue;
}
V_297 = V_299 >> V_19 ;
if ( F_288 ( V_12 , V_297 ) )
...
F_237 ( & V_12 -> V_106 -> V_211 ) ;
F_286 ( V_12 ) ;
V_49 = F_212 ( V_12 , V_297 , V_102 << 30 , V_220 ,
0 , V_265 ) ;
V_295 = F_36 ( V_49 -> V_133 ) ;
++ V_49 -> V_241 ;
F_238 ( & V_12 -> V_106 -> V_211 ) ;
V_12 -> V_36 . V_197 . V_234 [ V_102 ] = V_295 | V_300 ;
}
V_12 -> V_36 . V_197 . V_230 = F_36 ( V_12 -> V_36 . V_197 . V_234 ) ;
if ( V_12 -> V_36 . V_197 . V_231 == V_232 ) {
if ( V_12 -> V_36 . V_197 . V_305 == NULL ) {
T_1 * V_305 ;
V_305 = ( void * ) F_292 ( V_77 ) ;
if ( V_305 == NULL )
return 1 ;
V_305 [ 0 ] = F_36 ( V_12 -> V_36 . V_197 . V_234 ) | V_300 ;
V_12 -> V_36 . V_197 . V_305 = V_305 ;
}
V_12 -> V_36 . V_197 . V_230 = F_36 ( V_12 -> V_36 . V_197 . V_305 ) ;
}
return 0 ;
}
...
static bool F_300 ( struct V_320 * V_197 , T_1 V_44 , int V_41 )
{
return F_299 ( & V_197 -> V_321 , V_44 , V_41 ) ;
}
static bool F_301 ( struct V_320 * V_197 , T_1 V_10 , int V_41 )
{
return F_299 ( & V_197 -> V_322 , V_10 , V_41 ) ;
}
static bool F_302 ( struct V_11 * V_12 , T_1 V_228 , bool V_92 )
{
if ( V_92 )
return F_303 ( V_12 , V_228 ) ;
return F_304 ( V_12 , V_228 ) ;
}
static bool
F_305 ( struct V_11 * V_12 , T_1 V_228 , T_1 * V_14 )
{
struct V_227 V_151 ;
T_1 V_126 [ V_232 ] , V_10 = 0ull ;
int V_295 , V_323 ;
bool V_324 = false ;
if ( ! F_261 ( V_12 -> V_36 . V_197 . V_230 ) )
goto exit;
F_53 ( V_12 ) ;
for ( F_217 ( & V_151 , V_12 , V_228 ) ,
...
if ( ! F_22 ( V_10 ) )
break;
V_324 |= F_301 ( & V_12 -> V_36 . V_197 , V_10 ,
V_151 . V_41 ) ;
}
F_56 ( V_12 ) ;
if ( V_324 ) {
...
int F_306 ( struct V_11 * V_12 , T_1 V_228 , bool V_92 )
{
T_1 V_10 ;
bool V_324 ;
if ( F_302 ( V_12 , V_228 , V_92 ) )
return V_325 ;
V_324 = F_305 ( V_12 , V_228 , & V_10 ) ;
if ( F_3 ( V_324 ) )
return V_326 ;
if ( F_10 ( V_10 ) ) {
T_2 V_15 = F_11 ( V_10 ) ;
...
if ( V_92 )
V_228 = 0 ;
F_307 ( V_228 , V_15 , V_16 ) ;
F_276 ( V_12 , V_228 , V_15 , V_16 ) ;
return V_325 ;
}
return V_328 ;
}
...
static void F_309 ( struct V_11 * V_12 , T_6 V_228 )
{
struct V_227 V_151 ;
T_1 V_10 ;
if ( ! F_261 ( V_12 -> V_36 . V_197 . V_230 ) )
...
static int F_310 ( struct V_11 * V_12 , T_6 V_183 ,
T_4 V_288 , bool V_263 )
{
T_2 V_15 = V_183 >> V_19 ;
int V_81 ;
F_240 ( L_28 , V_144 , V_183 , V_288 ) ;
if ( F_308 ( V_12 , V_288 , V_15 ) )
return 1 ;
V_81 = F_69 ( V_12 ) ;
if ( V_81 )
return V_81 ;
F_162 ( ! F_261 ( V_12 -> V_36 . V_197 . V_230 ) ) ;
return F_283 ( V_12 , V_183 & V_20 ,
V_288 , V_15 , V_263 ) ;
}
static int F_311 ( struct V_11 * V_12 , T_6 V_183 , T_2 V_15 )
{
struct V_329 V_36 ;
V_36 . V_330 = ( V_12 -> V_36 . V_331 . V_332 ++ << 12 ) | V_12 -> V_333 ;
V_36 . V_15 = V_15 ;
V_36 . V_218 = V_12 -> V_36 . V_197 . V_218 ;
V_36 . V_334 = V_12 -> V_36 . V_197 . V_301 ( V_12 ) ;
return F_312 ( V_12 , V_183 , F_267 ( V_12 , V_15 ) , & V_36 ) ;
}
...
static bool F_284 ( struct V_11 * V_12 , bool V_263 , T_2 V_15 ,
T_6 V_183 , T_3 * V_21 , bool V_261 , bool * V_336 )
{
struct V_96 * V_97 ;
bool V_337 ;
V_97 = F_90 ( V_12 , V_15 ) ;
V_337 = false ;
* V_21 = F_316 ( V_97 , V_15 , false , & V_337 , V_261 , V_336 ) ;
if ( ! V_337 )
return false ;
if ( ! V_263 && F_313 ( V_12 ) ) {
F_317 ( V_183 , V_15 ) ;
...
F_193 ( V_338 , V_12 ) ;
return true ;
} else if ( F_311 ( V_12 , V_183 , V_15 ) )
return true ;
}
* V_21 = F_316 ( V_97 , V_15 , false , NULL , V_261 , V_336 ) ;
return false ;
}
static bool
...
static int F_322 ( struct V_11 * V_12 , T_6 V_340 , T_4 V_288 ,
bool V_263 )
{
T_3 V_21 ;
int V_81 ;
...
if ( F_280 ( V_12 , V_340 , V_41 , V_288 ) )
return 0 ;
V_293 = V_12 -> V_106 -> V_171 ;
F_38 () ;
if ( F_284 ( V_12 , V_263 , V_15 , V_340 , & V_21 , V_261 , & V_262 ) )
return 0 ;
if ( F_274 ( V_12 , 0 , V_15 , V_21 , V_265 , & V_81 ) )
return V_81 ;
F_237 ( & V_12 -> V_106 -> V_211 ) ;
if ( F_285 ( V_12 -> V_106 , V_293 ) )
goto V_294;
...
struct V_310 * V_347 )
{
V_12 -> V_36 . V_197 . F_326 ( V_12 , V_347 ) ;
}
...
static inline bool F_328 ( struct V_320 * V_197 ,
unsigned V_41 , unsigned V_44 )
{
V_44 |= V_41 - V_42 - 1 ;
V_44 &= V_41 - V_197 -> V_349 ;
return V_44 & V_40 ;
}
static void
...
{
bool V_358 = V_341 -> V_346 || V_341 -> V_217 . V_359 ;
...
for ( V_365 = 0 ; V_365 < F_60 ( V_197 -> V_380 ) ; ++ V_365 ) {
V_366 = V_365 << 1 ;
V_367 = 0 ;
V_371 = V_366 & V_291 ;
V_372 = V_366 & V_381 ;
...
static void F_348 ( struct V_11 * V_12 , struct V_320 * V_197 ,
bool V_363 )
{
unsigned V_364 ;
bool V_383 ;
...
V_383 = F_347 ( V_12 ) ;
for ( V_364 = 0 ; V_364 < F_60 ( V_197 -> V_380 ) ; ++ V_364 ) {
...
V_386 = ! ! V_387 ;
V_386 |= ( ! ! V_388 ) << 1 ;
V_197 -> V_384 |= ( V_386 & 3 ) << V_366 ;
}
}
static void F_350 ( struct V_11 * V_12 , struct V_320 * V_197 )
{
unsigned V_219 = V_197 -> V_219 ;
V_197 -> V_349 = V_219 ;
if ( V_219 == V_220 && F_334 ( V_12 ) )
V_197 -> V_349 ++ ;
}
...
struct V_320 * V_341 )
{
F_351 ( V_12 , V_341 , V_233 ) ;
}
static void F_355 ( struct V_11 * V_12 )
{
struct V_320 * V_341 = & V_12 -> V_36 . V_197 ;
V_341 -> V_217 . V_223 = 0 ;
V_341 -> V_217 . V_400 = F_356 ( V_12 ) ;
V_341 -> V_342 = F_322 ;
V_341 -> V_198 = F_176 ;
V_341 -> V_344 = F_177 ;
V_341 -> V_345 = F_178 ;
V_341 -> V_231 = V_120 -> V_401 () ;
V_341 -> V_230 = V_296 ;
V_341 -> V_218 = true ;
...
F_353 ( V_12 , V_341 ) ;
V_341 -> V_217 . V_407 = F_21 ( V_12 ) ;
V_341 -> V_217 . V_196 = ! ! F_188 ( V_12 ) ;
V_341 -> V_217 . V_408 = F_347 ( V_12 ) ;
V_341 -> V_217 . V_359
= V_406 && ! F_347 ( V_12 ) ;
V_341 -> V_217 . V_409
= V_377 && ! F_347 ( V_12 ) ;
...
if ( V_81 )
goto V_85;
V_12 -> V_36 . V_197 . V_402 ( V_12 , V_12 -> V_36 . V_197 . V_230 ) ;
V_85:
return V_81 ;
}
...
{
F_287 ( V_12 ) ;
F_3 ( F_261 ( V_12 -> V_36 . V_197 . V_230 ) ) ;
}
...
V_12 -> V_36 . V_197 . V_345 ( V_12 , V_49 , V_10 , V_418 ) ;
}
...
F_240 ( L_29 ,
V_340 , V_423 , V_49 -> V_91 . V_223 ) ;
V_425 = F_375 ( V_340 ) ;
V_426 = V_49 -> V_91 . V_196 ? 8 : 4 ;
...
if ( V_424 &&
! ( ( V_49 -> V_91 . V_223 ^ V_12 -> V_36 . V_197 . V_217 . V_223 )
& V_4 . V_223 ) && F_106 ( V_12 ) )
...
F_190 ( V_12 , & V_195 , V_199 , V_200 ) ;
F_194 ( V_12 , V_435 ) ;
F_238 ( & V_12 -> V_106 -> V_211 ) ;
}
int F_378 ( struct V_11 * V_12 , T_6 V_183 )
{
T_9 V_340 ;
int V_81 ;
if ( V_12 -> V_36 . V_197 . V_218 )
return 0 ;
V_340 = F_379 ( V_12 , V_183 , NULL ) ;
...
{
F_204 ( V_195 ) ;
if ( F_18 ( F_380 ( V_12 -> V_106 ) >= V_436 ) )
return;
while ( F_380 ( V_12 -> V_106 ) < V_437 ) {
if ( ! F_234 ( V_12 -> V_106 , & V_195 ) )
break;
++ V_12 -> V_106 -> V_137 . V_438 ;
}
F_192 ( V_12 -> V_106 , & V_195 ) ;
}
int F_381 ( struct V_11 * V_12 , T_6 V_439 , T_4 V_288 ,
void * V_440 , int V_441 )
{
int V_81 , V_442 = V_443 ;
enum V_444 V_445 ;
bool V_92 = V_12 -> V_36 . V_197 . V_218 || F_363 ( V_12 ) ;
if ( F_14 ( V_288 & V_289 ) ) {
V_81 = F_306 ( V_12 , V_439 , V_92 ) ;
if ( V_81 == V_325 ) {
V_442 = 0 ;
goto V_257;
}
...
V_81 = V_12 -> V_36 . V_197 . V_342 ( V_12 , V_439 , V_288 , false ) ;
if ( V_81 < 0 )
return V_81 ;
if ( ! V_81 )
return 1 ;
if ( F_302 ( V_12 , V_439 , V_92 ) )
V_442 = 0 ;
V_257:
V_445 = F_382 ( V_12 , V_439 , V_442 , V_440 , V_441 ) ;
switch ( V_445 ) {
case V_446 :
return 1 ;
case V_447 :
...
void F_383 ( struct V_11 * V_12 , T_6 V_183 )
{
V_12 -> V_36 . V_197 . V_344 ( V_12 , V_183 ) ;
F_193 ( V_201 , V_12 ) ;
++ V_12 -> V_137 . V_344 ;
}
void F_384 ( void )
...
static void F_386 ( struct V_11 * V_12 )
{
F_68 ( ( unsigned long ) V_12 -> V_36 . V_197 . V_234 ) ;
if ( V_12 -> V_36 . V_197 . V_305 != NULL )
F_68 ( ( unsigned long ) V_12 -> V_36 . V_197 . V_305 ) ;
}
static int F_387 ( struct V_11 * V_12 )
{
struct V_80 * V_80 ;
int V_102 ;
V_80 = F_388 ( V_77 | V_450 ) ;
if ( ! V_80 )
return - V_78 ;
V_12 -> V_36 . V_197 . V_234 = F_389 ( V_80 ) ;
for ( V_102 = 0 ; V_102 < 4 ; ++ V_102 )
V_12 -> V_36 . V_197 . V_234 [ V_102 ] = V_296 ;
return 0 ;
}
int F_390 ( struct V_11 * V_12 )
{
V_12 -> V_36 . V_451 = & V_12 -> V_36 . V_197 ;
V_12 -> V_36 . V_197 . V_230 = V_296 ;
V_12 -> V_36 . V_197 . V_313 = V_313 ;
V_12 -> V_36 . V_312 . V_313 = V_452 ;
return F_387 ( V_12 ) ;
}
void F_391 ( struct V_11 * V_12 )
{
F_162 ( F_261 ( V_12 -> V_36 . V_197 . V_230 ) ) ;
F_362 ( V_12 ) ;
}
void F_392 ( struct V_106 * V_106 )
{
struct V_453 * V_454 = & V_106 -> V_36 . V_455 ;
V_454 -> V_456 = F_377 ;
F_393 ( V_106 , V_454 ) ;
}
void F_394 ( struct V_106 * V_106 )
{
struct V_453 * V_454 = & V_106 -> V_36 . V_455 ;
F_395 ( V_106 , V_454 ) ;
}
static bool
F_396 ( struct V_106 * V_106 , struct V_96 * V_159 ,
T_11 V_457 , int V_155 , int V_156 ,
T_2 V_152 , T_2 V_154 , bool V_458 )
{
struct V_150 V_151 ;
bool V_140 = false ;
...
end_gfn, &iterator) {
if ( V_151 . V_132 )
V_140 |= V_457 ( V_106 , V_151 . V_132 ) ;
if ( F_206 () || F_207 ( & V_106 -> V_211 ) ) {
if ( V_140 && V_458 ) {
F_114 ( V_106 ) ;
V_140 = false ;
}
...
static bool
F_397 ( struct V_106 * V_106 , struct V_96 * V_159 ,
T_11 V_457 , int V_155 , int V_156 ,
bool V_458 )
{
return F_396 ( V_106 , V_159 , V_457 , V_155 ,
V_156 , V_159 -> V_99 ,
V_159 -> V_99 + V_159 -> V_166 - 1 ,
V_458 ) ;
}
static bool
F_398 ( struct V_106 * V_106 , struct V_96 * V_159 ,
T_11 V_457 , bool V_458 )
{
return F_397 ( V_106 , V_159 , V_457 , V_42 ,
V_104 , V_458 ) ;
}
static bool
F_399 ( struct V_106 * V_106 , struct V_96 * V_159 ,
T_11 V_457 , bool V_458 )
{
return F_397 ( V_106 , V_159 , V_457 , V_42 + 1 ,
V_104 , V_458 ) ;
}
static bool
...
void F_401 ( struct V_106 * V_106 , T_2 V_163 , T_2 V_164 )
{
struct V_107 * V_108 ;
struct V_96 * V_159 ;
int V_102 ;
...
static bool F_402 ( struct V_106 * V_106 ,
struct V_122 * V_123 )
{
return F_116 ( V_106 , V_123 , false ) ;
}
void F_403 ( struct V_106 * V_106 ,
struct V_96 * V_159 )
{
bool V_140 ;
F_237 ( & V_106 -> V_211 ) ;
V_140 = F_398 ( V_106 , V_159 , F_402 ,
false ) ;
F_238 ( & V_106 -> V_211 ) ;
F_404 ( & V_106 -> V_459 ) ;
if ( V_140 )
...
static bool F_405 ( struct V_106 * V_106 ,
struct V_122 * V_123 )
{
T_1 * V_14 ;
struct V_134 V_135 ;
...
void F_406 ( struct V_106 * V_106 ,
const struct V_96 * V_159 )
{
F_237 ( & V_106 -> V_211 ) ;
F_400 ( V_106 , (struct V_96 * ) V_159 ,
F_405 , true ) ;
F_238 ( & V_106 -> V_211 ) ;
}
...
bool V_140 ;
F_237 ( & V_106 -> V_211 ) ;
V_140 = F_400 ( V_106 , V_159 , F_119 , false ) ;
F_238 ( & V_106 -> V_211 ) ;
F_404 ( & V_106 -> V_459 ) ;
if ( V_140 )
F_114 ( V_106 ) ;
}
void F_408 ( struct V_106 * V_106 ,
struct V_96 * V_159 )
{
bool V_140 ;
F_237 ( & V_106 -> V_211 ) ;
V_140 = F_399 ( V_106 , V_159 , F_402 ,
false ) ;
F_238 ( & V_106 -> V_211 ) ;
F_404 ( & V_106 -> V_459 ) ;
if ( V_140 )
...
void F_409 ( struct V_106 * V_106 ,
struct V_96 * V_159 )
{
bool V_140 ;
F_237 ( & V_106 -> V_211 ) ;
V_140 = F_398 ( V_106 , V_159 , F_121 , false ) ;
F_238 ( & V_106 -> V_211 ) ;
F_404 ( & V_106 -> V_459 ) ;
if ( V_140 )
F_114 ( V_106 ) ;
}
static void F_410 ( struct V_106 * V_106 )
{
struct V_48 * V_49 , * V_454 ;
int V_461 = 0 ;
V_149:
F_411 (sp, node,
...
static bool F_414 ( struct V_106 * V_106 )
{
return F_14 ( ! F_415 ( & V_106 -> V_36 . V_463 ) ) ;
}
void F_416 ( struct V_106 * V_106 , struct V_107 * V_108 )
{
...
F_418 ( struct V_465 * V_466 , struct V_467 * V_468 )
{
struct V_106 * V_106 ;
int V_469 = V_468 -> V_469 ;
unsigned long V_470 = 0 ;
F_237 ( & V_471 ) ;
F_419 (kvm, &vm_list, vm_list) {
int V_98 ;
F_204 ( V_195 ) ;
if ( ! V_469 -- )
break;
...
V_473:
F_238 ( & V_106 -> V_211 ) ;
F_421 ( & V_106 -> V_472 , V_98 ) ;
F_422 ( & V_106 -> V_474 , & V_474 ) ;
break;
}
F_238 ( & V_471 ) ;
return V_470 ;
...
static unsigned long
F_423 ( struct V_465 * V_466 , struct V_467 * V_468 )
{
return F_424 ( & V_174 ) ;
}
...
unsigned int F_431 ( struct V_106 * V_106 )
{
unsigned int V_477 ;
...
V_477 = V_478 * V_479 / 1000 ;
V_477 = F_143 ( V_477 ,
( unsigned int ) V_480 ) ;
return V_477 ;
}
void F_432 ( struct V_11 * V_12 )
{
F_365 ( V_12 ) ;
F_386 ( V_12 ) ;
F_70 ( V_12 ) ;
