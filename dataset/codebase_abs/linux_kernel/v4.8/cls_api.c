...
V_23 = & V_24 -> V_25 )
F_16 ( V_15 , V_17 , V_19 , V_24 , 0 , V_22 ) ;
}
...
F_37 ( * V_40 , V_25 ) ;
F_16 ( V_15 , V_28 , V_19 , V_24 , V_45 , V_56 ) ;
F_38 ( V_24 , true ) ;
V_46 = 0 ;
goto V_71;
}
...
goto V_71;
case V_49 :
V_46 = F_16 ( V_15 , V_28 , V_19 , V_24 , V_45 , V_59 ) ;
goto V_71;
default:
V_46 = - V_66 ;
goto V_71;
...
F_16 ( V_15 , V_28 , V_19 , V_24 , V_45 , V_59 ) ;
} else {
if ( V_47 )
F_38 ( V_24 , true ) ;
}
...
unsigned long V_45 , int V_22 )
{
struct V_16 * V_28 ;
T_2 V_86 = V_17 ? F_46 ( V_17 ) . V_86 : 0 ;
V_28 = F_47 ( V_102 , V_73 ) ;
if ( ! V_28 )
return - V_72 ;
if ( F_40 ( V_15 , V_28 , V_24 , V_45 , V_86 , V_19 -> V_103 , 0 , V_22 ) <= 0 ) {
F_48 ( V_28 ) ;
return - V_66 ;
}
return F_49 ( V_28 , V_15 , V_86 , V_104 ,
V_19 -> V_60 & V_105 ) ;
}
static int F_50 ( struct V_20 * V_24 , unsigned long V_19 ,
struct V_106 * V_107 )
{
struct V_108 * V_109 = ( void * ) V_107 ;
struct V_15 * V_15 = F_20 ( V_109 -> V_28 -> V_29 ) ;
return F_40 ( V_15 , V_109 -> V_28 , V_24 , V_19 , F_46 ( V_109 -> V_110 -> V_28 ) . V_86 ,
V_109 -> V_110 -> V_90 -> V_103 , V_111 , V_59 ) ;
}
static int F_51 ( struct V_16 * V_28 , struct V_112 * V_110 )
{
struct V_15 * V_15 = F_20 ( V_28 -> V_29 ) ;
int V_4 ;
int V_113 ;
...
struct V_32 * V_89 = F_23 ( V_110 -> V_90 ) ;
unsigned long V_44 = 0 ;
const struct V_42 * V_43 ;
struct V_108 V_107 ;
if ( V_100 ( V_110 -> V_90 ) < sizeof( * V_89 ) )
return V_28 -> V_101 ;
...
continue;
if ( V_4 > V_113 )
memset ( & V_110 -> args [ 1 ] , 0 ,
sizeof( V_110 -> args ) - sizeof( V_110 -> args [ 0 ] ) ) ;
if ( V_110 -> args [ 1 ] == 0 ) {
if ( F_40 ( V_15 , V_28 , V_24 , 0 ,
F_46 ( V_110 -> V_28 ) . V_86 ,
V_110 -> V_90 -> V_103 , V_111 ,
V_59 ) <= 0 )
break;
V_110 -> args [ 1 ] = 1 ;
}
if ( V_24 -> V_8 -> V_114 == NULL )
continue;
V_107 . V_115 . V_116 = F_50 ;
V_107 . V_28 = V_28 ;
V_107 . V_110 = V_110 ;
V_107 . V_115 . V_117 = 0 ;
V_107 . V_115 . V_118 = V_110 -> args [ 1 ] - 1 ;
V_107 . V_115 . V_119 = 0 ;
V_24 -> V_8 -> V_114 ( V_24 , & V_107 . V_115 ) ;
...
int F_57 ( struct V_15 * V_15 , struct V_20 * V_24 , struct V_2 * * V_125 ,
struct V_2 * V_126 , struct V_120 * V_121 , bool V_127 )
{
#ifdef F_53
{
struct V_128 * V_129 ;
if ( V_121 -> V_130 && V_125 [ V_121 -> V_130 ] ) {
V_129 = F_58 ( V_15 , V_125 [ V_121 -> V_130 ] , V_126 ,
L_2 , V_127 ,
V_131 ) ;
if ( F_59 ( V_129 ) )
return F_60 ( V_129 ) ;
V_129 -> type = V_121 -> type = V_132 ;
V_121 -> V_122 [ 0 ] = V_129 ;
V_121 -> V_124 = 1 ;
} else if ( V_121 -> V_133 && V_125 [ V_121 -> V_133 ] ) {
F_54 ( V_122 ) ;
int V_46 , V_134 = 0 ;
V_46 = F_61 ( V_15 , V_125 [ V_121 -> V_133 ] , V_126 ,
NULL , V_127 ,
V_131 , & V_122 ) ;
if ( V_46 )
return V_46 ;
F_3 (act, &actions, list)
V_121 -> V_122 [ V_134 ++ ] = V_129 ;
V_121 -> V_124 = V_134 ;
}
}
#else
if ( ( V_121 -> V_133 && V_125 [ V_121 -> V_133 ] ) ||
( V_121 -> V_130 && V_125 [ V_121 -> V_130 ] ) )
return - V_69 ;
#endif
return 0 ;
}
void F_62 ( struct V_20 * V_24 , struct V_120 * V_135 ,
struct V_120 * V_136 )
{
#ifdef F_53
struct V_120 V_137 = * V_135 ;
F_63 ( V_24 ) ;
V_135 -> V_124 = V_136 -> V_124 ;
V_135 -> V_122 = V_136 -> V_122 ;
V_135 -> type = V_136 -> type ;
F_64 ( V_24 ) ;
F_52 ( & V_137 ) ;
#endif
}
static struct V_128 * F_65 ( struct V_120 * V_121 )
{
if ( V_121 -> V_124 == 0 )
return NULL ;
else
return V_121 -> V_122 [ 0 ] ;
}
int F_66 ( struct V_16 * V_28 , struct V_120 * V_121 )
{
#ifdef F_53
struct V_2 * V_138 ;
if ( V_121 -> V_133 && V_121 -> V_124 ) {
if ( V_121 -> type != V_132 ) {
F_54 ( V_122 ) ;
V_138 = F_67 ( V_28 , V_121 -> V_133 ) ;
if ( V_138 == NULL )
goto V_98;
F_55 ( V_121 , & V_122 ) ;
if ( F_68 ( V_28 , & V_122 , 0 , 0 ) < 0 )
goto V_98;
F_69 ( V_28 , V_138 ) ;
} else if ( V_121 -> V_130 ) {
struct V_128 * V_129 = F_65 ( V_121 ) ;
V_138 = F_67 ( V_28 , V_121 -> V_130 ) ;
if ( V_138 == NULL || ! V_129 )
goto V_98;
if ( F_70 ( V_28 , V_129 , 0 , 0 ) < 0 )
goto V_98;
F_69 ( V_28 , V_138 ) ;
}
}
...
int F_72 ( struct V_16 * V_28 , struct V_120 * V_121 )
{
#ifdef F_53
struct V_128 * V_109 = F_65 ( V_121 ) ;
if ( V_109 != NULL && F_73 ( V_28 , V_109 , 1 ) < 0 )
return - 1 ;
#endif
return 0 ;
}
...
{
F_75 ( V_139 , V_59 , F_19 , NULL , NULL ) ;
F_75 ( V_139 , V_56 , F_19 , NULL , NULL ) ;
F_75 ( V_139 , V_49 , F_19 ,
F_51 , NULL ) ;
return 0 ;
}
