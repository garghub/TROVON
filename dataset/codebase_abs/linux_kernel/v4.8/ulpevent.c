...
T_1 F_45 ( const struct V_1 * V_2 )
{
union V_143 * V_144 ;
struct V_8 * V_9 ;
V_9 = F_8 ( V_2 ) ;
V_144 = (union V_143 * ) V_9 -> V_58 ;
return V_144 -> V_145 . V_146 ;
}
void F_46 ( const struct V_1 * V_2 ,
struct V_147 * V_147 )
{
struct V_75 V_74 ;
if ( F_5 ( V_2 ) )
...
V_74 . V_148 = V_2 -> V_110 ;
V_74 . V_149 = V_2 -> V_111 ;
V_74 . V_150 = V_2 -> V_112 ;
V_74 . V_76 = V_2 -> V_21 ;
V_74 . V_151 = V_2 -> V_106 ;
V_74 . V_152 = V_2 -> V_115 ;
V_74 . V_153 = F_20 ( V_2 -> V_14 ) ;
V_74 . V_154 = V_2 -> V_14 -> V_155 ;
V_74 . V_156 = 0 ;
F_47 ( V_147 , V_157 , V_158 ,
sizeof( V_74 ) , & V_74 ) ;
}
void F_48 ( const struct V_1 * V_2 ,
struct V_147 * V_147 )
{
struct V_159 V_160 ;
if ( F_5 ( V_2 ) )
...
V_160 . V_161 = V_2 -> V_110 ;
V_160 . V_162 = V_2 -> V_111 ;
V_160 . V_163 = V_2 -> V_112 ;
V_160 . V_164 = V_2 -> V_21 ;
V_160 . V_165 = V_2 -> V_106 ;
V_160 . V_166 = V_2 -> V_115 ;
V_160 . V_167 = F_20 ( V_2 -> V_14 ) ;
V_160 . V_168 = V_2 -> V_14 -> V_155 ;
F_47 ( V_147 , V_157 , V_169 ,
sizeof( V_160 ) , & V_160 ) ;
}
...
V_171 . V_173 = V_2 -> V_112 ;
V_171 . V_174 = V_2 -> V_21 ;
if ( F_5 ( V_2 ) )
V_171 . V_174 |= V_175 ;
V_171 . V_176 = V_9 -> V_4 ;
V_171 . V_177 = F_20 ( V_2 -> V_14 ) ;
F_47 ( V_147 , V_157 , V_178 ,
sizeof( V_171 ) , & V_171 ) ;
}
...
unsigned int F_59 ( struct V_185 * V_186 )
{
struct V_8 * V_9 ;
unsigned int V_187 = 0 ;
while ( ( V_9 = F_60 ( V_186 ) ) != NULL ) {
