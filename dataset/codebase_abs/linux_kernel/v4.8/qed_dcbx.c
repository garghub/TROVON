...
static void F_51 ( struct V_203 * V_24 ,
struct V_23 * V_204 ,
enum V_25 type )
{
...
V_52 ) ;
V_210 = & V_209 -> V_218 ;
F_51 ( V_210 , V_204 , V_50 ) ;
V_210 = & V_209 -> V_219 ;
F_51 ( V_210 , V_204 , V_51 ) ;
}
...
V_70 -> V_155 [ V_27 ] = F_60 ( V_70 -> V_155 [ V_27 ] ) ;
...
V_260 = F_47 ( sizeof( * V_260 ) , V_200 ) ;
if ( ! V_260 ) {
F_17 ( V_262 -> V_221 , L_19 ) ;
return NULL ;
}
if ( F_53 ( V_262 , V_260 , type ) ) {
F_50 ( V_260 ) ;
return NULL ;
}
if ( ( type == V_188 ) &&
...
struct V_21 * V_262 = F_70 ( V_221 ) ;
struct V_161 * V_260 ;
F_12 ( V_262 , V_28 , L_22 , V_36 ) ;
* V_267 = * V_268 = * V_269 = * V_270 = 0 ;
if ( V_36 < 0 || V_36 >= V_157 ) {
F_68 ( V_262 , L_23 , V_36 ) ;
return;
}
V_260 = F_67 ( V_262 , V_188 ) ;
if ( ! V_260 )
...
struct V_161 * V_260 ;
* V_269 = 0 ;
F_12 ( V_262 , V_28 , L_24 , V_268 ) ;
if ( V_268 < 0 || V_268 >= V_157 ) {
F_68 ( V_262 , L_25 , V_268 ) ;
return;
}
V_260 = F_67 ( V_262 , V_188 ) ;
if ( ! V_260 )
...
struct V_21 * V_262 = F_70 ( V_221 ) ;
struct V_161 * V_260 ;
F_12 ( V_262 , V_28 , L_28 , V_35 ) ;
if ( V_35 < 0 || V_35 >= V_157 ) {
F_68 ( V_262 , L_29 , V_35 ) ;
return;
}
V_260 = F_67 ( V_262 , V_188 ) ;
if ( ! V_260 )
...
F_12 ( V_262 , V_28 , L_33 , V_273 , * V_274 ) ;
F_50 ( V_260 ) ;
return V_73 ;
}
...
struct V_86 * V_266 ;
int V_73 ;
F_12 ( V_262 , V_28 , L_39 , V_268 , V_269 ) ;
if ( V_268 < 0 || V_268 >= V_157 ) {
F_68 ( V_262 , L_25 , V_268 ) ;
return;
}
...
struct V_86 * V_266 ;
int V_73 ;
F_12 ( V_262 , V_28 , L_40 , V_285 , V_286 ) ;
memset ( & V_265 , 0 , sizeof( V_265 ) ) ;
V_73 = F_66 ( V_262 , & V_265 ) ;
if ( V_73 )
return 1 ;
...
break;
default:
F_68 ( V_262 , L_48 , V_295 ) ;
F_50 ( V_260 ) ;
return 1 ;
}
F_12 ( V_262 , V_28 , L_49 , * V_71 ) ;
F_50 ( V_260 ) ;
return 0 ;
}
...
V_129 -> V_311 |= F_58 ( V_27 ) ;
V_129 -> V_312 = V_260 -> V_168 . V_162 . V_129 . V_133 ;
F_12 ( V_262 , V_28 , L_51 ,
...
F_12 ( V_262 , V_28 , L_52 , V_314 -> V_131 ) ;
F_50 ( V_260 ) ;
return 0 ;
}
...
V_265 . V_250 |= V_251 ;
for ( V_27 = 0 ; V_27 < V_157 ; V_27 ++ )
V_265 . V_248 . V_162 . V_129 . V_41 [ V_27 ] = ! ! ( V_129 -> V_311 & F_58 ( V_27 ) ) ;
V_266 = F_55 ( V_262 ) ;
if ( ! V_266 )
return - V_65 ;
V_73 = F_63 ( V_262 , V_266 , & V_265 , 0 ) ;
...
int F_104 ( struct V_263 * V_221 , struct V_319 * V_80 )
{
return F_101 ( V_221 , V_80 , true ) ;
}
int F_105 ( struct V_263 * V_221 , struct V_317 * V_129 )
{
return F_98 ( V_221 , V_129 , true ) ;
}
int F_106 ( struct V_263 * V_221 , struct V_305 * V_78 )
{
struct V_21 * V_262 = F_70 ( V_221 ) ;
struct V_161 * V_260 ;
struct V_112 * V_62 ;
...
int F_107 ( struct V_263 * V_221 , struct V_305 * V_78 )
{
struct V_21 * V_262 = F_70 ( V_221 ) ;
struct V_161 * V_260 ;
struct V_247 V_265 ;
...
V_265 . V_248 . V_162 . V_122 [ V_27 ] . V_41 = F_58 ( V_78 -> V_35 ) ;
V_266 = F_55 ( V_262 ) ;
if ( ! V_266 )
return - V_222 ;
V_73 = F_63 ( V_262 , V_266 , & V_265 , 0 ) ;
