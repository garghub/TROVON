...
int V_43 = 0 ;
struct V_36 * V_284 ;
V_284 = F_16 ( sizeof( struct V_36 ) , V_107 ) ;
if ( V_284 == NULL )
return - V_109 ;
V_7 -> V_37 = V_284 ;
V_43 = F_9 ( V_7 ) ;
...
if ( V_309 )
return V_263 -> V_312 [ 0 ] . V_159 ;
else
return V_263 -> V_312 [ V_263 -> V_198 - 1 ] . V_159 ;
}
...
V_263 -> V_312 [ V_315 ] . V_159 = V_22 -> V_17 [ V_318 ] . V_26 ;
V_263 -> V_312 [ V_315 ] . V_160 = ( T_5 ) V_22 -> V_17 [ V_318 ] . V_100 ;
V_263 -> V_198 = V_315 + 1 ;
if ( F_38 ( V_7 -> V_65 . V_66 , V_69 ) ) {
V_263 -> V_312 [ V_315 ] . V_161 = 5 ;
V_263 -> V_312 [ V_315 ] . V_162 = 5 ;
}
return 0 ;
}
...
V_263 -> V_320 . V_196 = V_310 -> V_320 . V_322 ;
return V_43 ;
}
...
static void
F_84 ( struct V_6 * V_7 , struct V_323 * V_324 )
{
struct V_36 * V_36 = (struct V_36 * ) ( V_7 -> V_37 ) ;
struct V_21 * V_22 =
V_7 -> V_12 . V_23 ;
...
struct V_29 * V_182 =
V_7 -> V_12 . V_30 ;
T_1 V_325 = F_85 ( F_86 ( V_7 -> V_90 , V_326 , V_327 ) ,
V_328 , V_329 ) ;
T_1 V_330 = F_85 ( F_86 ( V_7 -> V_90 , V_326 , V_331 ) ,
V_332 , V_333 ) ;
T_1 V_334 = F_85 ( F_86 ( V_7 -> V_90 , V_326 , V_331 ) ,
V_332 , V_335 ) ;
T_1 V_98 , V_33 , V_196 , V_18 , V_336 , V_337 ;
T_2 V_338 , V_339 ;
int V_43 ;
if ( V_325 >= V_340 ) {
F_87 ( V_324 , L_20 , V_325 ) ;
} else {
V_98 = V_22 -> V_17 [ V_325 ] . V_26 ;
F_87 ( V_324 , L_21 , V_325 , V_98 / 100 ) ;
}
V_336 = ( F_86 ( V_7 -> V_90 , V_326 , V_341 ) &
V_342 ) >> V_343 ;
V_338 = F_13 ( V_7 , V_336 ) ;
V_336 = ( F_86 ( V_7 -> V_90 , V_326 , V_344 ) &
V_345 ) >> V_346 ;
V_339 = F_13 ( V_7 , ( V_347 ) V_336 ) ;
F_87 ( V_324 , L_22 , V_338 , V_339 ) ;
F_87 ( V_324 , L_23 , V_36 -> V_210 ? L_24 : L_25 ) ;
if ( ! V_36 -> V_210 ) {
if ( V_330 >= V_46 ) {
F_87 ( V_324 , L_26 , V_330 ) ;
} else {
V_33 = V_182 -> V_17 [ V_330 ] . V_33 ;
V_196 = V_182 -> V_17 [ V_330 ] . V_196 ;
F_87 ( V_324 , L_27 , V_330 , V_33 / 100 , V_196 / 100 ) ;
}
}
F_87 ( V_324 , L_28 , V_36 -> V_211 ? L_24 : L_25 ) ;
if ( ! V_36 -> V_211 ) {
if ( V_334 >= V_46 ) {
F_87 ( V_324 , L_29 , V_334 ) ;
} else {
V_18 = V_183 -> V_17 [ V_334 ] . V_18 ;
F_87 ( V_324 , L_30 , V_334 , V_18 / 100 ) ;
}
}
V_43 = F_7 ( V_7 -> V_39 , V_348 ) ;
if ( 0 == V_43 ) {
V_337 = F_88 ( V_7 -> V_90 , V_349 ) ;
V_337 = V_337 > 100 ? 100 : V_337 ;
} else {
V_337 = 50 ;
}
F_87 ( V_324 , L_31 , V_337 ) ;
}
static void F_89 (
...
V_234 -> V_79 . V_247 = false ;
F_89 ( & V_234 -> V_79 ) ;
V_284 |= ( V_234 -> V_79 . V_83
& V_350 )
<< V_351 ;
V_284 |= ( V_234 -> V_79 . V_80 ? 0x1 : 0x0 )
<< V_352 ;
V_284 |= ( V_234 -> V_79 . V_81 ? 0x1 : 0x0 )
<< V_353 ;
F_40 ( L_37 ,
V_284 ) ;
F_37 ( V_7 -> V_39 ,
...
V_310 = F_2 ( V_370 ) ;
V_372 = V_315 > V_310 -> V_198 - 1 ? V_310 -> V_198 - 1 : V_315 ;
V_198 -> V_373 = V_310 -> V_312 [ V_372 ] . V_159 ;
if ( V_371 == V_374 ) {
for ( V_9 = 1 ; V_9 < V_310 -> V_198 ; V_9 ++ ) {
if ( V_310 -> V_312 [ V_9 ] . V_159 > V_284 -> V_62 ) {
V_198 -> V_373 = V_310 -> V_312 [ V_9 ] . V_159 ;
break;
}
}
}
if ( V_372 == 0 )
V_198 -> V_375 = V_284 -> V_42 . V_102 [ V_141 - 1 ] ;
else
V_198 -> V_375 = V_284 -> V_42 . V_102 [ 0 ] ;
V_198 -> V_99 = ( F_13 ( V_7 , V_310 -> V_312 [ V_372 ] . V_160 ) + 2 ) / 4 ;
V_198 -> V_376 = 0 ;
V_198 -> V_377 = 0 ;
return 0 ;
}
static int F_96 ( struct V_6 * V_7 ,
const struct V_2 * V_370 , struct V_378 * V_316 )
{
const struct V_1 * V_310 = F_2 ( V_370 ) ;
V_316 -> V_379 = V_310 -> V_312 [ 0 ] . V_159 / ( 1 << ( V_310 -> V_312 [ 0 ] . V_162 ) ) ;
V_316 -> V_380 = V_310 -> V_312 [ V_310 -> V_198 - 1 ] . V_159 / ( 1 << ( V_310 -> V_312 [ V_310 -> V_198 - 1 ] . V_162 ) ) ;
return 0 ;
}
...
V_267 -> clock [ V_9 ] = V_284 -> V_42 . V_146 [ V_9 ] ;
break;
case V_384 :
V_22 = V_7 -> V_12 . V_23 ;
for ( V_9 = 0 ; V_9 < V_267 -> V_16 ; V_9 ++ )
...
V_267 -> V_16 = V_141 ;
for ( V_9 = 0 ; V_9 < V_267 -> V_16 ; V_9 ++ )
V_267 -> clock [ V_9 ] = V_284 -> V_42 . V_102 [ V_267 -> V_16 - 1 - V_9 ] ;
break;
default:
return - 1 ;
}
