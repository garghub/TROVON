...
V_377 -> V_295 [ V_377 -> V_294 ] = F_156 ( V_349 ) ;
...
F_158 ( V_368 -> V_342 -> V_343 . V_190 , & V_392 ) ;
...
void F_159 ( const struct V_52 * V_388 , const struct V_52 * V_389 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
...
static void F_161 ( struct V_204 * V_205 )
{
T_2 V_201 , V_43 ;
T_3 V_49 ;
unsigned int V_202 ;
...
F_74 ( V_205 , F_163 ( V_203 , V_93 ) ) ;
F_164 ( V_205 , V_93 -> V_220 ) ;
}
...
F_70 ( V_205 , L_59 ,
V_400 , F_103 () , V_403 ,
F_167 () , F_168 ( V_93 ) , V_404 ) ;
F_75 ( V_205 ) ;
}
struct V_169 * F_169 ( void )
{
