...
F_6 ( 0x7 , V_62 ) ;
V_30 = V_2 -> V_46 -> V_34 -> V_80 [ 0 ] / 8 ;
F_9 ( V_81 , V_30 ) ;
V_30 = 0x22 ;
V_30 |= ( V_2 -> V_46 -> V_34 -> V_80 [ 0 ] >> 7 ) & 0x10 ;
V_30 |= ( V_2 -> V_46 -> V_34 -> V_80 [ 0 ] >> 6 ) & 0x40 ;
F_9 ( 0x1b , V_30 ) ;
F_7 ( V_82 , 0x40 ) ;
F_7 ( V_83 , 0x01 ) ;
F_21 ( V_63 ) ;
...
static int F_25 ( struct V_1 * V_2 , T_4 * V_84 , T_4 * V_85 ,
T_4 * V_86 , T_5 V_87 )
{
struct V_3 * V_3 = F_2 ( V_2 ) ;
int V_9 ;
...
void F_34 ( struct V_1 * V_2 , T_4 V_84 , T_4 V_85 ,
T_4 V_86 , int V_94 )
{
struct V_3 * V_3 = F_2 ( V_2 ) ;
V_3 -> V_14 [ V_94 ] = V_84 ;
...
static void F_37 ( struct V_95 * V_96 , int V_97 )
{
return;
}
...
{
struct V_98 * V_98 = F_41 ( V_96 ) ;
F_42 ( V_96 ) ;
F_28 ( V_98 ) ;
}
static struct V_95 * F_43 ( struct V_4 * V_5 )
{
struct V_95 * V_96 ;
struct V_98 * V_98 ;
...
static int F_46 ( struct V_89 * V_103 )
{
int V_104 ;
if ( V_105 <= 24 ) {
V_104 = F_47 ( V_103 , 1280 , 1024 ) ;
F_48 ( V_103 , 1024 , 768 ) ;
} else {
V_104 = F_47 ( V_103 , 800 , 600 ) ;
F_48 ( V_103 , 800 , 600 ) ;
}
return V_104 ;
}
static struct V_95 * F_49 ( struct V_89
* V_103 )
{
int V_106 = V_103 -> V_107 [ 0 ] ;
if ( V_106 )
return F_50 ( V_103 -> V_5 , V_106 ) ;
return NULL ;
}
static enum V_108 F_51 ( struct V_89
* V_103 , bool V_109 )
{
return V_110 ;
}
static void F_52 ( struct V_89 * V_103 )
{
F_53 ( V_103 ) ;
F_28 ( V_103 ) ;
}
static struct V_89 * F_54 ( struct V_4 * V_5 )
{
struct V_89 * V_103 ;
struct V_111 * V_111 ;
V_111 = F_30 ( sizeof( struct V_111 ) , V_90 ) ;
if ( ! V_111 )
return NULL ;
V_103 = & V_111 -> V_91 ;
F_55 ( V_5 , V_103 ,
