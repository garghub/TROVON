...
int V_84 ( V_85 ) ;
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = F_5 ( V_12 , V_4 , & V_85 ) ;
if ( V_14 == V_21 ) {
if ( V_6 -> V_86 . V_80 < V_6 -> V_87 ) {
F_37 ( & V_6 -> V_86 , V_12 ) ;
V_6 -> V_88 ++ ;
} else {
return F_38 ( V_12 , V_4 , V_83 ) ;
}
#ifdef F_8
} else if ( ! V_14 ) {
if ( V_85 & V_25 )
...
return V_85 ;
#endif
} else if ( ( V_85 = F_41 ( V_12 , V_14 -> V_63 . V_79 . V_6 ,
V_83 ) ) != V_24 ) {
if ( F_42 ( V_85 ) ) {
F_39 ( V_4 ) ;
V_14 -> V_82 ++ ;
...
static inline void F_44 ( struct V_1 * V_14 , int V_89 , T_2 V_74 )
{
T_2 V_75 = V_74 + V_14 -> V_77 ;
if ( V_75 > V_14 -> V_72 )
V_75 = V_14 -> V_72 ;
V_75 -= ( T_2 ) F_45 ( & V_14 -> V_90 , V_89 ) ;
if ( V_75 <= - V_14 -> V_91 )
V_75 = 1 - V_14 -> V_91 ;
V_14 -> V_77 = V_75 ;
}
static inline void F_46 ( struct V_1 * V_14 , int V_89 , T_2 V_74 )
{
T_2 V_75 = V_74 + V_14 -> V_76 ;
if ( V_75 > V_14 -> V_71 )
V_75 = V_14 -> V_71 ;
V_75 -= ( T_2 ) F_45 ( & V_14 -> ceil , V_89 ) ;
if ( V_75 <= - V_14 -> V_91 )
V_75 = 1 - V_14 -> V_91 ;
V_14 -> V_76 = V_75 ;
}
...
T_2 V_74 ;
while ( V_14 ) {
V_74 = F_49 ( T_2 , V_6 -> V_47 - V_14 -> V_93 , V_14 -> V_91 ) ;
if ( V_14 -> V_22 >= V_22 ) {
if ( V_14 -> V_22 == V_22 )
V_14 -> V_94 . V_95 ++ ;
F_44 ( V_14 , V_89 , V_74 ) ;
...
* V_110 -> V_106 =
F_55 ( V_35 , V_110 -> V_34 , * V_110 -> V_107 ) ;
}
* V_110 -> V_107 = 0 ;
if ( ! * V_110 -> V_106 ) {
...
if ( F_60 ( V_12 != NULL ) ) {
F_50 ( & V_14 -> V_97 , V_12 ) ;
V_14 -> V_63 . V_79 . V_114 [ V_22 ] -= F_48 ( V_12 ) ;
...
F_67 ( V_4 ) ;
if ( F_60 ( V_116 > V_6 -> V_47 ) )
F_68 ( & V_6 -> V_122 , V_116 ) ;
else
F_69 ( & V_6 -> V_123 ) ;
V_119:
return V_12 ;
...
struct V_1 * V_14 ;
unsigned int V_105 ;
for ( V_105 = 0 ; V_105 < V_6 -> V_9 . V_124 ; V_105 ++ ) {
...
static void F_76 ( struct V_128 * V_123 )
{
struct V_5 * V_6 = F_4 ( V_123 , struct V_5 , V_123 ) ;
struct V_3 * V_4 = V_6 -> V_122 . V_129 ;
F_77 () ;
F_78 ( F_79 ( V_4 ) ) ;
F_80 () ;
}
static int F_81 ( struct V_3 * V_4 , struct V_130 * V_131 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
...
if ( ! V_131 )
return - V_137 ;
V_136 = F_82 ( V_132 , V_133 , V_131 , V_138 ) ;
if ( V_136 < 0 )
return V_136 ;
if ( ! V_132 [ V_139 ] )
return - V_137 ;
V_135 = F_83 ( V_132 [ V_139 ] ) ;
if ( V_135 -> V_140 != V_141 >> 16 )
return - V_137 ;
V_136 = F_84 ( & V_6 -> V_9 ) ;
if ( V_136 < 0 )
return V_136 ;
...
F_87 ( & V_6 -> V_86 ) ;
if ( V_132 [ V_142 ] )
V_6 -> V_87 = F_88 ( V_132 [ V_142 ] ) ;
else
V_6 -> V_87 = F_89 ( V_4 ) -> V_143 ;
if ( ( V_6 -> V_144 = V_135 -> V_144 ) < 1 )
V_6 -> V_144 = 1 ;
V_6 -> V_32 = V_135 -> V_32 ;
return 0 ;
}
...
V_135 . V_88 = V_6 -> V_88 ;
V_135 . V_140 = V_141 ;
V_135 . V_144 = V_6 -> V_144 ;
V_135 . V_32 = V_6 -> V_32 ;
V_135 . V_146 = 0 ;
V_145 = F_91 ( V_12 , V_147 ) ;
if ( V_145 == NULL )
goto V_148;
if ( F_92 ( V_12 , V_139 , sizeof( V_135 ) , & V_135 ) ||
F_93 ( V_12 , V_142 , V_6 -> V_87 ) )
goto V_148;
return F_94 ( V_12 , V_145 ) ;
V_148:
F_95 ( V_12 , V_145 ) ;
return - 1 ;
}
static int F_96 ( struct V_3 * V_4 , unsigned long V_149 ,
struct V_11 * V_12 , struct V_150 * V_151 )
{
struct V_1 * V_14 = (struct V_1 * ) V_149 ;
struct V_130 * V_145 ;
struct V_152 V_131 ;
V_151 -> V_153 = V_14 -> V_38 ? V_14 -> V_38 -> V_10 . V_31 : V_154 ;
V_151 -> V_155 = V_14 -> V_10 . V_31 ;
if ( ! V_14 -> V_22 && V_14 -> V_63 . V_79 . V_6 )
V_151 -> V_156 = V_14 -> V_63 . V_79 . V_6 -> V_2 ;
V_145 = F_91 ( V_12 , V_147 ) ;
if ( V_145 == NULL )
goto V_148;
memset ( & V_131 , 0 , sizeof( V_131 ) ) ;
F_97 ( & V_131 . V_90 , & V_14 -> V_90 ) ;
V_131 . V_72 = F_98 ( V_14 -> V_72 ) ;
F_97 ( & V_131 . ceil , & V_14 -> ceil ) ;
V_131 . V_71 = F_98 ( V_14 -> V_71 ) ;
V_131 . V_115 = V_14 -> V_115 ;
V_131 . V_35 = V_14 -> V_35 ;
V_131 . V_22 = V_14 -> V_22 ;
if ( F_92 ( V_12 , V_157 , sizeof( V_131 ) , & V_131 ) )
goto V_148;
if ( ( V_14 -> V_90 . V_158 >= ( 1ULL << 32 ) ) &&
F_99 ( V_12 , V_159 , V_14 -> V_90 . V_158 ,
V_160 ) )
goto V_148;
if ( ( V_14 -> ceil . V_158 >= ( 1ULL << 32 ) ) &&
F_99 ( V_12 , V_161 , V_14 -> ceil . V_158 ,
V_160 ) )
goto V_148;
return F_94 ( V_12 , V_145 ) ;
V_148:
...
static int
F_100 ( struct V_3 * V_4 , unsigned long V_149 , struct V_162 * V_163 )
{
struct V_1 * V_14 = (struct V_1 * ) V_149 ;
struct V_164 V_165 = {
. V_82 = V_14 -> V_82 ,
...
V_165 . V_126 = V_14 -> V_63 . V_79 . V_6 -> V_125 . V_126 ;
}
V_14 -> V_94 . V_77 = F_101 ( T_2 , F_98 ( V_14 -> V_77 ) ,
V_166 , V_167 ) ;
V_14 -> V_94 . V_76 = F_101 ( T_2 , F_98 ( V_14 -> V_76 ) ,
V_166 , V_167 ) ;
if ( F_102 ( F_103 ( V_4 ) ,
V_163 , NULL , & V_14 -> V_97 ) < 0 ||
F_104 ( V_163 , NULL , & V_14 -> V_168 ) < 0 ||
F_105 ( V_163 , NULL , & V_165 , V_80 ) < 0 )
return - 1 ;
return F_106 ( V_163 , & V_14 -> V_94 , sizeof( V_14 -> V_94 ) ) ;
}
static int F_107 ( struct V_3 * V_4 , unsigned long V_149 , struct V_3 * V_169 ,
struct V_3 * * V_170 )
{
struct V_1 * V_14 = (struct V_1 * ) V_149 ;
if ( V_14 -> V_22 )
return - V_137 ;
if ( V_169 == NULL &&
( V_169 = F_108 ( V_4 -> V_171 , & V_172 ,
V_14 -> V_10 . V_31 ) ) == NULL )
return - V_173 ;
* V_170 = F_109 ( V_4 , V_169 , & V_14 -> V_63 . V_79 . V_6 ) ;
return 0 ;
}
static struct V_3 * F_110 ( struct V_3 * V_4 , unsigned long V_149 )
{
struct V_1 * V_14 = (struct V_1 * ) V_149 ;
return ! V_14 -> V_22 ? V_14 -> V_63 . V_79 . V_6 : NULL ;
}
static void F_111 ( struct V_3 * V_4 , unsigned long V_149 )
{
struct V_1 * V_14 = (struct V_1 * ) V_149 ;
...
V_38 -> V_63 . V_79 . V_6 = V_176 ? V_176 : & V_177 ;
V_38 -> V_77 = V_38 -> V_72 ;
V_38 -> V_76 = V_38 -> V_71 ;
V_38 -> V_93 = F_66 () ;
V_38 -> V_61 = V_67 ;
...
static int F_124 ( struct V_3 * V_4 , unsigned long V_149 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_149 ;
struct V_3 * V_176 = NULL ;
int V_179 = 0 ;
if ( V_14 -> V_175 || V_14 -> V_180 )
return - V_181 ;
if ( ! V_14 -> V_22 && F_113 ( V_14 ) ) {
V_176 = F_108 ( V_4 -> V_171 , & V_172 ,
V_14 -> V_38 -> V_10 . V_31 ) ;
V_179 = 1 ;
}
F_125 ( V_4 ) ;
...
unsigned int V_126 = V_14 -> V_63 . V_79 . V_6 -> V_125 . V_126 ;
F_72 ( V_14 -> V_63 . V_79 . V_6 ) ;
F_126 ( V_14 -> V_63 . V_79 . V_6 , V_80 , V_126 ) ;
}
...
if ( V_179 )
F_114 ( V_6 , V_14 , V_176 ) ;
F_57 ( -- V_14 -> V_174 == 0 ) ;
F_128 ( V_4 ) ;
return 0 ;
}
static void F_129 ( struct V_3 * V_4 , unsigned long V_149 )
{
struct V_1 * V_14 = (struct V_1 * ) V_149 ;
if ( -- V_14 -> V_174 == 0 )
F_115 ( V_4 , V_14 ) ;
...
T_1 V_182 , struct V_130 * * V_183 ,
unsigned long * V_149 )
{
int V_136 = - V_137 ;
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) * V_149 , * V_38 ;
struct V_130 * V_131 = V_183 [ V_147 ] ;
struct V_130 * V_132 [ V_133 + 1 ] ;
struct V_152 * V_184 ;
T_4 V_185 , V_186 ;
if ( ! V_131 )
...
if ( V_132 [ V_157 ] == NULL )
goto V_187;
V_38 = V_182 == V_154 ? NULL : F_1 ( V_182 , V_4 ) ;
V_184 = F_83 ( V_132 [ V_157 ] ) ;
if ( ! V_184 -> V_90 . V_90 || ! V_184 -> ceil . V_90 )
goto V_187;
if ( V_184 -> V_90 . V_188 == V_189 )
F_131 ( F_132 ( & V_184 -> V_90 , V_132 [ V_190 ] ) ) ;
if ( V_184 -> ceil . V_188 == V_189 )
F_131 ( F_132 ( & V_184 -> ceil , V_132 [ V_191 ] ) ) ;
if ( ! V_14 ) {
struct V_3 * V_176 ;
int V_35 ;
struct {
...
. V_192 = {
. V_195 = F_133 ( sizeof( V_194 . V_131 ) ) ,
. V_196 = V_197 ,
} ,
. V_131 = {
. V_198 = 2 ,
...
V_136 = - V_173 ;
V_14 = F_135 ( sizeof( * V_14 ) , V_200 ) ;
if ( ! V_14 )
goto V_187;
if ( V_201 || V_183 [ V_197 ] ) {
V_136 = F_136 ( & V_14 -> V_97 , NULL ,
& V_14 -> V_168 ,
NULL ,
F_103 ( V_4 ) ,
V_183 [ V_197 ] ? : & V_194 . V_192 ) ;
if ( V_136 ) {
F_119 ( V_14 ) ;
goto V_187;
}
...
F_24 ( & V_14 -> V_40 [ V_35 ] ) ;
V_176 = F_108 ( V_4 -> V_171 ,
& V_172 , V_31 ) ;
F_125 ( V_4 ) ;
if ( V_38 && ! V_38 -> V_22 ) {
unsigned int V_80 = V_38 -> V_63 . V_79 . V_6 -> V_6 . V_80 ;
unsigned int V_126 = V_38 -> V_63 . V_79 . V_6 -> V_125 . V_126 ;
F_72 ( V_38 -> V_63 . V_79 . V_6 ) ;
F_126 ( V_38 -> V_63 . V_79 . V_6 , V_80 , V_126 ) ;
...
V_14 -> V_63 . V_79 . V_6 = V_176 ? V_176 : & V_177 ;
V_14 -> V_10 . V_31 = V_31 ;
V_14 -> V_38 = V_38 ;
V_14 -> V_77 = F_137 ( V_184 -> V_72 ) ;
V_14 -> V_76 = F_137 ( V_184 -> V_71 ) ;
...
V_185 = V_132 [ V_159 ] ? F_140 ( V_132 [ V_159 ] ) : 0 ;
V_186 = V_132 [ V_161 ] ? F_140 ( V_132 [ V_161 ] ) : 0 ;
F_141 ( & V_14 -> V_90 , & V_184 -> V_90 , V_185 ) ;
F_141 ( & V_14 -> ceil , & V_184 -> ceil , V_186 ) ;
if ( ! V_14 -> V_22 ) {
T_4 V_115 = V_14 -> V_90 . V_158 ;
F_142 ( V_115 , V_6 -> V_144 ) ;
V_14 -> V_115 = F_49 ( T_4 , V_115 , V_167 ) ;
if ( ! V_184 -> V_115 && V_14 -> V_115 < 1000 ) {
F_54 ( L_4 ,
V_14 -> V_10 . V_31 ) ;
V_14 -> V_115 = 1000 ;
}
if ( ! V_184 -> V_115 && V_14 -> V_115 > 200000 ) {
F_54 ( L_5 ,
V_14 -> V_10 . V_31 ) ;
V_14 -> V_115 = 200000 ;
}
if ( V_184 -> V_115 )
V_14 -> V_115 = V_184 -> V_115 ;
if ( ( V_14 -> V_35 = V_184 -> V_35 ) >= V_127 )
V_14 -> V_35 = V_127 - 1 ;
}
V_14 -> V_72 = F_137 ( V_184 -> V_72 ) ;
V_14 -> V_71 = F_137 ( V_184 -> V_71 ) ;
F_128 ( V_4 ) ;
F_143 ( V_4 , & V_6 -> V_9 ) ;
* V_149 = ( unsigned long ) V_14 ;
return 0 ;
V_187:
return V_136 ;
}
static struct V_17 T_5 * * F_144 ( struct V_3 * V_4 ,
unsigned long V_149 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_149 ;
struct V_17 T_5 * * V_202 = V_14 ? & V_14 -> V_23 : & V_6 -> V_23 ;
return V_202 ;
}
...
static void F_146 ( struct V_3 * V_4 , unsigned long V_149 )
{
struct V_1 * V_14 = (struct V_1 * ) V_149 ;
if ( V_14 )
V_14 -> V_180 -- ;
}
static void F_147 ( struct V_3 * V_4 , struct V_203 * V_149 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 ;
unsigned int V_105 ;
...
for ( V_105 = 0 ; V_105 < V_6 -> V_9 . V_124 ; V_105 ++ ) {
F_71 (cl, &q->clhash.hash[i], common.hnode) {
if ( V_149 -> V_205 < V_149 -> V_206 ) {
V_149 -> V_205 ++ ;
continue;
}
if ( V_149 -> V_207 ( V_4 , ( unsigned long ) V_14 , V_149 ) < 0 ) {
V_149 -> V_204 = 1 ;
return;
}
V_149 -> V_205 ++ ;
