...
static int F_58 ( struct V_102 * V_45 )
{
...
int V_46 = - V_126 ;
int V_8 ;
V_11 = F_59 ( V_44 , sizeof( * V_11 ) , V_127 ) ;
if ( ! V_11 )
return - V_126 ;
F_60 ( & V_11 -> V_62 ) ;
F_61 ( & V_11 -> V_55 ) ;
V_11 -> V_45 = V_45 ;
V_121 = F_62 ( V_128 , V_44 -> V_105 ) ;
if ( F_63 ( V_121 == NULL ) )
return - V_42 ;
V_123 = V_121 -> V_84 ;
...
V_11 -> V_129 = F_64 ( V_44 , L_22 ) ;
if ( F_16 ( V_11 -> V_129 ) )
return F_22 ( V_11 -> V_129 ) ;
V_125 = F_65 ( V_45 , V_130 , 0 ) ;
V_11 -> V_99 = F_66 ( V_44 , V_125 ) ;
if ( F_16 ( V_11 -> V_99 ) )
return F_22 ( V_11 -> V_99 ) ;
V_11 -> V_87 = F_67 ( V_45 , 0 ) ;
if ( V_11 -> V_87 < 0 ) {
F_24 ( V_44 , L_23 ) ;
return V_11 -> V_87 ;
}
...
return V_46 ;
if ( V_11 -> V_108 )
V_46 = F_69 ( V_11 -> clock [ V_135 ] ,
V_11 -> V_108 ) ;
else
F_70 ( V_44 , L_24 ) ;
if ( V_46 < 0 )
goto V_136;
V_46 = F_71 ( V_11 -> clock [ V_135 ] ) ;
if ( V_46 < 0 )
goto V_136;
V_46 = F_72 ( V_44 , V_11 -> V_87 , F_50 ,
0 , F_73 ( V_44 ) , V_11 ) ;
if ( V_46 ) {
F_24 ( V_44 , L_25 ) ;
goto V_137;
...
V_11 -> V_145 [ V_146 ] . V_54 = V_147 ;
V_11 -> V_145 [ V_79 ] . V_54 = V_148 ;
V_46 = F_75 ( & V_11 -> V_4 . V_149 ,
V_150 , V_11 -> V_145 ) ;
if ( V_46 < 0 )
goto V_137;
F_76 ( & V_11 -> V_4 , V_45 ) ;
F_77 ( V_45 , & V_11 -> V_4 ) ;
memcpy ( V_11 -> V_57 , V_151 , sizeof( V_11 -> V_57 ) ) ;
F_78 ( V_44 ) ;
if ( ! F_79 ( V_44 ) ) {
V_46 = F_80 ( V_44 , true ) ;
if ( V_46 < 0 )
...
F_82 ( & V_11 -> V_4 . V_149 ) ;
V_137:
F_83 ( V_11 -> clock [ V_135 ] ) ;
V_136:
F_15 ( V_11 ) ;
return V_46 ;
}
static int F_84 ( struct V_43 * V_44 , bool V_153 )
{
struct V_102 * V_45 = F_85 ( V_44 ) ;
...
static int F_80 ( struct V_43 * V_44 , bool V_153 )
{
struct V_102 * V_45 = F_85 ( V_44 ) ;
struct V_2 * V_4 = F_86 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
...
{
return F_80 ( V_44 , true ) ;
}
static int F_95 ( struct V_102 * V_45 )
{
struct V_2 * V_4 = F_86 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
F_96 ( & V_45 -> V_44 ) ;
