...
struct V_8 * V_9 = F_123 ( V_244 -> V_280 . V_271 ) ;
if ( ( V_811 -> V_828 & V_829 ) == 0 )
return - V_72 ;
if ( F_140 ( & V_9 -> V_317 , 1 , 0 ) )
F_141 ( V_9 ) ;
V_174 -> V_806 . V_830 |=
( V_811 -> V_831 . V_832 << V_833 ) ;
V_174 -> V_806 . V_834 |=
( V_811 -> V_831 . V_835 & V_836 ) ;
V_174 -> V_806 . V_834 |= ( V_811 -> V_837 << V_838 ) ;
V_174 -> V_806 . V_839 |=
( V_811 -> V_831 . V_840 << V_841 ) ;
V_174 -> V_322 |= V_842 ;
memcpy ( & V_174 -> V_806 . V_843 [ 0 ] , & V_811 -> V_831 . V_843 . V_844 [ 0 ] ,
sizeof( V_174 -> V_806 . V_843 ) ) ;
V_41 = F_142 ( & V_9 -> V_272 , 1 , V_811 -> V_831 . V_845 ,
& V_813 , & V_816 ) ;
if ( ! V_41 && V_816 . V_846 ) {
V_817 = F_143 ( V_816 . V_846 ) ;
memcpy ( V_818 , V_816 . V_846 -> V_847 , V_848 ) ;
F_144 ( V_816 . V_846 ) ;
}
memset ( & V_814 , 0 , sizeof( V_814 ) ) ;
if ( ! memcmp ( & V_813 , & V_814 , sizeof( V_814 ) ) )
return - V_72 ;
V_244 -> V_849 = V_811 -> V_831 . V_845 ;
memcpy ( & V_174 -> V_806 . V_813 [ 0 ] , & V_813 . V_844 [ 0 ] , sizeof( V_174 -> V_806 . V_813 ) ) ;
V_41 = F_145 ( V_9 , V_811 , & V_818 [ 0 ] ) ;
if ( V_41 )
return V_41 ;
V_174 -> V_806 . V_850 = V_818 [ 0 ] | ( V_818 [ 1 ] << 8 ) |
( V_818 [ 2 ] << 16 ) | ( V_818 [ 3 ] << 24 ) ;
V_819 = F_146 ( V_816 . V_851 , & V_813 ) ;
if ( V_819 == V_852 ) {
F_147 ( & V_826 . V_821 , & V_813 ) ;
F_147 ( & V_827 . V_821 , & V_811 -> V_831 . V_843 ) ;
memcpy ( & V_174 -> V_806 . V_843 [ 0 ] ,
& V_827 . V_823 . V_853 . V_854 , 4 ) ;
memcpy ( & V_174 -> V_806 . V_813 [ 0 ] ,
& V_826 . V_823 . V_853 . V_854 , 4 ) ;
}
F_148 ( & V_174 -> V_806 . V_843 [ 0 ] , sizeof( V_174 -> V_806 . V_843 ) ) ;
F_148 ( & V_174 -> V_806 . V_813 [ 0 ] , sizeof( V_174 -> V_806 . V_813 ) ) ;
V_174 -> V_806 . V_855 = V_818 [ 4 ] | ( V_818 [ 5 ] << 8 ) ;
if ( V_817 == 0xFFFF )
V_817 = 0 ;
if ( V_817 || V_9 -> V_856 ) {
if ( ! V_817 ) {
...
V_174 -> V_806 . V_850 = V_9 -> V_117 . V_818 [ 0 ] |
( V_9 -> V_117 . V_818 [ 1 ] << 8 ) |
( V_9 -> V_117 . V_818 [ 2 ] << 16 ) |
( V_9 -> V_117 . V_818 [ 3 ] << 24 ) ;
V_174 -> V_806 . V_855 = V_9 -> V_117 . V_818 [ 4 ] |
( V_9 -> V_117 . V_818 [ 5 ] << 8 ) ;
}
if ( ( V_809 & V_870 ) &&
V_699 -> V_871 ) {
...
if ( V_809 & V_904 ) {
V_174 -> V_806 . V_830 |= ( V_699 -> V_905 & 0x00ffffff ) ;
V_174 -> V_322 |= V_906 ;
}
if ( V_809 & V_907 ) {
V_174 -> V_806 . V_839 |= ( V_699 -> V_908 & 0x00ffffff ) ;
V_174 -> V_322 |= V_909 ;
}
if ( V_809 & V_910 ) {
...
V_41 = F_149 ( V_244 , V_174 , V_699 , V_809 ) ;
if ( V_41 )
goto V_200;
V_41 = F_80 ( V_9 , (struct V_17 * ) V_174 ) ;
if ( V_41 )
...
int F_153 ( struct V_8 * V_9 , struct V_785 * V_292 ,
struct V_926 * V_927 ,
struct V_520 * V_521 )
{
int V_41 = - V_163 ;
...
int F_154 ( struct V_785 * V_292 , struct V_948 * V_927 )
{
int V_41 = - V_163 ;
struct V_949 * V_174 ;
...
int F_155 ( struct V_785 * V_292 , struct V_948 * V_927 )
{
int V_41 = - V_163 ;
struct V_954 * V_174 ;
...
static int F_157 ( struct V_8 * V_9 , T_1 V_964 ,
struct V_965 * V_966 )
{
int V_41 ;
T_4 V_195 ;
...
V_174 . V_146 . V_151 = F_158 ( T_1 , sizeof( struct V_968 ) ,
sizeof( struct V_967 ) ) ;
...
static int F_159 ( struct V_8 * V_9 , int V_964 ,
struct V_965 * V_966 ,
T_2 * V_975 )
{
...
V_41 = F_157 ( V_9 , V_964 , & V_966 ) ;
if ( V_41 ) {
F_52 ( L_37 , V_299 , V_41 ) ;
V_964 = V_1002 ;
continue;
}
V_41 = F_159 ( V_9 , V_964 ,
& V_966 , & V_975 ) ;
if ( V_41 ) {
V_964 = V_1002 ;
continue;
...
F_161 ( & V_9 -> V_117 . V_158 -> V_9 ) , V_9 -> V_120 ,
V_975 ) ;
V_9 -> V_856 = F_162 ( V_966 . V_856 ) ;
V_9 -> V_837 = V_975 ;
}
int F_165 ( struct V_8 * V_9 , struct V_1003 * V_1004 )
{
int V_169 ;
int V_41 = - V_72 ;
struct V_570 * V_1005 ;
...
int F_166 ( struct V_8 * V_9 , struct V_1003 * V_1004 )
{
unsigned long V_322 ;
F_69 ( & V_9 -> V_569 . V_239 , V_322 ) ;
...
sprintf ( V_9 -> V_207 [ V_169 ] . V_1011 , L_40 ,
V_9 -> V_120 , V_169 ) ;
...
F_170 ( V_9 , & V_2 [ V_169 ] , V_1020 ) ;
V_169 += V_1020 ;
V_1013 -= V_1020 ;
}
} else {
F_170 ( V_9 , V_2 , V_1013 ) ;
}
return 0 ;
}
void F_172 ( struct V_1021 * V_1022 )
{
struct V_8 * V_9 =
F_173 ( V_1022 , struct V_8 , V_1023 . V_1022 ) ;
struct V_1 * V_2 = 0 ;
...
if ( V_1013 )
V_41 = F_171 ( V_9 , & V_9 -> V_207 [ 0 ] , V_1013 ) ;
F_174 ( & V_9 -> V_1023 , F_79 ( 1000 ) ) ;
}
