...
{
struct V_94 * V_95 = V_93 ;
struct V_10 * V_113 = F_3 ( V_95 -> args . V_9 ) ;
if ( V_113 -> V_114 -> V_115 )
V_113 -> V_114 -> V_115 ( V_95 ) ;
F_52 ( F_33 ( V_95 -> args . V_9 ) -> V_99 ) ;
F_53 () ;
F_54 ( V_116 , & F_33 ( V_95 -> args . V_9 ) -> V_117 ) ;
F_55 () ;
F_56 ( V_95 -> V_9 ) ;
F_9 ( V_95 -> args . V_118 ) ;
F_9 ( V_95 ) ;
...
static int F_61 ( struct V_1 * V_2 , struct V_3 * V_128 ,
struct V_3 * V_129 , struct V_5 * V_49 ,
struct V_5 * V_52 , T_1 V_130 ,
T_1 V_131 , T_1 V_53 )
{
struct V_9 * V_132 = F_2 ( V_128 ) ;
struct V_9 * V_61 = F_2 ( V_129 ) ;
struct V_10 * V_11 = F_3 ( V_61 ) ;
struct V_133 args = {
. V_55 = F_4 ( V_132 ) ,
. V_57 = F_4 ( V_61 ) ,
...
& args . V_30 , & V_19 . V_31 , 0 ) ;
if ( V_21 == 0 )
V_21 = F_8 ( V_61 , V_19 . V_136 ) ;
F_9 ( V_19 . V_136 ) ;
return V_21 ;
}
int F_62 ( struct V_3 * V_128 , struct V_3 * V_129 ,
T_1 V_130 , T_1 V_131 , T_1 V_53 )
{
struct V_1 V_2 = {
. V_39 = & V_40 [ V_137 ] ,
} ;
struct V_9 * V_9 = F_2 ( V_128 ) ;
struct V_10 * V_11 = F_3 ( F_2 ( V_128 ) ) ;
struct V_5 * V_49 ;
struct V_5 * V_52 ;
struct V_32 V_71 = { } ;
struct V_32 V_72 = { } ;
...
if ( ! F_18 ( V_9 , V_138 ) )
return - V_37 ;
V_49 = F_11 ( F_12 ( V_128 ) ) ;
if ( F_13 ( V_49 ) )
return F_14 ( V_49 ) ;
V_71 . V_9 = F_2 ( V_128 ) ;
V_71 . V_35 = V_49 -> V_25 -> V_35 ;
V_52 = F_11 ( F_12 ( V_129 ) ) ;
if ( F_13 ( V_52 ) ) {
V_34 = F_14 ( V_52 ) ;
goto V_74;
}
...
V_72 . V_35 = V_52 -> V_25 -> V_35 ;
do {
V_34 = F_61 ( & V_2 , V_128 , V_129 , V_49 , V_52 ,
V_130 , V_131 , V_53 ) ;
