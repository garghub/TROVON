...
unsigned int V_193 ;
F_132 (j) {
if ( F_5 ( V_3 ) . V_196 == F_5 ( V_193 ) . V_196 )
F_134 ( V_193 , & V_197 [ V_3 ] ) ;
}
}
F_132 (i) {
unsigned int V_193 ;
F_133 ( & F_135 ( V_198 , V_3 ) ) ;
if ( F_5 ( V_3 ) . V_199 == - 1 ) {
F_134 ( V_3 , & F_135 ( V_198 , V_3 ) ) ;
continue;
}
F_132 (j) {
if ( F_5 ( V_3 ) . V_199 ==
F_5 ( V_193 ) . V_199 )
F_134 ( V_193 , & F_135 ( V_198 , V_3 ) ) ;
}
}
}
int F_136 ( unsigned int V_46 , struct V_74 * V_200 )
{
int V_82 = F_41 ( V_46 , V_200 ) ;
if ( ! V_82 ) {
F_134 ( V_46 , & V_16 ) ;
while ( ! F_60 ( V_46 ) )
F_137 () ;
...
F_141 ( V_46 , & F_135 ( V_198 , V_3 ) ) ;
F_133 ( & F_135 ( V_198 , V_46 ) ) ;
V_209 = & F_5 ( V_46 ) ;
V_209 -> V_195 = 0 ;
V_209 -> V_199 = - 1 ;
F_145 () ;
...
static void * T_6 F_166 ( unsigned int V_46 , T_8 V_214 ,
T_8 V_215 )
{
const unsigned long V_216 = F_40 ( V_217 ) ;
#ifdef F_167
int V_218 = F_168 ( V_46 ) ;
void * V_219 ;
if ( ! F_169 ( V_218 ) || ! F_170 ( V_218 ) ) {
V_219 = F_171 ( V_214 , V_215 , V_216 ) ;
F_172 ( L_35 ,
V_46 , V_218 ) ;
F_173 ( L_36 ,
V_46 , V_214 , F_40 ( V_219 ) ) ;
} else {
V_219 = F_174 ( F_170 ( V_218 ) ,
V_214 , V_215 , V_216 ) ;
F_173 ( L_37
L_38 , V_46 , V_214 , V_218 , F_40 ( V_219 ) ) ;
}
return V_219 ;
#else
return F_171 ( V_214 , V_215 , V_216 ) ;
#endif
}
static void T_6 F_175 ( void * V_219 , T_8 V_214 )
{
F_176 ( F_40 ( V_219 ) , V_214 ) ;
}
static int T_6 F_177 ( unsigned int V_220 , unsigned int V_221 )
{
if ( F_168 ( V_220 ) == F_168 ( V_221 ) )
return V_222 ;
else
return V_223 ;
}
static void T_6 F_178 ( unsigned long V_224 )
{
T_9 * V_152 = F_179 ( V_224 ) ;
T_10 * V_225 ;
T_11 * V_226 ;
if ( F_180 ( * V_152 ) ) {
T_10 * V_227 ;
V_227 = F_171 ( V_228 , V_228 , V_228 ) ;
F_181 ( & V_12 , V_152 , V_227 ) ;
}
V_225 = F_182 ( V_152 , V_224 ) ;
if ( F_183 ( * V_225 ) ) {
T_11 * V_227 ;
V_227 = F_171 ( V_228 , V_228 , V_228 ) ;
F_184 ( & V_12 , V_225 , V_227 ) ;
}
V_226 = F_185 ( V_225 , V_224 ) ;
if ( ! F_186 ( * V_226 ) ) {
T_12 * V_227 ;
V_227 = F_171 ( V_228 , V_228 , V_228 ) ;
F_187 ( & V_12 , V_226 , V_227 ) ;
}
}
void T_6 F_188 ( void )
{
...
if ( V_229 < 0 )
F_25 ( L_41 , V_229 ) ;
V_33 = ( unsigned long ) V_235 - ( unsigned long ) V_236 ;
F_192 (cpu)
F_8 ( V_46 ) = V_33 + V_237 [ V_46 ] ;
V_6 = F_8 ( F_24 () ) ;
F_193 () ;
if ( V_7 == V_8 )
F_194 ( V_238 ) ;
