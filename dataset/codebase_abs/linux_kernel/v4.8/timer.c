...
{
if ( ! V_41 -> V_47 || ( long ) ( V_25 - V_41 -> V_35 ) < 2 )
return;
if ( F_93 ( V_41 -> V_48 , V_25 ) )
V_41 -> V_35 = V_25 ;
else
V_41 -> V_35 = V_41 -> V_48 ;
}
...
static inline void F_92 ( struct V_40 * V_41 ) { }
static inline struct V_40 *
F_94 ( struct V_40 * V_41 , unsigned V_75 )
{
struct V_40 * V_78 = F_89 ( V_41 , V_75 ) ;
F_92 ( V_78 ) ;
return V_78 ;
}
static struct V_40 * F_95 ( struct V_26 * V_27 ,
unsigned long * V_28 )
...
static inline int
F_99 ( struct V_26 * V_27 , unsigned long V_32 , bool V_82 )
{
...
{
return F_99 ( V_27 , V_32 , true ) ;
}
int F_106 ( struct V_26 * V_27 , unsigned long V_32 )
{
return F_99 ( V_27 , V_32 , false ) ;
}
void F_107 ( struct V_26 * V_27 )
{
F_101 ( F_81 ( V_27 ) ) ;
F_106 ( V_27 , V_27 -> V_32 ) ;
}
void F_108 ( struct V_26 * V_27 , int V_5 )
{
struct V_40 * V_83 , * V_41 ;
unsigned long V_28 ;
F_100 ( V_27 ) ;
F_101 ( F_81 ( V_27 ) || ! V_27 -> V_58 ) ;
...
static void F_118 ( struct V_26 * V_27 , void (* F_119)( unsigned long ) ,
unsigned long V_66 )
{
int V_89 = F_120 () ;
#ifdef F_112
struct V_71 V_71 ;
F_121 ( & V_71 , & V_27 -> V_71 ) ;
#endif
F_114 ( & V_71 ) ;
F_122 ( V_27 ) ;
F_119 ( V_66 ) ;
...
static void F_126 ( struct V_40 * V_41 , struct V_90 * V_91 )
{
while ( ! F_127 ( V_91 ) ) {
struct V_26 * V_27 ;
void (* F_119)( unsigned long );
unsigned long V_66 ;
V_27 = F_128 ( V_91 -> V_92 , struct V_26 , V_42 ) ;
F_40 ( V_27 ) ;
V_41 -> V_86 = V_27 ;
F_78 ( V_27 , true ) ;
F_119 = V_27 -> V_58 ;
...
static int F_131 ( struct V_40 * V_41 ,
struct V_90 * V_93 )
{
...
static int F_134 ( struct V_40 * V_41 , unsigned V_100 ,
unsigned V_35 )
{
unsigned V_101 , V_102 = V_100 + V_35 ;
unsigned V_103 = V_100 + V_97 ;
V_101 = F_135 ( V_41 -> V_44 , V_103 , V_102 ) ;
if ( V_101 < V_103 )
return V_101 - V_102 ;
V_101 = F_135 ( V_41 -> V_44 , V_102 , V_100 ) ;
return V_101 < V_102 ? V_101 + V_97 - V_102 : - 1 ;
}
static unsigned long F_136 ( struct V_40 * V_41 )
{
...
int V_101 = F_134 ( V_41 , V_100 , V_35 & V_34 ) ;
if ( V_101 >= 0 ) {
...
static T_5 F_138 ( T_5 V_107 , T_5 V_32 )
{
T_5 V_108 = F_139 () ;
if ( V_32 <= V_108 )
return V_32 ;
if ( V_108 <= V_107 )
return V_107 ;
return F_140 ( V_108 , V_109 ) * V_109 ;
}
T_5 F_141 ( unsigned long V_110 , T_5 V_107 )
{
struct V_40 * V_41 = F_87 ( & V_6 [ V_7 ] ) ;
T_5 V_32 = V_111 ;
unsigned long V_108 ;
...
return F_131 ( V_41 , V_93 ) ;
}
static inline int F_146 ( struct V_40 * V_41 ,
struct V_90 * V_93 )
{
return F_131 ( V_41 , V_93 ) ;
}
void F_147 ( int V_113 )
{
...
static inline void F_155 ( struct V_40 * V_41 )
{
...
V_96 = F_146 ( V_41 , V_93 ) ;
V_41 -> V_35 ++ ;
while ( V_96 -- )
F_126 ( V_41 , V_93 + V_96 ) ;
}
V_41 -> V_86 = NULL ;
F_129 ( & V_41 -> V_79 ) ;
}
static void F_156 ( struct V_116 * V_117 )
{
struct V_40 * V_41 = F_87 ( & V_6 [ V_7 ] ) ;
F_155 ( V_41 ) ;
if ( F_34 ( V_45 ) && V_41 -> V_11 )
...
static void F_159 ( unsigned long V_119 )
{
F_160 ( (struct V_114 * ) V_119 ) ;
}
signed long T_6 F_161 ( signed long V_120 )
{
struct V_26 V_27 ;
unsigned long V_121 ;
switch ( V_120 )
...
V_121 = V_120 + V_25 ;
F_165 ( & V_27 , F_159 , ( unsigned long ) V_52 ) ;
F_99 ( & V_27 , V_121 , false ) ;
F_162 () ;
F_166 ( & V_27 ) ;
F_67 ( & V_27 ) ;
V_120 = V_121 - V_25 ;
...
signed long T_6 F_167 ( signed long V_120 )
{
F_168 ( V_126 ) ;
return F_161 ( V_120 ) ;
}
signed long T_6 F_169 ( signed long V_120 )
{
F_168 ( V_127 ) ;
return F_161 ( V_120 ) ;
}
signed long T_6 F_170 ( signed long V_120 )
{
F_168 ( V_128 ) ;
return F_161 ( V_120 ) ;
}
signed long T_6 F_171 ( signed long V_120 )
{
F_168 ( V_129 ) ;
return F_161 ( V_120 ) ;
}
static void F_172 ( struct V_40 * V_83 , struct V_90 * V_91 )
{
struct V_26 * V_27 ;
int V_5 = V_83 -> V_5 ;
while ( ! F_127 ( V_91 ) ) {
...
V_83 = F_175 ( & V_6 [ V_131 ] ) ;
F_130 ( & V_83 -> V_79 ) ;
F_176 ( & V_130 -> V_79 , V_133 ) ;
F_101 ( V_130 -> V_86 ) ;
for ( V_95 = 0 ; V_95 < V_134 ; V_95 ++ )
F_172 ( V_83 , V_130 -> V_43 + V_95 ) ;
F_102 ( & V_130 -> V_79 ) ;
F_129 ( & V_83 -> V_79 ) ;
F_177 ( & V_6 ) ;
}
...
void F_184 ( unsigned int V_135 )
{
unsigned long V_120 = F_185 ( V_135 ) + 1 ;
while ( V_120 )
V_120 = F_170 ( V_120 ) ;
}
unsigned long F_186 ( unsigned int V_135 )
{
unsigned long V_120 = F_185 ( V_135 ) + 1 ;
while ( V_120 && ! F_187 ( V_52 ) )
V_120 = F_167 ( V_120 ) ;
return F_188 ( V_120 ) ;
}
static void T_6 F_189 ( unsigned long V_136 , unsigned long V_137 )
{
T_8 V_138 ;
T_5 V_36 ;
V_138 = F_190 ( 0 , V_136 * V_139 ) ;
V_36 = ( T_5 ) ( V_137 - V_136 ) * V_139 ;
F_191 ( & V_138 , V_36 , V_140 ) ;
}
void T_6 F_192 ( unsigned long V_136 , unsigned long V_137 )
{
F_168 ( V_128 ) ;
F_189 ( V_136 , V_137 ) ;
}
