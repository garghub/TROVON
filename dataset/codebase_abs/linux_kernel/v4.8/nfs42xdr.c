...
V_65 -> V_70 . V_71 = F_37 ( V_30 ) ;
return F_38 ( V_2 , & V_65 -> V_70 . V_70 ) ;
V_67:
F_39 ( V_68 , V_2 ) ;
return - V_72 ;
}
...
static int F_41 ( struct V_1 * V_2 , struct V_73 * V_65 )
{
int V_76 ;
V_76 = F_31 ( V_2 , V_12 ) ;
if ( V_76 == V_77 ) {
...
static int F_43 ( struct V_1 * V_2 , struct V_79 * V_65 )
{
int V_76 ;
T_1 * V_30 ;
V_76 = F_31 ( V_2 , V_22 ) ;
...
static int F_46 ( struct V_50 * V_82 ,
struct V_1 * V_2 ,
struct V_64 * V_65 )
{
struct V_7 V_8 ;
...
if ( V_76 )
goto V_83;
F_50 ( V_2 , V_65 -> V_85 , V_65 -> V_86 ) ;
V_83:
return V_76 ;
}
static int F_51 ( struct V_50 * V_82 ,
struct V_1 * V_2 ,
struct V_73 * V_65 )
{
struct V_7 V_8 ;
...
static int F_56 ( struct V_50 * V_82 ,
struct V_1 * V_2 ,
struct V_89 * V_65 )
{
struct V_7 V_8 ;
...
if ( V_76 )
goto V_83;
V_76 = F_50 ( V_2 , V_65 -> V_90 , V_65 -> V_91 ) ;
V_83:
V_65 -> V_88 = V_76 ;
return V_76 ;
}
