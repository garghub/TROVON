...
static int F_53 ( struct V_75 * V_75 , struct V_106 * V_107 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
F_47 ( 1 , V_102 , & V_5 -> V_103 , L_5 ) ;
return F_54 ( & V_3 -> V_104 , V_107 ) ;
}
static unsigned int F_55 ( struct V_75 * V_75 , T_2 * V_108 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
F_47 ( 1 , V_102 , & V_5 -> V_103 , L_6 ) ;
if ( V_3 -> V_60 )
return F_56 ( & V_3 -> V_104 , V_75 , V_108 ) ;
return 0 ;
}
static int F_57 ( struct V_75 * V_75 , void * V_109 ,
struct V_110 * V_111 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_111 -> V_113 = V_116 | V_115 ;
V_111 -> V_117 = V_114 | V_116 |
V_115 | V_118 ;
F_58 ( V_111 -> V_119 , V_120 , sizeof( V_111 -> V_119 ) ) ;
F_58 ( V_111 -> V_121 , L_8 , sizeof( V_111 -> V_121 ) ) ;
F_58 ( V_111 -> V_122 , V_5 -> V_123 -> V_124 , sizeof( V_111 -> V_122 ) ) ;
return 0 ;
}
static int F_59 ( struct V_75 * V_75 , void * V_109 ,
struct V_28 * V_31 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
static int F_60 ( struct V_75 * V_75 , void * V_109 ,
struct V_125 * V_31 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_126 . V_26 = V_7 -> V_27 ;
V_126 . V_33 = V_34 ;
V_32 = F_9 ( V_14 , V_26 , V_35 , NULL , & V_126 ) ;
if ( V_32 ) {
F_61 ( & V_5 -> V_103 ,
L_13 ) ;
return V_32 ;
}
V_128 . V_67 = V_126 . V_29 . V_67 ;
F_11 ( & V_128 , & V_29 . V_31 . V_37 ) ;
V_31 -> V_129 = V_29 . V_31 . V_37 . V_129 ;
return 0 ;
}
static int F_62 ( struct V_75 * V_75 , void * V_109 ,
struct V_28 * V_31 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
static int F_63 ( struct V_75 * V_75 , void * V_109 ,
struct V_28 * V_31 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
static int F_64 ( struct V_75 * V_75 , void * V_109 ,
struct V_131 * V_132 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_133 * V_134 = V_3 -> V_23 ;
struct V_4 * V_5 = V_3 -> V_5 ;
F_47 ( 1 , V_102 , & V_5 -> V_103 , L_17 ) ;
if ( V_132 -> V_27 < V_134 -> V_135 ) {
memcpy ( V_132 , & V_134 -> V_50 [ V_132 -> V_27 ] ,
sizeof( struct V_131 ) ) ;
return 0 ;
}
return - V_16 ;
}
static int F_65 ( struct V_75 * V_75 , void * V_109 , unsigned int * V_27 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
static int F_66 ( struct V_75 * V_75 , void * V_109 , unsigned int V_27 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_133 * V_134 ;
...
V_138 = & V_134 -> V_147 [ V_27 ] ;
if ( V_138 && V_134 -> V_148 ) {
V_141 = V_138 -> V_141 ;
V_140 = V_138 -> V_140 ;
V_32 = F_68 ( & V_5 -> V_103 ,
V_134 -> V_145 , V_3 ,
...
for ( V_15 = 0 ; V_15 < V_134 -> V_135 ; V_15 ++ ) {
V_139 = & V_134 -> V_50 [ V_15 ] ;
V_3 -> V_40 . V_150 |= V_139 -> V_151 ;
}
V_3 -> V_136 = V_27 ;
V_142:
F_15 ( & V_3 -> V_80 ) ;
...
static int F_69 ( struct V_75 * V_75 , void * V_109 , T_3 * V_152 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_133 * V_134 ;
...
if ( V_32 )
return V_32 ;
V_32 = F_68 ( & V_5 -> V_103 , V_134 -> V_145 ,
V_3 , V_153 , V_152 ) ;
F_15 ( & V_3 -> V_80 ) ;
return V_32 ;
}
static int F_70 ( struct V_75 * V_75 , void * V_109 , T_3 V_152 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_133 * V_134 ;
...
static int F_71 ( struct V_75 * V_75 , void * V_109 , T_3 * V_157 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
static int
F_72 ( struct V_75 * V_75 , void * V_101 ,
struct V_158 * V_159 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_9 ( V_14 , V_26 , V_160 , V_159 ) ;
}
static int
...
return F_9 ( V_14 , V_3 , V_162 , V_159 ) ;
}
static int
...
return F_9 ( V_14 , V_3 , V_164 , V_159 ) ;
}
static int
F_76 ( struct V_165 * V_166 ,
unsigned int * V_167 , unsigned int * V_168 ,
unsigned int V_169 [] , struct V_170 * V_171 [] )
{
struct V_76 * V_101 = F_77 ( V_166 ) ;
struct V_2 * V_3 = V_101 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
unsigned long V_172 ;
F_47 ( 1 , V_102 , & V_5 -> V_103 , L_32 ) ;
V_172 = V_3 -> V_31 . V_31 . V_37 . V_173 ;
if ( V_166 -> V_174 + * V_167 < 3 )
* V_167 = 3 - V_166 -> V_174 ;
* V_168 = 1 ;
V_169 [ 0 ] = V_172 ;
F_47 ( 1 , V_102 , & V_5 -> V_103 ,
...
static int F_78 ( struct V_175 * V_91 )
{
struct V_76 * V_101 = F_77 ( V_91 -> V_165 ) ;
struct V_2 * V_3 = V_101 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
unsigned long V_94 ;
...
V_91 -> V_54 != V_176 )
return 0 ;
F_79 ( V_91 , 0 , V_3 -> V_31 . V_31 . V_37 . V_173 ) ;
if ( F_80 ( V_91 , 0 ) &&
F_81 ( V_91 , 0 ) > F_82 ( V_91 , 0 ) )
return - V_16 ;
V_94 = F_37 ( V_91 , 0 ) ;
if ( ! F_83 ( V_94 , 32 ) )
return - V_16 ;
...
static void F_84 ( struct V_175 * V_91 )
{
struct V_177 * V_178 = F_85 ( V_91 ) ;
struct V_76 * V_101 = F_77 ( V_91 -> V_165 ) ;
struct V_2 * V_3 = V_101 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_44 * V_45 = & V_3 -> V_45 ;
...
static int F_92 ( struct V_165 * V_166 , unsigned int V_183 )
{
struct V_76 * V_101 = F_77 ( V_166 ) ;
struct V_2 * V_3 = V_101 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_187 ) ;
F_93 (buf, tmp, &video->dma_queue, list) {
F_36 ( & V_179 -> V_90 ) ;
...
static int F_94 ( struct V_175 * V_91 )
{
struct V_177 * V_178 = F_85 ( V_91 ) ;
struct V_89 * V_179 = F_46 ( V_178 ,
struct V_89 , V_91 ) ;
...
static void F_97 ( struct V_175 * V_91 )
{
struct V_177 * V_178 = F_85 ( V_91 ) ;
struct V_76 * V_101 = F_77 ( V_91 -> V_165 ) ;
struct V_2 * V_3 = V_101 -> V_3 ;
...
static int F_99 ( struct V_75 * V_75 , void * V_109 ,
struct V_189 * V_190 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_3 -> V_105 = 1 ;
F_95 ( & V_3 -> V_87 ) ;
V_32 = F_101 ( & V_3 -> V_104 , V_190 ) ;
V_142:
F_15 ( & V_3 -> V_80 ) ;
return V_32 ;
}
static int F_102 ( struct V_75 * V_75 , void * V_109 ,
struct V_205 * V_179 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
F_47 ( 1 , V_102 , & V_5 -> V_103 , L_40 ) ;
if ( V_179 -> type != V_112 &&
V_179 -> type != V_49 ) {
F_61 ( & V_5 -> V_103 , L_41 ) ;
return - V_16 ;
...
return F_103 ( & V_3 -> V_104 , V_179 ) ;
}
static int F_104 ( struct V_75 * V_75 , void * V_109 ,
struct V_205 * V_207 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_76 * V_101 = V_75 -> V_84 ;
F_47 ( 1 , V_102 , & V_5 -> V_103 , L_43 ) ;
if ( V_207 -> type != V_112 &&
V_207 -> type != V_49 ) {
F_61 ( & V_5 -> V_103 , L_41 ) ;
return - V_16 ;
...
return F_105 ( & V_3 -> V_104 , V_207 ) ;
}
static int F_106 ( struct V_75 * V_75 , void * V_109 ,
struct V_205 * V_179 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_107 ( & V_3 -> V_104 ,
V_179 , ( V_75 -> V_209 & V_210 ) ) ;
}
static int F_108 ( struct V_75 * V_75 , void * V_109 ,
enum V_211 V_212 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_109 ( & V_3 -> V_104 , V_212 ) ;
}
static int F_110 ( struct V_75 * V_75 , void * V_109 ,
enum V_211 V_212 )
{
struct V_2 * V_3 = F_30 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_3 -> V_40 . V_217 = V_218 ;
V_3 -> V_40 . V_219 = & V_220 ;
V_3 -> V_40 . V_221 = & V_222 ;
V_3 -> V_40 . V_223 = - 1 ;
V_3 -> V_40 . V_150 = 0 ;
...
{
int V_32 ;
V_3 -> V_40 . V_103 = V_226 ;
V_32 = F_117 ( & V_3 -> V_40 , V_227 , - 1 ) ;
if ( V_32 < 0 )
F_3 ( L_53 ,
V_228 , V_32 ) ;
return V_32 ;
