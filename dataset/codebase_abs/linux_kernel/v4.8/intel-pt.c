...
if ( ! ( V_161 -> type & V_241 ) )
return 0 ;
if ( T_1 -> V_128 . V_129 || T_1 -> V_128 . V_242 )
...
V_26 -> V_180 = V_247 ;
} else if ( V_26 -> V_180 == V_247 ) {
V_26 -> V_180 = V_244 ;
} else if ( V_26 -> V_180 == V_244 &&
V_161 -> V_77 == T_1 -> V_248 &&
( V_26 -> V_162 & V_167 ) ) {
V_26 -> V_180 = V_246 ;
}
return 0 ;
}
static T_4 F_87 ( struct V_1 * T_1 , T_4 * V_248 )
{
struct V_35 * V_35 = T_1 -> V_35 ;
struct V_93 * V_93 ;
struct V_249 * V_250 , * V_18 ;
T_4 V_76 , V_235 = 0 ;
const char * V_251 ;
if ( V_248 )
* V_248 = 0 ;
...
for ( V_250 = V_18 ; V_250 ; V_250 = F_90 ( V_250 ) ) {
if ( V_250 -> V_252 == V_253 &&
! strcmp ( V_250 -> V_254 , L_21 ) ) {
V_76 = V_93 -> V_255 ( V_93 , V_250 -> V_18 ) ;
...
V_161 -> V_184 , V_161 -> V_259 ) ;
V_26 -> V_184 = V_161 -> V_259 ;
} else if ( T_1 -> V_179 &&
V_26 -> V_180 == V_244 &&
...
if ( ! T_1 -> V_187 . V_262 )
return 0 ;
if ( T_1 -> V_187 . V_263 [ 0 ] . V_264 >= V_184 )
return 0 ;
V_33 = T_1 -> V_187 . V_263 [ 0 ] . V_33 ;
V_28 = & T_1 -> V_39 . V_40 [ V_33 ] ;
V_26 = V_28 -> V_158 ;
F_9 ( L_28 V_185 L_29 V_185 L_15 ,
V_33 , T_1 -> V_187 . V_263 [ 0 ] . V_264 ,
V_184 ) ;
F_95 ( & T_1 -> V_187 ) ;
if ( T_1 -> V_187 . V_262 ) {
V_261 = T_1 -> V_187 . V_263 [ 0 ] . V_264 + 1 ;
if ( V_261 > V_184 )
V_261 = V_184 ;
} else {
V_261 = V_184 ;
...
V_8 = F_91 ( V_26 , & V_261 ) ;
if ( V_8 < 0 ) {
F_63 ( & T_1 -> V_187 , V_33 , V_261 ) ;
return V_8 ;
}
if ( ! V_8 ) {
V_8 = F_63 ( & T_1 -> V_187 , V_33 , V_261 ) ;
if ( V_8 < 0 )
return V_8 ;
} else {
V_26 -> V_178 = false ;
...
{
return F_78 ( T_1 , V_267 , V_204 -> V_30 ,
...
for ( V_268 = 0 ; V_10 > 0 ; V_268 ++ ) {
if ( T_1 -> V_39 . V_40 [ -- V_10 ] . V_30 == V_30 )
return T_1 -> V_39 . V_40 [ V_10 ] . V_158 ;
}
for (; V_268 < T_1 -> V_39 . V_188 ; V_268 ++ ) {
if ( T_1 -> V_39 . V_40 [ V_268 ] . V_30 == V_30 )
return T_1 -> V_39 . V_40 [ V_268 ] . V_158 ;
}
return NULL ;
}
...
T_8 V_32 ;
int V_30 , V_8 ;
V_109 = F_102 ( T_1 -> V_42 -> V_269 , V_204 -> V_216 ) ;
if ( V_109 != T_1 -> V_270 )
return 0 ;
V_32 = F_103 ( V_109 , V_204 , L_31 ) ;
V_30 = V_204 -> V_30 ;
F_9 ( L_32 V_271 L_33 V_185 L_15 ,
...
struct V_203 * V_204 )
{
bool V_102 = V_202 -> V_206 . V_213 & V_272 ;
T_8 V_31 , V_32 ;
int V_30 , V_8 ;
V_30 = V_204 -> V_30 ;
if ( T_1 -> V_159 == 3 ) {
if ( ! V_102 )
return 0 ;
if ( V_202 -> V_206 . type != V_273 ) {
F_74 ( L_34 ) ;
return - V_22 ;
}
V_31 = V_202 -> V_274 . V_275 ;
V_32 = V_202 -> V_274 . V_276 ;
} else {
if ( V_102 )
return 0 ;
V_31 = V_204 -> V_31 ;
...
F_9 ( L_36 V_271 L_33 V_185 L_15 ,
...
if ( ! T_1 -> V_256 )
return 0 ;
F_9 ( L_37 V_271 L_33 V_185 L_15 ,
V_204 -> V_30 , V_202 -> V_277 . V_31 ,
V_202 -> V_277 . V_32 , V_204 -> time ,
F_100 ( V_204 -> time , & T_1 -> V_122 ) ) ;
return F_82 ( T_1 -> V_35 , V_204 -> V_30 ,
V_202 -> V_277 . V_31 ,
V_202 -> V_277 . V_32 ) ;
}
static int F_106 ( struct V_278 * V_42 ,
union V_201 * V_202 ,
struct V_203 * V_204 ,
struct V_279 * V_280 )
{
struct V_1 * T_1 = F_107 ( V_42 -> V_281 , struct V_1 ,
V_281 ) ;
T_4 V_184 ;
int V_69 = 0 ;
if ( V_282 )
...
if ( V_69 )
return V_69 ;
if ( V_202 -> V_206 . type == V_286 &&
( V_202 -> V_287 . V_162 & V_288 ) &&
T_1 -> V_128 . V_257 ) {
V_69 = F_97 ( T_1 , V_204 ) ;
if ( V_69 )
return V_69 ;
}
if ( T_1 -> V_270 && V_202 -> V_206 . type == V_212 )
V_69 = F_101 ( T_1 , V_204 ) ;
else if ( V_202 -> V_206 . type == V_289 )
V_69 = F_105 ( T_1 , V_202 , V_204 ) ;
else if ( V_202 -> V_206 . type == V_290 ||
V_202 -> V_206 . type == V_273 )
V_69 = F_104 ( T_1 , V_202 , V_204 ) ;
F_9 ( L_39 V_271 L_33 V_185 L_15 ,
F_108 ( V_202 -> V_206 . type ) , V_202 -> V_206 . type ,
V_204 -> V_30 , V_204 -> time , V_184 ) ;
return V_69 ;
}
static int F_109 ( struct V_278 * V_42 , struct V_279 * V_280 )
{
struct V_1 * T_1 = F_107 ( V_42 -> V_281 , struct V_1 ,
V_281 ) ;
int V_8 ;
...
return F_96 ( T_1 , - 1 ,
V_291 - 1 ) ;
return F_94 ( T_1 , V_291 ) ;
}
static void F_110 ( struct V_278 * V_42 )
{
struct V_1 * T_1 = F_107 ( V_42 -> V_281 , struct V_1 ,
V_281 ) ;
struct V_266 * V_39 = & T_1 -> V_39 ;
...
static void F_113 ( struct V_278 * V_42 )
{
struct V_1 * T_1 = F_107 ( V_42 -> V_281 , struct V_1 ,
V_281 ) ;
F_114 ( & T_1 -> V_187 ) ;
...
static int F_116 ( struct V_278 * V_42 ,
union V_201 * V_202 ,
struct V_279 * V_280 V_2 )
{
struct V_1 * T_1 = F_107 ( V_42 -> V_281 , struct V_1 ,
V_281 ) ;
if ( T_1 -> V_49 )
...
static int F_121 ( struct V_279 * V_280 ,
union V_201 * V_202 ,
struct V_203 * V_204 V_2 ,
struct V_35 * V_35 V_2 )
{
struct V_296 * V_296 =
F_107 ( V_280 , struct V_296 , V_297 ) ;
return F_73 ( V_296 -> V_42 , V_202 ,
NULL ) ;
}
static int F_122 ( struct V_278 * V_42 ,
struct V_104 * V_105 , T_4 V_216 )
{
struct V_296 V_296 ;
memset ( & V_296 , 0 , sizeof( struct V_296 ) ) ;
V_296 . V_42 = V_42 ;
return F_123 ( & V_296 . V_297 , V_105 , 1 ,
& V_216 , F_121 ) ;
}
static int F_124 ( struct V_1 * T_1 ,
struct V_278 * V_42 )
{
struct V_298 * V_269 = V_42 -> V_269 ;
struct V_108 * V_109 ;
struct V_104 V_105 ;
bool V_299 = false ;
T_4 V_216 ;
int V_69 ;
F_43 (evlist, evsel) {
if ( V_109 -> V_105 . type == T_1 -> V_107 && V_109 -> V_300 ) {
V_299 = true ;
break;
}
}
...
V_105 . type = V_301 ;
V_105 . V_117 = V_109 -> V_105 . V_117 & V_302 ;
V_105 . V_117 |= V_303 | V_304 |
V_305 ;
if ( T_1 -> V_114 )
...
V_105 . V_314 = T_1 -> V_128 . V_150 ;
T_1 -> V_315 = V_105 . V_314 ;
if ( T_1 -> V_128 . V_129 )
V_105 . V_117 |= V_316 ;
if ( T_1 -> V_128 . V_135 )
V_105 . V_117 |= V_317 ;
F_125 ( L_41 V_271 L_42 V_185 L_15 ,
...
if ( T_1 -> V_128 . V_135 )
V_105 . V_117 |= V_317 ;
F_125 ( L_44 V_271 L_42 V_185 L_15 ,
V_216 , ( T_4 ) V_105 . V_117 ) ;
V_69 = F_122 ( V_42 , & V_105 , V_216 ) ;
if ( V_69 ) {
F_74 ( L_45 ,
...
V_105 . V_117 &= ~ ( T_4 ) V_317 ;
F_125 ( L_47 V_271 L_42 V_185 L_15 ,
V_216 , ( T_4 ) V_105 . V_117 ) ;
V_69 = F_122 ( V_42 , & V_105 , V_216 ) ;
if ( V_69 ) {
F_74 ( L_48 ,
...
T_1 -> V_223 = V_109 -> V_323 ;
return 0 ;
}
static struct V_108 * F_127 ( struct V_298 * V_269 )
{
struct V_108 * V_109 ;
F_128 (evlist, evsel) {
const char * V_254 = F_129 ( V_109 ) ;
if ( ! strcmp ( V_254 , L_49 ) )
return V_109 ;
}
return NULL ;
}
static bool F_130 ( struct V_298 * V_269 )
{
struct V_108 * V_109 ;
F_43 (evlist, evsel) {
if ( V_109 -> V_105 . V_274 )
return true ;
}
return false ;
}
...
static void F_133 ( T_4 * V_324 , int V_18 , int V_325 )
{
int V_10 ;
if ( ! V_282 )
return;
for ( V_10 = V_18 ; V_10 <= V_325 ; V_10 ++ )
fprintf ( stdout , V_326 [ V_10 ] , V_324 [ V_10 ] ) ;
}
int F_134 ( union V_201 * V_202 ,
struct V_278 * V_42 )
{
struct V_327 * V_328 = & V_202 -> V_328 ;
T_2 V_329 = sizeof( T_4 ) * V_330 ;
struct V_1 * T_1 ;
int V_69 ;
if ( V_328 -> V_206 . V_20 < sizeof( struct V_327 ) +
V_329 )
return - V_22 ;
...
F_136 ( V_332 ) ;
T_1 -> V_42 = V_42 ;
T_1 -> V_35 = & V_42 -> V_333 . V_334 ;
T_1 -> V_335 = V_328 -> type ;
T_1 -> V_107 = V_328 -> V_158 [ V_336 ] ;
T_1 -> V_122 . V_124 = V_328 -> V_158 [ V_337 ] ;
T_1 -> V_122 . V_123 = V_328 -> V_158 [ V_338 ] ;
T_1 -> V_122 . V_339 = V_328 -> V_158 [ V_340 ] ;
T_1 -> V_116 = V_328 -> V_158 [ V_341 ] ;
T_1 -> V_115 = V_328 -> V_158 [ V_342 ] ;
T_1 -> V_111 = V_328 -> V_158 [ V_343 ] ;
T_1 -> V_159 = V_328 -> V_158 [ V_344 ] ;
T_1 -> V_45 = V_328 -> V_158 [ V_345 ] ;
T_1 -> V_256 = V_328 -> V_158 [ V_330 ] ;
F_133 ( & V_328 -> V_158 [ 0 ] , V_336 ,
V_330 ) ;
if ( V_328 -> V_206 . V_20 >= sizeof( struct V_327 ) +
( sizeof( T_4 ) * V_346 ) ) {
T_1 -> V_347 = V_328 -> V_158 [ V_348 ] ;
T_1 -> V_113 = V_328 -> V_158 [ V_349 ] ;
T_1 -> V_147 = V_328 -> V_158 [ V_350 ] ;
T_1 -> V_148 = V_328 -> V_158 [ V_351 ] ;
T_1 -> V_352 = V_328 -> V_158 [ V_346 ] ;
F_133 ( & V_328 -> V_158 [ 0 ] , V_348 ,
V_346 ) ;
}
T_1 -> V_114 = F_46 ( T_1 ) ;
T_1 -> V_21 = F_48 ( T_1 ) ;
...
T_1 -> V_281 . V_356 = F_106 ;
T_1 -> V_281 . V_357 = F_116 ;
T_1 -> V_281 . V_358 = F_109 ;
T_1 -> V_281 . V_359 = F_110 ;
T_1 -> V_281 . free = F_113 ;
V_42 -> V_281 = & T_1 -> V_281 ;
if ( V_282 )
return 0 ;
if ( T_1 -> V_159 == 1 ) {
T_1 -> V_270 = F_127 ( V_42 -> V_269 ) ;
if ( ! T_1 -> V_270 ) {
F_74 ( L_52 , V_318 ) ;
goto V_355;
}
...
if ( V_42 -> V_360 && V_42 -> V_360 -> V_361 ) {
T_1 -> V_128 = * V_42 -> V_360 ;
} else {
F_141 ( & T_1 -> V_128 ) ;
if ( V_362 != - 1 ) {
T_1 -> V_128 . V_320 = false ;
...
F_142 () ;
if ( T_1 -> V_122 . V_123 ) {
T_4 V_363 = F_49 ( T_1 , 1000000000 ) ;
T_1 -> V_145 = ( V_363 + 50000000 ) / 100000000 ;
F_9 ( L_54 V_271 L_15 , V_363 ) ;
F_9 ( L_55 ,
T_1 -> V_145 ) ;
}
if ( T_1 -> V_128 . V_364 )
...
T_1 -> V_209 |= V_366 |
V_174 ;
if ( T_1 -> V_128 . V_129 && ! V_367 . V_368 ) {
V_367 . V_368 = true ;
if ( F_143 ( & V_369 ) < 0 ) {
V_367 . V_368 = false ;
