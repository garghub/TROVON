...
break;
case V_123 :
V_83 = ( unsigned char ) ( 1 + ( ( V_106 >> 11 ) & 0x03 ) ) ;
V_106 = V_106 & 0x7ff ;
if ( V_83 > 3 )
goto V_118;
break;
...
static int F_29 ( struct V_103 * V_104 )
{
struct V_1 * V_2 ;
struct V_3 * V_4 ;
struct V_33 * V_8 ;
...
static struct V_134 *
F_31 ( struct V_103 * V_104 , T_4 V_135 )
{
struct V_29 * V_42 = NULL ;
V_42 = F_32 ( sizeof *V_42 , V_135 ) ;
if ( ! V_42 )
return NULL ;
...
static void F_34 ( struct V_103 * V_104 , struct V_134 * V_137 )
{
struct V_29 * V_42 = NULL ;
...
static void F_36 ( struct V_103 * V_104 )
{
struct V_1 * V_2 ;
T_1 V_40 , V_37 ;
struct V_3 * V_4 ;
...
static int
F_37 ( struct V_103 * V_104 , struct V_134 * V_137 , T_4 V_135 )
{
...
return - V_117 ;
V_42 -> V_4 = V_4 ;
V_38 = F_39 ( & V_2 -> V_114 , V_137 , F_11 ( V_4 ) ) ;
if ( V_38 )
return V_38 ;
...
if ( V_4 -> V_60 == 0 )
V_2 -> V_24 = V_147 ;
F_40 ( & V_42 -> V_68 , & V_4 -> V_68 ) ;
F_28 ( & V_2 -> V_124 , V_109 ) ;
return 0 ;
V_146:
F_41 ( & V_2 -> V_114 , V_137 , F_11 ( V_4 ) ) ;
return V_38 ;
}
static void F_42 ( struct V_3 * V_4 , struct V_29 * V_42 )
{
...
static int F_43 ( struct V_103 * V_104 , struct V_134 * V_137 )
{
struct V_3 * V_4 = F_25 ( V_104 , struct V_3 , V_4 ) ;
struct V_29 * V_42 ;
struct V_1 * V_2 = V_4 -> V_2 ;
...
static void F_45 ( struct V_1 * V_2 , T_5 V_60 , T_5 V_37 , int V_155 )
{
T_1 V_5 ;
...
static int F_46 ( struct V_1 * V_2 , T_5 V_60 , T_5 V_37 )
{
T_1 V_5 ;
V_5 = F_2 ( & V_2 -> V_16 -> V_5 [ V_60 ] ) ;
if ( V_37 == V_27 )
...
static int F_47 ( struct V_103 * V_104 , int V_156 , int V_157 )
{
struct V_3 * V_4 ;
...
F_27 ( & V_4 -> V_2 -> V_124 , V_109 ) ;
F_45 ( V_2 , V_4 -> V_60 , F_11 ( V_4 ) , V_156 ) ;
if ( V_156 && V_157 )
V_4 -> V_157 = 1 ;
else if ( ! V_156 )
V_4 -> V_157 = 0 ;
...
static int F_48 ( struct V_103 * V_104 , int V_156 )
{
return F_47 ( V_104 , V_156 , 0 ) ;
}
static int F_49 ( struct V_103 * V_104 )
{
return F_47 ( V_104 , 1 , 1 ) ;
}
...
static int F_61 ( struct V_193 * V_114 )
{
struct V_1 * V_2 ;
T_3 V_38 ;
if ( ! V_114 )
...
static int F_63 ( struct V_193 * V_114 , int V_201 )
{
struct V_1 * V_2 ;
unsigned long V_109 ;
int V_38 = 0 ;
...
static int F_65 ( struct V_193 * V_114 , int V_204 )
{
struct V_1 * V_2 ;
unsigned long V_109 ;
int V_38 = 0 ;
...
V_4 -> V_60 = V_6 / 2 ;
F_33 ( & V_4 -> V_68 ) ;
F_40 ( & V_4 -> V_4 . V_217 , & V_2 -> V_114 . V_217 ) ;
V_4 -> V_8 = & V_2 -> V_9 [ V_6 ] ;
}
return 0 ;
}
static void F_30 ( struct V_3 * V_4 , int V_65 )
{
V_4 -> V_126 = 1 ;
F_36 ( & V_4 -> V_4 ) ;
while ( ! F_12 ( & V_4 -> V_68 ) ) {
...
static void F_68 ( struct V_1 * V_2 , struct V_218 * V_113 )
{
struct V_3 * V_4 ;
F_30 ( & V_2 -> V_7 [ 0 ] , - V_117 ) ;
F_44 (ep, &udc->gadget.ep_list, ep.ep_list) {
F_30 ( V_4 , - V_117 ) ;
}
if ( V_113 ) {
F_69 ( & V_2 -> V_124 ) ;
F_70 ( & V_2 -> V_114 , V_113 ) ;
F_71 ( & V_2 -> V_124 ) ;
}
}
static void F_64 ( struct V_1 * V_2 , struct V_218 * V_113 )
{
struct V_3 * V_4 ;
F_30 ( & V_2 -> V_7 [ 0 ] , - V_117 ) ;
F_44 (ep, &udc->gadget.ep_list, ep.ep_list) {
...
static int F_72 ( struct V_193 * V_114 ,
struct V_218 * V_113 )
{
struct V_1 * V_2 ;
int V_38 = 0 ;
...
if ( V_2 -> V_226 )
F_74 ( V_2 -> V_226 , & V_2 -> V_227 ) ;
return 0 ;
}
static int F_75 ( struct V_193 * V_114 )
{
struct V_1 * V_2 ;
unsigned long V_109 ;
V_2 = F_25 ( V_114 , struct V_1 , V_114 ) ;
...
static void F_76 ( struct V_1 * V_2 , T_1 V_228 )
{
T_1 V_169 ;
V_169 = F_2 ( & V_2 -> V_16 -> V_169 [ 0 ] ) ;
V_169 |= V_228 << 16 ;
...
static void F_77 ( struct V_103 * V_4 , struct V_134 * V_137 )
{
...
static int
F_78 ( struct V_1 * V_2 , T_5 V_37 , T_3 V_65 , bool V_231 )
{
int V_38 = 0 ;
struct V_29 * V_42 ;
struct V_3 * V_4 ;
...
V_42 -> V_42 . V_79 = F_80 ( V_4 -> V_2 -> V_114 . V_47 . V_234 ,
...
return 0 ;
V_149:
F_41 ( & V_2 -> V_114 , & V_42 -> V_42 , F_11 ( V_4 ) ) ;
return V_38 ;
}
...
static void F_83 ( struct V_1 * V_2 , T_5 V_60 ,
struct V_239 * V_240 )
{
T_3 V_65 = 0 ;
int V_38 ;
...
? V_127 : V_27 ;
V_65 = F_46 ( V_2 , V_60 , V_37 )
<< V_257 ;
}
V_38 = F_78 ( V_2 , V_127 , V_65 , false ) ;
if ( V_38 )
F_4 ( V_2 ) ;
else
V_2 -> V_24 = V_147 ;
...
static void F_86 ( struct V_1 * V_2 , T_5 V_60 ,
struct V_239 * V_240 )
__releases( &ep->udc->lock
...
static void F_88 ( struct V_1 * V_2 , T_5 V_60 , T_5 * V_268 )
{
T_1 V_82 ;
struct V_33 * V_8 ;
...
static T_6 F_96 ( int V_288 , void * V_47 )
{
...
static void F_98 ( struct V_298 * V_299 )
{
struct V_1 * V_2 ;
unsigned int V_300 ;
...
static void F_99 ( struct V_304 * V_305 )
{
struct V_1 * V_2 ;
V_2 = F_100 ( V_305 ) ;
V_142 ( V_2 -> F_9 ) ;
}
static int F_101 ( struct V_306 * V_307 )
{
struct V_1 * V_2 ;
V_2 = F_102 ( V_307 ) ;
F_103 ( & V_2 -> V_114 ) ;
...
F_106 ( V_2 -> V_88 ) ;
if ( V_2 -> V_9 )
F_107 ( & V_307 -> V_47 , V_2 -> V_308 ,
V_2 -> V_9 , V_2 -> V_177 ) ;
F_60 ( V_2 ) ;
F_108 ( V_2 -> F_9 ) ;
return 0 ;
}
static int F_109 ( struct V_306 * V_307 )
{
struct V_309 * V_188 = F_110 ( & V_307 -> V_47 ) ;
struct V_1 * V_2 ;
int V_38 = 0 ;
struct V_310 * V_311 ;
T_7 V_312 ;
...
V_2 = F_111 ( & V_307 -> V_47 , sizeof( * V_2 ) , V_313 ) ;
if ( V_2 == NULL )
return - V_101 ;
V_2 -> F_9 = & V_314 ;
V_2 -> V_188 = F_110 ( & V_307 -> V_47 ) ;
F_112 ( & V_2 -> V_124 ) ;
V_2 -> V_47 = V_307 ;
if ( V_188 -> V_228 == V_315 ) {
V_2 -> V_224 = F_113 ( & V_307 -> V_47 ,
V_316 ) ;
if ( F_114 ( V_2 -> V_224 ) ) {
V_38 = F_115 ( V_2 -> V_224 ) ;
if ( V_38 == - V_317 )
return V_38 ;
V_2 -> V_224 = NULL ;
return - V_318 ;
...
V_2 -> V_160 = F_116 ( & V_307 -> V_47 , NULL ) ;
if ( F_114 ( V_2 -> V_160 ) )
return F_115 ( V_2 -> V_160 ) ;
V_311 = F_117 ( V_2 -> V_47 , V_319 , L_35 ) ;
if ( V_311 == NULL ) {
F_16 ( & V_307 -> V_47 , L_36 ) ;
return - V_194 ;
}
V_2 -> V_180 = (struct V_320 V_321 * )
F_118 ( & V_307 -> V_47 , V_311 -> V_322 , F_119 ( V_311 ) ) ;
if ( V_2 -> V_180 == NULL ) {
F_16 ( & V_307 -> V_47 , L_37 ) ;
return - V_220 ;
}
V_311 = F_117 ( V_2 -> V_47 , V_319 , L_38 ) ;
if ( V_311 == NULL ) {
F_16 ( & V_307 -> V_47 , L_39 ) ;
return - V_194 ;
}
V_2 -> V_190 = F_118 ( & V_307 -> V_47 , V_311 -> V_322 , F_119 ( V_311 ) ) ;
if ( V_2 -> V_190 == NULL ) {
...
V_2 -> V_9 = F_120 ( & V_307 -> V_47 , V_312 ,
& V_2 -> V_177 , V_313 ) ;
if ( V_2 -> V_9 == NULL ) {
...
V_2 -> V_7 = F_111 ( & V_307 -> V_47 , V_312 , V_313 ) ;
if ( V_2 -> V_7 == NULL ) {
V_38 = - V_101 ;
goto V_333;
}
V_2 -> V_233 = F_111 ( & V_307 -> V_47 , sizeof( struct V_29 ) ,
V_313 ) ;
if ( ! V_2 -> V_233 ) {
V_38 = - V_101 ;
goto V_333;
...
F_33 ( & V_2 -> V_233 -> V_68 ) ;
V_2 -> V_233 -> V_42 . V_143 = F_32 ( 8 , V_313 ) ;
V_2 -> V_233 -> V_42 . V_79 = V_136 ;
V_2 -> V_278 = V_334 ;
V_2 -> V_222 = V_335 ;
V_2 -> V_26 = V_27 ;
V_2 -> V_197 = 0 ;
V_311 = F_122 ( V_2 -> V_47 , V_336 , 0 ) ;
if ( V_311 == NULL ) {
...
if ( F_123 ( & V_307 -> V_47 , V_2 -> V_288 , F_96 ,
V_337 , V_338 , V_2 ) ) {
...
V_2 -> V_226 = F_125 ( L_48 ) ;
if ( ! V_2 -> V_226 ) {
F_16 ( & V_307 -> V_47 , L_49 ) ;
V_38 = - V_101 ;
goto V_333;
}
F_126 ( & V_2 -> V_227 , F_98 ) ;
}
if ( V_2 -> V_191 )
F_59 ( V_2 ) ;
else
V_2 -> V_202 = 1 ;
V_38 = F_127 ( & V_307 -> V_47 , & V_2 -> V_114 ,
F_99 ) ;
if ( V_38 )
goto V_342;
F_128 ( V_307 , V_2 ) ;
...
static int F_129 ( struct V_304 * V_47 )
{
struct V_1 * V_2 ;
V_2 = F_100 ( V_47 ) ;
if ( V_2 -> V_224 )
...
static int F_132 ( struct V_304 * V_47 )
{
struct V_1 * V_2 ;
int V_38 ;
V_2 = F_100 ( V_47 ) ;
...
static void F_133 ( struct V_306 * V_307 )
{
struct V_1 * V_2 ;
T_1 V_228 ;
V_2 = F_102 ( V_307 ) ;
