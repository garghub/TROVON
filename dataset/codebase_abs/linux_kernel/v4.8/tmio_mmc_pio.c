...
V_38 -> V_228 . V_229 >= 0 ) ;
if ( F_72 ( V_204 ) < 0 ) {
V_38 -> V_230 = V_48 -> V_231 ;
V_38 -> V_56 = V_38 -> V_230 / 512 ;
}
if ( V_38 -> V_56 == 0 ) {
V_165 = - V_94 ;
goto V_209;
...
F_106 ( & V_204 -> V_68 ) ;
F_107 ( & V_204 -> V_180 ) ;
F_108 ( & V_204 -> V_65 , F_25 ) ;
F_109 ( & V_204 -> V_76 , F_37 ) ;
F_110 ( V_204 , V_48 ) ;
F_111 ( & V_59 -> V_71 ) ;
F_112 ( & V_59 -> V_71 , 50 ) ;
F_113 ( & V_59 -> V_71 ) ;
...
int F_127 ( struct V_179 * V_71 )
{
struct V_37 * V_38 = F_128 ( V_71 ) ;
struct V_1 * V_2 = F_13 ( V_38 ) ;
F_3 ( V_2 , V_232 ) ;
if ( V_2 -> V_189 )
F_22 ( V_2 ) ;
