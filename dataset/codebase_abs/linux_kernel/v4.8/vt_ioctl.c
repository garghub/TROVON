...
void F_80 ( struct V_205 * V_206 )
{
struct V_52 * V_207 =
F_81 ( V_206 , struct V_52 , V_208 ) ;
struct V_51 * V_52 ;
struct V_66 * V_67 ;
F_25 () ;
V_52 = V_207 -> V_46 ;
...
static inline int
F_83 ( int V_27 , struct V_209 T_1 * V_29 ,
int V_30 , struct V_31 * V_32 )
{
struct V_209 V_33 ;
int V_34 ;
if ( F_15 ( & V_33 , V_29 , sizeof( struct V_209 ) ) )
return - V_20 ;
switch ( V_27 ) {
case V_35 :
if ( ! V_30 )
...
V_33 . V_41 = V_32 -> V_40 ;
V_33 . V_42 = V_32 -> V_42 ;
if ( F_16 ( V_29 , & V_33 , sizeof( struct V_209 ) ) )
return - V_20 ;
return 0 ;
}
return - V_22 ;
...
static inline int
F_85 ( struct V_210 T_1 * V_211 ,
int V_30 , struct V_31 * V_32 , struct V_51 * V_52 )
{
int V_34 ;
if ( F_15 ( V_32 , V_211 , sizeof( struct V_210 ) ) )
return - V_20 ;
if ( ! V_30 && V_32 -> V_32 != V_48 )
return - V_36 ;
V_32 -> V_43 = F_84 ( ( (struct V_210 * ) V_32 ) -> V_43 ) ;
V_34 = F_19 ( V_52 , V_32 ) ;
if ( V_34 )
return V_34 ;
( (struct V_210 * ) V_32 ) -> V_43 = ( unsigned long ) V_32 -> V_43 ;
if ( F_16 ( V_211 , V_32 , sizeof( struct V_210 ) ) )
return - V_20 ;
return 0 ;
}
static inline int
F_86 ( unsigned int V_27 , struct V_212 T_1 * V_50 ,
int V_30 , struct V_51 * V_52 )
{
struct V_212 V_53 ;
struct V_57 T_1 * V_213 ;
if ( F_15 ( & V_53 , V_50 , sizeof V_53 ) )
return - V_20 ;
V_213 = F_84 ( V_53 . V_54 ) ;
if ( V_213 )
if ( ! F_21 ( V_55 , V_213 ,
V_53 . V_56 * sizeof( struct V_57 ) ) )
return - V_20 ;
...
if ( ! V_30 )
return - V_36 ;
return F_22 ( V_52 , V_53 . V_56 , V_213 ) ;
case V_59 :
if ( ! V_30 && V_26 != V_52 -> V_60 )
return - V_36 ;
return F_23 ( V_52 , V_53 . V_56 , & ( V_50 -> V_56 ) , V_213 ) ;
}
return 0 ;
}
...
if ( V_52 -> V_133 . V_134 == V_136 ) {
if ( F_89 ( V_52 -> V_138 , V_52 -> V_133 . V_204 , 1 ) != 0 ) {
F_76 ( V_52 ) ;
if ( V_215 != V_52 -> V_102 ) {
if ( V_52 -> V_102 == V_101 )
F_42 ( 1 ) ;
...
void F_90 ( struct V_51 * V_217 )
{
struct V_51 * V_52 ;
if ( ! V_217 || V_217 -> V_60 == V_26 || V_197 )
return;
V_52 = V_45 [ V_26 ] . V_46 ;
if ( V_52 -> V_133 . V_134 == V_136 ) {
V_52 -> V_139 = V_217 -> V_60 ;
if ( F_89 ( V_52 -> V_138 , V_52 -> V_133 . V_203 , 1 ) == 0 ) {
return;
}
F_76 ( V_52 ) ;
}
...
int F_91 ( unsigned int V_218 , int V_219 )
{
int V_220 ;
F_25 () ;
if ( V_221 ) {
