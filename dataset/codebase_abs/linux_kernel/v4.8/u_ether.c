...
const struct V_120 * V_103 ;
const struct V_120 * V_37 ;
if ( V_90 -> V_121 )
V_90 -> V_121 ( V_90 ) ;
V_103 = V_90 -> V_92 -> V_122 ;
V_37 = V_90 -> V_41 -> V_122 ;
F_61 ( V_90 -> V_92 ) ;
F_61 ( V_90 -> V_41 ) ;
if ( F_44 ( V_9 ) ) {
F_11 ( V_18 , L_16 ) ;
V_90 -> V_92 -> V_122 = V_103 ;
V_90 -> V_41 -> V_122 = V_37 ;
F_62 ( V_90 -> V_92 ) ;
F_62 ( V_90 -> V_41 ) ;
}
}
...
static int F_67 ( T_5 V_124 [ V_126 ] , char * V_123 , int V_68 )
{
if ( V_68 < 18 )
return - V_127 ;
snprintf ( V_123 , V_68 , L_17 , V_124 ) ;
return 18 ;
}
...
int F_91 ( struct V_8 * V_9 , char * V_124 , int V_68 )
{
struct V_17 * V_18 ;
V_18 = F_5 ( V_9 ) ;
return F_67 ( V_18 -> V_139 , V_124 , V_68 ) ;
}
...
int F_93 ( struct V_8 * V_9 , char * V_129 , int V_68 )
{
struct V_17 * V_18 ;
V_18 = F_5 ( V_9 ) ;
return F_67 ( V_18 -> V_132 , V_129 , V_68 ) ;
}
int F_94 ( struct V_8 * V_9 , char * V_129 , int V_68 )
{
struct V_17 * V_18 ;
if ( V_68 < 13 )
return - V_127 ;
V_18 = F_5 ( V_9 ) ;
snprintf ( V_129 , V_68 , L_26 , V_18 -> V_132 ) ;
return strlen ( V_129 ) ;
}
...
int F_98 ( struct V_8 * V_9 , char * V_23 , int V_68 )
{
F_86 () ;
F_6 ( V_23 , F_99 ( V_9 ) , V_68 ) ;
F_88 () ;
return strlen ( V_23 ) ;
}
...
struct V_8 * F_103 ( struct V_89 * V_90 )
{
struct V_17 * V_18 = V_90 -> V_146 ;
int V_147 = 0 ;
if ( ! V_18 )
return F_70 ( - V_127 ) ;
V_90 -> V_92 -> V_63 = V_18 ;
V_147 = F_62 ( V_90 -> V_92 ) ;
if ( V_147 != 0 ) {
F_11 ( V_18 , L_27 ,
V_90 -> V_92 -> V_23 , V_147 ) ;
goto V_148;
}
V_90 -> V_41 -> V_63 = V_18 ;
V_147 = F_62 ( V_90 -> V_41 ) ;
if ( V_147 != 0 ) {
F_11 ( V_18 , L_27 ,
V_90 -> V_41 -> V_23 , V_147 ) ;
goto V_149;
}
if ( V_147 == 0 )
V_147 = F_37 ( V_18 , V_90 , F_1 ( V_18 -> V_2 ,
V_18 -> V_3 ) ) ;
if ( V_147 == 0 ) {
V_18 -> V_115 = V_90 -> V_150 ;
