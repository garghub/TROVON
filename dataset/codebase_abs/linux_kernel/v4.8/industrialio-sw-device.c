...
F_2 (iter, &iio_device_types_list, list)
...
struct V_1 * V_5 ;
F_4 ( & V_7 ) ;
V_5 = F_1 ( V_14 -> V_2 , strlen ( V_14 -> V_2 ) ) ;
if ( V_5 )
F_11 ( & V_14 -> V_9 ) ;
F_6 ( & V_7 ) ;
F_12 ( V_14 -> V_11 ) ;
...
struct V_1 * V_14 ;
F_4 ( & V_7 ) ;
V_14 = F_1 ( V_2 , strlen ( V_2 ) ) ;
if ( V_14 && ! F_14 ( V_14 -> V_15 ) )
V_14 = NULL ;
F_6 ( & V_7 ) ;
return V_14 ;
}
struct V_16 * F_15 ( const char * type , const char * V_2 )
{
struct V_16 * V_4 ;
struct V_1 * V_14 ;
V_14 = F_13 ( type ) ;
...
void F_19 ( struct V_16 * V_4 )
{
struct V_1 * V_14 = V_4 -> V_21 ;
V_14 -> V_18 -> remove ( V_4 ) ;
F_18 ( V_14 -> V_15 ) ;
}
