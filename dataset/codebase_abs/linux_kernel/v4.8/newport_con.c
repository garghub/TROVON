...
static int F_44 ( struct V_97 * V_98 , int V_148 , int V_149 , int V_150 ,
int V_151 )
{
int V_117 , V_152 , V_153 ;
unsigned short * V_116 , * V_154 ;
unsigned short V_155 ;
V_35 = 0 ;
if ( V_148 == 0 && V_149 == V_98 -> V_103 ) {
if ( V_150 == V_156 ) {
V_17 = ( V_17 + ( V_151 << 4 ) ) & 0x3ff ;
F_11 ( V_98 -> V_103 - V_151 ,
V_98 -> V_103 - 1 ,
( V_98 -> V_108 & 0xf0 ) >> 4 ) ;
} else {
V_17 = ( V_17 + ( - V_151 << 4 ) ) & 0x3ff ;
...
V_117 = ( V_149 - V_148 - V_151 ) * V_98 -> V_102 ;
if ( V_150 == V_156 ) {
V_152 = 0 ;
V_153 = V_148 ;
V_116 = ( unsigned short * ) ( V_98 -> V_157 +
V_98 -> V_158 * ( V_148 + V_151 ) ) ;
V_154 = ( unsigned short * ) ( V_98 -> V_157 +
V_98 -> V_158 * V_148 ) ;
while ( V_117 -- ) {
V_155 = F_32 ( V_116 ++ ) ;
if ( V_155 != F_32 ( V_154 ) ) {
F_29 ( V_98 , V_155 , V_153 , V_152 ) ;
F_45 ( V_155 , V_154 ) ;
}
V_154 ++ ;
if ( ++ V_152 == V_98 -> V_102 ) {
...
V_154 = ( unsigned short * ) ( V_98 -> V_157 +
V_98 -> V_158 * ( V_149 - V_151 ) ) ;
V_152 = 0 ;
V_153 = V_149 - V_151 ;
for ( V_117 = 0 ; V_117 < ( V_151 * V_98 -> V_102 ) ; V_117 ++ ) {
if ( F_32 ( V_154 ) != V_98 -> V_159 ) {
F_29 ( V_98 , V_98 -> V_159 ,
V_153 , V_152 ) ;
F_45 ( V_98 -> V_159 , V_154 ) ;
}
V_154 ++ ;
if ( ++ V_152 == V_98 -> V_102 ) {
V_152 = 0 ;
...
static int F_46 ( struct V_97 * V_104 )
{
return 0 ;
}
...
if ( V_6 )
return - V_168 ;
V_164 = V_161 -> V_166 . V_167 + 0xF0000 ;
if ( ! F_48 ( V_164 , 0x10000 , L_4 ) )
return - V_169 ;
V_6 = (struct V_170 * )
F_49 ( V_164 , sizeof( struct V_170 ) ) ;
F_50 () ;
V_165 = F_51 ( & V_105 , 0 , V_86 - 1 , 1 ) ;
F_52 () ;
return V_165 ;
}
