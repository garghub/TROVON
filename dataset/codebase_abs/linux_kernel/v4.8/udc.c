...
if ( F_56 ( V_53 -> V_73 . V_133 ) &&
V_55 -> V_72 . V_56 > ( 1 + V_53 -> V_73 . V_149 ) * V_53 -> V_73 . V_74 ) {
...
* ( V_158 * ) V_72 -> V_146 = F_12 ( V_4 , V_1 , V_2 ) ;
}
...
__acquires( V_53 -> V_125 )
{
struct V_54 * V_55 , * V_169 ;
struct V_52 * V_170 = V_53 ;
int V_131 = 0 ;
...
if ( ( V_53 -> type == V_110 ) &&
V_55 -> V_72 . V_56 )
V_170 = V_53 -> V_4 -> V_142 ;
F_52 ( & V_170 -> V_73 , & V_55 -> V_72 ) ;
F_53 ( V_53 -> V_125 ) ;
}
}
if ( V_131 == - V_118 )
...
struct V_152 V_72 ;
int type , V_1 , V_2 , V_171 = - V_35 ;
T_2 V_172 = 0 ;
F_50 ( V_4 -> V_141 ) ;
F_50 ( V_4 -> V_142 ) ;
do {
F_23 ( V_4 ) ;
memcpy ( & V_72 , & V_53 -> V_100 . V_64 -> V_153 , sizeof( V_72 ) ) ;
} while ( ! F_21 ( V_4 ) );
type = V_72 . V_155 ;
V_4 -> V_148 = ( type & V_173 ) ? V_70 : V_30 ;
switch ( V_72 . V_174 ) {
case V_175 :
if ( type == ( V_176 | V_160 ) &&
F_73 ( V_72 . V_177 ) ==
...
V_1 += V_4 -> V_7 / 2 ;
F_51 ( & V_4 -> V_125 ) ;
V_171 = F_54 ( & V_4 -> V_52 [ V_1 ] . V_73 , 1 , false ) ;
F_53 ( & V_4 -> V_125 ) ;
if ( ! V_171 )
F_77 ( V_4 ) ;
} else if ( type == ( V_176 | V_157 ) ) {
...
V_4 -> V_148 = V_70 ;
F_51 ( & V_4 -> V_125 ) ;
V_171 = V_4 -> V_143 -> V_153 ( & V_4 -> V_92 , & V_72 ) ;
F_53 ( & V_4 -> V_125 ) ;
break;
}
if ( V_171 < 0 ) {
...
V_53 -> V_2 = F_86 ( V_133 ) ? V_70 : V_30 ;
V_53 -> V_1 = F_87 ( V_133 ) ;
V_53 -> type = F_88 ( V_133 ) ;
V_53 -> V_73 . V_74 = F_89 ( V_133 ) & 0x07ff ;
V_53 -> V_73 . V_149 = F_90 ( F_89 ( V_133 ) ) ;
if ( V_53 -> type == V_110 )
V_108 |= V_199 ;
V_108 |= V_200 ;
...
static int F_97 ( struct V_128 * V_73 , int V_34 )
{
...
{
struct V_3 * V_4 = F_55 ( V_203 , struct V_3 , V_92 ) ;
if ( F_83 ( V_4 ) || V_4 -> V_220 == V_221 )
return 0 ;
F_102 ( & V_4 -> V_92 . V_144 ) ;
if ( V_219 )
F_4 ( V_4 , V_48 , V_222 , V_222 ) ;
else
F_4 ( V_4 , V_48 , V_222 , 0 ) ;
F_105 ( & V_4 -> V_92 . V_144 ) ;
return 0 ;
}
static int F_111 ( struct V_3 * V_4 )
{
int V_131 = 0 , V_57 , V_223 ;
for ( V_57 = 0 ; V_57 < V_4 -> V_7 / 2 ; V_57 ++ )
for ( V_223 = V_30 ; V_223 <= V_70 ; V_223 ++ ) {
int V_224 = V_57 + V_223 * V_4 -> V_7 / 2 ;
struct V_52 * V_53 = & V_4 -> V_52 [ V_224 ] ;
F_112 ( V_53 -> V_225 , sizeof( V_53 -> V_225 ) , L_11 , V_57 ,
( V_223 == V_70 ) ? L_12 : L_13 ) ;
V_53 -> V_4 = V_4 ;
V_53 -> V_125 = & V_4 -> V_125 ;
V_53 -> V_65 = V_4 -> V_65 ;
V_53 -> V_73 . V_225 = V_53 -> V_225 ;
V_53 -> V_73 . V_226 = & V_227 ;
if ( V_57 == 0 ) {
V_53 -> V_73 . V_228 . V_229 = true ;
} else {
V_53 -> V_73 . V_228 . V_230 = true ;
V_53 -> V_73 . V_228 . V_231 = true ;
V_53 -> V_73 . V_228 . V_232 = true ;
}
if ( V_223 == V_70 )
V_53 -> V_73 . V_228 . V_233 = true ;
else
V_53 -> V_73 . V_228 . V_234 = true ;
F_113 ( & V_53 -> V_73 , ( unsigned short ) ~ 0 ) ;
F_34 ( & V_53 -> V_100 . V_101 ) ;
V_53 -> V_100 . V_64 = F_114 ( V_4 -> V_235 , V_236 ,
& V_53 -> V_100 . V_8 ) ;
...
V_4 -> V_142 = V_53 ;
F_113 ( & V_53 -> V_73 , V_237 ) ;
continue;
}
F_35 ( & V_53 -> V_73 . V_238 , & V_4 -> V_92 . V_238 ) ;
}
return V_131 ;
}
...
if ( V_53 -> V_112 )
F_42 ( V_53 ) ;
F_43 ( V_4 -> V_235 , V_53 -> V_100 . V_64 , V_53 -> V_100 . V_8 ) ;
}
}
static int F_116 ( struct V_136 * V_92 ,
struct V_239 * V_143 )
{
struct V_3 * V_4 = F_55 ( V_92 , struct V_3 , V_92 ) ;
unsigned long V_132 ;
...
if ( V_143 -> V_208 == NULL )
return - V_35 ;
V_4 -> V_141 -> V_73 . V_133 = & V_240 ;
V_131 = F_117 ( & V_4 -> V_141 -> V_73 ) ;
if ( V_131 )
return V_131 ;
V_4 -> V_142 -> V_73 . V_133 = & V_241 ;
V_131 = F_117 ( & V_4 -> V_142 -> V_73 ) ;
if ( V_131 )
return V_131 ;
V_4 -> V_143 = V_143 ;
if ( F_83 ( V_4 ) && V_4 -> V_242 . V_243 ) {
F_118 ( V_4 ) ;
return V_131 ;
}
F_102 ( & V_4 -> V_92 . V_144 ) ;
...
if ( ! F_83 ( V_4 ) )
return;
F_120 ( & V_4 -> V_242 . V_125 ) ;
if ( V_4 -> V_242 . V_244 -> V_245 == V_246 ) {
V_4 -> V_242 . V_247 = 1 ;
F_118 ( V_4 ) ;
} else if ( V_4 -> V_242 . V_244 -> V_245 == V_248 ) {
V_4 -> V_242 . V_249 = V_250 ;
V_4 -> V_242 . V_244 -> V_245 = V_251 ;
}
F_121 ( & V_4 -> V_242 . V_125 ) ;
}
static int F_122 ( struct V_136 * V_92 )
{
struct V_3 * V_4 = F_55 ( V_92 , struct V_3 , V_92 ) ;
unsigned long V_132 ;
F_57 ( & V_4 -> V_125 , V_132 ) ;
...
static T_5 F_124 ( struct V_3 * V_4 )
{
T_5 V_131 ;
T_1 V_252 ;
if ( V_4 == NULL )
return V_253 ;
F_53 ( & V_4 -> V_125 ) ;
if ( V_4 -> V_209 -> V_132 & V_254 ) {
if ( F_7 ( V_4 , V_255 , V_256 ) !=
V_257 ) {
F_51 ( & V_4 -> V_125 ) ;
return V_258 ;
}
...
V_259 : V_260 ;
if ( V_4 -> V_140 && V_4 -> V_143 -> V_261 ) {
F_51 ( & V_4 -> V_125 ) ;
V_4 -> V_143 -> V_261 ( & V_4 -> V_92 ) ;
F_53 ( & V_4 -> V_125 ) ;
V_4 -> V_140 = 0 ;
}
}
...
{
struct V_264 * V_144 = V_4 -> V_144 ;
struct V_265 * V_266 = & V_4 -> V_209 -> V_267 ;
int V_131 = 0 ;
F_126 ( & V_4 -> V_125 ) ;
V_4 -> V_92 . V_226 = & V_268 ;
V_4 -> V_92 . V_137 = V_138 ;
V_4 -> V_92 . V_269 = V_259 ;
V_4 -> V_92 . V_225 = V_4 -> V_209 -> V_225 ;
V_4 -> V_92 . V_266 = V_266 ;
if ( V_4 -> V_270 && ( V_266 -> V_271 || V_266 -> V_272 ||
V_266 -> V_273 ) )
V_4 -> V_92 . V_270 = 1 ;
F_34 ( & V_4 -> V_92 . V_238 ) ;
V_4 -> V_235 = F_127 ( L_14 , V_144 ,
sizeof( struct V_274 ) ,
64 , V_79 ) ;
if ( V_4 -> V_235 == NULL )
return - V_63 ;
V_4 -> V_65 = F_127 ( L_15 , V_144 ,
sizeof( struct V_275 ) ,
64 , V_79 ) ;
if ( V_4 -> V_65 == NULL ) {
V_131 = - V_63 ;
...
if ( V_131 )
goto V_277;
V_4 -> V_92 . V_278 = & V_4 -> V_142 -> V_73 ;
V_131 = F_128 ( V_144 , & V_4 -> V_92 ) ;
if ( V_131 )
goto F_115;
F_129 ( & V_4 -> V_92 . V_144 ) ;
F_130 ( & V_4 -> V_92 . V_144 ) ;
return V_131 ;
F_115:
F_115 ( V_4 ) ;
V_277:
...
{
if ( V_4 -> V_270 )
F_135 ( V_4 , V_282 | V_281 , V_281 ) ;
}
int F_137 ( struct V_3 * V_4 )
{
struct V_283 * V_284 ;
if ( ! F_7 ( V_4 , V_285 , V_286 ) )
return - V_287 ;
V_284 = F_138 ( V_4 -> V_144 , sizeof( struct V_283 ) , V_236 ) ;
if ( ! V_284 )
return - V_63 ;
V_284 -> V_288 = F_134 ;
V_284 -> V_289 = F_136 ;
