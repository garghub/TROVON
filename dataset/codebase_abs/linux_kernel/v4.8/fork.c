...
V_13 ) ;
return V_11 ? F_14 ( V_11 ) : NULL ;
}
static inline void F_15 ( unsigned long * V_10 )
{
F_16 ( F_17 ( V_10 ) , V_13 ) ;
}
static unsigned long * F_12 ( struct V_5 * V_6 ,
int V_7 )
{
return F_8 ( V_14 , V_12 , V_7 ) ;
}
static void F_15 ( unsigned long * V_10 )
{
F_10 ( V_14 , V_10 ) ;
}
void F_18 ( void )
...
static void F_21 ( unsigned long * V_10 , int V_16 )
{
struct V_11 * V_17 = F_17 ( V_10 ) ;
F_22 ( F_23 ( V_17 ) , V_18 ,
V_15 / 1024 * V_16 ) ;
F_24 (
V_17 , V_19 ,
...
struct V_87 * F_164 ( struct V_5 * V_164 )
{
struct V_87 * V_78 = NULL ;
struct V_61 * V_62 ;
F_165 ( V_164 ) ;
V_62 = V_164 -> V_62 ;
if ( V_62 ) {
...
struct V_61 * F_167 ( struct V_5 * V_164 )
{
struct V_61 * V_62 ;
F_165 ( V_164 ) ;
V_62 = V_164 -> V_62 ;
...
struct V_61 * F_168 ( struct V_5 * V_164 , unsigned int V_166 )
{
struct V_61 * V_62 ;
int V_49 ;
V_49 = F_169 ( & V_164 -> signal -> V_167 ) ;
if ( V_49 )
return F_170 ( V_49 ) ;
V_62 = F_167 ( V_164 ) ;
...
static int F_176 ( struct V_5 * V_172 ,
struct V_169 * V_170 )
{
int V_173 ;
F_177 () ;
...
void F_181 ( struct V_5 * V_6 , struct V_61 * V_62 )
{
#ifdef F_182
if ( F_104 ( V_6 -> V_174 ) ) {
F_183 ( V_6 ) ;
...
F_188 ( V_6 , V_62 ) ;
if ( V_6 -> V_177 ) {
if ( ! ( V_6 -> signal -> V_144 & V_178 ) &&
F_36 ( & V_62 -> V_132 ) > 1 ) {
F_189 ( 0 , V_6 -> V_177 ) ;
F_190 ( V_6 -> V_177 , V_179 ,
1 , NULL , NULL , 0 ) ;
}
V_6 -> V_177 = NULL ;
}
...
static struct V_61 * F_191 ( struct V_5 * V_6 )
{
...
if ( V_49 )
goto V_180;
V_62 -> V_181 = F_192 ( V_62 ) ;
V_62 -> V_182 = V_62 -> V_79 ;
if ( V_62 -> V_157 && ! F_193 ( V_62 -> V_157 -> V_158 ) )
goto V_180;
return V_62 ;
V_180:
V_62 -> V_157 = NULL ;
...
static int F_194 ( unsigned long V_183 , struct V_5 * V_6 )
{
...
static int F_197 ( unsigned long V_183 , struct V_5 * V_6 )
{
...
V_6 -> V_193 = F_198 ( V_193 ) ;
if ( ! V_6 -> V_193 )
return - V_120 ;
return 0 ;
}
static int F_199 ( unsigned long V_183 , struct V_5 * V_6 )
{
...
static int F_201 ( unsigned long V_183 , struct V_5 * V_6 )
{
#ifdef F_202
...
F_203 ( V_205 ) ;
V_6 -> V_204 = V_205 ;
} else if ( F_204 ( V_205 -> V_208 ) ) {
V_206 = F_205 ( V_6 , V_9 , V_50 ) ;
if ( F_104 ( ! V_206 ) )
return - V_120 ;
...
static int F_207 ( unsigned long V_183 , struct V_5 * V_6 )
{
struct V_209 * V_21 ;
if ( V_183 & V_210 ) {
...
{
unsigned long V_214 ;
V_214 = F_211 ( V_21 -> V_39 [ V_215 ] . V_41 ) ;
if ( V_214 != V_216 ) {
V_21 -> V_217 . V_218 = F_212 ( V_214 ) ;
...
static int F_213 ( unsigned long V_183 , struct V_5 * V_6 )
{
struct V_20 * V_21 ;
if ( V_183 & V_222 )
return 0 ;
...
F_62 ( & V_21 -> V_224 , 1 ) ;
F_62 ( & V_21 -> V_23 , 1 ) ;
V_21 -> V_225 = (struct V_226 ) F_215 ( V_6 -> V_227 ) ;
V_6 -> V_227 = (struct V_226 ) F_215 ( V_21 -> V_225 ) ;
F_216 ( & V_21 -> V_228 ) ;
V_21 -> V_229 = V_6 ;
F_217 ( & V_21 -> V_230 ) ;
F_79 ( & V_21 -> V_231 ) ;
...
static void F_224 ( struct V_5 * V_128 )
{
#ifdef F_56
F_225 ( & V_26 -> V_211 -> V_244 ) ;
F_226 ( V_26 ) ;
...
static void F_230 ( struct V_5 * V_128 )
{
F_231 ( & V_128 -> V_247 ) ;
#ifdef F_232
V_128 -> V_248 = V_130 ;
...
static inline void
F_234 ( struct V_5 * V_164 , enum V_253 type , struct V_254 * V_254 )
{
V_164 -> V_255 [ type ] . V_254 = V_254 ;
}
static struct V_5 * F_235 ( unsigned long V_183 ,
unsigned long V_256 ,
unsigned long V_257 ,
int T_3 * V_258 ,
struct V_254 * V_254 ,
...
! F_242 ( V_276 ) && ! F_242 ( V_277 ) )
goto V_278;
}
V_26 -> V_144 &= ~ V_279 ;
V_72 = F_243 ( V_128 , V_183 ) ;
if ( V_72 < 0 )
goto V_278;
V_72 = - V_197 ;
if ( V_223 >= V_32 )
...
if ( V_72 )
goto V_330;
V_72 = F_199 ( V_183 , V_128 ) ;
if ( V_72 )
goto V_331;
V_72 = F_197 ( V_183 , V_128 ) ;
if ( V_72 )
goto V_332;
V_72 = F_207 ( V_183 , V_128 ) ;
if ( V_72 )
goto V_333;
V_72 = F_213 ( V_183 , V_128 ) ;
if ( V_72 )
goto V_334;
V_72 = F_194 ( V_183 , V_128 ) ;
if ( V_72 )
goto V_335;
V_72 = F_267 ( V_183 , V_128 ) ;
if ( V_72 )
goto V_336;
V_72 = F_201 ( V_183 , V_128 ) ;
if ( V_72 )
goto V_337;
...
if ( F_174 ( V_128 -> V_254 ) ) {
F_282 ( V_128 , ( V_183 & V_364 ) || V_259 ) ;
F_234 ( V_128 , V_365 , V_254 ) ;
if ( F_283 ( V_128 ) ) {
F_234 ( V_128 , V_366 , F_284 ( V_26 ) ) ;
F_234 ( V_128 , V_367 , F_285 ( V_26 ) ) ;
if ( F_286 ( V_254 ) ) {
F_287 ( V_254 ) -> V_368 = V_128 ;
V_128 -> signal -> V_144 |= V_265 ;
}
V_128 -> signal -> V_369 = V_254 ;
V_128 -> signal -> V_370 = F_288 ( V_26 -> signal -> V_370 ) ;
F_289 ( & V_128 -> V_285 , & V_128 -> V_359 -> V_284 ) ;
F_290 ( & V_128 -> V_371 , & V_38 . V_371 ) ;
F_291 ( V_128 , V_366 ) ;
F_291 ( V_128 , V_367 ) ;
F_292 ( V_4 ) ;
} else {
...
static inline void F_310 ( struct V_374 * V_375 )
{
enum V_253 type ;
for ( type = V_365 ; type < V_376 ; ++ type ) {
F_311 ( & V_375 [ type ] . V_7 ) ;
V_375 [ type ] . V_254 = & V_339 ;
}
}
struct V_5 * F_312 ( int V_2 )
{
struct V_5 * V_164 ;
V_164 = F_235 ( V_190 , 0 , 0 , NULL , & V_339 , 0 , 0 ,
F_313 ( V_2 ) ) ;
if ( ! F_255 ( V_164 ) ) {
F_310 ( V_164 -> V_255 ) ;
F_314 ( V_164 , V_2 ) ;
...
long F_315 ( unsigned long V_183 ,
unsigned long V_256 ,
unsigned long V_257 ,
int T_3 * V_377 ,
int T_3 * V_258 ,
...
V_259 = V_383 ;
if ( F_174 ( ! F_316 ( V_26 , V_259 ) ) )
V_259 = 0 ;
}
V_128 = F_235 ( V_183 , V_256 , V_257 ,
V_258 , NULL , V_259 , V_260 , V_50 ) ;
if ( ! F_255 ( V_128 ) ) {
struct V_169 V_170 ;
struct V_254 * V_254 ;
F_317 ( V_26 , V_128 ) ;
V_254 = F_318 ( V_128 , V_365 ) ;
V_378 = F_319 ( V_254 ) ;
if ( V_183 & V_384 )
F_189 ( V_378 , V_377 ) ;
if ( V_183 & V_346 ) {
...
long F_325 ( unsigned long V_183 ,
unsigned long V_256 ,
unsigned long V_257 ,
int T_3 * V_377 ,
int T_3 * V_258 )
{
return F_315 ( V_183 , V_256 , V_257 ,
V_377 , V_258 , 0 ) ;
}
T_4 F_326 ( int (* F_327)( void * ) , void * V_386 , unsigned long V_144 )
{
return F_315 ( V_144 | V_190 | V_379 , ( unsigned long ) F_327 ,
( unsigned long ) V_386 , NULL , NULL , 0 ) ;
}
static void F_328 ( void * V_387 )
{
...
V_389 | V_35 | V_36 | V_37 ,
NULL ) ;
V_93 = F_330 ( V_64 , V_35 | V_37 ) ;
F_331 () ;
F_332 () ;
}
static int F_333 ( unsigned long V_395 )
{
...
static int F_336 ( unsigned long V_395 , struct V_192 * * V_401 )
{
struct V_192 * V_193 = V_26 -> V_193 ;
...
static int F_337 ( unsigned long V_395 , struct V_199 * * V_402 )
{
struct V_199 * V_403 = V_26 -> V_202 ;
int error = 0 ;
if ( ( V_395 & V_203 ) &&
( V_403 && F_36 ( & V_403 -> V_153 ) > 1 ) ) {
* V_402 = F_200 ( V_403 , & error ) ;
if ( ! * V_402 )
return error ;
}
return 0 ;
}
int F_338 ( struct V_199 * * V_404 )
{
struct V_5 * V_164 = V_26 ;
struct V_199 * V_405 = NULL ;
int error ;
error = F_337 ( V_203 , & V_405 ) ;
if ( error || ! V_405 ) {
* V_404 = NULL ;
return error ;
}
...
int F_339 ( struct V_406 * V_407 , int V_408 ,
...
V_412 . V_416 = & V_414 ;
V_412 . V_417 = & V_415 ;
V_413 = F_340 ( & V_412 , V_408 , V_409 , V_410 , V_411 ) ;
if ( V_413 || ! V_408 )
return V_413 ;
F_44 ( V_28 ) ;
return 0 ;
