...
V_45 = V_21 -> V_22 -> V_47 ( V_21 , V_61 -> V_48 ) ;
F_23 ( & V_27 -> V_46 , V_42 ) ;
if ( F_11 ( V_3 , V_27 , V_5 , error ) )
F_36 ( V_45 , true ) ;
F_29 ( & V_27 -> V_46 , V_42 ) ;
...
int F_43 ( struct V_64 * V_65 , T_1 V_66 ,
T_2 * V_67 )
{
struct V_23 * V_21 ;
struct V_15 * V_15 ;
...
struct V_26 * F_49 ( struct V_23 * V_21 ,
int V_76 , int V_77 )
{
struct V_26 * V_27 ;
int V_78 = sizeof( struct V_2 ) ;
V_27 = F_50 ( sizeof( * V_27 ) , V_79 , V_76 ) ;
if ( ! V_27 )
goto V_80;
if ( V_21 -> V_22 ) {
F_51 ( & V_27 -> V_46 ) ;
V_78 = F_52 ( V_78 + V_77 , F_53 () ) ;
}
V_27 -> V_39 = F_50 ( V_78 , V_79 , V_76 ) ;
if ( ! V_27 -> V_39 )
goto V_81;
F_40 ( & V_27 -> V_30 [ 0 ] ) ;
F_40 ( & V_27 -> V_30 [ 1 ] ) ;
