...
F_21 ( & V_2 , V_43 -> V_36 , V_43 -> V_46 ) ;
F_3 ( & V_2 , 0 , 0 , 0 ) ;
return 0 ;
}
static int F_27 ( struct V_47 * V_47 , struct V_48 * V_48 )
{
return F_28 ( V_48 , F_26 , V_47 -> V_49 ) ;
}
int F_29 ( struct V_42 * V_43 , const char * V_21 )
{
struct V_50 * V_51 ;
unsigned V_6 , V_52 ;
for ( V_6 = 0 ; V_6 < F_30 ( V_18 ) ; V_6 ++ )
if ( V_18 [ V_6 ] . V_4 )
for ( V_52 = 0 ; V_52 < V_18 [ V_6 ] . V_5 ; V_52 ++ )
V_18 [ V_6 ] . V_9 |= V_18 [ V_6 ] . V_4 [ V_52 ] . V_9 ;
V_51 = F_31 ( V_21 , 0400 , NULL , V_43 , & V_53 ) ;
return V_51 ? 0 : - V_54 ;
}
static int F_32 ( void )
{
return F_29 ( & V_55 , L_7 ) ;
}
