...
( V_48 -> V_4 . V_89 & ( F_11 ( V_90 ) | F_11 ( V_91 ) ) ) )
V_70 |= V_92 ;
F_6 ( & V_47 -> V_51 ,
V_93 ,
0xffffffff ,
...
struct V_46 * V_115 ;
struct V_103 * V_116 ;
V_115 = F_20 ( V_101 -> V_117 -> V_115 ) ;
V_50 = & V_115 -> V_51 . V_52 -> V_50 ;
if ( ! V_50 -> V_118 || ! V_50 -> V_119 )
return 0 ;
V_114 = F_16 ( V_101 -> V_48 ,
& V_115 -> V_4 ) ;
if ( F_17 ( V_114 ) )
return F_18 ( V_114 ) ;
V_113 = F_1 ( V_114 ) ;
...
static int F_22 ( struct V_103 * V_125 ,
struct V_2 * V_3 )
{
struct V_46 * V_47 = F_20 ( V_125 ) ;
struct V_1 * V_48 =
F_1 ( V_3 ) ;
const struct V_49 * V_50 =
& V_47 -> V_51 . V_52 -> V_50 ;
...
V_48 -> V_57 >>= 16 ;
V_48 -> V_58 >>= 16 ;
V_48 -> V_97 = F_24 ( V_76 -> V_77 ) ;
if ( V_48 -> V_97 > V_142 )
return - V_141 ;
if ( V_48 -> V_4 . V_89 & ( F_11 ( V_90 ) | F_11 ( V_91 ) ) ) {
V_45 = V_48 -> V_54 ;
V_48 -> V_54 = V_48 -> V_55 ;
V_48 -> V_55 = V_45 ;
V_45 = V_48 -> V_57 ;
...
V_131 = F_25 ( V_129 * V_48 -> V_57 ,
V_48 -> V_54 ) ;
V_132 = F_25 ( V_130 * V_48 -> V_58 ,
V_48 -> V_55 ) ;
V_135 = F_26 ( V_76 -> V_77 ) ;
V_136 = F_27 ( V_76 -> V_77 ) ;
for ( V_44 = 0 ; V_44 < V_48 -> V_97 ; V_44 ++ ) {
unsigned int V_145 = 0 ;
int V_146 = V_44 ? V_135 : 1 ;
int V_147 = V_44 ? V_136 : 1 ;
V_48 -> V_110 [ V_44 ] = F_28 ( V_76 -> V_77 , V_44 ) ;
if ( ! V_48 -> V_110 [ V_44 ] )
return - V_141 ;
...
static int F_29 ( struct V_103 * V_125 ,
const struct V_2 * V_154 )
{
...
static void F_31 ( struct V_103 * V_125 ,
const struct V_2 * V_156 )
{
...
static void F_33 ( struct V_103 * V_125 ,
struct V_2 * V_157 )
{
struct V_46 * V_47 = F_20 ( V_125 ) ;
struct V_1 * V_48 =
...
static void F_35 ( struct V_103 * V_125 ,
struct V_2 * V_156 )
{
struct V_46 * V_47 = F_20 ( V_125 ) ;
F_36 ( & V_47 -> V_51 ) ;
}
static void F_37 ( struct V_103 * V_125 )
{
struct V_46 * V_47 = F_20 ( V_125 ) ;
if ( V_47 -> V_4 . V_76 )
F_38 ( V_47 -> V_4 . V_76 ) ;
F_39 ( V_125 -> V_158 , & V_47 -> V_51 ) ;
F_40 ( V_125 ) ;
F_41 ( V_125 -> V_158 -> V_158 , V_47 ) ;
}
...
static int F_43 ( struct V_103 * V_125 ,
...
static void F_50 ( struct V_103 * V_125 )
{
struct V_1 * V_48 ;
if ( V_125 -> V_48 ) {
V_48 = F_1 ( V_125 -> V_48 ) ;
...
static struct V_2 *
F_53 ( struct V_103 * V_125 )
{
struct V_1 * V_48 =
F_1 ( V_125 -> V_48 ) ;
struct V_1 * V_175 ;
V_175 = F_54 ( V_48 , sizeof( * V_48 ) , V_174 ) ;
if ( ! V_175 )
return NULL ;
V_175 -> V_122 = false ;
V_175 -> V_155 = false ;
...
static void F_56 ( struct V_103 * V_47 ,
struct V_2 * V_3 )
{
struct V_1 * V_48 =
F_1 ( V_3 ) ;
...
enum V_177 type ;
int V_88 ;
V_47 = F_58 ( V_158 -> V_158 , sizeof( * V_47 ) , V_174 ) ;
if ( ! V_47 )
return F_59 ( - V_178 ) ;
V_88 = F_60 ( V_158 , & V_47 -> V_51 , V_52 ) ;
if ( V_88 )
return F_59 ( V_88 ) ;
if ( V_52 -> type == V_179 )
type = V_72 ;
...
F_62 ( & V_47 -> V_4 ,
& V_185 ) ;
F_44 ( V_47 , V_52 , V_163 ) ;
return V_47 ;
}
static struct V_162 *
F_63 ( struct V_176 * V_158 )
{
struct V_162 * V_163 ;
V_163 = F_58 ( V_158 -> V_158 , sizeof( * V_163 ) , V_174 ) ;
if ( ! V_163 )
return F_59 ( - V_178 ) ;
V_163 -> V_80 = F_64 ( V_158 , 0 , L_1 , 0 , 255 ) ;
if ( ! V_163 -> V_80 )
return F_59 ( - V_178 ) ;
V_158 -> V_171 . V_172 =
F_65 ( V_158 ,
...
int V_44 ;
V_190 = F_58 ( V_158 -> V_158 , sizeof( * V_190 ) , V_174 ) ;
if ( ! V_190 )
return F_59 ( - V_178 ) ;
...
continue;
V_47 = F_57 ( V_158 , & V_191 [ V_44 ] , V_163 ) ;
if ( F_17 ( V_47 ) )
return F_67 ( V_47 ) ;
V_47 -> V_164 = V_163 ;
