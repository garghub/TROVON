...
V_81 += V_6 -> V_84 ;
V_82 = V_6 -> V_12 ;
V_82 += V_6 -> V_84 * sizeof( struct V_10 ) ;
if ( ! V_3 -> V_85 ) {
F_44 ( V_81 ) ;
F_32 () ;
V_55 = ( sizeof( struct V_10 ) - 24 ) / 4 ;
...
V_35 = V_81 -> V_35 ;
F_18 ( ( V_35 >> V_62 ) != V_80 ) ;
F_18 ( ! V_3 -> V_46 && ! ( V_35 & V_93 ) ) ;
F_18 ( ( V_35 & 0x1f ) != V_3 -> V_94 ) ;
V_3 -> V_90 = 1 ;
} else if ( V_54 ) {
F_46 ( 1 ) ;
}
...
{
while ( ! F_50 ( & V_6 -> V_96 . V_97 ) ) {
struct V_1 * V_98 ;
V_98 = F_51 ( & V_6 -> V_96 . V_97 ,
struct V_1 , V_4 . V_99 ) ;
F_52 ( & V_98 -> V_4 . V_99 ) ;
F_53 ( V_98 ) ;
}
}
static int F_54 ( struct V_100 * V_101 , struct V_5 * V_6 )
{
struct V_1 * V_98 ;
int V_22 ;
int V_52 ;
T_1 V_102 ;
V_52 = F_55 ( V_101 -> V_103 , L_2 ,
& V_102 ) ;
if ( V_52 )
return V_52 ;
V_102 *= 2 ;
for ( V_22 = 0 ; V_22 < V_102 ; V_22 ++ ) {
V_98 = F_56 ( sizeof( * V_98 ) , V_104 ) ;
if ( ! V_98 )
goto V_105;
V_98 -> V_6 = V_6 ;
if ( V_22 & 1 ) {
V_98 -> V_47 = V_6 -> V_106 + F_57 ( V_22 >> 1 ) ;
V_98 -> V_46 = 1 ;
} else {
V_98 -> V_47 = V_6 -> V_106 + F_58 ( V_22 >> 1 ) ;
V_98 -> V_46 = 0 ;
}
V_98 -> V_94 = V_22 >> 1 ;
V_98 -> V_7 = & V_6 -> V_83 [ V_22 ] ;
V_98 -> V_54 = V_6 -> V_12 ;
V_98 -> V_54 += V_22 * sizeof( struct V_10 ) ;
V_98 -> V_4 . V_100 = & V_6 -> V_96 ;
F_59 ( & V_98 -> V_4 . V_99 , & V_6 -> V_96 . V_97 ) ;
}
V_6 -> V_84 = V_102 ;
return 0 ;
V_105:
...
static void F_60 ( struct V_100 * V_101 , struct V_5 * V_6 )
{
unsigned int V_108 ;
int V_22 ;
V_108 = V_11 * sizeof( struct V_10 ) ;
for ( V_22 = 0 ; V_22 < V_109 ; V_22 ++ ) {
F_5 ( 0 , V_6 -> V_18 + F_61 ( V_22 ) ) ;
F_5 ( 0 , V_6 -> V_18 + F_62 ( V_22 ) ) ;
F_63 ( V_101 , V_108 , V_6 -> V_83 ,
V_6 -> V_12 ) ;
}
}
static void F_64 ( struct V_5 * V_6 )
{
F_5 ( 0 , V_6 -> V_110 + V_111 ) ;
}
static void F_65 ( struct V_100 * V_101 , struct V_5 * V_6 )
{
F_64 ( V_6 ) ;
F_60 ( V_101 , V_6 ) ;
F_5 ( 0 , V_6 -> V_18 + V_112 ) ;
F_5 ( 0 , V_6 -> V_18 + V_112 ) ;
F_63 ( V_101 , V_113 , V_6 -> V_114 ,
V_6 -> V_115 ) ;
}
static int F_66 ( struct V_100 * V_101 , struct V_5 * V_6 )
{
unsigned int V_116 ;
unsigned int V_108 ;
int V_22 ;
...
F_67 ( V_11 < 32 ) ;
V_116 = sizeof( struct V_10 ) ;
V_108 = V_11 * V_116 ;
V_117 = 0 ;
for ( V_22 = 0 ; V_22 < V_109 ; V_22 ++ ) {
V_55 = V_117 << V_118 ;
V_55 |= ( F_68 ( V_116 ) - 5 ) << V_119 ;
V_55 |= F_68 ( V_11 ) - 5 ;
F_67 ( V_109 != 1 ) ;
V_6 -> V_83 = F_69 ( V_101 , V_108 ,
& V_6 -> V_12 , V_104 ) ;
if ( ! V_6 -> V_83 )
return - V_107 ;
...
V_121 = 0 ;
F_5 ( 0 , V_6 -> V_110 + V_111 ) ;
for ( V_120 = 0 ; V_120 < 15 * 2 ; V_120 += 2 ) {
V_55 = F_71 ( V_120 ) ;
V_55 |= F_72 ( V_120 ) | V_122 ;
V_55 |= F_73 ( V_120 + 1 ) ;
V_55 |= F_74 ( V_120 + 1 ) | V_123 ;
F_5 ( V_55 , V_6 -> V_110 + F_75 ( V_121 ) ) ;
V_121 ++ ;
}
V_55 = 15 * 2 * 2 - 1 ;
V_55 |= V_124 ;
F_5 ( V_55 , V_6 -> V_110 + V_111 ) ;
}
static int F_76 ( struct V_100 * V_101 , struct V_5 * V_6 )
{
int V_52 ;
F_67 ( V_113 > ( ( 1 << 14 ) - 1 ) ) ;
V_6 -> V_114 = F_69 ( V_101 , V_113 ,
& V_6 -> V_115 , V_104 ) ;
if ( ! V_6 -> V_114 )
return - V_107 ;
F_5 ( V_6 -> V_115 , V_6 -> V_18 + V_112 ) ;
F_5 ( V_113 , V_6 -> V_18 + V_125 ) ;
F_5 ( 0 , V_6 -> V_18 + V_126 ) ;
V_52 = F_66 ( V_101 , V_6 ) ;
if ( V_52 )
goto V_127;
F_5 ( V_6 -> V_86 . V_87 , V_6 -> V_106 + V_128 ) ;
F_70 ( V_6 ) ;
return 0 ;
V_127:
F_65 ( V_101 , V_6 ) ;
...
static bool F_77 ( struct V_2 * V_4 , void * V_129 )
{
struct V_1 * V_98 ;
struct V_5 * V_6 ;
const struct V_130 * V_131 ;
T_1 * V_132 = V_129 ;
if ( V_4 -> V_100 -> V_101 -> V_133 != & V_134 . V_133 )
return false ;
V_98 = F_1 ( V_4 ) ;
if ( V_98 -> V_94 != V_132 [ V_135 ] )
return false ;
if ( V_98 -> V_46 && ! V_132 [ V_136 ] )
return false ;
V_6 = V_98 -> V_6 ;
if ( V_98 -> V_46 )
V_131 = V_6 -> V_137 ;
...
if ( F_18 ( V_98 -> V_94 > F_78 ( V_139 ) ) )
return false ;
V_98 -> V_29 = V_131 [ V_98 -> V_94 ] . V_87 ;
V_98 -> V_59 = V_131 [ V_98 -> V_94 ] . V_92 ;
return true ;
}
...
static const struct V_152 * F_81 ( struct V_100 * V_101 )
{
const struct V_153 * V_154 ;
V_154 = F_82 ( V_155 , V_101 -> V_103 ) ;
if ( ! V_154 )
return NULL ;
return V_154 -> V_20 ;
}
...
{
struct V_5 * V_6 ;
struct V_100 * V_101 = & V_157 -> V_101 ;
...
if ( ! V_158 )
return - V_159 ;
V_6 = F_84 ( & V_157 -> V_101 , sizeof( * V_6 ) , V_104 ) ;
if ( ! V_6 )
return - V_107 ;
F_85 ( V_160 , V_6 -> V_96 . V_161 ) ;
V_6 -> V_96 . V_162 = F_23 ;
V_6 -> V_96 . V_163 = F_26 ;
V_6 -> V_96 . V_164 = F_27 ;
V_6 -> V_96 . V_165 = F_31 ;
V_6 -> V_96 . V_166 = F_40 ;
V_6 -> V_96 . V_167 = F_48 ;
V_6 -> V_96 . V_168 = F_86 ( V_169 ) | F_86 ( V_170 ) ;
V_6 -> V_96 . V_171 = V_172 ;
V_6 -> V_96 . V_173 = V_172 ;
V_6 -> V_96 . V_174 = V_175 ;
V_6 -> V_96 . V_101 = V_101 ;
F_87 ( & V_6 -> V_96 . V_97 ) ;
V_176 . V_151 = V_6 -> V_96 . V_161 ;
V_6 -> V_23 = F_88 ( V_101 -> V_103 , 0 ) ;
V_6 -> V_106 = F_88 ( V_101 -> V_103 , 1 ) ;
V_6 -> V_110 = F_88 ( V_101 -> V_103 , 2 ) ;
V_6 -> V_18 = F_88 ( V_101 -> V_103 , 3 ) ;
if ( ! V_6 -> V_23 || ! V_6 -> V_106 || ! V_6 -> V_110 ||
! V_6 -> V_18 )
return - V_177 ;
F_89 ( V_101 ) ;
V_52 = F_90 ( V_101 ) ;
...
if ( V_52 )
goto V_180;
V_19 = F_91 ( V_101 -> V_103 , 0 ) ;
if ( ! V_19 ) {
V_52 = - V_159 ;
goto V_181;
}
F_5 ( V_25 , V_6 -> V_23 + V_182 ) ;
V_52 = F_92 ( & V_157 -> V_101 , V_19 , V_158 -> V_183 , V_184 ,
F_93 ( V_101 ) , V_6 ) ;
if ( V_52 )
goto V_181;
V_6 -> V_19 = V_19 ;
...
F_103 ( V_157 -> V_101 . V_103 ) ;
F_97 ( & V_6 -> V_96 ) ;
F_5 ( 0 , V_6 -> V_23 + V_187 ) ;
F_104 ( & V_157 -> V_101 , V_6 -> V_19 , V_6 ) ;
F_49 ( V_6 ) ;
F_65 ( & V_157 -> V_101 , V_6 ) ;
F_100 ( V_6 -> V_23 ) ;
F_100 ( V_6 -> V_106 ) ;
F_100 ( V_6 -> V_110 ) ;
F_100 ( V_6 -> V_18 ) ;
...
{
struct V_5 * V_6 = F_106 ( V_101 ) ;
V_6 -> V_188 = F_7 ( V_6 -> V_106 + V_128 ) ;
F_5 ( 0 , V_6 -> V_23 + V_187 ) ;
F_64 ( V_6 ) ;
return 0 ;
}
static int F_107 ( struct V_100 * V_101 )
{
struct V_5 * V_6 = F_106 ( V_101 ) ;
struct V_1 * V_3 ;
int V_22 ;
