...
static int F_61 ( struct V_43 * V_2 , struct V_134 * V_135 , int V_136 )
{
struct V_1 * V_61 = F_19 ( V_2 ) ;
struct V_137 * V_120 = F_62 ( V_135 ) ;
...
static int F_66 ( struct V_43 * V_2 , void * V_144 )
{
...
F_69 (ha, dev) {
T_1 V_160 = F_70 ( V_148 , V_150 -> V_12 ) ;
...
static int F_71 ( struct V_43 * V_2 , int V_164 )
{
return - V_165 ;
}
...
V_61 -> V_24 ++ ;
F_7 ( V_61 , V_63 , & V_9 ) ;
if ( F_32 ( V_67 -> V_169 < V_167 ) )
V_9 . V_11 |= V_172 ;
else
V_9 . V_11 &= ~ V_172 ;
V_166 = V_61 -> V_23 [ V_63 ] ;
F_76 ( V_166 , V_67 -> V_6 , V_67 -> V_169 ) ;
V_9 . V_11 &= ~ ( V_82 | V_173 ) ;
V_9 . V_11 |= F_77 ( V_67 -> V_169 ) ;
F_8 ( V_61 , V_63 , & V_9 ) ;
V_9 . V_11 |= V_86 ;
F_8 ( V_61 , V_63 , & V_9 ) ;
...
static void F_82 ( struct V_43 * V_2 , struct V_176 * V_177 ,
void * V_144 )
{
struct V_1 * V_61 = F_19 ( V_2 ) ;
T_1 * V_178 = V_144 ;
unsigned V_22 ;
V_177 -> V_179 = 0 ;
for ( V_22 = 0 ; V_22 < V_175 / sizeof( T_1 ) ; ++ V_22 )
V_178 [ V_22 ] = F_1 ( V_61 , V_22 * sizeof( T_1 ) ) ;
}
static void F_83 ( struct V_43 * V_2 ,
struct V_180 * V_181 )
{
struct V_1 * V_61 = F_19 ( V_2 ) ;
V_181 -> V_182 = V_61 -> V_183 - 1 ;
V_181 -> V_184 = 0 ;
V_181 -> V_185 = 0 ;
V_181 -> V_186 = V_61 -> V_183 - 1 ;
V_181 -> V_187 = V_61 -> V_36 ;
V_181 -> V_188 = 0 ;
V_181 -> V_189 = 0 ;
V_181 -> V_190 = V_61 -> V_28 ;
}
static int F_84 ( struct V_43 * V_2 ,
struct V_180 * V_181 )
{
struct V_1 * V_61 = F_19 ( V_2 ) ;
if ( V_181 -> V_190 < 1 || V_181 -> V_187 < 1 ||
V_181 -> V_190 + V_181 -> V_187 > V_61 -> V_183 )
return - V_138 ;
if ( V_181 -> V_188 || V_181 -> V_189 )
return - V_138 ;
if ( F_63 ( V_2 ) ) {
F_85 ( V_2 ) ;
F_13 ( V_61 ) ;
...
V_61 -> V_28 = F_87 ( V_181 -> V_190 ) ;
V_61 -> V_36 = V_181 -> V_187 ;
F_14 ( V_61 , V_2 -> V_21 ) ;
if ( F_63 ( V_2 ) ) {
F_9 ( V_61 , V_87 | V_64 ) ;
F_12 ( V_61 ) ;
...
static int F_88 ( struct V_191 * V_192 )
{
...
int V_45 = 0 ;
bool V_197 = false ;
struct V_198 * V_199 = F_89 ( & V_192 -> V_2 ) ;
T_1 V_200 = V_199 ? V_199 -> V_200 : 0 ;
V_44 = F_90 ( sizeof( struct V_1 ) ) ;
if ( ! V_44 ) {
V_45 = - V_201 ;
goto V_170;
}
F_91 ( V_44 , & V_192 -> V_2 ) ;
F_92 ( V_192 , V_44 ) ;
V_194 = F_93 ( V_192 , V_202 , 0 ) ;
if ( ! V_194 ) {
F_17 ( & V_192 -> V_2 , L_19 ) ;
V_45 = - V_121 ;
goto free;
}
V_195 = F_94 ( & V_192 -> V_2 , V_194 -> V_203 ,
F_95 ( V_194 ) , V_194 -> V_130 ) ;
if ( ! V_195 ) {
F_17 ( & V_192 -> V_2 , L_20 ) ;
V_45 = - V_121 ;
goto free;
}
V_44 -> V_132 = V_195 -> V_203 ;
V_194 = F_93 ( V_192 , V_202 , 1 ) ;
if ( V_194 ) {
V_196 = F_94 ( & V_192 -> V_2 , V_194 -> V_203 ,
F_95 ( V_194 ) , V_194 -> V_130 ) ;
if ( ! V_196 ) {
F_17 ( & V_192 -> V_2 , L_21 ) ;
V_45 = - V_121 ;
...
V_44 -> V_21 = V_196 -> V_203 ;
V_44 -> V_133 = V_196 -> V_204 ;
}
V_194 = F_93 ( V_192 , V_205 , 0 ) ;
if ( ! V_194 ) {
F_17 ( & V_192 -> V_2 , L_22 ) ;
V_45 = - V_121 ;
goto free;
}
V_44 -> V_88 = V_194 -> V_203 ;
V_61 = F_19 ( V_44 ) ;
V_61 -> V_44 = V_44 ;
V_61 -> V_206 = 0 ;
V_61 -> V_207 = F_95 ( V_195 ) ;
V_61 -> V_5 = F_96 ( & V_192 -> V_2 , V_44 -> V_132 ,
F_95 ( V_195 ) ) ;
if ( ! V_61 -> V_5 ) {
F_17 ( & V_192 -> V_2 , L_23 ) ;
V_45 = - V_121 ;
...
if ( V_44 -> V_133 ) {
V_61 -> V_31 = F_96 ( & V_192 -> V_2 ,
V_44 -> V_21 , F_95 ( V_196 ) ) ;
if ( ! V_61 -> V_31 ) {
F_17 ( & V_192 -> V_2 , L_24 ) ;
V_45 = - V_121 ;
goto free;
...
V_61 -> V_31 = F_97 ( & V_192 -> V_2 ,
V_208 , ( void * ) & V_44 -> V_21 ,
V_209 ) ;
if ( ! V_61 -> V_31 ) {
F_17 ( & V_192 -> V_2 , L_25 ,
V_208 ) ;
...
V_44 -> V_133 = V_44 -> V_21 + V_208 ;
V_61 -> V_206 = V_208 ;
}
V_61 -> V_4 = V_199 ? V_199 -> V_4 :
F_98 ( V_192 -> V_2 . V_210 ) ;
V_183 = F_99 (unsigned int,
...
V_61 -> V_183 = V_183 ;
V_61 -> V_28 = F_87 ( V_183 >> 1 ) ;
V_61 -> V_36 = V_183 - V_61 -> V_28 ;
F_50 ( & V_192 -> V_2 , L_26 ,
V_61 -> V_28 , V_61 -> V_36 ) ;
V_61 -> V_23 = F_100 ( & V_192 -> V_2 , V_183 * sizeof( void * ) , V_209 ) ;
if ( ! V_61 -> V_23 ) {
V_45 = - V_201 ;
goto free;
}
if ( V_199 ) {
memcpy ( V_44 -> V_143 , V_199 -> V_211 , V_212 ) ;
V_61 -> V_119 = V_199 -> V_119 ;
} else {
const T_7 * V_95 ;
V_95 = F_101 ( V_192 -> V_2 . V_210 ,
L_27 ,
NULL ) ;
if ( V_95 )
memcpy ( V_44 -> V_143 , V_95 , V_212 ) ;
V_61 -> V_119 = - 1 ;
}
if ( ! F_67 ( V_44 -> V_143 ) )
...
V_44 -> V_213 = V_214 ;
if ( ! V_200 ) {
struct V_215 * V_215 = F_103 ( & V_192 -> V_2 , NULL ) ;
if ( ! F_104 ( V_215 ) ) {
V_61 -> V_215 = V_215 ;
F_105 ( V_215 ) ;
V_200 = F_106 ( V_215 ) ;
...
if ( V_200 ) {
T_1 V_216 = F_107 ( V_200 / 2500000 + 1 ) ;
if ( ! V_216 )
V_216 = 2 ;
F_50 ( & V_192 -> V_2 , L_28 , V_216 ) ;
F_4 ( V_61 , V_217 ,
...
static int F_122 ( struct V_191 * V_192 , T_8 V_232 )
{
return - V_165 ;
}
