...
void F_168 ( struct V_113 * V_113 ,
const T_4 * V_221 )
{
struct V_1 * V_2 = F_169 ( V_113 ) -> V_1 ;
struct V_114 * V_115 = F_94 ( V_113 ) ;
struct V_222 * V_223 ;
struct V_102 * V_103 ;
bool V_224 = false ;
...
static void F_171 ( struct V_102 * V_103 )
{
struct V_113 * V_113 = V_103 -> V_113 ;
struct V_114 * V_115 = F_94 ( V_113 ) ;
struct V_222 * V_223 ;
...
continue;
F_5 ( V_225 , & V_223 -> V_85 ) ;
}
F_16 ( & V_113 -> V_116 ) ;
}
static void F_172 ( struct V_102 * V_103 , int error )
{
F_5 ( V_226 , & V_103 -> V_85 ) ;
F_171 ( V_103 ) ;
}
static int F_173 ( struct V_102 * V_103 , const struct V_227 * V_228 )
{
struct V_113 * V_113 = V_103 -> V_113 ;
struct V_114 * V_115 = F_94 ( V_113 ) ;
struct V_145 * V_150 ;
...
if ( F_175 ( V_150 -> V_237 ) -> V_103 != V_103 )
continue;
F_16 ( & V_230 -> V_235 ) ;
...
static int F_177 ( struct V_33 * V_34 , const struct V_227 * V_228 )
{
struct V_102 * V_103 ;
struct V_130 * V_87 ;
int V_12 = 0 ;
...
static void F_181 ( struct V_102 * V_103 )
{
struct V_130 * V_87 ;
F_7 ( V_128 , & V_103 -> V_85 ) ;
...
int (* F_183)( struct V_1 * V_2 , struct V_102 * V_103 ) )
{
struct V_1 * V_2 = V_32 -> V_1 ;
struct V_33 * V_34 ;
struct V_35 * V_36 ;
...
static int F_195 ( struct V_1 * V_2 , const struct V_227 * V_228 )
{
struct V_33 * V_34 ;
struct V_31 * V_32 ;
struct V_35 * V_36 ;
...
static int F_202 ( struct V_31 * V_32 , struct V_3 * V_4 )
{
struct V_1 * V_2 = V_32 -> V_1 ;
...
V_27 = 0 ;
V_280 = F_203 ( V_129 ) ;
V_279 = F_127 ( sizeof( struct V_278 ) , V_129 ) ;
if ( V_280 == NULL || V_279 == NULL ) {
F_154 ( L_24 , V_192 ) ;
goto V_26;
}
V_113 = F_204 ( V_32 -> V_281 -> V_282 ) ;
V_27 = F_205 ( V_113 , V_279 , V_280 , V_4 ) ;
if ( V_27 ) {
F_154 ( L_25 ,
V_192 , V_27 ) ;
goto V_26;
...
F_26 () ;
V_113 = F_204 ( V_32 -> V_281 -> V_282 ) ;
V_12 = F_210 ( V_113 , V_4 ) ;
if ( V_12 != - V_290 )
goto V_236;
if ( F_202 ( V_32 , V_4 ) == - V_291 )
goto V_236;
goto V_26;
}
F_26 () ;
...
V_293 = F_213 ( V_293 , V_302 ) ;
if ( F_149 ( V_293 ) ) {
V_12 = F_151 ( V_293 ) ;
break;
}
V_293 = F_214 ( & V_2 -> V_188 , V_293 ) ;
F_215 ( V_293 ) ;
V_293 = V_2 -> V_188 ;
goto V_296;
case - V_272 :
...
void F_218 ( struct V_46 * V_305 , int V_78 )
{
...
void F_227 ( struct V_1 * V_2 , T_5 V_85 )
{
if ( ! V_85 )
return;
F_154 ( L_41 ,
...
break;
default:
return F_194 ( V_2 , V_55 ) ;
}
return 0 ;
}
static int F_228 ( struct V_1 * V_2 ) { return 0 ; }
static int F_230 ( struct V_1 * V_2 )
{
return 0 ;
}
