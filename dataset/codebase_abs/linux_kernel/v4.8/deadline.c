...
static inline void F_63 ( struct V_2 * V_3 ,
struct V_2 * V_56 )
{
struct V_6 * V_6 = F_4 ( V_3 ) ;
struct V_5 * V_5 = F_3 ( V_6 ) ;
F_64 ( F_65 ( F_66 ( V_5 ) , V_3 -> V_45 ) ) ;
if ( V_3 -> V_57 )
return;
V_3 -> V_45 = F_66 ( V_5 ) + V_56 -> V_58 ;
V_3 -> V_13 = V_56 -> V_16 ;
}
...
struct V_2 * V_56 , T_1 V_60 )
{
T_1 V_61 , V_62 ;
V_61 = ( V_56 -> V_15 >> V_63 ) * ( V_3 -> V_13 >> V_63 ) ;
V_62 = ( ( V_3 -> V_45 - V_60 ) >> V_63 ) *
( V_56 -> V_16 >> V_63 ) ;
return F_65 ( V_62 , V_61 ) ;
}
...
static enum V_71 F_81 ( struct V_64 * V_65 )
{
...
#ifdef F_18
if ( F_89 ( ! V_5 -> V_33 ) ) {
F_90 ( & V_5 -> V_18 , V_73 . V_77 ) ;
V_5 = F_50 ( V_5 , V_7 ) ;
V_73 . V_77 = F_91 ( & V_5 -> V_18 ) ;
}
if ( F_42 ( V_5 ) ) {
F_90 ( & V_5 -> V_18 , V_73 . V_77 ) ;
F_92 ( V_5 ) ;
F_93 ( & V_5 -> V_18 , V_73 . V_77 ) ;
}
#endif
V_74:
F_94 ( V_5 , V_7 , & V_73 ) ;
...
static void F_99 ( struct V_5 * V_5 )
{
...
if ( F_101 ( V_5 ) == F_102 () )
F_103 ( F_66 ( V_5 ) ) ;
F_104 ( V_26 -> V_83 . V_86 . V_87 ,
F_105 ( V_26 -> V_83 . V_86 . V_87 , V_82 ) ) ;
V_26 -> V_83 . V_88 += V_82 ;
F_106 ( V_26 , V_82 ) ;
V_26 -> V_83 . V_84 = F_100 ( V_5 ) ;
F_107 ( V_26 , V_82 ) ;
F_108 ( V_5 , V_82 ) ;
V_3 -> V_13 -= V_82 ;
V_85:
if ( F_98 ( V_3 ) || V_3 -> V_59 ) {
V_3 -> V_57 = 1 ;
F_109 ( V_5 , V_26 , 0 ) ;
if ( F_89 ( V_3 -> V_75 || ! F_71 ( V_26 ) ) )
F_87 ( V_5 , V_26 , V_76 ) ;
if ( ! F_8 ( V_26 , & V_5 -> V_4 ) )
F_61 ( V_5 ) ;
}
...
static void F_112 ( struct V_6 * V_6 , T_1 V_45 )
{
struct V_5 * V_5 = F_3 ( V_6 ) ;
if ( V_6 -> V_25 . V_26 == 0 ||
F_65 ( V_45 , V_6 -> V_25 . V_26 ) ) {
V_6 -> V_25 . V_26 = V_45 ;
F_113 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , V_45 , 1 ) ;
}
}
static void F_114 ( struct V_6 * V_6 , T_1 V_45 )
{
struct V_5 * V_5 = F_3 ( V_6 ) ;
if ( ! V_6 -> V_36 ) {
V_6 -> V_25 . V_26 = 0 ;
V_6 -> V_25 . V_27 = 0 ;
F_113 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , 0 , 0 ) ;
} else {
struct V_8 * V_40 = V_6 -> V_9 ;
struct V_2 * V_39 ;
V_39 = F_34 ( V_40 , struct V_2 , V_8 ) ;
V_6 -> V_25 . V_26 = V_39 -> V_45 ;
F_113 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , V_39 -> V_45 , 1 ) ;
}
}
static inline void F_112 ( struct V_6 * V_6 , T_1 V_45 ) {}
static inline void F_114 ( struct V_6 * V_6 , T_1 V_45 ) {}
static inline
...
static inline
void F_118 ( struct V_2 * V_3 , struct V_6 * V_6 )
{
int V_94 = F_1 ( V_3 ) -> V_94 ;
F_64 ( ! F_116 ( V_94 ) ) ;
F_64 ( ! V_6 -> V_36 ) ;
...
{
struct V_1 * V_97 = F_124 ( V_7 ) ;
struct V_2 * V_56 = & V_7 -> V_4 ;
if ( V_97 && V_7 -> V_4 . V_75 && F_116 ( V_97 -> V_98 ) ) {
V_56 = & V_97 -> V_4 ;
} else if ( ! F_116 ( V_7 -> V_98 ) ) {
F_33 ( ! V_7 -> V_4 . V_75 || V_95 != V_76 ) ;
return;
}
if ( V_7 -> V_4 . V_57 && ! ( V_95 & V_76 ) )
return;
F_122 ( & V_7 -> V_4 , V_56 , V_95 ) ;
if ( ! F_125 ( V_5 , V_7 ) && F_30 ( V_7 ) > 1 )
F_32 ( V_5 , V_7 ) ;
}
static void F_109 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_95 )
{
F_123 ( & V_7 -> V_4 ) ;
F_38 ( V_5 , V_7 ) ;
}
static void F_126 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_95 )
{
F_99 ( V_5 ) ;
F_109 ( V_5 , V_7 , V_95 ) ;
}
static void F_127 ( struct V_5 * V_5 )
{
V_5 -> V_26 -> V_4 . V_59 = 1 ;
F_85 ( V_5 ) ;
F_99 ( V_5 ) ;
...
static int
F_129 ( struct V_1 * V_7 , int V_34 , int V_99 , int V_95 )
{
struct V_1 * V_26 ;
struct V_5 * V_5 ;
if ( V_99 != V_100 )
...
{
if ( F_30 ( V_5 -> V_26 ) == 1 ||
F_135 ( & V_5 -> V_31 -> V_93 , V_5 -> V_26 , NULL ) == - 1 )
return;
if ( F_30 ( V_7 ) != 1 &&
F_135 ( & V_5 -> V_31 -> V_93 , V_7 , NULL ) != - 1 )
return;
F_61 ( V_5 ) ;
}
...
static void F_137 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
F_138 ( V_5 , V_7 -> V_4 . V_13 ) ;
}
static void F_137 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
}
static struct V_2 * F_139 ( struct V_5 * V_5 ,
struct V_6 * V_6 )
{
...
struct V_1 *
F_140 ( struct V_5 * V_5 , struct V_1 * V_47 , struct V_103 V_77 )
{
struct V_2 * V_3 ;
struct V_1 * V_7 ;
struct V_6 * V_6 ;
...
static void F_143 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
F_99 ( V_5 ) ;
if ( F_6 ( & V_7 -> V_4 ) && F_30 ( V_7 ) > 1 )
F_32 ( V_5 , V_7 ) ;
}
static void F_144 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_108 )
{
F_99 ( V_5 ) ;
if ( F_142 ( V_5 ) && V_108 && V_7 -> V_4 . V_13 > 0 &&
F_8 ( V_7 , & V_5 -> V_4 ) )
F_137 ( V_5 , V_7 ) ;
}
...
static void F_146 ( struct V_1 * V_7 )
{
struct V_17 * V_11 = F_147 ( F_148 ( V_7 ) ) ;
F_149 ( & V_11 -> V_18 ) ;
...
static int F_152 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_34 )
{
if ( ! F_153 ( V_5 , V_7 ) &&
F_154 ( V_34 , F_53 ( V_7 ) ) )
return 1 ;
...
static struct V_1 * F_155 ( struct V_5 * V_5 , int V_34 )
{
...
static int F_132 ( struct V_1 * V_109 )
{
struct V_110 * V_111 ;
struct V_112 * V_113 = F_156 ( V_114 ) ;
int V_115 = F_102 () ;
int V_116 , V_34 = F_148 ( V_109 ) ;
if ( F_89 ( ! V_113 ) )
return - 1 ;
if ( F_30 ( V_109 ) == 1 )
return - 1 ;
V_116 = F_135 ( & F_5 ( V_109 ) -> V_31 -> V_93 ,
V_109 , V_113 ) ;
if ( V_116 == - 1 )
return - 1 ;
if ( F_154 ( V_34 , V_113 ) )
return V_34 ;
if ( ! F_154 ( V_115 , V_113 ) )
V_115 = - 1 ;
F_130 () ;
F_157 (cpu, sd) {
if ( V_111 -> V_95 & V_117 ) {
if ( V_115 != - 1 &&
F_154 ( V_115 , F_158 ( V_111 ) ) ) {
F_133 () ;
return V_115 ;
}
if ( V_116 < V_55 &&
F_154 ( V_116 , F_158 ( V_111 ) ) ) {
F_133 () ;
return V_116 ;
}
}
...
return 0 ;
V_122:
if ( F_89 ( V_120 == V_5 -> V_26 ) ) {
F_64 ( 1 ) ;
return 0 ;
}
if ( F_45 ( V_5 -> V_26 ) &&
F_65 ( V_120 -> V_4 . V_45 , V_5 -> V_26 -> V_4 . V_45 ) &&
F_30 ( V_5 -> V_26 ) > 1 ) {
F_61 ( V_5 ) ;
return 0 ;
}
...
struct V_1 * V_109 ;
V_109 = F_159 ( V_5 ) ;
if ( F_148 ( V_120 ) == V_5 -> V_34 && V_109 == V_120 ) {
goto V_101;
}
if ( ! V_109 )
goto V_101;
...
V_125 = F_56 ( V_34 ) ;
if ( V_123 -> V_4 . V_36 &&
F_65 ( V_123 -> V_4 . V_25 . V_26 ,
V_125 -> V_4 . V_25 . V_27 ) )
continue;
F_57 ( V_123 , V_125 ) ;
if ( V_125 -> V_4 . V_36 <= 1 )
goto V_128;
V_7 = F_155 ( V_125 , V_115 ) ;
if ( V_7 && F_65 ( V_7 -> V_4 . V_45 , V_126 ) &&
( ! V_123 -> V_4 . V_36 ||
F_65 ( V_7 -> V_4 . V_45 ,
V_123 -> V_4 . V_25 . V_26 ) ) ) {
F_64 ( V_7 == V_125 -> V_26 ) ;
F_64 ( ! F_86 ( V_7 ) ) ;
if ( F_65 ( V_7 -> V_4 . V_45 ,
V_125 -> V_26 -> V_4 . V_45 ) )
goto V_128;
V_124 = true ;
F_58 ( V_125 , V_7 , 0 ) ;
...
struct V_17 * V_133 ;
V_133 = F_147 ( F_101 ( V_5 ) ) ;
F_12 ( & V_133 -> V_18 ) ;
F_166 ( V_133 , V_7 -> V_4 . V_17 ) ;
F_16 ( & V_133 -> V_18 ) ;
}
F_167 ( V_7 , V_129 ) ;
}
static void F_168 ( struct V_5 * V_5 )
{
if ( V_5 -> V_4 . V_29 )
F_21 ( V_5 ) ;
F_169 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 ) ;
if ( V_5 -> V_4 . V_36 > 0 )
F_113 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , V_5 -> V_4 . V_25 . V_26 , 1 ) ;
}
...
F_25 ( V_5 ) ;
F_113 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , 0 , 0 ) ;
F_171 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 ) ;
}
void T_4 F_172 ( void )
{
unsigned int V_134 ;
F_173 (i)
F_174 ( & F_48 ( V_114 , V_134 ) ,
V_135 , F_175 ( V_134 ) ) ;
}
...
if ( ! F_71 ( V_7 ) )
F_83 ( V_7 ) ;
if ( ! F_86 ( V_7 ) || V_5 -> V_4 . V_36 )
return;
F_49 ( V_5 ) ;
}
static void F_177 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
if ( F_65 ( V_7 -> V_4 . V_45 , F_66 ( V_5 ) ) )
F_63 ( & V_7 -> V_4 , & V_7 -> V_4 ) ;
if ( F_86 ( V_7 ) && V_5 -> V_26 != V_7 ) {
#ifdef F_18
...
if ( ! V_5 -> V_4 . V_29 )
F_49 ( V_5 ) ;
if ( F_65 ( V_5 -> V_4 . V_25 . V_26 , V_7 -> V_4 . V_45 ) )
F_61 ( V_5 ) ;
#else
F_61 ( V_5 ) ;
#endif
...
void F_179 ( struct V_137 * V_138 , int V_34 )
{
F_180 ( V_138 , V_34 , & F_56 ( V_34 ) -> V_4 ) ;
}
