...
static int F_46 ( struct V_75 * V_75 , unsigned int V_3 )
{
struct V_75 * V_76 ;
struct V_16 * V_17 ;
int V_77 , V_78 ;
...
return - V_80 ;
V_76 = F_47 ( V_75 ) ;
if ( ! F_48 ( V_76 ) -> V_64 -> V_81 -> V_82 ( F_48 ( V_76 ) ) ) {
F_49 ( V_76 ) ;
return 0 ;
}
V_17 = F_48 ( V_76 ) -> V_18 ;
...
{
struct V_1 * V_2 =
F_54 ( V_91 , struct V_1 , V_92 . V_91 ) ;
...
void F_60 ( struct V_1 * V_2 , struct V_62 * V_62 )
{
F_61 ( & V_2 -> V_92 . V_91 , F_53 ) ;
V_2 -> V_92 . V_62 = V_62 ;
F_62 ( V_97 , & V_2 -> V_92 . V_91 ) ;
}
void F_63 ( struct V_31 * * V_31 , bool V_98 )
{
struct V_1 * V_2 ;
struct V_31 * V_6 ;
if ( ( * V_31 ) -> V_56 )
...
F_68 (pos, n, &fscrypt_free_ctxs, free_list)
F_3 ( V_10 , V_99 ) ;
F_69 ( & V_13 ) ;
F_70 ( V_7 ) ;
V_7 = NULL ;
