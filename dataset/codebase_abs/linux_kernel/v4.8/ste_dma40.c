...
if ( ! V_448 )
return - V_25 ;
F_202 ( V_447 , L_61 , & V_449 ) ;
if ( V_449 > 0 )
V_448 -> V_399 = V_449 ;
V_452 = F_203 ( V_447 , L_62 , & V_450 ) ;
V_450 /= sizeof( * V_452 ) ;
...
{
struct V_387 * V_74 = F_179 ( & V_359 -> V_5 ) ;
struct V_331 * V_447 = V_359 -> V_5 . V_456 ;
int V_34 = - V_457 ;
struct V_187 * V_8 ;
struct V_389 * V_173 ;
int V_348 ;
...
F_153 ( & V_8 -> V_193 ) ;
F_153 ( & V_8 -> V_111 ) ;
V_173 = F_183 ( V_359 , V_394 , L_67 ) ;
if ( ! V_173 ) {
V_34 = - V_457 ;
F_94 ( & V_359 -> V_5 , L_68 ) ;
goto V_393;
}
V_8 -> V_459 = F_185 ( V_173 ) ;
V_8 -> V_460 = V_173 -> V_395 ;
if ( F_184 ( V_173 -> V_395 , F_185 ( V_173 ) ,
V_396 L_69 ) == NULL ) {
V_34 = - V_116 ;
F_94 ( & V_359 -> V_5 , L_70 , V_173 ) ;
goto V_393;
}
V_133 = F_53 ( V_8 -> V_9 + V_461 ) ;
if ( V_173 -> V_395 != V_133 && V_133 != 0 ) {
F_199 ( & V_359 -> V_5 ,
L_71 ,
V_128 , V_133 , & V_173 -> V_395 ) ;
} else
F_30 ( V_173 -> V_395 , V_8 -> V_9 + V_461 ) ;
