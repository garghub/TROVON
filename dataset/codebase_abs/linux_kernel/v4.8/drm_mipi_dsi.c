...
int F_71 ( struct V_5 * V_6 , T_4 V_116 )
{
T_3 V_87 [ 3 ] = { V_117 , V_116 >> 8 ,
V_116 & 0xff } ;
T_2 V_10 ;
...
int F_72 ( struct V_5 * V_6 , T_3 V_103 )
{
T_2 V_10 ;
V_10 = F_56 ( V_6 , V_118 , & V_103 ,
sizeof( V_103 ) ) ;
if ( V_10 < 0 )
return V_10 ;
return 0 ;
...
{
struct V_119 * V_4 = F_74 ( V_2 -> V_120 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
return V_4 -> V_121 ( V_6 ) ;
}
...
int F_77 ( struct V_119 * V_4 ,
struct V_123 * V_124 )
{
V_4 -> V_120 . V_22 = & V_17 ;
V_4 -> V_120 . V_124 = V_124 ;
if ( V_4 -> V_121 )
V_4 -> V_120 . V_121 = F_73 ;
if ( V_4 -> remove )
V_4 -> V_120 . remove = F_75 ;
if ( V_4 -> V_122 )
V_4 -> V_120 . V_122 = F_76 ;
return F_78 ( & V_4 -> V_120 ) ;
}
void F_79 ( struct V_119 * V_4 )
{
F_80 ( & V_4 -> V_120 ) ;
}
