...
static int F_17 ( struct V_1 * V_2 , struct V_1 * V_3 ,
T_4 V_53 , T_1 * V_4 )
{
struct V_18 V_19 = {
. type = V_54 ,
...
int V_8 ;
if ( F_18 ( V_2 -> V_56 , V_19 . V_21 . V_55 . V_53 ) ) {
* V_4 &= 0xffffffff00000000UL ;
* V_4 |= V_57 ;
return V_16 ;
}
...
{
int V_8 ;
struct V_1 * V_3 = F_30 ( V_2 -> V_56 , V_64 ) ;
if ( ! V_3 )
return V_49 ;
switch ( V_62 ) {
case V_66 :
...
case V_75 :
V_2 -> V_67 . V_76 ++ ;
V_8 = F_13 ( V_2 , V_3 , V_65 ) ;
break;
case V_77 :
V_2 -> V_67 . V_78 ++ ;
V_8 = F_19 ( V_2 , V_3 , V_46 ,
V_65 ) ;
break;
case V_79 :
V_2 -> V_67 . V_80 ++ ;
V_8 = F_17 ( V_2 , V_3 , V_46 , V_65 ) ;
break;
case V_81 :
V_2 -> V_67 . V_82 ++ ;
...
case V_83 :
V_2 -> V_67 . V_84 ++ ;
V_8 = F_21 ( V_2 , V_3 , V_65 ) ;
break;
case V_85 :
V_2 -> V_67 . V_86 ++ ;
V_8 = F_23 ( V_2 , V_3 , V_62 ) ;
break;
case V_87 :
V_2 -> V_67 . V_88 ++ ;
V_8 = F_23 ( V_2 , V_3 , V_62 ) ;
...
static int F_31 ( struct V_1 * V_2 , T_5 V_62 ,
T_2 V_64 )
{
...
T_2 V_64 = V_2 -> V_100 -> V_101 . V_102 . V_103 [ V_99 ] ;
struct V_1 * V_108 ;
T_5 V_62 = F_34 ( V_2 , NULL ) ;
F_38 ( V_2 , V_62 , V_64 ) ;
if ( V_62 == V_69 ) {
V_108 = F_30 ( V_2 -> V_56 , V_64 ) ;
F_39 ( V_108 == NULL ) ;
F_40 ( V_108 ) ;
F_36 ( V_2 , V_13 ) ;
return 0 ;
