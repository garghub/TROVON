...
unsigned long F_23 ( void T_1 * V_6 , const void * V_8 , unsigned V_3 )
{
if ( F_5 ( V_7 , V_6 , V_3 ) )
V_3 = F_24 ( V_6 , V_8 , V_3 ) ;
return V_3 ;
}
unsigned long F_25 ( void * V_6 , const void T_1 * V_8 , unsigned V_3 )
{
if ( F_5 ( V_13 , V_8 , V_3 ) )
V_3 = F_26 ( V_6 , V_8 , V_3 ) ;
else
memset ( V_6 , 0 , V_3 ) ;
return V_3 ;
}
