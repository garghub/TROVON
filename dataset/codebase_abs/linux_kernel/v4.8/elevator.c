...
V_5 -> V_30 = F_61 ( V_2 ) ;
V_5 -> V_31 = V_2 ;
F_62 ( & V_2 -> V_60 , & V_5 -> V_28 ) ;
}
int F_63 ( struct V_4 * V_5 , struct V_1 * * V_61 , struct V_3 * V_3 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
struct V_1 * V_47 ;
int V_62 ;
...
{
struct V_6 * V_7 = V_5 -> V_8 ;
const int V_69 = V_41 -> V_37 & V_70 ;
if ( V_69 && V_7 -> type -> V_9 . V_71 )
V_7 -> type -> V_9 . V_71 ( V_5 , V_2 , V_41 ) ;
F_40 ( V_5 , V_2 ) ;
if ( V_69 ) {
F_34 ( V_5 , V_41 ) ;
V_5 -> V_56 -- ;
...
{
if ( V_2 -> V_5 -> V_73 && ! ( V_2 -> V_37 & V_74 ) )
V_2 -> V_5 -> V_75 -- ;
}
static void F_74 ( struct V_4 * V_5 , struct V_1 * V_2 )
{
if ( V_5 -> V_73 && ! ( V_2 -> V_37 & V_74 ) && V_5 -> V_75 ++ == 0 &&
...
void F_80 ( struct V_4 * V_5 , struct V_1 * V_2 , int V_84 )
{
F_82 ( V_5 , V_2 ) ;
F_74 ( V_5 , V_2 ) ;
V_2 -> V_5 = V_5 ;
...
void F_86 ( struct V_4 * V_5 , struct V_1 * V_2 , int V_84 )
{
unsigned long V_95 ;
F_87 ( V_5 -> V_82 , V_95 ) ;
F_80 ( V_5 , V_2 , V_84 ) ;
...
int F_93 ( struct V_4 * V_5 , int V_101 , int V_102 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
if ( V_7 -> type -> V_9 . V_103 )
return V_7 -> type -> V_9 . V_103 ( V_5 , V_101 , V_102 ) ;
return V_104 ;
}
...
static T_4
F_95 ( struct V_26 * V_22 , struct V_106 * V_107 , char * V_108 )
{
struct V_109 * V_54 = F_96 ( V_107 ) ;
struct V_6 * V_7 ;
T_4 error ;
if ( ! V_54 -> V_110 )
return - V_111 ;
...
static T_4
F_97 ( struct V_26 * V_22 , struct V_106 * V_107 ,
...
if ( F_100 ( & V_7 -> V_22 , & V_107 -> V_107 ) )
break;
V_107 ++ ;
}
}
F_101 ( & V_7 -> V_22 , V_116 ) ;
V_7 -> V_117 = 1 ;
...
char * V_120 = L_11 ;
if ( V_7 -> V_121 ) {
if ( F_105 ( V_7 -> V_121 < sizeof( struct V_122 ) ) ||
F_105 ( V_7 -> V_123 < F_106 ( struct V_122 ) ) )
return - V_32 ;
snprintf ( V_7 -> V_124 , sizeof( V_7 -> V_124 ) ,
L_12 , V_7 -> V_13 ) ;
V_7 -> V_125 = F_107 ( V_7 -> V_124 , V_7 -> V_121 ,
V_7 -> V_123 , 0 , NULL ) ;
if ( ! V_7 -> V_125 )
return - V_126 ;
}
...
static int F_112 ( struct V_4 * V_5 , struct V_11 * V_131 )
{
...
struct V_1 * V_2 )
{
struct V_44 * V_141 = F_127 ( & V_2 -> V_44 ) ;
if ( V_141 )
return F_128 ( V_141 ) ;
return NULL ;
}
...
struct V_1 * V_2 )
{
struct V_44 * V_142 = F_130 ( & V_2 -> V_44 ) ;
if ( V_142 )
return F_128 ( V_142 ) ;
return NULL ;
}
