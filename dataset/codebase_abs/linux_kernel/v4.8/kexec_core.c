...
struct V_39 * F_28 ( struct V_7 * V_8 ,
unsigned int V_41 )
{
...
static int F_29 ( struct V_7 * V_8 , T_2 V_32 )
{
if ( * V_8 -> V_32 != 0 )
V_8 -> V_32 ++ ;
...
T_2 * V_61 ;
struct V_39 * V_39 ;
V_39 = F_30 ( V_8 , V_30 , V_62 ) ;
if ( ! V_39 )
return - V_63 ;
V_61 = F_31 ( V_39 ) ;
* V_8 -> V_32 = F_32 ( V_61 ) | V_64 ;
V_8 -> V_32 = V_61 ;
V_8 -> V_33 = V_61 +
( ( V_65 / sizeof( T_2 ) ) - 1 ) ;
}
...
int V_67 ;
V_66 &= V_18 ;
V_67 = F_29 ( V_8 , V_66 | V_68 ) ;
return V_67 ;
}
static int F_34 ( struct V_7 * V_8 , unsigned long V_39 )
{
int V_67 ;
V_39 &= V_18 ;
V_67 = F_29 ( V_8 , V_39 | V_69 ) ;
return V_67 ;
}
...
static T_2 * F_44 ( struct V_7 * V_8 ,
unsigned long V_39 )
{
T_2 * V_71 , V_32 ;
...
struct V_39 * V_39 ;
unsigned long V_52 ;
F_45 (page, &image->dest_pages, lru) {
V_52 = F_24 ( V_39 ) << V_55 ;
if ( V_52 == V_66 ) {
F_22 ( & V_39 -> V_48 ) ;
return V_39 ;
...
char * V_71 ;
T_3 V_86 , V_87 ;
V_39 = F_30 ( V_8 , V_88 , V_80 ) ;
if ( ! V_39 ) {
V_67 = - V_63 ;
goto V_85;
}
V_67 = F_34 ( V_8 , F_24 ( V_39 )
<< V_55 ) ;
if ( V_67 < 0 )
goto V_85;
V_71 = F_49 ( V_39 ) ;
...
void __weak F_73 ( unsigned long V_98 ,
unsigned long V_29 )
{
unsigned long V_52 ;
...
V_28 = F_76 ( V_28 , V_106 ) ;
V_29 = F_76 ( V_28 + V_99 , V_106 ) ;
F_73 ( V_29 , V_27 . V_29 ) ;
...
static T_5 * F_79 ( T_5 * V_83 , char * V_111 , unsigned type , void * V_113 ,
T_3 V_114 )
{
struct V_115 V_116 ;
...
void F_81 ( struct V_90 * V_91 , int V_120 )
{
struct V_121 V_122 ;
T_5 * V_83 ;
if ( ( V_120 < 0 ) || ( V_120 >= V_123 ) )
return;
V_83 = ( T_5 * ) F_82 ( V_124 , V_120 ) ;
if ( ! V_83 )
return;
memset ( & V_122 , 0 , sizeof( V_122 ) ) ;
V_122 . V_125 = V_126 -> V_4 ;
F_83 ( & V_122 . V_127 , V_91 ) ;
V_83 = F_79 ( V_83 , V_128 , V_129 ,
& V_122 , sizeof( V_122 ) ) ;
F_80 ( V_83 ) ;
}
...
T_3 V_59 , V_130 ;
V_59 = sizeof( V_131 ) ;
V_130 = F_52 ( F_85 ( sizeof( V_131 ) ) , V_65 ) ;
F_86 ( V_59 > V_65 ) ;
V_124 = F_87 ( V_59 , V_130 ) ;
if ( ! V_124 ) {
F_88 ( L_2 ) ;
return - V_63 ;
}
...
static int T_6 F_89 ( char * V_132 ,
...
static int T_6 F_91 ( char * V_132 ,
unsigned long long * V_134 ,
unsigned long long * V_135 )
{
char * V_136 = V_132 ;
* V_134 = F_90 ( V_132 , & V_136 ) ;
if ( V_132 == V_136 ) {
F_88 ( L_10 ) ;
return - V_23 ;
}
if ( * V_136 == '@' )
* V_135 = F_90 ( V_136 + 1 , & V_136 ) ;
...
static T_6 char * F_93 ( char * V_132 ,
const char * V_111 ,
const char * V_139 )
{
...
static int T_6 F_94 ( char * V_132 ,
unsigned long long V_133 ,
unsigned long long * V_134 ,
unsigned long long * V_135 ,
const char * V_111 ,
...
* V_134 = 0 ;
* V_135 = 0 ;
V_140 = F_93 ( V_132 , V_111 , V_139 ) ;
if ( ! V_140 )
return - V_23 ;
V_140 += strlen ( V_111 ) ;
if ( V_139 )
return F_92 ( V_140 , V_134 ,
V_139 ) ;
V_144 = strchr ( V_140 , ':' ) ;
V_145 = strchr ( V_140 , ' ' ) ;
if ( V_144 && ( ! V_145 || V_144 < V_145 ) )
return F_89 ( V_140 , V_133 ,
V_134 , V_135 ) ;
return F_91 ( V_140 , V_134 , V_135 ) ;
}
int T_6 F_96 ( char * V_132 ,
unsigned long long V_133 ,
unsigned long long * V_134 ,
unsigned long long * V_135 )
{
return F_94 ( V_132 , V_133 , V_134 , V_135 ,
L_12 , NULL ) ;
}
...
void F_100 ( const char * V_152 , ... )
{
T_7 args ;
char V_83 [ 0x50 ] ;
T_3 V_153 ;
va_start ( args , V_152 ) ;
V_153 = F_102 ( V_83 , sizeof( V_83 ) , V_152 , args ) ;
va_end ( args ) ;
V_153 = F_52 ( V_153 , V_154 - V_149 ) ;
memcpy ( & V_151 [ V_149 ] , V_83 , V_153 ) ;
V_149 += V_153 ;
}
void __weak F_103 ( void )
{}
T_8 __weak F_104 ( void )
{
return F_105 ( ( unsigned long ) ( char * ) & V_148 ) ;
}
static int T_6 F_106 ( void )
{
F_107 ( V_155 . V_111 . V_156 ) ;
F_108 ( V_65 ) ;
F_109 ( V_155 ) ;
F_109 ( V_157 ) ;
#ifdef F_110
...
F_115 ( V_45 , V_47 ) ;
F_115 ( V_45 , V_185 ) ;
F_115 ( V_186 , va_start ) ;
F_115 ( V_186 , V_46 ) ;
F_113 ( V_167 . V_168 , V_187 ) ;
F_118 () ;
F_113 ( V_168 . V_184 , V_188 ) ;
F_119 ( V_189 ) ;
F_119 ( V_190 ) ;
F_119 ( V_191 ) ;
F_119 ( V_192 ) ;
