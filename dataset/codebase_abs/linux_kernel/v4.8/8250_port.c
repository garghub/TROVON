...
F_80 ( & V_14 -> V_81 , V_43 ) ;
F_47 ( V_2 ) ;
return ( V_171 & V_172 ) == V_172 ? V_234 : 0 ;
}
unsigned int F_132 ( struct V_6 * V_14 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
unsigned int V_215 ;
unsigned int V_233 ;
...
static unsigned int F_133 ( struct V_6 * V_14 )
{
if ( V_14 -> V_241 )
return V_14 -> V_241 ( V_14 ) ;
return F_132 ( V_14 ) ;
}
void F_134 ( struct V_6 * V_14 , unsigned int V_242 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
...
if ( V_242 & V_247 )
V_41 |= V_89 ;
V_41 = ( V_41 & V_2 -> V_248 ) | V_2 -> V_249 | V_2 -> V_41 ;
F_43 ( V_2 , V_41 ) ;
}
static void F_135 ( struct V_6 * V_14 , unsigned int V_242 )
{
if ( V_14 -> V_250 )
V_14 -> V_250 ( V_14 , V_242 ) ;
else
F_134 ( V_14 , V_242 ) ;
}
static void F_136 ( struct V_6 * V_14 , int V_251 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
unsigned long V_43 ;
F_45 ( V_2 ) ;
...
static void F_137 ( struct V_1 * V_2 , int V_253 )
{
unsigned int V_215 , V_254 = 10000 ;
for (; ; ) {
V_215 = F_2 ( V_2 , V_92 ) ;
V_2 -> V_177 |= V_215 & V_178 ;
if ( ( V_215 & V_253 ) == V_253 )
break;
if ( -- V_254 == 0 )
break;
F_91 ( 1 ) ;
}
if ( V_2 -> V_14 . V_43 & V_255 ) {
for ( V_254 = 1000000 ; V_254 ; V_254 -- ) {
unsigned int V_256 = F_2 ( V_2 , V_141 ) ;
V_2 -> V_216 |= V_256 & V_257 ;
if ( V_256 & V_225 )
break;
F_91 ( 1 ) ;
F_138 () ;
...
static int F_139 ( struct V_6 * V_14 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
unsigned char V_171 ;
int V_215 ;
...
static void F_140 ( struct V_6 * V_14 ,
unsigned char V_259 )
{
unsigned int V_161 ;
struct V_1 * V_2 = F_35 ( V_14 ) ;
...
F_94 ( V_14 , V_72 , 0 ) ;
F_137 ( V_2 , V_172 ) ;
F_94 ( V_14 , V_91 , V_259 ) ;
F_137 ( V_2 , V_172 ) ;
F_94 ( V_14 , V_72 , V_161 ) ;
F_47 ( V_2 ) ;
}
int F_141 ( struct V_6 * V_14 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
unsigned long V_43 ;
...
unsigned char V_265 ;
F_4 ( V_2 , V_29 , V_70 ) ;
V_265 = F_2 ( V_2 , V_266 ) & ~ ( V_267 | V_268 ) ;
F_94 ( V_14 , V_266 ,
V_265 | V_269 | V_267 ) ;
F_94 ( V_14 , V_270 , V_271 ) ;
F_94 ( V_14 , V_266 ,
V_265 | V_269 | V_268 ) ;
F_94 ( V_14 , V_270 , V_271 ) ;
F_94 ( V_14 , V_29 , 0 ) ;
...
unsigned char V_272 ;
F_78 ( & V_14 -> V_81 , V_43 ) ;
if ( V_2 -> V_14 . V_273 & V_274 )
F_143 ( V_14 -> V_156 ) ;
F_137 ( V_2 , V_179 ) ;
F_37 ( V_14 , V_72 , V_170 ) ;
F_91 ( 1 ) ;
V_272 = F_129 ( V_14 , V_122 ) ;
F_94 ( V_14 , V_72 , 0 ) ;
F_37 ( V_14 , V_72 , V_170 ) ;
F_91 ( 1 ) ;
V_227 = F_129 ( V_14 , V_122 ) ;
...
F_144 ( V_14 -> V_156 ) ;
F_80 ( & V_14 -> V_81 , V_43 ) ;
if ( ( ! ( V_272 & V_231 ) && ( V_227 & V_231 ) ) ||
V_2 -> V_14 . V_43 & V_275 ) {
V_2 -> V_105 |= V_276 ;
}
}
V_260 = V_2 -> V_277 -> V_278 ( V_2 ) ;
if ( V_260 )
goto V_66;
F_94 ( V_14 , V_29 , V_279 ) ;
F_78 ( & V_14 -> V_81 , V_43 ) ;
if ( V_2 -> V_14 . V_43 & V_157 ) {
if ( ! V_2 -> V_14 . V_156 )
V_2 -> V_14 . V_242 |= V_245 ;
} else
if ( V_14 -> V_156 )
V_2 -> V_14 . V_242 |= V_246 ;
F_135 ( V_14 , V_14 -> V_242 ) ;
if ( V_2 -> V_14 . V_43 & V_280 )
goto V_281;
F_94 ( V_14 , V_72 , V_170 ) ;
V_171 = F_129 ( V_14 , V_92 ) ;
V_227 = F_129 ( V_14 , V_122 ) ;
F_94 ( V_14 , V_72 , 0 ) ;
if ( V_171 & V_282 && V_227 & V_231 ) {
if ( ! ( V_2 -> V_105 & V_176 ) ) {
V_2 -> V_105 |= V_176 ;
F_113 ( L_21 ,
F_77 ( V_14 ) ) ;
...
static int F_147 ( struct V_6 * V_14 )
{
if ( V_14 -> V_284 )
return V_14 -> V_284 ( V_14 ) ;
return F_141 ( V_14 ) ;
}
void F_148 ( struct V_6 * V_14 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
unsigned long V_43 ;
F_45 ( V_2 ) ;
...
static void F_151 ( struct V_6 * V_14 )
{
if ( V_14 -> V_286 )
V_14 -> V_286 ( V_14 ) ;
else
...
V_287 == ( V_14 -> V_78 / 4 ) )
V_124 = 0x8001 ;
else if ( ( V_14 -> V_43 & V_290 ) &&
V_287 == ( V_14 -> V_78 / 8 ) )
V_124 = 0x8002 ;
else if ( V_2 -> V_14 . type == V_63 )
V_124 = F_152 ( V_2 , V_287 , V_288 ) ;
else
V_124 = F_155 ( V_14 , V_287 ) ;
if ( V_2 -> V_105 & V_106 && ( V_124 & 0xff ) == 0 )
V_124 ++ ;
return V_124 ;
}
static unsigned char F_156 ( struct V_1 * V_2 ,
T_1 V_291 )
{
unsigned char V_292 ;
switch ( V_291 & V_293 ) {
...
static void F_158 ( struct V_6 * V_14 , unsigned int V_287 ,
unsigned int V_124 , unsigned int V_310 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
if ( F_159 ( V_2 ) ) {
if ( V_287 == 115200 ) {
...
F_94 ( V_14 , V_29 , V_2 -> V_61 | V_312 ) ;
F_67 ( V_2 , V_124 ) ;
if ( V_2 -> V_14 . type == V_63 )
F_94 ( V_14 , 0x2 , V_310 ) ;
}
static unsigned int F_160 ( struct V_6 * V_14 ,
struct V_313 * V_314 ,
struct V_313 * V_315 )
{
unsigned int V_316 = V_14 -> V_78 / 100 ;
return F_161 ( V_14 , V_314 , V_315 ,
V_14 -> V_78 / 16 / 0xffff ,
( V_14 -> V_78 + V_316 ) / 16 ) ;
}
void
F_162 ( struct V_6 * V_14 , struct V_313 * V_314 ,
struct V_313 * V_315 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
unsigned char V_292 ;
unsigned long V_43 ;
unsigned int V_287 , V_124 , V_288 = 0 ;
V_292 = F_156 ( V_2 , V_314 -> V_291 ) ;
V_287 = F_160 ( V_14 , V_314 , V_315 ) ;
V_124 = F_154 ( V_2 , V_287 , & V_288 ) ;
F_45 ( V_2 ) ;
F_78 ( & V_14 -> V_81 , V_43 ) ;
V_2 -> V_61 = V_292 ;
if ( V_2 -> V_35 & V_36 && V_14 -> V_146 > 1 ) {
if ( ( V_287 < 2400 && ! V_2 -> V_174 ) || V_2 -> V_306 ) {
V_2 -> V_46 &= ~ V_317 ;
V_2 -> V_46 |= V_318 ;
}
}
if ( V_2 -> V_35 & V_119 && V_14 -> V_146 >= 32 ) {
V_2 -> V_41 &= ~ V_319 ;
if ( V_314 -> V_291 & V_320 )
V_2 -> V_41 |= V_319 ;
}
F_163 ( V_14 , V_314 -> V_291 , V_287 ) ;
V_14 -> V_164 = V_198 | V_179 | V_93 ;
if ( V_314 -> V_321 & V_322 )
V_14 -> V_164 |= V_193 | V_194 ;
if ( V_314 -> V_321 & ( V_323 | V_324 | V_325 ) )
V_14 -> V_164 |= V_192 ;
V_14 -> V_326 = 0 ;
if ( V_314 -> V_321 & V_327 )
V_14 -> V_326 |= V_194 | V_193 ;
if ( V_314 -> V_321 & V_323 ) {
V_14 -> V_326 |= V_192 ;
if ( V_314 -> V_321 & V_327 )
V_14 -> V_326 |= V_198 ;
}
if ( ( V_314 -> V_291 & V_328 ) == 0 )
V_14 -> V_326 |= V_93 ;
V_2 -> V_161 &= ~ V_185 ;
if ( ! ( V_2 -> V_105 & V_184 ) &&
F_164 ( & V_2 -> V_14 , V_314 -> V_291 ) )
V_2 -> V_161 |= V_185 ;
if ( V_2 -> V_35 & V_130 )
V_2 -> V_161 |= V_128 ;
if ( V_2 -> V_35 & V_131 )
...
F_94 ( V_14 , V_29 , V_70 ) ;
if ( V_14 -> V_43 & V_117 )
F_94 ( V_14 , V_262 , V_62 ) ;
else
F_94 ( V_14 , V_69 , V_62 ) ;
}
F_158 ( V_14 , V_287 , V_124 , V_288 ) ;
if ( V_14 -> type == V_127 )
...
F_47 ( V_2 ) ;
if ( F_165 ( V_314 ) )
F_166 ( V_314 , V_287 , V_287 ) ;
}
static void
F_167 ( struct V_6 * V_14 , struct V_313 * V_314 ,
struct V_313 * V_315 )
{
if ( V_14 -> V_331 )
V_14 -> V_331 ( V_14 , V_314 , V_315 ) ;
else
F_162 ( V_14 , V_314 , V_315 ) ;
}
static void
F_168 ( struct V_6 * V_14 , struct V_313 * V_314 )
{
...
void F_169 ( struct V_6 * V_14 , unsigned int V_205 ,
unsigned int V_335 )
{
...
static void
F_170 ( struct V_6 * V_14 , unsigned int V_205 ,
unsigned int V_335 )
{
if ( V_14 -> V_336 )
V_14 -> V_336 ( V_14 , V_205 , V_335 ) ;
else
F_169 ( V_14 , V_205 , V_335 ) ;
}
static unsigned int F_171 ( struct V_1 * V_337 )
{
if ( V_337 -> V_14 . V_338 )
return V_337 -> V_14 . V_338 ;
if ( V_337 -> V_14 . V_19 == V_25 ) {
if ( V_337 -> V_14 . type == V_339 )
return 0x100 ;
return 0x1000 ;
}
if ( F_172 ( V_337 ) )
return 0x16 << V_337 -> V_14 . V_12 ;
return 8 << V_337 -> V_14 . V_12 ;
}
static int F_173 ( struct V_1 * V_2 )
{
unsigned int V_340 = F_171 ( V_2 ) ;
struct V_6 * V_14 = & V_2 -> V_14 ;
int V_233 = 0 ;
switch ( V_14 -> V_19 ) {
case V_25 :
...
if ( ! V_14 -> V_138 )
break;
if ( ! F_174 ( V_14 -> V_138 , V_340 , L_23 ) ) {
V_233 = - V_342 ;
break;
}
if ( V_14 -> V_43 & V_343 ) {
V_14 -> V_11 = F_175 ( V_14 -> V_138 , V_340 ) ;
if ( ! V_14 -> V_11 ) {
F_176 ( V_14 -> V_138 , V_340 ) ;
V_233 = - V_52 ;
}
}
break;
...
case V_20 :
case V_344 :
F_180 ( V_14 -> V_16 , V_340 ) ;
break;
}
}
static void F_181 ( struct V_6 * V_14 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
F_178 ( V_2 ) ;
}
static int F_182 ( struct V_6 * V_14 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
return F_173 ( V_2 ) ;
}
...
{
const struct V_345 * V_346 = & V_147 [ V_2 -> V_14 . type ] ;
unsigned char V_347 ;
V_347 = V_346 -> V_348 [ F_184 ( V_2 -> V_46 ) ] ;
return V_347 ? V_347 : - V_349 ;
}
static int F_185 ( struct V_1 * V_2 , unsigned char V_347 )
{
const struct V_345 * V_346 = & V_147 [ V_2 -> V_14 . type ] ;
int V_350 ;
if ( ! V_346 -> V_348 [ F_184 ( V_351 ) ] )
return - V_349 ;
for ( V_350 = 1 ; V_350 < V_352 ; V_350 ++ ) {
if ( V_347 < V_346 -> V_348 [ V_350 ] )
return ( -- V_350 ) << V_353 ;
}
return V_354 ;
}
static int F_186 ( struct V_355 * V_14 )
{
struct V_356 * V_205 = F_187 ( V_14 , struct V_356 , V_14 ) ;
struct V_6 * V_357 = V_205 -> V_6 ;
struct V_1 * V_2 = F_35 ( V_357 ) ;
if ( ! ( V_2 -> V_35 & V_36 ) || V_357 -> V_146 <= 1 )
return - V_358 ;
return F_183 ( V_2 ) ;
}
static int F_188 ( struct V_355 * V_14 )
{
int V_348 ;
F_189 ( & V_14 -> V_359 ) ;
V_348 = F_186 ( V_14 ) ;
...
static T_2 F_191 ( struct V_360 * V_48 ,
struct V_361 * V_362 , char * V_210 )
{
struct V_355 * V_14 = F_192 ( V_48 ) ;
int V_348 ;
V_348 = F_188 ( V_14 ) ;
if ( V_348 < 0 )
return V_348 ;
return snprintf ( V_210 , V_363 , L_24 , V_348 ) ;
}
static int F_193 ( struct V_355 * V_14 , unsigned char V_347 )
{
struct V_356 * V_205 = F_187 ( V_14 , struct V_356 , V_14 ) ;
struct V_6 * V_357 = V_205 -> V_6 ;
struct V_1 * V_2 = F_35 ( V_357 ) ;
...
V_2 -> V_306 )
return - V_358 ;
V_364 = F_185 ( V_2 , V_347 ) ;
if ( V_364 < 0 )
return V_364 ;
F_40 ( V_2 ) ;
V_2 -> V_46 &= ~ V_317 ;
V_2 -> V_46 |= ( unsigned char ) V_364 ;
F_4 ( V_2 , V_37 , V_2 -> V_46 ) ;
return 0 ;
}
static int F_194 ( struct V_355 * V_14 , unsigned char V_347 )
{
int V_233 ;
F_189 ( & V_14 -> V_359 ) ;
V_233 = F_193 ( V_14 , V_347 ) ;
F_190 ( & V_14 -> V_359 ) ;
return V_233 ;
}
static T_2 F_195 ( struct V_360 * V_48 ,
struct V_361 * V_362 , const char * V_210 , T_3 V_88 )
{
struct V_355 * V_14 = F_192 ( V_48 ) ;
unsigned char V_347 ;
int V_233 ;
if ( ! V_88 )
return - V_358 ;
V_233 = F_196 ( V_210 , 10 , & V_347 ) ;
if ( V_233 < 0 )
return V_233 ;
V_233 = F_194 ( V_14 , V_347 ) ;
if ( V_233 < 0 )
return V_233 ;
return V_88 ;
}
...
const struct V_345 * V_346 = & V_147 [ V_2 -> V_14 . type ] ;
if ( V_346 -> V_348 [ 0 ] )
V_2 -> V_14 . V_365 = & V_366 ;
}
static void F_198 ( struct V_6 * V_14 , int V_43 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
int V_233 ;
V_233 = F_173 ( V_2 ) ;
...
static int
F_199 ( struct V_6 * V_14 , struct V_370 * V_371 )
{
if ( V_371 -> V_156 >= V_372 || V_371 -> V_156 < 0 ||
V_371 -> V_373 < 9600 || V_371 -> type < V_142 ||
V_371 -> type >= F_6 ( V_147 ) || V_371 -> type == V_374 ||
V_371 -> type == V_375 )
return - V_358 ;
return 0 ;
}
static const char * F_200 ( struct V_6 * V_14 )
{
int type = V_14 -> type ;
if ( type >= F_6 ( V_147 ) )
type = 0 ;
...
if ( V_2 -> V_174 ) {
if ( ! V_2 -> V_174 -> V_175 )
V_2 -> V_174 -> V_175 = V_378 ;
if ( ! V_2 -> V_174 -> V_230 )
V_2 -> V_174 -> V_230 = V_379 ;
}
}
static void F_204 ( struct V_6 * V_14 , int V_186 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
F_137 ( V_2 , V_179 ) ;
...
struct V_313 V_314 ;
unsigned int V_287 , V_124 , V_288 = 0 ;
V_314 . V_291 = V_14 -> V_380 -> V_381 ;
if ( V_14 -> V_205 -> V_14 . V_382 && V_314 . V_291 == 0 )
V_314 . V_291 = V_14 -> V_205 -> V_14 . V_382 -> V_314 . V_291 ;
V_287 = F_160 ( V_14 , & V_314 , NULL ) ;
V_124 = F_154 ( V_2 , V_287 , & V_288 ) ;
F_158 ( V_14 , V_287 , V_124 , V_288 ) ;
F_94 ( V_14 , V_29 , V_2 -> V_61 ) ;
F_43 ( V_2 , V_160 | V_45 ) ;
}
void F_206 ( struct V_1 * V_2 , const char * V_383 ,
unsigned int V_88 )
{
struct V_6 * V_14 = & V_2 -> V_14 ;
unsigned long V_43 ;
...
F_94 ( V_14 , V_72 , 0 ) ;
if ( V_2 -> V_387 && ( V_2 -> V_387 != F_129 ( V_14 , V_30 ) ) ) {
F_205 ( V_2 ) ;
V_2 -> V_387 = 0 ;
}
F_208 ( V_14 , V_383 , V_88 , F_204 ) ;
F_137 ( V_2 , V_172 ) ;
F_94 ( V_14 , V_72 , V_161 ) ;
if ( V_2 -> V_216 )
F_122 ( V_2 ) ;
...
static unsigned int F_209 ( struct V_6 * V_14 )
{
unsigned char V_61 , V_388 , V_389 ;
unsigned int V_124 ;
V_61 = F_129 ( V_14 , V_29 ) ;
F_94 ( V_14 , V_29 , V_61 | V_312 ) ;
V_388 = F_129 ( V_14 , V_3 ) ;
V_389 = F_129 ( V_14 , V_4 ) ;
F_94 ( V_14 , V_29 , V_61 ) ;
V_124 = ( V_389 << 8 ) | V_388 ;
return ( V_14 -> V_78 / 16 ) / V_124 ;
}
int F_210 ( struct V_6 * V_14 , char * V_390 , bool V_144 )
{
int V_287 = 9600 ;
int V_253 = 8 ;
int V_196 = 'n' ;
...
return - V_264 ;
if ( V_390 )
F_211 ( V_390 , & V_287 , & V_196 , & V_253 , & V_391 ) ;
else if ( V_144 )
V_287 = F_209 ( V_14 ) ;
return F_212 ( V_14 , V_14 -> V_380 , V_287 , V_196 , V_253 , V_391 ) ;
}
