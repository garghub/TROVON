...
if ( ! * args )
goto V_117;
V_115 = V_108 - ( args - ( V_114 ? V_114 : ( char * ) V_103 ) ) ;
if ( strcmp ( V_102 , L_1 ) == 0 ) {
...
static int F_82 ( char * V_135 , const struct V_132 * V_133 )
{
if ( ! F_83 () )
return - V_134 ;
return F_84 ( V_135 , V_133 ) ;
}
static int F_85 ( const char * V_131 , const struct V_132 * V_133 )
{
if ( ! F_80 () )
return - V_134 ;
return F_81 ( V_131 , V_133 ) ;
}
static int F_86 ( char * V_135 , const struct V_132 * V_133 )
{
if ( ! F_83 () )
return - V_134 ;
return F_84 ( V_135 , V_133 ) ;
}
static int F_87 ( const char * V_131 , const struct V_132 * V_133 )
{
if ( ! F_80 () )
return - V_134 ;
return F_88 ( V_131 , V_133 ) ;
}
static int F_89 ( char * V_135 , const struct V_132 * V_133 )
{
if ( ! F_83 () )
return - V_134 ;
return F_90 ( V_135 , V_133 ) ;
}
static int F_91 ( char * V_135 , struct V_132 * V_133 )
{
if ( ! F_83 () )
return - V_134 ;
if ( ! V_130 )
return - V_107 ;
return sprintf ( V_135 , L_9 , V_136 [ V_137 ] ) ;
}
static int F_92 ( const char * V_131 , struct V_132 * V_133 )
{
int V_138 ;
if ( ! F_80 () )
return - V_134 ;
...
static int F_93 ( char * V_135 , struct V_132 * V_133 )
{
if ( ! F_80 () )
return - V_134 ;
if ( ! V_130 )
return - V_107 ;
return sprintf ( V_135 , L_9 , V_140 [ V_141 ] ) ;
}
static int F_94 ( const char * V_131 , struct V_132 * V_133 )
{
int V_138 ;
if ( ! F_80 () )
return - V_134 ;
...
{
struct V_1 * V_1 = (struct V_1 * ) V_13 -> V_143 ;
struct V_3 * V_4 ;
V_4 = F_5 ( V_79 ) ;
if ( ! V_4 )
return - V_5 ;
V_4 -> V_21 = F_96 ( V_144 -> F_16 ) ;
F_3 ( V_1 ) = V_4 ;
return 0 ;
}
