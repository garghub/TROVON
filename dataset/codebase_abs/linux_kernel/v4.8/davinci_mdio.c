...
static int F_20 ( struct V_14 * V_15 , int V_37 , int V_38 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
T_1 V_30 ;
int V_19 ;
...
static int F_21 ( struct V_14 * V_15 , int V_37 ,
int V_38 , T_3 V_46 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
T_1 V_30 ;
...
static int F_22 ( struct V_48 * V_2 ,
struct V_49 * V_50 )
{
...
{
struct V_48 * V_7 = F_25 ( & V_50 -> V_20 ) ;
...
V_19 = F_22 ( & V_2 -> V_7 , V_50 ) ;
if ( V_19 )
return V_19 ;
snprintf ( V_2 -> V_15 -> V_66 , V_67 , L_10 , V_50 -> V_68 ) ;
V_65 = F_28 ( V_69 , & V_50 -> V_20 ) ;
if ( V_65 ) {
...
V_2 -> V_15 -> V_68 = F_29 ( V_20 ) ;
V_2 -> V_15 -> V_73 = F_20 ,
V_2 -> V_15 -> V_74 = F_21 ,
V_2 -> V_15 -> V_75 = F_6 ,
V_2 -> V_15 -> V_76 = V_20 ;
V_2 -> V_15 -> V_16 = V_2 ;
V_2 -> V_6 = F_30 ( V_20 , L_12 ) ;
if ( F_31 ( V_2 -> V_6 ) ) {
F_18 ( V_20 , L_13 ) ;
return F_32 ( V_2 -> V_6 ) ;
}
F_33 ( V_20 , V_2 ) ;
V_2 -> V_20 = V_20 ;
V_57 = F_34 ( V_50 , V_77 , 0 ) ;
V_2 -> V_12 = F_35 ( V_20 , V_57 ) ;
if ( F_31 ( V_2 -> V_12 ) )
...
F_37 ( & V_50 -> V_20 ) ;
F_38 ( & V_50 -> V_20 ) ;
if ( V_20 -> V_53 && F_39 ( V_20 -> V_53 ) ) {
V_2 -> V_23 = true ;
V_19 = F_40 ( V_2 -> V_15 , V_20 -> V_53 ) ;
} else {
V_19 = F_41 ( V_2 -> V_15 ) ;
}
if ( V_19 )
...
V_59 = F_42 ( V_2 -> V_15 , V_60 ) ;
if ( V_59 ) {
F_11 ( V_20 , L_14 ,
V_59 -> V_79 . V_60 , F_43 ( V_59 ) ,
...
static int F_49 ( struct V_55 * V_20 )
{
struct V_1 * V_2 = F_50 ( V_20 ) ;
T_1 V_81 ;
...
static int F_51 ( struct V_55 * V_20 )
{
struct V_1 * V_2 = F_50 ( V_20 ) ;
F_4 ( V_2 ) ;
return 0 ;
...
static int F_56 ( struct V_55 * V_20 )
{
struct V_1 * V_2 = F_50 ( V_20 ) ;
F_57 ( V_20 ) ;
if ( V_2 -> V_82 )
