...
static T_4
F_56 ( struct V_20 * V_20 , char T_2 * V_15 , T_3 V_83 , T_5 * V_84 )
{
T_1 * V_7 = F_57 ( V_20 ) -> V_79 ;
T_4 V_85 ;
char * V_65 ;
V_65 = ( char * ) F_58 ( V_54 ) ;
if ( ! V_65 )
return - V_53 ;
F_38 ( V_7 , V_65 ) ;
V_85 = F_59 ( V_15 , V_83 , V_84 , V_65 , strlen ( V_65 ) ) ;
...
T_1 * V_7 ;
struct V_69 * V_69 ;
struct V_70 * V_71 = F_57 ( V_20 ) -> V_78 ;
struct V_80 * V_86 = V_71 -> V_87 , * V_80 ;
int V_49 = 0 ;
V_7 = F_29 ( V_46 , V_47 ) ;
if ( F_18 ( V_7 ) )
return F_21 ( V_7 ) ;
F_64 ( F_52 ( V_86 ) ) ;
V_80 = F_67 ( V_7 -> V_56 , V_86 , strlen ( V_7 -> V_56 ) ) ;
V_49 = F_21 ( V_80 ) ;
if ( F_18 ( V_80 ) )
goto V_52;
V_49 = - V_88 ;
...
static T_4
F_75 ( struct V_20 * V_20 , char T_2 * V_15 , T_3 V_83 , T_5 * V_84 )
{
char * V_9 = V_28 ? L_31 : L_32 ;
return F_59 ( V_15 , V_83 , V_84 , V_9 , strlen ( V_9 ) ) ;
}
...
static struct V_80 * F_80 ( struct V_108 * V_109 ,
