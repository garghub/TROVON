...
V_78 = F_29 ( sizeof( struct V_57 ) * V_2 -> V_66 ,
V_63 ) ;
if ( ! V_78 ) {
F_25 ( L_13 ) ;
V_42 = V_64 ;
...
F_43 ( V_78 , V_2 -> V_66 ) ;
V_85 = F_30 ( V_2 -> V_65 , V_2 -> V_66 , V_12 ,
V_2 -> V_17 ) ;
if ( ! V_85 ) {
F_25 ( L_14 ) ;
V_42 = V_64 ;
...
V_81 = F_44 ( V_58 -> V_68 , V_84 ) ;
if ( memcmp ( V_56 , V_12 + V_59 , V_81 ) ) {
F_26 ( L_15 ,
V_56 , V_12 + V_59 ) ;
F_34 ( V_56 ) ;
goto V_87;
...
V_61 = 0 ;
V_81 = V_2 -> V_83 * V_16 ;
F_45 ( & V_80 , V_2 -> V_65 , V_2 -> V_66 , V_88 ) ;
while ( V_81 ) {
F_46 ( & V_80 ) ;
if ( V_16 < V_89 ) {
F_47 ( & V_78 [ V_61 ] , V_80 . V_90 , V_16 ,
V_80 . V_91 . V_58 -> V_59 + V_16 ) ;
} else {
F_46 ( & V_80 ) ;
F_47 ( & V_78 [ V_61 ] , V_80 . V_90 , V_16 ,
V_80 . V_91 . V_58 -> V_59 ) ;
...
V_42 = V_39 -> V_69 ( V_2 , V_2 -> V_86 , V_2 -> V_104 ,
V_105 ) ;
if ( V_42 ) {
V_2 -> V_96 = NULL ;
F_40 ( & V_4 -> V_77 ) ;
...
V_132 = V_174 ;
if ( V_132 / 16 > V_4 -> V_15 . V_176 ) {
V_42 = V_177 ;
goto V_178;
}
V_170 = & V_12 [ 8 ] ;
F_54 ( L_42
L_43 , V_4 -> V_9 -> V_101 , V_173 , V_174 , V_132 , V_170 ) ;
while ( V_132 >= 16 ) {
V_171 = F_58 ( & V_170 [ 0 ] ) ;
V_172 = F_11 ( & V_170 [ 8 ] ) ;
F_54 ( L_44 ,
( unsigned long long ) V_171 , V_172 ) ;
if ( V_172 > V_4 -> V_15 . V_179 ) {
V_42 = V_177 ;
goto V_178;
}
if ( V_171 + V_172 > V_4 -> V_9 -> V_10 ( V_4 ) + 1 ) {
V_42 = V_51 ;
goto V_178;
}
V_42 = V_39 -> V_43 ( V_2 , V_171 , V_172 ) ;
if ( V_42 )
goto V_178;
V_170 += 16 ;
V_132 -= 16 ;
...
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_180 * V_181 ;
struct V_57 * V_182 = V_2 -> V_65 , * V_183 ;
T_4 V_184 = V_2 -> V_37 ;
void * V_185 , * V_186 ;
int V_61 , V_187 , V_59 = 0 ;
unsigned int V_16 = V_4 -> V_15 . V_16 ;
F_31 (cmd->t_prot_sg, psg, cmd->t_prot_nents, i) {
V_186 = F_32 ( F_33 ( V_183 ) ) + V_183 -> V_59 ;
V_185 = F_32 ( F_33 ( V_182 ) ) + V_182 -> V_59 ;
for ( V_187 = 0 ; V_187 < V_183 -> V_68 ;
V_187 += sizeof( * V_181 ) ) {
T_6 V_188 ;
unsigned int V_189 ;
if ( V_59 >= V_182 -> V_68 ) {
V_59 -= V_182 -> V_68 ;
F_34 ( V_185 - V_182 -> V_59 ) ;
V_182 = F_63 ( V_182 ) ;
if ( ! V_182 ) {
...
V_181 = V_186 + V_187 ;
V_189 = F_44 ( V_16 , V_182 -> V_68 - V_59 ) ;
V_188 = F_64 ( V_185 + V_59 , V_189 ) ;
if ( V_189 < V_16 ) {
F_34 ( V_185 - V_182 -> V_59 ) ;
V_182 = F_63 ( V_182 ) ;
if ( ! V_182 ) {
...
V_185 = F_32 ( F_33 ( V_182 ) ) + V_182 -> V_59 ;
V_59 = V_16 - V_189 ;
V_188 = F_65 ( V_188 , V_185 , V_59 ) ;
} else {
V_59 += V_16 ;
}
V_181 -> V_190 = F_66 ( V_188 ) ;
if ( V_2 -> V_109 == V_116 )
V_181 -> V_191 = F_67 ( V_184 & 0xffffffff ) ;
V_181 -> V_192 = 0 ;
F_54 ( L_45
L_46 ,
( V_2 -> V_70 == V_144 ) ?
L_47 : L_48 , ( unsigned long long ) V_184 ,
V_181 -> V_190 , V_181 -> V_192 ,
F_68 ( V_181 -> V_191 ) ) ;
V_184 ++ ;
}
F_34 ( V_185 - V_182 -> V_59 ) ;
...
T_6 V_188 , T_4 V_184 , unsigned int V_193 )
{
T_7 V_194 ;
if ( ! ( V_2 -> V_114 & V_115 ) )
goto V_195;
...
F_25 ( L_49
L_50 , ( unsigned long long ) V_184 ,
F_70 ( V_181 -> V_190 ) , F_70 ( V_194 ) ) ;
return V_196 ;
}
V_195:
if ( ! ( V_2 -> V_114 & V_117 ) )
return 0 ;
if ( V_2 -> V_109 == V_116 &&
F_68 ( V_181 -> V_191 ) != ( V_184 & 0xffffffff ) ) {
F_25 ( L_51
L_52 , ( unsigned long long ) V_184 ,
F_68 ( V_181 -> V_191 ) , ( T_2 ) ( V_184 & 0xffffffff ) ) ;
return V_197 ;
}
if ( V_2 -> V_109 == V_127 &&
F_68 ( V_181 -> V_191 ) != V_193 ) {
F_25 ( L_53
L_54 , ( unsigned long long ) V_184 ,
F_68 ( V_181 -> V_191 ) , V_193 ) ;
return V_197 ;
}
return 0 ;
}
void F_71 ( struct V_1 * V_2 , unsigned int V_44 , bool V_198 ,
struct V_57 * V_58 , int V_199 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_57 * V_183 ;
void * V_186 , * V_56 ;
unsigned int V_61 , V_81 , V_200 ;
unsigned int V_59 = V_199 ;
if ( ! V_58 )
return;
V_200 = V_44 * V_4 -> V_129 ;
F_31 (cmd->t_prot_sg, psg, cmd->t_prot_nents, i) {
unsigned int V_201 , V_202 = 0 ;
V_186 = F_32 ( F_33 ( V_183 ) ) + V_183 -> V_59 ;
V_201 = F_44 ( V_200 , V_183 -> V_68 ) ;
while ( V_201 ) {
V_81 = F_44 ( V_201 , V_58 -> V_68 - V_59 ) ;
V_56 = F_32 ( F_33 ( V_58 ) ) + V_58 -> V_59 + V_59 ;
if ( V_198 )
memcpy ( V_186 + V_202 , V_56 , V_81 ) ;
else
memcpy ( V_56 , V_186 + V_202 , V_81 ) ;
V_200 -= V_81 ;
V_59 += V_81 ;
V_202 += V_81 ;
V_201 -= V_81 ;
...
T_1
F_72 ( struct V_1 * V_2 , T_4 V_203 , unsigned int V_44 ,
unsigned int V_193 , struct V_57 * V_183 , int V_204 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_180 * V_181 ;
struct V_57 * V_182 = V_2 -> V_65 ;
T_4 V_184 = V_203 ;
void * V_185 , * V_186 ;
int V_61 ;
T_1 V_85 ;
int V_205 = 0 ;
unsigned int V_16 = V_4 -> V_15 . V_16 ;
for (; V_183 && V_184 < V_203 + V_44 ; V_183 = F_63 ( V_183 ) ) {
V_186 = F_32 ( F_33 ( V_183 ) ) + V_183 -> V_59 ;
V_185 = F_32 ( F_33 ( V_182 ) ) + V_182 -> V_59 ;
for ( V_61 = V_204 ; V_61 < V_183 -> V_68 &&
V_184 < V_203 + V_44 ;
V_61 += sizeof( * V_181 ) ) {
T_6 V_188 ;
unsigned int V_189 ;
...
F_54 ( L_55
L_46 ,
( unsigned long long ) V_184 , V_181 -> V_190 ,
V_181 -> V_192 , F_68 ( V_181 -> V_191 ) ) ;
if ( V_181 -> V_192 == F_66 ( 0xffff ) ) {
V_205 += V_16 ;
goto V_206;
}
V_189 = F_44 ( V_16 , V_182 -> V_68 - V_205 ) ;
V_188 = F_64 ( V_185 + V_205 , V_189 ) ;
if ( V_189 < V_16 ) {
F_34 ( V_185 - V_182 -> V_59 ) ;
V_182 = F_63 ( V_182 ) ;
if ( ! V_182 ) {
...
V_185 = F_32 ( F_33 ( V_182 ) ) + V_182 -> V_59 ;
V_205 = V_16 - V_189 ;
V_188 = F_65 ( V_188 , V_185 , V_205 ) ;
} else {
V_205 += V_16 ;
}
V_85 = F_69 ( V_2 , V_181 , V_188 , V_184 , V_193 ) ;
if ( V_85 ) {
F_34 ( V_185 - V_182 -> V_59 ) ;
F_34 ( V_186 - V_183 -> V_59 ) ;
V_2 -> V_207 = V_184 ;
