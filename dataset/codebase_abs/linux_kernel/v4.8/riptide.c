...
V_108 -> V_213 = V_214 ;
V_11 = F_99 ( sizeof( struct V_109 ) , V_215 ) ;
if ( V_11 == NULL )
return - V_216 ;
...
static int F_105 ( struct V_102 * V_103 , int V_129 )
{
struct V_225 * V_135 ;
int V_21 ;
if ( ( V_21 =
F_106 ( V_103 -> V_132 , L_38 , V_129 , V_106 , 1 ,
& V_135 ) ) < 0 )
return V_21 ;
F_107 ( V_135 , V_226 ,
& V_227 ) ;
...
static T_4
F_109 ( int V_233 , void * V_101 )
{
struct V_102 * V_103 = V_101 ;
struct V_7 * V_8 = V_103 -> V_8 ;
if ( V_8 ) {
V_103 -> V_234 ++ ;
if ( F_110 ( V_8 -> V_56 ) || F_111 ( V_8 -> V_56 ) ||
F_112 ( V_8 -> V_56 ) ) {
V_103 -> V_235 ++ ;
F_113 ( & V_103 -> V_236 ) ;
}
if ( V_103 -> V_237 && F_114 ( V_8 -> V_56 ) ) {
V_103 -> V_235 ++ ;
F_115 ( V_233 ,
V_103 -> V_237 -> V_115 ) ;
}
...
static void
F_116 ( struct V_239 * V_136 , unsigned short V_240 ,
unsigned short V_20 )
{
...
static unsigned short F_117 ( struct V_239 * V_136 ,
...
V_8 = V_103 -> V_8 ;
if ( ! V_8 ) {
if ( ( V_8 = F_99 ( sizeof( struct V_7 ) , V_215 ) ) == NULL )
return - V_216 ;
...
static int F_121 ( struct V_102 * V_103 )
{
struct V_7 * V_8 ;
if ( ! V_103 )
return 0 ;
...
if ( V_103 -> V_233 >= 0 )
F_122 ( V_103 -> V_233 , V_103 ) ;
F_123 ( V_103 -> V_147 ) ;
F_124 ( V_103 -> V_242 ) ;
F_103 ( V_103 ) ;
return 0 ;
}
static int F_125 ( struct V_243 * V_129 )
{
struct V_102 * V_103 = V_129 -> V_244 ;
return F_121 ( V_103 ) ;
}
static int
F_126 ( struct V_131 * V_132 , struct V_245 * V_148 ,
struct V_102 * * V_246 )
{
struct V_102 * V_103 ;
struct V_55 * V_56 ;
...
* V_246 = NULL ;
if ( ( V_21 = F_127 ( V_148 ) ) < 0 )
return V_21 ;
if ( ! ( V_103 = F_99 ( sizeof( struct V_102 ) , V_215 ) ) )
return - V_216 ;
F_118 ( & V_103 -> V_64 ) ;
V_103 -> V_132 = V_132 ;
V_103 -> V_148 = V_148 ;
V_103 -> V_233 = - 1 ;
V_103 -> V_180 = 0 ;
V_103 -> V_68 = F_128 ( V_148 , 0 ) ;
V_103 -> V_234 = 0 ;
V_103 -> V_235 = 0 ;
V_103 -> V_8 = NULL ;
F_129 ( & V_103 -> V_236 , F_43 , ( unsigned long ) V_103 ) ;
if ( ( V_103 -> V_242 =
F_130 ( V_103 -> V_68 , 64 , L_38 ) ) == NULL ) {
F_17 ( V_62
L_44 ,
...
F_131 ( V_56 ) ;
if ( F_132 ( V_148 -> V_233 , F_109 , V_250 ,
V_251 , V_103 ) ) {
F_17 ( V_62 L_45 ,
V_148 -> V_233 ) ;
F_121 ( V_103 ) ;
...
if ( ( V_21 = F_134 ( V_132 , V_252 , V_103 , & V_248 ) ) < 0 ) {
F_121 ( V_103 ) ;
return V_21 ;
}
* V_246 = V_103 ;
...
if ( ! V_103 )
return;
F_136 ( V_256 , L_46 , V_103 -> V_132 -> V_257 ) ;
F_136 ( V_256 , L_47 ,
V_103 -> V_241 , V_103 -> V_235 , V_103 -> V_234 ) ;
for ( V_12 = 0 ; V_12 < 64 ; V_12 += 4 )
F_136 ( V_256 , L_48 ,
( V_12 % 16 ) ? ' ' : '\n' , V_12 , F_137 ( V_103 -> V_68 + V_12 ) ) ;
if ( ( V_8 = V_103 -> V_8 ) ) {
F_136 ( V_256 ,
L_49 ,
...
F_136 ( V_256 , L_51 , V_12 , V_81 , V_82 ) ;
}
F_136 ( V_256 ,
L_52 ,
V_8 -> V_75 , V_8 -> V_59 ,
...
while ( V_12 >= 2 ) {
V_12 -= 2 ;
F_136 ( V_256 , L_57 , V_13 [ V_12 ] , V_13 [ V_12 + 1 ] ) ;
}
F_136 ( V_256 , L_58 ) ;
}
...
{
struct V_253 * V_254 ;
if ( ! F_139 ( V_103 -> V_132 , L_59 , & V_254 ) )
F_140 ( V_254 , V_103 , F_135 ) ;
}
...
if ( ( V_21 = F_142 ( V_259 , & V_136 , & V_103 -> V_136 ) ) < 0 )
return V_21 ;
return V_21 ;
}
static int
F_143 ( struct V_245 * V_148 , const struct V_267 * V_91 )
{
static int V_130 ;
struct V_268 * V_268 ;
int V_52 ;
...
static void F_148 ( struct V_245 * V_148 )
{
struct V_268 * V_268 = F_149 ( V_148 ) ;
if ( V_268 ) {
F_150 ( V_268 -> V_276 , 8 ) ;
F_151 ( V_268 ) ;
}
...
static int
F_152 ( struct V_245 * V_148 , const struct V_267 * V_277 )
{
static int V_130 ;
struct V_131 * V_132 ;
struct V_102 * V_103 ;
...
V_21 = F_153 ( & V_148 -> V_130 , V_278 [ V_130 ] , V_91 [ V_130 ] , V_279 ,
0 , & V_132 ) ;
if ( V_21 < 0 )
return V_21 ;
V_21 = F_126 ( V_132 , V_148 , & V_103 ) ;
if ( V_21 < 0 )
goto error;
V_132 -> V_115 = V_103 ;
V_21 = F_105 ( V_103 , 0 ) ;
...
F_155 ( V_103 -> V_148 , V_287 , V_20 ) ;
if ( V_284 [ V_130 ] ) {
V_20 = V_284 [ V_130 ] ;
F_155 ( V_103 -> V_148 , V_288 , V_20 ) ;
V_21 = F_156 ( V_132 , 0 , V_289 ,
V_20 , V_290 , - 1 ,
& V_103 -> V_237 ) ;
if ( V_21 < 0 )
F_17 ( V_275
...
if ( V_281 [ V_130 ] ) {
V_20 = V_281 [ V_130 ] ;
F_155 ( V_103 -> V_148 , V_292 , V_20 ) ;
V_21 = F_157 ( V_132 , V_20 , V_20 + 2 ,
V_293 , 0 , & V_103 -> V_294 ) ;
if ( V_21 < 0 )
F_17 ( V_275
L_63 ,
...
V_103 -> V_295 = V_20 ;
V_21 = F_158 ( V_103 -> V_294 , 0 , 1 , NULL ) ;
if ( V_21 < 0 )
F_17 ( V_275
L_64 ) ;
}
...
static void F_161 ( struct V_245 * V_148 )
{
F_160 ( F_149 ( V_148 ) ) ;
}
