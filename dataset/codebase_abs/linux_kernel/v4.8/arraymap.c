...
int F_35 ( struct V_12 * V_4 , struct V_47 * V_48 ,
...
static void * F_40 ( struct V_12 * V_4 ,
struct V_47 * V_48 , int V_56 )
{
struct V_1 * V_2 = F_13 ( V_4 , struct V_1 , V_4 ) ;
struct V_57 * V_58 = F_41 ( V_56 ) ;
if ( F_36 ( V_58 ) )
return V_58 ;
if ( ! F_42 ( V_2 , V_58 ) ) {
F_43 ( V_58 ) ;
...
static struct V_60 * F_47 ( struct V_47 * V_61 ,
struct V_47 * V_48 )
{
struct V_60 * V_62 ;
V_62 = F_8 ( sizeof( * V_62 ) , V_63 ) ;
if ( V_62 ) {
V_62 -> V_64 = V_61 -> V_65 ;
V_62 -> V_61 = V_61 ;
V_62 -> V_48 = V_48 ;
...
{
struct V_60 * V_62 ;
V_62 = F_13 ( V_67 , struct V_60 , V_67 ) ;
F_49 ( V_62 -> V_61 ) ;
F_50 ( V_62 ) ;
}
