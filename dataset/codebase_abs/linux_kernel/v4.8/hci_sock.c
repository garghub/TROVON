...
static int F_100 ( struct V_103 * V_198 , struct V_1 * V_2 ,
struct V_175 * V_176 , T_3 V_199 )
{
void * V_200 ;
T_4 * V_201 ;
struct V_202 * V_45 ;
...
int V_117 ;
F_14 ( L_9 , V_199 ) ;
if ( V_199 < sizeof( * V_45 ) )
return - V_107 ;
V_200 = F_101 ( V_199 , V_207 ) ;
if ( ! V_200 )
return - V_208 ;
if ( F_102 ( V_200 , V_176 , V_199 ) ) {
V_117 = - V_118 ;
goto V_136;
}
V_45 = V_200 ;
...
if ( V_29 != V_199 - sizeof( * V_45 ) ) {
V_117 = - V_107 ;
goto V_136;
}
if ( V_22 >= V_198 -> V_209 ||
V_198 -> V_210 [ V_22 ] . V_211 == NULL ) {
F_14 ( L_10 , V_22 ) ;
V_117 = F_104 ( V_2 , V_56 , V_22 ,
V_212 ) ;
goto V_136;
}
V_204 = & V_198 -> V_210 [ V_22 ] ;
if ( ! F_6 ( V_2 , V_59 ) &&
! ( V_204 -> V_4 & V_213 ) ) {
V_117 = F_104 ( V_2 , V_56 , V_22 ,
V_214 ) ;
...
V_206 = ( V_204 -> V_4 & V_218 ) ;
if ( V_206 != ! V_27 ) {
V_117 = F_104 ( V_2 , V_56 , V_22 ,
V_216 ) ;
goto V_136;
}
V_205 = ( V_204 -> V_4 & V_219 ) ;
if ( ( V_205 && V_29 < V_204 -> V_220 ) ||
( ! V_205 && V_29 != V_204 -> V_220 ) ) {
V_117 = F_104 ( V_2 , V_56 , V_22 ,
V_221 ) ;
goto V_136;
}
if ( V_27 && V_198 -> V_222 )
V_198 -> V_222 ( V_2 , V_27 ) ;
V_201 = V_200 + sizeof( * V_45 ) ;
V_117 = V_204 -> V_211 ( V_2 , V_27 , V_201 , V_29 ) ;
if ( V_117 < 0 )
goto V_136;
V_117 = V_199 ;
V_136:
...
V_18 V_224 = V_9 -> V_19 [ sizeof( * V_45 ) ] ;
V_18 V_225 = V_9 -> V_19 [ sizeof( * V_45 ) + 1 ] ;
if ( V_224 > 7 || V_9 -> V_19 [ V_29 - 1 ] != 0x00 ||
V_225 > V_29 - sizeof( * V_45 ) - 3 ||
V_9 -> V_19 [ sizeof( * V_45 ) + V_225 + 1 ] != 0x00 ) {
V_117 = - V_107 ;
goto V_223;
}
} else {
...
int V_117 ;
F_14 ( L_4 , V_1 , V_2 ) ;
if ( V_176 -> V_187 & V_195 )
return - V_125 ;
if ( V_176 -> V_187 & ~ ( V_192 | V_227 | V_228 ) )
return - V_107 ;
if ( V_29 < 4 || V_29 > V_229 )
return - V_107 ;
F_70 ( V_2 ) ;
switch ( F_3 ( V_2 ) -> V_5 ) {
case V_35 :
...
default:
F_43 ( & V_105 ) ;
V_198 = F_41 ( F_3 ( V_2 ) -> V_5 ) ;
if ( V_198 )
V_117 = F_100 ( V_198 , V_2 , V_176 , V_29 ) ;
else
V_117 = - V_107 ;
F_44 ( & V_105 ) ;
goto V_136;
...
F_110 ( & V_27 -> V_231 , V_9 ) ;
F_111 ( V_27 -> V_232 , & V_27 -> V_233 ) ;
} else if ( F_11 ( V_9 ) == V_36 ) {
T_5 V_22 = F_112 ( V_9 -> V_19 ) ;
T_5 V_234 = F_113 ( V_22 ) ;
T_5 V_235 = F_114 ( V_22 ) ;
if ( ( ( V_234 > V_236 ) ||
! F_9 ( V_235 & V_237 ,
& V_238 . V_239 [ V_234 ] ) ) &&
! F_66 ( V_166 ) ) {
...
F_17 ( V_9 ) -> V_240 . V_241 |= V_242 ;
F_110 ( & V_27 -> V_243 , V_9 ) ;
F_111 ( V_27 -> V_232 , & V_27 -> V_244 ) ;
}
} else {
if ( ! F_66 ( V_166 ) ) {
V_117 = - V_129 ;
...
static int F_116 ( struct V_111 * V_1 , int V_245 , int V_246 ,
char T_1 * V_247 , unsigned int V_29 )
{
struct V_248 V_249 = { . V_22 = 0 } ;
struct V_1 * V_2 = V_1 -> V_2 ;
int V_117 = 0 , V_250 = 0 ;
F_14 ( L_11 , V_2 , V_246 ) ;
F_70 ( V_2 ) ;
...
case V_253 :
{
struct V_10 * V_254 = & F_3 ( V_2 ) -> V_14 ;
V_249 . V_16 = V_254 -> V_16 ;
V_249 . V_22 = V_254 -> V_22 ;
V_249 . V_21 [ 0 ] = * ( ( V_255 * ) V_254 -> V_21 + 0 ) ;
V_249 . V_21 [ 1 ] = * ( ( V_255 * ) V_254 -> V_21 + 1 ) ;
}
V_29 = F_82 (unsigned int, len, sizeof(uf)) ;
if ( F_59 ( & V_249 , V_247 , V_29 ) ) {
V_117 = - V_118 ;
break;
}
if ( ! F_66 ( V_166 ) ) {
V_249 . V_16 &= V_238 . V_16 ;
V_249 . V_21 [ 0 ] &= * ( ( V_255 * ) V_238 . V_21 + 0 ) ;
V_249 . V_21 [ 1 ] &= * ( ( V_255 * ) V_238 . V_21 + 1 ) ;
}
{
struct V_10 * V_254 = & F_3 ( V_2 ) -> V_14 ;
V_254 -> V_16 = V_249 . V_16 ;
V_254 -> V_22 = V_249 . V_22 ;
* ( ( V_255 * ) V_254 -> V_21 + 0 ) = V_249 . V_21 [ 0 ] ;
* ( ( V_255 * ) V_254 -> V_21 + 1 ) = V_249 . V_21 [ 1 ] ;
}
break;
default:
V_117 = - V_256 ;
...
static int F_118 ( struct V_111 * V_1 , int V_245 , int V_246 ,
char T_1 * V_247 , int T_1 * V_257 )
{
struct V_248 V_249 ;
struct V_1 * V_2 = V_1 -> V_2 ;
int V_29 , V_250 , V_117 = 0 ;
F_14 ( L_11 , V_2 , V_246 ) ;
if ( F_117 ( V_29 , V_257 ) )
return - V_118 ;
F_70 ( V_2 ) ;
...
static int F_121 ( struct V_258 * V_258 , struct V_111 * V_1 , int V_259 ,
int V_260 )
{
struct V_1 * V_2 ;
F_14 ( L_12 , V_1 ) ;
...
return - V_262 ;
V_1 -> V_263 = & V_264 ;
V_2 = F_122 ( V_258 , V_265 , V_41 , & V_266 , V_260 ) ;
if ( ! V_2 )
return - V_208 ;
F_123 ( V_1 , V_2 ) ;
F_124 ( V_2 , V_267 ) ;
...
if ( V_117 < 0 )
return V_117 ;
V_117 = F_129 ( V_271 , & V_272 ) ;
if ( V_117 < 0 ) {
F_130 ( L_13 ) ;
goto error;
}
V_117 = F_131 ( & V_273 , L_14 , & V_30 , NULL ) ;
if ( V_117 < 0 ) {
F_130 ( L_15 ) ;
F_132 ( V_271 ) ;
goto error;
