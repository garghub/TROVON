...
V_1 = F_9 ( V_9 , F_129 ( V_21 , V_63 -> V_14 ) ) ;
if ( ! V_1 &&
V_63 -> V_59 != F_44 ( V_21 , V_171 ) ) {
F_130 ( & V_9 -> V_21 -> V_10 ,
L_22 , V_63 -> V_14 ) ;
return;
}
switch ( F_131 ( V_21 , V_63 -> V_59 ) ) {
case V_171 :
if ( V_1 ) {
F_130 ( & V_9 -> V_21 -> V_10 ,
L_23 , V_1 -> V_14 ) ;
...
F_110 ( V_9 , F_129 ( V_21 , V_63 -> V_14 ) ) ;
break;
case V_174 :
F_123 ( V_1 ) ;
break;
...
if ( V_1 -> V_140 )
break;
V_170 = V_27 -> V_47 - V_27 -> V_48 - sizeof( * V_63 ) + 1 ;
...
strncpy ( V_1 -> V_140 , V_27 -> V_27 + V_27 -> V_48 + sizeof( * V_63 ) ,
V_170 - 1 ) ;
V_1 -> V_140 [ V_170 - 1 ] = 0 ;
