...
static void F_55 ( struct V_79 * V_79 ,
struct V_1 * V_2 , bool V_80 )
{
struct V_22 * V_22 ;
if ( ! V_80 && ( F_24 ( V_2 ) || F_21 ( V_2 ) ) ) {
int V_7 ;
V_22 = F_17 ( V_2 ) ;
for ( V_7 = 0 ; V_7 < V_22 -> V_24 ; V_7 ++ ) {
struct V_25 * V_25 = & V_22 -> V_26 [ V_7 ] ;
...
if ( V_2 -> V_83 && F_21 ( V_2 -> V_83 ) && V_80 ) {
V_22 = F_17 ( V_2 -> V_83 ) ;
F_10 ( V_2 ) ;
if ( V_22 -> V_63 == V_2 )
F_58 ( V_22 ) ;
...
if ( F_59 ( V_2 ) && V_80 ) {
struct V_84 * V_84 = F_60 ( V_2 ) ;
V_22 = F_17 ( V_2 -> V_83 ) ;
F_10 ( V_2 ) ;
if ( V_22 -> V_64 == V_2 )
F_61 ( V_22 ) ;
if ( V_22 -> V_63 == & V_84 -> V_85 -> V_2 &&
F_21 ( V_2 -> V_83 ) )
F_58 ( V_22 ) ;
F_12 ( V_2 ) ;
}
...
void F_66 ( struct V_79 * V_79 , struct V_1 * V_2 )
{
F_55 ( V_79 , V_2 , true ) ;
}
void F_67 ( struct V_79 * V_79 , struct V_1 * V_2 )
{
F_55 ( V_79 , V_2 , false ) ;
}
static T_4 F_68 ( struct V_1 * V_2 , char * V_49 , int V_73 )
{
struct V_22 * V_22 = F_17 ( V_2 ) ;
struct V_25 * V_25 ;
struct V_3 * V_3 ;
...
static T_6 F_69 ( struct V_69 * V_70 , struct V_71 * V_72 , int V_73 )
{
...
int F_70 ( struct V_22 * V_22 )
{
struct V_1 * V_2 = & V_22 -> V_2 ;
struct V_79 * V_79 = F_71 ( V_2 ) ;
if ( ! F_21 ( V_2 ) )
return 0 ;
if ( V_22 -> V_24 < 1 ) {
F_72 ( V_2 , L_11 ) ;
...
return F_23 ( V_2 ) -> F_73 ( V_79 , V_2 ) ;
}
unsigned int F_74 ( struct V_22 * V_22 )
{
unsigned int V_86 , V_30 ;
V_86 = F_75 () ;
if ( V_22 -> V_87 < V_88 ) {
struct V_89 * V_90 , * V_91 ;
V_30 = V_86 % V_22 -> V_87 ;
V_91 = F_76 ( V_22 -> V_30 , V_86 ) ;
V_90 = F_76 ( V_22 -> V_30 , V_30 ) ;
if ( V_91 -> V_92 ++ == 0 )
F_77 ( & V_90 -> V_93 ) ;
} else
V_30 = V_86 ;
...
void F_78 ( struct V_22 * V_22 , unsigned int V_30 )
{
if ( V_22 -> V_87 < V_88 ) {
unsigned int V_86 = F_75 () ;
struct V_89 * V_90 , * V_91 ;
V_91 = F_76 ( V_22 -> V_30 , V_86 ) ;
V_90 = F_76 ( V_22 -> V_30 , V_30 ) ;
if ( -- V_91 -> V_92 == 0 )
...
static struct V_22 * F_81 ( struct V_79 * V_79 ,
...
unsigned int V_7 ;
int V_67 = 0 ;
for ( V_7 = 0 ; V_7 < V_95 -> V_100 ; V_7 ++ ) {
struct V_25 * V_25 = & V_95 -> V_25 [ V_7 ] ;
struct V_3 * V_3 = V_25 -> V_3 ;
if ( ( V_25 -> V_15 | V_25 -> V_50 ) % V_101 ) {
F_72 ( & V_79 -> V_2 , L_12 ,
V_98 , F_45 ( & V_3 -> V_2 ) , V_7 ) ;
return NULL ;
}
if ( V_3 -> V_42 & V_102 )
V_67 = 1 ;
...
struct V_36 * V_38 ;
V_104 = F_82 ( V_95 ) ;
V_38 = F_83 ( sizeof( * V_38 ) + sizeof( struct V_25 )
* V_95 -> V_100 ,
V_27 ) ;
if ( V_38 ) {
V_22 = & V_38 -> V_22 ;
V_38 -> F_73 = V_104 -> F_73 ;
V_38 -> V_105 = V_104 -> V_105 ;
}
V_99 = V_38 ;
} else {
V_22 = F_83 ( sizeof( struct V_22 )
+ sizeof( struct V_25 )
* V_95 -> V_100 ,
V_27 ) ;
V_99 = V_22 ;
...
if ( ! V_99 )
return NULL ;
V_22 -> V_32 = F_84 ( & V_31 , 0 , 0 , V_27 ) ;
if ( V_22 -> V_32 < 0 )
goto V_106;
V_22 -> V_30 = F_85 ( struct V_89 ) ;
if ( ! V_22 -> V_30 )
goto V_107;
for ( V_7 = 0 ; V_7 < V_88 ; V_7 ++ ) {
struct V_89 * V_108 ;
V_108 = F_76 ( V_22 -> V_30 , V_7 ) ;
F_86 ( & V_108 -> V_93 ) ;
V_108 -> V_92 = 0 ;
}
memcpy ( V_22 -> V_26 , V_95 -> V_25 ,
sizeof( struct V_25 ) * V_95 -> V_100 ) ;
for ( V_7 = 0 ; V_7 < V_95 -> V_100 ; V_7 ++ ) {
struct V_25 * V_25 = & V_95 -> V_25 [ V_7 ] ;
struct V_3 * V_3 = V_25 -> V_3 ;
F_87 ( & V_3 -> V_2 ) ;
}
V_22 -> V_24 = V_95 -> V_100 ;
V_22 -> V_37 = V_95 -> V_37 ;
V_22 -> V_53 = V_95 -> V_53 ;
V_22 -> V_87 = V_95 -> V_87 ;
V_22 -> V_42 = V_95 -> V_42 ;
V_22 -> V_67 = V_67 ;
V_22 -> V_109 = V_95 -> V_109 ;
F_88 ( & V_22 -> V_110 ) ;
F_88 ( & V_22 -> V_111 ) ;
F_88 ( & V_22 -> V_112 ) ;
F_88 ( & V_22 -> V_113 ) ;
V_2 = & V_22 -> V_2 ;
F_89 ( V_2 , L_13 , V_22 -> V_32 ) ;
V_2 -> V_83 = & V_79 -> V_2 ;
V_2 -> type = V_97 ;
V_2 -> V_114 = V_95 -> V_115 ;
V_22 -> V_51 = F_90 ( V_95 -> V_12 ) ;
V_22 -> V_116 = V_95 -> V_12 -> V_15 ;
F_91 ( V_2 ) ;
return V_22 ;
V_107:
F_20 ( & V_31 , V_22 -> V_32 ) ;
...
struct V_22 * F_92 ( struct V_79 * V_79 ,
struct V_94 * V_95 )
{
V_95 -> V_87 = V_117 ;
return F_81 ( V_79 , V_95 , & V_33 ,
V_118 ) ;
}
struct V_22 * F_93 ( struct V_79 * V_79 ,
struct V_94 * V_95 )
{
if ( V_95 -> V_100 > 1 )
return NULL ;
V_95 -> V_87 = F_94 ( V_95 -> V_87 , V_117 ) ;
return F_81 ( V_79 , V_95 , & V_34 ,
V_118 ) ;
}
struct V_22 * F_95 ( struct V_79 * V_79 ,
struct V_94 * V_95 )
{
V_95 -> V_87 = V_117 ;
return F_81 ( V_79 , V_95 , & V_119 ,
V_118 ) ;
}
void F_96 ( struct V_22 * V_22 )
{
struct V_5 * V_6 = F_43 ( & V_22 -> V_2 ) ;
int V_7 , V_120 ;
V_120 = F_97 ( V_121 ) ;
V_120 = F_98 ( V_121 , F_99 ( V_122 -> V_123 + V_120 , 8 ) ) ;
F_100 () ;
for ( V_7 = 0 ; V_7 < V_22 -> V_24 ; V_7 ++ )
if ( F_5 ( V_6 , V_7 , 0 ) )
F_101 ( 1 , F_5 ( V_6 , V_7 , V_120 ) ) ;
F_100 () ;
}
int F_102 ( struct V_22 * V_22 )
{
struct V_5 * V_6 = F_43 ( & V_22 -> V_2 ) ;
int V_7 ;
if ( V_22 -> V_24 == 0 )
