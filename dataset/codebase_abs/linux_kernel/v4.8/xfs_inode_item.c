...
T_4 * V_9 )
{
F_41 ( V_9 -> V_119 -> V_4 . V_151 ) ;
F_42 ( V_148 , V_9 -> V_119 ) ;
}
void
F_43 (
struct V_152 * V_153 ,
...
V_160 ++ ;
if ( V_160 ) {
struct V_2 * V_166 [ V_160 ] ;
int V_167 = 0 ;
F_44 ( & V_158 -> V_168 ) ;
for ( V_154 = V_3 ; V_154 ; V_154 = V_154 -> V_163 ) {
V_5 = F_1 ( V_154 ) ;
if ( V_5 -> V_164 &&
V_154 -> V_120 == V_5 -> V_165 ) {
V_166 [ V_167 ++ ] = V_154 ;
}
ASSERT ( V_167 <= V_160 ) ;
}
F_45 ( V_158 , V_166 , V_167 ,
V_169 ) ;
}
...
T_7 * V_177 )
{
if ( V_176 -> V_178 == sizeof( V_179 ) ) {
V_179 * V_180 = V_176 -> V_181 ;
V_177 -> V_122 = V_180 -> V_122 ;
V_177 -> V_50 = V_180 -> V_50 ;
V_177 -> V_132 = V_180 -> V_132 ;
V_177 -> V_65 = V_180 -> V_65 ;
V_177 -> V_49 = V_180 -> V_49 ;
V_177 -> V_124 = V_180 -> V_124 ;
memcpy ( V_177 -> V_57 . V_61 . V_182 ,
V_180 -> V_57 . V_61 . V_182 ,
sizeof( V_183 ) ) ;
V_177 -> V_125 = V_180 -> V_125 ;
V_177 -> V_128 = V_180 -> V_128 ;
V_177 -> V_130 = V_180 -> V_130 ;
return 0 ;
} else if ( V_176 -> V_178 == sizeof( V_184 ) ) {
V_184 * V_185 = V_176 -> V_181 ;
V_177 -> V_122 = V_185 -> V_122 ;
V_177 -> V_50 = V_185 -> V_50 ;
V_177 -> V_132 = V_185 -> V_132 ;
V_177 -> V_65 = V_185 -> V_65 ;
V_177 -> V_49 = V_185 -> V_49 ;
V_177 -> V_124 = V_185 -> V_124 ;
memcpy ( V_177 -> V_57 . V_61 . V_182 ,
V_185 -> V_57 . V_61 . V_182 ,
sizeof( V_183 ) ) ;
V_177 -> V_125 = V_185 -> V_125 ;
V_177 -> V_128 = V_185 -> V_128 ;
V_177 -> V_130 = V_185 -> V_130 ;
return 0 ;
}
return - V_186 ;
}
