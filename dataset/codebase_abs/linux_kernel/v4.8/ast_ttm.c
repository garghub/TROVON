...
V_9 -> V_82 = F_36 ( F_22 ( V_66 -> V_67 , 0 ) ,
F_37 ( V_66 -> V_67 , 0 ) ) ;
return 0 ;
}
...
void F_18 ( struct V_27 * V_28 , int V_83 )
{
T_2 V_84 = 0 ;
unsigned V_85 ;
...
if ( V_83 & V_88 )
V_28 -> V_86 [ V_84 ++ ] . V_34 = V_45 | V_44 | V_88 ;
if ( V_83 & V_50 )
V_28 -> V_86 [ V_84 ++ ] . V_34 = V_39 | V_50 ;
if ( ! V_84 )
V_28 -> V_86 [ V_84 ++ ] . V_34 = V_39 | V_50 ;
V_28 -> V_51 . V_89 = V_84 ;
V_28 -> V_51 . V_90 = V_84 ;
for ( V_85 = 0 ; V_85 < V_84 ; ++ V_85 ) {
V_28 -> V_86 [ V_85 ] . V_91 = 0 ;
V_28 -> V_86 [ V_85 ] . V_92 = 0 ;
}
}
int F_41 ( struct V_76 * V_66 , int V_15 , int V_93 ,
T_1 V_34 , struct V_27 * * V_94 )
{
struct V_1 * V_9 = V_66 -> V_95 ;
struct V_27 * V_49 ;
T_3 V_96 ;
int V_75 ;
...
F_18 ( V_49 , V_88 | V_50 ) ;
V_96 = F_43 ( & V_9 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_75 = F_44 ( & V_9 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_98 , & V_49 -> V_51 ,
V_93 >> V_62 , false , NULL , V_96 ,
NULL , NULL , F_12 ) ;
if ( V_75 )
return V_75 ;
* V_94 = V_49 ;
...
int F_46 ( struct V_27 * V_28 , T_2 V_99 , T_4 * V_100 )
{
int V_85 , V_75 ;
if ( V_28 -> V_101 ) {
V_28 -> V_101 ++ ;
...
F_18 ( V_28 , V_99 ) ;
for ( V_85 = 0 ; V_85 < V_28 -> V_51 . V_89 ; V_85 ++ )
V_28 -> V_86 [ V_85 ] . V_34 |= V_102 ;
...
int F_51 ( struct V_52 * V_53 , struct V_105 * V_106 )
{
struct V_107 * V_108 ;
struct V_1 * V_9 ;
if ( F_52 ( V_106 -> V_109 < V_80 ) )
return - V_46 ;
V_108 = V_53 -> V_110 ;
V_9 = V_108 -> V_111 -> V_66 -> V_95 ;
return F_53 ( V_53 , V_106 , & V_9 -> V_4 . V_5 ) ;
}
