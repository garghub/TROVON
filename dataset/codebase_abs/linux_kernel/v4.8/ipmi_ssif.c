...
static int F_79 ( struct V_62 * V_40 , const struct V_156 * V_157 )
{
unsigned char V_5 [ 3 ] ;
unsigned char * V_125 ;
struct V_1 * V_1 ;
...
if ( ! V_125 )
return - V_134 ;
V_1 = F_80 ( sizeof( * V_1 ) , V_133 ) ;
if ( ! V_1 ) {
F_58 ( V_125 ) ;
return - V_134 ;
}
if ( ! F_76 ( V_1 , & V_40 -> V_117 ) ) {
V_118 = F_74 ( V_40 -> V_148 , V_40 -> V_120 -> V_159 ,
true ) ;
if ( ! V_118 ) {
V_1 -> V_116 = V_160 ;
} else {
...
F_29 ( V_8 L_35 ,
F_81 ( V_1 -> V_116 ) ,
V_40 -> V_148 , V_40 -> V_120 -> V_159 , V_158 ) ;
V_5 [ 0 ] = V_16 << 2 ;
V_5 [ 1 ] = V_135 ;
V_49 = F_59 ( V_40 , 2 , V_5 , & V_69 , V_125 ) ;
if ( V_49 )
goto V_162;
V_49 = F_82 ( V_125 , V_69 , & V_1 -> V_163 ) ;
if ( V_49 )
goto V_162;
V_1 -> V_40 = V_40 ;
F_83 ( V_40 , V_1 ) ;
...
static int F_94 ( struct V_153 * V_194 , void * V_195 )
{
struct V_147 * V_118 = V_195 ;
if ( V_194 -> type != & V_196 )
return 0 ;
F_95 ( F_96 ( V_194 ) , & V_118 -> V_152 ) ;
if ( ! V_118 -> V_149 )
return 1 ;
return 0 ;
}
static int F_97 ( int V_148 , char * V_149 ,
int V_161 , int V_158 ,
enum V_197 V_115 )
{
struct V_147 * V_118 ;
...
V_118 = F_80 ( sizeof( * V_118 ) , V_133 ) ;
if ( ! V_118 ) {
V_49 = - V_134 ;
goto V_200;
}
if ( V_149 ) {
V_118 -> V_149 = F_99 ( V_149 , V_133 ) ;
if ( ! V_118 -> V_149 ) {
F_58 ( V_118 ) ;
V_49 = - V_134 ;
goto V_200;
...
F_75 (info, &ssif_infos, link)
V_206 ++ ;
V_207 = F_80 ( sizeof( * V_207 ) * ( V_206 + 1 ) , V_133 ) ;
if ( ! V_207 )
return NULL ;
V_77 = 0 ;
F_75 (info, &ssif_infos, link) {
...
return F_97 ( V_213 , NULL , 0 , 0 , V_221 ) ;
}
...
static void F_108 ( void ) { }
static int F_110 ( const struct V_228 * V_229 )
{
...
return F_97 ( V_213 , NULL , 0 , 0 , V_234 ) ;
}
static void F_111 ( void )
{
const struct V_228 * V_117 = NULL ;
while ( ( V_117 = F_112 ( V_235 , NULL , V_117 ) ) )
F_110 ( V_117 ) ;
}
static void F_111 ( void ) { }
...
V_49 = F_97 ( V_148 [ V_77 ] , V_149 [ V_77 ] ,
