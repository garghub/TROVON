...
F_46 ( V_4 ) ;
V_4 -> V_130 = 1 ;
error = F_71 ( & V_4 -> V_131 , & V_132 , NULL , V_4 -> V_133 ) ;
if ( error )
goto V_127;
error = F_71 ( & V_4 -> V_134 . V_135 , & V_136 ,
& V_4 -> V_131 , L_15 ) ;
if ( error )
goto V_137;
error = F_72 ( V_4 ) ;
...
error = F_85 ( V_4 , NULL , V_25 -> V_156 , 0 , V_157 , & V_118 ) ;
if ( error ) {
F_5 ( V_4 , L_23 ) ;
goto V_155;
}
ASSERT ( V_118 != NULL ) ;
if ( F_86 ( ! F_87 ( F_88 ( V_118 ) -> V_158 ) ) ) {
F_5 ( V_4 , L_24 ,
...
{
ASSERT ( V_172 > V_173 ) ;
if ( ( V_4 -> V_174 -> V_175 . V_176 >= V_172 ) ||
F_116 ( V_4 ) || ( V_4 -> V_10 & V_162 ) )
return false ;
return true ;
}
int
...
T_9 V_178 )
{
F_118 ( & V_4 -> V_179 , V_178 , V_180 ) ;
if ( F_119 ( & V_4 -> V_179 , 0 , V_180 ) < 0 ) {
ASSERT ( 0 ) ;
F_120 ( & V_4 -> V_179 , - V_178 ) ;
return - V_12 ;
}
return 0 ;
}
...
T_9 V_178 )
{
F_120 ( & V_4 -> V_181 , V_178 ) ;
if ( F_122 ( & V_4 -> V_181 , 0 ) < 0 ) {
ASSERT ( 0 ) ;
F_120 ( & V_4 -> V_181 , - V_178 ) ;
return - V_12 ;
}
...
T_10 V_185 ;
if ( V_178 > 0 ) {
if ( F_124 ( V_4 -> V_186 == V_4 -> V_187 ) ) {
F_120 ( & V_4 -> V_188 , V_178 ) ;
return 0 ;
}
F_15 ( & V_4 -> V_114 ) ;
V_184 = ( long long ) ( V_4 -> V_186 - V_4 -> V_187 ) ;
if ( V_184 > V_178 ) {
V_4 -> V_187 += V_178 ;
} else {
V_178 -= V_184 ;
...
if ( F_119 ( & V_4 -> V_188 , 2 * V_189 ,
V_189 ) < 0 )
V_185 = 1 ;
else
V_185 = V_189 ;
F_118 ( & V_4 -> V_188 , V_178 , V_185 ) ;
if ( F_119 ( & V_4 -> V_188 , V_4 -> V_190 ,
V_189 ) >= 0 ) {
return 0 ;
}
F_15 ( & V_4 -> V_114 ) ;
...
if ( ! V_182 )
goto V_191;
V_183 = ( long long ) V_4 -> V_187 + V_178 ;
if ( V_183 >= 0 ) {
V_4 -> V_187 = V_183 ;
F_17 ( & V_4 -> V_114 ) ;
return 0 ;
