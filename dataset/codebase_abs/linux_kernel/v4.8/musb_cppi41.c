...
static T_4 F_32 ( unsigned V_80 , unsigned V_81 , T_4 V_82 )
{
unsigned V_83 ;
V_83 = ( V_80 - 1 ) * 2 ;
V_82 &= ~ ( 3 << V_83 ) ;
...
V_86 = V_6 -> V_88 ;
V_84 = V_2 -> V_89 ;
V_85 = F_32 ( V_84 , V_81 , V_86 ) ;
if ( V_85 == V_86 )
return;
if ( V_2 -> V_5 ) {
V_6 -> V_87 = V_85 ;
F_34 ( V_6 -> V_7 -> V_90 , V_91 ,
V_85 ) ;
} else {
V_6 -> V_88 = V_85 ;
F_34 ( V_6 -> V_7 -> V_90 , V_92 ,
V_85 ) ;
}
}
...
return;
V_6 -> V_93 = V_85 ;
F_34 ( V_6 -> V_7 -> V_90 , V_94 , V_85 ) ;
}
static bool F_36 ( struct V_66 * V_22 ,
T_1 V_29 , T_2 V_81 ,
T_5 V_95 , T_4 V_96 )
{
struct V_1 * V_2 = V_22 -> V_65 ;
...
static struct V_66 * F_40 ( struct V_102 * V_103 ,
...
static void F_42 ( struct V_66 * V_22 )
{
struct V_1 * V_2 = V_22 -> V_65 ;
F_43 ( V_2 ) ;
if ( V_2 -> V_108 ) {
...
static int F_44 ( struct V_66 * V_22 ,
T_1 V_29 , T_2 V_81 ,
T_5 V_95 , T_4 V_96 )
{
int V_56 ;
...
V_56 = F_36 ( V_22 , V_29 , V_81 , V_95 , V_96 ) ;
if ( ! V_56 )
V_22 -> V_23 = V_24 ;
return V_56 ;
}
static int F_46 ( struct V_66 * V_22 , T_1 V_114 ,
...
static int F_47 ( struct V_66 * V_22 )
{
struct V_1 * V_2 = V_22 -> V_65 ;
struct V_53 * V_6 = V_2 -> V_6 ;
struct V_7 * V_7 = V_6 -> V_7 ;
...
static void F_51 ( struct V_53 * V_127 )
{
struct V_31 * V_32 ;
int V_128 ;
...
unsigned V_5 ;
unsigned int V_84 ;
V_56 = F_56 ( V_132 , L_2 , V_128 , & V_137 ) ;
if ( V_56 )
goto V_138;
if ( F_57 ( V_137 , L_3 ) )
V_5 = 1 ;
else if ( F_57 ( V_137 , L_4 ) )
V_5 = 0 ;
else {
F_58 ( V_130 , L_5 , V_137 ) ;
goto V_138;
}
V_56 = F_59 ( V_137 + 2 , 0 , & V_84 ) ;
if ( V_56 )
goto V_138;
V_56 = - V_139 ;
if ( V_84 > V_105 || ! V_84 )
...
V_136 -> V_23 = V_24 ;
V_136 -> V_140 = V_141 ;
V_32 = F_61 ( V_130 -> V_133 , V_137 ) ;
if ( ! V_32 ) {
F_58 ( V_130 , L_6 , V_137 ) ;
V_56 = - V_142 ;
goto V_138;
}
V_2 -> V_32 = V_32 ;
...
struct V_102 *
F_65 ( struct V_7 * V_7 , void T_3 * V_143 )
{
struct V_53 * V_6 ;
int V_56 = 0 ;
...
V_6 = F_66 ( sizeof( * V_6 ) , V_144 ) ;
if ( ! V_6 )
goto V_145;
F_67 ( & V_6 -> V_58 , V_146 , V_79 ) ;
V_6 -> V_58 . V_147 = F_17 ;
F_60 ( & V_6 -> V_62 ) ;
V_6 -> V_7 = V_7 ;
V_6 -> V_6 . V_148 = F_40 ;
