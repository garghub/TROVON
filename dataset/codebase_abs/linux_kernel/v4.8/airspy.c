...
F_66 ( V_90 -> V_124 , L_21 , sizeof( V_90 -> V_124 ) ) ;
V_90 -> type = V_154 ;
V_90 -> V_148 = V_149 | V_150 ;
...
F_19 ( V_2 -> V_25 , L_22 , V_2 -> V_159 ) ;
V_8 = 0 ;
} else if ( V_135 -> V_157 == 1 ) {
V_135 -> type = V_154 ;
V_135 -> V_158 = V_2 -> V_160 ;
F_19 ( V_2 -> V_25 , L_23 , V_2 -> V_160 ) ;
V_8 = 0 ;
} else {
V_8 = - V_26 ;
}
...
int V_8 ;
T_1 V_164 ;
F_19 ( V_2 -> V_25 , L_27 , V_2 -> V_171 -> V_166 . V_167 , V_2 -> V_171 -> V_167 ) ;
