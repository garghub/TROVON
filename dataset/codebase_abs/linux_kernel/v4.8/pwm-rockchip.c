...
static int F_16 ( struct V_2 * V_4 , struct V_5 * V_6 ,
struct V_19 * V_20 )
{
struct V_1 * V_10 = F_1 ( V_4 ) ;
struct V_19 V_43 ;
...
if ( V_33 )
return V_33 ;
if ( V_20 -> V_9 != V_43 . V_9 && V_21 ) {
V_10 -> V_16 -> V_44 ( V_4 , V_6 , false , V_20 -> V_9 ) ;
V_21 = false ;
}
V_33 = F_14 ( V_4 , V_6 , V_20 -> V_39 , V_20 -> V_35 ) ;
if ( V_33 ) {
if ( V_21 != V_43 . V_21 )
V_10 -> V_16 -> V_44 ( V_4 , V_6 , ! V_21 ,
V_20 -> V_9 ) ;
goto V_45;
}
if ( V_20 -> V_21 != V_21 )
V_10 -> V_16 -> V_44 ( V_4 , V_6 , V_20 -> V_21 ,
V_20 -> V_9 ) ;
F_9 ( V_4 , V_6 , V_20 ) ;
V_45:
F_13 ( V_10 -> V_34 ) ;
...
struct V_50 * V_51 ;
int V_33 ;
V_49 = F_19 ( V_52 , & V_47 -> V_53 ) ;
if ( ! V_49 )
return - V_54 ;
V_10 = F_20 ( & V_47 -> V_53 , sizeof( * V_10 ) , V_55 ) ;
if ( ! V_10 )
return - V_56 ;
V_51 = F_21 ( V_47 , V_57 , 0 ) ;
V_10 -> V_15 = F_22 ( & V_47 -> V_53 , V_51 ) ;
if ( F_23 ( V_10 -> V_15 ) )
return F_24 ( V_10 -> V_15 ) ;
V_10 -> V_34 = F_25 ( & V_47 -> V_53 , NULL ) ;
if ( F_23 ( V_10 -> V_34 ) )
return F_24 ( V_10 -> V_34 ) ;
V_33 = F_26 ( V_10 -> V_34 ) ;
if ( V_33 )
return V_33 ;
F_27 ( V_47 , V_10 ) ;
...
if ( V_33 < 0 ) {
F_29 ( V_10 -> V_34 ) ;
F_30 ( & V_47 -> V_53 , L_1 , V_33 ) ;
}
if ( ! F_31 ( V_10 -> V_4 . V_64 ) )
F_13 ( V_10 -> V_34 ) ;
return V_33 ;
}
static int F_32 ( struct V_46 * V_47 )
{
struct V_1 * V_10 = F_33 ( V_47 ) ;
if ( F_31 ( V_10 -> V_4 . V_64 ) )
F_13 ( V_10 -> V_34 ) ;
F_29 ( V_10 -> V_34 ) ;
return F_34 ( & V_10 -> V_4 ) ;
}
