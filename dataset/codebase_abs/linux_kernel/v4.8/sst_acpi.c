...
if ( V_43 < 0 )
return V_43 ;
V_2 -> V_61 = F_19 ( V_2 -> V_7 , sizeof( * V_2 -> V_61 ) ,
V_62 ) ;
if ( ! V_2 -> V_61 ) {
V_43 = - V_63 ;
goto V_64;
...
static int F_25 ( const struct V_65 * V_45 )
{
V_66 = V_67 ;
return 1 ;
}
static struct V_46 * F_26 ( void * V_68 )
{
struct V_46 * V_47 = V_68 ;
F_27 ( V_69 ) ;
if ( V_66 == V_67 )
return & V_70 ;
else
