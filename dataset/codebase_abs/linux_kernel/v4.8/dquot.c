...
static inline struct V_30 * * F_106 ( struct V_118 * V_118 )
{
...
static void F_115 ( struct V_118 * V_118 , int type ,
struct V_84 * V_131 )
{
struct V_30 * * V_121 = F_106 ( V_118 ) ;
...
static void F_116 ( struct V_84 * V_131 )
{
struct V_84 * V_132 ;
struct V_30 * V_30 ;
V_132 = V_131 -> V_133 ;
...
F_119 ( V_131 ) ;
if ( V_2 -> V_49 ) {
F_117 ( V_2 , type , & V_131 ) ;
F_120 ( & V_136 ) ;
F_116 ( & V_131 ) ;
}
}
static inline void F_121 ( struct V_30 * V_30 , T_2 V_137 )
{
V_30 -> V_138 . V_139 += V_137 ;
}
static inline void F_122 ( struct V_30 * V_30 , T_2 V_137 )
{
...
static void F_124 ( struct V_30 * V_30 , T_2 V_137 )
{
...
{
if ( F_125 ( V_30 -> V_138 . V_140 < V_137 ) )
V_137 = V_30 -> V_138 . V_140 ;
V_30 -> V_138 . V_141 += V_137 ;
V_30 -> V_138 . V_140 -= V_137 ;
}
static inline
void F_127 ( struct V_30 * V_30 , T_2 V_137 )
{
if ( V_30 -> V_138 . V_141 >= V_137 )
V_30 -> V_138 . V_141 -= V_137 ;
else {
...
static void F_128 ( struct V_30 * V_30 , T_2 V_137 )
{
...
static int F_130 ( struct V_30 * V_30 , const int V_150 )
{
...
static int F_131 ( struct V_156 * V_157 )
{
if ( ! V_158 )
return 0 ;
switch ( V_157 -> V_159 . type ) {
case V_160 :
return F_132 ( F_133 () , V_157 -> V_159 . V_161 ) ;
case V_162 :
return F_134 ( V_157 -> V_159 . V_163 ) ;
case V_164 :
return 1 ;
}
return 0 ;
}
static void F_135 ( struct V_156 * V_157 )
{
char * V_165 = NULL ;
struct V_166 * V_167 ;
...
V_150 == V_170 ||
V_150 == V_171 ||
V_150 == V_172 || ! F_131 ( V_157 ) )
return;
V_167 = F_136 () ;
if ( ! V_167 )
return;
F_137 ( V_167 , V_157 -> V_173 -> V_9 ) ;
if ( V_150 == V_174 || V_150 == V_175 )
F_137 ( V_167 , L_11 ) ;
else
F_137 ( V_167 , L_12 ) ;
F_137 ( V_167 , V_105 [ V_157 -> V_159 . type ] ) ;
switch ( V_150 ) {
case V_154 :
V_165 = L_13 ;
break;
...
static void F_139 ( struct V_156 * V_157 , struct V_30 * V_30 ,
int V_150 )
{
if ( F_130 ( V_30 , V_150 ) )
return;
...
static void F_140 ( struct V_156 * V_157 )
{
int V_176 ;
...
static int F_145 ( struct V_30 * V_30 , T_2 V_184 ,
struct V_156 * V_157 )
{
T_2 V_185 = V_30 -> V_138 . V_139 + V_184 ;
if ( ! F_146 ( V_30 -> V_34 , V_30 -> V_35 . type ) ||
F_37 ( V_186 , & V_30 -> V_48 ) )
return 0 ;
if ( V_30 -> V_138 . V_187 &&
V_185 > V_30 -> V_138 . V_187 &&
! F_143 ( V_30 ) ) {
F_139 ( V_157 , V_30 , V_154 ) ;
return - V_188 ;
}
if ( V_30 -> V_138 . V_143 &&
V_185 > V_30 -> V_138 . V_143 &&
V_30 -> V_138 . V_144 &&
F_147 () >= V_30 -> V_138 . V_144 &&
! F_143 ( V_30 ) ) {
F_139 ( V_157 , V_30 , V_155 ) ;
return - V_188 ;
}
if ( V_30 -> V_138 . V_143 &&
V_185 > V_30 -> V_138 . V_143 &&
V_30 -> V_138 . V_144 == 0 ) {
F_139 ( V_157 , V_30 , V_174 ) ;
V_30 -> V_138 . V_144 = F_147 () +
F_42 ( V_30 -> V_34 ) -> V_53 [ V_30 -> V_35 . type ] . V_189 ;
}
return 0 ;
}
static int F_148 ( struct V_30 * V_30 , T_2 V_190 , int V_191 ,
struct V_156 * V_157 )
{
T_2 V_192 ;
struct V_1 * V_2 = V_30 -> V_34 ;
if ( ! F_146 ( V_2 , V_30 -> V_35 . type ) ||
F_37 ( V_186 , & V_30 -> V_48 ) )
return 0 ;
...
! F_143 ( V_30 ) ) {
if ( ! V_191 )
F_139 ( V_157 , V_30 , V_152 ) ;
return - V_188 ;
}
if ( V_30 -> V_138 . V_147 &&
V_192 > V_30 -> V_138 . V_147 &&
V_30 -> V_138 . V_148 &&
F_147 () >= V_30 -> V_138 . V_148 &&
! F_143 ( V_30 ) ) {
if ( ! V_191 )
F_139 ( V_157 , V_30 , V_153 ) ;
return - V_188 ;
}
if ( V_30 -> V_138 . V_147 &&
V_192 > V_30 -> V_138 . V_147 &&
V_30 -> V_138 . V_148 == 0 ) {
if ( ! V_191 ) {
F_139 ( V_157 , V_30 , V_175 ) ;
V_30 -> V_138 . V_148 = F_147 () +
...
static int F_149 ( struct V_30 * V_30 , T_2 V_184 )
{
T_2 V_185 ;
if ( F_37 ( V_186 , & V_30 -> V_48 ) ||
V_30 -> V_138 . V_139 <= V_30 -> V_138 . V_143 ||
! F_146 ( V_30 -> V_34 , V_30 -> V_35 . type ) )
return V_177 ;
...
static int F_150 ( struct V_30 * V_30 , T_2 V_190 )
{
if ( F_37 ( V_186 , & V_30 -> V_48 ) ||
...
static int F_151 ( const struct V_118 * V_118 )
{
struct V_1 * V_2 = V_118 -> V_119 ;
if ( F_108 ( V_118 ) )
return 0 ;
return F_152 ( V_2 ) & ~ F_153 ( V_2 ) ;
}
static int F_114 ( struct V_118 * V_118 , int type )
{
int V_56 , V_195 = 0 ;
...
switch ( V_56 ) {
case V_160 :
V_23 = F_154 ( V_118 -> V_200 ) ;
break;
case V_162 :
V_23 = F_155 ( V_118 -> V_201 ) ;
break;
case V_164 :
...
int F_159 ( struct V_118 * V_118 )
{
return F_114 ( V_118 , - 1 ) ;
}
static void F_160 ( struct V_118 * V_118 )
{
int V_56 ;
struct V_30 * * V_121 = F_106 ( V_118 ) ;
...
static T_2 * F_162 ( struct V_118 * V_118 )
{
F_92 ( ! V_118 -> V_119 -> V_49 -> V_206 ) ;
return V_118 -> V_119 -> V_49 -> V_206 ( V_118 ) ;
}
void F_163 ( struct V_118 * V_118 , T_2 V_137 )
{
F_5 ( & V_118 -> V_125 ) ;
* F_162 ( V_118 ) += V_137 ;
F_6 ( & V_118 -> V_125 ) ;
...
void F_166 ( struct V_118 * V_118 , T_2 V_137 )
{
F_5 ( & V_118 -> V_125 ) ;
* F_162 ( V_118 ) += V_137 ;
F_167 ( V_118 , V_137 ) ;
...
void F_168 ( struct V_118 * V_118 , T_2 V_137 )
{
F_5 ( & V_118 -> V_125 ) ;
* F_162 ( V_118 ) -= V_137 ;
F_6 ( & V_118 -> V_125 ) ;
}
static T_2 F_112 ( struct V_118 * V_118 )
{
T_2 V_51 ;
...
static void F_169 ( struct V_118 * V_118 , T_2 V_137 ,
int V_207 )
{
if ( V_207 )
F_163 ( V_118 , V_137 ) ;
...
static void F_171 ( struct V_118 * V_118 , T_2 V_137 , int V_207 )
{
if ( V_207 )
F_168 ( V_118 , V_137 ) ;
else
...
int F_173 ( struct V_118 * V_118 , T_2 V_137 , int V_89 )
{
...
continue;
if ( V_207 )
F_123 ( V_121 [ V_56 ] , V_137 ) ;
else
F_122 ( V_121 [ V_56 ] , V_137 ) ;
}
F_169 ( V_118 , V_137 , V_207 ) ;
F_6 ( & V_134 ) ;
if ( V_207 )
...
if ( ! V_121 [ V_56 ] )
continue;
V_51 = F_145 ( V_121 [ V_56 ] , 1 , & V_157 [ V_56 ] ) ;
if ( V_51 )
goto V_213;
}
for ( V_56 = 0 ; V_56 < V_27 ; V_56 ++ ) {
...
int F_177 ( struct V_118 * V_118 , T_2 V_137 )
{
struct V_30 * * V_121 ;
int V_56 , V_208 ;
if ( ! F_151 ( V_118 ) ) {
...
void F_178 ( struct V_118 * V_118 , T_2 V_137 )
{
struct V_30 * * V_121 ;
int V_56 , V_208 ;
if ( ! F_151 ( V_118 ) ) {
...
void F_179 ( struct V_118 * V_118 , T_2 V_137 , int V_89 )
{
unsigned int V_56 ;
struct V_156 V_157 [ V_27 ] ;
struct V_30 * * V_121 ;
...
if ( ! V_121 [ V_56 ] )
continue;
V_214 = F_150 ( V_121 [ V_56 ] , V_137 ) ;
if ( V_214 != V_177 )
F_139 ( & V_157 [ V_56 ] , V_121 [ V_56 ] , V_214 ) ;
if ( V_207 )
F_127 ( V_121 [ V_56 ] , V_137 ) ;
else
F_129 ( V_121 [ V_56 ] , V_137 ) ;
}
F_171 ( V_118 , V_137 , V_207 ) ;
F_6 ( & V_134 ) ;
if ( V_207 )
...
int F_181 ( struct V_118 * V_118 , struct V_30 * * V_216 )
{
T_2 V_190 , V_217 ;
T_2 V_218 = 0 ;
...
if ( ! V_216 [ V_56 ] )
continue;
if ( ! F_75 ( V_118 -> V_119 , V_56 ) )
continue;
V_220 [ V_56 ] = 1 ;
V_219 [ V_56 ] = F_106 ( V_118 ) [ V_56 ] ;
V_51 = F_145 ( V_216 [ V_56 ] , 1 , & V_221 [ V_56 ] ) ;
if ( V_51 )
goto V_224;
V_51 = F_148 ( V_216 [ V_56 ] , V_190 , 0 , & V_221 [ V_56 ] ) ;
if ( V_51 )
goto V_224;
}
for ( V_56 = 0 ; V_56 < V_27 ; V_56 ++ ) {
...
if ( V_219 [ V_56 ] ) {
int V_214 ;
V_214 = F_149 ( V_219 [ V_56 ] , 1 ) ;
if ( V_214 != V_177 )
F_139 ( & V_222 [ V_56 ] ,
V_219 [ V_56 ] , V_214 ) ;
V_214 = F_150 ( V_219 [ V_56 ] , V_190 ) ;
if ( V_214 != V_177 )
F_139 ( & V_223 [ V_56 ] ,
V_219 [ V_56 ] , V_214 ) ;
F_128 ( V_219 [ V_56 ] , 1 ) ;
F_129 ( V_219 [ V_56 ] , V_217 ) ;
F_127 ( V_219 [ V_56 ] ,
V_218 ) ;
}
F_121 ( V_216 [ V_56 ] , 1 ) ;
F_122 ( V_216 [ V_56 ] , V_217 ) ;
F_123 ( V_216 [ V_56 ] , V_218 ) ;
F_106 ( V_118 ) [ V_56 ] = V_216 [ V_56 ] ;
}
F_6 ( & V_134 ) ;
F_43 ( V_219 ) ;
F_43 ( V_216 ) ;
...
int F_183 ( struct V_118 * V_118 , struct V_225 * V_225 )
{
...
if ( ! F_151 ( V_118 ) )
return 0 ;
if ( V_225 -> V_226 & V_227 && ! F_132 ( V_225 -> V_228 , V_118 -> V_200 ) ) {
V_30 = F_102 ( V_2 , F_154 ( V_225 -> V_228 ) ) ;
if ( F_157 ( V_30 ) ) {
if ( F_158 ( V_30 ) != - V_114 ) {
V_51 = F_158 ( V_30 ) ;
goto V_203;
...
if ( V_225 -> V_226 & V_229 && ! F_184 ( V_225 -> V_230 , V_118 -> V_201 ) ) {
V_30 = F_102 ( V_2 , F_155 ( V_225 -> V_230 ) ) ;
if ( F_157 ( V_30 ) ) {
if ( F_158 ( V_30 ) != - V_114 ) {
V_51 = F_158 ( V_30 ) ;
goto V_203;
...
int F_186 ( struct V_1 * V_2 , struct V_22 * V_23 )
{
struct V_60 * V_61 = F_42 ( V_2 ) ;
int V_55 ;
F_34 ( & V_61 -> V_81 ) ;
...
int F_187 ( struct V_118 * V_118 , struct V_233 * V_233 )
{
int error ;
error = F_188 ( V_118 , V_233 ) ;
if ( ! error && ( V_233 -> V_234 & V_235 ) )
F_159 ( V_118 ) ;
return error ;
}
int F_189 ( struct V_1 * V_2 , int type , unsigned int V_89 )
{
int V_56 , V_51 = 0 ;
struct V_60 * V_61 = F_42 ( V_2 ) ;
...
F_5 ( & V_115 ) ;
V_61 -> V_89 &= ~ F_191 ( V_89 , V_56 ) ;
if ( ! F_190 ( V_2 , V_56 ) &&
F_192 ( V_2 , V_56 ) ) {
V_61 -> V_89 &= ~ F_191 (
V_239 , V_56 ) ;
F_6 ( & V_115 ) ;
F_113 ( V_61 -> V_94 [ V_56 ] ) ;
V_61 -> V_94 [ V_56 ] = NULL ;
continue;
}
F_6 ( & V_115 ) ;
}
if ( F_190 ( V_2 , V_56 ) && ! ( V_89 & V_239 ) )
continue;
F_118 ( V_2 , V_56 ) ;
F_63 ( V_2 , V_56 ) ;
...
{
return F_189 ( V_2 , type ,
V_237 | V_238 ) ;
}
static int F_196 ( struct V_118 * V_118 , int type , int V_248 ,
unsigned int V_89 )
{
...
error = - V_69 ;
V_61 -> V_94 [ type ] = F_200 ( V_118 ) ;
if ( ! V_61 -> V_94 [ type ] )
goto V_204;
error = - V_113 ;
if ( ! V_4 -> V_256 -> V_257 ( V_2 , type ) )
goto V_258;
V_61 -> V_64 [ type ] = V_4 -> V_256 ;
V_61 -> V_53 [ type ] . V_181 = V_4 ;
V_61 -> V_53 [ type ] . V_259 = V_248 ;
F_97 ( & V_61 -> V_53 [ type ] . V_54 ) ;
F_34 ( & V_61 -> V_62 ) ;
error = V_61 -> V_64 [ type ] -> F_201 ( V_2 , type ) ;
if ( error < 0 ) {
F_35 ( & V_61 -> V_62 ) ;
goto V_258;
}
if ( V_61 -> V_89 & V_90 )
V_61 -> V_53 [ type ] . V_58 |= V_260 ;
F_35 ( & V_61 -> V_62 ) ;
F_5 ( & V_115 ) ;
V_61 -> V_89 |= F_191 ( V_89 , type ) ;
F_6 ( & V_115 ) ;
F_109 ( V_2 , type ) ;
F_35 ( & V_61 -> V_81 ) ;
return 0 ;
...
int F_202 ( struct V_1 * V_2 , int type )
{
struct V_60 * V_61 = F_42 ( V_2 ) ;
struct V_118 * V_118 ;
int V_51 = 0 , V_56 ;
...
V_61 -> V_94 [ V_56 ] = NULL ;
F_5 ( & V_115 ) ;
V_89 = V_61 -> V_89 & F_191 ( V_237 |
V_238 ,
V_56 ) ;
V_61 -> V_89 &= ~ F_191 ( V_261 , V_56 ) ;
F_6 ( & V_115 ) ;
F_35 ( & V_61 -> V_81 ) ;
V_89 = F_203 ( V_89 , V_56 ) ;
V_51 = F_196 ( V_118 , V_56 ,
V_61 -> V_53 [ V_56 ] . V_259 , V_89 ) ;
F_113 ( V_118 ) ;
}
return V_51 ;
}
int F_204 ( struct V_1 * V_2 , int type , int V_248 ,
struct V_262 * V_262 )
{
int error = F_205 ( V_262 -> V_263 ) ;
if ( error )
return error ;
if ( V_262 -> V_263 -> V_264 != V_2 )
error = - V_265 ;
else
error = F_196 ( F_206 ( V_262 -> V_263 ) , type ,
V_248 , V_237 |
V_238 ) ;
return error ;
}
int F_207 ( struct V_118 * V_118 , int type , int V_248 ,
unsigned int V_89 )
{
int V_51 = 0 ;
struct V_1 * V_2 = V_118 -> V_119 ;
...
V_266:
return F_196 ( V_118 , type , V_248 , V_89 ) ;
}
int F_209 ( struct V_1 * V_2 , char * V_267 ,
int V_248 , int type )
{
struct V_263 * V_263 ;
int error ;
V_263 = F_210 ( V_267 , V_2 -> V_268 , strlen ( V_267 ) ) ;
if ( F_157 ( V_263 ) )
return F_158 ( V_263 ) ;
if ( F_211 ( V_263 ) ) {
error = - V_269 ;
...
error = F_205 ( V_263 ) ;
if ( ! error )
error = F_196 ( F_206 ( V_263 ) , type , V_248 ,
V_237 | V_238 ) ;
V_83:
F_212 ( V_263 ) ;
return error ;
}
static int F_213 ( struct V_1 * V_2 , unsigned int V_89 )
{
int V_51 ;
int type ;
struct V_60 * V_61 = F_42 ( V_2 ) ;
...
if ( ! F_208 ( V_2 , type ) )
return - V_113 ;
V_51 = F_207 ( V_61 -> V_94 [ type ] , type ,
V_61 -> V_53 [ type ] . V_259 ,
V_238 ) ;
if ( V_51 < 0 )
goto V_273;
}
...
if ( V_89 & F_214 ( type ) )
F_189 ( V_2 , type , V_238 ) ;
}
if ( V_51 == - V_247 )
V_51 = - V_274 ;
return V_51 ;
}
static int F_215 ( struct V_1 * V_2 , unsigned int V_89 )
{
int V_51 ;
int type ;
struct V_60 * V_61 = F_42 ( V_2 ) ;
...
for ( type -- ; type >= 0 ; type -- ) {
if ( V_89 & F_214 ( type ) )
F_207 ( V_61 -> V_94 [ type ] , type ,
V_61 -> V_53 [ type ] . V_259 ,
V_238 ) ;
}
return V_51 ;
}
static void F_216 ( struct V_30 * V_30 , struct V_276 * V_277 )
{
...
int F_218 ( struct V_1 * V_2 , struct V_22 * V_23 ,
struct V_276 * V_277 )
{
struct V_30 * V_30 ;
int V_55 ;
...
static int F_219 ( struct V_30 * V_30 , struct V_276 * V_277 )
{
struct V_278 * V_279 = & V_30 -> V_138 ;
int V_288 = 0 , V_289 = 0 ;
...
V_199 = F_219 ( V_30 , V_277 ) ;
F_45 ( V_30 ) ;
V_83:
return V_199 ;
}
int F_221 ( struct V_1 * V_2 , struct V_311 * V_312 )
{
struct V_179 * V_313 ;
struct V_314 * V_315 ;
struct V_60 * V_61 = F_42 ( V_2 ) ;
...
int F_222 ( struct V_1 * V_2 , int type , struct V_328 * V_329 )
{
struct V_179 * V_313 ;
int V_55 = 0 ;
...
static int F_223 ( struct V_336 * V_337 , int V_338 ,
void T_4 * V_339 , T_5 * V_340 , T_6 * V_341 )
{
unsigned int type = ( int * ) V_337 -> V_342 - V_103 . V_343 ;
V_103 . V_343 [ type ] =
F_224 ( & V_103 . V_104 [ type ] ) ;
return F_225 ( V_337 , V_338 , V_339 , V_340 , V_341 ) ;
}
...
NULL ) ;
V_345 = 0 ;
V_33 = (struct V_31 * ) F_229 ( V_353 , V_345 ) ;
if ( ! V_33 )
F_230 ( L_21 ) ;
for ( V_176 = 0 ; V_176 < V_354 ; V_176 ++ ) {
V_51 = F_231 ( & V_103 . V_104 [ V_176 ] , 0 , V_355 ) ;
if ( V_51 )
F_230 ( L_22 ) ;
}
