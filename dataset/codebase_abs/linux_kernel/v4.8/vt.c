...
if ( V_82 > V_5 -> V_186 )
return V_82 ;
if ( V_5 -> V_187 [ V_82 ] == 5 && V_82 < V_5 -> V_186 ) {
V_82 ++ ;
F_87 ( V_5 -> V_187 [ V_82 ] , & V_9 ) ;
} else if ( V_5 -> V_187 [ V_82 ] == 2 && V_82 <= V_5 -> V_186 + 3 ) {
...
{
struct V_387 * V_111 = V_385 -> V_111 ;
const struct V_384 * V_389 = NULL ;
struct V_350 * V_350 = NULL , * V_390 = NULL ;
...
for ( V_82 = 0 ; V_82 < V_349 ; V_82 ++ ) {
V_390 = & V_351 [ V_82 ] ;
if ( V_390 -> V_352 && V_390 -> V_352 != V_385 ) {
V_389 = V_390 -> V_352 ;
V_328 = 0 ;
break;
}
...
if ( ! F_199 ( V_389 ) ) {
const struct V_384 * V_392 = V_112 ;
V_389 -> V_348 () ;
V_390 -> V_354 |= V_355 ;
V_112 = V_392 ;
}
...
{
const struct V_384 * V_389 = NULL , * V_385 = NULL ;
int V_82 , V_393 = 1 , V_261 = - 1 , V_262 = - 1 , V_386 = 0 ;
if ( ! V_352 -> V_352 || ! ( V_352 -> V_354 & V_391 ) )
goto V_135;
V_385 = V_352 -> V_352 ;
for ( V_82 = 0 ; V_82 < V_349 ; V_82 ++ ) {
...
{
struct V_350 * V_352 = F_203 ( V_364 ) ;
int V_394 = F_199 ( V_352 -> V_352 ) ;
return snprintf ( V_197 , V_395 , L_21 , V_394 ) ;
}
static T_9 F_206 ( struct V_363 * V_364 , struct V_365 * V_366 ,
char * V_197 )
{
struct V_350 * V_352 = F_203 ( V_364 ) ;
return snprintf ( V_197 , V_395 , L_22 ,
( V_352 -> V_354 & V_391 ) ? L_23 : L_24 ,
V_352 -> V_353 ) ;
}
...
if ( F_211 ( V_405 [ 0 ] , & V_403 ) ) {
snprintf ( V_404 , 4 , L_27 , V_5 -> V_30 ) ;
F_212 ( 2 , V_405 ) ;
}
}
if ( V_5 -> V_34 < 999 ) {
...
for ( V_82 = 0 ; V_82 < V_349 ; V_82 ++ ) {
struct V_350 * V_350 = & V_351 [ V_82 ] ;
if ( ! ( V_350 -> V_354 & V_408 ) )
continue;
F_71 () ;
F_208 ( V_350 ) ;
F_218 ( V_410 , F_183 ( 0 , V_350 -> V_409 ) ) ;
F_70 () ;
...
return - V_311 ;
V_415 = ( V_293 < 4 ) ? V_293 : 0 ;
return 0 ;
}
void F_136 ( int V_416 )
{
struct V_4 * V_5 = V_101 [ V_13 ] . V_28 ;
int V_82 ;
F_22 () ;
...
V_290 = 0 ;
F_37 ( V_5 ) ;
V_82 = V_5 -> V_19 -> V_419 ( V_5 , V_216 ? 1 : ( V_415 + 1 ) , 0 ) ;
V_14 = V_13 + 1 ;
if ( V_82 )
F_36 ( V_5 ) ;
if ( V_420 && V_420 ( 1 ) )
...
F_67 ( V_421 , V_5 -> V_12 , V_5 -> V_12 ) ;
}
void F_225 ( int V_422 )
{
struct V_4 * V_5 ;
if ( ! V_423 )
F_129 () ;
...
V_14 = 0 ;
if ( V_5 -> V_19 -> V_419 ( V_5 , 0 , V_422 ) || F_42 ( V_5 ) )
F_66 ( V_5 ) ;
if ( V_420 )
V_420 ( 0 ) ;
F_41 ( V_5 ) ;
F_24 ( V_5 ) ;
F_67 ( V_424 , V_5 -> V_12 , V_5 -> V_12 ) ;
}
void F_150 ( void )
{
F_225 ( 0 ) ;
}
static void F_227 ( unsigned long V_425 )
{
if ( F_228 ( ! F_229 () ) ) {
F_175 ( & V_358 , V_359 + ( V_211 * V_217 ) ) ;
return;
...
{
F_22 () ;
if ( V_5 -> V_89 != V_90 && V_5 -> V_19 -> V_426 )
V_5 -> V_19 -> V_426 ( V_5 , V_195 ) ;
}
int F_231 ( unsigned char T_7 * V_306 )
{
int V_82 , V_252 , V_340 ;
unsigned char V_427 [ 3 * 16 ] ;
if ( F_232 ( V_427 , V_306 , sizeof( V_427 ) ) )
return - V_311 ;
F_70 () ;
for ( V_82 = V_340 = 0 ; V_82 < 16 ; V_82 ++ ) {
V_341 [ V_82 ] = V_427 [ V_340 ++ ] ;
V_342 [ V_82 ] = V_427 [ V_340 ++ ] ;
V_343 [ V_82 ] = V_427 [ V_340 ++ ] ;
}
for ( V_82 = 0 ; V_82 < V_108 ; V_82 ++ ) {
if ( ! F_45 ( V_82 ) )
continue;
...
F_70 () ;
for ( V_82 = V_340 = 0 ; V_82 < 16 ; V_82 ++ ) {
V_427 [ V_340 ++ ] = V_341 [ V_82 ] ;
V_427 [ V_340 ++ ] = V_342 [ V_82 ] ;
V_427 [ V_340 ++ ] = V_343 [ V_82 ] ;
}
F_71 () ;
if ( F_234 ( V_306 , V_427 , sizeof( V_427 ) ) )
return - V_311 ;
return 0 ;
}
...
static int F_235 ( struct V_4 * V_5 , struct V_428 * V_429 )
{
struct V_430 V_431 ;
int V_432 = - V_156 ;
int V_9 ;
if ( V_429 -> V_307 ) {
V_431 . V_307 = F_56 ( V_433 , V_124 ) ;
if ( ! V_431 . V_307 )
return - V_125 ;
} else
V_431 . V_307 = NULL ;
...
V_432 = V_5 -> V_19 -> F_235 ( V_5 , & V_431 ) ;
else
V_432 = - V_434 ;
F_71 () ;
if ( V_432 )
goto V_435;
V_9 = ( V_431 . V_132 + 7 ) / 8 * 32 * V_431 . V_436 ;
if ( V_429 -> V_307 && V_431 . V_436 > V_429 -> V_436 )
V_432 = - V_437 ;
if ( ! ( V_429 -> V_380 & V_438 ) ) {
if ( V_431 . V_132 > V_429 -> V_132 || V_431 . V_133 > V_429 -> V_133 )
V_432 = - V_437 ;
} else {
if ( V_431 . V_132 != 8 )
V_432 = - V_439 ;
else if ( ( V_429 -> V_133 && V_431 . V_133 > V_429 -> V_133 ) ||
V_431 . V_133 > 32 )
V_432 = - V_437 ;
}
if ( V_432 )
...
V_429 -> V_132 = V_431 . V_132 ;
V_429 -> V_436 = V_431 . V_436 ;
if ( V_429 -> V_307 && F_234 ( V_429 -> V_307 , V_431 . V_307 , V_9 ) )
V_432 = - V_311 ;
V_435:
F_59 ( V_431 . V_307 ) ;
return V_432 ;
}
static int F_236 ( struct V_4 * V_5 , struct V_428 * V_429 )
{
struct V_430 V_431 ;
int V_432 = - V_156 ;
int V_440 ;
...
if ( ! V_429 -> V_133 ) {
int V_441 , V_82 ;
T_2 T_7 * V_442 = V_429 -> V_307 ;
T_2 V_443 ;
if ( ! ( V_429 -> V_380 & V_438 ) )
return - V_156 ;
for ( V_441 = 32 ; V_441 > 0 ; V_441 -- )
for ( V_82 = 0 ; V_82 < V_429 -> V_436 ; V_82 ++ ) {
if ( F_147 ( V_443 , & V_442 [ 32 * V_82 + V_441 - 1 ] ) )
return - V_311 ;
if ( V_443 )
goto V_444;
}
...
if ( V_429 -> V_132 <= 0 || V_429 -> V_132 > 32 || V_429 -> V_133 > 32 )
return - V_156 ;
V_440 = ( V_429 -> V_132 + 7 ) / 8 * 32 * V_429 -> V_436 ;
if ( V_440 > V_433 )
return - V_437 ;
V_431 . V_436 = V_429 -> V_436 ;
V_431 . V_133 = V_429 -> V_133 ;
V_431 . V_132 = V_429 -> V_132 ;
V_431 . V_307 = F_237 ( V_429 -> V_307 , V_440 ) ;
if ( F_187 ( V_431 . V_307 ) )
return F_215 ( V_431 . V_307 ) ;
F_70 () ;
if ( V_5 -> V_89 != V_288 )
V_432 = - V_156 ;
else if ( V_5 -> V_19 -> F_236 )
V_432 = V_5 -> V_19 -> F_236 ( V_5 , & V_431 , V_429 -> V_380 ) ;
else
V_432 = - V_434 ;
F_71 () ;
F_59 ( V_431 . V_307 ) ;
...
static int F_238 ( struct V_4 * V_5 , struct V_428 * V_429 )
{
struct V_430 V_431 = { . V_132 = V_429 -> V_132 , . V_133 = V_429 -> V_133 } ;
char V_373 [ V_445 ] ;
char * V_29 = V_373 ;
int V_432 ;
if ( ! V_429 -> V_307 )
V_29 = NULL ;
else if ( F_239 ( V_373 , V_429 -> V_307 , V_445 - 1 ) < 0 )
return - V_311 ;
else
V_373 [ V_445 - 1 ] = 0 ;
F_70 () ;
...
if ( V_5 -> V_19 -> F_238 )
V_432 = V_5 -> V_19 -> F_238 ( V_5 , & V_431 , V_29 ) ;
else
V_432 = - V_434 ;
F_71 () ;
if ( ! V_432 ) {
...
static int F_240 ( struct V_4 * V_5 , struct V_428 * V_429 )
{
int V_352 = V_429 -> V_133 ;
int V_432 ;
F_70 () ;
if ( V_5 -> V_89 != V_288 )
V_432 = - V_156 ;
...
V_432 = V_5 -> V_19 -> F_240 ( V_5 , V_352 ) ;
F_71 () ;
return V_432 ;
}
int F_241 ( struct V_4 * V_5 , struct V_428 * V_429 )
{
switch ( V_429 -> V_429 ) {
case V_447 :
return F_236 ( V_5 , V_429 ) ;
case V_448 :
return F_235 ( V_5 , V_429 ) ;
case V_449 :
return F_238 ( V_5 , V_429 ) ;
case V_450 :
return F_240 ( V_5 , V_429 ) ;
}
return - V_434 ;
}
T_1 F_242 ( struct V_4 * V_5 , int V_15 )
{
T_1 V_451 = F_20 ( F_11 ( V_5 , V_15 , 1 ) ) ;
T_1 V_9 = V_451 & 0xff ;
if ( V_451 & V_5 -> V_60 )
V_9 |= 0x100 ;
return V_9 ;
}
unsigned short * F_243 ( struct V_4 * V_5 , int V_452 , int V_16 )
{
return F_11 ( V_5 , 2 * V_452 , V_16 ) ;
}
...
T_1 F_246 ( struct V_4 * V_5 , const T_1 * V_453 )
{
if ( ( unsigned long ) V_453 == V_5 -> V_79 && V_84 != - 1 )
return V_84 ;
return F_20 ( V_453 ) ;
}
void F_247 ( struct V_4 * V_5 , T_1 V_454 , T_1 * V_453 )
{
F_28 ( V_454 , V_453 ) ;
if ( ( unsigned long ) V_453 == V_5 -> V_79 ) {
V_84 = - 1 ;
F_33 ( V_5 ) ;
}
}
