...
goto V_80;
V_25 = F_20 ( V_23 , V_2 ) ;
V_79 = F_83 ( V_7 ) ? V_81 : V_82 ;
V_77 = F_84 ( V_25 , V_2 -> V_83 + V_2 -> V_21 ,
V_2 -> V_84 , V_79 ,
V_85 | V_86 ) ;
if ( ! V_77 )
goto V_80;
...
F_67 ( V_9 , L_11 ,
V_23 -> V_91 , F_43 ( V_7 ) , V_2 -> V_20 , V_2 -> V_14 ) ;
F_66 ( V_7 , 1 ) ;
F_86 ( V_7 , V_23 ) ;
F_61 ( V_7 , V_2 -> V_84 ) ;
F_87 ( V_25 ) ;
...
if ( F_44 ( V_7 ) )
return 0 ;
if ( ( V_13 < F_48 ( V_6 , V_93 ) ) ||
F_89 ( V_7 , V_94 ) )
goto F_68;
if ( ! F_48 ( V_6 , V_95 ) && V_13 & 0x7 )
goto F_68;
V_92 = F_48 ( V_6 , V_95 ) ?
V_96 - 1 : 0x7 ;
...
static int F_100 ( struct V_1 * V_2 , int * V_4 )
{
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
F_101 ( F_48 ( V_6 , V_95 ) ) ;
return F_99 ( V_2 , V_4 ) ;
}
static int F_102 ( struct V_1 * V_2 , int * V_4 )
{
struct V_11 * V_7 = V_2 -> V_7 ;
int V_55 = F_59 ( V_7 ) ;
F_94 ( V_7 , V_7 -> V_23 ) ;
...
struct V_24 * V_25 = F_20 ( V_23 , V_2 ) ;
int V_61 ;
F_106 ( V_6 , V_105 , F_43 ( V_7 ) ) ;
V_61 = F_40 ( V_6 , V_23 ) ;
F_22 ( V_7 , V_23 ) ;
V_2 -> V_21 = F_103 ( V_2 , V_25 , V_61 ) ;
F_94 ( V_7 , V_23 ) ;
F_23 ( V_2 ) ;
F_24 ( V_7 , V_7 -> V_23 ) ;
* V_4 = 1 ;
...
static int F_107 ( struct V_1 * V_2 , int * V_4 )
{
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
if ( F_48 ( V_6 , V_95 ) )
...
static bool F_108 ( struct V_24 * V_25 , void * V_106 )
{
...
static void F_109 ( struct V_5 * V_6 , struct V_22 * V_23 )
{
if ( V_23 -> V_65 )
F_110 ( V_23 -> V_65 ) ;
if ( V_23 -> V_67 )
...
F_112 ( V_44 ) ;
F_113 ( V_112 , V_44 ) ;
V_23 -> V_65 = F_114 ( V_44 , F_108 ,
& V_23 -> V_113 ) ;
F_112 ( V_44 ) ;
F_113 ( V_112 , V_44 ) ;
V_23 -> V_67 = F_114 ( V_44 , F_108 ,
& V_23 -> V_114 ) ;
}
static void F_115 ( struct V_8 * V_9 , struct V_22 * V_23 ,
int V_115 )
{
char V_91 [ 16 ] ;
snprintf ( V_91 , sizeof( V_91 ) , L_12 , V_115 ) ;
if ( V_115 & 1 ) {
V_23 -> V_65 = F_116 ( V_9 , V_91 ) ;
if ( F_117 ( V_23 -> V_65 ) )
V_23 -> V_65 = NULL ;
} else {
V_23 -> V_67 = F_116 ( V_9 , V_91 ) ;
if ( F_117 ( V_23 -> V_67 ) )
V_23 -> V_67 = NULL ;
}
}
static void F_118 ( struct V_5 * V_6 , struct V_22 * V_23 ,
int V_115 )
{
struct V_8 * V_9 = F_5 ( V_6 ) ;
if ( V_9 -> V_116 )
F_115 ( V_9 , V_23 , V_115 ) ;
else
F_111 ( V_23 ) ;
...
{
struct V_122 * V_123 = F_124 ( V_6 ) ;
struct V_22 * V_124 = F_51 ( V_6 ) ;
struct V_22 * V_125 ;
int V_57 ;
V_123 -> V_126 = F_119 ;
V_123 -> V_127 = F_121 ;
