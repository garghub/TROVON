...
static void F_60 ( struct V_85 * V_35 )
{
F_61 ( F_59 ( V_35 ) , V_86 ) ;
}
static void F_62 ( struct V_85 * V_35 ,
bool V_87 )
{
struct V_33 * V_34 = F_59 ( V_35 ) ;
T_1 V_15 ;
...
static int F_66 ( struct V_85 * V_35 )
{
struct V_33 * V_34 = F_59 ( V_35 ) ;
if ( F_67 ( ! F_68 ( V_34 ) ) )
return - V_90 ;
...
static int F_69 ( struct V_85 * V_35 ,
int V_59 , int V_8 )
{
struct V_33 * V_34 = F_59 ( V_35 ) ;
struct V_37 * V_37 ;
...
static int F_71 ( struct V_85 * V_35 , int V_59 ,
bool * V_95 ,
...
V_36 = V_58 -> V_78 -> V_36 ;
V_98 = F_12 ( V_36 ) ;
memcpy ( V_96 , V_36 , F_15 ( V_97 , V_98 ) ) ;
}
}
F_25 ( & V_34 -> V_51 ) ;
return V_98 ;
}
static int F_72 ( struct V_85 * V_100 ,
struct V_85 * V_101 , void * V_102 )
{
struct V_54 * V_55 = V_102 ;
struct V_33 * V_34 = F_59 ( V_100 ) ;
int V_3 ;
if ( F_33 ( V_55 -> V_103 || V_55 -> V_35 ) )
return - V_104 ;
F_73 ( & V_34 -> V_105 ) ;
V_55 -> V_103 = & V_106 ;
V_55 -> V_35 = V_100 ;
...
static void F_76 ( struct V_85 * V_100 ,
struct V_85 * V_101 , void * V_102 )
{
struct V_54 * V_55 = V_102 ;
struct V_33 * V_34 = F_59 ( V_100 ) ;
...
{
int V_98 ;
V_98 = F_78 ( V_34 -> V_105 . V_35 , & V_109 ) ;
if ( V_98 < 0 ) {
F_30 ( L_17 , V_98 ) ;
return;
}
