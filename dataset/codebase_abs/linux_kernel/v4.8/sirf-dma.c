...
return - V_96 ;
V_53 = (struct V_143 * )
( F_60 ( V_138 -> V_91 . V_149 -> V_150 ,
& V_138 -> V_91 ) -> V_53 ) ;
V_43 -> V_48 = V_53 -> V_151 ;
V_43 -> type = V_53 -> type ;
if ( F_61 ( V_140 , L_4 , & V_148 ) ) {
F_62 ( V_91 , L_5 ) ;
return - V_152 ;
}
...
static int T_8 F_90 ( struct V_128 * V_91 )
{
struct V_5 * V_43 = F_85 ( V_91 ) ;
F_91 ( V_43 -> V_154 ) ;
return 0 ;
}
static int T_8 F_92 ( struct V_128 * V_91 )
{
struct V_5 * V_43 = F_85 ( V_91 ) ;
int V_102 ;
V_102 = F_93 ( V_43 -> V_154 ) ;
if ( V_102 < 0 ) {
F_62 ( V_91 , L_13 , V_102 ) ;
return V_102 ;
}
return 0 ;
}
static int T_8 F_94 ( struct V_128 * V_91 )
{
struct V_5 * V_43 = F_85 ( V_91 ) ;
...
static int T_8 F_95 ( struct V_128 * V_91 )
{
struct V_5 * V_43 = F_85 ( V_91 ) ;
struct V_179 * V_180 = & V_43 -> V_181 ;
struct V_9 * V_10 ;
