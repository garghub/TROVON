...
if ( ! V_51 )
return;
if ( F_6 ( V_32 -> V_2 -> V_10 , V_32 -> V_3 , V_52 ) )
return;
V_32 -> V_53 = 0 ;
}
...
{
T_3 V_54 ;
F_23 ( V_32 , V_32 -> V_55 + V_56 , & V_54 ) ;
V_32 -> V_57 = ( V_58 V_59 ) ( V_54 & V_60 ) ;
F_24 ( V_32 , V_61 ) ;
}
...
F_28 ( V_32 , V_16 + 8 + ( V_63 * 4 ) , & V_17 ) ;
V_32 -> V_66 [ V_63 ] . V_67 = V_32 -> V_66 [ V_63 ] . V_68 + V_17 - 1 ;
V_32 -> V_66 [ V_63 ] . V_69 |= V_70 ;
}
}
