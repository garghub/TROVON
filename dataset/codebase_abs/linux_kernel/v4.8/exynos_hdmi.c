...
V_8 -> V_310 = F_104 ( V_29 , L_28 ) ;
if ( F_96 ( V_8 -> V_310 ) == - V_80 )
return 0 ;
if ( F_95 ( V_8 -> V_310 ) )
return F_96 ( V_8 -> V_310 ) ;
V_24 = F_105 ( V_8 -> V_310 ) ;
if ( V_24 )
F_40 ( L_29 ) ;
return V_24 ;
}
static int F_106 ( struct V_32 * V_29 , struct V_32 * V_311 , void * V_30 )
{
...
F_109 ( V_99 , V_312 ) -> V_314 = & V_8 -> V_306 ;
V_4 -> V_315 = 1 << V_312 ;
F_23 ( L_30 , V_4 -> V_315 ) ;
F_110 ( V_99 , V_4 , & V_316 ,
V_317 , NULL ) ;
F_111 ( V_4 , & V_318 ) ;
V_24 = F_38 ( V_4 ) ;
if ( V_24 ) {
...
static void F_113 ( struct V_32 * V_29 , struct V_32 * V_311 , void * V_30 )
{
}
static struct V_319 * F_114 ( struct V_32 * V_29 )
{
const char * V_320 = L_32 ;
struct V_319 * V_321 ;
V_321 = F_115 ( NULL , NULL , V_320 ) ;
if ( V_321 )
return F_116 ( V_321 ) ;
return NULL ;
}
static struct V_319 * F_117 ( struct V_32 * V_29 )
{
const char * V_320 = L_33 ;
return F_115 ( NULL , NULL , V_320 ) ;
}
static int F_118 ( struct V_322 * V_323 )
{
struct V_319 * V_324 , * V_325 ;
struct V_32 * V_29 = & V_323 -> V_29 ;
struct V_1 * V_8 ;
struct V_326 * V_327 ;
int V_24 ;
...
V_327 = F_121 ( V_323 , V_328 , 0 ) ;
V_8 -> V_13 = F_122 ( V_29 , V_327 ) ;
if ( F_95 ( V_8 -> V_13 ) ) {
V_24 = F_96 ( V_8 -> V_13 ) ;
return V_24 ;
}
...
static int F_135 ( struct V_322 * V_323 )
{
struct V_1 * V_8 = F_136 ( V_323 ) ;
F_137 ( & V_8 -> V_291 ) ;
F_138 ( & V_323 -> V_29 , & V_339 ) ;
F_133 ( & V_323 -> V_29 ) ;
if ( ! F_95 ( V_8 -> V_310 ) )
F_139 ( V_8 -> V_310 ) ;
if ( V_8 -> V_23 )
...
static int F_140 ( struct V_32 * V_29 )
{
struct V_1 * V_8 = F_107 ( V_29 ) ;
F_17 ( V_8 ) ;
return 0 ;
