...
int
F_71 ( struct V_8 * V_9 , struct V_95 * V_96 , int V_97 ,
enum V_49 V_50 , unsigned long V_92 )
{
struct V_95 * V_98 ;
int V_22 ;
F_41 ( V_50 == V_94 ) ;
...
if ( V_4 ||
! F_63 ( V_9 , V_83 , V_98 -> V_99 ) ) {
V_29 V_93 = F_47 ( V_9 , F_73 ( V_98 ) ,
V_98 -> V_99 , V_50 ) ;
if ( V_93 == V_73 ) {
F_60 ( V_9 , V_98 -> V_99 , V_50 , 0 ) ;
F_74 ( V_9 , V_96 , V_22 , V_50 ,
V_92 ) ;
F_75 ( V_96 ) = 0 ;
return 0 ;
}
...
enum V_49 V_50 )
{
return F_71 ( V_9 , V_96 , V_97 , V_50 , 0 ) ;
}
void
F_74 ( struct V_8 * V_9 , struct V_95 * V_96 ,
...
F_41 ( V_50 == V_94 ) ;
F_72 (sgl, sg, nelems, i)
F_65 ( V_9 , V_98 -> V_100 , F_75 ( V_98 ) , V_50 ) ;
}
void
F_77 ( struct V_8 * V_9 , struct V_95 * V_96 , int V_97 ,
enum V_49 V_50 )
{
return F_74 ( V_9 , V_96 , V_97 , V_50 , 0 ) ;
}
static void
F_78 ( struct V_8 * V_9 , struct V_95 * V_96 ,
int V_97 , enum V_49 V_50 ,
enum V_78 V_79 )
{
struct V_95 * V_98 ;
...
int V_97 , enum V_49 V_50 )
{
F_78 ( V_9 , V_98 , V_97 , V_50 , V_80 ) ;
}
void
F_80 ( struct V_8 * V_9 , struct V_95 * V_98 ,
int V_97 , enum V_49 V_50 )
{
F_78 ( V_9 , V_98 , V_97 , V_50 , V_81 ) ;
}
int
F_81 ( struct V_8 * V_9 , T_2 V_101 )
{
