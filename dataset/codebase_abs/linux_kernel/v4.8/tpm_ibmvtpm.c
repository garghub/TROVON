...
static unsigned long F_29 ( struct V_1 * V_2 )
{
struct V_7 * V_8 = F_4 ( & V_2 -> V_13 ) ;
struct V_11 * V_12 = F_4 ( & V_8 -> V_13 ) ;
if ( ! V_12 )
...
static int F_30 ( struct V_48 * V_13 )
{
...
static int F_32 ( struct V_48 * V_13 )
{
struct V_7 * V_8 = F_4 ( V_13 ) ;
struct V_11 * V_12 = F_4 ( & V_8 -> V_13 ) ;
int V_26 = 0 ;
...
static bool F_34 ( struct V_7 * V_8 , T_2 V_54 )
{
return ( V_54 == 0 ) ;
}
static struct V_23 * F_35 ( struct V_11 * V_12 )
{
...
V_12 -> V_27 = F_38 ( V_24 -> V_14 ) ;
V_12 -> V_16 = F_39 ( V_12 -> V_27 ,
V_63 ) ;
if ( ! V_12 -> V_16 ) {
F_5 ( V_12 -> V_13 , L_19 ) ;
return;
}
V_12 -> V_33 = F_40 ( V_12 -> V_13 ,
V_12 -> V_16 , V_12 -> V_27 ,
V_44 ) ;
if ( F_41 ( V_12 -> V_13 ,
V_12 -> V_33 ) ) {
...
return;
case V_64 :
V_12 -> V_65 = F_42 ( V_24 -> V_32 ) ;
return;
case V_66 :
V_12 -> V_20 = F_38 ( V_24 -> V_14 ) ;
V_12 -> V_18 = false ;
F_43 ( & V_12 -> V_17 ) ;
return;
default:
...
static T_6 F_44 ( int V_39 , void * V_67 )
{
struct V_11 * V_12 = (struct V_11 * ) V_67 ;
struct V_23 * V_24 ;
while ( ( V_24 = F_35 ( V_12 ) ) != NULL ) {
F_37 ( V_24 , V_12 ) ;
V_24 -> V_28 = 0 ;
F_45 () ;
}
...
if ( F_48 ( V_8 ) )
return F_49 ( V_8 ) ;
V_12 = F_50 ( sizeof( struct V_11 ) , V_74 ) ;
if ( ! V_12 ) {
F_5 ( V_13 , L_21 ) ;
goto V_75;
}
...
V_12 -> V_2 = V_1 ;
V_56 = & V_12 -> V_45 ;
V_56 -> V_46 = (struct V_23 * ) F_51 ( V_74 ) ;
if ( ! V_56 -> V_46 ) {
F_5 ( V_13 , L_22 ) ;
goto V_75;
}
V_56 -> V_58 = V_43 / sizeof( * V_56 -> V_46 ) ;
V_12 -> V_42 = F_40 ( V_13 , V_56 -> V_46 ,
V_43 ,
V_44 ) ;
if ( F_41 ( V_13 , V_12 -> V_42 ) ) {
F_5 ( V_13 , L_23 ) ;
goto V_75;
}
