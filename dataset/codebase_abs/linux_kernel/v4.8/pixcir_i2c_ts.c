...
V_65 = F_43 ( F_44 ( V_66 ) , V_18 ) ;
if ( ! V_65 )
return - V_67 ;
V_2 -> V_14 = ( const struct V_13 * ) V_65 -> V_68 ;
if ( ! V_2 -> V_14 )
return - V_67 ;
return 0 ;
}
...
static int F_45 ( struct V_60 * V_17 ,
...
V_29 -> V_79 = F_32 ;
V_29 -> V_80 = F_34 ;
V_29 -> V_18 . V_81 = & V_17 -> V_18 ;
if ( V_72 ) {
F_49 ( V_29 , V_31 , 0 , V_72 -> V_82 , 0 , 0 ) ;
F_49 ( V_29 , V_33 , 0 , V_72 -> V_83 , 0 , 0 ) ;
} else {
F_50 ( V_29 , V_84 , V_31 ) ;
F_50 ( V_29 , V_84 , V_33 ) ;
F_51 ( V_29 , true , & V_2 -> V_22 ) ;
if ( ! F_52 ( V_29 , V_31 ) ||
! F_52 ( V_29 , V_33 ) ) {
F_3 ( V_18 , L_15 ) ;
return - V_67 ;
...
F_55 ( V_29 , V_2 ) ;
V_2 -> V_38 = F_56 ( V_18 , L_18 , V_87 ) ;
if ( F_57 ( V_2 -> V_38 ) ) {
error = F_58 ( V_2 -> V_38 ) ;
F_3 ( V_18 , L_19 , error ) ;
return error ;
}
V_2 -> V_40 = F_59 ( V_18 , L_20 ,
V_88 ) ;
if ( F_57 ( V_2 -> V_40 ) ) {
error = F_58 ( V_2 -> V_40 ) ;
F_3 ( V_18 , L_21 , error ) ;
...
if ( V_2 -> V_57 )
F_18 ( 100 ) ;
error = F_60 ( V_18 , V_17 -> V_35 , NULL , F_16 ,
V_91 | V_92 ,
V_17 -> V_76 , V_2 ) ;
if ( error ) {
