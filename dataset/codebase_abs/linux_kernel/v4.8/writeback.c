...
struct V_41 * V_42 = V_44 -> V_46 . V_53 ;
F_21 ( V_42 ) ;
F_50 ( & V_44 -> V_46 , V_72 , 0 ) ;
V_44 -> V_46 . V_48 . V_73 = F_51 ( & V_42 -> V_50 ) ;
V_44 -> V_46 . V_74 = V_44 -> V_2 -> V_13 ;
V_44 -> V_46 . V_75 = F_47 ;
F_52 ( & V_44 -> V_46 , V_57 ) ;
F_53 ( V_57 , F_30 , V_76 ) ;
}
static void F_54 ( struct V_46 * V_46 )
{
struct V_41 * V_42 = V_46 -> V_53 ;
struct V_43 * V_44 = V_42 -> V_45 ;
F_55 ( F_56 ( V_44 -> V_2 -> V_5 . V_4 , & V_42 -> V_50 , 0 ) ,
V_46 -> V_71 , L_1 ) ;
F_47 ( V_46 ) ;
}
...
V_44 -> V_2 = V_2 ;
F_21 ( V_42 ) ;
F_50 ( & V_44 -> V_46 , V_81 , 0 ) ;
V_44 -> V_46 . V_48 . V_73 = F_68 ( & V_42 -> V_50 , 0 ) ;
V_44 -> V_46 . V_74 = F_56 ( V_2 -> V_5 . V_4 ,
& V_42 -> V_50 , 0 ) -> V_13 ;
V_44 -> V_46 . V_75 = F_54 ;
...
{
struct V_1 * V_2 = F_12 ( V_98 , struct V_1 , V_69 ) ;
F_62 ( F_81 ( V_100 ) != V_2 -> V_5 . V_101 ) ;
return F_33 ( V_100 ) ;
}
static void F_82 ( struct V_1 * V_2 )
{
struct V_97 * V_98 = & V_2 -> V_69 ;
unsigned V_102 , V_90 , V_103 ;
bool V_104 = false ;
V_90 = F_75 ( & V_2 -> V_5 , F_66 ( & V_98 -> V_105 ) ) ;
if ( V_90 >= V_2 -> V_5 . V_94 )
V_90 = 0 ;
V_102 = V_90 ;
while ( 1 ) {
V_90 = F_83 ( V_2 -> V_5 . V_96 ,
V_2 -> V_5 . V_94 , V_90 ) ;
if ( V_90 == V_2 -> V_5 . V_94 )
goto V_25;
V_103 = F_84 ( V_2 -> V_5 . V_96 ,
V_2 -> V_5 . V_94 , V_90 ) ;
V_98 -> V_105 = F_85 ( V_2 -> V_5 . V_101 ,
V_90 * V_2 -> V_5 . V_92 , 0 ) ;
F_86 ( V_2 -> V_5 . V_4 , V_98 ,
& F_85 ( V_2 -> V_5 . V_101 ,
V_103 * V_2 -> V_5 . V_92 , 0 ) ,
F_80 ) ;
if ( F_87 ( & V_98 -> V_106 ) )
return;
V_90 = V_103 ;
...
{
struct V_97 * V_98 = & V_2 -> V_69 ;
struct V_99 V_107 = F_85 ( V_2 -> V_5 . V_101 , 0 , 0 ) ;
struct V_99 V_108 = F_85 ( V_2 -> V_5 . V_101 , V_109 , 0 ) ;
struct V_99 V_110 ;
if ( F_89 ( & V_98 -> V_105 , & V_107 ) < 0 ||
F_89 ( & V_98 -> V_105 , & V_108 ) > 0 )
V_98 -> V_105 = V_107 ;
if ( V_2 -> V_111 ) {
F_82 ( V_2 ) ;
if ( F_87 ( & V_98 -> V_106 ) )
...
V_110 = V_98 -> V_105 ;
F_86 ( V_2 -> V_5 . V_4 , V_98 , & V_108 , F_80 ) ;
if ( F_89 ( & V_98 -> V_105 , & V_108 ) < 0 )
return false ;
V_98 -> V_105 = V_107 ;
F_86 ( V_2 -> V_5 . V_4 , V_98 , & V_110 , F_80 ) ;
return F_89 ( & V_98 -> V_105 , & V_110 ) >= 0 ;
}
static int F_90 ( void * V_112 )
{
...
static int F_101 ( struct V_117 * V_118 , struct V_119 * V_120 ,
struct V_99 * V_100 )
{
struct V_121 * V_122 = F_12 ( V_118 ,
struct V_121 , V_122 ) ;
if ( F_81 ( V_100 ) > V_122 -> V_83 )
return V_123 ;
if ( F_33 ( V_100 ) )
F_74 ( V_120 -> V_4 , F_81 ( V_100 ) ,
F_51 ( V_100 ) , F_25 ( V_100 ) ) ;
return V_124 ;
}
...
struct V_121 V_122 ;
F_103 ( & V_122 . V_122 , - 1 ) ;
V_122 . V_83 = V_2 -> V_5 . V_101 ;
F_104 ( & V_122 . V_122 , V_2 -> V_5 . V_4 , & F_85 ( V_122 . V_83 , 0 , 0 ) ,
F_101 , 0 ) ;
...
{
V_2 -> V_126 = F_111 ( F_90 , V_2 ,
L_2 ) ;
if ( F_112 ( V_2 -> V_126 ) )
return F_113 ( V_2 -> V_126 ) ;
F_17 ( & V_2 -> V_34 ,
V_2 -> V_20 * V_37 ) ;
F_114 ( V_2 ) ;
return 0 ;
