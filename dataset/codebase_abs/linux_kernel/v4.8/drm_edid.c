...
if ( ! V_12 || ! V_39 )
return 0 ;
F_46 ( ( T_1 * ) V_12 , F_131 , & V_283 ) ;
for ( V_284 = 0 ; V_283 && V_284 < 13 ; V_284 ++ ) {
if ( V_283 [ V_284 ] == 0x0a )
break;
V_39 [ V_284 ] = V_283 [ V_284 ] ;
}
return V_284 ;
}
void F_133 ( struct V_12 * V_12 , char * V_39 , int V_285 )
{
int V_286 ;
char V_22 [ 13 ] ;
if ( V_285 <= 0 )
return;
V_286 = F_45 ( F_132 ( V_12 , V_22 ) , V_285 - 1 ) ;
memcpy ( V_39 , V_22 , V_286 ) ;
V_39 [ V_286 ] = '\0' ;
}
...
V_284 = F_132 ( V_12 , V_275 + 20 ) ;
V_275 [ 4 ] = ( V_264 [ 1 ] << 5 ) | V_284 ;
F_14 ( L_25 , V_275 + 20 ) ;
V_275 [ 0 ] = 2 << 3 ;
V_275 [ 16 ] = V_12 -> V_56 [ 0 ] ;
V_275 [ 17 ] = V_12 -> V_56 [ 1 ] ;
V_275 [ 18 ] = V_12 -> V_288 [ 0 ] ;
V_275 [ 19 ] = V_12 -> V_288 [ 1 ] ;
if ( F_125 ( V_264 ) >= 3 ) {
int V_2 , V_26 , V_265 ;
if ( F_126 ( V_264 , & V_26 , & V_265 ) ) {
V_26 = 0 ;
...
int V_289 ;
case V_290 :
V_289 = F_45 ( V_272 / 3 , 15 - V_287 ) ;
if ( V_289 >= 1 )
memcpy ( V_275 + 20 + V_284 + V_287 * 3 ,
& V_241 [ 1 ] , V_289 * 3 ) ;
V_287 += V_289 ;
break;
case V_291 :
...
int F_138 ( struct V_12 * V_12 , struct V_293 * * V_294 )
{
int V_295 = 0 ;
...
F_129 (cea, i, start, end) {
T_1 * V_241 = & V_264 [ V_2 ] ;
if ( F_124 ( V_241 ) == V_290 ) {
int V_42 ;
V_272 = F_123 ( V_241 ) ;
V_295 = V_272 / 3 ;
* V_294 = F_139 ( V_295 , sizeof( * * V_294 ) , V_48 ) ;
if ( ! * V_294 )
return - V_299 ;
for ( V_42 = 0 ; V_42 < V_295 ; V_42 ++ ) {
T_1 * V_300 = & V_241 [ 1 + V_42 * 3 ] ;
( * V_294 ) [ V_42 ] . V_301 = ( V_300 [ 0 ] & 0x78 ) >> 3 ;
( * V_294 ) [ V_42 ] . V_302 = V_300 [ 0 ] & 0x7 ;
( * V_294 ) [ V_42 ] . V_303 = V_300 [ 1 ] & 0x7F ;
( * V_294 ) [ V_42 ] . V_304 = V_300 [ 2 ] ;
}
break;
}
}
...
int F_140 ( struct V_12 * V_12 , T_1 * * V_305 )
{
int V_295 = 0 ;
int V_2 , V_26 , V_265 , V_272 ;
const T_1 * V_264 ;
...
if ( F_124 ( V_241 ) == V_291 ) {
V_272 = F_123 ( V_241 ) ;
if ( V_272 == 3 ) {
* V_305 = F_28 ( & V_241 [ 1 ] , V_272 , V_48 ) ;
if ( ! * V_305 )
return - V_299 ;
V_295 = V_272 ;
break;
...
V_306 = V_41 -> V_279 [ V_2 ] ;
if ( V_110 == 255 || V_306 == 255 )
return 0 ;
if ( V_110 )
V_110 = F_45 ( 2 * ( V_110 - 1 ) , 500 ) ;
if ( V_306 )
V_306 = F_45 ( 2 * ( V_306 - 1 ) , 500 ) ;
return F_142 ( V_306 - V_110 , 0 ) ;
}
struct V_40 * F_143 ( struct V_307 * V_308 )
{
struct V_40 * V_41 ;
struct V_82 * V_52 = V_308 -> V_52 ;
F_6 ( ! F_144 ( & V_52 -> V_309 . V_310 ) ) ;
F_6 ( ! F_145 ( & V_52 -> V_309 . V_311 ) ) ;
F_146 (connector, dev)
if ( V_41 -> V_308 == V_308 && V_41 -> V_275 [ 0 ] )
return V_41 ;
return NULL ;
}
...
if ( F_124 ( & V_221 [ V_2 ] ) == V_316 &&
F_123 ( & V_221 [ V_2 ] ) == 2 ) {
F_14 ( L_32 , V_221 [ V_2 + 2 ] ) ;
return V_221 [ V_2 + 2 ] & V_317 ;
}
}
return false ;
}
static bool F_150 ( struct V_12 * V_12 ,
struct V_318 * V_319 ,
struct V_40 * V_41 )
{
T_1 * V_221 , * V_270 ;
...
static void F_151 ( struct V_12 * V_12 ,
struct V_318 * V_319 ,
struct V_40 * V_41 )
{
T_1 * V_221 ;
V_319 -> V_166 = V_12 -> V_173 * 10 ;
V_319 -> V_169 = V_12 -> V_174 * 10 ;
V_319 -> V_321 = 0 ;
V_319 -> V_326 = 0 ;
if ( V_12 -> V_16 < 3 )
return;
...
F_150 ( V_12 , V_319 , V_41 ) ;
if ( ( V_319 -> V_321 == 0 ) && ( V_12 -> V_16 < 4 ) &&
( V_12 -> V_102 & V_334 ) ) {
V_319 -> V_321 = 8 ;
F_7 ( L_40 ,
V_41 -> V_39 , V_319 -> V_321 ) ;
}
if ( V_12 -> V_16 < 4 )
return;
switch ( V_12 -> V_102 & V_335 ) {
case V_336 :
V_319 -> V_321 = 6 ;
break;
case V_337 :
...
static int F_152 ( T_1 * V_345 , int V_8 , int V_346 )
{
int V_2 ;
T_1 V_5 = 0 ;
struct V_347 * V_348 ;
V_348 = (struct V_347 * ) & V_345 [ V_346 ] ;
F_14 ( L_42 ,
V_348 -> V_349 , V_348 -> V_350 , V_348 -> V_351 , V_348 -> V_352 ) ;
if ( V_348 -> V_350 + 5 > V_8 - V_346 )
return - V_353 ;
for ( V_2 = V_346 ; V_2 <= V_348 -> V_350 + 5 ; V_2 ++ ) {
V_5 += V_345 [ V_2 ] ;
}
if ( V_5 ) {
F_8 ( L_43 , V_5 ) ;
...
static struct V_62 * F_153 ( struct V_82 * V_52 ,
struct V_354 * V_206 )
{
struct V_62 * V_75 ;
...
unsigned V_355 = ( V_206 -> V_356 [ 0 ] | V_206 -> V_356 [ 1 ] << 8 ) + 1 ;
...
unsigned V_357 = ( V_206 -> V_358 [ 0 ] | V_206 -> V_358 [ 1 ] << 8 ) + 1 ;
bool V_359 = ( V_206 -> V_176 [ 1 ] >> 7 ) & 0x1 ;
bool V_360 = ( V_206 -> V_179 [ 1 ] >> 7 ) & 0x1 ;
V_75 = F_66 ( V_52 ) ;
if ( ! V_75 )
return NULL ;
V_75 -> clock = V_158 * 10 ;
...
V_75 -> V_78 = V_75 -> V_79 + V_355 ;
V_75 -> V_76 = V_75 -> V_77 + V_141 ;
V_75 -> V_81 = V_138 ;
V_75 -> V_80 = V_75 -> V_81 + V_179 ;
V_75 -> V_130 = V_75 -> V_80 + V_357 ;
V_75 -> V_131 = V_75 -> V_81 + V_143 ;
V_75 -> V_35 = 0 ;
V_75 -> V_35 |= V_359 ? V_162 : V_163 ;
V_75 -> V_35 |= V_360 ? V_164 : V_165 ;
V_75 -> type = V_175 ;
if ( V_206 -> V_35 & 0x80 )
V_75 -> type |= V_73 ;
V_75 -> V_74 = F_38 ( V_75 ) ;
...
struct V_361 * V_9 )
{
struct V_362 * V_363 = (struct V_362 * ) V_9 ;
int V_2 ;
int V_364 ;
struct V_62 * V_185 ;
int V_365 = 0 ;
...
return 0 ;
V_364 = V_9 -> V_366 / 20 ;
for ( V_2 = 0 ; V_2 < V_364 ; V_2 ++ ) {
struct V_354 * V_206 = & V_363 -> V_206 [ V_2 ] ;
V_185 = F_153 ( V_41 -> V_52 , V_206 ) ;
if ( ! V_185 )
continue;
F_76 ( V_41 , V_185 ) ;
V_365 ++ ;
...
if ( ! V_345 )
return 0 ;
V_29 = F_152 ( V_345 , V_8 , V_346 ) ;
if ( V_29 )
return 0 ;
V_346 += sizeof( struct V_347 ) ;
while ( V_9 = (struct V_361 * ) & V_345 [ V_346 ] ,
V_346 + sizeof( struct V_361 ) <= V_8 &&
V_346 + sizeof( struct V_361 ) + V_9 -> V_366 <= V_8 &&
V_9 -> V_366 > 0 ) {
V_346 += V_9 -> V_366 + sizeof( struct V_361 ) ;
switch ( V_9 -> V_367 ) {
case V_368 :
V_365 += F_154 ( V_41 , V_9 ) ;
break;
}
}
return V_365 ;
}
int F_156 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
int V_365 = 0 ;
T_3 V_61 ;
if ( V_12 == NULL ) {
...
V_61 = F_30 ( V_12 ) ;
V_365 += F_93 ( V_41 , V_12 , V_61 ) ;
V_365 += F_90 ( V_41 , V_12 ) ;
V_365 += F_87 ( V_41 , V_12 ) ;
V_365 += F_85 ( V_41 , V_12 ) ;
V_365 += F_128 ( V_41 , V_12 ) ;
V_365 += F_110 ( V_41 , V_12 ) ;
V_365 += F_155 ( V_41 , V_12 ) ;
if ( V_12 -> V_104 & V_105 )
V_365 += F_82 ( V_41 , V_12 ) ;
if ( V_61 & ( V_70 | V_71 ) )
F_33 ( V_41 , V_61 ) ;
F_151 ( V_12 , & V_41 -> V_369 , V_41 ) ;
if ( V_61 & V_370 )
V_41 -> V_369 . V_321 = 6 ;
if ( V_61 & V_371 )
V_41 -> V_369 . V_321 = 8 ;
...
int F_157 ( struct V_40 * V_41 ,
int V_77 , int V_81 )
{
int V_2 , V_295 , V_365 = 0 ;
struct V_62 * V_75 ;
struct V_82 * V_52 = V_41 -> V_52 ;
V_295 = F_31 ( V_87 ) ;
if ( V_77 < 0 )
...
V_414 = F_165 ( V_41 -> V_52 , V_408 -> V_422 ) ;
if ( ! V_414 ) {
V_414 = F_166 ( V_41 -> V_52 , V_408 -> V_422 ) ;
}
if ( ! V_414 )
return - V_299 ;
if ( V_41 -> V_423 != V_414 ) {
if ( V_41 -> V_423 ) {
F_167 ( V_41 -> V_52 , V_41 -> V_423 ) ;
}
V_41 -> V_423 = V_414 ;
} else
F_167 ( V_41 -> V_52 , V_414 ) ;
return 0 ;
}
static int F_168 ( struct V_40 * V_41 ,
T_1 * V_345 , int V_8 ,
bool V_424 )
{
int V_346 = 0 ;
...
V_29 = F_168 ( V_41 , V_345 , V_6 , true ) ;
if ( V_29 < 0 )
goto V_426;
if ( ! V_41 -> V_417 )
goto V_426;
