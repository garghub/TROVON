...
V_53 = F_20 ( V_14 -> V_30 . V_64 , & V_52 ) ;
V_55 = F_21 ( V_52 , V_53 ) ;
V_45 = F_22 ( V_16 , V_14 , V_39 , V_40 , V_55 ) ;
if ( V_45 != 0 ) {
if ( V_14 -> V_65 & V_66 )
V_45 = ( V_16 -> V_27 & V_67 ) ? 0 : - V_68 ;
goto V_62;
}
if ( ! V_19 )
V_19 = F_8 ( & V_14 -> V_30 , & V_18 ) ;
...
V_52 , V_53 , V_49 ) ;
if ( V_47 & V_63 )
V_45 = F_24 ( V_43 , V_16 , V_14 , V_19 ,
V_52 , V_53 , V_44 ) ;
if ( V_47 & V_69 )
F_25 ( V_16 , V_19 ) ;
V_62:
if ( ( V_41 & V_70 ) && ( V_16 -> V_27 & V_71 ) &&
! ( V_16 -> V_27 & V_33 ) )
V_45 = - V_68 ;
F_26 ( V_52 ) ;
V_59:
...
V_11:
F_13 ( V_20 ) ;
if ( ( V_45 && V_48 ) && ( V_72 & V_73 ) )
return - V_68 ;
return 0 ;
}
int F_28 ( struct V_14 * V_14 , unsigned long V_74 )
{
if ( V_14 && ( V_74 & V_75 ) )
return F_16 ( V_14 , NULL , 0 , V_76 ,
V_57 , 0 ) ;
return 0 ;
}
int F_29 ( struct V_77 * V_78 )
{
return F_16 ( V_78 -> V_14 , NULL , 0 , V_76 ,
V_79 , 0 ) ;
}
int F_30 ( struct V_14 * V_14 , int V_41 , int V_44 )
{
return F_16 ( V_14 , NULL , 0 ,
V_41 & ( V_80 | V_70 | V_76 ) ,
V_56 , V_44 ) ;
}
void F_31 ( struct V_64 * V_64 )
{
struct V_15 * V_16 ;
struct V_20 * V_20 = V_64 -> V_81 ;
int V_48 ;
V_48 = F_32 ( V_20 , V_82 , V_56 ) ;
if ( ! V_48 )
return;
V_16 = F_18 ( V_20 ) ;
if ( V_16 )
...
int F_33 ( struct V_14 * V_14 , enum V_83 V_84 )
{
if ( ! V_14 && V_84 == V_85 ) {
#ifndef F_34
if ( ( V_72 & V_86 ) &&
...
int F_35 ( struct V_14 * V_14 , void * V_39 , T_3 V_40 ,
enum V_83 V_84 )
{
enum V_42 V_43 ;
if ( ! V_14 && V_84 == V_87 ) {
...
V_43 = V_89 [ V_84 ] ? : V_56 ;
return F_16 ( V_14 , V_39 , V_40 , V_80 , V_43 , 0 ) ;
}
