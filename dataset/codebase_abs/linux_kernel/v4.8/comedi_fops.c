...
static int F_126 ( struct V_32 * V_32 , struct V_254 * V_259 )
{
struct V_33 * V_34 = V_32 -> V_35 ;
struct V_1 * V_2 = V_34 -> V_2 ;
struct V_21 * V_22 ;
...
unsigned long V_260 = V_259 -> V_261 ;
unsigned long V_59 ;
int V_262 ;
int V_15 ;
int V_44 ;
...
V_262 = V_59 >> V_267 ;
V_257 = F_129 ( V_22 ) ;
if ( ! V_257 || V_262 > V_257 -> V_262 ) {
V_44 = - V_64 ;
goto V_237;
}
for ( V_15 = 0 ; V_15 < V_262 ; ++ V_15 ) {
struct V_268 * V_57 = & V_257 -> V_269 [ V_15 ] ;
if ( F_130 ( V_259 , V_260 ,
F_131 ( F_132 ( V_57 -> V_270 ) ) ,
V_49 , V_271 ) ) {
V_44 = - V_195 ;
goto V_237;
}
...
static unsigned int F_134 ( struct V_32 * V_32 , T_4 * V_275 )
{
unsigned int V_67 = 0 ;
struct V_33 * V_34 = V_32 -> V_35 ;
struct V_1 * V_2 = V_34 -> V_2 ;
struct V_21 * V_22 , * V_276 ;
F_135 ( & V_2 -> V_6 ) ;
if ( ! V_2 -> V_12 ) {
F_40 ( V_2 -> V_9 , L_35 ) ;
goto V_237;
...
V_276 = V_22 ;
if ( V_22 && V_22 -> V_43 ) {
F_136 ( V_32 , & V_22 -> V_43 -> V_78 , V_275 ) ;
...
static T_1 F_139 ( struct V_32 * V_32 , const char T_3 * V_57 ,
T_2 V_282 , T_5 * V_283 )
{
struct V_21 * V_22 ;
struct V_42 * V_43 ;
unsigned int V_154 , V_284 ;
T_1 V_61 = 0 ;
int V_44 = 0 ;
F_140 ( V_275 , V_285 ) ;
struct V_33 * V_34 = V_32 -> V_35 ;
...
V_288 = V_43 -> V_148 ;
V_289 = F_146 ( V_154 , V_43 -> V_53 - V_288 ) ;
V_290 = V_154 - V_289 ;
V_284 = F_77 ( V_43 -> V_295 + V_288 , V_57 , V_289 ) ;
if ( V_284 )
V_284 += V_290 ;
else if ( V_290 )
V_284 = F_77 ( V_43 -> V_295 , V_57 + V_289 , V_290 ) ;
if ( V_284 ) {
V_154 -= V_284 ;
V_44 = - V_87 ;
}
...
static T_1 F_148 ( struct V_32 * V_32 , char T_3 * V_57 , T_2 V_282 ,
T_5 * V_283 )
{
struct V_21 * V_22 ;
struct V_42 * V_43 ;
...
F_141 ( & V_43 -> V_78 , & V_275 ) ;
while ( V_61 == 0 && ! V_44 ) {
unsigned int V_298 , V_289 , V_290 ;
F_142 ( V_291 ) ;
V_284 = F_92 ( V_22 ) ;
V_154 = F_144 ( T_2 , V_284 , V_282 ) ;
if ( V_154 == 0 ) {
...
V_298 = V_43 -> V_150 ;
V_289 = F_146 ( V_154 , V_43 -> V_53 - V_298 ) ;
V_290 = V_154 - V_289 ;
V_284 = F_81 ( V_57 , V_43 -> V_295 + V_298 , V_289 ) ;
if ( V_284 )
V_284 += V_290 ;
else if ( V_290 )
V_284 = F_81 ( V_57 + V_289 , V_43 -> V_295 , V_290 ) ;
if ( V_284 ) {
V_154 -= V_284 ;
V_44 = - V_87 ;
}
...
static int F_149 ( struct V_299 * V_299 , struct V_32 * V_32 )
{
const unsigned int V_7 = F_32 ( V_299 ) ;
struct V_33 * V_34 ;
...
static int F_152 ( int V_301 , struct V_32 * V_32 , int V_302 )
{
struct V_33 * V_34 = V_32 -> V_35 ;
struct V_1 * V_2 = V_34 -> V_2 ;
return F_153 ( V_301 , V_32 , V_302 , & V_2 -> V_303 ) ;
}
static int F_154 ( struct V_299 * V_299 , struct V_32 * V_32 )
{
struct V_33 * V_34 = V_32 -> V_35 ;
struct V_1 * V_2 = V_34 -> V_2 ;
...
void F_155 ( struct V_1 * V_2 , struct V_21 * V_22 )
{
struct V_42 * V_43 = V_22 -> V_43 ;
unsigned int V_305 ;
int V_306 = 0 ;
...
if ( V_43 -> V_225 & V_305 ) {
F_156 ( & V_43 -> V_78 ) ;
V_306 = V_43 -> V_76 . V_68 & V_143 ? V_308 : V_309 ;
}
F_57 ( & V_22 -> V_69 , V_68 ) ;
if ( V_306 )
F_157 ( & V_2 -> V_303 , V_310 , V_306 ) ;
}
struct V_1 * F_158 ( struct V_26 * V_311 )
{
struct V_1 * V_2 ;
struct V_26 * V_54 ;
unsigned int V_15 ;
...
V_2 -> V_7 = V_15 ;
V_54 = F_161 ( V_19 , V_311 ,
F_24 ( V_20 , V_15 ) , NULL , L_40 , V_15 ) ;
if ( ! F_110 ( V_54 ) )
V_2 -> V_9 = F_162 ( V_54 ) ;
return V_2 ;
}
void F_163 ( struct V_26 * V_311 )
{
int V_7 ;
struct V_1 * V_2 ;
...
V_44 = F_170 ( F_24 ( V_20 , 0 ) ,
V_314 , L_46 ) ;
if ( V_44 )
return - V_198 ;
F_171 ( & V_316 , & V_317 ) ;
V_316 . V_318 = V_319 ;
V_44 = F_172 ( & V_316 . V_320 , L_46 ) ;
if ( V_44 ) {
F_173 ( F_24 ( V_20 , 0 ) ,
V_314 ) ;
return V_44 ;
}
if ( F_174 ( & V_316 , F_24 ( V_20 , 0 ) , V_314 ) ) {
F_173 ( F_24 ( V_20 , 0 ) ,
V_314 ) ;
return - V_198 ;
}
V_19 = F_175 ( V_319 , L_46 ) ;
if ( F_110 ( V_19 ) ) {
F_169 ( L_47 ) ;
F_176 ( & V_316 ) ;
F_173 ( F_24 ( V_20 , 0 ) ,
