...
void * T_7 F_41 ( T_4 V_40 , T_5 V_41 )
{
...
void T_7 F_46 ( void T_6 * V_43 , T_5 V_41 )
{
struct V_39 * V_42 ;
if ( ! V_54 ) {
F_47 ( V_43 , V_41 ) ;
...
void T_7 F_49 ( void * V_43 , T_5 V_41 )
{
...
static T_10 F_57 ( int V_72 , void * V_73 )
{
T_11 V_74 ;
V_74 = (* F_58) ( V_75 ) ;
if ( V_74 ) {
...
T_8 F_75 ( T_13 V_93 , T_11 * V_94 , T_11 V_95 )
{
T_11 V_96 ;
if ( ! V_94 )
V_94 = & V_96 ;
...
T_8 F_80 ( T_13 V_93 , T_11 V_94 , T_11 V_95 )
{
if ( V_95 <= 8 ) {
F_81 ( V_94 , V_93 ) ;
} else if ( V_95 <= 16 ) {
...
T_8
F_84 ( T_4 V_99 , T_2 * V_94 , T_11 V_95 )
{
void T_6 * V_100 ;
...
T_8
F_91 ( T_4 V_99 , T_2 V_94 , T_11 V_95 )
{
void T_6 * V_100 ;
unsigned int V_41 = V_95 / 8 ;
bool V_101 = false ;
...
T_8
F_96 ( struct V_103 * V_104 , T_11 V_105 ,
T_2 * V_94 , T_11 V_95 )
{
int V_106 , V_41 ;
T_11 V_107 ;
...
T_8
F_99 ( struct V_103 * V_104 , T_11 V_105 ,
T_2 V_94 , T_11 V_95 )
{
int V_106 , V_41 ;
switch ( V_95 ) {
...
int F_105 ( T_14 V_112 , void * V_82 )
{
int V_121 ;
int (* F_106)( T_14 , void * );
struct V_117 * V_118 ;
...
T_15 F_10 ( const char * V_129 )
{
T_15 V_121 ;
T_15 (* F_106)( const char * );
struct V_117 * V_118 ;
if ( ! V_126 )
return - V_127 ;
F_22 ( & V_122 . V_123 ) ;
...
T_15 F_109 ( char * V_26 , T_16 V_131 )
{
T_15 V_121 ;
T_15 (* F_106)( char * , T_16 );
struct V_117 * V_118 ;
if ( ! V_126 )
return - V_127 ;
F_22 ( & V_122 . V_123 ) ;
