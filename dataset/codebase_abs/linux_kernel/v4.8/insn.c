...
V_30 = F_20 ( V_1 ) ;
V_31 = F_21 ( V_1 ) ;
V_1 -> V_12 = F_22 ( V_28 , V_30 , V_31 ) ;
if ( ( F_23 ( V_1 -> V_12 ) && ! F_24 ( V_1 ) ) ||
( ! F_25 ( V_1 -> V_12 ) &&
! F_26 ( V_1 -> V_12 ) ) )
V_1 -> V_12 = 0 ;
goto V_32;
...
V_29 = F_28 ( V_1 ) ;
V_1 -> V_12 = F_29 ( V_28 , V_29 , V_1 -> V_12 ) ;
}
if ( F_30 ( V_1 -> V_12 ) )
V_1 -> V_12 = 0 ;
V_32:
...
if ( F_26 ( V_1 -> V_12 ) ) {
V_29 = F_28 ( V_1 ) ;
V_1 -> V_12 = F_33 ( V_34 , V_29 ,
V_1 -> V_12 ) ;
if ( F_19 ( V_1 ) && ! F_25 ( V_1 -> V_12 ) )
V_1 -> V_12 = 0 ;
}
}
if ( V_1 -> V_4 && F_34 ( V_1 -> V_12 ) )
V_1 -> V_8 = 8 ;
V_33 -> V_17 = 1 ;
V_26:
return;
...
if ( V_1 -> V_9 != 2 &&
F_13 ( V_33 ) != 3 && F_37 ( V_33 ) == 4 ) {
V_1 -> V_35 . V_22 = F_18 ( T_2 , V_1 ) ;
V_1 -> V_35 . V_20 = 1 ;
}
}
V_1 -> V_35 . V_17 = 1 ;
...
V_36 = F_37 ( V_1 -> V_33 . V_22 ) ;
V_37 = F_39 ( V_1 -> V_35 . V_22 ) ;
if ( V_34 == 3 )
goto V_39;
if ( V_34 == 1 ) {
V_1 -> V_38 . V_22 = F_18 (signed char, insn) ;
V_1 -> V_38 . V_20 = 1 ;
} else if ( V_1 -> V_9 == 2 ) {
...
switch ( V_1 -> V_9 ) {
case 2 :
V_1 -> V_40 . V_22 = F_18 ( short , V_1 ) ;
V_1 -> V_40 . V_20 = 2 ;
break;
case 4 :
V_1 -> V_40 . V_22 = F_18 ( int , V_1 ) ;
V_1 -> V_40 . V_20 = 4 ;
break;
case 8 :
V_1 -> V_40 . V_22 = F_18 ( int , V_1 ) ;
V_1 -> V_40 . V_20 = 4 ;
V_1 -> V_41 . V_22 = F_18 ( int , V_1 ) ;
V_1 -> V_41 . V_20 = 4 ;
break;
default:
goto V_26;
...
switch ( V_1 -> V_8 ) {
case 2 :
V_1 -> V_42 . V_22 = F_18 ( short , V_1 ) ;
V_1 -> V_42 . V_20 = 2 ;
break;
case 4 :
case 8 :
V_1 -> V_42 . V_22 = F_18 ( int , V_1 ) ;
V_1 -> V_42 . V_20 = 4 ;
break;
default:
goto V_26;
...
switch ( V_1 -> V_8 ) {
case 2 :
V_1 -> V_43 . V_22 = F_18 ( short , V_1 ) ;
V_1 -> V_43 . V_20 = 2 ;
break;
case 4 :
V_1 -> V_43 . V_22 = F_18 ( int , V_1 ) ;
V_1 -> V_43 . V_20 = 4 ;
break;
case 8 :
V_1 -> V_43 . V_22 = F_18 ( int , V_1 ) ;
V_1 -> V_43 . V_20 = 4 ;
V_1 -> V_44 . V_22 = F_18 ( int , V_1 ) ;
V_1 -> V_44 . V_20 = 4 ;
break;
default:
goto V_26;
...
V_1 -> V_44 . V_22 = F_18 (unsigned short, insn) ;
V_1 -> V_44 . V_20 = 2 ;
V_1 -> V_43 . V_17 = V_1 -> V_44 . V_17 = 1 ;
return 1 ;
V_26:
...
if ( ! F_46 ( V_1 -> V_12 ) )
goto V_45;
switch ( F_47 ( V_1 -> V_12 ) ) {
case V_46 :
V_1 -> V_42 . V_22 = F_18 (signed char, insn) ;
V_1 -> V_42 . V_20 = 1 ;
break;
case V_47 :
V_1 -> V_42 . V_22 = F_18 ( short , V_1 ) ;
...
if ( F_48 ( V_1 -> V_12 ) ) {
V_1 -> V_44 . V_22 = F_18 (signed char, insn) ;
V_1 -> V_44 . V_20 = 1 ;
}
V_45:
V_1 -> V_42 . V_17 = 1 ;
