...
if ( F_29 ( V_63 ) == - V_66 || V_59 != sizeof( * V_63 ) ) {
F_38 ( V_5 -> V_52 , L_8 ) ;
V_5 -> V_60 = V_67 ;
V_5 -> V_16 = V_68 ;
return 0 ;
...
T_1 V_74 ;
int V_55 ;
V_5 = F_41 ( & V_70 -> V_52 , sizeof( * V_5 ) , V_75 ) ;
if ( ! V_5 )
return - V_58 ;
V_5 -> V_52 = & V_70 -> V_52 ;
F_42 ( & V_5 -> V_13 ) ;
...
if ( V_55 )
return V_55 ;
V_5 -> V_76 = F_43 ( & V_70 -> V_52 ,
V_5 -> V_60 ,
sizeof( struct V_23 ) ,
V_75 ) ;
if ( ! V_5 -> V_76 )
return - V_58 ;
V_5 -> V_17 = F_43 ( & V_70 -> V_52 ,
V_5 -> V_16 ,
sizeof( struct V_6 ) ,
V_75 ) ;
if ( ! V_5 -> V_17 )
return - V_58 ;
V_71 = F_44 ( V_70 -> V_52 . V_53 , L_11 ) ;
if ( ! V_71 ) {
F_31 ( & V_70 -> V_52 , L_12 ) ;
return - V_39 ;
}
...
V_73 = F_37 ( V_64 , V_77 , NULL ) ;
if ( F_28 ( V_73 ) ) {
F_31 ( & V_70 -> V_52 , L_15 ) ;
return F_29 ( V_73 ) ;
}
V_59 = V_5 -> V_60 * V_5 -> V_16 * sizeof( T_1 ) ;
V_55 = F_46 ( V_64 , V_79 , V_59 ) ;
if ( V_55 < 0 && V_55 != - V_78 ) {
F_31 ( & V_70 -> V_52 , L_16 ) ;
return V_55 ;
}
V_72 = F_37 ( V_64 , V_79 , NULL ) ;
if ( F_28 ( V_72 ) ) {
F_31 ( & V_70 -> V_52 , L_17 ) ;
return F_29 ( V_72 ) ;
}
V_5 -> V_14 = V_73 + V_5 -> V_36 ;
V_5 -> V_18 = V_72 + V_5 -> V_36 * V_5 -> V_16 ;
V_5 -> V_80 = F_47 ( V_71 , & V_81 , V_5 ) ;
if ( F_28 ( V_5 -> V_80 ) ) {
F_31 ( V_5 -> V_52 , L_18 ) ;
return F_29 ( V_5 -> V_80 ) ;
}
F_48 (pdev->dev.of_node, node) {
if ( ! F_49 ( V_51 , L_19 ) )
continue;
V_55 = F_45 ( V_51 , L_20 , & V_74 ) ;
if ( V_55 || V_74 >= V_5 -> V_60 ) {
F_31 ( & V_70 -> V_52 , L_21 ) ;
if ( ! V_55 )
V_55 = - V_39 ;
goto V_82;
...
return 0 ;
V_82:
for ( V_74 = 0 ; V_74 < V_5 -> V_60 ; V_74 ++ )
if ( V_5 -> V_76 [ V_74 ] . V_31 )
F_51 ( V_5 -> V_76 [ V_74 ] . V_31 ) ;
F_52 ( V_5 -> V_80 ) ;
return V_55 ;
}
static int F_53 ( struct V_69 * V_70 )
{
struct V_4 * V_5 = F_54 ( V_70 ) ;
unsigned V_74 ;
for ( V_74 = 0 ; V_74 < V_5 -> V_60 ; V_74 ++ )
if ( V_5 -> V_76 [ V_74 ] . V_31 )
F_51 ( V_5 -> V_76 [ V_74 ] . V_31 ) ;
