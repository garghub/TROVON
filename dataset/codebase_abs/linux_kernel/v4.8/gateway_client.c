...
if ( V_49 < V_48 )
goto V_12;
if ( ( F_25 ( & V_9 -> V_10 . V_30 ) > 3 ) &&
( V_49 - V_48 < F_25 ( & V_9 -> V_10 . V_30 ) ) )
goto V_12;
F_32 ( V_39 , V_9 ,
L_5 ,
V_48 , V_49 ) ;
...
enum V_72
F_55 ( struct V_73 * V_74 , unsigned int * V_75 ,
T_2 * V_76 )
{
enum V_72 V_59 = V_77 ;
struct V_78 * V_78 ;
...
T_3 V_85 ;
T_2 * V_86 ;
if ( ! F_56 ( V_74 , * V_75 + V_87 ) )
return V_77 ;
V_78 = F_57 ( V_74 ) ;
V_85 = V_78 -> V_88 ;
* V_75 += V_87 ;
if ( V_85 == F_58 ( V_89 ) ) {
if ( ! F_56 ( V_74 , * V_75 + V_90 ) )
return V_77 ;
V_83 = F_59 ( V_74 ) ;
V_85 = V_83 -> V_91 ;
* V_75 += V_90 ;
...
switch ( V_85 ) {
case F_58 ( V_92 ) :
if ( ! F_56 ( V_74 , * V_75 + sizeof( * V_79 ) ) )
return V_77 ;
V_79 = (struct V_79 * ) ( V_74 -> V_93 + * V_75 ) ;
* V_75 += V_79 -> V_94 * 4 ;
if ( V_79 -> V_95 != V_96 )
return V_77 ;
break;
case F_58 ( V_97 ) :
if ( ! F_56 ( V_74 , * V_75 + sizeof( * V_80 ) ) )
return V_77 ;
V_80 = (struct V_80 * ) ( V_74 -> V_93 + * V_75 ) ;
* V_75 += sizeof( * V_80 ) ;
if ( V_80 -> V_98 != V_96 )
return V_77 ;
break;
...
if ( ! F_56 ( V_74 , * V_75 + sizeof( * V_81 ) ) )
return V_77 ;
V_81 = (struct V_81 * ) ( V_74 -> V_93 + * V_75 ) ;
* V_75 += sizeof( * V_81 ) ;
switch ( V_85 ) {
case F_58 ( V_92 ) :
if ( V_81 -> V_99 == F_58 ( 67 ) )
V_59 = V_100 ;
else if ( V_81 -> V_101 == F_58 ( 67 ) )
V_59 = V_102 ;
break;
case F_58 ( V_97 ) :
if ( V_81 -> V_99 == F_58 ( 547 ) )
V_59 = V_100 ;
else if ( V_81 -> V_101 == F_58 ( 547 ) )
V_59 = V_102 ;
break;
}
V_84 = * V_75 + V_103 ;
if ( V_59 == V_102 &&
F_56 ( V_74 , V_84 + V_104 ) ) {
V_86 = V_74 -> V_93 + * V_75 + V_105 ;
if ( * V_86 != V_106 )
return V_77 ;
V_86 = V_74 -> V_93 + * V_75 + V_107 ;
if ( * V_86 != V_104 )
return V_77 ;
F_60 ( V_76 , V_74 -> V_93 + V_84 ) ;
}
return V_59 ;
}
...
struct V_73 * V_74 )
{
struct V_19 * V_108 = NULL ;
struct V_19 * V_109 = NULL ;
struct V_13 * V_110 = NULL ;
struct V_3 * V_4 = NULL ;
struct V_3 * V_11 = NULL ;
struct V_21 * V_111 , * V_112 ;
struct V_78 * V_78 = (struct V_78 * ) V_74 -> V_93 ;
bool V_113 = false ;
T_2 V_114 ;
unsigned short V_115 ;
V_115 = F_62 ( V_74 , 0 ) ;
V_110 = F_63 ( V_9 , V_78 -> V_116 ,
V_78 -> V_117 , V_115 ) ;
if ( ! V_110 )
goto V_12;
V_4 = F_40 ( V_9 , V_110 ) ;
...
V_109 = F_64 ( V_9 , V_110 , NULL ) ;
if ( ! V_109 )
goto V_12;
V_112 = F_24 ( V_109 , V_27 ) ;
if ( ! V_112 )
goto V_12;
if ( ( V_114 - V_112 -> V_29 . V_26 ) > V_121 )
V_113 = true ;
F_27 ( V_112 ) ;
V_12:
if ( V_110 )
