...
. V_61 = V_62 ,
. V_36 = F_35 ( V_49 ) -> V_60 ,
. V_63 = F_39 ( F_35 ( V_49 ) -> V_64 ) ,
. V_65 = V_54 ,
. V_66 = F_40 ( V_51 ) ? V_49 -> V_67 : 0 ,
} ;
...
static int F_44 ( struct V_48 * V_49 , T_3 V_69 , T_3 V_70 ,
...
V_35 . V_80 = 0 ;
V_75 = V_73 -> V_81 == NULL ;
V_35 . V_66 = F_40 ( V_73 ) ? V_49 -> V_67 : 0 ;
F_46 ( V_32 , & V_35 ) ;
V_1 = F_38 ( V_32 ) ;
if ( F_41 ( V_1 , & V_35 , & V_38 , 0 ) )
goto V_82;
if ( V_38 . type != V_43 &&
( V_38 . type != V_83 || ! F_47 ( V_73 ) ) )
goto V_84;
if ( ! V_72 && ! F_48 ( F_38 ( V_32 ) ) &&
( V_32 -> V_85 != V_71 || ! F_49 ( V_73 ) ) )
goto V_82;
F_50 ( V_74 , & V_38 ) ;
V_76 = false ;
#ifdef F_51
...
int F_54 ( struct V_48 * V_49 , T_3 V_69 , T_3 V_70 ,
T_4 V_64 , int V_71 , struct V_31 * V_32 ,
struct V_50 * V_73 , T_2 * V_74 )
{
int V_96 = F_55 ( V_49 ) ? 0 : F_56 ( V_73 ) ;
...
return F_44 ( V_49 , V_69 , V_70 , V_64 , V_71 , V_32 , V_96 , V_73 , V_74 ) ;
}
...
V_33 = F_57 ( & V_53 -> V_150 ) ;
if ( V_53 -> V_150 . V_116 == V_117 && V_33 ) {
unsigned int V_151 ;
V_111 -> V_152 = V_33 ;
V_151 = F_28 ( V_1 , V_33 , V_111 -> V_143 ) ;
if ( V_53 -> V_55 & V_153 &&
V_151 == V_43 )
V_111 -> V_132 = V_59 ;
}
...
break;
case V_197 :
V_111 -> V_152 = F_81 ( V_176 ) ;
break;
case V_198 :
V_111 -> V_130 = F_82 ( V_176 ) ;
break;
case V_199 :
V_111 -> V_148 = F_81 ( V_176 ) ;
break;
case V_200 :
...
{
struct V_1 * V_1 = F_38 ( V_145 -> V_222 -> V_32 ) ;
T_2 V_25 = F_31 ( V_145 -> V_222 -> V_32 ) ;
struct V_2 * V_15 ;
struct V_110 V_111 = {
. V_127 = V_223 ,
. V_133 = type ,
...
if ( ! F_22 ( V_228 ) && ! ( V_145 -> V_230 & V_231 ) &&
...
V_254 -> V_167 = F_26 ( V_15 , & V_35 , & V_38 , V_44 ) ;
if ( ! V_254 -> V_167 ) {
...
V_291 = F_127 ( T_6 , V_291 , V_292 ) ;
V_1 -> V_10 . V_11 = F_68 ( V_291 , V_157 ) ;
if ( ! V_1 -> V_10 . V_11 )
return - V_6 ;
V_167 = F_1 ( V_1 ) ;
if ( V_167 < 0 )
...
#endif
for ( V_293 = 0 ; V_293 < V_22 ; V_293 ++ ) {
struct V_23 * V_24 = & V_1 -> V_10 . V_11 [ V_293 ] ;
struct V_29 * V_30 ;
struct V_2 * V_15 ;
F_15 (tb, tmp, head, tb_hlist) {
F_130 ( & V_15 -> V_9 ) ;
...
void T_8 F_137 ( void )
{
F_138 ( V_296 , V_225 , F_86 , NULL , NULL ) ;
F_138 ( V_296 , V_249 , F_84 , NULL , NULL ) ;
F_138 ( V_296 , V_297 , NULL , F_87 , NULL ) ;
F_139 ( & V_298 ) ;
F_140 ( & V_299 ) ;
F_141 ( & V_300 ) ;
F_142 () ;
