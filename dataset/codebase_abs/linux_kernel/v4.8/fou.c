...
static struct V_15 * F_30 ( struct V_5 * V_6 , unsigned int V_60 ,
...
if ( ! F_23 ( V_6 ) -> V_63 )
return NULL ;
V_15 = F_31 ( V_6 , ( void * ) V_15 , V_60 , V_17 ,
V_21 , V_22 , V_62 , V_19 ) ;
V_6 -> V_25 = 1 ;
return V_15 ;
}
...
static int F_42 ( struct V_2 * V_3 , struct V_5 * V_6 , int V_56 )
{
const struct V_43 * * V_47 ;
...
static int F_43 ( struct V_74 * V_74 , struct V_1 * V_1 )
{
struct V_75 * V_76 = F_44 ( V_74 , V_77 ) ;
struct V_1 * V_78 ;
F_45 ( & V_76 -> V_79 ) ;
...
static int F_53 ( struct V_74 * V_74 , struct V_86 * V_87 ,
struct V_84 * * V_88 )
{
...
struct V_89 V_90 ;
int V_57 ;
V_57 = F_54 ( V_74 , & V_87 -> V_91 , & V_2 ) ;
if ( V_57 < 0 )
goto error;
V_1 = F_55 ( sizeof( * V_1 ) , V_92 ) ;
if ( ! V_1 ) {
V_57 = - V_93 ;
goto error;
}
...
static int F_58 ( struct V_74 * V_74 , struct V_86 * V_87 )
{
struct V_75 * V_76 = F_44 ( V_74 , V_77 ) ;
...
T_2 V_8 = F_60 ( V_104 -> V_105 [ V_106 ] ) ;
switch ( V_8 ) {
case V_9 :
break;
case V_107 :
...
T_3 V_80 = F_61 ( V_104 -> V_105 [ V_110 ] ) ;
V_87 -> V_91 . V_94 = V_80 ;
}
if ( V_104 -> V_105 [ V_111 ] )
V_87 -> V_14 = F_60 ( V_104 -> V_105 [ V_111 ] ) ;
if ( V_104 -> V_105 [ V_112 ] )
V_87 -> type = F_60 ( V_104 -> V_105 [ V_112 ] ) ;
if ( V_104 -> V_105 [ V_113 ] )
V_87 -> V_34 |= V_39 ;
return 0 ;
}
static int F_62 ( struct V_5 * V_6 , struct V_103 * V_104 )
{
struct V_74 * V_74 = F_63 ( V_104 ) ;
struct V_86 V_87 ;
int V_57 ;
V_57 = F_59 ( V_104 , & V_87 ) ;
if ( V_57 )
return V_57 ;
return F_53 ( V_74 , & V_87 , NULL ) ;
}
static int F_64 ( struct V_5 * V_6 , struct V_103 * V_104 )
{
struct V_74 * V_74 = F_63 ( V_104 ) ;
struct V_86 V_87 ;
int V_57 ;
...
if ( V_57 )
return V_57 ;
return F_58 ( V_74 , & V_87 ) ;
}
static int F_65 ( struct V_1 * V_1 , struct V_5 * V_114 )
{
if ( F_66 ( V_114 , V_106 , V_1 -> V_2 -> V_3 -> V_115 ) ||
F_67 ( V_114 , V_110 , V_1 -> V_80 ) ||
F_66 ( V_114 , V_111 , V_1 -> V_14 ) ||
F_66 ( V_114 , V_112 , V_1 -> type ) )
return - 1 ;
if ( V_1 -> V_34 & V_39 )
if ( F_68 ( V_114 , V_113 ) )
return - 1 ;
...
static int F_69 ( struct V_1 * V_1 , T_5 V_116 , T_5 V_117 ,
T_5 V_34 , struct V_5 * V_6 , T_2 V_118 )
{
void * V_119 ;
V_119 = F_70 ( V_6 , V_116 , V_117 , & V_120 , V_34 , V_118 ) ;
if ( ! V_119 )
return - V_93 ;
if ( F_65 ( V_1 , V_6 ) < 0 )
goto V_121;
...
static int F_73 ( struct V_5 * V_6 , struct V_103 * V_104 )
{
struct V_74 * V_74 = F_63 ( V_104 ) ;
struct V_75 * V_76 = F_44 ( V_74 , V_77 ) ;
struct V_5 * V_114 ;
...
if ( V_123 < 0 )
goto V_129;
return F_75 ( V_114 , V_104 ) ;
V_129:
F_76 ( V_114 ) ;
return V_123 ;
}
static int F_77 ( struct V_5 * V_6 , struct V_130 * V_131 )
{
struct V_74 * V_74 = F_78 ( V_6 -> V_3 ) ;
struct V_75 * V_76 = F_44 ( V_74 , V_77 ) ;
struct V_1 * V_78 ;
int V_132 = 0 , V_123 ;
F_45 ( & V_76 -> V_79 ) ;
...
continue;
V_123 = F_69 ( V_78 , F_79 ( V_131 -> V_6 ) . V_116 ,
...
static void F_82 ( struct V_5 * V_6 , struct V_137 * V_138 ,
...
F_84 ( ! ( V_138 -> V_34 & V_148 ) , V_6 ,
V_142 -> V_149 , V_142 -> V_150 , V_6 -> V_7 ) ;
* V_14 = V_151 ;
}
int F_85 ( struct V_5 * V_6 , struct V_137 * V_138 ,
...
if ( V_57 )
return V_57 ;
* V_143 = V_138 -> V_143 ? : F_87 ( F_88 ( V_6 -> V_152 ) ,
V_6 , 0 , 0 , false ) ;
return 0 ;
}
int F_89 ( struct V_5 * V_6 , struct V_137 * V_138 ,
...
T_3 V_143 ;
int V_57 ;
V_57 = F_85 ( V_6 , V_138 , V_14 , & V_143 , type ) ;
if ( V_57 )
return V_57 ;
F_82 ( V_6 , V_138 , V_142 , V_14 , V_143 ) ;
return 0 ;
}
...
int F_93 ( struct V_5 * V_6 , struct V_137 * V_138 ,
T_2 * V_14 , struct V_141 * V_142 )
{
int type = V_138 -> V_34 & V_148 ? V_153 :
V_154 ;
T_3 V_143 ;
int V_57 ;
V_57 = F_90 ( V_6 , V_138 , V_14 , & V_143 , type ) ;
if ( V_57 )
return V_57 ;
F_82 ( V_6 , V_138 , V_142 , V_14 , V_143 ) ;
return 0 ;
...
{
int V_123 ;
V_123 = F_95 ( & V_162 , V_163 ) ;
if ( V_123 < 0 ) {
F_96 ( L_1 ) ;
return V_123 ;
}
V_123 = F_95 ( & V_164 , V_165 ) ;
if ( V_123 < 0 ) {
F_96 ( L_2 ) ;
F_97 ( & V_162 , V_163 ) ;
return V_123 ;
...
static T_6 int F_99 ( struct V_74 * V_74 )
{
struct V_75 * V_76 = F_44 ( V_74 , V_77 ) ;
F_100 ( & V_76 -> V_83 ) ;
F_101 ( & V_76 -> V_79 ) ;
...
static T_7 void F_102 ( struct V_74 * V_74 )
{
struct V_75 * V_76 = F_44 ( V_74 , V_77 ) ;
struct V_1 * V_1 , * V_68 ;
F_45 ( & V_76 -> V_79 ) ;
