...
struct V_30 * V_31 )
{
struct V_32 * V_32 = F_20 ( V_29 ) ;
struct V_33 * V_34 = & V_31 -> V_4 -> V_35 ;
struct V_1 * V_11 = F_3 ( V_7 ) ;
V_32 -> V_36 = V_34 -> V_36 ;
if ( ! V_11 -> V_37 && V_34 -> V_38 )
V_32 -> V_37 = V_34 -> V_39 [ 0 ] ;
else
V_32 -> V_37 = V_11 -> V_37 ;
V_32 -> V_40 = 2 ;
V_32 -> V_41 = 3 ;
...
V_11 -> V_7 . V_18 -> V_70 ( & V_11 -> V_7 ) ;
V_11 -> V_4 . V_18 -> V_70 ( & V_11 -> V_4 ) ;
F_46 ( V_11 -> V_20 ) ;
}
static int F_47 ( struct V_71 * V_72 )
{
return F_48 ( & V_72 -> V_14 , & V_73 ) ;
}
