...
V_2 -> V_36 . V_49 ) ;
V_64 = V_62 -> V_65 ? V_62 -> V_65 -> V_40 . V_64 : 0 ;
F_1 ( V_2 , V_4 , V_66 ,
V_64 & V_67 ?
0 : V_68 ) ;
F_1 ( V_2 , V_4 , V_69 ,
...
( V_40 -> V_42 << V_71 ) ) ;
F_1 ( V_2 , V_4 , V_72 , 0 ) ;
F_1 ( V_2 , V_4 , V_73 , V_2 -> V_13 |
( 0xff << V_74 ) ) ;
F_1 ( V_2 , V_4 , V_75 , F_22 ( 1 ) |
F_23 ( V_76 ) |
F_24 ( V_76 ) ) ;
for ( V_53 = 0 ; V_53 < V_2 -> V_36 . V_49 ; ++ V_53 ) {
bool V_77 = false ;
T_1 V_8 = 0 ;
if ( V_2 -> V_78 [ V_53 ] . V_79 ) {
V_8 |= V_80 ;
V_77 = V_2 -> V_78 [ V_53 ] . V_79 -> V_40 . V_64
& V_67 ;
} else {
V_8 |= F_25 ( V_76 )
| F_26 ( V_76 ) ;
...
struct V_1 * F_30 ( struct V_88 * V_89 )
{
struct V_1 * V_2 ;
int V_90 ;
V_2 = F_31 ( V_89 -> V_91 , sizeof( * V_2 ) , V_92 ) ;
if ( V_2 == NULL )
return F_32 ( - V_93 ) ;
V_2 -> V_36 . V_94 = & V_95 ;
V_2 -> V_36 . type = V_96 ;
V_90 = F_33 ( V_89 , & V_2 -> V_36 , L_1 ,
V_89 -> V_97 -> V_98 + 1 , & V_99 ,
V_100 ) ;
if ( V_90 < 0 )
return F_32 ( V_90 ) ;
F_34 ( & V_2 -> V_10 , 1 ) ;
F_35 ( & V_2 -> V_10 , & V_101 , V_12 ,
0 , 0xffffff , 1 , 0 ) ;
V_2 -> V_13 = 0 ;
V_2 -> V_36 . V_16 . V_102 = & V_2 -> V_10 ;
if ( V_2 -> V_10 . error ) {
F_36 ( V_89 -> V_91 , L_2 ) ;
V_90 = V_2 -> V_10 . error ;
F_37 ( & V_2 -> V_36 ) ;
