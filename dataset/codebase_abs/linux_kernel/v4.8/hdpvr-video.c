...
if ( F_68 ( V_118 , V_119 + V_25 , 0 , false ) )
break;
if ( V_25 == F_67 ( V_119 ) )
return - V_120 ;
...
static int F_73 ( struct V_70 * V_70 , void * V_104 ,
struct V_130 * V_118 )
{
struct V_9 * V_10 = F_53 ( V_70 ) ;
struct V_71 * V_72 = V_104 ;
...
static int F_75 ( struct V_70 * V_70 , void * V_104 , struct V_145 * V_25 )
{
unsigned int V_146 ;
V_146 = V_25 -> V_132 ;
if ( V_146 >= V_147 )
...
if ( V_10 -> V_11 != V_56 )
return - V_109 ;
V_26 = F_80 ( V_10 , V_160 -> V_132 + 1 , V_10 -> V_59 . V_165 ) ;
if ( ! V_26 )
...
static int F_82 ( struct V_167 * V_168 )
{
struct V_9 * V_10 =
...
return F_80 ( V_10 , V_178 -> V_166 + 1 ,
V_178 -> V_165 ) ;
}
return 0 ;
case V_197 :
...
static int F_86 ( struct V_70 * V_70 , void * V_74 ,
struct V_207 * V_208 )
{
if ( V_208 -> V_132 != 0 )
return - V_120 ;
V_208 -> V_195 = V_209 ;
strncpy ( V_208 -> V_210 , L_23 , 32 ) ;
V_208 -> V_211 = V_212 ;
return 0 ;
}
static int F_87 ( struct V_70 * V_70 , void * V_104 ,
struct V_213 * V_208 )
{
struct V_9 * V_10 = F_53 ( V_70 ) ;
struct V_71 * V_72 = V_104 ;
...
static int F_88 ( struct V_70 * V_86 , void * V_92 ,
struct V_224 * V_113 )
{
struct V_9 * V_10 = F_53 ( V_86 ) ;
int V_225 = 0 ;
...
static int F_89 ( struct V_70 * V_86 , void * V_92 ,
struct V_224 * V_113 )
{
V_113 -> V_195 = 0 ;
switch ( V_113 -> V_226 ) {
...
static void F_90 ( struct V_229 * V_230 )
{
struct V_9 * V_10 = F_91 ( V_230 ) ;
F_92 ( V_10 ) ;
F_26 ( & V_10 -> V_42 ) ;
F_46 ( & V_10 -> V_51 ) ;
F_31 ( & V_10 -> V_42 ) ;
...
int F_97 ( struct V_9 * V_10 , struct V_235 * V_236 ,
int V_237 )
{
...
V_246 , 0x3 ,
V_246 ) ;
V_10 -> V_247 = F_100 ( V_170 , & V_242 ,
V_172 ,
V_201 , 0 ,
V_201 ) ;
V_10 -> V_175 = F_99 ( V_170 , & V_242 ,
V_248 ,
1000000 , 13500000 , 100000 , 6500000 ) ;
V_10 -> V_176 = F_99 ( V_170 , & V_242 ,
V_249 ,
...
V_10 -> V_251 = V_252 ;
strcpy ( V_10 -> V_251 . V_149 , L_22 ) ;
V_10 -> V_251 . V_31 = & V_10 -> V_31 ;
F_103 ( & V_10 -> V_251 , V_10 ) ;
V_225 = F_104 ( & V_10 -> V_251 , V_253 , V_237 ) ;
if ( V_225 < 0 ) {
F_19 ( & V_10 -> V_31 , L_27 ) ;
goto error;
}
