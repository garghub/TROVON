...
if ( F_54 ( V_2 -> V_5 -> V_128 != V_129 ) ) {
F_3 ( V_2 , - V_98 ) ;
continue;
}
if ( F_55 ( V_2 -> V_5 ) == V_130 )
F_40 ( V_2 -> V_5 ) ;
else
F_45 ( V_2 -> V_5 ) ;
}
}
static unsigned int F_56 ( struct V_110 * V_5 ,
struct V_1 * V_2 ,
unsigned int V_99 ,
unsigned int V_100 )
{
...
if ( F_54 ( V_5 -> V_128 != V_129 ) ) {
F_3 ( V_2 , - V_98 ) ;
continue;
}
if ( ! F_56 ( V_5 , V_2 , V_99 , V_100 ) )
return;
}
}
static int F_58 ( struct V_132 * V_133 , struct V_134 * V_135 )
{
struct V_1 * V_2 = V_133 -> V_136 -> V_113 ;
V_135 -> V_137 = ( unsigned short ) V_2 -> V_77 ;
V_135 -> V_79 = ( unsigned char ) V_2 -> V_79 ;
V_135 -> V_81 = ( unsigned char ) V_2 -> V_81 ;
return 0 ;
}
static int F_59 ( struct V_138 * V_34 )
{
...
static int F_60 ( struct V_138 * V_34 )
{
struct V_32 * V_33 = V_34 -> V_35 ;
struct V_1 * V_2 = V_33 -> V_2 ;
if ( F_9 ( V_2 , V_40 , V_72 ) )
...
struct V_1 * V_2 ;
struct V_143 * V_144 ;
struct V_32 * V_33 = V_142 -> V_34 . V_35 ;
int V_3 = 0 ;
if ( ! V_33 ) {
F_6 ( V_12 L_32 ,
V_145 , __LINE__ ) ;
...
V_2 = F_62 ( sizeof( struct V_1 ) , V_148 ) ;
if ( ! V_2 ) {
F_6 ( V_12 L_33 ,
V_145 , __LINE__ ) ;
V_3 = - V_149 ;
...
V_2 -> V_20 = F_64 ( V_144 -> V_154 , F_65 ( V_144 ) ) ;
if ( ! V_2 -> V_20 ) {
F_6 ( V_12 L_35 ,
V_145 , __LINE__ ) ;
V_3 = - V_98 ;
...
V_2 -> V_90 = V_144 -> V_154 ;
V_3 = F_67 ( V_2 -> V_90 , V_156 ) ;
if ( V_3 )
goto V_157;
F_68 ( V_2 -> V_90 , 1 ) ;
if ( ! ( V_33 -> V_158 & V_159 ) ) {
...
V_2 -> V_43 = V_144 -> V_154 ;
V_3 = F_67 ( V_2 -> V_43 , V_162 ) ;
if ( V_3 )
goto V_160;
F_69 ( V_2 -> V_43 ) ;
}
if ( V_33 -> V_158 == V_163 ) {
V_3 = F_14 ( V_2 -> V_43 , V_164 ) ;
if ( V_3 )
goto V_165;
V_3 = F_32 ( V_2 ) ;
if ( V_3 ) {
...
if ( ! V_33 -> V_38 ) {
V_2 -> V_45 = F_70 ( V_142 , 0 ) ;
if ( V_2 -> V_45 == - V_166 ) {
V_3 = V_2 -> V_45 ;
goto V_165;
}
V_3 = F_71 ( V_2 -> V_45 , F_18 ,
V_167 ,
V_168 , V_2 ) ;
if ( V_3 ) {
F_6 ( V_12 L_40 ,
...
F_73 ( & V_2 -> V_48 ) ;
if ( V_33 -> V_38 )
V_2 -> V_120 = F_74 ( F_52 , & V_2 -> V_48 ) ;
else
V_2 -> V_120 = F_74 ( F_47 , & V_2 -> V_48 ) ;
if ( ! V_2 -> V_120 ) {
V_3 = - V_149 ;
F_6 ( V_12 L_42 ,
V_145 , __LINE__ ) ;
...
V_2 -> V_120 -> V_127 = V_2 ;
V_3 = F_75 ( V_2 -> V_120 , L_43 ) ;
if ( V_3 ) {
F_6 ( V_12 L_44 ,
V_145 , __LINE__ ) ;
goto V_171;
}
F_76 ( V_2 -> V_120 , V_172 ) ;
F_77 ( V_2 -> V_120 , V_69 ) ;
F_78 ( & V_2 -> V_49 ) ;
V_2 -> V_49 . V_173 = F_49 ;
V_2 -> V_49 . V_122 = ( unsigned long ) V_2 ;
V_2 -> V_174 = F_79 ( V_175 ) ;
if ( ! V_2 -> V_174 ) {
F_6 ( V_12 L_45 ,
V_145 , __LINE__ ) ;
V_3 = - V_149 ;
...
V_2 -> V_174 -> V_150 = V_2 -> V_150 ;
V_2 -> V_174 -> V_177 = 0 ;
V_2 -> V_174 -> V_178 = & V_179 ;
V_2 -> V_174 -> V_180 = V_2 -> V_120 ;
V_2 -> V_174 -> V_113 = V_2 ;
sprintf ( V_2 -> V_174 -> V_11 , V_9 L_46 ) ;
F_80 ( V_2 -> V_174 , V_2 -> V_75 ) ;
F_81 ( V_2 -> V_174 ) ;
return V_3 ;
V_176:
F_82 ( & V_2 -> V_49 ) ;
