...
static bool F_127 ( struct V_203 * V_204 ,
const char * V_214 )
{
const struct V_215 * V_216 = F_128 ( V_204 ) ;
if ( V_216 && ! strcmp ( V_216 -> V_217 , V_214 ) )
return true ;
#ifdef F_129
if ( F_130 ( V_204 -> V_60 . V_218 , V_214 ) )
return true ;
#endif
return false ;
}
static int F_131 ( struct V_203 * V_204 )
{
int V_58 , V_83 , V_219 = - V_114 ;
struct V_220 * V_221 , * V_196 ;
struct V_6 * V_7 = F_132 ( & V_204 -> V_60 , sizeof( * V_7 ) ,
V_222 ) ;
if ( ! V_7 )
return - V_90 ;
if ( F_127 ( V_204 , L_8 ) ) {
...
V_7 -> V_41 = V_227 ;
V_7 -> V_228 = V_229 ;
V_7 -> V_230 = F_133 ( V_229 ) ;
V_7 -> V_231 = V_232 ;
V_7 -> V_233 = F_133 ( V_232 ) ;
} else if ( F_127 ( V_204 , L_9 ) ) {
V_7 -> V_223 = V_234 ;
V_7 -> V_17 = V_235 ;
V_7 -> V_19 = V_236 ;
V_7 -> V_41 = V_237 ;
V_7 -> V_228 = V_238 ;
V_7 -> V_230 = F_133 ( V_238 ) ;
} else {
return - V_114 ;
}
V_7 -> V_217 = F_134 ( & V_204 -> V_60 ) ;
V_221 = F_135 ( V_204 , V_239 , 0 ) ;
V_7 -> V_9 = F_136 ( & V_204 -> V_60 , V_221 ) ;
if ( F_66 ( V_7 -> V_9 ) )
return F_67 ( V_7 -> V_9 ) ;
V_196 = F_135 ( V_204 , V_240 , 0 ) ;
if ( ! V_196 ) {
F_14 ( & V_204 -> V_60 , L_10 ) ;
return - V_241 ;
}
if ( F_137 ( & V_204 -> V_60 , V_196 -> V_242 , F_109 , 0 ,
V_7 -> V_217 , V_7 ) ) {
F_14 ( V_7 -> V_60 , L_11 ) ;
return - V_157 ;
}
...
V_7 -> V_63 = F_138 ( V_7 -> V_217 , V_7 -> V_60 ,
V_61 * sizeof( struct V_45 ) , 8 , V_245 ) ;
if ( ! V_7 -> V_63 )
return - V_90 ;
F_139 ( & V_7 -> V_158 ) ;
V_7 -> V_205 = F_140 ( & V_204 -> V_60 , L_12 ) ;
if ( F_66 ( V_7 -> V_205 ) ) {
F_141 ( & V_204 -> V_60 , L_13 ) ;
F_142 ( & V_204 -> V_60 , & V_246 ) ;
return F_67 ( V_7 -> V_205 ) ;
}
if ( F_143 ( V_7 -> V_205 ) ) {
F_141 ( & V_204 -> V_60 , L_14 ) ;
F_144 ( V_7 -> V_205 ) ;
return - V_195 ;
}
V_83 = F_145 ( & V_204 -> V_60 , & V_246 ) ;
if ( V_83 ) {
F_146 ( V_7 -> V_205 ) ;
F_144 ( V_7 -> V_205 ) ;
return V_83 ;
...
F_8 ( V_247 | V_248 ,
V_7 -> V_9 + V_249 ) ;
F_147 ( & V_7 -> V_148 , F_110 ,
( unsigned long ) V_7 ) ;
F_148 ( & V_7 -> V_152 ) ;
F_148 ( & V_7 -> V_185 ) ;
F_148 ( & V_7 -> V_155 ) ;
V_7 -> V_153 = 0 ;
F_149 ( & V_7 -> V_127 , F_111 ,
( unsigned long ) V_7 ) ;
F_150 ( V_204 , V_7 ) ;
F_148 ( & V_7 -> V_250 ) ;
for ( V_58 = 0 ; V_58 < V_7 -> V_230 ; ++ V_58 ) {
V_7 -> V_228 [ V_58 ] . V_7 = V_7 ;
V_83 = F_151 ( & V_7 -> V_228 [ V_58 ] . V_3 ) ;
if ( ! V_83 ) {
...
static int F_154 ( struct V_203 * V_204 )
{
