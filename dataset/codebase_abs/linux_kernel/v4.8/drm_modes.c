...
if ( V_184 -> V_167 )
V_2 = F_13 ( V_17 ,
V_184 -> V_163 , V_184 -> V_164 ,
V_184 -> V_162 ? V_184 -> V_98 : 60 ,
V_184 -> V_168 , V_184 -> V_38 ,
V_184 -> V_29 ) ;
else
V_2 = F_42 ( V_17 ,
V_184 -> V_163 , V_184 -> V_164 ,
...
void F_79 ( struct V_186 * V_187 ,
const struct V_1 * V_188 )
{
F_80 ( V_188 -> V_7 > V_189 || V_188 -> V_8 > V_189 ||
V_188 -> V_9 > V_189 || V_188 -> V_10 > V_189 ||
V_188 -> V_110 > V_189 || V_188 -> V_11 > V_189 ||
V_188 -> V_12 > V_189 || V_188 -> V_13 > V_189 ||
V_188 -> V_14 > V_189 || V_188 -> V_99 > V_189 ,
L_9 ) ;
V_187 -> clock = V_188 -> clock ;
V_187 -> V_7 = V_188 -> V_7 ;
V_187 -> V_8 = V_188 -> V_8 ;
V_187 -> V_9 = V_188 -> V_9 ;
V_187 -> V_10 = V_188 -> V_10 ;
V_187 -> V_110 = V_188 -> V_110 ;
V_187 -> V_11 = V_188 -> V_11 ;
V_187 -> V_12 = V_188 -> V_12 ;
V_187 -> V_13 = V_188 -> V_13 ;
V_187 -> V_14 = V_188 -> V_14 ;
V_187 -> V_99 = V_188 -> V_99 ;
V_187 -> V_6 = V_188 -> V_6 ;
V_187 -> V_15 = V_188 -> V_15 ;
V_187 -> type = V_188 -> type ;
strncpy ( V_187 -> V_5 , V_188 -> V_5 , V_96 ) ;
V_187 -> V_5 [ V_96 - 1 ] = 0 ;
}
int F_81 ( struct V_1 * V_187 ,
const struct V_186 * V_188 )
{
int V_95 = - V_190 ;
if ( V_188 -> clock > V_191 || V_188 -> V_6 > V_191 ) {
V_95 = - V_192 ;
goto V_187;
}
if ( ( V_188 -> V_15 & V_120 ) > V_193 )
goto V_187;
V_187 -> clock = V_188 -> clock ;
V_187 -> V_7 = V_188 -> V_7 ;
V_187 -> V_8 = V_188 -> V_8 ;
...
strncpy ( V_187 -> V_5 , V_188 -> V_5 , V_96 ) ;
V_187 -> V_5 [ V_96 - 1 ] = 0 ;
V_187 -> V_140 = F_60 ( V_187 ) ;
if ( V_187 -> V_140 != V_135 )
goto V_187;
F_51 ( V_187 , V_115 ) ;
V_95 = 0 ;
V_187:
