...
struct V_1 * V_2 = F_32 ( V_55 , V_56 ) ;
struct V_90 * V_91 = (struct V_90 * ) V_88 -> args ;
return F_67 ( & V_2 -> V_44 , & V_91 -> V_92 ,
V_10 ) ;
}
...
static int F_70 ( struct V_50 * V_51 , struct V_87 * V_88 )
{
struct V_90 * V_91 = (struct V_90 * ) V_88 -> args ;
...
while ( V_19 ) {
V_81 = F_55 ( V_19 , F_75 ( V_88 -> V_51 ) . V_73 ,
V_88 -> V_96 -> V_97 , V_98 ,
V_51 , V_99 ) ;
if ( V_81 )
goto V_95;
...
static T_4 int F_77 ( struct V_55 * V_55 )
{
int V_59 ;
struct V_1 * V_2 = F_32 ( V_55 , V_56 ) ;
V_59 = F_1 ( V_2 ) ;
...
static T_5 void F_79 ( struct V_55 * V_55 )
{
struct V_1 * V_2 = F_32 ( V_55 , V_56 ) ;
F_80 ( & V_2 -> V_44 , F_28 , NULL ) ;
F_81 ( V_2 -> V_9 ) ;
if ( V_2 -> V_61 )
F_82 ( V_55 , V_62 ,
F_34 ( V_62 ) ) ;
...
{
struct V_18 * V_19 ;
struct V_102 * V_103 = F_83 ( V_51 ) ;
struct V_55 * V_55 = F_84 ( V_51 -> V_104 ) ;
struct V_1 * V_2 = F_32 ( V_55 , V_56 ) ;
struct V_20 * V_21 = F_85 ( & V_103 -> V_105 ) ;
if ( ! F_86 ( V_21 ) ) {
return 0 ;
}
F_61 () ;
...
if ( V_19 )
F_87 ( V_51 , & V_19 -> V_23 . V_28 , V_101 ) ;
F_62 () ;
return 0 ;
}
int F_88 ( void )
