...
if ( V_108 < 0 )
return V_108 ;
return sprintf ( V_123 , L_73 , V_88 & V_173 ) ;
}
...
V_6 = ( V_179 == 0x4 ) ? 1 : 0 ;
V_178 = V_56 >> V_68 ;
return sprintf ( V_123 , L_74 , V_6 , V_178 ) ;
}
...
if ( V_108 < 0 )
return V_108 ;
return sprintf ( V_123 , L_74 , V_56 , V_166 -> V_105 ) ;
}
...
if ( ! V_10 -> V_160 )
return - V_143 ;
V_10 -> V_160 -> V_270 = L_94 ;
V_10 -> V_160 -> V_271 = L_95 ;
