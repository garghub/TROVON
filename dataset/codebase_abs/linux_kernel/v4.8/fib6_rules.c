...
static bool F_13 ( struct V_21 * V_22 , struct V_9 * V_10 )
{
...
static int F_14 ( struct V_21 * V_22 , struct V_23 * V_64 , int V_5 )
{
struct V_45 * V_46 = (struct V_45 * ) V_22 ;
struct V_3 * V_4 = & V_64 -> V_26 . V_27 ;
if ( V_46 -> V_17 . V_49 &&
! F_12 ( & V_4 -> V_54 , & V_46 -> V_17 . V_56 , V_46 -> V_17 . V_49 ) )
return 0 ;
if ( V_46 -> V_48 . V_49 ) {
if ( V_5 & V_50 ) {
if ( ! F_12 ( & V_4 -> V_52 , & V_46 -> V_48 . V_56 ,
V_46 -> V_48 . V_49 ) )
return 0 ;
} else if ( ! ( V_46 -> V_65 . V_5 & V_47 ) )
return 0 ;
}
if ( V_46 -> V_66 && V_46 -> V_66 != F_15 ( V_4 -> V_67 ) )
return 0 ;
return 1 ;
}
static int F_16 ( struct V_21 * V_22 , struct V_68 * V_69 ,
struct V_70 * V_71 ,
struct V_72 * * V_73 )
{
int V_31 = - V_39 ;
struct V_2 * V_2 = F_17 ( V_69 -> V_74 ) ;
struct V_45 * V_75 = (struct V_45 * ) V_22 ;
if ( V_22 -> V_33 == V_34 && ! V_22 -> V_76 ) {
if ( V_22 -> V_29 == V_77 )
goto V_78;
if ( F_18 ( V_2 , V_22 -> V_29 ) == NULL ) {
V_31 = - V_79 ;
goto V_78;
}
}
if ( V_71 -> V_80 )
V_75 -> V_48 . V_56 = F_19 ( V_73 [ V_81 ] ) ;
if ( V_71 -> V_82 )
V_75 -> V_17 . V_56 = F_19 ( V_73 [ V_83 ] ) ;
...
return 0 ;
if ( V_71 -> V_80 &&
F_21 ( V_73 [ V_81 ] , & V_75 -> V_48 . V_56 , sizeof( struct V_51 ) ) )
return 0 ;
if ( V_71 -> V_82 &&
F_21 ( V_73 [ V_83 ] , & V_75 -> V_17 . V_56 , sizeof( struct V_51 ) ) )
return 0 ;
return 1 ;
}
static int F_22 ( struct V_21 * V_22 , struct V_68 * V_69 ,
struct V_70 * V_71 )
{
struct V_45 * V_75 = (struct V_45 * ) V_22 ;
...
V_71 -> V_84 = V_75 -> V_66 ;
if ( ( V_75 -> V_17 . V_49 &&
F_23 ( V_69 , V_83 , & V_75 -> V_17 . V_56 ) ) ||
( V_75 -> V_48 . V_49 &&
F_23 ( V_69 , V_81 , & V_75 -> V_48 . V_56 ) ) )
goto V_85;
return 0 ;
V_85:
return - V_79 ;
}
static T_3 F_24 ( struct V_21 * V_22 )
{
return F_25 ( 16 )
+ F_25 ( 16 ) ;
}
...
if ( F_28 ( V_87 ) )
return F_29 ( V_87 ) ;
V_31 = F_30 ( V_87 , 0 , V_90 , 0 ) ;
if ( V_31 )
goto V_91;
V_31 = F_30 ( V_87 , 0x7FFE , V_92 , 0 ) ;
if ( V_31 )
goto V_91;
V_2 -> V_13 . V_14 = V_87 ;
V_44:
