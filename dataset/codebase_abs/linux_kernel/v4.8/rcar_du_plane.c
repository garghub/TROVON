...
return NULL ;
V_6 = F_2 ( V_2 -> V_6 ) ;
V_130 = F_30 ( V_6 , sizeof( * V_6 ) , V_131 ) ;
if ( V_130 == NULL )
return NULL ;
F_31 ( V_2 , & V_130 -> V_6 ) ;
return & V_130 -> V_6 ;
...
V_6 -> V_78 = 255 ;
V_6 -> V_71 = V_81 ;
V_6 -> V_6 . V_132 = V_2 -> type == V_133 ? 0 : 1 ;
V_2 -> V_6 = & V_6 -> V_6 ;
V_2 -> V_6 -> V_2 = V_2 ;
}
...
if ( V_135 == V_26 -> V_137 . V_78 )
V_122 -> V_78 = V_136 ;
else if ( V_135 == V_26 -> V_137 . V_71 )
V_122 -> V_71 = V_136 ;
else
return - V_18 ;
return 0 ;
...
const struct V_34 * V_6 , struct V_134 * V_135 ,
T_2 * V_136 )
{
...
unsigned int V_14 ;
int V_139 ;
V_44 -> V_12 = V_44 -> V_140 + 7 ;
V_138 = ( ( 1 << V_26 -> V_140 ) - 1 ) & ( 3 << ( 2 * V_44 -> V_17 ) ) ;
for ( V_14 = 0 ; V_14 < V_44 -> V_12 ; ++ V_14 ) {
enum V_141 type = V_14 < V_44 -> V_140
? V_133
: V_142 ;
struct V_1 * V_2 = & V_44 -> V_8 [ V_14 ] ;
V_2 -> V_16 = V_44 ;
V_139 = F_41 ( V_26 -> V_143 , & V_2 -> V_2 , V_138 ,
& V_144 , V_145 ,
F_42 ( V_145 ) , type ,
NULL ) ;
if ( V_139 < 0 )
