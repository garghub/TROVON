...
F_130 ( & V_2 -> V_115 ) ;
F_130 ( & V_2 -> V_119 ) ;
F_131 ( & V_2 -> V_311 . V_340 ) ;
F_132 ( & V_2 -> V_311 . V_341 ) ;
F_133 ( & V_2 -> V_342 ) ;
V_338 = F_134 ( V_94 , V_343 , 0 ) ;
V_2 -> V_4 = F_135 ( V_10 , V_338 ) ;
if ( F_136 ( V_2 -> V_4 ) )
return F_137 ( V_2 -> V_4 ) ;
V_2 -> V_344 = F_138 ( V_10 , L_41 ) ;
if ( ! F_136 ( V_2 -> V_344 ) ) {
V_174 = F_139 ( V_2 -> V_344 ) ;
if ( V_174 )
return V_174 ;
} else {
V_174 = F_137 ( V_2 -> V_344 ) ;
if ( V_174 == - V_345 )
return V_174 ;
V_2 -> V_344 = NULL ;
}
...
if ( V_174 )
goto V_233;
V_338 = F_140 ( V_94 , V_343 , L_42 ) ;
if ( V_338 ) {
V_2 -> V_40 = F_135 ( V_10 , V_338 ) ;
if ( F_136 ( V_2 -> V_40 ) ) {
V_174 = F_137 ( V_2 -> V_40 ) ;
goto V_233;
}
} else {
V_2 -> V_40 = V_2 -> V_4 +
...
V_338 = F_140 ( V_94 , V_343 , L_43 ) ;
if ( V_338 ) {
V_2 -> V_67 = F_135 ( V_10 , V_338 ) ;
if ( F_136 ( V_2 -> V_67 ) ) {
V_174 = F_137 ( V_2 -> V_67 ) ;
goto V_233;
}
F_32 ( V_2 , V_333 , 1 ) ;
F_32 ( V_2 , V_202 , 0 ) ;
V_2 -> V_209 = F_141 ( V_10 ,
sizeof( * V_2 -> V_209 ) ,
& V_2 -> V_210 , V_292 ) ;
if ( ! V_2 -> V_209 ) {
V_174 = - V_208 ;
...
V_2 -> V_347 = F_142 ( V_94 , 1 ) ;
if ( ( int ) V_2 -> V_347 < 0 ) {
F_6 ( V_10 , L_44 ) ;
V_174 = - V_11 ;
goto V_233;
}
V_174 = F_143 ( V_10 , V_2 -> V_347 ,
F_57 , 0 , V_348 ,
V_2 ) ;
if ( V_174 < 0 ) {
F_6 ( V_10 , L_45 ,
...
if ( V_116 ) {
V_2 -> V_116 = V_116 ;
V_174 = F_143 ( V_10 , V_2 -> V_112 , F_56 , 0 ,
V_348 , V_2 ) ;
V_2 -> V_116 -> V_117 ( V_2 -> V_116 ) ;
V_2 -> V_116 -> V_334 ( V_2 -> V_116 , true ) ;
} else {
V_174 = F_143 ( V_10 , V_2 -> V_112 , F_54 , 0 ,
V_348 , V_2 ) ;
}
if ( V_174 < 0 ) {
F_6 ( V_10 , L_45 ,
...
int F_151 ( struct V_289 * V_94 )
{
struct V_1 * V_2 = F_123 ( & V_94 -> V_10 ) ;
struct V_49 * V_50 ;
F_124 (host, &ctrl->host_list, node)
F_152 ( F_43 ( & V_50 -> V_80 ) ) ;
F_150 ( V_2 -> V_344 ) ;
