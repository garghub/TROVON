...
if ( F_30 ( V_3 ) <= V_25 -> V_50 ) {
if ( ! V_25 -> V_53 ) {
F_29 ( & V_25 -> V_45 ) ;
return V_25 -> V_57 ;
}
V_70 = F_22 () ;
V_71 = F_31 ( V_62 , V_70 - V_25 -> V_67 ,
V_25 -> V_58 ) ;
if ( V_25 -> V_54 ) {
V_72 = V_71 + V_25 -> V_63 ;
if ( V_72 > V_25 -> V_61 )
...
if ( V_71 > V_25 -> V_58 )
V_71 = V_25 -> V_58 ;
V_71 -= ( V_62 ) F_20 ( & V_25 -> V_39 , F_30 ( V_3 ) ) ;
if ( ( V_71 | V_72 ) >= 0 ) {
V_25 -> V_67 = V_70 ;
V_25 -> V_60 = V_71 ;
V_25 -> V_63 = V_72 ;
...
static int
F_32 ( struct V_2 * V_3 , struct V_14 * V_15 , int V_17 , int V_79 )
{
unsigned char * V_80 = F_33 ( V_3 ) ;
struct V_24 * V_25 = F_11 ( V_15 ) ;
struct V_22 V_81 = {
. V_35 = V_25 -> V_82 ,
. V_65 = V_25 -> V_64 ,
...
struct V_87 V_88 ;
if ( V_25 -> V_53 )
F_35 ( & V_81 . V_39 , & V_25 -> V_39 ) ;
if ( V_25 -> V_54 )
F_35 ( & V_81 . V_43 , & V_25 -> V_55 ) ;
if ( F_36 ( V_3 , V_33 , sizeof( V_81 ) , & V_81 ) )
goto V_89;
if ( V_25 -> V_57 &&
F_37 ( V_3 , V_56 , V_25 -> V_57 ) )
goto V_89;
if ( V_25 -> V_66 &&
F_37 ( V_3 , V_49 , V_25 -> V_66 ) )
goto V_89;
V_88 . V_90 = F_38 ( V_91 - V_25 -> V_73 . V_90 ) ;
V_88 . V_92 = F_38 ( V_91 - V_25 -> V_73 . V_92 ) ;
V_88 . V_93 = F_38 ( V_91 - V_25 -> V_73 . V_93 ) ;
V_88 . V_94 = F_38 ( V_25 -> V_73 . V_94 ) ;
if ( F_39 ( V_3 , V_95 , sizeof( V_88 ) , & V_88 , V_96 ) )
goto V_89;
return V_3 -> V_97 ;
V_89:
F_40 ( V_3 , V_80 ) ;
...
static int F_41 ( struct V_1 * V_1 , struct V_14 * * V_15 , T_1 V_35 )
{
struct V_8 * V_9 = F_2 ( V_1 , V_10 ) ;
return F_42 ( V_9 , V_15 , V_35 ) ;
}
static T_2 int F_43 ( struct V_1 * V_1 )
{
struct V_8 * V_9 = F_2 ( V_1 , V_10 ) ;
return F_44 ( V_9 , & V_36 , V_98 ) ;
}
static void T_3 F_45 ( struct V_1 * V_1 )
{
struct V_8 * V_9 = F_2 ( V_1 , V_10 ) ;
F_46 ( V_9 ) ;
}
