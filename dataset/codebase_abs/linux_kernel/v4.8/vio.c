...
V_169 = F_97 ( V_6 , 1 ) ;
F_98 ( & V_8 -> V_49 , L_31 , V_169 ) ;
V_8 -> V_170 = F_99 ( V_4 , 0 ) ;
V_8 -> V_169 = V_169 ;
} else {
V_6 = F_43 ( V_4 , L_32 , NULL ) ;
if ( V_6 != NULL )
V_8 -> V_120 = F_97 ( V_6 , 1 ) ;
F_98 ( & V_8 -> V_49 , L_33 , V_167 ) ;
V_8 -> type = V_167 ;
V_8 -> V_170 = 0 ;
}
V_8 -> V_162 = V_4 -> V_162 ;
...
if ( V_177 ) {
V_178 = F_108 ( V_177 , NULL ) ;
while ( V_178 ) {
F_94 ( V_178 ) ;
V_178 = F_108 ( V_177 , V_178 ) ;
}
F_5 ( V_177 ) ;
}
}
...
return sprintf ( V_103 , L_38 , F_93 ( V_4 ) ) ;
}
