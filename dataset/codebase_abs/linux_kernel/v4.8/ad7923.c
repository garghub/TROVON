...
if ( V_28 )
return V_28 ;
V_28 = F_14 ( V_5 , V_34 -> V_39 ) ;
F_20 ( V_2 ) ;
if ( V_28 < 0 )
return V_28 ;
if ( V_34 -> V_39 == F_21 ( V_28 , 12 , 4 ) )
* V_35 = F_21 ( V_28 , 0 , 12 ) ;
else
return - V_40 ;
return V_41 ;
...
static int F_22 ( struct V_47 * V_23 )
{
struct V_4 * V_5 ;
struct V_1 * V_2 ;
const struct V_48 * V_49 ;
int V_28 ;
V_2 = F_23 ( & V_23 -> V_50 , sizeof( * V_5 ) ) ;
if ( V_2 == NULL )
return - V_51 ;
V_5 = F_2 ( V_2 ) ;
F_24 ( V_23 , V_2 ) ;
...
V_5 -> V_11 = V_52 | V_32 |
F_25 ( V_53 ) ;
V_49 = & V_48 [ F_26 ( V_23 ) -> V_54 ] ;
V_2 -> V_55 = F_26 ( V_23 ) -> V_55 ;
V_2 -> V_50 . V_56 = & V_23 -> V_50 ;
V_2 -> V_50 . V_57 = V_23 -> V_50 . V_57 ;
V_2 -> V_58 = V_59 ;
V_2 -> V_60 = V_49 -> V_60 ;
V_2 -> V_61 = V_49 -> V_61 ;
V_2 -> V_49 = & V_62 ;
V_5 -> V_63 [ 0 ] . V_13 = & V_5 -> V_13 [ 0 ] ;
V_5 -> V_63 [ 0 ] . V_8 = 2 ;
V_5 -> V_63 [ 0 ] . V_15 = 1 ;
V_5 -> V_63 [ 1 ] . V_17 = & V_5 -> V_17 [ 0 ] ;
V_5 -> V_63 [ 1 ] . V_8 = 2 ;
F_7 ( & V_5 -> V_29 ) ;
F_8 ( & V_5 -> V_63 [ 0 ] , & V_5 -> V_29 ) ;
F_8 ( & V_5 -> V_63 [ 1 ] , & V_5 -> V_29 ) ;
V_5 -> V_31 = F_27 ( & V_23 -> V_50 , L_1 ) ;
if ( F_28 ( V_5 -> V_31 ) )
return F_29 ( V_5 -> V_31 ) ;
V_28 = F_30 ( V_5 -> V_31 ) ;
if ( V_28 )
return V_28 ;
V_28 = F_31 ( V_2 , NULL ,
...
static int F_35 ( struct V_47 * V_23 )
{
