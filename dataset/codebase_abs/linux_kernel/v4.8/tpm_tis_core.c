...
static int F_47 ( struct V_1 * V_2 , T_2 V_52 ,
int V_20 , int V_55 )
{
struct V_4 * V_5 = F_2 ( & V_2 -> V_6 ) ;
T_1 V_82 ;
int V_10 ;
T_2 V_83 ;
if ( F_48 ( V_2 -> V_6 . V_54 , V_55 , F_44 , V_20 ,
F_49 ( & V_2 -> V_6 ) , V_2 ) != 0 ) {
F_42 ( & V_2 -> V_6 , L_5 ,
V_55 ) ;
return - 1 ;
...
V_5 -> V_55 = V_55 ;
V_10 = F_3 ( V_5 , F_50 ( V_5 -> V_15 ) ,
& V_82 ) ;
if ( V_10 < 0 )
return V_10 ;
V_10 = F_9 ( V_5 , F_50 ( V_5 -> V_15 ) , V_55 ) ;
if ( V_10 < 0 )
return V_10 ;
V_10 = F_18 ( V_5 , F_45 ( V_5 -> V_15 ) , & V_83 ) ;
if ( V_10 < 0 )
return V_10 ;
V_10 = F_31 ( V_5 , F_45 ( V_5 -> V_15 ) , V_83 ) ;
if ( V_10 < 0 )
return V_10 ;
...
static void F_53 ( struct V_1 * V_2 , T_2 V_52 )
{
struct V_4 * V_5 = F_2 ( & V_2 -> V_6 ) ;
T_1 V_82 ;
int V_62 , V_10 ;
...
{
struct V_4 * V_5 = F_2 ( & V_2 -> V_6 ) ;
T_2 V_85 = F_30 ( V_5 -> V_15 ) ;
T_2 V_75 ;
int V_10 ;
V_10 = F_18 ( V_5 , V_85 , & V_75 ) ;
if ( V_10 < 0 )
V_75 = 0 ;
F_31 ( V_5 , V_85 , ~ V_53 & V_75 ) ;
F_8 ( V_2 , V_5 -> V_15 , 1 ) ;
}
int F_56 ( struct V_86 * V_6 , struct V_4 * V_5 , int V_55 ,
...
goto V_50;
V_5 -> V_70 = V_67 ;
V_10 = F_3 ( V_5 , F_64 ( 0 ) , & V_91 ) ;
if ( V_10 < 0 )
goto V_50;
F_42 ( V_6 , L_6 ,
( V_2 -> V_20 & V_59 ) ? L_7 : L_8 ,
V_67 >> 16 , V_91 ) ;
if ( ! ( V_5 -> V_20 & V_48 ) ) {
V_92 = F_40 ( V_2 ) ;
if ( V_92 < 0 ) {
...
V_10 = F_18 ( V_5 , F_65 ( V_5 -> V_15 ) , & V_90 ) ;
if ( V_10 < 0 )
goto V_50;
F_66 ( V_6 , L_9 ,
V_90 ) ;
...
T_2 V_52 ;
int V_10 ;
V_10 = F_9 ( V_5 , F_50 ( V_5 -> V_15 ) , V_5 -> V_55 ) ;
if ( V_10 < 0 )
return;
V_10 = F_18 ( V_5 , F_30 ( V_5 -> V_15 ) , & V_52 ) ;
if ( V_10 < 0 )
