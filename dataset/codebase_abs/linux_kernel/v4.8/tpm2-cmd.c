...
if ( ! V_5 )
* V_103 = F_26 ( V_7 . V_14 . V_110 . V_103 ) ;
return V_5 ;
}
static int F_27 ( struct V_1 * V_2 , T_4 V_111 )
{
struct V_6 V_7 ;
V_7 . V_11 . V_12 = V_112 ;
...
void F_28 ( struct V_1 * V_2 , T_4 V_114 )
{
struct V_6 V_7 ;
int V_5 ;
V_7 . V_11 . V_12 = V_115 ;
...
unsigned long F_29 ( struct V_1 * V_2 , T_3 V_116 )
{
int V_117 = V_118 ;
int V_119 = 0 ;
...
if ( V_117 != V_118 )
V_119 = V_2 -> V_119 [ V_117 ] ;
if ( V_119 <= 0 )
V_119 = 2 * 60 * V_123 ;
return V_119 ;
}
static int F_30 ( struct V_1 * V_2 , bool V_124 )
{
int V_5 ;
struct V_6 V_7 ;
V_7 . V_11 . V_12 = V_125 ;
...
struct V_6 V_7 ;
int V_62 ;
V_119 = F_29 ( V_2 , V_132 ) ;
V_130 = F_32 ( V_119 ) / V_131 ;
V_5 = F_30 ( V_2 , true ) ;
if ( V_5 )
return V_5 ;
