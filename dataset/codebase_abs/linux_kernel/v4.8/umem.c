...
V_4 -> V_49 = NULL ;
V_4 -> V_50 = 1 ;
V_21 = (struct V_8 * * ) F_16 ( V_35 ) ;
if ( ! V_21 ) {
F_15 ( V_4 ) ;
return F_9 ( - V_36 ) ;
}
V_23 = (struct V_22 * * ) F_16 ( V_35 ) ;
if ( ! V_23 )
V_4 -> V_50 = 0 ;
V_27 = F_17 ( V_4 ) ;
F_18 ( & V_42 -> V_51 -> V_52 ) ;
...
return V_28 < 0 ? F_9 ( V_28 ) : V_4 ;
}
static void F_30 ( struct V_60 * V_61 )
{
struct V_3 * V_4 = F_31 ( V_61 , struct V_3 , V_61 ) ;
F_18 ( & V_4 -> V_51 -> V_52 ) ;
...
int F_44 ( void * V_70 , struct V_3 * V_4 , T_1 V_71 ,
T_1 V_37 )
{
T_1 V_72 = V_71 + V_37 ;
int V_28 ;
...
V_28 = F_46 ( V_4 -> V_11 . V_12 , V_4 -> V_10 , V_70 , V_37 ,
V_71 + F_47 ( V_4 ) ) ;
if ( V_28 < 0 )
return V_28 ;
else if ( V_28 != V_37 )
