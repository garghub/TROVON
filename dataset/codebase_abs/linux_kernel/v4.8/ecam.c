...
V_12 = 1 << V_8 -> V_24 ;
V_9 -> V_25 . V_16 = V_5 -> V_16 ;
V_9 -> V_25 . V_17 = V_5 -> V_17 ;
V_9 -> V_25 . V_22 = V_26 | V_27 ;
V_9 -> V_25 . V_28 = L_2 ;
V_13 = F_6 ( & V_29 , & V_9 -> V_25 ) ;
if ( V_13 ) {
V_15 = - V_30 ;
F_7 ( V_3 , L_3 ,
& V_9 -> V_25 , V_13 -> V_28 , V_13 ) ;
goto V_31;
}
if ( V_32 ) {
V_9 -> V_33 = F_8 ( V_10 , sizeof( * V_9 -> V_33 ) , V_19 ) ;
if ( ! V_9 -> V_33 )
goto V_34;
for ( V_14 = 0 ; V_14 < V_10 ; V_14 ++ ) {
V_9 -> V_33 [ V_14 ] = F_9 ( V_5 -> V_16 + V_14 * V_12 , V_12 ) ;
if ( ! V_9 -> V_33 [ V_14 ] )
goto V_35;
}
} else {
V_9 -> V_36 = F_9 ( V_5 -> V_16 , V_10 * V_12 ) ;
if ( ! V_9 -> V_36 )
goto V_35;
}
if ( V_8 -> V_37 ) {
...
unsigned int V_43 = V_9 -> V_8 -> V_24 - 8 ;
...
V_46 = V_9 -> V_36 + ( V_44 << V_9 -> V_8 -> V_24 ) ;
