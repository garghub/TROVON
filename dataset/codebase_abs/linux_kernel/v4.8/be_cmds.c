...
int F_204 ( struct V_1 * V_2 , T_2 V_783 )
{
struct V_163 V_784 ;
struct V_785 * V_786 ;
int V_45 ;
...
T_1 V_808 )
{
return F_209 ( V_361 , V_806 , true , V_808 ) ;
}
static struct V_805 * F_211 ( T_1 * V_361 , T_2 V_806 ,
T_1 V_808 )
{
return F_209 ( V_361 , V_806 , false , V_808 ) ;
}
static struct V_818 * F_212 ( T_1 * V_361 , T_2 V_806 ,
T_1 V_808 )
{
struct V_809 * V_224 = (struct V_809 * ) V_361 ;
struct V_818 * V_819 ;
...
static struct V_822 * F_213 ( T_1 * V_361 , T_2 V_806 )
{
struct V_809 * V_224 = (struct V_809 * ) V_361 ;
int V_5 ;
for ( V_5 = 0 ; V_5 < V_806 ; V_5 ++ ) {
...
static void F_214 ( struct V_824 * V_825 ,
struct V_805 * V_826 )
{
...
int F_215 ( struct V_1 * V_2 , struct V_824 * V_825 )
{
struct V_11 * V_12 ;
struct V_849 * V_220 ;
int V_45 ;
...
T_3 F_216 ( T_1 * V_361 , T_2 V_806 , T_3 * V_854 )
{
struct V_809 * V_224 = (struct V_809 * ) V_361 ;
struct V_818 * V_819 = NULL ;
int V_5 ;
T_3 V_855 = 0 ;
for ( V_5 = 0 ; V_5 < V_806 ; V_5 ++ ) {
if ( V_224 -> V_811 == V_820 ||
V_224 -> V_811 == V_821 ) {
V_819 = (struct V_818 * ) V_224 ;
if ( V_819 -> V_856 && ( V_819 -> V_857 == V_858 ||
V_819 -> V_857 == V_859 ) ) {
V_854 [ V_855 ++ ] = V_819 -> V_808 ;
}
}
V_224 -> V_816 = V_224 -> V_816 ? : V_817 ;
V_224 = ( void * ) V_224 + V_224 -> V_816 ;
...
int V_45 ;
memset ( & V_459 , 0 , sizeof( struct V_163 ) ) ;
V_459 . V_202 = sizeof( struct V_864 ) ;
V_459 . V_167 = F_130 ( & V_2 -> V_69 -> V_70 , V_459 . V_202 , & V_459 . V_169 ,
V_368 ) ;
if ( ! V_459 . V_167 )
return - V_369 ;
...
T_3 V_870 = 0 , V_5 ;
T_3 V_871 [ V_872 ] ;
V_870 = F_216 ( V_60 -> V_852 ,
V_806 ,
V_871 ) ;
for ( V_5 = 0 ; V_5 < V_870 ; V_5 ++ ) {
V_810 = F_211 ( V_60 -> V_852 , V_806 ,
V_871 [ V_5 ] ) ;
if ( V_810 -> V_873 == V_2 -> V_111 ) {
V_861 -> V_874 ++ ;
V_819 = F_212 ( V_60 -> V_852 ,
V_806 ,
V_871 [ V_5 ] ) ;
V_861 -> V_875 += F_29 ( V_819 -> V_876 ) ;
}
}
return V_45 ;
}
V_819 = F_212 ( V_60 -> V_852 , V_806 ,
V_2 -> V_808 ) ;
if ( V_819 )
V_825 -> V_875 = F_29 ( V_819 -> V_876 ) ;
V_465 = F_213 ( V_60 -> V_852 , V_806 ) ;
if ( V_465 )
V_2 -> V_877 = V_465 -> V_877 ;
V_810 = F_211 ( V_60 -> V_852 , V_806 ,
V_2 -> V_808 ) ;
if ( V_810 )
F_214 ( V_825 , V_810 ) ;
V_866 = F_210 ( V_60 -> V_852 , V_806 ,
V_2 -> V_808 ) ;
if ( V_866 )
V_825 -> V_878 = V_866 -> V_321 ;
V_182:
if ( V_459 . V_167 )
F_131 ( & V_2 -> V_69 -> V_70 , V_459 . V_202 , V_459 . V_167 ,
V_459 . V_169 ) ;
...
static int F_218 ( struct V_1 * V_2 , void * V_826 ,
...
int V_45 ;
memset ( & V_459 , 0 , sizeof( struct V_163 ) ) ;
V_459 . V_202 = sizeof( struct V_879 ) ;
V_459 . V_167 = F_130 ( & V_2 -> V_69 -> V_70 , V_459 . V_202 , & V_459 . V_169 ,
V_368 ) ;
if ( ! V_459 . V_167 )
return - V_369 ;
...
V_810 -> V_844 = 0xFFFF ;
V_810 -> V_873 = 0xFF ;
V_810 -> V_883 = F_100 ( 0xF000 ) ;
V_810 -> V_884 = 0xFF ;
V_810 -> V_885 = 0x0F ;
V_810 -> V_886 = 0xFFFF ;
V_810 -> V_887 = 0xFFFF ;
V_810 -> V_888 = 0xFFFFFFFF ;
V_810 -> V_889 = 0xFFFFFFFF ;
}
static void F_220 ( struct V_818 * V_819 )
{
...
int F_221 ( struct V_1 * V_2 , T_2 V_891 , T_3 V_74 ,
T_1 V_245 )
{
struct V_805 V_892 ;
T_2 V_893 ;
T_3 V_194 = 0 ;
if ( F_120 ( V_2 ) )
return F_183 ( V_2 , V_891 / 10 , V_245 ) ;
F_219 ( & V_892 ) ;
V_892 . V_808 = V_2 -> V_808 ;
V_892 . V_853 = V_245 ;
V_892 . V_888 = 0 ;
if ( F_74 ( V_2 ) ) {
V_892 . V_224 . V_811 = V_812 ;
V_892 . V_224 . V_816 = V_817 ;
V_892 . V_28 = ( 1 << V_894 ) | ( 1 << V_895 ) |
( 1 << V_896 ) ;
V_892 . V_889 = F_80 ( V_891 / 10 ) ;
} else {
V_194 = 1 ;
V_892 . V_224 . V_811 = V_813 ;
V_892 . V_224 . V_816 = V_897 ;
V_892 . V_28 = ( 1 << V_895 ) | ( 1 << V_896 ) ;
V_893 = V_891 ? ( V_891 * 100 ) / V_74 : 100 ;
V_892 . V_889 = F_80 ( V_893 ) ;
}
return F_218 ( V_2 , & V_892 ,
V_892 . V_224 . V_816 ,
1 , V_194 , V_245 ) ;
}
int F_222 ( struct V_1 * V_2 ,
struct V_824 V_898 , T_3 V_876 ,
struct V_824 * V_899 )
{
struct {
struct V_818 V_819 ;
...
V_826 . V_819 . V_224 . V_816 = V_897 ;
V_826 . V_819 . V_28 = F_111 ( V_895 ) | F_111 ( V_896 ) ;
V_826 . V_819 . V_808 = V_2 -> V_69 -> V_902 ;
V_826 . V_819 . V_890 = V_876 ? 1 : 0 ;
V_826 . V_819 . V_876 = F_100 ( V_876 ) ;
F_219 ( & V_826 . V_900 ) ;
V_826 . V_900 . V_224 . V_811 = V_813 ;
V_826 . V_900 . V_224 . V_816 = V_897 ;
V_826 . V_900 . V_28 = V_899 -> V_28 | F_111 ( V_815 ) |
F_111 ( V_895 ) | F_111 ( V_896 ) ;
V_826 . V_900 . V_808 = V_2 -> V_69 -> V_902 ;
V_826 . V_900 . V_853 = 0 ;
V_826 . V_900 . V_321 = F_80 ( V_899 -> V_878 ) ;
V_826 . V_900 . V_838 = F_100 ( V_899 -> V_837 ) ;
V_826 . V_900 . V_834 = F_100 ( V_899 -> V_833 ) ;
V_826 . V_900 . V_836 = F_100 ( V_899 -> V_835 ) ;
V_826 . V_900 . V_842 = F_100 ( V_899 -> V_841 ) ;
if ( V_899 -> V_827 )
V_826 . V_900 . V_828 =
F_100 ( V_899 -> V_827 ) ;
if ( V_899 -> V_829 )
V_826 . V_900 . V_830 = F_100 ( V_899 -> V_829 ) ;
if ( V_899 -> V_843 )
V_826 . V_900 . V_844 =
F_100 ( V_899 -> V_843 ) ;
if ( V_899 -> V_845 )
V_826 . V_900 . V_846 = F_100 ( V_899 -> V_845 ) ;
return F_218 ( V_2 , & V_826 ,
2 * V_897 , 2 , 1 , 0 ) ;
}
int F_223 ( struct V_1 * V_2 , T_2 V_903 , T_1 V_904 )
{
struct V_11 * V_12 ;
struct V_905 * V_220 ;
int V_45 ;
...
V_12 , NULL ) ;
V_220 -> V_904 = V_904 ;
V_220 -> V_907 = F_80 ( V_903 ) ;
V_45 = F_60 ( V_2 ) ;
V_182:
F_47 ( & V_2 -> V_212 ) ;
return V_45 ;
}
int F_224 ( struct V_1 * V_2 , T_7 V_465 )
{
struct V_822 V_908 ;
memset ( & V_908 , 0 , sizeof( V_908 ) ) ;
V_908 . V_224 . V_811 = V_823 ;
V_908 . V_224 . V_816 = V_897 ;
V_908 . V_28 = ( 1 << V_895 ) | ( 1 << V_896 ) ;
V_908 . V_909 = V_2 -> V_91 ;
if ( V_465 ) {
V_908 . V_910 = V_911 | ( 1 << V_912 ) |
( 1 << V_913 ) ;
V_908 . V_914 = F_225 ( V_465 ) ;
} else {
V_908 . V_910 = V_915 ;
V_908 . V_914 = 0 ;
}
return F_218 ( V_2 , & V_908 ,
V_897 , 1 , 1 , 0 ) ;
}
int F_226 ( struct V_1 * V_2 , struct V_916 * V_917 ,
int V_853 )
{
struct V_11 * V_12 ;
struct V_918 * V_220 ;
...
V_45 = F_60 ( V_2 ) ;
if ( ! V_45 ) {
V_60 = (struct V_919 * ) V_220 ;
V_917 -> V_236 = F_8 ( V_60 -> V_921 . V_241 ) ;
}
V_182:
F_47 ( & V_2 -> V_212 ) ;
return V_45 ;
...
T_2 V_922 ;
int V_45 = 0 , V_5 ;
for ( V_5 = 0 ; V_5 < F_228 ; V_5 ++ ) {
V_922 = F_64 ( V_2 -> V_24 + V_923 ) ;
if ( ( V_922 & V_924 ) == 0 )
break;
F_229 ( 1 ) ;
}
...
int F_171 ( struct V_1 * V_2 , T_2 V_925 )
{
int V_45 = 0 ;
V_45 = F_227 ( V_2 ) ;
if ( V_45 )
return V_45 ;
F_6 ( V_925 , V_2 -> V_24 + V_923 ) ;
return V_45 ;
}
bool F_230 ( struct V_1 * V_2 )
{
T_2 V_175 = 0 ;
V_175 = F_64 ( V_2 -> V_24 + V_176 ) ;
return ! ! ( V_175 & V_926 ) ;
...
{
int V_45 ;
V_45 = F_155 ( V_2 , V_929 ) ;
return F_170 ( V_45 ) ;
}
int F_233 ( struct V_1 * V_2 , T_1 V_245 )
{
struct V_11 * V_12 ;
struct V_930 * V_220 ;
int V_45 ;
...
int F_234 ( struct V_1 * V_2 , bool V_932 )
{
struct V_11 * V_12 ;
struct V_933 * V_220 ;
int V_45 ;
...
int F_235 ( struct V_1 * V_2 , T_3 * V_936 )
{
struct V_937 * V_220 ;
struct V_11 * V_12 ;
int V_45 ;
...
int F_238 ( void * V_949 , void * V_950 ,
int V_951 , T_3 * V_952 , T_3 * V_953 )
{
struct V_1 * V_2 = F_239 ( V_949 ) ;
struct V_11 * V_12 ;
struct V_188 * V_224 = (struct V_188 * ) V_950 ;
struct V_188 * V_220 ;
struct V_30 * V_60 ;
int V_45 ;
F_45 ( & V_2 -> V_212 ) ;
...
V_224 -> V_3 , V_951 , V_12 , NULL ) ;
memcpy ( V_220 , V_950 , V_951 ) ;
F_81 ( V_220 , V_951 ) ;
V_45 = F_60 ( V_2 ) ;
if ( V_952 )
* V_952 = ( V_45 & 0xffff ) ;
if ( V_953 )
* V_953 = 0 ;
memcpy ( V_950 , V_60 , sizeof( * V_60 ) + V_60 -> V_954 ) ;
F_16 ( V_950 , sizeof( * V_60 ) + V_60 -> V_954 ) ;
V_182:
F_47 ( & V_2 -> V_212 ) ;
return V_45 ;
}
