...
static void F_14 ( struct V_42 * V_49 ,
struct V_42 * V_50 ,
struct V_25 * V_34 )
{
T_2 V_51 = F_15 ( V_50 -> time , V_49 -> time ) ;
...
void F_16 ( struct V_55 * V_56 )
{
struct V_10 * V_11 = F_17 ( V_56 , struct V_10 ,
V_56 ) ;
struct V_40 * V_41 = F_17 ( V_11 , struct V_40 , V_11 ) ;
struct V_1 V_57 = V_4 [ V_11 -> V_58 ] [ V_11 -> V_22 ] ;
F_18 ( V_41 -> V_59 -> V_60 , & V_41 -> V_48 . V_61 ,
V_57 . V_62 , V_57 . V_63 ) ;
V_11 -> V_64 = V_65 ;
}
