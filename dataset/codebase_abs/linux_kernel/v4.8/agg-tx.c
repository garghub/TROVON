...
F_69 ( V_97 , & V_59 -> V_94 ) ;
V_59 -> V_8 = V_8 ;
V_59 -> V_98 . V_139 = F_51 ;
V_59 -> V_98 . V_105 = ( unsigned long ) & V_57 -> V_106 [ V_4 ] ;
F_70 ( & V_59 -> V_98 ) ;
V_59 -> V_99 . V_139 = F_59 ;
V_59 -> V_99 . V_105 = ( unsigned long ) & V_57 -> V_106 [ V_4 ] ;
F_71 ( & V_59 -> V_99 ) ;
V_57 -> V_60 . V_140 ++ ;
V_59 -> V_5 = V_57 -> V_60 . V_140 ;
V_57 -> V_60 . V_135 [ V_4 ] = V_59 ;
F_72 ( & V_10 -> V_16 , & V_57 -> V_60 . V_141 ) ;
V_132:
F_27 ( & V_57 -> V_62 ) ;
return V_84 ;
}
...
if ( F_81 ( ! V_12 ) )
return;
V_147 = (struct V_146 * ) & V_12 -> V_148 ;
memcpy ( & V_147 -> V_41 , V_41 , V_18 ) ;
V_147 -> V_4 = V_4 ;
V_12 -> V_149 = V_150 ;
F_82 ( & V_2 -> V_151 , V_12 ) ;
F_72 ( & V_10 -> V_16 , & V_2 -> V_141 ) ;
}
...
T_1 V_82 ;
bool V_83 ;
V_15 = F_90 ( V_14 -> V_27 . V_34 . V_27 . V_158 . V_15 ) ;
V_83 = V_15 & V_159 ;
V_4 = ( V_15 & V_160 ) >> 2 ;
V_82 = ( V_15 & V_161 ) >> 6 ;
V_82 = F_91 ( V_82 , V_10 -> V_16 . V_162 ) ;
V_68 = V_57 -> V_57 . V_68 [ V_4 ] ;
if ( ! V_83 && V_68 )
F_26 ( V_163 , & F_24 ( V_68 ) -> V_53 ) ;
F_76 ( & V_57 -> V_60 . V_61 ) ;
V_59 = F_39 ( V_57 , V_4 ) ;
if ( ! V_59 )
goto V_164;
if ( V_14 -> V_27 . V_34 . V_27 . V_158 . V_5 != V_59 -> V_5 ) {
F_47 ( V_57 -> V_2 , L_21 ,
V_57 -> V_57 . V_21 , V_4 ) ;
goto V_164;
}
...
if ( F_90 ( V_14 -> V_27 . V_34 . V_27 . V_158 . V_165 )
== V_166 && V_82 ) {
if ( F_79 ( V_107 ,
& V_59 -> V_94 ) ) {
goto V_164;
