...
V_1 -> V_90 = V_3 -> V_140 . V_141 == V_142 ? L_37 : L_38 ;
F_22 ( V_143 L_39 , V_1 -> V_90 ,
( unsigned long ) V_3 -> V_144 . V_126 ) ;
for ( V_74 = 0 ; V_74 < V_99 ; V_74 ++ ) {
V_139 = & ( * V_139 ) -> V_93 ;
}
* V_139 = V_1 ;
V_1 -> V_98 = V_3 -> V_98 ;
V_1 -> V_38 = F_78 ( V_3 -> V_144 . V_126 , 4096 ) ;
F_60 ( V_1 ) ;
F_67 ( V_1 ) ;
V_145 = & V_146 ;
V_3 -> V_3 . V_147 = F_77 ( sizeof( struct V_148 ) , V_109 ) ;
F_4 ( V_3 -> V_3 . V_147 == NULL ) ;
F_79 ( V_3 -> V_3 . V_147 ) -> V_149 = V_1 ;
#ifdef F_80
if ( V_99 == 0 ) {
F_81 ( V_150 , 0 , V_151 ,
& V_152 ) ;
F_81 ( V_150 L_40 , 0 , V_151 ,
& V_153 ) ;
}
#endif
V_99 ++ ;
