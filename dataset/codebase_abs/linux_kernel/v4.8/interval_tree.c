...
static inline T_1 F_7 ( T_1 V_15 , T_1 V_16 )
{
...
while ( * V_27 ) {
V_23 = * V_27 ;
if ( F_6 ( & V_23 -> V_28 , & V_2 -> V_28 ) )
return V_23 ;
if ( V_23 -> V_20 < F_11 ( V_2 ) )
V_23 -> V_20 = F_11 ( V_2 ) ;
if ( F_5 ( & V_2 -> V_28 , & V_23 -> V_28 ) < 0 )
V_27 = & V_23 -> V_4 ;
else
V_27 = & V_23 -> V_5 ;
}
