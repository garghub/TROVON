...
V_183 = F_80 ( V_2 -> V_189 ) ;
if ( V_183 )
return V_183 ;
V_183 = F_80 ( V_2 -> V_190 ) ;
if ( V_183 )
goto V_191;
F_8 ( V_2 , V_192 , V_193 ) ;
if ( F_1 ( V_2 ) ) {
...
V_2 -> V_175 . V_203 = F_51 ;
V_2 -> V_175 . V_204 = F_56 ;
V_2 -> V_175 . V_205 = F_47 ;
V_2 -> V_175 . V_206 = F_60 ;
V_2 -> V_175 . V_207 = F_62 ;
V_2 -> V_175 . V_208 = F_65 ;
V_2 -> V_175 . V_209 = F_66 ;
V_2 -> V_175 . V_210 = F_44 ;
V_2 -> V_175 . V_211 = F_42 ;
V_2 -> V_175 . V_212 = F_67 ;
F_87 ( V_178 , V_2 ) ;
...
static void F_93 ( struct V_177 * V_178 , struct V_1 * V_2 )
{
int V_44 ;
if ( F_1 ( V_2 ) ) {
F_94 ( V_2 -> V_41 ) ;
...
{
struct V_1 * V_2 = F_97 ( V_178 ) ;
F_93 ( V_178 , V_2 ) ;
F_91 ( & V_2 -> V_175 ) ;
if ( V_178 -> V_29 . V_216 )
F_98 ( V_178 -> V_29 . V_216 ) ;
F_92 ( V_2 -> V_189 ) ;
F_92 ( V_2 -> V_190 ) ;
return 0 ;
}
