...
switch ( V_14 ) {
case 4 :
V_110 = F_37 ( union V_41 , V_86 . V_84 ) ;
break;
case 2 :
V_110 = F_37 ( union V_41 , V_89 . V_87 ) ;
break;
}
V_41 . V_37 = 0 ;
V_35 = 0 ;
...
case V_97 + V_67 :
case V_97 + V_106 + V_67 :
if ( V_14 == 2 )
V_41 . V_37 = V_41 . V_89 . V_87 ;
else
V_41 . V_37 = V_41 . V_86 . V_84 ;
break;
case V_97 + V_106 + V_111 :
#ifdef F_38
F_39 () ;
F_40 () ;
F_44 ( ( float * ) & V_41 . V_86 . V_84 , & V_41 . V_83 ) ;
F_42 () ;
F_43 () ;
#else
return 0 ;
