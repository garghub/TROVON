...
{
return V_37 -> V_218 == (struct V_219 * ) V_217 ;
}
static void F_116 ( struct V_2 * V_2 , struct V_219 * V_121 )
{
struct V_1 * V_7 = F_1 ( V_2 ) ;
int V_41 ;
F_110 () ;
...
static struct V_6 *
F_119 ( struct V_1 * V_7 , T_8 V_4 , T_3 V_226 )
{
struct V_6 * V_35 ;
V_35 = F_4 ( V_7 , V_4 ) ;
if ( ! V_35 )
...
static struct V_229 *
F_120 ( const struct V_83 * const V_230 [] )
{
struct V_229 * V_231 ;
unsigned int V_232 ;
if ( ! V_230 [ V_233 ] )
...
V_232 = F_121 ( V_231 -> V_232 ) & V_234 ;
if ( V_232 > V_235 || V_232 == V_236 )
return NULL ;
return V_231 ;
}
static int F_122 ( unsigned int V_40 , unsigned int V_237 )
{
return ( int ) ( V_40 - V_237 ) > 0 ;
}
static int F_123 ( struct V_2 * V_2 , struct V_58 * V_238 ,
struct V_46 * V_57 ,
...
if ( ! V_231 )
return - V_199 ;
V_232 = F_121 ( V_231 -> V_232 ) ;
V_240 = F_121 ( V_231 -> V_40 ) ;
F_29 ( & V_35 -> V_27 ) ;
F_32 (entry, tmp, &queue->queue_list, list) {
if ( F_122 ( V_37 -> V_40 , V_240 ) )
break;
F_26 ( V_35 , V_37 ) ;
...
if ( V_230 [ V_155 ] )
V_37 -> V_57 -> V_154 = F_121 ( F_130 ( V_230 [ V_155 ] ) ) ;
F_33 ( V_37 , V_232 ) ;
}
return 0 ;
}
static struct V_108 * F_131 ( struct V_113 * V_114 ,
const struct V_101 * V_102 ,
const struct V_83 * const V_230 [] ,
struct V_36 * V_37 ,
enum V_110 * V_112 )
...
int V_14 ;
V_14 = F_134 ( V_246 , V_247 , V_230 [ V_85 ] ,
V_248 ) ;
if ( V_14 < 0 )
return V_14 ;
if ( ! V_246 [ V_87 ] || ! V_246 [ V_89 ] )
return - V_199 ;
V_37 -> V_57 -> V_88 = F_125 ( F_135 ( V_246 [ V_87 ] ) ) ;
V_37 -> V_57 -> V_90 = F_135 ( V_246 [ V_89 ] ) ;
}
if ( V_230 [ V_92 ] ) {
...
static int F_136 ( struct V_2 * V_2 , struct V_58 * V_238 ,
struct V_46 * V_57 ,
const struct V_101 * V_102 ,
const struct V_83 * const V_230 [] )
{
struct V_103 * V_104 = F_70 ( V_102 ) ;
T_2 V_4 = F_125 ( V_104 -> V_139 ) ;
struct V_229 * V_231 ;
struct V_6 * V_35 ;
unsigned int V_232 ;
struct V_36 * V_37 ;
...
return - V_199 ;
V_232 = F_121 ( V_231 -> V_232 ) ;
V_37 = F_28 ( V_35 , F_121 ( V_231 -> V_40 ) ) ;
if ( V_37 == NULL )
return - V_242 ;
V_114 = F_65 ( V_113 ) ;
if ( V_230 [ V_171 ] ) {
if ( V_114 != NULL )
V_109 = F_131 ( V_114 , V_102 , V_230 , V_37 , & V_112 ) ;
}
if ( V_37 -> V_77 . V_78 == V_79 ) {
V_14 = F_133 ( V_37 , V_230 ) ;
if ( V_14 < 0 )
return V_14 ;
}
if ( V_230 [ V_175 ] ) {
...
V_50 = F_121 ( F_130 ( V_230 [ V_260 ] ) ) ;
V_255 = F_121 ( F_130 ( V_230 [ V_261 ] ) ) ;
if ( V_50 >= V_262 )
return - V_263 ;
#if ! F_45 ( V_73 )
if ( V_50 & V_255 & V_133 )
...
F_110 () ;
V_35 = F_4 ( V_7 , V_4 ) ;
if ( V_35 && V_35 -> V_20 != F_126 ( V_57 ) . V_12 ) {
V_192 = - V_228 ;
goto V_188;
}
if ( V_254 != NULL ) {
