...
if ( ! V_189 )
return NULL ;
if ( F_47 ( V_27 , L_18 , & V_191 ) >= 0 )
V_189 -> V_193 = F_43 ( V_27 , V_191 ) ;
else
V_189 -> V_193 = V_180 ;
if ( ! F_48 ( V_27 , L_19 , & V_190 ) )
V_189 -> V_194 = F_44 ( V_27 , V_190 ) ;
else
V_189 -> V_194 = V_185 ;
return V_189 ;
}
...
V_8 -> V_210 [ V_44 ] . V_211 = V_212 [ V_44 ] ;
V_9 = F_54 ( V_6 -> V_27 , V_209 ,
V_8 -> V_210 ) ;
if ( V_9 ) {
F_30 ( V_6 -> V_27 , L_21 ) ;
return V_9 ;
}
V_206 = V_8 -> V_210 [ V_213 ] . V_214 ;
V_9 = F_55 ( V_206 ) ;
if ( V_9 < 1200000 )
F_16 ( V_6 -> V_27 , L_22 ) ;
else if ( V_9 < 2800000 )
V_207 = V_215 ;
V_9 = F_56 ( V_209 , V_8 -> V_210 ) ;
if ( V_9 ) {
F_30 ( V_6 -> V_27 , L_23 ) ;
return V_9 ;
}
F_17 ( V_6 , V_216 , V_217 ) ;
F_17 ( V_6 , V_218 , V_207 ) ;
return 0 ;
}
...
V_8 -> V_189 = F_63 ( V_6 -> V_27 ) ;
if ( ! V_8 -> V_189 )
V_8 -> V_189 = F_45 ( V_6 ) ;
F_57 ( V_6 ) ;
V_8 -> V_70 = F_64 ( V_6 -> V_27 , L_26 ) ;
if ( F_65 ( V_8 -> V_70 ) ) {
if ( F_66 ( V_8 -> V_70 ) != - V_227 ) {
V_9 = F_66 ( V_8 -> V_70 ) ;
goto V_224;
} else {
V_8 -> V_70 = NULL ;
...
V_237 ,
V_237 ) ;
F_17 ( V_6 , V_238 , V_239 ) ;
V_9 = F_67 ( V_6 ) ;
if ( V_9 )
goto V_224;
return 0 ;
V_224:
F_68 ( V_209 , V_8 -> V_210 ) ;
return V_9 ;
}
...
static bool F_74 ( struct V_176 * V_27 , unsigned int V_35 )
{
switch ( V_35 ) {
case V_240 :
case V_241 :
...
static int F_75 ( struct V_259 * V_260 ,
const struct V_261 * V_262 )
{
struct V_7 * V_8 ;
int V_9 ;
V_8 = F_46 ( & V_260 -> V_27 , sizeof( struct V_7 ) ,
V_192 ) ;
if ( ! V_8 )
return - V_263 ;
F_76 ( V_260 , V_8 ) ;
V_8 -> V_37 = F_77 ( V_260 , & V_264 ) ;
if ( F_65 ( V_8 -> V_37 ) ) {
V_9 = F_66 ( V_8 -> V_37 ) ;
F_30 ( & V_260 -> V_27 , L_27 , V_9 ) ;
return V_9 ;
}
V_9 = F_78 ( & V_260 -> V_27 , & V_265 ,
& V_266 , 1 ) ;
if ( V_9 < 0 ) {
F_30 ( & V_260 -> V_27 , L_28 ,
V_9 ) ;
}
return V_9 ;
}
static int F_79 ( struct V_259 * V_267 )
{
F_80 ( & V_267 -> V_27 ) ;
return 0 ;
}
