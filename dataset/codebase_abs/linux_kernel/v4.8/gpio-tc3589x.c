...
static void F_5 ( struct V_1 * V_2 , unsigned V_3 , int V_10 )
{
struct V_4 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_5 = V_4 -> V_5 ;
T_1 V_6 = V_7 + ( V_3 / 8 ) * 2 ;
...
static int F_12 ( struct V_24 * V_25 , unsigned int type )
{
struct V_1 * V_26 = F_13 ( V_25 ) ;
...
F_17 ( V_5 , V_38 [ V_44 ] + V_45 * 8 , V_50 ) ;
}
}
F_18 ( & V_4 -> V_37 ) ;
}
...
static T_2 F_21 ( int V_51 , void * V_52 )
{
struct V_4 * V_4 = V_52 ;
struct V_5 * V_5 = V_4 -> V_5 ;
T_1 V_53 [ V_47 ] ;
...
int V_51 = F_24 ( V_4 -> V_2 . V_58 ,
line ) ;
F_25 ( V_51 ) ;
V_56 &= ~ ( 1 << V_57 ) ;
}
F_17 ( V_5 , V_59 + V_44 , V_53 [ V_44 ] ) ;
}
return V_60 ;
}
static int F_26 ( struct V_61 * V_62 )
{
struct V_5 * V_5 = F_27 ( V_62 -> V_52 . V_63 ) ;
...
if ( V_51 < 0 )
return V_51 ;
V_4 = F_30 ( & V_62 -> V_52 , sizeof( struct V_4 ) ,
V_68 ) ;
if ( ! V_4 )
return - V_69 ;
F_31 ( & V_4 -> V_37 ) ;
...
V_4 ) ;
if ( V_9 ) {
F_28 ( & V_62 -> V_52 , L_3 , V_9 ) ;
return V_9 ;
}
V_9 = F_33 ( & V_62 -> V_52 , & V_4 -> V_2 ,
V_4 ) ;
if ( V_9 ) {
F_28 ( & V_62 -> V_52 , L_4 , V_9 ) ;
return V_9 ;
}
V_9 = F_34 ( & V_4 -> V_2 ,
& V_77 ,
