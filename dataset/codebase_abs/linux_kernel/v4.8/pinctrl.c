...
return - V_105 ;
V_110 = V_5 -> V_6 -> V_107 -> V_111 ( V_5 , V_92 , & V_109 ) ;
if ( F_43 ( V_110 < 0 , L_15 , V_92 ) )
return V_110 ;
F_26 ( & V_5 -> V_63 , V_62 ) ;
V_89 = F_36 ( V_5 , V_109 , 32 ) ;
F_29 ( & V_5 -> V_63 , V_62 ) ;
* V_104 = ( V_89 & F_44 ( V_110 ) ) ? 3300 : 1800 ;
break;
}
default:
return - V_105 ;
...
static int F_45 ( struct V_1 * V_2 , unsigned V_92 ,
...
return - V_105 ;
F_26 ( & V_5 -> V_63 , V_62 ) ;
V_5 -> V_6 -> V_107 -> V_112 ( V_5 , V_92 , V_94 ) ;
F_29 ( & V_5 -> V_63 , V_62 ) ;
break;
case V_100 : {
unsigned int V_113 =
F_46 ( V_22 [ V_54 ] ) ;
int V_43 ;
V_43 = F_38 ( V_5 , V_92 , V_113 ) ;
if ( V_43 < 0 )
return V_43 ;
break;
}
case V_102 : {
unsigned int V_114 = F_46 ( V_22 [ V_54 ] ) ;
T_1 V_109 , V_89 ;
int V_110 ;
if ( ! V_5 -> V_6 -> V_107 || ! V_5 -> V_6 -> V_107 -> V_111 )
return - V_105 ;
...
static int F_47 ( struct V_1 * V_2 , unsigned V_41 ,
unsigned long * V_22 ,
unsigned V_23 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
F_45 ( V_2 , V_11 [ V_54 ] , V_22 , V_23 ) ;
return 0 ;
}
static int F_48 ( struct V_59 * V_5 , struct V_3 * V_4 )
{
unsigned int V_54 ;
V_4 -> V_11 = F_49 ( V_5 -> V_33 ,
sizeof( * V_4 -> V_11 ) * V_5 -> V_6 -> V_13 ,
V_25 ) ;
if ( F_50 ( ! V_4 -> V_11 ) )
return - V_26 ;
V_4 -> V_22 = F_49 ( V_5 -> V_33 ,
...
int F_51 ( struct V_59 * V_5 )
{
struct V_3 * V_4 ;
int V_43 ;
V_4 = F_49 ( V_5 -> V_33 , sizeof( * V_4 ) , V_25 ) ;
if ( F_50 ( ! V_4 ) )
return - V_26 ;
V_4 -> V_5 = V_5 ;
V_43 = F_48 ( V_5 , V_4 ) ;
...
V_4 -> V_127 = F_52 ( V_5 -> V_33 , & V_4 -> V_117 , V_4 ) ;
return F_53 ( V_4 -> V_127 ) ;
}
