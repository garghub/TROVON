...
if ( V_2 -> V_17 > V_36 )
return - V_37 ;
V_2 -> V_19 = F_15 ( V_2 -> V_17 * 3 * 4 , V_38 ) ;
if ( ! V_2 -> V_19 )
return - V_39 ;
V_2 -> V_35 = 0 ;
V_2 -> V_15 ++ ;
...
V_26 -> V_40 . V_41 = F_2 ( * V_30 ++ ) ;
V_26 -> V_40 . V_42 = F_2 ( * V_30 ++ ) ;
V_26 -> V_40 . V_43 = F_2 ( * V_30 ++ ) ;
V_26 -> type = V_44 ;
}
V_2 -> V_35 = 0 ;
V_2 -> V_15 ++ ;
...
static int F_32 ( struct V_1 * V_2 , struct V_22 * V_23 ,
bool V_24 )
{
struct V_54 * V_55 ;
unsigned V_33 ;
...
case 0 :
V_2 -> V_35 = 0 ;
V_2 -> V_19 = F_15 ( 11 * sizeof( T_2 ) , V_38 ) ;
if ( ! V_2 -> V_19 )
return - V_39 ;
V_2 -> V_15 ++ ;
case 1 :
...
F_13 ( L_15 ) ;
V_2 -> V_18 = F_15 ( sizeof( struct V_54 ) , V_38 ) ;
if ( ! V_2 -> V_18 )
return - V_39 ;
V_58 = V_2 -> V_19 ;
V_55 = V_2 -> V_18 ;
...
F_3 ( L_2 ) ;
V_67 = 0 ;
V_66 = F_16 ( 32 , sizeof( * V_66 ) , V_38 ) ;
if ( V_66 ) {
V_67 = F_34 ( V_66 , 32 , false ) ;
if ( V_67 < 0 ) {
F_7 ( V_66 ) ;
V_66 = NULL ;
V_67 = 0 ;
...
V_57 . V_72 . V_67 = F_30 ( V_67 ) ;
V_57 . V_72 . V_68 [ 0 ] = F_30 ( V_54 . V_59 ) ;
V_57 . V_72 . V_68 [ 1 ] = F_30 ( V_54 . V_60 ) ;
V_57 . V_72 . V_68 [ 2 ] = F_30 ( V_54 . V_61 ) ;
V_57 . V_72 . V_68 [ 3 ] = F_30 ( ( V_76 ) V_54 . V_62 ) ;
V_57 . V_72 . V_68 [ 4 ] = F_30 ( ( V_76 ) V_54 . V_63 ) ;
for ( V_33 = 0 ; V_33 < 6 ; V_33 ++ )
V_57 . V_72 . V_68 [ V_33 + 5 ] = F_30 ( ( V_76 ) V_54 . V_64 [ V_33 ] ) ;
if ( V_66 ) {
for ( V_33 = 0 ; V_33 < V_67 ; V_33 ++ ) {
V_57 . V_72 . V_69 [ V_33 ] = V_66 [ V_33 ] . V_77 . V_78 ;
V_57 . V_72 . V_70 [ V_33 ] = V_66 [ V_33 ] . V_70 . V_78 ;
V_57 . V_72 . V_71 [ V_33 ] = F_30 ( V_66 [ V_33 ] . V_71 ) ;
}
F_7 ( V_66 ) ;
}
V_57 . V_75 . V_73 = F_30 ( 1 ) ;
V_57 . V_75 . V_74 [ 0 ] = F_30 ( V_79 ) ;
F_31 ( V_2 , & V_57 , sizeof( V_57 ) ) ;
F_11 ( L_2 ) ;
}
