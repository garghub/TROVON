...
F_29 ( V_34 , V_82 ) ;
V_81 = F_30 ( sizeof( struct V_80 ) , V_85 ) ;
if ( ! V_81 )
return - V_86 ;
F_31 ( V_81 ) ;
V_81 -> V_87 = V_79 -> V_83 ;
...
static int F_33 ( struct V_33 * V_34 , T_2 V_90 , T_2 V_2 )
{
struct V_38 V_53 ;
struct V_91 V_92 ;
...
int V_54 ;
T_2 V_2 = V_96 ;
F_36 ( sizeof( struct V_94 ) !=
sizeof( struct V_78 ) ) ;
V_54 = F_28 ( V_34 , (struct V_78 * ) V_95 ) ;
if ( V_54 )
V_2 = ! V_96 ;
if ( V_34 -> V_97 == V_98 )
F_37 ( & V_34 -> V_99 ) ;
return F_33 ( V_34 , V_95 -> V_42 , V_2 ) ;
}
...
static inline enum V_103 F_39 ( struct V_51 * V_52 )
{
struct V_104 * V_105 =
(struct V_104 * ) V_52 ;
return F_40 ( V_105 -> V_100 ) ;
}
...
static int F_46 ( struct V_33 * V_34 , unsigned long V_109 )
{
struct V_38 V_53 ;
struct V_110 V_111 ;
...
unsigned long V_90 ;
int V_54 ;
V_90 = F_47 ( V_34 -> V_112 , V_113 , V_109 ) ;
if ( V_90 == V_113 ) {
V_34 -> V_36 = V_114 ;
F_48 ( V_34 ) ;
return 0 ;
...
int F_49 ( struct V_33 * V_34 , T_2 V_116 )
{
struct V_38 V_53 ;
struct V_117 V_95 ;
...
struct V_80 * V_81 ;
int V_127 ;
V_81 = F_53 ( V_34 , V_126 -> V_42 ) ;
if ( ! V_81 ) {
F_25 ( V_34 -> V_34 , L_13 ,
V_126 -> V_42 ) ;
return - V_128 ;
}
if ( F_54 ( V_81 -> V_87 . V_129 == 0 ) ) {
V_127 = - V_31 ;
goto V_130;
}
V_81 -> V_89 ++ ;
...
{
const T_1 V_50 = sizeof( struct V_132 ) ;
T_2 V_49 [ V_50 ] ;
return F_15 ( V_34 , V_47 , V_133 , V_49 , V_50 ) ;
}
int F_58 ( struct V_33 * V_34 , struct V_46 * V_47 )
{
const T_1 V_50 = sizeof( struct V_134 ) ;
T_2 V_49 [ V_50 ] ;
return F_15 ( V_34 , V_47 , V_135 , V_49 , V_50 ) ;
}
...
const T_1 V_50 = sizeof( struct V_132 ) ;
T_2 V_49 [ V_50 ] ;
return F_15 ( V_34 , V_47 , V_138 , V_49 , V_50 ) ;
}
...
switch ( V_140 ) {
case V_145 :
F_61 ( V_34 , V_47 , V_105 ) ;
break;
case V_146 :
F_59 ( V_34 , V_47 , V_105 ) ;
break;
case V_147 :
F_41 ( V_34 , V_47 , V_105 ) ;
break;
case V_148 :
F_43 ( V_34 , V_47 , V_105 ) ;
break;
default:
return;
}
...
struct V_46 * V_47 ;
struct V_141 * V_142 ;
V_47 = F_18 ( V_34 , V_151 ) ;
if ( V_47 ) {
F_68 ( V_34 , V_47 , L_18 ) ;
V_47 -> V_17 = V_152 ;
V_47 -> V_149 = 0 ;
V_142 = F_69 ( V_47 , V_153 , NULL ) ;
if ( ! V_142 )
return - V_86 ;
F_70 ( & V_142 -> V_144 , & V_34 -> V_154 . V_144 ) ;
}
return 0 ;
}
...
{
V_34 -> V_118 = 0 ;
if ( V_34 -> V_163 . V_64 > V_164 )
V_34 -> V_118 = 1 ;
if ( V_34 -> V_163 . V_64 == V_164 &&
V_34 -> V_163 . V_66 >= V_165 )
V_34 -> V_118 = 1 ;
if ( V_34 -> V_163 . V_64 >= V_166 )
V_34 -> V_73 = 1 ;
if ( V_34 -> V_163 . V_64 >= V_167 )
V_34 -> V_75 = 1 ;
if ( V_34 -> V_163 . V_64 >= V_168 )
V_34 -> V_169 = 1 ;
if ( V_34 -> V_163 . V_64 >= V_170 )
V_34 -> V_171 = 1 ;
if ( V_34 -> V_163 . V_64 >= V_172 )
V_34 -> V_173 = 1 ;
}
bool F_79 ( struct V_33 * V_34 )
{
return ( V_34 -> V_163 . V_64 < V_65 ) ||
( V_34 -> V_163 . V_64 == V_65 &&
V_34 -> V_163 . V_66 <= V_67 ) ;
}
...
case V_190 :
F_34 ( V_34 -> V_34 , L_29 ) ;
F_63 ( V_34 , V_182 , V_145 ) ;
break;
case V_135 :
F_34 ( V_34 -> V_34 , L_30 ) ;
F_63 ( V_34 , V_182 , V_146 ) ;
break;
case V_125 :
F_34 ( V_34 -> V_34 , L_31 ) ;
V_131 = (struct V_124 * ) V_175 ;
F_56 ( V_34 , V_131 ) ;
break;
case V_191 :
F_34 ( V_34 -> V_34 , L_32 ) ;
