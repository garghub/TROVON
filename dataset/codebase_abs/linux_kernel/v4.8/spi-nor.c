...
return V_3 ;
while ( V_63 ) {
V_3 = V_2 -> V_107 ( V_2 , V_104 , V_63 , V_55 ) ;
if ( V_3 == 0 ) {
V_3 = - V_68 ;
goto V_108;
}
...
static int F_49 ( struct V_20 * V_21 , T_4 V_109 , T_6 V_63 ,
T_6 * V_105 , const T_7 * V_55 )
{
struct V_1 * V_2 = F_10 ( V_21 ) ;
T_6 V_110 ;
int V_3 ;
F_21 ( V_2 -> V_9 , L_11 , ( T_2 ) V_109 , V_63 ) ;
V_3 = F_22 ( V_2 , V_111 ) ;
if ( V_3 )
return V_3 ;
F_8 ( V_2 ) ;
...
if ( V_110 ) {
V_2 -> V_113 = V_114 ;
V_3 = V_2 -> V_115 ( V_2 , V_109 , 1 , V_55 ) ;
if ( V_3 < 0 )
goto V_116;
F_50 ( V_3 != 1 , L_12 ,
( int ) V_3 ) ;
...
V_109 += V_110 ;
for (; V_110 < V_63 - 1 ; V_110 += 2 ) {
V_2 -> V_113 = V_117 ;
V_3 = V_2 -> V_115 ( V_2 , V_109 , 2 , V_55 + V_110 ) ;
if ( V_3 < 0 )
goto V_116;
F_50 ( V_3 != 2 , L_13 ,
( int ) V_3 ) ;
...
F_8 ( V_2 ) ;
V_2 -> V_113 = V_114 ;
V_3 = V_2 -> V_115 ( V_2 , V_109 , 1 , V_55 + V_110 ) ;
if ( V_3 < 0 )
goto V_116;
F_50 ( V_3 != 1 , L_12 ,
( int ) V_3 ) ;
...
static int F_51 ( struct V_20 * V_21 , T_4 V_109 , T_6 V_63 ,
T_6 * V_105 , const T_7 * V_55 )
{
struct V_1 * V_2 = F_10 ( V_21 ) ;
T_6 V_118 , V_119 , V_57 ;
T_8 V_3 ;
F_21 ( V_2 -> V_9 , L_11 , ( T_2 ) V_109 , V_63 ) ;
V_3 = F_22 ( V_2 , V_111 ) ;
if ( V_3 )
return V_3 ;
for ( V_57 = 0 ; V_57 < V_63 ; ) {
T_8 V_120 ;
V_118 = ( V_109 + V_57 ) & ( V_2 -> V_121 - 1 ) ;
F_52 ( V_118 ,
L_14 ,
V_118 ) ;
V_119 = F_53 ( T_6 ,
V_2 -> V_121 - V_118 , V_63 - V_57 ) ;
F_8 ( V_2 ) ;
V_3 = V_2 -> V_115 ( V_2 , V_109 + V_57 , V_119 , V_55 + V_57 ) ;
if ( V_3 < 0 )
goto V_122;
V_120 = V_3 ;
V_3 = F_19 ( V_2 ) ;
...
static int F_55 ( struct V_1 * V_2 , T_9 V_4 )
{
V_2 -> V_15 [ 0 ] = V_4 & 0xff ;
V_2 -> V_15 [ 1 ] = ( V_4 >> 8 ) ;
...
static int F_57 ( struct V_1 * V_2 , const struct V_23 * V_24 )
{
int V_26 ;
switch ( F_12 ( V_24 ) ) {
case V_30 :
...
{
if ( ! V_2 -> V_9 || ! V_2 -> V_107 || ! V_2 -> V_115 ||
! V_2 -> V_5 || ! V_2 -> V_16 ) {
F_2 ( L_21 ) ;
return - V_66 ;
}
...
int F_59 ( struct V_1 * V_2 , const char * V_126 , enum V_127 V_128 )
{
const struct V_23 * V_24 = NULL ;
struct V_129 * V_9 = V_2 -> V_9 ;
struct V_20 * V_21 = & V_2 -> V_21 ;
struct V_130 * V_131 = F_60 ( V_2 ) ;
int V_3 ;
int V_57 ;
V_3 = F_58 ( V_2 ) ;
if ( V_3 )
...
return - V_132 ;
if ( V_126 && V_24 -> V_102 ) {
const struct V_23 * V_133 ;
V_133 = F_44 ( V_2 ) ;
if ( F_63 ( V_133 ) ) {
return F_64 ( V_133 ) ;
} else if ( V_133 != V_24 ) {
F_65 ( V_9 , L_22 ,
V_133 -> V_126 , V_24 -> V_126 ) ;
V_24 = V_133 ;
}
}
F_66 ( & V_2 -> V_51 ) ;
...
V_21 -> V_139 = 1 ;
V_21 -> V_39 = V_140 ;
V_21 -> V_47 = V_24 -> V_141 * V_24 -> V_142 ;
V_21 -> V_143 = F_27 ;
V_21 -> V_144 = F_47 ;
if ( F_12 ( V_24 ) == V_29 ||
V_24 -> V_39 & V_137 ) {
...
{
V_2 -> V_60 = V_156 ;
V_21 -> V_65 = V_24 -> V_141 ;
}
if ( V_24 -> V_39 & V_157 )
V_21 -> V_39 |= V_158 ;
V_21 -> V_9 . V_159 = V_9 ;
V_2 -> V_121 = V_24 -> V_121 ;
V_21 -> V_160 = V_2 -> V_121 ;
if ( V_131 ) {
if ( F_69 ( V_131 , L_23 ) )
V_2 -> V_10 = V_11 ;
else
...
V_2 -> V_10 = V_13 ;
} else if ( V_128 == V_12 && V_24 -> V_39 & V_163 ) {
V_2 -> V_10 = V_12 ;
}
switch ( V_2 -> V_10 ) {
case V_13 :
...
V_2 -> V_177 = F_6 ( V_2 ) ;
F_70 ( V_9 , L_27 , V_24 -> V_126 ,
( long long ) V_21 -> V_47 >> 10 ) ;
F_21 ( V_9 ,
L_28
L_29 ,
V_21 -> V_126 , ( long long ) V_21 -> V_47 , ( long long ) ( V_21 -> V_47 >> 20 ) ,
V_21 -> V_65 , V_21 -> V_65 / 1024 , V_21 -> V_178 ) ;
if ( V_21 -> V_178 )
for ( V_57 = 0 ; V_57 < V_21 -> V_178 ; V_57 ++ )
F_21 ( V_9 ,
L_30
L_31
L_32 ,
V_57 , ( long long ) V_21 -> V_179 [ V_57 ] . V_180 ,
V_21 -> V_179 [ V_57 ] . V_65 ,
V_21 -> V_179 [ V_57 ] . V_65 / 1024 ,
V_21 -> V_179 [ V_57 ] . V_181 ) ;
return 0 ;
}
static const struct V_23 * F_61 ( const char * V_126 )
{
const struct V_23 * V_98 = V_101 ;
while ( V_98 -> V_126 ) {
if ( ! strcmp ( V_126 , V_98 -> V_126 ) )
return V_98 ;
V_98 ++ ;
}
return NULL ;
