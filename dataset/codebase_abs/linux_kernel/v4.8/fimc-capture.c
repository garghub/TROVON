...
unsigned int V_86 [] , struct V_87 * V_88 [] )
{
struct V_7 * V_8 = V_83 -> V_74 ;
struct V_52 * V_89 = & V_8 -> V_17 ;
struct V_90 * V_12 = V_89 -> V_12 ;
unsigned long V_91 = V_89 -> V_92 * V_89 -> V_93 ;
int V_79 ;
if ( V_12 == NULL )
return - V_13 ;
if ( * V_85 ) {
...
if ( V_86 [ V_79 ] < ( V_91 * V_12 -> V_95 [ V_79 ] ) / 8 )
return - V_13 ;
return 0 ;
}
* V_85 = V_12 -> V_94 ;
for ( V_79 = 0 ; V_79 < V_12 -> V_94 ; V_79 ++ ) {
unsigned int V_65 = ( V_91 * V_12 -> V_95 [ V_79 ] ) / 8 ;
if ( F_60 ( V_12 -> V_96 ) )
V_86 [ V_79 ] = V_89 -> V_66 [ V_79 ] ;
else
V_86 [ V_79 ] = F_61 ( V_97 , V_65 , V_89 -> V_66 [ V_79 ] ) ;
}
return 0 ;
}
...
return - V_13 ;
for ( V_79 = 0 ; V_79 < V_8 -> V_17 . V_12 -> V_94 ; V_79 ++ ) {
...
static struct V_90 * F_90 ( struct V_7 * V_8 ,
...
V_97 V_95 , V_128 , V_129 , V_130 , V_131 = 3 ;
V_97 V_132 = V_133 ;
struct V_90 * V_134 ;
...
V_152 -> V_115 = V_155 -> V_92 ;
V_152 -> V_116 = V_155 -> V_93 ;
...
V_97 V_95 = F_95 ( V_155 -> V_12 ) ;
V_158 = 64 / F_96 ( V_95 , 8 ) ;
V_157 = V_122 -> V_166 ;
V_128 = V_130 = V_157 ;
V_159 = V_160 = 1 ;
}
...
V_154 ? V_155 -> V_93 : V_155 -> V_92 ) ;
V_156 = F_99 ( V_97 , V_143 , V_155 -> V_93 ) ;
if ( V_153 == V_163 ) {
V_128 = F_99 ( V_97 , V_129 , V_155 -> V_92 / V_159 ) ;
V_130 = F_99 ( V_97 , V_156 , V_155 -> V_93 / V_160 ) ;
if ( V_154 ) {
F_100 ( V_159 , V_160 ) ;
F_100 ( V_128 , V_130 ) ;
}
...
V_158 ) ;
V_152 -> V_161 = F_101 ( V_97 , V_152 -> V_161 , 0 , V_155 -> V_92 - V_152 -> V_115 ) ;
V_152 -> V_162 = F_101 ( V_97 , V_152 -> V_162 , 0 , V_155 -> V_93 - V_152 -> V_116 ) ;
V_152 -> V_161 = F_102 ( V_152 -> V_161 , V_122 -> V_167 ) ;
F_44 ( L_7 ,
V_153 , V_152 -> V_161 , V_152 -> V_162 , V_152 -> V_115 , V_152 -> V_116 ,
V_155 -> V_92 , V_155 -> V_93 ) ;
}
...
V_8 -> V_11 . V_92 = V_221 -> V_115 ;
V_8 -> V_11 . V_93 = V_221 -> V_116 ;
}
}
...
{
struct V_1 * V_2 = F_72 ( V_103 ) ;
struct V_90 * V_219 = NULL , * V_218 = NULL ;
...
return V_9 ;
F_122 ( V_8 ) ;
for ( V_79 = 0 ; V_79 < V_232 -> V_12 -> V_94 ; V_79 ++ ) {
...
V_236 . V_192 . V_115 = V_232 -> V_92 ;
V_236 . V_192 . V_116 = V_232 -> V_93 ;
...
struct V_52 * V_89 = & V_104 -> V_8 -> V_17 ;
unsigned int V_79 ;
...
if ( V_9 < 0 )
return - V_226 ;
for ( V_79 = 0 ; V_79 < V_89 -> V_12 -> V_94 ; V_79 ++ )
if ( V_89 -> V_66 [ V_79 ] < V_204 [ V_79 ] . V_210 )
return - V_226 ;
}
}
return 0 ;
