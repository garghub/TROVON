...
if ( V_16 < 0 )
goto V_152;
V_12 -> V_135 = F_60 ( V_109 -> V_165 , V_166 ) ;
if ( ! V_12 -> V_135 ) {
V_16 = - V_167 ;
goto V_152;
}
...
static int F_65 ( struct V_168 * V_97 ,
...
struct V_18 * V_18 ;
int V_16 ;
V_109 = F_66 ( & V_97 -> V_2 , sizeof( * V_12 ) ) ;
if ( ! V_109 )
return - V_167 ;
V_12 = F_29 ( V_109 ) ;
V_12 -> V_171 = F_67 ( & V_97 -> V_2 , L_12 ) ;
if ( F_68 ( V_12 -> V_171 ) )
return F_69 ( V_12 -> V_171 ) ;
V_16 = F_70 ( V_12 -> V_171 ) ;
if ( V_16 )
return V_16 ;
V_18 = F_71 ( V_97 , & V_172 ) ;
if ( F_68 ( V_18 ) ) {
F_23 ( & V_97 -> V_2 , L_13 ) ;
V_16 = F_69 ( V_18 ) ;
goto V_173;
...
V_109 -> V_176 = V_177 ;
V_109 -> V_178 = F_72 ( V_177 ) ;
V_109 -> V_147 = & V_179 ;
V_109 -> V_180 = V_170 -> V_180 ;
V_109 -> V_181 = V_182 ;
V_16 = F_76 ( V_109 , & V_183 ,
& F_39 , & V_184 ) ;
if ( V_16 < 0 )
goto V_173;
V_12 -> V_106 = F_77 ( & V_97 -> V_2 , L_15 ,
V_109 -> V_180 ) ;
if ( V_12 -> V_106 == NULL ) {
V_16 = - V_167 ;
F_23 ( & V_109 -> V_2 , L_16 ) ;
...
F_78 ( & V_12 -> V_105 , F_25 ) ;
V_16 = F_79 ( V_12 -> V_106 ) ;
if ( V_16 < 0 ) {
F_23 ( & V_97 -> V_2 , L_19 ) ;
goto V_188;
}
...
static int F_84 ( struct V_168 * V_97 )
{
struct V_108 * V_109 = F_85 ( V_97 ) ;
struct V_11 * V_12 = F_29 ( V_109 ) ;
int V_16 ;
V_16 = F_2 ( V_12 ,
V_17 ) ;
