...
static int F_30 ( struct V_35 * V_36 , struct V_20 * V_20 , struct V_37 * V_38
)
{
F_31 ( F_32 ( V_20 ) , V_38 ) ;
V_38 -> V_39 = V_40 . V_39 + F_33 () ;
return 0 ;
}
static struct V_20 * F_34 ( struct V_41 * V_42 , struct V_20 * V_20 , unsigned int V_17 )
{
if ( ! F_35 ( V_42 , V_20 , V_17 ) )
return NULL ;
return F_36 ( V_42 , V_20 , V_17 ) ;
}
static int F_37 ( struct V_43 * V_43 , struct V_44 * V_45 )
{
if ( V_45 -> V_46 < V_47 ) {
int error = F_38 ( V_43 , V_45 ) ;
if ( F_39 ( error <= 0 ) )
return error ;
V_45 -> V_46 = V_47 ;
}
