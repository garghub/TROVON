...
static bool F_38 ( const struct V_120 * V_121 ,
int V_130 )
{
T_5 V_137 = F_39 ( V_138 ) ;
return V_137 > F_40 ( V_139 - 2 , 0 ) && ! F_37 () ;
}
static void T_4 F_41 ( const struct V_120 * V_140 )
{
switch ( V_140 -> V_141 ) {
case V_142 :
V_143 |= V_140 -> V_144 ;
...
#ifdef F_42
case V_145 :
V_146 |= ( T_1 ) V_140 -> V_144 ;
break;
case V_147 :
V_148 |= ( T_1 ) V_140 -> V_144 ;
break;
#endif
default:
F_28 ( 1 ) ;
...
static bool F_43 ( const struct V_120 * V_140 )
{
bool V_149 ;
switch ( V_140 -> V_141 ) {
case V_142 :
V_149 = ( V_143 & V_140 -> V_144 ) != 0 ;
break;
#ifdef F_42
case V_145 :
V_149 = ( V_146 & ( T_1 ) V_140 -> V_144 ) != 0 ;
break;
case V_147 :
V_149 = ( V_148 & ( T_1 ) V_140 -> V_144 ) != 0 ;
break;
#endif
default:
F_28 ( 1 ) ;
...
static void T_4 F_44 ( const struct V_120 * V_150 )
{
for (; V_150 -> V_151 ; V_150 ++ )
if ( V_150 -> V_151 ( V_150 , V_150 -> V_152 ) )
F_41 ( V_150 ) ;
}
void F_45 ( const struct V_120 * V_153 ,
const char * V_32 )
{
for (; V_153 -> V_151 ; V_153 ++ ) {
if ( ! V_153 -> V_151 ( V_153 , V_153 -> V_152 ) )
continue;
if ( ! F_46 ( V_153 -> V_154 ) && V_153 -> V_129 )
F_47 ( L_4 , V_32 , V_153 -> V_129 ) ;
F_48 ( V_153 -> V_154 ) ;
}
}
void T_4 F_49 ( const struct V_120 * V_153 )
{
for (; V_153 -> V_151 ; V_153 ++ )
if ( V_153 -> V_155 && F_46 ( V_153 -> V_154 ) )
F_50 ( V_153 -> V_155 , NULL , true ) ;
}
...
static void
F_55 ( const struct V_120 * V_153 )
{
for (; V_153 -> V_151 ; V_153 ++ )
if ( F_43 ( V_153 ) && ! V_153 -> V_151 ( V_153 , V_126 ) ) {
F_56 ( L_5 ,
F_57 () , V_153 -> V_129 ) ;
F_58 () ;
}
...
static void
F_59 ( const struct V_120 * V_153 )
{
for (; V_153 -> V_151 ; V_153 ++ ) {
if ( ! F_46 ( V_153 -> V_154 ) )
continue;
if ( ! V_153 -> V_151 ( V_153 , V_126 ) ) {
F_56 ( L_6 ,
F_57 () , V_153 -> V_129 ) ;
F_58 () ;
}
...
bool F_64 ( unsigned int V_140 )
{
const struct V_120 * V_153 ;
if ( F_28 ( F_29 () ) )
return false ;
for ( V_153 = V_157 ; V_153 -> V_129 ; V_153 ++ )
if ( V_153 -> V_154 == V_140 && V_153 -> V_151 )
return V_153 -> V_151 ( V_153 , V_126 ) ;
return false ;
}
void T_4 F_65 ( void )
{
...
static bool T_6
F_69 ( const struct V_120 * V_121 , int V_130 )
{
return ( F_46 ( V_163 ) && ! F_46 ( V_164 ) ) ;
}
