...
if ( ! F_100 ( & V_105 -> V_116 ) )
F_117 ( V_2 , V_2 -> V_76 , & V_105 -> V_117 ) ;
else
F_101 ( & V_105 -> V_103 , & F_93 ) ;
if ( V_14 == 0 ) {
unsigned int V_147 = F_118 ( V_140 - V_137 ) ;
if ( V_147 > 5 ) {
F_74 ( V_2 , L_24 ,
...
if ( ( V_14 & ~ V_120 ) == 0 )
F_74 ( V_2 , L_29 ,
F_122 ( V_138 , V_137 << ( V_150 - 10 ) ) , V_137 ) ;
F_101 ( & V_105 -> V_103 , & F_93 ) ;
return V_90 ;
}
...
int F_126 ( struct V_1 * V_2 , unsigned V_151 ) __must_hold( T_4 )
{
...
static unsigned long F_129 ( struct V_1 * V_2 , unsigned long V_152 ,
const int V_153 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_38 ;
...
if ( V_157 & V_5 -> V_18 )
F_133 ( V_2 ) ;
V_41 = F_129 ( V_2 , V_152 , V_153 ) ;
F_76 ( & V_5 -> V_55 ) ;
return V_41 ;
}
unsigned long F_134 ( struct V_1 * V_2 , unsigned long V_152 )
{
return F_132 ( V_2 , V_152 , 0 ) ;
}
unsigned long F_135 ( struct V_1 * V_2 , unsigned long V_152 )
{
return F_129 ( V_2 , V_152 , 0 ) ;
}
unsigned long F_136 ( struct V_1 * V_2 , unsigned long V_152 )
{
return F_129 ( V_2 , V_152 , 1 ) ;
}
static int F_137 ( struct V_1 * V_2 , const unsigned long V_99 ,
...
F_133 ( V_2 ) ;
V_69 = F_137 ( V_2 , V_99 , V_158 , V_159 ) ;
F_84 ( & V_5 -> V_55 , V_14 ) ;
return V_69 ;
}
int F_141 ( struct V_1 * V_2 , const unsigned long V_99 , const unsigned long V_158 )
{
return F_140 ( V_2 , V_99 , V_158 , 1 ) ;
}
int F_142 ( struct V_1 * V_2 , const unsigned long V_99 , const unsigned long V_158 )
{
return - F_140 ( V_2 , V_99 , V_158 , 0 ) ;
}
static inline void F_143 ( struct V_4 * V_5 ,
...
void F_144 ( struct V_1 * V_2 , const unsigned long V_99 , const unsigned long V_158 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
...
F_75 ( & V_5 -> V_55 ) ;
F_137 ( V_2 , V_99 , V_158 , 1 ) ;
F_76 ( & V_5 -> V_55 ) ;
return;
}
F_75 ( & V_5 -> V_55 ) ;
if ( V_167 )
F_137 ( V_2 , V_99 , V_167 - 1 , 1 ) ;
V_169 = V_167 >> ( 3 + V_35 ) ;
V_170 = V_168 >> ( 3 + V_35 ) ;
V_164 = F_71 ( V_167 >> V_36 ) ;
V_66 = V_74 ;
for ( V_22 = V_169 ; V_22 < V_170 ; V_22 ++ ) {
F_143 ( V_2 -> V_6 , V_22 , V_164 , V_66 ) ;
F_76 ( & V_5 -> V_55 ) ;
F_67 () ;
V_164 = 0 ;
F_75 ( & V_5 -> V_55 ) ;
...
if ( V_66 )
F_143 ( V_2 -> V_6 , V_170 , V_164 , V_66 ) ;
if ( V_168 <= V_158 )
F_137 ( V_2 , V_168 , V_158 , 1 ) ;
F_76 ( & V_5 -> V_55 ) ;
}
int F_145 ( struct V_1 * V_2 , const unsigned long V_37 )
{
unsigned long V_14 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_38 ;
...
int F_147 ( struct V_1 * V_2 , const unsigned long V_99 , const unsigned long V_158 )
{
unsigned long V_14 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_38 = NULL ;
...
V_69 += ( 0 != F_146 ( V_37 - ( V_22 << ( V_35 + 3 ) ) , V_38 ) ) ;
else
...
int F_148 ( struct V_1 * V_2 , unsigned long V_171 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
...
F_133 ( V_2 ) ;
V_99 = F_149 ( V_171 ) ;
V_158 = F_150 ( ( T_3 ) F_149 ( V_171 + 1 ) , V_5 -> V_73 ) ;
V_136 = 0 ;
if ( V_99 < V_5 -> V_73 ) {
