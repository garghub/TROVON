...
static void T_1 F_36 ( T_2 * V_2 , T_6 V_57 )
{
...
void T_1 F_40 ( T_2 * V_2 )
{
F_36 ( V_2 , V_2 -> V_64 ) ;
}
void T_7 * T_1 F_41 ( unsigned long V_51 , unsigned long V_62 ,
T_8 type , T_6 V_59 )
{
unsigned long V_71 ;
if ( type == V_72 )
return F_42 ( V_51 , V_62 ) ;
V_71 = F_43 ( V_51 , V_51 + V_62 ) ;
if ( ( V_71 << V_16 ) < V_51 + V_62 ) {
unsigned long V_73 = V_71 << V_16 ;
F_41 ( V_73 , V_62 - ( V_73 - V_51 ) , type , V_59 ) ;
}
if ( ! ( V_59 & V_60 ) )
F_44 ( ( T_6 ) ( unsigned long ) F_11 ( V_51 ) , V_62 ) ;
return ( void T_7 * ) F_11 ( V_51 ) ;
}
void T_1 F_45 ( T_6 V_51 , T_8 V_74 )
{
...
static T_9 F_55 ( T_10 * V_91 , T_11 * V_92 )
{
T_9 V_88 ;
T_8 V_93 , V_94 ;
F_56 ( & V_95 ) ;
V_93 = F_34 ( V_91 ) ;
V_94 = F_34 ( V_92 ) ;
V_88 = F_57 ( V_96 , V_93 , V_94 ) ;
F_58 ( & V_95 ) ;
return V_88 ;
}
static T_9 F_59 ( T_10 * V_91 )
{
T_9 V_88 ;
T_8 V_93 ;
F_56 ( & V_95 ) ;
...
V_101 = F_34 ( V_99 ) ;
V_93 = F_34 ( V_91 ) ;
V_88 = F_57 ( V_102 , V_100 ,
V_101 , V_93 ) ;
F_58 ( & V_95 ) ;
return V_88 ;
}
static T_9
F_61 ( T_12 V_98 , T_10 * V_91 )
{
T_9 V_88 ;
T_8 V_93 ;
F_56 ( & V_95 ) ;
V_93 = F_34 ( V_91 ) ;
V_88 = F_57 ( V_103 , V_98 , V_93 ) ;
F_58 ( & V_95 ) ;
return V_88 ;
}
static T_9
F_62 ( T_13 * V_104 , T_14 * V_105 ,
...
V_111 = F_34 ( V_106 ) ;
V_113 = F_34 ( V_108 ) ;
V_88 = F_57 ( V_114 , V_109 , V_110 ,
V_111 , V_112 , V_113 ) ;
return V_88 ;
}
static T_9
F_63 ( T_13 * V_104 , T_14 * V_105 ,
T_8 V_106 , unsigned long V_107 , void * V_108 )
{
...
V_110 = F_34 ( V_105 ) ;
V_113 = F_34 ( V_108 ) ;
V_88 = F_57 ( V_115 , V_109 , V_110 ,
V_106 , V_107 , V_113 ) ;
return V_88 ;
}
static T_9
F_64 ( unsigned long * V_116 ,
T_13 * V_104 ,
T_14 * V_105 )
{
T_9 V_88 ;
...
T_8 V_120 ;
V_120 = F_34 ( V_119 ) ;
V_88 = F_57 ( V_121 , V_120 ) ;
return V_88 ;
}
static void
F_66 ( int V_122 , T_9 V_88 ,
unsigned long V_107 , T_13 * V_108 )
{
T_8 V_113 ;
V_113 = F_34 ( V_108 ) ;
F_57 ( V_123 , V_122 , V_88 , V_107 , V_113 ) ;
}
static T_9
F_67 ( T_15 * * V_124 ,
