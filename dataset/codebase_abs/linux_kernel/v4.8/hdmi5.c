...
F_29 ( & V_2 . V_41 , V_30 -> V_42 , & V_36 ) ;
F_30 ( & V_2 . V_9 , 0xffffffff ) ;
F_9 ( & V_2 . V_9 ,
F_8 ( & V_2 . V_9 ) ) ;
V_1 = F_31 ( & V_2 . V_41 . V_41 ) ;
if ( V_1 ) {
F_18 ( L_7 ) ;
goto V_43;
}
V_1 = F_32 ( & V_2 . V_41 . V_41 , & V_36 ) ;
if ( V_1 ) {
F_18 ( L_8 ) ;
goto V_44;
}
V_1 = F_33 ( & V_2 . V_15 , V_36 . V_45 ,
V_36 . V_46 [ 0 ] ) ;
if ( V_1 ) {
F_2 ( L_9 ) ;
goto V_47;
...
if ( V_1 )
goto V_48;
F_34 ( & V_2 . V_49 , & V_2 . V_9 , & V_2 . V_37 ) ;
F_35 ( 0 ) ;
F_36 ( V_32 , V_30 ) ;
V_1 = F_37 ( & V_2 . V_9 ) ;
if ( V_1 )
...
V_1 = F_1 () ;
F_57 ( V_1 ) ;
V_62 = F_58 ( V_2 . V_9 . V_16 , V_63 , 3 , 2 ) ;
F_14 ( V_2 . V_9 . V_16 , V_63 , 1 , 3 , 2 ) ;
V_1 = F_59 ( & V_2 . V_49 , V_60 , V_61 ) ;
...
if ( V_2 . V_70 ) {
V_1 = F_65 ( & V_2 . V_49 , & V_2 . V_9 , & V_2 . V_71 ,
V_2 . V_37 . V_38 . V_42 ) ;
if ( V_1 ) {
F_18 ( L_13 , V_1 ) ;
...
static void F_81 ( struct V_87 * V_3 )
{
struct V_24 * V_53 = & V_2 . V_33 ;
V_53 -> V_4 = & V_3 -> V_4 ;
V_53 -> V_88 = V_89 ;
...
static void F_83 ( struct V_87 * V_3 )
{
struct V_24 * V_53 = & V_2 . V_33 ;
F_84 ( V_53 ) ;
}
static int F_85 ( struct V_87 * V_3 )
{
...
static int F_89 ( struct V_102 * V_4 ,
void (* F_90)( struct V_102 * V_4 ) )
{
struct V_64 * V_65 = F_91 ( V_4 ) ;
int V_103 = 0 ;
F_47 ( & V_65 -> V_57 ) ;
if ( ! F_92 ( & V_65 -> V_37 ) || ! V_65 -> V_75 ) {
V_103 = - V_104 ;
goto V_53;
}
V_65 -> V_72 = F_90 ;
...
static void F_95 ( struct V_102 * V_4 )
{
struct V_64 * V_65 = F_91 ( V_4 ) ;
unsigned long V_67 ;
F_4 ( ! F_92 ( & V_65 -> V_37 ) ) ;
...
static int F_96 ( struct V_102 * V_4 ,
struct V_105 * V_106 )
{
struct V_64 * V_65 = F_91 ( V_4 ) ;
int V_103 ;
...
V_103 = F_65 ( & V_65 -> V_49 , & V_65 -> V_9 , V_106 ,
V_65 -> V_37 . V_38 . V_42 ) ;
if ( ! V_103 ) {
V_65 -> V_70 = true ;
V_65 -> V_71 = * V_106 ;
...
F_1 () ;
V_2 . V_66 =
F_58 ( V_2 . V_9 . V_16 , V_63 , 3 , 2 ) ;
F_5 () ;
return 0 ;
}
static int F_101 ( struct V_102 * V_4 , struct V_102 * V_114 , void * V_7 )
{
struct V_87 * V_3 = F_102 ( V_4 ) ;
int V_1 ;
int V_6 ;
V_2 . V_3 = V_3 ;
F_103 ( & V_3 -> V_4 , & V_2 ) ;
...
V_1 = F_106 ( V_3 , & V_2 . V_9 ) ;
if ( V_1 )
return V_1 ;
V_1 = F_107 ( V_3 , & V_2 . V_41 , & V_2 . V_9 ) ;
if ( V_1 )
return V_1 ;
V_1 = F_108 ( V_3 , & V_2 . V_15 ) ;
if ( V_1 )
goto V_101;
V_1 = F_109 ( V_3 , & V_2 . V_49 ) ;
if ( V_1 )
goto V_101;
V_6 = F_110 ( V_3 , 0 ) ;
if ( V_6 < 0 ) {
...
static void F_116 ( struct V_102 * V_4 , struct V_102 * V_114 , void * V_7 )
{
struct V_87 * V_3 = F_102 ( V_4 ) ;
if ( V_2 . V_112 )
F_117 ( V_2 . V_112 ) ;
...
static int F_118 ( struct V_87 * V_3 )
{
return F_119 ( & V_3 -> V_4 , & V_116 ) ;
}
static int F_120 ( struct V_87 * V_3 )
{
F_121 ( & V_3 -> V_4 , & V_116 ) ;
return 0 ;
}
static int F_122 ( struct V_102 * V_4 )
{
F_123 () ;
return 0 ;
}
static int F_124 ( struct V_102 * V_4 )
{
int V_1 ;
V_1 = F_125 () ;
if ( V_1 < 0 )
