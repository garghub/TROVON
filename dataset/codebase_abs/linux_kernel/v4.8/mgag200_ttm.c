...
int F_33 ( struct V_1 * V_58 )
{
int V_76 ;
struct V_77 * V_67 = V_58 -> V_67 ;
struct V_2 * V_5 = & V_58 -> V_4 . V_5 ;
V_76 = F_7 ( V_58 ) ;
if ( V_76 )
return V_76 ;
V_76 = F_34 ( & V_58 -> V_4 . V_5 ,
...
V_76 = F_35 ( V_5 , V_40 , V_58 -> V_82 . V_83 >> V_63 ) ;
if ( V_76 ) {
F_9 ( L_6 , V_76 ) ;
return V_76 ;
}
V_58 -> V_84 = F_36 ( F_22 ( V_67 -> V_68 , 0 ) ,
F_37 ( V_67 -> V_68 , 0 ) ) ;
return 0 ;
}
void F_38 ( struct V_1 * V_58 )
{
F_39 ( & V_58 -> V_4 . V_5 ) ;
F_11 ( V_58 ) ;
F_40 ( V_58 -> V_84 ) ;
...
int F_41 ( struct V_77 * V_67 , int V_15 , int V_95 ,
T_1 V_34 , struct V_27 * * V_96 )
{
struct V_1 * V_58 = V_67 -> V_97 ;
struct V_27 * V_49 ;
T_3 V_98 ;
int V_76 ;
...
F_18 ( V_49 , V_90 | V_50 ) ;
V_98 = F_43 ( & V_58 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_76 = F_44 ( & V_58 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_100 , & V_49 -> V_51 ,
V_95 >> V_63 , false , NULL , V_98 ,
NULL , NULL , F_12 ) ;
if ( V_76 )
return V_76 ;
* V_96 = V_49 ;
...
V_76 = F_47 ( & V_28 -> V_28 , & V_28 -> V_51 , false , false ) ;
if ( V_76 )
return V_76 ;
V_28 -> V_103 = 1 ;
if ( V_102 )
...
for ( V_87 = 0 ; V_87 < V_28 -> V_51 . V_91 ; V_87 ++ )
V_28 -> V_88 [ V_87 ] . V_34 &= ~ V_104 ;
return F_47 ( & V_28 -> V_28 , & V_28 -> V_51 , false , false ) ;
}
...
int F_51 ( struct V_52 * V_53 , struct V_107 * V_108 )
{
struct V_109 * V_110 ;
struct V_1 * V_58 ;
if ( F_52 ( V_108 -> V_111 < V_81 ) )
return - V_46 ;
V_110 = V_53 -> V_112 ;
V_58 = V_110 -> V_113 -> V_67 -> V_97 ;
return F_53 ( V_53 , V_108 , & V_58 -> V_4 . V_5 ) ;
}
