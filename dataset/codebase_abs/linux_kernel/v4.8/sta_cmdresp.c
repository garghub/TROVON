...
int V_108 ;
struct V_263 * V_280 ;
for ( V_108 = 0 ; V_108 < V_277 -> V_281 ; V_108 ++ ) {
...
int F_49 ( struct V_1 * V_2 , T_2 V_297 ,
struct V_3 * V_4 )
{
int V_298 = 0 ;
struct V_5 * V_6 = V_2 -> V_6 ;
...
break;
case V_318 :
V_298 = F_11 ( V_2 , V_4 , V_62 ) ;
break;
case V_319 :
V_298 = F_8 ( V_2 , V_4 ) ;
break;
case V_320 :
V_298 = F_10 ( V_2 , V_4 , V_62 ) ;
break;
case V_122 :
V_298 = F_22 ( V_2 , V_4 ) ;
break;
case V_321 :
V_298 = F_31 ( V_2 , V_4 , V_62 ) ;
break;
case V_322 :
V_298 = F_32 ( V_2 , V_4 , V_62 ) ;
break;
case V_323 :
break;
case V_324 :
V_298 = F_33 ( V_2 , V_4 , V_62 ) ;
break;
case V_325 :
case V_326 :
case V_327 :
...
break;
case V_333 :
if ( 0xffff == ( T_2 ) F_3 ( V_4 -> V_17 . V_334 . V_335 ) ) {
if ( V_6 -> V_336 == V_337 &&
V_6 -> V_338 ) {
if ( V_6 -> V_339 . V_340 )
V_6 -> V_339 .
...
break;
case V_368 :
V_298 = F_62 ( V_2 , V_4 , V_62 ) ;
break;
case V_369 :
break;
case V_370 :
V_298 = F_48 ( V_2 , V_4 , V_62 ) ;
break;
case V_371 :
break;
default:
