...
static void F_23 ( const struct V_35 * V_36 ,
const struct V_6 * V_7 ,
struct V_37 * V_38 )
{
const struct V_14 * V_15 = F_7 ( V_7 ) ;
...
struct V_17 * V_22 ;
F_9 ( & V_20 ) ;
for ( V_22 = F_24 ( & V_15 -> V_21 ) ; V_22 != NULL ; V_22 = F_25 ( V_22 ) ) {
...
static unsigned int F_26 ( const struct V_43 * const V_44 [] )
{
...
static bool F_30 ( const struct V_45 * V_46 , T_1 V_48 ,
struct V_49 * V_50 )
{
unsigned int V_51 ;
