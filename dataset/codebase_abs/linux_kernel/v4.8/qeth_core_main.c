...
int F_325 ( struct V_232 * V_233 , struct V_599 * * V_133 , int V_163 )
{
int V_600 , V_601 , V_602 ;
if ( ( ( unsigned long ) V_233 -> V_117 & V_603 ) !=
( ( ( unsigned long ) V_233 -> V_117 + V_163 - 1 ) & V_603 ) ) {
V_600 = F_326 ( V_233 ) ;
V_601 = V_403 - ( ( unsigned long ) V_233 -> V_117 % V_403 ) ;
V_602 = V_163 - V_601 ;
if ( V_602 > V_600 )
return 1 ;
memmove ( V_233 -> V_117 - V_602 , V_233 -> V_117 , F_324 ( V_233 ) ) ;
V_233 -> V_117 -= V_602 ;
V_233 -> V_604 -= V_602 ;
* V_133 = (struct V_599 * ) V_233 -> V_117 ;
F_68 ( 2 , L_248 , V_163 , V_602 ) ;
}
return 0 ;
}
static inline void F_327 ( struct V_232 * V_233 ,
struct V_520 * V_64 , int V_605 , int * V_255 ,
int V_184 )
{
...
while ( V_253 > 0 ) {
V_606 = V_403 - ( ( unsigned long ) V_117 % V_403 ) ;
if ( V_253 < V_606 )
V_606 = V_253 ;
V_64 -> V_245 [ V_245 ] . V_250 = V_117 ;
V_64 -> V_245 [ V_245 ] . V_253 = V_606 ;
V_253 -= V_606 ;
if ( ! V_253 ) {
if ( V_607 )
...
V_64 -> V_245 [ V_245 - 1 ] . V_254 = V_612 ;
* V_255 = V_245 ;
}
static inline int F_330 ( struct V_92 * V_111 ,
struct V_96 * V_231 , struct V_232 * V_233 ,
struct V_599 * V_133 , int V_184 , int V_613 )
{
struct V_520 * V_64 ;
int V_552 = 0 , V_614 , V_615 = 0 ;
V_64 = V_231 -> V_64 ;
F_76 ( & V_233 -> V_242 ) ;
F_331 ( & V_231 -> V_234 , V_233 ) ;
if ( V_133 -> V_133 . V_616 . V_310 == V_617 ) {
int V_245 = V_231 -> V_255 ;
V_614 = sizeof( struct V_618 ) +
( (struct V_618 * ) V_133 ) -> V_496 . V_619 ;
V_64 -> V_245 [ V_245 ] . V_250 = V_233 -> V_117 ;
V_64 -> V_245 [ V_245 ] . V_253 = V_614 ;
V_64 -> V_245 [ V_245 ] . V_254 = V_608 ;
V_231 -> V_255 ++ ;
V_233 -> V_117 += V_614 ;
V_233 -> V_163 -= V_614 ;
V_615 = 1 ;
...
V_64 -> V_245 [ V_245 ] . V_253 = sizeof( struct V_599 ) +
V_613 ;
V_64 -> V_245 [ V_245 ] . V_254 = V_608 ;
V_231 -> V_251 [ V_245 ] = 1 ;
V_231 -> V_255 ++ ;
}
F_327 ( V_233 , V_64 , V_615 ,
...
V_62 ;
F_60 ( & V_111 -> V_3 , V_446 ) ;
F_330 ( V_111 , V_64 , V_233 , V_133 , V_184 , V_613 ) ;
F_297 ( V_111 , V_169 , 1 ) ;
return 0 ;
V_73:
F_60 ( & V_111 -> V_3 , V_446 ) ;
...
struct V_232 * V_233 , struct V_599 * V_133 ,
int V_621 )
{
struct V_96 * V_64 ;
int V_624 ;
...
if ( V_9 -> V_32 & V_631 )
V_626 = V_632 ;
F_52 ( V_2 , 4 , L_254 , V_626 ) ;
V_113 = F_273 ( V_2 , V_633 ,
sizeof( struct V_493 ) + 8 ) ;
if ( ! V_113 )
return;
V_130 = (struct V_129 * ) ( V_113 -> V_117 + V_386 ) ;
V_130 -> V_117 . V_462 . V_117 . V_626 = V_626 ;
F_269 ( V_2 , V_113 , F_335 , NULL ) ;
}
int F_337 ( struct V_630 * V_9 , int V_634 )
{
struct V_1 * V_2 ;
char V_635 [ 15 ] ;
V_2 = V_9 -> V_636 ;
F_4 ( V_2 , 4 , L_255 ) ;
sprintf ( V_635 , L_256 , V_634 ) ;
F_4 ( V_2 , 4 , V_635 ) ;
if ( V_634 < 64 )
return - V_401 ;
if ( V_634 > 65535 )
...
struct V_638 * F_339 ( struct V_630 * V_9 )
{
struct V_1 * V_2 ;
V_2 = V_9 -> V_636 ;
F_4 ( V_2 , 5 , L_257 ) ;
...
V_130 = (struct V_129 * ) V_117 ;
if ( ! V_2 -> V_66 . V_303 ||
! ( V_2 -> V_12 . V_639 & V_640 ) ) {
memcpy ( V_2 -> V_9 -> V_641 ,
& V_130 -> V_117 . V_462 . V_117 . V_642 . V_250 ,
V_643 ) ;
V_2 -> V_12 . V_639 |= V_640 ;
}
F_271 ( V_2 , V_125 , ( unsigned long ) V_130 ) ;
...
struct V_129 * V_130 ;
F_4 ( V_2 , 4 , L_259 ) ;
V_113 = F_273 ( V_2 , V_644 ,
sizeof( struct V_493 ) +
sizeof( struct V_645 ) ) ;
if ( ! V_113 )
return - V_50 ;
V_130 = (struct V_129 * ) ( V_113 -> V_117 + V_386 ) ;
V_130 -> V_117 . V_462 . V_117 . V_642 . V_130 = V_646 ;
V_130 -> V_117 . V_462 . V_117 . V_642 . V_647 = V_643 ;
memcpy ( & V_130 -> V_117 . V_462 . V_117 . V_642 . V_250 ,
V_2 -> V_9 -> V_641 , V_643 ) ;
...
F_4 ( V_2 , 4 , L_260 ) ;
V_130 = (struct V_129 * ) V_117 ;
V_649 = & V_130 -> V_117 . V_462 . V_117 . V_651 ;
F_45 ( V_65 , 2 , L_260 ) ;
F_45 ( V_65 , 2 , L_261 , V_2 -> V_10 -> V_9 . V_652 . V_511 ) ;
F_45 ( V_65 , 2 , L_262 ,
V_130 -> V_117 . V_462 . V_133 . V_139 ) ;
if ( V_130 -> V_117 . V_462 . V_133 . V_139 !=
V_653 )
F_68 ( 3 , L_263 ,
V_2 -> V_10 -> V_9 . V_652 . V_511 ,
V_649 -> V_654 ,
V_130 -> V_117 . V_462 . V_133 . V_139 ) ;
...
int F_344 ( struct V_1 * V_2 , int V_650 )
{
int V_37 = 0 ;
F_4 ( V_2 , 4 , L_282 ) ;
...
int F_346 ( struct V_630 * V_9 , int V_666 , int V_667 )
{
...
break;
case V_681 :
V_37 = ( V_9 -> V_641 [ 0 ] << 16 ) | ( V_9 -> V_641 [ 1 ] << 8 ) |
V_9 -> V_641 [ 2 ] ;
V_37 = ( V_37 >> 5 ) & 0xFFFF ;
break;
case V_682 :
V_37 = ( V_9 -> V_641 [ 2 ] << 10 ) & 0xFFFF ;
break;
case V_683 :
V_37 = V_684 ;
break;
...
memcpy ( F_268 ( V_113 -> V_117 ) ,
& V_2 -> V_350 . V_411 , V_366 ) ;
V_705 = ( V_707 ) V_386 + V_163 ;
V_706 = ( V_707 ) V_163 ;
memcpy ( F_348 ( V_113 -> V_117 ) , & V_705 , 2 ) ;
memcpy ( F_349 ( V_113 -> V_117 ) , & V_706 , 2 ) ;
memcpy ( F_350 ( V_113 -> V_117 ) , & V_706 , 2 ) ;
memcpy ( F_351 ( V_113 -> V_117 ) , & V_706 , 2 ) ;
...
V_712 = & V_130 -> V_117 . V_462 . V_117 . V_712 ;
if ( V_130 -> V_133 . V_139 ) {
...
V_713 = * ( ( V_185 * ) F_349 ( V_117 ) ) ;
if ( V_130 -> V_117 . V_462 . V_133 . V_473 == 1 )
V_713 -= ( V_185 ) ( ( char * ) & V_712 -> V_117 - ( char * ) V_130 ) ;
else
V_713 -= ( V_185 ) ( ( char * ) & V_712 -> V_714 - ( char * ) V_130 ) ;
if ( ( V_710 -> V_715 - V_710 -> V_716 ) < V_713 ) {
F_52 ( V_2 , 4 , L_289 , - V_50 ) ;
V_130 -> V_133 . V_139 = V_717 ;
return 0 ;
}
F_52 ( V_2 , 4 , L_290 ,
...
if ( V_130 -> V_117 . V_462 . V_133 . V_473 == 1 ) {
memcpy ( V_710 -> V_718 + V_710 -> V_716 ,
( char * ) V_712 ,
V_713 + F_353 ( struct V_711 , V_117 ) ) ;
V_710 -> V_716 += F_353 ( struct V_711 , V_117 ) ;
} else {
memcpy ( V_710 -> V_718 + V_710 -> V_716 ,
( char * ) & V_712 -> V_714 , V_713 ) ;
}
V_710 -> V_716 += V_713 ;
F_52 ( V_2 , 4 , L_292 ,
V_130 -> V_117 . V_462 . V_133 . V_472 ) ;
...
int F_354 ( struct V_1 * V_2 , char T_4 * V_718 )
{
struct V_112 * V_113 ;
struct V_129 * V_130 ;
struct V_719 * V_720 ;
...
if ( F_355 ( & V_721 , V_718 + sizeof( int ) , sizeof( int ) ) )
return - V_723 ;
if ( V_721 > ( V_118 - V_386 -
sizeof( struct V_724 ) -
sizeof( struct V_493 ) ) )
return - V_401 ;
V_720 = F_356 ( V_718 , V_721 + sizeof( struct V_725 ) ) ;
if ( F_116 ( V_720 ) ) {
F_4 ( V_2 , 2 , L_295 ) ;
return F_117 ( V_720 ) ;
}
V_710 . V_715 = V_720 -> V_133 . V_713 ;
V_710 . V_718 = F_27 ( V_710 . V_715 , V_49 ) ;
if ( ! V_710 . V_718 ) {
F_32 ( V_720 ) ;
return - V_50 ;
}
V_710 . V_716 = sizeof( struct V_725 ) ;
V_113 = F_273 ( V_2 , V_722 ,
V_726 + V_721 ) ;
if ( ! V_113 ) {
V_37 = - V_50 ;
goto V_73;
...
V_130 = (struct V_129 * ) ( V_113 -> V_117 + V_386 ) ;
memcpy ( & V_130 -> V_117 . V_462 . V_117 . V_712 , & V_720 -> V_130 , V_721 ) ;
V_37 = F_347 ( V_2 , V_113 , V_727 + V_721 ,
F_352 , ( void * ) & V_710 ) ;
if ( V_37 )
F_68 ( 2 , L_296 ,
F_81 ( V_2 ) , V_37 ) ;
else {
if ( F_357 ( V_718 , V_710 . V_718 , V_710 . V_715 ) )
V_37 = - V_723 ;
}
V_73:
F_32 ( V_720 ) ;
...
F_4 ( V_2 , 3 , L_297 ) ;
V_130 = (struct V_129 * ) V_117 ;
V_729 = (struct V_728 * ) V_125 -> V_382 ;
V_731 = V_130 -> V_117 . V_462 . V_133 . V_470 ;
V_730 = ( char * ) V_117 + 28 ;
if ( V_731 > ( V_729 -> V_732 - V_729 -> V_733 ) ) {
V_130 -> V_133 . V_139 = V_734 ;
return 0 ;
}
memcpy ( ( V_729 -> V_64 + V_729 -> V_733 ) , V_730 ,
V_731 ) ;
V_729 -> V_733 += V_731 ;
if ( V_130 -> V_117 . V_462 . V_133 . V_473 <
V_130 -> V_117 . V_462 . V_133 . V_472 )
...
int F_359 ( struct V_1 * V_2 , char T_4 * V_718 )
{
int V_37 = 0 ;
struct V_112 * V_113 ;
struct V_129 * V_130 ;
...
if ( F_355 ( & V_738 , V_718 ,
sizeof( struct V_737 ) ) ) {
V_37 = - V_723 ;
goto V_73;
}
V_729 . V_732 = V_738 . V_732 ;
V_729 . V_733 = 0 ;
V_729 . V_64 = F_27 ( V_738 . V_732 , V_49 ) ;
if ( ! V_729 . V_64 ) {
V_37 = - V_50 ;
goto V_73;
}
V_113 = F_273 ( V_2 , V_739 ,
sizeof( struct V_493 ) +
sizeof( struct V_735 ) ) ;
if ( ! V_113 ) {
V_37 = - V_50 ;
...
V_130 = (struct V_129 * ) ( V_113 -> V_117 + V_386 ) ;
V_736 = & V_130 -> V_117 . V_462 . V_117 . V_741 ;
V_736 -> V_654 = V_738 . V_134 ;
V_37 = F_269 ( V_2 , V_113 , F_358 ,
& V_729 ) ;
if ( ! V_37 ) {
if ( F_360 () )
V_41 = F_361 ( V_738 . V_43 ) ;
else
V_41 = ( void T_4 * ) ( unsigned long ) V_738 . V_43 ;
if ( F_357 ( V_41 , V_729 . V_64 ,
V_729 . V_733 ) ) {
V_37 = - V_723 ;
goto V_740;
}
V_738 . V_733 = V_729 . V_733 ;
if ( F_357 ( V_718 , & V_738 ,
sizeof( struct V_737 ) ) )
V_37 = - V_723 ;
} else
if ( V_37 == V_734 )
...
struct V_744 * V_744 ;
F_4 ( V_2 , 2 , L_299 ) ;
V_744 = (struct V_744 * ) V_125 -> V_382 ;
V_130 = (struct V_129 * ) V_117 ;
V_743 = & V_130 -> V_117 . V_462 . V_117 . V_743 ;
if ( V_130 -> V_117 . V_462 . V_133 . V_139 == 0 ) {
V_744 -> V_745 = V_743 -> V_745 ;
V_744 -> V_746 = V_743 -> V_746 ;
V_744 -> V_747 = V_743 -> V_747 ;
}
F_271 ( V_2 , V_125 , ( unsigned long ) V_130 ) ;
return 0 ;
}
static int V_742 ( struct V_1 * V_2 ,
struct V_744 * V_744 )
{
struct V_112 * V_113 ;
F_4 ( V_2 , 2 , L_300 ) ;
...
F_168 ( V_2 , V_342 ) ;
F_32 ( V_342 ) ;
V_37 = F_366 ( V_749 , & V_2 -> V_753 ) ;
if ( V_37 )
F_45 ( V_65 , 2 , L_187 , V_37 ) ;
F_45 ( V_65 , 2 , L_303 , V_2 -> V_753 . V_754 ) ;
F_45 ( V_65 , 2 , L_304 , V_2 -> V_753 . V_755 ) ;
F_45 ( V_65 , 2 , L_304 , V_2 -> V_753 . V_756 ) ;
F_45 ( V_65 , 2 , L_305 , V_2 -> V_753 . V_757 ) ;
if ( ! ( ( V_2 -> V_753 . V_754 != V_758 ) ||
( ( V_2 -> V_753 . V_755 & V_759 ) == 0 ) ||
( ( V_2 -> V_753 . V_756 & V_760 ) == 0 ) ) ) {
F_89 ( & V_2 -> V_10 -> V_9 ,
L_306 ) ;
} else {
V_2 -> V_66 . V_67 = V_560 ;
...
F_369 [ V_44 ] = V_2 -> V_149 -> V_770 ;
F_368 ( V_2 , V_761 , F_369 ) ;
V_765 =
...
for ( V_44 = 0 , V_766 = 0 ; V_44 < V_2 -> V_46 . V_78 ; ++ V_44 )
for ( V_45 = 0 ; V_45 < V_62 ; ++ V_45 , ++ V_766 ) {
V_765 [ V_766 ] = (struct V_520 * ) F_310 (
V_2 -> V_46 . V_80 [ V_44 ] -> V_63 [ V_45 ] -> V_64 ) ;
}
memset ( & V_763 , 0 , sizeof( struct V_762 ) ) ;
V_763 . V_159 = F_44 ( V_2 ) ;
V_763 . V_772 = F_363 ( V_2 ) ;
V_763 . V_773 = 0 ;
V_763 . V_764 = V_764 ;
V_763 . V_774 = V_2 -> V_46 . V_72 ;
V_763 . V_775 = V_2 -> V_46 . V_78 ;
V_763 . V_776 = V_2 -> V_149 -> V_776 ;
V_763 . V_777 = V_2 -> V_149 -> V_777 ;
V_763 . V_778 = F_369 ;
V_763 . V_779 = ( unsigned long ) V_2 ;
V_763 . V_780 = ( void * * ) V_761 ;
V_763 . V_781 = ( void * * ) V_765 ;
V_763 . V_782 = V_2 -> V_46 . V_77 ;
V_763 . V_783 =
...
static inline int F_379 ( struct V_439 * V_789 ,
struct V_790 * V_245 ,
struct V_232 * * V_791 , int V_184 , int * V_792 , int V_713 )
{
...
* V_791 = F_261 ( V_440 + V_441 ) ;
if ( ! ( * V_791 ) )
return - V_50 ;
}
F_380 ( * V_791 , V_441 ) ;
if ( V_713 <= V_440 ) {
memcpy ( F_381 ( * V_791 , V_713 ) , V_245 -> V_250 + V_184 ,
V_713 ) ;
} else {
F_382 ( V_435 ) ;
memcpy ( F_381 ( * V_791 , V_440 ) ,
V_245 -> V_250 + V_184 , V_440 ) ;
F_383 ( * V_791 , * V_792 , V_435 ,
V_184 + V_440 ,
V_713 - V_440 ) ;
( * V_791 ) -> V_713 += V_713 - V_440 ;
( * V_791 ) -> V_163 += V_713 - V_440 ;
( * V_791 ) -> V_793 += V_713 - V_440 ;
( * V_792 ) ++ ;
}
} else {
F_382 ( V_435 ) ;
F_383 ( * V_791 , * V_792 , V_435 , V_184 , V_713 ) ;
( * V_791 ) -> V_713 += V_713 ;
( * V_791 ) -> V_163 += V_713 ;
( * V_791 ) -> V_793 += V_713 ;
( * V_792 ) ++ ;
...
static inline int F_384 ( struct V_790 * V_794 )
{
return ( V_794 -> V_254 & V_442 ) ;
}
...
int V_800 = 0 ;
int V_596 = 0 ;
if ( V_245 -> V_253 < V_184 + sizeof( struct V_599 ) ) {
if ( F_384 ( V_245 ) )
return NULL ;
V_245 ++ ;
V_184 = 0 ;
if ( V_245 -> V_253 < sizeof( struct V_599 ) )
return NULL ;
}
* V_133 = V_245 -> V_250 + V_184 ;
V_184 += sizeof( struct V_599 ) ;
switch ( ( * V_133 ) -> V_133 . V_801 . V_310 ) {
case V_802 :
V_797 = ( * V_133 ) -> V_133 . V_801 . V_803 ;
break;
case V_804 :
V_797 = ( * V_133 ) -> V_133 . V_616 . V_253 ;
V_799 = V_441 ;
break;
case V_805 :
V_797 = ( * V_133 ) -> V_133 . V_806 . V_807 ;
V_799 = sizeof( struct V_599 ) ;
break;
default:
break;
}
if ( ! V_797 )
return NULL ;
if ( ( ( V_797 >= V_2 -> V_66 . V_274 ) &&
( ! ( V_2 -> V_12 . type == V_18 ) ) &&
( ! F_51 ( & V_2 -> V_528 ) ) ) ||
( V_2 -> V_66 . V_67 == V_68 ) ) {
V_800 = 1 ;
} else {
V_233 = F_261 ( V_797 + V_799 ) ;
if ( ! V_233 )
goto V_808;
if ( V_799 )
F_380 ( V_233 , V_799 ) ;
...
while ( V_797 ) {
V_713 = F_211 ( V_797 , ( int ) ( V_245 -> V_253 - V_184 ) ) ;
if ( V_713 ) {
if ( V_800 ) {
if ( F_379 ( V_789 , V_245 ,
& V_233 , V_184 , & V_596 , V_713 ) )
goto V_808;
} else {
memcpy ( F_381 ( V_233 , V_713 ) , V_798 ,
V_713 ) ;
}
}
V_797 -= V_713 ;
...
V_2 -> V_437 . V_809 ++ ;
V_2 -> V_437 . V_810 += F_319 ( V_233 ) -> V_594 ;
}
return V_233 ;
V_808:
if ( F_386 () ) {
...
V_130 = (struct V_129 * ) V_117 ;
if ( V_130 -> V_133 . V_139 == 0 ) {
V_130 -> V_133 . V_139 = V_130 -> V_117 . V_811 . V_133 . V_139 ;
if ( V_130 -> V_133 . V_388 == V_389 )
V_2 -> V_66 . V_478 . V_481 = V_130 -> V_133 . V_457 ;
if ( V_130 -> V_133 . V_388 == V_482 )
V_2 -> V_66 . V_480 . V_481 = V_130 -> V_133 . V_457 ;
}
if ( V_130 -> V_117 . V_811 . V_133 . V_812 == V_813 &&
V_130 -> V_117 . V_811 . V_133 . V_471 == V_814 ) {
V_2 -> V_12 . V_815 = V_130 -> V_117 . V_811 . V_117 . V_816 ;
F_52 ( V_2 , 3 , L_320 , V_2 -> V_12 . V_815 ) ;
}
if ( V_130 -> V_117 . V_811 . V_133 . V_812 == V_817 &&
V_130 -> V_117 . V_811 . V_133 . V_471 == V_814 ) {
V_2 -> V_12 . V_818 =
V_130 -> V_117 . V_811 . V_117 . V_816 ;
...
struct V_129 * V_130 ;
F_4 ( V_2 , 4 , L_322 ) ;
V_113 = F_265 ( V_2 , V_821 , V_449 ) ;
if ( V_113 ) {
V_130 = (struct V_129 * ) ( V_113 -> V_117 + V_386 ) ;
V_130 -> V_117 . V_811 . V_133 . V_812 = V_820 ;
V_130 -> V_117 . V_811 . V_133 . V_253 = 8 + V_163 ;
V_130 -> V_117 . V_811 . V_133 . V_471 = V_337 ;
V_130 -> V_117 . V_811 . V_133 . V_139 = 0 ;
V_130 -> V_117 . V_811 . V_133 . V_473 = 0 ;
}
return V_113 ;
}
...
V_130 = (struct V_129 * ) ( V_113 -> V_117 + V_386 ) ;
if ( V_163 <= sizeof( T_1 ) )
V_130 -> V_117 . V_811 . V_117 . V_816 = ( T_1 ) V_117 ;
else
memcpy ( & V_130 -> V_117 . V_811 . V_117 , ( void * ) V_117 , V_163 ) ;
...
F_392 ( V_824 [ V_822 ] . V_310 ) ;
V_824 [ V_822 ] . V_310 = NULL ;
}
}
void F_393 ( T_5 * V_310 , int V_369 , char * V_825 , ... )
{
char V_826 [ 32 ] ;
T_6 args ;
...
return;
va_start ( args , V_825 ) ;
vsnprintf ( V_826 , sizeof( V_826 ) , V_825 , args ) ;
va_end ( args ) ;
F_395 ( V_310 , V_369 , V_826 ) ;
}
...
int V_822 ;
for ( V_822 = 0 ; V_822 < V_823 ; V_822 ++ ) {
V_824 [ V_822 ] . V_310 = F_397 ( V_824 [ V_822 ] . V_511 ,
V_824 [ V_822 ] . V_827 ,
V_824 [ V_822 ] . V_828 ,
V_824 [ V_822 ] . V_163 ) ;
if ( V_824 [ V_822 ] . V_310 == NULL ) {
F_391 () ;
return - V_50 ;
}
V_334 = F_398 ( V_824 [ V_822 ] . V_310 , V_824 [ V_822 ] . V_829 ) ;
if ( V_334 ) {
F_391 () ;
return V_334 ;
}
F_399 ( V_824 [ V_822 ] . V_310 , V_824 [ V_822 ] . V_369 ) ;
}
return 0 ;
}
...
{
struct V_836 * V_840 ;
V_2 -> V_841 = F_397 ( V_511 , 2 , 1 , 8 ) ;
if ( ! V_2 -> V_841 ) {
F_45 ( V_65 , 2 , L_261 , L_329 ) ;
goto V_842;
}
if ( F_398 ( V_2 -> V_841 , & V_843 ) )
goto V_844;
V_840 = F_27 ( sizeof( struct V_836 ) , V_49 ) ;
if ( ! V_840 )
goto V_844;
strncpy ( V_840 -> V_838 , V_511 , V_845 ) ;
V_840 -> V_839 = V_2 -> V_841 ;
F_401 ( & V_837 ) ;
F_33 ( & V_840 -> V_846 , & V_847 ) ;
F_404 ( & V_837 ) ;
return 0 ;
V_844:
F_392 ( V_2 -> V_841 ) ;
...
snprintf ( V_838 , sizeof( V_838 ) , L_331 ,
F_69 ( & V_10 -> V_9 ) ) ;
V_2 -> V_841 = F_407 ( V_838 ) ;
if ( ! V_2 -> V_841 ) {
V_37 = F_408 ( V_2 , V_838 ) ;
if ( V_37 )
goto V_851;
}
...
F_412 ( & V_10 -> V_9 , V_2 ) ;
V_2 -> V_10 = V_10 ;
V_10 -> V_159 [ 0 ] -> V_852 = F_118 ;
V_10 -> V_159 [ 1 ] -> V_852 = F_118 ;
V_10 -> V_159 [ 2 ] -> V_852 = F_118 ;
V_37 = F_151 ( V_2 ) ;
if ( V_37 ) {
F_45 ( V_65 , 2 , L_140 , V_37 ) ;
goto V_851;
...
case V_18 :
case V_16 :
V_37 = F_400 ( V_2 , V_834 ) ;
if ( V_37 )
goto V_851;
V_37 = V_2 -> V_149 -> V_855 ( V_2 -> V_10 ) ;
if ( V_37 )
goto V_856;
case V_14 :
case V_17 :
...
F_413 ( & V_857 . V_858 , V_32 ) ;
F_102 ( & V_2 -> V_42 , & V_857 . V_42 ) ;
F_414 ( & V_857 . V_858 , V_32 ) ;
F_364 ( V_2 ) ;
return 0 ;
V_856:
F_405 ( V_2 ) ;
...
static T_7 F_425 ( struct V_868 * V_869 ,
const char * V_231 , T_8 V_167 )
{
int V_842 ;
V_842 = F_426 ( V_870 ,
& V_871 , 3 , V_231 ) ;
return V_842 ? V_842 : V_167 ;
}
int F_427 ( struct V_630 * V_9 , int V_872 )
{
switch ( V_872 ) {
case V_873 :
return ( sizeof( V_874 ) / V_875 ) ;
default:
return - V_401 ;
}
}
void F_428 ( struct V_630 * V_9 ,
struct V_876 * V_523 , T_9 * V_117 )
{
struct V_1 * V_2 = V_9 -> V_636 ;
V_117 [ 0 ] = V_2 -> V_523 . V_877 -
V_2 -> V_437 . V_878 ;
V_117 [ 1 ] = V_2 -> V_437 . V_879 ;
V_117 [ 2 ] = V_2 -> V_523 . V_880 -
V_2 -> V_437 . V_881 ;
V_117 [ 3 ] = V_2 -> V_437 . V_551 ;
V_117 [ 4 ] = V_2 -> V_523 . V_880 - V_2 -> V_437 . V_881
- V_2 -> V_437 . V_620 ;
V_117 [ 5 ] = V_2 -> V_437 . V_551 - V_2 -> V_437 . V_555 ;
V_117 [ 6 ] = V_2 -> V_437 . V_620 ;
V_117 [ 7 ] = V_2 -> V_437 . V_555 ;
V_117 [ 8 ] = V_2 -> V_437 . V_882 ;
V_117 [ 9 ] = V_2 -> V_437 . V_883 ;
V_117 [ 10 ] = V_2 -> V_437 . V_809 ;
V_117 [ 11 ] = V_2 -> V_437 . V_810 ;
V_117 [ 12 ] = V_2 -> V_437 . V_438 ;
V_117 [ 13 ] = ( V_2 -> V_437 . V_884 >> 10 ) ;
V_117 [ 14 ] = V_2 -> V_437 . V_885 ;
...
V_117 [ 23 ] = V_2 -> V_437 . V_886 ;
V_117 [ 24 ] = V_2 -> V_437 . V_887 ;
V_117 [ 25 ] = V_2 -> V_437 . V_532 ;
V_117 [ 26 ] = V_2 -> V_437 . V_530 ;
V_117 [ 27 ] = V_2 -> V_437 . V_575 ;
V_117 [ 28 ] = V_2 -> V_437 . V_571 ;
V_117 [ 29 ] = V_2 -> V_437 . V_888 ;
V_117 [ 30 ] = V_2 -> V_437 . V_889 ;
V_117 [ 31 ] = V_2 -> V_437 . V_548 ;
V_117 [ 32 ] = V_2 -> V_437 . V_544 ;
V_117 [ 33 ] = V_2 -> V_437 . V_890 ;
V_117 [ 34 ] = V_2 -> V_437 . V_891 ;
V_117 [ 35 ] = V_2 -> V_437 . V_892 ;
V_117 [ 36 ] = V_2 -> V_437 . V_562 ;
V_117 [ 37 ] = V_2 -> V_437 . V_567 ;
}
void F_429 ( struct V_630 * V_9 , V_707 V_872 , V_279 * V_117 )
{
switch ( V_872 ) {
case V_873 :
memcpy ( V_117 , & V_874 ,
...
void F_430 ( struct V_630 * V_9 ,
struct V_893 * V_12 )
{
struct V_1 * V_2 = V_9 -> V_636 ;
F_431 ( V_12 -> V_894 , V_2 -> V_66 . V_303 ? L_326 : L_325 ,
sizeof( V_12 -> V_894 ) ) ;
F_431 ( V_12 -> V_895 , L_333 , sizeof( V_12 -> V_895 ) ) ;
F_431 ( V_12 -> V_896 , V_2 -> V_12 . V_300 ,
sizeof( V_12 -> V_896 ) ) ;
snprintf ( V_12 -> V_897 , sizeof( V_12 -> V_897 ) , L_334 ,
F_432 ( V_2 ) , F_433 ( V_2 ) , F_434 ( V_2 ) ) ;
}
static void F_435 ( struct V_898 * V_899 ,
int V_900 , int V_901 )
{
int V_902 , V_903 , V_904 , V_905 ;
switch ( V_901 ) {
case V_906 :
V_902 = V_907 ;
V_903 = V_908 ;
...
V_899 -> V_930 = V_931 | V_903 | V_905 ;
V_899 -> V_932 = V_933 | V_902 | V_904 ;
}
int F_436 ( struct V_630 * V_934 ,
struct V_898 * V_899 )
{
struct V_1 * V_2 = V_934 -> V_636 ;
enum V_447 V_19 ;
struct V_744 V_744 ;
int V_37 ;
V_707 V_935 ;
...
case V_20 :
case V_24 :
F_435 ( V_899 , V_920 , V_906 ) ;
V_935 = V_920 ;
V_899 -> V_942 = V_906 ;
break;
case V_22 :
case V_26 :
F_435 ( V_899 , V_915 , V_909 ) ;
V_935 = V_915 ;
V_899 -> V_942 = V_909 ;
break;
case V_23 :
F_435 ( V_899 , V_912 , V_909 ) ;
V_935 = V_912 ;
V_899 -> V_942 = V_909 ;
break;
default:
F_435 ( V_899 , V_925 , V_906 ) ;
V_935 = V_925 ;
V_899 -> V_942 = V_906 ;
}
F_437 ( V_899 , V_935 ) ;
...
static int F_439 ( struct V_1 * V_2 , int V_956 )
{
long V_957 ;
int V_37 ;
V_37 = F_390 ( V_2 , V_956 , V_814 , 0 ) ;
if ( V_37 ) {
F_67 ( & V_2 -> V_10 -> V_9 ,
L_336 ,
F_81 ( V_2 ) ) ;
...
V_957 = ( V_956 == V_817 ) ? V_2 -> V_12 . V_818
: V_2 -> V_12 . V_815 ;
V_37 = F_390 ( V_2 , V_956 , V_958 ,
V_957 ) ;
if ( V_37 ) {
F_67 ( & V_2 -> V_10 -> V_9 ,
L_337 ,
...
F_89 ( & V_2 -> V_10 -> V_9 , L_338 ,
V_956 == V_813 ? L_339 : L_340 ) ;
return 0 ;
}
static int F_440 ( struct V_1 * V_2 , int V_959 , int V_956 )
{
int V_37 ;
if ( V_959 ) {
V_37 = F_439 ( V_2 , V_956 ) ;
if ( V_37 )
return - V_116 ;
} else {
V_37 = F_390 ( V_2 , V_956 ,
V_960 , 0 ) ;
if ( V_37 )
return - V_116 ;
}
...
static int F_441 ( struct V_1 * V_2 , int V_959 )
{
int V_37 ;
F_4 ( V_2 , 3 , L_341 ) ;
if ( V_959 ) {
V_37 = F_390 ( V_2 , V_961 ,
V_814 , 0 ) ;
if ( V_37 ) {
F_67 ( & V_2 -> V_10 -> V_9 ,
L_342 ,
...
int F_442 ( struct V_630 * V_9 )
{
struct V_1 * V_2 = V_9 -> V_636 ;
T_10 V_282 = V_9 -> V_962 ;
if ( V_282 & V_963 ) {
if ( F_440 ( V_2 , 1 , V_817 ) )
V_282 ^= V_963 ;
}
if ( V_282 & V_964 ) {
if ( F_440 ( V_2 , 1 , V_813 ) )
V_282 ^= V_964 ;
}
if ( V_282 & V_965 ) {
if ( F_441 ( V_2 , 1 ) )
...
int F_443 ( struct V_630 * V_9 , T_10 V_962 )
{
struct V_1 * V_2 = V_9 -> V_636 ;
T_10 V_966 = V_9 -> V_962 ^ V_962 ;
int V_37 = 0 ;
F_41 ( V_65 , 2 , L_345 ) ;
F_39 ( V_65 , 2 , & V_962 , sizeof( V_962 ) ) ;
if ( ( V_966 & V_963 ) ) {
V_37 = F_440 ( V_2 ,
V_962 & V_963 ? 1 : 0 ,
V_817 ) ;
...
if ( ( V_966 & V_965 ) ) {
V_37 = F_441 ( V_2 , V_962 & V_965 ? 1 : 0 ) ;
if ( V_37 )
V_966 ^= V_965 ;
}
if ( ( V_9 -> V_962 ^ V_962 ) == V_966 )
return 0 ;
V_9 -> V_962 ^= V_966 ;
return - V_116 ;
}
T_10 F_444 ( struct V_630 * V_9 ,
T_10 V_962 )
{
struct V_1 * V_2 = V_9 -> V_636 ;
F_41 ( V_65 , 2 , L_346 ) ;
...
if ( V_2 -> V_3 == V_55 ||
V_2 -> V_3 == V_56 )
V_962 = V_962 & ~ ( V_963 | V_964 |
V_965 ) ;
F_39 ( V_65 , 2 , & V_962 , sizeof( V_962 ) ) ;
return V_962 ;
}
static int T_11 F_445 ( void )
{
int V_37 ;
F_446 ( L_348 ) ;
F_137 ( & V_857 . V_42 ) ;
...
goto V_968;
V_252 = F_451 ( L_351 ,
sizeof( struct V_599 ) + V_441 , 64 , 0 , NULL ) ;
if ( ! V_252 ) {
V_37 = - V_50 ;
goto V_969;
}
