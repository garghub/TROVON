...
if ( ! ( V_6 -> V_11 -> V_2 -> V_101 . V_102 & V_103 ) )
return - V_104 ;
V_128 = F_35 ( V_6 -> V_11 -> V_2 ) ;
if ( F_36 ( V_128 ) )
return - V_105 ;
V_99 = V_128 -> V_108 ;
V_96 =
(struct V_95 * ) V_128 -> V_106 ;
for ( V_62 = 0 ; V_62 < V_46 ; V_62 ++ ) {
V_100 = V_6 -> V_40 | ( ( 1 << V_62 ) << 8 ) |
( V_107 << 16 ) ;
V_96 -> V_129 = F_43 (
F_41 ) ;
V_96 -> V_130 = F_43 ( F_42 ) ;
V_96 -> V_114 = F_43 ( V_94 -> V_113 [ V_62 ] << V_115 ) ;
...
V_96 -> V_125 = F_43 ( V_94 -> V_125 [ V_62 ] ) ;
V_6 -> V_127 [ V_62 ] = V_94 -> V_126 [ V_62 ] ;
if ( V_94 -> V_126 [ V_62 ] == V_131 )
V_96 -> V_114 |= F_43 ( 1 << V_132 ) ;
