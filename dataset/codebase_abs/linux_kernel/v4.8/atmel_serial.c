...
if ( V_233 ) {
if ( F_126 ( V_233 , L_15 , NULL ) ) {
if ( F_126 ( V_233 , L_16 , NULL ) ) {
V_10 -> V_14 = true ;
V_10 -> V_11 = false ;
} else {
V_10 -> V_14 = false ;
...
static void F_129 ( struct V_2 * V_4 )
{
struct V_1 * V_10 = F_1 ( V_4 ) ;
if ( F_14 ( V_4 ) ) {
V_10 -> V_239 = & F_90 ;
...
static int F_131 ( struct V_2 * V_4 )
{
struct V_230 * V_231 = F_132 ( V_4 -> V_45 ) ;
struct V_1 * V_10 = F_1 ( V_4 ) ;
struct V_254 * V_255 = V_4 -> V_117 -> V_4 . V_255 ;
int V_256 ;
F_5 ( V_4 , V_38 , - 1 ) ;
V_10 -> V_86 = false ;
V_256 = F_133 ( V_4 -> V_194 , F_101 ,
V_257 | V_258 ,
V_255 ? V_255 -> V_243 : L_27 , V_4 ) ;
if ( V_256 ) {
F_65 ( V_4 -> V_45 , L_28 ) ;
return V_256 ;
}
F_134 ( & V_10 -> V_18 , 0 ) ;
F_135 ( & V_10 -> V_115 , F_122 ,
( unsigned long ) V_4 ) ;
F_135 ( & V_10 -> V_132 , F_123 ,
( unsigned long ) V_4 ) ;
F_124 ( V_10 , V_231 ) ;
F_129 ( V_4 ) ;
if ( V_10 -> V_239 ) {
V_256 = V_10 -> V_239 ( V_4 ) ;
if ( V_256 < 0 )
F_129 ( V_4 ) ;
}
if ( V_10 -> V_241 ) {
V_256 = V_10 -> V_241 ( V_4 ) ;
if ( V_256 < 0 )
F_129 ( V_4 ) ;
}
if ( V_10 -> V_15 ) {
...
V_10 -> V_190 = F_19 ( V_4 ) ;
F_5 ( V_4 , V_66 , V_76 | V_271 ) ;
F_5 ( V_4 , V_66 , V_272 | V_77 ) ;
F_140 ( & V_10 -> V_186 ,
F_92 ,
( unsigned long ) V_4 ) ;
if ( F_11 ( V_4 ) ) {
...
static void F_148 ( struct V_2 * V_4 , unsigned int V_117 ,
unsigned int V_274 )
{
struct V_1 * V_10 = F_1 ( V_4 ) ;
switch ( V_117 ) {
case 0 :
F_149 ( V_10 -> V_275 ) ;
F_5 ( V_4 , V_53 , V_10 -> V_276 ) ;
break;
case 3 :
V_10 -> V_276 = F_3 ( V_4 , V_198 ) ;
F_5 ( V_4 , V_38 , - 1 ) ;
F_150 ( V_10 -> V_275 ) ;
break;
default:
...
static void F_151 ( struct V_2 * V_4 , struct V_277 * V_278 ,
struct V_277 * V_279 )
{
unsigned long V_43 ;
unsigned int V_280 , V_37 , V_281 , V_282 , V_283 ;
V_37 = V_280 = F_3 ( V_4 , V_40 ) ;
V_37 &= ~ ( V_284 | V_285 | V_286 |
V_287 | V_41 ) ;
V_283 = F_152 ( V_4 , V_278 , V_279 , 0 , V_4 -> V_288 / 16 ) ;
V_282 = F_153 ( V_4 , V_283 ) ;
if ( V_282 > 65535 ) {
V_282 /= 8 ;
V_37 |= V_289 ;
}
...
V_4 -> V_314 |= ( V_107 | V_106 ) ;
if ( V_278 -> V_309 & V_311 ) {
V_4 -> V_314 |= V_105 ;
if ( V_278 -> V_309 & V_315 )
V_4 -> V_314 |= V_112 ;
}
F_154 ( V_4 , V_278 -> V_290 , V_283 ) ;
V_281 = F_3 ( V_4 , V_198 ) ;
F_5 ( V_4 , V_38 , - 1 ) ;
F_5 ( V_4 , V_66 , V_316 | V_83 ) ;
if ( V_4 -> V_42 . V_43 & V_44 ) {
F_5 ( V_4 , V_47 ,
V_4 -> V_42 . V_48 ) ;
V_37 |= V_49 ;
...
F_5 ( V_4 , V_66 , V_272 | V_77 ) ;
F_5 ( V_4 , V_53 , V_281 ) ;
if ( F_155 ( V_4 , V_278 -> V_290 ) )
F_33 ( V_4 ) ;
else
F_35 ( V_4 ) ;
F_55 ( & V_4 -> V_126 , V_43 ) ;
}
static void F_156 ( struct V_2 * V_4 , struct V_277 * V_278 )
{
...
static const char * F_157 ( struct V_2 * V_4 )
{
return ( V_4 -> type == V_324 ) ? L_31 : NULL ;
}
static void F_158 ( struct V_2 * V_4 )
{
struct V_230 * V_231 = F_132 ( V_4 -> V_45 ) ;
int V_325 = V_231 -> V_326 [ 0 ] . V_327 - V_231 -> V_326 [ 0 ] . V_328 + 1 ;
F_159 ( V_4 -> V_162 , V_325 ) ;
if ( V_4 -> V_43 & V_329 ) {
F_160 ( V_4 -> V_6 ) ;
V_4 -> V_6 = NULL ;
}
...
struct V_230 * V_231 = F_132 ( V_4 -> V_45 ) ;
int V_325 = V_231 -> V_326 [ 0 ] . V_327 - V_231 -> V_326 [ 0 ] . V_328 + 1 ;
if ( ! F_162 ( V_4 -> V_162 , V_325 , L_27 ) )
return - V_330 ;
if ( V_4 -> V_43 & V_329 ) {
V_4 -> V_6 = F_163 ( V_4 -> V_162 , V_325 ) ;
if ( V_4 -> V_6 == NULL ) {
F_159 ( V_4 -> V_162 , V_325 ) ;
return - V_226 ;
}
...
static void F_164 ( struct V_2 * V_4 , int V_43 )
{
if ( V_43 & V_331 ) {
V_4 -> type = V_324 ;
F_161 ( V_4 ) ;
...
static int F_165 ( struct V_2 * V_4 , struct V_332 * V_333 )
{
int V_20 = 0 ;
if ( V_333 -> type != V_334 && V_333 -> type != V_324 )
V_20 = - V_131 ;
if ( V_4 -> V_194 != V_333 -> V_194 )
V_20 = - V_131 ;
if ( V_333 -> V_335 != V_336 )
V_20 = - V_131 ;
if ( V_4 -> V_288 / 16 != V_333 -> V_337 )
V_20 = - V_131 ;
if ( V_4 -> V_162 != ( unsigned long ) V_333 -> V_338 )
V_20 = - V_131 ;
...
static void F_168 ( struct V_2 * V_4 , unsigned char V_95 )
{
while ( ! ( F_3 ( V_4 , V_21 ) & V_52 ) )
F_167 () ;
F_8 ( V_4 , V_95 ) ;
}
static int F_169 ( struct V_1 * V_10 ,
struct V_230 * V_231 )
{
int V_20 ;
struct V_2 * V_4 = & V_10 -> V_3 ;
...
V_4 -> V_346 = 1 ;
V_4 -> V_45 = & V_231 -> V_45 ;
V_4 -> V_162 = V_231 -> V_326 [ 0 ] . V_328 ;
V_4 -> V_194 = V_231 -> V_326 [ 1 ] . V_328 ;
V_4 -> V_347 = F_23 ;
memset ( & V_10 -> V_98 , 0 , sizeof( V_10 -> V_98 ) ) ;
if ( V_236 && V_236 -> V_348 ) {
V_4 -> V_6 = V_236 -> V_348 ;
} else {
V_4 -> V_43 |= V_329 ;
V_4 -> V_6 = NULL ;
...
if ( ! V_10 -> V_275 ) {
V_10 -> V_275 = F_170 ( & V_231 -> V_45 , L_32 ) ;
if ( F_171 ( V_10 -> V_275 ) ) {
V_20 = F_172 ( V_10 -> V_275 ) ;
V_10 -> V_275 = NULL ;
return V_20 ;
}
V_20 = F_149 ( V_10 -> V_275 ) ;
if ( V_20 ) {
F_173 ( V_10 -> V_275 ) ;
V_10 -> V_275 = NULL ;
return V_20 ;
}
V_4 -> V_288 = F_174 ( V_10 -> V_275 ) ;
F_150 ( V_10 -> V_275 ) ;
}
if ( V_4 -> V_42 . V_43 & V_44 )
V_10 -> V_39 = V_46 ;
...
static void F_175 ( struct V_2 * V_4 , int V_95 )
{
while ( ! ( F_3 ( V_4 , V_21 ) & V_52 ) )
F_167 () ;
F_8 ( V_4 , V_95 ) ;
}
static void F_176 ( struct V_349 * V_350 , const char * V_351 , T_3 V_174 )
{
struct V_2 * V_4 = & V_352 [ V_350 -> V_353 ] . V_3 ;
struct V_1 * V_10 = F_1 ( V_4 ) ;
unsigned int V_19 , V_281 ;
unsigned int V_206 ;
V_281 = F_3 ( V_4 , V_198 ) ;
F_5 ( V_4 , V_38 ,
V_82 | V_10 -> V_39 ) ;
...
static void T_9 F_178 ( struct V_2 * V_4 , int * V_283 ,
int * V_110 , int * V_354 )
{
...
if ( ! V_282 )
return;
V_355 = F_3 ( V_4 , V_40 ) & V_285 ;
if ( V_355 == V_298 )
* V_354 = 8 ;
else
* V_354 = 7 ;
V_355 = F_3 ( V_4 , V_40 ) & V_287 ;
if ( V_355 == V_307 )
* V_110 = 'e' ;
else if ( V_355 == V_306 )
* V_110 = 'o' ;
...
static int T_9 F_179 ( struct V_349 * V_350 , char * V_357 )
{
int V_20 ;
struct V_2 * V_4 = & V_352 [ V_350 -> V_353 ] . V_3 ;
int V_283 = 115200 ;
...
V_20 = F_149 ( V_352 [ V_350 -> V_353 ] . V_275 ) ;
if ( V_20 )
return V_20 ;
F_5 ( V_4 , V_38 , - 1 ) ;
F_5 ( V_4 , V_66 , V_76 | V_271 ) ;
F_5 ( V_4 , V_66 , V_272 | V_77 ) ;
if ( V_357 )
F_180 ( V_357 , & V_283 , & V_110 , & V_354 , & V_358 ) ;
else
F_178 ( V_4 , & V_283 , & V_110 , & V_354 ) ;
return F_181 ( V_4 , V_350 , V_283 , V_110 , V_354 , V_358 ) ;
}
...
struct V_235 * V_236 =
F_125 ( & V_360 -> V_45 ) ;
int V_361 = V_236 -> V_362 ;
struct V_1 * V_10 = & V_352 [ V_361 ] ;
V_10 -> V_276 = 0 ;
V_10 -> V_3 . line = V_361 ;
F_183 ( V_363 , V_361 , NULL ) ;
V_20 = F_169 ( V_10 , V_360 ) ;
if ( V_20 )
return V_20 ;
F_184 ( & V_364 ) ;
}
...
static inline bool F_186 ( struct V_2 * V_4 )
{
...
F_55 ( & V_10 -> V_197 , V_43 ) ;
F_196 ( & V_369 , V_4 ) ;
F_193 ( & V_231 -> V_45 , V_10 -> V_368 ) ;
return 0 ;
}
static void F_197 ( struct V_1 * V_10 ,
struct V_230 * V_231 )
{
V_10 -> V_15 = 0 ;
V_10 -> V_268 = 0 ;
V_10 -> V_267 = 0 ;
if ( F_198 ( V_231 -> V_45 . V_234 ,
L_33 ,
& V_10 -> V_15 ) )
return;
if ( ! V_10 -> V_15 )
...
if ( V_10 -> V_15 < V_370 ) {
V_10 -> V_15 = 0 ;
F_65 ( & V_231 -> V_45 , L_34 ) ;
return;
}
V_10 -> V_267 = F_199 ( int , V_10 -> V_15 >> 1 ,
V_10 -> V_15 - V_371 ) ;
V_10 -> V_268 = F_199 ( int , V_10 -> V_15 >> 2 ,
V_10 -> V_15 - V_372 ) ;
F_72 ( & V_231 -> V_45 , L_35 ,
V_10 -> V_15 ) ;
F_24 ( & V_231 -> V_45 , L_36 ,
V_10 -> V_267 ) ;
F_24 ( & V_231 -> V_45 , L_37 ,
V_10 -> V_268 ) ;
}
...
F_201 ( V_103 & ( V_103 - 1 ) ) ;
if ( V_233 )
V_20 = F_202 ( V_233 , L_38 ) ;
else
if ( V_236 )
V_20 = V_236 -> V_362 ;
if ( V_20 < 0 )
V_20 = F_203 ( V_374 , V_375 ) ;
if ( V_20 >= V_375 ) {
V_20 = - V_359 ;
goto V_376;
}
...
F_134 ( & V_10 -> V_18 , 0 ) ;
F_74 ( & V_10 -> V_197 ) ;
V_20 = F_169 ( V_10 , V_231 ) ;
if ( V_20 )
goto V_377;
V_10 -> V_22 = F_205 ( & V_10 -> V_3 , 0 ) ;
if ( F_171 ( V_10 -> V_22 ) ) {
V_20 = F_172 ( V_10 -> V_22 ) ;
goto V_377;
}
if ( ! F_11 ( & V_10 -> V_3 ) ) {
V_20 = - V_226 ;
...
V_373 = V_10 -> V_3 . V_42 . V_43 & V_44 ;
V_20 = F_206 ( & V_369 , & V_10 -> V_3 ) ;
if ( V_20 )
goto V_379;
#ifdef F_207
if ( F_186 ( & V_10 -> V_3 )
...
F_146 ( & V_10 -> V_132 ) ;
F_208 ( & V_231 -> V_45 , 0 ) ;
V_20 = F_212 ( & V_369 , V_4 ) ;
F_115 ( V_10 -> V_98 . V_104 ) ;
F_210 ( V_4 -> line , V_374 ) ;
F_173 ( V_10 -> V_275 ) ;
V_10 -> V_275 = NULL ;
return V_20 ;
}
