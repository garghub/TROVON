...
return - V_124 ;
if ( V_71 -> V_35 ) {
V_59 = F_70 ( ( V_125 * ) V_27 -> V_46 , V_120 ,
V_71 -> V_35 * V_27 -> V_47 ) ;
if ( V_59 < 0 )
return V_59 ;
...
F_55 ( & V_27 -> V_69 ) ;
if ( ( V_27 -> V_33 & V_126 ) ||
( V_27 -> V_46 [ 0 ] . V_32 == V_27 -> V_32 ) )
V_27 -> V_46 [ 0 ] . V_32 = V_27 -> V_32 & ~ V_137 ;
} else {
if ( V_27 -> V_33 & V_133 ) {
V_27 -> V_75 = V_71 -> V_75 ;
V_27 -> V_76 = V_71 -> V_76 ;
...
static int F_80 ( struct V_139 * V_6 , struct V_119 * V_120 , T_3 V_140 )
{
...
if ( V_140 < V_118 )
return - V_117 ;
V_141 = F_70 ( ( V_125 * ) & V_71 , V_120 , V_118 ) ;
if ( V_141 < 0 )
return V_141 ;
V_47 = F_72 ( V_71 . V_33 ) ;
if ( ( V_140 - V_118 ) % V_47 )
return - V_117 ;
if ( ! V_14 && V_120 -> V_144 ) {
F_81 ( struct V_56 * , V_57 , V_120 -> V_144 ) ;
if ( V_120 -> V_145 < sizeof( * V_57 ) )
return - V_117 ;
if ( V_57 -> V_64 != V_65 )
return - V_117 ;
V_14 = V_57 -> V_66 ;
...
switch ( V_71 . V_73 ) {
case V_147 :
V_141 = F_69 ( & V_71 , V_120 , V_14 , V_7 ) ;
break;
case V_148 :
V_141 = F_77 ( & V_71 , V_120 , V_14 , V_7 ) ;
break;
case V_149 :
...
case V_151 :
V_71 . V_73 = V_152 ;
V_141 = F_68 ( & V_25 -> V_123 , & V_71 , V_14 ) ;
break;
case V_153 :
V_71 . V_73 = V_154 ;
V_141 = F_68 ( & V_25 -> V_138 , & V_71 , V_14 ) ;
break;
case V_155 :
if ( ( V_71 . V_35 != 1 ) || ( V_140 != V_47 + V_118 ) )
V_141 = - V_117 ;
else
V_141 = F_79 ( V_120 , V_14 , V_7 , V_47 ) ;
break;
default:
V_141 = - V_117 ;
break;
...
static int F_84 ( struct V_156 * V_157 , unsigned long V_120 ,
void * V_158 )
{
struct V_15 * V_16 = F_85 ( V_158 ) ;
struct V_5 * V_25 = F_38 ( V_157 , struct V_5 , V_159 ) ;
...
if ( V_27 -> V_113 == V_16 )
F_60 ( V_16 , V_27 ) ;
if ( V_25 -> V_142 && V_25 -> V_14 == V_16 -> V_14 ) {
V_25 -> V_142 = 0 ;
V_25 -> V_14 = 0 ;
V_160 = 1 ;
}
...
F_90 ( & V_25 -> V_123 ) ;
F_90 ( & V_25 -> V_138 ) ;
V_25 -> V_159 . V_169 = F_84 ;
F_91 ( & V_25 -> V_159 ) ;
return 0 ;
}
static int F_92 ( struct V_139 * V_6 )
{
struct V_6 * V_7 = V_6 -> V_7 ;
struct V_5 * V_25 ;
struct V_26 * V_27 , * V_170 ;
if ( V_7 == NULL )
return 0 ;
V_25 = F_2 ( V_7 ) ;
F_93 ( & V_25 -> V_159 ) ;
...
static int F_97 ( struct V_139 * V_6 , struct V_173 * V_174 , int V_94 ,
int V_33 )
{
struct V_56 * V_57 = (struct V_56 * ) V_174 ;
struct V_6 * V_7 = V_6 -> V_7 ;
struct V_5 * V_25 = F_2 ( V_7 ) ;
if ( V_94 < sizeof( * V_57 ) )
return - V_117 ;
...
V_25 -> V_142 = 1 ;
if ( V_171 ) {
sprintf ( V_25 -> V_172 , L_28 , F_98 ( V_7 ) ) ;
V_25 -> V_168 = F_99 ( V_25 -> V_172 , 0644 ,
V_171 ,
& V_176 , V_7 ) ;
}
return 0 ;
}
static int F_100 ( struct V_139 * V_6 , struct V_119 * V_120 , T_3 V_140 ,
int V_33 )
{
struct V_6 * V_7 = V_6 -> V_7 ;
struct V_43 * V_44 ;
...
V_177 = V_33 & V_178 ;
V_33 &= ~ V_178 ;
V_44 = F_101 ( V_7 , V_33 , V_177 , & error ) ;
if ( ! V_44 )
return error ;
if ( V_44 -> V_94 < V_140 )
V_140 = V_44 -> V_94 ;
V_59 = F_102 ( V_120 , V_44 -> V_4 , V_140 ) ;
if ( V_59 < 0 ) {
F_103 ( V_7 , V_44 ) ;
return V_59 ;
}
...
V_120 -> V_145 = sizeof( struct V_56 ) ;
memcpy ( V_120 -> V_144 , V_44 -> V_63 , V_120 -> V_145 ) ;
}
F_103 ( V_7 , V_44 ) ;
return V_140 ;
}
...
{
int V_59 ;
F_107 ( L_29 V_179 L_30 ) ;
V_59 = F_108 ( & V_180 ) ;
if ( V_59 < 0 ) {
F_63 ( V_114 L_31 ) ;
return V_59 ;
}
V_171 = F_109 ( L_32 , V_17 . V_181 ) ;
return 0 ;
}
