...
if ( V_102 == - 1 )
V_2 -> V_29 . V_103 = F_34 ( ( 1024ULL << 20 ) , V_2 -> V_29 . V_63 ) ;
else
...
{
struct V_1 * V_2 = (struct V_1 * ) V_232 ;
F_82 ( V_2 , & V_2 -> V_29 . V_233 , 0 ) ;
F_47 ( V_2 ) ;
return 0 ;
}
static int F_83 ( void * V_232 )
{
struct V_1 * V_2 = (struct V_1 * ) V_232 ;
if ( V_2 -> V_165 . V_242 ) {
F_54 ( V_2 ) ;
