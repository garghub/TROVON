...
goto V_32;
F_5 ( V_2 ) -> V_33 |= V_34 | V_35 ;
V_3 = F_21 ( & V_20 -> V_36 , true ) ;
if ( F_1 ( V_2 , V_3 ) ) {
F_22 ( V_9 , V_37 ) ;
F_23 ( V_2 , V_38 , V_39 ,
F_24 ( V_3 ) ) ;
...
if ( F_25 ( V_2 , F_26 ( V_20 -> V_36 . V_27 ) + V_20 -> V_36 . V_40 ) )
goto V_23;
V_18 = F_3 ( V_2 ) ;
F_27 ( V_18 ) ;
if ( F_5 ( V_2 ) -> V_33 & V_41 && ! V_13 -> V_42 &&
! F_28 ( V_2 ) )
F_29 ( V_2 ) ;
V_2 -> V_43 = F_30 ( V_18 -> V_44 ) ;
return F_31 ( V_45 , V_46 ,
V_9 , NULL , V_2 , V_2 -> V_27 , V_20 -> V_36 . V_27 ,
F_8 ) ;
V_32:
F_23 ( V_2 , V_38 , V_47 , 0 ) ;
goto V_23;
V_29:
F_9 ( V_9 , V_48 ) ;
F_23 ( V_2 , V_49 , V_50 , 0 ) ;
V_23:
F_32 ( V_2 ) ;
return V_51 ;
}
