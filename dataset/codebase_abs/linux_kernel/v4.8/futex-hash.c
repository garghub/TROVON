...
V_2 = F_6 ( & V_5 -> V_12 [ V_3 ] , 1234 , NULL , V_13 ) ;
if ( ! V_14 &&
...
if ( ! V_41 )
V_41 = V_32 ;
V_4 = calloc ( V_41 , sizeof( * V_4 ) ) ;
if ( ! V_4 )
goto V_42;
if ( ! V_43 )
V_13 = V_44 ;
printf ( L_5 ,
F_20 () , V_41 , V_10 , V_43 ? L_6 : L_7 , V_45 ) ;
F_21 ( & V_24 ) ;
F_22 ( & V_6 , NULL ) ;
F_23 ( & V_8 , NULL ) ;
F_23 ( & V_9 , NULL ) ;
...
if ( V_2 )
F_28 ( V_36 , L_8 ) ;
V_2 = F_29 ( & V_4 [ V_3 ] . V_47 , & V_33 , F_1 ,
...
F_35 ( & V_6 ) ;
for ( V_3 = 0 ; V_3 < V_41 ; V_3 ++ ) {
unsigned long V_48 = V_4 [ V_3 ] . V_11 / V_22 . V_26 ;
F_36 ( & V_24 , V_48 ) ;
if ( ! V_14 ) {
if ( V_10 == 1 )
printf ( L_11 ,
V_4 [ V_3 ] . V_46 , & V_4 [ V_3 ] . V_12 [ 0 ] , V_48 ) ;
else
printf ( L_12 ,
V_4 [ V_3 ] . V_46 , & V_4 [ V_3 ] . V_12 [ 0 ] ,
& V_4 [ V_3 ] . V_12 [ V_10 - 1 ] , V_48 ) ;
}
free ( V_4 [ V_3 ] . V_12 ) ;
}
F_11 () ;
