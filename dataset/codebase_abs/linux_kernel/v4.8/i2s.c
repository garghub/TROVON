...
static int F_72 ( struct V_188 * V_41 )
{
struct V_1 * V_2 = F_73 ( V_41 ) ;
F_34 ( V_2 -> V_189 ) ;
return 0 ;
}
static int F_74 ( struct V_188 * V_41 )
{
struct V_1 * V_2 = F_73 ( V_41 ) ;
F_40 ( V_2 -> V_189 ) ;
return 0 ;
...
if ( ! F_33 ( V_2 -> V_193 [ V_190 ] ) )
F_76 ( V_2 -> V_193 [ V_190 ] ) ;
}
}
static void F_77 ( struct V_169 * V_40 )
{
struct V_1 * V_2 = F_73 ( & V_40 -> V_41 ) ;
F_78 ( V_40 -> V_41 . V_194 ) ;
F_75 ( V_2 ) ;
}
static int F_79 ( struct V_169 * V_40 )
{
struct V_188 * V_41 = & V_40 -> V_41 ;
struct V_1 * V_2 = F_73 ( V_41 ) ;
...
struct V_189 * V_198 ;
int V_171 , V_190 ;
if ( ! F_80 ( V_41 -> V_194 , L_16 , NULL ) )
return 0 ;
for ( V_190 = 0 ; V_190 < F_81 ( V_196 ) ; V_190 ++ ) {
V_198 = F_37 ( V_41 , V_195 [ V_190 ] ) ;
if ( F_33 ( V_198 ) )
continue;
V_196 [ V_190 ] = F_82 ( V_198 ) ;
F_35 ( V_198 ) ;
}
if ( ! ( V_2 -> V_37 & V_86 ) ) {
T_1 V_63 = F_3 ( V_2 -> V_5 + V_142 ) ;
F_20 ( V_63 | V_141 , V_2 -> V_5 + V_142 ) ;
V_2 -> V_193 [ V_199 ] = F_83 ( NULL ,
L_17 , V_196 , F_81 ( V_196 ) ,
V_200 | V_201 ,
V_2 -> V_5 + V_6 , V_197 -> V_73 ,
1 , 0 , V_2 -> V_76 ) ;
V_2 -> V_193 [ V_202 ] = F_84 ( NULL ,
L_18 , L_17 ,
V_201 ,
...
F_85 ( V_41 -> V_194 ,
L_19 , 0 , & V_195 [ 0 ] ) ;
V_2 -> V_193 [ V_203 ] = F_86 ( NULL , V_195 [ 0 ] ,
V_196 [ 0 ] , V_201 ,
V_2 -> V_5 + V_6 , V_197 -> V_71 ,
V_204 , V_2 -> V_76 ) ;
V_2 -> V_191 . V_192 += 1 ;
V_2 -> V_191 . V_205 = V_2 -> V_193 ;
V_171 = F_87 ( V_41 -> V_194 , V_206 ,
& V_2 -> V_191 ) ;
if ( V_171 < 0 ) {
...
static int F_88 ( struct V_169 * V_40 )
{
...
struct V_216 * V_217 = V_40 -> V_41 . V_194 ;
const struct V_218 * V_219 ;
int V_171 ;
if ( F_89 ( V_220 ) && V_40 -> V_41 . V_194 )
V_219 = F_90 ( & V_40 -> V_41 ) ;
else
V_219 = (struct V_218 * )
F_91 ( V_40 ) -> V_221 ;
...
V_171 = F_92 ( & V_13 -> V_40 -> V_41 ,
& V_225 ,
& V_13 -> V_173 , 1 ) ;
if ( V_171 != 0 )
return V_171 ;
return F_93 ( & V_40 -> V_41 ,
V_13 -> V_226 , L_22 , NULL ) ;
}
V_3 = F_64 ( V_40 , false ) ;
if ( ! V_3 ) {
F_23 ( & V_40 -> V_41 , L_23 ) ;
...
V_3 -> V_122 . V_229 = V_208 -> V_122 ;
V_3 -> V_124 . V_229 = V_208 -> V_124 ;
V_3 -> V_226 = V_208 -> V_230 ;
if ( & V_208 -> type )
V_211 = & V_208 -> type . V_2 ;
if ( V_211 ) {
V_37 = V_211 -> V_37 ;
V_215 = V_211 -> V_215 ;
}
...
V_213 = F_97 ( V_40 , V_231 , 0 ) ;
V_3 -> V_5 = F_98 ( & V_40 -> V_41 , V_213 ) ;
if ( F_33 ( V_3 -> V_5 ) )
return F_39 ( V_3 -> V_5 ) ;
V_214 = V_213 -> V_232 ;
V_3 -> V_189 = F_99 ( & V_40 -> V_41 , L_28 ) ;
if ( F_33 ( V_3 -> V_189 ) ) {
F_23 ( & V_40 -> V_41 , L_29 ) ;
return F_39 ( V_3 -> V_189 ) ;
}
V_171 = F_40 ( V_3 -> V_189 ) ;
if ( V_171 != 0 ) {
F_23 ( & V_40 -> V_41 , L_30 , V_171 ) ;
return V_171 ;
}
V_3 -> V_122 . V_168 = V_214 + V_233 ;
V_3 -> V_124 . V_168 = V_214 + V_234 ;
V_3 -> V_122 . V_235 = L_31 ;
V_3 -> V_124 . V_235 = L_32 ;
V_3 -> V_122 . V_123 = 4 ;
V_3 -> V_124 . V_123 = 4 ;
V_3 -> V_37 = V_37 ;
V_3 -> V_7 = V_219 -> V_236 ;
...
V_13 -> V_76 = & V_3 -> V_228 ;
V_13 -> V_7 = V_3 -> V_7 ;
V_13 -> V_122 . V_168 = V_214 + V_239 ;
V_13 -> V_122 . V_235 = L_22 ;
if ( ! V_217 ) {
V_13 -> V_122 . V_229 = V_208 -> V_240 ;
V_13 -> V_226 = V_208 -> V_230 ;
}
V_13 -> V_122 . V_123 = 4 ;
V_13 -> V_5 = V_3 -> V_5 ;
V_13 -> V_189 = V_3 -> V_189 ;
V_13 -> V_37 = V_37 ;
V_13 -> V_167 . V_168 = V_215 ;
V_13 -> V_3 = V_3 ;
V_3 -> V_13 = V_13 ;
}
if ( V_208 && V_208 -> V_241 && V_208 -> V_241 ( V_40 ) ) {
F_23 ( & V_40 -> V_41 , L_34 ) ;
return - V_89 ;
}
V_171 = F_92 ( & V_3 -> V_40 -> V_41 ,
& V_225 ,
& V_3 -> V_173 , 1 ) ;
if ( V_171 < 0 )
goto V_242;
V_171 = F_93 ( & V_40 -> V_41 , V_3 -> V_226 ,
NULL , NULL ) ;
if ( V_171 < 0 )
goto V_242;
F_100 ( & V_40 -> V_41 ) ;
...
static int F_102 ( struct V_169 * V_40 )
{
struct V_1 * V_2 , * V_14 ;
V_2 = F_73 ( & V_40 -> V_41 ) ;
V_14 = F_5 ( V_2 ) ;
