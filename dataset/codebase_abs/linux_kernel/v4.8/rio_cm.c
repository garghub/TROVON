...
if ( V_17 . V_181 > V_25 )
return - V_37 ;
V_61 = F_15 ( V_17 . V_181 , V_26 ) ;
if ( ! V_61 )
return - V_38 ;
if ( F_96 ( V_61 , ( void T_4 * ) ( V_170 ) V_17 . V_17 , V_17 . V_181 ) ) {
V_5 = - V_164 ;
goto V_56;
}
...
static int F_109 ( void T_4 * V_162 )
{
struct V_180 V_17 ;
struct V_1 * V_2 ;
void * V_61 ;
...
static long
F_110 ( struct V_156 * V_157 , unsigned int V_185 , unsigned long V_162 )
{
switch ( V_185 ) {
case V_186 :
...
static int F_111 ( struct V_197 * V_198 , struct V_199 * V_200 )
{
struct V_121 * V_122 ;
struct V_93 * V_91 = F_112 ( V_198 ) ;
struct V_15 * V_16 ;
if ( ! F_113 ( V_91 ) )
return 0 ;
...
static void F_116 ( struct V_197 * V_198 , struct V_199 * V_200 )
{
struct V_93 * V_91 = F_112 ( V_198 ) ;
struct V_15 * V_16 ;
struct V_121 * V_122 ;
...
static int F_118 ( T_6 V_206 )
{
int V_5 ;
F_119 ( & V_207 . V_208 , & V_209 ) ;
V_207 . V_208 . V_210 = V_211 ;
V_5 = F_120 ( & V_207 . V_208 , V_206 , 1 ) ;
if ( V_5 < 0 ) {
F_32 ( L_43 , V_5 ) ;
return V_5 ;
}
V_207 . V_198 = F_121 ( V_212 , NULL , V_206 , NULL , V_213 ) ;
if ( F_68 ( V_207 . V_198 ) ) {
F_122 ( & V_207 . V_208 ) ;
return F_69 ( V_207 . V_198 ) ;
}
F_21 ( V_214 , L_44 ,
V_213 , F_123 ( V_206 ) , F_124 ( V_206 ) ) ;
return 0 ;
}
...
int V_18 ;
struct V_15 * V_16 ;
struct V_73 * V_19 = F_126 ( V_198 ) ;
F_21 ( V_214 , L_45 , V_19 -> V_217 ) ;
V_16 = F_22 ( sizeof( * V_16 ) , V_26 ) ;
if ( ! V_16 )
return - V_38 ;
V_16 -> V_19 = V_19 ;
V_88 = F_127 ( V_19 , V_16 , V_20 ,
V_83 , F_49 ) ;
if ( V_88 ) {
F_32 ( L_46 ,
V_20 , V_19 -> V_217 ) ;
...
F_130 ( & V_16 -> V_70 ) ;
F_14 ( V_16 , V_21 ) ;
V_16 -> V_77 = F_131 ( V_218 L_48 ) ;
F_132 ( & V_16 -> V_69 , F_36 ) ;
V_16 -> V_89 = 0 ;
V_16 -> V_80 = 0 ;
V_16 -> V_82 = 0 ;
F_74 ( & V_16 -> V_81 ) ;
...
static int F_137 ( struct V_220 * V_221 , unsigned long V_222 ,
void * V_223 )
{
struct V_1 * V_2 ;
unsigned int V_18 ;
...
{
int V_5 ;
V_212 = F_139 ( V_211 , V_218 ) ;
if ( F_68 ( V_212 ) ) {
F_32 ( L_55 V_218 L_56 ) ;
return F_69 ( V_212 ) ;
}
V_5 = F_140 ( & V_225 , 0 , 1 , V_218 ) ;
if ( V_5 ) {
F_141 ( V_212 ) ;
return V_5 ;
}
