...
if ( V_178 [ V_9 -> V_50 ] . V_321 && V_6 -> V_308 == 2 )
V_19 = V_322 ;
V_320:
if ( V_53 && V_53 -> V_254 )
F_123 ( V_53 -> V_254 ) ;
...
V_325 -> V_327 = V_53 -> V_327 ;
V_325 -> V_327 += V_6 -> V_132 * V_274 ;
V_325 -> V_328 = V_53 -> V_283 ;
V_94:
F_18 ( & V_9 -> V_20 ) ;
return V_19 ;
}
static int F_151 ( struct V_252 * V_53 , int V_329 )
{
struct V_293 * V_6 = V_53 -> V_6 ;
T_6 * V_330 = ( T_6 * ) V_53 -> V_260 ;
T_6 * V_331 = ( T_6 * ) V_53 -> V_260 ;
unsigned int V_332 ;
int V_158 , V_333 , V_334 ;
int V_27 , V_267 , V_19 ;
...
V_332 = V_6 -> V_175 [ V_27 ] . V_304 +
( V_6 -> V_307 - V_6 -> V_175 [ V_27 ] . V_58 ) ;
V_334 = F_127 ( V_53 ) ;
V_333 = V_6 -> V_175 [ V_27 ] . V_306 - V_6 -> V_307 ;
if ( V_333 > V_329 )
V_333 = V_329 ;
if ( V_333 > V_6 -> V_132 )
V_333 = V_6 -> V_132 ;
...
if ( ! V_333 )
return 0 ;
V_19 = F_130 ( V_6 -> V_9 , V_158 , V_332 ,
V_333 , V_53 -> V_260 ) ;
if ( V_19 < 0 )
return V_19 ;
for ( V_27 = 0 ; V_27 < V_333 ; V_27 ++ ) {
for ( V_267 = 0 ; V_267 < V_274 ; V_267 ++ )
* V_331 ++ = * V_330 ++ ;
V_330 += sizeof( * ( V_53 -> V_260 ) ) - V_274 ;
}
V_6 -> V_307 += V_333 ;
...
static int F_152 ( struct V_252 * V_53 ,
...
F_40 ( V_9 , L_118 , V_16 ) ;
if ( ! V_53 -> V_6 || V_53 -> V_6 -> error ) {
F_150 ( V_53 -> V_254 , V_326 ) ;
return - V_245 ;
}
V_16 /= V_274 ;
do {
V_333 = F_151 ( V_53 , V_16 ) ;
if ( V_333 < 0 ) {
F_21 ( V_9 , L_119 , V_333 ) ;
return V_333 ;
}
V_336 = V_333 * V_274 ;
F_40 ( V_9 , L_120 , V_336 ) ;
if ( F_54 ( V_6 + V_335 , V_53 -> V_260 , V_336 ) ) {
F_21 ( V_9 , L_121 ,
V_335 , V_336 ) ;
return - V_89 ;
}
V_16 -= V_333 ;
V_335 += V_336 ;
} while ( V_333 > 0 && V_16 > 0 );
V_53 -> V_327 += V_335 ;
return V_335 ;
}
int F_153 ( struct V_255 * V_254 , char T_3 * V_6 ,
T_1 V_16 )
{
struct V_252 * V_53 = V_254 -> V_259 -> V_18 ;
struct V_8 * V_9 = V_53 -> V_9 ;
int V_19 ;
F_16 ( & V_9 -> V_20 ) ;
if ( V_254 -> V_258 == V_337 )
V_19 = F_152 ( V_53 , V_6 , V_16 ) ;
else
V_19 = - V_338 ;
F_18 ( & V_9 -> V_20 ) ;
return V_19 ;
