...
static int F_36 ( struct V_87 * V_87 , struct V_88 * V_88 )
{
return F_37 ( V_88 , F_33 , NULL ) ;
}
...
static void T_2 F_40 ( struct V_11 * V_12 )
{
struct V_28 * V_29 ;
