...
static void F_44 ( struct V_14 * V_15 , int V_74 ,
...
F_45 (hn, tmp, addr_list, hi) {
if ( F_46 ( V_17 -> V_72 , V_5 -> V_8 . V_1 ) )
continue;
if ( V_24 >= V_77 )
break;
...
F_44 ( V_15 , V_74 , V_75 , V_77 ) ;
}
V_23 = F_48 ( V_15 -> V_25 , V_74 , V_75 , V_77 ) ;
V_89:
if ( V_23 )
F_17 ( V_15 -> V_18 ,
L_8 ,
...
struct V_81 * V_82 ;
int V_24 ;
F_45 (hn, tmp, priv->fs.l2.netdev_uc, i)
F_36 ( V_15 , V_5 ) ;
F_45 (hn, tmp, priv->fs.l2.netdev_mc, i)
F_36 ( V_15 , V_5 ) ;
}
...
F_45 (hn, tmp, priv->fs.l2.netdev_mc, i)
V_5 -> V_9 = V_68 ;
if ( ! F_53 ( V_95 , & V_15 -> V_96 ) )
F_39 ( V_15 ) ;
F_51 ( V_15 ) ;
}
void F_54 ( struct V_97 * V_98 )
{
struct V_14 * V_15 = F_55 ( V_98 , struct V_14 ,
V_99 ) ;
struct V_90 * V_91 = & V_15 -> V_36 . V_43 ;
struct V_16 * V_17 = V_15 -> V_18 ;
bool V_100 = ! F_53 ( V_95 , & V_15 -> V_96 ) ;
...
if ( V_102 ) {
F_37 ( V_15 , & V_91 -> V_108 , V_109 ) ;
if ( ! V_15 -> V_36 . V_22 . V_61 )
F_24 ( V_15 , V_52 ,
0 ) ;
}
if ( V_104 )
F_37 ( V_15 , & V_91 -> V_110 , V_111 ) ;
if ( V_106 )
F_37 ( V_15 , & V_91 -> V_85 , V_67 ) ;
F_52 ( V_15 ) ;
if ( V_107 )
F_38 ( V_15 , & V_91 -> V_85 ) ;
if ( V_105 )
F_38 ( V_15 , & V_91 -> V_110 ) ;
if ( V_103 ) {
if ( ! V_15 -> V_36 . V_22 . V_61 )
F_27 ( V_15 , V_52 ,
0 ) ;
F_38 ( V_15 , & V_91 -> V_108 ) ;
}
V_91 -> V_94 = V_94 ;
V_91 -> V_93 = V_93 ;
V_91 -> V_84 = V_84 ;
...
static void F_56 ( struct V_112 * V_35 )
{
int V_24 ;
for ( V_24 = V_35 -> V_113 - 1 ; V_24 >= 0 ; V_24 -- ) {
if ( ! F_57 ( V_35 -> V_114 [ V_24 ] ) )
F_58 ( V_35 -> V_114 [ V_24 ] ) ;
...
if ( ! F_57 ( V_116 -> V_118 [ V_24 ] ) ) {
F_28 ( V_116 -> V_118 [ V_24 ] ) ;
V_116 -> V_118 [ V_24 ] = NULL ;
}
}
}
static struct V_40 * F_63 ( struct V_14 * V_15 ,
struct V_34 * V_35 ,
struct V_38 * V_39 ,
T_2 V_119 ,
T_1 V_65 )
...
V_118 [ V_123 ] = F_63 ( V_15 , V_35 , & V_39 ,
V_130 [ V_123 ] . V_119 ,
V_130 [ V_123 ] . V_65 ) ;
if ( F_22 ( V_118 [ V_123 ] ) )
goto V_131;
...
V_135 = F_68 ( V_133 , V_134 , V_47 ) ;
F_19 ( V_46 , V_135 , V_48 . V_121 ) ;
F_19 ( V_46 , V_135 , V_48 . V_122 ) ;
F_69 ( V_134 , V_44 , V_45 ) ;
F_69 ( V_134 , V_137 , V_6 ) ;
V_6 += V_138 ;
F_69 ( V_134 , V_139 , V_6 - 1 ) ;
V_35 -> V_114 [ V_35 -> V_113 ] = F_70 ( V_35 -> V_37 , V_134 ) ;
...
V_147 = F_68 ( V_46 , V_33 -> V_47 ,
V_48 . V_149 ) ;
V_148 = F_68 ( V_46 , V_33 -> V_54 ,
V_48 . V_149 ) ;
V_39 . type = V_42 ;
...
static int F_75 ( struct V_90 * V_150 )
{
int V_132 = F_67 ( V_133 ) ;
...
static int F_79 ( struct V_112 * V_35 , T_5 * V_134 ,
int V_132 )
{
int V_23 ;
int V_6 = 0 ;
T_1 * V_135 = F_68 ( V_133 , V_134 , V_47 ) ;
memset ( V_134 , 0 , V_132 ) ;
F_69 ( V_134 , V_44 , V_45 ) ;
...
static int F_80 ( struct V_112 * V_35 )
{
T_5 * V_134 ;
int V_132 = F_67 ( V_133 ) ;
int V_23 ;
