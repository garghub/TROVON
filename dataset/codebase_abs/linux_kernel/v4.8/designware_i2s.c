...
V_5 -> V_40 . V_120 . V_121 = L_12 ;
V_5 -> V_40 . V_120 . V_122 = V_91 *
( V_123 [ V_118 ] ) >> 8 ;
V_5 -> V_40 . V_120 . V_124 = 16 ;
}
if ( F_53 ( V_87 ) ) {
V_118 = F_54 ( V_89 ) ;
V_5 -> V_36 |= V_37 ;
...
V_5 -> V_41 . V_120 . V_121 = L_13 ;
V_5 -> V_41 . V_120 . V_122 = V_91 *
( V_123 [ V_118 ] >> 8 ) ;
V_5 -> V_41 . V_120 . V_124 = 16 ;
}
return 0 ;
}
static int F_60 ( struct V_125 * V_126 )
{
const struct V_103 * V_104 = V_126 -> V_5 . V_127 ;
struct V_4 * V_5 ;
struct V_101 * V_102 ;
int V_48 , V_11 ;
struct V_84 * V_85 ;
const char * V_128 ;
V_5 = F_61 ( & V_126 -> V_5 , sizeof( * V_5 ) , V_129 ) ;
if ( ! V_5 ) {
F_62 ( & V_126 -> V_5 , L_14 ) ;
return - V_130 ;
}
V_85 = F_61 ( & V_126 -> V_5 , sizeof( * V_85 ) , V_129 ) ;
if ( ! V_85 )
return - V_130 ;
V_85 -> V_131 = & V_132 ;
V_85 -> V_133 = F_43 ;
V_85 -> V_134 = F_44 ;
V_102 = F_63 ( V_126 , V_135 , 0 ) ;
V_5 -> V_9 = F_64 ( & V_126 -> V_5 , V_102 ) ;
if ( F_65 ( V_5 -> V_9 ) )
return F_66 ( V_5 -> V_9 ) ;
V_5 -> V_5 = & V_126 -> V_5 ;
V_11 = F_67 ( V_126 , 0 ) ;
if ( V_11 >= 0 ) {
V_48 = F_68 ( & V_126 -> V_5 , V_11 , F_14 , 0 ,
V_126 -> V_136 , V_5 ) ;
if ( V_48 < 0 ) {
F_17 ( & V_126 -> V_5 , L_15 ) ;
return V_48 ;
