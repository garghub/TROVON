...
static T_1 F_16 ( struct V_10 * V_10 , char T_2 * V_22 ,
T_3 V_23 , T_4 * V_24 )
{
...
static T_1 F_21 ( struct V_10 * V_10 , const char T_2 * V_22 ,
T_3 V_23 , T_4 * V_24 )
{
struct V_2 * V_3 = V_10 -> V_21 ;
T_3 V_29 = V_23 ;
...
F_6 ( & V_3 -> V_7 , V_30 ) ;
F_7 ( & V_3 -> V_6 ) ;
F_26 ( & V_3 -> V_20 , V_34 + ( 60 * V_35 ) ) ;
return V_29 ;
}
static int F_27 ( struct V_9 * V_9 , struct V_10 * V_10 )
{
struct V_2 * V_3 = V_10 -> V_21 ;
F_17 ( & V_3 -> V_20 ) ;
F_18 ( & V_3 -> V_4 ) ;
