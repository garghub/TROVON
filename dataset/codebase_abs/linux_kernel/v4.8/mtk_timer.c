...
static void
T_6 F_18 ( struct V_2 * V_6 , T_3 V_7 , T_3 V_25 )
{
F_8 ( V_16 | V_26 ,
V_6 -> V_9 + F_7 ( V_7 ) ) ;
F_8 ( F_19 ( V_27 ) | V_28 ,
...
static int T_6 F_23 ( struct V_30 * V_31 )
{
struct V_2 * V_6 ;
struct V_32 V_33 ;
...
V_53 | V_54 , L_7 , V_6 ) ) {
F_27 ( L_8 , V_6 -> V_5 . V_21 ) ;
goto V_55;
}
V_6 -> V_19 = F_33 ( V_34 , V_56 ) ;
F_18 ( V_6 , V_57 , V_58 ) ;
F_34 ( V_6 -> V_9 + F_35 ( V_57 ) ,
V_31 -> V_37 , V_34 , 300 , 32 , V_59 ) ;
V_1 = V_6 -> V_9 + F_35 ( V_57 ) ;
F_36 ( F_1 , 32 , V_34 ) ;
F_18 ( V_6 , V_18 , V_14 ) ;
