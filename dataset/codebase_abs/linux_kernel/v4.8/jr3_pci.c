...
F_36 ( V_30 -> V_58 ,
L_5 ,
( unsigned int ) sizeof( struct V_5 ) , 0xc00 ) ;
return - V_51 ;
}
if ( V_81 < F_26 ( V_113 ) )
V_112 = & V_113 [ V_81 ] ;
...
if ( V_82 )
return V_82 ;
V_72 -> V_74 = F_39 ( V_110 , 0 ) ;
if ( ! V_72 -> V_74 )
return - V_118 ;
V_82 = F_40 ( V_30 , V_112 -> V_119 ) ;
if ( V_82 )
return V_82 ;
V_30 -> V_120 = F_18 ;
for ( V_11 = 0 ; V_11 < V_30 -> V_59 ; V_11 ++ ) {
...
F_41 ( 0 , & V_72 -> V_74 -> V_6 [ 0 ] . V_127 ) ;
V_82 = F_42 ( V_30 , & F_35 ( V_30 ) -> V_30 ,
L_6 ,
F_24 , 0 ) ;
...
F_44 ( & V_72 -> V_101 , F_27 , ( unsigned long ) V_30 ) ;
...
{
return F_50 ( V_30 , & V_131 , V_130 -> V_132 ) ;
}
