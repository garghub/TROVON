...
return F_20 ( - V_56 ) ;
F_22 (dev, child) {
struct V_5 * V_6 = & V_50 -> V_57 [ V_50 -> V_43 ] ;
struct V_17 V_58 = {} ;
const char * V_23 = NULL ;
V_58 . V_12 = F_23 ( V_47 , NULL , V_49 ) ;
if ( F_24 ( V_58 . V_12 ) ) {
F_25 ( V_49 ) ;
V_22 = F_26 ( V_58 . V_12 ) ;
goto V_59;
...
V_53 = F_27 ( V_49 ) ;
if ( F_28 ( V_49 , L_2 ) ) {
F_29 ( V_49 , L_2 , & V_58 . V_27 ) ;
} else {
if ( F_30 ( V_60 ) && ! V_58 . V_27 && V_53 )
V_58 . V_27 = V_53 -> V_27 ;
if ( ! V_58 . V_27 ) {
V_22 = - V_30 ;
goto V_59;
...
if ( F_28 ( V_49 , L_8 ) )
V_58 . V_41 = 1 ;
V_22 = F_7 ( & V_58 , V_6 , V_47 , NULL ) ;
if ( V_22 < 0 ) {
F_25 ( V_49 ) ;
goto V_59;
}
V_6 -> V_7 . V_47 -> V_62 = V_53 ;
V_50 -> V_43 ++ ;
}
return V_50 ;
V_59:
for ( V_51 = V_50 -> V_43 - 1 ; V_51 >= 0 ; V_51 -- )
F_31 ( & V_50 -> V_57 [ V_51 ] . V_7 ) ;
return F_20 ( V_22 ) ;
}
static int F_32 ( struct V_45 * V_46 )
{
struct V_63 * V_64 = F_33 ( & V_46 -> V_47 ) ;
struct V_44 * V_50 ;
int V_65 , V_22 = 0 ;
if ( V_64 && V_64 -> V_43 ) {
V_50 = F_21 ( & V_46 -> V_47 ,
...
int V_65 ;
for ( V_65 = 0 ; V_65 < V_50 -> V_43 ; V_65 ++ ) {
struct V_5 * V_58 = & V_50 -> V_57 [ V_65 ] ;
F_1 ( & V_58 -> V_7 , V_9 ) ;
}
}
