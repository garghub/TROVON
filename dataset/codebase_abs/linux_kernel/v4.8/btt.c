...
static T_10 F_87 ( struct V_170 * V_171 , struct V_172 * V_172 )
{
struct V_145 * V_146 = F_88 ( V_172 ) ;
struct V_60 * V_60 = V_171 -> V_173 ;
struct V_174 V_175 ;
unsigned long V_97 ;
struct V_150 V_176 ;
int V_177 = 0 ;
bool V_178 ;
if ( F_89 ( V_172 ) && F_90 ( V_172 ) ) {
V_172 -> V_179 = - V_29 ;
goto V_114;
}
V_178 = F_91 ( V_172 , & V_97 ) ;
F_92 (bvec, bio, iter) {
unsigned int V_142 = V_176 . V_154 ;
F_93 ( V_142 > V_180 ) ;
F_93 ( V_142 < V_60 -> V_136 ) ;
F_93 ( V_142 % V_60 -> V_136 ) ;
V_177 = F_85 ( V_60 , V_146 , V_176 . V_155 , V_142 , V_176 . V_156 ,
F_94 ( F_95 ( V_172 ) ) , V_175 . V_181 ) ;
if ( V_177 ) {
F_28 ( & V_60 -> V_6 -> V_62 ,
L_22 ,
( F_94 ( F_95 ( V_172 ) ) ) ? L_23 :
L_24 ,
( unsigned long long ) V_175 . V_181 , V_142 ) ;
V_172 -> V_179 = V_177 ;
break;
}
}
...
static int F_98 ( struct V_183 * V_184 , T_7 V_137 ,
struct V_140 * V_140 , bool V_169 )
{
struct V_60 * V_60 = V_184 -> V_185 -> V_186 ;
F_85 ( V_60 , NULL , V_140 , V_180 , 0 , V_169 , V_137 ) ;
F_99 ( V_140 , V_169 , 0 ) ;
return 0 ;
}
static int F_100 ( struct V_183 * V_187 , struct V_188 * V_189 )
{
V_189 -> V_190 = 1 << 6 ;
V_189 -> V_191 = 1 << 5 ;
V_189 -> V_192 = F_101 ( V_187 -> V_185 ) >> 11 ;
return 0 ;
}
static int F_102 ( struct V_60 * V_60 )
{
struct V_6 * V_6 = V_60 -> V_6 ;
struct V_7 * V_8 = V_6 -> V_8 ;
V_60 -> V_193 = F_103 ( V_81 ) ;
if ( ! V_60 -> V_193 )
return - V_82 ;
V_60 -> V_194 = F_104 ( 0 ) ;
if ( ! V_60 -> V_194 ) {
...
F_106 ( V_8 , V_60 -> V_194 -> V_195 ) ;
V_60 -> V_194 -> V_196 = 0 ;
V_60 -> V_194 -> V_197 = & V_198 ;
V_60 -> V_194 -> V_186 = V_60 ;
V_60 -> V_194 -> V_199 = V_60 -> V_193 ;
V_60 -> V_194 -> V_59 = V_200 ;
F_107 ( V_60 -> V_193 , F_87 ) ;
F_108 ( V_60 -> V_193 , V_60 -> V_136 ) ;
F_109 ( V_60 -> V_193 , V_201 ) ;
F_110 ( V_60 -> V_193 , V_202 ) ;
F_111 ( V_203 , V_60 -> V_193 ) ;
V_60 -> V_193 -> V_173 = V_60 ;
F_112 ( V_60 -> V_194 , 0 ) ;
F_113 ( & V_60 -> V_6 -> V_62 , V_60 -> V_194 ) ;
if ( F_66 ( V_60 ) ) {
int V_204 = F_114 ( V_60 -> V_194 , F_66 ( V_60 ) ) ;
if ( V_204 ) {
F_115 ( V_60 -> V_194 ) ;
F_116 ( V_60 -> V_194 ) ;
F_105 ( V_60 -> V_193 ) ;
...
F_112 ( V_60 -> V_194 , V_60 -> V_119 * V_60 -> V_136 >> 9 ) ;
V_60 -> V_6 -> V_49 = V_60 -> V_119 * ( T_5 ) V_60 -> V_136 ;
F_117 ( V_60 -> V_194 ) ;
return 0 ;
}
static void F_118 ( struct V_60 * V_60 )
{
F_115 ( V_60 -> V_194 ) ;
F_116 ( V_60 -> V_194 ) ;
F_105 ( V_60 -> V_193 ) ;
...
V_60 = F_120 ( V_62 , sizeof( struct V_60 ) , V_81 ) ;
if ( ! V_60 )
return NULL ;
V_60 -> V_6 = V_6 ;
V_60 -> V_109 = V_109 ;
...
V_12 = F_63 ( V_60 ) ;
if ( V_12 ) {
F_123 ( V_62 , L_29 , V_12 ) ;
return NULL ;
}
}
V_12 = F_102 ( V_60 ) ;
if ( V_12 ) {
F_123 ( V_62 , L_30 , V_12 ) ;
return NULL ;
}
F_22 ( V_60 ) ;
return V_60 ;
...
{
struct V_6 * V_6 = F_127 ( V_8 -> V_206 ) ;
struct V_158 * V_158 ;
struct V_60 * V_60 ;
T_2 V_109 ;
