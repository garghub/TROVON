...
if ( F_33 ( V_6 -> V_16 ) )
return F_34 ( V_6 -> V_16 ) ;
return 0 ;
}
static int F_38 ( struct V_60 * V_7 )
{
struct V_5 * V_6 = & V_7 -> V_8 ;
struct V_61 V_62 = F_29 ( 0 , 0 , 31 ) ;
V_62 . V_63 = F_30 ( V_7 -> V_64 -> V_65 ) ;
...
static int F_40 ( struct V_60 * V_7 , struct V_33 * V_34 ,
int V_73 )
{
...
T_1 V_17 ;
V_38 = F_43 ( V_34 , L_26 , V_77 * V_73 ,
& V_17 ) ;
if ( V_38 )
return V_38 ;
if ( V_17 > V_83 ||
! ( V_7 -> V_64 -> V_65 & F_44 ( V_17 ) ) ) {
F_7 ( V_40 , L_27 ,
V_34 -> V_41 ) ;
return - V_37 ;
}
...
F_46 ( & V_2 -> V_87 , & V_7 -> V_88 ) ;
return 0 ;
}
static int F_47 ( struct V_60 * V_7 , struct V_33 * V_34 )
{
struct V_75 * V_40 = V_7 -> V_40 ;
struct V_89 * V_90 ;
V_90 = F_42 ( V_40 , sizeof( * V_90 ) , V_80 ) ;
if ( ! V_90 )
return - V_81 ;
V_90 -> V_91 = F_48 ( V_40 , L_28 , V_80 ) ;
if ( ! V_90 -> V_91 )
return - V_81 ;
V_90 -> V_92 = F_48 ( V_40 , L_24 , V_80 ) ;
if ( ! V_90 -> V_91 )
return - V_81 ;
V_90 -> V_93 = sizeof( L_24 ) ;
return F_49 ( V_34 , V_90 ) ;
}
...
struct V_10 * V_10 ;
T_1 V_15 ;
V_99 = F_51 ( V_100 , V_40 ) ;
if ( ! V_99 || ! V_99 -> V_101 )
return - V_37 ;
V_7 = F_42 ( V_40 , sizeof( * V_7 ) , V_80 ) ;
if ( ! V_7 )
return - V_81 ;
F_52 ( & V_7 -> V_88 ) ;
V_7 -> V_64 = V_99 -> V_101 ;
...
V_73 += V_15 ;
F_56 (np, child) {
if ( ! F_57 ( V_96 , L_26 , NULL ) )
continue;
V_38 = F_40 ( V_7 , V_96 , V_73 ) ;
if ( V_38 ) {
F_7 ( V_40 , L_34 ,
V_96 -> V_41 ) ;
V_38 = F_47 ( V_7 , V_96 ) ;
...
return F_58 ( V_34 , NULL , NULL , V_40 ) ;
}
