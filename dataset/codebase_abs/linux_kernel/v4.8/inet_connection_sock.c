...
V_80 -> V_135 = 0 ;
V_80 -> V_10 = NULL ;
F_97 ( & V_80 -> V_143 , F_87 ,
( unsigned long ) V_80 ) ;
F_95 ( & V_80 -> V_143 , V_97 + V_157 ) ;
F_98 ( F_76 ( V_80 ) , NULL ) ;
F_99 () ;
F_100 ( & V_80 -> V_158 , 2 + 1 ) ;
}
void F_101 ( struct V_9 * V_10 , struct V_79 * V_80 ,
unsigned long V_157 )
{
F_96 ( V_80 , V_157 ) ;
F_102 ( V_10 ) ;
...
const T_5 V_159 )
{
struct V_9 * V_81 = F_104 ( V_10 , V_159 ) ;
if ( V_81 ) {
...
F_114 ( V_10 ) ;
F_115 () ;
F_116 ( V_10 -> V_29 -> V_177 ) ;
F_117 () ;
F_118 ( V_10 ) ;
}
void F_119 ( struct V_9 * V_10 )
__releases( &sk->sk_lock.slock
int F_120 ( struct V_9 * V_10 , int V_178 )
{
struct V_67 * V_68 = F_21 ( V_10 ) ;
...
static void F_125 ( struct V_9 * V_10 , struct V_79 * V_80 ,
struct V_9 * V_184 )
{
V_10 -> V_29 -> V_185 ( V_184 , V_83 ) ;
F_126 ( V_184 ) ;
F_127 ( V_10 -> V_29 -> V_177 ) ;
if ( V_10 -> V_84 == V_85 && F_43 ( V_80 ) -> V_86 ) {
F_128 ( F_129 ( V_184 ) -> V_186 != V_80 ) ;
F_128 ( V_10 != V_80 -> V_146 ) ;
F_129 ( V_184 ) -> V_186 = NULL ;
}
F_109 ( V_184 ) ;
F_44 ( V_80 ) ;
}
...
struct V_9 * F_132 ( struct V_9 * V_10 , struct V_9 * V_184 ,
struct V_79 * V_80 , bool V_191 )
{
if ( V_191 ) {
F_84 ( V_10 , V_80 ) ;
F_85 ( & F_21 ( V_10 ) -> V_72 , V_80 ) ;
if ( F_130 ( V_10 , V_80 , V_184 ) )
return V_184 ;
}
F_133 ( V_184 ) ;
F_118 ( V_184 ) ;
...
void F_139 ( struct V_9 * V_10 , struct V_194 * V_195 )
{
...
int F_141 ( struct V_9 * V_10 , int V_203 , int V_204 ,
...
static struct V_98 * F_142 ( struct V_9 * V_10 , struct V_211 * V_126 )
{
const struct V_123 * V_179 = F_69 ( V_10 ) ;
...
V_107 = F_143 ( F_11 ( V_10 ) , V_100 , V_10 , V_212 ,
...
V_107 = NULL ;
if ( V_107 )
F_144 ( V_10 , & V_107 -> V_121 ) ;
F_72 () ;
return & V_107 -> V_121 ;
}
struct V_98 * F_145 ( struct V_9 * V_10 , T_2 V_214 )
{
struct V_98 * V_121 = F_146 ( V_10 , 0 ) ;
struct V_123 * V_179 = F_69 ( V_10 ) ;
if ( ! V_121 ) {
V_121 = F_142 ( V_10 , & V_179 -> V_125 . V_126 ) ;
if ( ! V_121 )
goto V_88;
}
