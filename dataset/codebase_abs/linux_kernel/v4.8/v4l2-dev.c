...
V_7 -> V_32 . V_314 . V_23 . V_315 = V_316 ;
V_7 -> V_32 . V_314 . V_23 . V_27 = V_7 -> V_27 ;
...
int F_71 ( struct V_6 * V_7 , int type , int V_324 ,
int V_325 , struct V_326 * V_327 )
{
int V_87 = 0 ;
int V_54 ;
int V_328 = 0 ;
...
#endif
F_24 ( & V_26 ) ;
V_324 = F_12 ( V_7 , V_324 == - 1 ? 0 : V_324 , V_329 ) ;
if ( V_324 == V_329 )
V_324 = F_12 ( V_7 , 0 , V_329 ) ;
if ( V_324 == V_329 ) {
F_47 ( V_333 L_17 ) ;
F_26 ( & V_26 ) ;
return - V_335 ;
...
V_7 -> V_28 -> V_91 = & V_337 ;
V_7 -> V_28 -> V_327 = V_327 ;
V_54 = F_76 ( V_7 -> V_28 , F_77 ( V_316 , V_7 -> V_27 ) , 1 ) ;
if ( V_54 < 0 ) {
F_47 ( V_333 L_19 , V_318 ) ;
F_17 ( V_7 -> V_28 ) ;
V_7 -> V_28 = NULL ;
goto V_336;
}
V_7 -> V_23 . V_338 = & V_339 ;
V_7 -> V_23 . V_340 = F_77 ( V_316 , V_7 -> V_27 ) ;
V_7 -> V_23 . V_341 = V_7 -> V_334 ;
F_78 ( & V_7 -> V_23 , L_20 , V_330 , V_7 -> V_19 ) ;
V_54 = F_79 ( & V_7 -> V_23 ) ;
if ( V_54 < 0 ) {
F_47 ( V_333 L_21 , V_318 ) ;
goto V_336;
}
V_7 -> V_23 . V_35 = F_23 ;
if ( V_324 != - 1 && V_324 != V_7 -> V_19 && V_325 )
F_47 ( V_317 L_22 , V_318 ,
V_330 , V_324 , F_48 ( V_7 ) ) ;
F_80 ( V_7 -> V_25 ) ;
V_54 = F_67 ( V_7 , type ) ;
F_9 ( V_342 , & V_7 -> V_77 ) ;
return 0 ;
...
{
T_8 V_23 = F_77 ( V_316 , 0 ) ;
int V_54 ;
F_47 ( V_343 L_23 ) ;
V_54 = F_84 ( V_23 , V_86 , V_344 ) ;
if ( V_54 < 0 ) {
F_47 ( V_317 L_24 ,
V_316 ) ;
return V_54 ;
