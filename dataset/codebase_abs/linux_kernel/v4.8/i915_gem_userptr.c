...
int
F_103 ( struct V_3 * V_4 , void * V_105 , struct V_106 * V_107 )
{
struct V_108 * args = V_105 ;
struct V_1 * V_2 ;
int V_45 ;
T_1 V_109 ;
if ( ! F_104 ( V_4 ) && ! F_105 ( V_4 ) ) {
return - V_65 ;
}
if ( args -> V_57 & ~ ( V_110 |
V_58 ) )
return - V_61 ;
if ( F_106 ( args -> V_111 | args -> V_112 ) )
return - V_61 ;
if ( ! F_107 ( args -> V_57 & V_110 ? V_113 : V_114 ,
( char V_115 * ) ( unsigned long ) args -> V_111 , args -> V_112 ) )
return - V_91 ;
if ( args -> V_57 & V_110 ) {
return - V_65 ;
}
...
if ( V_2 == NULL )
return - V_47 ;
F_109 ( V_4 , & V_2 -> V_5 , args -> V_112 ) ;
F_110 ( V_2 , & V_116 ) ;
V_2 -> V_117 = V_118 ;
V_2 -> V_5 . V_119 = V_120 ;
V_2 -> V_5 . V_121 = V_120 ;
V_2 -> V_19 . V_62 = args -> V_111 ;
V_2 -> V_19 . V_94 = ! ! ( args -> V_57 & V_110 ) ;
V_45 = F_54 ( V_2 ) ;
if ( V_45 == 0 )
V_45 = F_45 ( V_2 , args -> V_57 ) ;
if ( V_45 == 0 )
V_45 = F_111 ( V_107 , & V_2 -> V_5 , & V_109 ) ;
F_112 ( & V_2 -> V_5 ) ;
if ( V_45 )
return V_45 ;
args -> V_109 = V_109 ;
