...
return 0 ;
F_34 ( & V_14 -> V_53 ) ;
V_16 = F_6 ( V_7 , V_9 , & V_8 , V_14 -> V_54 ,
V_14 -> V_55 ) ;
F_35 ( & V_14 -> V_53 ) ;
return V_16 ;
}
...
if ( V_8 > V_14 -> V_55 )
return - V_57 ;
if ( V_8 + V_9 > V_14 -> V_55 )
V_9 = V_14 -> V_55 - V_8 ;
F_34 ( & V_14 -> V_53 ) ;
memcpy ( & V_14 -> V_54 [ V_8 ] , V_7 , V_9 ) ;
F_35 ( & V_14 -> V_53 ) ;
return V_9 ;
}
static T_1
...
if ( V_8 )
return - V_43 ;
if ( F_38 ( F_39 ( V_14 -> V_63 ) ) )
return - V_48 ;
if ( sscanf ( V_7 , L_9 , & V_61 , & V_58 , & V_59 ) < 1 )
return - V_43 ;
if ( V_58 > V_14 -> V_60 )
return - V_43 ;
F_34 ( & V_14 -> V_53 ) ;
...
V_14 -> V_66 = V_58 ;
V_14 -> V_55 = V_58 + V_59 > V_14 -> V_60 ?
V_14 -> V_60 - V_58 : V_59 ;
V_14 -> V_51 = V_52 ;
V_14 -> V_54 = F_41 ( V_14 -> V_55 ) ;
if ( V_14 -> V_54 == NULL ) {
...
L_13 ,
V_14 -> V_66 , V_14 -> V_55 ) ;
memset ( V_14 -> V_54 , 0 , V_14 -> V_55 ) ;
V_14 -> V_36 -> V_37 ( V_11 , V_14 -> V_54 ,
V_14 -> V_66 , V_14 -> V_55 ) ;
break;
case 2 :
if ( V_14 -> V_51 != V_65 ) {
...
V_62 = 0 ;
if ( V_14 -> V_60 == V_68 && V_58 == 0 )
V_62 = 1 ;
else if ( V_58 == ( V_14 -> V_69 * 4 ) ||
V_58 == ( V_14 -> V_70 * 4 ) )
V_62 = 1 ;
...
struct V_12 , V_4 ) ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
struct V_10 * V_92 = F_54 ( V_14 -> V_63 ) ;
int type ;
T_5 V_93 ;
T_6 * V_78 = NULL ;
if ( V_8 != 0 )
...
if ( V_14 -> V_115 )
goto V_85;
V_14 -> V_115 = F_73 ( & V_14 -> V_63 -> V_116 , V_114 ,
& V_14 -> V_117 , V_87 ) ;
if ( ! V_14 -> V_115 ) {
...
if ( V_14 -> V_119 )
goto V_85;
V_14 -> V_119 = F_73 ( & V_14 -> V_63 -> V_116 , V_118 ,
& V_14 -> V_120 , V_87 ) ;
if ( ! V_14 -> V_119 ) {
...
{
T_8 * V_11 = F_2 ( F_84 ( V_116 ) ) ;
return F_82 ( V_7 , V_134 , L_44 , V_11 -> V_15 -> V_63 -> V_12 ) ;
}
static T_1
...
V_59 = V_14 -> V_19 + V_14 -> V_22 ;
else
V_59 = V_14 -> V_27 ;
return F_82 ( V_7 , V_134 , L_62 , V_59 ) ;
}
static T_1
...
return;
if ( F_38 ( F_39 ( V_228 -> V_11 -> V_15 -> V_63 ) ) ) {
...
V_254:
F_164 ( & V_14 -> V_63 -> V_116 , sizeof( struct V_248 ) ,
V_249 , V_250 ) ;
V_188:
return V_251 ;
}
...
F_164 ( & V_14 -> V_63 -> V_116 , sizeof( * V_249 ) ,
V_249 , V_250 ) ;
}
}
static void
...
{
T_8 * V_11 = F_2 ( V_198 ) ;
struct V_10 * V_92 = F_54 ( V_11 -> V_15 -> V_63 ) ;
if ( ! V_92 -> V_95 . V_298 ) {
F_173 ( V_198 ) = V_299 ;
return;
}
...
T_4 V_309 = 0 ;
int V_41 ;
struct V_310 * V_311 = V_14 -> V_312 [ 0 ] ;
V_123 = F_175 ( V_306 ) ;
if ( V_123 ) {
...
if ( V_307 ) {
F_177 ( & V_11 -> V_314 , V_315 ) ;
F_178 ( V_306 , V_316 ) ;
} else
F_177 ( & V_11 -> V_314 , V_317 ) ;
...
if ( V_14 -> V_95 . V_340 ) {
V_311 = V_14 -> V_312 [ 1 ] ;
F_21 ( V_341 , V_11 , 0xc000 ,
L_81
L_82 ,
V_311 , V_11 -> V_219 , V_14 -> V_95 . V_340 ) ;
goto V_342;
} else if ( V_343 == 1 || ! V_14 -> V_344 )
goto V_342;
for ( V_41 = 0 ; V_41 < V_14 -> V_345 ; V_41 ++ ) {
if ( memcmp ( V_14 -> V_344 [ V_41 ] . V_233 , V_11 -> V_233 , 8 ) == 0
&& memcmp ( V_14 -> V_344 [ V_41 ] . V_229 , V_11 -> V_229 ,
8 ) == 0 ) {
V_308 = V_14 -> V_344 [ V_41 ] . V_346 ;
break;
}
}
if ( V_308 ) {
V_123 = F_192 ( V_14 , V_309 , V_11 -> V_219 , 0 , 0 ,
V_308 ) ;
if ( ! V_123 )
...
L_84 ,
V_123 , V_308 , V_11 -> V_219 ) ;
F_21 ( V_32 , V_11 , 0x7085 ,
L_84 ,
V_123 , V_308 , V_11 -> V_219 ) ;
V_311 = V_14 -> V_312 [ V_123 ] ;
}
}
V_342:
V_11 -> V_311 = V_311 ;
...
F_202 ( F_94 ( & V_11 -> V_351 ) ) ;
F_203 ( V_11 ) ;
F_34 ( & V_14 -> V_352 ) ;
V_14 -> V_353 -- ;
F_204 ( V_11 -> V_219 , V_14 -> V_354 ) ;
F_35 ( & V_14 -> V_352 ) ;
if ( V_11 -> V_311 -> V_231 && ! V_14 -> V_95 . V_340 ) {
if ( F_205 ( V_11 , V_11 -> V_311 ) != V_46 )
F_9 ( V_47 , V_11 , 0x7087 ,
L_86 ) ;
}
F_9 ( V_29 , V_11 , 0x7088 , L_87 , V_231 ) ;
F_195 ( V_11 -> V_94 ) ;
return 0 ;
}
static int
...
F_186 ( V_11 -> V_94 ) = F_142 ( V_11 -> V_229 ) ;
F_187 ( V_11 -> V_94 ) = F_142 ( V_11 -> V_233 ) ;
F_188 ( V_11 -> V_94 ) = V_14 -> V_355 . V_356 ?
( V_357 | V_358 ) : V_358 ;
F_208 ( V_11 -> V_94 ) = V_14 -> V_359 ;
F_209 ( V_11 -> V_94 ) = V_14 -> V_353 ;
if ( F_44 ( V_14 ) )
V_200 = V_212 ;
else if ( F_45 ( V_14 ) )
V_200 = V_214 | V_210 |
