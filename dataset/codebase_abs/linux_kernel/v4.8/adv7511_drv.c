...
if ( ! V_2 -> V_187 )
return - V_114 ;
V_19 = F_71 ( V_2 , sizeof( * V_19 ) , V_188 ) ;
if ( ! V_19 )
return - V_189 ;
V_19 -> V_92 = false ;
V_19 -> V_115 = V_127 ;
if ( V_2 -> V_187 )
V_19 -> type = (enum V_190 ) F_72 ( V_2 ) ;
else
V_19 -> type = V_185 -> V_191 ;
memset ( & V_186 , 0 , sizeof( V_186 ) ) ;
if ( V_19 -> type == V_192 )
V_94 = F_66 ( V_2 -> V_187 , & V_186 ) ;
else
V_94 = F_73 ( V_2 -> V_187 , V_19 ) ;
if ( V_94 )
return V_94 ;
V_19 -> V_193 = F_74 ( V_2 , L_19 , V_194 ) ;
if ( F_75 ( V_19 -> V_193 ) )
return F_76 ( V_19 -> V_193 ) ;
if ( V_19 -> V_193 ) {
F_77 ( 5 ) ;
F_78 ( V_19 -> V_193 , 0 ) ;
}
V_19 -> V_24 = F_79 ( V_183 , & V_195 ) ;
if ( F_75 ( V_19 -> V_24 ) )
...
if ( V_94 )
return V_94 ;
F_10 ( V_19 -> V_24 , V_197 , V_198 ) ;
F_10 ( V_19 -> V_24 , V_199 ,
V_200 ) ;
F_10 ( V_19 -> V_24 , V_201 , V_202 ) ;
F_13 ( V_19 , 0xffff ) ;
V_19 -> V_84 = V_183 ;
V_19 -> V_118 = F_83 ( V_183 -> V_122 , V_198 >> 1 ) ;
if ( ! V_19 -> V_118 )
return - V_189 ;
if ( V_19 -> type == V_91 ) {
V_94 = F_84 ( V_19 ) ;
...
F_10 ( V_19 -> V_24 , V_206 ,
V_207 ) ;
F_24 ( V_19 ) ;
F_88 ( V_183 , V_19 ) ;
if ( V_19 -> type == V_192 )
F_19 ( V_19 , & V_186 ) ;
V_19 -> V_98 . V_208 = & V_209 ;
V_19 -> V_98 . V_187 = V_2 -> V_187 ;
V_94 = F_89 ( & V_19 -> V_98 ) ;
if ( V_94 ) {
F_90 ( V_2 , L_21 ) ;
goto V_205;
