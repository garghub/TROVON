...
V_3 = F_26 ( V_2 -> V_13 , V_95 ) ;
if ( ! V_3 )
return - V_96 ;
if ( F_4 ( V_2 , V_3 , V_2 -> V_13 , & V_5 , & V_78 ) ) {
F_27 ( V_3 ) ;
return 0 ;
}
* V_69 = 0 ;
...
V_97 = sizeof( * V_52 ) ;
V_4 = F_28 ( V_52 -> V_60 ) ;
time -> V_84 = F_29 ( V_52 -> V_61 ) ;
time -> V_85 = 0 ;
}
* V_76 = F_30 ( V_3 + V_97 , V_4 , V_95 ) ;
if ( * V_76 == NULL )
return - V_96 ;
F_27 ( V_3 ) ;
* V_77 = 0 ;
...
return;
V_105 = ( V_57 * 100 ) / 45 ;
V_55 = F_26 ( V_105 , V_95 ) ;
if ( V_55 ) {
V_35 . V_106 = F_26 ( F_37 (
V_38 , V_39 ) , V_95 ) ;
if ( ! V_35 . V_106 ) {
F_3 ( L_19
L_20 ,
...
static void F_39 ( struct V_108 * V_109 ,
enum V_66 V_67 )
{
struct V_51 * V_52 = (struct V_51 * ) V_53 ;
...
static T_5 F_47 ( struct V_120 * V_120 , char T_6 * V_76 ,
T_3 V_69 , T_1 * V_126 )
{
T_5 V_33 ;
char * V_127 = NULL ;
...
V_69 = F_48 ( T_3 , V_69 , V_13 - * V_126 ) ;
V_69 = F_49 ( V_69 , V_128 ) ;
V_127 = F_26 ( V_69 , V_95 ) ;
if ( ! V_127 ) {
V_33 = - V_96 ;
goto V_29;
}
...
if ( V_33 <= 0 )
goto V_29;
if ( F_50 ( V_76 , V_127 , V_33 ) )
V_33 = - V_129 ;
V_29:
F_27 ( V_127 ) ;
return V_33 ;
}
static T_5 F_51 ( struct V_120 * V_120 , const char T_6 * V_76 ,
T_3 V_69 , T_1 * V_126 )
{
T_5 V_33 ;
char * V_127 = NULL ;
...
if ( ! F_32 ( V_135 ) )
return - V_136 ;
if ( F_52 ( & V_2 , ( void T_6 * ) V_131 , sizeof( V_2 ) ) != 0 )
return - V_129 ;
...
if ( V_121 < 0 )
return V_121 ;
if ( F_50 ( ( void T_6 * ) V_131 , & V_121 , sizeof( V_121 ) ) != 0 )
return - V_129 ;
return 0 ;
}
#endif
...
const char * V_22 , int V_79 , const char * V_151 [] )
{
if ( V_2 -> V_142 . V_143 != V_79 )
return 0 ;
if ( V_22 ) {
...
int T_2 F_9 ( const char * V_22 , int V_79 ,
const char * V_151 [] )
{
struct V_140 * V_2 , * V_153 , * V_127 ;
int V_7 ;
F_58 (part, &nvram_partitions, partition) {
if ( ! F_61 ( V_2 , V_22 , V_79 , V_151 ) )
continue;
V_2 -> V_142 . V_143 = V_154 ;
strncpy ( V_2 -> V_142 . V_22 , L_29 , 12 ) ;
...
V_153 -> V_142 . V_144 = F_60 ( & V_2 -> V_142 ) ;
V_7 = F_59 ( V_2 ) ;
if ( V_7 <= 0 ) {
F_55 ( V_155 L_30 , V_7 ) ;
return V_7 ;
...
T_1 T_2 F_10 ( const char * V_22 , int V_79 ,
int V_25 , int V_24 )
{
struct V_140 * V_2 ;
struct V_140 * V_157 ;
...
if ( ! V_13 )
return - V_26 ;
V_157 = F_26 ( sizeof( * V_157 ) , V_95 ) ;
if ( ! V_157 ) {
F_3 ( L_31 , V_18 ) ;
return - V_96 ;
}
V_157 -> V_11 = V_158 -> V_11 ;
V_157 -> V_142 . V_143 = V_79 ;
...
T_1 F_7 ( const char * V_22 , int V_79 , int * V_162 )
{
struct V_140 * V_21 ;
F_58 (p, &nvram_partitions, partition) {
if ( V_21 -> V_142 . V_143 == V_79 &&
...
V_141 = F_26 ( sizeof( struct V_140 ) , V_95 ) ;
V_32 = - V_96 ;
if ( ! V_141 ) {
F_55 ( V_155 L_42 ) ;
goto V_29;
