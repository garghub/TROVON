...
F_117 ( V_113 , F_118 ( V_106 -> V_104 ) , V_106 -> V_104 -> V_142 ) ;
}
static int F_119 ( struct V_105 * V_106 , T_4 V_143 )
{
struct V_2 * V_3 = V_106 -> V_3 ;
struct V_81 * V_113 ;
V_113 = F_120 ( V_106 -> V_104 , V_143 , V_3 -> V_40 ) ;
if ( ! V_113 )
return 1 ;
F_111 ( V_106 ) ;
F_104 ( V_106 , V_113 ) ;
...
static void F_122 ( struct V_146 * V_147 )
{
struct V_105 * V_106 = F_123 ( V_147 , struct V_105 , V_147 ) ;
F_111 ( V_106 ) ;
if ( F_119 ( V_106 , V_101 ) )
V_106 -> error = - V_39 ;
F_112 ( V_106 ) ;
}
static void F_124 ( struct V_105 * V_106 )
{
struct V_2 * V_3 = V_106 -> V_3 ;
F_125 ( & V_106 -> V_147 , F_122 ) ;
F_126 ( V_3 -> V_148 , & V_106 -> V_147 ) ;
}
...
struct V_151 V_152 ;
F_129 ( V_153 , V_154 ) ;
F_130 ( & V_3 -> V_155 . V_156 ) ;
V_157:
if ( ! F_131 ( & V_3 -> V_150 ) )
goto V_158;
if ( F_101 ( F_132 ( V_159 , & V_3 -> V_59 ) ) ) {
F_133 ( & V_3 -> V_155 . V_156 ) ;
break;
}
F_134 ( V_160 ) ;
...
F_136 () ;
F_130 ( & V_3 -> V_155 . V_156 ) ;
F_137 ( & V_3 -> V_155 , & V_153 ) ;
goto V_157;
V_158:
V_150 = V_3 -> V_150 ;
V_3 -> V_150 = V_161 ;
F_133 ( & V_3 -> V_155 . V_156 ) ;
F_109 ( F_138 ( V_150 . V_162 ) ) ;
F_139 ( & V_152 ) ;
do {
V_106 = F_140 ( F_141 ( & V_150 ) ) ;
F_142 ( & V_106 -> V_162 , & V_150 ) ;
F_127 ( V_106 ) ;
} while ( ! F_131 ( & V_150 ) );
F_143 ( & V_152 ) ;
}
...
static void F_144 ( struct V_105 * V_106 , int V_163 )
{
struct V_81 * V_113 = V_106 -> V_63 . V_82 ;
struct V_2 * V_3 = V_106 -> V_3 ;
unsigned long V_59 ;
...
V_113 -> V_84 . V_144 = V_3 -> V_145 + V_106 -> V_77 ;
if ( F_145 ( ! V_163 ) && F_132 ( V_166 , & V_3 -> V_59 ) ) {
F_121 ( V_113 ) ;
return;
}
F_146 ( & V_3 -> V_155 . V_156 , V_59 ) ;
V_164 = & V_3 -> V_150 . V_162 ;
V_165 = NULL ;
V_77 = V_106 -> V_77 ;
while ( * V_164 ) {
V_165 = * V_164 ;
if ( V_77 < F_140 ( V_165 ) -> V_77 )
V_164 = & ( * V_164 ) -> V_167 ;
else
V_164 = & ( * V_164 ) -> V_168 ;
}
F_147 ( & V_106 -> V_162 , V_165 , V_164 ) ;
F_148 ( & V_106 -> V_162 , & V_3 -> V_150 ) ;
F_149 ( & V_3 -> V_155 ) ;
F_150 ( & V_3 -> V_155 . V_156 , V_59 ) ;
}
...
static void F_154 ( struct V_105 * V_106 )
{
struct V_2 * V_3 = V_106 -> V_3 ;
int V_28 = 0 ;
F_111 ( V_106 ) ;
...
struct V_105 * V_106 = F_123 ( V_63 , struct V_105 , V_63 ) ;
struct V_2 * V_3 = V_106 -> V_3 ;
if ( error == - V_111 ) {
F_155 ( & V_63 -> V_88 ) ;
return;
...
static void F_156 ( struct V_146 * V_147 )
{
struct V_105 * V_106 = F_123 ( V_147 , struct V_105 , V_147 ) ;
if ( F_56 ( V_106 -> V_104 ) == V_137 )
F_154 ( V_106 ) ;
...
{
struct V_2 * V_3 = V_106 -> V_3 ;
F_125 ( & V_106 -> V_147 , F_156 ) ;
F_126 ( V_3 -> V_174 , & V_106 -> V_147 ) ;
}
static int F_157 ( T_1 * V_22 , char * V_175 , unsigned int V_112 )
{
char V_176 [ 3 ] ;
unsigned int V_57 ;
V_176 [ 2 ] = '\0' ;
...
static int F_161 ( struct V_2 * V_3 , char * V_177 )
{
unsigned V_57 ;
int V_21 ;
...
static int F_165 ( struct V_2 * V_3 , char * V_22 )
{
int V_28 = - V_34 ;
...
goto V_78;
if ( V_3 -> V_23 && F_157 ( V_3 -> V_22 , V_22 , V_3 -> V_23 ) < 0 )
goto V_78;
F_166 ( V_180 , & V_3 -> V_59 ) ;
V_28 = F_163 ( V_3 ) ;
V_78:
memset ( V_22 , '0' , V_179 ) ;
return V_28 ;
...
V_3 -> V_184 = F_176 ( V_185 , V_38 ) ;
if ( ! V_3 -> V_184 )
goto V_194;
V_186 = V_185 ;
V_190 = F_177 ( & V_186 , L_17 ) ;
V_32 = F_177 ( & V_190 , L_19 ) ;
if ( ! V_190 )
V_3 -> V_49 = 1 ;
...
V_3 -> V_48 = V_3 -> V_49 ;
V_3 -> V_178 = 0 ;
V_3 -> V_32 = F_176 ( V_32 , V_38 ) ;
if ( ! V_3 -> V_32 )
goto V_194;
V_187 = F_177 ( & V_186 , L_17 ) ;
V_189 = F_177 ( & V_186 , L_17 ) ;
V_188 = F_177 ( & V_189 , L_19 ) ;
if ( V_186 )
F_179 ( L_22 ) ;
...
static int F_182 ( struct V_29 * V_30 , unsigned int V_205 , char * * V_206 )
{
struct V_2 * V_3 ;
...
V_3 -> V_23 = V_23 ;
V_30 -> V_181 = V_3 ;
V_192 = F_175 ( V_30 , V_206 [ 0 ] , V_206 [ 1 ] ) ;
if ( V_192 < 0 )
goto V_37;
V_3 -> V_90 = sizeof( struct V_89 ) ;
V_3 -> V_90 += F_183 ( F_1 ( V_3 ) ) ;
V_3 -> V_90 = F_76 ( V_3 -> V_90 , F_184 ( struct V_6 ) ) ;
...
V_192 = - V_39 ;
V_3 -> V_100 = F_185 ( V_216 , V_3 -> V_90 +
...
sizeof( struct V_6 ) + V_209 + V_3 -> V_8 ,
V_218 ) ;
V_3 -> V_128 = F_186 ( V_219 , 0 ) ;
if ( ! V_3 -> V_128 ) {
V_30 -> error = L_45 ;
goto V_37;
}
V_3 -> V_40 = F_187 ( V_216 , 0 ) ;
if ( ! V_3 -> V_40 ) {
V_30 -> error = L_46 ;
goto V_37;
}
...
V_3 -> V_87 = V_208 ;
V_192 = F_189 ( V_30 , V_206 [ 3 ] , F_190 ( V_30 -> V_220 ) , & V_3 -> V_140 ) ;
if ( V_192 ) {
V_30 -> error = L_49 ;
goto V_37;
}
...
V_211 . V_205 = V_205 ;
V_211 . V_206 = V_206 ;
V_192 = F_191 ( V_214 , & V_211 , & V_207 , & V_30 -> error ) ;
if ( V_192 )
goto V_37;
V_192 = - V_34 ;
while ( V_207 -- ) {
...
F_166 ( V_222 , & V_3 -> V_59 ) ;
else if ( ! strcasecmp ( V_212 , L_54 ) )
F_166 ( V_166 , & V_3 -> V_59 ) ;
else {
V_30 -> error = L_55 ;
goto V_37;
}
...
V_192 = - V_39 ;
V_3 -> V_148 = F_193 ( L_56 , V_223 , 1 ) ;
if ( ! V_3 -> V_148 ) {
V_30 -> error = L_57 ;
goto V_37;
}
if ( F_132 ( V_222 , & V_3 -> V_59 ) )
V_3 -> V_174 = F_193 ( L_58 , V_224 | V_223 , 1 ) ;
else
V_3 -> V_174 = F_193 ( L_58 , V_224 | V_223 | V_225 ,
F_194 () ) ;
if ( ! V_3 -> V_174 ) {
V_30 -> error = L_59 ;
goto V_37;
...
F_195 ( & V_3 -> V_155 ) ;
V_3 -> V_150 = V_161 ;
V_3 -> V_182 = F_196 ( F_128 , V_3 , L_60 ) ;
if ( F_19 ( V_3 -> V_182 ) ) {
...
static int F_198 ( struct V_29 * V_30 , struct V_81 * V_81 )
{
struct V_105 * V_106 ;
struct V_2 * V_3 = V_30 -> V_181 ;
if ( F_101 ( V_81 -> V_142 & V_228 ||
F_118 ( V_81 ) == V_229 ) ) {
V_81 -> V_139 = V_3 -> V_140 -> V_141 ;
if ( F_152 ( V_81 ) )
V_81 -> V_84 . V_144 = V_3 -> V_145 +
F_199 ( V_30 , V_81 -> V_84 . V_144 ) ;
return V_230 ;
}
if ( F_101 ( V_81 -> V_84 . V_109 > ( V_219 << V_116 ) ) &&
F_56 ( V_81 ) == V_65 )
F_200 ( V_81 , ( ( V_219 << V_116 ) >> V_79 ) ) ;
V_106 = F_91 ( V_81 , V_3 -> V_107 ) ;
F_110 ( V_106 , V_3 , V_81 , F_199 ( V_30 , V_81 -> V_84 . V_144 ) ) ;
V_106 -> V_63 . V_15 = (struct V_89 * ) ( V_106 + 1 ) ;
if ( F_56 ( V_106 -> V_104 ) == V_137 ) {
if ( F_119 ( V_106 , V_118 ) )
F_124 ( V_106 ) ;
} else
F_116 ( V_106 ) ;
return V_231 ;
}
static void F_201 ( struct V_29 * V_30 , T_6 type ,
...
break;
case V_238 :
F_202 ( L_62 , V_3 -> V_184 ) ;
if ( V_3 -> V_23 > 0 )
for ( V_57 = 0 ; V_57 < V_3 -> V_23 ; V_57 ++ )
F_202 ( L_63 , V_3 -> V_22 [ V_57 ] ) ;
else
F_202 ( L_17 ) ;
F_202 ( L_64 , ( unsigned long long ) V_3 -> V_87 ,
V_3 -> V_140 -> V_239 , ( unsigned long long ) V_3 -> V_145 ) ;
V_236 += ! ! V_30 -> V_221 ;
V_236 += F_132 ( V_222 , & V_3 -> V_59 ) ;
V_236 += F_132 ( V_166 , & V_3 -> V_59 ) ;
if ( V_236 ) {
F_202 ( L_65 , V_236 ) ;
if ( V_30 -> V_221 )
F_202 ( L_66 ) ;
...
{
struct V_2 * V_3 = V_30 -> V_181 ;
F_166 ( V_240 , & V_3 -> V_59 ) ;
}
static int F_204 ( struct V_29 * V_30 )
{
struct V_2 * V_3 = V_30 -> V_181 ;
if ( ! F_132 ( V_180 , & V_3 -> V_59 ) ) {
F_205 ( L_69 ) ;
return - V_241 ;
}
return 0 ;
...
{
struct V_2 * V_3 = V_30 -> V_181 ;
F_168 ( V_240 , & V_3 -> V_59 ) ;
}
static int F_207 ( struct V_29 * V_30 , unsigned V_205 , char * * V_206 )
{
struct V_2 * V_3 = V_30 -> V_181 ;
int V_192 = - V_34 ;
if ( V_205 < 2 )
...
if ( ! F_132 ( V_240 , & V_3 -> V_59 ) ) {
F_179 ( L_71 ) ;
return - V_34 ;
}
if ( V_205 == 3 && ! strcasecmp ( V_206 [ 1 ] , L_72 ) ) {
V_192 = F_165 ( V_3 , V_206 [ 2 ] ) ;
if ( V_192 )
return V_192 ;
if ( V_3 -> V_96 && V_3 -> V_96 -> V_204 )
V_192 = V_3 -> V_96 -> V_204 ( V_3 ) ;
...
static void F_209 ( struct V_29 * V_30 , struct V_244 * V_245 )
{
V_245 -> V_246 = V_115 ;
}
