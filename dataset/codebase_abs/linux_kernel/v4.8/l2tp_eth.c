...
static struct V_24 * F_19 ( struct V_4 * V_5 ,
struct V_24 * V_25 )
{
struct V_6 * V_7 = F_4 ( V_5 ) ;
...
V_15 = F_41 ( V_2 , V_61 , V_55 ) ;
if ( V_15 ) {
V_62 = - V_65 ;
goto V_64;
}
if ( V_58 -> V_66 ) {
V_5 = F_42 ( V_2 , V_58 -> V_66 ) ;
if ( V_5 ) {
F_13 ( V_5 ) ;
V_62 = - V_65 ;
goto V_64;
}
F_43 ( V_43 , V_58 -> V_66 , V_59 ) ;
} else
strcpy ( V_43 , V_67 ) ;
V_15 = F_44 ( sizeof( * V_39 ) , V_61 , V_55 ,
V_56 , V_58 ) ;
if ( ! V_15 ) {
V_62 = - V_68 ;
goto V_64;
}
V_5 = F_45 ( sizeof( * V_7 ) , V_43 , V_69 ,
F_21 ) ;
if ( ! V_5 ) {
V_62 = - V_68 ;
goto V_70;
...
goto V_80;
F_50 ( V_50 ) ;
F_43 ( V_15 -> V_66 , V_5 -> V_43 , V_59 ) ;
F_51 ( V_5 ) ;
V_9 = F_1 ( F_9 ( V_5 ) ) ;
F_10 ( & V_9 -> V_10 ) ;
F_52 ( & V_7 -> V_11 , & V_9 -> V_81 ) ;
F_12 ( & V_9 -> V_10 ) ;
return 0 ;
V_80:
V_36 ( V_5 ) ;
...
static T_2 int F_54 ( struct V_2 * V_2 )
{
