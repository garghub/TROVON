...
T_10 V_140 = F_105 ( log ) ;
T_11 V_141 = F_106 ( V_136 ) ;
T_10 V_142 = F_107 ( V_136 ) ;
...
T_12 int F_110 ( struct V_36 T_13 * V_146 )
{
struct V_36 args ;
unsigned long V_1 ;
...
if ( V_42 == V_151 ) {
int V_63 = 0 ;
T_8 V_120 = ( ( T_8 ) F_24 ( args . args [ 0 ] ) << 32 )
| F_24 ( args . args [ 1 ] ) ;
V_63 = F_94 ( V_120 ) ;
if ( V_63 == - V_127 )
...
#ifdef F_118
if ( F_119 ( V_160 ) ) {
V_154 = F_120 ( V_161 , V_155 ) ;
V_151 = F_26 ( L_29 ) ;
}
#endif
V_162 = F_121 ( V_163 , V_164 , V_154 ) ;
#ifdef F_122
V_41 = F_26 ( L_39 ) ;
#endif
}
int T_1 F_123 ( unsigned long V_165 ,
const char * V_166 , int V_167 , void * V_95 )
{
const T_3 * V_156 , * V_157 , * V_158 ;
if ( V_167 != 1 || strcmp ( V_166 , L_35 ) != 0 )
return 0 ;
V_156 = F_124 ( V_165 , L_36 , NULL ) ;
V_157 = F_124 ( V_165 , L_38 , NULL ) ;
V_158 = F_124 ( V_165 , L_37 , NULL ) ;
...
#ifdef F_125
V_156 = F_124 ( V_165 , L_40 , NULL ) ;
if ( V_156 )
V_11 = * V_156 ;
V_156 = F_124 ( V_165 , L_41 , NULL ) ;
if ( V_156 )
V_12 = * V_156 ;
if ( V_11 != V_28 &&
V_12 != V_28 )
...
F_130 () ;
F_128 ( & V_168 ) ;
F_132 ( V_169 >> 32 , V_169 & 0xffffffff ) ;
V_169 = 0 ;
F_6 ( & V_168 ) ;
}
