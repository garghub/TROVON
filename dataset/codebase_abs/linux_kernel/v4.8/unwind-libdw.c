...
V_17 -> V_11 = V_2 . V_11 ;
V_17 -> V_21 = V_2 . V_21 ;
F_7 ( L_1 V_22 L_2 V_22 L_3 ,
V_2 . V_21 ? V_2 . V_21 -> V_23 : L_4 ,
V_3 ,
V_2 . V_11 ? V_2 . V_11 -> V_24 ( V_2 . V_11 , V_3 ) : ( T_1 ) 0 ) ;
return 0 ;
}
static T_3 F_8 ( T_4 * V_12 , void * V_25 , void * * V_26 )
{
if ( * V_26 != NULL )
return 0 ;
* V_26 = V_25 ;
...
static int F_10 ( struct V_4 * V_5 , T_5 V_20 ,
T_6 * V_27 )
{
struct V_1 V_2 ;
T_7 V_28 ;
...
if ( ! V_2 . V_11 ) {
F_7 ( L_5 , ( unsigned long ) V_20 ) ;
return - 1 ;
}
if ( ! V_2 . V_11 -> V_7 )
return - 1 ;
V_28 = F_12 ( V_2 . V_11 -> V_7 , V_2 . V_11 , V_5 -> V_30 ,
V_20 , ( V_31 * ) V_27 , sizeof( * V_27 ) ) ;
return ! ( V_28 == sizeof( * V_27 ) ) ;
}
static bool F_13 ( T_4 * V_12 V_32 , T_5 V_20 , T_6 * V_33 ,
void * V_25 )
{
struct V_4 * V_5 = V_25 ;
...
return false ;
V_38 = V_15 + V_35 -> V_28 ;
if ( V_20 + sizeof( T_6 ) < V_20 )
return false ;
if ( V_20 < V_15 || V_20 + sizeof( T_6 ) > V_38 ) {
V_40 = F_10 ( V_5 , V_20 , V_33 ) ;
if ( V_40 ) {
F_7 ( L_6 V_22 L_7
L_8 V_22 L_9 V_22 L_10 ,
V_20 , V_15 , V_38 ) ;
return false ;
}
return true ;
...
F_7 ( L_11 V_22 L_12 ,
V_20 , ( unsigned long ) * V_33 , V_39 ) ;
return true ;
}
static int
F_15 ( T_8 * V_43 , void * V_25 )
{
struct V_4 * V_5 = V_25 ;
T_5 V_44 ;
...
V_52 = V_5 -> V_18 [ V_63 ] . V_3 ? V_5 -> V_48 ( & V_5 -> V_18 [ V_63 ] , V_5 -> V_25 ) : 0 ;
}
V_58:
if ( V_52 )
F_7 ( L_14 , F_18 ( - 1 ) ) ;
