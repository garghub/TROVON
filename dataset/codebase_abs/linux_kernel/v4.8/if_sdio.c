...
V_19 -> V_138 = F_74 ;
V_19 -> V_139 = F_77 ;
V_19 -> V_140 = ! ( V_6 -> V_2 -> V_90 -> V_91 & V_92 ) ;
V_4 = F_55 ( V_2 ) ;
if ( V_4 )
goto V_141;
V_25:
...
V_2 = F_80 ( V_6 ) ;
F_93 ( & V_6 -> V_76 ) ;
if ( V_142 && ( V_2 -> V_11 == V_14 ) ) {
struct V_83 V_84 ;
memset ( & V_84 , 0 , sizeof( V_84 ) ) ;
F_7 ( L_41 ) ;
if ( F_48 ( V_2 -> V_19 , V_143 ,
...
static int F_96 ( struct V_132 * V_76 )
{
...
if ( V_4 )
return V_4 ;
return F_103 ( V_6 , V_148 ) ;
}
static int F_105 ( struct V_132 * V_76 )
{
struct V_78 * V_6 = F_97 ( V_76 ) ;
struct V_1 * V_2 = F_80 ( V_6 ) ;
int V_4 ;
