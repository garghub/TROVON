...
struct V_7 * V_8 , unsigned long V_3 )
{
F_38 ( V_21 , V_8 , V_3 , V_3 + V_45 ) ;
}
static inline void F_39 ( struct V_44 * V_21 ,
struct V_7 * V_8 ,
unsigned long V_46 ,
unsigned long V_47 )
{
F_38 ( V_21 , V_8 , V_46 , V_47 ) ;
}
...
{
struct V_13 * V_14 =
F_40 ( V_21 , struct V_13 , V_21 ) ;
struct V_48 * V_19 = & V_14 -> V_19 ;
struct V_1 * V_2 , * V_41 = NULL ;
unsigned long V_31 ;
bool V_49 = false ;
F_15 ( & V_14 -> V_23 , V_31 ) ;
for ( V_2 = F_29 ( V_19 , V_46 , V_47 - 1 ) ;
V_2 ; V_2 = V_41 ) {
V_41 = F_30 ( V_2 , V_46 , V_47 - 1 ) ;
F_23 ( V_35 , L_4 ,
V_2 -> V_3 , V_2 -> V_5 ) ;
if ( V_14 -> V_10 -> V_50 ( V_14 -> V_6 , V_2 ) ) {
F_27 ( V_2 , V_19 ) ;
...
static void V_26 ( struct V_51 * V_52 )
{
struct V_13 * V_14 = F_40 ( V_52 ,
struct V_13 ,
V_25 ) ;
struct V_32 V_27 ;
unsigned long V_31 ;
