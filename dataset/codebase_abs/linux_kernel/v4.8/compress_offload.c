...
V_95 = F_34 ( sizeof( * V_95 ) , V_27 ) ;
if ( ! V_95 )
return - V_28 ;
if ( F_23 ( V_95 , ( void V_64 * ) V_59 , sizeof( * V_95 ) ) ) {
V_73 = - V_65 ;
goto V_78;
}
V_73 = F_35 ( V_95 ) ;
...
static int
F_37 ( struct V_46 * V_29 , unsigned long V_59 )
{
struct V_107 * V_95 ;
int V_73 ;
if ( ! V_29 -> V_32 -> V_108 )
...
static int
F_38 ( struct V_46 * V_29 , unsigned long V_59 )
{
struct V_109 V_110 ;
int V_73 ;
if ( ! V_29 -> V_32 -> V_111 )
...
static int
F_39 ( struct V_46 * V_29 , unsigned long V_59 )
{
struct V_109 V_110 ;
int V_73 ;
if ( ! V_29 -> V_32 -> V_112 )
...
static int F_40 ( struct V_46 * V_29 )
{
int V_73 ;
...
static int F_41 ( struct V_46 * V_29 )
{
int V_73 ;
...
static int F_42 ( struct V_46 * V_29 )
{
int V_73 ;
...
{
struct V_46 * V_29 ;
V_29 = F_45 ( V_117 , struct V_46 , V_30 . V_117 ) ;
F_11 ( & V_29 -> V_34 -> V_38 ) ;
V_29 -> V_32 -> V_43 ( V_29 , V_44 ) ;
F_46 ( & V_29 -> V_9 -> V_37 ) ;
F_12 ( & V_29 -> V_34 -> V_38 ) ;
}
int F_47 ( struct V_46 * V_29 ,
T_6 V_35 )
{
...
V_29 -> V_9 -> V_35 = V_35 ;
F_16 ( L_13 , V_35 ) ;
F_48 ( V_118 , & V_29 -> V_30 , 0 ) ;
return 0 ;
}
static int F_49 ( struct V_46 * V_29 )
{
int V_13 ;
V_29 -> V_9 -> V_35 = V_41 ;
F_12 ( & V_29 -> V_34 -> V_38 ) ;
V_13 = F_50 ( V_29 -> V_9 -> V_37 ,
( V_29 -> V_9 -> V_35 != V_41 ) ) ;
if ( V_13 == - V_119 )
F_16 ( L_14 ) ;
else if ( V_13 )
...
static int F_51 ( struct V_46 * V_29 )
{
int V_73 ;
if ( V_29 -> V_9 -> V_35 == V_74 ||
V_29 -> V_9 -> V_35 == V_57 )
...
static int F_53 ( struct V_46 * V_29 )
{
int V_73 ;
if ( V_29 -> V_9 -> V_35 == V_74 ||
V_29 -> V_9 -> V_35 == V_57 )
...
static long F_54 ( struct V_2 * V_3 , unsigned int V_123 , unsigned long V_59 )
{
struct V_6 * V_7 = V_3 -> V_33 ;
struct V_46 * V_29 ;
int V_73 = - V_124 ;
...
static long F_58 ( struct V_2 * V_2 , unsigned int V_123 ,
unsigned long V_59 )
{
return F_54 ( V_2 , V_123 , ( unsigned long ) F_59 ( V_59 ) ) ;
}
static int F_60 ( struct V_142 * V_34 )
{
int V_13 = - V_20 ;
char V_143 [ 16 ] ;
struct V_4 * V_5 ;
...
static int F_62 ( struct V_142 * V_34 )
{
struct V_4 * V_5 ;
V_5 = V_34 -> V_144 ;
F_63 ( & V_5 -> V_147 ) ;
...
F_65 ( V_45 , L_20 , V_5 -> V_26 -> V_151 ) ;
F_65 ( V_45 , L_21 , V_5 -> V_34 ) ;
F_65 ( V_45 , L_22 ,
V_5 -> V_25 == V_17
? L_23 : L_24 ) ;
F_65 ( V_45 , L_25 , V_5 -> V_99 ) ;
}
...
static inline void F_72 ( struct V_4 * V_5 , const char * V_99 )
{
F_73 ( V_5 -> V_99 , V_99 , sizeof( V_5 -> V_99 ) ) ;
}
static inline int F_66 ( struct V_4 * V_5 )
{
return 0 ;
}
...
static int F_74 ( struct V_142 * V_34 )
{
struct V_4 * V_5 ;
V_5 = V_34 -> V_144 ;
F_71 ( V_5 ) ;
...
int F_76 ( struct V_158 * V_26 , int V_34 ,
...
F_72 ( V_5 , V_99 ) ;
F_77 ( & V_5 -> V_147 , V_26 ) ;
F_78 ( & V_5 -> V_147 , L_28 , V_26 -> V_151 , V_34 ) ;
V_13 = F_79 ( V_26 , V_163 , V_5 , & V_32 ) ;
if ( V_13 == 0 )
F_66 ( V_5 ) ;
return V_13 ;
}
...
{
return F_83 ( V_34 -> V_26 ) ;
}
int F_84 ( struct V_4 * V_34 )
{
int V_73 ;
