...
struct V_4 * F_49 ( struct V_26 * V_27 , int V_61 )
{
struct V_4 * V_5 ;
T_1 V_62 = V_45 ;
int V_63 ;
...
V_5 -> V_101 = V_102 ;
F_55 ( & V_5 -> V_3 ) ;
F_56 ( & V_5 -> V_3 , L_7 , V_5 -> V_49 ) ;
V_5 -> V_3 . V_103 = & V_104 ;
V_5 -> V_3 . type = & V_105 ;
F_55 ( & V_5 -> V_24 ) ;
V_5 -> V_24 . V_38 = & V_5 -> V_3 ;
V_5 -> V_24 . V_106 = & V_107 ;
F_56 ( & V_5 -> V_24 , L_7 , V_5 -> V_49 ) ;
V_5 -> V_24 . V_108 = V_109 ;
V_5 -> V_56 = F_57 ( V_110 , V_5 ,
L_8 , V_5 -> V_49 ) ;
if ( F_58 ( V_5 -> V_56 ) ) {
F_6 ( V_91 , V_5 ,
L_9 ,
...
struct V_4 * F_62 ( struct V_26 * V_27 , int V_61 )
{
struct V_4 * V_5 = F_49 ( V_27 , V_61 ) ;
if ( ! V_27 -> V_115 ) {
F_63 ( V_91 L_12
L_13 , V_27 -> V_31 ) ;
F_64 () ;
...
static int F_69 ( struct V_1 * V_2 , const void * V_118 )
{
struct V_4 * V_119 ;
...
struct V_4 * F_70 ( unsigned short V_120 )
{
struct V_1 * V_121 ;
struct V_4 * V_5 = NULL ;
V_121 = F_71 ( & V_107 , NULL , & V_120 ,
F_69 ) ;
if ( V_121 ) {
V_5 = F_72 ( F_3 ( V_121 ) ) ;
F_2 ( V_121 ) ;
...
struct V_4 * F_72 ( struct V_4 * V_5 )
{
if ( ( V_5 -> V_9 == V_16 ) ||
! F_31 ( & V_5 -> V_3 ) )
return NULL ;
...
int F_78 ( const struct V_1 * V_2 )
{
return V_2 -> type == & V_105 ;
}
int F_79 ( struct V_4 * V_5 , struct V_122 * V_123 )
{
if ( F_80 ( ! V_5 -> V_50 ) ) {
F_6 ( V_18 , V_5 ,
L_14
