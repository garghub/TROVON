...
{
return fprintf ( V_31 , L_3 , V_1 -> V_6 , F_37 ( V_1 ) ) +
F_41 ( V_1 -> V_7 , V_31 ) ;
}
...
struct V_38 * V_38 = & V_1 -> V_7 -> V_38 [ V_36 ] ;
struct V_32 * V_32 ;
F_47 ( & V_38 -> V_39 ) ;
for ( V_32 = F_48 ( V_38 ) ; V_32 ; V_32 = F_49 ( V_32 ) ) {
V_25 = F_43 ( V_1 , V_32 , & V_35 ) ;
if ( V_25 || V_35 )
break;
}
F_50 ( & V_38 -> V_39 ) ;
...
if ( V_1 -> V_7 == V_42 -> V_7 ) {
F_53 ( L_4 ,
V_1 -> V_5 , V_1 -> V_6 , V_42 -> V_5 , V_42 -> V_6 ) ;
return 0 ;
}
for ( V_36 = 0 ; V_36 < V_37 ; ++ V_36 )
if ( F_54 ( V_1 , V_42 -> V_7 , V_36 ) < 0 )
return - V_27 ;
return 0 ;
}
...
if ( V_1 -> V_5 == - 1 )
return NULL ;
return F_60 ( V_2 , V_1 -> V_5 , V_1 -> V_5 ) ;
}
