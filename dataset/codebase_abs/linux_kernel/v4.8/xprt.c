...
void F_70 ( struct V_15 * V_16 , void * V_85 )
{
F_25 ( & V_16 -> V_40 ) ;
if ( V_16 -> V_25 != V_85 )
goto V_8;
...
V_18 -> V_21 -> V_45 = 0 ;
V_18 -> V_29 = V_18 -> V_21 -> V_56 ;
F_45 ( & V_16 -> V_54 , V_18 , V_93 ) ;
if ( F_16 ( V_87 , & V_16 -> V_24 ) )
return;
if ( F_74 ( V_16 ) )
return;
V_16 -> V_94 . V_95 = V_78 ;
V_16 -> V_41 -> V_96 ( V_16 , V_18 ) ;
}
F_36 ( V_16 , V_18 ) ;
}
...
if ( V_18 -> V_30 == 0 ) {
V_16 -> V_94 . V_97 ++ ;
V_16 -> V_94 . V_98 += ( long ) V_78 - V_16 -> V_94 . V_95 ;
F_13 ( L_14 ,
V_18 -> V_28 ) ;
return;
}
...
struct V_19 * F_75 ( struct V_15 * V_16 , T_2 V_107 )
{
struct V_19 * V_108 ;
F_3 (entry, &xprt->recv, rq_list)
if ( V_108 -> V_109 == V_107 ) {
F_76 ( V_16 , V_107 , 0 ) ;
return V_108 ;
}
F_13 ( L_20 ,
F_77 ( V_107 ) ) ;
F_76 ( V_16 , V_107 , - V_13 ) ;
V_16 -> V_94 . V_110 ++ ;
return NULL ;
}
...
long V_111 = F_79 ( F_80 ( V_20 -> V_112 ) ) ;
if ( V_57 ) {
if ( V_20 -> V_27 == 1 )
F_81 ( V_65 , V_57 , V_111 ) ;
F_82 ( V_65 , V_57 , V_20 -> V_27 - 1 ) ;
}
}
void F_83 ( struct V_17 * V_18 , int V_113 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
struct V_15 * V_16 = V_20 -> V_51 ;
F_13 ( L_21 ,
V_18 -> V_28 , F_77 ( V_20 -> V_109 ) , V_113 ) ;
F_84 ( V_16 , V_20 -> V_109 , V_113 ) ;
V_16 -> V_94 . V_114 ++ ;
V_20 -> V_112 = F_85 ( F_86 () , V_20 -> V_115 ) ;
if ( V_16 -> V_41 -> V_57 != NULL )
F_78 ( V_18 ) ;
F_8 ( & V_20 -> V_116 ) ;
V_20 -> V_117 . V_118 = V_113 ;
F_87 () ;
V_20 -> V_119 = V_113 ;
F_47 ( & V_16 -> V_54 , V_18 ) ;
}
...
if ( ! V_20 -> V_119 ) {
if ( F_68 ( & V_20 -> V_116 ) && F_92 ( V_18 ) ) {
F_25 ( & V_16 -> V_40 ) ;
memcpy ( & V_20 -> V_117 , & V_20 -> V_126 ,
sizeof( V_20 -> V_117 ) ) ;
F_4 ( & V_20 -> V_116 , & V_16 -> V_89 ) ;
F_26 ( & V_16 -> V_40 ) ;
F_52 ( V_20 ) ;
F_93 ( & V_16 -> V_57 ) ;
}
...
if ( V_124 > V_16 -> V_94 . V_130 )
V_16 -> V_94 . V_130 = V_124 ;
V_16 -> V_94 . V_131 ++ ;
V_16 -> V_94 . V_132 += V_16 -> V_94 . V_131 - V_16 -> V_94 . V_114 ;
V_16 -> V_94 . V_133 += V_16 -> V_134 . V_135 ;
V_16 -> V_94 . V_136 += V_16 -> V_35 . V_135 ;
V_16 -> V_94 . V_137 += V_16 -> V_54 . V_135 ;
if ( ! F_64 ( V_16 ) )
V_18 -> V_30 = - V_138 ;
else {
if ( ! V_20 -> V_119 && F_92 ( V_18 ) )
F_45 ( & V_16 -> V_54 , V_18 , F_88 ) ;
V_20 -> V_122 = V_16 -> V_86 ;
}
F_26 ( & V_16 -> V_40 ) ;
...
F_2 ( & V_16 -> V_140 ) ;
if ( ! F_68 ( & V_16 -> free ) ) {
V_20 = F_109 ( V_16 -> free . V_145 , struct V_19 , V_116 ) ;
F_110 ( & V_20 -> V_116 ) ;
goto V_146;
}
...
{
struct V_19 * V_20 ;
while ( ! F_68 ( & V_16 -> free ) ) {
V_20 = F_118 ( & V_16 -> free , struct V_19 , V_116 ) ;
F_110 ( & V_20 -> V_116 ) ;
F_107 ( V_20 ) ;
}
}
...
if ( F_65 ( V_16 ) )
F_145 ( & V_16 -> V_57 , F_67 ,
( unsigned long ) V_16 ) ;
else
F_146 ( & V_16 -> V_57 ) ;
if ( strlen ( args -> V_105 ) > V_185 ) {
F_147 ( V_16 ) ;
return F_102 ( - V_186 ) ;
}
V_16 -> V_105 = F_148 ( args -> V_105 , V_154 ) ;
if ( V_16 -> V_105 == NULL ) {
F_147 ( V_16 ) ;
return F_102 ( - V_143 ) ;
}
