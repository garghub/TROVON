...
V_80 = F_66 ( & V_3 -> V_84 , & V_128 , 0 ,
V_129 , V_130 ) ;
if ( V_80 ) {
F_63 ( V_3 -> V_11 , L_18 ) ;
goto V_125;
}
F_67 ( & V_3 -> V_84 , & V_128 , V_117 ,
NULL ) ;
return 0 ;
V_125:
F_68 ( & V_3 -> V_84 ) ;
...
{
#ifdef F_70
const struct V_131 * V_28 = V_3 -> V_28 ;
struct V_132 * V_8 ;
struct V_133 * V_134 ;
int V_6 ;
V_134 = F_71 ( V_3 -> V_11 , V_28 -> V_10 , sizeof( * V_134 ) , V_135 ) ;
if ( ! V_134 )
return - V_136 ;
...
T_2 * V_137 ;
V_137 = F_71 ( V_3 -> V_11 , V_5 -> V_114 ,
sizeof( * V_137 ) , V_135 ) ;
if ( ! V_137 )
return - V_136 ;
V_8 [ V_6 ] . V_137 = V_137 ;
}
V_3 -> V_138 . V_134 = V_134 ;
V_3 -> V_138 . V_8 = V_8 ;
#endif
return 0 ;
}
int F_72 ( struct V_139 * V_140 ,
const struct V_131 * V_141 )
{
struct V_2 * V_3 ;
int V_6 , V_80 , V_117 ;
if ( ! V_141 )
return - V_71 ;
V_3 = F_73 ( & V_140 -> V_11 , sizeof( * V_3 ) , V_135 ) ;
if ( ! V_3 )
return - V_136 ;
V_3 -> V_11 = & V_140 -> V_11 ;
V_3 -> V_28 = V_141 ;
...
V_3 -> V_8 = F_71 ( & V_140 -> V_11 , V_3 -> V_7 ,
sizeof( * V_3 -> V_8 ) , V_135 ) ;
if ( ! V_3 -> V_8 )
return - V_136 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_7 ; V_6 ++ ) {
struct V_1 * V_5 = & V_3 -> V_8 [ V_6 ] ;
...
V_143 = F_75 ( V_140 , V_145 ,
V_5 -> V_146 ) ;
V_21 = F_76 ( & V_140 -> V_11 , V_143 ) ;
if ( F_77 ( V_21 ) )
return F_78 ( V_21 ) ;
V_144 = F_7 ( V_21 + V_147 ) ;
V_5 -> V_21 = V_21 ;
V_5 -> V_14 = V_21 + V_144 ;
...
return V_80 ;
V_3 -> V_148 = V_149 ;
V_3 -> V_148 . V_31 = F_61 ( & V_140 -> V_11 ) ;
V_3 -> V_148 . V_32 = V_3 -> V_28 -> V_32 ;
V_3 -> V_148 . V_10 = V_3 -> V_28 -> V_10 ;
V_3 -> V_27 = F_81 ( & V_140 -> V_11 , & V_3 -> V_148 ,
V_3 ) ;
if ( F_77 ( V_3 -> V_27 ) ) {
F_63 ( & V_140 -> V_11 , L_20 ) ;
...
int F_83 ( struct V_139 * V_140 )
{
struct V_2 * V_3 = F_84 ( V_140 ) ;
F_68 ( & V_3 -> V_84 ) ;
return 0 ;
}
int F_85 ( struct V_150 * V_11 )
{
struct V_139 * V_140 = F_86 ( V_11 ) ;
struct V_2 * V_3 = F_84 ( V_140 ) ;
struct V_132 * V_8 ;
struct V_133 * V_134 ;
int V_6 ;
V_134 = V_3 -> V_138 . V_134 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_28 -> V_10 ; V_6 ++ ) {
const struct V_151 * V_152 = & V_3 -> V_28 -> V_32 [ V_6 ] ;
T_2 V_153 ;
if ( ! F_12 ( V_3 , V_152 -> V_154 ) )
continue;
V_153 = F_7 ( F_3 ( V_3 , V_152 -> V_154 , V_40 ) ) ;
V_134 [ V_6 ] . V_52 = V_153 & ~ V_85 ;
V_153 = F_7 ( F_3 ( V_3 , V_152 -> V_154 , V_41 ) ) ;
V_134 [ V_6 ] . V_79 = V_153 ;
}
V_8 = V_3 -> V_138 . V_8 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_7 ; V_6 ++ ) {
struct V_1 * V_5 = & V_3 -> V_8 [ V_6 ] ;
...
for ( V_15 = 0 ; V_15 < V_5 -> V_114 ; V_15 ++ )
V_8 [ V_6 ] . V_137 [ V_15 ] = F_7 ( V_87 + V_15 * 4 ) ;
}
return 0 ;
}
...
int F_88 ( struct V_150 * V_11 )
{
struct V_139 * V_140 = F_86 ( V_11 ) ;
struct V_2 * V_3 = F_84 ( V_140 ) ;
const struct V_132 * V_8 ;
...
if ( ! F_12 ( V_3 , V_152 -> V_154 ) )
continue;
V_155 = F_3 ( V_3 , V_152 -> V_154 , V_40 ) ;
V_153 = F_7 ( V_155 ) & ~ V_85 ;
if ( V_153 != V_134 [ V_6 ] . V_52 ) {
F_26 ( V_134 [ V_6 ] . V_52 , V_155 ) ;
F_54 ( V_11 , L_21 ,
V_152 -> V_154 , F_7 ( V_155 ) ) ;
}
V_155 = F_3 ( V_3 , V_152 -> V_154 , V_41 ) ;
V_153 = F_7 ( V_155 ) ;
if ( V_153 != V_134 [ V_6 ] . V_79 ) {
F_26 ( V_134 [ V_6 ] . V_79 , V_155 ) ;
F_54 ( V_11 , L_22 ,
V_152 -> V_154 , F_7 ( V_155 ) ) ;
}
}
...
V_87 = V_5 -> V_21 + V_5 -> V_93 ;
for ( V_15 = 0 ; V_15 < V_5 -> V_114 ; V_15 ++ ) {
F_26 ( V_8 [ V_6 ] . V_137 [ V_15 ] , V_87 + V_15 * 4 ) ;
