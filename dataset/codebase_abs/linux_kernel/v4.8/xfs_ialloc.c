...
V_235 -> V_240 = ( V_241 ) ( V_90 << V_2 -> V_3 . V_74 ) ;
return 0 ;
}
if ( V_2 -> V_242 ) {
V_233 = V_53 & V_2 -> V_242 ;
V_232 = V_53 - V_233 ;
} else {
error = F_112 ( V_2 , V_32 , V_40 , V_172 , V_53 ,
& V_232 , & V_233 , V_156 ) ;
...
{
T_13 V_244 ;
V_244 = ( 1LL << F_118 ( V_2 ) ) >> V_245 ;
V_2 -> V_126 = F_119 ( V_2 , V_2 -> V_246 ,
V_244 ) ;
}
void
F_72 (
...
ASSERT ( V_39 -> V_223 == F_7 ( V_224 ) ) ;
#endif
F_121 ( V_32 , V_247 , V_258 ) ;
if ( V_248 & V_259 ) {
F_122 ( V_248 , V_251 , V_260 ,
& V_249 , & V_250 ) ;
F_40 ( V_32 , V_247 , V_249 , V_250 ) ;
}
V_248 &= ~ V_259 ;
if ( V_248 ) {
F_122 ( V_248 , V_251 , V_261 ,
& V_249 , & V_250 ) ;
F_40 ( V_32 , V_247 , V_249 , V_250 ) ;
}
}
...
ASSERT ( V_39 -> V_255 [ V_12 ] ) ;
}
static bool
F_124 (
struct V_33 * V_247 )
{
struct V_1 * V_2 = V_247 -> V_263 -> V_264 ;
struct V_38 * V_39 = F_20 ( V_247 ) ;
if ( F_28 ( & V_2 -> V_3 ) ) {
if ( ! F_125 ( & V_39 -> V_265 , & V_2 -> V_3 . V_84 ) )
return false ;
if ( ! F_126 ( V_2 ,
F_16 ( F_20 ( V_247 ) -> V_266 ) ) )
return false ;
}
if ( V_39 -> V_223 != F_7 ( V_224 ) )
return false ;
if ( ! F_127 ( F_14 ( V_39 -> V_252 ) ) )
return false ;
if ( F_14 ( V_39 -> V_253 ) > V_267 )
return false ;
if ( V_247 -> V_268 && F_14 ( V_39 -> V_41 ) != V_247 -> V_268 -> V_269 )
return false ;
F_123 ( V_39 ) ;
return true ;
}
...
{
struct V_1 * V_2 = V_247 -> V_263 -> V_264 ;
struct V_275 * V_276 = V_247 -> V_277 ;
if ( ! F_124 ( V_247 ) ) {
F_130 ( V_247 , - V_139 ) ;
F_132 ( V_247 ) ;
return;
...
return;
if ( V_276 )
F_20 ( V_247 ) -> V_266 = F_10 ( V_276 -> V_278 . V_279 ) ;
F_134 ( V_247 , V_270 ) ;
}
int
F_135 (
...
F_136 ( V_2 , V_40 ) ;
ASSERT ( V_40 != V_169 ) ;
error = F_137 ( V_2 , V_32 , V_2 -> V_66 ,
F_138 ( V_2 , V_40 , F_139 ( V_2 ) ) ,
F_140 ( V_2 , 1 ) , 0 , V_280 , & V_281 ) ;
if ( error )
return error ;
F_141 ( * V_280 , V_282 ) ;
return 0 ;
...
int error ;
F_142 ( V_2 , V_40 ) ;
error = F_135 ( V_2 , V_32 , V_40 , V_280 ) ;
if ( error )
return error ;
V_39 = F_20 ( * V_280 ) ;
V_103 = F_70 ( V_2 , V_40 ) ;
...
T_17 * V_247 = NULL ;
int error ;
error = F_101 ( V_2 , V_32 , V_40 , & V_247 ) ;
if ( error )
return error ;
if ( V_247 )
F_102 ( V_32 , V_247 ) ;
