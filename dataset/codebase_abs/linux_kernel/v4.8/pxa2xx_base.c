...
void F_18 ( struct V_29 * V_30 , struct V_31 * V_32 )
{
T_2 V_33 = V_34 ;
if ( ( V_32 -> V_35 + V_32 -> V_19 ) > 1 ||
F_19 () || F_20 () )
V_33 |= V_36 ;
F_6 ( V_33 , V_37 ) ;
}
...
{
V_15 -> V_38 . V_39 = F_22 ( V_15 -> V_19 ) ;
V_15 -> V_38 . V_40 = F_22 ( V_15 -> V_19 ) + V_41 - 1 ;
V_15 -> V_38 . V_42 = V_43 [ V_15 -> V_19 ] ;
V_15 -> V_38 . V_44 = V_45 ;
V_15 -> V_46 . V_39 = F_23 ( V_15 -> V_19 ) ;
V_15 -> V_46 . V_40 = F_23 ( V_15 -> V_19 ) + V_47 - 1 ;
V_15 -> V_46 . V_42 = L_5 ;
V_15 -> V_46 . V_44 = V_45 | V_48 ;
V_15 -> V_49 . V_39 = F_24 ( V_15 -> V_19 ) ;
V_15 -> V_49 . V_40 = F_24 ( V_15 -> V_19 ) + V_50 - 1 ;
V_15 -> V_49 . V_42 = L_6 ;
V_15 -> V_49 . V_44 = V_45 ;
V_15 -> V_51 . V_39 = F_25 ( V_15 -> V_19 ) ;
V_15 -> V_51 . V_40 = F_25 ( V_15 -> V_19 ) + V_52 - 1 ;
V_15 -> V_51 . V_42 = L_7 ;
V_15 -> V_51 . V_44 = V_45 ;
return F_26 ( V_15 ) ;
}
...
static int F_29 ( struct V_55 * V_30 )
{
int V_56 , V_57 = 0 ;
struct V_31 * V_32 ;
struct V_58 * V_59 ;
struct V_14 * V_15 ;
struct V_16 * V_16 ;
V_32 = (struct V_31 * ) V_30 -> V_30 . V_60 ;
if ( ! V_32 ) {
V_57 = - V_61 ;
goto V_62;
}
...
return - V_61 ;
F_27 ( V_32 ) ;
V_59 = F_34 ( & V_30 -> V_30 , F_35 ( V_32 -> V_19 ) ,
V_64 ) ;
if ( ! V_59 )
return - V_65 ;
V_59 -> V_66 = V_32 -> V_19 ;
for ( V_56 = 0 ; V_56 < V_32 -> V_19 ; V_56 ++ ) {
V_15 = & V_59 -> V_15 [ V_56 ] ;
V_15 -> V_19 = V_32 -> V_35 + V_56 ;
V_15 -> V_16 = V_16 ;
F_36 ( V_15 , V_32 , & V_30 -> V_30 ) ;
V_57 = F_21 ( V_15 ) ;
if ( V_57 )
goto V_67;
}
...
static int F_39 ( struct V_55 * V_30 )
{
struct V_58 * V_59 = F_40 ( V_30 ) ;
int V_56 ;
for ( V_56 = 0 ; V_56 < V_59 -> V_66 ; V_56 ++ )
F_38 ( & V_59 -> V_15 [ V_56 ] ) ;
return 0 ;
}
static int F_41 ( struct V_29 * V_30 )
{
struct V_31 * V_32 = (struct V_31 * ) V_30 -> V_60 ;
F_18 ( V_30 , V_32 ) ;
return 0 ;
}
