...
static int F_52 ( struct V_99 * V_94 , struct V_99 * V_100 ,
void * V_101 )
{
struct V_102 * V_103 = F_53 ( V_94 ) ;
...
void T_1 * V_38 ;
int V_109 ;
V_33 = F_54 ( V_94 , sizeof( * V_33 ) , V_110 ) ;
if ( ! V_33 )
return - V_111 ;
V_33 -> V_35 = V_35 ;
F_55 ( V_94 , V_33 ) ;
V_108 = F_56 ( V_103 , V_112 , 0 ) ;
V_38 = F_57 ( V_94 , V_108 ) ;
if ( F_58 ( V_38 ) ) {
F_59 ( V_94 , L_6 ) ;
return F_60 ( V_38 ) ;
}
...
V_33 -> V_114 = F_62 ( V_94 , NULL ) ;
if ( F_58 ( V_33 -> V_114 ) ) {
F_59 ( V_94 , L_8 ) ;
return F_60 ( V_33 -> V_114 ) ;
}
V_109 = F_63 ( V_33 -> V_114 ) ;
if ( V_109 ) {
F_59 ( V_94 , L_9 ) ;
return V_109 ;
}
V_33 -> V_115 = F_64 ( V_94 , NULL ) ;
if ( F_58 ( V_33 -> V_115 ) ) {
F_59 ( V_94 , L_10 ) ;
V_109 = F_60 ( V_33 -> V_115 ) ;
goto V_116;
}
F_65 ( V_33 -> V_115 ) ;
F_66 ( & V_33 -> V_3 ,
...
static void F_73 ( struct V_99 * V_94 , struct V_99 * V_100 ,
void * V_101 )
{
...
{
return F_76 ( & V_103 -> V_94 , & V_127 ) ;
}
static int F_77 ( struct V_102 * V_103 )
{
F_78 ( & V_103 -> V_94 , & V_127 ) ;
return 0 ;
}
