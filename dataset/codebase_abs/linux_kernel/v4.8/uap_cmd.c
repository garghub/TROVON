...
if ( V_65 -> V_206 &&
( ( ( V_65 -> V_207 & F_21 ( 0 ) ) == V_208 &&
V_65 -> V_206 <= V_209 ) ||
( ( V_65 -> V_207 & F_21 ( 0 ) ) == V_210 &&
V_65 -> V_206 <= V_211 ) ) ) {
...
static int F_23 ( T_1 * V_149 , void * V_138 , T_2 * V_244 )
{
struct V_245 * V_246 = V_138 ;
struct V_152 * V_247 = ( void * ) V_149 ;
if ( ! V_246 || ! V_246 -> V_122 )
return - 1 ;
* V_244 += F_5 ( V_246 -> V_122 ) +
sizeof( struct V_152 ) ;
V_247 -> type = F_8 ( V_248 ) ;
V_247 -> V_122 = V_246 -> V_122 ;
V_149 += sizeof( struct V_152 ) ;
memcpy ( V_149 , V_246 -> V_249 , F_5 ( V_246 -> V_122 ) ) ;
return 0 ;
}
static int
F_24 ( struct V_250 * V_251 , T_2 V_252 ,
T_3 type , void * V_138 )
{
T_1 * V_149 ;
...
int F_26 ( struct V_1 * V_2 , T_2 V_270 ,
T_2 V_252 , T_3 type ,
...
switch ( V_270 ) {
case V_256 :
if ( F_24 ( V_251 , V_252 , type , V_271 ) )
return - 1 ;
break;
case V_272 :
case V_273 :
...
break;
case V_292 :
if ( V_278 . V_297 < V_278 . V_282 -> V_283 )
V_65 -> V_207 |= V_298 ;
else
V_65 -> V_207 |= V_299 ;
break;
