...
T_4 time ;
time = F_24 ( 0 , 0 ) ;
time = F_25 ( time , F_26 ( V_51 + V_61 ) ) ;
F_27 ( & V_3 -> V_78 , time , V_82 ) ;
}
F_28 ( F_29 ( V_18 ) ) ;
return V_83 ;
}
static inline void
F_30 ( struct V_2 * V_3 , struct V_1 * V_12 ,
struct V_1 * V_84 )
{
...
T_2 V_51 ;
V_3 -> V_86 = NULL ;
V_51 = V_3 -> V_51 + F_32 ( & V_3 -> V_21 , V_87 ) ;
...
F_30 ( V_3 , V_11 , V_3 -> V_97 ) ;
}
static inline struct V_1 *
F_33 ( struct V_1 * V_12 )
{
struct V_2 * V_3 = F_6 ( V_12 -> V_43 ) ;
...
F_34 ( struct V_17 * V_18 , int V_23 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
...
V_12 -> V_67 . V_105 ++ ;
#else
V_53 -> V_67 . V_105 += F_35 ( V_10 ) ;
V_12 -> V_67 . V_105 += F_35 ( V_10 ) ;
#endif
}
V_3 -> V_88 = F_35 ( V_10 ) ;
if ( V_12 -> V_100 <= 0 ) {
...
static void F_43 ( struct V_2 * V_3 , int V_23 )
{
struct V_1 * V_12 ;
unsigned int V_108 ;
if ( V_3 -> V_109 [ V_23 ] == 0 )
...
F_44 (cl, &q->clhash.hash[h], common.hnode) {
if ( V_12 -> V_24 == V_23 ) {
V_12 -> V_102 = ( V_12 -> V_111 * V_12 -> V_112 * V_3 -> V_113 [ V_23 ] ) /
V_3 -> V_109 [ V_23 ] ;
}
if ( V_12 -> V_102 <= 0 ||
V_12 -> V_102 > 32 * F_45 ( V_12 -> V_43 ) -> V_114 ) {
F_46 ( L_1 ,
V_12 -> V_8 . V_4 , V_12 -> V_102 ) ;
V_12 -> V_102 = F_45 ( V_12 -> V_43 ) -> V_114 / 2 + 1 ;
}
}
}
}
...
static void F_48 ( struct V_1 * V_12 , T_1 V_118 , T_1 V_119 , T_1 V_120 )
{
...
static void F_49 ( struct V_1 * V_11 )
{
struct V_1 * V_12 , * * V_121 ;
struct V_2 * V_3 = F_6 ( V_11 -> V_43 ) ;
F_50 ( & V_3 -> V_7 , & V_11 -> V_8 ) ;
if ( V_11 -> V_13 ) {
V_121 = & V_11 -> V_107 ;
V_12 = * V_121 ;
do {
...
static int F_58 ( struct V_1 * V_12 , struct V_124 * V_125 )
{
...
static void F_60 ( struct V_2 * V_3 , struct V_1 * V_12 )
{
V_3 -> V_113 [ V_12 -> V_24 ] ++ ;
V_3 -> V_109 [ V_12 -> V_24 ] += V_12 -> V_111 ;
F_43 ( V_3 , V_12 -> V_24 ) ;
}
static int F_61 ( struct V_1 * V_12 , struct V_137 * V_138 )
{
struct V_2 * V_3 = F_6 ( V_12 -> V_43 ) ;
if ( V_138 -> V_112 )
...
static int F_62 ( struct V_1 * V_12 , struct V_140 * V_141 )
{
F_48 ( V_12 , V_141 -> V_115 , V_141 -> V_22 , V_141 -> V_142 ) ;
return 0 ;
}
static int F_63 ( struct V_17 * V_18 , struct V_143 * V_144 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_143 * V_145 [ V_146 + 1 ] ;
struct V_147 * V_148 ;
int V_149 ;
V_149 = F_64 ( V_145 , V_146 , V_144 , V_150 ) ;
if ( V_149 < 0 )
return V_149 ;
if ( V_145 [ V_151 ] == NULL || V_145 [ V_152 ] == NULL )
return - V_153 ;
V_148 = F_65 ( V_145 [ V_152 ] ) ;
if ( ( V_3 -> V_21 . V_154 = F_66 ( V_148 , V_145 [ V_151 ] ) ) == NULL )
return - V_153 ;
V_149 = F_67 ( & V_3 -> V_7 ) ;
if ( V_149 < 0 )
goto V_155;
...
V_3 -> V_21 . V_43 = V_18 ;
V_3 -> V_21 . V_3 = F_68 ( V_18 -> V_157 , & V_158 ,
V_18 -> V_29 ) ;
if ( ! V_3 -> V_21 . V_3 )
V_3 -> V_21 . V_3 = & V_159 ;
...
F_70 ( & V_3 -> V_79 , V_18 ) ;
F_71 ( & V_3 -> V_78 , V_162 , V_82 ) ;
V_3 -> V_78 . V_163 = F_22 ;
V_3 -> V_50 = V_70 ;
V_3 -> V_51 = F_14 () ;
F_52 ( & V_3 -> V_21 ) ;
if ( V_145 [ V_164 ] )
F_58 ( & V_3 -> V_21 , F_65 ( V_145 [ V_164 ] ) ) ;
F_60 ( V_3 , & V_3 -> V_21 ) ;
return 0 ;
V_155:
F_72 ( V_3 -> V_21 . V_154 ) ;
...
{
unsigned char * V_71 = F_74 ( V_10 ) ;
if ( F_75 ( V_10 , V_152 , sizeof( V_12 -> V_154 -> V_160 ) , & V_12 -> V_154 -> V_160 ) )
goto V_165;
return V_10 -> V_87 ;
V_165:
F_76 ( V_10 , V_71 ) ;
...
V_144 . V_126 = ~ 0 ;
if ( F_75 ( V_10 , V_164 , sizeof( V_144 ) , & V_144 ) )
goto V_165;
return V_10 -> V_87 ;
V_165:
F_76 ( V_10 , V_71 ) ;
...
if ( F_75 ( V_10 , V_166 , sizeof( V_144 ) , & V_144 ) )
goto V_165;
return V_10 -> V_87 ;
V_165:
F_76 ( V_10 , V_71 ) ;
...
V_144 . V_142 = ~ 0 ;
if ( F_75 ( V_10 , V_167 , sizeof( V_144 ) , & V_144 ) )
goto V_165;
}
return V_10 -> V_87 ;
V_165:
...
return F_86 ( V_171 , & V_3 -> V_21 . V_67 , sizeof( V_3 -> V_21 . V_67 ) ) ;
}
static int
...
F_91 ( V_171 , & V_12 -> V_91 , & V_12 -> V_179 ) < 0 ||
F_92 ( V_171 , NULL , & V_12 -> V_59 , V_12 -> V_3 -> V_3 . V_58 ) < 0 )
return - 1 ;
return F_86 ( V_171 , & V_12 -> V_67 , sizeof( V_12 -> V_67 ) ) ;
}
...
static void F_106 ( struct V_17 * V_18 , unsigned long V_172 )
{
struct V_1 * V_12 = (struct V_1 * ) V_172 ;
if ( -- V_12 -> V_156 == 0 ) {
#ifdef F_10
T_5 * V_185 = F_107 ( V_18 ) ;
struct V_2 * V_3 = F_6 ( V_18 ) ;
F_108 ( V_185 ) ;
if ( V_3 -> V_57 == V_12 )
V_3 -> V_57 = NULL ;
...
static int
F_110 ( struct V_17 * V_18 , T_1 V_4 , T_1 V_186 , struct V_143 * * V_187 ,
unsigned long * V_172 )
{
int V_149 ;
struct V_2 * V_3 = F_6 ( V_18 ) ;
...
if ( V_145 [ V_152 ] ) {
V_189 = F_66 ( F_65 ( V_145 [ V_152 ] ) ,
V_145 [ V_151 ] ) ;
if ( V_189 == NULL )
return - V_153 ;
}
if ( V_187 [ V_193 ] ) {
V_149 = F_111 ( & V_12 -> V_91 , NULL ,
& V_12 -> V_179 ,
NULL ,
F_90 ( V_18 ) ,
V_187 [ V_193 ] ) ;
...
if ( V_145 [ V_164 ] )
F_58 ( V_12 , F_65 ( V_145 [ V_164 ] ) ) ;
if ( V_145 [ V_166 ] ) {
F_59 ( V_3 , V_12 ) ;
F_61 ( V_12 , F_65 ( V_145 [ V_166 ] ) ) ;
}
if ( V_145 [ V_167 ] )
F_62 ( V_12 , F_65 ( V_145 [ V_167 ] ) ) ;
if ( V_12 -> V_3 -> V_3 . V_58 )
F_11 ( V_12 ) ;
F_113 ( V_18 ) ;
return 0 ;
...
V_145 [ V_164 ] == NULL )
return - V_153 ;
V_189 = F_66 ( F_65 ( V_145 [ V_152 ] ) , V_145 [ V_151 ] ) ;
if ( V_189 == NULL )
return - V_153 ;
if ( V_4 ) {
V_149 = - V_153 ;
...
V_149 = - V_181 ;
V_12 = F_115 ( sizeof( * V_12 ) , V_197 ) ;
if ( V_12 == NULL )
goto V_194;
if ( V_187 [ V_193 ] ) {
V_149 = F_116 ( & V_12 -> V_91 , NULL , & V_12 -> V_179 ,
NULL ,
F_90 ( V_18 ) ,
V_187 [ V_193 ] ) ;
if ( V_149 ) {
...
V_189 = NULL ;
V_12 -> V_156 = 1 ;
V_12 -> V_3 = F_68 ( V_18 -> V_157 , & V_158 , V_4 ) ;
if ( ! V_12 -> V_3 )
V_12 -> V_3 = & V_159 ;
V_12 -> V_8 . V_4 = V_4 ;
V_12 -> V_13 = V_122 ;
...
static int F_118 ( struct V_17 * V_18 , unsigned long V_172 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) V_172 ;
...
static struct V_25 T_6 * * F_121 ( struct V_17 * V_18 ,
unsigned long V_172 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) V_172 ;
...
static unsigned long F_122 ( struct V_17 * V_18 , unsigned long V_122 ,
T_1 V_4 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
...
static void F_123 ( struct V_17 * V_18 , unsigned long V_172 )
{
struct V_1 * V_12 = (struct V_1 * ) V_172 ;
V_12 -> V_182 -- ;
}
static void F_124 ( struct V_17 * V_18 , struct V_201 * V_172 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 ;
unsigned int V_108 ;
