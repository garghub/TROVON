...
V_215 -> V_220 = log -> V_139 ;
F_104 ( V_215 , V_26 -> V_206 , V_61 , V_26 -> V_205 ) ;
F_105 ( V_215 -> V_218 . V_221 != V_61 ) ;
V_215 -> V_222 = V_223 ;
V_215 -> V_224 = V_26 ;
F_106 ( V_215 , V_225 , V_226 ) ;
if ( log -> V_169 ) {
V_215 -> V_218 . V_221 = 0 ;
V_223 ( V_215 ) ;
} else {
...
log -> V_184 = V_26 ;
V_26 -> V_86 = V_228 -> V_86 ;
V_228 -> V_86 = V_26 ;
}
V_228 = V_26 ;
}
if ( ( V_26 != V_228 -> V_86 ) || ! ( V_45 & V_89 ) ) {
F_98 ( V_19 ) ;
return;
}
F_98 ( V_19 ) ;
...
F_96 ( V_19 ) ;
F_97 ( V_26 -> V_207 , ( V_26 -> V_116 & V_233 ) , V_19 ) ;
...
static void V_223 ( struct V_215 * V_215 )
{
struct V_25 * V_26 = V_215 -> V_224 ;
struct V_25 * V_80 , * V_228 ;
struct V_1 * log ;
unsigned long V_19 ;
...
int F_118 ( struct V_1 * log , T_3 V_238 , int V_239 )
{
int V_93 = - V_96 ;
struct V_3 * V_4 ;
struct V_170 * V_170 ;
...
struct V_25 * V_26 ;
F_5 ( L_45 ,
( long long ) V_238 , V_239 ) ;
V_4 = F_29 ( log -> V_152 . V_66 , struct V_3 , V_161 ) ;
V_26 = F_32 ( log , 1 ) ;
V_241 = V_239 >> V_4 -> V_242 ;
V_170 = (struct V_170 * ) V_26 -> V_42 ;
V_170 -> V_174 = F_33 ( V_175 ) ;
V_170 -> V_243 = F_33 ( V_244 ) ;
V_170 -> V_177 = F_33 ( V_178 ) ;
V_170 -> V_45 = F_33 ( V_4 -> V_141 ) ;
V_170 -> V_92 = F_33 ( V_241 ) ;
V_170 -> V_245 = F_33 ( V_4 -> V_245 ) ;
V_170 -> V_167 = F_33 ( V_4 -> V_167 ) ;
V_170 -> V_179 = F_33 ( 2 * V_61 + V_63 + V_67 ) ;
V_26 -> V_116 = V_89 | V_180 | V_229 ;
V_26 -> V_209 = V_238 + V_4 -> V_246 ;
F_109 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
V_28 = (struct V_27 * ) V_26 -> V_42 ;
V_28 -> V_81 . V_70 = V_28 -> V_88 . V_70 = F_33 ( V_241 - 3 ) ;
V_28 -> V_81 . V_43 = V_28 -> V_88 . V_43 = F_21 ( V_63 + V_67 ) ;
V_240 = (struct V_11 * ) & V_28 -> V_47 ;
V_240 -> V_130 = 0 ;
V_240 -> V_131 = 0 ;
V_240 -> type = F_21 ( V_132 ) ;
V_240 -> V_60 = 0 ;
V_240 -> log . V_129 . V_128 = 0 ;
V_26 -> V_209 += V_4 -> V_246 ;
V_26 -> V_116 = V_89 | V_180 | V_229 ;
F_109 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
for ( V_79 = 0 ; V_79 < V_241 - 3 ; V_79 ++ ) {
...
static int F_119 ( struct V_247 * V_248 , void * V_249 )
{
F_120 ( V_248 ,
L_46
L_47
