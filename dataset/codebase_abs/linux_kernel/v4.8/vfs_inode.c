...
if ( F_27 ( V_2 ) )
V_124 = F_65 ( V_138 , V_135 -> V_139 . V_54 ,
F_60 ( V_130 ) ) ;
if ( V_124 == - V_136 ) {
V_137 = F_66 ( V_135 ) ;
if ( F_56 ( V_137 ) )
...
struct V_135 * V_135 , char * V_28 , T_1 V_140 , T_4 V_3 )
{
int V_79 ;
char * V_54 ;
struct V_128 * V_138 , * V_141 , * V_129 ;
struct V_63 * V_63 ;
F_11 ( V_114 , L_10 , V_135 ) ;
V_79 = 0 ;
V_141 = NULL ;
V_129 = NULL ;
V_54 = ( char * ) V_135 -> V_139 . V_54 ;
V_138 = F_63 ( V_135 ) ;
if ( F_56 ( V_138 ) ) {
V_79 = F_64 ( V_138 ) ;
F_11 ( V_114 , L_9 , V_79 ) ;
...
V_63 = F_75 ( V_2 , V_129 , V_134 -> V_143 ) ;
if ( F_56 ( V_63 ) ) {
V_79 = F_64 ( V_63 ) ;
F_11 ( V_114 ,
L_13 , V_79 ) ;
...
struct V_128 * V_129 ;
V_129 = F_71 ( V_2 , V_134 , V_135 , NULL , V_140 , V_41 ) ;
if ( F_56 ( V_129 ) )
return F_64 ( V_129 ) ;
F_70 ( V_134 ) ;
F_41 ( V_129 ) ;
...
V_129 = F_71 ( V_2 , V_134 , V_135 , NULL , V_140 , V_37 ) ;
if ( F_56 ( V_129 ) ) {
V_79 = F_64 ( V_129 ) ;
V_129 = NULL ;
} else {
...
V_63 = F_82 ( V_2 , V_129 , V_134 -> V_143 ) ;
else
V_63 = F_75 ( V_2 , V_129 , V_134 -> V_143 ) ;
if ( F_56 ( V_63 ) ) {
F_41 ( V_129 ) ;
...
struct V_149 * V_149 , unsigned V_130 , T_2 V_3 ,
int * V_150 )
{
int V_79 ;
T_1 V_140 ;
...
if ( ! ( V_130 & V_152 ) || F_86 ( V_135 ) )
return F_87 ( V_149 , V_4 ) ;
V_79 = 0 ;
V_2 = F_43 ( V_134 ) ;
V_140 = F_1 ( V_2 , V_3 ) ;
V_129 = F_71 ( V_2 , V_134 , V_135 , NULL , V_140 ,
F_13 ( V_130 ,
F_3 ( V_2 ) ) ) ;
if ( F_56 ( V_129 ) ) {
V_79 = F_64 ( V_129 ) ;
...
F_90 ( & V_67 -> V_74 ) ;
V_79 = F_91 ( V_149 , V_135 , V_154 , V_150 ) ;
if ( V_79 )
goto error;
V_149 -> V_155 = V_129 ;
if ( V_2 -> V_95 == V_96 || V_2 -> V_95 == V_97 )
F_92 ( F_62 ( V_135 ) , V_149 ) ;
* V_150 |= V_156 ;
V_157:
F_93 ( V_4 ) ;
return V_79 ;
...
int F_94 ( struct V_63 * V_158 , struct V_135 * V_159 )
{
return F_61 ( V_158 , V_159 , 0 ) ;
}
int F_95 ( struct V_63 * V_158 , struct V_135 * V_159 )
{
return F_61 ( V_158 , V_159 , V_132 ) ;
}
int
F_96 ( struct V_63 * V_160 , struct V_135 * V_161 ,
struct V_63 * V_162 , struct V_135 * V_163 )
{
int V_124 ;
struct V_63 * V_164 ;
struct V_63 * F_31 ;
...
if ( F_56 ( V_165 ) )
return F_64 ( V_165 ) ;
V_166 = F_72 ( F_63 ( V_161 ) ) ;
if ( F_56 ( V_166 ) ) {
V_124 = F_64 ( V_166 ) ;
goto V_168;
}
V_167 = F_72 ( F_63 ( V_163 ) ) ;
if ( F_56 ( V_167 ) ) {
V_124 = F_64 ( V_167 ) ;
goto V_169;
}
F_98 ( & V_2 -> V_170 ) ;
if ( F_27 ( V_2 ) ) {
V_124 = F_99 ( V_166 , V_161 -> V_139 . V_54 ,
V_167 , V_163 -> V_139 . V_54 ) ;
if ( V_124 == - V_136 )
V_124 = F_100 ( V_165 , V_167 ,
V_163 -> V_139 . V_54 ) ;
if ( V_124 != - V_136 )
goto V_171;
}
if ( V_161 -> V_172 != V_163 -> V_172 ) {
F_11 ( V_31 , L_16 ) ;
V_124 = - V_173 ;
goto V_171;
}
...
static int
F_104 ( struct V_175 * V_176 , struct V_135 * V_135 ,
struct V_177 * V_17 )
{
struct V_1 * V_2 ;
struct V_128 * V_129 ;
...
static int F_107 ( struct V_135 * V_135 , struct V_179 * V_179 )
{
int V_124 ;
struct V_1 * V_2 ;
struct V_128 * V_129 ;
...
if ( F_109 ( V_135 ) )
F_110 ( F_62 ( V_135 ) -> V_86 ) ;
V_124 = F_101 ( V_129 , & V_46 ) ;
if ( V_124 < 0 )
return V_124 ;
if ( ( V_179 -> V_181 & V_189 ) &&
V_179 -> V_190 != F_111 ( F_62 ( V_135 ) ) )
F_112 ( F_62 ( V_135 ) , V_179 -> V_190 ) ;
F_70 ( F_62 ( V_135 ) ) ;
F_113 ( F_62 ( V_135 ) , V_179 ) ;
F_114 ( F_62 ( V_135 ) ) ;
return 0 ;
}
void
...
if ( ( F_116 ( V_63 -> V_94 ) ) || ( F_2 ( V_63 -> V_94 ) ) ) {
...
V_3 |= V_63 -> V_94 & ~ V_18 ;
V_63 -> V_94 = V_3 ;
F_117 ( V_63 , V_17 -> V_53 ) ;
V_63 -> V_80 = ( F_111 ( V_63 ) + 512 - 1 ) >> 9 ;
V_67 -> V_73 &= ~ V_201 ;
}
...
static const char * F_118 ( struct V_135 * V_135 ,
struct V_63 * V_63 ,
struct V_202 * V_168 )
{
struct V_1 * V_2 ;
...
F_58 ( V_121 ) ;
F_59 ( V_121 ) ;
F_119 ( V_168 , V_206 , V_4 ) ;
return V_4 ;
}
static int F_120 ( struct V_63 * V_134 , struct V_135 * V_135 ,
...
V_129 = F_71 ( V_2 , V_134 , V_135 , ( char * ) V_28 , V_140 ,
V_37 ) ;
if ( F_56 ( V_129 ) )
return F_64 ( V_129 ) ;
F_70 ( V_134 ) ;
...
static int
F_121 ( struct V_63 * V_134 , struct V_135 * V_135 , const char * V_207 )
{
F_11 ( V_114 , L_22 ,
V_134 -> V_125 , V_135 , V_207 ) ;
return F_120 ( V_134 , V_135 , V_21 , V_207 ) ;
}
static int
F_122 ( struct V_135 * V_161 , struct V_63 * V_134 ,
struct V_135 * V_135 )
{
int V_124 ;
char V_54 [ 1 + V_208 + 2 ] ;
struct V_128 * V_165 ;
F_11 ( V_114 , L_23 ,
V_134 -> V_125 , V_135 , V_161 ) ;
V_165 = F_66 ( V_161 ) ;
if ( F_56 ( V_165 ) )
return F_64 ( V_165 ) ;
sprintf ( V_54 , L_24 , V_165 -> V_129 ) ;
V_124 = F_120 ( V_134 , V_135 , V_142 , V_54 ) ;
if ( ! V_124 ) {
F_123 ( V_165 , F_62 ( V_161 ) ) ;
F_70 ( V_134 ) ;
}
F_41 ( V_165 ) ;
return V_124 ;
...
static int
F_124 ( struct V_63 * V_134 , struct V_135 * V_135 , T_2 V_3 , T_3 V_19 )
{
struct V_1 * V_2 = F_43 ( V_134 ) ;
int V_124 ;
...
if ( F_6 ( V_3 ) )
sprintf ( V_54 , L_26 , F_125 ( V_19 ) , F_126 ( V_19 ) ) ;
else if ( F_7 ( V_3 ) )
sprintf ( V_54 , L_27 , F_125 ( V_19 ) , F_126 ( V_19 ) ) ;
else
* V_54 = 0 ;
V_140 = F_1 ( V_2 , V_3 ) ;
V_124 = F_120 ( V_134 , V_135 , V_140 , V_54 ) ;
return V_124 ;
}
int F_123 ( struct V_128 * V_129 , struct V_63 * V_63 )
{
int V_120 ;
T_3 V_19 ;
T_7 V_209 ;
