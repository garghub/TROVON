...
V_10 -> V_77 . V_82 = 24 ;
V_10 -> V_77 . V_83 = 1 ;
V_10 -> V_77 . V_84 = F_37 ( V_2 -> V_10 -> V_15 , 0 ) ;
if ( V_2 -> V_18 == V_25 ||
V_2 -> V_18 == V_23 ||
V_2 -> V_18 == V_22 ||
V_2 -> V_18 == V_21 ||
...
F_43 ( V_10 ) ;
F_44 ( V_2 ) ;
F_45 ( V_10 -> V_15 , V_2 -> V_75 ) ;
F_45 ( V_10 -> V_15 , V_2 -> V_71 ) ;
F_17 ( V_2 ) ;
return 0 ;
}
...
struct V_57 * V_97 ;
T_4 V_98 ;
args -> V_99 = args -> V_100 * ( ( args -> V_101 + 7 ) / 8 ) ;
args -> V_87 = args -> V_99 * args -> V_102 ;
V_8 = F_46 ( V_10 , args -> V_87 , false ,
& V_97 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_50 ( V_95 , V_97 , & V_98 ) ;
F_21 ( V_97 ) ;
if ( V_8 )
return V_8 ;
args -> V_98 = V_98 ;
...
static void F_51 ( struct V_89 * * V_103 )
{
struct V_104 * V_105 ;
if ( ( * V_103 ) == NULL )
return;
...
void F_53 ( struct V_57 * V_54 )
{
struct V_89 * V_89 = F_54 ( V_54 ) ;
F_51 ( & V_89 ) ;
}
static inline T_5 F_55 ( struct V_89 * V_103 )
{
return F_56 ( & V_103 -> V_103 . V_106 ) ;
}
int
F_57 ( struct V_59 * V_95 ,
struct V_9 * V_10 ,
T_1 V_98 ,
T_6 * V_107 )
{
