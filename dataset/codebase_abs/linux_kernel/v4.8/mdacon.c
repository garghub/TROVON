...
static int F_38 ( struct V_40 * V_41 , int V_77 , int V_78 , int V_79 , int V_80 )
{
T_2 V_62 = F_27 ( V_41 -> V_63 ) ;
if ( ! V_80 )
return 0 ;
...
switch ( V_79 ) {
case V_81 :
F_39 ( F_31 ( 0 , V_77 ) , F_31 ( 0 , V_77 + V_80 ) ,
( V_78 - V_77 - V_80 ) * V_37 * 2 ) ;
F_34 ( F_31 ( 0 , V_78 - V_80 ) , V_62 ,
V_80 * V_37 * 2 ) ;
break;
case V_82 :
F_39 ( F_31 ( 0 , V_77 + V_80 ) , F_31 ( 0 , V_77 ) ,
( V_78 - V_77 - V_80 ) * V_37 * 2 ) ;
F_34 ( F_31 ( 0 , V_77 ) , V_62 , V_80 * V_37 * 2 ) ;
break;
}
return 0 ;
}
...
return 1 ;
F_41 () ;
V_83 = F_42 ( & V_84 , V_17 - 1 , V_18 - 1 , 0 ) ;
F_43 () ;
return V_83 ;
}
