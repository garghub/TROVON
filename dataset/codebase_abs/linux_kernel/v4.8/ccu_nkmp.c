...
for ( V_13 = 0 ; V_13 <= V_4 -> V_15 ; V_13 ++ ) {
unsigned long V_16 ;
F_2 ( V_2 / V_11 , V_1 >> V_13 ,
V_4 -> V_17 , V_4 -> V_18 ,
& V_10 , & V_12 ) ;
V_16 = ( V_1 * V_10 * V_11 >> V_13 ) / V_12 ;
if ( V_16 > V_2 )
continue;
if ( ( V_2 - V_16 ) < ( V_2 - V_5 ) ) {
V_5 = V_16 ;
...
V_33 . V_18 = 1 << V_4 -> V_21 . V_32 ;
V_33 . V_15 = ( 1 << V_4 -> V_22 . V_32 ) - 1 ;
F_1 ( * V_28 , V_2 ,
& V_33 ) ;
return ( * V_28 * V_33 . V_19 * V_33 . V_20 >> V_33 . V_22 ) / V_33 . V_21 ;
}
...
V_29 |= V_33 . V_22 << V_4 -> V_22 . V_31 ;
F_16 ( V_29 , V_4 -> V_26 . V_30 + V_4 -> V_26 . V_29 ) ;
F_17 ( V_4 -> V_26 . V_35 , V_34 ) ;
F_18 ( & V_4 -> V_26 , V_4 -> V_35 ) ;
return 0 ;
}
