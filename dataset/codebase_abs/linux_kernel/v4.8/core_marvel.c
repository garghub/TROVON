...
F_33 ( struct V_28 * V_29 , T_6 V_85 ,
unsigned int V_86 , int V_87 )
{
return ( V_29 -> V_41 | ( V_85 << 16 ) | ( V_86 << 8 ) | V_87 ) ;
}
static unsigned long
F_34 ( struct V_88 * V_89 , unsigned int V_86 , int V_87 )
{
...
V_90 = F_33 ( V_29 , V_85 , V_86 , V_87 ) ;
F_36 ( ( L_16 , V_90 ) ) ;
return V_90 ;
}
static int
F_37 ( struct V_88 * V_85 , unsigned int V_86 , int V_87 ,
int V_62 , T_7 * V_93 )
{
unsigned long V_90 ;
if ( 0 == ( V_90 = F_34 ( V_85 , V_86 , V_87 ) ) )
return V_94 ;
switch( V_62 ) {
case 1 :
* V_93 = F_38 ( * ( V_95 ) V_90 ) ;
...
static int
F_40 ( struct V_88 * V_85 , unsigned int V_86 , int V_87 ,
int V_62 , T_7 V_93 )
{
unsigned long V_90 ;
if ( 0 == ( V_90 = F_34 ( V_85 , V_86 , V_87 ) ) )
...
static T_6
F_46 ( T_6 V_107 , unsigned long V_90 , int V_108 )
{
static T_6 V_32 = 0 ;
struct V_102 V_103 ;
T_6 V_109 = 0 ;
...
case 0x71 :
V_103 . V_32 = V_32 ;
V_103 . V_106 = F_47 ( V_107 ) ;
V_103 . V_105 = 0x48 + ! V_108 ;
F_45 ( & V_103 ) ;
V_109 = F_48 ( V_103 . V_106 ) ;
break;
default:
F_6 ( V_12 L_21 , V_90 ) ;
break;
...
void T_13 *
F_49 ( unsigned long V_90 , unsigned long V_62 )
{
struct V_28 * V_29 ;
...
V_110 &= V_118 ;
V_62 = F_51 ( V_111 ) - V_110 ;
V_113 = F_52 ( V_62 , V_119 ) ;
if ( ! V_113 )
return NULL ;
V_64 = V_29 -> V_67 -> V_64 ;
...
void
F_56 ( volatile void T_13 * V_122 )
{
unsigned long V_90 = ( unsigned long ) V_122 ;
if ( V_90 >= V_123 )
F_53 ( ( void * ) ( V_118 & V_90 ) ) ;
}
int
F_57 ( const volatile void T_13 * V_122 )
{
unsigned long V_90 = ( unsigned long ) V_122 ;
if ( V_90 >= V_123 )
return 1 ;
...
void T_13 * F_58 ( unsigned long V_90 )
{
F_59 ( V_90 ) ;
return ( void T_13 * ) V_90 ;
}
unsigned int
F_60 ( void T_13 * V_122 )
{
unsigned long V_90 = ( unsigned long ) V_122 ;
if ( F_61 ( V_90 ) )
return 0 ;
else if ( F_62 ( V_90 ) )
return F_46 ( 0 , V_90 , 0 ) ;
else if ( F_63 ( V_90 ) )
return F_38 ( * ( V_95 ) V_90 ) ;
else
return ~ 0 ;
}
void
F_64 ( T_6 V_107 , void T_13 * V_122 )
{
unsigned long V_90 = ( unsigned long ) V_122 ;
if ( F_61 ( V_90 ) )
return;
...
F_41 ( V_107 , * ( V_95 ) V_90 ) ;
}
int
F_65 ( unsigned long V_124 )
{
int V_125 ;
if ( ( V_124 >> 43 ) & 1 )
V_125 = ( ~ ( V_124 >> 35 ) & 0xff ) ;
...
int V_138 ;
V_138 = F_73 ( V_129 -> V_133 , V_129 -> V_135 , V_129 -> V_134 ) ;
if ( V_138 == - V_139 ) {
F_6 ( V_12
L_25 ) ;
F_74 ( V_129 -> V_133 , V_129 -> V_135 , V_129 -> V_134 ) ;
V_138 = F_73 ( V_129 -> V_133 , V_129 -> V_135 ,
V_129 -> V_134 ) ;
}
if ( V_138 < 0 )
F_6 ( V_16 L_26 ) ;
...
static int
F_77 ( T_14 * V_127 , T_15 V_135 , struct V_151 * V_152 )
{
struct V_128 * V_129 = V_127 -> V_136 . V_34 ;
return F_78 ( V_129 -> V_133 , V_129 -> V_135 + V_135 ,
V_152 -> V_153 , V_152 -> V_154 ) ;
}
static int
F_79 ( T_14 * V_127 , T_15 V_135 , struct V_151 * V_152 )
{
struct V_128 * V_129 = V_127 -> V_136 . V_34 ;
return F_74 ( V_129 -> V_133 , V_129 -> V_135 + V_135 ,
V_152 -> V_153 ) ;
}
static unsigned long
F_80 ( T_14 * V_127 , T_8 V_90 )
{
struct V_128 * V_129 = V_127 -> V_136 . V_34 ;
...
V_90 = ( V_97 ) F_33 ( V_11 , 0 , F_35 ( 5 , 0 ) , 0 ) ;
if ( * V_90 != 0xffffffffu ) {
V_29 = V_11 ;
break;
}
