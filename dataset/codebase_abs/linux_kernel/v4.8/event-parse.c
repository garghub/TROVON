...
int F_186 ( struct V_208 * V_209 , struct V_126 * V_71 ,
...
void * F_187 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
int * V_140 , int V_185 )
{
struct V_126 * V_71 ;
...
int F_188 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
unsigned long long * V_170 , int V_185 )
{
struct V_126 * V_71 ;
...
return - 1 ;
V_71 = F_87 ( V_53 , V_72 ) ;
return F_186 ( V_209 , V_71 , V_72 , V_293 , V_170 , V_185 ) ;
}
...
int F_191 ( struct V_208 * V_209 , const char * V_50 ,
...
static struct V_52 * F_195 ( struct V_14 * V_14 , int V_56 ,
const char * V_349 ,
const char * V_350 )
{
struct V_52 * V_53 ;
...
int F_196 ( struct V_14 * V_14 , int V_56 ,
const char * V_349 , const char * V_350 ,
T_5 V_35 , void * V_315 )
{
struct V_52 * V_53 ;
struct V_351 * V_352 ;
V_53 = F_195 ( V_14 , V_56 , V_349 , V_350 ) ;
if ( V_53 == NULL )
goto V_381;
F_177 ( L_192 ,
V_53 -> V_56 , V_53 -> system , V_53 -> V_72 ) ;
...
static int F_197 ( struct V_351 * V_313 , int V_56 ,
const char * V_349 , const char * V_350 ,
T_5 V_35 , void * V_315 )
{
...
V_352 = * V_22 ;
if ( F_197 ( V_352 , V_56 , V_349 , V_350 ,
V_35 , V_315 ) )
break;
}
if ( ! ( * V_22 ) )
...
static void F_202 ( struct V_126 * V_71 )
{
struct V_126 * V_22 ;
while ( V_71 ) {
V_22 = V_71 -> V_22 ;
...
static void F_203 ( struct V_150 * V_150 )
{
F_202 ( V_150 -> V_151 ) ;
F_202 ( V_150 -> V_129 ) ;
}
