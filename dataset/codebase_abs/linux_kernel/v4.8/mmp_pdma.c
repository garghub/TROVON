...
F_16 ( & V_36 -> V_55 , V_39 ) ;
V_43 = V_36 -> V_91 ;
V_139 = V_43 -> V_48 . V_141 ;
V_140 = V_43 -> V_48 . V_142 ;
F_17 ( & V_36 -> V_55 , V_39 ) ;
if ( V_139 )
V_139 ( V_140 ) ;
return;
...
struct V_50 * V_143 = & V_43 -> V_48 ;
F_40 ( & V_43 -> V_46 ) ;
if ( V_143 -> V_141 )
V_143 -> V_141 ( V_143 -> V_142 ) ;
F_41 ( V_36 -> V_58 , V_43 , V_143 -> V_49 ) ;
}
}
static int F_67 ( struct V_144 * V_145 )
{
struct V_27 * V_28 = F_68 ( V_145 ) ;
struct V_1 * V_2 ;
int V_29 , V_22 = 0 , V_31 = 0 ;
for ( V_29 = 0 ; V_29 < V_28 -> V_32 ; V_29 ++ ) {
if ( F_69 ( V_145 , V_29 ) > 0 )
V_31 ++ ;
}
if ( V_31 != V_28 -> V_32 ) {
V_22 = F_69 ( V_145 , 0 ) ;
F_70 ( & V_145 -> V_21 , V_22 , V_28 ) ;
} else {
for ( V_29 = 0 ; V_29 < V_28 -> V_32 ; V_29 ++ ) {
V_2 = & V_28 -> V_2 [ V_29 ] ;
V_22 = F_69 ( V_145 , V_29 ) ;
F_70 ( & V_145 -> V_21 , V_22 , V_2 ) ;
}
}
F_71 ( & V_28 -> V_37 ) ;
return 0 ;
}
static int F_72 ( struct V_27 * V_28 , int V_5 , int V_22 )
{
struct V_1 * V_2 = & V_28 -> V_2 [ V_5 ] ;
struct V_33 * V_36 ;
int V_30 ;
V_36 = F_73 ( V_28 -> V_21 , sizeof( * V_36 ) , V_146 ) ;
if ( V_36 == NULL )
return - V_63 ;
V_2 -> V_5 = V_5 ;
V_2 -> V_7 = V_28 -> V_7 ;
if ( V_22 ) {
V_30 = F_74 ( V_28 -> V_21 , V_22 , F_10 ,
V_147 , L_10 , V_2 ) ;
if ( V_30 ) {
F_31 ( V_28 -> V_21 , L_11 ) ;
return V_30 ;
...
F_76 ( & V_36 -> V_25 , F_63 , ( unsigned long ) V_36 ) ;
F_32 ( & V_36 -> V_45 ) ;
F_32 ( & V_36 -> V_47 ) ;
F_47 ( & V_36 -> V_36 . V_148 , & V_28 -> V_37 . V_149 ) ;
return 0 ;
}
static struct V_61 * F_77 ( struct V_150 * V_151 ,
struct V_152 * V_153 )
{
struct V_27 * V_154 = V_153 -> V_155 ;
struct V_61 * V_36 ;
V_36 = F_78 ( & V_154 -> V_37 ) ;
if ( ! V_36 )
return NULL ;
F_25 ( V_36 ) -> V_10 = V_151 -> args [ 0 ] ;
return V_36 ;
}
static int F_79 ( struct V_144 * V_145 )
{
struct V_27 * V_28 ;
const struct V_156 * V_157 ;
struct V_158 * V_159 = F_80 ( & V_145 -> V_21 ) ;
struct V_160 * V_161 ;
int V_29 , V_30 , V_22 = 0 ;
int V_32 = 0 , V_31 = 0 ;
const enum V_105 V_162 =
V_117 | V_119 |
V_121 ;
V_28 = F_73 ( & V_145 -> V_21 , sizeof( * V_28 ) , V_146 ) ;
if ( ! V_28 )
return - V_63 ;
V_28 -> V_21 = & V_145 -> V_21 ;
F_75 ( & V_28 -> V_40 ) ;
V_161 = F_81 ( V_145 , V_163 , 0 ) ;
V_28 -> V_7 = F_82 ( V_28 -> V_21 , V_161 ) ;
if ( F_83 ( V_28 -> V_7 ) )
return F_84 ( V_28 -> V_7 ) ;
V_157 = F_85 ( V_164 , V_28 -> V_21 ) ;
if ( V_157 )
F_86 ( V_28 -> V_21 -> V_165 , L_12 ,
& V_32 ) ;
else if ( V_159 && V_159 -> V_32 )
V_32 = V_159 -> V_32 ;
else
V_32 = 32 ;
V_28 -> V_32 = V_32 ;
...
V_28 -> V_2 = F_87 ( V_28 -> V_21 , V_32 , sizeof( * V_28 -> V_2 ) ,
V_146 ) ;
if ( V_28 -> V_2 == NULL )
return - V_63 ;
F_32 ( & V_28 -> V_37 . V_149 ) ;
if ( V_31 != V_32 ) {
V_22 = F_69 ( V_145 , 0 ) ;
V_30 = F_74 ( V_28 -> V_21 , V_22 , F_12 ,
V_147 , L_10 , V_28 ) ;
if ( V_30 )
return V_30 ;
}
for ( V_29 = 0 ; V_29 < V_32 ; V_29 ++ ) {
V_22 = ( V_31 != V_32 ) ? 0 : F_69 ( V_145 , V_29 ) ;
V_30 = F_72 ( V_28 , V_29 , V_22 ) ;
if ( V_30 )
return V_30 ;
}
F_88 ( V_166 , V_28 -> V_37 . V_167 ) ;
F_88 ( V_168 , V_28 -> V_37 . V_167 ) ;
F_88 ( V_169 , V_28 -> V_37 . V_167 ) ;
F_88 ( V_170 , V_28 -> V_37 . V_167 ) ;
V_28 -> V_37 . V_21 = & V_145 -> V_21 ;
V_28 -> V_37 . V_171 = F_34 ;
V_28 -> V_37 . V_172 = F_42 ;
V_28 -> V_37 . V_173 = F_58 ;
V_28 -> V_37 . V_174 = F_44 ;
V_28 -> V_37 . V_175 = F_48 ;
V_28 -> V_37 . V_176 = F_52 ;
V_28 -> V_37 . V_177 = F_62 ;
V_28 -> V_37 . V_178 = F_53 ;
V_28 -> V_37 . V_179 = F_54 ;
V_28 -> V_37 . V_180 = V_181 ;
V_28 -> V_37 . V_182 = V_162 ;
V_28 -> V_37 . V_183 = V_162 ;
V_28 -> V_37 . V_184 = F_8 ( V_87 ) | F_8 ( V_88 ) ;
V_28 -> V_37 . V_185 = V_186 ;
if ( V_28 -> V_21 -> V_187 )
F_89 ( V_28 -> V_21 , V_28 -> V_21 -> V_187 ) ;
else
F_89 ( V_28 -> V_21 , F_90 ( 64 ) ) ;
V_30 = F_91 ( & V_28 -> V_37 ) ;
if ( V_30 ) {
...
if ( V_145 -> V_21 . V_165 ) {
V_30 = F_92 ( V_145 -> V_21 . V_165 ,
F_77 , V_28 ) ;
if ( V_30 < 0 ) {
F_31 ( & V_145 -> V_21 , L_14 ) ;
return V_30 ;
}
}
F_93 ( V_145 , V_28 ) ;
F_94 ( V_28 -> V_37 . V_21 , L_15 , V_32 ) ;
return 0 ;
}
bool F_95 ( struct V_61 * V_36 , void * V_188 )
{
struct V_33 * V_189 = F_25 ( V_36 ) ;
if ( V_36 -> V_37 -> V_21 -> V_190 != & V_191 . V_190 )
return false ;
V_189 -> V_10 = * ( unsigned int * ) V_188 ;
return true ;
}
