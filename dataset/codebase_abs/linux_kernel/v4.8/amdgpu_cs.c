...
if ( V_142 ) {
V_25 -> V_81 -> V_149 = F_46 ( V_142 ) ;
V_25 -> V_81 -> V_150 = F_47 ( V_142 ) ;
}
}
if ( V_25 -> V_33 . V_34 )
V_25 -> V_81 -> V_83 += F_46 ( V_25 -> V_33 . V_34 ) ;
V_135:
if ( V_95 ) {
...
struct V_151 * V_152 = V_117 -> V_34 -> V_38 . V_152 ;
V_95 = F_51 ( V_25 -> V_2 , & V_25 -> V_81 -> V_153 , V_152 , V_25 -> V_31 ) ;
if ( V_95 )
return V_95 ;
}
return 0 ;
}
static void F_52 ( struct V_24 * V_154 , int error , bool V_155 )
{
struct V_42 * V_43 = V_154 -> V_31 -> V_44 ;
unsigned V_54 ;
if ( ! error ) {
F_48 ( V_154 -> V_2 , & V_43 -> V_46 ) ;
F_53 ( & V_154 -> V_129 ,
& V_154 -> V_91 ,
V_154 -> V_156 ) ;
} else if ( V_155 ) {
...
if ( V_154 -> V_121 )
F_55 ( V_154 -> V_121 ) ;
for ( V_54 = 0 ; V_54 < V_154 -> V_67 ; V_54 ++ )
F_17 ( V_154 -> V_64 [ V_54 ] . V_77 ) ;
F_16 ( V_154 -> V_64 ) ;
if ( V_154 -> V_81 )
F_56 ( V_154 -> V_81 ) ;
F_9 ( & V_154 -> V_33 . V_34 ) ;
...
if ( V_95 )
return V_95 ;
V_95 = F_59 ( V_2 , & V_25 -> V_81 -> V_153 , V_46 -> V_158 ) ;
if ( V_95 )
return V_95 ;
V_95 = F_60 ( V_2 , V_46 ) ;
if ( V_95 )
...
if ( ! V_37 )
continue;
V_144 = V_25 -> V_121 -> V_131 [ V_54 ] . V_144 ;
if ( V_144 == NULL )
continue;
V_95 = F_61 ( V_2 , V_144 , & V_37 -> V_38 . V_160 ) ;
if ( V_95 )
return V_95 ;
V_159 = V_144 -> V_161 ;
V_95 = F_59 ( V_2 , & V_25 -> V_81 -> V_153 , V_159 ) ;
if ( V_95 )
return V_95 ;
}
}
V_95 = F_62 ( V_2 , V_46 , & V_25 -> V_81 -> V_153 ) ;
if ( V_162 && V_25 -> V_121 ) {
for ( V_54 = 0 ; V_54 < V_25 -> V_121 -> V_124 ; V_54 ++ ) {
V_37 = V_25 -> V_121 -> V_131 [ V_54 ] . V_34 ;
if ( ! V_37 )
...
V_25 -> V_81 -> V_165 = F_46 ( V_46 -> V_166 ) ;
V_95 = F_57 ( V_25 , V_46 ) ;
if ( V_95 )
return V_95 ;
}
...
int V_54 , V_168 ;
int V_95 ;
for ( V_54 = 0 , V_168 = 0 ; V_54 < V_154 -> V_67 && V_168 < V_154 -> V_81 -> V_52 ; V_54 ++ ) {
struct V_68 * V_169 ;
struct V_170 * V_171 ;
struct V_172 * V_173 ;
struct V_6 * V_5 ;
V_169 = & V_154 -> V_64 [ V_54 ] ;
V_171 = & V_154 -> V_81 -> V_174 [ V_168 ] ;
V_173 = (struct V_172 * ) V_169 -> V_77 ;
if ( V_169 -> V_74 != V_78 )
continue;
V_95 = F_1 ( V_2 , V_173 -> V_3 ,
V_173 -> V_4 , V_173 -> V_5 ,
& V_5 ) ;
if ( V_95 )
return V_95 ;
if ( V_154 -> V_81 -> V_5 && V_154 -> V_81 -> V_5 != V_5 )
return - V_8 ;
V_154 -> V_81 -> V_5 = V_5 ;
if ( V_5 -> V_163 -> V_164 ) {
struct V_175 * V_176 ;
struct V_96 * V_177 = NULL ;
T_3 V_28 ;
T_6 * V_178 ;
V_176 = F_69 ( V_154 , V_173 -> va_start ,
& V_177 ) ;
if ( ! V_177 ) {
F_2 ( L_7 ) ;
return - V_8 ;
}
if ( ( V_173 -> va_start + V_173 -> V_179 ) >
( V_176 -> V_180 . V_181 + 1 ) * V_182 ) {
F_2 ( L_8 ) ;
return - V_8 ;
}
V_95 = F_70 ( V_177 , ( void * * ) & V_178 ) ;
if ( V_95 ) {
return V_95 ;
}
V_28 = ( ( T_3 ) V_176 -> V_180 . V_183 ) * V_182 ;
V_178 += V_173 -> va_start - V_28 ;
V_95 = F_71 ( V_2 , NULL , V_173 -> V_179 , V_171 ) ;
if ( V_95 ) {
F_2 ( L_9 ) ;
return V_95 ;
}
memcpy ( V_171 -> V_184 , V_178 , V_173 -> V_179 ) ;
F_72 ( V_177 ) ;
} else {
V_95 = F_71 ( V_2 , V_46 , 0 , V_171 ) ;
if ( V_95 ) {
F_2 ( L_9 ) ;
return V_95 ;
}
V_171 -> V_185 = V_173 -> va_start ;
}
V_171 -> V_75 = V_173 -> V_179 / 4 ;
V_171 -> V_186 = V_173 -> V_186 ;
V_168 ++ ;
}
if ( V_154 -> V_81 -> V_83 && (
V_154 -> V_81 -> V_5 -> type == V_187 ||
V_154 -> V_81 -> V_5 -> type == V_188 ) )
return - V_8 ;
return 0 ;
}
...
struct V_68 * V_169 ;
unsigned V_191 ;
V_169 = & V_25 -> V_64 [ V_54 ] ;
if ( V_169 -> V_74 != V_80 )
continue;
V_190 = (struct V_189 * ) V_169 -> V_77 ;
V_191 = V_169 -> V_75 * 4 /
sizeof( struct V_189 ) ;
...
struct V_192 * V_60 ;
struct V_156 * V_156 ;
V_95 = F_1 ( V_2 , V_190 [ V_168 ] . V_3 ,
V_190 [ V_168 ] . V_4 ,
V_190 [ V_168 ] . V_5 , & V_5 ) ;
if ( V_95 )
return V_95 ;
V_60 = F_12 ( V_43 , V_190 [ V_168 ] . V_61 ) ;
if ( V_60 == NULL )
return - V_8 ;
V_156 = F_74 ( V_60 , V_5 ,
V_190 [ V_168 ] . V_32 ) ;
...
{
struct V_6 * V_5 = V_25 -> V_81 -> V_5 ;
struct V_193 * V_194 = & V_25 -> V_60 -> V_195 [ V_5 -> V_196 ] . V_194 ;
struct V_197 * V_81 ;
int V_95 ;
V_81 = V_25 -> V_81 ;
V_25 -> V_81 = NULL ;
V_95 = F_78 ( & V_81 -> V_198 , & V_5 -> V_199 , V_194 , V_25 -> V_31 ) ;
if ( V_95 ) {
F_56 ( V_81 ) ;
return V_95 ;
}
V_81 -> V_200 = V_25 -> V_31 ;
V_81 -> V_60 = V_194 -> V_201 ;
V_25 -> V_156 = F_79 ( & V_81 -> V_198 . V_202 -> V_203 ) ;
V_48 -> V_204 . V_32 = F_80 ( V_25 -> V_60 , V_5 , V_25 -> V_156 ) ;
V_81 -> V_205 = V_48 -> V_204 . V_32 ;
F_81 ( V_81 ) ;
F_82 ( V_81 ) ;
F_83 ( & V_81 -> V_198 ) ;
return 0 ;
}
int F_84 ( struct V_206 * V_207 , void * V_27 , struct V_208 * V_31 )
{
struct V_1 * V_2 = V_207 -> V_209 ;
union V_47 * V_48 = V_27 ;
struct V_24 V_154 = {} ;
bool V_210 = false ;
int V_54 , V_95 ;
...
V_154 . V_2 = V_2 ;
V_154 . V_31 = V_31 ;
V_95 = F_10 ( & V_154 , V_27 ) ;
if ( V_95 ) {
F_2 ( L_10 ) ;
F_52 ( & V_154 , V_95 , false ) ;
V_95 = F_66 ( V_2 , V_95 ) ;
return V_95 ;
}
V_95 = F_27 ( & V_154 , V_27 ) ;
if ( V_95 == - V_59 )
F_2 ( L_11 ) ;
...
if ( V_95 )
goto V_204;
for ( V_54 = 0 ; V_54 < V_154 . V_81 -> V_52 ; V_54 ++ )
F_85 ( & V_154 , V_54 ) ;
V_95 = F_64 ( V_2 , & V_154 ) ;
if ( V_95 )
goto V_204;
V_95 = F_77 ( & V_154 , V_48 ) ;
V_204:
F_52 ( & V_154 , V_95 , V_210 ) ;
V_95 = F_66 ( V_2 , V_95 ) ;
return V_95 ;
}
int F_86 ( struct V_206 * V_207 , void * V_27 ,
struct V_208 * V_31 )
{
union V_213 * V_214 = V_27 ;
struct V_1 * V_2 = V_207 -> V_209 ;
unsigned long V_215 = F_87 ( V_214 -> V_56 . V_215 ) ;
struct V_6 * V_5 = NULL ;
struct V_192 * V_60 ;
struct V_156 * V_156 ;
long V_95 ;
V_95 = F_1 ( V_2 , V_214 -> V_56 . V_3 , V_214 -> V_56 . V_4 ,
V_214 -> V_56 . V_5 , & V_5 ) ;
if ( V_95 )
return V_95 ;
V_60 = F_12 ( V_31 -> V_44 , V_214 -> V_56 . V_61 ) ;
if ( V_60 == NULL )
return - V_8 ;
V_156 = F_74 ( V_60 , V_5 , V_214 -> V_56 . V_32 ) ;
if ( F_75 ( V_156 ) )
V_95 = F_76 ( V_156 ) ;
else if ( V_156 ) {
V_95 = F_88 ( V_156 , true , V_215 ) ;
F_54 ( V_156 ) ;
} else
V_95 = 1 ;
F_18 ( V_60 ) ;
...
V_214 -> V_204 . V_216 = ( V_95 == 0 ) ;
return 0 ;
}
struct V_175 *
F_69 ( struct V_24 * V_154 ,
T_3 V_217 , struct V_96 * * V_37 )
{
struct V_175 * V_218 ;
unsigned V_54 ;
if ( ! V_154 -> V_121 )
return NULL ;
V_217 /= V_182 ;
for ( V_54 = 0 ; V_54 < V_154 -> V_121 -> V_124 ; V_54 ++ ) {
struct V_92 * V_93 ;
V_93 = & V_154 -> V_121 -> V_131 [ V_54 ] ;
if ( ! V_93 -> V_144 )
continue;
F_23 (mapping, &lobj->bo_va->valids, list) {
if ( V_218 -> V_180 . V_183 > V_217 ||
V_217 > V_218 -> V_180 . V_181 )
continue;
* V_37 = V_93 -> V_144 -> V_37 ;
return V_218 ;
}
