...
V_4 -> V_46 - F_13 ( & V_2 -> V_47 ) ;
V_24 = F_14 ( V_4 ) + V_4 -> V_46 -
F_13 ( & V_2 -> V_47 ) ;
...
V_37 = * V_4 ;
V_37 . V_49 = F_15 ( V_37 . V_50 ) ;
if ( V_2 -> V_35 . V_51 . V_52 ) {
V_37 . V_49 = F_16 ( V_2 -> V_35 . V_53 ,
V_37 . V_49 ) ;
} else {
V_27 = V_2 -> V_27 ;
V_37 . V_49 = F_16 ( V_2 -> V_35 . V_53 ,
...
struct V_1 * V_2 =
(struct V_1 * ) V_4 -> V_20 ;
F_24 ( V_2 -> V_22 -> V_68 != V_4 -> V_61 -> V_62 ) ;
( void ) F_25 ( V_2 ) ;
}
...
struct V_1 * V_2 = NULL ;
F_29 ( & V_22 -> V_71 ) ;
V_70 = F_30 ( & V_22 -> V_71 , V_58 , V_59 ) ;
if ( F_2 ( V_70 ) ) {
V_2 = F_31 ( V_70 , struct V_1 , V_47 ) ;
if ( ! F_32 ( & V_2 -> V_72 ) )
V_2 = NULL ;
}
F_33 ( & V_22 -> V_71 ) ;
...
int F_35 ( struct V_73 * V_74 , struct V_3 * V_4 ,
struct V_21 * V_22 )
{
struct V_75 * V_41 ;
struct V_1 * V_2 ;
int V_7 ;
V_2 = F_28 ( V_22 , V_4 -> V_46 , F_14 ( V_4 ) ) ;
if ( F_6 ( ! V_2 ) )
return - V_76 ;
V_41 = V_2 -> V_22 -> V_41 ;
if ( F_6 ( ! V_41 -> V_77 ) ) {
