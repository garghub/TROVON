...
unsigned int V_35 [] , struct V_36 * V_37 [] )
{
struct V_5 * V_6 = F_17 ( V_32 ) ;
struct V_38 * V_16 = & V_6 -> V_16 ;
int V_39 = V_40 [ V_6 -> V_41 ] . V_42 * V_16 -> V_20 / 8 ;
F_18 ( V_6 -> V_43 . V_44 , L_1 , V_45 ) ;
if ( * V_34 )
return V_35 [ 0 ] < V_16 -> V_21 * V_39 ? - V_46 : 0 ;
* V_34 = 1 ;
V_35 [ 0 ] = V_16 -> V_21 * V_39 ;
return 0 ;
}
...
struct V_38 * V_16 = & V_6 -> V_16 ;
unsigned V_39 = V_40 [ V_6 -> V_41 ] . V_42 * V_16 -> V_20 / 8 ;
unsigned V_48 = V_16 -> V_21 * V_39 ;
F_18 ( V_6 -> V_43 . V_44 , L_1 , V_45 ) ;
if ( F_20 ( V_4 , 0 ) < V_48 ) {
F_21 ( V_6 -> V_43 . V_44 , L_2 ,
F_20 ( V_4 , 0 ) , V_48 ) ;
return - V_46 ;
}
F_22 ( V_4 , 0 , V_48 ) ;
...
{
struct V_5 * V_6 = F_37 ( V_73 ) ;
if ( V_87 -> V_88 >= F_40 ( V_40 ) )
return - V_46 ;
F_18 ( V_6 -> V_43 . V_44 , L_1 , V_45 ) ;
V_87 -> type = V_89 ;
F_38 ( V_87 -> V_90 , V_40 [ V_87 -> V_88 ] . V_91 ,
sizeof( V_87 -> V_90 ) ) ;
V_87 -> V_17 = V_40 [ V_87 -> V_88 ] . V_92 ;
return 0 ;
}
...
int V_41 , int V_94 , int V_95 )
{
struct V_96 * V_87 = V_40 + V_41 ;
...
F_18 ( V_6 -> V_43 . V_44 , L_8 , V_87 -> V_91 , V_105 ) ;
F_5 ( V_6 , V_119 , V_105 ) ;
F_5 ( V_6 , V_120 ,
...
{
struct V_5 * V_6 = F_37 ( V_73 ) ;
struct V_38 * V_16 = & V_87 -> V_87 . V_16 ;
unsigned int V_129 ;
int V_41 ;
F_18 ( V_6 -> V_43 . V_44 , L_1 , V_45 ) ;
V_16 -> V_148 = V_149 ;
...
for ( V_41 = 0 ; V_41 < F_40 ( V_40 ) ; V_41 ++ )
if ( V_40 [ V_41 ] . V_92 == V_16 -> V_17 )
break;
if ( V_41 == F_40 ( V_40 ) )
return - V_46 ;
if ( V_6 -> V_108 & V_109 )
...
& V_16 -> V_21 ,
V_135 , V_129 , 1 , 0 ) ;
V_16 -> V_154 = V_16 -> V_20 * V_40 [ V_41 ] . V_155 ;
V_16 -> V_156 = V_16 -> V_21 * ( ( V_16 -> V_20 * V_40 [ V_41 ] . V_42 ) >> 3 ) ;
return 0 ;
}
...
V_57 = F_29 ( & V_6 -> V_43 , 0 , V_167 ,
V_168 , NULL , & V_158 ) ;
if ( V_57 < 0 )
return V_57 ;
F_18 ( V_6 -> V_43 . V_44 , L_11 , V_45 ,
...
struct V_5 * V_6 = F_37 ( V_73 ) ;
int V_57 ;
F_18 ( V_6 -> V_43 . V_44 , L_15 , V_45 , V_182 ) ;
if ( V_182 == V_6 -> V_108 )
return 0 ;
if ( F_49 ( & V_6 -> V_165 ) )
return - V_166 ;
V_57 = F_29 ( & V_6 -> V_43 , 0 , V_59 ,
V_183 , V_182 ) ;
if ( V_57 < 0 && V_57 != - V_61 )
return V_57 ;
...
V_6 -> V_16 . V_154 =
V_6 -> V_16 . V_20 * V_40 [ V_6 -> V_41 ] . V_155 ;
V_6 -> V_16 . V_156 = V_6 -> V_16 . V_21 *
( ( V_6 -> V_16 . V_20 * V_40 [ V_6 -> V_41 ] . V_42 ) >> 3 ) ;
V_6 -> V_108 = V_182 ;
F_48 ( V_6 , & V_6 -> V_16 ) ;
return 0 ;
}
...
if ( ! V_130 )
return - V_215 ;
F_18 ( V_6 -> V_43 . V_44 , L_39 , 100 - V_130 ) ;
if ( V_185 -> V_50 & V_216 )
V_214 |= 1 << 28 ;
if ( V_185 -> V_50 & V_217 )
V_214 |= 1 << 27 ;
...
{
struct V_213 * V_227 = V_226 -> V_44 . V_228 ;
struct V_103 * V_104 ;
struct V_38 * V_16 ;
struct V_229 * V_230 ;
struct V_231 * V_175 ;
...
F_85 ( & V_226 -> V_44 , L_40 ) ;
return - V_238 ;
}
V_6 = F_86 ( & V_226 -> V_44 , sizeof( * V_6 ) , V_239 ) ;
if ( ! V_6 )
return - V_240 ;
F_87 ( & V_6 -> V_53 ) ;
F_88 ( & V_6 -> V_51 ) ;
...
V_16 -> V_150 = V_151 ;
V_6 -> V_9 = F_90 ( & V_226 -> V_44 , V_233 ) ;
if ( F_91 ( V_6 -> V_9 ) )
return F_92 ( V_6 -> V_9 ) ;
V_57 = F_93 ( & V_226 -> V_44 , V_201 , F_62 , 0 , L_41 , V_6 ) ;
if ( V_57 < 0 )
return V_57 ;
V_57 = F_94 ( & V_226 -> V_44 , & V_6 -> V_43 ) ;
if ( V_57 < 0 ) {
F_85 ( & V_226 -> V_44 , L_42 ) ;
return V_57 ;
}
V_175 = & V_6 -> V_175 ;
* V_175 = V_242 ;
...
if ( V_57 < 0 )
goto V_260;
V_235 = F_100 ( & V_6 -> V_43 , V_230 ,
V_227 -> V_261 , NULL ) ;
if ( ! V_235 ) {
V_57 = - V_240 ;
goto V_262;
}
V_57 = F_101 ( V_175 , V_263 , - 1 ) ;
if ( V_57 < 0 )
goto V_264;
return 0 ;
V_264:
...
{
struct V_265 * V_43 = F_106 ( V_226 ) ;
struct V_5 * V_6 = F_2 ( V_43 ,
struct V_5 , V_43 ) ;
struct V_234 * V_266 = F_33 ( V_43 -> V_267 . V_64 ,
struct V_234 , V_52 ) ;
struct V_268 * V_269 = F_107 ( V_266 ) ;
F_103 ( & V_226 -> V_44 ) ;
F_108 ( & V_6 -> V_175 ) ;
F_102 ( V_269 -> V_270 ) ;
F_104 ( & V_6 -> V_43 ) ;
