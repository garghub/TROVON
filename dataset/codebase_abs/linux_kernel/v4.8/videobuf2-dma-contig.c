...
V_34 -> V_38 = 0 ;
V_35 = F_29 ( V_11 -> V_18 , V_34 , V_11 -> V_22 ,
...
static int F_32 ( struct V_48 * V_49 , struct V_24 * V_18 ,
struct V_50 * V_51 )
{
struct V_52 * V_53 ;
unsigned int V_7 ;
...
int V_35 ;
V_53 = F_21 ( sizeof( * V_53 ) , V_27 ) ;
if ( ! V_53 )
return - V_28 ;
V_2 = & V_53 -> V_2 ;
V_35 = F_33 ( V_2 , V_11 -> V_21 -> V_19 , V_27 ) ;
if ( V_35 ) {
F_17 ( V_53 ) ;
return - V_28 ;
}
...
int V_35 ;
struct V_1 * V_2 ;
V_2 = F_49 ( sizeof( * V_2 ) , V_27 ) ;
if ( ! V_2 ) {
F_24 ( V_11 -> V_18 , L_6 ) ;
return NULL ;
}
V_35 = F_50 ( V_11 -> V_18 , V_2 , V_11 -> V_22 , V_11 -> V_12 ,
V_11 -> V_8 , V_11 -> V_23 ) ;
if ( V_35 < 0 ) {
F_24 ( V_11 -> V_18 , L_7 ) ;
F_17 ( V_2 ) ;
...
{
if ( ! V_18 -> V_92 ) {
V_18 -> V_92 = F_21 ( sizeof( * V_18 -> V_92 ) , V_27 ) ;
if ( ! V_18 -> V_92 )
return - V_28 ;
}
if ( F_86 ( V_18 ) < V_8 )
