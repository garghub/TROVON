...
static void F_302 ( int V_288 ,
struct V_483 * V_84 ,
void * V_121 )
{
struct V_484 * V_485 = V_121 ;
F_303 ( ! V_121 ) ;
if ( V_288 || ! V_84 ) {
F_304 ( L_8 ,
V_485 -> V_31 -> V_349 , V_485 -> V_71 , V_288 ) ;
goto V_108;
}
memcpy ( V_485 -> V_486 , V_84 , sizeof( struct V_483 ) ) ;
V_108:
F_41 ( & V_485 -> V_487 ) ;
}
static int F_305 ( struct V_38 * V_31 , T_4 V_71 ,
struct V_483 * V_486 )
{
struct V_484 * V_485 ;
int V_44 ;
V_485 = F_190 ( sizeof( * V_485 ) , V_23 ) ;
if ( ! V_485 )
return - V_124 ;
V_485 -> V_31 = V_31 ;
V_485 -> V_486 = V_486 ;
...
V_84 . V_82 = F_308 ( V_40 -> V_82 ) ;
F_217 ( V_66 , & V_84 . V_490 ) ;
V_84 . V_113 = F_219 ( F_103 ( V_66 ) ) ;
V_84 . V_491 = V_74 -> V_491 ;
if ( V_84 . V_491 == F_309 ( V_492 ) ) {
V_44 = F_305 ( V_40 -> V_63 . V_31 ,
V_40 -> V_63 . V_71 ,
& V_486 ) ;
if ( V_44 )
return V_44 ;
...
V_505 |
V_506 ;
V_74 -> V_76 . V_77 = F_311 ( & V_374 , V_40 -> V_63 . V_31 ,
V_40 -> V_63 . V_71 , & V_84 ,
V_359 , V_23 ,
F_296 , V_74 ) ;
return F_312 ( V_74 -> V_76 . V_77 ) ;
}
static void F_313 ( struct V_375 * V_352 )
{
struct V_507 * V_508 = F_43 ( V_352 , struct V_507 , V_352 ) ;
struct V_73 * V_74 = V_508 -> V_74 ;
struct V_475 * V_509 = V_74 -> V_76 . V_77 ;
V_74 -> V_76 . V_77 -> V_121 = V_74 ;
F_296 ( 0 , V_509 ) ;
F_178 ( & V_74 -> V_75 , F_42 ) ;
F_44 ( V_508 ) ;
}
static void F_314 ( struct V_78 * V_65 , union V_54 * V_55 )
{
struct V_174 * sin = (struct V_174 * ) V_65 ;
struct V_178 * V_360 = (struct V_178 * ) V_65 ;
if ( F_116 ( V_65 ) ) {
...
static int F_315 ( struct V_39 * V_40 ,
struct V_73 * V_74 )
{
struct V_507 * V_352 ;
struct V_88 * V_66 = & V_40 -> V_63 . V_64 . V_65 . V_66 ;
...
F_314 ( V_65 , & V_74 -> V_76 . V_77 -> V_84 . V_55 ) ;
V_74 -> V_76 . V_77 -> V_84 . V_113 = F_219 ( 0xffff ) ;
if ( V_40 -> V_63 . V_10 == V_14 )
V_74 -> V_76 . V_77 -> V_84 . V_82 = F_308 ( V_85 ) ;
if ( V_66 -> V_107 )
...
if ( V_65 -> V_93 == V_173 ) {
if ( V_62 == V_513 ) {
V_74 -> V_76 . V_77 -> V_84 . V_393 = V_514 ;
if ( ! V_510 ) {
...
F_68 ( (struct V_78 * ) & V_40 -> V_63 . V_64 . V_65 . V_79 ,
& V_74 -> V_76 . V_77 -> V_84 . V_490 ) ;
V_352 -> V_63 = V_40 ;
V_352 -> V_74 = V_74 ;
F_224 ( & V_352 -> V_352 , F_313 ) ;
F_316 ( & V_74 -> V_75 ) ;
F_215 ( V_357 , & V_352 -> V_352 ) ;
return 0 ;
V_512:
...
int F_317 ( struct V_119 * V_63 , struct V_78 * V_65 ,
T_4 V_491 , void * V_121 )
{
struct V_39 * V_40 ;
struct V_73 * V_74 ;
int V_44 ;
...
V_74 -> V_491 = V_491 ;
F_318 ( & V_40 -> V_30 ) ;
F_319 ( & V_74 -> V_69 , & V_40 -> V_131 ) ;
F_320 ( & V_40 -> V_30 ) ;
if ( F_62 ( V_63 -> V_31 , V_63 -> V_71 ) ) {
F_321 ( & V_74 -> V_75 ) ;
V_44 = F_315 ( V_40 , V_74 ) ;
...
void F_324 ( struct V_119 * V_63 , struct V_78 * V_65 )
{
struct V_39 * V_40 ;
struct V_73 * V_74 ;
V_40 = F_43 ( V_63 , struct V_39 , V_63 ) ;
...
static int F_326 ( struct V_52 * V_53 , struct V_39 * V_40 )
{
struct V_88 * V_66 ;
struct V_378 * V_352 ;
...
memcmp ( V_66 -> V_106 , V_53 -> V_66 , V_53 -> V_516 ) ) {
F_64 ( L_12 ,
...
static int F_327 ( struct V_518 * V_519 , unsigned long V_2 ,
void * V_520 )
{
struct V_52 * V_53 = F_328 ( V_520 ) ;
struct V_24 * V_25 ;
struct V_39 * V_40 ;
int V_44 = V_521 ;
if ( V_2 != V_522 )
return V_521 ;
if ( ! ( V_53 -> V_43 & V_523 ) || ! ( V_53 -> V_383 & V_524 ) )
return V_521 ;
F_14 ( & V_30 ) ;
F_15 (cma_dev, &dev_list, list)
F_15 (id_priv, &cma_dev->id_list, list) {
V_44 = F_326 ( V_53 , V_40 ) ;
if ( V_44 )
goto V_108;
}
V_108:
...
static void F_329 ( struct V_38 * V_31 )
{
struct V_24 * V_25 ;
struct V_39 * V_40 ;
unsigned int V_115 ;
...
F_82 ( & V_25 -> V_26 , 1 ) ;
F_83 ( & V_25 -> V_70 ) ;
F_332 ( V_31 , & V_526 , V_25 ) ;
F_14 ( & V_30 ) ;
F_37 ( & V_25 -> V_69 , & V_527 ) ;
F_15 (id_priv, &listen_any_list, list)
F_209 ( V_40 , V_25 ) ;
F_16 ( & V_30 ) ;
}
static int F_333 ( struct V_39 * V_40 )
{
struct V_273 V_2 ;
enum V_41 V_45 ;
int V_44 = 0 ;
...
static void F_334 ( struct V_24 * V_25 )
{
struct V_39 * V_40 ;
int V_44 ;
F_14 ( & V_30 ) ;
...
static void F_335 ( struct V_38 * V_31 , void * V_529 )
{
struct V_24 * V_25 = V_529 ;
if ( ! V_25 )
return;
F_14 ( & V_30 ) ;
F_46 ( & V_25 -> V_69 ) ;
...
static int F_336 ( struct V_530 * V_531 , struct V_532 * V_533 )
{
struct V_534 * V_535 ;
struct V_536 * V_537 ;
struct V_39 * V_40 ;
...
F_14 ( & V_30 ) ;
F_15 (cma_dev, &dev_list, list) {
if ( V_538 < V_533 -> args [ 0 ] ) {
V_538 ++ ;
continue;
}
V_539 = 0 ;
F_15 (id_priv, &cma_dev->id_list, list) {
if ( V_539 < V_533 -> args [ 1 ] ) {
V_539 ++ ;
continue;
}
V_537 = F_337 ( V_531 , & V_535 , V_533 -> V_535 -> V_540 ,
sizeof *V_537 , V_541 ,
V_542 ,
V_543 ) ;
if ( ! V_537 )
...
V_63 = & V_40 -> V_63 ;
V_537 -> V_68 = V_63 -> V_64 . V_65 . V_66 . V_89 ;
V_537 -> V_71 = V_63 -> V_71 ;
V_537 -> V_107 =
V_63 -> V_64 . V_65 . V_66 . V_107 ;
if ( F_338 ( V_531 , V_535 ,
F_201 ( F_47 ( V_40 ) ) ,
F_47 ( V_40 ) ,
V_544 ) )
goto V_108;
...
V_545 ) )
goto V_108;
V_537 -> V_546 = V_40 -> V_125 ;
V_537 -> V_547 = V_63 -> V_10 ;
V_537 -> V_548 = V_40 -> V_45 ;
V_537 -> V_151 = V_40 -> V_151 ;
V_537 -> V_123 = V_63 -> V_123 ;
V_539 ++ ;
}
V_533 -> args [ 1 ] = 0 ;
V_538 ++ ;
...
static int F_339 ( struct V_6 * V_6 )
{
struct V_5 * V_11 = V_5 ( V_6 ) ;
F_340 ( & V_11 -> V_13 ) ;
F_340 ( & V_11 -> V_15 ) ;
