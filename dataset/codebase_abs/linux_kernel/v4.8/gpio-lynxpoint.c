...
static int F_44 ( struct V_56 * V_15 )
{
return 0 ;
}
...
{
struct V_52 * V_14 = F_47 ( V_15 ) ;
struct V_5 * V_6 = F_48 ( V_14 ) ;
unsigned long V_4 ;
int V_78 ;
for ( V_78 = 0 ; V_78 < V_6 -> V_2 . V_26 ; V_78 ++ ) {
if ( F_49 ( & V_6 -> V_2 , V_78 ) != NULL ) {
V_4 = F_1 ( & V_6 -> V_2 , V_78 , V_9 ) ;
F_8 ( F_5 ( V_4 ) & ~ V_19 , V_4 ) ;
}
}
return 0 ;
}
static int F_50 ( struct V_52 * V_14 )
{
F_51 ( & V_14 -> V_15 ) ;
return 0 ;
}
