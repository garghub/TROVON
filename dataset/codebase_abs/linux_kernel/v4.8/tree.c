...
V_16 -> V_126 = F_5 ( V_27 ) ;
V_16 -> V_127 = ! ! ( V_2 -> V_101 & V_16 -> V_75 ) ;
F_155 ( V_16 ) ;
...
V_128 = F_154 ( V_5 , V_2 , V_16 ) ;
F_121 ( V_2 , V_26 ) ;
if ( V_128 )
F_150 ( V_5 ) ;
}
static void F_158 ( struct V_4 * V_5 , int V_129 )
{
if ( V_129 > 0 &&
! ( V_5 -> V_7 % ( V_130 * V_131 * V_129 ) ) )
F_159 ( V_129 ) ;
}
...
static bool F_172 ( struct V_4 * V_5 , int * V_137 )
{
struct V_1 * V_2 = F_50 ( V_5 ) ;
* V_137 = F_2 ( V_5 -> V_42 ) ;
if ( * V_137 & V_138 )
...
static void F_174 ( struct V_4 * V_5 , bool V_139 )
{
bool V_77 = false ;
unsigned long V_78 ;
struct V_1 * V_2 = F_50 ( V_5 ) ;
...
V_16 = F_10 ( V_5 -> V_21 ) ;
if ( V_2 == V_16 -> V_23 )
V_141 = F_154 ( V_5 , V_2 , V_16 ) || V_141 ;
V_142 += F_149 ( V_5 , V_2 ) ;
V_144 = F_179 ( V_2 ) ;
F_162 ( V_2 ) ;
F_180 ( V_144 ) ;
...
V_5 -> V_32 = V_147 ;
V_16 = F_10 ( V_5 -> V_21 ) ;
V_141 = F_153 ( V_5 , V_2 , V_16 ) || V_141 ;
if ( V_141 || F_52 ( V_5 , V_16 ) ) {
F_99 ( V_5 -> V_42 , V_148 ) ;
F_6 ( V_5 -> V_31 ,
F_2 ( V_5 -> V_7 ) ,
F_7 ( L_45 ) ) ;
...
static int T_3 F_182 ( void * V_149 )
{
bool V_150 ;
int V_151 ;
unsigned long V_92 ;
int V_74 ;
struct V_4 * V_5 = V_149 ;
struct V_1 * V_2 = F_50 ( V_5 ) ;
F_183 () ;
for (; ; ) {
for (; ; ) {
...
F_172 ( V_5 , & V_151 ) , V_92 ) ;
V_5 -> V_32 = V_157 ;
if ( ! F_2 ( V_2 -> V_101 ) &&
! F_173 ( V_2 ) )
break;
if ( F_102 ( V_88 , V_5 -> V_155 ) ||
( V_151 & V_138 ) ) {
F_6 ( V_5 -> V_31 ,
F_2 ( V_5 -> V_7 ) ,
F_7 ( L_49 ) ) ;
...
static void
F_190 ( unsigned long V_160 , struct V_4 * V_5 ,
struct V_1 * V_2 , unsigned long V_113 , unsigned long V_26 )
__releases( V_2 -> V_161 )
{
unsigned long V_132 = 0 ;
struct V_1 * V_162 ;
for (; ; ) {
if ( ! ( V_2 -> V_101 & V_160 ) || V_2 -> V_7 != V_113 ) {
F_121 ( V_2 , V_26 ) ;
return;
}
F_65 ( V_132 ) ;
...
F_148 ( V_2 ) ;
F_146 ( V_165 ) ;
F_190 ( V_160 , V_5 , V_165 , V_113 , V_26 ) ;
}
static void
...
V_160 = V_16 -> V_75 ;
if ( ( V_2 -> V_101 & V_160 ) == 0 ) {
F_121 ( V_2 , V_26 ) ;
} else {
V_16 -> V_127 = false ;
V_128 = F_152 ( V_5 , V_2 , V_16 ) ;
F_190 ( V_160 , V_5 , V_2 , V_2 -> V_7 , V_26 ) ;
if ( V_128 )
F_150 ( V_5 ) ;
}
}
...
{
if ( ! F_56 ( V_166 ) || F_196 ( V_16 -> V_80 ) )
return;
if ( V_16 -> V_44 != NULL ) {
V_5 -> V_167 += V_16 -> V_167 ;
...
F_198 ( V_5 , V_16 , V_26 ) )
return;
V_16 -> V_167 += V_5 -> V_167 ;
V_16 -> V_111 += V_5 -> V_111 ;
V_16 -> V_171 += V_5 -> V_111 ;
if ( V_5 -> V_167 != V_5 -> V_111 )
F_199 () ;
V_5 -> V_167 = 0 ;
V_5 -> V_111 = 0 ;
if ( V_5 -> V_172 != NULL ) {
* V_5 -> V_170 = * V_16 -> V_45 [ V_46 ] ;
* V_16 -> V_45 [ V_46 ] = V_5 -> V_172 ;
for ( V_51 = V_115 - 1 ; V_51 >= V_46 ; V_51 -- )
if ( V_16 -> V_45 [ V_51 ] == V_16 -> V_45 [ V_46 ] )
V_16 -> V_45 [ V_51 ] = V_5 -> V_170 ;
V_5 -> V_172 = NULL ;
V_5 -> V_170 = & V_5 -> V_172 ;
}
if ( V_5 -> V_173 != NULL ) {
* V_16 -> V_45 [ V_52 ] = V_5 -> V_173 ;
V_16 -> V_45 [ V_52 ] = V_5 -> V_169 ;
V_5 -> V_173 = NULL ;
V_5 -> V_169 = & V_5 -> V_173 ;
}
}
...
if ( ! F_56 ( V_166 ) )
return;
F_201 ( V_160 = V_16 -> V_75 ) ;
F_6 ( V_5 -> V_31 ,
V_2 -> V_7 + 1 - ! ! ( V_2 -> V_101 & V_160 ) ,
F_7 ( L_52 ) ) ;
}
static void F_166 ( struct V_1 * V_174 )
{
long V_160 ;
...
return;
F_203 ( V_2 , - 1 ) ;
F_204 ( & V_5 -> V_175 , V_26 ) ;
F_195 ( V_80 , V_5 , V_2 , V_16 ) ;
F_197 ( V_5 , V_26 ) ;
F_205 ( & V_5 -> V_175 , V_26 ) ;
...
long V_180 , V_181 , V_182 ;
int V_51 ;
if ( ! F_49 ( V_16 ) ) {
F_207 ( V_5 -> V_31 , V_16 -> V_167 , V_16 -> V_111 , 0 ) ;
...
F_65 ( F_103 ( F_59 () ) ) ;
V_180 = V_16 -> V_183 ;
F_207 ( V_5 -> V_31 , V_16 -> V_167 , V_16 -> V_111 , V_180 ) ;
V_178 = V_16 -> V_44 ;
V_16 -> V_44 = * V_16 -> V_45 [ V_46 ] ;
* V_16 -> V_45 [ V_46 ] = NULL ;
V_179 = V_16 -> V_45 [ V_46 ] ;
...
F_27 ( V_26 ) ;
F_208 ( V_5 -> V_31 , V_181 , ! ! V_178 , F_209 () ,
F_57 ( V_60 ) ,
F_210 () ) ;
if ( V_178 != NULL ) {
* V_179 = V_16 -> V_44 ;
...
V_16 -> V_45 [ V_51 ] = V_179 ;
else
break;
}
F_17 () ;
V_16 -> V_167 -= V_182 ;
F_99 ( V_16 -> V_111 , V_16 -> V_111 - V_181 ) ;
V_16 -> V_184 += V_181 ;
if ( V_16 -> V_183 == V_185 && V_16 -> V_111 <= V_186 )
V_16 -> V_183 = V_183 ;
if ( V_16 -> V_111 == 0 && V_16 -> V_187 != 0 ) {
V_16 -> V_187 = 0 ;
V_16 -> V_188 = V_5 -> V_95 ;
} else if ( V_16 -> V_111 < V_16 -> V_187 - V_189 )
V_16 -> V_187 = V_16 -> V_111 ;
...
if ( V_2 -> V_164 &&
( V_2 -> V_164 -> V_101 & V_2 -> V_75 ) ) {
F_192 ( V_5 , V_2 , V_26 ) ;
continue;
}
}
F_118 (rnp, cpu) {
unsigned long V_190 = F_119 ( V_2 , V_80 ) ;
if ( ( V_2 -> V_101 & V_190 ) != 0 ) {
...
for (; V_2 != NULL ; V_2 = V_2 -> V_164 ) {
V_74 = ( F_2 ( V_5 -> V_42 ) & V_138 ) ||
! F_223 ( & V_2 -> V_192 ) ;
if ( V_191 != NULL )
F_224 ( & V_191 -> V_192 ) ;
if ( V_74 ) {
...
F_99 ( V_5 -> V_42 , F_2 ( V_5 -> V_42 ) | V_138 ) ;
F_121 ( V_191 , V_26 ) ;
F_151 ( & V_5 -> V_125 ) ;
}
static void
...
static void F_227 ( struct V_195 * V_196 )
{
struct V_4 * V_5 ;
if ( F_103 ( F_59 () ) )
return;
...
struct V_176 * V_199 , unsigned long V_26 )
{
bool V_128 ;
if ( ! F_89 () )
F_214 () ;
...
return;
if ( F_25 ( V_16 -> V_111 > V_16 -> V_187 + V_189 ) ) {
F_156 ( V_5 , V_16 ) ;
if ( ! F_3 ( V_5 ) ) {
...
V_16 -> V_183 = V_185 ;
if ( V_5 -> V_95 == V_16 -> V_188 &&
* V_16 -> V_45 [ V_46 ] != V_199 )
F_41 ( V_5 ) ;
V_16 -> V_188 = V_5 -> V_95 ;
V_16 -> V_187 = V_16 -> V_111 ;
}
...
static void F_234 ( struct V_176 * V_200 )
{
}
static void
F_235 ( struct V_176 * V_199 , T_4 V_201 ,
struct V_4 * V_5 , int V_80 , bool V_202 )
{
unsigned long V_26 ;
struct V_15 * V_16 ;
F_65 ( ( unsigned long ) V_199 & 0x1 ) ;
if ( F_236 ( V_199 ) ) {
F_99 ( V_199 -> V_201 , F_234 ) ;
F_61 ( 1 , L_58 ) ;
return;
}
V_199 -> V_201 = V_201 ;
...
if ( F_228 ( V_16 -> V_23 ) ) {
V_203 = ! F_237 ( V_16 , V_199 , V_202 , V_26 ) ;
F_65 ( V_203 ) ;
F_28 ( V_26 ) ;
return;
}
...
F_199 () ;
F_17 () ;
* V_16 -> V_45 [ V_52 ] = V_199 ;
V_16 -> V_45 [ V_52 ] = & V_199 -> V_177 ;
if ( F_239 ( ( unsigned long ) V_201 ) )
F_240 ( V_5 -> V_31 , V_199 , ( unsigned long ) V_201 ,
V_16 -> V_167 , V_16 -> V_111 ) ;
else
F_241 ( V_5 -> V_31 , V_199 , V_16 -> V_167 , V_16 -> V_111 ) ;
F_232 ( V_5 , V_16 , V_199 , V_26 ) ;
F_28 ( V_26 ) ;
}
void F_242 ( struct V_176 * V_199 , T_4 V_201 )
{
F_235 ( V_199 , V_201 , & V_13 , - 1 , 0 ) ;
}
void F_243 ( struct V_176 * V_199 , T_4 V_201 )
{
F_235 ( V_199 , V_201 , & V_29 , - 1 , 0 ) ;
}
void F_244 ( struct V_176 * V_199 ,
T_4 V_201 )
{
F_235 ( V_199 , V_201 , V_28 , - 1 , 1 ) ;
}
...
void F_256 ( unsigned long V_204 )
{
unsigned long V_205 ;
V_205 = F_255 ( & V_28 -> V_6 ) ;
if ( F_102 ( V_204 , V_205 ) )
F_257 () ;
}
...
void F_259 ( unsigned long V_204 )
{
unsigned long V_205 ;
V_205 = F_255 ( & V_13 . V_6 ) ;
if ( F_102 ( V_204 , V_205 ) )
F_248 () ;
}
static void F_260 ( unsigned long * V_206 )
{
F_99 ( * V_206 , * V_206 + 1 ) ;
F_17 () ;
F_65 ( ! ( * V_206 & 0x1 ) ) ;
}
static void F_261 ( unsigned long * V_206 )
{
F_17 () ;
F_99 ( * V_206 , * V_206 + 1 ) ;
F_65 ( * V_206 & 0x1 ) ;
}
static unsigned long F_262 ( unsigned long * V_206 )
{
unsigned long V_10 ;
V_10 = ( F_2 ( * V_206 ) + 3 ) & ~ 0x1 ;
F_17 () ;
return V_10 ;
}
static bool F_263 ( unsigned long * V_206 , unsigned long V_10 )
{
return F_102 ( F_2 ( * V_206 ) , V_10 ) ;
}
...
static bool V_62 F_267 ( bool * V_216 )
{
bool V_217 = true ;
bool V_218 = false ;
struct V_15 * V_16 ;
...
continue;
V_218 = true ;
if ( V_16 -> V_111 != V_16 -> V_167 || ! V_216 ) {
V_217 = false ;
break;
}
}
...
int V_80 , unsigned long V_219 )
{
F_269 ( V_5 -> V_31 , V_10 , V_80 ,
F_66 ( & V_5 -> V_220 ) , V_219 ) ;
}
static void F_270 ( struct V_176 * V_200 )
{
struct V_15 * V_16 = F_271 ( V_200 , struct V_15 , V_221 ) ;
struct V_4 * V_5 = V_16 -> V_5 ;
if ( F_272 ( & V_5 -> V_220 ) ) {
F_268 ( V_5 , L_61 , - 1 , V_5 -> V_222 ) ;
F_273 ( & V_5 -> V_223 ) ;
} else {
F_268 ( V_5 , L_62 , - 1 , V_5 -> V_222 ) ;
}
}
...
struct V_4 * V_5 = type ;
struct V_15 * V_16 = F_16 ( V_5 -> V_21 ) ;
F_268 ( V_5 , L_63 , - 1 , V_5 -> V_222 ) ;
F_64 ( & V_5 -> V_220 ) ;
V_5 -> V_224 ( & V_16 -> V_221 , F_270 ) ;
}
static void F_275 ( struct V_4 * V_5 )
{
int V_80 ;
struct V_15 * V_16 ;
unsigned long V_10 = F_262 ( & V_5 -> V_222 ) ;
F_268 ( V_5 , L_64 , - 1 , V_10 ) ;
F_276 ( & V_5 -> V_225 ) ;
if ( F_263 ( & V_5 -> V_222 , V_10 ) ) {
F_268 ( V_5 , L_65 , - 1 , V_5 -> V_222 ) ;
F_17 () ;
F_277 ( & V_5 -> V_225 ) ;
return;
}
F_260 ( & V_5 -> V_222 ) ;
F_268 ( V_5 , L_66 , - 1 , V_5 -> V_222 ) ;
F_278 ( & V_5 -> V_223 ) ;
F_279 ( & V_5 -> V_220 , 1 ) ;
F_280 () ;
F_131 (cpu) {
...
static void F_164 ( struct V_1 * V_174 )
{
long V_160 ;
struct V_1 * V_2 = V_174 ;
for (; ; ) {
...
static void F_300 ( int V_80 , struct V_4 * V_5 )
{
unsigned long V_26 ;
unsigned long V_160 ;
struct V_15 * V_16 = F_132 ( V_5 -> V_21 , V_80 ) ;
...
static int F_302 ( struct V_229 * V_230 ,
...
V_76 = 1 ;
F_15 (rsp) {
V_242 = F_307 ( F_182 , V_5 , L_74 , V_5 -> V_31 ) ;
F_238 ( F_308 ( V_242 ) ) ;
V_2 = F_50 ( V_5 ) ;
F_117 ( V_2 , V_26 ) ;
V_5 -> V_33 = V_242 ;
...
static void T_5 F_314 ( int * V_247 , const int * V_248 )
{
int V_51 ;
if ( V_249 ) {
V_247 [ V_250 - 1 ] = V_251 ;
for ( V_51 = V_250 - 2 ; V_51 >= 0 ; V_51 -- )
V_247 [ V_51 ] = V_252 ;
} else {
int V_253 ;
int V_254 ;
V_254 = V_235 ;
for ( V_51 = V_250 - 1 ; V_51 >= 0 ; V_51 -- ) {
V_253 = V_248 [ V_51 ] ;
V_247 [ V_51 ] = ( V_254 + V_253 - 1 ) / V_253 ;
V_254 = V_253 ;
}
}
}
static void T_5 F_315 ( struct V_4 * V_5 )
{
static const char * const V_255 [] = V_256 ;
static const char * const V_257 [] = V_258 ;
static struct V_259 V_260 [ V_261 ] ;
static struct V_259 V_262 [ V_261 ] ;
static T_6 V_263 = 0x1 ;
int V_248 [ V_261 ] ;
int V_247 [ V_261 ] ;
int V_264 = 1 ;
int V_51 ;
int V_92 ;
struct V_1 * V_2 ;
F_316 ( V_261 > F_110 ( V_255 ) ) ;
if ( V_250 <= 0 || V_250 > V_261 )
F_125 ( L_75 ) ;
for ( V_51 = 0 ; V_51 < V_250 ; V_51 ++ )
V_248 [ V_51 ] = V_265 [ V_51 ] ;
for ( V_51 = 1 ; V_51 < V_250 ; V_51 ++ )
V_5 -> V_117 [ V_51 ] = V_5 -> V_117 [ V_51 - 1 ] + V_248 [ V_51 - 1 ] ;
F_314 ( V_247 , V_248 ) ;
V_5 -> V_22 = V_263 ;
V_263 <<= 1 ;
for ( V_51 = V_250 - 1 ; V_51 >= 0 ; V_51 -- ) {
V_264 *= V_247 [ V_51 ] ;
V_2 = V_5 -> V_117 [ V_51 ] ;
for ( V_92 = 0 ; V_92 < V_248 [ V_51 ] ; V_92 ++ , V_2 ++ ) {
F_317 ( & F_318 ( V_2 , V_161 ) ) ;
F_319 ( & F_318 ( V_2 , V_161 ) ,
& V_260 [ V_51 ] , V_255 [ V_51 ] ) ;
F_317 ( & V_2 -> V_192 ) ;
F_319 ( & V_2 -> V_192 ,
...
V_2 -> V_101 = 0 ;
V_2 -> V_134 = 0 ;
V_2 -> V_118 = V_92 * V_264 ;
V_2 -> V_119 = ( V_92 + 1 ) * V_264 - 1 ;
if ( V_2 -> V_119 >= V_235 )
V_2 -> V_119 = V_235 - 1 ;
if ( V_51 == 0 ) {
V_2 -> V_266 = 0 ;
...
V_2 -> V_266 = V_92 % V_247 [ V_51 - 1 ] ;
V_2 -> V_75 = 1UL << V_2 -> V_266 ;
V_2 -> V_164 = V_5 -> V_117 [ V_51 - 1 ] +
V_92 / V_247 [ V_51 - 1 ] ;
}
V_2 -> V_117 = V_51 ;
F_320 ( & V_2 -> V_267 ) ;
...
F_325 ( & V_5 -> V_271 , & V_272 ) ;
}
static void T_5 F_326 ( void )
{
T_7 V_273 ;
int V_51 ;
int V_274 [ V_261 ] ;
V_273 = V_275 + V_235 / V_276 ;
if ( V_154 == V_81 )
V_154 = V_273 ;
if ( V_112 == V_81 )
V_112 = V_273 ;
...
V_251 , V_235 ) ;
if ( V_251 < 2 ||
V_251 > sizeof( unsigned long ) * 8 ) {
V_251 = V_277 ;
F_185 ( 1 ) ;
return;
}
V_274 [ 0 ] = V_251 ;
for ( V_51 = 1 ; V_51 < V_261 ; V_51 ++ )
V_274 [ V_51 ] = V_274 [ V_51 - 1 ] * V_252 ;
if ( V_235 > V_274 [ V_261 - 1 ] ) {
V_251 = V_277 ;
F_185 ( 1 ) ;
return;
}
for ( V_51 = 0 ; V_235 > V_274 [ V_51 ] ; V_51 ++ ) {
}
V_250 = V_51 + 1 ;
for ( V_51 = 0 ; V_51 < V_250 ; V_51 ++ ) {
int V_279 = V_274 [ ( V_250 - 1 ) - V_51 ] ;
V_265 [ V_51 ] = F_327 ( V_235 , V_279 ) ;
}
V_130 = 0 ;
for ( V_51 = 0 ; V_51 < V_250 ; V_51 ++ )
V_130 += V_265 [ V_51 ] ;
}
static void T_5 F_328 ( struct V_4 * V_5 )
{
int V_117 = 0 ;
struct V_1 * V_2 ;
F_45 ( L_77 ) ;
...
F_133 ( L_80 , V_2 -> V_118 , V_2 -> V_119 , V_2 -> V_266 ) ;
}
F_133 ( L_79 ) ;
}
void T_5 F_329 ( void )
