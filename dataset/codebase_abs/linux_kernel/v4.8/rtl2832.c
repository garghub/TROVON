...
static int F_37 ( struct V_22 * V_23 , int V_185 )
{
struct V_1 * V_2 = V_23 -> V_25 ;
struct V_5 * V_6 = V_2 -> V_6 ;
int V_7 ;
T_3 V_156 ;
F_4 ( & V_6 -> V_2 , L_18 , V_185 , V_2 -> V_184 ) ;
if ( V_185 )
V_156 = 0x80 ;
else
V_156 = 0x00 ;
if ( V_2 -> V_184 )
V_7 = F_25 ( V_2 -> V_18 , 0x021 , 0xc0 , V_156 ) ;
else
...
static int F_38 ( struct V_22 * V_23 , T_3 V_186 , T_2 V_187 ,
int V_185 )
{
struct V_1 * V_2 = V_23 -> V_25 ;
struct V_5 * V_6 = V_2 -> V_6 ;
...
T_3 V_128 [ 4 ] ;
F_4 ( & V_6 -> V_2 , L_19 ,
V_186 , V_187 , V_185 , V_2 -> V_184 ) ;
if ( V_187 > 0x1fff || V_186 > 32 )
return 0 ;
if ( V_185 )
F_39 ( V_186 , & V_2 -> V_188 ) ;
else
F_40 ( V_186 , & V_2 -> V_188 ) ;
V_128 [ 0 ] = ( V_2 -> V_188 >> 0 ) & 0xff ;
V_128 [ 1 ] = ( V_2 -> V_188 >> 8 ) & 0xff ;
V_128 [ 2 ] = ( V_2 -> V_188 >> 16 ) & 0xff ;
V_128 [ 3 ] = ( V_2 -> V_188 >> 24 ) & 0xff ;
if ( V_2 -> V_184 )
V_7 = F_6 ( V_2 -> V_18 , 0x022 , V_128 , 4 ) ;
else
V_7 = F_6 ( V_2 -> V_18 , 0x062 , V_128 , 4 ) ;
if ( V_7 )
goto V_19;
V_128 [ 0 ] = ( V_187 >> 8 ) & 0xff ;
V_128 [ 1 ] = ( V_187 >> 0 ) & 0xff ;
if ( V_2 -> V_184 )
V_7 = F_6 ( V_2 -> V_18 , 0x026 + 2 * V_186 , V_128 , 2 ) ;
else
V_7 = F_6 ( V_2 -> V_18 , 0x066 + 2 * V_186 , V_128 , 2 ) ;
if ( V_7 )
goto V_19;
return 0 ;
V_19:
...
{
struct V_191 * V_28 = V_6 -> V_2 . V_192 ;
struct V_181 * V_193 = V_6 -> V_182 ;
struct V_1 * V_2 ;
int V_7 ;
T_3 V_155 ;
static const struct V_194 V_194 [] = {
{
. V_195 = 0x00 ,
. V_196 = 0xff ,
. V_197 = 0 ,
...
F_4 ( & V_6 -> V_2 , L_3 ) ;
V_2 = F_42 ( sizeof( struct V_1 ) , V_202 ) ;
if ( V_2 == NULL ) {
V_7 = - V_203 ;
goto V_19;
}
F_43 ( V_6 , V_2 ) ;
V_2 -> V_6 = V_6 ;
V_2 -> V_28 = V_6 -> V_2 . V_192 ;
V_2 -> V_103 = true ;
F_44 ( & V_2 -> V_176 , F_23 ) ;
V_2 -> V_204 . V_205 = 8 ,
V_2 -> V_204 . V_206 = 8 ,
V_2 -> V_204 . V_207 = F_32 ,
V_2 -> V_204 . V_208 = 5 * 0x100 ,
V_2 -> V_204 . V_209 = V_194 ,
V_2 -> V_204 . V_210 = F_10 ( V_194 ) ,
V_2 -> V_204 . V_211 = V_212 ,
V_2 -> V_18 = F_45 ( V_6 , & V_2 -> V_204 ) ;
if ( F_46 ( V_2 -> V_18 ) ) {
V_7 = F_47 ( V_2 -> V_18 ) ;
goto V_213;
}
...
if ( V_7 )
goto V_214;
V_2 -> V_178 = F_48 ( V_193 , & V_193 -> V_2 , 1 , 0 , V_215 ,
F_26 , F_29 ) ;
if ( ! V_2 -> V_178 ) {
V_7 = - V_203 ;
goto V_214;
...
if ( V_7 )
goto V_214;
memcpy ( & V_2 -> V_23 . V_109 , & V_217 , sizeof( struct V_218 ) ) ;
V_2 -> V_23 . V_25 = V_2 ;
V_28 -> V_219 = F_33 ;
V_28 -> V_220 = F_35 ;
V_28 -> V_221 = F_36 ;
