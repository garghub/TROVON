...
struct V_33 * V_37 , struct V_33 * V_194 )
{
struct V_33 * V_195 ;
int V_196 ;
V_195 = NULL ;
V_196 = 0 ;
while ( 1 ) {
V_195 = F_11 ( V_185 -> V_35 , V_37 -> V_36 ,
V_195 ) ;
if ( V_195 == NULL )
break;
if ( V_195 == V_194 )
...
F_32 ( & V_195 -> V_185 , & V_185 -> V_38 ) ;
if ( V_186 & V_187 ) {
if ( ! V_196 )
F_45 ( L_70 ) ;
F_45 ( L_71 , V_195 -> V_36 ) ;
V_196 = 1 ;
}
break;
case V_190 :
...
struct V_33 * V_158 )
{
struct V_33 * V_37 , * V_194 ;
F_16 ( V_187 , L_83 ) ;
V_37 = V_158 ;
V_194 = NULL ;
while ( V_37 != NULL ) {
if ( V_37 -> V_185 . V_198 || V_37 -> V_185 . V_194 ) {
F_16 ( V_65 , L_81
L_84 , V_37 -> V_36 ) ;
return - V_69 ;
}
...
static unsigned int F_50 ( struct V_199 * V_200 , T_5 V_201 ,
char * V_50 )
{
struct V_33 * V_158 ;
...
if ( ! F_36 ( V_158 ) )
continue;
if ( V_158 -> V_185 . V_198 || V_158 -> V_185 . V_194 )
continue;
...
static void F_69 ( struct V_210 * V_207 )
{
struct V_42 * V_43 = F_70 ( V_207 ) ;
...
struct V_42 * V_43 )
{
struct V_210 * V_207 = & V_43 -> V_207 ;
int V_116 ;
V_116 = F_78 ( & V_43 -> V_212 , V_43 -> type , ! V_213 ) ;
if ( V_116 )
return V_116 ;
V_116 = F_79 ( V_43 ) ;
if ( V_116 < 0 ) {
...
F_80 ( V_43 ) ;
V_207 -> V_215 = & V_35 -> V_207 ;
V_207 -> V_216 = & V_217 ;
V_207 -> V_218 = & V_219 ;
V_207 -> V_220 = F_69 ;
V_207 -> V_204 = & V_43 -> V_185 -> V_204 ;
if ( V_43 -> type == V_124 )
V_207 -> V_221 = V_222 ;
F_17 ( V_207 -> V_70 , V_35 -> V_70 , sizeof V_207 -> V_70 ) ;
F_81 ( V_207 , V_43 ) ;
V_116 = F_82 ( V_207 , V_223 , - 1 ) ;
if ( V_116 < 0 ) {
F_18 ( V_214 , L_93 ,
V_116 ) ;
return V_116 ;
...
if ( V_43 -> type == V_126 )
V_43 -> V_185 -> V_224 |= V_225 ;
else
V_43 -> V_185 -> V_224 |= V_226 ;
F_73 ( & V_35 -> V_211 ) ;
return 0 ;
}
...
V_43 -> V_185 = V_185 ;
V_116 = F_77 ( V_35 , V_43 ) ;
if ( V_116 < 0 )
return V_116 ;
V_158 -> V_207 = & V_43 -> V_207 ;
}
return 0 ;
}
static int F_84 ( struct V_34 * V_35 )
{
struct V_184 * V_185 ;
int V_116 ;
F_10 (chain, &dev->chains, list) {
V_116 = F_83 ( V_35 , V_185 ) ;
if ( V_116 < 0 )
return V_116 ;
#ifdef F_63
V_116 = F_85 ( V_185 ) ;
...
static int F_86 ( struct V_52 * V_53 ,
const struct V_227 * V_36 )
{
struct V_147 * V_66 = F_87 ( V_53 ) ;
struct V_34 * V_35 ;
int V_116 ;
if ( V_36 -> V_151 && V_36 -> V_228 )
F_16 ( V_187 , L_97
L_98 , V_66 -> V_229 , V_36 -> V_151 ,
V_36 -> V_228 ) ;
else
F_16 ( V_187 , L_99 ,
V_66 -> V_229 ) ;
...
? V_36 -> V_233 : V_232 ;
if ( V_66 -> V_234 != NULL )
F_17 ( V_35 -> V_70 , V_66 -> V_234 , sizeof V_35 -> V_70 ) ;
else
snprintf ( V_35 -> V_70 , sizeof V_35 -> V_70 ,
L_100 ,
F_31 ( V_66 -> V_150 . V_151 ) ,
F_31 ( V_66 -> V_150 . V_228 ) ) ;
if ( F_42 ( V_35 ) < 0 ) {
F_16 ( V_187 , L_101
L_102 ) ;
goto error;
...
V_66 -> V_234 ? V_66 -> V_234 : L_104 ,
F_31 ( V_66 -> V_150 . V_151 ) ,
F_31 ( V_66 -> V_150 . V_228 ) ) ;
if ( V_35 -> V_74 != V_36 -> V_233 ) {
F_18 ( V_72 , L_105
L_106 , V_35 -> V_74 ) ;
F_18 ( V_72 , L_107
L_108 ) ;
...
#ifdef F_63
V_35 -> V_208 . V_35 = & V_53 -> V_35 ;
F_17 ( V_35 -> V_208 . V_235 , V_35 -> V_70 , sizeof( V_35 -> V_208 . V_235 ) ) ;
if ( V_66 -> V_236 )
F_17 ( V_35 -> V_208 . V_236 , V_66 -> V_236 ,
sizeof( V_35 -> V_208 . V_236 ) ) ;
strcpy ( V_35 -> V_208 . V_237 , V_66 -> V_229 ) ;
V_35 -> V_208 . V_238 = F_31 ( V_66 -> V_150 . V_239 ) ;
V_35 -> V_208 . V_240 = V_241 ;
F_90 ( & V_35 -> V_208 ) ;
V_35 -> V_207 . V_208 = & V_35 -> V_208 ;
#endif
if ( F_91 ( & V_53 -> V_35 , & V_35 -> V_207 ) < 0 )
goto error;
if ( F_92 ( V_35 ) < 0 )
goto error;
if ( F_54 ( V_35 ) < 0 )
...
goto error;
#ifdef F_63
if ( F_93 ( & V_35 -> V_208 ) < 0 )
goto error;
#endif
F_94 ( V_53 , V_35 ) ;
if ( ( V_116 = F_95 ( V_35 ) ) < 0 ) {
F_18 ( V_72 , L_109
L_110
L_111 , V_116 ) ;
}
...
static void F_97 ( struct V_52 * V_53 )
{
struct V_34 * V_35 = F_98 ( V_53 ) ;
F_94 ( V_53 , NULL ) ;
if ( V_53 -> V_54 -> V_7 . V_117 ==
V_118 )
return;
...
static int F_99 ( struct V_52 * V_53 , T_7 V_243 )
{
struct V_34 * V_35 = F_98 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_244 , L_113 ,
...
static int F_104 ( struct V_52 * V_53 , int V_247 )
{
struct V_34 * V_35 = F_98 ( V_53 ) ;
struct V_42 * V_43 ;
int V_116 = 0 ;
...
F_100 ( & V_35 -> V_231 ) ;
if ( V_35 -> V_246 )
V_116 = F_106 ( V_35 , V_248 ) ;
F_102 ( & V_35 -> V_231 ) ;
return V_116 ;
}
F_10 (stream, &dev->streams, list) {
if ( V_43 -> V_53 == V_53 ) {
V_116 = F_107 ( V_43 , V_247 ) ;
if ( V_116 < 0 )
F_108 ( & V_43 -> V_212 ,
V_43 -> V_212 . V_212 . type ) ;
return V_116 ;
}
}
F_16 ( V_244 , L_117
...
static int F_109 ( struct V_52 * V_53 )
{
return F_104 ( V_53 , 0 ) ;
}
static int F_110 ( struct V_52 * V_53 )
{
return F_104 ( V_53 , 1 ) ;
}
static int F_111 ( char * V_50 , struct V_249 * V_250 )
{
if ( V_251 == V_252 )
...
static int F_112 ( const char * V_253 , struct V_249 * V_250 )
{
if ( strncasecmp ( V_253 , L_120 , strlen ( L_120 ) ) == 0 )
V_253 += strlen ( L_120 ) ;
if ( strcasecmp ( V_253 , L_121 ) == 0 )
V_251 = V_252 ;
else if ( strcasecmp ( V_253 , L_122 ) == 0 )
V_251 = V_254 ;
else
return - V_69 ;
return 0 ;
