...
static void F_52 (
struct V_21 * V_75 , struct V_21 * V_76 ,
void * V_77 , T_2 V_18 )
{
T_4 * V_78 = ( T_4 * ) V_77 ;
...
switch( F_55 ( V_79 -> V_33 ) ) {
case V_34 :
V_81 = F_56 ( V_76 , F_57 ( V_79 -> V_85 ) ) ;
V_79 -> V_85 = F_53 ( F_58 ( V_75 , V_81 ) ) ;
break;
case V_37 :
V_82 = F_59 ( V_76 , F_57 ( V_79 -> V_85 ) ) ;
V_79 -> V_85 = F_53 ( F_60 ( V_75 , V_82 ) ) ;
break;
default:
break;
}
...
void F_61 ( void * V_77 , T_2 V_18 )
{
struct V_21 * V_22 = F_62 () ;
if ( V_22 == & V_86 )
return;
F_52 ( & V_86 , V_22 , V_77 , V_18 ) ;
}
void F_63 ( void * V_77 , T_2 V_18 )
{
struct V_21 * V_22 = F_62 () ;
if ( V_22 == & V_86 )
return;
F_52 ( V_22 , & V_86 , V_77 , V_18 ) ;
}
struct V_1 *
F_64 ( struct V_21 * V_22 ,
const void * V_77 , T_2 V_18 )
{
T_4 * V_78 = ( T_4 * ) V_77 ;
T_5 * V_79 = ( T_5 * ) ( V_78 + 1 ) , * V_80 ;
int V_15 ;
...
return F_36 ( - V_47 ) ;
V_87 = V_8 -> V_48 ;
for ( V_80 = V_79 + V_15 ; V_79 != V_80 ; V_87 ++ , V_79 ++ ) {
V_87 -> V_33 = F_55 ( V_79 -> V_33 ) ;
V_87 -> V_28 = F_55 ( V_79 -> V_28 ) ;
switch( V_87 -> V_33 ) {
case V_26 :
case V_36 :
case V_39 :
...
int
F_67 ( struct V_21 * V_22 , const struct V_1 * V_8 ,
void * V_89 , T_2 V_18 )
{
T_4 * V_90 = ( T_4 * ) V_89 ;
T_5 * V_91 ;
...
const struct V_19 * V_87 = & V_8 -> V_48 [ V_93 ] ;
V_91 -> V_33 = F_69 ( V_87 -> V_33 ) ;
V_91 -> V_28 = F_69 ( V_87 -> V_28 ) ;
switch( V_87 -> V_33 ) {
case V_34 :
V_91 -> V_85 =
F_53 ( F_58 ( V_22 , V_87 -> V_35 ) ) ;
break;
case V_37 :
V_91 -> V_85 =
F_53 ( F_60 ( V_22 , V_87 -> V_38 ) ) ;
break;
default:
V_91 -> V_85 = F_53 ( V_95 ) ;
break;
...
static int
F_70 ( const struct V_96 * V_97 ,
struct V_98 * V_99 , struct V_2 * V_2 ,
const char * V_100 , void * V_77 , T_2 V_18 )
{
struct V_1 * V_8 ;
int error ;
if ( ! F_19 ( V_2 ) )
...
if ( V_8 == NULL )
return - V_102 ;
error = F_67 ( & V_86 , V_8 , V_77 , V_18 ) ;
F_14 ( V_8 ) ;
return error ;
}
int
F_71 ( struct V_2 * V_2 , int type , struct V_1 * V_8 )
{
if ( ! F_19 ( V_2 ) )
return - V_68 ;
if ( ! V_2 -> V_14 -> V_67 )
...
return - V_103 ;
if ( V_8 ) {
int V_66 = F_30 ( V_2 -> V_104 -> V_105 , V_8 ) ;
if ( V_66 )
return V_66 ;
}
...
static int
F_73 ( const struct V_96 * V_97 ,
struct V_98 * V_99 , struct V_2 * V_2 ,
const char * V_100 , const void * V_77 ,
T_2 V_18 , int V_17 )
{
struct V_1 * V_8 = NULL ;
int V_66 ;
if ( V_77 ) {
V_8 = F_64 ( & V_86 , V_77 , V_18 ) ;
if ( F_22 ( V_8 ) )
return F_47 ( V_8 ) ;
}
V_66 = F_71 ( V_2 , V_97 -> V_17 , V_8 ) ;
F_14 ( V_8 ) ;
return V_66 ;
}
static bool
F_74 ( struct V_98 * V_98 )
{
return F_19 ( F_75 ( V_98 ) ) ;
}
int F_76 ( struct V_2 * V_2 , struct V_1 * V_8 , int type )
{
int error ;
if ( type == V_3 ) {
...
int F_77 ( struct V_2 * V_70 , struct V_2 * V_2 )
{
struct V_1 * V_71 , * V_8 ;
int error ;
error = F_48 ( V_70 , & V_2 -> V_101 , & V_71 , & V_8 ) ;
if ( error )
return error ;
F_11 ( V_2 , V_5 , V_71 ) ;
F_11 ( V_2 , V_3 , V_8 ) ;
