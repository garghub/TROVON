...
V_51 = F_72 () ;
if ( V_51 ) {
F_86 ( V_39 -> V_120 , L_25 ) ;
return V_51 ;
}
V_51 = F_87 ( V_39 , & V_72 . V_146 ) ;
if ( V_51 ) {
F_86 ( V_39 -> V_120 , L_26 ) ;
return V_51 ;
}
while ( ( V_251 = F_88 ( V_246 , V_253 , V_252 ) ) ) {
V_51 = F_89 ( & V_246 -> V_71 , V_251 -> V_254 , F_40 ,
V_255 , V_121 ,
...
V_72 . V_211 . V_263 = F_84 ;
V_51 = F_92 ( & V_72 . V_146 ,
& V_72 . V_211 ) ;
if ( V_51 ) {
F_11 ( L_30 ) ;
V_51 = - V_15 ;
...
static int F_94 ( struct V_245 * V_27 )
{
struct V_9 * V_10 ;
struct V_6 * V_7 ;
int V_73 ;
...
static int F_95 ( struct V_27 * V_71 )
{
struct V_9 * V_10 ;
struct V_6 * V_7 ;
int V_73 ;
...
static int F_99 ( struct V_27 * V_71 )
{
struct V_9 * V_10 ;
struct V_6 * V_7 ;
int V_73 ;
