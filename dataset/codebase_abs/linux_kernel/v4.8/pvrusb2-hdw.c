...
V_383 . V_66 = V_66 ;
V_383 . V_71 = V_2 ;
F_172 (sd, &hdw->v4l2_dev)
F_173 ( NULL , V_235 -> V_384 , & V_383 ) ;
}
...
F_175 ( V_8 , V_398 , V_399 ) ;
F_175 ( V_8 , V_400 , V_401 ) ;
F_175 ( V_8 , V_402 , V_403 ) ;
F_175 ( V_8 , V_404 , V_405 ) ;
F_175 ( V_8 , V_406 , V_407 ) ;
F_175 ( V_8 , V_408 , V_409 ) ;
F_175 ( V_8 , V_410 , V_411 ) ;
F_175 ( V_8 , V_412 , V_413 ) ;
F_175 ( V_8 , V_414 , V_415 ) ;
...
V_8 -> V_428 = ! 0 ;
V_8 -> V_434 = F_178 ( V_452 , V_8 -> V_30 ) ;
}
V_450 =
( V_8 -> V_99 ||
V_8 -> V_58 ||
...
{
int V_187 = 0 ;
struct V_7 * V_8 = F_182 ( V_464 , struct V_7 , V_367 ) ;
F_102 ( V_8 -> V_188 ) ; do {
V_187 = F_183 ( V_8 ) ;
} while ( 0 ); F_103 ( V_8 -> V_188 ) ;
if ( V_187 && V_8 -> V_285 ) {
...
const char * F_187 ( struct V_7 * V_8 )
{
...
int F_190 ( struct V_7 * V_8 , struct V_21 * V_469 )
{
int V_24 = 0 ;
F_102 ( V_8 -> V_188 ) ;
V_24 = F_16 ( V_8 ) ;
...
int F_191 ( struct V_7 * V_8 , struct V_417 * V_470 )
{
F_102 ( V_8 -> V_188 ) ; do {
if ( V_8 -> V_49 ) {
F_41 ( V_8 ) ;
...
struct V_471 * F_192 ( struct V_7 * V_472 )
{
return V_472 -> V_277 ;
}
...
F_102 ( V_8 -> V_188 ) ;
do {
F_194 ( V_474 L_157 , V_473 ) ;
F_98 ( & V_8 -> V_180 , 0 , V_266 , V_475 ) ;
F_2 ( V_246 , L_158 ) ;
F_195 ( & V_8 -> V_69 , L_135 ) ;
F_196 ( V_8 ) ;
F_194 ( V_474 L_159 , V_473 ) ;
} while ( 0 );
F_103 ( V_8 -> V_188 ) ;
}
static T_5 * F_197 ( struct V_7 * V_8 )
{
...
int F_203 ( struct V_7 * V_8 , unsigned int V_481 ,
...
static void F_206 ( struct V_496 * V_496 )
{
...
static void F_208 ( struct V_496 * V_496 )
{
struct V_7 * V_8 = V_496 -> V_497 ;
V_8 -> V_499 = 0 ;
if ( V_8 -> V_498 ) return;
...
static void F_209 ( unsigned long V_152 )
{
...
V_8 -> V_498 = 0 ;
V_8 -> V_499 = 0 ;
F_138 ( & V_510 , F_209 , ( unsigned long ) V_8 ) ;
...
V_59 = F_188 ( V_8 , V_8 -> V_204 , V_141 , NULL , 0 ) ;
F_103 ( V_8 -> V_203 ) ;
return V_59 ;
}
...
F_102 ( V_8 -> V_203 ) ;
V_8 -> V_204 [ 0 ] = V_528 ;
F_217 ( V_8 -> V_204 , 1 , V_152 ) ;
V_8 -> V_204 [ 5 ] = 0 ;
V_8 -> V_204 [ 6 ] = ( V_527 >> 8 ) & 0xff ;
V_8 -> V_204 [ 7 ] = V_527 & 0xff ;
V_59 = F_188 ( V_8 , V_8 -> V_204 , 8 , V_8 -> V_204 , 0 ) ;
F_103 ( V_8 -> V_203 ) ;
return V_59 ;
}
static int F_218 ( struct V_7 * V_8 , T_2 V_527 , V_171 * V_152 )
{
int V_59 = 0 ;
F_102 ( V_8 -> V_203 ) ;
V_8 -> V_204 [ 0 ] = V_529 ;
...
V_8 -> V_204 [ 6 ] = ( V_527 >> 8 ) & 0xff ;
V_8 -> V_204 [ 7 ] = V_527 & 0xff ;
V_59 |= F_188 ( V_8 , V_8 -> V_204 , 8 , V_8 -> V_204 , 4 ) ;
* V_152 = F_219 ( V_8 -> V_204 , 0 ) ;
F_103 ( V_8 -> V_203 ) ;
return V_59 ;
}
...
int V_59 ;
F_2 ( V_206 , L_202 ) ;
V_59 = F_221 ( V_8 -> V_118 , NULL ) ;
if ( V_59 == 0 ) {
V_59 = F_222 ( V_8 -> V_118 ) ;
F_223 ( V_8 -> V_118 ) ;
} else {
F_2 ( V_135 ,
L_203 , V_59 ) ;
...
static int F_227 ( struct V_7 * V_8 , int V_535 )
{
V_8 -> V_369 = ! 0 ;
...
static void F_229 ( struct V_7 * V_8 , int V_541 )
{
int V_542 ;
...
static void F_231 ( struct V_7 * V_8 , int V_535 )
{
unsigned int V_545 ;
T_6 V_386 ;
...
static int F_232 ( struct V_7 * V_8 , int V_549 )
{
int V_59 ;
if ( V_8 -> V_319 == V_320 ) {
return F_93 ( V_8 ,
...
if ( ! F_240 ( V_8 ) ) return 0 ;
if ( F_243 ( V_8 ) < 0 ) return ! 0 ;
V_8 -> V_72 = ! 0 ;
if ( ! V_8 -> V_167 ) {
...
static unsigned int F_250 ( unsigned int V_93 ,
...
static const char * F_251 ( int V_66 )
{
switch ( V_66 ) {
...
static unsigned int F_252 ( struct V_7 * V_8 , int V_431 ,
char * V_207 , unsigned int V_570 )
{
switch ( V_431 ) {
case 0 :
...
static unsigned int F_254 ( struct V_7 * V_8 ,
char * V_207 , unsigned int V_570 )
{
struct V_234 * V_235 ;
unsigned int V_484 = 0 ;
...
unsigned int F_256 ( struct V_7 * V_8 ,
char * V_207 , unsigned int V_570 )
{
...
F_102 ( V_8 -> V_188 ) ;
for ( V_131 = 0 ; ; V_131 ++ ) {
V_447 = F_252 ( V_8 , V_131 , V_207 , V_570 ) ;
if ( ! V_447 ) break;
...
for ( V_131 = 0 ; ; V_131 ++ ) {
V_447 = F_252 ( V_8 , V_131 , V_207 , sizeof( V_207 ) ) ;
if ( ! V_447 ) break;
F_194 ( V_474 L_268 , V_8 -> V_1 , V_447 , V_207 ) ;
}
V_447 = F_254 ( V_8 , V_207 , sizeof( V_207 ) ) ;
if ( V_447 >= sizeof( V_207 ) )
V_447 = sizeof( V_207 ) ;
V_584 = 0 ;
while ( V_584 < V_447 ) {
V_583 = 0 ;
...
F_194 ( V_474 L_268 , V_8 -> V_1 , V_583 , V_207 + V_584 ) ;
V_584 += V_583 + 1 ;
}
}
...
{
return F_218 ( V_8 , V_592 , V_591 ) ;
}
int F_179 ( struct V_7 * V_8 , V_171 * V_591 )
{
return F_218 ( V_8 , V_593 , V_591 ) ;
}
int F_259 ( struct V_7 * V_8 , V_171 * V_591 )
{
return F_218 ( V_8 , V_594 , V_591 ) ;
}
