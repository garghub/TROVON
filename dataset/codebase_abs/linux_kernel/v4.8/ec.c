...
static void F_110 ( struct V_113 * V_34 )
{
unsigned long V_4 ;
...
static T_6
F_112 ( T_3 V_121 , T_7 V_81 ,
T_3 V_122 , T_8 * V_123 ,
void * V_124 , void * V_125 )
{
struct V_1 * V_2 = V_124 ;
int V_82 = 0 , V_92 , V_126 = V_122 / 8 ;
T_1 * V_93 = ( T_1 * ) V_123 ;
if ( ( V_81 > 0xFF ) || ! V_93 || ! V_124 )
return V_127 ;
if ( V_121 != V_128 && V_121 != V_129 )
return V_127 ;
if ( V_65 || V_122 > 8 )
F_65 ( V_2 ) ;
for ( V_92 = 0 ; V_92 < V_126 ; ++ V_92 , ++ V_81 , ++ V_93 )
V_82 = ( V_121 == V_128 ) ?
F_67 ( V_2 , V_81 , V_93 ) :
F_68 ( V_2 , V_81 , * V_93 ) ;
if ( V_65 || V_122 > 8 )
...
F_116 ( & V_2 -> V_107 ) ;
F_117 ( & V_2 -> V_36 ) ;
F_105 ( & V_2 -> V_34 , F_110 ) ;
V_2 -> V_15 = V_16 ;
return V_2 ;
}
static T_6
F_118 ( T_4 V_91 , T_3 V_133 ,
void * V_134 , void * * V_135 )
{
char V_136 [ 5 ] ;
struct V_137 V_138 = { sizeof( V_136 ) , V_136 } ;
struct V_1 * V_2 = V_134 ;
int V_93 = 0 ;
T_6 V_48 ;
V_48 = F_119 ( V_91 , V_139 , & V_138 ) ;
if ( F_120 ( V_48 ) && sscanf ( V_136 , L_41 , & V_93 ) == 1 )
F_95 ( V_2 , V_93 , V_91 , NULL , NULL ) ;
return V_132 ;
}
static T_6
F_121 ( T_4 V_91 , T_3 V_140 , void * V_134 , void * * V_141 )
{
T_6 V_48 ;
unsigned long long V_70 = 0 ;
struct V_1 * V_2 = V_134 ;
V_2 -> V_8 = V_2 -> V_14 = 0 ;
V_48 = F_122 ( V_91 , V_142 ,
V_143 , V_2 ) ;
if ( F_62 ( V_48 ) )
return V_48 ;
V_48 = F_123 ( V_91 , L_42 , NULL , & V_70 ) ;
if ( F_62 ( V_48 ) )
return V_48 ;
V_2 -> V_21 = V_70 ;
V_70 = 0 ;
F_123 ( V_91 , L_43 , NULL , & V_70 ) ;
V_2 -> V_75 = V_70 ;
V_2 -> V_91 = V_91 ;
return V_144 ;
}
...
F_81 ( V_2 , false ) ;
if ( F_2 ( V_27 , & V_2 -> V_4 ) ) {
if ( F_62 ( F_130 ( NULL , V_2 -> V_21 ,
& F_111 ) ) )
F_126 ( L_47 ) ;
F_30 ( V_27 , & V_2 -> V_4 ) ;
}
}
static struct V_1 * F_131 ( void )
{
struct V_1 * V_2 ;
if ( V_148 ) {
V_2 = V_148 ;
...
struct V_1 * V_2 = NULL ;
int V_41 ;
strcpy ( F_133 ( V_150 ) , V_151 ) ;
strcpy ( F_134 ( V_150 ) , V_152 ) ;
V_2 = F_131 () ;
if ( ! V_2 )
return - V_105 ;
if ( F_121 ( V_150 -> V_91 , 0 , V_2 , NULL ) !=
V_144 ) {
F_92 ( V_2 ) ;
return - V_71 ;
}
F_135 ( V_153 , V_2 -> V_91 , 1 ,
F_118 , NULL , V_2 , NULL ) ;
if ( ! V_88 )
V_88 = V_2 ;
V_150 -> V_154 = V_2 ;
V_41 = ! ! F_136 ( V_2 -> V_14 , 1 , L_48 ) ;
F_137 ( ! V_41 , L_49 , V_2 -> V_14 ) ;
V_41 = ! ! F_136 ( V_2 -> V_8 , 1 , L_50 ) ;
F_137 ( ! V_41 , L_51 , V_2 -> V_8 ) ;
F_77 ( L_52 ,
...
static int F_139 ( struct V_149 * V_150 )
{
struct V_1 * V_2 ;
if ( ! V_150 )
return - V_71 ;
...
static T_6
V_143 ( struct V_155 * V_156 , void * V_134 )
{
struct V_1 * V_2 = V_134 ;
if ( V_156 -> type != V_157 )
return V_132 ;
if ( V_2 -> V_14 == 0 )
V_2 -> V_14 = V_156 -> V_18 . V_158 . V_159 ;
else if ( V_2 -> V_8 == 0 )
V_2 -> V_8 = V_156 -> V_18 . V_158 . V_159 ;
else
return V_144 ;
return V_132 ;
}
...
if ( ! V_2 )
return - V_105 ;
V_48 = F_143 ( V_160 [ 0 ] . V_161 ,
F_121 , V_2 , NULL ) ;
if ( F_62 ( V_48 ) || ! V_2 -> V_91 ) {
V_41 = - V_77 ;
goto error;
}
V_41 = F_124 ( V_2 ) ;
...
static int F_144 ( const struct V_162 * V_161 )
{
F_55 ( L_53 ) ;
V_97 = 1 ;
V_37 = V_38 ;
...
static int F_145 ( const struct V_162 * V_161 )
{
F_55 ( L_54 ) ;
V_163 = 1 ;
return 0 ;
...
F_77 ( L_55 ) ;
if ( V_163 ) {
V_2 -> V_8 = V_165 -> V_18 . V_81 ;
V_2 -> V_14 = V_165 -> V_169 . V_81 ;
} else {
V_2 -> V_8 = V_165 -> V_169 . V_81 ;
V_2 -> V_14 = V_165 -> V_18 . V_81 ;
}
V_2 -> V_21 = V_165 -> V_21 ;
V_2 -> V_91 = V_170 ;
V_41 = F_124 ( V_2 ) ;
...
static int F_149 ( const char * V_86 , struct V_171 * V_172 )
{
int V_82 = 0 ;
...
static int F_150 ( char * V_138 , struct V_171 * V_172 )
{
switch ( V_37 ) {
case V_38 :
return sprintf ( V_138 , L_56 ) ;
case V_39 :
return sprintf ( V_138 , L_58 ) ;
case V_44 :
return sprintf ( V_138 , L_60 ) ;
default:
return sprintf ( V_138 , L_62 ) ;
}
return 0 ;
}
