...
static int F_45 ( struct V_33 * V_34 , struct V_33 * V_72 , void * V_46 )
{
struct V_1 * V_7 = F_21 ( V_34 ) ;
...
V_75 . V_80 = V_76 ;
V_75 . type = V_81 [ V_76 ] ;
V_41 = F_47 ( V_23 , & V_7 -> V_31 [ V_76 ] , V_76 ,
1 << V_7 -> V_27 , & V_75 ) ;
if ( V_41 )
return V_41 ;
}
V_73 = & V_7 -> V_31 [ V_82 ] ;
V_7 -> V_6 = F_48 ( V_23 , & V_73 -> V_18 ,
V_7 -> V_27 , V_83 ,
& V_84 , V_7 ) ;
if ( F_49 ( V_7 -> V_6 ) ) {
F_38 ( L_13 ) ;
...
static void F_55 ( struct V_33 * V_34 , struct V_33 * V_72 , void * V_46 )
{
}
...
struct V_1 * V_7 ;
int V_41 ;
V_7 = F_57 ( & V_90 -> V_34 , sizeof( * V_7 ) , V_63 ) ;
if ( ! V_7 )
return - V_52 ;
V_7 -> V_90 = V_90 ;
F_58 ( & V_7 -> V_13 , F_16 ) ;
F_59 ( & V_7 -> V_21 ) ;
F_60 ( V_90 , V_7 ) ;
V_41 = F_61 ( & V_90 -> V_34 , & V_91 ) ;
if ( V_41 < 0 ) {
F_38 ( L_16 ) ;
return V_41 ;
}
V_41 = F_62 ( & V_90 -> V_34 , & V_92 ) ;
if ( V_41 )
goto V_93;
return V_41 ;
V_93:
