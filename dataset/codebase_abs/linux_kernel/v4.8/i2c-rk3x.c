...
struct V_72 * V_73 )
{
unsigned long V_74 , V_75 , V_77 ;
unsigned long V_93 , V_100 ;
...
V_104 = F_26 ( V_78 * V_93
- 1000000 , 8 * 1000000 * ( V_73 -> V_98 ) ) ;
V_101 = V_71 -> V_92 + V_89 -> V_101 ;
V_105 = F_26 ( V_78 * V_101
- 1000000 , 8 * 1000000 * ( V_73 -> V_98 ) ) ;
V_73 -> V_107 = F_29 ( -- V_103 ) |
F_30 ( -- V_104 ) |
F_31 ( -- V_105 ) ;
V_73 -> V_97 -- ;
V_73 -> V_98 -- ;
...
V_90 = F_71 ( & V_2 -> V_139 ) ;
if ( V_90 < 0 ) {
F_15 ( & V_150 -> V_46 , L_26 ) ;
goto V_179;
}
F_72 ( & V_150 -> V_46 , L_27 , V_2 -> V_5 ) ;
return 0 ;
V_179:
