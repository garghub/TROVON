...
static T_2 F_36 ( struct V_107 * V_119 )
{
...
{
unsigned int V_124 ;
int V_125 = F_38 ( V_2 -> V_5 -> V_126 , L_18 ,
& V_124 ) ;
if ( V_125 < 0 ) {
F_4 ( V_2 -> V_5 , L_19 ) ;
return - V_127 ;
...
struct V_107 * V_119 ;
struct V_137 * V_138 ;
V_2 = F_40 ( & V_136 -> V_2 , sizeof( * V_2 ) , V_139 ) ;
if ( ! V_2 )
return - V_140 ;
F_41 ( V_136 , V_2 ) ;
V_2 -> V_5 = & V_136 -> V_2 ;
F_42 ( & V_2 -> V_34 ) ;
V_138 = F_43 ( V_136 , V_141 , 0 ) ;
V_2 -> V_12 = F_44 ( V_2 -> V_5 , V_138 ) ;
if ( F_45 ( V_2 -> V_12 ) )
return - V_140 ;
V_2 -> V_104 = F_46 ( V_2 -> V_5 , NULL ) ;
if ( F_45 ( V_2 -> V_104 ) ) {
F_4 ( V_2 -> V_5 , L_22 ) ;
return - V_127 ;
}
...
V_30 ,
V_2 -> V_12 + V_27 ) ;
V_2 -> V_24 = F_47 ( V_136 , 0 ) ;
if ( V_2 -> V_24 < 0 ) {
F_4 ( V_2 -> V_5 , L_24 ) ;
V_41 = - V_127 ;
goto V_142;
}
V_41 = F_48 ( & V_136 -> V_2 , V_2 -> V_24 , F_8 ,
...
F_49 ( V_119 , V_2 ) ;
V_119 -> V_149 = V_150 ;
F_50 ( V_119 -> V_148 , L_26 , sizeof( V_119 -> V_148 ) ) ;
V_119 -> V_151 = & V_152 ;
