...
const char * type ;
int V_106 ;
type = F_46 ( V_93 , L_26 , NULL ) ;
if ( ! type || strcmp ( type , L_27 ) ) {
F_14 ( V_10 , L_28 , type ) ;
return - V_41 ;
}
V_106 = F_47 ( V_93 , 0 , & V_105 ) ;
if ( V_106 ) {
F_14 ( V_10 , L_29 ) ;
return V_106 ;
}
V_2 -> V_4 = F_48 ( V_10 , & V_105 ) ;
if ( F_49 ( V_2 -> V_4 ) )
return F_50 ( V_2 -> V_4 ) ;
V_2 -> V_24 = F_51 ( V_93 , 0 ) ;
V_106 = F_52 ( V_10 , V_2 -> V_24 , F_31 ,
V_107 | V_108 ,
L_30 , V_2 ) ;
if ( V_106 ) {
...
static int F_53 ( struct V_109 * V_34 )
{
struct V_1 * V_2 ;
...
V_106 = F_56 ( V_10 -> V_94 , 0 , 0xff , & V_111 ,
& V_110 ) ;
if ( V_106 ) {
F_14 ( V_10 , L_34 ) ;
return V_106 ;
}
V_106 = F_57 ( V_10 , & V_111 ) ;
if ( V_106 )
goto error;
V_14 = F_58 ( & V_34 -> V_10 , 0 ,
& V_113 , V_2 , & V_111 ) ;
if ( ! V_14 ) {
V_106 = - V_112 ;
goto error;
...
static int F_66 ( struct V_109 * V_34 )
{
struct V_1 * V_2 = F_67 ( V_34 ) ;
F_37 ( V_2 ) ;
return 0 ;
}
