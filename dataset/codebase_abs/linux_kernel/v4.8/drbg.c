...
static void F_92 ( struct V_149 * V_83 , int error )
{
...
V_12 -> V_145 = V_139 ;
if ( snprintf ( V_157 , V_158 , L_29 ,
V_12 -> V_95 -> V_142 ) >= V_158 ) {
F_87 ( V_12 ) ;
return - V_45 ;
}
V_154 = F_97 ( V_157 , 0 , 0 ) ;
if ( F_68 ( V_154 ) ) {
F_70 ( L_30 ,
V_157 ) ;
F_87 ( V_12 ) ;
...
{
struct V_163 V_164 ;
F_103 ( & V_164 , V_160 , V_161 ) ;
while ( V_66 ) {
T_7 V_165 = F_21 ( T_7 , V_161 , V_66 ) ;
struct V_163 V_166 ;
int V_17 ;
F_103 ( & V_166 , V_162 , V_165 ) ;
F_104 ( V_12 -> V_147 , & V_164 , & V_166 ,
V_165 , V_12 -> V_50 ) ;
V_17 = F_105 ( V_12 -> V_147 ) ;
switch ( V_17 ) {
case 0 :
break;
case - V_150 :
...
static inline void F_109 ( const char * V_168 ,
int * V_132 , bool * V_121 )
{
int V_39 = 0 ;
T_4 V_169 = 0 ;
int V_23 = 0 ;
* V_121 = true ;
if ( ! memcmp ( V_168 , L_32 , 10 ) ) {
V_169 = 10 ;
* V_121 = false ;
} else if ( ! memcmp ( V_168 , L_33 , 8 ) ) {
V_169 = 8 ;
} else {
return;
}
V_23 = strlen ( V_168 ) - V_169 ;
for ( V_39 = 0 ; F_110 ( V_133 ) > V_39 ; V_39 ++ ) {
if ( ! memcmp ( V_168 + V_169 , V_133 [ V_39 ] . V_170 ,
V_23 ) ) {
* V_132 = V_39 ;
return;
}
...
static int F_111 ( struct V_171 * V_139 )
{
struct V_11 * V_12 = F_112 ( V_139 ) ;
F_113 ( & V_12 -> V_97 ) ;
return 0 ;
}
static void F_114 ( struct V_171 * V_139 )
{
F_71 ( F_112 ( V_139 ) ) ;
}
static int F_115 ( struct V_138 * V_139 ,
const T_6 * V_82 , unsigned int V_172 ,
T_6 * V_67 , unsigned int V_173 )
{
struct V_11 * V_12 = F_75 ( V_139 ) ;
struct V_18 * V_54 = NULL ;
struct V_18 string ;
if ( V_172 ) {
F_5 ( & string , V_82 , V_172 ) ;
V_54 = & string ;
}
return F_60 ( V_12 , V_67 , V_173 , V_54 ) ;
}
static int F_116 ( struct V_138 * V_139 ,
const T_6 * V_44 , unsigned int V_172 )
{
struct V_11 * V_12 = F_75 ( V_139 ) ;
struct V_171 * V_174 = F_117 ( V_139 ) ;
bool V_121 = false ;
struct V_18 string ;
struct V_18 * V_175 = NULL ;
int V_132 = 0 ;
F_109 ( F_118 ( V_174 ) , & V_132 ,
& V_121 ) ;
if ( 0 < V_172 ) {
F_5 ( & string , V_44 , V_172 ) ;
V_175 = & string ;
}
return F_67 ( V_12 , V_175 , V_132 , V_121 ) ;
}
static inline int T_8 F_119 ( void )
{
int V_23 = 0 ;
#define F_120 16
unsigned char V_7 [ F_120 ] ;
...
return 0 ;
#ifdef F_54
F_109 ( L_34 , & V_132 , & V_121 ) ;
#elif V_179 F_53
F_109 ( L_35 , & V_132 , & V_121 ) ;
#else
F_109 ( L_36 , & V_132 , & V_121 ) ;
#endif
V_12 = F_57 ( sizeof( struct V_11 ) , V_117 ) ;
if ( ! V_12 )
return - V_105 ;
F_113 ( & V_12 -> V_97 ) ;
V_17 = F_67 ( V_12 , NULL , V_132 , V_121 ) ;
if ( V_17 ) {
V_176 = V_17 ;
goto V_162;
}
V_177 = F_46 ( V_12 ) ;
V_178 = F_59 ( V_12 ) ;
F_5 ( & V_54 , V_7 , V_177 + 1 ) ;
V_23 = F_58 ( V_12 , V_7 , F_120 , & V_54 ) ;
F_38 ( 0 < V_23 ) ;
V_23 = F_58 ( V_12 , V_7 , ( V_178 + 1 ) , NULL ) ;
F_38 ( 0 < V_23 ) ;
F_71 ( V_12 ) ;
V_17 = F_67 ( V_12 , & V_54 , V_132 , V_121 ) ;
F_38 ( 0 == V_17 ) ;
V_176 = 0 ;
F_47 ( L_37
L_38 ) ;
...
static inline void T_8 F_121 ( struct V_180 * V_181 ,
const struct V_182 * V_95 , int V_121 )
{
int V_22 = 0 ;
static int V_183 = 200 ;
memcpy ( V_181 -> V_184 . V_170 , L_39 , 6 ) ;
if ( V_121 ) {
memcpy ( V_181 -> V_184 . V_168 , L_33 , 8 ) ;
V_22 = 8 ;
} else {
memcpy ( V_181 -> V_184 . V_168 , L_32 , 10 ) ;
V_22 = 10 ;
}
memcpy ( V_181 -> V_184 . V_168 + V_22 , V_95 -> V_170 ,
strlen ( V_95 -> V_170 ) ) ;
V_181 -> V_184 . V_185 = V_183 ;
V_183 ++ ;
if ( V_136 )
V_181 -> V_184 . V_185 += 200 ;
V_181 -> V_184 . V_186 = sizeof( struct V_11 ) ;
V_181 -> V_184 . V_187 = V_129 ;
V_181 -> V_184 . V_188 = F_111 ;
V_181 -> V_184 . V_189 = F_114 ;
V_181 -> V_122 = F_115 ;
V_181 -> V_44 = F_116 ;
V_181 -> V_190 = F_74 ;
V_181 -> V_191 = 0 ;
...
if ( V_17 )
return V_17 ;
if ( F_110 ( V_133 ) * 2 > F_110 ( V_193 ) ) {
F_70 ( L_40
L_41 ,
F_110 ( V_133 ) * 2 , F_110 ( V_193 ) ) ;
return V_17 ;
}
for ( V_192 = 0 ; F_110 ( V_133 ) > V_192 ; V_192 ++ , V_39 ++ )
F_121 ( & V_193 [ V_39 ] , & V_133 [ V_192 ] , 1 ) ;
for ( V_192 = 0 ; F_110 ( V_133 ) > V_192 ; V_192 ++ , V_39 ++ )
F_121 ( & V_193 [ V_39 ] , & V_133 [ V_192 ] , 0 ) ;
return F_123 ( V_193 , ( F_110 ( V_133 ) * 2 ) ) ;
}
static void T_9 F_124 ( void )
{
F_125 ( V_193 , ( F_110 ( V_133 ) * 2 ) ) ;
}
