...
static void F_86 ( struct V_37 * V_38 )
{
struct V_5 * V_6 ;
struct V_3 * V_4 ;
V_4 = F_50 ( V_38 , struct V_3 , V_40 . V_38 ) ;
...
static int F_87 ( struct V_65 * V_5 , struct V_98 * V_18 ,
int V_99 , int V_137 )
{
int V_94 ;
struct V_5 * V_6 ;
...
static int F_96 ( struct V_65 * V_5 , struct V_65 * V_156 , int V_137 )
{
struct V_5 * V_26 ;
int V_94 ;
struct V_5 * V_31 ;
...
V_145 = F_97 ( V_26 , V_137 & V_153 ) ;
F_89 ( F_81 ( V_26 ) , & V_110 , V_152 ) ;
while ( ( V_31 = F_44 ( V_26 ) ) == NULL &&
V_26 -> V_112 == 0 ) {
F_53 ( V_26 ) ;
V_145 = F_92 ( V_145 ) ;
F_95 ( F_81 ( V_26 ) , & V_110 ) ;
F_51 ( V_26 ) ;
if ( F_93 ( V_155 ) ) {
V_94 = F_94 ( V_145 ) ;
goto V_44;
...
static int F_99 ( struct V_65 * V_5 , int V_158 )
{
int V_94 ;
struct V_5 * V_6 ;
struct V_3 * V_4 ;
...
static int F_100 ( struct V_65 * V_5 ,
int V_160 ,
int V_161 ,
char T_6 * V_162 ,
unsigned int V_163 )
...
F_102 ( V_174 . V_176 , ( 1000000 / V_179 ) ) ;
if ( V_4 -> V_83 == 0 )
V_4 -> V_83 =
V_85 ;
} else {
...
static int F_103 ( struct V_65 * V_5 ,
int V_160 , int V_161 ,
char T_6 * V_162 ,
int T_6 * V_163 )
{
...
V_94 = F_106 ( V_129 , V_163 ) ;
if ( V_94 != 0 )
return - V_184 ;
#undef F_105
return 0 ;
}
static int F_107 ( struct V_65 * V_5 , struct V_127 * V_128 ,
T_5 V_129 )
{
struct V_5 * V_6 ;
struct V_3 * V_4 ;
...
V_145 = F_97 ( V_6 , V_128 -> V_130 & V_190 ) ;
...
static int
F_108 ( struct V_65 * V_5 , struct V_127 * V_128 , T_5 V_129 ,
int V_137 )
{
struct V_5 * V_6 ;
struct V_3 * V_4 ;
...
V_199 = F_110 ( V_6 , V_137 & V_203 , V_129 ) ;
if ( V_199 >= V_1 -> V_204 ( V_4 ) ) {
V_94 = - V_197 ;
goto V_44;
}
V_145 = F_111 ( V_6 , V_137 & V_190 ) ;
V_200 = 0 ;
...
static int F_112 ( struct V_64 * V_64 , struct V_65 * V_5 ,
int V_213 , int V_68 )
{
if ( ! V_5 )
return - V_60 ;
...
V_5 -> V_97 = V_104 ;
return F_58 ( V_64 , V_5 , NULL , V_220 , 0 , V_68 ) ? 0 : - V_197 ;
}
static long F_113 ( struct V_109 * V_221 ,
...
{
return F_113 ( V_221 , V_222 , ( void T_6 * ) V_226 ) ;
}
static long F_116 ( struct V_109 * V_221 ,
unsigned int V_222 , unsigned long V_226 )
{
return F_113 ( V_221 , V_222 , F_117 ( V_226 ) ) ;
}
int F_118 ( const struct V_227 * V_228 , struct V_229 * V_82 )
{
int V_94 = F_119 ( & V_230 ) ;
if ( V_94 )
return V_94 ;
if ( V_1 ) {
V_94 = - V_231 ;
