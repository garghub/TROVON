...
static struct V_42 * F_51 ( struct V_54 * V_55 ,
unsigned int V_24 )
{
...
F_53 ( & V_43 -> V_46 , L_29 , V_43 -> V_51 -> V_77 , V_43 -> V_25 ) ;
if ( ! F_54 ( & V_43 -> V_46 ) )
goto V_102;
V_43 -> V_52 = F_55 ( V_29 , L_30 , F_54 ( & V_43 -> V_46 ) ) ;
if ( ! V_43 -> V_52 )
goto V_102;
F_34 ( & V_43 -> V_46 , L_31 , V_43 -> V_52 ) ;
F_7 ( & V_55 -> V_71 ) ;
F_56 (tmp_dev, &s->devices_list, socket_device_list)
if ( V_43 -> V_60 == V_45 -> V_60 ) {
V_43 -> V_53 = V_45 -> V_53 ;
V_43 -> V_69 = V_45 -> V_69 ;
F_57 ( & V_43 -> V_53 -> V_48 ) ;
}
F_58 ( & V_43 -> V_78 , & V_55 -> V_107 ) ;
if ( F_59 ( V_43 ) )
F_60 ( & V_43 -> V_46 ,
L_32 ) ;
if ( ! V_43 -> V_53 ) {
...
static int F_69 ( struct V_44 * V_46 , void * V_125 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
if ( ! V_43 -> V_46 . V_15 ) {
F_34 ( V_46 , L_41 ) ;
...
static int F_73 ( struct V_42 * V_46 , char * V_132 )
{
...
if ( F_74 ( & V_134 , V_132 , & V_46 -> V_46 ) == 0 ) {
if ( V_134 -> V_135 >= V_136 ) {
V_57 = - V_28 ;
F_75 ( & V_46 -> V_46 , L_44 ) ;
goto V_104;
}
if ( ! F_68 ( V_55 , V_134 -> V_137 , V_134 -> V_135 ) )
V_57 = 0 ;
else {
F_75 ( & V_46 -> V_46 , L_45 ) ;
goto V_104;
...
static inline int F_77 ( struct V_42 * V_46 ,
...
static int F_78 ( struct V_44 * V_46 , struct V_14 * V_36 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
...
struct V_18 * V_19 ;
F_7 ( & V_2 -> V_32 . V_33 ) ;
F_56 (dynid, &p_drv->dynids.list, node) {
F_34 ( V_46 , L_49 , V_36 -> V_10 ) ;
if ( F_77 ( V_43 , & V_19 -> V_31 ) ) {
...
static int F_79 ( struct V_44 * V_46 , struct V_152 * V_153 )
{
struct V_42 * V_43 ;
int V_6 ;
T_1 V_7 [ 4 ] = { 0 , 0 , 0 , 0 } ;
...
if ( F_80 ( V_153 , L_51 , V_43 -> V_51 -> V_77 ) )
return - V_30 ;
if ( F_80 ( V_153 , L_52 , V_43 -> V_25 ) )
return - V_30 ;
if ( F_80 ( V_153 , L_53
L_54 ,
...
static T_2 F_87 ( struct V_44 * V_46 , struct V_155 * V_156 ,
char * V_16 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
...
static T_2 F_89 ( struct V_44 * V_46 , struct V_155 * V_156 , char * V_16 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
if ( V_43 -> V_158 )
...
static T_2 F_90 ( struct V_44 * V_46 , struct V_155 * V_156 ,
...
if ( ! V_17 )
return - V_28 ;
if ( ( ! V_43 -> V_158 ) && ! strncmp ( V_16 , L_59 , 3 ) )
V_57 = F_81 ( V_46 ) ;
else if ( V_43 -> V_158 && ! strncmp ( V_16 , L_60 , 2 ) )
V_57 = F_85 ( V_46 ) ;
return V_57 ? V_57 : V_17 ;
}
static T_2 F_91 ( struct V_44 * V_46 , struct V_155 * V_156 , char * V_16 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
int V_6 ;
T_1 V_7 [ 4 ] = { 0 , 0 , 0 , 0 } ;
...
static T_2 F_92 ( struct V_44 * V_46 ,
...
static int F_83 ( struct V_44 * V_46 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
struct V_1 * V_2 = NULL ;
int V_57 = 0 ;
...
static int F_86 ( struct V_44 * V_46 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
struct V_1 * V_2 = NULL ;
int V_57 = 0 ;
...
{
struct V_54 * V_162 = V_125 ;
struct V_42 * V_43 = F_28 ( V_46 ) ;
if ( V_43 -> V_51 != V_162 || V_43 -> V_158 )
return 0 ;
return F_81 ( V_46 ) ;
}
static int F_96 ( struct V_44 * V_46 , void * V_125 )
{
struct V_54 * V_162 = V_125 ;
struct V_42 * V_43 = F_28 ( V_46 ) ;
if ( V_43 -> V_51 != V_162 || ! V_43 -> V_158 )
...
static int F_97 ( struct V_54 * V_162 )
{
F_34 ( & V_162 -> V_46 , L_68 , V_162 -> V_77 ) ;
F_71 ( & V_40 , NULL , V_162 , F_96 ) ;
return 0 ;
}
static int F_98 ( struct V_54 * V_162 )
{
F_34 ( & V_162 -> V_46 , L_69 , V_162 -> V_77 ) ;
if ( F_71 ( & V_40 , NULL , V_162 ,
F_95 ) ) {
F_97 ( V_162 ) ;
return - V_121 ;
}
...
static int F_99 ( struct V_54 * V_162 )
{
F_100 ( & V_162 -> V_163 , 0 ) ;
F_43 ( V_162 , NULL ) ;
F_7 ( & V_162 -> V_71 ) ;
...
static int F_103 ( struct V_54 * V_162 )
{
F_100 ( & V_162 -> V_163 , 1 ) ;
F_7 ( & V_162 -> V_71 ) ;
V_162 -> V_72 = 0 ;
...
static int F_104 ( struct V_54 * V_162 )
{
if ( ! F_105 ( V_162 ) )
return 0 ;
F_34 ( & V_162 -> V_46 , L_70 ) ;
F_99 ( V_162 ) ;
F_7 ( & V_162 -> V_71 ) ;
F_101 ( V_162 ) ;
F_14 ( V_162 -> V_129 ) ;
...
struct V_42 * F_106 ( struct V_42 * V_164 )
{
struct V_42 * V_43 ;
...
if ( ! V_43 )
return NULL ;
if ( F_107 ( & V_43 -> V_51 -> V_163 ) != 0 )
V_57 = V_43 ;
F_29 ( V_43 ) ;
return V_57 ;
}
static int F_108 ( struct V_44 * V_46 ,
struct V_165 * V_166 )
{
struct V_54 * V_51 = F_109 ( V_46 ) ;
int V_57 ;
V_51 = F_52 ( V_51 ) ;
if ( ! V_51 ) {
F_75 ( V_46 , L_71 ) ;
...
static void F_112 ( struct V_44 * V_46 ,
struct V_165 * V_166 )
{
struct V_54 * V_51 = F_109 ( V_46 ) ;
if ( ! V_51 )
...
F_113 ( V_51 ) ;
F_9 ( & V_51 -> V_170 ) ;
F_114 ( & V_46 -> V_167 , & V_168 ) ;
F_35 ( V_51 ) ;
return;
}
static int T_13 F_115 ( void )
{
int V_57 ;
V_57 = F_116 ( & V_40 ) ;
if ( V_57 < 0 ) {
