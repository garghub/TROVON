...
static inline void F_2 ( struct V_1 * V_2 , int V_3 , T_1 V_4 )
{
if ( V_3 < 31 )
V_2 -> V_2 [ V_3 ] = F_3 ( V_4 ) ;
}
...
{
if ( V_3 < 31 )
return F_3 ( V_2 -> V_2 [ V_3 ] ) ;
else
return 0 ;
}
static bool T_3 F_6 ( T_2 V_5 , struct V_1 * V_2 )
{
int V_6 = V_5 & 0x1f ;
return ( V_5 & ( 1 << 31 ) ) ?
( F_4 ( V_2 , V_6 ) == 0 ) : ( F_5 ( V_2 , V_6 ) == 0 ) ;
}
static bool T_3 F_7 ( T_2 V_5 , struct V_1 * V_2 )
{
int V_6 = V_5 & 0x1f ;
return ( V_5 & ( 1 << 31 ) ) ?
( F_4 ( V_2 , V_6 ) != 0 ) : ( F_5 ( V_2 , V_6 ) != 0 ) ;
...
void T_3
F_10 ( T_2 V_5 , long V_8 , struct V_1 * V_2 )
{
long V_9 , V_6 , V_4 ;
V_6 = V_5 & 0x1f ;
...
void T_3
F_14 ( T_2 V_5 , long V_8 , struct V_1 * V_2 )
{
int V_10 = F_15 ( V_5 ) ;
if ( V_5 & ( 1 << 31 ) )
F_1 ( V_2 , 30 , V_8 + 4 ) ;
...
{
int V_6 = ( V_5 >> 5 ) & 0x1f ;
F_12 ( V_2 , F_4 ( V_2 , V_6 ) ) ;
if ( ( ( V_5 >> 21 ) & 0x3 ) == 1 )
F_1 ( V_2 , 30 , V_8 + 4 ) ;
}
void T_3
F_19 ( T_2 V_5 , long V_8 , struct V_1 * V_2 )
{
int V_10 = 4 ;
if ( V_5 & ( 1 << 24 ) ) {
if ( F_7 ( V_5 , V_2 ) )
