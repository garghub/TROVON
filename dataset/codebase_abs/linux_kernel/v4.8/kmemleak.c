...
{
T_7 V_91 = V_4 -> V_31 ;
if ( ! F_96 ( V_4 -> V_6 , V_4 -> V_8 ) )
return false ;
F_4 () ;
V_4 -> V_31 = F_97 ( 0 , ( void * ) V_4 -> V_6 , V_4 -> V_8 ) ;
F_6 () ;
...
F_135 ( V_60 , 10 ) ;
if ( V_120 ) {
signed long V_121 = F_136 ( V_122 * 1000 ) ;
V_120 = 0 ;
while ( V_121 && ! F_100 () )
V_121 = F_137 ( V_121 ) ;
}
while ( ! F_100 () ) {
signed long V_121 = V_123 ;
F_138 ( & V_124 ) ;
F_116 () ;
F_139 ( & V_124 ) ;
while ( V_121 && ! F_100 () )
...
if ( strncmp ( V_141 , L_40 , 3 ) == 0 )
F_46 () ;
else if ( strncmp ( V_141 , L_41 , 8 ) == 0 )
V_111 = 1 ;
else if ( strncmp ( V_141 , L_42 , 9 ) == 0 )
V_111 = 0 ;
else if ( strncmp ( V_141 , L_43 , 7 ) == 0 )
F_140 () ;
else if ( strncmp ( V_141 , L_44 , 8 ) == 0 )
F_142 () ;
else if ( strncmp ( V_141 , L_45 , 5 ) == 0 ) {
unsigned long V_146 ;
...
F_142 () ;
if ( V_146 ) {
V_123 = F_136 ( V_146 * 1000 ) ;
F_140 () ;
}
} else if ( strncmp ( V_141 , L_46 , 4 ) == 0 )
F_116 () ;
else if ( strncmp ( V_141 , L_47 , 5 ) == 0 )
V_143 = F_153 ( V_141 + 5 ) ;
else
V_143 = - V_138 ;
V_63:
...
static int F_162 ( char * V_136 )
{
if ( ! V_136 )
return - V_138 ;
if ( strcmp ( V_136 , L_40 ) == 0 )
F_46 () ;
else if ( strcmp ( V_136 , L_50 ) == 0 )
V_151 = 1 ;
else
return - V_138 ;
return 0 ;
}
static void T_4 F_163 ( struct V_73 * log )
{
struct V_28 V_27 ;
V_27 . V_29 = log -> V_26 ;
V_27 . V_30 = log -> V_27 ;
...
#endif
V_20 = F_136 ( V_152 ) ;
V_123 = F_136 ( V_153 * 1000 ) ;
V_47 = F_166 ( V_3 , V_154 ) ;
V_46 = F_166 ( V_43 , V_154 ) ;
if ( V_75 > F_76 ( V_73 ) )
F_45 ( L_52 ,
V_75 ) ;
F_77 ( V_17 ) ;
...
V_156 = F_168 ( L_36 , V_158 , NULL , NULL ,
& V_159 ) ;
if ( ! V_156 )
F_45 ( L_54 ) ;
F_138 ( & V_124 ) ;
