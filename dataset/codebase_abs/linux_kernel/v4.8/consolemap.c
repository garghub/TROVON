...
int F_26 ( struct V_1 * V_21 , T_3 V_48 , struct V_49 T_2 * V_50 )
{
int V_51 = 0 , V_52 , V_5 ;
struct V_3 * V_4 , * V_10 ;
if ( ! V_48 )
...
int F_29 ( struct V_1 * V_21 , T_3 V_48 , T_3 T_2 * V_60 , struct V_49 T_2 * V_50 )
{
int V_5 , V_6 , V_15 , V_61 ;
T_1 * * V_16 , * V_17 ;
struct V_3 * V_4 ;
F_11 () ;
V_61 = 0 ;
...
F_15 ( V_61 , V_60 ) ;
F_13 () ;
return ( ( V_61 <= V_48 ) ? 0 : - V_46 ) ;
}
T_5 F_30 ( unsigned char V_62 )
{
unsigned short V_63 = V_9 [ V_29 ] [ V_62 ] ;
return V_63 == ( 0xf000 | V_62 ) ? V_62 : V_63 ;
}
int F_31 ( T_5 V_63 )
{
int V_62 ;
for ( V_62 = 0 ; V_62 < 0x100 ; V_62 ++ )
if ( V_9 [ V_29 ] [ V_62 ] == V_63 ||
( V_9 [ V_29 ] [ V_62 ] == ( V_62 | 0xf000 ) && V_63 == V_62 ) )
return V_62 ;
return - 1 ;
}
int
F_3 ( struct V_1 * V_2 , long V_64 )
{
int V_65 ;
T_1 * * V_16 , * V_17 ;
struct V_3 * V_4 ;
...
return - 1 ;
else if ( V_64 == 0xfeff || ( V_64 >= 0x200b && V_64 <= 0x200f ) )
return - 2 ;
else if ( ( V_64 & ~ V_66 ) == V_34 )
return V_64 & V_66 ;
if ( ! * V_2 -> V_25 )
return - 3 ;
V_4 = * V_2 -> V_25 ;
if ( ( V_16 = V_4 -> V_19 [ V_64 >> 11 ] ) &&
( V_17 = V_16 [ ( V_64 >> 6 ) & 0x1f ] ) &&
( V_65 = V_17 [ V_64 & 0x3f ] ) < V_12 )
return V_65 ;
return - 4 ;
}
void T_6
