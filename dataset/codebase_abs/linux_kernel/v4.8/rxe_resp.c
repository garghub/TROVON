...
static enum V_15 F_63 ( struct V_3 * V_4 , struct V_8 * V_9 )
{
enum V_15 V_121 ;
if ( V_9 -> V_34 & V_183 ) {
if ( F_13 ( V_4 ) == V_67 ||
...
memcpy ( & V_155 . V_187 , F_66 ( V_6 ) , sizeof( V_155 . V_187 ) ) ;
else if ( V_6 -> V_185 == F_65 ( V_188 ) )
memcpy ( & V_155 . V_189 , F_67 ( V_6 ) , sizeof( V_155 . V_189 ) ) ;
...
static enum V_15 F_68 ( struct V_3 * V_4 ,
struct V_8 * V_9 )
{
struct V_193 V_194 ;
...
V_199 -> V_209 |= V_211 ;
V_199 -> V_212 . V_213 =
( V_214 V_215 ) F_69 ( V_9 ) ;
}
if ( V_9 -> V_34 & V_216 ) {
V_199 -> V_209 |= V_217 ;
V_199 -> V_212 . V_218 = F_70 ( V_9 ) ;
}
V_199 -> V_219 = V_4 -> V_89 . V_219 ;
if ( V_9 -> V_34 & V_220 )
V_199 -> V_221 = F_71 ( V_9 ) ;
...
if ( V_9 -> V_34 & V_202 ) {
V_196 -> V_209 |= V_211 ;
V_196 -> V_212 . V_213 = F_69 ( V_9 ) ;
}
if ( V_9 -> V_34 & V_216 ) {
struct V_1 * V_2 = F_38 ( V_4 -> V_89 . V_88 ) ;
struct V_101 * V_227 ;
V_196 -> V_209 |= V_217 ;
V_196 -> V_212 . V_218 = F_70 ( V_9 ) ;
V_227 = F_72 ( & V_2 -> V_228 ,
V_196 -> V_212 . V_218 >> 8 ) ;
if ( F_34 ( ! V_227 ) ) {
F_61 ( L_3 , V_196 -> V_212 . V_218 ) ;
return V_229 ;
}
V_227 -> V_17 = V_115 ;
}
...
F_21 ( V_4 -> V_74 . V_75 ) ;
V_4 -> V_13 . V_77 = NULL ;
if ( F_73 ( V_4 -> V_207 , & V_194 , V_9 ? F_74 ( V_9 ) : 1 ) )
return V_230 ;
if ( V_4 -> V_13 . V_17 == V_18 )
return V_20 ;
if ( ! V_9 )
...
static int F_75 ( struct V_3 * V_4 , struct V_8 * V_9 ,
T_3 V_142 , T_2 V_26 )
{
int V_121 = 0 ;
struct V_8 V_163 ;
...
static int F_77 ( struct V_3 * V_4 , struct V_8 * V_9 ,
T_3 V_142 )
{
int V_128 = 0 ;
struct V_8 V_163 ;
...
static enum V_15 F_81 ( struct V_3 * V_4 ,
struct V_8 * V_9 )
{
if ( F_13 ( V_4 ) != V_27 )
return V_29 ;
if ( V_4 -> V_13 . V_238 != V_179 )
F_75 ( V_4 , V_9 , V_4 -> V_13 . V_238 , V_9 -> V_26 ) ;
else if ( V_9 -> V_34 & V_64 )
F_77 ( V_4 , V_9 , V_179 ) ;
else if ( F_82 ( V_9 ) )
F_75 ( V_4 , V_9 , V_179 , V_9 -> V_26 ) ;
return V_29 ;
}
static enum V_15 F_83 ( struct V_3 * V_4 ,
struct V_8 * V_9 )
{
struct V_5 * V_6 ;
if ( V_9 ) {
...
static struct V_164 * F_84 ( struct V_3 * V_4 , T_2 V_26 )
{
int V_239 ;
for ( V_239 = 0 ; V_239 < V_4 -> V_59 . V_97 ; V_239 ++ ) {
...
V_9 -> V_34 & V_62 ) {
if ( F_82 ( V_9 ) )
F_75 ( V_4 , V_9 , V_179 , V_4 -> V_13 . V_26 - 1 ) ;
V_128 = V_29 ;
goto V_129;
} else if ( V_9 -> V_34 & V_58 ) {
struct V_164 * V_22 ;
V_22 = F_84 ( V_4 , V_9 -> V_26 ) ;
if ( ! V_22 ) {
V_128 = V_29 ;
goto V_129;
} else {
...
if ( V_22 ) {
struct V_5 * V_233 ;
V_233 = F_78 ( V_22 -> V_237 . V_6 , V_235 ) ;
if ( V_233 ) {
F_79 ( V_4 ) ;
} else {
F_80 ( L_6 ) ;
...
static void F_86 ( struct V_3 * V_4 , T_3 V_142 ,
enum V_241 V_93 )
{
...
break;
case V_30 :
F_75 ( V_4 , V_9 , V_253 , V_4 -> V_13 . V_26 ) ;
V_17 = V_29 ;
break;
case V_98 :
case V_48 :
