...
if ( ! ( V_180 . V_29 & V_70 ) ) {
T_4 V_131 ;
int V_105 = F_60 ( V_5 , V_180 . V_39 ) ;
if ( V_180 . V_29 & V_183 )
V_131 = sizeof( V_184 ) ;
else if ( V_180 . V_29 & V_185 )
V_131 = sizeof( V_186 ) ;
else
return - V_118 ;
if ( V_180 . V_150 - V_144 < V_180 . V_116 * V_131 ||
V_180 . V_33 >= V_105 || V_180 . V_33 + V_180 . V_116 > V_105 )
return - V_118 ;
...
struct V_191 * V_108 = NULL ;
bool V_120 = false ;
int V_44 = 0 ;
V_144 = F_84 ( struct V_190 , V_116 ) ;
if ( F_85 ( & V_180 , ( void V_148 * ) V_143 , V_144 ) )
return - V_149 ;
...
return - V_118 ;
V_196 = F_95 ( V_180 . V_116 , sizeof( * V_196 ) , V_35 ) ;
...
if ( F_85 ( V_196 , ( void V_148 * ) ( V_143 + V_144 ) ,
V_180 . V_116 * sizeof( * V_196 ) ) ) {
F_16 ( V_196 ) ;
F_16 ( V_117 ) ;
return - V_149 ;
}
...
struct V_198 * V_114 ;
struct V_199 V_200 = F_96 ( V_196 [ V_69 ] ) ;
if ( ! V_200 . V_201 ) {
V_44 = - V_202 ;
break;
}
V_114 = F_97 ( V_200 . V_201 ) ;
F_98 ( V_200 ) ;
if ( F_77 ( V_114 ) ) {
V_44 = F_78 ( V_114 ) ;
break;
...
T_4 V_116 , T_7 * V_205 , bool V_206 )
{
unsigned int V_39 = F_104 ( * V_205 ) ;
struct V_4 * V_5 = V_83 ;
if ( V_39 >= V_153 + V_5 -> V_74 )
return - V_118 ;
switch ( V_39 ) {
case V_158 :
return F_105 ( V_5 , V_157 , V_116 , V_205 , V_206 ) ;
case V_165 :
if ( V_206 )
return - V_118 ;
return F_106 ( V_5 , V_157 , V_116 , V_205 , false ) ;
case V_162 ... V_163 :
return F_106 ( V_5 , V_157 , V_116 , V_205 , V_206 ) ;
case V_169 :
return F_107 ( V_5 , V_157 , V_116 , V_205 , V_206 ) ;
default:
V_39 -= V_153 ;
return V_5 -> V_75 [ V_39 ] . V_76 -> V_207 ( V_5 , V_157 ,
V_116 , V_205 , V_206 ) ;
}
return - V_118 ;
}
...
if ( ! V_116 )
return 0 ;
return F_103 ( V_83 , V_157 , V_116 , V_205 , false ) ;
}
...
if ( ! V_116 )
return 0 ;
return F_103 ( V_83 , ( char V_148 * ) V_157 , V_116 , V_205 , true ) ;
}
static int F_110 ( void * V_83 , struct V_208 * V_209 )
{
struct V_4 * V_5 = V_83 ;
struct V_6 * V_8 = V_5 -> V_8 ;
unsigned int V_39 ;
T_8 V_210 , V_211 , V_212 , V_213 ;
int V_44 ;
V_39 = V_209 -> V_214 >> ( V_215 - V_216 ) ;
if ( V_209 -> V_217 < V_209 -> V_218 )
return - V_118 ;
if ( ( V_209 -> V_219 & V_220 ) == 0 )
return - V_118 ;
if ( V_39 >= V_165 )
return - V_118 ;
if ( ! V_5 -> V_32 [ V_39 ] )
return - V_118 ;
V_210 = F_75 ( F_74 ( V_8 , V_39 ) ) ;
V_211 = V_209 -> V_217 - V_209 -> V_218 ;
V_212 = V_209 -> V_214 &
( ( 1U << ( V_215 - V_216 ) ) - 1 ) ;
V_213 = V_212 << V_216 ;
if ( V_213 + V_211 > V_210 )
return - V_118 ;
if ( V_39 == V_5 -> V_61 ) {
if ( ! ( V_213 >= V_5 -> V_63 + V_5 -> V_65 ||
V_213 + V_211 <= V_5 -> V_63 ) )
return - V_118 ;
}
if ( ! V_5 -> V_78 [ V_39 ] ) {
V_44 = F_111 ( V_8 ,
...
V_209 -> V_221 = V_5 ;
V_209 -> V_222 = F_113 ( V_209 -> V_222 ) ;
V_209 -> V_214 = ( F_114 ( V_8 , V_39 ) >> V_216 ) + V_212 ;
return F_115 ( V_209 , V_209 -> V_218 , V_209 -> V_214 ,
V_211 , V_209 -> V_222 ) ;
}
...
static int F_119 ( struct V_6 * V_8 , const struct V_224 * V_115 )
{
struct V_4 * V_5 ;
struct V_103 * V_114 ;
int V_44 ;
...
{
struct V_234 * V_235 = V_100 ;
struct V_230 * V_43 ;
if ( V_235 -> V_236 == V_235 -> V_237 )
return - V_192 ;
V_43 = F_130 ( & V_8 -> V_51 ) ;
if ( ! V_43 )
return - V_118 ;
...
V_235 -> V_108 [ V_235 -> V_236 ++ ] = V_43 ;
return 0 ;
}
static void F_51 ( struct V_4 * V_5 )
{
struct V_234 V_235 = { . V_236 = 0 } ;
...
return;
V_235 . V_237 = V_69 ;
V_235 . V_108 = F_95 ( V_69 , sizeof( struct V_230 * ) , V_35 ) ;
if ( ! V_235 . V_108 )
return;
if ( F_71 ( V_5 -> V_8 ,
F_133 , & V_235 , V_120 ) )
goto V_240;
for ( V_69 = 0 ; V_69 < V_235 . V_236 ; V_69 ++ ) {
V_7 = F_131 ( V_235 . V_108 [ V_69 ] ) ;
if ( V_7 -> V_79 )
V_79 = true ;
if ( V_7 -> V_85 )
goto V_240;
...
return;
V_241 = V_243 ;
while ( ( V_115 = F_139 ( & V_241 , L_9 ) ) ) {
unsigned int V_41 , V_43 , V_244 = V_245 ,
V_246 = V_245 , V_18 = 0 , V_247 = 0 ;
int V_248 ;
if ( ! strlen ( V_115 ) )
continue;
V_248 = sscanf ( V_115 , L_10 ,
& V_41 , & V_43 , & V_244 , & V_246 ,
& V_18 , & V_247 ) ;
if ( V_248 < 2 ) {
F_140 ( L_11 , V_115 ) ;
continue;
}
V_242 = F_141 ( & V_238 , V_41 , V_43 ,
V_244 , V_246 , V_18 , V_247 , 0 ) ;
if ( V_242 )
F_140 ( L_12 ,
V_41 , V_43 , V_244 , V_246 ,
V_18 , V_247 , V_242 ) ;
