...
unsigned int V_32 [] , struct V_33 * V_34 [] )
{
...
V_169 -> V_185 = 0 ;
V_169 -> V_41 = & V_5 -> V_41 ;
strncpy ( V_169 -> V_186 , V_155 , sizeof( V_169 -> V_186 ) ) ;
V_55 = F_64 ( & V_167 -> V_173 , & V_5 -> V_41 ) ;
if ( V_55 ) {
...
F_65 ( & V_5 -> V_41 , L_12 ) ;
V_5 -> V_41 . V_188 = & V_5 -> V_188 ;
V_55 = F_66 ( & V_5 -> V_188 , 0 ) ;
if ( V_55 ) {
F_13 ( & V_5 -> V_41 ,
L_13 ) ;
goto V_189;
...
V_172 = & V_5 -> V_111 ;
V_172 -> type = V_143 ;
V_172 -> V_190 = V_191 | V_192 ;
V_172 -> V_193 = V_5 ;
V_172 -> V_194 = sizeof( struct V_1 ) ;
V_172 -> V_85 = & V_195 ;
V_172 -> V_196 = & V_197 ;
V_172 -> V_198 = V_199 ;
V_172 -> V_45 = & V_5 -> V_200 ;
V_172 -> V_201 = 1 ;
V_172 -> V_173 = & V_167 -> V_173 ;
V_55 = F_68 ( V_172 ) ;
if ( V_55 )
goto V_202;
F_69 ( & V_5 -> V_200 ) ;
F_70 ( & V_5 -> V_90 ) ;
F_71 ( & V_5 -> V_47 ) ;
V_169 -> V_45 = & V_5 -> V_200 ;
V_169 -> V_203 = V_172 ;
V_55 = F_72 ( & V_5 -> V_178 , V_204 , - 1 ) ;
if ( V_55 ) {
F_13 ( & V_5 -> V_41 ,
L_14 ) ;
goto V_202;
...
V_169 -> V_185 |= V_121 -> V_67 [ V_13 ] . V_82 ;
} else {
F_13 ( & V_5 -> V_41 ,
L_17 ) ;
V_55 = - V_175 ;
...
T_3 V_82 ;
V_55 = F_4 ( V_5 -> V_15 , V_56 , V_208 , & V_82 ) ;
if ( V_55 ) {
F_13 ( & V_5 -> V_41 ,
L_19 ) ;
goto V_206;
