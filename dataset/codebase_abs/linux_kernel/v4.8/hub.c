...
F_147 ( & V_11 -> V_22 . V_347 , L_79 ) ;
F_147 ( & V_81 -> V_22 . V_347 , L_80 ) ;
...
if ( ! string )
return;
F_8 ( & V_11 -> V_22 , L_81 , V_299 , string ) ;
}
...
V_11 -> V_36 . V_353 ,
V_11 -> V_36 . V_354 ) ;
F_155 ( V_11 , L_84 , V_11 -> V_355 ) ;
F_155 ( V_11 , L_85 , V_11 -> V_356 ) ;
F_155 ( V_11 , L_86 , V_11 -> V_357 ) ;
}
...
& V_81 -> V_22 . V_347 , L_79 ) ;
if ( V_358 )
goto V_251;
V_358 = F_179 ( & V_81 -> V_22 . V_347 ,
& V_11 -> V_22 . V_347 , L_80 ) ;
if ( V_358 ) {
F_147 ( & V_11 -> V_22 . V_347 , L_79 ) ;
goto V_251;
}
...
break;
default:
F_73 ( & V_11 -> V_22 , L_130 ,
V_122 , V_481 ? L_131 : L_132 ) ;
return - V_69 ;
}
if ( V_11 -> V_90 != V_91 ) {
F_23 ( & V_11 -> V_22 , L_133
L_134 ,
V_122 , V_481 ? L_131 : L_132 ,
V_479 [ V_90 ] ) ;
return 0 ;
...
F_8 ( & V_11 -> V_22 ,
L_159 ,
( V_11 -> V_360 ) ? L_153 : L_154 ,
( V_11 -> V_14 == V_419 ) ? L_160 : L_41 ,
V_176 , V_11 -> V_178 -> V_519 -> V_165 -> V_520 ) ;
}
F_68 ( 10 ) ;
if ( V_522 )
...
F_31 ( & V_11 -> V_22 , L_164 , V_56 ) ;
V_504 = - V_531 ;
goto V_251;
}
if ( V_11 -> V_14 == V_16 )
F_23 ( & V_11 -> V_22 , L_165 , V_56 ) ;
else
F_73 ( & V_11 -> V_22 , L_166 , V_56 ) ;
...
V_542 = 8 ;
if ( V_542 > V_2 -> V_283 )
F_73 ( & V_81 -> V_22 , L_170 ,
V_542 , V_2 -> V_283 ) ;
V_286 -= V_542 ;
}
if ( V_286 < 0 ) {
F_73 ( V_2 -> V_121 , L_171 ,
- V_286 ) ;
V_286 = 0 ;
}
return V_286 ;
...
V_57 = F_78 ( V_128 ) ;
if ( V_57 ) {
F_23 ( V_242 , L_180 , V_57 ) ;
goto V_555;
}
if ( V_2 -> V_92 )
goto V_556;
if ( V_2 -> error ) {
F_23 ( V_242 , L_181 , V_2 -> error ) ;
V_57 = F_270 ( V_4 ) ;
if ( V_57 ) {
F_23 ( V_242 , L_182 , V_57 ) ;
goto V_556;
}
V_2 -> V_142 = 0 ;
V_2 -> error = 0 ;
...
V_57 = F_215 ( V_11 ) ;
if ( V_57 ) {
F_31 ( & V_11 -> V_22 , L_196 , V_122 ) ;
goto V_580;
}
V_57 = F_207 ( V_11 ) ;
if ( V_57 ) {
F_31 ( & V_11 -> V_22 , L_197 ,
V_122 ) ;
goto V_580;
}
V_17 = V_11 -> V_17 ;
