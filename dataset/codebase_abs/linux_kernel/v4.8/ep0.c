...
int F_15 ( struct V_62 * V_63 , struct V_64 * V_45 ,
T_4 V_65 )
{
struct V_43 * V_44 = F_16 ( V_45 ) ;
...
static void F_31 ( struct V_62 * V_63 , struct V_64 * V_44 )
{
}
...
V_18 = V_8 -> V_20 [ 0 ] ;
V_8 -> V_108 . V_18 = V_18 ;
V_8 -> V_108 . V_45 . V_72 = sizeof( * V_87 ) ;
V_8 -> V_108 . V_45 . V_109 = V_8 -> V_107 ;
V_8 -> V_108 . V_45 . V_110 = F_31 ;
...
static void F_43 ( struct V_62 * V_63 , struct V_64 * V_44 )
{
struct V_17 * V_18 = F_17 ( V_63 ) ;
struct V_7 * V_8 = V_18 -> V_8 ;
T_3 V_141 = 0 ;
...
int V_19 ;
memcpy ( & V_142 , V_44 -> V_109 , sizeof( V_142 ) ) ;
...
V_18 = V_8 -> V_20 [ 0 ] ;
V_8 -> V_108 . V_18 = V_18 ;
V_8 -> V_108 . V_45 . V_72 = V_18 -> V_67 . V_150 ;
V_8 -> V_108 . V_45 . V_109 = V_8 -> V_107 ;
V_8 -> V_108 . V_45 . V_110 = F_43 ;
return F_9 ( V_18 , & V_8 -> V_108 ) ;
}
...
V_168 -> V_46 += V_173 ;
if ( ( V_9 & 1 ) && V_168 -> V_46 < V_168 -> V_72 ) {
F_21 ( V_8 ) ;
} else {
F_24 ( V_169 , V_167 , 0 ) ;
...
struct V_17 * V_18 , struct V_43 * V_44 )
{
int V_19 ;
V_44 -> V_53 = ! ! V_18 -> V_49 ;
if ( V_44 -> V_45 . V_72 == 0 ) {
V_19 = F_2 ( V_8 , V_18 -> V_49 ,
V_8 -> V_76 , 0 ,
V_182 , false ) ;
} else if ( ! F_57 ( V_44 -> V_45 . V_72 , V_18 -> V_67 . V_150 )
&& ( V_18 -> V_49 == 0 ) ) {
T_3 V_170 = 0 ;
T_3 V_150 ;
V_19 = F_62 ( & V_8 -> V_59 , & V_44 -> V_45 ,
V_18 -> V_49 ) ;
if ( V_19 ) {
F_3 ( V_23 , L_26 ) ;
return;
...
if ( V_44 -> V_45 . V_72 > V_179 ) {
V_170 = F_54 ( V_44 -> V_45 . V_72 - V_150 ,
V_150 ) ;
V_19 = F_2 ( V_8 , V_18 -> V_49 ,
V_44 -> V_45 . V_183 ,
V_170 ,
...
V_170 = F_55 ( ( V_44 -> V_45 . V_72 - V_170 ) ,
V_150 ) ;
V_8 -> V_178 = true ;
V_19 = F_2 ( V_8 , V_18 -> V_49 ,
V_8 -> V_184 , V_170 ,
...
V_19 = F_2 ( V_8 , V_18 -> V_49 , V_44 -> V_45 . V_183 ,
V_44 -> V_45 . V_72 , V_182 ,
false ) ;
}
F_28 ( V_19 < 0 ) ;
}
...
V_187 = V_188 ;
V_187 |= V_189 ;
V_187 |= F_66 ( V_18 -> V_40 ) ;
memset ( & V_14 , 0 , sizeof( V_14 ) ) ;
V_19 = F_7 ( V_18 , V_187 , & V_14 ) ;
F_67 ( V_19 ) ;
V_18 -> V_40 = 0 ;
}
