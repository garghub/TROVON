...
if ( V_21 )
return V_21 ;
return F_70 ( V_71 , V_15 , V_73 , V_74 ) ;
}
...
if ( ! V_21 && V_121 && V_121 -> V_137 ) {
struct V_142 * V_143 = V_121 -> V_137 ;
V_143 -> V_144 ( V_143 , false ) ;
}
}
if ( V_21 )
goto V_145;
...
F_113 ( V_37 , V_48 ) ;
if ( ( V_37 -> V_146 == F_114 ( V_148 ) ||
V_37 -> V_146 == F_114 ( V_149 ) ) &&
F_115 ( V_37 , V_37 -> V_146 , & V_130 ) != 0 )
F_109 ( V_37 , V_130 ) ;
F_116 () ;
V_20 = F_16 ( V_2 -> V_20 ) ;
if ( V_131 ) {
F_117 ( V_37 ) -> V_150 = V_121 -> V_137 ;
F_117 ( V_37 ) -> V_151 |= V_152 ;
F_117 ( V_37 ) -> V_151 |= V_153 ;
}
if ( V_20 ) {
V_37 -> V_15 = V_20 -> V_15 ;
F_118 ( V_37 ) ;
