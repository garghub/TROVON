...
{
struct V_1 * V_3 = F_4 ( V_5 , struct V_1 ,
V_6 ) ;
F_5 ( & V_3 -> V_7 ) ;
F_6 ( V_3 ) ;
}
...
static struct V_1 * F_9 ( T_1 V_2 )
{
struct V_1 * V_3 ;
V_3 = F_10 ( sizeof( * V_3 ) , V_8 ) ;
if ( ! V_3 )
return NULL ;
V_3 -> V_2 = V_2 ;
V_3 -> V_9 = - 1 ;
...
V_3 -> V_49 = F_53 ( V_12 -> V_33 -> V_50 ) ;
if ( F_54 ( V_3 -> V_49 ) ) {
F_30 ( V_12 -> V_28 , L_10 ) ;
return F_55 ( V_3 -> V_49 ) ;
}
V_3 -> V_51 = V_3 -> V_49 -> V_51 ;
return 0 ;
}
...
T_1 V_52 ;
F_60 (ports, port) {
V_26 = F_61 ( V_15 , L_14 , & V_52 ) ;
if ( V_26 )
return V_26 ;
if ( V_52 >= V_17 )
return - V_46 ;
V_12 -> V_18 [ V_52 ] . V_19 = V_15 ;
if ( ! F_19 ( V_15 ) )
V_12 -> V_31 |= 1 << V_52 ;
}
return 0 ;
}
static int F_62 ( struct V_14 * V_53 , T_1 * V_2 , T_1 * V_13 )
{
int V_26 ;
* V_2 = * V_13 = 0 ;
V_26 = F_63 ( V_53 , L_15 , 0 , V_2 ) ;
if ( V_26 ) {
if ( V_26 == - V_46 )
return 0 ;
return V_26 ;
}
V_26 = F_63 ( V_53 , L_15 , 1 , V_13 ) ;
if ( V_26 )
return V_26 ;
if ( * V_13 >= V_20 )
return - V_46 ;
...
static int F_68 ( struct V_11 * V_12 , struct V_14 * V_53 )
{
struct V_14 * V_18 = F_64 ( V_12 , V_53 ) ;
struct V_1 * V_3 ;
T_1 V_2 , V_13 ;
int V_54 , V_26 ;
V_26 = F_62 ( V_53 , & V_2 , & V_13 ) ;
if ( V_26 )
return V_26 ;
if ( F_54 ( V_18 ) )
return F_55 ( V_18 ) ;
...
int F_69 ( struct V_11 * V_12 , struct V_14 * V_53 )
{
int V_26 ;
F_70 ( & V_59 ) ;
V_26 = F_68 ( V_12 , V_53 ) ;
