...
if ( ! V_30 -> V_37 )
return - V_38 ;
V_12 = F_12 ( V_30 , sizeof( * V_12 ) , V_39 ) ;
if ( ! V_12 )
return - V_40 ;
V_36 = F_13 ( V_30 ) ;
V_34 = F_14 ( V_36 , V_41 , 1 ) ;
if ( ! V_34 ) {
F_15 ( V_30 , L_1 ) ;
return - V_38 ;
}
V_12 -> V_15 = F_16 ( V_30 , V_34 -> V_21 , 0x10000 ) ;
if ( ! V_12 -> V_15 )
return - V_40 ;
V_32 = V_34 -> V_21 + 0xf00000 ;
V_12 -> V_17 [ 0 ] = ( T_1 ) V_32 | 2 ;
V_12 -> V_17 [ 1 ] = ( T_1 ) ( V_34 -> V_22 - V_32 ) & ~ 3u ;
V_12 -> V_17 [ 2 ] = ( T_1 ) ( V_32 >> 32 ) ;
V_9 -> V_13 = V_12 ;
return 0 ;
}
static int F_17 ( struct V_35 * V_36 )
{
return F_18 ( V_36 , & V_42 ) ;
}
