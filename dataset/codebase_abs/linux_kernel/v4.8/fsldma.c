...
V_2 -> V_4 = F_99 ( V_66 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_100 ( V_132 -> V_84 , L_34 ) ;
V_147 = - V_85 ;
goto V_150;
}
V_147 = F_101 ( V_66 , 0 , & V_146 ) ;
if ( V_147 ) {
F_100 ( V_132 -> V_84 , L_35 ) ;
goto V_151;
}
V_2 -> V_16 = V_16 ;
if ( ! V_132 -> V_16 )
...
if ( V_2 -> V_138 >= V_137 ) {
F_100 ( V_132 -> V_84 , L_36 ) ;
V_147 = - V_51 ;
goto V_151;
}
V_132 -> V_2 [ V_2 -> V_138 ] = V_2 ;
F_103 ( & V_2 -> V_129 , F_87 , ( unsigned long ) V_2 ) ;
snprintf ( V_2 -> V_83 , sizeof( V_2 -> V_83 ) , L_37 , V_2 -> V_138 ) ;
F_18 ( V_2 ) ;
F_7 ( V_2 , 0 ) ;
switch ( V_2 -> V_16 & V_17 ) {
case V_18 :
...
F_107 ( V_132 -> V_84 , L_38 , V_2 -> V_138 , V_144 ,
