...
V_57 -> V_80 =
F_60 ( V_53 -> V_81 . V_82 ) ;
V_57 -> V_83 = V_53 -> V_81 . V_84 ;
} else {
V_57 -> V_80 = NULL ;
V_57 -> V_83 = 0 ;
}
V_57 -> V_85 = V_53 -> V_86 != V_87 ;
V_57 -> V_88 = V_53 -> V_67 ;
V_53 -> V_67 = 0 ;
V_57 -> V_89 = V_58 ;
F_61 ( & V_57 -> V_70 , & V_53 -> V_90 ) ;
if ( V_60 & V_65 ) {
F_2 ( L_21
L_22 , V_54 ,
V_57 , V_58 , V_58 -> V_44 ) ;
...
{
struct V_54 * V_54 = & V_53 -> V_55 ;
struct V_1 * V_2 = F_64 ( V_54 -> V_92 ) -> V_2 ;
F_55 ( V_57 -> V_91 ) ;
V_57 -> V_93 = V_54 -> V_94 ;
V_57 -> V_95 = V_54 -> V_96 ;
V_57 -> V_97 = V_54 -> V_98 ;
V_57 -> ctime = V_54 -> V_99 ;
V_57 -> V_100 = V_53 -> V_101 ;
if ( V_57 -> V_88 ) {
F_2 ( L_24
L_25 , V_54 , V_57 ,
V_57 -> V_89 , V_57 -> V_89 -> V_44 ,
F_56 ( V_57 -> V_61 ) , V_57 -> V_93 ,
V_57 -> V_88 ) ;
return 0 ;
}
V_53 -> V_102 |= V_103 ;
F_2 ( L_26 ,
V_54 , V_57 , V_57 -> V_89 ,
V_57 -> V_89 -> V_44 , F_56 ( V_57 -> V_61 ) ,
V_57 -> V_93 ) ;
F_5 ( & V_2 -> V_104 ) ;
F_61 ( & V_53 -> V_105 , & V_2 -> V_106 ) ;
F_7 ( & V_2 -> V_104 ) ;
return 1 ;
}
...
void * V_12 , void * V_108 , bool V_109 ,
struct V_3 * * V_110 )
{
struct V_111 * V_112 ;
T_3 * V_29 ;
...
F_2 ( L_30 , V_109 ) ;
V_116:
F_70 ( & V_12 , V_108 , sizeof( * V_112 ) , V_117 ) ;
V_112 = V_12 ;
V_12 += sizeof( * V_112 ) ;
F_70 ( & V_12 , V_108 , sizeof( T_1 ) * ( F_71 ( V_112 -> V_42 ) +
F_71 ( V_112 -> V_41 ) ) , V_117 ) ;
V_29 = V_12 ;
V_12 += sizeof( T_1 ) * F_71 ( V_112 -> V_42 ) ;
V_28 = V_12 ;
V_12 += sizeof( T_1 ) * F_71 ( V_112 -> V_41 ) ;
V_4 = F_20 ( V_2 , F_72 ( V_112 -> V_16 ) ) ;
if ( ! V_4 ) {
V_4 = F_13 ( V_2 , F_72 ( V_112 -> V_16 ) ) ;
if ( F_38 ( V_4 ) ) {
V_39 = F_39 ( V_4 ) ;
goto V_43;
}
}
V_39 = F_37 ( V_2 , V_4 , F_72 ( V_112 -> V_13 ) ) ;
if ( V_39 < 0 )
goto V_43;
V_114 += V_39 ;
if ( F_72 ( V_112 -> V_44 ) > V_4 -> V_44 ) {
F_2 ( L_31 ,
V_4 -> V_16 , V_4 , V_4 -> V_44 , F_72 ( V_112 -> V_44 ) ) ;
V_4 -> V_44 = F_72 ( V_112 -> V_44 ) ;
V_4 -> V_118 = F_72 ( V_112 -> V_118 ) ;
V_4 -> V_47 = F_72 ( V_112 -> V_47 ) ;
V_4 -> V_42 = F_71 ( V_112 -> V_42 ) ;
...
struct V_124 * V_125 )
{
struct V_126 * V_127 = V_2 -> V_128 -> V_127 ;
int V_129 = V_122 -> V_130 ;
T_1 V_131 ;
int V_132 ;
int V_133 ;
struct V_3 * V_4 = NULL ;
void * V_12 = V_125 -> V_134 . V_135 ;
void * V_108 = V_12 + V_125 -> V_134 . V_136 ;
struct V_137 * V_138 ;
int V_139 , V_140 ;
T_3 * V_141 = NULL , * V_142 = NULL ;
int V_46 ;
int V_143 = 0 ;
if ( V_125 -> V_134 . V_136 < sizeof( * V_138 ) )
goto V_117;
V_138 = V_12 ;
V_132 = F_71 ( V_138 -> V_132 ) ;
V_131 = F_72 ( V_138 -> V_131 ) ;
V_139 = F_71 ( V_138 -> V_139 ) ;
V_140 = F_71 ( V_138 -> V_140 ) ;
V_133 = F_71 ( V_138 -> V_133 ) ;
V_12 += sizeof( * V_138 ) ;
F_2 ( L_38 , V_129 ,
F_78 ( V_132 ) , V_131 , V_133 ) ;
F_79 ( & V_122 -> V_123 ) ;
V_122 -> V_144 ++ ;
F_75 ( & V_122 -> V_123 ) ;
F_36 ( & V_2 -> V_31 ) ;
...
struct V_147 V_148 = {
. V_16 = F_72 ( V_141 [ V_46 ] ) ,
. V_149 = V_150 ,
} ;
struct V_54 * V_54 = F_80 ( V_127 , V_148 ) ;
struct V_52 * V_53 ;
struct V_3 * V_151 ;
if ( ! V_54 )
continue;
