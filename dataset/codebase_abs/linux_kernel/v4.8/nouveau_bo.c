...
if ( V_49 )
goto V_104;
V_49 = F_106 ( V_26 , true , V_177 , V_116 , V_153 ) ;
V_104:
F_107 ( V_26 , & V_194 ) ;
return V_49 ;
}
...
if ( V_49 )
return V_49 ;
V_49 = F_106 ( V_26 , true , V_177 , V_116 , & V_194 ) ;
if ( V_49 )
goto V_104;
...
V_49 = F_116 ( V_26 , V_177 , V_116 ) ;
if ( V_49 == 0 )
V_49 = F_118 ( V_26 , V_97 , V_177 , V_116 , V_153 ) ;
V_104:
if ( V_10 -> V_14 . V_35 . V_36 < V_37 ) {
if ( V_49 )
...
{
struct V_28 * V_29 = V_28 ( V_26 ) ;
return F_120 ( & V_29 -> V_30 . V_201 , V_31 ) ;
}
static int
...
V_70 -> V_202 . V_5 = NULL ;
V_70 -> V_202 . V_156 = 0 ;
V_70 -> V_202 . V_6 = V_70 -> V_71 << V_72 ;
V_70 -> V_202 . V_184 = 0 ;
V_70 -> V_202 . V_119 = false ;
if ( ! ( V_131 -> V_8 & V_133 ) )
return - V_57 ;
switch ( V_70 -> V_99 ) {
case V_132 :
...
#if F_58 ( V_127 )
if ( V_10 -> V_128 . V_129 ) {
V_70 -> V_202 . V_156 = V_70 -> V_171 << V_72 ;
V_70 -> V_202 . V_184 = V_10 -> V_128 . V_184 ;
V_70 -> V_202 . V_119 = ! V_10 -> V_128 . V_203 ;
}
#endif
...
case V_100 :
V_70 -> V_202 . V_156 = V_70 -> V_171 << V_72 ;
V_70 -> V_202 . V_184 = V_14 -> V_65 -> V_204 ( V_14 , 1 ) ;
V_70 -> V_202 . V_119 = true ;
if ( V_10 -> V_14 . V_35 . V_36 >= V_37 ) {
struct V_205 * V_206 = F_63 ( & V_10 -> V_14 ) ;
int V_40 = 12 ;
if ( V_10 -> V_14 . V_35 . V_36 >= V_207 )
V_40 = V_154 -> V_40 ;
V_49 = F_122 ( V_206 , V_154 -> V_6 << 12 , V_40 ,
& V_154 -> V_208 ) ;
if ( V_49 )
return V_49 ;
F_90 ( & V_154 -> V_208 , V_154 ) ;
V_70 -> V_202 . V_156 = V_154 -> V_208 . V_156 ;
}
break;
default:
return - V_57 ;
...
struct V_28 * V_29 = V_28 ( V_26 ) ;
struct V_13 * V_14 = F_2 ( & V_10 -> V_14 ) ;
T_1 V_209 = V_14 -> V_65 -> V_210 ( V_14 , 1 ) >> V_72 ;
int V_11 , V_49 ;
if ( V_26 -> V_70 . V_99 != V_100 ) {
if ( V_10 -> V_14 . V_35 . V_36 < V_37 ||
! F_125 ( V_29 ) )
...
if ( V_10 -> V_14 . V_35 . V_36 >= V_37 ||
V_26 -> V_70 . V_171 + V_26 -> V_70 . V_71 < V_209 )
return 0 ;
for ( V_11 = 0 ; V_11 < V_29 -> V_73 . V_85 ; ++ V_11 ) {
V_29 -> V_86 [ V_11 ] . V_81 = 0 ;
V_29 -> V_86 [ V_11 ] . V_82 = V_209 ;
}
for ( V_11 = 0 ; V_11 < V_29 -> V_73 . V_87 ; ++ V_11 ) {
V_29 -> V_88 [ V_11 ] . V_81 = 0 ;
V_29 -> V_88 [ V_11 ] . V_82 = V_209 ;
}
F_28 ( V_29 , V_77 , 0 ) ;
...
unsigned V_11 ;
int V_212 ;
bool V_213 = ! ! ( V_64 -> V_124 & V_214 ) ;
if ( V_64 -> V_215 != V_216 )
return 0 ;
if ( V_213 && V_64 -> V_44 ) {
F_127 ( V_64 -> V_44 , V_64 -> V_217 ,
...
T_7 V_5 ;
V_5 = F_132 ( V_211 , V_64 -> V_217 [ V_11 ] , 0 , V_41 ,
V_221 ) ;
if ( F_133 ( V_211 , V_5 ) ) {
while ( V_11 -- ) {
F_134 ( V_211 , V_111 -> V_112 [ V_11 ] ,
V_41 , V_221 ) ;
V_111 -> V_112 [ V_11 ] = 0 ;
}
F_135 ( V_64 ) ;
...
for ( V_11 = 0 ; V_11 < V_64 -> V_71 ; V_11 ++ ) {
if ( V_111 -> V_112 [ V_11 ] ) {
F_134 ( V_211 , V_111 -> V_112 [ V_11 ] , V_41 ,
V_221 ) ;
}
}
F_135 ( V_64 ) ;
...
void
F_139 ( struct V_28 * V_29 , struct V_22 * V_19 , bool V_223 )
{
...
struct V_195 *
F_142 ( struct V_28 * V_29 , struct V_224 * V_54 )
{
struct V_195 * V_155 ;
F_110 (vma, &nvbo->vma_list, head) {
if ( V_155 -> V_54 == V_54 )
...
int
F_143 ( struct V_28 * V_29 , struct V_224 * V_54 ,
struct V_195 * V_155 )
{
