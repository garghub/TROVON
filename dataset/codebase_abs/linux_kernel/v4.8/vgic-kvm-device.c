...
V_53 = ( V_34 -> V_34 & V_59 ) >>
V_60 ;
V_56 = F_24 ( V_32 -> V_1 , V_53 ) ;
V_3 = V_34 -> V_34 & V_61 ;
F_5 ( & V_32 -> V_1 -> V_16 ) ;
V_42 = F_12 ( V_32 -> V_1 ) ;
if ( V_42 )
goto V_29;
if ( V_53 >= F_25 ( & V_32 -> V_1 -> V_62 ) ) {
V_42 = - V_7 ;
goto V_29;
}
V_42 = - V_46 ;
F_26 (c, tmp_vcpu, dev->kvm) {
if ( ! F_27 ( & V_57 -> V_63 ) )
goto V_29;
V_58 = V_54 ;
}
...
if ( F_10 ( V_51 , V_37 ) )
return - V_38 ;
return F_23 ( V_32 , V_34 , & V_51 , true ) ;
}
}
return - V_39 ;
}
...
T_4 T_3 * V_37 = ( T_4 T_3 * ) ( long ) V_34 -> V_3 ;
T_4 V_51 = 0 ;
V_42 = F_23 ( V_32 , V_34 , & V_51 , false ) ;
if ( V_42 )
return V_42 ;
