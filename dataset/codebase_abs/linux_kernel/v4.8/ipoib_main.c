...
static struct V_1 * F_224 ( const char * V_296 ,
...
if ( ! V_4 )
goto V_298;
F_225 ( V_4 -> V_2 , V_289 -> V_299 ) ;
V_4 -> V_2 -> V_300 = V_59 - 1 ;
V_45 = F_226 ( V_289 , V_59 , & V_270 ) ;
if ( ! V_45 )
V_4 -> V_23 = F_227 ( V_270 . V_301 ) ;
else {
F_177 ( V_212 L_36 ,
V_289 -> V_101 , V_59 ) ;
goto V_302;
...
V_4 -> V_2 -> V_303 = sizeof( struct V_116 ) ;
...
return;
F_113 ( V_58 ) ;
for ( V_311 = F_241 ( V_268 ) ; V_311 <= F_242 ( V_268 ) ; ++ V_311 ) {
if ( ! F_47 ( V_268 , V_311 ) )
continue;
V_2 = F_224 ( L_43 , V_268 , V_311 ) ;
if ( ! F_243 ( V_2 ) ) {
V_4 = F_2 ( V_2 ) ;
F_62 ( & V_4 -> V_83 , V_58 ) ;
V_274 ++ ;
...
int V_63 ;
V_211 = F_168 ( V_211 ) ;
V_211 = F_27 ( V_211 , V_315 ) ;
V_211 = F_247 ( V_211 , V_316 ) ;
V_214 = F_168 ( V_214 ) ;
V_214 = F_27 ( V_214 , V_315 ) ;
V_214 = F_248 ( V_214 , 2 * V_317 , V_316 ) ;
#ifdef F_249
V_318 = F_27 ( V_318 , V_319 ) ;
#endif
F_250 ( V_320 > V_321 ) ;
V_63 = F_251 () ;
if ( V_63 )
