...
if ( V_29 && V_29 -> V_52 && ! V_29 -> V_33 && ! V_29 -> V_48 )
F_30 ( V_7 , NULL , V_29 ) ;
...
static int F_97 ( struct V_6 * V_7 , struct V_25 * V_85 ,
const T_7 * V_23 , T_2 V_72 , T_2 V_36 , T_2 V_16 )
{
struct V_49 * V_20 = & V_7 -> V_50 [ F_9 ( V_23 , V_16 ) ] ;
struct V_2 * V_11 ;
bool V_140 = false ;
if ( V_85 && ! ( V_72 & V_93 ) && ! ( V_72 & V_94 ) &&
! ( V_85 -> V_72 == V_92 ||
V_85 -> V_72 == V_73 ) )
return - V_141 ;
if ( ! V_85 && ! ( V_72 & V_93 ) ) {
...
static int F_99 ( struct V_106 * V_107 , struct V_6 * V_7 ,
struct V_25 * V_26 , const unsigned char * V_23 ,
T_4 V_146 , T_4 V_16 )
{
int V_24 = 0 ;
...
F_100 () ;
F_59 () ;
F_72 ( V_7 , V_26 , V_23 , V_16 , true ) ;
F_61 () ;
F_101 () ;
} else {
F_37 ( & V_7 -> V_51 ) ;
V_24 = F_97 ( V_7 , V_26 , V_23 , V_107 -> V_118 ,
V_146 , V_16 ) ;
F_39 ( & V_7 -> V_51 ) ;
}
return V_24 ;
}
int F_102 ( struct V_106 * V_107 , struct V_148 * V_149 [] ,
struct V_69 * V_27 ,
...
V_45 = F_33 ( V_43 , V_16 ) ;
if ( ! V_45 || ! F_35 ( V_45 ) ) {
F_98 ( L_11 , V_16 , V_27 -> V_89 ) ;
return - V_88 ;
}
V_24 = F_99 ( V_107 , V_7 , V_26 , V_23 , V_146 , V_16 ) ;
} else {
V_24 = F_99 ( V_107 , V_7 , V_26 , V_23 , V_146 , 0 ) ;
if ( V_24 || ! V_43 || ! V_43 -> V_57 )
goto V_60;
F_17 (v, &vg->vlan_list, vlist) {
if ( ! F_35 ( V_45 ) )
continue;
V_24 = F_99 ( V_107 , V_7 , V_26 , V_23 , V_146 , V_45 -> V_16 ) ;
if ( V_24 )
goto V_60;
}
}
