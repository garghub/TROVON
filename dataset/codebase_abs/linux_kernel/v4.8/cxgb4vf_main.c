...
V_1 -> V_347 -> V_276 = V_441 ;
F_224 ( & V_1 -> V_116 ) ;
F_224 ( & V_1 -> V_443 ) ;
F_59 ( & V_1 -> V_444 . V_153 ) ;
...
V_144 -> V_450 = V_451 | V_452 |
V_453 | V_454 |
V_182 | V_455 ;
V_144 -> V_456 = V_451 | V_452 |
V_453 | V_454 |
V_457 ;
V_144 -> V_181 = V_144 -> V_450 |
V_183 ;
if ( V_436 )
V_144 -> V_181 |= V_457 ;
V_144 -> V_458 |= V_459 ;
...
if ( V_144 == NULL )
continue;
F_237 ( V_144 , V_10 -> V_35 ) ;
F_238 ( V_144 , V_10 -> V_35 ) ;
V_38 = F_239 ( V_144 ) ;
if ( V_38 ) {
F_191 ( & V_107 -> V_5 , L_144
L_145 , V_144 -> V_19 ) ;
continue;
}
F_63 ( V_2 , & V_1 -> V_465 ) ;
...
static void F_250 ( struct V_433 * V_107 )
{
struct V_1 * V_1 = F_251 ( V_107 ) ;
if ( V_1 ) {
int V_2 ;
F_16 (adapter, pidx)
if ( F_243 ( V_2 , & V_1 -> V_465 ) )
...
static void F_254 ( struct V_433 * V_107 )
{
struct V_1 * V_1 ;
int V_2 ;
V_1 = F_251 ( V_107 ) ;
...
static int T_14 F_255 ( void )
{
int V_23 ;
if ( V_33 != V_464 && V_33 != V_409 ) {
F_256 ( L_153 ,
V_33 , V_464 , V_409 ) ;
return - V_155 ;
}
V_467 = F_240 ( V_256 , NULL ) ;
if ( F_187 ( V_467 ) )
F_256 ( L_154 ) ;
V_23 = F_257 ( & V_468 ) ;
if ( V_23 < 0 && ! F_187 ( V_467 ) )
F_258 ( V_467 ) ;
return V_23 ;
}
static void T_15 F_259 ( void )
{
F_260 ( & V_468 ) ;
F_258 ( V_467 ) ;
}
