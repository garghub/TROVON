...
if ( ! V_22 -> V_25 -> V_79 )
return - V_46 ;
if ( args -> V_47 & ~ ( V_80 | V_81 ) )
return - V_35 ;
return V_22 -> V_25 -> V_79 ( V_22 , V_57 ,
args -> V_4 , args -> V_47 , & args -> V_82 ) ;
}
...
if ( ! V_22 -> V_25 -> V_83 )
return - V_46 ;
return V_22 -> V_25 -> V_83 ( V_22 , V_57 ,
args -> V_82 , & args -> V_4 ) ;
}
struct V_27 * F_57 ( struct V_84 * * V_85 , unsigned int V_86 )
{
struct V_27 * V_87 = NULL ;
int V_59 ;
V_87 = F_2 ( sizeof( struct V_27 ) , V_7 ) ;
if ( ! V_87 ) {
V_59 = - V_8 ;
goto V_67;
}
V_59 = F_58 ( V_87 , V_85 , V_86 , 0 ,
V_86 << V_88 , V_7 ) ;
if ( V_59 )
goto V_67;
return V_87 ;
...
int F_59 ( struct V_27 * V_28 , struct V_84 * * V_85 ,
T_2 * V_89 , int V_90 )
{
unsigned V_91 ;
struct V_92 * V_87 ;
...
void F_63 ( struct V_18 * V_19 , struct V_27 * V_87 )
{
struct V_14 * V_15 ;
struct V_3 * V_3 ;
V_15 = V_19 -> V_65 ;
