...
if ( 0 == ( V_41 % 8000 ) )
V_68 = 0x80000000 ;
F_19 ( V_43 , V_69 , 0x80000000 , V_68 ) ;
}
F_26 ( V_17 , L_3 ,
F_29 ( V_6 ) , F_4 ( V_6 ) ,
V_62 , V_41 ) ;
...
V_26 = F_31 ( V_17 , V_70 [ V_1 ] ) ;
V_15 -> V_26 [ V_1 ] = F_32 ( V_26 ) ? NULL : V_26 ;
}
F_27 (clk, adg, i) {
V_71 = F_33 ( V_26 ) ;
if ( V_71 < 0 )
...
V_26 = F_39 ( V_17 , V_84 [ V_1 ] ,
V_83 , 0 ,
V_79 ) ;
if ( ! F_32 ( V_26 ) ) {
V_15 -> V_93 . V_94 = V_15 -> V_90 ;
V_15 -> V_93 . V_95 = V_92 ;
V_15 -> V_90 [ V_1 ] = V_26 ;
F_40 ( V_74 , V_96 ,
& V_15 -> V_93 ) ;
...
F_19 ( V_43 , V_69 , 0x80FF0000 , V_68 ) ;
F_41 ( V_43 , V_97 , V_77 ) ;
F_41 ( V_43 , V_98 , V_78 ) ;
F_42 (clk, adg, i)
...
struct V_16 * V_17 = F_8 ( V_10 ) ;
struct V_73 * V_74 = V_17 -> V_75 ;
V_15 = F_44 ( V_17 , sizeof( * V_15 ) , V_99 ) ;
if ( ! V_15 ) {
F_11 ( V_17 , L_18 ) ;
return - V_100 ;
}
F_45 ( V_10 , & V_15 -> V_101 , & V_102 ,
NULL , NULL , 0 , 0 ) ;
F_30 ( V_10 , V_15 ) ;
F_35 ( V_10 , V_15 ) ;
if ( F_46 ( V_74 , L_19 , NULL ) )
V_15 -> V_103 = V_67 ;
V_10 -> V_15 = V_15 ;
return 0 ;
}
