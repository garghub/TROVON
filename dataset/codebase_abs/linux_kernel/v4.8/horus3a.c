...
V_39 = ( T_1 ) ( ( V_33 * 11 + ( 10000 - 1 ) ) / 10000 ) ;
else
V_39 = ( T_1 ) ( ( V_33 * 3 + ( 5000 - 1 ) ) / 5000 + 5 ) ;
if ( V_39 > 36 )
V_39 = 36 ;
} else {
F_17 ( & V_2 -> V_7 -> V_8 ,
...
T_1 V_11 [ 3 ] , V_21 ;
struct V_1 * V_2 = NULL ;
V_2 = F_22 ( sizeof( struct V_1 ) , V_49 ) ;
if ( V_2 == NULL )
return NULL ;
V_2 -> V_16 = ( V_47 -> V_16 >> 1 ) ;
V_2 -> V_7 = V_7 ;
V_2 -> V_41 = V_47 -> V_50 ;
V_2 -> V_40 = V_47 -> V_51 ;
if ( V_27 -> V_52 . V_53 )
V_27 -> V_52 . V_53 ( V_27 , 1 ) ;
F_10 ( 4000 , 6000 ) ;
F_7 ( V_2 , 0x2a , 0x79 ) ;
V_11 [ 0 ] = V_47 -> V_54 ;
V_11 [ 1 ] = V_47 -> V_54 ;
...
F_10 ( 3000 , 5000 ) ;
if ( V_27 -> V_52 . V_53 )
V_27 -> V_52 . V_53 ( V_27 , 0 ) ;
memcpy ( & V_27 -> V_52 . V_55 , & V_56 ,
sizeof( struct V_57 ) ) ;
V_27 -> V_28 = V_2 ;
F_23 ( & V_2 -> V_7 -> V_8 ,
L_12 ,
