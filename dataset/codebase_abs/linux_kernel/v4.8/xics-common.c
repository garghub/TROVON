...
struct V_21 * V_21 ;
F_17 (ics, &ics_list, link)
if ( V_21 -> V_73 ( V_21 , V_70 ) )
return 1 ;
return 0 ;
}
static void F_41 ( struct V_50 * V_74 ) { }
static void F_42 ( struct V_50 * V_74 ) { }
...
F_17 (ics, &ics_list, link)
if ( V_21 -> V_79 ( V_21 , V_40 ) == 0 )
return 0 ;
return - V_80 ;
}
static int F_46 ( struct V_68 * V_69 , struct V_3 * V_81 ,
const T_1 * V_82 , unsigned int V_83 ,
...
int F_47 ( struct V_50 * V_74 , unsigned int V_88 )
{
...
{
V_24 = F_52 ( NULL , & V_93 , NULL ) ;
F_3 ( V_24 == NULL ) ;
F_53 ( V_24 ) ;
}
void T_3 F_54 ( struct V_21 * V_21 )
{
F_55 ( & V_21 -> V_94 , & V_95 ) ;
}
...
V_100 . V_101 = V_17 -> V_101 ;
V_77 . V_102 = V_17 -> V_103 ;
V_97 = F_63 () ;
if ( V_97 < 0 )
V_97 = F_64 () ;
if ( V_97 < 0 )
