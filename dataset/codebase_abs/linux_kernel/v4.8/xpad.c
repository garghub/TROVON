...
F_81 ( V_137 , V_5 -> V_138 ) ;
if ( ! ( V_2 -> V_7 & V_8 ) ) {
F_81 ( V_139 , V_5 -> V_138 ) ;
for ( V_65 = 0 ; V_140 [ V_65 ] >= 0 ; V_65 ++ )
F_74 ( V_5 , V_140 [ V_65 ] ) ;
}
for ( V_65 = 0 ; V_141 [ V_65 ] >= 0 ; V_65 ++ )
F_81 ( V_141 [ V_65 ] , V_5 -> V_142 ) ;
if ( V_2 -> V_37 == V_58 || V_2 -> V_37 == V_38 ||
V_2 -> V_37 == V_60 ) {
for ( V_65 = 0 ; V_143 [ V_65 ] >= 0 ; V_65 ++ )
F_81 ( V_143 [ V_65 ] , V_5 -> V_142 ) ;
} else {
for ( V_65 = 0 ; V_144 [ V_65 ] >= 0 ; V_65 ++ )
F_81 ( V_144 [ V_65 ] , V_5 -> V_142 ) ;
}
if ( V_2 -> V_7 & V_20 ) {
for ( V_65 = 0 ; V_145 [ V_65 ] >= 0 ; V_65 ++ )
F_81 ( V_145 [ V_65 ] , V_5 -> V_142 ) ;
}
if ( ! ( V_2 -> V_7 & V_20 ) ||
V_2 -> V_37 == V_38 ) {
...
static int F_85 ( struct V_79 * V_51 , const struct V_152 * V_133 )
{
struct V_153 * V_84 = F_86 ( V_51 ) ;
struct V_1 * V_2 ;
struct V_80 * V_154 ;
int V_155 ;
int V_65 , error ;
...
if ( ( F_87 ( V_84 -> V_160 . V_159 ) == V_158 [ V_65 ] . V_159 ) &&
( F_87 ( V_84 -> V_160 . V_161 ) == V_158 [ V_65 ] . V_161 ) )
break;
}
...
static int F_95 ( struct V_79 * V_51 , T_2 V_175 )
{
struct V_1 * V_2 = F_94 ( V_51 ) ;
