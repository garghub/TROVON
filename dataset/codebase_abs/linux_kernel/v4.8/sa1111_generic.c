...
struct V_52 * V_52 ;
int V_53 , V_54 = 0 ;
V_52 = F_10 ( & V_8 -> V_8 , NULL ) ;
if ( F_11 ( V_52 ) )
return F_12 ( V_52 ) ;
V_51 -> V_55 = F_1 ;
for ( V_53 = 0 ; V_53 < V_51 -> V_11 ; V_53 ++ ) {
V_6 = F_13 ( sizeof( * V_6 ) , V_56 ) ;
if ( ! V_6 )
return - V_57 ;
V_6 -> V_58 . V_11 = V_51 -> V_59 + V_53 ;
V_6 -> V_58 . V_52 = V_52 ;
F_14 ( & V_6 -> V_58 , V_51 , & V_8 -> V_8 ) ;
V_6 -> V_8 = V_8 ;
if ( V_6 -> V_58 . V_11 ) {
V_6 -> V_58 . V_60 . V_61 = V_8 -> V_62 [ V_63 ] ;
V_6 -> V_58 . V_64 [ V_65 ] . V_62 = V_8 -> V_62 [ V_66 ] ;
V_6 -> V_58 . V_64 [ V_65 ] . V_67 = L_1 ;
V_6 -> V_58 . V_64 [ V_68 ] . V_62 = V_8 -> V_62 [ V_69 ] ;
V_6 -> V_58 . V_64 [ V_68 ] . V_67 = L_2 ;
} else {
V_6 -> V_58 . V_60 . V_61 = V_8 -> V_62 [ V_70 ] ;
V_6 -> V_58 . V_64 [ V_65 ] . V_62 = V_8 -> V_62 [ V_71 ] ;
V_6 -> V_58 . V_64 [ V_65 ] . V_67 = L_3 ;
V_6 -> V_58 . V_64 [ V_68 ] . V_62 = V_8 -> V_62 [ V_72 ] ;
V_6 -> V_58 . V_64 [ V_68 ] . V_67 = L_4 ;
}
V_54 = F_9 ( & V_6 -> V_58 ) ;
if ( V_54 == 0 ) {
V_6 -> V_73 = F_15 ( & V_8 -> V_8 ) ;
F_16 ( & V_8 -> V_8 , V_6 ) ;
} else
F_17 ( V_6 ) ;
}
...
#endif
if ( V_54 ) {
F_35 ( V_8 -> V_75 . V_76 , 512 ) ;
F_22 ( V_8 ) ;
}
return V_54 ;
}
static int F_36 ( struct V_49 * V_8 )
{
struct V_5 * V_73 , * V_6 = F_15 ( & V_8 -> V_8 ) ;
F_16 ( & V_8 -> V_8 , NULL ) ;
for (; V_6 ; V_6 = V_73 ) {
V_73 = V_6 -> V_73 ;
F_37 ( & V_6 -> V_58 ) ;
