...
assert ( V_7 -> V_44 == 0 ) ;
assert ( V_7 -> V_43 == 0 ) ;
V_7 -> V_42 = F_44 ( V_7 -> V_34 , sizeof( V_7 -> V_42 [ 0 ] ) ,
V_41 ) ;
if ( ! V_7 -> V_42 ) {
V_36 = - V_13 ;
goto V_49;
...
static int F_45 ( struct V_52 * V_53 , struct V_45 * V_46 ,
struct V_27 * V_25 )
{
int V_36 ;
V_46 -> V_25 = V_25 ;
...
for ( V_33 = 0 ; V_33 < V_54 -> V_65 ; V_33 ++ ) {
V_36 = F_45 ( V_54 , V_54 -> V_66 [ V_33 ] , V_54 -> V_25 ) ;
if ( V_36 )
goto V_68;
}
return 0 ;
...
struct V_52 * F_52 ( struct V_24 * V_69 ,
...
V_54 -> V_76 = V_70 ;
for ( V_33 = 0 ; V_33 < V_54 -> V_65 ; V_33 ++ ) {
V_36 = F_45 ( V_54 , V_54 -> V_66 [ V_33 ] , V_25 ) ;
if ( V_36 )
goto V_68;
}
F_55 ( V_25 -> V_77 ) ;
...
int F_59 ( struct V_27 * V_28 , struct V_80 * V_77 )
{
static T_3 V_81 = F_60 ( - 1 ) ;
int V_36 ;
if ( ! V_28 -> V_25 )
return - V_73 ;
if ( ! V_28 -> V_59 || ! V_28 -> V_59 -> V_74 ||
! V_28 -> V_59 -> V_82 ||
! V_28 -> V_59 -> V_83 || ! V_28 -> V_59 -> V_84 )
return - V_48 ;
V_28 -> V_77 = V_77 ;
V_28 -> V_81 = ( int ) F_61 ( & V_81 ) ;
V_28 -> V_85 . V_86 = V_28 -> V_25 ;
V_28 -> V_85 . V_87 = V_32 ;
V_28 -> V_85 . V_88 = F_58 ;
( void ) F_62 ( & V_28 -> V_85 , L_3 , V_28 -> V_81 ) ;
V_36 = F_63 ( & V_28 -> V_85 ) ;
if ( V_36 )
return V_36 ;
F_55 ( V_89 ) ;
