...
static int F_125 ( struct V_208 * V_39 )
{
struct V_42 * V_167 = (struct V_42 * ) V_39 -> V_40 ;
struct V_216 V_217 ;
struct V_218 V_219 ;
...
static struct V_241 * F_133 ( struct V_208 * V_39 )
{
return ( (struct V_42 * ) V_39 -> V_40 ) -> V_242 ;
}
static int F_134 ( struct V_241 * V_243 , struct V_1 * V_2 ,
struct V_244 * V_245 )
{
unsigned int V_31 = V_245 -> V_31 ;
unsigned int V_246 = V_245 -> V_246 ;
struct V_247 * V_248 = V_245 -> V_249 ;
struct V_250 * V_251 ;
struct V_236 * V_10 ;
unsigned int V_252 ;
unsigned int V_253 = ( V_31 << V_254 ) + V_243 -> V_255 ;
int V_82 ;
for ( V_82 = 0 ; V_82 < V_246 ; V_82 ++ , V_31 ++ , V_253 += V_240 ) {
struct V_3 * V_4 = F_37 ( sizeof( struct V_236 ) +
V_240 , 0 , V_77 ) ;
if ( ! V_4 )
return - V_137 ;
F_128 ( V_4 , V_253 ) ;
V_10 = (struct V_236 * ) V_4 -> V_11 ;
V_251 = (struct V_250 * ) ( V_10 + 1 ) ;
V_252 = V_82 * V_256 ;
F_135 ( V_251 , V_245 , & V_248 ,
& V_252 ) ;
V_4 -> V_12 = V_257 ;
F_26 ( V_243 -> V_40 , V_4 ) ;
}
...
static void F_136 ( struct V_208 * V_39 , struct V_241 * V_243 ,
struct V_244 * V_245 )
{
unsigned int V_31 = V_245 -> V_31 ;
unsigned int V_253 = ( V_31 << V_254 ) + V_243 -> V_255 ;
...
unsigned int V_46 , int V_258 , bool V_259 )
{
struct V_3 * V_4 = F_37 ( sizeof( struct V_260 ) , 0 ,
V_199 ) ;
struct V_260 * V_10 ;
T_2 V_261 = V_258 < V_262 ? V_258 : 0 ;
F_14 ( 1 << V_192 ,
L_35 , V_2 , V_46 , V_258 ) ;
if ( ! V_4 )
return - V_137 ;
V_10 = (struct V_260 * ) V_4 -> V_11 ;
V_10 -> V_14 . V_15 = F_3 ( F_4 ( V_16 ) ) ;
F_5 ( V_10 ) = F_3 ( F_6 ( V_263 , V_46 ) ) ;
V_10 -> V_259 = F_138 ( V_259 ? 0 : 1 ) ;
V_10 -> V_264 = 0 ;
V_10 -> V_265 = F_139 ( 31 ) ;
V_10 -> V_266 = F_140 ( 0xF0000000 ) ;
V_10 -> V_261 = F_140 ( V_261 << 28 ) ;
V_4 -> V_12 = V_257 ;
F_26 ( V_2 -> V_39 -> V_40 , V_4 ) ;
return 0 ;
}
static int F_141 ( struct V_1 * V_2 , unsigned int V_46 ,
int V_267 , int V_268 , int V_259 )
{
struct V_3 * V_4 = F_37 ( sizeof( struct V_260 ) , 0 ,
V_199 ) ;
struct V_260 * V_10 ;
T_2 V_261 = ( V_267 ? 1 : 0 ) | ( V_268 ? 2 : 0 ) ;
F_14 ( 1 << V_192 ,
L_36 , V_2 , V_46 , V_267 , V_268 ) ;
if ( ! V_4 )
return - V_137 ;
V_10 = (struct V_260 * ) V_4 -> V_11 ;
V_10 -> V_14 . V_15 = F_3 ( F_4 ( V_16 ) ) ;
...
V_10 -> V_264 = 0 ;
V_10 -> V_265 = F_139 ( 31 ) ;
V_10 -> V_266 = F_140 ( 0x0F000000 ) ;
V_10 -> V_261 = F_140 ( V_261 << 24 ) ;
V_4 -> V_12 = V_257 ;
F_26 ( V_2 -> V_39 -> V_40 , V_4 ) ;
return 0 ;
}
static int F_142 ( struct V_208 * V_39 )
{
struct V_42 * V_53 = (struct V_42 * ) V_39 -> V_40 ;
struct V_209 * V_206 = V_39 -> V_179 [ 0 ] ;
struct V_269 V_270 ;
unsigned int V_271 , V_272 = 0 ;
struct V_273 V_274 ;
int V_82 , V_163 ;
V_163 = V_53 -> V_221 ( V_53 , V_275 , & V_274 ) ;
if ( V_163 < 0 ) {
F_98 ( L_37 ,
V_206 -> V_181 , V_163 ) ;
return V_163 ;
}
if ( V_274 . V_255 >= V_274 . V_276 ) {
F_126 ( L_38 ,
V_206 -> V_181 , V_274 . V_255 , V_274 . V_276 ) ;
return - V_277 ;
}
V_271 = ( V_274 . V_276 - V_274 . V_255 + 1 ) >> V_254 ;
V_272 = F_143 ( V_271 ) ;
F_38 ( L_39 ,
V_206 -> V_181 , V_274 . V_255 , V_274 . V_276 , V_271 , V_274 . V_272 ,
V_272 ) ;
memset ( & V_270 , 0 , sizeof( struct V_269 ) ) ;
for ( V_82 = 0 ; V_82 < 4 ; V_82 ++ )
V_270 . V_278 [ V_82 ] = V_274 . V_279 [ V_82 ] ;
F_144 ( V_272 , & V_270 ) ;
F_145 ( & V_53 -> V_242 , V_39 , & V_270 , V_271 ,
V_274 . V_255 , V_274 . V_255 , 0 ) ;
if ( ! ( V_39 -> V_38 & V_280 ) ) {
V_274 . V_272 = V_272 ;
V_274 . V_276 = V_274 . V_255 + ( V_271 << V_254 ) ;
V_163 = V_53 -> V_221 ( V_53 , V_281 , & V_274 ) ;
if ( V_163 < 0 ) {
F_98 ( L_40 ,
V_206 -> V_181 , V_163 ) ;
V_39 -> V_38 |= V_280 ;
...
V_39 -> V_285 = F_136 ;
V_39 -> F_133 = F_133 ;
V_39 -> V_286 = F_146 (unsigned int, ULP2_MAX_PDU_PAYLOAD,
uinfo.max_txsz - ISCSI_PDU_NONPAYLOAD_LEN) ;
V_39 -> V_287 = F_146 (unsigned int, ULP2_MAX_PDU_PAYLOAD,
...
if ( ! V_39 || V_39 -> V_38 & V_288 ) {
F_38 ( L_41 , V_39 , V_39 ? V_39 -> V_38 : 0 ) ;
return;
}
F_149 ( V_39 ) ;
}
...
{
struct V_208 * V_39 = F_148 ( V_167 ) ;
struct V_289 * V_289 = F_151 ( V_167 ) ;
int V_82 , V_163 ;
if ( V_39 ) {
F_38 ( L_42 , V_39 ) ;
return;
}
V_39 = F_152 ( 0 , V_289 -> V_290 . V_291 ) ;
if ( ! V_39 ) {
F_126 ( L_43 , V_167 ) ;
return;
}
V_39 -> V_38 = V_292 | V_293 ;
V_39 -> V_40 = V_167 ;
V_39 -> V_294 = V_289 -> V_294 ;
V_39 -> V_179 = V_289 -> V_217 ;
V_39 -> V_291 = V_289 -> V_290 . V_291 ;
V_39 -> V_295 = V_289 -> V_290 . V_295 ;
V_39 -> V_296 = V_297 ;
V_39 -> V_298 = V_299 ;
V_39 -> V_300 = V_301 ;
V_39 -> V_302 = sizeof( struct V_170 ) ;
V_39 -> V_303 = & V_304 ;
V_163 = F_142 ( V_39 ) ;
if ( V_163 ) {
F_38 ( L_44 , V_39 ) ;
...
V_163 = F_153 ( V_39 , V_306 , V_226 ,
& V_307 , V_308 ) ;
if ( V_163 )
goto V_305;
for ( V_82 = 0 ; V_82 < V_39 -> V_291 ; V_82 ++ )
...
static void F_154 ( struct V_42 * V_167 , T_1 V_309 , T_1 V_217 )
{
struct V_208 * V_39 = F_148 ( V_167 ) ;
F_14 ( 1 << V_35 ,
L_47 ,
V_167 , V_39 , V_309 , V_217 ) ;
if ( ! V_39 )
return;
switch ( V_309 ) {
case V_310 :
...
{
int V_220 ;
F_156 ( V_312 L_48 , V_313 ) ;
V_220 = F_157 ( & V_304 , & V_308 ) ;
if ( V_220 < 0 )
return V_220 ;
F_158 ( & V_117 ) ;
return 0 ;
