...
static void
F_156 ( unsigned long V_103 , long V_237 )
{
...
static int
F_157 ( unsigned long V_299 , long V_300 , int V_301 ,
T_3 V_302 )
{
int V_240 , V_303 ;
unsigned long V_304 ;
unsigned long V_305 , V_306 = 0 ;
unsigned char V_157 [ 4 ] ;
V_303 = 0 ;
for ( V_304 = V_299 ; V_300 > 0 ; -- V_300 , V_299 += 4 ) {
V_240 = F_73 ( V_299 , V_157 , 4 ) ;
if ( V_240 == 0 ) {
if ( V_301 ) {
const char * V_307 = V_234 [ V_227 ] ;
printf ( V_105 L_180 , V_299 , V_307 , V_307 , V_307 , V_307 ) ;
}
break;
}
V_305 = F_158 ( V_157 ) ;
if ( V_299 > V_304 && V_305 == V_306 ) {
if ( ! V_303 ) {
printf ( L_181 ) ;
V_303 = 1 ;
}
...
V_306 = V_305 ;
if ( V_301 )
printf ( V_105 L_182 , V_299 , V_305 ) ;
printf ( L_183 ) ;
V_302 ( V_305 , V_299 ) ;
printf ( L_34 ) ;
}
...
static int
F_46 ( unsigned long V_299 , long V_300 , int V_301 )
{
return F_157 ( V_299 , V_300 , V_301 , V_308 ) ;
}
void
F_159 ( unsigned long V_6 )
{
F_37 ( V_6 , L_184 , L_86 ) ;
}
void
...
F_160 ( & V_310 ) ;
F_153 () ;
while ( F_161 ( & V_310 , false , V_221 , sizeof( V_221 ) , & V_80 ) ) {
V_221 [ V_80 ] = '\0' ;
printf ( L_159 , V_221 ) ;
}
F_154 () ;
...
F_3 () ;
F_153 () ;
while ( ( V_312 = F_163 ( V_221 , V_313 , sizeof( V_221 ) - 1 ) ) ) {
if ( V_312 < 0 ) {
printf ( L_187 , V_312 ) ;
break;
}
...
if( V_87 != '\n' )
V_87 = 0 ;
F_79 ( ( void * ) ( V_27 == 's' ? & V_316 : & V_317 ) ) ;
if( V_87 != '\n' )
V_87 = 0 ;
F_79 ( ( void * ) & V_318 ) ;
switch( V_27 ) {
case 'm' :
memmove ( ( void * ) V_315 , ( void * ) V_317 , V_318 ) ;
break;
case 's' :
memset ( ( void * ) V_315 , V_316 , V_318 ) ;
break;
case 'd' :
if( V_87 != '\n' )
V_87 = 0 ;
F_79 ( ( void * ) & V_319 ) ;
F_164 ( ( unsigned char * ) V_315 , ( unsigned char * ) V_317 , V_318 , V_319 ) ;
break;
}
}
static void
F_164 ( unsigned char * V_320 , unsigned char * V_321 , unsigned V_322 , unsigned V_323 )
{
unsigned V_146 , V_324 ;
V_324 = 0 ;
for( V_146 = V_322 ; V_146 > 0 ; -- V_146 )
if( * V_320 ++ != * V_321 ++ )
if( ++ V_324 <= V_323 )
printf ( L_188 , V_320 - 1 ,
V_320 [ - 1 ] , V_321 - 1 , V_321 [ - 1 ] ) ;
if( V_324 > V_323 )
printf ( L_189 , V_324 ) ;
}
static void
...
V_146 = 0 ;
for ( V_72 = V_315 ; V_72 < V_325 ; V_72 += 4 ) {
if ( F_73 ( V_72 , V_157 , 4 ) == 4
&& ( ( F_158 ( V_157 ) ^ V_316 ) & V_326 ) == 0 ) {
printf ( L_191 , V_72 , F_158 ( V_157 ) ) ;
if ( ++ V_146 >= 10 )
break;
}
}
...
F_79 ( & V_329 ) ;
V_327 = 0 ;
for ( V_72 = V_315 ; V_72 < V_329 ; V_72 += V_328 ) {
V_156 = F_73 ( V_72 , & V_102 , 1 ) ;
if ( V_156 && ! V_327 ) {
printf ( L_192 , V_72 ) ;
} else if ( ! V_156 && V_327 )
printf ( L_193 , V_72 - V_328 ) ;
V_327 = V_156 ;
if ( V_72 + V_328 < V_72 )
break;
}
...
static void F_165 ( struct V_330 * V_331 )
{
char V_332 ;
V_332 = ( V_331 -> V_332 == 0 ) ? 'R' :
( V_331 -> V_332 < 0 ) ? 'U' :
( V_331 -> V_332 & V_333 ) ? 'D' :
( V_331 -> V_332 & V_334 ) ? 'T' :
( V_331 -> V_332 & V_335 ) ? 'C' :
...
printf ( L_194 , V_331 ,
V_331 -> V_340 . V_341 ,
V_331 -> V_143 , V_331 -> V_342 -> V_143 ,
V_332 , F_166 ( V_331 ) -> V_34 ,
V_331 -> V_144 ) ;
}
...
V_65 = 1 ;
F_3 () ;
V_111 = V_344 ( args [ 0 ] , args [ 1 ] , args [ 2 ] , args [ 3 ] ,
...
char V_345 [ 8 ] ;
int V_67 ;
for ( V_67 = 0 ; V_67 < sizeof( V_345 ) - 1 ; ++ V_67 ) {
V_236 = F_85 () ;
if ( ! isalnum ( V_236 ) ) {
V_87 = V_236 ;
break;
...
V_345 [ V_67 ] = 0 ;
for ( V_67 = 0 ; V_67 < V_346 ; ++ V_67 ) {
if ( strcmp ( V_347 [ V_67 ] , V_345 ) == 0 ) {
if ( V_83 == NULL ) {
printf ( L_199 ) ;
return 0 ;
}
...
F_85 ( void )
{
if ( V_349 == NULL || * V_349 == 0 ) {
if ( F_171 ( line , sizeof( line ) ) == NULL ) {
V_349 = NULL ;
return V_57 ;
}
V_349 = line ;
...
static void F_37 ( unsigned long V_37 , const char * V_352 ,
const char * V_353 )
{
char * V_354 ;
...
V_65 = 1 ;
F_3 () ;
V_115 = F_118 ( V_37 , & V_114 , & V_32 , & V_354 ,
V_116 ) ;
F_3 () ;
F_126 ( 200 ) ;
}
V_65 = 0 ;
if ( V_115 ) {
printf ( L_204 , V_352 , V_115 , V_32 , V_114 ) ;
if ( V_354 )
printf ( L_205 , V_354 ) ;
}
printf ( L_159 , V_353 ) ;
...
printf ( L_211 , F_174 ( V_67 ) ) ;
printf ( L_34 ) ;
}
static void F_109 ( void )
{
int V_67 ;
for ( V_67 = 0 ; V_67 < V_363 ; V_67 ++ ) {
unsigned long V_364 , V_365 , V_366 ;
asm volatile("tlbre %0,%1,0" : "=r" (w0) : "r" (i));
asm volatile("tlbre %0,%1,1" : "=r" (w1) : "r" (i));
asm volatile("tlbre %0,%1,2" : "=r" (w2) : "r" (i));
printf ( L_212 , V_67 , V_364 , V_365 , V_366 ) ;
if ( V_364 & V_367 ) {
printf ( L_213 ,
V_364 & V_368 ,
V_365 & V_369 ,
...
{
V_224 V_376 , V_377 , V_378 ;
V_225 V_379 ;
int V_67 , V_380 , V_381 , V_382 , V_383 , V_384 , V_385 = 0 ;
int V_386 ;
static const char * V_387 [] = {
L_214 ,
L_215 ,
L_216 ,
L_217 ,
...
V_386 = ( V_376 & 3 ) + 1 ;
V_381 = ( ( V_376 >> 2 ) & 3 ) + 1 ;
V_382 = ( ( V_376 >> 6 ) & 0x1f ) + 1 ;
V_383 = ( V_376 >> 24 ) & 0xf ;
V_384 = ( V_376 >> 16 ) & 0x7f ;
if ( ( V_386 > 1 ) && ( V_376 & 0x10000 ) )
V_385 = 1 ;
printf ( L_246 ,
V_386 , V_381 , V_382 , V_383 , V_384 ) ;
V_377 = ( 1ul << V_382 ) - 1 ;
V_378 = ( 1ul << V_383 ) - 1 ;
V_379 = ( 1ull << V_384 ) - 1 ;
for ( V_380 = 0 ; V_380 < V_381 ; V_380 ++ ) {
V_224 V_389 ;
int V_390 , V_391 , V_392 = 1 ;
printf ( L_247 , V_380 ) ;
switch( V_380 ) {
case 0 :
V_389 = F_111 ( V_393 ) ;
...
V_390 = V_389 & 0xfff ;
V_391 = ( V_389 >> 24 ) & 0xff ;
for ( V_67 = 0 ; V_67 < V_390 ; V_67 ++ ) {
V_224 V_397 = F_175 ( V_380 ) ;
V_224 V_398 = F_176 ( V_399 ) ;
V_225 V_400 = 0 ;
V_225 V_401 ;
int V_402 = V_67 , V_403 = V_67 ;
if ( V_391 != 0 ) {
V_403 = V_67 / V_391 ;
V_402 = V_67 % V_391 ;
V_400 = V_403 * 0x1000 ;
...
printf ( L_250 , V_403 , 'A' + V_402 ) ;
else
printf ( L_251 , 'A' + V_402 ) ;
V_392 = 0 ;
printf ( L_252 ,
V_400 & ~ 0x3ffull ,
( V_398 >> 16 ) & 0x3fff ,
...
V_400 & V_417 ? 'g' : ' ' ,
V_400 & V_418 ? 'e' : ' ' ) ;
printf ( L_254 , V_401 & V_379 & ~ 0x7ffull ) ;
if ( V_398 & V_409 )
printf ( L_255 ,
V_387 [ ( V_401 >> 1 ) & 0x1f ] ) ;
else
...
void F_186 ( struct V_437 * V_438 )
{
struct V_439 * V_439 ;
F_187 (spu, list, full_list) {
if ( V_439 -> V_440 >= V_441 ) {
F_188 ( 1 ) ;
continue;
}
V_442 [ V_439 -> V_440 ] . V_439 = V_439 ;
V_442 [ V_439 -> V_440 ] . V_443 = 0 ;
V_442 [ V_439 -> V_440 ] . V_444 = ( unsigned long )
V_442 [ V_439 -> V_440 ] . V_439 -> V_445 ;
}
}
...
int V_67 ;
V_225 V_351 ;
for ( V_67 = 0 ; V_67 < V_441 ; V_67 ++ ) {
if ( ! V_442 [ V_67 ] . V_439 )
continue;
if ( setjmp ( V_40 ) == 0 ) {
V_65 = 1 ;
F_3 () ;
V_439 = V_442 [ V_67 ] . V_439 ;
V_442 [ V_67 ] . V_446 =
F_190 ( & V_439 -> V_447 -> V_448 ) ;
V_351 = F_191 ( V_439 ) ;
V_442 [ V_67 ] . V_449 = V_351 ;
V_351 &= ~ V_450 ;
F_192 ( V_439 , V_351 ) ;
F_3 () ;
F_126 ( 200 ) ;
...
F_3 () ;
V_439 = V_442 [ V_67 ] . V_439 ;
F_192 ( V_439 , V_442 [ V_67 ] . V_449 ) ;
F_194 ( & V_439 -> V_447 -> V_448 ,
V_442 [ V_67 ] . V_446 ) ;
F_3 () ;
F_126 ( 200 ) ;
printf ( L_267 , V_67 ) ;
...
static void F_195 ( struct V_439 * V_439 )
{
printf ( L_269 , V_439 ) ;
F_196 ( V_439 , L_270 , V_440 ) ;
F_196 ( V_439 , L_159 , V_115 ) ;
F_196 ( V_439 , L_271 , V_451 ) ;
F_196 ( V_439 , L_272 , V_445 ) ;
F_196 ( V_439 , L_271 , V_452 ) ;
F_196 ( V_439 , L_270 , V_453 ) ;
F_196 ( V_439 , L_271 , V_33 ) ;
F_196 ( V_439 , L_273 , V_454 ) ;
F_196 ( V_439 , L_271 , V_455 ) ;
F_196 ( V_439 , L_271 , V_456 ) ;
F_196 ( V_439 , L_271 , V_457 ) ;
F_196 ( V_439 , L_271 , V_458 [ 0 ] ) ;
F_196 ( V_439 , L_271 , V_458 [ 1 ] ) ;
F_196 ( V_439 , L_271 , V_458 [ 2 ] ) ;
F_196 ( V_439 , L_270 , V_459 ) ;
F_196 ( V_439 , L_273 , V_143 ) ;
F_196 ( V_439 , L_272 , V_460 ) ;
F_196 ( V_439 , L_272 , V_461 ) ;
F_196 ( V_439 , L_272 , V_462 ) ;
F_196 ( V_439 , L_272 , V_463 ) ;
F_196 ( V_439 , L_271 , V_464 ) ;
F_196 ( V_439 , L_272 , V_447 ) ;
F_197 ( L_270 , V_447 -> V_448 ,
F_190 ( & V_439 -> V_447 -> V_448 ) ) ;
F_197 ( L_270 , V_447 -> V_465 ,
F_190 ( & V_439 -> V_447 -> V_465 ) ) ;
F_197 ( L_270 , V_447 -> V_466 ,
F_190 ( & V_439 -> V_447 -> V_466 ) ) ;
F_196 ( V_439 , L_272 , V_467 ) ;
F_196 ( V_439 , L_272 , V_468 ) ;
}
int
F_198 ( unsigned long V_299 , long V_300 , int V_301 )
{
return F_157 ( V_299 , V_300 , V_301 , V_469 ) ;
}
static void F_199 ( unsigned long V_296 , int V_470 )
{
unsigned long V_32 , V_6 , V_471 ;
if ( setjmp ( V_40 ) == 0 ) {
V_65 = 1 ;
F_3 () ;
V_471 = ( unsigned long ) V_442 [ V_296 ] . V_439 -> V_445 ;
F_3 () ;
F_126 ( 200 ) ;
} else {
V_65 = 0 ;
...
case 'd' :
V_470 = F_85 () ;
if ( isxdigit ( V_470 ) || V_470 == '\n' )
V_87 = V_470 ;
case 'f' :
F_79 ( & V_296 ) ;
if ( V_296 >= V_441 || ! V_442 [ V_296 ] . V_439 ) {
printf ( L_278 ) ;
return 0 ;
}
switch ( V_27 ) {
case 'f' :
F_195 ( V_442 [ V_296 ] . V_439 ) ;
break;
default:
F_199 ( V_296 , V_470 ) ;
break;
