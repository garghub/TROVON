...
{
struct V_23 * V_65 ;
unsigned int V_66 = sizeof( * V_64 ) ;
unsigned int V_67 = V_60 - V_66 ;
V_65 = F_44 ( NULL , V_60 + V_45 ) ;
if ( ! V_65 )
goto V_32;
V_65 -> V_68 = V_8 -> V_68 ;
F_45 ( V_65 , V_66 + V_45 ) ;
F_46 ( V_8 , V_65 , V_8 -> V_36 - V_67 ) ;
F_47 ( V_65 , V_66 ) ;
memcpy ( V_65 -> V_33 , V_64 , V_66 ) ;
V_32:
return V_65 ;
}
int F_48 ( struct V_23 * V_8 ,
struct V_9 * V_10 ,
struct V_55 * V_56 )
{
struct V_51 * V_52 ;
struct V_49 * V_69 = NULL ;
struct V_20 V_70 ;
struct V_23 * V_65 ;
unsigned int V_60 = V_56 -> V_58 -> V_59 -> V_60 ;
unsigned int V_66 = sizeof( V_70 ) ;
unsigned int V_71 , V_72 ;
int V_31 = - 1 ;
V_60 = F_49 (unsigned int, mtu, BATADV_FRAG_MAX_FRAG_SIZE) ;
V_71 = V_60 - V_66 ;
V_72 = V_71 * V_21 ;
if ( V_8 -> V_36 > V_72 )
goto V_40;
...
V_70 . V_75 = V_76 ;
V_70 . V_63 = V_77 ;
V_70 . V_22 = F_51 ( F_52 ( & V_52 -> V_78 ) ) ;
V_70 . V_79 = 0 ;
V_70 . V_35 = 0 ;
V_70 . V_39 = F_51 ( V_8 -> V_36 ) ;
if ( V_8 -> V_68 >= 256 && V_8 -> V_68 <= 263 )
V_70 . V_68 = V_8 -> V_68 - 256 ;
F_53 ( V_70 . V_80 , V_69 -> V_59 -> V_81 ) ;
F_53 ( V_70 . V_57 , V_10 -> V_80 ) ;
while ( V_8 -> V_36 > V_71 ) {
V_65 = F_43 ( V_8 , & V_70 , V_60 ) ;
if ( ! V_65 )
goto V_40;
F_38 ( V_52 , V_82 ) ;
F_39 ( V_52 , V_83 ,
...
if ( F_54 ( V_8 , V_66 ) < 0 ||
F_26 ( V_8 , V_66 + V_45 , 0 , V_34 ) < 0 )
goto V_40;
memcpy ( V_8 -> V_33 , & V_70 , V_66 ) ;
F_38 ( V_52 , V_82 ) ;
F_39 ( V_52 , V_83 ,
V_8 -> V_36 + V_45 ) ;
V_31 = F_40 ( V_8 , V_56 ) ;
