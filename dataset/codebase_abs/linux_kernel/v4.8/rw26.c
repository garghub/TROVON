...
struct V_94 * V_95 = F_57 ( V_7 ) ;
struct V_123 * V_124 = & V_95 -> V_96 . V_97 . V_125 ;
if ( V_2 && V_124 -> V_126 > 0 ) {
F_78 ( V_2 ) ;
F_28 ( V_2 ) ;
V_2 = NULL ;
}
...
V_115 -> V_127 = V_1 ;
F_81 ( & V_1 -> V_128 , L_5 , V_36 ) ;
F_82 ( V_7 , V_36 , V_1 ) ;
if ( ! F_83 ( V_2 ) ) {
if ( V_118 == 0 && V_119 == V_12 ) {
F_84 ( V_129 , V_7 , V_1 , L_6 ) ;
F_85 ( V_2 , 0x11 ) ;
} else {
...
static int F_88 ( struct V_72 * V_72 , struct V_19 * V_13 ,
T_4 V_109 , unsigned V_110 , unsigned V_130 ,
...
F_43 ( V_124 , V_1 ) ;
if ( V_124 -> V_126 == 1 )
V_95 -> V_96 . V_97 . V_132 = V_118 ;
else
F_2 ( V_118 == 0 ) ;
V_95 -> V_96 . V_97 . V_133 = V_118 + V_130 ;
if ( V_124 -> V_126 >= V_134 )
V_131 = true ;
F_90 ( V_86 , V_7 , V_1 ,
L_7 , V_124 -> V_126 ) ;
} else {
F_41 ( V_7 , V_36 , V_1 ) ;
V_115 -> V_127 = NULL ;
F_91 ( & V_1 -> V_128 , L_5 , V_36 ) ;
F_10 ( V_7 , V_1 ) ;
V_131 = true ;
}
if ( V_131 ||
V_72 -> V_135 & V_136 || F_92 ( F_93 ( V_72 ) ) )
V_20 = F_79 ( V_7 , V_36 ) ;
return V_20 >= 0 ? V_130 : V_20 ;
}
static int F_94 ( struct V_19 * V_13 ,
struct V_1 * V_137 , struct V_1 * V_1 ,
enum V_138 V_139
)
{
return - V_120 ;
