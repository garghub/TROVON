...
0 , V_51 ) ;
F_16 ( V_51 L_10 ) ;
V_56 = ( T_1 * ) V_31 -> V_56 - V_52 ;
if ( V_56 < ( T_1 * ) V_57 || F_15 ( V_56 , V_55 ) ) {
V_56 = ( T_1 * ) V_31 -> V_56 ;
V_54 = V_54 - V_52 + 1 ;
}
for ( V_46 = 0 ; V_46 < V_54 ; V_46 ++ , V_56 ++ ) {
if ( V_56 < ( T_1 * ) V_57 ||
F_15 ( V_56 , V_55 ) ) {
F_13 ( L_11 ) ;
break;
}
if ( V_56 == ( T_1 * ) V_31 -> V_56 )
F_13 ( L_12 , V_55 ) ;
else
F_13 ( L_13 , V_55 ) ;
}
...
int F_24 ( unsigned long V_56 )
{
unsigned short V_58 ;
if ( F_25 ( & V_58 , ( const void V_59 * ) V_56 , sizeof( V_58 ) ) )
return 0 ;
return V_58 == 0x0b0f ;
}
