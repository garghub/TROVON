...
unsigned long V_51 = ( unsigned long ) F_52 ( V_11 ) ;
int V_52 = 0 ;
int V_12 ;
int V_16 = - V_53 ;
int V_54 = V_55 ;
T_1 V_56 = 0 ;
V_2 = F_53 ( V_11 , sizeof( * V_2 ) , V_57 ) ;
if ( ! V_2 )
return - V_58 ;
F_54 ( V_48 , V_2 ) ;
F_55 ( & V_2 -> V_59 ) ;
...
F_57 ( V_11 ) ;
F_58 ( V_11 ) ;
V_44 = F_59 ( V_48 , V_60 , 0 ) ;
if ( V_44 ) {
V_50 = F_59 ( V_48 , V_61 , V_52 ++ ) ;
...
F_36 ( V_9 ) ;
F_67 ( & V_9 -> V_63 , & V_2 -> V_59 ) ;
V_56 |= 3 << ( V_12 * 8 ) ;
}
if ( V_44 ) {
V_16 = F_68 ( V_11 , V_44 -> V_67 , F_39 , 0 ,
F_69 ( V_11 ) , V_2 ) ;
if ( V_16 ) {
F_15 ( V_11 , L_12 ) ;
goto V_62;
