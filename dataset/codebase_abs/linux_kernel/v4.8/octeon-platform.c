...
V_30 = F_22 ( V_38 ,
L_5 , & V_39 ) ;
if ( ! V_30 && strcmp ( L_6 , V_39 ) == 0 )
V_33 = true ;
}
V_27 . V_17 = 0 ;
V_27 . V_18 . V_40 = 1 ;
F_23 ( F_24 ( 0 ) , V_27 . V_17 ) ;
...
V_15 . V_18 . V_49 = 0 ;
V_15 . V_18 . V_50 = 0 ;
F_23 ( F_12 ( 0 ) , V_15 . V_17 ) ;
V_15 . V_18 . V_51 = V_33 ? 0 : 1 ;
switch ( V_32 ) {
default:
F_26 ( L_7 ,
V_32 ) ;
...
static int F_32 ( struct V_1 * V_54 )
{
F_16 ( & V_54 -> V_25 ) ;
return 0 ;
}
static void F_33 ( struct V_1 * V_54 )
{
F_31 () ;
}
static void T_1 F_34 ( struct V_24 * V_25 )
{
union V_55 V_56 ;
F_16 ( V_25 ) ;
V_56 . V_17 = F_11 ( F_35 ( 0 ) ) ;
V_56 . V_18 . V_57 = 1 ;
V_56 . V_18 . V_58 = 0 ;
#ifdef F_36
V_56 . V_18 . V_59 = 1 ;
...
static void F_41 ( struct V_1 * V_54 )
{
F_31 () ;
}
static void T_1 F_42 ( struct V_24 * V_25 )
{
union V_65 V_66 ;
F_16 ( V_25 ) ;
V_66 . V_17 = F_11 ( F_43 ( 0 ) ) ;
V_66 . V_18 . V_58 = 0 ;
#ifdef F_36
V_66 . V_18 . V_59 = 1 ;
V_66 . V_18 . V_60 = 1 ;
...
static void T_1 F_59 ( int V_90 , V_17 * V_91 )
{
const T_4 * V_92 ;
int V_93 ;
T_4 V_94 [ 6 ] ;
...
static void T_1 F_62 ( int V_99 , int V_30 , int V_80 , int V_100 )
{
char V_101 [ 20 ] ;
int V_72 ;
int V_73 ;
...
if ( F_46 ( V_103 ) )
V_102 = ( 0x100 * V_30 ) + ( 0x10 * V_80 ) + 0x800 ;
else
V_102 = 16 * V_30 + V_80 ;
V_73 = F_65 ( V_102 ) ;
F_47 ( V_72 , V_73 ) ;
...
int V_111 ;
snprintf ( V_101 , sizeof( V_101 ) , L_24 , V_30 ) ;
...
int V_99 ;
int V_80 ;
snprintf ( V_101 , sizeof( V_101 ) , L_22 , V_30 ) ;
...
V_125 . V_17 = F_11 ( F_77 ( V_131 ) ) ;
V_127 = V_125 . V_18 . V_143 << 16 ;
V_128 = ( V_125 . V_18 . V_144 + 1 ) << 16 ;
if ( V_125 . V_18 . V_40 && V_126 >= V_127
&& V_126 < V_127 + V_128 ) {
V_133 = V_125 . V_18 . V_145 ;
break;
}
}
if ( V_131 >= 7 ) {
...
V_125 . V_17 =
F_11 ( F_77 ( V_131 + 1 ) ) ;
V_129 = V_125 . V_18 . V_143 << 16 ;
V_130 = ( V_125 . V_18 . V_144 + 1 ) << 16 ;
if ( ! V_125 . V_18 . V_40 )
goto V_142;
V_134 = true ;
} else {
