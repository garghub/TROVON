...
static void F_203 ( struct V_1 * V_2 , struct V_280 * V_281 ,
struct V_280 * V_36 )
{
T_6 V_254 ;
for (; V_281 < V_36 ; V_281 ++ )
if ( ( V_281 -> V_55 == ( T_1 ) ( V_2 -> V_55 >> V_281 -> V_282 ) ||
V_281 -> V_55 == ( T_1 ) V_283 ) &&
( V_281 -> V_161 == V_2 -> V_161 ||
V_281 -> V_161 == ( T_2 ) V_283 ) &&
( V_281 -> V_87 == V_2 -> V_87 ||
V_281 -> V_87 == ( T_2 ) V_283 ) ) {
V_254 = F_173 ( V_2 , V_281 -> V_284 ) ;
V_281 -> V_284 ( V_2 ) ;
F_181 ( V_2 , V_254 , V_281 -> V_284 ) ;
}
}
void F_204 ( enum V_285 V_286 , struct V_1 * V_2 )
{
...
F_148 ( V_314 L_117 ,
V_312 << 2 , V_316 << 2 ) ;
V_313 = V_312 ? V_312 : V_316 ;
}
return 0 ;
}
static int F_207 ( struct V_1 * V_2 , int V_317 )
{
if ( V_317 )
return 0 ;
if ( ! F_208 ( V_2 ) )
F_170 ( & V_2 -> V_2 , L_118 ) ;
F_209 ( V_2 , V_318 , V_319 ) ;
F_200 ( 100 ) ;
return 0 ;
}
static int F_210 ( struct V_1 * V_2 , int V_317 )
{
void T_4 * V_320 ;
unsigned long V_321 ;
T_1 V_76 ;
...
if ( ! V_320 )
return - V_322 ;
F_211 ( 0x00000002 , V_320 + V_323 ) ;
F_211 ( 0x00000005 , V_320 + V_324 ) ;
V_76 = F_212 ( V_320 + V_325 ) & 0xfffffffe ;
F_211 ( V_76 , V_320 + V_325 ) ;
V_321 = V_326 + F_213 ( V_327 ) ;
do {
V_76 = F_212 ( V_320 + V_328 ) ;
if ( ( V_76 & 0xb0000000 ) == 0 )
goto V_329;
F_200 ( 10 ) ;
} while ( F_214 ( V_326 , V_321 ) );
F_52 ( & V_2 -> V_2 , L_119 ) ;
V_329:
F_211 ( 0x00000002 , V_320 + V_330 ) ;
F_186 ( V_2 , V_320 ) ;
return 0 ;
}
static int F_215 ( struct V_1 * V_2 , int V_317 )
{
T_2 V_331 ;
T_2 V_332 ;
...
V_331 | V_334 ) ;
F_216 ( V_2 ) ;
F_33 ( V_2 , V_2 -> V_335 + V_336 , & V_332 ) ;
if ( ( V_332 & V_337 ) == 0 )
F_54 ( V_2 , V_2 -> V_335 + V_336 ,
V_332 |
V_337 |
V_338 ) ;
if ( ! F_208 ( V_2 ) )
...
int F_218 ( struct V_1 * V_2 , int V_317 )
{
const struct V_339 * V_29 ;
for ( V_29 = V_339 ; V_29 -> V_340 ; V_29 ++ ) {
if ( ( V_29 -> V_161 == V_2 -> V_161 ||
V_29 -> V_161 == ( T_2 ) V_283 ) &&
( V_29 -> V_87 == V_2 -> V_87 ||
V_29 -> V_87 == ( T_2 ) V_283 ) )
return V_29 -> V_340 ( V_2 , V_317 ) ;
}
return - V_333 ;
}
...
V_342 = F_223 ( V_343 , V_2 ) ;
if ( V_342 )
F_220 ( V_2 , V_342 -> V_344 ) ;
}
static void F_224 ( struct V_1 * V_54 )
{
if ( ! F_191 ( V_54 -> V_51 ) &&
V_54 -> V_150 == V_345 &&
! F_225 ( V_54 ) && F_225 ( V_54 -> V_51 -> V_346 ) &&
F_195 ( V_54 -> V_51 -> V_346 ) != V_347 )
V_54 -> V_109 |= V_348 ;
}
...
{
T_1 V_55 = V_54 -> V_55 ;
V_54 -> V_55 = ( V_349 << 8 ) | 0x01 ;
F_6 ( & V_54 -> V_2 , L_120 ,
V_55 , V_54 -> V_55 ) ;
}
static void F_228 ( struct V_1 * V_54 )
{
struct V_1 * V_350 = F_229 ( V_54 ) ;
if ( ! V_350 ) {
F_52 ( & V_54 -> V_2 , L_121 ) ;
return;
}
...
static int F_232 ( struct V_1 * V_2 , T_2 V_353 )
{
#ifdef F_233
...
return - V_357 ;
V_356 = F_234 ( L_123 , 0 , & V_355 ) ;
if ( F_197 ( V_356 ) )
return - V_357 ;
V_353 &= ( V_358 | V_359 | V_360 | V_361 ) ;
return V_353 & ~ ( V_358 | V_359 ) ? 0 : 1 ;
#else
return - V_357 ;
#endif
}
static int F_235 ( struct V_1 * V_2 , T_2 V_353 )
{
V_353 &= ~ ( V_362 | V_363 | V_358 |
V_359 | V_364 | V_361 ) ;
return V_353 ? 0 : 1 ;
}
...
{
int V_29 ;
if ( ! F_225 ( V_2 ) || F_195 ( V_2 ) != V_365 )
return false ;
for ( V_29 = 0 ; V_29 < F_237 ( V_366 ) ; V_29 ++ )
if ( V_366 [ V_29 ] == V_2 -> V_87 )
return true ;
return false ;
}
static int F_238 ( struct V_1 * V_2 , T_2 V_353 )
{
T_2 V_33 = V_2 -> V_109 & V_367 ?
V_368 : 0 ;
if ( ! F_236 ( V_2 ) )
return - V_333 ;
return V_353 & ~ V_33 ? 0 : 1 ;
}
...
static int F_240 ( struct V_1 * V_2 , T_2 V_353 )
{
int V_39 ;
T_1 V_369 , V_227 ;
if ( ! F_239 ( V_2 ) )
return - V_333 ;
V_39 = F_241 ( V_2 , V_370 ) ;
if ( ! V_39 )
return - V_333 ;
F_10 ( V_2 , V_39 + V_371 , & V_369 ) ;
V_353 &= ( V_369 | V_360 ) ;
F_10 ( V_2 , V_39 + V_372 , & V_227 ) ;
return V_353 & ~ V_227 ? 0 : 1 ;
}
static int F_242 ( struct V_1 * V_2 , T_2 V_353 )
{
V_353 &= ~ ( V_362 | V_363 | V_358 |
V_359 | V_364 | V_361 ) ;
return V_353 ? 0 : 1 ;
}
int F_243 ( struct V_1 * V_2 , T_2 V_353 )
{
const struct V_373 * V_29 ;
int V_374 ;
for ( V_29 = V_373 ; V_29 -> V_375 ; V_29 ++ ) {
if ( ( V_29 -> V_161 == V_2 -> V_161 ||
V_29 -> V_161 == ( T_2 ) V_283 ) &&
( V_29 -> V_87 == V_2 -> V_87 ||
V_29 -> V_87 == ( T_2 ) V_283 ) ) {
V_374 = V_29 -> V_375 ( V_2 , V_353 ) ;
if ( V_374 >= 0 )
return V_374 ;
}
}
...
{
T_1 V_132 , V_376 , V_377 ;
void T_4 * V_378 ;
F_245 ( V_2 -> V_51 , F_115 ( 31 , 0 ) ,
V_379 , & V_132 ) ;
if ( ! ( V_132 & V_380 ) )
return - V_381 ;
V_378 = F_84 ( V_132 & V_382 ,
F_246 ( V_383 ) ) ;
if ( ! V_378 )
return - V_322 ;
V_376 = F_86 ( V_378 + V_384 ) ;
V_376 &= V_385 | V_386 ;
if ( V_376 != ( V_385 | V_386 ) ) {
V_377 = F_86 ( V_378 + V_383 ) ;
if ( V_377 & V_387 ) {
F_6 ( & V_2 -> V_2 , L_124 ) ;
V_377 &= ~ V_387 ;
F_87 ( V_377 , V_378 + V_383 ) ;
}
}
F_89 ( V_378 ) ;
return 0 ;
...
{
T_1 V_388 ;
F_10 ( V_2 , V_389 , & V_388 ) ;
if ( ! ( V_388 & V_390 ) ) {
F_6 ( & V_2 -> V_2 , L_125 ) ;
V_388 |= V_390 ;
F_54 ( V_2 , V_389 , V_388 ) ;
}
}
...
V_227 |= ( V_369 & V_359 ) ;
V_227 |= ( V_369 & V_364 ) ;
F_67 ( V_2 , V_39 + V_372 , V_227 ) ;
F_6 ( & V_2 -> V_2 , L_128 ) ;
return 0 ;
}
int F_250 ( struct V_1 * V_2 )
{
const struct V_391 * V_29 ;
int V_374 ;
for ( V_29 = V_391 ; V_29 -> V_392 ; V_29 ++ ) {
if ( ( V_29 -> V_161 == V_2 -> V_161 ||
V_29 -> V_161 == ( T_2 ) V_283 ) &&
( V_29 -> V_87 == V_2 -> V_87 ||
V_29 -> V_87 == ( T_2 ) V_283 ) ) {
V_374 = V_29 -> V_392 ( V_2 ) ;
if ( V_374 >= 0 )
return V_374 ;
}
}
...
T_2 V_394 , * V_369 ;
struct V_395 * V_396 ;
if ( V_54 -> V_397 || F_147 ( V_54 , V_398 ) )
return;
V_39 = F_147 ( V_54 , V_399 ) ;
if ( ! V_39 )
return;
F_5 ( V_54 , V_39 + 1 , & V_393 ) ;
if ( V_393 )
return;
V_39 = 0x50 ;
F_33 ( V_54 , V_39 , & V_394 ) ;
if ( V_394 == ( 0x0000 | V_398 ) ) {
T_1 V_356 ;
#ifndef F_252
#define F_252 7
#endif
...
V_54 -> V_397 = V_39 ;
F_33 ( V_54 , V_39 + V_400 , & V_394 ) ;
V_54 -> V_401 = V_394 ;
F_33 ( V_54 , V_39 + V_402 , & V_394 ) ;
V_54 -> V_246 = V_394 & V_403 ;
V_54 -> V_28 = V_404 ;
if ( F_10 ( V_54 , V_405 , & V_356 ) !=
V_406 || ( V_356 == 0xffffffff ) )
V_54 -> V_28 = V_405 ;
if ( F_253 ( V_54 , V_398 ) )
return;
V_396 = F_254 ( sizeof( * V_396 ) + V_40 , V_407 ) ;
if ( ! V_396 )
return;
V_396 -> V_369 . V_408 = V_398 ;
V_396 -> V_369 . V_409 = 0 ;
V_396 -> V_369 . V_40 = V_40 ;
V_369 = ( T_2 * ) & V_396 -> V_369 . V_410 [ 0 ] ;
F_255 ( V_54 , V_318 , & V_369 [ V_29 ++ ] ) ;
F_255 ( V_54 , V_411 , & V_369 [ V_29 ++ ] ) ;
F_255 ( V_54 , V_412 , & V_369 [ V_29 ++ ] ) ;
F_255 ( V_54 , V_413 , & V_369 [ V_29 ++ ] ) ;
F_255 ( V_54 , V_414 , & V_369 [ V_29 ++ ] ) ;
F_255 ( V_54 , V_415 , & V_369 [ V_29 ++ ] ) ;
F_255 ( V_54 , V_416 , & V_369 [ V_29 ++ ] ) ;
F_256 ( & V_396 -> V_417 , & V_54 -> V_418 ) ;
}
}
