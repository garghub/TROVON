...
if ( ( V_27 -> V_72 & V_111 ) && ! V_76 ) {
F_2 ( L_15 ,
* V_29 ) ;
return false ;
}
if ( V_27 -> V_72 & V_112 ) {
const T_1 V_113 = V_27 -> V_77 . V_113 ? V_27 -> V_77 . V_113 : V_74 ;
T_1 V_114 ;
for ( V_114 = V_27 -> V_77 . V_114 ; V_114 < V_74 ;
V_114 += V_113 ) {
const T_1 V_115 = V_29 [ V_114 ] & V_27 -> V_77 . V_31 ;
const struct V_34 * V_77 =
F_31 ( V_16 -> V_40 ,
V_16 -> V_39 ,
V_76 ,
...
if ( ! V_77 ) {
F_2 ( L_16 ,
V_115 , * V_29 , V_16 -> V_32 ) ;
return false ;
}
if ( V_115 == F_8 ( V_116 ) ) {
if ( V_27 -> V_29 . V_30 == V_117 ) {
F_2 ( L_17 ) ;
return false ;
}
...
if ( V_27 -> V_29 . V_30 == F_49 ( 1 ) &&
( V_114 + 2 > V_74 ||
( V_29 [ V_114 + 1 ] & V_77 -> V_31 ) != V_77 -> V_30 ) ) {
F_2 ( L_21 ,
V_115 ) ;
return false ;
}
...
T_1 V_125 = V_29 [ V_114 ] &
V_27 -> V_122 [ V_20 ] . V_123 ;
if ( V_125 == 0 )
continue;
}
V_121 = V_29 [ V_27 -> V_122 [ V_20 ] . V_114 ] &
