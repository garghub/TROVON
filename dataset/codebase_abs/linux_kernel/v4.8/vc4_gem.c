...
struct V_39 * V_40 )
{
struct V_118 * args = V_40 -> args ;
T_2 * V_119 ;
int V_23 = 0 ;
int V_10 ;
V_40 -> V_12 = args -> V_120 ;
if ( ! V_40 -> V_12 ) {
F_60 ( L_2 ) ;
return - V_121 ;
}
...
V_119 = F_62 ( V_40 -> V_12 , sizeof( T_2 ) ) ;
if ( ! V_119 ) {
F_60 ( L_4 ) ;
goto V_123;
}
V_23 = F_63 ( V_119 ,
( void V_36 * ) ( V_37 ) args -> V_124 ,
...
F_64 ( & V_16 -> V_125 ) ;
for ( V_10 = 0 ; V_10 < V_40 -> V_12 ; V_10 ++ ) {
struct V_126 * V_13 = F_65 ( & V_16 -> V_127 ,
V_119 [ V_10 ] ) ;
if ( ! V_13 ) {
F_60 ( L_6 ,
V_10 , V_119 [ V_10 ] ) ;
...
F_20 ( V_13 ) ;
V_40 -> V_13 [ V_10 ] = (struct V_122 * ) V_13 ;
}
F_66 ( & V_16 -> V_125 ) ;
V_123:
F_67 ( V_119 ) ;
...
int V_23 = 0 ;
T_2 V_130 = 0 ;
T_2 V_131 = F_69 ( V_130 + args -> V_132 ,
16 ) ;
T_2 V_133 = V_131 + args -> V_134 ;
T_2 V_135 = V_133 + args -> V_136 ;
T_2 V_137 = V_135 + ( sizeof( struct V_138 ) *
args -> V_139 ) ;
struct V_30 * V_13 ;
if ( V_133 < V_131 ||
V_135 < V_133 ||
...
V_129 = V_128 + V_130 ;
V_40 -> V_141 = V_128 + V_131 ;
V_40 -> V_142 = V_128 + V_133 ;
V_40 -> V_143 = V_128 + V_135 ;
V_40 -> V_144 = args -> V_139 ;
if ( F_63 ( V_129 ,
( void V_36 * ) ( V_37 ) args -> V_145 ,
args -> V_132 ) ) {
V_23 = - V_38 ;
goto V_123;
}
if ( F_63 ( V_40 -> V_141 ,
( void V_36 * ) ( V_37 ) args -> V_146 ,
args -> V_134 ) ) {
V_23 = - V_38 ;
goto V_123;
}
if ( F_63 ( V_40 -> V_142 ,
( void V_36 * ) ( V_37 ) args -> V_147 ,
args -> V_136 ) ) {
V_23 = - V_38 ;
goto V_123;
}
V_13 = F_70 ( V_2 , V_135 , true ) ;
if ( F_71 ( V_13 ) ) {
F_60 ( L_10 ) ;
V_23 = F_72 ( V_13 ) ;
goto V_123;
}
V_40 -> V_148 = & V_13 -> V_34 ;
F_58 ( & F_13 ( & V_40 -> V_148 -> V_34 ) -> V_149 ,
& V_40 -> V_150 ) ;
V_40 -> V_46 = V_40 -> V_148 -> V_33 + V_130 ;
V_40 -> V_151 = V_129 ;
V_40 -> V_152 = V_40 -> V_148 -> V_153 + V_131 ;
V_40 -> V_154 = V_40 -> V_148 -> V_33 + V_131 ;
V_40 -> V_134 = args -> V_134 ;
V_40 -> V_155 = V_40 -> V_148 -> V_153 + V_133 ;
V_40 -> V_156 = V_40 -> V_148 -> V_33 + V_133 ;
V_40 -> V_136 = args -> V_136 ;
V_23 = F_73 ( V_2 ,
V_40 -> V_148 -> V_153 + V_130 ,
V_129 ,
V_40 ) ;
if ( V_23 )
goto V_123;
...
while ( ! F_54 ( & V_40 -> V_150 ) ) {
struct V_30 * V_13 = F_76 ( & V_40 -> V_150 ,
struct V_30 , V_149 ) ;
F_77 ( & V_13 -> V_149 ) ;
F_7 ( & V_13 -> V_34 . V_34 ) ;
}
...
if ( V_158 -> V_93 <= V_4 -> V_98 ) {
F_81 ( & V_158 -> V_84 . V_161 ) ;
F_35 ( & V_158 -> V_84 ) ;
}
}
F_11 ( & V_4 -> V_24 , V_22 ) ;
...
{
struct V_157 * V_158 = F_33 ( V_84 , struct V_157 , V_84 ) ;
V_158 -> V_162 ( V_158 ) ;
}
int F_83 ( struct V_1 * V_2 ,
struct V_157 * V_158 , T_3 V_93 ,
void (* V_162)( struct V_157 * V_158 ) )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_23 = 0 ;
unsigned long V_22 ;
V_158 -> V_162 = V_162 ;
F_84 ( & V_158 -> V_84 , F_82 ) ;
F_10 ( & V_4 -> V_24 , V_22 ) ;
if ( V_93 > V_4 -> V_98 ) {
V_158 -> V_93 = V_93 ;
F_58 ( & V_158 -> V_84 . V_161 , & V_4 -> V_163 ) ;
} else {
F_35 ( & V_158 -> V_84 ) ;
}
F_11 ( & V_4 -> V_24 , V_22 ) ;
...
if ( ( V_23 == - V_165 || V_23 == - V_104 ) && * V_94 != ~ 0ull ) {
T_3 V_166 = F_87 ( V_7 - V_91 ) ;
if ( * V_94 >= V_166 )
* V_94 -= V_166 ;
}
return V_23 ;
...
{
int V_23 ;
struct V_168 * args = V_14 ;
struct V_126 * V_169 ;
struct V_30 * V_13 ;
if ( args -> V_170 != 0 )
return - V_121 ;
V_169 = F_90 ( V_16 , args -> V_31 ) ;
if ( ! V_169 ) {
F_60 ( L_11 , args -> V_31 ) ;
return - V_121 ;
}
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_118 * args = V_14 ;
struct V_39 * V_40 ;
int V_23 = 0 ;
if ( ( args -> V_171 & ~ V_172 ) != 0 ) {
F_60 ( L_12 , args -> V_171 ) ;
return - V_121 ;
}
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_99 ( V_4 -> V_116 != V_4 -> V_98 ) ;
if ( V_4 -> V_173 ) {
F_7 ( & V_4 -> V_173 -> V_34 . V_34 ) ;
V_4 -> V_173 = NULL ;
}
if ( V_4 -> V_25 )
F_6 ( V_2 , V_4 -> V_25 ) ;
