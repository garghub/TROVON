...
static void F_85 ( struct V_131 * V_33 )
{
#ifdef F_86
...
static void F_96 ( struct V_144 * V_145 )
{
struct V_8 * V_10 ;
struct V_131 * V_33 , * V_71 ;
if ( ! V_145 )
...
static void F_98 ( struct V_153 * V_125 )
{
struct V_8 * V_10 ;
struct V_131 * V_33 ;
...
struct V_66 * F_100 ( struct V_23 * V_24 ,
struct V_155 * V_151 ,
struct V_144 * V_145 ,
void * V_156 )
{
...
goto V_159;
F_94 ( V_145 ) ;
F_102 ( & V_145 -> V_127 , & V_24 -> V_112 ) ;
V_75 = F_103 ( NULL , V_157 , V_151 -> V_161 ,
V_156 , & V_145 -> V_127 ) ;
if ( ! V_75 )
goto V_159;
F_104 ( V_75 ) ;
F_105 ( F_106 ( V_75 -> V_125 ) ,
F_98 , V_145 ) ;
if ( V_70 != V_162 )
F_107 ( V_163 , & V_75 -> V_36 , L_33 , V_70 ) ;
return V_75 ;
V_159:
F_96 ( V_145 ) ;
return NULL ;
