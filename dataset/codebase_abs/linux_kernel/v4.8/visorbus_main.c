...
struct V_47 * V_94 )
{
int V_44 = sizeof( struct V_90 ) + V_89 -> V_97 ;
if ( V_89 -> V_97 == 0 )
return - V_96 ;
if ( F_62 ( V_87 , V_44 , V_94 , sizeof( * V_94 ) ) < 0 )
return - V_96 ;
...
struct V_88 * V_89 ,
struct V_47 * V_94 , int V_98 )
{
int V_44 =
( sizeof( struct V_90 ) + V_89 -> V_99 ) +
( V_89 -> V_93 * V_98 ) ;
if ( V_89 -> V_99 == 0 )
return - V_96 ;
if ( F_62 ( V_87 , V_44 , V_94 , sizeof( * V_94 ) ) < 0 )
...
static void
F_54 ( struct V_10 * V_100 )
{
int V_21 ;
struct V_10 * V_101 ;
struct V_22 * V_102 ;
int V_103 = V_100 -> V_72 ;
int V_104 = V_100 -> V_49 ;
struct V_47 V_48 ;
const char * V_105 = NULL ;
struct V_88 * V_89 ;
if ( ! V_100 -> V_6 . V_34 )
return;
V_89 = (struct V_88 * ) V_100 -> V_106 ;
if ( ! V_89 )
return;
V_101 = F_86 ( V_103 , V_107 , NULL ) ;
if ( ! V_101 )
return;
V_102 = F_8 ( V_100 -> V_6 . V_34 ) ;
for ( V_21 = 0 ; V_102 -> V_26 [ V_21 ] . V_28 ; V_21 ++ ) {
if ( memcmp ( & V_102 -> V_26 [ V_21 ] . V_12 ,
& V_100 -> V_108 ,
sizeof( V_102 -> V_26 [ V_21 ] . V_12 ) ) == 0 ) {
V_105 = V_102 -> V_26 [ V_21 ] . V_28 ;
break;
}
}
F_87 ( & V_48 , V_105 ,
V_102 -> V_28 , V_102 -> V_53 ,
V_102 -> V_109 ) ;
F_85 ( V_101 -> V_13 , V_89 , & V_48 , V_104 ) ;
F_83 ( V_101 -> V_13 , V_89 , & V_110 ) ;
F_84 ( V_101 -> V_13 , V_89 ,
& V_111 ) ;
}
static int
...
struct V_88 * V_89 ;
F_89 ( V_113 , V_74 ) ;
V_89 = F_90 ( sizeof( * V_89 ) , V_114 ) ;
if ( ! V_89 )
return - V_17 ;
F_74 ( & V_7 -> V_6 , L_10 , V_112 ) ;
V_7 -> V_6 . V_2 = & V_65 ;
V_7 -> V_6 . V_75 = V_115 ;
V_7 -> V_6 . V_77 = F_10 ;
if ( F_91 ( & V_7 -> V_6 ) < 0 ) {
...
int V_63 ;
T_5 V_103 = V_7 -> V_72 ;
F_73 ( V_113 , V_103 , V_74 ) ;
V_63 = F_88 ( V_7 ) ;
F_73 ( V_122 , V_103 , V_74 ) ;
if ( V_63 < 0 )
F_73 ( V_123 , V_103 ,
V_116 ) ;
else
...
T_5 V_103 = V_48 -> V_72 ;
T_5 V_104 = V_48 -> V_49 ;
F_68 ( V_73 , V_104 , V_103 ,
V_74 ) ;
V_63 = F_67 ( V_48 ) ;
if ( V_125 . V_128 )
V_125 . V_128 ( V_48 , V_63 ) ;
if ( V_63 < 0 )
F_68 ( V_80 , V_104 , V_103 ,
V_116 ) ;
else
F_68 ( V_129 , V_104 , V_103 ,
V_74 ) ;
}
static void
...
static void
F_105 ( struct V_10 * V_7 , int V_131 )
{
if ( ! V_7 -> V_132 )
return;
V_7 -> V_132 = false ;
if ( ! V_125 . V_133 )
return;
(* V_125 . V_133 ) ( V_7 , V_131 ) ;
}
static void
F_106 ( struct V_10 * V_7 , int V_131 )
{
if ( ! V_7 -> V_134 )
return;
V_7 -> V_134 = false ;
if ( ! V_125 . V_135 )
return;
(* V_125 . V_135 ) ( V_7 , V_131 ) ;
}
static void
F_107 ( struct V_10 * V_7 , bool V_136 )
{
int V_63 ;
struct V_22 * V_23 = NULL ;
void (* F_108)( struct V_10 * V_7 , int V_137 ) = NULL ;
if ( V_136 )
F_108 = V_125 . V_133 ;
else
F_108 = V_125 . V_135 ;
