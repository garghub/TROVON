...
static int F_167 ( struct V_176 * V_170 , const char * V_210 ,
struct V_201 * V_202 ,
int V_48 )
{
unsigned int V_131 ;
...
static bool F_178 ( struct V_262 * V_170 , const char * V_263 , T_6 * V_264 )
{
...
static bool F_181 ( int V_261 , T_6 * V_266 )
{
switch ( V_261 ) {
case V_267 :
...
static int F_183 ( struct V_176 * V_170 , char * V_210 )
{
unsigned int V_131 ;
for ( V_131 = 0 ; V_131 < F_168 ( V_218 ) ; V_131 ++ ) {
struct V_161 * V_162 = & V_218 [ V_131 ] ;
