...
F_148 ( & V_175 , & V_38 , & V_172 ) ;
error = F_149 ( V_15 , & V_175 , V_114 [ V_178 ] ,
V_114 [ V_179 ] , log ) ;
if ( error )
goto V_180;
F_150 ( & V_170 -> V_38 , & V_38 , true , & V_172 ) ;
error = F_151 ( & V_170 -> V_165 , V_114 [ V_181 ] ,
& V_38 , log ) ;
if ( error )
goto V_180;
...
V_41 = F_152 ( & V_20 -> V_26 , & V_170 -> V_165 ) ;
if ( ! V_41 )
V_41 = F_153 ( & V_20 -> V_26 , & V_38 ) ;
if ( F_154 ( ! V_41 ) ) {
F_108 ( V_170 -> V_43 , V_116 ) ;
error = F_155 ( & V_20 -> V_26 , V_170 , & V_172 ) ;
if ( F_45 ( error ) ) {
V_116 = NULL ;
goto V_183;
}
...
struct V_37 V_190 ;
int error ;
F_150 ( & V_190 , V_38 , true , V_172 ) ;
error = F_107 ( V_15 , V_114 , & V_190 , & V_116 , log ) ;
if ( error ) {
F_147 ( log ,
L_4 ) ;
return F_141 ( error ) ;
...
struct V_14 * V_20 ;
struct V_42 * V_185 = NULL , * V_116 = NULL ;
struct V_174 V_175 ;
struct V_143 V_144 ;
T_3 V_145 = F_146 ( V_114 [ V_176 ] ) ;
int error = 0 ;
bool log = ! V_114 [ V_177 ] ;
bool V_191 ;
V_191 = F_163 ( & V_144 , V_114 [ V_181 ] , log ) ;
if ( V_114 [ V_178 ] ) {
F_148 ( & V_175 , & V_38 , & V_172 ) ;
error = F_149 ( V_15 , & V_175 , V_114 [ V_178 ] ,
V_114 [ V_179 ] , log ) ;
...
bool log = ! V_114 [ V_177 ] ;
bool V_191 ;
V_191 = F_163 ( & V_193 , V_114 [ V_181 ] , log ) ;
if ( V_114 [ V_178 ] ) {
F_148 ( & V_175 , & V_38 , NULL ) ;
...
F_8 () ;
V_173 = F_140 ( ( const struct V_42 V_195 * ) V_41 -> V_43 ,
...
F_170 ( F_95 ( V_10 -> V_113 ) -> V_197 , 0 , 0 , F_61 ( V_173 ) ) ;
}
}
F_111 ( V_41 , true ) ;
return 0 ;
...
static int F_171 ( struct V_9 * V_10 , struct V_198 * V_199 )
{
struct V_89 * V_114 [ V_200 ] ;
struct V_79 * V_79 = F_172 ( F_173 ( V_199 -> V_201 ) ) ;
struct V_202 * V_203 ;
struct V_14 * V_20 ;
T_3 V_145 ;
int V_62 ;
V_62 = F_174 ( V_199 -> V_201 , & V_164 , V_114 ,
V_204 , V_205 ) ;
if ( V_62 )
return V_62 ;
...
V_203 = F_51 ( V_20 -> V_26 . V_203 ) ;
for (; ; ) {
struct V_40 * V_41 ;
T_3 V_206 , V_207 ;
V_206 = V_199 -> args [ 0 ] ;
V_207 = V_199 -> args [ 1 ] ;
V_41 = F_175 ( V_203 , & V_206 , & V_207 ) ;
if ( ! V_41 )
break;
if ( F_134 ( V_41 , V_79 -> V_16 , V_10 ,
F_176 ( V_199 -> V_10 ) . V_52 ,
V_199 -> V_201 -> V_208 , V_209 ,
V_184 , V_145 ) < 0 )
break;
V_199 -> args [ 0 ] = V_206 ;
V_199 -> args [ 1 ] = V_207 ;
...
{
T_5 V_210 = F_63 ( sizeof( struct V_79 ) ) ;
V_210 += F_64 ( V_211 ) ;
V_210 += F_124 ( sizeof( struct V_134 ) ) ;
V_210 += F_124 ( sizeof( struct V_135 ) ) ;
V_210 += F_64 ( sizeof( T_3 ) ) ;
return V_210 ;
}
...
struct V_135 V_213 ;
int V_62 ;
V_79 = F_77 ( V_10 , V_52 , V_163 , & V_214 ,
V_57 , V_50 ) ;
if ( ! V_79 )
goto error;
V_79 -> V_16 = F_23 ( V_20 ) ;
V_62 = F_179 ( V_10 , V_215 , F_20 ( V_20 ) ) ;
if ( V_62 )
goto V_216;
F_112 ( V_20 , & V_212 , & V_213 ) ;
if ( F_129 ( V_10 , V_217 , sizeof( struct V_134 ) ,
& V_212 , V_218 ) )
goto V_216;
if ( F_129 ( V_10 , V_219 ,
sizeof( struct V_135 ) ,
...
struct V_19 * V_19 ;
V_19 = F_182 ( V_15 , F_81 ( V_114 [ V_215 ] ) ) ;
...
V_34 . V_228 = F_81 ( V_114 [ V_215 ] ) ;
V_34 . type = V_229 ;
V_34 . V_230 = NULL ;
V_34 . V_20 = V_20 ;
V_34 . V_30 = V_21 ;
V_34 . V_231 = V_114 [ V_223 ] ;
F_185 ( V_20 , V_114 ) ;
F_6 () ;
V_19 = F_33 ( & V_34 ) ;
if ( F_35 ( V_19 ) ) {
...
V_4 -> V_169 , 0 , V_237 ) ;
F_79 ( V_62 < 0 ) ;
V_222 = F_194 ( F_92 ( V_20 ) , V_238 ) ;
F_195 ( & V_20 -> V_239 , & V_222 -> V_240 ) ;
F_8 () ;
F_4 ( & V_214 , V_173 , V_4 ) ;
return 0 ;
V_236:
...
static int F_204 ( struct V_9 * V_10 , struct V_198 * V_199 )
{
struct V_222 * V_222 = F_194 ( F_95 ( V_10 -> V_113 ) , V_238 ) ;
struct V_14 * V_20 ;
int V_245 = V_199 -> args [ 0 ] ;
int V_137 = 0 ;
F_6 () ;
F_205 (dp, &ovs_net->dps, list_node) {
if ( V_137 >= V_245 &&
F_178 ( V_20 , V_10 , F_176 ( V_199 -> V_10 ) . V_52 ,
V_199 -> V_201 -> V_208 , V_209 ,
V_237 ) < 0 )
break;
V_137 ++ ;
...
struct V_246 V_247 ;
int V_62 ;
V_79 = F_77 ( V_10 , V_52 , V_163 , & V_248 ,
V_57 , V_50 ) ;
if ( ! V_79 )
return - V_156 ;
V_79 -> V_16 = F_23 ( V_19 -> V_20 ) ;
if ( F_88 ( V_10 , V_249 , V_19 -> V_30 ) ||
F_88 ( V_10 , V_250 , V_19 -> V_251 -> type ) ||
F_179 ( V_10 , V_252 ,
F_22 ( V_19 ) ) )
goto V_216;
F_207 ( V_19 , & V_247 ) ;
...
const struct V_79 * V_79 ,
struct V_89 * V_114 [ V_256 + 1 ] )
{
struct V_14 * V_20 ;
struct V_19 * V_19 ;
if ( V_114 [ V_252 ] ) {
V_19 = F_182 ( V_15 , F_81 ( V_114 [ V_252 ] ) ) ;
if ( ! V_19 )
return F_141 ( - V_92 ) ;
if ( V_79 -> V_16 &&
V_79 -> V_16 != F_23 ( V_19 -> V_20 ) )
...
V_34 . V_228 = F_81 ( V_114 [ V_252 ] ) ;
V_34 . type = F_186 ( V_114 [ V_250 ] ) ;
V_34 . V_230 = V_114 [ V_263 ] ;
V_34 . V_20 = V_20 ;
V_34 . V_30 = V_30 ;
V_34 . V_231 = V_114 [ V_260 ] ;
V_19 = F_33 ( & V_34 ) ;
V_62 = F_61 ( V_19 ) ;
if ( F_35 ( V_19 ) ) {
if ( V_62 == - V_264 )
...
V_4 -> V_169 , 0 , V_265 ) ;
if ( F_215 ( V_19 -> V_18 ) > V_20 -> V_259 )
F_214 ( V_20 ) ;
else
F_216 ( V_19 -> V_18 , V_20 -> V_259 ) ;
F_79 ( V_62 < 0 ) ;
F_8 () ;
F_4 ( & V_248 , V_173 , V_4 ) ;
return 0 ;
...
goto V_262;
if ( V_114 [ V_250 ] &&
F_186 ( V_114 [ V_250 ] ) != V_19 -> V_251 -> type ) {
V_62 = - V_71 ;
goto V_262;
}
if ( V_114 [ V_263 ] ) {
V_62 = F_219 ( V_19 , V_114 [ V_263 ] ) ;
if ( V_62 )
goto V_262;
}
if ( V_114 [ V_260 ] ) {
struct V_89 * V_266 = V_114 [ V_260 ] ;
V_62 = F_220 ( V_19 , V_266 ) ;
if ( V_62 )
goto V_262;
}
V_62 = F_206 ( V_19 , V_173 , V_4 -> V_168 ,
...
static int F_224 ( struct V_9 * V_10 , struct V_198 * V_199 )
{
struct V_79 * V_79 = F_172 ( F_173 ( V_199 -> V_201 ) ) ;
struct V_14 * V_20 ;
int V_206 = V_199 -> args [ 0 ] , V_245 = V_199 -> args [ 1 ] ;
int V_137 , V_269 = 0 ;
F_18 () ;
V_20 = F_12 ( F_95 ( V_10 -> V_113 ) , V_79 -> V_16 ) ;
if ( ! V_20 ) {
...
for ( V_137 = V_206 ; V_137 < V_31 ; V_137 ++ ) {
struct V_19 * V_19 ;
V_269 = 0 ;
F_32 (vport, &dp->ports[i], dp_hash_node) {
if ( V_269 >= V_245 &&
...
int V_62 ;
int V_137 ;
for ( V_137 = 0 ; V_137 < F_228 ( V_271 ) ; V_137 ++ ) {
V_62 = F_229 ( V_271 [ V_137 ] ) ;
if ( V_62 )
goto error;
}
return 0 ;
...
{
struct V_222 * V_222 = F_194 ( V_15 , V_238 ) ;
F_231 ( & V_222 -> V_240 ) ;
F_232 ( & V_222 -> V_272 , V_273 ) ;
F_233 ( V_15 ) ;
return 0 ;
}
static void T_8 F_234 ( struct V_15 * V_15 , struct V_15 * V_274 ,
struct V_275 * V_32 )
{
struct V_222 * V_222 = F_194 ( V_15 , V_238 ) ;
struct V_14 * V_20 ;
...
if ( V_19 -> V_251 -> type != V_229 )
continue;
if ( F_236 ( V_19 -> V_18 ) == V_274 )
F_237 ( & V_19 -> V_276 , V_32 ) ;
}
}
}
}
static void T_8 F_238 ( struct V_15 * V_274 )
{
struct V_14 * V_20 , * V_277 ;
struct V_222 * V_222 = F_194 ( V_274 , V_238 ) ;
struct V_19 * V_19 , * V_278 ;
struct V_15 * V_15 ;
F_239 ( V_32 ) ;
F_240 ( V_274 ) ;
F_6 () ;
...
{
int V_62 ;
F_59 ( sizeof( struct V_279 ) > F_248 ( struct V_9 , V_199 ) ) ;
F_249 ( L_9 ) ;
V_62 = F_250 () ;
if ( V_62 )
goto error;
