...
enum V_154 V_155 , unsigned int V_63 )
{
switch ( V_155 ) {
case V_156 :
case V_120 :
...
static void F_36 ( struct V_158 * V_159 )
{
struct V_3 * V_13 = F_2 ( V_159 , struct V_3 ,
V_160 ) ;
struct V_5 * V_6 = & V_13 -> V_6 ;
T_3 V_161 ;
if ( ! V_13 -> V_162 )
...
F_38 ( V_13 -> V_162 ) ;
V_13 -> V_162 = NULL ;
F_39 ( V_165 , & V_13 -> V_166 ) ;
V_13 -> V_167 ++ ;
F_40 ( & V_13 -> V_168 -> V_169 , L_1 ) ;
return;
}
V_161 = F_3 ( V_170 ) ;
if ( V_161 & V_171 )
...
static void F_43 ( struct V_158 * V_159 )
{
struct V_3 * V_4 =
F_2 ( V_159 , struct V_3 , V_172 . V_159 ) ;
struct V_14 V_15 ;
V_4 -> V_38 . V_173 ( & V_4 -> V_38 , & V_15 ) ;
F_44 ( L_2 ,
...
V_177 = V_13 -> V_179 ;
if ( F_47 ( V_13 -> V_181 , V_177 ) )
V_177 = V_13 -> V_181 ;
if ( F_37 ( V_177 + 5 * V_182 ) ) {
F_3 ( V_183 ) ;
V_13 -> V_179 = V_180 ;
V_13 -> V_184 ++ ;
F_40 ( & V_13 -> V_168 -> V_169 , L_3 ) ;
}
}
...
int V_187 = 0 ;
V_186 = F_3 ( V_188 ) ;
V_186 |= ( T_2 ) F_3 ( V_189 ) << 32 ;
F_8 ( V_13 , & V_185 , V_186 ) ;
...
V_185 . V_32 =
F_48 ( V_185 . V_32 , V_187 ) ;
F_49 ( V_13 -> V_162 , & V_185 ) ;
F_38 ( V_13 -> V_162 ) ;
V_13 -> V_162 = NULL ;
F_39 ( V_165 , & V_13 -> V_166 ) ;
}
void F_50 ( struct V_197 * V_198 ,
unsigned char * V_199 ,
struct V_200 * V_201 )
{
T_6 * V_186 = ( T_6 * ) V_199 ;
struct V_3 * V_13 = V_198 -> V_13 ;
int V_187 = 0 ;
F_8 ( V_13 , F_51 ( V_201 ) ,
F_52 ( V_186 [ 1 ] ) ) ;
if ( V_13 -> V_6 . V_25 . type == V_33 ) {
...
F_51 ( V_201 ) -> V_32 =
F_53 ( F_51 ( V_201 ) -> V_32 , V_187 ) ;
}
void F_54 ( struct V_197 * V_198 ,
struct V_200 * V_201 )
{
struct V_3 * V_13 = V_198 -> V_13 ;
struct V_5 * V_6 = & V_13 -> V_6 ;
...
return;
V_186 = F_3 ( V_205 ) ;
V_186 |= ( T_2 ) F_3 ( V_183 ) << 32 ;
F_8 ( V_13 , F_51 ( V_201 ) , V_186 ) ;
if ( V_13 -> V_6 . V_25 . type == V_33 ) {
switch ( V_13 -> V_190 ) {
case V_191 :
V_187 = V_202 ;
...
int F_55 ( struct V_206 * V_207 , struct V_208 * V_209 )
{
struct V_3 * V_13 = F_56 ( V_207 ) ;
struct V_210 * V_211 = & V_13 -> V_212 ;
return F_57 ( V_209 -> V_213 , V_211 , sizeof( * V_211 ) ) ?
- V_214 : 0 ;
}
...
if ( V_6 -> V_25 . type == V_246 ) {
if ( V_217 | V_215 )
return - V_134 ;
return 0 ;
}
if ( ( V_6 -> V_25 . type >= V_27 ) && V_217 ) {
V_217 = V_218 ;
V_217 |= V_245 ;
V_211 -> V_226 = V_244 ;
V_221 = true ;
...
| V_258 ) ;
V_254 &= ~ V_259 ;
F_7 ( F_60 ( 3 ) , F_61 ( V_260 ) ) ;
F_7 ( F_62 ( 3 ) ,
( V_261 | V_262 ) ) ;
if ( V_6 -> V_25 . type == V_26 ) {
F_7 ( F_63 ( 3 ) , F_61 ( V_260 ) ) ;
V_254 &= ~ V_263 ;
}
F_7 ( F_64 ( 3 ) , V_254 ) ;
} else {
...
int F_66 ( struct V_206 * V_207 , struct V_208 * V_209 )
{
struct V_3 * V_13 = F_56 ( V_207 ) ;
struct V_210 V_211 ;
int V_264 ;
if ( F_67 ( & V_211 , V_209 -> V_213 , sizeof( V_211 ) ) )
return - V_214 ;
V_264 = F_58 ( V_13 , & V_211 ) ;
if ( V_264 )
return V_264 ;
memcpy ( & V_13 -> V_212 , & V_211 ,
sizeof( V_13 -> V_212 ) ) ;
return F_57 ( V_209 -> V_213 , & V_211 , sizeof( V_211 ) ) ?
- V_214 : 0 ;
}
...
{
struct V_5 * V_6 = & V_13 -> V_6 ;
struct V_206 * V_207 = V_13 -> V_207 ;
int V_149 ;
switch ( V_6 -> V_25 . type ) {
case V_26 :
snprintf ( V_13 -> V_38 . V_265 , 16 , L_4 , V_207 -> V_266 ) ;
V_13 -> V_38 . V_267 = V_268 ;
V_13 -> V_38 . V_269 = 999999881 ;
V_13 -> V_38 . V_270 = 0 ;
V_13 -> V_38 . V_271 = 0 ;
V_13 -> V_38 . V_272 = F_14 ;
V_13 -> V_38 . V_273 = F_17 ;
V_13 -> V_38 . V_173 = F_22 ;
V_13 -> V_38 . V_274 = F_25 ;
V_13 -> V_38 . V_275 = F_34 ;
V_13 -> V_2 . V_276 = F_1 ;
...
snprintf ( V_13 -> V_38 . V_265 , 16 , L_4 , V_207 -> V_266 ) ;
V_13 -> V_38 . V_267 = V_268 ;
V_13 -> V_38 . V_269 = 62499999 ;
V_13 -> V_38 . V_270 = 0 ;
V_13 -> V_38 . V_271 = 0 ;
V_13 -> V_38 . V_272 = F_16 ;
V_13 -> V_38 . V_273 = F_17 ;
V_13 -> V_38 . V_173 = F_22 ;
V_13 -> V_38 . V_274 = F_25 ;
V_13 -> V_38 . V_275 = F_34 ;
V_13 -> V_2 . V_276 = F_4 ;
V_13 -> V_2 . V_57 = F_69 ( V_281 ) ;
V_13 -> V_2 . V_277 = 1 ;
V_13 -> V_2 . V_278 = 0 ;
V_13 -> V_279 |= V_280 ;
break;
...
struct V_282 * V_283 = & V_13 -> V_284 [ V_149 ] ;
snprintf ( V_283 -> V_265 , sizeof( V_283 -> V_265 ) , L_5 , V_149 ) ;
V_283 -> V_122 = V_149 ;
V_283 -> V_155 = V_156 ;
}
snprintf ( V_13 -> V_38 . V_265 , 16 , L_4 , V_207 -> V_266 ) ;
V_13 -> V_38 . V_267 = V_268 ;
V_13 -> V_38 . V_269 = 62499999 ;
V_13 -> V_38 . V_270 = V_285 ;
V_13 -> V_38 . V_286 = V_287 ;
V_13 -> V_38 . V_288 = V_58 ;
V_13 -> V_38 . V_271 = 1 ;
V_13 -> V_38 . V_289 = V_13 -> V_284 ;
V_13 -> V_38 . V_272 = F_16 ;
V_13 -> V_38 . V_273 = F_19 ;
V_13 -> V_38 . V_173 = F_24 ;
V_13 -> V_38 . V_274 = F_28 ;
V_13 -> V_38 . V_275 = F_32 ;
V_13 -> V_38 . V_290 = F_35 ;
break;
default:
V_13 -> V_119 = NULL ;
return;
...
F_70 ( & V_13 -> V_30 ) ;
F_71 ( & V_13 -> V_160 , F_36 ) ;
if ( V_13 -> V_279 & V_280 )
F_72 ( & V_13 -> V_172 ,
F_43 ) ;
V_13 -> V_212 . V_226 = V_227 ;
V_13 -> V_212 . V_222 = V_223 ;
F_73 ( V_13 ) ;
V_13 -> V_119 = F_74 ( & V_13 -> V_38 ,
& V_13 -> V_168 -> V_169 ) ;
if ( F_75 ( V_13 -> V_119 ) ) {
V_13 -> V_119 = NULL ;
F_76 ( & V_13 -> V_168 -> V_169 , L_6 ) ;
} else {
F_77 ( & V_13 -> V_168 -> V_169 , L_7 ,
V_13 -> V_207 -> V_265 ) ;
V_13 -> V_279 |= V_291 ;
}
}
