...
return;
V_38 = F_55 ( V_2 -> V_4 ) ;
V_10 = F_194 ( V_38 , & V_323 ) ;
if ( V_10 == - 1 )
return;
fprintf ( V_312 , L_95 ) ;
fprintf ( V_312 , L_96 , ctime ( & V_323 . V_324 ) ) ;
F_195 ( V_2 , V_312 , V_322 ) ;
fprintf ( V_312 , L_97 ) ;
}
...
T_10 V_102 ;
int V_230 ;
for ( V_102 = 0 ; V_102 < V_327 ; V_102 ++ ) {
V_13 = F_197 ( V_2 -> V_7 , V_326 [ V_102 ] . V_309 ) ;
if ( V_13 == NULL )
continue;
V_230 = - V_328 ;
if ( V_13 -> V_329 != NULL )
goto V_26;
V_13 -> V_329 = V_326 [ V_102 ] . V_329 ;
}
V_230 = 0 ;
V_26:
return V_230 ;
}
int F_198 ( struct V_25 * V_22 V_33 ,
union V_34 * V_19 ,
struct V_1 * V_2 )
{
struct V_35 * V_7 = V_2 -> V_7 ;
struct V_330 * V_331 = & V_19 -> V_64 ;
T_10 V_102 , V_126 , V_332 ;
V_332 = ( V_331 -> V_5 . V_42 - sizeof( struct V_330 ) ) /
sizeof( struct V_333 ) ;
V_126 = V_331 -> V_126 ;
if ( V_126 > V_332 )
return - V_210 ;
if ( V_36 )
fprintf ( stdout , L_98 , V_126 ) ;
for ( V_102 = 0 ; V_102 < V_126 ; V_102 ++ ) {
struct V_333 * V_155 = & V_331 -> V_127 [ V_102 ] ;
struct V_206 * V_207 ;
if ( V_36 ) {
fprintf ( stdout , L_99 V_150 , V_155 -> V_91 ) ;
fprintf ( stdout , L_100 V_150 , V_155 -> V_122 ) ;
fprintf ( stdout , L_101 V_334 , V_155 -> V_123 ) ;
fprintf ( stdout , L_102 V_334 L_10 , V_155 -> V_79 ) ;
}
...
union V_34 * V_337 ;
struct V_12 * V_13 ;
T_10 V_126 = 0 , V_102 = 0 , T_9 , V_332 , V_39 ;
int V_230 ;
F_200 ( L_103 ) ;
V_332 = ( V_338 - sizeof( struct V_330 ) ) /
sizeof( struct V_333 ) ;
F_18 (evlist, evsel)
V_126 += V_13 -> V_339 ;
V_39 = V_126 > V_332 ? V_332 : V_126 ;
T_9 = sizeof( struct V_330 ) + V_39 * sizeof( struct V_333 ) ;
V_337 = F_26 ( T_9 ) ;
if ( ! V_337 )
return - V_299 ;
V_337 -> V_64 . V_5 . type = V_238 ;
V_337 -> V_64 . V_5 . V_42 = T_9 ;
V_337 -> V_64 . V_126 = V_39 ;
F_18 (evlist, evsel) {
T_12 V_340 ;
for ( V_340 = 0 ; V_340 < V_13 -> V_339 ; V_340 ++ ) {
struct V_333 * V_155 ;
struct V_206 * V_207 ;
if ( V_102 >= V_39 ) {
V_230 = V_336 ( V_22 , V_337 , NULL , V_37 ) ;
if ( V_230 )
goto V_275;
V_126 -= V_39 ;
V_102 = 0 ;
}
V_155 = & V_337 -> V_64 . V_127 [ V_102 ++ ] ;
V_155 -> V_91 = V_13 -> V_91 [ V_340 ] ;
V_207 = F_132 ( V_7 , V_155 -> V_91 ) ;
if ( ! V_207 ) {
free ( V_337 ) ;
return - V_335 ;
...
T_9 = sizeof( struct V_330 ) + V_126 * sizeof( struct V_333 ) ;
V_337 -> V_64 . V_5 . V_42 = T_9 ;
V_337 -> V_64 . V_126 = V_126 ;
V_230 = V_336 ( V_22 , V_337 , NULL , V_37 ) ;
V_275:
free ( V_337 ) ;
return V_230 ;
