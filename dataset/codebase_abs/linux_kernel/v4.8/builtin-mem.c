...
if ( V_53 . V_54 ) {
V_44 = L_24 V_55 L_25 V_55 L_26 V_56
L_25 V_55 L_27 ;
} else {
V_44 = L_28 V_55 L_29 V_55
L_30 V_56 L_31 V_55 L_27 ;
V_53 . V_54 = L_32 ;
}
printf ( V_44 ,
V_40 -> V_57 ,
...
V_40 -> V_62 ,
V_53 . V_54 ,
V_43 . V_50 ? ( V_43 . V_50 -> V_51 ? V_43 . V_50 -> V_51 -> V_63 : L_33 ) : L_33 ,
V_43 . V_48 ? V_43 . V_48 -> V_64 : L_33 ) ;
V_49:
F_17 ( & V_43 ) ;
return 0 ;
}
...
F_8 ( 'U' , L_47 , & V_6 . V_47 ,
L_48 ) ,
F_30 ( 'i' , L_49 , & V_69 , L_50 ,
L_51 ) ,
F_30 ( 'C' , L_52 , & V_6 . V_75 , L_52 ,
L_53 ) ,
F_31 ( 'x' , L_54 , & V_53 . V_54 ,
L_55 ,
L_56
L_57 ) ,
F_8 ( 'f' , L_58 , & V_6 . V_72 , L_59 ) ,
F_9 ()
} ;
const char * const V_104 [] = { L_15 , L_35 , NULL } ;
const char * V_105 [] = {
NULL ,
NULL
} ;
...
V_105 , V_29 ) ;
if ( ! V_18 || ! ( strncmp ( V_19 [ 0 ] , L_61 , 3 ) || V_6 . V_9 ) )
F_34 ( V_105 , V_103 ) ;
...
if ( ! strncmp ( V_19 [ 0 ] , L_61 , 3 ) )
return F_4 ( V_18 , V_19 , & V_6 ) ;
else if ( ! strncmp ( V_19 [ 0 ] , L_63 , 3 ) )
