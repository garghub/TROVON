...
case V_250 :
{
int V_248 = F_153 ( int , 0 , F_138 ( V_7 ) ) ;
return F_152 ( V_248 , ( int V_249 * ) V_246 ) ;
}
default:
return - V_251 ;
...
int F_154 ( struct V_6 * V_7 , struct V_160 * V_161 , T_8 V_129 , int V_252 ,
int V_231 , int * V_253 )
{
struct V_48 * V_62 = F_32 ( V_7 ) ;
...
bool V_244 ;
if ( V_231 & V_259 )
return F_155 ( V_7 , V_161 , V_129 , V_253 ) ;
V_260:
V_256 = V_257 = F_156 ( V_7 , V_231 ) ;
V_73 = F_157 ( V_7 , V_231 | ( V_252 ? V_261 : 0 ) ,
& V_255 , & V_257 , & V_99 ) ;
if ( ! V_73 )
return V_99 ;
V_163 = V_73 -> V_129 ;
...
V_161 -> V_172 |= V_262 ;
if ( V_254 < V_163 || F_158 ( V_73 ) -> V_263 || V_256 ) {
V_258 = ! F_141 ( V_73 ) ;
if ( ! V_258 )
goto V_264;
}
if ( V_258 || F_159 ( V_73 ) )
V_99 = F_160 ( V_73 , V_257 , V_161 , V_254 ) ;
else {
V_99 = F_161 ( V_73 , V_257 , V_161 ) ;
if ( V_99 == - V_184 )
goto V_264;
}
if ( F_58 ( V_99 ) ) {
...
if ( V_62 -> V_267 )
F_165 ( V_161 , V_73 , sizeof( struct V_79 ) + V_257 ) ;
V_99 = V_254 ;
if ( V_231 & V_262 )
V_99 = V_163 ;
F_166 ( V_7 , V_73 , V_256 ? - V_99 : V_99 ) ;
return V_99 ;
V_264:
V_244 = F_146 ( V_7 ) ;
if ( ! F_167 ( V_7 , V_73 , V_231 ) ) {
...
int F_169 ( struct V_6 * V_7 , int V_231 )
{
struct V_48 * V_62 = F_32 ( V_7 ) ;
V_7 -> V_121 = V_268 ;
V_62 -> V_64 = 0 ;
...
static int F_180 ( struct V_6 * V_7 , struct V_72 * V_73 )
{
int V_276 ;
if ( F_32 ( V_7 ) -> V_64 ) {
F_181 ( V_7 , V_73 ) ;
...
if ( ( V_147 & V_284 ) && F_158 ( V_73 ) -> V_263 ) {
if ( V_127 -> V_285 == 0 ) {
F_130 ( L_3 ,
F_158 ( V_73 ) -> V_286 , V_73 -> V_129 ) ;
goto V_281;
}
if ( F_158 ( V_73 ) -> V_286 < V_127 -> V_285 ) {
F_130 ( L_4 ,
F_158 ( V_73 ) -> V_286 , V_127 -> V_285 ) ;
goto V_281;
}
}
if ( F_8 ( V_7 -> V_287 ) &&
...
! ( V_7 -> V_355 & V_356 ) && F_138 ( V_7 ) == - 1 )
V_33 &= ~ ( V_357 | V_352 ) ;
return V_33 ;
}
static struct V_6 * F_259 ( struct V_358 * V_359 , int V_360 )
{
struct V_6 * V_7 ;
struct V_361 * V_362 = V_359 -> V_363 ;
struct V_1 * V_1 = F_260 ( V_359 ) ;
...
static struct V_6 * F_262 ( struct V_358 * V_359 , struct V_6 * V_7 )
{
struct V_361 * V_362 = V_359 -> V_363 ;
struct V_1 * V_1 = F_260 ( V_359 ) ;
do {
...
return F_259 ( V_359 , V_362 -> V_364 + 1 ) ;
}
return V_7 ;
}
static struct V_6 * F_264 ( struct V_358 * V_359 , T_13 V_366 )
{
struct V_6 * V_7 = F_259 ( V_359 , 0 ) ;
if ( V_7 )
while ( V_366 && ( V_7 = F_262 ( V_359 , V_7 ) ) != NULL )
-- V_366 ;
return V_366 ? NULL : V_7 ;
}
static void * F_265 ( struct V_358 * V_359 , T_13 * V_366 )
{
struct V_361 * V_362 = V_359 -> V_363 ;
V_362 -> V_364 = V_367 ;
return * V_366 ? F_264 ( V_359 , * V_366 - 1 ) : V_368 ;
}
static void * F_266 ( struct V_358 * V_359 , void * V_369 , T_13 * V_366 )
{
struct V_6 * V_7 ;
if ( V_369 == V_368 )
V_7 = F_264 ( V_359 , 0 ) ;
else
V_7 = F_262 ( V_359 , V_369 ) ;
++ * V_366 ;
return V_7 ;
}
static void F_267 ( struct V_358 * V_359 , void * V_369 )
{
struct V_361 * V_362 = V_359 -> V_363 ;
if ( V_362 -> V_364 <= V_362 -> V_23 -> V_33 )
F_30 ( & V_362 -> V_23 -> V_78 [ V_362 -> V_364 ] . V_19 ) ;
}
int F_268 ( struct V_370 * V_370 , struct V_349 * V_349 )
{
struct V_371 * V_372 = F_269 ( V_370 ) ;
struct V_361 * V_373 ;
int V_99 ;
V_99 = F_270 ( V_370 , V_349 , & V_372 -> V_374 ,
sizeof( struct V_361 ) ) ;
if ( V_99 < 0 )
return V_99 ;
...
int F_271 ( struct V_1 * V_1 , struct V_371 * V_372 )
{
struct V_376 * V_377 ;
int V_276 = 0 ;
V_372 -> V_374 . V_360 = F_265 ;
V_372 -> V_374 . V_378 = F_266 ;
V_372 -> V_374 . V_379 = F_267 ;
V_377 = F_272 ( V_372 -> V_380 , V_381 , V_1 -> V_382 ,
V_372 -> V_383 , V_372 ) ;
if ( ! V_377 )
V_276 = - V_277 ;
return V_276 ;
}
void F_273 ( struct V_1 * V_1 , struct V_371 * V_372 )
{
F_274 ( V_372 -> V_380 , V_1 -> V_382 ) ;
}
static void F_275 ( struct V_6 * V_384 , struct V_358 * V_385 ,
int V_364 )
{
...
F_277 ( V_384 ) ,
0 , 0L , 0 ,
F_278 ( F_279 ( V_385 ) , F_3 ( V_384 ) ) ,
0 , F_280 ( V_384 ) ,
F_281 ( & V_384 -> V_88 ) , V_384 ,
F_281 ( & V_384 -> V_243 ) ) ;
}
int F_282 ( struct V_358 * V_359 , void * V_369 )
{
F_283 ( V_359 , 127 ) ;
if ( V_369 == V_368 )
F_284 ( V_359 , L_11
...
struct V_361 * V_362 = V_359 -> V_363 ;
F_275 ( V_369 , V_359 , V_362 -> V_364 ) ;
}
F_285 ( V_359 , '\n' ) ;
return 0 ;
}
static int T_14 F_286 ( struct V_1 * V_1 )
{
return F_271 ( V_1 , & V_388 ) ;
}
static void T_15 F_287 ( struct V_1 * V_1 )
{
F_273 ( V_1 , & V_388 ) ;
}
int T_16 F_288 ( void )
...
static int T_16 F_292 ( char * V_390 )
{
T_17 V_235 ;
if ( ! V_390 )
return 0 ;
V_235 = F_293 ( V_390 , 0 , & V_391 ) ;
if ( V_235 )
return 0 ;
...
void T_16 F_294 ( struct V_23 * V_393 , const char * V_380 )
{
unsigned int V_394 ;
V_393 -> V_78 = F_295 ( V_380 ,
2 * sizeof( struct V_3 ) ,
V_391 ,
21 ,
0 ,
...
F_296 ( & V_393 -> V_78 [ V_394 ] . V_43 ) ;
V_393 -> V_78 [ V_394 ] . V_36 = 0 ;
F_297 ( & V_393 -> V_78 [ V_394 ] . V_19 ) ;
}
for ( V_394 = 0 ; V_394 <= V_393 -> V_33 ; V_394 ++ ) {
F_296 ( & V_393 -> V_81 [ V_394 ] . V_43 ) ;
V_393 -> V_81 [ V_394 ] . V_36 = 0 ;
F_297 ( & V_393 -> V_81 [ V_394 ] . V_19 ) ;
}
}
T_3 F_298 ( void )
{
