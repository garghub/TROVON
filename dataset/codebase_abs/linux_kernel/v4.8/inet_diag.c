...
case V_187 : {
V_36 V_188 ;
V_188 = * ( ( const V_36 * ) ( V_162 + 1 ) ) ;
if ( V_188 != V_157 -> V_188 )
V_160 = 0 ;
break;
}
}
...
#if F_10 ( V_24 )
if ( V_13 -> V_15 == V_25 ) {
V_157 -> V_182 = V_13 -> V_28 . V_189 ;
V_157 -> V_183 = V_13 -> V_30 . V_189 ;
} else
#endif
{
...
F_70 ( & V_157 , V_13 ) ;
V_157 . V_167 = V_45 -> V_190 ;
V_157 . V_171 = F_72 ( V_45 -> V_191 ) ;
V_157 . V_188 = V_13 -> V_22 ;
V_157 . V_174 = F_25 ( V_13 ) ? V_13 -> V_192 : 0 ;
return F_68 ( V_158 , & V_157 ) ;
}
static int F_73 ( const void * V_158 , int V_159 , int V_193 )
{
while ( V_159 >= 0 ) {
const struct V_161 * V_162 = V_158 ;
if ( V_193 > V_159 )
...
static bool F_75 ( const struct V_161 * V_162 , int V_159 ,
int * V_194 )
{
struct V_178 * V_179 ;
int V_195 ;
* V_194 += sizeof( struct V_178 ) ;
if ( V_159 < * V_194 )
return false ;
...
if ( V_159 < * V_194 )
return false ;
if ( V_179 -> V_186 > 8 * V_195 )
return false ;
return true ;
}
static bool F_76 ( const struct V_161 * V_162 ,
int V_159 , int * V_194 )
{
* V_194 += sizeof( struct V_161 ) ;
if ( V_159 < * V_194 )
return false ;
return true ;
}
static int F_77 ( const void * V_197 , int V_198 )
{
const void * V_158 = V_197 ;
int V_159 = V_198 ;
while ( V_159 > 0 ) {
int V_194 = sizeof( struct V_161 ) ;
const struct V_161 * V_162 = V_158 ;
switch ( V_162 -> V_163 ) {
case V_176 :
case V_177 :
if ( ! F_75 ( V_158 , V_159 , & V_194 ) )
return - V_134 ;
break;
case V_187 :
if ( ! F_74 ( V_158 , V_159 , & V_194 ) )
return - V_134 ;
break;
case V_166 :
case V_169 :
...
if ( V_162 -> V_168 < V_194 || V_162 -> V_168 > V_159 + 4 || V_162 -> V_168 & 3 )
return - V_134 ;
if ( V_162 -> V_168 < V_159 &&
! F_73 ( V_197 , V_198 , V_159 - V_162 -> V_168 ) )
return - V_134 ;
}
if ( V_162 -> V_160 < V_194 || V_162 -> V_160 > V_159 + 4 || V_162 -> V_160 & 3 )
return - V_134 ;
V_158 += V_162 -> V_160 ;
V_159 -= V_162 -> V_160 ;
}
...
F_60 ( F_61 ( V_200 -> V_40 ) . V_13 ) ,
F_61 ( V_200 -> V_40 ) . V_63 ,
V_200 -> V_71 -> V_139 , V_201 , V_200 -> V_71 ) ;
}
...
F_47 ( struct V_44 , V_190 ) ) ;
F_46 ( F_47 ( struct V_115 , V_204 ) !=
F_47 ( struct V_44 , V_191 ) ) ;
F_46 ( F_47 ( struct V_115 , V_205 ) !=
F_47 ( struct V_44 , V_206 ) ) ;
F_46 ( F_47 ( struct V_115 , V_207 ) !=
F_47 ( struct V_44 , V_208 ) ) ;
#if F_10 ( V_24 )
F_46 ( F_47 ( struct V_115 , V_209 ) !=
F_47 ( struct V_12 , V_28 ) ) ;
F_46 ( F_47 ( struct V_115 , V_210 ) !=
F_47 ( struct V_12 , V_30 ) ) ;
#endif
}
void F_80 ( struct V_131 * V_132 , struct V_39 * V_40 ,
struct V_199 * V_200 ,
const struct V_61 * V_11 , struct V_72 * V_158 )
{
struct V_130 * V_130 = F_56 ( V_40 -> V_13 ) ;
int V_211 , V_212 , V_213 , V_214 ;
V_36 V_215 = V_11 -> V_215 ;
if ( V_215 & V_216 )
V_215 |= V_217 ;
V_213 = V_200 -> args [ 1 ] ;
V_214 = V_212 = V_200 -> args [ 2 ] ;
if ( V_200 -> args [ 0 ] == 0 ) {
if ( ! ( V_215 & V_54 ) )
goto V_218;
...
struct V_12 * V_13 ;
V_212 = 0 ;
V_221 = & V_132 -> V_222 [ V_211 ] ;
F_81 ( & V_221 -> V_223 ) ;
F_82 (sk, &ilb->head) {
struct V_44 * V_45 = F_14 ( V_13 ) ;
if ( ! F_83 ( F_56 ( V_13 ) , V_130 ) )
continue;
if ( V_212 < V_214 ) {
V_212 ++ ;
continue;
...
goto V_224;
if ( V_11 -> V_16 . V_17 != V_45 -> V_225 &&
V_11 -> V_16 . V_17 )
goto V_224;
if ( V_11 -> V_16 . V_19 ||
V_200 -> args [ 3 ] > 0 )
goto V_224;
if ( F_78 ( V_13 , V_40 , V_200 , V_11 , V_158 ) < 0 ) {
F_84 ( & V_221 -> V_223 ) ;
goto V_226;
}
V_224:
...
if ( ! ( V_215 & ~ V_54 ) )
goto V_91;
for ( V_211 = V_213 ; V_211 <= V_132 -> V_227 ; V_211 ++ ) {
struct V_228 * V_229 = & V_132 -> V_230 [ V_211 ] ;
T_4 * V_223 = F_85 ( V_132 , V_211 ) ;
struct V_231 * V_232 ;
struct V_12 * V_13 ;
V_212 = 0 ;
if ( F_86 ( & V_229 -> V_233 ) )
...
V_214 = 0 ;
F_81 ( V_223 ) ;
F_87 (sk, node, &head->chain) {
int V_234 , V_235 ;
if ( ! F_83 ( F_56 ( V_13 ) , V_130 ) )
continue;
if ( V_212 < V_214 )
goto V_236;
V_234 = ( V_13 -> V_53 == V_111 ) ?
...
if ( ! F_71 ( V_158 , V_13 ) )
goto V_236;
V_235 = F_48 ( V_13 , V_40 , V_11 ,
F_60 ( F_61 ( V_200 -> V_40 ) . V_13 ) ,
F_61 ( V_200 -> V_40 ) . V_63 ,
V_200 -> V_71 -> V_139 , V_201 ,
V_200 -> V_71 ) ;
if ( V_235 < 0 ) {
F_84 ( V_223 ) ;
goto V_226;
...
static int F_89 ( struct V_39 * V_40 , struct V_199 * V_200 ,
const struct V_61 * V_11 ,
struct V_72 * V_158 )
{
const struct V_1 * V_9 ;
...
V_9 = F_1 ( V_11 -> V_75 ) ;
if ( ! F_57 ( V_9 ) )
V_9 -> V_237 ( V_40 , V_200 , V_11 , V_158 ) ;
else
V_108 = F_58 ( V_9 ) ;
F_5 ( V_9 ) ;
return V_108 ? : V_40 -> V_159 ;
}
static int F_90 ( struct V_39 * V_40 , struct V_199 * V_200 )
{
int V_238 = sizeof( struct V_61 ) ;
struct V_72 * V_158 = NULL ;
if ( F_91 ( V_200 -> V_71 , V_238 ) )
V_158 = F_92 ( V_200 -> V_71 , V_238 , V_239 ) ;
return F_89 ( V_40 , V_200 , F_24 ( V_200 -> V_71 ) , V_158 ) ;
}
static int F_93 ( int type )
{
switch ( type ) {
case V_240 :
return V_241 ;
...
struct V_199 * V_200 )
{
struct V_244 * V_245 = F_24 ( V_200 -> V_71 ) ;
int V_238 = sizeof( struct V_244 ) ;
struct V_61 V_62 ;
struct V_72 * V_158 = NULL ;
V_62 . V_133 = V_185 ;
V_62 . V_75 = F_93 ( V_200 -> V_71 -> V_76 ) ;
V_62 . V_70 = V_245 -> V_70 ;
V_62 . V_215 = V_245 -> V_215 ;
V_62 . V_16 = V_245 -> V_16 ;
if ( F_91 ( V_200 -> V_71 , V_238 ) )
V_158 = F_92 ( V_200 -> V_71 , V_238 , V_239 ) ;
return F_89 ( V_40 , V_200 , & V_62 , V_158 ) ;
}
static int F_95 ( struct V_39 * V_135 ,
const struct V_66 * V_71 )
{
struct V_244 * V_245 = F_24 ( V_71 ) ;
struct V_61 V_62 ;
V_62 . V_133 = V_245 -> V_14 ;
V_62 . V_75 = F_93 ( V_71 -> V_76 ) ;
V_62 . V_70 = V_245 -> V_70 ;
V_62 . V_215 = V_245 -> V_215 ;
V_62 . V_16 = V_245 -> V_16 ;
return F_65 ( V_143 , V_135 , V_71 , & V_62 ) ;
}
static int F_96 ( struct V_39 * V_40 , struct V_66 * V_71 )
{
int V_238 = sizeof( struct V_244 ) ;
struct V_130 * V_130 = F_56 ( V_40 -> V_13 ) ;
if ( V_71 -> V_76 >= V_246 ||
...
if ( F_91 ( V_71 , V_238 ) ) {
struct V_72 * V_73 ;
V_73 = F_92 ( V_71 , V_238 ,
V_239 ) ;
if ( ! V_73 ||
F_69 ( V_73 ) < sizeof( struct V_161 ) ||
F_77 ( F_33 ( V_73 ) , F_69 ( V_73 ) ) )
return - V_134 ;
}
{
struct V_248 V_249 = {
...
return F_98 ( V_130 -> V_140 , V_40 , V_71 , & V_249 ) ;
}
}
return F_95 ( V_40 , V_71 ) ;
}
static int F_99 ( struct V_39 * V_40 , struct V_66 * V_250 )
{
int V_238 = sizeof( struct V_61 ) ;
struct V_130 * V_130 = F_56 ( V_40 -> V_13 ) ;
if ( F_97 ( V_250 ) < V_238 )
...
return F_98 ( V_130 -> V_140 , V_40 , V_250 , & V_249 ) ;
}
}
return F_65 ( V_250 -> V_76 , V_40 , V_250 , F_24 ( V_250 ) ) ;
}
static
int F_100 ( struct V_39 * V_40 , struct V_12 * V_13 )
{
const struct V_1 * V_9 ;
struct V_66 * V_71 ;
struct V_72 * V_73 ;
...
F_7 ( V_11 , V_13 ) ;
if ( V_13 -> V_251 == V_252 || V_13 -> V_251 == V_253 )
V_11 -> V_16 . V_17 = F_14 ( V_13 ) -> V_225 ;
V_11 -> V_78 = V_13 -> V_53 ;
if ( ( V_108 = F_15 ( V_40 , V_254 , V_13 -> V_255 ) ) ) {
F_39 ( V_40 , V_71 ) ;
return V_108 ;
}
V_9 = F_1 ( V_13 -> V_255 ) ;
...
int F_101 ( const struct V_1 * V_250 )
{
const T_5 type = V_250 -> V_256 ;
int V_108 = - V_134 ;
if ( type >= V_257 )
goto V_91;
F_3 ( & V_7 ) ;
...
void F_102 ( const struct V_1 * V_250 )
{
const T_5 type = V_250 -> V_256 ;
if ( type >= V_257 )
return;
...
{
const int V_259 = ( V_257 *
sizeof( struct V_1 * ) ) ;
int V_108 = - V_138 ;
V_3 = F_104 ( V_259 , V_137 ) ;
if ( ! V_3 )
goto V_91;
V_108 = F_105 ( & V_1 ) ;
if ( V_108 )
