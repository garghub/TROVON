...
static int F_276 ( struct V_1 * V_7 , enum V_353 V_353 )
{
...
static int F_292 ( struct V_462 * V_463 ,
unsigned long V_464 , void * V_465 )
{
unsigned V_457 = ( unsigned long ) V_465 ;
switch ( V_464 ) {
case V_466 :
case V_467 :
...
static int F_293 ( struct V_471 * V_472 )
{
if ( ! V_473 )
return 0 ;
F_294 ( V_472 , V_473 ) ;
...
static T_9
F_311 ( struct V_187 * V_99 , struct V_483 * V_484 ,
char * V_294 )
{
...
struct V_483 * V_484 , const char * V_294 , T_10 V_426 )
{
struct V_158 * V_159 = F_312 ( V_99 ) ;
struct V_2 * V_3 = F_102 ( V_159 ) ;
struct V_5 * V_34 = F_2 ( V_3 ) ;
struct V_4 * V_35 = V_34 -> V_6 ;
int V_485 , V_486 ;
V_485 = F_314 ( V_294 , 10 , & V_486 ) ;
if ( V_485 )
return V_485 ;
if ( V_486 > 255 )
return - V_487 ;
V_35 -> V_450 = ( T_1 ) V_486 ;
return strlen ( V_294 ) ;
}
