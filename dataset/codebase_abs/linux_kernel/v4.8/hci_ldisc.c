...
if ( ! F_18 ( V_49 , & V_10 -> V_37 ) )
return;
V_10 -> V_24 -> V_113 ( V_10 , V_40 , V_112 ) ;
if ( V_10 -> V_13 )
V_10 -> V_13 -> V_15 . V_114 += V_112 ;
F_56 ( V_33 ) ;
}
...
V_13 -> V_119 = F_31 ;
V_13 -> V_97 = F_38 ;
F_60 ( V_13 , V_10 -> V_33 -> V_120 ) ;
if ( F_18 ( V_121 , & V_10 -> V_45 ) )
F_9 ( V_122 , & V_13 -> V_123 ) ;
if ( F_18 ( V_124 , & V_10 -> V_45 ) )
F_9 ( V_125 , & V_13 -> V_123 ) ;
if ( ! F_18 ( V_126 , & V_10 -> V_45 ) )
F_9 ( V_127 , & V_13 -> V_123 ) ;
...
{
unsigned long V_134 = F_63 ( V_121 ) |
F_63 ( V_126 ) |
F_63 ( V_128 ) |
F_63 ( V_44 ) |
F_63 ( V_124 ) |
...
static int F_64 ( struct V_32 * V_33 , struct V_135 * V_135 ,
...
switch ( V_136 ) {
case V_139 :
if ( ! F_8 ( V_111 , & V_10 -> V_37 ) ) {
V_43 = F_61 ( V_10 , V_137 ) ;
if ( V_43 ) {
F_14 ( V_111 , & V_10 -> V_37 ) ;
return V_43 ;
}
...
return V_10 -> V_45 ;
default:
V_43 = F_65 ( V_33 , V_135 , V_136 , V_137 ) ;
break;
}
return V_43 ;
}
static T_2 F_66 ( struct V_32 * V_33 , struct V_135 * V_135 ,
unsigned char T_3 * V_146 , T_4 V_147 )
{
return 0 ;
}
static T_2 F_67 ( struct V_32 * V_33 , struct V_135 * V_135 ,
const unsigned char * V_40 , T_4 V_112 )
{
return 0 ;
}
static unsigned int F_68 ( struct V_32 * V_33 ,
struct V_135 * V_148 , T_5 * V_149 )
{
return 0 ;
}
