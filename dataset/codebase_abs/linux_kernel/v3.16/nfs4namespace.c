...
F_9 ( L_6 ,
V_28 , V_17 ) ;
V_61 = F_39 ( V_73 , V_94 -> V_97 , & V_17 -> V_98 , V_95 , V_24 ) ;
F_40 ( V_94 ) ;
if ( V_61 != 0 ||
V_95 -> V_92 <= 0 ||
V_95 -> V_26 . V_7 <= 0 )
...
struct V_65 * F_42 ( struct V_37 * V_38 , struct V_17 * V_17 ,
struct V_99 * V_100 , struct V_101 * V_102 )
{
T_3 V_46 = V_38 -> V_73 -> V_56 -> V_90 ;
struct V_17 * V_94 = F_38 ( V_17 ) ;
struct V_58 * V_103 = V_94 -> V_97 ;
struct V_59 * V_60 = & V_17 -> V_98 ;
struct V_35 * V_73 ;
struct V_65 * V_74 ;
V_73 = F_43 ( V_103 , V_60 , V_100 , V_102 ) ;
F_40 ( V_94 ) ;
if ( F_6 ( V_73 ) )
return F_29 ( V_73 ) ;
...
V_46 = V_73 -> V_56 -> V_90 ;
V_74 = F_44 ( V_17 , V_100 , V_102 , V_46 ) ;
V_64:
F_18 ( V_73 ) ;
return V_74 ;
}
...
F_31 ( V_106 , V_85 ) ;
error = - V_63 ;
V_86 = F_46 ( V_81 -> V_13 , V_81 -> V_11 , V_62 ) ;
if ( V_86 == NULL )
break;
error = F_47 ( V_38 , V_86 , V_106 , V_32 , V_33 ) ;
F_33 ( V_86 ) ;
if ( error == 0 )
break;
}
