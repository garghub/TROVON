...
V_24 -> V_39 = 0 ;
V_9 = F_10 ( V_24 -> V_40 , NULL , V_24 , 1 ) ;
if ( V_9 == - V_41 ) {
if ( V_24 -> V_39 > 0 ) {
...
static int F_12 ( struct V_2 * V_3 , unsigned char * V_6 )
{
struct V_7 V_8 ;
int V_47 ;
...
static void F_13 ( struct V_23 * V_24 , int error )
{
struct V_1 * V_22 = V_24 -> V_49 ;
unsigned V_50 = V_45 ;
if ( error || F_14 ( V_24 -> V_42 ) != V_51 ||
F_15 ( V_24 -> V_42 ) != V_52 ) {
F_5 ( V_11 , V_22 -> V_3 ,
L_7 ,
V_12 , V_24 -> V_42 ) ;
...
V_24 -> V_39 = 0 ;
V_24 -> V_49 = V_22 ;
F_18 ( V_24 -> V_40 , NULL , V_24 , 1 , F_13 ) ;
return V_45 ;
}
static int F_19 ( struct V_2 * V_3 , struct V_23 * V_24 )
{
