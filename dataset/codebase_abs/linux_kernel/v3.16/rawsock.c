...
if ( V_43 == NULL )
return V_25 ;
V_25 = F_39 ( F_40 ( V_43 , V_19 ) , V_54 -> V_59 , V_19 ) ;
if ( V_25 < 0 ) {
F_31 ( V_43 ) ;
return V_25 ;
}
...
V_25 = F_44 ( V_43 , 0 , V_54 -> V_59 , V_62 ) ;
F_45 ( V_4 , V_43 ) ;
return V_25 ? : V_62 ;
}
...
static int F_51 ( struct V_66 * V_66 , struct V_14 * V_3 ,
...
V_3 -> V_70 = & V_72 ;
V_4 = F_52 ( V_66 , V_73 , V_74 , V_67 -> V_75 ) ;
if ( ! V_4 )
return - V_76 ;
F_53 ( V_3 , V_4 ) ;
V_4 -> V_77 = V_67 -> V_78 ;
