...
V_74 |= F_21 ( & V_73 -> V_87 , V_73 -> V_88 ) ;
V_74 |= F_21 ( & V_73 -> V_89 , 0 ) ;
if ( V_74 )
return 3 ;
if ( V_74 )
return 4 ;
...
if ( ! V_21 -> V_31 )
return - V_107 ;
V_101 = F_32 ( V_21 -> V_31 ) ;
if ( V_101 < 0 ) {
F_33 ( V_15 -> V_108 , L_1 ) ;
return V_101 ;
}
V_15 -> V_57 = F_34 ( V_21 -> V_31 ) ;
F_35 ( V_15 -> V_108 , L_2 , V_15 -> V_105 ,
...
F_11 ( 0x00 ,
V_21 -> V_31 -> V_32 + F_5 ( V_100 ) ) ;
if ( V_6 -> V_55 )
F_11 ( 0x01 ,
V_21 -> V_31 -> V_32 + F_1 ( V_100 ) ) ;
else
F_11 ( 0x00 ,
V_21 -> V_31 -> V_32 + F_1 ( V_100 ) ) ;
}
...
V_101 = F_38 ( V_15 -> V_57 , F_16 , V_127 ,
L_3 , V_15 ) ;
if ( V_101 < 0 ) {
V_15 -> V_57 = 0 ;
F_33 ( V_15 -> V_108 , L_4 ) ;
...
static int F_44 ( struct V_97 * V_15 ,
