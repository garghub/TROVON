...
static T_1 F_34 ( struct V_1 * V_2 , unsigned int V_4 )
{
return F_2 ( V_2 -> V_8 + V_2 -> V_5 -> V_6 + V_4 ) ;
}
static void F_35 ( T_1 V_12 , struct V_1 * V_2 ,
unsigned int V_4 )
{
F_3 ( V_12 , V_2 -> V_8 + V_2 -> V_5 -> V_6 + V_4 ) ;
}
static int F_36 ( struct V_65 * V_28 , unsigned int V_4 , T_1 * V_12 )
{
struct V_22 * V_23 ;
struct V_1 * V_2 ;
unsigned long V_66 ;
int V_57 ;
V_57 = F_37 ( F_38 ( V_28 ) , & V_23 ) ;
if ( F_39 ( V_57 ) )
return V_57 ;
F_40 ( & V_28 -> V_67 . V_68 , V_66 ) ;
if ( F_41 ( V_28 ) ) {
V_57 = - V_69 ;
goto V_70;
}
...
* V_12 = F_34 ( V_2 , V_4 ) ;
V_70:
F_43 ( & V_28 -> V_67 . V_68 , V_66 ) ;
return V_57 ;
}
static T_3 F_44 ( struct V_65 * V_28 , struct V_71 * V_72 ,
char * V_73 )
{
T_1 V_74 = 0 ;
unsigned int V_4 ;
...
V_57 = F_36 ( V_28 , V_4 , & V_74 ) ;
if ( V_57 )
return V_57 ;
return snprintf ( V_73 , V_77 , L_6 , V_74 ) ;
}
static T_3 F_45 ( struct V_65 * V_28 ,
struct V_71 * V_72 , char * V_73 )
{
T_1 V_78 = 0 ;
char * V_79 ;
int V_57 ;
V_57 = F_36 ( V_28 , V_10 , & V_78 ) ;
if ( V_57 )
return V_57 ;
V_79 = ( V_78 & V_80 ) ? L_7 : L_8 ;
return sprintf ( V_73 , L_9 , V_79 ) ;
}
static void F_46 ( struct V_65 * V_28 , T_4 V_12 )
{
struct V_1 * V_2 = F_42 ( F_47 ( V_28 ) ) ;
T_1 V_78 , V_81 ;
V_78 = F_34 ( V_2 , V_10 ) ;
if ( V_12 < 0 ) {
if ( V_78 & V_80 ) {
...
static void F_48 ( struct V_65 * V_28 )
{
struct V_1 * V_2 = F_42 ( F_47 ( V_28 ) ) ;
unsigned int V_89 ;
for ( V_89 = 0 ; V_89 < V_90 ; V_89 ++ ) {
unsigned long V_3 = V_89 * sizeof( T_1 ) ;
V_2 -> V_91 [ V_89 ] = F_34 ( V_2 , V_3 ) ;
F_49 ( V_28 , L_10 ,
V_2 -> V_91 [ V_89 ] , V_3 ) ;
}
}
static void F_50 ( struct V_65 * V_28 )
{
struct V_1 * V_2 = F_42 ( F_47 ( V_28 ) ) ;
unsigned int V_89 ;
F_51 ( 10 ) ;
for ( V_89 = 0 ; V_89 < V_90 ; V_89 ++ ) {
unsigned long V_3 = V_89 * sizeof( T_1 ) ;
F_35 ( V_2 -> V_91 [ V_89 ] , V_2 , V_3 ) ;
F_49 ( V_28 , L_11 ,
V_2 -> V_91 [ V_89 ] , V_3 ) ;
}
}
static int F_52 ( struct V_65 * V_28 )
{
int V_57 = F_53 ( V_28 ) ;
if ( V_57 )
return V_57 ;
...
static int F_55 ( struct V_65 * V_28 )
{
int V_57 = F_56 ( V_28 ) ;
if ( V_57 )
return V_57 ;
...
static int F_58 ( struct V_65 * V_28 )
{
int V_57 = F_59 ( V_28 ) ;
if ( V_57 )
return V_57 ;
...
static int F_61 ( struct V_65 * V_28 )
{
int V_57 = F_62 ( V_28 ) ;
if ( V_57 )
return V_57 ;
...
{
struct V_55 * V_56 = F_65 ( V_95 ) ;
struct V_1 * V_2 ;
struct V_22 * V_23 ;
const struct V_49 * V_50 ;
V_50 = F_66 ( V_96 , & V_56 -> V_28 ) ;
if ( ! V_50 || ! V_50 -> V_58 )
return 0 ;
if ( F_37 ( F_38 ( & V_56 -> V_28 ) , & V_23 ) )
return 0 ;
V_2 = F_42 ( V_23 ) ;
if ( ! V_2 || ! V_2 -> V_8 )
return 0 ;
...
case V_103 :
if ( V_2 -> V_5 -> V_104 )
return F_68 ( & V_56 -> V_28 . V_105 ,
& V_106 ) ;
case V_107 :
if ( V_2 -> V_5 -> V_104 )
F_69 ( & V_56 -> V_28 . V_105 , & V_106 ) ;
default:
break;
}
return 0 ;
...
return;
if ( V_2 -> V_37 >= V_2 -> V_5 -> V_6 + V_97 )
V_28 -> V_67 . V_108 = F_46 ;
else
F_67 ( V_28 , L_12 ) ;
}
static void F_71 ( struct V_65 * V_28 )
{
