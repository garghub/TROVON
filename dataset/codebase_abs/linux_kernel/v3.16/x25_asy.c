...
return - V_19 ;
V_18 = 2 * V_17 ;
V_16 = F_14 ( V_18 + 4 , V_20 ) ;
V_15 = F_14 ( V_18 + 4 , V_20 ) ;
...
F_25 ( V_33 , 1 ) ;
memcpy ( F_26 ( V_33 , V_34 ) , V_4 -> V_15 , V_34 ) ;
...
static void F_32 ( struct V_1 * V_4 , unsigned char * V_42 , int V_18 )
{
unsigned char * V_43 ;
...
if ( V_33 != NULL ) {
F_18 ( V_4 ) ;
V_3 -> V_25 . V_60 += V_33 -> V_18 ;
F_32 ( V_4 , V_33 -> V_56 , V_33 -> V_18 ) ;
F_49 ( V_33 ) ;
}
F_41 ( & V_4 -> V_22 ) ;
}
...
static void F_51 ( struct V_2 * V_3 , int V_61 )
{
struct V_1 * V_4 = F_2 ( V_3 ) ;
struct V_32 * V_33 ;
unsigned char * V_62 ;
...
return - V_63 ;
V_18 = V_3 -> V_30 * 2 ;
V_4 -> V_15 = F_14 ( V_18 + 4 , V_64 ) ;
if ( V_4 -> V_15 == NULL )
goto V_65;
V_4 -> V_16 = F_14 ( V_18 + 4 , V_64 ) ;
if ( V_4 -> V_16 == NULL )
goto V_66;
V_4 -> V_31 = V_18 ;
V_4 -> V_27 = 0 ;
...
static void F_56 ( struct V_50 * V_46 ,
...
static int F_58 ( struct V_50 * V_46 )
{
struct V_1 * V_4 = V_46 -> V_51 ;
int V_35 ;
...
static void F_61 ( struct V_50 * V_46 )
{
struct V_1 * V_4 = V_46 -> V_51 ;
int V_35 ;
if ( ! V_4 || V_4 -> V_52 != V_53 )
...
static int F_33 ( unsigned char * V_77 , unsigned char * V_78 , int V_18 )
{
...
static void F_57 ( struct V_1 * V_4 , unsigned char V_77 )
{
switch ( V_77 ) {
case V_80 :
...
static int F_70 ( struct V_50 * V_46 , struct V_83 * V_83 ,
...
switch ( V_84 ) {
case V_86 :
if ( F_71 ( ( void V_87 * ) V_85 , V_4 -> V_3 -> V_10 ,
...
return - V_19 ;
default:
return F_72 ( V_46 , V_83 , V_84 , V_85 ) ;
}
}
static long F_73 ( struct V_50 * V_46 , struct V_83 * V_83 ,
unsigned int V_84 , unsigned long V_85 )
{
switch ( V_84 ) {
case V_86 :
case V_89 :
return F_70 ( V_46 , V_83 , V_84 ,
( unsigned long ) F_74 ( V_85 ) ) ;
}
return - V_90 ;
}
