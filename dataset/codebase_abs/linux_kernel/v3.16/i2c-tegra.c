...
V_2 -> V_19 = & V_136 -> V_19 ;
V_2 -> V_49 = F_56 ( & V_136 -> V_19 , L_12 ) ;
if ( F_52 ( V_2 -> V_49 ) ) {
F_25 ( & V_136 -> V_19 , L_13 ) ;
return F_53 ( V_2 -> V_49 ) ;
}
V_40 = F_57 ( V_2 -> V_19 -> V_149 , L_14 ,
& V_2 -> V_55 ) ;
if ( V_40 )
V_2 -> V_55 = 100000 ;
V_2 -> V_41 = & V_150 ;
...
F_60 ( & V_2 -> V_87 ) ;
if ( ! V_2 -> V_41 -> V_42 ) {
V_43 = F_54 ( & V_136 -> V_19 , L_16 ) ;
if ( F_52 ( V_43 ) ) {
F_25 ( & V_136 -> V_19 , L_17 ) ;
return F_53 ( V_43 ) ;
}
V_2 -> V_43 = V_43 ;
}
...
if ( V_40 ) {
F_25 ( & V_136 -> V_19 , L_19 , V_2 -> V_68 ) ;
return V_40 ;
}
F_64 ( & V_2 -> V_145 , V_2 ) ;
V_2 -> V_145 . V_154 = V_155 ;
V_2 -> V_145 . V_156 = V_157 | V_158 ;
F_65 ( V_2 -> V_145 . V_159 , L_20 ,
