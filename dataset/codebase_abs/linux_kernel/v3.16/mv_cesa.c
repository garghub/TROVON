...
struct {
struct V_119 V_126 ;
char V_15 [ F_43 ( V_15 -> V_179 ) ] ;
} V_120 ;
unsigned int V_121 ;
char V_180 [ V_178 ] ;
char V_181 [ V_178 ] ;
V_120 . V_126 . V_31 = V_15 -> V_179 ;
V_120 . V_126 . V_129 = F_93 ( V_15 -> V_179 ) &
V_130 ;
if ( V_175 > V_176 ) {
int V_182 ;
V_182 =
F_94 ( & V_120 . V_126 , V_28 , V_175 , V_180 ) ;
if ( V_182 )
return V_182 ;
V_175 = V_177 ;
} else
...
F_46 ( & V_120 . V_126 , V_180 , V_176 ) ? :
F_95 ( & V_120 . V_126 , V_180 ) ? :
F_45 ( & V_120 . V_126 ) ? :
F_46 ( & V_120 . V_126 , V_181 , V_176 ) ? :
F_95 ( & V_120 . V_126 , V_181 ) ;
if ( V_128 == 0 )
...
static T_3 F_107 ( int V_191 , void * V_192 )
{
V_100 V_193 ;
...
V_204 = F_109 ( V_200 , V_206 , L_10 ) ;
if ( ! V_204 )
return - V_207 ;
V_202 = F_110 ( sizeof( * V_202 ) , V_208 ) ;
if ( ! V_202 )
return - V_188 ;
F_111 ( & V_202 -> V_163 ) ;
F_112 ( & V_202 -> V_164 , 50 ) ;
V_202 -> V_4 = F_113 ( V_204 -> V_209 , F_114 ( V_204 ) ) ;
if ( ! V_202 -> V_4 ) {
V_39 = - V_188 ;
goto V_182;
}
V_204 = F_109 ( V_200 , V_206 , L_11 ) ;
if ( ! V_204 ) {
V_39 = - V_207 ;
goto V_210;
}
V_202 -> V_211 = F_114 ( V_204 ) ;
V_202 -> V_50 = V_202 -> V_211 - V_212 ;
V_202 -> V_51 = F_113 ( V_204 -> V_209 , V_202 -> V_211 ) ;
if ( ! V_202 -> V_51 ) {
V_39 = - V_188 ;
goto V_210;
}
if ( V_200 -> V_213 . V_214 )
V_191 = F_115 ( V_200 -> V_213 . V_214 , 0 ) ;
else
V_191 = F_116 ( V_200 , 0 ) ;
if ( V_191 < 0 || V_191 == V_215 ) {
V_39 = V_191 ;
goto V_216;
}
V_202 -> V_191 = V_191 ;
F_117 ( V_200 , V_202 ) ;
V_3 = V_202 ;
V_202 -> V_11 = F_118 ( F_60 , V_202 , L_12 ) ;
if ( F_99 ( V_202 -> V_11 ) ) {
V_39 = F_100 ( V_202 -> V_11 ) ;
goto V_216;
}
V_39 = F_119 ( V_191 , F_107 , 0 , F_120 ( & V_200 -> V_213 ) ,
V_202 ) ;
if ( V_39 )
goto V_217;
V_202 -> V_218 = F_121 ( & V_200 -> V_213 , NULL ) ;
if ( ! F_99 ( V_202 -> V_218 ) )
F_122 ( V_202 -> V_218 ) ;
F_5 ( 0 , V_3 -> V_4 + V_194 ) ;
F_5 ( V_195 , V_3 -> V_4 + V_219 ) ;
F_5 ( V_220 , V_3 -> V_4 + V_221 ) ;
F_5 ( V_85 , V_3 -> V_4 + V_222 ) ;
V_39 = F_123 ( & V_223 ) ;
if ( V_39 ) {
F_3 (KERN_WARNING MV_CESA
L_13 ) ;
...
static int F_132 ( struct V_199 * V_200 )
{
struct V_201 * V_202 = F_133 ( V_200 ) ;
F_125 ( & V_223 ) ;
F_125 ( & V_225 ) ;
if ( V_202 -> V_228 )
F_134 ( & V_227 ) ;
...
F_134 ( & V_229 ) ;
F_129 ( V_202 -> V_11 ) ;
F_126 ( V_202 -> V_191 , V_202 ) ;
memset ( V_202 -> V_51 , 0 , V_202 -> V_211 ) ;
F_130 ( V_202 -> V_51 ) ;
F_130 ( V_202 -> V_4 ) ;
if ( ! F_99 ( V_202 -> V_218 ) ) {
F_127 ( V_202 -> V_218 ) ;
