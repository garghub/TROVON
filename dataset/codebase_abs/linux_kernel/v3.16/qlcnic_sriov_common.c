...
V_285 = V_28 -> V_286 [ V_30 ] ;
if ( V_285 )
F_135 ( V_6 , V_60 , V_285 ) ;
}
F_114 ( & V_28 -> V_44 ) ;
if ( F_136 ( V_6 ) )
F_135 ( V_6 , V_60 , 0 ) ;
...
{
struct V_260 * V_287 = & V_22 -> V_41 ;
struct V_288 * V_289 ;
F_44 ( V_22 -> V_40 ) ;
while ( ! F_26 ( V_287 ) ) {
V_289 = F_117 ( V_287 -> V_290 , struct V_288 ,
V_68 ) ;
F_34 ( & V_289 -> V_257 ) ;
F_28 ( & V_289 -> V_68 ) ;
F_23 ( V_289 ) ;
...
struct V_5 * V_6 = F_133 ( V_171 ) ;
struct V_81 * V_34 = V_6 -> V_34 ;
static const T_2 V_291 [ V_292 ] = {
0xff , 0xff , 0xff , 0xff , 0xff , 0xff
} ;
struct V_293 * V_294 ;
T_1 V_295 = V_296 ;
if ( ! F_39 ( V_297 , & V_6 -> V_77 ) )
return;
if ( V_171 -> V_67 & V_298 ) {
if ( ! ( V_6 -> V_67 & V_299 ) )
V_295 = V_300 ;
} else if ( ( V_171 -> V_67 & V_301 ) ||
...
if ( ! F_139 ( V_171 ) ) {
F_140 (ha, netdev)
F_132 ( V_171 , V_294 -> V_303 ) ;
}
}
if ( F_141 ( V_171 ) > V_34 -> V_304 ) {
V_295 = V_300 ;
} else if ( ! F_142 ( V_171 ) ) {
F_143 (ha, netdev)
F_132 ( V_171 , V_294 -> V_303 ) ;
...
struct V_5 * V_6 ;
struct V_65 * V_66 ;
V_289 = F_107 ( V_257 , struct V_288 , V_257 ) ;
V_6 = V_289 -> V_264 ;
V_66 = V_289 -> V_66 ;
F_126 ( V_6 , V_66 ) ;
return;
...
static struct V_288 *
F_147 ( struct V_21 * V_22 )
{
struct V_260 * V_261 ;
struct V_288 * V_289 = NULL ;
T_2 V_309 = 0 ;
F_116 (node, &bc->async_list) {
V_289 = F_117 ( V_261 , struct V_288 , V_68 ) ;
if ( ! F_148 ( & V_289 -> V_257 ) ) {
V_309 = 1 ;
break;
}
}
...
if ( V_289 == NULL )
return NULL ;
F_111 ( & V_289 -> V_68 , & V_22 -> V_41 ) ;
}
return V_289 ;
}
static void F_149 ( struct V_21 * V_22 ,
T_4 V_233 , void * V_310 ,
struct V_65 * V_66 )
{
struct V_288 * V_289 = NULL ;
V_289 = F_147 ( V_22 ) ;
...
V_289 -> V_264 = V_310 ;
V_289 -> V_66 = V_66 ;
F_18 ( & V_289 -> V_257 , V_233 ) ;
F_90 ( V_22 -> V_40 , & V_289 -> V_257 ) ;
}
...
{
struct V_81 * V_34 = V_6 -> V_34 ;
struct V_314 * V_315 = V_34 -> V_315 ;
struct V_284 * V_171 = V_6 -> V_171 ;
T_2 V_30 , V_316 = V_34 -> V_317 - 1 ;
F_159 ( V_171 ) ;
F_160 ( V_6 ) ;
F_161 ( V_6 ) ;
if ( F_154 ( V_171 ) )
F_162 ( V_6 , V_171 ) ;
for ( V_30 = 0 ; V_30 < V_316 ; V_30 ++ ) {
V_315 [ V_30 ] . V_318 = V_30 ;
V_315 [ V_30 ] . V_319 = 0 ;
V_315 [ V_30 ] . V_320 = 0 ;
}
V_34 -> V_182 = 0 ;
...
struct V_81 * V_34 = V_6 -> V_34 ;
struct V_114 * V_9 = & V_6 -> V_10 -> V_9 ;
struct V_321 * V_174 = & V_34 -> V_174 ;
T_2 V_233 = V_34 -> V_42 ;
T_1 V_77 ;
if ( ( V_174 -> V_322 == V_323 ) ||
( V_174 -> V_322 == V_324 ) ) {
if ( ! F_150 ( V_6 ) ) {
F_153 ( V_6 ) ;
V_6 -> V_176 = 0 ;
...
{
struct V_321 * V_174 = & V_6 -> V_34 -> V_174 ;
F_13 ( & V_6 -> V_10 -> V_9 , L_43 ) ;
if ( V_174 -> V_322 == V_179 )
F_158 ( V_6 ) ;
F_77 ( V_180 , & V_174 -> V_115 ) ;
F_77 ( V_188 , & V_6 -> V_77 ) ;
return - V_31 ;
...
struct V_321 * V_174 ;
int V_146 = 0 ;
V_6 = F_107 ( V_257 , struct V_5 , V_330 . V_257 ) ;
V_174 = & V_6 -> V_34 -> V_174 ;
V_174 -> V_331 = F_72 ( V_6 -> V_34 , V_178 ) ;
switch ( V_174 -> V_331 ) {
case V_179 :
V_146 = F_165 ( V_6 ) ;
break;
...
static int F_177 ( struct V_19 * V_20 ,
struct V_27 * V_28 )
{
int V_29 = 0 ;
F_175 ( & V_28 -> V_44 ) ;
if ( V_28 -> V_335 >= V_20 -> V_145 )
V_29 = - V_201 ;
F_176 ( & V_28 -> V_44 ) ;
return V_29 ;
}
...
if ( ! V_337 || F_174 ( V_20 , V_28 , V_336 ) )
return - V_201 ;
}
return 0 ;
}
static void F_180 ( struct V_27 * V_28 , T_3 V_285 ,
enum V_339 V_270 )
{
struct V_5 * V_6 = V_28 -> V_6 ;
struct V_19 * V_20 ;
...
switch ( V_270 ) {
case V_340 :
F_181 ( V_20 , V_28 , V_285 ) ;
break;
case V_341 :
F_182 ( V_20 , V_28 , V_285 ) ;
break;
default:
F_183 ( V_6 -> V_171 , L_47 ) ;
}
F_176 ( & V_28 -> V_44 ) ;
return;
}
int F_184 ( struct V_5 * V_6 ,
T_3 V_336 , T_2 V_266 )
{
struct V_19 * V_20 = V_6 -> V_34 -> V_20 ;
struct V_284 * V_171 = V_6 -> V_171 ;
...
if ( V_146 )
return V_146 ;
V_66 . V_70 . V_71 [ 1 ] = ( V_266 & 1 ) | V_336 << 16 ;
F_33 ( & V_20 -> V_22 ) ;
V_146 = F_48 ( V_6 , & V_66 ) ;
if ( V_146 ) {
F_13 ( & V_6 -> V_10 -> V_9 ,
...
F_187 ( V_171 ) ;
if ( V_266 )
F_180 ( V_28 , V_336 , V_340 ) ;
else
F_180 ( V_28 , V_336 , V_341 ) ;
F_185 ( V_171 ) ;
F_188 ( V_171 ) ;
F_187 ( V_171 ) ;
}
...
{
struct V_260 * V_287 = & V_6 -> V_343 ;
struct V_344 * V_345 ;
while ( ! F_26 ( V_287 ) ) {
V_345 = F_117 ( V_287 -> V_290 , struct V_344 , V_68 ) ;
F_190 ( V_6 , V_345 -> V_346 , V_345 -> V_285 ,
V_347 ) ;
F_28 ( & V_345 -> V_68 ) ;
F_23 ( V_345 ) ;
}
}
static int F_191 ( struct V_8 * V_10 )
{
struct V_5 * V_6 = F_192 ( V_10 ) ;
struct V_284 * V_171 = V_6 -> V_171 ;
int V_348 ;
F_159 ( V_171 ) ;
F_193 ( V_6 ) ;
...
for ( V_30 = 0 ; V_30 < V_20 -> V_18 ; V_30 ++ ) {
V_28 = & V_20 -> V_35 [ V_30 ] ;
V_28 -> V_286 = F_85 ( V_20 -> V_145 ,
sizeof( * V_28 -> V_286 ) , V_32 ) ;
}
}
