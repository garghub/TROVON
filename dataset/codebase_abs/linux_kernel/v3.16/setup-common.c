...
int V_55 = 1 ;
F_40 ( L_27 ) ;
while ( ( V_53 = F_48 ( V_53 , L_28 ) ) && V_54 < V_40 ) {
const T_4 * V_56 ;
T_4 V_57 ;
int V_58 , V_59 ;
F_40 ( L_29 , V_53 -> V_60 ) ;
...
bool V_61 ;
F_40 ( L_34 ,
V_58 , V_54 , F_50 ( V_56 [ V_58 ] ) ) ;
V_61 = F_51 ( V_53 ) ;
if ( ! V_61 )
V_61 = ! F_52 ( V_53 ,
L_35 , L_36 ) ;
F_53 ( V_54 , V_61 ) ;
F_54 ( V_54 , F_50 ( V_56 [ V_58 ] ) ) ;
F_55 ( V_54 , true ) ;
V_54 ++ ;
}
}
...
int F_71 ( unsigned long V_84 )
{
struct V_9 * V_85 , * V_73 = NULL ;
int V_76 = - V_77 ;
switch( V_84 ) {
case V_86 :
if ( ! ( V_73 = F_66 ( NULL , NULL , L_50 ) ) )
V_73 = F_66 ( NULL , NULL , L_51 ) ;
if ( V_73 ) {
V_85 = F_72 ( V_73 ) ;
V_87 = F_73 ( V_85 , 0 ) ;
if ( ! V_87 )
...
{
V_102 = F_82 ( L_59 , NULL ) ;
return V_102 == NULL ;
}
void F_83 ( char * V_103 , unsigned short V_104 )
{
F_84 ( L_60 , V_103 ) ;
}
