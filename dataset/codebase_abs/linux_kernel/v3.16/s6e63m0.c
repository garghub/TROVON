...
V_2 -> V_12 = V_12 ;
V_2 -> V_23 = & V_12 -> V_23 ;
V_2 -> V_45 = F_34 ( & V_12 -> V_23 ) ;
if ( ! V_2 -> V_45 ) {
F_9 ( & V_12 -> V_23 , L_20 ) ;
return - V_47 ;
}
V_48 = F_35 ( & V_12 -> V_23 , L_21 , & V_12 -> V_23 , V_2 ,
& V_76 ) ;
if ( F_36 ( V_48 ) )
return F_37 ( V_48 ) ;
V_2 -> V_48 = V_48 ;
...
V_15 = F_39 ( & ( V_12 -> V_23 ) , & V_80 ) ;
if ( V_15 < 0 )
F_9 ( & ( V_12 -> V_23 ) , L_23 ) ;
V_15 = F_39 ( & ( V_12 -> V_23 ) , & V_81 ) ;
if ( V_15 < 0 )
F_9 ( & ( V_12 -> V_23 ) , L_23 ) ;
if ( ! V_2 -> V_45 -> V_82 ) {
V_2 -> V_39 = V_58 ;
...
static int F_44 ( struct V_62 * V_23 )
{
struct V_1 * V_2 = F_26 ( V_23 ) ;
F_45 ( V_23 , L_25 , V_2 -> V_39 ) ;
return F_18 ( V_2 , V_58 ) ;
}
static int F_46 ( struct V_62 * V_23 )
{
struct V_1 * V_2 = F_26 ( V_23 ) ;
V_2 -> V_39 = V_58 ;
return F_18 ( V_2 , V_57 ) ;
}
static void F_47 ( struct V_71 * V_12 )
{
struct V_1 * V_2 = F_42 ( V_12 ) ;
F_18 ( V_2 , V_58 ) ;
}
