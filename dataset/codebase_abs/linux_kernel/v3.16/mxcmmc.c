...
F_36 ( & V_2 -> V_59 ) ;
V_62 = F_3 ( V_2 , V_63 ) ;
F_7 ( V_2 , V_62 & ~ V_64 , V_63 ) ;
F_20 ( F_17 ( V_2 -> V_11 ) , L_2 , V_65 , V_62 ) ;
if ( V_62 & V_66 )
F_7 ( V_2 , V_66 , V_63 ) ;
F_37 ( V_2 , V_62 ) ;
}
static int F_38 ( struct V_1 * V_2 , struct V_67 * V_68 ,
unsigned int V_69 )
{
T_1 V_70 = V_2 -> V_71 ;
unsigned long V_39 ;
...
F_7 ( V_2 , V_70 , V_87 ) ;
F_43 ( & V_2 -> V_84 , V_39 ) ;
F_12 ( V_2 , V_68 -> V_88 , V_89 ) ;
F_7 ( V_2 , V_68 -> V_90 , V_91 ) ;
F_12 ( V_2 , V_69 , V_92 ) ;
return 0 ;
}
...
V_62 ) ;
if ( V_62 & V_97 ) {
F_41 ( F_17 ( V_2 -> V_11 ) , L_5 , V_65 ) ;
V_28 -> error = - V_98 ;
} else if ( V_62 & V_99 ) {
T_1 V_100 = ( V_62 >> 9 ) & 0x3 ;
if ( V_100 == 2 ) {
F_41 ( F_17 ( V_2 -> V_11 ) ,
L_6 , V_65 ) ;
V_28 -> error = - V_101 ;
...
V_68 -> error = - V_101 ;
} else if ( V_62 & V_108 && V_68 -> V_39 & V_109 ) {
...
V_104 = F_10 ( V_2 , V_112 ) ;
V_105 = F_10 ( V_2 , V_112 ) ;
V_68 -> V_113 [ V_20 ] = V_104 << 16 | V_105 ;
}
} else {
V_104 = F_10 ( V_2 , V_112 ) ;
V_105 = F_10 ( V_2 , V_112 ) ;
V_106 = F_10 ( V_2 , V_112 ) ;
V_68 -> V_113 [ 0 ] = V_104 << 24 | V_105 << 8 | V_106 >> 8 ;
}
}
}
static int F_48 ( struct V_1 * V_2 , T_1 V_114 )
{
T_1 V_62 ;
unsigned long V_115 = V_60 + V_116 ;
do {
V_62 = F_3 ( V_2 , V_63 ) ;
if ( V_62 & V_96 )
return V_62 ;
...
static int F_52 ( struct V_1 * V_2 , void * V_117 , int V_118 )
{
unsigned int V_62 ;
T_1 * V_25 = V_117 ;
while ( V_118 > 3 ) {
...
if ( V_62 )
return V_62 ;
V_121 = F_53 ( F_3 ( V_2 , V_120 ) ) ;
memcpy ( V_105 , & V_121 , V_118 ) ;
}
return 0 ;
}
static int F_54 ( struct V_1 * V_2 , void * V_117 , int V_118 )
{
unsigned int V_62 ;
T_1 * V_25 = V_117 ;
while ( V_118 > 3 ) {
...
if ( V_62 )
return V_62 ;
memcpy ( & V_121 , V_105 , V_118 ) ;
F_7 ( V_2 , F_53 ( V_121 ) , V_120 ) ;
}
V_62 = F_48 ( V_2 , V_122 ) ;
if ( V_62 )
return V_62 ;
...
{
struct V_27 * V_28 = V_2 -> V_94 -> V_28 ;
struct V_29 * V_30 ;
int V_62 , V_20 ;
V_2 -> V_28 = V_28 ;
V_2 -> V_35 = 0 ;
...
{
struct V_1 * V_2 = F_57 ( V_125 , struct V_1 ,
V_126 ) ;
int V_127 = F_55 ( V_2 ) ;
F_7 ( V_2 , V_66 | V_123 ,
V_63 ) ;
...
static T_4 F_60 ( int V_129 , void * V_130 )
{
...
static void F_63 ( struct V_137 * V_11 , struct V_93 * V_94 )
{
struct V_1 * V_2 = F_64 ( V_11 ) ;
unsigned int V_69 = V_2 -> V_69 ;
int error ;
F_39 ( V_2 -> V_94 != NULL ) ;
V_2 -> V_94 = V_94 ;
V_2 -> V_69 &= ~ V_138 ;
...
V_2 -> V_19 = 1 ;
if ( V_94 -> V_28 ) {
error = F_26 ( V_2 , V_94 -> V_28 ) ;
if ( error ) {
V_94 -> V_68 -> error = error ;
goto V_139;
}
V_69 |= V_140 ;
if ( V_94 -> V_28 -> V_39 & V_141 )
V_69 |= V_142 ;
}
error = F_38 ( V_2 , V_94 -> V_68 , V_69 ) ;
V_139:
if ( error )
F_44 ( V_2 , V_94 ) ;
}
...
V_151 -> V_152 = V_2 -> V_153 + V_120 ;
V_151 -> V_154 = V_2 -> V_153 + V_120 ;
V_151 -> V_155 = 4 ;
V_151 -> V_156 = 4 ;
...
static T_4 F_70 ( int V_129 , void * V_28 )
{
struct V_137 * V_11 = V_28 ;
F_20 ( F_17 ( V_11 ) , L_13 , V_65 ) ;
F_62 ( V_11 , F_34 ( 250 ) ) ;
return V_136 ;
}
...
F_99 ( & V_2 -> V_126 , F_56 ) ;
V_163 = F_100 ( & V_183 -> V_53 , V_129 , F_60 , 0 ,
