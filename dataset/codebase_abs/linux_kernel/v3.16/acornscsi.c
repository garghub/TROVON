...
if ( V_1 -> V_73 -> V_168 ) {
unsigned int V_259 ;
if ( V_1 -> V_73 -> V_165 [ 0 ] == V_260 ||
V_1 -> V_73 -> V_165 [ 0 ] == V_261 ||
V_1 -> V_73 -> V_165 [ 0 ] == V_262 )
V_259 = V_250 ;
else
V_259 = V_237 ;
F_71 ( & V_1 -> V_22 . V_225 , 2 , V_259 , V_1 -> V_73 -> V_168 ) ;
}
#endif
#ifdef F_69
...
V_265 = F_76 ( V_1 -> V_73 ) - V_1 -> V_22 . V_23 . V_27 ;
F_1 ( V_1 , V_60 , V_1 -> V_78 [ V_1 -> V_73 -> V_78 -> V_102 ] . V_254 ) ;
F_60 ( V_1 , V_265 >> 16 ) ;
F_60 ( V_1 , V_265 >> 8 ) ;
F_60 ( V_1 , V_265 ) ;
...
int F_77 ( T_1 * V_1 )
{
unsigned int V_92 , V_169 , V_266 = 0 ;
V_92 = F_3 ( V_1 , V_62 ) ;
if ( ! ( V_92 & 8 ) )
F_8 ( V_189 L_59
L_60 ,
...
V_266 = 1 ;
if ( ! V_266 && F_78 ( & V_1 -> V_150 . V_153 , V_92 , V_169 ) )
V_266 = 1 ;
...
#endif
F_79 ( 8 , V_82 , V_1 -> V_22 . V_74 , V_268 ) ;
if ( V_1 -> V_73 && ! V_1 -> V_22 . V_76 )
F_79 ( V_1 -> V_73 -> V_78 -> V_102 , V_82 , V_1 -> V_22 . V_74 , V_268 ) ;
switch ( V_82 ) {
case 0x00 :
F_8 ( V_189 L_71 ,
V_1 -> V_1 -> V_18 ) ;
...
do {
V_280 = V_152 ;
V_281 = F_21 ( V_1 -> V_46 + V_48 ) ;
if ( V_281 & 2 ) {
F_55 ( V_1 ) ;
V_281 = F_21 ( V_1 -> V_46 + V_48 ) ;
}
if ( V_281 & 8 )
V_280 = F_83 ( V_1 , V_268 ) ;
if ( V_1 -> V_20 . V_161 )
F_56 ( V_1 ) ;
if ( V_280 == V_270 )
V_280 = F_35 ( V_1 ) ;
...
{
T_1 * V_1 = ( T_1 * ) V_73 -> V_78 -> V_1 -> V_283 ;
if ( ! F_87 ) {
F_45 ( L_87 ,
V_1 -> V_1 -> V_18 , V_73 ) ;
return - V_284 ;
...
static inline void F_91 ( struct V_148 * * V_286 ,
struct V_148 * * V_287 ,
int V_177 )
{
struct V_148 * V_73 = * V_286 ;
if ( V_73 ) {
* V_286 = NULL ;
V_73 -> V_177 = V_177 ;
V_73 -> V_191 ( V_73 ) ;
...
static enum V_288 F_92 ( T_1 * V_1 , struct V_148 * V_73 )
{
...
F_51 ( V_1 ) ;
F_20 ( V_1 ) ;
while ( ( V_299 = F_96 ( & V_1 -> V_150 . V_153 ) ) != NULL )
;
return V_297 ;
}
const
char * F_97 ( struct V_302 * V_1 )
{
static char string [ 100 ] , * V_303 ;
V_303 = string ;
V_303 += sprintf ( string , L_101
#ifdef F_69
L_102
#endif
#ifdef F_39
...
#endif
#if ( V_154 & V_204 )
L_104 F_98 ( V_205 ) L_105
#endif
, V_1 -> V_304 -> V_305 , V_1 -> V_306 , V_1 -> V_100 ,
V_307 , V_308 , V_309 ) ;
return string ;
}
static int F_99 ( struct V_310 * V_311 , struct V_302 * V_312 )
{
int V_313 ;
struct V_314 * V_315 ;
T_1 * V_1 ;
...
L_104 F_98 ( V_205 ) L_105
#endif
L_107 , V_307 , V_308 , V_309 ) ;
F_100 ( V_311 , L_108 ,
V_1 -> V_4 + V_5 , V_1 -> V_22 . V_100 ) ;
#ifdef F_23
F_100 ( V_311 , L_109 ,
V_1 -> V_4 + V_316 , V_1 -> V_22 . V_100 ) ;
#endif
F_100 ( V_311 , L_110
L_111
L_112
...
V_1 -> V_170 . V_277 , V_1 -> V_170 . V_295 ,
V_1 -> V_170 . V_300 ) ;
for ( V_313 = 0 ; V_313 < 9 ; V_313 ++ ) {
unsigned int V_317 , V_93 ;
F_100 ( V_311 , L_116 , V_313 == 8 ? 'H' : ( '0' + V_313 ) ) ;
V_317 = V_1 -> V_94 [ V_313 ] - 10 ;
if ( ( signed int ) V_317 < 0 )
V_317 += V_96 ;
V_93 = V_1 -> V_97 [ V_313 ] [ V_317 ] . V_98 ;
for (; V_317 != V_1 -> V_94 [ V_313 ] ; V_317 = ( V_317 + 1 ) & ( V_96 - 1 ) ) {
if ( V_1 -> V_97 [ V_313 ] [ V_317 ] . V_98 ) {
F_100 ( V_311 , L_117 ,
V_1 -> V_97 [ V_313 ] [ V_317 ] . V_100 ? '-' : ' ' ,
V_1 -> V_97 [ V_313 ] [ V_317 ] . V_101 ,
V_1 -> V_97 [ V_313 ] [ V_317 ] . V_82 ,
( V_1 -> V_97 [ V_313 ] [ V_317 ] . V_98 - V_93 ) < 100 ?
( V_1 -> V_97 [ V_313 ] [ V_317 ] . V_98 - V_93 ) : 99 ) ;
V_93 = V_1 -> V_97 [ V_313 ] [ V_317 ] . V_98 ;
}
}
}
...
F_101 (scd, instance) {
F_100 ( V_311 , L_119 ) ;
F_100 ( V_311 , L_120 , V_315 -> V_102 , V_315 -> V_169 ) ;
if ( V_315 -> V_318 )
F_100 ( V_311 , L_121 ,
V_315 -> V_166 ? L_122 : L_123 ,
V_315 -> V_167 ) ;
else
F_100 ( V_311 , L_124 ) ;
if ( V_1 -> V_78 [ V_315 -> V_102 ] . V_254 & 15 )
F_100 ( V_311 , L_125 ,
V_1 -> V_78 [ V_315 -> V_102 ] . V_254 & 15 ,
F_32 ( V_1 -> V_78 [ V_315 -> V_102 ] . V_254 ) ) ;
else
F_100 ( V_311 , L_126 ) ;
}
return 0 ;
}
static int F_102 ( struct V_319 * V_320 , const struct V_321 * V_102 )
{
struct V_302 * V_1 ;
T_1 * V_322 ;
int V_280 ;
...
if ( V_280 )
goto V_323;
V_1 = F_104 ( & V_324 , sizeof( T_1 ) ) ;
if ( ! V_1 ) {
V_280 = - V_325 ;
goto V_326;
}
V_322 = ( T_1 * ) V_1 -> V_283 ;
V_322 -> V_4 = F_105 ( V_320 , V_327 , 0 , 0 ) ;
V_322 -> V_46 = F_105 ( V_320 , V_328 , 0 , 0 ) ;
if ( ! V_322 -> V_4 || ! V_322 -> V_46 )
goto V_329;
V_1 -> V_100 = V_320 -> V_100 ;
V_322 -> V_1 = V_1 ;
V_322 -> V_22 . V_100 = V_1 -> V_100 ;
V_320 -> V_330 = V_322 -> V_46 + V_48 ;
V_320 -> V_331 = 0x0a ;
V_280 = F_106 ( V_1 -> V_100 , F_85 , 0 , L_127 , V_322 ) ;
if ( V_280 ) {
F_8 ( V_54 L_128 ,
V_1 -> V_18 , V_322 -> V_22 . V_100 , V_280 ) ;
goto V_329;
}
memset ( & V_322 -> V_170 , 0 , sizeof ( V_322 -> V_170 ) ) ;
F_107 ( & V_322 -> V_150 . V_151 ) ;
F_107 ( & V_322 -> V_150 . V_153 ) ;
F_108 ( & V_322 -> V_22 . V_225 ) ;
F_20 ( V_322 ) ;
V_280 = F_109 ( V_1 , & V_320 -> V_332 ) ;
if ( V_280 )
goto V_333;
F_110 ( V_1 ) ;
goto V_323;
V_333:
F_111 ( V_1 -> V_100 , V_322 ) ;
F_112 ( & V_322 -> V_22 . V_225 ) ;
F_113 ( & V_322 -> V_150 . V_153 ) ;
F_113 ( & V_322 -> V_150 . V_151 ) ;
V_329:
F_114 ( V_320 , V_322 -> V_46 ) ;
F_114 ( V_320 , V_322 -> V_4 ) ;
F_115 ( V_1 ) ;
V_326:
F_116 ( V_320 ) ;
V_323:
...
static void F_117 ( struct V_319 * V_320 )
{
struct V_302 * V_1 = F_118 ( V_320 ) ;
T_1 * V_322 = ( T_1 * ) V_1 -> V_283 ;
F_119 ( V_320 , NULL ) ;
F_120 ( V_1 ) ;
F_2 ( 0x80 , V_322 -> V_46 + V_47 ) ;
F_111 ( V_1 -> V_100 , V_322 ) ;
F_112 ( & V_322 -> V_22 . V_225 ) ;
F_113 ( & V_322 -> V_150 . V_153 ) ;
F_113 ( & V_322 -> V_150 . V_151 ) ;
