...
static inline int F_70 ( int V_118 , T_3 V_49 , struct V_119 * V_120 )
{
int V_30 = 0 ;
int V_121 ;
if ( V_118 & ( V_110 | V_122 ) )
V_120 -> V_49 = ( V_49 & V_68 ) | V_123 ;
else
V_120 -> V_49 = 0 ;
V_118 &= ~ V_124 & ~ V_125 ;
if ( V_118 & V_126 )
...
return - V_9 ;
V_121 = V_130 | F_71 ( V_118 ) ;
if ( ! ( V_121 & V_24 ) )
return - V_9 ;
} else if ( V_118 & V_94 ) {
V_118 &= V_131 | V_132 | V_94 ;
V_121 = 0 ;
} else {
V_121 = V_130 | F_71 ( V_118 ) ;
}
...
V_121 |= V_135 ;
V_120 -> V_121 = V_121 ;
V_120 -> V_136 = V_118 & V_94 ? 0 : V_137 ;
if ( V_118 & V_110 ) {
V_120 -> V_136 |= V_138 ;
if ( V_118 & V_111 )
V_120 -> V_136 |= V_139 ;
...
struct V_4 * F_72 ( struct V_141 * V_142 , int V_118 , T_3 V_49 )
{
struct V_119 V_120 ;
int V_143 = F_70 ( V_118 , V_49 , & V_120 ) ;
return V_143 ? F_68 ( V_143 ) : F_73 ( V_33 , V_142 , & V_120 ) ;
}
struct V_4 * F_74 ( const char * V_141 , int V_118 , T_3 V_49 )
{
struct V_141 V_142 = { . V_142 = V_141 } ;
return F_72 ( & V_142 , V_118 , V_49 ) ;
}
struct V_4 * F_75 ( struct V_1 * V_1 , struct V_144 * V_22 ,
const char * V_141 , int V_118 )
{
struct V_119 V_120 ;
int V_143 = F_70 ( V_118 , 0 , & V_120 ) ;
if ( V_143 )
return F_68 ( V_143 ) ;
if ( V_118 & V_110 )
return F_68 ( - V_9 ) ;
if ( ! V_141 && ( V_118 & V_131 ) )
if ( ! V_1 -> V_16 -> V_145 -> V_146 )
return F_68 ( - V_147 ) ;
return F_76 ( V_1 , V_22 , V_141 , & V_120 ) ;
}
long F_77 ( int V_148 , const char T_2 * V_141 , int V_118 , T_3 V_49 )
{
struct V_119 V_120 ;
int V_35 = F_70 ( V_118 , V_49 , & V_120 ) ;
struct V_141 * V_149 ;
if ( V_35 )
return V_35 ;
V_149 = F_78 ( V_141 ) ;
...
V_35 = F_80 ( V_118 ) ;
if ( V_35 >= 0 ) {
struct V_4 * V_37 = F_73 ( V_148 , V_149 , & V_120 ) ;
if ( F_66 ( V_37 ) ) {
F_81 ( V_35 ) ;
V_35 = F_79 ( V_37 ) ;
} else {
...
int F_85 ( struct V_4 * V_5 , T_8 V_150 )
{
int V_151 = 0 ;
if ( ! F_86 ( V_5 ) ) {
F_87 ( V_152 L_1 ) ;
