...
{
struct V_1 * V_1 = F_109 ( V_24 , struct V_1 , V_115 ) ;
int V_174 ;
F_112 ( V_1 ) ;
F_113 ( V_1 -> V_43 ) ;
F_114 ( 100 ) ;
...
int V_31 ;
int V_12 ;
V_1 = F_117 ( V_3 , sizeof( * V_1 ) , V_224 ) ;
if ( ! V_1 )
return NULL ;
F_118 ( & V_1 -> V_225 ) ;
F_118 ( & V_1 -> V_226 ) ;
...
static void F_128 ( struct V_219 * V_236 )
{
struct V_1 * V_1 ;
unsigned long V_41 ;
V_1 = F_109 ( V_236 , struct V_1 , V_237 . V_236 ) ;
F_26 ( & V_1 -> V_42 , V_41 ) ;
if ( V_1 -> V_59 & V_238 )
F_129 ( V_1 , false ) ;
F_30 ( & V_1 -> V_42 , V_41 ) ;
...
static int
F_130 ( struct V_2 * V_3 , int V_230 , void T_2 * V_239 )
{
int V_174 ;
struct V_1 * V_1 ;
...
if ( F_143 ( V_230 , V_1 -> V_250 , 0 , F_144 ( V_3 ) , V_1 ) ) {
F_102 ( V_3 , L_78 , V_230 ) ;
V_174 = - V_231 ;
goto V_261;
}
V_1 -> V_230 = V_230 ;
...
if ( V_174 < 0 )
goto V_269;
V_174 = F_152 ( & V_1 -> V_30 -> V_221 , & V_234 ) ;
if ( V_174 )
goto V_270;
F_7 ( V_1 -> V_30 ) ;
return 0 ;
