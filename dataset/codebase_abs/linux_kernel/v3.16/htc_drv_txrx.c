...
if ( V_8 -> V_198 & V_214 )
V_194 |= V_215 ;
if ( V_8 -> V_208 > 1 || V_8 -> V_198 & V_216 )
V_194 |= V_217 ;
return V_194 ;
#undef F_94
}
...
F_100 ( V_8 -> V_30 ) ;
F_96 ( V_8 ) ;
F_101 ( V_8 -> V_30 , F_102 ( V_219 , & V_29 -> V_220 ) ) ;
}
static inline void F_103 ( struct V_221 * V_222 ,
struct V_223 * V_224 )
{
V_222 -> V_225 = 0 ;
if ( V_224 -> V_226 & V_227 )
V_222 -> V_225 |= V_228 ;
if ( V_224 -> V_226 & V_229 )
V_222 -> V_225 |= V_230 ;
}
static void F_104 ( struct V_221 * V_222 ,
struct V_223 * V_224 )
{
V_222 -> V_231 = V_224 -> V_231 ;
V_222 -> V_232 = V_224 -> V_232 ;
V_222 -> V_233 = V_224 -> V_233 ;
V_222 -> V_234 = V_224 -> V_234 ;
V_222 -> V_235 = V_224 -> V_235 ;
V_222 -> V_236 = V_224 -> V_236 ;
V_222 -> V_237 = V_224 -> V_237 ;
V_222 -> V_238 = V_224 -> V_238 ;
memcpy ( V_222 -> V_239 , V_224 -> V_239 ,
sizeof( V_222 -> V_239 ) ) ;
memcpy ( V_222 -> V_240 , V_224 -> V_240 ,
sizeof( V_222 -> V_240 ) ) ;
V_222 -> V_241 = V_224 -> V_241 ;
V_222 -> V_242 = V_224 -> V_242 ;
V_222 -> V_243 = V_224 -> V_243 ;
F_103 ( V_222 , V_224 ) ;
}
...
V_224 = (struct V_223 * ) V_41 -> V_46 ;
if ( F_106 ( V_224 -> V_231 ) -
( V_41 -> V_99 - V_250 ) != 0 ) {
F_17 ( V_29 ,
L_10 ,
V_224 -> V_231 , V_41 -> V_99 ) ;
goto V_251;
}
memset ( V_247 , 0 , sizeof( struct V_246 ) ) ;
F_104 ( & V_222 , V_224 ) ;
F_107 ( V_8 , & V_222 ) ;
V_247 -> V_252 = F_108 ( V_224 -> V_253 ) ;
F_20 ( V_41 , V_250 ) ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
if ( ! F_109 ( V_29 , V_70 , V_247 , & V_222 ,
& V_249 , V_8 -> V_198 ) )
goto V_251;
F_110 ( V_29 , V_41 , & V_222 ,
V_247 , V_249 ) ;
if ( F_111 ( V_29 , V_15 , & V_222 , V_247 ) )
goto V_251;
V_222 . V_254 = F_112 ( V_29 , V_70 ) ;
F_113 ( V_29 , V_15 , & V_222 , V_247 ) ;
V_247 -> V_159 = V_30 -> V_255 -> V_158 -> V_159 ;
V_247 -> V_256 = V_30 -> V_255 -> V_158 -> V_257 ;
V_247 -> V_258 = V_222 . V_237 ;
V_247 -> V_225 |= V_259 ;
return true ;
V_251:
return false ;
...
{
struct V_7 * V_8 = (struct V_7 * ) V_46 ;
struct V_244 * V_245 = NULL , * V_260 = NULL ;
struct V_246 V_247 ;
struct V_40 * V_41 ;
unsigned long V_13 ;
struct V_69 * V_70 ;
do {
F_65 ( & V_8 -> V_261 . V_262 , V_13 ) ;
...
if ( V_245 == NULL ) {
F_68 ( & V_8 -> V_261 . V_262 , V_13 ) ;
break;
}
if ( ! V_245 -> V_41 )
goto V_264;
if ( ! F_105 ( V_8 , V_245 , & V_247 ) ) {
F_49 ( V_245 -> V_41 ) ;
goto V_264;
}
memcpy ( F_116 ( V_245 -> V_41 ) , & V_247 ,
sizeof( struct V_246 ) ) ;
V_41 = V_245 -> V_41 ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
if ( F_117 ( V_70 -> V_72 ) && V_8 -> V_265 )
F_118 ( V_8 -> V_15 , & V_8 -> V_266 ) ;
F_68 ( & V_8 -> V_261 . V_262 , V_13 ) ;
F_119 ( V_8 -> V_15 , V_41 ) ;
F_65 ( & V_8 -> V_261 . V_262 , V_13 ) ;
V_264:
V_245 -> V_263 = false ;
V_245 -> V_41 = NULL ;
F_120 ( & V_245 -> V_170 , & V_8 -> V_261 . V_245 ) ;
V_245 = NULL ;
F_68 ( & V_8 -> V_261 . V_262 , V_13 ) ;
} while ( 1 );
}
...
F_73 ( & V_8 -> V_261 . V_262 ) ;
if ( V_245 == NULL ) {
F_37 ( V_29 , V_267 , L_11 ) ;
goto V_268;
}
F_71 ( & V_8 -> V_261 . V_262 ) ;
V_245 -> V_41 = V_41 ;
...
{
int V_178 = 0 ;
F_124 ( & V_8 -> V_261 . V_245 ) ;
F_125 ( & V_8 -> V_261 . V_262 ) ;
for ( V_178 = 0 ; V_178 < V_271 ; V_178 ++ ) {
struct V_244 * V_245 =
F_70 ( sizeof( struct V_244 ) , V_272 ) ;
if ( V_245 == NULL )
goto V_268;
F_72 ( & V_245 -> V_170 , & V_8 -> V_261 . V_245 ) ;
}
return 0 ;
V_268:
F_122 ( V_8 ) ;
