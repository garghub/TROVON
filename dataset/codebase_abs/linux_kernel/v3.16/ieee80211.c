...
V_91 = V_87 [ V_94 ] ;
if ( ( V_91 == V_55 ) &&
( ! memcmp ( & V_87 [ V_94 + 2 ] , & V_93 [ 0 ] , 4 ) ) ) {
memcpy ( V_77 , & V_87 [ V_94 ] , V_87 [ V_94 + 1 ] + 2 ) ;
* V_90 = V_87 [ V_94 + 1 ] + 2 ;
V_94 += V_87 [ V_94 + 1 ] + 2 ;
} else {
if ( V_91 == V_58 ) {
memcpy ( V_86 , & V_87 [ V_94 ] ,
V_87 [ V_94 + 1 ] + 2 ) ;
* V_89 = V_87 [ V_94 + 1 ] + 2 ;
V_94 += V_87 [ V_94 + 1 ] + 2 ;
} else
...
int F_17 ( T_2 * V_87 , T_1 V_88 , T_2 * V_98 , T_1 * V_99 )
{
int V_100 ;
T_1 V_94 ;
...
V_101 = V_87 [ V_94 ] ;
if ( ( V_101 == V_55 ) &&
( ! memcmp ( & V_87 [ V_94 + 2 ] , V_102 , 4 ) ) ) {
memcpy ( V_98 , & V_87 [ V_94 ] , V_87 [ V_94 + 1 ] + 2 ) ;
* V_99 = V_87 [ V_94 + 1 ] + 2 ;
V_94 += V_87 [ V_94 + 1 ] + 2 ;
V_100 = true ;
break;
