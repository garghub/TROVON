...
return - V_8 ;
if ( V_7 -> V_16 . V_85 )
return snprintf ( V_5 , 5 , L_35 ) ;
else
return snprintf ( V_5 , 8 , L_36 ) ;
}
...
V_9 = 1 ;
V_22 = F_18 ( & V_78 , L_17 ) ;
if ( ! strcmp ( V_22 , L_37 ) && ! V_7 -> V_16 . V_85 ) {
if ( V_9 ) {
if ( F_39 ( V_7 ,
V_86 ) ) {
V_24 = F_40 ( V_7 , V_87 ) ;
...
V_7 -> V_16 . V_85 = 1 ;
} else if ( ! strcmp ( V_22 , L_38 ) && V_7 -> V_16 . V_85 ) {
if ( V_9 ) {
V_24 = F_40 ( V_7 , V_88 ) ;
if ( ! V_24 )
V_7 -> V_16 . V_85 = 0 ;
...
V_7 -> V_16 . V_85 = 0 ;
} else if ( ! strcmp ( V_22 , L_39 ) && V_9 && V_7 -> V_16 . V_85 )
V_24 = F_40 ( V_7 , V_89 ) ;
else
V_24 = - V_8 ;
F_14 ( & V_7 -> V_25 ) ;
...
static T_1 F_41 ( char * V_5 , struct V_6 * V_7 , int V_90 )
{
if ( ! V_7 )
return - V_8 ;
return sprintf ( V_5 , L_15 , V_90 ) ;
}
static T_1 F_42 ( struct V_6 * V_7 ,
const char * V_5 , T_2 V_21 , int * V_90 , int V_91 )
{
char * V_22 ;
int V_33 , V_24 = 0 ;
if ( ! V_7 )
...
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
return F_41 ( V_5 , V_7 , V_7 -> V_16 . V_92 . V_93 ) ;
}
...
& V_7 -> V_16 . V_92 . V_93 , 5000 ) ;
}
static T_1 F_45 ( struct V_1 * V_2 ,
struct V_3 * V_4 , char * V_5 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
return F_41 ( V_5 , V_7 , V_7 -> V_16 . V_92 . V_94 ) ;
}
