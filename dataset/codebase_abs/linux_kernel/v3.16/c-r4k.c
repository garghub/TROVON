...
unsigned int V_138 = F_108 () ;
unsigned int V_139 = F_109 () ;
unsigned long V_140 ;
unsigned int V_141 ;
switch ( F_30 () ) {
case V_142 :
...
V_127 -> V_26 . V_31 = 2 ;
V_127 -> V_26 . V_29 = F_110 ( V_115 / 2 ) ;
V_114 = 1 << ( 12 + ( ( V_138 & V_149 ) >> 6 ) ) ;
V_127 -> V_134 . V_147 = 16 << ( ( V_138 & V_150 ) >> 4 ) ;
V_127 -> V_134 . V_31 = 2 ;
V_127 -> V_134 . V_29 = F_110 ( V_114 / 2 ) ;
V_127 -> V_151 |= V_152 ;
break;
case V_153 :
case V_154 :
...
V_127 -> V_26 . V_147 = 16 << ( ( V_138 & V_148 ) >> 5 ) ;
V_127 -> V_26 . V_31 = 4 ;
V_127 -> V_26 . V_29 = F_110 ( V_115 / V_127 -> V_26 . V_31 ) ;
V_114 = 1 << ( 12 + ( ( V_138 & V_149 ) >> 6 ) ) ;
V_127 -> V_134 . V_147 = 16 << ( ( V_138 & V_150 ) >> 4 ) ;
V_127 -> V_134 . V_31 = 4 ;
V_127 -> V_134 . V_29 = F_110 ( V_114 / V_127 -> V_134 . V_31 ) ;
V_127 -> V_151 |= V_152 ;
V_127 -> V_151 |= V_155 ;
break;
case V_42 :
...
case V_194 :
case V_195 :
if ( ( V_127 -> V_196 == V_189 ) || ( V_127 -> V_196 == V_191 ) )
F_102 ( V_127 ) ;
if ( ! ( F_114 () & V_197 ) &&
...
static int T_6 F_135 ( char * V_228 )
{
F_136 ( & V_228 , & V_229 ) ;
return 0 ;
}
...
extern char __weak V_234 ;
switch ( F_30 () ) {
case V_181 :
case V_182 :
F_142 ( 0x100 , & V_234 , 0x80 ) ;
break;
default:
F_142 ( 0x100 , & V_233 , 0x80 ) ;
break;
}
}
void F_143 ( void )
...
static int F_146 ( struct V_259 * V_260 , unsigned long V_261 ,
void * V_262 )
{
switch ( V_261 ) {
case V_263 :
