...
int F_48 ( struct V_1 * V_2 , const T_2 * V_124 )
{
T_4 V_76 = 0 , V_77 = 0 ;
int V_56 = 1000 ;
int V_62 ;
...
int F_49 ( struct V_1 * V_2 , const T_2 * V_124 )
{
T_4 V_76 = 0 , V_77 = 0 ;
int V_56 = 1000 ;
int V_62 ;
...
struct V_156 * F_73 ( struct V_1 * V_2 )
{
return V_2 -> V_49 ;
}
int F_74 ( struct V_1 * V_2 , T_2 * V_159 , T_3 V_14 )
{
T_4 V_76 , V_77 = V_14 ;
int V_56 = 1000 ;
T_6 V_160 ;
...
int F_75 ( struct V_1 * V_2 , int V_164 )
{
T_4 V_76 , V_77 = 0 ;
int V_56 = 1000 ;
V_76 = ( V_164 ? V_165 : 0 ) ;
...
static int F_76 ( struct V_1 * V_2 , enum V_54 V_55 ,
int * V_61 )
{
...
{
return F_76 ( V_2 , V_166 , V_61 ) ;
}
int F_78 ( struct V_1 * V_2 , int * V_61 )
{
return F_76 ( V_2 , V_143 , V_61 ) ;
}
int F_79 ( struct V_1 * V_2 , T_2 * V_110 )
{
T_4 V_76 , V_77 ;
int V_56 = 1000 ;
int V_59 ;
