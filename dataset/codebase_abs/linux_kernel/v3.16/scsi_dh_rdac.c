...
F_6 ( V_10 ) ;
if ( V_8 && F_7 ( V_12 , V_10 , V_7 , V_8 , V_13 ) ) {
F_8 ( V_10 ) ;
F_5 ( V_14 , V_3 ,
L_2 ) ;
return NULL ;
...
static struct V_6 * F_9 ( struct V_2 * V_3 ,
...
V_10 -> V_55 = F_11 ( V_10 -> V_52 [ 0 ] ) ;
V_10 -> V_56 = V_23 -> V_56 ;
memset ( V_10 -> V_56 , 0 , V_57 ) ;
V_10 -> V_58 = 0 ;
return V_10 ;
}
static void F_12 ( struct V_59 * V_59 )
{
struct V_60 * V_32 ;
V_32 = F_13 ( V_59 , struct V_60 , V_59 ) ;
F_14 ( & V_32 -> V_61 ) ;
F_15 ( V_32 ) ;
}
