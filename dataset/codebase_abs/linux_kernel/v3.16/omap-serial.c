...
static void F_35 ( struct V_21 * V_4 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned long V_34 ;
F_17 ( V_2 -> V_14 ) ;
...
F_38
( & V_2 -> V_4 , V_66 & V_77 ) ;
F_39 ( & V_2 -> V_4 . V_52 -> V_4 . V_78 ) ;
}
return V_66 ;
}
static void F_40 ( struct V_1 * V_2 , unsigned int V_49 )
{
unsigned int V_79 ;
...
#endif
F_44 ( & V_2 -> V_4 , V_49 , V_93 , 0 , V_79 ) ;
}
static void F_45 ( struct V_1 * V_2 , unsigned int V_49 )
{
unsigned char V_80 = 0 ;
unsigned int V_79 ;
if ( ! ( V_49 & V_48 ) )
...
V_79 = V_83 ;
V_2 -> V_4 . V_56 . V_82 ++ ;
if ( F_46 ( & V_2 -> V_4 , V_80 ) )
return;
F_44 ( & V_2 -> V_4 , V_49 , V_93 , V_80 , V_79 ) ;
}
static T_1 F_47 ( int V_98 , void * V_99 )
{
struct V_1 * V_2 = V_99 ;
...
static void F_54 ( struct V_21 * V_4 , int V_139 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned long V_34 = 0 ;
...
static int F_55 ( struct V_21 * V_4 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned long V_34 = 0 ;
int V_143 ;
V_143 = F_56 ( V_2 -> V_4 . V_98 , F_47 , V_2 -> V_4 . V_144 ,
V_2 -> V_145 , V_2 ) ;
if ( V_143 )
return V_143 ;
if ( V_2 -> V_18 ) {
V_143 = F_56 ( V_2 -> V_18 , F_47 ,
V_2 -> V_4 . V_144 , V_2 -> V_145 , V_2 ) ;
if ( V_143 ) {
F_57 ( V_2 -> V_4 . V_98 , V_2 ) ;
return V_143 ;
}
F_58 ( V_2 -> V_18 ) ;
}
...
static void F_59 ( struct V_21 * V_4 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned long V_34 = 0 ;
...
static void F_60 ( struct V_153 * V_154 )
{
struct V_1 * V_2 = F_61 ( V_154 , struct V_1 ,
V_155 ) ;
F_62 ( & V_2 -> V_156 , V_2 -> V_157 ) ;
}
static void
F_63 ( struct V_21 * V_4 , struct V_158 * V_159 ,
struct V_158 * V_160 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
...
V_161 |= V_179 ;
V_22 = F_64 ( V_4 , V_159 , V_160 , 0 , V_4 -> V_24 / 13 ) ;
V_162 = F_13 ( V_4 , V_22 ) ;
...
static void
F_69 ( struct V_21 * V_4 , unsigned int V_52 ,
unsigned int V_235 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned char V_201 ;
...
static void F_73 ( struct V_21 * V_4 )
{
F_16 ( V_4 -> V_14 , L_10 ) ;
}
static int F_74 ( struct V_21 * V_4 )
{
F_16 ( V_4 -> V_14 , L_11 ) ;
return 0 ;
}
static void F_75 ( struct V_21 * V_4 , int V_34 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
...
static int
F_76 ( struct V_21 * V_4 , struct V_238 * V_239 )
{
F_16 ( V_4 -> V_14 , L_13 ) ;
return - V_16 ;
}
static const char *
F_77 ( struct V_21 * V_4 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
...
static void F_80 ( struct V_21 * V_4 , unsigned char V_80 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
F_17 ( V_2 -> V_14 ) ;
F_78 ( V_2 ) ;
...
static int F_81 ( struct V_21 * V_4 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned int V_66 ;
F_17 ( V_2 -> V_14 ) ;
...
static void F_82 ( struct V_21 * V_4 , int V_80 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
F_78 ( V_2 ) ;
F_3 ( V_2 , V_55 , V_80 ) ;
...
V_251 = F_85 ( & V_2 -> V_4 . V_65 ) ;
else
F_48 ( & V_2 -> V_4 . V_65 ) ;
V_29 = F_1 ( V_2 , V_31 ) ;
F_3 ( V_2 , V_31 , 0 ) ;
F_86 ( & V_2 -> V_4 , V_249 , V_53 , F_82 ) ;
F_78 ( V_2 ) ;
F_3 ( V_2 , V_31 , V_29 ) ;
if ( V_2 -> V_68 )
F_36 ( V_2 ) ;
...
if ( V_254 )
F_89 ( V_254 , & V_22 , & V_90 , & V_255 , & V_256 ) ;
return F_90 ( & V_2 -> V_4 , V_248 , V_22 , V_90 , V_255 , V_256 ) ;
}
...
{}
static void
F_92 ( struct V_21 * V_4 , struct V_258 * V_259 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned long V_34 ;
unsigned int V_28 ;
...
static int
F_94 ( struct V_21 * V_4 , unsigned int V_261 , unsigned long V_262 )
{
struct V_258 V_259 ;
switch ( V_261 ) {
case V_263 :
if ( F_95 ( & V_259 , ( void V_264 * ) V_262 ,
sizeof( V_259 ) ) )
return - V_265 ;
F_92 ( V_4 , & V_259 ) ;
break;
case V_266 :
if ( F_96 ( ( void V_264 * ) V_262 ,
& ( F_15 ( V_4 ) -> V_33 ) ,
sizeof( V_259 ) ) )
return - V_265 ;
break;
...
static int F_97 ( struct V_268 * V_14 )
{
struct V_1 * V_2 = F_98 ( V_14 ) ;
V_2 -> V_269 = true ;
return 0 ;
}
static void F_99 ( struct V_268 * V_14 )
{
struct V_1 * V_2 = F_98 ( V_14 ) ;
V_2 -> V_269 = false ;
}
static int F_100 ( struct V_268 * V_14 )
{
struct V_1 * V_2 = F_98 ( V_14 ) ;
F_101 ( & V_270 , & V_2 -> V_4 ) ;
F_102 ( & V_2 -> V_155 ) ;
...
static int F_103 ( struct V_268 * V_14 )
{
struct V_1 * V_2 = F_98 ( V_14 ) ;
if ( F_70 ( V_14 ) )
F_11 ( V_2 , false ) ;
...
V_271 = F_106 ( V_2 -> V_4 . V_6 + ( V_276 << V_2 -> V_4 . V_5 ) ) ;
V_272 = V_271 >> V_277 ;
switch ( V_272 ) {
case 0 :
V_274 = ( V_271 & V_278 ) >>
...
static struct V_12 * F_109 ( struct V_268 * V_14 )
{
struct V_12 * V_288 ;
V_288 = F_110 ( V_14 , sizeof( * V_288 ) , V_289 ) ;
if ( ! V_288 )
return NULL ;
F_111 ( V_14 -> V_290 , L_16 ,
& V_288 -> V_24 ) ;
return V_288 ;
}
...
V_259 -> V_34 |= V_39 ;
V_2 -> V_40 = F_114 ( V_292 , L_18 , 0 , & V_34 ) ;
if ( F_93 ( V_2 -> V_40 ) ) {
V_101 = F_115 ( V_2 -> V_14 , V_2 -> V_40 , L_19 ) ;
if ( V_101 < 0 )
return V_101 ;
V_101 = F_116 ( V_2 -> V_40 ,
V_34 & V_39 ) ;
if ( V_101 < 0 )
return V_101 ;
...
static int F_118 ( struct V_296 * V_297 )
{
...
int V_101 ;
if ( V_297 -> V_14 . V_290 ) {
V_301 = F_119 ( V_297 -> V_14 . V_290 , 0 ) ;
if ( ! V_301 )
return - V_295 ;
V_18 = F_119 ( V_297 -> V_14 . V_290 , 1 ) ;
V_288 = F_109 ( & V_297 -> V_14 ) ;
...
V_2 = F_110 ( & V_297 -> V_14 , sizeof( * V_2 ) , V_289 ) ;
if ( ! V_2 )
return - V_303 ;
V_299 = F_121 ( V_297 , V_304 , 0 ) ;
V_300 = F_122 ( & V_297 -> V_14 , V_299 ) ;
if ( F_123 ( V_300 ) )
return F_124 ( V_300 ) ;
V_2 -> V_14 = & V_297 -> V_14 ;
...
V_2 -> V_18 = V_18 ;
if ( ! V_2 -> V_18 )
F_125 ( V_2 -> V_4 . V_14 , L_23 ,
V_2 -> V_4 . line ) ;
V_2 -> V_4 . V_5 = 2 ;
V_2 -> V_4 . V_58 = 64 ;
V_2 -> V_4 . V_307 = & V_308 ;
if ( V_297 -> V_14 . V_290 )
V_2 -> V_4 . line = F_126 ( V_297 -> V_14 . V_290 , L_24 ) ;
else
V_2 -> V_4 . line = V_297 -> V_309 ;
if ( V_2 -> V_4 . line < 0 ) {
F_127 ( & V_297 -> V_14 , L_25 ,
V_2 -> V_4 . line ) ;
V_101 = - V_257 ;
goto V_310;
}
V_101 = F_112 ( V_2 , V_297 -> V_14 . V_290 ) ;
if ( V_101 < 0 )
goto V_311;
...
V_311:
V_310:
F_127 ( & V_297 -> V_14 , L_28 ,
V_297 -> V_309 , V_320 , V_101 ) ;
return V_101 ;
}
static int F_139 ( struct V_296 * V_14 )
{
struct V_1 * V_2 = F_140 ( V_14 ) ;
F_141 ( V_2 -> V_14 ) ;
F_138 ( V_2 -> V_14 ) ;
F_142 ( & V_270 , & V_2 -> V_4 ) ;
F_143 ( & V_2 -> V_156 ) ;
F_131 ( & V_14 -> V_14 , false ) ;
return 0 ;
}
static void F_68 ( struct V_1 * V_2 , T_6 V_184 )
{
T_6 V_321 = 255 ;
F_3 ( V_2 , V_213 , V_184 ) ;
F_79 ( 2 ) ;
...
static int F_146 ( struct V_268 * V_14 )
{
struct V_1 * V_2 = F_98 ( V_14 ) ;
if ( ! V_2 )
return - V_16 ;
...
static int F_148 ( struct V_268 * V_14 )
{
struct V_1 * V_2 = F_98 ( V_14 ) ;
int V_325 = F_6 ( V_2 ) ;
F_11 ( V_2 , false ) ;
