...
if ( F_62 ( V_33 -> V_325 , V_29 , V_28 -> V_47 ) ) {
V_292 = - V_326 ;
goto V_324;
}
...
if ( V_33 -> V_327 <= V_328 ) {
if ( F_64 ( V_29 , V_33 -> V_325 , V_33 -> V_327 ) )
V_292 = - V_326 ;
} else {
V_292 = - V_329 ;
}
...
T_7 V_339 [ V_340 ] ;
T_7 V_341 [ 64 ] ;
T_10 V_342 = 0 , V_343 = 0 ;
T_7 V_344 [ 64 ] ;
int V_292 = 0 ;
F_9 ( L_66 ) ;
V_333 = F_66 ( sizeof( * V_333 ) , V_220 ) ;
if ( V_333 == NULL )
return - V_221 ;
switch ( V_331 -> V_345 ) {
case V_346 :
...
T_1 V_4 = ( T_1 ) F_2 ( V_3 ) ;
T_2 V_33 = & ( V_4 -> V_34 ) ;
struct V_362 * V_363 = (struct V_362 * ) V_29 ;
int V_292 = 0 ;
