...
struct V_150 * V_162 = V_110 -> V_114 . V_104 ;
struct V_163 * V_164 = V_162 -> V_154 -> V_155 -> V_165 ;
T_6 V_166 = V_102 / V_117 ;
struct V_99 * V_99 ;
T_3 V_167 = F_53 ( V_162 -> V_154 -> V_155 ) ;
if ( V_102 >= V_167 ) {
* V_161 = true ;
F_3 ( L_13 , V_6 , V_166 ) ;
return F_54 ( 0 ) ;
}
V_99 = F_55 ( V_164 , V_166 ) ;
if ( ! V_99 ) {
V_99 = F_56 ( V_164 , V_166 , V_168 ) ;
if ( F_16 ( ! V_99 ) ) {
F_3 ( L_14 ,
V_6 , V_166 ) ;
return NULL ;
...
* V_161 = F_60 ( V_99 ) ;
F_3 ( L_15 , V_6 , V_166 , * V_161 ) ;
return V_99 ;
}
static void F_61 ( void * V_160 , struct V_99 * V_99 )
{
F_3 ( L_16 , V_6 ,
( V_99 == F_54 ( 0 ) ) ? - 1UL : V_99 -> V_166 ) ;
if ( F_54 ( 0 ) != V_99 )
F_62 ( V_99 ) ;
return;
}
int F_63 ( struct V_150 * V_162 , int V_169 )
{
struct V_152 * V_153 = V_162 -> V_154 ;
struct V_105 * V_110 ;
int V_108 ;
V_108 = F_35 ( F_48 ( V_153 -> V_155 ) -> V_77 , false ,
V_153 -> V_19 , V_162 -> args . V_100 , V_162 -> args . V_101 ,
V_162 -> args . V_102 , V_162 -> args . V_103 , V_162 , V_168 ,
& V_110 ) ;
if ( F_16 ( V_108 ) )
return V_108 ;
V_110 -> V_119 = 0 != ( V_169 & V_170 ) ;
V_110 -> V_107 -> V_171 = & V_172 ;
if ( ! V_110 -> V_119 )
V_110 -> V_107 -> V_157 = F_50 ;
F_3 ( L_12 , V_6 ,
V_162 -> args . V_102 , V_162 -> args . V_103 ) ;
...
static T_2 F_65 ( struct V_173 * V_174 ,
struct V_175 * V_176 , struct V_175 * V_177 )
{
unsigned int V_178 ;
V_178 = F_66 ( V_174 , V_176 , V_177 ) ;
if ( ! V_178 || V_174 -> V_179 + V_177 -> V_180 >
( unsigned long ) V_174 -> V_181 )
return 0 ;
return F_67 ( V_178 , V_177 -> V_180 ) ;
}
static void F_68 ( struct V_173 * V_174 , struct V_175 * V_177 )
{
F_69 ( V_174 , V_177 ) ;
if ( F_16 ( V_174 -> V_182 == NULL ) )
return;
V_174 -> V_181 = ( void * )
F_12 ( V_174 -> V_182 ) -> V_77 . V_183 ;
}
static bool F_70 ( T_4 V_102 , struct V_184 * V_77 ,
unsigned long * V_185 )
{
T_7 V_186 ;
unsigned V_187 ;
...
F_71 ( V_102 , V_187 , & V_186 ) ;
if ( ! V_186 )
return true ;
* V_185 = V_187 - V_186 ;
return false ;
}
static void F_72 ( struct V_173 * V_174 , struct V_175 * V_177 )
{
unsigned long V_185 = 0 ;
T_4 V_190 ;
if ( V_174 -> V_191 == NULL )
V_190 = F_53 ( V_174 -> V_192 ) - F_73 ( V_177 ) ;
else
V_190 = F_74 ( V_174 -> V_191 ) ;
F_75 ( V_174 , V_177 , V_190 ) ;
if ( F_16 ( V_174 -> V_182 == NULL ) )
return;
if ( V_177 -> V_193 ||
! F_70 ( V_177 -> V_194 * V_117 ,
& F_12 ( V_174 -> V_182 ) -> V_77 ,
& V_185 ) ) {
V_174 -> V_181 = ( void * ) V_185 ;
} else {
V_174 -> V_181 = ( void * )
F_12 ( V_174 -> V_182 ) -> V_77 . V_183 ;
}
