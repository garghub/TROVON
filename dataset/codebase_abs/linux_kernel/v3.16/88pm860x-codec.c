...
static struct V_133 * F_40 ( struct V_134 * V_112 )
{
struct V_60 * V_61 = F_41 ( V_112 ) ;
return V_61 -> V_133 ;
}
static int F_42 ( struct V_135 * V_136 )
{
struct V_137 * V_138 = F_41 ( V_136 -> V_112 . V_139 ) ;
struct V_60 * V_61 ;
struct V_140 * V_141 ;
int V_15 , V_62 ;
V_61 = F_43 ( & V_136 -> V_112 , sizeof( struct V_60 ) ,
V_142 ) ;
if ( V_61 == NULL )
return - V_143 ;
V_61 -> V_138 = V_138 ;
V_61 -> V_91 = ( V_138 -> V_144 == V_145 ) ? V_138 -> V_146
: V_138 -> V_147 ;
V_61 -> V_133 = ( V_138 -> V_144 == V_145 ) ? V_138 -> V_133
: V_138 -> V_148 ;
F_44 ( V_136 , V_61 ) ;
for ( V_15 = 0 ; V_15 < 4 ; V_15 ++ ) {
V_141 = F_45 ( V_136 , V_149 , V_15 ) ;
if ( ! V_141 ) {
F_37 ( & V_136 -> V_112 , L_6 ) ;
return - V_22 ;
}
V_61 -> V_94 [ V_15 ] = V_141 -> V_150 + V_138 -> V_151 ;
strncpy ( V_61 -> V_36 [ V_15 ] , V_141 -> V_36 , V_152 ) ;
}
V_62 = F_46 ( & V_136 -> V_112 , & V_153 ,
V_154 , F_4 ( V_154 ) ) ;
if ( V_62 ) {
F_37 ( & V_136 -> V_112 , L_7 ) ;
return - V_22 ;
}
return V_62 ;
}
