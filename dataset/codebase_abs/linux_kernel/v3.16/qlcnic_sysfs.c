...
static T_2 F_58 ( struct V_53 * V_53 ,
struct V_55 * V_56 ,
struct V_57 * V_10 ,
char * V_11 , T_6 V_47 ,
T_3 V_48 )
...
V_14 = F_52 ( V_2 , V_83 , V_67 ) ;
if ( V_14 )
return V_14 ;
for ( V_60 = 0 ; V_60 < V_67 ; V_60 ++ ) {
if ( V_2 -> V_16 -> V_45 == V_88 )
if ( F_59 ( V_2 , & V_83 [ V_60 ] ) )
return V_40 ;
...
if ( F_45 ( V_2 , V_59 ) < 0 )
return V_40 ;
if ( ! F_66 ( V_103 [ V_60 ] . V_104 ) ||
! F_66 ( V_103 [ V_60 ] . V_105 ) )
return V_40 ;
}
return 0 ;
}
...
V_14 = F_65 ( V_2 , V_103 , V_67 ) ;
if ( V_14 )
return V_14 ;
for ( V_60 = 0 ; V_60 < V_67 ; V_60 ++ ) {
V_59 = V_103 [ V_60 ] . V_59 ;
memset ( & V_107 , 0 , sizeof( struct V_106 ) ) ;
V_14 = F_68 ( V_2 , & V_107 , V_59 ) ;
if ( V_14 )
return V_14 ;
V_107 . V_59 = V_59 ;
...
return V_40 ;
memset ( & V_118 , 0 , V_48 ) ;
V_14 = F_72 ( V_2 , V_47 , V_120 ,
& V_118 . V_121 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_72 ( V_2 , V_47 , V_122 ,
& V_118 . V_123 ) ;
if ( V_14 )
return V_14 ;
...
static T_2 F_73 ( struct V_53 * V_53 ,
struct V_55 * V_56 ,
struct V_57 * V_10 ,
char * V_11 , T_6 V_47 ,
T_3 V_48 )
...
return V_40 ;
memset ( & V_124 , 0 , V_48 ) ;
V_14 = F_74 ( V_2 , V_47 , V_120 ,
& V_124 . V_121 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_74 ( V_2 , V_47 , V_122 ,
& V_124 . V_123 ) ;
if ( V_14 )
return V_14 ;
...
static T_2 F_75 ( struct V_53 * V_53 ,
struct V_55 * V_56 ,
struct V_57 * V_10 ,
char * V_11 , T_6 V_47 ,
T_3 V_48 )
...
int V_60 , V_14 ;
T_1 V_67 ;
V_131 = F_79 ( V_48 , sizeof( * V_131 ) , V_132 ) ;
if ( ! V_131 )
return - V_133 ;
V_14 = F_80 ( V_2 , V_131 ) ;
if ( V_14 ) {
...
static T_2 F_82 ( struct V_53 * V_54 ,
struct V_55 * V_56 ,
struct V_57 * V_10 ,
char * V_11 , T_6 V_47 ,
T_3 V_48 )
...
if ( V_48 % sizeof( T_1 ) )
V_67 ++ ;
V_142 = F_79 ( V_48 , sizeof( unsigned char ) , V_132 ) ;
if ( ! V_142 )
return - V_133 ;
if ( F_83 ( V_2 ) != 0 ) {
F_81 ( V_142 ) ;
...
V_143 = F_79 ( V_48 , sizeof( unsigned char ) , V_132 ) ;
if ( ! V_143 )
return - V_133 ;
...
static T_2 F_92 ( struct V_53 * V_54 ,
struct V_55 * V_56 ,
struct V_57 * V_10 ,
char * V_11 , T_6 V_47 ,
T_3 V_48 )
...
static T_2 F_94 ( struct V_7 * V_8 ,
struct V_9 * V_156 ,
char * V_11 )
{
struct V_1 * V_2 = F_4 ( V_8 ) ;
...
if ( F_31 ( V_2 ) )
V_158 = F_54 ( V_2 -> V_16 , V_159 ) ;
else if ( F_30 ( V_2 ) )
V_158 = F_95 ( V_2 , V_160 ) ;
V_157 = F_96 ( V_158 ) ;
V_157 *= 1000 ;
