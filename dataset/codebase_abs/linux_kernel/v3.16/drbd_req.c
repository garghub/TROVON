...
V_90 = V_136 ;
F_68 ( V_2 ) ;
V_4 -> V_33 . V_113 = V_137 ;
F_67 ( & F_44 ( V_2 ) -> V_50 -> V_51 ,
& V_4 -> V_33 ) ;
break;
case V_138 :
if ( ! ( V_4 -> V_22 & V_24 ) && ! V_4 -> V_33 . V_113 ) {
F_50 ( V_4 , V_56 , V_65 , 0 ) ;
break;
}
if ( ! ( V_4 -> V_22 & V_43 ) ) {
...
F_67 ( & F_44 ( V_2 ) -> V_50 -> V_51 ,
& V_4 -> V_33 ) ;
V_90 = V_4 -> V_22 & V_24 ? V_136 : V_135 ;
}
break;
}
case V_139 :
...
return true ;
if ( V_2 -> V_146 . V_147 != V_149 )
return false ;
V_144 = V_26 + ( V_13 >> 9 ) - 1 ;
V_145 = F_70 ( V_2 -> V_150 ) ;
F_47 ( V_2 , V_26 < V_145 ) ;
F_47 ( V_2 , V_144 < V_145 ) ;
V_142 = F_71 ( V_26 ) ;
V_143 = F_71 ( V_144 ) ;
return F_72 ( V_2 , V_142 , V_143 ) == 0 ;
}
...
switch ( V_152 ) {
case V_156 :
V_154 = & V_2 -> V_83 -> V_84 -> V_157 -> V_158 -> V_153 ;
return F_74 ( V_154 ) ;
case V_159 :
return F_20 ( & V_2 -> V_160 ) >
F_20 ( & V_2 -> V_161 ) + F_20 ( & V_2 -> V_162 ) ;
case V_163 :
case V_164 :
case V_165 :
case V_166 :
case V_167 :
case V_168 :
V_155 = ( V_152 - V_163 + 15 ) ;
return ( V_26 >> ( V_155 - 9 ) ) & 1 ;
case V_169 :
return F_75 ( V_170 , & V_2 -> V_112 ) ;
case V_171 :
return true ;
case V_172 :
default:
...
return;
for (; ; ) {
F_79 ( & V_2 -> V_60 , & V_173 , V_174 ) ;
V_12 = F_78 ( & V_2 -> V_67 , V_26 , V_13 ) ;
if ( ! V_12 )
break;
V_12 -> V_31 = true ;
F_80 ( & V_2 -> V_175 -> V_176 ) ;
F_81 () ;
F_82 ( & V_2 -> V_175 -> V_176 ) ;
}
F_83 ( & V_2 -> V_60 , & V_173 ) ;
}
...
return;
if ( V_88 -> V_182 &&
F_20 ( & V_2 -> V_78 ) >= V_88 -> V_182 ) {
F_85 ( V_2 , L_12 ) ;
V_177 = true ;
}
if ( V_2 -> V_183 -> V_184 >= V_88 -> V_185 ) {
F_85 ( V_2 , L_13 ) ;
V_177 = true ;
}
if ( V_177 ) {
F_33 ( F_44 ( V_2 ) -> V_50 ) ;
if ( V_179 == V_186 )
F_86 ( F_87 ( V_2 , V_187 , V_188 ) , 0 , NULL ) ;
else
F_86 ( F_87 ( V_2 , V_187 , V_189 ) , 0 , NULL ) ;
}
F_27 ( V_2 ) ;
}
...
if ( V_2 -> V_146 . V_190 != V_148 )
return false ;
if ( V_4 -> V_66 == NULL )
return true ;
F_61 () ;
V_152 = F_62 ( V_2 -> V_83 -> V_191 ) -> V_192 ;
F_63 () ;
if ( V_152 == V_172 && V_4 -> V_66 )
return false ;
if ( F_73 ( V_2 , V_4 -> V_12 . V_26 , V_152 ) ) {
if ( V_4 -> V_66 ) {
F_89 ( V_4 -> V_66 ) ;
V_4 -> V_66 = NULL ;
F_27 ( V_2 ) ;
...
struct V_1 * V_2 = V_4 -> V_2 ;
int V_193 , V_194 ;
V_193 = F_91 ( V_2 -> V_146 ) ;
V_194 = F_92 ( V_2 -> V_146 ) ;
if ( F_93 ( V_4 -> V_12 . V_13 == 0 ) ) {
F_47 ( V_2 , V_4 -> V_6 -> V_195 & V_196 ) ;
if ( V_193 )
F_94 ( V_4 , V_141 ) ;
return V_193 ;
}
...
{
F_99 ( & V_2 -> V_201 . V_202 ) ;
F_100 ( & V_4 -> V_32 , & V_2 -> V_201 . V_203 ) ;
F_101 ( & V_2 -> V_201 . V_202 ) ;
F_102 ( V_2 -> V_201 . V_204 , & V_2 -> V_201 . V_205 ) ;
}
static struct V_3 *
...
if ( V_5 == V_23 )
F_44 ( V_2 ) -> V_50 -> V_53 ++ ;
F_100 ( & V_4 -> V_32 , & F_44 ( V_2 ) -> V_50 -> V_211 ) ;
}
if ( V_5 == V_23 ) {
if ( ! F_90 ( V_4 ) )
V_208 = true ;
...
static void F_112 ( struct V_1 * V_2 , struct V_212 * V_213 )
{
...
F_82 ( & V_2 -> V_218 ) ;
F_113 (req, tmp, incoming, tl_requests) {
V_217 = F_115 ( V_2 , & V_4 -> V_12 ) ;
if ( V_217 == - V_219 )
V_216 = 1 ;
if ( V_217 )
continue;
V_4 -> V_22 |= V_46 ;
F_116 ( & V_4 -> V_32 , V_215 ) ;
}
F_80 ( & V_2 -> V_218 ) ;
if ( V_216 )
F_32 ( & V_2 -> V_220 ) ;
...
void F_117 ( struct V_221 * V_222 )
{
struct V_1 * V_2 = F_19 ( V_222 , struct V_1 , V_201 . V_205 ) ;
F_118 ( V_213 ) ;
F_118 ( V_215 ) ;
struct V_3 * V_4 , * V_214 ;
for (; ; ) {
F_99 ( & V_2 -> V_201 . V_202 ) ;
F_119 ( & V_2 -> V_201 . V_203 , & V_213 ) ;
F_101 ( & V_2 -> V_201 . V_202 ) ;
F_112 ( V_2 , & V_213 ) ;
if ( F_45 ( & V_213 ) )
break;
V_223:
F_120 ( V_2 -> V_220 , F_114 ( V_2 , & V_213 , & V_215 ) ) ;
for (; ; ) {
F_118 ( V_224 ) ;
F_118 ( V_225 ) ;
bool V_226 ;
if ( F_45 ( & V_2 -> V_201 . V_203 ) )
break;
F_99 ( & V_2 -> V_201 . V_202 ) ;
F_119 ( & V_2 -> V_201 . V_203 , & V_225 ) ;
F_101 ( & V_2 -> V_201 . V_202 ) ;
if ( F_45 ( & V_225 ) )
break;
V_226 = F_114 ( V_2 , & V_225 , & V_224 ) ;
F_119 ( & V_224 , & V_215 ) ;
F_119 ( & V_225 , & V_213 ) ;
if ( ! V_226 )
break;
...
F_22 ( & V_4 -> V_32 ) ;
V_4 -> V_22 |= V_46 ;
if ( ! F_122 ( V_2 , & V_4 -> V_12 ) ) {
F_107 ( V_2 , V_4 ) ;
} else {
F_123 ( & V_4 -> V_32 , & V_215 ) ;
goto V_223;
}
}
}
}
void F_124 ( struct V_227 * V_228 , struct V_18 * V_18 )
{
struct V_1 * V_2 = (struct V_1 * ) V_228 -> V_229 ;
unsigned long V_16 ;
V_16 = V_15 ;
F_47 ( V_2 , F_125 ( V_18 -> V_27 . V_29 , 512 ) ) ;
F_126 ( V_2 ) ;
F_110 ( V_2 , V_18 , V_16 ) ;
}
int F_127 ( struct V_227 * V_228 , struct V_230 * V_231 , struct V_232 * V_233 )
{
struct V_1 * V_2 = (struct V_1 * ) V_228 -> V_229 ;
unsigned int V_234 = V_231 -> V_29 ;
int V_235 = V_236 ;
int V_237 ;
if ( V_234 && F_68 ( V_2 ) ) {
unsigned int V_238 = F_128 ( V_228 ) ;
struct V_227 * const V_81 =
V_2 -> V_83 -> V_84 -> V_157 -> V_158 ;
if ( V_81 -> V_239 ) {
V_237 = V_81 -> V_239 ( V_81 , V_231 , V_233 ) ;
V_235 = F_129 ( V_235 , V_237 ) ;
}
F_27 ( V_2 ) ;
if ( ( V_235 >> 9 ) > V_238 )
V_235 = V_238 << 9 ;
...
* V_240 = NULL ;
* V_241 = NULL ;
F_131 (r, &connection->transfer_log, tl_requests) {
const unsigned V_37 = V_242 -> V_22 ;
if ( ! * V_240
&& ( ( V_37 & V_40 ) && ! ( V_37 & V_41 ) ) )
* V_240 = V_242 ;
if ( ! * V_241
&& ( V_37 & V_39 ) && V_242 -> V_2 == V_2 )
* V_241 = V_242 ;
if ( * V_240 && * V_241 )
break;
}
}
void F_132 ( unsigned long V_243 )
{
struct V_1 * V_2 = (struct V_1 * ) V_243 ;
struct V_49 * V_50 = F_44 ( V_2 ) -> V_50 ;
struct V_3 * V_244 , * V_245 ;
struct V_87 * V_88 ;
unsigned long V_246 = 0 , V_247 = 0 , V_248 , V_249 ;
unsigned long V_250 ;
F_61 () ;
V_88 = F_62 ( V_50 -> V_87 ) ;
if ( V_88 && V_2 -> V_146 . V_187 >= V_251 )
V_246 = V_88 -> V_252 * V_253 / 10 * V_88 -> V_254 ;
if ( F_68 ( V_2 ) ) {
V_247 = F_62 ( V_2 -> V_83 -> V_191 ) -> V_255 * V_253 / 10 ;
F_27 ( V_2 ) ;
}
F_63 () ;
V_248 = F_133 ( V_247 , V_246 ) ;
if ( ! V_248 )
return;
V_250 = V_15 ;
F_82 ( & V_2 -> V_175 -> V_176 ) ;
F_130 ( V_50 , V_2 , & V_245 , & V_244 ) ;
if ( V_245 == NULL && V_244 == NULL ) {
F_80 ( & V_2 -> V_175 -> V_176 ) ;
F_134 ( & V_2 -> V_256 , V_250 + V_248 ) ;
return;
}
if ( V_246 && V_245 &&
F_135 ( V_250 , V_245 -> V_16 + V_246 ) &&
! F_136 ( V_250 , V_50 -> V_257 , V_50 -> V_257 + V_246 ) ) {
F_29 ( V_2 , L_16 ) ;
F_86 ( F_87 ( V_2 , V_187 , V_258 ) , V_259 | V_260 , NULL ) ;
}
if ( V_247 && V_244 &&
F_135 ( V_250 , V_244 -> V_16 + V_247 ) &&
! F_136 ( V_250 , V_2 -> V_261 , V_2 -> V_261 + V_247 ) ) {
F_29 ( V_2 , L_17 ) ;
F_64 ( V_2 , V_262 ) ;
}
V_246 = ( V_246 && V_245 && F_137 ( V_250 , V_245 -> V_16 + V_246 ) )
? V_245 -> V_16 + V_246 : V_250 + V_248 ;
V_247 = ( V_247 && V_244 && F_137 ( V_250 , V_244 -> V_16 + V_247 ) )
? V_244 -> V_16 + V_247 : V_250 + V_248 ;
V_249 = F_137 ( V_246 , V_247 ) ? V_246 : V_247 ;
F_80 ( & V_50 -> V_175 -> V_176 ) ;
F_134 ( & V_2 -> V_256 , V_249 ) ;
}
