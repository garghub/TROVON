...
T_1 * F_30 ( struct V_46 * V_20 , T_3 V_10 )
{
static T_1 * V_1 ;
int V_54 ;
int V_55 , V_56 ;
...
V_61 = V_60 + V_59 ;
V_20 -> V_53 -= ( V_61 >> V_62 ) - ( V_60 >> V_62 ) ;
if ( V_16 -> V_30 && V_16 -> V_5 == V_5 ) {
...
int F_35 ( struct V_46 * V_20 , int V_63 )
{
struct V_15 * V_16 = V_20 -> V_16 ;
int V_64 = ( void * ) V_20 -> V_50 - ( void * ) V_20 -> V_1 ;
int V_65 = V_16 -> V_5 + V_64 ;
if ( V_63 < 0 || V_63 < V_16 -> V_5 )
return - 1 ;
if ( V_63 > V_16 -> V_28 )
return 0 ;
if ( V_63 < V_65 )
V_20 -> V_50 = ( void * ) V_20 -> V_50 + V_63 - V_65 ;
V_16 -> V_28 = V_63 ;
return 0 ;
}
...
V_23 += V_20 -> V_16 -> V_19 ;
V_67 = V_23 >> V_62 ;
V_20 -> V_53 = & V_20 -> V_16 -> V_18 [ V_67 ] ;
V_17 = F_29 ( * V_20 -> V_53 ) ;
V_68 = V_23 & ~ V_71 ;
V_20 -> V_1 = ( T_1 * ) ( V_17 + V_68 ) ;
V_69 = V_68 + V_5 ;
if ( V_69 > V_57 )
V_69 = V_57 ;
V_20 -> V_50 = ( T_1 * ) ( V_17 + V_69 ) ;
V_20 -> V_48 = NULL ;
return 0 ;
}
...
{
unsigned int V_72 ;
V_72 = ( 1 + V_20 -> V_53 - V_20 -> V_16 -> V_18 ) << V_62 ;
V_72 -= V_20 -> V_16 -> V_19 ;
if ( F_38 ( V_20 , V_72 , V_57 ) < 0 )
...
{
T_1 * V_1 ;
void * V_73 = V_20 -> V_52 . V_27 ;
T_3 V_74 = ( char * ) V_20 -> V_50 - ( char * ) V_20 -> V_1 ;
if ( V_10 > V_20 -> V_52 . V_29 )
return NULL ;
memcpy ( V_73 , V_20 -> V_1 , V_74 ) ;
V_73 += V_74 ;
V_10 -= V_74 ;
if ( ! F_40 ( V_20 ) )
return NULL ;
...
unsigned int V_75 = F_25 ( V_20 ) ;
if ( V_20 -> V_47 == 0 )
return 0 ;
V_48 = V_16 -> V_25 ;
if ( V_48 -> V_29 > V_75 ) {
F_21 ( V_16 , V_48 -> V_29 - V_75 ) ;
V_20 -> V_47 = F_2 ( V_16 -> V_5 - V_75 ) ;
}
if ( V_47 > V_20 -> V_47 ) {
V_47 = V_20 -> V_47 ;
V_5 = V_47 << 2 ;
...
int
F_50 ( struct V_15 * V_16 , struct V_15 * V_77 ,
unsigned int V_23 , unsigned int V_5 )
{
V_77 -> V_28 = V_77 -> V_5 = V_5 ;
if ( V_23 < V_16 -> V_25 [ 0 ] . V_29 ) {
V_77 -> V_25 [ 0 ] . V_27 = V_16 -> V_25 [ 0 ] . V_27 + V_23 ;
V_77 -> V_25 [ 0 ] . V_29 = F_31 (unsigned int, len,
buf->head[0].iov_len - base) ;
V_5 -= V_77 -> V_25 [ 0 ] . V_29 ;
V_23 = 0 ;
} else {
...
if ( V_23 < V_16 -> V_30 ) {
V_77 -> V_30 = F_51 ( V_16 -> V_30 - V_23 , V_5 ) ;
V_23 += V_16 -> V_19 ;
V_77 -> V_19 = V_23 & ~ V_39 ;
V_77 -> V_18 = & V_16 -> V_18 [ V_23 >> V_38 ] ;
V_5 -= V_77 -> V_30 ;
V_23 = 0 ;
} else {
V_23 -= V_16 -> V_30 ;
...
V_77 -> V_26 [ 0 ] . V_27 = V_16 -> V_26 [ 0 ] . V_27 + V_23 ;
V_77 -> V_26 [ 0 ] . V_29 = F_31 (unsigned int, len,
buf->tail[0].iov_len - base) ;
V_5 -= V_77 -> V_26 [ 0 ] . V_29 ;
V_23 = 0 ;
} else {
...
{
T_3 V_75 ;
unsigned int V_78 = V_5 ;
if ( V_16 -> V_26 [ 0 ] . V_29 ) {
V_75 = F_31 ( T_3 , V_16 -> V_26 [ 0 ] . V_29 , V_78 ) ;
V_16 -> V_26 [ 0 ] . V_29 -= V_75 ;
V_78 -= V_75 ;
if ( ! V_78 )
goto V_79;
}
if ( V_16 -> V_30 ) {
V_75 = F_31 (unsigned int, buf->page_len, trim) ;
V_16 -> V_30 -= V_75 ;
V_78 -= V_75 ;
if ( ! V_78 )
goto V_79;
...
if ( V_16 -> V_25 [ 0 ] . V_29 ) {
V_75 = F_31 ( T_3 , V_16 -> V_25 [ 0 ] . V_29 , V_78 ) ;
V_16 -> V_25 [ 0 ] . V_29 -= V_75 ;
V_78 -= V_75 ;
}
V_79:
V_16 -> V_5 -= ( V_5 - V_78 ) ;
}
static void F_53 ( struct V_15 * V_77 , void * V_3 , unsigned int V_5 )
{
unsigned int V_80 ;
V_80 = F_31 (unsigned int, len, subbuf->head[0].iov_len) ;
memcpy ( V_3 , V_77 -> V_25 [ 0 ] . V_27 , V_80 ) ;
V_5 -= V_80 ;
V_3 += V_80 ;
V_80 = F_31 (unsigned int, len, subbuf->page_len) ;
if ( V_80 )
F_20 ( V_3 , V_77 -> V_18 , V_77 -> V_19 , V_80 ) ;
V_5 -= V_80 ;
V_3 += V_80 ;
V_80 = F_31 (unsigned int, len, subbuf->tail[0].iov_len) ;
memcpy ( V_3 , V_77 -> V_26 [ 0 ] . V_27 , V_80 ) ;
}
int F_54 ( struct V_15 * V_16 , unsigned int V_23 , void * V_3 , unsigned int V_5 )
{
struct V_15 V_77 ;
int V_81 ;
V_81 = F_50 ( V_16 , & V_77 , V_23 , V_5 ) ;
if ( V_81 != 0 )
return V_81 ;
F_53 ( & V_77 , V_3 , V_5 ) ;
return 0 ;
}
static void F_55 ( struct V_15 * V_77 , void * V_3 , unsigned int V_5 )
{
unsigned int V_80 ;
V_80 = F_31 (unsigned int, len, subbuf->head[0].iov_len) ;
memcpy ( V_77 -> V_25 [ 0 ] . V_27 , V_3 , V_80 ) ;
V_5 -= V_80 ;
V_3 += V_80 ;
V_80 = F_31 (unsigned int, len, subbuf->page_len) ;
if ( V_80 )
F_19 ( V_77 -> V_18 , V_77 -> V_19 , V_3 , V_80 ) ;
V_5 -= V_80 ;
V_3 += V_80 ;
V_80 = F_31 (unsigned int, len, subbuf->tail[0].iov_len) ;
memcpy ( V_77 -> V_26 [ 0 ] . V_27 , V_3 , V_80 ) ;
}
...
T_1 V_82 ;
int V_81 ;
V_81 = F_54 ( V_16 , V_23 , & V_82 , sizeof( * V_3 ) ) ;
if ( V_81 )
return V_81 ;
* V_3 = F_5 ( V_82 ) ;
return 0 ;
...
{
T_1 V_82 = F_3 ( V_3 ) ;
return F_56 ( V_16 , V_23 , & V_82 , sizeof( V_3 ) ) ;
}
...
return - V_83 ;
if ( F_50 ( V_16 , & V_77 , V_21 + 4 , V_3 -> V_5 ) )
return - V_83 ;
V_3 -> V_6 = V_77 . V_25 [ 0 ] . V_27 ;
if ( V_77 . V_25 [ 0 ] . V_29 == V_3 -> V_5 )
return 0 ;
V_3 -> V_6 = V_77 . V_26 [ 0 ] . V_27 ;
if ( V_77 . V_26 [ 0 ] . V_29 == V_3 -> V_5 )
return 0 ;
...
{
char * V_88 = NULL , * V_89 ;
unsigned int V_90 = 0 , V_91 , V_92 ;
struct V_22 * * V_93 = NULL ;
int V_94 ;
if ( V_87 ) {
if ( F_58 ( V_16 , V_23 , V_86 -> V_95 ) != 0 )
return - V_70 ;
} else {
if ( F_57 ( V_16 , V_23 , & V_86 -> V_95 ) != 0 ||
V_86 -> V_95 > V_86 -> V_96 ||
( unsigned long ) V_23 + 4 + V_86 -> V_95 *
V_86 -> V_97 > V_16 -> V_5 )
return - V_70 ;
}
V_23 += 4 ;
if ( ! V_86 -> V_98 )
return 0 ;
V_91 = V_86 -> V_95 * V_86 -> V_97 ;
if ( V_91 && V_23 < V_16 -> V_25 -> V_29 ) {
V_89 = V_16 -> V_25 -> V_27 + V_23 ;
V_92 = F_31 (unsigned int, todo,
buf->head->iov_len - base) ;
V_91 -= V_92 ;
while ( V_92 >= V_86 -> V_97 ) {
V_94 = V_86 -> V_98 ( V_86 , V_89 ) ;
if ( V_94 )
goto V_99;
V_89 += V_86 -> V_97 ;
V_92 -= V_86 -> V_97 ;
...
if ( V_92 ) {
if ( ! V_88 ) {
V_88 = F_61 ( V_86 -> V_97 , V_100 ) ;
V_94 = - V_84 ;
if ( ! V_88 )
goto V_99;
}
if ( V_87 ) {
V_94 = V_86 -> V_98 ( V_86 , V_88 ) ;
if ( V_94 )
goto V_99;
memcpy ( V_89 , V_88 , V_92 ) ;
} else
memcpy ( V_88 , V_89 , V_92 ) ;
V_90 = V_92 ;
}
V_23 = V_16 -> V_25 -> V_29 ;
}
V_23 -= V_16 -> V_25 -> V_29 ;
if ( V_91 && V_23 < V_16 -> V_30 ) {
unsigned int V_101 ;
V_92 = F_51 ( V_91 , V_16 -> V_30 - V_23 ) ;
V_91 -= V_92 ;
V_23 += V_16 -> V_19 ;
V_93 = V_16 -> V_18 + ( V_23 >> V_38 ) ;
V_23 &= ~ V_39 ;
V_101 = F_31 (unsigned int, PAGE_CACHE_SIZE - base,
avail_here) ;
V_89 = F_62 ( * V_93 ) + V_23 ;
while ( V_92 ) {
V_92 -= V_101 ;
if ( V_90 || V_101 < V_86 -> V_97 ) {
unsigned int V_102 = F_51 ( V_101 ,
V_86 -> V_97 - V_90 ) ;
if ( ! V_88 ) {
V_88 = F_61 ( V_86 -> V_97 ,
V_100 ) ;
...
memcpy ( V_89 , V_88 + V_90 , V_102 ) ;
V_90 += V_102 ;
if ( V_90 == V_86 -> V_97 )
V_90 = 0 ;
} else {
memcpy ( V_88 + V_90 , V_89 , V_102 ) ;
V_90 += V_102 ;
if ( V_90 == V_86 -> V_97 ) {
V_94 = V_86 -> V_98 ( V_86 , V_88 ) ;
if ( V_94 )
...
V_23 -= V_16 -> V_30 ;
if ( V_91 ) {
V_89 = V_16 -> V_26 -> V_27 + V_23 ;
if ( V_90 ) {
unsigned int V_102 = V_86 -> V_97 - V_90 ;
if ( V_87 )
memcpy ( V_89 , V_88 + V_90 , V_102 ) ;
else {
memcpy ( V_88 + V_90 , V_89 , V_102 ) ;
...
if ( V_23 >= V_16 -> V_5 )
return - V_70 ;
return F_60 ( V_16 , V_23 , V_86 , 0 ) ;
}
int
F_66 ( struct V_15 * V_16 , unsigned int V_23 ,
struct V_85 * V_86 )
{
if ( ( unsigned long ) V_23 + 4 + V_86 -> V_95 * V_86 -> V_97 >
V_16 -> V_25 -> V_29 + V_16 -> V_30 + V_16 -> V_26 -> V_29 )
return - V_70 ;
return F_60 ( V_16 , V_23 , V_86 , 1 ) ;
}
int
F_67 ( struct V_15 * V_16 , unsigned int V_21 , unsigned int V_5 ,
int (* F_68)( struct V_103 * , void * ) , void * V_6 )
{
int V_104 , V_105 = 0 ;
unsigned int V_30 , V_106 , V_107 ;
struct V_103 V_108 [ 1 ] ;
F_69 ( V_108 , 1 ) ;
if ( V_21 >= V_16 -> V_25 [ 0 ] . V_29 ) {
V_21 -= V_16 -> V_25 [ 0 ] . V_29 ;
} else {
V_106 = V_16 -> V_25 [ 0 ] . V_29 - V_21 ;
if ( V_106 > V_5 )
V_106 = V_5 ;
F_70 ( V_108 , V_16 -> V_25 [ 0 ] . V_27 + V_21 , V_106 ) ;
V_105 = F_68 ( V_108 , V_6 ) ;
if ( V_105 )
goto V_99;
V_21 = 0 ;
V_5 -= V_106 ;
...
V_30 = V_5 ;
V_5 -= V_30 ;
V_107 = ( V_21 + V_16 -> V_19 ) & ( V_40 - 1 ) ;
V_104 = ( V_21 + V_16 -> V_19 ) >> V_38 ;
V_106 = V_40 - V_107 ;
do {
if ( V_106 > V_30 )
V_106 = V_30 ;
F_71 ( V_108 , V_16 -> V_18 [ V_104 ] , V_106 , V_107 ) ;
V_105 = F_68 ( V_108 , V_6 ) ;
if ( V_105 )
goto V_99;
V_30 -= V_106 ;
...
V_106 = V_16 -> V_26 [ 0 ] . V_29 - V_21 ;
if ( V_106 > V_5 )
V_106 = V_5 ;
F_70 ( V_108 , V_16 -> V_26 [ 0 ] . V_27 + V_21 , V_106 ) ;
V_105 = F_68 ( V_108 , V_6 ) ;
V_5 -= V_106 ;
}
if ( V_5 != 0 )
