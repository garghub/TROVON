...
switch ( F_46 ( V_4 -> V_23 -> V_86 . V_87 ) ) {
case V_88 :
case V_89 :
case V_90 :
case V_91 :
...
return - V_122 ;
F_53 ( V_4 -> V_23 , V_2 -> V_123 -> V_124 ) ;
F_53 ( V_4 -> V_23 , V_2 -> V_19 -> V_124 ) ;
V_114 -> V_125 ++ ;
...
struct V_119 * V_120 = F_59 ( & V_2 -> V_2 ) ;
unsigned int V_68 = V_2 -> V_126 ;
struct V_6 * V_8 = F_4 ( V_2 ) ;
struct V_6 * V_114 = F_4 ( V_4 -> V_2 [ 0 ] ) ;
if ( V_4 -> V_141 )
F_60 ( V_2 -> V_123 ) ;
if ( V_4 -> V_145 )
F_60 ( V_2 -> V_19 ) ;
...
static int F_64 ( struct V_119 * V_120 , struct V_1 * V_2 ,
const unsigned char * V_146 , int V_147 )
{
int V_30 ;
struct V_5 * V_4 = F_8 ( V_2 , V_29 ) ;
if ( V_4 == NULL )
...
V_147 =
( V_147 > V_2 -> V_148 ) ? V_2 -> V_148 : V_147 ;
memcpy ( V_2 -> V_123 -> V_27 , V_146 , V_147 ) ;
F_21 ( V_2 -> V_123 , V_4 -> V_23 ,
F_65 ( V_4 -> V_23 ,
V_2 ->
V_133 ) ,
V_2 -> V_123 -> V_27 , V_147 ,
F_14 , V_2 ) ;
