...
static int F_60 ( struct V_1 * V_26 )
{
int V_43 , V_126 , V_127 ;
T_2 V_128 ;
T_2 V_129 [ 2 ] ;
V_43 = F_14 ( V_26 , V_52 , V_47 ) ;
if ( V_43 )
return V_43 ;
V_127 = F_61 ( V_26 -> V_5 -> V_124 ) ;
if ( V_127 & ( V_130 | V_131 ) )
V_126 = V_132 ;
else
V_126 = V_133 ;
V_43 = F_14 ( V_26 , V_134 , V_126 ) ;
if ( V_43 )
return V_43 ;
V_43 = F_14 ( V_26 , V_135 , V_123 ) ;
if ( V_43 )
return V_43 ;
F_62 ( V_129 , F_63 ( V_129 ) ) ;
V_43 = F_14 ( V_26 , V_136 , V_129 [ 0 ] ) ;
if ( V_43 )
return V_43 ;
V_43 = F_14 ( V_26 , V_137 , V_129 [ 1 ] ) ;
if ( V_43 )
return V_43 ;
V_43 = F_14 ( V_26 , V_138 , 0x00 ) ;
if ( V_43 )
return V_43 ;
V_43 = F_14 ( V_26 , V_139 , 0x00 ) ;
if ( V_43 )
return V_43 ;
F_29 ( 100 ) ;
V_43 = F_11 ( V_26 , V_140 , & V_128 ) ;
if ( V_43 )
return V_43 ;
if ( ! V_128 ) {
...
{
struct V_141 * V_142 ;
if ( ! F_66 ( V_143 ) || ! V_5 -> V_25 . V_144 )
return V_5 -> V_25 . V_145 ;
V_142 = F_67 ( & V_5 -> V_25 , sizeof( * V_142 ) , V_10 ) ;
if ( ! V_142 )
goto V_146;
V_142 -> V_147 = F_68 ( V_5 -> V_25 . V_144 , L_13 , 0 ) ;
V_142 -> V_148 = F_68 ( V_5 -> V_25 . V_144 , L_14 , 0 ) ;
V_5 -> V_25 . V_145 = V_142 ;
V_146:
return V_142 ;
}
...
if ( F_70 ( V_142 -> V_147 ) ) {
V_43 = F_71 ( & V_5 -> V_25 , V_142 -> V_147 ,
V_154 , L_17 ) ;
if ( V_43 )
return V_43 ;
}
if ( F_70 ( V_142 -> V_148 ) ) {
V_43 = F_71 ( & V_5 -> V_25 , V_142 -> V_148 ,
V_155 , L_18 ) ;
if ( V_43 )
return V_43 ;
}
...
F_75 ( & V_5 -> V_25 , L_25 , V_151 , V_7 ) ;
if ( ! V_153 )
return - V_158 ;
V_25 = F_76 ( sizeof( * V_26 ) , V_153 ) ;
if ( ! V_25 )
return - V_20 ;
V_26 = V_25 -> V_42 ;
V_26 -> V_25 = V_25 ;
...
V_25 -> V_160 = & V_5 -> V_25 ;
V_25 -> V_161 = 0 ;
V_25 -> V_72 = V_162 | V_163 ;
V_127 = F_61 ( V_5 -> V_124 ) ;
if ( ! V_127 )
V_127 = V_164 ;
if ( V_127 & ( V_164 | V_130 ) ) {
V_150 = F_51 ;
V_149 = F_56 ;
} else {
V_150 = F_54 ;
...
if ( V_43 )
goto V_165;
V_43 = F_82 ( & V_5 -> V_25 , V_5 -> V_124 , V_149 ,
V_166 | V_127 ,
F_83 ( & V_5 -> V_25 ) , V_26 ) ;
if ( V_43 )
goto V_165;
