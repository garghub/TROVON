...
static struct V_1 *
F_16 ( struct V_1 * V_1 , struct V_6 * V_6 , unsigned V_36 ,
...
V_46 = V_45 + V_36 * V_42 ;
V_47 = ( F_17 ( V_24 ) + V_44 - 1 ) >> V_41 ;
if ( V_46 > V_47 )
V_46 = V_47 ;
V_23 = 0 ;
V_53 = V_38 -> V_57 >> V_41 ;
if ( F_18 ( V_38 ) && V_45 > * V_39 &&
V_45 < ( * V_39 + V_53 ) ) {
...
if ( V_1 == NULL ) {
if ( V_50 == V_42 ) {
if ( ! F_25 ( V_11 , V_48 [ 0 ] << ( V_41 - 9 ) ,
V_6 ) )
goto V_61;
}
V_1 = F_8 ( V_11 , V_48 [ 0 ] << ( V_41 - 9 ) ,
F_26 ( int , V_36 , F_27 ( V_11 ) ) ,
V_64 ) ;
if ( V_1 == NULL )
goto V_55;
}
V_51 = V_50 << V_41 ;
if ( F_28 ( V_1 , V_6 , V_51 , 0 ) < V_51 ) {
V_1 = F_6 ( V_62 , V_1 ) ;
goto V_63;
}
V_54 = V_45 - * V_39 ;
V_53 = V_38 -> V_57 >> V_41 ;
if ( ( F_29 ( V_38 ) && V_54 == V_53 ) ||
( V_50 != V_42 ) )
V_1 = F_6 ( V_62 , V_1 ) ;
else
* V_37 = V_48 [ V_42 - 1 ] ;
...
int
F_31 ( struct V_65 * V_25 , struct V_66 * V_67 ,
...
struct V_6 * V_6 = F_32 ( V_67 -> V_69 , struct V_6 , V_70 ) ;
F_33 ( & V_6 -> V_16 ) ;
F_34 ( & V_6 -> V_70 ) ;
if ( ! F_35 ( V_6 , V_25 ,
V_6 -> V_56 , V_64 ) ) {
...
int F_39 ( struct V_6 * V_6 , T_3 V_40 )
{
struct V_1 * V_1 = NULL ;
T_1 V_37 = 0 ;
struct V_21 V_38 ;
...
V_38 . V_32 = 0 ;
V_38 . V_57 = 0 ;
V_1 = F_16 ( V_1 , V_6 , 1 , & V_37 ,
& V_38 , & V_39 , V_40 ) ;
if ( V_1 )
F_6 ( V_62 , V_1 ) ;
return 0 ;
}
static void F_40 ( struct V_6 * V_6 , unsigned V_71 )
{
unsigned V_72 = 0 ;
...
static int F_43 ( struct V_6 * V_6 , struct V_74 * V_75 ,
void * V_76 )
{
...
int F_58 ( struct V_6 * V_6 , T_3 V_40 ,
struct V_74 * V_75 )
{
struct V_77 V_78 = {
. V_1 = NULL ,
