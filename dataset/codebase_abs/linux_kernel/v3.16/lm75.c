...
F_14 ( V_15 , V_58 , V_27 ) ;
F_22 ( V_3 , L_3 , V_27 ) ;
V_5 -> V_60 = F_23 ( V_3 , V_15 -> V_61 ,
V_5 , V_62 ) ;
if ( F_4 ( V_5 -> V_60 ) )
return F_5 ( V_5 -> V_60 ) ;
V_5 -> V_63 = F_24 ( V_5 -> V_60 ,
0 ,
V_5 -> V_60 ,
F_2 , NULL ) ;
if ( F_4 ( V_5 -> V_63 ) )
V_5 -> V_63 = NULL ;
F_25 ( V_3 , L_4 ,
F_26 ( V_5 -> V_60 ) , V_15 -> V_61 ) ;
return 0 ;
}
static int F_27 ( struct V_14 * V_15 )
{
struct V_4 * V_5 = F_28 ( V_15 ) ;
F_29 ( V_5 -> V_60 , V_5 -> V_63 ) ;
F_30 ( V_5 -> V_60 ) ;
F_14 ( V_15 , V_58 , V_5 -> V_59 ) ;
return 0 ;
}
static int F_31 ( struct V_14 * V_64 ,
struct V_65 * V_66 )
{
...
if ( F_32 ( V_64 , V_68 + 1 ) != V_69
|| F_32 ( V_64 , V_68 + 2 ) != V_70
|| F_32 ( V_64 , V_68 + 3 ) != V_71 )
return - V_73 ;
if ( V_72 && F_32 ( V_64 , V_68 + 7 )
!= V_74 )
return - V_73 ;
}
F_33 ( V_66 -> type , V_72 ? L_5 : L_6 , V_75 ) ;
return 0 ;
}
...
static int F_21 ( struct V_14 * V_15 , T_2 V_76 )
{
if ( V_76 == V_58 )
return F_32 ( V_15 , V_76 ) ;
else
return F_37 ( V_15 , V_76 ) ;
}
static int F_14 ( struct V_14 * V_15 , T_2 V_76 , T_5 V_77 )
{
if ( V_76 == V_58 )
return F_38 ( V_15 , V_76 , V_77 ) ;
else
return F_39 ( V_15 , V_76 , V_77 ) ;
}
...
struct V_4 * V_78 = V_5 ;
F_11 ( & V_5 -> V_18 ) ;
if ( F_40 ( V_79 , V_5 -> V_80 + V_5 -> V_39 )
|| ! V_5 -> V_81 ) {
int V_68 ;
F_22 ( & V_15 -> V_3 , L_7 ) ;
for ( V_68 = 0 ; V_68 < F_41 ( V_5 -> V_1 ) ; V_68 ++ ) {
int V_24 ;
V_24 = F_21 ( V_15 , V_21 [ V_68 ] ) ;
if ( F_42 ( V_24 < 0 ) ) {
F_22 ( V_3 ,
L_8 ,
V_21 [ V_68 ] , V_24 ) ;
