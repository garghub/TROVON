...
F_100 () ;
F_101 ( & V_51 -> V_63 , V_62 , F_96 , V_158 ) ;
if ( F_102 ( V_83 , V_157 + V_159 ) )
V_51 -> V_152 -> V_79 = F_103 ( V_51 -> V_152 -> V_79 +
V_160 ,
V_161 ) ;
return V_51 -> V_68 ;
}
...
F_111 ( V_51 ) ;
F_100 () ;
F_101 ( & V_15 -> V_39 , V_85 , F_98 , V_158 ) ;
}
...
if ( V_186 -> V_6 < V_187 -> V_6 )
return - 1 ;
F_119 ( V_184 -> V_152 -> V_17 -> V_125 == V_185 -> V_152 -> V_17 -> V_125 ) ;
return 0 ;
}
static int F_120 ( unsigned int V_188 , struct V_50 * V_189 ,
struct V_50 * * V_190 )
{
unsigned int V_191 ;
int error = 0 ;
...
F_121 ( V_190 , V_188 , sizeof( struct V_50 * ) , F_118 , NULL ) ;
for ( V_191 = 0 ; V_191 < V_188 ; V_191 ++ ) {
...
int F_122 ( unsigned int V_188 , struct V_50 * V_189 )
{
struct V_50 * V_65 [ 4 ] ;
...
if ( V_188 <= 4 )
break;
V_192 = F_123 ( V_188 * sizeof( struct V_50 * ) , V_129 ) ;
if ( ! V_192 )
return - V_130 ;
}
...
void F_124 ( unsigned int V_188 , struct V_50 * V_189 )
{
while ( V_188 -- )
F_111 ( & V_189 [ V_188 ] ) ;
}
...
static int F_128 ( void * V_197 , struct V_198 * V_186 , struct V_198 * V_187 )
{
...
static void F_129 ( struct V_198 * V_201 )
__releases( &lru_lock
static long F_130 ( int V_202 )
{
struct V_14 * V_15 ;
F_131 ( V_203 ) ;
F_131 ( V_204 ) ;
...
static unsigned long F_134 ( struct V_206 * V_207 ,
struct V_208 * V_209 )
{
if ( ! ( V_209 -> V_210 & V_211 ) )
return V_212 ;
return F_130 ( V_209 -> V_213 ) ;
}
...
static void F_144 ( struct V_166 * V_167 , struct V_14 * V_15 )
{
F_22 ( & V_15 -> V_89 ) ;
F_145 ( V_167 , V_15 ) ;
F_27 ( & V_15 -> V_89 ) ;
...
static const char * F_154 ( char * V_221 , unsigned V_147 , unsigned long V_222 )
{
char * V_190 = V_221 ;
if ( V_147 & V_70 )
* V_190 ++ = 't' ;
...
static void F_155 ( struct V_166 * V_167 , const struct V_50 * V_51 )
{
struct V_224 * V_225 = NULL ;
char V_226 [ 32 ] ;
F_76 () ;
if ( V_51 -> V_154 )
V_225 = F_156 ( V_51 -> V_154 , V_227 ) ;
F_106 ( V_167 , L_8 ,
F_153 ( V_51 -> V_55 ) ,
F_154 ( V_226 , V_51 -> V_57 , V_51 -> V_63 ) ,
V_51 -> V_68 ,
V_51 -> V_154 ? ( long ) F_157 ( V_51 -> V_154 ) : - 1 ,
...
void F_145 ( struct V_166 * V_167 , const struct V_14 * V_15 )
{
const struct V_28 * V_29 = V_15 -> V_17 ;
...
F_162 (i) {
const struct V_255 * V_137 = F_163 ( V_2 -> V_136 , V_252 ) ;
if ( V_249 == 0 ) {
V_251 = V_252 ;
} else {
...
static int F_185 ( struct V_105 * V_105 , struct V_266 * V_266 )
{
int V_64 = F_186 ( V_266 , & V_267 ,
sizeof( struct V_246 ) ) ;
if ( V_64 == 0 ) {
struct V_166 * V_167 = V_266 -> V_148 ;
struct V_246 * V_247 = V_167 -> V_248 ;
V_247 -> V_2 = V_105 -> V_268 ;
V_167 -> V_221 = F_123 ( V_269 , V_270 | V_271 ) ;
if ( V_167 -> V_221 )
V_167 -> V_272 = V_269 ;
}
return V_64 ;
}
static int F_187 ( struct V_105 * V_105 , struct V_266 * V_266 )
{
int V_64 = F_186 ( V_266 , & V_273 ,
sizeof( struct V_246 ) ) ;
if ( V_64 == 0 ) {
struct V_166 * V_167 = V_266 -> V_148 ;
struct V_246 * V_247 = V_167 -> V_248 ;
...
static int F_188 ( struct V_105 * V_105 , struct V_266 * V_266 )
{
int V_64 = F_186 ( V_266 , & V_274 ,
sizeof( struct V_246 ) ) ;
if ( V_64 == 0 ) {
struct V_166 * V_167 = V_266 -> V_148 ;
struct V_246 * V_247 = V_167 -> V_248 ;
