...
struct V_80 * F_39 ( struct V_1 * V_2 ,
int V_81 )
{
struct V_18 * V_19 ;
struct V_82 V_83 ;
V_19 = F_7 ( V_2 -> V_21 . V_22 ) ;
F_40 ( & V_83 ) ;
V_83 . V_84 = V_19 -> V_24 . V_25 . V_83 [ V_81 ] ;
return F_41 ( V_83 ) ;
}
void F_42 ( struct V_1 * V_2 , struct V_85 * V_86 )
{
* V_86 = V_2 -> V_7 -> V_86 ;
}
int F_43 ( struct V_1 * V_2 , struct V_87 * V_87 ,
...
V_64 = F_44 ( V_19 , V_87 , V_33 , V_34 ) ;
if ( V_64 == 0 )
V_2 -> V_7 -> V_17 = V_17 ;
return V_64 ;
}
int F_45 ( struct V_1 * V_2 , struct V_87 * V_87 ,
unsigned long V_17 , T_3 V_33 , T_3 V_34 ,
int V_47 )
{
int V_20 ;
F_14 ( V_2 , V_47 ) ;
V_20 = F_43 ( V_2 , V_87 , V_17 , V_33 , V_34 ) ;
if ( V_20 != 0 )
F_14 ( V_2 , 0 ) ;
return V_20 ;
}
int F_46 ( struct V_1 * V_2 , struct V_87 * V_87 ,
unsigned long V_17 , T_3 V_33 )
{
return F_43 ( V_2 , V_87 , V_17 , V_33 ,
V_48 ) ;
}
int F_47 ( struct V_1 * V_2 , struct V_87 * V_87 ,
unsigned long V_17 , T_3 V_33 , int V_47 )
{
return F_45 ( V_2 , V_87 , V_17 , V_33 ,
V_48 , V_47 ) ;
}
int F_48 ( struct V_1 * V_2 , T_3 V_89 )
{
struct V_18 * V_19 = F_7 ( V_2 -> V_21 . V_22 ) ;
struct V_90 * V_91 ;
struct V_82 V_83 ;
...
if ( ! ( V_89 & ( 0x80 >> V_93 ) ) )
continue;
V_83 . V_84 = V_19 -> V_24 . V_25 . V_83 [ V_93 ] ;
V_91 = F_49 ( V_83 ) ;
if ( ! V_91 )
continue;
F_50 ( & V_91 -> V_74 ) ;
...
if ( ! V_91 -> V_94 . V_96 )
V_92 = 1 ;
V_92 = V_92 ? F_52 ( int , V_92 , V_91 -> V_94 . V_92 ) :
V_91 -> V_94 . V_92 ;
F_51 ( & V_91 -> V_74 ) ;
}
return V_92 ;
...
if ( V_2 -> V_7 -> V_27 != V_29 )
return - V_73 ;
if ( ! F_54 ( & V_19 -> V_24 . V_39 ) ||
! ( F_55 ( & V_19 -> V_24 . V_39 ) & V_97 ) )
return - V_6 ;
return F_56 ( V_19 ) ;
}
void F_57 ( struct V_1 * V_2 , struct V_98 * V_99 )
{
struct V_18 * V_19 = F_7 ( V_2 -> V_21 . V_22 ) ;
* V_99 = V_19 -> V_99 ;
}
