...
void T_4 * V_46 ;
if ( V_44 )
memcpy ( V_5 -> V_47 + F_29 ( 0 ) , V_44 , 0x10 ) ;
if ( V_45 == V_48 )
V_46 = V_5 -> V_47 + F_30 ( 0 ) ;
else if ( V_45 == V_49 )
V_46 = V_5 -> V_47 + F_30 ( 2 ) ;
else
V_46 = V_5 -> V_47 + F_30 ( 4 ) ;
memcpy ( V_46 , V_43 , V_45 ) ;
}
static void F_31 ( struct V_12 * V_5 , unsigned long V_50 )
{
...
V_86 -> V_22 ( V_86 , - V_90 ) ;
V_5 -> V_20 = F_36 ( V_85 ) ;
V_5 -> V_61 = F_37 ( V_5 -> V_20 -> V_21 . V_91 ) ;
V_88 = F_38 ( V_5 -> V_20 ) ;
F_31 ( V_5 , V_88 -> V_50 ) ;
}
static int F_39 ( struct V_12 * V_5 ,
struct V_51 * V_20 )
{
unsigned long V_35 ;
int V_19 ;
F_25 ( & V_5 -> V_36 , V_35 ) ;
V_19 = F_40 ( & V_5 -> V_89 , V_20 ) ;
if ( V_5 -> V_23 ) {
F_27 ( & V_5 -> V_36 , V_35 ) ;
goto exit;
}
...
static int F_41 ( struct V_51 * V_20 , unsigned long V_50 )
{
struct V_92 * V_91 = F_42 ( V_20 ) ;
struct V_93 * V_61 = F_43 ( V_91 ) ;
struct V_87 * V_88 = F_38 ( V_20 ) ;
...
static int F_45 ( struct V_92 * V_95 ,
const T_3 * V_43 , unsigned int V_45 )
{
struct V_96 * V_91 = F_46 ( V_95 ) ;
struct V_93 * V_61 = F_37 ( V_91 ) ;
if ( V_45 != V_97 &&
V_45 != V_49 &&
V_45 != V_48 )
return - V_29 ;
...
static int F_47 ( struct V_51 * V_20 )
{
return F_41 ( V_20 , 0 ) ;
}
static int F_48 ( struct V_51 * V_20 )
{
return F_41 ( V_20 , V_54 ) ;
}
static int F_49 ( struct V_51 * V_20 )
{
return F_41 ( V_20 , V_57 ) ;
}
static int F_50 ( struct V_51 * V_20 )
{
return F_41 ( V_20 , V_54 | V_57 ) ;
}
static int F_51 ( struct V_96 * V_91 )
{
struct V_93 * V_61 = F_37 ( V_91 ) ;
V_61 -> V_5 = V_98 ;
...
if ( V_98 )
return - V_109 ;
V_104 = F_53 ( V_5 , sizeof( * V_104 ) , V_110 ) ;
if ( ! V_104 )
return - V_30 ;
V_107 = F_54 ( V_3 , V_111 , 0 ) ;
V_104 -> V_112 = F_55 ( & V_3 -> V_5 , V_107 ) ;
if ( F_56 ( V_104 -> V_112 ) )
return F_57 ( V_104 -> V_112 ) ;
V_108 = F_1 ( V_3 ) ;
V_104 -> V_113 = F_58 ( V_5 , L_2 ) ;
if ( F_56 ( V_104 -> V_113 ) ) {
F_59 ( V_5 , L_3 ) ;
return - V_114 ;
}
...
F_65 ( V_3 , V_104 ) ;
V_98 = V_104 ;
F_66 ( & V_104 -> V_31 , F_33 , ( unsigned long ) V_104 ) ;
...
return 0 ;
V_123:
F_59 ( V_5 , L_8 , V_122 [ V_101 ] . V_124 , V_19 ) ;
