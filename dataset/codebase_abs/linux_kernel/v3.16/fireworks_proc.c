...
static void
F_16 ( struct V_9 * V_10 , struct V_5 * V_67 , const char * V_55 ,
void (* F_17)( struct V_5 * V_68 , struct V_7 * V_69 ) )
{
struct V_5 * V_6 ;
V_6 = F_18 ( V_10 -> V_70 , V_55 , V_67 ) ;
if ( V_6 == NULL )
return;
F_19 ( V_6 , V_10 , F_17 ) ;
if ( F_20 ( V_6 ) < 0 )
...
{
struct V_5 * V_67 ;
V_67 = F_18 ( V_10 -> V_70 , L_49 ,
V_10 -> V_70 -> V_71 ) ;
if ( V_67 == NULL )
return;
V_67 -> V_72 = V_73 | V_74 | V_75 ;
if ( F_20 ( V_67 ) < 0 ) {
F_21 ( V_67 ) ;
return;
}
F_16 ( V_10 , V_67 , L_50 , F_8 ) ;
F_16 ( V_10 , V_67 , L_51 , F_3 ) ;
F_16 ( V_10 , V_67 , L_52 , F_11 ) ;
F_16 ( V_10 , V_67 , L_53 , F_15 ) ;
}
