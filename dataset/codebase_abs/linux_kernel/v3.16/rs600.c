...
V_19 = F_57 ( V_132 ) ;
F_58 ( V_132 , ( V_19 | F_78 ( 1 ) ) ) ;
V_19 = F_57 ( V_160 ) ;
F_58 ( V_160 , ( V_19 | F_79 ( 1 ) ) ) ;
F_56 ( V_2 ) ;
F_80 ( L_8 ,
...
void F_86 ( struct V_1 * V_2 , unsigned V_10 , T_4 V_164 )
{
void T_5 * V_165 = ( void * ) V_2 -> V_136 . V_165 ;
V_164 = V_164 & 0xFFFFFFFFFFFFF000ULL ;
if ( V_164 == V_2 -> V_166 . V_164 )
V_164 |= V_167 | V_168 ;
else
V_164 |= V_169 ;
F_87 ( V_164 , V_165 + ( V_10 * 8 ) ) ;
}
...
if ( F_93 ( & V_2 -> V_175 . V_178 [ V_179 ] ) ) {
V_19 |= F_94 ( 1 ) ;
}
if ( V_2 -> V_175 . V_180 [ 0 ] ||
F_93 ( & V_2 -> V_175 . V_181 [ 0 ] ) ) {
V_170 |= F_95 ( 1 ) ;
}
if ( V_2 -> V_175 . V_180 [ 1 ] ||
F_93 ( & V_2 -> V_175 . V_181 [ 1 ] ) ) {
V_170 |= F_96 ( 1 ) ;
}
if ( V_2 -> V_175 . V_107 [ 0 ] ) {
V_171 |= F_89 ( 1 ) ;
}
if ( V_2 -> V_175 . V_107 [ 1 ] ) {
V_172 |= F_90 ( 1 ) ;
}
if ( V_2 -> V_175 . V_182 [ 0 ] ) {
V_173 |= F_92 ( 1 ) ;
}
F_6 ( V_177 , V_19 ) ;
F_6 ( V_183 , V_170 ) ;
...
T_1 V_19 ;
if ( F_99 ( V_184 ) ) {
V_2 -> V_175 . V_187 . V_188 . V_189 = F_2 ( V_190 ) ;
if ( F_100 ( V_2 -> V_175 . V_187 . V_188 . V_189 ) ) {
F_6 ( V_191 ,
F_101 ( 1 ) ) ;
}
if ( F_102 ( V_2 -> V_175 . V_187 . V_188 . V_189 ) ) {
F_6 ( V_192 ,
F_103 ( 1 ) ) ;
}
if ( F_104 ( V_2 -> V_175 . V_187 . V_188 . V_189 ) ) {
V_19 = F_2 ( V_113 ) ;
V_19 |= F_105 ( 1 ) ;
F_6 ( V_113 , V_19 ) ;
}
if ( F_106 ( V_2 -> V_175 . V_187 . V_188 . V_189 ) ) {
V_19 = F_2 ( V_114 ) ;
V_19 |= F_107 ( 1 ) ;
F_6 ( V_114 , V_19 ) ;
}
} else {
V_2 -> V_175 . V_187 . V_188 . V_189 = 0 ;
}
if ( F_91 ( V_2 ) ) {
V_2 -> V_175 . V_187 . V_188 . V_193 = F_2 ( V_194 ) &
F_108 ( 1 ) ;
if ( F_109 ( V_2 -> V_175 . V_187 . V_188 . V_193 ) ) {
V_19 = F_2 ( V_174 ) ;
V_19 |= F_110 ( 1 ) ;
F_6 ( V_174 , V_19 ) ;
}
} else
V_2 -> V_175 . V_187 . V_188 . V_193 = 0 ;
if ( V_184 ) {
F_6 ( V_185 , V_184 ) ;
}
return V_184 & V_186 ;
...
V_121 = F_97 ( V_2 ) ;
if ( ! V_121 &&
! V_2 -> V_175 . V_187 . V_188 . V_189 &&
! V_2 -> V_175 . V_187 . V_188 . V_193 ) {
return V_198 ;
}
while ( V_121 ||
V_2 -> V_175 . V_187 . V_188 . V_189 ||
...
F_115 ( V_2 -> V_102 , 0 ) ;
V_2 -> V_57 . V_199 = true ;
F_116 ( & V_2 -> V_175 . V_200 ) ;
}
if ( F_93 ( & V_2 -> V_175 . V_181 [ 0 ] ) )
F_117 ( V_2 , 0 ) ;
}
if ( F_102 ( V_2 -> V_175 . V_187 . V_188 . V_189 ) ) {
if ( V_2 -> V_175 . V_180 [ 1 ] ) {
...
case V_206 :
case V_207 :
V_195 = F_2 ( V_141 ) & ~ V_208 ;
F_6 ( V_141 , V_195 ) ;
F_6 ( V_141 , V_195 | V_208 ) ;
break;
default:
F_6 ( V_209 , V_210 ) ;
break;
...
{
T_2 V_215 ;
V_2 -> V_151 . V_216 = F_126 ( V_2 -> V_130 , 0 ) ;
V_2 -> V_151 . V_217 = F_127 ( V_2 -> V_130 , 0 ) ;
V_2 -> V_151 . V_218 = true ;
V_2 -> V_151 . V_219 = 128 ;
V_2 -> V_151 . V_220 = F_2 ( V_221 ) ;
V_2 -> V_151 . V_222 = V_2 -> V_151 . V_220 ;
V_2 -> V_151 . V_223 = V_2 -> V_151 . V_217 ;
V_2 -> V_151 . V_224 = F_128 ( V_2 ) ;
V_215 = F_57 ( V_225 ) ;
V_215 = F_129 ( V_215 ) << 16 ;
F_130 ( V_2 , & V_2 -> V_151 , V_215 ) ;
V_2 -> V_151 . V_226 = 0 ;
F_131 ( V_2 , & V_2 -> V_151 ) ;
F_132 ( V_2 ) ;
}
...
T_1 V_230 , V_231 ;
F_134 ( V_2 ) ;
if ( V_2 -> V_17 . V_18 [ 0 ] -> V_215 . V_104 )
V_228 = & V_2 -> V_17 . V_18 [ 0 ] -> V_215 . V_232 ;
if ( V_2 -> V_17 . V_18 [ 1 ] -> V_215 . V_104 )
V_229 = & V_2 -> V_17 . V_18 [ 1 ] -> V_215 . V_232 ;
F_135 ( V_2 , V_228 , V_229 ) ;
if ( V_2 -> V_233 == 2 ) {
V_230 = F_2 ( V_234 ) ;
V_231 = F_2 ( V_235 ) ;
V_230 |= F_136 ( 1 ) ;
...
unsigned long V_95 ;
T_1 V_135 ;
F_139 ( & V_2 -> V_238 , V_95 ) ;
F_6 ( V_239 , F_140 ( V_74 ) |
F_141 ( 1 ) ) ;
V_135 = F_2 ( V_240 ) ;
F_142 ( & V_2 -> V_238 , V_95 ) ;
return V_135 ;
}
void F_143 ( struct V_1 * V_2 , T_3 V_74 , T_3 V_241 )
{
unsigned long V_95 ;
F_139 ( & V_2 -> V_238 , V_95 ) ;
F_6 ( V_239 , F_140 ( V_74 ) |
...
{
V_2 -> V_242 . V_243 . V_244 = V_245 ;
V_2 -> V_242 . V_243 . V_246 = F_149 ( V_245 ) ;
}
...
F_88 ( V_2 ) ;
V_2 -> V_242 . V_243 . V_251 = F_2 ( V_252 ) ;
