...
V_7 = V_27 -> V_7 ;
if ( V_27 -> V_17 & V_39 )
F_17 ( V_7 , V_27 , F_13 ( V_2 ) -> V_40 , V_34 , false ) ;
...
struct V_26 * V_27 = F_14 ( V_2 -> V_20 ) ;
T_1 V_34 = 0 ;
if ( V_27 -> V_17 & V_39 && F_30 ( V_27 , V_2 , & V_34 ) )
F_17 ( V_27 -> V_7 , V_27 , F_13 ( V_2 ) -> V_40 , V_34 , false ) ;
return 0 ;
}
...
V_27 = F_14 ( V_2 -> V_20 ) ;
if ( F_32 ( F_35 ( V_24 ) ) ) {
T_1 V_54 = V_27 -> V_7 -> V_55 ;
switch ( V_24 [ 5 ] ) {
case 0x00 :
if ( V_27 -> V_7 -> V_56 == V_57 ||
V_54 & ( 1u << V_24 [ 5 ] ) )
goto V_58;
break;
case 0x01 :
...
case V_41 :
if ( F_37 ( V_27 -> V_7 -> V_20 -> V_62 , V_24 ) )
V_2 -> V_49 = V_63 ;
F_11 ( V_21 , V_64 , V_2 , V_2 -> V_20 , NULL ,
F_12 ) ;
break;
default:
V_37:
