...
F_64 ( V_45 -> V_8 , V_126 , V_130 , V_128 ) ;
return 0 ;
}
...
return - V_58 ;
V_132 -> type = V_133 ;
V_132 -> V_129 = V_45 -> V_8 -> V_134 -> V_135 ;
strcpy ( V_132 -> V_84 , L_26 ) ;
return 0 ;
}
...
if ( V_3 > 1 )
return - V_58 ;
F_64 ( V_45 -> V_8 , V_126 , V_136 , V_3 , 0 , 0 ) ;
return 0 ;
}
...
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_71 ( V_139 ) ; V_3 ++ ) {
if ( V_138 -> V_128 && V_138 -> V_128 == V_139 [ V_3 ] . V_128 ) {
memcpy ( V_138 , & ( V_139 [ V_3 ] ) , sizeof( * V_138 ) ) ;
return 0 ;
}
}
return - V_58 ;
...
int V_3 ;
for ( V_3 = 0 ; V_3 < F_71 ( V_139 ) ; V_3 ++ ) {
if ( V_141 -> V_128 == V_139 [ V_3 ] . V_128 ) {
V_141 -> V_142 = V_143 [ V_3 ] ;
return 0 ;
}
}
return - V_58 ;
...
for ( V_3 = 0 ; V_3 < F_71 ( V_139 ) ; V_3 ++ ) {
if ( V_141 -> V_128 == V_139 [ V_3 ] . V_128 ) {
if ( V_141 -> V_142 < V_139 [ V_3 ] . V_144
|| V_141 -> V_142 > V_139 [ V_3 ] . V_145 )
return - V_146 ;
V_143 [ V_3 ] = V_141 -> V_142 ;
return 0 ;
}
}
return - V_58 ;
...
{
struct V_9 * V_10 = V_9 ;
F_4 ( & V_10 -> V_148 , 0x9512A254 ) ;
F_4 ( & V_10 -> V_149 , 0x03310000 ) ;
F_4 ( & V_10 -> V_150 , 0x06600F38 ) ;
F_4 ( & V_10 -> V_151 , 0x00000409 ) ;
F_4 ( & V_10 -> V_152 , 0x000000ff ) ;
F_4 ( & V_10 -> V_153 , 0x00000090 ) ;
F_2 ( 1 , L_28 ,
F_6 ( & V_10 -> V_12 ) , F_6 ( & V_10 -> V_55 ) ) ;
}
static void F_76 ( struct V_7 * V_8 , T_1 V_154 )
{
struct V_9 * V_10 = V_8 -> V_10 ;
if ( V_154 & V_17 )
V_8 -> V_155 = 1 ;
...
static void F_77 ( struct V_7 * V_8 , T_1 V_154 )
{
struct V_18 * V_19 = & V_8 -> V_19 ;
struct V_9 * V_10 = V_8 -> V_10 ;
struct V_20 * V_21 ;
...
F_11 ( & V_21 -> V_26 . V_27 ) ;
F_80 ( & V_21 -> V_26 . V_164 ) ;
V_21 -> V_26 . V_28 = V_165 ;
V_21 -> V_26 . V_166 ++ ;
F_12 ( & V_21 -> V_26 . V_30 ) ;
}
F_74 ( V_8 , V_19 ) ;
...
static T_3 F_81 ( int V_167 , void * V_168 )
{
struct V_7 * V_8 = (struct V_7 * ) V_168 ;
struct V_9 * V_10 = V_8 -> V_10 ;
T_1 V_154 ;
T_1 error ;
V_154 = F_6 ( & V_10 -> V_12 ) ;
...
if ( error )
F_2 ( 1 , L_34 ,
error >> 4 , V_8 -> V_170 . V_171 ) ;
F_4 ( & V_10 -> V_12 ,
( V_154 & 0xffc0ffff ) | V_169 ) ;
}
if ( V_154 & V_17 ) {
V_8 -> V_170 . V_173 ++ ;
V_8 -> V_155 = 1 ;
...
{
struct V_181 * V_134 = F_83 ( V_69 ) ;
struct V_7 * V_8 = F_84 ( V_134 ) ;
struct V_44 * V_45 ;
struct V_9 * V_10 ;
int V_182 = V_134 -> V_182 ;
T_1 V_12 ;
int V_3 ;
F_2 ( 1 , L_38 , V_182 ) ;
V_8 -> V_183 ++ ;
...
V_10 = V_8 -> V_10 ;
F_2 ( 1 , L_39 , V_182 ,
V_185 [ V_124 ] , V_8 -> V_183 ) ;
if ( F_85 ( & V_8 -> V_186 ) ) {
V_8 -> V_183 -- ;
return - V_187 ;
}
V_45 = F_86 ( sizeof( * V_45 ) , V_188 ) ;
if ( ! V_45 ) {
V_8 -> V_183 -- ;
F_87 ( & V_8 -> V_186 ) ;
return - V_189 ;
...
V_60 | V_196 | V_197 ) ) ;
V_12 = F_6 ( & V_10 -> V_12 ) ;
F_4 ( & V_10 -> V_12 , V_12 | V_159 ) ;
F_88 ( & V_45 -> V_198 ) ;
F_89 ( & V_45 -> V_87 , & V_199 ,
V_8 -> V_8 , & V_45 -> V_198 ,
V_45 -> type , V_93 ,
...
static unsigned int F_92 ( struct V_69 * V_69 , struct V_201 * V_202 )
{
struct V_44 * V_45 = V_69 -> V_190 ;
...
void F_99 ( struct V_9 * V_206 )
{
F_4 ( & V_206 -> V_12 , 0 ) ;
F_4 ( & V_206 -> V_148 , 0x9512a254 ) ;
F_4 ( & V_206 -> V_149 , 0x03310000 ) ;
F_4 ( & V_206 -> V_150 , 0x06600f38 ) ;
F_4 ( & V_206 -> V_151 , 0x00000409 ) ;
F_4 ( & V_206 -> V_55 , 0 ) ;
F_4 ( & V_206 -> V_57 , 0 ) ;
F_4 ( & V_206 -> V_59 , 0x01e002d0 ) ;
F_4 ( & V_206 -> V_153 , 0x00000090 ) ;
F_4 ( & V_206 -> V_152 , 0x000000ff ) ;
}
static int F_100 ( struct V_69 * V_69 , struct V_207 * V_208 )
{
struct V_44 * V_45 = V_69 -> V_190 ;
struct V_7 * V_8 = V_45 -> V_8 ;
int V_94 ;
F_2 ( 1 , L_45 , ( unsigned long ) V_208 ) ;
if ( F_85 ( & V_8 -> V_186 ) )
return - V_187 ;
V_94 = F_101 ( & V_45 -> V_87 , V_208 ) ;
F_87 ( & V_8 -> V_186 ) ;
F_2 ( 1 , L_46 ,
( unsigned long ) V_208 -> V_209 ,
( unsigned long ) V_208 -> V_210 - ( unsigned long ) V_208 -> V_209 ,
V_94 ) ;
return V_94 ;
}
...
struct V_181 * V_134 ;
struct V_213 V_214 ;
struct V_9 T_8 * V_215 ;
struct V_216 * V_217 ;
int V_94 , V_218 ;
struct V_219 * V_219 ;
V_94 = F_103 ( V_212 -> V_8 . V_220 , 0 , & V_214 ) ;
if ( V_94 ) {
F_104 ( & V_212 -> V_8 , L_47 ) ;
return - V_221 ;
}
V_218 = F_105 ( V_212 -> V_8 . V_220 , 0 ) ;
if ( V_218 == V_222 ) {
F_104 ( & V_212 -> V_8 , L_48 ) ;
return - V_58 ;
}
if ( ! F_106 ( & V_212 -> V_8 , V_214 . V_223 ,
sizeof( struct V_9 ) , V_224 ) ) {
F_104 ( & V_212 -> V_8 , L_49 ) ;
V_94 = - V_184 ;
goto V_106;
}
V_215 = F_107 ( & V_212 -> V_8 , V_214 . V_223 , sizeof( struct V_9 ) ) ;
if ( ! V_215 ) {
F_104 ( & V_212 -> V_8 , L_50 ) ;
V_94 = - V_189 ;
goto V_106;
}
V_7 = F_108 ( & V_212 -> V_8 , sizeof( struct V_7 ) , V_225 ) ;
if ( ! V_7 ) {
F_104 ( & V_212 -> V_8 , L_51 ) ;
V_94 = - V_189 ;
goto V_106;
}
V_7 -> V_10 = V_215 ;
...
if ( V_94 < 0 ) {
F_104 ( & V_212 -> V_8 , L_54 , V_94 ) ;
goto V_106;
}
V_217 = F_111 ( 0 ) ;
V_7 -> V_227 = F_112 ( & V_7 -> V_226 , V_217 ,
L_55 , V_228 , NULL ) ;
...
memcpy ( V_134 , & V_232 , sizeof( V_232 ) ) ;
V_134 -> V_226 = & V_7 -> V_226 ;
V_7 -> V_134 = V_134 ;
F_115 ( & V_7 -> V_186 ) ;
V_7 -> V_134 -> V_186 = & V_7 -> V_186 ;
F_88 ( & V_7 -> V_107 ) ;
F_116 ( V_7 -> V_134 , V_7 ) ;
F_93 ( & V_7 -> V_186 ) ;
V_94 = F_117 ( V_7 -> V_134 , V_233 , - 1 ) ;
if ( V_94 < 0 ) {
F_118 ( V_7 -> V_134 ) ;
goto V_231;
}
V_219 = F_119 ( & V_212 -> V_8 , L_56 ) ;
if ( F_120 ( V_219 ) ) {
F_104 ( & V_212 -> V_8 , L_57 ) ;
V_94 = F_121 ( V_219 ) ;
goto V_234;
}
V_94 = F_122 ( V_219 ) ;
if ( V_94 ) {
F_104 ( & V_212 -> V_8 , L_58 ) ;
goto V_234;
}
V_7 -> V_219 = V_219 ;
F_99 ( V_7 -> V_10 ) ;
if ( F_123 ( V_7 -> V_167 , F_81 , 0 , L_20 , ( void * ) V_7 ) ) {
F_104 ( & V_212 -> V_8 , L_59 ) ;
V_94 = - V_221 ;
goto V_235;
}
F_87 ( & V_7 -> V_186 ) ;
F_124 ( & V_212 -> V_8 , L_60 ) ;
return V_94 ;
V_235:
F_125 ( V_7 -> V_219 ) ;
V_234:
...
static int F_134 ( struct V_211 * V_212 , T_9 V_28 )
{
struct V_236 * V_226 = F_131 ( & V_212 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_226 , struct V_7 , V_226 ) ;
F_135 ( V_8 -> V_219 ) ;
