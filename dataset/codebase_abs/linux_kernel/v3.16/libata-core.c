...
unsigned int V_534 = V_5 -> V_273 -> V_535 ;
unsigned int V_25 , V_108 ;
if ( F_5 ( V_5 -> V_211 & V_212 ) )
return NULL ;
for ( V_25 = 0 , V_108 = V_5 -> V_536 + 1 ; V_25 < V_534 ; V_25 ++ , V_108 ++ ) {
V_108 = V_108 < V_534 ? V_108 : 0 ;
if ( V_108 == V_111 )
continue;
if ( ! F_69 ( V_108 , & V_5 -> V_216 ) ) {
V_194 = F_71 ( V_5 , V_108 ) ;
...
case V_521 :
if ( V_194 -> V_68 . V_72 != V_544 &&
V_194 -> V_68 . V_72 != V_545 )
break;
case V_525 :
case V_546 :
...
if ( F_207 ( V_194 ) )
goto V_555;
if ( F_5 ( V_194 -> V_15 -> V_42 & V_550 ) ) {
V_3 -> V_543 . V_494 |= V_557 ;
F_229 ( & V_3 -> V_543 , L_155 ) ;
F_230 ( V_3 ) ;
return;
}
V_5 -> V_214 -> V_558 ( V_194 ) ;
V_194 -> V_158 |= V_5 -> V_214 -> V_559 ( V_194 ) ;
if ( F_5 ( V_194 -> V_158 ) )
goto V_560;
return;
V_555:
...
{
struct V_4 * V_5 = V_3 -> V_5 ;
return ( V_5 -> V_42 & V_448 ) && V_5 -> V_214 -> V_561 ;
}
int F_127 ( struct V_2 * V_3 , int V_562 , T_1 * V_563 )
{
if ( F_13 ( V_3 ) ) {
if ( F_104 ( V_3 ) )
return V_3 -> V_5 -> V_214 -> V_561 ( V_3 , V_562 , V_563 ) ;
return - V_392 ;
}
...
if ( F_13 ( V_3 ) ) {
if ( F_104 ( V_3 ) )
return V_3 -> V_5 -> V_214 -> V_564 ( V_3 , V_562 , V_563 ) ;
return - V_392 ;
}
...
int V_181 ;
if ( F_104 ( V_3 ) ) {
V_181 = V_3 -> V_5 -> V_214 -> V_564 ( V_3 , V_562 , V_563 ) ;
if ( V_181 == 0 )
V_181 = V_3 -> V_5 -> V_214 -> V_561 ( V_3 , V_562 , & V_563 ) ;
return V_181 ;
}
return - V_392 ;
}
...
unsigned int V_494 , unsigned int V_567 ,
bool V_568 )
{
struct V_2 * V_3 ;
unsigned long V_42 ;
if ( V_5 -> V_211 & V_569 ) {
F_234 ( V_5 ) ;
F_87 ( V_5 -> V_211 & V_569 ) ;
}
F_67 ( V_5 -> V_210 , V_42 ) ;
V_5 -> V_570 = V_566 ;
V_5 -> V_211 |= V_569 ;
F_198 (link, ap, HOST_FIRST) {
V_3 -> V_543 . V_494 |= V_494 ;
...
int F_254 ( struct V_519 * V_273 , T_6 V_566 )
{
V_273 -> V_15 -> V_579 . V_580 = V_566 ;
return 0 ;
}
void F_255 ( struct V_519 * V_273 )
{
V_273 -> V_15 -> V_579 . V_580 = V_581 ;
}
...
T_2 V_136 ;
int V_181 ;
V_181 = F_127 ( V_3 , V_388 , & V_3 -> V_589 ) ;
if ( V_181 )
return V_181 ;
...
{
struct V_519 * V_273 = F_273 ( V_616 ) ;
int V_25 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_618 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_619 [ V_25 ] ;
if ( ! V_5 )
continue;
if ( V_5 -> V_293 )
F_274 ( V_5 -> V_293 ) ;
...
F_275 ( V_5 -> V_12 ) ;
F_275 ( V_5 ) ;
V_273 -> V_619 [ V_25 ] = NULL ;
}
F_276 ( V_616 , NULL ) ;
}
struct V_519 * F_277 ( struct V_21 * V_15 , int V_620 )
{
struct V_519 * V_273 ;
T_5 V_621 ;
int V_25 ;
...
return NULL ;
V_621 = sizeof( struct V_519 ) + ( V_620 + 1 ) * sizeof( void * ) ;
V_273 = F_279 ( F_272 , V_621 , V_590 ) ;
if ( ! V_273 )
goto V_264;
F_280 ( V_15 , V_273 ) ;
F_276 ( V_15 , V_273 ) ;
...
struct V_519 * V_273 ;
int V_25 , V_337 ;
V_273 = F_277 ( V_15 , V_618 ) ;
if ( ! V_273 )
return NULL ;
for ( V_25 = 0 , V_337 = 0 , V_626 = NULL ; V_25 < V_273 -> V_618 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_619 [ V_25 ] ;
if ( V_625 [ V_337 ] )
V_626 = V_625 [ V_337 ++ ] ;
V_5 -> V_44 = V_626 -> V_44 ;
...
V_5 -> V_214 = V_626 -> V_628 ;
if ( ! V_273 -> V_214 && ( V_626 -> V_628 != & V_629 ) )
V_273 -> V_214 = V_626 -> V_628 ;
}
return V_273 ;
}
...
struct V_519 * V_273 = F_273 ( V_616 ) ;
int V_25 ;
F_87 ( ! ( V_273 -> V_42 & V_632 ) ) ;
for ( V_25 = 0 ; V_25 < V_273 -> V_618 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_619 [ V_25 ] ;
if ( V_5 -> V_214 -> V_633 )
V_5 -> V_214 -> V_633 ( V_5 ) ;
}
if ( V_273 -> V_214 -> V_634 )
V_273 -> V_214 -> V_634 ( V_273 ) ;
}
static void F_287 ( struct V_635 * V_214 )
{
static F_288 ( V_210 ) ;
const struct V_635 * V_481 ;
void * * V_636 = ( void * * ) V_214 ;
void * * V_637 = ( void * * ) & V_214 -> V_638 ;
void * * V_639 ;
if ( ! V_214 || ! V_214 -> V_638 )
return;
F_289 ( & V_210 ) ;
for ( V_481 = V_214 -> V_638 ; V_481 ; V_481 = V_481 -> V_638 ) {
void * * V_640 = ( void * * ) V_481 ;
...
if ( ! ( V_5 -> V_273 -> V_42 & V_468 ) && V_5 -> V_623 != 0 )
F_301 ( V_649 ) ;
( void ) F_299 ( V_5 ) ;
F_301 ( V_649 ) ;
F_302 ( V_5 , 1 ) ;
}
int F_303 ( struct V_519 * V_273 , struct V_650 * V_651 )
{
int V_25 , V_181 ;
V_273 -> V_535 = F_304 ( V_651 -> V_294 , 1 , V_295 - 1 ) ;
if ( ! ( V_273 -> V_42 & V_632 ) ) {
F_294 ( V_273 -> V_15 , L_159 ) ;
F_87 ( 1 ) ;
return - V_119 ;
}
for ( V_25 = V_273 -> V_618 ; V_273 -> V_619 [ V_25 ] ; V_25 ++ )
F_275 ( V_273 -> V_619 [ V_25 ] ) ;
for ( V_25 = 0 ; V_25 < V_273 -> V_618 ; V_25 ++ ) {
V_273 -> V_619 [ V_25 ] -> V_31 = F_305 ( & V_652 ) ;
V_273 -> V_619 [ V_25 ] -> V_592 = V_25 + 1 ;
}
for ( V_25 = 0 ; V_25 < V_273 -> V_618 ; V_25 ++ ) {
V_181 = F_306 ( V_273 -> V_15 , V_273 -> V_619 [ V_25 ] ) ;
if ( V_181 ) {
goto V_653;
}
}
V_181 = F_307 ( V_273 , V_651 ) ;
if ( V_181 )
goto V_653;
for ( V_25 = 0 ; V_25 < V_273 -> V_618 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_619 [ V_25 ] ;
...
V_653:
while ( -- V_25 >= 0 ) {
F_310 ( V_273 -> V_619 [ V_25 ] ) ;
}
return V_181 ;
}
int F_311 ( struct V_519 * V_273 , int V_654 ,
...
if ( ! V_654 ) {
F_87 ( V_655 ) ;
return F_303 ( V_273 , V_651 ) ;
}
V_181 = F_312 ( V_273 -> V_15 , V_654 , V_655 , V_656 ,
F_313 ( V_273 -> V_15 ) , V_273 ) ;
if ( V_181 )
return V_181 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_618 ; V_25 ++ )
F_314 ( V_273 -> V_619 [ V_25 ] , L_162 , V_654 ) ;
V_181 = F_303 ( V_273 , V_651 ) ;
if ( V_181 )
F_315 ( V_273 -> V_15 , V_654 , V_273 ) ;
return V_181 ;
}
...
void F_321 ( struct V_519 * V_273 )
{
int V_25 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_618 ; V_25 ++ )
F_316 ( V_273 -> V_619 [ V_25 ] ) ;
F_322 ( V_273 ) ;
}
void F_323 ( struct V_661 * V_662 )
{
struct V_519 * V_273 = F_324 ( V_662 ) ;
F_321 ( V_273 ) ;
}
...
{
struct V_519 * V_273 = F_340 ( V_662 ) ;
F_321 ( V_273 ) ;
return 0 ;
}
...
{ L_209 , . V_41 = V_677 } ,
{ L_210 , . V_41 = V_678 } ,
{ L_211 , . V_41 = V_677 | V_678 } ,
{ L_212 , . V_41 = V_679 } ,
{ L_213 , . V_49 = V_356 } ,
{ L_214 , . V_49 = V_316 } ,
} ;
char * V_464 = * V_481 , * V_148 = * V_481 ;
char * V_143 , * V_563 , * V_680 ;
...
if ( V_148 ) {
* V_148 ++ = '\0' ;
V_673 -> V_21 = F_343 ( V_148 , & V_680 , 10 ) ;
if ( V_148 == V_680 || * V_680 != '\0' ) {
* V_255 = L_215 ;
return - V_119 ;
}
}
V_673 -> V_30 = F_343 ( V_143 , & V_680 , 10 ) ;
if ( V_148 == V_680 || * V_680 != '\0' ) {
* V_255 = L_216 ;
return - V_119 ;
}
...
for ( V_481 = V_689 ; * V_481 != '\0' ; V_481 = V_23 ) {
const char * V_255 = L_67 ;
struct V_27 V_691 = { . V_30 = - 1 , . V_21 = - 1 } ;
V_23 = V_481 ;
if ( F_341 ( & V_23 , & V_691 , & V_255 ) ) {
F_345 ( V_690 L_221
L_222 ,
V_481 , V_255 ) ;
continue;
...
{
bool V_696 = V_5 && V_5 -> V_273 -> V_697 == V_698 ;
if ( V_696 )
F_77 ( V_5 ) ;
F_180 ( V_695 ) ;
if ( V_696 )
...
T_1 F_356 ( struct V_4 * V_5 , void T_11 * V_562 , T_1 V_390 , T_1 V_563 ,
...
while ( ( V_386 & V_390 ) == V_563 && F_173 ( V_465 , V_463 ) ) {
F_174 ( V_5 , V_477 ) ;
V_386 = F_357 ( V_562 ) ;
}
return V_386 ;
...
int F_360 ( const struct V_4 * V_5 , const char * V_699 ,
const char * V_700 , ... )
{
struct V_701 V_702 ;
T_12 args ;
...
V_702 . V_700 = V_700 ;
V_702 . V_704 = & args ;
V_703 = F_345 ( L_225 , V_699 , V_5 -> V_31 , & V_702 ) ;
va_end ( args ) ;
return V_703 ;
}
int F_361 ( const struct V_2 * V_3 , const char * V_699 ,
const char * V_700 , ... )
{
struct V_701 V_702 ;
T_12 args ;
...
int F_362 ( const struct V_14 * V_15 , const char * V_699 ,
const char * V_700 , ... )
{
struct V_701 V_702 ;
T_12 args ;
...
void F_363 ( const struct V_21 * V_15 , const char * V_705 )
{
F_364 ( V_271 , V_15 , L_227 , V_705 ) ;
}
