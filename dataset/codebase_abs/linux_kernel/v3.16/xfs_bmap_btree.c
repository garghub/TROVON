...
args . V_86 = V_67 -> V_70 ;
args . V_13 = V_67 -> V_69 ;
args . V_87 = V_67 -> V_71 . V_40 . V_73 ;
args . V_73 = args . V_87 ;
if ( args . V_87 == V_78 ) {
args . V_87 = F_21 ( V_84 -> V_55 ) ;
args . type = V_88 ;
args . V_89 = F_43 ( args . V_86 ) ;
} else if ( V_67 -> V_71 . V_40 . V_74 -> V_90 ) {
args . type = V_88 ;
} else {
args . type = V_91 ;
}
args . V_92 = args . V_93 = args . V_94 = 1 ;
args . V_95 = V_67 -> V_71 . V_40 . V_75 & V_96 ;
if ( ! args . V_95 && F_43 ( args . V_86 ) == 0 ) {
error = F_44 ( V_97 ) ;
goto V_98;
}
error = F_45 ( & args ) ;
...
ASSERT ( args . V_101 == 1 ) ;
V_67 -> V_71 . V_40 . V_73 = args . V_87 ;
V_67 -> V_71 . V_40 . V_82 ++ ;
V_67 -> V_71 . V_40 . V_6 -> V_79 . V_102 ++ ;
F_47 ( args . V_86 , V_67 -> V_71 . V_40 . V_6 , V_103 ) ;
F_48 ( args . V_86 , V_67 -> V_71 . V_40 . V_6 ,
V_104 , 1L ) ;
V_68 -> V_55 = F_28 ( args . V_87 ) ;
F_46 ( V_67 , V_100 ) ;
* V_85 = 1 ;
return 0 ;
V_98:
...
struct V_108 * V_86 = V_67 -> V_70 ;
V_39 V_87 = F_50 ( V_13 , F_51 ( V_107 ) ) ;
F_52 ( V_87 , 1 , V_67 -> V_71 . V_40 . V_74 , V_13 ) ;
V_6 -> V_79 . V_102 -- ;
F_47 ( V_86 , V_6 , V_103 ) ;
F_48 ( V_86 , V_6 , V_104 , - 1L ) ;
F_53 ( V_86 , V_107 ) ;
return 0 ;
}
STATIC int
...
int V_109 )
{
if ( V_109 == V_67 -> V_110 - 1 ) {
struct V_111 * V_62 ;
V_62 = F_55 ( V_67 -> V_71 . V_40 . V_6 ,
V_67 -> V_71 . V_40 . V_72 ) ;
return F_56 ( V_67 -> V_69 ,
V_62 -> V_112 , V_109 == 0 ) / 2 ;
}
return V_67 -> V_69 -> V_113 [ V_109 != 0 ] ;
}
int
F_57 (
struct V_66 * V_67 ,
...
return V_67 -> V_69 -> V_114 [ V_109 != 0 ] ;
}
STATIC int
F_58 (
struct V_66 * V_67 ,
...
if ( V_109 != V_67 -> V_110 - 1 )
return V_67 -> V_69 -> V_114 [ V_109 != 0 ] ;
return F_6 ( V_67 -> V_71 . V_40 . V_115 , V_109 == 0 ) ;
}
STATIC void
F_59 (
union V_116 * V_117 ,
...
union V_118 * V_119 )
{
ASSERT ( V_117 -> V_120 . V_35 != 0 ) ;
F_27 ( & V_119 -> V_120 , F_21 ( V_117 -> V_120 . V_35 ) ,
0 , 0 , V_4 ) ;
}
STATIC void
F_61 (
...
union V_118 * V_119 )
{
F_29 ( & V_119 -> V_120 , & V_67 -> V_121 . V_40 ) ;
}
STATIC void
F_62 (
struct V_66 * V_67 ,
...
union V_116 * V_117 )
{
return ( T_14 ) F_21 ( V_117 -> V_120 . V_35 ) -
V_67 -> V_121 . V_40 . V_35 ;
}
static bool
F_64 (
struct V_106 * V_107 )
{
struct V_12 * V_13 = V_107 -> V_123 -> V_124 ;
struct V_9 * V_125 = F_65 ( V_107 ) ;
unsigned int V_109 ;
switch ( V_125 -> V_53 ) {
case F_35 ( V_22 ) :
if ( ! F_3 ( & V_13 -> V_20 ) )
return false ;
if ( ! F_36 ( & V_125 -> V_54 . V_55 . V_56 , & V_13 -> V_20 . V_57 ) )
return false ;
if ( F_21 ( V_125 -> V_54 . V_55 . V_58 ) != V_107 -> V_126 )
return false ;
if ( F_21 ( V_125 -> V_54 . V_55 . V_127 ) == 0 )
return false ;
case F_35 ( V_26 ) :
break;
default:
...
V_109 = F_5 ( V_125 -> V_27 ) ;
if ( V_109 > F_66 ( V_13 -> V_128 [ 0 ] , V_13 -> V_128 [ 1 ] ) )
return false ;
if ( F_5 ( V_125 -> V_28 ) > V_13 -> V_114 [ V_109 != 0 ] )
return false ;
if ( ! V_125 -> V_54 . V_55 . V_59 ||
( V_125 -> V_54 . V_55 . V_59 != F_28 ( V_60 ) &&
! F_67 ( V_13 , F_21 ( V_125 -> V_54 . V_55 . V_59 ) ) ) )
return false ;
if ( ! V_125 -> V_54 . V_55 . V_61 ||
( V_125 -> V_54 . V_55 . V_61 != F_28 ( V_60 ) &&
! F_67 ( V_13 , F_21 ( V_125 -> V_54 . V_55 . V_61 ) ) ) )
return false ;
return true ;
}
static void
...
union V_116 * V_134 )
{
return F_21 ( V_133 -> V_120 . V_35 ) <
F_21 ( V_134 -> V_120 . V_35 ) ;
}
STATIC int
F_76 (
struct V_66 * V_67 ,
...
int V_72 )
{
struct V_111 * V_62 = F_55 ( V_6 , V_72 ) ;
struct V_66 * V_67 ;
V_67 = F_77 ( V_137 , V_138 ) ;
V_67 -> V_70 = V_86 ;
V_67 -> V_69 = V_13 ;
V_67 -> V_110 = F_5 ( V_62 -> V_139 -> V_27 ) + 1 ;
V_67 -> V_140 = V_141 ;
V_67 -> V_142 = V_13 -> V_20 . V_143 ;
V_67 -> V_144 = & V_145 ;
V_67 -> V_146 = V_24 | V_147 ;
if ( F_3 ( & V_13 -> V_20 ) )
V_67 -> V_146 |= V_25 ;
V_67 -> V_71 . V_40 . V_115 = F_78 ( V_6 , V_72 ) ;
...
V_148 -= F_79 ( V_13 ) ;
if ( V_149 )
return V_148 / sizeof( T_10 ) ;
return V_148 / ( sizeof( T_4 ) + sizeof( V_150 ) ) ;
}
int
F_6 (
int V_148 ,
...
V_148 -= sizeof( T_3 ) ;
if ( V_149 )
return V_148 / sizeof( V_151 ) ;
return V_148 / ( sizeof( V_152 ) + sizeof( V_153 ) ) ;
}
int
F_80 (
struct V_108 * V_86 ,
...
ASSERT ( ! ( V_86 && V_156 ) ) ;
if ( V_72 == V_157 )
ASSERT ( V_6 -> V_79 . V_158 == V_159 ) ;
else
ASSERT ( V_6 -> V_79 . V_160 == V_159 ) ;
V_67 = F_40 ( V_6 -> V_14 , V_86 , V_6 , V_72 ) ;
if ( ! V_67 )
return V_161 ;
error = F_81 ( V_67 , V_154 , V_156 ) ;
F_82 ( V_67 , error ? V_162 : V_163 ) ;
return error ;
}
