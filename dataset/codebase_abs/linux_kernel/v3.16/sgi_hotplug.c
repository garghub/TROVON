...
if ( V_47 == V_50 ) {
F_20 ( & V_5 -> V_9 -> V_49 -> V_40 , L_4 ,
V_46 . V_51 , V_46 . V_52 ) ;
return - V_16 ;
}
if ( V_47 ) {
F_20 ( & V_5 -> V_9 -> V_49 -> V_40 , L_5 ,
V_47 , V_46 . V_51 ) ;
return - V_27 ;
}
V_11 = F_3 ( V_5 -> V_9 ) ;
...
F_20 ( & V_5 -> V_9 -> V_49 -> V_40 , L_7 ) ;
return - V_16 ;
}
if ( ( V_54 == V_56 ) && ( V_47 == V_50 ) ) {
F_20 ( & V_5 -> V_9 -> V_49 -> V_40 , L_8 ,
V_46 . V_51 , V_46 . V_52 ) ;
return - V_16 ;
}
if ( ( V_54 == V_56 ) && V_47 ) {
F_20 ( & V_5 -> V_9 -> V_49 -> V_40 , L_9 ,
V_47 , V_46 . V_51 ) ;
return - V_27 ;
}
if ( ( V_54 == V_56 ) && ! V_47 )
...
F_12 (dev, &slot->pci_bus->devices, bus_list) {
if ( F_33 ( V_40 -> V_70 ) != V_5 -> V_33 + 1 )
continue;
V_63 ( V_40 ) ;
if ( F_27 () )
F_34 ( V_40 ) ;
...
T_5 V_78 ;
T_4 V_65 ;
V_76 = F_37 ( F_38 ( V_5 -> V_9 ) -> V_79 ) ;
if ( F_39 ( V_76 , & V_75 ) ) {
F_20 ( & V_5 -> V_9 -> V_49 -> V_40 , L_14 ) ;
V_75 = NULL ;
}
F_40 () ;
for (; ; ) {
...
F_25 ( & V_64 ) ;
if ( V_47 == 0 )
F_20 ( & V_5 -> V_9 -> V_49 -> V_40 , L_16 ) ;
else
F_20 ( & V_5 -> V_9 -> V_49 -> V_40 , L_17 , V_47 ) ;
return V_47 ;
}
static int F_49 ( struct V_28 * V_29 )
{
struct V_5 * V_5 = V_29 -> V_7 ;
struct V_39 * V_40 , * V_83 ;
int V_47 ;
T_6 V_84 = 0 ;
F_24 ( & V_64 ) ;
...
F_46 () ;
F_52 (dev, temp, &slot->pci_bus->devices, bus_list) {
if ( F_33 ( V_40 -> V_70 ) != V_5 -> V_33 + 1 )
continue;
F_53 ( V_40 ) ;
F_15 ( V_40 ) ;
...
static inline int F_58 ( struct V_28 * V_29 ,
T_7 * V_86 )
{
struct V_5 * V_5 = V_29 -> V_7 ;
struct V_11 * V_11 ;
...
F_20 ( & V_9 -> V_49 -> V_40 , L_19 ) ;
return V_47 ;
V_96:
F_20 ( & V_9 -> V_49 -> V_40 , L_20 ,
V_47 ) ;
V_91:
if ( V_47 == - V_32 )
F_20 ( & V_9 -> V_49 -> V_40 , L_21 ) ;
if ( V_29 )
F_59 ( V_29 ) ;
while ( ( V_29 = F_11 () ) )
F_64 ( V_29 ) ;
