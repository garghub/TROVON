...
{
struct V_2 * V_3 = V_40 -> V_42 -> V_43 ;
int V_33 = F_28 ( V_3 , V_1 , V_58 , 0 , V_31 , V_4 ) ;
F_38 ( V_1 , V_31 & V_59 , V_33 ) ;
return V_33 ;
}
static int F_39 ( struct V_39 * V_40 , T_1 V_4 ,
void * * V_60 , unsigned long * V_61 )
{
struct V_2 * V_3 = V_40 -> V_42 -> V_43 ;
struct V_1 * V_1 ;
if ( ! V_3 )
...
static int F_42 ( struct V_39 * V_40 , T_5 V_65 ,
...
static int T_6 F_46 ( char * V_74 )
{
V_75 = F_47 ( V_74 , NULL , 0 ) ;
return 1 ;
}
static struct V_2 * F_48 ( int V_18 )
{
struct V_2 * V_3 ;
struct V_76 * V_77 ;
V_3 = F_49 ( sizeof( * V_3 ) , V_78 ) ;
if ( ! V_3 )
goto V_35;
V_3 -> V_79 = V_18 ;
F_50 ( & V_3 -> V_13 ) ;
...
V_3 -> V_81 -> V_84 . V_86 = V_87 ;
V_3 -> V_81 -> V_84 . V_88 = 1 ;
F_56 ( V_89 , V_3 -> V_81 ) ;
V_77 = V_3 -> V_90 = F_57 ( 1 << V_91 ) ;
if ( ! V_77 )
goto V_92;
V_77 -> V_93 = V_94 ;
V_77 -> V_95 = V_18 << V_91 ;
...
static struct V_2 * F_63 ( int V_18 )
{
struct V_2 * V_3 ;
...
static struct V_104 * F_70 ( T_7 V_105 , int * V_106 , void * V_107 )
{
struct V_2 * V_3 ;
struct V_104 * V_108 ;
F_43 ( & V_109 ) ;
V_3 = F_63 ( F_71 ( V_105 ) >> V_91 ) ;
V_108 = V_3 ? F_72 ( V_3 -> V_90 ) : NULL ;
F_45 ( & V_109 ) ;
* V_106 = 0 ;
return V_108 ;
}
...
F_64 (brd, &brd_devices, brd_list)
F_65 ( V_3 -> V_90 ) ;
F_76 ( F_77 ( V_94 , 0 ) , V_111 ,
V_119 , F_70 , NULL , NULL ) ;
F_78 ( V_120 L_3 ) ;
return 0 ;
V_118:
F_79 (brd, next, &brd_devices, brd_list) {
F_68 ( & V_3 -> V_102 ) ;
F_61 ( V_3 ) ;
}
F_80 ( V_94 , L_2 ) ;
...
unsigned long V_111 ;
struct V_2 * V_3 , * V_112 ;
V_111 = V_115 ? V_115 << V_91 : 1UL << V_116 ;
F_79 (brd, next, &brd_devices, brd_list)
F_67 ( V_3 ) ;
F_82 ( F_77 ( V_94 , 0 ) , V_111 ) ;
F_80 ( V_94 , L_2 ) ;
}
