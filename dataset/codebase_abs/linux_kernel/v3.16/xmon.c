...
static long F_106 ( unsigned long V_100 )
{
unsigned int V_48 ;
V_100 &= ~ 3 ;
if ( ! F_107 ( V_100 ) ) {
...
if ( ! F_66 ( V_100 , & V_48 , sizeof( V_48 ) ) ) {
printf ( L_41 , V_100 ) ;
return 0 ;
}
...
printf ( L_128 V_99 L_129 V_99 L_32 , V_113 , F_102 ( V_160 ) ) ;
printf ( L_130 V_99 L_131 V_99 L_32 , V_154 , F_102 ( V_161 ) ) ;
return;
}
F_103 ( & V_162 ) ;
switch ( V_22 ) {
...
printf ( V_99 L_155 , V_211 , V_219 , V_219 , V_219 , V_219 ) ;
}
break;
}
V_217 = F_140 ( V_153 ) ;
...
void
F_141 ( unsigned long V_100 )
{
F_31 ( V_100 , L_159 , L_84 ) ;
}
void
F_137 ( void )
{
...
{
unsigned long V_27 , V_100 , V_374 ;
if ( setjmp ( V_111 ) == 0 ) {
V_58 = 1 ;
F_1 () ;
...
V_100 = V_345 [ V_208 ] . V_347 ;
if ( V_100 >= V_374 + V_375 ) {
printf ( L_248 ) ;
return;
}
switch ( V_373 ) {
case 'i' :
V_100 += F_178 ( V_100 , 16 , 1 ) ;
V_77 = L_249 ;
break;
default:
F_138 ( V_100 , 64 ) ;
