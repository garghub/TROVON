...
static void F_138 ( struct V_68 * V_29 ,
struct V_1 * V_2 ,
T_5 V_314 , bool V_315 )
{
}
...
V_29 -> V_30 -> V_390 |= V_392 ;
V_29 -> V_393 = sizeof( struct V_3 ) ;
V_29 -> V_394 = sizeof( struct V_12 ) ;
V_29 -> V_395 = sizeof( struct V_17 ) ;
memcpy ( V_23 -> V_396 , V_397 ,
sizeof( V_397 ) ) ;
memcpy ( V_23 -> V_398 , V_399 ,
sizeof( V_399 ) ) ;
memcpy ( V_23 -> V_147 , V_400 , sizeof( V_400 ) ) ;
for ( V_165 = V_401 ; V_165 < V_402 ; V_165 ++ ) {
struct V_403 * V_404 = & V_23 -> V_405 [ V_165 ] ;
switch ( V_165 ) {
case V_401 :
V_404 -> V_327 = V_23 -> V_396 ;
V_404 -> V_325 = F_93 ( V_397 ) ;
V_404 -> V_406 = V_23 -> V_147 ;
V_404 -> V_407 = F_93 ( V_400 ) ;
break;
case V_408 :
V_404 -> V_327 = V_23 -> V_398 ;
V_404 -> V_325 = F_93 ( V_399 ) ;
V_404 -> V_406 = V_23 -> V_147 + 4 ;
V_404 -> V_407 = F_93 ( V_400 ) - 4 ;
break;
default:
continue;
}
V_404 -> V_409 . V_410 = true ;
V_404 -> V_409 . V_411 = V_412 |
V_413 |
V_414 |
V_415 ;
V_404 -> V_409 . V_416 = 0x3 ;
V_404 -> V_409 . V_417 = 0x6 ;
memset ( & V_404 -> V_409 . V_418 , 0 ,
sizeof( V_404 -> V_409 . V_418 ) ) ;
V_404 -> V_409 . V_418 . V_419 [ 0 ] = 0xff ;
V_404 -> V_409 . V_418 . V_419 [ 1 ] = 0xff ;
V_404 -> V_409 . V_418 . V_420 = V_421 ;
V_29 -> V_30 -> V_405 [ V_165 ] = V_404 ;
V_404 -> V_422 . V_423 = true ;
V_404 -> V_422 . V_411 =
V_424 |
V_425 |
V_426 |
...
V_29 -> V_442 = 11 ;
if ( V_345 )
V_29 -> V_30 -> V_443 |= V_444 ;
if ( V_344 ) {
V_29 -> V_30 -> V_443 |= V_445 ;
...
V_23 -> V_446 = F_180 ( L_51 , V_29 -> V_30 -> V_447 ) ;
F_181 ( L_52 , 0666 , V_23 -> V_446 , V_23 , & V_448 ) ;
F_181 ( L_53 , 0666 , V_23 -> V_446 , V_23 ,
& V_449 ) ;
if ( ! V_23 -> V_192 )
F_181 ( L_54 , 0222 ,
V_23 -> V_446 ,
...
static int F_197 ( struct V_24 * V_462 ,
struct V_463 * V_80 )
{
struct V_44 * V_45 ;
struct V_22 * V_158 ;
...
! V_80 -> V_469 [ V_149 ] )
goto V_222;
V_466 = ( void * ) F_198 ( V_80 -> V_469 [ V_136 ] ) ;
V_123 = F_128 ( V_80 -> V_469 [ V_144 ] ) ;
V_464 = F_199 ( V_80 -> V_469 [ V_150 ] ) ;
V_158 = F_196 ( V_466 ) ;
if ( ! V_158 )
goto V_222;
F_200 (&data2->pending, skb, tmp) {
if ( ( unsigned long ) V_25 == V_464 ) {
...
V_190 -> V_146 . V_470 = F_128 ( V_80 -> V_469 [ V_471 ] ) ;
if ( ! ( V_123 & V_143 ) &&
( V_123 & V_472 ) ) {
if ( V_25 -> V_139 >= 16 ) {
...
static int F_202 ( struct V_24 * V_462 ,
struct V_463 * V_80 )
{
struct V_22 * V_158 ;
struct V_160 V_161 ;
...
! V_80 -> V_469 [ V_471 ] )
goto V_222;
V_473 = ( void * ) F_198 ( V_80 -> V_469 [ V_476 ] ) ;
V_474 = F_203 ( V_80 -> V_469 [ V_138 ] ) ;
V_475 = ( void * ) F_198 ( V_80 -> V_469 [ V_138 ] ) ;
V_25 = F_204 ( V_474 , V_478 ) ;
if ( V_25 == NULL )
goto V_291;
if ( V_474 > V_362 )
goto V_291;
memcpy ( F_15 ( V_25 , V_474 ) , V_475 , V_474 ) ;
V_158 = F_196 ( V_473 ) ;
if ( ! V_158 )
goto V_222;
...
V_161 . V_168 = F_128 ( V_80 -> V_469 [ V_477 ] ) ;
V_161 . signal = F_128 ( V_80 -> V_469 [ V_471 ] ) ;
...
static int F_205 ( struct V_24 * V_462 ,
struct V_463 * V_80 )
{
struct V_22 * V_23 ;
int V_479 = 1 ;
...
static int F_207 ( struct V_24 * V_480 , struct V_463 * V_80 )
{
unsigned int V_479 = V_327 ;
const char * V_481 = NULL ;
const struct V_343 * V_344 = NULL ;
bool V_345 = V_80 -> V_469 [ V_482 ] ;
bool V_346 = V_80 -> V_469 [ V_483 ] ;
bool V_192 ;
if ( V_80 -> V_469 [ V_484 ] )
V_479 = F_128 ( V_80 -> V_469 [ V_484 ] ) ;
if ( V_80 -> V_469 [ V_485 ] )
V_192 = true ;
else
V_192 = ( V_479 > 1 ) ;
if ( V_80 -> V_469 [ V_486 ] )
V_481 = F_198 ( V_80 -> V_469 [ V_486 ] ) ;
if ( V_80 -> V_469 [ V_487 ] ) {
T_5 V_145 = F_128 ( V_80 -> V_469 [ V_487 ] ) ;
if ( V_145 >= F_93 ( V_488 ) )
return - V_59 ;
V_344 = V_488 [ V_145 ] ;
}
return F_163 ( V_479 , V_481 , V_344 , V_345 ,
V_346 , V_192 ) ;
}
static int F_208 ( struct V_24 * V_480 , struct V_463 * V_80 )
{
struct V_22 * V_23 ;
int V_145 ;
if ( ! V_80 -> V_469 [ V_489 ] )
return - V_59 ;
V_145 = F_128 ( V_80 -> V_469 [ V_489 ] ) ;
F_164 ( & V_180 ) ;
F_81 (data, &hwsim_radios, list) {
if ( V_23 -> V_145 != V_145 )
continue;
...
static int F_209 ( struct V_491 * V_492 ,
unsigned long V_493 ,
void * V_494 )
{
struct V_495 * V_496 = V_494 ;
if ( V_493 != V_497 )
return V_498 ;
if ( V_496 -> V_499 == V_196 ) {
F_62 ( V_500 L_57
L_58 ) ;
V_196 = 0 ;
}
...
if ( V_291 )
return V_291 ;
V_354 = F_220 ( V_516 , L_60 ) ;
if ( F_168 ( V_354 ) ) {
V_291 = F_169 ( V_354 ) ;
goto V_517;
}
for ( V_124 = 0 ; V_124 < V_505 ; V_124 ++ ) {
