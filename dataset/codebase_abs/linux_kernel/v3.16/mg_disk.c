...
static int F_58 ( struct V_133 * V_134 , struct V_135 * V_136 )
{
...
static int F_60 ( struct V_139 * V_34 )
{
struct V_32 * V_33 = V_34 -> V_35 ;
struct V_1 * V_2 = V_33 -> V_2 ;
if ( F_9 ( V_2 , V_40 , V_72 ) )
...
V_2 = F_62 ( sizeof( struct V_1 ) , V_149 ) ;
if ( ! V_2 ) {
F_6 ( V_12 L_33 ,
V_146 , __LINE__ ) ;
V_3 = - V_150 ;
...
V_2 -> V_20 = F_64 ( V_145 -> V_155 , F_65 ( V_145 ) ) ;
if ( ! V_2 -> V_20 ) {
F_6 ( V_12 L_35 ,
V_146 , __LINE__ ) ;
V_3 = - V_98 ;
...
F_76 ( V_2 -> V_120 , V_173 ) ;
F_77 ( V_2 -> V_120 , V_69 ) ;
F_78 ( & V_2 -> V_49 ) ;
V_2 -> V_49 . V_174 = F_49 ;
V_2 -> V_49 . V_122 = ( unsigned long ) V_2 ;
V_2 -> V_175 = F_79 ( V_176 ) ;
if ( ! V_2 -> V_175 ) {
F_6 ( V_12 L_45 ,
V_146 , __LINE__ ) ;
V_3 = - V_150 ;
