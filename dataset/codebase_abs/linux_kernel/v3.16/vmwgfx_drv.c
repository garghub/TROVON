...
static int F_99 ( struct V_80 * V_71 , struct V_175 * V_176 )
{
struct V_21 * V_22 = F_87 ( V_71 ) ;
struct V_177 * V_178 ;
int V_23 = - V_88 ;
...
return V_23 ;
F_49 ( & V_178 -> V_179 ) ;
V_178 -> V_184 = F_100 ( V_22 -> V_157 , 10 ) ;
if ( F_5 ( V_178 -> V_184 == NULL ) )
goto V_185;
V_178 -> V_183 = F_101 ( V_22 ) ;
if ( F_102 ( V_178 -> V_183 ) )
goto V_186;
V_176 -> V_187 = V_178 ;
return 0 ;
V_186:
...
static struct V_181 * F_103 ( struct V_80 * V_71 ,
struct V_175 * V_176 ,
unsigned int V_188 )
{
int V_23 ;
struct V_177 * V_178 = V_177 ( V_176 ) ;
struct V_181 * V_182 ;
if ( V_176 -> V_189 -> type != V_190 ||
! ( V_188 & V_191 ) )
return NULL ;
V_23 = F_104 ( & V_71 -> V_192 ) ;
if ( F_5 ( V_23 != 0 ) )
return F_105 ( - V_193 ) ;
if ( V_176 -> V_194 ) {
F_28 ( & V_71 -> V_192 ) ;
...
V_182 = V_181 ( V_176 -> V_198 ) ;
V_23 = F_106 ( & V_182 -> V_136 , true ) ;
if ( F_5 ( V_23 != 0 ) )
V_182 = F_105 ( V_23 ) ;
return V_182 ;
}
static long F_107 ( struct V_199 * V_200 , unsigned int V_201 ,
unsigned long V_202 ,
long (* F_108)( struct V_199 * , unsigned int ,
unsigned long ) )
{
struct V_175 * V_176 = V_200 -> V_203 ;
struct V_80 * V_71 = V_176 -> V_189 -> V_71 ;
unsigned int V_204 = F_109 ( V_201 ) ;
struct V_181 * V_182 ;
unsigned int V_188 ;
long V_23 ;
if ( ( V_204 >= V_205 ) && ( V_204 < V_206 )
&& ( V_204 < V_205 + V_71 -> V_207 -> V_208 ) ) {
...
V_188 = V_210 -> V_188 ;
} else if ( ! F_110 ( V_204 , & V_188 ) )
return - V_79 ;
V_182 = F_103 ( V_71 , V_176 , V_188 ) ;
if ( F_5 ( F_102 ( V_182 ) ) ) {
F_2 ( L_59 , V_204 ) ;
return F_111 ( V_182 ) ;
}
V_23 = F_108 ( V_200 , V_201 , V_202 ) ;
if ( V_182 )
F_112 ( & V_182 -> V_136 ) ;
return V_23 ;
}
...
unsigned long V_202 )
{
return F_107 ( V_200 , V_201 , V_202 , & V_213 ) ;
}
static long F_114 ( struct V_199 * V_200 , unsigned int V_201 ,
unsigned long V_202 )
{
return F_107 ( V_200 , V_201 , V_202 , & V_214 ) ;
}
...
struct V_227 * V_198 )
{
struct V_181 * V_182 = V_181 ( V_198 ) ;
V_198 -> V_187 = NULL ;
F_85 ( V_182 ) ;
}
...
struct V_21 * V_22 = F_87 ( V_71 ) ;
struct V_177 * V_178 = V_177 ( V_176 ) ;
struct V_181 * V_229 = V_22 -> V_138 ;
struct V_181 * V_182 = V_181 ( V_176 -> V_198 ) ;
int V_23 = 0 ;
if ( ! V_22 -> V_109 ) {
V_23 = F_24 ( V_22 , true ) ;
if ( F_5 ( V_23 != 0 ) )
...
if ( V_229 ) {
F_7 ( V_229 != & V_22 -> V_135 ) ;
V_23 = F_122 ( & V_229 -> V_136 , false , V_178 -> V_184 ) ;
if ( F_5 ( V_23 != 0 ) )
goto V_231;
F_55 ( & V_229 -> V_136 , true , V_137 ) ;
...
struct V_181 * V_182 = V_181 ( V_176 -> V_198 ) ;
int V_23 ;
V_178 -> V_180 = F_125 ( V_176 -> V_198 ) ;
V_23 = F_122 ( & V_182 -> V_136 , false , V_178 -> V_184 ) ;
if ( F_5 ( ( V_23 != 0 ) ) ) {
F_14 ( L_62 ) ;
F_96 ( & V_178 -> V_180 ) ;
}
...
static void F_128 ( struct V_233 * V_89 )
{
struct V_80 * V_71 = F_129 ( V_89 ) ;
F_130 ( V_71 ) ;
}
static int V_170 ( struct V_234 * V_235 , unsigned long V_236 ,
void * V_237 )
{
struct V_21 * V_22 =
F_131 ( V_235 , struct V_21 , V_168 ) ;
switch ( V_236 ) {
case V_238 :
case V_239 :
F_132 ( & V_22 -> V_95 ) ;
...
static int F_136 ( struct V_233 * V_89 , T_5 V_35 )
{
struct V_80 * V_71 = F_129 ( V_89 ) ;
struct V_21 * V_22 = F_87 ( V_71 ) ;
if ( V_22 -> V_47 != 0 ) {
...
static int F_140 ( struct V_233 * V_89 )
{
F_139 ( V_89 , V_246 ) ;
F_141 ( V_89 ) ;
return F_142 ( V_89 ) ;
...
static int F_146 ( struct V_247 * V_248 )
{
struct V_233 * V_89 = F_144 ( V_248 ) ;
struct V_80 * V_71 = F_129 ( V_89 ) ;
struct V_21 * V_22 = F_87 ( V_71 ) ;
...
static void F_147 ( struct V_247 * V_248 )
{
struct V_233 * V_89 = F_144 ( V_248 ) ;
struct V_80 * V_71 = F_129 ( V_89 ) ;
struct V_21 * V_22 = F_87 ( V_71 ) ;
...
static int F_148 ( struct V_233 * V_89 , const struct V_252 * V_253 )
{
return F_149 ( V_89 , V_253 , & V_207 ) ;
}
static int T_6 F_150 ( void )
{
int V_23 ;
V_23 = F_151 ( & V_207 , & V_254 ) ;
if ( V_23 )
F_14 ( L_66 ) ;
return V_23 ;
}
