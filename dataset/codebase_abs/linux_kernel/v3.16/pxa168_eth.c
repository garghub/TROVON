...
V_19 -> V_271 = 0 ;
V_19 -> V_272 = & V_273 ;
F_120 ( & V_2 -> V_133 , F_49 ) ;
F_7 ( V_71 L_23 , V_253 ) ;
F_121 ( V_19 ) ;
V_2 -> V_248 = F_122 ( & V_259 -> V_19 ) ;
V_2 -> V_26 = V_274 ;
if ( V_2 -> V_248 -> V_275 )
V_2 -> V_26 = V_2 -> V_248 -> V_275 ;
V_2 -> V_125 = V_276 ;
if ( V_2 -> V_248 -> V_277 )
V_2 -> V_125 = V_2 -> V_248 -> V_277 ;
V_2 -> V_15 = V_2 -> V_248 -> V_278 ;
F_76 ( V_2 -> V_15 > 2 ) ;
F_123 ( V_19 , & V_2 -> V_45 , F_86 , V_2 -> V_26 ) ;
memset ( & V_2 -> V_41 , 0 , sizeof( struct V_279 ) ) ;
F_124 ( & V_2 -> V_41 ) ;
V_2 -> V_41 . V_280 = F_18 ;
...
V_2 -> V_235 -> V_282 = F_95 ;
V_2 -> V_235 -> V_283 = F_96 ;
snprintf ( V_2 -> V_235 -> V_284 , V_285 , L_25 ,
V_259 -> V_129 , V_259 -> V_284 ) ;
V_2 -> V_235 -> V_77 = & V_259 -> V_19 ;
V_2 -> V_235 -> V_286 = 0xffffffff ;
V_179 = F_126 ( V_2 -> V_235 ) ;
if ( V_179 )
goto V_287;
F_67 ( V_2 ) ;
V_179 = F_105 ( V_19 ) ;
...
static void F_140 ( struct V_258 * V_259 )
{
struct V_18 * V_19 = F_136 ( V_259 ) ;
F_40 ( V_19 ) ;
}
...
static int F_142 ( struct V_258 * V_259 , T_6 V_290 )
{
return - V_289 ;
}
