...
V_76 -> V_87 = V_210 ;
V_76 -> V_88 = V_210 - 1 ;
if ( F_177 ( V_76 -> V_157 , V_210 ) ) {
char V_211 [ V_212 ] ;
F_178 ( V_76 -> V_157 , V_211 ) ;
F_68 ( V_76 -> V_89 ,
L_8 ,
V_210 , V_211 ) ;
return V_213 ;
}
V_76 -> V_214 = F_179 ( V_76 -> V_157 ) ;
V_76 -> V_215 = F_179 ( V_76 -> V_157 ) - 1 ;
return 0 ;
}
STATIC int
F_180 (
...
if ( F_183 ( & V_76 -> V_15 ) )
goto error;
V_76 -> V_202 . V_221 = F_170 ;
V_76 -> V_202 . V_222 = F_168 ;
V_76 -> V_202 . V_223 = V_224 ;
V_76 -> V_202 . V_29 = V_225 ;
F_184 ( & V_76 -> V_202 ) ;
return V_76 ;
error:
F_14 ( V_76 ) ;
...
F_193 ( & V_2 -> V_37 , V_233 ) ;
F_194 ( V_2 , V_48 ) ;
}
F_195 ( NULL , V_233 , F_189 ) ;
F_147 ( & V_164 ) ;
...
{
F_160 ( V_233 ) ;
return F_190 ( V_232 , & V_233 , false ) ;
}
int
F_197 (
struct V_188 * V_232 )
...
int error = 0 , V_236 ;
struct V_1 * V_2 ;
F_190 ( V_232 , & V_233 , true ) ;
while ( ! F_33 ( & V_233 ) ) {
V_2 = F_163 ( & V_233 , struct V_1 , V_37 ) ;
F_164 ( & V_2 -> V_37 ) ;
V_236 = F_73 ( V_2 ) ;
F_69 ( V_2 ) ;
if ( ! error )
