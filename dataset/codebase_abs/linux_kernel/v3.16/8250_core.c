...
unsigned int V_337 = ( V_2 -> V_59 * 2 ) / V_294 ;
T_3 V_107 = V_337 / 32 ;
...
if ( ! V_2 -> V_124 )
break;
if ( ! F_156 ( V_2 -> V_124 , V_346 , L_23 ) ) {
V_213 = - V_348 ;
break;
}
if ( V_2 -> V_102 & V_349 ) {
V_2 -> V_14 = F_157 ( V_2 -> V_124 , V_346 ) ;
if ( ! V_2 -> V_14 ) {
F_158 ( V_2 -> V_124 , V_346 ) ;
V_213 = - V_238 ;
}
}
break;
...
static int
F_168 ( struct V_1 * V_2 , struct V_358 * V_359 )
{
if ( V_359 -> V_145 >= V_360 || V_359 -> V_145 < 0 ||
V_359 -> V_361 < 9600 || V_359 -> type < V_129 ||
V_359 -> type >= F_169 ( V_43 ) || V_359 -> type == V_362 ||
V_359 -> type == V_363 )
return - V_353 ;
return 0 ;
}
...
if ( V_373 )
V_366 = V_233 ;
for ( V_132 = 0 , V_6 = V_369 ;
V_132 < F_169 ( V_374 ) && V_132 < V_367 ;
V_132 ++ , V_6 ++ ) {
struct V_1 * V_2 = & V_6 -> V_2 ;
V_2 -> V_17 = V_374 [ V_132 ] . V_2 ;
V_2 -> V_145 = F_175 ( V_374 [ V_132 ] . V_145 ) ;
V_2 -> V_239 = V_374 [ V_132 ] . V_239 ;
V_2 -> V_59 = V_374 [ V_132 ] . V_361 * 16 ;
V_2 -> V_102 = V_374 [ V_132 ] . V_102 ;
V_2 -> V_16 = V_374 [ V_132 ] . V_16 ;
V_2 -> V_14 = V_374 [ V_132 ] . V_375 ;
V_2 -> V_20 = V_374 [ V_132 ] . V_376 ;
V_2 -> V_13 = V_374 [ V_132 ] . V_377 ;
F_26 ( V_2 ) ;
V_2 -> V_239 |= V_366 ;
if ( V_364 != NULL )
V_364 ( V_132 , & V_6 -> V_2 , & V_6 -> V_36 ) ;
}
}
static void
...
static void T_5
F_177 ( struct V_378 * V_379 , struct V_380 * V_381 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_367 ; V_132 ++ ) {
struct V_5 * V_6 = & V_369 [ V_132 ] ;
...
static void
F_180 ( struct V_383 * V_384 , const char * V_385 , unsigned int V_69 )
{
struct V_5 * V_6 = & V_369 [ V_384 -> V_386 ] ;
struct V_1 * V_2 = & V_6 -> V_2 ;
unsigned long V_102 ;
unsigned int V_151 ;
int V_387 = 1 ;
...
static int T_5 F_183 ( struct V_383 * V_384 , char * V_390 )
{
struct V_1 * V_2 ;
int V_294 = 9600 ;
int V_265 = 8 ;
int V_176 = 'n' ;
int V_391 = 'n' ;
if ( V_384 -> V_386 >= V_367 )
V_384 -> V_386 = 0 ;
V_2 = & V_369 [ V_384 -> V_386 ] . V_2 ;
if ( ! V_2 -> V_17 && ! V_2 -> V_14 )
return - V_274 ;
if ( V_390 )
F_184 ( V_390 , & V_294 , & V_176 , & V_265 , & V_391 ) ;
return F_185 ( V_2 , V_384 , V_294 , V_176 , V_265 , V_391 ) ;
}
...
{
struct V_1 * V_10 ;
if ( V_2 -> line >= F_169 ( V_369 ) )
return - V_274 ;
F_173 () ;
V_10 = & V_369 [ V_2 -> line ] . V_2 ;
V_10 -> V_17 = V_2 -> V_17 ;
V_10 -> V_14 = V_2 -> V_14 ;
...
void F_193 ( int line )
{
F_194 ( & V_3 , & V_369 [ line ] . V_2 ) ;
}
void F_195 ( int line )
{
struct V_5 * V_6 = & V_369 [ line ] ;
struct V_1 * V_2 = & V_6 -> V_2 ;
if ( V_6 -> V_36 & V_109 ) {
F_68 ( V_2 , V_30 , 0xE0 ) ;
F_49 ( V_6 ) ;
...
static int F_197 ( struct V_394 * V_381 )
{
struct V_395 * V_10 = F_198 ( & V_381 -> V_381 ) ;
struct V_5 V_396 ;
int V_213 , V_132 , V_366 = 0 ;
memset ( & V_396 , 0 , sizeof( V_396 ) ) ;
if ( V_373 )
V_366 = V_233 ;
for ( V_132 = 0 ; V_10 && V_10 -> V_102 != 0 ; V_10 ++ , V_132 ++ ) {
V_396 . V_2 . V_17 = V_10 -> V_17 ;
V_396 . V_2 . V_14 = V_10 -> V_14 ;
V_396 . V_2 . V_145 = V_10 -> V_145 ;
V_396 . V_2 . V_239 = V_10 -> V_239 ;
V_396 . V_2 . V_59 = V_10 -> V_59 ;
V_396 . V_2 . V_13 = V_10 -> V_13 ;
V_396 . V_2 . V_20 = V_10 -> V_20 ;
V_396 . V_2 . V_102 = V_10 -> V_102 ;
V_396 . V_2 . V_124 = V_10 -> V_124 ;
V_396 . V_2 . V_16 = V_10 -> V_16 ;
V_396 . V_2 . V_393 = V_10 -> V_393 ;
V_396 . V_2 . type = V_10 -> type ;
V_396 . V_2 . F_3 = V_10 -> F_3 ;
V_396 . V_2 . F_5 = V_10 -> F_5 ;
V_396 . V_2 . V_28 = V_10 -> V_28 ;
V_396 . V_2 . V_397 = V_10 -> V_397 ;
V_396 . V_2 . V_339 = V_10 -> V_339 ;
V_396 . V_2 . V_344 = V_10 -> V_344 ;
V_396 . V_2 . V_381 = & V_381 -> V_381 ;
V_396 . V_2 . V_239 |= V_366 ;
V_213 = F_199 ( & V_396 ) ;
if ( V_213 < 0 ) {
F_200 ( & V_381 -> V_381 , L_29
L_30 , V_132 ,
...
static int F_201 ( struct V_394 * V_381 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_367 ; V_132 ++ ) {
struct V_5 * V_6 = & V_369 [ V_132 ] ;
if ( V_6 -> V_2 . V_381 == & V_381 -> V_381 )
F_202 ( V_132 ) ;
}
return 0 ;
}
static int F_203 ( struct V_394 * V_381 , T_6 V_183 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_368 ; V_132 ++ ) {
struct V_5 * V_6 = & V_369 [ V_132 ] ;
if ( V_6 -> V_2 . type != V_129 && V_6 -> V_2 . V_381 == & V_381 -> V_381 )
F_194 ( & V_3 , & V_6 -> V_2 ) ;
}
return 0 ;
}
static int F_204 ( struct V_394 * V_381 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_368 ; V_132 ++ ) {
struct V_5 * V_6 = & V_369 [ V_132 ] ;
...
int V_132 ;
for ( V_132 = 0 ; V_132 < V_367 ; V_132 ++ )
if ( F_191 ( & V_369 [ V_132 ] . V_2 , V_2 ) )
return & V_369 [ V_132 ] ;
for ( V_132 = 0 ; V_132 < V_367 ; V_132 ++ )
if ( V_369 [ V_132 ] . V_2 . type == V_129 &&
V_369 [ V_132 ] . V_2 . V_17 == 0 )
return & V_369 [ V_132 ] ;
for ( V_132 = 0 ; V_132 < V_367 ; V_132 ++ )
if ( V_369 [ V_132 ] . V_2 . type == V_129 )
return & V_369 [ V_132 ] ;
...
F_105 ( & V_399 ) ;
V_396 = F_205 ( & V_6 -> V_2 ) ;
if ( V_396 && V_396 -> V_2 . type != V_273 ) {
if ( V_396 -> V_2 . V_381 )
F_206 ( & V_3 , & V_396 -> V_2 ) ;
V_396 -> V_2 . V_17 = V_6 -> V_2 . V_17 ;
V_396 -> V_2 . V_14 = V_6 -> V_2 . V_14 ;
V_396 -> V_2 . V_145 = V_6 -> V_2 . V_145 ;
V_396 -> V_2 . V_239 = V_6 -> V_2 . V_239 ;
V_396 -> V_2 . V_59 = V_6 -> V_2 . V_59 ;
V_396 -> V_2 . V_135 = V_6 -> V_2 . V_135 ;
V_396 -> V_2 . V_13 = V_6 -> V_2 . V_13 ;
V_396 -> V_2 . V_20 = V_6 -> V_2 . V_20 ;
V_396 -> V_2 . V_102 = V_6 -> V_2 . V_102 | V_400 ;
V_396 -> V_89 = V_6 -> V_89 ;
V_396 -> V_2 . V_124 = V_6 -> V_2 . V_124 ;
V_396 -> V_2 . V_393 = V_6 -> V_2 . V_393 ;
V_396 -> V_2 . V_135 = V_6 -> V_2 . V_135 ;
V_396 -> V_137 = V_6 -> V_137 ;
V_396 -> V_36 = V_6 -> V_36 ;
if ( V_396 -> V_2 . V_135 && ! V_396 -> V_137 )
V_396 -> V_137 = V_396 -> V_2 . V_135 ;
if ( V_6 -> V_2 . V_381 )
V_396 -> V_2 . V_381 = V_6 -> V_2 . V_381 ;
if ( V_6 -> V_2 . V_102 & V_382 )
F_176 ( V_396 , V_6 -> V_2 . type ) ;
F_26 ( & V_396 -> V_2 ) ;
if ( V_6 -> V_2 . F_3 )
V_396 -> V_2 . F_3 = V_6 -> V_2 . F_3 ;
if ( V_6 -> V_2 . F_5 )
V_396 -> V_2 . F_5 = V_6 -> V_2 . F_5 ;
if ( V_6 -> V_2 . V_28 )
V_396 -> V_2 . V_28 = V_6 -> V_2 . V_28 ;
if ( V_6 -> V_2 . V_339 )
V_396 -> V_2 . V_339 = V_6 -> V_2 . V_339 ;
if ( V_6 -> V_2 . V_344 )
V_396 -> V_2 . V_344 = V_6 -> V_2 . V_344 ;
if ( V_6 -> V_2 . V_397 )
V_396 -> V_2 . V_397 = V_6 -> V_2 . V_397 ;
if ( V_6 -> V_18 )
V_396 -> V_18 = V_6 -> V_18 ;
if ( V_6 -> V_19 )
V_396 -> V_19 = V_6 -> V_19 ;
if ( V_6 -> V_154 )
V_396 -> V_154 = V_6 -> V_154 ;
if ( V_364 != NULL )
V_364 ( 0 , & V_396 -> V_2 ,
& V_396 -> V_36 ) ;
V_213 = F_178 ( & V_3 , & V_396 -> V_2 ) ;
if ( V_213 == 0 )
V_213 = V_396 -> V_2 . line ;
}
F_109 ( & V_399 ) ;
return V_213 ;
}
void F_202 ( int line )
{
struct V_5 * V_396 = & V_369 [ line ] ;
F_105 ( & V_399 ) ;
F_206 ( & V_3 , & V_396 -> V_2 ) ;
if ( V_401 ) {
V_396 -> V_2 . V_102 &= ~ V_400 ;
V_396 -> V_2 . type = V_129 ;
V_396 -> V_2 . V_381 = & V_401 -> V_381 ;
V_396 -> V_36 = V_43 [ V_396 -> V_2 . type ] . V_102 ;
F_178 ( & V_3 , & V_396 -> V_2 ) ;
} else {
V_396 -> V_2 . V_381 = NULL ;
}
F_109 ( & V_399 ) ;
}
...
{
#undef V_409
#define V_409 "8250_core."
F_224 ( V_373 , & V_410 , & V_373 , 0644 ) ;
F_224 ( V_367 , & V_410 , & V_367 , 0644 ) ;
F_224 ( V_289 , & V_410 , & V_289 , 0644 ) ;
#ifdef F_56
F_225 ( V_409 , V_134 ,
& V_411 , . V_412 = & V_413 ,
0444 , - 1 ) ;
