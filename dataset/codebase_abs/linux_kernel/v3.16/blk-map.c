...
struct V_14 * V_15 , const struct V_37 * V_38 ,
int V_39 , unsigned int V_17 , T_2 V_18 )
{
struct V_5 * V_5 ;
int V_40 , V_41 = F_9 ( V_4 ) == V_22 ;
int V_42 = 0 ;
if ( ! V_38 || V_39 <= 0 )
return - V_6 ;
for ( V_40 = 0 ; V_40 < V_39 ; V_40 ++ ) {
unsigned long V_19 = ( unsigned long ) V_38 [ V_40 ] . V_43 ;
if ( ! V_38 [ V_40 ] . V_44 )
return - V_6 ;
if ( V_19 & F_24 ( V_2 ) )
V_42 = 1 ;
}
if ( V_42 || ( V_2 -> V_45 & V_17 ) || V_15 )
V_5 = F_25 ( V_2 , V_15 , V_38 , V_39 , V_41 ,
V_18 ) ;
else
V_5 = F_26 ( V_2 , NULL , V_38 , V_39 , V_41 , V_18 ) ;
if ( F_13 ( V_5 ) )
return F_14 ( V_5 ) ;
...
if ( ! V_17 || ! V_50 )
return - V_6 ;
V_52 = ! F_10 ( V_2 , V_51 , V_17 ) || F_29 ( V_50 ) ;
if ( V_52 )
V_5 = F_30 ( V_2 , V_50 , V_17 , V_18 , V_21 ) ;
else
V_5 = F_31 ( V_2 , V_50 , V_17 , V_18 ) ;
if ( F_13 ( V_5 ) )
return F_14 ( V_5 ) ;
if ( ! V_21 )
V_5 -> V_53 |= V_54 ;
