...
static int F_36 ( struct V_1 * V_2 , void T_2 * V_27 )
{
T_3 V_81 ;
if ( F_24 ( & V_81 , V_27 , sizeof( V_81 ) ) )
return - V_34 ;
if ( ! V_2 -> V_18 -> V_90 )
return - V_26 ;
return V_2 -> V_18 -> V_90 ( V_2 , V_81 ) ;
}
static int F_37 ( struct V_1 * V_2 , int type , int V_3 , T_1 V_4 ,
void T_2 * V_27 , struct V_23 * V_23 )
{
int V_20 ;
if ( type >= ( F_38 ( V_3 ) ? V_91 : V_21 ) )
return - V_22 ;
if ( ! V_2 -> V_18 )
return - V_26 ;
...
static struct V_1 * F_40 ( const char T_2 * V_104 , int V_3 )
{
#ifdef F_41
struct V_105 * V_106 ;
struct V_1 * V_2 ;
struct V_107 * V_108 = F_42 ( V_104 ) ;
if ( F_14 ( V_108 ) )
return F_43 ( V_108 ) ;
V_106 = F_44 ( V_108 -> V_109 ) ;
F_45 ( V_108 ) ;
if ( F_14 ( V_106 ) )
return F_43 ( V_106 ) ;
if ( F_39 ( V_3 ) )
