...
V_40 = F_25 ( V_29 ) ;
if ( V_40 -> V_41 )
V_40 = F_26 ( & V_40 -> V_41 -> V_42 , struct V_39 , V_43 ) ;
V_29 = F_27 ( V_40 ) ;
if ( ! V_29 )
return NULL ;
V_29 = F_28 ( V_29 ) ;
...
static void * F_29 ( struct V_28 * V_29 , void * V_44 )
{
...
static int F_32 ( struct V_17 * V_37 , int V_52 )
{
struct V_28 * V_56 ;
struct V_45 V_46 ;
int V_38 ;
...
V_52 = F_36 ( V_46 . V_53 , V_52 ) ;
F_7 ( L_17 , V_52 ) ;
V_57:
F_37 ( V_56 ) ;
return V_52 ;
}
static int F_38 ( struct V_17 * V_18 , int V_26 , int type )
{
int V_53 , V_9 ;
if ( type == V_58 )
V_9 = F_19 ( V_18 , V_26 ) ;
...
F_41 ( & V_18 -> V_37 ,
L_19 ) ;
F_42 ( V_18 , V_18 -> V_65 + V_66 , & V_63 ) ;
V_64 = 0xffff0000 | ( ( V_63 >> ( 48 - 32 ) ) << 4 ) ;
F_43 ( V_18 , V_18 -> V_65 + V_67 , V_64 ) ;
F_43 ( V_18 , V_18 -> V_65 + V_66 , 0 ) ;
}
static int F_44 ( struct V_17 * V_18 , int V_68 , int type )
{
struct V_1 * V_2 ;
int V_69 , V_70 , V_71 , V_9 ;
struct V_22 * V_23 ;
struct V_72 V_73 ;
int V_26 = V_68 ;
int V_74 = 0 ;
...
if ( ! V_2 )
return - V_32 ;
if ( type == V_58 && F_39 ( V_18 ) )
return - V_62 ;
if ( type == V_58 ) {
int V_75 = F_45 ( V_26 ) ;
int V_53 = F_32 ( V_18 , V_75 ) ;
if ( V_53 >= V_75 )
V_26 = V_75 ;
}
V_76:
