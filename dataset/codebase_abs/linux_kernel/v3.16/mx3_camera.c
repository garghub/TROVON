...
unsigned char V_139 , unsigned long * V_93 )
{
...
if ( V_202 . V_55 != V_43 -> V_90 || V_202 . V_58 != V_43 -> V_88 )
F_74 ( V_17 , V_202 . V_55 , V_202 . V_58 ,
V_43 -> V_78 -> V_56 ) ;
F_10 ( V_43 -> V_46 , L_16 ,
V_202 . V_55 , V_202 . V_58 ) ;
V_43 -> V_90 = V_202 . V_55 ;
V_43 -> V_88 = V_202 . V_58 ;
return V_54 ;
}
...
{
struct V_162 * V_163 = V_232 -> V_20 . V_164 ;
struct V_1 * V_17 ;
struct V_233 * V_234 ;
void T_8 * V_4 ;
int V_235 = 0 ;
...
V_4 = F_95 ( & V_232 -> V_20 , V_234 ) ;
if ( F_96 ( V_4 ) )
return F_97 ( V_4 ) ;
if ( ! V_163 )
return - V_48 ;
V_17 = F_98 ( & V_232 -> V_20 , sizeof( * V_17 ) , V_237 ) ;
if ( ! V_17 ) {
F_29 ( & V_232 -> V_20 , L_26 ) ;
return - V_238 ;
}
V_17 -> V_134 = F_99 ( & V_232 -> V_20 , NULL ) ;
if ( F_96 ( V_17 -> V_134 ) )
return F_97 ( V_17 -> V_134 ) ;
V_17 -> V_163 = V_163 ;
V_17 -> V_116 = V_163 -> V_93 ;
if ( ! ( V_17 -> V_116 & V_239 ) ) {
...
V_136 -> V_245 = V_232 -> V_165 ;
V_17 -> V_60 = F_101 ( & V_232 -> V_20 ) ;
if ( F_96 ( V_17 -> V_60 ) )
return F_97 ( V_17 -> V_60 ) ;
if ( V_163 -> V_246 ) {
V_136 -> V_247 = V_163 -> V_247 ;
V_136 -> V_246 = V_163 -> V_246 ;
}
V_235 = F_102 ( V_136 ) ;
if ( V_235 )
goto V_248;
