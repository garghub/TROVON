...
static struct V_56 *
F_48 ( struct V_94 * V_95 , struct V_96 * V_97 , T_1 V_66 )
{
int V_58 ;
T_5 V_98 , V_99 ;
T_6 * V_100 ;
...
if ( ! V_105 )
goto V_71;
F_50 ( & V_102 , & V_77 , V_97 -> V_106 , V_97 -> V_107 ) ;
F_51 ( & V_102 , F_52 ( V_105 ) , V_108 ) ;
V_69 = F_41 ( & V_102 , 4 ) ;
if ( F_42 ( ! V_69 ) )
goto V_109;
V_98 = F_43 ( V_69 ) ;
...
V_65 = F_53 ( V_98 , sizeof( T_6 ) , V_66 ) ;
if ( ! V_65 )
goto V_109;
V_69 = F_41 ( & V_102 , V_98 << 2 ) ;
if ( F_42 ( ! V_69 ) )
goto V_112;
V_100 = & V_65 [ 0 ] ;
V_101 = 0 ;
...
V_43 = F_40 ( F_56 ( V_95 ) -> V_40 -> V_120 ,
& V_102 , V_66 ) ;
if ( V_43 )
F_57 ( & V_43 -> V_33 , & V_36 ) ;
}
...
static struct V_56 *
F_59 ( struct V_94 * V_94 , struct V_96 * V_122 , T_1 V_66 )
{
struct V_123 * V_124 ;
struct V_56 * V_125 , * V_126 ;
V_126 = F_48 ( V_94 , V_122 , V_66 ) ;
if ( ! V_126 ) {
F_2 ( V_111 L_39 ,
V_3 ) ;
return NULL ;
}
V_124 = F_60 ( & V_126 -> V_59 ) ;
V_125 = F_61 ( V_124 , struct V_56 , V_59 ) ;
if ( V_125 != V_126 ) {
F_27 ( V_126 ) ;
return V_125 ;
}
...
struct V_56 * V_57 = NULL ;
int V_132 , V_58 ;
struct V_38 * V_133 = F_56 ( V_94 ) ;
V_130 = V_133 -> V_40 -> V_134 -> V_135 . V_130 ;
V_131 = F_63 ( 0 , V_130 ) ;
F_7 ( L_40 ,
V_3 , V_94 , V_130 , V_131 ) ;
V_97 = F_32 ( sizeof( struct V_96 ) , V_66 ) ;
if ( V_97 == NULL )
return NULL ;
V_106 = F_32 ( V_131 * sizeof( struct V_104 * ) , V_66 ) ;
if ( V_106 == NULL ) {
F_26 ( V_97 ) ;
return NULL ;
}
for ( V_58 = 0 ; V_58 < V_131 ; V_58 ++ ) {
V_106 [ V_58 ] = F_49 ( V_66 ) ;
if ( ! V_106 [ V_58 ] )
goto V_136;
}
...
V_97 -> V_107 = V_130 ;
V_97 -> V_140 = 0 ;
V_97 -> V_141 = V_130 - V_142 ;
V_132 = F_64 ( V_133 , V_97 , V_129 ) ;
F_7 ( L_41 , V_3 , V_132 ) ;
if ( V_132 )
goto V_136;
V_57 = F_59 ( V_94 , V_97 , V_66 ) ;
V_136:
for ( V_58 = 0 ; V_58 < V_131 ; V_58 ++ )
F_58 ( V_106 [ V_58 ] ) ;
F_26 ( V_106 ) ;
...
void
F_65 ( struct V_56 * V_57 )
{
F_66 ( & V_57 -> V_59 ) ;
}
T_5
F_67 ( struct V_143 * V_144 , T_7 V_145 )
{
struct V_146 * V_147 = F_68 ( V_144 ) ;
T_8 V_82 ;
V_82 = V_145 - V_147 -> V_148 ;
F_69 ( V_82 , V_147 -> V_149 ) ;
V_82 += V_147 -> V_150 ;
return F_69 ( V_82 , V_147 -> V_57 -> V_114 ) ;
}
T_5
F_70 ( struct V_143 * V_144 , T_5 V_117 )
{
return F_68 ( V_144 ) -> V_57 -> V_65 [ V_117 ] ;
}
struct V_151 *
F_71 ( struct V_143 * V_144 , T_5 V_117 )
{
struct V_146 * V_147 = F_68 ( V_144 ) ;
T_5 V_58 ;
...
V_58 = F_70 ( V_144 , V_117 ) ;
} else
V_58 = V_117 ;
return V_147 -> V_155 [ V_58 ] ;
}
static void F_72 ( struct V_1 * V_2 )
{
F_73 () ;
F_74 ( & V_2 -> V_156 , V_157 ,
V_158 , V_159 ) ;
}
static void F_75 ( struct V_1 * V_2 )
{
F_76 () ;
F_77 ( V_157 , & V_2 -> V_156 ) ;
F_78 () ;
F_79 ( & V_2 -> V_156 , V_157 ) ;
}
struct V_1 *
F_80 ( struct V_143 * V_144 , T_5 V_160 )
{
struct V_56 * V_57 = F_68 ( V_144 ) -> V_57 ;
struct V_1 * V_2 = V_57 -> V_62 [ V_160 ] ;
struct V_123 * V_161 = F_81 ( V_144 ) ;
struct V_1 * V_162 = V_2 ;
if ( V_2 == NULL ) {
F_2 ( V_163 L_43 ,
V_3 , V_160 ) ;
F_82 ( V_161 ) ;
...
if ( V_2 -> V_6 )
goto V_164;
if ( F_84 ( V_157 , & V_2 -> V_156 ) == 0 ) {
struct V_38 * V_165 = F_56 ( V_144 -> V_166 -> V_167 ) ;
int V_168 ;
V_168 = F_14 ( V_165 , V_2 ) ;
if ( V_168 )
F_85 ( V_161 ) ;
F_75 ( V_2 ) ;
} else {
