...
F_18 ( V_10 ) ;
F_6 ( & V_27 -> V_36 ) ;
F_34 ( & V_2 -> V_124 , & V_27 -> V_37 ) ;
V_2 -> V_130 -> V_71 = 1 ;
F_42 ( V_143 , V_10 , V_116 , V_2 , V_176 ) ;
F_8 ( & V_27 -> V_36 ) ;
if ( ! V_2 -> V_133 || V_182 )
return;
F_25 (pr_reg_tmp, pr_reg_tmp_safe,
...
{
return F_53 ( V_40 -> V_47 -> V_192 ,
& V_40 -> V_193 . V_194 ) ;
}
static void F_54 ( struct V_39 * V_40 )
{
F_55 ( V_40 -> V_47 -> V_192 ,
& V_40 -> V_193 . V_194 ) ;
F_32 ( & V_40 -> V_195 ) ;
F_27 () ;
}
static int F_56 ( struct V_20 * V_116 )
{
struct V_39 * V_40 = V_116 -> V_42 ;
if ( V_116 -> V_196 )
return 0 ;
...
static void F_57 ( struct V_20 * V_116 )
{
struct V_39 * V_40 = V_116 -> V_42 ;
if ( V_116 -> V_196 ) {
F_32 ( & V_116 -> V_198 ) ;
...
V_212 = F_60 ( sizeof( struct V_211 ) , V_158 ) ;
if ( ! V_212 ) {
F_9 ( L_60 ) ;
return V_226 ;
}
...
V_212 = F_60 ( sizeof( struct V_211 ) ,
V_158 ) ;
if ( ! V_212 ) {
F_9 ( L_60 ) ;
F_33 ( V_205 ) ;
...
V_236 = ( strlen ( V_3 ) + 1 ) ;
V_55 = F_74 ( V_245 , V_3 , V_236 , 0 ) ;
if ( V_55 < 0 )
F_11 ( L_108 , V_250 ) ;
F_75 ( V_245 ) ;
return ( V_55 < 0 ) ? - V_252 : 0 ;
}
static T_2 F_76 ( struct V_9 * V_10 , bool V_121 )
{
unsigned char * V_3 ;
int V_41 ;
if ( ! V_121 ) {
char * V_253 = L_109 ;
V_41 = F_70 ( V_10 , V_253 ) ;
V_10 -> V_28 . V_174 = 0 ;
F_11 ( L_110 ) ;
if ( V_41 )
return V_226 ;
...
V_3 = F_60 ( V_254 , V_158 ) ;
if ( ! V_3 )
return V_255 ;
V_41 = F_69 ( V_10 , V_3 , V_254 ) ;
if ( V_41 < 0 ) {
F_61 ( V_3 ) ;
return V_255 ;
}
...
static T_2
F_77 ( struct V_7 * V_8 , T_3 V_256 , T_3 V_119 ,
...
static T_2
F_79 ( struct V_7 * V_8 , int type , int V_264 , T_3 V_256 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_49 * V_49 = V_8 -> V_49 ;
...
case V_34 :
case V_35 :
return F_79 ( V_8 , type , V_264 , V_256 ) ;
default:
F_9 ( L_148
L_149 , type ) ;
return V_261 ;
...
static T_2
F_85 ( struct V_7 * V_8 , int type , int V_264 , T_3 V_256 ,
...
static T_2
F_87 ( struct V_7 * V_8 , int type , int V_264 ,
...
case V_34 :
case V_35 :
return F_85 ( V_8 , type , V_264 , V_256 ,
V_119 , V_273 ) ;
default:
F_9 ( L_166
...
static unsigned long long F_89 ( unsigned char * V_58 )
{
