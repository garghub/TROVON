...
{
struct V_103 * V_103 = & V_18 -> V_104 -> V_105 -> V_104 ;
struct V_8 * V_9 ;
struct V_6 * V_7 ;
unsigned V_106 , V_107 ;
unsigned V_108 , V_109 ;
unsigned V_110 , V_111 , V_112 , V_113 , V_114 ;
int V_30 ;
V_110 = 32 ;
V_111 = 24 ;
V_108 = F_15 ( V_18 -> V_115 , ( unsigned ) 2048 ) ;
V_109 = F_15 ( V_18 -> V_116 , ( unsigned ) 2048 ) ;
V_106 = F_15 ( V_18 -> V_106 , V_108 ) ;
V_107 = F_15 ( V_18 -> V_107 , V_109 ) ;
V_113 = V_108 * V_110 / 8 ;
V_114 = V_113 * V_109 ;
V_112 = F_9 ( V_18 , V_41 ) ;
V_7 = F_37 ( sizeof( * V_9 ) , V_103 ) ;
if ( ! V_7 )
return - V_99 ;
V_18 -> V_6 = V_7 ;
V_9 = V_7 -> V_9 ;
...
V_9 -> V_27 = V_108 ;
V_9 -> V_29 = V_109 ;
V_9 -> V_117 = V_117 ( V_114 ) ;
if ( F_18 ( V_9 -> V_117 == NULL ) ) {
V_30 = - V_99 ;
goto V_118;
}
V_30 = F_31 ( V_18 , V_114 , & V_9 -> V_92 ) ;
if ( F_18 ( V_30 != 0 ) )
goto V_118;
V_30 = F_38 ( & V_9 -> V_92 -> V_119 ,
0 ,
V_9 -> V_92 -> V_119 . V_120 ,
& V_9 -> V_121 ) ;
if ( F_18 ( V_30 != 0 ) )
goto V_122;
V_9 -> V_47 = F_39 ( & V_9 -> V_121 , & V_9 -> V_123 ) ;
V_9 -> V_124 = V_114 ;
strcpy ( V_7 -> V_31 . V_125 , L_8 ) ;
V_7 -> V_31 . type = V_126 ;
V_7 -> V_31 . V_127 = V_128 ;
V_7 -> V_31 . V_129 = 0 ;
V_7 -> V_31 . V_130 = 1 ;
V_7 -> V_31 . V_131 = 1 ;
V_7 -> V_31 . V_132 = 0 ;
...
V_7 -> V_144 -> V_146 [ 0 ] . V_119 = V_18 -> V_147 ;
V_7 -> V_144 -> V_146 [ 0 ] . V_89 = V_18 -> V_148 ;
V_9 -> V_59 . V_62 = V_9 -> V_59 . V_63 = 0 ;
V_9 -> V_59 . y1 = V_9 -> V_59 . V_64 = 0 ;
V_9 -> V_59 . V_61 = true ;
F_41 ( & V_9 -> V_59 . V_60 ) ;
