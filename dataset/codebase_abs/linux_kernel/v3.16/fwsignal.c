...
int F_113 ( struct V_211 * V_75 )
{
struct V_6 * V_7 ;
T_1 V_268 = V_269 ;
int V_236 ;
T_1 V_89 ;
V_75 -> V_7 = F_114 ( sizeof( * ( V_75 -> V_7 ) ) , V_270 ) ;
if ( ! V_75 -> V_7 ) {
V_236 = - V_261 ;
goto V_131;
}
...
V_7 -> V_75 = V_75 ;
V_7 -> V_195 = V_195 ;
if ( ( V_75 -> V_76 -> V_272 == false ) &&
( V_195 == V_273 ) ) {
V_7 -> V_256 = true ;
F_25 ( V_198 , L_50 ) ;
return 0 ;
}
V_7 -> V_147 = F_116 ( L_51 ) ;
if ( V_7 -> V_147 == NULL ) {
F_15 ( L_52 ) ;
V_236 = - V_274 ;
goto V_131;
}
F_117 ( & V_7 -> V_148 , F_111 ) ;
if ( V_7 -> V_195 != V_273 )
V_268 |= V_275 |
V_276 |
V_277 |
V_278 ;
V_236 = F_118 ( V_75 , V_279 ,
F_94 ) ;
if ( V_236 < 0 ) {
F_15 ( L_53 ) ;
goto V_131;
}
V_236 = F_118 ( V_75 , V_280 ,
F_95 ) ;
if ( V_236 < 0 ) {
F_15 ( L_54 ) ;
F_119 ( V_75 , V_279 ) ;
...
V_7 -> V_218 = true ;
if ( F_120 ( V_75 -> V_106 [ 0 ] , L_55 , V_268 ) ) {
F_15 ( L_56 ) ;
V_7 -> V_195 = V_273 ;
V_7 -> V_218 = false ;
}
if ( F_120 ( V_75 -> V_106 [ 0 ] , L_57 , 1 ) )
F_25 ( V_198 , L_58 ) ;
if ( F_121 ( V_75 -> V_106 [ 0 ] , L_59 , & V_89 ) == 0 ) {
if ( F_45 ( V_89 ) ) {
V_89 = 0 ;
F_122 ( V_89 , 1 ) ;
if ( F_120 ( V_75 -> V_106 [ 0 ] ,
L_59 , V_89 ) == 0 ) {
F_122 ( V_7 -> V_89 , 1 ) ;
}
}
...
F_123 ( V_75 , & V_7 -> V_8 ) ;
F_25 ( V_198 , L_60 ,
V_7 -> V_218 ? L_61 : L_62 , V_268 ) ;
return 0 ;
V_131:
F_124 ( V_75 ) ;
return V_236 ;
}
void F_124 ( struct V_211 * V_75 )
{
struct V_6 * V_7 = V_75 -> V_7 ;
if ( ! V_7 )
return;
if ( V_75 -> V_7 -> V_147 )
F_125 ( V_75 -> V_7 -> V_147 ) ;
F_5 ( V_7 ) ;
F_39 ( V_7 , - 1 ) ;
V_75 -> V_7 = NULL ;
F_6 ( V_7 ) ;
...
if ( ! V_7 -> V_209 )
return false ;
return V_7 -> V_195 != V_273 ;
}
void F_127 ( struct V_6 * V_7 , struct V_11 * V_12 )
{
T_1 V_74 ;
...
void F_128 ( struct V_211 * V_75 , bool V_281 )
{
struct V_6 * V_7 = V_75 -> V_7 ;
V_7 -> V_267 = V_281 ;
if ( ! V_281 )
