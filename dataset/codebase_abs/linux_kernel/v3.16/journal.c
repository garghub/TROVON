...
F_161 ( F_160 ( V_2 ) -> V_186 ) ;
F_147 ( V_2 ) ;
F_162 ( V_2 ) ;
return 0 ;
}
int F_163 ( struct V_176 * V_177 ,
struct V_1 * V_2 )
{
...
if ( ! V_191 )
return 0 ;
V_188 = (struct V_187 * ) V_191 -> V_134 ;
if ( F_169 ( V_188 ) > 0
...
if ( ! V_194 )
return 0 ;
V_190 = (struct V_189 * ) V_194 -> V_134 ;
...
memcpy ( V_203 [ V_25 ] -> V_134 , V_202 [ V_25 ] -> V_134 ,
V_203 [ V_25 ] -> V_210 ) ;
F_66 ( V_203 [ V_25 ] ) ;
F_148 ( V_202 [ V_25 ] ) ;
}
...
F_111 ( V_2 ) +
F_181 ( V_85 -> V_133 ) ;
V_201 = F_181 ( V_85 -> V_131 ) + 1 ;
V_193 = F_181 ( V_85 -> V_135 ) ;
F_172 ( V_2 , V_196 ,
L_84
L_85
L_86 , F_181 ( V_85 -> V_133 ) ,
F_181 ( V_85 -> V_131 ) ) ;
V_219 = 1 ;
V_191 =
F_174 ( V_2 ,
...
static void F_149 ( struct V_1 * V_225 ,
struct V_3 * V_4 )
{
if ( V_4 -> V_222 != NULL ) {
...
V_4 -> V_148 = F_181 ( V_85 -> V_255 . V_257 ) ;
...
{
struct V_3 * V_4 = F_2 ( V_64 ) ;
F_215 ( V_279 , & V_4 -> V_151 ) ;
F_216 ( & V_4 -> V_269 ) ;
}
void F_217 ( struct V_1 * V_64 )
{
struct V_3 * V_4 = F_2 ( V_64 ) ;
F_218 ( V_4 -> V_269 ,
! F_41 ( V_279 , & V_4 -> V_151 ) ) ;
}
static void F_219 ( struct V_1 * V_64 )
{
T_6 V_280 ;
struct V_3 * V_4 = F_2 ( V_64 ) ;
F_19 ( V_281 , & V_4 -> V_151 ) ;
F_220 ( & V_280 , V_282 ) ;
F_221 ( & V_4 -> V_269 , & V_280 ) ;
F_222 ( V_283 ) ;
...
F_224 ( V_284 ) ;
F_225 ( & V_4 -> V_269 , & V_280 ) ;
}
static void F_226 ( struct V_1 * V_64 )
{
struct V_3 * V_4 = F_2 ( V_64 ) ;
if ( F_227 ( V_281 , & V_4 -> V_151 ) )
F_216 ( & V_4 -> V_269 ) ;
}
static void F_228 ( struct V_1 * V_2 , unsigned int V_66 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
int V_109 ;
F_32 ( V_2 , L_134 ) ;
F_81 ( V_287 > V_4 -> V_148 ) ;
F_40 ( V_2 , V_4 . V_291 ) ;
V_177 -> V_277 = 1 ;
V_177 -> V_275 = V_2 ;
V_292:
F_45 ( V_2 ) ;
if ( V_288 != V_293 && F_118 ( V_4 ) ) {
F_47 ( V_2 ) ;
V_114 = V_4 -> V_96 ;
goto V_294;
}
...
return F_230 ( V_177 , V_2 , 1 , V_303 ) ;
}
...
V_177 -> V_302 = V_301 ;
F_81 ( V_301 && V_301 -> V_277 > 1 ) ;
return F_230 ( V_177 , V_2 , 1 , V_293 ) ;
}
...
V_82 = F_230 ( V_177 , V_2 , V_287 , V_304 ) ;
F_81 ( V_282 -> V_300 != V_177 ) ;
if ( V_82 )
...
if ( V_4 -> V_116 > V_4 -> V_264 ) {
V_4 -> V_264 = V_4 -> V_116 + V_310 ;
}
F_238 ( V_9 ) ;
if ( ! V_46 ) {
V_46 = F_31 ( V_2 ) ;
...
return F_151 ( V_177 , V_296 | V_312 ) ;
}
static void V_272 ( struct V_313 * V_314 )
{
struct V_3 * V_4 =
F_244 ( V_314 , struct V_3 , V_184 . V_314 ) ;
...
1 ) ;
F_155 ( & V_177 , F_154 ( V_2 ) ) ;
F_151 ( & V_177 , V_296 | V_312 ) ;
}
}
}
static int F_246 ( struct V_176 * V_177 , int V_315 )
{
T_3 V_276 ;
...
&& ! V_316 && ! V_317 && ( V_4 -> V_116 < V_4 -> V_240 )
&& V_4 -> V_264 < V_4 -> V_240
&& V_4 -> V_47 > ( V_4 -> V_148 * 3 ) ) {
V_4 -> V_265 ++ ;
F_47 ( V_2 ) ;
...
F_250 ( V_94 ) -> V_322 = V_4 -> V_91 ;
F_250 ( V_94 ) -> V_323 = V_4 -> V_65 ;
}
...
{
unsigned int V_12 = F_250 ( V_94 ) -> V_323 ;
struct V_38 * V_39 = F_250 ( V_94 ) -> V_322 ;
if ( ! V_12 || ! V_39 ) {
F_249 ( V_94 ) ;
V_12 = F_250 ( V_94 ) -> V_323 ;
}
...
static int F_151 ( struct V_176 * V_177 , int V_315 )
{
struct V_1 * V_2 = V_177 -> V_275 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
F_66 ( V_191 ) ;
V_188 = (struct V_187 * ) ( V_191 ) -> V_134 ;
memset ( V_191 -> V_134 , 0 , V_191 -> V_210 ) ;
memcpy ( F_171 ( V_191 ) , V_195 , 8 ) ;
F_259 ( V_188 , V_4 -> V_65 ) ;
V_194 = F_179 ( V_2 , F_111 ( V_2 ) +
( ( V_4 -> V_119 + V_4 -> V_116 +
1 ) % F_112 ( V_2 ) ) ) ;
V_190 = (struct V_189 * ) V_194 -> V_134 ;
memset ( V_194 -> V_134 , 0 , V_194 -> V_210 ) ;
F_260 ( V_190 , V_4 -> V_65 ) ;
F_66 ( V_194 ) ;
V_39 = V_4 -> V_91 ;
F_46 ( & V_39 -> V_118 , V_2 ) ;
V_334 = V_39 -> V_65 ;
...
F_261 ( V_188 , V_4 -> V_116 ) ;
F_262 ( V_188 , V_4 -> V_135 ) ;
F_259 ( V_188 , V_4 -> V_65 ) ;
F_263 ( V_190 , V_4 -> V_116 ) ;
F_81 ( V_4 -> V_116 == 0 ) ;
F_119 ( V_191 ) ;
V_329 = V_4 -> V_119 ;
V_46 = V_4 -> V_268 ;
...
F_270 ( F_160 ( V_2 ) -> V_186 ,
& V_4 -> V_184 , V_111 / 10 ) ;
V_101:
F_271 (entry, safe, &journal->j_journal_list) {
V_331 = F_55 ( V_18 ) ;
if ( V_4 -> V_119 <= V_331 -> V_119 ) {
...
void F_272 ( struct V_1 * V_2 , int V_338 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
if ( F_41 ( V_339 , & V_4 -> V_151 ) )
return;
if ( ! V_4 -> V_96 )
V_4 -> V_96 = V_338 ;
V_2 -> V_180 |= V_181 ;
F_19 ( V_339 , & V_4 -> V_151 ) ;
#ifdef F_116
F_273 () ;
#endif
}
