...
int T_7 F_42 ( const char * V_14 , T_5 V_88 ,
T_6 V_89 ,
T_5 V_90 ,
T_6 V_91 )
{
const struct V_93 * V_94 ;
for ( V_94 = V_95 ; V_94 -> V_96 [ 0 ] ; V_94 ++ )
...
static int T_7 F_43 ( struct V_3 * V_4 ,
T_2 V_7 , T_2 V_8 ,
T_3 V_9 , T_3 V_10 )
{
...
int * V_104 , const T_8 * * V_105 ,
const T_8 * * V_106 )
{
const T_8 * V_107 ;
int V_108 , V_109 ;
* V_105 = F_45 ( V_100 , L_17 , & V_108 ) ;
if ( * V_105 == NULL ) {
* V_101 = * V_102 = * V_103 = * V_104 = 0 ;
* V_105 = * V_106 = NULL ;
return 0 ;
}
* V_106 = * V_105 + V_108 / sizeof( T_8 ) ;
* V_101 = F_46 ( V_100 ) ;
V_107 = F_45 ( V_100 , L_18 , NULL ) ;
* V_102 = F_47 ( V_107 ) ;
V_107 = F_45 ( V_100 , L_19 , NULL ) ;
* V_103 = F_47 ( V_107 ) ;
* V_104 = * V_101 + * V_102 + * V_103 ;
V_109 = ( * V_104 ) * sizeof( T_8 ) ;
if ( V_108 % V_109 ) {
F_48 ( L_20 , V_100 -> V_110 ) ;
return - V_43 ;
}
return 0 ;
}
...
int V_50 , V_112 , V_104 ;
const T_8 * V_113 , * V_105 , * V_106 ;
V_112 = F_44 ( V_111 , & V_101 , & V_102 ,
& V_103 , & V_104 ,
& V_105 , & V_106 ) ;
if ( V_112 < 0 )
return V_112 ;
for ( V_50 = 0 , V_113 = V_105 ; V_113 < V_106 ; V_113 += V_104 , V_50 ++ ) {
T_2 V_114 , V_7 , V_8 ;
T_3 V_9 , V_10 ;
V_114 = F_50 ( V_113 , 1 ) ;
if ( F_51 ( V_114 ) )
...
V_9 = F_52 ( V_114 ) ;
V_10 = F_53 ( V_114 ) ;
V_7 = F_50 ( V_113 + V_102 , V_101 ) ;
V_8 = F_50 ( V_113 + V_102 + V_101 ,
V_103 ) ;
V_112 = F_43 ( V_4 , V_7 , V_8 , V_9 , V_10 ) ;
if ( V_112 < 0 )
return V_112 ;
}
return 0 ;
}
static void T_7 F_54 ( struct V_99 * V_111 ,
struct V_78 * V_115 ,
struct V_78 * V_116 )
{
T_2 V_117 [ 2 ] ;
...
V_116 -> V_34 = - 1 ;
V_112 = F_55 ( V_111 , L_21 , V_117 , F_56 ( V_117 ) ) ;
if ( ! V_112 ) {
V_115 -> V_118 = V_117 [ 0 ] ;
V_115 -> V_34 = V_115 -> V_118 + V_117 [ 1 ] - 1 ;
V_115 -> V_119 = V_120 ;
}
V_112 = F_55 ( V_111 , L_22 , V_117 , F_56 ( V_117 ) ) ;
if ( ! V_112 ) {
V_116 -> V_118 = V_117 [ 0 ] ;
...
int T_7 F_57 ( bool V_122 )
{
struct V_78 V_123 , V_124 ;
struct V_99 * V_111 , * V_125 ;
const struct V_93 * V_94 ;
const T_8 * V_107 ;
int V_112 ;
V_111 = F_58 ( NULL , V_95 , & V_94 ) ;
if ( ! V_111 ) {
F_31 ( L_14 ) ;
return - V_41 ;
}
V_60 . V_14 = V_94 -> V_97 ;
V_107 = F_45 ( V_111 , L_23 , NULL ) ;
if ( ! V_107 ) {
F_31 ( L_24 ) ;
return - V_43 ;
}
V_125 = F_59 ( F_47 ( V_107 ) ) ;
if ( ! V_125 ) {
F_31 ( L_25 ) ;
return - V_41 ;
}
if ( F_60 ( V_125 , 0 , & V_123 ) ) {
F_31 ( L_26 ) ;
return - V_43 ;
}
if ( F_60 ( V_125 , 1 , & V_124 ) ) {
F_31 ( L_27 ) ;
return - V_43 ;
}
V_60 . V_73 = V_122 ;
F_54 ( V_111 , & V_60 . V_80 ,
& V_60 . V_81 ) ;
V_112 = F_39 ( & V_60 ,
V_123 . V_118 ,
F_61 ( & V_123 ) ,
