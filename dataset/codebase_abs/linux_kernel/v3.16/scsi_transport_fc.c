...
void
F_173 ( struct V_13 * V_14 , T_2 V_132 )
{
struct V_18 * V_19 = F_42 ( V_14 ) ;
struct V_20 * V_21 = F_10 ( V_19 ) ;
unsigned long V_136 ;
...
V_153 = F_174 ( V_19 , ( unsigned long ) V_14 ,
( char * ) & V_14 -> V_15 ) ;
if ( V_153 )
F_29 ( V_236 L_28 ,
V_153 ) ;
...
struct V_165 * V_255 , struct V_134 * * V_281 )
{
struct V_20 * V_21 = F_10 ( V_19 ) ;
struct V_113 * V_256 = F_43 ( V_19 -> V_114 ) ;
struct V_134 * V_135 ;
...
return - V_79 ;
V_257 = ( sizeof( struct V_134 ) + V_256 -> V_121 -> V_282 ) ;
...
if ( V_256 -> V_121 -> V_282 )
V_135 -> V_259 = & V_135 [ 1 ] ;
V_135 -> V_19 = V_19 ;
V_135 -> V_176 = V_176 ;
V_135 -> V_136 = V_139 ;
F_156 ( & V_135 -> V_141 , V_284 ) ;
F_53 ( V_19 -> V_137 , V_136 ) ;
...
V_300 -> V_307 -= F_184 ( V_292 -> V_303 -> V_308 ,
V_300 -> V_307 ) ;
}
F_185 ( V_299 ) ;
}
static void F_186 ( struct V_298 * V_309 )
{
...
V_292 -> V_294 -- ;
F_54 ( & V_292 -> V_293 , V_136 ) ;
F_187 ( V_309 , V_309 -> V_302 ) ;
F_182 ( V_292 ) ;
}
static enum V_189
F_188 ( struct V_298 * V_299 )
{
...
static int
F_189 ( struct V_317 * V_1 , struct V_298 * V_299 )
{
...
if ( ! V_1 -> V_296 )
return - V_59 ;
F_190 ( V_1 -> V_296 , V_299 -> V_320 ) ;
V_1 -> V_321 = F_191 ( V_299 -> V_322 , V_299 , V_1 -> V_296 ) ;
V_1 -> V_323 = F_192 ( V_299 ) ;
return 0 ;
}
static int
...
V_292 -> V_306 = V_330 ;
if ( V_299 -> V_331 ) {
V_153 = F_189 ( & V_292 -> V_295 , V_299 ) ;
if ( V_153 )
goto V_332;
}
if ( V_300 && V_300 -> V_331 ) {
V_153 = F_189 ( & V_292 -> V_297 , V_300 ) ;
if ( V_153 )
goto V_333;
}
V_292 -> V_334 = F_183 ;
...
static enum V_335
F_195 ( struct V_336 * V_322 , struct V_18 * V_19 ,
struct V_291 * V_292 )
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
...
static void
F_198 ( struct V_336 * V_322 , struct V_18 * V_19 ,
...
if ( V_14 )
V_153 = F_197 ( V_322 , V_19 , V_14 , V_292 ) ;
else
V_153 = F_195 ( V_322 , V_19 , V_292 ) ;
if ( V_153 == V_365 )
break;
if ( V_153 == V_356 )
F_201 ( V_322 -> V_364 ) ;
...
F_198 ( V_322 , V_19 , NULL , & V_19 -> V_172 ) ;
}
static void
F_203 ( struct V_336 * V_322 )
{
struct V_13 * V_14 = V_322 -> V_366 ;
struct V_18 * V_19 = F_42 ( V_14 ) ;
F_198 ( V_322 , V_19 , V_14 , & V_14 -> V_9 ) ;
}
static int
...
F_207 ( V_322 , F_188 ) ;
F_208 ( V_322 , V_370 ) ;
V_77 = F_209 ( V_322 , V_9 , V_367 , NULL ) ;
if ( V_77 ) {
F_29 ( V_236 L_50
L_52 ,
V_19 -> V_57 ) ;
...
F_207 ( V_322 , F_188 ) ;
F_208 ( V_322 , V_371 ) ;
V_77 = F_209 ( V_322 , V_9 , NULL , NULL ) ;
if ( V_77 ) {
F_29 ( V_236 L_53
L_52 ,
V_9 -> V_288 . V_76 ) ;
