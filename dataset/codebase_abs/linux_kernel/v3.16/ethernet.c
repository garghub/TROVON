...
const T_7 * V_32 ;
for (; ; ) {
V_110 = F_59 ( V_108 , V_110 ) ;
if ( ! V_110 )
break;
V_32 = F_60 ( V_110 , L_2 , & V_111 ) ;
if ( V_32 && ( F_61 ( * V_32 ) == V_109 ) )
break;
}
return V_110 ;
}
static struct V_107 * F_62 ( struct V_107 * V_112 ,
int V_61 , int V_13 )
{
struct V_107 * V_113 , * V_114 ;
V_113 = F_58 ( V_112 , V_61 ) ;
if ( ! V_113 )
return NULL ;
V_114 = F_58 ( V_113 , V_13 ) ;
F_63 ( V_113 ) ;
return V_114 ;
}
...
V_9 = F_18 ( V_37 ) ;
V_9 -> V_91 = F_62 ( V_112 , V_61 ,
V_133 ) ;
F_80 ( & V_9 -> V_10 ,
F_5 ) ;
V_9 -> V_130 = V_130 ;
V_9 -> V_13 = V_13 ;
V_9 -> V_97 = F_81 ( V_9 -> V_13 ) ;
V_9 -> V_118 = V_118 - F_82 ( V_13 ) * 4 ;
for ( V_120 = 0 ; V_120 < 16 ; V_120 ++ )
F_77 ( & V_9 -> V_132 [ V_120 ] ) ;
for ( V_120 = 0 ; V_120 < F_82 ( V_13 ) ;
V_120 ++ )
F_74 ( V_9 -> V_118 + V_120 * 4 , 0 ) ;
switch ( V_9 -> V_130 ) {
case V_131 :
case V_134 :
case V_135 :
...
static int F_86 ( struct V_115 * V_116 )
{
int V_13 ;
F_32 ( F_87 ( V_127 ) , 0 ) ;
F_88 () ;
F_89 ( V_149 + V_127 , V_12 ) ;
F_90 ( & V_4 ) ;
F_91 ( & V_6 ) ;
F_92 () ;
F_93 () ;
