...
goto V_38;
if ( ! V_2 -> V_30 . V_31 . V_157 ) {
V_19 = V_18 -> V_22 . V_23 ( V_2 , V_470 , 18 ) ;
if ( V_19 )
goto V_38;
V_19 = V_18 -> V_22 . V_25 ( V_2 , V_471 ,
& V_469 ) ;
if ( V_19 )
goto V_38;
V_469 |= V_472 ;
V_19 = V_18 -> V_22 . V_23 ( V_2 , V_471 ,
V_469 ) ;
if ( V_19 )
goto V_38;
V_19 = V_18 -> V_22 . V_23 ( V_2 , V_470 , 0 ) ;
if ( V_19 )
goto V_38;
V_19 = F_89 ( V_2 , V_473 ,
V_474 ,
...
T_4 V_486 ;
T_4 V_263 ;
struct V_487 * V_20 = & V_2 -> V_5 . V_488 ;
if ( ( V_2 -> V_5 . type != V_11 ) || ( V_2 -> V_55 . V_56 != 0 ) )
return V_489 ;
V_20 -> V_490 [ 0 ] . V_491 = ( F_2 ( V_492 ) & 0xFF ) ;
V_2 -> V_102 . V_22 . V_129 ( V_2 , V_493 , 1 , & V_481 ) ;
if ( ( V_481 == 0x0000 ) || ( V_481 == 0xFFFF ) )
return 0 ;
V_2 -> V_102 . V_22 . V_129 ( V_2 , V_481 , 1 , & V_482 ) ;
if ( ( ( V_482 & V_494 ) >> V_495 )
!= V_496 )
return V_489 ;
V_484 = ( V_482 & V_497 ) ;
if ( V_484 > V_498 )
V_484 = V_498 ;
for ( V_263 = 1 ; V_263 < V_484 ; V_263 ++ ) {
V_2 -> V_102 . V_22 . V_129 ( V_2 , ( V_481 + V_263 ) , 1 , & V_483 ) ;
V_485 = ( ( V_483 & V_499 ) >>
V_500 ) ;
V_486 = ( ( V_483 & V_501 ) >>
V_502 ) ;
if ( V_486 != 0 )
V_2 -> V_18 . V_22 . V_503 ( V_2 ,
V_504 [ V_485 ] ,
V_505 ,
& V_20 -> V_490 [ V_263 ] . V_491 ) ;
}
return 0 ;
}
...
if ( ( V_2 -> V_5 . type != V_11 ) || ( V_2 -> V_55 . V_56 != 0 ) )
return V_489 ;
memset ( V_20 , 0 , sizeof( struct V_487 ) ) ;
V_20 -> V_490 [ 0 ] . V_508 = 0x1 ;
V_20 -> V_490 [ 0 ] . V_509 =
( F_2 ( V_510 ) & 0xFF ) ;
V_20 -> V_490 [ 0 ] . V_511 =
( F_2 ( V_512 ) & 0xFF ) ;
...
V_502 ) ;
V_507 = V_483 & V_515 ;
V_2 -> V_18 . V_22 . V_516 ( V_2 ,
V_517 [ V_485 ] ,
V_505 ,
V_507 ) ;
if ( ( V_263 < V_498 ) && ( V_486 != 0 ) ) {
V_20 -> V_490 [ V_263 ] . V_508 = V_486 ;
V_20 -> V_490 [ V_263 ] . V_509 = V_507 ;
V_20 -> V_490 [ V_263 ] . V_511 = V_507 -
V_506 ;
}
}
return 0 ;
