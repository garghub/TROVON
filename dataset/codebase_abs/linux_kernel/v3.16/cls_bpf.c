...
struct V_30 * V_32 , bool V_33 )
{
struct V_34 * V_20 , * V_35 ;
struct V_36 V_16 ;
struct V_37 V_25 ;
...
T_1 V_15 ;
int V_12 ;
if ( ! V_31 [ V_43 ] || ! V_31 [ V_44 ] || ! V_31 [ V_45 ] )
return - V_46 ;
F_22 ( & V_16 , V_47 , V_48 ) ;
V_12 = F_23 ( V_28 , V_4 , V_31 , V_32 , & V_16 , V_33 ) ;
if ( V_12 < 0 )
return V_12 ;
V_15 = F_24 ( V_31 [ V_45 ] ) ;
V_42 = F_25 ( V_31 [ V_43 ] ) ;
...
memcpy ( V_20 , F_26 ( V_31 [ V_44 ] ) , V_41 ) ;
V_25 . V_52 = V_42 ;
V_25 . V_14 = V_20 ;
V_12 = F_27 ( & V_39 , & V_25 ) ;
if ( V_12 )
...
V_12 = F_21 ( V_28 , V_4 , V_11 , V_29 , V_31 , V_57 [ V_61 ] , V_33 ) ;
if ( V_12 < 0 )
goto V_50;
F_14 ( V_4 ) ;
...
if ( V_65 == NULL )
goto V_68;
if ( F_37 ( V_2 , V_45 , V_11 -> V_6 . V_15 ) )
goto V_68;
if ( F_38 ( V_2 , V_43 , V_11 -> V_42 ) )
goto V_68;
V_66 = F_39 ( V_2 , V_44 , V_11 -> V_42 *
sizeof( struct V_34 ) ) ;
if ( V_66 == NULL )
goto V_68;
