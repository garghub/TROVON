...
static void F_92 ( unsigned long V_1 , struct V_6 * V_6 )
{
struct V_156 * V_157 ;
V_6 -> V_158 = V_159 ;
V_159 = V_6 ;
V_6 -> V_70 = F_93 ( V_1 , 0x1000 ) ;
V_6 -> V_160 = F_3 ( V_6 -> V_70 + V_161 ) ;
V_6 -> V_153 = F_3 ( V_6 -> V_70 + V_162 ) & 0xFFUL ;
V_6 -> V_104 = 0xFFFFFFFFFFFFFFFFUL ;
for ( V_157 = V_163 ; V_157 < V_163 + F_94 ( V_163 ) ; V_157 ++ ) {
if ( V_6 -> V_160 == V_157 -> V_160 ) {
V_6 -> V_164 = V_157 -> V_164 ;
if ( V_157 -> V_165 )
( V_157 -> V_165 ) ( V_6 ) ;
}
}
...
V_87 >> 10 , V_92 >> 10 ) ;
if ( ! V_6 -> V_164 ) {
V_6 -> V_164 = F_95 ( 24 , V_138 ) ;
if ( V_6 -> V_164 )
sprintf ( ( char * ) V_6 -> V_164 , L_57 ,
V_6 -> V_160 & 0xFFFF , ( V_6 -> V_160 >> 16 ) & 0xFFFF ) ;
else
V_6 -> V_164 = L_58 ;
}
F_83 ( V_6 ) ;
...
static void *
F_96 ( struct V_167 * V_168 , T_9 * V_169 )
{
struct V_6 * V_6 ;
T_9 V_170 = * V_169 ;
for ( V_6 = V_159 ; V_6 ; V_6 = V_6 -> V_158 )
if ( ! V_170 -- )
return V_6 ;
return NULL ;
}
static void *
F_97 ( struct V_167 * V_168 , void * V_171 , T_9 * V_169 )
{
struct V_6 * V_6 = V_171 ;
++ * V_169 ;
return V_6 -> V_158 ;
}
static void
F_98 ( struct V_167 * V_168 , void * V_171 )
{
}
static int
F_99 ( struct V_167 * V_168 , void * V_171 )
{
struct V_6 * V_6 = V_171 ;
unsigned long * V_32 = ( unsigned long * ) V_6 -> V_13 ;
int V_58 , V_172 = 0 ;
F_100 ( V_168 , L_60 ,
V_6 -> V_164 , ( ( V_6 -> V_153 >> 4 ) & 0xF ) , ( V_6 -> V_153 & 0xF ) ) ;
#ifdef F_66
if ( V_6 -> V_110 != V_111 )
F_100 ( V_168 , L_61 , V_6 -> V_110 ) ;
#endif
F_100 ( V_168 , L_62 , ( ( V_6 -> V_93 >> 3 ) * V_92 ) / ( 1024 * 1024 ) ) ;
F_100 ( V_168 , L_63 , V_92 / 1024 ) ;
for ( V_58 = 0 ; V_58 < ( V_6 -> V_17 / sizeof( unsigned long ) ) ; ++ V_58 , ++ V_32 )
V_172 += F_101 ( * V_32 ) ;
F_100 ( V_168 , L_64 , V_6 -> V_93 >> 3 ) ;
F_100 ( V_168 , L_65 , V_172 ) ;
#ifdef F_29
{
unsigned long V_58 = 0 , V_173 = 0 , F_61 , V_174 ;
F_61 = V_174 = V_6 -> V_73 [ 0 ] ;
for ( V_58 = 0 ; V_58 < V_75 ; V_58 ++ ) {
V_173 += V_6 -> V_73 [ V_58 ] ;
if ( V_6 -> V_73 [ V_58 ] > V_174 ) V_174 = V_6 -> V_73 [ V_58 ] ;
...
static int
F_102 ( struct V_175 * V_175 , struct V_176 * V_176 )
{
return F_103 ( V_176 , & V_177 ) ;
}
static void T_8
F_104 ( void )
{
...
if ( ! V_98 )
return;
F_106 ( V_159 -> V_164 , 0 , V_98 , & V_179 ) ;
}
static void
F_107 ( struct V_180 * V_150 )
{
T_10 V_181 , V_182 ;
T_11 V_183 ;
struct V_6 * V_6 ;
...
V_183 = F_110 ( V_181 , & V_182 ) ;
V_181 = V_182 ;
} while ( F_111 ( V_183 ) );
F_5 ( V_72 L_70 , F_112 ( V_150 ) , V_150 -> V_184 ) ;
}
static void T_8
F_113 ( struct V_6 * V_6 , T_10 V_181 )
{
#ifdef F_66
unsigned int V_110 ;
V_110 = F_114 ( V_181 ) ;
...
static void F_116 ( struct V_6 * V_6 )
{
T_10 V_181 = V_6 -> V_181 ;
T_11 V_183 ;
T_2 V_1 , V_127 ;
struct V_186 * V_187 ;
V_188 = V_6 -> V_158 ;
V_183 = F_117 ( V_181 , & V_1 , & V_127 ) ;
if ( F_118 ( V_183 ) )
goto V_189;
V_183 = F_119 ( V_181 , & V_187 ) ;
if ( F_118 ( V_183 ) )
goto V_189;
if ( strncmp ( L_71 , V_187 -> V_190 . string , 7 ) == 0 ) {
V_1 += V_191 ;
if ( ! V_31 )
V_31 = F_61 ( V_192 , 16 ) ;
}
...
static int F_121 ( struct V_193 * V_34 ,
...
#if F_126 ( V_198 ) || F_126 ( V_201 )
if ( F_125 ( L_73 ) ) {
extern void V_202 ( void ) ;
V_202 () ;
}
#endif
#ifdef F_90
{
struct V_180 * V_203 = NULL ;
while ( ( V_203 = F_130 ( V_203 ) ) != NULL )
F_107 ( V_203 ) ;
}
#endif
#ifdef F_131
...
static int F_133 ( struct V_34 * V_35 , T_2 V_53 )
{
return ( ( V_53 & 0xFFFFFFFFUL ) == 0xFFFFFFFFUL ) ;
}
static int F_134 ( struct V_34 * V_35 , T_6 V_205 )
{
return 0 ;
}
static int T_8
