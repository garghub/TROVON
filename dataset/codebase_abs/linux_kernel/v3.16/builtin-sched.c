...
if ( V_7 -> V_168 == - 1 )
return 0 ;
V_172 = F_49 ( V_105 , 0 , V_43 ) ;
V_26 = F_54 ( & V_7 -> V_146 , V_172 , & V_7 -> V_147 ) ;
if ( ! V_26 ) {
if ( F_59 ( V_7 , V_172 ) )
return - 1 ;
F_17 ( V_7 , V_172 -> V_107 , F_50 ( V_172 ) ) ;
V_26 = F_54 ( & V_7 -> V_146 , V_172 , & V_7 -> V_147 ) ;
if ( ! V_26 ) {
F_27 ( L_41 ) ;
return - 1 ;
...
if ( ! V_145 -> V_163 )
return;
if ( ! strcmp ( F_50 ( V_145 -> V_89 ) , L_42 ) )
return;
V_7 -> V_174 += V_145 -> V_156 ;
V_7 -> V_175 += V_145 -> V_163 ;
V_55 = printf ( L_43 , F_50 ( V_145 -> V_89 ) , V_145 -> V_89 -> V_107 ) ;
...
static int F_77 ( const char * V_178 , struct V_125 * V_126 )
{
T_2 V_14 ;
...
for ( V_14 = 0 ; V_14 < F_78 ( V_185 ) ; V_14 ++ ) {
if ( ! strcmp ( V_185 [ V_14 ] -> V_180 , V_178 ) ) {
F_63 ( & V_185 [ V_14 ] -> V_126 , V_126 ) ;
return 0 ;
}
}
return - 1 ;
...
F_56 ( & V_7 -> V_186 , V_141 , & V_7 -> V_135 ) ;
}
}
static int F_83 ( struct V_187 * V_188 ,
struct V_101 * V_102 ,
struct V_103 * V_104 ,
struct V_105 * V_105 )
{
struct V_6 * V_7 = F_55 ( V_188 , struct V_6 , V_188 ) ;
if ( V_7 -> V_189 -> V_190 )
...
{
const T_5 V_111 = F_45 ( V_102 , V_104 , L_24 ) ;
struct V_89 * V_167 ;
int V_191 ;
T_1 V_115 , V_20 = V_104 -> time ;
T_6 V_12 ;
...
if ( V_191 ) {
printf ( L_55 ,
V_167 -> V_195 , F_50 ( V_167 ) , V_167 -> V_107 ) ;
} else {
printf ( L_12 ) ;
}
return 0 ;
}
static int F_85 ( struct V_187 * V_188 ,
struct V_101 * V_102 ,
struct V_103 * V_104 ,
struct V_105 * V_105 )
{
...
static int F_90 ( struct V_187 * V_188 V_41 ,
...
V_214 = F_93 ( & V_216 , false , & V_7 -> V_188 ) ;
if ( V_214 == NULL ) {
F_47 ( L_61 ) ;
return - 1 ;
}
...
static void F_105 ( struct V_6 * V_7 , const struct V_228 * V_229 ,
const char * const V_230 [] )
{
char * V_231 , * V_178 , * V_148 = F_106 ( V_7 -> V_232 ) ;
for ( V_178 = strtok_r ( V_148 , L_81 , & V_231 ) ;
V_178 ; V_178 = strtok_r ( NULL , L_81 , & V_231 ) ) {
if ( F_77 ( V_178 , & V_7 -> V_135 ) < 0 ) {
error ( L_82 , V_178 ) ;
F_107 ( V_230 , V_229 ) ;
}
}
...
static int F_108 ( int V_233 , const char * * V_234 )
{
...
V_235 = F_78 ( V_237 ) + V_233 - 1 ;
V_236 = calloc ( V_235 + 1 , sizeof( char * ) ) ;
if ( V_236 == NULL )
return - V_238 ;
for ( V_14 = 0 ; V_14 < F_78 ( V_237 ) ; V_14 ++ )
V_236 [ V_14 ] = F_106 ( V_237 [ V_14 ] ) ;
for ( V_53 = 1 ; V_53 < ( unsigned int ) V_233 ; V_53 ++ , V_14 ++ )
V_236 [ V_14 ] = V_234 [ V_53 ] ;
F_11 ( V_14 != V_235 ) ;
return F_109 ( V_14 , V_236 , NULL ) ;
}
int F_110 ( int V_233 , const char * * V_234 , const char * T_8 V_41 )
{
...
F_112 ( 's' , L_96 , & V_7 . V_232 , L_97 ,
L_98 ) ,
F_113 ( 'v' , L_99 , & V_50 ,
L_100 ) ,
F_114 ( 'C' , L_101 , & V_7 . V_168 ,
L_102 ) ,
F_115 ( 'D' , L_103 , & V_246 ,
L_104 ) ,
F_116 ()
...
unsigned int V_14 ;
for ( V_14 = 0 ; V_14 < F_78 ( V_7 . V_198 ) ; V_14 ++ )
V_7 . V_198 [ V_14 ] = - 1 ;
V_233 = F_118 ( V_233 , V_234 , V_248 , V_251 ,
V_252 , V_257 ) ;
if ( ! V_233 )
F_107 ( V_252 , V_248 ) ;
if ( ! strcmp ( V_234 [ 0 ] , L_115 ) )
return F_119 ( V_233 , V_234 , T_8 ) ;
F_120 () ;
if ( ! strncmp ( V_234 [ 0 ] , L_116 , 3 ) ) {
return F_108 ( V_233 , V_234 ) ;
} else if ( ! strncmp ( V_234 [ 0 ] , L_117 , 3 ) ) {
V_7 . V_189 = & V_254 ;
if ( V_233 > 1 ) {
V_233 = F_121 ( V_233 , V_234 , V_245 , V_249 , 0 ) ;
if ( V_233 )
F_107 ( V_249 , V_245 ) ;
}
F_105 ( & V_7 , V_245 , V_249 ) ;
return F_99 ( & V_7 ) ;
...
V_7 . V_189 = & V_256 ;
if ( V_233 ) {
V_233 = F_121 ( V_233 , V_234 , V_247 , V_250 , 0 ) ;
if ( V_233 )
F_107 ( V_250 , V_247 ) ;
}
return F_104 ( & V_7 ) ;
