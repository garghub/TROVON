...
if ( ! F_107 ( V_143 . V_152 ) ) {
F_97 ( L_20 ,
( unsigned long long ) V_143 . V_152 ) ;
V_122 = - V_146 ;
goto V_153;
}
if ( ! F_107 ( F_106 ( & V_143 ) ) ) {
F_97 ( L_21 ,
( unsigned long long ) F_106 ( & V_143 ) ,
V_154 ) ;
V_122 = - V_146 ;
goto V_153;
}
V_155 = V_143 . V_152 ;
F_108 ( L_22 , V_144 -> V_156 ,
V_142 . V_152 , V_131 ) ;
F_109 ( F_91 , NULL , 1 ) ;
goto V_123;
V_153:
...
if ( F_115 ( V_19 ) )
goto V_123;
if ( F_116 ( V_19 -> V_20 . V_21 . V_88 ) ||
F_116 ( V_19 -> V_20 . V_21 . V_157 ) ) {
F_97 ( L_23 ) ;
V_122 = - V_146 ;
goto V_123;
}
V_122 = F_117 ( V_19 , V_19 -> V_20 . V_21 . V_157 ,
V_155 , V_158 ) ;
if ( V_122 ) {
F_97 ( L_24 ) ;
goto V_123;
...
F_38 ( V_19 , 0 , V_53 ) ;
V_19 -> V_20 . V_21 . V_159 = true ;
V_123:
F_118 ( & V_19 -> V_94 ) ;
return V_122 ;
}
int F_119 ( struct V_19 * V_19 )
{
int V_53 , V_160 = - 1 , V_122 = 0 ;
struct V_15 * V_16 ;
F_114 ( & V_19 -> V_94 ) ;
if ( V_19 -> V_20 . V_21 . V_161 ) {
V_122 = - V_162 ;
goto V_123;
}
F_40 (i, vcpu, kvm) {
...
F_121 ( & V_19 -> V_20 . V_21 . V_94 ) ;
V_19 -> V_20 . V_21 . V_161 = V_149 ;
V_19 -> V_20 . V_21 . V_88 = V_166 ;
V_19 -> V_20 . V_21 . V_157 = V_166 ;
V_164:
for (; V_160 >= 0 ; V_160 -- ) {
V_16 = F_87 ( V_19 , V_160 ) ;
F_118 ( & V_16 -> V_163 ) ;
}
V_123:
F_118 ( & V_19 -> V_94 ) ;
...
static bool F_122 ( struct V_19 * V_19 )
{
T_2 V_18 = V_19 -> V_20 . V_21 . V_88 ;
T_2 V_135 = V_19 -> V_20 . V_21 . V_157 ;
if ( F_116 ( V_18 ) || F_116 ( V_135 ) )
return 0 ;
if ( ( V_18 <= V_135 && V_18 + V_91 > V_135 ) ||
( V_135 <= V_18 && V_135 + V_158 > V_18 ) )
return - V_125 ;
return 0 ;
}
static int F_123 ( struct V_19 * V_19 , T_2 * V_167 ,
T_2 V_168 , T_2 V_169 )
{
int V_122 ;
if ( V_168 & ~ V_170 )
...
int F_124 ( struct V_19 * V_19 , unsigned long type , T_6 * V_168 , bool V_174 )
{
int V_83 = 0 ;
...
struct V_32 * V_33 , T_2 V_4 )
{
return F_125 ( V_16 , V_33 , V_186 ) ;
}
static bool F_127 ( struct V_15 * V_16 ,
struct V_32 * V_33 ,
T_2 V_4 )
{
T_1 V_6 ;
...
static int F_128 ( struct V_190 * V_191 ,
struct V_192 * V_193 ,
T_1 * V_6 , bool V_43 )
{
...
T_2 V_4 ;
int V_122 , V_3 , V_56 ;
struct V_15 * V_16 , * V_194 ;
struct V_17 * V_21 ;
struct V_32 V_33 ;
V_4 = V_193 -> V_193 & V_195 ;
V_3 = ( V_193 -> V_193 & V_196 ) >>
V_197 ;
F_114 ( & V_191 -> V_19 -> V_94 ) ;
if ( V_3 >= F_29 ( & V_191 -> V_19 -> V_49 ) ) {
V_122 = - V_173 ;
goto V_123;
}
V_16 = F_87 ( V_191 -> V_19 , V_3 ) ;
V_21 = & V_191 -> V_19 -> V_20 . V_21 ;
V_33 . V_39 = 4 ;
V_33 . V_43 = V_43 ;
if ( V_43 )
F_23 ( & V_33 , ~ 0 , * V_6 ) ;
...
F_62 ( & V_21 -> V_94 ) ;
V_123:
F_118 ( & V_191 -> V_19 -> V_94 ) ;
return V_122 ;
}
static int F_130 ( struct V_190 * V_191 , struct V_192 * V_193 )
{
int V_83 ;
switch ( V_193 -> V_198 ) {
case V_203 : {
T_6 T_7 * V_204 = ( T_6 T_7 * ) ( long ) V_193 -> V_168 ;
T_6 V_168 ;
unsigned long type = ( unsigned long ) V_193 -> V_193 ;
if ( F_131 ( & V_168 , V_204 , sizeof( V_168 ) ) )
return - V_205 ;
V_83 = F_124 ( V_191 -> V_19 , type , & V_168 , true ) ;
return ( V_83 == - V_145 ) ? - V_146 : V_83 ;
}
case V_199 :
case V_200 : {
T_1 T_7 * V_204 = ( T_1 T_7 * ) ( long ) V_193 -> V_168 ;
T_1 V_6 ;
if ( F_132 ( V_6 , V_204 ) )
return - V_205 ;
return F_128 ( V_191 , V_193 , & V_6 , true ) ;
}
}
return - V_146 ;
}
static int F_133 ( struct V_190 * V_191 , struct V_192 * V_193 )
{
int V_83 = - V_146 ;
switch ( V_193 -> V_198 ) {
case V_203 : {
...
T_6 V_168 ;
unsigned long type = ( unsigned long ) V_193 -> V_193 ;
V_83 = F_124 ( V_191 -> V_19 , type , & V_168 , false ) ;
if ( V_83 )
return ( V_83 == - V_145 ) ? - V_146 : V_83 ;
if ( F_134 ( V_204 , & V_168 , sizeof( V_168 ) ) )
return - V_205 ;
break;
}
case V_199 :
...
T_1 T_7 * V_204 = ( T_1 T_7 * ) ( long ) V_193 -> V_168 ;
T_1 V_6 = 0 ;
V_83 = F_128 ( V_191 , V_193 , & V_6 , false ) ;
if ( V_83 )
return V_83 ;
V_83 = F_135 ( V_6 , V_204 ) ;
break;
}
}
return V_83 ;
}
static int F_136 ( const struct V_81 * V_82 ,
T_2 V_4 )
{
struct V_32 V_206 ;
V_206 . V_39 = 4 ;
if ( F_56 ( V_82 , & V_206 , V_4 ) )
return 0 ;
else
return - V_146 ;
}
static int F_137 ( struct V_190 * V_191 , struct V_192 * V_193 )
{
T_2 V_4 ;
switch ( V_193 -> V_198 ) {
case V_203 :
...
case V_199 :
V_4 = V_193 -> V_193 & V_195 ;
return F_136 ( V_92 , V_4 ) ;
case V_200 :
V_4 = V_193 -> V_193 & V_195 ;
return F_136 ( V_201 , V_4 ) ;
}
return - V_146 ;
}
...
static int F_140 ( struct V_190 * V_191 , T_1 type )
{
return F_119 ( V_191 -> V_19 ) ;
}
