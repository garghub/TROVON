...
V_9 = F_169 ( V_15 , V_25 - V_196 , V_196 ,
...
V_178 = V_86 + 1 ;
F_2 ( V_192 -> V_7 , V_9 ) ;
F_170 ( V_9 , V_25 - V_196 ) ;
V_9 -> V_196 = V_196 ;
V_9 -> V_25 = V_25 ;
V_86 = F_171 ( V_9 , 0 , V_190 -> V_207 , 0 , V_25 ) ;
if ( V_86 )
goto V_206;
...
static int F_175 ( struct V_188 * V_188 , struct V_84 * V_14 ,
struct V_189 * V_190 , T_3 V_25 )
{
struct V_191 * V_192 = F_163 ( V_188 ) ;
struct V_14 * V_15 = V_14 -> V_15 ;
...
V_210 = F_166 ( int , V_210 , F_176 ( 0 ) + V_216 ) ;
V_196 = F_177 ( int , 0 , V_210 - F_176 ( 0 ) ) ;
V_196 = F_166 ( T_3 , V_210 , F_167 ( V_196 ) ) ;
V_9 = F_169 ( V_15 , V_210 - V_196 , V_196 ,
V_190 -> V_197 & V_204 , & V_86 ,
F_178 ( V_216 ) ) ;
if ( ! V_9 )
goto V_213;
...
V_178 = V_86 + 1 ;
V_212 = true ;
F_170 ( V_9 , V_210 - V_196 ) ;
V_9 -> V_196 = V_196 ;
V_9 -> V_25 = V_210 ;
V_86 = F_171 ( V_9 , 0 , V_190 -> V_207 ,
V_211 , V_210 ) ;
if ( V_86 ) {
F_65 ( V_9 ) ;
goto V_213;
...
static int F_180 ( struct V_188 * V_188 , struct V_84 * V_14 ,
struct V_189 * V_190 , T_3 V_25 )
{
int V_86 ;
struct V_14 * V_15 = V_14 -> V_15 ;
...
static int F_182 ( struct V_188 * V_220 , struct V_84 * V_14 ,
...
if ( V_15 -> V_70 != V_161 )
return - V_175 ;
return F_183 ( V_220 , V_14 , V_190 , V_210 , V_144 ) ;
}
static void F_184 ( struct V_189 * V_190 , struct V_14 * V_15 )
{
struct V_35 * V_36 = F_33 ( V_15 ) ;
if ( V_36 -> V_2 ) {
...
static int F_183 ( struct V_188 * V_220 , struct V_84 * V_14 ,
struct V_189 * V_190 , T_3 V_210 ,
int V_144 )
{
...
V_223 = F_185 ( V_15 , V_144 ) ;
V_9 = F_186 ( V_15 , V_144 , & V_222 , & V_223 , & V_86 ) ;
if ( ! V_9 ) {
F_13 ( V_15 ) ;
...
V_50 | V_51 | V_52 ) ;
if ( V_190 -> V_193 )
F_184 ( V_190 , V_9 -> V_15 ) ;
if ( V_210 > V_9 -> V_25 - V_223 )
V_210 = V_9 -> V_25 - V_223 ;
else if ( V_210 < V_9 -> V_25 - V_223 )
V_190 -> V_197 |= V_225 ;
V_86 = F_187 ( V_9 , V_223 , V_190 -> V_207 , V_210 ) ;
if ( V_86 )
goto V_206;
if ( F_51 ( V_15 , V_209 ) )
F_188 ( V_190 , V_15 , V_9 ) ;
if ( ! V_192 -> V_7 ) {
V_192 -> V_7 = & V_195 ;
memset ( & V_195 , 0 , sizeof( V_195 ) ) ;
}
F_189 ( V_192 -> V_7 , F_149 ( V_9 ) . V_87 , F_149 ( V_9 ) . V_184 , F_149 ( V_9 ) . V_186 ) ;
F_4 ( V_192 -> V_7 , V_9 ) ;
if ( ! ( V_144 & V_226 ) ) {
if ( F_149 ( V_9 ) . V_176 )
F_148 ( V_192 -> V_7 , V_9 ) ;
...
F_192 ( V_14 , V_190 , V_192 -> V_7 , V_144 ) ;
V_206:
F_143 ( V_15 , V_9 ) ;
V_91:
F_79 ( & V_36 -> V_93 ) ;
...
static long F_193 ( struct V_14 * V_15 , long V_151 ,
struct V_8 * V_227 )
{
F_123 ( V_49 ) ;
F_13 ( V_15 ) ;
for (; ; ) {
F_194 ( F_195 ( V_15 ) , & V_49 , V_153 ) ;
if ( F_196 ( & V_15 -> V_17 ) != V_227 ||
V_15 -> V_58 ||
( V_15 -> V_67 & V_154 ) ||
F_131 ( V_82 ) ||
! V_151 )
...
V_151 = F_197 ( V_151 ) ;
F_13 ( V_15 ) ;
F_198 ( V_228 , & V_15 -> V_61 -> V_144 ) ;
}
F_126 ( F_195 ( V_15 ) , & V_49 ) ;
F_15 ( V_15 ) ;
return V_151 ;
}
static unsigned int F_199 ( const struct V_8 * V_9 )
{
return V_9 -> V_25 - F_149 ( V_9 ) . V_229 ;
}
static int F_200 ( struct V_188 * V_220 , struct V_84 * V_14 ,
struct V_189 * V_190 , T_3 V_210 ,
int V_144 )
{
struct V_191 * V_192 = F_163 ( V_220 ) ;
...
if ( V_144 & V_198 )
goto V_90;
V_232 = F_201 ( V_15 , V_144 & V_233 , V_210 ) ;
V_151 = F_202 ( V_15 , V_221 ) ;
if ( ! V_192 -> V_7 ) {
V_192 -> V_7 = & V_195 ;
memset ( & V_195 , 0 , sizeof( V_195 ) ) ;
}
...
V_223 = F_185 ( V_15 , V_144 ) ;
while ( V_223 >= F_199 ( V_9 ) ) {
V_223 -= F_199 ( V_9 ) ;
V_227 = V_9 ;
V_9 = F_204 ( V_9 , & V_15 -> V_17 ) ;
if ( ! V_9 )
goto V_235;
}
F_15 ( V_15 ) ;
...
! F_205 ( F_149 ( V_9 ) . V_184 , V_192 -> V_7 -> V_185 . V_184 ) ||
! F_206 ( F_149 ( V_9 ) . V_186 , V_192 -> V_7 -> V_185 . V_186 ) )
break;
...
if ( F_187 ( V_9 , F_149 ( V_9 ) . V_229 + V_223 ,
V_190 -> V_207 , V_234 ) ) {
if ( V_230 == 0 )
V_230 = - V_237 ;
break;
...
static int F_209 ( struct V_84 * V_14 , int V_130 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
struct V_14 * V_55 ;
...
long F_212 ( struct V_14 * V_15 )
{
return F_213 ( V_15 ) ;
}
static int F_214 ( struct V_84 * V_14 , unsigned int V_243 , unsigned long V_244 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
long V_242 = 0 ;
int V_86 ;
...
case V_245 :
V_242 = F_212 ( V_15 ) ;
V_86 = F_215 ( V_242 , ( int V_246 * ) V_244 ) ;
break;
case V_247 :
V_242 = F_210 ( V_15 ) ;
if ( V_242 < 0 )
...
static unsigned int F_216 ( struct V_249 * V_249 , struct V_84 * V_14 , T_4 * V_49 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
unsigned int V_250 ;
F_217 ( V_249 , F_195 ( V_15 ) , V_49 ) ;
V_250 = 0 ;
if ( V_15 -> V_58 )
V_250 |= V_251 ;
if ( V_15 -> V_67 == V_68 )
...
static unsigned int F_218 ( struct V_249 * V_249 , struct V_84 * V_14 ,
T_4 * V_49 )
{
...
if ( ! ( F_219 ( V_49 ) & ( V_52 | V_51 | V_50 ) ) )
return V_250 ;
V_256 = F_38 ( V_15 ) ;
V_55 = F_12 ( V_15 ) ;
if ( V_55 ) {
if ( F_8 ( V_55 ) != V_15 ) {
F_217 ( V_249 , & F_33 ( V_55 ) -> V_56 , V_49 ) ;
if ( F_10 ( V_55 ) )
V_256 = 0 ;
}
F_63 ( V_55 ) ;
...
static struct V_14 * F_220 ( struct V_262 * V_263 , T_5 * V_264 )
{
unsigned long V_265 = F_221 ( * V_264 ) ;
unsigned long V_266 = F_222 ( * V_264 ) ;
struct V_14 * V_15 ;
unsigned long V_177 = 0 ;
for ( V_15 = F_223 ( & V_5 [ V_266 ] ) ; V_15 ; V_15 = F_224 ( V_15 ) ) {
if ( F_35 ( V_15 ) != F_225 ( V_263 ) )
continue;
if ( ++ V_177 == V_265 )
break;
}
...
static struct V_14 * F_226 ( struct V_262 * V_263 ,
struct V_14 * V_15 ,
T_5 * V_264 )
{
unsigned long V_266 ;
...
do {
V_15 = F_220 ( V_263 , V_264 ) ;
if ( V_15 )
return V_15 ;
V_268:
V_266 = F_222 ( * V_264 ) + 1 ;
* V_264 = F_227 ( V_266 , 1 ) ;
} while ( V_266 < F_228 ( V_5 ) );
return NULL ;
}
static void * F_229 ( struct V_262 * V_263 , T_5 * V_264 )
__acquires( V_32 )
{
F_28 ( & V_32 ) ;
if ( ! * V_264 )
return V_267 ;
if ( F_222 ( * V_264 ) >= F_228 ( V_5 ) )
return NULL ;
return F_226 ( V_263 , NULL , V_264 ) ;
}
static void * F_230 ( struct V_262 * V_263 , void * V_269 , T_5 * V_264 )
{
++ * V_264 ;
return F_226 ( V_263 , V_269 , V_264 ) ;
}
static void F_231 ( struct V_262 * V_263 , void * V_269 )
__releases( V_32 )
{
F_29 ( & V_32 ) ;
}
static int F_232 ( struct V_262 * V_263 , void * V_269 )
{
if ( V_269 == V_267 )
F_233 ( V_263 , L_4
L_5 ) ;
...
for ( ; V_40 < V_25 ; V_40 ++ )
F_236 ( V_263 , V_36 -> V_2 -> V_37 -> V_30 [ V_40 ] ) ;
}
F_15 ( V_19 ) ;
F_236 ( V_263 , '\n' ) ;
}
...
static int F_238 ( struct V_39 * V_39 , struct V_249 * V_249 )
{
return F_239 ( V_39 , V_249 , & V_274 ,
sizeof( struct V_275 ) ) ;
}
static int T_6 F_240 ( struct V_33 * V_33 )
{
int error = - V_118 ;
V_33 -> V_102 . V_103 = 10 ;
if ( F_241 ( V_33 ) )
goto V_90;
#ifdef F_242
if ( ! F_243 ( L_7 , 0 , V_33 -> V_276 , & V_277 ) ) {
F_244 ( V_33 ) ;
goto V_90;
}
#endif
...
static void T_7 F_245 ( struct V_33 * V_33 )
{
F_244 ( V_33 ) ;
F_246 ( L_7 , V_33 -> V_276 ) ;
}
static int T_8 F_247 ( void )
{
int V_278 = - 1 ;
F_168 ( sizeof( struct V_279 ) > F_248 ( struct V_8 , V_280 ) ) ;
V_278 = F_249 ( & V_98 , 1 ) ;
if ( V_278 != 0 ) {
F_250 ( L_8 , V_281 ) ;
goto V_90;
