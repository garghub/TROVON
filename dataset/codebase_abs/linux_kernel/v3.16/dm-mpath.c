...
static void F_104 ( struct V_9 * V_10 , T_3 type ,
...
F_41 ( & V_13 -> V_25 , V_68 ) ;
if ( type == V_160 )
F_105 ( L_41 , V_13 -> V_26 , V_13 -> V_45 ) ;
else {
F_105 ( L_42 , V_13 -> V_61 +
( V_13 -> V_112 > 0 ) * 2 +
( V_13 -> V_27 != V_28 ) * 2 +
V_13 -> V_98 ) ;
if ( V_13 -> V_61 )
F_105 ( L_43 ) ;
if ( V_13 -> V_112 )
F_105 ( L_44 , V_13 -> V_112 ) ;
if ( V_13 -> V_27 != V_28 )
F_105 ( L_45 , V_13 -> V_27 ) ;
if ( V_13 -> V_98 )
F_105 ( L_46 ) ;
}
...
F_105 ( L_48 , V_13 -> V_16 ) ;
F_105 ( L_42 , V_13 -> V_115 ) ;
if ( V_13 -> V_60 )
...
F_105 ( L_47 ) ;
F_105 ( L_50 , V_6 -> V_104 ,
V_6 -> V_21 . type -> V_162 ) ;
F_31 (p, &pg->pgpaths, list) {
F_105 ( L_51 , V_93 -> V_17 . V_18 -> V_126 ,
V_93 -> V_3 ? L_52 : L_53 ,
V_93 -> V_127 ) ;
if ( V_6 -> V_21 . type -> V_161 )
...
case V_163 :
F_31 (pg, &m->priority_groups, list) {
F_105 ( L_54 , V_6 -> V_21 . type -> V_126 ) ;
if ( V_6 -> V_21 . type -> V_161 )
V_158 += V_6 -> V_21 . type -> V_161 ( & V_6 -> V_21 , NULL , type ,
V_156 + V_158 ,
V_157 - V_158 ) ;
...
V_6 -> V_21 . type -> V_164 ) ;
F_31 (p, &pg->pgpaths, list) {
F_105 ( L_54 , V_93 -> V_17 . V_18 -> V_126 ) ;
if ( V_6 -> V_21 . type -> V_161 )
V_158 += V_6 -> V_21 . type -> V_161 ( & V_6 -> V_21 ,
& V_93 -> V_17 , type , V_156 + V_158 ,
V_157 - V_158 ) ;
...
static int F_106 ( struct V_9 * V_10 , unsigned V_96 , char * * V_92 )
{
int V_66 = - V_90 ;
struct V_131 * V_18 ;
struct V_12 * V_13 = (struct V_12 * ) V_10 -> V_14 ;
...
static int F_108 ( struct V_9 * V_10 , unsigned int V_165 ,
unsigned long V_166 )
{
struct V_12 * V_13 = V_10 -> V_14 ;
struct V_1 * V_1 ;
...
V_66 = - V_70 ;
F_43 ( & V_13 -> V_25 , V_68 ) ;
if ( ! V_19 || V_10 -> V_110 != F_109 ( V_19 -> V_169 ) >> V_170 ) {
int V_171 = F_110 ( NULL , V_165 ) ;
if ( V_171 )
V_66 = V_171 ;
}
if ( V_66 == - V_168 && ! F_111 ( V_121 ) ) {
F_41 ( & V_13 -> V_25 , V_68 ) ;
if ( ! V_13 -> V_47 ) {
F_36 ( V_13 , 0 ) ;
}
...
return V_66 ? : F_112 ( V_19 , V_167 , V_165 , V_166 ) ;
}
...
if ( F_117 ( ! V_13 -> V_56 && V_13 -> V_60 ) )
V_6 = V_13 -> V_60 ;
else if ( F_118 ( V_13 -> V_47 ) )
V_6 = V_13 -> V_47 ;
else
goto V_125;
V_174 = 1 ;
