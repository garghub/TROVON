...
F_21 ( V_2 ) ;
V_11 = F_22 ( V_2 , V_82 , & V_40 , V_5 ,
0 , V_34 ,
V_26 -> V_83 , NULL , & V_33 , V_38 ,
V_84 , V_26 -> V_85 ) ;
if ( V_11 ) {
F_23 ( F_24 ( V_2 ) , V_38 -> V_86 ,
V_87 ) ;
F_25 ( V_2 ) ;
} else {
V_11 = F_26 ( V_2 , & V_33 ,
...
static void * F_28 ( struct V_88 * V_89 , T_5 * V_90 )
{
return F_29 ( V_89 , V_90 , V_42 ) ;
}
static int F_30 ( struct V_88 * V_89 , void * V_91 )
{
if ( V_91 == V_92 ) {
F_31 ( V_89 , V_93 ) ;
} else {
...
T_6 V_97 = F_32 ( V_24 -> V_75 ) ;
T_6 V_98 = F_32 ( V_24 -> V_99 ) ;
F_33 ( V_89 , V_91 , V_97 , V_98 , V_94 ) ;
}
return 0 ;
}
static int T_7 F_34 ( struct V_15 * V_15 )
{
return F_35 ( V_15 , & V_100 ) ;
}
static void T_7 F_36 ( struct V_15 * V_15 )
{
return F_37 ( V_15 , & V_100 ) ;
}
int T_8 F_38 ( void )
{
#ifdef F_39
int V_101 = F_40 ( & V_102 ) ;
if ( V_101 )
return V_101 ;
#endif
V_103 . V_104 = V_104 ;
