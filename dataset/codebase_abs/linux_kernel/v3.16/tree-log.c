...
if ( V_248 == V_320 && F_39 ( V_78 -> V_143 ) ) {
...
F_113 ( V_78 ) -> V_211 = F_113 ( V_78 ) -> V_323 ;
V_218:
if ( F_263 ( V_214 ) )
F_264 ( & V_275 ) ;
else
...
if ( F_133 ( V_78 -> V_143 ) &&
F_113 ( V_78 ) -> V_236 <= V_327 &&
F_113 ( V_78 ) -> V_330 <= V_327 )
goto V_13;
if ( ! F_39 ( V_78 -> V_143 ) ) {
...
struct V_5 * V_6 )
{
struct V_324 * V_183 = F_268 ( V_324 ) ;
int V_8 ;
V_8 = F_270 ( V_2 , V_4 , V_324 -> V_331 , V_183 ,
0 , V_6 ) ;
F_269 ( V_183 ) ;
return V_8 ;
}
...
V_339 . V_54 = V_146 . V_76 ;
V_339 . type = V_341 ;
V_339 . V_76 = ( T_1 ) - 1 ;
V_31 . V_170 = F_278 ( V_11 , & V_339 ) ;
if ( F_83 ( V_31 . V_170 ) ) {
...
return;
V_344:
F_113 ( V_99 ) -> V_330 = V_2 -> V_73 ;
}
int F_283 ( struct V_1 * V_2 ,
struct V_78 * V_78 , struct V_78 * V_345 ,
struct V_324 * V_183 )
{
...
if ( F_113 ( V_78 ) -> V_217 <=
V_4 -> V_11 -> V_308 &&
( ! V_345 || F_113 ( V_345 ) -> V_217 <=
V_4 -> V_11 -> V_308 ) )
return 0 ;
return F_270 ( V_2 , V_4 , V_78 , V_183 , 1 , NULL ) ;
}
