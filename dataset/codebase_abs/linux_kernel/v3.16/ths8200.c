...
F_14 ( V_3 , V_71 , ( V_35 -> V_38 + 1 ) & 0xff ) ;
F_17 ( V_3 , V_72 , 0x3f ,
( ( V_35 -> V_38 + 1 ) >> 2 ) & 0xc0 ) ;
F_17 ( V_3 , V_72 , 0xf8 ,
( ( F_9 ( V_35 ) + 1 ) >> 8 ) & 0x7 ) ;
F_14 ( V_3 , V_73 , F_9 ( V_35 ) + 1 ) ;
F_14 ( V_3 , V_74 , 0x00 ) ;
F_14 ( V_3 , V_75 , 0x07 ) ;
F_14 ( V_3 , V_76 , 0xff ) ;
F_14 ( V_3 , V_77 , 0 ) ;
...
struct V_2 * V_3 ;
int error ;
if ( ! F_36 ( V_8 -> V_97 , V_98 ) )
return - V_99 ;
V_16 = F_37 ( & V_8 -> V_100 , sizeof( * V_16 ) , V_101 ) ;
if ( ! V_16 )
return - V_102 ;
V_3 = & V_16 -> V_3 ;
F_38 ( V_3 , V_8 , & V_103 ) ;
V_16 -> V_19 = F_11 ( V_3 , V_104 ) ;
