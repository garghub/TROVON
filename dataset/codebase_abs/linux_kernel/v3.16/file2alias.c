...
static int F_49 ( const char * V_58 , void * V_7 , char * V_18 )
{
F_5 ( V_7 , V_253 , V_246 ) ;
sprintf ( V_18 , L_114 , V_246 ) ;
return 1 ;
}
static int F_50 ( const char * V_58 , void * V_7 ,
char * V_18 )
{
F_20 ( V_7 , V_254 , V_57 ) ;
sprintf ( V_18 , V_255 L_99 , * V_57 ) ;
return 1 ;
}
static int F_51 ( const char * V_58 ,
void * V_7 , char * V_18 )
{
F_5 ( V_7 , V_256 , V_257 ) ;
F_5 ( V_7 , V_256 , V_258 ) ;
...
F_5 ( V_7 , V_256 , V_260 ) ;
strcpy ( V_18 , L_115 ) ;
F_6 ( V_18 , L_14 , V_258 != V_261 , V_258 ) ;
F_6 ( V_18 , L_16 , V_257 != V_261 , V_257 ) ;
F_6 ( V_18 , L_116 , V_260 != V_261 , V_260 ) ;
F_6 ( V_18 , L_117 , V_259 != V_261 , V_259 ) ;
F_1 ( V_18 ) ;
return 1 ;
}
static bool F_52 ( const char * V_57 , unsigned V_262 , const char * V_263 )
{
if ( V_262 != strlen ( V_263 ) )
return false ;
return memcmp ( V_57 , V_263 , V_262 ) == 0 ;
}
static void F_53 ( void * V_7 , unsigned long V_5 ,
unsigned long V_6 ,
const char * V_4 ,
void * V_124 ,
struct V_16 * V_17 )
...
unsigned int V_8 ;
char V_18 [ 500 ] ;
int (* F_54)( const char * , void * V_264 , char * V_18 ) = V_124 ;
F_2 ( V_17 -> V_57 , V_4 , V_5 , V_6 , V_7 ) ;
V_5 -= V_6 ;
for ( V_8 = 0 ; V_8 < V_5 ; V_8 += V_6 ) {
if ( F_54 ( V_17 -> V_57 , V_7 + V_8 , V_18 ) ) {
F_7 ( & V_17 -> V_40 ,
L_31 , V_18 ) ;
}
}
}
void F_55 ( struct V_16 * V_17 , struct V_265 * V_266 ,
T_3 * V_267 , const char * V_268 )
{
void * V_7 ;
char * V_269 = NULL ;
const char * V_57 , * V_270 ;
unsigned int V_262 ;
if ( ! V_267 -> V_271 || F_56 ( V_266 , V_267 ) >= V_266 -> V_272 )
return;
if ( F_57 ( V_267 -> V_273 ) != V_274 )
return;
V_57 = strstr ( V_268 , L_118 ) ;
if ( ! V_57 )
return;
V_57 += strlen ( L_118 ) ;
V_262 = strlen ( V_57 ) ;
if ( V_262 < strlen ( L_119 ) )
return;
if ( strcmp ( V_57 + V_262 - strlen ( L_119 ) , L_119 ) )
return;
V_270 = strstr ( V_57 , L_120 ) ;
if ( ! V_270 )
return;
V_262 = V_270 - V_57 ;
if ( V_266 -> V_275 [ F_56 ( V_266 , V_267 ) ] . V_276 & V_277 ) {
V_269 = calloc ( 1 , V_267 -> V_278 ) ;
V_7 = V_269 ;
} else {
V_7 = ( void * ) V_266 -> V_279
+ V_266 -> V_275 [ F_56 ( V_266 , V_267 ) ] . V_280
+ V_267 -> V_281 ;
}
if ( F_52 ( V_57 , V_262 , L_32 ) )
F_10 ( V_7 , V_267 -> V_278 , V_17 ) ;
else if ( F_52 ( V_57 , V_262 , L_61 ) )
F_21 ( V_7 , V_267 -> V_278 , V_17 ) ;
else if ( F_52 ( V_57 , V_262 , L_121 ) )
F_22 ( V_7 , V_267 -> V_278 , V_17 ) ;
else {
struct V_282 * * V_242 ;
F_58 ( V_283 ) ;
for ( V_242 = V_284 ; V_242 < V_285 ; V_242 ++ ) {
if ( F_52 ( V_57 , V_262 , ( * V_242 ) -> V_4 ) ) {
F_53 ( V_7 , V_267 -> V_278 , ( * V_242 ) -> V_6 ,
...
void F_59 ( struct V_286 * V_287 , struct V_16 * V_17 )
{
F_7 ( V_287 , L_10 ) ;
F_60 ( V_287 , V_17 -> V_40 . V_242 , V_17 -> V_40 . V_288 ) ;
