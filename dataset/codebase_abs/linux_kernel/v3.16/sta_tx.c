...
V_10 -> V_20 = V_2 -> V_20 ;
V_10 -> V_21 = V_2 -> V_21 ;
V_10 -> V_45 = V_40 - ( sizeof( struct V_7 ) + V_19 ) ;
...
V_8 -> V_30 = V_30 ;
V_8 -> V_23 = V_46 ;
V_8 -> V_36 = F_8 ( sizeof( struct V_7 ) ) ;
V_8 -> V_20 = V_2 -> V_20 ;
V_8 -> V_21 = V_2 -> V_21 ;
if ( V_6 -> V_47 == V_48 ) {
V_41 = V_6 -> V_49 . V_50 ( V_6 , V_51 ,
V_4 , NULL ) ;
} else {
F_7 ( V_4 , V_19 ) ;
V_39 . V_52 = 0 ;
V_41 = V_6 -> V_49 . V_50 ( V_6 , V_53 ,
V_4 , & V_39 ) ;
}
switch ( V_41 ) {
case - V_54 :
