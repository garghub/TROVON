...
V_274 = (struct V_240 * )
& ( V_138 -> V_222 . V_223 . V_224 . V_274 . V_294 ) ;
...
V_2 -> V_125 = F_26 ( V_49 ) ;
V_49 -> V_54 . V_55 = ( char * ) V_2 ;
V_299 = F_113 ( V_14 -> V_299 , F_51 () ) ;
if ( V_49 -> V_259 == V_300 ) {
V_2 -> V_158 = V_301 ;
V_299 -> V_302 ++ ;
V_299 -> V_303 += V_2 -> V_125 ;
} else if ( V_49 -> V_259 == V_304 ) {
V_2 -> V_158 = V_305 ;
V_299 -> V_306 ++ ;
V_299 -> V_307 += V_2 -> V_125 ;
} else {
V_2 -> V_158 = 0 ;
V_299 -> V_308 ++ ;
}
