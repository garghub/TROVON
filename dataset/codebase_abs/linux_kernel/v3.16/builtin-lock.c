...
static int F_56 ( int V_118 , const char * * V_119 )
{
const char * V_120 [] = {
L_40 , L_41 , L_42 , L_43 , L_44 , L_45 ,
} ;
unsigned int V_121 , V_22 , V_122 , V_32 ;
const char * * V_123 ;
for ( V_22 = 0 ; V_22 < F_57 ( V_117 ) ; V_22 ++ ) {
if ( ! F_58 ( V_117 [ V_22 ] . V_24 ) ) {
F_9 ( L_46
L_47 ,
V_117 [ V_22 ] . V_24 ) ;
return 1 ;
...
V_121 = F_57 ( V_120 ) + V_118 - 1 ;
V_121 += 2 * F_57 ( V_117 ) ;
V_123 = calloc ( V_121 + 1 , sizeof( char * ) ) ;
if ( ! V_123 )
return - V_48 ;
for ( V_22 = 0 ; V_22 < F_57 ( V_120 ) ; V_22 ++ )
V_123 [ V_22 ] = F_59 ( V_120 [ V_22 ] ) ;
for ( V_122 = 0 ; V_122 < F_57 ( V_117 ) ; V_122 ++ ) {
V_123 [ V_22 ++ ] = L_48 ;
V_123 [ V_22 ++ ] = F_59 ( V_117 [ V_122 ] . V_24 ) ;
}
for ( V_122 = 1 ; V_122 < ( unsigned int ) V_118 ; V_122 ++ , V_22 ++ )
V_123 [ V_22 ] = V_119 [ V_122 ] ;
F_4 ( V_22 != V_121 ) ;
V_32 = F_60 ( V_22 , V_123 , NULL ) ;
free ( V_123 ) ;
return V_32 ;
}
int F_61 ( int V_118 , const char * * V_119 , const char * T_5 V_95 )
{
...
const struct V_124 V_126 [] = {
F_64 ( 'i' , L_53 , & V_113 , L_54 , L_55 ) ,
F_65 ( 'v' , L_56 , & V_127 , L_57 ) ,
F_62 ( 'D' , L_58 , & V_128 , L_59 ) ,
F_63 ()
} ;
const struct V_124 V_129 [] = {
F_64 ( 'k' , L_60 , & V_25 , L_9 ,
L_61 ) ,
F_63 ()
} ;
...
const char * const V_131 [] = { L_40 , L_63 , L_64 ,
L_65 , NULL } ;
const char * V_132 [] = {
NULL ,
NULL
...
for ( V_22 = 0 ; V_22 < V_90 ; V_22 ++ )
F_10 ( V_134 + V_22 ) ;
V_118 = F_67 ( V_118 , V_119 , V_126 , V_131 ,
V_132 , V_135 ) ;
if ( ! V_118 )
F_68 ( V_132 , V_126 ) ;
if ( ! strncmp ( V_119 [ 0 ] , L_67 , 3 ) ) {
return F_56 ( V_118 , V_119 ) ;
} else if ( ! strncmp ( V_119 [ 0 ] , L_63 , 6 ) ) {
V_77 = & V_136 ;
if ( V_118 ) {
V_118 = F_69 ( V_118 , V_119 ,
V_129 , V_133 , 0 ) ;
if ( V_118 )
F_68 ( V_133 , V_129 ) ;
}
V_91 = F_49 ( false ) ;
} else if ( ! strcmp ( V_119 [ 0 ] , L_64 ) ) {
return F_70 ( V_118 , V_119 , T_5 ) ;
} else if ( ! strcmp ( V_119 [ 0 ] , L_65 ) ) {
if ( V_118 ) {
V_118 = F_69 ( V_118 , V_119 ,
V_125 , V_130 , 0 ) ;
if ( V_118 )
