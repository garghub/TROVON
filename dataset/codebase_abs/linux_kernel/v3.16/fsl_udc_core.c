...
static int T_8 F_129 ( struct V_362 * V_363 )
{
struct V_3 * V_4 ;
struct V_372 * V_373 ;
int V_198 = - V_212 ;
...
#endif
V_373 = F_133 ( V_363 , V_378 , 0 ) ;
if ( ! V_373 ) {
V_198 = - V_379 ;
goto V_377;
}
if ( V_4 -> V_374 == V_380 ) {
if ( ! F_134 ( V_373 -> V_381 , F_135 ( V_373 ) ,
V_352 ) ) {
F_36 ( L_113 , V_363 -> V_35 ) ;
V_198 = - V_382 ;
goto V_377;
}
}
V_47 = F_136 ( V_373 -> V_381 , F_135 ( V_373 ) ) ;
if ( ! V_47 ) {
V_198 = - V_196 ;
goto V_383;
}
...
V_9 -> V_329 = F_138 ( V_363 , 0 ) ;
if ( ! V_9 -> V_329 ) {
V_198 = - V_212 ;
goto V_389;
}
V_198 = F_139 ( V_9 -> V_329 , F_111 , V_391 ,
V_352 , V_9 ) ;
if ( V_198 != 0 ) {
F_36 ( L_115 ,
V_9 -> V_329 , V_198 ) ;
...
char V_35 [ 14 ] ;
sprintf ( V_35 , L_119 , V_304 ) ;
F_127 ( V_9 , V_304 * 2 , V_35 , 1 ) ;
sprintf ( V_35 , L_120 , V_304 ) ;
F_127 ( V_9 , V_304 * 2 + 1 , V_35 , 1 ) ;
}
V_9 -> V_31 = F_142 ( L_121 , & V_363 -> V_359 ,
sizeof( struct V_22 ) ,
V_397 , V_398 ) ;
if ( V_9 -> V_31 == NULL ) {
V_198 = - V_196 ;
...
V_198 = F_143 ( & V_363 -> V_359 , & V_9 -> V_33 ,
F_121 ) ;
if ( V_198 )
goto V_399;
F_144 () ;
...
V_383:
if ( V_4 -> V_374 == V_380 )
F_149 ( V_373 -> V_381 , F_135 ( V_373 ) ) ;
V_377:
F_59 ( V_9 ) ;
V_9 = NULL ;
return V_198 ;
}
static int T_10 F_150 ( struct V_362 * V_363 )
{
struct V_372 * V_373 = F_133 ( V_363 , V_378 , 0 ) ;
...
static int F_155 ( struct V_362 * V_363 , T_11 V_400 )
{
F_41 ( V_9 ) ;
return 0 ;
}
static int F_156 ( struct V_362 * V_363 )
{
if ( V_9 -> V_21 ) {
F_28 ( V_9 ) ;
F_40 ( V_9 ) ;
...
static int F_157 ( struct V_358 * V_359 , T_11 V_400 )
{
struct V_19 * V_20 = V_9 ;
T_1 V_401 , V_68 ;
V_401 = F_30 ( & V_47 -> V_73 ) & V_74 ;
F_42 ( L_122 , V_105 , V_401 , V_20 -> V_21 ) ;
if ( V_20 -> V_21 ) {
F_42 ( L_123 ) ;
V_20 -> V_402 = 1 ;
return 0 ;
...
static int F_159 ( struct V_358 * V_359 )
{
F_42 ( L_126 , V_105 ,
V_9 -> V_21 , V_9 -> V_402 ) ;
if ( V_9 -> V_402 ) {
