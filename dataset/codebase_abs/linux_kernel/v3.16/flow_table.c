...
void F_36 ( struct V_31 * V_32 , bool V_42 )
{
...
static V_49 F_48 ( const struct V_5 * V_12 , int V_68 ,
int V_69 )
{
const V_49 * V_70 = ( const V_49 * ) ( ( const V_11 * ) V_12 + V_68 ) ;
int V_71 = ( V_69 - V_68 ) >> 2 ;
F_49 ( sizeof( long ) % sizeof( V_49 ) ) ;
return F_50 ( V_70 , V_71 , 0 ) ;
}
static int F_51 ( const struct V_5 * V_12 )
{
if ( V_12 -> V_72 . V_73 )
return 0 ;
else
return F_52 ( F_53 ( struct V_5 , V_74 ) ,
sizeof( long ) ) ;
}
static bool F_54 ( const struct V_5 * V_75 ,
...
static bool F_55 ( const struct V_16 * V_17 ,
const struct V_5 * V_12 ,
int V_68 , int V_69 )
{
return F_54 ( & V_17 -> V_12 , V_12 , V_68 , V_69 ) ;
}
bool F_56 ( const struct V_16 * V_17 ,
struct V_80 * V_81 )
{
struct V_5 * V_12 = V_81 -> V_12 ;
int V_68 = F_51 ( V_12 ) ;
int V_69 = V_81 -> V_2 . V_3 ;
return F_54 ( & V_17 -> V_82 , V_12 , V_68 , V_69 ) ;
}
static struct V_16 * F_57 ( struct V_43 * V_44 ,
...
struct V_16 * F_58 ( struct V_31 * V_85 ,
const struct V_5 * V_12 ,
V_49 * V_86 )
{
struct V_43 * V_44 = F_59 ( V_85 -> V_44 ) ;
struct V_8 * V_9 ;
struct V_16 * V_17 ;
* V_86 = 0 ;
F_60 (mask, &tbl->mask_list, list) {
( * V_86 ) ++ ;
V_17 = F_57 ( V_44 , V_12 , V_9 ) ;
if ( V_17 )
return V_17 ;
}
return NULL ;
}
struct V_16 * F_61 ( struct V_31 * V_85 ,
const struct V_5 * V_12 )
{
V_49 T_2 V_86 ;
return F_58 ( V_85 , V_12 , & V_86 ) ;
}
...
struct V_8 * V_9 ;
struct V_16 * V_17 ;
F_63 (mask, &tbl->mask_list, list) {
V_17 = F_57 ( V_44 , V_81 -> V_12 , V_9 ) ;
if ( V_17 && F_56 ( V_17 , V_81 ) )
return V_17 ;
}
return NULL ;
}
int F_64 ( const struct V_31 * V_32 )
{
struct V_8 * V_9 ;
int V_87 = 0 ;
...
static struct V_43 * F_65 ( struct V_43 * V_44 )
{
return F_46 ( V_44 , V_44 -> V_35 * 2 ) ;
}
static void F_66 ( struct V_31 * V_85 , struct V_8 * V_9 )
{
if ( V_9 ) {
F_67 () ;
F_68 ( ! V_9 -> V_88 ) ;
...
void F_71 ( struct V_31 * V_32 , struct V_16 * V_17 )
{
struct V_43 * V_44 = F_37 ( V_32 -> V_44 ) ;
F_68 ( V_32 -> V_33 == 0 ) ;
...
static struct V_8 * F_74 ( const struct V_31 * V_85 ,
const struct V_8 * V_9 )
{
struct V_94 * V_95 ;
...
static int F_76 ( struct V_31 * V_85 , struct V_16 * V_17 ,
struct V_8 * V_64 )
{
struct V_8 * V_9 ;
V_9 = F_74 ( V_85 , V_64 ) ;
...
int F_78 ( struct V_31 * V_32 , struct V_16 * V_17 ,
struct V_8 * V_9 )
{
struct V_43 * V_66 = NULL ;
struct V_43 * V_44 ;
int V_29 ;
V_29 = F_76 ( V_32 , V_17 , V_9 ) ;
if ( V_29 )
return V_29 ;
V_17 -> V_62 = F_48 ( & V_17 -> V_12 , V_17 -> V_9 -> V_2 . V_4 ,
V_17 -> V_9 -> V_2 . V_3 ) ;
V_44 = F_37 ( V_32 -> V_44 ) ;
F_42 ( V_44 , V_17 ) ;
V_32 -> V_33 ++ ;
...
V_66 = F_65 ( V_44 ) ;
else if ( F_79 ( V_53 , V_32 -> V_52 + V_96 ) )
...
int F_80 ( void )
{
F_49 ( F_81 ( struct V_5 ) % F_81 ( long ) ) ;
F_49 ( sizeof( struct V_5 ) % sizeof( long ) ) ;
V_21 = F_82 ( L_1 , sizeof( struct V_16 )
+ ( F_83 ()
* sizeof( struct V_18 * ) ) ,
0 , 0 , NULL ) ;
if ( V_21 == NULL )
