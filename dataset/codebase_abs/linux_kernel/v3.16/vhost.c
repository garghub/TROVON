...
if ( ( V_94 . V_146 & ( sizeof * V_33 -> V_36 -> V_113 - 1 ) ) ||
( V_94 . V_145 & ( sizeof * V_33 -> V_37 -> V_113 - 1 ) ) ||
( V_94 . V_147 & ( sizeof * V_33 -> V_37 -> V_113 - 1 ) ) ) {
V_136 = - V_25 ;
break;
}
if ( V_33 -> V_46 ) {
...
V_124 = V_133 . V_149 == - 1 ? NULL : F_86 ( V_133 . V_149 ) ;
if ( F_58 ( V_124 ) ) {
V_136 = F_59 ( V_124 ) ;
break;
}
...
long F_88 ( struct V_20 * V_105 , unsigned int V_122 , void T_6 * V_123 )
{
struct V_1 * V_124 , * V_125 = NULL ;
struct V_128 * V_129 = NULL ;
T_7 V_153 ;
...
break;
case V_156 :
if ( F_82 ( & V_153 , V_123 , sizeof V_153 ) ) {
V_136 = - V_117 ;
break;
}
...
break;
case V_158 :
V_136 = F_84 ( V_149 , ( int T_6 * ) V_123 ) ;
if ( V_136 < 0 )
break;
V_124 = V_149 == - 1 ? NULL : F_86 ( V_149 ) ;
if ( F_58 ( V_124 ) ) {
V_136 = F_59 ( V_124 ) ;
break;
}
...
static const struct V_100 * F_89 ( struct V_88 * V_98 ,
T_10 V_92 , T_11 V_159 )
{
struct V_100 * V_160 ;
int V_64 ;
for ( V_64 = 0 ; V_64 < V_98 -> V_90 ; ++ V_64 ) {
V_160 = V_98 -> V_89 + V_64 ;
if ( V_160 -> V_104 <= V_92 &&
V_160 -> V_104 + V_160 -> V_103 - 1 >= V_92 )
return V_160 ;
}
return NULL ;
}
static int F_90 ( int V_161 , void T_6 * V_92 )
{
...
static int F_97 ( void T_6 * V_48 ,
T_7 V_165 , T_7 V_166 )
{
T_7 V_167 = V_165 / V_95 ;
int V_136 ;
if ( ! V_166 )
return 0 ;
V_166 += V_165 % V_95 ;
for (; ; ) {
T_7 V_157 = ( T_7 ) ( unsigned long ) V_48 ;
T_7 log = V_157 + V_167 / 8 ;
int V_163 = V_167 % 8 ;
if ( ( T_7 ) ( unsigned long ) log != log )
return - V_117 ;
V_136 = F_90 ( V_163 , ( void T_6 * ) ( unsigned long ) log ) ;
if ( V_136 < 0 )
return V_136 ;
if ( V_166 <= V_95 )
break;
...
int F_98 ( struct V_32 * V_33 , struct V_168 * log ,
unsigned int V_169 , T_7 V_159 )
{
int V_64 , V_136 ;
F_99 () ;
for ( V_64 = 0 ; V_64 < V_169 ; ++ V_64 ) {
T_7 V_170 = F_100 ( log [ V_64 ] . V_159 , V_159 ) ;
V_136 = F_97 ( V_33 -> V_48 , log [ V_64 ] . V_92 , V_170 ) ;
if ( V_136 < 0 )
return V_136 ;
V_159 -= V_170 ;
if ( ! V_159 ) {
...
{
void T_6 * V_37 ;
if ( F_104 ( V_33 -> V_43 , & V_33 -> V_37 -> V_29 ) < 0 )
return - V_117 ;
if ( F_105 ( V_33 -> V_44 ) ) {
F_99 () ;
V_37 = & V_33 -> V_37 -> V_29 ;
F_97 ( V_33 -> V_48 , V_33 -> V_45 +
...
static int F_106 ( struct V_32 * V_33 , T_12 V_171 )
{
if ( F_104 ( V_33 -> V_39 , F_107 ( V_33 ) ) )
return - V_117 ;
if ( F_105 ( V_33 -> V_44 ) ) {
void T_6 * V_37 ;
F_99 () ;
...
return V_136 ;
V_33 -> V_42 = false ;
return F_84 ( V_33 -> V_40 , & V_33 -> V_37 -> V_135 ) ;
}
static int F_109 ( struct V_32 * V_33 , T_7 V_92 , T_9 V_159 ,
struct V_172 V_173 [] , int V_174 )
{
const struct V_100 * V_160 ;
struct V_88 * V_98 ;
struct V_172 * V_175 ;
T_7 V_78 = 0 ;
int V_22 = 0 ;
V_98 = V_33 -> V_54 ;
while ( ( T_7 ) V_159 > V_78 ) {
T_7 V_116 ;
if ( F_105 ( V_22 >= V_174 ) ) {
V_22 = - V_137 ;
break;
}
V_160 = F_89 ( V_98 , V_92 , V_159 ) ;
if ( F_105 ( ! V_160 ) ) {
V_22 = - V_117 ;
break;
}
V_175 = V_173 + V_22 ;
V_116 = V_160 -> V_103 - V_92 + V_160 -> V_104 ;
V_175 -> V_176 = F_100 ( ( T_7 ) V_159 - V_78 , V_116 ) ;
V_175 -> V_177 = ( void T_6 * ) ( unsigned long )
( V_160 -> V_102 + V_92 - V_160 -> V_104 ) ;
V_78 += V_116 ;
V_92 += V_116 ;
++ V_22 ;
}
...
static unsigned F_110 ( struct V_108 * V_35 )
{
unsigned int V_178 ;
if ( ! ( V_35 -> V_29 & V_179 ) )
return - 1U ;
...
{
struct V_108 V_35 ;
unsigned int V_64 = 0 , V_182 , V_183 = 0 ;
int V_22 ;
if ( F_105 ( V_62 -> V_159 % sizeof V_35 ) ) {
F_113 ( V_33 , L_2
L_3 ,
( unsigned long long ) V_62 -> V_159 ,
sizeof V_35 ) ;
return - V_25 ;
}
V_22 = F_109 ( V_33 , V_62 -> V_92 , V_62 -> V_159 , V_33 -> V_62 ,
V_67 ) ;
if ( F_105 ( V_22 < 0 ) ) {
F_113 ( V_33 , L_4 , V_22 ) ;
return V_22 ;
...
F_111 () ;
V_182 = V_62 -> V_159 / sizeof V_35 ;
if ( F_105 ( V_182 > V_184 + 1 ) ) {
F_113 ( V_33 , L_5 ,
V_62 -> V_159 ) ;
return - V_121 ;
}
...
if ( F_105 ( ++ V_183 > V_182 ) ) {
F_113 ( V_33 , L_6
L_7 ,
V_64 , V_182 ) ;
return - V_25 ;
}
if ( F_105 ( F_114 ( ( unsigned char * ) & V_35 ,
V_33 -> V_62 , sizeof V_35 ) ) ) {
F_113 ( V_33 , L_8 ,
V_64 , ( T_8 ) V_62 -> V_92 + V_64 * sizeof V_35 ) ;
return - V_25 ;
}
if ( F_105 ( V_35 . V_29 & V_186 ) ) {
F_113 ( V_33 , L_9 ,
V_64 , ( T_8 ) V_62 -> V_92 + V_64 * sizeof V_35 ) ;
return - V_25 ;
}
V_22 = F_109 ( V_33 , V_35 . V_92 , V_35 . V_159 , V_173 + V_185 ,
V_174 - V_185 ) ;
if ( F_105 ( V_22 < 0 ) ) {
F_113 ( V_33 , L_10 ,
V_22 , V_64 ) ;
...
{
struct V_108 V_35 ;
unsigned int V_64 , V_188 , V_183 = 0 ;
T_12 V_38 ;
int V_22 ;
V_38 = V_33 -> V_38 ;
if ( F_105 ( F_116 ( V_33 -> V_39 , & V_33 -> V_36 -> V_135 ) ) ) {
F_113 ( V_33 , L_13 ,
& V_33 -> V_36 -> V_135 ) ;
return - V_117 ;
}
if ( F_105 ( ( T_12 ) ( V_33 -> V_39 - V_38 ) > V_33 -> V_34 ) ) {
F_113 ( V_33 , L_14 ,
V_38 , V_33 -> V_39 ) ;
return - V_117 ;
}
...
do {
unsigned V_185 = * V_181 + * V_180 ;
if ( F_105 ( V_64 >= V_33 -> V_34 ) ) {
F_113 ( V_33 , L_17 ,
V_64 , V_33 -> V_34 , V_188 ) ;
return - V_25 ;
}
if ( F_105 ( ++ V_183 > V_33 -> V_34 ) ) {
F_113 ( V_33 , L_6
L_18 ,
V_64 , V_33 -> V_34 , V_188 ) ;
return - V_25 ;
}
V_22 = F_118 ( & V_35 , V_33 -> V_35 + V_64 , sizeof V_35 ) ;
if ( F_105 ( V_22 ) ) {
F_113 ( V_33 , L_19 ,
V_64 , V_33 -> V_35 + V_64 ) ;
return - V_117 ;
...
void F_119 ( struct V_32 * V_33 , int V_190 )
{
V_33 -> V_38 -= V_190 ;
}
int F_120 ( struct V_32 * V_33 , unsigned int V_188 , int V_159 )
{
struct V_191 V_63 = { V_188 , V_159 } ;
return F_121 ( V_33 , & V_63 , 1 ) ;
}
...
V_37 = V_33 -> V_37 -> V_113 + V_194 ;
if ( V_182 == 1 ) {
if ( F_104 ( V_63 [ 0 ] . V_195 , & V_37 -> V_195 ) ) {
F_113 ( V_33 , L_25 ) ;
return - V_117 ;
}
if ( F_104 ( V_63 [ 0 ] . V_159 , & V_37 -> V_159 ) ) {
F_113 ( V_33 , L_26 ) ;
return - V_117 ;
}
} else if ( F_123 ( V_37 , V_63 , V_182 * sizeof *V_37 ) ) {
F_113 ( V_33 , L_27 ) ;
return - V_117 ;
}
if ( F_105 ( V_33 -> V_44 ) ) {
...
if ( F_105 ( ( T_12 ) ( V_193 - V_33 -> V_41 ) < ( T_12 ) ( V_193 - V_192 ) ) )
V_33 -> V_42 = false ;
return 0 ;
}
int F_121 ( struct V_32 * V_33 , struct V_191 * V_63 ,
unsigned V_182 )
{
...
if ( V_190 < V_182 ) {
V_136 = F_122 ( V_33 , V_63 , V_190 ) ;
if ( V_136 < 0 )
return V_136 ;
V_63 += V_190 ;
V_182 -= V_190 ;
}
V_136 = F_122 ( V_33 , V_63 , V_182 ) ;
F_99 () ;
if ( F_124 ( V_33 -> V_40 , & V_33 -> V_37 -> V_135 ) ) {
F_113 ( V_33 , L_28 ) ;
return - V_117 ;
}
if ( F_105 ( V_33 -> V_44 ) ) {
...
static bool F_125 ( struct V_20 * V_21 , struct V_32 * V_33 )
{
T_13 V_192 , V_193 , V_196 ;
bool V_197 ;
F_126 () ;
if ( F_75 ( V_33 , V_198 ) &&
F_105 ( V_33 -> V_39 == V_33 -> V_38 ) )
return true ;
if ( ! F_75 ( V_33 , V_111 ) ) {
T_13 V_29 ;
if ( F_116 ( V_29 , & V_33 -> V_36 -> V_29 ) ) {
F_113 ( V_33 , L_29 ) ;
return true ;
}
return ! ( V_29 & V_199 ) ;
...
if ( F_105 ( ! V_197 ) )
return true ;
if ( F_84 ( V_196 , F_127 ( V_33 ) ) ) {
F_113 ( V_33 , L_30 ) ;
return true ;
}
return F_128 ( V_196 , V_193 , V_192 ) ;
}
void F_129 ( struct V_20 * V_21 , struct V_32 * V_33 )
{
if ( V_33 -> V_51 && F_125 ( V_21 , V_33 ) )
F_101 ( V_33 -> V_51 , 1 ) ;
}
void F_130 ( struct V_20 * V_21 ,
struct V_32 * V_33 ,
unsigned int V_188 , int V_159 )
{
F_120 ( V_33 , V_188 , V_159 ) ;
F_129 ( V_21 , V_33 ) ;
}
void F_131 ( struct V_20 * V_21 ,
struct V_32 * V_33 ,
struct V_191 * V_63 , unsigned V_182 )
{
F_121 ( V_33 , V_63 , V_182 ) ;
F_129 ( V_21 , V_33 ) ;
}
bool F_132 ( struct V_20 * V_21 , struct V_32 * V_33 )
{
T_12 V_39 ;
int V_136 ;
if ( ! ( V_33 -> V_43 & V_189 ) )
...
F_126 () ;
V_136 = F_116 ( V_39 , & V_33 -> V_36 -> V_135 ) ;
if ( V_136 ) {
F_113 ( V_33 , L_33 ,
...
void F_133 ( struct V_20 * V_21 , struct V_32 * V_33 )
{
int V_136 ;
if ( V_33 -> V_43 & V_189 )
return;
...
static int T_14 F_134 ( void )
{
return 0 ;
}
static void T_15 F_135 ( void )
{
}
