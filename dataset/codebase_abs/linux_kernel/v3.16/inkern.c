...
V_6 = F_36 ( V_23 , V_61 , NULL , V_74 ) ;
V_72:
F_5 ( & V_23 -> V_2 -> V_71 ) ;
return V_6 ;
}
static int F_39 ( struct V_32 * V_23 ,
int V_75 , int * V_76 , unsigned int V_77 )
{
int V_78 , V_79 , V_80 , V_81 ;
T_1 V_82 = V_75 ;
int V_6 ;
V_6 = F_36 ( V_23 , & V_81 , NULL , V_83 ) ;
if ( V_6 >= 0 )
V_82 += V_81 ;
V_78 = F_36 ( V_23 , & V_79 , & V_80 ,
V_84 ) ;
if ( V_78 < 0 )
return V_78 ;
switch ( V_78 ) {
...
int F_41 ( struct V_32 * V_23 , int V_75 ,
...
V_6 = F_39 ( V_23 , V_75 , V_76 ,
V_77 ) ;
V_72:
F_5 ( & V_23 -> V_2 -> V_71 ) ;
return V_6 ;
}
int F_42 ( struct V_32 * V_23 , int * V_61 )
{
int V_6 ;
F_2 ( & V_23 -> V_2 -> V_71 ) ;
if ( V_23 -> V_2 -> V_64 == NULL ) {
...
if ( V_6 < 0 )
goto V_72;
V_6 = F_39 ( V_23 , * V_61 , V_61 , 1 ) ;
}
V_72:
F_5 ( & V_23 -> V_2 -> V_71 ) ;
return V_6 ;
}
int F_44 ( struct V_32 * V_23 , int * V_61 , int * V_62 )
{
int V_6 ;
F_2 ( & V_23 -> V_2 -> V_71 ) ;
if ( V_23 -> V_2 -> V_64 == NULL ) {
...
V_6 = F_36 ( V_23 , V_61 , V_62 , V_84 ) ;
V_72:
F_5 ( & V_23 -> V_2 -> V_71 ) ;
return V_6 ;
}
int F_45 ( struct V_32 * V_23 , enum V_91 * type )
{
int V_6 = 0 ;
F_2 ( & V_23 -> V_2 -> V_71 ) ;
if ( V_23 -> V_2 -> V_64 == NULL ) {
