...
const void * V_17 , T_2 V_18 , int V_19 )
{
struct V_1 * V_2 = F_9 ( V_16 ) ;
if ( F_3 ( V_2 ) )
return F_4 ( V_2 ) ;
return F_11 ( V_2 , V_3 , V_17 , V_18 , V_19 ) ;
}
int F_11 ( struct V_1 * V_2 , const char * V_3 ,
const void * V_17 , T_2 V_18 , int V_19 )
{
T_3 V_9 = 0 ;
int V_6 , V_7 , V_20 ;
F_5 ( V_12 , L_3 ,
V_3 , V_18 , V_19 ) ;
V_2 = F_12 ( V_2 , 0 , NULL , 1 ) ;
if ( F_3 ( V_2 ) )
return F_4 ( V_2 ) ;
V_6 = F_13 ( V_2 , V_3 , V_18 , V_19 ) ;
if ( V_6 < 0 ) {
F_5 ( V_12 , L_4 ,
V_6 ) ;
goto V_21;
...
T_1 F_15 ( struct V_16 * V_16 , char * V_4 , T_2 V_5 )
{
