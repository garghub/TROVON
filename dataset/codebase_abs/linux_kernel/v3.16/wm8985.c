...
V_117 -> V_177 [ V_115 ] . V_187 = V_188 [ V_115 ] ;
V_156 = F_34 ( V_64 -> V_2 , F_17 ( V_117 -> V_177 ) ,
V_117 -> V_177 ) ;
if ( V_156 ) {
...
for ( V_115 = 0 ; V_115 < F_17 ( V_190 ) ; ++ V_115 )
F_6 ( V_64 , V_190 [ V_115 ] ,
0x100 , 0x100 ) ;
F_6 ( V_64 , V_58 , V_191 ,
V_191 ) ;
F_24 ( V_64 , V_173 ) ;
...
static int F_35 ( struct V_192 * V_193 )
{
struct V_116 * V_117 ;
int V_156 ;
V_117 = F_36 ( & V_193 -> V_2 , sizeof *V_117 , V_194 ) ;
if ( ! V_117 )
return - V_195 ;
F_37 ( V_193 , V_117 ) ;
V_117 -> V_178 = F_38 ( V_193 , & V_196 ) ;
if ( F_39 ( V_117 -> V_178 ) ) {
V_156 = F_40 ( V_117 -> V_178 ) ;
F_11 ( & V_193 -> V_2 , L_18 ,
V_156 ) ;
return V_156 ;
}
V_156 = F_41 ( & V_193 -> V_2 ,
& V_197 , & V_198 , 1 ) ;
return V_156 ;
}
static int F_42 ( struct V_192 * V_193 )
{
F_43 ( & V_193 -> V_2 ) ;
return 0 ;
}
static int F_44 ( struct V_199 * V_200 ,
const struct V_201 * V_202 )
{
struct V_116 * V_117 ;
int V_156 ;
V_117 = F_36 ( & V_200 -> V_2 , sizeof *V_117 , V_194 ) ;
if ( ! V_117 )
return - V_195 ;
F_45 ( V_200 , V_117 ) ;
V_117 -> V_178 = F_46 ( V_200 , & V_196 ) ;
if ( F_39 ( V_117 -> V_178 ) ) {
V_156 = F_40 ( V_117 -> V_178 ) ;
F_11 ( & V_200 -> V_2 , L_18 ,
V_156 ) ;
...
V_156 = F_41 ( & V_200 -> V_2 ,
& V_197 , & V_198 , 1 ) ;
return V_156 ;
}
static int F_47 ( struct V_199 * V_200 )
{
F_43 ( & V_200 -> V_2 ) ;
return 0 ;
}
