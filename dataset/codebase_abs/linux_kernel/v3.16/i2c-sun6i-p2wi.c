...
V_47 = F_17 ( V_38 , V_54 , 0 ) ;
V_3 -> V_5 = F_18 ( V_23 , V_47 ) ;
if ( F_19 ( V_3 -> V_5 ) )
return F_20 ( V_3 -> V_5 ) ;
F_21 ( V_3 -> V_55 . V_56 , V_38 -> V_56 , sizeof( V_3 -> V_55 . V_56 ) ) ;
V_1 = F_22 ( V_38 , 0 ) ;
if ( V_1 < 0 ) {
F_9 ( V_23 , L_9 , V_1 ) ;
return V_1 ;
}
V_3 -> V_57 = F_23 ( V_23 , NULL ) ;
if ( F_19 ( V_3 -> V_57 ) ) {
V_49 = F_20 ( V_3 -> V_57 ) ;
F_9 ( V_23 , L_10 , V_49 ) ;
return V_49 ;
...
F_28 ( & V_3 -> F_4 ) ;
V_3 -> V_55 . V_23 . V_60 = V_23 ;
V_3 -> V_55 . V_61 = & V_62 ;
V_3 -> V_55 . V_63 = V_64 ;
V_3 -> V_55 . V_23 . V_42 = V_38 -> V_23 . V_42 ;
F_29 ( V_38 , V_3 ) ;
F_30 ( & V_3 -> V_55 , V_3 ) ;
V_49 = F_31 ( V_23 , V_1 , F_1 , 0 , V_38 -> V_56 , V_3 ) ;
if ( V_49 ) {
F_9 ( V_23 , L_14 ,
V_1 , V_49 ) ;
goto V_65;
}
F_3 ( V_66 , V_3 -> V_5 + V_31 ) ;
V_48 = V_44 / V_45 ;
if ( ! V_48 ) {
F_32 ( V_23 ,
L_15 ,
