...
V_146 = F_53 ( V_150 , V_144 -> V_151 , V_144 -> V_152 , V_144 -> V_148 ,
V_153 ) ;
if ( ! V_146 ) {
...
static void F_56 ( struct V_143 * V_144 )
{
struct V_33 * V_34 = V_144 -> V_48 -> V_51 -> V_52 ;
void T_1 * V_1 = V_34 -> V_36 ;
F_57 ( V_34 -> V_115 ) ;
...
{
V_144 -> V_48 -> V_102 -> V_160 ( V_144 -> V_48 , & V_144 -> V_61 ) ;
}
...
static int F_61 ( struct V_104 * V_172 , unsigned int * V_173 ,
unsigned long V_106 )
{
...
V_105 |= ( 1 << 1 ) ;
V_48 -> V_102 -> V_103 ( V_172 -> V_48 , 0 ) ;
V_109 = F_40 ( V_48 , V_105 , V_106 ) ;
if ( V_109 && ( V_109 != - V_113 || F_62 ( V_172 ) ) ) {
F_63 ( V_172 , L_7 , V_109 ) ;
return V_109 ;
}
V_173 [ 0 ] = F_64 ( & V_172 -> V_85 [ 0 ] , V_105 & ( 1 << 0 ) ,
& V_176 ) ;
if ( V_174 && V_176 != 0x81 )
...
V_48 = V_144 -> V_48 ;
V_34 = V_48 -> V_51 -> V_52 ;
for ( V_24 = 0 ; ( V_48 -> V_102 -> V_177 ( V_48 ) & V_178 )
&& V_24 < 65536 ; V_24 += 2 )
F_12 ( V_34 , V_100 ) ;
if ( V_24 )
F_66 ( V_48 , L_8 , V_24 ) ;
...
V_182 = F_72 ( V_122 , V_185 , 0 ) ;
V_36 = F_73 ( & V_122 -> V_139 , V_182 ) ;
if ( F_74 ( V_36 ) ) {
V_176 = F_75 ( V_36 ) ;
goto V_184;
}
V_34 = F_76 ( & V_122 -> V_139 , sizeof( * V_34 ) , V_186 ) ;
if ( ! V_34 ) {
V_176 = - V_183 ;
goto V_184;
}
...
V_34 -> V_122 = V_122 ;
V_34 -> V_36 = V_36 ;
V_34 -> V_136 = V_182 -> V_26 + V_15 ;
V_34 -> V_141 = V_182 -> V_26 + V_14 ;
F_46 ( V_34 ) ;
V_51 = F_78 ( & V_122 -> V_139 , 1 ) ;
if ( ! V_51 ) {
V_176 = - V_183 ;
goto V_187;
}
...
F_6 ( V_36 , 0 ) ;
F_80 ( & V_122 -> V_139 , L_9 V_199 L_10 ) ;
V_176 = F_81 ( V_51 , V_180 , V_200 , 0 ,
& V_201 ) ;
if ( V_176 == 0 )
return 0 ;
V_187:
