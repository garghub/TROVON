...
static void F_87 ( struct V_1 * V_1 , struct V_37 * V_37 )
{
int V_54 ;
T_2 V_29 ;
struct V_34 V_35 ;
...
F_90 ( V_105 , & V_37 -> V_106 ) ;
F_88 ( V_37 , 0 ) ;
return;
V_25:
F_91 ( V_37 ) ;
}
static void F_92 ( struct V_107 * V_108 , struct V_37 * V_37 )
{
...
static void F_93 ( struct V_94 * V_95 ,
unsigned long V_29 )
{
struct V_1 * V_1 ;
struct V_17 * V_2 ;
...
static int F_94 ( struct V_1 * V_1 , int V_113 )
{
int V_22 = - V_71 ;
F_95 ( & V_1 -> V_12 ) ;
V_1 -> V_108 = F_96 ( V_48 ) ;
...
F_74 ( V_1 -> V_88 , 0 ) ;
F_100 ( V_121 , V_1 -> V_88 -> V_108 ) ;
F_101 ( V_1 -> V_88 -> V_108 , V_9 ) ;
F_102 ( V_1 -> V_88 -> V_108 ,
V_45 ) ;
F_103 ( V_1 -> V_88 -> V_108 , V_9 ) ;
F_104 ( V_1 -> V_88 -> V_108 , V_9 ) ;
...
F_100 ( V_127 , V_1 -> V_88 -> V_108 ) ;
F_105 ( V_1 -> V_88 ) ;
V_22 = F_106 ( & F_107 ( V_1 -> V_88 ) -> V_128 ,
& V_129 ) ;
if ( V_22 < 0 ) {
F_99 ( L_17 ) ;
goto V_130;
...
V_135 = F_115 ( V_133 * sizeof( struct V_1 ) , V_48 ) ;
if ( ! V_135 ) {
V_22 = - V_71 ;
goto V_136;
}
for ( V_132 = 0 ; V_132 < V_133 ; V_132 ++ ) {
V_22 = F_94 ( & V_135 [ V_132 ] , V_132 ) ;
if ( V_22 )
goto V_137;
}
F_18 ( L_21 , V_133 ) ;
