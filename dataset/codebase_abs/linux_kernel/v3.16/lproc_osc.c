...
static T_1 F_20 ( struct V_12 * V_12 ,
const char T_4 * V_13 ,
T_2 V_14 , T_3 * V_15 )
{
struct V_4 * V_5 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
...
if ( V_14 >= sizeof( V_38 ) )
return - V_39 ;
if ( F_21 ( V_38 , V_13 , V_14 ) )
return - V_40 ;
V_38 [ V_14 ] = 0 ;
V_28 = 1 << ( 20 - V_31 ) ;
V_13 += F_22 ( V_38 , L_6 , & V_14 ) -
V_38 ;
V_7 = F_16 ( V_13 , V_14 , & V_30 , V_28 ) ;
if ( V_7 )
return V_7 ;
...
int V_7 ;
F_10 ( & V_9 -> V_21 ) ;
V_7 = F_3 ( V_2 , L_7 , V_9 -> V_42 ) ;
F_11 ( & V_9 -> V_21 ) ;
return V_7 ;
}
static T_1 F_26 ( struct V_12 * V_12 , const char * V_13 ,
T_2 V_14 , T_3 * V_15 )
{
struct V_4 * V_43 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
struct V_20 * V_9 = & V_43 -> V_8 . V_9 ;
int V_7 ;
T_5 V_17 ;
if ( V_43 == NULL )
return 0 ;
V_7 = F_27 ( V_13 , V_14 , & V_17 ) ;
if ( V_7 )
return V_7 ;
F_10 ( & V_9 -> V_21 ) ;
if ( V_17 >= V_9 -> V_42 ) {
...
static T_1 F_31 ( struct V_12 * V_12 ,
const char * V_13 , T_2 V_14 , T_3 * V_15 )
{
struct V_4 * V_43 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
int V_17 , V_7 ;
...
return 0 ;
return F_3 ( V_2 , L_1 ,
V_43 -> V_8 . V_9 . V_48 ? 1 : 0 ) ;
}
static T_1 F_33 ( struct V_12 * V_12 , const char * V_13 ,
T_2 V_14 , T_3 * V_15 )
{
struct V_4 * V_43 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
int V_17 , V_7 ;
...
if ( ( ( 1 << V_49 ) & V_43 -> V_8 . V_9 . V_52 ) == 0 )
continue;
if ( V_43 -> V_8 . V_9 . V_53 == ( 1 << V_49 ) )
...
static T_1 F_36 ( struct V_12 * V_12 , const char * V_13 ,
T_2 V_14 , T_3 * V_15 )
{
struct V_4 * V_43 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
int V_49 ;
...
if ( V_43 == NULL )
return 0 ;
if ( V_14 > sizeof( V_38 ) - 1 )
return - V_39 ;
if ( F_21 ( V_38 , V_13 , V_14 ) )
return - V_40 ;
if ( V_14 > 0 && V_38 [ V_14 - 1 ] == '\n' )
V_38 [ V_14 - 1 ] = '\0' ;
else
V_38 [ V_14 ] = '\0' ;
for ( V_49 = 0 ; V_49 < F_35 ( V_51 ) ; V_49 ++ ) {
...
{
struct V_4 * V_43 = V_2 -> V_6 ;
return F_3 ( V_2 , L_3 , F_19 ( & V_43 -> V_8 . V_9 . V_54 ) ) ;
}
...
if ( V_17 < 0 )
return - V_39 ;
F_39 ( & V_43 -> V_8 . V_9 . V_54 , V_17 ) ;
return V_14 ;
}
static int F_40 ( struct V_1 * V_2 , void * V_3 )
{
struct V_4 * V_43 = V_2 -> V_6 ;
struct V_55 * V_56 = F_41 ( V_43 ) ;
...
unsigned long V_84 = V_9 -> V_81 . V_85 [ V_49 ] ;
unsigned long V_86 = V_9 -> V_82 . V_85 [ V_49 ] ;
V_73 += V_84 ;
V_74 += V_86 ;
F_3 ( V_68 , L_19 ,
1 << V_49 , V_84 , F_52 ( V_84 , V_71 ) ,
F_52 ( V_73 , V_71 ) , V_86 ,
F_52 ( V_86 , V_72 ) ,
F_52 ( V_74 , V_72 ) ) ;
...
V_74 = 0 ;
for ( V_49 = 0 ; V_49 < V_83 ; V_49 ++ ) {
unsigned long V_84 = V_9 -> V_87 . V_85 [ V_49 ] ;
unsigned long V_86 = V_9 -> V_88 . V_85 [ V_49 ] ;
V_73 += V_84 ;
V_74 += V_86 ;
F_3 ( V_68 , L_19 ,
V_49 , V_84 , F_52 ( V_84 , V_71 ) ,
F_52 ( V_73 , V_71 ) , V_86 ,
F_52 ( V_86 , V_72 ) ,
F_52 ( V_74 , V_72 ) ) ;
if ( V_73 == V_71 && V_74 == V_72 )
...
V_74 = 0 ;
for ( V_49 = 0 ; V_49 < V_83 ; V_49 ++ ) {
unsigned long V_84 = V_9 -> V_89 . V_85 [ V_49 ] ;
unsigned long V_86 = V_9 -> V_90 . V_85 [ V_49 ] ;
V_73 += V_84 ;
V_74 += V_86 ;
F_3 ( V_68 , L_19 ,
( V_49 == 0 ) ? 0 : 1 << ( V_49 - 1 ) ,
