...
int V_99 = 0 ;
unsigned int V_100 ;
V_99 |= F_48 ( & V_93 -> V_101 , V_102 | V_103 ) ;
V_99 |= F_48 ( & V_93 -> V_104 ,
V_105 | V_106 | V_103 ) ;
V_99 |= F_48 ( & V_93 -> V_107 ,
V_106 | V_102 | V_103 ) ;
V_99 |= F_48 ( & V_93 -> V_108 , V_109 ) ;
V_99 |= F_48 ( & V_93 -> V_110 , V_109 | V_111 ) ;
if ( V_99 )
return 1 ;
V_99 |= F_49 ( V_93 -> V_101 ) ;
V_99 |= F_49 ( V_93 -> V_104 ) ;
V_99 |= F_49 ( V_93 -> V_107 ) ;
V_99 |= F_49 ( V_93 -> V_110 ) ;
...
if ( V_93 -> V_104 == V_106 )
V_99 |= F_51 ( & V_93 -> V_117 ,
V_87 -> V_118 * V_93 -> V_97 ) ;
if ( V_93 -> V_107 == V_106 )
V_99 |= F_51 ( & V_93 -> V_119 ,
V_87 -> V_118 ) ;
V_99 |= F_50 ( & V_93 -> V_120 , V_93 -> V_97 ) ;
if ( V_93 -> V_110 == V_111 )
V_99 |= F_50 ( & V_93 -> V_121 , 0 ) ;
if ( V_99 )
return 3 ;
if ( V_93 -> V_104 == V_106 ) {
V_100 = V_93 -> V_117 ;
...
& V_6 -> V_124 ,
& V_100 , V_93 -> V_41 ) ;
V_99 |= F_50 ( & V_93 -> V_119 , V_100 ) ;
}
if ( V_99 )
return 4 ;
if ( V_93 -> V_95 && V_93 -> V_97 > 0 )
V_99 |= F_45 ( V_4 , V_11 , V_93 ) ;
if ( V_99 )
return 5 ;
return 0 ;
}
...
F_54 ( V_125 , 0 , 1 , V_128 | V_129 ) ;
F_54 ( V_125 , 0 , 2 , V_128 | V_129 ) ;
F_55 ( V_125 , 0 , 1 , V_6 -> V_123 ) ;
F_55 ( V_125 , 0 , 2 , V_6 -> V_124 ) ;
}
...
int V_99 = 0 ;
unsigned int V_100 ;
V_99 |= F_48 ( & V_93 -> V_101 , V_154 ) ;
V_99 |= F_48 ( & V_93 -> V_104 ,
V_106 | V_103 ) ;
V_99 |= F_48 ( & V_93 -> V_107 , V_102 ) ;
V_99 |= F_48 ( & V_93 -> V_108 , V_109 ) ;
V_99 |= F_48 ( & V_93 -> V_110 , V_109 | V_111 ) ;
if ( V_99 )
return 1 ;
...
V_161 = V_6 -> V_163 ;
V_160 = F_61 ( V_11 , V_6 -> V_164 ,
V_161 * sizeof( short ) ) ;
V_161 = V_160 / sizeof( short ) ;
if ( V_93 -> V_110 == V_109 )
V_6 -> V_163 -= V_161 ;
F_62 ( V_6 -> V_48 + V_52 , V_6 -> V_164 , V_160 ) ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
...
F_54 ( V_125 , 0 , 1 , V_128 | V_129 ) ;
F_54 ( V_125 , 0 , 2 , V_128 | V_129 ) ;
F_55 ( V_125 , 0 , 1 , V_6 -> V_156 ) ;
F_55 ( V_125 , 0 , 2 , V_6 -> V_157 ) ;
}
...
static void F_66 ( struct V_3 * V_4 , unsigned int V_15 )
{
const struct V_86 * V_87 = F_42 ( V_4 ) ;
struct V_5 * V_6 = V_4 -> V_7 ;
...
static T_2 F_68 ( int V_179 , void * V_180 )
{
...
V_131 = V_11 -> V_131 ;
V_93 = & V_131 -> V_93 ;
V_182 = F_69 ( V_6 -> V_60 + V_186 ) ;
if ( ( V_187 & V_182 ) == 0 )
return V_185 ;
F_70 ( V_6 -> V_60 + V_188 ) ;
F_71 ( V_6 -> V_189 | V_190 ,
V_6 -> V_60 + V_186 ) ;
...
V_6 = F_78 ( V_4 , sizeof( * V_6 ) ) ;
if ( ! V_6 )
return - V_204 ;
V_25 = F_79 ( V_4 ) ;
if ( V_25 )
return V_25 ;
V_6 -> V_60 = F_80 ( V_198 , 0 ) ;
V_6 -> V_16 = F_80 ( V_198 , 1 ) ;
V_6 -> V_33 = F_80 ( V_198 , 2 ) ;
V_6 -> V_126 = F_80 ( V_198 , 3 ) ;
if ( V_87 -> V_205 )
V_6 -> V_48 = F_80 ( V_198 , 4 ) ;
F_71 ( V_190 ,
V_6 -> V_60 + V_186 ) ;
if ( F_81 ( V_198 -> V_179 , F_68 ,
V_206 , V_4 -> V_207 -> V_208 , V_4 ) ) {
F_46 ( V_4 -> V_39 , L_11 ,
V_198 -> V_179 ) ;
return - V_40 ;
}
...
V_4 -> V_181 = V_11 ;
V_11 -> type = V_210 ;
V_11 -> V_211 = V_212 | V_213 | V_214 | V_215 ;
V_11 -> V_98 = V_87 -> V_216 ;
V_11 -> V_217 = V_87 -> V_216 ;
V_11 -> V_218 = ( 1 << V_87 -> V_219 ) - 1 ;
V_11 -> V_220 = V_87 -> V_221 ;
V_11 -> V_222 = F_9 ;
V_11 -> V_223 = F_18 ;
V_11 -> V_224 = F_56 ;
V_11 -> V_225 = F_47 ;
...
V_11 = & V_4 -> V_209 [ 2 ] ;
V_25 = F_83 ( V_4 , V_11 , NULL ,
V_6 -> V_126 + V_234 ) ;
if ( V_25 )
return V_25 ;
V_11 = & V_4 -> V_209 [ 3 ] ;
V_11 -> type = V_235 ;
V_11 -> V_211 = V_212 | V_236 ;
V_11 -> V_98 = 256 ;
V_11 -> V_218 = 0xff ;
V_11 -> V_222 = F_30 ;
V_11 = & V_4 -> V_209 [ 4 ] ;
V_11 -> type = V_237 ;
V_11 -> V_211 = V_212 | V_228 | V_236 ;
V_11 -> V_98 = V_238 ;
V_11 -> V_218 = 0xff ;
V_11 -> V_222 = F_35 ;
V_11 -> V_232 = F_34 ;
for ( V_55 = 0 ; V_55 < V_11 -> V_98 ; V_55 ++ )
F_32 ( V_4 , V_55 , V_11 -> V_218 / 2 ) ;
V_11 = & V_4 -> V_209 [ 5 ] ;
V_11 -> type = V_237 ;
V_11 -> V_211 = V_212 | V_228 | V_236 ;
if ( V_87 -> V_89 == V_90 ) {
...
static int F_89 ( struct V_197 * V_4 ,
const struct V_244 * V_36 )
{
return F_90 ( V_4 , & V_245 ,
V_36 -> V_246 ) ;
}
