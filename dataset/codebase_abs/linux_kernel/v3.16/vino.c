...
V_295 -> V_297 . V_61 = 0 ;
V_295 -> V_297 . V_79 = 0 ;
V_295 -> V_297 . V_75 = V_136 -> V_75 ;
V_295 -> V_297 . V_76 = V_136 -> V_76 ;
memcpy ( & V_295 -> V_298 , & V_295 -> V_297 ,
sizeof( struct V_299 ) ) ;
V_295 -> V_300 . V_301 = 1 ;
V_295 -> V_300 . V_302 = 1 ;
break;
...
case V_296 :
F_31 ( & V_187 -> V_194 , V_52 ) ;
V_305 -> V_305 . V_61 = V_57 -> V_59 . V_61 ;
V_305 -> V_305 . V_79 = V_57 -> V_59 . V_79 ;
V_305 -> V_305 . V_75 = V_57 -> V_59 . V_60 - V_57 -> V_59 . V_61 ;
V_305 -> V_305 . V_76 = V_57 -> V_59 . V_80 - V_57 -> V_59 . V_79 ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
break;
case V_303 :
default:
...
case V_296 :
F_31 ( & V_187 -> V_194 , V_52 ) ;
F_45 ( V_57 , V_305 -> V_305 . V_61 , V_305 -> V_305 . V_79 ,
V_305 -> V_305 . V_75 , V_305 -> V_305 . V_76 ) ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
break;
case V_303 :
default:
...
struct V_56 * V_57 = F_109 ( V_260 ) ;
unsigned long V_52 ;
struct V_308 * V_309 = & V_307 -> V_310 . V_311 ;
V_309 -> V_312 = V_313 ;
V_309 -> V_314 . V_301 = 1 ;
F_31 ( & V_187 -> V_194 , V_52 ) ;
V_309 -> V_314 . V_302 = V_57 -> V_83 ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
return 0 ;
}
...
struct V_308 * V_309 = & V_307 -> V_310 . V_311 ;
F_31 ( & V_187 -> V_194 , V_52 ) ;
if ( ( V_309 -> V_314 . V_301 == 0 ) ||
( V_309 -> V_314 . V_302 == 0 ) ) {
F_52 ( V_57 ) ;
} else {
F_50 ( V_57 , V_309 -> V_314 . V_302 /
V_309 -> V_314 . V_301 ) ;
}
F_32 ( & V_187 -> V_194 , V_52 ) ;
return 0 ;
...
V_142 -> V_318 = ( V_57 -> V_197 . type == V_46 ) ?
V_319 : V_328 ;
V_142 -> V_329 . V_49 = V_2 -> V_49 ;
V_142 -> V_330 = V_2 -> V_153 ;
V_142 -> V_30 = V_2 -> V_14 ;
V_142 -> V_137 = V_289 ;
V_142 -> V_331 = V_2 -> V_138 ;
...
{
struct V_56 * V_57 = F_109 ( V_260 ) ;
unsigned int V_332 = V_260 -> V_333 & V_334 ;
struct V_1 * V_2 ;
...
if ( V_124 )
goto V_41;
if ( V_155 -> V_348 < V_340 [ V_4 ] . V_349 ||
V_155 -> V_348 > V_340 [ V_4 ] . V_350 ) {
V_124 = - V_351 ;
goto V_41;
}
V_124 = F_133 ( V_346 , V_352 , V_155 ) ;
if ( V_124 )
V_124 = - V_17 ;
break;
}
...
if ( V_124 )
goto V_41;
if ( V_155 -> V_348 < V_344 [ V_4 ] . V_349 ||
V_155 -> V_348 > V_344 [ V_4 ] . V_350 ) {
V_124 = - V_351 ;
goto V_41;
}
V_124 = F_100 ( V_346 , V_352 , V_155 ) ;
if ( V_124 )
V_124 = - V_17 ;
break;
}
...
static int F_139 ( struct V_260 * V_260 , struct V_355 * V_356 )
{
struct V_56 * V_57 = F_109 ( V_260 ) ;
...
static unsigned int F_143 ( struct V_260 * V_260 , T_6 * V_373 )
{
struct V_56 * V_57 = F_109 ( V_260 ) ;
unsigned int V_210 ;
unsigned int V_16 = 0 ;
...
if ( V_210 > 0 )
goto V_375;
F_144 ( V_260 , & V_57 -> V_197 . V_203 , V_373 ) ;
if ( F_38 ( & V_57 -> V_197 , & V_210 ) ) {
F_2 ( L_117 ) ;
V_16 = V_374 ;
goto error;
...
V_393 ++ ;
F_162 ( V_187 -> V_386 . V_256 , L_128 ,
sizeof( V_187 -> V_386 . V_256 ) ) ;
