...
if ( ! V_17 -> V_20 )
goto V_68;
V_17 -> V_20 -> V_25 = F_53 ( V_113 , V_90 ) ;
if ( ! V_17 -> V_20 -> V_25 )
goto V_68;
V_17 -> V_20 -> V_37 = V_113 ;
V_17 -> V_20 -> V_32 = V_17 ;
V_17 -> V_20 -> V_57 = F_16 ;
V_114 . V_115 = V_110 . V_115 ;
V_116 . V_115 = V_111 . V_115 ;
V_117 . V_115 = V_112 . V_115 ;
V_118 . V_115 = V_110 . V_115 ;
V_119 . V_115 = V_111 . V_115 ;
V_120 . V_115 = V_112 . V_115 ;
V_26 = F_54 ( V_3 , V_121 , V_122 ,
V_123 ) ;
if ( V_26 )
goto V_68;
V_17 -> V_4 . V_124 = F_38 ;
V_17 -> V_4 . V_125 = F_41 ;
F_39 ( V_17 -> V_23 , V_79 , 0 ) ;
F_55 ( V_17 -> V_23 , V_17 -> V_126 ) ;
if ( V_17 -> V_127 && V_17 -> V_128 &&
F_56 ( V_17 -> V_23 , V_17 -> V_128 ,
V_17 -> V_127 ) )
goto V_68;
F_15 ( V_22 , L_15 ,
...
void F_60 ( struct V_129 * V_3 , struct V_70 * V_71 )
{
struct V_84 * V_130 ;
V_130 = F_2 ( V_3 , struct V_84 , V_87 ) ;
if ( V_130 -> V_95 )
F_61 ( F_62 ( V_130 -> V_71 ) ) ;
else
F_63 ( V_130 -> V_71 ) ;
V_130 -> V_131 = V_130 -> V_95 = true ;
V_130 -> V_71 = V_71 ;
}
static inline struct V_84 * F_64 ( struct V_132 * V_133 )
{
return F_2 ( F_65 ( V_133 ) , struct V_84 ,
V_87 . V_134 ) ;
}
static void F_66 ( struct V_129 * V_3 )
{
struct V_84 * V_130 ;
V_130 = F_2 ( V_3 , struct V_84 , V_87 ) ;
if ( ! V_130 -> V_131 ) {
...
F_57 ( V_130 -> V_94 . V_134 . V_135 ) ;
F_57 ( V_130 ) ;
}
static struct V_129 * F_67 ( void )
{
struct V_84 * V_130 ;
struct V_136 * V_137 [ 1 ] ;
char * V_138 [ 1 ] ;
V_130 = F_45 ( sizeof( * V_130 ) , V_90 ) ;
if ( ! V_130 )
return F_68 ( - V_91 ) ;
V_130 -> V_94 . V_139 = V_130 -> V_140 ;
F_69 ( & V_130 -> V_141 ) ;
V_130 -> V_87 . V_142 = F_66 ;
V_130 -> V_71 = F_70 () ;
if ( F_33 ( V_130 -> V_71 ) ) {
struct V_70 * V_71 = V_130 -> V_71 ;
F_57 ( V_130 ) ;
return F_71 ( V_71 ) ;
}
F_72 ( & V_130 -> V_94 . V_143 ) ;
V_137 [ 0 ] = & V_130 -> V_94 ;
V_138 [ 0 ] = L_20 ;
F_73 ( & V_130 -> V_87 . V_134 , 1 , V_137 ,
V_138 , V_144 ) ;
F_74 ( & V_130 -> V_87 . V_134 , L_21 ,
& V_145 ) ;
return & V_130 -> V_87 ;
}
...
V_17 = F_1 ( V_3 ) ;
F_76 ( V_17 -> V_23 ) ;
V_130 = F_2 ( V_3 -> V_86 , struct V_84 , V_87 ) ;
F_57 ( V_17 ) ;
F_77 ( & V_130 -> V_141 ) ;
V_130 -> V_146 -- ;
F_78 ( & V_130 -> V_141 ) ;
...
static struct V_2 * F_80 ( struct V_129 * V_86 )
{
struct V_1 * V_17 ;
struct V_84 * V_130 ;
int V_26 ;
...
if ( ! V_17 )
return F_68 ( - V_91 ) ;
V_130 = F_2 ( V_86 , struct V_84 , V_87 ) ;
F_77 ( & V_130 -> V_141 ) ;
V_130 -> V_146 ++ ;
F_81 ( V_130 -> V_71 , V_17 -> V_126 ) ;
V_17 -> V_128 = V_130 -> V_147 ;
V_17 -> V_127 = V_130 -> V_127 ;
V_17 -> V_4 . V_148 = F_62 ( V_130 -> V_71 ) ;
F_78 ( & V_130 -> V_141 ) ;
V_17 -> V_4 . V_75 = 0 ;
V_17 -> V_4 . V_149 = sizeof( struct V_15 ) ;
V_17 -> V_4 . V_150 = F_6 ;
V_17 -> V_4 . V_151 = V_152 ;
V_17 -> V_4 . V_5 . V_35 = L_20 ;
V_17 -> V_4 . V_5 . V_153 = F_44 ;
V_17 -> V_4 . V_5 . V_154 = F_79 ;
V_17 -> V_4 . V_5 . V_155 = F_27 ;
V_17 -> V_4 . V_5 . V_156 = F_22 ;
V_17 -> V_4 . V_5 . V_157 = F_36 ;
V_17 -> V_4 . V_5 . V_158 = F_75 ;
V_26 = F_82 ( F_10 , V_17 ) ;
if ( V_26 < 0 ) {
F_57 ( V_17 ) ;
return F_68 ( V_26 ) ;
