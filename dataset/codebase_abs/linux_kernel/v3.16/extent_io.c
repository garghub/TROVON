...
F_66 ( & V_10 -> V_347 ) ;
if ( F_229 ( V_348 , & V_10 -> V_343 ) ) {
F_230 ( V_344 , & V_10 -> V_343 ) ;
F_70 ( & V_10 -> V_347 ) ;
F_231 ( V_10 , V_349 ) ;
F_232 ( & V_169 -> V_350 ,
- V_10 -> V_21 ,
...
{
F_235 ( V_344 , & V_10 -> V_343 ) ;
F_236 () ;
F_237 ( & V_10 -> V_343 , V_344 ) ;
}
static void F_238 ( struct V_40 * V_40 , int V_95 )
{
struct V_239 * V_240 ;
struct V_9 * V_10 ;
int V_139 , V_146 ;
...
F_68 ( ! V_10 ) ;
V_146 = F_36 ( & V_10 -> V_352 ) ;
if ( V_95 || F_155 ( V_353 , & V_10 -> V_343 ) ) {
F_230 ( V_353 , & V_10 -> V_343 ) ;
F_159 ( V_128 ) ;
F_160 ( V_128 ) ;
}
F_122 ( V_128 ) ;
...
static T_13 int F_239 ( struct V_9 * V_10 ,
struct V_31 * V_169 ,
struct V_310 * V_311 ,
struct V_319 * V_320 )
{
struct V_256 * V_192 = V_169 -> V_229 -> V_230 ;
struct V_24 * V_17 = & F_120 ( V_169 -> V_354 ) -> V_151 ;
T_1 V_56 = V_10 -> V_15 ;
unsigned long V_139 , V_201 ;
unsigned long V_220 = 0 ;
int V_265 = ( V_320 -> V_346 ? V_195 : V_188 ) | V_355 ;
int V_74 = 0 ;
F_235 ( V_353 , & V_10 -> V_343 ) ;
V_201 = F_144 ( V_10 -> V_15 , V_10 -> V_21 ) ;
F_32 ( & V_10 -> V_352 , V_201 ) ;
if ( F_240 ( V_10 ) == V_356 )
V_220 = V_357 ;
for ( V_139 = 0 ; V_139 < V_201 ; V_139 ++ ) {
struct V_128 * V_60 = F_145 ( V_10 , V_139 ) ;
...
F_230 ( V_353 , & V_10 -> V_343 ) ;
F_160 ( V_60 ) ;
if ( F_241 ( V_201 - V_139 , & V_10 -> V_352 ) )
F_234 ( V_10 ) ;
V_74 = - V_185 ;
break;
}
...
V_366:
if ( V_311 -> V_338 == V_339 )
F_244 ( V_27 , V_125 , V_16 ) ;
while ( ! V_146 && ! V_359 && ( V_125 <= V_16 ) &&
( V_138 = F_245 ( & V_361 , V_27 , & V_125 , V_363 ,
F_124 ( V_16 - V_125 , ( T_8 ) V_367 - 1 ) + 1 ) ) ) {
unsigned V_139 ;
V_362 = 1 ;
for ( V_139 = 0 ; V_139 < V_138 ; V_139 ++ ) {
struct V_128 * V_128 = V_361 . V_137 [ V_139 ] ;
if ( ! F_184 ( V_128 ) )
continue;
...
V_74 = F_246 ( & V_10 -> V_18 ) ;
F_70 ( & V_27 -> V_368 ) ;
if ( ! V_74 )
continue;
V_358 = V_10 ;
V_74 = F_224 ( V_10 , V_169 , & V_320 ) ;
if ( ! V_74 ) {
F_247 ( V_10 ) ;
continue;
}
V_74 = F_239 ( V_10 , V_169 , V_311 , & V_320 ) ;
if ( V_74 ) {
V_146 = 1 ;
F_247 ( V_10 ) ;
break;
...
static int F_249 ( struct V_24 * V_17 ,
struct V_43 * V_27 ,
struct V_310 * V_311 ,
T_14 V_369 , void * V_337 ,
void (* F_250)( void * ) )
{
...
static void F_254 ( struct V_319 * V_320 )
{
if ( V_320 -> V_40 ) {
int V_265 = V_188 ;
int V_74 ;
...
static T_5 void F_226 ( void * V_337 )
{
struct V_319 * V_320 = V_337 ;
F_254 ( V_320 ) ;
}
int F_255 ( struct V_24 * V_17 , struct V_128 * V_128 ,
T_12 * V_284 ,
struct V_310 * V_311 )
{
int V_74 ;
...
int F_256 ( struct V_24 * V_17 , struct V_25 * V_25 ,
...
unsigned V_374 ;
unsigned long V_220 = 0 ;
struct V_128 * V_375 [ 16 ] ;
struct V_128 * V_128 ;
struct V_211 * V_285 = NULL ;
int V_276 = 0 ;
for ( V_374 = 0 ; V_374 < V_138 ; V_374 ++ ) {
V_128 = F_9 ( V_137 -> V_71 , struct V_128 , V_376 ) ;
F_259 ( & V_128 -> V_4 ) ;
F_6 ( & V_128 -> V_376 ) ;
if ( F_260 ( V_128 , V_27 ,
V_128 -> V_125 , V_124 ) ) {
...
V_375 [ V_276 ++ ] = V_128 ;
if ( V_276 < F_261 ( V_375 ) )
continue;
F_205 ( V_17 , V_375 , V_276 , V_284 , & V_285 ,
& V_40 , 0 , & V_220 , V_309 ) ;
V_276 = 0 ;
}
if ( V_276 )
...
static int F_263 ( struct V_213 * V_377 ,
struct V_24 * V_17 ,
...
V_21 = V_16 - V_15 + 1 ;
F_265 ( & V_377 -> V_47 ) ;
V_212 = F_152 ( V_377 , V_15 , V_21 ) ;
if ( ! V_212 ) {
F_266 ( & V_377 -> V_47 ) ;
break;
}
if ( F_155 ( V_379 , & V_212 -> V_4 ) ||
V_212 -> V_15 != V_15 ) {
F_266 ( & V_377 -> V_47 ) ;
F_154 ( V_212 ) ;
break;
...
return F_263 ( V_377 , V_17 , V_128 , V_48 ) ;
}
static struct V_211 * F_268 ( struct V_25 * V_25 ,
T_1 V_56 ,
T_1 V_159 ,
T_12 * V_284 )
{
T_1 V_381 = F_120 ( V_25 ) -> V_54 -> V_381 ;
struct V_211 * V_212 ;
T_1 V_21 ;
if ( V_56 >= V_159 )
return NULL ;
...
if ( V_21 == 0 )
break;
V_21 = F_199 ( V_21 , V_381 ) ;
V_212 = V_284 ( V_25 , NULL , 0 , V_56 , V_21 , 0 ) ;
if ( F_192 ( V_212 ) )
return V_212 ;
if ( ! F_155 ( V_382 , & V_212 -> V_4 ) &&
V_212 -> V_221 != V_303 ) {
return V_212 ;
}
V_56 = F_191 ( V_212 ) ;
...
static T_5 int F_269 ( T_1 V_383 , T_1 V_56 , T_1 V_384 , void * V_385 )
{
unsigned long V_386 = * ( ( unsigned long * ) V_385 ) ;
V_386 ++ ;
...
int F_270 ( struct V_25 * V_25 , struct V_387 * V_388 ,
...
return - V_35 ;
V_396 -> V_400 = 1 ;
V_15 = F_199 ( V_15 , F_120 ( V_25 ) -> V_54 -> V_381 ) ;
V_21 = F_199 ( V_21 , F_120 ( V_25 ) -> V_54 -> V_381 ) ;
...
F_37 ( ! V_74 ) ;
V_396 -> V_401 [ 0 ] -- ;
F_274 ( V_396 -> V_402 [ 0 ] , & V_394 , V_396 -> V_401 [ 0 ] ) ;
V_390 = F_275 ( & V_394 ) ;
if ( V_394 . V_403 != F_16 ( V_25 ) ||
V_390 != V_404 ) {
V_159 = ( T_1 ) - 1 ;
V_391 = V_26 ;
} else {
...
while ( ! V_16 ) {
T_1 V_405 = 0 ;
if ( V_212 -> V_15 >= F_125 || F_191 ( V_212 ) < V_389 )
break;
V_397 = F_125 ( V_212 -> V_15 , V_389 ) ;
if ( ! F_155 ( V_222 , & V_212 -> V_4 ) )
V_405 = V_397 - V_212 -> V_15 ;
V_334 = F_191 ( V_212 ) ;
V_398 = V_334 - V_397 ;
V_392 = 0 ;
V_4 = 0 ;
...
if ( V_389 >= F_125 )
V_16 = 1 ;
if ( V_212 -> V_221 == V_406 ) {
V_16 = 1 ;
V_4 |= V_407 ;
} else if ( V_212 -> V_221 == V_304 ) {
V_4 |= ( V_408 |
V_409 ) ;
} else if ( V_212 -> V_221 == V_410 ) {
V_4 |= ( V_411 |
V_412 ) ;
} else {
unsigned long V_413 = 0 ;
V_392 = V_212 -> V_221 + V_405 ;
V_74 = F_279 (
V_212 -> V_221 ,
...
F_154 ( V_212 ) ;
V_212 = NULL ;
if ( ( V_397 >= V_159 ) || V_398 == ( T_1 ) - 1 ||
( V_159 == ( T_1 ) - 1 && V_26 <= V_334 ) ) {
V_4 |= V_407 ;
V_16 = 1 ;
}
V_212 = F_268 ( V_25 , V_389 , V_391 ,
V_284 ) ;
if ( F_277 ( V_212 ) ) {
V_74 = F_278 ( V_212 ) ;
goto V_107;
...
{
return ( F_11 ( & V_10 -> V_352 ) ||
F_155 ( V_344 , & V_10 -> V_343 ) ||
F_155 ( V_348 , & V_10 -> V_343 ) ) ;
}
...
unsigned long V_201 ;
struct V_128 * V_128 ;
int V_418 = ! F_155 ( V_419 , & V_10 -> V_343 ) ;
F_68 ( F_282 ( V_10 ) ) ;
V_201 = F_144 ( V_10 -> V_15 , V_10 -> V_21 ) ;
V_125 = V_417 + V_201 ;
if ( V_417 >= V_125 )
...
if ( V_128 && V_418 ) {
F_66 ( & V_128 -> V_27 -> V_368 ) ;
if ( F_184 ( V_128 ) &&
V_128 -> V_49 == ( unsigned long ) V_10 ) {
F_68 ( F_155 ( V_348 , & V_10 -> V_343 ) ) ;
F_68 ( F_116 ( V_128 ) ) ;
F_68 ( F_215 ( V_128 ) ) ;
F_284 ( V_128 ) ;
F_187 ( V_128 , 0 ) ;
...
struct V_9 * F_290 ( struct V_9 * V_431 )
{
unsigned long V_139 ;
struct V_128 * V_60 ;
struct V_9 * V_2 ;
unsigned long V_201 = F_144 ( V_431 -> V_15 , V_431 -> V_21 ) ;
V_2 = F_286 ( NULL , V_431 -> V_15 , V_431 -> V_21 , V_124 ) ;
if ( V_2 == NULL )
return NULL ;
for ( V_139 = 0 ; V_139 < V_201 ; V_139 ++ ) {
V_60 = F_291 ( V_124 ) ;
...
F_292 ( V_2 , V_431 , 0 , 0 , V_431 -> V_21 ) ;
F_230 ( V_432 , & V_2 -> V_343 ) ;
F_230 ( V_419 , & V_2 -> V_343 ) ;
return V_2 ;
}
...
int V_18 ;
V_18 = F_11 ( & V_10 -> V_18 ) ;
if ( V_18 >= 2 && F_155 ( V_433 , & V_10 -> V_343 ) )
return;
F_66 ( & V_10 -> V_347 ) ;
if ( ! F_298 ( V_433 , & V_10 -> V_343 ) )
F_78 ( & V_10 -> V_18 ) ;
F_70 ( & V_10 -> V_347 ) ;
}
...
struct V_9 * V_10 ;
F_302 () ;
V_10 = F_303 ( & V_169 -> V_435 ,
V_15 >> V_126 ) ;
if ( V_10 && F_246 ( & V_10 -> V_18 ) ) {
F_304 () ;
F_299 ( V_10 , NULL ) ;
return V_10 ;
}
...
V_10 -> V_169 = V_169 ;
V_104:
V_74 = F_306 ( V_124 & ~ V_437 ) ;
if ( V_74 )
goto V_438;
F_66 ( & V_169 -> V_439 ) ;
V_74 = F_307 ( & V_169 -> V_435 ,
V_15 >> V_126 , V_10 ) ;
F_70 ( & V_169 -> V_439 ) ;
F_308 () ;
if ( V_74 == - V_84 ) {
V_436 = F_301 ( V_169 , V_15 ) ;
if ( V_436 )
goto V_438;
else
goto V_104;
...
unsigned long V_125 = V_15 >> V_126 ;
struct V_9 * V_10 ;
struct V_9 * V_436 = NULL ;
struct V_128 * V_60 ;
struct V_43 * V_27 = V_169 -> V_354 -> V_129 ;
int V_237 = 1 ;
int V_74 ;
V_10 = F_301 ( V_169 , V_15 ) ;
if ( V_10 )
...
static inline void F_313 ( struct V_441 * V_3 )
{
struct V_9 * V_10 =
F_314 ( V_3 , struct V_9 , V_441 ) ;
F_281 ( V_10 ) ;
}
...
if ( V_18 <= 3 )
break;
V_442 = F_318 ( & V_10 -> V_18 , V_18 , V_18 - 1 ) ;
if ( V_442 == V_18 )
return;
}
F_66 ( & V_10 -> V_347 ) ;
if ( F_11 ( & V_10 -> V_18 ) == 2 &&
F_155 ( V_419 , & V_10 -> V_343 ) )
F_67 ( & V_10 -> V_18 ) ;
if ( F_11 ( & V_10 -> V_18 ) == 2 &&
F_155 ( V_443 , & V_10 -> V_343 ) &&
! F_282 ( V_10 ) &&
F_229 ( V_433 , & V_10 -> V_343 ) )
F_67 ( & V_10 -> V_18 ) ;
F_315 ( V_10 ) ;
}
...
F_37 ( ! F_184 ( V_128 ) ) ;
F_100 ( V_128 ) ;
F_321 ( & V_128 -> V_27 -> V_444 ) ;
if ( ! F_116 ( V_128 ) ) {
F_322 ( & V_128 -> V_27 -> V_445 ,
F_323 ( V_128 ) ,
V_365 ) ;
}
F_324 ( & V_128 -> V_27 -> V_444 ) ;
F_219 ( V_128 ) ;
F_113 ( V_128 ) ;
}
F_37 ( F_11 ( & V_10 -> V_18 ) == 0 ) ;
...
int V_446 = 0 ;
F_297 ( V_10 ) ;
V_446 = F_298 ( V_348 , & V_10 -> V_343 ) ;
V_201 = F_144 ( V_10 -> V_15 , V_10 -> V_21 ) ;
F_37 ( F_11 ( & V_10 -> V_18 ) == 0 ) ;
F_37 ( ! F_155 ( V_433 , & V_10 -> V_343 ) ) ;
for ( V_139 = 0 ; V_139 < V_201 ; V_139 ++ )
...
V_201 = F_144 ( V_10 -> V_15 , V_10 -> V_21 ) ;
for ( V_139 = V_447 ; V_139 < V_201 ; V_139 ++ ) {
V_128 = F_145 ( V_10 , V_139 ) ;
if ( V_109 == V_451 ) {
if ( ! F_233 ( V_128 ) )
goto V_452;
...
if ( V_40 ) {
V_95 = F_175 ( V_309 | V_355 , V_40 , V_172 ,
V_220 ) ;
if ( V_95 )
return V_95 ;
}
...
void F_331 ( struct V_9 * V_10 , void * V_455 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_9 V_287 ;
...
struct V_128 * V_128 ;
char * V_456 ;
char * V_457 = ( char * ) V_455 ;
T_9 V_458 = V_10 -> V_15 & ( ( T_1 ) V_148 - 1 ) ;
unsigned long V_139 = ( V_458 + V_15 ) >> V_126 ;
F_37 ( V_15 > V_10 -> V_21 ) ;
F_37 ( V_15 + V_21 > V_10 -> V_15 + V_10 -> V_21 ) ;
V_56 = ( V_458 + V_15 ) & ( V_148 - 1 ) ;
while ( V_21 > 0 ) {
V_128 = F_145 ( V_10 , V_139 ) ;
V_287 = F_124 ( V_21 , ( V_148 - V_56 ) ) ;
V_456 = F_332 ( V_128 ) ;
memcpy ( V_457 , V_456 + V_56 , V_287 ) ;
V_457 += V_287 ;
V_21 -= V_287 ;
V_56 = 0 ;
V_139 ++ ;
...
int F_333 ( struct V_9 * V_10 , void T_17 * V_455 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_9 V_287 ;
...
struct V_128 * V_128 ;
char * V_456 ;
char T_17 * V_457 = ( char T_17 * ) V_455 ;
T_9 V_458 = V_10 -> V_15 & ( ( T_1 ) V_148 - 1 ) ;
unsigned long V_139 = ( V_458 + V_15 ) >> V_126 ;
int V_74 = 0 ;
F_37 ( V_15 > V_10 -> V_21 ) ;
...
V_287 = F_124 ( V_21 , ( V_148 - V_56 ) ) ;
V_456 = F_332 ( V_128 ) ;
if ( F_334 ( V_457 , V_456 + V_56 , V_287 ) ) {
V_74 = - V_459 ;
break;
}
V_457 += V_287 ;
...
unsigned long V_460 , char * * V_377 ,
unsigned long * V_461 ,
unsigned long * V_462 )
{
...
T_9 V_458 = V_10 -> V_15 & ( ( T_1 ) V_148 - 1 ) ;
unsigned long V_139 = ( V_458 + V_15 ) >> V_126 ;
unsigned long V_463 = ( V_458 + V_15 + V_460 - 1 ) >>
V_126 ;
if ( V_139 != V_463 )
return - V_399 ;
if ( V_139 == 0 ) {
...
V_56 = 0 ;
* V_461 = ( ( T_1 ) V_139 << V_126 ) - V_458 ;
}
if ( V_15 + V_460 > V_10 -> V_21 ) {
F_54 ( 1 , V_14 L_33
L_34 ,
V_10 -> V_15 , V_10 -> V_21 , V_15 , V_460 ) ;
return - V_399 ;
}
V_60 = F_145 ( V_10 , V_139 ) ;
V_456 = F_332 ( V_60 ) ;
...
int F_336 ( struct V_9 * V_10 , const void * V_464 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_9 V_287 ;
...
V_287 = F_124 ( V_21 , ( V_148 - V_56 ) ) ;
V_456 = F_332 ( V_128 ) ;
V_74 = memcmp ( V_465 , V_456 + V_56 , V_287 ) ;
if ( V_74 )
break;
V_465 += V_287 ;
V_21 -= V_287 ;
...
void F_337 ( struct V_9 * V_10 , const void * V_466 ,
...
void F_338 ( struct V_9 * V_10 , char V_467 ,
unsigned long V_15 , unsigned long V_21 )
{
T_9 V_287 ;
T_9 V_56 ;
...
V_287 = F_124 ( V_21 , V_148 - V_56 ) ;
V_456 = F_332 ( V_128 ) ;
memset ( V_456 + V_56 , V_467 , V_287 ) ;
V_21 -= V_287 ;
V_56 = 0 ;
V_139 ++ ;
}
}
void F_292 ( struct V_9 * V_457 , struct V_9 * V_431 ,
unsigned long V_468 , unsigned long V_469 ,
unsigned long V_21 )
{
T_1 V_470 = V_457 -> V_21 ;
T_9 V_287 ;
T_9 V_56 ;
struct V_128 * V_128 ;
char * V_456 ;
T_9 V_458 = V_457 -> V_15 & ( ( T_1 ) V_148 - 1 ) ;
unsigned long V_139 = ( V_458 + V_468 ) >> V_126 ;
F_37 ( V_431 -> V_21 != V_470 ) ;
V_56 = ( V_458 + V_468 ) &
( V_148 - 1 ) ;
while ( V_21 > 0 ) {
V_128 = F_145 ( V_457 , V_139 ) ;
F_37 ( ! F_194 ( V_128 ) ) ;
V_287 = F_124 ( V_21 , ( unsigned long ) ( V_148 - V_56 ) ) ;
V_456 = F_332 ( V_128 ) ;
F_331 ( V_431 , V_456 + V_56 , V_469 , V_287 ) ;
V_469 += V_287 ;
V_21 -= V_287 ;
V_56 = 0 ;
V_139 ++ ;
...
static inline bool F_339 ( unsigned long V_431 , unsigned long V_457 , unsigned long V_21 )
{
unsigned long V_471 = ( V_431 > V_457 ) ? V_431 - V_457 : V_457 - V_431 ;
return V_471 < V_21 ;
}
static void F_340 ( struct V_128 * V_472 , struct V_128 * V_473 ,
unsigned long V_474 , unsigned long V_475 ,
unsigned long V_21 )
{
char * V_476 = F_332 ( V_472 ) ;
char * V_477 ;
int V_478 = 0 ;
if ( V_472 != V_473 ) {
V_477 = F_332 ( V_473 ) ;
...
V_477 = V_476 ;
if ( F_339 ( V_475 , V_474 , V_21 ) )
V_478 = 1 ;
}
if ( V_478 )
memmove ( V_476 + V_474 , V_477 + V_475 , V_21 ) ;
else
memcpy ( V_476 + V_474 , V_477 + V_475 , V_21 ) ;
}
void F_341 ( struct V_9 * V_457 , unsigned long V_468 ,
unsigned long V_469 , unsigned long V_21 )
{
T_9 V_287 ;
T_9 V_479 ;
T_9 V_480 ;
...
unsigned long V_481 ;
unsigned long V_482 ;
if ( V_469 + V_21 > V_457 -> V_21 ) {
F_10 ( V_14 L_35
L_36 , V_469 , V_21 , V_457 -> V_21 ) ;
F_68 ( 1 ) ;
}
if ( V_468 + V_21 > V_457 -> V_21 ) {
F_10 ( V_14 L_37
L_36 , V_468 , V_21 , V_457 -> V_21 ) ;
F_68 ( 1 ) ;
}
while ( V_21 > 0 ) {
V_479 = ( V_458 + V_468 ) &
...
void F_342 ( struct V_9 * V_457 , unsigned long V_468 ,
unsigned long V_469 , unsigned long V_21 )
{
T_9 V_287 ;
T_9 V_479 ;
...
unsigned long V_484 = V_469 + V_21 - 1 ;
T_9 V_458 = V_457 -> V_15 & ( ( T_1 ) V_148 - 1 ) ;
unsigned long V_481 ;
unsigned long V_482 ;
if ( V_469 + V_21 > V_457 -> V_21 ) {
F_10 ( V_14 L_35
L_38 , V_469 , V_21 , V_457 -> V_21 ) ;
F_68 ( 1 ) ;
}
if ( V_468 + V_21 > V_457 -> V_21 ) {
F_10 ( V_14 L_37
L_38 , V_468 , V_21 , V_457 -> V_21 ) ;
F_68 ( 1 ) ;
}
if ( V_468 < V_469 ) {
F_341 ( V_457 , V_468 , V_469 , V_21 ) ;
return;
}
while ( V_21 > 0 ) {
V_481 = ( V_458 + V_483 ) >> V_126 ;
V_482 = ( V_458 + V_484 ) >> V_126 ;
V_479 = ( V_458 + V_483 ) &
( V_148 - 1 ) ;
V_480 = ( V_458 + V_484 ) &
( V_148 - 1 ) ;
V_287 = F_112 (unsigned long, len, src_off_in_page + 1 ) ;
V_287 = F_124 ( V_287 , V_479 + 1 ) ;
F_340 ( F_145 ( V_457 , V_481 ) ,
F_145 ( V_457 , V_482 ) ,
V_479 - V_287 + 1 ,
V_480 - V_287 + 1 , V_287 ) ;
