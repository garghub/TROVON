...
V_134 = & V_78 -> V_147 ;
V_134 -> V_111 [ 0 ] . V_148 = F_81 ( V_78 -> V_139 [ 0 ] ) ;
V_134 -> V_111 [ 0 ] . V_112 = V_137 ;
V_134 -> V_135 = V_78 -> V_139 + 1 ;
V_134 -> V_118 = 0 ;
V_134 -> V_117 = ( V_135 - 2 ) * V_137 ;
V_134 -> V_14 = ( V_135 - 1 ) * V_137 ;
V_134 -> V_149 [ 0 ] . V_112 = 0 ;
return 0 ;
}
static struct V_18 * F_82 ( struct V_77 * V_78 , long V_150 )
{
struct V_18 * V_19 ;
struct V_87 * V_88 = V_78 -> V_151 ;
F_83 ( V_152 , V_153 ) ;
long V_154 ;
V_78 -> V_155 . V_156 = 5 * V_157 ;
F_38 ( & V_88 -> V_97 ) ;
V_19 = F_62 ( V_88 ) ;
if ( V_19 ) {
V_78 -> V_104 = V_19 ;
F_34 ( V_19 ) ;
V_78 -> V_155 . V_156 = 1 * V_157 ;
V_88 -> V_122 = 0 ;
} else {
if ( V_88 -> V_122 ) {
V_88 -> V_122 = 0 ;
...
F_84 ( & V_78 -> V_106 , & V_152 ) ;
F_40 ( & V_88 -> V_97 ) ;
V_154 = F_79 ( V_150 ) ;
F_85 () ;
F_38 ( & V_88 -> V_97 ) ;
F_86 ( & V_78 -> V_106 , & V_152 ) ;
if ( ! V_154 )
V_88 -> V_100 . V_159 ++ ;
V_19 = V_78 -> V_104 ;
if ( ! V_19 ) {
...
static void F_87 ( struct V_32 * V_33 , struct V_18 * V_160 )
{
F_38 ( & V_33 -> V_70 ) ;
F_24 ( V_69 , & V_160 -> V_26 ) ;
F_39 ( & V_160 -> V_36 , & V_33 -> V_129 ) ;
V_33 -> V_128 ++ ;
if ( V_33 -> V_161 . V_162 == NULL ) {
F_88 ( & V_33 -> V_161 , V_163 ,
( unsigned long ) V_33 ) ;
F_89 ( & V_33 -> V_161 ,
V_164 + V_165 * V_157 ) ;
}
...
if ( F_13 ( V_166 , & V_19 -> V_26 ) ) {
struct V_18 * V_160 ;
F_92 ( V_19 -> V_23 -> V_24 ) ;
F_72 ( V_19 -> V_35 ) ;
V_160 = V_19 -> V_29 -> V_167 ( V_19 ) ;
if ( V_160 )
F_87 ( V_33 , V_160 ) ;
else
F_17 ( V_19 -> V_23 -> V_24 ) ;
...
F_2 ( L_21 ,
V_78 , V_78 -> V_151 -> V_168 , V_19 ,
F_63 ( & V_19 -> V_20 . V_108 ) ) ;
V_78 -> V_116 = F_93 ( V_19 ) ;
if ( V_78 -> V_116 )
V_14 = F_94 ( V_78 ) ;
else
V_14 = V_19 -> V_29 -> V_169 ( V_78 ) ;
F_2 ( L_22 , V_14 ) ;
...
if ( F_77 () || F_78 () )
return - V_145 ;
V_19 = F_82 ( V_78 , V_150 ) ;
if ( F_43 ( V_19 ) )
return F_44 ( V_19 ) ;
V_14 = F_90 ( V_78 , V_19 ) ;
if ( V_14 <= 0 )
goto V_9;
F_35 ( V_170 , & V_19 -> V_26 ) ;
V_78 -> V_171 = V_19 -> V_29 -> V_172 ( V_78 ) ;
V_78 -> V_155 . V_173 = V_174 ;
if ( V_33 -> V_175 )
V_33 -> V_175 -> V_176 ++ ;
return V_14 ;
V_9:
...
V_78 -> V_104 -> V_29 -> V_115 ( V_78 ) ;
V_177 = & V_78 -> V_110 ;
V_177 -> V_14 = V_177 -> V_111 [ 0 ] . V_112 +
V_177 -> V_117 +
V_177 -> V_149 [ 0 ] . V_112 ;
F_101 ( & V_19 -> V_40 ) ;
if ( F_13 ( V_179 , & V_19 -> V_26 )
|| F_13 ( V_92 , & V_19 -> V_26 ) )
V_14 = - V_180 ;
else
V_14 = V_19 -> V_29 -> V_181 ( V_78 ) ;
F_102 ( & V_19 -> V_40 ) ;
F_103 ( & V_19 -> V_43 ) ;
F_66 ( V_78 ) ;
if ( V_14 == - V_182 || V_14 == - V_180 || V_14 == - V_158 )
return 0 ;
return V_14 ;
}
static void V_163 ( unsigned long V_183 )
{
struct V_32 * V_33 = (struct V_32 * ) V_183 ;
struct V_18 * V_19 ;
struct V_184 * V_185 , * V_103 ;
F_2 ( L_27 ) ;
if ( ! F_104 ( & V_33 -> V_70 ) ) {
F_2 ( L_28 ) ;
F_89 ( & V_33 -> V_161 , V_164 + V_157 ) ;
return;
}
F_105 (le, next, &serv->sv_tempsocks) {
V_19 = F_60 ( V_185 , struct V_18 , V_36 ) ;
if ( ! F_59 ( V_170 , & V_19 -> V_26 ) )
continue;
...
F_40 ( & V_33 -> V_70 ) ;
F_89 ( & V_33 -> V_161 , V_164 + V_165 * V_157 ) ;
}
...
V_188 = F_107 ( & V_19 -> V_39 , struct V_187 , V_189 ) ;
F_52 ( & V_188 -> V_189 ) ;
V_188 -> V_190 ( V_188 ) ;
}
F_7 ( & V_19 -> V_41 ) ;
...
struct V_191 * V_192 ;
if ( F_59 ( V_179 , & V_19 -> V_26 ) )
F_108 () ;
F_2 ( L_30 , V_19 ) ;
V_19 -> V_29 -> V_193 ( V_19 ) ;
F_38 ( & V_33 -> V_70 ) ;
if ( ! F_59 ( V_186 , & V_19 -> V_26 ) )
F_9 ( & V_19 -> V_36 ) ;
F_33 ( ! F_57 ( & V_19 -> V_37 ) ) ;
if ( F_13 ( V_69 , & V_19 -> V_26 ) )
V_33 -> V_128 -- ;
F_40 ( & V_33 -> V_70 ) ;
while ( ( V_192 = F_93 ( V_19 ) ) != NULL )
F_67 ( V_192 ) ;
F_106 ( V_19 ) ;
F_18 ( V_19 ) ;
}
...
static int F_110 ( struct V_32 * V_33 , struct V_184 * V_194 , struct V_31 * V_31 )
{
struct V_18 * V_19 ;
int V_195 = 0 ;
F_4 ( & V_33 -> V_70 ) ;
...
static void F_116 ( struct V_198 * V_199 , int V_200 )
{
struct V_191 * V_192 =
F_12 ( V_199 , struct V_191 , V_201 ) ;
struct V_18 * V_19 = V_192 -> V_19 ;
F_4 ( & V_19 -> V_41 ) ;
F_24 ( V_94 , & V_19 -> V_26 ) ;
if ( V_200 || F_13 ( V_179 , & V_19 -> V_26 ) ) {
F_7 ( & V_19 -> V_41 ) ;
F_2 ( L_31 ) ;
F_18 ( V_19 ) ;
F_67 ( V_192 ) ;
...
F_2 ( L_32 ) ;
V_192 -> V_19 = NULL ;
F_39 ( & V_192 -> V_201 . V_202 , & V_19 -> V_38 ) ;
F_7 ( & V_19 -> V_41 ) ;
F_36 ( V_19 ) ;
F_18 ( V_19 ) ;
}
static struct V_198 * V_174 ( struct V_203 * V_204 )
{
struct V_77 * V_78 = F_12 ( V_204 , struct V_77 , V_155 ) ;
struct V_191 * V_192 ;
if ( V_78 -> V_147 . V_117 || ! V_78 -> V_205 )
return NULL ;
if ( V_78 -> V_116 ) {
V_192 = V_78 -> V_116 ;
V_78 -> V_116 = NULL ;
...
T_1 V_206 ;
T_1 V_207 ;
V_207 = sizeof( struct V_191 ) + V_78 -> V_147 . V_14 ;
V_192 = F_117 ( V_207 , V_142 ) ;
if ( V_192 == NULL )
return NULL ;
V_192 -> V_201 . V_22 = V_78 -> V_132 ;
V_192 -> V_208 = V_78 -> V_209 ;
memcpy ( & V_192 -> V_210 , & V_78 -> V_79 , V_78 -> V_82 ) ;
V_192 -> V_211 = V_78 -> V_82 ;
V_192 -> V_212 = V_78 -> V_83 ;
V_192 -> V_213 = V_78 -> V_147 . V_14 >> 2 ;
V_192 -> V_214 = V_78 -> V_215 ;
V_206 = V_78 -> V_147 . V_14 - V_78 -> V_147 . V_111 [ 0 ] . V_112 ;
memcpy ( V_192 -> args , V_78 -> V_147 . V_111 [ 0 ] . V_148 - V_206 ,
V_192 -> V_213 << 2 ) ;
}
F_34 ( V_78 -> V_104 ) ;
V_192 -> V_19 = V_78 -> V_104 ;
V_78 -> V_216 = true ;
V_192 -> V_201 . V_217 = F_116 ;
return & V_192 -> V_201 ;
}
static int F_94 ( struct V_77 * V_78 )
{
struct V_191 * V_192 = V_78 -> V_116 ;
V_78 -> V_147 . V_111 [ 0 ] . V_148 = V_192 -> args + ( V_192 -> V_214 >> 2 ) ;
V_78 -> V_147 . V_111 [ 0 ] . V_112 = ( V_192 -> V_213 << 2 ) - V_192 -> V_214 ;
V_78 -> V_147 . V_117 = 0 ;
V_78 -> V_147 . V_14 = V_192 -> V_213 << 2 ;
V_78 -> V_209 = V_192 -> V_208 ;
memcpy ( & V_78 -> V_79 , & V_192 -> V_210 , V_192 -> V_211 ) ;
V_78 -> V_82 = V_192 -> V_211 ;
V_78 -> V_215 = V_192 -> V_214 ;
V_78 -> V_83 = V_192 -> V_212 ;
V_78 -> V_218 = V_78 -> V_139 ;
return ( V_192 -> V_213 << 2 ) - V_192 -> V_214 ;
}
static struct V_191 * F_93 ( struct V_18 * V_19 )
{
...
F_4 ( & V_19 -> V_41 ) ;
if ( ! F_57 ( & V_19 -> V_38 ) ) {
V_192 = F_60 ( V_19 -> V_38 . V_103 ,
struct V_191 ,
V_201 . V_202 ) ;
F_9 ( & V_192 -> V_201 . V_202 ) ;
} else
F_35 ( V_94 , & V_19 -> V_26 ) ;
F_7 ( & V_19 -> V_41 ) ;
return V_192 ;
...
struct V_31 * V_31 , const T_2 V_219 ,
const unsigned short V_45 )
{
struct V_18 * V_19 ;
struct V_18 * V_220 = NULL ;
...
continue;
if ( V_219 != V_221 && V_219 != V_19 -> V_84 . V_222 )
continue;
...
{
int V_14 ;
V_14 = snprintf ( V_223 , V_224 , L_33 ,
V_19 -> V_23 -> V_6 ,
F_45 ( V_19 ) ) ;
if ( V_14 >= V_224 )
return - V_225 ;
...
int F_120 ( struct V_32 * V_33 , char * V_11 , const int V_226 )
{
struct V_18 * V_19 ;
int V_14 , V_227 ;
char * V_223 ;
...
V_227 = 0 ;
F_5 (xprt, &serv->sv_permsocks, xpt_list) {
V_14 = F_119 ( V_19 , V_223 , V_226 - V_227 ) ;
if ( V_14 < 0 ) {
* V_11 = '\0' ;
V_227 = V_14 ;
}
...
static void * F_121 ( struct V_228 * V_229 , T_3 * V_223 )
{
unsigned int V_230 = ( unsigned int ) * V_223 ;
struct V_32 * V_33 = V_229 -> V_231 ;
F_2 ( L_34 , V_230 ) ;
if ( ! V_230 )
return V_232 ;
return ( V_230 > V_33 -> V_120 ? NULL : & V_33 -> V_121 [ V_230 - 1 ] ) ;
}
static void * F_122 ( struct V_228 * V_229 , void * V_141 , T_3 * V_223 )
{
...
unsigned int V_230 = ( V_88 - & V_33 -> V_121 [ 0 ] ) ;
if ( V_230 < V_33 -> V_120 - 1 )
V_88 = & V_33 -> V_121 [ V_230 + 1 ] ;
else
V_88 = NULL ;
}
++ * V_223 ;
...
static void F_123 ( struct V_228 * V_229 , void * V_141 )
{
}
static int F_124 ( struct V_228 * V_229 , void * V_141 )
{
struct V_87 * V_88 = V_141 ;
if ( V_141 == V_232 ) {
F_125 ( V_229 , L_36 ) ;
...
int F_127 ( struct V_32 * V_33 , struct V_233 * V_233 )
{
int V_75 ;
V_75 = F_128 ( V_233 , & V_234 ) ;
if ( ! V_75 )
( (struct V_228 * ) V_233 -> V_235 ) -> V_231 = V_33 ;
return V_75 ;
}
