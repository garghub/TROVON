...
struct V_30 * V_37 , int V_38 )
{
struct V_40 * V_41 = V_36 -> V_2 -> V_41 ;
if ( F_18 ( V_38 ) )
F_20 ( V_41 , 1 ) ;
else
F_20 ( V_41 , 0 ) ;
...
V_6 -> V_71 = F_44 ( V_4 -> V_43 , L_28 ) ;
if ( F_45 ( V_6 -> V_71 ) ) {
F_28 ( V_4 -> V_43 , L_29 ) ;
return F_46 ( V_6 -> V_71 ) ;
}
V_42 = F_47 ( V_6 -> V_71 , 1 ) ;
if ( V_42 ) {
F_28 ( V_4 -> V_43 , L_30 ) ;
return V_42 ;
}
...
V_42 = F_47 ( V_6 -> V_39 , 0 ) ;
if ( V_42 ) {
F_28 ( V_4 -> V_43 , L_33 ) ;
return V_42 ;
}
V_42 = F_48 ( V_4 -> V_43 , V_4 ) ;
if ( V_42 ) {
F_28 ( & V_51 -> V_43 , L_34 , V_42 ) ;
return V_42 ;
}
return 0 ;
}
