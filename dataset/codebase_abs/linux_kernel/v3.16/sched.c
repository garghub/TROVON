...
if ( ! V_110 )
return;
V_102 = F_117 ( V_110 , struct V_101 , V_67 ) ;
V_100 = V_102 -> V_109 ;
F_2 ( L_17 ,
V_100 , V_102 ) ;
if ( V_100 <= V_107 )
...
F_127 ( void )
{
return (struct V_3 * ) F_119 ( V_119 , V_120 ) ;
}
struct V_3 * F_128 ( const struct V_111 * V_121 )
{
...
static void F_136 ( struct V_3 * V_4 , struct V_126 * V_16 )
{
if ( F_58 ( & V_4 -> V_50 ) ) {
F_132 ( V_4 ) ;
F_135 ( V_4 , V_16 ) ;
...
struct V_126 * V_45 ;
F_2 ( L_22 ) ;
V_45 = F_144 ( L_23 , V_129 , 1 ) ;
V_56 = V_45 ;
return V_56 != NULL ;
}
static void F_145 ( void )
{
struct V_126 * V_45 = NULL ;
if ( V_56 == NULL )
return;
F_2 ( L_24 ) ;
V_45 = V_56 ;
