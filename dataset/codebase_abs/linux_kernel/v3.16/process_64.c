...
V_50 -> V_56 [ V_51 ] = V_57 -> V_58 ( V_51 ) ;
V_50 -> V_59 [ V_51 ] = V_57 -> V_60 ( V_51 ) ;
}
}
static void F_39 ( struct V_49 * V_50 )
{
int V_39 = 0 ;
while ( ! V_50 -> V_56 [ 0 ] && ++ V_39 < 100 ) {
F_27 () ;
F_28 ( 1 ) ;
}
}
...
F_41 () ;
F_35 (cpu) {
struct V_49 * V_50 = & V_31 [ V_42 ] . V_53 ;
F_39 ( V_50 ) ;
F_16 ( L_21 ,
( V_42 == V_28 ? '*' : ' ' ) , V_42 ,
V_50 -> V_56 [ 0 ] , V_50 -> V_56 [ 1 ] , V_50 -> V_56 [ 2 ] , V_50 -> V_56 [ 3 ] ,
