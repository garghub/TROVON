...
V_5 -> V_16 = V_16 ;
F_15 ( L_1 ,
V_15 -> type , V_15 -> V_31 , V_15 -> V_32 , V_15 -> type >= 2 ?
V_15 -> V_33 . V_34 : 0 , V_15 -> V_35 , V_15 -> V_36 ,
V_15 -> V_37 , V_15 -> V_38 ) ;
V_5 -> V_39 = V_22 -> V_40 ( V_22 , V_5 -> V_30 . V_36 ) ;
V_5 -> V_41 = V_5 -> V_39 ;
V_29 = F_16 ( V_20 , V_5 -> V_30 . V_35 , & V_27 , & V_28 , & V_26 ) ;
if ( ! V_29 ) {
F_15 ( L_2 ) ;
memset ( & V_26 , 0x00 , sizeof( V_26 ) ) ;
V_26 . type = V_42 ;
}
V_8 = F_17 ( V_10 , V_11 , V_43 ,
& V_26 , V_5 -> V_30 . V_35 ,
(struct V_1 * * ) & V_5 -> V_6 ) ;
if ( V_8 < 0 ) {
F_18 ( L_3 , V_8 ) ;
...
F_19 ( & V_5 -> V_9 , & V_24 -> V_5 ) ;
return 0 ;
}
int
F_20 ( struct V_1 * V_10 ,
struct V_1 * V_11 ,
...
struct V_4 * V_5 ;
int V_8 ;
V_8 = F_21 ( V_10 , V_11 , V_13 , V_15 , V_16 , & V_5 ) ;
* V_18 = F_4 ( V_5 ) ;
if ( V_8 )
return V_8 ;
return 0 ;
