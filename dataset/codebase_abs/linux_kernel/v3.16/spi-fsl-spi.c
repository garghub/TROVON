...
return - V_47 ;
if ( ! V_16 ) {
V_16 = F_33 ( & V_11 -> V_2 , sizeof( * V_16 ) , V_86 ) ;
if ( ! V_16 )
return - V_87 ;
V_11 -> V_17 = V_16 ;
}
...
V_141 -> V_145 = F_75 ( V_148 * sizeof( * V_141 -> V_145 ) ,
V_86 ) ;
if ( ! V_141 -> V_145 ) {
V_66 = - V_87 ;
goto V_151;
...
static int F_88 ( struct V_155 * V_157 )
{
struct V_120 * V_121 ;
int V_105 ;
struct V_114 * V_14 ;
...
static int F_92 ( struct V_155 * V_157 )
{
return F_87 ( & V_157 -> V_2 ) ;
}
