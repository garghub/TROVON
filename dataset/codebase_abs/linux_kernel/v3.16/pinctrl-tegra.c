...
F_10 ( V_18 , L_15 , F_43 ( V_100 ) , V_97 ) ;
}
...
V_2 = F_47 ( & V_102 -> V_20 , sizeof( * V_2 ) , V_111 ) ;
if ( ! V_2 ) {
...
for ( V_29 = 0 ; ; V_29 ++ ) {
V_106 = F_49 ( V_102 , V_118 , V_29 ) ;
if ( ! V_106 )
break;
}
V_2 -> V_119 = V_29 ;
V_2 -> V_5 = F_47 ( & V_102 -> V_20 , V_2 -> V_119 * sizeof( * V_2 -> V_5 ) ,
V_111 ) ;
if ( ! V_2 -> V_5 ) {
...
V_106 = F_49 ( V_102 , V_118 , V_29 ) ;
V_2 -> V_5 [ V_29 ] = F_50 ( & V_102 -> V_20 , V_106 ) ;
if ( F_51 ( V_2 -> V_5 [ V_29 ] ) )
return F_52 ( V_2 -> V_5 [ V_29 ] ) ;
}
V_2 -> V_120 = F_53 ( & V_117 , & V_102 -> V_20 , V_2 ) ;
if ( ! V_2 -> V_120 ) {
F_14 ( & V_102 -> V_20 , L_18 ) ;
return - V_121 ;
}
F_54 ( V_2 -> V_120 , & V_115 ) ;
F_55 ( V_102 , V_2 ) ;
F_56 ( & V_102 -> V_20 , L_19 ) ;
return 0 ;
}
int F_57 ( struct V_101 * V_102 )
{
struct V_1 * V_2 = F_58 ( V_102 ) ;
F_59 ( V_2 -> V_120 ) ;
return 0 ;
}
