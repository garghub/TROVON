...
static int F_40 ( struct V_33 * V_34 , struct V_83 * V_84 )
{
struct V_2 * V_3 = F_18 ( V_34 ) ;
...
F_43 ( V_34 ) ;
if ( V_85 [ V_96 ] )
V_34 -> V_72 = F_42 ( V_85 [ V_96 ] ) ;
V_3 -> V_71 = V_89 ;
V_3 -> V_68 = V_90 ;
if ( V_85 [ V_97 ] )
V_3 -> V_29 = F_42 ( V_85 [ V_97 ] ) ;
if ( V_85 [ V_98 ] ) {
T_1 V_99 = F_42 ( V_85 [ V_98 ] ) ;
V_3 -> V_44 = F_44 ( V_99 ) ;
}
if ( V_85 [ V_100 ] )
V_3 -> V_53 = F_42 ( V_85 [ V_100 ] ) ;
if ( V_85 [ V_101 ] ) {
T_1 V_99 = F_42 ( V_85 [ V_101 ] ) ;
V_3 -> V_25 = F_44 ( V_99 ) ;
}
V_60 = V_34 -> V_3 . V_60 ;
...
static int F_46 ( struct V_33 * V_34 , struct V_83 * V_84 )
{
struct V_2 * V_3 = F_18 ( V_34 ) ;
int V_42 ;
V_34 -> V_72 = 1000 ;
V_3 -> V_71 = F_47 ( F_48 ( V_34 ) ) ;
V_3 -> V_16 = F_49 () ;
F_15 ( & V_3 -> V_69 ) ;
F_15 ( & V_3 -> V_67 ) ;
V_3 -> V_44 = V_102 / 25 ;
...
static int F_50 ( struct V_33 * V_34 , struct V_4 * V_5 )
{
struct V_2 * V_3 = F_18 ( V_34 ) ;
struct V_83 * V_106 ;
V_106 = F_51 ( V_5 , V_107 ) ;
if ( V_106 == NULL )
goto V_108;
if ( F_52 ( V_5 , V_96 , V_34 -> V_72 ) ||
F_52 ( V_5 , V_93 , V_3 -> V_71 ) ||
F_52 ( V_5 , V_97 , V_3 -> V_29 ) ||
F_52 ( V_5 , V_98 ,
F_53 ( V_3 -> V_44 ) ) ||
F_52 ( V_5 , V_100 , V_3 -> V_53 ) ||
F_52 ( V_5 , V_101 ,
F_53 ( V_3 -> V_25 ) ) ||
F_52 ( V_5 , V_94 , V_3 -> V_68 ) )
goto V_108;
return F_54 ( V_5 , V_106 ) ;
V_108:
return - 1 ;
}
static int F_55 ( struct V_33 * V_34 , struct V_109 * V_110 )
{
struct V_2 * V_3 = F_18 ( V_34 ) ;
struct V_111 V_112 = {
. V_74 = V_3 -> V_74 ,
...
return F_56 ( V_110 , & V_112 , sizeof( V_112 ) ) ;
}
