...
if ( V_4 [ V_22 ] . V_24 < type
&& V_4 [ V_22 ] . V_16 < V_16
&& V_4 [ V_22 ] . V_17 < V_17 )
break;
if ( V_22 < V_3 )
memmove ( & V_4 [ V_22 + 1 ] , & V_4 [ V_22 ] , V_3 - V_22 ) ;
V_4 [ V_22 ] . V_24 = type << 8 | V_15 ;
V_4 [ V_22 ] . V_16 = V_16 ;
V_4 [ V_22 ] . V_17 = V_17 ;
V_4 [ V_22 ] . V_19 = V_19 ;
V_4 [ V_22 ] . V_20 = V_20 ;
...
if ( V_30 >= V_29 -> V_20 ) {
F_13 ( V_37 , L_1 ,
V_29 , V_29 -> V_24 , V_29 -> V_16 , V_29 -> V_17 ,
V_29 -> V_20 , V_30 ) ;
goto V_9;
}
V_35 = - V_27 ;
...
goto V_9;
V_46 = F_15 ( V_32 -> V_47 ) ;
V_24 = V_32 -> V_48 << 8 | ( V_46 & 0xff00 ) >> 8 ;
for ( V_22 = 0 ; V_22 < V_3 ; V_22 ++ ) {
if ( V_4 [ V_22 ] . V_24 != V_24 )
continue;
