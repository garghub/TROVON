...
V_72 = 0 ;
while ( V_70 > 0 ) {
struct V_76 * V_1 = * ( V_37 -> V_77 ++ ) ;
V_37 -> V_78 [ V_72 ] . V_79 = F_31 ( V_1 ) ;
V_37 -> V_78 [ V_72 ] . V_80 = V_70 < V_81 ? V_70 : V_81 ;
V_70 -= V_37 -> V_78 [ V_72 ] . V_80 ;
V_72 ++ ;
}
args -> V_82 = V_72 ;
return F_26 ( V_37 , V_1 ) ;
...
if ( V_70 > V_75 )
return 0 ;
V_84 = ( void * ) V_1 - V_37 -> V_86 . V_87 [ 0 ] . V_79 ;
V_85 = V_37 -> V_86 . V_87 [ 0 ] . V_80 + V_37 -> V_86 . V_88
- V_84 ;
if ( V_85 < F_33 ( V_70 ) * 4 )
return 0 ;
V_37 -> V_78 [ 0 ] . V_79 = ( void * ) V_1 ;
V_37 -> V_78 [ 0 ] . V_80 = V_37 -> V_86 . V_87 [ 0 ] . V_80 - V_84 ;
V_72 = 0 ;
while ( V_70 > V_37 -> V_78 [ V_72 ] . V_80 ) {
V_70 -= V_37 -> V_78 [ V_72 ] . V_80 ;
V_72 ++ ;
V_37 -> V_78 [ V_72 ] . V_79 = F_31 ( V_37 -> V_89 [ V_72 ] ) ;
V_37 -> V_78 [ V_72 ] . V_80 = V_81 ;
}
V_37 -> V_78 [ V_72 ] . V_80 = V_70 ;
args -> V_82 = V_72 + 1 ;
return 1 ;
}
int
...
int
F_36 ( struct V_36 * V_37 , T_1 * V_1 , struct V_98 * args )
{
V_1 = F_1 ( V_1 , & args -> V_66 ) ;
if ( ! V_1 )
return 0 ;
args -> V_99 = F_31 ( * ( V_37 -> V_77 ++ ) ) ;
return F_26 ( V_37 , V_1 ) ;
}
int
...
int
F_40 ( struct V_36 * V_37 , T_1 * V_1 , void * V_64 )
{
...
* V_1 ++ = F_15 ( V_105 -> V_70 ) ;
F_41 ( V_37 , V_1 ) ;
V_37 -> V_108 . V_88 = V_105 -> V_70 ;
if ( V_105 -> V_70 & 3 ) {
V_37 -> V_108 . V_109 [ 0 ] . V_79 = V_1 ;
* V_1 = 0 ;
V_37 -> V_108 . V_109 [ 0 ] . V_80 = 4 - ( V_105 -> V_70 & 3 ) ;
}
return 1 ;
}
int
...
* V_1 ++ = F_15 ( V_105 -> V_74 ) ;
F_41 ( V_37 , V_1 ) ;
V_37 -> V_108 . V_88 = V_105 -> V_74 ;
if ( V_105 -> V_74 & 3 ) {
V_37 -> V_108 . V_109 [ 0 ] . V_79 = V_1 ;
* V_1 = 0 ;
V_37 -> V_108 . V_109 [ 0 ] . V_80 = 4 - ( V_105 -> V_74 & 3 ) ;
}
return 1 ;
}
int
...
V_37 -> V_108 . V_88 = ( ( ( unsigned long ) V_1 - 1 ) & ~ V_115 ) + 1 ;
return 1 ;
}
int
...
int
F_48 ( void * V_123 , const char * V_10 ,
int V_124 , T_3 V_73 , T_4 V_61 , unsigned int V_125 )
{
struct V_126 * V_127 = V_123 ;
struct V_111 * V_128 = F_49 ( V_127 , struct V_111 , V_112 ) ;
T_1 * V_1 = V_128 -> V_99 ;
int V_129 , V_130 ;
if ( V_73 > ~ ( ( T_2 ) 0 ) ) {
