...
V_63 = F_34 ( V_10 -> V_76 , NULL , V_10 -> V_38 , V_73 ,
V_10 -> V_41 ) ;
if ( F_28 ( V_63 ) ) {
V_62 = F_29 ( V_63 ) ;
V_63 = NULL ;
...
static T_3 F_45 ( struct V_84 * V_85 ,
struct V_86 * V_87 ,
char * V_88 )
{
T_3 V_89 = 0 , V_90 = 0 , V_91 = V_92 ;
struct V_9 * V_10 ;
F_24 ( & V_70 ) ;
F_46 (v9ses, &v9fs_sessionlist, slist) {
if ( V_10 -> V_22 ) {
V_89 = snprintf ( V_88 , V_91 , L_27 , V_10 -> V_22 ) ;
if ( V_89 < 0 ) {
V_90 = V_89 ;
break;
}
...
V_98 -> V_83 = NULL ;
#endif
memset ( & V_98 -> V_99 , 0 , sizeof( V_98 -> V_99 ) ) ;
F_54 ( & V_98 -> V_100 ) ;
}
