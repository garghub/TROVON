...
static bool F_108 ( struct V_11 * V_11 , T_1 * V_14 , bool V_137 )
{
T_1 V_10 = * V_14 ;
if ( ! F_43 ( V_10 ) &&
! ( V_137 && F_41 ( V_10 ) ) )
...
F_195 ( V_227 != V_42 ||
V_228 != V_138 ) ;
V_10 = F_38 ( V_52 -> V_131 ) | V_42 | V_138 |
V_31 | V_35 ;
if ( V_226 )
V_10 |= V_32 ;
F_9 ( V_14 , V_10 ) ;
...
static bool
F_249 ( struct V_36 * V_37 , struct V_51 * V_52 ,
T_1 * V_14 , T_1 V_10 )
{
T_2 V_15 ;
F_3 ( ! V_52 -> V_94 . V_95 ) ;
V_15 = F_75 ( V_52 , V_14 - V_52 -> V_131 ) ;
if ( F_250 ( V_14 , V_10 , V_10 | V_138 ) == V_10 )
F_221 ( V_37 -> V_11 , V_15 ) ;
return true ;
}
...
V_52 = F_37 ( F_38 ( V_219 . V_14 ) ) ;
if ( ! F_26 ( V_10 , V_52 -> V_94 . V_44 ) )
goto exit;
if ( F_43 ( V_10 ) ) {
V_68 = true ;
goto exit;
...
if ( V_52 -> V_94 . V_44 > V_45 )
goto exit;
V_68 = F_249 ( V_37 , V_52 , V_219 . V_14 , V_10 ) ;
exit:
...
F_19 ( V_358 , 63 ) |
F_19 ( 5 , 8 ) | F_19 ( 1 , 2 ) ;
V_346 -> V_362 [ 0 ] [ 1 ] = V_359 |
F_19 ( V_358 , 62 ) ;
V_346 -> V_362 [ 0 ] [ 0 ] = V_359 |
F_19 ( V_358 , 62 ) ;
V_346 -> V_362 [ 1 ] [ 1 ] = V_359 |
F_19 ( V_358 , 62 ) |
F_19 ( 13 , 20 ) ;
V_346 -> V_362 [ 1 ] [ 0 ] = V_346 -> V_362 [ 0 ] [ 0 ] ;
break;
case V_197 :
V_346 -> V_362 [ 0 ] [ 3 ] = V_359 |
F_19 ( V_358 , 51 ) | F_19 ( 7 , 7 ) ;
V_346 -> V_362 [ 0 ] [ 2 ] = V_359 |
V_360 | F_19 ( V_358 , 51 ) ;
V_346 -> V_362 [ 0 ] [ 1 ] = V_359 |
F_19 ( V_358 , 51 ) ;
V_346 -> V_362 [ 0 ] [ 0 ] = V_359 |
...
void F_302 ( struct V_36 * V_37 ,
struct V_345 * V_190 , bool V_366 )
{
unsigned V_367 , V_368 , V_369 ;
T_8 V_370 ;
bool V_354 , V_371 , V_372 , V_373 , V_374 , V_375 , V_376 , V_377 , V_378 , V_379 , V_380 = 0 ;
V_379 = F_303 ( V_37 , V_381 ) ;
V_378 = F_303 ( V_37 , V_382 ) ;
for ( V_368 = 0 ; V_368 < F_60 ( V_190 -> V_383 ) ; ++ V_368 ) {
V_369 = V_368 << 1 ;
V_370 = 0 ;
V_374 = V_369 & V_307 ;
V_375 = V_369 & V_384 ;
...
if ( ! V_366 ) {
V_371 |= ! V_190 -> V_351 ;
V_372 |= ! F_304 ( V_37 ) && ! V_375 ;
V_371 &= ! ( V_379 && V_373 && ! V_375 ) ;
V_380 = V_378 && V_373 && ! V_375 && ! V_376 ;
} else
V_373 = 1 ;
V_354 = ( V_376 && ! V_371 ) || ( V_375 && ! V_373 ) || ( V_374 && ! V_372 ) ||
( V_377 && V_380 ) ;
V_370 |= V_354 << V_367 ;
}
V_190 -> V_383 [ V_368 ] = V_370 ;
}
}
static void F_305 ( struct V_36 * V_37 , struct V_345 * V_190 )
{
T_8 V_370 ;
...
if ( V_44 <= V_387
&& ( V_190 -> V_210 >= V_224 || F_300 ( V_37 ) ) )
V_370 |= 1 << ( V_386 | ( V_44 - 1 ) ) ;
}
V_190 -> V_357 = V_370 ;
}
...
struct V_345 * V_346 )
{
F_306 ( V_37 , V_346 , V_224 ) ;
}
static void F_310 ( struct V_36 * V_37 )
{
struct V_345 * V_346 = V_37 -> V_38 . V_398 ;
V_346 -> V_208 . V_214 = 0 ;
V_346 -> V_347 = F_290 ;
V_346 -> V_191 = F_151 ;
V_346 -> V_349 = F_152 ;
V_346 -> V_350 = F_153 ;
V_346 -> V_223 = V_118 -> V_399 () ;
V_346 -> V_222 = V_313 ;
V_346 -> V_209 = true ;
V_346 -> V_400 = V_118 -> V_401 ;
V_346 -> V_318 = V_318 ;
V_346 -> V_321 = V_402 ;
V_346 -> F_294 = V_403 ;
if ( ! F_311 ( V_37 ) ) {
...
F_308 ( V_37 , V_346 ) ;
V_37 -> V_38 . V_190 . V_208 . V_405 = F_22 ( V_37 ) ;
V_37 -> V_38 . V_190 . V_208 . V_189 = ! ! F_162 ( V_37 ) ;
V_37 -> V_38 . V_190 . V_208 . V_406 = F_304 ( V_37 ) ;
V_37 -> V_38 . V_190 . V_208 . V_407
= V_404 && ! F_304 ( V_37 ) ;
}
void F_314 ( struct V_36 * V_37 , struct V_345 * V_346 ,
bool V_363 )
{
ASSERT ( V_37 ) ;
ASSERT ( ! F_232 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
...
V_346 -> V_222 = V_313 ;
V_346 -> V_209 = false ;
F_302 ( V_37 , V_346 , true ) ;
F_301 ( V_37 , V_346 , V_363 ) ;
}
static void F_315 ( struct V_36 * V_37 )
{
F_313 ( V_37 , V_37 -> V_38 . V_398 ) ;
V_37 -> V_38 . V_398 -> V_400 = V_118 -> V_400 ;
V_37 -> V_38 . V_398 -> V_318 = V_318 ;
V_37 -> V_38 . V_398 -> V_321 = V_402 ;
V_37 -> V_38 . V_398 -> F_294 = V_403 ;
}
static void F_316 ( struct V_36 * V_37 )
{
struct V_345 * V_413 = & V_37 -> V_38 . V_328 ;
V_413 -> V_318 = V_318 ;
V_413 -> V_321 = V_402 ;
V_413 -> F_294 = V_403 ;
if ( ! F_311 ( V_37 ) ) {
...
F_302 ( V_37 , V_413 , false ) ;
F_305 ( V_37 , V_413 ) ;
}
static void F_317 ( struct V_36 * V_37 )
{
if ( F_318 ( V_37 ) )
return F_316 ( V_37 ) ;
else if ( V_266 )
...
if ( V_84 )
goto V_88;
V_37 -> V_38 . V_190 . V_400 ( V_37 , V_37 -> V_38 . V_190 . V_222 ) ;
V_88:
return V_84 ;
}
void F_320 ( struct V_36 * V_37 )
{
F_258 ( V_37 ) ;
F_3 ( F_232 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
}
static void F_322 ( struct V_36 * V_37 ,
struct V_51 * V_52 , T_1 * V_10 ,
const void * V_416 )
{
if ( V_52 -> V_94 . V_44 != V_45 ) {
...
++ V_37 -> V_11 -> V_135 . V_418 ;
V_37 -> V_38 . V_190 . V_350 ( V_37 , V_52 , V_10 , V_416 ) ;
}
static bool F_323 ( T_1 V_419 , T_1 V_416 )
{
if ( ! F_23 ( V_419 ) )
return false ;
if ( ! F_23 ( V_416 ) )
...
static void F_324 ( struct V_36 * V_37 , bool V_421 ,
...
static T_1 F_325 ( struct V_36 * V_37 , T_9 * V_344 ,
const T_8 * V_416 , int * V_424 )
{
T_1 V_425 ;
int V_84 ;
if ( F_162 ( V_37 ) && * V_424 == 4 ) {
* V_344 &= ~ ( T_9 ) 7 ;
* V_424 = 8 ;
V_84 = F_326 ( V_37 -> V_11 , * V_344 , & V_425 , 8 ) ;
if ( V_84 )
V_425 = 0 ;
...
static bool F_327 ( struct V_51 * V_52 )
{
if ( V_52 -> V_94 . V_44 == V_45 )
return false ;
return ++ V_52 -> V_202 >= 3 ;
}
static bool F_328 ( struct V_51 * V_52 , T_9 V_344 ,
int V_424 )
{
unsigned V_426 , V_427 , V_428 ;
F_213 ( L_25 ,
V_344 , V_424 , V_52 -> V_94 . V_214 ) ;
V_426 = F_329 ( V_344 ) ;
V_427 = V_52 -> V_94 . V_189 ? 8 : 4 ;
...
static T_1 * F_330 ( struct V_51 * V_52 , T_9 V_344 , int * V_429 )
{
unsigned V_430 , V_206 ;
T_1 * V_10 ;
int V_44 ;
V_430 = F_329 ( V_344 ) ;
V_44 = V_52 -> V_94 . V_44 ;
...
V_10 = & V_52 -> V_131 [ V_430 / sizeof( * V_10 ) ] ;
return V_10 ;
}
void F_331 ( struct V_36 * V_37 , T_9 V_344 ,
const T_8 * V_416 , int V_424 )
{
T_2 V_15 = V_344 >> V_19 ;
...
F_213 ( L_26 , V_162 , V_344 , V_424 ) ;
V_425 = F_325 ( V_37 , & V_344 , V_416 , & V_424 ) ;
F_69 ( V_37 ) ;
F_210 ( & V_37 -> V_11 -> V_200 ) ;
++ V_37 -> V_11 -> V_135 . V_433 ;
F_168 ( V_37 , V_434 ) ;
V_4 . V_406 = V_4 . V_189 = V_4 . V_405 = 1 ;
F_172 (vcpu->kvm, sp, gfn) {
if ( F_328 ( V_52 , V_344 , V_424 ) ||
F_327 ( V_52 ) ) {
V_421 |= ! ! F_163 ( V_37 -> V_11 , V_52 ,
& V_187 ) ;
++ V_37 -> V_11 -> V_135 . V_435 ;
continue;
}
V_10 = F_330 ( V_52 , V_344 , & V_432 ) ;
if ( ! V_10 )
continue;
V_423 = true ;
while ( V_432 -- ) {
...
& V_4 . V_214 ) && F_99 ( V_37 ) )
F_322 ( V_37 , V_52 , V_10 , & V_425 ) ;
if ( F_323 ( V_431 , * V_10 ) )
V_422 = true ;
++ V_10 ;
}
}
F_324 ( V_37 , V_421 , V_422 , V_423 ) ;
F_167 ( V_37 -> V_11 , & V_187 ) ;
F_168 ( V_37 , V_436 ) ;
F_211 ( & V_37 -> V_11 -> V_200 ) ;
}
int F_332 ( struct V_36 * V_37 , T_7 V_175 )
{
T_9 V_344 ;
int V_84 ;
if ( V_37 -> V_38 . V_190 . V_209 )
return 0 ;
V_344 = F_333 ( V_37 , V_175 , NULL ) ;
...
{
F_166 ( V_187 ) ;
if ( F_18 ( F_334 ( V_37 -> V_11 ) >= V_437 ) )
return;
while ( F_334 ( V_37 -> V_11 ) < V_438 ) {
if ( ! F_207 ( V_37 -> V_11 , & V_187 ) )
break;
++ V_37 -> V_11 -> V_135 . V_439 ;
}
F_167 ( V_37 -> V_11 , & V_187 ) ;
}
static bool F_335 ( struct V_36 * V_37 , T_7 V_220 )
{
if ( V_37 -> V_38 . V_190 . V_209 || F_318 ( V_37 ) )
return F_272 ( V_37 , V_220 ) ;
return F_273 ( V_37 , V_220 ) ;
}
int F_336 ( struct V_36 * V_37 , T_7 V_440 , T_4 V_304 ,
void * V_441 , int V_442 )
{
int V_84 , V_443 = V_444 ;
enum V_445 V_446 ;
V_84 = V_37 -> V_38 . V_190 . V_347 ( V_37 , V_440 , V_304 , false ) ;
if ( V_84 < 0 )
goto V_88;
if ( ! V_84 ) {
V_84 = 1 ;
...
if ( F_335 ( V_37 , V_440 ) )
V_443 = 0 ;
V_446 = F_337 ( V_37 , V_440 , V_443 , V_441 , V_442 ) ;
switch ( V_446 ) {
case V_447 :
return 1 ;
case V_448 :
...
void F_338 ( struct V_36 * V_37 , T_7 V_175 )
{
...
static void F_341 ( struct V_36 * V_37 )
{
F_68 ( ( unsigned long ) V_37 -> V_38 . V_190 . V_225 ) ;
if ( V_37 -> V_38 . V_190 . V_322 != NULL )
F_68 ( ( unsigned long ) V_37 -> V_38 . V_190 . V_322 ) ;
}
static int F_342 ( struct V_36 * V_37 )
{
struct V_83 * V_83 ;
int V_105 ;
ASSERT ( V_37 ) ;
V_83 = F_343 ( V_80 | V_451 ) ;
if ( ! V_83 )
return - V_81 ;
V_37 -> V_38 . V_190 . V_225 = F_344 ( V_83 ) ;
for ( V_105 = 0 ; V_105 < 4 ; ++ V_105 )
V_37 -> V_38 . V_190 . V_225 [ V_105 ] = V_313 ;
return 0 ;
}
int F_345 ( struct V_36 * V_37 )
{
ASSERT ( V_37 ) ;
V_37 -> V_38 . V_398 = & V_37 -> V_38 . V_190 ;
V_37 -> V_38 . V_190 . V_222 = V_313 ;
V_37 -> V_38 . V_190 . V_329 = V_329 ;
V_37 -> V_38 . V_328 . V_329 = V_452 ;
return F_342 ( V_37 ) ;
}
void F_346 ( struct V_36 * V_37 )
{
ASSERT ( V_37 ) ;
ASSERT ( ! F_232 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
F_317 ( V_37 ) ;
}
void F_347 ( struct V_11 * V_11 , int V_100 )
{
struct V_99 * V_150 ;
T_2 V_453 ;
int V_105 ;
V_150 = F_348 ( V_11 -> V_454 , V_100 ) ;
V_453 = V_150 -> V_102 + V_150 -> V_156 - 1 ;
F_210 ( & V_11 -> V_200 ) ;
for ( V_105 = V_45 ;
V_105 < V_45 + V_107 ; ++ V_105 ) {
unsigned long * V_130 ;
unsigned long V_455 , V_93 ;
V_130 = V_150 -> V_38 . V_129 [ V_105 - V_45 ] ;
V_455 = F_78 ( V_453 , V_150 -> V_102 , V_105 ) ;
for ( V_93 = 0 ; V_93 <= V_455 ; ++ V_93 , ++ V_130 ) {
if ( * V_130 )
F_109 ( V_11 , V_130 , false ) ;
if ( F_349 () || F_350 ( & V_11 -> V_200 ) )
F_178 ( & V_11 -> V_200 ) ;
}
}
F_211 ( & V_11 -> V_200 ) ;
...
static void F_352 ( struct V_11 * V_11 )
{
struct V_51 * V_52 , * V_457 ;
int V_458 = 0 ;
V_459:
F_353 (sp, node,
...
F_167 ( V_11 , & V_11 -> V_38 . V_461 ) ;
}
void F_354 ( struct V_11 * V_11 )
{
F_210 ( & V_11 -> V_200 ) ;
F_355 ( V_11 ) ;
V_11 -> V_38 . V_203 ++ ;
...
static bool F_356 ( struct V_11 * V_11 )
{
return F_14 ( ! F_357 ( & V_11 -> V_38 . V_461 ) ) ;
}
void F_358 ( struct V_11 * V_11 )
{
...
F_360 ( struct V_463 * V_464 , struct V_465 * V_466 )
{
struct V_11 * V_11 ;
...
V_471:
F_211 ( & V_11 -> V_200 ) ;
F_363 ( & V_11 -> V_470 , V_101 ) ;
F_364 ( & V_11 -> V_472 , & V_472 ) ;
break;
}
F_211 ( & V_469 ) ;
return V_468 ;
...
static unsigned long
F_365 ( struct V_463 * V_464 , struct V_465 * V_466 )
{
return F_366 ( & V_165 ) ;
}
...
unsigned int F_373 ( struct V_11 * V_11 )
{
unsigned int V_475 ;
...
int F_374 ( struct V_36 * V_37 , T_1 V_220 , T_1 V_122 [ 4 ] )
{
struct V_218 V_219 ;
T_1 V_10 ;
int V_479 = 0 ;
