...
T_4 V_159 , unsigned V_31 , unsigned V_177 ,
struct V_2 * V_2 , void * V_176 )
{
struct V_6 * V_6 = F_28 ( V_25 ) ;
struct V_75 * V_76 = F_29 ( V_6 ) ;
struct V_160 * V_161 = V_76 -> V_161 ;
unsigned V_178 = V_159 & ( V_23 - 1 ) ;
int V_179 = 0 ;
F_7 ( L_61 , V_25 ,
V_6 , V_2 , ( int ) V_159 , ( int ) V_177 , ( int ) V_31 ) ;
if ( V_177 < V_31 )
F_36 ( V_2 , V_178 + V_177 , V_31 ) ;
if ( V_159 + V_177 > V_6 -> V_165 )
V_179 = F_117 ( V_6 , V_159 + V_177 ) ;
if ( ! F_87 ( V_2 ) )
F_38 ( V_2 ) ;
F_118 ( V_2 ) ;
F_41 ( V_2 ) ;
...
F_46 ( V_2 ) ;
if ( V_179 )
F_119 ( F_9 ( V_6 ) , V_180 , NULL ) ;
return V_177 ;
}
static T_7 F_120 ( int V_181 , struct V_182 * V_183 ,
struct V_184 * V_185 ,
T_4 V_159 )
{
F_16 ( 1 ) ;
...
static int F_121 ( struct V_186 * V_187 , struct V_188 * V_189 )
{
struct V_6 * V_6 = F_28 ( V_187 -> V_190 ) ;
struct V_7 * V_8 = F_9 ( V_6 ) ;
struct V_191 * V_192 = V_187 -> V_190 -> V_193 ;
T_4 V_63 = V_189 -> V_194 << V_66 ;
int V_148 , V_195 , V_10 ;
F_7 ( L_62 ,
V_6 , F_122 ( V_6 ) , V_63 , ( V_196 ) V_23 ) ;
...
while ( 1 ) {
V_195 = 0 ;
V_10 = F_123 ( V_8 , V_199 , V_148 , & V_195 , - 1 ) ;
if ( V_10 == 0 )
break;
if ( V_10 != - V_169 ) {
F_16 ( 1 ) ;
...
F_7 ( L_63 ,
V_6 , V_63 , ( V_196 ) V_23 , F_124 ( V_195 ) ) ;
V_10 = F_125 ( V_187 , V_189 ) ;
F_7 ( L_64 ,
V_6 , V_63 , ( V_196 ) V_23 , F_124 ( V_195 ) , V_10 ) ;
F_126 ( V_8 , V_195 ) ;
return V_10 ;
}
static int F_127 ( struct V_186 * V_187 , struct V_188 * V_189 )
{
struct V_6 * V_6 = F_28 ( V_187 -> V_190 ) ;
struct V_7 * V_8 = F_9 ( V_6 ) ;
struct V_191 * V_192 = V_187 -> V_190 -> V_193 ;
...
while ( 1 ) {
V_195 = 0 ;
V_10 = F_123 ( V_8 , V_201 , V_148 , & V_195 , V_63 + V_31 ) ;
if ( V_10 == 0 )
break;
if ( V_10 != - V_169 ) {
F_16 ( 1 ) ;
...
( V_2 -> V_5 != V_6 -> V_108 ) )
goto V_32;
V_10 = F_108 ( V_187 -> V_190 , V_63 , V_31 , V_2 ) ;
if ( V_10 == 0 ) {
F_118 ( V_2 ) ;
F_110 ( & V_161 -> V_167 ) ;
V_10 = V_203 ;
...
int V_205 ;
F_11 ( & V_8 -> V_15 ) ;
V_205 = F_129 ( V_8 , V_201 ) ;
F_13 ( & V_8 -> V_15 ) ;
if ( V_205 )
F_130 ( V_6 , V_205 ) ;
}
F_7 ( L_67 ,
V_6 , V_63 , V_31 , F_124 ( V_195 ) , V_10 ) ;
F_126 ( V_8 , V_195 ) ;
return V_10 ;
}
int F_131 ( struct V_25 * V_25 , struct V_186 * V_187 )
{
struct V_4 * V_5 = V_25 -> V_206 ;
if ( ! V_5 -> V_207 -> V_208 )
return - V_209 ;
F_132 ( V_25 ) ;
V_187 -> V_210 = & V_211 ;
