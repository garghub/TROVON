...
static int F_17 ( struct V_106 * V_107 ,
...
static void F_25 ( struct V_112 * V_7 )
{
struct V_106 * V_113 = V_7 -> V_106 ;
struct V_14 * V_15 = F_19 ( V_113 ) ;
struct V_6 * V_114 =
...
F_8 ( & V_15 -> V_77 , V_78 , V_160 , V_15 -> V_158 ) ;
F_7 ( V_15 , NULL , 0 ) ;
return 0 ;
}
...
{
struct V_14 * V_15 = F_10 ( V_80 ) ;
return F_8 ( & V_15 -> V_77 , V_78 , V_161 , V_158 ) ;
}
static int F_44 ( struct V_80 * V_80 , void * V_81 ,
struct V_162 * V_163 )
{
struct V_14 * V_15 = F_10 ( V_80 ) ;
if ( V_163 -> V_101 >= V_15 -> V_22 -> V_164 )
return - V_52 ;
strncpy ( V_163 -> V_86 , V_15 -> V_22 -> V_165 [ V_163 -> V_101 ] . V_86 ,
sizeof( V_163 -> V_86 ) ) ;
if ( ( V_15 -> V_22 -> V_94 & V_95 ) &&
V_163 -> V_101 == 0 )
V_163 -> type = V_166 ;
...
V_163 -> type = V_167 ;
if ( V_15 -> V_22 -> V_92 )
V_163 -> V_168 = ( 1 << V_15 -> V_22 -> V_92 ) - 1 ;
else
V_163 -> V_168 = 0 ;
V_163 -> V_169 = 0 ;
if ( V_15 -> V_22 -> V_53 & V_170 )
V_163 -> V_158 = F_45 ( V_80 ) -> V_171 ;
else
V_163 -> V_158 = 0 ;
return 0 ;
}
static int F_46 ( struct V_80 * V_80 , void * V_81 , unsigned int * V_172 )
{
struct V_14 * V_15 = F_10 ( V_80 ) ;
* V_172 = V_15 -> V_172 ;
return 0 ;
}
static int F_47 ( struct V_80 * V_80 , void * V_173 , struct V_174 * V_175 )
{
struct V_14 * V_15 = F_10 ( V_80 ) ;
if ( V_175 -> V_101 >= V_15 -> V_22 -> V_92 )
return - V_52 ;
F_11 ( V_175 -> V_86 , V_15 -> V_22 -> V_176 [ V_175 -> V_101 ] . V_86 ,
sizeof( V_175 -> V_86 ) ) ;
V_175 -> V_146 = V_177 ;
return 0 ;
}
static int F_48 ( struct V_80 * V_80 , void * V_173 , struct V_174 * V_175 )
{
struct V_14 * V_15 = F_10 ( V_80 ) ;
V_175 -> V_101 = V_15 -> V_178 ;
F_11 ( V_175 -> V_86 , V_15 -> V_22 -> V_176 [ V_15 -> V_178 ] . V_86 ,
sizeof( V_175 -> V_86 ) ) ;
V_175 -> V_146 = V_177 ;
return 0 ;
}
static int F_49 ( struct V_80 * V_80 , void * V_173 ,
const struct V_174 * V_175 )
{
struct V_14 * V_15 = F_10 ( V_80 ) ;
if ( V_175 -> V_101 >= V_15 -> V_22 -> V_92 )
return - V_52 ;
V_15 -> V_178 = V_175 -> V_101 ;
...
static int F_52 ( struct V_80 * V_80 , void * V_81 , unsigned int V_172 )
{
struct V_14 * V_15 = F_10 ( V_80 ) ;
...
if ( V_188 -> V_101 != 0 )
return - V_52 ;
F_11 ( V_188 -> V_86 , L_6 , sizeof( V_188 -> V_86 ) ) ;
return F_8 ( & V_15 -> V_77 , V_169 , V_189 , V_188 ) ;
}
...
if ( V_188 -> V_101 != 0 )
return - V_52 ;
return F_8 ( & V_15 -> V_77 , V_169 , V_190 , V_188 ) ;
}
...
if ( V_192 -> V_169 )
return - V_52 ;
return F_8 ( & V_15 -> V_77 , V_169 , V_193 , V_192 ) ;
}
...
if ( V_192 -> V_169 )
return - V_52 ;
return F_8 ( & V_15 -> V_77 , V_169 , V_194 , V_192 ) ;
}
static int F_57 ( struct V_80 * V_80 , void * V_81 )
{
struct V_14 * V_15 = F_10 ( V_80 ) ;
F_58 ( V_80 , V_81 ) ;
return F_8 ( & V_15 -> V_77 , V_195 , V_196 ) ;
}
...
F_8 ( & V_15 -> V_77 , V_169 , V_194 , & V_192 ) ;
}
if ( ! ( V_15 -> V_22 -> V_53 & V_170 ) ) {
F_70 ( V_214 , V_240 ) ;
F_70 ( V_214 , V_241 ) ;
