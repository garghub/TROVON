...
void F_14 ( struct V_1 * * V_5 , int V_3 )
{
int V_16 ;
for ( V_16 = 0 ; V_16 < V_3 ; V_16 ++ )
F_15 ( V_5 [ V_16 ] , 0 ) ;
...
struct V_1 * * F_16 ( int V_3 , T_2 V_17 )
{
struct V_1 * * V_5 ;
int V_16 ;
...
int V_23 , V_24 ;
while ( V_22 > 0 ) {
V_23 = F_19 ( int , V_25 - V_20 , V_22 ) ;
V_24 = F_20 ( F_21 ( V_5 [ V_16 ] ) + V_20 , V_2 , V_23 ) ;
if ( V_24 == V_23 )
return - V_26 ;
V_2 += V_23 - V_24 ;
V_22 -= V_23 - V_24 ;
...
T_4 V_22 = V_19 ;
while ( V_22 > 0 ) {
T_4 V_23 = F_19 ( T_4 , V_25 - V_20 , V_22 ) ;
memcpy ( F_21 ( V_5 [ V_16 ] ) + V_20 , V_2 , V_23 ) ;
V_2 += V_23 ;
V_22 -= V_23 ;
V_20 += V_23 ;
if ( V_20 == V_25 ) {
...
while ( V_22 > 0 ) {
T_4 V_23 = F_19 ( T_4 , V_25 - V_20 , V_22 ) ;
memcpy ( V_2 , F_21 ( V_5 [ V_16 ] ) + V_20 , V_23 ) ;
V_2 += V_23 ;
V_22 -= V_23 ;
V_20 += V_23 ;
if ( V_20 == V_25 ) {
