...
static int F_58 ( struct V_17 * V_23 , char * V_74 , int V_77 , T_1 V_78 ,
T_1 V_79 )
{
char V_80 [ 27 ] ;
...
struct V_39 * V_40 ;
int V_82 ;
V_82 = F_59 ( V_74 , V_77 , L_14 , V_23 -> V_4 , V_23 -> V_5 ) ;
if ( V_78 == 2 ) {
V_82 += F_59 ( V_74 - V_82 , V_77 + V_82 , L_15 ) ;
return V_82 ;
}
V_40 = V_23 -> V_40 ;
F_19 (publ, &info->zone_list, zone_list) {
...
V_82 += F_59 ( V_74 + V_82 , V_77 - V_82 , L_17 , V_80 ) ;
if ( V_78 > 3 ) {
V_82 += F_59 ( V_74 + V_82 , V_77 - V_82 , L_18 ,
V_10 -> V_9 , V_81 [ V_10 -> V_6 ] ) ;
}
if ( ! F_63 ( & V_10 -> V_46 , & V_40 -> V_46 ) )
V_82 += F_59 ( V_74 + V_82 , V_77 - V_82 ,
L_19 , L_20 ) ;
}
V_82 += F_59 ( V_74 + V_82 , V_77 - V_82 , L_15 ) ;
return V_82 ;
...
if ( V_78 == 1 ) {
V_82 += F_59 ( V_74 , V_77 , L_22 , V_85 ) ;
return V_82 ;
}
for ( V_23 = V_29 -> V_25 ; V_23 != & V_29 -> V_25 [ V_29 -> V_30 ] ; V_23 ++ ) {
if ( ( V_83 <= V_23 -> V_5 ) && ( V_84 >= V_23 -> V_4 ) ) {
V_82 += F_59 ( V_74 + V_82 , V_77 - V_82 , L_23 ,
V_85 ) ;
F_38 ( & V_29 -> V_24 ) ;
V_82 += F_58 ( V_23 , V_74 + V_82 , V_77 - V_82 ,
V_78 , V_79 ) ;
F_43 ( & V_29 -> V_24 ) ;
...
static int F_64 ( char * V_74 , int V_77 , T_1 V_78 )
{
const char * V_86 [] = {
L_25 ,
L_26 ,
...
V_82 += F_59 ( V_74 + V_82 , V_77 - V_82 , V_86 [ V_87 ] ) ;
V_82 += F_59 ( V_74 + V_82 , V_77 - V_82 , L_15 ) ;
return V_82 ;
}
static int F_65 ( char * V_74 , int V_77 , T_1 V_88 ,
...
V_82 += F_64 ( V_74 + V_82 , V_77 - V_82 , V_78 ) ;
V_87 = F_1 ( type ) ;
V_21 = & V_59 . V_60 [ V_87 ] ;
F_30 (seq, seq_head, ns_list) {
if ( V_29 -> type == type ) {
...
struct V_73 * F_66 ( const void * V_91 , int V_92 )
{
struct V_73 * V_74 ;
struct V_93 * V_94 ;
struct V_95 * V_96 ;
...
int V_98 ;
int V_99 ;
if ( ! F_67 ( V_91 , V_92 , V_100 ) )
return F_68 ( V_101 ) ;
V_74 = F_69 ( F_70 ( V_102 ) ) ;
if ( ! V_74 )
return NULL ;
V_96 = (struct V_95 * ) V_74 -> V_103 ;
V_97 = F_71 ( V_96 ) ;
V_98 = V_102 ;
V_94 = (struct V_93 * ) F_71 ( V_91 ) ;
F_36 ( & V_65 ) ;
V_99 = F_65 ( V_97 , V_98 , F_72 ( V_94 -> V_78 ) ,
F_72 ( V_94 -> type ) ,
F_72 ( V_94 -> V_83 ) , F_72 ( V_94 -> V_84 ) ) ;
F_44 ( & V_65 ) ;
V_99 += 1 ;
F_73 ( V_74 , F_70 ( V_99 ) ) ;
F_74 ( V_96 , V_104 , NULL , V_99 ) ;
return V_74 ;
}
int F_75 ( void )
{
...
static void F_76 ( struct V_19 * V_29 )
{
...
F_48 ( & V_65 ) ;
for ( V_87 = 0 ; V_87 < V_2 ; V_87 ++ ) {
if ( F_78 ( & V_59 . V_60 [ V_87 ] ) )
continue;
V_21 = & V_59 . V_60 [ V_87 ] ;
F_79 (seq, safe, seq_head, ns_list) {
F_76 ( V_29 ) ;
}
}
F_9 ( V_59 . V_60 ) ;
