...
if ( ! V_2 -> V_88 )
return NULL ;
V_73 = F_34 ( V_93 * sizeof( * V_73 ) , V_51 ) ;
if ( ! V_73 )
return NULL ;
V_87 = ( T_5 ) F_22 ( & V_59 ,
V_90 ) ;
...
void F_56 ( struct V_110 * V_111 )
{
struct V_1 * V_2 = F_57 ( V_111 ) ;
F_52 ( V_2 ) ;
}
...
int F_67 ( struct V_117 * V_118 , void * V_119 )
{
...
if ( ! V_122 )
goto V_50;
F_69 ( V_118 , L_17 , V_111 -> V_127 ) ;
F_69 ( V_118 , L_18 , L_19 ,
L_20 , L_21 , L_22 ) ;
for ( V_18 = 0 ; V_18 < V_19 -> V_20 ; V_18 ++ ) {
V_17 = & V_19 -> V_21 [ V_18 ] ;
F_25 () ;
...
T_3 * V_129 , * V_130 ;
T_4 type = 0 ;
if ( F_37 ( ! F_73 ( V_33 , V_34 + V_37 ) ) )
goto V_50;
V_128 = (struct V_128 * ) ( V_33 -> V_36 + V_34 ) ;
if ( V_128 -> V_131 != F_74 ( V_132 ) )
goto V_50;
if ( F_37 ( ! F_73 ( V_33 , V_34 + V_37 +
F_75 ( V_33 -> V_133 ) ) ) )
goto V_50;
V_38 = (struct V_38 * ) ( V_33 -> V_36 + V_34 + V_37 ) ;
if ( V_38 -> V_134 != F_74 ( V_135 ) )
goto V_50;
if ( V_38 -> V_136 != F_74 ( V_137 ) )
goto V_50;
if ( V_38 -> V_138 != V_39 )
goto V_50;
if ( V_38 -> V_139 != 4 )
...
V_58 = F_19 ( V_33 , V_34 ) ;
V_59 = F_21 ( V_33 , V_34 ) ;
if ( F_76 ( V_58 ) || F_77 ( V_58 ) ||
F_76 ( V_59 ) || F_77 ( V_59 ) ||
F_78 ( V_58 ) || F_79 ( V_58 ) ||
F_78 ( V_59 ) || F_79 ( V_59 ) )
goto V_50;
V_129 = F_18 ( V_33 , V_34 ) ;
if ( F_80 ( V_129 ) || F_81 ( V_129 ) )
goto V_50;
if ( V_38 -> V_140 != F_74 ( V_141 ) ) {
V_130 = F_20 ( V_33 , V_34 ) ;
if ( F_80 ( V_130 ) ||
F_81 ( V_130 ) )
goto V_50;
}
type = F_82 ( V_38 -> V_140 ) ;
V_50:
return type ;
}
...
if ( V_8 ) {
if ( F_86 ( V_2 , V_8 -> V_46 , V_41 ) ) {
V_81 = true ;
goto V_50;
}
V_144 = F_87 ( V_145 , V_132 , V_58 ,
V_2 -> V_146 , V_59 , V_129 ,
V_8 -> V_46 , V_129 ) ;
if ( ! V_144 )
goto V_50;
if ( V_41 & V_142 )
V_144 = F_88 ( V_144 , F_74 ( V_147 ) ,
V_41 & V_148 ) ;
F_89 ( V_144 ) ;
V_144 -> V_149 = F_90 ( V_144 ,
V_2 -> V_146 ) ;
V_2 -> V_150 . V_151 ++ ;
...
V_155 = F_93 ( V_2 , V_144 ,
V_68 ,
NULL , V_41 ) ;
else
V_155 = F_94 ( V_2 , V_144 , NULL , V_41 ) ;
if ( V_155 != V_156 ) {
F_49 ( V_2 , V_157 ) ;
V_81 = true ;
}
...
F_43 ( V_2 , V_33 , V_58 , V_66 ) ;
F_43 ( V_2 , V_33 , V_59 , V_66 ) ;
}
...
if ( V_159 -> V_160 )
goto V_50;
V_41 = F_83 ( V_159 -> V_33 , & V_34 ) ;
type = F_72 ( V_2 , V_159 -> V_33 , V_34 ) ;
if ( type != V_141 )
goto V_50;
