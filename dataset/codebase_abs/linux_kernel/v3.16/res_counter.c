...
struct V_1 * * V_15 )
{
return F_6 ( V_2 , V_8 , V_15 , false ) ;
}
int F_12 ( struct V_1 * V_2 , unsigned long V_8 ,
struct V_1 * * V_15 )
{
return F_6 ( V_2 , V_8 , V_15 , true ) ;
}
...
T_1 F_14 ( struct V_1 * V_2 , unsigned long V_8 )
{
return F_13 ( V_2 , NULL , V_8 ) ;
}
...
T_2 F_17 ( struct V_1 * V_2 , int V_21 ,
...
return F_19 ( ( void T_3 * ) V_27 , V_28 ,
V_29 , V_31 , V_32 - V_31 ) ;
}
T_1 F_20 ( struct V_1 * V_2 , int V_21 )
{
unsigned long V_17 ;
T_1 V_11 ;
F_21 ( & V_2 -> V_4 , V_17 ) ;
