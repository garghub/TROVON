...
static T_1 F_23 ( struct V_5 * V_6 ,
struct V_7 * V_8 , char * V_9 )
{
...
struct V_10 * V_11 ;
int V_12 ;
V_11 = F_25 ( & V_29 -> V_6 , sizeof( struct V_10 ) ,
V_30 ) ;
if ( ! V_11 )
return - V_31 ;
F_26 ( & V_11 -> V_14 ) ;
V_11 -> V_2 = F_9 ( V_29 -> V_6 . V_32 ) ;
F_27 ( V_29 , V_11 ) ;
V_12 = F_28 ( & V_29 -> V_6 . V_33 , & V_34 ) ;
if ( V_12 )
goto V_35;
V_11 -> V_36 = F_29 ( & V_29 -> V_6 ) ;
if ( F_30 ( V_11 -> V_36 ) ) {
V_12 = F_31 ( V_11 -> V_36 ) ;
goto V_37;
}
return 0 ;
V_37:
F_32 ( & V_29 -> V_6 . V_33 , & V_34 ) ;
V_35:
return V_12 ;
}
static int F_33 ( struct V_28 * V_29 )
{
struct V_10 * V_11 = F_34 ( V_29 ) ;
F_35 ( V_11 -> V_36 ) ;
F_32 ( & V_29 -> V_6 . V_33 , & V_34 ) ;
return 0 ;
}
