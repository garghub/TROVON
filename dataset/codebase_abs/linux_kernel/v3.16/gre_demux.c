...
bool * V_30 )
{
unsigned int V_31 = F_13 ( V_10 ) ;
const struct V_14 * V_15 ;
T_2 * V_32 ;
int V_13 ;
if ( F_14 ( ! F_15 ( V_10 , sizeof( struct V_14 ) ) ) )
return - V_5 ;
V_15 = (struct V_14 * ) ( F_16 ( V_10 ) + V_31 ) ;
if ( F_14 ( V_15 -> V_17 & ( V_33 | V_34 ) ) )
return - V_5 ;
V_12 -> V_17 = F_17 ( V_15 -> V_17 ) ;
V_13 = F_18 ( V_12 -> V_17 ) ;
if ( ! F_15 ( V_10 , V_13 ) )
return - V_5 ;
V_15 = (struct V_14 * ) ( F_16 ( V_10 ) + V_31 ) ;
...
V_12 -> V_24 = 0 ;
if ( F_14 ( V_15 -> V_17 & V_37 ) ) {
V_12 -> V_23 = * V_32 ;
V_32 ++ ;
} else
V_12 -> V_23 = 0 ;
if ( V_15 -> V_17 == 0 && V_12 -> V_2 == F_20 ( V_38 ) ) {
V_12 -> V_2 = F_20 ( V_39 ) ;
if ( ( * ( T_1 * ) V_32 & 0xF0 ) != 0x40 ) {
V_13 += 4 ;
if ( ! F_15 ( V_10 , V_13 ) )
return - V_5 ;
}
...
F_30 () ;
F_31 ( V_10 , V_48 , V_49 , 0 ) ;
V_42:
F_32 ( V_10 ) ;
return 0 ;
}
static void F_33 ( struct V_9 * V_10 , T_3 V_50 )
{
const int type = F_34 ( V_10 ) -> type ;
const int V_51 = F_34 ( V_10 ) -> V_51 ;
struct V_11 V_12 ;
bool V_30 = false ;
int V_40 ;
...
if ( type == V_48 && V_51 == V_52 ) {
F_35 ( V_10 , F_36 ( V_10 -> V_53 ) , V_50 ,
V_10 -> V_53 -> V_54 , 0 , V_55 , 0 ) ;
return;
}
if ( type == V_56 ) {
F_37 ( V_10 , F_36 ( V_10 -> V_53 ) , V_10 -> V_53 -> V_54 , 0 ,
V_55 , 0 ) ;
return;
}
F_28 () ;
...
if ( ! V_2 )
continue;
if ( V_2 -> V_57 ( V_10 , V_50 , & V_12 ) == V_47 )
goto V_58;
}
V_58:
F_30 () ;
...
static void F_39 ( struct V_9 * V_10 , T_3 V_50 )
{
const struct V_1 * V_2 ;
...
int F_40 ( struct V_44 * V_65 )
{
struct V_44 * * V_2 = (struct V_44 * * )
& V_45 [ V_65 -> V_66 ] ;
return ( F_2 ( V_2 , NULL , V_65 ) == NULL ) ? 0 : - V_7 ;
}
int F_41 ( struct V_44 * V_67 )
{
struct V_44 * * V_2 = (struct V_44 * * )
& V_45 [ V_67 -> V_66 ] ;
int V_8 ;
