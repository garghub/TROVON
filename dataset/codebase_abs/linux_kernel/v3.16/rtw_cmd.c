...
T_2 F_95 ( struct V_57 * V_42 , T_2 V_286 )
{
struct V_35 * V_276 ;
struct V_287 * V_288 ;
struct V_1 * V_2 = & V_42 -> V_68 ;
...
V_288 -> V_286 = V_286 ;
F_47 ( V_276 , V_288 , F_29 ( V_289 ) ) ;
V_3 = F_30 ( V_2 , V_276 ) ;
exit:
return V_3 ;
}
T_2 F_96 ( struct V_57 * V_42 , T_2 * V_241 , T_2 V_290 )
{
return V_4 ;
}
static void F_97 ( struct V_57 * V_42 )
{
T_2 V_291 ;
T_2 V_292 = false , V_293 = false , V_294 = false ;
T_2 V_295 = false , V_296 = false , V_297 = false ;
struct V_96 * V_97 = & ( V_42 -> V_98 ) ;
if ( F_49 ( V_97 , V_99 ) ) {
if ( V_97 -> V_298 . V_299 > 100 ||
V_97 -> V_298 . V_300 > 100 ) {
V_292 = true ;
if ( V_97 -> V_298 . V_299 > V_97 -> V_298 . V_300 )
V_294 = true ;
else
V_293 = true ;
}
if ( V_97 -> V_298 . V_299 > 4000 ||
V_97 -> V_298 . V_300 > 4000 ) {
V_295 = true ;
if ( V_97 -> V_298 . V_299 > V_97 -> V_298 . V_300 )
V_296 = true ;
else
...
if ( ( ( V_97 -> V_298 . V_301 + V_97 -> V_298 . V_300 ) > 8 ) ||
( V_97 -> V_298 . V_301 > 2 ) )
V_291 = false ;
else
V_291 = true ;
...
V_97 -> V_298 . V_300 = 0 ;
V_97 -> V_298 . V_301 = 0 ;
V_97 -> V_298 . V_292 = V_292 ;
V_97 -> V_298 . V_293 = V_293 ;
V_97 -> V_298 . V_294 = V_294 ;
V_97 -> V_298 . V_295 = V_295 ;
V_97 -> V_298 . V_296 = V_296 ;
V_97 -> V_298 . V_297 = V_297 ;
}
static void F_100 ( struct V_57 * V_42 , T_2 * V_66 , int V_165 )
{
struct V_96 * V_97 ;
V_42 = (struct V_57 * ) V_66 ;
V_97 = & ( V_42 -> V_98 ) ;
#ifdef F_101
if ( F_49 ( V_97 , V_302 ) == true )
F_102 ( V_42 ) ;
#endif
F_103 ( V_42 ) ;
F_104 ( V_42 ) ;
...
static void F_106 ( struct V_57 * V_42 , T_2 V_303 )
{
struct V_304 * V_305 = & V_42 -> V_43 ;
struct V_96 * V_97 = & ( V_42 -> V_98 ) ;
T_2 V_306 ;
...
T_2 F_50 ( struct V_57 * V_42 , T_2 V_303 , T_2 V_221 )
{
struct V_35 * V_83 ;
struct V_49 * V_50 ;
struct V_1 * V_2 = & V_42 -> V_68 ;
...
static void F_108 ( struct V_57 * V_42 , T_4 V_317 )
{
F_107 ( V_42 , V_318 , ( T_2 * ) ( & V_317 ) ) ;
}
T_2 F_109 ( struct V_57 * V_42 , T_4 V_317 )
{
struct V_35 * V_83 ;
struct V_49 * V_50 ;
struct V_1 * V_2 = & V_42 -> V_68 ;
...
static void F_110 ( struct V_57 * V_42 , T_2 V_320 )
{
F_107 ( V_42 , V_321 , ( T_2 * ) ( & V_320 ) ) ;
}
T_2 F_111 ( struct V_57 * V_42 , T_2 V_320 , T_2 V_221 )
{
struct V_35 * V_83 ;
struct V_49 * V_50 ;
struct V_1 * V_2 = & V_42 -> V_68 ;
...
static void F_113 ( struct V_57 * V_42 , T_2 * V_66 , int V_165 )
{
F_114 ( V_42 ) ;
}
T_2 F_115 ( struct V_57 * V_42 , int V_325 )
{
struct V_35 * V_83 ;
struct V_49 * V_50 ;
struct V_326 * V_327 = & ( V_42 -> V_328 ) ;
struct V_1 * V_2 = & V_42 -> V_68 ;
T_2 V_3 = V_4 ;
if ( F_116 ( V_327 , V_329 ) )
return V_3 ;
V_83 = (struct V_35 * ) F_4 ( sizeof( struct V_35 ) ) ;
if ( V_83 == NULL ) {
V_3 = V_12 ;
...
T_2 F_117 ( struct V_57 * V_42 )
{
struct V_35 * V_331 ;
struct V_49 * V_50 ;
struct V_1 * V_2 = & V_42 -> V_68 ;
T_2 V_3 = V_4 ;
V_331 = (struct V_35 * ) F_4 ( sizeof( struct V_35 ) ) ;
if ( V_331 == NULL ) {
V_3 = V_12 ;
goto exit;
}
...
V_50 -> V_52 = V_53 ;
V_50 -> V_66 = NULL ;
F_47 ( V_331 , V_50 , F_29 ( V_48 ) ) ;
V_3 = F_30 ( V_2 , V_331 ) ;
exit:
return V_3 ;
}
static void F_118 ( struct V_57 * V_42 )
{
int V_332 = 0 ;
struct V_238 * V_333 ;
struct V_334 * V_335 = & V_42 -> V_336 ;
V_333 = F_119 ( V_42 ) ;
if ( ! V_333 )
return;
if ( V_333 -> V_337 == 0 ) {
T_2 V_136 = 0 ;
F_120 ( V_42 , V_338 , & V_136 ) ;
while ( ! V_136 ) {
F_12 ( 100 ) ;
V_332 ++ ;
if ( V_332 > 10 )
...
V_335 -> V_339 &= ~ F_121 ( 0 ) ;
V_335 -> V_340 &= ~ F_121 ( 0 ) ;
F_122 ( V_42 , V_341 , NULL , false ) ;
} else {
F_123 ( V_42 ) ;
}
}
}
T_2 F_123 ( struct V_57 * V_42 )
{
struct V_35 * V_83 ;
struct V_49 * V_50 ;
struct V_1 * V_2 = & V_42 -> V_68 ;
...
T_2 F_124 ( struct V_57 * V_42 , T_2 * V_343 )
{
struct V_35 * V_83 ;
struct V_49 * V_50 ;
struct V_1 * V_2 = & V_42 -> V_68 ;
...
static T_5 F_125 ( struct V_57 * V_57 , struct V_345 * V_343 , T_6 V_346 )
{
T_5 V_64 = V_12 ;
T_2 V_347 [ 16 ] ;
if ( ! V_343 ) {
if ( F_126 ( V_57 , V_347 ) == V_4 ) {
V_343 = (struct V_345 * ) V_347 ;
if ( V_346 && V_346 ( V_343 -> V_252 ) == false )
goto exit;
V_64 = F_127 ( V_57 , V_343 ) ;
}
} else {
if ( V_346 && V_346 ( V_343 -> V_252 ) == false )
goto exit;
...
static void V_26 ( struct V_348 * V_349 )
{
struct V_21 * V_350 = F_23 ( V_349 , struct V_21 , V_25 ) ;
struct V_57 * V_57 = F_23 ( V_350 , struct V_57 , V_350 ) ;
struct V_345 * V_343 ;
T_6 V_351 = F_128 ( V_57 ) ;
V_350 -> V_27 = true ;
while ( ! F_13 ( V_350 -> V_28 ) ) {
V_343 = (struct V_345 * )
F_14 ( V_350 -> V_28 ) ;
if ( V_343 != NULL )
F_129 ( V_57 ) ;
else {
V_343 = (struct V_345 * ) F_130 ( 16 ) ;
if ( V_343 != NULL &&
F_126 ( V_57 , ( T_2 * ) V_343 ) != V_4 )
continue;
}
if ( ( void * ) V_343 == ( void * ) V_350 )
continue;
if ( ! F_131 ( V_343 ) ) {
F_15 ( V_343 ) ;
continue;
}
if ( V_351 ( V_343 -> V_252 ) == true ) {
F_127 ( V_57 , V_343 ) ;
F_15 ( V_343 ) ;
} else {
#ifdef F_132
F_124 ( V_57 , ( T_2 * ) V_343 ) ;
#endif
}
}
V_350 -> V_27 = false ;
}
T_2 F_133 ( struct V_57 * V_42 , unsigned char * V_66 )
{
struct V_49 * V_352 ;
if ( ! V_66 )
return V_78 ;
V_352 = (struct V_49 * ) V_66 ;
switch ( V_352 -> V_52 ) {
case V_272 :
F_100 ( V_42 , V_352 -> V_66 , V_352 -> V_273 ) ;
break;
case V_53 :
F_113 ( V_42 , V_352 -> V_66 , V_352 -> V_273 ) ;
break;
case V_316 :
F_106 ( V_42 , ( T_2 ) V_352 -> V_273 ) ;
break;
case V_319 :
F_108 ( V_42 , V_352 -> V_273 ) ;
break;
case V_324 :
F_110 ( V_42 , V_352 -> V_273 ) ;
break;
#ifdef F_132
case V_353 :
F_134 ( V_42 , V_352 -> V_273 ) ;
break;
case V_330 :
F_135 ( V_42 , V_352 -> V_273 ) ;
break;
#endif
#ifdef F_101
case V_342 :
...
#endif
case V_344 :
F_125 ( V_42 , (struct V_345 * ) V_352 -> V_66 , NULL ) ;
break;
default:
break;
}
if ( V_352 -> V_66 && V_352 -> V_273 > 0 )
F_15 ( V_352 -> V_66 ) ;
return V_226 ;
}
void F_136 ( struct V_57 * V_42 , struct V_35 * V_58 )
{
struct V_96 * V_97 = & V_42 -> V_98 ;
if ( V_58 -> V_3 == V_73 ) {
F_54 ( & V_97 -> V_114 , 1 ) ;
...
void F_141 ( struct V_57 * V_42 , struct V_35 * V_58 )
{
struct V_96 * V_97 = & V_42 -> V_98 ;
if ( V_58 -> V_3 == V_73 ) {
F_54 ( & V_97 -> V_354 , 1 ) ;
...
struct V_167 * V_356 = NULL ;
struct V_96 * V_97 = & V_42 -> V_98 ;
struct V_157 * V_168 = (struct V_157 * ) V_58 -> V_51 ;
struct V_167 * V_357 = & ( V_97 -> V_358 ) ;
if ( V_58 -> V_3 != V_226 ) {
F_10 ( V_30 , V_81 , ( L_26 ) ) ;
F_54 ( & V_97 -> V_354 , 1 ) ;
}
F_143 ( & V_97 -> V_354 , & V_355 ) ;
F_138 ( & V_97 -> V_38 ) ;
if ( F_49 ( V_97 , V_302 ) ) {
V_232 = F_144 ( & V_42 -> V_336 , V_168 -> V_206 ) ;
if ( ! V_232 ) {
V_232 = F_145 ( & V_42 -> V_336 , V_168 -> V_206 ) ;
if ( V_232 == NULL ) {
F_10 ( V_30 , V_81 , ( L_27 ) ) ;
goto V_359;
}
...
V_356 = F_147 ( V_97 ) ;
F_138 ( & ( V_97 -> V_360 . V_38 ) ) ;
if ( V_356 == NULL ) {
V_356 = F_148 ( & V_97 -> V_360 ) ;
if ( V_356 == NULL ) {
F_10 ( V_30 , V_81 , ( L_28 ) ) ;
F_139 ( & V_97 -> V_360 . V_38 ) ;
goto V_359;
}
V_356 -> V_361 = V_113 ;
} else {
F_19 ( & ( V_356 -> V_39 ) , & V_97 -> V_360 . V_34 ) ;
}
V_168 -> V_163 = F_68 ( V_168 ) ;
memcpy ( & ( V_356 -> V_184 ) , V_168 , V_168 -> V_163 ) ;
memcpy ( & V_357 -> V_184 , V_168 , ( F_68 ( V_168 ) ) ) ;
F_56 ( V_97 , V_362 ) ;
F_139 ( & V_97 -> V_360 . V_38 ) ;
}
V_359:
...
void F_149 ( struct V_57 * V_42 , struct V_35 * V_58 )
{
struct V_334 * V_335 = & V_42 -> V_336 ;
struct V_236 * V_237 = (struct V_236 * ) ( V_58 -> V_61 ) ;
struct V_238 * V_232 = F_144 ( V_335 , V_237 -> V_241 ) ;
if ( V_232 == NULL ) {
F_10 ( V_30 , V_81 , ( L_29 ) ) ;
goto exit;
}
...
struct V_334 * V_335 = & V_42 -> V_336 ;
struct V_96 * V_97 = & V_42 -> V_98 ;
struct V_263 * V_363 = (struct V_263 * ) ( V_58 -> V_51 ) ;
struct V_266 * V_364 = (struct V_266 * ) ( V_58 -> V_61 ) ;
struct V_238 * V_232 = F_144 ( V_335 , V_363 -> V_241 ) ;
if ( V_232 == NULL ) {
F_10 ( V_30 , V_81 , ( L_30 ) ) ;
goto exit;
}
V_232 -> V_365 = V_364 -> V_366 ;
V_232 -> V_123 = V_364 -> V_366 ;
F_138 ( & V_97 -> V_38 ) ;
if ( ( F_49 ( V_97 , V_367 ) == true ) && ( F_49 ( V_97 , V_362 ) == true ) )
F_56 ( V_97 , V_362 ) ;
F_53 ( V_97 , V_99 ) ;
F_139 ( & V_97 -> V_38 ) ;
exit:
