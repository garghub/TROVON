...
V_54 . V_61 = 0 ;
V_7 -> V_62 . V_54 = & V_54 ;
F_26 ( V_51 , L_3 , & V_54 . V_55 ) ;
V_49 = F_27 ( & V_6 -> V_2 , & V_7 -> V_62 ) ;
if ( ! F_28 ( V_49 ) )
F_29 ( V_51 , V_63 , V_49 ) ;
return V_49 ;
}
static T_2 F_30 ( int V_64 , void * V_65 )
{
...
struct V_7 * V_7 ;
int V_9 ;
V_7 = F_41 ( & V_6 -> V_2 , sizeof( * V_7 ) , V_79 ) ;
if ( ! V_7 )
return - V_80 ;
V_7 -> V_6 = V_6 ;
F_42 ( V_6 , V_7 ) ;
...
V_9 = F_34 ( V_6 ) ;
if ( V_9 ) {
F_32 ( & V_6 -> V_2 , L_7 , V_9 ) ;
return V_9 ;
}
V_9 = F_44 ( & V_6 -> V_2 , V_6 -> V_64 ,
NULL , F_30 ,
V_81 | V_82 ,
V_6 -> V_55 , V_7 ) ;
if ( V_9 < 0 ) {
...
F_45 ( & V_6 -> V_2 , L_9 ,
V_7 -> V_10 ? L_10 : L_11 ) ;
V_7 -> V_68 = F_46 ( & V_6 -> V_2 , V_6 -> V_55 ,
& V_84 , V_85 ) ;
if ( F_28 ( V_7 -> V_68 ) )
return F_47 ( V_7 -> V_68 ) ;
V_7 -> V_68 -> V_86 = 1 ;
#ifdef F_48
F_24 ( V_7 ) ;
#endif
