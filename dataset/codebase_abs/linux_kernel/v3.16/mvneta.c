...
int V_150 = 0 ;
T_3 V_151 ;
if ( V_170 -> V_193 == F_71 ( V_155 ) ) {
struct V_194 * V_195 = F_99 ( V_170 ) ;
V_150 = V_195 -> V_196 ;
V_151 = V_195 -> V_193 ;
} else if ( V_170 -> V_193 == F_71 ( V_197 ) ) {
...
static inline void
F_116 ( struct V_169 * V_170 ,
struct V_1 * V_2 , struct V_6 * V_7 )
{
struct V_54 * V_55 ;
int V_213 = F_117 ( V_170 ) + F_118 ( V_170 ) ;
...
static int F_120 ( struct V_169 * V_170 , struct V_16 * V_17 ,
struct V_6 * V_7 )
{
int V_220 , V_221 ;
int V_222 = 0 ;
...
int V_213 = F_117 ( V_170 ) + F_118 ( V_170 ) ;
int V_11 ;
if ( ( V_7 -> V_69 + F_121 ( V_170 ) ) >= V_7 -> V_9 )
return 0 ;
if ( F_122 ( V_170 ) < ( F_117 ( V_170 ) + F_118 ( V_170 ) ) ) {
F_123 ( L_10 ) ;
return 0 ;
}
F_124 ( V_170 , & V_224 ) ;
...
while ( V_220 > 0 ) {
char * V_226 ;
V_221 = F_125 ( int , F_126 ( V_170 ) -> V_227 , V_220 ) ;
V_220 -= V_221 ;
V_222 ++ ;
V_226 = V_7 -> V_228 + V_7 -> V_10 * V_216 ;
F_127 ( V_170 , V_226 , & V_224 , V_221 , V_220 == 0 ) ;
F_116 ( V_170 , V_2 , V_7 ) ;
while ( V_221 > 0 ) {
int V_9 ;
V_222 ++ ;
V_9 = F_125 ( int , V_224 . V_9 , V_221 ) ;
if ( F_119 ( V_17 , V_7 , V_170 ,
V_224 . V_4 , V_9 ,
V_9 == V_221 ,
V_220 == 0 ) )
goto V_229;
V_221 -= V_9 ;
F_128 ( V_170 , & V_224 , V_9 ) ;
}
}
return V_222 ;
V_229:
...
static int F_129 ( struct V_1 * V_2 , struct V_169 * V_170 ,
struct V_6 * V_7 )
{
struct V_54 * V_55 ;
int V_11 , V_230 = F_126 ( V_170 ) -> V_230 ;
for ( V_11 = 0 ; V_11 < V_230 ; V_11 ++ ) {
T_5 * V_231 = & F_126 ( V_170 ) -> V_232 [ V_11 ] ;
void * V_128 = F_130 ( V_231 -> V_233 . V_234 ) + V_231 -> V_235 ;
V_55 = F_29 ( V_7 ) ;
...
static int F_131 ( struct V_169 * V_170 , struct V_16 * V_17 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
T_6 V_237 = F_132 ( V_170 ) ;
...
goto V_239;
if ( F_134 ( V_170 ) ) {
V_232 = F_120 ( V_170 , V_17 , V_7 ) ;
goto V_239;
}
V_232 = F_126 ( V_170 ) -> V_230 + 1 ;
V_55 = F_29 ( V_7 ) ;
...
static void F_137 ( struct V_1 * V_2 , T_1 V_243 )
{
struct V_6 * V_7 ;
struct V_182 * V_183 ;
while ( V_243 ) {
...
static int F_141 ( unsigned char * V_128 )
{
int V_244 = 0 ;
int V_11 ;
...
static int F_144 ( struct V_1 * V_2 , unsigned char * V_251 ,
int V_61 )
{
unsigned char V_252 = 0 ;
if ( memcmp ( V_251 , L_11 , 5 ) == 0 ) {
F_142 ( V_2 , V_251 [ 5 ] , V_61 ) ;
return 0 ;
}
V_252 = F_141 ( V_251 ) ;
if ( V_61 == - 1 ) {
...
static T_7 F_150 ( int V_265 , void * V_266 )
{
...
static int F_152 ( struct V_268 * V_211 , int V_269 )
{
int V_41 = 0 ;
T_1 V_270 ;
unsigned long V_261 ;
...
V_270 = F_3 ( V_2 , V_85 ) &
( F_154 ( V_66 ) | F_155 ( V_63 ) ) ;
if ( V_270 & V_271 ) {
F_137 ( V_2 , ( V_270 & V_271 ) ) ;
V_270 &= ~ V_271 ;
}
V_270 |= V_2 -> V_270 ;
if ( V_66 > 1 ) {
...
int V_69 ;
struct V_33 * V_34 ;
V_34 = F_103 ( V_2 , V_270 ) ;
if ( ! V_34 )
break;
V_69 = F_105 ( V_2 , V_269 , V_34 ) ;
V_41 += V_69 ;
V_269 -= V_69 ;
if ( V_269 > 0 ) {
V_270 &= ~ ( ( 1 << V_34 -> V_37 ) << 8 ) ;
...
V_41 = F_105 ( V_2 , V_269 , & V_2 -> V_67 [ V_103 ] ) ;
V_269 -= V_41 ;
}
if ( V_269 > 0 ) {
V_270 = 0 ;
...
static int F_158 ( struct V_1 * V_2 , struct V_33 * V_34 ,
int V_178 )
{
int V_11 ;
for ( V_11 = 0 ; V_11 < V_178 ; V_11 ++ ) {
...
{
V_34 -> V_9 = V_2 -> V_274 ;
V_34 -> V_46 = F_162 ( V_2 -> V_17 -> V_17 . V_180 ,
V_34 -> V_9 * V_275 ,
& V_34 -> V_276 , V_277 ) ;
if ( V_34 -> V_46 == NULL )
return - V_189 ;
F_163 ( V_34 -> V_46 !=
F_164 ( V_34 -> V_46 , V_278 ) ) ;
V_34 -> V_56 = V_34 -> V_9 - 1 ;
F_1 ( V_2 , F_165 ( V_34 -> V_37 ) , V_34 -> V_276 ) ;
...
V_7 -> V_46 = F_162 ( V_2 -> V_17 -> V_17 . V_180 ,
V_7 -> V_9 * V_275 ,
& V_7 -> V_276 , V_277 ) ;
if ( V_7 -> V_46 == NULL )
return - V_189 ;
F_163 ( V_7 -> V_46 !=
F_164 ( V_7 -> V_46 , V_278 ) ) ;
V_7 -> V_56 = V_7 -> V_9 - 1 ;
F_1 ( V_2 , F_47 ( V_7 -> V_37 ) , 0x03ffffff ) ;
F_1 ( V_2 , F_46 ( V_7 -> V_37 ) , 0x3fffffff ) ;
F_1 ( V_2 , F_169 ( V_7 -> V_37 ) , V_7 -> V_276 ) ;
...
V_7 -> V_228 = F_162 ( V_2 -> V_17 -> V_17 . V_180 ,
V_7 -> V_9 * V_216 ,
& V_7 -> V_215 , V_277 ) ;
if ( V_7 -> V_228 == NULL ) {
F_92 ( V_7 -> V_179 ) ;
...
int V_61 ;
for ( V_61 = 0 ; V_61 < V_63 ; V_61 ++ )
F_170 ( V_2 , & V_2 -> V_64 [ V_61 ] ) ;
}
static void F_172 ( struct V_1 * V_2 )
{
int V_61 ;
for ( V_61 = 0 ; V_61 < V_66 ; V_61 ++ )
F_166 ( V_2 , & V_2 -> V_67 [ V_61 ] ) ;
}
static int F_173 ( struct V_1 * V_2 )
{
int V_61 ;
for ( V_61 = 0 ; V_61 < V_66 ; V_61 ++ ) {
int V_205 = F_161 ( V_2 , & V_2 -> V_67 [ V_61 ] ) ;
if ( V_205 ) {
F_73 ( V_2 -> V_17 , L_15 ,
V_273 , V_61 ) ;
F_172 ( V_2 ) ;
...
int V_61 ;
for ( V_61 = 0 ; V_61 < V_63 ; V_61 ++ ) {
int V_205 = F_168 ( V_2 , & V_2 -> V_64 [ V_61 ] ) ;
if ( V_205 ) {
F_73 ( V_2 -> V_17 , L_16 ,
V_273 , V_61 ) ;
F_171 ( V_2 ) ;
...
static int F_184 ( struct V_16 * V_17 , int V_118 )
{
if ( V_118 < 68 ) {
F_73 ( V_17 , L_17 ) ;
return - V_253 ;
...
if ( V_118 > 9676 ) {
F_145 ( V_17 , L_18 , V_118 ) ;
V_118 = 9676 ;
}
if ( ! F_185 ( F_186 ( V_118 ) , 8 ) ) {
F_145 ( V_17 , L_19 ,
V_118 , F_187 ( F_186 ( V_118 ) , 8 ) ) ;
V_118 = F_187 ( F_186 ( V_118 ) , 8 ) ;
}
return V_118 ;
}
static int F_188 ( struct V_16 * V_17 , int V_118 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
int V_282 ;
V_118 = F_184 ( V_17 , V_118 ) ;
if ( V_118 < 0 )
return - V_253 ;
V_17 -> V_118 = V_118 ;
if ( ! F_133 ( V_17 ) )
...
F_171 ( V_2 ) ;
F_172 ( V_2 ) ;
V_2 -> V_190 = F_186 ( V_17 -> V_118 ) ;
V_2 -> V_186 = F_189 ( F_95 ( V_2 -> V_190 ) ) +
F_189 ( sizeof( struct V_283 ) ) ;
V_282 = F_173 ( V_2 ) ;
if ( V_282 ) {
F_73 ( V_17 , L_20 ) ;
return V_282 ;
...
static void F_190 ( struct V_1 * V_2 , unsigned char * V_128 )
{
T_1 V_284 , V_285 ;
V_284 = F_3 ( V_2 , V_131 ) ;
V_285 = F_3 ( V_2 , V_132 ) ;
...
static int F_191 ( struct V_16 * V_17 , void * V_128 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
struct V_286 * V_286 = V_128 ;
int V_282 ;
V_282 = F_192 ( V_17 , V_128 ) ;
if ( V_282 < 0 )
return V_282 ;
...
static void F_194 ( struct V_16 * V_288 )
{
...
{
struct V_289 * V_281 ;
V_281 = F_196 ( V_2 -> V_17 , V_2 -> V_305 , F_194 , 0 ,
V_2 -> V_306 ) ;
if ( ! V_281 ) {
F_73 ( V_2 -> V_17 , L_24 ) ;
return - V_307 ;
...
static int F_199 ( struct V_16 * V_17 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
int V_282 ;
V_2 -> V_190 = F_186 ( V_2 -> V_17 -> V_118 ) ;
V_2 -> V_186 = F_189 ( F_95 ( V_2 -> V_190 ) ) +
F_189 ( sizeof( struct V_283 ) ) ;
V_282 = F_173 ( V_2 ) ;
if ( V_282 )
...
if ( V_282 )
goto V_311;
V_282 = F_200 ( V_2 -> V_17 -> V_265 , F_150 , 0 ,
V_312 , V_2 ) ;
if ( V_282 ) {
...
F_179 ( V_2 ) ;
F_197 ( V_2 ) ;
F_201 ( V_17 -> V_265 , V_2 ) ;
F_172 ( V_2 ) ;
F_171 ( V_2 ) ;
return 0 ;
}
static int F_203 ( struct V_16 * V_17 , struct V_315 * V_316 , int V_317 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
int V_282 ;
if ( ! V_2 -> V_281 )
return - V_318 ;
V_282 = F_204 ( V_2 -> V_281 , V_316 , V_317 ) ;
if ( ! V_282 )
F_194 ( V_17 ) ;
return V_282 ;
}
int F_205 ( struct V_16 * V_17 , struct V_319 * V_317 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
if ( ! V_2 -> V_281 )
return - V_307 ;
return F_206 ( V_2 -> V_281 , V_317 ) ;
}
...
static int F_209 ( struct V_16 * V_17 ,
struct V_320 * V_321 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
int V_61 ;
...
static void F_211 ( struct V_16 * V_17 ,
struct V_325 * V_326 )
{
F_212 ( V_326 -> V_327 , V_312 ,
sizeof( V_326 -> V_327 ) ) ;
F_212 ( V_326 -> V_328 , V_329 ,
sizeof( V_326 -> V_328 ) ) ;
F_212 ( V_326 -> V_330 , F_213 ( & V_17 -> V_17 ) ,
sizeof( V_326 -> V_330 ) ) ;
}
static void F_214 ( struct V_16 * V_331 ,
struct V_332 * V_333 )
{
...
V_333 -> V_338 : V_335 ;
V_2 -> V_279 = F_216 ( T_6 , V_333 -> V_339 ,
V_280 * 2 , V_337 ) ;
...
static int F_217 ( struct V_340 * V_17 , struct V_1 * V_2 )
{
int V_61 ;
F_40 ( V_2 ) ;
F_44 ( V_2 ) ;
V_2 -> V_64 = F_218 ( V_17 , V_63 , sizeof( struct V_6 ) ,
V_277 ) ;
if ( ! V_2 -> V_64 )
return - V_189 ;
for ( V_61 = 0 ; V_61 < V_63 ; V_61 ++ ) {
...
V_2 -> V_67 = F_218 ( V_17 , V_66 , sizeof( struct V_33 ) ,
V_277 ) ;
if ( ! V_2 -> V_67 )
return - V_189 ;
for ( V_61 = 0 ; V_61 < V_66 ; V_61 ++ ) {
...
F_1 ( V_2 , F_220 ( V_11 ) , ( V_350 -> V_5 & 0xffff0000 ) |
...
static int F_223 ( struct V_1 * V_2 , int V_354 )
{
T_1 V_355 ;
F_1 ( V_2 , V_356 , 0 ) ;
V_355 = F_3 ( V_2 , V_357 ) ;
...
static int F_224 ( struct V_368 * V_369 )
{
...
int V_205 ;
if ( V_103 != 0 ) {
F_225 ( & V_369 -> V_17 , L_29 , V_103 ) ;
return - V_253 ;
}
V_17 = F_226 ( sizeof( struct V_1 ) , V_63 , V_66 ) ;
if ( ! V_17 )
return - V_189 ;
V_17 -> V_265 = F_227 ( V_374 , 0 ) ;
if ( V_17 -> V_265 == 0 ) {
V_205 = - V_253 ;
goto V_379;
}
V_305 = F_228 ( V_374 , L_30 , 0 ) ;
if ( ! V_305 ) {
if ( ! F_229 ( V_374 ) ) {
F_225 ( & V_369 -> V_17 , L_31 ) ;
V_205 = - V_307 ;
goto V_314;
}
V_205 = F_230 ( V_374 ) ;
if ( V_205 < 0 ) {
F_225 ( & V_369 -> V_17 , L_32 ) ;
goto V_314;
}
V_305 = V_374 ;
}
...
V_2 -> V_305 = V_305 ;
V_2 -> V_306 = V_354 ;
V_2 -> V_136 = F_232 ( & V_369 -> V_17 , NULL ) ;
if ( F_233 ( V_2 -> V_136 ) ) {
V_205 = F_234 ( V_2 -> V_136 ) ;
goto V_314;
}
F_235 ( V_2 -> V_136 ) ;
V_372 = F_236 ( V_369 , V_387 , 0 ) ;
V_2 -> V_5 = F_237 ( & V_369 -> V_17 , V_372 ) ;
if ( F_233 ( V_2 -> V_5 ) ) {
V_205 = F_234 ( V_2 -> V_5 ) ;
goto V_388;
}
V_2 -> V_18 = F_238 ( struct V_21 ) ;
if ( ! V_2 -> V_18 ) {
V_205 = - V_189 ;
goto V_388;
}
...
V_2 -> V_274 = V_335 ;
V_2 -> V_17 = V_17 ;
F_242 ( V_17 , & V_369 -> V_17 ) ;
V_205 = F_217 ( & V_369 -> V_17 , V_2 ) ;
if ( V_205 < 0 )
goto V_389;
V_205 = F_223 ( V_2 , V_354 ) ;
if ( V_205 < 0 ) {
F_225 ( & V_369 -> V_17 , L_37 ) ;
goto V_389;
}
V_370 = F_243 () ;
if ( V_370 )
F_219 ( V_2 , V_370 ) ;
F_244 ( V_17 , & V_2 -> V_211 , F_152 , V_390 ) ;
V_17 -> V_391 = V_392 | V_393 | V_394 ;
V_17 -> V_395 |= V_17 -> V_391 ;
V_17 -> V_396 |= V_17 -> V_391 ;
V_17 -> V_397 |= V_398 ;
V_17 -> V_399 = V_400 ;
V_205 = F_245 ( V_17 ) ;
if ( V_205 < 0 ) {
F_225 ( & V_369 -> V_17 , L_38 ) ;
goto V_389;
}
F_145 ( V_17 , L_39 , V_378 ,
V_17 -> V_263 ) ;
F_246 ( V_369 , V_2 -> V_17 ) ;
return 0 ;
V_389:
F_247 ( V_2 -> V_18 ) ;
V_388:
...
static int F_251 ( struct V_368 * V_369 )
{
struct V_16 * V_17 = F_252 ( V_369 ) ;
struct V_1 * V_2 = F_9 ( V_17 ) ;
F_253 ( V_17 ) ;
F_248 ( V_2 -> V_136 ) ;
F_247 ( V_2 -> V_18 ) ;
