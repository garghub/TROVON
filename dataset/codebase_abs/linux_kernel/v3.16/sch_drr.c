...
struct V_72 V_73 ;
int V_74 ;
if ( F_50 ( V_47 -> V_75 ^ V_3 -> V_55 ) == 0 ) {
V_11 = F_1 ( V_3 , V_47 -> V_75 ) ;
if ( V_11 != NULL )
return V_11 ;
}
* V_71 = V_76 | V_77 ;
V_74 = F_51 ( V_47 , V_6 -> V_40 , & V_73 ) ;
if ( V_74 >= 0 ) {
#ifdef F_52
switch ( V_74 ) {
case V_78 :
...
goto V_85;
while ( 1 ) {
V_11 = F_61 ( & V_6 -> V_84 , struct V_1 , V_45 ) ;
V_47 = V_11 -> V_13 -> V_86 -> V_87 ( V_11 -> V_13 ) ;
if ( V_47 == NULL ) {
F_62 ( V_88 , V_11 -> V_13 ) ;
goto V_85;
}
...
struct V_1 * V_11 ;
unsigned int V_12 ;
F_69 (cl, &q->active, alist) {
if ( V_11 -> V_13 -> V_86 -> V_89 ) {
V_12 = V_11 -> V_13 -> V_86 -> V_89 ( V_11 -> V_13 ) ;
if ( V_12 > 0 ) {
V_3 -> V_6 . V_14 -- ;
if ( V_11 -> V_13 -> V_6 . V_14 == 0 )
F_36 ( & V_11 -> V_45 ) ;
...
static int F_70 ( struct V_2 * V_3 , struct V_16 * V_19 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
int V_24 ;
V_24 = F_71 ( & V_6 -> V_9 ) ;
