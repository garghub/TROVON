...
static int F_21 ( struct V_28 * V_103 , int V_112 )
{
struct V_1 * V_2 = V_103 -> V_2 ;
T_1 V_14 = F_7 ( V_2 , V_113 ) & ~ V_114 ;
if ( V_112 )
F_8 ( V_2 , V_113 , V_14 | V_114 ) ;
else
F_8 ( V_2 , V_113 , V_14 ) ;
return 0 ;
}
...
V_14 = F_7 ( V_2 , V_119 ) &
~ V_120 ;
F_8 ( V_2 , V_119 , V_14 | 0x2 ) ;
break;
case V_121 :
if ( V_2 -> V_122 . V_123 == V_124 ) {
V_13 = F_23 ( F_24 ( V_125 ) ,
& V_125 [ 0 ] ) ;
if ( V_13 != 0 ) {
F_13 ( V_4 -> V_4 -> V_42 ,
L_8 ,
...
F_8 ( V_2 , V_119 , V_14 ) ;
F_8 ( V_2 , V_128 , 0x0 ) ;
V_13 = F_26 ( F_24 ( V_125 ) ,
& V_125 [ 0 ] ) ;
if ( V_13 != 0 )
return V_13 ;
break;
}
V_2 -> V_122 . V_123 = V_116 ;
return 0 ;
}
...
static void F_29 ( struct V_146 * V_147 )
{
struct V_3 * V_148 = F_30 ( V_147 , struct V_3 ,
V_147 ) ;
...
{
struct V_4 * V_4 = F_32 ( V_2 -> V_42 ) ;
struct V_3 * V_148 ;
int V_13 ;
T_1 V_12 ;
V_148 = F_33 ( V_2 -> V_42 , sizeof( struct V_3 ) ,
V_149 ) ;
if ( V_148 == NULL )
return - V_150 ;
F_34 ( V_2 , V_148 ) ;
...
F_36 ( & V_148 -> V_147 , F_29 ) ;
F_1 ( V_2 ) ;
V_12 = F_7 ( V_2 , V_119 ) ;
F_8 ( V_2 , V_119 , V_12 | V_126 ) ;
V_12 = F_7 ( V_2 , V_151 ) ;
F_8 ( V_2 , V_151 ,
V_12 & V_152 ) ;
V_12 = F_7 ( V_2 , V_153 ) ;
F_8 ( V_2 , V_153 ,
V_12 & V_152 ) ;
F_8 ( V_2 , V_154 , 0x50 | ( 1 << 8 ) ) ;
F_8 ( V_2 , V_155 , 0x50 | ( 1 << 8 ) ) ;
if ( ! F_37 ( & V_148 -> V_147 ) )
return - V_43 ;
return 0 ;
}
...
static struct V_156 * F_39 ( struct V_157 * V_42 )
{
struct V_4 * V_4 = F_32 ( V_42 ) ;
return V_4 -> V_156 ;
}
static int F_40 ( struct V_158 * V_159 )
{
return F_41 ( & V_159 -> V_42 , & V_160 ,
& V_161 , 1 ) ;
}
