...
static int F_63 ( struct V_112 * V_113 [] , struct V_112 * V_48 [] )
{
if ( V_113 [ V_114 ] ) {
if ( F_64 ( V_113 [ V_114 ] ) != V_7 )
return - V_53 ;
}
return 0 ;
}
static int F_65 ( struct V_8 * V_9 , struct V_2 * V_3 ,
struct V_115 * V_116 , struct V_2 * V_117 )
{
struct V_41 V_42 ;
int V_118 ;
V_9 = F_66 ( V_9 , V_39 ) ;
...
static int F_71 ( struct V_126 * V_127 , struct V_2 * V_3 ,
struct V_112 * V_113 [] , struct V_112 * V_48 [] )
{
struct V_2 * V_32 ;
struct V_33 * V_34 ;
F_45 ( L_10 ) ;
if ( ! V_113 [ V_128 ] )
return - V_53 ;
V_32 = F_72 ( V_127 , F_73 ( V_113 [ V_128 ] ) ) ;
if ( ! V_32 )
return - V_129 ;
if ( V_32 -> type != V_97 ) {
F_74 ( V_32 ) ;
...
F_77 ( & V_1 ( V_3 ) -> V_130 ) ;
F_78 ( & V_34 -> V_132 ) ;
F_79 ( & V_34 -> V_132 , & V_133 ) ;
F_80 ( & V_1 ( V_3 ) -> V_130 ) ;
F_81 ( V_3 ) ;
return 0 ;
}
static void F_82 ( struct V_2 * V_3 , struct V_134 * V_135 )
{
struct V_1 * V_136 = V_1 ( V_3 ) ;
struct V_2 * V_32 = V_136 -> V_32 ;
struct V_33 * V_34 , * V_137 ;
F_83 () ;
F_77 ( & V_1 ( V_3 ) -> V_130 ) ;
