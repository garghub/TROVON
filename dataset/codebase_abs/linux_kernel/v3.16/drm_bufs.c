...
struct V_152 * V_37 = & V_104 -> V_123 [ V_96 ] . V_153 ;
if ( F_53 ( & V_150 -> V_109 ,
& V_151 -> V_99 ,
sizeof( V_151 -> V_99 ) ) ||
F_53 ( & V_150 -> V_33 ,
...
V_104 -> V_123 [ V_96 ] . V_153 . V_154 ,
V_104 -> V_123 [ V_96 ] . V_153 . V_155 ) ;
++ V_109 ;
}
}
}
...
return - V_28 ;
F_10 ( L_24 ,
V_94 -> V_33 , V_94 -> V_154 , V_94 -> V_155 ) ;
V_110 = F_18 ( V_94 -> V_33 ) ;
if ( V_110 < V_118 || V_110 > V_119 )
return - V_28 ;
V_6 = & V_104 -> V_123 [ V_110 ] ;
if ( V_94 -> V_154 < 0 || V_94 -> V_154 > V_6 -> V_99 )
return - V_28 ;
if ( V_94 -> V_155 < 0 || V_94 -> V_155 > V_6 -> V_99 )
return - V_28 ;
V_6 -> V_153 . V_154 = V_94 -> V_154 ;
V_6 -> V_153 . V_155 = V_94 -> V_155 ;
return 0 ;
}
...
V_74 = F_61 ( V_85 -> V_166 , 0 , V_5 -> V_33 ,
V_167 | V_168 ,
V_169 ,
V_163 ) ;
} else {
V_74 = F_61 ( V_85 -> V_166 , 0 , V_104 -> V_114 ,
V_167 | V_168 ,
V_169 , 0 ) ;
}
if ( V_74 > - 1024UL ) {
V_159 = ( signed long ) V_74 ;
goto V_165;
}
...
return - V_28 ;
if ( V_3 -> V_133 -> V_170 )
return V_3 -> V_133 -> V_170 ( V_3 , V_83 , V_85 ) ;
else
return - V_28 ;
}
