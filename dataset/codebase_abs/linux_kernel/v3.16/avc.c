...
int V_42 , V_12 = 0 ;
unsigned long V_63 ;
struct V_22 * V_67 , * V_32 , * V_93 = NULL ;
struct V_33 * V_34 ;
T_4 * V_46 ;
V_32 = F_38 () ;
if ( ! V_32 ) {
...
F_41 ( V_32 , V_1 , V_2 , V_3 , & V_93 -> V_56 . V_55 ) ;
switch ( V_83 ) {
case V_96 :
V_32 -> V_56 . V_55 . V_97 |= V_8 ;
break;
case V_98 :
case V_99 :
V_32 -> V_56 . V_55 . V_97 &= ~ V_8 ;
...
V_73 = V_76 & ~ ( V_55 -> V_97 ) ;
if ( F_63 ( V_73 ) )
V_12 = F_61 ( V_1 , V_2 , V_3 , V_76 , V_45 , V_55 ) ;
F_19 () ;
return V_12 ;
}
int F_65 ( T_1 V_1 , T_1 V_2 , T_2 V_3 ,
T_1 V_76 , struct V_70 * V_112 )
{
struct V_54 V_55 ;
int V_12 , V_113 ;
V_12 = F_62 ( V_1 , V_2 , V_3 , V_76 , 0 , & V_55 ) ;
V_113 = F_66 ( V_1 , V_2 , V_3 , V_76 , & V_55 , V_12 , V_112 ) ;
if ( V_113 )
return V_113 ;
return V_12 ;
}
