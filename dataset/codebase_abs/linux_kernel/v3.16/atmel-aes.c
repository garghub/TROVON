...
static bool F_65 ( struct V_150 * V_67 , void * V_151 )
{
...
F_67 ( V_159 ) ;
F_68 ( V_160 , V_159 ) ;
V_18 -> V_52 . V_67 = F_69 ( V_159 ,
F_65 , & V_158 -> V_161 -> V_162 , V_18 -> V_37 , L_12 ) ;
if ( ! V_18 -> V_52 . V_67 )
goto V_163;
...
F_65 , & V_158 -> V_161 -> V_168 , V_18 -> V_37 , L_13 ) ;
if ( ! V_18 -> V_56 . V_67 )
goto V_169;
...
static int F_74 ( struct V_171 * V_172 , const T_5 * V_122 ,
unsigned int V_94 )
{
...
static int F_94 ( struct V_175 * V_172 )
{
V_172 -> V_176 . V_177 = sizeof( struct V_127 ) ;
return 0 ;
}
static void F_95 ( struct V_175 * V_172 )
{
}
...
static T_6 F_99 ( int V_179 , void * V_180 )
{
...
static struct V_157 * F_106 ( struct V_194 * V_195 )
{
struct V_196 * V_197 = V_195 -> V_37 . V_198 ;
struct V_157 * V_158 ;
if ( ! V_197 ) {
F_40 ( & V_195 -> V_37 , L_17 ) ;
return F_107 ( - V_72 ) ;
}
V_158 = F_108 ( & V_195 -> V_37 , sizeof( * V_158 ) , V_139 ) ;
if ( ! V_158 ) {
F_40 ( & V_195 -> V_37 , L_18 ) ;
return F_107 ( - V_138 ) ;
}
V_158 -> V_161 = F_108 ( & V_195 -> V_37 ,
sizeof( * ( V_158 -> V_161 ) ) ,
V_139 ) ;
if ( ! V_158 -> V_161 ) {
F_40 ( & V_195 -> V_37 , L_19 ) ;
F_109 ( & V_195 -> V_37 , V_158 ) ;
return F_107 ( - V_138 ) ;
}
return V_158 ;
}
static inline struct V_157 * F_106 ( struct V_194 * V_195 )
{
return F_107 ( - V_72 ) ;
}
static int F_110 ( struct V_194 * V_195 )
{
struct V_17 * V_23 ;
struct V_157 * V_158 ;
...
V_23 = F_113 ( sizeof( struct V_17 ) , V_139 ) ;
if ( V_23 == NULL ) {
F_40 ( V_37 , L_20 ) ;
V_34 = - V_138 ;
goto V_203;
...
F_114 ( V_195 , V_23 ) ;
F_115 ( & V_23 -> V_205 ) ;
F_116 ( & V_23 -> V_42 , F_97 ,
( unsigned long ) V_23 ) ;
F_116 ( & V_23 -> V_136 , F_96 ,
( unsigned long ) V_23 ) ;
F_117 ( & V_23 -> V_130 , V_206 ) ;
V_23 -> V_179 = - 1 ;
V_200 = F_118 ( V_195 , V_207 , 0 ) ;
if ( ! V_200 ) {
F_40 ( V_37 , L_21 ) ;
V_34 = - V_149 ;
goto V_208;
}
V_23 -> V_166 = V_200 -> V_209 ;
V_201 = F_119 ( V_200 ) ;
...
V_34 = F_121 ( V_23 -> V_179 , F_99 , V_211 , L_23 ,
V_23 ) ;
if ( V_34 ) {
F_40 ( V_37 , L_24 ) ;
goto V_210;
}
V_23 -> V_27 = F_122 ( & V_195 -> V_37 , L_25 ) ;
if ( F_111 ( V_23 -> V_27 ) ) {
F_40 ( V_37 , L_26 ) ;
V_34 = F_112 ( V_23 -> V_27 ) ;
goto V_212;
}
V_23 -> V_19 = F_123 ( V_23 -> V_166 , V_201 ) ;
if ( ! V_23 -> V_19 ) {
F_40 ( V_37 , L_27 ) ;
V_34 = - V_138 ;
goto V_213;
...
if ( V_34 )
goto V_214;
V_34 = F_66 ( V_23 , V_158 ) ;
if ( V_34 )
goto V_215;
F_124 ( & V_25 . V_26 ) ;
F_125 ( & V_23 -> V_205 , & V_25 . V_216 ) ;
F_126 ( & V_25 . V_26 ) ;
V_34 = F_103 ( V_23 ) ;
if ( V_34 )
goto V_217;
...
static int F_134 ( struct V_194 * V_195 )
{
