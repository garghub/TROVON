...
{
struct V_9 * V_10 = V_5 -> V_11 ;
struct V_101 * V_102 = & V_5 -> V_103 [ V_105 ] ;
unsigned long V_12 ;
F_4 ( & V_10 -> V_38 , V_12 ) ;
if ( V_10 -> V_45 )
F_59 ( V_10 -> V_45 , V_102 ) ;
F_8 ( & V_10 -> V_38 , V_12 ) ;
}
...
V_126 ) ;
F_63 ( V_5 ) ;
V_102 -> V_110 -> V_111 |= V_137 ;
if ( V_126 & ( V_138 | V_139 ) )
V_102 -> V_110 -> V_111 |= V_141 ;
F_68 ( V_5 , V_102 ) ;
return;
}
if ( V_126 & V_117 ) {
...
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_165 * V_110 = V_102 -> V_110 ;
struct V_166 * V_167 = & V_110 -> V_167 ;
int V_168 ;
int V_67 ;
unsigned short V_82 ;
T_4 V_169 ;
...
F_56 ( V_5 ) ;
#endif
V_239 = V_102 -> V_110 -> V_240 - V_102 -> V_110 -> V_241 ;
F_8 ( & V_5 -> V_90 , V_12 ) ;
return V_239 ;
}
...
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
const struct V_166 * V_167 = & V_102 -> V_110 -> V_167 ;
int V_309 ;
int V_335 = 0 ;
int V_336 = 0 ;
int V_337 = 0 ;
...
#endif
if ( V_167 -> V_315 == V_316 ) {
V_10 -> V_16 ( V_5 , V_383 | V_10 -> V_113 ,
V_384 ) ;
V_102 -> V_110 -> V_385 = NULL ;
} else if ( V_167 -> V_315 == V_318 ) {
V_102 -> V_110 -> V_385 = NULL ;
} else {
V_102 -> V_110 -> V_385 = V_386 ;
}
return 0 ;
}
static int V_386 ( struct V_4 * V_5 ,
struct V_101 * V_102 ,
unsigned int V_387 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
struct V_166 * V_167 = & V_102 -> V_110 -> V_167 ;
if ( V_387 != V_167 -> V_326 )
return - V_388 ;
V_10 -> V_16 ( V_5 , V_383 | V_10 -> V_113 ,
V_384 ) ;
V_102 -> V_110 -> V_385 = NULL ;
...
unsigned int V_256 = 1 << ( V_59 -> V_404 - 1 ) ;
unsigned short * V_198 = V_73 ;
unsigned int V_170 ;
unsigned int V_67 ;
for ( V_67 = 0 ; V_67 < V_197 ; V_67 ++ ) {
V_170 = F_74 ( V_167 -> V_173 [ V_196 ] ) ;
...
int V_67 ;
for ( V_67 = 0 ; V_67 < V_167 -> V_178 ; ++ V_67 ) {
unsigned int V_168 = F_103 ( V_167 -> V_173 [ V_67 ] ) ;
if ( V_168 != V_67 )
return - V_388 ;
}
return 0 ;
...
if ( V_171 )
return 4 ;
if ( V_167 -> V_173 && V_167 -> V_178 > 0 )
V_171 |= F_163 ( V_5 , V_102 , V_167 ) ;
if ( V_171 )
return 5 ;
return 0 ;
}
...
if ( V_190 < 0 )
return V_190 ;
V_102 -> V_110 -> V_385 = V_529 ;
return 0 ;
}
static int V_529 ( struct V_4 * V_5 ,
struct V_101 * V_102 ,
unsigned int V_387 )
{
#ifdef F_24
...
static int F_167 ( struct V_4 * V_5 , struct V_101 * V_102 )
{
struct V_9 * V_10 V_193 = V_5 -> V_11 ;
F_33 ( V_535 | V_536 |
V_537 |
...
static void F_174 ( struct V_4 * V_5 , struct V_101 * V_102 )
{
int V_67 ;
for ( V_67 = 0 ; V_67 < V_102 -> V_253 ; V_67 ++ ) {
...
static unsigned F_175 ( enum V_573 V_6 )
{
unsigned V_574 ;
switch ( V_6 ) {
case V_575 :
...
static void F_184 ( struct V_602 * V_603 , unsigned V_74 ,
enum V_573 V_6 )
{
...
static unsigned F_185 ( struct V_602 * V_603 ,
enum V_573 V_6 )
{
struct V_4 * V_5 = V_603 -> V_52 -> V_5 ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
switch ( V_73 [ 0 ] ) {
case V_643 :
return F_189 ( V_5 , V_73 [ 1 ] ) ;
break;
case V_644 :
F_190 ( V_5 , & V_73 [ 1 ] , & V_73 [ 2 ] ) ;
return 3 ;
default:
break;
}
...
static int F_195 ( int V_43 , int V_646 , int V_73 , unsigned long V_647 )
{
...
struct V_242 * V_243 , unsigned int * V_73 )
{
V_73 [ 0 ] = F_197 ( V_5 , F_103 ( V_243 -> V_247 ) ) ;
return 1 ;
}
static int F_197 ( struct V_4 * V_5 , int V_76 )
{
struct V_9 * V_10 V_193 = V_5 -> V_11 ;
int V_649 ;
int V_650 ;
...
static int F_199 ( struct V_4 * V_5 , unsigned int * V_73 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
...
struct V_242 * V_243 , unsigned int * V_73 )
{
F_205 ( V_5 , F_103 ( V_243 -> V_247 ) , V_73 [ 0 ] ) ;
return 1 ;
}
...
static void F_207 ( struct V_4 * V_5 , struct V_101 * V_102 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
int V_67 , V_664 ;
...
F_205 ( V_5 , V_67 , V_102 -> V_670 [ V_67 ] / 2 ) ;
} else {
type = V_59 -> V_668 [ 0 ] ;
V_102 -> V_673 = ( 1 << V_663 [ type ] . V_666 ) - 1 ;
for ( V_168 = 0 ; V_168 < V_102 -> V_253 ; V_168 ++ )
F_205 ( V_5 , V_67 , V_102 -> V_673 / 2 ) ;
}
}
static void F_205 ( struct V_4 * V_5 , int V_76 , int V_674 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
V_74 = V_663 [ type ] . F_208 ( V_76 , V_674 , & V_650 ) ;
V_675 = F_209 ( V_67 ) ;
break;
}
...
static int F_215 ( int V_76 , int V_674 , int * V_650 )
{
* V_650 = ( ( V_76 + 1 ) << 8 ) | ( V_674 & 0xff ) ;
return 12 ;
}
static int F_216 ( struct V_4 * V_5 , struct V_101 * V_102 )
{
...
F_217 ( V_603 , NULL , NULL , NULL , NULL ) ;
F_30 ( V_5 , V_603 -> V_1 , 1 ) ;
return F_218 ( V_5 , V_102 ) ;
}
static int F_219 ( struct V_4 * V_5 , struct V_101 * V_102 )
{
struct V_602 * V_603 = V_102 -> V_11 ;
int V_190 ;
V_190 = F_220 ( V_603 ) ;
...
static int F_221 ( struct V_4 * V_5 , unsigned V_168 ,
unsigned V_676 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
unsigned V_677 ;
...
static int F_225 ( struct V_4 * V_5 , unsigned V_168 ,
unsigned V_676 )
{
if ( V_676 != F_226 ( V_5 , V_168 ) )
return - V_388 ;
return 2 ;
}
static int F_227 ( struct V_4 * V_5 , unsigned V_168 ,
unsigned V_676 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_59 -> V_60 & V_61 )
return F_221 ( V_5 , V_168 , V_676 ) ;
else
return F_225 ( V_5 , V_168 , V_676 ) ;
}
...
static unsigned F_226 ( struct V_4 * V_5 , unsigned V_168 )
{
switch ( V_168 ) {
case 0 :
return V_680 ;
...
static unsigned F_230 ( struct V_4 * V_5 , unsigned V_168 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_59 -> V_60 & V_61 )
return F_228 ( V_5 , V_168 ) ;
else
return F_226 ( V_5 , V_168 ) ;
}
static int F_231 ( struct V_4 * V_5 , unsigned V_690 ,
enum V_691 V_692 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 V_193 = V_5 -> V_11 ;
...
break;
case V_698 :
return F_227 ( V_5 , V_168 , V_73 [ 1 ] ) ;
break;
case V_699 :
V_73 [ 1 ] = F_230 ( V_5 , V_168 ) ;
break;
case V_700 :
return F_231 ( V_5 , V_168 , V_73 [ 1 ] ) ;
break;
default:
return - V_388 ;
}
...
static int F_240 ( unsigned V_716 ,
unsigned * V_717 ,
unsigned * V_718 ,
unsigned * V_719 )
{
...
static int F_237 ( struct V_4 * V_5 , unsigned V_676 ,
unsigned V_731 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
static int F_248 ( struct V_4 * V_5 , unsigned V_168 ,
unsigned V_676 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
if ( F_247 ( V_5 , V_168 , V_676 ) == 0 )
return - V_388 ;
if ( V_168 < 4 ) {
V_10 -> V_704 &= ~ F_249 ( V_168 ) ;
V_10 -> V_704 |=
F_238 ( V_168 , V_676 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_704 ,
V_709 ) ;
} else if ( V_168 < 8 ) {
V_10 -> V_710 &= ~ F_249 ( V_168 ) ;
V_10 -> V_710 |=
F_238 ( V_168 , V_676 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_710 ,
V_715 ) ;
...
static unsigned F_250 ( struct V_4 * V_5 , unsigned V_168 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
if ( V_168 < 4 ) {
return F_251 ( V_168 ,
V_10 -> V_704 ) ;
} else if ( V_168 < F_241 ( V_5 ) ) {
return F_251 ( V_168 ,
V_10 -> V_710 ) ;
} else {
if ( V_168 == V_755 )
...
break;
case V_643 :
return F_237 ( V_5 , V_73 [ 1 ] , V_73 [ 2 ] ) ;
break;
case V_644 :
V_73 [ 1 ] = V_10 -> V_636 ;
V_73 [ 2 ] = V_10 -> V_306 ;
...
break;
case V_698 :
return F_248 ( V_5 , V_168 , V_73 [ 1 ] ) ;
break;
case V_699 :
V_73 [ 1 ] = F_250 ( V_5 , V_168 ) ;
return 2 ;
break;
default:
return - V_388 ;
...
static void F_257 ( struct V_4 * V_5 , unsigned short V_80 )
{
...
static void F_258 ( struct V_4 * V_5 , unsigned int V_80 ,
unsigned int V_766 )
{
...
V_768 ) ;
V_766 &= V_769 ;
F_257 ( V_5 , V_770 | V_766 ) ;
if ( F_254 ( V_5 ) )
F_19 ( V_5 , L_45 ) ;
}
static int F_259 ( struct V_4 * V_5 , unsigned short * V_73 )
{
int V_190 ;
unsigned short V_126 ;
F_257 ( V_5 , V_770 | V_771 ) ;
V_190 = F_254 ( V_5 ) ;
if ( V_190 ) {
F_19 ( V_5 ,
L_46 ) ;
...
V_779 | V_780 ;
#if 1
F_258 ( V_5 , V_274 | V_781 ,
V_782 ) ;
F_259 ( V_5 , NULL ) ;
#else
F_258 ( V_5 , 0x400000 , V_783 ) ;
F_258 ( V_5 , V_274 | V_784 ,
V_782 ) ;
if ( F_254 ( V_5 ) )
F_19 ( V_5 , L_49 ) ;
#endif
