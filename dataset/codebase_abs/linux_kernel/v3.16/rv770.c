...
V_2 -> V_201 . V_202 . V_235 = V_2 -> V_201 . V_202 . V_205 ;
V_199 = ( F_19 ( V_229 ) >> 16 ) & V_236 ;
V_41 = ( V_192 & V_237 ) >> V_238 ;
V_41 = F_69 ( V_2 , V_41 , V_2 -> V_201 . V_202 . V_207 ,
V_230 , V_199 ) ;
V_192 |= V_41 << 16 ;
V_2 -> V_201 . V_202 . V_239 = V_41 ;
if ( V_2 -> V_9 == V_22 )
V_192 |= F_70 ( 1 ) ;
else {
if ( ( V_195 & V_240 ) >> V_241 )
V_192 |= F_70 ( 1 ) ;
else
V_192 |= F_70 ( 0 ) ;
}
V_2 -> V_201 . V_202 . V_242 = 4 << ( ( V_192 >> 4 ) & 0x3 ) ;
V_192 |= F_71 ( ( V_195 & V_243 ) >> V_244 ) ;
if ( ( ( V_195 & V_245 ) >> V_246 ) > 3 ) {
V_192 |= F_72 ( 3 ) ;
V_192 |= F_73 ( 3 ) ;
} else {
V_192 |=
F_72 ( ( ( V_195 & V_245 ) >> V_246 ) ) ;
V_192 |=
F_73 ( ( ( V_195 & V_245 ) >> V_246 ) ) ;
}
V_192 |= F_74 ( 1 ) ;
V_2 -> V_201 . V_202 . V_247 = V_192 ;
F_21 ( V_248 , V_192 ) ;
...
F_21 ( V_255 , ( V_192 & 0xffff ) ) ;
}
F_21 ( V_256 , 0 ) ;
F_21 ( V_257 , 0 ) ;
F_21 ( V_258 , 0 ) ;
F_21 ( V_259 , 0 ) ;
V_179 = V_226 - F_67 ( ( V_194 & V_224 ) >> 8 ) ;
F_21 ( V_260 , ( V_179 * 4 ) & V_261 ) ;
F_21 ( V_262 , ( ( V_179 * 4 ) - 2 ) & V_263 ) ;
F_21 ( V_264 , ( F_75 ( 0x16 ) |
F_76 ( 0x2b ) ) ) ;
F_21 ( V_265 , F_77 ( 0x30 ) ) ;
V_180 = F_19 ( V_266 ) ;
F_21 ( V_266 , V_180 | V_267 ) ;
V_181 = F_19 ( V_268 ) ;
V_181 |= V_269 ;
F_21 ( V_268 , V_181 ) ;
V_182 = F_19 ( V_270 ) ;
V_182 &= ~ F_78 ( 0x1ff ) ;
V_182 |= F_78 ( ( V_2 -> V_201 . V_202 . V_217 * 64 ) - 1 ) ;
F_21 ( V_270 , V_182 ) ;
if ( V_2 -> V_9 != V_10 )
F_21 ( V_271 , ( F_79 ( 4 ) |
F_80 ( 4 ) |
...
F_21 ( V_277 , ( F_83 ( ( V_2 -> V_201 . V_202 . V_213 / 4 ) - 1 ) |
F_84 ( ( V_2 -> V_201 . V_202 . V_214 / 4 ) - 1 ) |
F_85 ( ( V_2 -> V_201 . V_202 . V_215 / 4 ) - 1 ) ) ) ;
F_21 ( V_278 , ( F_86 ( V_2 -> V_201 . V_202 . V_218 ) |
F_87 ( V_2 -> V_201 . V_202 . V_219 ) |
F_88 ( V_2 -> V_201 . V_202 . V_220 ) ) ) ;
F_21 ( V_279 , 0 ) ;
F_21 ( V_280 , 1 ) ;
F_21 ( V_281 , F_89 ( 4 ) ) ;
F_21 ( V_282 , 0 ) ;
V_187 = ( F_90 ( 16 * V_2 -> V_201 . V_202 . V_216 ) |
F_91 ( 0xe0 ) |
F_92 ( 0x8 ) ) ;
switch ( V_2 -> V_9 ) {
case V_22 :
...
V_188 &= ~ V_286 ;
F_21 ( V_284 , V_188 ) ;
F_21 ( V_288 , ( F_98 ( ( V_2 -> V_201 . V_202 . V_208 * 24 ) / 64 ) |
F_99 ( ( V_2 -> V_201 . V_202 . V_208 * 24 ) / 64 ) |
F_100 ( ( ( V_2 -> V_201 . V_202 . V_208 * 24 ) / 64 ) / 2 ) ) ) ;
F_21 ( V_289 , ( F_101 ( ( V_2 -> V_201 . V_202 . V_208 * 7 ) / 64 ) |
F_102 ( ( V_2 -> V_201 . V_202 . V_208 * 7 ) / 64 ) ) ) ;
V_189 = ( F_103 ( ( V_2 -> V_201 . V_202 . V_209 * 4 ) / 8 ) |
F_104 ( ( V_2 -> V_201 . V_202 . V_209 * 2 ) / 8 ) |
F_105 ( ( V_2 -> V_201 . V_202 . V_209 * 1 ) / 8 ) ) ;
if ( ( ( V_2 -> V_201 . V_202 . V_209 * 1 ) / 8 ) > V_2 -> V_201 . V_202 . V_212 )
V_189 |= F_106 ( V_2 -> V_201 . V_202 . V_212 ) ;
else
V_189 |= F_106 ( ( V_2 -> V_201 . V_202 . V_212 * 1 ) / 8 ) ;
F_21 ( V_290 , V_189 ) ;
F_21 ( V_291 , ( F_107 ( ( V_2 -> V_201 . V_202 . V_210 * 1 ) / 4 ) |
F_108 ( ( V_2 -> V_201 . V_202 . V_210 * 1 ) / 4 ) ) ) ;
F_21 ( V_292 , ( F_109 ( ( V_2 -> V_201 . V_202 . V_210 * 1 ) / 4 ) |
F_110 ( ( V_2 -> V_201 . V_202 . V_210 * 1 ) / 4 ) ) ) ;
V_191 = ( F_111 ( ( V_2 -> V_201 . V_202 . V_208 * 38 ) / 64 ) |
F_112 ( ( V_2 -> V_201 . V_202 . V_208 * 38 ) / 64 ) |
F_113 ( ( V_2 -> V_201 . V_202 . V_208 * 38 ) / 64 ) |
F_114 ( ( V_2 -> V_201 . V_202 . V_208 * 38 ) / 64 ) ) ;
F_21 ( V_293 , V_191 ) ;
F_21 ( V_294 , V_191 ) ;
F_21 ( V_295 , V_191 ) ;
F_21 ( V_296 , V_191 ) ;
...
F_21 ( V_299 , V_191 ) ;
F_21 ( V_300 , V_191 ) ;
F_21 ( V_301 , ( F_115 ( 4095 ) |
F_116 ( 255 ) ) ) ;
if ( V_2 -> V_9 == V_33 )
F_21 ( V_302 , ( F_117 ( V_303 ) |
F_118 ( V_304 ) ) ) ;
else
F_21 ( V_302 , ( F_117 ( V_305 ) |
F_118 ( V_304 ) ) ) ;
switch ( V_2 -> V_9 ) {
case V_22 :
case V_30 :
...
void F_121 ( struct V_1 * V_2 , struct V_334 * V_105 )
{
T_2 V_335 , V_336 ;
if ( V_105 -> V_337 > 0xE0000000 ) {
F_50 ( V_2 -> V_84 , L_6 ) ;
V_105 -> V_338 = 0xE0000000 ;
V_105 -> V_337 = 0xE0000000 ;
}
if ( V_2 -> V_125 & V_126 ) {
V_335 = V_105 -> V_106 ;
V_336 = V_105 -> V_339 - V_105 -> V_108 ;
if ( V_335 > V_336 ) {
if ( V_105 -> V_337 > V_335 ) {
F_50 ( V_2 -> V_84 , L_6 ) ;
V_105 -> V_338 = V_335 ;
V_105 -> V_337 = V_335 ;
}
V_105 -> V_127 = V_105 -> V_106 - V_105 -> V_337 ;
} else {
if ( V_105 -> V_337 > V_336 ) {
F_50 ( V_2 -> V_84 , L_6 ) ;
V_105 -> V_338 = V_336 ;
V_105 -> V_337 = V_336 ;
}
...
V_105 -> V_130 = V_105 -> V_127 + V_105 -> V_337 - 1 ;
F_122 ( V_2 -> V_84 , L_7 ,
V_105 -> V_337 >> 20 , V_105 -> V_127 ,
V_105 -> V_130 , V_105 -> V_338 >> 20 ) ;
} else {
F_123 ( V_2 , & V_2 -> V_105 , 0 ) ;
V_2 -> V_105 . V_340 = 0 ;
F_124 ( V_2 , V_105 ) ;
}
}
...
V_2 -> V_105 . V_349 = V_342 * V_341 ;
V_2 -> V_105 . V_350 = F_126 ( V_2 -> V_25 , 0 ) ;
V_2 -> V_105 . V_351 = F_127 ( V_2 -> V_25 , 0 ) ;
V_2 -> V_105 . V_337 = F_19 ( V_352 ) ;
V_2 -> V_105 . V_338 = F_19 ( V_352 ) ;
V_2 -> V_105 . V_146 = V_2 -> V_105 . V_351 ;
F_121 ( V_2 , & V_2 -> V_105 ) ;
F_128 ( V_2 ) ;
return 0 ;
}
...
V_8 = F_140 ( V_2 , V_151 , V_151 -> V_355 , V_358 ,
V_359 ) ;
if ( V_8 )
return V_8 ;
V_151 = & V_2 -> V_151 [ V_353 ] ;
V_8 = F_140 ( V_2 , V_151 , V_151 -> V_355 , V_360 ,
F_141 ( V_361 , 0 , 0 , 0 ) ) ;
if ( V_8 )
return V_8 ;
V_8 = F_55 ( V_2 ) ;
...
if ( V_8 )
return V_8 ;
V_151 = & V_2 -> V_151 [ V_354 ] ;
if ( V_151 -> V_355 ) {
V_8 = F_140 ( V_2 , V_151 , V_151 -> V_355 , 0 ,
V_359 ) ;
if ( ! V_8 )
V_8 = F_144 ( V_2 ) ;
if ( V_8 )
...
{
int V_8 ;
F_148 ( V_2 -> V_49 . V_362 ) ;
F_15 ( V_2 ) ;
if ( V_2 -> V_69 . V_363 == V_364 )
F_149 ( V_2 ) ;
V_2 -> V_365 = true ;
V_8 = F_129 ( V_2 ) ;
if ( V_8 ) {
...
if ( V_8 )
return V_8 ;
if ( ! V_2 -> V_153 || ! V_2 -> V_154 || ! V_2 -> V_369 ) {
V_8 = F_170 ( V_2 ) ;
if ( V_8 ) {
F_137 ( L_19 ) ;
return V_8 ;
...
F_171 ( V_2 ) ;
V_2 -> V_151 [ V_145 ] . V_370 = NULL ;
F_172 ( V_2 , & V_2 -> V_151 [ V_145 ] , 1024 * 1024 ) ;
V_2 -> V_151 [ V_353 ] . V_370 = NULL ;
F_172 ( V_2 , & V_2 -> V_151 [ V_353 ] , 64 * 1024 ) ;
V_8 = F_173 ( V_2 ) ;
if ( ! V_8 ) {
V_2 -> V_151 [ V_354 ] . V_370 = NULL ;
F_172 ( V_2 , & V_2 -> V_151 [ V_354 ] ,
4096 ) ;
}
V_2 -> V_371 . V_370 = NULL ;
F_174 ( V_2 , 64 * 1024 ) ;
V_8 = F_175 ( V_2 ) ;
if ( V_8 )
return V_8 ;
...
if ( F_190 ( V_2 ) )
return;
if ( ( V_2 -> V_25 -> V_378 -> V_379 != V_380 ) &&
( V_2 -> V_25 -> V_378 -> V_379 != V_381 ) )
return;
F_40 ( L_21 ) ;
V_372 = F_191 ( V_382 ) ;
V_372 &= ~ V_383 ;
