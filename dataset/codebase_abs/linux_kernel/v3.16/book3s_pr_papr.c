...
V_11 [ 0 ] = F_9 ( F_4 ( V_2 , 6 ) ) ;
V_11 [ 1 ] = F_9 ( F_4 ( V_2 , 7 ) ) ;
V_6 += V_10 * V_21 ;
F_10 ( ( void V_16 * ) V_6 , V_11 , V_21 ) ;
F_11 ( V_2 , 4 , V_3 | V_10 ) ;
V_12 = V_22 ;
V_19:
...
long V_60 ;
V_60 = F_18 ( V_2 , V_57 , V_58 , V_59 ) ;
if ( V_60 == V_61 )
return V_62 ;
F_11 ( V_2 , 3 , V_60 ) ;
return V_23 ;
}
static int F_19 ( struct V_1 * V_2 , T_1 V_63 )
{
long V_60 = F_20 ( V_2 , V_63 ) ;
F_11 ( V_2 , 3 , V_60 ) ;
return V_23 ;
}
int F_21 ( struct V_1 * V_2 , unsigned long V_63 )
{
switch ( V_63 ) {
case V_64 :
return F_3 ( V_2 ) ;
...
case V_80 :
if ( F_26 ( V_2 ) )
return F_19 ( V_2 , V_63 ) ;
break;
case V_81 :
if ( F_27 ( & V_2 -> V_13 -> V_14 . V_82 ) )
return V_83 ;
if ( F_28 ( V_2 ) )
break;
F_11 ( V_2 , 3 , 0 ) ;
