...
case 0x10ec0293 :
V_9 = F_39 ( V_8 , 0x4a ) ;
F_127 ( V_8 , 0x4a , ( V_9 & 0xfff0 ) | 0x0008 ) ;
F_127 ( V_8 , 0x45 , 0xD429 ) ;
F_22 ( 300 ) ;
V_9 = F_39 ( V_8 , 0x46 ) ;
V_300 = ( V_9 & 0x0070 ) == 0x0070 ;
...
static unsigned int F_187 ( struct V_7 * V_8 ,
T_1 V_16 ,
unsigned int V_284 )
{
struct V_1 * V_2 = V_8 -> V_2 ;
if ( V_2 -> V_77 . V_171 )
if ( V_16 == V_8 -> V_191 || V_16 == 0x02 )
return V_286 ;
return V_284 ;
}
...
if ( F_6 ( V_8 , 0x51 , 0 , V_334 , 0 ) == 0x10ec5505 ) {
V_2 -> V_263 = 1 ;
V_2 -> V_128 = F_140 ;
}
V_121 = F_125 ( V_8 ) ;
...
V_8 -> V_132 = V_166 ;
#ifdef F_205
V_8 -> V_132 . V_335 = F_142 ;
V_8 -> V_132 . V_336 = F_144 ;
#endif
if ( ! V_2 -> V_130 )
V_2 -> V_130 = F_128 ;
F_61 ( V_8 , V_55 ) ;
...
{
static const T_1 V_337 [] = { 0x1d , 0 } ;
static const T_1 V_338 [] = { 0x0e , 0x0f , 0x0b , 0 } ;
return F_77 ( V_8 , V_337 , V_338 ) ;
}
...
return F_77 ( V_8 , V_343 , V_344 ) ;
}
static void F_211 ( struct V_7 * V_8 ,
const struct V_47 * V_48 , int V_49 )
{
if ( V_49 == V_50 ) {
F_212 ( V_8 , 0x18 , 0x00000734 ) ;
F_212 ( V_8 , 0x19 , 0x0000073c ) ;
}
}
...
if ( V_49 == V_127 ) {
struct V_1 * V_2 = V_8 -> V_2 ;
V_2 -> V_77 . V_350 [ 0 ] . V_351 [ 0 ] . V_352 = V_353 ;
}
}
static void F_218 ( void * V_277 , int V_278 )
{
struct V_7 * V_8 = V_277 ;
struct V_1 * V_2 = V_8 -> V_2 ;
unsigned int V_295 = V_2 -> V_296 ;
...
static unsigned int F_219 ( struct V_7 * V_8 ,
T_1 V_16 ,
unsigned int V_284 )
{
struct V_1 * V_2 = V_8 -> V_2 ;
...
static int F_222 ( struct V_7 * V_8 )
{
struct V_1 * V_2 ;
int V_121 ;
V_121 = F_80 ( V_8 , 0x0b ) ;
