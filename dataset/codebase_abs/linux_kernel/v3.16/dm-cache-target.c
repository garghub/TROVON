...
if ( V_21 -> V_105 ) {
F_93 ( V_12 , V_21 -> V_107 , false ) ;
F_38 ( V_12 , V_21 -> V_106 , V_21 -> V_41 ) ;
F_94 ( V_21 ) ;
return;
} else if ( V_21 -> V_108 ) {
...
F_38 ( V_12 , V_21 -> V_109 , V_21 -> V_41 ) ;
F_94 ( V_21 ) ;
}
}
...
while ( V_167 != V_169 ) {
V_27 = F_156 ( V_12 -> V_43 , F_157 ( V_167 ) ) ;
if ( ! V_27 ) {
V_27 = F_100 ( V_12 -> V_54 , F_157 ( V_167 ) ) ;
if ( V_27 )
break;
} else if ( V_27 == - V_170 ) {
V_27 = 0 ;
...
static bool F_162 ( struct V_12 * V_12 )
{
...
{
F_165 ( V_12 -> V_177 , F_58 ( & V_12 -> V_176 ) ) ;
}
...
{
F_165 ( V_12 -> V_100 , ! F_58 ( & V_12 -> V_99 ) ) ;
}
...
static void F_174 ( struct V_180 * V_181 )
{
struct V_12 * V_12 = F_175 ( V_181 , struct V_12 , V_14 ) ;
do {
if ( ! F_162 ( V_12 ) ) {
F_153 ( V_12 ) ;
F_152 ( V_12 ) ;
...
{
struct V_12 * V_12 = F_175 ( F_177 ( V_181 ) , struct V_12 , V_178 ) ;
F_178 ( V_12 -> V_43 ) ;
F_11 ( V_12 ) ;
F_179 ( V_12 -> V_13 , & V_12 -> V_178 , V_160 ) ;
}
static int F_180 ( struct V_182 * V_32 , int V_183 )
{
struct V_184 * V_185 = F_181 ( V_32 -> V_80 ) ;
return F_182 ( & V_185 -> V_186 , V_183 ) ;
}
static int F_183 ( struct V_187 * V_188 , int V_183 )
{
struct V_12 * V_12 = F_175 ( V_188 , struct V_12 , V_189 ) ;
return F_180 ( V_12 -> V_79 , V_183 ) ||
F_180 ( V_12 -> V_83 , V_183 ) ;
}
...
F_190 ( V_12 -> V_54 ) ;
if ( V_12 -> V_192 )
F_191 ( V_12 -> V_44 , V_12 -> V_192 ) ;
if ( V_12 -> V_79 )
F_191 ( V_12 -> V_44 , V_12 -> V_79 ) ;
if ( V_12 -> V_83 )
F_191 ( V_12 -> V_44 , V_12 -> V_83 ) ;
if ( V_12 -> V_43 )
F_192 ( V_12 -> V_43 ) ;
for ( V_190 = 0 ; V_190 < V_12 -> V_193 ; V_190 ++ )
F_193 ( V_12 -> V_194 [ V_190 ] ) ;
F_193 ( V_12 -> V_194 ) ;
F_193 ( V_12 ) ;
}
static void F_194 ( struct V_195 * V_44 )
{
struct V_12 * V_12 = V_44 -> V_196 ;
F_184 ( V_12 ) ;
}
static T_9 F_195 ( struct V_182 * V_32 )
{
return F_196 ( V_32 -> V_80 -> V_197 ) >> V_128 ;
}
static void F_197 ( struct V_198 * V_199 )
{
if ( V_199 -> V_192 )
F_191 ( V_199 -> V_44 , V_199 -> V_192 ) ;
if ( V_199 -> V_83 )
F_191 ( V_199 -> V_44 , V_199 -> V_83 ) ;
if ( V_199 -> V_79 )
F_191 ( V_199 -> V_44 , V_199 -> V_79 ) ;
F_193 ( V_199 ) ;
}
static bool F_198 ( struct V_200 * V_201 , char * * error )
{
if ( ! V_201 -> V_202 ) {
* error = L_10 ;
return false ;
...
static int F_199 ( struct V_198 * V_199 , struct V_200 * V_201 ,
char * * error )
{
int V_27 ;
T_9 V_203 ;
char V_39 [ V_204 ] ;
if ( ! F_198 ( V_201 , error ) )
return - V_205 ;
V_27 = F_200 ( V_199 -> V_44 , F_201 ( V_201 ) , V_206 | V_207 ,
& V_199 -> V_192 ) ;
if ( V_27 ) {
* error = L_11 ;
return V_27 ;
}
V_203 = F_195 ( V_199 -> V_192 ) ;
if ( V_203 > V_208 )
F_104 ( L_12 ,
F_202 ( V_199 -> V_192 -> V_80 , V_39 ) , V_209 ) ;
return 0 ;
}
...
if ( ! F_198 ( V_201 , error ) )
return - V_205 ;
if ( F_206 ( F_201 ( V_201 ) , 10 , & V_213 ) || ! V_213 ||
V_213 < V_214 ||
V_213 > V_215 ||
V_213 & ( V_214 - 1 ) ) {
* error = L_16 ;
...
static void F_207 ( struct V_63 * V_216 )
{
V_216 -> V_217 = V_218 ;
V_216 -> V_65 = V_67 ;
}
static int F_208 ( struct V_198 * V_199 , struct V_200 * V_201 ,
char * * error )
{
...
F_207 ( V_216 ) ;
V_27 = F_209 ( V_220 , V_201 , & V_202 , error ) ;
if ( V_27 )
return - V_205 ;
while ( V_202 -- ) {
V_221 = F_201 ( V_201 ) ;
...
if ( ! F_198 ( V_201 , error ) )
return - V_205 ;
V_199 -> V_222 = F_201 ( V_201 ) ;
V_27 = F_209 ( V_220 , V_201 , & V_199 -> V_223 , error ) ;
if ( V_27 )
return - V_205 ;
V_199 -> V_224 = ( const char * * ) V_201 -> V_225 ;
F_211 ( V_201 , V_199 -> V_223 ) ;
return 0 ;
}
static int F_212 ( struct V_198 * V_199 , int V_202 , char * * V_225 ,
char * * error )
{
int V_27 ;
struct V_200 V_201 ;
...
if ( V_27 )
return V_27 ;
V_27 = F_208 ( V_199 , & V_201 , error ) ;
if ( V_27 )
return V_27 ;
V_27 = F_210 ( V_199 , & V_201 , error ) ;
if ( V_27 )
return V_27 ;
return 0 ;
}
...
{
int V_27 = F_213 ( V_12 , V_30 , V_226 ) ;
if ( V_27 == V_227 )
V_27 = F_215 ( V_12 -> V_43 , V_30 , V_226 ) ;
if ( V_27 )
F_104 ( L_25 , V_30 , V_226 ) ;
return V_27 ;
}
static int F_216 ( struct V_12 * V_12 , int V_202 , const char * * V_225 )
{
int V_27 = 0 ;
if ( V_202 & 1 ) {
F_104 ( L_26 ) ;
...
while ( V_202 ) {
V_27 = F_214 ( V_12 , V_225 [ 0 ] , V_225 [ 1 ] ) ;
if ( V_27 )
break;
V_202 -= 2 ;
V_225 += 2 ;
...
static int F_217 ( struct V_12 * V_12 , struct V_198 * V_199 ,
char * * error )
{
struct V_228 * V_20 = F_218 ( V_199 -> V_222 ,
V_12 -> V_229 ,
V_12 -> V_211 ,
V_12 -> V_84 ) ;
if ( F_219 ( V_20 ) ) {
...
static int F_221 ( struct V_198 * V_199 , struct V_12 * * V_230 )
{
int V_27 = 0 ;
...
V_12 -> V_189 . V_242 = F_183 ;
F_223 ( V_44 -> V_45 , & V_12 -> V_189 ) ;
...
V_12 -> V_229 = F_157 ( V_229 ) ;
} else {
V_12 -> V_46 = F_225 ( V_199 -> V_213 ) ;
V_12 -> V_229 = F_157 ( V_199 -> V_210 >> V_12 -> V_46 ) ;
}
V_27 = F_217 ( V_12 , V_199 , error ) ;
if ( V_27 )
goto V_243;
V_12 -> V_244 = V_199 -> V_223 ;
V_12 -> V_141 = V_245 ;
V_27 = F_216 ( V_12 , V_199 -> V_223 , V_199 -> V_224 ) ;
if ( V_27 ) {
* error = L_28 ;
goto V_243;
}
V_54 = F_226 ( V_12 -> V_192 -> V_80 ,
V_199 -> V_213 , V_233 ,
F_227 ( V_12 -> V_43 ) ) ;
if ( F_219 ( V_54 ) ) {
* error = L_29 ;
...
V_12 -> V_126 = F_231 ( & V_248 ) ;
if ( F_219 ( V_12 -> V_126 ) ) {
* error = L_34 ;
V_27 = F_220 ( V_12 -> V_126 ) ;
goto V_243;
}
V_12 -> V_13 = F_232 ( L_35 V_249 , V_250 ) ;
if ( ! V_12 -> V_13 ) {
* error = L_36 ;
goto V_243;
}
F_233 ( & V_12 -> V_14 , F_174 ) ;
F_234 ( & V_12 -> V_178 , F_176 ) ;
V_12 -> V_159 = V_137 ;
V_12 -> V_16 = F_235 ( V_251 ) ;
if ( ! V_12 -> V_16 ) {
* error = L_37 ;
goto V_243;
}
...
static int F_238 ( struct V_12 * V_12 , int V_202 , const char * * V_225 )
{
unsigned V_190 ;
const char * * V_257 ;
V_257 = F_239 ( V_202 , sizeof( * V_257 ) , V_234 ) ;
if ( ! V_257 )
return - V_23 ;
for ( V_190 = 0 ; V_190 < V_202 ; V_190 ++ ) {
V_257 [ V_190 ] = F_240 ( V_225 [ V_190 ] , V_234 ) ;
if ( ! V_257 [ V_190 ] ) {
while ( V_190 -- )
F_193 ( V_257 [ V_190 ] ) ;
F_193 ( V_257 ) ;
...
static int F_241 ( struct V_195 * V_44 , unsigned V_202 , char * * V_225 )
{
int V_27 = - V_205 ;
struct V_198 * V_199 ;
struct V_12 * V_12 = NULL ;
V_199 = F_222 ( sizeof( * V_199 ) , V_234 ) ;
if ( ! V_199 ) {
V_44 -> error = L_40 ;
return - V_23 ;
}
V_199 -> V_44 = V_44 ;
V_27 = F_212 ( V_199 , V_202 , V_225 , & V_44 -> error ) ;
if ( V_27 )
goto V_258;
V_27 = F_221 ( V_199 , & V_12 ) ;
if ( V_27 )
goto V_258;
V_27 = F_238 ( V_12 , V_202 - 3 , ( const char * * ) V_225 + 3 ) ;
if ( V_27 ) {
F_184 ( V_12 ) ;
goto V_258;
}
...
static int F_242 ( struct V_195 * V_44 , struct V_8 * V_8 )
{
struct V_12 * V_12 = V_44 -> V_196 ;
int V_27 ;
T_3 V_33 = F_75 ( V_12 , V_8 ) ;
...
if ( F_243 ( F_27 ( V_33 ) >= F_27 ( V_12 -> V_231 ) ) ) {
F_68 ( V_12 , V_8 ) ;
return V_259 ;
}
...
static int F_244 ( struct V_195 * V_44 , struct V_8 * V_8 , int error )
{
struct V_12 * V_12 = V_44 -> V_196 ;
unsigned long V_48 ;
T_1 V_85 = F_63 ( V_12 ) ;
...
V_27 = F_246 ( V_12 -> V_54 , F_157 ( V_190 ) ,
F_32 ( V_12 , F_157 ( V_190 ) ) ) ;
if ( V_27 )
return V_27 ;
}
return 0 ;
...
{
unsigned V_190 , V_27 ;
V_27 = F_248 ( V_12 -> V_54 , V_12 -> V_84 ,
V_12 -> V_231 ) ;
if ( V_27 ) {
F_158 ( L_43 ) ;
return V_27 ;
...
V_27 = F_249 ( V_12 -> V_54 , F_76 ( V_190 ) ,
...
static bool F_250 ( struct V_12 * V_12 )
{
...
F_158 ( L_45 ) ;
F_57 ( V_12 ) ;
V_263 = F_251 ( V_12 -> V_54 , V_12 -> V_43 ) ;
if ( V_263 )
F_158 ( L_46 ) ;
...
static void F_252 ( struct V_195 * V_44 )
{
struct V_12 * V_12 = V_44 -> V_196 ;
F_166 ( V_12 ) ;
F_168 ( V_12 ) ;
...
static int F_253 ( void * V_119 , T_3 V_28 , T_5 V_41 ,
bool V_265 , T_8 V_266 , bool V_267 )
{
int V_27 ;
struct V_12 * V_12 = V_119 ;
V_27 = F_254 ( V_12 -> V_43 , V_28 , V_41 , V_266 , V_267 ) ;
if ( V_27 )
return V_27 ;
if ( V_265 )
F_35 ( V_12 , V_28 , V_41 ) ;
...
static int F_255 ( void * V_119 , T_9 V_268 ,
T_3 V_28 , bool V_269 )
{
struct V_12 * V_12 = V_119 ;
if ( V_269 )
...
static T_5 F_256 ( struct V_12 * V_12 )
{
T_9 V_270 = F_195 ( V_12 -> V_83 ) ;
( void ) F_70 ( V_270 , V_12 -> V_84 ) ;
return F_157 ( V_270 ) ;
}
static bool F_257 ( struct V_12 * V_12 , T_5 V_271 )
{
if ( F_34 ( V_271 ) > F_34 ( V_12 -> V_229 ) )
return true ;
while ( F_34 ( V_271 ) < F_34 ( V_12 -> V_229 ) ) {
V_271 = F_157 ( F_34 ( V_271 ) + 1 ) ;
if ( F_32 ( V_12 , V_271 ) ) {
F_158 ( L_48 ,
...
static int F_258 ( struct V_12 * V_12 , T_5 V_271 )
{
int V_27 ;
V_27 = F_259 ( V_12 -> V_54 , V_271 ) ;
if ( V_27 ) {
F_158 ( L_49 ) ;
return V_27 ;
}
...
static int F_260 ( struct V_195 * V_44 )
{
int V_27 = 0 ;
struct V_12 * V_12 = V_44 -> V_196 ;
T_5 V_272 = F_256 ( V_12 ) ;
if ( ! V_12 -> V_254 ) {
V_27 = F_258 ( V_12 , V_272 ) ;
if ( V_27 )
return V_27 ;
V_12 -> V_254 = true ;
...
if ( ! V_12 -> V_255 ) {
V_27 = F_261 ( V_12 -> V_54 , V_12 -> V_43 ,
F_253 , V_12 ) ;
if ( V_27 ) {
F_158 ( L_50 ) ;
return V_27 ;
...
if ( ! V_12 -> V_256 ) {
V_27 = F_262 ( V_12 -> V_54 , F_255 , V_12 ) ;
if ( V_27 ) {
F_158 ( L_51 ) ;
return V_27 ;
}
...
static void F_263 ( struct V_195 * V_44 )
{
struct V_12 * V_12 = V_44 -> V_196 ;
V_12 -> V_86 = true ;
F_176 ( & V_12 -> V_178 . V_134 ) ;
}
static void F_264 ( struct V_195 * V_44 , T_11 type ,
...
switch ( type ) {
case V_280 :
if ( ! ( V_273 & V_281 ) && ! F_265 ( V_44 ) ) {
V_27 = F_145 ( V_12 -> V_54 , false ) ;
if ( V_27 )
F_158 ( L_52 ) ;
}
V_27 = F_266 ( V_12 -> V_54 ,
& V_276 ) ;
if ( V_27 ) {
F_158 ( L_53 ) ;
goto V_96;
}
V_27 = F_267 ( V_12 -> V_54 , & V_277 ) ;
if ( V_27 ) {
F_158 ( L_54 ) ;
goto V_96;
}
V_279 = F_268 ( V_12 -> V_43 ) ;
F_269 ( L_55 ,
...
F_158 ( L_59 , ( int ) V_12 -> V_69 . V_65 ) ;
goto V_96;
}
F_269 ( L_60 , ( unsigned long long ) V_12 -> V_141 ) ;
F_269 ( L_61 , F_270 ( V_12 -> V_43 ) ) ;
if ( V_275 < V_274 ) {
V_27 = F_271 ( V_12 -> V_43 , V_230 + V_275 , V_274 - V_275 ) ;
if ( V_27 )
F_158 ( L_62 , V_27 ) ;
}
break;
case V_283 :
F_272 ( V_278 , V_12 -> V_192 -> V_80 -> V_284 ) ;
F_269 ( L_61 , V_278 ) ;
F_272 ( V_278 , V_12 -> V_83 -> V_80 -> V_284 ) ;
F_269 ( L_61 , V_278 ) ;
F_272 ( V_278 , V_12 -> V_79 -> V_80 -> V_284 ) ;
F_269 ( L_63 , V_278 ) ;
for ( V_190 = 0 ; V_190 < V_12 -> V_193 - 1 ; V_190 ++ )
F_269 ( L_64 , V_12 -> V_194 [ V_190 ] ) ;
if ( V_12 -> V_193 )
F_269 ( L_64 , V_12 -> V_194 [ V_12 -> V_193 - 1 ] ) ;
}
return;
V_96:
F_269 ( L_65 ) ;
}
static int F_273 ( struct V_12 * V_12 , const char * V_285 ,
struct V_286 * V_230 )
{
char V_287 ;
T_10 V_39 , V_288 ;
...
return V_27 ;
if ( V_27 == 2 ) {
V_230 -> V_167 = F_157 ( V_39 ) ;
V_230 -> V_169 = F_157 ( V_288 ) ;
return 0 ;
}
...
if ( V_27 == 1 ) {
V_230 -> V_167 = F_157 ( V_39 ) ;
V_230 -> V_169 = F_157 ( F_34 ( V_230 -> V_167 ) + 1u ) ;
return 0 ;
}
F_158 ( L_68 , V_285 ) ;
return - V_205 ;
...
if ( V_39 >= V_47 ) {
F_158 ( L_69 , V_39 , V_47 ) ;
return - V_205 ;
}
if ( V_288 > V_47 ) {
F_158 ( L_70 , V_288 , V_47 ) ;
return - V_205 ;
}
if ( V_39 >= V_288 ) {
F_158 ( L_71 , V_39 , V_288 ) ;
return - V_205 ;
}
return 0 ;
}
static int F_275 ( struct V_12 * V_12 , struct V_286 * V_289 )
{
struct V_165 V_166 ;
F_117 ( & V_166 . V_112 ) ;
V_166 . V_168 = V_289 ;
...
F_230 ( & V_166 . V_172 ) ;
F_160 ( & V_12 -> V_173 ) ;
F_276 ( & V_166 . V_112 , & V_12 -> V_174 ) ;
F_161 ( & V_12 -> V_173 ) ;
F_11 ( V_12 ) ;
F_165 ( V_166 . V_172 , F_58 ( & V_166 . V_171 ) ) ;
return V_166 . V_96 ;
}
static int F_277 ( struct V_12 * V_12 , unsigned V_124 ,
const char * * V_290 )
{
int V_27 = 0 ;
unsigned V_190 ;
...
V_27 = F_273 ( V_12 , V_290 [ V_190 ] , & V_289 ) ;
if ( V_27 )
break;
V_27 = F_274 ( V_12 , & V_289 ) ;
if ( V_27 )
break;
V_27 = F_275 ( V_12 , & V_289 ) ;
if ( V_27 )
break;
}
return V_27 ;
}
static int F_278 ( struct V_195 * V_44 , unsigned V_202 , char * * V_225 )
{
struct V_12 * V_12 = V_44 -> V_196 ;
if ( ! V_202 )
return - V_205 ;
if ( ! strcasecmp ( V_225 [ 0 ] , L_73 ) )
return F_277 ( V_12 , V_202 - 1 , ( const char * * ) V_225 + 1 ) ;
if ( V_202 != 2 )
return - V_205 ;
return F_214 ( V_12 , V_225 [ 0 ] , V_225 [ 1 ] ) ;
}
...
int V_27 = 0 ;
struct V_12 * V_12 = V_44 -> V_196 ;
V_27 = F_116 ( V_44 , V_12 -> V_83 , 0 , F_195 ( V_12 -> V_83 ) , V_292 ) ;
if ( ! V_27 )
V_27 = F_116 ( V_44 , V_12 -> V_79 , 0 , V_44 -> V_212 , V_292 ) ;
return V_27 ;
}
static int F_280 ( struct V_195 * V_44 ,
struct V_293 * V_294 ,
struct V_295 * V_296 , int V_297 )
{
struct V_12 * V_12 = V_44 -> V_196 ;
struct V_184 * V_185 = F_181 ( V_12 -> V_79 -> V_80 ) ;
if ( ! V_185 -> V_298 )
return V_297 ;
V_294 -> V_78 = V_12 -> V_79 -> V_80 ;
return F_281 ( V_297 , V_185 -> V_298 ( V_185 , V_294 , V_296 ) ) ;
}
static void F_282 ( struct V_12 * V_12 , struct V_299 * V_300 )
{
V_300 -> V_301 = V_12 -> V_84 ;
V_300 -> V_302 = V_12 -> V_84 << V_128 ;
}
static void F_283 ( struct V_195 * V_44 , struct V_299 * V_300 )
{
struct V_12 * V_12 = V_44 -> V_196 ;
