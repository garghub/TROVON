...
{
struct V_1 * V_75 ;
V_75 = F_74 ( V_87 , struct V_1 , V_88 ) ;
F_75 ( V_75 -> V_13 , V_75 , 1 ) ;
F_76 ( & V_75 -> V_51 ) ;
}
int F_77 ( struct V_32 * V_7 , int V_89 )
{
struct V_73 V_90 , V_91 ;
...
F_27 ( & V_7 -> V_55 ) ;
F_79 ( & V_7 -> V_56 , & V_90 ) ;
while ( ! F_30 ( & V_90 ) && V_89 ) {
V_75 = F_51 ( & V_90 , struct V_1 ,
V_49 ) ;
F_80 ( & V_75 -> V_49 ,
& V_7 -> V_56 ) ;
F_45 ( & V_75 -> V_46 ) ;
...
void F_87 ( struct V_16 * V_17 , int V_89 )
{
struct V_32 * V_7 ;
struct V_73 V_90 ;
int V_95 ;
...
struct V_73 V_90 ;
struct V_73 V_91 ;
struct V_103 * V_87 , * V_83 ;
int V_26 = 0 ;
F_22 ( & V_90 ) ;
F_22 ( & V_91 ) ;
F_78 ( & V_7 -> V_17 -> V_104 ) ;
F_27 ( & V_7 -> V_17 -> V_58 ) ;
F_79 ( & V_101 -> V_85 , & V_90 ) ;
while ( ! F_30 ( & V_90 ) ) {
V_99 = F_64 ( V_90 . V_83 , struct V_99 ,
V_85 ) ;
V_13 = & V_99 -> V_105 ;
F_52 ( & V_99 -> V_85 ) ;
V_13 = F_18 ( V_13 ) ;
...
V_26 = F_58 ( V_13 -> V_81 , V_28 , V_106 ) ;
if ( V_26 )
return V_26 ;
if ( F_57 ( V_108 ,
& F_16 ( V_13 ) -> V_109 ) ) {
...
V_26 = F_96 ( V_13 -> V_81 , V_28 , V_106 ) ;
if ( V_26 )
return V_26 ;
V_80 = V_106 ;
while ( 1 ) {
