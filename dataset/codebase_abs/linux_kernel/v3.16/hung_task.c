...
static unsigned long F_26 ( unsigned long V_12 )
{
return V_12 ? V_12 * V_35 : V_36 ;
}
int F_27 ( struct V_37 * V_38 , int V_39 ,
void T_2 * V_40 ,
T_3 * V_41 , T_4 * V_42 )
{
int V_43 ;
V_43 = F_28 ( V_38 , V_39 , V_40 , V_41 , V_42 ) ;
if ( V_43 || ! V_39 )
goto V_44;
F_29 ( V_45 ) ;
V_44:
