...
return F_39 ( V_5 , V_120 ) ;
}
static int F_46 ( struct V_4 * V_5 )
{
struct V_6 * V_6 = F_2 ( V_5 ) ;
int V_127 ;
V_127 = F_39 ( V_5 , V_122 ) ;
F_47 ( V_6 -> V_22 , true ) ;
return V_127 ;
}
...
{
return F_39 ( V_5 , V_122 ) ;
}
int F_51 ( struct V_128 * V_129 , struct V_22 * V_22 )
{
struct V_6 * V_6 ;
if ( F_52 ( V_22 ) )
return F_53 ( V_22 ) ;
V_6 = F_54 ( V_129 , sizeof( * V_6 ) , V_130 ) ;
if ( ! V_6 )
return - V_131 ;
F_55 ( V_129 , V_6 ) ;
V_6 -> V_22 = V_22 ;
return F_56 ( V_129 , & V_132 ,
V_133 , F_57 ( V_133 ) ) ;
}
