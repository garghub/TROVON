...
struct V_100 * V_100 ;
int V_72 , V_96 ;
V_84 -> clock [ 0 ] = F_44 ( V_4 -> V_30 , L_15 ) ;
...
if ( ! V_4 )
return - V_124 ;
V_270 = F_112 ( V_271 , & V_80 -> V_30 ) ;
if ( V_270 ) {
V_4 -> V_16 = V_270 -> V_142 ;
} else {
F_10 ( & V_80 -> V_30 , L_50 ) ;
return - V_94 ;
}
