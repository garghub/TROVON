...
if ( ! F_103 ( V_15 , V_121 ) || V_123 -> V_182 == NULL )
return;
F_104 ( V_123 -> V_182 , V_178 ) ;
}
...
if ( ! F_103 ( V_15 , V_121 ) )
return;
F_110 ( V_123 -> V_182 , V_123 -> V_184 -= V_183 ) ;
}
int F_111 ( const struct V_14 * V_15 , struct V_97 * V_74 ,
struct V_100 * V_121 , T_4 V_168 , T_3 V_185 , int * V_186 )
{
struct V_107 * V_108 = F_112 ( V_15 ) ;
struct V_112 * V_112 = F_61 ( V_74 ) ;
T_4 V_187 = V_168 + V_185 - 1 ;
T_4 V_188 ;
int V_53 ;
F_67 ( V_74 ) ;
V_53 = F_113 ( V_15 , V_74 , V_108 ) ;
if ( V_53 == 0 ) {
V_188 = V_108 -> V_189 ;
if ( V_187 > V_188 ) {
F_70 ( V_74 ) ;
V_53 = F_114 ( V_15 , V_121 , V_112 , V_74 , 0 ) ;
if ( V_53 == 0 && V_186 != NULL ) {
T_4 V_178 = F_115 ( V_112 ) ;
unsigned long V_190 = V_168 >> V_191 ;
if ( ( V_178 == 0 && V_190 != 0 ) ||
( ( ( V_178 - 1 ) >> V_191 ) < V_190 ) )
* V_186 = 1 ;
}
...
if ( F_115 ( V_112 ) < V_188 ) {
F_116 ( V_112 , V_188 ) ;
F_100 ( V_172 ,
V_192 L_4 V_193 L_5 ,
F_117 ( F_118 ( & V_74 -> V_194 ) ) ,
( V_195 ) F_115 ( V_112 ) ) ;
}
}
}
...
void F_119 ( const struct V_14 * V_15 ,
const struct V_196 * V_120 , int V_197 )
{
struct V_51 * V_52 ;
if ( V_197 > 0 )
F_120 ( V_120 -> V_198 , V_120 -> V_199 -> V_200 , V_197 ) ;
V_52 = F_121 ( V_120 ) ;
F_5 ( V_52 , V_54 ) ;
}
void F_122 ( const struct V_14 * V_15 ,
...
V_108 -> V_209 = F_123 ( V_112 ,
V_120 -> V_199 -> V_200 ) ;
}
if ( V_120 -> V_199 -> V_200 == V_210 ) {
if ( V_202 & V_211 ) {
V_204 -> V_212 |= V_211 ;
V_204 -> V_213 = F_124 ( V_112 ) -> V_214 ;
V_205 |= V_215 | V_216 |
V_217 | V_218 ;
}
}
F_125 ( V_204 , V_112 , V_205 & V_202 ) ;
F_126 ( V_204 , & F_124 ( V_112 ) -> V_219 ) ;
memcpy ( V_108 -> V_220 , F_124 ( V_112 ) -> V_221 ,
V_222 ) ;
}
int F_127 ( struct V_112 * V_112 , const struct V_223 * V_108 ,
struct V_224 * V_225 )
{
struct V_14 * V_15 ;
struct V_100 * V_121 ;
...
return F_35 ( V_15 ) ;
V_121 = F_129 ( V_15 ) ;
V_121 -> V_165 = F_124 ( V_112 ) -> V_227 ;
V_121 -> V_179 . V_228 . V_229 . V_114 = F_130 ( V_108 -> V_230 ) ;
V_121 -> V_179 . V_228 . V_229 . V_113 = F_130 ( V_108 -> V_231 ) ;
V_121 -> V_179 . V_228 . V_229 . V_115 = F_130 ( V_108 -> V_232 ) ;
V_121 -> V_179 . V_228 . V_229 . V_116 = V_108 -> V_233 ;
V_121 -> V_179 . V_228 . V_234 = V_108 -> V_235 ;
V_121 -> V_179 . V_228 . V_236 = V_225 ;
V_237:
if ( F_131 ( V_15 , V_121 , V_238 , V_121 -> V_165 ) == 0 ) {
struct V_122 * V_123 = F_76 ( V_15 ) ;
if ( V_108 -> V_235 & V_239 )
V_123 -> V_133 = F_132 ( V_112 , V_108 ) ;
V_53 = F_133 ( V_15 , V_121 ) ;
} else {
V_53 = V_121 -> V_240 ;
}
F_134 ( V_15 , V_121 ) ;
if ( F_135 ( V_121 -> V_241 ) )
goto V_237;
...
{
return F_136 ( V_17 , struct V_20 , V_42 . V_43 ) ;
}
struct V_20 * F_137 ( const struct V_47 * V_17 )
{
return F_136 ( V_17 , struct V_20 , V_42 ) ;
}
...
{
return F_136 ( V_74 , struct V_72 , V_80 . V_194 ) ;
}
struct V_72 * F_138 ( const struct V_97 * V_74 )
{
return F_136 ( V_74 , struct V_72 , V_80 ) ;
}
struct V_103 * F_91 ( const struct V_147 * V_120 )
{
return F_139 ( V_120 , struct V_103 , V_106 ) ;
}
struct V_122 * F_109 ( const struct V_14 * V_15 ,
const struct V_162 * V_120 )
{
struct V_122 * V_123 ;
V_123 = F_139 ( V_120 , struct V_122 , V_244 ) ;
F_11 ( V_123 == F_76 ( V_15 ) ) ;
return V_123 ;
}
struct V_51 * F_121 ( const struct V_196 * V_120 )
{
return F_136 ( V_120 , struct V_51 , V_55 ) ;
}
struct V_118 * F_74 ( const struct V_119 * V_120 )
{
return F_140 ( V_120 ) -> V_245 ;
}
int F_57 ( const struct V_97 * V_74 )
{
struct V_112 * V_112 = F_61 ( V_74 ) ;
struct V_246 * V_247 = F_124 ( V_112 ) ;
return ( F_141 ( F_142 ( V_112 ) ) ||
F_142 ( V_112 ) == 0 ) && V_247 -> V_227 == V_74 ;
}
struct V_112 * F_61 ( const struct V_97 * V_74 )
{
return F_138 ( V_74 ) -> V_85 ;
}
struct V_127 * F_143 ( struct V_118 * V_248 )
{
F_144 ( F_145 ( V_248 ) ) ;
return (struct V_127 * ) V_248 -> V_249 ;
}
int F_146 ( struct V_112 * V_112 , struct V_250 * V_251 )
{
struct V_14 * V_15 ;
struct V_246 * V_247 ;
struct V_97 * V_252 ;
...
F_11 ( F_141 ( F_142 ( V_112 ) ) ) ;
V_15 = F_128 ( & V_226 ) ;
if ( F_34 ( V_15 ) )
return F_35 ( V_15 ) ;
V_41 = F_147 ( V_112 ) -> V_259 ;
V_247 = F_124 ( V_112 ) ;
V_255 = & V_247 -> V_219 ;
F_11 ( F_148 ( V_255 ) ) ;
if ( V_247 -> V_227 == NULL ) {
...
V_252 = F_149 ( V_15 , F_10 ( V_41 -> V_265 ) ,
V_255 , & V_84 ) ;
if ( ! F_34 ( V_252 ) ) {
V_247 -> V_227 = V_252 ;
V_247 -> V_266 = F_150 ( V_251 -> V_267 ) ;
F_151 ( & V_252 -> V_194 , L_6 , V_112 ) ;
} else
V_53 = F_35 ( V_252 ) ;
} else {
V_53 = F_152 ( V_15 , V_247 -> V_227 , & V_84 ) ;
}
F_39 ( V_15 , & V_226 ) ;
if ( V_53 != 0 )
F_22 ( L_7 V_192 L_8 ,
...
static void F_153 ( struct V_14 * V_15 , struct V_97 * V_74 )
{
struct V_68 * V_268 = V_74 -> V_194 . V_94 ;
T_7 V_269 ;
if ( F_135 ( F_154 ( & V_268 -> V_270 ) != 1 ) ) {
struct V_253 * V_41 = V_74 -> V_194 . V_90 -> V_24 ;
struct V_271 * V_272 ;
V_272 = F_155 ( V_41 , & V_268 -> V_273 ) ;
F_156 ( & V_269 , V_274 ) ;
F_157 ( & V_272 -> V_275 , & V_269 ) ;
while ( 1 ) {
F_158 ( V_276 ) ;
if ( F_154 ( & V_268 -> V_270 ) == 1 )
break;
F_159 () ;
}
F_158 ( V_277 ) ;
F_160 ( & V_272 -> V_275 , & V_269 ) ;
}
F_161 ( V_15 , V_74 ) ;
}
void F_162 ( struct V_112 * V_112 )
{
struct V_14 * V_15 ;
struct V_246 * V_247 = F_124 ( V_112 ) ;
...
T_8 F_171 ( struct V_281 * V_282 )
{
T_8 type = 0 ;
struct V_283 * V_284 ;
int V_285 = 0 ;
if ( F_172 ( V_282 -> V_286 ) & V_287 ) {
const unsigned V_288 = sizeof( struct V_283 ) - 1 ;
V_285 = F_173 ( V_282 -> V_289 ) ;
V_285 = ( V_285 + V_288 ) & ~ V_288 ;
V_284 = ( void * ) V_282 -> V_290 + V_285 ;
type = F_174 ( F_173 ( V_284 -> V_291 ) ) ;
}
return type ;
}
V_195 F_175 ( const struct V_254 * V_255 , int V_292 )
{
if ( V_293 == 32 || V_292 )
return F_176 ( V_255 ) ;
else
...
T_1 F_178 ( const struct V_254 * V_255 )
{
T_1 V_294 ;
if ( F_179 ( V_255 ) ) {
V_294 = F_180 ( V_255 ) ;
...
V_294 = ( F_177 ( V_255 ) >> 32 ) ;
return V_294 ;
}
struct V_295 * F_181 ( struct V_112 * V_112 )
{
return F_182 ( F_124 ( V_112 ) -> V_227 ) ;
}
void inline F_183 ( struct V_112 * V_112 , struct V_295 * V_267 )
{
F_184 ( F_124 ( V_112 ) -> V_227 , V_267 ) ;
}
