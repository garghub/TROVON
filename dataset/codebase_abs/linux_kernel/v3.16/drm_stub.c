...
static int F_32 ( struct V_28 * V_29 , unsigned int type )
{
struct V_13 * V_60 ;
unsigned long V_61 ;
int V_44 ;
...
static void F_45 ( struct V_28 * V_29 , unsigned int type )
{
struct V_13 * V_14 ;
unsigned long V_61 ;
V_14 = * F_28 ( V_29 , type ) ;
...
struct V_13 * F_47 ( unsigned int V_62 )
{
struct V_13 * V_14 ;
unsigned long V_61 ;
F_35 ( & V_63 , V_61 ) ;
...
static struct V_74 * F_58 ( struct V_75 * V_76 , int V_61 ,
...
static struct V_80 * F_60 ( void )
{
struct V_80 * V_80 ;
int V_5 ;
V_5 = F_61 ( & V_81 , & V_82 , & V_83 ) ;
if ( V_5 < 0 ) {
F_40 ( L_10 , V_5 ) ;
return F_50 ( V_5 ) ;
}
...
static void F_65 ( struct V_80 * V_80 )
{
if ( V_80 ) {
F_66 ( V_80 ) ;
F_64 ( & V_82 , & V_83 ) ;
...
struct V_28 * F_67 ( struct V_85 * V_34 ,
struct V_86 * V_87 )
{
struct V_28 * V_29 ;
int V_44 ;
...
static void F_75 ( struct V_24 * V_88 )
{
...
int F_77 ( struct V_28 * V_29 , unsigned long V_61 )
{
int V_44 ;
F_16 ( & V_72 ) ;
V_44 = F_32 ( V_29 , V_55 ) ;
...
goto V_100;
if ( V_29 -> V_34 -> V_108 ) {
V_44 = V_29 -> V_34 -> V_108 ( V_29 , V_61 ) ;
if ( V_44 )
goto V_100;
}
if ( F_70 ( V_29 , V_99 ) ) {
...
int F_83 ( struct V_28 * V_29 , const char * V_6 , ... )
{
T_1 V_112 ;
F_10 ( V_29 -> V_37 ) ;
va_start ( V_112 , V_6 ) ;
V_29 -> V_37 = F_84 ( V_16 , V_6 , V_112 ) ;
va_end ( V_112 ) ;
return V_29 -> V_37 ? 0 : - V_57 ;
}
