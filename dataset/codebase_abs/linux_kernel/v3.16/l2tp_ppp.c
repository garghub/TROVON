...
static void F_98 ( struct V_72 * V_72 , struct V_213 * V_214 )
{
for (; ; ) {
V_214 -> V_43 = F_99 ( V_72 , V_214 -> V_215 ) ;
V_214 -> V_215 ++ ;
if ( V_214 -> V_43 == NULL )
break;
if ( V_214 -> V_43 -> V_150 < 3 )
break;
}
}
static void F_100 ( struct V_72 * V_72 , struct V_213 * V_214 )
{
V_214 -> V_4 = F_101 ( V_214 -> V_43 , V_214 -> V_216 ) ;
V_214 -> V_216 ++ ;
if ( V_214 -> V_4 == NULL ) {
V_214 -> V_216 = 0 ;
F_98 ( V_72 , V_214 ) ;
...
static void * F_102 ( struct V_87 * V_39 , T_4 * V_217 )
{
...
F_100 ( V_72 , V_214 ) ;
if ( ( V_214 -> V_43 == NULL ) && ( V_214 -> V_4 == NULL ) )
V_214 = NULL ;
V_6:
return V_214 ;
}
static void * F_104 ( struct V_87 * V_39 , void * V_220 , T_4 * V_219 )
{
( * V_219 ) ++ ;
return NULL ;
}
static void F_105 ( struct V_87 * V_221 , void * V_220 )
{
}
static void F_106 ( struct V_87 * V_39 , void * V_220 )
{
struct V_42 * V_43 = V_220 ;
F_60 ( V_39 , L_26 ,
V_43 -> V_35 ,
...
static void F_108 ( struct V_87 * V_39 , void * V_220 )
{
...
V_223 = F_109 ( V_147 -> V_225 ) ;
V_224 = F_110 ( V_147 -> V_226 ) ;
}
F_60 ( V_39 , L_28
L_29 ,
V_4 -> V_35 , V_223 , V_224 ,
V_43 -> V_98 ,
V_4 -> V_100 ,
V_43 -> V_99 ,
V_4 -> V_101 ,
...
static int F_111 ( struct V_87 * V_39 , void * V_220 )
{
struct V_213 * V_214 = V_220 ;
if ( V_220 == V_218 ) {
F_112 ( V_39 , L_34 V_229 L_35 ) ;
F_112 ( V_39 , L_36 ) ;
F_112 ( V_39 , L_37 ) ;
F_112 ( V_39 , L_38
L_39 ) ;
...
if ( V_214 -> V_4 == NULL )
F_106 ( V_39 , V_214 -> V_43 ) ;
else
F_108 ( V_39 , V_214 -> V_4 ) ;
V_6:
return 0 ;
}
static int F_113 ( struct V_230 * V_230 , struct V_231 * V_231 )
{
return F_114 ( V_230 , V_231 , & V_232 ,
sizeof( struct V_213 ) ) ;
}
...
struct V_233 * V_234 ;
int V_19 = 0 ;
V_234 = F_116 ( L_42 , V_235 , V_72 -> V_236 ,
& V_237 ) ;
if ( ! V_234 ) {
V_19 = - V_54 ;
goto V_6;
...
if ( V_19 )
goto V_239;
V_19 = F_122 ( V_81 , & V_240 ) ;
if ( V_19 )
goto V_241;
#ifdef F_123
V_19 = F_124 ( V_242 , & V_243 ) ;
if ( V_19 )
goto V_244;
#endif
F_125 ( L_43 , V_229 ) ;
