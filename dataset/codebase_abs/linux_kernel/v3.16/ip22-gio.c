...
static void F_35 ( int V_39 , unsigned long V_46 , int V_56 )
{
const char * V_33 = L_5 ;
struct V_3 * V_16 ;
T_3 V_8 ;
...
for ( V_57 = 0 ; V_57 < F_37 ( V_61 ) ; V_57 ++ ) {
if ( V_6 == V_61 [ V_57 ] . V_6 ) {
V_33 = V_61 [ V_57 ] . V_33 ;
break;
}
}
...
if ( F_33 ( T_8 , ( unsigned int * ) & V_76 -> T_8 [ 1 ] ) )
F_35 ( 0 , V_73 ,
V_77 ) ;
F_35 ( 1 , V_75 , V_78 ) ;
F_35 ( 2 , V_79 , V_80 ) ;
