...
F_76 ( & V_157 -> V_97 , L_12 ) ;
V_5 = F_77 ( & V_157 -> V_97 , V_166 , V_75 ) ;
...
if ( V_140 )
return V_140 ;
if ( F_79 ( V_157 , V_171 ) & V_172 )
V_169 = V_171 ;
else
V_169 = V_173 ;
V_140 = F_80 ( V_157 , 1 << V_169 , V_174 ) ;
if ( V_140 )
return V_140 ;
V_5 -> V_168 = V_168 = F_81 ( V_157 ) ;
V_4 -> V_7 = V_168 [ V_169 ] ;
V_4 -> V_162 = F_3 ( V_4 -> V_7 + V_121 ) ;
for ( V_69 = 0 ; V_69 < V_75 ; V_69 ++ ) {
struct V_1 * V_2 = V_5 -> V_77 [ V_69 ] ;
F_82 ( V_2 , V_169 , - 1 , L_13 ) ;
F_82 ( V_2 , V_169 , V_69 * V_9 , L_14 ) ;
}
V_140 = F_83 ( V_157 , F_84 ( 32 ) ) ;
if ( V_140 ) {
F_85 ( & V_157 -> V_97 , L_15 ) ;
return V_140 ;
}
V_140 = F_86 ( V_157 , F_84 ( 32 ) ) ;
if ( V_140 ) {
F_85 ( & V_157 -> V_97 , L_16 ) ;
return V_140 ;
}
V_140 = F_87 ( V_157 , 65536 - 512 ) ;
if ( V_140 ) {
F_85 ( & V_157 -> V_97 , L_17 ) ;
return V_140 ;
}
V_140 = F_69 ( V_4 -> V_7 , V_4 -> V_162 ) ;
if ( V_140 ) {
F_85 ( & V_157 -> V_97 , L_18 ) ;
return V_140 ;
}
F_88 ( V_157 ) ;
return F_89 ( V_5 , V_157 -> V_65 , F_27 , V_175 ,
& V_176 ) ;
}
