...
struct V_19 * V_20 = F_15 ( V_2 ) ;
struct V_9 * V_9 ;
struct V_21 * V_22 ;
void T_1 * V_23 ;
V_9 = F_16 ( V_2 , sizeof( * V_9 ) , V_24 ) ;
if ( ! V_9 )
return - V_25 ;
V_22 = F_17 ( V_18 , V_26 , 0 ) ;
if ( ! V_22 )
return - V_27 ;
V_23 = F_18 ( V_2 , V_22 -> V_28 , F_19 ( V_22 ) ) ;
if ( ! V_23 )
return - V_25 ;
V_29 . V_30 = V_22 -> V_31 - V_22 -> V_28 - 3 ;
if ( V_20 )
V_29 . V_32 = V_20 -> V_33 ;
V_9 -> V_7 = F_20 ( V_2 , V_23 ,
& V_29 ) ;
if ( F_21 ( V_9 -> V_7 ) ) {
F_22 ( V_2 , L_1 ) ;
return F_23 ( V_9 -> V_7 ) ;
