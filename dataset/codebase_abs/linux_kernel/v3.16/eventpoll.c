...
static int F_86 ( struct V_25 * * V_97 )
{
int error ;
struct V_98 * V_73 ;
struct V_25 * V_26 ;
...
static struct V_14 * F_92 ( struct V_25 * V_26 , struct V_1 * V_1 , int V_7 )
{
int V_102 ;
struct V_75 * V_76 ;
...
static int F_93 ( T_1 * V_13 , unsigned V_106 , int V_107 , void * V_108 )
{
int V_59 = 0 ;
unsigned long V_35 ;
...
struct V_12 * V_50 ;
if ( V_18 -> V_112 >= 0 && ( V_50 = F_94 ( V_53 , V_100 ) ) ) {
F_95 ( & V_50 -> V_13 , F_93 ) ;
V_50 -> V_51 = V_51 ;
V_50 -> V_15 = V_18 ;
F_96 ( V_51 , & V_50 -> V_13 ) ;
...
static void F_97 ( struct V_25 * V_26 , struct V_14 * V_18 )
{
int V_102 ;
...
F_98 ( & V_18 -> V_71 , V_113 , V_11 ) ;
F_99 ( & V_18 -> V_71 , & V_26 -> V_72 ) ;
}
static int F_100 ( int V_115 )
{
if ( V_115 == 0 )
return 0 ;
...
static int F_102 ( void * V_31 , void * V_32 , int V_34 )
{
int error = 0 ;
struct V_1 * V_1 = V_31 ;
struct V_1 * V_120 ;
struct V_14 * V_18 ;
F_31 () ;
F_103 (epi, &file->f_ep_links, fllink) {
V_120 = V_18 -> V_26 -> V_1 ;
if ( F_1 ( V_120 ) ) {
if ( F_5 ( & V_120 -> V_121 ) ) {
if ( F_100 ( V_34 ) ) {
