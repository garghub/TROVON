...
static int F_77 ( struct V_289 * V_4 )
{
struct V_148 * V_149 ;
struct V_2 * V_3 ;
struct V_6 * V_7 ;
...
F_84 ( & V_4 -> V_5 ) ;
#ifdef F_78
snprintf ( V_3 -> V_292 , sizeof( V_3 -> V_292 ) ,
L_33 , F_85 ( V_149 ) ) ;
V_3 -> V_258 . V_293 = V_3 -> V_292 ;
V_3 -> V_258 . V_260 = V_264 ;
V_3 -> V_258 . V_294 = F_85 ( V_149 ) ;
V_3 -> V_258 . V_295 = F_70 ;
...
static int F_91 ( struct V_289 * V_4 )
{
