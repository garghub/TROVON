...
static T_1
F_41 ( struct V_1 * V_2 , struct V_39 * V_40 ,
char * V_41 )
{
int V_24 ;
struct V_3 * V_4 ;
...
static T_1
F_42 ( struct V_1 * V_2 , struct V_39 * V_40 , const char * V_41 , T_2 V_44 )
{
...
F_51 ( V_4 -> V_14 , V_54 >> 9 ) ;
F_39 ( L_18
L_19 , V_53 , V_54 , V_54 >> 9 ) ;
V_4 -> V_52 = 0 ;
V_4 -> V_42 = 1 ;
V_4 -> V_2 . V_71 = V_55 ;
F_24 ( & V_36 ) ;
...
static T_1
F_56 ( struct V_1 * V_2 , struct V_39 * V_40 , const char * V_41 , T_2 V_44 )
{
struct V_3 * V_4 ;
struct V_5 * V_6 ;
int V_26 , V_24 ;
...
static int
F_58 ( struct V_79 * V_80 , T_3 V_81 )
{
struct V_3 * V_4 ;
int V_26 ;
V_4 = V_80 -> V_82 -> V_68 ;
...
static void
F_60 ( struct V_84 * V_85 , T_3 V_81 )
{
...
goto V_98;
if ( F_63 ( V_88 ) > F_64 ( V_88 -> V_97 -> V_82 ) ) {
goto V_98;
}
if ( V_4 -> V_42 ) {
switch ( V_4 -> V_32 ) {
...
F_67 (bvec, bio, iter) {
V_94 = ( unsigned long )
F_68 ( V_90 . V_103 ) + V_90 . V_104 ;
V_95 = V_4 -> V_23 + ( V_93 << 12 ) + V_96 ;
if ( F_69 ( ( V_94 & 4095 ) != 0 ) || ( V_90 . V_105 & 4095 ) != 0 )
goto V_98;
if ( F_65 ( V_88 ) == V_106 ) {
...
static int
F_72 ( struct V_79 * V_80 , T_4 V_107 ,
...
V_26 = F_90 ( V_55 , & V_123 ) ;
if ( V_26 )
goto V_124;
V_26 = F_90 ( V_55 , & V_125 ) ;
if ( V_26 )
goto V_124;
V_26 = F_91 ( 0 , V_120 ) ;
if ( V_26 < 0 )
