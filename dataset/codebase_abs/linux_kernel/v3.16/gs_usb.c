...
static struct V_1 * F_5 ( struct V_2 * V_3 , unsigned int V_11 )
{
unsigned long V_5 ;
if ( V_11 < V_7 ) {
F_2 ( & V_3 -> V_6 , V_5 ) ;
...
static T_1 F_36 ( struct V_63 * V_64 , struct V_56 * V_57 )
{
struct V_2 * V_3 = F_27 ( V_57 ) ;
...
static struct V_2 * F_61 ( unsigned int V_29 , struct V_17 * V_18 )
{
struct V_2 * V_3 ;
struct V_56 * V_57 ;
int V_20 ;
struct V_126 * V_127 ;
V_127 = F_28 ( sizeof( * V_127 ) , V_21 ) ;
if ( ! V_127 )
return F_62 ( - V_22 ) ;
V_20 = F_8 ( F_9 ( V_18 ) ,
F_63 ( F_9 ( V_18 ) , 0 ) ,
...
V_57 = F_64 ( sizeof( struct V_2 ) , V_7 ) ;
if ( ! V_57 ) {
F_30 ( & V_18 -> V_3 , L_12 ) ;
F_29 ( V_127 ) ;
return F_62 ( - V_22 ) ;
...
V_57 -> V_130 = & V_131 ;
V_57 -> V_5 |= V_132 ;
strcpy ( V_3 -> V_127 . V_133 , L_13 ) ;
V_3 -> V_127 . V_134 = V_127 -> V_134 ;
V_3 -> V_127 . V_135 = V_127 -> V_135 ;
V_3 -> V_127 . V_136 = V_127 -> V_136 ;
V_3 -> V_127 . V_137 = V_127 -> V_137 ;
V_3 -> V_127 . V_138 = V_127 -> V_138 ;
V_3 -> V_127 . V_139 = V_127 -> V_139 ;
V_3 -> V_127 . V_140 = V_127 -> V_140 ;
V_3 -> V_127 . V_141 = V_127 -> V_141 ;
V_3 -> V_82 = F_9 ( V_18 ) ;
V_3 -> V_19 = V_18 ;
V_3 -> V_57 = V_57 ;
V_3 -> V_29 = V_29 ;
...
V_3 -> V_34 . V_37 = V_142 ;
V_3 -> V_34 . clock . V_143 = V_127 -> V_144 ;
V_3 -> V_34 . V_145 = & V_3 -> V_127 ;
V_3 -> V_34 . V_146 = F_26 ;
V_3 -> V_34 . V_147 = 0 ;
if ( V_127 -> V_148 & V_149 )
V_3 -> V_34 . V_147 |= V_119 ;
if ( V_127 -> V_148 & V_150 )
V_3 -> V_34 . V_147 |= V_117 ;
if ( V_127 -> V_148 & V_151 )
V_3 -> V_34 . V_147 |= V_123 ;
if ( V_127 -> V_148 & V_152 )
V_3 -> V_34 . V_147 |= V_121 ;
F_29 ( V_127 ) ;
F_67 ( V_57 , & V_18 -> V_3 ) ;
V_20 = F_68 ( V_3 -> V_57 ) ;
if ( V_20 ) {
F_69 ( V_3 -> V_57 ) ;
F_30 ( & V_18 -> V_3 , L_14 , V_20 ) ;
return F_62 ( V_20 ) ;
}
return V_3 ;
}
...
static int F_72 ( struct V_17 * V_18 , const struct V_153 * V_11 )
{
struct V_12 * V_3 ;
int V_20 = - V_22 ;
unsigned int V_154 , V_4 ;
struct V_155 * V_156 ;
struct V_157 * V_158 ;
V_156 = F_28 ( sizeof( * V_156 ) , V_21 ) ;
if ( ! V_156 )
return - V_22 ;
V_156 -> V_159 = 0x0000beef ;
V_20 = F_8 ( F_9 ( V_18 ) ,
F_10 ( F_9 ( V_18 ) , 0 ) ,
V_160 ,
V_26 | V_27 | V_28 ,
1 ,
V_18 -> V_161 [ 0 ] . V_162 . V_163 ,
V_156 ,
sizeof( * V_156 ) ,
1000 ) ;
F_29 ( V_156 ) ;
...
F_74 ( V_18 , V_3 ) ;
V_3 -> V_82 = F_9 ( V_18 ) ;
for ( V_4 = 0 ; V_4 < V_154 ; V_4 ++ ) {
V_3 -> V_70 [ V_4 ] = F_61 ( V_4 , V_18 ) ;
if ( F_75 ( V_3 -> V_70 [ V_4 ] ) ) {
V_154 = V_4 ;
for ( V_4 = 0 ; V_4 < V_154 ; V_4 ++ ) {
F_70 ( V_3 -> V_70 [ V_4 ] ) ;
V_3 -> V_70 [ V_4 ] = NULL ;
