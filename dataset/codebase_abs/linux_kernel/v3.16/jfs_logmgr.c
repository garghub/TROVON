...
V_215 -> V_221 [ 0 ] . V_222 = V_26 -> V_206 ;
V_215 -> V_221 [ 0 ] . V_223 = V_61 ;
V_215 -> V_221 [ 0 ] . V_224 = V_26 -> V_205 ;
V_215 -> V_225 = 1 ;
V_215 -> V_218 . V_226 = V_61 ;
V_215 -> V_227 = V_228 ;
V_215 -> V_229 = V_26 ;
if ( log -> V_169 ) {
V_215 -> V_218 . V_226 = 0 ;
...
log -> V_184 = V_26 ;
V_26 -> V_86 = V_232 -> V_86 ;
V_232 -> V_86 = V_26 ;
}
V_232 = V_26 ;
}
if ( ( V_26 != V_232 -> V_86 ) || ! ( V_45 & V_89 ) ) {
F_100 ( V_19 ) ;
return;
}
F_100 ( V_19 ) ;
...
F_98 ( V_19 ) ;
F_99 ( V_26 -> V_207 , ( V_26 -> V_116 & V_236 ) , V_19 ) ;
...
static void V_228 ( struct V_215 * V_215 , int error )
{
struct V_25 * V_26 = V_215 -> V_229 ;
struct V_25 * V_80 , * V_232 ;
struct V_1 * log ;
unsigned long V_19 ;
F_5 ( L_43 , V_26 , V_26 -> V_116 ) ;
F_98 ( V_19 ) ;
V_26 -> V_116 |= V_236 ;
if ( ! F_35 ( V_237 , & V_215 -> V_238 ) ) {
V_26 -> V_116 |= V_117 ;
F_18 ( L_44 ) ;
}
F_109 ( V_215 ) ;
...
int F_117 ( struct V_1 * log , T_3 V_242 , int V_243 )
{
int V_93 = - V_96 ;
struct V_3 * V_4 ;
struct V_170 * V_170 ;
...
struct V_25 * V_26 ;
F_5 ( L_46 ,
( long long ) V_242 , V_243 ) ;
V_4 = F_29 ( log -> V_152 . V_66 , struct V_3 , V_161 ) ;
V_26 = F_32 ( log , 1 ) ;
V_245 = V_243 >> V_4 -> V_246 ;
V_170 = (struct V_170 * ) V_26 -> V_42 ;
V_170 -> V_174 = F_33 ( V_175 ) ;
V_170 -> V_247 = F_33 ( V_248 ) ;
V_170 -> V_177 = F_33 ( V_178 ) ;
V_170 -> V_45 = F_33 ( V_4 -> V_141 ) ;
V_170 -> V_92 = F_33 ( V_245 ) ;
V_170 -> V_249 = F_33 ( V_4 -> V_249 ) ;
V_170 -> V_167 = F_33 ( V_4 -> V_167 ) ;
V_170 -> V_179 = F_33 ( 2 * V_61 + V_63 + V_67 ) ;
V_26 -> V_116 = V_89 | V_180 | V_233 ;
V_26 -> V_209 = V_242 + V_4 -> V_250 ;
F_108 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
V_28 = (struct V_27 * ) V_26 -> V_42 ;
V_28 -> V_81 . V_70 = V_28 -> V_88 . V_70 = F_33 ( V_245 - 3 ) ;
V_28 -> V_81 . V_43 = V_28 -> V_88 . V_43 = F_21 ( V_63 + V_67 ) ;
V_244 = (struct V_11 * ) & V_28 -> V_47 ;
V_244 -> V_130 = 0 ;
V_244 -> V_131 = 0 ;
V_244 -> type = F_21 ( V_132 ) ;
V_244 -> V_60 = 0 ;
V_244 -> log . V_129 . V_128 = 0 ;
V_26 -> V_209 += V_4 -> V_250 ;
V_26 -> V_116 = V_89 | V_180 | V_233 ;
F_108 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
for ( V_79 = 0 ; V_79 < V_245 - 3 ; V_79 ++ ) {
...
static int F_118 ( struct V_251 * V_252 , void * V_253 )
{
F_119 ( V_252 ,
L_47
L_48
...
static int F_120 ( struct V_254 * V_254 , struct V_255 * V_255 )
{
return F_121 ( V_255 , F_118 , NULL ) ;
}
