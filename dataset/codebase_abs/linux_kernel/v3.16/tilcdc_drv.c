...
F_26 ( V_12 -> V_12 ) ;
V_54 = F_52 ( V_12 , F_53 ( V_12 -> V_47 , 0 ) ) ;
F_28 ( V_12 -> V_12 ) ;
if ( V_54 < 0 ) {
F_16 ( V_12 -> V_12 , L_23 ) ;
goto V_59;
...
static void F_57 ( struct V_11 * V_12 , struct V_13 * V_74 )
{
struct V_17 * V_18 = V_12 -> V_19 ;
F_58 ( V_18 -> V_21 , V_74 ) ;
}
...
static T_2 F_61 ( int V_75 , void * V_76 )
{
...
static void F_69 ( struct V_11 * V_12 , bool V_88 )
{
struct V_17 * V_18 = V_12 -> V_19 ;
T_1 V_89 , V_90 ;
if ( V_18 -> V_70 == 1 ) {
...
static int F_72 ( struct V_91 * V_92 , void * V_76 )
{
...
unsigned V_96 ;
F_26 ( V_12 -> V_12 ) ;
F_73 ( V_92 , L_25 , V_18 -> V_70 ) ;
for ( V_96 = 0 ; V_96 < F_74 ( V_97 ) ; V_96 ++ )
if ( V_18 -> V_70 >= V_97 [ V_96 ] . V_70 )
F_73 ( V_92 , L_26 , V_97 [ V_96 ] . V_3 ,
F_49 ( V_12 , V_97 [ V_96 ] . V_89 ) ) ;
F_28 ( V_12 -> V_12 ) ;
return 0 ;
}
static int F_75 ( struct V_91 * V_92 , void * V_76 )
{
struct V_93 * V_49 = (struct V_93 * ) V_92 -> V_94 ;
struct V_11 * V_12 = V_49 -> V_95 -> V_12 ;
return F_76 ( V_92 , & V_12 -> V_98 -> V_99 ) ;
}
static int F_77 ( struct V_100 * V_95 )
{
...
static void F_79 ( struct V_100 * V_95 )
{
struct V_1 * V_2 ;
F_80 ( V_101 ,
F_74 ( V_101 ) , V_95 ) ;
...
static int F_81 ( struct V_105 * V_12 )
{
struct V_11 * V_106 = F_82 ( V_12 ) ;
...
static int F_84 ( struct V_105 * V_12 )
{
struct V_11 * V_106 = F_82 ( V_12 ) ;
struct V_17 * V_18 = V_106 -> V_19 ;
unsigned V_96 , V_107 = 0 ;
for ( V_96 = 0 ; V_96 < F_74 ( V_97 ) ; V_96 ++ )
if ( V_97 [ V_96 ] . V_108 && ( V_18 -> V_70 >= V_97 [ V_96 ] . V_70 ) )
F_85 ( V_106 , V_97 [ V_96 ] . V_89 , V_18 -> V_109 [ V_107 ++ ] ) ;
F_86 ( V_106 ) ;
return 0 ;
}
