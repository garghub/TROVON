...
F_23 ( V_37 + ( V_3 * 2 ) , V_9 -> V_63 -> V_35 [ V_3 ] ) ;
V_37 [ V_3 * 2 ] = '\0' ;
V_69 = F_24 ( V_74 -> V_75 , V_76 ,
V_77 ) ;
if ( ! V_69 )
return;
F_25 ( V_69 , L_7 ) ;
...
const char * F_29 ( struct V_78 * V_78 , char * * V_79 )
{
char * V_80 = NULL ;
* V_79 = F_30 ( V_81 + 11 , V_76 ) ;
if ( * V_79 ) {
V_80 = F_31 ( V_78 , * V_79 , V_81 + 11 ) ;
if ( F_32 ( V_80 ) ) {
F_2 ( * V_79 ) ;
* V_79 = NULL ;
V_80 = NULL ;
