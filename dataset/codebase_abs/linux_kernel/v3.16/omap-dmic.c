...
int V_22 = - V_23 ;
if ( V_21 == 192000 ) {
if ( V_2 -> V_24 == 19200000 && V_2 -> V_25 == 3840000 )
V_22 = 0x6 ;
else
F_14 ( V_2 -> V_26 ,
L_1 ) ;
...
break;
default:
F_14 ( V_2 -> V_26 , L_11 , V_50 ) ;
return - V_23 ;
}
V_53 = F_23 ( V_2 -> V_26 , V_54 ) ;
if ( F_24 ( V_53 ) ) {
F_14 ( V_2 -> V_26 , L_12 , V_54 ) ;
return - V_59 ;
}
F_10 ( & V_2 -> V_18 ) ;
if ( V_2 -> V_19 ) {
F_25 ( V_2 -> V_26 ) ;
V_17 = F_26 ( V_2 -> V_60 , V_53 ) ;
F_27 ( V_2 -> V_26 ) ;
} else {
V_17 = F_26 ( V_2 -> V_60 , V_53 ) ;
}
...
static int F_29 ( struct V_1 * V_2 , int V_50 ,
unsigned int V_51 )
{
int V_17 = 0 ;
if ( V_50 != V_62 ) {
...
break;
default:
F_14 ( V_2 -> V_26 , L_2 , V_51 ) ;
V_2 -> V_25 = 0 ;
V_17 = - V_23 ;
}
return V_17 ;
}
static int F_30 ( struct V_15 * V_16 , int V_50 ,
unsigned int V_51 , int V_63 )
{
struct V_1 * V_2 = F_9 ( V_16 ) ;
if ( V_63 == V_64 )
return F_22 ( V_2 , V_50 , V_51 ) ;
else if ( V_63 == V_65 )
return F_29 ( V_2 , V_50 , V_51 ) ;
F_14 ( V_2 -> V_26 , L_15 , V_63 ) ;
return - V_23 ;
}
...
struct V_69 * V_70 ;
int V_17 ;
V_2 = F_37 ( & V_68 -> V_26 , sizeof( struct V_1 ) , V_71 ) ;
if ( ! V_2 )
return - V_72 ;
F_38 ( V_68 , V_2 ) ;
V_2 -> V_26 = & V_68 -> V_26 ;
...
V_2 -> V_31 . V_75 = V_70 -> V_76 + V_77 ;
V_2 -> V_31 . V_78 = L_20 ;
V_70 = F_40 ( V_68 , V_73 , L_21 ) ;
V_2 -> V_5 = F_41 ( & V_68 -> V_26 , V_70 ) ;
if ( F_24 ( V_2 -> V_5 ) ) {
V_17 = F_42 ( V_2 -> V_5 ) ;
goto V_74;
}
V_17 = F_43 ( & V_68 -> V_26 , & V_79 ,
& V_80 , 1 ) ;
if ( V_17 )
goto V_74;
V_17 = F_44 ( & V_68 -> V_26 ) ;
