...
if ( V_91 == V_154 ) {
V_116 = V_14 -> V_116 ;
if ( ! V_116 || ! F_53 ( V_116 -> V_117 -> V_155 ) ) {
V_18 = - V_6 ;
break;
}
}
...
return V_18 ;
F_58 ( V_14 ) ;
V_18 = F_59 ( V_14 , V_167 , V_17 , V_12 -> V_170 ) ;
F_60 ( V_14 ) ;
return V_18 ;
}
static int F_61 ( struct V_164 * V_165 , struct V_1 * V_2 ,
struct V_166 * V_167 , T_5 V_17 , int V_49 )
{
struct V_2 * V_12 = V_2 -> V_12 ;
...
V_12 -> V_29 = V_53 ;
V_172 -> V_14 -> V_47 = V_53 ;
F_62 ( V_172 -> V_14 ) ;
} else {
V_12 -> V_29 = V_149 ;
V_172 -> V_14 -> V_47 = V_149 ;
F_63 ( V_172 -> V_14 ) ;
}
V_18 = 0 ;
goto V_32;
...
F_17 ( V_12 ) ;
if ( V_2 -> type == V_58 )
V_18 = F_64 ( V_165 , V_2 , V_167 , V_17 , V_49 ) ;
else
V_18 = F_65 ( V_165 , V_2 , V_167 , V_17 , V_49 ) ;
if ( V_172 -> V_14 -> V_45 != V_60 )
return V_18 ;
F_12 ( V_12 ) ;
if ( ! F_41 ( V_173 , & V_172 -> V_14 -> V_174 ) )
goto V_32;
if ( V_172 -> V_175 ) {
if ( ! F_66 ( V_12 , V_172 -> V_175 ) )
V_172 -> V_175 = NULL ;
else
goto V_32;
}
if ( F_67 ( & V_12 -> V_176 ) <= V_12 -> V_177 >> 1 )
F_68 ( V_172 -> V_14 , 0 ) ;
V_32:
F_17 ( V_12 ) ;
return V_18 ;
...
static int F_77 ( struct V_1 * V_2 , int V_183 )
{
struct V_2 * V_12 = V_2 -> V_12 ;
struct V_13 * V_14 ;
struct V_148 * V_116 ;
...
F_79 ( V_14 , 0 ) ;
F_12 ( V_12 ) ;
if ( F_70 ( V_12 , V_187 ) && V_12 -> V_188 )
V_18 = F_21 ( V_12 , V_189 ,
V_12 -> V_188 ) ;
}
if ( ! V_18 && V_12 -> V_190 )
V_18 = - V_12 -> V_190 ;
...
int V_18 ;
F_60 ( V_14 ) ;
V_198 = F_99 ( V_12 , V_17 , V_201 , & V_18 ) ;
F_58 ( V_14 ) ;
if ( ! V_198 )
return F_100 ( V_18 ) ;
...
F_72 ( F_6 ( V_12 ) -> V_14 ) ;
if ( F_6 ( V_12 ) -> V_175 ) {
F_109 ( F_6 ( V_12 ) -> V_175 ) ;
F_6 ( V_12 ) -> V_175 = NULL ;
}
F_110 ( & V_12 -> V_203 ) ;
F_110 ( & V_12 -> V_204 ) ;
}
static void F_111 ( struct V_197 * V_198 , void * V_205 ,
int * V_206 )
{
F_112 ( struct V_15 * , V_16 , V_205 ) ;
memset ( V_16 , 0 , sizeof( struct V_15 ) ) ;
V_16 -> V_207 = V_20 ;
V_16 -> V_22 = F_101 ( V_198 ) -> V_5 ;
F_16 ( & V_16 -> V_34 , & F_101 ( V_198 ) -> V_208 ) ;
* V_206 = sizeof( struct V_15 ) ;
}
...
F_7 ( L_1 , V_12 ) ;
if ( V_192 ) {
struct V_13 * V_209 = F_6 ( V_192 ) -> V_14 ;
V_12 -> V_56 = V_192 -> V_56 ;
F_43 ( V_12 ) -> V_49 = F_43 ( V_192 ) -> V_49 ;
V_14 -> V_24 = V_209 -> V_24 ;
V_14 -> V_94 = V_209 -> V_94 ;
V_14 -> V_26 = V_209 -> V_26 ;
V_14 -> V_147 = V_209 -> V_147 ;
V_14 -> V_45 = V_209 -> V_45 ;
V_14 -> V_96 = V_209 -> V_96 ;
V_14 -> V_97 = V_209 -> V_97 ;
V_14 -> V_99 = V_209 -> V_99 ;
V_14 -> V_210 = V_209 -> V_210 ;
V_14 -> V_37 = V_209 -> V_37 ;
V_14 -> V_49 = V_209 -> V_49 ;
V_14 -> V_211 = V_209 -> V_211 ;
V_14 -> V_212 = V_209 -> V_212 ;
if ( V_14 -> V_24 == V_25 ) {
V_14 -> V_51 = V_209 -> V_51 ;
V_14 -> V_82 = V_209 -> V_51 ;
}
F_113 ( V_192 , V_12 ) ;
} else {
switch ( V_12 -> V_56 ) {
...
static struct V_2 * F_88 ( struct V_217 * V_217 , struct V_1 * V_2 ,
int V_218 , T_6 V_219 )
{
struct V_2 * V_12 ;
struct V_13 * V_14 ;
V_12 = F_115 ( V_217 , V_220 , V_219 , & V_221 ) ;
if ( ! V_12 )
return NULL ;
F_116 ( V_2 , V_12 ) ;
F_117 ( & F_43 ( V_12 ) -> V_222 ) ;
V_12 -> V_223 = F_108 ;
V_12 -> V_202 = V_224 ;
F_118 ( V_12 , V_178 ) ;
V_12 -> V_225 = V_218 ;
...
static int F_122 ( struct V_217 * V_217 , struct V_1 * V_2 , int V_226 ,
int V_227 )
{
struct V_2 * V_12 ;
F_7 ( L_10 , V_2 ) ;
...
V_2 -> type != V_213 && V_2 -> type != V_135 )
return - V_229 ;
if ( V_2 -> type == V_135 && ! V_227 && ! F_3 ( V_230 ) )
return - V_162 ;
V_2 -> V_3 = & V_4 ;
V_12 = F_88 ( V_217 , V_2 , V_226 , V_196 ) ;
if ( ! V_12 )
return - V_199 ;
F_91 ( V_12 , NULL ) ;
F_123 ( & V_191 , V_12 ) ;
...
if ( V_18 < 0 )
return V_18 ;
V_18 = F_126 ( V_195 , & V_231 ) ;
if ( V_18 < 0 ) {
F_127 ( L_11 ) ;
goto error;
}
V_18 = F_128 ( & V_232 , L_12 , & V_191 ,
NULL ) ;
if ( V_18 < 0 ) {
F_127 ( L_13 ) ;
F_129 ( V_195 ) ;
