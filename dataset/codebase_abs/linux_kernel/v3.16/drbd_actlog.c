...
( V_198 && F_13 ( V_71 , & V_64 -> V_19 ) ) ) ;
if ( V_197 || ( V_198 && F_13 ( V_71 , & V_64 -> V_19 ) ) ) {
F_39 ( & V_2 -> V_70 ) ;
...
int F_118 ( struct V_1 * V_2 , T_1 V_22 )
{
unsigned int V_59 = F_96 ( V_22 ) ;
...
void F_120 ( struct V_1 * V_2 , T_1 V_22 )
{
unsigned int V_59 = F_96 ( V_22 ) ;
struct V_60 * V_117 ;
struct V_58 * V_64 ;
...
void F_124 ( struct V_1 * V_2 , T_1 V_22 , int V_24 )
{
unsigned long V_185 , V_186 , V_187 ;
unsigned long V_169 ;
T_1 V_188 , V_189 ;
