...
int V_154 ;
int V_373 = V_371 ;
if ( F_180 ( V_2 -> V_281 , V_45 ) )
return 0 ;
for ( V_154 = 0 ; V_154 < V_2 -> V_374 ; V_154 ++ ) {
if ( F_180 ( V_2 -> V_372 [ V_154 ] , V_45 ) )
return 0 ;
...
static int F_181 ( struct V_1 * V_2 , T_4 * V_45 )
{
int V_154 ;
for ( V_154 = 0 ; V_154 < V_2 -> V_374 ; V_154 ++ ) {
if ( F_180 ( V_2 -> V_372 [ V_154 ] , V_45 ) ) {
...
static int F_375 ( struct V_260 * V_261 , T_11 V_162 )
{
int V_154 ;
struct V_648 * V_26 = F_368 ( V_261 ) ;
struct V_258 * V_259 = & V_26 -> V_258 ;
...
F_377 ( V_261 ) ;
F_373 ( V_261 , F_378 ( V_261 , V_162 ) , 1 ) ;
F_371 ( V_261 , F_378 ( V_261 , V_162 ) ) ;
return 0 ;
}
