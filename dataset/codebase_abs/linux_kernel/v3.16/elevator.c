...
static T_4
F_93 ( struct V_27 * V_23 , struct V_106 * V_107 , char * V_108 )
{
...
static T_4
F_95 ( struct V_27 * V_23 , struct V_106 * V_107 ,
...
struct V_6 * V_7 = V_5 -> V_8 ;
int error ;
error = F_97 ( & V_7 -> V_23 , & V_5 -> V_23 , L_9 , L_10 ) ;
if ( ! error ) {
struct V_109 * V_107 = V_7 -> type -> V_115 ;
if ( V_107 ) {
while ( V_107 -> V_107 . V_12 ) {
if ( F_98 ( & V_7 -> V_23 , & V_107 -> V_107 ) )
break;
V_107 ++ ;
}
}
