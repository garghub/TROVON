...
if ( F_2 ( ! F_3 ( V_2 ) ) )
return false ;
V_74 = & V_34 -> V_77 [ V_2 -> V_4 -> V_78 ] -> V_74 ;
V_76 = & V_34 -> V_77 [ V_2 -> V_4 -> V_78 ] -> V_76 ;
V_18 = V_2 -> V_4 -> V_12 ;
switch ( V_2 -> V_9 ) {
case V_19 :
V_9 = 5 ;
...
static bool F_26 ( struct V_93 * V_94 ,
struct V_3 * V_4 )
{
struct V_95 * V_96 ;
struct V_34 * V_34 = F_27 ( V_94 -> V_97 ) ;
F_28 () ;
if ( ! F_29 ( V_98 ) ||
! ( V_34 -> V_99 & V_100 ) )
return false ;
...
continue;
V_65 = F_35 ( V_4 -> V_12 ) ;
V_66 = F_35 ( V_103 -> V_12 ) ;
if ( V_65 != - V_45 && V_65 == V_66 ) {
if ( V_4 -> V_12 == 5825 &&
V_103 -> V_12 != 5825 )
continue;
return true ;
...
V_109 = F_25 ( V_34 , V_2 , V_72 ) ;
F_39 ( V_109 ) ;
return V_109 ;
}
int F_40 ( struct V_93 * V_94 ,
struct V_1 * V_2 )
{
if ( ! V_94 -> V_111 -> V_112 )
return - V_113 ;
if ( ! F_41 ( V_94 ) )
return - V_114 ;
return F_42 ( V_94 , V_2 ) ;
}
void
F_43 ( struct V_95 * V_115 ,
struct V_3 * * V_4 ,
enum V_116 * V_117 ,
T_2 * V_118 )
{
...
* V_117 = V_119 ;
F_44 ( V_115 ) ;
if ( V_115 -> V_104 && ! F_32 ( V_115 -> V_104 ) )
return;
switch ( V_115 -> V_47 ) {
case V_49 :
if ( V_115 -> V_105 ) {
* V_4 = V_115 -> V_105 -> V_106 . V_107 ;
* V_117 = ( V_115 -> V_120 &&
! V_115 -> V_121 )
? V_122
: V_123 ;
if ( V_115 -> V_121 )
* V_118 |= F_16 ( V_115 -> V_2 . V_9 ) ;
return;
}
break;
case V_53 :
