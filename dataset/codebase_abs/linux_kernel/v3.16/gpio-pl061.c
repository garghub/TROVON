...
return - V_11 ;
F_7 ( & V_2 -> V_12 , V_8 ) ;
F_10 ( ! ! V_14 << V_3 , V_2 -> V_5 + ( F_9 ( V_3 + 2 ) ) ) ;
V_9 = F_8 ( V_2 -> V_5 + V_13 ) ;
V_9 |= F_9 ( V_3 ) ;
F_10 ( V_9 , V_2 -> V_5 + V_13 ) ;
F_10 ( ! ! V_14 << V_3 , V_2 -> V_5 + ( F_9 ( V_3 + 2 ) ) ) ;
...
static int F_13 ( struct V_1 * V_6 , unsigned V_3 )
{
struct V_7 * V_2 = F_6 ( V_6 , struct V_7 , V_6 ) ;
return ! ! F_8 ( V_2 -> V_5 + ( F_9 ( V_3 + 2 ) ) ) ;
}
static void F_14 ( struct V_1 * V_6 , unsigned V_3 , int V_14 )
{
struct V_7 * V_2 = F_6 ( V_6 , struct V_7 , V_6 ) ;
F_10 ( ! ! V_14 << V_3 , V_2 -> V_5 + ( F_9 ( V_3 + 2 ) ) ) ;
}
static int F_15 ( struct V_15 * V_16 , unsigned V_17 )
{
struct V_1 * V_6 = F_16 ( V_16 ) ;
struct V_7 * V_2 = F_6 ( V_6 , struct V_7 , V_6 ) ;
int V_3 = F_17 ( V_16 ) ;
unsigned long V_8 ;
T_1 V_18 , V_19 , V_20 ;
...
F_10 ( V_18 , V_2 -> V_5 + V_24 ) ;
F_10 ( V_19 , V_2 -> V_5 + V_25 ) ;
F_10 ( V_20 , V_2 -> V_5 + V_23 ) ;
F_11 ( & V_2 -> V_12 , V_8 ) ;
return 0 ;
}
...
struct V_1 * V_6 = F_16 ( V_16 ) ;
struct V_7 * V_2 = F_6 ( V_6 , struct V_7 , V_6 ) ;
T_1 V_40 = F_9 ( F_17 ( V_16 ) % V_22 ) ;
T_1 V_41 ;
F_27 ( & V_2 -> V_12 ) ;
V_41 = F_8 ( V_2 -> V_5 + V_42 ) & ~ V_40 ;
F_10 ( V_41 , V_2 -> V_5 + V_42 ) ;
F_28 ( & V_2 -> V_12 ) ;
}
...
if ( V_2 -> V_73 . V_75 & ( F_9 ( V_3 ) ) )
V_2 -> V_73 . V_74 |=
F_13 ( & V_2 -> V_6 , V_3 ) << V_3 ;
}
return 0 ;
}
...
F_10 ( V_2 -> V_73 . V_76 , V_2 -> V_5 + V_24 ) ;
F_10 ( V_2 -> V_73 . V_77 , V_2 -> V_5 + V_25 ) ;
F_10 ( V_2 -> V_73 . V_78 , V_2 -> V_5 + V_23 ) ;
F_10 ( V_2 -> V_73 . V_79 , V_2 -> V_5 + V_42 ) ;
return 0 ;
}
