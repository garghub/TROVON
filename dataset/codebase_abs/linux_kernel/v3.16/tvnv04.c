...
int
F_24 ( struct V_58 * V_59 , struct V_60 * V_61 )
{
struct V_14 * V_15 ;
struct V_11 * V_12 ;
...
if ( type < 0 )
return type ;
V_15 = F_25 ( sizeof( * V_15 ) , V_66 ) ;
if ( ! V_15 )
return - V_67 ;
V_12 = F_26 ( V_15 ) ;
F_27 ( V_2 , V_12 , & V_68 , V_69 ) ;
F_28 ( V_12 , & V_70 ) ;
V_12 -> V_71 = V_61 -> V_72 ;
V_12 -> V_73 = 0 ;
V_15 -> V_20 = V_61 ;
V_15 -> V_57 = F_19 ( V_61 -> V_57 ) - 1 ;
V_65 = F_29 ( V_2 , F_30 ( V_12 ) ,
& V_63 -> V_74 ,
& V_10 [ type ] . V_2 ) ;
if ( V_65 < 0 )
goto V_75;
F_9 ( V_12 ) -> F_31 ( V_12 , V_59 ) ;
F_32 ( V_59 , V_12 ) ;
return 0 ;
V_75:
F_22 ( V_12 ) ;
