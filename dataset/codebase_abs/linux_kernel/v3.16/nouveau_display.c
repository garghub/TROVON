...
T_2 * V_19 , T_2 * V_20 )
{
const T_1 V_21 = V_22 + F_9 ( V_16 ) -> V_23 ;
...
int * V_17 , int * V_18 , T_2 * V_19 , T_2 * V_20 )
{
struct V_15 * V_16 ;
...
F_14 (crtc, &dev->mode_config.crtc_list, head) {
struct F_9 * V_140 = F_9 ( V_16 ) ;
T_1 V_144 = V_140 -> V_141 . V_54 -> V_145 . V_144 ;
...
V_153 -> V_145 . V_144 } ;
F_94 ( V_5 , F_9 ( V_16 ) -> V_23 ) ;
if ( F_32 ( V_4 -> V_47 ) -> V_64 >= V_65 ) {
V_25 = F_95 ( V_16 , V_53 , V_151 , V_170 ) ;
if ( V_25 )
goto V_182;
} else {
...
F_96 ( V_153 , & V_184 -> V_186 [ V_2 ] ) ;
}
V_25 = F_75 ( V_151 , V_152 , V_153 , V_155 , & V_160 ) ;
if ( V_25 )
goto V_182;
F_97 ( & V_151 -> V_174 -> V_175 ) ;
...
int V_188 = - 1 ;
F_76 ( & V_5 -> V_161 , V_37 ) ;
if ( F_102 ( & V_159 -> V_162 ) ) {
F_34 ( V_4 , L_12 ) ;
F_78 ( & V_5 -> V_161 , V_37 ) ;
return - V_41 ;
}
V_155 = F_103 ( & V_159 -> V_162 , struct V_154 , V_2 ) ;
if ( V_155 -> V_169 ) {
if ( F_32 ( V_4 -> V_47 ) -> V_64 >= V_65 )
V_188 = V_155 -> V_16 ;
F_104 ( V_5 , V_188 , V_155 -> V_169 ) ;
}
F_100 ( V_5 , V_155 -> V_16 ) ;
F_86 ( & V_155 -> V_2 ) ;
if ( V_187 )
* V_187 = * V_155 ;
F_20 ( V_155 ) ;
...
struct V_3 * V_4 = V_151 -> V_4 ;
struct V_154 V_189 ;
if ( ! F_101 ( V_151 , & V_189 ) ) {
if ( F_32 ( V_4 -> V_47 ) -> V_64 < V_65 ) {
F_106 ( V_4 -> V_5 , V_189 . V_16 , V_189 . V_144 +
V_189 . V_181 * V_189 . V_190 +
V_189 . V_180 * V_189 . V_191 / 8 ) ;
}
}
return 0 ;
}
int
F_107 ( struct V_56 * V_57 , struct V_7 * V_5 ,
struct V_192 * args )
{
struct V_62 * V_145 ;
int V_25 ;
args -> V_190 = F_108 ( args -> V_193 * ( args -> V_191 / 8 ) , 256 ) ;
args -> V_194 = args -> V_190 * args -> V_195 ;
args -> V_194 = F_108 ( args -> V_194 , V_196 ) ;
V_25 = F_109 ( V_5 , args -> V_194 , 0 , V_197 , 0 , 0 , & V_145 ) ;
if ( V_25 )
return V_25 ;
