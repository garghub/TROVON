...
V_157 [ V_23 -> V_158 ] . V_156 :
L_58 ,
F_47 ( V_23 -> V_78 -> V_159 . V_160 ) ,
F_47 ( V_23 -> V_78 -> V_159 . V_161 ) ) ;
F_48 ( V_23 -> V_78 , V_23 -> V_162 , sizeof( V_23 -> V_162 ) ) ;
V_119 -> V_163 = V_23 -> V_156 ;
V_119 -> V_164 = V_23 -> V_162 ;
F_49 ( V_23 -> V_78 , & V_119 -> V_165 ) ;
V_119 -> V_36 . V_166 = V_36 ;
V_119 -> V_93 = V_23 ;
V_119 -> V_167 = V_168 ;
F_50 ( V_119 , V_169 ) ;
V_119 -> V_120 = F_51 ( 100 ) ;
if ( ! V_23 -> V_41 . V_151 ) {
V_119 -> V_170 = F_25 ;
V_119 -> V_171 = F_26 ;
V_119 -> V_172 = F_24 ;
...
static int F_54 ( struct V_178 * V_179 ,
const struct V_180 * V_181 )
{
struct V_182 * V_36 = F_55 ( V_179 ) ;
struct V_183 * V_184 ;
...
if ( F_15 ( V_187 ) )
V_72 = F_60 ( V_36 , V_187 -> V_79 ) ;
else
V_72 = F_61 ( V_36 , V_187 -> V_79 ) ;
V_189 = F_62 ( V_36 , V_72 , F_63 ( V_72 ) ) ;
V_23 = F_14 ( sizeof( struct V_22 ) , V_76 ) ;
if ( ! V_23 )
goto V_203;
V_23 -> V_116 = F_64 ( V_36 , V_189 , V_86 , & V_23 -> V_204 ) ;
if ( ! V_23 -> V_116 )
goto V_205;
...
V_23 -> V_77 = V_188 ;
if ( V_36 -> V_159 . V_208
&& F_65 ( V_36 , V_36 -> V_159 . V_208 ,
V_24 , sizeof( V_24 ) ) > 0 )
F_66 ( V_156 , V_24 , sizeof( V_156 ) ) ;
if ( V_36 -> V_159 . V_209
&& F_65 ( V_36 , V_36 -> V_159 . V_209 ,
V_24 , sizeof( V_24 ) ) > 0 )
...
if ( ! V_23 -> V_119 )
goto V_210;
F_17 ( V_23 -> V_82 , V_36 , V_72 , V_23 -> V_116 , V_189 ,
F_35 , V_23 , V_187 -> V_80 ) ;
V_23 -> V_82 -> V_211 = V_23 -> V_204 ;
V_23 -> V_82 -> V_212 |= V_213 ;
F_4 ( & V_179 -> V_36 , L_67 ) ;
F_23 ( V_23 , V_189 ) ;
F_37 ( V_23 ) ;
if ( V_23 -> V_41 . V_42 )
...
F_68 ( V_23 -> V_36 , true ) ;
F_69 ( V_23 -> V_36 , true ) ;
F_70 ( & V_179 -> V_36 , L_68 ,
V_156 , V_23 -> V_123 ) ;
F_70 ( & V_179 -> V_36 , L_69 ,
...
F_10 ( V_23 -> V_82 ) ;
V_206:
F_71 ( V_36 , V_189 , V_23 -> V_116 , V_23 -> V_204 ) ;
V_205:
F_9 ( V_23 ) ;
V_203:
F_8 ( & V_179 -> V_36 , L_70 , V_140 ) ;
return - V_214 ;
}
static void F_72 ( struct V_178 * V_179 )
{
struct V_182 * V_36 = F_55 ( V_179 ) ;
struct V_22 * V_23 = F_73 ( V_179 ) ;
F_67 ( V_179 , NULL ) ;
if ( ! V_23 )
return;
V_23 -> V_78 = NULL ;
...
F_75 ( V_23 -> V_82 ) ;
F_10 ( V_23 -> V_82 ) ;
F_71 ( V_36 , V_23 -> V_207 , V_23 -> V_116 , V_23 -> V_204 ) ;
F_9 ( V_23 ) ;
}
static int F_76 ( struct V_178 * V_179 , T_3 V_215 )
{
struct V_22 * V_23 = F_73 ( V_179 ) ;
F_70 ( V_23 -> V_36 , L_71 ) ;
F_75 ( V_23 -> V_82 ) ;
