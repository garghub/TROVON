...
return - V_5 ;
F_8 ( V_20 -> V_4 != NULL ) ;
V_20 -> V_35 = V_4 -> V_2 && V_4 -> V_2 -> V_12 &&
V_20 -> V_36 == V_4 -> V_2 -> V_12 -> V_36 ;
if ( ! V_20 -> V_35 && ! F_29 ( V_20 -> V_36 ) )
return - V_37 ;
V_20 -> V_4 = V_4 ;
if ( V_20 -> V_38 && V_20 -> V_38 -> V_39 ) {
V_34 = V_20 -> V_38 -> V_39 ( V_20 ) ;
if ( V_34 )
goto V_40;
}
V_34 = F_30 ( V_4 -> V_41 , V_20 -> V_41 , NULL ) ;
if ( V_34 )
goto V_42;
#if F_26 ( V_31 )
if ( V_4 -> V_43 ) {
V_34 = F_31 ( V_4 -> V_43 , V_33 ) ;
if ( V_34 < 0 )
goto V_42;
}
#endif
...
F_42 ( V_47 , V_20 ) ;
F_43 ( V_47 -> V_11 , V_20 -> V_11 , sizeof( V_47 -> V_11 ) ) ;
V_47 -> V_4 = V_4 ;
V_47 -> V_53 = & V_54 ;
V_47 -> V_14 = F_36 ;
V_47 -> V_41 = V_20 -> V_41 ;
V_34 = F_44 ( V_47 , V_55 , - 1 , 1 ,
V_20 -> V_36 ) ;
if ( V_34 < 0 ) {
F_38 ( V_47 ) ;
goto V_52;
...
#if F_26 ( V_31 )
V_20 -> V_33 . V_56 . V_57 . V_58 = V_59 ;
V_20 -> V_33 . V_56 . V_57 . V_60 = V_47 -> V_60 ;
#endif
V_20 -> V_48 = V_47 ;
}
return 0 ;
