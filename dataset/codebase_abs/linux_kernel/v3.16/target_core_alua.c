...
static inline void F_25 ( struct V_1 * V_2 , T_4 V_75 )
{
F_17 ( L_12
L_13
L_14 ,
...
T_2 V_157 )
{
struct V_158 * V_158 = F_39 ( V_155 , V_159 | V_160 | V_161 , 0600 ) ;
int V_162 ;
if ( F_40 ( V_158 ) ) {
F_16 ( L_30 , V_155 ) ;
return - V_163 ;
}
V_162 = F_41 ( V_158 , V_156 , V_157 , 0 ) ;
if ( V_162 < 0 )
F_16 ( L_31 , V_155 ) ;
F_42 ( V_158 ) ;
...
L_36 , & V_166 -> V_173 [ 0 ] ,
F_45 ( & V_32 -> V_174 . V_175 ) ) ;
V_59 = F_38 ( V_155 , V_156 , V_61 ) ;
F_46 ( V_156 ) ;
return V_59 ;
}
static void F_47 ( struct V_176 * V_177 )
{
struct V_31 * V_32 = F_48 ( V_177 ,
...
struct V_6 *
F_62 ( struct V_233 * V_234 ,
T_5 V_98 , T_5 V_97 )
{
struct V_6 * V_235 ;
V_235 = F_63 ( V_236 , V_170 ) ;
if ( ! V_235 ) {
F_16 ( L_53 ) ;
return F_64 ( - V_171 ) ;
}
...
V_235 -> V_22 = V_98 ;
V_235 -> V_23 = V_97 ;
F_66 ( & V_235 -> V_18 , V_234 ) ;
return V_235 ;
}
int
F_67 ( struct V_6 * V_235 ,
int V_238 , int V_142 )
{
struct V_8 * V_239 ;
...
void
F_72 ( struct V_3 * V_4 , struct V_233 * V_18 ,
int V_85 , int V_86 )
{
struct V_233 V_244 ;
struct V_31 * V_32 ;
...
struct V_205 *
F_74 ( const char * V_247 , int V_248 )
{
struct V_205 * V_206 ;
V_206 = F_63 ( V_249 , V_170 ) ;
if ( ! V_206 ) {
F_16 ( L_56 ) ;
return F_64 ( - V_171 ) ;
}
...
int F_76 ( struct V_205 * V_206 , T_3 V_214 )
{
struct V_205 * V_255 ;
T_3 V_256 ;
if ( V_206 -> V_253 ) {
...
struct V_205 * F_82 ( const char * V_247 )
{
struct V_205 * V_206 ;
struct V_266 * V_267 ;
F_4 ( & V_257 ) ;
...
T_6 F_96 ( struct V_29 * V_30 , char * V_285 )
{
struct V_266 * V_286 ;
struct V_31 * V_32 ;
struct V_33 * V_34 ;
...
T_6 F_110 ( struct V_47 * V_125 , char * V_285 )
{
if ( ! V_125 -> V_48 )
return - V_163 ;
