...
if ( V_48 <= 0 )
goto V_57;
V_50 = V_44 -> V_50 & ( V_59 - 1 ) ;
V_51 = V_44 -> V_51 & ( V_59 - 1 ) ;
V_52 = ( ( V_50 >= V_51 ) ? V_50 : V_59 ) - V_51 ;
V_48 = F_27 ( V_48 , V_52 ) ;
F_28 ( V_6 -> V_10 + V_60 , & V_44 -> V_61 [ V_44 -> V_51 ] , V_48 ) ;
V_44 -> V_51 = ( V_44 -> V_51 + V_48 ) & ( V_59 - 1 ) ;
F_29 () ;
F_4 ( V_48 & 0x3ff , V_6 -> V_10 + V_56 ) ;
V_6 -> V_18 . V_62 += V_48 ;
V_57:
if ( ! F_21 ( V_44 ) )
F_1 ( V_2 , V_63 , V_64 ) ;
