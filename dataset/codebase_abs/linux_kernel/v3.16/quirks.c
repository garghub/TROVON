...
{
if ( F_91 ( V_2 -> V_72 ) != 0 ) {
V_2 -> V_314 = F_130 ( F_58 ( V_2 -> V_72 ) , 0 ) ;
V_2 -> V_100 |= V_315 ;
}
}
...
{
if ( F_91 ( V_2 -> V_72 ) != 1 ) {
V_2 -> V_314 = F_130 ( F_58 ( V_2 -> V_72 ) , 1 ) ;
V_2 -> V_100 |= V_315 ;
}
}
static void F_202 ( struct V_1 * V_65 )
{
if ( ! F_203 ( V_65 -> V_44 ) &&
V_65 -> V_141 == V_316 &&
! F_204 ( V_65 ) && F_204 ( V_65 -> V_44 -> V_317 ) &&
F_205 ( V_65 -> V_44 -> V_317 ) != V_318 )
V_65 -> V_100 |= V_319 ;
}
static struct V_1 * F_206 ( struct V_1 * V_2 )
{
if ( ! F_91 ( V_2 -> V_72 ) )
return F_207 ( V_2 ) ;
return F_129 ( V_2 -> V_44 , F_130 ( F_58 ( V_2 -> V_72 ) , 0 ) ) ;
}
struct V_1 * F_208 ( struct V_1 * V_2 )
{
const struct V_320 * V_144 ;
for ( V_144 = V_320 ; V_144 -> V_321 ; V_144 ++ ) {
if ( ( V_144 -> V_153 == V_2 -> V_153 ||
V_144 -> V_153 == ( T_2 ) V_257 ) &&
( V_144 -> V_79 == V_2 -> V_79 ||
V_144 -> V_79 == ( T_2 ) V_257 ) )
return V_144 -> V_321 ( V_2 ) ;
}
return F_207 ( V_2 ) ;
}
static int F_209 ( struct V_1 * V_2 , T_2 V_322 )
{
#ifdef F_210
struct V_323 * V_324 = NULL ;
T_8 V_325 ;
if ( ! V_2 -> V_142 || ! F_203 ( V_2 -> V_44 ) )
return - V_326 ;
V_325 = F_211 ( L_108 , 0 , & V_324 ) ;
if ( F_212 ( V_325 ) )
return - V_326 ;
V_322 &= ( V_327 | V_328 | V_329 | V_330 ) ;
return V_322 & ~ ( V_327 | V_328 ) ? 0 : 1 ;
#else
return - V_326 ;
#endif
}
...
{
int V_144 ;
if ( ! F_204 ( V_2 ) || F_205 ( V_2 ) != V_331 )
return false ;
for ( V_144 = 0 ; V_144 < F_214 ( V_332 ) ; V_144 ++ )
if ( V_332 [ V_144 ] == V_2 -> V_79 )
return true ;
return false ;
}
static int F_215 ( struct V_1 * V_2 , T_2 V_322 )
{
T_2 V_33 = V_2 -> V_100 & V_333 ?
V_334 : 0 ;
if ( ! F_213 ( V_2 ) )
return - V_291 ;
return V_322 & ~ V_33 ? 0 : 1 ;
}
int F_216 ( struct V_1 * V_2 , T_2 V_322 )
{
const struct V_335 * V_144 ;
int V_336 ;
for ( V_144 = V_335 ; V_144 -> V_337 ; V_144 ++ ) {
if ( ( V_144 -> V_153 == V_2 -> V_153 ||
V_144 -> V_153 == ( T_2 ) V_257 ) &&
( V_144 -> V_79 == V_2 -> V_79 ||
V_144 -> V_79 == ( T_2 ) V_257 ) ) {
V_336 = V_144 -> V_337 ( V_2 , V_322 ) ;
if ( V_336 >= 0 )
return V_336 ;
}
}
...
{
T_1 V_123 , V_338 , V_339 ;
void T_4 * V_340 ;
F_218 ( V_2 -> V_44 , F_130 ( 31 , 0 ) ,
V_341 , & V_123 ) ;
if ( ! ( V_123 & V_342 ) )
return - V_343 ;
V_340 = F_80 ( V_123 & V_344 ,
F_219 ( V_345 ) ) ;
if ( ! V_340 )
return - V_296 ;
V_338 = F_82 ( V_340 + V_346 ) ;
V_338 &= V_347 | V_348 ;
if ( V_338 != ( V_347 | V_348 ) ) {
V_339 = F_82 ( V_340 + V_345 ) ;
if ( V_339 & V_349 ) {
F_6 ( & V_2 -> V_2 , L_109 ) ;
V_339 &= ~ V_349 ;
F_83 ( V_339 , V_340 + V_345 ) ;
}
}
F_85 ( V_340 ) ;
return 0 ;
...
{
T_1 V_350 ;
F_10 ( V_2 , V_351 , & V_350 ) ;
if ( ! ( V_350 & V_352 ) ) {
F_6 ( & V_2 -> V_2 , L_110 ) ;
V_350 |= V_352 ;
F_49 ( V_2 , V_351 , V_350 ) ;
}
}
...
{
const struct V_353 * V_144 ;
int V_336 ;
for ( V_144 = V_353 ; V_144 -> V_354 ; V_144 ++ ) {
if ( ( V_144 -> V_153 == V_2 -> V_153 ||
V_144 -> V_153 == ( T_2 ) V_257 ) &&
( V_144 -> V_79 == V_2 -> V_79 ||
V_144 -> V_79 == ( T_2 ) V_257 ) ) {
V_336 = V_144 -> V_354 ( V_2 ) ;
if ( V_336 >= 0 )
return;
}
}
