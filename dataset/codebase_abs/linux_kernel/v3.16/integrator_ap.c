...
V_89 , NULL ) ;
V_84 = F_6 ( V_14 ) ;
V_83 = F_46 ( sizeof( * V_83 ) , V_90 ) ;
if ( ! V_83 )
return;
V_83 -> V_91 = L_4 ;
V_83 -> V_92 = L_5 ;
V_83 -> V_93 = L_6 ;
V_83 -> V_94 = F_47 ( V_90 , L_7 ,
'A' + ( V_84 & 0x0f ) ) ;
V_81 = F_48 ( V_83 ) ;
if ( F_36 ( V_81 ) ) {
F_49 ( V_83 -> V_94 ) ;
...
if ( ( V_75 & ( 16 << V_85 ) ) == 0 )
continue;
V_97 = F_46 ( sizeof( struct V_96 ) , V_90 ) ;
if ( ! V_97 )
continue;
V_97 -> V_98 . V_32 = 0xc0000000 + 0x10000000 * V_85 ;
V_97 -> V_98 . V_99 = V_97 -> V_98 . V_32 + 0x0fffffff ;
V_97 -> V_98 . V_100 = V_101 ;
V_97 -> V_47 = F_39 ( V_76 , V_85 ) ;
V_97 -> V_102 = V_85 ;
F_52 ( V_97 ) ;
}
}
