...
int F_12 ( const struct V_68 * V_69 ,
const struct V_1 * V_2 ,
const struct V_70 * const V_71 [] )
{
struct V_8 * V_9 = F_2 ( V_2 ) ;
int V_33 ;
V_9 -> V_17 = F_13 ( F_14 ( V_71 [ V_72 ] ) ) ;
switch ( V_9 -> V_17 ) {
case V_18 :
case V_20 :
case V_23 :
...
V_9 -> V_16 = F_13 ( F_14 ( V_71 [ V_74 ] ) ) ;
V_33 = F_15 ( V_9 -> V_16 ) ;
if ( V_33 < 0 )
return V_33 ;
V_33 = F_16 ( V_69 , V_9 -> V_16 , NULL , V_75 ) ;
if ( V_33 < 0 )
return V_33 ;
return 0 ;
}
int F_17 ( const struct V_68 * V_69 ,
const struct V_1 * V_2 ,
const struct V_70 * const V_71 [] )
{
struct V_8 * V_9 = F_2 ( V_2 ) ;
...
V_9 -> V_65 = F_13 ( F_14 ( V_71 [ V_76 ] ) ) ;
V_33 = F_18 ( V_9 -> V_65 ) ;
if ( V_33 < 0 )
return V_33 ;
return 0 ;
}
int F_19 ( struct V_10 * V_11 ,
const struct V_1 * V_2 )
{
const struct V_8 * V_9 = F_2 ( V_2 ) ;
if ( F_20 ( V_11 , V_72 , F_21 ( V_9 -> V_17 ) ) )
goto V_77;
if ( F_20 ( V_11 , V_74 , F_21 ( V_9 -> V_16 ) ) )
goto V_77;
return 0 ;
V_77:
return - 1 ;
...
if ( F_20 ( V_11 , V_72 , F_21 ( V_9 -> V_17 ) ) )
goto V_77;
if ( F_20 ( V_11 , V_76 , F_21 ( V_9 -> V_65 ) ) )
goto V_77;
return 0 ;
V_77:
return - 1 ;
