...
static void F_27 ( struct V_6 * V_7 , T_2 V_8 ,
void * V_17 , T_3 V_9 ,
struct V_1 * V_2 )
{
void * V_28 = F_28 ( F_16 ( V_7 , V_9 ) ) ;
F_29 ( V_17 ) ;
F_15 ( V_7 , V_8 , V_28 , V_9 , V_2 ) ;
}
static T_3 F_30 ( struct V_6 * V_7 , struct V_15 * V_15 ,
unsigned long V_29 , T_2 V_8 ,
enum V_30 V_31 ,
struct V_1 * V_2 )
{
T_3 V_32 ;
V_32 = F_31 ( V_7 , V_15 , V_29 , V_8 , V_31 , V_2 ) ;
F_32 ( F_28 ( F_16 ( V_7 , V_32 ) ) , V_8 , V_31 ) ;
return V_32 ;
}
static void F_33 ( struct V_6 * V_7 , T_3 V_32 ,
T_2 V_8 , enum V_30 V_31 ,
struct V_1 * V_2 )
{
F_34 ( F_28 ( F_16 ( V_7 , V_32 ) ) , V_8 , V_31 ) ;
F_35 ( V_7 , V_32 , V_8 , V_31 , V_2 ) ;
}
static int F_36 ( struct V_6 * V_7 , struct V_33 * V_34 ,
int V_35 , enum V_30 V_31 ,
struct V_1 * V_2 )
{
struct V_33 * V_36 ;
int V_23 , V_37 ;
V_37 = F_37 ( V_7 , V_34 , V_35 , V_31 , V_2 ) ;
F_38 (sgl, sg, ret, i)
F_32 ( F_28 ( F_16 ( V_7 , V_36 -> V_38 ) ) ,
V_36 -> V_39 , V_31 ) ;
return V_37 ;
}
...
struct V_33 * V_36 ;
int V_23 ;
F_38 (sgl, sg, nelems, i)
F_34 ( F_28 ( F_16 ( V_7 , V_36 -> V_38 ) ) ,
V_36 -> V_39 , V_31 ) ;
F_40 ( V_7 , V_34 , V_35 , V_31 , V_2 ) ;
}
...
{
F_34 ( F_28 ( F_16 ( V_7 , V_32 ) ) , V_8 , V_31 ) ;
F_42 ( V_7 , V_32 , V_8 , V_31 ) ;
}
static void F_43 ( struct V_6 * V_7 ,
T_3 V_32 , T_2 V_8 ,
enum V_30 V_31 )
{
F_44 ( V_7 , V_32 , V_8 , V_31 ) ;
F_32 ( F_28 ( F_16 ( V_7 , V_32 ) ) , V_8 , V_31 ) ;
}
...
struct V_33 * V_36 ;
int V_23 ;
F_48 ( V_7 , V_34 , V_35 , V_31 ) ;
F_38 (sgl, sg, nelems, i)
F_32 ( F_28 ( F_16 ( V_7 , V_36 -> V_38 ) ) ,
V_36 -> V_39 , V_31 ) ;
}
static int F_49 ( struct V_6 * V_7 , struct V_40 * V_41 ,
...
if ( F_50 ( V_7 , V_41 , V_42 , V_8 , & V_37 ) )
return V_37 ;
if ( V_50 < V_48 && V_45 <= ( V_48 - V_50 ) ) {
V_37 = F_51 ( V_41 , V_41 -> V_47 ,
V_49 + V_50 ,
V_41 -> V_46 - V_41 -> V_47 ,
V_41 -> V_52 ) ;
}
...
return F_49 ( V_7 , V_41 , V_42 , V_43 , V_8 ) ;
}
...
if ( V_55 != V_57 )
return V_58 ;
if ( F_55 ( V_7 -> V_59 , L_2 ) )
F_56 ( V_7 , & V_60 ) ;
return V_61 ;
}
static int T_6 F_57 ( void )
{
T_2 V_62 = F_58 ( V_63 , V_64 << V_16 ) ;
F_59 ( & V_65 , & V_66 ) ;
F_59 ( & V_67 , & V_68 ) ;
V_69 = & V_70 ;
return F_60 ( V_62 ) ;
