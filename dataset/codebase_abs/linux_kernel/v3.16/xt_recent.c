...
static int F_33 ( const struct V_72 * V_39 ,
...
V_74 = F_48 ( V_21 -> V_34 , V_91 , V_1 -> V_92 ,
& V_93 , V_21 ) ;
if ( V_74 == NULL ) {
F_31 ( V_21 ) ;
V_46 = - V_87 ;
...
return F_33 ( V_39 , & V_97 ) ;
}
static int F_52 ( const struct V_72 * V_39 )
{
return F_33 ( V_39 , V_39 -> V_44 ) ;
}
...
{
struct V_104 * V_105 ;
V_105 = F_61 ( V_114 , & V_115 , sizeof( * V_105 ) ) ;
if ( V_105 == NULL )
return - V_87 ;
V_105 -> V_14 = F_62 ( V_113 ) ;
return 0 ;
}
static T_7
F_63 ( struct V_114 * V_114 , const char T_8 * V_116 ,
T_5 V_117 , T_6 * V_118 )
{
struct V_13 * V_21 = F_62 ( F_64 ( V_114 ) ) ;
struct V_12 * V_18 ;
...
++ V_120 ;
-- V_117 ;
if ( F_66 ( V_120 , V_117 , ':' ) != NULL ) {
V_16 = V_125 ;
V_122 = F_67 ( V_120 , V_117 , ( void * ) & V_5 , '\n' , NULL ) ;
} else {
V_16 = V_20 ;
