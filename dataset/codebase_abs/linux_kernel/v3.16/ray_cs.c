...
static int F_50 ( struct V_4 * V_5 , struct V_130 * V_131 )
{
T_1 * V_3 = F_4 ( V_5 ) ;
struct V_1 * V_31 = V_3 -> V_7 ;
...
static T_5 F_51 ( struct V_132 * V_133 ,
struct V_4 * V_5 )
{
T_1 * V_3 = F_4 ( V_5 ) ;
struct V_1 * V_31 = V_3 -> V_7 ;
...
switch ( F_55 ( V_133 -> V_92 , V_134 , V_5 , V_143 ) ) {
case V_144 :
case V_145 :
F_6 ( V_5 ) ;
return V_141 ;
...
static int F_55 ( unsigned char * V_92 , int V_135 , struct V_4 * V_5 ,
T_3 V_149 )
{
T_1 * V_3 = F_4 ( V_5 ) ;
struct V_51 T_2 * V_55 ;
...
short int V_153 ;
F_56 ( L_45 , V_92 , V_135 , V_5 ) ;
if ( V_135 + V_154 > V_155 ) {
F_14 ( V_34 L_46 ,
V_135 ) ;
return V_147 ;
}
switch ( V_79 = F_57 ( V_3 ) ) {
case V_156 :
F_56 ( L_47 ) ;
case V_157 :
F_56 ( L_48 ) ;
...
F_58 ( V_3 , V_152 , V_149 , V_92 ) ;
if ( V_163 ) {
V_150 = F_59 ( V_3 , V_152 , V_92 , V_135 ) ;
} else {
...
static int F_59 ( T_1 * V_3 , struct V_151 T_2 * V_152 ,
...
( T_3 * ) & V_173 , 2 ) ;
if ( V_173 == F_61 ( V_178 ) || V_173 == F_61 ( V_179 ) ) {
F_28 ( 0xf8 ,
...
static void F_58 ( T_1 * V_3 , struct V_151 T_2 * V_152 ,
...
static int F_80 ( struct V_4 * V_5 , struct V_195 * V_196 ,
union V_197 * V_198 , char * V_199 )
{
return 0 ;
}
static T_7 * F_81 ( struct V_4 * V_5 )
{
T_1 * V_3 = F_4 ( V_5 ) ;
struct V_1 * V_31 = V_3 -> V_7 ;
...
static struct V_264 * F_88 ( struct V_4 * V_5 )
{
T_1 * V_3 = F_4 ( V_5 ) ;
struct V_1 * V_31 = V_3 -> V_7 ;
struct V_117 T_2 * V_54 = V_3 -> V_44 + V_244 ;
...
if ( F_37 ( & V_54 -> V_265 ) ) {
V_3 -> V_160 . V_266 += F_89 ( F_90 ( & V_54 -> V_267 ) ) ;
F_28 ( 0 , & V_54 -> V_267 ) ;
F_28 ( 0 , & V_54 -> V_265 ) ;
}
if ( F_37 ( & V_54 -> V_268 ) ) {
V_3 -> V_160 . V_269 +=
F_89 ( F_90 ( & V_54 -> V_270 ) ) ;
F_28 ( 0 , & V_54 -> V_270 ) ;
F_28 ( 0 , & V_54 -> V_268 ) ;
}
if ( F_37 ( & V_54 -> V_271 ) ) {
V_3 -> V_160 . V_272 += F_89 ( F_90 ( & V_54 -> V_273 ) ) ;
F_28 ( 0 , & V_54 -> V_273 ) ;
F_28 ( 0 , & V_54 -> V_271 ) ;
}
return & V_3 -> V_160 ;
}
static void F_91 ( struct V_4 * V_5 , T_3 V_274 , T_3 * V_217 ,
int V_135 )
{
T_1 * V_3 = F_4 ( V_5 ) ;
struct V_1 * V_31 = V_3 -> V_7 ;
...
static void F_92 ( struct V_4 * V_5 , int V_279 )
{
int V_79 ;
struct V_51 T_2 * V_55 ;
T_1 * V_3 = F_4 ( V_5 ) ;
...
static void F_98 ( struct V_4 * V_5 , T_1 * V_3 ,
struct V_53 T_2 * V_289 )
{
int V_318 ;
unsigned int V_319 ;
...
static void F_99 ( struct V_4 * V_5 , struct V_53 T_2 * V_289 ,
...
F_56 ( L_124 , V_336 ,
V_318 ) ;
V_335 = F_106 ( V_133 , V_336 ) ;
V_335 +=
F_102 ( V_3 , V_335 , V_319 & V_323 , V_318 ) ;
#ifdef F_5
F_107 ( V_133 ,
F_108 ( struct V_346 , V_192 ) ,
V_338 , V_129 ) ;
#endif
if ( ! V_250 ) {
if ( ! V_163 ) {
...
& V_323 ;
V_335 +=
F_102 ( V_3 , V_335 , V_319 , V_318 ) ;
} while ( V_211 -- &&
F_37 ( & V_334 -> V_120 . V_321 . V_342 ) !=
0xFF );
F_103 ( V_3 , V_289 ) ;
}
V_133 -> V_347 = F_111 ( V_133 , V_5 ) ;
F_112 ( V_133 ) ;
V_3 -> V_160 . V_348 ++ ;
...
V_245 . V_241 = V_337 ;
V_245 . V_248 = 0x2 ;
F_113 ( V_5 , V_338 , & V_245 ) ;
}
#endif
}
static void F_110 ( T_1 * V_3 , struct V_132 * V_133 , int V_135 )
{
...
memcpy ( V_358 , F_114 ( V_353 ) , V_77 ) ;
memcpy ( V_357 , F_115 ( V_353 ) , V_77 ) ;
#if 0
if {
...
static int F_102 ( T_1 * V_3 , T_3 * V_364 , int V_319 ,
int V_134 )
{
...
static void F_103 ( T_1 * V_3 , struct V_53 T_2 * V_289 )
{
struct V_53 T_2 * V_334 = V_289 ;
int V_211 = 17 ;
...
F_40 ( & V_3 -> V_28 ) ;
F_102 ( V_3 , V_367 , V_319 , V_318 & 0xff ) ;
if ( V_3 -> V_73 . V_74 . V_112 == V_118 ) {
F_56 ( L_134 ,
...
static int F_117 ( struct V_374 * V_204 , void * V_375 )
{
int V_33 ;
struct V_1 * V_31 ;
struct V_4 * V_5 ;
...
if ( V_33 > 16 )
V_33 = 10 ;
F_119 ( V_204 , L_150 , V_16 [ V_33 ] ) ;
F_119 ( V_204 , L_151 , V_381 [ V_163 ] ) ;
F_119 ( V_204 , L_152 , V_3 -> V_325 ) ;
if ( V_3 -> V_333 ) {
F_119 ( V_204 , L_153 ,
V_3 -> V_331 . V_382 [ 0 ]
...
static int F_121 ( struct V_391 * V_391 , struct V_392 * V_392 )
{
return F_122 ( V_392 , F_117 , NULL ) ;
}
static int F_53 ( T_1 * V_3 , T_3 * V_364 , int V_393 )
{
int V_153 ;
struct V_51 T_2 * V_55 ;
struct V_151 T_2 * V_152 ;
...
static T_10 F_124 ( struct V_392 * V_392 ,
...
V_135 = 32 ;
memset ( V_399 , 0 , 33 ) ;
if ( F_125 ( V_399 , V_396 , V_135 ) )
return - V_400 ;
V_114 = V_399 ;
return V_397 ;
}
static T_10 F_126 ( struct V_392 * V_392 , const char T_11 * V_396 ,
...
* ( int * ) F_127 ( F_128 ( V_392 ) ) = V_402 ;
return V_397 ;
}
static int T_14 F_129 ( void )
{
int V_403 ;
F_56 ( L_143 , V_379 ) ;
V_403 = F_130 ( & V_404 ) ;
...
#ifdef F_131
F_132 ( L_167 , NULL ) ;
F_133 ( L_168 , 0 , NULL , & V_405 ) ;
F_133 ( L_169 , V_406 , NULL , & V_407 ) ;
F_134 ( L_170 , V_406 , NULL , & V_408 , & V_56 ) ;
F_134 ( L_171 , V_406 , NULL , & V_408 , & V_163 ) ;
#endif
if ( V_163 != 0 )
V_163 = 1 ;
return 0 ;
