...
V_120 -> V_129 = F_88 ( V_116 -> V_130 [ 0 ] ) ;
memcpy ( V_120 -> V_130 , V_116 -> V_130 , V_131 ) ;
V_120 -> V_132 = 60 * V_133 ;
if ( V_116 -> V_134 )
V_120 -> V_135 |= V_136 ;
F_89 ( V_120 -> V_118 , V_3 -> V_52 -> V_137 , V_120 , 0 ) ;
if ( V_120 -> V_138 )
V_61 = - V_139 ;
V_128:
F_90 ( V_120 ) ;
...
static const char * F_91 ( T_4 V_140 )
{
...
return V_140 < F_92 ( V_141 ) ? V_141 [ V_140 ] : L_30 ;
}
...
F_94 ( V_3 , L_32 , V_131 , V_116 -> V_130 ) ;
}
static int F_95 ( struct V_2 * V_3 )
{
struct V_115 V_116 ;
F_96 ( & V_116 , NULL , 0 , V_147 ) ;
V_116 . V_130 [ 0 ] = V_148 ;
V_116 . V_134 = 1 ;
#if 0
cgc.cmd[1] = 1 << 1;
...
static T_5 int F_97 ( struct V_2 * V_3 ,
...
static void F_98 ( struct V_2 * V_3 , struct V_95 * V_95 )
{
F_12 ( & V_3 -> V_80 . V_28 ) ;
if ( F_99 ( V_95 ) == V_124 )
F_100 ( & V_3 -> V_80 . V_152 , V_95 ) ;
else
F_100 ( & V_3 -> V_80 . V_153 , V_95 ) ;
F_13 ( & V_3 -> V_80 . V_28 ) ;
F_57 ( & V_3 -> V_80 . V_81 , 1 ) ;
F_58 ( & V_3 -> V_82 ) ;
}
...
int V_154 , V_155 ;
F_12 ( & V_3 -> V_80 . V_28 ) ;
V_154 = ! F_102 ( & V_3 -> V_80 . V_152 ) ;
V_155 = ! F_102 ( & V_3 -> V_80 . V_153 ) ;
F_13 ( & V_3 -> V_80 . V_28 ) ;
if ( ! V_154 && ! V_155 )
break;
if ( V_3 -> V_80 . V_156 ) {
...
V_3 -> V_80 . V_159 = 0 ;
V_3 -> V_80 . V_158 = F_105 ( V_95 ) ;
}
if ( V_3 -> V_80 . V_159 >= V_161 ) {
if ( V_3 -> V_150 == V_3 -> V_149 ) {
V_3 -> V_150 = V_162 ;
F_97 ( V_3 , V_3 -> V_149 , V_3 -> V_150 ) ;
}
} else {
if ( V_3 -> V_150 != V_3 -> V_149 ) {
V_3 -> V_150 = V_3 -> V_149 ;
...
static int F_108 ( struct V_2 * V_3 , struct V_117 * V_118 )
{
if ( ( V_3 -> V_5 . V_6 << 9 ) / V_163
<= F_109 ( V_118 ) ) {
F_110 ( V_164 , & V_3 -> V_165 ) ;
return 0 ;
...
static void F_112 ( struct V_83 * V_86 , struct V_167 * V_168 )
{
...
void * V_172 = F_113 ( V_168 [ V_169 ] . V_171 ) + V_168 [ V_169 ] . V_173 ;
void * V_174 = F_114 ( V_86 -> V_91 [ V_13 ] ) + V_170 ;
...
static void F_116 ( struct V_95 * V_95 , int V_175 )
{
...
static void F_119 ( struct V_2 * V_3 , struct V_83 * V_86 )
{
int V_180 = 0 ;
struct V_95 * V_95 ;
int V_169 ;
char V_181 [ V_182 ] ;
F_53 ( F_102 ( & V_86 -> V_94 ) ) ;
F_57 ( & V_86 -> V_178 , 0 ) ;
F_57 ( & V_86 -> V_177 , 0 ) ;
memset ( V_181 , 0 , sizeof( V_181 ) ) ;
F_12 ( & V_86 -> V_28 ) ;
F_120 (bio, &pkt->orig_bios) {
...
if ( ! F_122 ( V_95 , V_86 -> V_91 [ V_13 ] , V_163 , V_4 ) )
F_123 () ;
F_106 ( & V_86 -> V_178 ) ;
V_95 -> V_189 = V_124 ;
F_98 ( V_3 , V_95 ) ;
...
static struct V_83 * F_124 ( struct V_2 * V_3 , int V_190 )
{
struct V_83 * V_86 ;
F_125 (pkt, &pd->cdrw.pkt_free_list, list) {
...
static void F_127 ( struct V_2 * V_3 , struct V_83 * V_86 )
{
if ( V_86 -> V_185 ) {
F_72 ( & V_86 -> V_103 , & V_3 -> V_78 . V_100 ) ;
} else {
F_128 ( & V_86 -> V_103 , & V_3 -> V_78 . V_100 ) ;
}
}
static int F_129 ( struct V_83 * V_86 )
{
return 0 ;
#if 0
...
static inline void F_130 ( struct V_83 * V_86 , enum V_191 V_192 )
{
#if V_193 > 1
...
F_125 (p, &pd->cdrw.pkt_active_list, list) {
if ( V_13 -> V_1 == V_190 ) {
V_95 = NULL ;
goto V_200;
}
...
static void F_134 ( struct V_2 * V_3 , struct V_83 * V_86 )
{
int V_169 ;
...
static void F_137 ( struct V_83 * V_86 , int V_214 )
{
struct V_95 * V_95 ;
if ( ! V_214 )
V_86 -> V_185 = 0 ;
while ( ( V_95 = F_104 ( & V_86 -> V_94 ) ) )
F_138 ( V_95 , V_214 ? 0 : - V_139 ) ;
}
static void F_139 ( struct V_2 * V_3 , struct V_83 * V_86 )
{
int V_214 ;
...
if ( F_54 ( & V_86 -> V_178 ) > 0 )
return;
if ( F_136 ( V_217 , & V_86 -> V_88 -> V_218 ) ) {
F_130 ( V_86 , V_219 ) ;
} else {
F_130 ( V_86 , V_216 ) ;
}
...
break;
case V_219 :
V_214 = F_136 ( V_217 , & V_86 -> V_88 -> V_218 ) ;
F_137 ( V_86 , V_214 ) ;
return;
default:
F_123 () ;
...
{
struct V_83 * V_86 , * V_98 ;
F_125 (pkt, &pd->cdrw.pkt_active_list, list) {
...
static void F_142 ( struct V_2 * V_3 , int * V_221 )
{
struct V_83 * V_86 ;
int V_85 ;
...
static int F_155 ( struct V_2 * V_3 , struct V_115 * V_116 , int V_235 , int V_236 )
{
...
static int F_156 ( struct V_2 * V_3 , struct V_115 * V_116 )
{
memset ( V_116 -> V_130 , 0 , sizeof( V_116 -> V_130 ) ) ;
...
static int F_157 ( struct V_2 * V_3 , T_6 * V_240 )
{
struct V_115 V_116 ;
int V_61 ;
F_96 ( & V_116 , V_240 , sizeof( * V_240 ) , V_238 ) ;
V_116 . V_130 [ 0 ] = V_241 ;
V_116 . V_130 [ 8 ] = V_116 . V_126 = 2 ;
V_116 . V_134 = 1 ;
if ( ( V_61 = F_83 ( V_3 , & V_116 ) ) )
return V_61 ;
V_116 . V_126 = F_158 ( V_240 -> V_242 ) +
sizeof( V_240 -> V_242 ) ;
...
static int F_159 ( struct V_2 * V_3 , T_7 V_243 , T_4 type , T_8 * V_244 )
{
struct V_115 V_116 ;
int V_61 ;
F_96 ( & V_116 , V_244 , 8 , V_238 ) ;
V_116 . V_130 [ 0 ] = V_245 ;
...
T_9 V_248 ;
int V_61 = - 1 ;
if ( ( V_61 = F_157 ( V_3 , & V_240 ) ) )
return V_61 ;
V_248 = ( V_240 . V_249 << 8 ) | V_240 . V_250 ;
if ( ( V_61 = F_159 ( V_3 , V_248 , 1 , & V_244 ) ) )
return V_61 ;
if ( V_244 . V_251 ) {
V_248 -- ;
if ( ( V_61 = F_159 ( V_3 , V_248 , 1 , & V_244 ) ) )
...
if ( V_244 . V_252 ) {
* V_247 = F_161 ( V_244 . V_253 ) ;
} else {
* V_247 = F_161 ( V_244 . V_254 ) +
F_161 ( V_244 . V_255 ) ;
if ( V_244 . V_256 )
* V_247 -= ( F_161 ( V_244 . V_256 ) + 7 ) ;
}
return 0 ;
}
...
F_96 ( & V_116 , V_127 , sizeof( * V_257 ) , V_238 ) ;
V_116 . V_143 = & V_143 ;
if ( ( V_61 = F_155 ( V_3 , & V_116 , V_259 , 0 ) ) ) {
F_93 ( V_3 , & V_116 ) ;
return V_61 ;
}
...
F_94 ( V_3 , L_62 , V_257 -> V_264 ) ;
return 1 ;
}
V_257 -> V_272 = F_164 ( V_3 -> V_5 . V_6 >> 2 ) ;
V_116 . V_126 = V_116 . V_130 [ 8 ] = V_6 ;
if ( ( V_61 = F_156 ( V_3 , & V_116 ) ) ) {
F_93 ( V_3 , & V_116 ) ;
return V_61 ;
}
F_153 ( V_3 ) ;
...
static int F_165 ( struct V_2 * V_3 , T_8 * V_244 )
{
switch ( V_3 -> V_258 ) {
case 0x1a :
case 0x12 :
...
return 1 ;
F_94 ( V_3 , L_63 , V_244 -> V_274 , V_244 -> V_251 , V_244 -> V_273 ) ;
return 0 ;
}
static int F_166 ( struct V_2 * V_3 , T_6 * V_240 )
{
switch ( V_3 -> V_258 ) {
case 0x0a :
case 0xffff :
...
T_8 V_244 ;
int V_61 , V_243 ;
F_96 ( & V_116 , V_54 , sizeof( V_54 ) , V_238 ) ;
V_116 . V_130 [ 0 ] = V_279 ;
V_116 . V_130 [ 8 ] = 8 ;
V_61 = F_83 ( V_3 , & V_116 ) ;
...
V_243 = 1 ;
if ( ( V_61 = F_159 ( V_3 , V_243 , 1 , & V_244 ) ) ) {
F_94 ( V_3 , L_70 ) ;
return V_61 ;
}
if ( ! F_165 ( V_3 , & V_244 ) ) {
...
V_3 -> V_5 . V_6 = F_161 ( V_244 . V_283 ) << 2 ;
if ( V_3 -> V_5 . V_6 == 0 ) {
F_167 ( V_3 , L_72 ) ;
return - V_284 ;
}
...
V_3 -> V_4 = ( F_161 ( V_244 . V_254 ) << 2 ) & ( V_3 -> V_5 . V_6 - 1 ) ;
if ( V_244 . V_286 ) {
V_3 -> V_287 = F_161 ( V_244 . V_288 ) ;
F_111 ( V_289 , & V_3 -> V_165 ) ;
}
if ( V_244 . V_252 ) {
V_3 -> V_290 = F_161 ( V_244 . V_253 ) ;
F_111 ( V_291 , & V_3 -> V_165 ) ;
} else {
...
static int F_170 ( struct V_2 * V_3 , int V_298 )
{
struct V_115 V_116 ;
F_96 ( & V_116 , NULL , 0 , V_147 ) ;
V_116 . V_130 [ 0 ] = V_299 ;
...
F_96 ( & V_116 , V_54 , sizeof( V_54 ) , V_301 ) ;
V_116 . V_143 = & V_143 ;
V_61 = F_155 ( V_3 , & V_116 , V_302 , 0 ) ;
if ( V_61 ) {
...
break;
default:
F_167 ( V_3 , L_79 , V_305 ) ;
return 1 ;
}
if ( * V_304 ) {
F_154 ( V_3 , L_80 , * V_304 ) ;
return 0 ;
} else {
F_167 ( V_3 , L_81 , V_306 , V_305 ) ;
return 1 ;
}
}
...
static int F_175 ( struct V_2 * V_3 , T_11 V_314 )
{
int V_61 ;
long V_315 ;
struct V_117 * V_118 ;
F_176 ( V_3 -> V_52 -> V_53 ) ;
if ( ( V_61 = F_177 ( V_3 -> V_52 , V_316 | V_317 , V_3 ) ) )
goto V_128;
if ( ( V_61 = F_160 ( V_3 , & V_315 ) ) ) {
F_94 ( V_3 , L_89 ) ;
goto V_318;
}
F_178 ( V_3 -> V_202 , V_315 << 2 ) ;
F_178 ( V_3 -> V_52 -> V_137 , V_315 << 2 ) ;
F_179 ( V_3 -> V_52 , ( V_319 ) V_315 << 11 ) ;
V_118 = F_84 ( V_3 -> V_52 ) ;
if ( V_314 ) {
if ( ( V_61 = F_174 ( V_3 ) ) )
goto V_318;
F_180 ( V_118 -> V_320 ) ;
F_181 ( V_118 , V_3 -> V_5 . V_6 ) ;
F_182 ( V_118 -> V_320 ) ;
F_111 ( V_321 , & V_3 -> V_165 ) ;
} else {
F_97 ( V_3 , V_162 , V_162 ) ;
F_110 ( V_321 , & V_3 -> V_165 ) ;
}
if ( ( V_61 = F_108 ( V_3 , V_118 ) ) )
goto V_318;
if ( V_314 ) {
if ( ! F_71 ( V_3 , V_322 ) ) {
F_94 ( V_3 , L_90 ) ;
...
F_154 ( V_3 , L_91 , V_315 << 1 ) ;
}
return 0 ;
V_318:
F_183 ( V_3 -> V_52 , V_316 | V_317 ) ;
V_128:
return V_61 ;
}
static void F_184 ( struct V_2 * V_3 , int V_323 )
{
if ( V_323 && F_95 ( V_3 ) )
F_56 ( 1 , V_3 , L_92 ) ;
F_170 ( V_3 , 0 ) ;
...
static struct V_2 * F_185 ( unsigned int V_324 )
{
if ( V_324 >= V_49 )
return NULL ;
return V_50 [ V_324 ] ;
}
static int F_186 ( struct V_325 * V_52 , T_11 V_326 )
{
struct V_2 * V_3 = NULL ;
int V_61 ;
F_187 ( & V_327 ) ;
F_187 ( & V_47 ) ;
V_3 = F_185 ( F_28 ( V_52 -> V_53 ) ) ;
if ( ! V_3 ) {
V_61 = - V_59 ;
goto V_128;
}
...
if ( V_3 -> V_328 > 1 ) {
if ( ( V_326 & V_329 ) &&
! F_136 ( V_321 , & V_3 -> V_165 ) ) {
V_61 = - V_330 ;
goto V_331;
}
} else {
V_61 = F_175 ( V_3 , V_326 & V_329 ) ;
if ( V_61 )
goto V_331;
F_188 ( V_52 , V_163 ) ;
}
...
static void F_189 ( struct V_332 * V_202 , T_11 V_326 )
{
...
F_53 ( V_3 -> V_328 < 0 ) ;
if ( V_3 -> V_328 == 0 ) {
int V_323 = F_136 ( V_321 , & V_3 -> V_165 ) ;
F_184 ( V_3 , V_323 ) ;
}
F_29 ( & V_47 ) ;
F_29 ( & V_327 ) ;
}
static void F_190 ( struct V_95 * V_95 , int V_175 )
{
struct V_334 * V_335 = V_95 -> V_176 ;
struct V_2 * V_3 = V_335 -> V_3 ;
F_64 ( V_95 ) ;
F_138 ( V_335 -> V_95 , V_175 ) ;
F_78 ( V_335 , V_336 ) ;
F_52 ( V_3 ) ;
}
static void F_191 ( struct V_2 * V_3 , struct V_95 * V_95 )
{
struct V_95 * V_337 = F_192 ( V_95 , V_338 ) ;
struct V_334 * V_335 = F_193 ( V_336 , V_338 ) ;
V_335 -> V_3 = V_3 ;
V_335 -> V_95 = V_95 ;
...
static void F_195 ( struct V_117 * V_118 , struct V_95 * V_95 )
{
...
static void F_198 ( struct V_117 * V_118 , struct V_95 * V_95 )
{
struct V_2 * V_3 ;
char V_342 [ V_343 ] ;
struct V_95 * V_344 ;
...
if ( ! V_3 ) {
F_38 ( L_93 ,
F_199 ( V_95 -> V_187 , V_342 ) ) ;
goto V_345;
}
F_56 ( 2 , V_3 , L_94 ,
( unsigned long long ) V_95 -> V_111 . V_112 ,
( unsigned long long ) F_105 ( V_95 ) ) ;
if ( F_99 ( V_95 ) == V_124 ) {
F_191 ( V_3 , V_95 ) ;
return;
}
if ( ! F_136 ( V_321 , & V_3 -> V_165 ) ) {
F_167 ( V_3 , L_95 ,
( unsigned long long ) V_95 -> V_111 . V_112 ) ;
goto V_345;
}
...
T_1 V_346 = F_1 ( F_105 ( V_95 ) - 1 , V_3 ) ;
if ( V_346 != V_190 ) {
F_53 ( V_346 != V_190 + V_3 -> V_5 . V_6 ) ;
V_344 = F_201 ( V_95 , V_346 -
V_95 -> V_111 . V_112 ,
V_338 , V_347 ) ;
F_202 ( V_344 , V_95 ) ;
} else {
...
static int F_204 ( struct V_117 * V_118 , struct V_348 * V_349 ,
struct V_167 * V_168 )
{
struct V_2 * V_3 = V_118 -> V_339 ;
...
V_354 = L_101 ;
F_209 ( V_69 , L_102 , V_354 ) ;
F_209 ( V_69 , L_103 , V_3 -> V_5 . V_233 ? L_60 : L_61 ) ;
F_209 ( V_69 , L_104 , V_3 -> V_5 . V_292 ) ;
F_209 ( V_69 , L_105 , V_3 -> V_5 . V_262 ) ;
...
static int F_212 ( struct V_2 * V_3 , T_12 V_37 )
{
int V_85 ;
int V_61 = 0 ;
char V_342 [ V_343 ] ;
...
if ( ! V_52 )
return - V_62 ;
V_61 = F_177 ( V_52 , V_316 | V_357 , NULL ) ;
if ( V_61 )
return V_61 ;
F_213 ( V_58 ) ;
V_3 -> V_52 = V_52 ;
...
V_3 -> V_78 . V_358 = F_214 ( F_143 , V_3 , L_1 , V_3 -> V_8 ) ;
if ( F_21 ( V_3 -> V_78 . V_358 ) ) {
F_94 ( V_3 , L_131 ) ;
V_61 = - V_62 ;
goto V_359;
}
F_215 ( V_3 -> V_8 , 0 , V_360 , & V_361 , V_3 ) ;
F_56 ( 1 , V_3 , L_132 , F_199 ( V_52 , V_342 ) ) ;
return 0 ;
V_359:
F_183 ( V_52 , V_316 | V_357 ) ;
F_33 ( V_58 ) ;
return V_61 ;
}
static int F_216 ( struct V_325 * V_52 , T_11 V_326 , unsigned int V_130 , unsigned long V_362 )
{
...
case V_367 :
case V_368 :
V_61 = F_217 ( V_3 -> V_52 , V_326 , V_130 , V_362 ) ;
break;
default:
...
static unsigned int F_218 ( struct V_332 * V_202 ,
unsigned int V_370 )
{
struct V_2 * V_3 = V_202 -> V_333 ;
struct V_332 * V_371 ;
...
static char * F_219 ( struct V_332 * V_374 , T_13 * V_326 )
{
return F_220 ( V_14 , L_135 , V_374 -> V_375 ) ;
}
...
if ( ! F_21 ( V_3 -> V_78 . V_358 ) )
F_230 ( V_3 -> V_78 . V_358 ) ;
V_50 [ V_46 ] = NULL ;
F_48 ( V_3 ) ;
F_22 ( V_3 ) ;
F_183 ( V_3 -> V_52 , V_316 | V_357 ) ;
F_231 ( V_3 -> V_8 , V_360 ) ;
F_56 ( 1 , V_3 , L_139 ) ;
F_232 ( V_3 -> V_202 ) ;
...
static void F_233 ( struct V_388 * V_389 )
{
struct V_2 * V_3 ;
F_26 ( & V_47 , V_48 ) ;
V_3 = F_185 ( V_389 -> V_390 ) ;
if ( V_3 ) {
V_389 -> V_37 = F_234 ( V_3 -> V_52 -> V_53 ) ;
V_389 -> V_51 = F_234 ( V_3 -> V_51 ) ;
} else {
V_389 -> V_37 = 0 ;
V_389 -> V_51 = 0 ;
}
...
static long F_235 ( struct V_71 * V_71 , unsigned int V_130 , unsigned long V_362 )
{
...
if ( V_130 != V_393 )
return - V_369 ;
if ( F_236 ( & V_389 , V_392 , sizeof( struct V_388 ) ) )
return - V_394 ;
switch ( V_389 . V_395 ) {
case V_396 :
if ( ! F_237 ( V_397 ) )
return - V_398 ;
V_61 = F_32 ( F_238 ( V_389 . V_37 ) , & V_51 ) ;
V_389 . V_51 = F_234 ( V_51 ) ;
break;
case V_399 :
if ( ! F_237 ( V_397 ) )
return - V_398 ;
V_61 = F_35 ( F_238 ( V_389 . V_51 ) ) ;
break;
case V_400 :
F_233 ( & V_389 ) ;
break;
...
if ( F_239 ( V_392 , & V_389 , sizeof( struct V_388 ) ) )
return - V_394 ;
return V_61 ;
}
static long F_240 ( struct V_71 * V_71 , unsigned int V_130 , unsigned long V_362 )
{
return F_235 ( V_71 , V_130 , ( unsigned long ) F_241 ( V_362 ) ) ;
}
static int T_15 F_242 ( void )
{
int V_61 ;
F_243 ( & V_47 ) ;
V_336 = F_221 ( V_401 ,
