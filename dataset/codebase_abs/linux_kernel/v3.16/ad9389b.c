...
static int F_41 ( struct V_2 * V_3 , struct V_97 * V_56 )
{
struct V_1 * V_19 = F_1 ( V_3 ) ;
if ( V_56 -> V_94 != 0 )
return - V_46 ;
...
if ( V_56 -> V_99 >= V_19 -> V_56 . V_62 * 2 )
return - V_100 ;
if ( V_56 -> V_63 + V_56 -> V_99 >= V_19 -> V_56 . V_62 * 2 )
V_56 -> V_63 = V_19 -> V_56 . V_62 * 2 - V_56 -> V_99 ;
memcpy ( V_56 -> V_56 , & V_19 -> V_56 . V_101 [ V_56 -> V_99 * 128 ] ,
128 * V_56 -> V_63 ) ;
return 0 ;
}
...
T_1 * V_101 = V_19 -> V_56 . V_101 ;
if ( F_58 ( & V_101 [ V_108 * 256 ] ) ) {
if ( ( V_108 + 1 ) * 2 <= V_63 )
return F_58 ( & V_101 [ V_108 * 256 + 128 ] ) ;
return true ;
}
return false ;
}
...
F_11 ( V_3 , 256 , & V_19 -> V_56 . V_101 [ V_108 * 256 ] ) ;
F_46 ( 2 , V_20 , V_3 , V_108 ,
& V_19 -> V_56 . V_101 [ V_108 * 256 ] ) ;
if ( V_108 == 0 ) {
V_19 -> V_56 . V_63 = V_19 -> V_56 . V_101 [ 0x7e ] + 1 ;
...
if ( ( ( V_19 -> V_56 . V_101 [ 0x7e ] >> 1 ) + 1 ) > V_19 -> V_56 . V_62 ) {
...
V_19 -> V_94 . V_89 = V_165 ;
V_145 = F_72 ( & V_3 -> V_166 , 1 , & V_19 -> V_94 , 0 ) ;
if ( V_145 )
goto V_163;
