...
{
struct V_36 * V_37 ;
F_25 (ring->cmd_hash, desc_node, node,
...
static bool F_27 ( const T_1 * V_19 , int V_22 , T_1 V_67 )
{
if ( V_19 && V_22 != 0 ) {
int V_17 ;
...
static T_1 * F_28 ( struct V_68 * V_69 )
{
int V_17 ;
void * V_67 = NULL ;
struct V_70 V_71 ;
struct V_72 * * V_73 ;
V_73 = F_29 ( V_69 -> V_74 . V_75 >> V_76 , sizeof( * V_73 ) ) ;
if ( V_73 == NULL ) {
F_2 ( L_8 ) ;
goto V_77;
}
V_17 = 0 ;
F_30 (obj->pages->sgl, &sg_iter, obj->pages->nents, 0 ) {
V_73 [ V_17 ] = F_31 ( & V_71 ) ;
V_17 ++ ;
}
V_67 = F_32 ( V_73 , V_17 , 0 , V_78 ) ;
if ( V_67 == NULL ) {
F_2 ( L_9 ) ;
goto V_77;
}
...
static bool F_35 ( const struct V_12 * V_13 ,
const struct V_23 * V_24 ,
const T_1 * V_26 ,
const bool V_86 ,
bool * V_87 )
...
if ( V_108 )
F_40 ( ( char * ) V_106 , V_104 -> V_74 . V_75 ) ;
...
if ( ! F_35 ( V_13 , V_24 , V_26 , V_86 , & V_87 ) ) {
V_18 = - V_110 ;
break;
}
V_26 += V_66 ;
