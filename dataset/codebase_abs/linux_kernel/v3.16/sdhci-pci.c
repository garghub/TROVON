...
V_120:
while ( -- V_87 >= 0 )
F_73 ( V_2 -> V_88 [ V_87 ] -> V_11 ) ;
return V_54 ;
}
static int F_74 ( struct V_62 * V_37 )
{
struct V_67 * V_3 = F_64 ( V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
...
if ( V_54 )
return V_54 ;
if ( V_2 -> V_122 && V_2 -> V_122 -> V_127 ) {
V_54 = V_2 -> V_122 -> V_127 ( V_2 ) ;
if ( V_54 )
return V_54 ;
}
for ( V_87 = 0 ; V_87 < V_2 -> V_23 ; V_87 ++ ) {
...
static int F_77 ( struct V_62 * V_37 )
{
struct V_67 * V_3 = F_78 ( V_37 , struct V_67 , V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
int V_87 , V_54 ;
V_2 = F_65 ( V_3 ) ;
...
V_128:
while ( -- V_87 >= 0 )
F_80 ( V_2 -> V_88 [ V_87 ] -> V_11 ) ;
return V_54 ;
}
static int F_81 ( struct V_62 * V_37 )
{
struct V_67 * V_3 = F_78 ( V_37 , struct V_67 , V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
...
static int F_82 ( struct V_62 * V_37 )
{
return 0 ;
}
static struct V_9 * F_83 (
struct V_67 * V_3 , struct V_1 * V_2 , int V_129 ,
int V_130 )
{
struct V_9 * V_10 ;
struct V_26 * V_11 ;
int V_54 , V_131 = V_129 + V_130 ;
if ( ! ( F_84 ( V_3 , V_131 ) & V_132 ) ) {
F_40 ( & V_3 -> V_37 , L_11 , V_131 ) ;
return F_85 ( - V_50 ) ;
}
if ( F_86 ( V_3 , V_131 ) < 0x100 ) {
F_40 ( & V_3 -> V_37 , L_12
L_13 ) ;
}
...
V_10 -> V_30 = - V_31 ;
if ( * V_134 )
V_10 -> V_135 = V_134 ( V_3 , V_130 ) ;
if ( V_10 -> V_135 ) {
if ( V_10 -> V_135 -> V_136 ) {
V_54 = V_10 -> V_135 -> V_136 ( V_10 -> V_135 ) ;
if ( V_54 ) {
F_40 ( & V_3 -> V_37 , L_17 ) ;
goto free;
}
}
V_10 -> V_117 = V_10 -> V_135 -> V_117 ;
V_10 -> V_30 = V_10 -> V_135 -> V_30 ;
}
V_11 -> V_137 = L_18 ;
V_11 -> V_138 = & V_139 ;
V_11 -> V_7 = V_2 -> V_7 ;
...
V_11 -> V_24 = V_3 -> V_24 ;
V_54 = F_90 ( V_3 , V_131 , F_91 ( V_11 -> V_21 ) ) ;
if ( V_54 ) {
F_40 ( & V_3 -> V_37 , L_19 ) ;
goto V_141;
}
V_11 -> V_72 = F_92 ( V_3 , V_131 ) ;
if ( ! V_11 -> V_72 ) {
F_40 ( & V_3 -> V_37 , L_20 ) ;
V_54 = - V_142 ;
goto V_143;
}
if ( V_2 -> V_122 && V_2 -> V_122 -> V_144 ) {
V_54 = V_2 -> V_122 -> V_144 ( V_10 ) ;
if ( V_54 )
goto V_145;
}
if ( F_12 ( V_10 -> V_117 ) ) {
...
V_11 -> V_21 -> V_146 = V_124 | V_121 ;
V_11 -> V_21 -> V_130 = V_130 ;
V_11 -> V_21 -> V_39 |= V_147 ;
V_54 = F_94 ( V_11 ) ;
if ( V_54 )
goto remove;
F_11 ( V_10 ) ;
...
if ( F_12 ( V_10 -> V_117 ) )
F_17 ( V_10 -> V_117 ) ;
if ( V_2 -> V_122 && V_2 -> V_122 -> V_150 )
V_2 -> V_122 -> V_150 ( V_10 , 0 ) ;
V_145:
F_95 ( V_11 -> V_72 ) ;
V_143:
F_96 ( V_3 , V_131 ) ;
V_141:
if ( V_10 -> V_135 && V_10 -> V_135 -> V_141 )
V_10 -> V_135 -> V_141 ( V_10 -> V_135 ) ;
free:
F_97 ( V_11 ) ;
return F_85 ( V_54 ) ;
}
...
F_19 ( V_10 ) ;
V_86 = 0 ;
V_53 = F_45 ( V_10 -> V_11 -> V_72 + V_151 ) ;
if ( V_53 == ( T_5 ) - 1 )
V_86 = 1 ;
F_99 ( V_10 -> V_11 , V_86 ) ;
if ( F_12 ( V_10 -> V_117 ) )
F_17 ( V_10 -> V_117 ) ;
if ( V_10 -> V_2 -> V_122 && V_10 -> V_2 -> V_122 -> V_150 )
V_10 -> V_2 -> V_122 -> V_150 ( V_10 , V_86 ) ;
if ( V_10 -> V_135 && V_10 -> V_135 -> V_141 )
V_10 -> V_135 -> V_141 ( V_10 -> V_135 ) ;
F_96 ( V_10 -> V_2 -> V_3 , V_10 -> V_133 ) ;
F_97 ( V_10 -> V_11 ) ;
}
...
static void F_106 ( struct V_62 * V_37 )
{
F_107 ( V_37 ) ;
F_108 ( V_37 ) ;
}
static int F_109 ( struct V_67 * V_3 ,
...
F_110 ( V_153 == NULL ) ;
F_39 ( & V_3 -> V_37 , L_23 ,
( int ) V_3 -> V_154 , ( int ) V_3 -> V_62 , ( int ) V_3 -> V_56 ) ;
V_54 = F_33 ( V_3 , V_155 , & V_88 ) ;
if ( V_54 )
return V_54 ;
V_88 = F_111 ( V_88 ) + 1 ;
F_112 ( & V_3 -> V_37 , L_24 , V_88 ) ;
if ( V_88 == 0 )
return - V_50 ;
F_110 ( V_88 > V_156 ) ;
V_54 = F_33 ( V_3 , V_155 , & V_129 ) ;
if ( V_54 )
return V_54 ;
V_129 &= V_157 ;
if ( V_129 > 5 ) {
...
if ( V_54 )
return V_54 ;
V_2 = F_113 ( sizeof( struct V_1 ) , V_158 ) ;
if ( ! V_2 ) {
V_54 = - V_142 ;
goto V_28;
}
V_2 -> V_3 = V_3 ;
V_2 -> V_122 = ( const struct V_159 * ) V_153 -> V_160 ;
if ( V_2 -> V_122 ) {
V_2 -> V_7 = V_2 -> V_122 -> V_7 ;
V_2 -> V_140 = V_2 -> V_122 -> V_140 ;
V_2 -> V_149 = V_2 -> V_122 -> V_149 ;
}
V_2 -> V_23 = V_88 ;
F_114 ( V_3 , V_2 ) ;
if ( V_2 -> V_122 && V_2 -> V_122 -> V_161 ) {
V_54 = V_2 -> V_122 -> V_161 ( V_2 ) ;
if ( V_54 )
goto free;
}
V_88 = V_2 -> V_23 ;
for ( V_87 = 0 ; V_87 < V_88 ; V_87 ++ ) {
V_10 = F_83 ( V_3 , V_2 , V_129 , V_87 ) ;
if ( F_88 ( V_10 ) ) {
...
static void F_117 ( struct V_67 * V_3 )
{
int V_87 ;
struct V_1 * V_2 ;
V_2 = F_65 ( V_3 ) ;
