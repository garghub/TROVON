...
struct V_1 * V_1 = F_2 ( V_16 , struct V_1 , V_3 ) ;
int V_4 = V_15 -> V_17 ;
int V_18 = V_4 / 8 ;
int V_8 = 1 << ( V_4 % 8 ) ;
if ( type == V_19 ) {
...
struct V_54 * V_55 ;
struct V_56 * V_57 = V_52 -> V_42 . V_58 ;
struct V_1 * V_1 ;
int V_9 ;
int V_41 ;
V_55 = V_5 -> V_55 -> V_59 ;
...
V_1 -> V_5 = V_5 ;
V_1 -> V_3 = V_63 ;
V_1 -> V_3 . V_64 = V_5 -> V_65 ;
V_1 -> V_3 . V_42 = & V_52 -> V_42 ;
V_1 -> V_3 . V_66 = ( V_55 ) ? V_55 -> V_67 : - 1 ;
#ifdef F_31
V_1 -> V_3 . V_58 = V_57 ;
#endif
V_9 = F_9 ( V_5 , V_68 ,
...
struct V_5 * V_5 = V_1 -> V_5 ;
struct V_54 * V_55 = V_5 -> V_55 -> V_59 ;
int V_9 ;
if ( V_55 && V_55 -> remove )
V_55 -> remove ( V_5 , V_1 -> V_3 . V_66 ) ;
V_9 = F_38 ( & V_1 -> V_3 ) ;
if ( V_9 < 0 ) {
F_27 ( V_1 -> V_42 ,
L_6 , V_9 ) ;
