...
{
if ( V_3 -> V_17 . V_98 && ! ( V_3 -> V_99 ) &&
V_3 -> V_44 -> V_45 < V_100 )
return 0 ;
if ( F_53 ( & V_3 -> V_17 ) ) {
if ( V_3 -> V_44 -> V_45 == V_100 ) {
if ( ( V_3 -> V_17 . V_98 ) || ( V_3 -> V_101 ) ||
( V_3 -> V_17 . V_49 ) )
F_10 ( V_3 ) ;
if ( V_3 -> V_101 )
V_3 -> V_101 = false ;
} else if ( V_3 -> V_44 -> V_45 == V_46 ) {
if ( V_3 -> V_17 . V_43 ) {
V_3 -> V_17 . V_49 = 0 ;
F_10 ( V_3 ) ;
}
...
break;
case V_46 :
if ( V_103 && ( V_102 & V_108 ) && V_104 ) {
V_17 -> V_43 = 1 ;
F_10 ( V_3 ) ;
}
break;
case V_109 :
if ( ( V_102 & V_110 ) && V_104 && V_103 ) {
V_17 -> V_111 = 1 ;
F_10 ( V_3 ) ;
} else if ( V_102 & V_108 ) {
if ( V_17 -> V_111 == 1 )
...
struct V_51 * V_17 = & V_3 -> V_17 ;
V_123 = F_19 ( V_3 , ~ 0 ) ;
V_124 = V_123 & V_125 & ( V_123 >> 8 ) ;
V_17 -> V_98 = ( V_123 & V_126 ) ? 1 : 0 ;
if ( V_124 ) {
if ( V_124 & V_127 ) {
F_20 ( V_3 , V_127 , V_127 ) ;
V_121 = F_25 ( V_3 ) ;
return V_128 ;
} else if ( V_124 & V_40 ) {
F_20 ( V_3 , V_40 , V_40 ) ;
...
struct V_134 * V_135 ;
V_135 = F_3 ( V_3 -> V_7 ,
sizeof( struct V_134 ) , V_8 ) ;
if ( ! V_135 ) {
F_40 ( V_3 -> V_7 ,
L_3 ) ;
return - V_55 ;
}
V_135 -> V_136 = V_3 -> V_44 ;
V_135 -> V_97 = & V_3 -> V_97 ;
V_3 -> V_17 . V_135 = V_135 ;
V_3 -> V_44 -> V_135 = V_3 -> V_17 . V_135 ;
V_3 -> V_17 . V_49 = 1 ;
V_3 -> V_17 . V_98 = F_19 ( V_3 , V_126 ) ? 1 : 0 ;
V_3 -> V_44 -> V_45 = V_137 ;
V_3 -> V_17 . V_138 = & V_139 ;
F_60 ( & V_3 -> V_17 . V_20 ) ;
V_3 -> V_26 = F_3 ( V_3 -> V_7 ,
sizeof( struct V_140 ) , V_8 ) ;
if ( ! V_3 -> V_26 ) {
F_40 ( V_3 -> V_7 ,
L_4 ) ;
return - V_55 ;
...
V_121 = F_62 ( & V_3 -> V_7 -> V_141 , & V_142 ) ;
if ( V_121 < 0 ) {
F_63 ( V_3 -> V_7 ,
L_6 , V_121 ) ;
return V_121 ;
}
F_20 ( V_3 , V_143 , V_143 ) ;
if ( V_3 -> V_17 . V_98 ) {
V_3 -> V_17 . V_75 =
F_19 ( V_3 , V_42 ) ? 0 : 1 ;
V_3 -> V_17 . V_43 =
F_19 ( V_3 , V_42 ) ? 1 : 0 ;
F_20 ( V_3 , V_144 , V_144 ) ;
}
return 0 ;
}
void F_64 ( struct V_2 * V_3 )
{
F_65 ( & V_3 -> V_7 -> V_141 , & V_142 ) ;
}
