...
F_34 ( V_74 , V_10 ) ;
V_2 -> V_74 = V_74 ;
V_76 = F_35 ( V_74 , V_84 , 0 ) ;
V_2 -> V_4 = F_36 ( & V_74 -> V_19 , V_76 ) ;
if ( F_30 ( V_2 -> V_4 ) ) {
V_81 = F_31 ( V_2 -> V_4 ) ;
goto V_85;
}
...
V_2 -> V_80 = V_80 ;
V_2 -> V_61 = V_79 -> V_61 ;
V_81 = F_37 ( & V_74 -> V_19 , V_67 , F_24 , 0 ,
V_74 -> V_86 , V_10 ) ;
if ( V_81 ) {
F_21 ( V_19 , L_10 ) ;
goto V_85;
...
{
struct V_54 * V_10 = F_45 ( V_74 ) ;
struct V_1 * V_2 = F_11 ( V_10 ) ;
F_6 ( V_2 , 0 , V_30 ) ;
F_42 ( V_2 -> V_80 ) ;
return 0 ;
}
static int F_46 ( struct V_77 * V_19 )
{
struct V_54 * V_10 = F_47 ( V_19 ) ;
struct V_1 * V_2 = F_11 ( V_10 ) ;
F_48 ( V_10 ) ;
F_42 ( V_2 -> V_80 ) ;
return 0 ;
}
static int F_49 ( struct V_77 * V_19 )
{
struct V_54 * V_10 = F_47 ( V_19 ) ;
struct V_1 * V_2 = F_11 ( V_10 ) ;
int V_81 ;
