...
static int F_166 ( struct V_13 * V_14 , struct V_15 * V_16 ,
struct V_60 * V_61 )
{
const struct V_222 * V_223 ;
unsigned int V_62 = 0 , V_63 = V_61 -> args [ 0 ] ;
...
return V_16 -> V_70 ;
F_46 () ;
V_61 -> V_28 = V_14 -> V_1 -> V_7 . V_64 ;
F_47 (set, &ctx->table->sets, list) {
if ( V_62 < V_63 )
goto V_66;
if ( F_164 ( V_16 , V_14 , V_223 , V_225 ,
V_68 ) < 0 ) {
V_61 -> args [ 0 ] = V_62 ;
goto V_69;
}
...
static int F_167 ( struct V_13 * V_14 , struct V_15 * V_16 ,
struct V_60 * V_61 )
{
const struct V_222 * V_223 ;
...
F_46 () ;
V_61 -> V_28 = V_14 -> V_1 -> V_7 . V_64 ;
F_47 (table, &ctx->afi->tables, list) {
if ( V_244 ) {
if ( V_244 != V_20 )
continue;
V_244 = NULL ;
...
static int F_168 ( struct V_13 * V_14 , struct V_15 * V_16 ,
struct V_60 * V_61 )
{
const struct V_222 * V_223 ;
unsigned int V_62 , V_63 = V_61 -> args [ 0 ] ;
...
static int F_169 ( struct V_15 * V_16 , struct V_60 * V_61 )
{
const struct V_45 * V_46 = F_33 ( V_61 -> V_18 ) ;
struct V_23 * V_24 [ V_246 + 1 ] ;
struct V_13 V_14 ;
int V_56 , V_84 ;
V_56 = F_170 ( V_61 -> V_18 , sizeof( * V_46 ) , V_24 , V_246 ,
V_247 ) ;
if ( V_56 < 0 )
return V_56 ;
V_56 = F_153 ( & V_14 , V_61 -> V_16 , V_61 -> V_18 , ( void * ) V_24 ) ;
if ( V_56 < 0 )
return V_56 ;
if ( V_14 . V_20 == NULL ) {
if ( V_14 . V_3 == NULL )
V_84 = F_168 ( & V_14 , V_16 , V_61 ) ;
else
V_84 = F_167 ( & V_14 , V_16 , V_61 ) ;
} else
V_84 = F_166 ( & V_14 , V_16 , V_61 ) ;
return V_84 ;
}
static int F_171 ( struct V_71 * V_72 , struct V_15 * V_16 ,
const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_222 * V_223 ;
...
static int F_172 ( const struct V_13 * V_14 ,
struct V_206 * V_207 ,
const struct V_23 * V_24 )
{
...
static int F_173 ( struct V_13 * V_14 , int V_31 ,
struct V_222 * V_223 )
{
struct V_30 * V_33 ;
...
static int F_174 ( struct V_71 * V_72 , struct V_15 * V_16 ,
const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_45 * V_46 = F_33 ( V_18 ) ;
...
if ( V_207 . V_237 == 0 || V_207 . V_237 > F_175 ( struct V_255 , V_165 ) )
return - V_36 ;
V_44 = 0 ;
if ( V_24 [ V_214 ] != NULL ) {
...
if ( V_207 . V_202 == 0 ||
V_207 . V_202 > F_175 ( struct V_255 , V_165 ) )
return - V_36 ;
} else
...
if ( V_24 [ V_241 ] != NULL ) {
V_56 = F_172 ( & V_14 , & V_207 , V_24 [ V_241 ] ) ;
if ( V_56 < 0 )
return V_56 ;
}
V_140 = V_18 -> V_74 & V_141 ? true : false ;
...
static void F_176 ( struct V_222 * V_223 )
{
V_223 -> V_82 -> V_175 ( V_223 ) ;
F_71 ( V_223 -> V_82 -> V_92 ) ;
F_22 ( V_223 ) ;
}
static void F_177 ( const struct V_13 * V_14 , struct V_222 * V_223 )
{
F_7 ( & V_223 -> V_6 ) ;
F_165 ( V_14 , V_223 , V_262 , V_263 ) ;
F_176 ( V_223 ) ;
}
static int F_178 ( struct V_71 * V_72 , struct V_15 * V_16 ,
const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_45 * V_46 = F_33 ( V_18 ) ;
...
{
enum V_267 V_268 ;
V_268 = F_180 ( V_223 -> V_239 ) ;
return F_181 ( V_14 , V_268 , & V_187 -> V_165 ,
V_223 -> V_239 == V_258 ?
V_258 : V_253 ) ;
}
int F_182 ( const struct V_13 * V_14 , struct V_222 * V_223 ,
struct V_269 * V_270 )
{
struct V_269 * V_40 ;
struct V_264 V_265 ;
...
void F_183 ( const struct V_13 * V_14 , struct V_222 * V_223 ,
struct V_269 * V_270 )
{
F_7 ( & V_270 -> V_6 ) ;
if ( F_152 ( & V_223 -> V_261 ) && V_223 -> V_44 & V_256 &&
...
const struct V_266 * V_187 )
{
unsigned char * V_277 = F_186 ( V_16 ) ;
struct V_23 * V_104 ;
V_104 = F_85 ( V_16 , V_188 ) ;
if ( V_104 == NULL )
goto V_47;
if ( F_187 ( V_16 , V_278 , & V_187 -> V_279 , V_253 ,
V_223 -> V_237 ) < 0 )
goto V_47;
if ( V_223 -> V_44 & V_216 &&
! ( V_187 -> V_44 & V_280 ) &&
F_187 ( V_16 , V_281 , & V_187 -> V_165 ,
...
static int F_188 ( const struct V_13 * V_14 ,
const struct V_222 * V_223 ,
const struct V_264 * V_265 ,
const struct V_266 * V_187 )
{
struct V_284 * args ;
args = F_189 ( V_265 , struct V_284 , V_265 ) ;
return F_185 ( args -> V_16 , V_223 , V_187 ) ;
}
static int F_190 ( struct V_15 * V_16 , struct V_60 * V_61 )
{
const struct V_222 * V_223 ;
struct V_284 args ;
struct V_13 V_14 ;
...
T_1 V_26 , V_28 ;
int V_43 , V_56 ;
V_56 = F_170 ( V_61 -> V_18 , sizeof( struct V_45 ) , V_24 ,
V_285 , V_286 ) ;
if ( V_56 < 0 )
return V_56 ;
V_56 = F_184 ( & V_14 , V_61 -> V_16 , V_61 -> V_18 , ( void * ) V_24 ,
false ) ;
if ( V_56 < 0 )
return V_56 ;
...
static int F_191 ( struct V_71 * V_72 , struct V_15 * V_16 ,
const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_222 * V_223 ;
struct V_13 V_14 ;
int V_56 ;
V_56 = F_184 ( & V_14 , V_16 , V_18 , V_24 , false ) ;
if ( V_56 < 0 )
return V_56 ;
V_223 = F_154 ( V_14 . V_20 , V_24 [ V_287 ] ) ;
if ( F_53 ( V_223 ) )
...
static int F_193 ( const struct V_13 * V_14 ,
const struct V_222 * V_223 ,
const struct V_266 * V_187 ,
int V_43 , T_6 V_44 )
{
...
if ( V_16 == NULL )
goto V_56;
V_56 = F_192 ( V_16 , V_14 , 0 , V_26 , V_43 , V_44 ,
V_223 , V_187 ) ;
if ( V_56 < 0 ) {
F_42 ( V_16 ) ;
goto V_56;
...
static struct V_30 * F_194 ( struct V_13 * V_14 ,
int V_31 ,
struct V_222 * V_223 )
{
struct V_30 * V_33 ;
...
static int F_196 ( struct V_13 * V_14 , struct V_222 * V_223 ,
...
V_56 = F_197 ( V_14 , & V_187 . V_279 , & V_293 , V_24 [ V_278 ] ) ;
if ( V_56 < 0 )
goto V_157;
V_56 = - V_36 ;
...
goto V_158;
if ( V_24 [ V_281 ] != NULL ) {
V_56 = F_197 ( V_14 , & V_187 . V_165 , & V_294 , V_24 [ V_281 ] ) ;
if ( V_56 < 0 )
goto V_158;
V_56 = - V_36 ;
...
V_56 = F_181 ( & V_298 , V_268 ,
& V_187 . V_165 , V_294 . type ) ;
if ( V_56 < 0 )
goto V_203;
}
}
V_33 = F_194 ( V_14 , V_288 , V_223 ) ;
if ( V_33 == NULL )
goto V_203;
...
V_203:
if ( V_24 [ V_281 ] != NULL )
F_198 ( & V_187 . V_165 , V_294 . type ) ;
V_158:
F_198 ( & V_187 . V_279 , V_293 . type ) ;
V_157:
return V_56 ;
}
static int F_199 ( struct V_71 * V_72 , struct V_15 * V_16 ,
const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
struct V_1 * V_1 = F_15 ( V_16 -> V_25 ) ;
...
struct V_13 V_14 ;
int V_199 , V_56 = 0 ;
V_56 = F_184 ( & V_14 , V_16 , V_18 , V_24 , true ) ;
if ( V_56 < 0 )
return V_56 ;
V_223 = F_154 ( V_14 . V_20 , V_24 [ V_287 ] ) ;
if ( F_53 ( V_223 ) ) {
...
static int F_200 ( struct V_13 * V_14 , struct V_222 * V_223 ,
const struct V_23 * V_129 )
{
struct V_23 * V_24 [ V_291 + 1 ] ;
struct V_292 V_207 ;
...
if ( V_24 [ V_278 ] == NULL )
goto V_157;
V_56 = F_197 ( V_14 , & V_187 . V_279 , & V_207 , V_24 [ V_278 ] ) ;
if ( V_56 < 0 )
goto V_157;
V_56 = - V_36 ;
...
if ( V_56 < 0 )
goto V_158;
V_33 = F_194 ( V_14 , V_302 , V_223 ) ;
if ( V_33 == NULL )
goto V_158;
V_290 ( V_33 ) = V_187 ;
F_67 ( & V_33 -> V_6 , & V_14 -> V_1 -> V_7 . V_87 ) ;
F_198 ( & V_187 . V_279 , V_253 ) ;
if ( V_223 -> V_44 & V_216 )
F_198 ( & V_187 . V_165 , V_223 -> V_239 ) ;
V_158:
F_198 ( & V_187 . V_279 , V_207 . type ) ;
V_157:
return V_56 ;
}
static int F_201 ( struct V_71 * V_72 , struct V_15 * V_16 ,
const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_23 * V_129 ;
...
static void F_202 ( struct V_30 * V_33 )
{
struct F_59 * V_116 ;
if ( F_110 ( V_33 ) [ 0 ] )
...
static void F_203 ( struct V_303 * V_304 )
{
struct V_30 * V_33 = F_189 ( V_304 , struct V_30 , V_303 ) ;
switch ( V_33 -> V_31 ) {
case V_96 :
F_74 ( & V_33 -> V_14 ) ;
break;
...
F_102 () ;
F_205 (trans, next, &net->nft.commit_list, list) {
switch ( V_33 -> V_31 ) {
case V_67 :
if ( F_66 ( V_33 ) ) {
if ( ! F_65 ( V_33 ) ) {
...
F_21 ( & V_33 -> V_6 ) ;
V_33 -> V_14 . V_24 = NULL ;
F_206 ( & V_33 -> V_303 , F_203 ) ;
}
return 0 ;
}
static void F_207 ( struct V_303 * V_304 )
{
struct V_30 * V_33 = F_189 ( V_304 , struct V_30 , V_303 ) ;
switch ( V_33 -> V_31 ) {
case V_67 :
...
if ( V_187 -> V_44 & V_280 )
return 0 ;
switch ( V_187 -> V_165 . V_305 ) {
case V_306 :
case V_307 :
return F_211 ( V_14 , V_187 -> V_165 . V_22 ) ;
default:
return 0 ;
}
}
...
{
const struct V_176 * V_177 ;
const struct V_162 * V_163 , * V_308 ;
const struct V_222 * V_223 ;
struct V_269 * V_270 ;
struct V_264 V_265 ;
if ( V_14 -> V_22 == V_22 )
...
if ( ! V_163 -> V_82 -> V_310 )
continue;
V_56 = V_163 -> V_82 -> V_310 ( V_14 , V_163 , & V_165 ) ;
if ( V_56 < 0 )
return V_56 ;
if ( V_165 == NULL )
continue;
...
int F_181 ( const struct V_13 * V_14 , enum V_267 V_311 ,
...
return - V_36 ;
if ( V_165 -> V_305 == V_307 || V_165 -> V_305 == V_306 ) {
V_56 = F_211 ( V_14 , V_165 -> V_22 ) ;
if ( V_56 < 0 )
return V_56 ;
if ( V_14 -> V_22 -> V_316 + 1 > V_165 -> V_22 -> V_316 ) {
if ( V_14 -> V_22 -> V_316 + 1 == V_317 )
return - V_318 ;
V_165 -> V_22 -> V_316 = V_14 -> V_22 -> V_316 + 1 ;
}
}
return 0 ;
default:
...
static int F_214 ( const struct V_13 * V_14 , struct V_255 * V_165 ,
struct V_292 * V_207 , const struct V_23 * V_24 )
{
struct V_23 * V_130 [ V_319 + 1 ] ;
struct V_21 * V_22 ;
int V_56 ;
V_56 = F_94 ( V_130 , V_319 , V_24 , V_320 ) ;
if ( V_56 < 0 )
return V_56 ;
if ( ! V_130 [ V_321 ] )
return - V_36 ;
V_165 -> V_305 = F_63 ( F_64 ( V_130 [ V_321 ] ) ) ;
switch ( V_165 -> V_305 ) {
default:
switch ( V_165 -> V_305 & V_322 ) {
case V_139 :
case V_142 :
case V_323 :
break;
...
static void F_215 ( const struct V_255 * V_165 )
{
switch ( V_165 -> V_305 ) {
case V_306 :
case V_307 :
...
static int F_216 ( struct V_15 * V_16 , const struct V_255 * V_165 )
{
struct V_23 * V_104 ;
V_104 = F_85 ( V_16 , V_328 ) ;
if ( ! V_104 )
goto V_47;
if ( F_35 ( V_16 , V_321 , F_36 ( V_165 -> V_305 ) ) )
goto V_47;
switch ( V_165 -> V_305 ) {
case V_306 :
case V_307 :
if ( F_34 ( V_16 , V_327 , V_165 -> V_22 -> V_35 ) )
goto V_47;
}
F_88 ( V_16 , V_104 ) ;
return 0 ;
...
static int F_217 ( const struct V_13 * V_14 , struct V_255 * V_165 ,
struct V_292 * V_207 , const struct V_23 * V_24 )
{
unsigned int V_70 ;
V_70 = F_29 ( V_24 ) ;
...
static int F_218 ( struct V_15 * V_16 , const struct V_255 * V_165 ,
unsigned int V_70 )
{
return F_126 ( V_16 , V_329 , V_70 , V_165 -> V_165 ) ;
}
int F_197 ( const struct V_13 * V_14 , struct V_255 * V_165 ,
struct V_292 * V_207 , const struct V_23 * V_24 )
{
struct V_23 * V_130 [ V_330 + 1 ] ;
int V_56 ;
V_56 = F_94 ( V_130 , V_330 , V_24 , V_331 ) ;
if ( V_56 < 0 )
return V_56 ;
if ( V_130 [ V_329 ] )
return F_217 ( V_14 , V_165 , V_207 , V_130 [ V_329 ] ) ;
if ( V_130 [ V_328 ] && V_14 != NULL )
return F_214 ( V_14 , V_165 , V_207 , V_130 [ V_328 ] ) ;
return - V_36 ;
}
void F_198 ( const struct V_255 * V_165 , enum V_315 type )
{
switch ( type ) {
case V_253 :
return;
...
int F_187 ( struct V_15 * V_16 , int V_129 , const struct V_255 * V_165 ,
enum V_315 type , unsigned int V_70 )
{
struct V_23 * V_104 ;
int V_56 ;
...
switch ( type ) {
case V_253 :
V_56 = F_218 ( V_16 , V_165 , V_70 ) ;
break;
case V_258 :
V_56 = F_216 ( V_16 , V_165 ) ;
break;
default:
V_56 = - V_36 ;
F_219 ( 1 ) ;
...
static int F_220 ( struct V_1 * V_1 )
{
F_2 ( & V_1 -> V_7 . V_8 ) ;
F_2 ( & V_1 -> V_7 . V_87 ) ;
V_1 -> V_7 . V_64 = 1 ;
...
{
int V_56 ;
V_168 = F_222 ( sizeof( struct V_167 ) * V_201 ,
V_34 ) ;
if ( V_168 == NULL ) {
V_56 = - V_80 ;
goto V_157;
