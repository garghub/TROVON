...
int V_127 ;
F_48 ( & V_134 ) ;
V_127 = F_49 ( V_135 , V_136 , 1 ) ;
if ( V_127 >= V_136 ) {
F_50 ( V_137 L_8 , V_138 ) ;
goto V_139;
}
F_26 ( V_127 , V_135 ) ;
V_117 -> V_127 = V_127 ;
F_51 ( & V_117 -> V_132 , & V_140 ) ;
F_52 ( & V_134 ) ;
F_53 ( V_117 ) ;
F_54 ( V_117 -> V_79 , L_9
L_10 , V_117 -> V_127 ) ;
...
{
F_54 ( V_117 -> V_79 , L_11 , V_117 -> V_127 ) ;
F_48 ( & V_134 ) ;
F_56 ( & V_117 -> V_132 ) ;
F_52 ( & V_134 ) ;
F_57 ( V_117 ) ;
F_25 ( V_117 -> V_127 , V_135 ) ;
}
static int F_58 ( struct V_11 * V_12 )
{
struct V_112 * V_141 = V_12 -> V_15 . V_79 ;
struct V_1 * V_142 = V_12 -> V_15 . V_49 ;
const int V_143 = 1 ;
int V_105 ;
V_142 -> V_143 = V_143 ;
V_142 -> V_117 -> V_126 = V_143 + 1 ;
memset ( & V_142 -> V_117 -> V_124 . V_144 , 0 ,
sizeof V_142 -> V_117 -> V_124 . V_144 ) ;
F_26 ( V_143 , V_142 -> V_117 -> V_124 . V_144 ) ;
F_59 ( V_142 , V_145 ) ;
F_48 ( & V_134 ) ;
V_142 -> V_146 . V_110 . V_147 = F_60 ( 64 ) ;
V_105 = F_61 ( V_142 , V_148 ) ;
if ( V_105 != sizeof V_142 -> V_149 ) {
F_52 ( & V_134 ) ;
F_16 ( V_141 , L_12 ,
F_62 ( & V_142 -> V_50 ) , V_105 ) ;
return ( V_105 < 0 ) ? V_105 : - V_150 ;
}
if ( V_142 -> V_60 == V_151 ) {
V_105 = F_63 ( V_142 ) ;
if ( V_105 < 0 ) {
...
int F_109 ( struct V_22 * V_22 , T_5 V_178 )
{
int V_31 ;
struct V_11 * V_12 = F_42 ( V_22 -> V_50 -> V_117 ) ;
F_110 ( V_22 ) ;
F_111 ( & V_22 -> V_208 ) ;
F_111 ( & V_22 -> V_50 -> V_209 ) ;
...
static void F_129 ( unsigned long V_221 )
{
...
V_223 -> V_226 = true ;
V_227:
F_130 ( & V_223 -> V_228 , & V_224 ) ;
F_9 ( & V_223 -> V_225 ) ;
while ( ! F_131 ( & V_224 ) ) {
struct V_22 * V_22 ;
V_22 = F_132 ( V_224 . V_229 , struct V_22 , V_173 ) ;
F_83 ( & V_22 -> V_173 ) ;
...
if ( F_134 ( V_22 -> V_232 ) || F_135 ( V_22 -> V_232 ) ) {
V_223 = & V_12 -> V_231 ;
V_231 = true ;
} else {
V_223 = & V_12 -> V_233 ;
...
F_9 ( & V_165 ) ;
while ( ! F_131 ( & V_109 -> V_173 ) ) {
F_7 ( & V_165 ) ;
V_22 = NULL ;
if ( ! F_131 ( & V_109 -> V_173 ) ) {
V_22 = F_132 ( V_109 -> V_173 . V_237 , struct V_22 ,
V_173 ) ;
F_110 ( V_22 ) ;
}
F_9 ( & V_165 ) ;
...
int V_268 = F_147 ( & V_109 -> V_110 ) ;
int V_269 = F_35 ( & V_109 -> V_110 ) ;
F_148 ( V_2 , V_267 , V_268 , 0 ) ;
if ( V_269 )
F_148 ( V_2 , V_267 , ! V_268 , 0 ) ;
}
}
int F_149 ( struct V_261 * V_270 ,
...
if ( ! F_151 ( & V_271 [ V_244 ] -> V_110 ) )
return - V_107 ;
if ( V_271 [ V_244 ] -> V_276 )
return - V_107 ;
}
V_198 = V_12 -> V_20 -> V_274 ( V_12 , V_50 , V_271 , V_272 ,
V_273 , V_178 ) ;
if ( V_198 < 0 )
return V_198 ;
for ( V_244 = 0 ; V_244 < V_272 ; V_244 ++ )
V_271 [ V_244 ] -> V_276 = V_198 ;
return V_198 ;
}
int F_152 ( struct V_261 * V_270 ,
struct V_234 * * V_271 , unsigned int V_272 ,
T_5 V_178 )
{
struct V_11 * V_12 ;
...
return - V_107 ;
for ( V_244 = 0 ; V_244 < V_272 ; V_244 ++ )
if ( ! V_271 [ V_244 ] || ! V_271 [ V_244 ] -> V_276 )
return - V_107 ;
V_198 = V_12 -> V_20 -> V_275 ( V_12 , V_50 , V_271 , V_272 , V_178 ) ;
if ( V_198 < 0 )
return V_198 ;
for ( V_244 = 0 ; V_244 < V_272 ; V_244 ++ )
V_271 [ V_244 ] -> V_276 = 0 ;
...
if ( ! F_79 ( V_12 ) )
return - V_174 ;
return V_12 -> V_20 -> V_277 ( V_12 ) ;
}
int F_155 ( struct V_1 * V_278 , T_7 V_279 )
{
struct V_11 * V_12 = F_156 ( V_278 -> V_117 , struct V_11 , V_15 ) ;
int V_31 ;
int V_280 = V_12 -> V_281 ;
F_16 ( & V_278 -> V_50 , L_25 ,
( F_157 ( V_279 ) ? L_26 : L_21 ) ,
V_278 -> V_282 ) ;
if ( F_66 ( V_12 ) ) {
F_16 ( & V_278 -> V_50 , L_27 , L_28 ) ;
return 0 ;
}
if ( ! V_12 -> V_20 -> V_283 ) {
V_31 = - V_169 ;
} else {
F_25 ( V_284 , & V_12 -> V_94 ) ;
V_12 -> V_281 = V_285 ;
V_31 = V_12 -> V_20 -> V_283 ( V_12 ) ;
}
if ( V_31 == 0 ) {
F_59 ( V_278 , V_286 ) ;
V_12 -> V_281 = V_287 ;
...
F_7 ( & V_37 ) ;
if ( ! F_66 ( V_12 ) ) {
F_26 ( V_284 , & V_12 -> V_94 ) ;
V_12 -> V_281 = V_280 ;
}
F_9 ( & V_37 ) ;
F_16 ( & V_278 -> V_50 , L_30 ,
L_28 , V_31 ) ;
}
return V_31 ;
}
int F_158 ( struct V_1 * V_278 , T_7 V_279 )
{
struct V_11 * V_12 = F_156 ( V_278 -> V_117 , struct V_11 , V_15 ) ;
int V_31 ;
int V_280 = V_12 -> V_281 ;
F_16 ( & V_278 -> V_50 , L_31 ,
( F_157 ( V_279 ) ? L_26 : L_21 ) ) ;
if ( F_66 ( V_12 ) ) {
F_16 ( & V_278 -> V_50 , L_27 , L_32 ) ;
return 0 ;
}
if ( ! V_12 -> V_20 -> V_289 )
return - V_169 ;
...
return 0 ;
V_12 -> V_281 = V_290 ;
V_31 = V_12 -> V_20 -> V_289 ( V_12 ) ;
F_25 ( V_291 , & V_12 -> V_94 ) ;
if ( V_31 == 0 ) {
struct V_1 * V_2 ;
int V_292 ;
F_7 ( & V_37 ) ;
if ( ! F_66 ( V_12 ) ) {
F_59 ( V_278 , V_278 -> V_293
? V_294
: V_145 ) ;
F_26 ( V_284 , & V_12 -> V_94 ) ;
V_12 -> V_281 = V_295 ;
...
static void F_161 ( struct V_298 * V_299 )
{
struct V_11 * V_12 = F_156 ( V_299 , struct V_11 , V_300 ) ;
...
F_24 ( & V_37 , V_94 ) ;
if ( V_12 -> V_152 ) {
F_26 ( V_291 , & V_12 -> V_94 ) ;
F_164 ( V_301 , & V_12 -> V_300 ) ;
}
F_27 ( & V_37 , V_94 ) ;
}
int F_165 ( struct V_116 * V_117 , unsigned V_302 )
{
struct V_11 * V_12 ;
int V_31 = - V_303 ;
V_12 = F_156 ( V_117 , struct V_11 , V_15 ) ;
if ( V_302 && V_12 -> V_20 -> V_304 )
V_31 = V_12 -> V_20 -> V_304 ( V_12 , V_302 ) ;
if ( V_31 == 0 )
F_29 ( & V_12 -> V_101 , V_102 + F_166 ( 10 ) ) ;
return V_31 ;
}
T_8 F_167 ( int V_305 , void * V_306 )
{
struct V_11 * V_12 = V_306 ;
T_8 V_111 ;
if ( F_23 ( F_66 ( V_12 ) || ! F_168 ( V_12 ) ) )
V_111 = V_307 ;
else if ( V_12 -> V_20 -> V_305 ( V_12 ) == V_307 )
V_111 = V_307 ;
else
V_111 = V_308 ;
return V_111 ;
...
F_24 ( & V_37 , V_94 ) ;
F_25 ( V_284 , & V_12 -> V_94 ) ;
F_26 ( V_309 , & V_12 -> V_94 ) ;
if ( V_12 -> V_152 ) {
F_25 ( V_310 , & V_12 -> V_94 ) ;
F_59 ( V_12 -> V_15 . V_49 ,
V_296 ) ;
F_169 ( V_12 -> V_15 . V_49 ) ;
}
if ( F_170 ( V_12 ) && V_12 -> V_311 ) {
V_12 = V_12 -> V_311 ;
if ( V_12 -> V_152 ) {
F_25 ( V_310 , & V_12 -> V_94 ) ;
F_59 ( V_12 -> V_15 . V_49 ,
...
F_172 ( & V_223 -> V_225 ) ;
F_46 ( & V_223 -> V_228 ) ;
F_173 ( & V_223 -> V_223 , F_129 , ( unsigned long ) V_223 ) ;
}
struct V_11 * F_174 ( const struct V_312 * V_20 ,
struct V_112 * V_50 , const char * V_16 ,
struct V_11 * V_313 )
{
struct V_11 * V_12 ;
V_12 = F_12 ( sizeof( * V_12 ) + V_20 -> V_314 , V_44 ) ;
if ( ! V_12 ) {
F_16 ( V_50 , L_34 ) ;
return NULL ;
}
if ( V_313 == NULL ) {
V_12 -> V_315 = F_175 ( sizeof( * V_12 -> V_315 ) ,
V_44 ) ;
if ( ! V_12 -> V_315 ) {
F_19 ( V_12 ) ;
F_16 ( V_50 , L_35 ) ;
...
V_12 -> V_15 . V_79 = V_50 ;
V_12 -> V_15 . V_16 = V_16 ;
V_12 -> V_15 . V_200 = ( V_50 -> V_318 != NULL ) ;
F_178 ( & V_12 -> V_101 ) ;
V_12 -> V_101 . V_319 = F_30 ;
V_12 -> V_101 . V_13 = ( unsigned long ) V_12 ;
#ifdef F_179
F_180 ( & V_12 -> V_300 , F_161 ) ;
#endif
V_12 -> V_20 = V_20 ;
V_12 -> V_60 = V_20 -> V_94 & V_320 ;
V_12 -> V_17 = ( V_20 -> V_17 ) ? V_20 -> V_17 :
L_36 ;
return V_12 ;
}
struct V_11 * F_181 ( const struct V_312 * V_20 ,
struct V_112 * V_50 , const char * V_16 )
{
return F_174 ( V_20 , V_50 , V_16 , NULL ) ;
}
static void F_182 ( struct V_317 * V_317 )
{
struct V_11 * V_12 = F_156 ( V_317 , struct V_11 , V_317 ) ;
F_48 ( & V_316 ) ;
if ( F_170 ( V_12 ) )
F_19 ( V_12 -> V_315 ) ;
if ( V_12 -> V_311 ) {
struct V_11 * V_321 = V_12 -> V_311 ;
V_321 -> V_311 = NULL ;
if ( V_321 -> V_313 == V_12 )
V_321 -> V_313 = NULL ;
}
...
{
if ( V_12 )
F_186 ( & V_12 -> V_317 , F_182 ) ;
}
int F_170 ( struct V_11 * V_12 )
{
if ( ! V_12 -> V_313 )
return 1 ;
return V_12 == V_12 -> V_313 ;
}
int F_187 ( struct V_11 * V_12 , int V_292 )
{
if ( ! V_12 -> V_20 -> V_322 )
return V_292 ;
return V_12 -> V_20 -> V_322 ( V_12 , V_292 ) ;
}
...
int V_105 ;
if ( V_12 -> V_20 -> V_305 ) {
snprintf ( V_12 -> V_325 , sizeof( V_12 -> V_325 ) , L_37 ,
V_12 -> V_20 -> V_21 , V_12 -> V_15 . V_127 ) ;
V_105 = F_189 ( V_323 , & F_167 , V_324 ,
V_12 -> V_325 , V_12 ) ;
if ( V_105 != 0 ) {
F_65 ( V_12 -> V_15 . V_79 ,
L_38 ,
...
V_12 -> V_305 = V_323 ;
F_54 ( V_12 -> V_15 . V_79 , L_39 , V_323 ,
( V_12 -> V_20 -> V_94 & V_326 ) ?
L_40 : L_41 ,
( unsigned long long ) V_12 -> V_327 ) ;
} else {
V_12 -> V_305 = 0 ;
if ( V_12 -> V_327 )
...
int V_105 ;
struct V_1 * V_278 ;
if ( F_192 ( V_328 ) && ! V_12 -> V_329 ) {
struct V_330 * V_329 = F_193 ( V_12 -> V_15 . V_79 , 0 ) ;
if ( F_194 ( V_329 ) ) {
V_105 = F_195 ( V_329 ) ;
if ( V_105 == - V_331 )
return V_105 ;
...
if ( V_120 < 0 || V_120 > 1 )
V_12 -> V_120 = V_12 -> V_333 ? 0 : 1 ;
else
V_12 -> V_120 = V_120 ;
F_26 ( V_334 , & V_12 -> V_94 ) ;
...
goto V_336;
if ( ( V_278 = F_199 ( NULL , & V_12 -> V_15 , 0 ) ) == NULL ) {
F_65 ( V_12 -> V_15 . V_79 , L_45 ) ;
V_105 = - V_45 ;
goto V_337;
}
F_48 ( & V_316 ) ;
V_12 -> V_15 . V_49 = V_278 ;
F_52 ( & V_316 ) ;
switch ( V_12 -> V_60 ) {
case V_67 :
V_278 -> V_60 = V_163 ;
...
F_171 ( & V_12 -> V_233 ) ;
if ( F_170 ( V_12 ) && V_323 ) {
V_105 = F_188 ( V_12 , V_323 , V_324 ) ;
if ( V_105 )
goto V_341;
}
V_12 -> V_281 = V_295 ;
V_105 = V_12 -> V_20 -> V_342 ( V_12 ) ;
if ( V_105 < 0 ) {
...
goto V_344;
V_105 = F_201 ( & V_278 -> V_50 . V_345 , & V_346 ) ;
if ( V_105 < 0 ) {
F_50 ( V_137 L_49 ,
V_105 ) ;
goto V_347;
...
{
struct V_1 * V_278 = V_12 -> V_15 . V_49 ;
F_54 ( V_12 -> V_15 . V_79 , L_50 , V_12 -> V_281 ) ;
F_120 ( V_278 ) ;
F_210 ( & V_278 -> V_50 . V_345 , & V_346 ) ;
F_25 ( V_284 , & V_12 -> V_94 ) ;
if ( F_202 ( V_12 -> V_281 ) )
V_12 -> V_281 = V_285 ;
...
void
F_211 ( struct V_350 * V_50 )
{
struct V_11 * V_12 = F_212 ( V_50 ) ;
if ( V_12 -> V_20 -> V_351 )
V_12 -> V_20 -> V_351 ( V_12 ) ;
}
int F_213 ( struct V_352 * V_353 )
{
if ( V_354 )
return - V_177 ;
V_354 = V_353 ;
