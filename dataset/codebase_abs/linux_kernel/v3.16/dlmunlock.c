...
F_2 ( 0 , L_37 , V_7 , V_5 ) ;
F_4 ( & V_5 -> V_27 ) ;
V_96 = ( V_5 -> V_16 == V_3 -> V_18 ) ;
if ( V_10 & V_17 && V_7 -> V_49 . type != V_92 )
V_10 &= ~ V_17 ;
F_6 ( & V_5 -> V_27 ) ;
if ( V_96 ) {
