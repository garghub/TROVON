...
static void F_185 ( void * V_116 , struct V_17 * V_18 ,
...
if ( ! V_20 -> V_79 )
return;
F_88 ( & V_5 -> V_2 -> V_10 , V_421 ,
V_20 -> V_79 , V_20 -> V_422 ) ;
}
static int F_186 ( void * V_116 , struct V_17 * V_18 , unsigned int V_419 ,
unsigned int V_420 , unsigned int V_376 )
{
struct V_4 * V_5 = V_116 ;
struct V_16 * V_20 = F_9 ( V_18 ) ;
T_2 V_423 = F_23 ( V_5 -> V_37 + V_53 ) & V_54 ;
V_20 -> V_79 = F_86 ( & V_5 -> V_2 -> V_10 , V_421 ,
& V_20 -> V_422 , V_161 ) ;
if ( ! V_20 -> V_79 )
return - V_221 ;
memset ( V_20 -> V_79 , 0 , V_421 ) ;
V_20 -> V_164 = V_5 -> V_12 -> V_364 +
( sizeof( struct V_424 ) * V_420 ) ;
V_20 -> V_425 = V_5 -> V_12 -> V_55 +
( sizeof( struct V_424 ) * V_420 ) ;
if ( V_423 )
V_20 -> V_164 -> V_426 = V_165 F_70 ( ( V_20 -> V_422 >> 16 ) >> 16 ) ;
V_20 -> V_164 -> V_427 = V_165 F_70 ( V_20 -> V_422 & 0xFFFFFFFF ) ;
F_187 ( V_20 -> V_29 , V_428 ) ;
return 0 ;
}
...
V_5 -> V_325 = F_188 ( V_433 , V_5 -> V_376 ) ;
if ( V_5 -> V_325 == NULL ) {
F_39 ( & V_5 -> V_2 -> V_10 ,
L_123 ) ;
V_70 = - V_207 ;
...
do {
if ( ! F_189 ( & V_333 , V_161 ) )
goto V_435;
F_29 ( & V_332 ) ;
V_70 = F_190 ( & V_333 , & V_334 ) ;
F_32 ( & V_332 ) ;
} while ( V_70 == - V_175 );
if ( V_70 )
goto V_435;
...
if ( V_70 )
goto V_437;
V_5 -> V_325 -> V_438 = & V_5 -> V_2 -> V_10 ;
V_5 -> V_325 -> V_439 = V_5 -> V_439 ;
V_5 -> V_325 -> V_440 = V_5 -> V_132 * V_433 ;
V_5 -> V_325 -> V_441 = & V_442 ;
V_5 -> V_325 -> V_307 = V_5 ;
V_5 -> V_334 = V_334 ;
F_125 ( V_5 ) ;
V_431:
memset ( & V_5 -> V_25 , 0 , sizeof( V_5 -> V_25 ) ) ;
V_5 -> V_25 . V_443 = & V_444 ;
V_5 -> V_25 . V_445 = 1 ;
V_5 -> V_25 . V_446 = V_447 ;
V_5 -> V_25 . V_448 = 1 ;
V_5 -> V_25 . V_449 = sizeof( struct V_16 ) ;
...
if ( V_429 == V_352 )
goto V_453;
F_4 ( V_454 , & V_5 -> V_7 -> V_9 ) ;
F_194 ( V_5 -> V_7 , V_428 ) ;
F_195 ( V_5 -> V_7 , 4096 ) ;
F_196 ( V_5 -> V_7 , 0xffff ) ;
F_197 ( V_5 -> V_7 , 0x400000 ) ;
F_198 ( V_5 -> V_7 , 4096 ) ;
F_199 ( V_5 -> V_7 , V_5 -> V_2 -> V_455 ) ;
F_200 ( V_5 -> V_7 , 0 ) ;
if ( V_5 -> V_188 == true ) {
F_4 ( V_456 , & V_5 -> V_7 -> V_9 ) ;
V_5 -> V_7 -> V_457 . V_458 = 4096 ;
F_201 ( V_5 -> V_7 ,
V_218 * V_219 ) ;
V_5 -> V_7 -> V_457 . V_459 = 0 ;
}
if ( ! ( F_89 ( V_5 , & V_409 ) ) ) {
F_5 ( & V_5 -> V_2 -> V_10 ,
L_127 ) ;
...
F_202 ( V_5 -> V_325 , V_409 ) ;
F_203 ( V_5 -> V_325 ) ;
V_5 -> V_330 = F_204 ( V_5 -> V_325 , 0 ) ;
V_321 = F_135 ( & F_136 ( V_5 -> V_325 ) -> V_321 ) ;
if ( V_321 ) {
F_121 ( V_5 , V_321 ) ;
F_137 ( V_321 ) ;
...
V_453:
sprintf ( V_430 , L_128 , V_334 ) ;
V_5 -> V_461 = F_205 ( F_147 ,
V_5 , V_5 -> V_376 , L_75 ,
V_430 ) ;
if ( F_193 ( V_5 -> V_461 ) ) {
...
static void F_212 ( int V_463 )
{
V_464 [ V_463 ] -- ;
}
static int F_213 ( int V_465 )
{
int V_463 , V_466 , V_467 ;
...
static void F_219 ( struct V_4 * V_5 , struct V_1 * V_2 )
{
int V_473 ;
unsigned short V_474 ;
V_473 = F_220 ( V_2 , V_475 ) ;
if ( V_473 ) {
F_3 ( V_2 ,
V_473 + V_476 ,
& V_474 ) ;
...
static void F_222 ( struct V_4 * V_5 , struct V_1 * V_2 )
{
if ( V_2 -> V_480 && V_2 -> V_480 -> V_481 ) {
if ( V_2 -> V_480 -> V_481 -> V_477 == V_482 &&
( ( V_2 -> V_480 -> V_481 -> V_199 & 0xff00 ) == 0x5a00 ) ) {
F_219 ( V_5 , V_2 -> V_480 -> V_481 ) ;
} else {
struct V_1 * V_483 = V_2 -> V_480 -> V_481 ;
if ( V_483 -> V_480 &&
V_483 -> V_480 -> V_484 &&
V_483 -> V_480 -> V_484 -> V_481 &&
V_483 -> V_480 -> V_484 -> V_481 -> V_477 ==
V_482 &&
( V_483 -> V_480 -> V_484 -> V_481 -> V_199 &
0xff00 ) == 0x5a00 ) {
F_219 ( V_5 ,
V_483 -> V_480 -> V_484 -> V_481 ) ;
}
...
char V_487 [ 256 ] ;
const struct V_468 * V_469 ;
int V_463 , V_52 = 0 , V_488 = 0 ;
int V_489 = V_490 ;
unsigned long V_14 ;
V_489 = F_224 ( V_2 -> V_480 ) ;
if ( V_489 != V_490 ) {
if ( ! F_225 ( V_489 ) )
V_489 = F_217 () ;
} else {
...
F_49 ( & V_2 -> V_10 , L_136 ,
V_489 , F_224 ( V_2 -> V_480 ) , F_226 ( & V_2 -> V_10 ) ,
F_227 ( F_228 () ) , F_228 () ) ;
V_5 = F_158 ( sizeof( struct V_4 ) , V_161 , V_489 ) ;
if ( V_5 == NULL ) {
F_39 ( & V_2 -> V_10 ,
L_137 ) ;
return - V_221 ;
...
V_70 = F_231 ( V_2 , 1 << V_374 , V_97 ) ;
if ( V_70 < 0 ) {
F_39 ( & V_2 -> V_10 , L_139 ) ;
goto V_491;
}
if ( ! F_232 ( V_2 , F_233 ( 64 ) ) ) {
V_70 = F_234 ( V_2 , F_233 ( 64 ) ) ;
if ( V_70 ) {
V_70 = F_234 ( V_2 ,
F_233 ( 32 ) ) ;
if ( V_70 ) {
...
F_235 ( & V_5 -> V_494 ) ;
F_235 ( & V_5 -> V_495 ) ;
memset ( V_5 -> V_496 , 0 , 32 ) ;
snprintf ( V_5 -> V_496 , 31 , L_141 , V_5 -> V_132 ) ;
V_5 -> V_128 = F_236 ( V_5 -> V_496 ) ;
if ( ! V_5 -> V_128 ) {
...
V_469 = F_214 ( V_5 -> V_376 ) ;
if ( ! F_237 ( V_469 ) ) {
F_216 (cpu, node_mask)
{
snprintf ( & V_487 [ V_488 ] , 256 - V_488 , L_143 , V_463 ) ;
V_488 = strlen ( V_487 ) ;
}
F_49 ( & V_2 -> V_10 , L_144 ,
V_5 -> V_376 ,
...
F_53 ( & V_2 -> V_10 , L_145 ) ;
V_5 -> V_387 = F_213 ( V_5 -> V_376 ) ;
F_49 ( & V_2 -> V_10 , L_146 ,
F_227 ( V_5 -> V_387 ) , V_5 -> V_387 ) ;
V_5 -> V_126 [ 0 ] . V_127 = V_5 -> V_387 ;
V_5 -> V_126 [ 1 ] . V_127 = F_213 ( V_5 -> V_376 ) ;
V_5 -> V_126 [ 2 ] . V_127 = F_213 ( V_5 -> V_376 ) ;
...
F_240 (cpu) {
memset ( V_487 , 0 , sizeof( V_487 ) ) ;
for ( V_52 = 0 , V_488 = 0 ; V_52 < V_125 ; V_52 ++ ) {
if ( V_5 -> V_126 [ V_52 ] . V_127 == V_463 ) {
snprintf ( & V_487 [ V_488 ] , 256 - V_488 , L_143 , V_52 ) ;
V_488 = strlen ( V_487 ) ;
}
}
if ( V_488 )
F_49 ( & V_2 -> V_10 , L_147 , V_463 , V_487 ) ;
}
F_241 ( & V_5 -> V_126 [ 0 ] . V_126 , V_498 ) ;
F_241 ( & V_5 -> V_126 [ 1 ] . V_126 , V_499 ) ;
F_241 ( & V_5 -> V_126 [ 2 ] . V_126 , V_500 ) ;
F_241 ( & V_5 -> V_126 [ 3 ] . V_126 , V_501 ) ;
F_241 ( & V_5 -> V_126 [ 4 ] . V_126 , V_502 ) ;
F_241 ( & V_5 -> V_126 [ 5 ] . V_126 , V_503 ) ;
F_241 ( & V_5 -> V_126 [ 6 ] . V_126 , V_504 ) ;
F_241 ( & V_5 -> V_126 [ 7 ] . V_126 , V_505 ) ;
F_242 ( V_2 ) ;
V_70 = F_243 ( V_2 ) ;
if ( V_70 ) {
F_5 ( & V_2 -> V_10 ,
...
F_246 ( V_5 -> V_128 ) ;
F_247 ( V_5 -> V_128 ) ;
F_212 ( V_5 -> V_126 [ 0 ] . V_127 ) ;
F_212 ( V_5 -> V_126 [ 1 ] . V_127 ) ;
F_212 ( V_5 -> V_126 [ 2 ] . V_127 ) ;
}
V_492:
F_248 ( V_2 , 1 << V_374 ) ;
V_491:
...
static int F_252 ( struct V_1 * V_2 , T_15 V_509 )
{
int V_70 = 0 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( ! V_5 ) {
...
static int T_16 F_259 ( void )
{
int error ;
F_260 ( V_97 L_155 V_513 L_92 ) ;
F_160 ( & V_312 ) ;
F_235 ( & V_494 ) ;
F_235 ( & V_508 ) ;
error = F_261 ( 0 , V_97 ) ;
