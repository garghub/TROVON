...
V_5 -> V_7 = 0 ;
F_2 ( V_5 -> V_7 , V_2 -> V_9 + V_10 ) ;
F_17 ( V_39 , 0 , 0 , V_41 | V_42 ) ;
F_17 ( V_39 , 0 , 1 , V_41 | V_42 ) ;
F_18 ( V_39 , 0 , 0 , 0x0003 ) ;
F_2 ( V_38 , V_2 -> V_9 + V_36 ) ;
V_5 -> V_27 = 0 ;
F_2 ( V_5 -> V_27 , V_2 -> V_9 + V_30 ) ;
F_10 ( V_2 -> V_9 + V_43 ) ;
...
static int F_19 ( struct V_1 * V_2 , struct V_47 * V_48 )
{
const struct V_49 * V_50 = F_20 ( V_2 ) ;
struct V_4 * V_5 ;
struct V_11 * V_12 ;
int V_25 ;
V_25 = F_21 ( V_2 , V_48 -> V_51 [ 0 ] , 0x20 ) ;
if ( V_25 )
return V_25 ;
...
V_12 -> V_57 = V_50 -> V_58 ;
V_12 -> V_34 = 0x0fff ;
V_12 -> V_59 = V_48 -> V_51 [ 3 ] ? & V_60 : & V_61 ;
V_12 -> V_62 = F_3 ;
V_12 -> V_63 = F_7 ;
V_12 = & V_2 -> V_53 [ 1 ] ;
V_12 -> type = V_64 ;
