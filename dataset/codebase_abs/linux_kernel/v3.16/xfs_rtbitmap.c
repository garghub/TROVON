...
V_40 = F_19 ( V_1 , V_6 , V_39 ) ;
* V_40 += V_35 ;
F_20 ( V_2 , V_6 , ( V_41 ) ( ( char * ) V_40 - ( char * ) V_6 -> V_30 ) ,
...
if ( V_20 > V_43 )
F_20 ( V_2 , V_6 , ( V_41 ) ( ( char * ) V_43 - ( char * ) V_22 ) ,
...
T_3 V_46 ;
V_44 = V_17 + V_25 - 1 ;
error = F_21 ( V_1 , V_2 , V_17 , V_25 , 1 ) ;
if ( error ) {
return error ;
}
...
int V_50 ;
int error ;
error = F_24 ( V_1 , V_2 , V_51 , V_25 , 0 , & V_49 , & V_50 ) ;
if ( error )
return error ;
ASSERT ( V_50 ) ;
return 0 ;
...
ASSERT ( F_27 ( V_1 -> V_11 , V_55 ) ) ;
error = F_25 ( V_1 , V_2 , V_51 , V_25 ) ;
if ( error )
return error ;
error = F_22 ( V_1 , V_2 , V_51 , V_25 , & V_52 , & V_38 ) ;
if ( error ) {
return error ;
}
F_28 ( V_2 , V_56 , ( long ) V_25 ) ;
if ( V_2 -> V_57 + V_1 -> V_47 . V_58 ==
V_1 -> V_47 . V_48 ) {
if ( ! ( V_1 -> V_11 -> V_59 . V_60 & V_61 ) )
V_1 -> V_11 -> V_59 . V_60 |= V_61 ;
* ( V_62 * ) & V_1 -> V_11 -> V_59 . V_63 = 0 ;
F_29 ( V_2 , V_1 -> V_11 , V_64 ) ;
}
return 0 ;
}
