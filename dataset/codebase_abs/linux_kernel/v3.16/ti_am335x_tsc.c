...
struct V_1 * V_8 ;
struct V_60 * V_60 ;
struct V_91 * V_92 = F_25 ( V_86 ) ;
int V_90 ;
V_8 = F_26 ( sizeof( struct V_1 ) , V_93 ) ;
V_60 = F_27 () ;
if ( ! V_8 || ! V_60 ) {
F_28 ( & V_86 -> V_59 , L_7 ) ;
V_90 = - V_94 ;
...
V_60 -> V_103 [ 0 ] = F_30 ( V_104 ) | F_30 ( V_105 ) ;
V_60 -> V_106 [ F_31 ( V_74 ) ] = F_30 ( V_74 ) ;
F_32 ( V_60 , V_71 , 0 , V_70 , 0 , 0 ) ;
F_32 ( V_60 , V_72 , 0 , V_70 , 0 , 0 ) ;
F_32 ( V_60 , V_73 , 0 , V_70 , 0 , 0 ) ;
V_90 = F_33 ( V_60 ) ;
if ( V_90 )
goto V_100;
F_34 ( V_86 , V_8 ) ;
...
static int F_42 ( struct V_108 * V_59 )
{
...
static int F_46 ( struct V_108 * V_59 )
{
struct V_1 * V_8 = F_43 ( V_59 ) ;
struct V_91 * V_92 ;
V_92 = F_25 ( F_44 ( V_59 ) ) ;
