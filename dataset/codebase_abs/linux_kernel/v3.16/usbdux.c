...
struct V_8 * V_9 = V_6 -> V_10 ;
unsigned int V_59 = F_22 ( V_114 -> V_116 ) ;
unsigned int V_46 = V_9 -> V_61 [ V_59 ] ;
T_1 * V_91 = ( T_1 * ) & V_9 -> V_95 [ 2 ] ;
int V_55 = - V_108 ;
int V_4 ;
F_5 ( & V_9 -> V_16 ) ;
if ( V_9 -> V_52 )
...
{
int V_55 ;
V_55 = F_46 ( V_6 , V_15 , V_114 , V_115 , 0 ) ;
if ( V_55 )
return V_55 ;
return V_114 -> V_119 ;
}
...
return 0 ;
case V_155 :
return F_58 ( V_6 , V_15 , V_115 [ 1 ] ) ;
case V_156 :
V_115 [ 1 ] = V_9 -> V_142 ;
return 0 ;
case V_157 :
F_60 ( V_6 , V_15 , V_59 , V_115 [ 1 ] , ( V_115 [ 2 ] != 0 ) ) ;
return 0 ;
case V_158 :
return - V_105 ;
}
...
struct V_1 * V_1 ;
int V_4 ;
V_9 -> V_95 = F_70 ( V_96 , V_163 ) ;
V_9 -> V_24 = F_70 ( V_26 , V_163 ) ;
V_9 -> V_101 = F_70 ( V_102 , V_163 ) ;
V_9 -> V_11 = F_71 ( V_9 -> V_12 , sizeof( void * ) ,
V_163 ) ;
V_9 -> V_50 = F_71 ( V_9 -> V_51 , sizeof( void * ) ,
V_163 ) ;
...
V_1 -> V_6 = V_72 ;
V_1 -> V_17 = V_6 ;
V_1 -> V_168 = F_73 ( V_72 , 6 ) ;
V_1 -> V_74 = V_75 ;
V_1 -> V_25 = F_70 ( V_26 , V_163 ) ;
if ( ! V_1 -> V_25 )
return - V_162 ;
V_1 -> V_169 = F_7 ;
V_1 -> V_66 = 1 ;
...
V_1 -> V_6 = V_72 ;
V_1 -> V_17 = V_6 ;
V_1 -> V_168 = F_74 ( V_72 , 2 ) ;
V_1 -> V_74 = V_75 ;
V_1 -> V_25 = F_70 ( V_63 , V_163 ) ;
if ( ! V_1 -> V_25 )
return - V_162 ;
V_1 -> V_169 = F_21 ;
V_1 -> V_66 = 1 ;
...
if ( V_55 )
return V_55 ;
V_55 = F_82 ( V_72 , V_172 -> V_179 -> V_180 . V_181 ,
3 ) ;
if ( V_55 < 0 ) {
F_10 ( V_6 -> V_28 ,
L_15 ) ;
...
V_55 = F_83 ( V_6 , & V_72 -> V_6 , V_182 ,
F_63 , 0 ) ;
if ( V_55 < 0 )
return V_55 ;
V_55 = F_84 ( V_6 , ( V_9 -> V_64 ) ? 5 : 4 ) ;
if ( V_55 )
return V_55 ;
V_15 = & V_6 -> V_183 [ 0 ] ;
V_6 -> V_18 = V_15 ;
...
static int F_86 ( struct V_171 * V_172 ,
const struct V_211 * V_212 )
{
return F_87 ( V_172 , & V_213 , 0 ) ;
}
