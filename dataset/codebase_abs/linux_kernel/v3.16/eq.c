...
F_12 ( V_2 , L_33 , V_101 ) ;
if ( 0 ) {
F_22 ( V_2 , L_34 , V_10 -> V_131 ) ;
for ( V_42 = 0 ; V_42 < sizeof ( struct V_215 ) / 4 ; ++ V_42 ) {
if ( V_42 % 4 == 0 )
F_87 ( L_35 , V_42 * 4 ) ;
F_87 ( L_36 , F_88 ( V_204 -> V_24 + V_42 * 4 ) ) ;
if ( ( V_42 + 1 ) % 4 == 0 )
F_87 ( L_37 ) ;
}
}
...
int F_113 ( struct V_1 * V_2 , int V_240 )
{
struct V_39 * V_40 = V_39 ( V_2 ) ;
return V_40 -> V_181 . V_10 [ V_240 ] . V_179 ;
}
void F_114 ( struct V_1 * V_2 , int V_240 )
{
struct V_39 * V_40 = V_39 ( V_2 ) ;
