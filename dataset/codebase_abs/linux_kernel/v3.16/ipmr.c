...
static int F_61 ( struct V_1 * V_4 , int V_126 , int V_127 ,
struct V_128 * V_129 )
{
struct V_130 * V_63 ;
struct V_60 * V_61 ;
...
static void F_70 ( struct V_139 * V_129 )
{
struct V_140 * V_141 = F_71 ( V_129 , struct V_140 , V_142 ) ;
F_72 ( V_143 , V_141 ) ;
}
static inline void F_73 ( struct V_140 * V_141 )
{
F_74 ( & V_141 -> V_142 , F_70 ) ;
}
static void F_75 ( struct V_1 * V_4 , struct V_140 * V_141 )
{
struct V_2 * V_2 = F_76 ( & V_4 -> V_2 ) ;
struct V_33 * V_34 ;
struct V_144 * V_145 ;
F_77 ( & V_4 -> V_146 ) ;
while ( ( V_34 = F_78 ( & V_141 -> V_147 . V_148 . V_149 ) ) ) {
if ( F_79 ( V_34 ) -> V_76 == 0 ) {
struct V_150 * V_151 = (struct V_150 * ) F_80 ( V_34 , sizeof( struct V_117 ) ) ;
V_151 -> V_152 = V_153 ;
V_151 -> V_154 = F_81 ( sizeof( struct V_144 ) ) ;
F_82 ( V_34 , V_151 -> V_154 ) ;
V_145 = F_83 ( V_151 ) ;
V_145 -> error = - V_155 ;
memset ( & V_145 -> V_156 , 0 , sizeof( V_145 -> V_156 ) ) ;
F_84 ( V_34 , V_2 , F_85 ( V_34 ) . V_157 ) ;
} else {
F_49 ( V_34 ) ;
}
}
...
if ( F_89 ( V_141 -> V_147 . V_148 . V_159 , V_158 ) ) {
...
F_22 ( & V_141 -> V_51 ) ;
F_90 ( V_4 , V_141 , V_165 ) ;
F_75 ( V_4 , V_141 ) ;
}
if ( ! F_88 ( & V_4 -> V_56 ) )
F_87 ( & V_4 -> V_57 , V_161 + V_159 ) ;
V_163:
F_91 ( & V_160 ) ;
}
static void F_92 ( struct V_1 * V_4 , struct V_140 * V_166 ,
unsigned char * V_167 )
{
int V_126 ;
...
V_61 = F_94 ( V_2 , V_170 -> V_176 ) ;
if ( V_61 && F_39 ( V_61 ) == NULL ) {
F_69 ( V_61 ) ;
return - V_132 ;
}
} else {
V_61 = F_95 ( V_2 , V_170 -> V_75 . V_73 ) ;
}
if ( ! V_61 )
return - V_132 ;
V_7 = F_65 ( V_61 , 1 ) ;
...
static struct V_140 * F_96 ( struct V_1 * V_4 ,
T_6 V_189 ,
T_6 V_190 )
{
int line = F_97 ( V_190 , V_189 ) ;
struct V_140 * V_141 ;
...
static struct V_140 * F_99 ( struct V_1 * V_4 ,
int V_126 )
{
int line = F_97 ( F_100 ( V_193 ) , F_100 ( V_193 ) ) ;
struct V_140 * V_141 ;
F_98 (c, &mrt->mfc_cache_array[line], list)
if ( V_141 -> V_191 == F_100 ( V_193 ) &&
V_141 -> V_192 == F_100 ( V_193 ) &&
...
T_6 V_190 , int V_126 )
{
int line = F_97 ( V_190 , F_100 ( V_193 ) ) ;
struct V_140 * V_141 , * V_194 ;
if ( V_190 == F_100 ( V_193 ) )
goto V_195;
F_98 (c, &mrt->mfc_cache_array[line], list)
if ( V_141 -> V_191 == F_100 ( V_193 ) &&
V_141 -> V_192 == V_190 ) {
...
V_195:
return F_99 ( V_4 , V_126 ) ;
}
static struct V_140 * F_102 ( void )
{
struct V_140 * V_141 = F_103 ( V_143 , V_53 ) ;
if ( V_141 )
...
{
struct V_140 * V_141 = F_103 ( V_143 , V_197 ) ;
if ( V_141 ) {
F_105 ( & V_141 -> V_147 . V_148 . V_149 ) ;
...
struct V_33 * V_34 ;
struct V_144 * V_145 ;
while ( ( V_34 = F_107 ( & V_198 -> V_147 . V_148 . V_149 ) ) ) {
if ( F_79 ( V_34 ) -> V_76 == 0 ) {
struct V_150 * V_151 = (struct V_150 * ) F_80 ( V_34 , sizeof( struct V_117 ) ) ;
if ( F_108 ( V_4 , V_34 , V_141 , F_83 ( V_151 ) ) > 0 ) {
V_151 -> V_154 = F_109 ( V_34 ) -
( V_199 * ) V_151 ;
} else {
V_151 -> V_152 = V_153 ;
V_151 -> V_154 = F_81 ( sizeof( struct V_144 ) ) ;
...
#ifdef F_27
if ( assert == V_112 )
V_34 = F_112 ( V_201 , sizeof( struct V_117 ) ) ;
else
#endif
V_34 = F_113 ( 128 , V_197 ) ;
if ( ! V_34 )
return - V_174 ;
#ifdef F_27
if ( assert == V_112 ) {
...
F_115 ( V_34 ) ;
F_116 ( V_34 ) ;
V_156 = (struct V_204 * ) F_117 ( V_34 ) ;
memcpy ( V_156 , F_117 ( V_201 ) , sizeof( struct V_117 ) ) ;
V_156 -> V_208 = V_112 ;
V_156 -> V_209 = 0 ;
V_156 -> V_210 = V_4 -> V_59 ;
F_79 ( V_34 ) -> V_77 = sizeof( struct V_117 ) >> 2 ;
F_79 ( V_34 ) -> V_211 = F_118 ( F_119 ( F_79 ( V_201 ) -> V_211 ) +
sizeof( struct V_117 ) ) ;
} else
#endif
{
...
F_121 ( V_34 , V_77 ) ;
F_122 ( V_34 , V_201 -> V_212 , V_77 ) ;
F_79 ( V_34 ) -> V_78 = 0 ;
V_156 = (struct V_204 * ) F_117 ( V_34 ) ;
V_156 -> V_210 = V_126 ;
F_123 ( V_34 , F_124 ( F_125 ( V_201 ) ) ) ;
V_203 = (struct V_202 * ) F_121 ( V_34 , sizeof( struct V_202 ) ) ;
V_203 -> type =
V_156 -> V_208 = assert ;
V_203 -> V_213 = 0 ;
F_79 ( V_34 ) -> V_211 = F_118 ( V_34 -> V_110 ) ;
V_34 -> V_214 = V_34 -> V_215 ;
}
F_58 () ;
V_206 = F_126 ( V_4 -> V_206 ) ;
if ( V_206 == NULL ) {
F_60 () ;
F_49 ( V_34 ) ;
return - V_28 ;
}
V_207 = F_127 ( V_206 , V_34 ) ;
F_60 () ;
if ( V_207 < 0 ) {
F_128 ( L_5 ) ;
F_49 ( V_34 ) ;
...
static int
F_129 ( struct V_1 * V_4 , T_7 V_126 , struct V_33 * V_34 )
{
bool V_216 = false ;
int V_7 ;
struct V_140 * V_141 ;
...
F_134 ( & V_4 -> V_146 ) ;
F_135 ( & V_141 -> V_51 , & V_4 -> V_56 ) ;
F_90 ( V_4 , V_141 , V_218 ) ;
if ( F_132 ( & V_4 -> V_146 ) == 1 )
F_87 ( & V_4 -> V_57 , V_141 -> V_147 . V_148 . V_159 ) ;
}
if ( V_141 -> V_147 . V_148 . V_149 . V_219 > 3 ) {
F_49 ( V_34 ) ;
V_7 = - V_174 ;
} else {
F_136 ( & V_141 -> V_147 . V_148 . V_149 , V_34 ) ;
V_7 = 0 ;
}
F_133 ( & V_160 ) ;
return V_7 ;
}
static int F_137 ( struct V_1 * V_4 , struct V_220 * V_221 , int V_222 )
{
int line ;
struct V_140 * V_141 , * V_50 ;
line = F_97 ( V_221 -> V_223 . V_73 , V_221 -> V_224 . V_73 ) ;
...
if ( V_221 -> V_223 . V_73 != F_100 ( V_193 ) &&
! F_140 ( V_221 -> V_223 . V_73 ) )
return - V_28 ;
V_141 = F_102 () ;
if ( V_141 == NULL )
return - V_47 ;
...
if ( ! V_171 )
V_141 -> V_229 |= V_230 ;
F_141 ( & V_141 -> V_51 , & V_4 -> V_55 [ line ] ) ;
V_216 = false ;
F_130 ( & V_160 ) ;
...
static void F_145 ( struct V_205 * V_231 )
{
struct V_2 * V_2 = F_146 ( V_231 ) ;
struct V_1 * V_4 ;
F_46 () ;
F_2 (mrt, net) {
if ( V_231 == F_147 ( V_4 -> V_206 ) ) {
F_148 ( V_2 , V_135 ) -- ;
F_66 ( V_2 , V_136 ,
V_232 ,
V_2 -> V_15 . V_233 ) ;
F_149 ( V_4 -> V_206 , NULL ) ;
F_31 ( V_4 ) ;
}
}
F_45 () ;
}
int F_150 ( struct V_205 * V_231 , int V_234 , char V_85 * V_235 , unsigned int V_236 )
{
int V_207 , V_222 = 0 ;
struct V_62 V_237 ;
struct V_220 V_221 ;
...
F_151 ( V_231 ) -> V_240 != V_241 )
return - V_93 ;
V_4 = F_1 ( V_2 , F_152 ( V_231 ) -> V_242 ? : V_46 ) ;
if ( V_4 == NULL )
return - V_225 ;
if ( V_234 != V_243 ) {
if ( V_231 != F_153 ( V_4 -> V_206 ) &&
! F_154 ( V_2 -> V_244 , V_245 ) )
return - V_26 ;
}
switch ( V_234 ) {
case V_243 :
...
V_207 = F_155 ( V_231 , 1 , F_145 ) ;
if ( V_207 == 0 ) {
F_156 ( V_4 -> V_206 , V_231 ) ;
F_148 ( V_2 , V_135 ) ++ ;
F_66 ( V_2 , V_136 ,
V_232 ,
V_2 -> V_15 . V_233 ) ;
...
if ( V_231 != F_153 ( V_4 -> V_206 ) )
return - V_26 ;
return F_155 ( V_231 , 0 , NULL ) ;
case V_247 :
case V_248 :
if ( V_236 != sizeof( V_237 ) )
return - V_28 ;
if ( F_157 ( & V_237 , V_235 , sizeof( V_237 ) ) )
return - V_249 ;
if ( V_237 . V_81 >= V_169 )
return - V_227 ;
F_46 () ;
if ( V_234 == V_247 ) {
V_207 = F_93 ( V_2 , V_4 , & V_237 ,
V_231 == F_147 ( V_4 -> V_206 ) ) ;
} else {
V_207 = F_61 ( V_4 , V_237 . V_81 , 0 , NULL ) ;
}
F_45 () ;
return V_207 ;
case V_250 :
...
return - V_28 ;
if ( F_157 ( & V_221 , V_235 , sizeof( V_221 ) ) )
return - V_249 ;
if ( V_222 == 0 )
V_222 = V_221 . V_226 ;
F_46 () ;
if ( V_234 == V_251 || V_234 == V_253 )
V_207 = F_137 ( V_4 , & V_221 , V_222 ) ;
else
V_207 = F_139 ( V_2 , V_4 , & V_221 ,
V_231 == F_147 ( V_4 -> V_206 ) ,
V_222 ) ;
F_45 () ;
return V_207 ;
...
int F_159 ( struct V_205 * V_231 , int V_234 , char V_85 * V_235 , int V_85 * V_236 )
{
int V_261 ;
int V_262 ;
struct V_2 * V_2 = F_146 ( V_231 ) ;
...
V_234 != V_254 )
return - V_260 ;
if ( F_158 ( V_261 , V_236 ) )
return - V_249 ;
V_261 = F_160 (unsigned int, olr, sizeof(int)) ;
if ( V_261 < 0 )
return - V_28 ;
if ( F_161 ( V_261 , V_236 ) )
return - V_249 ;
if ( V_234 == V_263 )
V_262 = 0x0305 ;
#ifdef F_27
...
V_262 = V_4 -> V_255 ;
if ( F_162 ( V_235 , & V_262 , V_261 ) )
return - V_249 ;
return 0 ;
}
int F_163 ( struct V_205 * V_231 , int V_264 , void V_85 * V_11 )
{
struct V_265 V_266 ;
struct V_267 V_268 ;
struct V_130 * V_237 ;
...
return - V_132 ;
case V_274 :
if ( F_157 ( & V_266 , V_11 , sizeof( V_266 ) ) )
return - V_249 ;
F_58 () ;
V_141 = F_96 ( V_4 , V_266 . V_275 . V_73 , V_266 . V_276 . V_73 ) ;
if ( V_141 ) {
V_266 . V_277 = V_141 -> V_147 . V_9 . V_201 ;
V_266 . V_278 = V_141 -> V_147 . V_9 . V_279 ;
V_266 . V_280 = V_141 -> V_147 . V_9 . V_280 ;
F_60 () ;
if ( F_162 ( V_11 , & V_266 , sizeof( V_266 ) ) )
return - V_249 ;
return 0 ;
}
F_60 () ;
...
int F_164 ( struct V_205 * V_231 , unsigned int V_264 , void V_85 * V_11 )
{
struct V_282 V_266 ;
struct V_283 V_268 ;
struct V_130 * V_237 ;
...
static int F_165 ( struct V_284 * V_285 , unsigned long V_286 , void * V_287 )
{
struct V_60 * V_61 = F_166 ( V_287 ) ;
struct V_2 * V_2 = F_33 ( V_61 ) ;
struct V_1 * V_4 ;
struct V_130 * V_63 ;
int V_288 ;
...
{
struct V_117 * V_70 ;
const struct V_117 * V_291 = F_79 ( V_34 ) ;
F_114 ( V_34 , sizeof( struct V_117 ) ) ;
V_34 -> V_214 = V_34 -> V_215 ;
F_115 ( V_34 ) ;
V_70 = F_79 ( V_34 ) ;
...
V_70 -> V_78 = V_79 ;
V_70 -> V_77 = 5 ;
V_70 -> V_211 = F_118 ( V_34 -> V_110 ) ;
F_168 ( V_34 , NULL ) ;
F_169 ( V_70 ) ;
memset ( & ( F_170 ( V_34 ) -> V_294 ) , 0 , sizeof( F_170 ( V_34 ) -> V_294 ) ) ;
F_171 ( V_34 ) ;
}
static inline int F_172 ( struct V_33 * V_34 )
{
struct V_295 * V_294 = & ( F_170 ( V_34 ) -> V_294 ) ;
F_173 ( F_33 ( F_125 ( V_34 ) -> V_61 ) , V_296 ) ;
F_174 ( F_33 ( F_125 ( V_34 ) -> V_61 ) , V_297 , V_34 -> V_110 ) ;
if ( F_175 ( V_294 -> V_236 ) )
F_176 ( V_34 ) ;
return F_177 ( V_34 ) ;
}
...
#endif
if ( V_237 -> V_13 & V_137 ) {
V_299 = F_179 ( V_2 , & V_99 , NULL ,
V_237 -> V_180 , V_237 -> V_179 ,
0 , 0 ,
V_79 ,
F_180 ( V_70 -> V_41 ) , V_237 -> V_188 ) ;
if ( F_13 ( V_299 ) )
goto V_301;
V_300 = sizeof( struct V_117 ) ;
} else {
V_299 = F_179 ( V_2 , & V_99 , NULL , V_70 -> V_71 , 0 ,
0 , 0 ,
V_79 ,
F_180 ( V_70 -> V_41 ) , V_237 -> V_188 ) ;
if ( F_13 ( V_299 ) )
...
if ( V_34 -> V_110 + V_300 > F_181 ( & V_299 -> V_302 ) && ( F_119 ( V_70 -> V_293 ) & V_303 ) ) {
F_173 ( F_33 ( V_61 ) , V_304 ) ;
F_182 ( V_299 ) ;
goto V_301;
}
V_300 += F_183 ( V_61 ) + V_299 -> V_302 . V_305 ;
if ( F_184 ( V_34 , V_300 ) ) {
F_182 ( V_299 ) ;
goto V_301;
}
...
V_237 -> V_185 += V_34 -> V_110 ;
F_185 ( V_34 ) ;
F_123 ( V_34 , & V_299 -> V_302 ) ;
F_186 ( F_79 ( V_34 ) ) ;
if ( V_237 -> V_13 & V_137 ) {
F_167 ( V_34 , V_237 -> V_179 , V_237 -> V_180 ) ;
V_237 -> V_61 -> V_108 . V_111 ++ ;
V_237 -> V_61 -> V_108 . V_109 += V_34 -> V_110 ;
}
F_170 ( V_34 ) -> V_13 |= V_306 ;
F_187 ( V_307 , V_308 , V_34 , V_34 -> V_61 , V_61 ,
F_172 ) ;
return;
V_301:
F_49 ( V_34 ) ;
...
int V_309 = - 1 ;
int V_237 , V_288 ;
int V_310 = F_188 ( V_4 , V_34 -> V_61 ) ;
V_237 = V_166 -> V_196 ;
V_166 -> V_147 . V_9 . V_201 ++ ;
V_166 -> V_147 . V_9 . V_279 += V_34 -> V_110 ;
if ( V_166 -> V_191 == F_100 ( V_193 ) && V_310 >= 0 ) {
struct V_140 * V_311 ;
V_311 = F_99 ( V_4 , V_237 ) ;
if ( V_311 &&
...
if ( V_166 -> V_191 == F_100 ( V_193 ) &&
V_166 -> V_192 == F_100 ( V_193 ) ) {
if ( V_310 >= 0 &&
V_310 != V_166 -> V_196 &&
F_79 ( V_34 ) -> V_292 >
...
if ( ( V_166 -> V_191 != F_100 ( V_193 ) ||
V_288 != V_310 ) &&
F_79 ( V_34 ) -> V_292 > V_166 -> V_147 . V_9 . V_167 [ V_288 ] ) {
if ( V_309 != - 1 ) {
struct V_33 * V_318 = F_191 ( V_34 , V_197 ) ;
if ( V_318 )
F_178 ( V_2 , V_4 , V_318 , V_166 ,
V_309 ) ;
}
V_309 = V_288 ;
}
...
struct V_33 * V_318 = F_191 ( V_34 , V_197 ) ;
if ( V_318 )
F_178 ( V_2 , V_4 , V_318 , V_166 , V_309 ) ;
} else {
F_178 ( V_2 , V_4 , V_34 , V_166 , V_309 ) ;
return;
}
}
V_313:
...
{
struct V_298 * V_299 = F_190 ( V_34 ) ;
struct V_117 * V_70 = F_79 ( V_34 ) ;
struct V_5 V_99 = {
. V_71 = V_70 -> V_71 ,
. V_74 = V_70 -> V_74 ,
. V_319 = F_180 ( V_70 -> V_41 ) ,
. V_100 = ( F_189 ( V_299 ) ?
V_34 -> V_61 -> V_101 : 0 ) ,
. V_102 = ( F_189 ( V_299 ) ?
V_104 :
...
int V_179 = F_190 ( V_34 ) -> V_320 & V_321 ;
struct V_1 * V_4 ;
if ( F_170 ( V_34 ) -> V_13 & V_306 )
goto V_313;
V_4 = F_192 ( V_2 , V_34 ) ;
if ( F_13 ( V_4 ) ) {
F_49 ( V_34 ) ;
...
if ( ! V_179 ) {
if ( F_170 ( V_34 ) -> V_294 . V_322 ) {
if ( F_195 ( V_34 ) )
return 0 ;
} else if ( F_79 ( V_34 ) -> V_78 == V_241 ) {
struct V_205 * V_206 ;
V_206 = F_126 ( V_4 -> V_206 ) ;
if ( V_206 ) {
F_171 ( V_34 ) ;
...
V_166 = F_96 ( V_4 , F_79 ( V_34 ) -> V_74 , F_79 ( V_34 ) -> V_71 ) ;
if ( V_166 == NULL ) {
int V_237 = F_188 ( V_4 , V_34 -> V_61 ) ;
if ( V_237 >= 0 )
V_166 = F_101 ( V_4 , F_79 ( V_34 ) -> V_71 ,
V_237 ) ;
}
if ( V_166 == NULL ) {
int V_237 ;
...
F_50 ( & V_107 ) ;
V_237 = F_188 ( V_4 , V_34 -> V_61 ) ;
if ( V_237 >= 0 ) {
int V_49 = F_129 ( V_4 , V_237 , V_34 ) ;
F_52 ( & V_107 ) ;
return V_49 ;
}
F_52 ( & V_107 ) ;
...
F_50 ( & V_107 ) ;
F_110 ( V_2 , V_4 , V_34 , V_166 , V_179 ) ;
F_52 ( & V_107 ) ;
if ( V_179 )
return F_197 ( V_34 ) ;
return 0 ;
...
struct V_117 * V_300 ;
V_300 = (struct V_117 * ) ( F_199 ( V_34 ) + V_324 ) ;
if ( ! F_140 ( V_300 -> V_71 ) ||
V_300 -> V_211 == 0 ||
F_119 ( V_300 -> V_211 ) + V_324 > V_34 -> V_110 )
return 1 ;
F_50 ( & V_107 ) ;
if ( V_4 -> V_59 >= 0 )
...
F_80 ( V_34 , ( V_199 * ) V_300 - V_34 -> V_212 ) ;
F_115 ( V_34 ) ;
...
struct V_2 * V_2 = F_33 ( V_34 -> V_61 ) ;
struct V_1 * V_4 ;
if ( ! F_203 ( V_34 , sizeof( * V_331 ) + sizeof( struct V_117 ) ) )
goto V_332;
V_331 = F_204 ( V_34 ) ;
V_4 = F_192 ( V_2 , V_34 ) ;
if ( F_13 ( V_4 ) )
...
return - V_225 ;
if ( F_64 ( V_4 , V_141 -> V_196 ) &&
F_209 ( V_34 , V_347 , V_4 -> V_133 [ V_141 -> V_196 ] . V_61 -> V_101 ) < 0 )
return - V_200 ;
if ( ! ( V_344 = F_210 ( V_34 , V_348 ) ) )
return - V_200 ;
for ( V_288 = V_141 -> V_147 . V_9 . V_168 ; V_288 < V_141 -> V_147 . V_9 . V_131 ; V_288 ++ ) {
if ( F_64 ( V_4 , V_288 ) && V_141 -> V_147 . V_9 . V_167 [ V_288 ] < 255 ) {
...
return - V_225 ;
F_58 () ;
V_166 = F_96 ( V_4 , V_74 , V_71 ) ;
if ( V_166 == NULL && V_34 -> V_61 ) {
int V_237 = F_188 ( V_4 , V_34 -> V_61 ) ;
if ( V_237 >= 0 )
V_166 = F_101 ( V_4 , V_71 , V_237 ) ;
}
if ( V_166 == NULL ) {
struct V_33 * V_318 ;
struct V_117 * V_70 ;
...
F_50 ( & V_107 ) ;
if ( V_61 )
V_237 = F_188 ( V_4 , V_61 ) ;
if ( V_237 < 0 ) {
F_52 ( & V_107 ) ;
F_60 () ;
return - V_323 ;
}
V_318 = F_191 ( V_34 , V_197 ) ;
if ( ! V_318 ) {
F_52 ( & V_107 ) ;
F_60 () ;
return - V_47 ;
}
F_114 ( V_318 , sizeof( struct V_117 ) ) ;
F_115 ( V_318 ) ;
V_70 = F_79 ( V_318 ) ;
...
V_166 -> V_229 |= V_362 ;
V_7 = F_108 ( V_4 , V_34 , V_166 , V_341 ) ;
F_52 ( & V_107 ) ;
F_60 () ;
return V_7 ;
}
...
struct V_340 * V_341 ;
int V_7 ;
V_151 = F_217 ( V_34 , V_157 , V_363 , V_264 , sizeof( * V_341 ) , V_13 ) ;
if ( V_151 == NULL )
return - V_200 ;
V_341 = F_83 ( V_151 ) ;
V_341 -> V_364 = V_365 ;
...
V_341 -> V_374 = V_376 ;
V_341 -> V_360 = 0 ;
if ( F_218 ( V_34 , V_377 , V_141 -> V_191 ) ||
F_218 ( V_34 , V_378 , V_141 -> V_192 ) )
goto V_371;
V_7 = F_108 ( V_4 , V_34 , V_141 , V_341 ) ;
if ( V_7 < 0 && V_7 != - V_225 )
goto V_371;
return F_219 ( V_34 , V_151 ) ;
V_371:
F_220 ( V_34 , V_151 ) ;
return - V_200 ;
}
static T_8 F_221 ( bool V_149 , int V_131 )
{
T_8 V_110 =
...
+ F_223 ( 4 )
+ F_223 ( 0 )
+ V_131 * F_224 ( sizeof( struct V_342 ) )
+ F_223 ( sizeof( struct V_345 ) )
;
return V_110 ;
}
static void F_90 ( struct V_1 * V_4 , struct V_140 * V_221 ,
int V_264 )
{
struct V_2 * V_2 = F_76 ( & V_4 -> V_2 ) ;
struct V_33 * V_34 ;
int V_7 = - V_174 ;
V_34 = F_225 ( F_221 ( V_221 -> V_196 >= V_169 , V_4 -> V_131 ) ,
V_197 ) ;
if ( V_34 == NULL )
goto V_379;
V_7 = F_216 ( V_4 , V_34 , 0 , 0 , V_221 , V_264 , 0 ) ;
if ( V_7 < 0 )
goto V_379;
F_226 ( V_34 , V_2 , 0 , V_380 , NULL , V_197 ) ;
return;
V_379:
F_49 ( V_34 ) ;
if ( V_7 < 0 )
...
{
struct V_2 * V_2 = F_146 ( V_34 -> V_231 ) ;
struct V_1 * V_4 ;
struct V_140 * V_221 ;
...
static struct V_140 * F_239 ( struct V_2 * V_2 ,
...
return F_242 ( V_221 -> V_51 . V_50 , struct V_140 , V_51 ) ;
if ( V_404 -> V_166 == & V_4 -> V_56 )
goto V_405;
F_243 ( V_404 -> V_166 != & V_4 -> V_55 [ V_404 -> V_288 ] ) ;
while ( ++ V_404 -> V_288 < V_54 ) {
V_404 -> V_166 = & V_4 -> V_55 [ V_404 -> V_288 ] ;
if ( F_88 ( V_404 -> V_166 ) )
continue;
return F_244 ( V_404 -> V_166 , struct V_140 , V_51 ) ;
}
F_60 () ;
V_404 -> V_166 = & V_4 -> V_56 ;
V_404 -> V_288 = 0 ;
