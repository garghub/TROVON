...
goto V_65;
V_63 = - V_66 ;
if ( V_101 == NULL || ( V_63 = F_56 ( V_35 ) ) != 0 )
goto V_65;
...
if ( V_133 == V_132 )
F_76 ( V_125 , L_2 ,
L_3 , L_4 , L_5 , L_6 , L_7 , L_8 , L_9 , L_10 ) ;
else {
struct V_1 * V_4 = V_133 ;
F_76 ( V_125 ,
L_11 ,
( unsigned int ) F_77 ( V_4 -> V_3 ) ,
V_4 -> V_7 ,
( ( V_4 -> V_7 == V_8 ) ?
F_78 ( V_4 -> V_9 . V_10 , V_127 -> V_134 ) :
( ( V_4 -> V_7 == V_86 ) ?
F_79 ( F_80 ( V_125 ) , V_4 -> V_9 . V_87 ) :
0 ) ) ,
F_24 ( & V_4 -> V_6 ) ,
V_4 -> V_17 / V_53 ,
...
static int F_81 ( struct V_135 * V_135 , struct V_136 * V_136 )
{
struct V_124 * V_125 ;
struct V_126 * V_127 ;
int V_63 ;
V_63 = F_82 ( V_135 , V_136 , & V_137 ,
sizeof( struct V_126 ) ) ;
if ( ! V_63 ) {
V_125 = V_136 -> V_138 ;
V_127 = F_67 ( V_125 ) ;
F_83 () ;
V_127 -> V_134 = F_84 ( F_85 ( V_84 ) ) ;
F_86 () ;
}
return V_63 ;
}
...
struct V_126 * V_127 = F_67 ( V_125 ) ;
F_88 ( V_127 -> V_134 ) ;
return F_89 ( V_135 , V_136 ) ;
}
static int T_7 F_90 ( struct V_2 * V_2 )
{
if ( ! F_91 ( L_12 , V_139 , V_2 -> V_140 ,
& V_141 ) )
return - V_66 ;
return 0 ;
}
...
static inline int F_90 ( struct V_2 * V_2 )
{
return 0 ;
}
static inline void F_92 ( struct V_2 * V_2 )
{
}
static void T_3 F_94 ( struct V_2 * V_2 )
{
F_29 ( V_2 ) ;
F_92 ( V_2 ) ;
}
