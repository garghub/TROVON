...
void T_5 F_155 ( int V_144 , struct V_145 * V_146 )
{
F_68 ( 1 << V_144 ) ;
F_156 () ;
}
...
static void * T_6 F_158 ( unsigned int V_46 , T_8 V_208 ,
T_8 V_209 )
{
const unsigned long V_210 = F_40 ( V_211 ) ;
#ifdef F_159
int V_212 = F_160 ( V_46 ) ;
void * V_213 ;
if ( ! F_161 ( V_212 ) || ! F_162 ( V_212 ) ) {
V_213 = F_163 ( V_208 , V_209 , V_210 ) ;
F_164 ( L_33 ,
V_46 , V_212 ) ;
F_165 ( L_34 ,
V_46 , V_208 , F_40 ( V_213 ) ) ;
} else {
V_213 = F_166 ( F_162 ( V_212 ) ,
V_208 , V_209 , V_210 ) ;
F_165 ( L_35
...
return V_213 ;
#else
return F_163 ( V_208 , V_209 , V_210 ) ;
#endif
}
static void T_6 F_167 ( void * V_213 , T_8 V_208 )
{
F_168 ( F_40 ( V_213 ) , V_208 ) ;
}
static int T_6 F_169 ( unsigned int V_214 , unsigned int V_215 )
{
if ( F_160 ( V_214 ) == F_160 ( V_215 ) )
return V_216 ;
else
return V_217 ;
}
static void T_6 F_170 ( unsigned long V_218 )
{
T_9 * V_152 = F_171 ( V_218 ) ;
T_10 * V_219 ;
T_11 * V_220 ;
V_219 = F_172 ( V_152 , V_218 ) ;
if ( F_173 ( * V_219 ) ) {
T_11 * V_221 ;
V_221 = F_163 ( V_222 , V_222 , V_222 ) ;
F_174 ( & V_12 , V_219 , V_221 ) ;
}
V_220 = F_175 ( V_219 , V_218 ) ;
if ( ! F_176 ( * V_220 ) ) {
T_12 * V_221 ;
V_221 = F_163 ( V_222 , V_222 , V_222 ) ;
F_177 ( & V_12 , V_220 , V_221 ) ;
}
}
void T_6 F_178 ( void )
{
