...
V_7 -> V_539 = V_540 ;
V_7 -> V_541 = V_536 ;
F_216 ( V_542 , & V_7 -> V_164 ) ;
F_217 ( V_7 , V_10 ) ;
snprintf ( V_7 -> V_302 , sizeof( V_7 -> V_302 ) , L_93 ,
V_10 -> V_149 , ( V_10 -> V_149 == 848 && V_10 -> V_543 == 0x12 ) ? L_94 : L_87 ,
...
if ( V_387 > 0 )
F_191 ( L_95 ) ;
V_10 -> V_392 = F_214 ( V_10 , & V_548 , L_96 ) ;
if ( NULL == V_10 -> V_392 )
goto V_292;
if ( F_223 ( V_10 -> V_392 , V_409 ,
V_549 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_292;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_163 ( V_10 -> V_392 ) ) ;
if ( F_224 ( & V_10 -> V_392 -> V_8 ,
& V_550 ) < 0 ) {
F_19 ( L_98 , V_10 -> V_11 . V_58 ) ;
goto V_292;
}
V_10 -> V_401 = F_214 ( V_10 , & V_548 , L_99 ) ;
if ( NULL == V_10 -> V_401 )
goto V_292;
if ( F_223 ( V_10 -> V_401 , V_411 ,
V_551 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_292;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_163 ( V_10 -> V_401 ) ) ;
if ( ! V_10 -> V_552 )
return 0 ;
V_10 -> V_403 = F_214 ( V_10 , & V_553 , L_100 ) ;
if ( NULL == V_10 -> V_403 )
goto V_292;
V_10 -> V_403 -> V_121 = & V_10 -> V_554 ;
if ( F_223 ( V_10 -> V_403 , V_555 ,
V_556 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_292;
F_23 ( L_97 ,
...
static void F_225 ( struct V_557 * V_8 )
{
#if F_226 ( V_558 )
unsigned int V_478 ;
F_227 ( V_8 , V_559 , & V_478 ) ;
V_478 = ( V_478 | V_560 ) ;
F_228 ( V_8 , V_559 , V_478 ) ;
#endif
}
static int F_229 ( struct V_557 * V_8 , const struct V_561 * V_562 )
{
struct V_315 V_563 = {
. V_288 = 0 ,
. type = V_437 ,
...
return - V_361 ;
F_23 ( L_101 , V_567 ) ;
V_569 [ V_567 ] = V_10 = F_230 ( sizeof( * V_10 ) , V_360 ) ;
if ( V_10 == NULL ) {
F_19 ( L_102 ) ;
return - V_361 ;
}
V_10 -> V_11 . V_58 = V_567 ;
...
F_232 ( & V_10 -> V_570 ) ;
F_233 ( & V_10 -> V_535 ) ;
F_234 ( & V_10 -> V_11 . V_571 ) ;
F_234 ( & V_10 -> V_287 ) ;
F_234 ( & V_10 -> V_524 ) ;
F_235 ( & V_10 -> V_572 ) ;
V_10 -> V_572 . V_573 = F_200 ;
V_10 -> V_572 . V_237 = ( unsigned long ) V_10 ;
V_10 -> V_574 = - 1 ;
V_10 -> V_170 = V_12 ;
V_10 -> V_169 = V_12 ;
V_10 -> V_552 = V_575 [ V_10 -> V_11 . V_58 ] ;
V_10 -> V_11 . V_394 = V_8 ;
V_10 -> V_149 = V_8 -> V_1 ;
if ( F_236 ( V_8 ) ) {
...
if ( F_237 ( V_8 , F_238 ( 32 ) ) ) {
F_190 ( L_105 , V_10 -> V_11 . V_58 ) ;
return - V_576 ;
}
if ( ! F_239 ( F_240 ( V_8 , 0 ) ,
F_241 ( V_8 , 0 ) ,
V_10 -> V_11 . V_325 . V_302 ) ) {
F_190 ( L_106 ,
V_10 -> V_11 . V_58 ,
( unsigned long long ) F_240 ( V_8 , 0 ) ) ;
return - V_344 ;
}
F_242 ( V_8 ) ;
F_225 ( V_8 ) ;
V_485 = F_243 ( & V_8 -> V_8 , & V_10 -> V_11 . V_325 ) ;
if ( V_485 < 0 ) {
...
V_566 = & V_10 -> V_121 ;
F_244 ( V_566 , 20 ) ;
V_10 -> V_11 . V_325 . V_121 = V_566 ;
F_244 ( & V_10 -> V_554 , 6 ) ;
V_10 -> V_543 = V_8 -> V_543 ;
F_245 ( V_8 , V_578 , & V_564 ) ;
F_23 ( L_108 ,
V_567 , V_10 -> V_149 , V_10 -> V_543 , F_121 ( V_8 ) ,
V_10 -> V_11 . V_394 -> V_526 , V_564 ,
( unsigned long long ) F_240 ( V_8 , 0 ) ) ;
F_246 () ;
V_10 -> V_579 = F_247 ( F_240 ( V_8 , 0 ) , 0x1000 ) ;
if ( NULL == V_10 -> V_579 ) {
...
F_248 ( V_10 ) ;
F_17 ( 0 , V_175 ) ;
V_485 = F_249 ( V_10 -> V_11 . V_394 -> V_526 , F_211 ,
V_581 , V_10 -> V_11 . V_325 . V_302 , ( void * ) V_10 ) ;
if ( V_485 < 0 ) {
F_19 ( L_110 ,
V_567 , V_10 -> V_11 . V_394 -> V_526 ) ;
goto V_580;
}
if ( 0 != F_250 ( V_10 ) ) {
V_485 = - V_576 ;
...
F_252 ( V_566 , & V_584 , NULL ) ;
F_252 ( V_566 , & V_589 , NULL ) ;
F_252 ( V_566 , & V_586 , NULL ) ;
F_252 ( V_566 , & V_590 , NULL ) ;
F_252 ( V_566 , & V_593 , NULL ) ;
F_252 ( V_566 , & V_596 , NULL ) ;
F_252 ( V_566 , & V_594 , NULL ) ;
F_252 ( V_566 , & V_599 , NULL ) ;
F_252 ( V_566 , & V_600 , NULL ) ;
F_252 ( V_566 , & V_602 , NULL ) ;
if ( V_115 )
F_39 ( V_10 , L_111 ) ;
F_253 ( V_10 ) ;
F_56 ( V_10 ) ;
...
F_40 ( V_10 , 1 ) ;
if ( ! V_95 [ V_10 -> V_11 . type ] . V_173 ) {
F_258 ( & V_10 -> V_554 , V_566 ,
V_609 ) ;
if ( V_10 -> V_554 . error ) {
V_485 = V_10 -> V_554 . error ;
goto V_582;
}
...
if ( V_95 [ V_10 -> V_11 . type ] . V_610 ) {
F_259 ( & V_10 -> V_11 , L_113 ) ;
F_6 ( V_10 ) ;
}
if ( ! V_611 ) {
F_260 ( V_10 ) ;
...
return 0 ;
V_582:
F_262 ( V_10 -> V_11 . V_394 -> V_526 , V_10 ) ;
V_580:
F_263 ( & V_10 -> V_121 ) ;
F_263 ( & V_10 -> V_554 ) ;
F_264 ( & V_10 -> V_11 . V_325 ) ;
V_577:
if ( V_10 -> V_579 )
F_265 ( V_10 -> V_579 ) ;
F_266 ( F_240 ( V_10 -> V_11 . V_394 , 0 ) ,
F_241 ( V_10 -> V_11 . V_394 , 0 ) ) ;
return V_485 ;
}
static void F_267 ( struct V_557 * V_557 )
{
struct V_612 * V_325 = F_268 ( V_557 ) ;
struct V_9 * V_10 = F_269 ( V_325 ) ;
if ( V_60 )
...
F_263 ( & V_10 -> V_121 ) ;
F_263 ( & V_10 -> V_554 ) ;
F_273 ( V_10 -> V_11 . V_394 , & V_10 -> main ) ;
F_262 ( V_10 -> V_11 . V_394 -> V_526 , V_10 ) ;
F_265 ( V_10 -> V_579 ) ;
F_266 ( F_240 ( V_10 -> V_11 . V_394 , 0 ) ,
F_241 ( V_10 -> V_11 . V_394 , 0 ) ) ;
F_264 ( & V_10 -> V_11 . V_325 ) ;
V_569 [ V_10 -> V_11 . V_58 ] = NULL ;
F_66 ( V_10 ) ;
return;
}
static int F_274 ( struct V_557 * V_557 , T_13 V_252 )
{
struct V_612 * V_325 = F_268 ( V_557 ) ;
struct V_9 * V_10 = F_269 ( V_325 ) ;
struct V_511 V_614 ;
unsigned long V_164 ;
F_22 ( L_116 , V_10 -> V_11 . V_58 , V_252 . V_615 ) ;
F_53 ( & V_10 -> V_166 , V_164 ) ;
...
F_17 ( 0 , V_175 ) ;
F_54 ( & V_10 -> V_166 , V_164 ) ;
V_10 -> V_252 . V_616 = F_16 ( V_238 ) ;
V_10 -> V_252 . V_617 = F_50 () ;
F_275 ( V_557 ) ;
if ( 0 != F_276 ( V_557 , F_277 ( V_557 , V_252 ) ) ) {
F_278 ( V_557 ) ;
V_10 -> V_252 . V_618 = 1 ;
}
return 0 ;
}
static int F_279 ( struct V_557 * V_557 )
{
struct V_612 * V_325 = F_268 ( V_557 ) ;
struct V_9 * V_10 = F_269 ( V_325 ) ;
unsigned long V_164 ;
...
F_280 ( V_557 ) ;
F_58 ( V_10 ) ;
F_32 ( 0xffffff , V_10 -> V_252 . V_616 ) ;
F_281 ( V_10 -> V_252 . V_617 ) ;
F_53 ( & V_10 -> V_166 , V_164 ) ;
...
static int T_14 F_282 ( void )
{
int V_620 ;
V_567 = 0 ;
F_23 ( L_118 , V_621 ) ;
if ( V_282 < 2 || V_282 > V_622 )
V_282 = 2 ;
if ( V_283 > V_623 )
V_283 = V_623 ;
V_283 = ( V_283 + V_624 - 1 ) & V_625 ;
if ( V_60 )
F_23 ( L_119 ,
V_282 , V_283 >> 10 , V_283 >> V_626 ) ;
F_283 () ;
V_620 = F_284 ( & V_627 ) ;
if ( V_620 < 0 ) {
F_190 ( L_120 , V_620 ) ;
