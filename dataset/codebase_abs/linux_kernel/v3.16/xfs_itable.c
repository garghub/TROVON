...
if ( V_97 > 0 ) {
T_14 V_124 ;
error = F_27 ( V_101 , V_97 , V_125 ,
& V_115 ) ;
if ( ! error &&
V_115 &&
! ( error = F_28 ( V_101 , & V_124 , & V_104 ) ) &&
V_104 == 1 &&
V_97 < V_124 . V_126 + V_127 &&
( V_99 = V_97 - V_124 . V_126 + 1 ) <
V_127 &&
F_29 ( V_99 ,
V_127 - V_99 ) &
~ V_124 . V_128 ) {
for ( V_104 = 0 ; V_104 < V_99 ; V_104 ++ ) {
if ( F_30 ( V_104 ) & ~ V_124 . V_128 )
V_124 . V_129 ++ ;
}
V_124 . V_128 |= F_29 ( 0 , V_99 ) ;
V_107 -> V_126 = V_124 . V_126 ;
V_107 -> V_129 = V_124 . V_129 ;
V_107 -> V_128 = V_124 . V_128 ;
V_107 ++ ;
V_97 = V_124 . V_126 + V_127 ;
V_105 = V_127 - V_124 . V_129 ;
} else {
V_97 ++ ;
V_105 = 0 ;
}
...
error = F_27 ( V_101 , 0 , V_130 , & V_115 ) ;
V_105 = 0 ;
}
...
for ( V_97 = V_107 -> V_126 , V_99 = V_100 = 0 ;
F_22 ( V_117 ) &&
V_107 -> V_129 < V_127 ;
V_99 ++ , V_100 ++ , V_97 ++ ) {
ASSERT ( V_99 < V_127 ) ;
V_2 = F_19 ( V_1 , V_98 , V_97 ) ;
if ( F_30 ( V_99 ) & V_107 -> V_128 ) {
V_110 = V_2 ;
continue;
}
V_107 -> V_129 ++ ;
...
long * V_141 )
{
if ( F_14 ( V_88 , V_7 , V_138 * sizeof( * V_7 ) ) )
return - V_89 ;
* V_141 = V_138 * sizeof( * V_7 ) ;
return 0 ;
}
int
F_41 (
...
V_144 = * V_138 ;
* V_138 = 0 ;
V_142 = F_42 ( V_144 , ( int ) ( V_122 / sizeof( * V_7 ) ) ) ;
V_7 = F_6 ( V_142 * sizeof( * V_7 ) , V_20 ) ;
error = V_143 = 0 ;
V_101 = NULL ;
V_95 = NULL ;
while ( V_144 > 0 && V_98 < V_1 -> V_3 . V_120 ) {
if ( V_95 == NULL ) {
error = F_24 ( V_1 , NULL , V_98 , & V_95 ) ;
if ( error ) {
ASSERT ( V_101 == NULL ) ;
...
V_97 = V_124 . V_126 + V_127 - 1 ;
V_7 [ V_143 ] . V_146 =
F_19 ( V_1 , V_98 , V_124 . V_126 ) ;
V_7 [ V_143 ] . V_147 =
V_127 - V_124 . V_129 ;
V_7 [ V_143 ] . V_148 = ~ V_124 . V_128 ;
V_143 ++ ;
V_144 -- ;
if ( V_143 == V_142 ) {
long V_141 ;
if ( V_9 ( V_88 , V_7 , V_143 , & V_141 ) ) {
error = F_5 ( V_89 ) ;
break;
}
V_88 += V_141 ;
