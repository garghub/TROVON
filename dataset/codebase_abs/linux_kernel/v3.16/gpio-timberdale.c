...
struct V_6 * V_7 ;
struct V_54 * V_55 ;
struct V_56 * V_57 = F_24 ( & V_48 -> V_52 ) ;
int V_20 = F_25 ( V_48 , 0 ) ;
if ( ! V_57 || V_57 -> V_58 > 32 ) {
F_26 ( V_52 , L_1 ) ;
return - V_17 ;
}
V_55 = F_27 ( V_48 , V_59 , 0 ) ;
if ( ! V_55 ) {
F_26 ( V_52 , L_2 ) ;
return - V_17 ;
}
V_7 = F_28 ( V_52 , sizeof( struct V_6 ) , V_60 ) ;
if ( ! V_7 ) {
F_26 ( V_52 , L_3 ) ;
return - V_17 ;
}
V_7 -> V_16 = V_57 -> V_16 ;
F_29 ( & V_7 -> V_9 ) ;
if ( ! F_30 ( V_52 , V_55 -> V_61 , F_31 ( V_55 ) ,
V_62 ) ) {
F_26 ( V_52 , L_4 ) ;
return - V_63 ;
}
V_7 -> V_10 = F_32 ( V_52 , V_55 -> V_61 , F_31 ( V_55 ) ) ;
if ( ! V_7 -> V_10 ) {
F_26 ( V_52 , L_5 ) ;
return - V_64 ;
}
V_53 = & V_7 -> V_2 ;
V_53 -> V_65 = F_33 ( & V_48 -> V_52 ) ;
V_53 -> V_66 = V_67 ;
V_53 -> V_52 = & V_48 -> V_52 ;
V_53 -> V_68 = F_7 ;
V_53 -> V_69 = F_8 ;
V_53 -> V_70 = F_9 ;
V_53 -> V_71 = F_10 ;
V_53 -> V_72 = ( V_20 >= 0 && V_7 -> V_16 > 0 ) ? F_11 : NULL ;
V_53 -> V_73 = NULL ;
V_53 -> V_74 = V_57 -> V_75 ;
V_53 -> V_30 = V_57 -> V_58 ;
V_53 -> V_76 = false ;
...
return 0 ;
for ( V_50 = 0 ; V_50 < V_57 -> V_58 ; V_50 ++ ) {
F_36 ( V_7 -> V_16 + V_50 ,
& V_77 , V_78 ) ;
F_37 ( V_7 -> V_16 + V_50 , V_7 ) ;
#ifdef F_38
F_39 ( V_7 -> V_16 + V_50 , V_79 | V_80 ) ;
#endif
}
F_40 ( V_20 , V_7 ) ;
F_41 ( V_20 , F_18 ) ;
...
int V_50 ;
for ( V_50 = 0 ; V_50 < V_57 -> V_58 ; V_50 ++ ) {
F_44 ( V_7 -> V_16 + V_50 , NULL ) ;
F_37 ( V_7 -> V_16 + V_50 , NULL ) ;
}
F_45 ( V_20 , NULL ) ;
F_40 ( V_20 , NULL ) ;
}
