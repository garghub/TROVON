...
case V_152 :
if ( V_4 -> V_49 >= V_65 )
* V_24 = V_4 -> V_66 . V_67 . V_153 ;
else if ( V_4 -> V_49 >= V_69 )
* V_24 = V_4 -> V_66 . V_70 . V_153 ;
else if ( V_4 -> V_49 >= V_71 )
* V_24 = V_4 -> V_66 . V_72 . V_154 ;
else if ( V_4 -> V_49 >= V_50 )
* V_24 = V_4 -> V_66 . V_73 . V_154 ;
else if ( V_4 -> V_49 >= V_74 )
* V_24 = V_4 -> V_66 . V_75 . V_154 ;
else if ( V_4 -> V_49 >= V_76 )
* V_24 = V_4 -> V_66 . V_77 . V_154 ;
else
* V_24 = 1 ;
break;
default:
...
int F_38 ( struct V_1 * V_2 , struct V_21 * V_155 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_9 ;
V_155 -> V_156 = NULL ;
...
if ( V_4 -> V_52 ) {
V_9 = F_41 ( V_4 -> V_161 . V_162 , false ) ;
if ( V_9 ) {
F_42 ( V_4 , V_160 ) ;
F_7 ( V_158 ) ;
return V_9 ;
}
V_160 -> V_163 = F_43 ( V_4 , V_160 ,
V_4 -> V_161 . V_162 ) ;
V_9 = F_44 ( V_4 , V_160 -> V_163 ,
V_164 ,
V_165 |
V_166 ) ;
F_45 ( V_4 -> V_161 . V_162 ) ;
if ( V_9 ) {
F_42 ( V_4 , V_160 ) ;
F_7 ( V_158 ) ;
return V_9 ;
...
{
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_4 -> V_49 >= V_71 && V_155 -> V_156 ) {
struct V_157 * V_158 = V_155 -> V_156 ;
...
F_54 ( & V_4 -> V_168 . V_169 , V_167 ) ;
V_4 -> V_168 . V_170 [ V_38 ] = true ;
V_9 = F_55 ( V_4 ) ;
F_56 ( & V_4 -> V_168 . V_169 , V_167 ) ;
return V_9 ;
}
...
struct V_37 * V_174 ;
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_38 < 0 || V_38 >= V_2 -> V_175 ) {
F_29 ( L_15 , V_38 ) ;
return - V_62 ;
}
V_174 = & V_4 -> V_32 . V_57 [ V_38 ] -> V_58 ;
return F_59 ( V_2 , V_38 , V_171 ,
V_173 , V_8 ,
V_174 , & V_174 -> V_176 ) ;
}
