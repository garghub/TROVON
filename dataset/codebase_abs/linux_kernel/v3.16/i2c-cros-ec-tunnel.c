...
V_44 = V_35 -> V_49 -> V_50 ( V_35 -> V_49 , V_51 ,
V_42 , V_40 ,
V_43 , V_41 ) ;
if ( V_44 )
goto exit;
...
struct V_59 * V_49 = F_12 ( V_55 -> V_38 . V_60 ) ;
...
V_35 = F_14 ( V_38 , sizeof( * V_35 ) , V_46 ) ;
if ( V_35 == NULL )
return - V_47 ;
V_61 = F_15 ( V_57 , L_4 , & V_39 ) ;
if ( V_61 ) {
F_13 ( V_38 , L_5 ) ;
return V_61 ;
}
...
V_35 -> V_38 = V_38 ;
V_35 -> V_33 . V_63 = V_64 ;
F_16 ( V_35 -> V_33 . V_65 , L_6 , sizeof( V_35 -> V_33 . V_65 ) ) ;
V_35 -> V_33 . V_66 = & V_67 ;
V_35 -> V_33 . V_36 = V_35 ;
...
static int F_19 ( struct V_54 * V_38 )
{
