...
V_82 = F_31 ( V_8 + V_83 ) ;
F_29 ( V_8 , V_61 ) ;
F_30 ( F_31 ( V_8 + V_63 ) & ~ V_102 , V_8 + V_63 ) ;
F_29 ( V_8 , V_60 ) ;
F_30 ( V_103 | V_65 , V_8 + V_64 ) ;
F_44 ( V_12 -> V_4 . V_6 , V_12 -> V_43 , V_12 -> V_38 . V_97 ,
V_104 ) ;
V_12 -> V_4 . V_105 = V_106 ;
F_29 ( V_8 , V_61 ) ;
F_30 ( F_31 ( V_8 + V_63 ) | V_102 | V_107 , V_8 + V_63 ) ;
F_30 ( V_82 , V_8 + V_83 ) ;
}
static int F_45 ( int V_8 , T_4 * V_108 , int V_97 , int V_22 )
{
int V_109 = 0 ;
T_4 V_82 ;
F_2 ( 4 , L_1 , V_2 ) ;
...
T_4 V_82 ;
F_2 ( 4 , L_21 , V_2 , V_96 ) ;
F_48 (self != NULL, return;) ;
V_8 = V_12 -> V_4 . V_20 ;
V_82 = F_31 ( V_8 + V_83 ) ;
F_29 ( V_8 , V_61 ) ;
F_30 ( F_31 ( V_8 + V_63 ) & ~ V_102 , V_8 + V_63 ) ;
if ( F_31 ( V_8 + V_113 ) & V_114 ) {
F_2 ( 0 , L_22 , V_2 ) ;
V_12 -> V_49 -> V_115 . V_116 ++ ;
V_12 -> V_49 -> V_115 . V_117 ++ ;
F_30 ( V_114 , V_8 + V_113 ) ;
} else
V_12 -> V_49 -> V_115 . V_118 ++ ;
if ( V_12 -> V_99 ) {
F_32 ( V_12 , V_12 -> V_99 ) ;
V_12 -> V_99 = 0 ;
}
...
F_30 ( F_31 ( V_8 + V_63 ) & ~ V_102 , V_8 + V_63 ) ;
F_29 ( V_8 , V_60 ) ;
F_30 ( ( F_31 ( V_8 + V_64 ) & ~ V_103 ) | V_65 ,
V_8 + V_64 ) ;
V_12 -> V_4 . V_105 = V_121 ;
V_12 -> V_36 . V_48 = V_12 -> V_36 . V_39 ;
#ifdef F_28
F_49 ( & V_12 -> V_19 , V_119 ) ;
F_50 ( V_12 -> V_4 . V_6 ) ;
F_51 ( V_12 -> V_4 . V_6 ) ;
F_52 ( V_12 -> V_4 . V_6 , V_122 ) ;
F_53 ( V_12 -> V_4 . V_6 , V_12 -> V_40 ) ;
F_54 ( V_12 -> V_4 . V_6 , V_12 -> V_36 . V_37 ) ;
#else
F_44 ( V_12 -> V_4 . V_6 , V_12 -> V_40 , V_12 -> V_36 . V_37 ,
V_122 ) ;
#endif
F_29 ( V_8 , V_61 ) ;
...
#ifdef F_28
V_120 = F_31 ( V_8 + V_63 ) ;
F_30 ( V_120 | V_102 , V_8 + V_63 ) ;
F_55 ( V_12 -> V_4 . V_6 ) ;
F_56 ( & V_12 -> V_19 , V_119 ) ;
#else
F_30 ( F_31 ( V_8 + V_63 ) | V_102 , V_8 + V_63 ) ;
#endif
F_30 ( V_82 , V_8 + V_83 ) ;
...
if ( V_125 & V_132 ) {
if ( V_125 & V_133 ) {
V_12 -> V_49 -> V_115 . V_134 += V_97 ;
} else {
V_12 -> V_49 -> V_115 . V_134 ++ ;
V_12 -> V_36 . V_48 += V_97 ;
if ( V_125 & V_135 )
V_12 -> V_49 -> V_115 . V_136 ++ ;
if ( V_125 & V_137 )
V_12 -> V_49 -> V_115 . V_138 ++ ;
if ( V_125 & V_139 )
V_12 -> V_49 -> V_115 . V_140 ++ ;
}
if ( V_125 & V_141 )
V_12 -> V_49 -> V_115 . V_142 ++ ;
if ( V_125 & V_143 )
V_12 -> V_49 -> V_115 . V_142 ++ ;
} else {
F_29 ( V_8 , V_61 ) ;
if ( F_31 ( V_8 + V_110 ) & V_144 ) {
F_41 ( 80 ) ;
}
V_94 = F_58 ( V_97 + 1 ) ;
if ( V_94 == NULL ) {
...
V_12 -> V_36 . V_48 += V_97 ;
V_12 -> V_49 -> V_115 . V_146 ++ ;
V_94 -> V_10 = V_12 -> V_49 ;
F_62 ( V_94 ) ;
V_94 -> V_147 = F_63 ( V_148 ) ;
F_64 ( V_94 ) ;
}
}
F_30 ( V_82 , V_8 + V_83 ) ;
...
F_66 ( V_12 -> V_49 , & V_12 -> V_49 -> V_115 , & V_12 -> V_36 ,
V_149 ) ;
} while ( F_31 ( V_8 + V_110 ) & V_144 );
}
static T_4 F_67 ( struct V_11 * V_12 , int V_151 )
{
int V_109 ;
T_4 V_152 = 0 ;
T_4 V_82 ;
...
V_8 = V_12 -> V_4 . V_20 ;
if ( V_151 & V_153 ) {
V_109 = F_45 ( V_12 -> V_4 . V_20 ,
V_12 -> V_38 . V_48 ,
V_12 -> V_38 . V_97 ,
V_12 -> V_4 . V_22 ) ;
V_12 -> V_38 . V_48 += V_109 ;
V_12 -> V_38 . V_97 -= V_109 ;
V_12 -> V_4 . V_105 = V_106 ;
if ( V_12 -> V_38 . V_97 > 0 ) {
V_152 |= V_101 ;
} else {
...
static T_4 F_68 ( struct V_11 * V_12 , int V_151 )
{
T_4 V_152 = 0 ;
T_4 V_82 ;
int V_8 ;
...
static T_7 F_69 ( int V_5 , void * V_167 )
{
...
if ( V_151 ) {
if ( V_12 -> V_4 . V_80 > V_90 )
V_168 = F_68 ( V_12 , V_151 ) ;
else
V_168 = F_67 ( V_12 , V_151 ) ;
}
F_30 ( V_168 , V_8 + V_84 ) ;
F_30 ( V_82 , V_8 + V_83 ) ;
return F_70 ( V_151 ) ;
...
T_4 V_82 ;
F_2 ( 0 , L_1 , V_2 ) ;
F_48 (dev != NULL, return -1;) ;
V_12 = F_11 ( V_10 ) ;
F_48 (self != NULL, return 0;) ;
V_8 = V_12 -> V_4 . V_20 ;
if ( F_73 ( V_12 -> V_4 . V_5 , F_69 , 0 , V_10 -> V_53 ,
( void * ) V_10 ) ) {
return - V_172 ;
}
if ( F_74 ( V_12 -> V_4 . V_6 , V_10 -> V_53 ) ) {
F_75 ( V_12 -> V_4 . V_5 , V_10 ) ;
return - V_172 ;
}
V_82 = F_31 ( V_8 + V_83 ) ;
F_29 ( V_8 , V_61 ) ;
...
V_12 -> V_173 = F_77 ( V_10 , & V_12 -> V_23 , V_171 ) ;
return 0 ;
}
...
static int F_81 ( struct V_9 * V_10 , struct V_174 * V_175 , int V_176 )
{
