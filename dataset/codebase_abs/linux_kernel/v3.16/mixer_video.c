...
static int F_49 ( struct V_37 * V_37 , void * V_107 , T_3 V_149 )
{
struct V_41 * V_42 = F_23 ( V_37 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
int V_11 ;
...
static int F_50 ( struct V_37 * V_37 , void * V_107 , T_3 * V_149 )
{
struct V_41 * V_42 = F_23 ( V_37 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
int V_11 ;
...
static int F_85 ( struct V_178 * V_179 , const struct V_97 * V_180 ,
...
V_184 [ V_20 ] = V_42 -> V_7 -> V_22 ;
V_183 [ V_20 ] = V_90 [ V_20 ] . V_95 ;
F_24 ( V_7 , L_27 , V_20 , V_183 [ V_20 ] ) ;
}
if ( * V_181 == 0 )
* V_181 = 1 ;
return 0 ;
}
static void F_87 ( struct V_185 * V_186 )
{
struct V_187 * V_188 = F_88 ( V_186 , struct V_187 , V_186 ) ;
struct V_41 * V_42 = F_86 ( V_186 -> V_178 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
F_89 ( & V_42 -> V_189 , V_132 ) ;
F_90 ( & V_188 -> V_190 , & V_42 -> V_191 ) ;
F_91 ( & V_42 -> V_189 , V_132 ) ;
F_24 ( V_7 , L_28 ) ;
}
...
static void F_93 ( struct V_178 * V_179 )
{
struct V_41 * V_42 = F_86 ( V_179 ) ;
F_24 ( V_42 -> V_7 , L_18 , V_43 ) ;
F_45 ( & V_42 -> V_139 ) ;
}
static int F_94 ( struct V_178 * V_179 , unsigned int V_192 )
{
struct V_41 * V_42 = F_86 ( V_179 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
...
V_42 -> V_199 = NULL ;
if ( V_42 -> V_199 ) {
F_98 ( & V_42 -> V_199 -> V_186 , V_201 ) ;
V_42 -> V_199 = NULL ;
}
if ( V_42 -> V_200 ) {
F_98 ( & V_42 -> V_200 -> V_186 , V_201 ) ;
V_42 -> V_200 = NULL ;
}
F_91 ( & V_42 -> V_189 , V_132 ) ;
}
...
unsigned long V_132 ;
struct V_202 V_203 ;
struct V_187 * V_204 , * V_205 ;
F_24 ( V_7 , L_18 , V_43 ) ;
F_89 ( & V_42 -> V_189 , V_132 ) ;
V_42 -> V_194 = V_206 ;
F_100 (buf, buf_tmp, &layer->enq_list, list) {
F_101 ( & V_204 -> V_190 ) ;
F_98 ( & V_204 -> V_186 , V_201 ) ;
}
F_91 ( & V_42 -> V_189 , V_132 ) ;
F_102 ( & V_203 , F_97 ,
( unsigned long ) V_42 ) ;
...
static void F_116 ( struct V_158 * V_213 )
{
F_117 ( L_32 ) ;
}
...
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_42 -> V_234 ; ++ V_20 )
