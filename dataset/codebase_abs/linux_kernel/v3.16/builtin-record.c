...
if ( F_29 ( & V_2 -> V_5 -> V_15 , V_62 ) )
V_25 = F_1 ( V_2 , & V_63 , sizeof( V_63 ) ) ;
V_28:
return V_25 ;
}
...
static int F_35 ( struct V_1 * V_2 , int V_76 , const char * * V_77 )
{
int V_57 ;
int V_78 = 0 ;
