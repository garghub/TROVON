...
const char * F_19 ( struct V_1 * V_2 , const char * V_38 )
{
T_1 V_13 ;
while ( ( V_13 = * V_38 ) ) {
if ( V_13 == '\n' )
...
void F_34 ( const char * V_50 , T_3 V_51 )
{
while ( V_51 -- )
F_35 ( * V_50 ++ ) ;
F_28 () ;
}
void F_25 ( const char * V_52 , ... )
{
T_4 args ;
...
F_25 ( V_2 -> V_62 . V_66 , V_61 , V_61 ) ;
}
}
void F_39 ( int * V_67 , int * V_68 )
{
int V_69 = V_2 -> V_57 () ;
if ( V_69 ) {
V_59 = V_69 % 10 ;
...
int F_40 ( unsigned long V_70 , unsigned long V_29 )
{
...
V_74 . V_14 = V_77 ;
return F_41 ( V_72 , & V_74 ) ;
}
int F_42 ( unsigned long V_70 , unsigned long V_29 )
{
return F_43 ( & V_74 ) ;
}
int F_44 ( char * V_78 )
...
static int F_48 ( struct V_1 * V_84 )
{
struct V_16 * V_85 ;
F_46 () ;
if ( V_84 -> V_86 != V_87 )
