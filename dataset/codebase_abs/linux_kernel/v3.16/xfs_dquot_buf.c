...
ASSERT ( V_7 != - 1 ) ;
ASSERT ( V_8 & V_31 ) ;
memset ( V_10 , 0 , sizeof( V_3 ) ) ;
V_10 -> V_32 . V_12 = F_5 ( V_13 ) ;
V_10 -> V_32 . V_15 = V_16 ;
V_10 -> V_32 . V_17 = type ;
V_10 -> V_32 . V_21 = F_11 ( V_7 ) ;
if ( F_12 ( & V_5 -> V_33 ) ) {
F_13 ( & V_10 -> V_34 , & V_5 -> V_33 . V_35 ) ;
...
V_37 ) )
return false ;
if ( ! F_18 ( & V_10 -> V_34 , & V_5 -> V_33 . V_35 ) )
return false ;
}
return true ;
}
...
V_2 = F_1 ( V_39 -> V_44 ) ;
for ( V_41 = 0 ; V_41 < V_2 ; V_41 ++ ) {
struct V_45 * V_6 ;
int error ;
V_6 = & V_10 [ V_41 ] . V_32 ;
if ( V_41 == 0 )
V_7 = F_8 ( V_6 -> V_21 ) ;
error = F_4 ( V_5 , V_6 , V_7 + V_41 , 0 , V_14 ,
L_10 ) ;
if ( error )
return false ;
}
...
struct V_38 * V_39 )
{
struct V_4 * V_5 = V_39 -> V_46 -> V_47 ;
if ( ! F_15 ( V_5 , V_39 ) )
F_21 ( V_39 , V_48 ) ;
else if ( ! F_19 ( V_5 , V_39 ) )
F_21 ( V_39 , V_49 ) ;
if ( V_39 -> V_50 )
F_22 ( V_39 ) ;
}
