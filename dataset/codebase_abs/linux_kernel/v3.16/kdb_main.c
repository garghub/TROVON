...
static int F_50 ( T_5 V_121 , int error , struct V_114 * V_115 ,
T_6 V_122 )
{
char * V_123 ;
int V_21 ;
...
V_147:
#if F_53 ( V_128 )
snprintf ( V_148 , V_85 , F_6 ( L_54 ) ,
F_51 () ) ;
#else
snprintf ( V_148 , V_85 , F_6 ( L_54 ) ) ;
#endif
if ( V_62 )
strncat ( V_148 , L_55 , V_85 ) ;
V_123 = F_56 ( V_123 , V_85 , V_148 ) ;
if ( * V_123 != '\n' ) {
if ( * V_123 < 32 ) {
if ( V_110 == V_108 ) {
...
void F_57 ( const char * V_152 , int V_17 )
{
F_16 ( L_58 ,
V_152 , F_51 () , V_17 , V_153 ,
V_154 ) ;
}
int F_58 ( T_5 V_121 , T_5 V_155 , int error ,
T_6 V_122 , struct V_114 * V_115 )
{
int V_95 = 1 ;
while ( 1 ) {
F_52 ( L_59 , V_121 ) ;
...
if ( F_55 ( V_158 ) )
break;
V_95 = F_50 ( V_155 , error , V_115 , V_122 ) ;
F_52 ( L_61 , V_95 ) ;
if ( V_95 == V_149 )
break;
if ( V_95 == V_150 ) {
...
static void F_62 ( const char * V_163 , unsigned long V_41 ,
...
if ( V_169 )
F_16 ( L_67 V_171 L_68 , V_41 ) ;
else
F_16 ( V_171 L_68 , V_41 ) ;
for ( V_10 = 0 ; V_10 < V_167 && V_168 -- ; V_10 ++ ) {
if ( V_169 ) {
if ( F_63 ( & V_170 , V_41 , V_166 ) )
break;
} else if ( F_64 ( & V_170 , V_41 , V_166 ) )
break;
F_16 ( V_163 , V_170 ) ;
if ( V_164 )
F_20 ( V_170 , & V_47 ) ;
...
F_16 ( L_70 , ( int ) ( ( V_167 - V_10 ) * ( 2 * V_166 + 1 ) + 1 ) ,
L_68 , V_84 ) ;
}
...
switch ( V_166 ) {
case 8 :
sprintf ( V_163 , L_78 , V_185 ) ;
break;
case 4 :
sprintf ( V_163 , L_79 , V_185 ) ;
break;
case 2 :
...
if ( V_169 ) {
if ( F_63 ( & V_170 , V_189 , V_166 )
|| V_170 )
break;
} else if ( F_64 ( & V_170 , V_189 , V_166 ) || V_170 )
break;
}
V_190 = F_68 ( V_167 , V_168 ) ;
F_62 ( V_163 , V_41 , V_164 , V_165 , V_166 ,
V_167 , V_168 , V_169 ) ;
V_41 += V_166 * V_190 ;
V_168 -= V_190 ;
...
V_21 = F_70 ( V_41 , V_192 , V_193 ) ;
if ( V_21 )
return V_21 ;
F_16 ( V_130 L_85 V_130 L_30 , V_41 , V_192 ) ;
return 0 ;
}
...
if ( V_199 > 16 )
V_199 = 2 ;
if ( V_76 + strlen ( V_204 [ V_10 ] . V_40 ) + 4 + V_199 > 80 ) {
V_76 = 0 ;
F_16 ( L_30 ) ;
}
if ( V_76 )
...
case 8 :
V_198 = F_73 ( V_10 , & V_203 , V_36 ) ;
if ( ! V_198 )
break;
V_76 += F_16 ( L_95 , V_198 , V_203 ) ;
break;
case 16 :
V_198 = F_73 ( V_10 , & V_202 , V_36 ) ;
if ( ! V_198 )
break;
V_76 += F_16 ( L_96 , V_198 , V_202 ) ;
break;
case 32 :
V_198 = F_73 ( V_10 , & V_201 , V_36 ) ;
if ( ! V_198 )
break;
V_76 += F_16 ( L_97 , V_198 , V_201 ) ;
break;
case 64 :
V_198 = F_73 ( V_10 , & V_200 , V_36 ) ;
if ( ! V_198 )
break;
V_76 += F_16 ( L_98 , V_198 , V_200 ) ;
break;
default:
V_76 += F_16 ( L_99 , V_204 [ V_10 ] . V_40 ) ;
}
}
F_16 ( L_30 ) ;
#else
...
continue;
F_16 ( L_102 , V_207 -> V_40 ,
V_207 -> V_210 , ( void * ) V_207 ) ;
#ifdef F_81
F_16 ( L_103 , F_82 ( V_207 ) ) ;
#endif
if ( V_207 -> V_208 == V_211 )
F_16 ( L_104 ) ;
else if ( V_207 -> V_208 == V_212 )
F_16 ( L_105 ) ;
else
F_16 ( L_106 ) ;
F_16 ( L_107 , V_207 -> V_213 ) ;
#ifdef F_81
{
struct V_214 * V_215 ;
F_16 ( L_108 ) ;
...
if ( V_25 ) {
char * V_13 ;
V_219 = F_86 ( V_26 [ 1 ] , & V_13 , 0 ) ;
if ( * V_13 )
V_219 = 0 ;
if ( V_25 > 1 ) {
V_220 = F_10 ( V_26 [ 2 ] , & V_13 , 0 ) ;
if ( * V_13 || V_220 < 0 )
V_220 = 0 ;
}
}
V_21 = F_11 ( L_113 , & V_218 ) ;
if ( ! V_21 && V_218 ) {
const char * V_226 [] = { L_114 , L_113 , L_115 } ;
F_15 ( 2 , V_226 ) ;
}
F_87 ( & V_223 ) ;
while ( F_88 ( & V_223 , 1 , NULL , 0 , NULL ) )
V_190 ++ ;
if ( V_219 < 0 ) {
if ( V_220 >= V_190 )
F_16 ( L_116
L_117 , V_190 ) ;
else if ( V_220 - V_219 >= V_190 )
F_16 ( L_118
L_119 , V_190 , V_190 - V_220 ) ;
V_221 = V_220 ;
V_219 = abs ( V_219 ) ;
} else if ( V_219 > 0 ) {
V_221 = V_190 - V_219 - V_220 ;
V_219 = abs ( V_219 ) ;
if ( V_220 >= V_190 ) {
F_16 ( L_120
L_121 , V_190 ) ;
...
if ( V_221 >= V_190 || V_221 < 0 )
return 0 ;
F_87 ( & V_223 ) ;
while ( F_88 ( & V_223 , 1 , V_225 , sizeof( V_225 ) , & V_76 ) ) {
if ( V_221 ) {
V_221 -- ;
continue;
}
...
static int F_92 ( const char * V_20 , const struct V_230 * V_231 )
{
if ( ! F_93 ( & V_227 , - 1 , 0 ) )
return - V_232 ;
V_228 . V_229 ( 1 ) ;
...
{
int V_10 , V_233 , V_234 = 1 ;
char V_208 , V_235 = '?' ;
F_16 ( L_125 , F_51 () ) ;
F_16 ( L_126 ) ;
for ( V_233 = - 1 , V_10 = 0 ; V_10 < V_236 ; V_10 ++ ) {
if ( ! F_95 ( V_10 ) ) {
V_208 = 'F' ;
} else {
V_208 = ' ' ;
...
if ( V_25 != 1 )
return V_29 ;
V_21 = F_12 ( V_26 [ 1 ] , & V_237 ) ;
if ( V_21 )
return V_21 ;
if ( ( V_237 > V_236 ) || ! F_95 ( V_237 ) )
return V_194 ;
V_238 = V_237 ;
return V_149 ;
}
...
{
int V_239 = 0 , V_240 = 0 ;
unsigned long V_241 = F_99 ( L_131 ) ,
V_242 = F_99 ( L_132 ) ;
unsigned long V_2 ;
const struct V_1 * V_3 , * V_243 ;
F_100 (cpu) {
V_3 = F_1 ( V_2 ) ;
if ( F_101 ( V_3 , V_241 ) )
++ V_239 ;
...
int V_2 ;
unsigned long V_244 ;
if ( ! V_3 || F_105 ( & V_244 , ( char * ) V_3 , sizeof( unsigned long ) ) )
return;
V_2 = F_49 ( V_3 ) ;
F_16 ( L_139 ,
( void * ) V_3 , V_3 -> V_127 , V_3 -> V_245 -> V_127 ,
F_47 ( V_3 ) , F_49 ( V_3 ) ,
F_96 ( V_3 ) ,
( void * ) ( & V_3 -> V_246 ) ,
V_3 == F_1 ( F_51 () ) ? '*' : ' ' ,
...
unsigned long V_248 , V_2 ;
if ( V_25 == 0 )
F_98 () ;
F_16 ( L_143 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_144 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_145 ) ;
V_248 = F_99 ( V_25 ? V_26 [ 1 ] : NULL ) ;
F_100 (cpu) {
if ( F_32 ( V_92 ) )
return 0 ;
V_3 = F_1 ( V_2 ) ;
...
if ( V_21 )
return V_24 ;
V_3 = F_108 ( ( V_249 ) V_20 , & V_250 ) ;
if ( ! V_3 ) {
F_16 ( L_147 , ( V_249 ) V_20 ) ;
return 0 ;
}
}
F_46 ( V_3 ) ;
...
if ( ! V_251 -> V_96 )
continue;
if ( strlen ( V_251 -> V_253 ) > 20 )
V_252 = L_155 ;
F_16 ( L_156 , V_251 -> V_96 ,
V_251 -> V_253 , V_252 , V_251 -> V_254 ) ;
}
return 0 ;
}
...
if ( V_25 )
return V_29 ;
F_16 ( L_160 , V_284 . V_40 . V_285 ) ;
F_16 ( L_161 , V_284 . V_40 . V_286 ) ;
F_16 ( L_162 , V_284 . V_40 . V_287 ) ;
F_16 ( L_163 , V_284 . V_40 . V_288 ) ;
F_16 ( L_164 , V_284 . V_40 . V_289 ) ;
F_16 ( L_165 , V_284 . V_40 . V_290 ) ;
F_16 ( L_166 , F_118 ( V_291 ) ) ;
V_283 = F_119 () ;
F_113 ( & V_283 , & V_268 ) ;
F_16 ( L_167
L_168 ,
...
V_20 . V_278 %= ( 24 * 60 * 60 ) ;
F_16 ( L_170 , V_294 , V_294 == 1 ? L_1 : L_171 ) ;
}
F_16 ( L_172 , V_20 . V_278 / ( 60 * 60 ) , ( V_20 . V_278 / 60 ) % 60 ) ;
...
char V_163 [ 64 ] ;
int V_2 , V_21 , V_38 = 1 ;
unsigned long V_41 , V_298 , V_20 , V_166 = 0 , V_299 = ~ 0UL ;
if ( V_25 < 1 || V_25 > 3 )
return V_29 ;
...
return V_188 ;
sprintf ( V_163 , L_176 , ( int ) ( 2 * V_166 ) ) ;
if ( V_25 >= 3 ) {
...
V_21 = F_64 ( & V_20 , V_41 , V_166 ) ;
if ( V_21 ) {
F_16 ( L_178 V_300 L_179
L_180 , V_2 , V_41 , V_21 ) ;
continue;
}
F_16 ( L_178 , V_2 ) ;
...
T_4 * V_231 ;
F_35 (kp, i) {
if ( V_231 -> V_96 && ( strcmp ( V_231 -> V_96 , V_107 ) == 0 ) ) {
F_16 ( L_192
L_193 , V_107 , V_301 , V_67 ) ;
return 1 ;
}
}
F_35 (kp, i) {
...
if ( V_306 ) {
memcpy ( V_303 , V_306 ,
( V_98 - V_304 ) * sizeof( * V_303 ) ) ;
F_26 ( V_306 ) ;
}
memset ( V_303 + V_98 - V_304 , 0 ,
V_305 * sizeof( * V_303 ) ) ;
V_306 = V_303 ;
V_231 = V_306 + V_98 - V_304 ;
V_98 += V_305 ;
}
V_231 -> V_96 = V_107 ;
V_231 -> V_100 = V_301 ;
...
short V_302 )
{
return F_127 ( V_107 , V_301 , V_66 , V_67 , V_302 ,
V_103 ) ;
}
...
L_215 , 0 , V_103 ) ;
F_127 ( L_216 , V_308 , L_207 ,
L_217 , 1 , V_103 ) ;
F_127 ( L_218 , V_308 , L_219 ,
L_220 , 0 , V_103 ) ;
F_127 ( L_221 , V_308 , L_222 ,
L_223 , 0 , V_103 ) ;
F_127 ( L_224 , V_308 , L_1 ,
L_225 , 0 , V_103 ) ;
F_127 ( L_226 , V_308 , L_196 ,
L_227 , 0 ,
V_103 ) ;
