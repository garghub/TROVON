...
switch ( V_5 -> type ) {
case V_158 :
F_126 ( & V_4 -> V_419 , F_99 ) ;
break;
case V_284 :
F_126 ( & V_4 -> V_419 , F_112 ) ;
break;
default:
break;
}
F_126 ( & V_4 -> V_446 , F_117 ) ;
...
F_133 ( V_2 , 0 , 0 ) ;
V_63 = F_128 ( V_4 -> V_4 , V_520 ,
V_521 , L_103 ,
& V_4 -> V_137 ) ;
if ( V_63 == 0 )
V_4 -> V_137 . V_522 = true ;
F_134 ( V_48 , V_523 , F_4 ( V_523 ) ) ;
switch ( V_5 -> type ) {
case V_158 :
F_134 ( V_48 , V_524 ,
F_4 ( V_524 ) ) ;
...
F_136 ( V_4 -> V_4 , V_490 , V_4 ) ;
F_136 ( V_4 -> V_4 , V_489 , V_4 ) ;
F_136 ( V_4 -> V_4 , V_488 , V_4 ) ;
if ( V_4 -> V_473 )
F_137 ( V_4 -> V_473 , V_4 ) ;
for ( V_7 = 0 ; V_7 < F_4 ( V_4 -> V_255 ) ; V_7 ++ )
F_136 ( V_4 -> V_4 , V_493 + V_7 ,
& V_4 -> V_255 [ V_7 ] ) ;
F_136 ( V_4 -> V_4 , V_520 ,
& V_4 -> V_137 ) ;
F_136 ( V_4 -> V_4 , V_484 , V_2 ) ;
F_136 ( V_4 -> V_4 , V_486 , V_2 ) ;
F_136 ( V_4 -> V_4 , V_485 , V_2 ) ;
return V_63 ;
}
...
static struct V_420 * F_141 ( struct V_421 * V_28 )
{
struct V_4 * V_5 = F_124 ( V_28 -> V_472 ) ;
return V_5 -> V_420 ;
}
