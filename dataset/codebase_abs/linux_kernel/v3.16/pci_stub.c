...
static int F_58 ( struct V_2 * V_3 , const struct V_49 * V_50 )
{
int V_18 = 0 ;
F_2 ( & V_3 -> V_3 , L_17 ) ;
if ( F_43 ( V_3 ) ) {
...
static T_2 F_69 ( struct V_1 * V_4 ,
T_3 V_63 , int V_64 ,
T_2 V_65 )
{
T_2 V_66 = V_65 ;
...
F_72 ( V_73 , ( unsigned long * ) & V_4 -> V_29 -> V_25 ) ;
F_72 ( V_74 ,
( unsigned long * ) & V_4 -> V_29 -> V_70 -> V_25 ) ;
F_71 () ;
F_73 ( V_4 -> V_29 -> V_75 ) ;
V_69 = F_74 ( V_41 ,
! ( F_75 ( V_74 , ( unsigned long * )
...
F_76 ( V_73 , ( unsigned long * ) & V_4 -> V_29 -> V_25 ) ;
if ( F_75 ( V_77 ,
( unsigned long * ) & V_4 -> V_29 -> V_70 -> V_25 ) ) {
F_2 ( & V_4 -> V_3 -> V_3 ,
L_36 V_38 L_37 ) ;
...
static inline int F_82 ( const char * V_87 , int * V_22 , int * V_15 ,
int * V_23 , int * V_24 )
{
int V_88 = 0 ;
switch ( sscanf ( V_87 , L_50 , V_22 , V_15 , V_23 , V_24 ,
& V_88 ) ) {
case 3 :
* V_24 = - 1 ;
sscanf ( V_87 , L_51 , V_22 , V_15 , V_23 , & V_88 ) ;
break;
case 2 :
* V_23 = * V_24 = - 1 ;
sscanf ( V_87 , L_52 , V_22 , V_15 , & V_88 ) ;
break;
}
if ( V_88 && ! V_87 [ V_88 ] )
return 0 ;
* V_22 = 0 ;
switch ( sscanf ( V_87 , L_53 , V_15 , V_23 , V_24 , & V_88 ) ) {
case 2 :
* V_24 = - 1 ;
sscanf ( V_87 , L_54 , V_15 , V_23 , & V_88 ) ;
break;
case 1 :
* V_23 = * V_24 = - 1 ;
sscanf ( V_87 , L_55 , V_15 , & V_88 ) ;
break;
}
if ( V_88 && ! V_87 [ V_88 ] )
return 0 ;
...
static inline int F_83 ( const char * V_87 , int * V_22 , int * V_15 , int
* V_23 , int * V_24 , int * V_90 , int * V_91 , int * V_92 )
{
int V_88 = 0 ;
sscanf ( V_87 , L_56 , V_22 , V_15 , V_23 , V_24 ,
V_90 , V_91 , V_92 , & V_88 ) ;
if ( V_88 && ! V_87 [ V_88 ] )
return 0 ;
* V_22 = 0 ;
sscanf ( V_87 , L_57 , V_15 , V_23 , V_24 , V_90 , V_91 ,
V_92 , & V_88 ) ;
if ( V_88 && ! V_87 [ V_88 ] )
return 0 ;
return - V_89 ;
}
static int F_84 ( int V_22 , int V_15 , int V_23 , int V_24 )
{
struct V_33 * V_93 ;
unsigned long V_25 ;
int V_94 = 0 , V_17 = F_85 ( V_23 , V_24 ) ;
if ( V_23 < 0 ) {
for ( V_23 = 0 ; ! V_94 && V_23 < 32 ; ++ V_23 )
V_94 = F_84 ( V_22 , V_15 , V_23 , V_24 ) ;
return V_94 ;
}
if ( V_24 < 0 ) {
...
int V_18 ;
V_18 = F_82 ( V_87 , & V_22 , & V_15 , & V_23 , & V_24 ) ;
if ( V_18 )
goto V_27;
V_18 = F_84 ( V_22 , V_15 , V_23 , V_24 ) ;
V_27:
if ( ! V_18 )
V_18 = V_113 ;
return V_18 ;
...
int V_18 ;
V_18 = F_83 ( V_87 , & V_22 , & V_15 , & V_23 , & V_24 , & V_90 , & V_91 ,
& V_92 ) ;
if ( V_18 )
goto V_27;
...
continue;
V_113 +=
F_96 ( V_87 + V_113 , V_114 - V_113 , L_72 ,
F_45 ( V_4 -> V_3 ) ) ;
}
F_32 ( & V_26 , V_25 ) ;
return V_113 ;
