...
F_7 ( V_219 -> V_2 , L_18 , V_248 , V_249 ) ;
F_3 ( V_108 ) ;
return 0 ;
}
...
V_284 . V_292
<< V_321 ) ;
F_7 ( V_108 -> V_2 , L_29 , V_285 , V_286 ) ;
V_110 -> V_305 = V_285 ;
V_110 -> V_121 = V_286 ;
V_110 -> V_304 = V_302 ;
F_6 ( V_108 , V_65 ,
...
F_7 ( V_108 -> V_2 , L_32 ,
V_110 -> V_147 ) ;
V_110 -> V_342 . V_346 = V_110 -> V_147 ;
V_110 -> V_342 . V_347 = V_110 -> V_153 ;
...
if ( V_127 -> V_141 ) {
struct V_340 V_341 =
F_56 ( L_35 , V_110 -> V_349 ,
F_12 , F_10 ) ;
V_110 -> V_350 = F_59 ( sizeof( char * )
* V_127 -> V_141 , V_345 ) ;
if ( ! V_110 -> V_350 ) {
F_8 ( V_108 -> V_2 ,
L_36 ,
...
V_110 -> V_350 [ V_129 ] = V_127 -> V_131 [ V_129 ] . V_152 ;
V_110 -> V_349 . V_346 = V_127 -> V_141 ;
V_110 -> V_349 . V_347 = V_110 -> V_350 ;
V_162 = F_34 ( V_108 , & V_341 , 1 ) ;
if ( V_162 != 0 )
F_8 ( V_108 -> V_2 ,
L_37 , V_162 ) ;
...
static int F_63 ( struct V_353 * V_354 ,
const struct V_355 * V_356 )
{
struct V_109 * V_110 ;
unsigned int V_157 ;
int V_162 , V_129 ;
V_110 = F_64 ( & V_354 -> V_2 , sizeof( struct V_109 ) ,
V_345 ) ;
if ( V_110 == NULL )
return - V_357 ;
V_110 -> V_337 = F_65 ( V_354 , & V_358 ) ;
if ( F_66 ( V_110 -> V_337 ) ) {
V_162 = F_67 ( V_110 -> V_337 ) ;
F_8 ( & V_354 -> V_2 , L_40 ,
V_162 ) ;
return V_162 ;
}
V_110 -> V_201 = V_356 -> V_359 ;
F_68 ( V_354 , V_110 ) ;
V_110 -> V_127 = V_354 -> V_2 . V_360 ;
for ( V_129 = 0 ; V_129 < F_17 ( V_110 -> V_336 ) ; V_129 ++ )
V_110 -> V_336 [ V_129 ] . V_361 = V_362 [ V_129 ] ;
V_162 = F_69 ( & V_354 -> V_2 , F_17 ( V_110 -> V_336 ) ,
V_110 -> V_336 ) ;
if ( V_162 != 0 ) {
F_8 ( & V_354 -> V_2 , L_41 , V_162 ) ;
return V_162 ;
}
V_162 = F_50 ( F_17 ( V_110 -> V_336 ) ,
V_110 -> V_336 ) ;
if ( V_162 != 0 ) {
F_8 ( & V_354 -> V_2 , L_30 , V_162 ) ;
return V_162 ;
}
V_162 = F_70 ( V_110 -> V_337 , V_4 , & V_157 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_354 -> V_2 , L_42 , V_162 ) ;
goto V_363;
}
if ( V_157 != 0x8904 ) {
F_8 ( & V_354 -> V_2 , L_43 , V_157 ) ;
V_162 = - V_122 ;
goto V_363;
}
V_162 = F_70 ( V_110 -> V_337 , V_5 , & V_157 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_354 -> V_2 , L_44 ,
V_162 ) ;
goto V_363;
}
F_71 ( & V_354 -> V_2 , L_45 , V_157 + 'A' ) ;
V_162 = F_72 ( V_110 -> V_337 , V_4 , 0 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_354 -> V_2 , L_46 , V_162 ) ;
goto V_363;
}
F_73 ( V_110 -> V_337 , V_35 ,
V_364 , V_364 ) ;
F_73 ( V_110 -> V_337 , V_36 ,
V_364 , V_364 ) ;
F_73 ( V_110 -> V_337 , V_31 ,
V_365 , V_365 ) ;
F_73 ( V_110 -> V_337 , V_32 ,
V_365 , V_365 ) ;
F_73 ( V_110 -> V_337 , V_47 ,
V_366 | V_367 ,
V_366 | V_367 ) ;
F_73 ( V_110 -> V_337 , V_48 ,
V_366 | V_368 ,
V_366 | V_368 ) ;
F_73 ( V_110 -> V_337 , V_49 ,
V_369 | V_370 ,
V_369 | V_370 ) ;
F_73 ( V_110 -> V_337 , V_50 ,
V_369 | V_371 ,
V_369 | V_371 ) ;
F_73 ( V_110 -> V_337 , V_24 ,
V_372 , 0 ) ;
if ( V_110 -> V_127 ) {
for ( V_129 = 0 ; V_129 < V_373 ; V_129 ++ ) {
if ( ! V_110 -> V_127 -> V_374 [ V_129 ] )
continue;
F_73 ( V_110 -> V_337 ,
V_70 + V_129 ,
0xffff ,
V_110 -> V_127 -> V_374 [ V_129 ] ) ;
}
...
F_73 ( V_110 -> V_337 , V_59 ,
V_377 , V_377 ) ;
F_73 ( V_110 -> V_337 , V_13 ,
V_378 , 0 ) ;
F_51 ( V_110 -> V_337 , true ) ;
F_54 ( F_17 ( V_110 -> V_336 ) , V_110 -> V_336 ) ;
V_162 = F_74 ( & V_354 -> V_2 ,
& V_379 , & V_351 , 1 ) ;
if ( V_162 != 0 )
return V_162 ;
return 0 ;
...
static int F_75 ( struct V_353 * V_380 )
{
F_76 ( & V_380 -> V_2 ) ;
return 0 ;
}
