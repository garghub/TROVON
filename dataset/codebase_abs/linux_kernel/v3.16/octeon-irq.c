...
V_8 . V_11 = F_14 ( V_18 ) ;
V_21 = 1ull << ( V_8 . V_10 . V_2 ) ;
V_134 = F_128 ( V_16 ) + ( 0x1000ull * V_8 . V_10 . line ) ;
F_39 ( V_134 , V_21 ) ;
}
...
V_8 . V_11 = F_14 ( V_18 ) ;
V_21 = 1ull << ( V_8 . V_10 . V_2 ) ;
V_134 = F_132 ( V_16 ) + ( 0x1000ull * V_8 . V_10 . line ) ;
F_39 ( V_134 , V_21 ) ;
}
...
V_21 = 1ull << ( V_8 . V_10 . V_2 ) ;
F_48 (cpu) {
T_4 V_134 = F_132 ( F_6 ( V_15 ) ) + ( 0x1000ull * V_8 . V_10 . line ) ;
F_39 ( V_134 , V_21 ) ;
}
}
...
if ( F_32 ( V_15 , V_60 ) && V_62 ) {
V_62 = false ;
V_134 = F_128 ( F_6 ( V_15 ) ) + ( 0x1000ull * V_8 . V_10 . line ) ;
} else {
V_134 = F_132 ( F_6 ( V_15 ) ) + ( 0x1000ull * V_8 . V_10 . line ) ;
}
F_39 ( V_134 , V_21 ) ;
}
return 0 ;
...
const unsigned long V_89 = F_9 () ;
V_139 = F_99 ( F_114 ( V_89 ) ) & 0xfful ;
if ( F_150 ( ! V_139 ) )
goto V_140;
line = F_101 ( V_139 ) - 1 ;
V_137 = F_151 ( V_89 ) + ( 0x1000 * line ) ;
V_138 = F_99 ( V_137 ) ;
if ( F_150 ( ! V_138 ) )
goto V_140;
V_2 = F_101 ( V_138 ) - 1 ;
...
if ( F_150 ( V_151 & V_99 ) )
V_106 () ;
else if ( F_150 ( V_151 & V_98 ) )
V_107 () ;
else if ( F_150 ( V_151 & V_91 ) )
V_93 () ;
else if ( F_100 ( V_151 ) )
F_102 ( F_161 ( V_151 ) - 9 + V_154 ) ;
else
break;
}
}
