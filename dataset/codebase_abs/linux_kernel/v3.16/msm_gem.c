...
int F_51 ( struct V_74 * V_44 , struct V_24 * V_7 ,
struct V_75 * args )
{
args -> V_76 = F_52 ( args -> V_77 , args -> V_78 ) ;
args -> V_25 = F_53 ( args -> V_76 * args -> V_79 ) ;
return F_54 ( V_7 , V_44 , args -> V_25 ,
V_80 | V_29 , & args -> V_81 ) ;
}
int F_55 ( struct V_74 * V_44 , struct V_24 * V_7 ,
T_4 V_81 , T_3 * V_62 )
{
struct V_1 * V_2 ;
int V_17 = 0 ;
V_2 = F_56 ( V_7 , V_44 , V_81 ) ;
if ( V_2 == NULL ) {
V_17 = - V_82 ;
goto V_83;
}
...
if ( F_12 ( V_23 ) )
return F_16 ( V_23 ) ;
V_4 -> V_84 = F_59 ( V_23 , V_2 -> V_25 >> V_11 ,
V_85 , F_29 ( V_86 ) ) ;
}
return V_4 -> V_84 ;
}
...
int V_17 = 0 ;
F_25 ( & V_7 -> V_34 ) ;
if ( ! F_62 ( & V_88 -> V_89 . V_90 ) ) {
V_17 = - V_69 ;
} else if ( F_63 ( V_4 ) ) {
V_88 -> V_91 = F_64 ( V_4 -> V_92 , V_4 -> V_93 ) ;
F_65 ( & V_88 -> V_89 . V_90 , & V_6 -> V_94 ) ;
} else {
F_66 ( V_6 -> V_95 , & V_88 -> V_89 ) ;
}
F_26 ( & V_7 -> V_34 ) ;
return V_17 ;
}
...
T_4 V_62 = ( T_4 ) F_42 ( V_2 ) ;
V_67 -> V_70 -> V_118 ( V_67 , V_62 , V_4 -> V_27 , V_2 -> V_25 ) ;
}
}
F_81 ( V_2 ) ;
if ( V_2 -> V_119 ) {
if ( V_4 -> V_84 )
F_82 ( V_2 -> V_119 -> V_120 , V_4 -> V_84 ) ;
if ( V_4 -> V_23 )
F_7 ( V_4 -> V_23 ) ;
} else {
if ( V_4 -> V_84 )
...
int F_54 ( struct V_24 * V_7 , struct V_74 * V_44 ,
