...
if ( V_20 )
goto V_46;
V_20 = F_29 ( V_10 , F_30 ( V_10 -> V_24 , 0 ) ) ;
if ( V_20 )
goto V_46;
V_10 -> V_48 = 1 ;
V_20 = F_31 ( V_10 ) ;
...
void F_40 ( struct V_50 * V_18 ,
struct V_51 * V_52 )
{
unsigned long V_12 ;
F_10 ( & V_18 -> V_53 , V_12 ) ;
if ( F_41 ( & V_52 -> V_54 ) ) {
F_42 ( & V_52 -> V_54 , & V_18 -> V_55 ) ;
F_43 ( V_18 -> V_56 . V_10 , V_18 -> V_57 ) ;
}
F_11 ( & V_18 -> V_53 , V_12 ) ;
}
void F_44 ( struct V_50 * V_18 ,
struct V_51 * V_52 )
{
if ( ! F_41 ( & V_52 -> V_54 ) ) {
F_45 ( & V_52 -> V_54 ) ;
F_46 ( V_18 -> V_56 . V_10 , V_18 -> V_57 ) ;
}
}
void F_47 ( struct V_50 * V_18 ,
struct V_51 * V_52 )
{
unsigned long V_12 ;
F_10 ( & V_18 -> V_53 , V_12 ) ;
...
static int F_48 ( struct V_9 * V_10 , int V_56 )
{
struct V_3 * V_4 = V_10 -> V_11 ;
F_49 ( V_4 -> V_18 [ V_56 ] , V_58 ) ;
return 0 ;
}
static void F_50 ( struct V_9 * V_10 , int V_56 )
{
struct V_3 * V_4 = V_10 -> V_11 ;
F_51 ( V_4 -> V_18 [ V_56 ] , V_58 ) ;
}
static T_1 F_52 ( int V_59 , void * V_60 )
{
struct V_9 * V_10 = V_60 ;
struct V_3 * V_4 = V_10 -> V_11 ;
struct V_50 * V_18 = V_4 -> V_18 [ 0 ] ;
T_2 V_61 , V_62 = F_53 ( V_18 -> V_63 + V_64 ) ;
T_1 V_65 = V_66 ;
F_54 ( 0 , V_18 -> V_63 + V_64 ) ;
V_61 = V_62 & V_18 -> V_67 ;
...
struct V_50 * V_18 = V_4 -> V_18 [ 0 ] ;
F_57 ( & V_10 -> V_72 ) ;
F_54 ( V_18 -> V_67 , V_18 -> V_63 + V_73 ) ;
F_58 ( 0 , V_18 -> V_63 + V_64 ) ;
F_59 ( & V_10 -> V_72 ) ;
return 0 ;
}
