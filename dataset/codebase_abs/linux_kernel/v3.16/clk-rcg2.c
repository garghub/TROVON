...
static int F_22 ( struct V_3 * V_4 , const struct V_40 * V_41 )
{
T_1 V_14 , V_32 ;
int V_6 ;
...
unsigned long V_25 , unsigned long V_31 , T_2 V_24 )
{
return F_26 ( V_2 , V_25 , V_31 ) ;
}
static long F_29 ( struct V_1 * V_2 , unsigned long V_25 ,
unsigned long * V_43 , struct V_13 * * V_44 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
V_29 >>= V_39 ;
V_29 &= V_32 ;
return F_12 ( V_54 , V_52 -> V_58 , V_52 -> V_59 , ! ! V_52 -> V_59 ,
V_29 ) ;
}
return - V_20 ;
}
...
return - V_20 ;
* V_44 = F_19 ( V_2 -> V_13 , V_41 -> V_46 ) ;
* V_43 = V_31 = F_31 ( * V_44 , V_25 ) ;
div = F_32 ( ( 2 * V_31 ) , V_25 ) - 1 ;
div = F_33 ( T_1 , div , V_32 ) ;
...
unsigned long V_25 , unsigned long V_31 , T_2 V_24 )
{
return F_34 ( V_2 , V_25 , V_31 ) ;
}
static long F_36 ( struct V_1 * V_2 , unsigned long V_25 ,
unsigned long * V_43 , struct V_13 * * V_44 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
int V_53 = 100000 ;
const struct V_40 * V_41 = V_4 -> V_40 ;
const struct V_51 * V_52 = V_60 ;
struct V_13 * V_61 = * V_44 = F_19 ( V_2 -> V_13 , V_41 -> V_46 ) ;
for (; V_52 -> V_58 ; V_52 ++ ) {
V_55 = ( V_25 * V_52 -> V_59 ) / V_52 -> V_58 ;
V_54 = F_31 ( V_61 , V_55 ) ;
if ( ( V_54 < ( V_55 - V_53 ) ) ||
( V_54 > ( V_55 + V_53 ) ) )
continue;
* V_43 = V_54 ;
return ( V_54 * V_52 -> V_58 ) / V_52 -> V_59 ;
}
return - V_20 ;
}
static int F_37 ( struct V_1 * V_2 , unsigned long V_25 ,
unsigned long V_31 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_40 V_41 = * V_4 -> V_40 ;
...
T_1 V_32 = F_15 ( V_4 -> V_38 ) - 1 ;
T_1 V_29 ;
struct V_13 * V_61 = F_19 ( V_2 -> V_13 , V_41 . V_46 ) ;
for (; V_52 -> V_58 ; V_52 ++ ) {
V_55 = ( V_25 * V_52 -> V_59 ) / V_52 -> V_58 ;
V_54 = F_31 ( V_61 , V_55 ) ;
if ( ( V_54 < ( V_55 - V_53 ) ) ||
