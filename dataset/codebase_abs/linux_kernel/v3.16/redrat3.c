...
static int F_69 ( struct V_152 * V_153 ,
const struct V_154 * V_155 )
{
struct V_44 * V_45 = F_70 ( V_153 ) ;
struct V_28 * V_6 = & V_153 -> V_6 ;
struct V_156 * V_157 ;
struct V_1 * V_2 ;
struct V_158 * V_159 ;
struct V_158 * V_57 = NULL ;
struct V_158 * V_120 = NULL ;
T_3 V_160 , V_161 ;
int V_64 , V_29 ;
int V_162 = - V_47 ;
V_157 = V_153 -> V_163 ;
for ( V_29 = 0 ; V_29 < V_157 -> V_164 . V_165 ; ++ V_29 ) {
V_159 = & V_157 -> V_166 [ V_29 ] . V_164 ;
V_160 = V_159 -> V_121 ;
V_161 = V_159 -> V_167 ;
if ( ( V_57 == NULL ) &&
( ( V_160 & V_168 ) == V_50 ) &&
...
V_64 = F_73 ( V_45 , V_57 -> V_121 ) ;
F_74 ( V_2 -> V_4 , V_45 , V_64 , V_2 -> V_59 ,
...
V_2 -> V_127 . V_173 = L_66 ;
V_2 -> V_127 . V_174 = F_56 ;
V_162 = F_75 ( & V_153 -> V_6 , & V_2 -> V_127 ) ;
if ( V_162 )
goto error;
F_59 ( & V_2 -> V_129 , 0 ) ;
V_2 -> V_56 = F_71 ( 0 , V_46 ) ;
if ( ! V_2 -> V_56 ) {
V_162 = - V_47 ;
goto V_175;
}
V_2 -> V_176 . V_177 = 0xc0 ;
V_2 -> V_176 . V_178 = V_179 ;
V_2 -> V_176 . V_180 = F_76 ( 1 ) ;
F_77 ( V_2 -> V_56 , V_45 , F_25 ( V_45 , 0 ) ,
( unsigned char * ) & V_2 -> V_176 ,
& V_2 -> V_181 , sizeof( V_2 -> V_181 ) ,
F_60 , V_2 ) ;
V_2 -> V_26 = F_62 ( V_2 ) ;
if ( ! V_2 -> V_26 ) {
V_162 = - V_47 ;
...
F_78 ( & V_2 -> V_37 , F_11 , ( unsigned long ) V_2 ) ;
F_79 ( V_153 , V_2 ) ;
return 0 ;
V_175:
F_80 ( & V_2 -> V_127 ) ;
...
F_29 ( V_2 , V_2 -> V_45 ) ;
V_172:
F_26 ( V_6 , L_67 , V_7 , V_162 ) ;
return V_162 ;
}
static void F_81 ( struct V_152 * V_153 )
{
struct V_44 * V_45 = F_70 ( V_153 ) ;
struct V_1 * V_2 = F_82 ( V_153 ) ;
if ( ! V_2 )
return;
F_79 ( V_153 , NULL ) ;
F_83 ( V_2 -> V_26 ) ;
...
static int F_85 ( struct V_152 * V_153 , T_5 V_182 )
{
struct V_1 * V_2 = F_82 ( V_153 ) ;
F_86 ( & V_2 -> V_127 ) ;
F_30 ( V_2 -> V_4 ) ;
...
static int F_87 ( struct V_152 * V_153 )
{
struct V_1 * V_2 = F_82 ( V_153 ) ;
if ( F_2 ( V_2 -> V_4 , V_5 ) )
return - V_52 ;
