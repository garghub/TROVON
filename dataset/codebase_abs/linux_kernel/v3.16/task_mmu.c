...
for ( V_96 = V_70 ; V_96 < V_71 ; V_96 += V_26 ) {
...
static void F_112 ( T_12 * V_171 , struct V_172 * V_173 ,
...
if ( V_38 -> V_67 & V_141 )
V_179 |= V_181 ;
* V_171 = F_108 ( F_111 ( V_173 -> V_177 ) | F_118 ( V_173 -> V_177 , V_179 ) ) ;
return;
}
if ( V_102 && ! F_63 ( V_102 ) )
V_66 |= V_185 ;
if ( ( V_38 -> V_67 & V_141 ) )
V_179 |= V_181 ;
* V_171 = F_108 ( F_119 ( V_178 ) | F_118 ( V_173 -> V_177 , V_179 ) | V_66 ) ;
}
static void F_120 ( T_12 * V_171 , struct V_172 * V_173 ,
T_7 V_115 , int V_186 , int V_187 )
{
if ( F_121 ( V_115 ) )
* V_171 = F_108 ( F_119 ( F_122 ( V_115 ) + V_186 )
| F_118 ( V_173 -> V_177 , V_187 ) | V_180 ) ;
else
* V_171 = F_108 ( F_111 ( V_173 -> V_177 ) | F_118 ( V_173 -> V_177 , V_187 ) ) ;
}
static inline void F_120 ( T_12 * V_171 , struct V_172 * V_173 ,
T_7 V_115 , int V_186 , int V_187 )
{
}
static int F_123 ( T_7 * V_115 , unsigned long V_96 , unsigned long V_71 ,
struct V_98 * V_99 )
{
struct V_37 * V_38 ;
struct V_172 * V_173 = V_99 -> V_43 ;
...
int V_187 ;
if ( ( V_38 -> V_67 & V_141 ) || F_124 ( * V_115 ) )
V_187 = V_181 ;
else
V_187 = 0 ;
...
V_186 = ( V_96 & ~ V_188 ) >>
V_19 ;
F_120 ( & V_171 , V_173 , * V_115 , V_186 , V_187 ) ;
V_176 = F_109 ( V_96 , & V_171 , V_173 ) ;
if ( V_176 )
break;
}
...
! F_80 ( V_38 ) ) {
V_116 = F_125 ( V_115 , V_96 ) ;
F_112 ( & V_171 , V_173 , V_38 , V_96 , * V_116 ) ;
F_126 ( V_116 ) ;
}
V_176 = F_109 ( V_96 , & V_171 , V_173 ) ;
if ( V_176 )
...
static void F_127 ( T_12 * V_171 , struct V_172 * V_173 ,
V_24 V_116 , int V_186 , int V_179 )
{
if ( F_54 ( V_116 ) )
* V_171 = F_108 ( F_119 ( F_113 ( V_116 ) + V_186 ) |
F_118 ( V_173 -> V_177 , V_179 ) |
V_180 ) ;
else
* V_171 = F_108 ( F_111 ( V_173 -> V_177 ) |
F_118 ( V_173 -> V_177 , V_179 ) ) ;
}
static int F_128 ( V_24 * V_116 , unsigned long V_189 ,
...
F_127 ( & V_171 , V_173 , * V_116 , V_186 , V_179 ) ;
V_176 = F_109 ( V_96 , & V_171 , V_173 ) ;
if ( V_176 )
return V_176 ;
}
...
static T_10 F_130 ( struct V_57 * V_57 , char T_11 * V_155 ,
T_9 V_91 , T_1 * V_156 )
{
...
goto V_52;
V_60 = - V_165 ;
if ( ( * V_156 % V_196 ) || ( V_91 % V_196 ) )
goto V_197;
V_60 = 0 ;
if ( ! V_91 )
goto V_197;
V_173 . V_177 = V_166 ;
V_173 . V_174 = ( V_198 >> V_19 ) ;
V_173 . V_157 = F_131 ( V_173 . V_174 * V_196 , V_199 ) ;
V_60 = - V_61 ;
if ( ! V_173 . V_157 )
goto V_197;
V_4 = F_21 ( V_34 , V_50 ) ;
...
unsigned long V_71 ;
V_173 . V_42 = 0 ;
V_71 = ( V_193 + V_198 ) & V_188 ;
if ( V_71 < V_193 || V_71 > V_194 )
V_71 = V_194 ;
F_23 ( & V_4 -> V_41 ) ;
V_60 = F_81 ( V_193 , V_71 , & V_190 ) ;
F_16 ( & V_4 -> V_41 ) ;
V_193 = V_71 ;
V_174 = F_135 ( V_91 , V_196 * V_173 . V_42 ) ;
...
static void F_138 ( struct V_102 * V_102 , struct V_204 * V_205 , int F_67 ,
unsigned long V_206 )
{
int V_91 = F_66 ( V_102 ) ;
V_205 -> V_207 += V_206 ;
...
V_24 * V_116 ;
V_205 = V_99 -> V_43 ;
if ( F_70 ( V_115 , V_205 -> V_38 , & V_117 ) == 1 ) {
V_24 V_219 = * ( V_24 * ) V_115 ;
struct V_102 * V_102 ;
V_102 = F_144 ( V_219 , V_205 -> V_38 , V_96 ) ;
if ( V_102 )
F_138 ( V_102 , V_205 , F_67 ( V_219 ) ,
V_118 / V_26 ) ;
F_71 ( V_117 ) ;
return 0 ;
}
if ( F_72 ( V_115 ) )
return 0 ;
V_218 = V_116 = F_73 ( V_99 -> V_4 , V_115 , V_96 , & V_117 ) ;
do {
struct V_102 * V_102 = F_144 ( * V_116 , V_205 -> V_38 , V_96 ) ;
if ( ! V_102 )
continue;
F_138 ( V_102 , V_205 , F_67 ( * V_116 ) , 1 ) ;
} while ( V_116 ++ , V_96 += V_26 , V_96 != V_71 );
F_74 ( V_218 , V_117 ) ;
return 0 ;
}
static int F_148 ( V_24 * V_116 , unsigned long V_189 ,
...
{
struct V_220 * V_221 = V_2 -> V_43 ;
struct V_31 * V_222 = & V_221 -> V_223 ;
struct V_37 * V_38 = V_55 ;
struct V_204 * V_205 = & V_221 -> V_205 ;
struct V_57 * V_57 = V_38 -> V_65 ;
struct V_33 * V_34 = V_222 -> V_34 ;
struct V_3 * V_4 = V_38 -> V_40 ;
struct V_98 V_99 = {} ;
struct V_36 * V_224 ;
char V_157 [ 64 ] ;
...
V_99 . V_43 = V_205 ;
V_99 . V_4 = V_4 ;
V_224 = F_151 ( V_34 , V_38 , V_38 -> V_78 ) ;
F_152 ( V_157 , sizeof( V_157 ) , V_224 ) ;
F_153 ( V_224 ) ;
...
goto V_52;
if ( V_205 -> V_212 )
F_5 ( V_2 , L_78 , V_205 -> V_212 ) ;
if ( V_205 -> V_208 )
F_5 ( V_2 , L_79 , V_205 -> V_208 ) ;
if ( V_205 -> V_207 != V_205 -> V_212 && V_205 -> V_207 != V_205 -> V_208 )
F_5 ( V_2 , L_80 , V_205 -> V_207 ) ;
if ( V_205 -> V_213 > 1 )
F_5 ( V_2 , L_81 , V_205 -> V_213 ) ;
if ( V_205 -> V_209 )
F_5 ( V_2 , L_82 , V_205 -> V_209 ) ;
if ( V_205 -> V_210 < V_205 -> V_207 && ! F_80 ( V_38 ) )
F_5 ( V_2 , L_83 , V_205 -> V_210 ) ;
if ( V_205 -> V_211 )
F_5 ( V_2 , L_84 , V_205 -> V_211 ) ;
F_154 (nid, N_MEMORY)
if ( V_205 -> V_214 [ V_215 ] )
F_5 ( V_2 , L_85 , V_215 , V_205 -> V_214 [ V_215 ] ) ;
V_52:
F_46 ( V_2 , '\n' ) ;
if ( V_2 -> V_91 < V_2 -> V_92 )
V_2 -> V_45 = ( V_38 != V_222 -> V_39 ) ? V_38 -> V_78 : 0 ;
return 0 ;
}
