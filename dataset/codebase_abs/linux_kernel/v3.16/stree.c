...
static void F_151 ( struct V_38 * V_118 ,
const struct V_11 * V_28 )
{
struct V_5 * V_228 = F_72 ( V_118 ) ;
if ( F_85 ( V_228 ) ) {
if ( F_68 ( V_228 ) +
F_69 ( V_228 ,
F_80 ( V_118 ) -> V_71 ) !=
...
F_80 ( V_118 ) -> V_71 ) !=
F_10 ( V_28 )
|| F_86 ( V_228 ) != F_67 ( V_118 )
|| F_152 ( V_228 ) != 0 )
F_59 ( NULL , L_103 , L_104
L_105
L_106 ,
V_228 , F_67 ( V_118 ) , V_28 ) ;
}
}
int F_153 ( struct V_129 * V_130 ,
struct V_38 * V_53 ,
const struct V_11 * V_28 ,
struct V_120 * V_120 ,
const char * V_229 ,
...
#endif
V_74 = F_46 ( V_41 ) ;
V_16 = F_154 ( V_120 , V_230 ) ;
F_54 ( V_41 , V_74 ) ;
if ( V_16 ) {
F_32 ( V_53 ) ;
return V_16 ;
}
F_97 ( V_130 , & V_231 , V_130 -> V_171 , V_53 ,
V_230 ) ;
#ifdef F_155
V_231 . V_28 = V_28 -> V_14 ;
#endif
if ( F_56 ( V_83 , V_120 -> V_133 ) ) {
goto V_232;
}
while ( ( V_16 =
F_106 ( V_206 , & V_231 , NULL ,
V_229 ) ) == V_161 ) {
V_232:
F_50 ( V_130 -> V_171 , V_233 ) ;
V_16 =
...
if ( V_16 == V_163 ) {
F_111 ( & V_231 , NULL , V_229 , V_206 ) ;
return 0 ;
}
V_16 = ( V_16 == V_205 ) ? - V_236 : - V_203 ;
V_234:
F_107 ( & V_231 ) ;
#ifdef F_112
F_113 ( V_120 -> V_133 , V_169 ,
...
V_238 = V_120 -> V_133 -> V_112 + V_115 ;
#ifdef F_112
F_113 ( V_120 -> V_133 , V_169 ,
L_111 ,
V_238 , V_120 -> V_170 , F_104 ( V_58 ) ) ;
#endif
V_74 = F_46 ( V_120 -> V_133 ) ;
V_16 = F_154 ( V_120 , V_238 ) ;
F_54 ( V_120 -> V_133 , V_74 ) ;
if ( V_16 ) {
F_32 ( V_118 ) ;
return V_16 ;
...
F_97 ( V_130 , & V_237 , V_130 -> V_171 , V_118 ,
V_8 + F_40 ( V_58 ) ) ;
#ifdef F_155
V_237 . V_28 = V_28 -> V_14 ;
#endif
if ( V_120 && F_56 ( V_83 , V_120 -> V_133 ) ) {
goto V_232;
}
while ( ( V_16 =
F_106 ( V_207 , & V_237 , V_58 ,
V_229 ) ) == V_161 ) {
V_232:
F_50 ( V_130 -> V_171 , V_239 ) ;
