...
V_39 = 1 ;
if ( fflush ( stdout ) ) {
fprintf ( V_15 , L_28 , strerror ( V_30 ) ) ;
goto V_49;
}
if ( ferror ( stdout ) ) {
fprintf ( V_15 , L_29 ) ;
