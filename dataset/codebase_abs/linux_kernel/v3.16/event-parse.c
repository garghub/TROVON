...
static int F_126 ( char * V_48 , unsigned int V_132 )
{
unsigned int V_19 ;
...
static void F_127 ( struct V_194 * V_195 , void * V_175 ,
int V_2 V_152 ,
struct V_49 * V_50 )
{
struct V_118 * V_68 ;
...
V_68 -> V_2 ) ;
if ( V_68 -> V_71 & V_126 ) {
F_116 ( V_195 , L_130 , V_158 ) ;
} else if ( V_68 -> V_71 & V_139 ) {
switch ( V_68 -> V_2 ) {
case 4 :
if ( V_68 -> V_71 & V_136 )
F_116 ( V_195 , L_131 , ( int ) V_158 ) ;
else
F_116 ( V_195 , L_132 , ( int ) V_158 ) ;
break;
case 2 :
F_116 ( V_195 , L_133 , ( short ) V_158 ) ;
break;
case 1 :
F_116 ( V_195 , L_134 , ( char ) V_158 ) ;
break;
default:
...
F_116 ( V_195 , L_135 , V_158 ) ;
}
}
V_68 = V_68 -> V_22 ;
}
}
static void F_128 ( struct V_194 * V_195 , void * V_175 , int V_2 , struct V_49 * V_50 )
{
struct V_14 * V_14 = V_50 -> V_14 ;
...
if ( V_50 -> V_71 & V_150 ) {
F_116 ( V_195 , L_136 ) ;
F_127 ( V_195 , V_175 , V_2 , V_50 ) ;
return;
}
if ( V_50 -> V_71 & V_236 ) {
V_233 = F_124 ( V_175 , V_2 , V_50 ) ;
args = F_123 ( V_233 , V_175 , V_2 , V_50 ) ;
V_63 = args ;
V_174 = V_233 ;
}
for (; * V_174 ; V_174 ++ ) {
...
int V_249 ;
int V_250 ;
void * V_175 = V_240 -> V_175 ;
V_245 = F_104 ( V_14 , V_175 ) ;
V_246 = F_103 ( V_14 , V_175 ) ;
if ( V_243 )
V_247 = F_105 ( V_14 , V_175 ) ;
else if ( V_241 ) {
V_247 = F_105 ( V_14 , V_175 ) ;
if ( V_247 < 0 )
V_241 = 0 ;
...
F_116 ( V_195 , L_132 , V_248 ) ;
}
if ( V_243 ) {
if ( V_247 < 0 )
F_120 ( V_195 , '.' ) ;
else
F_116 ( V_195 , L_132 , V_247 ) ;
}
F_121 ( V_195 ) ;
}
int F_130 ( struct V_14 * V_14 , struct V_239 * V_256 )
{
return F_101 ( V_14 , V_256 -> V_175 ) ;
}
struct V_49 * F_131 ( struct V_14 * V_14 , int type )
{
return F_107 ( V_14 , type ) ;
}
int F_132 ( struct V_14 * V_14 , struct V_239 * V_256 )
{
return F_102 ( V_14 , V_256 -> V_175 ) ;
}
const char * F_133 ( struct V_14 * V_14 , int V_13 )
{
const char * V_21 ;
V_21 = F_9 ( V_14 , V_13 ) ;
return V_21 ;
}
void F_134 ( struct V_194 * V_195 , struct V_49 * V_50 ,
struct V_239 * V_240 )
{
int V_257 = 1 ;
if ( V_50 -> V_14 -> V_258 || ( V_50 -> V_71 & V_259 ) )
F_127 ( V_195 , V_240 -> V_175 , V_240 -> V_2 , V_50 ) ;
else {
if ( V_50 -> V_260 && ! ( V_50 -> V_71 & V_261 ) )
V_257 = V_50 -> V_260 ( V_195 , V_240 , V_50 ,
V_50 -> V_262 ) ;
if ( V_257 )
F_128 ( V_195 , V_240 -> V_175 , V_240 -> V_2 , V_50 ) ;
}
F_121 ( V_195 ) ;
}
static bool F_135 ( char * V_27 , bool V_263 )
{
if ( ! V_263 )
return true ;
if ( ! strcmp ( V_27 , L_146 ) || ! strcmp ( V_27 , L_147 )
|| ! strcmp ( V_27 , L_148 ) || ! strcmp ( V_27 , L_149 ) )
return true ;
return false ;
}
void F_136 ( struct V_14 * V_14 , struct V_194 * V_195 ,
struct V_239 * V_240 , bool V_263 )
{
static const char * V_264 = L_150 ;
struct V_49 * V_50 ;
unsigned long V_265 ;
unsigned long V_266 ;
unsigned long V_267 ;
...
int V_48 ;
bool V_268 ;
V_268 = F_135 ( V_14 -> V_27 ,
V_263 ) ;
if ( V_268 ) {
V_265 = V_240 -> V_269 / V_270 ;
V_267 = V_240 -> V_269 - V_265 * V_270 ;
}
if ( V_240 -> V_2 < 0 ) {
F_47 ( L_151 , V_240 -> V_2 ) ;
return;
}
...
if ( V_14 -> V_271 ) {
F_116 ( V_195 , L_153 ,
V_21 , V_13 , V_240 -> V_272 ) ;
F_129 ( V_14 , V_195 , V_240 ) ;
} else
F_116 ( V_195 , L_154 , V_21 , V_13 , V_240 -> V_272 ) ;
if ( V_268 ) {
if ( V_14 -> V_71 & V_273 ) {
V_266 = V_267 ;
V_48 = 9 ;
} else {
V_266 = ( V_267 + 500 ) / V_274 ;
V_48 = 6 ;
}
F_116 ( V_195 , L_155 ,
V_265 , V_48 , V_266 , V_50 -> V_69 ) ;
} else
F_116 ( V_195 , L_156 ,
V_240 -> V_269 , V_50 -> V_69 ) ;
V_132 = strlen ( V_50 -> V_69 ) ;
if ( V_132 < 20 )
F_116 ( V_195 , L_157 , 20 - V_132 , V_264 ) ;
F_134 ( V_195 , V_50 , V_240 ) ;
}
static int V_188 ( const void * V_8 , const void * V_9 )
{
struct V_49 * const * V_275 = V_8 ;
struct V_49 * const * V_276 = V_9 ;
if ( ( * V_275 ) -> V_53 < ( * V_276 ) -> V_53 )
return - 1 ;
if ( ( * V_275 ) -> V_53 > ( * V_276 ) -> V_53 )
return 1 ;
return 0 ;
}
static int F_137 ( const void * V_8 , const void * V_9 )
{
struct V_49 * const * V_275 = V_8 ;
struct V_49 * const * V_276 = V_9 ;
int V_277 ;
V_277 = strcmp ( ( * V_275 ) -> V_69 , ( * V_276 ) -> V_69 ) ;
if ( V_277 )
return V_277 ;
V_277 = strcmp ( ( * V_275 ) -> system , ( * V_276 ) -> system ) ;
if ( V_277 )
return V_277 ;
return V_188 ( V_8 , V_9 ) ;
}
static int F_138 ( const void * V_8 , const void * V_9 )
{
struct V_49 * const * V_275 = V_8 ;
struct V_49 * const * V_276 = V_9 ;
int V_277 ;
...
struct V_49 * * F_139 ( struct V_14 * V_14 , enum V_278 V_279 )
{
struct V_49 * * V_51 ;
int (* F_140)( const void * V_8 , const void * V_9 );
V_51 = V_14 -> V_280 ;
if ( V_51 && V_14 -> V_129 == V_279 )
return V_51 ;
if ( ! V_51 ) {
...
qsort ( V_51 , V_14 -> V_52 , sizeof( * V_51 ) , F_140 ) ;
V_14 -> V_129 = V_279 ;
return V_51 ;
}
static struct V_118 * *
F_141 ( const char * type , const char * V_69 ,
...
struct V_118 * * F_142 ( struct V_49 * V_50 )
{
return F_141 ( L_160 , V_50 -> V_69 ,
V_50 -> V_142 . V_144 ,
V_50 -> V_142 . V_143 ) ;
}
struct V_118 * * F_143 ( struct V_49 * V_50 )
{
return F_141 ( L_161 , V_50 -> V_69 ,
V_50 -> V_142 . V_145 ,
V_50 -> V_142 . V_121 ) ;
}
static void F_144 ( struct V_194 * V_195 , struct V_59 * V_68 )
{
F_116 ( V_195 , L_162 , V_68 -> V_61 , V_68 -> V_62 ) ;
if ( V_68 -> V_22 ) {
F_119 ( V_195 , L_129 ) ;
F_144 ( V_195 , V_68 -> V_22 ) ;
}
}
static void F_145 ( struct V_7 * args )
{
int V_284 = 1 ;
struct V_194 V_195 ;
switch ( args -> type ) {
...
break;
case V_67 :
printf ( L_164 , args -> V_68 . V_69 ) ;
break;
case V_70 :
printf ( L_165 ) ;
F_145 ( args -> V_71 . V_68 ) ;
printf ( L_166 , args -> V_71 . V_72 ) ;
F_111 ( & V_195 ) ;
F_144 ( & V_195 , args -> V_71 . V_71 ) ;
F_146 ( & V_195 ) ;
F_113 ( & V_195 ) ;
printf ( L_69 ) ;
break;
case V_73 :
printf ( L_167 ) ;
F_145 ( args -> V_74 . V_68 ) ;
printf ( L_129 ) ;
F_111 ( & V_195 ) ;
F_144 ( & V_195 , args -> V_74 . V_75 ) ;
F_146 ( & V_195 ) ;
F_113 ( & V_195 ) ;
printf ( L_69 ) ;
break;
...
case V_80 :
case V_81 :
printf ( L_169 , args -> string . string ) ;
break;
case V_82 :
printf ( L_170 , args -> V_83 . V_83 ) ;
break;
case V_78 :
printf ( L_171 , args -> V_79 . type ) ;
F_145 ( args -> V_79 . V_17 ) ;
break;
case V_87 :
...
if ( V_284 )
printf ( L_84 ) ;
F_145 ( args -> V_88 . V_89 ) ;
printf ( L_172 , args -> V_88 . V_88 ) ;
F_145 ( args -> V_88 . V_90 ) ;
if ( V_284 )
printf ( L_69 ) ;
break;
default:
...
static void F_147 ( const char * V_68 ,
int * V_138 , int * V_2 , int V_285 )
{
unsigned long long V_109 ;
unsigned long long V_111 ;
char * V_112 ;
...
int F_148 ( struct V_14 * V_14 , char * V_1 , unsigned long V_2 ,
int V_141 )
{
int V_287 ;
if ( ! V_2 ) {
V_14 -> V_288 = sizeof( long long ) ;
V_14 -> V_289 = V_141 ;
V_14 -> V_290 = sizeof( long long ) + V_141 ;
V_14 -> V_291 = 1 ;
return - 1 ;
}
F_1 ( V_1 , V_2 ) ;
F_147 ( L_173 , & V_14 -> V_292 ,
& V_14 -> V_288 , 1 ) ;
F_147 ( L_174 , & V_14 -> V_293 ,
& V_14 -> V_289 , 1 ) ;
F_147 ( L_175 , & V_14 -> V_294 ,
& V_287 , 0 ) ;
F_147 ( L_176 , & V_14 -> V_290 ,
& V_14 -> V_295 , 1 ) ;
return 0 ;
}
static int F_149 ( struct V_49 * V_50 ,
int V_53 , const char * V_296 ,
const char * V_297 )
{
if ( V_53 >= 0 && V_53 != V_50 -> V_53 )
return 0 ;
if ( V_297 && ( strcmp ( V_297 , V_50 -> V_69 ) != 0 ) )
return 0 ;
if ( V_296 && ( strcmp ( V_296 , V_50 -> system ) != 0 ) )
return 0 ;
return 1 ;
}
static void F_150 ( struct V_298 * V_299 )
{
free ( ( void * ) V_299 -> V_296 ) ;
free ( ( void * ) V_299 -> V_297 ) ;
free ( V_299 ) ;
}
static int F_151 ( struct V_14 * V_14 , struct V_49 * V_50 )
{
struct V_298 * V_299 , * * V_22 ;
for ( V_22 = & V_14 -> V_300 ; * V_22 ;
V_22 = & ( * V_22 ) -> V_22 ) {
V_299 = * V_22 ;
if ( F_149 ( V_50 , V_299 -> V_53 ,
V_299 -> V_296 ,
V_299 -> V_297 ) )
break;
}
...
V_50 -> V_260 = V_299 -> V_35 ;
V_50 -> V_262 = V_299 -> V_262 ;
* V_22 = V_299 -> V_22 ;
F_150 ( V_299 ) ;
return 1 ;
}
enum V_301 F_153 ( struct V_49 * * V_302 ,
...
if ( strcmp ( V_189 , L_178 ) == 0 ) {
V_50 -> V_71 |= V_125 ;
if ( strcmp ( V_50 -> V_69 , L_179 ) == 0 )
V_50 -> V_71 |= V_236 ;
}
V_50 -> V_53 = F_55 () ;
if ( V_50 -> V_53 < 0 ) {
...
const char * V_189 )
{
int V_116 = F_153 ( V_302 , V_14 , V_1 , V_2 , V_189 ) ;
struct V_49 * V_50 = * V_302 ;
if ( V_50 == NULL )
return V_116 ;
...
#define F_155 0
if ( F_155 && V_50 -> V_172 . args )
F_145 ( V_50 -> V_172 . args ) ;
return 0 ;
V_311:
F_156 ( V_50 ) ;
return V_116 ;
}
enum V_301 F_157 ( struct V_14 * V_14 ,
struct V_49 * * V_302 ,
const char * V_1 ,
unsigned long V_2 , const char * V_189 )
{
return F_154 ( V_14 , V_302 , V_1 , V_2 , V_189 ) ;
}
enum V_301 F_158 ( struct V_14 * V_14 , const char * V_1 ,
unsigned long V_2 , const char * V_189 )
{
struct V_49 * V_50 = NULL ;
return F_154 ( V_14 , & V_50 , V_1 , V_2 , V_189 ) ;
}
int F_159 ( struct V_14 * V_14 V_152 ,
enum V_301 V_312 , char * V_1 , T_1 V_313 )
{
int V_314 ;
const char * V_315 ;
if ( V_312 >= 0 ) {
V_315 = F_160 ( V_312 , V_1 , V_313 ) ;
if ( V_315 != V_1 ) {
T_1 V_132 = strlen ( V_315 ) ;
memcpy ( V_1 , V_315 , F_161 ( V_313 - 1 , V_132 ) ) ;
* ( V_1 + F_161 ( V_313 - 1 , V_132 ) ) = '\0' ;
}
return 0 ;
}
if ( V_312 <= V_316 ||
...
V_314 = V_312 - V_316 - 1 ;
V_315 = V_318 [ V_314 ] ;
snprintf ( V_1 , V_313 , L_111 , V_315 ) ;
return 0 ;
}
int F_162 ( struct V_194 * V_195 , struct V_118 * V_68 ,
const char * V_69 , struct V_239 * V_240 ,
unsigned long long * V_158 , int V_171 )
{
if ( ! V_68 ) {
if ( V_171 )
F_116 ( V_195 , L_180 , V_69 ) ;
return - 1 ;
}
if ( F_98 ( V_68 , V_240 -> V_175 , V_158 ) ) {
if ( V_171 )
F_116 ( V_195 , L_181 , V_69 ) ;
return - 1 ;
}
return 0 ;
}
void * F_163 ( struct V_194 * V_195 , struct V_49 * V_50 ,
const char * V_69 , struct V_239 * V_240 ,
int * V_132 , int V_171 )
{
struct V_118 * V_68 ;
...
int F_164 ( struct V_194 * V_195 , struct V_49 * V_50 ,
const char * V_69 , struct V_239 * V_240 ,
unsigned long long * V_158 , int V_171 )
{
struct V_118 * V_68 ;
...
return - 1 ;
V_68 = F_82 ( V_50 , V_69 ) ;
return F_162 ( V_195 , V_68 , V_69 , V_240 , V_158 , V_171 ) ;
}
int F_165 ( struct V_194 * V_195 , struct V_49 * V_50 ,
const char * V_69 , struct V_239 * V_240 ,
unsigned long long * V_158 , int V_171 )
{
struct V_118 * V_68 ;
...
int F_166 ( struct V_194 * V_195 , struct V_49 * V_50 ,
const char * V_69 , struct V_239 * V_240 ,
unsigned long long * V_158 , int V_171 )
{
struct V_118 * V_68 ;
...
int F_167 ( struct V_194 * V_195 , const char * V_47 ,
struct V_49 * V_50 , const char * V_69 ,
struct V_239 * V_240 , int V_171 )
{
...
V_320:
if ( V_171 )
F_116 ( V_195 , L_182 , V_69 ) ;
return - 1 ;
}
int F_168 ( struct V_194 * V_195 , const char * V_47 ,
struct V_49 * V_50 , const char * V_69 ,
struct V_239 * V_240 , int V_171 )
{
struct V_118 * V_68 = F_82 ( V_50 , V_69 ) ;
...
V_35 = F_18 ( V_14 , V_158 ) ;
if ( V_35 )
snprintf ( V_321 , 128 , L_183 , V_35 -> V_35 , V_35 -> V_31 - V_158 ) ;
else
sprintf ( V_321 , L_184 , V_158 ) ;
return F_116 ( V_195 , V_47 , V_321 ) ;
V_320:
if ( V_171 )
F_116 ( V_195 , L_182 , V_69 ) ;
return - 1 ;
...
static struct V_49 * F_171 ( struct V_14 * V_14 , int V_53 ,
const char * V_296 ,
const char * V_297 )
{
struct V_49 * V_50 ;
...
struct V_49 * V_50 ;
struct V_298 * V_299 ;
V_50 = F_171 ( V_14 , V_53 , V_296 , V_297 ) ;
if ( V_50 == NULL )
goto V_329;
F_152 ( L_177 ,
V_50 -> V_53 , V_50 -> system , V_50 -> V_69 ) ;
...
V_299 -> V_53 = V_53 ;
if ( V_297 )
V_299 -> V_297 = F_12 ( V_297 ) ;
if ( V_296 )
V_299 -> V_296 = F_12 ( V_296 ) ;
if ( ( V_297 && ! V_299 -> V_297 ) ||
( V_296 && ! V_299 -> V_296 ) ) {
F_47 ( L_191 ) ;
free ( ( void * ) V_299 -> V_297 ) ;
free ( ( void * ) V_299 -> V_296 ) ;
...
V_299 -> V_35 = V_35 ;
V_299 -> V_22 = V_14 -> V_300 ;
V_14 -> V_300 = V_299 ;
V_299 -> V_262 = V_262 ;
return - 1 ;
}
static int F_173 ( struct V_298 * V_260 , int V_53 ,
const char * V_296 , const char * V_297 ,
T_4 V_35 , void * V_262 )
{
if ( V_53 >= 0 && V_53 != V_260 -> V_53 )
return 0 ;
if ( V_297 && ( strcmp ( V_297 , V_260 -> V_297 ) != 0 ) )
return 0 ;
if ( V_296 && ( strcmp ( V_296 , V_260 -> V_296 ) != 0 ) )
return 0 ;
if ( V_35 != V_260 -> V_35 || V_262 != V_260 -> V_262 )
return 0 ;
return 1 ;
}
int F_174 ( struct V_14 * V_14 , int V_53 ,
const char * V_296 , const char * V_297 ,
T_4 V_35 , void * V_262 )
{
struct V_49 * V_50 ;
...
if ( V_50 == NULL )
goto V_329;
if ( V_50 -> V_260 == V_35 && V_50 -> V_262 == V_262 ) {
F_152 ( L_192 ,
V_50 -> V_53 , V_50 -> system , V_50 -> V_69 ) ;
V_50 -> V_260 = NULL ;
V_50 -> V_262 = NULL ;
...
V_329:
for ( V_22 = & V_14 -> V_300 ; * V_22 ; V_22 = & ( * V_22 ) -> V_22 ) {
V_299 = * V_22 ;
if ( F_173 ( V_299 , V_53 , V_296 , V_297 ,
V_35 , V_262 ) )
break;
}
if ( ! ( * V_22 ) )
...
void F_176 ( struct V_14 * V_14 )
{
V_14 -> V_330 ++ ;
}
static void F_177 ( struct V_118 * V_68 )
{
struct V_118 * V_22 ;
while ( V_68 ) {
V_22 = V_68 -> V_22 ;
...
void F_179 ( struct V_14 * V_14 )
{
struct V_15 * V_16 , * V_331 ;
struct V_32 * V_33 , * V_332 ;
struct V_43 * V_44 , * V_333 ;
struct V_166 * V_334 ;
struct V_298 * V_299 ;
int V_19 ;
if ( ! V_14 )
...
for ( V_19 = 0 ; V_19 < V_14 -> V_52 ; V_19 ++ )
F_156 ( V_14 -> V_51 [ V_19 ] ) ;
while ( V_14 -> V_300 ) {
V_299 = V_14 -> V_300 ;
V_14 -> V_300 = V_299 -> V_22 ;
F_150 ( V_299 ) ;
}
free ( V_14 -> V_51 ) ;
free ( V_14 -> V_280 ) ;
