...
struct V_108 V_110 ;
struct V_52 V_53 ;
const void T_3 * V_111 , * V_112 ;
int V_12 ;
if ( F_31 ( & V_110 , V_109 , sizeof( V_110 ) ) )
return - V_57 ;
V_111 = ( const void T_3 * ) ( V_113 ) V_110 . V_111 ;
V_112 = ( const void T_3 * ) ( V_113 ) V_110 . V_112 ;
if ( ! F_39 ( V_77 , V_111 , V_110 . V_46 ) ||
! F_39 ( V_77 , V_112 , V_110 . V_78 ) )
return - V_57 ;
if ( ! V_7 -> V_76 )
return - V_66 ;
