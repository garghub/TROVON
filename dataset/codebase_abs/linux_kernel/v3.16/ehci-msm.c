...
V_2 -> V_26 = V_15 -> V_27 ;
V_2 -> V_28 = F_12 ( V_15 ) ;
V_2 -> V_29 = F_13 ( & V_13 -> V_19 , V_15 ) ;
if ( F_14 ( V_2 -> V_29 ) ) {
V_18 = F_15 ( V_2 -> V_29 ) ;
goto V_23;
}
if ( V_13 -> V_19 . V_30 )
V_17 = F_16 ( & V_13 -> V_19 , L_5 , 0 ) ;
else
V_17 = F_17 ( & V_13 -> V_19 , V_31 ) ;
if ( F_14 ( V_17 ) ) {
F_9 ( & V_13 -> V_19 , L_6 ) ;
V_18 = - V_32 ;
goto V_23;
}
V_18 = F_18 ( V_17 -> V_33 , & V_2 -> V_34 ) ;
if ( V_18 < 0 ) {
F_9 ( & V_13 -> V_19 , L_7 ) ;
goto V_23;
}
...
F_25 ( & V_13 -> V_19 ) ;
F_26 ( & V_13 -> V_19 ) ;
F_18 ( V_2 -> V_17 -> V_33 , NULL ) ;
F_22 ( V_2 ) ;
return 0 ;
}
static int F_27 ( struct V_35 * V_19 )
{
...
static int F_31 ( struct V_35 * V_19 )
{
struct V_1 * V_2 = F_28 ( V_19 ) ;
F_6 ( V_19 , L_9 ) ;
F_32 ( V_2 , false ) ;
