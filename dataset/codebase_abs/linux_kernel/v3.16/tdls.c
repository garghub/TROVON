...
V_13 -> V_184 = V_2 -> V_184 ;
V_13 -> V_185 = V_2 -> V_185 ;
F_61 ( & V_172 ) ;
V_10 -> V_186 = F_62 ( V_172 ) ;
F_63 ( V_2 , V_10 ) ;
return 0 ;
}
static int
...
{
struct V_175 * V_187 ;
T_1 V_188 [] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
int V_128 ;
T_3 V_129 ;
struct V_130 * V_131 ;
T_1 V_132 , * V_41 ;
V_129 = V_2 -> V_57 . V_66 . V_133 ;
V_187 = ( void * ) F_26 ( V_10 , F_51 ( struct V_175 , V_134 ) ) ;
memset ( V_187 , 0 , 24 ) ;
memcpy ( V_187 -> V_135 , V_122 , V_136 ) ;
memcpy ( V_187 -> V_137 , V_2 -> V_138 , V_136 ) ;
memcpy ( V_187 -> V_160 , V_2 -> V_181 , V_136 ) ;
V_187 -> V_189 = F_46 ( V_190 |
V_191 ) ;
V_41 = F_26 ( V_10 , V_136 ) ;
switch ( V_123 ) {
case V_192 :
F_26 ( V_10 , sizeof( V_187 -> V_134 . V_193 . V_134 . V_194 ) + 1 ) ;
V_187 -> V_134 . V_193 . V_144 = V_195 ;
V_187 -> V_134 . V_193 . V_134 . V_194 . V_123 =
V_192 ;
V_187 -> V_134 . V_193 . V_134 . V_194 . V_124 =
V_124 ;
V_187 -> V_134 . V_193 . V_134 . V_194 . V_147 =
F_46 ( V_129 ) ;
memmove ( V_41 + V_136 , & V_187 -> V_134 . V_193 . V_144 ,
sizeof( V_187 -> V_134 . V_193 . V_134 . V_194 ) ) ;
memcpy ( V_41 , V_188 , V_136 ) ;
V_128 = F_21 ( V_2 , V_10 ) ;
if ( V_128 ) {
F_53 ( V_10 ) ;
return V_128 ;
...
int F_65 ( struct V_1 * V_2 , const T_1 * V_122 ,
T_1 V_123 , T_1 V_124 ,
T_3 V_125 , const T_1 * V_169 ,
T_4 V_170 )
{
...
V_196 = V_199 ;
V_197 = 0 ;
V_41 = F_26 ( V_10 , V_176 + sizeof( V_198 ) ) ;
memset ( V_41 , 0 , V_176 + sizeof( V_198 ) ) ;
memcpy ( V_41 , & V_196 , sizeof( V_196 ) ) ;
memcpy ( V_41 + sizeof( V_196 ) , & V_197 , sizeof( V_197 ) ) ;
if ( F_64 ( V_2 , V_122 , V_123 ,
V_124 , V_125 ,
V_10 ) ) {
F_53 ( V_10 ) ;
return - V_158 ;
...
V_13 -> V_185 = V_2 -> V_185 ;
V_13 -> V_14 |= V_27 ;
V_198 = V_10 -> V_117 - V_176 - sizeof( V_198 ) ;
memcpy ( V_10 -> V_22 + V_176 , & V_198 ,
sizeof( V_198 ) ) ;
F_61 ( & V_172 ) ;
V_10 -> V_186 = F_62 ( V_172 ) ;
F_63 ( V_2 , V_10 ) ;
...
{
struct V_62 * V_63 ;
T_1 * V_122 , * V_41 , * V_201 ;
T_1 V_37 , V_193 , V_202 ;
int V_165 = 0 ;
if ( V_117 < ( sizeof( struct V_203 ) + 3 ) )
return;
if ( * ( V_200 + sizeof( struct V_203 ) ) != V_142 )
return;
if ( * ( V_200 + sizeof( struct V_203 ) + 1 ) != V_145 )
return;
V_122 = V_200 + V_136 ;
V_193 = * ( V_200 + sizeof( struct V_203 ) + 2 ) ;
if ( V_193 > V_151 )
return;
F_2 ( V_2 -> V_17 -> V_18 ,
L_8 , V_122 , V_193 ) ;
...
switch ( V_193 ) {
case V_143 :
if ( V_117 < ( sizeof( struct V_203 ) + V_204 ) )
return;
V_41 = V_200 + sizeof( struct V_203 ) + 4 ;
V_63 -> V_74 . V_129 = F_46 ( * ( T_3 * ) V_41 ) ;
V_165 = V_117 - sizeof( struct V_203 ) - V_204 ;
V_41 += 2 ;
break;
case V_149 :
if ( V_117 < ( sizeof( struct V_203 ) + V_205 ) )
return;
V_41 = V_200 + sizeof( struct V_203 ) + 6 ;
V_63 -> V_74 . V_129 = F_46 ( * ( T_3 * ) V_41 ) ;
V_165 = V_117 - sizeof( struct V_203 ) - V_205 ;
V_41 += 2 ;
break;
case V_151 :
if ( V_117 < ( sizeof( struct V_203 ) + V_206 ) )
return;
V_41 = V_200 + sizeof( struct V_203 ) + V_206 ;
V_165 = V_117 - sizeof( struct V_203 ) - V_206 ;
break;
default:
F_34 ( V_2 -> V_17 -> V_18 , L_5 ) ;
return;
}
for ( V_201 = V_41 + V_165 ; V_41 + 1 < V_201 ; V_41 += 2 + V_41 [ 1 ] ) {
if ( V_41 + 2 + V_41 [ 1 ] > V_201 )
break;
switch ( * V_41 ) {
case V_47 :
V_63 -> V_74 . V_207 = V_41 [ 1 ] ;
for ( V_37 = 0 ; V_37 < V_41 [ 1 ] ; V_37 ++ )
V_63 -> V_74 . V_39 [ V_37 ] = V_41 [ V_37 + 2 ] ;
break;
case V_48 :
V_202 = V_63 -> V_74 . V_207 ;
for ( V_37 = 0 ; V_37 < V_41 [ 1 ] ; V_37 ++ )
V_63 -> V_74 . V_39 [ V_202 + V_37 ] = V_41 [ V_37 + 2 ] ;
V_63 -> V_74 . V_207 += V_41 [ 1 ] ;
break;
case V_148 :
memcpy ( ( T_1 * ) & V_63 -> V_74 . V_208 , V_41 ,
sizeof( struct V_130 ) ) ;
V_63 -> V_209 = 1 ;
break;
case V_67 :
...
break;
case V_212 :
memcpy ( ( T_1 * ) & V_63 -> V_74 . V_213 , V_41 ,
sizeof( struct V_166 ) + V_41 [ 1 ] ) ;
break;
case V_120 :
V_63 -> V_74 . V_214 = V_41 [ 2 ] ;
break;
case V_94 :
if ( V_2 -> V_17 -> V_119 )
memcpy ( & V_63 -> V_74 . V_215 , V_41 ,
sizeof( struct V_75 ) ) ;
break;
case V_56 :
if ( V_2 -> V_17 -> V_119 ) {
...
static int
F_68 ( struct V_1 * V_2 , const T_1 * V_122 )
{
struct V_62 * V_63 ;
struct V_219 V_220 ;
memset ( & V_220 , 0 , sizeof( struct V_219 ) ) ;
V_63 = F_32 ( V_2 , V_122 ) ;
if ( ! V_63 || V_63 -> V_221 == V_222 ) {
F_25 ( V_2 -> V_17 -> V_18 ,
L_9 , V_122 ) ;
return - V_158 ;
}
memcpy ( & V_220 . V_223 , V_122 , V_136 ) ;
V_220 . V_224 = V_225 ;
return F_69 ( V_2 , V_226 ,
V_227 , 0 , & V_220 , true ) ;
}
static int
...
static int
F_71 ( struct V_1 * V_2 , const T_1 * V_122 )
{
struct V_62 * V_63 ;
struct V_219 V_220 ;
unsigned long V_14 ;
...
static int
F_75 ( struct V_1 * V_2 , const T_1 * V_122 )
{
struct V_62 * V_63 ;
struct V_232 V_233 ;
unsigned long V_14 ;
...
L_11 , V_122 ) ;
V_63 -> V_221 = V_25 ;
V_233 = V_63 -> V_74 . V_208 . V_233 ;
if ( V_233 . V_234 [ 0 ] != 0xff )
V_63 -> V_209 = true ;
if ( V_63 -> V_209 ) {
if ( F_28 ( V_63 -> V_74 . V_208 . V_235 ) &
V_236 )
V_63 -> V_237 =
V_238 ;
else
...
for ( V_37 = 0 ; V_37 < V_38 ; V_37 ++ )
V_63 -> V_240 [ V_37 ] =
V_2 -> V_241 [ V_37 ] . V_242 ;
} else {
for ( V_37 = 0 ; V_37 < V_38 ; V_37 ++ )
V_63 -> V_240 [ V_37 ] = V_243 ;
}
memset ( V_63 -> V_244 , 0xff , sizeof( V_63 -> V_244 ) ) ;
F_1 ( V_2 , V_122 , V_25 ) ;
} else {
F_2 ( V_2 -> V_17 -> V_18 ,
L_12 , V_122 ) ;
...
int F_76 ( struct V_1 * V_2 , const T_1 * V_122 , T_1 V_193 )
{
switch ( V_193 ) {
case V_245 :
return F_75 ( V_2 , V_122 ) ;
case V_231 :
return F_71 ( V_2 , V_122 ) ;
case V_229 :
return F_70 ( V_2 , V_122 ) ;
case V_225 :
return F_68 ( V_2 , V_122 ) ;
}
return 0 ;
}
...
F_1 ( V_2 , V_63 -> V_248 ,
V_230 ) ;
memcpy ( & V_220 . V_223 , V_63 -> V_248 , V_136 ) ;
V_220 . V_224 = V_231 ;
if ( F_69 ( V_2 , V_226 ,
V_227 , 0 , & V_220 , false ) )
F_34 ( V_2 -> V_17 -> V_18 ,
