...
F_83 ( V_244 , & V_131 -> V_31 ) ;
F_84 ( V_5 -> V_167 , V_5 ) ;
V_50 = F_85 ( V_131 , V_245 ,
( V_205 ? 3 : 2 ) ) ;
if ( V_50 < 0 )
goto V_220;
}
...
V_50 = F_71 () ;
if ( V_50 ) {
F_90 ( V_38 -> V_121 , L_26 ) ;
return V_50 ;
}
V_50 = F_91 ( V_38 , & V_72 . V_146 ) ;
if ( V_50 ) {
F_90 ( V_38 -> V_121 , L_27 ) ;
return V_50 ;
}
while ( ( V_254 = F_92 ( V_247 , V_255 , V_249 ) ) ) {
V_50 = F_93 ( & V_247 -> V_71 , V_254 -> V_256 , F_39 ,
V_257 , V_122 ,
...
V_72 . V_83 = V_247 -> V_71 . V_39 ;
V_156 = V_72 . V_83 -> V_156 ;
V_248 = V_72 . V_83 -> V_157 ;
...
V_72 . V_211 . V_263 = V_72 . V_83 -> V_214 ;
V_72 . V_211 . V_264 = V_72 . V_83 -> V_260 [ 0 ] ;
V_72 . V_211 . V_265 = F_74 ;
V_72 . V_211 . V_266 = F_88 ;
V_50 = F_97 ( & V_72 . V_146 ,
& V_72 . V_211 ) ;
if ( V_50 ) {
F_10 ( L_31 ) ;
V_50 = - V_13 ;
...
static int F_99 ( struct V_246 * V_267 )
{
struct V_7 * V_8 ;
struct V_4 * V_5 ;
int V_74 ;
...
static int F_100 ( struct V_267 * V_71 )
{
struct V_7 * V_8 ;
struct V_4 * V_5 ;
int V_74 ;
...
static int F_104 ( struct V_267 * V_71 )
{
struct V_7 * V_8 ;
struct V_4 * V_5 ;
int V_74 ;
