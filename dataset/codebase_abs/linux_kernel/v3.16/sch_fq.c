...
static int F_52 ( struct V_56 * V_57 , struct V_111 * V_112 )
{
struct V_7 * V_8 = F_24 ( V_57 ) ;
...
if ( ! V_112 )
return - V_118 ;
V_115 = F_53 ( V_113 , V_114 , V_112 , V_119 ) ;
if ( V_115 < 0 )
return V_115 ;
F_50 ( V_57 ) ;
V_117 = V_8 -> V_48 ;
if ( V_113 [ V_120 ] ) {
V_47 V_121 = F_54 ( V_113 [ V_120 ] ) ;
if ( V_121 >= 1 && V_121 <= F_55 ( 256 * 1024 ) )
V_117 = V_121 ;
else
V_115 = - V_118 ;
}
if ( V_113 [ V_122 ] )
V_57 -> V_63 = F_54 ( V_113 [ V_122 ] ) ;
if ( V_113 [ V_123 ] )
V_8 -> V_64 = F_54 ( V_113 [ V_123 ] ) ;
if ( V_113 [ V_124 ] )
V_8 -> V_69 = F_54 ( V_113 [ V_124 ] ) ;
if ( V_113 [ V_125 ] )
V_8 -> V_52 = F_54 ( V_113 [ V_125 ] ) ;
if ( V_113 [ V_126 ] )
F_56 ( L_1 ,
F_54 ( V_113 [ V_126 ] ) ) ;
if ( V_113 [ V_127 ] )
V_8 -> V_80 = F_54 ( V_113 [ V_127 ] ) ;
if ( V_113 [ V_128 ] ) {
V_47 V_129 = F_54 ( V_113 [ V_128 ] ) ;
if ( V_129 <= 1 )
V_8 -> V_79 = V_129 ;
else
V_115 = - V_118 ;
...
if ( V_113 [ V_130 ] ) {
V_47 V_131 = F_54 ( V_113 [ V_130 ] ) ;
V_8 -> V_68 = F_57 ( V_131 ) ;
}
if ( ! V_115 ) {
F_51 ( V_57 ) ;
V_115 = F_48 ( V_57 , V_117 ) ;
F_50 ( V_57 ) ;
}
...
static int F_61 ( struct V_56 * V_57 , struct V_111 * V_112 )
{
struct V_7 * V_8 = F_24 ( V_57 ) ;
int V_115 ;
V_57 -> V_63 = 10000 ;
V_8 -> V_64 = 100 ;
V_8 -> V_69 = 2 * F_62 ( F_63 ( V_57 ) ) ;
...
F_65 ( & V_8 -> V_77 , V_57 ) ;
if ( V_112 )
V_115 = F_52 ( V_57 , V_112 ) ;
else
V_115 = F_48 ( V_57 , V_8 -> V_48 ) ;
return V_115 ;
}
...
struct V_7 * V_8 = F_24 ( V_57 ) ;
struct V_111 * V_132 ;
V_132 = F_67 ( V_41 , V_133 ) ;
if ( V_132 == NULL )
goto V_134;
if ( F_68 ( V_41 , V_122 , V_57 -> V_63 ) ||
F_68 ( V_41 , V_123 , V_8 -> V_64 ) ||
F_68 ( V_41 , V_124 , V_8 -> V_69 ) ||
F_68 ( V_41 , V_125 , V_8 -> V_52 ) ||
F_68 ( V_41 , V_128 , V_8 -> V_79 ) ||
F_68 ( V_41 , V_127 , V_8 -> V_80 ) ||
F_68 ( V_41 , V_130 ,
F_69 ( V_8 -> V_68 ) ) ||
F_68 ( V_41 , V_120 , V_8 -> V_48 ) )
goto V_134;
return F_70 ( V_41 , V_132 ) ;
V_134:
return - 1 ;
}
static int F_71 ( struct V_56 * V_57 , struct V_135 * V_136 )
{
struct V_7 * V_8 = F_24 ( V_57 ) ;
T_1 V_72 = F_31 ( F_32 () ) ;
struct V_137 V_138 = {
...
return F_72 ( V_136 , & V_138 , sizeof( V_138 ) ) ;
}
