...
int F_42 ( struct V_60 * V_48 ,
struct V_14 * V_15 )
{
struct V_22 * V_13 = V_48 -> V_61 ;
struct V_12 * V_25 = F_12 ( V_13 ) ;
struct V_45 * V_62 = V_13 -> V_44 ;
struct V_26 * V_28 ;
unsigned long V_63 ;
int V_39 ;
F_43 ( ! F_44 ( & V_13 -> V_44 -> V_64 ) ) ;
V_15 -> V_18 |= V_65 | V_66 | V_67 ;
V_15 -> V_68 = V_13 ;
V_15 -> V_69 = V_62 -> V_56 -> V_70 ;
F_4 ( V_25 , V_15 ) ;
V_63 = V_15 -> V_71 - V_15 -> V_72 ;
V_28 = V_25 -> V_28 ;
if ( V_63 > V_28 -> V_20 )
return - V_11 ;
V_39 = F_45 ( V_62 -> V_44 , V_15 , V_28 -> V_73 ,
V_28 -> V_53 , V_28 -> V_20 ,
& V_28 -> V_74 ) ;
if ( V_39 < 0 ) {
F_3 ( L_12 ) ;
...
int F_48 ( struct V_45 * V_44 , void * V_51 ,
struct V_36 * V_37 )
{
struct V_75 * V_76 ;
...
V_78 = V_76 -> V_78 ;
V_78 -> V_61 = V_13 ;
V_79 = F_51 ( V_78 , 0 , args -> V_20 , V_81 | V_82 ,
V_83 , 0 ) ;
F_52 ( V_13 ) ;
if ( F_53 ( V_79 ) ) {
F_50 ( & V_44 -> V_64 ) ;
...
int F_54 ( struct V_45 * V_44 , void * V_51 ,
struct V_36 * V_37 )
{ struct V_12 * V_25 ;
...
struct V_14 * F_55 ( struct V_14 * V_15 )
{
struct V_14 * V_86 ;
V_86 = F_56 ( sizeof( * V_86 ) , V_47 ) ;
if ( ! V_86 )
return NULL ;
...
int F_69 ( struct V_45 * V_62 ,
struct V_100 * V_33 ,
enum V_101 V_102 )
{
int V_103 ;
F_49 ( & V_62 -> V_64 ) ;
V_103 = F_70 ( V_62 -> V_44 , V_33 -> V_30 , V_33 -> V_103 , V_102 ) ;
if ( ! V_103 ) {
F_3 ( L_15 ) ;
F_50 ( & V_62 -> V_64 ) ;
return V_103 ;
...
void F_71 ( struct V_45 * V_62 ,
struct V_100 * V_33 ,
enum V_101 V_102 )
{
F_72 ( V_62 -> V_44 , V_33 -> V_30 , V_33 -> V_103 , V_102 ) ;
}
void F_73 ( struct V_22 * V_13 )
{
struct V_12 * V_25 ;
struct V_26 * V_27 ;
V_25 = F_12 ( V_13 ) ;
...
int F_80 ( struct V_14 * V_15 , struct V_113 * V_114 )
{
...
int F_81 ( struct V_60 * V_48 , struct V_14 * V_15 )
{
struct V_12 * V_25 ;
struct V_22 * V_13 ;
int V_39 ;
