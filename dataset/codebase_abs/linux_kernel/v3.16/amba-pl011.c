...
V_10 -> V_28 |= V_21 | V_22 ;
if ( V_247 -> V_268 & ( V_270 | V_271 | V_272 ) )
V_10 -> V_28 |= V_20 ;
V_10 -> V_273 = 0 ;
if ( V_247 -> V_268 & V_274 )
V_10 -> V_273 |= V_21 | V_22 ;
if ( V_247 -> V_268 & V_270 ) {
V_10 -> V_273 |= V_20 ;
if ( V_247 -> V_268 & V_274 )
V_10 -> V_273 |= V_26 ;
}
...
static void F_147 ( struct V_119 * V_10 , int V_302 )
{
while ( F_148 ( V_10 -> V_11 + V_12 ) & V_118 )
;
F_149 ( V_302 , V_10 -> V_11 + V_14 ) ;
while ( F_148 ( V_10 -> V_11 + V_12 ) & V_164 )
;
}
static void F_150 ( struct V_288 * V_303 , const char * V_290 , unsigned V_304 )
{
struct V_305 * V_2 = V_303 -> V_81 ;
F_139 ( & V_2 -> V_10 , V_290 , V_304 , F_147 ) ;
}
static int T_4 F_151 ( struct V_305 * V_40 ,
const char * V_306 )
{
if ( ! V_40 -> V_10 . V_11 )
return - V_301 ;
V_40 -> V_303 -> V_307 = F_150 ;
return 0 ;
}
static int F_152 ( int V_292 , struct V_40 * V_2 )
{
struct V_308 * V_309 ;
static bool V_310 = false ;
static bool V_311 = false ;
int V_117 = V_292 ;
if ( ! F_153 ( V_312 ) )
return V_117 ;
V_309 = V_2 -> V_313 ;
if ( ! V_309 )
return V_117 ;
V_117 = F_154 ( V_309 , L_22 ) ;
if ( F_155 ( V_117 ) ) {
V_311 = true ;
V_117 = V_292 ;
} else {
V_310 = true ;
if ( V_117 >= F_156 ( V_291 ) || V_291 [ V_117 ] != NULL ) {
F_62 ( V_2 , L_23 , V_117 ) ;
V_117 = V_292 ;
}
}
...
static int F_157 ( struct V_1 * V_2 , const struct V_314 * V_315 )
{
struct V_3 * V_4 ;
struct V_316 * V_158 = V_315 -> V_81 ;
void T_10 * V_317 ;
int V_231 , V_117 ;
for ( V_231 = 0 ; V_231 < F_156 ( V_291 ) ; V_231 ++ )
if ( V_291 [ V_231 ] == NULL )
break;
if ( V_231 == F_156 ( V_291 ) ) {
V_117 = - V_107 ;
goto V_227;
}
...
V_231 = F_152 ( V_231 , & V_2 -> V_2 ) ;
V_317 = F_159 ( & V_2 -> V_2 , V_2 -> V_318 . V_319 ,
F_160 ( & V_2 -> V_318 ) ) ;
if ( ! V_317 ) {
V_117 = - V_43 ;
goto V_227;
...
V_4 -> V_241 = 0 ;
V_4 -> V_55 = V_158 -> V_320 ( V_2 ) ;
V_4 -> V_10 . V_2 = & V_2 -> V_2 ;
V_4 -> V_10 . V_49 = V_2 -> V_318 . V_319 ;
V_4 -> V_10 . V_11 = V_317 ;
V_4 -> V_10 . V_321 = V_322 ;
