...
V_17 = F_42 ( V_6 -> V_33 + V_109 ) ;
V_101 = F_43 ( V_17 ) ;
F_3 ( F_44 ( V_101 , 0 ) ,
V_6 -> V_33 + V_109 ) ;
V_77 = F_34 ( NULL , V_101 ) ;
V_27 = F_45 ( V_77 , V_110 ,
V_111 , L_29 , NULL ) ;
if ( V_27 ) {
F_12 ( L_30 , V_101 ) ;
F_13 () ;
...
T_4 F_47 ( void * V_112 , const struct V_68 * V_113 ,
T_4 V_15 , T_4 V_114 )
{
return V_113 -> V_69 ;
}
int F_48 ( struct V_59 * V_60 , int V_115 )
{
return 0 ;
}
void F_49 ( unsigned int V_116 , struct V_117 * V_21 )
{
V_116 = F_50 ( V_116 ) ;
...
static inline unsigned long F_51 ( int V_121 )
{
return 1 << V_121 ;
}
static void F_52 ( struct V_122 * V_112 )
{
...
static unsigned int F_54 ( struct V_122 * V_112 )
{
F_55 ( V_112 -> V_77 ) ;
F_53 ( V_112 ) ;
return 0 ;
...
F_57 ( V_77 , & V_129 ,
V_130 , L_32 ) ;
F_58 ( V_77 , ( void * ) V_115 ) ;
V_128:
return V_77 ;
}
static void F_59 ( int V_131 , unsigned int V_132 )
{
