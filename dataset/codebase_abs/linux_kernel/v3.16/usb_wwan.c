...
struct V_4 * V_5 ;
struct V_6 * V_7 ;
struct V_85 * V_8 = V_2 -> V_8 ;
int V_55 , V_60 ;
struct V_58 * V_58 ;
V_5 = F_3 ( V_2 ) ;
V_7 = F_2 ( V_8 ) ;
if ( V_2 -> V_86 ) {
V_60 = F_26 ( V_2 -> V_86 , V_87 ) ;
if ( V_60 ) {
F_27 ( & V_2 -> V_48 , L_11 ,
V_49 , V_60 ) ;
}
...
int V_78 ,
int V_92 , void * V_93 , char * V_53 , int V_94 ,
...
static void F_65 ( struct V_85 * V_8 )
{
int V_55 , V_109 ;
struct V_1 * V_2 ;
struct V_4 * V_5 ;
...
int F_66 ( struct V_85 * V_8 , T_3 V_111 )
{
struct V_6 * V_7 = F_2 ( V_8 ) ;
F_42 ( & V_7 -> V_73 ) ;
if ( F_67 ( V_111 ) ) {
