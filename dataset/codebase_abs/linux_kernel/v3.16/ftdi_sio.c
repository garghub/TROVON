...
F_33 ( & V_73 -> V_13 , L_18 , V_123 ) ;
if ( ! V_123 )
return;
for ( V_124 = 0 ; V_124 < V_123 ; V_124 ++ ) {
F_33 ( & V_73 -> V_13 , L_19 , V_124 + 1 ,
V_26 -> V_125 -> V_127 [ V_124 ] . V_111 . V_128 ) ;
V_122 = & V_26 -> V_125 -> V_127 [ V_124 ] . V_111 ;
if ( V_122 -> V_128 == 0 ) {
V_122 -> V_128 = F_35 ( 0x40 ) ;
F_33 ( & V_73 -> V_13 , L_20 , V_124 ) ;
}
}
...
int V_124 , V_168 , V_169 ;
V_133 = 0 ;
F_68 ( & V_7 -> V_170 , V_33 ) ;
for ( V_124 = 0 ; V_124 < V_166 - 1 ; V_124 += V_11 -> V_129 ) {
V_168 = F_69 ( int , V_166 - V_124 , V_11 -> V_129 ) - 1 ;
V_169 = F_70 ( & V_7 -> V_171 , & V_167 [ V_124 + 1 ] , V_168 ) ;
if ( ! V_169 )
break;
V_7 -> V_172 . V_173 += V_169 ;
V_167 [ V_124 ] = ( V_169 << 2 ) + 1 ;
V_133 += V_169 + 1 ;
}
F_71 ( & V_7 -> V_170 , V_33 ) ;
} else {
...
for ( V_124 = 0 ; V_124 < V_168 ; V_124 ++ , V_177 ++ ) {
if ( ! F_80 ( V_7 , * V_177 ) )
...
int V_168 ;
int V_133 = 0 ;
for ( V_124 = 0 ; V_124 < V_208 -> V_212 ; V_124 += V_11 -> V_129 ) {
V_168 = F_69 ( int , V_208 -> V_212 - V_124 , V_11 -> V_129 ) ;
V_133 += F_73 ( V_7 , V_11 , & V_210 [ V_124 ] , V_168 ) ;
}
if ( V_133 )
F_83 ( & V_7 -> V_7 ) ;
}
