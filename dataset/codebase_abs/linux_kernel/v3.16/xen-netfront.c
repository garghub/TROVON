...
F_78 ( & V_12 -> V_109 , V_91 ) ;
if ( F_15 ( ! F_21 ( V_20 ) ||
( V_105 > 1 && ! F_9 ( V_20 ) ) ||
F_79 ( V_5 , F_80 ( V_5 ) ) ) ) {
F_81 ( & V_12 -> V_109 , V_91 ) ;
goto V_107;
}
V_14 = V_12 -> V_25 . V_26 ;
V_3 = F_5 ( & V_12 -> V_84 , V_12 -> V_78 ) ;
...
static void F_89 ( struct V_11 * V_12 , struct V_10 * V_5 ,
T_2 V_16 )
{
...
if ( F_91 () )
F_95 ( L_11 , V_117 -> V_119 . V_117 . type ) ;
return - V_140 ;
}
...
if ( V_157 -> V_87 == V_29 ) {
unsigned int V_160 = F_97 ( V_5 ) -> V_160 ;
F_31 ( V_160 <= F_62 ( V_5 ) ) ;
F_98 ( V_5 , V_160 - F_62 ( V_5 ) ) ;
}
...
int V_160 = F_97 ( V_5 ) -> V_160 ;
if ( V_160 > F_62 ( V_5 ) )
F_98 ( V_5 , V_160 - F_62 ( V_5 ) ) ;
V_5 -> V_165 = F_104 ( V_5 , V_12 -> V_30 -> V_31 ) ;
F_105 ( V_5 ) ;
...
static int F_107 ( struct V_169 * V_24 , int V_170 )
{
...
V_137 = F_93 ( V_12 , & V_143 , V_134 , & V_173 ) ;
if ( F_15 ( V_137 ) ) {
V_137:
...
struct V_116 * V_117 ;
V_117 = & V_133 [ V_125 - 1 ] ;
if ( F_15 ( F_94 ( V_5 , V_117 ) ) ) {
F_111 ( & V_173 , V_5 ) ;
V_12 -> V_38 . V_27 += F_22 ( & V_173 ) ;
goto V_137;
}
}
F_97 ( V_5 ) -> V_160 = V_38 -> V_76 ;
if ( F_97 ( V_5 ) -> V_160 > V_45 )
F_97 ( V_5 ) -> V_160 = V_45 ;
F_35 ( V_5 ) -> V_60 [ 0 ] . V_94 = V_38 -> V_88 ;
F_112 ( & F_35 ( V_5 ) -> V_60 [ 0 ] , V_38 -> V_76 ) ;
V_5 -> V_174 = V_38 -> V_76 ;
V_5 -> V_89 += V_38 -> V_76 ;
V_14 = F_96 ( V_12 , V_5 , & V_173 ) ;
if ( V_38 -> V_91 & V_175 )
V_5 -> V_110 = V_111 ;
...
static int F_120 ( struct V_19 * V_20 , int V_179 )
{
int V_146 = F_9 ( V_20 ) ?
V_108 - V_180 : V_181 ;
if ( V_179 > V_146 )
...
static struct V_182 * F_121 ( struct V_19 * V_20 ,
struct V_182 * V_183 )
{
struct V_65 * V_66 = F_44 ( V_20 ) ;
int V_184 ;
F_122 (cpu) {
struct V_103 * V_104 = F_123 ( V_66 -> V_104 , V_184 ) ;
T_7 V_167 , V_168 , V_129 , V_128 ;
unsigned int V_185 ;
do {
V_185 = F_124 ( & V_104 -> V_127 ) ;
V_167 = V_104 -> V_167 ;
V_129 = V_104 -> V_129 ;
V_168 = V_104 -> V_168 ;
V_128 = V_104 -> V_128 ;
} while ( F_125 ( & V_104 -> V_127 , V_185 ) );
V_183 -> V_167 += V_167 ;
V_183 -> V_129 += V_129 ;
V_183 -> V_168 += V_168 ;
V_183 -> V_128 += V_128 ;
...
F_127 ( V_12 -> V_83 [ V_14 ] ) ;
F_128 ( V_12 -> V_79 [ V_14 ] ,
V_81 ,
...
static void F_130 ( struct V_19 * V_20 )
{
struct V_65 * V_66 = F_44 ( V_20 ) ;
unsigned int V_67 = V_20 -> V_68 ;
struct V_11 * V_12 ;
...
if ( V_137 ) {
F_95 ( L_19 , V_80 , V_137 ) ;
goto V_208;
}
V_137 = F_155 ( V_30 -> V_31 ) ;
if ( V_137 ) {
F_156 ( V_30 -> V_31 ) ;
F_95 ( L_20 , V_80 , V_137 ) ;
goto V_208;
}
return 0 ;
V_208:
...
{
if ( V_16 != V_18 )
F_128 ( V_16 , 0 , ( unsigned long ) V_34 ) ;
}
...
F_201 ( V_20 ) ;
F_189 () ;
for ( V_258 = 0 ; V_258 < V_67 ; ++ V_258 ) {
V_12 = & V_66 -> V_69 [ V_258 ] ;
F_202 ( & V_12 -> V_109 ) ;
F_126 ( V_12 ) ;
F_203 ( & V_12 -> V_109 ) ;
F_46 ( & V_12 -> V_70 ) ;
for ( V_256 = 0 , V_14 = 0 ; V_14 < V_9 ; V_14 ++ ) {
T_3 * V_93 ;
const struct V_34 * V_34 ;
if ( ! V_12 -> V_15 [ V_14 ] )
continue;
V_5 = V_12 -> V_15 [ V_256 ] = F_7 ( V_12 , V_14 ) ;
V_16 = V_12 -> V_17 [ V_256 ] = F_8 ( V_12 , V_14 ) ;
V_42 = F_37 ( & V_12 -> V_38 , V_256 ) ;
V_93 = & F_35 ( V_5 ) -> V_60 [ 0 ] ;
V_34 = F_34 ( V_93 ) ;
F_38 (
V_16 , V_12 -> V_30 -> V_61 -> V_62 ,
F_39 ( F_33 ( V_34 ) ) ,
0 ) ;
V_42 -> V_63 = V_16 ;
V_42 -> V_3 = V_256 ;
...
F_163 ( & V_20 -> V_20 , L_21 , F_206 ( V_261 ) ) ;
switch ( V_261 ) {
case V_262 :
case V_263 :
case V_264 :
...
static int F_210 ( struct V_19 * V_20 , int V_272 )
{
switch ( V_272 ) {
case V_273 :
return F_211 ( V_274 ) ;
...
struct V_275 * V_104 , T_7 * V_23 )
{
void * V_66 = F_44 ( V_20 ) ;
int V_14 ;
for ( V_14 = 0 ; V_14 < F_211 ( V_274 ) ; V_14 ++ )
V_23 [ V_14 ] = F_213 ( ( V_276 * ) ( V_66 + V_274 [ V_14 ] . V_88 ) ) ;
}
static void F_214 ( struct V_19 * V_20 , T_6 V_277 , T_10 * V_23 )
{
int V_14 ;
switch ( V_277 ) {
case V_273 :
for ( V_14 = 0 ; V_14 < F_211 ( V_274 ) ; V_14 ++ )
memcpy ( V_23 + V_14 * V_278 ,
V_274 [ V_14 ] . V_219 , V_278 ) ;
break;
}
}
static T_12 F_215 ( struct V_136 * V_20 ,
struct V_279 * V_280 , char * V_281 )
{
struct V_19 * V_31 = F_216 ( V_20 ) ;
struct V_65 * V_30 = F_44 ( V_31 ) ;
unsigned int V_67 = V_31 -> V_68 ;
if ( V_67 )
return sprintf ( V_281 , L_64 , V_30 -> V_69 [ 0 ] . V_177 ) ;
else
return sprintf ( V_281 , L_64 , V_282 ) ;
}
static T_12 F_217 ( struct V_136 * V_20 ,
struct V_279 * V_280 ,
const char * V_281 , T_11 V_89 )
{
struct V_19 * V_31 = F_216 ( V_20 ) ;
...
unsigned int V_67 = V_31 -> V_68 ;
if ( V_67 )
return sprintf ( V_281 , L_64 , V_30 -> V_69 [ 0 ] . V_58 ) ;
else
return sprintf ( V_281 , L_64 , V_238 ) ;
}
...
unsigned int V_67 = V_31 -> V_68 ;
if ( V_67 )
return sprintf ( V_281 , L_64 , V_30 -> V_69 [ 0 ] . V_43 ) ;
else
return sprintf ( V_281 , L_65 ) ;
}
static int F_155 ( struct V_19 * V_31 )
{
int V_14 ;
int V_137 ;
for ( V_14 = 0 ; V_14 < F_211 ( V_288 ) ; V_14 ++ ) {
