...
{
struct V_48 * V_7 = F_22 ( & V_50 -> V_20 ) ;
struct V_55 * V_20 = & V_50 -> V_20 ;
struct V_1 * V_2 ;
struct V_56 * V_57 ;
struct V_58 * V_59 ;
int V_35 , V_60 ;
V_2 = F_23 ( V_20 , sizeof( * V_2 ) , V_61 ) ;
if ( ! V_2 )
return - V_62 ;
V_2 -> V_14 = F_24 ( V_20 ) ;
if ( ! V_2 -> V_14 ) {
...
V_2 -> V_7 = V_63 ;
snprintf ( V_2 -> V_14 -> V_64 , V_65 , L_10 , V_50 -> V_66 ) ;
} else {
V_2 -> V_7 = V_7 ? ( * V_7 ) : V_63 ;
snprintf ( V_2 -> V_14 -> V_64 , V_65 , L_11 ,
V_50 -> V_66 , V_50 -> V_64 ) ;
}
V_2 -> V_14 -> V_66 = F_25 ( V_20 ) ;
V_2 -> V_14 -> V_67 = F_15 ,
V_2 -> V_14 -> V_68 = F_18 ,
V_2 -> V_14 -> V_69 = F_5 ,
V_2 -> V_14 -> V_70 = V_20 ;
...
V_2 -> V_20 = V_20 ;
F_32 ( & V_2 -> V_39 ) ;
V_57 = F_33 ( V_50 , V_72 , 0 ) ;
V_2 -> V_11 = F_34 ( V_20 , V_57 ) ;
if ( F_29 ( V_2 -> V_11 ) ) {
V_35 = F_30 ( V_2 -> V_11 ) ;
goto V_71;
}
...
V_59 = V_2 -> V_14 -> V_73 [ V_60 ] ;
if ( V_59 ) {
F_8 ( V_20 , L_14 ,
V_59 -> V_60 , F_25 ( & V_59 -> V_20 ) ,
V_59 -> V_74 ? V_59 -> V_74 -> V_66 : L_15 ) ;
}
}
return 0 ;
V_71:
...
static int F_44 ( struct V_55 * V_20 )
{
struct V_1 * V_2 = F_42 ( V_20 ) ;
F_45 ( V_20 ) ;
F_27 ( V_2 -> V_20 ) ;
