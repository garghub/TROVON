...
static inline long F_13 ( T_1 V_2 , T_2 V_46 )
{
int V_47 = 16 ;
...
static inline T_1 F_14 ( T_3 V_3 , T_2 V_46 )
{
int V_47 = 16 ;
if ( V_46 == V_48 || V_46 == V_49 || V_46 == V_50 ||
V_46 == V_51 )
V_47 <<= 1 ;
return F_15 ( F_16 ( V_3 , V_47 ) , 0 , 127 ) ;
}
static T_1 F_17 ( struct V_52 * V_53 , T_1 V_2 )
{
int V_54 ;
F_18 ( 0xff , V_53 -> V_55 + V_56 ) ;
F_18 ( V_2 >> 8 , V_53 -> V_55 + V_56 ) ;
F_18 ( V_2 & 0xff , V_53 -> V_55 + V_57 ) ;
V_54 = F_19 ( V_53 -> V_55 + V_58 ) ;
return V_54 ;
}
static T_1 F_20 ( struct V_52 * V_53 , T_1 V_2 )
{
return ( F_17 ( V_53 , V_2 ) << 8 ) | F_17 ( V_53 , V_2 + 1 ) ;
}
static void F_21 ( struct V_52 * V_53 , T_1 V_2 , T_1 V_59 )
{
F_18 ( 0xff , V_53 -> V_55 + V_56 ) ;
F_18 ( V_2 >> 8 , V_53 -> V_55 + V_56 ) ;
F_18 ( V_2 & 0xff , V_53 -> V_55 + V_57 ) ;
F_18 ( V_59 & 0xff , V_53 -> V_55 + V_58 ) ;
}
static int F_22 ( struct V_52 * V_53 , int V_39 , int V_41 )
{
...
static int F_26 ( struct V_52 * V_53 , int V_39 , int V_41 )
{
...
{
struct V_52 * V_53 = F_32 ( V_10 ) ;
int V_25 ;
for ( V_25 = 0 ; V_25 < V_65 ; V_25 ++ ) {
if ( ! ( V_53 -> V_66 & ( 1 << V_25 ) ) )
continue;
V_53 -> V_67 [ V_25 ] = F_17 ( V_53 , F_33 ( V_25 ) ) ;
}
}
static struct V_52 * F_34 ( struct V_9 * V_10 )
{
struct V_52 * V_53 = F_32 ( V_10 ) ;
int V_25 , V_26 ;
F_35 ( & V_53 -> V_68 ) ;
if ( F_36 ( V_69 , V_53 -> V_70 + V_71 ) || ! V_53 -> V_72 ) {
for ( V_25 = 0 ; V_25 < V_53 -> V_73 ; V_25 ++ ) {
for ( V_26 = 0 ; V_26 < 3 ; V_26 ++ ) {
int V_2 = F_22 ( V_53 , V_26 , V_25 ) ;
if ( V_2 >= 0 )
V_53 -> V_74 [ V_26 ] [ V_25 ] =
F_17 ( V_53 , V_2 ) ;
}
...
V_53 -> V_76 [ V_25 ] = F_20 ( V_53 ,
F_23 ( V_60 ) ) ;
for ( V_26 = 0 ; V_26 < 4 ; V_26 ++ ) {
int V_2 = F_26 ( V_53 , V_26 , V_25 ) ;
if ( V_2 >= 0 )
V_53 -> V_77 [ V_26 ] [ V_25 ] =
F_17 ( V_53 , V_2 ) ;
}
}
for ( V_25 = 0 ; V_25 < F_37 ( V_53 -> V_78 ) ; V_25 ++ ) {
if ( ! ( V_53 -> V_79 & ( 1 << V_25 ) ) )
continue;
V_53 -> V_78 [ V_25 ] = F_20 ( V_53 ,
F_38 ( V_25 ) ) ;
V_53 -> V_80 [ V_25 ] = F_20 ( V_53 ,
F_39 ( V_25 ) ) ;
}
F_31 ( V_10 ) ;
V_53 -> V_70 = V_69 ;
...
static T_4
F_41 ( struct V_9 * V_10 , struct V_81 * V_35 , char * V_82 )
{
struct V_16 * V_83 = F_42 ( V_35 ) ;
struct V_52 * V_53 = F_34 ( V_10 ) ;
int V_39 = V_83 -> V_41 ;
return sprintf ( V_82 , L_1 , V_84 [ V_53 -> V_85 [ V_39 ] ] ) ;
}
static T_4
F_43 ( struct V_9 * V_10 , struct V_81 * V_35 , char * V_82 )
{
struct V_14 * V_83 = F_44 ( V_35 ) ;
struct V_52 * V_53 = F_34 ( V_10 ) ;
int V_41 = V_83 -> V_41 ;
int V_39 = V_83 -> V_39 ;
return sprintf ( V_82 , L_2 ,
F_13 ( V_53 -> V_74 [ V_41 ] [ V_39 ] , V_53 -> V_61 [ V_41 ] ) ) ;
}
static T_5 F_45 ( struct V_86 * V_87 ,
struct V_23 * V_35 , int V_41 )
{
struct V_9 * V_10 = F_46 ( V_87 , struct V_9 , V_87 ) ;
struct V_52 * V_53 = F_32 ( V_10 ) ;
int V_39 = V_41 % 4 ;
if ( ( V_39 == 2 || V_39 == 3 ) &&
V_53 -> V_62 == V_63 )
...
static T_4
F_47 ( struct V_9 * V_10 , struct V_81 * V_35 , char * V_82 )
{
struct V_16 * V_83 = F_42 ( V_35 ) ;
struct V_52 * V_53 = F_34 ( V_10 ) ;
...
static T_5 F_50 ( struct V_86 * V_87 ,
struct V_23 * V_35 , int V_41 )
{
struct V_9 * V_10 = F_46 ( V_87 , struct V_9 , V_87 ) ;
struct V_52 * V_53 = F_32 ( V_10 ) ;
...
static T_4
F_51 ( struct V_9 * V_10 , struct V_81 * V_35 , char * V_82 )
{
struct V_16 * V_83 = F_42 ( V_35 ) ;
struct V_52 * V_53 = F_34 ( V_10 ) ;
int V_39 = V_83 -> V_41 ;
...
static T_4
F_56 ( struct V_9 * V_10 , struct V_81 * V_35 , char * V_82 )
{
struct V_52 * V_53 = F_34 ( V_10 ) ;
struct V_16 * V_83 = F_42 ( V_35 ) ;
int V_39 = V_83 -> V_41 ;
return sprintf ( V_82 , L_3 , F_55 ( V_53 -> V_90 [ V_39 ] ) ) ;
}
static T_5 F_57 ( struct V_86 * V_87 ,
struct V_23 * V_35 , int V_41 )
{
struct V_9 * V_10 = F_46 ( V_87 , struct V_9 , V_87 ) ;
struct V_52 * V_53 = F_32 ( V_10 ) ;
...
V_53 -> V_62 == V_63 )
return 0 ;
if ( V_39 == 6 && F_55 ( V_53 -> V_90 [ V_77 ] ) == 0 )
return 0 ;
return V_35 -> V_42 ;
}
static T_4
F_58 ( struct V_9 * V_10 , struct V_81 * V_35 , char * V_82 )
{
struct V_52 * V_53 = F_34 ( V_10 ) ;
struct V_14 * V_83 = F_44 ( V_35 ) ;
int V_41 = V_83 -> V_41 ;
...
static T_5 F_59 ( struct V_86 * V_87 ,
struct V_23 * V_35 , int V_41 )
{
struct V_9 * V_10 = F_46 ( V_87 , struct V_9 , V_87 ) ;
struct V_52 * V_53 = F_32 ( V_10 ) ;
...
static T_4
F_60 ( struct V_9 * V_10 , struct V_81 * V_35 , char * V_82 )
{
struct V_52 * V_53 = F_32 ( V_10 ) ;
int V_91 ;
T_2 V_2 ;
...
static T_4
F_61 ( struct V_9 * V_10 , struct V_81 * V_35 ,
...
T_2 V_2 ;
int V_91 ;
if ( F_62 ( V_82 , 10 , & V_3 ) || ( V_3 != 0 && V_3 != 1 ) )
return - V_28 ;
F_35 ( & V_53 -> V_68 ) ;
V_91 = F_6 ( V_53 -> V_92 ) ;
if ( V_91 ) {
...
static T_4
F_63 ( struct V_9 * V_10 , struct V_81 * V_35 , char * V_82 )
{
struct V_52 * V_53 = F_32 ( V_10 ) ;
int V_91 ;
T_2 V_2 ;
...
static T_4
F_64 ( struct V_9 * V_10 , struct V_81 * V_35 ,
const char * V_82 , T_6 V_27 )
{
struct V_52 * V_53 = F_32 ( V_10 ) ;
unsigned long V_3 ;
...
static inline void F_65 ( struct V_52 * V_53 )
{
T_2 V_99 ;
V_99 = F_17 ( V_53 , V_100 ) ;
if ( ! ( V_99 & 0x80 ) )
F_21 ( V_53 , V_100 , V_99 | 0x80 ) ;
}
static void
...
V_2 = F_17 ( V_53 , F_67 ( V_25 ) ) ;
if ( V_2 & 0x80 )
V_53 -> V_79 |= 1 << V_25 ;
V_53 -> V_88 [ V_25 ] = V_2 ;
}
for ( V_25 = 0 ; V_25 < V_65 ; V_25 ++ ) {
V_2 = F_17 ( V_53 , F_68 ( V_25 ) ) ;
if ( V_2 & 0x80 )
V_53 -> V_66 |= 1 << V_25 ;
V_53 -> V_102 [ V_25 ] = V_2 ;
}
...
static int F_71 ( struct V_106 * V_107 )
{
...
struct V_112 * V_54 ;
int V_113 = 0 ;
V_54 = F_72 ( V_107 , V_114 , 0 ) ;
if ( ! F_73 ( V_10 , V_54 -> V_115 , V_116 , V_6 ) )
return - V_7 ;
...
struct V_52 * V_53 = F_32 ( V_10 ) ;
F_35 ( & V_53 -> V_68 ) ;
F_21 ( V_53 , V_100 , V_53 -> V_131 ) ;
V_53 -> V_72 = false ;
F_40 ( & V_53 -> V_68 ) ;
return 0 ;
}
static int T_7 F_84 ( int V_132 , struct V_108 * V_109 )
{
const char * V_133 ;
int V_55 ;
T_1 V_3 ;
...
if ( V_134 )
return V_134 ;
for ( V_25 = 0 ; V_25 < F_37 ( V_107 ) ; V_25 ++ ) {
V_147 = F_84 ( V_132 [ V_25 ] , & V_109 ) ;
if ( V_147 <= 0 )
continue;
V_146 = true ;
V_107 [ V_25 ] = F_91 ( V_6 , V_147 ) ;
if ( ! V_107 [ V_25 ] ) {
V_134 = - V_31 ;
goto V_149;
}
V_134 = F_92 ( V_107 [ V_25 ] , & V_109 ,
sizeof( struct V_108 ) ) ;
if ( V_134 )
goto V_150;
...
V_134 = F_95 ( V_107 [ V_25 ] , & V_54 , 1 ) ;
if ( V_134 )
goto V_150;
V_134 = F_96 ( V_107 [ V_25 ] ) ;
if ( V_134 )
goto V_150;
}
if ( ! V_146 ) {
