...
F_87 ( V_23 , V_162 , V_272 , V_23 -> V_242 ) ;
}
...
int V_19 ;
V_23 -> V_273 = V_242 ;
V_23 -> V_274 = ( V_242 & V_268 ) ? 1 : 0 ;
V_23 -> V_229 = ! V_23 -> V_274 ;
F_87 ( V_23 , V_162 , V_275 , V_23 -> V_273 ) ;
F_13 ( & V_23 -> V_43 ) ;
for ( V_19 = 0 ; V_19 < 4 ; V_19 ++ ) {
F_14 ( & V_23 -> V_276 , & V_35 ,
V_277 ) ;
if ( ( F_93 ( V_278 ) >> 16 ) < 100 )
break;
F_94 ( F_95 ( 25 ) ) ;
}
F_18 ( & V_23 -> V_276 , & V_35 ) ;
F_19 ( & V_23 -> V_43 ) ;
if ( V_19 == 4 )
F_96 ( L_10 ) ;
F_8 ( V_23 , V_279 , 1 , V_23 -> V_229 ) ;
V_23 -> V_126 . V_150 = 0 ;
V_23 -> V_126 . V_149 = 0 ;
...
static int F_98 ( struct V_88 * V_88 , void * V_89 , const struct V_282 * V_283 )
{
struct V_55 * V_56 = F_30 ( V_89 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
if ( V_283 -> V_209 != 0 )
return - V_65 ;
F_87 ( V_23 , V_264 , V_284 , V_283 ) ;
return 0 ;
}
static int F_99 ( struct V_88 * V_88 , void * V_89 , struct V_282 * V_283 )
{
struct V_22 * V_23 = F_30 ( V_89 ) -> V_23 ;
if ( V_283 -> V_209 != 0 )
return - V_65 ;
F_87 ( V_23 , V_264 , V_285 , V_283 ) ;
if ( V_283 -> type == V_286 )
F_58 ( V_283 -> V_287 , L_12 , sizeof( V_283 -> V_287 ) ) ;
else
F_58 ( V_283 -> V_287 , L_13 , sizeof( V_283 -> V_287 ) ) ;
return 0 ;
}
static int F_100 ( struct V_88 * V_88 , void * V_89 , struct V_288 * V_289 )
{
struct V_22 * V_23 = F_30 ( V_89 ) -> V_23 ;
...
V_289 -> V_21 [ V_19 ] [ V_20 ] = V_11 ;
}
}
} else if ( V_289 -> type == V_290 ) {
if ( ! ( V_23 -> V_63 & V_94 ) )
return - V_65 ;
if ( V_23 -> V_97 ) {
V_289 -> V_21 [ 0 ] [ 21 ] = V_3 ;
...
for ( V_19 = 0 ; V_19 < 2 ; V_19 ++ )
for ( V_20 = 0 ; V_20 < 24 ; V_20 ++ )
V_11 |= V_289 -> V_21 [ V_19 ] [ V_20 ] ;
V_289 -> V_18 = V_11 ;
return 0 ;
}
static int F_101 ( struct V_88 * V_88 , void * V_89 , struct V_291 * V_292 )
{
struct V_22 * V_23 = F_30 ( V_89 ) -> V_23 ;
struct V_293 * V_294 = V_292 -> V_295 ;
int V_296 ;
int V_15 ;
V_296 = ( V_23 -> V_297 + V_298 - V_23 -> V_299 ) %
V_298 ;
if ( V_296 > V_300 )
V_296 = V_300 ;
V_292 -> V_296 = 0 ;
...
if ( ! F_12 ( & V_23 -> V_157 ) )
return 0 ;
for ( V_15 = 0 ; V_15 < V_296 ; V_15 ++ ) {
* V_294 = V_23 -> V_302 [ ( V_23 -> V_299 + V_15 ) % V_298 ] ;
if ( ( V_294 -> V_68 & V_303 ) <= V_304 ) {
V_292 -> V_296 ++ ;
V_294 ++ ;
}
}
V_23 -> V_299 = ( V_23 -> V_299 + V_292 -> V_296 ) % V_298 ;
return 0 ;
}
static int F_102 ( struct V_88 * V_88 , void * V_89 , struct V_305 * V_306 )
{
struct V_55 * V_56 = F_30 ( V_89 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
switch ( V_306 -> V_66 ) {
...
if ( ! F_12 ( & V_23 -> V_157 ) )
return - V_86 ;
if ( ! F_25 ( V_311 , & V_23 -> V_47 ) )
return 0 ;
F_8 ( V_23 , V_312 , 1 , 1 ) ;
F_82 ( V_23 ) ;
break;
default:
F_103 ( L_18 , V_306 -> V_66 ) ;
return - V_65 ;
}
return 0 ;
}
static int F_107 ( struct V_88 * V_88 , void * V_89 , struct V_305 * V_306 )
{
struct V_22 * V_23 = F_30 ( V_89 ) -> V_23 ;
switch ( V_306 -> V_66 ) {
case V_307 :
...
static int F_108 ( struct V_88 * V_88 , void * V_89 , struct V_314 * V_315 )
{
struct V_22 * V_23 = F_30 ( V_89 ) -> V_23 ;
T_2 V_32 [ V_33 ] ;
struct V_170 * V_171 = & V_23 -> V_128 ;
...
V_331 ;
F_109 ( V_23 , V_32 , V_332 , 0 ) ;
V_32 [ 0 ] |= ( F_93 ( 0x2a00 ) >> 7 ) & 0x40 ;
V_99 = ( V_32 [ 0 ] >> 3 ) & 0xf ;
V_315 -> V_17 . V_108 = V_316 [ V_99 ] ;
V_315 -> V_17 . V_101 = V_23 -> V_151 . V_101 ;
V_315 -> V_17 . V_102 = V_23 -> V_151 . V_102 ;
V_315 -> V_17 . V_9 = V_105 ;
V_315 -> V_17 . V_111 = V_315 -> V_17 . V_101 ;
V_315 -> V_17 . V_103 = V_104 ;
V_315 -> V_17 . V_9 = V_105 ;
V_315 -> V_17 . V_106 = 0 ;
if ( V_315 -> V_17 . V_108 != V_317 )
V_315 -> V_17 . V_111 *= 2 ;
if ( V_315 -> V_17 . V_108 == V_321 ||
V_315 -> V_17 . V_108 == V_325 )
V_315 -> V_17 . V_111 *= 2 ;
V_315 -> V_17 . V_110 = V_315 -> V_17 . V_111 * V_315 -> V_17 . V_102 ;
V_315 -> V_333 = ( void * ) V_23 -> V_327 ;
V_315 -> V_68 = 0 ;
if ( V_23 -> V_29 )
V_315 -> V_68 |= V_334 ;
if ( V_23 -> V_25 )
...
static int F_110 ( struct V_88 * V_88 , void * V_89 , const struct V_314 * V_315 )
{
struct V_55 * V_56 = F_30 ( V_89 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
struct V_170 * V_171 = & V_23 -> V_128 ;
...
if ( ! V_23 -> V_327 )
return - V_65 ;
V_23 -> V_25 = ( V_315 -> V_68 & V_335 ) != 0 ;
V_23 -> V_27 =
( V_315 -> V_68 & ( V_340 | V_339 ) ) != 0 ;
V_23 -> V_29 = ( V_315 -> V_68 & V_334 ) != 0 ;
F_7 ( V_23 ) ;
V_171 -> V_226 = ( V_315 -> V_68 & V_336 ) != 0 ;
return 0 ;
}
static int F_111 ( struct V_88 * V_88 , void * V_89 , unsigned int V_341 )
{
struct V_55 * V_56 = F_30 ( V_89 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
if ( ! ( V_23 -> V_63 & V_326 ) )
return - V_65 ;
F_8 ( V_23 , V_342 , 1 , V_341 != 0 ) ;
return 0 ;
}
static int F_112 ( struct V_343 * V_89 , const struct V_344 * V_345 )
{
switch ( V_345 -> type ) {
case V_346 :
case V_347 :
return F_113 ( V_89 , V_345 , 0 , NULL ) ;
case V_348 :
return F_113 ( V_89 , V_345 , 0 , & V_349 ) ;
default:
return - V_65 ;
}
}
...
struct V_22 * V_23 = F_30 ( V_89 ) -> V_23 ;
T_2 V_32 [ V_33 ] ;
int V_350 = V_23 -> V_63 & V_64 ;
struct V_215 V_351 ;
struct V_207 V_352 ;
int V_15 ;
F_115 ( L_19 , V_353 , V_23 -> V_200 ) ;
if ( V_23 -> V_269 & V_354 ) {
struct V_355 V_356 ;
F_116 ( V_23 , & V_356 ) ;
}
F_87 ( V_23 , V_357 , V_358 ) ;
F_70 ( V_23 , V_23 -> V_240 , & V_351 ) ;
F_61 ( V_23 , V_23 -> V_210 , & V_352 ) ;
F_115 ( L_20 , V_351 . V_287 ) ;
F_115 ( L_21 , V_352 . V_287 ,
