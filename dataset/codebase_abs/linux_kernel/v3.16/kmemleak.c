...
static void F_99 ( void * V_95 , void * V_96 ,
struct V_3 * V_97 , int V_98 )
{
unsigned long * V_5 ;
unsigned long * V_67 = F_100 ( V_95 , V_99 ) ;
...
F_106 (area, &object->area_list, node)
F_99 ( ( void * ) V_47 -> V_67 ,
...
{
struct V_3 * V_4 , * V_45 ;
V_4 = F_108 ( V_62 . V_102 , F_109 ( * V_4 ) , V_62 ) ;
while ( & V_4 -> V_62 != & V_62 ) {
F_101 () ;
if ( ! F_96 () )
F_104 ( V_4 ) ;
V_45 = F_108 ( V_4 -> V_62 . V_102 , F_109 ( * V_4 ) ,
V_62 ) ;
F_110 ( & V_4 -> V_62 ) ;
F_24 ( V_4 ) ;
V_4 = V_45 ;
...
F_99 ( V_106 , V_107 , NULL , 1 ) ;
#ifdef F_114
F_80 (i)
F_99 ( V_108 + F_115 ( V_7 ) ,
V_109 + F_115 ( V_7 ) , NULL , 1 ) ;
#endif
F_116 () ;
F_117 (i) {
unsigned long V_110 = F_118 ( V_7 ) ;
unsigned long V_111 = F_119 ( V_7 ) ;
unsigned long V_112 ;
...
static void * F_140 ( struct V_1 * V_2 , T_7 * V_129 )
{
struct V_3 * V_4 ;
T_7 V_130 = * V_129 ;
int V_131 ;
...
static void * F_143 ( struct V_1 * V_2 , void * V_132 , T_7 * V_129 )
{
struct V_3 * V_133 = V_132 ;
struct V_3 * V_134 = NULL ;
struct V_3 * V_135 = V_133 ;
++ ( * V_129 ) ;
F_144 (obj, &object_list, object_list) {
if ( F_17 ( V_135 ) ) {
V_134 = V_135 ;
break;
}
...
static void F_145 ( struct V_1 * V_2 , void * V_132 )
{
if ( ! F_78 ( V_132 ) ) {
F_32 () ;
F_134 ( & V_127 ) ;
...
static int F_146 ( struct V_1 * V_2 , void * V_132 )
{
...
static int F_147 ( struct V_136 * V_136 , struct V_137 * V_137 )
{
return F_148 ( V_137 , & V_138 ) ;
}
static int F_149 ( const char * V_139 )
{
unsigned long V_21 ;
struct V_3 * V_4 ;
unsigned long V_140 ;
if ( F_150 ( V_139 , 0 , & V_140 ) )
return - V_141 ;
V_4 = F_28 ( V_140 , 0 ) ;
if ( ! V_4 ) {
F_129 ( L_42 , V_140 ) ;
...
static T_8 F_152 ( struct V_137 * V_137 , const char T_9 * V_142 ,
V_13 V_12 , T_7 * V_143 )
{
char V_144 [ 64 ] ;
int V_145 ;
...
unsigned long V_149 ;
V_146 = F_150 ( V_144 + 5 , 0 , & V_149 ) ;
if ( V_146 < 0 )
goto V_66;
F_138 () ;
if ( V_149 ) {
V_126 = F_155 ( V_149 * 1000 ) ;
F_136 () ;
}
...
static void F_156 ( struct V_150 * V_151 )
{
F_133 ( & V_127 ) ;
F_138 () ;
if ( ! V_121 )
...
static void T_3 F_160 ( struct V_76 * log )
{
struct V_31 V_30 ;
V_30 . V_32 = log -> V_29 ;
V_30 . V_33 = log -> V_30 ;
...
#endif
V_24 = F_155 ( V_155 ) ;
V_126 = F_155 ( V_156 * 1000 ) ;
V_50 = F_163 ( V_3 , V_157 ) ;
V_49 = F_163 ( V_46 , V_157 ) ;
if ( V_78 >= F_74 ( V_76 ) )
F_38 ( L_57
L_58 , V_78 ) ;
F_75 ( V_21 ) ;
...
V_159 = F_165 ( L_40 , V_161 , NULL , NULL ,
& V_162 ) ;
if ( ! V_159 )
F_38 ( L_60 ) ;
F_133 ( & V_127 ) ;
