...
{
struct V_9 * V_9 = V_101 -> V_103 ;
int error ;
error = F_62 ( F_36 ( V_9 ) ) ;
if ( F_14 ( error ) )
return error ;
error = F_86 ( V_9 , V_102 ) ;
if ( F_14 ( error ) )
return error ;
if ( ( V_102 -> V_104 & V_105 ) &&
V_102 -> V_106 != F_41 ( V_9 ) ) {
error = F_82 ( V_9 , V_102 -> V_106 ) ;
if ( F_14 ( error ) )
return error ;
}
F_87 ( V_9 , V_102 ) ;
...
static int F_88 ( struct V_107 * V_108 , struct V_44 * V_45 ,
struct V_109 * V_9 )
{
struct V_10 * V_11 = V_108 -> V_13 ;
struct V_110 V_111 [] = {
[ 0 ] = V_112 ,
[ 1 ] = V_113 ,
[ 2 ] = V_114 ,
...
V_111 [ 1 ] . V_24 = F_90 ( V_11 -> V_47 . V_117 ) ;
V_111 [ 2 ] . V_24 = F_90 ( V_11 -> V_47 . V_117 ) ;
V_14 -> V_118 = V_111 ;
V_14 -> V_119 = F_91 ( V_111 ) ;
V_25 = F_38 ( V_14 ) ;
if ( F_14 ( V_25 ) ) {
F_9 ( L_52 ,
F_28 ( V_45 -> V_120 . V_121 . V_122 ) , V_25 ) ;
memset ( V_9 , 0 , sizeof( * V_9 ) ) ;
V_9 -> V_95 = 0040000 | ( 0777 & ~ 022 ) ;
V_25 = 0 ;
goto V_87;
}
V_25 = F_92 ( V_14 , & V_111 [ 0 ] ) ;
if ( V_25 ) {
F_9 ( L_53 , V_116 ) ;
goto V_87;
}
F_77 ( V_111 [ 0 ] . V_24 != V_123 ) ;
memcpy ( V_9 , V_111 [ 0 ] . V_124 , V_123 ) ;
V_25 = F_92 ( V_14 , & V_111 [ 1 ] ) ;
if ( V_25 ) {
F_9 ( L_54 , V_116 ) ;
goto V_87;
}
...
struct V_9 * F_96 ( struct V_107 * V_108 , unsigned long V_130 )
{
struct V_44 * V_45 ;
struct V_109 V_131 ;
struct V_9 * V_9 ;
int V_25 ;
V_9 = F_97 ( V_108 , V_130 ) ;
if ( ! V_9 )
return F_98 ( - V_23 ) ;
if ( ! ( V_9 -> V_132 & V_133 ) )
return V_9 ;
V_45 = F_36 ( V_9 ) ;
F_94 ( V_45 ) ;
F_99 ( & V_45 -> V_47 , & V_45 -> V_120 , V_108 -> V_13 ,
F_100 ( V_45 ) ) ;
V_25 = F_88 ( V_108 , V_45 , & V_131 ) ;
if ( V_25 )
goto V_134;
F_101 ( V_45 ) ;
V_9 -> V_95 = F_102 ( V_131 . V_95 ) ;
F_103 ( V_9 , F_104 ( V_131 . V_135 ) ) ;
F_105 ( V_9 , F_104 ( V_131 . V_136 ) ) ;
F_106 ( V_9 , F_102 ( V_131 . V_137 ) ) ;
V_9 -> V_99 . V_138 = ( signed ) F_104 ( V_131 . V_99 ) ;
V_9 -> V_139 . V_138 = ( signed ) F_104 ( V_131 . V_139 ) ;
V_9 -> V_98 . V_138 = ( signed ) F_104 ( V_131 . V_98 ) ;
V_9 -> V_99 . V_140 =
V_9 -> V_139 . V_140 = V_9 -> V_98 . V_140 = 0 ;
V_45 -> V_141 = F_107 ( V_131 . V_54 ) ;
F_108 ( V_9 , V_45 -> V_141 ) ;
V_9 -> V_142 = V_143 ;
V_9 -> V_144 = F_104 ( V_131 . V_144 ) ;
V_45 -> V_145 = 0 ;
if ( ( V_9 -> V_146 == 0 ) && ( V_9 -> V_95 == 0 ) ) {
V_25 = - V_147 ;
goto V_134;
}
if ( F_109 ( V_9 -> V_95 ) || F_110 ( V_9 -> V_95 ) ) {
if ( V_131 . V_96 [ 0 ] )
V_9 -> V_148 =
F_111 ( F_104 ( V_131 . V_96 [ 0 ] ) ) ;
else
V_9 -> V_148 =
F_112 ( F_104 ( V_131 . V_96 [ 1 ] ) ) ;
} else {
memcpy ( V_45 -> V_96 , V_131 . V_96 , sizeof( V_131 . V_96 ) ) ;
}
V_9 -> V_65 -> V_149 = V_108 -> V_150 ;
if ( F_113 ( V_9 -> V_95 ) ) {
V_9 -> V_151 = & V_152 ;
V_9 -> V_153 = & V_154 ;
V_9 -> V_65 -> V_155 = & V_156 ;
} else if ( F_114 ( V_9 -> V_95 ) ) {
V_9 -> V_151 = & V_157 ;
V_9 -> V_153 = & V_158 ;
V_9 -> V_65 -> V_155 = & V_156 ;
...
F_20 ( L_58 ) ;
F_34 ( ! F_119 ( V_45 ) ) ;
F_120 ( V_45 -> V_128 , F_44 ( V_45 ) ) ;
F_20 ( L_59 ) ;
}
return F_14 ( F_121 ( & V_45 -> V_162 ) ) ? - V_163 : 0 ;
}
...
F_9 ( L_60 ,
F_28 ( F_100 ( V_45 ) ) ,
F_28 ( V_45 -> V_120 . V_121 . V_164 ) ) ;
}
F_101 ( V_45 ) ;
F_123 ( & V_45 -> V_128 ) ;
}
struct V_9 * F_124 ( struct V_9 * V_165 , T_7 V_166 )
{
struct V_107 * V_108 = V_165 -> V_12 ;
struct V_10 * V_11 = V_108 -> V_13 ;
struct V_9 * V_9 ;
struct V_44 * V_45 ;
struct V_35 * V_14 ;
...
F_126 ( V_45 ) ;
V_9 -> V_65 -> V_149 = V_108 -> V_150 ;
F_127 ( V_9 , V_165 , V_166 ) ;
V_9 -> V_31 = V_11 -> V_167 ++ ;
V_9 -> V_142 = V_143 ;
V_9 -> V_98 = V_9 -> V_139 = V_9 -> V_99 = V_100 ;
V_45 -> V_141 = V_9 -> V_54 = 0 ;
F_128 ( & V_11 -> V_168 ) ;
V_9 -> V_144 = V_11 -> V_169 ++ ;
F_129 ( & V_11 -> V_168 ) ;
F_130 ( V_9 ) ;
F_99 ( & V_45 -> V_47 , & V_45 -> V_120 , V_108 -> V_13 ,
F_100 ( V_45 ) ) ;
...
{
struct V_170 * args = V_36 ;
F_12 ( V_14 ) ;
F_31 ( & args -> V_11 -> V_37 ) ;
F_11 ( args ) ;
}
static int F_134 ( struct V_9 * V_9 , int V_171 )
{
struct V_44 * V_45 = F_36 ( V_9 ) ;
struct V_107 * V_108 = V_9 -> V_12 ;
struct V_10 * V_11 = V_108 -> V_13 ;
struct V_35 * V_14 ;
struct V_110 V_172 ;
struct V_109 * V_131 ;
...
V_131 = & args -> V_131 ;
V_131 -> V_95 = F_93 ( V_9 -> V_95 ) ;
V_131 -> V_135 = F_136 ( F_137 ( V_9 ) ) ;
V_131 -> V_136 = F_136 ( F_138 ( V_9 ) ) ;
V_131 -> V_137 = F_93 ( V_9 -> V_146 ) ;
V_131 -> V_99 = F_136 ( V_9 -> V_99 . V_138 ) ;
V_131 -> V_139 = F_136 ( V_9 -> V_139 . V_138 ) ;
V_131 -> V_98 = F_136 ( V_9 -> V_98 . V_138 ) ;
V_45 -> V_141 = F_41 ( V_9 ) ;
V_131 -> V_54 = F_139 ( V_45 -> V_141 ) ;
V_131 -> V_144 = F_136 ( V_9 -> V_144 ) ;
if ( F_109 ( V_9 -> V_95 ) || F_110 ( V_9 -> V_95 ) ) {
if ( F_140 ( V_9 -> V_148 ) ) {
V_131 -> V_96 [ 0 ] =
F_136 ( F_141 ( V_9 -> V_148 ) ) ;
V_131 -> V_96 [ 1 ] = 0 ;
} else {
V_131 -> V_96 [ 0 ] = 0 ;
V_131 -> V_96 [ 1 ] =
F_136 ( F_142 ( V_9 -> V_148 ) ) ;
V_131 -> V_96 [ 2 ] = 0 ;
}
} else
memcpy ( V_131 -> V_96 , V_45 -> V_96 , sizeof( V_131 -> V_96 ) ) ;
V_25 = F_89 ( & V_11 -> V_2 , & V_45 -> V_47 , & V_14 ) ;
if ( F_14 ( V_25 ) ) {
F_9 ( L_51 , V_116 ) ;
goto V_173;
