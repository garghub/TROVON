...
void F_16 ( struct V_12 * V_13 , struct V_8 * V_9 )
{
struct V_12 * V_15 ;
struct V_1 * V_16 = & V_9 -> V_11 ;
F_4 ( V_9 ) ;
...
static void T_1 F_23 ( struct V_12 * V_13 )
{
F_16 ( V_13 , & V_22 ) ;
if ( V_13 != F_18 ( & V_22 ) )
F_17 ( V_13 -> V_18 == F_19 ( V_13 ) -> V_18 ) ;
}
static int T_1 F_24 ( void )
{
int V_19 = 0 , V_23 , V_24 ;
unsigned int V_25 = F_25 () ;
F_26 ( V_26 L_4 ) ;
F_27 ( & V_22 ) ;
for ( V_23 = 0 ; V_23 < F_28 ( V_27 ) ; V_23 ++ )
F_29 ( V_27 + V_23 , 0 ) ;
