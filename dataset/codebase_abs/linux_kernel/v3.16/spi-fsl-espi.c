...
return - V_52 ;
if ( ! V_7 ) {
V_7 = F_38 ( & V_2 -> V_39 , sizeof( * V_7 ) , V_72 ) ;
if ( ! V_7 )
return - V_73 ;
V_2 -> V_8 = V_7 ;
}
...
void F_39 ( struct V_3 * V_4 , T_3 V_91 )
{
struct V_9 * V_10 = V_4 -> V_10 ;
if ( V_91 & V_92 ) {
T_3 V_93 , V_15 ;
T_5 V_94 ;
while ( F_40 ( V_91 ) < F_41 ( 4 , V_4 -> V_40 ) ) {
F_42 () ;
V_91 = F_4 ( & V_10 -> V_95 ) ;
}
if ( V_4 -> V_40 >= 4 ) {
...
static T_6 F_45 ( T_7 V_98 , void * V_99 )
{
struct V_3 * V_4 = V_99 ;
struct V_9 * V_10 = V_4 -> V_10 ;
T_6 V_46 = V_100 ;
...
static struct V_103 * F_49 ( struct V_104 * V_39 ,
struct V_105 * V_106 , unsigned int V_98 )
{
struct V_107 * V_108 = F_50 ( V_39 ) ;
struct V_103 * V_5 ;
struct V_3 * V_3 ;
struct V_9 * V_10 ;
struct V_109 * V_110 ;
...
V_5 = F_51 ( V_39 , sizeof( struct V_3 ) ) ;
if ( ! V_5 ) {
V_46 = - V_73 ;
goto V_113;
}
F_52 ( V_39 , V_5 ) ;
V_46 = F_53 ( V_39 , V_106 , V_98 ) ;
if ( V_46 )
goto V_114;
V_5 -> V_115 = F_54 ( 4 , 16 ) ;
V_5 -> V_116 = F_37 ;
...
V_3 -> V_117 = F_36 ;
V_3 -> V_118 = F_47 ;
V_3 -> V_10 = F_55 ( V_106 -> V_119 , F_56 ( V_106 ) ) ;
if ( ! V_3 -> V_10 ) {
V_46 = - V_73 ;
goto V_114;
}
V_10 = V_3 -> V_10 ;
V_46 = F_57 ( V_3 -> V_98 , F_45 ,
0 , L_8 , V_3 ) ;
if ( V_46 )
goto V_120;
if ( V_3 -> V_16 & V_121 ) {
...
F_58 (master->dev.of_node, nc) {
V_111 = F_59 ( V_110 , L_9 , & V_40 ) ;
if ( ! V_111 || V_40 < sizeof( * V_111 ) )
continue;
V_71 = F_60 ( V_111 ) ;
if ( V_71 < 0 || V_71 >= V_108 -> V_122 )
continue;
V_12 = V_123 ;
V_111 = F_59 ( V_110 , L_10 , & V_40 ) ;
if ( V_111 && V_40 >= sizeof( * V_111 ) ) {
V_12 &= ~ ( F_61 ( 0xf ) ) ;
V_12 |= F_61 ( F_60 ( V_111 ) ) ;
}
V_111 = F_59 ( V_110 , L_11 , & V_40 ) ;
if ( V_111 && V_40 >= sizeof( * V_111 ) ) {
V_12 &= ~ ( F_62 ( 0xf ) ) ;
V_12 |= F_62 ( F_60 ( V_111 ) ) ;
}
F_5 ( & V_10 -> V_12 [ V_71 ] , V_12 ) ;
F_63 ( V_39 , L_12 , V_71 , V_12 ) ;
}
V_112 = V_108 -> V_124 | V_125 | V_17 ;
F_5 ( & V_10 -> V_11 , V_112 ) ;
V_46 = F_64 ( V_5 ) ;
if ( V_46 < 0 )
goto V_126;
F_63 ( V_39 , L_13 , V_10 , V_3 -> V_98 ) ;
return V_5 ;
V_126:
V_120 ( V_3 -> V_98 , V_3 ) ;
V_120:
...
static int F_67 ( struct V_104 * V_39 )
{
struct V_109 * V_127 = V_39 -> V_128 ;
struct V_107 * V_108 = F_50 ( V_39 ) ;
const T_3 * V_111 ;
int V_40 ;
V_111 = F_59 ( V_127 , L_14 , & V_40 ) ;
if ( ! V_111 || V_40 < sizeof( * V_111 ) ) {
F_19 ( V_39 , L_15 ) ;
return - V_52 ;
}
...
struct V_109 * V_127 = V_131 -> V_39 . V_128 ;
struct V_103 * V_5 ;
struct V_105 V_106 ;
unsigned int V_98 ;
int V_46 = - V_73 ;
...
static int F_74 ( struct V_130 * V_39 )
{
return F_75 ( & V_39 -> V_39 ) ;
}
static int F_76 ( struct V_104 * V_39 )
{
struct V_103 * V_5 = F_77 ( V_39 ) ;
struct V_3 * V_3 ;
struct V_9 * V_10 ;
T_3 V_112 ;
int V_46 ;
...
static int F_80 ( struct V_104 * V_39 )
{
struct V_107 * V_108 = F_50 ( V_39 ) ;
struct V_103 * V_5 = F_77 ( V_39 ) ;
struct V_3 * V_3 ;
...
F_5 ( & V_10 -> V_53 , 0 ) ;
F_5 ( & V_10 -> V_95 , 0xffffffff ) ;
for ( V_71 = 0 ; V_71 < V_108 -> V_122 ; V_71 ++ )
F_5 ( & V_10 -> V_12 [ V_71 ] , V_123 ) ;
V_112 = V_108 -> V_124 | V_125 | V_17 ;
F_5 ( & V_10 -> V_11 , V_112 ) ;
return F_81 ( V_5 ) ;
}
