...
{
if ( V_94 -> V_187 -> V_201 == F_20 )
return 1 ;
return 0 ;
}
static int F_128 ( struct V_5 * V_6 , struct V_202 * V_203 )
{
V_203 -> V_204 = 0 ;
V_203 -> V_205 = 0 ;
F_129 ( V_203 , V_206 ) ;
...
struct V_218 * V_219 )
{
F_131 ( V_219 -> V_220 , L_4 , sizeof( V_219 -> V_220 ) ) ;
F_131 ( V_219 -> V_86 , V_221 , sizeof( V_219 -> V_86 ) ) ;
F_131 ( V_219 -> V_222 , L_5 , sizeof( V_219 -> V_222 ) ) ;
F_131 ( V_219 -> V_223 , L_6 , sizeof( V_219 -> V_223 ) ) ;
}
static T_5 F_132 ( struct V_5 * V_6 )
{
return - V_224 ;
}
static void F_133 ( struct V_5 * V_6 , T_5 V_225 )
{
}
...
static void F_135 ( struct V_5 * V_6 , T_3 V_226 ,
T_1 * V_85 )
{
if ( V_226 == V_227 )
memcpy ( V_85 , V_228 ,
...
struct V_8 * V_9 = F_9 ( V_6 ) ;
int V_230 ;
for ( V_230 = 0 ; V_230 < V_141 ; V_230 ++ )
V_85 [ V_230 ] = F_10 ( V_9 , V_230 ) ;
}
static int F_137 ( struct V_5 * V_6 , int V_226 )
{
if ( V_226 == V_227 )
return V_141 ;
return - V_224 ;
