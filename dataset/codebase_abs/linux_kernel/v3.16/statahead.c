...
V_158 -> V_161 = F_103 () ;
F_27 ( V_38 , L_14 ,
V_9 , V_65 -> V_162 . V_33 , V_65 -> V_162 . V_32 ) ;
F_32 ( & V_156 -> V_163 ) ;
F_7 ( & V_153 -> V_67 ) ;
V_9 -> V_17 = 1 ;
if ( F_104 ( V_158 ) )
...
static void F_107 ( struct V_147 * V_65 , struct V_8 * V_9 )
{
struct V_157 * V_158 = & V_9 -> V_69 ;
struct V_159 V_160 = { 0 } ;
struct V_21 * V_153 ;
...
V_168 = F_108 ( F_102 , V_65 ,
L_17 , V_153 -> V_80 ) ;
if ( F_92 ( V_168 ) ) {
F_109 ( L_18 , F_93 ( V_168 ) ) ;
F_105 ( V_158 , V_166 ) ;
return;
}
F_106 ( V_158 -> V_70 ,
...
V_178 = F_113 ( V_170 ) ;
for ( V_180 = F_114 ( V_178 ) ; V_180 != NULL ;
V_180 = F_115 ( V_180 ) ) {
T_1 V_12 ;
int V_181 ;
char * V_32 ;
V_12 = F_116 ( V_180 -> V_182 ) ;
if ( F_25 ( V_12 < V_58 ) )
continue;
V_181 = F_117 ( V_180 -> V_183 ) ;
if ( F_25 ( V_181 == 0 ) )
continue;
V_32 = V_180 -> V_184 ;
if ( V_32 [ 0 ] == '.' ) {
...
V_189:
F_99 ( V_65 , V_32 , V_181 ) ;
}
V_58 = F_116 ( V_178 -> V_190 ) ;
if ( V_58 == V_191 ) {
F_118 ( V_170 , 0 ) ;
while ( 1 ) {
F_106 ( V_158 -> V_70 ,
...
F_118 ( V_170 , F_119 ( V_178 -> V_192 ) &
V_193 ) ;
V_170 = F_112 ( V_88 , V_58 , & V_173 ) ;
} else {
F_36 ( F_119 ( V_178 -> V_192 ) & V_193 ) ;
F_118 ( V_170 , 1 ) ;
}
}
V_96:
...
F_56 ( & V_169 -> V_70 ) ;
F_27 ( V_38 , L_24 ,
V_9 , ( unsigned int ) V_169 -> V_161 ) ;
F_106 ( V_169 -> V_70 ,
F_64 ( V_169 ) ,
& V_160 ) ;
} else {
F_105 ( & V_9 -> V_69 , V_166 ) ;
}
F_120 ( & V_173 ) ;
F_7 ( & V_153 -> V_44 ) ;
if ( ! F_19 ( V_9 ) ) {
...
void F_121 ( struct V_15 * V_88 , void * V_195 )
{
struct V_21 * V_34 = F_30 ( V_88 ) ;
if ( F_25 ( V_195 == NULL ) )
return;
...
static int F_122 ( struct V_15 * V_88 , struct V_147 * V_147 )
{
struct V_172 V_173 ;
struct V_47 * V_196 = & V_147 -> V_162 ;
struct V_170 * V_170 ;
T_1 V_58 = 0 ;
int V_197 ;
int V_85 = V_198 ;
...
struct V_21 * V_34 = F_30 ( V_88 ) ;
V_85 = F_93 ( V_170 ) ;
F_109 ( L_20 V_83 L_21 V_39 L_27
L_28 ,
F_65 ( F_79 ( V_88 ) ) , V_58 ,
V_85 , V_34 -> V_80 ) ;
break;
...
if ( V_196 -> V_33 != V_181 ||
memcmp ( V_196 -> V_32 , V_32 , V_181 ) != 0 )
V_85 = V_198 ;
else if ( ! V_197 )
V_85 = V_199 ;
else
...
int F_125 ( struct V_15 * V_88 , struct V_147 * * V_204 ,
int V_205 )
{
struct V_21 * V_34 = F_30 ( V_88 ) ;
struct V_8 * V_9 = V_34 -> V_79 ;
...
( * V_204 ) -> V_162 . V_33 , ( * V_204 ) -> V_162 . V_32 ,
