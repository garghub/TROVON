...
int F_36 ( struct V_1 * V_2 , struct V_63 * V_64 )
{
int V_48 = 0 ;
V_48 = F_32 ( V_2 -> V_57 , V_65 , V_64 ) ;
if ( V_48 ) {
F_2 ( L_24 ) ;
goto V_19;
}
...
F_25 ( 2 , L_27 , V_64 -> V_72 ) ;
return V_48 ;
V_71:
if ( V_64 -> type == V_66 )
F_32 ( V_2 -> V_57 , V_73 , V_64 ) ;
V_68:
F_32 ( V_2 -> V_57 , V_74 , V_64 ) ;
V_19:
return V_48 ;
}
void F_40 ( struct V_1 * V_2 , struct V_63 * V_64 )
{
V_64 -> V_75 = V_76 ;
F_37 ( V_64 ) ;
F_38 ( V_64 ) ;
