...
void F_52 ( unsigned int V_51 , unsigned int V_37 )
{
int V_38 ;
if ( V_51 >= V_43 || ( V_51 + V_37 ) > V_43 )
return;
for ( V_38 = 0 ; V_38 < V_37 ; V_38 ++ )
F_31 ( V_51 + V_38 ) ;
F_33 ( & V_35 ) ;
...
int T_4
F_53 ( int V_11 , unsigned int V_51 , unsigned int V_37 , int V_6 ,
struct V_12 * V_13 )
{
int V_36 , V_52 ;
if ( ! V_37 )
...
unsigned int F_56 ( int V_37 , int V_6 )
{
int V_38 , V_11 = F_53 ( - 1 , 0 , V_37 , V_6 , NULL ) ;
if ( V_11 < 0 )
return 0 ;
...
void F_61 ( unsigned int V_51 , int V_37 )
{
int V_38 , V_56 ;
for ( V_38 = V_51 , V_56 = V_37 ; V_56 > 0 ; V_38 ++ , V_56 -- ) {
F_59 ( V_38 , V_54 | V_55 ) ;
F_60 ( V_38 ) ;
}
F_52 ( V_51 , V_37 ) ;
}
unsigned int F_62 ( unsigned int V_57 )
{
return F_63 ( V_40 , V_43 , V_57 ) ;
}
struct V_3 *
F_64 ( unsigned int V_11 , unsigned long * V_49 , bool V_58 ,
unsigned int V_59 )
{
struct V_3 * V_4 = F_19 ( V_11 ) ;
if ( V_4 ) {
...
void F_67 ( struct V_3 * V_4 , unsigned long V_49 , bool V_58 )
{
F_46 ( & V_4 -> V_33 , V_49 ) ;
if ( V_58 )
F_68 ( V_4 ) ;
}
int F_69 ( unsigned int V_11 )
{
struct V_3 * V_4 = F_19 ( V_11 ) ;
if ( ! V_4 )
return - V_50 ;
if ( V_4 -> V_62 )
return - V_50 ;
V_4 -> V_62 = F_70 ( sizeof( * V_4 -> V_62 ) , V_30 ) ;
if ( ! V_4 -> V_62 )
return - V_9 ;
F_71 ( V_11 ) ;
return 0 ;
}
void F_72 ( unsigned int V_11 )
{
F_73 ( V_11 , F_19 ( V_11 ) ) ;
}
unsigned int F_74 ( unsigned int V_11 , int V_14 )
{
struct V_3 * V_4 = F_19 ( V_11 ) ;
return V_4 && V_4 -> V_28 ?
* F_16 ( V_4 -> V_28 , V_14 ) : 0 ;
