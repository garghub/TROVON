...
void * F_139 ( unsigned long V_108 )
{
void * V_168 = F_140 ( V_108 , V_217 | V_299 ) ;
if ( ! V_168 )
V_168 = F_141 ( V_108 ) ;
return V_168 ;
}
void F_142 ( void * V_93 )
{
if ( F_143 ( V_93 ) )
F_144 ( V_93 ) ;
else
...
static int F_146 ( struct V_185 * V_90 , unsigned int V_220 ,
unsigned int V_300 , unsigned int V_301 ,
unsigned int V_225 , unsigned int V_227 )
{
unsigned long V_108 = V_220 * sizeof( * V_90 -> V_199 ) +
V_300 * sizeof( * V_90 -> V_224 ) + V_301 * sizeof( * V_90 -> V_226 ) ;
V_90 -> V_199 = F_139 ( V_108 ) ;
if ( ! V_90 -> V_199 )
return - V_302 ;
V_90 -> V_226 = (union V_195 * ) & V_90 -> V_199 [ V_220 ] ;
V_90 -> V_224 = (union V_187 * ) & V_90 -> V_226 [ V_301 ] ;
V_90 -> V_220 = V_220 ;
V_90 -> V_301 = V_301 ;
V_90 -> V_227 = V_227 ;
V_90 -> V_197 = NULL ;
...
if ( V_301 ) {
while ( -- V_301 )
V_90 -> V_226 [ V_301 - 1 ] . V_191 = & V_90 -> V_226 [ V_301 ] ;
V_90 -> V_197 = V_90 -> V_226 ;
}
if ( V_300 ) {
while ( -- V_300 )
V_90 -> V_224 [ V_300 - 1 ] . V_191 = & V_90 -> V_224 [ V_300 ] ;
V_90 -> V_192 = V_90 -> V_224 ;
}
return 0 ;
}
static void F_149 ( struct V_185 * V_90 )
{
F_142 ( V_90 -> V_199 ) ;
}
static inline void F_150 ( struct V_3 * V_303 )
{
F_151 ( & V_281 ) ;
F_6 ( & V_303 -> V_304 , & V_304 ) ;
F_152 ( & V_281 ) ;
}
static inline void F_153 ( struct V_3 * V_303 )
{
F_151 ( & V_281 ) ;
F_10 ( & V_303 -> V_304 ) ;
F_152 ( & V_281 ) ;
}
int F_154 ( struct V_3 * V_3 )
{
struct V_1 * V_18 = & V_3 -> V_2 ;
int V_300 , V_305 ;
struct V_211 * V_90 ;
struct V_121 V_306 , V_121 ;
struct V_123 V_123 ;
unsigned int V_307 ;
struct V_308 * V_309 ;
V_90 = F_140 ( sizeof( * V_90 ) , V_217 ) ;
if ( ! V_90 )
return - V_302 ;
V_305 = - V_58 ;
if ( V_18 -> V_310 ( V_18 , V_138 , & V_90 -> V_311 ) < 0 ||
V_18 -> V_310 ( V_18 , V_134 , & V_90 -> V_312 ) < 0 ||
V_18 -> V_310 ( V_18 , V_147 , & V_307 ) < 0 ||
V_18 -> V_310 ( V_18 , V_148 , & V_123 ) < 0 ||
V_18 -> V_310 ( V_18 , V_139 , & V_121 ) < 0 ||
V_18 -> V_310 ( V_18 , V_146 , & V_306 ) < 0 )
goto V_313;
V_305 = - V_302 ;
V_309 = F_155 ( V_307 ) ;
if ( ! V_309 )
goto V_313;
V_300 = F_25 ( V_121 . V_140 / 2 , V_314 ) ;
V_305 = F_146 ( & V_90 -> V_186 , V_121 . V_140 , V_300 ,
V_306 . V_140 , V_315 , V_306 . V_145 ) ;
if ( V_305 )
goto V_316;
V_90 -> V_150 = V_123 . V_150 ;
V_90 -> V_317 = V_123 . V_108 ;
F_156 ( & V_90 -> V_213 , F_69 ) ;
F_148 ( & V_90 -> V_214 ) ;
F_157 ( & V_90 -> V_318 ) ;
V_90 -> V_18 = V_18 ;
F_158 ( V_18 -> V_319 , V_309 ) ;
F_55 ( V_18 ) = V_90 ;
V_18 -> V_182 = F_123 ;
V_18 -> V_183 = F_130 ;
if ( F_159 ( & V_304 ) )
...
static void F_162 ( struct V_321 * V_322 )
{
struct V_308 * V_323 = F_70 ( V_322 , struct V_308 , V_321 ) ;
F_161 ( V_323 ) ;
}
...
V_323 = F_137 ( V_2 ) ;
F_22 () ;
F_158 ( V_2 -> V_319 , NULL ) ;
F_165 ( & V_323 -> V_321 , F_162 ) ;
if ( V_90 -> V_218 )
F_124 ( V_90 -> V_218 ) ;
F_145 ( V_90 ) ;
}
...
static int V_324 ;
F_5 ( & V_8 ) ;
snprintf ( V_2 -> V_54 , sizeof( V_2 -> V_54 ) , L_15 , V_324 ++ ) ;
F_6 ( & V_2 -> V_325 , & V_325 ) ;
F_8 ( & V_8 ) ;
}
...
static inline int F_168 ( struct V_3 * V_3 )
{
int type = 0 ;
switch ( V_3 -> V_46 . V_326 ) {
case V_327 :
type = V_221 ;
break;
case V_328 :
