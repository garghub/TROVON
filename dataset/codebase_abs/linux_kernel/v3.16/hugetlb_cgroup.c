...
return;
F_20 ( V_21 , NULL ) ;
F_40 ( & V_8 -> V_13 [ V_11 ] , V_22 ) ;
return;
}
void F_41 ( int V_11 , unsigned long V_32 ,
struct V_1 * V_8 )
{
unsigned long V_22 = V_32 * V_28 ;
if ( F_28 () || ! V_8 )
...
static T_1 F_42 ( struct V_2 * V_4 ,
struct V_40 * V_41 )
{
int V_11 , V_42 ;
struct V_1 * V_8 = F_1 ( V_4 ) ;
...
static T_2 F_45 ( struct V_44 * V_45 ,
char * V_46 , T_3 V_47 , T_4 V_48 )
{
int V_11 , V_42 , V_34 ;
unsigned long long V_49 ;
struct V_1 * V_8 = F_1 ( F_46 ( V_45 ) ) ;
V_46 = F_47 ( V_46 ) ;
V_11 = F_43 ( F_48 ( V_45 ) -> V_43 ) ;
V_42 = F_44 ( F_48 ( V_45 ) -> V_43 ) ;
switch ( V_42 ) {
case V_50 :
if ( F_5 ( V_8 ) ) {
V_34 = - V_51 ;
...
static char * F_54 ( char * V_46 , int V_54 , unsigned long V_55 )
{
if ( V_55 >= ( 1UL << 30 ) )
...
static void T_5 F_55 ( int V_11 )
{
char V_46 [ 32 ] ;
struct V_40 * V_41 ;
struct V_29 * V_30 = & V_36 [ V_11 ] ;
F_54 ( V_46 , 32 , F_56 ( V_30 ) ) ;
V_41 = & V_30 -> V_56 [ 0 ] ;
snprintf ( V_41 -> V_42 , V_57 , L_4 , V_46 ) ;
V_41 -> V_43 = F_57 ( V_11 , V_50 ) ;
V_41 -> V_58 = F_42 ;
V_41 -> V_59 = F_45 ;
V_41 = & V_30 -> V_56 [ 1 ] ;
snprintf ( V_41 -> V_42 , V_57 , L_5 , V_46 ) ;
V_41 -> V_43 = F_57 ( V_11 , V_14 ) ;
V_41 -> V_58 = F_42 ;
V_41 = & V_30 -> V_56 [ 2 ] ;
snprintf ( V_41 -> V_42 , V_57 , L_6 , V_46 ) ;
V_41 -> V_43 = F_57 ( V_11 , V_52 ) ;
V_41 -> V_59 = F_51 ;
V_41 -> V_58 = F_42 ;
V_41 = & V_30 -> V_56 [ 3 ] ;
snprintf ( V_41 -> V_42 , V_57 , L_7 , V_46 ) ;
V_41 -> V_43 = F_57 ( V_11 , V_53 ) ;
V_41 -> V_59 = F_51 ;
V_41 -> V_58 = F_42 ;
V_41 = & V_30 -> V_56 [ 4 ] ;
memset ( V_41 , 0 , sizeof( * V_41 ) ) ;
F_58 ( F_59 ( & V_60 , V_30 -> V_56 ) ) ;
return;
}
void T_5 F_60 ( void )
{
...
void F_62 ( struct V_21 * V_61 , struct V_21 * V_62 )
{
struct V_1 * V_8 ;
struct V_29 * V_30 = F_63 ( V_61 ) ;
if ( F_28 () )
return;
F_64 ( ! F_65 ( V_61 ) , V_61 ) ;
F_23 ( & V_31 ) ;
