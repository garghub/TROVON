...
goto V_535;
V_534 = V_47 = F_24 ( V_123 , V_108 -> V_110 ,
V_18 -> V_118 , V_101 ) ;
if ( V_47 == V_536 )
V_534 = V_47 = F_36 ( V_4 ) ;
if ( V_47 == V_124 )
...
if ( ( V_47 = F_258 ( V_108 -> V_112 , F_192 , 0 , V_538 , V_4 ) ) ) {
...
V_4 -> V_152 , V_4 -> V_519 ) ;
F_261 ( V_4 -> V_220 ) ;
F_33 ( V_4 -> V_98 , V_540 -> V_118 ,
V_540 -> V_129 * sizeof( * V_540 -> V_100 ) , V_119 ) ;
F_34 ( ( unsigned long ) V_540 -> V_100 ) ;
V_95 ;
}
...
struct V_231 * V_98 = V_4 -> V_98 ;
V_92 ;
V_540 -> V_100 = (struct V_380 * ) F_254 ( V_213 ) ;
if ( ! V_540 -> V_100 ) {
F_21 ( V_98 , L_107 ) ;
goto V_541;
}
V_540 -> V_129 = V_101 / sizeof( struct V_380 ) ;
V_540 -> V_118 = F_255 ( V_98 , V_540 -> V_100 ,
V_540 -> V_129 * sizeof( * V_540 -> V_100 ) ,
V_119 ) ;
if ( F_256 ( V_98 , V_540 -> V_118 ) ) {
F_21 ( V_98 , L_108 ) ;
goto V_542;
}
V_4 -> V_220 = F_263 ( V_538 , V_98 ,
V_543 * sizeof( struct V_226 ) ,
...
V_4 -> V_499 = sizeof( V_4 -> V_491 -> V_24 [ 0 ] ) * V_546 ;
...
static void F_265 ( struct V_552 * V_553 )
{
struct V_3 * V_4 = F_69 ( V_553 , struct V_3 ,
V_531 ) ;
struct V_64 * V_65 ;
struct V_169 * V_170 ;
unsigned long V_39 ;
...
static int F_269 ( struct V_107 * V_108 , const struct V_555 * V_149 )
{
struct V_3 * V_4 ;
struct V_145 * V_146 ;
...
V_146 -> V_516 = V_191 ;
V_146 -> V_561 = V_562 ;
V_146 -> V_563 = V_146 -> V_564 ;
V_4 = F_59 ( V_146 ) ;
F_271 ( & V_4 -> V_248 ) ;
F_271 ( & V_4 -> free ) ;
F_271 ( & V_4 -> V_489 ) ;
sprintf ( V_4 -> V_48 , V_538 ) ;
V_4 -> V_89 = V_146 ;
V_4 -> V_98 = V_98 ;
V_4 -> V_184 = - 1 ;
V_4 -> V_234 = V_234 ;
...
if ( ( V_47 = F_262 ( V_4 ) ) )
goto V_565;
V_4 -> V_566 = F_275 ( F_250 , V_4 , L_116 , V_538 ,
V_146 -> V_564 ) ;
if ( F_276 ( V_4 -> V_566 ) ) {
F_21 ( V_98 , L_117 ,
F_277 ( V_4 -> V_566 ) ) ;
...
goto V_570;
F_279 ( V_146 ) = V_571 ;
if ( ( V_47 = F_280 ( & V_146 -> V_572 . V_434 ,
& V_573 ) ) ) {
...
unsigned long V_39 ;
V_92 ;
F_290 ( & V_4 -> V_89 -> V_572 . V_434 , & V_573 ) ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_18 ( V_4 , V_73 ) ;
F_39 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_77 ( V_4 ) ;
...
{
unsigned long V_577 = V_202 * sizeof( union V_307 ) ;
return V_577 + ( ( 512 * 1024 ) * V_556 . V_578 ) ;
}
