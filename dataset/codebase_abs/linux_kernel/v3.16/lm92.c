...
static T_3 F_11 ( struct V_4 * V_5 , struct V_18 * V_19 ,
char * V_20 )
{
struct V_21 * V_22 = F_12 ( V_19 ) ;
struct V_3 * V_6 = F_4 ( V_5 ) ;
return sprintf ( V_20 , L_2 , F_1 ( V_6 -> V_16 [ V_22 -> V_23 ] ) ) ;
}
static T_3 F_13 ( struct V_4 * V_5 , struct V_18 * V_19 ,
...
long V_2 ;
int V_26 ;
V_26 = F_14 ( V_20 , 10 , & V_2 ) ;
if ( V_26 )
return V_26 ;
F_6 ( & V_6 -> V_10 ) ;
V_6 -> V_16 [ V_25 ] = F_2 ( V_2 ) ;
F_15 ( V_8 , V_17 [ V_25 ] , V_6 -> V_16 [ V_25 ] ) ;
F_10 ( & V_6 -> V_10 ) ;
return V_24 ;
}
...
return V_26 ;
F_6 ( & V_6 -> V_10 ) ;
V_6 -> V_16 [ V_27 ] = F_1 ( V_6 -> V_16 [ V_22 -> V_23 ] ) - V_2 ;
F_15 ( V_8 , V_29 ,
F_2 ( V_6 -> V_16 [ V_27 ] ) ) ;
F_10 ( & V_6 -> V_10 ) ;
return V_24 ;
}
static T_3 F_19 ( struct V_4 * V_5 , struct V_18 * V_22 ,
char * V_20 )
{
struct V_3 * V_6 = F_4 ( V_5 ) ;
return sprintf ( V_20 , L_2 , F_3 ( V_6 -> V_16 [ V_30 ] ) ) ;
}
static T_3 F_20 ( struct V_4 * V_5 , struct V_18 * V_22 ,
char * V_20 )
{
int V_31 = F_12 ( V_22 ) -> V_23 ;
struct V_3 * V_6 = F_4 ( V_5 ) ;
...
int V_9 ;
V_34 = F_25 ( V_8 , V_39 ) ;
if ( F_25 ( V_8 , V_40 ) != V_34 )
return 0 ;
V_35 = F_25 ( V_8 , V_41 ) ;
if ( F_25 ( V_8 , V_40 ) != V_35 )
return 0 ;
...
static int F_26 ( struct V_7 * V_43 ,
struct V_44 * V_45 )
{
...
return - V_51 ;
F_29 ( V_45 -> type , L_5 , V_52 ) ;
return 0 ;
}
static int F_30 ( struct V_7 * V_43 ,
const struct V_53 * V_54 )
{
struct V_4 * V_55 ;
struct V_3 * V_6 ;
V_6 = F_31 ( & V_43 -> V_5 , sizeof( struct V_3 ) ,
V_56 ) ;
if ( ! V_6 )
return - V_57 ;
V_6 -> V_8 = V_43 ;
