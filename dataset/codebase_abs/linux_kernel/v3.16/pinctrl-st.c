...
static int F_112 ( struct V_170 * V_171 , unsigned type )
{
struct V_84 * V_87 = F_110 ( V_171 ) ;
struct F_1 * V_79 = F_43 ( V_87 ) ;
unsigned long V_90 ;
...
static void F_118 ( struct F_1 * V_79 )
{
...
F_121 ( F_122 ( V_79 -> V_84 . V_199 , V_192 ) ) ;
}
}
}
static void F_123 ( unsigned V_200 , struct V_201 * V_202 )
{
struct V_203 * V_85 = F_124 ( V_200 ) ;
struct V_84 * V_87 = F_125 ( V_202 ) ;
struct F_1 * V_79 = F_43 ( V_87 ) ;
F_126 ( V_85 , V_202 ) ;
F_118 ( V_79 ) ;
F_127 ( V_85 , V_202 ) ;
}
static void F_128 ( unsigned V_200 , struct V_201 * V_202 )
{
struct V_203 * V_85 = F_124 ( V_200 ) ;
struct V_44 * V_45 = F_129 ( V_200 ) ;
unsigned long V_204 ;
int V_192 ;
F_126 ( V_85 , V_202 ) ;
V_204 = F_44 ( V_45 -> V_205 ) ;
F_119 (n, &status, info->nbanks)
F_118 ( & V_45 -> V_156 [ V_192 ] ) ;
F_127 ( V_85 , V_202 ) ;
}
...
struct V_144 * V_113 = V_45 -> V_113 ;
int V_207 = F_131 ( V_105 , L_15 ) ;
struct V_208 V_209 , V_210 ;
int V_211 = 0 , V_212 ;
if ( F_132 ( V_105 , 0 , & V_209 ) )
return - V_213 ;
V_79 -> V_80 = F_133 ( V_113 , & V_209 ) ;
if ( F_96 ( V_79 -> V_80 ) )
return F_134 ( V_79 -> V_80 ) ;
V_79 -> V_84 = V_214 ;
...
V_209 = F_145 ( V_224 ,
V_231 , L_27 ) ;
V_45 -> V_205 = F_133 ( & V_224 -> V_113 , V_209 ) ;
if ( F_96 ( V_45 -> V_205 ) )
return F_134 ( V_45 -> V_205 ) ;
F_146 ( V_200 , F_128 ) ;
F_147 ( V_200 , V_45 ) ;
}
