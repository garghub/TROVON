...
if ( ! ( V_24 -> V_43 -> V_124 & V_125 ) )
V_118 |= V_126 ;
if ( ! ( V_24 -> V_43 -> V_124 & V_127 ) )
V_118 |= V_128 ;
F_30 ( V_12 , V_39 ,
V_126 | V_128 ,
V_118 ) ;
...
static bool F_41 ( struct V_139 * V_61 , unsigned int V_140 )
{
switch ( V_140 ) {
case V_39 ... V_141 :
case V_142 ... V_143 :
...
static int F_42 ( struct V_144 * V_145 ,
const struct V_146 * V_147 )
{
struct V_23 * V_24 ;
int V_107 , V_15 ;
V_24 = F_43 ( & V_145 -> V_61 , sizeof( struct V_23 ) ,
V_148 ) ;
if ( ! V_24 )
return - V_149 ;
for ( V_15 = 0 ; V_15 < F_22 ( V_24 -> V_117 ) ; V_15 ++ )
V_24 -> V_117 [ V_15 ] . V_150 = V_151 [ V_15 ] ;
V_107 = F_44 ( & V_145 -> V_61 , F_22 ( V_24 -> V_117 ) ,
V_24 -> V_117 ) ;
if ( V_107 != 0 ) {
F_24 ( & V_145 -> V_61 , L_12 , V_107 ) ;
return V_107 ;
}
V_24 -> V_33 = F_45 ( V_145 , & V_152 ) ;
if ( F_46 ( V_24 -> V_33 ) ) {
V_107 = F_47 ( V_24 -> V_33 ) ;
F_24 ( & V_145 -> V_61 , L_13 , V_107 ) ;
return V_107 ;
}
F_48 ( V_145 , V_24 ) ;
V_107 = F_49 ( & V_145 -> V_61 , & V_153 , & V_154 , 1 ) ;
if ( V_107 != 0 )
F_24 ( & V_145 -> V_61 , L_14 , V_107 ) ;
return V_107 ;
}
static int F_50 ( struct V_144 * V_155 )
{
F_51 ( & V_155 -> V_61 ) ;
return 0 ;
}
