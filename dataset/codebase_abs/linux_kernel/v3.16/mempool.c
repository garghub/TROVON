...
F_23 ( & V_14 ) ;
F_24 ( & V_1 -> V_14 , & V_14 , V_30 ) ;
F_15 ( & V_1 -> V_13 , V_18 ) ;
F_25 ( 5 * V_31 ) ;
F_26 ( & V_1 -> V_14 , & V_14 ) ;
goto V_29;
}
void F_27 ( void * V_2 , T_1 * V_1 )
{
unsigned long V_18 ;
if ( F_12 ( V_2 == NULL ) )
return;
F_28 () ;
if ( F_12 ( V_1 -> V_3 < V_1 -> V_4 ) ) {
F_14 ( & V_1 -> V_13 , V_18 ) ;
if ( F_20 ( V_1 -> V_3 < V_1 -> V_4 ) ) {
F_1 ( V_1 , V_2 ) ;
F_15 ( & V_1 -> V_13 , V_18 ) ;
F_29 ( & V_1 -> V_14 ) ;
return;
...
void * F_30 ( T_4 V_11 , void * V_6 )
{
struct V_32 * V_33 = V_6 ;
return F_31 ( V_33 , V_11 ) ;
}
...
{
T_6 V_34 = ( T_6 ) V_6 ;
return F_16 ( V_34 , V_11 ) ;
}
void F_35 ( void * V_2 , void * V_6 )
{
F_5 ( V_2 ) ;
}
void * F_36 ( T_4 V_11 , void * V_6 )
{
int V_35 = ( int ) ( long ) V_6 ;
return F_37 ( V_11 , V_35 ) ;
}
void F_38 ( void * V_2 , void * V_6 )
{
int V_35 = ( int ) ( long ) V_6 ;
F_39 ( V_2 , V_35 ) ;
}
