...
break;
case 0x08 :
V_2 -> V_33 = F_11 ( 32 * 1024 , V_34 ) ;
if ( V_2 -> V_33 ) {
if ( F_12 ( V_10 , V_2 -> V_33 , 32 * 1024 ) ) {
F_13 ( V_2 -> V_33 ) ;
V_2 -> V_33 = NULL ;
}
}
...
V_12 = F_10 ( V_2 , 0x10120 ) ;
V_36 = F_10 ( V_2 , 0x10170 ) ;
if ( V_36 & 0x2000 )
V_39 = 14318 ;
else
V_39 = 12000 ;
...
struct V_51 * V_52 ;
int V_8 ;
V_53 = F_24 ( V_10 , V_59 , V_55 -> V_60 [ 0 ] ) ;
if ( V_53 == NULL )
return F_25 ( - V_61 ) ;
V_52 = F_11 ( sizeof( * V_52 ) , V_34 ) ;
if ( ! V_52 ) {
F_17 ( V_53 ) ;
return F_25 ( - V_62 ) ;
}
V_8 = F_19 ( V_10 , V_52 , V_55 , V_53 ) ;
if ( V_8 ) {
F_17 ( V_53 ) ;
F_13 ( V_52 ) ;
return F_25 ( V_8 ) ;
...
struct V_1 * V_2 ;
int V_8 = 0 ;
V_2 = F_11 ( sizeof( struct V_1 ) , V_34 ) ;
if ( ! V_2 )
return - V_62 ;
V_10 -> V_11 = V_2 ;
V_2 -> V_10 = V_10 ;
...
F_14 ( V_10 ) ;
V_2 -> V_63 = F_26 ( V_10 ) ;
F_8 ( L_10 , V_2 -> V_48 , V_2 -> V_41 , V_2 -> V_40 , V_2 -> V_63 ) ;
}
V_8 = F_30 ( V_2 ) ;
if ( V_8 )
goto V_72;
