...
static void F_54 ( unsigned long V_90 )
{
...
static T_5 F_60 ( int V_35 , void * V_98 )
{
T_1 V_94 ;
struct V_1 * V_2 = V_98 ;
F_61 ( & V_2 -> V_92 ) ;
...
static unsigned int F_64 ( struct V_103 * V_51 , unsigned int V_104 )
{
struct V_1 * V_2 = V_51 -> V_102 ;
F_31 ( V_2 -> V_20 , L_26 , V_2 -> V_50 ) ;
return V_2 -> V_50 ? V_105 : 0 ;
}
static int F_65 ( struct V_103 * V_51 )
{
struct V_1 * V_2 = V_51 -> V_102 ;
unsigned long V_91 ;
F_31 ( V_2 -> V_20 , L_27 ) ;
...
static int F_67 ( struct V_106 * V_107 , T_6 V_108 )
{
...
static void F_71 ( struct V_103 * V_112 , T_6 V_108 )
{
...
static int F_72 ( struct V_106 * V_107 , struct V_113 * V_114 )
{
struct V_1 * V_2 = V_107 -> V_109 -> V_102 ;
T_1 * V_70 = V_2 -> V_70 ;
F_31 ( V_2 -> V_20 , L_32 ) ;
...
F_74 ( & V_2 -> V_92 ) ;
F_75 ( & V_2 -> V_54 ) ;
V_2 -> V_5 = F_76 ( V_2 -> V_123 , 0x80 ) ;
if ( ! V_2 -> V_5 )
goto V_124;
F_77 ( & V_2 -> V_33 , F_54 , ( unsigned long ) V_2 ) ;
F_78 ( & V_2 -> V_57 , F_57 , ( unsigned long ) V_2 ) ;
V_2 -> V_52 = F_79 ( F_63 , & V_2 -> V_92 ) ;
if ( V_2 -> V_52 == NULL )
goto V_125;
F_80 ( V_2 -> V_52 , 512 ) ;
V_2 -> V_51 = F_81 ( V_126 ) ;
...
V_141 | V_97 ) ;
if ( V_2 -> V_35 ) {
V_122 = F_82 ( V_2 -> V_35 , F_60 , 0 , L_36 , V_2 ) ;
if ( V_122 ) {
F_46 ( V_2 -> V_20 , L_37 ) ;
V_2 -> V_35 = 0 ;
}
...
static int F_91 ( struct V_143 * V_20 , int V_30 , T_7 V_123 ,
int V_35 , int V_134 )
{
struct V_1 * V_2 ;
int V_122 ;
...
V_2 = F_92 ( sizeof( struct V_1 ) , V_146 ) ;
if ( ! V_2 ) {
V_122 = - V_142 ;
goto V_147;
}
...
static void F_95 ( struct V_143 * V_20 )
{
struct V_1 * V_2 = F_96 ( V_20 ) ;
F_31 ( V_20 , L_43 , V_20 ) ;
if ( V_2 ) {
F_87 ( V_2 ) ;
F_93 ( V_20 , NULL ) ;
...
static int F_97 ( struct V_149 * V_20 )
{
T_7 V_123 = 0 ;
int V_134 = V_135 ;
T_4 V_30 = V_20 -> V_30 ;
...
if ( F_98 ( V_20 -> V_20 . V_150 , L_45 , & V_30 ) )
V_30 = 0 ;
if ( F_99 ( V_20 -> V_20 . V_150 , L_46 , NULL ) )
V_134 = V_151 ;
...
return F_91 ( & V_20 -> V_20 , V_30 , V_123 , V_35 , V_134 ) ;
}
static int F_100 ( struct V_149 * V_20 )
{
F_95 ( & V_20 -> V_20 ) ;
return 0 ;
}
