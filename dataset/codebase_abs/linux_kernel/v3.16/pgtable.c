...
void T_3 F_72 ( unsigned long V_56 )
{
#ifdef F_73
F_74 ( V_57 > 0 ) ;
V_58 = F_75 ( - V_56 , 1 << V_59 ) - V_60 ;
F_76 ( V_61 L_2 ,
- V_56 , V_58 + V_60 ) ;
#endif
}
void F_77 ( enum V_62 V_63 , T_1 V_6 )
{
unsigned long V_3 = F_78 ( V_63 ) ;
if ( V_63 >= V_64 ) {
F_79 () ;
return;
}
...
void F_81 ( enum V_62 V_63 , T_7 V_65 ,
T_8 V_66 )
{
F_77 ( V_63 , F_82 ( V_65 >> V_14 , V_66 ) ) ;
}
