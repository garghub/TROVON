...
1 , 2 ) ;
V_11 [ V_88 ] = V_2 ;
V_2 = F_31 ( NULL , L_30 , V_89 ,
F_8 ( V_89 ) ,
V_90 ,
V_1 + V_91 , 25 , 1 , 0 , & V_72 ) ;
V_11 [ V_92 ] = V_2 ;
V_2 = F_31 ( NULL , L_31 , V_89 ,
F_8 ( V_89 ) ,
V_90 ,
V_1 + V_93 , 25 , 1 , 0 , & V_76 ) ;
V_11 [ V_94 ] = V_2 ;
V_2 = F_31 ( NULL , L_32 , V_95 ,
F_8 ( V_95 ) ,
V_90 ,
V_1 + V_96 ,
29 , 3 , 0 , NULL ) ;
...
V_121 | V_122 |
V_123 | V_124 ) ;
F_12 ( V_118 , V_1 + V_125 ) ;
V_117 |= ( V_111 | V_112 |
V_113 | V_114 |
V_115 | V_116 ) ;
F_12 ( V_117 , V_1 + V_126 ) ;
F_43 () ;
}
void F_45 ( void )
{
...
static void T_1 F_47 ( struct V_130 * V_131 )
{
struct V_130 * V_132 ;
V_1 = F_48 ( V_131 , 0 ) ;
if ( ! V_1 ) {
...
F_16 ( V_1 , V_87 ) ;
F_30 ( V_1 , V_87 ) ;
F_51 ( V_1 , V_87 , V_97 , & V_135 ) ;
F_52 ( V_87 , V_97 ) ;
F_53 ( V_1 , V_87 , V_97 ,
& V_136 ) ;
F_54 ( V_131 ) ;
F_55 ( V_137 , F_8 ( V_137 ) ) ;
V_138 = F_38 ;
V_139 = & V_140 ;
}
