...
static int F_26 ( struct V_170 * V_171 , unsigned int V_196 )
{
struct V_115 * V_116 = V_171 -> V_116 ;
struct V_117 * V_118 = F_5 ( V_116 ) ;
...
switch ( V_196 & V_198 ) {
case V_199 :
V_118 -> V_200 [ V_171 -> V_179 ] = 1 ;
break;
case V_201 :
V_197 |= V_202 ;
V_118 -> V_200 [ V_171 -> V_179 ] = 0 ;
break;
default:
return - V_120 ;
}
...
struct V_117 * V_118 = F_5 ( V_116 ) ;
unsigned int V_197 = 0 ;
if ( V_219 == V_118 -> V_121 && V_218 == V_118 -> V_221 )
return 0 ;
switch ( V_218 ) {
case V_222 :
V_197 |= V_223 ;
...
V_118 -> V_121 = V_219 ;
V_118 -> V_221 = V_218 ;
F_24 ( V_171 -> V_2 , L_8 , V_219 , V_218 ) ;
return 0 ;
}
static int F_28 ( struct V_170 * V_171 , int V_227 , int V_124 ,
...
struct V_230 V_231 ;
int V_232 ;
if ( V_124 == V_118 -> V_233 && V_228 == V_118 -> V_234 &&
V_229 == V_118 -> V_235 )
return 0 ;
if ( ! V_228 || ! V_229 ) {
F_24 ( V_116 -> V_2 , L_9 ) ;
...
V_232 = F_29 ( V_228 , V_229 , & V_231 ) ;
if ( V_232 < 0 ) {
F_7 ( V_116 -> V_2 , L_11 , V_228 ) ;
return V_232 ;
}
F_24 ( V_116 -> V_2 , L_12 ,
V_231 . V_243 , ( V_231 . V_243 ? 0 : V_231 . V_244 ) ,
V_231 . V_245 , V_231 . V_246 ) ;
F_30 ( V_116 , V_69 ,
V_231 . V_245 << V_247 | V_231 . V_246 ) ;
F_30 ( V_116 , V_70 ,
( V_231 . V_243 ? 0 : V_231 . V_244 ) << V_248 |
V_231 . V_243 << V_249 ) ;
V_118 -> V_234 = V_228 ;
V_118 -> V_235 = V_229 ;
V_118 -> V_233 = V_124 ;
...
static int F_38 ( struct V_263 * V_264 ,
const struct V_265 * V_179 )
{
struct V_266 * V_267 = F_39 ( & V_264 -> V_2 ) ;
struct V_117 * V_118 ;
int V_232 ;
V_118 = F_40 ( & V_264 -> V_2 , sizeof( * V_118 ) ,
V_268 ) ;
if ( NULL == V_118 )
return - V_269 ;
F_41 ( V_264 , V_118 ) ;
if ( V_267 )
V_118 -> V_267 = * V_267 ;
V_118 -> V_130 = F_42 ( V_264 , & V_270 ) ;
if ( F_43 ( V_118 -> V_130 ) ) {
V_232 = F_44 ( V_118 -> V_130 ) ;
F_7 ( & V_264 -> V_2 , L_13 ,
V_232 ) ;
return V_232 ;
}
F_45 ( V_118 -> V_130 , V_19 , & V_232 ) ;
if ( V_232 != V_271 ) {
F_7 ( & V_264 -> V_2 ,
L_14 , V_232 ) ;
return - V_272 ;
...
V_232 = F_46 ( V_118 -> V_130 , V_273 ,
F_2 ( V_273 ) ) ;
if ( V_232 != 0 )
F_47 ( & V_264 -> V_2 , L_15 , V_232 ) ;
if ( V_118 -> V_267 . V_274 )
F_12 ( V_118 -> V_130 , V_24 ,
V_275 , V_275 ) ;
if ( V_118 -> V_267 . V_276 )
F_12 ( V_118 -> V_130 , V_90 ,
V_277 , V_278 ) ;
V_118 -> V_161 = 1 ;
V_232 = F_48 ( & V_264 -> V_2 , & V_279 ,
V_280 , F_2 ( V_280 ) ) ;
return V_232 ;
}
static int F_49 ( struct V_263 * V_264 )
{
F_50 ( & V_264 -> V_2 ) ;
return 0 ;
}
