...
F_51 ( & V_4 -> V_125 ) ;
if ( V_137 )
F_63 ( V_4 -> V_141 , L_1 , V_137 ) ;
}
static void F_64 ( struct V_129 * V_75 , struct V_142 * V_74 )
{
...
static int F_65 ( struct V_129 * V_75 , struct V_142 * V_74 ,
T_3 T_4 V_144 )
{
...
F_49 ( V_54 ) ;
V_137 = - V_147 ;
F_66 ( V_54 -> V_4 -> V_141 , L_2 ,
F_36 ( V_54 ) ) ;
}
}
if ( F_67 ( V_54 -> V_75 . V_145 ) &&
V_56 -> V_74 . V_57 > ( 1 + V_54 -> V_75 . V_148 ) * V_54 -> V_75 . V_76 ) {
F_63 ( V_54 -> V_4 -> V_141 , L_3 ) ;
return - V_149 ;
}
if ( ! F_32 ( & V_56 -> V_102 ) ) {
F_63 ( V_54 -> V_4 -> V_141 , L_4 ) ;
return - V_118 ;
}
...
== V_158 ) {
V_2 = ( F_69 ( V_152 -> V_159 ) & V_87 ) ?
V_72 : V_32 ;
V_1 = F_69 ( V_152 -> V_159 ) & V_160 ;
* ( V_157 * ) V_74 -> V_143 = F_12 ( V_4 , V_1 , V_2 ) ;
}
V_137 = F_65 ( & V_54 -> V_75 , V_74 , V_144 ) ;
if ( V_137 )
goto V_161;
return 0 ;
V_161:
...
static void
F_70 ( struct V_129 * V_75 , struct V_142 * V_74 )
{
...
V_4 -> V_92 -> V_162 = V_4 ;
V_4 -> V_92 -> V_127 = F_70 ;
V_137 = F_65 ( & V_54 -> V_75 , V_4 -> V_92 , V_63 ) ;
return V_137 ;
}
...
V_56 -> V_74 . V_127 ( & V_168 -> V_75 , & V_56 -> V_74 ) ;
F_51 ( V_54 -> V_125 ) ;
}
}
if ( V_137 == - V_118 )
...
if ( type != ( V_174 | V_156 ) )
goto V_180;
if ( F_69 ( V_74 . V_177 ) != 0 ||
F_69 ( V_74 . V_159 ) != 0 )
break;
V_4 -> V_164 = ( T_2 ) F_69 ( V_74 . V_175 ) ;
V_4 -> V_163 = true ;
V_169 = F_72 ( V_4 ) ;
break;
case V_184 :
...
if ( V_74 . V_177 != 0 )
break;
switch ( F_69 ( V_74 . V_175 ) ) {
case V_179 :
V_4 -> V_133 = 1 ;
V_169 = F_72 ( V_4 ) ;
break;
case V_185 :
V_170 = F_69 ( V_74 . V_159 ) >> 8 ;
switch ( V_170 ) {
case V_186 :
case V_187 :
case V_188 :
...
static int F_79 ( struct V_129 * V_75 ,
...
if ( ! F_32 ( & V_54 -> V_101 . V_102 ) )
F_66 ( V_54 -> V_4 -> V_141 , L_6 ) ;
V_54 -> V_2 = F_80 ( V_145 ) ? V_72 : V_32 ;
V_54 -> V_1 = F_81 ( V_145 ) ;
V_54 -> type = F_82 ( V_145 ) ;
V_54 -> V_75 . V_76 = F_83 ( V_145 ) & 0x07ff ;
V_54 -> V_75 . V_148 = F_84 ( F_83 ( V_145 ) ) ;
if ( V_54 -> type == V_112 )
V_110 |= V_194 ;
V_110 |= V_195 ;
...
static int F_85 ( struct V_129 * V_75 )
{
struct V_53 * V_54 = F_53 ( V_75 , struct V_53 , V_75 ) ;
int V_197 , V_137 = 0 ;
unsigned long V_130 ;
...
static struct V_142 * F_86 ( struct V_129 * V_75 , T_3 V_144 )
{
...
static void F_87 ( struct V_129 * V_75 , struct V_142 * V_74 )
{
struct V_53 * V_54 = F_53 ( V_75 , struct V_53 , V_75 ) ;
struct V_55 * V_56 = F_53 ( V_74 , struct V_55 , V_74 ) ;
struct V_60 * V_62 , * V_116 ;
...
static int F_88 ( struct V_129 * V_75 , struct V_142 * V_74 ,
T_3 T_4 V_144 )
{
struct V_53 * V_54 = F_53 ( V_75 , struct V_53 , V_75 ) ;
int V_137 = 0 ;
...
static int F_91 ( struct V_129 * V_75 , int V_36 )
{
struct V_53 * V_54 = F_53 ( V_75 , struct V_53 , V_75 ) ;
int V_197 , V_137 = 0 ;
unsigned long V_130 ;
...
static int F_93 ( struct V_129 * V_75 )
{
struct V_53 * V_54 = F_53 ( V_75 , struct V_53 , V_75 ) ;
unsigned long V_130 ;
if ( V_75 == NULL || V_54 -> V_75 . V_145 == NULL )
...
static void F_94 ( struct V_129 * V_75 )
{
struct V_53 * V_54 = F_53 ( V_75 , struct V_53 , V_75 ) ;
unsigned long V_130 ;
if ( V_75 == NULL ) {
F_63 ( V_54 -> V_4 -> V_141 , L_9 , F_36 ( V_54 ) ) ;
return;
}
F_54 ( V_54 -> V_125 , V_130 ) ;
F_5 ( V_54 -> V_4 , V_54 -> V_1 , V_54 -> V_2 ) ;
...
static int F_95 ( struct V_128 * V_201 , int V_202 )
{
struct V_3 * V_4 = F_53 ( V_201 , struct V_3 , V_94 ) ;
unsigned long V_130 ;
int V_203 = 0 ;
F_54 ( & V_4 -> V_125 , V_130 ) ;
V_4 -> V_204 = V_202 ;
...
static int F_99 ( struct V_128 * V_201 )
{
struct V_3 * V_4 = F_53 ( V_201 , struct V_3 , V_94 ) ;
unsigned long V_130 ;
int V_88 = 0 ;
...
static int F_100 ( struct V_128 * V_201 , unsigned V_214 )
{
struct V_3 * V_4 = F_53 ( V_201 , struct V_3 , V_94 ) ;
if ( V_4 -> V_215 )
return F_101 ( V_4 -> V_215 , V_214 ) ;
return - V_216 ;
}
static int F_102 ( struct V_128 * V_201 , int V_217 )
{
struct V_3 * V_4 = F_53 ( V_201 , struct V_3 , V_94 ) ;
if ( ! V_4 -> V_204 )
return - V_199 ;
...
F_104 ( V_54 -> V_220 , sizeof( V_54 -> V_220 ) , L_10 , V_58 ,
...
F_105 ( & V_54 -> V_75 , ( unsigned short ) ~ 0 ) ;
...
V_137 = F_108 ( & V_4 -> V_135 -> V_75 ) ;
if ( V_137 )
return V_137 ;
V_4 -> V_136 -> V_75 . V_145 = & V_229 ;
V_137 = F_108 ( & V_4 -> V_136 -> V_75 ) ;
if ( V_137 )
return V_137 ;
V_4 -> V_138 = V_138 ;
if ( F_77 ( V_4 ) && V_4 -> V_230 . V_231 ) {
F_109 ( V_4 ) ;
return V_137 ;
}
F_96 ( & V_4 -> V_94 . V_141 ) ;
...
static int F_110 ( struct V_128 * V_94 ,
struct V_227 * V_138 )
{
struct V_3 * V_4 = F_53 ( V_94 , struct V_3 , V_94 ) ;
unsigned long V_130 ;
...
F_34 ( & V_4 -> V_94 . V_226 ) ;
V_4 -> V_223 = F_115 ( L_13 , V_141 ,
sizeof( struct V_247 ) ,
64 , V_81 ) ;
if ( V_4 -> V_223 == NULL )
return - V_64 ;
V_4 -> V_66 = F_115 ( L_14 , V_141 ,
sizeof( struct V_67 ) ,
64 , V_81 ) ;
if ( V_4 -> V_66 == NULL ) {
V_137 = - V_64 ;
...
V_137 = F_116 ( V_141 , & V_4 -> V_94 ) ;
if ( V_137 )
goto F_106;
F_117 ( & V_4 -> V_94 . V_141 ) ;
...
return - V_259 ;
V_256 = F_126 ( V_4 -> V_141 , sizeof( struct V_255 ) , V_224 ) ;
if ( ! V_256 )
return - V_64 ;
V_256 -> V_260 = F_122 ;
V_256 -> V_261 = F_124 ;
