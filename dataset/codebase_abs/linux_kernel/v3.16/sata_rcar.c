...
V_36 -> V_163 = V_164 ;
V_36 -> V_74 |= V_165 ;
V_46 -> V_166 = V_3 + V_167 ;
V_46 -> V_50 = V_3 + V_168 ;
V_46 -> V_112 = V_3 + V_169 ;
V_46 -> V_48 = V_46 -> V_50 ;
V_46 -> V_98 = V_46 -> V_166 + ( V_170 << 2 ) ;
V_46 -> V_90 = V_46 -> V_166 + ( V_171 << 2 ) ;
V_46 -> V_78 = V_46 -> V_166 + ( V_172 << 2 ) ;
V_46 -> V_57 = V_46 -> V_166 + ( V_173 << 2 ) ;
V_46 -> V_58 = V_46 -> V_166 + ( V_174 << 2 ) ;
V_46 -> V_82 = V_46 -> V_166 + ( V_175 << 2 ) ;
V_46 -> V_84 = V_46 -> V_166 + ( V_176 << 2 ) ;
V_46 -> V_53 = V_46 -> V_166 + ( V_177 << 2 ) ;
V_46 -> V_47 = V_46 -> V_166 + ( V_178 << 2 ) ;
V_46 -> V_92 = V_46 -> V_166 + ( V_179 << 2 ) ;
}
...
static int F_69 ( struct V_188 * V_189 )
{
...
if ( V_151 <= 0 )
return - V_111 ;
V_2 = F_71 ( & V_189 -> V_94 , sizeof( struct V_1 ) ,
V_195 ) ;
if ( ! V_2 )
return - V_196 ;
V_191 = F_72 ( V_197 , & V_189 -> V_94 ) ;
if ( V_191 )
V_2 -> type = (enum V_198 ) V_191 -> V_45 ;
else
V_2 -> type = F_73 ( V_189 ) -> V_199 ;
V_2 -> V_200 = F_74 ( & V_189 -> V_94 , NULL ) ;
if ( F_75 ( V_2 -> V_200 ) ) {
F_76 ( & V_189 -> V_94 , L_16 ) ;
return F_77 ( V_2 -> V_200 ) ;
}
F_78 ( V_2 -> V_200 ) ;
V_37 = F_79 ( & V_189 -> V_94 , 1 ) ;
if ( ! V_37 ) {
F_76 ( & V_189 -> V_94 , L_17 ) ;
V_194 = - V_196 ;
goto V_201;
}
V_37 -> V_38 = V_2 ;
V_193 = F_80 ( V_189 , V_202 , 0 ) ;
V_2 -> V_3 = F_81 ( & V_189 -> V_94 , V_193 ) ;
if ( F_75 ( V_2 -> V_3 ) ) {
V_194 = F_77 ( V_2 -> V_3 ) ;
goto V_201;
}
