...
if ( V_35 > V_33 )
V_35 = V_33 ;
V_36 = ( unsigned long ) V_11 -> V_17 + V_2 ;
V_35 += * V_34 = V_36 & ( V_37 - 1 ) ;
V_36 &= ~ ( V_37 - 1 ) ;
V_28 = ( V_35 + V_37 - 1 ) / V_37 ;
V_26 = F_26 ( V_36 , V_28 , ( V_5 -> type & V_38 ) != V_38 , V_32 ) ;
if ( F_2 ( V_26 < 0 ) )
return V_26 ;
return ( V_26 == V_28 ? V_35 : V_26 * V_37 ) - * V_34 ;
}
...
V_36 &= ~ ( V_37 - 1 ) ;
V_28 = ( V_35 + V_37 - 1 ) / V_37 ;
V_39 = F_28 ( V_28 * sizeof( struct V_1 * ) , V_40 ) ;
if ( ! V_39 )
V_39 = F_29 ( V_28 * sizeof( struct V_1 * ) ) ;
if ( ! V_39 )
return - V_41 ;
V_26 = F_26 ( V_36 , V_28 , ( V_5 -> type & V_38 ) != V_38 , V_39 ) ;
if ( F_2 ( V_26 < 0 ) ) {
F_30 ( V_39 ) ;
return V_26 ;
}
...
static int F_31 ( const struct V_4 * V_5 , int V_42 )
{
T_1 V_2 = V_5 -> V_16 ;
T_1 V_27 = V_5 -> V_15 ;
const struct V_10 * V_11 = V_5 -> V_11 ;
...
unsigned long V_36 = ( unsigned long ) V_11 -> V_17 + V_2 ;
T_1 V_35 = V_11 -> V_18 - V_2 ;
V_2 = 0 ;
if ( F_2 ( ! V_35 ) )
continue;
if ( V_35 > V_27 )
V_35 = V_27 ;
V_43 += ( V_36 + V_35 + V_37 - 1 ) / V_37
- V_36 / V_37 ;
if ( V_43 >= V_42 )
return V_42 ;
V_27 -= V_35 ;
...
return F_3 ( V_43 , V_42 ) ;
}
static void F_32 ( char * V_21 , struct V_1 * V_1 , T_1 V_2 , T_1 V_35 )
{
char * V_14 = F_5 ( V_1 ) ;
memcpy ( V_21 , V_14 + V_2 , V_35 ) ;
F_8 ( V_14 ) ;
}
static void F_33 ( struct V_1 * V_1 , T_1 V_2 , char * V_14 , T_1 V_35 )
{
char * V_21 = F_5 ( V_1 ) ;
memcpy ( V_21 + V_2 , V_14 , V_35 ) ;
F_8 ( V_21 ) ;
}
...
{
const struct V_44 * V_45 = V_5 -> V_45 ;
T_1 V_35 = V_45 -> V_46 - V_5 -> V_16 ;
if ( V_35 > V_5 -> V_15 )
V_35 = V_5 -> V_15 ;
if ( V_35 > V_33 )
V_35 = V_33 ;
* V_34 = V_45 -> V_48 + V_5 -> V_16 ;
F_41 ( * V_32 = V_45 -> V_47 ) ;
return V_35 ;
}
...
V_35 = V_33 ;
* V_34 = V_45 -> V_48 + V_5 -> V_16 ;
* V_32 = F_28 ( sizeof( struct V_1 * ) , V_40 ) ;
if ( ! * V_32 )
return - V_41 ;
F_41 ( * * V_32 = V_45 -> V_47 ) ;
return V_35 ;
}
static int F_43 ( const struct V_4 * V_5 , int V_42 )
{
T_1 V_2 = V_5 -> V_16 ;
T_1 V_27 = V_5 -> V_15 ;
const struct V_44 * V_45 = V_5 -> V_45 ;
...
{
if ( V_5 -> type & V_25 )
return F_40 ( V_5 , V_32 , V_33 , V_34 ) ;
else
return F_25 ( V_5 , V_32 , V_33 , V_34 ) ;
}
...
{
if ( V_5 -> type & V_25 )
return F_42 ( V_5 , V_32 , V_33 , V_34 ) ;
else
return F_27 ( V_5 , V_32 , V_33 , V_34 ) ;
}
int F_52 ( const struct V_4 * V_5 , int V_42 )
{
if ( V_5 -> type & V_25 )
return F_43 ( V_5 , V_42 ) ;
else
return F_31 ( V_5 , V_42 ) ;
}
