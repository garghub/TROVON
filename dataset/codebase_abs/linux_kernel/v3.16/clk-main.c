...
static unsigned long F_46 ( struct V_7 * V_8 ,
unsigned long V_43 )
{
struct V_61 * V_62 = F_44 ( V_8 ) ;
...
void T_3 F_48 ( struct V_37 * V_38 ,
struct V_9 * V_10 )
{
struct V_19 * V_19 ;
const char * V_21 ;
...
V_21 = F_25 ( V_38 , 0 ) ;
F_23 ( V_38 , L_1 , & V_20 ) ;
V_19 = F_47 ( V_10 , V_20 , V_21 ) ;
if ( F_19 ( V_19 ) )
return;
F_27 ( V_38 , V_39 , V_19 ) ;
}
static T_1 F_49 ( int V_1 , void * V_2 )
{
...
static unsigned long F_53 ( struct V_7 * V_8 ,
unsigned long V_43 )
{
struct V_64 * V_62 = F_51 ( V_8 ) ;
return F_42 ( V_62 -> V_10 , V_43 ) ;
}
static int F_54 ( struct V_7 * V_8 , T_4 V_66 )
{
struct V_64 * V_62 = F_51 ( V_8 ) ;
struct V_9 * V_10 = V_62 -> V_10 ;
T_2 V_11 ;
...
static T_4 F_55 ( struct V_7 * V_8 )
{
struct V_64 * V_62 = F_51 ( V_8 ) ;
...
void T_3 F_57 ( struct V_37 * V_38 ,
struct V_9 * V_10 )
{
struct V_19 * V_19 ;
const char * V_31 [ 2 ] ;
