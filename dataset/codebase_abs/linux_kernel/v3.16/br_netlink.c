...
F_55 ( V_7 , V_112 ^ V_7 -> V_9 ) ;
return 0 ;
}
int F_56 ( struct V_34 * V_35 , struct V_39 * V_40 )
{
struct V_64 * V_113 ;
struct V_64 * V_114 ;
struct V_6 * V_7 ;
...
int V_85 = 0 ;
V_113 = F_57 ( V_40 , sizeof( struct V_1 ) , V_66 ) ;
V_114 = F_57 ( V_40 , sizeof( struct V_1 ) , V_79 ) ;
if ( ! V_113 && ! V_114 )
return 0 ;
V_7 = F_36 ( V_35 ) ;
if ( ! V_7 && ! V_114 )
...
if ( F_60 ( V_113 ) < sizeof( T_2 ) )
return - V_99 ;
F_58 ( & V_7 -> V_37 -> V_118 ) ;
V_85 = F_44 ( V_7 , F_49 ( V_113 ) ) ;
F_59 ( & V_7 -> V_37 -> V_118 ) ;
}
if ( V_85 )
goto V_91;
...
static int F_62 ( struct V_64 * V_95 [] , struct V_64 * V_121 [] )
{
if ( V_95 [ V_58 ] ) {
if ( F_60 ( V_95 [ V_58 ] ) != V_122 )
return - V_99 ;
...
static int F_64 ( struct V_84 * V_124 , struct V_34 * V_35 ,
struct V_64 * V_95 [] , struct V_64 * V_121 [] )
{
struct V_36 * V_37 = F_11 ( V_35 ) ;
if ( V_95 [ V_58 ] ) {
F_58 ( & V_37 -> V_118 ) ;
F_65 ( V_37 , F_39 ( V_95 [ V_58 ] ) ) ;
F_59 ( & V_37 -> V_118 ) ;
}
return F_66 ( V_35 ) ;
}
static T_1 F_67 ( const struct V_34 * V_35 )
{
struct V_70 * V_71 ;
if ( F_68 ( V_35 ) )
V_71 = F_20 ( F_36 ( V_35 ) ) ;
...
if ( ! V_71 )
return 0 ;
return V_71 -> V_125 * F_2 ( sizeof( struct V_72 ) ) ;
}
int T_5 F_69 ( void )
{
int V_85 ;
