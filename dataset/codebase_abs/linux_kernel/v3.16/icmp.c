...
F_63 () ;
V_116 = F_75 ( V_117 [ V_100 ] ) ;
if ( V_116 && V_116 -> V_118 )
V_116 -> V_118 ( V_35 , V_90 ) ;
F_68 () ;
}
static bool F_76 ( int V_119 )
{
bool V_120 ;
F_63 () ;
V_120 = F_75 ( V_117 [ V_119 ] ) -> V_121 ;
F_68 () ;
return V_120 ;
}
...
goto V_16;
case 0 :
V_90 = F_80 ( V_41 -> V_112 . V_128 . V_129 ) ;
}
break;
case V_130 :
...
if ( V_41 -> V_11 > V_131 )
goto V_16;
} else if ( V_41 -> type == V_132 )
V_90 = F_81 ( V_41 -> V_112 . V_113 ) >> 24 ;
if ( ! V_2 -> V_3 . V_133 &&
F_52 ( V_2 , V_75 -> V_26 ) == V_134 ) {
F_82 ( L_3 ,
& F_39 ( V_35 ) -> V_56 ,
V_41 -> type , V_41 -> V_11 ,
& V_75 -> V_26 , V_35 -> V_19 -> V_135 ) ;
goto V_16;
}
F_72 ( V_35 , V_90 ) ;
V_16:
...
return;
V_122:
F_24 ( F_22 ( F_78 ( V_35 ) -> V_19 ) , V_136 ) ;
goto V_16;
}
