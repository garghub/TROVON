...
V_34 = F_17 ( V_30 ) ;
V_33 = F_18 ( V_34 ) ;
V_12 = F_19 ( V_33 , union V_11 , V_24 ) ;
F_20 ( & V_12 -> V_24 . V_27 . V_25 ) ;
...
V_3 * V_45 , V_46 , * V_47 ;
struct V_48 * V_49 ;
struct V_50 * V_51 = & V_12 -> V_24 . V_27 . V_52 ;
struct V_53 * V_54 = & V_15 -> V_55 ;
V_49 = F_28 ( & V_15 -> V_56 , & V_51 -> V_57 [ 0 ] ) ;
if ( V_51 -> V_58 == V_59 ) {
if ( V_49 != NULL ) {
if ( F_29 ( V_51 -> V_60 ) ) {
V_47 = V_12 -> V_24 . V_27 . V_61 +
V_51 -> V_62 ;
V_46 = V_47 [ 3 ] ;
V_45 = & V_54 -> V_63 [ ( ( ( V_46 >>
6 ) & 0x3 ) ) - 1 ] . V_64 [ 0 ] ;
...
V_39 = V_12 -> V_24 . V_27 . V_67 - V_51 -> V_62 -
V_51 -> V_68 - V_51 -> V_69 - 8 ;
V_42 = V_12 -> V_24 . V_27 . V_61 ;
V_43 = V_42 + V_51 -> V_62 +
V_51 -> V_68 ;
...
union V_11 * V_73 )
{
struct V_50 * V_51 = & V_73 -> V_24 . V_27 . V_52 ;
...
V_82 = V_15 -> V_55 . V_90 ;
if ( V_82 == 2 ) {
V_81 = V_81 + V_84 -> V_52 . V_62 + V_91 ;
memcpy ( & V_89 , V_81 , 2 ) ;
V_89 = F_39 ( ( unsigned short ) V_89 ) ;
if ( ( V_85 != NULL ) && ( V_85 -> V_92 ) ) {
if ( V_89 == 0x888e )
V_88 = V_73 ;
else {
F_25 ( V_73 ,
...
struct V_94 * V_95 )
{
T_1 V_96 = V_73 -> V_24 . V_27 . V_52 . V_70 ;
T_4 V_97 = ( ( V_73 -> V_24 . V_27 . V_52 . V_98 & 0xffff ) << 4 ) |
( V_73 -> V_24 . V_27 . V_52 . V_99 & 0xf ) ;
if ( V_96 > 15 )
return V_21 ;
...
struct V_48 * * V_85 )
{
V_3 * V_81 = V_73 -> V_24 . V_27 . V_61 ;
T_1 V_101 = V_38 ;
struct V_50 * V_102 = & V_73 -> V_24 . V_27 . V_52 ;
...
memcpy ( V_102 -> V_111 , F_46 ( V_81 ) , V_115 ) ;
memcpy ( V_102 -> V_114 , F_47 ( V_81 ) , V_115 ) ;
memcpy ( V_102 -> V_116 , F_48 ( V_81 ) , V_115 ) ;
...
if ( ( F_51 ( V_81 ) & V_124 ) ==
V_124 ) {
if ( F_51 ( V_81 ) & ( F_52 ( 4 ) | F_52 ( 5 ) | F_52 ( 6 ) ) )
return V_21 ;
}
if ( ! memcmp ( V_107 , V_102 -> V_114 , V_115 ) )
return V_21 ;
...
V_37 = F_50 ( V_15 , V_73 , & V_85 ) ;
break;
case 2 :
memcpy ( V_102 -> V_60 , V_127 , V_115 ) ;
memcpy ( V_102 -> V_57 , V_125 , V_115 ) ;
V_37 = F_53 ( V_15 , V_73 , & V_85 ) ;
break;
case 3 :
memcpy ( V_102 -> V_60 , F_46 ( V_81 ) , V_115 ) ;
memcpy ( V_102 -> V_57 , F_47 ( V_81 ) , V_115 ) ;
return V_21 ;
default:
return V_21 ;
}
...
V_73 -> V_24 . V_27 . V_85 = V_85 ;
V_102 -> V_129 = 0 ;
if ( V_102 -> V_130 == 1 ) {
V_102 -> V_70 = F_61 ( ( V_81 + 24 ) ) ;
V_102 -> V_131 = F_62 ( ( V_81 + 24 ) ) ;
V_102 -> V_129 = F_63 ( ( V_81 + 24 ) ) ;
...
if ( V_102 -> V_132 )
V_102 -> V_62 += 4 ;
V_73 -> V_24 . V_27 . V_133 =
& V_85 -> V_134 [ V_102 -> V_70 ] ;
if ( F_40 ( V_73 , V_93 , & V_85 -> V_135 . V_136 ) ==
V_21 )
return V_21 ;
if ( V_102 -> V_137 ) {
F_64 ( V_54 , V_85 , V_102 -> V_58 ,
F_29 ( V_102 -> V_60 ) ) ;
F_65 ( V_102 -> V_68 , V_102 -> V_69 ,
V_102 -> V_58 ) ;
} else {
V_102 -> V_58 = 0 ;
...
type = F_67 ( V_81 ) ;
V_138 = F_51 ( V_81 ) ;
V_102 -> V_128 = F_68 ( V_81 ) ;
V_102 -> V_99 = F_69 ( V_81 ) ;
V_102 -> V_98 = F_70 ( V_81 ) ;
V_102 -> V_141 = F_71 ( V_81 ) ;
V_102 -> V_142 = F_72 ( V_81 ) ;
V_102 -> V_143 = F_73 ( V_81 ) ;
V_102 -> V_137 = F_74 ( V_81 ) ;
V_102 -> V_132 = F_75 ( V_81 ) ;
switch ( type ) {
case V_144 :
...
break;
case V_146 :
V_102 -> V_130 = ( V_138 & F_52 ( 7 ) ) ? 1 : 0 ;
V_139 = F_56 ( V_15 , V_73 ) ;
break;
default:
return V_21 ;
}
...
struct V_103 * V_104 = & V_15 -> V_105 ;
V_3 * V_81 = F_38 ( V_12 ) ;
struct V_50 * V_102 = & V_12 -> V_24 . V_27 . V_52 ;
if ( V_102 -> V_58 )
...
( V_149 ? V_153 : 0 ) ;
V_67 = V_12 -> V_24 . V_27 . V_67 - V_147 ;
if ( ( F_44 ( V_104 , V_119 ) == true ) ) {
V_81 += V_147 ;
* V_81 = 0x87 ;
* ( V_81 + 1 ) = 0x12 ;
V_148 = 0x8712 ;
V_81 = F_77 ( V_12 , ( V_147 -
sizeof( struct V_158 ) + 2 ) - 24 ) ;
memcpy ( V_81 , F_78 ( V_12 ) , 24 ) ;
V_81 += 24 ;
} else
V_81 = F_77 ( V_12 , ( V_147 -
...
V_30 = & ( V_7 -> V_13 ) ;
V_166 = & ( V_7 -> V_14 ) ;
V_34 = V_12 -> V_24 . V_27 . V_172 ;
V_163 = V_12 -> V_24 . V_27 . V_61 ;
V_164 = V_12 -> V_24 . V_27 . V_173 ;
...
goto V_178;
V_7 -> V_179 ++ ;
V_7 -> V_180 += ( T_3 ) ( V_12 -> V_24 . V_27 . V_173 -
V_12 -> V_24 . V_27 . V_61 ) ;
return V_101 ;
V_178:
V_7 -> V_181 ++ ;
