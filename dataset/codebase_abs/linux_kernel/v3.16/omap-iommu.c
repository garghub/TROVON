...
F_13 ( V_9 -> V_7 ) ;
if ( V_17 && V_17 -> V_24 )
V_17 -> V_24 ( V_15 , V_17 -> V_21 ) ;
}
void F_14 ( struct V_25 * V_26 , struct V_27 * V_28 )
{
F_15 ( ! V_26 || ! V_28 ) ;
V_3 -> V_29 ( V_26 , V_28 ) ;
}
static inline int F_16 ( struct V_25 * V_26 )
{
if ( ! V_26 )
return - V_30 ;
return V_3 -> V_31 ( V_26 ) ;
}
static inline struct V_25 * F_17 ( struct V_8 * V_9 ,
struct V_27 * V_28 )
{
if ( ! V_28 )
return NULL ;
return V_3 -> V_32 ( V_9 , V_28 ) ;
}
static T_1 F_18 ( struct V_25 * V_26 )
{
return V_3 -> V_33 ( V_26 ) ;
}
static T_1 F_19 ( struct V_27 * V_28 )
{
return V_3 -> V_34 ( V_28 ) ;
}
...
static void F_27 ( struct V_8 * V_9 , struct V_25 * V_26 )
{
V_3 -> V_45 ( V_9 , V_26 ) ;
}
static void F_28 ( struct V_8 * V_9 , struct V_25 * V_26 )
{
V_3 -> V_46 ( V_9 , V_26 ) ;
F_26 ( V_9 , 1 , V_47 ) ;
F_26 ( V_9 , 1 , V_48 ) ;
}
static inline T_2 F_29 ( struct V_8 * V_9 , struct V_25 * V_26 ,
char * V_49 )
{
F_15 ( ! V_26 || ! V_49 ) ;
return V_3 -> V_50 ( V_9 , V_26 , V_49 ) ;
}
static struct V_25 F_30 ( struct V_8 * V_9 , int V_51 )
{
struct V_25 V_26 ;
struct V_37 V_38 ;
F_21 ( V_9 , & V_38 ) ;
...
static int F_31 ( struct V_8 * V_9 , struct V_27 * V_28 )
{
int V_13 = 0 ;
struct V_37 V_38 ;
struct V_25 * V_26 ;
if ( ! V_9 || ! V_9 -> V_52 || ! V_28 )
return - V_30 ;
F_11 ( V_9 -> V_7 ) ;
F_21 ( V_9 , & V_38 ) ;
...
static int F_38 ( struct V_8 * V_9 , struct V_27 * V_28 )
{
return F_31 ( V_9 , V_28 ) ;
}
...
static int
F_43 ( struct V_8 * V_9 , struct V_25 * V_62 , int V_63 )
{
int V_55 ;
struct V_37 V_64 ;
struct V_25 V_56 ;
struct V_25 * V_65 = V_62 ;
F_11 ( V_9 -> V_7 ) ;
F_21 ( V_9 , & V_64 ) ;
F_33 (obj, num, i, tmp) {
if ( ! F_16 ( & V_56 ) )
...
struct V_25 * V_26 ;
char * V_65 = V_49 ;
V_63 = V_58 / sizeof( * V_26 ) ;
V_63 = F_45 ( V_9 -> V_52 , V_63 ) ;
V_26 = F_46 ( V_63 , sizeof( * V_26 ) , V_66 ) ;
if ( ! V_26 )
return 0 ;
V_63 = F_43 ( V_9 , V_26 , V_63 ) ;
for ( V_55 = 0 ; V_55 < V_63 ; V_55 ++ )
V_65 += F_29 ( V_9 , V_26 + V_55 , V_65 ) ;
F_37 ( V_26 ) ;
return V_65 - V_49 ;
}
...
static int
F_67 ( struct V_8 * V_9 , struct V_27 * V_28 )
{
...
V_81 = F_19 ( V_28 ) ;
F_57 ( & V_9 -> V_77 ) ;
V_13 = F_48 ( V_9 , V_28 -> V_35 , V_28 -> V_80 , V_81 ) ;
F_55 ( & V_9 -> V_77 ) ;
return V_13 ;
}
int F_69 ( struct V_8 * V_9 , struct V_27 * V_28 )
{
int V_13 ;
F_39 ( V_9 , V_28 -> V_35 ) ;
V_13 = F_67 ( V_9 , V_28 ) ;
...
if ( ! F_71 ( * V_75 ) ) {
F_10 ( V_9 -> V_7 , L_11 ,
V_9 -> V_113 , V_107 , V_35 , V_75 , * V_75 ) ;
return V_111 ;
}
V_73 = F_61 ( V_75 , V_35 ) ;
F_10 ( V_9 -> V_7 , L_12 ,
V_9 -> V_113 , V_107 , V_35 , V_75 , * V_75 , V_73 , * V_73 ) ;
return V_111 ;
}
...
F_55 ( & V_9 -> V_114 ) ;
F_34 ( V_9 -> V_7 , L_15 , V_5 , V_9 -> V_113 ) ;
return V_9 ;
V_117:
if ( V_9 -> V_110 == 1 )
F_12 ( V_9 ) ;
...
struct V_118 * V_119 ;
struct V_16 * V_17 = V_15 -> V_7 . V_18 ;
struct V_120 * V_121 = V_15 -> V_7 . V_122 ;
V_9 = F_86 ( & V_15 -> V_7 , sizeof( * V_9 ) + V_123 , V_66 ) ;
if ( ! V_9 )
return - V_78 ;
if ( V_121 ) {
V_9 -> V_113 = F_87 ( & V_15 -> V_7 ) ;
V_9 -> V_52 = 32 ;
V_13 = F_88 ( V_121 , L_16 ,
& V_9 -> V_52 ) ;
if ( V_13 && V_13 != - V_30 )
return V_13 ;
if ( V_9 -> V_52 != 32 && V_9 -> V_52 != 8 )
return - V_30 ;
V_9 -> V_124 = 0 ;
V_9 -> V_125 = 0xfffff000 ;
if ( F_89 ( V_121 , L_17 , NULL ) )
V_9 -> V_126 = V_127 ;
} else {
V_9 -> V_52 = V_17 -> V_52 ;
V_9 -> V_113 = V_17 -> V_113 ;
V_9 -> V_124 = V_17 -> V_124 ;
V_9 -> V_125 = V_17 -> V_125 ;
}
if ( V_9 -> V_125 <= V_9 -> V_124 )
return - V_30 ;
V_9 -> V_7 = & V_15 -> V_7 ;
V_9 -> V_128 = ( void * ) V_9 + sizeof( * V_9 ) ;
F_90 ( & V_9 -> V_114 ) ;
F_91 ( & V_9 -> V_129 ) ;
F_90 ( & V_9 -> V_77 ) ;
F_92 ( & V_9 -> V_130 ) ;
V_119 = F_93 ( V_15 , V_131 , 0 ) ;
V_9 -> V_132 = F_94 ( V_9 -> V_7 , V_119 ) ;
if ( F_35 ( V_9 -> V_132 ) )
return F_36 ( V_9 -> V_132 ) ;
V_106 = F_95 ( V_15 , 0 ) ;
if ( V_106 < 0 )
return - V_19 ;
V_13 = F_96 ( V_9 -> V_7 , V_106 , F_75 , V_133 ,
F_87 ( V_9 -> V_7 ) , V_9 ) ;
if ( V_13 < 0 )
return V_13 ;
F_97 ( V_15 , V_9 ) ;
...
static T_1 F_106 ( struct V_27 * V_28 , T_1 V_35 , T_1 V_80 , int V_93 )
{
...
V_28 -> V_139 = V_140 ;
V_28 -> V_141 = 0 ;
return F_40 ( V_28 -> V_93 ) ;
}
static int F_107 ( struct V_108 * V_109 , unsigned long V_35 ,
T_5 V_80 , T_3 V_58 , int V_81 )
{
struct V_142 * V_143 = V_109 -> V_144 ;
struct V_8 * V_145 = V_143 -> V_146 ;
...
F_106 ( & V_28 , V_35 , V_80 , V_147 ) ;
V_148 = F_69 ( V_145 , & V_28 ) ;
if ( V_148 )
F_10 ( V_7 , L_22 , V_148 ) ;
return V_148 ;
}
static T_3 F_109 ( struct V_108 * V_109 , unsigned long V_35 ,
T_3 V_149 )
{
struct V_142 * V_143 = V_109 -> V_144 ;
struct V_8 * V_145 = V_143 -> V_146 ;
struct V_6 * V_7 = V_145 -> V_7 ;
F_34 ( V_7 , L_23 , V_35 , V_149 ) ;
return F_73 ( V_145 , V_35 ) ;
}
static int
F_110 ( struct V_108 * V_109 , struct V_6 * V_7 )
{
struct V_142 * V_143 = V_109 -> V_144 ;
struct V_8 * V_145 ;
struct V_150 * V_151 = V_7 -> V_152 . V_153 ;
int V_148 = 0 ;
F_57 ( & V_143 -> V_154 ) ;
if ( V_143 -> V_146 ) {
F_10 ( V_7 , L_24 ) ;
...
V_145 = F_80 ( V_151 -> V_113 , V_143 -> V_155 ) ;
if ( F_35 ( V_145 ) ) {
V_148 = F_36 ( V_145 ) ;
F_10 ( V_7 , L_25 , V_148 ) ;
goto V_53;
}
V_143 -> V_146 = V_151 -> V_146 = V_145 ;
V_143 -> V_7 = V_7 ;
V_145 -> V_109 = V_109 ;
V_53:
F_55 ( & V_143 -> V_154 ) ;
...
static void F_111 ( struct V_142 * V_143 ,
struct V_6 * V_7 )
{
struct V_8 * V_145 = F_5 ( V_7 ) ;
struct V_150 * V_151 = V_7 -> V_152 . V_153 ;
if ( V_143 -> V_146 != V_145 ) {
F_10 ( V_7 , L_26 ) ;
return;
}
F_74 ( V_145 ) ;
F_83 ( V_145 ) ;
V_143 -> V_146 = V_151 -> V_146 = NULL ;
V_143 -> V_7 = NULL ;
}
...
{
struct V_142 * V_143 ;
V_143 = F_114 ( sizeof( * V_143 ) , V_66 ) ;
if ( ! V_143 ) {
F_3 ( L_27 ) ;
goto V_53;
}
V_143 -> V_155 = F_114 ( V_156 , V_66 ) ;
if ( ! V_143 -> V_155 ) {
F_3 ( L_27 ) ;
goto V_157;
}
F_15 ( ! F_115 ( ( long ) V_143 -> V_155 , V_156 ) ) ;
F_105 ( V_143 -> V_155 , V_156 ) ;
F_90 ( & V_143 -> V_154 ) ;
V_109 -> V_144 = V_143 ;
V_109 -> V_158 . V_159 = 0 ;
V_109 -> V_158 . V_160 = ( 1ULL << 32 ) - 1 ;
V_109 -> V_158 . V_161 = true ;
return 0 ;
V_157:
F_37 ( V_143 ) ;
V_53:
...
static void F_116 ( struct V_108 * V_109 )
{
struct V_142 * V_143 = V_109 -> V_144 ;
V_109 -> V_144 = NULL ;
if ( V_143 -> V_146 )
F_111 ( V_143 , V_143 -> V_7 ) ;
F_37 ( V_143 -> V_155 ) ;
F_37 ( V_143 ) ;
}
static T_5 F_117 ( struct V_108 * V_109 ,
T_6 V_35 )
{
struct V_142 * V_143 = V_109 -> V_144 ;
struct V_8 * V_145 = V_143 -> V_146 ;
...
T_1 * V_162 , * V_163 ;
T_5 V_148 = 0 ;
F_70 ( V_145 , V_35 , & V_162 , & V_163 ) ;
if ( V_163 ) {
if ( F_118 ( * V_163 ) )
V_148 = F_119 ( * V_163 , V_35 , V_164 ) ;
else if ( F_120 ( * V_163 ) )
V_148 = F_119 ( * V_163 , V_35 , V_90 ) ;
else
F_10 ( V_7 , L_28 , * V_163 ,
( unsigned long long ) V_35 ) ;
} else {
if ( F_121 ( * V_162 ) )
V_148 = F_119 ( * V_162 , V_35 , V_82 ) ;
else if ( F_122 ( * V_162 ) )
V_148 = F_119 ( * V_162 , V_35 , V_85 ) ;
else
F_10 ( V_7 , L_29 , * V_162 ,
( unsigned long long ) V_35 ) ;
}
...
if ( ! V_7 -> V_122 )
return 0 ;
V_165 = F_124 ( V_7 -> V_122 , L_30 , 0 ) ;
if ( ! V_165 )
return 0 ;
V_151 = F_114 ( sizeof( * V_151 ) , V_66 ) ;
if ( ! V_151 ) {
F_125 ( V_165 ) ;
return - V_78 ;
}
V_151 -> V_113 = F_126 ( F_87 ( V_7 ) , V_66 ) ;
V_7 -> V_152 . V_153 = V_151 ;
F_125 ( V_165 ) ;
return 0 ;
}
...
{
struct V_166 * V_65 ;
const unsigned long V_167 = V_168 ;
T_3 V_169 = 1 << 10 ;
V_65 = F_129 ( L_31 , V_134 , V_169 , V_167 ,
F_104 ) ;
if ( ! V_65 )
return - V_78 ;
V_74 = V_65 ;
