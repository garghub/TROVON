...
static int F_78 ( struct V_175 * V_176 , T_3 V_177 ,
...
if ( F_79 ( V_187 , & V_184 , sizeof( V_184 ) ) )
return - V_192 ;
return 0 ;
}
switch ( V_178 ) {
...
return - V_196 ;
if ( F_80 ( & V_186 , V_187 , sizeof( V_186 ) ) )
return - V_192 ;
if ( F_68 ( V_135 , 0 ) )
F_70 ( V_135 ) ;
if ( V_24 . V_12 & V_136 )
...
if ( V_168 -> V_195 != 1 && V_168 -> V_195 != - 1 )
return - V_196 ;
if ( F_80 ( & V_181 , V_187 , sizeof( V_181 ) ) )
return - V_192 ;
...
static int F_82 ( struct V_175 * V_176 , T_3 V_177 ,
unsigned int V_178 , unsigned long V_208 )
{
int V_209 ;
F_83 ( & V_210 ) ;
V_209 = F_78 ( V_176 , V_177 , V_178 , V_208 ) ;
F_84 ( & V_210 ) ;
return V_209 ;
}
static void T_5 F_85 ( int V_16 )
{
V_24 . V_40 = 0 ;
V_26 = NULL ;
if ( ! F_86 ( V_16 ) )
...
static int F_89 ( struct V_175 * V_176 , T_3 V_177 )
{
struct V_152 * V_66 = V_176 -> V_180 -> V_153 ;
int type = F_90 ( V_176 -> V_224 ) >> 2 ;
F_21 ( ( L_46 , type ) ) ;
...
static int F_91 ( struct V_175 * V_176 , T_3 V_177 )
{
int V_209 ;
F_83 ( & V_210 ) ;
V_209 = F_89 ( V_176 , V_177 ) ;
F_84 ( & V_210 ) ;
return V_209 ;
}
static void F_92 ( struct V_150 * V_135 , T_3 V_177 )
{
struct V_152 * V_66 = V_135 -> V_153 ;
F_83 ( & V_210 ) ;
if ( V_66 -> V_195 < 0 )
...
static struct V_230 * F_93 ( T_6 V_231 , int * V_232 , void * V_233 )
{
int V_16 = * V_232 & 3 ;
int type = * V_232 >> 2 ;
...
V_134 [ V_234 ] . V_135 -> V_166 = F_100 ( F_77 ,
& V_242 ) ;
if ( ! V_134 [ V_234 ] . V_135 -> V_166 )
goto V_237;
F_58 ( V_134 [ V_234 ] . V_135 , V_205 * 2 ) ;
F_101 ( V_134 [ V_234 ] . V_135 ) ;
}
F_102 ( F_103 ( V_236 , 0 ) , 256 , V_243 ,
F_93 , NULL , NULL ) ;
F_32 ( V_137 L_52 ,
V_77 == 0 ? 'D' : V_77 == 1 ? 'H' : 'E' ,
V_88 ? L_34 : L_53 ) ;
...
static int T_5 F_107 ( char * V_245 )
{
int V_246 [ 3 + V_167 ] ;
int V_234 ;
if ( ! V_235 )
return 0 ;
V_245 = F_108 ( V_245 , 3 + V_167 , V_246 ) ;
if ( V_246 [ 0 ] < 1 ) {
F_32 ( V_59 L_54 ) ;
return 0 ;
}
...
{
int V_234 ;
F_110 ( F_103 ( V_236 , 0 ) , 256 ) ;
for ( V_234 = 0 ; V_234 < V_167 ; V_234 ++ ) {
struct V_161 * V_162 = V_134 [ V_234 ] . V_135 -> V_166 ;
F_111 ( V_134 [ V_234 ] . V_135 ) ;
F_104 ( V_134 [ V_234 ] . V_135 ) ;
F_105 ( V_162 ) ;
}
F_106 ( V_236 , L_48 ) ;
