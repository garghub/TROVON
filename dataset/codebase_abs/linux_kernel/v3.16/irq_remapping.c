...
if ( ! V_45 || ! V_45 -> V_36 )
return - V_51 ;
return V_45 -> V_36 ( V_12 , V_77 ) ;
}
void F_40 ( const char * V_73 )
{
if ( V_53 )
F_41 ( V_73 ) ;
}
...
{
F_43 () ;
F_45 ( V_64 -> V_12 , V_64 -> V_78 ) ;
}
static void F_46 ( struct V_63 * V_64 , struct V_79 * V_80 )
{
F_47 ( V_80 , L_6 , V_64 -> V_81 -> V_82 ) ;
}
void F_48 ( struct V_83 * V_81 )
{
V_81 -> V_84 = F_46 ;
V_81 -> V_85 = F_42 ;
V_81 -> V_86 = F_44 ;
...
bool F_49 ( int V_12 , struct V_1 * V_2 , struct V_83 * V_81 )
{
if ( ! F_1 ( V_2 ) )
return false ;
F_50 ( V_12 , V_88 ) ;
