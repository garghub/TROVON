...
int F_25 ( struct V_1 * V_2 , T_2 * V_75 )
{
F_1 ( V_2 , false , true ) ;
* V_75 = F_6 ( V_2 , V_22 ) ;
F_1 ( V_2 , false , false ) ;
...
return V_63 ;
F_1 ( V_2 , false , true ) ;
F_27 ( V_2 , V_77 , V_59 , V_69 , V_53 ) ;
F_1 ( V_2 , false , false ) ;
return V_62 ;
}
void
F_29 ( struct V_1 * V_19 , T_1 V_20 , T_1 * V_78 )
{
T_2 V_76 = 0 ;
F_1 ( V_19 , false , true ) ;
F_14 ( V_19 , V_20 , V_47 ,
( void * ) & V_76 ) ;
F_27 ( V_19 , V_20 , 0 , V_76 , V_78 ) ;
...
* V_58 = V_81 -> V_82 [ V_79 ] ;
* V_58 |= V_81 -> V_82 [ V_79 + 1 ] << 8 ;
* V_58 |= V_81 -> V_82 [ V_79 + 2 ] << 16 ;
* V_58 |= V_81 -> V_82 [ V_79 + 3 ] << 24 ;
}
...
{
if ( Type == 1 )
F_30 ( V_19 , V_79 , ( T_1 * ) V_58 ) ;
else if ( Type == 2 )
F_32 ( V_19 , V_79 , ( T_2 * ) V_58 ) ;
else if ( Type == 4 )
F_33 ( V_19 , V_79 , ( T_3 * ) V_58 ) ;
}
