...
( unsigned long long ) F_150 ( V_236 -> V_239 ) ) ;
F_158 () ;
F_121 ( V_17 , V_236 , sizeof( * V_236 ) ) ;
F_56 ( V_17 ) ;
}
...
struct V_43 * V_46 = F_25 ( V_17 -> V_72 -> V_110 ) ;
#ifdef F_159
unsigned long V_241 = F_160 ( F_4 () ) -
F_160 ( V_17 -> V_21 ) ;
#else
unsigned long V_241 = F_22 () ;
#endif
F_85 ( V_107 L_17 V_108 L_60
L_61 , F_86 ( V_17 ) ,
V_241 / 1000 , V_241 % 1000 ) ;
F_152 ( & V_46 -> V_224 , 1 ) ;
F_71 ( V_17 , & V_17 -> V_82 ) ;
}
...
struct V_16 * V_17 = NULL ;
struct V_75 * V_7 = NULL , * V_242 = NULL ;
struct V_165 * V_114 = NULL ;
struct V_243 V_244 = { 0 , } , V_245 = { 0 , } ;
int V_49 = 0 , V_246 ;
unsigned int V_247 ;
if ( F_88 () <= F_27 ( V_46 ) )
goto V_63;
...
F_29 ( & V_46 -> V_50 ) ;
V_247 = F_78 ( & V_46 -> V_224 ) ;
V_246 = ( V_46 -> V_101 ||
( V_46 -> V_99 &&
( V_46 -> V_99 != - V_102 || V_247 == 0 ) ) ) ;
F_32 ( & V_46 -> V_50 ) ;
if ( V_246 )
goto V_63;
V_46 -> V_111 = V_112 ;
...
V_49 = F_164 ( V_248 , V_249 , V_250 , & V_114 ) ;
if ( V_49 < 0 ) {
F_44 ( 0 , L_63 , V_49 ) ;
goto V_63;
}
V_17 -> V_71 = V_114 ;
V_114 -> V_115 -> V_251 = V_52 ;
V_244 . V_252 = V_253 ;
V_244 . V_254 . V_255 = V_242 -> V_256 ;
V_244 . V_257 = F_165 ( 0 ) ;
V_49 = V_114 -> V_181 -> V_258 ( V_114 , (struct V_259 * ) & V_244 ,
sizeof( V_244 ) ) ;
if ( V_49 ) {
F_44 ( V_177 , L_64 ,
V_49 , & V_242 -> V_256 ) ;
...
F_32 ( & V_46 -> V_50 ) ;
V_245 . V_252 = V_253 ;
V_245 . V_254 . V_255 = V_7 -> V_256 ;
V_245 . V_257 = V_7 -> V_260 ;
V_49 = V_17 -> V_71 -> V_181 -> V_261 ( V_17 -> V_71 ,
(struct V_259 * ) & V_245 ,
sizeof( V_245 ) ,
V_262 ) ;
if ( V_49 == - V_263 )
...
F_178 ( & V_264 , V_268 ,
F_173 , NULL , V_267 ) ;
V_49 = F_179 ( NULL , & V_264 ) ;
if ( V_49 == 0 )
V_49 = F_179 ( NULL , & V_265 ) ;
if ( V_49 )
F_175 () ;
return V_49 ;
}
static int F_180 ( struct V_165 * V_114 , int * V_269 )
{
int V_49 , V_270 ;
struct V_243 sin ;
struct V_165 * V_271 = NULL ;
...
F_24 ( V_114 == NULL ) ;
* V_269 = 0 ;
V_49 = F_181 ( V_114 -> V_115 -> V_273 , V_114 -> V_115 -> V_274 ,
V_114 -> V_115 -> V_275 , & V_271 ) ;
if ( V_49 )
goto V_63;
V_271 -> type = V_114 -> type ;
V_271 -> V_181 = V_114 -> V_181 ;
V_49 = V_114 -> V_181 -> V_276 ( V_114 , V_271 , V_262 ) ;
if ( V_49 < 0 )
goto V_63;
* V_269 = 1 ;
V_271 -> V_115 -> V_251 = V_52 ;
V_49 = F_155 ( V_271 ) ;
if ( V_49 ) {
F_44 ( V_177 , L_65 , V_49 ) ;
goto V_63;
...
V_270 = sizeof( sin ) ;
V_49 = V_271 -> V_181 -> V_277 ( V_271 , (struct V_259 * ) & sin ,
& V_270 , 1 ) ;
if ( V_49 < 0 )
goto V_63;
V_7 = F_182 ( sin . V_254 . V_255 ) ;
if ( V_7 == NULL ) {
F_85 ( V_107 L_70
L_71 , & sin . V_254 . V_255 ,
F_183 ( sin . V_257 ) ) ;
V_49 = - V_153 ;
goto V_63;
}
...
L_73
L_74 ,
V_272 -> V_278 , V_272 -> V_110 ,
& ( V_272 -> V_256 ) ,
F_183 ( V_272 -> V_260 ) ,
V_7 -> V_278 ,
V_7 -> V_110 , & sin . V_254 . V_255 ,
F_183 ( sin . V_257 ) ) ;
V_49 = - V_153 ;
goto V_63;
}
...
{
struct V_165 * V_114 = V_280 ;
int V_269 ;
int V_38 ;
for (; ; ) {
V_38 = F_180 ( V_114 , & V_269 ) ;
if ( ! V_269 )
break;
F_125 () ;
}
...
static int F_186 ( T_12 V_283 , T_13 V_284 )
{
struct V_165 * V_114 = NULL ;
int V_49 ;
struct V_243 sin = {
...
V_280 = V_114 ;
F_67 ( & V_282 , F_185 ) ;
V_114 -> V_115 -> V_286 = V_287 ;
V_49 = V_114 -> V_181 -> V_258 ( V_114 , (struct V_259 * ) & sin , sizeof( sin ) ) ;
if ( V_49 < 0 ) {
F_85 ( V_285 L_80
L_81 , V_49 , & V_283 , F_183 ( V_284 ) ) ;
goto V_63;
}
V_49 = V_114 -> V_181 -> V_288 ( V_114 , 64 ) ;
if ( V_49 < 0 )
F_85 ( V_285 L_82 ,
V_49 , & V_283 , F_183 ( V_284 ) ) ;
V_63:
if ( V_49 ) {
V_280 = NULL ;
if ( V_114 )
...
if ( F_193 () )
return - V_154 ;
V_236 = F_62 ( sizeof( struct V_215 ) , V_291 ) ;
V_240 = F_62 ( sizeof( struct V_185 ) , V_291 ) ;
V_208 = F_62 ( sizeof( struct V_185 ) , V_291 ) ;
if ( ! V_236 || ! V_240 || ! V_208 ) {
F_55 ( V_236 ) ;
F_55 ( V_240 ) ;
F_55 ( V_208 ) ;
return - V_154 ;
}
V_236 -> V_217 = F_149 ( V_218 ) ;
V_236 -> V_239 = F_149 ( 1 ) ;
V_240 -> V_187 = F_127 ( V_207 ) ;
