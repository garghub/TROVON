...
static void F_89 ( struct V_121 * V_131 )
{
...
static void F_91 ( struct V_8 * V_24 , struct V_30 * V_83 )
{
struct V_1 * V_2 ;
V_2 = V_83 -> V_2 ;
F_69 ( & V_2 -> V_84 ) ;
...
int F_96 ( struct V_43 * V_44 , const T_2 * V_42 )
{
struct V_8 * V_24 ;
struct V_1 * V_2 ;
struct V_30 * V_83 ;
...
{
struct V_49 * V_50 ;
while ( ( V_50 = F_102 ( & V_2 -> V_54 ) ) != NULL )
F_100 ( V_2 -> V_44 , V_50 ) ;
}
void F_103 ( struct V_1 * V_2 , struct V_47 * V_53 )
{
F_16 ( & V_2 -> V_84 ) ;
F_27 ( V_2 , V_53 ) ;
V_2 -> V_127 = 0xffff ;
...
static void F_105 ( struct V_27 * V_28 , bool V_25 )
{
struct V_1 * V_2 ;
struct V_30 * V_83 = F_106 ( V_28 , struct V_30 , V_33 ) ;
V_2 = V_83 -> V_2 ;
F_61 ( V_28 ) ;
if ( V_25 ) {
F_90 ( & V_2 -> V_113 ) ;
...
static int F_107 ( struct V_27 * V_28 , struct V_8 * V_14 )
{
struct V_1 * V_2 ;
struct V_30 * V_83 , * V_101 ;
T_1 V_103 ;
...
if ( V_101 == NULL )
return - V_41 ;
V_83 = F_106 ( V_28 , struct V_30 , V_33 ) ;
V_2 = V_83 -> V_2 ;
V_101 -> V_2 = V_2 ;
