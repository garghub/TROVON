...
F_94 ( V_168 , & V_6 -> V_164 -> V_94 ) ;
F_95 ( V_6 -> V_164 , V_6 ) ;
V_86 = F_96 ( V_6 -> V_164 , V_169 , - 1 ) ;
if ( V_86 )
goto V_170;
V_6 -> V_171 = F_97 ( V_6 -> V_146 -> V_172 ) ;
if ( ! V_6 -> V_171 ) {
V_86 = - V_162 ;
F_71 ( & V_58 -> V_126 , L_19 ) ;
goto V_173;
}
V_6 -> V_70 = F_98 ( & V_6 -> V_42 , V_6 -> V_171 ,
L_20 , V_6 -> V_146 -> V_174 ,
NULL ) ;
if ( ! V_6 -> V_70 ) {
V_86 = - V_162 ;
...
static void F_110 ( struct V_142 * V_58 )
{
...
static int F_112 ( struct V_142 * V_58 , T_4 V_178 )
{
struct V_177 * V_42 = F_111 ( V_58 ) ;
struct V_5 * V_6 =
F_2 ( V_42 , struct V_5 , V_42 ) ;
...
static int F_118 ( struct V_142 * V_58 )
{
struct V_177 * V_42 = F_111 ( V_58 ) ;
struct V_5 * V_6 =
F_2 ( V_42 , struct V_5 , V_42 ) ;
