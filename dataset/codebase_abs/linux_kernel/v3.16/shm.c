...
if ( V_95 << V_46 < V_93 )
return - V_99 ;
if ( V_2 -> V_10 + V_95 < V_2 -> V_10 ||
V_2 -> V_10 + V_95 > V_2 -> V_5 )
return - V_99 ;
...
F_106 ( & V_188 ) ;
V_14 -> V_16 ++ ;
V_93 = F_107 ( V_188 . V_207 -> V_208 ) ;
F_72 ( & V_14 -> V_15 ) ;
F_73 () ;
V_64 = - V_100 ;
V_39 = F_108 ( sizeof( * V_39 ) , V_209 ) ;
if ( ! V_39 ) {
F_109 ( & V_188 ) ;
goto V_210;
}
V_36 = F_110 ( & V_188 , V_189 ,
F_35 ( V_14 -> V_43 ) ?
& V_88 :
& V_211 ) ;
V_64 = F_70 ( V_36 ) ;
...
if ( V_66 + V_93 < V_66 )
goto V_217;
if ( F_113 ( V_42 -> V_215 , V_66 , V_66 + V_93 ) )
goto V_217;
if ( V_66 < V_42 -> V_215 -> V_218 &&
V_66 > V_42 -> V_215 -> V_218 - V_93 - V_45 * 5 )
goto V_217;
}
V_66 = F_114 ( V_36 , V_66 , V_93 , V_186 , V_86 , 0 , & V_190 ) ;
* V_184 = V_66 ;
V_64 = 0 ;
if ( F_115 ( V_66 ) )
V_64 = ( long ) V_66 ;
...
V_14 -> V_41 ,
V_14 -> V_16 ,
F_120 ( V_222 , V_14 -> V_15 . V_134 ) ,
F_121 ( V_222 , V_14 -> V_15 . V_135 ) ,
F_120 ( V_222 , V_14 -> V_15 . V_223 ) ,
F_121 ( V_222 , V_14 -> V_15 . V_224 ) ,
V_14 -> V_40 ,
V_14 -> V_50 ,
V_14 -> V_117 ,
V_155 * V_45 ,
