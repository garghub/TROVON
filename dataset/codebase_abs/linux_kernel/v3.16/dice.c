...
V_5 -> V_99 . V_115 [ V_2 * 2 ] = V_2 ;
V_5 -> V_99 . V_115 [ V_2 * 2 + 1 ] = V_2 + V_63 ;
}
V_1 /= 2 ;
V_63 *= 2 ;
}
...
static int F_75 ( struct V_74 * V_75 , int V_117 )
{
struct V_5 * V_5 = V_75 -> V_93 ;
struct V_74 * V_118 ;
switch ( V_117 ) {
...
struct V_136 * V_118 ;
int V_8 ;
V_8 = F_80 ( V_5 -> V_25 , L_3 , 0 , 1 , 0 , & V_118 ) ;
if ( V_8 < 0 )
return V_8 ;
V_118 -> V_93 = V_5 ;
...
static long F_81 ( struct V_141 * V_142 , char T_7 * V_143 ,
long V_144 , T_8 * V_13 )
{
...
F_8 ( & V_5 -> V_9 ) ;
if ( F_87 ( V_143 , & V_147 , V_144 ) )
return - V_156 ;
return V_144 ;
}
static unsigned int F_88 ( struct V_141 * V_142 , struct V_157 * V_157 ,
T_9 * V_145 )
{
struct V_5 * V_5 = V_142 -> V_93 ;
unsigned int V_158 ;
F_89 ( V_157 , & V_5 -> V_7 , V_145 ) ;
F_7 ( & V_5 -> V_9 ) ;
...
static int F_90 ( struct V_5 * V_5 , void T_7 * V_161 )
{
...
F_91 ( V_78 . V_168 , F_92 ( & V_162 -> V_18 ) ,
sizeof( V_78 . V_168 ) ) ;
if ( F_87 ( V_161 , & V_78 , sizeof( V_78 ) ) )
return - V_156 ;
return 0 ;
}
...
static int F_95 ( struct V_141 * V_142 , struct V_157 * V_157 )
{
struct V_5 * V_5 = V_142 -> V_93 ;
F_7 ( & V_5 -> V_9 ) ;
if ( V_5 -> V_10 == - 1 )
...
static int F_96 ( struct V_141 * V_142 , struct V_157 * V_157 ,
unsigned int V_117 , unsigned long V_161 )
{
struct V_5 * V_5 = V_142 -> V_93 ;
switch ( V_117 ) {
case V_170 :
return F_90 ( V_5 , ( void T_7 * ) V_161 ) ;
case V_171 :
return F_93 ( V_5 ) ;
case V_172 :
return F_94 ( V_5 ) ;
...
unsigned int V_117 , unsigned long V_161 )
{
return F_96 ( V_142 , V_157 , V_117 ,
( unsigned long ) F_98 ( V_161 ) ) ;
}
...
struct V_141 * V_142 ;
int V_8 ;
V_8 = F_100 ( V_5 -> V_25 , L_3 , 0 , & V_142 ) ;
if ( V_8 < 0 )
return V_8 ;
...
static const char * F_103 ( const char * const V_185 [] , unsigned int V_144 ,
unsigned int V_2 )
{
if ( V_2 < V_144 )
return V_185 [ V_2 ] ;
...
static void F_104 ( char * V_186 , unsigned int V_187 )
{
unsigned int V_2 ;
...
unsigned int V_183 , V_99 , V_2 ;
if ( F_101 ( V_5 , V_193 , 0 , F_2 ( V_193 ) ) < 0 )
return;
F_107 ( V_20 , L_34 ) ;
...
V_183 = F_108 ( T_5 , V_193 [ 1 ] , sizeof( V_143 . V_207 ) / 4 ) ;
if ( F_101 ( V_5 , & V_143 . V_207 , V_193 [ 0 ] , V_183 ) < 0 )
return;
F_107 ( V_20 , L_36 ) ;
F_107 ( V_20 , L_37 ,
V_143 . V_207 . V_196 >> 16 ,
V_143 . V_207 . V_196 & 0xffff , V_143 . V_207 . V_197 ) ;
F_107 ( V_20 , L_38 , V_143 . V_207 . V_155 ) ;
F_104 ( V_143 . V_207 . V_198 , V_199 ) ;
F_107 ( V_20 , L_39 , V_143 . V_207 . V_198 ) ;
F_107 ( V_20 , L_40 ,
F_103 ( V_192 , F_2 ( V_192 ) ,
V_143 . V_207 . V_200 & V_224 ) ,
F_103 ( V_97 , F_2 ( V_97 ) ,
( V_143 . V_207 . V_200 & V_225 )
>> V_112 ) ) ;
F_107 ( V_20 , L_41 , V_143 . V_207 . V_201 ) ;
F_107 ( V_20 , L_42 ,
...
V_227 )
>> V_112 ) ) ;
F_107 ( V_20 , L_45 , V_143 . V_207 . V_202 ) ;
F_107 ( V_20 , L_46 , V_143 . V_207 . V_203 ) ;
F_107 ( V_20 , L_47 ,
...
F_107 ( V_20 , L_49 , V_192 [ V_2 ] ) ;
F_107 ( V_20 , L_50 ) ;
F_104 ( V_143 . V_207 . V_205 ,
V_206 ) ;
F_107 ( V_20 , L_51 ,
V_143 . V_207 . V_205 ) ;
}
if ( F_101 ( V_5 , & V_195 , V_193 [ 2 ] , 2 ) < 0 )
return;
V_183 = F_108 ( T_5 , V_195 . V_187 , sizeof( V_143 . V_216 ) / 4 ) ;
for ( V_99 = 0 ; V_99 < V_195 . V_194 ; ++ V_99 ) {
if ( F_101 ( V_5 , & V_143 . V_216 , V_193 [ 2 ] + 2 +
V_99 * V_195 . V_187 ,
V_183 ) < 0 )
break;
F_107 ( V_20 , L_52 , V_99 ) ;
F_107 ( V_20 , L_53 , ( int ) V_143 . V_216 . V_208 ) ;
F_107 ( V_20 , L_54 ,
V_143 . V_216 . V_209 ) ;
F_107 ( V_20 , L_55 , V_143 . V_216 . V_210 ) ;
F_107 ( V_20 , L_56 , 100u << V_143 . V_216 . V_211 ) ;
if ( V_183 >= 68 ) {
F_104 ( V_143 . V_216 . V_212 , V_213 ) ;
F_107 ( V_20 , L_57 , V_143 . V_216 . V_212 ) ;
}
if ( V_183 >= 70 ) {
F_107 ( V_20 , L_58 ,
V_143 . V_216 . V_214 ) ;
...
if ( F_101 ( V_5 , & V_195 , V_193 [ 4 ] , 2 ) < 0 )
return;
V_183 = F_108 ( T_5 , V_195 . V_187 , sizeof( V_143 . V_219 ) / 4 ) ;
for ( V_99 = 0 ; V_99 < V_195 . V_194 ; ++ V_99 ) {
if ( F_101 ( V_5 , & V_143 . V_219 , V_193 [ 4 ] + 2 +
V_99 * V_195 . V_187 ,
V_183 ) < 0 )
break;
F_107 ( V_20 , L_60 , V_99 ) ;
F_107 ( V_20 , L_53 , ( int ) V_143 . V_219 . V_208 ) ;
F_107 ( V_20 , L_61 , V_143 . V_219 . V_217 ) ;
F_107 ( V_20 , L_54 ,
V_143 . V_219 . V_209 ) ;
F_107 ( V_20 , L_55 , V_143 . V_219 . V_210 ) ;
if ( V_183 >= 68 ) {
F_104 ( V_143 . V_219 . V_212 , V_218 ) ;
F_107 ( V_20 , L_57 , V_143 . V_219 . V_212 ) ;
}
if ( V_183 >= 70 ) {
F_107 ( V_20 , L_58 ,
V_143 . V_219 . V_214 ) ;
...
V_183 = F_108 ( T_5 , V_193 [ 7 ] , sizeof( V_143 . V_223 ) / 4 ) ;
if ( V_183 >= 4 ) {
if ( F_101 ( V_5 , & V_143 . V_223 ,
V_193 [ 6 ] , 4 ) < 0 )
return;
F_107 ( V_20 , L_62 ) ;
F_107 ( V_20 , L_63 ,
...
F_2 ( V_192 ) ,
V_143 . V_223 . V_220 ) ) ;
F_107 ( V_20 , L_64 , V_143 . V_223 . V_221 ) ;
F_107 ( V_20 , L_65 ,
F_103 ( V_97 , F_2 ( V_97 ) ,
V_143 . V_223 . V_1 ) ) ;
F_107 ( V_20 , L_66 ) ;
...
{
struct V_188 * V_189 ;
if ( ! F_110 ( V_5 -> V_25 , L_69 , & V_189 ) )
F_111 ( V_189 , V_5 , F_106 ) ;
}
static void F_112 ( struct V_229 * V_25 )
{
...
static int F_116 ( struct V_230 * V_19 )
{
...
T_3 V_239 [ 4 ] ;
T_3 V_204 ;
F_117 ( & V_233 , V_19 -> V_240 ) ;
while ( F_118 ( & V_233 , & V_234 , & V_36 ) ) {
switch ( V_234 ) {
case V_241 :
V_235 = V_36 ;
break;
...
if ( V_8 < 0 )
return V_8 ;
V_5 -> V_72 [ V_70 ] = F_119 ( V_249 [ 0 ] ) ;
V_5 -> V_116 [ V_70 ] = F_119 ( V_249 [ 1 ] ) ;
return 0 ;
}
...
if ( V_8 < 0 )
return V_8 ;
V_5 -> V_15 = F_119 ( V_238 [ 0 ] ) * 4 ;
V_5 -> V_16 = F_119 ( V_238 [ 4 ] ) * 4 ;
if ( F_119 ( V_238 [ 1 ] ) * 4 >= V_251 + 4 ) {
V_8 = F_18 (
V_5 -> V_19 , V_247 ,
F_11 ( V_5 , V_251 ) ,
& V_36 , 4 , 0 ) ;
...
F_124 ( V_199 < sizeof( V_25 -> V_138 ) ) ;
V_8 = F_18 ( V_5 -> V_19 , V_184 ,
F_11 ( V_5 , V_257 ) ,
V_25 -> V_138 , sizeof( V_25 -> V_138 ) , 0 ) ;
if ( V_8 >= 0 ) {
F_124 ( sizeof( V_25 -> V_138 ) % 4 != 0 ) ;
for ( V_2 = 0 ; V_2 < sizeof( V_25 -> V_138 ) ; V_2 += 4 )
F_125 ( ( T_5 * ) & V_25 -> V_138 [ V_2 ] ) ;
V_25 -> V_138 [ sizeof( V_25 -> V_138 ) - 1 ] = '\0' ;
}
strcpy ( V_235 , L_71 ) ;
F_126 ( V_162 -> V_167 + 5 , V_258 , V_235 , sizeof( V_235 ) ) ;
strcpy ( V_236 , L_71 ) ;
F_126 ( V_5 -> V_19 -> V_240 , V_242 , V_236 , sizeof( V_236 ) ) ;
snprintf ( V_25 -> V_259 , sizeof( V_25 -> V_259 ) ,
L_72 ,
V_235 , V_236 , V_162 -> V_167 [ 4 ] & 0x3fffff ,
F_92 ( & V_5 -> V_19 -> V_18 ) , 100 << V_162 -> V_102 ) ;
strcpy ( V_25 -> V_260 , L_3 ) ;
}
static int F_127 ( struct V_230 * V_19 , const struct V_261 * V_262 )
{
struct V_229 * V_25 ;
struct V_5 * V_5 ;
T_3 V_263 ;
...
if ( V_8 < 0 )
return V_8 ;
V_8 = F_128 ( & V_19 -> V_18 , - 1 , NULL , V_264 ,
sizeof( * V_5 ) , & V_25 ) ;
if ( V_8 < 0 )
return V_8 ;
V_5 = V_25 -> V_93 ;
...
if ( V_8 < 0 )
goto V_269;
V_5 -> V_100 . V_270 = 0x00000000ffffffffuLL ;
V_8 = F_135 ( & V_5 -> V_99 , V_19 , V_271 ,
V_272 ) ;
if ( V_8 < 0 )
goto V_105;
V_25 -> V_273 = F_112 ;
...
static void F_140 ( struct V_230 * V_19 )
{
...
static void F_145 ( struct V_230 * V_19 )
{
struct V_5 * V_5 = F_141 ( & V_19 -> V_18 ) ;
F_142 ( & V_5 -> V_99 ) ;
F_61 ( & V_5 -> V_111 ) ;
