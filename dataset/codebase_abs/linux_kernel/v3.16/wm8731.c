...
V_8 -> V_85 [ V_10 ] . V_90 = V_91 [ V_10 ] ;
V_23 = F_34 ( V_6 -> V_2 , F_5 ( V_8 -> V_85 ) ,
V_8 -> V_85 ) ;
if ( V_23 != 0 ) {
...
F_7 ( V_6 , V_94 , 0x100 , 0 ) ;
F_7 ( V_6 , V_95 , 0x100 , 0 ) ;
...
struct V_7 * V_8 ;
int V_23 ;
V_8 = F_39 ( & V_99 -> V_2 , sizeof( struct V_7 ) ,
V_100 ) ;
if ( V_8 == NULL )
return - V_101 ;
V_8 -> V_86 = F_40 ( V_99 , & V_102 ) ;
if ( F_41 ( V_8 -> V_86 ) ) {
V_23 = F_42 ( V_8 -> V_86 ) ;
F_35 ( & V_99 -> V_2 , L_5 ,
V_23 ) ;
...
struct V_7 * V_8 ;
int V_23 ;
V_8 = F_39 ( & V_106 -> V_2 , sizeof( struct V_7 ) ,
V_100 ) ;
if ( V_8 == NULL )
return - V_101 ;
V_8 -> V_86 = F_48 ( V_106 , & V_102 ) ;
if ( F_41 ( V_8 -> V_86 ) ) {
V_23 = F_42 ( V_8 -> V_86 ) ;
F_35 ( & V_106 -> V_2 , L_5 ,
V_23 ) ;
...
& V_103 , & V_104 , 1 ) ;
if ( V_23 != 0 ) {
F_35 ( & V_106 -> V_2 , L_6 , V_23 ) ;
return V_23 ;
}
return 0 ;
}
static int F_50 ( struct V_105 * V_109 )
{
F_46 ( & V_109 -> V_2 ) ;
return 0 ;
}
