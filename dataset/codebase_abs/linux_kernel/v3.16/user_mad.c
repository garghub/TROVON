...
V_16 = F_74 ( V_168 , V_85 ) ;
if ( V_16 ) {
F_13 ( & V_6 -> V_173 ) ;
F_3 ( V_6 ) ;
goto V_147;
}
F_75 ( & V_114 -> V_175 -> V_2 ) ;
V_147:
F_10 ( & V_114 -> V_144 ) ;
return V_16 ;
}
static int F_76 ( struct V_168 * V_168 , struct V_6 * V_85 )
{
struct V_5 * V_6 = V_85 -> V_87 ;
...
V_177 = V_6 -> V_12 ;
V_6 -> V_12 = 1 ;
F_77 (packet, tmp, &file->recv_list, list) {
if ( V_15 -> V_43 )
F_23 ( V_15 -> V_43 ) ;
F_3 ( V_15 ) ;
}
...
return 0 ;
V_186:
F_83 ( V_179 . V_180 , V_179 . V_187 ) ;
F_82 ( V_114 -> V_145 , V_114 -> V_58 , 0 , & V_179 ) ;
V_185:
F_84 ( & V_114 -> V_183 ) ;
V_184:
return V_16 ;
}
static int F_85 ( struct V_168 * V_168 , struct V_6 * V_85 )
{
...
F_10 ( & V_114 -> V_144 ) ;
F_84 ( & V_114 -> V_183 ) ;
F_78 ( & V_114 -> V_175 -> V_2 ) ;
return V_16 ;
}
static T_1 F_86 ( struct V_57 * V_4 , struct V_188 * V_189 ,
char * V_69 )
{
struct V_169 * V_114 = F_87 ( V_4 ) ;
if ( ! V_114 )
return - V_190 ;
return sprintf ( V_69 , L_5 , V_114 -> V_145 -> V_191 ) ;
}
static T_1 F_88 ( struct V_57 * V_4 , struct V_188 * V_189 ,
char * V_69 )
{
struct V_169 * V_114 = F_87 ( V_4 ) ;
if ( ! V_114 )
...
V_16 = F_91 ( V_195 , V_193 ) ;
if ( V_16 >= V_193 )
return - 1 ;
return V_16 ;
}
static int F_92 ( struct V_196 * V_57 , int V_58 ,
struct V_3 * V_175 ,
struct V_169 * V_114 )
{
int V_197 ;
...
F_70 ( & V_114 -> V_144 ) ;
F_72 ( & V_114 -> V_174 ) ;
F_97 ( & V_114 -> V_172 , & V_203 ) ;
V_114 -> V_172 . V_204 = V_205 ;
V_114 -> V_172 . V_2 . V_206 = & V_175 -> V_2 ;
F_98 ( & V_114 -> V_172 . V_2 , L_9 , V_114 -> V_201 ) ;
if ( F_99 ( & V_114 -> V_172 , V_198 , 1 ) )
goto V_207;
V_114 -> V_4 = F_100 ( V_208 , V_57 -> V_209 ,
V_114 -> V_172 . V_4 , V_114 ,
L_9 , V_114 -> V_201 ) ;
if ( F_46 ( V_114 -> V_4 ) )
goto V_207;
if ( F_101 ( V_114 -> V_4 , & V_210 ) )
goto V_211;
if ( F_101 ( V_114 -> V_4 , & V_212 ) )
goto V_211;
V_198 += V_193 ;
F_97 ( & V_114 -> V_182 , & V_213 ) ;
V_114 -> V_182 . V_204 = V_205 ;
V_114 -> V_182 . V_2 . V_206 = & V_175 -> V_2 ;
F_98 ( & V_114 -> V_182 . V_2 , L_10 , V_114 -> V_201 ) ;
if ( F_99 ( & V_114 -> V_182 , V_198 , 1 ) )
goto V_214;
V_114 -> V_215 = F_100 ( V_208 , V_57 -> V_209 ,
V_114 -> V_182 . V_4 , V_114 ,
L_10 , V_114 -> V_201 ) ;
if ( F_46 ( V_114 -> V_215 ) )
goto V_214;
if ( F_101 ( V_114 -> V_215 , & V_210 ) )
goto V_216;
if ( F_101 ( V_114 -> V_215 , & V_212 ) )
goto V_216;
return 0 ;
V_216:
F_102 ( V_208 , V_114 -> V_182 . V_4 ) ;
V_214:
F_103 ( & V_114 -> V_182 ) ;
V_211:
F_102 ( V_208 , V_114 -> V_172 . V_4 ) ;
V_207:
F_103 ( & V_114 -> V_172 ) ;
if ( V_114 -> V_201 < V_193 )
F_104 ( V_197 , V_200 ) ;
else
F_104 ( V_197 , V_195 ) ;
return - 1 ;
}
static void F_105 ( struct V_169 * V_114 )
{
struct V_5 * V_6 ;
int V_11 ;
F_106 ( V_114 -> V_4 , NULL ) ;
F_106 ( V_114 -> V_215 , NULL ) ;
F_102 ( V_208 , V_114 -> V_172 . V_4 ) ;
F_102 ( V_208 , V_114 -> V_182 . V_4 ) ;
F_103 ( & V_114 -> V_172 ) ;
F_103 ( & V_114 -> V_182 ) ;
...
F_10 ( & V_114 -> V_144 ) ;
if ( V_114 -> V_201 < V_193 )
F_104 ( V_114 -> V_201 , V_200 ) ;
else
F_104 ( V_114 -> V_201 - V_193 , V_195 ) ;
}
static void F_107 ( struct V_196 * V_57 )
{
struct V_3 * V_175 ;
int V_217 , V_218 , V_153 ;
if ( F_108 ( V_57 -> V_219 ) != V_220 )
return;
if ( V_57 -> V_219 == V_221 )
V_217 = V_218 = 0 ;
else {
...
( V_218 - V_217 + 1 ) * sizeof ( struct V_169 ) ,
V_41 ) ;
if ( ! V_175 )
return;
F_109 ( & V_175 -> V_2 , & V_223 ) ;
V_175 -> V_224 = V_217 ;
V_175 -> V_225 = V_218 ;
for ( V_153 = V_217 ; V_153 <= V_218 ; ++ V_153 ) {
V_175 -> V_114 [ V_153 - V_217 ] . V_175 = V_175 ;
if ( F_92 ( V_57 , V_153 , V_175 ,
& V_175 -> V_114 [ V_153 - V_217 ] ) )
goto V_110;
}
F_110 ( V_57 , & V_226 , V_175 ) ;
return;
V_110:
while ( -- V_153 >= V_217 )
F_105 ( & V_175 -> V_114 [ V_153 - V_217 ] ) ;
F_78 ( & V_175 -> V_2 ) ;
}
static void F_111 ( struct V_196 * V_57 )
{
struct V_3 * V_175 = F_112 ( V_57 , & V_226 ) ;
int V_153 ;
if ( ! V_175 )
return;
for ( V_153 = 0 ; V_153 <= V_175 -> V_225 - V_175 -> V_224 ; ++ V_153 )
F_105 ( & V_175 -> V_114 [ V_153 ] ) ;
F_78 ( & V_175 -> V_2 ) ;
}
static char * F_113 ( struct V_57 * V_4 , T_8 * V_227 )
{
return F_114 ( V_41 , L_11 , F_115 ( V_4 ) ) ;
}
static int T_9 F_116 ( void )
{
int V_16 ;
V_16 = F_117 ( V_202 , V_193 * 2 ,
L_7 ) ;
if ( V_16 ) {
F_61 ( V_194 L_12 ) ;
goto V_147;
}
V_208 = F_118 ( V_205 , L_7 ) ;
if ( F_46 ( V_208 ) ) {
V_16 = F_47 ( V_208 ) ;
F_61 ( V_194 L_13 ) ;
goto V_228;
