...
F_39 ( & V_45 , F_15 , ( unsigned long ) V_10 ) ;
F_9 ( V_11 , V_90 , V_91 ) ;
F_1 () ;
F_40 ( 5 ) ;
F_41 ( L_16 ,
...
{
struct V_95 V_96 [ 2 ] ;
struct V_97 * V_98 = F_46 ( & V_94 -> V_99 ) ;
struct V_93 * V_10 ;
struct V_100 * V_101 ;
struct V_102 V_103 ;
struct V_104 * V_104 ;
int V_59 = - V_105 ;
V_101 = F_47 ( sizeof( * V_101 ) , V_106 ) ;
if ( ! V_101 ) {
F_48 ( & V_94 -> V_99 , L_17 ) ;
goto V_107;
}
V_104 = F_49 ( & V_94 -> V_99 , L_18 ) ;
if ( F_50 ( V_104 ) ) {
F_48 ( & V_94 -> V_99 , L_19 ) ;
V_59 = F_51 ( V_104 ) ;
goto V_108;
...
V_101 -> V_112 = F_53 () ;
if ( F_50 ( V_101 -> V_112 ) ) {
V_59 = F_51 ( V_101 -> V_112 ) ;
goto V_113;
}
F_54 ( V_94 , V_101 ) ;
memset ( V_96 , 0x00 , sizeof( * V_96 ) *
F_55 ( V_96 ) ) ;
V_96 [ 0 ] . V_114 = V_94 -> V_95 [ 0 ] . V_114 ;
V_96 [ 0 ] . V_115 = V_94 -> V_95 [ 0 ] . V_115 ;
V_96 [ 0 ] . V_116 = V_94 -> V_95 [ 0 ] . V_116 ;
V_96 [ 0 ] . V_33 = V_94 -> V_95 [ 0 ] . V_33 ;
V_96 [ 1 ] . V_114 = V_94 -> V_95 [ 1 ] . V_114 ;
V_96 [ 1 ] . V_115 = V_94 -> V_95 [ 1 ] . V_115 ;
V_96 [ 1 ] . V_116 = V_94 -> V_95 [ 1 ] . V_116 ;
V_96 [ 1 ] . V_33 = V_94 -> V_95 [ 1 ] . V_33 ;
V_103 = V_117 ;
V_103 . V_118 = & V_94 -> V_99 ;
V_103 . V_119 = V_96 ;
V_103 . V_120 = F_55 ( V_96 ) ;
V_103 . V_121 = V_98 ;
V_103 . V_122 = sizeof( * V_98 ) ;
V_101 -> V_10 = V_10 = F_56 ( & V_103 ) ;
if ( F_50 ( V_10 ) ) {
V_59 = F_51 ( V_10 ) ;
F_48 ( & V_94 -> V_99 , L_21 , V_59 ) ;
goto V_123;
}
return 0 ;
V_123:
