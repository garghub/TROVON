...
( ( V_162 & V_41 ) && ( V_166 . V_177 != V_165 . V_177 ) ) ) {
V_83 = 0 ;
break;
}
F_80 () ;
...
struct V_1 * V_21 = V_4 -> V_1 ;
if ( V_21 -> V_10 -> V_199 )
V_83 = V_21 -> V_10 -> V_199 ( V_21 , V_187 , V_162 ) ;
break;
}
}
V_197:
...
if ( V_21 -> V_8 & V_39 )
return;
if ( ( V_74 -> V_35 & V_75 ) && ! ( V_33 & V_75 ) ) {
F_5 ( & V_21 -> V_9 , V_8 ) ;
V_5 -> V_13 = 0 ;
F_7 ( V_5 ) ;
F_6 ( & V_21 -> V_9 , V_8 ) ;
}
else if ( ! ( V_74 -> V_35 & V_75 ) && ( V_33 & V_75 ) ) {
F_5 ( & V_21 -> V_9 , V_8 ) ;
if ( ! ( V_21 -> V_10 -> V_40 ( V_21 ) & V_41 ) ) {
V_5 -> V_13 = 1 ;
V_21 -> V_10 -> V_11 ( V_21 ) ;
...
if ( ! V_2 -> V_87 || F_89 ( V_2 , V_5 , V_220 ) == 0 )
return;
if ( V_2 -> V_8 & V_43 ) {
unsigned long V_8 ;
F_5 ( & V_21 -> V_9 , V_8 ) ;
...
static void F_90 ( struct V_6 * V_5 , int V_57 )
{
struct V_3 * V_4 = V_5 -> V_7 ;
struct V_1 * V_2 = V_4 -> V_1 ;
...
{
unsigned int V_248 ;
for ( V_248 = 0 ; V_248 < V_87 ; V_248 ++ , V_261 ++ ) {
if ( * V_261 == '\n' )
putchar ( V_2 , '\r' ) ;
putchar ( V_2 , * V_261 ) ;
}
...
void
F_117 ( char * V_267 , int * V_48 , int * V_184 , int * V_49 , int * V_268 )
{
char * V_261 = V_267 ;
* V_48 = F_118 ( V_261 , NULL , 10 ) ;
...
int V_48 , int V_184 , int V_49 , int V_268 )
{
struct V_59 V_34 ;
static struct V_59 V_269 ;
int V_248 ;
...
V_34 . V_35 = V_272 | V_46 | V_77 ;
for ( V_248 = 0 ; V_273 [ V_248 ] . V_274 ; V_248 ++ )
if ( V_273 [ V_248 ] . V_274 <= V_48 )
break;
...
V_296 , V_2 -> V_103 , V_2 -> V_73 / 16 , F_104 ( V_2 ) ) ;
}
static void
...
V_83 = 0 ;
F_57 ( & V_308 -> V_116 ) ;
if ( ! F_87 ( V_45 , & V_308 -> V_8 ) )
V_83 = V_2 -> V_10 -> V_307 ( V_2 ) ;
F_58 ( & V_308 -> V_116 ) ;
if ( V_83 )
return V_83 ;
}
if ( V_267 ) {
F_117 ( V_267 , & V_48 , & V_184 , & V_49 , & V_268 ) ;
return F_119 ( V_2 , NULL , V_48 , V_184 , V_49 , V_268 ) ;
}
return 0 ;
}
...
static void F_141 ( struct V_256 * V_238 , int line , char V_86 )
{
struct V_236 * V_237 = V_238 -> V_239 ;
struct V_3 * V_4 = V_237 -> V_4 + line ;
struct V_1 * V_2 ;
...
V_2 = V_4 -> V_1 ;
if ( V_86 == '\n' )
V_2 -> V_10 -> V_306 ( V_2 , '\r' ) ;
V_2 -> V_10 -> V_306 ( V_2 , V_86 ) ;
}
...
V_309 -> V_315 = V_316 ;
V_309 -> V_317 = V_318 ;
V_309 -> V_317 . V_35 = V_319 | V_275 | V_272 | V_46 | V_77 ;
...
struct V_256 * F_153 ( struct V_263 * V_264 , int * V_90 )
{
...
struct V_22 * V_2 = F_155 ( V_279 ) ;
F_56 ( V_2 , & V_117 ) ;
return snprintf ( V_28 , V_326 , L_33 , V_117 . V_72 ) ;
}
...
unsigned int V_183 , unsigned int V_86 , unsigned int V_338 )
{
struct V_22 * V_308 = & V_2 -> V_4 -> V_2 ;
if ( ( V_252 & V_2 -> V_339 & ~ V_183 ) == 0 )
if ( F_187 ( V_308 , V_86 , V_338 ) == 0 )
++ V_2 -> V_167 . V_186 ;
