...
struct V_111 * V_121 ;
long V_113 ;
snprintf ( V_157 , sizeof( V_157 ) , L_39 ,
V_23 -> V_159 ? V_23 -> V_159 : L_40 ,
F_16 ( V_23 -> V_160 . V_161 ) ,
F_16 ( V_23 -> V_160 . V_162 ) ) ;
V_113 = F_72 ( & V_122 , V_157 , & V_10 -> V_59 ) ;
if ( V_113 < 0 ) {
F_73 ( L_41 , V_10 -> V_13 ,
V_157 ) ;
return 0 ;
...
F_73 ( L_45
L_46 , V_10 -> V_13 , V_121 -> V_163 , V_121 -> V_164 ,
V_121 -> V_165 , V_121 -> V_166 ) ;
F_33 ( V_58 ) ;
...
V_133 = V_122 -> V_2 ;
V_158 = V_122 -> V_31 ;
while ( V_158 >= sizeof( * V_136 ) ) {
V_136 = (struct V_135 * ) V_133 ;
V_133 += sizeof( * V_136 ) ;
V_158 -= sizeof( * V_136 ) ;
if ( V_158 < V_136 -> V_142 ) {
F_9 ( L_48 ,
V_10 -> V_13 , V_157 ) ;
V_113 = - V_132 ;
goto V_167;
...
static int F_80 ( struct V_95 * V_65 ,
...
int V_44 , V_12 ;
F_7 ( L_51 , V_65 , V_169 ) ;
if ( V_65 -> V_100 -> V_101 . V_170 != 0 )
return - V_27 ;
if ( ! V_169 -> V_171 ) {
const struct V_168 * V_172 ;
V_172 = F_81 ( V_65 , V_173 ) ;
if ( V_172 )
V_169 = V_172 ;
}
if ( V_169 -> V_171 == V_174 )
return - V_27 ;
if ( V_175 && V_169 -> V_171 & V_176 )
return - V_27 ;
if ( V_177 && V_169 -> V_171 & V_178 )
return - V_27 ;
if ( V_179 && V_169 -> V_171 & V_180 )
return - V_27 ;
if ( V_169 -> V_171 & V_181 ) {
struct V_156 * V_23 = F_82 ( V_65 ) ;
if ( F_16 ( V_23 -> V_160 . V_182 ) <= 0x0001 )
return - V_27 ;
}
V_2 = F_83 ( & V_65 -> V_59 , sizeof( * V_2 ) , V_67 ) ;
if ( ! V_2 )
return - V_33 ;
for ( V_44 = 0 ; V_44 < V_65 -> V_100 -> V_101 . V_102 ; V_44 ++ ) {
V_98 = & V_65 -> V_100 -> V_103 [ V_44 ] . V_101 ;
if ( ! V_2 -> V_32 && F_84 ( V_98 ) ) {
V_2 -> V_32 = V_98 ;
continue;
}
if ( ! V_2 -> V_85 && F_85 ( V_98 ) ) {
V_2 -> V_85 = V_98 ;
continue;
}
if ( ! V_2 -> V_43 && F_86 ( V_98 ) ) {
V_2 -> V_43 = V_98 ;
continue;
}
}
...
V_10 -> V_190 = F_48 ;
V_10 -> V_191 = F_57 ;
if ( V_169 -> V_171 & V_192 )
V_10 -> V_193 = F_65 ;
if ( V_169 -> V_171 & V_194 )
V_10 -> V_193 = F_78 ;
if ( V_169 -> V_171 & V_195 )
V_10 -> V_193 = F_76 ;
V_2 -> V_96 = F_93 ( V_2 -> V_23 , 1 ) ;
if ( ! V_196 )
F_39 ( V_116 , & V_10 -> V_117 ) ;
if ( V_197 || V_169 -> V_171 & V_198 ) {
if ( ! V_199 )
F_39 ( V_200 , & V_10 -> V_117 ) ;
}
if ( V_169 -> V_171 & V_201 )
V_2 -> V_96 = NULL ;
if ( V_169 -> V_171 & V_176 ) {
V_2 -> V_79 = V_202 ;
F_39 ( V_116 , & V_10 -> V_117 ) ;
}
if ( V_169 -> V_171 & V_178 ) {
struct V_156 * V_23 = V_2 -> V_23 ;
T_4 V_182 = F_16 ( V_23 -> V_160 . V_182 ) ;
if ( V_182 < 0x117 )
F_39 ( V_116 , & V_10 -> V_117 ) ;
if ( V_182 <= 0x100 )
V_10 -> V_193 = F_69 ;
}
if ( V_169 -> V_171 & V_180 ) {
struct V_156 * V_23 = V_2 -> V_23 ;
if ( F_16 ( V_23 -> V_160 . V_182 ) > 0x997 )
F_39 ( V_203 , & V_10 -> V_117 ) ;
V_2 -> V_96 = NULL ;
}
if ( V_2 -> V_96 ) {
V_12 = F_94 ( & V_204 ,
...
static void F_98 ( struct V_95 * V_65 )
{
struct V_1 * V_2 = F_99 ( V_65 ) ;
struct V_9 * V_10 ;
F_7 ( L_52 , V_65 ) ;
if ( ! V_2 )
return;
...
F_100 ( V_10 ) ;
if ( V_65 == V_2 -> V_96 )
F_101 ( & V_204 , V_2 -> V_65 ) ;
else if ( V_2 -> V_96 )
F_101 ( & V_204 , V_2 -> V_96 ) ;
F_95 ( V_10 ) ;
}
static int F_102 ( struct V_95 * V_65 , T_5 V_205 )
{
struct V_1 * V_2 = F_99 ( V_65 ) ;
F_7 ( L_52 , V_65 ) ;
if ( V_2 -> V_206 ++ )
...
static int F_108 ( struct V_95 * V_65 )
{
struct V_1 * V_2 = F_99 ( V_65 ) ;
struct V_9 * V_10 = V_2 -> V_10 ;
int V_12 = 0 ;
