...
enum V_136 F_67 ( struct V_137 * V_138 )
{
struct V_3 * V_4 ;
V_4 = F_26 ( V_138 , struct V_3 , V_139 ) ;
F_68 ( V_138 , F_69 ( V_4 -> V_78 /
V_106 , ( V_4 -> V_78 % V_106 ) * V_140 ) ) ;
F_63 ( V_4 ) ;
F_70 ( & V_4 -> V_141 ) ;
return V_142 ;
}
enum V_136 F_71 ( struct V_137 * V_138 )
{
struct V_3 * V_4 ;
...
case V_135 :
if ( F_72 ( & V_4 -> V_143 ) ) {
F_73 ( & V_4 -> V_143 , F_69 ( V_146 /
V_106 , ( V_146 % V_106 ) *
V_140 ) ) ;
F_74 ( & V_4 -> V_143 , V_147 ) ;
} else {
F_75 ( & V_4 -> V_143 , F_69 ( V_146 /
V_106 , ( V_146 % V_106 ) *
V_140 ) , V_147 ) ;
}
V_4 -> V_134 = type ;
...
void F_83 ( const char * V_10 )
{
struct V_128 * V_158 ;
V_158 = F_84 ( sizeof( struct V_128 ) , V_159 ) ;
if ( ! V_158 )
return;
V_158 -> V_132 . type = F_9 ( V_19 ) ;
V_158 -> V_132 . V_160 = F_78 ;
if ( V_10 && * V_10 ) {
memcpy ( V_158 -> V_161 , V_10 , V_162 ) ;
F_14 ( V_34 , L_18 , V_10 ) ;
V_158 -> V_132 . V_9 = F_85 ( & V_163 , V_10 ) ;
...
F_29 ( & V_46 ) ;
while ( ! F_61 ( & V_165 ) ) {
V_4 = F_62 ( & V_165 , struct V_3 , V_62 ) ;
F_37 ( V_4 ) ;
F_38 ( V_4 ) ;
}
}
void F_90 ( const char * V_10 )
{
struct V_128 * V_158 ;
int V_95 = 0 ;
F_14 ( V_34 , L_20 , V_10 ) ;
...
F_60 ( & V_158 -> V_132 ) ;
if ( V_158 -> V_132 . V_9 ) {
F_39 ( V_158 -> V_132 . V_9 ) ;
F_87 ( V_158 -> V_132 . V_9 ) ;
}
F_44 ( & V_158 -> V_62 ) ;
F_45 ( V_158 ) ;
}
}
static char * F_91 ( char * V_167 , char * V_168 , int V_169 )
{
while ( * V_167 == ',' )
V_167 ++ ;
...
char V_171 [ 32 ] ;
while ( * V_170 ) {
V_170 = F_91 ( V_170 , V_171 , sizeof( V_171 ) ) ;
if ( V_171 [ 0 ] )
F_83 ( V_171 ) ;
}
}
...
int F_94 ( struct V_172 * V_173 , int V_174 )
{
struct V_3 * V_4 ;
struct V_59 * V_60 ;
int V_175 = 0 ;
