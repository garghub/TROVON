...
static int F_11 ( struct V_71 * V_72 )
{
const struct V_73 * V_74 ;
static struct V_1 * V_2 ;
int V_56 , V_55 , V_75 ;
V_74 = F_12 ( V_76 , & V_72 -> V_49 ) ;
if ( ! V_74 ) {
F_10 ( & V_72 -> V_49 , L_17 ) ;
return - V_77 ;
}
V_2 = F_13 ( & V_72 -> V_49 , sizeof( * V_2 ) , V_78 ) ;
if ( ! V_2 )
return - V_79 ;
memcpy ( V_2 , V_74 -> V_80 , sizeof( * V_2 ) ) ;
V_2 -> V_49 = & V_72 -> V_49 ;
F_14 ( V_72 , V_2 ) ;
for ( V_55 = 0 , V_75 = 0 ; V_55 < V_2 -> V_63 ; V_55 ++ ) {
struct V_81 * V_82 ;
if ( V_2 -> V_64 [ V_55 ] == V_83 ) {
F_2 ( V_55 == 0 ) ;
V_2 -> V_64 [ V_55 ] = V_2 -> V_64 [ V_55 - 1 ] ;
continue;
}
V_82 = F_15 ( V_72 , V_84 , V_75 ) ;
V_2 -> V_64 [ V_55 ] = F_16 ( & V_72 -> V_49 , V_82 ) ;
if ( F_17 ( V_2 -> V_64 [ V_55 ] ) ) {
F_10 ( V_2 -> V_49 , L_18 , V_55 ) ;
return F_18 ( V_2 -> V_64 [ V_55 ] ) ;
}
V_75 ++ ;
}
V_2 -> V_85 = F_19 ( V_72 , 0 ) ;
V_56 = F_20 ( V_2 -> V_49 , V_2 -> V_85 , F_9 ,
V_86 , L_19 , V_2 ) ;
if ( V_56 ) {
F_10 ( V_2 -> V_49 , L_20 ,
V_2 -> V_85 ) ;
...
V_2 -> V_60 = F_19 ( V_72 , 1 ) ;
V_56 = F_20 ( V_2 -> V_49 , V_2 -> V_60 , F_9 ,
V_86 , L_21 , V_2 ) ;
if ( V_56 )
F_10 ( V_2 -> V_49 , L_20 , V_2 -> V_60 ) ;
return V_56 ;
}
