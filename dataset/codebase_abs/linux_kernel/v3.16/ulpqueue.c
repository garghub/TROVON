...
if ( ! F_28 ( V_11 ) )
F_29 ( V_22 , V_9 ) ;
if ( ! F_30 ( V_11 , & F_16 ( V_22 ) -> V_39 ) )
goto V_38;
if ( F_31 ( & F_16 ( V_22 ) -> V_7 ) == 0 ) {
V_31 = & V_22 -> V_28 ;
} else {
if ( V_2 -> V_7 ) {
if ( ( V_11 -> V_19 & V_40 ) ||
...
F_37 ( & V_2 -> V_5 , V_45 , F_12 ( V_11 ) ) ;
}
static struct V_10 * F_38 ( struct V_49 * V_49 ,
...
struct V_8 * V_27 = F_39 ( V_50 ) -> V_55 ;
if ( V_50 == V_51 )
V_45 = NULL ;
else
V_45 = V_50 -> V_56 ;
...
F_31 ( & F_16 ( V_4 -> V_30 . V_22 ) -> V_7 ) )
goto V_72;
V_46 = F_5 ( V_64 ) ;
V_67 = F_16 ( V_4 -> V_30 . V_22 ) -> V_67 ;
if ( V_67 && V_67 <= V_66 ) {
V_63 = F_38 ( F_46 ( V_4 -> V_30 . V_22 ) ,
& V_2 -> V_5 ,
V_64 ,
V_65 ) ;
if ( V_63 )
...
return V_63 ;
V_71:
V_63 = F_38 ( F_46 ( V_2 -> V_4 -> V_30 . V_22 ) ,
& V_2 -> V_5 , V_61 , V_45 ) ;
if ( V_63 )
V_63 -> V_19 |= V_20 ;
goto V_72;
...
if ( V_83 > V_82 )
break;
if ( V_83 == V_82 && F_57 ( V_88 , V_84 ) )
break;
}
F_37 ( & V_2 -> V_6 , V_45 , F_12 ( V_11 ) ) ;
}
...
V_83 = V_46 -> V_85 ;
V_84 = V_46 -> V_88 ;
if ( V_83 == V_82 && V_84 == F_54 ( V_81 , V_83 ) ) {
F_55 ( V_81 , V_83 ) ;
F_22 ( V_45 , V_6 ) ;
F_11 ( & V_16 , V_45 ) ;
V_11 = F_5 ( V_45 ) ;
...
void F_59 ( struct V_1 * V_2 , T_5 V_82 , T_5 V_88 )
{
struct V_80 * V_81 ;
V_81 = & V_2 -> V_4 -> V_86 -> V_81 ;
if ( F_57 ( V_88 , F_54 ( V_81 , V_82 ) ) )
return;
F_60 ( V_81 , V_82 , V_88 ) ;
F_58 ( V_2 , V_82 ) ;
}
...
while ( ( V_9 = F_34 ( V_27 ) ) != NULL ) {
V_11 = F_5 ( V_9 ) ;
V_47 = V_11 -> V_47 ;
if ( F_49 ( V_47 , F_48 ( V_95 ) ) )
break;
V_91 += F_62 ( V_9 ) ;
V_93 = F_39 ( V_9 ) -> V_55 ;
...
{
return F_61 ( V_2 , & V_2 -> V_6 , V_90 ) ;
}
static T_5 F_65 ( struct V_1 * V_2 , T_5 V_90 )
{
return F_61 ( V_2 , & V_2 -> V_5 , V_90 ) ;
}
...
if ( V_9 != NULL ) {
V_48 = F_5 ( V_9 ) -> V_47 ;
if ( ! F_49 ( V_48 , F_48 ( & V_4 -> V_76 . V_77 ) ) )
return;
}
if ( V_24 -> V_43 || F_31 ( & V_24 -> V_7 ) == 0 ) {
V_11 = F_50 ( V_2 ) ;
if ( V_11 ) {
F_14 ( V_2 , V_11 ) ;
F_23 ( V_2 ) ;
