...
F_146 ( V_24 , ( unsigned long ) V_52 -> V_127 , V_126 ) )
V_353 = NULL ;
else
V_353 = & V_354 ;
if ( V_353 ) {
if ( ! F_50 ( V_5 ) && V_126 <= V_271 -> V_141 )
F_147 ( V_5 , V_50 , V_126 ) ;
else {
V_25 = F_148 ( V_351 , V_5 , V_126 ) ;
if ( V_25 )
return V_25 ;
}
V_353 -> V_282 = V_351 -> V_282 ;
V_353 -> V_279 = V_351 -> V_279 ;
V_353 -> V_362 = V_351 -> V_277 ;
V_353 -> V_269 = 0 ;
V_353 -> V_363 = V_52 -> V_127 ? 0 : 1 ;
if ( V_349 == V_122 )
V_353 -> V_364 = 1 ;
else
V_353 -> V_364 = 0 ;
...
if ( V_350 ) {
int V_99 , V_365 = sizeof( struct V_366 ) * V_350 ;
struct V_367 * V_368 ;
V_368 = F_149 ( V_52 -> V_127 , V_365 ) ;
if ( F_17 ( V_368 ) )
return F_18 ( V_368 ) ;
V_99 = F_150 ( V_368 , V_350 ) ;
if ( V_52 -> V_126 < V_99 ) {
V_350 = F_151 ( V_368 , V_350 , V_52 -> V_126 ) ;
V_99 = V_52 -> V_126 ;
}
V_25 = F_152 ( V_24 , V_151 , V_353 , (struct V_366 * ) V_368 ,
V_350 ,
V_99 , V_358 ) ;
F_35 ( V_368 ) ;
} else
V_25 = F_153 ( V_24 , V_151 , V_353 , V_52 -> V_127 ,
V_52 -> V_126 , V_358 ) ;
if ( ! V_25 ) {
...
T_2 * V_5 = V_50 -> V_294 ;
T_12 * V_351 = & V_50 -> V_72 ;
F_14 ( 4 , F_15 ( L_44 , ( int ) V_50 -> V_371 ) ) ;
if ( V_50 -> V_151 ) {
if ( V_50 -> V_150 )
V_14 = F_154 ( V_50 -> V_150 ) ;
F_155 ( V_50 -> V_151 ) ;
}
if ( V_50 -> V_371 )
F_156 ( V_5 , V_50 ) ;
...
static int
F_157 ( T_12 * V_372 , const T_2 * V_5 , int V_373 )
{
int V_374 = V_373 * sizeof( struct V_281 * ) ;
T_16 V_375 = V_358 | V_376 ;
...
static int
F_148 ( T_12 * V_372 , T_2 * V_5 , int V_378 )
{
int V_379 = 0 , V_380 , V_111 , V_381 , V_382 , V_383 ;
int V_41 = V_5 -> V_7 -> V_41 ;
int V_384 = V_378 , V_385 ;
T_16 V_386 = V_358 | V_387 | V_376 ;
if ( V_384 < 0 )
return - V_56 ;
if ( 0 == V_384 )
++ V_384 ;
V_384 = F_158 ( V_384 , V_388 ) ;
F_14 ( 4 , F_15 ( L_45 ,
V_378 , V_384 ) ) ;
V_383 = F_157 ( V_372 , V_5 , V_41 ) ;
if ( V_383 < 0 )
return V_383 ;
V_382 = V_343 ;
if ( F_91 ( V_382 != V_345 ) ) {
...
V_382 = ( V_381 > V_345 ) ?
V_345 : V_381 ;
V_372 -> V_282 [ V_111 ] = F_160 ( V_386 , V_385 ) ;
...
F_161 ( V_372 -> V_282 [ V_111 ] , V_372 -> V_279 ) ;
}
F_35 ( V_372 -> V_282 ) ;
}
}
...
for ( V_111 = 0 ; V_111 < V_372 -> V_277 && V_372 -> V_282 [ V_111 ] ; V_111 ++ ) {
if ( V_382 > V_393 ) {
if ( F_38 ( V_392 , F_162 ( V_372 -> V_282 [ V_111 ] ) ,
V_393 ) )
return - V_56 ;
break;
} else {
...
F_14 ( 4 , F_15 ( L_53 , V_394 ) ) ;
do {
if ( V_394 < V_344 )
V_394 = V_344 ;
if ( 0 == F_148 ( V_372 , V_5 , V_394 ) )
return;
else
F_63 ( V_372 ) ;
V_394 >>= 1 ;
...
unsigned long V_166 ;
int V_141 ;
V_5 = F_106 ( sizeof( * V_5 ) , V_358 | V_376 ) ;
if ( ! V_5 )
return NULL ;
F_112 ( & V_5 -> V_66 ) ;
F_163 ( & V_5 -> V_160 ) ;
...
static void F_166 ( struct V_290 * V_291 )
{
...
static int
F_169 ( int V_185 , void * V_164 , void * V_72 )
{
int * V_111 = V_72 ;
if ( * V_111 < V_185 )
* V_111 = V_185 ;
...
unsigned long V_166 ;
F_8 ( & V_18 , V_166 ) ;
F_171 ( & V_313 , F_169 , & V_111 ) ;
F_10 ( & V_18 , V_166 ) ;
return V_111 + 1 ;
}
static T_1 * F_172 ( int V_21 )
{
return F_173 ( & V_313 , V_21 ) ;
}
...
return;
for ( V_111 = 0 ; V_111 < V_408 ; ++ V_111 )
F_177 ( V_409 [ V_111 ] . V_419 , V_410 ) ;
F_177 ( V_411 , NULL ) ;
}
static int F_178 ( struct V_420 * V_421 , void * V_422 )
{
F_179 ( V_421 , L_61 , * ( ( int * ) V_421 -> V_423 ) ) ;
return 0 ;
}
static int F_180 ( struct V_20 * V_20 , struct V_1 * V_1 )
{
return F_181 ( V_1 , F_178 , & V_361 ) ;
}
static T_3
F_182 ( struct V_1 * V_2 , const char T_4 * V_424 ,
T_5 V_48 , T_6 * V_425 )
{
int V_98 ;
unsigned long V_382 ;
if ( ! F_70 ( V_232 ) || ! F_70 ( V_233 ) )
return - V_234 ;
V_98 = F_183 ( V_424 , V_48 , 0 , & V_382 ) ;
if ( V_98 )
return V_98 ;
V_361 = V_382 ? 1 : 0 ;
return V_48 ;
}
static int F_184 ( struct V_20 * V_20 , struct V_1 * V_1 )
{
return F_181 ( V_1 , F_178 , & V_347 ) ;
}
static T_3
...
{
F_179 ( V_421 , L_62 , V_210 , V_428 ,
V_429 ) ;
return 0 ;
}
static int F_187 ( struct V_20 * V_20 , struct V_1 * V_1 )
{
return F_181 ( V_1 , F_186 , NULL ) ;
}
static int F_188 ( struct V_420 * V_421 , void * V_422 )
{
F_179 ( V_421 , L_63
L_64 ) ;
return 0 ;
}
static int F_189 ( struct V_20 * V_20 , struct V_1 * V_1 )
{
return F_181 ( V_1 , F_188 , NULL ) ;
}
static void * F_190 ( struct V_420 * V_421 , T_6 * V_430 )
{
...
static void * F_191 ( struct V_420 * V_421 , void * V_422 , T_6 * V_430 )
{
struct V_431 * V_432 = V_421 -> V_423 ;
* V_430 = ++ V_432 -> V_247 ;
return ( V_432 -> V_247 < V_432 -> V_433 ) ? V_432 : NULL ;
}
static void F_192 ( struct V_420 * V_421 , void * V_422 )
{
F_35 ( V_421 -> V_423 ) ;
}
static int F_193 ( struct V_20 * V_20 , struct V_1 * V_1 )
{
return F_194 ( V_1 , & V_434 ) ;
}
static int F_195 ( struct V_420 * V_421 , void * V_422 )
{
...
unsigned long V_166 ;
F_8 ( & V_18 , V_166 ) ;
V_12 = V_432 ? F_172 ( V_432 -> V_247 ) : NULL ;
...
static int F_197 ( struct V_20 * V_20 , struct V_1 * V_1 )
{
return F_194 ( V_1 , & V_436 ) ;
}
...
static void F_199 ( struct V_420 * V_421 , T_1 * V_12 )
{
...
F_179 ( V_421 , V_50 -> V_161 ?
( ( 1 == V_50 -> V_161 ) ? L_76 : L_77 )
: L_78 ) ;
F_179 ( V_421 , L_79 ,
V_50 -> V_67 . V_64 , V_442 ) ;
if ( V_50 -> V_161 )
F_179 ( V_421 , L_80 , V_52 -> V_157 ) ;
else {
V_216 = F_54 ( V_158 ) ;
F_179 ( V_421 , L_81 ,
( V_441 ? V_52 -> V_69 :
...
static int F_202 ( struct V_20 * V_20 , struct V_1 * V_1 )
{
return F_194 ( V_1 , & V_447 ) ;
}
static int F_203 ( struct V_420 * V_421 , void * V_422 )
{
struct V_431 * V_432 = (struct V_431 * ) V_422 ;
T_1 * V_12 ;
unsigned long V_166 ;
...
F_179 ( V_421 , L_84 ,
( int ) V_432 -> V_433 ) ;
F_179 ( V_421 , L_85 , V_347 ) ;
}
F_8 ( & V_18 , V_166 ) ;
V_12 = V_432 ? F_172 ( V_432 -> V_247 ) : NULL ;
if ( V_12 && ! F_9 ( & V_12 -> V_19 ) ) {
struct V_251 * V_312 = V_12 -> V_8 ;
F_179 ( V_421 , L_86 , V_12 -> V_43 -> V_44 ) ;
if ( V_12 -> V_38 )
F_179 ( V_421 , L_87 ) ;
else
F_179
