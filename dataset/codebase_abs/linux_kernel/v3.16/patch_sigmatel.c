...
struct V_3 * V_4 , T_1 V_18 )
{
F_121 ( V_208 , V_4 , V_18 ) ;
if ( V_18 == V_4 -> V_31 )
F_123 ( V_208 , V_4 , 0xfa0 ) ;
}
static void F_125 ( struct V_207 * V_208 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_123 ( V_208 , V_4 , 0xfe0 ) ;
}
static void F_126 ( struct V_207 * V_208 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_123 ( V_208 , V_4 , 0xfeb ) ;
}
...
if ( F_141 ( F_142 ( V_4 , 0x28 ) ) == V_253 )
F_77 ( V_4 , V_254 ) ;
if ( F_142 ( V_4 , 0xa ) & V_255 )
F_143 ( V_4 , V_250 ) ;
V_9 -> V_205 = & V_256 ;
V_9 -> V_89 = 0x50 ;
V_9 -> V_93 = 0 ;
