...
return 0 ;
return F_110 ( & V_13 -> V_22 , V_21 , F_106 , V_299 ) ;
}
...
char V_300 [ 20 ] ;
char V_301 [ 20 ] ;
char * V_198 [] = { V_300 , V_301 , NULL } ;
sprintf ( V_300 , L_61 , ( V_12 -> V_302 & V_303 ) ? 1 : 0 ) ;
sprintf ( V_301 , L_62 , V_13 -> V_153 . V_237 ? 1 : 0 ) ;
F_64 ( & V_13 -> V_202 , V_304 , V_198 ) ;
}
static int F_112 ( struct V_11 * V_12 , struct V_275 * args , int V_72 )
{
struct V_10 * V_13 ;
struct V_160 V_161 ;
int error ;
...
V_12 -> V_318 = V_319 ;
V_12 -> V_320 = & V_321 ;
F_113 ( V_12 ) -> V_49 |= V_322 ;
V_12 -> V_323 = 1 ;
V_12 -> V_324 = V_325 ;
V_13 -> V_74 . V_96 = F_114 ( V_12 , V_326 ) ;
V_13 -> V_74 . V_97 = V_12 -> V_327 ;
V_13 -> V_125 = V_13 -> V_74 . V_97 -
V_126 ;
V_13 -> V_127 = 1 << V_13 -> V_125 ;
...
if ( V_13 -> V_153 . V_332 ) {
V_13 -> V_23 . V_333 = 0 ;
V_13 -> V_23 . V_334 = V_13 -> V_153 . V_332 ;
} else {
V_13 -> V_23 . V_333 = 1 ;
V_13 -> V_23 . V_334 = 30 ;
}
...
snprintf ( V_13 -> V_335 , V_158 , L_64 , V_13 -> V_159 ) ;
error = F_116 ( V_13 ) ;
if ( error )
return error ;
F_117 ( V_13 ) ;
...
if ( V_13 -> V_153 . V_237 )
snprintf ( V_13 -> V_335 , V_158 , L_65 ,
V_13 -> V_159 ) ;
else
snprintf ( V_13 -> V_335 , V_158 , L_66 ,
...
static int F_123 ( struct V_11 * V_88 , void * V_342 )
{
V_88 -> V_47 = V_342 ;
V_88 -> V_343 = V_88 -> V_47 -> V_344 ;
V_88 -> V_53 = & F_124 ( V_88 -> V_47 ) -> V_52 ;
return 0 ;
}
static int F_125 ( struct V_11 * V_88 , void * V_345 )
{
struct V_346 * V_347 = V_345 ;
return ( V_347 == V_88 -> V_47 ) ;
}
static struct V_183 * F_126 ( struct V_348 * V_349 , int V_49 ,
const char * V_350 , void * V_342 )
{
struct V_346 * V_347 ;
struct V_11 * V_88 ;
...
V_88 = F_129 ( V_349 , F_125 , F_123 , V_49 , V_347 ) ;
F_76 ( & V_347 -> V_355 ) ;
error = F_55 ( V_88 ) ;
if ( F_54 ( V_88 ) )
goto V_358;
...
if ( V_88 -> V_195 ) {
error = - V_357 ;
if ( ( V_49 ^ V_88 -> V_302 ) & V_303 )
goto V_366;
} else {
char V_367 [ V_368 ] ;
V_88 -> V_369 = V_351 ;
F_46 ( V_88 -> V_156 , F_134 ( V_347 , V_367 ) , sizeof( V_88 -> V_156 ) ) ;
F_59 ( V_88 , F_135 ( V_347 ) ) ;
error = F_112 ( V_88 , & args , V_49 & V_370 ? 1 : 0 ) ;
if ( error )
goto V_366;
V_88 -> V_302 |= V_371 ;
V_347 -> V_372 = V_88 ;
...
static int F_138 ( struct V_11 * V_88 , void * V_345 )
{
return - V_79 ;
}
static struct V_183 * F_139 ( struct V_348 * V_349 ,
int V_49 , const char * V_350 , void * V_342 )
{
struct V_11 * V_88 ;
struct V_10 * V_13 ;
struct V_373 V_373 ;
int error ;
error = F_140 ( V_350 , V_374 , & V_373 ) ;
if ( error ) {
F_17 ( L_70 ,
V_350 , error ) ;
return F_137 ( error ) ;
}
V_88 = F_129 ( & V_375 , F_125 , F_138 , V_49 ,
V_373 . V_183 -> V_232 -> V_376 -> V_47 ) ;
F_141 ( & V_373 ) ;
if ( F_54 ( V_88 ) ) {
F_17 ( L_71 ) ;
return F_128 ( V_88 ) ;
