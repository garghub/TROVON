...
V_32 = F_24 ( sizeof( struct V_207 ) , V_25 ) ;
if ( ! V_32 ) {
V_42 -> error = L_42 ;
V_51 = - V_26 ;
goto V_208;
}
V_51 = F_113 ( V_42 , V_116 [ 0 ] , F_114 ( V_42 -> V_58 ) , & V_32 -> V_209 ) ;
if ( V_51 ) {
V_42 -> error = L_43 ;
goto V_210;
}
...
{
struct V_207 * V_32 = V_42 -> V_139 ;
F_129 ( V_42 , V_32 -> V_209 ) ;
F_29 ( V_32 ) ;
}
...
struct V_207 * V_32 = V_42 -> V_139 ;
unsigned V_211 ;
V_13 -> V_173 = V_32 -> V_209 -> V_28 ;
if ( F_99 ( V_13 -> V_177 & V_178 ) )
return V_150 ;
if ( F_160 ( V_13 ) != V_180 )
return V_150 ;
V_211 = V_32 -> V_212 -
( ( unsigned ) V_13 -> V_174 . V_175 & ( V_32 -> V_212 - 1 ) ) ;
if ( F_180 ( V_13 ) > V_211 )
F_181 ( V_13 , V_211 ) ;
return F_139 ( V_32 -> V_209 , V_13 ) ;
}
static void F_182 ( struct V_114 * V_42 )
{
struct V_207 * V_32 = V_42 -> V_139 ;
V_32 -> V_212 = F_170 ( V_32 -> V_209 -> V_28 ) ;
}
static void F_183 ( struct V_114 * V_42 , T_7 type ,
unsigned V_187 , char * V_188 , unsigned V_189 )
{
struct V_207 * V_32 = V_42 -> V_139 ;
switch ( type ) {
...
break;
case V_196 :
snprintf ( V_188 , V_189 , L_44 , V_32 -> V_209 -> V_197 ) ;
break;
}
}
static int F_184 ( struct V_114 * V_42 , struct V_213 * V_214 ,
struct V_215 * V_216 , int V_217 )
{
struct V_207 * V_32 = V_42 -> V_139 ;
struct V_218 * V_219 = F_185 ( V_32 -> V_209 -> V_28 ) ;
if ( ! V_219 -> V_220 )
return V_217 ;
V_214 -> V_173 = V_32 -> V_209 -> V_28 ;
return F_79 ( V_217 , V_219 -> V_220 ( V_219 , V_214 , V_216 ) ) ;
}
static int F_186 ( struct V_114 * V_42 ,
T_8 V_199 , void * V_200 )
{
struct V_207 * V_32 = V_42 -> V_139 ;
return V_199 ( V_42 , V_32 -> V_209 , 0 , V_42 -> V_201 , V_200 ) ;
}
