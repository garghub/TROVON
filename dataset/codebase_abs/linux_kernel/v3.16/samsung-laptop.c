...
if ( ! V_2 -> V_112 )
return 0 ;
memset ( & V_46 , 0 , sizeof( struct V_111 ) ) ;
V_46 . type = V_113 ;
...
static T_7 F_65 ( struct V_115 * V_116 ,
struct V_117 * V_67 , int V_118 )
{
struct V_64 * V_65 = F_46 ( V_116 , struct V_64 , V_116 ) ;
struct V_91 * V_119 = F_66 ( V_65 ) ;
struct V_1 * V_2 = F_67 ( V_119 ) ;
bool V_120 = true ;
if ( V_67 == & V_121 . V_67 )
V_120 = ! ! V_2 -> V_8 -> V_69 [ 0 ] . V_70 ;
if ( V_67 == & V_122 . V_67 )
V_120 = ! ! ( F_27 ( V_2 ) >= 0 ) ;
if ( V_67 == & V_123 . V_67 )
V_120 = ! ! ( F_29 ( V_2 ) >= 0 ) ;
return V_120 ? V_67 -> V_124 : 0 ;
}
static void F_68 ( struct V_1 * V_2 )
{
struct V_91 * V_64 = V_2 -> V_91 ;
F_69 ( & V_64 -> V_65 . V_116 , & V_125 ) ;
}
static int T_6 F_70 ( struct V_1 * V_2 )
{
struct V_91 * V_64 = V_2 -> V_91 ;
return F_71 ( & V_64 -> V_65 . V_116 , & V_125 ) ;
}
static int F_72 ( struct V_126 * V_127 , void * V_31 )
{
struct V_1 * V_2 = V_127 -> V_128 ;
struct V_4 * V_129 = & V_2 -> V_16 . V_31 ;
int V_9 ;
F_73 ( V_127 , L_17 ,
V_2 -> V_16 . V_3 ,
V_129 -> V_17 , V_129 -> V_18 , V_129 -> V_19 , V_129 -> V_20 ) ;
V_9 = F_1 ( V_2 , V_2 -> V_16 . V_3 , V_129 , V_129 ) ;
if ( V_9 ) {
F_73 ( V_127 , L_18 ,
V_2 -> V_16 . V_3 ) ;
return V_9 ;
...
{
return F_75 ( V_131 , F_72 , V_130 -> V_132 ) ;
}
...
{
struct V_134 * V_135 ;
V_2 -> V_16 . V_133 = F_79 ( L_20 , NULL ) ;
if ( ! V_2 -> V_16 . V_133 ) {
F_80 ( L_21 ) ;
goto V_136;
}
V_2 -> V_16 . V_137 . V_31 = V_2 -> V_138 ;
V_2 -> V_16 . V_137 . V_139 = 0xffff ;
V_2 -> V_16 . V_140 . V_31 = & V_2 -> V_16 . V_31 ;
V_2 -> V_16 . V_140 . V_139 = sizeof( V_2 -> V_16 . V_31 ) ;
V_2 -> V_16 . V_141 . V_31 = V_2 -> V_142 ;
V_2 -> V_16 . V_141 . V_139 = strlen ( V_2 -> V_142 ) ;
V_135 = F_81 ( L_22 , V_143 | V_144 ,
V_2 -> V_16 . V_133 , & V_2 -> V_16 . V_3 ) ;
if ( ! V_135 )
goto V_136;
V_135 = F_82 ( L_23 , V_143 | V_144 , V_2 -> V_16 . V_133 ,
& V_2 -> V_16 . V_31 . V_17 ) ;
if ( ! V_135 )
goto V_136;
V_135 = F_82 ( L_24 , V_143 | V_144 , V_2 -> V_16 . V_133 ,
& V_2 -> V_16 . V_31 . V_18 ) ;
if ( ! V_135 )
goto V_136;
V_135 = F_81 ( L_25 , V_143 | V_144 , V_2 -> V_16 . V_133 ,
& V_2 -> V_16 . V_31 . V_19 ) ;
if ( ! V_135 )
goto V_136;
V_135 = F_83 ( L_26 , V_143 | V_144 , V_2 -> V_16 . V_133 ,
& V_2 -> V_16 . V_31 . V_20 ) ;
if ( ! V_135 )
goto V_136;
V_135 = F_84 ( L_27 , V_143 | V_144 ,
V_2 -> V_16 . V_133 ,
& V_2 -> V_16 . V_140 ) ;
if ( ! V_135 )
goto V_136;
V_135 = F_84 ( L_28 , V_145 | V_144 ,
V_2 -> V_16 . V_133 ,
& V_2 -> V_16 . V_137 ) ;
if ( ! V_135 )
goto V_136;
V_135 = F_85 ( L_29 , V_146 | V_143 ,
V_2 -> V_16 . V_133 , V_2 ,
& V_147 ) ;
if ( ! V_135 )
goto V_136;
V_135 = F_84 ( L_30 , V_143 | V_144 ,
V_2 -> V_16 . V_133 ,
& V_2 -> V_16 . V_141 ) ;
if ( ! V_135 )
goto V_136;
...
{
const struct V_7 * V_8 = V_2 -> V_8 ;
if ( V_8 && V_8 -> V_33 . V_148 != 0xff )
F_13 ( V_2 , V_8 -> V_33 . V_148 , 0x80 ) ;
if ( V_2 -> V_23 ) {
F_87 ( V_2 -> V_23 ) ;
V_2 -> V_23 = NULL ;
}
...
F_89 ( V_150 L_37 ,
F_2 ( V_2 -> V_11 + V_8 -> V_12 . V_151 ) ) ;
F_89 ( V_150 L_38 ,
F_2 ( V_2 -> V_11 + V_8 -> V_12 . V_152 ) ) ;
F_89 ( V_150 L_39 , V_149 ) ;
}
static void T_6 F_90 ( struct V_1 * V_2 )
{
int V_83 = F_31 ( V_2 -> V_138 , L_40 ) ;
int V_57 ;
if ( V_83 == 0xffff )
return ;
V_83 += 1 ;
for ( V_57 = 0 ; V_83 < 0xffff && V_57 < sizeof( V_2 -> V_142 ) - 1 ; V_83 ++ ) {
char V_84 = F_6 ( V_2 -> V_138 + V_83 ) ;
...
F_90 ( V_2 ) ;
for ( V_57 = 0 ; V_154 [ V_57 ] . V_155 != 0 ; ++ V_57 ) {
V_2 -> V_8 = & V_154 [ V_57 ] ;
V_83 = F_31 ( V_2 -> V_138 ,
V_2 -> V_8 -> V_155 ) ;
if ( V_83 != 0xffff )
...
V_33 = & V_8 -> V_33 ;
V_83 += 1 ;
V_2 -> V_11 = ( V_2 -> V_138 + V_83 ) ;
V_149 = ( F_2 ( V_2 -> V_11 + V_8 -> V_12 . V_152 ) & 0x0ffff ) << 4 ;
V_149 += F_2 ( V_2 -> V_11 + V_8 -> V_12 . V_151 ) & 0x0ffff ;
if ( V_16 )
F_88 ( V_2 , V_83 , V_149 ) ;
V_2 -> V_23 = F_92 ( V_149 , 16 ) ;
if ( ! V_2 -> V_23 ) {
F_80 ( L_44 , V_149 ) ;
V_9 = - V_30 ;
goto exit;
...
static int F_95 ( struct V_156 * V_157 ,
unsigned long V_158 , void * V_159 )
{
struct V_1 * V_2 ;
V_2 = F_46 ( V_157 , struct V_1 , V_160 ) ;
if ( V_158 == V_161 &&
V_2 -> V_109 -> V_162 )
F_42 ( V_2 ) ;
return 0 ;
...
static int T_6 F_99 ( const struct V_163 * V_164 )
{
V_109 = V_164 -> V_165 ;
return 0 ;
}
...
return - V_76 ;
V_109 = & V_167 ;
if ( ! V_153 && ! F_102 ( V_168 ) )
return - V_76 ;
V_2 = F_103 ( sizeof( * V_2 ) , V_169 ) ;
if ( ! V_2 )
return - V_106 ;
F_104 ( & V_2 -> V_15 ) ;
V_2 -> V_112 = true ;
