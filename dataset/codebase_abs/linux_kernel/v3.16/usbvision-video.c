...
{
struct V_1 * V_11 = F_21 ( V_42 ) ;
if ( ! V_11 -> V_69 || V_94 -> V_74 )
return - V_76 ;
if ( V_11 -> V_95 ) {
strcpy ( V_94 -> V_78 , L_18 ) ;
V_94 -> type = V_96 ;
} else {
strcpy ( V_94 -> V_78 , L_12 ) ;
}
F_7 ( V_11 , V_81 , V_97 , V_94 ) ;
return 0 ;
}
...
{
struct V_1 * V_11 = F_21 ( V_42 ) ;
if ( ! V_11 -> V_69 || V_100 -> V_81 )
return - V_76 ;
V_11 -> V_100 = V_100 -> V_102 ;
F_7 ( V_11 , V_81 , V_103 , V_100 ) ;
return 0 ;
}
...
struct V_1 * V_11 = F_21 ( V_42 ) ;
if ( V_11 -> V_95 )
strcpy ( V_105 -> V_78 , L_18 ) ;
else
strcpy ( V_105 -> V_78 , L_19 ) ;
return 0 ;
}
...
struct V_1 * V_11 = F_21 ( V_42 ) ;
struct V_120 * V_121 ;
if ( V_119 -> V_74 >= V_11 -> V_122 )
return - V_76 ;
V_119 -> V_123 = V_124 ;
V_121 = & V_11 -> V_121 [ V_119 -> V_74 ] ;
...
V_119 -> V_123 |= V_131 ;
V_119 -> V_115 = V_116 ;
V_119 -> V_132 . V_133 = V_119 -> V_74 * F_76 ( V_11 -> V_134 ) ;
V_119 -> V_115 = V_116 ;
V_119 -> V_135 = V_136 ;
V_119 -> V_137 = V_11 -> V_88 *
V_11 -> V_89 *
V_11 -> V_138 . V_139 ;
V_119 -> V_140 = V_11 -> V_121 [ V_119 -> V_74 ] . V_140 ;
V_119 -> V_141 = V_11 -> V_121 [ V_119 -> V_74 ] . V_141 ;
return 0 ;
}
...
F_79 ( & V_11 -> V_121 [ V_119 -> V_74 ] . V_121 , & V_11 -> V_149 ) ;
...
F_85 ( V_11 -> V_151 . V_154 ) ;
F_80 ( & V_11 -> V_148 , V_142 ) ;
if ( V_121 -> V_125 == V_187 ) {
V_121 -> V_188 = 0 ;
return 0 ;
}
F_22 ( V_44 , L_21 ,
V_41 ,
V_121 -> V_74 , V_121 -> V_188 , V_121 -> V_146 ) ;
if ( ( V_113 + V_121 -> V_188 ) > ( unsigned long ) V_121 -> V_146 )
V_113 = V_121 -> V_146 - V_121 -> V_188 ;
...
V_58 != F_76 ( V_11 -> V_134 ) ) {
return - V_76 ;
}
for ( V_157 = 0 ; V_157 < V_11 -> V_122 ; V_157 ++ ) {
if ( ( ( F_76 ( V_11 -> V_134 ) * V_157 ) >> V_199 ) ==
V_191 -> V_200 )
break;
}
if ( V_157 == V_11 -> V_122 ) {
...
T_8 V_267 = F_132 ( V_243 -> V_245 [ V_157 ] . V_250 [ 1 ] . V_165 .
V_268 ) ;
V_11 -> V_234 [ V_157 ] =
( V_267 & 0x07ff ) * ( ( ( V_267 & 0x1800 ) >> 11 ) + 1 ) ;
F_22 ( V_217 , L_47 , V_157 ,
V_11 -> V_234 [ V_157 ] ) ;
}
V_11 -> V_222 = V_269 ++ ;
