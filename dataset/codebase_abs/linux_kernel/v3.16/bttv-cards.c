...
{
int V_210 , V_211 , V_212 , V_33 = 0 ;
V_210 = ( V_23 [ 0x41 ] & 0x7 ) ;
V_211 = ( V_23 [ 0x41 ] & 0x18 ) >> 3 ;
V_212 = ( V_23 [ 0x42 ] & 0xf0 ) >> 4 ;
...
{
if ( V_2 -> V_216 == V_217 ) {
if ( V_218 [ V_2 -> V_219 ] . V_220 & V_221 )
V_3 |= 0x10000 ;
else
V_3 &= ~ 0x10000 ;
}
...
static void F_30 ( struct V_1 * V_2 , int V_222 )
{
int V_223 = ( 1 << V_222 ) ;
F_8 ( V_223 , V_223 ) ;
F_15 ( V_223 , 0 ) ;
...
{
static int V_226 [] = { 0x08 , 0x09 , 0x0a , 0x0b , 0x0d , 0x0d , 0x01 , 0x02 ,
...
F_9 ( 10 ) ;
F_14 ( 1 << 2 ) ;
for ( V_4 = 0 ; V_4 < F_4 ( V_226 ) ; V_4 ++ ) {
V_227 = F_65 ( V_2 , 0x1E , 0 , V_226 [ V_4 ] , 1 ) ;
if ( V_227 != - 1 ) {
F_2 ( L_75 ,
V_226 [ V_4 ] , V_227 , F_12 ( V_2 , 0x1F , NULL ) ) ;
}
}
F_2 ( L_76 ) ;
}
...
F_2 ( L_77 ,
V_2 -> V_6 . V_12 ) ;
F_22 ( 0x00c3feff , V_235 ) ;
F_22 ( 0 + V_234 , V_236 ) ;
F_67 ( 1 ) ;
F_22 ( 0x10 + V_234 , V_236 ) ;
F_67 ( 10 ) ;
F_22 ( 0 + V_234 , V_236 ) ;
V_233 = F_66 ( V_236 ) ;
if ( ( ( ( V_233 >> 18 ) & 0x01 ) != 0 ) || ( ( ( V_233 >> 19 ) & 0x01 ) != 1 ) ) {
F_2 ( L_78 ,
V_2 -> V_6 . V_12 , V_233 ) ;
}
F_22 ( 0x4400 + V_234 , V_236 ) ;
F_67 ( 10 ) ;
F_22 ( 0x4410 + V_234 , V_236 ) ;
F_67 ( 1 ) ;
F_22 ( V_234 , V_236 ) ;
F_67 ( 1 ) ;
V_233 = F_66 ( V_236 ) ;
if ( ( ( ( V_233 >> 18 ) & 0x01 ) != 0 ) || ( ( ( V_233 >> 19 ) & 0x01 ) != 0 ) ) {
F_2 ( L_79 ,
V_2 -> V_6 . V_12 , V_233 ) ;
return;
}
...
{
int V_237 ;
if ( ( F_68 ( V_2 -> V_6 . V_7 -> V_238 ) & ~ 3 ) != 0xC ) {
F_46 ( L_81 ) ;
return;
}
if ( F_68 ( V_2 -> V_6 . V_7 -> V_238 ) != 0xD )
return;
F_22 ( 0x080002 , V_235 ) ;
V_237 = ( F_66 ( V_236 ) >> 21 ) & 7 ;
for (; ; ) {
switch ( V_237 ) {
case 1 :
case 5 :
...
static void F_70 ( struct V_1 * V_2 , int V_239 )
{
if ( V_2 -> V_189 ) {
...
static void F_71 ( struct V_1 * V_2 , int V_239 )
{
if ( V_2 -> V_189 ) {
F_15 ( V_2 -> V_189 | V_2 -> V_188 | V_2 -> V_190 ,
V_2 -> V_189 | V_2 -> V_188 | V_2 -> V_190 ) ;
...
static int F_72 ( struct V_1 * V_2 , int V_239 )
{
if ( V_2 -> V_189 ) {
F_15 ( V_2 -> V_189 | V_2 -> V_188 | V_2 -> V_190 ,
V_2 -> V_189 | V_2 -> V_188 | V_2 -> V_190 ) ;
...
F_70 ( V_2 , V_2 -> V_46 ) ;
F_9 ( 10 ) ;
V_240 = V_241 + F_73 ( 1000 ) ;
while ( F_72 ( V_2 , V_2 -> V_47 ) && F_74 ( V_241 , V_240 ) )
F_75 () ;
...
{
static const T_2 V_243 [] = { 0x3 , 0x1 , 0x2 , 0x4 , 0xf , 0x7 , 0xe , 0x0 ,
0xd , 0xb , 0xc , 0x6 , 0x9 , 0x5 , 0x8 , 0xa } ;
F_15 ( 0x07f , V_243 [ V_59 ] ) ;
F_15 ( 0x200 , 0x200 ) ;
F_63 ( 1 ) ;
F_15 ( 0x200 , 0x000 ) ;
F_63 ( 1 ) ;
...
unsigned char V_203 ) {
unsigned int V_246 ;
V_246 = ( V_203 << 7 ) | ( ( V_245 & 3 ) << 4 ) | ( V_244 & 0xf ) ;
F_15 ( 0x1ff , V_246 ) ;
F_15 ( 0x1ff , V_246 | ( 1 << 8 ) ) ;
F_15 ( 0x1ff , V_246 ) ;
}
...
int V_244 , V_245 ;
struct V_1 * V_247 ;
static unsigned char V_248 [ 4 ] = { 3 , 0 , 2 , 1 } ;
V_247 = V_249 [ V_2 -> V_6 . V_12 ] ;
if ( V_247 == NULL ) {
return;
}
V_245 = ( V_2 -> V_6 . V_12 - V_247 -> V_6 . V_12 + 1 ) & 3 ;
V_245 = V_248 [ V_245 ] ;
V_244 = V_59 & 0xf ;
if ( V_247 -> V_250 [ V_245 ] != V_244 )
{
F_81 ( V_247 , V_247 -> V_250 [ V_245 ] , V_245 , 0 ) ;
V_247 -> V_250 [ V_245 ] = V_244 ;
F_81 ( V_247 , V_244 , V_245 , 1 ) ;
}
}
...
F_14 ( 1 << 9 ) ;
F_14 ( 0 ) ;
for ( V_251 = 0 ; V_251 < 4 ; V_251 ++ ) {
V_2 -> V_250 [ V_251 ] = V_251 ;
F_81 ( V_2 , V_251 , V_251 , 1 ) ;
}
if ( ( V_2 -> V_6 . V_12 < 1 ) || ( V_2 -> V_6 . V_12 > V_252 - 3 ) )
return;
V_249 [ V_2 -> V_6 . V_12 - 1 ] = V_2 ;
V_249 [ V_2 -> V_6 . V_12 ] = V_2 ;
V_249 [ V_2 -> V_6 . V_12 + 1 ] = V_2 ;
V_249 [ V_2 -> V_6 . V_12 + 2 ] = V_2 ;
}
...
V_257 , V_257 | V_258 , V_257 | V_259 , V_257 | V_258 | V_259 ,
V_260 , V_260 | V_258 , V_260 | V_259 , V_260 | V_258 | V_259 ,
} ;
F_14 ( V_65 [ V_59 % 16 ] ) ;
}
...
int V_262 = V_59 / 4 ;
F_76 ( L_96 ,
V_2 -> V_6 . V_12 , V_59 , V_262 , V_261 ) ;
F_65 ( V_2 , V_263 , 0x00 ,
( ( V_262 == 3 ) ? ( V_261 | V_261 << 2 ) : 0x00 ) , 1 ) ;
F_65 ( V_2 , V_264 , 0x00 ,
( ( V_262 == 0 ) ? ( V_261 | V_261 << 2 ) : 0x00 ) , 1 ) ;
F_65 ( V_2 , V_265 , 0x00 ,
( ( V_262 == 1 ) ? ( V_261 | V_261 << 2 ) : 0x00 ) , 1 ) ;
F_65 ( V_2 , V_266 , 0x00 ,
( ( V_262 == 2 ) ? ( V_261 | V_261 << 2 ) : 0x00 ) , 1 ) ;
F_65 ( V_2 , V_263 , 0x02 ,
( ( V_262 == 3 ) ? 0x03 : 0x00 ) , 1 ) ;
F_65 ( V_2 , V_264 , 0x02 ,
( ( V_262 == 0 ) ? 0x03 : 0x00 ) , 1 ) ;
...
long V_267 ;
int V_268 ;
unsigned char V_269 [ 2 ] ;
V_269 [ 0 ] = 0 ;
V_269 [ 1 ] = 0 ;
V_201 = F_65 ( V_2 , ( V_270 << 1 ) , V_269 [ 0 ] , V_269 [ 1 ] , 1 ) ;
if ( V_201 ) {
F_3 ( L_97 ,
V_2 -> V_6 . V_12 , V_201 ) ;
return;
}
V_201 = F_12 ( V_2 , ( V_270 << 1 ) , NULL ) ;
if ( ! ( V_201 & V_271 ) ) {
F_3 ( L_98 ,
V_2 -> V_6 . V_12 , V_201 ) ;
return;
...
V_268 = F_66 ( V_236 ) ;
if ( V_2 -> V_5 == V_272 )
V_268 = ( V_268 & ~ 0x280 ) | ( ( V_267 & 2 ) << 8 ) | ( ( V_267 & 1 ) << 7 ) ;
else
V_268 = ( V_268 & ~ 0x300 ) | ( ( V_267 & 3 ) << 8 ) ;
F_22 ( V_268 , V_236 ) ;
if ( V_2 -> V_5 == V_272 )
F_16 ( 2 << 5 , ~ V_273 , V_58 ) ;
else
F_19 ( ~ V_273 , V_58 ) ;
F_3 ( L_99 , V_2 -> V_6 . V_12 , ( int ) V_267 ) ;
}
static void F_87 ( struct V_1 * V_2 , unsigned int V_59 )
{
unsigned int V_267 = V_59 % 4 ;
if ( V_59 == V_2 -> V_137 )
V_267 = 0 ;
F_15 ( 0x3 , V_267 ) ;
}
...
unsigned char V_245 ,
unsigned char V_203 ) {
const T_1 V_274 = ( ( V_244 & 0xf ) | ( V_245 & 3 ) << 4 ) ;
const T_1 V_275 = 1 << 16 ;
const T_1 V_276 = 1 << 17 ;
const T_1 V_277 = V_203 << 18 ;
F_15 ( 0x1007f , V_274 | V_275 ) ;
F_15 ( 0x20000 , V_276 ) ;
F_15 ( 0x40000 , V_277 ) ;
F_15 ( 0x20000 , ~ V_276 ) ;
}
...
struct V_1 * V_247 ;
int V_244 , V_245 ;
static unsigned int V_248 [ 4 ] [ 4 ] = { { 0x0 , 0x4 , 0xa , 0x6 } ,
{ 0x1 , 0x5 , 0xb , 0x7 } ,
{ 0x2 , 0x8 , 0xc , 0xe } ,
{ 0x3 , 0x9 , 0xd , 0xf } } ;
V_59 = V_59 % 4 ;
...
V_245 = ( V_2 -> V_6 . V_12 - V_247 -> V_6 . V_12 ) & 3 ;
V_244 = V_248 [ V_245 ] [ V_59 ] & 0xf ;
if ( V_247 -> V_250 [ V_245 ] != V_244 ) {
F_88 ( V_247 , V_247 -> V_250 [ V_245 ] , V_245 , 0 ) ;
V_247 -> V_250 [ V_245 ] = V_244 ;
F_88 ( V_247 , V_244 , V_245 , 1 ) ;
}
}
...
for ( V_251 = 0 ; V_251 < 4 ; V_251 ++ ) {
V_2 -> V_250 [ V_251 ] = V_251 ;
F_88 ( V_2 , V_251 , V_251 , 1 ) ;
}
F_65 ( V_2 , 0x18 , 0x5 , 0x90 , 1 ) ;
if ( V_2 -> V_6 . V_12 > V_252 - 4 )
return;
V_249 [ V_2 -> V_6 . V_12 ] = V_2 ;
V_249 [ V_2 -> V_6 . V_12 + 1 ] = V_2 ;
V_249 [ V_2 -> V_6 . V_12 + 2 ] = V_2 ;
V_249 [ V_2 -> V_6 . V_12 + 3 ] = V_2 ;
}
void T_5 F_90 ( void )
{
int V_278 = 0 ;
struct V_279 * V_202 = NULL ;
if ( V_280 & ( V_281 | V_282 ) )
V_278 = 1 ;
if ( V_280 & ( V_283 | V_284 | V_285 ) )
V_286 = 1 ;
if ( V_280 & V_287 )
V_288 = 1 ;
#ifdef F_91
...
if ( V_18 != V_289 )
F_2 ( L_105 , V_289 ) ;
while ( ( V_202 = F_92 ( V_291 ,
V_292 , V_202 ) ) ) {
unsigned char V_293 ;
F_93 ( V_202 , 0x53 , & V_293 ) ;
if ( V_70 )
F_2 ( L_106 ,
V_293 ) ;
}
...
{
unsigned char V_294 ;
if ( ! V_286 && ! V_288 && V_18 == V_289 )
return 0 ;
if ( V_225 ) {
if ( V_286 )
F_2 ( L_107 ,
V_2 -> V_6 . V_12 ) ;
if ( V_288 && V_2 -> V_11 >= 878 )
...
F_93 ( V_2 -> V_6 . V_7 , V_296 , & V_294 ) ;
if ( V_286 )
V_294 |= V_297 ;
if ( V_288 )
V_294 |= V_298 ;
F_95 ( V_2 -> V_6 . V_7 , V_296 , V_294 ) ;
}
if ( V_18 != V_289 )
F_95 ( V_2 -> V_6 . V_7 , V_299 , V_289 ) ;
return 0 ;
}
