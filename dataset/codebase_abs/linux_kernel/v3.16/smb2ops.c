...
static void
F_96 ( struct V_1 * V_2 ,
struct V_135 * V_136 , bool V_232 )
{
if ( V_232 )
V_2 -> V_15 -> V_140 ( V_136 , V_233 ,
0 , NULL ) ;
else
V_2 -> V_15 -> V_140 ( V_136 , 0 , 0 , NULL ) ;
}
static void
...
static void
F_99 ( struct V_135 * V_136 , T_8 V_62 ,
unsigned int V_141 , bool * V_142 )
{
unsigned int V_247 = V_136 -> V_62 ;
F_98 ( V_136 , V_62 , V_141 , V_142 ) ;
if ( V_142 ) {
* V_142 = false ;
if ( V_247 == V_240 ) {
if ( V_136 -> V_62 == V_240 &&
( V_141 - V_136 -> V_141 > 0 ) )
* V_142 = true ;
else if ( V_136 -> V_62 == V_248 &&
( V_141 - V_136 -> V_141 > 1 ) )
* V_142 = true ;
else if ( V_136 -> V_62 == V_236 &&
( V_141 - V_136 -> V_141 > 1 ) )
* V_142 = true ;
...
static char *
F_103 ( T_3 * V_203 , T_3 V_62 )
{
struct V_252 * V_30 ;
V_30 = F_39 ( sizeof( struct V_252 ) , V_90 ) ;
if ( ! V_30 )
return NULL ;
V_30 -> V_253 . V_254 = F_60 ( * ( ( T_5 * ) V_203 ) ) ;
V_30 -> V_253 . V_255 = F_60 ( * ( ( T_5 * ) ( V_203 + 8 ) ) ) ;
V_30 -> V_253 . V_256 = F_102 ( V_62 ) ;
V_30 -> V_257 . V_179 = F_104 ( F_105
( struct V_252 , V_253 ) ) ;
V_30 -> V_257 . V_180 = F_61 ( sizeof( struct V_258 ) ) ;
V_30 -> V_257 . V_259 = F_104 ( F_105
( struct V_252 , V_260 ) ) ;
V_30 -> V_257 . V_261 = F_104 ( 4 ) ;
V_30 -> V_260 [ 0 ] = 'R' ;
V_30 -> V_260 [ 1 ] = 'q' ;
V_30 -> V_260 [ 2 ] = 'L' ;
V_30 -> V_260 [ 3 ] = 's' ;
...
static char *
F_106 ( T_3 * V_203 , T_3 V_62 )
{
struct V_262 * V_30 ;
V_30 = F_39 ( sizeof( struct V_262 ) , V_90 ) ;
if ( ! V_30 )
return NULL ;
V_30 -> V_253 . V_254 = F_60 ( * ( ( T_5 * ) V_203 ) ) ;
V_30 -> V_253 . V_255 = F_60 ( * ( ( T_5 * ) ( V_203 + 8 ) ) ) ;
...
V_30 -> V_257 . V_179 = F_104 ( F_105
( struct V_262 , V_253 ) ) ;
V_30 -> V_257 . V_180 = F_61 ( sizeof( struct V_263 ) ) ;
V_30 -> V_257 . V_259 = F_104 ( F_105
( struct V_262 , V_260 ) ) ;
V_30 -> V_257 . V_261 = F_104 ( 4 ) ;
V_30 -> V_260 [ 0 ] = 'R' ;
...
{
struct V_252 * V_264 = (struct V_252 * ) V_30 ;
* V_141 = 0 ;
if ( V_264 -> V_253 . V_265 & V_266 )
return V_234 ;
return F_26 ( V_264 -> V_253 . V_256 ) ;
}
static T_4
F_108 ( void * V_30 , unsigned int * V_141 )
{
struct V_262 * V_264 = (struct V_262 * ) V_30 ;
* V_141 = F_11 ( V_264 -> V_253 . V_267 ) ;
if ( V_264 -> V_253 . V_265 & V_266 )
return V_234 ;
return F_26 ( V_264 -> V_253 . V_256 ) ;
}
