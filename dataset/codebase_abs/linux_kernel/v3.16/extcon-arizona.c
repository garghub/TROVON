...
V_2 -> V_77 = F_60 ( & V_139 -> V_14 , V_152 ) ;
if ( F_55 ( V_2 -> V_77 ) ) {
F_17 ( & V_139 -> V_14 , L_59 ) ;
return - V_147 ;
}
V_2 -> V_77 -> V_153 = L_60 ;
V_2 -> V_77 -> V_14 . V_140 = V_4 -> V_14 ;
V_5 = F_61 ( & V_139 -> V_14 , V_2 -> V_77 ) ;
if ( V_5 < 0 ) {
F_17 ( V_4 -> V_14 , L_61 ,
V_5 ) ;
return V_5 ;
}
V_2 -> V_108 = F_62 ( & V_139 -> V_14 ) ;
if ( ! V_2 -> V_108 ) {
F_17 ( V_4 -> V_14 , L_62 ) ;
V_5 = - V_147 ;
goto V_154;
}
V_2 -> V_108 -> V_153 = L_63 ;
V_2 -> V_108 -> V_155 = L_64 ;
...
V_4 -> V_18 . V_167
<< V_169 ) ;
F_64 ( F_27 ( V_170 ) != 0x40 ) ;
if ( V_4 -> V_18 . V_107 ) {
V_2 -> V_109 = V_18 -> V_109 ;
V_2 -> V_107 = V_18 -> V_107 ;
} else {
V_2 -> V_109 = V_171 ;
V_2 -> V_107 = F_27 ( V_171 ) ;
}
if ( V_4 -> V_18 . V_107 > V_172 ) {
F_17 ( V_4 -> V_14 , L_68 ,
V_4 -> V_18 . V_107 ) ;
}
if ( V_2 -> V_107 > 1 ) {
...
V_176 , 0x81 ) ;
for ( V_93 = 0 ; V_93 < V_2 -> V_107 ; V_93 ++ ) {
for ( V_144 = 0 ; V_144 < F_27 ( V_170 ) ; V_144 ++ )
if ( V_170 [ V_144 ] >= V_2 -> V_109 [ V_93 ] . V_58 )
break;
if ( V_144 == F_27 ( V_170 ) ) {
F_17 ( V_4 -> V_14 , L_70 ,
V_2 -> V_109 [ V_93 ] . V_58 ) ;
...
V_5 = F_69 ( V_4 , V_143 , 1 ) ;
if ( V_5 != 0 ) {
F_17 ( & V_139 -> V_14 , L_74 ,
V_5 ) ;
goto V_187;
}
V_5 = F_68 ( V_4 , V_142 ,
L_75 , F_49 , V_2 ) ;
if ( V_5 != 0 ) {
F_17 ( & V_139 -> V_14 , L_76 , V_5 ) ;
goto V_188;
}
V_5 = F_69 ( V_4 , V_142 , 1 ) ;
if ( V_5 != 0 ) {
F_17 ( & V_139 -> V_14 , L_77 ,
V_5 ) ;
goto V_189;
}
V_5 = F_68 ( V_4 , V_190 ,
