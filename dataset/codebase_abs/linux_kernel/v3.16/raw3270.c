...
return V_2 && V_2 -> V_35 == V_35 &&
! F_4 ( V_39 , & V_2 -> V_9 ) ;
}
int
F_30 ( struct V_34 * V_35 , struct V_11 * V_13 )
{
unsigned long V_9 ;
struct V_1 * V_2 ;
int V_25 ;
F_31 ( F_32 ( V_35 -> V_38 -> V_33 ) , V_9 ) ;
V_2 = V_35 -> V_38 ;
...
int
F_35 ( struct V_34 * V_35 , struct V_11 * V_13 )
{
struct V_1 * V_2 ;
V_2 = V_35 -> V_38 ;
V_13 -> V_35 = V_35 ;
...
static void
F_36 ( struct V_42 * V_33 , unsigned long V_43 , struct V_44 * V_44 )
{
struct V_1 * V_2 ;
struct V_34 * V_35 ;
struct V_11 * V_13 ;
...
while ( ! F_15 ( & V_2 -> V_36 ) ) {
V_13 = F_43 ( V_2 -> V_36 . V_61 , struct V_11 , V_18 ) ;
V_13 -> V_25 = F_26 ( V_2 -> V_33 , & V_13 -> V_19 ,
( unsigned long ) V_13 , 0 , 0 ) ;
if ( V_13 -> V_25 == 0 )
break;
...
static void
F_49 ( struct V_11 * V_13 , void * V_27 )
{
...
V_2 -> V_3 = V_89 ;
F_35 ( & V_2 -> V_93 , & V_2 -> V_95 ) ;
}
static void
F_52 ( struct V_11 * V_13 , void * V_27 )
{
struct V_1 * V_2 = V_13 -> V_35 -> V_38 ;
if ( V_2 -> V_3 != V_97 )
return;
...
unsigned long V_9 ;
int V_25 ;
F_31 ( F_32 ( V_2 -> V_33 ) , V_9 ) ;
V_25 = F_53 ( V_2 ) ;
F_33 ( F_32 ( V_2 -> V_33 ) , V_9 ) ;
return V_25 ;
}
int
...
static int
F_56 ( struct V_34 * V_35 , struct V_11 * V_13 ,
struct V_44 * V_44 )
{
struct V_1 * V_2 ;
if ( V_44 -> V_46 . V_26 . V_51 & V_102 ) {
if ( V_44 -> V_103 [ 0 ] & V_104 ) {
F_39 ( V_37 , & V_35 -> V_38 -> V_9 ) ;
return V_55 ;
}
}
if ( V_13 ) {
...
static int
F_57 ( struct V_42 * V_33 , struct V_1 * V_2 , char * V_108 )
{
struct V_109 * V_82 ;
struct V_1 * V_110 ;
int V_111 ;
...
V_111 = V_117 ;
V_2 -> V_111 = - 1 ;
F_59 (l, &raw3270_devices) {
V_110 = F_43 ( V_82 , struct V_1 , V_18 ) ;
if ( V_110 -> V_111 > V_111 ) {
V_2 -> V_111 = V_111 ;
F_60 ( & V_2 -> V_18 , V_82 -> V_118 , V_82 ) ;
break;
}
V_111 ++ ;
}
...
int
F_73 ( struct V_34 * V_35 )
{
struct V_1 * V_2 ;
struct V_34 * V_125 , * V_126 ;
unsigned long V_9 ;
int V_25 ;
V_2 = V_35 -> V_38 ;
if ( ! V_2 )
...
V_125 = NULL ;
if ( V_2 -> V_35 && V_2 -> V_35 -> V_56 -> V_128 ) {
V_125 = V_2 -> V_35 ;
V_125 -> V_56 -> V_128 ( V_125 ) ;
}
V_2 -> V_35 = V_35 ;
V_25 = V_35 -> V_56 -> V_88 ( V_35 ) ;
if ( V_25 ) {
V_2 -> V_35 = V_125 ;
if ( ! V_125 || V_125 -> V_56 -> V_88 ( V_125 ) != 0 ) {
F_48 (nv, &rp->view_list, list)
if ( V_126 != V_35 && V_126 != V_125 ) {
V_2 -> V_35 = V_126 ;
if ( V_126 -> V_56 -> V_88 ( V_126 ) == 0 )
break;
V_2 -> V_35 = NULL ;
}
}
...
int
F_75 ( struct V_34 * V_35 , struct V_129 * V_56 , int V_111 )
{
unsigned long V_9 ;
struct V_1 * V_2 ;
int V_25 ;
...
struct V_34 *
F_79 ( struct V_129 * V_56 , int V_111 )
{
struct V_1 * V_2 ;
...
static int
F_86 ( struct V_42 * V_33 )
{
return 0 ;
}
static T_4
F_87 ( struct V_133 * V_38 , struct V_134 * V_135 , char * V_136 )
{
return snprintf ( V_136 , V_137 , L_1 ,
( (struct V_1 * ) F_37 ( V_38 ) ) -> V_62 ) ;
}
static T_4
F_88 ( struct V_133 * V_38 , struct V_134 * V_135 , char * V_136 )
{
return snprintf ( V_136 , V_137 , L_1 ,
( (struct V_1 * ) F_37 ( V_38 ) ) -> V_71 ) ;
}
static T_4
F_89 ( struct V_133 * V_38 , struct V_134 * V_135 , char * V_136 )
{
return snprintf ( V_136 , V_137 , L_1 ,
( (struct V_1 * ) F_37 ( V_38 ) ) -> V_72 ) ;
}
static int F_90 ( struct V_1 * V_2 )
{
return F_91 ( & V_2 -> V_33 -> V_38 . V_138 , & V_139 ) ;
}
int F_92 ( struct V_140 * V_141 )
{
struct V_1 * V_2 ;
F_58 ( & V_116 ) ;
F_28 ( & V_141 -> V_18 , & V_140 ) ;
F_48 (rp, &raw3270_devices, list)
V_141 -> V_142 ( V_2 -> V_111 ) ;
F_61 ( & V_116 ) ;
return 0 ;
}
void F_93 ( struct V_140 * V_141 )
{
struct V_1 * V_2 ;
F_58 ( & V_116 ) ;
F_48 (rp, &raw3270_devices, list)
V_141 -> V_143 ( V_2 -> V_111 ) ;
F_94 ( & V_141 -> V_18 ) ;
F_61 ( & V_116 ) ;
}
static int
F_95 ( struct V_42 * V_33 )
{
struct V_140 * V_144 ;
struct V_1 * V_2 ;
int V_25 ;
...
F_54 ( V_2 ) ;
F_58 ( & V_116 ) ;
F_48 (np, &raw3270_notifier, list)
V_144 -> V_142 ( V_2 -> V_111 ) ;
F_61 ( & V_116 ) ;
return 0 ;
V_145:
F_84 ( V_2 ) ;
...
if ( V_2 == NULL )
return;
F_98 ( & V_33 -> V_38 . V_138 , & V_139 ) ;
F_31 ( F_32 ( V_33 ) , V_9 ) ;
if ( V_2 -> V_35 ) {
if ( V_2 -> V_35 -> V_56 -> V_128 )
V_2 -> V_35 -> V_56 -> V_128 ( V_2 -> V_35 ) ;
V_2 -> V_35 = NULL ;
}
while ( ! F_15 ( & V_2 -> V_114 ) ) {
V_146 = F_43 ( V_2 -> V_114 . V_61 , struct V_34 , V_18 ) ;
if ( V_146 -> V_56 -> V_147 )
V_146 -> V_56 -> V_147 ( V_146 ) ;
F_33 ( F_32 ( V_33 ) , V_9 ) ;
F_80 ( V_146 ) ;
F_31 ( F_32 ( V_33 ) , V_9 ) ;
}
...
F_58 ( & V_116 ) ;
F_48 (np, &raw3270_notifier, list)
V_144 -> V_143 ( V_2 -> V_111 ) ;
F_61 ( & V_116 ) ;
F_54 ( V_2 ) ;
F_84 ( V_2 ) ;
}
static int
F_99 ( struct V_42 * V_33 )
{
struct V_1 * V_2 ;
V_2 = F_37 ( & V_33 -> V_38 ) ;
if ( F_4 ( V_124 , & V_2 -> V_9 ) )
return - V_41 ;
F_97 ( V_33 ) ;
return 0 ;
}
static int F_100 ( struct V_42 * V_33 )
{
struct V_1 * V_2 ;
struct V_34 * V_35 ;
unsigned long V_9 ;
...
static int F_101 ( struct V_42 * V_33 )
{
struct V_1 * V_2 ;
unsigned long V_9 ;
V_2 = F_37 ( & V_33 -> V_38 ) ;
