...
if ( V_373 -> V_375 ) {
V_208 . V_177 = V_262 ;
V_374 = V_373 -> V_376 [ 0 ] . V_374 ;
V_284 = V_373 -> V_376 [ 0 ] . V_269 ;
} else {
V_208 . V_177 = V_211 ;
}
if ( V_284 ) {
memcpy ( V_208 . V_244 , V_374 , V_284 ) ;
V_208 . V_243 = V_284 ;
}
V_208 . V_180 = F_38 ( V_71 -> V_213 ) ;
V_208 . V_181 = F_38 ( V_71 -> V_214 ) ;
...
static int F_122 ( struct V_345 * V_79 , T_2 V_377 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
F_13 ( V_313 , L_148 ,
V_37 , V_79 -> V_378 . V_379 . V_380 -> V_358 ) ;
F_39 ( V_313 , V_71 -> V_209 , V_75 , L_149 ) ;
F_82 ( & V_71 -> V_279 ) ;
V_71 -> V_210 = V_79 -> V_378 . V_379 . V_380 -> V_358 ;
if ( F_99 ( V_71 -> V_209 ) )
F_97 ( V_71 ) ;
else
F_63 ( V_71 ) ;
...
if ( ! ( V_377 & V_382 ) )
return;
F_39 ( V_313 , V_378 -> V_209 , V_75 , L_149 ) ;
F_82 ( & V_71 -> V_279 ) ;
memcpy ( V_71 -> V_209 , V_378 -> V_209 , V_75 ) ;
if ( F_99 ( V_71 -> V_209 ) )
F_97 ( V_71 ) ;
F_83 ( & V_71 -> V_279 ) ;
}
...
{
int V_21 = 0 ;
struct V_141 * V_387 = & V_71 -> V_116 . V_53 . V_388 ;
...
V_387 -> V_143 = V_71 -> V_247 ;
V_387 -> V_144 = V_71 -> V_248 ;
memcpy ( V_387 -> V_153 , V_71 -> V_271 ,
sizeof( V_71 -> V_271 ) ) ;
V_21 = F_45 ( V_71 , & V_71 -> V_116 ) ;
if ( V_21 < 0 )
F_30 ( V_71 -> V_79 -> V_80 ,
...
static int F_126 ( struct V_345 * V_79 , enum V_389 V_85 ,
struct V_366 * V_367 , struct V_390 * V_391 ,
struct V_392 * V_393 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
int V_73 ;
F_13 ( V_313 , L_153
L_154 ,
V_37 , V_85 , V_393 -> V_394 , V_393 -> V_395 , V_393 -> V_396 ) ;
if ( ( V_393 -> V_394 != V_397 ) &&
( V_393 -> V_394 != V_398 ) )
return - V_370 ;
V_393 -> V_399 = V_393 -> V_395 ;
F_82 ( & V_71 -> V_279 ) ;
switch ( V_85 ) {
case V_400 :
memcpy ( V_71 -> V_271 [ V_393 -> V_395 ] , V_393 -> V_393 , V_393 -> V_396 ) ;
V_71 -> V_249 [ V_393 -> V_395 ] = V_393 -> V_396 ;
V_71 -> V_248 = V_393 -> V_395 ;
break;
case V_401 :
default:
V_71 -> V_249 [ V_393 -> V_395 ] = 0 ;
break;
}
V_71 -> V_247 = 0 ;
for ( V_73 = 0 ; V_73 < V_152 ; V_73 ++ ) {
...
struct V_345 * V_79 ;
struct V_70 * V_71 ;
V_79 = F_128 ( sizeof( struct V_70 ) , & V_402 ) ;
if ( ! V_79 ) {
...
struct V_404 * V_405 )
{
struct V_406 * V_407 , * V_408 , * V_409 ;
int V_73 ;
int V_410 ;
struct V_411 * V_412 ;
F_13 ( V_413 , L_157 , V_37 ) ;
F_13 ( V_299 , L_158 , V_37 ,
V_405 -> V_414 [ 0 ] . V_415 . V_416 ) ;
V_408 = NULL ;
V_409 = NULL ;
V_412 = V_405 -> V_417 ;
for ( V_73 = 0 ; V_73 < V_412 -> V_415 . V_416 ; V_73 ++ ) {
V_407 = & V_412 -> V_407 [ V_73 ] . V_415 ;
F_13 ( V_299 , L_159 ,
V_37 , V_73 , V_407 -> V_418 ,
V_407 -> V_419 ) ;
if ( ! V_408 && F_135 ( V_407 ) )
V_408 = V_407 ;
if ( ! V_409 && F_136 ( V_407 ) )
V_409 = V_407 ;
}
if ( ! V_408 || ! V_409 ) {
F_14 ( & V_405 -> V_38 , L_160 ) ;
return - V_420 ;
}
V_71 -> V_226 = F_137 ( V_71 -> V_10 , V_408 -> V_418 ) ;
V_71 -> V_362 = F_138 ( V_71 -> V_10 , V_409 -> V_418 ) ;
V_71 -> V_223 = F_139 ( 0 , V_40 ) ;
V_71 -> V_354 = F_139 ( 0 , V_40 ) ;
if ( ! V_71 -> V_223 || ! V_71 -> V_354 ) {
F_14 ( & V_405 -> V_38 , L_161 ) ;
return - V_41 ;
}
V_410 = sizeof( struct V_348 ) + V_421 ;
V_71 -> V_350 = F_15 ( V_410 , V_40 ) ;
if ( ! V_71 -> V_350 )
return - V_41 ;
F_13 ( V_413 , L_162 , V_37 ) ;
return 0 ;
}
...
int V_21 ;
F_13 ( V_229 , L_163 ,
V_405 -> V_417 -> V_415 . V_416 ) ;
V_21 = F_134 ( V_71 , V_405 ) ;
if ( V_21 < 0 )
goto exit;
V_21 = F_29 ( V_71 ) ;
if ( V_21 < 0 ) {
F_14 ( & V_405 -> V_38 , L_164 ) ;
goto exit;
}
V_71 -> V_422 = F_31 ( V_71 -> V_76 ) ;
V_71 -> V_210 = V_423 ;
V_71 -> V_245 = V_369 ;
V_71 -> V_130 = V_424 ;
V_71 -> V_128 = V_425 ;
...
V_71 -> V_278 = 0 ;
V_80 = V_71 -> V_79 -> V_80 ;
V_71 -> V_79 -> V_80 -> V_430 = 1 ;
V_71 -> V_79 -> V_80 -> V_431 = 0 ;
V_71 -> V_79 -> V_80 -> V_432 = F_141 ( V_368 ) ;
V_71 -> V_79 -> V_80 -> V_433 [ V_294 ] = & V_434 ;
V_71 -> V_79 -> V_343 = V_435 |
V_436 ;
V_71 -> V_79 -> V_437 = 100 ;
F_142 ( V_71 -> V_79 , & V_405 -> V_38 ) ;
...
F_145 ( & V_405 -> V_38 ) , V_71 -> V_74 ,
V_71 -> V_324 . V_325 , V_71 -> V_324 . V_326 ,
V_71 -> V_324 . V_327 , V_71 -> V_324 . V_328 ) ;
F_47 ( V_71 -> V_79 -> V_80 , L_168 ,
V_71 -> V_76 , V_71 -> V_422 -> V_441 ) ;
exit:
return V_21 ;
}
...
static int F_154 ( struct V_404 * V_405 ,
...
int V_1 = ( int ) V_443 -> V_447 ;
V_10 = F_155 ( F_156 ( V_405 ) ) ;
V_446 = F_15 ( sizeof( * V_446 ) , V_40 ) ;
if ( ! V_446 ) {
V_21 = - V_41 ;
goto exit;
}
...
|| ( V_64 == V_450 ) ) {
V_21 = F_33 ( V_10 , V_451 , V_446 , sizeof( * V_446 ) ) ;
if ( V_21 < 0 || ( V_446 -> V_325 | V_446 -> V_326 ) == 0 )
V_444 = 1 ;
} else
V_444 = 1 ;
if ( V_444 ) {
...
F_157 ( V_405 , V_71 ) ;
memcpy ( & V_71 -> V_324 , V_446 , sizeof( struct V_445 ) ) ;
V_71 -> V_1 = V_1 ;
V_21 = F_140 ( V_71 , V_405 ) ;
if ( V_21 < 0 )
F_146 ( V_71 ) ;
exit:
F_18 ( V_446 ) ;
...
static void F_158 ( struct V_404 * V_405 )
{
struct V_70 * V_71 ;
V_71 = F_159 ( V_405 ) ;
F_157 ( V_405 , NULL ) ;
