...
struct V_182 V_183 = { 0 } ;
#endif
switch ( V_173 -> V_106 ) {
case V_107 :
#if F_77 ( V_117 )
if ( V_173 -> V_184 && V_173 -> V_185 ) {
V_10 = F_119 ( V_186 , V_187 , 0 , & V_2 ) ;
if ( V_10 < 0 )
goto V_12;
F_120 ( V_2 -> V_3 , V_6 ) ;
V_181 . V_188 = V_186 ;
memcpy ( & V_181 . V_189 , V_173 -> V_184 ,
sizeof( V_181 . V_189 ) ) ;
V_181 . V_190 = F_72 ( V_173 -> V_191 ) ;
V_10 = F_121 ( V_2 , (struct V_192 * ) & V_181 ,
sizeof( V_181 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_181 . V_188 = V_186 ;
memcpy ( & V_181 . V_189 , V_173 -> V_185 ,
sizeof( V_181 . V_189 ) ) ;
V_181 . V_190 = F_72 ( V_173 -> V_193 ) ;
V_10 = F_122 ( V_2 ,
(struct V_192 * ) & V_181 ,
sizeof( V_181 ) , 0 ) ;
if ( V_10 < 0 )
...
#endif
{
V_10 = F_119 ( V_196 , V_187 , 0 , & V_2 ) ;
if ( V_10 < 0 )
goto V_12;
F_120 ( V_2 -> V_3 , V_6 ) ;
V_177 . V_197 = V_196 ;
V_177 . V_198 = V_173 -> V_199 ;
V_177 . V_200 = F_72 ( V_173 -> V_191 ) ;
V_10 = F_121 ( V_2 , (struct V_192 * ) & V_177 ,
sizeof( V_177 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_177 . V_197 = V_196 ;
V_177 . V_198 = V_173 -> V_201 ;
V_177 . V_200 = F_72 ( V_173 -> V_193 ) ;
V_10 = F_122 ( V_2 ,
(struct V_192 * ) & V_177 ,
sizeof( V_177 ) , 0 ) ;
if ( V_10 < 0 )
...
#if F_77 ( V_117 )
if ( V_173 -> V_184 && V_173 -> V_185 ) {
V_10 = F_119 ( V_186 , V_187 ,
V_203 , & V_2 ) ;
if ( V_10 < 0 )
goto V_12;
F_120 ( V_2 -> V_3 , V_6 ) ;
V_183 . V_204 = V_186 ;
memcpy ( & V_183 . V_205 , V_173 -> V_184 ,
sizeof( V_183 . V_205 ) ) ;
V_183 . V_206 = V_30 ;
V_10 = F_121 ( V_2 , (struct V_192 * ) & V_183 ,
sizeof( V_183 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_183 . V_204 = V_186 ;
memcpy ( & V_183 . V_205 , V_173 -> V_185 ,
sizeof( V_183 . V_205 ) ) ;
V_183 . V_206 = V_104 ;
V_10 = F_122 ( V_2 ,
(struct V_192 * ) & V_183 ,
...
#endif
{
V_10 = F_119 ( V_196 , V_187 ,
V_203 , & V_2 ) ;
if ( V_10 < 0 )
goto V_12;
F_120 ( V_2 -> V_3 , V_6 ) ;
V_179 . V_204 = V_196 ;
V_179 . V_205 = V_173 -> V_199 ;
V_179 . V_206 = V_30 ;
V_10 = F_121 ( V_2 , (struct V_192 * ) & V_179 ,
sizeof( V_179 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_179 . V_204 = V_196 ;
V_179 . V_205 = V_173 -> V_201 ;
V_179 . V_206 = V_104 ;
V_10 = F_122 ( V_2 , (struct V_192 * ) & V_179 ,
sizeof( V_179 ) , 0 ) ;
if ( V_10 < 0 )
goto V_12;
}
...
int F_125 ( struct V_6 * V_6 , int V_13 , int V_73 , T_1 V_30 , T_1 V_104 , struct V_172 * V_173 , struct V_1 * * V_207 )
{
struct V_1 * V_8 = NULL ;
int V_10 ;
struct V_11 * V_2 = NULL ;
...
V_8 = F_129 ( sizeof( struct V_1 ) , V_214 ) ;
if ( V_8 == NULL ) {
V_10 = - V_215 ;
goto V_10;
}
...
#if F_77 ( V_117 )
if ( V_3 -> V_118 == V_119 ) {
struct V_218 * V_219 = F_95 ( V_3 ) ;
if ( F_131 ( & V_219 -> V_146 ) &&
F_131 ( & V_3 -> V_147 ) ) {
struct V_126 * V_127 = F_90 ( V_3 ) ;
V_8 -> V_120 = true ;
V_127 -> V_149 = V_219 -> V_146 . V_220 [ 3 ] ;
V_127 -> V_221 = V_3 -> V_222 . V_220 [ 3 ] ;
V_127 -> V_150 = V_3 -> V_147 . V_220 [ 3 ] ;
} else {
V_8 -> V_120 = false ;
}
}
...
V_8 -> V_2 = V_3 ;
V_8 -> V_13 = V_13 ;
F_134 ( & V_3 -> V_224 . V_225 , & V_226 , L_34 ) ;
V_3 -> V_227 = V_228 ;
F_135 ( & V_8 -> V_170 , F_113 ) ;
F_136 ( & V_8 -> V_160 ) ;
F_5 ( & V_161 ) ;
F_137 ( V_8 ) ;
F_34 ( & V_17 -> V_159 ) ;
F_138 ( & V_8 -> V_160 , & V_17 -> V_229 ) ;
F_41 ( & V_17 -> V_159 ) ;
V_10 = 0 ;
V_10:
if ( V_207 )
...
int F_139 ( struct V_1 * V_8 )
{
F_102 ( V_8 ) ;
return ( false == F_140 ( V_231 , & V_8 -> V_170 ) ) ;
}
void F_141 ( struct V_15 * V_20 )
{
struct V_1 * V_8 = V_20 -> V_8 ;
...
struct V_15 * F_146 ( int V_235 , struct V_1 * V_8 , T_1 V_16 , T_1 V_105 , struct V_236 * V_173 )
{
struct V_15 * V_20 ;
V_20 = F_129 ( sizeof( struct V_15 ) + V_235 , V_214 ) ;
if ( V_20 != NULL ) {
V_20 -> V_87 = V_88 ;
V_20 -> V_8 = V_8 ;
V_20 -> V_16 = V_16 ;
...
V_20 -> V_92 = V_8 -> V_92 ;
if ( V_173 ) {
V_20 -> V_237 = V_173 -> V_238 ;
V_20 -> V_92 = V_173 -> V_92 ;
V_20 -> V_239 = V_173 -> V_239 ;
V_20 -> V_240 = V_173 -> V_240 ;
