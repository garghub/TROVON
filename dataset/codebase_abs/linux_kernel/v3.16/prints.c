...
F_46 ( L_62 , F_82 ( V_77 ) ) ;
V_79 = V_28 -> V_33 ;
V_80 = F_80 ( V_77 ) - V_79 - 1 - F_83 ( V_77 ) -
( ! F_78 ( V_77 ) ? F_84 ( V_77 ) +
1 : F_85 ( V_77 ) ) - F_82 ( V_77 ) ;
F_46
( L_63
L_64 , V_79 , F_83 ( V_77 ) ,
( ! F_78 ( V_77 ) ? ( F_84 ( V_77 ) + 1 ) :
F_85 ( V_77 ) ) , V_80 ) ;
F_46 ( L_65 , F_86 ( V_77 ) ) ;
F_46 ( L_66 , F_87 ( V_77 ) ) ;
F_46 ( L_67 , F_88 ( V_77 ) ) ;
...
{
struct V_82 * V_83 ;
if ( memcmp ( F_93 ( V_28 ) , V_84 , 8 ) )
return 1 ;
V_83 = (struct V_82 * ) ( V_28 -> V_78 ) ;
F_46 ( L_72 ,
( unsigned long long ) V_28 -> V_33 , F_94 ( V_83 ) ,
F_95 ( V_83 ) , F_96 ( V_83 ) ) ;
return 0 ;
}
...
L_78 ,
F_99 ( V_87 -> V_92 ) -> V_93 ,
V_87 -> V_94 , F_100 ( V_87 -> V_95 ) ,
V_87 -> V_95 -> V_96 ) ;
for ( V_88 = 0 ; V_88 < F_101 ( V_87 -> V_97 ) ; V_88 ++ ) {
if ( F_102 ( V_87 -> V_95 , V_88 ) <=
V_87 -> V_95 -> V_98
&& F_102 ( V_87 -> V_95 ,
V_88 ) > V_99 ) {
V_89 = F_103 ( V_87 -> V_95 , V_88 ) ;
V_90 = F_104 ( V_87 -> V_95 , V_88 ) ;
} else {
V_89 = NULL ;
V_90 = NULL ;
}
...
V_87 -> V_109 , V_87 -> V_110 [ 0 ] , V_87 -> V_111 , V_87 -> V_112 [ 0 ] ,
V_87 -> V_113 [ 0 ] , V_87 -> V_112 [ 1 ] , V_87 -> V_113 [ 1 ] ,
V_87 -> V_114 , V_87 -> V_115 [ 0 ] , V_87 -> V_116 [ 0 ] ) ;
V_88 = 0 ;
do {
V_88 ++ ;
sprintf ( V_91 + strlen ( V_91 ) ,
...
L_83 ) ;
V_88 = 0 ;
for ( V_64 = 0 ; V_64 < F_101 ( V_87 -> V_117 ) ; V_64 ++ )
sprintf ( V_91 + strlen ( V_91 ) ,
L_84 , V_87 -> V_117 [ V_64 ] ,
V_87 -> V_117 [ V_64 ] ? ( unsigned long long ) V_87 -> V_117 [ V_64 ] ->
V_33 : 0ULL ,
V_87 -> V_117 [ V_64 ] ? F_33 ( & V_87 -> V_117 [ V_64 ] -> V_34 ) : 0 ,
( V_64 == F_101 ( V_87 -> V_117 ) - 1 ) ? L_44 : L_85 ) ;
sprintf ( V_91 + strlen ( V_91 ) ,
L_86 ) ;
}
void F_105 ( char * V_118 )
{
F_46 ( L_87 , V_118 , V_91 ) ;
}
...
V_69 = F_70 ( V_28 ) ;
V_70 = F_71 ( V_69 ) ;
if ( V_70 > ( V_28 -> V_32 - V_119 ) / V_120 )
F_107 ( NULL , L_88 , L_89 ,
V_28 ) ;
if ( F_108 ( V_69 ) > V_28 -> V_32 - V_119 - V_120 * V_70 )
...
struct V_68 * V_69 ;
V_69 = F_70 ( V_28 ) ;
if ( ! ( F_28 ( V_28 ) > V_121 && F_28 ( V_28 ) <= V_122 ) )
F_107 ( NULL , L_92 , L_93 , V_28 ) ;
if ( F_29 ( V_28 ) > ( V_28 -> V_32 - V_119 ) / V_120 )
F_107 ( NULL , L_94 , L_89 , V_28 ) ;
if ( F_30 ( V_28 ) !=
V_28 -> V_32 - V_119 - V_123 * F_29 ( V_28 ) -
V_124 * ( F_29 ( V_28 ) + 1 ) )
...
return;
F_106 ( V_28 ) ;
for ( V_64 = 0 , V_17 = V_16 ( V_28 , 0 ) ; V_64 < F_29 ( V_28 ) ; V_64 ++ , V_17 ++ )
