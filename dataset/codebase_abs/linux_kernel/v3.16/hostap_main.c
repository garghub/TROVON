...
int F_86 ( T_2 * V_3 , int V_63 , int V_4 )
{
int V_11 ;
if ( V_63 < 0 || V_63 > 1 )
return - V_44 ;
...
V_3 -> V_231 = ( V_232 ) F_89 ( V_229 . V_233 ) ;
V_3 -> V_234 = ( V_232 ) F_89 ( V_229 . V_235 ) ;
V_3 -> V_236 = ( V_232 ) F_89 ( V_229 . V_237 ) ;
V_3 -> V_238 = V_140 ;
} else
V_11 = - 1 ;
} else {
if ( V_3 -> F_28 -> V_93 ( V_3 -> V_7 , V_239 ,
& V_229 , sizeof( V_229 ) , 1 ) >= 0 ) {
V_3 -> V_231 = F_89 ( V_229 . V_233 ) ;
V_3 -> V_234 = F_90 (
F_89 ( V_229 . V_235 ) ) ;
V_3 -> V_236 = F_90 (
F_89 ( V_229 . V_237 ) ) ;
...
int F_91 ( T_2 * V_3 , T_1 * V_240 , T_3 V_241 ,
T_1 * V_242 , T_5 V_243 )
{
struct V_50 * V_160 ;
struct V_244 * V_245 ;
...
F_21 ( V_3 -> V_252 , L_45 ) )
return 0 ;
V_11 = F_91 ( V_3 , V_3 -> V_252 , V_258 ,
( T_1 * ) & V_63 , 2 ) ;
memset ( V_257 . V_259 . V_187 , 0 , V_37 ) ;
F_98 ( V_3 -> V_7 , V_260 , & V_257 , NULL ) ;
return V_11 ;
}
static int T_6 F_99 ( void )
{
if ( V_261 . V_262 != NULL ) {
V_263 = F_100 ( L_46 , V_261 . V_262 ) ;
if ( ! V_263 )
F_11 ( V_21 L_47
L_48 ) ;
} else
