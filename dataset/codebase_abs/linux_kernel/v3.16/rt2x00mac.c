...
if ( V_95 . V_115 == V_116 )
return - V_110 ;
if ( V_95 . V_115 == V_117 && F_54 ( V_2 ) )
return - V_110 ;
V_95 . V_104 = V_104 ;
if ( V_43 ) {
V_95 . V_118 = V_43 -> V_63 ;
V_109 = F_55 ( V_43 ) ;
V_95 . V_119 = V_109 -> V_119 ;
} else
V_95 . V_118 = V_106 ;
if ( V_95 . V_115 == V_117 )
...
{
struct V_1 * V_2 = V_19 -> V_30 ;
struct V_108 * V_109 = F_55 ( V_43 ) ;
if ( V_2 -> V_40 -> V_81 -> V_124 ( V_2 , V_26 , V_43 ) )
V_109 -> V_119 = - 1 ;
return 0 ;
}
int F_57 ( struct V_28 * V_19 , struct V_45 * V_26 ,
struct V_89 * V_43 )
{
struct V_1 * V_2 = V_19 -> V_30 ;
struct V_108 * V_109 = F_55 ( V_43 ) ;
if ( V_109 -> V_119 < 0 )
return 0 ;
return V_2 -> V_40 -> V_81 -> V_125 ( V_2 , V_109 -> V_119 ) ;
}
...
void F_60 ( struct V_28 * V_19 )
{
struct V_1 * V_2 = V_19 -> V_30 ;
F_34 ( V_126 , & V_2 -> V_15 ) ;
F_61 ( V_2 ) ;
}
int F_62 ( struct V_28 * V_19 ,
struct V_127 * V_128 )
{
struct V_1 * V_2 = V_19 -> V_30 ;
...
} else if ( V_131 -> V_136 && ! V_47 -> V_136 ) {
V_2 -> V_137 ++ ;
V_47 -> V_136 = true ;
if ( F_54 ( V_2 ) )
F_67 ( V_2 , V_26 ) ;
...
return - V_155 ;
if ( V_154 -> V_156 > 0 )
V_4 -> V_156 = F_71 ( V_154 -> V_156 ) ;
else
V_4 -> V_156 = 5 ;
if ( V_154 -> V_157 > 0 )
V_4 -> V_157 = F_71 ( V_154 -> V_157 ) ;
else
V_4 -> V_157 = 10 ;
...
{
struct V_1 * V_2 = V_19 -> V_30 ;
bool V_160 = ! ! V_2 -> V_40 -> V_81 -> V_161 ( V_2 ) ;
F_74 ( V_19 -> V_162 , ! V_160 ) ;
}
void F_75 ( struct V_28 * V_19 , struct V_45 * V_26 ,
...
int F_78 ( struct V_28 * V_19 , T_1 V_165 , T_1 V_166 )
{
struct V_1 * V_2 = V_19 -> V_30 ;
...
int F_79 ( struct V_28 * V_19 , T_1 * V_165 , T_1 * V_166 )
{
struct V_1 * V_2 = V_19 -> V_30 ;
struct V_167 * V_168 = & V_2 -> V_139 . V_168 ;
...
T_1 * V_174 , T_1 * V_177 , T_1 * V_69 , T_1 * V_178 )
{
struct V_1 * V_2 = V_19 -> V_30 ;
struct V_3 * V_4 ;
F_76 (rt2x00dev, queue) {
