...
static void F_14 ( struct V_1 * V_2 , T_1 V_76 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_6 -> V_75 = V_76 ;
}
...
V_82 [ V_81 ] = F_18 ( V_6 -> V_35 + ( V_81 * 4 ) ) ;
for ( V_81 = 0 ; V_81 < 9 ; V_81 ++ )
V_82 [ V_81 + 12 ] =
F_18 ( V_6 -> V_35 + ( V_83 + ( V_81 * 4 ) ) ) ;
V_82 [ 22 ] = F_18 ( V_6 -> V_35 + V_84 ) ;
V_82 [ 23 ] = F_18 ( V_6 -> V_35 + V_85 ) ;
} else {
