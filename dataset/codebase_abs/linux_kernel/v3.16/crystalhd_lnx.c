...
static inline int F_15 ( void T_2 * V_21 , void * V_22 ,
int V_23 , int V_24 )
{
int V_5 ;
if ( ! V_21 || ! V_22 ) {
...
if ( V_24 )
V_5 = F_16 ( V_21 , V_22 , V_23 ) ;
else
V_5 = F_17 ( V_22 , V_21 , V_23 ) ;
if ( V_5 ) {
F_5 ( L_4 ) ;
V_5 = - V_25 ;
}
...
V_5 = F_15 ( ( void T_2 * ) V_29 , V_26 -> V_30 ,
V_26 -> V_32 , 0 ) ;
if ( V_5 ) {
F_5 ( L_7 ,
...
V_5 = F_15 ( ( void T_2 * ) V_28 , & V_26 -> V_33 ,
sizeof( V_26 -> V_33 ) , V_24 ) ;
if ( V_5 ) {
...
static int F_23 ( struct V_3 * V_4 , unsigned long V_28 ,
T_3 V_42 , T_3 V_35 , T_4 V_43 )
{
int V_5 ;
struct V_13 * V_16 ;
enum V_44 V_45 = V_46 ;
...
V_16 -> V_47 = V_42 ;
V_16 -> V_35 = V_35 ;
V_5 = F_22 ( V_4 , V_16 , V_28 , 0 ) ;
if ( ! V_5 ) {
V_45 = V_43 ( & V_4 -> V_6 , V_16 ) ;
if ( V_45 == V_48 )
V_45 = V_49 ;
V_16 -> V_33 . V_50 = V_45 ;
V_5 = F_22 ( V_4 , V_16 , V_28 , 1 ) ;
}
F_14 ( V_4 , V_16 , 0 ) ;
return V_5 ;
}
static long F_24 ( struct V_51 * V_52 , unsigned int V_35 , unsigned long V_28 )
{
struct V_3 * V_4 = F_25 () ;
T_4 V_53 ;
struct V_54 * V_55 ;
...
F_26 ( & V_58 ) ;
V_53 = F_27 ( & V_4 -> V_6 , V_35 , V_55 ) ;
if ( ! V_53 ) {
F_5 ( L_15 , V_35 ) ;
F_28 ( & V_58 ) ;
return - V_8 ;
}
V_56 = F_23 ( V_4 , V_28 , V_55 -> V_42 , V_35 , V_53 ) ;
F_28 ( & V_58 ) ;
return V_56 ;
}
static int F_29 ( struct V_59 * V_60 , struct V_51 * V_52 )
{
struct V_3 * V_4 = F_25 () ;
int V_5 = 0 ;
enum V_44 V_45 = V_46 ;
...
if ( V_4 -> V_61 >= V_62 ) {
F_30 ( V_63 , L_16 , V_4 -> V_61 ) ;
return - V_64 ;
}
V_45 = F_31 ( & V_4 -> V_6 , & V_55 ) ;
if ( V_45 != V_46 ) {
F_5 ( L_17 , V_45 ) ;
V_5 = - V_64 ;
}
...
static int F_32 ( struct V_59 * V_60 , struct V_51 * V_52 )
{
struct V_3 * V_4 = F_25 () ;
struct V_54 * V_55 ;
if ( ! V_4 ) {
...
T_3 V_84 = F_51 ( V_82 -> V_7 , 2 ) ;
unsigned long V_85 = F_50 ( V_82 -> V_7 , 0 ) ;
T_3 V_86 = F_51 ( V_82 -> V_7 , 0 ) ;
F_30 ( V_87 , L_24 ,
V_83 , V_84 , V_85 , V_86 ) ;
V_5 = F_52 ( V_83 , V_84 ) ;
if ( V_5 ) {
...
snprintf ( V_82 -> V_12 , sizeof( V_82 -> V_12 ) , L_34 ,
...
static int F_73 ( struct V_94 * V_7 , T_5 V_110 )
{
struct V_3 * V_4 ;
struct V_13 * V_16 ;
enum V_44 V_45 = V_46 ;
...
if ( ( ! V_2 ) || ( strlen ( V_2 ) < 3 ) )
V_112 = V_113 | V_114 ;
else if ( ! strncmp ( V_2 , L_42 , 5 ) )
V_112 = V_63 | V_114 | V_98 |
V_87 | V_113 ;
else if ( ! strncmp ( V_2 , L_43 , 4 ) )
V_112 = V_113 | V_114 | V_63 ;
else if ( ! strncmp ( V_2 , L_44 , 5 ) )
V_112 = V_113 | V_114 | V_63 |
V_98 ;
else if ( ! strncmp ( V_2 , L_45 , 5 ) )
V_112 = 0xFFFFFFFF & ~ ( V_115 ) ;
else if ( ! strncmp ( V_2 , L_46 , 6 ) )
V_112 = 0 ;
else
V_112 = 0 ;
}
