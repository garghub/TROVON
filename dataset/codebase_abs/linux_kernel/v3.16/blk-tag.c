...
struct V_6 * F_18 ( int V_14 )
{
return F_15 ( NULL , V_14 ) ;
}
...
int F_20 ( struct V_2 * V_3 , int V_26 )
{
struct V_6 * V_7 = V_3 -> V_5 ;
struct V_1 * * V_11 ;
unsigned long * V_9 ;
...
void F_26 ( struct V_2 * V_3 , struct V_1 * V_29 )
{
struct V_6 * V_7 = V_3 -> V_5 ;
unsigned V_4 = V_29 -> V_4 ;
F_5 ( V_4 >= V_7 -> V_22 ) ;
F_27 ( & V_29 -> V_30 ) ;
V_29 -> V_31 &= ~ V_32 ;
V_29 -> V_4 = - 1 ;
...
int F_31 ( struct V_2 * V_3 , struct V_1 * V_29 )
{
struct V_6 * V_7 = V_3 -> V_5 ;
unsigned V_10 ;
int V_4 ;
if ( F_28 ( ( V_29 -> V_31 & V_32 ) ) ) {
F_12 ( V_17
L_4 ,
V_18 , V_29 ,
V_29 -> V_33 ? V_29 -> V_33 -> V_34 : L_5 , V_29 -> V_4 ) ;
F_32 () ;
}
V_10 = V_7 -> V_10 ;
if ( ! F_33 ( V_29 ) && V_10 > 1 ) {
...
if ( V_4 >= V_10 )
return 1 ;
} while ( F_35 ( V_4 , V_7 -> V_9 ) );
V_29 -> V_31 |= V_32 ;
V_29 -> V_4 = V_4 ;
V_7 -> V_11 [ V_4 ] = V_29 ;
F_36 ( V_29 ) ;
F_37 ( & V_29 -> V_30 , & V_3 -> V_25 ) ;
return 0 ;
}
void F_38 ( struct V_2 * V_3 )
{
struct V_37 * V_38 , * V_39 ;
F_39 (tmp, n, &q->tag_busy_list)
F_40 ( V_3 , F_41 ( V_38 ) ) ;
}
