...
F_73 ( & V_44 -> V_208 ) ;
V_165 = - V_83 ;
for ( V_190 = 0 ; V_190 < F_74 ( V_198 , L_37 ) ; V_190 ++ ) {
V_196 = F_75 ( V_198 , L_37 ,
V_190 , & V_203 ) ;
if ( V_196 < 0 )
continue;
V_195 = F_76 ( V_38 , sizeof( * V_195 ) , V_82 ) ;
if ( ! V_195 )
goto V_207;
V_195 -> V_196 = V_196 ;
V_195 -> V_209 = V_203 & V_210 ;
V_204 = true ;
V_165 = F_77 ( V_38 , V_196 , L_38 ) ;
if ( V_165 ) {
F_12 ( V_38 , L_39 , V_196 ) ;
goto V_207;
}
V_165 = F_78 ( V_196 , V_195 -> V_209 ) ;
if ( V_165 ) {
F_12 ( V_38 , L_40 , V_196 ) ;
goto V_207;
}
F_79 ( & V_195 -> V_211 , & V_44 -> V_208 ) ;
}
if ( V_204 )
V_44 -> F_18 = F_66 ;
V_165 = F_63 ( V_198 ) ;
...
V_44 -> V_118 = V_165 ;
V_44 -> V_47 = F_80 ( V_198 , L_42 ) ;
V_201 = F_81 ( V_198 ) ;
if ( ! V_201 ) {
F_12 ( V_38 , L_43 ) ;
goto V_207;
}
V_199 = F_82 ( V_198 , L_44 ) ;
if ( ! V_199 ) {
F_12 ( V_38 , L_45 ) ;
goto V_207;
}
for ( V_190 = 0 ; V_190 < F_83 ( V_199 ) ; V_190 ++ ) {
struct V_212 V_213 ;
struct V_84 V_214 ;
V_165 = F_84 ( V_201 , & V_213 , V_190 ) ;
if ( V_165 < 0 )
goto V_215;
V_165 = F_85 ( & V_213 , & V_214 ) ;
if ( V_165 < 0 )
goto V_215;
F_86 ( & V_214 , & V_11 -> V_87 ) ;
}
return 0 ;
V_215:
F_87 ( V_199 ) ;
...
static int T_3 F_88 ( struct V_2 * V_3 )
{
...
struct V_216 * V_218 = NULL ;
struct V_219 * V_87 ;
int V_165 ;
F_37 ( V_38 , L_46 , V_90 ) ;
V_165 = - V_83 ;
V_11 = F_89 ( sizeof( struct V_6 ) , V_38 ) ;
if ( ! V_11 ) {
F_12 ( V_38 , L_47 ) ;
goto V_220;
}
...
V_223 = V_44 -> V_224 ;
V_7 -> V_44 = * V_44 ;
for ( V_190 = 0 ; V_190 < V_223 -> V_225 ; V_190 ++ )
F_86 ( & V_223 -> V_226 [ V_190 ] , & V_11 -> V_87 ) ;
V_7 -> V_51 = F_1 ( V_3 ) ;
V_11 -> V_9 . V_15 = V_44 -> V_227 ? V_44 -> V_227 : 16 ;
memcpy ( & V_11 -> V_223 , V_44 -> V_224 , sizeof( V_11 -> V_223 ) ) ;
} else {
F_12 ( V_38 , L_48 ) ;
goto V_221;
}
...
V_11 -> V_229 = & V_230 ;
V_11 -> V_71 = V_231 ;
strcpy ( V_11 -> V_71 . V_232 , V_7 -> V_3 -> V_233 ) ;
V_7 -> V_185 = F_91 ( V_38 , L_49 ) ;
if ( F_11 ( V_7 -> V_185 ) ) {
V_165 = F_13 ( V_7 -> V_185 ) ;
goto V_221;
}
V_7 -> V_89 = F_91 ( V_38 , L_50 ) ;
if ( F_11 ( V_7 -> V_89 ) ) {
V_165 = F_13 ( V_7 -> V_89 ) ;
goto V_234;
}
...
F_35 ( & V_11 -> V_9 , V_11 ) ;
V_217 = F_93 ( V_3 , V_235 , 0 ) ;
if ( ! V_217 ) {
F_12 ( V_38 , L_51 ) ;
V_165 = - V_236 ;
goto V_237;
}
V_7 -> V_238 = F_94 ( V_3 , 0 ) ;
if ( V_7 -> V_238 < 0 ) {
F_12 ( V_38 , L_52 ) ;
V_165 = V_7 -> V_238 ;
goto V_237;
}
V_218 = F_93 ( V_3 , V_235 , 1 ) ;
if ( V_218 ) {
V_11 -> V_71 . V_73 = V_218 -> V_239 ;
V_11 -> V_71 . V_78 = F_95 ( V_218 ) ;
if ( ! F_96 ( V_11 -> V_71 . V_73 ,
V_11 -> V_71 . V_78 , V_3 -> V_233 ) ) {
V_165 = - V_240 ;
goto V_237;
}
V_11 -> V_79 = F_97 ( V_11 -> V_71 . V_73 , V_11 -> V_71 . V_78 ) ;
if ( ! V_11 -> V_79 ) {
V_165 = - V_83 ;
goto V_241;
}
...
V_11 -> V_71 . V_242 = V_217 -> V_239 ;
V_11 -> V_71 . V_243 = F_95 ( V_217 ) ;
if ( ! F_96 ( V_11 -> V_71 . V_242 ,
V_11 -> V_71 . V_243 , V_3 -> V_233 ) ) {
V_165 = - V_240 ;
goto V_244;
}
V_7 -> V_245 = F_97 ( V_11 -> V_71 . V_242 , V_11 -> V_71 . V_243 ) ;
if ( ! V_7 -> V_245 ) {
F_12 ( V_38 , L_54 ) ;
V_165 = - V_83 ;
goto V_246;
...
F_17 ( V_7 ) ;
V_165 = F_98 ( V_7 -> V_238 , F_52 , 0 , V_3 -> V_233 , V_11 ) ;
if ( V_165 ) {
...
V_165 = F_101 ( V_11 ) ;
if ( V_165 < 0 ) {
F_12 ( V_38 , L_58 , V_165 ) ;
goto V_249;
}
F_18 ( V_7 , 1 ) ;
F_57 ( V_38 , L_59 ,
V_11 -> V_250 , V_11 -> V_71 . V_242 , V_7 -> V_245 , V_7 -> V_238 ) ;
return 0 ;
V_249:
F_100 ( V_38 , NULL ) ;
F_102 ( & V_11 -> V_184 ) ;
V_248:
F_103 ( & V_7 -> V_176 ) ;
F_104 ( V_7 -> V_238 , V_11 ) ;
V_247:
F_14 ( V_7 ) ;
F_105 ( V_7 -> V_245 ) ;
V_246:
F_106 ( V_11 -> V_71 . V_242 , V_11 -> V_71 . V_243 ) ;
V_244:
if ( V_218 )
F_105 ( V_11 -> V_79 ) ;
else
...
V_241:
if ( V_218 )
F_106 ( V_11 -> V_71 . V_73 , V_11 -> V_71 . V_78 ) ;
V_237:
F_61 ( V_7 ) ;
F_107 ( V_7 -> V_89 ) ;
V_234:
...
static int T_4 F_109 ( struct V_2 * V_3 )
{
struct V_77 * V_38 = & V_3 -> V_38 ;
struct V_10 * V_11 = F_110 ( V_38 ) ;
struct V_6 * V_7 ;
struct V_43 * V_44 ;
if ( ! V_11 || ! V_11 -> V_69 )
return 0 ;
...
static int F_112 ( struct V_2 * V_3 , T_5 V_251 )
{
struct V_10 * V_11 = F_113 ( V_3 ) ;
struct V_6 * V_7 = V_11 -> V_69 ;
F_4 ( V_7 , V_154 , ~ 0UL ) ;
V_7 -> V_252 = F_5 ( V_7 , V_33 ) ;
F_4 ( V_7 , V_33 , 0 ) ;
F_18 ( V_7 , 0 ) ;
F_23 ( V_7 ) ;
F_61 ( V_7 ) ;
