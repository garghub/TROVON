...
V_57 = F_36 ( V_21 * sizeof( V_57 ) , V_65 ) ;
if ( ! V_57 ) {
F_4 ( L_44 , V_9 ,
V_21 ) ;
return F_35 ( - V_66 ) ;
}
V_51 = F_36 ( V_21 * sizeof( * V_51 ) , V_65 ) ;
if ( ! V_51 ) {
F_4 ( L_45 , V_9 ,
V_21 ) ;
F_26 ( V_57 ) ;
...
static void F_44 ( struct V_74 * V_74 )
{
struct V_75 * V_76 ;
struct V_12 * V_13 ;
if ( ! V_74 )
...
struct V_74 * F_48 ( struct V_12 * V_13 )
{
struct V_67 * V_30 = & V_13 -> V_30 ;
struct V_74 * V_74 = NULL ;
switch ( V_13 -> type ) {
case V_20 :
if ( F_42 ( V_13 -> V_16 . V_70 , V_30 ) )
return NULL ;
break;
default:
F_4 ( L_48 , V_9 ,
...
{
T_1 V_60 ;
for ( V_60 = 0 ; V_60 < V_2 -> V_79 . V_80 ; V_60 ++ )
F_44 ( V_2 -> V_79 . V_81 [ V_60 ] ) ;
F_26 ( V_2 -> V_79 . V_81 ) ;
}
...
if ( V_2 -> V_79 . V_80 ) {
T_4 V_88 ;
V_88 = V_2 -> V_79 . V_80 * sizeof( * V_2 -> V_79 . V_81 ) ;
V_2 -> V_79 . V_81 = F_58 ( V_88 , V_65 ) ;
if ( ! V_2 -> V_79 . V_81 ) {
F_4 ( L_51 ,
V_9 , V_2 -> V_79 . V_80 , V_83 -> V_10 ) ;
return;
}
}
V_68 = F_59 ( V_83 , 0 , & V_87 ) ;
if ( V_68 ) {
F_4 ( L_52 , V_9 ,
V_83 -> V_10 ) ;
goto V_89;
...
V_2 -> V_6 = ( T_1 ) V_6 ;
if ( ! F_56 ( V_2 ) ) {
F_4 ( L_54 , V_9 , V_83 -> V_10 ) ;
goto V_89;
}
V_2 -> V_82 = F_61 ( V_87 . V_91 , V_2 -> V_6 ) ;
if ( ! V_2 -> V_82 ) {
F_4 ( L_55 , V_9 ,
V_83 -> V_10 ) ;
goto V_89;
...
F_63 ( & V_2 -> V_84 , & V_92 ) ;
for ( V_60 = 0 ; V_60 < V_2 -> V_79 . V_80 ; V_60 ++ ) {
if ( ! V_2 -> V_93 [ V_60 ] . V_2 )
continue;
V_2 -> V_79 . V_81 [ V_60 ] = F_48 ( & V_2 -> V_93 [ V_60 ] ) ;
}
V_68 = F_64 ( V_83 , V_94 , & V_2 -> V_79 ) ;
if ( V_68 ) {
F_4 ( L_56 , V_9 ,
V_83 -> V_10 , V_68 ) ;
goto V_89;
