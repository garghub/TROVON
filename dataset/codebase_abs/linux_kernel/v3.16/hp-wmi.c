...
static T_2 F_24 ( struct V_52 * V_58 , struct V_59 * V_60 ,
char * V_61 )
{
int V_62 = F_7 () ;
if ( V_62 < 0 )
...
static T_2 F_25 ( struct V_52 * V_58 , struct V_59 * V_60 ,
char * V_61 )
{
int V_62 = F_8 () ;
if ( V_62 < 0 )
...
static T_2 F_26 ( struct V_52 * V_58 , struct V_59 * V_60 ,
char * V_61 )
{
int V_62 = F_9 () ;
if ( V_62 < 0 )
...
static T_2 F_27 ( struct V_52 * V_58 , struct V_59 * V_60 ,
char * V_61 )
{
int V_62 = F_10 () ;
if ( V_62 < 0 )
...
static T_2 F_28 ( struct V_52 * V_58 , struct V_59 * V_60 ,
char * V_61 )
{
int V_62 = F_11 () ;
if ( V_62 < 0 )
...
static T_2 F_29 ( struct V_52 * V_58 , struct V_59 * V_60 ,
char * V_61 )
{
int V_62 = F_23 () ;
if ( V_62 < 0 )
...
static T_2 F_30 ( struct V_52 * V_58 , struct V_59 * V_60 ,
const char * V_61 , T_3 V_53 )
{
...
static T_2 F_32 ( struct V_52 * V_58 , struct V_59 * V_60 ,
const char * V_61 , T_3 V_53 )
{
int V_29 ;
T_1 V_63 ;
...
static int F_54 ( struct V_114 * V_52 )
{
int V_44 ;
int V_40 = 0 ;
...
static int F_61 ( struct V_114 * V_52 )
{
int V_44 , V_45 ;
struct V_46 V_28 ;
V_44 = F_1 ( V_43 , 0 , & V_28 ,
...
static int T_5 F_62 ( struct V_114 * V_52 )
{
int V_44 ;
V_82 = NULL ;
V_84 = NULL ;
