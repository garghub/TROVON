...
static int F_52 ( struct V_78 * V_10 )
{
struct V_49 * V_50 = F_53 ( V_10 ) ;
struct V_1 * V_2 = F_21 ( V_50 ) ;
F_54 ( V_50 ) ;
F_49 ( V_50 ) ;
F_50 ( V_2 -> V_75 ) ;
...
static int F_55 ( struct V_100 * V_11 )
{
struct V_49 * V_50 = F_53 ( F_56 ( V_11 ) ) ;
struct V_1 * V_2 = F_21 ( V_50 ) ;
int V_7 ;
F_22 ( & V_2 -> V_55 ) ;
V_7 = F_10 ( V_2 , 1 ) ;
...
static int F_57 ( struct V_100 * V_11 )
{
struct V_49 * V_50 = F_53 ( F_56 ( V_11 ) ) ;
struct V_1 * V_2 = F_21 ( V_50 ) ;
int V_7 ;
