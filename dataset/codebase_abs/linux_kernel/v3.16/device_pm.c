...
return V_36 ;
if ( ! V_27 || ! F_64 ( V_33 )
|| F_29 ( V_33 ) != ! ! V_27 -> V_42 . V_76 )
return 0 ;
V_75 = F_35 () ;
if ( V_75 == V_51 )
return 1 ;
if ( V_27 -> V_15 . V_12 . V_77 )
return 0 ;
V_36 = F_28 ( V_33 , V_27 , V_75 , NULL , & V_1 ) ;
return ! V_36 && V_1 == V_27 -> V_15 . V_1 ;
}
void F_65 ( struct V_8 * V_33 )
{
if ( V_33 -> V_15 . V_78 )
F_66 ( V_33 ) ;
}
...
int F_75 ( struct V_8 * V_33 , bool V_79 )
{
struct V_7 * V_27 = F_54 ( V_33 ) ;
if ( ! V_27 )
return - V_22 ;
...
void F_76 ( struct V_8 * V_33 , bool V_83 )
{
struct V_7 * V_27 = F_54 ( V_33 ) ;
if ( V_27 && V_33 -> V_80 == & V_82 ) {
V_33 -> V_80 = NULL ;
F_25 ( V_27 , F_36 ) ;
if ( V_83 ) {
F_77 ( V_33 ) ;
