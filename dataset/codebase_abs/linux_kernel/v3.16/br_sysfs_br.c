...
static T_1 F_102 ( struct V_69 * V_70 , struct V_71 * V_72 ,
struct V_73 * V_74 ,
char * V_3 , T_4 V_75 , T_2 V_76 )
{
struct V_1 * V_10 = F_103 ( V_72 ) ;
struct V_5 * V_6 = F_3 ( V_10 ) ;
int V_77 ;
if ( V_75 % sizeof( struct V_78 ) != 0 )
return - V_14 ;
V_77 = F_104 ( V_6 , V_3 ,
...
int F_105 ( struct V_79 * V_10 )
{
struct V_71 * V_80 = & V_10 -> V_10 . V_72 ;
struct V_5 * V_6 = F_106 ( V_10 ) ;
int V_9 ;
V_9 = F_107 ( V_80 , & V_81 ) ;
if ( V_9 ) {
F_108 ( L_9 ,
V_82 , V_10 -> V_83 , V_81 . V_83 ) ;
goto V_84;
}
V_9 = F_109 ( V_80 , & V_85 ) ;
if ( V_9 ) {
F_108 ( L_10 ,
V_82 , V_10 -> V_83 , V_85 . V_16 . V_83 ) ;
goto V_86;
}
V_6 -> V_87 = F_110 ( V_88 , V_80 ) ;
if ( ! V_6 -> V_87 ) {
F_108 ( L_11 ,
V_82 , V_10 -> V_83 , V_88 ) ;
goto V_89;
...
return 0 ;
V_89:
F_111 ( & V_10 -> V_10 . V_72 , & V_85 ) ;
V_86:
F_112 ( & V_10 -> V_10 . V_72 , & V_81 ) ;
V_84:
return V_9 ;
}
void F_113 ( struct V_79 * V_10 )
{
struct V_71 * V_72 = & V_10 -> V_10 . V_72 ;
struct V_5 * V_6 = F_106 ( V_10 ) ;
F_114 ( V_6 -> V_87 ) ;
F_111 ( V_72 , & V_85 ) ;
F_112 ( V_72 , & V_81 ) ;
