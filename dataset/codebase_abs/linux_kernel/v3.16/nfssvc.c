...
F_54 () ;
for (; ; ) {
while ( ( V_73 = F_55 ( V_82 , 60 * 60 * V_98 ) ) == - V_99 )
;
if ( V_73 == - V_100 )
break;
F_56 () ;
...
int
F_62 ( struct V_81 * V_82 , T_2 * V_106 )
{
struct V_107 * V_108 ;
T_3 V_109 ;
T_2 V_101 ;
T_2 * V_110 ;
F_32 ( L_8 ,
V_82 -> V_111 , V_82 -> V_112 ) ;
V_108 = V_82 -> V_113 ;
V_82 -> V_114 = V_108 -> V_115 ;
V_109 = V_108 -> V_116 ;
if ( V_109 && ! V_109 ( V_82 , ( T_2 * ) V_82 -> V_117 . V_118 [ 0 ] . V_119 ,
V_82 -> V_120 ) ) {
F_32 ( L_9 ) ;
* V_106 = V_121 ;
return 1 ;
...
V_110 = V_82 -> V_125 . V_118 [ 0 ] . V_119
+ V_82 -> V_125 . V_118 [ 0 ] . V_126 ;
V_82 -> V_125 . V_118 [ 0 ] . V_126 += sizeof( T_2 ) ;
V_101 = V_108 -> V_127 ( V_82 , V_82 -> V_120 , V_82 -> V_128 ) ;
V_101 = F_61 ( V_82 -> V_111 , V_101 ) ;
if ( V_101 == V_103 || V_82 -> V_129 ) {
F_32 ( L_10 ) ;
F_64 ( V_82 , V_130 , NULL ) ;
return 0 ;
}
if ( V_82 -> V_112 != 0 )
* V_110 ++ = V_101 ;
if ( ! ( V_101 && V_82 -> V_111 == 2 ) ) {
V_109 = V_108 -> V_131 ;
if ( V_109 && ! V_109 ( V_82 , V_110 ,
V_82 -> V_128 ) ) {
F_32 ( L_11 ) ;
F_64 ( V_82 , V_130 , NULL ) ;
* V_106 = V_132 ;
