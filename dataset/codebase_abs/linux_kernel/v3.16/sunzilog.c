...
V_199 = F_82 ( & V_44 -> V_55 . V_103 , V_45 ) ;
else
F_47 ( & V_44 -> V_55 . V_103 , V_45 ) ;
F_83 ( & V_44 -> V_55 , V_196 , V_197 , F_72 ) ;
F_9 ( 2 ) ;
if ( V_199 )
F_48 ( & V_44 -> V_55 . V_103 , V_45 ) ;
}
static int T_4 F_84 ( struct V_194 * V_195 , char * V_202 )
{
struct V_43 * V_44 = & V_182 [ V_195 -> V_198 ] ;
unsigned long V_45 ;
int V_170 , V_50 ;
...
F_86 ( V_195 , V_44 -> V_55 . V_207 -> V_208 ) ;
...
static inline struct V_194 * F_87 ( void )
{
return & V_219 ;
}
...
F_90 ( V_59 -> V_226 , L_4 , sizeof( V_59 -> V_226 ) ) ;
} else {
V_59 -> V_222 . V_224 = V_227 ;
V_59 -> V_222 . V_228 = 1 ;
F_90 ( V_59 -> V_226 , L_5 , sizeof( V_59 -> V_226 ) ) ;
}
F_90 ( V_59 -> V_229 ,
( ( V_44 -> V_45 & V_220 ) ?
L_6 : L_7 ) ,
...
int V_248 = 0 ;
int V_249 ;
if ( F_96 ( V_243 -> V_207 . V_208 , L_8 , NULL ) )
V_248 = 1 ;
if ( V_248 )
V_246 = V_250 + V_244 ;
else
V_246 = V_245 ;
V_187 [ V_246 ] = F_97 ( & V_243 -> V_251 [ 0 ] , 0 ,
sizeof( struct V_186 ) ,
L_2 ) ;
if ( ! V_187 [ V_246 ] )
return - V_184 ;
...
F_92 ( & V_44 [ 1 ] ) ;
if ( ! V_248 ) {
if ( F_98 ( F_87 () , V_243 -> V_207 . V_208 ,
& V_205 , V_44 [ 0 ] . V_55 . line ,
false ) )
V_44 -> V_45 |= V_267 ;
V_249 = F_99 ( & V_205 , & V_44 [ 0 ] . V_55 ) ;
if ( V_249 ) {
F_100 ( & V_243 -> V_251 [ 0 ] ,
...
false ) )
V_44 -> V_45 |= V_267 ;
V_249 = F_99 ( & V_205 , & V_44 [ 1 ] . V_55 ) ;
if ( V_249 ) {
F_101 ( & V_205 , & V_44 [ 0 ] . V_55 ) ;
F_100 ( & V_243 -> V_251 [ 0 ] ,
V_247 , sizeof( struct V_186 ) ) ;
return V_249 ;
}
...
F_101 ( & V_205 , & V_44 -> V_55 ) ;
}
static int F_106 ( struct V_242 * V_243 )
{
struct V_43 * V_44 = F_107 ( V_243 ) ;
struct V_186 T_1 * V_16 ;
F_104 ( & V_44 [ 0 ] ) ;
F_104 ( & V_44 [ 1 ] ) ;
V_16 = V_187 [ V_44 [ 0 ] . V_55 . line / 2 ] ;
F_100 ( & V_243 -> V_251 [ 0 ] , V_16 , sizeof( struct V_186 ) ) ;
return 0 ;
}
