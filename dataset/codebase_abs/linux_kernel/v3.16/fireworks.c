...
V_9 = F_15 ( & V_5 -> V_24 , V_76 [ V_65 ] , V_77 [ V_65 ] ,
...
V_82 = F_20 ( V_82 ,
V_83 , 4096U ) ;
V_2 -> V_69 = F_3 ( V_82 , V_10 ) ;
if ( V_2 -> V_69 == NULL ) {
V_9 = - V_11 ;
goto error;
}
V_2 -> V_84 = V_2 -> V_85 = V_2 -> V_69 ;
F_21 ( V_2 ) ;
V_9 = F_1 ( V_2 ) ;
if ( V_9 < 0 )
goto error;
...
static void F_32 ( struct V_70 * V_5 )
{
struct V_1 * V_2 = F_33 ( & V_5 -> V_24 ) ;
F_34 ( V_2 -> V_5 ) ;
F_35 ( V_2 ) ;
}
static void F_36 ( struct V_70 * V_5 )
{
struct V_1 * V_2 = F_33 ( & V_5 -> V_24 ) ;
F_28 ( V_2 ) ;
F_30 ( V_2 ) ;
