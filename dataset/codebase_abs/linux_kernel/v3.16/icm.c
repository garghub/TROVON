...
V_46 -> V_13 [ V_5 ] = F_22 ( V_2 , V_50 >> V_54 ,
( V_46 -> V_55 ? V_48 : V_56 ) |
V_29 , V_46 -> V_14 ) ;
if ( ! V_46 -> V_13 [ V_5 ] ) {
V_27 = - V_21 ;
...
return NULL ;
F_36 ( & V_46 -> V_52 ) ;
V_60 = ( T_2 ) ( V_47 & ( V_46 -> V_49 - 1 ) ) * V_46 -> V_51 ;
V_13 = V_46 -> V_13 [ V_60 / V_50 ] ;
V_59 = V_25 = V_60 % V_50 ;
if ( ! V_13 )
goto V_53;
...
T_3 V_61 , T_3 V_62 )
{
int V_63 = V_50 / V_46 -> V_51 ;
int V_64 ;
T_3 V_5 ;
for ( V_5 = V_61 ; V_5 <= V_62 ; V_5 += V_63 ) {
V_64 = F_35 ( V_2 , V_46 , V_5 , V_65 ) ;
if ( V_64 )
goto V_34;
}
return 0 ;
...
{
T_3 V_5 ;
for ( V_5 = V_61 ; V_5 <= V_62 ; V_5 += V_50 / V_46 -> V_51 )
F_38 ( V_2 , V_46 , V_5 ) ;
}
int F_43 ( struct V_1 * V_2 , struct V_45 * V_46 ,
T_2 V_37 , int V_51 , T_3 V_66 , int V_67 ,
int V_68 , int V_69 )
{
int V_70 ;
int V_71 ;
...
V_46 -> V_13 = F_44 ( V_71 , sizeof * V_46 -> V_13 , V_65 ) ;
if ( ! V_46 -> V_13 )
return - V_21 ;
V_46 -> V_37 = V_37 ;
V_46 -> V_71 = V_71 ;
...
F_45 ( & V_46 -> V_52 ) ;
V_73 = ( T_2 ) V_66 * V_51 ;
for ( V_5 = 0 ; V_5 * V_50 < V_67 * V_51 ; ++ V_5 ) {
V_72 = V_50 ;
if ( ( V_5 + 1 ) * V_50 > V_73 )
V_72 = F_46 ( V_73 -
V_5 * V_50 ) ;
V_46 -> V_13 [ V_5 ] = F_22 ( V_2 , V_72 >> V_54 ,
( V_68 ? V_65 : V_56 ) |
V_29 , V_69 ) ;
if ( ! V_46 -> V_13 [ V_5 ] )
goto V_64;
if ( F_29 ( V_2 , V_46 -> V_13 [ V_5 ] , V_37 + V_5 * V_50 ) ) {
F_10 ( V_2 , V_46 -> V_13 [ V_5 ] , V_69 ) ;
V_46 -> V_13 [ V_5 ] = NULL ;
goto V_64;
}
++ V_46 -> V_13 [ V_5 ] -> V_31 ;
