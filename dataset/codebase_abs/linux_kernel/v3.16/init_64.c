...
{
unsigned long V_32 = F_138 ( V_64 ) ;
unsigned long V_121 = F_138 ( V_122 ) ;
unsigned long V_4 = ( unsigned long ) & V_123 ;
unsigned long V_124 = F_138 ( & V_119 ) ;
unsigned long V_125 = F_138 ( & V_126 ) ;
unsigned long V_127 = F_138 ( & V_128 ) ;
F_39 ( V_129 L_15 ,
( V_4 - V_32 ) >> 10 ) ;
F_141 ( V_32 , ( V_4 - V_32 ) >> V_63 ) ;
V_120 = 1 ;
F_143 ( V_121 , ( V_127 - V_121 ) >> V_63 ) ;
F_144 () ;
#ifdef F_145
F_39 ( V_129 L_16 , V_32 , V_4 ) ;
F_139 ( V_32 , ( V_4 - V_32 ) >> V_63 ) ;
F_39 ( V_129 L_17 ) ;
F_141 ( V_32 , ( V_4 - V_32 ) >> V_63 ) ;
#endif
...
( unsigned long ) F_55 ( F_147 ( V_121 ) ) ) ;
F_146 ( L_18 ,
( unsigned long ) F_55 ( F_147 ( V_125 ) ) ,
( unsigned long ) F_55 ( F_147 ( V_130 ) ) ) ;
}
...
static const char * F_154 ( struct V_133 * V_134 )
{
return L_19 ;
}
struct V_133 * F_155 ( struct V_135 * V_136 )
{
#ifdef F_156
...
int F_157 ( struct V_135 * V_136 , unsigned long V_3 )
{
struct V_133 * V_134 = F_155 ( V_136 ) ;
if ( ! V_134 )
return 0 ;
return ( V_3 >= V_134 -> V_139 ) && ( V_3 < V_134 -> V_140 ) ;
}
int F_158 ( unsigned long V_3 )
{
return ( V_3 & V_44 ) == V_117 ;
}
static unsigned long F_159 ( void )
{
...
#endif
if ( ( V_90 << V_63 ) < ( 16UL << 32 ) )
return V_142 ;
while ( V_141 > V_142 ) {
if ( ! ( ( V_90 << V_63 ) & ( V_141 - 1 ) ) )
break;
V_141 >>= 1 ;
}
F_39 ( V_143 L_21 , V_141 >> 20 ) ;
return V_141 ;
}
...
static int T_9 F_163 ( unsigned long V_32 ,
...
V_11 = F_115 ( V_3 , V_4 ) ;
V_24 = F_164 ( V_3 , V_145 ) ;
if ( ! V_24 )
return - V_17 ;
V_12 = F_165 ( V_24 , V_3 , V_145 ) ;
if ( ! V_12 )
return - V_17 ;
V_7 = F_9 ( V_12 , V_3 ) ;
if ( F_44 ( * V_7 ) ) {
void * V_146 ;
V_146 = F_166 ( V_6 , V_145 ) ;
if ( V_146 ) {
T_7 V_147 ;
...
F_167 ( ( T_7 * ) V_7 , V_145 , V_3 , V_11 ) ;
continue;
}
F_168 ( L_23 ) ;
if ( F_169 ( V_3 , V_11 , V_145 ) )
return - V_17 ;
}
return 0 ;
}
int T_9 F_170 ( unsigned long V_32 , unsigned long V_4 , int V_145 )
{
int V_153 ;
if ( V_154 )
V_153 = F_163 ( V_32 , V_4 , V_145 ) ;
else
V_153 = F_169 ( V_32 , V_4 , V_145 ) ;
if ( ! V_153 )
F_22 ( V_32 , V_4 - 1 ) ;
return V_153 ;
}
void F_171 ( unsigned long V_155 ,
...
F_172 ( V_155 , V_19 ( * V_24 ) , V_106 ) ;
V_12 = F_16 ( V_24 , V_3 ) ;
if ( F_41 ( * V_12 ) ) {
V_11 = ( V_3 + V_43 ) & V_44 ;
continue;
}
F_172 ( V_155 , V_10 ( * V_12 ) , V_106 ) ;
if ( ! V_154 ) {
V_11 = ( V_3 + V_43 ) & V_44 ;
V_7 = F_9 ( V_12 , V_3 ) ;
if ( F_44 ( * V_7 ) )
