...
unsigned long * V_96 , struct V_95 * * V_97 )
{
struct V_89 * V_90 = F_64 ( V_88 ) ;
...
T_1 V_81 ;
T_1 V_101 ;
F_71 ( V_90 -> V_92 . V_25 & V_102 ) ;
V_81 = ( T_1 ) V_90 -> V_92 . V_103 ;
if ( V_81 < 2 )
return F_68 ( V_88 , V_20 , V_96 ) ;
V_98 = F_72 ( V_95 ) ;
V_70 = F_69 ( V_98 ) ;
V_100 = F_68 ( V_88 , V_20 , & V_70 ) ;
V_99 = abs ( V_100 - V_20 ) ;
for ( V_101 = 0 ; V_101 < V_81 ; V_101 ++ ) {
struct V_95 * V_104 = F_73 ( V_95 , V_101 ) ;
unsigned long V_105 ;
unsigned long V_106 ;
F_8 ( ! V_104 ) ;
if ( V_104 == V_98 )
continue;
V_70 = F_69 ( V_104 ) ;
V_106 = F_68 ( V_88 , V_20 , & V_70 ) ;
V_105 = abs ( V_106 - V_20 ) ;
if ( V_105 < V_99 ) {
V_99 = V_105 ;
V_100 = V_106 ;
* V_97 = V_104 ;
...
static int F_74 ( struct V_87 * V_88 , T_3 V_84 )
{
struct V_89 * V_90 = F_64 ( V_88 ) ;
struct V_93 * V_94 = V_90 -> V_11 . V_91 ;
...
if ( ! F_59 ( V_79 ) )
return 0 ;
V_64 = F_75 ( & V_94 -> V_107 ) ? & V_94 -> V_107
: & V_94 -> V_64 ;
...
F_23 ( L_18 , V_28 ,
V_64 == & V_94 -> V_107 ? L_19 : L_20 ,
V_90 -> V_92 . V_29 ) ;
}
return V_43 ;
}
static T_3 F_76 ( struct V_87 * V_88 )
{
struct V_89 * V_90 = F_64 ( V_88 ) ;
struct V_93 * V_94 = V_90 -> V_11 . V_91 ;
T_3 V_84 ;
...
static int F_77 ( struct V_87 * V_88 , unsigned long V_20 ,
unsigned long V_70 )
{
struct V_89 * V_90 = F_64 ( V_88 ) ;
struct V_93 * V_94 = V_90 -> V_11 . V_91 ;
...
static bool F_78 ( struct V_89 * V_90 )
{
...
V_64 = F_75 ( & V_91 -> V_107 ) ? & V_91 -> V_107
: & V_91 -> V_64 ;
...
bool T_4 F_81 ( struct V_21 * V_22 )
{
unsigned long V_25 ;
unsigned int V_101 ;
struct V_95 * * V_109 = V_22 -> V_110 . V_109 ;
bool V_58 = true ;
V_25 = F_18 ( V_22 ) ;
F_22 ( V_22 ) ;
for ( V_101 = 0 ; V_101 < V_22 -> V_110 . V_111 ; V_101 ++ ) {
struct V_89 * V_90 ;
if ( ! V_109 [ V_101 ] )
continue;
V_90 = F_64 ( F_82 ( V_109 [ V_101 ] ) ) ;
V_58 &= F_79 ( V_90 ) ;
}
F_24 ( V_22 ) ;
F_20 ( V_22 , V_25 ) ;
