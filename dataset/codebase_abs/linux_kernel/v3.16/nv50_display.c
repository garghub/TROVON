...
static void
F_125 ( struct V_41 * V_42 , struct V_66 * V_67 )
{
struct F_21 * V_208 = F_21 ( V_42 ) ;
struct V_36 * V_51 = V_36 ( V_42 -> V_38 ) ;
const T_1 V_243 = ( V_67 -> V_72 << 3 ) | V_208 -> V_209 ;
...
struct F_21 * V_251 = F_21 ( V_248 ) ;
if ( V_248 -> V_252 != V_253 )
continue;
if ( V_251 != V_208 &&
V_251 -> V_233 -> V_209 == V_208 -> V_233 -> V_209 ) {
if ( V_251 -> V_250 == V_216 )
return;
break;
}
}
V_249 = ( F_115 ( V_208 -> V_233 -> V_237 ) - 1 ) << 3 ;
V_249 |= ( F_115 ( V_208 -> V_233 -> V_254 . V_255 ) - 1 ) << 2 ;
V_249 |= V_208 -> V_209 ;
if ( V_208 -> V_233 -> type == V_256 ) {
F_104 ( V_51 -> V_2 , V_257 | V_249 , 1 ) ;
V_249 |= V_258 ;
} else {
V_249 |= V_257 ;
}
F_104 ( V_51 -> V_2 , V_249 , ( V_97 == V_216 ) ) ;
}
static bool
...
static void
F_129 ( struct F_21 * V_208 , T_1 V_259 , T_1 V_5 )
{
struct V_52 * V_53 = V_52 ( V_208 -> V_18 . V_18 . V_38 ) ;
T_1 V_260 = ( V_208 -> V_261 & ~ V_259 ) | ( V_5 & V_259 ) , * V_47 ;
if ( V_260 != V_208 -> V_261 && ( V_47 = F_22 ( V_53 , 2 ) ) ) {
if ( F_54 ( V_53 ) < V_108 ) {
F_36 ( V_47 , 0x0600 + ( V_208 -> V_209 * 0x40 ) , 1 ) ;
F_37 ( V_47 , ( V_208 -> V_261 = V_260 ) ) ;
} else {
F_36 ( V_47 , 0x0200 + ( V_208 -> V_209 * 0x20 ) , 1 ) ;
F_37 ( V_47 , ( V_208 -> V_261 = V_260 ) ) ;
}
F_29 ( V_47 , V_53 ) ;
}
...
if ( V_67 ) {
F_67 ( & V_67 -> V_18 ) ;
F_129 ( V_208 , 1 << V_67 -> V_72 , 0 ) ;
F_125 ( & V_208 -> V_18 . V_18 , V_67 ) ;
}
}
static void
...
static void
F_132 ( struct V_41 * V_42 , struct V_110 * V_112 ,
struct V_110 * V_97 )
{
struct V_36 * V_51 = V_36 ( V_42 -> V_38 ) ;
struct V_52 * V_53 = V_52 ( V_42 -> V_38 ) ;
...
struct V_66 * V_67 = V_66 ( V_42 -> V_43 ) ;
struct V_93 * V_94 ;
struct V_262 * V_263 = & V_178 -> V_223 ;
T_1 V_264 = 0 , V_259 , V_261 ;
T_2 V_265 = 1 << V_67 -> V_72 ;
T_2 V_266 = 0xf ;
T_2 V_101 = 0x0 ;
V_94 = F_106 ( V_208 ) ;
V_208 -> V_43 = V_42 -> V_43 ;
...
F_124 ( & V_208 -> V_18 . V_18 , V_97 ) ;
break;
case V_268 :
V_266 = 0x0 ;
if ( V_263 -> V_269 ) {
if ( V_263 -> V_270 . V_271 )
V_264 |= 0x0100 ;
if ( V_263 -> V_270 . V_272 )
V_264 |= 0x0200 ;
} else {
if ( V_94 -> type == V_273 ) {
...
if ( V_97 -> clock >= V_263 -> V_270 . V_274 ) {
V_264 |= 0x0100 ;
}
if ( V_264 & 0x0100 ) {
if ( V_263 -> V_270 . V_275 & 2 )
V_264 |= 0x0200 ;
} else {
if ( V_263 -> V_270 . V_275 & 1 )
V_264 |= 0x0200 ;
}
if ( V_94 -> V_18 . V_102 . V_103 == 8 )
V_264 |= 0x0200 ;
}
F_104 ( V_51 -> V_2 , V_276 + V_208 -> V_209 , V_264 ) ;
break;
case V_256 :
if ( V_94 -> V_18 . V_102 . V_103 == 6 ) {
V_208 -> V_277 . V_278 = V_97 -> clock * 18 / 8 ;
V_101 = 0x2 ;
} else
if ( V_94 -> V_18 . V_102 . V_103 == 8 ) {
V_208 -> V_277 . V_278 = V_97 -> clock * 24 / 8 ;
V_101 = 0x5 ;
} else {
V_208 -> V_277 . V_278 = V_97 -> clock * 30 / 8 ;
V_101 = 0x6 ;
}
if ( V_208 -> V_233 -> V_254 . V_255 & 1 )
V_266 = 0x8 ;
...
F_126 ( & V_208 -> V_18 . V_18 , V_216 ) ;
if ( F_54 ( V_53 ) >= V_185 ) {
T_1 * V_47 = F_22 ( V_53 , 3 ) ;
if ( V_47 ) {
T_1 V_220 = 0x31ec6000 | ( V_67 -> V_72 << 25 ) ;
T_1 V_217 = 0x00000001 ;
if ( V_97 -> V_120 & V_218 )
...
F_129 ( V_208 , V_259 | V_265 , V_261 | V_265 ) ;
}
static void
...
static int
F_135 ( struct V_95 * V_96 , struct V_228 * V_229 )
{
struct V_177 * V_178 = V_177 ( V_96 -> V_38 ) ;
struct V_230 * V_231 = V_230 ( V_178 -> V_50 ) ;
struct F_21 * V_208 ;
...
V_42 -> V_236 = V_229 -> V_237 ;
V_42 -> V_238 = 0 ;
F_117 ( V_96 -> V_38 , V_42 , & V_280 , type ) ;
F_118 ( V_42 , & V_281 ) ;
F_119 ( V_96 , V_42 ) ;
return 0 ;
}
static void
F_136 ( struct V_41 * V_42 , int V_97 )
{
struct F_21 * V_208 = F_21 ( V_42 ) ;
struct V_36 * V_51 = V_36 ( V_42 -> V_38 ) ;
T_1 V_249 = ( V_208 -> V_233 -> type << 12 ) | V_208 -> V_209 ;
T_1 V_261 = ( V_97 == V_216 ) ;
F_104 ( V_51 -> V_2 , V_282 + V_249 , V_261 ) ;
}
static bool
...
static void
F_139 ( struct V_41 * V_42 , struct V_110 * V_97 ,
struct V_110 * V_150 )
{
struct V_52 * V_53 = V_52 ( V_42 -> V_38 ) ;
struct F_21 * V_208 = F_21 ( V_42 ) ;
...
if ( V_47 ) {
if ( F_54 ( V_53 ) < V_108 ) {
T_1 V_261 = ( V_101 << 16 ) | ( V_266 << 8 ) | V_265 ;
if ( V_97 -> V_120 & V_218 )
V_261 |= 0x00001000 ;
if ( V_97 -> V_120 & V_219 )
V_261 |= 0x00002000 ;
...
static void
F_141 ( struct V_41 * V_42 )
{
F_113 ( V_42 ) ;
F_93 ( V_42 ) ;
}
static int
F_142 ( struct V_95 * V_96 , struct V_228 * V_229 )
{
struct V_177 * V_178 = V_177 ( V_96 -> V_38 ) ;
struct V_230 * V_231 = V_230 ( V_178 -> V_50 ) ;
...
switch ( V_229 -> type ) {
case V_267 :
V_284 = V_231 -> V_285 ( V_231 , F_143 ( V_229 -> V_286 ) ) ;
type = V_253 ;
break;
case V_256 :
V_284 = V_231 -> V_285 ( V_231 , F_144 ( V_229 -> V_286 ) ) ;
type = V_253 ;
break;
default:
return - V_287 ;
...
V_42 -> V_236 = V_229 -> V_237 ;
V_42 -> V_238 = 0 ;
F_117 ( V_96 -> V_38 , V_42 , & V_288 , type ) ;
F_118 ( V_42 , & V_289 ) ;
F_119 ( V_96 , V_42 ) ;
return 0 ;
}
...
int
F_148 ( struct V_37 * V_38 )
{
struct V_49 * V_50 = F_34 ( V_38 ) ;
struct V_177 * V_178 = V_177 ( V_38 ) ;
struct V_290 * V_233 = & V_178 -> V_223 . V_233 ;
struct V_95 * V_96 , * V_291 ;
struct V_36 * V_51 ;
struct V_228 * V_229 ;
int V_292 , V_13 , V_181 ;
V_51 = F_97 ( sizeof( * V_51 ) , V_199 ) ;
if ( ! V_51 )
return - V_32 ;
F_19 ( V_38 ) -> V_39 = V_51 ;
F_19 ( V_38 ) -> V_293 = F_147 ;
F_19 ( V_38 ) -> V_294 = F_146 ;
...
goto V_207;
if ( F_45 ( V_51 -> V_2 ) >= V_185 )
V_292 = F_149 ( V_50 , 0x022448 ) ;
else
V_292 = 2 ;
for ( V_181 = 0 ; V_181 < V_292 ; V_181 ++ ) {
V_13 = F_96 ( V_38 , V_51 -> V_2 , V_181 ) ;
if ( V_13 )
goto V_207;
}
for ( V_181 = 0 , V_229 = & V_233 -> V_296 [ 0 ] ; V_181 < V_233 -> V_297 ; V_181 ++ , V_229 ++ ) {
V_96 = F_150 ( V_38 , V_229 -> V_96 ) ;
if ( F_151 ( V_96 ) )
continue;
if ( V_229 -> V_298 == V_299 ) {
switch ( V_229 -> type ) {
case V_267 :
case V_268 :
case V_256 :
V_13 = F_135 ( V_96 , V_229 ) ;
break;
case V_300 :
...
V_13 = F_142 ( V_96 , V_229 ) ;
}
if ( V_13 ) {
F_152 ( V_178 , L_3 ,
V_229 -> V_298 , V_229 -> type ,
