...
if ( V_2 -> V_25 <= 0 || V_2 -> V_25 > V_84 )
return - V_44 ;
V_2 -> V_24 = F_42 ( V_4 -> V_48 . V_93 . V_24 , V_2 -> V_25 ,
V_14 ) ;
if ( ! V_2 -> V_24 )
return - V_15 ;
V_11 = F_35 () ;
...
if ( ! V_2 -> V_36 )
return - V_44 ;
F_46 ( V_2 -> V_11 , V_42 , V_4 -> V_48 . V_94 . V_61 ,
...
if ( ! V_2 -> V_36 )
return - V_44 ;
F_46 ( V_2 -> V_11 , V_42 , V_4 -> V_48 . V_95 . V_61 ,
...
static int F_49 ( struct V_96 * V_96 , struct V_97 * V_97 )
{
struct V_1 * V_2 ;
...
static int F_54 ( struct V_96 * V_96 , struct V_97 * V_97 )
{
...
static T_6 F_55 ( struct V_97 * V_97 , char T_4 * V_69 ,
T_3 V_28 , T_7 * V_101 )
{
struct V_1 * V_2 = V_97 -> V_99 ;
int V_31 ;
...
if ( F_57 ( V_69 , V_2 -> V_9 [ V_2 -> V_8 ] , V_33 ) ) {
V_31 = - V_70 ;
} else {
F_4 ( V_2 -> V_9 [ V_2 -> V_8 ] ) ;
...
static T_6 F_58 ( struct V_97 * V_97 , const char T_4 * V_69 ,
T_3 V_28 , T_7 * V_101 )
{
struct V_1 * V_2 = V_97 -> V_99 ;
int V_31 ;
...
break;
case V_109 :
V_31 = F_45 ( V_2 , & V_2 -> V_106 ) ;
break;
case V_110 :
V_31 = F_47 ( V_2 , & V_2 -> V_106 ) ;
break;
case V_111 :
V_31 = F_48 ( V_2 , & V_2 -> V_106 ) ;
break;
default:
V_31 = - V_112 ;
}
...
static unsigned int F_59 ( struct V_97 * V_97 , T_8 * V_113 )
{
struct V_1 * V_2 = V_97 -> V_99 ;
F_60 ( V_97 , & V_2 -> V_10 , V_113 ) ;
if ( V_2 -> V_6 != V_2 -> V_8 )
return V_114 | V_115 ;
return 0 ;
}
