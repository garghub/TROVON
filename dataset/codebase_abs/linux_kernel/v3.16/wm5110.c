...
static struct V_11 * F_15 ( struct V_38 * V_9 )
{
...
struct V_25 * V_26 ;
int V_14 , V_34 ;
V_26 = F_17 ( & V_40 -> V_9 , sizeof( struct V_25 ) ,
V_41 ) ;
if ( V_26 == NULL )
return - V_42 ;
F_18 ( V_40 , V_26 ) ;
...
V_26 -> V_35 . V_45 [ V_14 ] . V_46 = L_2 ;
V_26 -> V_35 . V_45 [ V_14 ] . V_47 = V_14 + 1 ;
V_26 -> V_35 . V_45 [ V_14 ] . type = V_48 ;
V_26 -> V_35 . V_45 [ V_14 ] . V_9 = V_8 -> V_9 ;
V_26 -> V_35 . V_45 [ V_14 ] . V_11 = V_8 -> V_11 ;
V_26 -> V_35 . V_45 [ V_14 ] . V_49 = V_50
+ ( 0x100 * V_14 ) ;
V_26 -> V_35 . V_45 [ V_14 ] . V_51 = V_52 [ V_14 ] ;
V_26 -> V_35 . V_45 [ V_14 ] . V_53
= F_3 ( V_54 ) ;
V_34 = F_19 ( & V_26 -> V_35 . V_45 [ V_14 ] , false ) ;
if ( V_34 != 0 )
return V_34 ;
}
for ( V_14 = 0 ; V_14 < F_3 ( V_26 -> V_28 ) ; V_14 ++ )
V_26 -> V_28 [ V_14 ] . V_55 = 3 ;
F_20 ( V_8 , 1 , V_56 - 1 ,
V_57 , V_58 ,
& V_26 -> V_28 [ 0 ] ) ;
F_20 ( V_8 , 2 , V_59 - 1 ,
...
F_22 ( & V_26 -> V_35 , V_14 ) ;
for ( V_14 = 0 ; V_14 < F_3 ( V_67 ) ; V_14 ++ )
F_21 ( V_8 -> V_11 , V_67 [ V_14 ] ,
V_68 , V_68 ) ;
F_23 ( & V_40 -> V_9 ) ;
F_24 ( & V_40 -> V_9 ) ;
return F_25 ( & V_40 -> V_9 , & V_69 ,
V_66 , F_3 ( V_66 ) ) ;
}
