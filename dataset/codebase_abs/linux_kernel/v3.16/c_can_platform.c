...
V_31 = F_29 ( V_21 , V_40 , 0 ) ;
V_33 = F_30 ( V_21 , 0 ) ;
if ( ! V_31 || V_33 <= 0 ) {
V_22 = - V_39 ;
goto V_41;
}
if ( ! F_31 ( V_31 -> V_42 , F_32 ( V_31 ) ,
V_43 ) ) {
F_25 ( & V_21 -> V_25 , L_3 ) ;
V_22 = - V_39 ;
goto V_41;
}
V_23 = F_33 ( V_31 -> V_42 , F_32 ( V_31 ) ) ;
if ( ! V_23 ) {
F_25 ( & V_21 -> V_25 , L_4 ) ;
V_22 = - V_44 ;
goto V_45;
...
V_2 -> V_19 = F_20 ;
if ( V_21 -> V_25 . V_35 )
V_2 -> V_11 = F_36 ( V_21 -> V_25 . V_35 , L_5 ) ;
else
V_2 -> V_11 = V_21 -> V_29 ;
V_32 = F_29 ( V_21 , V_40 , 1 ) ;
if ( ! V_32 ) {
V_2 -> V_59 = F_22 ;
break;
}
V_2 -> V_9 = F_37 ( & V_21 -> V_25 , V_32 -> V_42 ,
F_32 ( V_32 ) ) ;
if ( F_28 ( V_2 -> V_9 ) || V_2 -> V_11 < 0 )
F_38 ( & V_21 -> V_25 , L_6 ) ;
else
V_2 -> V_59 = F_10 ;
break;
...
static int F_50 ( struct V_20 * V_21 , T_4 V_63 )
{
int V_22 ;
struct V_24 * V_64 = F_48 ( V_21 ) ;
struct V_1 * V_2 = F_35 ( V_64 ) ;
if ( V_2 -> type != V_54 ) {
F_51 ( & V_21 -> V_25 , L_10 ) ;
return 0 ;
}
