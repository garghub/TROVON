...
if ( ! V_249 )
return - V_250 ;
return sprintf ( V_158 , L_112 , V_251 [ V_249 -> V_169 [ 0 ] -> V_252 . V_253 ] ) ;
}
static T_3
...
if ( F_176 ( V_254 ) != 0 )
goto V_164;
F_103 ( L_125 , V_19 -> V_76 -> V_228 ,
( V_19 -> V_143 & V_272 ) ?
L_126 : L_127 ) ;
F_103 ( L_128 , V_19 -> V_76 -> V_228 ,
( V_19 -> V_143 & V_147 ) ?
L_126 : L_127 ) ;
return 0 ;
V_164:
...
static int
F_184 ( struct V_248 * V_254 , int V_273 )
{
struct V_18 * V_19 ;
enum V_260 V_261 ;
...
F_191 ( V_19 -> V_76 ) ;
if ( V_20 ) {
F_127 ( & V_19 -> V_256 -> V_76 , L_137
L_138 ) ;
}
return V_20 ;
}
static int F_192 ( struct V_248 * V_256 )
{
return 0 ;
}
static void F_193 ( struct V_248 * V_256 )
{
return;
}
...
static int F_195 ( struct V_248 * V_256 )
{
struct V_18 * V_19 = F_163 ( & V_256 -> V_76 ) ;
return F_190 ( V_19 ) ;
}
