...
static void F_42 ( struct V_1 * V_2 , unsigned int V_102 )
{
struct V_12 * V_13 = F_9 ( V_2 -> V_14 ) ;
unsigned long V_25 ;
if ( ! ( V_13 -> V_19 -> V_25 & V_79 ) )
...
V_42 = 1 << F_44 ( V_13 -> V_43 . V_44 [ V_2 -> line ] ,
V_112 ) ;
V_102 &= ~ V_108 ;
...
V_11 = F_47 ( V_2 , V_121 , V_122 , 50 ,
( V_13 -> V_19 -> V_25 & V_26 ) ?
230400 : 38400 ) ;
V_11 = F_8 ( V_2 , V_11 ) ;
F_48 ( V_2 , V_121 -> V_125 , V_11 ) ;
if ( F_49 ( V_121 ) )
F_50 ( V_121 , V_11 , V_11 ) ;
...
static void F_56 ( struct V_1 * V_2 , int V_25 )
{
if ( V_25 & V_160 )
V_2 -> type = V_158 ;
}
static int F_57 ( struct V_1 * V_2 , struct V_161 * V_13 )
{
...
static void F_58 ( struct V_1 * V_2 , int V_164 )
{
int V_165 = 100000 ;
while ( V_165 -- ) {
...
static void F_60 ( struct V_166 * V_167 , const char * V_164 , unsigned V_168 )
{
struct V_12 * V_13 = (struct V_12 * ) V_167 -> V_91 ;
struct V_1 * V_2 = & V_13 -> V_2 [ V_167 -> V_169 ] ;
unsigned long V_25 ;
F_32 ( & V_13 -> V_92 , V_25 ) ;
F_61 ( V_2 , V_164 , V_168 , F_58 ) ;
F_33 ( & V_13 -> V_92 , V_25 ) ;
}
static int F_62 ( struct V_166 * V_167 , char * V_170 )
{
struct V_12 * V_13 = (struct V_12 * ) V_167 -> V_91 ;
struct V_1 * V_2 = & V_13 -> V_2 [ ( V_167 -> V_169 > 0 ) ? V_167 -> V_169 : 0 ] ;
int V_11 = 9600 , V_171 = 8 , V_62 = 'n' , V_172 = 'n' ;
if ( V_170 )
F_63 ( V_170 , & V_11 , & V_62 , & V_171 , & V_172 ) ;
return F_64 ( V_2 , V_167 , V_11 , V_62 , V_171 , V_172 ) ;
}
static int F_65 ( struct V_173 * V_174 )
{
struct V_175 * V_176 = F_66 ( V_174 , V_177 , 0 ) ;
struct V_178 * V_43 = F_67 ( & V_174 -> V_14 ) ;
int V_20 , V_179 , V_28 ;
struct V_12 * V_13 ;
void T_3 * V_4 ;
struct V_180 * V_180 ;
V_4 = F_68 ( & V_174 -> V_14 , V_176 ) ;
if ( F_69 ( V_4 ) )
return F_70 ( V_4 ) ;
V_13 = F_71 ( & V_174 -> V_14 , sizeof( struct V_12 ) , V_181 ) ;
if ( ! V_13 ) {
F_72 ( & V_174 -> V_14 , L_2 ) ;
return - V_182 ;
}
...
V_13 -> V_185 = F_75 ( & V_174 -> V_14 , L_3 ) ;
if ( ! F_69 ( V_13 -> V_185 ) ) {
V_179 = F_76 ( V_13 -> V_185 ) ;
if ( V_179 ) {
F_72 ( & V_174 -> V_14 ,
L_4 , V_179 ) ;
return V_179 ;
}
} else if ( F_70 ( V_13 -> V_185 ) == - V_186 )
return - V_186 ;
V_180 = F_77 ( & V_174 -> V_14 , NULL ) ;
if ( F_69 ( V_180 ) ) {
if ( F_70 ( V_180 ) == - V_186 ) {
V_179 = - V_186 ;
goto V_187;
...
V_13 -> V_88 . V_199 -> V_202 = F_60 ;
V_13 -> V_88 . V_199 -> V_203 = F_62 ;
...
if ( ! V_179 )
return 0 ;
F_72 ( & V_174 -> V_14 , L_11 , V_13 -> V_96 ) ;
} else {
F_86 ( & V_13 -> V_93 ) ;
