...
static inline struct V_122 * F_49 ( struct V_123 * V_124 )
{
return F_31 ( V_124 , struct V_122 , V_125 ) ;
}
static inline struct V_8 * F_50 ( struct V_126 * V_125 )
{
return F_31 ( V_125 , struct V_8 , V_125 ) ;
}
static int F_51 ( struct V_123 * V_127 , unsigned V_106 )
{
struct V_122 * V_128 = F_49 ( V_127 ) ;
unsigned long V_129 ;
V_129 = F_3 ( V_128 -> V_130 + V_131 ) ;
V_129 >>= V_106 ;
return V_129 & 1UL ;
}
static void F_52 ( struct V_122 * V_132 ,
unsigned long V_133 )
{
unsigned long V_134 ;
if ( F_3 ( V_132 -> V_135 ) & V_133 ) {
F_7 ( F_50 ( V_132 -> V_136 ) -> V_21 ,
L_29 , V_133 ) ;
V_134 = F_3 ( V_132 -> V_135 ) ;
V_134 &= ~ V_133 ;
F_16 ( V_134 , V_132 -> V_135 ) ;
F_9 ( F_50 ( V_132 -> V_136 ) ) ;
}
}
static void F_53 ( struct V_123 * V_127 , unsigned V_106 , int V_137 )
{
struct V_122 * V_132 = F_49 ( V_127 ) ;
struct V_126 * V_128 = V_132 -> V_136 ;
unsigned long V_133 = 1 << V_106 ;
void T_1 * V_11 = V_132 -> V_130 ;
unsigned long V_36 ;
unsigned long V_2 ;
F_4 ( F_50 ( V_128 ) -> V_21 , L_30 ,
V_46 , V_127 , V_106 ) ;
...
static int F_54 ( struct V_123 * V_127 , unsigned V_106 )
{
struct V_122 * V_132 = F_49 ( V_127 ) ;
struct V_126 * V_128 = V_132 -> V_136 ;
void T_1 * V_11 = V_132 -> V_130 ;
...
static int F_55 ( struct V_123 * V_127 ,
...
F_59 ( & V_125 -> V_138 ) ;
V_125 -> V_154 = F_60 ( V_151 , 0x20 , L_35 ) ;
if ( V_125 -> V_154 == NULL ) {
F_22 ( V_9 -> V_21 , L_36 ) ;
return - V_155 ;
}
V_125 -> V_11 = F_61 ( V_151 , 0x20 ) ;
if ( V_125 -> V_11 == NULL ) {
F_22 ( V_9 -> V_21 , L_37 ) ;
V_55 = - V_155 ;
goto V_156;
}
V_55 = F_56 ( V_9 , V_125 , & V_125 -> V_157 ) ;
if ( V_55 ) {
F_22 ( V_9 -> V_21 , L_38 ) ;
goto V_158;
}
V_55 = F_56 ( V_9 , V_125 , & V_125 -> V_148 ) ;
if ( V_55 ) {
F_22 ( V_9 -> V_21 , L_39 ) ;
goto V_159;
}
...
if ( ! V_9 -> V_125 . V_160 )
return;
V_55 = F_62 ( & V_125 -> V_157 . V_125 ) ;
if ( V_55 )
F_22 ( V_9 -> V_21 , L_40 ) ;
V_55 = F_62 ( & V_125 -> V_148 . V_125 ) ;
if ( V_55 )
F_22 ( V_9 -> V_21 , L_41 ) ;
F_63 ( V_125 -> V_11 ) ;
F_64 ( V_125 -> V_154 ) ;
...
static inline int F_66 ( struct V_8 * V_9 , unsigned int V_161 )
{
struct V_126 * V_125 = & V_9 -> V_125 ;
...
if ( ! V_74 )
return - V_103 ;
V_165 = F_47 ( & V_74 -> V_21 ) ;
V_165 -> V_166 = F_66 ( V_9 , V_163 -> V_167 ) ;
V_165 -> V_168 = F_66 ( V_9 , V_163 -> V_169 ) ;
...
static T_3 F_70 ( struct V_32 * V_21 ,
...
V_182 -> V_183 . V_33 ,
V_182 -> V_183 . V_5 ) ;
F_71 ( V_9 , V_12 , & V_182 -> V_184 ) ;
F_71 ( V_9 , V_24 , & V_182 -> V_185 ) ;
F_71 ( V_9 , V_25 , & V_182 -> V_186 ) ;
if ( V_182 -> V_187 ) {
...
static void F_83 ( struct V_8 * V_9 , int V_212 )
{
...
static int F_84 ( struct V_73 * V_74 , T_4 V_216 )
{
...
static int F_87 ( struct V_219 * V_21 ,
...
static void F_100 ( struct V_219 * V_21 )
{
