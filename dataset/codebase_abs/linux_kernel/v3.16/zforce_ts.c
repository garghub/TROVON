...
static struct V_30 * F_52 ( struct V_93 * V_8 )
{
struct V_30 * V_31 ;
struct V_98 * V_99 = V_8 -> V_100 ;
if ( ! V_99 )
return F_53 ( - V_101 ) ;
V_31 = F_54 ( V_8 , sizeof( * V_31 ) , V_102 ) ;
if ( ! V_31 ) {
F_7 ( V_8 , L_38 ) ;
return F_53 ( - V_103 ) ;
}
V_31 -> V_75 = F_55 ( V_99 , 0 ) ;
if ( ! F_56 ( V_31 -> V_75 ) ) {
F_7 ( V_8 , L_39 ) ;
return F_53 ( - V_104 ) ;
}
V_31 -> V_97 = F_55 ( V_99 , 1 ) ;
if ( ! F_56 ( V_31 -> V_97 ) ) {
F_7 ( V_8 , L_40 ) ;
return F_53 ( - V_104 ) ;
}
if ( F_57 ( V_99 , L_41 , & V_31 -> V_33 ) ) {
F_7 ( V_8 , L_42 ) ;
return F_53 ( - V_104 ) ;
}
if ( F_57 ( V_99 , L_43 , & V_31 -> V_34 ) ) {
F_7 ( V_8 , L_44 ) ;
return F_53 ( - V_104 ) ;
}
return V_31 ;
...
const struct V_105 * V_48 )
{
const struct V_30 * V_31 = F_59 ( & V_5 -> V_8 ) ;
struct V_1 * V_2 ;
struct V_92 * V_92 ;
int V_7 ;
if ( ! V_31 ) {
...
V_2 = F_54 ( & V_5 -> V_8 , sizeof( struct V_1 ) , V_102 ) ;
if ( ! V_2 )
return - V_103 ;
V_7 = F_62 ( & V_5 -> V_8 , V_31 -> V_75 , V_106 ,
L_45 ) ;
if ( V_7 ) {
F_7 ( & V_5 -> V_8 , L_46 ,
V_31 -> V_75 , V_7 ) ;
...
V_7 = F_63 ( & V_5 -> V_8 , F_50 , V_2 ) ;
if ( V_7 ) {
F_7 ( & V_5 -> V_8 , L_48 ,
V_7 ) ;
return V_7 ;
}
snprintf ( V_2 -> V_108 , sizeof( V_2 -> V_108 ) ,
L_49 , F_64 ( & V_5 -> V_8 ) ) ;
V_92 = F_65 ( & V_5 -> V_8 ) ;
if ( ! V_92 ) {
F_7 ( & V_5 -> V_8 , L_50 ) ;
...
V_2 -> V_54 = V_92 ;
V_92 -> V_109 = L_51 ;
V_92 -> V_108 = V_2 -> V_108 ;
V_92 -> V_48 . V_110 = V_111 ;
V_92 -> V_112 = F_39 ;
V_92 -> V_113 = F_41 ;
F_67 ( V_114 , V_92 -> V_115 ) ;
F_67 ( V_116 , V_92 -> V_115 ) ;
F_67 ( V_117 , V_92 -> V_115 ) ;
F_68 ( V_92 , V_57 , 0 ,
V_31 -> V_33 , 0 , 0 ) ;
F_68 ( V_92 , V_58 , 0 ,
V_31 -> V_34 , 0 , 0 ) ;
...
F_68 ( V_92 , V_60 , 0 ,
V_118 , 0 , 0 ) ;
F_68 ( V_92 , V_61 , 0 , 1 , 0 , 0 ) ;
F_69 ( V_92 , V_44 , V_119 ) ;
F_70 ( V_2 -> V_54 , V_2 ) ;
F_71 ( & V_2 -> V_17 ) ;
V_7 = F_72 ( & V_5 -> V_8 , V_5 -> V_67 ,
F_32 , F_35 ,
V_120 | V_121 ,
V_92 -> V_109 , V_2 ) ;
if ( V_7 ) {
F_7 ( & V_5 -> V_8 , L_52 , V_5 -> V_67 ) ;
return V_7 ;
}
F_73 ( V_5 , V_2 ) ;
F_51 ( V_31 -> V_97 , 1 ) ;
