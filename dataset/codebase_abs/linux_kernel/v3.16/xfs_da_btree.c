...
switch ( V_171 -> V_25 ) {
case V_49 :
V_118 = F_78 ( V_171 -> V_8 , V_172 -> V_8 ) ;
break;
case V_54 :
V_118 = F_79 ( V_60 , V_171 -> V_8 , V_172 -> V_8 ) ;
break;
case V_32 :
V_118 = F_77 ( V_60 , V_171 -> V_8 , V_172 -> V_8 ) ;
break;
}
if ( V_118 ) {
F_80 ( args ) ;
...
T_6
F_85 ( const T_7 * V_181 , int V_182 )
{
T_6 V_183 ;
for ( V_183 = 0 ; V_182 >= 4 ; V_182 -= 4 , V_181 += 4 )
V_183 = ( V_181 [ 0 ] << 21 ) ^ ( V_181 [ 1 ] << 14 ) ^ ( V_181 [ 2 ] << 7 ) ^
( V_181 [ 3 ] << 0 ) ^ F_86 ( V_183 , 7 * 4 ) ;
switch ( V_182 ) {
case 3 :
return ( V_181 [ 0 ] << 14 ) ^ ( V_181 [ 1 ] << 7 ) ^ ( V_181 [ 2 ] << 0 ) ^
F_86 ( V_183 , 7 * 3 ) ;
case 2 :
return ( V_181 [ 0 ] << 7 ) ^ ( V_181 [ 1 ] << 0 ) ^ F_86 ( V_183 , 7 * 2 ) ;
case 1 :
return ( V_181 [ 0 ] << 0 ) ^ F_86 ( V_183 , 7 * 1 ) ;
default:
return V_183 ;
}
}
...
struct V_188 * V_181 )
{
return F_85 ( V_181 -> V_181 , V_181 -> V_185 ) ;
}
int
F_89 (
struct V_70 * args ,
...
error = F_90 ( V_58 , V_60 , V_35 , V_61 , V_189 ) ;
if ( error )
return error ;
V_196 = 1 ;
ASSERT ( args -> V_199 != NULL ) ;
error = F_91 ( V_58 , V_60 , * V_61 , V_35 ,
F_92 ( V_189 ) | V_200 | V_201 ,
...
T_8 V_204 ;
int V_205 ;
V_195 = F_93 ( sizeof( * V_195 ) * V_35 , V_206 ) ;
for ( V_204 = * V_61 , V_198 = 0 ; V_204 < * V_61 + V_35 ; ) {
V_196 = F_94 ( V_207 , V_35 ) ;
V_205 = ( int ) ( * V_61 + V_35 - V_204 ) ;
error = F_91 ( V_58 , V_60 , V_204 , V_205 ,
F_92 ( V_189 ) | V_200 ,
...
error = F_89 ( args , & V_61 , args -> V_115 -> V_212 ) ;
if ( ! error )
* V_211 = ( T_2 ) V_61 ;
return error ;
}
...
error = F_99 ( V_58 , V_60 , & V_226 , V_189 ) ;
if ( error )
return error ;
if ( F_100 ( V_226 == 0 ) ) {
F_101 ( L_1 , V_234 ,
...
for (; ; ) {
error = F_103 ( V_58 , V_60 , V_227 , V_35 ,
F_92 ( V_189 ) | V_200 ,
...
ASSERT ( V_244 >= 1 ) ;
if ( V_244 > 1 ) {
V_194 = F_107 ( V_244 * sizeof( struct V_241 ) ,
V_206 | V_2 ) ;
if ( ! V_194 )
return V_245 ;
* V_195 = V_194 ;
...
V_194 [ V_4 ] . V_246 = F_108 ( V_11 , V_243 [ V_4 ] . V_238 ) ;
V_194 [ V_4 ] . V_247 = F_109 ( V_11 , V_243 [ V_4 ] . V_210 ) ;
}
return 0 ;
}
static int
...
V_206 | V_2 ) ;
V_244 = V_248 ;
error = F_111 ( V_60 , ( T_8 ) V_61 , V_248 , V_243 ,
& V_244 , F_92 ( V_71 ) ) ;
if ( error )
goto V_250;
} else {
V_243 -> V_238 = F_112 ( V_11 , V_62 ) ;
V_243 -> V_209 = ( T_8 ) V_61 ;
V_243 -> V_210 = V_248 ;
V_243 -> V_251 = 0 ;
V_244 = 1 ;
}
if ( ! F_105 ( V_244 , V_243 , V_61 , V_248 ) ) {
error = V_62 == - 2 ? - 1 : F_76 ( V_42 ) ;
if ( F_100 ( error == V_42 ) ) {
if ( V_252 >= V_234 ) {
int V_4 ;
F_113 ( V_11 , L_8 ,
...
error = F_106 ( V_11 , V_194 , V_242 , V_243 , V_244 ) ;
V_250:
if ( V_243 != & V_249 )
F_95 ( V_243 ) ;
return error ;
...
V_8 = F_114 ( V_73 , V_60 -> V_233 -> V_255 ,
V_195 , V_196 , 0 ) ;
...
V_62 = V_195 [ 0 ] . V_246 ;
F_118 ( V_60 -> V_233 -> V_255 , V_195 , V_196 , V_20 ) ;
V_254:
if ( V_195 != & V_194 )
F_95 ( V_195 ) ;
if ( error )
