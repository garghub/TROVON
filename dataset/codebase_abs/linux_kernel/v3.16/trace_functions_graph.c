...
struct V_75 * V_76 , T_3 V_26 )
{
unsigned long V_124 = ( V_92 & V_125 ) ;
struct V_71 * V_45 = V_76 -> V_78 ;
struct V_126 * V_32 ;
int V_3 = 0 ;
int V_1 ;
...
if ( ! V_32 )
return V_91 ;
V_1 = V_32 -> V_129 -> V_17 ( V_76 , V_124 , V_32 ) ;
if ( V_1 != V_61 )
return V_1 ;
}
...
int V_47 = V_76 -> V_47 ;
int V_1 ;
if ( V_45 && F_30 ( V_45 -> V_74 , V_47 ) -> V_130 ) {
F_30 ( V_45 -> V_74 , V_47 ) -> V_130 = 0 ;
return V_61 ;
}
if ( V_45 && V_45 -> V_82 ) {
V_118 = & V_45 -> V_51 ;
...
F_30 ( V_45 -> V_74 , V_76 -> V_47 ) -> V_130 = 1 ;
V_1 = V_114 ;
}
V_76 -> V_47 = V_47 ;
return V_1 ;
...
F_83 ( V_118 , V_37 ) ;
V_131 = * V_118 ;
return F_76 ( & V_131 , V_58 , V_76 , V_26 ) ;
}
case V_55 : {
struct V_54 * V_118 ;
F_83 ( V_118 , V_37 ) ;
...
static void F_86 ( struct V_136 * V_58 , T_3 V_26 )
{
...
if ( V_26 & V_97 )
V_137 += 17 ;
F_87 ( V_58 , L_34 , V_137 , V_66 ) ;
F_87 ( V_58 , L_35 , V_137 , V_66 ) ;
F_87 ( V_58 , L_36 , V_137 , V_66 ) ;
F_87 ( V_58 , L_37 , V_137 , V_66 ) ;
F_87 ( V_58 , L_38 , V_137 , V_66 ) ;
}
static void F_88 ( struct V_136 * V_58 , T_3 V_26 )
{
int V_138 = V_92 & V_115 ;
if ( V_138 )
F_86 ( V_58 , V_26 ) ;
F_87 ( V_58 , L_39 ) ;
if ( V_26 & V_94 )
...
void F_89 ( struct V_136 * V_58 )
{
F_90 ( V_58 , V_134 . V_135 ) ;
}
void F_90 ( struct V_136 * V_58 , T_3 V_26 )
{
...
int * V_130 = & ( F_30 ( V_45 -> V_74 , V_47 ) -> V_130 ) ;
...
static int
F_101 ( struct V_23 * V_24 , T_3 V_142 , T_3 V_143 , int V_144 )
{
if ( V_143 == V_117 )
V_41 = ! V_144 ;
return 0 ;
...
static T_5
F_102 ( struct V_145 * V_146 , const char T_6 * V_147 , T_4 V_148 ,
T_7 * V_149 )
{
unsigned long V_135 ;
int V_1 ;
V_1 = F_103 ( V_147 , V_148 , 10 , & V_135 ) ;
if ( V_1 )
return V_1 ;
V_48 = V_135 ;
* V_149 += V_148 ;
...
static T_5
F_104 ( struct V_145 * V_146 , char T_6 * V_147 , T_4 V_148 ,
T_7 * V_149 )
{
char V_150 [ 15 ] ;
int V_151 ;
V_151 = sprintf ( V_150 , L_52 , V_48 ) ;
return F_105 ( V_147 , V_148 , V_149 , V_150 , V_151 ) ;
}
...
if ( ! V_153 )
return 0 ;
F_108 ( L_53 , 0644 , V_153 ,
NULL , & V_154 ) ;
return 0 ;
}
static T_8 int F_109 ( void )
{
V_59 = snprintf ( NULL , 0 , L_4 , V_155 - 1 ) ;
if ( ! F_110 ( & V_156 ) ) {
F_98 ( L_54 ) ;
return 1 ;
}
