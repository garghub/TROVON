...
{
struct V_295 * V_204 = F_120 ( V_18 ) ;
struct V_296 * V_17 = F_121 ( V_18 ) ;
struct V_1 * V_2 = V_17 -> V_23 ;
int V_78 ;
F_122 ( V_17 , V_297 ) ;
for ( V_78 = 0 ; V_78 < V_2 -> V_222 ; V_78 ++ )
F_123 ( V_2 -> V_129 [ V_78 ] ) ;
if ( V_2 -> V_124 ) {
for ( V_78 = 0 ; V_78 < V_2 -> V_89 ; V_78 ++ ) {
...
static int F_126 ( struct V_192 * V_18 )
{
struct V_295 * V_204 = F_120 ( V_18 ) ;
struct V_296 * V_17 = F_121 ( V_18 ) ;
struct V_1 * V_2 = V_17 -> V_23 ;
...
struct V_46 * V_46 ;
unsigned long V_49 ;
unsigned long V_304 , V_305 , V_306 ;
int V_64 , V_160 = 1000 , V_307 = 1 ;
T_7 V_308 , V_309 ;
if ( V_2 -> V_225 -> clock != 48000 )
return;
V_310:
V_303 = V_2 -> V_129 [ 0 ] -> V_311 [ 0 ] . V_82 ;
if ( ! V_303 || V_303 -> V_312 . V_294 < V_313 ) {
F_23 ( V_2 -> V_17 -> V_18 ,
L_17 ) ;
return;
}
V_46 = & V_2 -> V_90 [ V_132 ] ;
V_46 -> V_59 = V_303 -> V_312 . V_6 ;
V_46 -> V_53 = V_46 -> V_54 = V_313 ;
V_46 -> V_82 = NULL ;
if ( F_50 ( V_2 -> V_21 [ 0 ] , V_314 , 48000 ) < 0 ) {
F_18 ( V_2 -> V_17 -> V_18 , L_18 ,
V_2 -> V_225 -> clock ) ;
return;
}
F_27 ( V_2 , V_46 ) ;
...
do {
V_64 = F_1 ( V_2 , V_46 -> V_50 + V_65 ) ;
V_305 = F_3 ( V_2 , V_46 -> V_50 + V_46 -> V_161 ) ;
if ( V_305 == 0 ) {
F_17 ( 10 ) ;
continue;
}
...
V_304 /= 4 ;
V_306 = F_137 ( V_309 , V_308 ) ;
F_138 ( V_2 -> V_17 -> V_18 ,
L_20 , V_317 , V_306 , V_304 ) ;
if ( V_306 == 0 ) {
F_18 ( V_2 -> V_17 -> V_18 , L_21 ) ;
goto V_315;
}
V_304 *= 1000 ;
V_304 = ( V_304 / V_306 ) * 1000 + ( ( V_304 % V_306 ) * 1000 ) / V_306 ;
if ( V_304 < 40000 || V_304 >= 60000 ) {
F_138 ( V_2 -> V_17 -> V_18 , L_22 , V_304 ) ;
goto V_315;
} else if ( V_304 > 40500 && V_304 < 41500 )
V_2 -> V_225 -> clock = 41000 ;
else if ( V_304 > 43600 && V_304 < 44600 )
V_2 -> V_225 -> clock = 44100 ;
else if ( V_304 < 47500 || V_304 > 48500 )
V_2 -> V_225 -> clock = ( V_2 -> V_225 -> clock * 48000 ) / V_304 ;
V_316:
F_138 ( V_2 -> V_17 -> V_18 , L_23 , V_2 -> V_225 -> clock ) ;
F_139 ( V_2 -> V_21 [ 0 ] , V_314 , 0 ) ;
}
static int F_140 ( struct V_1 * V_2 )
{
struct V_295 * V_204 = V_2 -> V_204 ;
const struct V_318 * V_319 ;
V_319 = F_102 ( V_204 , V_320 ) ;
if ( ! V_319 )
return 0 ;
F_138 ( V_2 -> V_17 -> V_18 , L_24 ,
V_204 -> V_321 , V_204 -> V_322 , V_319 -> V_323 ) ;
V_2 -> V_225 -> clock = V_319 -> V_323 ;
return 1 ;
}
static void F_141 ( struct V_324 * V_325 ,
struct V_326 * V_327 )
{
struct V_1 * V_2 = V_325 -> V_23 ;
unsigned int V_27 ;
F_142 ( V_327 , L_25 ) ;
if ( V_2 -> V_137 == V_138 )
return;
V_27 = F_5 ( V_2 , F_16 ( V_13 ) ) ;
F_142 ( V_327 , L_26 , F_5 ( V_2 , F_16 ( V_145 ) ) ) ;
F_142 ( V_327 , L_27 , V_27 ) ;
if ( V_2 -> V_137 == V_155 )
F_142 ( V_327 , L_28 , F_5 ( V_2 , F_16 ( V_245 ) ) ) ;
F_142 ( V_327 , L_29 ) ;
if ( V_27 & V_2 -> V_10 ) {
int V_78 ;
...
{
struct V_324 * V_325 ;
if ( ! F_144 ( V_2 -> V_17 , L_37 , & V_325 ) )
F_145 ( V_325 , V_2 , F_141 ) ;
}
static int F_146 ( struct V_328 * V_192 )
{
struct V_1 * V_2 = V_192 -> V_329 ;
return F_112 ( V_2 ) ;
}
static int F_147 ( struct V_295 * V_204 )
{
int V_330 = V_162 ;
char * V_331 = NULL ;
if ( V_330 >= 0 ) {
V_331 = V_330 ? L_38 : L_39 ;
goto V_332;
}
V_330 = F_148 () ;
#ifdef F_149
V_330 = V_330 || F_150 ( F_149 ) ;
#endif
if ( ! V_330 )
goto V_332;
if ( V_204 -> V_321 == 0x1af4 &&
V_204 -> V_322 == 0x1100 ) {
V_331 = L_40 ;
} else if ( V_204 -> V_321 == 0x1ab8 ) {
V_331 = L_41 ;
} else {
V_331 = L_42 ;
V_330 = 0 ;
...
V_332:
if ( V_331 != NULL )
F_138 ( & V_204 -> V_18 , L_43 , V_331 ) ;
return V_330 ;
}
static int F_151 ( struct V_296 * V_17 ,
struct V_295 * V_204 ,
unsigned long V_137 ,
struct V_1 * * V_333 )
{
...
static struct V_337 V_342 [ 4 ] = {
{ V_287 , 0 } ,
{ V_286 , 0x10 } ,
{ V_285 , 0x20 } ,
{ V_288 , 0x70 } ,
} ;
static struct V_337 V_343 [ 6 ] = {
{ V_344 , 0x40 } ,
{ V_345 , 0x50 } ,
{ V_346 , 0x60 } ,
{ V_347 , 0x70 } ,
...
struct V_337 * V_216 ;
* V_333 = NULL ;
if ( ( V_123 = F_129 ( V_204 ) ) < 0 )
return V_123 ;
V_2 = F_152 ( sizeof( * V_2 ) , V_350 ) ;
if ( V_2 == NULL ) {
F_117 ( V_204 ) ;
return - V_351 ;
}
...
if ( V_242 )
V_2 -> V_242 = 1 ;
V_2 -> V_162 = F_147 ( V_204 ) ;
if ( V_204 -> V_352 == V_353 &&
V_204 -> V_192 == V_354 )
V_2 -> V_124 = 1 ;
if ( ( V_123 = F_154 ( V_204 , V_17 -> V_202 ) ) < 0 ) {
F_118 ( V_2 ) ;
F_117 ( V_204 ) ;
return V_123 ;
}
if ( V_137 == V_138 ) {
V_2 -> V_4 = F_155 ( V_204 , 0 , 0 ) ;
goto V_355;
}
if ( F_156 ( V_204 , 2 ) & V_356 )
V_2 -> V_6 = F_155 ( V_204 , 2 , 0 ) ;
else
V_2 -> V_6 = F_155 ( V_204 , 0 , 0 ) ;
if ( ! V_2 -> V_6 ) {
F_18 ( V_17 -> V_18 , L_44 ) ;
F_112 ( V_2 ) ;
return - V_8 ;
}
if ( F_156 ( V_204 , 3 ) & V_356 )
V_2 -> V_4 = F_155 ( V_204 , 3 , 0 ) ;
else
V_2 -> V_4 = F_155 ( V_204 , 1 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_18 ( V_17 -> V_18 , L_45 ) ;
F_112 ( V_2 ) ;
return - V_8 ;
...
if ( F_157 ( V_203 , F_88 ( V_204 ) ,
V_2 -> V_89 * sizeof( T_2 ) * V_358 * 2 ,
& V_2 -> V_292 ) < 0 ) {
F_112 ( V_2 ) ;
F_18 ( V_17 -> V_18 , L_46 ) ;
return - V_351 ;
...
V_2 -> V_244 = 3 ;
V_2 -> V_11 = V_361 ;
V_2 -> V_29 = V_362 | V_363 | V_364 ;
break;
case V_144 :
V_2 -> V_244 = 3 ;
V_2 -> V_11 = V_365 ;
V_2 -> V_29 = V_362 | V_363 | V_366 ;
break;
default:
V_2 -> V_244 = 2 ;
V_2 -> V_11 = V_361 ;
V_2 -> V_29 = V_362 | V_363 ;
break;
}
for ( V_78 = 0 ; V_78 < V_2 -> V_244 ; V_78 ++ )
...
if ( F_132 ( V_204 -> V_83 , F_37 ,
V_300 , V_301 , V_2 ) ) {
F_18 ( V_17 -> V_18 , L_47 , V_204 -> V_83 ) ;
F_112 ( V_2 ) ;
return - V_19 ;
}
V_2 -> V_83 = V_204 -> V_83 ;
if ( ( V_123 = F_158 ( V_17 , V_367 , V_2 , & V_233 ) ) < 0 ) {
F_112 ( V_2 ) ;
return V_123 ;
}
* V_333 = V_2 ;
...
static int F_159 ( struct V_295 * V_204 )
{
const struct V_318 * V_368 ;
V_368 = F_102 ( V_204 , V_369 ) ;
if ( V_368 ) {
if ( V_368 -> V_323 )
F_160 ( & V_204 -> V_18 ,
L_48 ,
...
static int F_162 ( struct V_295 * V_204 ,
...
int V_123 ;
struct V_372 * V_196 ;
V_123 = F_163 ( & V_204 -> V_18 , V_373 , V_374 , V_375 , 0 , & V_17 ) ;
if ( V_123 < 0 )
return V_123 ;
if ( V_218 < 0 )
V_218 = F_159 ( V_204 ) ;
strcpy ( V_17 -> V_376 , L_50 ) ;
if ( ! V_218 ) {
switch ( V_371 -> V_377 ) {
case V_154 :
strcpy ( V_17 -> V_376 , L_51 ) ;
break;
case V_155 :
strcpy ( V_17 -> V_376 , L_52 ) ;
}
}
strcpy ( V_17 -> V_202 , L_8 ) ;
for ( V_196 = V_378 ; V_196 -> V_374 ; V_196 ++ ) {
if ( V_204 -> V_192 == V_196 -> V_374 ) {
strcpy ( V_17 -> V_202 , V_196 -> V_379 ) ;
break;
}
}
if ( V_88 < 0 ) {
if ( V_371 -> V_377 == V_154 )
V_88 = 1 ;
else
V_88 = 0 ;
}
if ( ( V_123 = F_151 ( V_17 , V_204 , V_371 -> V_377 ,
& V_2 ) ) < 0 ) {
F_164 ( V_17 ) ;
return V_123 ;
}
V_17 -> V_23 = V_2 ;
if ( ( V_123 = F_94 ( V_2 , V_226 , V_380 ) ) < 0 ) {
F_164 ( V_17 ) ;
return V_123 ;
}
if ( ( V_123 = F_90 ( V_2 ) ) < 0 ) {
...
F_143 ( V_2 ) ;
snprintf ( V_17 -> V_381 , sizeof( V_17 -> V_381 ) ,
L_53 , V_17 -> V_202 ,
F_165 ( V_2 -> V_21 [ 0 ] ) , V_2 -> V_83 ) ;
if ( V_226 == 0 || V_226 == 1 ) {
if ( V_226 == 0 ) {
if ( F_140 ( V_2 ) == 0 )
F_135 ( V_2 ) ;
...
static void F_168 ( struct V_295 * V_204 )
{
F_164 ( F_169 ( V_204 ) ) ;
}
