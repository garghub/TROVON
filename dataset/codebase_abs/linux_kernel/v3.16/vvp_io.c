...
F_16 ( V_171 ,
L_9 ,
V_168 -> V_48 , V_168 -> V_48 -> V_172 , V_168 -> V_48 -> V_173 ,
( long ) V_168 -> V_48 -> V_82 , F_82 ( V_168 -> V_48 ) ,
F_83 ( V_168 -> V_48 ) , V_168 -> V_174 ) ;
if ( F_84 ( ! ( V_166 -> V_30 . V_170 & V_175 ) ) ) {
F_85 ( V_168 -> V_48 ) ;
V_166 -> V_30 . V_170 &= V_175 ;
}
V_166 -> V_176 = V_168 -> V_48 ;
return 0 ;
}
if ( V_166 -> V_30 . V_170 & V_177 ) {
F_16 ( V_171 , L_10 , V_168 -> V_174 ) ;
return - V_178 ;
}
if ( V_166 -> V_30 . V_170 & V_179 ) {
F_16 ( V_171 , L_11 , V_168 -> V_174 ) ;
return - V_180 ;
}
if ( V_166 -> V_30 . V_170 & V_181 )
return - V_182 ;
...
struct V_34 * V_35 = V_4 -> V_36 ;
struct V_12 * V_12 = F_10 ( V_35 ) ;
struct V_184 * V_185 = & V_4 -> V_29 . V_49 ;
struct V_165 * V_166 = & V_6 -> V_29 . V_30 ;
T_4 V_186 ;
int V_71 = 0 ;
struct V_48 * V_187 = NULL ;
struct V_47 * V_48 ;
T_4 V_123 ;
T_7 V_188 ;
if ( V_185 -> V_189 &&
...
L_14 ,
F_17 ( F_18 ( & V_35 -> V_39 ) ) ) ;
V_186 = F_88 ( V_35 , V_185 -> V_106 + 1 ) - 1 ;
F_3 ( F_32 ( V_35 , V_186 ) == V_185 -> V_106 ) ;
V_71 = F_64 ( V_2 , V_35 , V_4 , 0 , V_186 + 1 , NULL ) ;
if ( V_71 != 0 )
return V_71 ;
if ( V_185 -> V_190 ) {
F_3 ( V_166 -> V_176 != NULL ) ;
F_85 ( V_166 -> V_176 ) ;
} else {
V_71 = F_80 ( V_166 ) ;
if ( V_71 != 0 )
...
F_91 ( V_187 ) ;
V_123 = F_66 ( V_12 ) ;
if ( F_84 ( ( V_187 -> V_172 != V_12 -> V_192 ) ||
( F_92 ( V_187 ) > V_123 ) ) ) {
F_16 ( V_171 , L_15 ) ;
GOTO ( V_146 , V_71 = + 1 ) ;
}
if ( V_185 -> V_190 ) {
T_7 V_193 ;
V_193 = F_32 ( V_35 , V_123 - 1 ) ;
if ( V_193 < V_185 -> V_106 ) {
F_16 ( V_171 ,
L_16
L_17 ,
V_187 -> V_172 , V_185 -> V_106 , V_193 ) ;
GOTO ( V_146 , V_71 = - V_194 ) ;
}
}
V_48 = F_93 ( V_2 , V_35 , V_185 -> V_106 , V_187 , V_195 ) ;
if ( F_94 ( V_48 ) )
GOTO ( V_146 , V_71 = F_95 ( V_48 ) ) ;
if ( V_185 -> V_190 ) {
F_96 ( V_187 ) ;
if ( F_97 ( V_187 ) ) {
struct V_196 * V_197 ;
F_98 ( V_2 , V_4 , V_48 ) ;
V_197 = F_99 ( F_100 ( V_48 , & V_198 ) ) ;
F_101 ( F_102 ( V_35 ) , V_197 ) ;
V_71 = F_103 ( V_2 , V_4 , V_48 , V_199 ) ;
F_3 ( F_104 ( V_48 , V_4 ) ) ;
V_187 = NULL ;
if ( V_71 < 0 ) {
F_105 ( V_2 , V_4 , V_48 ) ;
...
V_188 = F_32 ( V_35 , V_123 - 1 ) ;
F_3 ( ! V_185 -> V_190 || V_185 -> V_106 <= V_188 ) ;
if ( V_185 -> V_106 == V_188 )
V_185 -> V_202 = V_123 - F_88 ( V_35 , V_185 -> V_106 ) ;
else
V_185 -> V_202 = F_108 ( V_35 ) ;
...
{
struct V_3 * V_4 = V_23 -> V_33 ;
struct V_34 * V_35 = V_204 -> V_205 ;
struct V_196 * V_197 = F_99 ( V_204 ) ;
struct V_47 * V_48 = V_204 -> V_206 ;
struct V_12 * V_12 = F_10 ( V_35 ) ;
struct V_207 * V_208 = F_74 ( V_12 ) ;
struct V_209 * V_210 = F_11 ( V_2 , V_23 ) -> V_25 ;
struct V_211 * V_212 = & V_210 -> V_213 ;
struct V_48 * V_187 = V_197 -> V_214 ;
struct V_215 * V_216 = & V_4 -> V_217 ;
int V_17 ;
F_14 ( V_2 , V_35 , F_15 ( V_35 ) ) ;
F_3 ( V_204 -> V_205 == V_35 ) ;
if ( V_208 -> V_218 . V_219 &&
V_208 -> V_218 . V_220 )
F_113 ( V_208 , V_12 , V_212 , V_48 -> V_221 ,
V_197 -> V_222 ) ;
V_17 = F_114 ( V_2 , V_4 , V_48 ) ;
if ( V_17 != - V_223 ) {
F_115 ( V_224 , V_2 , V_48 , L_18 ,
V_17 == - V_194 ? L_19 :
L_20 , V_17 ) ;
if ( V_17 != - V_194 )
return V_17 ;
...
V_208 -> V_218 . V_220 )
F_118 ( V_2 , V_4 , V_212 ,
V_187 -> V_172 , & V_216 -> V_226 , V_210 -> V_227 ) ;
return 0 ;
}
static int F_119 ( const struct V_1 * V_2 , struct V_3 * V_4 ,
struct V_47 * V_48 , struct V_196 * V_197 ,
enum V_228 V_229 )
{
struct V_215 * V_216 ;
int V_71 ;
...
V_216 = & V_4 -> V_217 ;
F_120 ( V_216 , V_48 ) ;
V_71 = F_121 ( V_2 , V_4 , V_229 , V_216 , 0 ) ;
F_3 ( F_104 ( V_48 , V_4 ) ) ;
if ( V_229 == V_230 )
...
struct V_34 * V_35 , struct V_47 * V_231 ,
struct V_196 * V_197 ,
unsigned V_232 , unsigned V_233 )
{
struct V_124 * V_125 = F_53 ( V_2 ) ;
T_4 V_186 = F_88 ( V_35 , V_231 -> V_221 ) ;
int V_71 ;
F_54 ( V_35 ) ;
V_71 = F_125 ( V_2 , V_35 , V_125 ) ;
F_56 ( V_35 ) ;
if ( V_71 == 0 ) {
if ( V_125 -> V_234 <= V_186 ) {
char * V_235 = F_126 ( V_197 -> V_214 ) ;
memset ( V_235 , 0 , F_108 ( V_35 ) ) ;
F_127 ( V_235 ) ;
} else if ( V_197 -> V_222 )
V_197 -> V_225 = 1 ;
else
V_71 = F_119 ( V_2 , V_4 , V_231 , V_197 , V_230 ) ;
if ( V_71 == 0 )
F_116 ( V_2 , V_231 , 1 ) ;
}
return V_71 ;
...
struct V_34 * V_35 = V_204 -> V_205 ;
struct V_196 * V_197 = F_99 ( V_204 ) ;
struct V_47 * V_231 = V_204 -> V_206 ;
struct V_48 * V_187 = V_197 -> V_214 ;
int V_71 ;
F_129 ( F_130 ( V_2 , V_231 ) ) ;
F_3 ( V_187 -> V_172 -> V_236 == F_10 ( V_35 ) ) ;
V_71 = 0 ;
F_115 ( V_171 , V_2 , V_231 , L_21 , V_232 , V_233 ) ;
if ( ! F_131 ( V_187 ) ) {
if ( V_232 == 0 && V_233 == V_154 ) {
F_115 ( V_171 , V_2 , V_231 , L_22 ) ;
F_132 ( V_48 , 0x11 ) ;
} else
V_71 = F_124 ( V_2 , V_23 -> V_33 , V_35 ,
V_231 , V_197 , V_232 , V_233 ) ;
} else
F_115 ( V_171 , V_2 , V_231 , L_23 ) ;
return V_71 ;
}
...
T_4 V_123 ;
F_129 ( F_130 ( V_2 , V_231 ) ) ;
F_3 ( V_187 -> V_172 -> V_236 == V_12 ) ;
F_65 ( V_147 , V_2 , & V_35 -> V_39 , L_24 ) ;
F_115 ( V_171 , V_2 , V_231 , L_25 , V_232 , V_233 ) ;
if ( ! F_134 ( V_187 ) ) {
V_237 = V_238 ;
V_71 = F_103 ( V_2 , V_4 , V_231 , V_199 ) ;
if ( V_71 == 0 ) {
F_97 ( V_187 ) ;
F_101 ( F_102 ( V_35 ) , V_197 ) ;
} else if ( V_71 == - V_200 ) {
...
int V_241 = F_66 ( V_12 ) & ~ V_79 ;
if ( V_233 < V_241 )
V_233 = V_241 ;
}
if ( V_240 )
F_135 ( V_2 , V_231 , 0 , V_233 ) ;
V_71 = F_119 ( V_2 , V_4 , V_231 , V_197 , V_199 ) ;
if ( V_71 )
F_71 ( L_26 ,
V_231 -> V_221 , V_12 , V_71 ) ;
}
} else {
V_237 = V_242 ;
V_71 = 0 ;
...
V_123 = F_88 ( V_35 , V_231 -> V_221 ) + V_233 ;
F_46 ( V_12 ) ;
if ( V_71 == 0 ) {
if ( V_123 > F_66 ( V_12 ) ) {
F_139 ( V_12 , V_123 ) ;
...
V_16 -> V_18 , V_4 -> V_42 ) ;
F_141 ( V_16 , V_245 ) ;
F_142 ( V_4 , & V_16 -> V_245 , V_35 , & V_246 ) ;
V_6 -> V_151 = 0 ;
V_71 = 0 ;
