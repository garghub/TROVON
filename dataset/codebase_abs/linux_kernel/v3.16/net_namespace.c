...
static T_2 int F_69 ( struct V_8 * V_8 )
{
return F_70 ( & V_8 -> V_67 ) ;
}
static T_4 void F_71 ( struct V_8 * V_8 )
{
F_72 ( V_8 -> V_67 ) ;
}
...
struct V_1 * V_2 ;
#ifdef F_74
V_36 = F_75 ( L_2 , sizeof( struct V_8 ) ,
V_68 ,
V_69 , NULL ) ;
V_52 = F_76 ( L_3 ) ;
if ( ! V_52 )
...
static int F_83 ( struct V_24 * V_44 ,
struct V_17 * V_18 )
{
int error ;
if ( V_18 -> V_9 ) {
V_73:
error = F_84 ( & V_74 , 1 , V_18 -> V_9 ) ;
if ( error < 0 ) {
if ( error == - V_75 ) {
F_85 ( & V_74 , V_6 ) ;
goto V_73;
...
V_5 = F_86 (unsigned int, max_gen_ptrs, *ops->id) ;
}
error = F_79 ( V_44 , V_18 ) ;
if ( error ) {
F_23 () ;
if ( V_18 -> V_9 )
F_87 ( & V_74 , * V_18 -> V_9 ) ;
...
int F_78 ( struct V_17 * V_18 )
{
int error ;
F_37 ( & V_12 ) ;
error = F_83 ( V_76 , V_18 ) ;
F_41 ( & V_12 ) ;
return error ;
}
...
static void * F_92 ( struct V_62 * V_79 )
{
struct V_8 * V_8 = NULL ;
struct V_65 * V_65 ;
F_65 () ;
...
static void F_93 ( void * V_39 )
{
F_94 ( V_39 ) ;
}
static int F_95 ( struct V_65 * V_65 , void * V_39 )
{
struct V_8 * V_8 = V_39 ;
if ( ! F_96 ( V_8 -> V_28 , V_80 ) ||
! F_96 ( F_97 () , V_80 ) )
return - V_81 ;
F_94 ( V_65 -> V_66 ) ;
V_65 -> V_66 = F_34 ( V_8 ) ;
...
static unsigned int F_98 ( void * V_39 )
{
struct V_8 * V_8 = V_39 ;
return V_8 -> V_67 ;
}
