...
struct V_31 * F_70 ( T_1 V_53 )
{
int V_37 , V_95 ;
struct V_31 * V_32 ;
V_95 = F_71 ( sizeof( * V_32 ) , V_44 ) ;
V_32 = F_72 ( V_95 , V_76 ) ;
if ( ! V_32 )
return NULL ;
...
void F_80 ( struct V_31 * V_32 , unsigned long V_99 )
{
struct V_60 * V_61 ;
...
void * F_81 ( struct V_31 * V_32 , unsigned long V_47 ,
enum V_108 V_109 )
{
struct V_1 * V_1 ;
...
void F_84 ( struct V_31 * V_32 , unsigned long V_47 )
{
struct V_1 * V_1 ;
unsigned long V_46 , V_50 ;
unsigned int V_2 ;
