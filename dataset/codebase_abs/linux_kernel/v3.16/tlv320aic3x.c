...
V_26 -> V_135 [ V_195 ] . V_133 . V_197 = F_22 ;
V_26 -> V_135 [ V_195 ] . V_26 = V_26 ;
V_140 = F_42 ( V_26 -> V_141 [ V_195 ] . V_198 ,
...
if ( V_26 -> V_201 ) {
F_16 ( V_6 , V_202 ,
( V_26 -> V_201 -> V_203 [ 0 ] & 0xf ) << 4 ) ;
F_16 ( V_6 , V_204 ,
( V_26 -> V_201 -> V_203 [ 1 ] & 0xf ) << 4 ) ;
}
switch ( V_26 -> V_34 ) {
case V_35 :
case V_36 :
...
static int F_48 ( struct V_211 * V_212 ,
const struct V_213 * V_214 )
{
struct V_215 * V_216 = V_212 -> V_199 . V_217 ;
struct V_25 * V_26 ;
struct V_218 * V_219 ;
struct V_220 * V_221 = V_212 -> V_199 . V_222 ;
int V_140 , V_195 ;
T_3 V_20 ;
V_26 = F_49 ( & V_212 -> V_199 , sizeof( struct V_25 ) , V_223 ) ;
if ( V_26 == NULL ) {
F_43 ( & V_212 -> V_199 , L_3 ) ;
return - V_224 ;
}
V_26 -> V_138 = F_50 ( V_212 , & V_225 ) ;
if ( F_51 ( V_26 -> V_138 ) ) {
V_140 = F_52 ( V_26 -> V_138 ) ;
return V_140 ;
}
F_30 ( V_26 -> V_138 , true ) ;
F_53 ( V_212 , V_26 ) ;
if ( V_216 ) {
V_26 -> V_137 = V_216 -> V_137 ;
V_26 -> V_201 = V_216 -> V_201 ;
V_26 -> V_30 = V_216 -> V_30 ;
} else if ( V_221 ) {
V_219 = F_49 ( & V_212 -> V_199 , sizeof( * V_219 ) ,
V_223 ) ;
if ( V_219 == NULL ) {
F_43 ( & V_212 -> V_199 , L_3 ) ;
return - V_224 ;
}
V_140 = F_54 ( V_221 , L_4 , 0 ) ;
if ( V_140 >= 0 )
V_26 -> V_137 = V_140 ;
else
V_26 -> V_137 = - 1 ;
...
V_26 -> V_34 = V_214 -> V_226 ;
if ( F_24 ( V_26 -> V_137 ) &&
! F_38 ( V_26 ) ) {
V_140 = F_57 ( V_26 -> V_137 , L_9 ) ;
if ( V_140 != 0 )
goto V_227;
F_58 ( V_26 -> V_137 , 0 ) ;
}
for ( V_195 = 0 ; V_195 < F_11 ( V_26 -> V_141 ) ; V_195 ++ )
V_26 -> V_141 [ V_195 ] . V_228 = V_229 [ V_195 ] ;
V_140 = F_59 ( & V_212 -> V_199 , F_11 ( V_26 -> V_141 ) ,
V_26 -> V_141 ) ;
if ( V_140 != 0 ) {
F_43 ( & V_212 -> V_199 , L_10 , V_140 ) ;
goto V_230;
}
if ( V_26 -> V_34 == V_39 ) {
V_140 = F_60 ( V_26 -> V_138 , V_231 ,
F_11 ( V_231 ) ) ;
if ( V_140 != 0 )
F_43 ( & V_212 -> V_199 , L_11 ,
V_140 ) ;
}
V_140 = F_61 ( & V_212 -> V_199 ,
& V_232 , & V_233 , 1 ) ;
if ( V_140 != 0 )
goto V_230;
F_62 ( & V_26 -> V_196 , & V_234 ) ;
return 0 ;
V_230:
if ( F_24 ( V_26 -> V_137 ) &&
! F_38 ( V_26 ) )
...
static int F_64 ( struct V_211 * V_235 )
{
struct V_25 * V_26 = F_65 ( V_235 ) ;
F_66 ( & V_235 -> V_199 ) ;
if ( F_24 ( V_26 -> V_137 ) &&
! F_38 ( V_26 ) ) {
F_25 ( V_26 -> V_137 , 0 ) ;
