...
static int F_60 ( struct V_68 V_21 , void * V_92 )
{
struct V_26 V_26 ;
if ( F_30 ( V_21 , & V_26 ) != 0 )
return - V_71 ;
...
int F_73 ( struct V_68 V_21 )
{
if ( ! V_98 )
return 0 ;
return F_74 ( & V_21 , & V_98 -> V_21 ) ;
}
void F_75 ( void )
{
int V_64 ;
...
static int
F_77 ( struct V_68 V_21 , struct V_26 * V_26 )
{
int V_63 , V_99 ;
V_99 = 0 ;
...
struct V_78 V_100 ;
if ( F_79 ( & V_100 ) ) {
F_33 ( V_100 . V_21 , & F_46 ( V_82 ) ) ;
if ( F_74 ( & V_100 . V_21 , & V_21 ) )
return 0 ;
}
F_80 ( 100 ) ;
}
...
static int F_83 ( struct V_68 V_21 , struct V_26 * V_102 )
{
int V_103 ;
V_101 = 0 ;
V_104 = F_82 ;
...
static int F_85 ( struct V_68 V_21 , void * V_92 )
{
struct V_26 V_26 ;
if ( F_83 ( V_21 , & V_26 ) )
return - V_71 ;
...
struct V_106 V_106 ;
struct V_107 * V_107 ;
V_107 = (struct V_107 * ) & V_108 . V_109 ;
if ( ! V_107 -> V_110 )
return;
while ( F_87 ( & V_106 ) == 0 ) {
if ( V_106 . V_111 && V_106 . V_112 == V_113 )
F_88 ( & V_114 ) ;
}
}
...
static int F_103 ( struct V_68 V_21 , void * V_92 )
{
struct V_26 V_26 ;
struct V_124 * V_125 = V_92 ;
if ( F_83 ( V_21 , & V_26 ) )
return - V_71 ;
if ( ( V_26 . V_53 . V_73 == V_74 ) && V_26 . V_53 . V_93 &&
...
static int F_104 ( struct V_128 * V_126 ,
struct V_68 * V_21 )
{
struct V_124 V_125 ;
V_125 . V_126 = * V_126 ;
...
void F_105 ( struct V_128 * V_126 )
{
struct V_68 V_129 ( V_21 ) ;
F_106 ( NULL , NULL ) ;
if ( F_104 ( V_126 , & V_21 ) != 0 )
F_107 ( L_19 ) ;
F_108 ( * ( ( V_43 * ) & V_21 ) ) ;
}
int T_1 F_109 ( struct V_130 * V_131 )
{
struct V_68 V_21 ;
struct V_26 V_26 ;
...
V_131 -> V_133 = V_26 . V_53 . V_134 ;
return 0 ;
}
int F_110 ( struct V_7 * V_8 , struct V_135 * V_135 , T_4 V_19 , T_4 V_30 )
{
int V_99 ;
union V_31 * V_31 = & F_7 ( V_8 ) -> V_31 ;
memset ( V_31 , 0 , sizeof( union V_31 ) ) ;
V_31 -> V_136 . V_34 = ( V_35 ) ( V_36 ) V_8 ;
V_31 -> V_136 . V_30 = V_30 >> 4 ;
V_31 -> V_136 . V_137 = 1 ;
V_31 -> V_136 . V_19 = V_19 ? V_19 : V_8 -> V_19 ;
V_31 -> V_136 . V_135 = ( V_35 ) ( V_36 ) V_135 ;
