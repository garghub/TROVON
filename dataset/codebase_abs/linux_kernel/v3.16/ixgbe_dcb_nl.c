...
static T_1 F_44 ( struct V_46 * V_26 , T_1 V_114 , T_2 V_115 )
{
struct V_1 * V_2 = F_5 ( V_26 ) ;
struct V_19 V_20 = {
. V_21 = V_114 ,
...
{
struct V_1 * V_2 = F_5 ( V_71 ) ;
struct V_116 * V_118 = V_2 -> V_119 ;
V_117 -> V_120 = V_2 -> V_8 . V_54 . V_55 ;
if ( ! V_118 )
return 0 ;
V_117 -> V_121 = V_118 -> V_121 ;
memcpy ( V_117 -> V_122 , V_118 -> V_122 , sizeof( V_117 -> V_122 ) ) ;
memcpy ( V_117 -> V_123 , V_118 -> V_123 , sizeof( V_117 -> V_123 ) ) ;
memcpy ( V_117 -> V_124 , V_118 -> V_124 , sizeof( V_117 -> V_124 ) ) ;
memcpy ( V_117 -> V_83 , V_118 -> V_83 , sizeof( V_117 -> V_83 ) ) ;
return 0 ;
}
...
return - V_113 ;
if ( ! V_2 -> V_119 ) {
V_2 -> V_119 = F_47 ( sizeof( struct V_116 ) ,
V_128 ) ;
if ( ! V_2 -> V_119 )
return - V_129 ;
for ( V_12 = 0 ; V_12 < V_92 ; V_12 ++ )
...
for ( V_12 = 0 ; V_12 < V_92 ; V_12 ++ ) {
if ( V_117 -> V_83 [ V_12 ] > V_125 )
V_125 = V_117 -> V_83 [ V_12 ] ;
if ( V_117 -> V_83 [ V_12 ] != V_2 -> V_119 -> V_83 [ V_12 ] )
V_126 = 1 ;
}
memcpy ( V_2 -> V_119 , V_117 , sizeof( * V_2 -> V_119 ) ) ;
if ( V_125 )
V_125 ++ ;
if ( V_125 > V_2 -> V_8 . V_54 . V_55 )
return - V_113 ;
if ( V_125 != F_49 ( V_71 ) )
V_50 = F_7 ( V_71 , V_125 ) ;
else if ( V_126 )
...
int V_12 ;
V_132 -> V_135 = V_2 -> V_8 . V_54 . V_112 ;
if ( ! V_133 )
return 0 ;
...
static int F_53 ( struct V_46 * V_71 ,
struct V_19 * V_20 )
{
struct V_1 * V_2 = F_5 ( V_71 ) ;
int V_50 = - V_113 ;
...
int V_145 ;
V_2 -> V_146 = V_20 -> V_69 ;
for ( V_145 = 0 ; V_145 < V_2 -> V_147 ; V_145 ++ ) {
struct V_148 * V_149 = & V_2 -> V_149 [ V_145 ] ;
if ( ! V_149 -> V_150 )
F_56 ( V_2 , V_149 -> V_151 ,
V_20 -> V_69 , V_145 ) ;
}
}
return 0 ;
}
static int F_57 ( struct V_46 * V_71 ,
struct V_19 * V_20 )
{
struct V_1 * V_2 = F_5 ( V_71 ) ;
int V_50 ;
...
#endif
if ( V_20 -> V_21 == V_143 &&
V_20 -> V_23 == 0 && V_2 -> V_146 == V_20 -> V_69 ) {
int V_145 ;
long unsigned int V_144 = F_55 ( V_71 , V_20 ) ;
int V_153 = V_144 ? F_59 ( & V_144 , 8 ) : 0 ;
V_2 -> V_146 = V_153 ;
for ( V_145 = 0 ; V_145 < V_2 -> V_147 ; V_145 ++ ) {
struct V_148 * V_149 = & V_2 -> V_149 [ V_145 ] ;
if ( ! V_149 -> V_150 )
...
static T_1 F_60 ( struct V_46 * V_71 )
{
struct V_1 * V_2 = F_5 ( V_71 ) ;
return V_2 -> V_51 ;
}
static T_1 F_61 ( struct V_46 * V_71 , T_1 V_154 )
{
struct V_1 * V_2 = F_5 ( V_71 ) ;
