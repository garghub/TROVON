...
{
int V_71 = 0 ;
V_71 = F_59 ( V_66 , V_70 - 2 , F_6 ( V_28 ) ) ;
V_66 [ V_71 ++ ] = '\n' ;
V_66 [ V_71 ] = '\0' ;
return V_71 ;
}
static int F_60 ( struct V_72 * V_62 )
{
int V_73 ;
V_73 = F_61 ( & V_62 -> V_63 , & V_74 ) ;
if ( V_73 )
return - V_75 ;
V_73 = F_61 ( & V_62 -> V_63 , & V_76 ) ;
if ( V_73 ) {
F_62 ( & V_62 -> V_63 , & V_74 ) ;
return - V_75 ;
}
V_73 = F_61 ( & V_62 -> V_63 , & V_77 ) ;
if ( V_73 ) {
F_62 ( & V_62 -> V_63 , & V_74 ) ;
F_62 ( & V_62 -> V_63 , & V_76 ) ;
return - V_75 ;
...
static void F_63 ( struct V_72 * V_62 )
{
F_62 ( & V_62 -> V_63 , & V_74 ) ;
F_62 ( & V_62 -> V_63 , & V_76 ) ;
F_62 ( & V_62 -> V_63 , & V_77 ) ;
}
static int F_64 ( T_6 V_78 )
{
struct V_79 V_80 = { V_81 , NULL } ;
union V_82 * V_83 ;
int V_60 = - 1 ;
if ( F_65 ( F_66 ( V_78 , L_4 , NULL , & V_80 ) ) )
return V_60 ;
...
F_46 ( V_61 ) ;
V_89 = F_50 () ;
F_69 ( V_78 , V_90 , 0 , & V_42 ) ;
F_15 ( & V_69 ) ;
}
static void F_70 ( T_6 V_78 , T_7 V_91 ,
void * V_40 )
{
...
static int F_74 ( struct V_72 * V_62 )
{
T_8 V_94 ;
strcpy ( F_75 ( V_62 ) , V_95 ) ;
strcpy ( F_76 ( V_62 ) , V_96 ) ;
if ( F_60 ( V_62 ) )
return - V_75 ;
V_94 = F_77 ( V_62 -> V_78 ,
V_97 , F_70 , V_62 ) ;
...
static int F_78 ( struct V_72 * V_62 )
{
F_8 ( & V_69 ) ;
F_46 ( 0 ) ;
F_15 ( & V_69 ) ;
