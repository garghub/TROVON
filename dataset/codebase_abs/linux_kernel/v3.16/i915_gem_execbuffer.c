...
{
V_105 -> V_166 = true ;
( void ) F_111 ( V_105 , V_23 , V_29 , NULL ) ;
}
static int
F_112 ( struct V_67 * V_26 ,
struct V_104 * V_105 )
{
struct V_24 * V_25 = V_26 -> V_27 ;
int V_33 , V_32 ;
if ( ! F_113 ( V_26 ) || V_105 != & V_25 -> V_105 [ V_155 ] ) {
F_12 ( L_13 ) ;
return - V_40 ;
}
V_33 = F_114 ( V_105 , 4 * 3 ) ;
if ( V_33 )
return V_33 ;
for ( V_32 = 0 ; V_32 < 4 ; V_32 ++ ) {
F_115 ( V_105 , F_116 ( 1 ) ) ;
F_115 ( V_105 , F_117 ( V_32 ) ) ;
F_115 ( V_105 , 0 ) ;
}
F_118 ( V_105 ) ;
return 0 ;
}
static int F_119 ( struct V_67 * V_26 ,
struct V_22 * V_23 )
{
struct V_24 * V_25 = V_26 -> V_27 ;
struct V_167 * V_168 = V_23 -> V_157 ;
if ( V_168 -> V_169 )
return V_168 -> V_169 -> V_154 ;
else {
int V_170 ;
F_85 ( & V_26 -> V_129 ) ;
if ( V_25 -> V_171 . V_172 == 0 ) {
V_170 = V_173 ;
V_25 -> V_171 . V_172 = 1 ;
} else {
V_170 = V_174 ;
...
{
struct V_8 * V_42 = F_121 ( V_3 -> V_16 . V_175 , F_53 ( * V_42 ) , V_47 ) ;
V_42 -> V_48 -> V_4 |= V_114 ;
return V_42 -> V_29 ;
}
static int
F_122 ( struct V_67 * V_26 , void * V_176 ,
struct V_22 * V_23 ,
struct V_2 * args ,
struct V_18 * V_19 )
{
...
struct V_149 * V_151 ;
struct V_20 * V_21 ;
const T_7 V_150 = F_123 ( * args ) ;
T_6 V_180 = args -> V_138 , V_181 ;
T_7 V_182 , V_4 ;
int V_33 , V_183 , V_32 ;
bool V_122 ;
if ( ! F_95 ( args ) )
...
V_4 = 0 ;
if ( args -> V_4 & V_45 ) {
if ( ! V_23 -> V_184 || ! F_124 ( V_185 ) )
return - V_186 ;
V_4 |= V_187 ;
}
if ( args -> V_4 & V_188 )
V_4 |= V_189 ;
if ( ( args -> V_4 & V_190 ) > V_191 ) {
F_12 ( L_14 ,
( int ) ( args -> V_4 & V_190 ) ) ;
return - V_40 ;
}
if ( ( args -> V_4 & V_190 ) == V_192 )
V_105 = & V_25 -> V_105 [ V_155 ] ;
else if ( ( args -> V_4 & V_190 ) == V_193 ) {
if ( F_125 ( V_26 ) ) {
int V_170 ;
V_170 = F_119 ( V_26 , V_23 ) ;
V_105 = & V_25 -> V_105 [ V_170 ] ;
} else
V_105 = & V_25 -> V_105 [ V_173 ] ;
} else
V_105 = & V_25 -> V_105 [ ( args -> V_4 & V_190 ) - 1 ] ;
if ( ! F_126 ( V_105 ) ) {
F_12 ( L_15 ,
( int ) ( args -> V_4 & V_190 ) ) ;
return - V_40 ;
}
V_183 = args -> V_4 & V_194 ;
V_182 = V_194 ;
switch ( V_183 ) {
case V_195 :
case V_196 :
case V_197 :
if ( V_183 != 0 && V_105 != & V_25 -> V_105 [ V_155 ] ) {
F_12 ( L_16 ) ;
return - V_40 ;
}
if ( V_183 != V_25 -> V_198 ) {
...
if ( args -> V_199 > V_142 / sizeof( * V_179 ) ) {
F_12 ( L_23 ,
args -> V_199 ) ;
return - V_40 ;
}
V_179 = F_127 ( args -> V_199 ,
sizeof( * V_179 ) ,
V_200 ) ;
if ( V_179 == NULL ) {
V_33 = - V_130 ;
...
if ( F_86 ( V_179 ,
F_57 ( args -> V_202 ) ,
sizeof( * V_179 ) * args -> V_199 ) ) {
V_33 = - V_96 ;
goto V_201;
}
} else {
if ( args -> V_203 == 0xffffffff ) {
F_12 ( L_24 ) ;
args -> V_203 = 0 ;
}
if ( args -> V_204 || args -> V_203 || args -> V_202 ) {
F_12 ( L_25 ) ;
return - V_40 ;
}
}
...
if ( V_4 & V_187 &&
! V_177 -> V_85 ) {
struct V_8 * V_42 = F_107 ( V_177 ) ;
F_131 ( ! V_42 ) ;
V_42 -> V_88 ( V_42 , V_177 -> V_62 , V_89 ) ;
}
if ( V_4 & V_187 )
V_180 += F_46 ( V_177 ) ;
else
V_180 += F_135 ( V_177 , V_21 ) ;
V_33 = F_89 ( V_105 , & V_3 -> V_16 ) ;
if ( V_33 )
goto V_38;
V_33 = F_136 ( V_105 , V_151 ) ;
if ( V_33 )
goto V_38;
if ( V_105 == & V_25 -> V_105 [ V_155 ] &&
V_183 != V_25 -> V_198 ) {
...
F_115 ( V_105 , F_116 ( 1 ) ) ;
F_115 ( V_105 , V_209 ) ;
F_115 ( V_105 , V_182 << 16 | V_183 ) ;
F_118 ( V_105 ) ;
V_25 -> V_198 = V_183 ;
}
if ( args -> V_4 & V_210 ) {
V_33 = F_112 ( V_26 , V_105 ) ;
if ( V_33 )
goto V_38;
}
V_181 = args -> V_139 ;
if ( V_179 ) {
for ( V_32 = 0 ; V_32 < args -> V_199 ; V_32 ++ ) {
V_33 = F_137 ( V_26 , & V_179 [ V_32 ] ,
args -> V_204 , args -> V_203 ) ;
if ( V_33 )
goto V_38;
V_33 = V_105 -> V_211 ( V_105 ,
V_180 , V_181 ,
V_4 ) ;
if ( V_33 )
goto V_38;
...
F_138 ( V_105 , F_105 ( V_105 ) , V_4 ) ;
F_103 ( & V_3 -> V_16 , V_105 ) ;
F_110 ( V_26 , V_23 , V_105 , V_177 ) ;
V_38:
F_130 ( V_151 ) ;
F_30 ( V_3 ) ;
F_82 ( & V_26 -> V_129 ) ;
...
int
F_140 ( struct V_67 * V_26 , void * V_176 ,
struct V_22 * V_23 )
{
struct V_212 * args = V_176 ;
struct V_2 V_213 ;
...
V_213 . V_204 = args -> V_204 ;
V_213 . V_203 = args -> V_203 ;
V_213 . V_199 = args -> V_199 ;
V_213 . V_202 = args -> V_202 ;
V_213 . V_4 = V_217 ;
F_141 ( V_213 , 0 ) ;
V_33 = F_122 ( V_26 , V_176 , V_23 , & V_213 , V_215 ) ;
if ( ! V_33 ) {
...
int
F_142 ( struct V_67 * V_26 , void * V_176 ,
struct V_22 * V_23 )
{
struct V_2 * args = V_176 ;
struct V_18 * V_215 = NULL ;
int V_33 ;
if ( args -> V_7 < 1 ||
...
V_33 = F_122 ( V_26 , V_176 , V_23 , args , V_215 ) ;
if ( ! V_33 ) {
struct V_18 * V_218 =
F_57 ( args -> V_216 ) ;
int V_32 ;
