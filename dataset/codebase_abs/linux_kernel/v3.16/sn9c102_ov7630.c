...
break;
case V_20 :
V_10 -> V_15 = F_6 ( V_2 , 0x00 ) ;
if ( V_10 -> V_15 < 0 )
return - V_16 ;
V_10 -> V_15 &= 0x3f ;
break;
case V_21 :
V_10 -> V_15 = F_6 ( V_2 , 0x0c ) ;
if ( V_10 -> V_15 < 0 )
return - V_16 ;
V_10 -> V_15 &= 0x3f ;
break;
case V_22 :
V_10 -> V_15 = F_6 ( V_2 , 0x0d ) ;
if ( V_10 -> V_15 < 0 )
return - V_16 ;
V_10 -> V_15 &= 0x3f ;
break;
case V_23 :
V_10 -> V_15 = F_6 ( V_2 , 0x13 ) ;
if ( V_10 -> V_15 < 0 )
return - V_16 ;
V_10 -> V_15 &= 0x01 ;
break;
case V_24 :
V_10 -> V_15 = F_6 ( V_2 , 0x75 ) ;
if ( V_10 -> V_15 < 0 )
return - V_16 ;
V_10 -> V_15 = ( V_10 -> V_15 & 0x80 ) ? 1 : 0 ;
break;
case V_25 :
V_10 -> V_15 = F_6 ( V_2 , 0x14 ) ;
if ( V_10 -> V_15 < 0 )
return - V_16 ;
V_10 -> V_15 = ( V_10 -> V_15 & 0x02 ) ? 1 : 0 ;
break;
case V_26 :
V_10 -> V_15 = F_6 ( V_2 , 0x2d ) ;
if ( V_10 -> V_15 < 0 )
return - V_16 ;
V_10 -> V_15 = ( V_10 -> V_15 & 0x02 ) ? 1 : 0 ;
break;
