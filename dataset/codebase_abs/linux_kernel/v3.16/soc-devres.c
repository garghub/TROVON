...
{
F_13 ( * (struct V_15 * * ) V_3 ) ;
}
int F_14 ( struct V_1 * V_2 , struct V_15 * V_16 )
{
struct V_15 * * V_9 ;
int V_10 ;
...
static void F_16 ( struct V_1 * V_2 , void * V_3 )
{
F_17 ( * (struct V_1 * * ) V_3 ) ;
}
int F_18 ( struct V_1 * V_2 ,
const struct V_17 * V_18 , unsigned int V_19 )
{
struct V_1 * * V_9 ;
int V_10 ;
V_9 = F_4 ( F_16 , sizeof( * V_9 ) , V_11 ) ;
if ( ! V_9 )
return - V_12 ;
V_10 = F_19 ( V_2 , V_18 , V_19 ) ;
if ( V_10 == 0 ) {
* V_9 = V_2 ;
F_6 ( V_2 , V_9 ) ;
} else {
