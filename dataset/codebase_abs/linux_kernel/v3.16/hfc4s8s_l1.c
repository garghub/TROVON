...
static void
F_40 ( struct V_100 * V_101 )
{
T_1 * V_8 = F_41 ( V_101 , T_1 , V_34 ) ;
T_2 V_2 ;
struct V_18 * V_51 ;
volatile T_2 * V_102 ;
int V_103 ;
...
static void
F_47 ( T_1 * V_8 , int V_147 , int V_36 )
{
T_4 V_24 ;
char V_148 [ 40 ] ;
int V_149 ;
...
V_8 -> V_19 [ V_149 ] . V_27 = 0 ;
F_49 ( & V_8 -> V_19 [ V_149 ] . V_43 ) ;
F_42 ( & V_8 -> V_19 [ V_149 ] . V_40 ) ;
...
F_58 ( & V_8 -> V_34 , F_40 ) ;
if ( F_59
( V_8 -> V_177 , F_44 , V_178 , V_8 -> V_179 , V_8 ) ) {
F_30 ( V_46
L_12 ,
V_8 -> V_177 ) ;
goto V_175;
...
static int
F_61 ( struct V_180 * V_164 , const struct V_181 * V_182 )
{
int V_167 = - V_183 ;
T_6 * V_111 = ( T_6 * ) V_182 -> V_111 ;
T_1 * V_8 ;
if ( ! ( V_8 = F_62 ( sizeof( T_1 ) , V_184 ) ) ) {
F_30 ( V_93 L_14 ) ;
return ( V_167 ) ;
}
V_8 -> V_164 = V_164 ;
...
F_30 ( V_46 L_16 ,
V_111 -> V_186 , V_8 -> V_179 , F_64 ( V_164 ) ) ;
F_55 ( & V_8 -> V_28 ) ;
V_8 -> V_111 = * V_111 ;
V_8 -> V_177 = V_164 -> V_177 ;
V_8 -> V_3 = F_65 ( V_164 , 0 ) ;
if ( ! F_66 ( V_8 -> V_3 , 8 , V_8 -> V_179 ) ) {
F_30 ( V_46
L_17 ,
V_8 -> V_3 ) ;
goto V_175;
...
static void
F_68 ( struct V_180 * V_164 )
{
T_1 * V_8 = F_69 ( V_164 ) ;
F_30 ( V_46 L_18 , V_8 -> V_110 ) ;
F_47 ( V_8 , 0 , 0 ) ;
if ( V_8 -> V_177 )
F_70 ( V_8 -> V_177 , V_8 ) ;
V_8 -> V_177 = 0 ;
