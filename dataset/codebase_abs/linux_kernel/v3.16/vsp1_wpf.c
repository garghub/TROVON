...
( V_16 -> V_42 << V_39 ) ) ;
if ( ! V_13 -> V_25 ) {
const struct V_43 * V_44 = V_2 -> V_28 . V_44 ;
V_19 = V_44 -> V_45 << V_46 ;
if ( V_44 -> V_47 )
V_19 |= V_48 ;
if ( V_44 -> V_49 )
V_19 |= V_50 ;
F_3 ( V_2 , V_51 , V_44 -> V_52 ) ;
}
if ( V_2 -> V_4 . V_53 [ V_54 ] . V_55 !=
V_2 -> V_4 . V_53 [ V_56 ] . V_55 )
V_19 |= V_57 ;
F_3 ( V_2 , V_58 , V_19 ) ;
F_4 ( V_5 , F_11 ( V_2 -> V_4 . V_6 ) ,
V_59 ) ;
F_4 ( V_5 , V_60 , 0 ) ;
...
static void F_13 ( struct V_62 * V_28 ,
struct V_63 * V_64 )
{
struct V_1 * V_2 = F_14 ( V_28 , struct V_1 , V_28 ) ;
F_3 ( V_2 , V_65 , V_64 -> V_66 [ 0 ] ) ;
if ( V_64 -> V_64 . V_32 > 1 )
F_3 ( V_2 , V_67 , V_64 -> V_66 [ 1 ] ) ;
if ( V_64 -> V_64 . V_32 > 2 )
F_3 ( V_2 , V_68 , V_64 -> V_66 [ 2 ] ) ;
}
struct V_1 * F_15 ( struct V_14 * V_5 , unsigned int V_6 )
{
struct V_9 * V_10 ;
struct V_62 * V_28 ;
struct V_1 * V_2 ;
unsigned int V_69 ;
int V_70 ;
V_2 = F_16 ( V_5 -> V_71 , sizeof( * V_2 ) , V_72 ) ;
if ( V_2 == NULL )
return F_17 ( - V_73 ) ;
V_2 -> V_74 = V_75 ;
V_2 -> V_76 = V_77 ;
...
V_28 -> V_5 = V_5 ;
V_28 -> V_80 = & V_87 ;
V_70 = F_23 ( V_28 , & V_2 -> V_4 ) ;
if ( V_70 < 0 )
goto V_88;
V_69 = V_89 ;
if ( ! ( V_5 -> V_90 -> V_91 & V_92 ) || V_6 != 0 )
V_69 |= V_93 ;
V_70 = F_24 ( & V_2 -> V_4 . V_10 . V_4 ,
V_56 ,
& V_2 -> V_28 . V_28 . V_4 , 0 , V_69 ) ;
if ( V_70 < 0 )
goto V_94;
V_2 -> V_4 . V_95 = & V_2 -> V_28 . V_28 . V_4 ;
return V_2 ;
V_94:
F_25 ( V_28 ) ;
V_88:
