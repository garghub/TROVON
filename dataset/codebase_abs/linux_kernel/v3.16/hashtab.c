...
void * F_9 ( struct V_1 * V_2 , const void * V_3 )
{
T_1 V_13 ;
struct V_14 * V_16 ;
if ( ! V_2 )
...
int (* F_12)( void * V_24 , void * V_25 , void * args ) ,
void * args )
{
T_1 V_8 ;
int V_26 ;
...
V_16 = V_2 -> V_11 [ V_8 ] ;
while ( V_16 ) {
V_26 = F_12 ( V_16 -> V_3 , V_16 -> V_12 , args ) ;
if ( V_26 )
return V_26 ;
V_16 = V_16 -> V_20 ;
}
...
void F_13 ( struct V_1 * V_2 , struct V_27 * V_28 )
{
