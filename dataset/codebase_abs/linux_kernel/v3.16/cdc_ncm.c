...
V_13 -> V_67 = NULL ;
V_11 -> V_64 -> V_8 . V_222 += V_13 -> V_207 ;
V_13 -> V_223 += V_194 -> V_47 - V_13 -> V_208 ;
V_13 -> V_224 ++ ;
V_11 -> V_64 -> V_8 . V_225 -= V_194 -> V_47 - V_13 -> V_208 ;
return V_194 ;
V_202:
...
{
if ( ! ( F_69 ( & V_13 -> V_138 ) || F_85 ( & V_13 -> V_146 ) ) )
F_86 ( & V_13 -> V_138 ,
F_87 ( 0 , V_13 -> V_45 ) ,
V_140 ) ;
}
static enum V_226 V_142 ( struct V_227 * V_228 )
{
struct V_12 * V_13 =
F_88 ( V_228 , struct V_12 , V_138 ) ;
if ( ! F_85 ( & V_13 -> V_146 ) )
F_89 ( & V_13 -> V_143 ) ;
return V_229 ;
}
static void V_145 ( unsigned long V_230 )
{
...
struct V_180 *
F_90 ( struct V_10 * V_11 , struct V_180 * V_181 , T_8 V_218 )
{
struct V_180 * V_194 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
if ( V_13 == NULL )
goto error;
F_24 ( & V_13 -> V_52 ) ;
V_194 = F_81 ( V_11 , V_181 , F_26 ( V_232 ) ) ;
F_25 ( & V_13 -> V_52 ) ;
return V_194 ;
error:
if ( V_181 != NULL )
...
int F_91 ( struct V_12 * V_13 , struct V_180 * V_233 )
{
...
sizeof( struct V_99 ) ) ) {
F_92 ( V_11 , V_234 , V_11 -> V_64 , L_30 ) ;
goto error;
}
V_188 = (struct V_34 * ) V_233 -> V_9 ;
if ( V_188 -> V_191 != F_26 ( V_203 ) ) {
F_92 ( V_11 , V_234 , V_11 -> V_64 ,
L_31 ,
F_8 ( V_188 -> V_191 ) ) ;
goto error;
}
...
if ( ( V_13 -> V_235 + 1 ) != F_42 ( V_188 -> V_205 ) &&
( V_13 -> V_235 || F_42 ( V_188 -> V_205 ) ) &&
! ( ( V_13 -> V_235 == 0xffff ) && ! F_42 ( V_188 -> V_205 ) ) ) {
F_92 ( V_11 , V_234 , V_11 -> V_64 ,
L_33 ,
V_13 -> V_235 , F_42 ( V_188 -> V_205 ) ) ;
}
...
int F_93 ( struct V_180 * V_233 , int V_189 )
{
struct V_10 * V_11 = F_4 ( V_233 -> V_11 ) ;
struct V_99 * V_187 ;
int V_49 = - V_48 ;
if ( ( V_189 + sizeof( struct V_99 ) ) > V_233 -> V_47 ) {
F_92 ( V_11 , V_234 , V_11 -> V_64 , L_34 ,
V_189 ) ;
goto error;
}
V_187 = (struct V_99 * ) ( V_233 -> V_9 + V_189 ) ;
if ( F_42 ( V_187 -> V_193 ) < V_236 ) {
F_92 ( V_11 , V_234 , V_11 -> V_64 , L_35 ,
F_42 ( V_187 -> V_193 ) ) ;
goto error;
}
...
V_49 * ( sizeof( struct V_100 ) ) ) > V_233 -> V_47 ) {
F_92 ( V_11 , V_234 , V_11 -> V_64 , L_36 , V_49 ) ;
V_49 = - V_48 ;
}
error:
return V_49 ;
}
int F_94 ( struct V_10 * V_11 , struct V_180 * V_233 )
{
struct V_180 * V_181 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
int V_47 ;
...
int V_240 = 50 ;
V_18 V_241 = 0 ;
V_189 = F_91 ( V_13 , V_233 ) ;
if ( V_189 < 0 )
goto error;
V_242:
V_237 = F_93 ( V_233 , V_189 ) ;
if ( V_237 < 0 )
goto error;
V_187 = (struct V_99 * ) ( V_233 -> V_9 + V_189 ) ;
if ( V_187 -> V_191 != F_26 ( V_232 ) ) {
F_92 ( V_11 , V_234 , V_11 -> V_64 ,
L_37 ,
F_8 ( V_187 -> V_191 ) ) ;
goto V_243;
...
V_210 = V_187 -> V_210 ;
for ( V_238 = 0 ; V_238 < V_237 ; V_238 ++ , V_210 ++ ) {
V_239 = F_42 ( V_210 -> V_212 ) ;
...
V_181 = F_95 ( V_11 -> V_64 , V_47 ) ;
if ( ! V_181 )
goto error;
memcpy ( F_79 ( V_181 , V_47 ) , V_233 -> V_9 + V_239 , V_47 ) ;
F_96 ( V_11 , V_181 ) ;
V_241 += V_47 ;
}
}
...
static void F_99 ( struct V_10 * V_11 , struct V_252 * V_252 )
{
struct V_12 * V_13 ;
struct V_253 * V_254 ;
...
F_98 ( V_11 , V_251 , V_11 -> V_64 ,
L_41 ,
! ! V_254 -> V_260 ? L_42 : L_43 ) ;
F_75 ( V_11 , ! ! V_254 -> V_260 , 0 ) ;
break;
case V_261 :
if ( V_252 -> V_255 < ( sizeof( * V_254 ) +
sizeof( struct V_246 ) ) )
F_101 ( V_256 , & V_11 -> V_218 ) ;
else
F_97 ( V_11 ,
