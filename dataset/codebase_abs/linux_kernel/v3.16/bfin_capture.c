...
L_7 ) ;
while ( ! F_47 ( & V_5 -> V_63 ) ) {
V_5 -> V_103 = F_48 ( V_5 -> V_63 . V_104 ,
struct V_1 , V_60 ) ;
F_49 ( & V_5 -> V_103 -> V_60 ) ;
F_50 ( & V_5 -> V_103 -> V_3 , V_105 ) ;
}
}
static int F_51 ( struct V_25 * V_25 , void * V_106 ,
struct V_107 * V_108 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
...
return - V_109 ;
V_29 -> V_34 = true ;
return F_53 ( V_49 , V_108 ) ;
}
static int F_54 ( struct V_25 * V_25 , void * V_106 ,
struct V_110 * V_59 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
return F_55 ( & V_5 -> V_36 , V_59 ) ;
}
static int F_56 ( struct V_25 * V_25 , void * V_106 ,
struct V_110 * V_59 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
struct V_35 * V_32 = V_25 -> V_33 ;
...
if ( ! V_29 -> V_34 )
return - V_109 ;
return F_57 ( & V_5 -> V_36 , V_59 ) ;
}
static int F_58 ( struct V_25 * V_25 , void * V_106 ,
struct V_110 * V_59 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
struct V_35 * V_32 = V_25 -> V_33 ;
...
static int F_65 ( struct V_25 * V_25 , void * V_106 ,
enum V_122 V_123 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
...
static int F_68 ( struct V_25 * V_25 , void * V_106 ,
enum V_122 V_123 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
struct V_29 * V_32 = V_25 -> V_33 ;
if ( ! V_32 -> V_34 )
return - V_109 ;
return F_67 ( & V_5 -> V_36 , V_123 ) ;
}
static int F_69 ( struct V_25 * V_25 , void * V_106 , T_4 * V_93 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
...
if ( F_52 ( & V_5 -> V_36 ) )
return - V_109 ;
V_39 = F_4 ( V_5 -> V_13 , V_14 , V_125 , V_93 ) ;
if ( V_39 < 0 )
return V_39 ;
V_5 -> V_93 = V_93 ;
return 0 ;
}
static int F_72 ( struct V_25 * V_25 , void * V_106 ,
struct V_126 * V_127 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
V_127 -> V_128 = 0 ;
return F_4 ( V_5 -> V_13 , V_128 ,
V_129 , V_127 ) ;
}
...
if ( F_52 ( & V_5 -> V_36 ) )
return - V_109 ;
V_39 = F_4 ( V_5 -> V_13 , V_14 , V_132 , V_127 ) ;
if ( V_39 < 0 )
return V_39 ;
V_5 -> V_84 = * V_127 ;
return 0 ;
...
static int F_77 ( struct V_25 * V_25 , void * V_106 , unsigned int * V_138 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
* V_138 = V_5 -> V_79 ;
return 0 ;
...
static int F_79 ( struct V_4 * V_146 ,
struct V_147 * V_148 ,
struct V_8 * V_149 )
{
...
static int F_82 ( struct V_25 * V_25 , void * V_106 ,
struct V_155 * V_51 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
...
static int F_84 ( struct V_25 * V_25 , void * V_106 ,
struct V_50 * V_51 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
struct V_147 * V_148 = & V_51 -> V_51 . V_159 ;
return F_79 ( V_5 , V_148 , NULL ) ;
}
...
if ( F_52 ( & V_5 -> V_36 ) )
return - V_109 ;
V_39 = F_79 ( V_5 , V_148 , & V_149 ) ;
if ( V_39 < 0 )
return V_39 ;
F_80 ( & V_151 , V_148 , V_149 . V_21 ) ;
...
F_83 ( V_162 -> V_165 , V_166 , sizeof( V_162 -> V_165 ) ) ;
F_83 ( V_162 -> V_167 , L_10 , sizeof( V_162 -> V_167 ) ) ;
F_83 ( V_162 -> V_168 , V_5 -> V_76 -> V_169 , sizeof( V_162 -> V_168 ) ) ;
return 0 ;
}
...
static int F_90 ( struct V_25 * V_25 , void * V_106 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
F_91 ( & V_5 -> V_30 , 0 , V_174 , V_175 ) ;
return 0 ;
}
...
struct V_141 * V_142 ;
int V_39 ;
V_136 = V_177 -> V_181 . V_182 ;
if ( ! V_136 || ! V_136 -> V_139 ) {
F_10 ( V_177 -> V_181 . V_165 , L_11 ) ;
return - V_31 ;
}
V_5 = F_5 ( sizeof( * V_5 ) , V_17 ) ;
if ( ! V_5 ) {
F_10 ( V_177 -> V_181 . V_165 , L_12 ) ;
return - V_18 ;
}
V_5 -> V_76 = V_136 ;
V_5 -> V_66 = F_93 ( V_136 -> V_183 ) ;
if ( ! V_5 -> V_66 ) {
F_10 ( V_177 -> V_181 . V_165 , L_13 ) ;
V_39 = - V_31 ;
goto V_184;
}
V_5 -> V_66 -> V_106 = V_5 ;
V_5 -> V_58 = F_94 ( & V_177 -> V_181 ) ;
if ( F_95 ( V_5 -> V_58 ) ) {
V_39 = F_96 ( V_5 -> V_58 ) ;
goto V_185;
}
...
V_27 -> V_193 = 0 ;
V_27 -> V_30 = & V_5 -> V_30 ;
F_98 ( V_194 , & V_27 -> V_45 ) ;
strncpy ( V_27 -> V_195 , V_166 , sizeof( V_27 -> V_195 ) ) ;
V_5 -> V_28 = V_27 ;
V_39 = F_99 ( & V_177 -> V_181 , & V_5 -> V_30 ) ;
if ( V_39 ) {
F_10 ( V_177 -> V_181 . V_165 ,
L_15 ) ;
goto V_196;
}
F_100 ( & V_5 -> V_30 , L_16 ) ;
V_5 -> V_30 . V_197 = & V_5 -> V_197 ;
V_39 = F_101 ( & V_5 -> V_197 , 0 ) ;
if ( V_39 ) {
F_10 ( & V_5 -> V_30 ,
L_17 ) ;
goto V_198;
...
V_27 -> V_193 |= V_136 -> V_78 [ V_11 ] . V_93 ;
} else {
F_10 ( & V_5 -> V_30 ,
L_21 ) ;
V_39 = - V_31 ;
...
T_4 V_93 ;
V_39 = F_4 ( V_5 -> V_13 , V_14 , V_213 , & V_93 ) ;
if ( V_39 ) {
F_10 ( & V_5 -> V_30 ,
L_23 ) ;
goto V_211;
