...
V_251 -> V_256 = F_121 ( V_37 ) ;
#ifdef F_122
V_251 -> V_256 |= F_121 ( V_39 ) ;
#endif
...
V_253 -> V_262 = 1 ;
V_2 -> V_27 -> V_220 -> V_263 = V_2 -> V_257 ;
V_2 -> V_27 -> V_220 -> V_264 = 1 ;
}
...
F_126 ( & V_2 -> V_54 ) ;
F_7 ( V_30 , & V_2 -> V_11 ) ;
V_2 -> V_27 -> V_272 = sizeof( struct V_20 ) ;
V_2 -> V_27 -> V_220 -> V_273 [ V_274 - 1 ] =
( V_2 -> V_7 -> V_8 - 1 ) ;
V_2 -> V_144 =
F_129 ( L_5 , 0 , F_130 ( V_2 -> V_27 -> V_220 ) ) ;
if ( ! V_2 -> V_144 ) {
V_246 = - V_214 ;
goto exit;
}
...
goto exit;
V_2 -> V_71 = F_123 ( V_2 ) ;
V_2 -> V_27 -> V_220 -> V_276 = F_121 ( V_277 ) ;
if ( V_2 -> V_278 -> V_235 > 0 )
V_2 -> V_27 -> V_220 -> V_276 |=
F_121 ( V_38 ) |
F_121 ( V_37 ) |
#ifdef F_122
F_121 ( V_39 ) |
...
int F_148 ( struct V_1 * V_2 , T_8 V_283 )
{
F_149 ( V_2 , L_8 ) ;
