...
if ( V_57 > 255 )
return V_62 ;
F_19 ( & V_2 -> V_64 . V_65 , NULL ) ;
F_18 ( L_9 , V_57 ) ;
F_20 (intel_connector, &dev->mode_config.connector_list, base.head)
F_21 ( V_58 , V_57 , 255 ) ;
F_5 ( F_22 ( V_57 * 100 , 255 ) | V_66 , & V_60 -> V_67 ) ;
F_23 ( & V_2 -> V_64 . V_65 ) ;
return 0 ;
}
static T_1 F_24 ( struct V_1 * V_2 , T_1 V_68 )
{
F_4 ( L_10 ) ;
return V_69 ;
}
static T_1 F_25 ( struct V_1 * V_2 , T_1 V_70 )
{
F_4 ( L_11 ) ;
return V_71 ;
}
static T_1 F_26 ( struct V_1 * V_2 , T_1 V_72 )
{
F_4 ( L_12 ) ;
return V_73 ;
}
static T_1 F_27 ( struct V_1 * V_2 , T_1 V_74 )
{
F_4 ( L_13 ) ;
return V_75 ;
}
...
static T_1 F_30 ( struct V_1 * V_2 , T_1 V_76 )
{
if ( V_76 & V_85 )
F_4 ( L_22 ) ;
else
...
if ( V_92 & V_95 )
V_91 |= F_24 ( V_2 , F_2 ( & V_60 -> V_68 ) ) ;
if ( V_92 & V_96 )
V_91 |= F_16 ( V_2 , F_2 ( & V_60 -> V_57 ) ) ;
if ( V_92 & V_97 )
V_91 |= F_26 ( V_2 , F_2 ( & V_60 -> V_72 ) ) ;
if ( V_92 & V_98 )
V_91 |= F_25 ( V_2 , F_2 ( & V_60 -> V_70 ) ) ;
if ( V_92 & V_99 )
V_91 |= F_27 ( V_2 ,
F_2 ( & V_60 -> V_74 ) ) ;
if ( V_92 & V_100 )
...
T_1 V_130 ;
int V_53 = 0 ;
V_123 = F_38 ( & V_2 -> V_29 -> V_2 ) ;
if ( ! V_123 || F_39 ( V_123 , & V_125 ) )
return;
if ( F_40 ( V_123 ) )
V_127 = V_125 ;
else {
...
F_57 ( & V_10 -> F_32 , F_32 ) ;
#endif
V_40 = F_58 ( V_174 , V_181 ) ;
if ( ! V_40 )
return - V_182 ;
F_59 ( V_176 , V_40 , sizeof( V_176 ) ) ;
