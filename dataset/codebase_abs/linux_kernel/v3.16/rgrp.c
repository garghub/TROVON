...
static void F_138 ( const struct V_1 * V_2 , bool V_299 ,
unsigned int * V_59 )
{
...
F_1 ( & V_127 , true , V_302 ) ;
( * V_59 ) ++ ;
V_44 ++ ;
}
}
static struct V_69 * F_139 ( struct V_74 * V_75 , T_2 V_303 ,
...
F_28 ( & V_22 -> V_109 ) ;
for ( V_59 = F_32 ( & V_22 -> V_104 ) ; V_59 ; V_59 = F_34 ( & V_306 -> V_99 ) ) {
V_306 = F_29 ( V_59 , struct V_35 , V_99 ) ;
F_42 ( V_101 , V_306 ) ;
}
F_30 ( & V_22 -> V_109 ) ;
}
...
if ( ! V_299 && F_26 ( V_2 -> V_22 , V_93 -> V_236 ) )
V_41 = V_93 -> V_236 ;
else
V_41 = V_2 -> V_22 -> V_237 + V_2 -> V_22 -> V_46 ;
F_16 ( V_2 , V_41 ) ;
}
int F_148 ( struct V_92 * V_93 , T_2 * V_309 , unsigned int * V_310 ,
bool V_299 , T_2 * V_311 )
{
struct V_74 * V_75 = F_70 ( & V_93 -> V_133 ) ;
struct V_188 * V_312 ;
...
if ( error ) {
F_100 ( V_75 , L_19 ,
( unsigned long long ) V_93 -> V_238 , error , * V_310 ,
F_119 ( V_107 , & V_2 . V_22 -> V_78 -> V_108 ) ,
V_2 . V_22 -> V_106 ) ;
goto V_314;
}
F_138 ( & V_2 , V_299 , V_310 ) ;
V_44 = F_12 ( & V_2 ) ;
V_2 . V_22 -> V_237 = V_44 - V_2 . V_22 -> V_46 ;
if ( F_45 ( V_93 -> V_95 ) )
F_144 ( V_93 , & V_2 , * V_310 ) ;
V_313 = * V_310 ;
if ( V_299 )
V_313 -- ;
if ( ! V_299 ) {
V_93 -> V_236 = V_44 + V_313 - 1 ;
error = F_149 ( V_93 , & V_312 ) ;
if ( error == 0 ) {
struct V_315 * V_316 =
(struct V_315 * ) V_312 -> V_18 ;
F_109 ( V_93 -> V_151 , V_312 ) ;
V_316 -> V_317 = V_316 -> V_318 =
F_82 ( V_93 -> V_236 ) ;
F_93 ( V_312 ) ;
}
}
if ( V_2 . V_22 -> V_79 < * V_310 ) {
F_5 ( L_20 , * V_310 ) ;
goto V_314;
}
V_2 . V_22 -> V_79 -= * V_310 ;
...
F_150 ( V_75 , 0 , - ( T_9 ) * V_310 , V_299 ? 1 : 0 ) ;
if ( V_299 )
F_151 ( V_75 , V_44 , * V_310 ) ;
F_152 ( V_93 , * V_310 , V_93 -> V_133 . V_319 , V_93 -> V_133 . V_320 ) ;
V_2 . V_22 -> V_181 -= * V_310 ;
F_153 ( V_93 , V_2 . V_22 , V_44 , * V_310 ,
V_299 ? V_301 : V_302 ) ;
* V_309 = V_44 ;
return 0 ;
V_314:
...
void F_154 ( struct V_92 * V_93 , T_2 V_303 , T_4 V_304 , int V_321 )
{
struct V_74 * V_75 = F_70 ( & V_93 -> V_133 ) ;
struct V_69 * V_22 ;
V_22 = F_139 ( V_75 , V_303 , V_304 , V_61 ) ;
if ( ! V_22 )
return;
F_153 ( V_93 , V_22 , V_303 , V_304 , V_61 ) ;
V_22 -> V_79 += V_304 ;
V_22 -> V_147 &= ~ V_223 ;
...
if ( V_321 || V_93 -> V_322 )
F_155 ( V_93 , V_303 , V_304 ) ;
}
void F_156 ( struct V_92 * V_93 , T_2 V_303 , T_4 V_304 )
{
struct V_74 * V_75 = F_70 ( & V_93 -> V_133 ) ;
F_154 ( V_93 , V_303 , V_304 , 1 ) ;
F_150 ( V_75 , 0 , + V_304 , 0 ) ;
F_152 ( V_93 , - ( T_9 ) V_304 , V_93 -> V_133 . V_319 , V_93 -> V_133 . V_320 ) ;
}
...
struct V_74 * V_75 = F_70 ( V_123 ) ;
struct V_69 * V_22 ;
T_2 V_323 = V_93 -> V_238 ;
V_22 = F_139 ( V_75 , V_323 , 1 , V_176 ) ;
if ( ! V_22 )
return;
F_153 ( V_93 , V_22 , V_323 , 1 , V_176 ) ;
F_109 ( V_22 -> V_113 , V_22 -> V_78 [ 0 ] . V_17 ) ;
F_80 ( V_22 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_84 ( V_22 -> V_143 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_85 ( V_22 , 1 ) ;
}
static void F_158 ( struct V_69 * V_22 , T_2 V_323 )
{
struct V_74 * V_75 = V_22 -> V_55 ;
struct V_69 * V_324 ;
V_324 = F_139 ( V_75 , V_323 , 1 , V_61 ) ;
if ( ! V_324 )
return;
F_159 ( V_75 , V_22 == V_324 ) ;
if ( ! V_22 -> V_80 )
F_7 ( V_22 ) ;
V_22 -> V_80 -- ;
V_22 -> V_79 ++ ;
...
F_152 ( V_93 , - 1 , V_93 -> V_133 . V_319 , V_93 -> V_133 . V_320 ) ;
F_155 ( V_93 , V_93 -> V_238 , 1 ) ;
}
int F_161 ( struct V_74 * V_75 , T_2 V_325 , unsigned int type )
{
struct V_69 * V_22 ;
struct V_152 V_326 ;
int error = - V_48 ;
V_22 = F_27 ( V_75 , V_325 , 1 ) ;
if ( ! V_22 )
goto V_139;
error = F_77 ( V_22 -> V_113 , V_155 , 0 , & V_326 ) ;
if ( error )
goto V_139;
if ( F_137 ( V_22 , V_325 ) != type )
error = - V_327 ;
F_78 ( & V_326 ) ;
V_139:
return error ;
}
void F_162 ( struct V_92 * V_93 , struct V_328 * V_329 ,
T_2 V_44 )
{
struct V_74 * V_75 = F_70 ( & V_93 -> V_133 ) ;
struct V_69 * V_22 ;
...
V_93 -> V_288 = V_22 ;
for ( V_77 = 0 ; V_77 < V_329 -> V_332 ; V_77 ++ )
if ( V_329 -> V_333 [ V_77 ] == V_22 )
return;
if ( V_329 -> V_332 == V_329 -> V_334 ) {
V_330 = V_329 -> V_334 + 10 ;
V_31 = F_60 ( V_330 , sizeof( struct V_69 * ) ,
V_97 | V_305 ) ;
if ( V_329 -> V_333 ) {
memcpy ( V_31 , V_329 -> V_333 ,
V_329 -> V_334 * sizeof( struct V_69 * ) ) ;
F_36 ( V_329 -> V_333 ) ;
}
V_329 -> V_334 = V_330 ;
V_329 -> V_333 = V_31 ;
}
V_329 -> V_333 [ V_329 -> V_332 ++ ] = V_22 ;
}
void F_163 ( struct V_328 * V_329 , unsigned int V_30 )
{
unsigned int V_77 ;
V_329 -> V_331 = F_60 ( V_329 -> V_332 , sizeof( struct V_152 ) ,
V_97 | V_305 ) ;
for ( V_77 = 0 ; V_77 < V_329 -> V_332 ; V_77 ++ )
F_164 ( V_329 -> V_333 [ V_77 ] -> V_113 ,
V_30 , 0 ,
& V_329 -> V_331 [ V_77 ] ) ;
}
void F_165 ( struct V_328 * V_329 )
{
unsigned int V_77 ;
F_36 ( V_329 -> V_333 ) ;
if ( V_329 -> V_331 ) {
for ( V_77 = 0 ; V_77 < V_329 -> V_332 ; V_77 ++ )
F_166 ( & V_329 -> V_331 [ V_77 ] ) ;
F_36 ( V_329 -> V_331 ) ;
V_329 -> V_331 = NULL ;
}
}
