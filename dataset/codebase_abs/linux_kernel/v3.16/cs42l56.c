...
static void F_20 ( struct V_134 * V_135 )
{
struct V_64 * V_65 =
F_21 ( V_135 , struct V_64 , V_136 ) ;
...
static int F_26 ( struct V_144 * V_2 , unsigned int type ,
unsigned int V_145 , int V_146 )
{
struct V_62 * V_63 = F_27 ( V_2 ) ;
struct V_64 * V_65 = F_6 ( V_63 ) ;
F_22 ( V_63 -> V_2 , L_6 , V_145 , V_146 ) ;
switch ( V_145 ) {
case V_147 :
if ( V_146 )
V_146 = 261 ;
...
long int time ;
int V_123 ;
V_123 = F_31 ( V_151 , 10 , & time ) ;
if ( V_123 != 0 )
return V_123 ;
F_32 ( V_65 -> V_153 , V_154 , V_148 , time ) ;
return V_152 ;
}
...
struct V_64 * V_65 = F_6 ( V_63 ) ;
int V_123 ;
V_65 -> V_153 = F_34 ( V_63 -> V_2 ) ;
if ( ! V_65 -> V_153 ) {
F_12 ( V_63 -> V_2 , L_7 ) ;
return;
}
F_35 ( & V_65 -> V_136 , F_20 ) ;
V_65 -> V_140 = 0 ;
V_65 -> V_153 -> V_155 = L_8 ;
V_65 -> V_153 -> V_156 = F_36 ( V_63 -> V_2 ) ;
V_65 -> V_153 -> V_157 . V_158 = V_159 ;
V_65 -> V_153 -> V_160 [ 0 ] = F_37 ( V_154 ) ;
V_65 -> V_153 -> V_161 [ 0 ] = F_37 ( V_147 ) | F_37 ( V_148 ) ;
V_65 -> V_153 -> V_162 = F_26 ;
V_65 -> V_153 -> V_2 . V_163 = V_63 -> V_2 ;
F_38 ( V_65 -> V_153 , V_63 ) ;
V_123 = F_39 ( V_65 -> V_153 ) ;
if ( V_123 != 0 ) {
V_65 -> V_153 = NULL ;
F_12 ( V_63 -> V_2 , L_9 ) ;
}
V_123 = F_40 ( V_63 -> V_2 , & V_164 ) ;
if ( V_123 != 0 ) {
F_12 ( V_63 -> V_2 , L_10 ,
V_123 ) ;
}
...
F_41 ( V_63 ) ;
F_13 ( V_63 , V_131 ) ;
F_46 ( F_4 ( V_65 -> V_133 ) , V_65 -> V_133 ) ;
return 0 ;
}
static int F_47 ( struct V_166 * V_166 ,
struct V_167 * V_168 )
{
...
if ( F_48 ( V_170 , L_14 ) )
V_168 -> V_176 = true ;
if ( F_49 ( V_170 , L_15 , & V_172 ) >= 0 )
V_168 -> V_177 = V_172 ;
if ( F_49 ( V_170 , L_16 , & V_172 ) >= 0 )
V_168 -> V_178 = V_172 ;
if ( F_49 ( V_170 , L_17 , & V_172 ) >= 0 )
V_168 -> V_179 = V_172 ;
if ( F_49 ( V_170 , L_18 , & V_172 ) >= 0 )
V_168 -> V_180 = V_172 ;
if ( F_49 ( V_170 , L_18 , & V_172 ) >= 0 )
V_168 -> V_181 = V_172 ;
V_168 -> V_182 = F_50 ( V_170 , L_19 , 0 ) ;
return 0 ;
}
static int F_51 ( struct V_166 * V_166 ,
...
return - V_188 ;
V_65 -> V_2 = & V_166 -> V_2 ;
V_65 -> V_132 = F_54 ( V_166 , & V_189 ) ;
if ( F_55 ( V_65 -> V_132 ) ) {
V_123 = F_56 ( V_65 -> V_132 ) ;
...
F_61 ( V_65 -> V_132 , true ) ;
V_123 = F_62 ( V_65 -> V_132 , V_4 , & V_3 ) ;
V_184 = V_3 & V_193 ;
if ( V_184 != V_194 ) {
F_12 ( & V_166 -> V_2 ,
L_26 ,
...
F_63 ( & V_166 -> V_2 , L_28 ,
V_185 , V_186 ) ;
F_61 ( V_65 -> V_132 , false ) ;
if ( V_65 -> V_168 . V_173 )
F_64 ( V_65 -> V_132 , V_29 ,
V_198 , 1 ) ;
if ( V_65 -> V_168 . V_175 )
F_64 ( V_65 -> V_132 , V_29 ,
V_199 , 1 ) ;
...
V_201 , 1 ) ;
if ( V_65 -> V_168 . V_177 )
F_64 ( V_65 -> V_132 , V_32 ,
V_202 ,
V_65 -> V_168 . V_177 ) ;
if ( V_65 -> V_168 . V_178 )
F_64 ( V_65 -> V_132 , V_11 ,
V_203 ,
V_65 -> V_168 . V_178 ) ;
if ( V_65 -> V_168 . V_181 )
F_64 ( V_65 -> V_132 , V_30 ,
V_204 ,
V_65 -> V_168 . V_181 ) ;
if ( V_65 -> V_168 . V_180 )
F_64 ( V_65 -> V_132 , V_30 ,
...
static int F_66 ( struct V_166 * V_209 )
{
struct V_64 * V_65 = F_67 ( V_209 ) ;
F_68 ( & V_209 -> V_2 ) ;
F_17 ( F_4 ( V_65 -> V_133 ) ,
V_65 -> V_133 ) ;
return 0 ;
