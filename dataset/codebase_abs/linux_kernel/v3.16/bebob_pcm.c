...
static int
F_37 ( struct V_35 * V_36 , int V_75 )
{
struct V_33 * V_34 = V_36 -> V_59 ;
switch ( V_75 ) {
case V_76 :
...
static int
F_39 ( struct V_35 * V_36 , int V_75 )
{
struct V_33 * V_34 = V_36 -> V_59 ;
switch ( V_75 ) {
case V_76 :
...
static T_1
F_40 ( struct V_35 * V_79 )
{
struct V_33 * V_34 = V_79 -> V_59 ;
return F_41 ( & V_34 -> V_53 ) ;
}
static T_1
F_42 ( struct V_35 * V_79 )
{
struct V_33 * V_34 = V_79 -> V_59 ;
...
struct V_80 * V_19 ;
int V_41 ;
V_41 = F_44 ( V_34 -> V_81 , V_34 -> V_81 -> V_82 , 0 , 1 , 1 , & V_19 ) ;
if ( V_41 < 0 )
goto V_58;
V_19 -> V_59 = V_34 ;
snprintf ( V_19 -> V_83 , sizeof( V_19 -> V_83 ) ,
L_2 , V_34 -> V_81 -> V_84 ) ;
F_45 ( V_19 , V_85 , & V_86 ) ;
F_45 ( V_19 , V_50 , & V_87 ) ;
V_58:
