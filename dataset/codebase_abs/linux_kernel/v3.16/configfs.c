...
if ( V_20 [ V_21 - 1 ] == '\n' || V_20 [ V_21 - 1 ] == '\0' )
-- V_21 ;
V_121 = F_58 ( V_21 , V_15 ) ;
if ( ! V_121 )
return - V_16 ;
memcpy ( V_121 , V_20 , V_21 ) ;
if ( V_24 -> V_110 )
F_14 ( V_24 -> V_110 ) ;
F_5 ( V_108 -> V_120 ) ;
V_108 -> V_120 = V_121 ;
...
char * V_126 ;
F_84 ( V_127 ) ;
F_85 ( V_127 , struct V_107 , V_108 , 1 ) ;
F_85 ( V_127 , struct V_124 , V_125 , 1 ) ;
V_126 = F_58 ( F_86 ( V_127 ) , V_15 ) ;
if ( ! V_126 )
return F_48 ( - V_16 ) ;
V_108 = F_87 ( V_126 , V_127 , V_108 ) ;
V_125 = F_87 ( V_126 , V_127 , V_125 ) ;
V_24 = F_18 ( V_35 , struct V_109 , V_35 ) ;
V_125 -> V_128 = & V_129 ;
V_125 -> V_130 = V_131 ;
V_125 -> V_132 = V_24 -> V_133 ;
F_88 ( & V_108 -> V_34 , V_1 , V_125 ) ;
...
static void F_89 ( struct V_52 * V_35 , struct V_33 * V_34 )
{
struct V_107 * V_108 = F_76 ( V_34 ) ;
...
static T_2 F_90 ( struct V_109 * V_24 ,
char * V_20 )
{
...
static T_2 F_93 ( struct V_109 * V_24 ,
char * V_20 )
{
...
F_84 ( V_127 ) ;
F_85 ( V_127 , struct V_52 * , V_142 , 2 ) ;
F_85 ( V_127 , struct V_52 , V_103 , 1 ) ;
F_85 ( V_127 , struct V_52 * , V_143 ,
V_139 + 1 ) ;
F_85 ( V_127 , struct V_124 , V_144 , 1 ) ;
F_85 ( V_127 , struct V_124 , V_145 , 1 ) ;
char * V_126 = F_58 ( F_86 ( V_127 ) , V_15 ) ;
if ( ! V_126 )
return - V_16 ;
V_142 = F_87 ( V_126 , V_127 , V_142 ) ;
V_103 = F_87 ( V_126 , V_127 , V_103 ) ;
V_144 = F_87 ( V_126 , V_127 , V_144 ) ;
V_143 = F_87 ( V_126 , V_127 , V_143 ) ;
V_145 = F_87 ( V_126 , V_127 , V_145 ) ;
V_138 -> V_83 = V_142 ;
V_144 -> V_132 = V_133 ;
...
static int F_96 ( struct V_51 * V_23 )
{
F_25 ( 1 ) ;
return - V_8 ;
}
...
F_98 (f, tmp, &c->functions, list) {
F_99 ( & V_56 -> V_47 , & V_44 -> V_59 ) ;
if ( V_56 -> V_152 ) {
F_100 ( & V_19 -> V_23 . V_153 -> V_154 , L_13
L_14 , V_56 -> V_1 , V_56 ) ;
...
static int F_101 ( struct V_159 * V_153 ,
struct V_160 * V_161 )
{
struct V_162 * V_28 = F_102 ( V_161 ) ;
...
V_10 = F_105 ( & V_19 -> V_23 , V_19 -> V_67 ,
V_170 ) ;
if ( F_32 ( V_10 ) ) {
V_7 = F_33 ( V_10 ) ;
goto V_165;
...
V_10 = F_105 ( & V_19 -> V_23 , V_44 -> V_67 , 1 ) ;
if ( F_32 ( V_10 ) ) {
V_7 = F_33 ( V_10 ) ;
goto V_165;
}
...
F_98 (f, tmp, &cfg->func_list, list) {
F_28 ( & V_56 -> V_47 ) ;
V_7 = F_106 ( V_45 , V_56 ) ;
if ( V_7 ) {
F_107 ( & V_56 -> V_47 , & V_44 -> V_59 ) ;
goto V_177;
}
}
F_108 ( V_23 -> V_153 ) ;
...
static void F_111 ( struct V_159 * V_153 )
{
struct V_51 * V_23 ;
struct V_18 * V_19 ;
V_23 = F_112 ( V_153 ) ;
...
& V_144 ) ;
V_19 -> V_28 . V_182 = F_96 ;
V_19 -> V_28 . V_152 = F_96 ;
...
static void F_117 ( struct V_52 * V_35 , struct V_33 * V_34 )
{
F_55 ( V_34 ) ;
}
void F_118 ( struct V_33 * V_34 )
{
struct V_18 * V_19 = F_17 ( V_34 ) ;
F_11 ( V_19 ) ;
}
