...
V_43 = 1 ;
V_38 = F_115 ( V_77 , V_8 , V_95 , & V_25 , V_43 ) ;
if ( V_38 > 0 ) {
F_104 ( V_95 ) ;
return - V_117 ;
} else if ( V_38 < 0 ) {
...
static inline int F_117 ( struct V_76 * V_77 ,
struct V_7 * V_8 ,
struct V_94 * V_95 ,
struct V_2 * V_35 )
{
...
if ( V_38 )
return V_38 ;
V_38 = F_117 ( V_77 , V_35 -> V_8 , V_95 , V_35 ) ;
return V_38 ;
}
...
struct V_7 * V_8 )
{
return F_119 ( V_77 , V_8 , - 1 ) ;
}
int F_124 ( struct V_76 * V_77 ,
struct V_7 * V_8 , int V_128 )
{
return F_119 ( V_77 , V_8 , V_128 ) ;
}
int F_125 ( struct V_76 * V_77 ,
struct V_32 * V_32 )
{
...
V_38 = F_118 ( V_77 , V_95 , V_6 ) ;
F_48 ( V_6 ) ;
F_122 ( V_95 ) ;
V_77 -> V_82 = V_82 ;
return V_38 ;
}
int F_126 ( struct V_32 * V_32 )
{
struct V_76 * V_77 ;
struct V_2 * V_6 = F_11 ( V_32 ) ;
struct V_94 * V_95 ;
...
static void F_133 ( struct V_134 * V_135 )
{
struct V_136 * V_137 ;
struct V_29 * V_31 ;
struct V_76 * V_77 ;
...
struct V_78 * V_82 ;
int V_138 = 0 ;
V_137 = F_134 ( V_135 , struct V_136 , V_135 ) ;
V_31 = V_137 -> V_31 ;
V_95 = F_120 () ;
if ( ! V_95 )
goto V_51;
...
static int F_136 ( struct V_29 * V_31 ,
struct V_7 * V_8 , int V_128 )
{
struct V_136 * V_137 ;
...
return - V_5 ;
V_137 -> V_31 = V_31 ;
F_137 ( & V_137 -> V_135 , F_133 ,
NULL , NULL ) ;
V_137 -> V_128 = V_128 ;
F_138 ( V_8 -> V_30 -> V_141 , & V_137 -> V_135 ) ;
return 0 ;
}
...
static int F_140 ( struct V_29 * V_31 , int V_71 )
{
int V_142 = F_46 ( & V_31 -> V_72 ) ;
if ( V_142 < V_71 || V_142 >= V_71 + V_74 )
return 1 ;
if ( F_46 ( & V_31 -> V_70 ) < V_73 )
return 1 ;
return 0 ;
...
if ( F_46 ( & V_31 -> V_70 ) < V_73 )
return;
if ( F_46 ( & V_31 -> V_70 ) >= V_143 ) {
int V_71 ;
int V_38 ;
V_71 = F_46 ( & V_31 -> V_72 ) ;
V_38 = F_136 ( V_31 , V_8 , 0 ) ;
if ( V_38 )
return;
F_142 ( V_31 -> V_75 ,
F_140 ( V_31 , V_71 ) ) ;
...
struct V_7 * V_8 , const char * V_144 ,
int V_145 , struct V_32 * V_146 ,
...
if ( F_128 ( V_6 ) )
return F_129 ( V_6 ) ;
V_61 = F_51 ( sizeof( * V_151 ) + V_145 ) ;
if ( ! V_61 ) {
V_38 = - V_5 ;
goto V_152;
}
V_61 -> V_25 . V_27 = F_13 ( V_146 ) ;
F_114 ( & V_61 -> V_25 , V_26 ) ;
V_61 -> V_25 . V_28 = V_149 ;
V_151 = (struct V_150 * ) V_61 -> V_112 ;
V_151 -> V_153 = * V_148 ;
F_144 ( V_151 , V_77 -> V_154 ) ;
F_145 ( V_151 , 0 ) ;
F_146 ( V_151 , V_145 ) ;
F_147 ( V_151 , type ) ;
...
struct V_7 * V_8 , struct V_32 * V_146 ,
T_2 V_149 )
{
struct V_2 * V_35 ;
struct V_22 * V_54 ;
...
if ( F_128 ( V_35 ) )
return F_129 ( V_35 ) ;
V_155 . V_27 = F_13 ( V_146 ) ;
F_114 ( & V_155 , V_26 ) ;
V_155 . V_28 = V_149 ;
V_38 = F_150 ( V_8 , V_35 , & V_155 ) ;
if ( ! V_38 )
goto V_156;
V_54 = F_51 ( 0 ) ;
if ( ! V_54 ) {
...
void F_153 ( struct V_32 * V_32 , struct V_49 * V_158 ,
struct V_49 * V_159 )
{
struct V_2 * V_6 ;
struct V_22 * V_54 ;
...
while ( V_54 ) {
F_15 ( & V_54 -> V_10 ) ;
F_32 ( & V_54 -> V_160 , V_158 ) ;
V_54 = F_77 ( V_54 ) ;
}
V_54 = F_76 ( V_6 ) ;
while ( V_54 ) {
F_15 ( & V_54 -> V_10 ) ;
F_32 ( & V_54 -> V_160 , V_159 ) ;
V_54 = F_77 ( V_54 ) ;
}
F_44 ( & V_6 -> V_16 ) ;
F_35 ( & V_6 -> V_10 ) ;
}
void F_154 ( struct V_49 * V_158 ,
struct V_49 * V_159 )
{
struct V_22 * V_96 , * V_52 ;
...
return 0 ;
F_96 (curr, next, del_list, readdir_list) {
if ( V_96 -> V_25 . V_28 > V_149 )
break;
F_99 ( & V_96 -> V_160 ) ;
V_38 = ( V_96 -> V_25 . V_28 == V_149 ) ;
if ( F_45 ( & V_96 -> V_10 ) )
F_73 ( V_96 ) ;
if ( V_38 )
return 1 ;
...
F_96 (curr, next, ins_list, readdir_list) {
F_99 ( & V_96 -> V_160 ) ;
if ( V_96 -> V_25 . V_28 < V_162 -> V_166 ) {
if ( F_45 ( & V_96 -> V_10 ) )
F_73 ( V_96 ) ;
continue;
}
V_162 -> V_166 = V_96 -> V_25 . V_28 ;
V_163 = (struct V_150 * ) V_96 -> V_112 ;
V_144 = ( char * ) ( V_163 + 1 ) ;
V_145 = F_157 ( V_163 ) ;
V_165 = V_167 [ V_163 -> type ] ;
F_158 ( & V_153 , & V_163 -> V_153 ) ;
V_164 = ! F_159 ( V_162 , V_144 , V_145 ,
V_153 . V_27 , V_165 ) ;
if ( F_45 ( & V_96 -> V_10 ) )
F_73 ( V_96 ) ;
if ( V_164 )
...
struct V_32 * V_32 )
{
F_161 ( V_21 , F_162 ( V_32 ) ) ;
F_163 ( V_21 , F_164 ( V_32 ) ) ;
F_165 ( V_21 , F_12 ( V_32 ) -> V_168 ) ;
F_166 ( V_21 , V_32 -> V_169 ) ;
F_167 ( V_21 , V_32 -> V_170 ) ;
F_168 ( V_21 , F_169 ( V_32 ) ) ;
F_170 ( V_21 ,
F_12 ( V_32 ) -> V_171 ) ;
F_171 ( V_21 , V_32 -> V_172 ) ;
F_172 ( V_21 , V_77 -> V_154 ) ;
F_173 ( V_21 , V_32 -> V_173 ) ;
F_174 ( V_21 , F_12 ( V_32 ) -> V_12 ) ;
F_175 ( V_21 , 0 ) ;
F_176 ( F_177 ( V_21 ) ,
V_32 -> V_174 . V_175 ) ;
F_178 ( F_177 ( V_21 ) ,
...
int F_181 ( struct V_32 * V_32 , T_3 * V_179 )
{
struct V_2 * V_6 ;
struct V_121 * V_21 ;
struct V_180 * V_181 ;
...
F_184 ( V_32 , F_185 ( V_21 ) ) ;
F_186 ( V_32 , F_187 ( V_21 ) ) ;
V_32 -> V_169 = F_188 ( V_21 ) ;
F_189 ( V_32 , F_190 ( V_21 ) ) ;
F_191 ( V_32 , F_192 ( V_21 ) ) ;
F_12 ( V_32 ) -> V_171 = F_193 ( V_21 ) ;
V_32 -> V_172 = F_194 ( V_21 ) ;
V_32 -> V_173 = 0 ;
* V_179 = F_195 ( V_21 ) ;
F_12 ( V_32 ) -> V_12 = F_196 ( V_21 ) ;
V_181 = F_177 ( V_21 ) ;
V_32 -> V_174 . V_175 = F_197 ( V_181 ) ;
V_32 -> V_174 . V_176 = F_198 ( V_181 ) ;
V_181 = F_179 ( V_21 ) ;
V_32 -> V_177 . V_175 = F_197 ( V_181 ) ;
V_32 -> V_177 . V_176 = F_198 ( V_181 ) ;
V_181 = F_180 ( V_21 ) ;
V_32 -> V_178 . V_175 = F_197 ( V_181 ) ;
V_32 -> V_178 . V_176 = F_198 ( V_181 ) ;
...
static void F_201 ( struct V_2 * V_6 )
{
struct V_7 * V_8 = V_6 -> V_8 ;
...
for ( V_108 = 0 ; V_108 < V_186 ; V_108 ++ )
F_15 ( & V_185 [ V_108 ] -> V_10 ) ;
F_19 ( & V_8 -> V_36 ) ;
for ( V_108 = 0 ; V_108 < V_186 ; V_108 ++ ) {
F_201 ( V_185 [ V_108 ] ) ;
F_48 ( V_185 [ V_108 ] ) ;
