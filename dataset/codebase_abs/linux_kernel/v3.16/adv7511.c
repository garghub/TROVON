...
static int F_37 ( struct V_2 * V_3 , int V_53 )
{
struct V_1 * V_34 = F_1 ( V_3 ) ;
F_16 ( 1 , V_36 , V_3 , L_67 , V_24 , ( V_53 ? L_68 : L_69 ) ) ;
...
struct V_1 * V_34 = F_1 ( V_3 ) ;
F_16 ( 1 , V_36 , V_3 , L_5 , V_24 ) ;
if ( ! F_39 ( V_98 , & V_99 , NULL , NULL ) )
return - V_59 ;
F_40 ( V_98 , & V_99 , 0 , NULL , NULL ) ;
V_98 -> V_56 . V_16 &= ~ V_100 ;
V_34 -> V_55 = * V_98 ;
F_23 ( V_3 , V_34 -> V_66 ) ;
F_22 ( V_3 ) ;
return 0 ;
...
if ( V_98 -> V_102 != 0 )
return - V_59 ;
return F_43 ( V_98 , & V_99 , NULL , NULL ) ;
}
...
static int F_45 ( struct V_2 * V_3 , int V_53 )
{
F_16 ( 1 , V_36 , V_3 , L_67 , V_24 , ( V_53 ? L_68 : L_69 ) ) ;
if ( V_53 )
...
static int F_46 ( struct V_2 * V_3 , T_6 V_105 )
{
T_6 V_78 ;
switch ( V_105 ) {
...
static int F_47 ( struct V_2 * V_3 , T_6 V_105 )
{
T_6 V_106 ;
switch ( V_105 ) {
case 32000 : V_106 = 0x30 ; break;
case 44100 : V_106 = 0x00 ; break;
case 48000 : V_106 = 0x20 ; break;
case 88200 : V_106 = 0x80 ; break;
case 96000 : V_106 = 0xa0 ; break;
case 176400 : V_106 = 0xc0 ; break;
case 192000 : V_106 = 0xe0 ; break;
default:
return - V_59 ;
}
F_13 ( V_3 , 0x15 , 0xf , V_106 ) ;
return 0 ;
}
static int F_48 ( struct V_2 * V_3 , T_6 V_107 , T_6 V_108 , T_6 V_109 )
{
...
static int F_49 ( struct V_2 * V_3 , struct V_110 * V_70 )
{
struct V_1 * V_34 = F_1 ( V_3 ) ;
if ( V_70 -> V_102 != 0 )
return - V_59 ;
...
return - V_59 ;
if ( ! V_34 -> V_70 . V_74 ) {
F_16 ( 1 , V_36 , V_3 , L_70 ) ;
return - V_111 ;
}
if ( V_70 -> V_112 >= V_34 -> V_70 . V_74 * 2 )
return - V_113 ;
if ( ( V_70 -> V_75 + V_70 -> V_112 ) >= V_34 -> V_70 . V_74 * 2 )
V_70 -> V_75 = V_34 -> V_70 . V_74 * 2 - V_70 -> V_112 ;
memcpy ( V_70 -> V_70 , & V_34 -> V_70 . V_13 [ V_70 -> V_112 * 128 ] ,
128 * V_70 -> V_75 ) ;
return 0 ;
}
...
V_34 -> V_102 . V_16 = V_168 ;
V_35 = F_71 ( & V_3 -> V_169 , 1 , & V_34 -> V_102 , 0 ) ;
if ( V_35 )
goto V_166;
