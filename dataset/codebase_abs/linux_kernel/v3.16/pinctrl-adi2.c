...
static void F_53 ( struct V_72 * V_73 , unsigned V_84 ,
unsigned V_85 )
{
struct V_74 * V_75 = F_45 ( V_73 ) ;
struct V_5 * V_6 ;
...
static int F_58 ( struct V_90 * V_48 , unsigned V_14 )
{
return F_59 ( V_48 -> V_49 + V_14 ) ;
}
static void F_60 ( struct V_90 * V_48 , unsigned V_14 )
{
F_61 ( V_48 -> V_49 + V_14 ) ;
}
static int F_62 ( struct V_90 * V_48 , unsigned V_14 )
{
struct V_5 * V_6 ;
unsigned long V_24 ;
...
static void F_63 ( struct V_90 * V_48 , unsigned V_14 ,
int V_91 )
{
...
static int F_66 ( struct V_90 * V_48 , unsigned V_14 )
{
struct V_5 * V_6 = F_51 ( V_48 , struct V_5 , V_48 ) ;
if ( V_6 -> V_93 >= 0 )
...
static int F_68 ( struct V_10 * V_12 , bool V_57 , T_1 V_94 ,
struct V_70 * V_71 )
{
struct V_25 * V_17 = V_12 -> V_17 ;
T_2 V_95 ;
...
struct V_101 * V_102 ;
struct V_10 * V_12 ;
V_12 = F_70 ( V_100 , sizeof( struct V_10 ) , V_103 ) ;
if ( ! V_12 ) {
F_71 ( V_100 , L_3 ) ;
return - V_104 ;
}
V_102 = F_72 ( V_98 , V_105 , 0 ) ;
V_12 -> V_49 = F_73 ( V_100 , V_102 ) ;
if ( F_74 ( V_12 -> V_49 ) )
return F_75 ( V_12 -> V_49 ) ;
V_12 -> V_17 = (struct V_25 * ) V_12 -> V_49 ;
V_102 = F_72 ( V_98 , V_106 , 0 ) ;
if ( ! V_102 ) {
F_71 ( V_100 , L_4 ) ;
return - V_35 ;
}
...
F_78 ( V_12 -> V_34 , F_37 ) ;
F_79 ( V_12 -> V_34 , V_12 ) ;
F_80 ( & V_12 -> V_109 , & V_110 ) ;
return 0 ;
}
static int F_81 ( struct V_97 * V_98 )
{
struct V_10 * V_12 = F_82 ( V_98 ) ;
F_83 ( & V_12 -> V_109 ) ;
F_84 ( V_12 -> V_34 , V_111 ) ;
return 0 ;
}
...
if ( ! V_121 )
return - V_55 ;
V_6 = F_70 ( V_100 , sizeof( struct V_5 ) , V_103 ) ;
if ( ! V_6 ) {
F_71 ( V_100 , L_3 ) ;
return - V_104 ;
}
V_102 = F_72 ( V_98 , V_105 , 0 ) ;
V_6 -> V_49 = F_73 ( V_100 , V_102 ) ;
if ( F_74 ( V_6 -> V_49 ) )
...
V_6 -> V_48 . V_134 = F_66 ;
if ( V_121 -> V_135 > 0 )
V_6 -> V_48 . V_49 = V_121 -> V_135 ;
else
V_6 -> V_48 . V_49 = V_124 ;
V_6 -> V_48 . V_136 = V_6 -> V_116 ;
...
V_121 -> V_138 ) ;
V_122 [ V_123 - 1 ] = 0 ;
V_40 = F_93 ( & V_6 -> V_48 , V_122 ,
0 , V_121 -> V_139 , V_6 -> V_116 ) ;
if ( V_40 ) {
F_71 ( & V_98 -> V_100 , L_10 ,
V_122 ) ;
goto V_140;
}
F_80 ( & V_6 -> V_109 , & V_141 ) ;
return 0 ;
V_140:
V_125 = F_94 ( & V_6 -> V_48 ) ;
V_137:
...
static int F_96 ( struct V_97 * V_98 )
{
struct V_5 * V_6 = F_82 ( V_98 ) ;
int V_40 ;
T_1 V_14 ;
F_83 ( & V_6 -> V_109 ) ;
F_97 ( & V_6 -> V_48 ) ;
...
{
struct V_74 * V_75 ;
V_75 = F_70 ( & V_98 -> V_100 , sizeof( * V_75 ) , V_103 ) ;
if ( ! V_75 )
return - V_104 ;
V_75 -> V_100 = & V_98 -> V_100 ;
F_100 ( & V_75 -> V_76 ) ;
V_142 . V_81 = V_75 -> V_76 -> V_81 ;
V_142 . V_143 = V_75 -> V_76 -> V_143 ;
V_75 -> V_144 = F_101 ( & V_142 , & V_98 -> V_100 , V_75 ) ;
if ( ! V_75 -> V_144 ) {
F_71 ( & V_98 -> V_100 , L_11 ) ;
return - V_55 ;
}
F_77 ( V_98 , V_75 ) ;
return 0 ;
}
static int F_102 ( struct V_97 * V_98 )
{
struct V_74 * V_75 = F_82 ( V_98 ) ;
F_103 ( V_75 -> V_144 ) ;
return 0 ;
}
