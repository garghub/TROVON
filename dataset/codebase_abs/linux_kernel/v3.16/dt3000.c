...
struct V_1 * V_2 = V_39 ;
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_24 * V_25 = V_2 -> V_40 ;
unsigned int V_8 ;
if ( ! V_2 -> V_41 )
return V_42 ;
V_8 = F_3 ( V_5 -> V_9 + V_43 ) ;
if ( V_8 & V_44 ) {
F_9 ( V_2 , V_25 ) ;
V_25 -> V_45 -> V_46 |= V_47 ;
}
if ( V_8 & ( V_48 | V_49 ) )
V_25 -> V_45 -> V_46 |= V_50 | V_51 ;
V_52 ++ ;
if ( V_52 >= 10 )
V_25 -> V_45 -> V_46 |= V_51 ;
F_13 ( V_2 , V_25 ) ;
...
if ( V_3 -> V_70 == V_71 ) {
V_67 = V_3 -> V_77 ;
F_14 ( 100 , & V_67 , V_3 -> V_83 & V_84 ) ;
V_66 |= F_18 ( & V_3 -> V_77 , V_67 ) ;
}
if ( V_3 -> V_72 == V_71 ) {
V_67 = V_3 -> V_79 ;
F_14 ( 50 , & V_67 , V_3 -> V_83 & V_84 ) ;
V_66 |= F_18 ( & V_3 -> V_79 , V_67 ) ;
if ( V_3 -> V_70 == V_71 ) {
V_67 = V_3 -> V_79 * V_3 -> V_80 ;
V_66 |= F_19 ( & V_3 -> V_77 ,
V_67 ) ;
}
}
...
V_22 [ V_7 ] = F_6 ( V_2 , V_35 , V_18 , V_19 ) ;
return V_7 ;
}
...
return - V_118 ;
if ( V_112 -> V_38 ) {
V_103 = F_40 ( V_112 -> V_38 , F_12 , V_119 ,
V_2 -> V_116 , V_2 ) ;
if ( V_103 == 0 )
V_2 -> V_38 = V_112 -> V_38 ;
}
...
static int F_46 ( struct V_111 * V_2 ,
const struct V_149 * V_150 )
{
return F_47 ( V_2 , & V_151 , V_150 -> V_152 ) ;
}
