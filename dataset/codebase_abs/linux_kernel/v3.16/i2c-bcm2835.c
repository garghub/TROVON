...
int V_53 ;
struct V_48 * V_49 ;
V_2 = F_18 ( & V_57 -> V_43 , sizeof( * V_2 ) , V_63 ) ;
if ( ! V_2 )
return - V_64 ;
F_19 ( V_57 , V_2 ) ;
V_2 -> V_43 = & V_57 -> V_43 ;
F_20 ( & V_2 -> V_18 ) ;
V_59 = F_21 ( V_57 , V_65 , 0 ) ;
V_2 -> V_5 = F_22 ( & V_57 -> V_43 , V_59 ) ;
if ( F_23 ( V_2 -> V_5 ) )
return F_24 ( V_2 -> V_5 ) ;
V_2 -> V_66 = F_25 ( & V_57 -> V_43 , NULL ) ;
if ( F_23 ( V_2 -> V_66 ) ) {
F_12 ( & V_57 -> V_43 , L_3 ) ;
return F_24 ( V_2 -> V_66 ) ;
}
V_53 = F_26 ( V_57 -> V_43 . V_67 , L_4 ,
& V_61 ) ;
if ( V_53 < 0 ) {
F_27 ( & V_57 -> V_43 ,
L_5 ) ;
...
V_62 = F_28 ( F_29 ( V_2 -> V_66 ) , V_61 ) ;
if ( V_62 & 1 )
V_62 ++ ;
F_1 ( V_2 , V_68 , V_62 ) ;
V_60 = F_21 ( V_57 , V_69 , 0 ) ;
if ( ! V_60 ) {
F_12 ( & V_57 -> V_43 , L_6 ) ;
return - V_70 ;
}
V_2 -> V_60 = V_60 -> V_71 ;
V_53 = F_30 ( V_2 -> V_60 , F_7 , V_72 ,
F_31 ( & V_57 -> V_43 ) , V_2 ) ;
if ( V_53 ) {
F_12 ( & V_57 -> V_43 , L_7 ) ;
return - V_70 ;
...
V_49 -> V_74 = V_75 ;
V_49 -> V_76 = V_77 | V_78 ;
F_33 ( V_49 -> V_79 , L_8 , sizeof( V_49 -> V_79 ) ) ;
V_49 -> V_80 = & V_81 ;
V_49 -> V_43 . V_82 = & V_57 -> V_43 ;
V_49 -> V_43 . V_67 = V_57 -> V_43 . V_67 ;
F_1 ( V_2 , V_29 , 0 ) ;
V_53 = F_34 ( V_49 ) ;
if ( V_53 )
F_35 ( V_2 -> V_60 , V_2 ) ;
