...
int F_89 ( struct V_262 * V_262 , struct V_263 * V_264 )
{
struct V_1 * V_2 = F_90 ( V_262 , V_264 -> V_265 ) ;
void T_2 * V_10 = V_264 -> V_266 ;
T_1 V_72 ;
int V_102 ;
V_21 V_267 ;
if ( ! V_2 || ! F_91 ( V_2 ) )
...
break;
default:
if ( ! F_92 ( V_262 -> V_279 , V_280 ) )
return - V_281 ;
}
if ( V_2 -> V_40 -> V_282 ) {
V_102 = V_2 -> V_40 -> V_282 ( V_2 ) ;
if ( V_102 < 0 )
return V_102 ;
}
V_267 = V_2 -> V_17 ;
