...
int F_40 ( struct V_5 * V_6 , struct V_53 * V_54 )
{
struct V_55 * V_56 [ V_98 ] ;
T_2 V_99 , V_100 ;
const char * V_60 = L_30 ;
if ( F_24 ( V_54 , V_98 ,
V_101 , V_56 , V_60 ) )
return - V_14 ;
V_99 = F_25 ( V_56 [ V_102 ] ) ;
V_100 = F_25 ( V_56 [ V_103 ] ) ;
if ( V_100 != V_99 )
F_14 ( L_31 ,
V_30 , V_99 , V_100 ) ;
F_29 ( & V_19 , V_54 -> V_10 -> V_17 ) ;
...
{
struct V_7 * V_8 = NULL ;
int V_4 = F_37 ( V_54 -> V_10 -> V_97 ) ;
struct V_55 * V_56 [ V_104 ] ;
T_2 V_11 ;
T_3 V_67 ;
const char * V_60 = L_32 ;
if ( F_24 ( V_54 , V_104 ,
V_105 , V_56 , V_60 ) )
return - V_14 ;
V_11 = F_25 ( V_56 [ V_106 ] ) ;
V_67 = F_28 ( V_56 [ V_107 ] ) ;
F_14 ( L_33 ,
V_30 , V_11 , V_67 , V_4 ) ;
V_8 = F_26 ( V_11 ) ;
if ( ! V_8 ) {
