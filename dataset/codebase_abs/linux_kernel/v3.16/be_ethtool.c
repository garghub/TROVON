...
static void F_57 ( struct V_1 * V_2 , struct V_199 * V_200 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_6 -> V_201 & V_202 ) {
V_200 -> V_149 |= V_203 ;
...
static int F_58 ( struct V_1 * V_2 , struct V_199 * V_200 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
V_95 * V_26 )
{
F_64 ( V_6 , V_6 -> V_186 , V_213 , 1 ) ;
* V_26 = F_65 ( V_6 , V_6 -> V_186 ,
V_213 , 1500 , 2 , 0xabc ) ;
F_64 ( V_6 , V_6 -> V_186 , V_214 , 1 ) ;
return * V_26 ;
}
static void F_66 ( struct V_1 * V_2 , struct V_215 * V_216 ,
V_95 * V_71 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_26 ;
...
if ( F_63 ( V_6 , V_222 , & V_71 [ 0 ] ) != 0 )
V_216 -> V_219 |= V_220 ;
if ( F_63 ( V_6 , V_223 , & V_71 [ 1 ] ) != 0 )
V_216 -> V_219 |= V_220 ;
...
switch ( V_246 ) {
case V_247 :
if ( V_6 -> V_248 . V_249 & V_250 )
V_71 |= V_251 | V_252 ;
if ( V_6 -> V_248 . V_249 & V_253 )
V_71 |= V_254 | V_255 ;
break;
case V_256 :
if ( V_6 -> V_248 . V_249 & V_250 )
V_71 |= V_251 | V_252 ;
if ( V_6 -> V_248 . V_249 & V_257 )
V_71 |= V_254 | V_255 ;
break;
case V_258 :
if ( V_6 -> V_248 . V_249 & V_259 )
V_71 |= V_251 | V_252 ;
if ( V_6 -> V_248 . V_249 & V_260 )
V_71 |= V_254 | V_255 ;
break;
case V_261 :
if ( V_6 -> V_248 . V_249 & V_259 )
V_71 |= V_251 | V_252 ;
if ( V_6 -> V_248 . V_249 & V_262 )
V_71 |= V_254 | V_255 ;
break;
}
return V_71 ;
}
static int F_77 ( struct V_1 * V_2 , struct V_263 * V_264 ,
T_1 * V_265 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ! F_78 ( V_6 ) ) {
...
switch ( V_264 -> V_264 ) {
case V_266 :
V_264 -> V_71 = F_76 ( V_6 , V_264 -> V_246 ) ;
break;
case V_267 :
V_264 -> V_71 = V_6 -> V_100 - 1 ;
break;
default:
return - V_105 ;
}
...
T_2 V_268 [ 128 ] ;
T_1 V_249 = V_6 -> V_248 . V_249 ;
if ( V_264 -> V_71 != V_269 &&
V_264 -> V_71 != ( V_269 | V_270 ) )
return - V_105 ;
switch ( V_264 -> V_246 ) {
case V_247 :
if ( V_264 -> V_71 == V_269 )
V_249 &= ~ V_253 ;
else if ( V_264 -> V_71 == ( V_269 | V_270 ) )
V_249 |= V_250 |
V_253 ;
break;
case V_258 :
...
if ( ( V_77 + V_66 ) >= 128 )
break;
V_268 [ V_77 + V_66 ] = V_73 -> V_271 ;
}
}
}
V_26 = F_81 ( V_6 , V_6 -> V_248 . V_268 ,
V_249 , 128 , V_6 -> V_248 . V_272 ) ;
if ( ! V_26 )
V_6 -> V_248 . V_249 = V_249 ;
return V_26 ;
}
static int F_82 ( struct V_1 * V_2 , struct V_263 * V_264 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_26 = 0 ;
if ( ! F_78 ( V_6 ) ) {
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_275 -> V_276 = V_6 -> V_277 ;
V_275 -> V_278 = F_84 ( V_6 ) ;
}
static int F_85 ( struct V_1 * V_2 ,
struct V_274 * V_275 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_275 -> V_279 || V_275 -> V_280 || V_275 -> V_281 ||
! V_275 -> V_276 || V_275 -> V_276 > F_84 ( V_6 ) )
return - V_105 ;
V_6 -> V_282 = V_275 -> V_276 ;
return F_86 ( V_6 ) ;
}
...
static int F_89 ( struct V_1 * V_2 , T_1 * V_285 , T_2 * V_286 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_66 ;
struct V_248 * V_287 = & V_6 -> V_248 ;
if ( V_285 ) {
for ( V_66 = 0 ; V_66 < V_283 ; V_66 ++ )
V_285 [ V_66 ] = V_287 -> V_288 [ V_66 ] ;
}
if ( V_286 )
memcpy ( V_286 , V_287 -> V_272 , V_284 ) ;
return 0 ;
}
static int F_90 ( struct V_1 * V_2 , const T_1 * V_285 ,
const T_2 * V_286 )
{
int V_289 = 0 , V_66 , V_77 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
T_2 V_268 [ V_283 ] ;
if ( V_285 ) {
struct V_72 * V_73 ;
...
V_77 = V_285 [ V_66 ] ;
V_73 = & V_6 -> V_172 [ V_77 ] ;
V_268 [ V_66 ] = V_73 -> V_271 ;
V_6 -> V_248 . V_288 [ V_66 ] = V_77 ;
}
} else {
memcpy ( V_268 , V_6 -> V_248 . V_268 ,
V_283 ) ;
}
if ( ! V_286 )
V_286 = V_6 -> V_248 . V_272 ;
V_289 = F_81 ( V_6 , V_268 ,
V_6 -> V_248 . V_249 ,
V_283 , V_286 ) ;
if ( V_289 ) {
V_6 -> V_248 . V_249 = V_290 ;
return - V_40 ;
}
memcpy ( V_6 -> V_248 . V_272 , V_286 , V_284 ) ;
memcpy ( V_6 -> V_248 . V_268 , V_268 ,
V_283 ) ;
return 0 ;
}
