...
struct V_54 V_55 ;
F_30 ( & V_55 , V_56 , V_57 ) ;
V_51 = F_31 ( V_44 , V_16 , V_47 , V_48 , & V_55 , V_50 ) ;
if ( V_51 < 0 )
return V_51 ;
V_51 = - V_42 ;
if ( V_47 [ V_58 ] ) {
...
if ( ! V_23 ) {
V_51 = - V_62 ;
V_23 = F_33 ( sizeof( struct V_22 ) , V_63 ) ;
if ( V_23 == NULL )
goto V_59;
F_27 ( V_16 ) ;
V_6 -> V_30 [ V_36 ] = V_23 ;
...
unsigned int V_37 = F_17 ( V_53 >> 16 ) ;
V_51 = - V_64 ;
...
F_28 ( V_16 ) ;
if ( V_47 [ V_65 ] ) {
V_10 -> V_18 . V_34 = F_32 ( V_47 [ V_65 ] ) ;
F_34 ( V_16 , & V_10 -> V_18 , V_45 ) ;
}
F_35 ( V_16 , & V_10 -> V_38 , & V_55 ) ;
return 0 ;
V_59:
F_23 ( V_16 , & V_55 ) ;
return V_51 ;
}
static int F_36 ( struct V_44 * V_44 , struct V_13 * V_66 ,
struct V_15 * V_16 , unsigned long V_45 ,
T_1 V_33 ,
struct V_46 * * V_67 ,
unsigned long * V_39 , bool V_50 )
{
struct V_5 * V_6 = V_16 -> V_19 ;
struct V_9 * V_10 , * V_68 , * * V_40 ;
struct V_22 * V_23 ;
struct V_46 * V_69 = V_67 [ V_70 ] ;
struct V_46 * V_47 [ V_71 + 1 ] ;
unsigned int V_11 , V_72 ;
T_1 V_73 = 0 ;
int V_51 ;
if ( V_69 == NULL )
return V_33 ? - V_42 : 0 ;
V_51 = F_37 ( V_47 , V_71 , V_69 , V_74 ) ;
if ( V_51 < 0 )
return V_51 ;
...
if ( V_10 -> V_43 )
V_73 = V_10 -> V_33 ;
V_51 = F_29 ( V_44 , V_16 , V_45 , V_10 , V_33 , V_6 , V_47 ,
V_67 [ V_75 ] , 0 , V_50 ) ;
if ( V_51 < 0 )
return V_51 ;
goto V_76;
...
V_51 = - V_62 ;
if ( V_6 == NULL ) {
V_6 = F_33 ( sizeof( struct V_5 ) , V_63 ) ;
if ( V_6 == NULL )
goto V_59;
F_27 ( V_16 ) ;
V_16 -> V_19 = V_6 ;
...
V_10 = F_33 ( sizeof( struct V_9 ) , V_63 ) ;
if ( V_10 == NULL )
goto V_59;
F_30 ( & V_10 -> V_38 , V_56 , V_57 ) ;
V_51 = F_29 ( V_44 , V_16 , V_45 , V_10 , V_33 , V_6 , V_47 ,
V_67 [ V_75 ] , 1 , V_50 ) ;
if ( V_51 < 0 )
goto V_59;
...
for ( V_40 = & V_10 -> V_43 -> V_31 [ V_11 ] ; ( V_68 = * V_40 ) != NULL ; V_40 = & V_68 -> V_32 )
if ( V_10 -> V_33 < V_68 -> V_33 )
break;
V_10 -> V_32 = V_68 ;
F_27 ( V_16 ) ;
* V_40 = V_10 ;
if ( V_73 && V_10 -> V_33 != V_73 ) {
V_72 = F_16 ( V_73 ) ;
V_11 = F_17 ( V_73 >> 16 ) ;
V_23 = V_6 -> V_30 [ V_72 ] ;
if ( V_23 ) {
...
static void F_38 ( struct V_15 * V_16 , struct V_77 * V_39 )
{
struct V_5 * V_6 = V_16 -> V_19 ;
...
if ( V_39 -> V_79 < V_39 -> V_80 ) {
V_39 -> V_79 ++ ;
continue;
}
if ( V_39 -> V_81 ( V_16 , ( unsigned long ) V_10 , V_39 ) < 0 ) {
V_39 -> V_78 = 1 ;
return;
}
V_39 -> V_79 ++ ;
...
static int F_39 ( struct V_44 * V_44 , struct V_15 * V_16 , unsigned long V_82 ,
struct V_13 * V_14 , struct V_83 * V_84 )
{
struct V_9 * V_10 = (struct V_9 * ) V_82 ;
...
if ( ! ( V_10 -> V_33 & 0x8000 ) ) {
V_1 = V_10 -> V_1 & 0xFF ;
if ( F_42 ( V_14 , V_58 , V_1 ) )
goto V_88;
}
if ( V_10 -> V_33 & 0x80000000 ) {
if ( ( V_10 -> V_33 >> 16 ) != 0xFFFF &&
F_42 ( V_14 , V_61 , V_10 -> V_2 ) )
goto V_88;
} else {
V_1 = V_10 -> V_1 >> 16 ;
if ( F_42 ( V_14 , V_60 , V_1 ) )
goto V_88;
}
if ( V_10 -> V_18 . V_34 &&
F_42 ( V_14 , V_65 , V_10 -> V_18 . V_34 ) )
goto V_88;
