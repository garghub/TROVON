...
V_133 = F_93 ( F_94 ( V_134 ) , & V_131 -> V_10 ) ;
if ( ! V_133 ) {
...
T_1 V_144 ;
V_2 = F_98 ( V_10 , sizeof( struct V_1 ) , V_145 ) ;
if ( V_2 == NULL ) {
F_10 ( V_10 , L_25 ) ;
goto V_146;
}
...
F_99 ( V_131 , V_2 ) ;
F_100 ( & V_2 -> V_107 ) ;
F_101 ( & V_2 -> V_108 , V_147 ) ;
V_142 = F_96 ( V_131 , V_148 , 0 ) ;
if ( ! V_142 ) {
F_10 ( V_10 , L_26 ) ;
goto V_149;
}
V_9 = ( V_10 -> V_150 ) ? F_92 ( V_2 , V_131 ) :
F_95 ( V_2 , V_131 ) ;
if ( V_9 )
goto V_149;
V_2 -> V_4 = F_102 ( V_10 , V_142 ) ;
if ( F_103 ( V_2 -> V_4 ) ) {
V_9 = F_104 ( V_2 -> V_4 ) ;
goto V_149;
}
...
F_19 ( V_2 ) ;
V_144 = F_1 ( V_2 , F_106 ( V_2 ) ) ;
F_107 ( V_10 ) ;
F_108 ( V_10 , L_27 ,
( V_144 & V_2 -> V_27 -> V_152 ) >> V_2 -> V_27 -> V_153 ,
( V_144 & V_2 -> V_27 -> V_154 ) >> V_2 -> V_27 -> V_155 ) ;
F_109 ( & V_2 -> V_37 , F_75 , ( unsigned long ) V_2 ) ;
F_109 ( & V_2 -> V_116 , F_79 , ( unsigned long ) V_2 ) ;
V_9 = F_26 ( V_2 ) ;
...
static int F_125 ( struct V_135 * V_10 )
{
int V_9 ;
V_9 = F_8 ( V_10 ) ;
if ( V_9 < 0 ) {
