...
static void * F_44 ( struct V_60 * V_61 , T_8 * V_67 ,
struct V_36 * V_37 )
{
...
static bool F_50 ( struct V_36 * V_71 ,
struct V_64 * V_45 )
{
...
T_9 F_63 ( struct V_80 * V_80 , const char T_10 * V_81 ,
T_11 V_96 , T_8 * V_67 )
{
struct V_60 * V_61 = V_80 -> V_84 ;
struct V_2 * V_14 = V_61 -> V_63 ;
...
T_9 F_64 ( struct V_80 * V_80 , const char T_10 * V_81 ,
T_11 V_96 , T_8 * V_67 )
{
struct V_60 * V_61 = V_80 -> V_84 ;
struct V_2 * V_14 = V_61 -> V_63 ;
...
T_9 F_65 ( struct V_80 * V_80 , const char T_10 * V_81 ,
T_11 V_96 , T_8 * V_67 )
{
struct V_60 * V_61 = V_80 -> V_84 ;
struct V_2 * V_14 = V_61 -> V_63 ;
