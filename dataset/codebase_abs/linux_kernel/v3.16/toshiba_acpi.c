...
if ( ! V_10 -> V_149 )
return - V_129 ;
V_10 -> V_149 -> V_193 = L_56 ;
V_10 -> V_149 -> V_194 = L_57 ;
V_10 -> V_149 -> V_195 . V_196 = V_197 ;
if ( F_96 ( V_198 ) )
V_191 = V_199 ;
error = F_97 ( V_10 -> V_149 , V_191 , NULL ) ;
if ( error )
goto V_200;
V_6 = V_201 ;
V_188 = F_89 () ;
if ( V_188 && F_98 ( V_188 , L_51 ) ) {
F_99 ( & V_10 -> V_185 , F_88 ) ;
error = F_100 ( F_85 ) ;
if ( error ) {
F_12 ( L_58 ) ;
goto V_202;
...
error = F_102 ( V_10 -> V_149 ) ;
if ( error ) {
F_13 ( L_62 ) ;
goto V_205;
}
F_6 ( V_10 , V_206 , V_207 , & V_73 ) ;
return 0 ;
V_205:
if ( V_10 -> V_203 )
F_103 ( F_85 ) ;
...
if ( V_10 -> V_93 )
V_105 . V_106 ++ ;
V_10 -> V_104 = F_108 ( L_64 ,
& V_10 -> V_26 -> V_10 ,
V_10 ,
& V_211 ,
& V_105 ) ;
if ( F_109 ( V_10 -> V_104 ) ) {
V_94 = F_110 ( V_10 -> V_104 ) ;
F_12 ( L_65 ) ;
V_10 -> V_104 = NULL ;
return V_94 ;
}
...
static int F_111 ( struct V_212 * V_26 )
{
struct V_9 * V_10 = F_112 ( V_26 ) ;
F_74 ( V_10 ) ;
if ( V_10 -> V_213 )
F_113 ( & V_10 -> V_26 -> V_10 . V_168 ,
& V_214 ) ;
if ( V_10 -> V_203 ) {
F_103 ( F_85 ) ;
F_114 ( & V_10 -> V_185 ) ;
...
static const char * F_120 ( T_10 V_27 )
{
if ( F_98 ( V_27 , L_66 ) )
return L_66 ;
if ( F_98 ( V_27 , L_67 ) )
...
static int F_121 ( struct V_212 * V_26 )
{
struct V_9 * V_10 ;
const char * V_219 ;
T_2 V_220 ;
...
F_13 ( L_68 ,
V_139 ) ;
V_219 = F_120 ( V_26 -> V_27 ) ;
if ( ! V_219 ) {
F_12 ( L_69 ) ;
return - V_60 ;
}
V_10 = F_122 ( sizeof( * V_10 ) , V_128 ) ;
if ( ! V_10 )
return - V_129 ;
V_10 -> V_26 = V_26 ;
V_10 -> V_28 = V_219 ;
V_26 -> V_223 = V_10 ;
F_123 ( & V_26 -> V_10 , V_10 ) ;
if ( F_94 ( V_10 ) )
F_13 ( L_70 ) ;
F_124 ( & V_10 -> V_85 ) ;
V_94 = F_106 ( V_10 ) ;
if ( V_94 )
goto error;
if ( F_33 ( V_10 , & V_221 ) == V_76 && V_221 ) {
V_10 -> V_215 = F_125 ( L_71 ,
& V_26 -> V_10 ,
V_224 ,
& V_225 ,
V_10 ) ;
...
if ( F_18 ( V_10 ) ) {
V_10 -> V_54 . V_193 = L_74 ;
V_10 -> V_54 . V_106 = 1 ;
V_10 -> V_54 . V_226 = F_19 ;
V_10 -> V_54 . V_227 = F_21 ;
if ( ! F_127 ( & V_26 -> V_10 , & V_10 -> V_54 ) )
V_10 -> V_216 = 1 ;
}
if ( F_28 ( V_10 ) ) {
V_10 -> V_65 . V_193 = L_75 ;
V_10 -> V_65 . V_106 = 1 ;
V_10 -> V_65 . V_226 = F_30 ;
V_10 -> V_65 . V_227 = F_29 ;
if ( ! F_127 ( & V_10 -> V_26 -> V_10 , & V_10 -> V_65 ) )
V_10 -> V_218 = 1 ;
}
V_94 = F_23 ( V_10 , & V_220 ) ;
if ( ! V_94 ) {
V_10 -> V_158 = V_220 >> V_159 ;
V_10 -> V_157 = V_220 & 0x07 ;
}
V_10 -> V_174 = ! V_94 ;
if ( V_10 -> V_174 && V_10 -> V_157 == V_228 ) {
V_10 -> V_61 . V_193 = L_76 ;
V_10 -> V_61 . V_106 = 1 ;
V_10 -> V_61 . V_226 = F_25 ;
V_10 -> V_61 . V_227 = F_24 ;
if ( ! F_127 ( & V_10 -> V_26 -> V_10 , & V_10 -> V_61 ) )
V_10 -> V_217 = 1 ;
}
V_94 = F_27 ( V_10 , & V_220 ) ;
V_10 -> V_177 = ! V_94 ;
V_94 = F_31 ( V_10 ) ;
V_10 -> V_179 = ! V_94 ;
V_94 = F_56 ( V_10 , & V_220 ) ;
V_10 -> V_145 = ! V_94 ;
V_94 = F_62 ( V_10 , & V_220 ) ;
V_10 -> V_147 = ! V_94 ;
V_94 = F_128 ( & V_10 -> V_26 -> V_10 . V_168 ,
& V_214 ) ;
if ( V_94 ) {
V_10 -> V_213 = 0 ;
goto error;
...
static void F_129 ( struct V_212 * V_26 , T_2 V_229 )
{
struct V_9 * V_10 = F_112 ( V_26 ) ;
T_2 V_73 , V_3 ;
int V_230 = 3 ;
...
static int F_130 ( struct V_152 * V_152 )
{
struct V_9 * V_10 = F_112 ( F_131 ( V_152 ) ) ;
T_2 V_33 ;
if ( V_10 -> V_149 )
F_6 ( V_10 , V_206 , V_231 , & V_33 ) ;
return 0 ;
}
static int F_132 ( struct V_152 * V_152 )
{
struct V_9 * V_10 = F_112 ( F_131 ( V_152 ) ) ;
T_2 V_33 ;
if ( V_10 -> V_149 )
F_6 ( V_10 , V_206 , V_207 , & V_33 ) ;
return 0 ;
}
...
if ( F_134 ( V_232 ) )
return - V_60 ;
V_143 = F_135 ( V_233 , V_234 ) ;
if ( ! V_143 ) {
F_12 ( L_78 V_233 L_79 ) ;
return - V_60 ;
}
V_94 = F_136 ( & V_235 ) ;
if ( V_94 ) {
