...
static void F_57 ( struct V_66 * V_83 ,
struct V_84 * V_85 )
{
memset ( V_85 , 0 , sizeof( struct V_84 ) ) ;
V_85 -> V_86 =
F_53 ( V_83 -> V_68 . V_21 . V_57 ) ;
V_85 -> V_87 =
F_53 ( V_83 -> V_68 . V_21 . V_69 . V_25 . V_36 ) ;
return;
}
static int F_58 ( struct V_66 * V_83 )
{
if ( ! V_5 )
return - V_79 ;
if ( F_38 ( & V_83 -> V_68 . V_21 . V_69 ) < 0 )
return V_88 ;
return 0 ;
}
static int F_59 ( struct V_66 * V_83 , int V_2 ,
struct V_84 * V_89 ,
struct V_84 * V_90 )
{
T_1 exp ;
...
if ( F_38 ( & V_83 -> V_68 . V_21 . V_69 ) < 0 )
return V_88 ;
V_83 -> V_68 . V_21 . V_57 = F_60 ( V_89 -> V_86 ) ;
exp = F_60 ( V_89 -> V_87 ) ;
if ( V_2 != V_91 ) {
T_1 V_41 ;
V_41 = V_29 [ V_83 -> V_68 . V_21 . V_69 . type ] . V_35 () ;
exp = F_31 ( V_41 , exp ) ;
}
F_34 ( & V_83 -> V_68 . V_21 . V_69 , exp ) ;
return 0 ;
}
static enum V_65 F_61 ( struct V_21 * V_21 ,
T_1 V_41 )
{
struct V_92 * V_93 = (struct V_92 * ) V_21 -> V_94 ;
V_21 -> V_94 = NULL ;
if ( V_93 )
F_62 ( V_93 ) ;
return V_32 ;
...
F_66 () ;
F_40 ( V_21 ) ;
} while ( V_21 -> V_94 && ! F_67 ( V_95 ) );
F_68 ( V_97 ) ;
return ( V_21 -> V_94 == NULL ) ;
}
static int F_69 ( T_1 exp , enum V_54 type ,
struct V_73 T_5 * V_98 )
{
struct V_73 V_99 ;
T_1 V_100 ;
V_100 = F_22 ( exp , V_29 [ type ] . V_35 () ) ;
if ( V_100 . V_49 <= 0 )
return 0 ;
V_99 = F_53 ( V_100 ) ;
if ( F_70 ( V_98 , & V_99 , sizeof( * V_98 ) ) )
return - V_101 ;
return 1 ;
}
static long T_6 F_71 ( struct V_102 * V_31 )
{
enum V_54 type = V_31 -> V_103 . V_60 ;
T_1 exp ;
struct V_73 T_5 * V_98 ;
struct V_21 V_21 ;
int V_3 = 0 ;
exp . V_49 = V_31 -> V_103 . V_36 ;
F_56 ( & V_21 , type , F_61 ) ;
if ( F_63 ( & V_21 , exp ) )
goto V_104;
if ( F_72 ( V_95 ) )
F_33 ( exp , type ) ;
V_98 = V_31 -> V_103 . V_98 ;
if ( V_98 ) {
V_3 = F_69 ( exp , type , V_98 ) ;
if ( V_3 <= 0 )
goto V_104;
}
V_3 = - V_105 ;
...
struct V_73 * V_106 , struct V_73 T_5 * V_98 )
{
...
V_31 = & F_74 () -> V_102 ;
V_31 -> V_108 = F_71 ;
V_31 -> V_103 . V_60 = type ;
V_31 -> V_103 . V_36 = exp . V_49 ;
V_31 -> V_103 . V_98 = V_98 ;
V_3 = - V_105 ;
V_104:
return V_3 ;
}
...
F_76 ( V_61 , & V_112 ) ;
F_76 ( V_63 , & V_112 ) ;
V_29 [ V_62 ] . V_76 = V_120 ;
V_29 [ V_62 ] . V_35 = & V_121 ;
V_29 [ V_64 ] . V_76 = V_122 ;
V_29 [ V_64 ] . V_35 = & V_123 ;
for ( V_42 = 0 ; V_42 < V_45 ; V_42 ++ ) {
F_77 ( & V_29 [ V_42 ] . V_24 ) ;
F_78 ( & V_29 [ V_42 ] . V_33 ) ;
}
