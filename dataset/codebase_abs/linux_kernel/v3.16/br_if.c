...
int F_63 ( struct V_52 * V_52 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_53 ;
V_2 = F_64 ( sizeof( struct V_12 ) , V_9 ,
V_54 ) ;
if ( ! V_2 )
return - V_45 ;
F_65 ( V_2 , V_52 ) ;
...
int F_68 ( struct V_52 * V_52 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_57 = 0 ;
F_69 () ;
...
if ( V_2 == NULL )
V_57 = - V_58 ;
else if ( ! ( V_2 -> V_22 & V_59 ) ) {
V_57 = - V_60 ;
}
else if ( V_2 -> V_14 & V_61 ) {
V_57 = - V_62 ;
}
else
F_44 ( V_2 , NULL ) ;
...
int F_72 ( const struct V_12 * V_13 )
{
...
F_19 (p, &br->port_list, list) {
if ( ! V_63 || V_11 -> V_2 -> V_63 < V_63 )
V_63 = V_11 -> V_2 -> V_63 ;
}
}
return V_63 ;
}
T_2 F_75 ( struct V_12 * V_13 ,
T_2 V_66 )
{
struct V_10 * V_11 ;
T_2 V_67 ;
...
int F_77 ( struct V_12 * V_13 , struct V_1 * V_2 )
{
struct V_10 * V_11 ;
int V_20 = 0 ;
bool V_69 ;
if ( ( V_2 -> V_14 & V_70 ) ||
V_2 -> type != V_71 || V_2 -> V_72 != V_73 ||
! F_78 ( V_2 -> V_74 ) )
return - V_75 ;
...
if ( V_20 )
goto V_83;
V_20 = F_83 ( & V_11 -> V_29 , & V_84 , & ( V_2 -> V_2 . V_29 ) ,
V_85 ) ;
if ( V_20 )
goto V_86;
V_20 = F_84 ( V_11 ) ;
...
if ( V_20 )
goto V_88;
V_20 = F_86 ( V_2 , V_13 -> V_2 ) ;
if ( V_20 )
goto V_89;
V_20 = F_87 ( V_2 , V_90 , V_11 ) ;
if ( V_20 )
goto V_91;
V_2 -> V_22 |= V_36 ;
F_88 ( V_2 ) ;
F_89 ( & V_11 -> V_35 , & V_13 -> V_64 ) ;
F_21 ( V_13 ) ;
F_90 ( V_13 -> V_2 ) ;
if ( V_13 -> V_2 -> V_92 < V_2 -> V_92 )
V_13 -> V_2 -> V_92 = V_2 -> V_92 ;
if ( F_91 ( V_13 , V_11 , V_2 -> V_74 , 0 ) )
F_92 ( V_2 , L_3 ) ;
F_7 ( & V_13 -> V_17 ) ;
V_69 = F_93 ( V_13 ) ;
if ( F_5 ( V_2 ) && F_6 ( V_2 ) &&
...
int F_95 ( struct V_12 * V_13 , struct V_1 * V_2 )
{
struct V_10 * V_11 ;
bool V_69 ;
V_11 = F_96 ( V_2 ) ;
...
void F_97 ( struct V_10 * V_11 , unsigned long V_67 )
{
struct V_12 * V_13 = V_11 -> V_13 ;
if ( V_67 & V_96 )
F_21 ( V_13 ) ;
