...
const unsigned char * V_50 , char * V_51 , int V_52 )
{
struct V_45 * V_46 = V_39 -> V_42 ;
...
V_43 . V_55 ( V_39 , V_50 , V_51 , V_52 ) ;
for ( V_53 = & V_50 [ V_52 - 1 ] ; V_53 >= V_50 ; V_53 -- ) {
if ( * V_53 != '\r' )
continue;
F_24 ( & V_34 ) ;
F_25 ( & V_47 , V_58 + F_26 ( 150 ) ) ;
V_54 = ! V_36 && ! V_35 ;
V_35 = 1 ;
F_27 ( & V_34 ) ;
if ( V_54 )
...
return F_30 ( V_65 -> V_67 ,
V_68 |
V_69 |
V_70 ) ;
}
static int F_31 ( struct V_71 * V_72 , int V_73 )
{
int V_54 ;
if ( V_36 == V_73 )
return 0 ;
