...
V_58 * V_308 , V_401 ;
T_1 V_402 = 0 ;
struct V_403 * V_11 = V_2 -> V_404 ;
V_4 -> V_6 = F_2 ( V_405 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
F_7 ( & V_4 -> V_8 , sizeof( struct V_381 ) ) ;
V_382 -> V_406 = 0 ;
memcpy ( V_382 -> V_407 , V_384 -> V_407 , V_126 ) ;
V_386 = F_47 ( V_2 , V_384 -> V_407 ) ;
V_308 = ( V_58 * ) V_382 + sizeof( struct V_381 ) ;
switch ( V_384 -> V_408 ) {
case V_409 :
V_382 -> V_408 = F_2 ( V_410 ) ;
break;
case V_411 :
V_382 -> V_408 = F_2 ( V_412 ) ;
break;
case V_413 :
V_382 -> V_408 = F_2 ( V_414 ) ;
if ( ! V_11 ) {
F_4 ( V_2 -> V_29 -> V_30 ,
L_31 ,
V_384 -> V_407 ) ;
...
* ( V_43 * ) V_308 = F_2 ( V_11 -> V_416 ) ;
V_402 += sizeof( V_11 -> V_416 ) ;
V_401 = V_11 -> V_417 | ( V_11 -> V_418 << 5 ) ;
V_392 = (struct V_391 * ) ( V_308 +
V_402 ) ;
V_392 -> V_232 . type = F_2 ( V_419 ) ;
V_392 -> V_232 . V_168 = F_2 ( sizeof( V_401 ) ) ;
V_392 -> V_401 = V_401 ;
V_402 += sizeof( struct V_391 ) ;
if ( V_11 -> V_420 ) {
...
F_2 ( V_421 ) ;
V_390 -> V_232 . V_168 =
F_2 ( sizeof( struct V_422 ) ) ;
memcpy ( & V_390 -> V_423 , V_11 -> V_420 ,
sizeof( struct V_422 ) ) ;
V_402 += sizeof( struct V_389 ) ;
}
if ( V_11 -> V_424 && V_11 -> V_425 ) {
...
V_388 -> V_232 . V_168 =
F_2 ( V_11 -> V_425 ) ;
memcpy ( V_388 -> V_427 , V_11 -> V_424 ,
V_11 -> V_425 ) ;
V_402 += sizeof( struct V_387 ) +
V_11 -> V_425 ;
}
if ( V_11 -> V_428 && V_11 -> V_429 ) {
V_394 = (struct V_393 * ) ( V_308 +
V_402 ) ;
V_394 -> V_232 . type =
F_2 ( V_430 ) ;
V_394 -> V_232 . V_168 = F_2 ( V_11 -> V_429 ) ;
memcpy ( V_394 -> V_428 , V_11 -> V_428 ,
V_11 -> V_429 ) ;
V_402 += sizeof( struct V_393 ) +
V_11 -> V_429 ;
}
if ( V_11 -> V_431 ) {
...
F_2 ( V_432 ) ;
V_396 -> V_232 . V_168 =
F_2 ( sizeof( struct V_433 ) ) ;
memcpy ( & V_396 -> V_434 , V_11 -> V_431 ,
sizeof( struct V_433 ) ) ;
V_402 += sizeof( struct V_395 ) ;
}
if ( V_11 -> V_398 ) {
V_398 = (struct V_397 * ) ( V_308 + V_402 ) ;
V_398 -> V_232 . type = F_2 ( V_435 ) ;
V_398 -> V_232 . V_168 = F_2 ( sizeof( V_11 -> V_398 ) ) ;
V_398 -> V_398 = F_2 ( V_11 -> V_398 ) ;
V_402 += sizeof( struct V_397 ) ;
}
V_400 = ( void * ) ( V_308 + V_402 ) ;
V_400 -> V_232 . type = F_2 ( V_436 ) ;
V_400 -> V_232 . V_168 = F_2 ( sizeof( V_400 -> V_44 ) ) ;
V_400 -> V_44 = F_2 ( V_437 ) ;
...
int F_48 ( struct V_1 * V_2 , T_4 V_439 ,
T_1 V_5 , T_2 V_32 ,
void * V_79 , void * V_440 )
{
struct V_3 * V_441 = V_440 ;
int V_222 = 0 ;
switch ( V_439 ) {
case V_442 :
V_222 = F_49 ( V_2 , V_441 ) ;
break;
case V_359 :
V_222 = F_43 ( V_2 , V_441 , V_79 ) ;
break;
case V_31 :
V_222 = F_3 ( V_2 , V_441 , V_5 ,
V_79 ) ;
break;
case V_121 :
V_222 = F_17 ( V_2 , V_441 ,
V_5 ) ;
break;
case V_132 :
V_222 = F_18 ( V_441 , V_5 ,
V_79 ) ;
break;
case V_56 :
V_222 = F_10 ( V_2 , V_441 , V_5 ,
V_79 ) ;
break;
case V_77 :
V_222 = F_12 ( V_441 , V_5 ,
V_79 ) ;
break;
case V_81 :
V_222 = F_13 ( V_2 , V_441 , V_5 ,
V_79 ) ;
break;
case V_88 :
V_222 = F_14 ( V_2 , V_441 , V_5 ,
V_79 ) ;
break;
case V_443 :
V_222 = F_50 ( V_2 , V_441 , V_5 ,
( T_4 ) V_32 , V_79 ) ;
break;
case V_108 :
V_222 = F_15 ( V_2 , V_441 , V_5 ,
(struct V_101 * ) V_79 ) ;
break;
case V_444 :
V_222 = F_51 ( V_441 , V_79 ) ;
break;
case V_445 :
V_222 = F_52 ( V_441 ) ;
break;
case V_446 :
V_222 = F_53 ( V_2 , V_441 , V_79 ) ;
break;
case V_139 :
V_222 = F_19 ( V_2 , V_441 ,
V_79 ) ;
break;
case V_447 :
V_222 = F_54 ( V_2 , V_441 ,
V_79 ) ;
break;
case V_45 :
V_222 = F_9 ( V_441 ) ;
...
break;
case V_7 :
V_222 = F_1 ( V_2 , V_441 , V_5 ) ;
break;
case V_37 :
V_222 = F_5 ( V_2 , V_441 , V_5 ,
V_32 , V_79 ) ;
break;
case V_449 :
V_441 -> V_6 =
...
case V_452 :
V_441 -> V_6 = F_2 ( V_439 ) ;
V_441 -> V_11 . V_453 . V_454 =
( V_58 ) ( * ( ( T_2 * ) V_79 ) ) ;
memcpy ( & V_441 -> V_11 , V_79 ,
sizeof( struct V_455 ) ) ;
V_441 -> V_8 =
...
case V_456 :
V_441 -> V_6 = F_2 ( V_439 ) ;
V_441 -> V_11 . V_457 . V_13 = F_2 ( V_5 ) ;
V_441 -> V_11 . V_457 . V_458 = F_16 ( * ( T_2 * ) V_79 ) ;
V_441 -> V_8 =
...
break;
case V_462 :
V_222 = F_56 ( V_2 , V_441 , V_5 , V_79 ) ;
break;
case V_463 :
V_441 -> V_6 = F_2 ( V_439 ) ;
V_441 -> V_11 . V_464 . V_13 = F_2 ( V_5 ) ;
V_441 -> V_11 . V_464 . V_78 = F_2 ( * ( T_1 * ) V_79 ) ;
V_441 -> V_8 =
F_2 ( sizeof( struct V_465 ) +
V_10 ) ;
break;
case V_466 :
if ( V_2 -> V_29 -> V_467 == V_468 )
V_2 -> V_29 -> V_467 = V_469 ;
V_441 -> V_6 = F_2 ( V_439 ) ;
V_441 -> V_8 = F_2 ( V_10 ) ;
break;
case V_470 :
V_2 -> V_29 -> V_467 = V_468 ;
V_441 -> V_6 = F_2 ( V_439 ) ;
V_441 -> V_8 = F_2 ( V_10 ) ;
break;
case V_471 :
V_222 = F_57 ( V_441 , V_79 ) ;
break;
case V_472 :
V_222 = F_58 ( V_441 , V_79 ) ;
break;
case V_473 :
V_222 = F_59 ( V_2 , V_441 , V_79 ) ;
break;
case V_186 :
V_222 = F_28 ( V_2 , V_441 ,
V_5 , V_32 ,
V_79 ) ;
break;
case V_242 :
V_222 = F_29 ( V_2 , V_441 ,
V_5 ) ;
break;
case V_474 :
V_222 = F_60 ( V_2 , V_441 , V_5 ,
V_79 ) ;
break;
case V_475 :
V_222 = F_61 ( V_441 , V_5 ,
V_79 ) ;
break;
case V_476 :
V_222 = F_62 ( V_2 , V_441 , V_5 , V_79 ) ;
break;
case V_477 :
F_6 ( V_2 -> V_29 -> V_30 ,
L_33 ) ;
V_441 -> V_6 = F_2 ( V_477 ) ;
V_441 -> V_8 =
F_2 ( sizeof( struct V_478 ) +
V_10 ) ;
V_222 = 0 ;
break;
case V_251 :
V_222 = F_30 ( V_441 , V_5 ,
V_79 ) ;
break;
case V_479 :
V_222 = F_63 ( V_2 , V_441 , V_79 ) ;
break;
case V_254 :
case V_258 :
case V_261 :
...
case V_267 :
case V_269 :
V_222 = F_31 ( V_441 , V_5 , V_79 ) ;
break;
case V_480 :
V_441 -> V_6 = F_2 ( V_439 ) ;
if ( V_2 -> V_209 == V_210 )
V_441 -> V_11 . V_209 . V_481 =
V_482 ;
else if ( V_2 -> V_209 == V_483 )
V_441 -> V_11 . V_209 . V_481 =
V_484 ;
else if ( V_2 -> V_209 == V_485 )
V_441 -> V_11 . V_209 . V_481 = V_486 ;
V_441 -> V_8 = F_2 ( sizeof( struct
V_487 ) + V_10 ) ;
V_222 = 0 ;
break;
case V_281 :
V_222 = F_33 ( V_2 , V_441 , V_5 ) ;
break;
case V_309 :
V_222 = F_34 ( V_2 , V_441 , V_79 ) ;
break;
case V_343 :
V_222 = F_36 ( V_2 , V_441 , V_79 ) ;
break;
case V_372 :
V_222 = F_45 ( V_2 , V_441 , V_5 ,
V_79 ) ;
break;
case V_405 :
V_222 = F_46 ( V_2 , V_441 , V_79 ) ;
break;
default:
F_4 ( V_2 -> V_29 -> V_30 ,
L_34 , V_439 ) ;
...
int F_64 ( struct V_1 * V_2 , V_58 V_488 )
{
struct V_103 * V_29 = V_2 -> V_29 ;
int V_222 ;
T_1 V_247 = true ;
...
if ( V_222 )
return - 1 ;
if ( V_488 && V_2 -> V_29 -> V_497 != V_507 &&
V_2 -> V_230 != V_231 ) {
V_492 . V_492 = V_508 ;
V_492 . V_509 = V_510 ;
V_222 = F_42 ( V_2 , V_443 ,
V_502 , V_511 ,
& V_492 , true ) ;
if ( V_222 )
return - 1 ;
