...
V_2 -> V_51 = V_31 -> V_52 ;
V_2 -> V_53 = F_35 ( V_31 ) ;
V_2 -> V_17 = F_36 ( & V_9 -> V_9 , V_31 ) ;
if ( F_28 ( V_2 -> V_17 ) ) {
V_32 = F_29 ( V_2 -> V_17 ) ;
goto V_54;
}
V_32 = F_37 ( V_2 , V_33 , V_55 ) ;
if ( V_32 )
goto V_54;
F_38 ( V_2 -> V_5 . V_6 ) ;
F_25 ( V_9 , V_2 ) ;
...
static int F_44 ( struct V_57 * V_9 )
{
...
static int F_49 ( struct V_57 * V_9 )
{
struct V_1 * V_2 = F_45 ( V_9 ) ;
struct V_7 * V_8 = F_3 ( V_9 ) ;
struct V_3 * V_4 =
