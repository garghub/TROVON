...
} else if ( V_28 -> V_42 <= 0xffffffff ) {
V_48 = V_61 ;
V_47 = V_28 -> V_42 / 100000 ;
} else if ( V_28 -> V_42 <= 0xffffffff ) {
V_48 = V_62 ;
V_47 = V_28 -> V_42 / 1000000 ;
}
F_2 ( 0xFF03 , V_2 -> V_3 + V_4 ) ;
...
} else if ( V_28 -> V_41 < 0xffffffff ) {
V_48 = V_61 ;
V_47 = V_28 -> V_41 / 100000 ;
} else if ( V_28 -> V_41 < 0xffffffff ) {
V_48 = V_62 ;
V_47 = V_28 -> V_41 / 1000000 ;
}
F_2 ( 0xFF02 , V_2 -> V_3 + V_4 ) ;
F_2 ( V_48 , V_2 -> V_3 + V_5 ) ;
F_2 ( 0xFF0A , V_2 -> V_3 + V_4 ) ;
...
struct V_22 * V_23 ,
struct V_68 * V_69 , unsigned int * V_77 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
int V_10 ;
int V_51 ;
...
for ( V_10 = 0 ; V_10 < V_69 -> V_80 ; V_10 ++ ) {
F_2 ( 0 , V_2 -> V_3 + V_81 ) ;
V_78 = F_19 ( V_2 , V_23 , V_69 , F_17 , 0 ) ;
if ( V_78 )
return V_78 ;
V_77 [ V_10 ] = F_6 ( V_2 -> V_3 + V_25 ) ;
if ( V_8 -> V_16 == V_82 )
V_77 [ V_10 ] ^= 0x800 ;
}
return V_10 ;
...
int V_10 ;
for ( V_10 = 0 ; V_10 < V_69 -> V_80 ; V_10 ++ )
V_77 [ V_10 ] = V_8 -> V_83 [ F_14 ( V_69 -> V_79 ) ] ;
return V_10 ;
}
...
{
struct V_7 * V_8 = V_2 -> V_9 ;
unsigned int V_51 = F_14 ( V_69 -> V_79 ) ;
unsigned int V_91 ;
int V_78 ;
if ( V_51 < 4 )
V_91 = 0x0f ;
...
V_91 = 0xf0 ;
V_78 = F_25 ( V_2 , V_23 , V_69 , V_77 , V_91 ) ;
if ( V_78 )
return V_78 ;
V_8 -> V_55 &= ~ ( V_92 | V_93 ) ;
if ( V_23 -> V_94 & 0x0f )
...
struct V_95 * V_96 )
{
const struct V_97 * V_98 = F_27 ( V_2 ) ;
struct V_7 * V_8 ;
struct V_22 * V_23 ;
int V_78 ;
V_78 = F_28 ( V_2 , V_96 -> V_99 [ 0 ] , V_100 ) ;
if ( V_78 )
return V_78 ;
V_78 = F_29 ( V_2 , 4 ) ;
if ( V_78 )
...
V_23 = & V_2 -> V_109 [ 3 ] ;
if ( V_98 -> V_142 ) {
V_78 = F_32 ( V_2 , V_23 , NULL , V_2 -> V_3 ) ;
if ( V_78 )
return V_78 ;
} else {
V_23 -> type = V_143 ;
