...
if ( ! V_3 )
return NULL ;
V_70 = F_164 ( sizeof( struct V_1 ) , L_83 , F_156 ) ;
if ( ! V_70 ) {
F_8 ( & V_94 -> V_15 , L_84 ) ;
goto exit;
}
...
V_1 -> V_70 = V_70 ;
V_1 -> V_36 = V_3 ;
V_1 -> V_123 = F_165 ( V_94 , V_328 ,
V_271 ) ;
if ( ! V_1 -> V_123 ) {
F_8 ( & V_94 -> V_15 , L_85 ) ;
goto exit;
}
V_1 -> V_89 = F_165 ( V_94 , V_328 ,
V_275 ) ;
if ( ! V_1 -> V_89 ) {
F_8 ( & V_94 -> V_15 , L_86 ) ;
goto exit;
...
V_299 = 1 ;
if ( F_139 ( V_31 , V_299 , V_332 ,
V_333 ) )
goto exit;
V_31 -> V_123 = F_165 ( V_94 , V_328 ,
V_271 ) ;
if ( ! V_31 -> V_123 ) {
F_8 ( & V_94 -> V_15 , L_90 ) ;
goto V_334;
...
{
struct V_190 * V_338 = F_148 ( V_94 ) ;
T_5 * V_339 = F_177 ( 17 , V_176 ) ;
T_2 V_200 = V_94 -> V_201 -> V_202 . V_203 ;
T_8 V_38 ;
if ( ! V_339 )
return - V_340 ;
if ( F_111 ( V_338 , F_112 ( V_338 , 0 ) ,
0x86 , 0xC0 , 0 , 0 , V_339 , 17 ,
V_253 ) != 0x11 ) {
F_137 ( V_339 ) ;
return - V_341 ;
}
...
struct V_2 * V_3 = NULL ;
struct V_41 * V_42 ;
struct V_2 * V_348 = NULL ;
if ( V_94 -> V_349 -> V_202 . V_350 != 0xFF ) {
F_8 ( & V_94 -> V_15 , L_93 ) ;
return - V_54 ;
}
V_200 = V_94 -> V_201 -> V_202 . V_203 ;
if ( V_346 -> V_351 )
V_19 = ( ( T_2 * ) ( V_346 -> V_351 ) ) [ V_200 ] ;
else
V_19 = F_176 ( V_94 ) ;
if ( V_94 -> V_352 > 1 )
...
static void V_304 ( struct V_356 * V_84 )
{
struct V_2 * V_3 =
F_184 ( V_84 , struct V_2 , V_304 ) ;
F_77 ( V_3 -> V_94 ) ;
}
static void V_305 ( struct V_356 * V_84 )
{
struct V_2 * V_3 =
...
{
if ( V_3 -> V_88 -> V_239 == V_357 ) {
if ( ! V_3 -> V_358 ) {
V_3 -> V_358 = 1 ;
F_19 ( & V_3 -> V_304 ) ;
}
}
if ( V_3 -> V_88 -> V_239 != V_359 )
return - V_61 ;
F_57 ( V_3 -> V_88 ) ;
return 0 ;
}
...
static int F_185 ( struct V_302 * V_360 , T_9 V_361 )
{
int V_43 , V_38 ;
for ( V_43 = 0 ; V_43 < V_44 ; V_43 ++ ) {
if ( V_45 [ V_43 ] && ( V_45 [ V_43 ] -> V_94 == V_360 ) ) {
V_38 = F_82 ( V_45 [ V_43 ] ) ;
if ( V_38 )
goto V_184;
}
...
static int F_186 ( struct V_302 * V_360 )
{
int V_43 , V_38 = 0 ;
struct V_1 * V_1 ;
for ( V_43 = 0 ; V_43 < V_44 ; V_43 ++ ) {
...
static void V_68 ( struct V_356 * V_84 )
{
struct V_2 * V_3 =
...
static void V_177 ( struct V_363 * V_175 )
{
...
struct V_325 * V_364 = F_1 ( V_307 [ V_43 ] ) -> V_325 ;
...
static struct V_365 * F_165 ( struct V_302 * V_303 ,
int type , int V_366 )
{
int V_43 ;
struct V_367 * V_360 = V_303 -> V_349 ;
struct V_365 * V_191 ;
for ( V_43 = 0 ; V_43 < V_360 -> V_202 . V_368 ; V_43 ++ ) {
V_191 = & V_360 -> V_369 [ V_43 ] . V_202 ;
if ( ( ( V_191 -> V_90 & V_370 ) == V_366 ) &&
( F_193 ( V_191 ) == type ) )
return V_191 ;
}
return NULL ;
}
static int F_180 ( struct V_302 * V_303 , unsigned char * V_371 )
{
int V_43 ;
struct V_367 * V_360 = V_303 -> V_349 ;
if ( V_360 -> V_372 == 3 ) {
...
for ( V_43 = 0 ; V_43 < V_360 -> V_202 . V_368 ; V_43 ++ ) {
if ( V_360 -> V_369 [ V_43 ] . V_372 == 3 ) {
* V_371 = V_360 -> V_369 [ V_43 ] . V_373 [ 2 ] ;
return 0 ;
}
}
return - 1 ;
...
struct V_190 * V_88 , T_7 V_374 )
{
int V_38 ;
F_96 ( V_42 -> V_296 , V_88 ,
F_97 ( V_88 ,
V_42 -> V_337 -> V_90 & 0x7F ) ,
V_42 -> V_336 ,
1 ,
F_119 , V_42 ,
V_42 -> V_337 -> V_195 ) ;
V_38 = F_40 ( V_42 -> V_296 , V_374 ) ;
if ( V_38 )
