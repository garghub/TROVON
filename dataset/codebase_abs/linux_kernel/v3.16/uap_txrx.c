...
if ( ! V_2 -> V_80 ||
( ! F_36 ( V_2 , V_28 -> V_77 , V_69 ) &&
( F_14 ( V_28 -> V_68 ) != V_81 ) ) ) {
V_67 = F_28 ( V_2 , V_8 ) ;
return V_67 ;
}
V_70 = ( V_47 ) F_14 ( V_28 -> V_68 ) ;
V_67 = F_37 ( V_2 , F_14 ( V_28 -> V_79 ) ,
V_28 -> V_77 , V_69 , V_70 ,
V_8 ) ;
if ( V_67 || ( V_68 == V_76 ) )
F_29 ( V_8 ) ;
...
T_1 V_70 ;
if ( ! V_8 -> V_57 ) {
F_15 ( V_14 -> V_40 , L_8 , V_8 -> V_57 ) ;
V_12 -> V_85 = - 1 ;
return V_8 -> V_37 ;
}
V_70 = F_39 ( V_8 ) ? V_75 : 0 ;
V_84 = ( 4 - ( ( ( void * ) V_8 -> V_37 - NULL ) & 0x3 ) ) % 4 ;
V_57 = sizeof( * V_83 ) + V_84 ;
F_40 ( F_19 ( V_8 ) < V_57 + V_86 ) ;
F_41 ( V_8 , V_57 ) ;
V_83 = (struct V_82 * ) V_8 -> V_37 ;
memset ( V_83 , 0 , sizeof( * V_83 ) ) ;
V_83 -> V_54 = V_2 -> V_54 ;
V_83 -> V_55 = V_2 -> V_55 ;
V_83 -> V_87 = F_42 ( ( T_1 ) ( V_8 -> V_57 - V_57 ) ) ;
V_83 -> V_77 = ( V_47 ) V_8 -> V_77 ;
V_83 -> V_88 = F_43 ( V_2 , V_8 ) ;
if ( V_83 -> V_77 < F_44 ( V_2 -> V_18 . V_89 ) )
V_83 -> V_90 =
F_45 ( V_2 -> V_18 . V_89 [ V_83 -> V_77 ] ) ;
if ( V_70 == V_75 ) {
V_83 -> V_91 = F_42 ( V_70 ) ;
V_57 += V_92 ;
}
