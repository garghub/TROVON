...
{
F_40 ( V_9 , V_170 , F_33 ( 31 ) | F_33 ( 30 ) ) ;
}
...
V_205 = ( V_205 + V_206 - 1 ) /
V_206 ;
F_18 ( V_9 , V_208 , ( T_1 ) V_205 ) ;
}
void F_69 ( struct V_8 * V_9 , T_3 V_209 )
{
struct V_44 * V_45 = F_17 ( V_9 ) ;
struct V_210 * V_211 = & V_45 -> V_212 . V_213 ;
if ( V_209 == 0xff )
F_70 ( & V_45 -> V_212 , V_211 -> V_214 ) ;
else {
V_211 -> V_214 = V_211 -> V_215 ;
F_70 ( & V_45 -> V_212 , V_209 ) ;
}
}
void F_71 ( struct V_8 * V_9 )
{
struct V_44 * V_45 = F_17 ( V_9 ) ;
V_45 -> V_212 . V_216 = V_45 -> V_212 . V_217 ;
}
void F_72 ( struct V_8 * V_9 )
{
struct V_44 * V_45 = F_17 ( V_9 ) ;
V_45 -> V_212 . V_217 = V_45 -> V_212 . V_216 ;
}
void F_73 ( struct V_8 * V_9 , T_3 V_123 )
{
struct V_44 * V_45 = F_17 ( V_9 ) ;
if ( V_123 == V_218 ) {
V_45 -> V_219 . V_220 = V_45 -> V_219 . V_221 ;
V_45 -> V_212 . V_216 = V_45 -> V_219 . V_222 ;
} else {
V_45 -> V_212 . V_216 |= V_123 ;
}
}
void F_74 ( struct V_8 * V_9 , T_3 V_123 )
{
struct V_44 * V_45 = F_17 ( V_9 ) ;
V_45 -> V_212 . V_216 &= V_123 ;
}
void F_75 ( struct V_8 * V_9 , T_1 V_123 )
{
F_18 ( V_9 , V_223 , V_123 ) ;
}
...
bool F_77 ( struct V_8 * V_9 )
{
bool V_190 ;
T_3 V_225 ;
if ( ( V_9 -> V_226 == true ) ||
( V_9 -> V_179 . V_227 == V_228 ) ) {
V_190 = true ;
} else {
V_225 = F_39 ( V_9 , V_127 ) ;
if ( V_225 & 0x00070000 )
V_190 = false ;
else
V_190 = true ;
...
bool F_78 ( struct V_8 * V_9 )
{
T_3 V_229 ;
V_229 = F_39 ( V_9 , V_230 ) ;
return ( ( V_229 & 0x0000ff00 ) == 0 ) ? true : false ;
}
