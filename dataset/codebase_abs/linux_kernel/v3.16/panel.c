...
static T_1 F_37 ( struct V_87 * V_87 ,
const char T_2 * V_88 , T_3 V_89 , T_4 * V_90 )
{
const char T_2 * V_91 = V_88 ;
char V_56 ;
...
static int F_40 ( struct V_93 * V_93 , struct V_87 * V_87 )
{
if ( V_94 )
return - V_95 ;
if ( V_87 -> V_96 & V_97 )
...
V_94 ++ ;
return F_41 ( V_93 , V_87 ) ;
}
static int F_42 ( struct V_93 * V_93 , struct V_87 * V_87 )
{
V_94 -- ;
return 0 ;
}
static void F_43 ( const char * V_100 )
{
...
static T_1 F_48 ( struct V_87 * V_87 ,
char T_2 * V_88 , T_3 V_89 , T_4 * V_90 )
{
unsigned V_136 = * V_90 ;
char T_2 * V_91 = V_88 ;
if ( V_137 == 0 ) {
...
for (; V_89 -- > 0 && ( V_137 > 0 ) ;
++ V_136 , ++ V_91 , -- V_137 ) {
F_50 ( V_143 [ V_144 ] , V_91 ) ;
V_144 = ( V_144 + 1 ) % V_145 ;
}
* V_90 = V_136 ;
return V_91 - V_88 ;
}
static int F_51 ( struct V_93 * V_93 , struct V_87 * V_87 )
{
if ( V_146 )
return - V_95 ;
if ( V_87 -> V_96 & V_147 )
...
static int F_52 ( struct V_93 * V_93 , struct V_87 * V_87 )
{
V_146 -- ;
return 0 ;
}
...
for ( V_204 = 0 ; ( V_204 < sizeof( V_199 ) ) && ( V_199 [ V_204 ] != * V_196 ) ;
V_204 ++ )
;
