...
{
V_2 -> V_16 -> V_30 = V_2 -> V_16 -> V_25 = V_2 -> V_16 -> V_28 = 0 ;
V_2 -> V_16 -> V_13 = 0 ;
( void ) F_11 ( V_2 ) ;
}
static int F_14 ( struct V_1 * V_2 , T_1 V_31 )
{
if ( V_31 & V_5 ) {
if ( ! F_15 ( V_32 , & V_2 -> V_13 ) )
...
static int F_65 ( struct V_1 * V_2 , T_1 V_31 )
{
if ( V_31 & V_5 ) {
if ( ! F_15 ( V_32 , & V_2 -> V_13 ) ) {
F_3 ( L_19 ) ;
...
if ( F_76 ( V_20 ) && sscanf ( V_105 , L_20 , & V_69 ) == 1 ) {
...
if ( F_29 ( V_20 ) )
return V_20 ;
V_20 = F_79 ( V_67 , L_21 , NULL , & V_41 ) ;
if ( F_29 ( V_20 ) )
return V_20 ;
V_2 -> V_52 = V_41 ;
V_41 = 0 ;
F_79 ( V_67 , L_22 , NULL , & V_41 ) ;
V_2 -> V_48 = V_41 ;
V_2 -> V_67 = V_67 ;
return V_113 ;
}
...
V_64 = V_2 ;
V_118 -> V_124 = V_2 ;
V_14 = ! ! F_91 ( V_2 -> V_10 , 1 , L_27 ) ;
F_92 ( ! V_14 , L_28 , V_2 -> V_10 ) ;
V_14 = ! ! F_91 ( V_2 -> V_4 , 1 , L_29 ) ;
F_92 ( ! V_14 , L_30 , V_2 -> V_4 ) ;
F_33 ( L_31 ,
