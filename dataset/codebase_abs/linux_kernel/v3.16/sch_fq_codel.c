...
static int F_42 ( struct V_17 * V_18 , struct V_71 * V_72 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
int V_40 ;
V_18 -> V_56 = 10 * 1024 ;
V_2 -> V_16 = 1024 ;
V_2 -> V_55 = F_43 ( F_44 ( V_18 ) ) ;
V_2 -> V_14 = F_45 () ;
F_46 ( & V_2 -> V_52 ) ;
F_46 ( & V_2 -> V_66 ) ;
F_47 ( & V_2 -> V_70 ) ;
...
static int F_50 ( struct V_17 * V_18 , struct V_3 * V_4 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
struct V_71 * V_97 ;
V_97 = F_51 ( V_4 , V_98 ) ;
...
V_2 -> V_16 ) )
goto V_99;
return F_54 ( V_4 , V_97 ) ;
V_99:
return - 1 ;
}
static int F_55 ( struct V_17 * V_18 , struct V_100 * V_101 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
struct V_102 V_103 = {
. type = V_104 ,
...
F_56 (pos, &q->new_flows)
V_103 . V_106 . V_108 ++ ;
F_56 (pos, &q->old_flows)
V_103 . V_106 . V_109 ++ ;
return F_57 ( V_101 , & V_103 , sizeof( V_103 ) ) ;
}
static struct V_17 * F_58 ( struct V_17 * V_18 , unsigned long V_110 )
{
return NULL ;
}
static unsigned long F_59 ( struct V_17 * V_18 , V_9 V_32 )
{
return 0 ;
}
static unsigned long F_60 ( struct V_17 * V_18 , unsigned long V_111 ,
V_9 V_32 )
{
V_18 -> V_95 &= ~ V_96 ;
return 0 ;
}
static void F_61 ( struct V_17 * V_2 , unsigned long V_112 )
{
}
static struct V_113 * * F_62 ( struct V_17 * V_18 , unsigned long V_112 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
if ( V_112 )
return NULL ;
...
static int F_63 ( struct V_17 * V_18 , unsigned long V_112 ,
struct V_3 * V_4 , struct V_114 * V_115 )
{
V_115 -> V_116 |= F_7 ( V_112 ) ;
return 0 ;
}
static int F_64 ( struct V_17 * V_18 , unsigned long V_112 ,
struct V_100 * V_101 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
V_9 V_39 = V_112 - 1 ;
...
if ( F_66 ( V_101 , & V_118 ) < 0 )
return - 1 ;
if ( V_39 < V_2 -> V_16 )
return F_57 ( V_101 , & V_119 , sizeof( V_119 ) ) ;
return 0 ;
}
static void F_67 ( struct V_17 * V_18 , struct V_128 * V_110 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
unsigned int V_40 ;
if ( V_110 -> V_129 )
