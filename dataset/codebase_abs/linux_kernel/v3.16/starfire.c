...
struct V_223 * V_224 = F_57 ( V_2 , V_6 -> V_129 ) ;
V_6 -> V_225 [ V_17 ] . V_224 = V_224 ;
if ( V_224 == NULL )
break;
V_6 -> V_225 [ V_17 ] . V_226 = F_58 ( V_6 -> V_11 , V_224 -> V_193 , V_6 -> V_129 , V_227 ) ;
V_6 -> V_127 [ V_17 ] . V_228 = F_59 ( V_6 -> V_225 [ V_17 ] . V_226 | V_229 ) ;
}
F_46 ( V_17 - 1 , V_6 -> V_22 + V_230 ) ;
...
V_6 -> V_127 [ V_118 - 1 ] . V_228 |= F_59 ( V_231 ) ;
...
static T_6 F_60 ( struct V_223 * V_224 , struct V_1 * V_2 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
unsigned int V_234 ;
T_7 V_232 ;
int V_17 ;
if ( ( V_6 -> V_216 - V_6 -> V_219 ) + F_61 ( V_224 ) * 2 > V_116 ) {
F_62 ( V_2 ) ;
return V_235 ;
}
#if F_27 ( F_23 ) && F_27 ( V_236 )
if ( V_224 -> V_237 == V_238 ) {
if ( F_63 ( V_224 , ( V_224 -> V_239 + V_240 ) & ~ V_240 ) )
return V_241 ;
}
#endif
V_234 = V_6 -> V_216 % V_116 ;
for ( V_17 = 0 ; V_17 < F_61 ( V_224 ) ; V_17 ++ ) {
int V_242 = 0 ;
V_232 = V_243 ;
if ( V_17 == 0 ) {
V_6 -> V_233 [ V_234 ] . V_224 = V_224 ;
V_232 |= V_244 ;
if ( V_234 >= V_116 - F_61 ( V_224 ) ) {
V_232 |= V_245 ;
V_242 = 1 ;
}
if ( V_6 -> V_217 ) {
...
V_232 |= F_64 ( V_224 ) | ( F_61 ( V_224 ) << 16 ) ;
V_6 -> V_233 [ V_234 ] . V_226 =
F_58 ( V_6 -> V_11 , V_224 -> V_193 , F_64 ( V_224 ) , V_249 ) ;
} else {
const T_8 * V_250 = & F_65 ( V_224 ) -> V_251 [ V_17 - 1 ] ;
V_232 |= F_66 ( V_250 ) ;
V_6 -> V_233 [ V_234 ] . V_226 =
F_58 ( V_6 -> V_11 ,
F_67 ( V_250 ) ,
...
V_6 -> V_125 [ V_234 ] . V_252 = F_59 ( V_6 -> V_233 [ V_234 ] . V_226 ) ;
V_6 -> V_125 [ V_234 ] . V_232 = F_68 ( V_232 ) ;
if ( V_8 > 3 )
F_4 ( V_109 L_32 ,
...
F_4 ( V_109 L_35 ,
V_2 -> V_9 , V_256 ) ;
while ( ( V_257 = F_73 ( V_6 -> V_121 [ V_6 -> V_221 ] . V_232 ) ) != 0 ) {
if ( V_8 > 3 )
F_4 ( V_109 L_36 ,
...
{
int V_17 ;
for ( V_17 = 0 ; V_17 < F_65 ( V_224 ) -> V_264 ; V_17 ++ ) {
F_74 ( V_6 -> V_11 ,
V_6 -> V_233 [ V_234 ] . V_226 ,
F_66 ( & F_65 ( V_224 ) -> V_251 [ V_17 ] ) ,
V_249 ) ;
V_6 -> V_219 ++ ;
V_234 ++ ;
}
...
static int F_81 ( struct V_1 * V_2 , int * V_267 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
T_7 V_268 ;
int V_269 = 0 ;
while ( ( V_268 = F_73 ( V_6 -> V_123 [ V_6 -> V_220 ] . V_232 ) ) != 0 ) {
struct V_223 * V_224 ;
T_2 V_270 ;
int V_234 ;
...
if ( V_270 < V_278 &&
( V_224 = F_57 ( V_2 , V_270 + 2 ) ) != NULL ) {
F_82 ( V_224 , 2 ) ;
F_83 ( V_6 -> V_11 ,
V_6 -> V_225 [ V_234 ] . V_226 ,
V_270 , V_227 ) ;
F_84 ( V_224 , V_6 -> V_225 [ V_234 ] . V_224 -> V_193 , V_270 ) ;
F_85 ( V_6 -> V_11 ,
V_6 -> V_225 [ V_234 ] . V_226 ,
V_270 , V_227 ) ;
F_86 ( V_224 , V_270 ) ;
} else {
F_74 ( V_6 -> V_11 , V_6 -> V_225 [ V_234 ] . V_226 , V_6 -> V_129 , V_227 ) ;
...
#endif
V_224 -> V_279 = F_87 ( V_224 , V_2 ) ;
#ifdef F_24
if ( V_8 > 4 )
F_4 ( V_109 L_44 , V_6 -> V_220 , F_88 ( V_271 -> V_280 ) ) ;
#endif
if ( F_88 ( V_271 -> V_280 ) & 0x0100 ) {
V_224 -> V_237 = V_281 ;
V_2 -> V_213 . V_282 ++ ;
}
else if ( F_88 ( V_271 -> V_280 ) & 0x0040 ) {
V_224 -> V_237 = V_283 ;
V_224 -> V_284 = F_88 ( V_271 -> V_284 ) ;
F_4 ( V_109 L_45 , V_2 -> V_9 , F_88 ( V_271 -> V_280 ) ) ;
}
#ifdef F_24
if ( F_88 ( V_271 -> V_280 ) & 0x0200 ) {
T_2 V_285 = F_88 ( V_271 -> V_286 ) ;
if ( V_8 > 4 ) {
F_4 ( V_109 L_46 ,
V_285 ) ;
}
F_89 ( V_224 , F_90 ( V_183 ) , V_285 ) ;
}
#endif
F_91 ( V_224 ) ;
V_2 -> V_213 . V_287 ++ ;
...
{
struct V_5 * V_6 = F_93 ( V_70 , struct V_5 , V_70 ) ;
...
V_224 = F_57 ( V_2 , V_6 -> V_129 ) ;
V_6 -> V_225 [ V_234 ] . V_224 = V_224 ;
if ( V_224 == NULL )
break;
V_6 -> V_225 [ V_234 ] . V_226 =
F_58 ( V_6 -> V_11 , V_224 -> V_193 , V_6 -> V_129 , V_227 ) ;
V_6 -> V_127 [ V_234 ] . V_228 =
F_59 ( V_6 -> V_225 [ V_234 ] . V_226 | V_229 ) ;
}
if ( V_234 == V_118 - 1 )
V_6 -> V_127 [ V_234 ] . V_228 |= F_59 ( V_231 ) ;
}
if ( V_234 >= 0 )
F_46 ( V_234 , V_6 -> V_22 + V_230 ) ;
}
...
static void F_79 ( struct V_1 * V_2 , int V_259 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_259 & V_304 ) {
...
static struct V_309 * F_77 ( struct V_1 * V_2 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
void T_3 * V_21 = V_6 -> V_22 ;
...
V_2 -> V_213 . V_315 += F_96 ( V_21 + V_316 ) ;
F_46 ( 0 , V_21 + V_316 ) ;
...
static T_7 F_97 ( struct V_5 * V_6 )
{
T_7 V_321 = V_322 ;
T_2 V_4 ;
...
F_46 ( F_47 ( V_163 [ 2 ] ) , V_323 ) ; V_323 += 4 ;
F_46 ( F_47 ( V_163 [ 1 ] ) , V_323 ) ; V_323 += 4 ;
F_46 ( F_47 ( V_163 [ 0 ] ) , V_323 ) ; V_323 += 8 ;
}
V_163 = ( T_1 * ) V_2 -> V_42 ;
V_17 = F_99 ( V_2 ) + 2 ;
while ( V_17 ++ < 16 ) {
F_46 ( F_47 ( V_163 [ 0 ] ) , V_323 ) ; V_323 += 4 ;
F_46 ( F_47 ( V_163 [ 1 ] ) , V_323 ) ; V_323 += 4 ;
F_46 ( F_47 ( V_163 [ 2 ] ) , V_323 ) ; V_323 += 8 ;
}
V_327 |= V_336 | V_338 ;
} else {
void T_3 * V_323 ;
T_1 * V_163 ;
T_10 V_339 [ 32 ] V_340 ( ( F_101 ( sizeof( long ) ) ) ) ;
memset ( V_339 , 0 , sizeof( V_339 ) ) ;
F_100 (ha, dev) {
int V_341 = F_102 ( V_342 , V_330 -> V_252 ) >> 23 ;
T_11 * V_343 = ( T_11 * ) & V_339 [ ( V_341 >> 4 ) & ~ 1 ] ;
* V_343 |= F_68 ( 1 << ( V_341 & 31 ) ) ;
}
...
static void F_105 ( struct V_1 * V_2 , struct V_346 * V_347 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_106 ( V_347 -> V_348 , V_32 , sizeof( V_347 -> V_348 ) ) ;
F_106 ( V_347 -> V_27 , V_349 , sizeof( V_347 -> V_27 ) ) ;
F_106 ( V_347 -> V_350 , F_107 ( V_6 -> V_11 ) , sizeof( V_347 -> V_350 ) ) ;
}
static int F_108 ( struct V_1 * V_2 , struct V_351 * V_352 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_109 ( & V_6 -> V_7 ) ;
F_110 ( & V_6 -> V_48 , V_352 ) ;
F_111 ( & V_6 -> V_7 ) ;
return 0 ;
}
static int F_112 ( struct V_1 * V_2 , struct V_351 * V_352 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_353 ;
F_109 ( & V_6 -> V_7 ) ;
V_353 = F_113 ( & V_6 -> V_48 , V_352 ) ;
F_111 ( & V_6 -> V_7 ) ;
F_50 ( V_2 ) ;
return V_353 ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_115 ( & V_6 -> V_48 ) ;
}
static T_7 F_116 ( struct V_1 * V_2 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_117 ( & V_6 -> V_48 ) ;
}
static T_7 F_118 ( struct V_1 * V_2 )
{
return V_8 ;
}
static void F_119 ( struct V_1 * V_2 , T_7 V_354 )
{
V_8 = V_354 ;
}
static int F_120 ( struct V_1 * V_2 , struct V_355 * V_356 , int V_357 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_358 * V_193 = F_121 ( V_356 ) ;
int V_359 ;
if ( ! F_104 ( V_2 ) )
return - V_189 ;
F_109 ( & V_6 -> V_7 ) ;
V_359 = F_122 ( & V_6 -> V_48 , V_193 , V_357 , NULL ) ;
F_111 ( & V_6 -> V_7 ) ;
...
F_4 ( V_109 L_57 ,
V_17 , F_73 ( V_6 -> V_125 [ V_17 ] . V_232 ) ,
( long long ) F_124 ( V_6 -> V_125 [ V_17 ] . V_252 ) ,
F_73 ( V_6 -> V_121 [ V_17 ] . V_232 ) ) ;
F_4 ( V_109 L_58 ,
( long long ) V_6 -> V_128 , V_6 -> V_123 ) ;
if ( V_6 -> V_123 )
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ ) {
F_4 ( V_109 L_59 ,
V_17 , ( long long ) F_124 ( V_6 -> V_127 [ V_17 ] . V_228 ) , F_73 ( V_6 -> V_123 [ V_17 ] . V_232 ) ) ;
}
}
F_42 ( V_6 -> V_11 -> V_18 , V_2 ) ;
for ( V_17 = 0 ; V_17 < V_118 ; V_17 ++ ) {
V_6 -> V_127 [ V_17 ] . V_228 = F_59 ( 0xBADF00D0 ) ;
if ( V_6 -> V_225 [ V_17 ] . V_224 != NULL ) {
F_74 ( V_6 -> V_11 , V_6 -> V_225 [ V_17 ] . V_226 , V_6 -> V_129 , V_227 ) ;
F_125 ( V_6 -> V_225 [ V_17 ] . V_224 ) ;
}
V_6 -> V_225 [ V_17 ] . V_224 = NULL ;
V_6 -> V_225 [ V_17 ] . V_226 = 0 ;
}
...
static int F_126 ( struct V_11 * V_12 , T_12 V_361 )
{
struct V_1 * V_2 = F_127 ( V_12 ) ;
if ( F_104 ( V_2 ) ) {
F_128 ( V_2 ) ;
F_54 ( V_2 ) ;
}
F_129 ( V_12 ) ;
F_130 ( V_12 , F_131 ( V_12 , V_361 ) ) ;
return 0 ;
}
...
F_137 ( V_2 ) ;
if ( V_6 -> V_110 )
F_138 ( V_12 , V_6 -> V_119 , V_6 -> V_110 , V_6 -> V_120 ) ;
F_130 ( V_12 , V_363 ) ;
F_139 ( V_12 ) ;
F_36 ( V_6 -> V_22 ) ;
F_37 ( V_12 ) ;
...
#endif
F_141 ( sizeof( V_364 ) != sizeof( V_365 ) ) ;
return F_142 ( & V_366 ) ;
}
