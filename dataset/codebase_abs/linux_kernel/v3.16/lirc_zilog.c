...
static T_2 F_54 ( struct V_86 * V_87 , char T_3 * V_88 , T_4 V_89 ,
T_5 * V_90 )
{
...
static T_2 F_64 ( struct V_86 * V_87 , const char T_3 * V_51 , T_4 V_89 ,
T_5 * V_90 )
{
struct V_1 * V_2 = V_87 -> V_91 ;
struct V_21 * V_22 ;
...
static unsigned int F_66 ( struct V_86 * V_87 , T_6 * V_95 )
{
struct V_1 * V_2 = V_87 -> V_91 ;
struct V_14 * V_15 ;
struct V_32 * V_10 = V_2 -> V_7 . V_10 ;
...
switch ( V_111 ) {
case V_115 :
V_113 = F_69 ( 13UL , V_112 ) ;
break;
case V_116 :
V_113 = F_69 ( V_18 , V_112 ) ;
break;
case V_117 :
if ( ! ( V_18 & V_118 ) )
return - V_119 ;
...
if ( ! ( V_18 & V_118 ) )
return - V_119 ;
V_113 = F_71 ( V_114 , V_112 ) ;
if ( ! V_113 && ! ( F_72 ( V_114 ) & V_18 ) )
V_113 = - V_98 ;
break;
case V_121 :
if ( ! ( V_18 & V_122 ) )
return - V_119 ;
V_113 = F_69 ( V_123 , V_112 ) ;
break;
case V_124 :
if ( ! ( V_18 & V_122 ) )
return - V_119 ;
...
static int F_76 ( struct V_126 * V_127 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
unsigned int V_8 = F_77 ( V_127 -> V_128 ) ;
V_2 = F_73 ( V_8 ) ;
if ( V_2 == NULL )
return - V_129 ;
F_78 ( & V_2 -> V_46 ) ;
...
static int F_80 ( struct V_126 * V_127 , struct V_86 * V_87 )
{
struct V_1 * V_2 = V_87 -> V_91 ;
if ( V_2 == NULL ) {
F_30 ( L_50 ) ;
...
{
if ( strncmp ( L_51 , V_131 -> V_132 , 8 ) == 0 ) {
struct V_21 * V_22 = F_83 ( V_131 ) ;
if ( V_22 != NULL ) {
F_3 ( & V_22 -> V_35 ) ;
V_22 -> V_36 = NULL ;
F_4 ( & V_22 -> V_35 ) ;
...
} else if ( strncmp ( L_52 , V_131 -> V_132 , 8 ) == 0 ) {
struct V_14 * V_15 = F_83 ( V_131 ) ;
if ( V_15 != NULL ) {
F_3 ( & V_15 -> V_35 ) ;
V_15 -> V_36 = NULL ;
F_4 ( & V_15 -> V_35 ) ;
...
static struct V_1 * F_84 ( struct V_133 * V_134 )
{
struct V_1 * V_2 ;
if ( F_74 ( & V_125 ) )
return NULL ;
...
static int F_85 ( struct V_130 * V_131 , const struct V_135 * V_58 )
{
struct V_1 * V_2 ;
struct V_21 * V_22 ;
struct V_14 * V_15 ;
...
bool V_137 = false ;
F_27 ( L_53 ,
V_138 , V_58 -> V_132 , V_136 -> V_139 , V_136 -> V_132 , V_131 -> V_140 ) ;
if ( V_58 -> V_141 & V_142 )
V_137 = true ;
else if ( V_143 )
return - V_34 ;
F_86 ( L_54 ,
V_137 ? L_55 : L_56 , V_136 -> V_132 , V_136 -> V_139 ) ;
F_3 ( & V_5 ) ;
V_2 = F_84 ( V_136 ) ;
if ( V_2 == NULL ) {
V_2 = F_87 ( sizeof( struct V_1 ) , V_144 ) ;
if ( V_2 == NULL ) {
V_29 = - V_85 ;
goto V_145;
}
...
if ( V_137 ) {
V_15 = F_13 ( V_2 ) ;
V_22 = F_87 ( sizeof( struct V_21 ) , V_144 ) ;
if ( V_22 == NULL ) {
V_29 = - V_85 ;
goto V_150;
}
...
V_22 -> V_41 = 1 ;
V_22 -> V_106 =
( V_58 -> V_141 & V_151 ) ? false : true ;
V_22 -> V_2 = F_1 ( V_2 , true ) ;
F_95 ( V_131 , F_22 ( V_2 ) ) ;
F_50 ( V_22 ) ;
if ( V_15 == NULL && ! V_143 ) {
F_86 ( L_57
L_58 , V_136 -> V_132 , V_136 -> V_139 ) ;
goto V_152;
}
} else {
V_22 = F_22 ( V_2 ) ;
V_15 = F_87 ( sizeof( struct V_14 ) , V_144 ) ;
if ( V_15 == NULL ) {
V_29 = - V_85 ;
goto V_150;
}
...
V_145:
F_30 ( L_67 ,
V_138 , V_137 ? L_55 : L_56 , V_136 -> V_132 , V_136 -> V_139 ,
V_29 ) ;
F_4 ( & V_5 ) ;
return V_29 ;
}
