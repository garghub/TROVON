...
V_195 -> V_231 . V_244 = V_233 ;
V_195 -> V_231 . V_245 = V_235 ;
V_195 -> V_231 . V_246 = F_140 ;
V_195 -> V_231 . V_247 = F_143 ;
V_195 -> V_231 . V_248 = F_144 ;
V_19 -> V_195 = V_195 ;
V_19 -> V_48 = V_47 -> V_193 . V_2 ;
snprintf ( V_216 , sizeof( V_216 ) , L_29 ,
V_237 -> V_233 . V_249 . V_250 . V_251 , V_237 -> V_233 . V_249 . V_250 . V_252 ) ;
V_19 -> V_6 = F_127 ( & V_225 , V_216 , L_30 , V_19 ) ;
if ( F_128 ( V_19 -> V_6 ) ) {
V_7 = F_129 ( V_19 -> V_6 ) ;
goto V_226;
...
struct V_232 * * V_233 ;
int V_253 ;
for ( V_253 = 0 , V_233 = V_47 -> V_233 ; V_47 -> V_254 [ V_253 ] ; V_253 ++ ) {
F_145 ( V_47 , V_233 , V_47 -> V_254 [ V_253 ] ) ;
V_233 += V_47 -> V_254 [ V_253 ] ;
}
}
...
if ( V_7 < 0 && V_7 != - V_218 )
goto V_117;
} else if ( ! V_211 -> V_256 || ! V_211 -> V_257 ) {
V_7 = - V_64 ;
goto V_117;
} else {
F_56 ( & V_47 -> V_114 ) ;
...
goto V_117;
if ( V_211 -> V_258 )
V_7 = F_155 ( V_211 -> V_258 ) ;
V_7 = V_211 -> V_256 ( V_19 ) ;
if ( V_7 < 0 )
goto V_259;
V_228 = F_65 ( V_19 ) ;
if ( ! V_228 || ! V_228 -> V_162 || ! F_156 ( V_228 ) ||
...
struct V_262 * V_263 = V_2 ? V_2 -> V_162 : NULL ;
if ( V_263 ) {
V_129 -> V_212 . V_257 ( V_19 ) ;
F_71 ( V_263 -> V_123 ) ;
}
}
if ( V_19 -> V_29 )
...
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
return F_14 ( V_21 , V_76 , V_264 , V_75 ) ;
}
static int F_163 ( struct V_18 * V_19 , const struct V_169 * V_75 )
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
return F_14 ( V_21 , V_76 , V_265 , V_75 ) ;
}
static int F_164 ( struct V_18 * V_19 ,
struct V_188 * V_266 )
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
return F_14 ( V_21 , V_76 , V_267 , V_266 ) ;
}
static int F_165 ( struct V_18 * V_19 ,
struct V_188 * V_266 )
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
return F_14 ( V_21 , V_76 , V_268 , V_266 ) ;
}
...
struct V_20 * V_21 = F_13 ( V_19 ) ;
const struct V_26 * V_49 ;
T_7 V_269 = V_81 -> V_270 ;
struct V_80 V_271 = * V_81 ;
V_49 = F_16 ( V_19 , V_269 ) ;
if ( ! V_49 )
return - V_64 ;
V_271 . V_270 = V_49 -> V_100 ;
V_7 = F_14 ( V_21 , V_76 , V_82 , & V_271 ) ;
if ( V_7 < 0 )
return V_7 ;
* V_81 = V_271 ;
V_81 -> V_270 = V_269 ;
...
if ( ! V_47 -> V_62 -> V_82 )
V_47 -> V_62 -> V_82 = F_166 ;
F_56 ( & V_121 ) ;
F_106 (ix, &hosts, list) {
if ( V_272 -> V_192 == V_47 -> V_192 ) {
V_7 = - V_86 ;
goto V_273;
}
}
...
int V_278 = - 1 , V_28 ;
F_56 ( & V_121 ) ;
for ( V_28 = 0 ; V_28 < 256 && V_278 < 0 ; V_28 ++ ) {
V_278 = V_28 ;
F_106 (ix, &devices, list) {
if ( V_272 -> V_191 == V_19 -> V_191 && V_272 -> V_279 == V_28 ) {
V_278 = - 1 ;
break;
}
}
...
V_120 -> V_288 = & V_47 -> V_125 ;
V_19 -> V_120 = V_120 ;
return 0 ;
}
static int F_123 ( struct V_18 * V_19 )
{
const struct V_289 * type = V_19 -> V_120 -> V_2 . type ;
int V_7 ;
if ( ! V_19 -> V_48 )
return - V_25 ;
F_183 ( V_19 -> V_120 , V_19 ) ;
if ( V_19 -> V_120 -> V_203 == 0 ) {
F_184 ( V_19 -> V_120 , V_290 ) ;
F_184 ( V_19 -> V_120 , V_291 ) ;
F_184 ( V_19 -> V_120 , V_292 ) ;
}
V_7 = F_185 ( V_19 -> V_120 , V_293 , - 1 ) ;
if ( V_7 < 0 ) {
...
static int F_186 ( struct V_196 * V_53 )
{
...
static int F_188 ( struct V_196 * V_53 )
{
