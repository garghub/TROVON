...
{
V_15 = 1 ;
V_56 . V_41 = F_21 ( V_18 . V_42 ,
V_56 . V_40 ) ;
return F_22 ( & V_56 ) ;
}
static void F_23 ( enum V_24 V_25 ,
struct V_26 * V_27 )
{
int V_57 = F_24 ( V_27 -> V_38 ) ;
switch ( V_25 ) {
case V_28 :
V_18 . V_58 ( V_57 ,
V_59 / V_60 ) ;
...
static int F_25 ( unsigned long V_63 ,
struct V_26 * V_27 )
{
int V_57 = F_24 ( V_27 -> V_38 ) ;
...
void F_26 ( int V_57 )
{
struct V_26 * V_31 = & F_27 ( V_65 , V_57 ) ;
...
V_31 -> V_41 = F_13 ( V_18 . V_42 , V_43 ,
V_31 -> V_40 ) ;
V_31 -> V_69 = F_29 ( V_18 . V_42 , V_31 ) ;
V_31 -> V_70 = F_29 ( 100 , V_31 ) ;
F_14 ( V_31 ) ;
}
static unsigned char F_30 ( struct V_71 * V_72 , T_4 V_73 )
{
struct V_74 * V_75 = F_31 ( V_72 ) ;
struct V_76 * V_77 = V_75 -> V_72 . V_78 ;
return F_32 ( V_77 -> V_79 + V_73 ) ;
}
static void F_33 ( struct V_71 * V_72 , T_4 V_73 , T_7 V_44 )
{
struct V_74 * V_75 = F_31 ( V_72 ) ;
struct V_76 * V_77 = V_75 -> V_72 . V_78 ;
F_34 ( V_44 , V_77 -> V_79 + V_73 ) ;
}
static int F_35 ( struct V_74 * V_80 )
{
struct V_81 * V_82 = V_80 -> V_72 . V_83 ;
const char * V_84 = F_36 ( V_82 , L_3 , NULL ) ;
if ( ! V_84 )
return - V_85 ;
if ( ! F_37 ( V_82 , L_4 , NULL ) )
return - V_85 ;
V_86 . V_87 = & V_80 -> V_87 [ 0 ] ;
if ( ! strcmp ( V_84 , L_5 ) ) {
V_88 . V_79 = F_38 ( & V_80 -> V_87 [ 0 ] , 0 ,
2048 , L_6 ) ;
V_88 . type = V_89 ;
...
{
struct V_98 * V_99 = F_49 ( L_9 ) ;
int V_100 = - 1 ;
if ( V_99 ) {
V_100 = F_50 ( V_99 , V_97 ) ;
F_51 ( V_99 ) ;
}
return V_100 ;
}
