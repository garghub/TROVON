...
V_35 . V_50 ++ ;
V_51 ;
if ( ! F_42 ( V_20 , V_34 , & V_35 , V_48 ) ) {
F_3 ( L_14 ,
V_8 ) ;
goto V_11;
}
if ( ! F_42 ( V_20 , V_34 , & V_35 , V_50 ) ) {
F_3 ( L_15 , V_8 ) ;
goto V_11;
}
V_8 = TRUE ;
...
BOOL
F_44 ( T_1 * V_20 , T_8 V_34 , void * V_49 )
{
BOOL V_8 = FALSE ;
T_9 V_35 ;
if ( V_20 -> V_6 )
...
V_35 . V_53 ++ ;
V_51 ;
if ( ! F_42 ( V_20 , V_34 , & V_35 , V_47 ) ) {
F_3 ( L_18 ,
V_8 ) ;
goto V_11;
}
if ( ! F_42 ( V_20 , V_34 , & V_35 , V_53 ) ) {
F_3 ( L_19 , V_8 ) ;
goto V_11;
}
V_8 = TRUE ;
...
static void
F_47 ( T_9 * V_59 , int V_60 , struct V_61 * V_62 )
{
F_48 ( V_62 , L_20 , V_60 ) ;
F_48 ( V_62 , L_21 , ( T_3 ) V_59 -> V_63 ) ;
F_48 ( V_62 , L_22 , ( T_3 ) V_59 -> Type ) ;
F_48 ( V_62 , L_23 ,
( long long ) V_59 -> V_64 ) ;
F_48 ( V_62 , L_24 , ( T_3 ) V_59 -> V_41 ) ;
F_48 ( V_62 , L_25 ,
( T_3 ) V_59 -> V_46 ) ;
F_48 ( V_62 , L_26 , ( T_3 ) V_59 -> V_58 ) ;
F_48 ( V_62 , L_27 ,
( long long ) V_59 -> V_65 ) ;
F_48 ( V_62 , L_28 ,
( long long ) V_59 -> V_53 ) ;
...
F_48 ( V_62 , L_30 ,
( long long ) V_59 -> V_52 ) ;
F_48 ( V_62 , L_31 , ( T_3 ) V_59 -> V_47 ) ;
F_48 ( V_62 , L_32 , ( T_3 ) V_59 -> V_48 ) ;
}
void
F_49 ( T_1 * V_20 , int V_66 ,
struct V_61 * V_62 , T_8 V_4 )
{
T_2 V_67 = 0 ;
T_3 V_26 = 0 , V_68 = 0 ;
T_5 * V_12 = NULL ;
...
F_48 ( V_62 , L_37 ,
V_67 + V_4 , V_26 , V_68 ) ;
F_48 ( V_62 , L_38 , & V_70 -> Type ) ;
F_48 ( V_62 , L_39 , & V_70 -> V_22 ) ;
F_48 ( V_62 , L_40 ,
( long long ) V_70 -> V_73 ) ;
F_48 ( V_62 , L_41 , ( T_3 ) V_70 -> V_74 ) ;
F_48 ( V_62 , L_42 , ( T_3 ) V_70 -> V_75 ) ;
F_48 ( V_62 , L_43 , ( T_3 ) V_70 -> V_76 ) ;
F_48 ( V_62 , L_44 , ( T_3 ) V_70 -> V_77 ) ;
F_48 ( V_62 , L_45 , ( T_3 ) V_70 -> V_78 ) ;
F_48 ( V_62 , L_46 , ( long long ) V_70 -> V_17 ) ;
F_48 ( V_62 , L_47 ,
( long long ) V_70 -> V_79 ) ;
F_48 ( V_62 , L_48 ,
( long long ) V_70 -> V_23 ) ;
...
F_54 ( V_83 , V_71 , 16 , 1 , V_84 , V_85 , TRUE ) ;
F_48 ( V_62 , L_56 , V_84 ) ;
V_83 += 16 ;
V_82 -= 16 ;
}
