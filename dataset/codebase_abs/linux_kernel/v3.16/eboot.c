...
static inline T_1 F_8 ( void * V_3 )
{
if ( V_12 -> V_25 ) {
T_8 * V_6 = V_3 ;
...
static void F_3 ( T_9 * V_39 , T_2 * V_40 )
{
unsigned long V_41 ;
T_13 V_42 ;
if ( V_12 -> V_25 ) {
...
static T_1 F_19 ( struct V_77 * V_78 )
{
T_1 V_8 ;
void * * V_79 = NULL ;
T_6 V_80 = V_81 ;
...
goto V_88;
if ( V_12 -> V_25 )
V_8 = F_18 ( V_78 , V_79 , V_26 ) ;
else
V_8 = F_16 ( V_78 , V_79 , V_26 ) ;
V_88:
F_4 ( V_23 , V_79 ) ;
return V_8 ;
}
...
struct V_62 * V_192 , T_7 V_193 )
{
struct V_62 * V_60 ;
T_1 V_8 ;
unsigned long V_26 ;
V_192 -> type = V_194 ;
V_192 -> V_50 = V_193 * sizeof( struct V_195 ) ;
V_192 -> V_63 = 0 ;
V_60 = (struct V_62 * ) ( unsigned long ) V_78 -> V_85 . V_62 ;
while ( V_60 && V_60 -> V_63 )
V_60 = (struct V_62 * ) ( unsigned long ) V_60 -> V_63 ;
if ( V_60 )
V_60 -> V_63 = ( unsigned long ) V_192 ;
else
V_78 -> V_85 . V_62 = ( unsigned long ) V_192 ;
}
static T_1 F_38 ( struct V_77 * V_78 ,
struct V_62 * V_192 , T_7 V_196 )
{
struct V_195 * V_197 = & V_78 -> V_197 [ 0 ] ;
...
int V_84 ;
V_193 = 0 ;
V_199 = V_169 -> V_200 / V_169 -> V_201 ;
for ( V_84 = 0 ; V_84 < V_199 ; V_84 ++ ) {
T_20 * V_202 ;
unsigned int V_203 = 0 ;
unsigned long V_119 = V_169 -> V_204 ;
V_202 = ( T_20 * ) ( V_119 + ( V_84 * V_169 -> V_201 ) ) ;
switch ( V_202 -> type ) {
case V_205 :
case V_206 :
case V_207 :
...
if ( V_198 && V_198 -> type == V_203 &&
( V_198 -> V_27 + V_198 -> V_26 ) == V_202 -> V_223 ) {
V_198 -> V_26 += V_202 -> V_224 << 12 ;
continue;
}
if ( V_193 == F_39 ( V_78 -> V_197 ) ) {
T_7 V_225 = ( V_199 - V_84 ) * sizeof( struct V_195 ) +
sizeof( struct V_62 ) ;
if ( ! V_192 || V_196 < V_225 )
return V_19 ;
V_197 = (struct V_195 * ) V_192 -> V_60 ;
}
V_197 -> V_27 = V_202 -> V_223 ;
V_197 -> V_26 = V_202 -> V_224 << V_226 ;
V_197 -> type = V_203 ;
V_198 = V_197 ++ ;
V_193 ++ ;
}
if ( V_193 > F_39 ( V_78 -> V_197 ) ) {
T_7 V_227 = V_193 - F_39 ( V_78 -> V_197 ) ;
F_37 ( V_78 , V_192 , V_227 ) ;
V_193 -= V_227 ;
}
V_78 -> V_228 = ( T_14 ) V_193 ;
return V_16 ;
}
static T_1 F_40 ( T_7 V_199 , struct V_62 * * V_192 ,
T_7 * V_196 )
{
T_1 V_8 ;
unsigned long V_26 ;
V_26 = sizeof( struct V_62 ) +
sizeof( struct V_195 ) * V_199 ;
if ( * V_192 ) {
F_4 ( V_23 , * V_192 ) ;
* V_192 = NULL ;
* V_196 = 0 ;
...
V_196 = 0 ;
V_236:
V_8 = F_42 ( V_17 , & V_232 , & V_229 , & V_231 ,
& V_234 , & V_230 ) ;
if ( V_8 != V_16 )
return V_8 ;
V_233 = V_199 ;
V_199 = V_229 / V_231 ;
if ( V_199 > V_233 &&
V_199 > F_39 ( V_77 -> V_197 ) ) {
T_7 V_227 = V_199 - F_39 ( V_77 -> V_197 ) ;
V_8 = F_40 ( V_227 , & V_192 , & V_196 ) ;
if ( V_8 != V_16 )
goto V_237;
F_4 ( V_23 , V_232 ) ;
goto V_236;
}
V_179 = V_25 ? V_238 : V_239 ;
memcpy ( & V_169 -> V_240 , V_179 , sizeof( T_21 ) ) ;
V_169 -> V_241 = ( unsigned long ) V_17 ;
V_169 -> V_201 = V_231 ;
V_169 -> V_242 = V_234 ;
V_169 -> V_204 = ( unsigned long ) V_232 ;
V_169 -> V_200 = V_229 ;
#ifdef F_43
V_169 -> V_243 = ( unsigned long ) V_17 >> 32 ;
V_169 -> V_244 = ( unsigned long ) V_232 >> 32 ;
#endif
V_8 = F_4 ( V_245 , V_3 , V_230 ) ;
if ( V_8 != V_16 ) {
if ( V_235 )
goto V_237;
V_235 = true ;
...
bool V_25 ;
V_12 = V_162 ;
V_251 = ( T_9 * ) ( unsigned long ) V_12 -> V_39 ;
V_3 = ( void * ) ( unsigned long ) V_12 -> V_178 ;
V_25 = V_12 -> V_25 ;
V_17 = V_251 ;
if ( V_17 -> V_85 . V_179 != V_180 )
...
F_19 ( V_77 ) ;
V_8 = F_4 ( V_21 , V_22 ,
sizeof( * V_248 ) , ( void * * ) & V_248 ) ;
if ( V_8 != V_16 ) {
F_2 ( V_17 , L_11 ) ;
goto V_187;
}
V_248 -> V_26 = 0x800 ;
V_8 = F_33 ( V_17 , V_248 -> V_26 , 8 ,
( unsigned long * ) & V_248 -> V_252 ) ;
if ( V_8 != V_16 ) {
F_2 ( V_17 , L_12 ) ;
goto V_187;
}
if ( V_85 -> V_253 != V_85 -> V_254 ) {
unsigned long V_255 = V_85 -> V_254 ;
V_8 = F_45 ( V_17 , & V_255 ,
V_85 -> V_256 , V_85 -> V_256 ,
V_85 -> V_253 ,
V_85 -> V_257 ) ;
if ( V_8 != V_16 )
goto V_187;
V_85 -> V_253 = V_85 -> V_254 ;
V_85 -> V_254 = V_255 ;
}
V_8 = F_41 ( V_77 , V_3 , V_25 ) ;
if ( V_8 != V_16 )
goto V_187;
memset ( ( char * ) V_248 -> V_252 , 0x0 , V_248 -> V_26 ) ;
V_250 = (struct V_249 * ) V_248 -> V_252 ;
V_250 += 2 ;
V_250 -> V_258 = 0xffff ;
V_250 -> V_259 = 0x0000 ;
V_250 -> V_260 = 0x0000 ;
V_250 -> type = V_261 | V_262 ;
V_250 -> V_263 = V_264 ;
V_250 -> V_265 = 0 ;
V_250 -> V_266 = 1 ;
V_250 -> V_267 = 0xf ;
