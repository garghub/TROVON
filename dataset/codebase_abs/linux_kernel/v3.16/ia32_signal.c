...
V_101 = V_81 -> V_109 -> V_110 . V_111 +
V_112 -> V_113 ;
else
V_101 = & V_68 -> V_114 ;
}
F_4 {
F_5 ( F_6 ( V_101 ) , & V_68 -> V_115 ) ;
F_5 ( * ( ( V_116 * ) & V_107 ) , ( V_116 T_2 * ) V_68 -> V_114 ) ;
} F_7 ( V_3 ) ;
if ( V_3 )
return - V_7 ;
V_38 -> V_55 = ( unsigned long ) V_68 ;
V_38 -> V_59 = ( unsigned long ) V_89 -> V_91 . V_92 . V_117 ;
V_38 -> V_66 = V_71 ;
V_38 -> V_57 = 0 ;
V_38 -> V_58 = 0 ;
F_37 ( V_50 , V_95 ) ;
...
int F_38 ( int V_71 , struct V_88 * V_89 ,
T_8 * V_69 , struct V_37 * V_38 )
{
struct V_75 T_2 * V_68 ;
void T_2 * V_101 ;
...
F_4 {
F_5 ( V_71 , & V_68 -> V_71 ) ;
F_5 ( F_6 ( & V_68 -> V_122 ) , & V_68 -> V_123 ) ;
F_5 ( F_6 ( & V_68 -> V_76 ) , & V_68 -> V_124 ) ;
if ( V_125 )
F_5 ( V_126 , & V_68 -> V_76 . V_127 ) ;
else
...
V_38 -> V_59 = ( unsigned long ) V_89 -> V_91 . V_92 . V_117 ;
V_38 -> V_66 = V_71 ;
V_38 -> V_57 = ( unsigned long ) & V_68 -> V_122 ;
