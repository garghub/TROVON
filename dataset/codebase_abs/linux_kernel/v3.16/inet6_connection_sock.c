...
int F_35 ( struct V_1 * V_2 , struct V_90 * V_91 , struct V_92 * V_93 )
{
struct V_23 * V_24 = F_8 ( V_2 ) ;
struct V_17 V_18 ;
struct V_16 * V_28 ;
...
F_39 ( V_91 , V_28 ) ;
V_18 . V_31 = V_2 -> V_76 ;
V_94 = F_40 ( V_2 , V_91 , & V_18 , V_24 -> V_33 , V_24 -> V_97 ) ;
F_41 () ;
return V_94 ;
}
struct V_16 * F_42 ( struct V_1 * V_2 , T_2 V_98 )
{
struct V_17 V_18 ;
struct V_16 * V_28 = F_32 ( V_2 , & V_18 ) ;
if ( F_14 ( V_28 ) )
return NULL ;
V_28 -> V_99 -> V_100 ( V_28 , V_2 , NULL , V_98 ) ;
V_28 = F_32 ( V_2 , & V_18 ) ;
