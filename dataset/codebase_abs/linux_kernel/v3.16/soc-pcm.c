...
if ( V_2 -> V_14 -> V_81 && V_2 -> V_14 -> V_81 -> V_111 ) {
V_40 = V_2 -> V_14 -> V_81 -> V_111 ( V_17 , V_110 ) ;
if ( V_40 < 0 )
return V_40 ;
}
return 0 ;
...
if ( V_138 == NULL )
return - V_117 ;
V_142 = F_68 ( V_5 , V_3 , & V_138 ) ;
F_8 ( V_30 -> V_36 , L_46 , V_142 ,
V_3 ? L_38 : L_39 ) ;
* V_141 = V_138 ;
return V_142 ;
}
static int F_69 ( struct V_1 * V_30 , int V_3 ,
struct V_137 * * V_141 )
{
struct V_33 * V_34 ;
...
int V_143 = 0 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
V_133 = F_65 ( V_34 -> V_35 -> V_5 , V_3 ) ;
if ( V_133 && F_66 ( V_138 , V_133 ) )
continue;
V_133 = F_65 ( V_34 -> V_35 -> V_6 , V_3 ) ;
if ( V_133 && F_66 ( V_138 , V_133 ) )
continue;
F_8 ( V_30 -> V_36 , L_47 ,
V_3 ? L_38 : L_39 ,
...
int F_71 ( struct V_1 * V_30 ,
int V_3 , struct V_137 * * V_138 , int V_146 )
{
if ( V_146 )
return F_70 ( V_30 , V_3 , V_138 ) ;
else
return F_69 ( V_30 , V_3 , V_138 ) ;
}
void F_72 ( struct V_1 * V_30 , int V_3 )
{
struct V_33 * V_34 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be)
...
static void F_73 ( struct V_1 * V_30 ,
int V_3 )
{
struct V_33 * V_34 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
int F_74 ( struct V_1 * V_30 , int V_3 )
{
struct V_33 * V_34 ;
int V_147 , V_155 = 0 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
return V_155 ;
V_158:
F_76 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
struct V_1 * V_35 = V_34 -> V_35 ;
struct V_16 * V_127 =
F_58 ( V_35 , V_3 ) ;
if ( ! F_75 ( V_30 , V_35 , V_3 ) )
...
int F_80 ( struct V_1 * V_30 , int V_3 )
{
struct V_33 * V_34 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
struct V_1 * V_35 = V_34 -> V_35 ;
...
int F_82 ( struct V_1 * V_30 , int V_3 )
{
struct V_33 * V_34 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
struct V_1 * V_35 = V_34 -> V_35 ;
...
int F_85 ( struct V_1 * V_30 , int V_3 )
{
struct V_33 * V_34 ;
int V_40 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
int F_89 ( struct V_1 * V_30 , int V_3 ,
int V_110 )
{
struct V_33 * V_34 ;
int V_40 = 0 ;
...
static int F_90 ( struct V_16 * V_17 , int V_110 )
{
struct V_1 * V_30 = V_17 -> V_39 ;
...
int F_91 ( struct V_1 * V_30 , int V_3 )
{
struct V_33 * V_34 ;
int V_40 = 0 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
V_30 -> V_34 [ V_3 ] . V_144 = V_159 ;
if ( F_93 ( & V_30 -> V_34 [ V_3 ] . V_121 ) ) {
F_12 ( V_30 -> V_36 , L_82 ,
V_30 -> V_14 -> V_37 ) ;
V_40 = - V_54 ;
goto V_83;
}
V_40 = F_91 ( V_30 , V_17 -> V_3 ) ;
if ( V_40 < 0 )
goto V_83;
V_40 = F_44 ( V_17 ) ;
if ( V_40 < 0 ) {
...
return F_95 ( V_17 , V_110 , V_181 ) ;
}
static int F_96 ( struct V_1 * V_30 , int V_3 )
{
struct V_16 * V_17 =
F_58 ( V_30 , V_3 ) ;
enum V_177 V_111 = V_30 -> V_14 -> V_111 [ V_3 ] ;
...
V_146 = F_71 ( V_30 , V_8 , & V_138 , 1 ) ;
if ( V_146 ) {
F_98 ( V_30 , V_8 ) ;
F_72 ( V_30 , V_8 ) ;
F_59 ( V_30 , V_8 ) ;
}
V_185 = F_71 ( V_30 , V_8 , & V_138 , 0 ) ;
if ( V_185 ) {
F_99 ( V_30 , V_8 ) ;
F_72 ( V_30 , V_8 ) ;
F_59 ( V_30 , V_8 ) ;
...
V_146 = F_71 ( V_30 , V_102 , & V_138 , 1 ) ;
if ( V_146 ) {
F_98 ( V_30 , V_102 ) ;
F_72 ( V_30 , V_102 ) ;
F_59 ( V_30 , V_102 ) ;
}
V_185 = F_71 ( V_30 , V_102 , & V_138 , 0 ) ;
if ( V_185 ) {
F_99 ( V_30 , V_102 ) ;
F_72 ( V_30 , V_102 ) ;
F_59 ( V_30 , V_102 ) ;
...
int F_102 ( struct V_1 * V_30 , int V_187 )
{
struct V_33 * V_34 ;
struct V_188 * V_189 =
& V_30 -> V_34 [ V_8 ] . V_121 ;
...
static int F_103 ( struct V_16 * V_126 )
{
struct V_1 * V_30 = V_126 -> V_39 ;
struct V_33 * V_34 ;
struct V_137 * V_138 ;
...
if ( F_67 ( V_30 , V_3 , & V_138 ) <= 0 ) {
F_8 ( V_30 -> V_36 , L_98 ,
V_30 -> V_14 -> V_37 , V_3 ? L_38 : L_39 ) ;
}
F_71 ( V_30 , V_3 , & V_138 , 1 ) ;
V_40 = F_79 ( V_126 ) ;
if ( V_40 < 0 ) {
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be)
V_34 -> V_118 = V_130 ;
...
int F_105 ( struct V_1 * V_2 , int V_193 )
{
struct V_76 * V_77 = V_2 -> V_77 ;
struct V_4 * V_6 = V_2 -> V_6 ;
struct V_4 * V_5 = V_2 -> V_5 ;
...
V_2 -> V_14 -> V_98 ) ;
V_40 = F_106 ( V_2 -> V_104 -> V_201 , V_196 , V_193 ,
V_63 , V_65 , & V_195 ) ;
} else {
if ( V_2 -> V_14 -> V_88 )
...
V_40 = F_107 ( V_2 -> V_104 -> V_201 , V_196 , V_193 , V_63 ,
V_65 , & V_195 ) ;
}
if ( V_40 < 0 ) {
...
if ( V_63 )
F_109 ( V_195 , V_8 , & V_2 -> V_81 ) ;
if ( V_65 )
F_109 ( V_195 , V_102 , & V_2 -> V_81 ) ;
if ( V_77 -> V_42 -> V_208 ) {
...
V_83:
F_110 ( V_2 -> V_104 -> V_36 , L_105 , V_6 -> V_37 ,
V_5 -> V_37 ) ;
return V_40 ;
}
int F_111 ( struct V_1 * V_30 , int V_3 )
{
if ( V_30 -> V_34 [ V_3 ] . V_144 == V_159 )
return 1 ;
return 0 ;
}
int F_75 ( struct V_1 * V_30 ,
struct V_1 * V_35 , int V_3 )
{
if ( ( V_30 -> V_34 [ V_3 ] . V_144 == V_159 ) ||
( ( V_30 -> V_34 [ V_3 ] . V_144 == V_145 ) &&
...
enum V_211
F_112 ( struct V_1 * V_35 , int V_3 )
{
return V_35 -> V_34 [ V_3 ] . V_118 ;
}
void F_113 ( struct V_1 * V_35 ,
int V_3 , enum V_211 V_118 )
{
V_35 -> V_34 [ V_3 ] . V_118 = V_118 ;
}
int F_83 ( struct V_1 * V_30 ,
struct V_1 * V_35 , int V_3 )
{
struct V_33 * V_34 ;
int V_118 ;
...
static char * F_115 ( enum V_211 V_118 )
{
switch ( V_118 ) {
case V_157 :
return L_106 ;
...
static T_3 F_116 ( struct V_1 * V_30 ,
...
static T_3 F_118 ( struct V_214 * V_214 , char T_5 * V_215 ,
T_4 V_155 , T_6 * V_216 )
{
struct V_1 * V_30 = V_214 -> V_39 ;
T_3 V_217 = V_218 , V_113 = 0 , V_40 = 0 ;
char * V_212 ;
V_212 = F_119 ( V_217 , V_116 ) ;
if ( ! V_212 )
return - V_117 ;
if ( V_30 -> V_5 -> V_42 -> V_63 . V_70 )
V_113 += F_116 ( V_30 , V_8 ,
V_212 + V_113 , V_217 - V_113 ) ;
if ( V_30 -> V_5 -> V_42 -> V_65 . V_70 )
V_113 += F_116 ( V_30 , V_102 ,
V_212 + V_113 , V_217 - V_113 ) ;
V_40 = F_120 ( V_215 , V_155 , V_216 , V_212 , V_113 ) ;
F_63 ( V_212 ) ;
return V_40 ;
}
