...
static int F_51 ( struct V_2 * V_4 , enum V_126 V_127 ,
unsigned long V_128 )
{
struct V_1 * V_6 ;
struct V_5 * V_9 ;
...
F_21 ( & V_6 -> V_35 , V_57 ) ;
V_6 -> V_118 = V_130 -> V_137 ;
V_6 -> V_119 = V_130 -> V_140 ;
V_6 -> V_120 = V_130 -> V_138 ;
V_6 -> V_121 = V_130 -> V_141 ;
if ( V_6 -> V_119 == 0 )
V_6 -> V_119 = 1 ;
if ( V_6 -> V_121 == 0 )
V_6 -> V_121 = 1 ;
...
{
struct V_145 * V_146 = V_144 -> V_64 . V_147 ;
struct V_148 * V_64 = & V_144 -> V_64 ;
struct V_149 * V_46 ;
struct V_5 * V_9 ;
struct V_1 * V_6 ;
struct V_150 V_151 ;
T_7 V_152 , V_153 ;
int V_154 , V_59 ;
V_9 = F_53 ( V_64 , sizeof( struct V_5 ) , V_78 ) ;
if ( ! V_9 ) {
F_25 ( V_64 , L_16 ) ;
V_154 = - V_79 ;
goto V_155;
}
V_9 -> V_40 = F_54 ( V_146 , 0 ) ;
if ( V_9 -> V_40 == V_156 ) {
F_25 ( V_64 , L_17 ) ;
V_154 = - V_139 ;
goto V_155;
...
V_152 = V_151 . V_23 ;
V_153 = F_57 ( & V_151 ) ;
if ( ! F_58 ( V_64 , V_152 , V_153 , V_160 ) ) {
F_25 ( V_64 , L_20 ) ;
V_154 = - V_161 ;
goto V_159;
}
V_9 -> V_27 = F_59 ( V_64 , V_152 , V_153 ) ;
if ( ! V_9 -> V_27 ) {
F_25 ( V_64 , L_21 ) ;
V_154 = - V_79 ;
goto V_159;
}
V_9 -> V_19 = (struct V_25 * ) ( ( V_162 * ) ( V_9 -> V_27 )
+ V_163 ) ;
V_154 = F_60 ( V_9 -> V_40 , & F_16 , 0 , V_160 , V_9 ) ;
if ( V_154 ) {
F_25 ( V_64 , L_22 ) ;
V_154 = - V_139 ;
goto V_159;
...
V_46 -> V_173 = F_51 ;
F_62 ( & V_46 -> V_7 ) ;
F_63 ( V_174 , V_46 -> V_175 ) ;
F_63 ( V_176 , V_46 -> V_175 ) ;
for ( V_59 = 0 ; V_59 < V_46 -> V_47 ; V_59 ++ ) {
V_6 = & V_9 -> V_7 [ V_59 ] ;
V_6 -> V_4 . V_148 = V_46 ;
F_64 ( & V_6 -> V_4 ) ;
F_62 ( & V_6 -> free ) ;
...
F_62 ( & V_6 -> V_39 ) ;
F_61 ( & V_6 -> V_35 ) ;
F_34 ( & V_6 -> V_4 . V_145 , & V_46 -> V_7 ) ;
}
F_65 ( & V_9 -> V_52 , F_24 , ( unsigned long ) V_9 ) ;
if ( V_9 -> V_26 ) {
F_66 ( & V_9 -> V_27 -> V_177 , V_178 ) ;
F_66 ( & V_9 -> V_27 -> V_179 , V_180 ) ;
F_66 ( & V_9 -> V_27 -> V_181 , 0 ) ;
F_66 ( & V_9 -> V_27 -> V_50 , 0xFFFF ) ;
F_66 ( & V_9 -> V_27 -> V_51 , 0xFFFF ) ;
} else {
F_66 ( & V_9 -> V_27 -> V_177 , V_182 |
V_183 | V_178 ) ;
F_66 ( & V_9 -> V_27 -> V_184 , 0 ) ;
F_66 ( & V_9 -> V_27 -> V_185 , 0 ) ;
F_66 ( & V_9 -> V_27 -> V_186 , 0 ) ;
F_66 ( & V_9 -> V_27 -> V_181 , 0 ) ;
F_66 ( & V_9 -> V_27 -> V_48 , 0xFFFFFFFF ) ;
F_66 ( & V_9 -> V_27 -> V_50 , 0xFFFFFFFF ) ;
F_66 ( & V_9 -> V_27 -> V_49 , 0xFFFFFFFF ) ;
F_66 ( & V_9 -> V_27 -> V_51 , 0xFFFFFFFF ) ;
F_66 ( & V_9 -> V_27 -> V_187 , 0 ) ;
F_66 ( & V_9 -> V_27 -> V_188 , 0 ) ;
}
F_67 ( V_64 , V_9 ) ;
V_154 = F_68 ( V_46 ) ;
if ( V_154 )
