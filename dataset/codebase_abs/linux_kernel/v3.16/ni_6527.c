...
V_41 |= F_19 ( & V_40 -> V_54 , V_40 -> V_55 ) ;
V_41 |= F_19 ( & V_40 -> V_56 , 0 ) ;
if ( V_41 )
return 3 ;
if ( V_41 )
return 4 ;
...
struct V_4 * V_5 = V_2 -> V_6 ;
void T_1 * V_7 = V_5 -> V_8 ;
F_2 ( V_60 & 0xff , V_7 + F_24 ( 0 ) ) ;
F_2 ( ( V_60 >> 8 ) & 0xff , V_7 + F_24 ( 1 ) ) ;
F_2 ( ( V_60 >> 16 ) & 0xff , V_7 + F_24 ( 2 ) ) ;
F_2 ( V_61 & 0xff , V_7 + F_25 ( 0 ) ) ;
F_2 ( ( V_61 >> 8 ) & 0xff , V_7 + F_25 ( 1 ) ) ;
F_2 ( ( V_61 >> 16 ) & 0xff , V_7 + F_25 ( 2 ) ) ;
}
...
if ( ! V_5 -> V_8 )
return - V_75 ;
if ( F_9 ( V_5 -> V_8 + V_76 ) != 0x27 )
return - V_71 ;
F_27 ( V_2 ) ;
V_69 = F_34 ( V_66 -> V_26 , F_14 , V_77 ,
V_2 -> V_73 , V_2 ) ;
if ( V_69 == 0 )
V_2 -> V_26 = V_66 -> V_26 ;
V_69 = F_35 ( V_2 , 3 ) ;
...
static int F_39 ( struct V_65 * V_2 ,
const struct V_96 * V_97 )
{
return F_40 ( V_2 , & V_98 , V_97 -> V_99 ) ;
}
