...
V_16 -> V_33 . V_42 |= V_131 ;
} else {
if ( V_16 -> V_33 . V_42 & V_131 )
return - V_130 ;
...
V_16 -> V_33 . V_42 &= V_80 ? ~ V_131 : ~ V_129 ;
F_74 () ;
}
...
for ( V_44 = 0 ; V_44 < V_16 -> V_33 . V_45 ; V_44 ++ ) {
struct V_70 * V_71 = & V_16 -> V_33 . args [ V_44 ] ;
V_5 = F_109 ( V_112 , V_71 -> type -> V_135 ,
V_71 -> V_36 , V_72 + V_71 -> V_17 ,
V_71 -> type -> V_72 , V_71 -> type -> V_136 ,
V_137 ) ;
if ( V_5 )
return V_5 ;
}
...
static bool
F_110 ( struct V_18 * V_19 , struct V_138 * V_139 )
{
struct V_140 * V_27 ;
if ( V_19 -> V_21 )
return true ;
F_23 (event, &filter->perf_events, hw.tp_list) {
if ( V_27 -> V_141 . V_142 -> V_139 == V_139 )
return true ;
}
return false ;
}
static inline bool
F_111 ( struct V_23 * V_16 , struct V_140 * V_27 )
{
return F_110 ( & V_16 -> V_19 , V_27 -> V_141 . V_142 -> V_139 ) ;
}
static int F_112 ( struct V_23 * V_16 , struct V_140 * V_27 )
{
bool V_143 ;
F_113 ( & V_16 -> V_19 . V_20 ) ;
if ( V_27 -> V_141 . V_142 ) {
F_27 ( & V_27 -> V_141 . V_144 ) ;
V_143 = V_16 -> V_19 . V_21 ||
( V_27 -> V_141 . V_142 -> V_42 & V_145 ) ||
F_111 ( V_16 , V_27 ) ;
} else {
V_16 -> V_19 . V_21 -- ;
V_143 = V_16 -> V_19 . V_21 ;
...
if ( ! V_143 )
return F_115 ( V_16 -> V_46 , V_16 -> V_17 , & V_16 -> V_24 , false ) ;
return 0 ;
}
static int F_116 ( struct V_23 * V_16 , struct V_140 * V_27 )
{
bool V_143 ;
int V_96 ;
F_113 ( & V_16 -> V_19 . V_20 ) ;
if ( V_27 -> V_141 . V_142 ) {
V_143 = V_16 -> V_19 . V_21 ||
V_27 -> V_146 || V_27 -> V_147 . V_148 ||
F_111 ( V_16 , V_27 ) ;
F_117 ( & V_27 -> V_141 . V_144 , & V_16 -> V_19 . V_22 ) ;
} else {
V_143 = V_16 -> V_19 . V_21 ;
V_16 -> V_19 . V_21 ++ ;
}
...
V_96 = 0 ;
if ( ! V_143 ) {
V_96 = F_115 ( V_16 -> V_46 , V_16 -> V_17 , & V_16 -> V_24 , true ) ;
if ( V_96 )
F_112 ( V_16 , V_27 ) ;
}
return V_96 ;
}
static bool F_118 ( struct V_149 * V_150 ,
enum V_151 V_152 , struct V_138 * V_139 )
{
struct V_23 * V_16 ;
int V_5 ;
V_16 = F_94 ( V_150 , struct V_23 , V_24 ) ;
F_119 ( & V_16 -> V_19 . V_20 ) ;
V_5 = F_110 ( & V_16 -> V_19 , V_139 ) ;
...
V_110 = F_82 ( F_11 ( V_16 ) ) ;
V_72 = V_110 + V_16 -> V_33 . V_72 + V_102 ;
V_72 = F_122 ( V_72 + sizeof( V_156 ) , sizeof( V_157 ) ) - sizeof( V_156 ) ;
if ( F_123 ( V_72 > V_158 , L_27 ) )
return;
F_124 () ;
V_154 = F_125 ( V_34 -> V_22 ) ;
if ( F_126 ( V_154 ) )
goto V_159;
V_106 = F_127 ( V_72 , V_34 -> V_27 . type , V_4 , & V_155 ) ;
if ( ! V_106 )
goto V_159;
if ( F_11 ( V_16 ) ) {
V_106 -> V_14 [ 0 ] = V_101 ;
...
int V_160 = V_16 -> V_33 . V_72 + V_102 ;
memset ( V_109 + V_160 , 0 , V_72 - V_110 - V_160 ) ;
}
F_128 ( V_106 , V_72 , V_155 , 0 , 1 , V_4 , V_154 , NULL ) ;
V_159:
F_129 () ;
}
...
struct V_93 * V_100 , int V_102 )
{
if ( ! F_118 ( & V_16 -> V_24 , 0 , V_12 -> V_139 ) )
return V_161 ;
if ( ! F_11 ( V_16 ) )
...
static int
F_132 ( struct V_111 * V_27 , enum V_162 type ,
void * V_109 )
{
...
static int V_40 ( struct V_149 * V_169 , struct V_3 * V_4 )
{
struct V_23 * V_16 ;
struct V_10 V_11 ;
struct V_93 * V_100 ;
int V_102 , V_110 ;
int V_5 = 0 ;
V_16 = F_94 ( V_169 , struct V_23 , V_24 ) ;
V_16 -> V_89 ++ ;
V_11 . V_16 = V_16 ;
V_11 . V_15 = F_85 ( V_4 ) ;
...
static int V_41 ( struct V_149 * V_169 ,
unsigned long V_101 , struct V_3 * V_4 )
{
struct V_23 * V_16 ;
struct V_10 V_11 ;
...
int V_5 ;
F_8 ( & V_34 -> V_35 -> V_170 ) ;
V_34 -> V_27 . V_171 = & V_172 ;
V_34 -> V_35 -> V_173 = F_107 ;
...
if ( V_5 )
return V_5 ;
F_18 ( V_16 -> V_33 . V_34 . V_174 ) ;
V_16 -> V_33 . V_34 . V_174 = NULL ;
return 0 ;
}
...
if ( ! V_177 )
return 0 ;
F_143 ( L_29 , 0644 , V_177 ,
NULL , & V_178 ) ;
F_143 ( L_30 , 0444 , V_177 ,
NULL , & V_179 ) ;
return 0 ;
}
