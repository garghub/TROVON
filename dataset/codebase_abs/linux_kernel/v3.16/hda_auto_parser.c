...
if ( V_125 < 0 && V_157 ) {
V_158 = F_52 ( V_21 -> V_159 -> V_160 , V_157 ) ;
if ( V_158 ) {
V_125 = V_158 -> V_153 ;
#ifdef F_50
V_112 = V_158 -> V_112 ;
...
if ( V_125 < 0 && V_157 ) {
for ( V_158 = V_157 ; V_158 -> V_150 || V_158 -> V_161 ; V_158 ++ ) {
unsigned int V_162 =
V_158 -> V_161 | ( V_158 -> V_150 << 16 ) ;
unsigned int V_163 = 0xffff0000 | V_158 -> V_164 ;
if ( ( V_21 -> V_151 & V_163 ) == ( V_162 & V_163 ) ) {
V_125 = V_158 -> V_153 ;
#ifdef F_50
V_112 = V_158 -> V_112 ;
#endif
