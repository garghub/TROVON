...
V_69 = F_35 ( V_55 , sizeof( struct V_69 ) , V_72 ) ;
if ( ! V_69 )
return - V_73 ;
V_71 = F_36 ( V_68 , V_74 , 0 ) ;
V_69 -> V_56 = F_37 ( V_55 , V_71 ) ;
if ( F_38 ( V_69 -> V_56 ) )
return F_39 ( V_69 -> V_56 ) ;
for ( V_17 = 0 ; V_17 < F_40 ( V_75 ) ; V_17 ++ ) {
struct V_52 * V_53 = & V_69 -> V_53 [ V_17 ] ;
struct V_57 * V_58 = & V_75 [ V_17 ] ;
if ( F_31 ( V_53 , & V_68 -> V_55 ,
V_69 -> V_56 , V_58 ) )
F_41 ( & V_68 -> V_55 , L_1 ,
V_58 -> V_63 ) ;
}
