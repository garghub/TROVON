...
if ( V_18 < 0 )
return V_18 ;
V_18 = F_56 ( V_46 , 0 , & V_116 ) ;
if ( V_18 < 0 )
return V_18 ;
sprintf ( V_116 -> V_17 + strlen ( V_116 -> V_17 ) , L_25 , V_12 -> V_38 + 'A' ) ;
strcat ( V_116 -> V_17 , L_26 ) ;
V_18 = F_57 ( V_46 , 2 , NULL ) ;
if ( V_18 < 0 )
return V_18 ;
V_18 = F_58 ( V_46 ) ;
if ( V_18 < 0 )
...
sprintf ( V_16 -> V_128 , L_31 ,
V_117 ,
V_12 -> V_21 . V_5 ,
V_111 ,
V_112 ) ;
if ( V_113 >= 0 )
sprintf ( V_16 -> V_128 + strlen ( V_16 -> V_128 ) , L_32 , V_113 ) ;
V_18 = F_62 ( V_16 ) ;
if ( V_18 < 0 )
return V_18 ;
V_10 -> V_46 = V_46 ;
...
static int F_63 ( int V_13 , struct V_107 * V_129 )
{
struct V_15 * V_16 ;
int V_18 ;
V_18 = F_49 ( V_129 , V_13 , & V_16 ) ;
if ( V_18 < 0 )
return V_18 ;
...
{
int V_18 ;
static int V_132 [] = { 5 , 11 , 12 , 9 , 7 , 15 , 3 , - 1 } ;
static int V_133 [] = { 0 , 1 , 3 , 5 , 6 , 7 , - 1 } ;
if ( V_39 [ V_13 ] == V_134 ) {
if ( ( V_39 [ V_13 ] = F_69 ( V_132 ) ) < 0 ) {
F_9 (KERN_ERR PFX L_33 ) ;
return - V_101 ;
}
}
if ( V_104 [ V_13 ] == V_135 ) {
if ( ( V_104 [ V_13 ] = F_70 ( V_133 ) ) < 0 ) {
F_9 (KERN_ERR PFX L_34 ) ;
return - V_101 ;
}
}
if ( V_105 [ V_13 ] == V_135 ) {
if ( ( V_105 [ V_13 ] = F_70 ( V_133 ) ) < 0 ) {
...
static long V_136 [] = { 0x210 , 0x220 , 0x230 , 0x240 , 0x250 , 0x260 } ;
int V_53 ;
for ( V_53 = 0 ; V_53 < F_33 ( V_136 ) ; V_53 ++ ) {
V_5 [ V_13 ] = V_136 [ V_53 ] ;
V_18 = F_63 ( V_13 , V_99 ) ;
if ( ! V_18 )
return 0 ;
...
static int F_71 ( struct V_107 * V_129 , unsigned int V_13 )
{
F_64 ( F_72 ( V_129 ) ) ;
return 0 ;
}
static int F_73 ( struct V_95 * V_137 ,
const struct V_96 * V_138 )
{
static int V_13 ;
struct V_15 * V_16 ;
int V_7 ;
for ( ; V_13 < V_139 ; V_13 ++ ) {
if ( V_130 [ V_13 ] && V_131 [ V_13 ] )
break;
}
if ( V_13 >= V_139 )
return - V_24 ;
V_7 = F_49 ( & V_137 -> V_16 -> V_13 , V_13 , & V_16 ) ;
if ( V_7 < 0 )
return V_7 ;
if ( ( V_7 = F_40 ( V_13 , V_16 -> V_106 , V_137 , V_138 ) ) < 0 ) {
F_64 ( V_16 ) ;
return V_7 ;
}
...
static void F_75 ( struct V_95 * V_137 )
{
F_64 ( F_76 ( V_137 ) ) ;
F_74 ( V_137 , NULL ) ;
}
