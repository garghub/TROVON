...
struct V_97 * V_98 )
{
const T_1 V_99 [] = { V_100 , V_101 } ;
int V_48 ;
if ( ! V_98 )
return - V_102 ;
switch ( V_7 -> V_23 -> V_103 ) {
case V_104 :
case V_105 :
case V_106 :
case V_107 :
...
for ( V_48 = 0 ; V_48 < V_98 -> V_116 && V_48 < V_121 ; V_48 ++ ) {
int V_33 ;
V_33 = F_63 ( V_7 -> V_23 ,
V_99 [ V_48 ] , & V_98 -> V_122 [ V_48 ] ) ;
if ( V_33 )
return V_33 ;
}
return 0 ;
}
static bool F_64 ( struct V_123 * V_23 )
{
T_1 V_52 ;
F_63 ( V_23 , V_101 , & V_52 ) ;
return ( V_52 & 0x600 ) == 0x200 ;
}
static bool F_65 ( struct V_123 * V_23 )
{
T_1 V_52 ;
F_63 ( V_23 , V_100 , & V_52 ) ;
return ( V_52 & 0xf0000 ) == 0xf0000 ;
}
struct V_6 * F_66 ( struct V_123 * V_23 ,
