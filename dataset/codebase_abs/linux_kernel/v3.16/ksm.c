...
while ( V_122 & V_160 ) {
F_151 ( & V_125 ) ;
F_187 ( & V_122 , F_188 ( V_160 ) ,
F_185 , V_161 ) ;
F_149 ( & V_125 ) ;
}
}
static void F_189 ( unsigned long V_162 ,
unsigned long V_163 )
{
struct V_5 * V_5 ;
struct V_73 * V_74 , * V_41 ;
...
static int F_192 ( struct V_164 * V_165 ,
...
static T_6 F_195 ( struct V_174 * V_175 ,
...
unsigned long V_180 ;
int V_68 ;
V_68 = F_197 ( V_178 , 10 , & V_180 ) ;
if ( V_68 || V_180 > V_181 )
return - V_182 ;
V_127 = V_180 ;
return V_179 ;
}
static T_6 F_198 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
...
int V_68 ;
unsigned long V_171 ;
V_68 = F_197 ( V_178 , 10 , & V_171 ) ;
if ( V_68 || V_171 > V_181 )
return - V_182 ;
V_126 = V_171 ;
return V_179 ;
}
static T_6 F_200 ( struct V_174 * V_175 , struct V_176 * V_177 ,
char * V_178 )
{
...
static T_6 F_204 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
...
struct V_107 * V_178 ;
V_178 = F_206 ( V_186 + V_186 , sizeof( * V_178 ) ,
V_11 ) ;
if ( ! V_178 )
V_68 = - V_10 ;
else {
