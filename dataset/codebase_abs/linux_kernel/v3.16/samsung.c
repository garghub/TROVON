...
static int F_31 ( T_4 V_119 , T_4 V_120 , T_3 V_118 , int V_121 )
{
...
static T_5 F_32 ( int V_142 , void * V_143 )
{
void T_1 * V_3 = V_2 -> V_122 ;
int V_123 , V_5 = 0 ;
V_123 = F_2 ( V_3 + V_144 ) ;
...
static int F_35 ( T_4 V_119 , T_4 V_120 , T_3 V_118 , int V_121 )
{
void T_1 * V_3 = V_2 -> V_122 ;
int V_123 ;
V_123 = F_2 ( V_3 + V_151 ) ;
