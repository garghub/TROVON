...
F_64 ( & V_46 -> V_97 , & V_98 ) ;
F_35 ( & V_96 ) ;
V_30 = V_67 -> V_99 ? V_67 -> V_99 ( V_46 ) : - V_3 ;
if ( V_30 ) {
F_34 ( & V_96 ) ;
F_65 ( & V_46 -> V_97 ) ;
F_35 ( & V_96 ) ;
...
F_67 (ap_msg, next, &ap_dev->pendingq, list) {
F_65 ( & V_101 -> V_97 ) ;
V_46 -> V_64 -- ;
V_101 -> V_103 ( V_46 , V_101 , F_68 ( - V_3 ) ) ;
}
F_67 (ap_msg, next, &ap_dev->requestq, list) {
F_65 ( & V_101 -> V_97 ) ;
V_46 -> V_63 -- ;
V_101 -> V_103 ( V_46 , V_101 , F_68 ( - V_3 ) ) ;
}
...
V_46 -> V_50 >= V_46 -> V_6 )
return 0 ;
V_101 = F_130 ( V_46 -> V_144 . V_102 , struct V_100 , V_97 ) ;
...
if ( V_30 )
goto V_132;
for ( V_16 = 0 ; V_169 [ V_16 ] ; V_16 ++ ) {
V_30 = F_167 ( & V_109 , V_169 [ V_16 ] ) ;
if ( V_30 )
goto V_170;
}
V_147 = F_168 ( L_26 ) ;
