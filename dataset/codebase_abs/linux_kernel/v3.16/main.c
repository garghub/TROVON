...
V_11 -> V_58 [ V_70 ] . V_59 . V_77 ) ;
F_5 ( & V_11 -> V_7 -> V_11 , L_15 ,
V_11 -> V_58 [ V_70 ] . V_59 . V_60 ) ;
if ( F_44 ( V_50 -> V_74 , V_78 ) == 0 ) {
...
V_69 -> V_77 = V_11 -> V_58 [ V_70 ] . V_59 . V_77 ;
F_5 ( & V_11 -> V_7 -> V_11 , L_17 ) ;
V_23 = F_45 ( V_9 , V_2 ) ;
V_71:
return V_23 ;
}
static long F_46 ( struct V_2 * V_2 , unsigned int V_82 , unsigned long V_50 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 = V_2 -> V_5 ;
...
unsigned int V_82 , unsigned long V_50 )
{
return F_46 ( V_2 , V_82 , ( unsigned long ) F_49 ( V_50 ) ) ;
}
static unsigned int F_50 ( struct V_2 * V_2 , T_5 * V_87 )
{
struct V_8 * V_9 = V_2 -> V_5 ;
struct V_10 * V_11 ;
unsigned int V_88 = 0 ;
...
F_9 ( & V_11 -> V_15 ) ;
if ( V_9 == & V_11 -> V_24 )
return F_52 ( V_11 , V_2 , V_87 ) ;
F_53 ( V_2 , & V_9 -> V_90 , V_87 ) ;
F_4 ( & V_11 -> V_15 ) ;
if ( ! F_51 ( V_9 ) ) {
V_88 = V_89 ;
goto V_25;
...
{
int V_93 ;
V_94 . V_13 = & V_11 -> V_7 -> V_11 ;
V_93 = F_55 ( & V_94 ) ;
if ( V_93 )
return V_93 ;
if ( F_56 ( V_11 , V_94 . V_95 ) )
