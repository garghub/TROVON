...
V_52 = F_26 ( & V_12 -> V_14 ) ;
if ( V_52 )
V_51 = F_23 ( V_52 , struct V_2 , V_14 ) ;
if ( V_52 && F_30 ( V_51 , V_12 ) ) {
V_12 -> V_23 = V_51 -> V_23 ;
V_12 -> V_53 = V_51 -> V_53 ;
V_12 -> V_24 += V_51 -> V_24 ;
V_12 -> V_54 += V_51 -> V_54 ;
...
V_12 -> V_56 = V_51 -> V_56 ;
V_12 -> V_18 = F_33 ( V_12 -> V_18 , V_51 -> V_18 ) ;
F_34 ( & V_51 -> V_14 , & V_7 -> V_8 ) ;
F_10 ( & V_51 -> V_14 ) ;
F_12 ( V_51 ) ;
}
}
...
F_38 ( & V_12 -> V_20 , & V_7 -> V_10 ) ;
V_12 -> V_18 = V_57 ;
F_39 ( V_43 , & V_12 -> V_15 ) ;
V_12 -> V_56 = V_12 -> V_23 ;
V_12 -> V_55 = V_12 -> V_24 ;
if ( F_18 ( V_61 , & V_12 -> V_15 ) ) {
V_59 = true ;
F_39 ( V_61 , & V_12 -> V_15 ) ;
}
F_32 ( V_7 , V_12 ) ;
...
void F_41 ( struct V_6 * V_7 , struct V_2 * V_12 )
{
F_39 ( V_45 , & V_12 -> V_15 ) ;
if ( F_16 ( V_12 ) )
F_32 ( V_7 , V_12 ) ;
...
if ( V_63 && ! ( V_31 > V_12 -> V_23 && V_23 < F_24 ( V_12 ) ) )
return NULL ;
F_43 ( & V_12 -> V_19 ) ;
return V_12 ;
}
...
int V_62 )
{
F_13 ( F_18 ( V_43 , & V_64 -> V_15 ) ) ;
ASSERT ( F_16 ( V_64 ) ) ;
if ( ! F_18 ( V_45 , & V_64 -> V_15 ) )
F_48 ( & V_64 -> V_20 ) ;
F_50 ( & V_64 -> V_14 , & V_65 -> V_14 , & V_7 -> V_8 ) ;
F_10 ( & V_64 -> V_14 ) ;
F_42 ( V_7 , V_65 , V_62 ) ;
}
