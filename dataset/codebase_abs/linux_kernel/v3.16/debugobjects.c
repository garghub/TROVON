...
static struct V_17 * F_28 ( unsigned long V_16 )
{
unsigned long V_46 ;
V_46 = F_29 ( ( V_16 >> V_47 ) , V_48 ) ;
return & V_39 [ V_46 ] ;
}
static void F_30 ( struct V_7 * V_19 , char * V_49 )
{
...
static int
F_32 ( int (* F_33)( void * V_16 , enum V_58 V_26 ) ,
...
static void F_34 ( void * V_16 , int V_61 )
{
int V_62 ;
static int V_50 ;
if ( V_50 > 4 )
...
static void
F_37 ( void * V_16 , struct V_23 * V_24 , int V_61 )
{
enum V_58 V_26 ;
struct V_17 * V_38 ;
struct V_7 * V_19 ;
...
int F_40 ( void * V_16 , struct V_23 * V_24 )
{
enum V_58 V_26 ;
struct V_17 * V_38 ;
struct V_7 * V_19 ;
...
void
F_45 ( void * V_16 , struct V_23 * V_24 ,
...
static void F_46 ( const void * V_79 , unsigned long V_80 )
{
...
void F_47 ( const void * V_79 , unsigned long V_80 )
{
if ( V_2 )
F_46 ( V_79 , V_80 ) ;
}
static int F_48 ( struct V_89 * V_90 , void * V_91 )
{
F_49 ( V_90 , L_13 , V_22 ) ;
F_49 ( V_90 , L_14 , V_57 ) ;
F_49 ( V_90 , L_15 , V_60 ) ;
...
static int F_50 ( struct V_92 * V_92 , struct V_93 * V_94 )
{
return F_51 ( V_94 , F_48 , NULL ) ;
}
...
static int T_1 V_66 ( void * V_16 , enum V_58 V_26 )
{
...
static int T_1 V_71 ( void * V_16 , enum V_58 V_26 )
{
struct V_101 * V_19 = V_16 ;
switch ( V_26 ) {
case V_70 :
...
static int T_1 V_74 ( void * V_16 , enum V_58 V_26 )
{
struct V_101 * V_19 = V_16 ;
switch ( V_26 ) {
case V_65 :
...
static int T_1 V_75 ( void * V_16 , enum V_58 V_26 )
{
struct V_101 * V_19 = V_16 ;
switch ( V_26 ) {
case V_65 :
...
static int T_1
F_56 ( void * V_16 , enum V_58 V_26 , int V_104 , int V_105 )
{
struct V_17 * V_38 ;
struct V_7 * V_19 ;
unsigned long V_9 ;
...
V_51 = & V_102 ;
F_38 ( & V_19 , & V_102 ) ;
if ( F_56 ( & V_19 , V_63 , V_104 , V_105 ) )
goto V_107;
F_40 ( & V_19 , & V_102 ) ;
if ( F_56 ( & V_19 , V_65 , V_104 , V_105 ) )
goto V_107;
F_40 ( & V_19 , & V_102 ) ;
if ( F_56 ( & V_19 , V_65 , ++ V_104 , ++ V_105 ) )
goto V_107;
F_41 ( & V_19 , & V_102 ) ;
if ( F_56 ( & V_19 , V_64 , V_104 , V_105 ) )
goto V_107;
F_42 ( & V_19 , & V_102 ) ;
if ( F_56 ( & V_19 , V_67 , V_104 , V_105 ) )
goto V_107;
F_38 ( & V_19 , & V_102 ) ;
if ( F_56 ( & V_19 , V_67 , V_104 , ++ V_105 ) )
goto V_107;
