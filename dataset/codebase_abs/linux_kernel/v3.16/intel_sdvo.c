...
if ( ! F_45 ( V_1 , V_211 ) )
return;
if ( F_71 ( V_10 ) -> V_221 >= 4 ) {
V_208 = V_222 | V_223 ;
if ( ! F_67 ( V_10 ) && V_163 -> V_169 . V_170 )
V_208 |= V_207 ;
if ( F_71 ( V_10 ) -> V_221 < 5 )
V_208 |= V_224 ;
} else {
V_208 = F_9 ( V_1 -> V_17 ) ;
switch ( V_1 -> V_17 ) {
...
if ( F_72 ( V_10 ) >= V_227 )
V_208 |= F_73 ( V_163 -> V_228 ) ;
else
V_208 |= F_74 ( V_163 -> V_228 ) ;
if ( V_1 -> V_229 )
V_208 |= V_230 ;
if ( F_71 ( V_10 ) -> V_221 >= 4 ) {
} else if ( F_75 ( V_10 ) || F_76 ( V_10 ) || F_77 ( V_10 ) ) {
} else {
V_208 |= ( V_163 -> V_169 . V_202 - 1 )
<< V_231 ;
}
...
if ( ( V_245 & V_237 ) == 0 ) {
if ( F_89 ( V_10 ) )
V_245 |= F_74 ( V_164 -> V_228 ) ;
F_7 ( V_1 , V_245 | V_237 ) ;
}
for ( V_16 = 0 ; V_16 < 2 ; V_16 ++ )
F_91 ( V_10 , V_164 -> V_228 ) ;
V_249 = F_31 ( V_1 , & V_247 , & V_248 ) ;
if ( V_249 && ! V_247 ) {
F_12 ( L_22
L_23 , F_18 ( V_1 ) ) ;
}
...
static bool F_97 ( struct V_1 * V_1 , struct V_261 * V_262 )
{
F_32 ( sizeof( * V_262 ) != 8 ) ;
if ( ! F_29 ( V_1 ,
V_263 ,
...
{
return F_101 ( V_1 -> V_262 . V_275 ) > 1 ;
}
static struct V_280 *
F_102 ( struct V_5 * V_6 )
{
struct V_1 * V_281 = F_3 ( V_6 ) ;
return F_103 ( V_6 , & V_281 -> V_282 ) ;
}
static struct V_280 *
...
struct V_280 * V_280 ;
V_280 = F_102 ( V_6 ) ;
if ( V_280 == NULL && F_100 ( V_1 ) ) {
T_2 V_282 , V_286 = V_1 -> V_56 ;
for ( V_282 = V_1 -> V_56 >> 1 ; V_282 > 1 ; V_282 >>= 1 ) {
V_1 -> V_56 = V_282 ;
V_280 = F_102 ( V_6 ) ;
if ( V_280 )
break;
...
V_38 = V_290 ;
if ( V_1 -> V_291 ) {
V_1 -> V_204 = F_107 ( V_280 ) ;
V_1 -> V_229 = F_108 ( V_280 ) ;
V_1 -> V_168 =
F_109 ( V_280 ) ;
}
} else
...
if ( V_7 -> V_293 != V_294 )
V_1 -> V_229 = ( V_7 -> V_293 == V_295 ) ;
}
return V_38 ;
}
static bool
F_110 ( struct V_7 * V_281 ,
struct V_280 * V_280 )
{
bool V_296 = ! ! ( V_280 -> V_288 & V_289 ) ;
bool V_297 = ! ! F_111 ( V_281 ) ;
F_12 ( L_37 ,
V_297 , V_296 ) ;
return V_297 == V_296 ;
}
...
V_178 = 1 << V_1 -> V_179 ;
memcpy ( & V_304 , & V_178 ,
V_87 ( sizeof( V_178 ) , sizeof( struct V_303 ) ) ) ;
...
if ( ! F_23 ( V_1 , & V_305 , 3 ) )
return;
for ( V_16 = 0 ; V_16 < F_16 ( V_307 ) ; V_16 ++ )
if ( V_305 & ( 1 << V_16 ) ) {
struct V_54 * V_308 ;
...
if ( V_7 -> V_314 )
F_128 ( V_10 , V_7 -> V_314 ) ;
if ( V_7 -> V_315 )
F_128 ( V_10 , V_7 -> V_315 ) ;
if ( V_7 -> V_316 )
F_128 ( V_10 , V_7 -> V_316 ) ;
if ( V_7 -> V_317 )
F_128 ( V_10 , V_7 -> V_317 ) ;
if ( V_7 -> V_318 )
F_128 ( V_10 , V_7 -> V_318 ) ;
if ( V_7 -> V_319 )
F_128 ( V_10 , V_7 -> V_319 ) ;
if ( V_7 -> V_320 )
F_128 ( V_10 , V_7 -> V_320 ) ;
if ( V_7 -> V_321 )
F_128 ( V_10 , V_7 -> V_321 ) ;
if ( V_7 -> V_322 )
F_128 ( V_10 , V_7 -> V_322 ) ;
if ( V_7 -> V_323 )
F_128 ( V_10 , V_7 -> V_323 ) ;
if ( V_7 -> V_324 )
F_128 ( V_10 , V_7 -> V_324 ) ;
if ( V_7 -> V_325 )
F_128 ( V_10 , V_7 -> V_325 ) ;
if ( V_7 -> V_326 )
F_128 ( V_10 , V_7 -> V_326 ) ;
if ( V_7 -> V_327 )
F_128 ( V_10 , V_7 -> V_327 ) ;
if ( V_7 -> V_328 )
F_128 ( V_10 , V_7 -> V_328 ) ;
if ( V_7 -> V_329 )
F_128 ( V_10 , V_7 -> V_329 ) ;
if ( V_7 -> V_330 )
F_128 ( V_10 , V_7 -> V_330 ) ;
}
...
static bool F_131 ( struct V_5 * V_6 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
struct V_280 * V_280 ;
bool V_332 = false ;
...
return false ;
V_280 = F_102 ( V_6 ) ;
if ( V_280 != NULL && V_280 -> V_288 & V_289 )
V_332 = F_108 ( V_280 ) ;
F_22 ( V_280 ) ;
return V_332 ;
}
...
F_134 (hpos, HPOS)
F_134 (vpos, VPOS)
F_134 (saturation, SATURATION)
F_134 (contrast, CONTRAST)
F_134 (hue, HUE)
F_134 (brightness, BRIGHTNESS)
F_134 (sharpness, SHARPNESS)
F_134 (flicker_filter, FLICKER_FILTER)
F_134 (flicker_filter_2d, FLICKER_FILTER_2D)
F_134 (flicker_filter_adaptive, FLICKER_FILTER_ADAPTIVE)
F_134 (tv_chroma_filter, TV_CHROMA_FILTER)
F_134 (tv_luma_filter, TV_LUMA_FILTER)
F_134 (dot_crawl, DOT_CRAWL)
}
return - V_344 ;
V_351:
if ( ! F_28 ( V_1 , V_32 , & V_335 , 2 ) )
return - V_356 ;
V_337:
if ( V_1 -> V_4 . V_4 . V_163 )
F_136 ( V_1 -> V_4 . V_4 . V_163 ) ;
return 0 ;
#undef F_134
}
static void F_137 ( struct V_357 * V_3 )
{
struct V_1 * V_1 = F_1 ( F_138 ( V_3 ) ) ;
if ( V_1 -> V_102 != NULL )
F_139 ( V_3 -> V_10 ,
V_1 -> V_102 ) ;
F_140 ( & V_1 -> V_282 ) ;
...
V_369 = & ( V_12 -> V_371 [ 1 ] ) ;
if ( V_369 -> V_372 )
V_281 -> V_56 = 1 << ( ( V_369 -> V_373 & 0xf0 ) >> 4 ) ;
else
F_142 ( V_281 ) ;
}
static void
...
V_369 = & V_12 -> V_371 [ 1 ] ;
if ( V_369 -> V_372 && F_145 ( V_369 -> V_375 ) )
V_374 = V_369 -> V_375 ;
else
V_374 = V_376 ;
V_281 -> V_31 = F_105 ( V_12 , V_374 ) ;
F_146 ( V_281 -> V_31 , true ) ;
}
static void
F_147 ( struct V_1 * V_281 )
{
F_146 ( V_281 -> V_31 , false ) ;
}
static bool
F_148 ( struct V_1 * V_1 , int V_377 )
{
return F_50 ( V_1 ) ;
}
static T_2
F_149 ( struct V_9 * V_10 , struct V_1 * V_281 )
{
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_368 * V_378 , * V_379 ;
if ( V_281 -> V_370 ) {
V_378 = & V_12 -> V_371 [ 0 ] ;
V_379 = & V_12 -> V_371 [ 1 ] ;
} else {
...
static void
F_150 ( struct V_234 * V_234 )
{
struct V_5 * V_5 ;
struct V_1 * V_380 ;
V_5 = & V_234 -> V_4 ;
V_380 = F_3 ( & V_234 -> V_4 ) ;
F_151 ( & V_5 -> V_381 -> V_382 ,
V_380 -> V_282 . V_10 . V_382 . V_37 ) ;
F_152 ( V_234 ) ;
}
static int
F_153 ( struct V_7 * V_6 ,
struct V_1 * V_3 )
{
struct V_5 * V_5 ;
int V_30 ;
V_5 = & V_6 -> V_4 . V_4 ;
V_30 = F_154 ( V_3 -> V_4 . V_4 . V_10 ,
V_5 ,
& V_383 ,
V_6 -> V_4 . V_4 . V_384 ) ;
if ( V_30 < 0 )
...
V_6 -> V_4 . V_4 . V_386 = 1 ;
V_6 -> V_4 . V_4 . V_387 = 0 ;
V_6 -> V_4 . V_4 . V_388 . V_389 = V_390 ;
V_6 -> V_4 . V_391 = F_78 ;
V_6 -> V_4 . V_392 = F_150 ;
F_156 ( & V_6 -> V_4 , & V_3 -> V_4 ) ;
V_30 = F_157 ( V_5 ) ;
if ( V_30 < 0 )
goto V_393;
V_30 = F_158 ( & V_5 -> V_381 -> V_382 ,
& V_3 -> V_282 . V_10 . V_382 ,
V_3 -> V_282 . V_10 . V_382 . V_37 ) ;
if ( V_30 < 0 )
goto V_394;
return 0 ;
V_394:
...
F_161 ( & V_6 -> V_4 . V_4 ) ;
if ( F_71 ( V_10 ) -> V_221 >= 4 && F_162 ( V_10 ) ) {
F_163 ( & V_6 -> V_4 . V_4 ) ;
V_1 -> V_205 = true ;
}
}
static bool
F_164 ( struct V_1 * V_1 , int V_377 )
{
struct V_357 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_2 * V_2 = F_138 ( V_3 ) ;
struct V_234 * V_234 ;
struct V_7 * V_7 ;
F_12 ( L_40 , V_377 ) ;
...
static bool
F_168 ( struct V_1 * V_1 , int V_377 )
{
struct V_357 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_234 * V_234 ;
...
return false ;
if ( ( V_26 & V_415 ) == 0 ) {
unsigned char V_416 [ 2 ] ;
V_1 -> V_360 = 0 ;
memcpy ( V_416 , & V_1 -> V_262 . V_275 , 2 ) ;
F_12 ( L_44 ,
F_18 ( V_1 ) ,
V_416 [ 0 ] , V_416 [ 1 ] ) ;
return false ;
}
V_1 -> V_4 . V_417 = ( 1 << 0 ) | ( 1 << 1 ) | ( 1 << 2 ) ;
return true ;
}
...
if ( V_178 & ( 1 << V_16 ) )
V_7 -> V_346 [ V_7 -> V_419 ++ ] = V_16 ;
V_7 -> V_331 =
F_173 ( V_10 , V_420 ,
L_45 , V_7 -> V_419 ) ;
if ( ! V_7 -> V_331 )
return false ;
for ( V_16 = 0 ; V_16 < V_7 -> V_419 ; V_16 ++ )
F_174 (
V_7 -> V_331 , V_16 ,
V_16 , V_421 [ V_7 -> V_346 [ V_16 ] ] ) ;
V_1 -> V_179 = V_7 -> V_346 [ 0 ] ;
...
return false ;
V_7 -> V_349 = V_424 [ 0 ] ;
V_7 -> V_347 = V_424 [ 0 ] - V_44 ;
V_7 -> V_348 = V_7 -> V_347 ;
V_7 -> V_314 =
F_177 ( V_10 , 0 , L_46 , 0 , V_424 [ 0 ] ) ;
if ( ! V_7 -> V_314 )
return false ;
F_175 ( & V_6 -> V_4 ,
V_7 -> V_314 ,
...
if ( F_124 ( V_7 ) )
return F_176 ( V_1 , V_7 , V_423 . V_305 ) ;
else if ( F_125 ( V_7 ) )
return F_179 ( V_1 , V_7 , V_423 . V_305 ) ;
else
return true ;
}
static int F_180 ( struct V_447 * V_448 ,
struct V_23 * V_24 ,
int V_449 )
{
struct V_1 * V_281 = V_448 -> V_450 ;
if ( ! F_27 ( V_281 , V_281 -> V_56 ) )
return - V_356 ;
return V_281 -> V_31 -> V_451 -> V_452 ( V_281 -> V_31 , V_24 , V_449 ) ;
}
static T_1 F_181 ( struct V_447 * V_448 )
{
struct V_1 * V_281 = V_448 -> V_450 ;
return V_281 -> V_31 -> V_451 -> V_453 ( V_281 -> V_31 ) ;
}
static bool
F_182 ( struct V_1 * V_281 ,
struct V_9 * V_10 )
{
V_281 -> V_282 . V_454 = V_455 ;
V_281 -> V_282 . V_456 = V_457 ;
snprintf ( V_281 -> V_282 . V_37 , V_458 , L_56 ) ;
V_281 -> V_282 . V_10 . V_459 = & V_10 -> V_460 -> V_10 ;
V_281 -> V_282 . V_450 = V_281 ;
V_281 -> V_282 . V_451 = & V_461 ;
return F_183 ( & V_281 -> V_282 ) == 0 ;
}
bool F_184 ( struct V_9 * V_10 , T_7 V_17 , bool V_370 )
{
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_2 * V_2 ;
struct V_1 * V_1 ;
...
V_1 -> V_17 = V_17 ;
V_1 -> V_370 = V_370 ;
V_1 -> V_25 = F_149 ( V_10 , V_1 ) >> 1 ;
F_144 ( V_12 , V_1 , V_17 ) ;
if ( ! F_182 ( V_1 , V_10 ) )
goto V_462;
V_2 = & V_1 -> V_4 ;
V_2 -> type = V_463 ;
F_185 ( V_10 , & V_2 -> V_4 , & V_464 , 0 ) ;
...
V_2 -> V_391 = F_79 ;
V_2 -> V_470 = F_83 ;
if ( ! F_97 ( V_1 , & V_1 -> V_262 ) )
goto V_405;
if ( F_170 ( V_1 ,
V_1 -> V_262 . V_275 ) != true ) {
F_12 ( L_58 ,
F_18 ( V_1 ) ) ;
goto V_471;
}
...
L_62 ,
F_18 ( V_1 ) ,
V_1 -> V_262 . V_264 , V_1 -> V_262 . V_265 ,
V_1 -> V_262 . V_266 ,
V_1 -> V_255 / 1000 ,
V_1 -> V_257 / 1000 ,
( V_1 -> V_262 . V_269 & 0x1 ) ? 'Y' : 'N' ,
( V_1 -> V_262 . V_269 & 0x2 ) ? 'Y' : 'N' ,
V_1 -> V_262 . V_275 &
( V_364 | V_366 ) ? 'Y' : 'N' ,
V_1 -> V_262 . V_275 &
( V_363 | V_365 ) ? 'Y' : 'N' ) ;
