...
struct V_10 * V_11 ;
int V_54 ;
V_11 = F_74 ( & V_2 -> V_20 , sizeof( struct V_10 ) ,
V_70 ) ;
if ( ! V_11 )
return - V_71 ;
F_75 ( V_2 , V_11 ) ;
...
return V_54 ;
if ( V_11 -> V_38 == V_39 ) {
V_54 = F_78 ( & V_2 -> V_20 . V_76 , & V_78 ) ;
if ( V_54 )
goto V_79;
}
V_11 -> V_80 = F_79 ( & V_2 -> V_20 ) ;
if ( F_80 ( V_11 -> V_80 ) ) {
V_54 = F_81 ( V_11 -> V_80 ) ;
goto V_79;
}
...
V_11 -> V_95 = F_1 ( V_2 , V_87 ) ;
V_11 -> V_51 = F_1 ( V_2 , F_91 ( 0 ) )
| ( F_1 ( V_2 , F_91 ( 1 ) ) << 8 ) ;
if ( V_11 -> V_38 == V_73 )
V_11 -> V_51 &= 0xc0ff ;
