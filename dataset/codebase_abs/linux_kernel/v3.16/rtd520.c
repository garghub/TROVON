...
V_89 |= F_32 ( & V_88 -> V_110 , V_88 -> V_102 ) ;
if ( V_88 -> V_99 == V_98 ) {
} else {
V_89 |= F_32 ( & V_88 -> V_111 , 0 ) ;
}
if ( V_89 )
return 3 ;
if ( V_88 -> V_93 == V_94 ) {
V_90 = V_88 -> V_103 ;
F_2 ( & V_90 , V_88 -> V_112 & V_113 ) ;
V_89 |= F_32 ( & V_88 -> V_103 , V_90 ) ;
}
if ( V_88 -> V_96 == V_94 ) {
V_90 = V_88 -> V_109 ;
F_2 ( & V_90 , V_88 -> V_112 & V_113 ) ;
V_89 |= F_32 ( & V_88 -> V_109 , V_90 ) ;
if ( V_88 -> V_93 == V_94 ) {
V_90 = V_88 -> V_109 * V_88 -> V_110 ;
V_89 |= F_33 ( & V_88 -> V_103 ,
V_90 ) ;
}
}
if ( V_89 )
...
F_10 ( V_11 , V_88 -> V_102 , V_88 -> V_115 ) ;
if ( V_88 -> V_102 > 1 ) {
F_11 ( 0 , V_17 -> V_33 + V_116 ) ;
...
F_11 ( ( V_17 -> V_77 / 2 - 1 ) & 0xffff , V_17 -> V_33 + V_118 ) ;
if ( V_94 == V_88 -> V_93 ) {
if ( V_88 -> V_112 & V_119 ) {
...
switch ( V_88 -> V_99 ) {
case V_98 :
V_17 -> V_64 = V_88 -> V_111 * V_88 -> V_102 ;
if ( ( V_17 -> V_79 > 0 )
&& ( V_17 -> V_79 > V_17 -> V_64 ) ) {
V_17 -> V_79 = V_17 -> V_64 ;
}
...
switch ( V_88 -> V_93 ) {
case V_94 :
V_114 = F_2 ( & V_88 -> V_103 ,
V_5 ) ;
F_11 ( V_114 & 0xffffff , V_17 -> V_33 + V_124 ) ;
break;
case V_95 :
F_11 ( 1 , V_17 -> V_33 + V_116 ) ;
break;
}
switch ( V_88 -> V_96 ) {
case V_94 :
if ( V_88 -> V_102 > 1 ) {
V_114 = F_2 ( & V_88 -> V_109 ,
V_5 ) ;
F_11 ( V_114 & 0x3ff , V_17 -> V_33 + V_125 ) ;
}
break;
case V_95 :
F_11 ( 2 , V_17 -> V_33 + V_117 ) ;
break;
}
...
unsigned int V_126 = ( V_19 == 0 ) ? V_127 : V_128 ;
unsigned int V_53 ;
V_53 = F_16 ( V_17 -> V_33 + V_44 ) ;
if ( V_53 & V_126 )
return 0 ;
...
int V_131 = V_56 [ V_38 ] << 3 ;
if ( ( V_20 > 1 )
&& ( V_56 [ V_38 ] < 2048 ) ) {
V_131 = ( ( ( int ) V_56 [ V_38 ] ) - 2048 ) << 3 ;
} else {
V_131 = V_56 [ V_38 ] << 3 ;
}
F_14 ( V_131 , V_17 -> V_60 +
( ( V_19 == 0 ) ? V_132 : V_133 ) ) ;
F_14 ( 0 , V_17 -> V_33 +
( ( V_19 == 0 ) ? V_134 : V_135 ) ) ;
V_17 -> V_136 [ V_19 ] = V_56 [ V_38 ] ;
...
struct V_16 * V_17 = V_11 -> V_18 ;
if ( F_41 ( V_49 , V_56 ) )
F_14 ( V_49 -> V_137 & 0xff , V_17 -> V_33 + V_138 ) ;
V_56 [ 1 ] = F_21 ( V_17 -> V_33 + V_138 ) & 0xff ;
return V_51 -> V_58 ;
}
...
if ( V_57 )
return V_57 ;
F_14 ( 0x01 , V_17 -> V_33 + V_139 ) ;
F_14 ( V_49 -> V_140 & 0xff , V_17 -> V_33 + V_141 ) ;
F_14 ( 0x00 , V_17 -> V_33 + V_139 ) ;
return V_51 -> V_58 ;
}
static void F_44 ( struct V_10 * V_11 )
{
struct V_16 * V_17 = V_11 -> V_18 ;
F_11 ( 0 , V_17 -> V_33 + V_142 ) ;
F_15 ( 100 ) ;
F_11 ( 0 , V_17 -> V_143 + V_144 ) ;
F_14 ( 0 , V_17 -> V_33 + V_74 ) ;
F_14 ( ~ 0 , V_17 -> V_33 + V_81 ) ;
F_21 ( V_17 -> V_33 + V_81 ) ;
}
...
F_14 ( 0 , V_17 -> V_33 + V_139 ) ;
F_46 ( ( 0 << 6 ) | 0x30 , V_17 -> V_33 + V_147 ) ;
F_46 ( ( 1 << 6 ) | 0x30 , V_17 -> V_33 + V_147 ) ;
F_46 ( ( 2 << 6 ) | 0x30 , V_17 -> V_33 + V_147 ) ;
F_46 ( ( 3 << 6 ) | 0x00 , V_17 -> V_33 + V_147 ) ;
}
static void F_47 ( struct V_10 * V_11 ,
struct V_148 * V_149 )
{
unsigned char V_150 ;
F_48 ( V_149 , V_151 , & V_150 ) ;
if ( V_150 < 32 ) {
F_17 ( V_11 -> V_46 ,
L_3 ,
V_150 , 32 ) ;
...
if ( V_57 )
return V_57 ;
V_17 -> V_33 = F_55 ( V_149 , 2 ) ;
V_17 -> V_60 = F_55 ( V_149 , 3 ) ;
V_17 -> V_143 = F_55 ( V_149 , 0 ) ;
if ( ! V_17 -> V_33 || ! V_17 -> V_60 || ! V_17 -> V_143 )
return - V_157 ;
F_47 ( V_11 , V_149 ) ;
if ( V_149 -> V_67 ) {
V_57 = F_56 ( V_149 -> V_67 , F_27 , V_158 ,
V_11 -> V_155 , V_11 ) ;
if ( V_57 == 0 )
V_11 -> V_67 = V_149 -> V_67 ;
}
V_57 = F_57 ( V_11 , 4 ) ;
if ( V_57 )
return V_57 ;
V_49 = & V_11 -> V_159 [ 0 ] ;
V_49 -> type = V_160 ;
V_49 -> V_161 = V_162 | V_163 | V_164 | V_165 ;
V_49 -> V_30 = 16 ;
V_49 -> V_62 = 0x0fff ;
V_49 -> V_166 = V_15 -> V_167 ;
V_49 -> V_168 = V_169 ;
V_49 -> V_170 = F_19 ;
if ( V_11 -> V_67 ) {
V_11 -> V_68 = V_49 ;
...
V_17 -> V_77 = V_57 ;
if ( V_11 -> V_67 )
F_11 ( V_184 | V_185 , V_17 -> V_143 + V_144 ) ;
return 0 ;
}
...
struct V_16 * V_17 = V_11 -> V_18 ;
if ( V_17 ) {
if ( V_17 -> V_33 && V_17 -> V_143 )
F_44 ( V_11 ) ;
if ( V_11 -> V_67 ) {
F_11 ( F_16 ( V_17 -> V_143 + V_144 ) &
~ ( V_185 | V_186 | V_187 ) ,
V_17 -> V_143 + V_144 ) ;
F_59 ( V_11 -> V_67 , V_11 ) ;
}
...
static int F_62 ( struct V_148 * V_11 ,
