...
V_62 = 0 ;
if ( V_62 ) {
V_22 = F_32 ( V_31 , V_33 , NULL , V_63 , V_62 ,
V_13 ) ;
if ( V_22 )
goto V_12;
}
...
static void F_36 ( struct V_32 * V_33 , int V_79 )
{
...
V_2 -> V_35 . V_81 = F_37 ( V_82 - V_2 -> V_35 . V_81 ) ;
F_3 ( & V_4 -> V_7 , V_5 ) ;
F_38 ( & V_2 -> V_15 , & V_4 -> V_83 ) ;
V_4 -> V_23 ++ ;
F_4 ( & V_4 -> V_7 , V_5 ) ;
F_5 ( & V_4 -> V_28 ) ;
}
static void F_39 ( struct V_3 * V_4 , struct V_30 * V_31 ,
...
V_2 -> V_35 . V_81 = V_82 ;
F_8 ( & V_4 -> V_7 ) ;
F_40 ( & V_2 -> V_15 , & V_4 -> V_87 ) ;
F_9 ( & V_4 -> V_7 ) ;
F_13 ( L_4 , V_4 -> V_16 , V_33 , V_2 ) ;
V_33 -> V_80 = V_2 ;
F_41 ( V_31 , NULL , V_33 , V_84 , F_36 ) ;
}
...
F_8 ( & V_4 -> V_7 ) ;
if ( V_4 -> V_23 ) {
V_2 = F_43 ( & V_4 -> V_83 , struct V_1 , V_15 ) ;
F_44 ( & V_2 -> V_15 ) ;
V_4 -> V_23 -- ;
}
F_9 ( & V_4 -> V_7 ) ;
...
static int F_47 ( struct V_32 * V_33 , struct V_34 * V_35 ,
struct V_78 * V_78 , struct V_78 * V_86 )
{
int V_22 = 0 ;
F_13 ( L_6 , V_33 , V_78 , V_33 -> V_89 ) ;
V_35 -> V_90 = V_33 -> V_89 & 0xff ;
V_35 -> V_91 = F_48 ( V_33 -> V_89 ) ;
V_35 -> V_92 = F_49 ( V_33 -> V_89 ) ;
V_35 -> V_93 = 0 ;
if ( V_35 -> V_90 || V_35 -> V_91 || V_35 -> V_92 )
V_35 -> V_93 |= V_94 ;
V_35 -> V_95 = 0 ;
if ( V_33 -> V_76 && V_35 -> V_96 ) {
int V_97 = F_50 (unsigned int, hdr->max_response_len,
rq->sense_len) ;
V_22 = F_51 ( ( void V_40 * ) ( unsigned long ) V_35 -> V_96 ,
V_33 -> V_59 , V_97 ) ;
if ( ! V_22 )
V_35 -> V_95 = V_97 ;
else
...
if ( F_54 ( V_2 ) )
break;
V_101 = F_47 ( V_2 -> V_33 , & V_2 -> V_35 , V_2 -> V_78 ,
V_2 -> V_86 ) ;
if ( ! V_22 )
V_22 = V_101 ;
F_1 ( V_2 ) ;
...
static int
F_55 ( char V_40 * V_102 , T_3 V_103 , struct V_3 * V_4 ,
...
V_22 = F_47 ( V_2 -> V_33 , & V_2 -> V_35 , V_2 -> V_78 ,
V_2 -> V_86 ) ;
if ( F_51 ( V_102 , & V_2 -> V_35 , sizeof( V_2 -> V_35 ) ) )
V_22 = - V_41 ;
F_1 ( V_2 ) ;
if ( V_22 )
break;
...
F_57 ( V_4 , V_108 ) ;
V_106 = 0 ;
V_22 = F_55 ( V_102 , V_103 , V_4 , NULL , & V_106 ) ;
* V_112 = V_106 ;
if ( ! V_106 || F_60 ( V_22 ) )
V_106 = V_22 ;
return V_106 ;
...
V_22 = F_47 ( V_33 , & V_35 , V_78 , V_86 ) ;
if ( F_51 ( V_138 , & V_35 , sizeof( V_35 ) ) )
return - V_41 ;
return V_22 ;
}
default:
