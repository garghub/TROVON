...
int V_5 ;
F_73 ( args ) ;
V_121 = F_59 ( args -> V_125 -> V_144 , V_122 ) ;
if ( ! V_121 )
return V_145 ;
...
if ( error )
goto V_124;
error = F_76 ( args -> V_98 , V_52 , V_37 , - 1 , & V_157 , V_57 ) ;
if ( error )
goto V_124;
...
F_77 ( args -> V_98 , V_157 , 0 , args -> V_125 -> V_144 - 1 ) ;
error = F_78 ( args , 0 , 1 , & V_156 , V_57 ) ;
if ( error )
goto V_124;
V_155 = V_156 -> V_31 ;
...
F_77 ( args -> V_98 , V_156 , 0 , args -> V_125 -> V_144 - 1 ) ;
error = 0 ;
V_124:
return error ;
}
...
int error ;
F_79 ( args ) ;
error = F_76 ( args -> V_98 , args -> V_52 , V_37 , - 1 , & V_25 ,
V_57 ) ;
if ( error )
return error ;
V_25 -> V_158 = & V_58 ;
...
F_5 ( V_30 , & V_32 ) ;
F_77 ( args -> V_98 , V_25 , 0 , args -> V_125 -> V_144 - 1 ) ;
* V_55 = V_25 ;
return 0 ;
}
int
...
error = F_61 ( V_169 -> args , & V_37 ) ;
if ( error )
return ( error ) ;
error = F_62 ( V_169 -> args , V_37 , & V_172 -> V_25 ) ;
if ( error )
return ( error ) ;
V_172 -> V_37 = V_37 ;
V_172 -> V_8 = V_9 ;
F_83 ( V_169 , V_171 , V_172 ) ;
error = F_84 ( V_169 , V_171 , V_172 ) ;
if ( error )
return ( error ) ;
if ( V_169 -> V_173 ) {
F_85 ( V_169 -> args ) ;
error = F_67 ( V_171 -> V_25 , V_169 -> args ) ;
} else {
F_86 ( V_169 -> args ) ;
error = F_67 ( V_172 -> V_25 , V_169 -> args ) ;
}
V_171 -> V_131 = F_87 ( V_171 -> V_25 , NULL ) ;
V_172 -> V_131 = F_87 ( V_172 -> V_25 , NULL ) ;
return ( error ) ;
}
int
F_67 (
...
V_32 -> V_20 [ V_181 ] . V_22 -= F_89 ( args , & V_177 ) ;
...
V_183 -> V_188 = 0 ;
args -> V_189 = 1 ;
args -> V_190 = F_96 ( V_27 , args -> V_109 ) ;
args -> V_191 = args -> V_109 ;
}
F_77 ( args -> V_98 , V_25 ,
F_93 ( V_30 , F_97 ( V_30 , args -> V_178 ) ,
F_98 ( V_30 , args -> V_178 ) ) ) ;
...
V_32 -> V_16 += F_98 ( V_30 , args -> V_178 ) ;
return 0 ;
}
STATIC void
F_92 (
...
V_193 = ( V_146 * ) V_121 ;
V_194 = V_25 -> V_31 ;
memcpy ( V_25 -> V_31 , V_121 , F_90 ( V_193 ) ) ;
V_195 = * V_192 ;
V_192 -> V_17 = args -> V_125 -> V_144 ;
V_192 -> V_16 = 0 ;
V_192 -> V_15 = 0 ;
V_192 -> V_18 = 0 ;
V_192 -> V_20 [ 0 ] . V_21 = F_90 ( V_193 ) ;
V_192 -> V_20 [ 0 ] . V_22 = V_192 -> V_17 -
V_192 -> V_20 [ 0 ] . V_21 ;
F_5 ( V_194 , V_192 ) ;
F_100 ( args , V_193 , & V_195 , 0 ,
V_194 , V_192 , 0 , V_195 . V_15 ) ;
F_77 ( V_98 , V_25 , 0 , args -> V_125 -> V_144 - 1 ) ;
F_68 ( V_121 ) ;
}
static int
F_101 (
...
struct V_133 * V_200 ;
struct V_133 * V_201 ;
V_200 = F_70 ( V_196 -> V_31 ) ;
V_201 = F_70 ( V_198 -> V_31 ) ;
...
return F_101 ( V_196 , & V_202 , V_198 , & V_203 ) ;
}
STATIC void
F_83 (
struct V_168 * V_169 ,
...
F_103 ( args ) ;
V_211 = 0 ;
if ( F_101 ( V_204 -> V_25 , & V_202 , V_205 -> V_25 , & V_203 ) ) {
struct V_170 * V_212 ;
struct V_1 V_213 ;
V_212 = V_204 ;
V_204 = V_205 ;
...
V_169 -> V_173 = F_104 ( V_169 , V_204 , & V_202 ,
V_205 , & V_203 ,
& V_15 , & V_208 ) ;
if ( V_211 )
...
V_209 = V_203 . V_17 - F_90 ( V_206 ) ;
V_209 -= V_203 . V_15 * sizeof( V_179 ) ;
if ( V_210 > V_209 )
F_92 ( args , & V_203 , V_205 -> V_25 ) ;
F_100 ( args , V_206 , & V_202 ,
...
V_210 += V_15 * sizeof( V_179 ) ;
V_209 = V_202 . V_17 - F_90 ( V_206 ) ;
V_209 -= V_202 . V_15 * sizeof( V_179 ) ;
if ( V_210 > V_209 )
F_92 ( args , & V_202 , V_204 -> V_25 ) ;
F_100 ( args , V_207 , & V_203 , 0 , V_206 , & V_202 ,
V_202 . V_15 , V_15 ) ;
}
F_5 ( V_206 , & V_202 ) ;
F_5 ( V_207 , & V_203 ) ;
F_77 ( args -> V_98 , V_204 -> V_25 , 0 , args -> V_125 -> V_144 - 1 ) ;
F_77 ( args -> V_98 , V_205 -> V_25 , 0 , args -> V_125 -> V_144 - 1 ) ;
V_200 = F_70 ( V_206 ) ;
V_201 = F_70 ( V_207 ) ;
...
V_177 = V_208 + sizeof( * V_134 ) + F_98 ( V_206 ,
V_178 ) ;
if ( F_105 ( V_217 - V_177 ) > V_218 )
break;
V_218 = F_105 ( V_217 - V_177 ) ;
...
error = F_108 ( V_169 , & V_169 -> V_226 , V_222 ,
0 , & V_223 ) ;
if ( error )
return ( error ) ;
if ( V_223 ) {
...
error = F_108 ( V_169 , & V_169 -> V_224 , V_222 ,
0 , & V_223 ) ;
}
if ( error )
return ( error ) ;
...
V_228 = 0 ;
memset ( F_97 ( V_30 , args -> V_178 ) , 0 , V_175 ) ;
V_32 . V_16 -= V_175 ;
F_77 ( args -> V_98 , V_25 ,
F_93 ( V_30 , F_97 ( V_30 , args -> V_178 ) ,
V_175 ) ) ;
...
V_32 . V_15 -- ;
F_77 ( args -> V_98 , V_25 ,
F_93 ( V_30 , V_134 , V_177 + sizeof( V_179 ) ) ) ;
V_134 = & F_70 ( V_30 ) [ V_32 . V_15 ] ;
...
struct V_3 * V_237 ;
struct V_1 V_238 ;
V_237 = F_114 ( V_169 -> args -> V_125 -> V_144 , V_122 ) ;
memcpy ( V_237 , V_234 , F_90 ( V_234 ) ) ;
...
F_5 ( V_234 , & V_236 ) ;
F_77 ( V_169 -> args -> V_98 , V_232 -> V_25 , 0 ,
...
args -> V_191 = F_3 ( V_183 -> V_109 ) ;
args -> V_189 = F_3 ( V_183 -> V_188 ) ;
args -> V_190 = F_96 ( args -> V_52 -> V_67 ,
args -> V_191 ) ;
if ( args -> V_108 & V_118 ) {
...
V_177 = F_98 ( V_241 , V_243 + V_5 ) ;
#ifdef F_117
if ( V_247 -> V_108 & V_138 ) {
memset ( F_97 ( V_241 , V_243 + V_5 ) , 0 , V_177 ) ;
V_242 -> V_16 -= V_177 ;
V_242 -> V_15 -= 1 ;
V_248 -- ;
V_249 -- ;
...
<= args -> V_125 -> V_144 ) ;
memmove ( F_97 ( V_244 , V_249 ) ,
F_97 ( V_241 , V_243 + V_5 ) , V_177 ) ;
...
V_135 = F_71 ( V_30 , V_178 ) ;
V_22 = F_118 ( V_135 -> V_105 ,
F_4 ( V_135 -> V_109 ) ) ;
} else {
V_183 = F_95 ( V_30 , V_178 ) ;
V_22 = F_119 ( V_183 -> V_105 ) ;
}
return V_22 ;
}
int
...
{
int V_22 ;
V_22 = F_118 ( args -> V_105 , args -> V_109 ) ;
if ( V_22 < F_120 ( args -> V_125 -> V_144 ) ) {
if ( V_251 )
* V_251 = 1 ;
return V_22 ;
}
...
F_77 ( args -> V_98 , V_25 ,
F_93 ( V_30 , V_183 , sizeof( * V_183 ) ) ) ;
}
return F_123 ( & args -> V_98 , args -> V_52 ) ;
}
int
F_124 (
struct V_142 * args )
...
V_206 = V_156 -> V_31 ;
V_252 = & F_70 ( V_206 ) [ args -> V_178 ] ;
V_207 = V_157 -> V_31 ;
V_253 = & F_70 ( V_207 ) [ args -> V_187 ] ;
#ifdef F_45
F_1 ( & V_202 , V_206 ) ;
...
V_135 = F_71 ( V_206 , args -> V_178 ) ;
V_254 = V_135 -> V_105 ;
V_256 = ( char * ) V_135 -> V_107 ;
} else {
V_183 = F_95 ( V_206 , args -> V_178 ) ;
V_254 = V_183 -> V_105 ;
V_256 = ( char * ) V_183 -> V_106 ;
}
if ( V_253 -> V_108 & V_139 ) {
V_135 = F_71 ( V_207 , args -> V_187 ) ;
V_255 = V_135 -> V_105 ;
V_257 = ( char * ) V_135 -> V_107 ;
} else {
V_183 = F_95 ( V_207 , args -> V_187 ) ;
V_255 = V_183 -> V_105 ;
...
V_252 -> V_108 &= ~ V_138 ;
F_77 ( args -> V_98 , V_156 ,
F_93 ( V_206 , V_252 , sizeof( * V_252 ) ) ) ;
if ( args -> V_189 ) {
...
V_183 -> V_109 = F_6 ( args -> V_191 ) ;
F_77 ( args -> V_98 , V_156 ,
F_93 ( V_206 , V_183 , sizeof( * V_183 ) ) ) ;
}
V_253 -> V_108 |= V_138 ;
F_77 ( args -> V_98 , V_157 ,
F_93 ( V_207 , V_253 , sizeof( * V_253 ) ) ) ;
if ( ( V_253 -> V_108 & V_139 ) == 0 ) {
V_183 = F_95 ( V_207 , args -> V_187 ) ;
V_183 -> V_188 = 0 ;
V_183 -> V_109 = 0 ;
F_77 ( args -> V_98 , V_157 ,
F_93 ( V_207 , V_183 , sizeof( * V_183 ) ) ) ;
}
error = F_123 ( & args -> V_98 , args -> V_52 ) ;
return error ;
}
