...
V_6 &= ~ ( V_5 -> V_43 | V_5 -> V_44 ) ;
V_6 |= V_5 -> V_45 << F_3 ( V_5 -> V_43 ) ;
V_6 |= ( V_5 -> V_46 - 1 ) << F_3 ( V_5 -> V_44 ) ;
if ( V_5 -> V_47 ) {
F_18 ( V_2 , & V_30 , V_5 -> V_45 , V_5 -> V_46 ) ;
V_6 &= ~ ( V_5 -> V_47 ) ;
V_6 |= V_30 << F_3 ( V_5 -> V_47 ) ;
}
if ( V_5 -> V_48 ) {
F_20 ( V_2 , & V_33 , V_5 -> V_45 ,
V_5 -> V_46 ) ;
V_6 &= ~ ( V_5 -> V_48 ) ;
V_6 |= V_33 << F_3 ( V_5 -> V_48 ) ;
}
...
unsigned long F_23 ( struct V_53 * V_14 , unsigned long V_54 )
{
struct V_1 * V_2 = F_24 ( V_14 ) ;
return F_25 ( V_2 ) ;
}
int F_26 ( struct V_53 * V_14 )
{
struct V_1 * V_2 = F_24 ( V_14 ) ;
int V_24 ;
struct V_4 * V_5 ;
...
V_55 = F_19 ( V_14 -> V_2 ) ;
if ( F_11 ( V_14 -> V_2 ) == F_11 ( V_5 -> V_59 ) ) {
F_29 ( V_55 != V_5 -> V_59 ) ;
V_24 = F_16 ( V_2 ) ;
} else {
F_29 ( V_55 != V_5 -> V_22 ) ;
...
void F_30 ( struct V_53 * V_14 )
{
struct V_1 * V_2 = F_24 ( V_14 ) ;
F_17 ( V_2 ) ;
if ( V_2 -> V_56 )
F_31 ( V_2 -> V_56 , V_14 -> V_2 ) ;
}
int F_32 ( struct V_53 * V_14 , unsigned long V_60 ,
unsigned long V_54 )
{
struct V_1 * V_2 = F_24 ( V_14 ) ;
...
V_6 = F_2 ( V_2 , V_5 -> V_62 ) ;
V_6 &= ~ V_5 -> V_63 ;
V_6 |= V_64 << F_3 ( V_5 -> V_63 ) ;
F_4 ( V_6 , V_2 , V_5 -> V_62 ) ;
}
...
V_6 = F_2 ( V_2 , V_5 -> V_62 ) ;
V_6 &= ~ V_5 -> V_63 ;
V_6 |= V_65 << F_3 ( V_5 -> V_63 ) ;
F_4 ( V_6 , V_2 , V_5 -> V_62 ) ;
}
static struct V_1 * F_40 ( struct V_53 * V_14 )
{
...
unsigned long F_43 ( struct V_53 * V_14 ,
unsigned long V_54 )
{
const struct V_4 * V_5 ;
unsigned long V_60 ;
...
V_5 = V_66 -> V_4 ;
F_29 ( ! V_5 -> V_8 ) ;
V_6 = F_2 ( V_66 , V_5 -> V_7 ) & V_5 -> V_8 ;
V_6 >>= F_3 ( V_5 -> V_8 ) ;
if ( ( V_6 != V_68 ) || ( V_5 -> V_69 & V_70 ) )
V_60 = V_54 ;
else
V_60 = V_54 * 2 ;
return V_60 ;
}
int F_44 ( struct V_53 * V_14 , unsigned long V_60 ,
unsigned long V_54 )
{
return 0 ;
}
long F_45 ( struct V_53 * V_14 , unsigned long V_60 ,
unsigned long * V_71 )
{
const struct V_4 * V_5 ;
T_2 V_6 ;
...
V_5 = V_66 -> V_4 ;
if ( V_5 -> V_69 & V_70 ) {
* V_71 = F_37 ( F_19 ( V_66 -> V_14 . V_2 ) , V_60 ) ;
return * V_71 ;
}
F_29 ( ! V_5 -> V_8 ) ;
V_6 = F_2 ( V_66 , V_5 -> V_7 ) & V_5 -> V_8 ;
...
if ( V_6 != V_68 )
return * V_71 ;
if ( F_42 ( V_14 -> V_2 ) & V_72 ) {
unsigned long V_73 ;
V_73 = ( V_60 / 2 ) ;
* V_71 = F_37 ( F_19 ( V_14 -> V_2 ) ,
V_73 ) ;
}
return * V_71 * 2 ;
}
