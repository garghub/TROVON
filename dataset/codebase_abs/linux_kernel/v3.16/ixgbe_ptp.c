...
int F_40 ( struct V_1 * V_2 , struct V_101 * V_102 )
{
struct V_103 V_104 ;
int V_146 ;
if ( F_41 ( & V_104 , V_102 -> V_106 , sizeof( V_104 ) ) )
return - V_107 ;
V_146 = F_38 ( V_2 , & V_104 ) ;
if ( V_146 )
return V_146 ;
...
{
struct V_161 * V_162 = V_2 -> V_162 ;
long V_146 ;
if ( ! F_48 ( V_2 -> V_67 ) )
return 0 ;
switch ( V_2 -> V_4 . V_18 . type ) {
case V_19 :
snprintf ( V_2 -> V_40 . V_163 ,
sizeof( V_2 -> V_40 . V_163 ) ,
L_3 , V_162 -> V_163 ) ;
V_2 -> V_40 . V_164 = V_165 ;
V_2 -> V_40 . V_166 = 250000000 ;
V_2 -> V_40 . V_167 = 0 ;
V_2 -> V_40 . V_168 = 0 ;
V_2 -> V_40 . V_169 = 0 ;
V_2 -> V_40 . V_170 = 1 ;
