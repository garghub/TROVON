...
for ( V_4 = 0 ; V_4 < V_3 -> V_8 ; V_4 ++ ) {
V_3 -> V_9 [ V_4 ] . V_10 = ( char * ) F_32 ( F_23 ( V_3 -> V_9 [ V_4 ] . V_10 ) ) ;
V_6 += V_3 -> V_9 [ V_4 ] . V_12 ;
V_3 -> V_9 [ V_4 ] . V_12 = F_32 ( V_3 -> V_9 [ V_4 ] . V_12 ) ;
}
V_7 = V_3 -> V_7 ;
if ( V_3 -> V_7 )
V_3 -> V_7 = (struct V_1 * ) F_32 ( F_23 ( V_3 -> V_7 ) ) ;
else
V_3 -> V_7 = NULL ;
V_3 -> V_8 = ( V_85 << 56 ) | ( ( V_3 -> V_8 + 1 ) * 16 ) ;
V_3 -> V_8 = F_32 ( V_3 -> V_8 ) ;
}
F_2 ( V_83 L_23 , V_6 ) ;
F_2 ( V_83 L_24 ) ;
F_33 ( L_25 , 0x0 ) ;
...
for ( V_4 = 0 ; V_4 < F_38 ( V_89 ) ; V_4 ++ ) {
const struct V_90 * V_3 = & V_89 [ V_4 ] ;
int V_61 ;
if ( ! F_39 ( V_3 -> V_91 , V_92 | V_93 , NULL , & V_3 -> V_94 ) )
goto V_95;
V_61 = F_17 ( V_3 -> V_96 ) ;
if ( V_61 == V_84 )
* V_3 -> V_26 = V_27 ;
