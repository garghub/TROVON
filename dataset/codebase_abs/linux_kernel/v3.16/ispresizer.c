...
static void F_64 ( const struct V_1 * V_215 ,
...
V_13 -> V_91 = F_42 ( T_2 , V_13 -> V_91 , 0 , V_215 -> V_81 - V_216 ) ;
V_13 -> V_81 = F_42 ( T_2 , V_13 -> V_81 , V_216 ,
V_215 -> V_81 - V_13 -> V_91 ) ;
V_13 -> V_92 = F_42 ( T_2 , V_13 -> V_92 , 0 , V_215 -> V_82 - V_217 ) ;
V_13 -> V_82 = F_42 ( T_2 , V_13 -> V_82 , V_217 ,
V_215 -> V_82 - V_13 -> V_92 ) ;
}
static int F_65 ( struct V_207 * V_208 ,
struct V_4 * V_5 ,
struct V_218 * V_219 )
{
struct V_2 * V_3 = F_57 ( V_208 ) ;
...
if ( V_219 -> V_6 != V_12 )
return - V_222 ;
V_221 = F_1 ( V_3 , V_5 , V_12 ,
V_219 -> V_8 ) ;
V_220 = F_1 ( V_3 , V_5 , V_115 ,
V_219 -> V_8 ) ;
switch ( V_219 -> V_223 ) {
case V_224 :
V_219 -> V_225 . V_91 = 0 ;
V_219 -> V_225 . V_92 = 0 ;
V_219 -> V_225 . V_81 = V_226 ;
V_219 -> V_225 . V_82 = V_226 ;
F_64 ( V_221 , V_220 , & V_219 -> V_225 ) ;
F_38 ( V_3 , & V_219 -> V_225 , V_220 , & V_66 ) ;
break;
case V_227 :
V_219 -> V_225 = * F_3 ( V_3 , V_5 , V_219 -> V_8 ) ;
F_38 ( V_3 , & V_219 -> V_225 , V_220 , & V_66 ) ;
break;
default:
return - V_222 ;
...
static int F_66 ( struct V_207 * V_208 ,
struct V_4 * V_5 ,
struct V_218 * V_219 )
{
struct V_2 * V_3 = F_57 ( V_208 ) ;
struct V_17 * V_18 = F_6 ( V_3 ) ;
struct V_1 * V_221 , * V_220 ;
struct V_65 V_66 ;
...
V_219 -> V_225 . V_91 , V_219 -> V_225 . V_92 , V_219 -> V_225 . V_81 , V_219 -> V_225 . V_82 ,
V_219 -> V_8 ) ;
F_18 ( V_18 -> V_83 , L_8 , V_140 ,
V_221 -> V_81 , V_221 -> V_82 ,
V_220 -> V_81 , V_220 -> V_82 ) ;
F_64 ( V_221 , V_220 , & V_219 -> V_225 ) ;
* F_3 ( V_3 , V_5 , V_219 -> V_8 ) = V_219 -> V_225 ;
F_38 ( V_3 , & V_219 -> V_225 , V_220 , & V_66 ) ;
if ( V_219 -> V_8 == V_9 )
return 0 ;
V_3 -> V_66 = V_66 ;
V_3 -> V_13 . V_119 = V_219 -> V_225 ;
if ( V_3 -> V_184 != V_192 )
V_3 -> V_200 = 1 ;
return 0 ;
}
...
V_231 -> V_181 != V_38 )
V_231 -> V_181 = V_36 ;
V_231 -> V_81 = F_42 ( T_2 , V_231 -> V_81 , V_216 ,
F_67 ( V_3 ) ) ;
V_231 -> V_82 = F_42 ( T_2 , V_231 -> V_82 , V_217 ,
V_233 ) ;
break;
case V_115 :
V_232 = F_1 ( V_3 , V_5 , V_12 , V_8 ) ;
V_231 -> V_181 = V_232 -> V_181 ;
V_13 = * F_3 ( V_3 , V_5 , V_8 ) ;
F_38 ( V_3 , & V_13 , V_231 , & V_66 ) ;
break;
}
V_231 -> V_234 = V_235 ;
V_231 -> V_236 = V_237 ;
...
struct V_1 * V_232 ;
if ( V_181 -> V_6 == V_12 ) {
if ( V_181 -> V_239 >= F_70 ( V_240 ) )
return - V_222 ;
V_181 -> V_181 = V_240 [ V_181 -> V_239 ] ;
} else {
if ( V_181 -> V_239 != 0 )
return - V_222 ;
V_232 = F_1 ( V_3 , V_5 , V_12 ,
V_9 ) ;
V_181 -> V_181 = V_232 -> V_181 ;
}
return 0 ;
}
...
if ( V_242 -> V_239 != 0 )
return - V_222 ;
V_232 . V_181 = V_242 -> V_181 ;
V_232 . V_81 = 1 ;
V_232 . V_82 = 1 ;
F_68 ( V_3 , V_5 , V_242 -> V_6 , & V_232 , V_9 ) ;
V_242 -> V_164 = V_232 . V_81 ;
V_242 -> V_165 = V_232 . V_82 ;
if ( V_232 . V_181 != V_242 -> V_181 )
return - V_222 ;
V_232 . V_181 = V_242 -> V_181 ;
V_232 . V_81 = - 1 ;
V_232 . V_82 = - 1 ;
F_68 ( V_3 , V_5 , V_242 -> V_6 , & V_232 , V_9 ) ;
V_242 -> V_166 = V_232 . V_81 ;
V_242 -> V_167 = V_232 . V_82 ;
return 0 ;
}
...
struct V_2 * V_3 = F_57 ( V_208 ) ;
struct V_1 * V_232 ;
V_232 = F_1 ( V_3 , V_5 , V_231 -> V_6 , V_231 -> V_8 ) ;
if ( V_232 == NULL )
return - V_222 ;
V_231 -> V_232 = * V_232 ;
return 0 ;
...
if ( V_232 == NULL )
return - V_222 ;
F_68 ( V_3 , V_5 , V_231 -> V_6 , & V_231 -> V_232 , V_231 -> V_8 ) ;
* V_232 = V_231 -> V_232 ;
if ( V_231 -> V_6 == V_12 ) {
V_13 = F_3 ( V_3 , V_5 , V_231 -> V_8 ) ;
V_13 -> V_91 = 0 ;
V_13 -> V_92 = 0 ;
V_13 -> V_81 = V_231 -> V_232 . V_81 ;
V_13 -> V_82 = V_231 -> V_232 . V_82 ;
V_232 = F_1 ( V_3 , V_5 , V_115 ,
V_231 -> V_8 ) ;
* V_232 = V_231 -> V_232 ;
F_68 ( V_3 , V_5 , V_115 , V_232 ,
V_231 -> V_8 ) ;
}
if ( V_231 -> V_8 == V_201 ) {
V_3 -> V_13 . V_119 = V_3 -> V_13 . V_14 ;
F_38 ( V_3 , & V_3 -> V_13 . V_119 , V_232 ,
& V_3 -> V_66 ) ;
}
return 0 ;
}
...
{
struct V_2 * V_3 = F_57 ( V_208 ) ;
struct V_110 * V_111 = F_26 ( & V_208 -> V_113 ) ;
F_25 ( V_3 , & V_111 -> V_109 ) ;
return F_75 ( V_208 , V_245 ,
V_246 , V_247 ) ;
}
...
V_232 . V_6 = V_12 ;
V_232 . V_8 = V_5 ? V_9 : V_201 ;
V_232 . V_232 . V_181 = V_36 ;
V_232 . V_232 . V_81 = 4096 ;
V_232 . V_232 . V_82 = 4096 ;
F_73 ( V_208 , V_5 , & V_232 ) ;
return 0 ;
}
static int F_77 ( struct V_248 * V_113 ,
const struct V_249 * V_250 ,
const struct V_249 * V_251 , T_2 V_252 )
{
struct V_207 * V_208 = F_78 ( V_113 ) ;
struct V_2 * V_3 = F_57 ( V_208 ) ;
switch ( V_250 -> V_239 | F_79 ( V_251 -> V_113 ) ) {
case V_12 | V_253 :
if ( V_252 & V_254 ) {
if ( V_3 -> V_129 == V_179 )
return - V_255 ;
...
{
int V_260 ;
V_260 = F_84 ( V_259 , & V_3 -> V_112 ) ;
if ( V_260 < 0 )
goto error;
V_260 = F_85 ( & V_3 -> V_195 , V_259 ) ;
if ( V_260 < 0 )
goto error;
V_260 = F_85 ( & V_3 -> V_186 , V_259 ) ;
if ( V_260 < 0 )
goto error;
return 0 ;
error:
...
struct V_249 * V_261 = V_3 -> V_261 ;
struct V_248 * V_262 = & V_208 -> V_113 ;
int V_260 ;
V_3 -> V_129 = V_256 ;
F_87 ( V_208 , & V_263 ) ;
V_208 -> V_264 = & V_265 ;
F_88 ( V_208 -> V_214 , L_9 , sizeof( V_208 -> V_214 ) ) ;
V_208 -> V_266 = 1 << 16 ;
F_89 ( V_208 , V_3 ) ;
V_208 -> V_252 |= V_267 ;
V_261 [ V_12 ] . V_252 = V_268
| V_269 ;
V_261 [ V_115 ] . V_252 = V_270 ;
V_262 -> V_271 = & V_272 ;
V_260 = F_90 ( V_262 , V_273 , V_261 , 0 ) ;
if ( V_260 < 0 )
return V_260 ;
F_76 ( V_208 , NULL ) ;
V_3 -> V_195 . type = V_205 ;
V_3 -> V_195 . V_271 = & V_274 ;
V_3 -> V_195 . V_18 = F_6 ( V_3 ) ;
V_3 -> V_195 . V_275 = F_91 ( 4096 * 4096 ) * 2 * 3 ;
V_3 -> V_195 . V_276 = 32 ;
V_3 -> V_186 . type = V_206 ;
V_3 -> V_186 . V_271 = & V_274 ;
V_3 -> V_186 . V_18 = F_6 ( V_3 ) ;
V_3 -> V_186 . V_275 = F_91 ( 4096 * 4096 ) * 2 * 3 ;
V_3 -> V_186 . V_276 = 32 ;
V_260 = F_92 ( & V_3 -> V_195 , L_10 ) ;
if ( V_260 < 0 )
goto V_277;
V_260 = F_92 ( & V_3 -> V_186 , L_10 ) ;
if ( V_260 < 0 )
goto V_278;
V_3 -> V_186 . V_203 . V_113 . V_252 |= V_279 ;
V_260 = F_93 ( & V_3 -> V_195 . V_203 . V_113 , 0 ,
& V_3 -> V_112 . V_113 , V_12 , 0 ) ;
if ( V_260 < 0 )
goto V_280;
V_260 = F_93 ( & V_3 -> V_112 . V_113 , V_115 ,
