...
bool F_22 ( struct V_4 * V_14 )
{
if ( F_8 ( V_14 ) )
return F_20 ( V_14 ) ;
return true ;
}
static void F_23 ( struct V_16 * V_14 , unsigned int V_33 )
{
unsigned int V_11 ;
V_14 -> V_9 [ V_33 ] = NULL ;
V_11 = V_33 ;
if ( V_14 -> V_21 . V_34 [ V_11 ] . V_29 & V_35 )
F_24 ( F_25 ( V_14 -> V_21 . V_34 [ V_11 ] . V_36 ) ) ;
while ( V_14 -> V_21 . V_34 [ V_11 ] . V_29 & V_37 ) {
V_11 = V_14 -> V_21 . V_34 [ V_11 ] . V_38 ;
V_14 -> V_14 . V_39 ++ ;
}
V_14 -> V_21 . V_34 [ V_11 ] . V_38 = V_14 -> V_40 ;
V_14 -> V_40 = V_33 ;
V_14 -> V_14 . V_39 ++ ;
}
static inline bool F_26 ( const struct V_16 * V_14 )
{
return V_14 -> V_41 != V_14 -> V_21 . V_28 -> V_23 ;
}
void * F_27 ( struct V_4 * V_5 , unsigned int * V_42 )
{
struct V_16 * V_14 = F_9 ( V_5 ) ;
void * V_43 ;
unsigned int V_11 ;
...
F_29 ( V_14 -> V_20 ) ;
V_44 = ( V_14 -> V_41 & ( V_14 -> V_21 . V_15 - 1 ) ) ;
V_11 = V_14 -> V_21 . V_28 -> V_45 [ V_44 ] . V_46 ;
* V_42 = V_14 -> V_21 . V_28 -> V_45 [ V_44 ] . V_42 ;
if ( F_21 ( V_11 >= V_14 -> V_21 . V_15 ) ) {
F_30 ( V_14 , L_2 , V_11 ) ;
return NULL ;
}
if ( F_21 ( ! V_14 -> V_9 [ V_11 ] ) ) {
F_30 ( V_14 , L_3 , V_11 ) ;
return NULL ;
}
V_43 = V_14 -> V_9 [ V_11 ] ;
...
F_10 ( V_14 ) ;
V_14 -> V_21 . V_22 -> V_29 &= ~ V_47 ;
F_31 ( & V_14 -> V_21 ) = V_41 = V_14 -> V_41 ;
F_19 ( V_14 ) ;
return V_41 ;
}
bool F_34 ( struct V_4 * V_5 , unsigned V_41 )
{
struct V_16 * V_14 = F_9 ( V_5 ) ;
F_11 ( V_14 -> V_20 ) ;
return ( T_2 ) V_41 != V_14 -> V_21 . V_28 -> V_23 ;
}
bool F_35 ( struct V_4 * V_5 )
{
unsigned V_41 = F_33 ( V_5 ) ;
return ! F_34 ( V_5 , V_41 ) ;
}
...
F_10 ( V_14 ) ;
V_14 -> V_21 . V_22 -> V_29 &= ~ V_47 ;
V_48 = ( T_2 ) ( V_14 -> V_21 . V_22 -> V_23 - V_14 -> V_41 ) * 3 / 4 ;
F_31 ( & V_14 -> V_21 ) = V_14 -> V_41 + V_48 ;
F_11 ( V_14 -> V_20 ) ;
if ( F_21 ( ( T_2 ) ( V_14 -> V_21 . V_28 -> V_23 - V_14 -> V_41 ) > V_48 ) ) {
F_19 ( V_14 ) ;
return false ;
}
F_19 ( V_14 ) ;
...
F_38 ( V_14 -> V_14 . V_39 != V_14 -> V_21 . V_15 ) ;
F_19 ( V_14 ) ;
return NULL ;
}
...
V_14 -> V_21 . V_34 [ V_11 ] . V_38 = V_11 + 1 ;
V_14 -> V_9 [ V_11 ] = NULL ;
}
V_14 -> V_9 [ V_11 ] = NULL ;
return & V_14 -> V_14 ;
...
bool F_51 ( struct V_4 * V_5 )
{
struct V_16 * V_14 = F_9 ( V_5 ) ;
return V_14 -> V_31 ;
}
void F_52 ( struct V_56 * V_60 )
{
struct V_4 * V_5 ;
F_53 (_vq, &dev->vqs, list) {
struct V_16 * V_14 = F_9 ( V_5 ) ;
V_14 -> V_31 = true ;
}
}
