...
{
struct V_104 * V_157 = F_100 ( V_169 ) ;
void T_1 * V_45 = V_157 -> V_42 ;
...
case V_172 :
default:
F_105 ( L_47 , F_106 ( V_169 -> V_175 ) ) ;
return - V_15 ;
}
F_22 ( V_46 , V_45 + V_186 ) ;
return 0 ;
}
static void F_107 ( struct V_168 * V_169 )
{
}
static unsigned int F_108 ( struct V_168 * V_169 )
{
struct V_104 * V_157 = F_100 ( V_169 ) ;
unsigned V_43 = V_169 -> V_170 ;
int V_88 ;
V_88 = F_109 ( & V_157 -> V_107 , V_43 ) ;
if ( V_88 ) {
...
static void F_110 ( struct V_168 * V_169 )
{
struct V_104 * V_157 = F_100 ( V_169 ) ;
unsigned V_43 = V_169 -> V_170 ;
F_99 ( V_169 ) ;
F_111 ( & V_157 -> V_107 , V_43 ) ;
}
static int F_112 ( struct V_168 * V_169 , unsigned V_187 )
{
struct V_104 * V_157 = F_100 ( V_169 ) ;
...
static void F_120 ( unsigned V_175 , struct V_196 * V_197 )
{
struct V_198 * V_107 = F_121 ( V_175 ) ;
struct V_106 * V_106 = F_122 ( V_197 ) ;
struct V_104 * V_157 = F_58 ( V_106 ,
struct V_104 , V_107 ) ;
void T_1 * V_45 = V_157 -> V_42 ;
unsigned long V_199 ;
int V_200 ;
...
static int F_128 ( struct V_19 * V_204 ,
struct V_104 * V_157 )
{
struct V_104 * V_205 = NULL ;
struct V_168 * V_169 = F_129 ( V_157 -> V_191 ) ;
int V_88 ;
V_157 -> V_206 = F_130 ( V_169 ) ;
V_207 . V_208 = V_157 -> V_91 -> V_209 ;
F_22 ( ~ 0 , V_157 -> V_42 + V_47 ) ;
V_88 = F_131 ( & V_157 -> V_107 ,
& V_207 ,
0 ,
V_210 ,
V_173 ) ;
...
int V_88 = 0 ;
int V_175 , V_6 ;
int V_214 = F_136 ( V_20 , L_51 ) ;
T_3 V_156 ;
char * * V_215 ;
F_137 ( V_214 >= F_138 ( V_41 ) ) ;
if ( V_41 [ V_214 ] ) {
V_88 = - V_216 ;
goto V_154;
}
...
V_213 = F_140 ( V_141 , V_217 , 0 ) ;
V_105 -> V_42 = F_141 ( & V_141 -> V_9 , V_213 ) ;
if ( F_142 ( V_105 -> V_42 ) ) {
V_88 = F_143 ( V_105 -> V_42 ) ;
goto V_154;
}
V_105 -> V_91 = (struct V_145 * )
F_76 ( V_218 , & V_141 -> V_9 ) -> V_30 ;
V_105 -> V_191 = V_175 ;
V_105 -> V_188 = V_214 ;
V_105 -> clock = F_144 ( & V_141 -> V_9 , NULL ) ;
...
for ( V_6 = 0 ; V_6 < V_107 -> V_156 ; V_6 ++ )
V_215 [ V_6 ] = F_79 ( V_27 , L_38 , V_214 + 'A' , V_6 ) ;
