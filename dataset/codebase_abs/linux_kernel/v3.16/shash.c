...
static unsigned int F_75 ( struct V_49 * V_52 )
{
return V_52 -> V_72 ;
}
static int F_76 ( struct V_73 * V_74 , struct V_49 * V_52 )
{
struct V_75 V_76 ;
...
static void F_78 ( struct V_83 * V_84 , struct V_49 * V_52 )
{
struct V_6 * V_77 = F_55 ( V_52 ) ;
F_79 ( V_84 , L_2 ) ;
F_79 ( V_84 , L_3 , V_52 -> V_79 ) ;
F_79 ( V_84 , L_4 , V_77 -> V_66 ) ;
}
struct V_1 * F_80 ( const char * V_85 , T_4 type ,
T_4 V_17 )
{
return F_81 ( V_85 , & V_55 , type , V_17 ) ;
}
static int F_82 ( struct V_6 * V_52 )
{
...
int F_85 ( struct V_6 * V_52 )
{
return F_86 ( & V_52 -> V_37 ) ;
}
...
int F_88 ( struct V_6 * V_90 , int V_91 )
{
int V_92 , V_93 ;
...
if ( V_12 )
return V_12 ;
return F_91 ( V_97 , F_92 ( V_99 ) ) ;
}
void F_93 ( struct V_100 * V_99 )
{
F_94 ( F_95 ( V_99 ) ) ;
F_96 ( V_98 ( V_99 ) ) ;
}
...
struct V_100 * V_99 )
{
return F_98 ( & V_102 -> V_37 , & V_52 -> V_37 , V_99 ,
& V_55 ) ;
}
struct V_6 * F_99 ( struct V_103 * V_104 , T_4 type , T_4 V_17 )
{
struct V_49 * V_52 ;
V_52 = F_100 ( V_104 , & V_55 , type , V_17 ) ;
return F_59 ( V_52 ) ? F_101 ( V_52 ) :
F_102 ( V_52 , struct V_6 , V_37 ) ;
}
