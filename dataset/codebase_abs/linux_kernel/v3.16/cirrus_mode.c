...
* V_104 )
{
int V_106 = V_104 -> V_107 [ 0 ] ;
struct V_108 * V_41 ;
struct V_96 * V_97 ;
if ( V_106 ) {
V_41 =
F_52 ( V_104 -> V_5 , V_106 ,
V_109 ) ;
if ( ! V_41 )
return NULL ;
V_97 = F_53 ( V_41 ) ;
...
static enum V_110 F_54 ( struct V_90
* V_104 , bool V_111 )
{
return V_112 ;
}
static void F_55 ( struct V_90 * V_104 )
{
F_56 ( V_104 ) ;
F_29 ( V_104 ) ;
}
static struct V_90 * F_57 ( struct V_4 * V_5 )
{
struct V_90 * V_104 ;
struct V_113 * V_113 ;
V_113 = F_31 ( sizeof( struct V_113 ) , V_91 ) ;
if ( ! V_113 )
return NULL ;
V_104 = & V_113 -> V_92 ;
F_58 ( V_5 , V_104 ,
