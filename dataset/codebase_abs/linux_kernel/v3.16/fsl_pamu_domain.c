...
V_109 = F_71 ( V_81 ) ;
F_72 ( & V_109 , F_73 ( V_109 ) ) ;
if ( V_109 -> V_112 &&
! F_74 ( V_109 , V_113 ) ) {
T_6 V_27 , V_114 = F_75 ( V_109 -> V_115 ) ;
for ( V_27 = 0 ; V_27 < 8 ; V_27 ++ ) {
struct V_80 * V_56 ;
V_56 = F_76 ( V_109 -> V_84 , F_77 ( V_114 , V_27 ) ) ;
if ( ! V_56 )
continue;
if ( ! F_74 ( V_56 , V_113 ) ) {
F_72 ( & V_109 , V_56 ) ;
...
if ( F_80 ( V_84 -> V_116 , NULL , V_113 ) )
break;
F_72 ( & V_109 , F_71 ( V_84 -> V_116 ) ) ;
}
V_117:
V_101 = F_60 ( & V_109 -> V_41 ) ;
F_78 ( V_109 ) ;
if ( V_83 -> V_85 -> V_100 )
F_81 ( V_83 -> V_85 ) ;
} else {
...
static int F_89 ( struct V_15 * V_48 , T_4 V_118 )
{
struct V_2 * V_7 = V_48 -> V_59 ;
unsigned long V_30 ;
int V_28 ;
