...
V_23 = NULL ;
V_12 = F_47 ( V_20 , V_39 , L_5 ) ;
V_29 = F_48 ( & V_20 -> V_2 , V_12 ) ;
if ( F_42 ( V_29 ) ) {
V_30 = F_49 ( V_29 ) ;
goto V_40;
}
...
return - V_10 ;
V_26 = F_65 ( V_20 -> V_2 . V_47 ) ;
if ( ! V_26 )
return - V_36 ;
V_45 = F_40 ( sizeof( * V_45 ) , V_34 ) ;
if ( ! V_45 )
return - V_35 ;
V_45 -> V_48 = V_7 -> V_48 ;
V_45 -> V_20 = V_20 ;
...
if ( V_51 == - 1 )
break;
F_67 ( V_26 -> V_16 , V_51 , 0 ) ;
F_68 ( V_26 -> V_16 , V_7 -> V_48 , 0 ) ;
F_69 ( V_26 -> V_16 , V_51 , 0 ) ;
F_70 ( V_26 -> V_16 , V_51 , V_7 -> V_48 ) ;
F_71 ( V_26 -> V_16 , V_7 -> V_48 , 0 ) ;
F_72 ( V_26 -> V_16 , V_7 -> V_48 , V_7 -> V_48 ) ;
F_73 ( V_26 -> V_16 , V_51 , 3 ) ;
}
if ( V_26 -> V_22 )
F_58 ( V_26 -> V_22 ) ;
F_58 ( V_26 -> V_42 ) ;
F_74 ( & V_20 -> V_2 , L_11 , V_7 -> V_9 , V_7 -> V_48 ) ;
return 0 ;
V_15:
F_60 ( V_45 ) ;
return V_30 ;
