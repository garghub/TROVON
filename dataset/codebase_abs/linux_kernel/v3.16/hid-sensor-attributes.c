...
V_8 = V_29 % F_1 ( exp ) ;
V_32 = 0 ;
for ( V_2 = 0 ; V_2 < ( 6 - exp ) ; ++ V_2 ) {
V_31 = V_30 / F_1 ( 5 - V_2 ) ;
V_32 += ( F_1 ( 5 - exp - V_2 ) * V_31 ) ;
V_30 = V_30 % F_1 ( 5 - V_2 ) ;
}
* V_10 = V_8 * F_1 ( 6 - exp ) + V_32 ;
} else {
* V_28 = V_29 ;
* V_10 = V_30 ;
}
...
V_16 -> V_44 . V_20 , V_16 -> V_44 . V_19 ,
V_16 -> V_46 . V_20 , V_16 -> V_46 . V_19 ,
