...
static T_4 F_36 ( int V_4 , void * V_50 )
{
struct V_51 * V_52 ;
int V_1 = F_37 () ;
F_38 ( V_1 ) ;
...
#else
V_4 = F_32 ( NULL , V_84 ) ;
V_65 = F_51 ( V_4 , F_39 , V_94 , L_16 , NULL ) ;
#endif
if ( V_65 ) {
F_52 ( L_17 , V_4 ) ;
F_53 () ;
}
F_11 ( & V_47 -> V_48 [ V_49 ] . V_85 ,
V_95 |
V_96 |
V_97 |
V_98 ) ;
...
static void F_56 ( int V_1 , unsigned int V_99 )
{
}
void T_5 F_57 ( struct V_56 * V_100 )
{
if ( strcmp ( V_100 -> type , L_19 ) == 0 && strcmp ( V_100 -> V_35 , L_20 ) == 0 ) {
struct V_60 * V_9 ;
V_9 = F_46 ( V_100 , L_21 , ( void * ) 0 ) ;
if ( V_9 ) {
int V_101 ;
V_100 -> V_35 = F_58 ( 5 + 1 ) ;
memcpy ( & V_101 , V_9 -> V_81 , V_9 -> V_102 ) ;
sprintf ( ( char * ) V_100 -> V_35 , L_22 , V_101 ) ;
}
}
}
void F_38 ( int V_1 )
...
void F_59 ( unsigned int V_103 , unsigned int V_1 )
{
unsigned long V_11 , V_24 , * V_104 ;
V_11 = F_12 ( V_103 ) ;
F_20 ( & V_29 , V_24 ) ;
V_104 = ( unsigned long * ) F_10 ( V_1 ) ;
F_11 ( V_104 , ( F_2 ( V_104 ) | V_11 ) ) ;
F_21 ( & V_29 , V_24 ) ;
}
void T_5 F_60 ( void )
{
