...
static void F_110 ( struct V_5 * V_266 , int V_37 )
{
...
static void F_115 ( struct V_81 * V_14 , int V_274 )
{
struct V_5 * V_6 =
F_35 ( V_14 , struct V_5 , V_14 ) ;
F_110 ( V_6 , V_272 ) ;
...
static void
F_116 ( struct V_275 * V_276 , const char * V_277 , unsigned int V_3 )
{
struct V_5 * V_6 ;
unsigned long V_185 ;
int V_278 = 1 ;
...
V_278 = F_118 ( & V_6 -> V_187 ) ;
V_279 = F_118 ( & V_6 -> V_14 . V_187 ) ;
} else {
F_96 ( & V_6 -> V_187 ) ;
F_96 ( & V_6 -> V_14 . V_187 ) ;
}
V_33 = F_3 ( V_6 -> V_15 + V_16 ) ;
F_10 ( V_6 , V_219 ) ;
F_119 ( & V_6 -> V_14 , V_277 , V_3 , F_115 ) ;
F_110 ( V_6 , V_273 ) ;
F_4 ( V_33 , V_6 -> V_15 + V_16 ) ;
if ( V_279 )
F_99 ( & V_6 -> V_14 . V_187 ) ;
...
static int T_10 F_121 ( struct V_275 * V_276 , char * V_283 )
{
struct V_81 * V_14 ;
int V_35 = V_220 ;
int V_37 = 8 ;
...
V_14 -> V_41 = F_7 () ;
if ( V_283 )
F_122 ( V_283 , & V_35 , & V_36 , & V_37 , & V_284 ) ;
return F_123 ( V_14 , V_276 , V_35 , V_36 , V_37 , V_284 ) ;
}
...
#endif
V_10 = F_133 ( & V_309 , & V_6 -> V_14 ) ;
if ( V_10 < 0 )
goto V_298;
#ifdef F_125
snprintf ( V_292 , sizeof( V_292 ) , L_48 , V_291 -> V_306 ) ;
V_6 -> V_310 = F_134 ( V_292 , V_311 | V_312 ,
NULL , V_6 , & V_313 ) ;
#endif
return V_6 ;
V_298:
