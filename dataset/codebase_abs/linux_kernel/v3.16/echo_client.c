...
int V_117 ;
V_117 = F_156 ( V_26 , V_38 , V_236 , V_238 ) ;
if ( V_117 == 0 )
continue;
V_227 = V_227 ? : V_117 ;
}
...
static int F_157 ( struct V_10 * V_11 , int V_239 , T_2 V_240 ,
...
F_14 ( V_241 [ V_247 ] ) ;
V_236 = F_160 ( V_26 , V_59 , F_141 ( V_59 , V_240 ) ,
V_241 [ V_247 ] , V_255 ) ;
if ( F_131 ( V_236 ) ) {
V_117 = F_137 ( V_236 ) ;
break;
...
if ( V_243 )
V_117 = F_154 ( V_26 , V_38 , V_259 , V_235 ) ;
else
V_117 = F_165 ( V_26 , V_38 , V_259 , V_235 , 0 ) ;
F_119 ( V_181 , L_18 ,
V_243 ? L_19 : L_20 , V_117 ) ;
}
F_149 ( V_26 , V_72 , V_245 . V_52 ) ;
V_254:
F_166 ( V_26 , V_38 , V_235 ) ;
F_167 ( V_26 , V_38 , V_235 ) ;
F_168 ( V_26 , V_235 ) ;
F_148 ( V_26 , V_38 ) ;
V_150:
F_135 ( V_26 , & V_190 ) ;
...
static int
F_169 ( struct V_93 * V_187 , void * V_261 , int V_262 )
{
struct V_93 * V_263 = V_261 ;
int V_264 , V_247 ;
V_264 = F_170 ( struct V_93 , V_97 [ V_187 -> V_265 ] ) ;
if ( V_264 > V_262 )
return ( - V_165 ) ;
if ( F_171 ( V_263 , V_187 , sizeof( * V_263 ) ) )
return ( - V_266 ) ;
for ( V_247 = 0 ; V_247 < V_187 -> V_265 ; V_247 ++ ) {
if ( F_171 ( V_263 -> V_97 [ V_247 ] , V_187 -> V_97 [ V_247 ] ,
sizeof( V_187 -> V_97 [ 0 ] ) ) )
return ( - V_266 ) ;
}
return 0 ;
...
return ( - V_165 ) ;
if ( F_173 ( V_187 , V_263 , sizeof ( * V_187 ) ) )
return ( - V_266 ) ;
...
static inline void F_174 ( struct V_271 * V_272 , char * V_177 ,
T_3 V_273 )
{
...
static int F_175 ( const struct V_25 * V_26 , struct V_277 * V_13 ,
struct V_278 * V_279 )
{
struct V_24 * V_27 = F_12 ( V_26 ) ;
int V_117 ;
F_14 ( V_279 -> V_280 > 0 ) ;
V_117 = F_176 ( V_26 , V_13 , & V_281 , V_282 ) ;
if ( V_117 < 0 )
return V_117 ;
if ( V_27 -> V_283 < V_117 ) {
int V_284 = F_177 ( V_117 ) ;
if ( V_27 -> V_283 > 0 ) {
F_14 ( V_27 -> V_285 ) ;
F_178 ( V_27 -> V_285 ,
V_27 -> V_283 ) ;
...
V_117 = F_176 ( V_26 , V_13 , & V_27 -> V_286 , V_282 ) ;
if ( V_117 < 0 )
return V_117 ;
V_279 -> V_289 |= V_290 ;
...
int F_180 ( const struct V_25 * V_26 , struct V_277 * V_145 ,
struct V_278 * V_279 )
{
struct V_24 * V_27 = F_12 ( V_26 ) ;
struct V_292 * V_293 = & V_27 -> V_286 ;
T_5 V_208 = F_181 ( & V_145 -> V_294 ) ;
int V_58 = V_279 -> V_295 ;
int V_117 = 0 , V_176 ;
V_279 -> V_289 = 0 ;
if ( V_58 & V_296 ) {
V_279 -> V_295 = V_296 ;
V_117 = F_182 ( V_26 , V_145 , V_279 ) ;
if ( V_117 )
GOTO ( V_150 , V_117 ) ;
V_279 -> V_289 |= V_296 ;
}
...
V_176 = F_176 ( V_26 , V_145 , V_293 , V_282 ) ;
if ( V_176 > 0 ) {
V_279 -> V_280 = V_176 ;
V_279 -> V_289 |= V_290 ;
} else if ( V_176 == - V_46 ) {
...
#ifdef F_185
if ( V_58 & V_298 && F_184 ( V_208 ) ) {
V_293 -> V_287 = V_279 -> V_299 ;
V_293 -> V_288 = V_279 -> V_300 ;
V_176 = F_176 ( V_26 , V_145 , V_293 , V_301 ) ;
if ( V_176 > 0 ) {
V_279 -> V_300 = V_176 ;
V_279 -> V_289 |= V_298 ;
} else if ( V_176 == - V_46 ) {
...
int V_117 ;
V_117 = F_187 ( V_26 , V_303 , V_272 , V_308 , V_305 ) ;
if ( V_117 == 0 )
return - V_312 ;
else if ( V_117 != - V_232 )
return V_117 ;
V_306 = F_188 ( V_26 , & V_72 -> V_4 . V_151 ,
V_189 , & V_69 ) ;
if ( F_131 ( V_306 ) ) {
F_79 ( L_23 V_313 L_24 , F_189 ( V_189 ) ,
F_137 ( V_306 ) ) ;
return F_137 ( V_306 ) ;
}
V_307 = F_190 ( V_306 -> V_83 , V_163 -> V_168 ) ;
if ( V_307 == NULL ) {
F_79 ( L_25 V_313 L_16 , F_189 ( V_189 ) ) ;
GOTO ( V_314 , V_117 = - V_165 ) ;
}
F_119 ( V_315 , L_26 V_313 L_27 ,
F_189 ( F_191 ( & V_303 -> V_294 ) ) , V_272 -> V_275 , V_303 ) ;
V_305 -> V_316 = 0 ;
V_117 = F_192 ( V_26 , V_303 , V_272 , F_193 ( V_307 ) , V_305 , V_279 ) ;
if ( V_117 ) {
F_79 ( L_28 V_313 L_29 , F_189 ( V_189 ) , V_117 ) ;
GOTO ( V_314 , V_117 ) ;
}
F_119 ( V_315 , L_30 V_313 L_31 ,
F_189 ( F_191 ( & V_303 -> V_294 ) ) , V_272 -> V_275 , V_303 , V_117 ) ;
V_314:
F_194 ( V_26 , V_306 ) ;
return V_117 ;
}
...
if ( V_319 == NULL )
return - 1 ;
V_303 = F_190 ( V_319 -> V_83 , V_163 -> V_168 ) ;
if ( V_303 == NULL )
return - V_327 ;
...
V_279 -> V_342 . V_347 = F_197 () ;
if ( V_177 != NULL ) {
V_272 -> V_275 = V_177 ;
V_272 -> V_276 = V_320 ;
V_117 = F_186 ( V_26 , V_72 , F_193 ( V_303 ) , V_189 , V_272 ,
V_305 , V_279 ) ;
return V_117 ;
}
for ( V_247 = 0 ; V_247 < V_321 ; V_247 ++ ) {
char * V_348 = V_27 -> V_349 ;
F_174 ( V_272 , V_348 , V_273 ) ;
V_117 = F_186 ( V_26 , V_72 , F_193 ( V_303 ) , V_189 , V_272 ,
V_305 , V_279 ) ;
if ( V_117 ) {
F_79 ( L_32 , V_348 ,
...
F_189 ( V_189 ) , V_303 ) ;
V_117 = F_187 ( V_26 , V_303 , V_272 , V_189 , NULL ) ;
if ( V_117 ) {
F_79 ( L_35 , V_272 -> V_275 , V_117 ) ;
return F_84 ( V_117 ) ;
}
V_307 = F_188 ( V_26 , & V_72 -> V_4 . V_151 , V_189 , NULL ) ;
return V_307 ;
}
...
for ( V_247 = 0 ; V_247 < V_321 ; V_247 ++ ) {
struct V_70 * V_306 , * V_307 ;
F_174 ( V_272 , V_177 , V_273 ) ;
V_306 = F_198 ( V_26 , V_72 , F_193 ( V_303 ) , V_272 ) ;
if ( F_131 ( V_306 ) ) {
F_79 ( L_36 ,
V_272 -> V_275 , F_137 ( V_306 ) ) ;
return F_137 ( V_306 ) ;
}
V_307 = F_190 ( V_306 -> V_83 , V_163 -> V_168 ) ;
if ( V_307 == NULL ) {
...
V_117 = F_200 ( V_26 , F_193 ( V_307 ) , V_293 , V_177 ,
V_353 ) ;
if ( V_117 < 0 ) {
F_79 ( L_40 V_313 L_29 ,
F_189 ( F_191 ( V_307 ) ) , V_117 ) ;
F_194 ( V_26 , V_306 ) ;
break;
}
...
F_189 ( F_191 ( V_307 ) ) ) ;
V_117 = F_180 ( V_26 , F_193 ( V_307 ) , V_279 ) ;
if ( V_117 ) {
...
F_189 ( F_191 ( V_303 ) ) , V_272 -> V_275 , V_303 ) ;
V_117 = F_187 ( V_26 , F_193 ( V_303 ) , V_272 , V_189 , NULL ) ;
if ( V_117 ) {
...
struct V_70 * V_307 ;
int V_117 ;
V_306 = F_198 ( V_26 , V_72 , V_303 , V_272 ) ;
if ( F_131 ( V_306 ) ) {
...
F_189 ( F_191 ( & V_303 -> V_294 ) ) , V_272 -> V_275 , V_303 ) ;
V_117 = F_204 ( V_26 , V_303 , F_193 ( V_307 ) , V_272 , V_279 , 0 ) ;
if ( V_117 ) {
F_79 ( L_49 ,
V_272 -> V_275 , V_117 ) ;
GOTO ( V_314 , V_117 ) ;
...
V_272 -> V_275 = V_177 ;
V_272 -> V_276 = V_320 ;
V_117 = F_203 ( V_26 , V_72 , F_193 ( V_303 ) , V_272 ,
V_279 ) ;
return V_117 ;
}
for ( V_247 = 0 ; V_247 < V_321 ; V_247 ++ ) {
...
{
struct V_79 * V_163 = V_72 -> V_77 ;
struct V_358 * V_199 = F_207 ( V_163 ) ;
struct V_24 * V_27 = F_12 ( V_26 ) ;
struct V_188 * V_189 = & V_27 -> V_202 ;
struct V_271 * V_272 = & V_27 -> V_324 ;
...
V_303 = F_188 ( V_26 , & V_72 -> V_4 . V_151 , V_189 , NULL ) ;
if ( F_131 ( V_303 ) ) {
F_79 ( L_52 V_313 L_24 ,
F_189 ( V_189 ) , F_137 ( V_303 ) ) ;
return V_303 ;
}
while ( 1 ) {
struct V_70 * V_361 ;
char * V_362 ;
V_362 = F_208 ( & V_356 , L_53 ) ;
if ( V_362 == NULL )
break;
if ( V_362 [ 0 ] == 0 ) {
if ( ! V_356 || V_356 [ 0 ] == '\0' )
...
V_361 = F_190 ( V_303 -> V_83 , V_163 -> V_168 ) ;
if ( V_361 == NULL ) {
F_194 ( V_26 , V_303 ) ;
V_117 = - V_165 ;
break;
}
V_307 = F_198 ( V_26 , V_72 , F_193 ( V_361 ) , V_272 ) ;
F_194 ( V_26 , V_303 ) ;
if ( F_131 ( V_307 ) ) {
V_117 = ( int ) F_137 ( V_307 ) ;
F_79 ( L_54 V_313 L_29 ,
V_272 -> V_275 , F_189 ( F_191 ( V_361 ) ) ,
V_117 ) ;
break;
}
V_303 = V_307 ;
...
static int F_218 ( struct V_1 * V_72 , int V_381 ,
...
if ( F_131 ( V_26 ) )
return F_137 ( V_26 ) ;
V_117 = F_219 ( V_26 , V_384 , V_385 ) ;
if ( V_117 != 0 )
GOTO ( V_386 , V_117 ) ;
V_27 = F_12 ( V_26 ) ;
F_14 ( V_27 -> V_285 == NULL ) ;
F_179 ( V_27 -> V_285 , V_387 ) ;
if ( V_27 -> V_285 == NULL )
GOTO ( V_386 , V_117 = - V_68 ) ;
V_27 -> V_283 = V_387 ;
V_303 = F_206 ( V_26 , V_72 , V_356 , V_357 ) ;
if ( F_131 ( V_303 ) ) {
F_79 ( L_57 , V_356 ,
F_137 ( V_303 ) ) ;
GOTO ( V_388 , V_117 = F_137 ( V_303 ) ) ;
}
if ( V_320 > 0 ) {
F_61 ( V_177 , V_320 + 1 ) ;
if ( V_177 == NULL )
GOTO ( V_314 , V_117 = - V_68 ) ;
if ( F_173 ( V_177 , V_125 -> V_389 , V_320 ) )
...
V_117 = F_132 ( V_189 , & V_125 -> V_398 . V_399 , 0 ) ;
if ( V_117 != 0 )
break;
V_117 = F_196 ( V_26 , V_72 , V_303 , V_189 , V_177 , V_320 ,
...
case V_401 : {
T_4 V_208 = V_125 -> V_393 . V_394 ;
V_117 = F_205 ( V_26 , V_72 , V_303 , V_177 , V_320 ,
V_273 , V_208 , V_321 ) ;
break;
}
case V_402 :
V_117 = F_202 ( V_26 , V_72 , V_303 , V_273 , V_321 ) ;
break;
case V_403 :
V_117 = F_201 ( V_26 , V_72 , V_303 , V_273 , V_321 ) ;
break;
case V_404 :
V_117 = F_199 ( V_26 , V_72 , V_303 , V_273 , V_321 ) ;
break;
default:
F_79 ( L_58 , V_381 ) ;
V_117 = - V_165 ;
...
if ( V_263 != NULL ) {
int V_247 , V_414 ;
V_117 = F_172 ( V_72 , V_187 , V_263 , V_262 ) ;
if ( V_117 != 0 )
GOTO ( V_413 , V_117 ) ;
if ( V_187 -> V_265 == 0 )
...
V_414 = F_221 () ;
for ( V_247 = 0 ; V_247 < V_187 -> V_265 ; V_247 ++ ) {
if ( F_127 ( & V_187 -> V_97 [ V_247 ] -> V_196 ) == 0 )
...
F_222 ( & V_187 -> V_101 , ++ V_417 ) ;
V_117 = 0 ;
if ( V_405 ) {
F_14 ( ( V_407 -> V_411 & V_416 ) &&
( F_129 ( & V_407 -> V_399 ) == V_192 ) ) ;
V_117 = F_223 ( V_26 , V_75 -> V_96 , V_407 , & V_187 , V_409 ) ;
if ( V_117 != 0 ) {
F_79 ( L_61 , V_117 ) ;
GOTO ( V_413 , V_117 ) ;
}
...
if ( F_131 ( V_11 ) )
GOTO ( V_413 , V_117 = F_137 ( V_11 ) ) ;
F_136 ( V_11 ) ;
F_119 ( V_181 , L_62 V_191 L_16 , F_128 ( & V_407 -> V_399 ) ) ;
V_413:
if ( V_410 && V_117 )
F_224 ( V_26 , V_75 -> V_96 , V_407 , V_187 , V_409 , NULL , NULL ) ;
if ( V_187 )
F_65 ( V_72 , & V_187 ) ;
if ( V_117 )
F_79 ( L_63 , V_117 ) ;
...
static int F_225 ( struct V_10 * * V_418 , struct V_1 * V_72 ,
struct V_406 * V_407 )
{
struct V_93 * V_187 = NULL ;
struct V_10 * V_11 ;
int V_117 ;
if ( ( V_407 -> V_411 & V_412 ) == 0 || F_127 ( & V_407 -> V_399 ) == 0 ) {
F_79 ( L_59 ) ;
return - V_165 ;
}
V_117 = F_58 ( V_72 , & V_187 ) ;
...
static void
F_227 ( struct V_93 * V_187 , T_2 * V_419 , T_6 * V_420 )
{
unsigned long V_322 ;
unsigned long V_421 ;
unsigned long V_422 ;
...
V_322 = V_187 -> V_265 ;
V_422 = V_421 * V_322 ;
V_423 = F_228 ( V_240 , V_422 ) ;
V_396 = V_423 / V_421 ;
* V_420 = F_127 ( & V_187 -> V_97 [ V_396 ] -> V_196 ) ;
...
static int F_235 ( struct V_1 * V_72 , int V_239 , struct V_406 * V_407 ,
...
T_9 V_435 ;
int V_436 = 0 ;
V_434 = ( F_127 ( & V_407 -> V_399 ) != V_437 &&
( V_407 -> V_411 & V_438 ) != 0 &&
( V_407 -> V_439 & V_440 ) != 0 ) ;
V_435 = ( ( F_127 ( & V_407 -> V_399 ) & 2 ) == 0 ) ? V_441 : V_442 ;
F_14 ( V_239 == V_429 || V_239 == V_443 ) ;
F_14 ( V_187 != NULL ) ;
F_14 ( F_127 ( & V_187 -> V_101 ) == F_127 ( & V_407 -> V_399 ) ) ;
if ( V_321 <= 0 ||
( V_321 & ( ~ V_248 ) ) != 0 )
return - V_165 ;
V_242 = V_321 >> V_444 ;
...
V_432 -> V_447 = V_436 ;
if ( V_434 )
F_229 ( V_187 , V_432 -> V_446 , V_239 ,
F_127 ( & V_407 -> V_399 ) , V_433 ,
V_432 -> V_321 ) ;
}
F_14 ( V_72 -> V_77 != NULL ) ;
V_117 = F_157 ( V_11 , V_239 , V_240 , V_241 , V_242 , V_243 ) ;
V_150:
...
( V_187 != NULL && F_127 ( & V_187 -> V_101 ) != F_127 ( & V_407 -> V_399 ) ) )
return - V_165 ;
V_242 = V_450 >> V_444 ;
V_457 = V_321 >> V_444 ;
...
V_409 -> V_463 = 0 ;
V_459 = V_242 ;
V_458 = F_240 ( V_26 , V_239 , exp , V_407 , 1 , & V_452 , V_456 , & V_459 ,
V_454 , V_409 , NULL ) ;
if ( V_458 != 0 )
GOTO ( V_150 , V_458 ) ;
F_14 ( V_459 == V_242 ) ;
...
if ( F_127 ( & V_407 -> V_399 ) == V_437 ||
( V_407 -> V_411 & V_438 ) == 0 ||
( V_407 -> V_439 & V_440 ) == 0 )
continue;
if ( V_239 == V_429 )
F_229 ( V_187 , V_34 , V_239 ,
F_127 ( & V_407 -> V_399 ) ,
V_456 [ V_247 ] . V_240 ,
V_456 [ V_247 ] . V_460 ) ;
else
...
V_458 = F_241 ( V_26 , V_239 , exp , V_407 , 1 , & V_452 ,
...
static int F_244 ( const struct V_25 * V_26 , int V_239 ,
struct V_449 * exp ,
struct V_382 * V_125 ,
struct V_408 * V_464 )
{
...
case 1 :
case 2 :
V_117 = F_235 ( V_72 , V_239 , V_407 ,
V_11 , V_125 -> V_471 ,
V_125 -> V_469 , V_243 , V_464 ) ;
break;
case 3 :
V_117 = F_238 ( V_26 , V_75 -> V_96 , V_239 , V_407 ,
V_11 , V_125 -> V_471 ,
...
V_117 = F_146 ( V_11 , V_240 , V_207 , V_208 , & V_473 -> V_52 ) ;
if ( V_117 == 0 ) {
V_407 -> V_411 |= V_466 ;
...
static int
F_247 ( struct V_449 * exp , struct V_406 * V_407 )
{
struct V_1 * V_72 = F_4 ( exp -> V_472 ) ;
...
static int
F_248 ( unsigned int V_476 , struct V_449 * exp , int V_460 ,
...
V_117 = F_132 ( & V_189 , & V_407 -> V_399 , 0 ) ;
if ( V_117 < 0 )
return V_117 ;
F_91 ( V_26 ) ;
if ( V_26 == NULL )
return - V_68 ;
V_117 = F_249 ( V_26 , V_481 ) ;
if ( V_117 )
GOTO ( V_150 , V_117 = - V_68 ) ;
switch ( V_476 ) {
case V_482 :
...
V_117 = F_220 ( V_26 , V_72 , 1 , V_407 , V_125 -> V_467 ,
V_125 -> V_468 , & V_464 ) ;
GOTO ( V_150 , V_117 ) ;
case V_485 : {
int V_321 ;
...
V_321 = V_125 -> V_469 ;
V_476 = V_125 -> V_488 ;
V_273 = F_127 ( & V_125 -> V_393 . V_399 ) ;
V_487 = V_125 -> V_468 ;
F_61 ( V_486 , V_487 + 1 ) ;
if ( V_486 == NULL )
GOTO ( V_150 , V_117 = - V_68 ) ;
if ( F_173 ( V_486 , V_125 -> V_467 , V_487 ) ) {
F_62 ( V_486 , V_125 -> V_468 + 1 ) ;
GOTO ( V_150 , V_117 = - V_266 ) ;
}
V_117 = F_218 ( V_72 , V_476 , V_486 , V_487 , V_273 , V_321 , V_125 ) ;
F_62 ( V_486 , V_487 + 1 ) ;
GOTO ( V_150 , V_117 ) ;
}
case V_489 : {
...
V_490 = F_130 ( & V_190 ) ;
if ( F_131 ( V_490 ) )
GOTO ( V_150 , V_117 = F_137 ( V_490 ) ) ;
V_117 = F_219 ( V_490 , V_384 ,
V_385 ) ;
if ( V_117 != 0 ) {
F_135 ( V_490 , & V_190 ) ;
GOTO ( V_150 , V_117 ) ;
}
V_117 = F_251 ( V_490 , V_72 -> V_133 , & V_491 ) ;
F_135 ( V_490 , & V_190 ) ;
if ( V_117 < 0 ) {
F_79 ( L_68 ,
V_7 -> V_129 , V_117 ) ;
...
if ( F_171 ( V_125 -> V_467 , & V_491 , V_125 -> V_468 ) )
return - V_266 ;
V_492 = V_493 ;
if ( F_171 ( V_125 -> V_389 , & V_492 ,
V_125 -> V_383 ) )
return - V_266 ;
GOTO ( V_150 , V_117 ) ;
}
...
V_117 = F_225 ( & V_11 , V_72 , V_407 ) ;
if ( V_117 == 0 ) {
V_117 = F_224 ( V_26 , V_75 -> V_96 , V_407 , V_11 -> V_88 ,
& V_464 , NULL , NULL ) ;
if ( V_117 == 0 )
V_11 -> V_182 = 1 ;
F_226 ( V_11 ) ;
...
V_239 = V_429 ;
case V_501 :
V_117 = F_244 ( V_26 , V_239 , exp , V_125 , & V_464 ) ;
GOTO ( V_150 , V_117 ) ;
case V_502 :
V_117 = F_225 ( & V_11 , V_72 , V_407 ) ;
if ( V_117 == 0 ) {
V_117 = F_169 ( V_11 -> V_88 , V_125 -> V_467 ,
V_125 -> V_468 ) ;
F_226 ( V_11 ) ;
}
GOTO ( V_150 , V_117 ) ;
...
int V_117 ;
if ( V_509 -> V_514 < 2 || F_256 ( V_509 , 1 ) < 1 ) {
F_79 ( L_71 ) ;
return - V_165 ;
}
...
V_513 -> V_528 = V_529 ;
V_513 -> V_530 = V_192 ;
V_117 = F_260 ( V_26 , & V_75 -> V_96 , V_147 , & V_511 , V_513 , NULL ) ;
if ( V_117 == 0 ) {
F_55 ( & V_147 -> V_531 ) ;
...
V_117 = F_265 ( & V_538 , V_535 , V_536 ) ;
if ( V_117 == 0 ) {
* exp = F_266 ( & V_538 ) ;
}
return V_117 ;
}
static int F_267 ( struct V_449 * exp )
{
#if 0
