...
( V_91 -> V_103 == V_152 ) ? L_39 :
( V_91 -> V_103 == V_153 ) ? L_40
: L_41 ) ;
if ( V_91 -> V_103 == V_153 )
F_81 ( V_91 ) ;
...
unsigned char * F_83 ( struct V_90 * V_91 )
{
switch ( V_91 -> V_154 ) {
case V_155 :
return L_42 ;
...
int * V_160 )
{
* V_160 += sprintf ( V_159 + * V_160 , L_46 ) ;
if ( V_93 -> V_161 )
* V_160 += sprintf ( V_159 + * V_160 , L_47 ) ;
else
* V_160 += sprintf ( V_159 + * V_160 , L_48 ) ;
* V_160 += sprintf ( V_159 + * V_160 , L_49 , V_93 -> V_162 ) ;
...
int V_171 ;
memset ( V_60 , 0 , V_170 ) ;
V_171 = sprintf ( V_60 , L_52 ) ;
switch ( V_167 -> V_172 ) {
case 0x00 :
sprintf ( V_60 + V_171 , L_53 ) ;
break;
case 0x10 :
sprintf ( V_60 + V_171 , L_54 ) ;
break;
case 0x20 :
...
void
F_86 ( struct V_166 * V_167 , unsigned char * V_173 )
{
if ( V_173 [ 1 ] & 0x80 ) {
...
int V_171 ;
memset ( V_60 , 0 , V_170 ) ;
V_171 = sprintf ( V_60 , L_65 ) ;
switch ( V_167 -> V_175 ) {
case 0x00 :
sprintf ( V_60 + V_171 , L_66 ) ;
break;
case 0x10 :
sprintf ( V_60 + V_171 , L_67 ) ;
break;
case 0x20 :
sprintf ( V_60 + V_171 , L_68 ) ;
break;
default:
sprintf ( V_60 + V_171 , L_63 , V_167 -> V_175 ) ;
V_36 = - V_176 ;
break;
}
if ( V_168 )
...
int F_88 ( struct V_166 * V_167 , unsigned char * V_173 )
{
V_167 -> V_175 = ( V_173 [ 1 ] & 0x30 ) ;
return F_87 ( V_167 , NULL , 0 ) ;
}
int F_89 (
struct V_166 * V_167 ,
unsigned char * V_168 ,
...
int V_171 ;
memset ( V_60 , 0 , V_170 ) ;
V_171 = sprintf ( V_60 , L_69 ) ;
switch ( V_167 -> V_177 ) {
case 0x00 :
sprintf ( V_60 + V_171 , L_70 ) ;
break;
case 0x01 :
sprintf ( V_60 + V_171 , L_71 ) ;
break;
case 0x02 :
...
int F_90 ( struct V_166 * V_167 , unsigned char * V_173 )
{
V_167 -> V_177 = ( V_173 [ 1 ] & 0x0f ) ;
return F_89 ( V_167 , NULL , 0 ) ;
}
int F_91 (
struct V_166 * V_167 ,
unsigned char * V_168 ,
...
int
F_92 ( struct V_166 * V_167 , unsigned char * V_173 )
{
static const char V_180 [] = L_82 ;
int V_181 = 0 , V_182 = 4 ;
...
return F_91 ( V_167 , NULL , 0 ) ;
}
T_4
F_93 ( struct V_90 * V_91 , unsigned int V_183 )
{
struct V_92 * V_93 = V_91 -> V_94 ;
if ( V_91 -> V_184 ) {
V_91 -> V_143 = V_183 ;
...
T_4
F_99 ( struct V_90 * V_91 , unsigned char * V_201 )
{
struct V_92 * V_93 = V_91 -> V_94 ;
T_4 V_36 ;
if ( F_100 ( V_201 ) > V_202 ) {
F_4 ( L_94
L_95 ,
F_100 ( V_201 ) , V_202 ) ;
return V_186 ;
}
if ( F_100 ( V_201 ) > sizeof( V_91 -> V_203 ) ) {
V_91 -> V_185 = F_22 ( F_100 ( V_201 ) ,
V_41 ) ;
if ( ! V_91 -> V_185 ) {
F_4 ( L_96
L_97 ,
...
memcpy ( V_91 -> V_185 , V_201 , F_100 ( V_201 ) ) ;
F_101 ( V_91 ) ;
V_36 = F_102 ( V_91 ) ;
if ( V_36 )
return V_36 ;
...
T_4
F_109 ( struct V_90 * V_91 , struct V_213 * V_214 ,
...
int F_110 ( struct V_90 * V_90 , struct V_2 * V_40 ,
...
F_10 ( F_107 () ) ;
F_95 ( V_90 , V_56 -> V_62 , V_40 ,
V_143 , V_224 , V_189 , V_222 ) ;
if ( V_71 & V_227 )
V_90 -> V_184 = 1 ;
V_36 = F_111 ( V_40 , V_90 , ( V_71 & V_228 ) ) ;
if ( V_36 )
return V_36 ;
if ( V_71 & V_229 )
V_90 -> V_115 |= V_230 ;
V_50 = F_112 ( V_90 , V_223 ) ;
if ( V_50 ) {
F_113 ( V_90 , V_50 , 0 ) ;
F_114 ( V_40 , V_90 ) ;
return 0 ;
}
V_50 = F_99 ( V_90 , V_201 ) ;
if ( V_50 != 0 ) {
F_67 ( V_90 , V_50 ) ;
return 0 ;
}
...
if ( V_214 )
V_60 = F_115 ( F_116 ( V_214 ) ) + V_214 -> V_234 ;
if ( V_60 ) {
memset ( V_60 , 0 , V_214 -> V_141 ) ;
F_117 ( F_116 ( V_214 ) ) ;
}
}
V_50 = F_109 ( V_90 , V_214 , V_215 ,
V_216 , V_217 ) ;
if ( V_50 != 0 ) {
F_67 ( V_90 , V_50 ) ;
return 0 ;
...
int F_119 ( struct V_90 * V_90 , struct V_2 * V_40 ,
unsigned char * V_201 , unsigned char * V_222 , T_1 V_223 ,
T_1 V_143 , int V_189 , int V_224 , int V_71 )
{
return F_110 ( V_90 , V_40 , V_201 , V_222 ,
V_223 , V_143 , V_189 , V_224 ,
V_71 , NULL , 0 , NULL , 0 , NULL , 0 ) ;
}
static void F_120 ( struct V_118 * V_119 )
{
...
int F_121 ( struct V_90 * V_90 , struct V_2 * V_40 ,
...
F_95 ( V_90 , V_56 -> V_62 , V_40 ,
0 , V_155 , V_243 , V_222 ) ;
V_36 = F_122 ( V_90 , V_239 , V_240 , V_241 ) ;
if ( V_36 < 0 )
return - V_31 ;
if ( V_240 == V_244 )
...
V_36 = F_124 ( V_90 , V_223 ) ;
if ( V_36 ) {
F_71 ( & V_90 -> V_119 , F_120 ) ;
F_125 ( & V_90 -> V_119 ) ;
return 0 ;
}
F_126 ( V_90 ) ;
...
bool F_127 ( struct V_90 * V_91 , unsigned long * V_71 )
{
bool V_246 = false ;
if ( V_91 -> V_95 & V_96 ) {
V_91 -> V_95 |= V_135 ;
...
V_271:
V_91 -> V_103 = V_152 ;
F_132 ( V_91 , V_91 -> V_94 ) ;
}
void F_133 ( struct V_90 * V_91 )
{
T_4 V_36 ;
if ( V_91 -> V_273 ) {
...
static bool F_134 ( struct V_90 * V_91 )
{
struct V_92 * V_93 = V_91 -> V_94 ;
if ( V_93 -> V_126 -> V_196 == V_197 )
return false ;
...
static void F_129 ( struct V_90 * V_91 )
{
struct V_92 * V_93 = V_91 -> V_94 ;
if ( V_93 -> V_126 -> V_196 == V_197 )
return;
...
F_125 ( & V_91 -> V_94 -> V_146 ) ;
}
static bool F_142 ( struct V_90 * V_91 )
{
T_4 V_50 ;
...
V_271:
F_37 ( L_122
L_123 , V_91 , V_91 -> V_154 ) ;
V_91 -> V_103 = V_152 ;
F_132 ( V_91 , V_91 -> V_94 ) ;
}
static inline void F_144 ( struct V_213 * V_214 , int V_291 )
{
struct V_213 * V_292 ;
int V_293 ;
F_145 (sgl, sg, nents, count)
F_146 ( F_116 ( V_292 ) ) ;
F_27 ( V_214 ) ;
}
...
static inline void F_148 ( struct V_90 * V_91 )
{
if ( V_91 -> V_115 & V_221 ) {
F_147 ( V_91 ) ;
return;
...
F_147 ( V_91 ) ;
F_144 ( V_91 -> V_133 , V_91 -> V_218 ) ;
V_91 -> V_133 = NULL ;
V_91 -> V_218 = 0 ;
F_144 ( V_91 -> V_219 , V_91 -> V_220 ) ;
V_91 -> V_219 = NULL ;
V_91 -> V_220 = 0 ;
F_144 ( V_91 -> V_231 , V_91 -> V_232 ) ;
V_91 -> V_231 = NULL ;
V_91 -> V_232 = 0 ;
}
...
F_10 ( ! V_292 ) ;
if ( V_91 -> V_218 == 1 )
return F_115 ( F_116 ( V_292 ) ) + V_292 -> V_234 ;
V_298 = F_151 ( sizeof( * V_298 ) * V_91 -> V_218 , V_41 ) ;
if ( ! V_298 )
return NULL ;
F_145 (cmd->t_data_sg, sg, cmd->t_data_nents, i) {
V_298 [ V_182 ] = F_116 ( V_292 ) ;
}
V_91 -> V_299 = F_152 ( V_298 , V_91 -> V_218 , V_300 , V_301 ) ;
F_27 ( V_298 ) ;
if ( ! V_91 -> V_299 )
return NULL ;
return V_91 -> V_299 + V_91 -> V_133 [ 0 ] . V_234 ;
}
void F_153 ( struct V_90 * V_91 )
{
if ( ! V_91 -> V_218 ) {
return;
} else if ( V_91 -> V_218 == 1 ) {
F_117 ( F_116 ( V_91 -> V_133 ) ) ;
return;
}
F_154 ( V_91 -> V_299 ) ;
V_91 -> V_299 = NULL ;
...
int
F_155 ( struct V_213 * * V_214 , unsigned int * V_291 , T_1 V_141 ,
bool V_302 )
{
struct V_213 * V_292 ;
struct V_297 * V_297 ;
...
unsigned int V_305 ;
int V_182 = 0 ;
V_305 = F_156 ( V_141 , V_306 ) ;
V_292 = F_151 ( sizeof( struct V_213 ) * V_305 , V_41 ) ;
if ( ! V_292 )
return - V_31 ;
F_157 ( V_292 , V_305 ) ;
while ( V_141 ) {
T_1 V_307 = F_158 ( T_1 , V_141 , V_306 ) ;
V_297 = F_159 ( V_41 | V_303 ) ;
if ( ! V_297 )
goto V_3;
F_160 ( & V_292 [ V_182 ] , V_297 , V_307 , 0 ) ;
V_141 -= V_307 ;
V_182 ++ ;
}
* V_214 = V_292 ;
...
while ( V_182 > 0 ) {
V_182 -- ;
F_146 ( F_116 ( & V_292 [ V_182 ] ) ) ;
}
F_27 ( V_292 ) ;
return - V_31 ;
}
T_4
F_108 ( struct V_90 * V_91 )
{
int V_36 = 0 ;
if ( ! ( V_91 -> V_115 & V_221 ) &&
V_91 -> V_143 ) {
...
if ( V_91 -> V_281 != V_310 ) {
V_36 = F_155 ( & V_91 -> V_231 ,
& V_91 -> V_232 ,
V_91 -> V_311 , true ) ;
if ( V_36 < 0 )
return V_120 ;
}
V_36 = F_155 ( & V_91 -> V_133 , & V_91 -> V_218 ,
V_91 -> V_143 , V_303 ) ;
if ( V_36 < 0 )
return V_120 ;
}
...
int F_161 ( struct V_90 * V_91 , int V_312 )
{
unsigned long V_71 ;
int V_36 = 0 ;
if ( ! ( V_91 -> V_115 & V_116 ) ) {
...
int F_111 ( struct V_2 * V_40 , struct V_90 * V_90 ,
bool V_313 )
{
unsigned long V_71 ;
int V_36 = 0 ;
...
static void F_163 ( struct V_73 * V_73 )
{
...
int F_114 ( struct V_2 * V_40 , struct V_90 * V_90 )
{
if ( ! V_40 ) {
V_90 -> V_82 -> V_317 ( V_90 ) ;
return 1 ;
}
return F_164 ( & V_90 -> V_193 , F_163 ,
& V_40 -> V_46 ) ;
}
void F_165 ( struct V_2 * V_40 )
{
struct V_90 * V_90 ;
unsigned long V_71 ;
F_39 ( & V_40 -> V_46 , V_71 ) ;
...
F_166 (se_cmd, &se_sess->sess_wait_list, se_cmd_list)
V_90 -> V_318 = 1 ;
F_40 ( & V_40 -> V_46 , V_71 ) ;
}
void F_167 ( struct V_2 * V_40 )
{
...
int F_170 ( struct V_105 * V_112 )
{
struct V_323 * V_324 ;
V_324 = F_171 ( F_168 , V_112 ,
L_129 , V_112 -> V_223 ) ;
if ( F_29 ( V_324 ) ) {
F_4 ( L_130 ) ;
return F_172 ( V_324 ) ;
...
static
void F_174 ( unsigned char * V_329 , T_6 V_330 )
{
V_329 [ V_331 ] = 0xc ;
V_329 [ V_332 ] = 0 ;
V_329 [ V_333 ] = 0xa ;
V_329 [ V_334 ] = 0x80 ;
F_175 ( V_330 , & V_329 [ 12 ] ) ;
}
int
...
int F_138 ( struct V_90 * V_91 , int V_356 )
{
if ( ! ( V_91 -> V_95 & V_137 ) )
return 0 ;
...
static void F_178 ( struct V_118 * V_119 )
{
struct V_90 * V_91 = F_42 ( V_119 , struct V_90 , V_119 ) ;
struct V_92 * V_93 = V_91 -> V_94 ;
...
break;
case V_366 :
V_36 = F_180 ( V_93 , V_360 , NULL , NULL ) ;
