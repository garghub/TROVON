...
if ( V_127 ) {
int V_130 = F_4 ( & V_3 [ V_125 + 2 ] ) ;
int V_131 = F_4 ( & V_3 [ V_125 + 4 ] ) ;
int V_132 = F_4 ( & V_3 [ V_125 + 6 ] ) ;
int V_133 = F_4 ( & V_3 [ V_125 + 8 ] ) ;
int V_134 = F_4 ( & V_3 [ V_125 + 10 ] ) ;
int V_135 = F_4 ( & V_3 [ V_125 + 12 ] ) ;
F_3 ( V_5 , V_136 , V_130 ) ;
F_3 ( V_5 , V_137 , V_132 ) ;
...
int V_123 = 0 ;
int V_142 = 0 ;
if ( V_2 -> V_22 . type == V_143 || V_2 -> V_22 . type == V_144 )
V_142 = - 4 ;
if ( V_122 )
V_2 -> V_124 = V_122 ;
V_123 = F_23 ( 5 , V_2 -> V_124 ) ;
for ( V_102 = 0 ; V_102 < V_123 ; V_102 ++ ) {
int V_125 = ( V_145 + V_142 ) * V_102 + 3 ;
bool V_127 = V_3 [ V_125 ] & 0x1 ;
int V_9 = F_4 ( & V_3 [ V_125 + 1 ] ) ;
...
F_26 ( V_5 , V_129 , V_127 ) ;
if ( V_127 ) {
int V_120 = F_4 ( & V_3 [ V_125 + V_142 + 7 ] ) ;
int V_121 = F_4 ( & V_3 [ V_125 + V_142 + 9 ] ) ;
F_3 ( V_5 , V_136 , V_120 ) ;
F_3 ( V_5 , V_137 , V_121 ) ;
}
}
...
int V_147 = V_3 [ 1 ] & ( 1 << V_102 ) ;
bool V_127 = V_147 && ! V_2 -> V_56 -> V_57 ;
F_25 ( V_5 , V_102 ) ;
F_26 ( V_5 , V_129 , V_127 ) ;
if ( V_127 ) {
...
F_27 ( V_5 , true ) ;
V_2 -> V_56 -> V_148 = ( V_146 > 0 ) ;
return 1 ;
}
static int F_30 ( struct V_1 * V_2 , T_1 V_149 )
{
unsigned char * V_3 = V_2 -> V_3 ;
struct V_4 * V_5 = V_2 -> V_5 ;
bool V_23 ;
int V_120 = 0 , V_121 = 0 ;
if ( V_2 -> V_22 . V_150 > 1 || V_149 > V_151 )
return 0 ;
if ( ! V_2 -> V_56 -> V_57 ) {
if ( V_149 == V_152 ) {
V_23 = V_3 [ 0 ] & 0x01 ;
...
F_3 ( V_5 , V_13 , F_9 ( ( V_28 * ) & V_3 [ 2 ] ) ) ;
F_3 ( V_5 , V_14 , F_9 ( ( V_28 * ) & V_3 [ 4 ] ) ) ;
F_3 ( V_5 , V_15 , ( ( V_3 [ 7 ] & 0x03 ) << 8 ) | V_3 [ 6 ] ) ;
F_2 ( V_5 , V_16 , V_3 [ 1 ] & 0x05 ) ;
F_2 ( V_5 , V_2 -> V_6 [ 0 ] , V_23 ) ;
return 1 ;
}
...
static int F_32 ( struct V_1 * V_2 , T_1 V_149 )
{
unsigned char * V_3 = V_2 -> V_3 ;
...
int V_164 = V_3 [ 5 ] ;
int V_165 = F_35 ( V_5 , V_136 ) ;
int V_166 = F_35 ( V_5 , V_137 ) ;
V_162 = 2 * F_21 ( V_164 * V_167 ) ;
V_163 = V_162 * V_166 / V_165 ;
}
F_3 ( V_5 , V_136 , V_120 ) ;
F_3 ( V_5 , V_137 , V_121 ) ;
F_3 ( V_5 , V_138 , V_162 ) ;
...
struct V_4 * V_5 = V_2 -> V_5 ;
unsigned char * V_3 = V_2 -> V_3 ;
int V_23 = 0 , V_120 = 0 , V_121 = 0 , V_147 = 0 , V_172 = 0 , V_173 = 0 , V_174 = 0 , V_175 = 0 ;
if ( V_3 [ 0 ] != V_25 && V_3 [ 0 ] != V_176 )
return 0 ;
if ( V_3 [ 0 ] == V_176 ) {
if ( V_22 -> type == V_169 && V_22 -> V_150 ) {
F_39 ( V_2 -> V_56 -> V_177 ,
V_178 , V_3 [ 8 ] & 0x40 ) ;
F_7 ( V_2 -> V_56 -> V_177 ) ;
}
...
V_120 = F_9 ( ( V_28 * ) & V_3 [ 2 ] ) ;
V_121 = F_9 ( ( V_28 * ) & V_3 [ 4 ] ) ;
V_147 = F_9 ( ( V_28 * ) & V_3 [ 6 ] ) ;
if ( V_3 [ 8 ] <= V_22 -> V_64 )
V_172 = V_22 -> V_64 - V_3 [ 8 ] ;
V_173 = V_3 [ 1 ] & 0x01 ;
V_174 = V_3 [ 1 ] & 0x02 ;
V_175 = V_3 [ 1 ] & 0x04 ;
}
...
static int F_40 ( struct V_1 * V_2 , T_1 V_149 )
{
if ( V_149 == V_179 )
return F_33 ( V_2 ) ;
else if ( V_149 == V_180 )
return F_37 ( V_2 ) ;
else if ( V_149 == V_181 || V_149 == V_182 )
return F_38 ( V_2 ) ;
return 0 ;
}
static int F_41 ( struct V_1 * V_2 , T_1 V_149 )
{
unsigned char * V_3 = V_2 -> V_3 ;
int V_183 ;
if ( V_149 != V_184 || V_3 [ 0 ] != V_185 )
return 0 ;
V_183 = V_3 [ 1 ] & 0x01 ;
if ( V_183 ) {
int V_186 , V_187 ;
if ( ( V_2 -> V_56 -> type == V_169 ) &&
V_2 -> V_56 -> V_150 ) {
F_39 ( V_2 -> V_56 -> V_177 ,
V_178 , V_3 [ 5 ] & 0x40 ) ;
F_7 ( V_2 -> V_56 -> V_177 ) ;
...
void F_43 ( struct V_1 * V_1 , T_1 V_149 )
{
bool V_189 ;
...
case V_143 :
case V_144 :
V_189 = F_32 ( V_1 , V_149 ) ;
break;
case V_202 :
case V_169 :
V_189 = F_40 ( V_1 , V_149 ) ;
break;
case V_203 :
V_189 = F_41 ( V_1 , V_149 ) ;
break;
default:
V_189 = false ;
break;
...
{
if ( V_22 -> V_206 == V_207 && ! V_22 -> V_208 ) {
V_22 -> V_208 = 1023 ;
V_22 -> V_209 = 1023 ;
}
if ( V_22 -> type >= V_203 ||
( V_22 -> type >= V_100 && V_22 -> type <= V_169 ) ||
( V_22 -> V_210 && V_22 -> V_211 ) )
V_22 -> V_54 |= V_55 ;
if ( V_22 -> type == V_202 &&
V_22 -> V_212 == V_179 ) {
V_22 -> V_208 <<= 5 ;
...
if ( V_22 -> V_206 == V_8 ) {
F_47 ( V_4 , V_13 , V_22 -> V_217 ,
V_22 -> V_208 , V_22 -> V_213 , 0 ) ;
F_47 ( V_4 , V_14 , V_22 -> V_218 ,
V_22 -> V_209 , V_22 -> V_214 , 0 ) ;
F_47 ( V_4 , V_15 , 0 ,
V_22 -> V_26 , V_22 -> V_219 , 0 ) ;
F_51 ( V_4 , V_13 , V_22 -> V_220 ) ;
F_51 ( V_4 , V_14 , V_22 -> V_221 ) ;
} else {
if ( V_22 -> V_150 == 1 ) {
F_47 ( V_4 , V_13 , 0 ,
V_22 -> V_208 , V_22 -> V_213 , 0 ) ;
...
struct V_21 * V_22 = & V_1 -> V_22 ;
int V_102 ;
V_4 -> V_222 [ 0 ] |= F_53 ( V_223 ) | F_53 ( V_224 ) ;
F_46 ( V_16 , V_4 -> V_204 ) ;
F_46 ( V_12 , V_4 -> V_225 ) ;
F_50 ( V_4 , V_1 ) ;
switch ( V_22 -> type ) {
...
F_46 ( V_95 , V_4 -> V_204 ) ;
F_46 ( V_96 , V_4 -> V_204 ) ;
F_46 ( V_104 , V_4 -> V_204 ) ;
F_46 ( V_105 , V_4 -> V_204 ) ;
case V_196 :
F_46 ( V_86 , V_4 -> V_204 ) ;
F_46 ( V_90 , V_4 -> V_204 ) ;
case V_113 :
...
F_47 ( V_4 , V_72 , - 900 , 899 , 0 , 0 ) ;
F_48 ( V_1 ) ;
} else if ( V_22 -> V_206 == V_207 ) {
F_54 ( V_12 , V_4 -> V_225 ) ;
F_47 ( V_4 , V_138 ,
0 , V_22 -> V_208 , 0 , 0 ) ;
F_47 ( V_4 , V_168 ,
0 , V_22 -> V_209 , 0 , 0 ) ;
F_55 ( V_4 , V_22 -> V_150 , V_229 ) ;
}
break;
case V_109 :
case V_81 :
...
case V_197 :
if ( V_22 -> V_206 == V_207 ) {
F_47 ( V_4 , V_138 , 0 , V_22 -> V_208 , 0 , 0 ) ;
F_47 ( V_4 , V_139 , 0 , V_22 -> V_208 , 0 , 0 ) ;
F_47 ( V_4 , V_140 , 0 , V_22 -> V_209 , 0 , 0 ) ;
...
case V_144 :
case V_200 :
if ( V_22 -> V_206 == V_207 && V_22 -> V_150 > 1 )
F_55 ( V_4 , V_22 -> V_150 , V_230 ) ;
case V_198 :
case V_199 :
F_54 ( V_12 , V_4 -> V_225 ) ;
F_46 ( V_228 , V_4 -> V_227 ) ;
...
if ( V_22 -> V_150 &&
V_22 -> V_206 == V_207 ) {
V_4 -> V_222 [ 0 ] |= F_53 ( V_231 ) ;
F_46 ( V_178 , V_4 -> V_232 ) ;
}
case V_202 :
F_54 ( V_12 , V_4 -> V_225 ) ;
if ( V_22 -> V_206 == V_207 ) {
