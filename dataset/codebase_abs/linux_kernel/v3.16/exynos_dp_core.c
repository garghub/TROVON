...
static struct V_127 * F_106 (
struct V_114 * V_115 )
{
struct V_1 * V_2 = F_100 ( V_115 ) ;
return V_2 -> V_128 ;
}
static bool F_107 ( const char * V_129 , struct V_130 * V_131 )
{
V_131 -> V_132 = NULL ;
V_131 -> V_133 = F_108 ( NULL , NULL , V_129 ) ;
if ( ! V_131 -> V_133 )
return false ;
V_131 -> V_132 = F_109 ( V_131 -> V_133 ) ;
if ( ! V_131 -> V_132 )
return false ;
return true ;
}
static int F_110 ( struct V_134 * V_5 ,
struct V_127 * V_128 )
{
struct V_130 V_131 ;
int V_111 ;
if ( F_107 ( L_31 , & V_131 ) ) {
V_111 = F_111 ( V_5 , V_128 , V_131 . V_132 , V_131 . V_133 ) ;
if ( ! V_111 )
return 1 ;
}
return 0 ;
...
int V_111 ;
V_2 -> V_128 = V_128 ;
V_111 = F_110 ( V_2 -> V_138 , V_128 ) ;
if ( V_111 )
return 0 ;
V_115 -> V_139 = V_140 ;
V_111 = F_113 ( V_2 -> V_138 , V_115 ,
& V_141 , V_142 ) ;
if ( V_111 ) {
F_102 ( L_32 ) ;
return V_111 ;
...
T_2 V_65 ;
V_65 = F_119 ( V_2 -> V_145 ) ;
V_65 |= V_2 -> V_146 ;
F_120 ( V_65 , V_2 -> V_145 ) ;
}
}
...
static void F_130 ( struct V_135 * V_136 , int V_119 )
{
struct V_1 * V_2 = V_136 -> V_137 ;
switch ( V_119 ) {
case V_148 :
...
static struct V_112 * F_131 ( struct V_152 * V_5 )
{
struct V_153 * V_154 = V_5 -> V_155 ;
struct V_112 * V_156 ;
V_156 = F_132 ( V_5 ,
sizeof( * V_156 ) , V_157 ) ;
if ( ! V_156 )
...
{
struct V_153 * V_166 = F_137 ( V_2 -> V_5 -> V_155 ) ;
T_2 V_167 ;
int V_111 = 0 ;
V_166 = F_138 ( V_166 , L_48 ) ;
if ( ! V_166 ) {
V_2 -> V_144 = F_139 ( V_2 -> V_5 , L_49 ) ;
return F_140 ( V_2 -> V_144 ) ;
}
if ( F_135 ( V_166 , L_50 , & V_167 ) ) {
F_13 ( V_2 -> V_5 , L_51 ) ;
V_111 = - V_59 ;
goto V_168;
}
...
{
int V_111 ;
V_111 = F_144 ( V_2 -> V_5 -> V_155 , & V_2 -> V_120 . V_121 ,
V_170 ) ;
if ( V_111 ) {
F_102 ( L_55 , V_111 ) ;
return V_111 ;
...
static int F_145 ( struct V_152 * V_5 , struct V_152 * V_171 , void * V_28 )
{
struct V_172 * V_173 = F_146 ( V_5 ) ;
struct V_134 * V_138 = V_28 ;
struct V_174 * V_175 ;
struct V_1 * V_2 ;
unsigned int V_176 ;
int V_111 = 0 ;
V_2 = F_132 ( & V_173 -> V_5 , sizeof( struct V_1 ) ,
V_157 ) ;
if ( ! V_2 )
return - V_158 ;
V_2 -> V_5 = & V_173 -> V_5 ;
V_2 -> V_147 = V_151 ;
V_2 -> V_112 = F_131 ( & V_173 -> V_5 ) ;
if ( F_147 ( V_2 -> V_112 ) )
return F_148 ( V_2 -> V_112 ) ;
V_111 = F_136 ( V_2 ) ;
if ( V_111 )
return V_111 ;
V_111 = F_143 ( V_2 ) ;
if ( V_111 )
return V_111 ;
V_2 -> clock = F_149 ( & V_173 -> V_5 , L_49 ) ;
if ( F_147 ( V_2 -> clock ) ) {
F_13 ( & V_173 -> V_5 , L_56 ) ;
return F_148 ( V_2 -> clock ) ;
}
F_124 ( V_2 -> clock ) ;
V_175 = F_150 ( V_173 , V_177 , 0 ) ;
V_2 -> V_178 = F_151 ( & V_173 -> V_5 , V_175 ) ;
if ( F_147 ( V_2 -> V_178 ) )
return F_148 ( V_2 -> V_178 ) ;
V_2 -> V_179 = F_152 ( V_5 -> V_155 , L_57 , 0 ) ;
if ( F_153 ( V_2 -> V_179 ) ) {
V_111 = F_154 ( & V_173 -> V_5 , V_2 -> V_179 , V_180 ,
L_58 ) ;
if ( V_111 ) {
F_13 ( & V_173 -> V_5 , L_59 ) ;
return V_111 ;
}
V_2 -> V_100 = F_155 ( V_2 -> V_179 ) ;
V_176 = V_181 | V_182 ;
} else {
V_2 -> V_179 = - V_183 ;
V_2 -> V_100 = F_156 ( V_173 , 0 ) ;
V_176 = 0 ;
}
if ( V_2 -> V_100 == - V_184 ) {
F_13 ( & V_173 -> V_5 , L_60 ) ;
...
F_157 ( & V_2 -> V_105 , F_94 ) ;
F_117 ( V_2 ) ;
F_1 ( V_2 ) ;
V_111 = F_158 ( & V_173 -> V_5 , V_2 -> V_100 , F_90 ,
V_176 , L_61 , V_2 ) ;
if ( V_111 ) {
F_13 ( & V_173 -> V_5 , L_62 ) ;
return V_111 ;
...
V_185 . V_137 = V_2 ;
F_159 ( V_173 , & V_185 ) ;
return F_160 ( V_138 , & V_185 ) ;
}
static void F_161 ( struct V_152 * V_5 , struct V_152 * V_171 ,
void * V_28 )
{
struct V_135 * V_136 = F_162 ( V_5 ) ;
struct V_1 * V_2 = V_136 -> V_137 ;
struct V_127 * V_128 = V_2 -> V_128 ;
F_130 ( V_136 , V_151 ) ;
V_128 -> V_186 -> V_187 ( V_128 ) ;
F_163 ( & V_2 -> V_115 ) ;
}
static int F_164 ( struct V_172 * V_173 )
{
int V_111 ;
V_111 = F_165 ( & V_173 -> V_5 , V_188 ,
V_185 . type ) ;
if ( V_111 )
return V_111 ;
V_111 = F_166 ( & V_173 -> V_5 , & V_189 ) ;
if ( V_111 )
F_167 ( & V_173 -> V_5 ,
V_188 ) ;
return V_111 ;
}
static int F_168 ( struct V_172 * V_173 )
{
F_169 ( & V_173 -> V_5 , & V_189 ) ;
F_167 ( & V_173 -> V_5 , V_188 ) ;
return 0 ;
}
static int F_170 ( struct V_152 * V_5 )
{
struct V_172 * V_173 = F_146 ( V_5 ) ;
struct V_135 * V_136 = F_171 ( V_173 ) ;
F_130 ( V_136 , V_151 ) ;
return 0 ;
}
static int F_172 ( struct V_152 * V_5 )
{
struct V_172 * V_173 = F_146 ( V_5 ) ;
struct V_135 * V_136 = F_171 ( V_173 ) ;
F_130 ( V_136 , V_148 ) ;
