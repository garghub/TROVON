...
V_5 = F_107 ( V_185 , V_283 -> V_287 , V_288 ) ;
V_23 = - V_241 ;
V_4 = F_108 ( V_185 , sizeof( * V_4 ) * V_192 ,
V_255 ) ;
if ( ! V_4 )
return V_23 ;
V_4 -> V_5 = V_5 ;
F_109 ( & V_4 -> V_129 ) ;
V_4 -> V_92 = F_110 ( V_289 , V_90 ,
V_290 ) ;
if ( ! V_4 -> V_92 )
return V_23 ;
for ( floor = 0 ; floor < V_192 ; floor ++ ) {
...
V_23 = F_113 ( V_111 , V_293 , NULL , NULL ,
0 ) ;
if ( V_23 )
goto V_291;
V_284 ++ ;
...
static int T_10 F_117 ( struct V_188 * V_189 )
{
