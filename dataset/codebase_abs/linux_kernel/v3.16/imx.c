...
int V_176 , V_177 ;
unsigned long V_34 , V_39 ;
V_176 = F_76 ( V_2 -> V_178 ) ;
if ( V_176 )
goto V_179;
V_176 = F_76 ( V_2 -> V_180 ) ;
if ( V_176 ) {
F_77 ( V_2 -> V_178 ) ;
goto V_179;
}
...
V_39 &= ~ V_185 ;
F_8 ( V_39 , V_2 -> V_9 . V_13 + V_16 ) ;
while ( ! ( F_6 ( V_2 -> V_9 . V_13 + V_16 ) & V_185 ) && ( -- V_177 > 0 ) )
F_19 ( 1 ) ;
if ( V_2 -> V_186 > 0 ) {
...
static void
F_87 ( struct V_8 * V_9 , struct V_207 * V_208 ,
struct V_207 * V_209 )
{
struct V_1 * V_2 = (struct V_1 * ) V_9 ;
unsigned long V_34 ;
...
F_84 ( & V_2 -> V_36 ) ;
V_212 = F_89 ( V_9 , V_208 , V_209 , 50 , V_9 -> V_234 / 16 ) ;
V_213 = F_90 ( V_9 , V_212 ) ;
F_14 ( & V_2 -> V_9 . V_35 , V_34 ) ;
V_2 -> V_9 . V_118 = 0 ;
...
F_92 ( 16 * div * V_212 , V_2 -> V_9 . V_234 ,
1 << 16 , 1 << 16 , & V_219 , & V_220 ) ;
V_221 = V_2 -> V_9 . V_234 ;
V_221 *= V_219 ;
F_93 ( V_221 , V_220 * 16 * div ) ;
F_94 ( V_208 ,
( V_241 ) V_221 , ( V_241 ) V_221 ) ;
V_219 -= 1 ;
V_220 -= 1 ;
V_218 = F_6 ( V_2 -> V_9 . V_13 + V_139 ) ;
V_218 = ( V_218 & ( ~ V_140 ) ) | F_95 ( div ) ;
if ( V_2 -> V_242 )
V_218 |= V_141 ;
...
static int
F_99 ( struct V_8 * V_9 , struct V_248 * V_249 )
{
struct V_1 * V_2 = (struct V_1 * ) V_9 ;
int V_81 = 0 ;
if ( V_249 -> type != V_250 && V_249 -> type != V_246 )
V_81 = - V_153 ;
if ( V_2 -> V_9 . V_92 != V_249 -> V_92 )
V_81 = - V_153 ;
if ( V_249 -> V_251 != V_252 )
V_81 = - V_153 ;
if ( V_2 -> V_9 . V_234 / 16 != V_249 -> V_253 )
V_81 = - V_153 ;
if ( V_2 -> V_9 . V_161 != ( unsigned long ) V_249 -> V_254 )
V_81 = - V_153 ;
if ( V_2 -> V_9 . V_255 != V_249 -> V_9 )
V_81 = - V_153 ;
if ( V_249 -> V_256 != 0 )
V_81 = - V_153 ;
return V_81 ;
...
F_8 ( V_257 . V_15 & ~ ( V_259 | V_260 | V_261 ) ,
V_9 -> V_13 + V_16 ) ;
F_8 ( V_257 . V_17 & ~ ( V_262 | V_263 | V_264 ) ,
V_9 -> V_13 + V_18 ) ;
do {
V_19 = F_6 ( V_9 -> V_13 + V_41 ) ;
} while ( ~ V_19 & V_105 );
V_258 = F_6 ( V_9 -> V_13 + V_48 ) ;
F_7 ( V_9 , & V_257 ) ;
return V_258 ;
}
static void F_101 ( struct V_8 * V_9 , unsigned char V_258 )
{
struct V_10 V_257 ;
unsigned int V_19 ;
F_5 ( V_9 , & V_257 ) ;
...
F_8 ( V_258 , V_9 -> V_13 + V_61 ) ;
do {
V_19 = F_6 ( V_9 -> V_13 + V_41 ) ;
} while ( ~ V_19 & V_42 );
F_7 ( V_9 , & V_257 ) ;
}
static void F_102 ( struct V_8 * V_9 , int V_265 )
{
struct V_1 * V_2 = (struct V_1 * ) V_9 ;
while ( F_6 ( V_2 -> V_9 . V_13 + F_1 ( V_2 ) ) & V_58 )
F_20 () ;
F_8 ( V_265 , V_2 -> V_9 . V_13 + V_61 ) ;
}
static void
F_103 ( struct V_266 * V_267 , const char * V_268 , unsigned int V_148 )
{
struct V_1 * V_2 = V_269 [ V_267 -> V_270 ] ;
struct V_10 V_257 ;
unsigned int V_12 ;
unsigned long V_34 = 0 ;
int V_271 = 1 ;
int V_176 ;
V_176 = F_104 ( V_2 -> V_178 ) ;
if ( V_176 )
return;
V_176 = F_104 ( V_2 -> V_180 ) ;
if ( V_176 ) {
F_105 ( V_2 -> V_178 ) ;
return;
}
...
F_8 ( V_257 . V_15 | V_194 , V_2 -> V_9 . V_13 + V_16 ) ;
F_107 ( & V_2 -> V_9 , V_268 , V_148 , F_102 ) ;
while ( ! ( F_6 ( V_2 -> V_9 . V_13 + V_41 ) & V_42 ) ) ;
F_7 ( & V_2 -> V_9 , & V_257 ) ;
if ( V_271 )
F_15 ( & V_2 -> V_9 . V_35 , V_34 ) ;
...
static void T_3
F_108 ( struct V_1 * V_2 , int * V_212 ,
int * V_112 , int * V_274 )
{
if ( F_6 ( V_2 -> V_9 . V_13 + V_14 ) & V_192 ) {
unsigned int V_15 , V_275 , V_276 , V_234 ;
unsigned int V_277 ;
unsigned int V_278 ;
...
V_276 = F_6 ( V_2 -> V_9 . V_13 + V_244 ) & 0xffff ;
V_278 = ( F_6 ( V_2 -> V_9 . V_13 + V_139 ) & V_140 ) >> 7 ;
if ( V_278 == 6 )
V_278 = 7 ;
else
V_278 = 6 - V_278 ;
V_234 = F_109 ( V_2 -> V_178 ) ;
V_234 /= V_278 ;
{
unsigned int V_279 = V_275 + 1 ;
unsigned int div = 16 * ( V_276 + 1 ) ;
unsigned int V_280 = V_234 % div ;
V_277 = ( V_234 / div ) * V_279 ;
V_277 += ( V_280 * V_279 + div / 2 ) / div ;
* V_212 = ( V_277 + 50 ) / 100 * 100 ;
}
if ( * V_212 != V_277 )
F_110 ( L_19 ,
V_277 , * V_212 ) ;
...
static int T_3
F_111 ( struct V_266 * V_267 , char * V_281 )
{
struct V_1 * V_2 ;
int V_212 = 9600 ;
int V_274 = 8 ;
...
int V_282 = 'n' ;
int V_176 ;
if ( V_267 -> V_270 == - 1 || V_267 -> V_270 >= F_112 ( V_269 ) )
V_267 -> V_270 = 0 ;
V_2 = V_269 [ V_267 -> V_270 ] ;
if ( V_2 == NULL )
return - V_283 ;
V_176 = F_76 ( V_2 -> V_180 ) ;
if ( V_176 )
goto V_284;
if ( V_281 )
F_113 ( V_281 , & V_212 , & V_112 , & V_274 , & V_282 ) ;
else
F_108 ( V_2 , & V_212 , & V_112 , & V_274 ) ;
F_60 ( V_2 , 0 ) ;
V_176 = F_114 ( & V_2 -> V_9 , V_267 , V_212 , V_112 , V_274 , V_282 ) ;
F_105 ( V_2 -> V_180 ) ;
if ( V_176 ) {
F_115 ( V_2 -> V_180 ) ;
goto V_284;
}
V_176 = F_116 ( V_2 -> V_178 ) ;
if ( V_176 )
F_77 ( V_2 -> V_180 ) ;
V_284:
return V_176 ;
}
static int F_117 ( struct V_285 * V_68 , T_4 V_31 )
{
...
static int F_120 ( struct V_285 * V_68 )
{
struct V_1 * V_2 = F_118 ( V_68 ) ;
unsigned int V_94 ;
V_94 = F_6 ( V_2 -> V_9 . V_13 + V_18 ) ;
...
struct V_285 * V_288 )
{
struct V_289 * V_290 = V_288 -> V_68 . V_291 ;
const struct V_292 * V_293 =
F_123 ( V_294 , & V_288 -> V_68 ) ;
int V_81 ;
if ( ! V_290 )
return 1 ;
V_81 = F_124 ( V_290 , L_20 ) ;
if ( V_81 < 0 ) {
F_38 ( & V_288 -> V_68 , L_21 , V_81 ) ;
return V_81 ;
}
V_2 -> V_9 . line = V_81 ;
if ( F_125 ( V_290 , L_22 , NULL ) )
V_2 -> V_195 = 1 ;
if ( F_125 ( V_290 , L_23 , NULL ) )
V_2 -> V_295 = 1 ;
if ( F_125 ( V_290 , L_24 , NULL ) )
V_2 -> V_242 = 1 ;
V_2 -> V_3 = V_293 -> V_33 ;
return 0 ;
}
...
struct V_285 * V_288 )
{
struct V_203 * V_204 = F_81 ( & V_288 -> V_68 ) ;
V_2 -> V_9 . line = V_288 -> V_296 ;
V_2 -> V_3 = (struct V_297 * ) V_288 -> V_298 -> V_299 ;
if ( ! V_204 )
return;
if ( V_204 -> V_34 & V_300 )
V_2 -> V_195 = 1 ;
...
static int F_127 ( struct V_285 * V_288 )
{
struct V_1 * V_2 ;
void T_5 * V_302 ;
int V_81 = 0 ;
struct V_303 * V_304 ;
V_2 = F_128 ( & V_288 -> V_68 , sizeof( * V_2 ) , V_166 ) ;
if ( ! V_2 )
return - V_167 ;
V_81 = F_122 ( V_2 , V_288 ) ;
if ( V_81 > 0 )
F_126 ( V_2 , V_288 ) ;
else if ( V_81 < 0 )
return V_81 ;
V_304 = F_129 ( V_288 , V_305 , 0 ) ;
V_302 = F_130 ( & V_288 -> V_68 , V_304 ) ;
if ( F_131 ( V_302 ) )
return F_132 ( V_302 ) ;
V_2 -> V_9 . V_68 = & V_288 -> V_68 ;
V_2 -> V_9 . V_161 = V_304 -> V_306 ;
V_2 -> V_9 . V_13 = V_302 ;
V_2 -> V_9 . type = V_246 ,
V_2 -> V_9 . V_307 = V_252 ;
V_2 -> V_9 . V_92 = F_133 ( V_288 , 0 ) ;
V_2 -> V_187 = F_133 ( V_288 , 0 ) ;
V_2 -> V_186 = F_133 ( V_288 , 1 ) ;
V_2 -> V_189 = F_133 ( V_288 , 2 ) ;
V_2 -> V_9 . V_308 = 32 ;
V_2 -> V_9 . V_21 = & V_309 ;
V_2 -> V_9 . V_34 = V_310 ;
F_134 ( & V_2 -> V_36 ) ;
...
V_2 -> V_180 = F_135 ( & V_288 -> V_68 , L_25 ) ;
if ( F_131 ( V_2 -> V_180 ) ) {
V_81 = F_132 ( V_2 -> V_180 ) ;
F_38 ( & V_288 -> V_68 , L_26 , V_81 ) ;
return V_81 ;
}
V_2 -> V_178 = F_135 ( & V_288 -> V_68 , L_27 ) ;
if ( F_131 ( V_2 -> V_178 ) ) {
V_81 = F_132 ( V_2 -> V_178 ) ;
F_38 ( & V_288 -> V_68 , L_28 , V_81 ) ;
return V_81 ;
}
V_2 -> V_9 . V_234 = F_109 ( V_2 -> V_178 ) ;
V_269 [ V_2 -> V_9 . line ] = V_2 ;
F_136 ( V_288 , V_2 ) ;
return F_137 ( & V_287 , & V_2 -> V_9 ) ;
}
static int F_138 ( struct V_285 * V_288 )
{
struct V_1 * V_2 = F_118 ( V_288 ) ;
return F_139 ( & V_287 , & V_2 -> V_9 ) ;
}
