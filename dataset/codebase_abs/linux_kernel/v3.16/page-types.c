...
static void F_44 ( int V_104 , T_5 * V_105 , void * V_106 )
{
( void ) V_104 ;
( void ) V_106 ;
...
static void F_46 ( const char * V_10 , const struct V_95 * V_96 )
{
T_6 V_110 [ V_70 ] ;
T_2 V_11 [ V_70 ] , V_8 ;
unsigned long V_35 , V_21 , V_24 ;
V_16 V_111 , V_71 = V_96 -> V_97 ;
int V_9 ;
T_7 V_65 ;
void * V_112 ;
int V_113 = 1 ;
V_9 = F_3 ( V_10 , V_80 | V_114 | V_115 ) ;
for ( V_111 = 0 ; V_111 < V_71 ; V_111 += V_65 ) {
V_35 = ( V_71 - V_111 + V_2 - 1 ) / V_2 ;
if ( V_35 > V_70 )
V_35 = V_70 ;
V_65 = V_35 * V_2 ;
V_112 = F_47 ( NULL , V_65 , V_116 , V_117 , V_9 , V_111 ) ;
if ( V_112 == V_118 )
F_2 ( L_67 , V_10 ) ;
if ( F_48 ( V_112 , V_65 , V_110 ) )
F_2 ( L_68 , V_10 ) ;
if ( F_49 ( V_112 , V_65 , V_119 ) )
F_2 ( L_69 , V_10 ) ;
if ( F_50 ( V_109 , 1 ) ) {
V_71 = V_111 + V_107 ? V_107 - V_112 : 0 ;
fprintf ( V_5 , L_70 ,
( long long ) V_71 , V_10 ) ;
goto V_120;
}
...
if ( V_110 [ V_24 ] & 1 )
( void ) * ( volatile int * ) ( V_112 + V_24 * V_2 ) ;
}
V_120:
if ( F_49 ( V_112 , V_65 , V_121 ) )
F_2 ( L_69 , V_10 ) ;
if ( F_8 ( V_11 , ( unsigned long ) V_112 / V_2 ,
V_35 ) != V_35 )
F_2 ( L_71 ) ;
F_51 ( V_112 , V_65 ) ;
for ( V_24 = 0 ; V_24 < V_35 ; V_24 ++ ) {
...
F_30 ( V_111 / V_2 + V_24 , V_21 , V_8 , V_11 [ V_24 ] ) ;
}
}
F_38 ( V_9 ) ;
}
int F_52 ( const char * V_10 , const struct V_95 * V_96 , int type , struct V_122 * V_123 )
{
( void ) V_123 ;
switch ( type ) {
case V_124 :
...
V_17 = F_3 ( V_18 , V_80 ) ;
V_19 = F_3 ( L_73 , V_80 ) ;
F_55 ( V_127 , & V_128 , NULL ) ;
if ( V_95 ( V_34 , & V_96 ) )
F_2 ( L_74 , V_34 ) ;
if ( F_53 ( V_96 . V_125 ) ) {
F_46 ( V_34 , & V_96 ) ;
} else if ( F_56 ( V_96 . V_125 ) ) {
if ( F_57 ( V_34 , F_52 , 64 , V_129 | V_130 ) < 0 )
F_2 ( L_75 , V_34 ) ;
} else
F_2 ( L_76 , V_34 ) ;
F_38 ( V_17 ) ;
...
static void F_59 ( const char * V_132 )
{
unsigned long V_29 ;
unsigned long V_30 ;
char * V_133 ;
...
static void F_60 ( T_2 V_134 , T_2 V_135 )
{
if ( V_38 >= V_136 )
F_2 ( L_78 ) ;
V_41 [ V_38 ] = V_134 ;
...
static T_2 F_61 ( const char * V_83 , int V_65 )
{
T_3 V_24 ;
if ( ! * V_83 || ! V_65 )
return 0 ;
if ( V_65 <= 8 && ! strncmp ( V_83 , L_79 , V_65 ) )
return V_55 ;
...
static T_2 F_62 ( const char * V_83 , int V_137 )
{
const char * V_133 = V_83 ;
T_2 V_8 = 0 ;
while ( 1 ) {
if ( * V_133 == ',' || * V_133 == '=' || * V_133 == '\0' ) {
if ( ( * V_83 != '~' ) || ( * V_83 == '~' && V_137 && * ++ V_83 ) )
V_8 |= F_61 ( V_83 , V_133 - V_83 ) ;
if ( * V_133 != ',' )
break;
V_83 = V_133 + 1 ;
}
...
static void F_63 ( const char * V_132 )
{
T_2 V_134 ;
T_2 V_135 ;
const char * V_133 ;
...
if ( V_133 == V_132 ) {
V_134 = V_40 ;
V_135 = F_62 ( V_133 + 1 , 0 ) ;
} else if ( V_133 ) {
V_134 = F_62 ( V_132 , 0 ) ;
V_135 = F_62 ( V_133 + 1 , 0 ) ;
} else if ( strchr ( V_132 , '~' ) ) {
V_134 = F_62 ( V_132 , 1 ) ;
V_135 = F_62 ( V_132 , 0 ) ;
} else {
V_134 = F_62 ( V_132 , 0 ) ;
...
static void F_64 ( const char * V_132 )
{
T_2 V_8 = F_62 ( V_132 , 0 ) ;
printf ( L_80 ,
( unsigned long long ) V_8 ,
F_11 ( V_8 ) ,
F_13 ( V_8 ) ) ;
}
int main ( int V_138 , char * V_139 [] )
{
int V_140 ;
V_2 = F_65 () ;
while ( ( V_140 = F_66 ( V_138 , V_139 ,
L_81 , V_141 , NULL ) ) != - 1 ) {
switch ( V_140 ) {
case 'r' :
V_57 = 1 ;
