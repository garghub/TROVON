...
int V_161 ;
struct V_58 V_59 ;
unsigned long V_152 , V_318 ;
F_101 ( & V_59 ) ;
F_80 ( & V_4 -> V_89 , V_152 ) ;
V_4 -> V_82 |= V_198 ;
if ( V_4 -> V_82 & V_319 && V_195 == V_39 -> V_310 ) {
F_81 ( & V_4 -> V_89 , V_152 ) ;
F_80 ( & V_39 -> V_320 , V_318 ) ;
F_26 ( & V_4 -> V_91 ) ;
V_39 -> V_321 -- ;
F_81 ( & V_39 -> V_320 , V_318 ) ;
F_238 ( V_4 -> V_37 -> V_322 ) ;
F_239 ( V_39 , V_4 ) ;
return;
}
...
{
F_240 ( V_39 , & V_39 -> V_273 ) ;
F_240 ( V_39 , & V_39 -> V_274 ) ;
F_240 ( V_39 , & V_39 -> V_275 ) ;
F_240 ( V_39 , & V_39 -> V_268 . V_269 ) ;
}
int F_241 ( struct V_27 * V_27 )
{
int V_161 , V_323 ;
V_323 = F_234 ( F_46 ( V_27 -> V_97 ) ,
& F_45 ( V_27 ) -> V_209 ) ;
if ( V_323 < 0 )
F_113 ( V_323 ) ;
V_161 = V_323 ;
...
V_1 = V_4 -> V_74 ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
V_326 -> V_335 = V_4 -> V_37 -> V_333 ( V_4 , V_327 ) ;
if ( V_326 -> V_335 == V_336 ) {
F_3 ( V_158 , L_97 ,
V_4 -> V_8 ) ;
goto V_329;
}
F_80 ( & V_4 -> V_89 , V_152 ) ;
if ( ( V_327 != V_4 -> V_77 ) || ( V_1 != V_4 -> V_74 ) ) {
F_3 ( V_158 , L_98
L_99 , V_4 -> V_8 , V_327 ,
...
static int F_251 ( struct V_342 * V_343 ,
struct V_3 * V_4 ,
int V_138 )
{
int V_344 = F_252 ( V_343 ) ;
F_11 ( V_138 != V_139 && V_138 != V_137 ) ;
F_11 ( V_4 -> V_74 != V_136 && ! V_344 ) ;
if ( V_344 )
return 1 ;
F_253 ( F_46 ( F_254 ( V_343 ) ) ) ;
return 0 ;
}
...
{
struct V_27 * V_27 = F_10 ( V_4 ) ;
return F_251 ( F_159 ( V_27 ) , V_4 , V_138 ) ;
}
...
F_21 ( & V_347 ) ;
while ( 1 ) {
V_276 = F_260 ( V_108 -> V_109 ,
V_108 -> V_349 , 1 ) ;
if ( ! V_276 )
break;
F_23 ( & V_347 ) ;
F_3 ( 0 , L_103 , V_276 -> V_350 . V_45 ,
V_276 -> V_350 . V_44 ) ;
F_261 ( V_276 ) ;
F_262 ( V_276 ) ;
F_21 ( & V_347 ) ;
...
struct V_33 * V_352 =
F_14 ( V_4 ) ;
return F_251 ( & V_352 -> V_353 , V_4 , V_138 ) ;
}
...
{
struct V_354 * V_6 ;
struct V_31 * V_355 = F_13 ( V_4 ) ;
struct V_356 * V_98 = F_266 ( V_355 -> V_99 . V_100 ,
V_355 -> V_99 . V_129 ) ;
V_6 = F_2 ( & V_4 -> V_7 ) ;
V_6 -> V_9 = V_357 ;
V_6 -> V_358 = F_139 ( V_98 -> V_359 ) ;
V_6 -> V_360 = F_139 ( V_98 -> V_361 ) ;
V_6 -> V_362 = F_139 ( V_355 -> V_363 ) ;
V_6 -> V_364 = F_139 ( V_355 -> V_99 . V_365 ) ;
V_6 -> V_366 = F_139 ( V_355 -> V_99 . V_367 ) ;
V_6 -> V_368 = F_139 ( V_355 -> V_99 . V_369 ) ;
}
void F_267 ( struct V_31 * V_355 , int V_204 )
{
struct V_3 * V_4 = & V_355 -> V_370 ;
struct V_36 * V_39 = F_46 ( V_355 -> V_99 . V_100 ) ;
int V_1 = V_204 ? V_136 : V_137 ;
if ( ! F_126 ( V_39 ) && ! F_123 ( V_39 ) )
F_16 ( V_39 , V_4 , V_1 ) ;
}
static int F_268 ( struct V_31 * V_355 )
{
struct V_356 * V_98 = F_266 ( V_355 -> V_99 . V_100 ,
V_355 -> V_99 . V_129 ) ;
struct V_3 * V_4 = & V_355 -> V_370 ;
struct V_354 * V_6 = F_2 ( & V_4 -> V_7 ) ;
struct V_243 * V_244 = NULL ;
struct V_371 * V_372 ;
int V_161 = 0 ;
if ( F_154 ( & V_4 -> V_7 ) &&
V_6 -> V_9 == V_357 ) {
V_98 -> V_359 = F_4 ( V_6 -> V_358 ) ;
V_98 -> V_361 = F_4 ( V_6 -> V_360 ) ;
V_355 -> V_363 = F_4 ( V_6 -> V_362 ) ;
V_355 -> V_99 . V_365 = F_4 ( V_6 -> V_364 ) ;
V_355 -> V_99 . V_367 = F_4 ( V_6 -> V_366 ) ;
V_355 -> V_99 . V_369 =
F_4 ( V_6 -> V_368 ) ;
} else {
V_161 = F_269 ( V_355 -> V_373 ,
V_355 -> V_374 , & V_244 ) ;
if ( V_161 ) {
F_113 ( V_161 ) ;
goto V_175;
...
V_372 = (struct V_371 * )
( V_244 -> V_249 + V_375 ) ;
V_98 -> V_359 = F_162 ( V_372 -> V_359 ) ;
V_98 -> V_361 = F_162 ( V_372 -> V_361 ) ;
V_355 -> V_363 = F_162 ( V_372 -> V_363 ) ;
V_355 -> V_99 . V_365 = F_162 ( V_372 -> V_365 ) ;
V_355 -> V_99 . V_367 = F_162 ( V_372 -> V_367 ) ;
V_355 -> V_99 . V_369 =
F_162 ( V_372 -> V_369 ) ;
F_170 ( V_244 ) ;
F_34 ( V_4 ) ;
...
int F_270 ( struct V_31 * V_355 , int V_204 )
{
struct V_3 * V_4 = & V_355 -> V_370 ;
struct V_36 * V_39 = F_46 ( V_355 -> V_99 . V_100 ) ;
int V_1 = V_204 ? V_136 : V_137 ;
...
int F_271 ( struct V_33 * V_376 , int V_204 )
{
int V_161 ;
int V_1 = V_204 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_376 -> V_35 ;
...
void F_272 ( struct V_33 * V_376 , int V_204 )
{
int V_1 = V_204 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_376 -> V_35 ;
struct V_36 * V_39 = V_4 -> V_28 ;
...
goto V_377;
F_81 ( & V_4 -> V_89 , V_152 ) ;
V_161 = F_242 ( V_39 , V_4 , & V_326 ) ;
if ( V_161 < 0 )
F_113 ( V_161 ) ;
F_80 ( & V_4 -> V_89 , V_152 ) ;
V_377:
if ( V_4 -> V_82 & V_198 || ! V_326 . V_331 ) {
F_72 ( V_4 , V_319 ) ;
} else
F_85 ( V_39 , V_4 ) ;
F_3 ( V_158 , L_105 , V_4 -> V_8 ,
V_326 . V_331 ? L_106 : L_107 ) ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
if ( V_326 . V_335 != V_341
&& V_4 -> V_37 -> V_322 )
V_4 -> V_37 -> V_322 ( V_39 , V_4 ) ;
}
...
F_71 ( V_4 , V_319 ) ;
F_80 ( & V_39 -> V_320 , V_152 ) ;
if ( F_25 ( & V_4 -> V_91 ) ) {
F_107 ( & V_4 -> V_91 ,
& V_39 -> V_378 ) ;
V_39 -> V_321 ++ ;
}
F_81 ( & V_39 -> V_320 , V_152 ) ;
}
static void F_273 ( struct V_36 * V_39 )
{
unsigned long V_379 ;
unsigned long V_152 ;
struct V_3 * V_4 ;
...
V_379 = V_39 -> V_321 ;
while ( V_379 ) {
F_11 ( F_25 ( & V_39 -> V_378 ) ) ;
V_4 = F_274 ( V_39 -> V_378 . V_382 ,
struct V_3 , V_91 ) ;
F_26 ( & V_4 -> V_91 ) ;
V_39 -> V_321 -- ;
F_81 ( & V_39 -> V_320 , V_152 ) ;
