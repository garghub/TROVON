...
static void
F_40 ( struct V_76 * V_13 , int * V_85 , T_1 * V_86 )
{
struct V_87 * V_88 ;
const T_4 * V_6 ;
int V_89 ;
...
static int F_44 ( struct V_1 * V_4 , T_1 V_86 )
{
int V_8 ;
T_2 V_6 [ V_62 ] ;
...
V_8 = F_9 ( V_4 , V_94 , V_6 ) ;
V_93:
return V_8 ;
}
static int F_45 ( struct V_1 * V_4 , T_1 V_86 )
{
int V_8 ;
T_2 V_6 [ V_62 ] ;
...
static int F_46 ( struct V_76 * V_13 ,
const struct V_73 * V_74 )
{
struct V_97 * V_98 ;
struct V_1 * V_4 ;
...
F_40 ( V_13 , & V_4 -> V_37 , & V_86 ) ;
#ifdef F_49
if ( F_50 ( V_13 -> V_14 . V_90 , L_12 , NULL ) == NULL )
V_75 = - 1 ;
#endif
}
V_4 -> V_13 = V_13 ;
...
return V_8 ;
if ( V_98 && V_98 -> V_102 ) {
V_8 = V_98 -> V_102 ( V_13 , V_4 -> V_2 . V_36 ,
V_4 -> V_2 . V_10 , V_98 -> V_103 ) ;
if ( V_8 < 0 )
F_39 ( & V_13 -> V_14 , L_13 , V_8 ) ;
}
F_52 ( V_13 , V_4 ) ;
return 0 ;
}
static int F_53 ( struct V_76 * V_13 )
{
struct V_97 * V_98 = F_48 ( & V_13 -> V_14 ) ;
struct V_1 * V_4 = F_54 ( V_13 ) ;
int V_8 = 0 ;
if ( V_98 && V_98 -> V_104 ) {
V_8 = V_98 -> V_104 ( V_13 , V_4 -> V_2 . V_36 ,
V_4 -> V_2 . V_10 , V_98 -> V_103 ) ;
if ( V_8 < 0 ) {
F_6 ( & V_13 -> V_14 , L_14 ,
L_15 , V_8 ) ;
