...
unsigned int V_56 , V_57 , V_58 , V_59 , V_48 ;
unsigned int V_7 ;
F_7 ( L_16 , V_4 -> V_29 ) ;
V_56 = 0 ;
V_54 = V_4 -> V_29 ;
...
V_51 -> V_8 = 0 ;
V_51 -> V_61 = 0 ;
V_57 = F_22 ( V_51 -> V_62 , V_63 ,
V_64 ) ;
V_58 = F_22 ( V_51 -> V_62 , V_63 ,
V_65 ) ;
if ( ( V_57 && ( V_51 -> V_66 != V_4 -> V_31 . V_67 ) ) ||
( V_58 && ( V_51 -> V_68 != V_4 -> V_31 . V_69 ) ) )
V_55 ++ ;
V_6 = F_2 ( V_4 , V_55 ) ;
if ( V_57 ) {
F_7 ( L_17 ) ;
...
for ( V_59 = F_23 ( V_36 ) - V_56 ; V_59 ; ) {
V_48 = F_24 (unsigned int, datalen, TX_MAX_BUF_SIZE) ;
V_34 = F_16 ( V_2 -> V_10 , V_36 -> V_38 + V_56 , V_48 ,
V_46 ) ;
if ( F_17 ( V_2 -> V_10 , V_34 ) ) {
F_12 ( V_2 -> V_23 , L_18 ) ;
goto V_71;
...
for ( V_7 = 0 ; V_7 < F_25 ( V_36 ) -> V_72 ; V_7 ++ ) {
F_7 ( L_20 , V_7 ) ;
V_53 = & F_25 ( V_36 ) -> V_73 [ V_7 ] ;
V_56 = 0 ;
for ( V_59 = F_26 ( V_53 ) ; V_59 ; ) {
V_48 = F_24 (unsigned int, datalen, TX_MAX_BUF_SIZE) ;
V_34 = F_27 ( V_2 -> V_10 , V_53 , V_56 ,
V_48 , V_46 ) ;
if ( F_17 ( V_2 -> V_10 , V_34 ) ) {
F_12 ( V_2 -> V_23 ,
L_21 ) ;
