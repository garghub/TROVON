...
struct V_9 * F_38 ( struct V_9 * V_10 , int V_71 , int * V_65 )
{
struct V_62 * V_63 = F_20 ( V_10 ) ;
...
F_50 ( & V_63 -> V_85 , F_48 ,
( unsigned long ) V_10 ) ;
F_50 ( & V_10 -> V_86 , F_49 , ( unsigned long ) V_10 ) ;
...
void F_54 ( struct V_9 * V_10 , unsigned long V_91 )
{
F_55 ( V_10 , & V_10 -> V_86 , V_92 + V_91 ) ;
}
struct V_93 * F_56 ( struct V_9 * V_10 ,
struct V_94 * V_95 ,
const struct V_75 * V_76 )
{
struct V_96 * V_97 ;
const struct V_98 * V_99 = F_57 ( V_76 ) ;
struct V_100 * V_101 = F_57 ( V_76 ) -> V_101 ;
struct V_1 * V_1 = F_10 ( V_10 ) ;
int V_71 = F_58 ( V_10 ) ;
F_59 ( V_95 , V_10 -> V_20 , V_99 -> V_102 ,
F_60 ( V_10 ) , V_103 ,
V_10 -> V_79 ,
V_71 ,
( V_101 && V_101 -> V_101 . V_104 ) ? V_101 -> V_101 . V_105 : V_99 -> V_106 ,
V_99 -> V_107 , V_99 -> V_108 , F_61 ( V_10 ) -> V_109 ) ;
F_62 ( V_76 , F_63 ( V_95 ) ) ;
V_97 = F_64 ( V_1 , V_95 , V_10 ) ;
if ( F_65 ( V_97 ) )
goto V_110;
...
struct V_93 * F_68 ( struct V_9 * V_10 ,
struct V_9 * V_74 ,
const struct V_75 * V_76 )
{
const struct V_98 * V_99 = F_57 ( V_76 ) ;
struct V_116 * V_117 = F_61 ( V_74 ) ;
struct V_100 * V_101 ;
struct V_1 * V_1 = F_10 ( V_10 ) ;
struct V_94 * V_95 ;
struct V_96 * V_97 ;
...
F_69 () ;
V_101 = F_70 ( V_117 -> V_122 ) ;
F_59 ( V_95 , V_10 -> V_20 , F_57 ( V_76 ) -> V_102 ,
F_60 ( V_10 ) , V_103 ,
V_10 -> V_79 , F_58 ( V_10 ) ,
( V_101 && V_101 -> V_101 . V_104 ) ? V_101 -> V_101 . V_105 : V_99 -> V_106 ,
V_99 -> V_107 , V_99 -> V_108 , F_61 ( V_10 ) -> V_109 ) ;
...
static inline T_2 F_72 ( const T_3 V_123 , const T_4 V_124 ,
const T_2 V_125 , const T_2 V_126 )
{
return F_73 ( ( V_127 T_2 ) V_123 , ( V_127 T_2 ) V_124 , V_125 ) & ( V_126 - 1 ) ;
}
struct V_75 * F_74 ( const struct V_9 * V_10 ,
struct V_75 * * * V_128 ,
...
for ( V_133 = & V_131 -> V_134 [ F_72 ( V_123 , V_124 , V_131 -> V_135 ,
V_131 -> V_136 ) ] ;
( V_76 = * V_133 ) != NULL ;
V_133 = & V_76 -> V_137 ) {
const struct V_98 * V_99 = F_57 ( V_76 ) ;
...
void F_76 ( struct V_9 * V_10 , struct V_75 * V_76 ,
unsigned long V_140 )
{
struct V_62 * V_63 = F_20 ( V_10 ) ;
struct V_130 * V_131 = V_63 -> V_67 . V_132 ;
const T_2 V_29 = F_72 ( F_57 ( V_76 ) -> V_106 ,
F_57 ( V_76 ) -> V_108 ,
V_131 -> V_135 , V_131 -> V_136 ) ;
F_77 ( & V_63 -> V_67 , V_29 , V_76 , V_140 ) ;
F_78 ( V_10 , V_140 ) ;
}
static inline void F_79 ( struct V_75 * V_76 , const int V_141 ,
const int V_142 ,
const T_5 V_143 ,
int * V_144 , int * V_145 )
{
...
* V_144 = V_76 -> V_146 >= V_141 &&
( ! F_57 ( V_76 ) -> V_147 || V_76 -> V_146 >= V_142 ) ;
* V_145 = ! F_57 ( V_76 ) -> V_147 ||
V_76 -> V_146 >= V_143 - 1 ;
}
int F_80 ( struct V_9 * V_148 , struct V_75 * V_76 )
{
...
if ( F_82 ( V_155 , V_76 -> V_164 ) ) {
int V_144 = 0 , V_145 = 0 ;
F_79 ( V_76 , V_141 , V_142 ,
V_73 -> V_143 ,
& V_144 , & V_145 ) ;
...
if ( V_76 -> V_146 ++ == 0 )
V_131 -> V_162 -- ;
V_61 = F_83 ( V_140 << V_76 -> V_146 ,
V_152 ) ;
V_76 -> V_164 = V_155 + V_61 ;
V_156 = & V_76 -> V_137 ;
continue;
}
F_84 ( V_148 , V_76 , V_156 ) ;
F_85 ( V_73 , V_76 ) ;
F_86 ( V_76 ) ;
continue;
}
...
struct V_9 * F_87 ( const struct V_9 * V_10 ,
const struct V_75 * V_76 ,
const T_6 V_166 )
{
struct V_9 * V_74 = F_88 ( V_10 , V_166 ) ;
if ( V_74 != NULL ) {
struct V_62 * V_167 = F_20 ( V_74 ) ;
V_74 -> V_21 = V_168 ;
V_167 -> V_60 = NULL ;
F_61 ( V_74 ) -> V_169 = F_57 ( V_76 ) -> V_108 ;
F_61 ( V_74 ) -> V_170 = F_57 ( V_76 ) -> V_171 ;
F_61 ( V_74 ) -> V_109 = F_89 ( F_57 ( V_76 ) -> V_171 ) ;
V_74 -> V_172 = V_173 ;
V_74 -> V_174 = F_57 ( V_76 ) -> V_102 ;
V_167 -> V_175 = 0 ;
V_167 -> V_176 = 0 ;
V_167 -> V_177 = 0 ;
...
F_25 ( ! F_92 ( V_10 , V_179 ) ) ;
F_25 ( ! F_93 ( V_10 ) ) ;
F_25 ( F_61 ( V_10 ) -> V_170 && ! F_20 ( V_10 ) -> V_60 ) ;
V_10 -> V_28 -> V_180 ( V_10 ) ;
F_94 ( V_10 ) ;
F_95 ( V_10 ) ;
F_96 ( V_10 ) ;
F_97 ( V_10 -> V_28 -> V_181 ) ;
F_98 ( V_10 ) ;
}
void F_99 ( struct V_9 * V_10 )
__releases( &sk->sk_lock.slock
int F_100 ( struct V_9 * V_10 , const int V_136 )
{
struct V_116 * V_182 = F_61 ( V_10 ) ;
struct V_62 * V_63 = F_20 ( V_10 ) ;
int V_183 = F_101 ( & V_63 -> V_67 , V_136 ) ;
if ( V_183 != 0 )
return V_183 ;
V_10 -> V_184 = 0 ;
V_10 -> V_185 = 0 ;
...
F_111 ( V_190 ) ;
F_112 ( V_10 -> V_28 -> V_181 ) ;
if ( V_10 -> V_79 == V_80 && F_43 ( V_76 ) -> V_82 ) {
F_113 ( F_114 ( V_190 ) -> V_192 != V_76 ) ;
F_113 ( V_10 != F_43 ( V_76 ) -> V_82 ) ;
F_114 ( V_190 ) -> V_192 = NULL ;
F_98 ( V_10 ) ;
}
F_91 ( V_190 ) ;
F_115 ( V_190 ) ;
...
void F_116 ( struct V_9 * V_10 , struct V_194 * V_195 )
{
struct V_196 * sin = (struct V_196 * ) V_195 ;
const struct V_116 * V_182 = F_61 ( V_10 ) ;
sin -> V_197 = V_198 ;
sin -> V_199 . V_200 = V_182 -> V_201 ;
sin -> V_202 = V_182 -> V_169 ;
}
int F_117 ( struct V_9 * V_10 , int V_203 , int V_204 ,
...
static struct V_93 * F_119 ( struct V_9 * V_10 , struct V_211 * V_119 )
{
const struct V_116 * V_182 = F_61 ( V_10 ) ;
...
V_97 = NULL ;
if ( V_97 )
F_121 ( V_10 , & V_97 -> V_114 ) ;
F_71 () ;
return & V_97 -> V_114 ;
}
struct V_93 * F_122 ( struct V_9 * V_10 , T_2 V_214 )
{
struct V_93 * V_114 = F_123 ( V_10 , 0 ) ;
struct V_116 * V_182 = F_61 ( V_10 ) ;
if ( ! V_114 ) {
V_114 = F_119 ( V_10 , & V_182 -> V_118 . V_119 ) ;
if ( ! V_114 )
goto V_83;
}
