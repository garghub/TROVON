...
static int F_111 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
unsigned int V_36 ;
V_36 = F_7 ( V_2 , V_230 ) ;
...
static int F_115 ( struct V_188 * V_189 , struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
unsigned int V_241 ;
unsigned int V_242 ;
...
static struct V_249 * F_118 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
F_78 ( V_29 ) ;
V_29 -> V_160 . V_196 += F_7 ( V_2 , V_239 ) ;
...
static void F_119 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
unsigned long V_5 ;
if ( V_29 -> V_5 & V_250 ) {
...
static T_5 F_122 ( int V_136 , void * V_261 )
{
...
static void F_126 ( struct V_23 * V_29 )
{
F_127 ( V_29 -> V_136 ) ;
F_122 ( 0 , V_29 ) ;
F_128 ( V_29 -> V_136 ) ;
}
static int F_129 ( struct V_23 * V_29 , void * V_272 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
struct V_273 * V_45 = V_272 ;
if ( V_2 -> V_211 <= 1 && F_130 ( V_29 ) )
return - V_274 ;
if ( ! F_131 ( V_45 -> V_275 ) )
return - V_276 ;
...
static int F_132 ( struct V_23 * V_29 , struct V_277 * V_278 , int V_279 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
if ( ! F_130 ( V_29 ) || ! V_2 -> V_89 )
return - V_280 ;
return F_133 ( V_2 -> V_89 , V_278 , V_279 ) ;
}
static int
F_134 ( struct V_23 * V_29 , struct V_281 * V_279 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
V_279 -> V_282 = 1 ;
V_279 -> V_283 = 1 ;
return F_135 ( V_2 -> V_89 , V_279 ) ;
}
static int
...
static void F_138 ( struct V_23 * V_29 ,
struct V_284 * V_285 )
{
F_139 ( V_285 -> V_286 , V_287 , sizeof( V_285 -> V_286 ) ) ;
F_139 ( V_285 -> V_288 , V_289 , sizeof( V_285 -> V_288 ) ) ;
F_139 ( V_285 -> V_290 , F_70 ( V_29 -> V_29 . V_154 ) ,
sizeof( V_285 -> V_290 ) ) ;
}
static int F_140 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
return F_141 ( V_2 -> V_89 ) ;
}
static T_1 F_142 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
return V_2 -> V_291 ;
}
static void F_143 ( struct V_23 * V_29 , T_1 V_292 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
V_2 -> V_291 = V_292 ;
}
...
static void
F_145 ( struct V_23 * V_29 , struct V_296 * V_297 ,
void * V_15 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
struct V_88 * V_89 = V_2 -> V_89 ;
...
static int F_147 ( struct V_1 * V_2 , T_1 V_299 )
{
int V_181 = 100 ;
T_1 V_300 ;
...
static int F_151 ( struct V_23 * V_29 ,
...
int V_30 ;
F_146 ( V_2 ) ;
V_247 = F_152 ( V_308 -> V_247 , V_306 ) ;
for ( V_30 = 0 ; V_30 < V_247 ; V_30 ++ ) {
int V_25 = F_148 ( V_2 , V_30 , V_309 ) ;
if ( V_25 < 0 ) {
V_308 -> V_247 = 0 ;
return V_25 ;
}
...
F_146 ( V_2 ) ;
F_147 ( V_2 , V_310 ) ;
V_25 = F_149 ( V_2 , V_308 -> V_35 , * V_9 ) ;
F_147 ( V_2 , V_311 ) ;
V_308 -> V_247 = 1 ;
return V_25 ;
}
static void F_154 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
