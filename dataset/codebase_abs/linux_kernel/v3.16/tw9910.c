...
V_59 -> V_8 > 0xff )
return - V_52 ;
return F_6 ( V_3 , V_59 -> V_59 , V_59 -> V_8 ) ;
}
static int F_22 ( struct V_47 * V_48 , int V_61 )
{
struct V_2 * V_3 = F_15 ( V_48 ) ;
struct V_62 * V_63 = F_23 ( V_3 ) ;
struct V_1 * V_17 = F_1 ( V_3 ) ;
return F_24 ( & V_3 -> V_51 , V_63 , V_17 -> V_64 , V_61 ) ;
}
...
static int F_26 ( struct V_47 * V_48 , struct V_89 * V_90 )
{
struct V_2 * V_3 = F_15 ( V_48 ) ;
struct V_1 * V_17 = F_1 ( V_3 ) ;
V_90 -> V_91 . V_92 = 0 ;
...
static int F_27 ( struct V_47 * V_48 , struct V_95 * V_90 )
{
struct V_2 * V_3 = F_15 ( V_48 ) ;
struct V_1 * V_17 = F_1 ( V_3 ) ;
V_90 -> V_96 . V_92 = 0 ;
...
static int F_36 ( struct V_47 * V_48 , unsigned int V_115 ,
enum V_116 * V_103 )
{
if ( V_115 )
return - V_52 ;
...
struct V_62 * V_63 = F_23 ( V_3 ) ;
T_1 V_8 = V_128 | V_129 ;
unsigned long V_119 = F_38 ( V_63 , V_118 ) ;
if ( V_119 & V_125 )
V_8 |= V_130 ;
if ( V_119 & V_123 )
V_8 |= V_131 ;
...
V_17 = F_44 ( & V_3 -> V_51 , sizeof( * V_17 ) , V_142 ) ;
if ( ! V_17 )
return - V_143 ;
V_17 -> V_67 = V_67 ;
F_45 ( & V_17 -> V_4 , V_3 , & V_144 ) ;
V_17 -> V_64 = F_46 ( & V_3 -> V_51 , L_11 ) ;
if ( F_47 ( V_17 -> V_64 ) )
return F_48 ( V_17 -> V_64 ) ;
V_11 = F_32 ( V_3 ) ;
if ( V_11 < 0 )
F_49 ( V_17 -> V_64 ) ;
return V_11 ;
