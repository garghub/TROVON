...
if ( F_90 ( V_37 , V_82 , & V_153 ) == 0 ) {
struct V_127 * V_128 = & F_91 ( V_153 ) ;
...
static void F_97 ( struct V_1 * V_2 , struct V_83 * V_84 , struct V_55 * V_56 )
{
struct V_50 * V_60 ;
struct V_81 V_82 ;
const struct V_76 * V_77 = ( const struct V_76 * ) V_56 -> V_164 ;
...
void F_100 ( struct V_55 * V_56 )
{
struct V_50 * V_60 = F_101 ( V_56 ) ;
struct V_150 * V_151 ;
struct V_167 * V_168 ;
struct V_37 * V_37 ;
int V_169 ;
...
V_168 = F_103 ( V_37 -> V_170 . V_171 , F_39 ( V_56 ) -> V_79 , 1 ) ;
if ( ! V_168 ) {
F_104 ( V_56 , V_172 , V_157 ,
F_105 ( V_60 , F_39 ( V_56 ) -> V_57 ) ) ;
return;
}
if ( F_106 ( V_73 , V_168 -> V_173 + V_174 ) )
V_168 -> V_175 = 0 ;
...
( V_168 -> V_173 +
( V_178 << V_168 -> V_175 ) ) ) ) {
T_6 V_129 = F_105 ( V_60 , F_39 ( V_56 ) -> V_57 ) ;
F_104 ( V_56 , V_172 , V_157 , V_129 ) ;
V_168 -> V_173 = V_73 ;
++ V_168 -> V_175 ;
#ifdef F_94
if ( V_169 &&
...
static int F_110 ( struct V_55 * V_56 )
{
...
if ( V_179 )
F_104 ( V_56 , V_192 , V_154 , 0 ) ;
V_184: F_113 ( V_56 ) ;
return 0 ;
}
static void F_114 ( struct V_50 * V_60 , struct V_81 * V_82 , T_1 V_193 )
{
...
return;
F_58 () ;
if ( F_90 ( F_35 ( V_2 -> V_53 ) , V_82 , & V_153 ) == 0 ) {
struct V_127 * V_128 = & F_91 ( V_153 ) ;
...
static void F_116 ( struct V_1 * V_2 , struct V_83 * V_84 ,
struct V_55 * V_56 , T_1 V_193 )
{
struct V_50 * V_60 = (struct V_50 * ) V_2 ;
struct V_81 V_82 ;
F_62 ( & V_82 , V_84 , V_56 ) ;
F_114 ( V_60 , & V_82 , V_193 ) ;
}
void F_117 ( struct V_55 * V_56 , struct V_37 * V_37 , T_1 V_193 ,
...
if ( ! V_82 . V_197 )
V_82 . V_197 = F_118 ( F_122 ( V_84 ) , V_56 -> V_88 ) ;
V_60 = F_119 ( F_122 ( V_84 ) , & V_82 ) ;
if ( ! F_120 ( V_60 ) ) {
F_114 ( V_60 , & V_82 , V_193 ) ;
F_99 ( V_60 ) ;
}
...
F_114 ( (struct V_50 * ) V_60 -> V_2 . V_202 , & V_82 , V_193 ) ;
if ( ! F_129 ( & V_60 -> V_2 , 0 ) ) {
if ( V_199 )
F_130 ( & V_60 -> V_2 ) ;
V_60 = F_128 ( F_122 ( V_84 ) , & V_82 , V_84 ) ;
...
F_58 () ;
if ( F_90 ( F_35 ( V_60 -> V_2 . V_53 ) , & V_82 , & V_153 ) == 0 )
V_28 = F_142 ( F_35 ( V_60 -> V_2 . V_53 ) , V_153 ) ;
else
V_28 = F_143 ( V_60 -> V_2 . V_53 ,
F_105 ( V_60 , V_77 -> V_57 ) ,
V_97 ) ;
F_61 () ;
}
memcpy ( V_206 , & V_28 , 4 ) ;
...
if ( V_261 == V_151 && V_241 && F_102 ( V_261 ) &&
( F_84 ( V_261 ) ||
...
V_109 = F_152 ( & F_91 ( * V_153 ) , V_57 ) ;
if ( V_262 ) {
if ( V_109 != NULL )
V_51 = F_59 ( V_109 -> V_110 ) ;
else
V_51 = F_59 ( F_91 ( * V_153 ) . V_140 ) ;
if ( F_166 ( V_51 ) ) {
F_196 ( V_56 , & V_51 -> V_2 ) ;
goto V_184;
}
...
F_182 ( V_17 ) ;
if ( V_153 . type == V_279 ) {
V_51 -> V_2 . V_253 = F_110 ;
V_51 -> V_2 . error = - V_241 ;
V_51 -> V_124 &= ~ V_255 ;
}
if ( V_262 ) {
if ( F_150 ( ! F_155 ( & F_91 ( V_153 ) , V_51 ) ) ) {
...
return F_205 ( - V_185 ) ;
if ( F_173 ( ! F_174 ( V_151 ) ) )
if ( F_175 ( V_82 -> V_79 ) && ! ( V_282 -> V_217 & V_283 ) )
return F_205 ( - V_185 ) ;
if ( F_82 ( V_82 -> V_57 ) )
type = V_274 ;
...
V_262 = false ;
if ( V_226 && V_153 -> V_285 < 4 )
V_226 = NULL ;
}
V_109 = NULL ;
V_262 &= V_226 != NULL ;
if ( V_262 ) {
struct V_50 T_9 * * V_286 ;
struct V_127 * V_128 = & F_91 ( * V_153 ) ;
...
struct V_50 * F_119 ( struct V_37 * V_37 , struct V_81 * V_82 )
{
...
V_281 = V_82 -> V_208 ;
V_82 -> V_209 = V_292 ;
V_82 -> V_207 = V_86 & V_293 ;
V_82 -> V_272 = ( ( V_86 & V_294 ) ?
V_231 : V_97 ) ;
F_58 () ;
if ( V_82 -> V_79 ) {
V_51 = F_205 ( - V_185 ) ;
...
( F_81 ( V_82 -> V_57 ) ||
F_82 ( V_82 -> V_57 ) ) ) {
V_282 = F_208 ( V_37 , V_82 -> V_79 , false ) ;
if ( V_282 == NULL )
goto V_184;
V_82 -> V_208 = V_282 -> V_98 ;
goto V_295;
}
if ( ! ( V_82 -> V_287 & V_296 ) ) {
...
if ( V_82 -> V_208 ) {
V_282 = F_209 ( V_37 , V_82 -> V_208 ) ;
V_51 = F_205 ( - V_297 ) ;
if ( V_282 == NULL )
goto V_184;
if ( ! ( V_282 -> V_217 & V_298 ) || ! F_79 ( V_282 ) ) {
V_51 = F_205 ( - V_182 ) ;
goto V_184;
}
if ( F_176 ( V_82 -> V_57 ) ||
...
V_82 -> V_57 = V_82 -> V_79 ;
if ( ! V_82 -> V_57 )
V_82 -> V_57 = V_82 -> V_79 = F_210 ( V_300 ) ;
V_282 = V_37 -> V_224 ;
V_82 -> V_208 = V_292 ;
V_153 . type = V_275 ;
V_217 |= V_255 ;
...
if ( V_153 . type == V_275 ) {
if ( ! V_82 -> V_79 ) {
if ( V_153 . V_226 -> V_301 )
V_82 -> V_79 = V_153 . V_226 -> V_301 ;
else
V_82 -> V_79 = V_82 -> V_57 ;
}
V_282 = V_37 -> V_224 ;
...
V_82 -> V_208 = V_282 -> V_98 ;
V_295:
V_51 = F_204 ( & V_153 , V_82 , V_281 , V_282 , V_217 ) ;
V_184:
F_61 () ;
return V_51 ;
}
...
struct V_1 * F_217 ( struct V_37 * V_37 , struct V_1 * V_303 )
{
struct V_50 * V_304 = (struct V_50 * ) V_303 ;
struct V_50 * V_60 ;
V_60 = F_171 ( & V_305 , NULL , 1 , V_306 , 0 ) ;
if ( V_60 ) {
struct V_1 * V_199 = & V_60 -> V_2 ;
V_199 -> V_307 = 1 ;
V_199 -> V_253 = V_308 ;
V_199 -> V_247 = V_309 ;
V_199 -> V_53 = V_304 -> V_2 . V_53 ;
if ( V_199 -> V_53 )
F_164 ( V_199 -> V_53 ) ;
V_60 -> V_251 = V_304 -> V_251 ;
V_60 -> V_252 = V_304 -> V_252 ;
V_60 -> V_119 = V_304 -> V_119 ;
V_60 -> V_52 = F_34 ( V_37 ) ;
V_60 -> V_124 = V_304 -> V_124 ;
V_60 -> V_249 = V_304 -> V_249 ;
...
struct V_50 * F_128 ( struct V_37 * V_37 , struct V_81 * V_310 ,
struct V_83 * V_84 )
{
struct V_50 * V_60 = F_119 ( V_37 , V_310 ) ;
if ( F_120 ( V_60 ) )
return V_60 ;
if ( V_310 -> V_284 )
...
T_1 V_5 , int V_312 , int V_313 , unsigned int V_217 )
{
struct V_50 * V_60 = F_101 ( V_56 ) ;
struct V_314 * V_315 ;
struct V_316 * V_317 ;
...
T_1 error ;
T_1 V_318 [ V_319 ] ;
V_317 = F_222 ( V_56 , V_311 , V_5 , V_312 , sizeof( * V_315 ) , V_217 ) ;
if ( V_317 == NULL )
return - V_320 ;
V_315 = F_223 ( V_317 ) ;
V_315 -> V_321 = V_322 ;
V_315 -> V_323 = 32 ;
V_315 -> V_324 = 0 ;
V_315 -> V_325 = V_82 -> V_207 ;
V_315 -> V_326 = V_327 ;
if ( F_224 ( V_56 , V_328 , V_327 ) )
goto V_329;
V_315 -> V_330 = V_60 -> V_249 ;
V_315 -> V_331 = V_97 ;
V_315 -> V_332 = V_333 ;
V_315 -> V_334 = ( V_60 -> V_124 & ~ 0xFFFF ) | V_335 ;
if ( V_60 -> V_124 & V_336 )
V_315 -> V_334 |= V_337 ;
if ( F_225 ( V_56 , V_338 , V_2 ) )
goto V_329;
if ( V_28 ) {
V_315 -> V_324 = 32 ;
if ( F_225 ( V_56 , V_339 , V_28 ) )
goto V_329;
}
if ( V_60 -> V_2 . V_53 &&
F_224 ( V_56 , V_340 , V_60 -> V_2 . V_53 -> V_98 ) )
goto V_329;
#ifdef F_28
if ( V_60 -> V_2 . V_211 &&
F_224 ( V_56 , V_341 , V_60 -> V_2 . V_211 ) )
goto V_329;
#endif
if ( ! F_154 ( V_60 ) &&
V_82 -> V_79 != V_28 ) {
if ( F_225 ( V_56 , V_342 , V_82 -> V_79 ) )
goto V_329;
}
if ( V_60 -> V_126 &&
F_225 ( V_56 , V_343 , V_60 -> V_62 ) )
goto V_329;
...
memcpy ( V_318 , F_226 ( & V_60 -> V_2 ) , sizeof( V_318 ) ) ;
if ( V_60 -> V_119 && V_121 )
V_318 [ V_194 - 1 ] = V_60 -> V_119 ;
if ( F_227 ( V_56 , V_318 ) < 0 )
goto V_329;
if ( V_82 -> V_197 &&
F_224 ( V_56 , V_344 , V_82 -> V_197 ) )
goto V_329;
...
#endif
if ( F_224 ( V_56 , V_346 , V_56 -> V_53 -> V_98 ) )
goto V_329;
}
if ( F_230 ( V_56 , & V_60 -> V_2 , 0 , V_121 , error ) < 0 )
goto V_329;
return F_231 ( V_56 , V_317 ) ;
V_329:
F_232 ( V_56 , V_317 ) ;
return - V_320 ;
}
static int F_233 ( struct V_55 * V_347 , struct V_316 * V_317 )
{
struct V_37 * V_37 = F_122 ( V_347 -> V_84 ) ;
struct V_314 * V_348 ;
...
int V_88 ;
struct V_55 * V_56 ;
V_241 = F_234 ( V_317 , sizeof( * V_348 ) , V_350 , V_351 , V_353 ) ;
if ( V_241 < 0 )
goto V_354;
V_348 = F_223 ( V_317 ) ;
V_56 = F_235 ( V_355 , V_31 ) ;
if ( V_56 == NULL ) {
V_241 = - V_257 ;
goto V_354;
}
...
F_238 ( V_56 , V_357 + sizeof( struct V_76 ) ) ;
V_28 = V_350 [ V_339 ] ? F_239 ( V_350 [ V_339 ] ) : 0 ;
V_2 = V_350 [ V_338 ] ? F_239 ( V_350 [ V_338 ] ) : 0 ;
V_352 = V_350 [ V_346 ] ? F_240 ( V_350 [ V_346 ] ) : 0 ;
V_88 = V_350 [ V_344 ] ? F_240 ( V_350 [ V_344 ] ) : 0 ;
memset ( & V_82 , 0 , sizeof( V_82 ) ) ;
V_82 . V_57 = V_2 ;
V_82 . V_79 = V_28 ;
V_82 . V_207 = V_348 -> V_325 ;
V_82 . V_208 = V_350 [ V_340 ] ? F_240 ( V_350 [ V_340 ] ) : 0 ;
V_82 . V_197 = V_88 ;
if ( V_352 ) {
struct V_58 * V_53 ;
V_53 = F_241 ( V_37 , V_352 ) ;
if ( V_53 == NULL ) {
V_241 = - V_297 ;
goto V_358;
}
...
V_56 -> V_88 = V_88 ;
F_242 () ;
V_241 = F_243 ( V_56 , V_2 , V_28 , V_348 -> V_325 , V_53 ) ;
F_244 () ;
V_60 = F_101 ( V_56 ) ;
...
F_247 ( V_347 ) . V_311 , V_317 -> V_359 ,
V_360 , 0 , 0 ) ;
if ( V_241 <= 0 )
goto V_358;
V_241 = F_248 ( V_56 , V_37 , F_247 ( V_347 ) . V_311 ) ;
V_354:
return V_241 ;
V_358:
F_113 ( V_56 ) ;
...
static int F_250 ( struct V_361 * V_362 , int V_363 ,
void T_12 * V_364 ,
...
V_368 = V_369 ;
if ( ! F_253 ( V_37 , & V_370 ) ) {
V_368 = F_254 ( V_368 , sizeof( V_369 ) , V_31 ) ;
if ( V_368 == NULL )
goto V_371;
if ( V_37 -> V_372 != & V_373 )
V_368 [ 0 ] . V_374 = NULL ;
...
V_368 [ 0 ] . V_367 = V_37 ;
V_37 -> V_170 . V_375 = F_255 ( V_37 , L_19 , V_368 ) ;
if ( V_37 -> V_170 . V_375 == NULL )
goto V_376;
return 0 ;
V_376:
if ( V_368 != V_369 )
...
{
struct V_361 * V_368 ;
V_368 = V_37 -> V_170 . V_375 -> V_377 ;
F_257 ( V_37 -> V_170 . V_375 ) ;
F_258 ( V_368 == V_369 ) ;
F_23 ( V_368 ) ;
}
...
F_260 ( & V_37 -> V_138 , 0 ) ;
F_261 ( & V_37 -> V_170 . V_378 ,
sizeof( V_37 -> V_170 . V_378 ) ) ;
return 0 ;
}
static int T_3 F_262 ( struct V_37 * V_37 )
{
struct V_379 * V_380 = F_263 ( sizeof( * V_380 ) , V_31 ) ;
if ( ! V_380 )
return - V_32 ;
F_264 ( V_380 ) ;
V_37 -> V_170 . V_171 = V_380 ;
return 0 ;
}
static void T_4 F_265 ( struct V_37 * V_37 )
{
struct V_379 * V_380 = V_37 -> V_170 . V_171 ;
...
F_279 () ;
#endif
F_280 ( V_388 , V_389 , F_233 , NULL , NULL ) ;
#ifdef F_281
F_32 ( & V_390 ) ;
#endif
F_32 ( & V_391 ) ;
