...
int
F_45 ( int V_89 , T_5 * V_36 , T_5 * V_61 ,
T_7 * V_62 , T_5 * V_8 , T_5 * V_63 )
{
struct V_26 * V_78 ;
struct V_26 * V_79 ;
T_4 * V_37 ;
...
void
F_94 ( T_15 * V_167 , int V_168 )
{
int V_169 = F_95 ( T_15 , V_170 [ V_168 ] ) ;
while ( -- V_168 >= 0 )
F_96 ( V_167 -> V_170 [ V_168 ] . V_171 ) ;
F_37 ( V_167 , V_169 ) ;
}
T_15 *
F_97 ( T_16 * V_172 , int V_80 )
{
...
int
F_103 ( T_16 * V_172 , int V_187 , int V_80 )
{
T_15 * V_167 ;
int V_81 ;
if ( V_172 -> V_182 != 0 ) {
...
int V_66 ;
int V_81 ;
if ( ! strcmp ( V_210 , L_31 ) ) {
if ( ! V_202 )
return 0 ;
} else if ( ! strcmp ( V_210 , L_32 ) ) {
return 0 ;
} else if ( ! strcmp ( V_210 , L_33 ) ) {
} else {
F_78 ( 0x10b , L_34
L_35 ) ;
return - V_68 ;
...
int
F_114 ( T_1 * V_1 , T_7 V_112 , int V_8 , T_3 V_9 )
{
