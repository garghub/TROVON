...
static inline void F_21 ( unsigned long * V_55 , unsigned long V_33 )
{
...
if ( F_34 ( ( V_8 & V_89 ) == 0 ) ) {
V_23 &= ~ 7UL ;
V_55 = ( unsigned long * ) ( V_7 -> V_10 . V_90 + ( V_23 << 4 ) ) ;
...
long F_40 ( struct V_14 * V_93 , unsigned long V_8 ,
long V_23 , unsigned long V_56 , unsigned long V_38 )
{
return F_22 ( V_93 -> V_7 , V_8 , V_23 , V_56 , V_38 ,
...
while ( ! F_35 ( V_55 , V_69 ) )
F_36 () ;
if ( ( V_55 [ 0 ] & ( V_70 | V_71 ) ) == 0 ||
( ( V_8 & V_110 ) && ( V_55 [ 0 ] & ~ 0x7fUL ) != V_106 ) ||
( ( V_8 & V_111 ) && ( V_55 [ 0 ] & V_106 ) != 0 ) ) {
V_55 [ 0 ] &= ~ V_69 ;
return V_112 ;
}
...
if ( V_108 & V_71 ) {
V_55 [ 0 ] &= ~ V_71 ;
V_104 = F_45 ( V_108 , V_55 [ 1 ] , V_23 ) ;
F_43 ( V_7 , & V_104 , 1 , F_6 ( V_7 , V_8 ) , true ) ;
F_12 ( V_7 , V_23 , V_21 , V_108 , V_55 [ 1 ] ) ;
}
...
long F_46 ( struct V_14 * V_93 , unsigned long V_8 ,
unsigned long V_23 , unsigned long V_106 )
{
return F_44 ( V_93 -> V_7 , V_8 , V_23 , V_106 ,
& V_93 -> V_10 . V_94 [ 4 ] ) ;
}
long F_47 ( struct V_14 * V_93 )
{
...
unsigned long V_8 , V_121 , V_23 , V_41 ;
int V_9 ;
long int V_122 = V_92 ;
struct V_20 * V_21 , * V_123 [ 4 ] ;
V_9 = F_6 ( V_7 , 0 ) ;
for ( V_27 = 0 ; V_27 < 4 && V_122 == V_92 ; ) {
V_118 = 0 ;
for (; V_27 < 4 ; ++ V_27 ) {
V_116 = V_27 * 2 ;
V_23 = args [ V_116 ] ;
...
V_113 = ( unsigned long * )
( V_7 -> V_10 . V_90 + ( V_23 << 4 ) ) ;
if ( ! F_35 ( V_113 , V_69 ) ) {
if ( V_118 )
break;
while ( ! F_35 ( V_113 , V_69 ) )
F_36 () ;
}
V_119 = 0 ;
if ( V_113 [ 0 ] & ( V_70 | V_71 ) ) {
switch ( V_8 & 3 ) {
case 0 :
V_119 = 1 ;
break;
...
args [ V_116 ] |= V_41 << ( 56 - 5 ) ;
V_113 [ 0 ] = 0 ;
continue;
}
V_113 [ 0 ] &= ~ V_71 ;
V_115 [ V_118 ] = F_45 ( V_113 [ 0 ] , V_113 [ 1 ] , V_23 ) ;
V_120 [ V_118 ] = V_116 ;
V_114 [ V_118 ] = V_113 ;
V_123 [ V_118 ] = V_21 ;
++ V_118 ;
...
V_113 = V_114 [ V_117 ] ;
V_21 = V_123 [ V_117 ] ;
F_12 ( V_7 , V_23 , V_21 , V_113 [ 0 ] , V_113 [ 1 ] ) ;
V_41 = V_21 -> V_44 & ( V_42 | V_43 ) ;
args [ V_116 ] |= V_41 << ( 56 - 5 ) ;
V_113 [ 0 ] = 0 ;
}
...
V_126 = ( V_8 << 55 ) & V_85 ;
V_126 |= ( V_8 << 48 ) & V_77 ;
V_126 |= V_8 & ( V_127 | V_128 | V_78 ) ;
V_125 = V_85 | V_127 | V_128 |
V_77 | V_78 ;
V_21 = F_1 ( & V_7 -> V_10 . V_30 [ V_23 ] ) ;
if ( V_21 ) {
V_109 = ( V_21 -> V_44 & ~ V_125 ) | V_126 ;
V_21 -> V_44 = V_109 ;
F_37 ( V_7 , V_21 ) ;
}
V_109 = ( V_55 [ 1 ] & ~ V_125 ) | V_126 ;
if ( V_108 & V_71 ) {
V_104 = F_45 ( V_108 , V_109 , V_23 ) ;
V_55 [ 0 ] = V_108 & ~ V_71 ;
F_43 ( V_7 , & V_104 , 1 , F_6 ( V_7 , V_8 ) , true ) ;
...
long F_49 ( struct V_14 * V_93 , unsigned long V_8 ,
unsigned long V_23 )
{
struct V_7 * V_7 = V_93 -> V_7 ;
unsigned long * V_55 , V_108 , V_109 ;
int V_27 , V_118 = 1 ;
...
unsigned long V_104 ;
V_130 [ 0 ] &= ~ V_71 ;
V_104 = F_45 ( V_130 [ 0 ] , V_130 [ 1 ] , V_23 ) ;
...
V_139 |= V_106 ;
for (; ; ) {
V_55 = ( unsigned long * ) ( V_7 -> V_10 . V_90 + ( V_138 << 7 ) ) ;
for ( V_27 = 0 ; V_27 < 16 ; V_27 += 2 ) {
V_108 = V_55 [ V_27 ] & ~ V_69 ;
if ( ! ( V_108 & V_134 ) || ( V_108 & V_125 ) != V_139 )
continue;
while ( ! F_35 ( & V_55 [ V_27 ] , V_69 ) )
F_36 () ;
V_108 = V_55 [ V_27 ] & ~ V_69 ;
V_109 = V_55 [ V_27 + 1 ] ;
if ( ( V_108 & V_134 ) && ( V_108 & V_125 ) == V_139 &&
F_53 ( V_108 , V_109 ) == ( 1ul << V_135 ) )
return ( V_138 << 3 ) + ( V_27 >> 1 ) ;
V_55 [ V_27 ] = V_108 ;
}
if ( V_139 & V_142 )
break;
...
long F_54 ( struct V_14 * V_93 , unsigned long V_2 ,
...
V_55 = ( unsigned long * ) ( V_7 -> V_10 . V_90 + ( V_153 << 4 ) ) ;
V_108 = V_55 [ 0 ] & ~ V_69 ;
V_109 = V_55 [ 1 ] ;
V_21 = F_1 ( & V_7 -> V_10 . V_30 [ V_153 ] ) ;
V_154 = V_21 -> V_44 ;
F_21 ( V_55 , V_108 ) ;
if ( ( V_151 & V_157 ) && ( V_108 & V_71 ) )
return 0 ;
V_155 = V_154 & ( V_85 | V_127 ) ;
...
unsigned int V_168 = F_57 ( V_154 , V_93 -> V_10 . V_169 ) ;
if ( V_151 & V_165 )
V_168 >>= 1 ;
if ( V_168 & 1 )
return V_151 | V_170 ;
