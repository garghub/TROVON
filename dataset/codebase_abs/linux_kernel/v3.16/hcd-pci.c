...
static void F_53 ( struct V_1 * V_1 , int V_56 )
{
if ( F_54 ( V_57 ) ) {
struct V_58 * V_59 ;
V_59 = F_55 ( V_1 ) ;
...
static inline void F_53 ( struct V_1 * V_1 , int V_56 )
{}
static int F_57 ( struct V_61 * V_18 )
{
...
static int F_61 ( struct V_61 * V_18 , bool V_63 )
{
struct V_1 * V_1 = F_58 ( V_18 ) ;
struct V_6 * V_7 = F_5 ( V_1 ) ;
int V_25 ;
...
F_64 ( V_7 -> V_24 -> V_64 , V_25 ) ;
if ( ( V_25 == 0 && V_63 && F_63 ( V_7 ) ) ||
...
static int F_66 ( struct V_61 * V_18 , int V_67 )
{
struct V_1 * V_1 = F_58 ( V_18 ) ;
struct V_6 * V_7 = F_5 ( V_1 ) ;
int V_25 ;
...
static int F_68 ( struct V_61 * V_18 )
{
...
static int F_75 ( struct V_61 * V_18 )
{
struct V_1 * V_1 = F_58 ( V_18 ) ;
F_53 ( V_1 , 1 ) ;
F_76 ( V_1 ) ;
...
{
return F_66 ( V_18 , V_72 ) ;
}
static int F_78 ( struct V_61 * V_18 )
{
return F_66 ( V_18 , V_69 ) ;
}
