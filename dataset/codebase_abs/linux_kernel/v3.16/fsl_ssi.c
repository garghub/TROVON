...
{
struct V_9 * V_10 = V_2 -> V_10 ;
T_3 V_115 = 0 , V_29 , V_27 , V_38 , V_83 ;
T_5 V_116 ;
V_2 -> V_3 = V_114 ;
if ( F_2 ( V_2 ) && F_24 ( V_2 -> V_95 ) ) {
F_29 ( & V_2 -> V_117 -> V_99 , L_3 ) ;
return - V_96 ;
}
F_13 ( V_2 ) ;
F_4 ( V_10 , V_35 , & V_38 ) ;
...
V_116 = V_2 -> V_144 ;
F_5 ( V_10 , V_145 ,
F_40 ( V_116 ) | F_41 ( V_116 ) |
F_42 ( V_116 ) | F_43 ( V_116 ) ) ;
if ( V_2 -> V_70 ) {
F_8 ( V_10 , V_26 , V_146 ,
V_146 ) ;
F_8 ( V_10 , V_28 , V_147 ,
...
static int F_44 ( struct V_64 * V_69 , unsigned int V_114 )
{
struct V_1 * V_2 = F_19 ( V_69 ) ;
return F_39 ( V_2 , V_114 ) ;
}
...
static int F_52 ( struct V_184 * V_117 ,
struct V_1 * V_2 , void T_6 * V_185 )
{
struct V_186 * V_187 = V_117 -> V_99 . V_188 ;
T_3 V_189 [ 4 ] ;
int V_78 ;
V_2 -> V_190 = F_53 ( & V_117 -> V_99 , NULL ) ;
if ( F_24 ( V_2 -> V_190 ) ) {
V_78 = F_54 ( V_2 -> V_190 ) ;
F_29 ( & V_117 -> V_99 , L_5 , V_78 ) ;
return V_78 ;
}
V_78 = F_36 ( V_2 -> V_190 ) ;
if ( V_78 ) {
F_29 ( & V_117 -> V_99 , L_6 , V_78 ) ;
return V_78 ;
}
V_2 -> V_95 = F_53 ( & V_117 -> V_99 , L_7 ) ;
if ( F_24 ( V_2 -> V_95 ) )
F_55 ( & V_117 -> V_99 , L_8 ,
F_54 ( V_2 -> V_95 ) ) ;
V_2 -> V_167 . V_191 = V_2 -> V_144 - 2 ;
V_2 -> V_169 . V_191 = V_2 -> V_144 - 2 ;
V_2 -> V_167 . V_192 = V_2 -> V_193 + V_194 ;
V_2 -> V_169 . V_192 = V_2 -> V_193 + V_195 ;
V_78 = ! F_56 ( V_187 , L_9 , V_189 , 4 ) ;
if ( V_2 -> V_47 && ! V_78 && V_189 [ 2 ] == V_196 ) {
V_2 -> V_70 = true ;
V_2 -> V_167 . V_191 &= ~ 0x1 ;
V_2 -> V_169 . V_191 &= ~ 0x1 ;
}
if ( ! V_2 -> V_47 ) {
V_2 -> V_197 . V_7 = V_2 -> V_7 ;
V_2 -> V_197 . V_198 = V_185 ;
V_2 -> V_197 . V_169 =
& V_2 -> V_169 ;
V_2 -> V_197 . V_167 =
& V_2 -> V_167 ;
V_78 = F_57 ( V_117 , & V_2 -> V_197 ) ;
if ( V_78 )
goto V_199;
} else {
V_78 = F_58 ( V_117 ) ;
...
static void F_59 ( struct V_184 * V_117 ,
struct V_1 * V_2 )
{
if ( ! V_2 -> V_47 )
F_60 ( V_117 ) ;
...
static int F_61 ( struct V_184 * V_117 )
{
struct V_1 * V_2 ;
int V_78 = 0 ;
struct V_186 * V_187 = V_117 -> V_99 . V_188 ;
const struct V_200 * V_201 ;
const char * V_182 , * V_202 ;
const T_7 * V_203 ;
struct V_204 V_205 ;
void T_6 * V_185 ;
char V_206 [ 64 ] ;
if ( ! F_62 ( V_187 ) )
return - V_207 ;
V_201 = F_63 ( V_208 , & V_117 -> V_99 ) ;
if ( ! V_201 || ! V_201 -> V_209 )
return - V_96 ;
V_2 = F_64 ( & V_117 -> V_99 , sizeof( * V_2 ) ,
V_210 ) ;
if ( ! V_2 ) {
F_29 ( & V_117 -> V_99 , L_10 ) ;
return - V_211 ;
}
V_2 -> V_14 = V_201 -> V_209 ;
V_202 = F_65 ( V_187 , L_11 , NULL ) ;
if ( V_202 ) {
if ( ! strcmp ( V_202 , L_12 ) )
V_2 -> V_3 = V_4 ;
else if ( ! strcmp ( V_202 , L_13 ) )
V_2 -> V_3 = V_128 |
V_131 ;
}
V_2 -> V_47 = ! F_66 ( V_187 ,
L_14 ) ;
if ( F_1 ( V_2 ) ) {
memcpy ( & V_2 -> V_76 , & V_212 ,
sizeof( V_212 ) ) ;
V_172 = V_2 ;
F_67 ( & V_213 , V_117 ) ;
} else {
memcpy ( & V_2 -> V_76 , & V_214 ,
sizeof( V_214 ) ) ;
}
V_2 -> V_76 . V_206 = F_68 ( & V_117 -> V_99 ) ;
V_78 = F_69 ( V_187 , 0 , & V_205 ) ;
if ( V_78 ) {
F_29 ( & V_117 -> V_99 , L_15 ) ;
return V_78 ;
}
V_2 -> V_193 = V_205 . V_215 ;
V_185 = F_70 ( & V_117 -> V_99 , V_205 . V_215 , F_71 ( & V_205 ) ) ;
if ( ! V_185 ) {
F_29 ( & V_117 -> V_99 , L_16 ) ;
return - V_211 ;
}
V_2 -> V_10 = F_72 ( & V_117 -> V_99 , V_185 ,
& V_216 ) ;
if ( F_24 ( V_2 -> V_10 ) ) {
F_29 ( & V_117 -> V_99 , L_17 ) ;
return F_54 ( V_2 -> V_10 ) ;
}
V_2 -> V_7 = F_73 ( V_187 , 0 ) ;
if ( ! V_2 -> V_7 ) {
F_29 ( & V_117 -> V_99 , L_18 , V_187 -> V_217 ) ;
return - V_218 ;
}
if ( ! F_74 ( V_187 , L_19 , NULL ) ) {
V_2 -> V_76 . V_77 = 1 ;
V_2 -> V_76 . V_219 = 1 ;
V_2 -> V_76 . V_220 = 1 ;
}
V_203 = F_65 ( V_187 , L_20 , NULL ) ;
if ( V_203 )
V_2 -> V_144 = F_75 ( V_203 ) ;
else
V_2 -> V_144 = 8 ;
F_76 ( & V_117 -> V_99 , V_2 ) ;
if ( V_2 -> V_14 -> V_165 ) {
V_78 = F_52 ( V_117 , V_2 , V_185 ) ;
if ( V_78 )
goto V_221;
}
V_78 = F_77 ( & V_117 -> V_99 , & V_222 ,
& V_2 -> V_76 , 1 ) ;
if ( V_78 ) {
F_29 ( & V_117 -> V_99 , L_21 , V_78 ) ;
goto V_223;
}
if ( V_2 -> V_47 ) {
V_78 = F_78 ( & V_117 -> V_99 , V_2 -> V_7 ,
F_3 , 0 , F_68 ( & V_117 -> V_99 ) ,
V_2 ) ;
if ( V_78 < 0 ) {
F_29 ( & V_117 -> V_99 , L_22 ,
V_2 -> V_7 ) ;
goto V_224;
}
}
V_78 = F_79 ( & V_2 -> V_16 , & V_117 -> V_99 ) ;
if ( V_78 )
goto V_223;
if ( ! F_65 ( V_187 , L_23 , NULL ) )
goto V_225;
V_202 = F_65 ( F_80 ( L_24 ) , L_25 , NULL ) ;
V_182 = strrchr ( V_202 , ',' ) ;
if ( V_182 )
V_202 = V_182 + 1 ;
snprintf ( V_206 , sizeof( V_206 ) , L_26 , V_202 ) ;
F_51 ( V_206 ) ;
V_2 -> V_117 =
F_81 ( & V_117 -> V_99 , V_206 , 0 , NULL , 0 ) ;
if ( F_24 ( V_2 -> V_117 ) ) {
V_78 = F_54 ( V_2 -> V_117 ) ;
F_29 ( & V_117 -> V_99 , L_27 , V_78 ) ;
goto V_226;
}
V_225:
if ( V_2 -> V_3 )
...
static int F_85 ( struct V_184 * V_117 )
{
struct V_1 * V_2 = F_86 ( & V_117 -> V_99 ) ;
F_82 ( & V_2 -> V_16 ) ;
if ( V_2 -> V_117 )
F_87 ( V_2 -> V_117 ) ;
F_83 ( & V_117 -> V_99 ) ;
