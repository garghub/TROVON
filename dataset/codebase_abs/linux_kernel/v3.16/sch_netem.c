...
static int F_65 ( struct V_56 * V_57 , const struct V_110 * V_111 )
{
struct V_16 * V_17 = F_19 ( V_57 ) ;
T_5 V_112 = F_66 ( V_111 ) / sizeof( V_113 ) ;
const V_113 * V_9 = F_67 ( V_111 ) ;
T_6 * V_114 ;
struct V_40 * V_109 ;
int V_115 ;
T_5 V_116 ;
...
V_114 = F_70 ( V_57 ) ;
F_71 ( V_114 ) ;
F_72 ( V_17 -> V_95 , V_109 ) ;
F_73 ( V_114 ) ;
F_63 ( V_109 ) ;
return 0 ;
}
static void F_74 ( struct V_16 * V_17 , const struct V_110 * V_111 )
{
...
static void F_75 ( struct V_16 * V_17 , const struct V_110 * V_111 )
{
...
if ( V_17 -> V_50 )
V_17 -> V_52 = F_78 ( V_17 -> V_50 ) ;
else
V_17 -> V_52 = (struct F_78 ) { 0 } ;
}
static int F_79 ( struct V_16 * V_17 , const struct V_110 * V_111 )
{
...
{
int V_154 = F_66 ( V_151 ) - F_84 ( V_47 ) ;
if ( V_154 < 0 ) {
F_82 ( L_4 , V_154 ) ;
return - V_118 ;
}
if ( V_154 >= F_85 ( 0 ) )
return F_86 ( V_149 , V_150 , F_67 ( V_151 ) + F_84 ( V_47 ) ,
V_154 , V_153 ) ;
memset ( V_149 , 0 , sizeof( struct V_110 * ) * ( V_150 + 1 ) ) ;
return 0 ;
}
static int F_87 ( struct V_56 * V_57 , struct V_110 * V_155 )
{
struct V_16 * V_17 = F_19 ( V_57 ) ;
...
V_17 -> V_90 = ~ 0 ;
if ( V_149 [ V_165 ] )
F_74 ( V_17 , V_149 [ V_165 ] ) ;
if ( V_149 [ V_166 ] )
F_75 ( V_17 , V_149 [ V_166 ] ) ;
if ( V_149 [ V_167 ] )
F_76 ( V_17 , V_149 [ V_167 ] ) ;
if ( V_149 [ V_168 ] )
F_77 ( V_17 , V_149 [ V_168 ] ) ;
if ( V_149 [ V_169 ] )
V_17 -> V_55 = F_44 ( T_2 , V_17 -> V_55 ,
F_88 ( V_149 [ V_169 ] ) ) ;
if ( V_149 [ V_170 ] )
V_17 -> V_72 = F_89 ( V_149 [ V_170 ] ) ;
return V_161 ;
}
static int F_90 ( struct V_56 * V_57 , struct V_110 * V_155 )
{
struct V_16 * V_17 = F_19 ( V_57 ) ;
int V_161 ;
if ( ! V_155 )
return - V_118 ;
F_91 ( & V_17 -> V_108 , V_57 ) ;
V_17 -> V_32 = V_33 ;
V_161 = F_87 ( V_57 , V_155 ) ;
if ( V_161 )
F_82 ( L_5 ) ;
return V_161 ;
}
...
if ( F_97 ( V_3 , V_136 , sizeof( V_138 ) , & V_138 ) )
goto V_172;
break;
}
case V_37 : {
...
if ( F_97 ( V_3 , V_144 , sizeof( V_146 ) , & V_146 ) )
goto V_172;
break;
}
}
...
static int F_99 ( struct V_56 * V_57 , struct V_2 * V_3 )
{
const struct V_16 * V_17 = F_19 ( V_57 ) ;
struct V_110 * V_151 = (struct V_110 * ) F_100 ( V_3 ) ;
struct V_157 V_158 ;
struct V_123 V_173 ;
struct V_128 V_90 ;
struct V_132 V_82 ;
...
V_55 . V_50 = V_17 -> V_50 ;
V_55 . V_53 = V_17 -> V_53 ;
if ( F_97 ( V_3 , V_168 , sizeof( V_55 ) , & V_55 ) )
goto V_172;
if ( V_17 -> V_72 && F_102 ( V_3 , V_170 , V_17 -> V_72 ) )
goto V_172;
if ( F_94 ( V_17 , V_3 ) != 0 )
goto V_172;
return F_98 ( V_3 , V_151 ) ;
V_172:
F_103 ( V_3 , V_151 ) ;
return - 1 ;
}
static int F_104 ( struct V_56 * V_57 , unsigned long V_175 ,
...
static int F_106 ( struct V_56 * V_57 , unsigned long V_182 , struct V_56 * V_183 ,
struct V_56 * * V_184 )
{
struct V_16 * V_17 = F_19 ( V_57 ) ;
F_107 ( V_57 ) ;
...
static struct V_56 * F_109 ( struct V_56 * V_57 , unsigned long V_182 )
{
struct V_16 * V_17 = F_19 ( V_57 ) ;
return V_17 -> V_98 ;
}
static unsigned long F_110 ( struct V_56 * V_57 , T_1 V_185 )
{
return 1 ;
}
static void F_111 ( struct V_56 * V_57 , unsigned long V_182 )
{
}
static void F_112 ( struct V_56 * V_57 , struct V_186 * V_187 )
{
if ( ! V_187 -> V_188 ) {
