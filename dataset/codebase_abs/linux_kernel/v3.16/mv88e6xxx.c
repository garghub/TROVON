...
int F_9 ( struct V_1 * V_2 , int V_3 , int V_7 ,
int V_8 , T_1 V_16 )
{
int V_4 ;
if ( V_3 == 0 )
...
int F_10 ( struct V_9 * V_10 , int V_7 , int V_8 , T_1 V_16 )
{
struct V_11 * V_12 = F_6 ( V_10 ) ;
int V_4 ;
F_7 ( & V_12 -> V_13 ) ;
...
{
F_12 ( V_17 , 0x10 , 0x0000 ) ;
F_12 ( V_17 , 0x11 , 0x0000 ) ;
F_12 ( V_17 , 0x12 , 0x5555 ) ;
F_12 ( V_17 , 0x13 , 0x5555 ) ;
F_12 ( V_17 , 0x14 , 0xaaaa ) ;
F_12 ( V_17 , 0x15 , 0xaaaa ) ;
F_12 ( V_17 , 0x16 , 0xffff ) ;
F_12 ( V_17 , 0x17 , 0xffff ) ;
F_12 ( V_17 , 0x18 , 0xfa41 ) ;
return 0 ;
}
int F_13 ( struct V_9 * V_10 , T_2 * V_7 )
{
F_12 ( V_17 , 0x01 , ( V_7 [ 0 ] << 8 ) | V_7 [ 1 ] ) ;
F_12 ( V_17 , 0x02 , ( V_7 [ 2 ] << 8 ) | V_7 [ 3 ] ) ;
F_12 ( V_17 , 0x03 , ( V_7 [ 4 ] << 8 ) | V_7 [ 5 ] ) ;
return 0 ;
}
int F_14 ( struct V_9 * V_10 , T_2 * V_7 )
{
int V_5 ;
int V_4 ;
for ( V_5 = 0 ; V_5 < 6 ; V_5 ++ ) {
int V_18 ;
F_12 ( V_19 , 0x0d , 0x8000 | ( V_5 << 8 ) | V_7 [ V_5 ] ) ;
...
int F_16 ( struct V_9 * V_10 , int V_7 , int V_20 )
{
if ( V_7 >= 0 )
return F_5 ( V_10 , V_7 , V_20 ) ;
return 0xffff ;
}
int F_17 ( struct V_9 * V_10 , int V_7 , int V_20 , T_1 V_16 )
{
if ( V_7 >= 0 )
return F_10 ( V_10 , V_7 , V_20 , V_16 ) ;
return 0 ;
}
...
unsigned long V_21 ;
V_4 = F_15 ( V_17 , 0x04 ) ;
F_12 ( V_17 , 0x04 , V_4 & ~ 0x4000 ) ;
V_21 = V_22 + 1 * V_23 ;
while ( F_19 ( V_22 , V_21 ) ) {
V_4 = F_15 ( V_17 , 0x00 ) ;
F_20 ( 1000 , 2000 ) ;
...
{
struct V_11 * V_12 ;
V_12 = F_23 ( V_25 , struct V_11 , V_26 ) ;
if ( F_24 ( & V_12 -> V_27 ) ) {
...
static void F_25 ( unsigned long V_29 )
{
...
int F_36 ( struct V_9 * V_10 , int V_7 , int V_20 )
{
int V_4 ;
V_4 = F_27 ( V_10 ) ;
if ( V_4 >= 0 ) {
...
int F_37 ( struct V_9 * V_10 , int V_7 ,
int V_20 , T_1 V_16 )
{
int V_4 ;
V_4 = F_27 ( V_10 ) ;
if ( V_4 >= 0 ) {
V_4 = F_10 ( V_10 , V_7 , V_20 , V_16 ) ;
F_29 ( V_10 ) ;
}
return V_4 ;
}
...
static int F_45 ( struct V_9 * V_10 , int V_45 )
{
int V_4 ;
F_12 ( V_17 , 0x1d , 0xdc00 | V_45 ) ;
V_4 = F_44 ( V_10 ) ;
if ( V_4 < 0 )
return V_4 ;
return 0 ;
}
static void F_46 ( struct V_9 * V_10 , int V_46 , T_3 * V_16 )
{
T_3 V_47 ;
int V_4 ;
* V_16 = 0 ;
V_4 = F_10 ( V_10 , V_17 , 0x1d , 0xcc00 | V_46 ) ;
if ( V_4 < 0 )
return;
V_4 = F_44 ( V_10 ) ;
if ( V_4 < 0 )
...
T_3 V_54 ;
T_3 V_55 ;
F_46 ( V_10 , V_53 -> V_8 , & V_54 ) ;
if ( V_53 -> V_56 == 8 )
F_46 ( V_10 , V_53 -> V_8 + 1 , & V_55 ) ;
else
V_55 = 0 ;
