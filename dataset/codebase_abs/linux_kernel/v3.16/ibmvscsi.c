...
F_95 ( struct V_84 , V_109 ) +
F_95 ( struct V_110 , V_113 ) ) ;
}
...
static void F_97 ( struct V_62 * V_76 )
{
struct V_3 * V_4 = V_76 -> V_4 ;
switch ( V_76 -> V_65 -> V_125 . F_97 . V_128 ) {
case V_173 :
break;
case V_174 :
F_28 ( V_4 -> V_5 , L_29 ,
...
V_4 -> V_177 = 0 ;
F_45 ( & V_4 -> V_130 ,
F_90 ( V_76 -> V_65 -> V_125 . F_97 . V_178 ) ) ;
F_98 ( V_4 -> V_118 ) ;
}
...
static void F_104 ( struct V_62 * V_76 )
{
struct V_3 * V_4 = V_76 -> V_4 ;
T_6 V_153 = F_105 ( V_76 -> V_65 -> V_187 . V_213 . V_189 . V_153 ) ;
if ( V_153 == V_214 )
F_39 ( V_4 -> V_5 , L_39 ) ;
else if ( V_153 == V_215 )
F_39 ( V_4 -> V_5 , L_40 ) ;
...
static void F_107 ( struct V_62 * V_76 )
{
struct V_3 * V_4 = V_76 -> V_4 ;
...
static void F_110 ( struct V_62 * V_76 )
{
if ( V_76 -> V_81 )
* V_76 -> V_81 = * V_76 -> V_65 ;
F_111 ( & V_76 -> V_226 ) ;
}
static int F_112 ( struct V_82 * V_83 )
{
...
F_14 ( V_4 -> V_118 -> V_119 , V_23 ) ;
F_117 (tmp_evt, pos, &hostdata->sent, list) {
...
static int F_118 ( struct V_82 * V_83 )
{
unsigned long V_232 = 0 ;
struct V_3 * V_4 = F_94 ( V_83 -> V_95 -> V_118 ) ;
F_39 ( V_4 -> V_5 , L_61 ) ;
...
if ( V_22 -> V_77 == V_137 )
F_119 ( F_90 ( V_76 -> V_65 -> V_125 . V_143 . V_178 ) ,
& V_4 -> V_130 ) ;
F_75 ( & V_76 -> V_122 ) ;
...
static int F_121 ( struct V_161 * V_257 )
{
...
if ( V_257 -> type == V_261 ) {
V_257 -> V_262 = 1 ;
F_122 ( V_257 -> V_263 , 120 * V_147 ) ;
}
F_16 ( V_259 -> V_119 , V_260 ) ;
F_123 ( V_257 , 0 , V_259 -> V_264 ) ;
return 0 ;
}
static int F_124 ( struct V_161 * V_257 , int V_265 ,
int V_176 )
{
if ( V_176 != V_266 )
return - V_267 ;
...
{
struct V_258 * V_259 = F_126 ( V_5 ) ;
struct V_3 * V_4 = F_94 ( V_259 ) ;
int V_106 ;
V_106 = snprintf ( V_272 , sizeof( V_4 -> V_171 . V_204 ) , L_74 ,
V_4 -> V_171 . V_204 ) ;
return V_106 ;
}
...
struct V_3 * V_4 = F_94 ( V_259 ) ;
int V_106 ;
V_106 = snprintf ( V_272 , sizeof( V_4 -> V_171 . V_202 ) , L_74 ,
V_4 -> V_171 . V_202 ) ;
return V_106 ;
}
...
static int F_139 ( void * V_30 )
{
struct V_3 * V_4 = V_30 ;
int V_11 ;
F_140 ( V_278 , V_279 ) ;
while ( 1 ) {
V_11 = F_141 ( V_4 -> V_133 ,
F_137 ( V_4 ) ) ;
F_100 ( V_11 ) ;
if ( F_138 () )
break;
...
static int F_142 ( struct V_12 * V_13 , const struct V_280 * V_162 )
{
struct V_3 * V_4 ;
struct V_258 * V_118 ;
...
V_4 -> V_290 = F_148 ( F_139 , V_4 , L_81 ,
L_8 , V_118 -> V_291 ) ;
if ( F_149 ( V_4 -> V_290 ) ) {
F_39 ( & V_13 -> V_5 , L_82 ,
F_150 ( V_4 -> V_290 ) ) ;
...
V_11 = F_32 ( & V_4 -> V_9 , V_4 , V_274 ) ;
if ( V_11 != 0 && V_11 != V_49 ) {
F_39 ( & V_13 -> V_5 , L_83 , V_11 ) ;
goto V_293;
}
if ( F_41 ( & V_4 -> V_55 , V_274 , V_4 ) != 0 ) {
F_39 ( & V_13 -> V_5 , L_84 ) ;
goto V_294;
}
V_118 -> V_295 = 8 ;
...
V_118 -> V_297 = V_297 ;
V_118 -> V_298 = 16 ;
if ( F_151 ( V_4 -> V_118 , V_4 -> V_5 ) )
goto V_299;
memcpy ( V_282 . V_300 , V_4 -> V_38 . V_36 ,
sizeof( V_282 . V_300 ) ) ;
V_282 . V_301 = V_302 ;
V_284 = F_152 ( V_118 , & V_282 ) ;
if ( F_149 ( V_284 ) )
goto V_303;
...
static int F_160 ( struct V_95 * V_5 )
{
