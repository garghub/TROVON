...
struct V_63 * V_69 = & V_6 -> V_8 ;
signal ( V_70 , F_40 ) ;
if ( V_6 -> V_71 || V_6 -> V_72 ) {
V_6 -> V_2 . V_73 = F_10 ;
V_6 -> V_2 . V_74 = F_12 ;
V_6 -> V_2 . V_75 = F_14 ;
V_6 -> V_2 . V_76 = F_16 ;
}
T_2 = F_44 ( & V_64 , true , & V_6 -> V_2 ) ;
if ( T_2 == NULL )
return - V_77 ;
if ( V_6 -> V_71 ) {
V_6 -> V_2 . T_3 = F_24 ;
...
struct V_20 * V_21 ;
V_6 -> V_2 . V_78 = true ;
F_45 (session->evlist, evsel) {
const char * V_61 = F_42 ( V_21 ) ;
if ( ! strcmp ( V_61 , L_9 ) ) {
if ( F_41 ( V_21 , V_79 , L_10 ) )
return - V_62 ;
V_21 -> V_22 = F_33 ;
...
if ( ! V_69 -> V_17 )
F_46 ( V_69 -> V_80 , T_2 -> V_9 . V_81 , V_82 ) ;
V_16 = F_47 ( T_2 , & V_6 -> V_2 ) ;
if ( ! V_69 -> V_17 ) {
T_2 -> V_9 . V_83 = V_6 -> V_11 ;
F_48 ( T_2 , T_2 -> V_84 , V_69 -> V_80 , true ) ;
}
F_49 ( T_2 ) ;
return V_16 ;
}
int F_50 ( int V_85 , const char * * V_86 , const char * T_10 V_13 )
{
struct V_5 V_6 = {
. V_2 = {
. T_3 = F_8 ,
...
F_52 ( 'b' , L_14 , & V_6 . V_71 ,
L_15 ) ,
F_53 ( 'i' , L_16 , & V_6 . V_66 , L_17 ,
L_18 ) ,
F_53 ( 'o' , L_19 , & V_6 . V_8 . V_65 , L_17 ,
L_20 ) ,
F_52 ( 's' , L_21 , & V_6 . V_72 ,
L_22
L_23 ) ,
F_54 ( 'v' , L_24 , & V_96 ,
L_25 ) ,
...
V_85 = F_56 ( V_85 , V_86 , V_95 , V_97 , 0 ) ;
if ( V_85 )
F_57 ( V_97 , V_95 ) ;
if ( F_58 ( & V_6 . V_8 ) ) {
perror ( L_27 ) ;
