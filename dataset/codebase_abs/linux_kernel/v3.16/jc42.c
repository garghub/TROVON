static T_1 F_1 ( int V_1 , bool V_2 )
{
int V_3 = F_2 ( V_1 ,
V_2 ? V_4 :
V_5 , V_6 ) ;
...
int V_15 , V_16 ;
F_6 ( & V_11 -> V_17 ) ;
if ( F_7 ( V_18 , V_11 -> V_19 + V_20 ) || ! V_11 -> V_21 ) {
for ( V_15 = 0 ; V_15 < V_22 ; V_15 ++ ) {
V_16 = F_8 ( V_13 , V_23 [ V_15 ] ) ;
if ( V_16 < 0 ) {
V_14 = F_9 ( V_16 ) ;
goto abort;
}
...
static T_3 F_11 ( struct V_9 * V_10 , struct V_24 * V_25 ,
char * V_26 )
{
struct V_27 * V_28 = F_12 ( V_25 ) ;
...
static T_3 F_15 ( struct V_9 * V_10 ,
...
static T_3 F_16 ( struct V_9 * V_10 , struct V_24 * V_25 ,
...
int V_37 = V_28 -> V_29 ;
long V_16 ;
if ( F_17 ( V_26 , 10 , & V_16 ) < 0 )
return - V_38 ;
F_6 ( & V_11 -> V_17 ) ;
V_11 -> V_1 [ V_37 ] = F_1 ( V_16 , V_11 -> V_2 ) ;
V_36 = F_18 ( V_11 -> V_13 , V_23 [ V_37 ] ,
V_11 -> V_1 [ V_37 ] ) ;
if ( V_36 < 0 )
V_14 = V_36 ;
F_10 ( & V_11 -> V_17 ) ;
...
static T_3 F_19 ( struct V_9 * V_10 ,
struct V_24 * V_28 ,
const char * V_26 , T_4 V_35 )
{
struct V_8 * V_11 = F_5 ( V_10 ) ;
