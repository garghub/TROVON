...
{
F_53 ( V_71 , V_52 , V_45 ) ;
const T_7 V_72 = F_54 ( V_53 , V_44 ) ;
struct V_7 * V_8 ;
const struct V_55 * V_29 ;
unsigned int V_56 = F_1 ( V_1 , V_45 , V_44 , V_52 , V_53 ) ;
unsigned int V_73 = V_56 & V_32 -> V_74 ;
struct V_75 * V_19 = & V_32 -> V_76 [ V_73 ] ;
F_39 () ;
V_64:
F_40 (sk, node, &head->chain) {
if ( V_8 -> V_77 != V_56 )
continue;
if ( F_55 ( F_56 ( V_8 , V_1 , V_71 ,
V_52 , V_45 , V_72 , V_46 ) ) ) {
if ( F_43 ( ! F_44 ( & V_8 -> V_68 ) ) )
goto V_78;
if ( F_43 ( ! F_56 ( V_8 , V_1 , V_71 ,
V_52 , V_45 , V_72 , V_46 ) ) ) {
F_47 ( V_8 ) ;
goto V_64;
}
...
int V_46 = V_8 -> V_51 ;
F_53 ( V_71 , V_52 , V_45 ) ;
const T_7 V_72 = F_54 ( V_10 -> V_14 , V_3 ) ;
struct V_1 * V_1 = F_7 ( V_8 ) ;
unsigned int V_56 = F_1 ( V_1 , V_45 , V_3 ,
V_52 , V_10 -> V_14 ) ;
struct V_75 * V_19 = V_75 ( V_84 , V_56 ) ;
...
F_62 ( ! F_63 ( V_8 ) ) ;
V_8 -> V_77 = F_5 ( V_8 ) ;
V_19 = V_75 ( V_32 , V_8 -> V_77 ) ;
V_93 = & V_19 -> V_30 ;
V_39 = F_58 ( V_32 , V_8 -> V_77 ) ;
F_26 ( V_39 ) ;
F_64 ( V_8 , V_93 ) ;
if ( V_86 ) {
F_62 ( V_8 -> V_77 != V_86 -> V_94 ) ;
V_87 = F_65 ( V_86 ) ;
}
F_28 ( V_39 ) ;
F_68 ( F_7 ( V_8 ) , V_8 -> V_33 , 1 ) ;
