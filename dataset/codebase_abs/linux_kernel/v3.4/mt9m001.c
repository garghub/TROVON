...
static int F_15 ( struct V_18 * V_19 , struct V_22 * V_23 )
{
struct V_8 * V_9 = F_14 ( V_19 ) ;
...
static int F_30 ( struct V_97 * V_98 ,
struct V_8 * V_9 )
{
struct V_7 * V_7 = F_2 ( V_9 ) ;
T_3 V_12 ;
...
static void F_34 ( struct V_97 * V_98 )
{
if ( V_98 -> V_108 )
V_98 -> V_108 ( V_98 ) ;
}
static int F_35 ( struct V_18 * V_19 , T_4 * V_109 )
{
struct V_8 * V_9 = F_14 ( V_19 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
* V_109 = V_7 -> V_42 ;
...
static int F_36 ( struct V_18 * V_19 , unsigned int V_110 ,
enum V_2 * V_3 )
{
struct V_8 * V_9 = F_14 ( V_19 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
...
{
struct V_8 * V_9 = F_14 ( V_19 ) ;
struct V_97 * V_98 = F_38 ( V_9 ) ;
V_112 -> V_99 = V_113 |
V_114 | V_115 |
V_116 | V_117 ;
V_112 -> type = V_118 ;
V_112 -> V_99 = F_39 ( V_98 , V_112 ) ;
return 0 ;
}
...
struct V_97 * V_98 = F_38 ( V_9 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
unsigned int V_119 = F_41 ( V_7 -> V_4 -> V_3 ) -> V_120 ;
if ( V_98 -> V_121 )
...
{
struct V_7 * V_7 ;
struct V_124 * V_125 = F_43 ( V_9 -> V_14 . V_126 ) ;
struct V_97 * V_98 = F_38 ( V_9 ) ;
int V_13 ;
if ( ! V_98 ) {
F_31 ( & V_9 -> V_14 , L_11 ) ;
...
V_7 = F_46 ( sizeof( struct V_7 ) , V_128 ) ;
if ( ! V_7 )
return - V_129 ;
F_47 ( & V_7 -> V_10 , V_9 , & V_130 ) ;
F_48 ( & V_7 -> V_81 , 4 ) ;
F_49 ( & V_7 -> V_81 , & V_131 ,
V_88 , 0 , 1 , 1 , 0 ) ;
F_49 ( & V_7 -> V_81 , & V_131 ,
V_90 , 0 , 127 , 1 , 64 ) ;
V_7 -> V_85 = F_49 ( & V_7 -> V_81 , & V_131 ,
V_132 , 1 , 255 , 1 , 255 ) ;
V_7 -> V_49 = F_50 ( & V_7 -> V_81 ,
& V_131 , V_84 , 1 , 0 ,
V_50 ) ;
