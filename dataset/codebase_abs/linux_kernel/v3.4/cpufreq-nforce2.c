...
F_11 (KERN_ERR PFX L_1 , fsb) ;
return - V_24 ;
}
V_20 = F_6 ( 0 ) ;
if ( ! V_20 ) {
F_11 (KERN_ERR PFX L_2 ) ;
return - V_24 ;
}
F_9 ( V_9 , V_18 , ( V_19 * ) & V_8 ) ;
if ( ! V_8 ) {
...
{
unsigned int V_41 ;
V_41 = V_29 -> V_35 / ( V_27 * 100 ) ;
if ( V_29 -> V_36 < ( V_41 * V_27 * 100 ) )
V_29 -> V_35 = ( V_41 + 1 ) * V_27 * 100 ;
F_20 ( V_29 ,
V_29 -> V_42 . V_43 ,
V_29 -> V_42 . V_44 ) ;
return 0 ;
...
if ( V_25 < V_23 )
V_25 = V_23 ;
V_29 -> V_42 . V_43 = V_25 * V_27 * 100 ;
V_29 -> V_42 . V_44 = V_22 * V_27 * 100 ;
V_29 -> V_42 . V_50 = V_51 ;
V_29 -> V_52 = F_15 ( V_29 -> V_26 ) ;
V_29 -> V_36 = V_29 -> V_42 . V_43 ;
V_29 -> V_35 = V_29 -> V_42 . V_44 ;
return 0 ;
}
