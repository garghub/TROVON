...
V_2 -> V_62 . V_291 = V_287 ;
return 0 ;
}
static int F_38 ( struct V_295 * V_296 , unsigned int V_297 )
{
...
static int F_39 ( struct V_327 * V_328 ,
struct V_329 * V_330 ,
struct V_295 * V_296 )
{
struct V_1 * V_2 = V_296 -> V_2 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
int V_331 , V_12 , V_280 , V_9 ;
int V_332 = 0 ;
int V_333 = 0 ;
int V_334 = 0 ;
...
V_5 -> V_280 [ V_296 -> V_37 ] = V_280 ;
V_5 -> V_28 [ V_296 -> V_37 ] = F_41 ( V_330 ) ;
V_331 = F_42 ( F_43 ( V_330 ) ) ;
if ( V_331 < 0 )
return V_331 ;
V_332 |= ( V_331 << V_343 ) | V_331 ;
V_9 = 0 ;
for ( V_12 = 0 ; V_12 < F_5 ( V_344 ) ; V_12 ++ ) {
if ( abs ( V_344 [ V_12 ] - F_41 ( V_330 ) ) <
abs ( V_344 [ V_9 ] - F_41 ( V_330 ) ) )
V_9 = V_12 ;
}
V_334 |= V_12 << V_337 ;
F_32 ( V_2 ) ;
V_333 = V_280 / F_41 ( V_330 ) ;
F_4 ( V_296 -> V_29 , L_13 ,
V_333 , V_280 / V_333 ) ;
F_6 ( V_2 , V_335 ,
V_345 |
...
static int F_44 ( struct V_295 * V_296 ,
...
int V_356 ;
int V_357 ;
if ( V_350 == V_5 -> V_282 && V_349 == V_5 -> V_358 )
return 0 ;
...
static int F_46 ( struct V_369 * V_370 , unsigned int V_371 ,
unsigned int V_372 )
{
unsigned int V_373 ;
unsigned int div ;
...
static int F_50 ( struct V_1 * V_2 , int V_388 , int V_389 ,
...
unsigned long V_57 ;
int V_47 , V_88 , V_390 ;
if ( V_389 == V_5 -> V_391 && V_371 == V_5 -> V_392 &&
V_372 == V_5 -> V_393 )
return 0 ;
if ( V_372 == 0 ) {
F_4 ( V_2 -> V_29 , L_23 ) ;
...
V_88 |= V_370 . V_376 << V_399 ;
V_88 |= V_370 . V_378 << V_400 ;
F_6 ( V_2 , V_141 ,
V_401 | V_402 |
V_403 , V_88 ) ;
V_88 = 0 ;
...
( V_370 . V_379 << V_408 ) |
( V_370 . V_383 ) ) ;
F_20 ( V_2 , V_139 , V_370 . V_386 ) ;
F_6 ( V_2 , V_140 ,
V_409 | V_410 ,
( V_370 . V_385 << V_411 ) |
V_370 . V_377 ) ;
F_20 ( V_2 , V_143 , V_370 . V_387 ) ;
V_47 = F_3 ( V_2 , V_137 ) ;
if ( ! ( V_47 & V_394 ) )
F_11 ( V_2 ) ;
F_51 ( & V_5 -> V_412 ) ;
...
F_4 ( V_2 -> V_29 , L_26 , V_371 , V_372 ) ;
V_5 -> V_392 = V_371 ;
V_5 -> V_393 = V_372 ;
V_5 -> V_391 = V_389 ;
return V_47 ;
}
static inline struct V_4 * F_54 ( struct V_416 * V_417 )
{
return F_25 ( V_417 , struct V_4 , V_416 ) ;
}
static void F_55 ( struct V_416 * V_417 , unsigned V_418 , int V_38 )
{
struct V_4 * V_5 = F_54 ( V_417 ) ;
F_56 ( V_5 -> V_277 , V_259 + V_418 ,
V_419 , ! ! V_38 << V_420 ) ;
}
static int F_57 ( struct V_416 * V_417 ,
unsigned V_418 , int V_38 )
{
struct V_4 * V_5 = F_54 ( V_417 ) ;
int V_65 ;
V_65 = ( 1 << V_421 ) | ( ! ! V_38 << V_420 ) ;
return F_56 ( V_5 -> V_277 , V_259 + V_418 ,
V_340 | V_422 |
V_419 , V_65 ) ;
}
static int F_58 ( struct V_416 * V_417 , unsigned V_418 )
{
struct V_4 * V_5 = F_54 ( V_417 ) ;
unsigned int V_88 ;
int V_47 ;
V_47 = F_59 ( V_5 -> V_277 , V_259 + V_418 , & V_88 ) ;
if ( V_47 < 0 )
return V_47 ;
return ( V_88 & V_419 ) != 0 ;
}
static int F_60 ( struct V_416 * V_417 , unsigned V_418 )
{
struct V_4 * V_5 = F_54 ( V_417 ) ;
return F_56 ( V_5 -> V_277 , V_259 + V_418 ,
V_340 | V_422 ,
...
V_5 -> V_416 = V_424 ;
V_5 -> V_416 . V_425 = 5 ;
V_5 -> V_416 . V_29 = V_5 -> V_29 ;
if ( V_5 -> V_7 . V_426 )
V_5 -> V_416 . V_8 = V_5 -> V_7 . V_426 ;
else
V_5 -> V_416 . V_8 = - 1 ;
V_47 = F_62 ( & V_5 -> V_416 ) ;
if ( V_47 != 0 )
...
int F_65 ( struct V_1 * V_2 , struct V_427 * V_428 ,
T_2 V_429 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
V_5 -> V_428 = V_428 ;
...
F_4 ( V_2 -> V_29 , L_40 ) ;
F_68 ( V_5 -> V_428 , 0 , V_455 ) ;
}
return;
}
if ( V_5 -> V_430 && ( V_65 & 0x3f0 ) ) {
V_5 -> V_431 ++ ;
if ( V_5 -> V_431 > 1 ) {
F_72 ( V_2 ) ;
return;
...
static T_3 F_74 ( int V_59 , void * V_459 )
{
...
static T_3 F_76 ( int V_59 , void * V_459 )
{
T_3 V_47 = V_461 ;
T_3 V_65 ;
do {
V_65 = F_74 ( V_59 , V_459 ) ;
if ( V_65 != V_461 )
V_47 = V_65 ;
} while ( V_65 != V_461 );
return V_47 ;
...
F_4 ( V_2 -> V_29 , L_47 ,
V_5 -> V_15 ) ;
V_5 -> V_470 . V_382 = V_5 -> V_15 ;
V_5 -> V_470 . V_474 = V_5 -> V_26 ;
V_47 = F_80 ( V_2 , V_469 , F_5 ( V_469 ) ) ;
if ( V_47 != 0 )
F_23 ( V_2 -> V_29 ,
L_48 , V_47 ) ;
}
...
F_82 ( & V_5 -> V_412 ) ;
V_2 -> V_294 = V_5 -> V_277 ;
V_47 = F_83 ( V_2 , 16 , 16 , V_476 ) ;
if ( V_47 != 0 ) {
F_23 ( V_2 -> V_29 , L_49 , V_47 ) ;
goto V_477;
}
V_5 -> V_478 [ 0 ] . V_479 = V_480 ;
V_5 -> V_478 [ 1 ] . V_479 = V_481 ;
V_5 -> V_478 [ 2 ] . V_479 = V_482 ;
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_293 ) ; V_12 ++ ) {
V_47 = F_84 ( V_5 -> V_293 [ V_12 ] . V_483 ,
& V_5 -> V_478 [ V_12 ] ) ;
if ( V_47 != 0 ) {
F_23 ( V_2 -> V_29 ,
L_50 ,
...
V_5 -> V_7 . V_486 << V_487 |
V_5 -> V_7 . V_488 ) ;
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_7 . V_489 ) ; V_12 ++ ) {
if ( ! V_5 -> V_7 . V_489 [ V_12 ] )
continue;
F_20 ( V_2 , V_259 + V_12 ,
V_5 -> V_7 . V_489 [ V_12 ] & 0xffff ) ;
}
if ( V_5 -> V_7 . V_490 )
F_6 ( V_2 , V_274 ,
V_491 |
...
F_87 ( V_56 -> V_59 , V_2 ) ;
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_293 ) ; V_12 ++ )
F_88 ( V_5 -> V_293 [ V_12 ] . V_483 ,
& V_5 -> V_478 [ V_12 ] ) ;
F_89 ( F_5 ( V_5 -> V_293 ) , V_5 -> V_293 ) ;
return 0 ;
}
static T_4 int F_90 ( struct V_55 * V_56 ,
const struct V_552 * V_37 )
{
struct V_4 * V_5 ;
int V_47 , V_12 ;
unsigned int V_88 ;
V_5 = F_91 ( & V_56 -> V_29 , sizeof( struct V_4 ) ,
V_473 ) ;
if ( V_5 == NULL )
return - V_553 ;
F_92 ( V_56 , V_5 ) ;
V_5 -> V_29 = & V_56 -> V_29 ;
if ( F_93 ( & V_56 -> V_29 ) )
memcpy ( & V_5 -> V_7 , F_93 ( & V_56 -> V_29 ) ,
sizeof( V_5 -> V_7 ) ) ;
if ( V_5 -> V_7 . V_276 > 0 ) {
V_47 = F_94 ( V_5 -> V_7 . V_276 ,
V_554 , L_53 ) ;
if ( V_47 < 0 ) {
F_23 ( & V_56 -> V_29 , L_54 ,
V_5 -> V_7 . V_276 , V_47 ) ;
...
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_293 ) ; V_12 ++ )
V_5 -> V_293 [ V_12 ] . V_555 = V_556 [ V_12 ] ;
V_47 = F_95 ( & V_56 -> V_29 , F_5 ( V_5 -> V_293 ) ,
V_5 -> V_293 ) ;
if ( V_47 != 0 ) {
...
static T_5 int F_103 ( struct V_55 * V_565 )
{
struct V_4 * V_5 = F_104 ( V_565 ) ;
F_105 ( & V_565 -> V_29 ) ;
F_63 ( V_5 ) ;
F_101 ( V_5 -> V_277 ) ;
if ( V_5 -> V_7 . V_276 > 0 ) {
