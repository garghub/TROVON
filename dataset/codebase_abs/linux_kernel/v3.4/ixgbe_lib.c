...
int V_88 , V_89 ;
V_88 = V_80 + V_82 ;
V_89 = sizeof( struct V_84 ) +
( sizeof( struct V_74 ) * V_88 ) ;
if ( V_2 -> V_4 & V_32 ) {
if ( F_31 ( V_79 ) ) {
V_87 = V_79 ;
V_86 = F_32 ( V_87 ) ;
...
F_36 ( & V_85 -> V_92 , V_93 ) ;
V_85 -> V_94 = V_86 ;
F_37 ( V_2 -> V_16 , & V_85 -> V_95 ,
V_96 , 64 ) ;
V_2 -> V_85 [ V_79 ] = V_85 ;
V_85 -> V_2 = V_2 ;
V_85 -> V_79 = V_79 ;
V_85 -> V_12 . V_97 = V_2 -> V_98 ;
V_75 = V_85 -> V_75 ;
while ( V_80 ) {
...
F_38 ( V_101 , & V_75 -> V_102 ) ;
#ifdef F_10
if ( V_2 -> V_16 -> V_103 & V_104 ) {
struct V_33 * V_34 ;
V_34 = & V_2 -> V_35 [ V_36 ] ;
if ( ( V_83 >= V_34 -> V_40 ) &&
( V_83 < V_34 -> V_40 + V_34 -> V_41 ) )
F_38 ( V_105 , & V_75 -> V_102 ) ;
}
#endif
V_75 -> V_28 = V_2 -> V_106 ;
V_75 -> V_100 = V_83 ;
...
static void F_39 ( struct V_1 * V_2 , int V_79 )
{
struct V_84 * V_85 = V_2 -> V_85 [ V_79 ] ;
struct V_74 * V_75 ;
F_40 (ring, q_vector->tx)
V_2 -> V_10 [ V_75 -> V_100 ] = NULL ;
F_40 (ring, q_vector->rx)
V_2 -> V_7 [ V_75 -> V_100 ] = NULL ;
V_2 -> V_85 [ V_79 ] = NULL ;
F_41 ( & V_85 -> V_95 ) ;
F_42 ( V_85 , V_107 ) ;
}
...
{
int V_108 = V_2 -> V_71 - V_73 ;
int V_109 = V_2 -> V_6 ;
int V_110 = V_2 -> V_9 ;
int V_83 = 0 , V_81 = 0 , V_79 = 0 ;
int V_64 ;
if ( ! ( V_2 -> V_4 & V_70 ) )
V_108 = 1 ;
if ( V_108 >= ( V_109 + V_110 ) ) {
for (; V_109 ; V_79 ++ , V_108 -- ) {
int V_111 = F_44 ( V_109 , V_108 ) ;
V_64 = F_30 ( V_2 , V_79 ,
0 , 0 , V_111 , V_83 ) ;
if ( V_64 )
goto V_112;
...
for (; V_108 ; V_79 ++ , V_108 -- ) {
int V_111 = F_44 ( V_109 , V_108 ) ;
int V_113 = F_44 ( V_110 , V_108 ) ;
V_64 = F_30 ( V_2 , V_79 ,
V_113 , V_81 ,
V_111 , V_83 ) ;
if ( V_64 )
...
int V_64 = 0 ;
int V_115 , V_116 ;
V_116 = F_50 ( V_2 -> V_6 , V_2 -> V_9 ) ;
V_116 = F_14 ( int , V_116 , F_15 () ) ;
V_116 += V_73 ;
V_116 = F_14 ( int , V_116 , V_18 -> V_20 . V_117 ) ;
V_2 -> V_68 = F_51 ( V_116 ,
sizeof( struct V_118 ) , V_90 ) ;
if ( V_2 -> V_68 ) {
for ( V_115 = 0 ; V_115 < V_116 ; V_115 ++ )
V_2 -> V_68 [ V_115 ] . V_119 = V_115 ;
F_24 ( V_2 , V_116 ) ;
if ( V_2 -> V_4 & V_70 )
goto V_120;
}
...
void F_59 ( struct V_74 * V_10 , T_3 V_127 ,
T_3 V_128 , T_3 V_129 , T_3 V_130 )
{
struct V_131 * V_132 ;
T_2 V_3 = V_10 -> V_133 ;
V_132 = F_60 ( V_10 , V_3 ) ;
V_3 ++ ;
V_10 -> V_133 = ( V_3 < V_10 -> V_28 ) ? V_3 : 0 ;
V_129 |= V_134 | V_135 ;
V_132 -> V_127 = F_61 ( V_127 ) ;
V_132 -> V_136 = F_61 ( V_128 ) ;
V_132 -> V_137 = F_61 ( V_129 ) ;
V_132 -> V_130 = F_61 ( V_130 ) ;
}
