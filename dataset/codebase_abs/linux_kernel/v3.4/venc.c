...
static int F_51 ( struct V_128 * V_90 )
{
struct V_129 * V_129 ;
if ( F_52 ( V_130 ) ) {
V_129 = F_53 ( & V_90 -> V_91 , L_15 ) ;
if ( F_45 ( V_129 ) ) {
F_8 ( L_16 ) ;
return F_46 ( V_129 ) ;
}
...
static int F_56 ( struct V_128 * V_90 )
{
T_2 V_132 ;
struct V_133 * V_134 ;
int V_89 ;
...
F_57 ( & V_3 . V_112 ) ;
V_3 . V_30 = 0 ;
V_134 = F_58 ( V_3 . V_90 , V_135 , 0 ) ;
if ( ! V_134 ) {
F_8 ( L_17 ) ;
return - V_116 ;
}
V_3 . V_4 = F_59 ( & V_90 -> V_91 , V_134 -> V_136 ,
F_60 ( V_134 ) ) ;
if ( ! V_3 . V_4 ) {
F_8 ( L_18 ) ;
return - V_137 ;
...
if ( V_89 )
goto V_138;
V_132 = ( T_2 ) ( F_3 ( V_139 ) & 0xff ) ;
F_62 ( & V_90 -> V_91 , L_19 , V_132 ) ;
F_14 () ;
V_89 = F_63 ( & V_140 ) ;
if ( V_89 )
goto V_141;
...
static int F_65 ( struct V_128 * V_90 )
{
if ( V_3 . V_107 != NULL ) {
F_66 ( V_3 . V_107 ) ;
V_3 . V_107 = NULL ;
...
static int F_68 ( struct V_142 * V_91 )
{
if ( V_3 . V_131 )
F_69 ( V_3 . V_131 ) ;
F_70 () ;
...
static int F_72 ( struct V_142 * V_91 )
{
int V_89 ;
V_89 = F_73 () ;
if ( V_89 < 0 )
