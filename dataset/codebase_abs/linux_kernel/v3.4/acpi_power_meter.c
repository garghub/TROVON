...
struct V_63 V_108 = { sizeof( L_23 ) , L_23 } ;
union V_21 * V_66 ;
T_4 * V_106 ;
T_1 V_6 ;
...
static void F_52 ( struct V_17 * V_12 , T_6 V_114 )
{
struct V_3 * V_4 ;
int V_25 ;
if ( ! V_12 || ! F_53 ( V_12 ) )
...
break;
case V_116 :
F_54 ( & V_12 -> V_13 . V_62 , NULL , V_117 ) ;
F_18 ( V_4 ) ;
break;
case V_118 :
F_54 ( & V_12 -> V_13 . V_62 , NULL , V_119 ) ;
F_12 ( V_4 ) ;
break;
case V_120 :
F_54 ( & V_12 -> V_13 . V_62 , NULL , V_121 ) ;
F_2 ( V_4 ) ;
break;
case V_122 :
F_54 ( & V_12 -> V_13 . V_62 , NULL , V_123 ) ;
F_51 ( & V_12 -> V_13 , L_30 ) ;
break;
default:
F_23 () ;
...
V_4 -> V_7 = V_12 ;
F_58 ( & V_4 -> V_19 ) ;
strcpy ( F_59 ( V_12 ) , V_125 ) ;
strcpy ( F_60 ( V_12 ) , V_124 ) ;
V_12 -> V_18 = V_4 ;
F_48 ( V_4 ) ;
V_25 = F_49 ( V_4 ) ;
if ( V_25 )
...
static int F_66 ( struct V_17 * V_12 )
{
struct V_3 * V_4 ;
if ( ! V_12 || ! F_53 ( V_12 ) )
return - V_30 ;
...
static int T_7 F_67 ( const struct V_128 * V_129 )
{
V_2 = 1 ;
return 0 ;
}
