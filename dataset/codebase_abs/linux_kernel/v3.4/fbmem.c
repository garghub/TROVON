...
return - V_150 ;
if ( V_1 -> V_275 ) {
F_107 ( V_276 , F_99 ( V_278 , V_35 ) ) ;
V_1 -> V_275 = NULL ;
}
return 0 ;
}
void F_108 ( struct V_259 * V_265 ,
const char * V_266 , bool V_267 )
{
F_3 ( & V_5 ) ;
...
F_112 ( void )
{
F_113 ( L_13 , 0 , NULL , & V_292 ) ;
if ( F_114 ( V_278 , L_13 , & V_293 ) )
F_57 ( L_14 , V_278 ) ;
V_276 = F_115 ( V_294 , L_15 ) ;
if ( F_100 ( V_276 ) ) {
...
V_171 = F_122 ( V_117 , struct V_296 , V_297 ) ;
V_116 = & V_171 -> V_182 ;
F_123 ( & V_13 , V_116 ) ;
V_13 . V_156 = V_298 ;
...
int F_125 ( char * V_266 , char * * V_300 )
{
...
static int T_11 F_126 ( char * V_302 )
{
int V_35 , V_307 = 0 ;
if ( ! V_302 || ! * V_302 )
V_307 = 1 ;
