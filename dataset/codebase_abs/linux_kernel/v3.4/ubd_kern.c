...
static int F_93 ( struct V_147 * V_148 , T_7 V_97 )
{
...
else F_96 ( V_54 -> V_79 , V_54 -> V_60 , & V_54 -> V_157 ,
...
V_66 -> V_174 = 0 ;
V_66 -> V_172 = F_105 ( V_171 , V_54 , V_66 -> V_130 ) ;
}
V_54 = V_66 -> V_160 ;
...
static int F_112 ( struct V_147 * V_148 , T_7 V_97 ,
...
if( V_54 -> V_153 == - 1 )
return 0 ;
V_3 = F_42 ( V_54 -> V_165 [ 1 ] , V_54 -> V_153 ) ;
if( V_3 < 0 ) {
F_18 ( L_68 , - V_3 ) ;
return 1 ;
}
...
V_3 = F_110 ( V_54 -> V_165 [ V_1 ] , V_78 , V_80 ) ;
if( V_3 != V_80 ) {
F_18 ( L_73
L_72 , - V_3 , V_54 -> V_165 [ V_1 ] ) ;
V_54 -> error = 1 ;
