...
char V_73 = 0 ;
struct V_74 V_75 [] = {
{ V_72 -> V_76 , 0 , sizeof( V_70 ) , & V_70 } ,
{ V_72 -> V_76 , V_77 | V_78 , sizeof( V_73 ) , & V_73 }
} ;
int V_79 ;
V_79 = F_6 ( V_72 -> V_80 , V_75 , F_7 ( V_75 ) ) ;
if ( V_79 != F_7 ( V_75 ) )
F_8 ( 1 , V_81 , V_3 , L_1 ) ;
return V_73 ;
}
...
char V_83 [] = { V_70 , V_73 } ;
if ( F_10 ( V_72 , V_83 , sizeof( V_83 ) ) != sizeof( V_83 ) )
F_8 ( 1 , V_81 , V_3 , L_2 ) ;
V_82 -> V_84 [ V_70 ] = V_73 ;
}
static void F_11 ( struct V_2 * V_3 , T_1 V_70 , T_1 V_85 , T_1 V_86 )
{
struct V_1 * V_82 = F_1 ( V_3 ) ;
T_1 V_73 = V_82 -> V_84 [ V_70 ] ;
V_73 = ( V_73 & V_85 ) | V_86 ;
F_9 ( V_3 , V_70 , V_73 ) ;
}
...
F_8 ( 1 , V_81 , V_3 , L_3 ) ;
F_13 ( 1 ) ;
for ( V_87 = 1 ; V_87 < 33 ; V_87 ++ )
F_9 ( V_3 , V_87 , V_5 [ V_87 ] ) ;
for ( V_87 = 35 ; V_87 < 40 ; V_87 ++ )
F_9 ( V_3 , V_87 , V_5 [ V_87 ] ) ;
for ( V_87 = 41 ; V_87 < 56 ; V_87 ++ )
F_9 ( V_3 , V_87 , V_5 [ V_87 ] ) ;
for ( V_87 = 58 ; V_87 < 64 ; V_87 ++ )
F_9 ( V_3 , V_87 , V_5 [ V_87 ] ) ;
if ( ( F_4 ( V_3 , V_90 ) & 0x80 ) == 0 ) {
V_82 -> V_88 = V_91 ;
F_8 ( 1 , V_81 , V_3 , L_4 ) ;
return;
}
...
static int F_15 ( struct V_2 * V_3 , T_3 V_108 )
{
struct V_1 * V_82 = F_1 ( V_3 ) ;
...
static int F_17 ( struct V_2 * V_3 , int V_115 )
{
F_8 ( 1 , V_81 , V_3 , L_18 , V_115 ) ;
if ( V_115 ) {
...
static int F_18 ( struct V_2 * V_3 , T_2 * V_116 , T_3 * V_117 )
{
int V_118 = V_119 ;
T_1 V_120 ;
T_3 V_108 = V_121 ;
...
static int F_19 ( struct V_2 * V_3 , T_3 * V_108 )
{
F_8 ( 1 , V_81 , V_3 , L_19 ) ;
return F_18 ( V_3 , NULL , V_108 ) ;
}
static int F_20 ( struct V_2 * V_3 , T_2 * V_120 )
{
F_8 ( 1 , V_81 , V_3 , L_20 ) ;
return F_18 ( V_3 , V_120 , NULL ) ;
}
static int F_21 ( struct V_2 * V_3 , struct V_123 * V_124 )
{
struct V_71 * V_72 = F_5 ( V_3 ) ;
struct V_1 * V_82 = F_1 ( V_3 ) ;
return F_22 ( V_72 , V_124 , V_82 -> V_88 , 0 ) ;
}
static int F_23 ( struct V_71 * V_72 , const struct V_125 * V_126 )
{
struct V_1 * V_82 ;
struct V_2 * V_3 ;
F_24 ( V_72 , L_21 ,
V_72 -> V_76 == ( V_127 >> 1 ) ? L_22 : L_23 ,
V_72 -> V_76 << 1 , V_72 -> V_80 -> V_128 ) ;
V_82 = F_25 ( sizeof( * V_82 ) , V_129 ) ;
if ( V_82 == NULL )
return - V_130 ;
V_3 = & V_82 -> V_3 ;
F_26 ( V_3 , V_72 , & V_131 ) ;
