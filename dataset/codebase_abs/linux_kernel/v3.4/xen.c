...
if ( V_71 ) {
struct V_73 V_74 ;
V_74 . V_75 = F_34 ( V_2 -> V_59 ) ;
V_74 . V_59 = V_2 -> V_59 -> V_60 ;
V_74 . V_61 = V_2 -> V_61 ;
V_37 = F_7 ( V_76 ,
& V_74 ) ;
if ( V_37 == - V_77 )
V_71 = false ;
F_39 ( V_37 && V_37 != - V_77 , L_21 , V_37 ) ;
}
if ( ! V_71 ) {
struct V_78 V_79 ;
V_79 . V_59 = V_2 -> V_59 -> V_60 ;
V_79 . V_61 = V_2 -> V_61 ;
V_37 = F_7 ( V_80 , & V_79 ) ;
F_39 ( V_37 && V_37 != - V_77 , L_22 , V_37 ) ;
}
}
static void F_40 ( struct V_1 * V_2 )
{
struct V_39 * V_40 ;
V_40 = F_41 ( V_2 -> V_81 . V_82 , struct V_39 , V_83 ) ;
if ( V_40 -> V_69 . V_84 )
F_42 ( V_2 ) ;
else
F_43 ( V_2 ) ;
...
static struct V_100 * F_58 ( struct V_1 * V_2 )
{
struct V_100 * V_101 ;
...
int F_61 ( struct V_1 * V_2 , T_5 V_102 )
{
struct V_100 * V_101 ;
V_101 = F_15 ( sizeof( struct V_100 ) , V_42 ) ;
if ( ! V_101 )
return - V_57 ;
F_59 ( & V_103 ) ;
if ( F_58 ( V_2 ) ) {
