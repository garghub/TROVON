...
V_131 -> V_114 = V_11 -> V_114 ;
V_131 -> V_116 = V_11 -> V_116 ;
V_131 -> V_117 = V_11 -> V_117 ;
V_131 -> V_115 = V_11 -> V_115 ;
V_131 -> V_113 = V_11 -> V_113 ;
memcpy ( V_131 -> V_134 , V_11 -> V_135 , sizeof( V_131 -> V_134 ) ) ;
V_133:
F_10 ( V_11 ) ;
return V_7 ;
}
int F_16 ( struct V_2 * V_3 , V_81 V_100 , T_3 V_136 , T_3 * V_137 )
{
int V_7 = 0 ;
T_2 V_102 ;
struct V_8 * V_9 ;
...
memcpy ( V_137 , & V_11 -> V_135 + V_136 , sizeof( T_3 ) ) ;
V_138:
F_10 ( V_11 ) ;
return V_7 ;
}
int F_17 ( struct V_2 * V_3 , V_81 V_100 ,
int V_136 , union V_139 * V_140 )
{
int V_7 = 0 ;
T_2 V_102 ;
struct V_8 * V_9 = F_4 ( V_3 , struct V_8 ,
...
memcpy ( & V_140 -> V_142 [ 0 ] , & V_11 -> V_143 , sizeof( T_2 ) ) ;
memcpy ( & V_140 -> V_142 [ 8 ] , & V_11 -> V_144 [ V_136 ] , sizeof( T_2 ) ) ;
V_141:
F_10 ( V_11 ) ;
return V_7 ;
}
int F_18 ( struct V_2 * V_3 ,
V_81 V_100 , int V_145 ,
struct V_146 * V_5 )
{
int V_7 = 0 ;
struct V_8 * V_9 ;
...
V_148 = F_14 ( V_9 -> V_37 , V_100 , V_11 ) ;
if ( V_148 != V_38 ) {
F_6 ( & V_9 -> V_2 , L_5 ) ;
V_7 = - V_39 ;
goto V_155;
}
V_147 = ( V_11 -> V_108 | V_5 -> V_149 )
& ~ V_5 -> V_150 ;
V_148 = F_20 ( V_9 -> V_37 , V_100 ,
V_147 , V_5 -> V_156 , V_145 ) ;
if ( V_148 != V_38 ) {
F_6 ( & V_9 -> V_2 , L_9 ,
V_148 ) ;
V_7 = - V_39 ;
