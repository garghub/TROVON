...
static struct V_46 * F_234 ( struct V_265 * V_147 ,
struct V_55 * V_56 ,
unsigned long V_266 , V_31 V_255 )
{
struct V_172 * V_173 = F_235 ( V_147 ) ;
struct V_46 * V_46 = NULL ;
V_255 = F_236 ( V_31 , F_237 ( V_56 -> V_107 ) , V_255 ) ;
if ( ! V_37 && V_255 > F_238 ( 32 ) ) {
V_46 = F_239 ( & V_56 -> V_187 , V_266 ,
F_157 ( F_238 ( 32 ) ) , 1 ) ;
if ( V_46 )
return V_46 ;
}
V_46 = F_239 ( & V_56 -> V_187 , V_266 , F_157 ( V_255 ) , 1 ) ;
if ( F_172 ( ! V_46 ) ) {
F_42 ( V_141 L_49 ,
V_266 , F_198 ( V_173 ) ) ;
return NULL ;
...
static struct V_55 * F_240 ( struct V_172 * V_173 )
{
struct V_55 * V_56 ;
int V_86 ;
V_56 = F_196 ( V_173 ,
...
static inline struct V_55 * F_241 ( struct V_172 * V_147 )
{
struct V_142 * V_144 ;
...
static int F_242 ( struct V_172 * V_173 )
{
return V_173 -> V_147 . V_225 . V_49 == V_240 ;
}
static int F_243 ( struct V_265 * V_147 )
{
struct V_172 * V_173 ;
int V_143 ;
...
static V_218 F_245 ( struct V_265 * V_268 , T_6 V_269 ,
T_5 V_82 , int V_270 , V_23 V_255 )
{
struct V_172 * V_173 = F_235 ( V_268 ) ;
struct V_55 * V_56 ;
T_6 V_271 ;
struct V_46 * V_46 ;
int V_30 = 0 ;
...
V_46 = F_234 ( V_268 , V_56 , F_10 ( V_82 ) , V_255 ) ;
if ( ! V_46 )
goto error;
...
error:
if ( V_46 )
F_247 ( & V_56 -> V_187 , V_46 ) ;
F_42 ( V_141 L_54 ,
F_198 ( V_173 ) , V_82 , ( unsigned long long ) V_269 , V_270 ) ;
return 0 ;
}
static V_218 F_248 ( struct V_265 * V_147 , struct V_12 * V_12 ,
unsigned long V_92 , T_5 V_82 ,
enum V_278 V_270 ,
struct V_279 * V_280 )
{
return F_245 ( V_147 , F_183 ( V_12 ) + V_92 , V_82 ,
V_270 , F_235 ( V_147 ) -> V_255 ) ;
}
...
F_247 ( & V_258 [ V_64 ] . V_56 [ V_281 ] -> V_187 , V_46 ) ;
}
V_258 [ V_64 ] . V_222 = 0 ;
}
V_284 = 0 ;
...
static void F_250 ( struct V_55 * V_287 , struct V_46 * V_46 )
{
unsigned long V_58 ;
int V_222 , V_57 ;
struct V_48 * V_49 ;
...
V_258 [ V_57 ] . V_222 ++ ;
if ( ! V_282 ) {
F_251 ( & V_289 , V_290 + F_252 ( 10 ) ) ;
V_282 = 1 ;
}
V_284 ++ ;
F_80 ( & V_286 , V_58 ) ;
}
static void F_253 ( struct V_265 * V_147 , V_218 V_291 ,
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_254 ( & V_56 -> V_187 , F_157 ( V_291 ) ) ;
if ( F_255 ( ! V_46 , L_55 ,
...
static void * F_256 ( struct V_265 * V_268 , T_5 V_82 ,
...
if ( ! F_243 ( V_268 ) )
V_58 &= ~ ( V_293 | V_294 ) ;
else if ( V_268 -> V_256 < F_219 ( V_268 ) ) {
if ( V_268 -> V_256 < F_238 ( 32 ) )
V_58 |= V_293 ;
else
V_58 |= V_294 ;
}
V_41 = ( void * ) F_258 ( V_58 , V_105 ) ;
if ( ! V_41 )
return NULL ;
memset ( V_41 , 0 , V_82 ) ;
* V_292 = F_245 ( V_268 , F_259 ( V_41 ) , V_82 ,
V_275 ,
V_268 -> V_256 ) ;
if ( * V_292 )
return V_41 ;
F_260 ( ( unsigned long ) V_41 , V_105 ) ;
return NULL ;
}
static void F_261 ( struct V_265 * V_268 , T_5 V_82 , void * V_41 ,
V_218 V_292 , struct V_279 * V_280 )
{
int V_105 ;
V_82 = F_180 ( V_82 ) ;
V_105 = F_257 ( V_82 ) ;
F_253 ( V_268 , V_292 , V_82 , V_275 , NULL ) ;
F_260 ( ( unsigned long ) V_41 , V_105 ) ;
}
static void F_262 ( struct V_265 * V_268 , struct V_208 * V_295 ,
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_254 ( & V_56 -> V_187 , F_157 ( V_295 [ 0 ] . V_217 ) ) ;
if ( F_255 ( ! V_46 , L_57 ,
...
static int F_263 ( struct V_265 * V_297 ,
struct V_208 * V_295 , int V_296 , int V_270 )
{
int V_64 ;
struct V_208 * V_209 ;
F_264 (sglist, sg, nelems, i) {
F_62 ( ! F_184 ( V_209 ) ) ;
...
static int F_265 ( struct V_265 * V_268 , struct V_208 * V_295 , int V_296 ,
...
F_62 ( V_270 == V_273 ) ;
if ( F_243 ( V_268 ) )
return F_263 ( V_268 , V_295 , V_296 , V_270 ) ;
V_56 = F_241 ( V_173 ) ;
if ( ! V_56 )
return 0 ;
V_49 = F_61 ( V_56 ) ;
...
V_46 = F_234 ( V_268 , V_56 , F_10 ( V_82 ) ,
V_173 -> V_255 ) ;
if ( ! V_46 ) {
V_295 -> V_219 = 0 ;
return 0 ;
...
static int F_266 ( struct V_265 * V_147 , V_218 V_299 )
{
return ! V_299 ;
}
...
static void T_1 F_273 ( void )
{
F_272 ( V_45 ) ;
F_272 ( V_44 ) ;
F_272 ( V_47 ) ;
}
static void F_274 ( struct V_172 * V_173 )
{
struct V_68 * V_69 ;
T_3 V_302 ;
int V_303 ;
V_303 = F_275 ( V_173 -> V_73 , F_276 ( 0 , 0 ) , 0xb0 , & V_302 ) ;
if ( V_303 ) {
F_277 ( & V_173 -> V_147 , L_64 ) ;
return;
}
V_302 &= 0xffff0000 ;
V_69 = F_197 ( V_173 ) ;
if ( F_278 ( ! V_69 || V_69 -> V_260 - V_302 != 0xa000 ,
V_304 ,
L_65 ) )
...
unsigned long V_111 ;
F_70 (iommu, drhd) {
V_49 -> V_306 = F_224 ( sizeof( T_3 ) * V_307 ,
V_42 ) ;
if ( ! V_49 -> V_306 )
goto V_308;
}
...
static void T_1 F_287 ( void )
{
F_288 ( & V_317 ) ;
}
static inline void F_287 ( void ) {}
static void T_1 F_289 ( struct V_238 * V_239 )
{
F_199 ( & V_239 -> V_318 , & V_319 ) ;
}
int T_1 F_290 ( struct V_320 * V_321 )
{
struct V_322 * V_239 ;
struct V_238 * V_323 ;
V_323 = F_224 ( sizeof( * V_323 ) , V_166 ) ;
if ( ! V_323 )
return - V_108 ;
V_323 -> V_324 = V_321 ;
...
static int T_1
F_291 ( struct V_238 * V_323 )
{
struct V_322 * V_239 ;
int V_86 ;
V_239 = (struct V_322 * ) V_323 -> V_324 ;
V_86 = F_292 ( ( void * ) ( V_239 + 1 ) ,
...
int T_1 F_293 ( struct V_320 * V_324 )
{
struct V_325 * V_326 ;
struct V_327 * V_328 ;
V_326 = F_294 ( V_324 , struct V_325 , V_321 ) ;
V_328 = F_224 ( sizeof( * V_328 ) , V_166 ) ;
if ( ! V_328 )
return - V_108 ;
V_328 -> V_324 = V_324 ;
...
static int T_1 F_295 ( struct V_327 * V_328 )
{
int V_303 ;
struct V_325 * V_326 ;
if ( V_328 -> V_80 )
return 0 ;
V_326 = F_294 ( V_328 -> V_324 , struct V_325 , V_321 ) ;
V_303 = F_292 ( ( void * ) ( V_326 + 1 ) ,
...
int V_86 = 0 ;
F_298 (rmrr, rmrr_n, &dmar_rmrr_units, list) {
V_86 = F_291 ( V_239 ) ;
if ( V_86 )
return V_86 ;
}
F_298 (atsr, atsr_n, &dmar_atsr_units, list) {
V_86 = F_295 ( V_326 ) ;
if ( V_86 )
return V_86 ;
}
...
static int F_299 ( struct V_335 * V_336 ,
...
static void F_308 ( struct V_48 * V_49 ,
struct V_172 * V_173 )
{
struct V_172 * V_106 , * V_91 ;
if ( ! V_49 || ! V_173 )
...
static void F_244 ( struct V_55 * V_56 ,
struct V_172 * V_173 )
{
struct V_142 * V_144 ;
struct V_48 * V_49 ;
...
return;
F_79 ( & V_146 , V_58 ) ;
F_309 (entry, tmp, &domain->devices) {
...
static void F_310 ( struct V_55 * V_56 )
{
struct V_142 * V_144 ;
struct V_48 * V_49 ;
...
static int F_314 ( struct V_353 * V_56 )
{
struct V_55 * V_55 ;
V_55 = F_312 () ;
if ( ! V_55 ) {
...
static void F_315 ( struct V_353 * V_56 )
{
...
static T_5 F_320 ( struct V_353 * V_56 ,
...
static T_6 F_321 ( struct V_353 * V_56 ,
unsigned long V_46 )
{
struct V_55 * V_55 = V_56 -> V_354 ;
struct V_25 * V_26 ;
...
static int F_323 ( struct V_265 * V_147 , unsigned int * V_366 )
{
struct V_172 * V_173 = F_235 ( V_147 ) ;
struct V_172 * V_331 ;
union {
...
V_171 . V_367 . V_74 = F_276 ( F_170 ( V_171 . V_367 . V_74 ) , 0 ) ;
* V_366 = V_171 . V_368 ;
return 0 ;
}
...
static void T_8 F_325 ( struct V_172 * V_147 )
{
unsigned short V_372 ;
if ( F_326 ( V_147 , V_373 , & V_372 ) )
return;
if ( ! ( V_372 & V_374 ) ) {
F_42 ( V_35 L_83 ) ;
V_36 = 0 ;
...
static void T_1 F_230 ( void )
{
struct V_172 * V_173 ;
T_9 V_375 ;
V_173 = F_327 ( V_376 , 0x3a3e , NULL ) ;
if ( ! V_173 )
return;
F_328 ( V_173 ) ;
V_173 = F_327 ( V_376 , 0x342e , NULL ) ;
if ( ! V_173 )
return;
if ( F_329 ( V_173 , 0x188 , & V_375 ) ) {
F_328 ( V_173 ) ;
return;
}
F_328 ( V_173 ) ;
