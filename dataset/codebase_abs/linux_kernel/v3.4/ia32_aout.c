...
static int F_19 ( struct V_63 * V_64 , struct V_1 * V_2 )
{
unsigned long error , V_74 , V_75 ;
struct V_76 V_77 ;
int V_78 ;
V_77 = * ( (struct V_76 * ) V_64 -> V_79 ) ;
if ( ( F_20 ( V_77 ) != V_80 && F_20 ( V_77 ) != V_81 &&
F_20 ( V_77 ) != V_82 && F_20 ( V_77 ) != V_83 ) ||
F_21 ( V_77 ) || F_22 ( V_77 ) ||
F_23 ( V_64 -> V_49 -> V_84 . V_85 -> V_86 ) <
V_77 . V_87 + V_77 . V_88 + F_24 ( V_77 ) + F_25 ( V_77 ) ) {
return - V_89 ;
}
V_74 = F_25 ( V_77 ) ;
V_75 = F_26 ( V_90 ) ;
...
( V_14 -> V_15 -> V_9 = F_31 ( V_77 ) ) ;
V_14 -> V_15 -> V_104 = V_77 . V_88 +
( V_14 -> V_15 -> V_105 = F_32 ( V_77 ) ) ;
V_14 -> V_15 -> V_19 = V_77 . V_92 +
( V_14 -> V_15 -> V_106 = F_33 ( V_77 ) ) ;
V_14 -> V_15 -> V_107 = V_108 ;
V_14 -> V_15 -> V_109 = 0 ;
V_78 = F_34 ( V_64 , V_110 , V_111 ) ;
if ( V_78 < 0 ) {
F_35 ( V_112 , V_14 , 0 ) ;
return V_78 ;
}
...
F_37 ( V_113 , V_113 + V_77 . V_87 + V_77 . V_88 ) ;
} else {
#ifdef F_38
static unsigned long V_119 , V_120 ;
if ( ( V_77 . V_87 & 0xfff || V_77 . V_88 & 0xfff ) &&
( F_20 ( V_77 ) != V_83 ) &&
F_39 ( V_121 , V_120 + 5 * V_122 ) ) {
F_40 ( V_123 L_1 ) ;
V_120 = V_121 ;
}
if ( ( V_74 & ~ V_116 ) != 0 &&
F_39 ( V_121 , V_119 + 5 * V_122 ) ) {
F_40 ( V_124
L_2
L_3 ,
...
T_4 V_115 = V_74 ;
F_6 ( F_31 ( V_77 ) , V_77 . V_87 + V_77 . V_88 ) ;
V_64 -> V_49 -> V_117 -> V_118 ( V_64 -> V_49 ,
( char T_3 * ) F_31 ( V_77 ) ,
V_77 . V_87 + V_77 . V_88 , & V_115 ) ;
F_37 ( ( unsigned long ) F_31 ( V_77 ) ,
( unsigned long ) F_31 ( V_77 ) +
V_77 . V_87 + V_77 . V_88 ) ;
goto V_128;
}
error = F_41 ( V_64 -> V_49 , F_31 ( V_77 ) , V_77 . V_87 ,
V_129 | V_130 ,
V_131 | V_132 | V_133 |
V_134 | V_135 ,
V_74 ) ;
...
error = F_41 ( V_64 -> V_49 , F_32 ( V_77 ) , V_77 . V_88 ,
V_129 | V_136 | V_130 ,
V_131 | V_132 | V_133 |
V_134 | V_135 ,
V_74 + V_77 . V_87 ) ;
...
static int F_45 ( struct V_49 * V_49 )
{
struct V_140 * V_140 ;
...
V_78 = - V_89 ;
error = F_46 ( V_49 , 0 , ( char * ) & V_77 , sizeof( V_77 ) ) ;
if ( error != sizeof( V_77 ) )
goto V_144;
if ( ( F_20 ( V_77 ) != V_80 && F_20 ( V_77 ) != V_82 ) || F_21 ( V_77 ) ||
F_22 ( V_77 ) || ( ( V_77 . V_139 & 0xfff ) && F_20 ( V_77 ) == V_80 ) ||
F_23 ( V_140 ) <
V_77 . V_87 + V_77 . V_88 + F_24 ( V_77 ) + F_25 ( V_77 ) ) {
goto V_144;
}
...
if ( ( F_25 ( V_77 ) & ~ V_116 ) != 0 ) {
T_4 V_115 = F_25 ( V_77 ) ;
#ifdef F_38
static unsigned long V_119 ;
if ( F_39 ( V_121 , V_119 + 5 * V_122 ) ) {
F_40 ( V_124
L_4
L_5 ,
...
V_77 . V_87 + V_77 . V_88 , & V_115 ) ;
F_37 ( ( unsigned long ) V_142 ,
( unsigned long ) V_142 + V_77 . V_87 +
V_77 . V_88 ) ;
V_78 = 0 ;
goto V_144;
}
error = F_41 ( V_49 , V_142 , V_77 . V_87 + V_77 . V_88 ,
V_129 | V_136 | V_130 ,
