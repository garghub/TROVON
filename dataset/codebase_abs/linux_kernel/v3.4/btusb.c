...
static int F_64 ( struct V_95 * V_65 ,
...
int V_44 , V_12 ;
F_7 ( L_12 , V_65 , V_107 ) ;
if ( V_65 -> V_100 -> V_101 . V_108 != 0 )
return - V_27 ;
if ( ! V_107 -> V_109 ) {
const struct V_106 * V_110 ;
V_110 = F_65 ( V_65 , V_111 ) ;
if ( V_110 )
V_107 = V_110 ;
}
if ( V_107 -> V_109 == V_112 )
return - V_27 ;
if ( V_113 && V_107 -> V_109 & V_114 )
return - V_27 ;
if ( V_115 && V_107 -> V_109 & V_116 )
return - V_27 ;
if ( V_117 && V_107 -> V_109 & V_118 )
return - V_27 ;
if ( V_107 -> V_109 & V_119 ) {
struct V_120 * V_23 = F_66 ( V_65 ) ;
if ( F_16 ( V_23 -> V_121 . V_122 ) <= 0x0001 )
return - V_27 ;
}
V_2 = F_67 ( sizeof( * V_2 ) , V_67 ) ;
if ( ! V_2 )
return - V_33 ;
for ( V_44 = 0 ; V_44 < V_65 -> V_100 -> V_101 . V_102 ; V_44 ++ ) {
V_98 = & V_65 -> V_100 -> V_103 [ V_44 ] . V_101 ;
if ( ! V_2 -> V_32 && F_68 ( V_98 ) ) {
V_2 -> V_32 = V_98 ;
continue;
}
if ( ! V_2 -> V_85 && F_69 ( V_98 ) ) {
V_2 -> V_85 = V_98 ;
continue;
}
if ( ! V_2 -> V_43 && F_70 ( V_98 ) ) {
V_2 -> V_43 = V_98 ;
continue;
}
}
...
V_10 -> V_130 = F_48 ;
V_10 -> V_131 = F_56 ;
V_2 -> V_96 = F_77 ( V_2 -> V_23 , 1 ) ;
if ( ! V_132 )
F_39 ( V_133 , & V_10 -> V_134 ) ;
if ( V_135 || V_107 -> V_109 & V_136 ) {
if ( ! V_137 )
F_39 ( V_138 , & V_10 -> V_134 ) ;
}
if ( V_107 -> V_109 & V_139 )
V_2 -> V_96 = NULL ;
if ( V_107 -> V_109 & V_114 ) {
V_2 -> V_79 = V_140 ;
F_39 ( V_133 , & V_10 -> V_134 ) ;
}
if ( V_107 -> V_109 & V_116 ) {
struct V_120 * V_23 = V_2 -> V_23 ;
if ( F_16 ( V_23 -> V_121 . V_122 ) < 0x117 )
F_39 ( V_133 , & V_10 -> V_134 ) ;
}
if ( V_107 -> V_109 & V_118 ) {
struct V_120 * V_23 = V_2 -> V_23 ;
if ( F_16 ( V_23 -> V_121 . V_122 ) > 0x997 )
F_39 ( V_141 , & V_10 -> V_134 ) ;
V_2 -> V_96 = NULL ;
}
if ( V_107 -> V_109 & V_142 ) {
unsigned char V_143 [] = { 0x3b , 0xfc , 0x01 , 0x00 } ;
struct V_57 * V_58 ;
V_58 = F_78 ( sizeof( V_143 ) , V_67 ) ;
if ( V_58 ) {
memcpy ( F_79 ( V_58 , sizeof( V_143 ) ) , V_143 , sizeof( V_143 ) ) ;
F_80 ( & V_10 -> V_144 , V_58 ) ;
}
}
if ( V_2 -> V_96 ) {
V_12 = F_81 ( & V_145 ,
...
static void F_85 ( struct V_95 * V_65 )
{
struct V_1 * V_2 = F_86 ( V_65 ) ;
struct V_9 * V_10 ;
F_7 ( L_13 , V_65 ) ;
if ( ! V_2 )
return;
...
static int F_89 ( struct V_95 * V_65 , T_2 V_146 )
{
struct V_1 * V_2 = F_86 ( V_65 ) ;
F_7 ( L_13 , V_65 ) ;
if ( V_2 -> V_147 ++ )
...
static int F_95 ( struct V_95 * V_65 )
{
struct V_1 * V_2 = F_86 ( V_65 ) ;
struct V_9 * V_10 = V_2 -> V_10 ;
int V_12 = 0 ;
