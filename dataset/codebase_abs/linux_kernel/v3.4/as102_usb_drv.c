...
int V_36 ;
F_2 () ;
if ( ( sizeof( V_54 ) / sizeof( struct V_52 ) ) !=
( sizeof( V_55 ) / sizeof( const char * ) ) ) {
F_39 ( L_13 ) ;
return - V_21 ;
}
V_31 = F_40 ( sizeof( struct V_22 ) , V_41 ) ;
if ( V_31 == NULL ) {
V_25 ( L_14 , V_30 ) ;
return - V_42 ;
}
for ( V_36 = 0 ; V_36 < ( sizeof( V_54 ) /
sizeof( struct V_52 ) ) ; V_36 ++ ) {
if ( V_53 == & V_54 [ V_36 ] ) {
V_31 -> V_56 = V_55 [ V_36 ] ;
V_31 -> V_57 = V_58 [ V_36 ] ;
}
...
static int F_46 ( struct V_68 * V_68 , struct V_69 * V_69 )
{
int V_7 = 0 , V_70 = 0 ;
