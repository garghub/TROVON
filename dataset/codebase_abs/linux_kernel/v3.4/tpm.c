...
V_32 V_128 [ V_122 ] ;
unsigned int V_129 ;
unsigned int V_130 = 1000 ;
unsigned long V_13 ;
V_13 = F_8 ( V_3 ,
V_131 ) ;
V_129 = F_38 ( V_13 ) / V_130 ;
V_23 = F_23 ( V_3 ) ;
if ( V_23 )
return V_23 ;
do {
V_23 = F_33 ( V_3 , 0 , V_128 ) ;
if ( V_23 == V_132 || V_23 == V_133 ) {
F_22 ( V_3 -> V_28 ,
L_18 , V_23 ) ;
return 0 ;
}
...
int F_39 ( T_1 V_109 , void * V_47 , T_3 V_135 )
{
struct V_2 * V_3 ;
int V_23 ;
V_3 = F_28 ( V_109 ) ;
...
V_23 = F_33 ( V_3 , V_136 , V_128 ) ;
if ( V_23 )
break;
V_139 += sprintf ( V_139 , L_21 , V_136 ) ;
for ( V_137 = 0 ; V_137 < V_122 ; V_137 ++ )
V_139 += sprintf ( V_139 , L_22 , V_128 [ V_137 ] ) ;
...
int F_78 ( struct V_55 * V_28 , T_8 V_180 )
{
struct V_2 * V_3 = F_17 ( V_28 ) ;
struct V_46 V_47 ;
int V_23 ;
...
if ( V_182 ) {
V_47 . V_53 . V_59 = V_125 ;
V_47 . V_63 . V_126 . V_115 = F_18 ( V_182 ) ;
memcpy ( V_47 . V_63 . V_126 . V_124 , V_181 ,
V_122 ) ;
V_23 = F_15 ( V_3 , & V_47 , V_127 ,
L_44 ) ;
}
V_47 . V_53 . V_59 = V_183 ;
V_23 = F_15 ( V_3 , & V_47 , V_184 ,
L_45 ) ;
return V_23 ;
}
...
{
if ( V_3 -> V_19 . V_185 )
V_3 -> V_19 . V_185 ( V_3 -> V_28 ) ;
F_59 ( V_3 -> V_112 , V_186 ) ;
F_63 ( V_3 -> V_19 . V_162 . V_187 ) ;
}
...
V_190 = F_84 ( F_83 , V_165 ) ;
if ( V_3 == NULL || V_190 == NULL )
goto V_191;
F_85 ( & V_3 -> V_6 ) ;
F_85 ( & V_3 -> V_30 ) ;
F_86 ( & V_3 -> V_176 ) ;
...
F_88 ( & V_3 -> V_168 , F_1 ,
( unsigned long ) V_3 ) ;
memcpy ( & V_3 -> V_19 , V_189 , sizeof( struct V_188 ) ) ;
V_3 -> V_112 = F_89 ( V_186 , V_192 ) ;
if ( V_3 -> V_112 >= V_192 ) {
F_11 ( V_28 , L_46 ) ;
goto V_191;
} else if ( V_3 -> V_112 == 0 )
...
V_3 -> V_19 . V_162 . V_161 = V_194 ;
F_90 ( V_3 -> V_112 , V_186 ) ;
F_91 ( V_190 , F_83 , L_47 , L_48 , V_3 -> V_112 ) ;
V_3 -> V_19 . V_162 . V_187 = V_190 ;
V_3 -> V_19 . V_162 . V_195 = V_28 ;
V_3 -> V_28 = F_54 ( V_28 ) ;
V_3 -> V_185 = V_28 -> V_185 ;
V_28 -> V_185 = F_81 ;
F_92 ( V_28 , V_3 ) ;
if ( F_93 ( & V_3 -> V_19 . V_162 ) ) {
F_11 ( V_3 -> V_28 ,
L_49 ,
V_3 -> V_19 . V_162 . V_187 ,
...
V_3 -> V_179 = F_95 ( V_190 ) ;
F_71 ( & V_175 ) ;
F_96 ( & V_3 -> V_176 , & V_196 ) ;
F_73 ( & V_175 ) ;
return V_3 ;
V_191:
F_63 ( V_3 ) ;
