...
int F_90 ( struct V_44 * V_45 , T_8 V_121 ,
struct V_89 * * V_90 )
{
int V_39 ;
F_78 ( & V_45 -> V_72 ) ;
...
int F_94 ( struct V_89 * V_90 , T_3 V_135 ,
int V_136 , struct V_137 * V_38 )
{
int V_39 ;
T_2 V_138 = 0 ;
T_5 V_30 ;
struct V_44 * V_45 = V_90 -> V_45 ;
T_3 V_139 [ 2 ] = { V_90 -> V_95 , V_135 } ;
if ( V_136 ) {
F_68 ( & V_45 -> V_72 ) ;
V_39 = F_72 ( & V_45 -> V_32 , V_45 -> V_34 , V_139 , & V_30 ) ;
if ( ! V_39 )
V_138 = F_8 ( V_30 ) ;
F_69 ( & V_45 -> V_72 ) ;
} else if ( F_95 ( & V_45 -> V_72 ) ) {
V_39 = F_72 ( & V_45 -> V_67 , V_45 -> V_34 , V_139 , & V_30 ) ;
if ( ! V_39 )
V_138 = F_8 ( V_30 ) ;
F_69 ( & V_45 -> V_72 ) ;
} else
...
& V_142 ) ;
V_38 -> V_135 = V_141 ;
V_38 -> V_143 = F_93 ( V_90 , V_142 ) ;
}
return V_39 ;
}
static int F_96 ( struct V_89 * V_90 , T_3 V_135 ,
T_3 V_144 )
{
int V_39 , V_145 ;
T_5 V_30 ;
...
T_3 V_139 [ 2 ] = { V_90 -> V_95 , V_135 } ;
V_45 -> V_73 = 1 ;
V_30 = F_3 ( F_11 ( V_144 , V_45 -> time ) ) ;
F_46 ( & V_30 ) ;
V_39 = F_97 ( & V_45 -> V_32 , V_45 -> V_34 , V_139 , & V_30 ,
& V_45 -> V_34 , & V_145 ) ;
if ( V_39 )
return V_39 ;
if ( V_145 ) {
...
int F_98 ( struct V_89 * V_90 , T_3 V_135 ,
T_3 V_144 )
{
int V_39 ;
F_78 ( & V_90 -> V_45 -> V_72 ) ;
V_39 = F_96 ( V_90 , V_135 , V_144 ) ;
F_79 ( & V_90 -> V_45 -> V_72 ) ;
return V_39 ;
}
static int F_99 ( struct V_89 * V_90 , T_3 V_135 )
{
int V_39 ;
struct V_44 * V_45 = V_90 -> V_45 ;
T_3 V_139 [ 2 ] = { V_90 -> V_95 , V_135 } ;
V_39 = F_76 ( & V_45 -> V_32 , V_45 -> V_34 , V_139 , & V_45 -> V_34 ) ;
if ( V_39 )
return V_39 ;
V_90 -> V_96 -- ;
V_90 -> V_94 = 1 ;
...
int F_100 ( struct V_89 * V_90 , T_3 V_135 )
{
int V_39 ;
F_78 ( & V_90 -> V_45 -> V_72 ) ;
V_39 = F_99 ( V_90 , V_135 ) ;
F_79 ( & V_90 -> V_45 -> V_72 ) ;
return V_39 ;
}
...
return V_39 ;
V_146 = F_8 ( V_20 ) ;
return F_112 ( & V_45 -> V_69 , V_146 , V_38 ) ;
}
...
static int F_114 ( struct V_44 * V_45 , T_3 V_147 )
{
int V_39 ;
T_3 V_148 ;
V_39 = F_107 ( V_45 -> V_48 , & V_148 ) ;
if ( V_39 )
return V_39 ;
if ( V_147 == V_148 )
return 0 ;
...
V_39 = F_115 ( V_45 -> V_48 , V_147 - V_148 ) ;
if ( ! V_39 )
V_45 -> V_73 = 1 ;
return V_39 ;
}
int F_116 ( struct V_44 * V_45 , T_3 V_147 )
{
int V_39 ;
F_78 ( & V_45 -> V_72 ) ;
V_39 = F_114 ( V_45 , V_147 ) ;
F_79 ( & V_45 -> V_72 ) ;
return V_39 ;
}
