...
V_21 = & V_26 ;
V_135 . V_21 = V_21 ;
memcpy ( & V_135 . V_136 , V_129 , sizeof( * V_129 ) ) ;
V_135 . V_137 = V_138 ;
V_135 . V_21 = & V_26 ;
V_135 . V_82 = 0 ;
V_135 . V_139 = V_30 ;
V_135 . V_140 = 0 ;
V_32 = F_63 ( F_64 ( V_12 -> V_141 ) , & V_135 ) ;
F_5 ( L_24 , V_8 , V_32 ) ;
if ( V_32 )
goto V_142;
V_101 = F_15 ( V_26 ) ;
...
V_147 [ 6 ] = V_145 -> V_153 ;
V_147 [ 7 ] = NULL ;
V_148 = F_68 ( V_147 [ 0 ] , V_147 , V_146 , V_154 ) ;
...
V_164 = V_162 ;
for ( V_122 = 0 ; V_122 < V_157 . V_24 ; V_122 ++ )
V_164 = F_72 ( V_164 , V_157 . V_161 [ V_122 ] ) ;
}
int F_73 ( struct V_130 * V_131 )
{
int V_166 ;
struct V_144 V_145 ;
if ( ! V_131 -> V_167 . V_168 . V_169 . V_24 )
return - V_170 ;
memset ( & V_145 , 0 , sizeof( V_145 ) ) ;
F_69 (
V_131 -> V_167 . V_168 . V_169 ,
V_145 . V_151 , sizeof( V_145 . V_151 ) , L_40 ) ;
F_69 (
V_131 -> V_171 ,
V_145 . V_152 , sizeof( V_145 . V_152 ) , L_41 ) ;
F_71 ( V_131 -> V_172 , V_145 . V_153 ) ;
V_166 = F_67 ( & V_145 ) ;
if ( V_166 > 0 )
V_166 = - V_170 ;
return V_166 ;
