...
struct V_9 * V_11 = F_12 ( V_2 ) ;
int V_12 ;
F_13 ( & V_11 -> V_13 ) ;
if ( F_14 ( V_14 , V_11 -> V_15 + V_16 ) || ! V_11 -> V_17 ) {
...
static T_3 F_24 ( struct V_10 * V_6 , struct V_24 * V_25 ,
char * V_26 )
{
struct V_9 * V_11 = F_10 ( V_6 ) ;
int V_27 = F_25 ( V_25 ) -> V_28 ;
int V_12 = F_25 ( V_25 ) -> V_12 ;
return sprintf ( V_26 , L_4 ,
( unsigned ) V_11 -> V_18 [ V_27 ] [ V_12 ] * V_29 [ V_12 ] / 0xC0 ) ;
}
static T_3 F_26 ( struct V_10 * V_6 , struct V_24 * V_25 ,
...
long V_7 ;
T_2 V_3 ;
V_8 = F_27 ( V_26 , 10 , & V_7 ) ;
if ( V_8 < 0 )
return V_8 ;
V_7 = F_28 ( V_7 * 0xC0 , V_29 [ V_12 ] ) ;
V_3 = ( V_27 == V_20 ) ? F_16 ( V_12 )
: F_17 ( V_12 ) ;
F_13 ( & V_11 -> V_13 ) ;
V_11 -> V_18 [ V_27 ] [ V_12 ] = F_29 ( V_7 , 0 , 255 ) ;
...
return V_8 ;
V_7 /= 1000 ;
V_3 = ( V_27 == V_20 ) ? F_19 ( V_12 )
: F_20 ( V_12 ) ;
F_13 ( & V_11 -> V_13 ) ;
V_11 -> V_22 [ V_27 ] [ V_12 ] = F_29 ( V_7 , - 127 , 128 ) ;
...
static T_3 F_33 ( struct V_10 * V_6 , struct V_24 * V_25 ,
const char * V_26 , T_4 V_30 )
{
struct V_1 * V_2 = F_11 ( V_6 ) ;
struct V_9 * V_11 = F_12 ( V_2 ) ;
...
int V_8 ;
unsigned long V_7 ;
V_8 = F_34 ( V_26 , 10 , & V_7 ) ;
if ( V_8 < 0 )
return V_8 ;
if ( V_7 == 0 ) {
V_7 = 0xFFFF ;
} else {
V_7 = F_28 ( 5400000U , V_7 ) ;
V_7 = F_29 ( V_7 , 0 , 0xFFFE ) ;
}
F_13 ( & V_11 -> V_13 ) ;
V_11 -> V_23 [ V_27 ] [ V_12 ] = V_7 ;
V_8 = F_5 ( V_2 , F_22 ( V_12 ) ,
V_11 -> V_23 [ V_27 ] [ V_12 ] ) ;
F_23 ( & V_11 -> V_13 ) ;
return V_8 < 0 ? V_8 : V_30 ;
}
...
struct V_9 * V_11 ;
int V_8 ;
V_11 = F_40 ( sizeof( struct V_9 ) , V_47 ) ;
if ( ! V_11 ) {
V_8 = - V_48 ;
goto exit;
}
F_41 ( V_2 , V_11 ) ;
F_42 ( & V_11 -> V_13 ) ;
V_8 = F_43 ( & V_2 -> V_6 . V_49 , & V_50 ) ;
if ( V_8 )
goto V_51;
V_11 -> V_52 = F_44 ( & V_2 -> V_6 ) ;
if ( F_45 ( V_11 -> V_52 ) ) {
V_8 = F_46 ( V_11 -> V_52 ) ;
goto V_53;
}
