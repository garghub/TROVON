...
void F_50 ( struct V_1 * V_2 , enum V_190 V_128 )
{
struct V_195 * V_195 ;
struct V_209 * V_210 ;
int V_36 ;
F_46 ( L_28 , V_128 ) ;
if ( V_128 == V_193 )
V_210 = & V_2 -> V_203 . V_211 ;
else
V_210 = & V_2 -> V_203 . V_212 ;
V_2 -> V_203 . V_213 = - 1 ;
for ( V_36 = 0 ; V_36 < V_210 -> V_214 ; V_36 ++ ) {
V_195 = V_210 -> V_195 [ V_36 ] ;
if ( V_195 ) {
if ( ! F_51 () )
F_52 ( V_195 ) ;
else
...
F_55 ( V_195 ) ;
V_210 -> V_195 [ V_36 ] = NULL ;
}
V_210 -> V_215 [ V_36 ] = NULL ;
}
F_56 ( V_210 -> V_195 ) ;
F_56 ( V_210 -> V_215 ) ;
V_210 -> V_195 = NULL ;
...
int F_57 ( struct V_1 * V_2 , enum V_190 V_128 ,
int V_218 , int V_214 , int V_185 )
{
struct V_209 * V_210 ;
int V_36 ;
int V_219 , V_8 ;
...
F_50 ( V_2 , V_128 ) ;
V_210 -> V_214 = V_214 ;
V_210 -> V_195 = F_58 ( sizeof( void * ) * V_214 , V_222 ) ;
if ( ! V_210 -> V_195 ) {
F_43 ( L_30 ) ;
return - V_223 ;
}
V_210 -> V_215 = F_58 ( sizeof( void * ) * V_214 ,
V_222 ) ;
if ( ! V_210 -> V_215 ) {
F_43 ( L_31 ) ;
F_56 ( V_210 -> V_195 ) ;
...
V_219 = V_210 -> V_224 * V_210 -> V_185 ;
for ( V_36 = 0 ; V_36 < V_210 -> V_214 ; V_36 ++ ) {
V_195 = F_59 ( V_210 -> V_224 , V_222 ) ;
if ( ! V_195 ) {
F_60 ( L_32 , V_36 ) ;
F_50 ( V_2 , V_128 ) ;
return - V_223 ;
}
V_210 -> V_195 [ V_36 ] = V_195 ;
V_210 -> V_215 [ V_36 ] = F_61 ( V_2 -> V_9 ,
V_219 , V_222 , & V_195 -> V_217 ) ;
if ( ! V_210 -> V_215 [ V_36 ] ) {
F_60 ( L_33
L_34 ,
V_219 , V_36 ,
...
memset ( V_210 -> V_215 [ V_36 ] , 0 , V_219 ) ;
V_8 = F_63 ( V_2 -> V_9 ,
V_128 == V_129 ?
V_227 : V_228 ) ;
F_64 ( V_195 , V_2 -> V_9 , V_8 ,
V_210 -> V_215 [ V_36 ] , V_219 ,
F_45 , V_2 , 1 ) ;
V_195 -> V_205 = V_210 -> V_224 ;
V_195 -> V_229 = V_230 | V_231 ;
V_221 = 0 ;
for ( V_220 = 0 ; V_220 < V_210 -> V_224 ; V_220 ++ ) {
V_195 -> V_206 [ V_220 ] . V_232 = V_221 ;
V_195 -> V_206 [ V_220 ] . V_233 =
V_210 -> V_185 ;
V_221 += V_210 -> V_185 ;
}
}
...
F_31 ( V_2 , 1 ) ;
for ( V_36 = 0 ; V_36 < V_210 -> V_214 ; V_36 ++ ) {
V_28 = F_49 ( V_210 -> V_195 [ V_36 ] , V_208 ) ;
if ( V_28 ) {
F_60 ( L_38 , V_36 ,
V_28 ) ;
F_50 ( V_2 , V_128 ) ;
...
{
F_68 ( & V_2 -> V_241 , 0 , V_242 , V_243 , 0 ) ;
F_68 ( & V_2 -> V_241 , 0 , V_244 , V_245 ,
F_25 ( V_2 -> V_61 ) -> V_246 , 0 , 0 ) ;
F_68 ( & V_2 -> V_241 , 0 , V_244 , V_247 , 0 ) ;
}
int F_69 ( struct V_248 * V_249 )
{
struct V_1 * V_2 = NULL ;
F_4 ( & V_250 ) ;
F_70 ( & V_249 -> V_251 , & V_252 ) ;
F_71 (dev, &em28xx_devlist, devlist) {
V_249 -> V_253 ( V_2 ) ;
}
F_6 ( & V_250 ) ;
F_3 ( V_254 L_39 , V_249 -> V_255 ) ;
return 0 ;
}
void F_72 ( struct V_248 * V_249 )
{
struct V_1 * V_2 = NULL ;
F_4 ( & V_250 ) ;
F_71 (dev, &em28xx_devlist, devlist) {
...
F_73 ( & V_249 -> V_251 ) ;
F_6 ( & V_250 ) ;
F_3 ( V_254 L_40 , V_249 -> V_255 ) ;
}
void F_74 ( struct V_1 * V_2 )
{
const struct V_248 * V_249 = NULL ;
F_4 ( & V_250 ) ;
F_70 ( & V_2 -> V_257 , & V_258 ) ;
