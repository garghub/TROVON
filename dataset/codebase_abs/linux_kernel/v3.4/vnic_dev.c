...
int V_56 = 1000 ;
if ( F_30 ( V_2 , V_97 ) )
return F_29 ( V_2 , V_97 , & V_75 , & V_76 , V_56 ) ;
else
...
int F_78 ( struct V_1 * V_2 , T_2 * V_109 )
{
T_4 V_75 , V_76 ;
int V_56 = 1000 ;
int V_59 ;
for ( V_59 = 0 ; V_59 < V_110 ; V_59 ++ )
( ( T_2 * ) & V_75 ) [ V_59 ] = V_109 [ V_59 ] ;
return F_29 ( V_2 , V_167 , & V_75 , & V_76 , V_56 ) ;
}
