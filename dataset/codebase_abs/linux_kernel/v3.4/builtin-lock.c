...
static int F_47 ( struct V_96 * T_6 V_44 ,
union V_97 * V_43 ,
struct V_98 * V_99 ,
struct V_100 * T_7 V_44 ,
struct V_101 * V_101 )
{
struct V_45 * V_45 = F_48 ( V_101 , V_99 -> V_2 ) ;
if ( V_45 == NULL ) {
F_49 ( L_40 ,
V_43 -> V_102 . type ) ;
return - 1 ;
}
F_34 ( V_99 -> V_103 , V_99 -> T_4 , V_99 -> time , V_45 ) ;
return 0 ;
}
static int F_50 ( void )
{
V_91 = F_51 ( V_104 , V_105 , 0 , false , & V_106 ) ;
if ( ! V_91 )
F_9 ( L_41 ) ;
return F_52 ( V_91 , & V_106 ) ;
}
...
static int F_56 ( int V_107 , const char * * V_108 )
{
unsigned int V_109 , V_22 , V_110 ;
const char * * V_111 ;
V_109 = F_57 ( V_112 ) + V_107 - 1 ;
V_111 = calloc ( V_109 + 1 , sizeof( char * ) ) ;
if ( V_111 == NULL )
return - V_113 ;
for ( V_22 = 0 ; V_22 < F_57 ( V_112 ) ; V_22 ++ )
V_111 [ V_22 ] = F_58 ( V_112 [ V_22 ] ) ;
for ( V_110 = 1 ; V_110 < ( unsigned int ) V_107 ; V_110 ++ , V_22 ++ )
V_111 [ V_22 ] = V_108 [ V_110 ] ;
F_4 ( V_22 != V_109 ) ;
return F_59 ( V_22 , V_111 , NULL ) ;
}
int F_60 ( int V_107 , const char * * V_108 , const char * T_8 V_44 )
{
unsigned int V_22 ;
F_61 () ;
for ( V_22 = 0 ; V_22 < V_93 ; V_22 ++ )
F_10 ( V_114 + V_22 ) ;
V_107 = F_62 ( V_107 , V_108 , V_115 , V_116 ,
V_117 ) ;
if ( ! V_107 )
F_63 ( V_116 , V_115 ) ;
