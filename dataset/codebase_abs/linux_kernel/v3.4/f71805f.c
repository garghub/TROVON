...
static int T_5 F_88 ( struct V_65 * V_66 )
{
struct V_67 * V_68 = V_66 -> V_14 . V_69 ;
struct V_8 * V_9 ;
struct V_70 * V_71 ;
int V_62 , V_47 ;
...
V_9 = F_89 ( sizeof( struct V_8 ) , V_73 ) ;
if ( ! V_9 ) {
V_47 = - V_74 ;
F_90 ( L_12 ) ;
goto exit;
}
V_71 = F_91 ( V_66 , V_75 , 0 ) ;
if ( ! F_92 ( V_71 -> V_76 + V_11 , 2 , V_77 ) ) {
V_47 = - V_78 ;
F_93 ( & V_66 -> V_14 , L_13 ,
( unsigned long ) ( V_71 -> V_76 + V_11 ) ,
( unsigned long ) ( V_71 -> V_76 + V_11 + 1 ) ) ;
goto V_79;
}
V_9 -> V_10 = V_71 -> V_76 ;
V_9 -> V_61 = V_72 [ V_68 -> V_80 ] ;
F_94 ( & V_9 -> V_17 ) ;
F_95 ( V_66 , V_9 ) ;
switch ( V_68 -> V_80 ) {
case V_81 :
...
F_86 ( V_9 ) ;
V_47 = F_96 ( & V_66 -> V_14 . V_53 , & V_84 ) ;
if ( V_47 )
goto V_85;
if ( V_9 -> V_22 & ( 1 << 4 ) ) {
V_47 = F_96 ( & V_66 -> V_14 . V_53 ,
& V_86 [ 0 ] ) ;
if ( V_47 )
goto V_87;
}
...
V_9 -> V_89 = F_98 ( & V_66 -> V_14 ) ;
if ( F_99 ( V_9 -> V_89 ) ) {
V_47 = F_100 ( V_9 -> V_89 ) ;
F_93 ( & V_66 -> V_14 , L_14 , V_47 ) ;
goto V_87;
}
return 0 ;
V_87:
F_101 ( & V_66 -> V_14 . V_53 , & V_84 ) ;
for ( V_62 = 0 ; V_62 < 4 ; V_62 ++ )
F_101 ( & V_66 -> V_14 . V_53 , & V_86 [ V_62 ] ) ;
F_101 ( & V_66 -> V_14 . V_53 , & V_90 ) ;
V_85:
F_102 ( V_71 -> V_76 + V_11 , 2 ) ;
V_79:
F_95 ( V_66 , NULL ) ;
F_103 ( V_9 ) ;
exit:
...
static int T_6 F_104 ( struct V_65 * V_66 )
{
struct V_8 * V_9 = F_105 ( V_66 ) ;
struct V_70 * V_71 ;
int V_62 ;
F_106 ( V_9 -> V_89 ) ;
F_101 ( & V_66 -> V_14 . V_53 , & V_84 ) ;
...
if ( V_47 )
goto V_95;
V_47 = F_110 ( V_66 , & V_71 , 1 ) ;
if ( V_47 ) {
F_90 ( L_16 , V_47 ) ;
goto V_95;
}
V_47 = F_111 ( V_66 , V_68 ,
sizeof( struct V_67 ) ) ;
if ( V_47 ) {
F_90 ( L_17 ) ;
goto V_95;
...
unsigned short V_91 ;
struct V_67 V_68 ;
if ( F_114 ( 0x2e , & V_91 , & V_68 )
&& F_114 ( 0x4e , & V_91 , & V_68 ) )
return - V_97 ;
V_47 = F_118 ( & V_110 ) ;
if ( V_47 )
goto exit;
V_47 = F_107 ( V_91 , & V_68 ) ;
if ( V_47 )
goto V_111;
return 0 ;
V_111:
