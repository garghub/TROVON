...
int V_60 ;
F_3 ( L_9 , V_10 ) ;
V_60 = F_33 ( V_10 -> V_34 -> V_61 , & V_10 -> V_32 -> V_33 . V_25 . V_27 ) ;
F_14 ( V_10 ) ;
return V_60 ;
}
static void F_34 ( struct V_62 * V_62 )
{
struct V_9 * V_10 = F_35 ( V_62 , struct V_9 , V_16 ) ;
...
static int F_27 ( struct V_41 * V_42 , struct V_24 * V_25 )
{
F_43 ( & V_42 -> V_33 . V_25 . V_27 , & V_25 -> V_27 ) ;
memcpy ( & V_42 -> V_33 . V_25 . V_67 , & V_25 -> V_67 , sizeof( V_42 -> V_33 . V_25 . V_67 ) ) ;
V_42 -> V_33 . V_25 . V_68 = F_44 () -> V_69 ;
...
void * V_8 = F_45 ( V_25 -> V_70 . V_6 , V_43 ) ;
if ( ! V_8 )
return 0 ;
...
F_30 ( V_42 -> V_33 . V_25 . V_70 . V_8 ) ;
F_46 ( & V_42 -> V_33 . V_25 . V_27 ) ;
}
static T_2
F_47 ( struct V_37 * V_38 , struct V_9 * V_10 )
{
T_2 V_60 = V_75 ;
V_10 -> V_76 |= V_77 ;
F_11 ( V_10 , V_78 ) ;
...
F_3 ( L_11 ,
V_10 , V_10 -> V_76 , F_48 ( V_60 ) ) ;
return V_60 ;
}
T_2
F_49 ( struct V_37 * V_38 , struct V_22 * V_23 ,
...
V_10 = F_16 ( V_23 , V_25 ) ;
if ( V_10 == NULL ) {
struct V_26 * V_106 = F_24 ( sizeof( * V_106 ) , V_43 ) ;
if ( V_106 == NULL )
return V_95 ;
V_10 = F_21 ( V_38 , V_40 , V_23 , V_25 , V_2 ) ;
if ( V_10 == NULL ) {
...
T_2
F_54 ( struct V_22 * V_23 , struct V_24 * V_25 )
{
int error ;
F_3 ( L_20 ,
V_23 -> V_61 -> V_87 . V_88 -> V_89 -> V_90 -> V_91 ,
...
T_2
F_55 ( struct V_22 * V_23 , struct V_24 * V_25 )
{
struct V_9 * V_10 ;
int V_60 = 0 ;
F_3 ( L_21 ,
...
static int F_63 ( struct V_26 * V_115 , struct V_26 * V_116 )
{
return V_115 -> V_117 == V_116 -> V_117 && V_115 -> V_28 == V_116 -> V_28 ;
}
static void
...
V_10 -> V_94 = 1 ;
F_11 ( V_10 , V_18 ) ;
error = F_66 ( V_10 -> V_32 , V_121 ,
& V_122 ) ;
if ( error < 0 )
F_11 ( V_10 , 10 * V_120 ) ;
}
static void F_67 ( struct V_123 * V_124 , void * V_8 )
{
