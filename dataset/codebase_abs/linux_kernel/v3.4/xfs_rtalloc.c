...
F_58 ( V_6 ) ;
V_102 = V_100 ;
F_59 ( V_102 , V_97 -> V_117 ) ;
V_101 = F_60 ( V_102 , V_120 * V_110 -> V_35 ) ;
V_103 = F_27 ( V_102 ) ;
V_105 = V_103 + 1 ;
V_106 = ( V_95 ) sizeof( T_12 ) * V_105 * V_101 ;
V_104 = F_61 ( V_1 , V_106 ) ;
V_106 = F_57 ( V_1 , V_104 ) ;
if ( V_104 > ( V_1 -> V_34 . V_121 >> 1 ) )
return F_10 ( V_119 ) ;
V_108 = F_61 ( V_1 , V_1 -> V_74 -> V_122 . V_123 ) ;
V_109 = F_61 ( V_1 , V_1 -> V_73 -> V_122 . V_123 ) ;
...
if ( error )
return error ;
V_99 = F_62 ( sizeof( * V_99 ) , V_124 ) ;
for ( V_98 = V_110 -> V_62 -
( ( V_110 -> V_60 & ( ( 1 << V_1 -> V_125 ) - 1 ) ) != 0 ) ;
V_98 < V_101 ;
V_98 ++ ) {
T_10 * V_16 ;
int V_15 = 0 ;
...
F_59 ( V_107 -> V_60 , V_107 -> V_118 ) ;
ASSERT ( V_107 -> V_60 != 0 ) ;
V_107 -> V_126 = F_27 ( V_107 -> V_60 ) ;
V_105 = V_99 -> V_61 = V_107 -> V_126 + 1 ;
V_106 =
( V_95 ) sizeof( T_12 ) * V_105 *
V_107 -> V_62 ;
V_104 = F_61 ( V_1 , V_106 ) ;
V_99 -> V_127 = V_106 = F_57 ( V_1 , V_104 ) ;
V_16 = F_2 ( V_1 , V_128 ) ;
if ( ( error = F_4 ( V_16 , 0 ,
F_63 ( V_99 ) , 0 , 0 , 0 ) ) )
goto V_20;
...
V_1 -> V_74 -> V_122 . V_123 =
V_107 -> V_62 * V_107 -> V_35 ;
F_64 ( V_16 , V_1 -> V_74 , V_129 ) ;
V_15 |= V_23 ;
F_6 ( V_1 -> V_73 , V_22 ) ;
F_7 ( V_16 , V_1 -> V_73 , V_22 ) ;
V_1 -> V_73 -> V_122 . V_123 = V_99 -> V_127 ;
F_64 ( V_16 , V_1 -> V_73 , V_129 ) ;
...
if ( V_107 -> V_126 != V_110 -> V_126 )
F_66 ( V_16 , V_134 ,
V_107 -> V_126 - V_110 -> V_126 ) ;
V_6 = NULL ;
...
& V_138 , & V_91 , V_43 , & V_59 ) ;
break;
case V_140 :
error = F_25 ( V_1 , V_16 , V_5 , V_37 , V_38 ,
V_39 , & V_138 , & V_91 , V_43 , & V_59 ) ;
break;
case V_141 :
...
return error ;
if ( V_59 != V_53 ) {
long V_142 = ( long ) * V_39 ;
ASSERT ( * V_39 >= V_37 && * V_39 <= V_38 ) ;
if ( V_136 )
F_66 ( V_16 , V_143 , - V_142 ) ;
else
F_66 ( V_16 , V_135 , - V_142 ) ;
}
* V_44 = V_59 ;
return 0 ;
}
...
T_5 * V_138 ;
V_1 = V_16 -> V_137 ;
ASSERT ( V_1 -> V_74 -> V_144 != NULL ) ;
ASSERT ( F_69 ( V_1 -> V_74 , V_22 ) ) ;
#if F_71 ( V_145 ) && F_71 ( V_146 )
{
int V_50 ;
...
#endif
V_138 = NULL ;
error = F_48 ( V_1 , V_16 , V_5 , V_39 , & V_138 , & V_91 ) ;
if ( error ) {
return error ;
}
F_66 ( V_16 , V_135 , ( long ) V_39 ) ;
if ( V_16 -> V_147 + V_1 -> V_34 . V_148 ==
V_1 -> V_34 . V_60 ) {
if ( ! ( V_1 -> V_74 -> V_122 . V_149 & V_150 ) )
V_1 -> V_74 -> V_122 . V_149 |= V_150 ;
* ( V_151 * ) & V_1 -> V_74 -> V_122 . V_152 = 0 ;
F_64 ( V_16 , V_1 -> V_74 , V_129 ) ;
}
return 0 ;
}
...
V_1 -> V_61 = V_110 -> V_126 + 1 ;
V_1 -> V_127 =
( V_95 ) sizeof( T_12 ) * V_1 -> V_61 *
V_110 -> V_62 ;
V_1 -> V_127 = F_74 ( V_1 -> V_127 , V_110 -> V_35 ) ;
...
return 0 ;
error = F_77 ( V_1 , NULL , V_110 -> V_155 , 0 , 0 , & V_1 -> V_74 ) ;
if ( error )
return error ;
ASSERT ( V_1 -> V_74 != NULL ) ;
ASSERT ( V_110 -> V_157 != V_156 ) ;
error = F_77 ( V_1 , NULL , V_110 -> V_157 , 0 , 0 , & V_1 -> V_73 ) ;
if ( error ) {
F_78 ( V_1 -> V_74 ) ;
return error ;
}
...
V_151 * V_163 ;
ASSERT ( F_69 ( V_1 -> V_74 , V_22 ) ) ;
V_163 = ( V_151 * ) & V_1 -> V_74 -> V_122 . V_152 ;
if ( ! ( V_1 -> V_74 -> V_122 . V_149 & V_150 ) ) {
V_1 -> V_74 -> V_122 . V_149 |= V_150 ;
* V_163 = 0 ;
}
V_162 = * V_163 ;
if ( ( V_160 = F_81 ( V_162 ) ) == - 1 )
V_79 = 0 ;
else {
