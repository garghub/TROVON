...
F_24 ( V_52 , 2 , L_205 ) ;
F_27 ( V_52 , 2 , L_206 , ( T_1 ) V_123 -> V_126 . V_455 ) ;
F_27 ( V_52 , 2 , L_206 , ( T_1 ) V_123 -> V_126 . V_456 ) ;
return 0 ;
}
...
if ( V_123 -> V_110 . V_461 . V_126 . V_472 == 1 ) {
memcpy ( V_681 -> V_688 + V_681 -> V_686 ,
( char * ) V_683 ,
...
int F_327 ( struct V_1 * V_2 , char T_4 * V_688 )
{
struct V_105 * V_106 ;
struct V_122 * V_123 ;
struct V_689 * V_690 ;
...
if ( F_328 ( & V_691 , V_688 + sizeof( int ) , sizeof( int ) ) )
return - V_693 ;
V_690 = F_329 ( V_688 , V_691 + sizeof( struct V_694 ) ) ;
if ( F_98 ( V_690 ) ) {
F_11 ( V_2 , 2 , L_282 ) ;
return F_99 ( V_690 ) ;
}
V_681 . V_685 = V_690 -> V_126 . V_572 ;
V_681 . V_688 = F_15 ( V_681 . V_685 , V_38 ) ;
if ( ! V_681 . V_688 ) {
F_20 ( V_690 ) ;
return - V_39 ;
}
V_681 . V_686 = sizeof( struct V_694 ) ;
V_106 = F_255 ( V_2 , V_692 ,
V_695 + V_691 ) ;
V_123 = (struct V_122 * ) ( V_106 -> V_110 + V_386 ) ;
memcpy ( & V_123 -> V_110 . V_461 . V_110 . V_683 , & V_690 -> V_123 , V_691 ) ;
V_26 = F_320 ( V_2 , V_106 , V_696 + V_691 ,
F_325 , ( void * ) & V_681 ) ;
if ( V_26 )
F_51 ( 2 , L_283 ,
F_64 ( V_2 ) , V_26 ) ;
else {
if ( F_330 ( V_688 , V_681 . V_688 , V_681 . V_685 ) )
V_26 = - V_693 ;
}
F_20 ( V_690 ) ;
F_20 ( V_681 . V_688 ) ;
...
F_11 ( V_2 , 3 , L_284 ) ;
V_123 = (struct V_122 * ) V_110 ;
V_698 = (struct V_697 * ) V_118 -> V_382 ;
V_700 = V_123 -> V_110 . V_461 . V_126 . V_469 ;
V_699 = ( char * ) V_110 + 28 ;
if ( V_700 > ( V_698 -> V_701 - V_698 -> V_702 ) ) {
V_123 -> V_126 . V_132 = V_703 ;
return 0 ;
}
memcpy ( ( V_698 -> V_66 + V_698 -> V_702 ) , V_699 ,
V_700 ) ;
V_698 -> V_702 += V_700 ;
if ( V_123 -> V_110 . V_461 . V_126 . V_472 <
V_123 -> V_110 . V_461 . V_126 . V_471 )
...
int F_332 ( struct V_1 * V_2 , char T_4 * V_688 )
{
int V_26 = 0 ;
struct V_105 * V_106 ;
struct V_122 * V_123 ;
...
if ( F_328 ( & V_707 , V_688 ,
sizeof( struct V_706 ) ) ) {
V_26 = - V_693 ;
goto V_60;
}
V_698 . V_701 = V_707 . V_701 ;
V_698 . V_702 = 0 ;
V_698 . V_66 = F_15 ( V_707 . V_701 , V_38 ) ;
if ( ! V_698 . V_66 ) {
V_26 = - V_39 ;
goto V_60;
}
V_106 = F_255 ( V_2 , V_708 ,
sizeof( struct V_636 ) +
sizeof( struct V_704 ) ) ;
V_123 = (struct V_122 * ) ( V_106 -> V_110 + V_386 ) ;
V_705 = & V_123 -> V_110 . V_461 . V_110 . V_709 ;
V_705 -> V_630 = V_707 . V_127 ;
V_26 = F_251 ( V_2 , V_106 , F_331 ,
& V_698 ) ;
if ( ! V_26 ) {
if ( F_333 () )
V_30 = F_334 ( V_707 . V_32 ) ;
else
V_30 = ( void T_4 * ) ( unsigned long ) V_707 . V_32 ;
if ( F_330 ( V_30 , V_698 . V_66 ,
V_698 . V_702 ) ) {
V_26 = - V_693 ;
goto V_710;
}
V_707 . V_702 = V_698 . V_702 ;
if ( F_330 ( V_688 , & V_707 ,
sizeof( struct V_706 ) ) )
V_26 = - V_693 ;
} else
if ( V_26 == V_703 )
...
F_152 ( V_2 , V_344 ) ;
F_20 ( V_344 ) ;
V_26 = F_338 ( V_711 , & V_2 -> V_715 ) ;
if ( V_26 )
F_27 ( V_52 , 2 , L_183 , V_26 ) ;
F_27 ( V_52 , 2 , L_288 , V_2 -> V_715 . V_716 ) ;
F_27 ( V_52 , 2 , L_289 , V_2 -> V_715 . V_717 ) ;
F_27 ( V_52 , 2 , L_289 , V_2 -> V_715 . V_718 ) ;
F_27 ( V_52 , 2 , L_290 , V_2 -> V_715 . V_719 ) ;
if ( ! ( ( V_2 -> V_715 . V_716 != V_720 ) ||
( ( V_2 -> V_715 . V_717 & V_721 ) == 0 ) ||
( ( V_2 -> V_715 . V_718 & V_722 ) == 0 ) ) ) {
F_72 ( & V_2 -> V_72 -> V_73 ,
L_291 ) ;
} else {
V_2 -> V_49 . V_50 = V_546 ;
...
F_341 [ V_33 ] = V_2 -> V_280 . V_732 ;
F_340 ( V_2 , V_723 , F_341 ) ;
V_727 =
...
for ( V_33 = 0 , V_728 = 0 ; V_33 < V_2 -> V_35 . V_68 ; ++ V_33 )
for ( V_34 = 0 ; V_34 < V_55 ; ++ V_34 , ++ V_728 ) {
V_727 [ V_728 ] = (struct V_56 * ) F_289 (
V_2 -> V_35 . V_70 [ V_33 ] -> V_65 [ V_34 ] -> V_66 ) ;
}
memset ( & V_725 , 0 , sizeof( struct V_724 ) ) ;
V_725 . V_179 = F_26 ( V_2 ) ;
V_725 . V_734 = F_335 ( V_2 ) ;
V_725 . V_735 = 0 ;
V_725 . V_726 = V_726 ;
V_725 . V_736 = V_2 -> V_35 . V_59 ;
V_725 . V_737 = V_2 -> V_35 . V_68 ;
V_725 . V_738 = V_2 -> V_280 . V_738 ;
V_725 . V_739 = V_2 -> V_280 . V_739 ;
V_725 . V_740 = F_341 ;
V_725 . V_741 = ( unsigned long ) V_2 ;
V_725 . V_742 = ( void * * ) V_723 ;
V_725 . V_743 = ( void * * ) V_727 ;
V_725 . V_744 = V_2 -> V_35 . V_67 ;
V_725 . V_745 =
...
static int F_347 ( const char * V_217 , struct V_746 * V_747 ,
unsigned long V_748 )
{
return F_348 ( V_747 , V_748 ,
& V_749 , 3 , V_217 ) ;
}
...
static inline int F_351 ( struct V_438 * V_755 ,
struct V_756 * V_231 ,
struct V_218 * * V_757 , int V_168 , int * V_758 , int V_572 )
{
...
* V_757 = F_243 ( V_439 + V_440 ) ;
if ( ! ( * V_757 ) )
return - V_39 ;
}
F_352 ( * V_757 , V_440 ) ;
if ( V_572 <= V_439 ) {
memcpy ( F_353 ( * V_757 , V_572 ) , V_231 -> V_236 + V_168 ,
V_572 ) ;
} else {
F_354 ( V_434 ) ;
memcpy ( F_353 ( * V_757 , V_439 ) ,
V_231 -> V_236 + V_168 , V_439 ) ;
F_355 ( * V_757 , * V_758 , V_434 ,
V_168 + V_439 ,
V_572 - V_439 ) ;
( * V_757 ) -> V_572 += V_572 - V_439 ;
( * V_757 ) -> V_147 += V_572 - V_439 ;
( * V_757 ) -> V_759 += V_572 - V_439 ;
( * V_758 ) ++ ;
}
} else {
F_354 ( V_434 ) ;
F_355 ( * V_757 , * V_758 , V_434 , V_168 , V_572 ) ;
( * V_757 ) -> V_572 += V_572 ;
( * V_757 ) -> V_147 += V_572 ;
( * V_757 ) -> V_759 += V_572 ;
( * V_758 ) ++ ;
...
struct V_218 * F_356 ( struct V_1 * V_2 ,
struct V_438 * V_755 ,
struct V_756 * * V_760 , int * V_761 ,
struct V_590 * * V_126 )
{
struct V_756 * V_231 = * V_760 ;
struct V_56 * V_66 = V_755 -> V_66 ;
int V_168 = * V_761 ;
...
switch ( ( * V_126 ) -> V_126 . V_766 . V_312 ) {
case V_767 :
V_762 = ( * V_126 ) -> V_126 . V_766 . V_768 ;
break;
case V_769 :
V_762 = ( * V_126 ) -> V_126 . V_594 . V_239 ;
...
break;
case V_771 :
V_762 = ( * V_126 ) -> V_126 . V_772 . V_773 ;
V_764 = sizeof( struct V_590 ) ;
break;
default:
break;
}
if ( ! V_762 )
return NULL ;
if ( ( ( V_762 >= V_2 -> V_49 . V_271 ) &&
( ! ( V_2 -> V_3 . type == V_9 ) ) &&
( ! F_34 ( & V_2 -> V_513 ) ) ) ||
( V_2 -> V_49 . V_50 == V_51 ) ) {
V_765 = 1 ;
} else {
V_219 = F_243 ( V_762 + V_764 ) ;
if ( ! V_219 )
goto V_774;
if ( V_764 )
F_352 ( V_219 , V_764 ) ;
}
V_763 = V_231 -> V_236 + V_168 ;
while ( V_762 ) {
V_572 = F_358 ( V_762 , ( int ) ( V_231 -> V_239 - V_168 ) ) ;
if ( V_572 ) {
if ( V_765 ) {
if ( F_351 ( V_755 , V_231 ,
& V_219 , V_168 , & V_583 , V_572 ) )
goto V_774;
} else {
memcpy ( F_353 ( V_219 , V_572 ) , V_763 ,
V_572 ) ;
}
}
V_762 -= V_572 ;
...
* V_760 = V_231 ;
* V_761 = V_168 ;
if ( V_765 && V_2 -> V_49 . V_270 ) {
V_2 -> V_436 . V_775 ++ ;
V_2 -> V_436 . V_776 += F_296 ( V_219 ) -> V_574 ;
}
return V_219 ;
V_774:
if ( F_360 () ) {
...
F_362 ( V_779 [ V_777 ] . V_312 ) ;
V_779 [ V_777 ] . V_312 = NULL ;
}
}
void F_363 ( T_5 * V_312 , int V_371 , char * V_780 , ... )
{
char V_781 [ 32 ] ;
T_6 args ;
...
return;
va_start ( args , V_780 ) ;
vsnprintf ( V_781 , sizeof( V_781 ) , V_780 , args ) ;
va_end ( args ) ;
F_364 ( V_312 , V_371 , V_781 ) ;
}
...
int V_777 ;
for ( V_777 = 0 ; V_777 < V_778 ; V_777 ++ ) {
V_779 [ V_777 ] . V_312 = F_366 ( V_779 [ V_777 ] . V_497 ,
V_779 [ V_777 ] . V_782 ,
V_779 [ V_777 ] . V_783 ,
V_779 [ V_777 ] . V_147 ) ;
if ( V_779 [ V_777 ] . V_312 == NULL ) {
F_361 () ;
return - V_39 ;
}
V_336 = F_367 ( V_779 [ V_777 ] . V_312 , V_779 [ V_777 ] . V_784 ) ;
if ( V_336 ) {
F_361 () ;
return V_336 ;
}
F_368 ( V_779 [ V_777 ] . V_312 , V_779 [ V_777 ] . V_371 ) ;
}
return 0 ;
}
...
F_375 ( V_789 ) ;
V_2 -> V_280 . V_788 = NULL ;
}
static int F_376 ( struct V_792 * V_72 )
{
struct V_1 * V_2 ;
struct V_746 * V_73 ;
int V_26 ;
...
snprintf ( V_793 , sizeof( V_793 ) , L_309 ,
F_52 ( & V_72 -> V_73 ) ) ;
V_2 -> V_796 = F_366 ( V_793 , 2 , 1 , 8 ) ;
if ( ! V_2 -> V_796 ) {
F_27 ( V_52 , 2 , L_186 , L_310 ) ;
V_26 = - V_39 ;
goto V_797;
}
F_367 ( V_2 -> V_796 , & V_798 ) ;
V_2 -> V_107 . V_112 = V_72 -> V_179 [ 0 ] ;
V_2 -> V_142 . V_112 = V_72 -> V_179 [ 1 ] ;
V_2 -> V_110 . V_112 = V_72 -> V_179 [ 2 ] ;
F_378 ( & V_72 -> V_73 , V_2 ) ;
V_2 -> V_72 = V_72 ;
V_72 -> V_179 [ 0 ] -> V_799 = F_100 ;
V_72 -> V_179 [ 1 ] -> V_799 = F_100 ;
V_72 -> V_179 [ 2 ] -> V_799 = F_100 ;
V_26 = F_134 ( V_2 ) ;
if ( V_26 ) {
F_27 ( V_52 , 2 , L_136 , V_26 ) ;
goto V_800;
...
case V_9 :
case V_7 :
V_26 = F_369 ( V_2 , V_790 ) ;
if ( V_26 )
goto V_801;
V_26 = V_2 -> V_280 . V_788 -> V_802 ( V_2 -> V_72 ) ;
if ( V_26 )
goto V_803;
case V_5 :
case V_8 :
...
F_381 ( & V_804 . V_805 , V_21 ) ;
F_84 ( & V_2 -> V_31 , & V_804 . V_31 ) ;
F_382 ( & V_804 . V_805 , V_21 ) ;
F_336 ( V_2 ) ;
return 0 ;
V_803:
F_374 ( V_2 ) ;
...
static void F_386 ( struct V_792 * V_72 )
{
unsigned long V_21 ;
struct V_1 * V_2 = F_387 ( & V_72 -> V_73 ) ;
F_24 ( V_52 , 2 , L_311 ) ;
if ( V_2 -> V_3 . type == V_9 ) {
F_383 ( & V_72 -> V_73 ) ;
} else {
...
F_382 ( & V_804 . V_805 , V_21 ) ;
F_344 ( V_2 ) ;
F_378 ( & V_72 -> V_73 , NULL ) ;
F_385 ( & V_72 -> V_73 ) ;
return;
}
static int F_388 ( struct V_792 * V_72 )
{
struct V_1 * V_2 = F_387 ( & V_72 -> V_73 ) ;
int V_26 = 0 ;
int V_806 ;
...
V_26 = V_2 -> V_280 . V_788 -> V_808 ( V_72 ) ;
V_807:
return V_26 ;
}
static int F_389 ( struct V_792 * V_72 )
{
struct V_1 * V_2 = F_387 ( & V_72 -> V_73 ) ;
return V_2 -> V_280 . V_788 -> V_809 ( V_72 ) ;
}
static void F_390 ( struct V_792 * V_72 )
{
struct V_1 * V_2 = F_387 ( & V_72 -> V_73 ) ;
if ( V_2 -> V_280 . V_788 &&
V_2 -> V_280 . V_788 -> V_810 )
V_2 -> V_280 . V_788 -> V_810 ( V_72 ) ;
}
static int F_391 ( struct V_792 * V_72 )
{
struct V_1 * V_2 = F_387 ( & V_72 -> V_73 ) ;
if ( V_2 -> V_280 . V_788 &&
V_2 -> V_280 . V_788 -> V_811 )
return V_2 -> V_280 . V_788 -> V_811 ( V_72 ) ;
return 0 ;
}
static void F_392 ( struct V_792 * V_72 )
{
struct V_1 * V_2 = F_387 ( & V_72 -> V_73 ) ;
if ( V_2 -> V_280 . V_788 &&
V_2 -> V_280 . V_788 -> V_812 )
V_2 -> V_280 . V_788 -> V_812 ( V_72 ) ;
}
static int F_393 ( struct V_792 * V_72 )
{
struct V_1 * V_2 = F_387 ( & V_72 -> V_73 ) ;
if ( V_2 -> V_280 . V_788 &&
V_2 -> V_280 . V_788 -> V_813 )
return V_2 -> V_280 . V_788 -> V_813 ( V_72 ) ;
return 0 ;
}
static int F_394 ( struct V_792 * V_72 )
{
struct V_1 * V_2 = F_387 ( & V_72 -> V_73 ) ;
if ( V_2 -> V_280 . V_788 &&
V_2 -> V_280 . V_788 -> V_814 )
return V_2 -> V_280 . V_788 -> V_814 ( V_72 ) ;
return 0 ;
}
static int F_395 ( struct V_792 * V_72 )
{
struct V_1 * V_2 = F_387 ( & V_72 -> V_73 ) ;
if ( V_2 -> V_280 . V_788 &&
V_2 -> V_280 . V_788 -> V_815 )
return V_2 -> V_280 . V_788 -> V_815 ( V_72 ) ;
return 0 ;
}
static T_7
F_396 ( struct V_816 * V_817 , const char * V_217 ,
T_8 V_151 )
{
int V_807 ;
V_807 = F_347 ( V_217 , V_818 ,
V_819 . V_748 ) ;
if ( V_807 )
return V_807 ;
else
...
int F_397 ( struct V_607 * V_73 , int V_820 )
{
switch ( V_820 ) {
case V_821 :
return ( sizeof( V_822 ) / V_823 ) ;
default:
return - V_401 ;
}
}
void F_398 ( struct V_607 * V_73 ,
struct V_824 * V_508 , T_9 * V_110 )
{
struct V_1 * V_2 = V_73 -> V_612 ;
V_110 [ 0 ] = V_2 -> V_508 . V_825 -
V_2 -> V_436 . V_826 ;
V_110 [ 1 ] = V_2 -> V_436 . V_827 ;
V_110 [ 2 ] = V_2 -> V_508 . V_828 -
V_2 -> V_436 . V_829 ;
V_110 [ 3 ] = V_2 -> V_436 . V_537 ;
V_110 [ 4 ] = V_2 -> V_508 . V_828 - V_2 -> V_436 . V_829
- V_2 -> V_436 . V_598 ;
V_110 [ 5 ] = V_2 -> V_436 . V_537 - V_2 -> V_436 . V_541 ;
V_110 [ 6 ] = V_2 -> V_436 . V_598 ;
V_110 [ 7 ] = V_2 -> V_436 . V_541 ;
V_110 [ 8 ] = V_2 -> V_436 . V_830 ;
V_110 [ 9 ] = V_2 -> V_436 . V_831 ;
V_110 [ 10 ] = V_2 -> V_436 . V_775 ;
V_110 [ 11 ] = V_2 -> V_436 . V_776 ;
V_110 [ 12 ] = V_2 -> V_436 . V_437 ;
V_110 [ 13 ] = ( V_2 -> V_436 . V_832 >> 10 ) ;
V_110 [ 14 ] = V_2 -> V_436 . V_833 ;
...
V_110 [ 23 ] = V_2 -> V_436 . V_834 ;
V_110 [ 24 ] = V_2 -> V_436 . V_835 ;
V_110 [ 25 ] = V_2 -> V_436 . V_517 ;
V_110 [ 26 ] = V_2 -> V_436 . V_515 ;
V_110 [ 27 ] = V_2 -> V_436 . V_560 ;
V_110 [ 28 ] = V_2 -> V_436 . V_556 ;
V_110 [ 29 ] = V_2 -> V_436 . V_836 ;
V_110 [ 30 ] = V_2 -> V_436 . V_837 ;
V_110 [ 31 ] = V_2 -> V_436 . V_534 ;
V_110 [ 32 ] = V_2 -> V_436 . V_530 ;
V_110 [ 33 ] = V_2 -> V_436 . V_838 ;
V_110 [ 34 ] = V_2 -> V_436 . V_839 ;
V_110 [ 35 ] = V_2 -> V_436 . V_548 ;
V_110 [ 36 ] = V_2 -> V_436 . V_552 ;
}
void F_399 ( struct V_607 * V_73 , V_678 V_820 , T_3 * V_110 )
{
switch ( V_820 ) {
case V_821 :
memcpy ( V_110 , & V_822 ,
...
void F_400 ( struct V_607 * V_73 ,
struct V_840 * V_3 )
{
struct V_1 * V_2 = V_73 -> V_612 ;
if ( V_2 -> V_49 . V_305 )
strcpy ( V_3 -> V_841 , L_305 ) ;
else
strcpy ( V_3 -> V_841 , L_304 ) ;
strcpy ( V_3 -> V_842 , L_312 ) ;
strcpy ( V_3 -> V_843 , V_2 -> V_3 . V_300 ) ;
sprintf ( V_3 -> V_844 , L_313 ,
F_401 ( V_2 ) ,
F_402 ( V_2 ) ,
F_403 ( V_2 ) ) ;
}
int F_404 ( struct V_607 * V_845 ,
struct V_846 * V_847 )
{
struct V_1 * V_2 = V_845 -> V_612 ;
enum V_446 V_10 ;
...
if ( V_26 )
goto V_886;
V_26 = F_410 ( & V_819 . V_841 ,
& V_887 ) ;
if ( V_26 )
goto V_888;
V_818 = F_411 ( L_315 ) ;
V_26 = F_98 ( V_818 ) ? F_99 ( V_818 ) : 0 ;
if ( V_26 )
goto V_889;
V_238 = F_412 ( L_316 ,
