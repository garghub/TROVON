...
F_72 ( V_36 , V_3 ) ;
F_15 ( V_113 , 0x00 ) ;
F_15 ( V_114 , ( V_50 -> V_60 * 4 ) ) ;
F_15 ( V_115 ,
( ( V_50 -> V_65 - 1 ) << 16 ) | ( V_50 -> V_60 - 1 ) ) ;
F_15 ( V_18 , 0x98000000 ) ;
F_15 ( V_116 , 0x00 ) ;
F_15 ( V_117 , 0x80000000 ) ;
F_15 ( V_118 , 0x00000001 ) ;
...
if ( V_122 -> V_128 )
V_122 -> V_128 ( V_36 , V_3 ) ;
V_126 = F_79 ( V_36 , & V_125 , false ) ;
if ( V_126 ) {
F_8 ( L_14 , V_3 ) ;
V_120 -> V_129 = V_130 ;
} else {
...
V_34 = F_80 ( sizeof( struct V_33 ) , V_132 ) ;
if ( ! V_34 ) {
F_8 ( L_16 ) ;
return NULL ;
}
...
V_34 -> V_92 = 1 ;
V_36 = F_78 ( V_120 ) ;
V_124 = & V_120 -> V_133 . V_133 ;
V_96 = & V_34 -> V_133 . V_133 . V_133 ;
F_81 ( V_2 ,
V_96 ,
V_122 -> V_134 ,
V_135 ) ;
...
V_120 -> V_133 . V_96 = & V_34 -> V_133 . V_133 ;
return & V_34 -> V_133 ;
}
