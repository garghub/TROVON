...
struct V_1 * V_2 , int V_137 )
{
T_1 V_11 = F_3 ( V_2 , V_5 ) ;
T_1 V_98 = F_3 ( V_2 , V_6 ) ;
T_1 V_101 = F_3 ( V_2 , V_8 ) ;
T_1 V_50 = F_3 ( V_2 , V_9 ) ;
if ( V_137 && ( V_11 & V_13 ) )
...
static int F_52 ( struct V_37 * V_38 , int V_140 ,
struct V_39 * V_40 )
{
int V_43 = 0 ;
struct V_41 * V_42 = F_12 ( V_40 ) ;
...
static int F_53 ( struct V_39 * V_147 )
{
struct V_41 * V_42 ;
int V_43 ;
...
if ( ! V_42 )
return - V_148 ;
V_42 -> V_2 = F_54 ( V_147 -> V_63 + 1 , L_12 ) ;
if ( V_42 -> V_2 == NULL ) {
V_43 = - V_70 ;
goto V_149;
}
...
static int F_56 ( struct V_39 * V_147 )
{
struct V_41 * V_42 = F_12 ( V_147 ) ;
F_57 ( V_42 -> V_2 ) ;
F_14 ( V_42 ) ;
return 0 ;
}
static T_4 int F_58 ( struct V_150 * V_3 )
{
return F_59 ( & V_3 -> V_4 , & V_151 ) ;
}
static int T_5 F_60 ( struct V_150 * V_3 )
{
F_61 ( & V_3 -> V_4 ) ;
return 0 ;
}
