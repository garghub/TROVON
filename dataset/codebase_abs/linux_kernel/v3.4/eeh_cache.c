...
unsigned long V_38 = F_22 ( V_14 , V_32 ) ;
unsigned long V_39 = F_23 ( V_14 , V_32 ) ;
unsigned int V_15 = F_24 ( V_14 , V_32 ) ;
if ( 0 == ( V_15 & ( V_21 | V_40 ) ) )
continue;
if ( V_38 == 0 || ~ V_38 == 0 || V_39 == 0 || ~ V_39 == 0 )
continue;
F_12 ( V_14 , V_38 , V_39 , V_15 ) ;
}
}
void F_25 ( struct V_1 * V_14 )
{
unsigned long V_15 ;
if ( ( V_14 -> V_41 >> 16 ) == V_42 )
return;
F_5 ( & V_5 . V_16 , V_15 ) ;
F_17 ( V_14 ) ;
F_6 ( & V_5 . V_16 , V_15 ) ;
}
static inline void F_26 ( struct V_1 * V_14 )
{
struct V_3 * V_4 ;
V_43:
V_4 = F_8 ( & V_5 . V_6 ) ;
