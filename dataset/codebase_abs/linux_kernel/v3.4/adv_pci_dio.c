...
if ( V_162 [ V_11 ] . V_163 != V_152 -> V_164 )
continue;
if ( V_162 [ V_11 ] . V_165 != V_152 -> V_166 )
continue;
if ( V_124 -> V_167 [ 0 ] || V_124 -> V_167 [ 1 ] ) {
if ( V_152 -> V_168 -> V_169 != V_124 -> V_167 [ 0 ] ||
F_39 ( V_152 -> V_170 ) != V_124 -> V_167 [ 1 ] ) {
continue;
}
}
...
if ( F_41 ( V_152 , V_174 . V_175 ) ) {
F_40 ( V_2 -> V_172 , L_6 ) ;
return - V_173 ;
}
V_13 = F_42 ( V_152 , V_74 -> V_176 ) ;
F_43 ( V_2 -> V_172 , L_7 ,
V_152 -> V_168 -> V_169 , F_39 ( V_152 -> V_170 ) ,
F_44 ( V_152 -> V_170 ) , V_13 ) ;
V_2 -> V_13 = V_13 ;
V_2 -> V_177 = V_74 -> V_178 ;
if ( V_74 -> V_75 == V_120 ) {
V_158 = 4 ;
} else {
V_158 = 0 ;
for ( V_11 = 0 ; V_11 < V_179 ; V_11 ++ )
if ( V_74 -> V_180 [ V_11 ] . V_146 )
V_158 ++ ;
for ( V_11 = 0 ; V_11 < V_181 ; V_11 ++ )
if ( V_74 -> V_182 [ V_11 ] . V_146 )
V_158 ++ ;
for ( V_11 = 0 ; V_11 < V_183 ; V_11 ++ )
V_158 += V_74 -> V_184 [ V_11 ] . V_12 ;
if ( V_74 -> V_185 . V_146 )
V_158 ++ ;
for ( V_11 = 0 ; V_11 < V_186 ; V_11 ++ )
if ( V_74 -> V_187 [ V_11 ] . V_146 )
V_158 ++ ;
}
V_23 = F_45 ( V_2 , V_158 ) ;
if ( V_23 < 0 )
...
if ( V_74 -> V_180 [ V_11 ] . V_146 ) {
V_4 = V_2 -> V_126 + V_125 ;
F_32 ( V_2 , V_4 , & V_74 -> V_180 [ V_11 ] , V_125 ) ;
V_125 ++ ;
}
for ( V_11 = 0 ; V_11 < V_181 ; V_11 ++ )
if ( V_74 -> V_182 [ V_11 ] . V_146 ) {
V_4 = V_2 -> V_126 + V_125 ;
F_33 ( V_2 , V_4 , & V_74 -> V_182 [ V_11 ] , V_125 ) ;
V_125 ++ ;
}
for ( V_11 = 0 ; V_11 < V_183 ; V_11 ++ )
for ( V_159 = 0 ; V_159 < V_74 -> V_184 [ V_11 ] . V_12 ; V_159 ++ ) {
V_4 = V_2 -> V_126 + V_125 ;
F_46 ( V_2 , V_4 , NULL ,
V_2 -> V_13 +
V_74 -> V_184 [ V_11 ] . V_14 +
V_188 * V_159 ) ;
V_125 ++ ;
}
if ( V_74 -> V_185 . V_146 ) {
V_4 = V_2 -> V_126 + V_125 ;
V_4 -> type = V_127 ;
F_32 ( V_2 , V_4 , & V_74 -> V_185 , V_125 ) ;
V_125 ++ ;
}
for ( V_11 = 0 ; V_11 < V_186 ; V_11 ++ )
if ( V_74 -> V_187 [ V_11 ] . V_146 ) {
V_4 = V_2 -> V_126 + V_125 ;
F_34 ( V_2 , V_4 , & V_74 -> V_187 [ V_11 ] , V_125 ) ;
V_125 ++ ;
}
if ( V_74 -> V_75 == V_120 )
F_31 ( V_2 , V_124 ) ;
...
static int T_1 F_51 ( struct V_151 * V_2 ,
const struct V_190 * V_191 )
{
return F_52 ( V_2 , V_174 . V_175 ) ;
}
static void T_2 F_53 ( struct V_151 * V_2 )
{
F_54 ( V_2 ) ;
}
