...
if ( ! V_201 )
return - V_5 ;
V_27 = F_127 ( V_201 -> V_202 , args -> V_214 . V_215 ) ;
return V_27 ;
}
...
if ( ! V_28 ) {
V_28 = F_137 ( V_238 , args -> V_241 . V_242 ,
& V_236 , args -> V_241 . V_74 ) ;
}
F_28 ( args -> V_241 . V_236 , & V_236 , V_28 , 1 ) ;
return V_28 ;
}
T_2 T_4 F_138 ( union V_7 * args , void * V_9 )
{
F_9 ( L_5 , V_12 ) ;
return - V_206 ;
}
...
T_2 F_140 ( union V_7 * args , void * V_9 )
{
int V_28 = 0 ;
struct V_244 * V_245 ;
void * V_85 = ( (struct V_86 * ) V_9 ) -> V_75 ;
V_28 = F_141 ( V_85 , & V_245 ) ;
F_28 ( args -> V_246 . V_247 , & V_245 , V_28 , 1 ) ;
return V_28 ;
}
T_2 F_142 ( union V_7 * args , void * V_9 )
{
int V_28 = 0 ;
struct V_248 V_249 ;
V_28 = F_143 ( args -> V_250 . V_247 , & V_249 ) ;
