...
static int F_42 ( unsigned short V_49 , enum V_50 type ,
int V_51 , struct V_9 * V_10 )
{
...
break;
case V_61 :
if ( ! F_45 ( V_57 , V_58 , V_60 ) ) {
F_46 ( V_10 , L_13
L_14 , V_57 , V_57 + V_58 ) ;
for ( V_54 -= 2 ; V_54 >= 0 ; V_54 -= 2 )
F_47 ( V_49 + V_56 [ V_54 ] ,
V_56 [ V_54 + 1 ] ) ;
return - V_62 ;
}
...
static int T_4 F_50 ( struct V_72 * V_73 )
{
struct V_9 * V_10 = & V_73 -> V_10 ;
struct V_38 * V_39 = V_10 -> V_74 ;
struct V_5 * V_6 ;
struct V_75 * V_76 ;
int V_27 ;
int V_77 , V_78 , V_79 , V_80 , V_81 , V_82 ;
static const char * const V_83 [] = {
L_15 ,
L_16 ,
} ;
V_76 = F_51 ( V_73 , V_84 , 0 ) ;
V_27 = F_42 ( V_76 -> V_57 , V_39 -> type ,
V_61 , V_10 ) ;
if ( V_27 < 0 )
return V_27 ;
V_6 = F_52 ( sizeof( struct V_5 ) , V_85 ) ;
if ( ! V_6 ) {
V_27 = - V_86 ;
goto V_87;
}
V_6 -> V_7 = V_76 -> V_57 ;
V_6 -> type = V_39 -> type ;
V_6 -> V_37 = V_83 [ V_39 -> type ] ;
F_53 ( & V_6 -> V_28 ) ;
F_54 ( V_73 , V_6 ) ;
V_80 = ( F_7 ( V_6 , F_55 ( 0 ) ) & 0x05 )
== 0x04 ;
V_81 = ( F_7 ( V_6 , F_55 ( 1 ) ) & 0x05 )
== 0x04 ;
if ( V_6 -> type == V_45 ) {
V_77 = ( F_7 ( V_6 , V_88 )
& 0x0d ) == 0x09 ;
...
if ( ! ( V_77 || V_78 || V_79 || V_80 || V_81 || V_82 ) ) {
F_57 ( V_10 , L_17 ) ;
V_27 = - V_44 ;
goto V_92;
}
...
F_63 ( V_6 ) ;
V_87:
F_42 ( V_76 -> V_57 , V_39 -> type , V_63 , V_10 ) ;
return V_27 ;
}
static int T_5 F_64 ( struct V_72 * V_73 )
{
struct V_5 * V_6 = F_65 ( V_73 ) ;
struct V_75 * V_76 ;
F_66 ( V_6 -> V_94 ) ;
F_48 ( & V_73 -> V_10 ) ;
V_76 = F_51 ( V_73 , V_84 , 0 ) ;
F_42 ( V_76 -> V_57 , V_6 -> type , V_63 , & V_73 -> V_10 ) ;
F_54 ( V_73 , NULL ) ;
F_63 ( V_6 ) ;
return 0 ;
}
...
struct V_5 * V_6 = F_26 ( V_10 ) ;
F_28 ( & V_6 -> V_28 ) ;
if ( F_67 ( V_96 , V_6 -> V_97 + V_98 + V_98 / 2 ) || V_95 ) {
int V_54 , V_99 ;
V_99 = V_6 -> type == V_45 ? 3 : 2 ;
...
static int T_4 F_68 ( unsigned short V_49 ,
