...
break;
case V_61 :
F_28 ( L_25 , V_4 -> V_35 -> V_62 ,
( unsigned long long ) V_4 -> V_31 , V_4 -> V_32 ,
V_4 -> V_33 ) ;
V_59 = F_6 ( V_13 , & V_4 -> V_14 ) ;
F_28 ( L_26 , V_59 + ( V_4 -> V_16 > 0 ) * 5 ) ;
if ( V_59 )
F_28 ( L_27 ) ;
if ( V_4 -> V_16 )
F_28 ( L_28 ,
...
static int F_29 ( struct V_5 * V_6 , unsigned int V_63 , unsigned long V_64 )
{
struct V_3 * V_4 = V_6 -> V_38 ;
struct V_65 * V_35 = V_4 -> V_35 ;
int V_7 = 0 ;
if ( V_4 -> V_31 ||
V_6 -> V_66 != F_30 ( V_35 -> V_42 -> V_67 ) >> V_68 )
V_7 = F_31 ( NULL , V_63 ) ;
return V_7 ? : F_32 ( V_35 -> V_42 , V_35 -> V_69 , V_63 , V_64 ) ;
}
static int F_33 ( struct V_5 * V_6 , struct V_70 * V_71 ,
struct V_72 * V_73 , int V_74 )
{
struct V_3 * V_4 = V_6 -> V_38 ;
struct V_75 * V_76 = F_34 ( V_4 -> V_35 -> V_42 ) ;
if ( ! V_76 -> V_77 )
return V_74 ;
V_71 -> V_41 = V_4 -> V_35 -> V_42 ;
V_71 -> V_39 = F_14 ( V_6 , V_71 -> V_39 ) ;
return F_35 ( V_74 , V_76 -> V_77 ( V_76 , V_71 , V_73 ) ) ;
}
static int F_36 ( struct V_5 * V_6 , T_3 V_78 , void * V_44 )
{
struct V_3 * V_4 = V_6 -> V_38 ;
return V_78 ( V_6 , V_4 -> V_35 , V_4 -> V_31 , V_6 -> V_66 , V_44 ) ;
}
