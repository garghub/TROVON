...
char V_50 [ 4 ] = { '|' , '/' , '-' , '\\' } ;
#endif
V_43 = F_17 ( ( const char V_51 V_52 * ) L_9 , V_53 , 0 ) ;
if ( V_43 < 0 )
goto V_54;
V_42 = F_17 ( V_40 , V_55 , 0 ) ;
if ( V_42 < 0 )
goto V_56;
...
if ( F_19 ( V_43 , V_58 , ( unsigned long ) & V_44 ) < 0 )
V_44 = 0 ;
else
V_44 >>= 1 ;
if ( V_16 > V_44 ) {
...
if ( F_19 ( V_42 , V_58 , ( unsigned long ) & V_45 ) < 0 )
V_45 = 0 ;
else
V_45 >>= 1 ;
...
F_21 ( L_24 ) ;
F_25 ( L_25 , V_60 ) ;
F_25 ( L_9 , F_26 ( V_61 , V_19 ) ) ;
return F_15 ( L_25 ) ;
}
static int T_1 F_27 ( void * V_17 , unsigned int V_62 )
{
int V_63 = F_7 ( V_64 , V_17 , V_62 ) ;
if ( V_63 < 0 )
F_9 ( V_59 L_26 ) ;
else if ( V_63 == 0 )
F_9 ( V_59 L_27 ) ;
...
static int T_1 F_28 ( void * V_65 , unsigned int V_66 )
{
int V_67 = F_22 ( V_68 , V_65 , V_66 ) ;
if ( V_67 != V_66 ) {
if ( V_69 == 0 )
F_9 ( V_59
L_28 ,
...
static void T_1 error ( char * V_70 )
{
F_9 ( V_59 L_29 , V_70 ) ;
V_71 = 1 ;
V_69 = 1 ;
}
static int T_1 F_18 ( int V_42 , int V_43 , T_2 V_72 )
{
int V_73 ;
V_64 = V_42 ;
V_68 = V_43 ;
V_73 = V_72 ( NULL , 0 , F_27 , F_28 , NULL , NULL , error ) ;
if ( V_69 )
V_73 = 1 ;
return V_73 ;
}
