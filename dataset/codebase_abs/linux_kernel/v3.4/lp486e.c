...
V_8 -> V_50 . V_11 = V_51 ;
F_21 ( V_4 , (struct V_52 * ) & V_8 -> V_50 ) ;
V_8 -> V_53 . V_11 = V_54 ;
F_21 ( V_4 , (struct V_52 * ) & V_8 -> V_53 ) ;
...
struct V_15 * V_16 , int * V_56 ) {
if ( V_16 -> V_20 & V_57 ) {
int V_58 = ( V_16 -> V_22 & 0x3fff ) ;
struct V_59 * V_60 = F_23 ( V_4 , V_58 ) ;
( * V_56 ) ++ ;
if ( V_16 -> V_24 & V_25 )
F_7 ( L_6 ) ;
if ( V_60 == NULL ) {
...
memcpy ( F_24 ( V_60 , V_58 ) , V_16 -> V_63 , V_58 ) ;
V_60 -> V_64 = F_25 ( V_60 , V_4 ) ;
F_26 ( V_60 ) ;
V_4 -> V_61 . V_65 ++ ;
} else {
#if 0
...
#if 1
if ( V_16 -> V_20 && ! ( V_16 -> V_20 & ( V_81 | V_82 ) ) )
F_7 ( L_10 , V_16 , V_16 -> V_20 ) ;
#endif
if ( ! ( V_16 -> V_20 & V_81 ) )
break;
if ( F_22 ( V_4 , V_8 , V_16 , & V_56 ) )
break;
V_16 -> V_24 = V_25 ;
V_8 -> V_26 -> V_24 = 0 ;
V_8 -> V_26 = V_16 ;
...
static void F_21 ( struct V_3 * V_4 , struct V_52 * V_24 ) {
struct V_7 * V_8 = F_6 ( V_4 ) ;
int V_91 = V_4 -> V_94 ;
unsigned long V_95 ;
V_24 -> V_13 = 0 ;
...
if ( V_17 ) {
F_7 ( V_80 L_16 , V_4 -> V_12 , V_4 -> V_103 ) ;
return V_17 ;
}
if ( ( V_17 = F_10 ( V_4 , V_106 ) ) < V_106 )
F_7 ( V_80 L_17 , V_4 -> V_12 , V_17 ) ;
if ( V_17 < 4 ) {
F_38 ( V_4 -> V_103 , V_4 ) ;
return - V_107 ;
}
...
static T_2 F_39 ( struct V_59 * V_60 , struct V_3 * V_4 ) {
struct V_84 * V_84 ;
short V_108 ;
V_108 = V_60 -> V_109 ;
if ( V_108 < V_110 ) {
...
V_86 -> V_116 = F_1 ( V_60 -> V_63 ) ;
V_86 -> V_60 = V_60 ;
if ( V_117 & V_118 )
F_42 ( V_60 -> V_63 ) ;
F_21 ( V_4 , (struct V_52 * ) V_84 ) ;
V_4 -> V_61 . V_119 ++ ;
}
return V_111 ;
}
...
V_4 -> V_61 . V_88 ++ ;
if ( V_8 -> V_120 == V_4 -> V_61 . V_119 ) {
F_7 ( L_20 ) ;
F_31 ( V_4 , V_8 , V_91 ) ;
} else {
F_7 ( L_21 ) ;
V_8 -> V_10 . V_11 = ( V_99 | V_55 ) ;
F_16 () ;
V_8 -> V_120 = V_4 -> V_61 . V_119 ;
}
F_30 ( V_4 ) ;
}
...
struct V_154 * V_155 ;
char * V_156 ;
V_24 = F_11 ( sizeof( struct V_52 ) + 2 +
F_53 ( V_4 ) * 6 , V_112 ) ;
if ( V_24 == NULL ) {
F_7 ( V_80 L_43 , V_4 -> V_12 ) ;
return;
}
V_24 -> V_11 = V_90 ;
