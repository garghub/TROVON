...
goto V_67;
V_67:
V_33 -> V_72 [ 0 ] . V_73 = F_19 ( V_74 , V_58 ,
& V_33 -> V_57 -> V_75 ) ;
...
static int F_20 ( struct V_56 * V_33 )
{
int V_5 ;
struct V_37 * V_38 = V_33 -> V_57 -> V_38 ;
T_1 V_8 [ 1 ] ;
...
struct V_83 * V_73 ;
F_8 ( L_3 , V_22 ) ;
V_82 = F_22 ( V_33 -> V_72 [ 0 ] . V_73 ) ;
switch ( V_38 -> V_64 ) {
case V_65 :
V_73 = F_19 ( V_84 , V_33 -> V_72 [ 0 ] . V_73 ,
V_82 , & V_85 ) ;
break;
case V_68 :
V_73 = F_19 ( V_86 , V_33 -> V_72 [ 0 ] . V_73 ,
V_82 , & V_87 ,
1220 ) ;
break;
case V_70 :
V_73 = F_19 ( V_88 , V_33 -> V_72 [ 0 ] . V_73 ,
V_82 , & V_89 ) ;
break;
default:
V_73 = NULL ;
...
static int F_23 ( struct V_56 * V_33 )
{
int V_5 ;
struct V_37 * V_38 = V_33 -> V_57 -> V_38 ;
struct V_83 * V_73 ;
...
static int F_24 ( struct V_56 * V_33 , int V_90 )
{
int V_5 ;
T_1 V_8 [ 2 ] , V_91 ;
F_8 ( L_14 , V_22 , V_90 ) ;
...
static int F_25 ( struct V_1 * V_2 , int V_90 )
{
int V_5 ;
T_1 V_91 , V_94 ;
F_8 ( L_14 , V_22 , V_90 ) ;
...
if ( ! V_38 -> V_100 ) {
for ( V_96 = 0 ; V_96 < F_27 ( V_99 ) ; V_96 ++ ) {
...
{
int V_5 , V_96 ;
int V_123 = F_27 ( V_124 ) ;
struct V_1 * V_2 ;
F_8 ( L_17 , V_22 ,
V_120 -> V_125 -> V_126 . V_127 ) ;
if ( V_120 -> V_125 -> V_126 . V_127 != 0 )
return 0 ;
for ( V_96 = 0 ; V_96 < V_123 ; V_96 ++ ) {
V_5 = F_31 ( V_120 , & V_124 [ V_96 ] ,
V_128 , & V_2 , V_129 ) ;
if ( V_5 == 0 || V_5 != - V_76 )
break;
}
if ( V_5 )
goto V_12;
V_5 = F_11 ( V_2 , V_130 , 0x09 ) ;
if ( V_5 )
goto V_12;
V_5 = F_9 ( V_2 , V_131 , L_18 , 4 ) ;
if ( V_5 )
goto V_12;
V_5 = F_9 ( V_2 , V_132 , L_19 , 4 ) ;
if ( V_5 )
goto V_12;
return V_5 ;
V_12:
