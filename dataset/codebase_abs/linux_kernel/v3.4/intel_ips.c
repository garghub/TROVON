...
static int F_85 ( struct V_194 * V_30 , const struct V_195 * V_196 )
{
T_1 V_197 ;
struct V_1 * V_2 ;
T_3 V_50 ;
int V_32 = 0 ;
T_2 V_198 , V_199 , V_200 ;
T_4 V_201 ;
...
V_201 = F_61 ( V_207 ) ;
if ( V_201 != V_208 ) {
F_18 ( & V_30 -> V_30 , L_30 , V_201 ) ;
V_32 = - V_202 ;
goto V_209;
}
V_199 = F_29 ( V_210 ) ;
V_200 = V_211 | V_212 | V_213 ;
if ( ( V_199 & V_200 ) != V_200 ) {
F_18 ( & V_30 -> V_30 , L_31 ) ;
V_32 = - V_202 ;
goto V_209;
}
...
F_93 ( V_30 ) ;
V_32 = F_94 ( V_30 -> V_124 , F_60 , V_220 , L_14 ,
V_2 ) ;
if ( V_32 ) {
F_18 ( & V_30 -> V_30 , L_37 ) ;
goto V_209;
}
F_64 ( V_221 , V_222 | V_223 |
V_224 | V_225 ) ;
F_64 ( V_226 , V_227 ) ;
V_2 -> V_228 = F_29 ( V_229 ) ;
V_2 -> V_75 = F_29 ( V_230 ) ;
V_2 -> V_231 = F_29 ( V_71 ) ;
F_3 ( V_9 , V_2 -> V_17 ) ;
F_11 ( V_2 ) ;
V_2 -> V_8 = false ;
V_2 -> V_116 = F_95 ( F_30 , V_2 , L_38 ) ;
if ( F_96 ( V_2 -> V_116 ) ) {
F_18 ( & V_30 -> V_30 ,
L_39 ) ;
V_32 = - V_108 ;
...
static void F_103 ( struct V_194 * V_30 )
{
...
static int F_105 ( struct V_194 * V_30 , T_6 V_241 )
{
return 0 ;
}
static int F_106 ( struct V_194 * V_30 )
{
return 0 ;
}
static void F_107 ( struct V_194 * V_30 )
{
}
