...
F_49 ( V_2 , V_135 , V_74 , 0 ) ;
V_5 = V_41 -> V_9 . V_136 ( V_2 ) ;
F_50 ( V_2 , V_137 ,
& V_132 ) ;
V_132 |= V_138 ;
F_51 ( V_2 , V_137 ,
...
V_131 |= V_148 ;
F_21 ( V_146 , V_131 ) ;
V_131 = F_53 ( V_2 , V_149 , 0x0001 ) ;
V_131 &= ~ 0x00100000 ;
F_49 ( V_2 , V_149 , 0x0001 , V_131 ) ;
...
if ( V_5 )
return V_5 ;
V_5 = F_32 ( V_2 , V_169 , & V_79 ) ;
if ( V_5 )
return V_5 ;
V_79 &= ~ V_170 ;
V_5 = F_33 ( V_2 , V_169 , V_79 ) ;
if ( V_5 )
return V_5 ;
V_156 = F_4 ( V_171 ) ;
V_156 &= ~ ( V_172 ) ;
...
V_5 = F_32 ( V_2 , V_178 , & V_79 ) ;
if ( V_5 )
return V_5 ;
V_79 |= V_179 ;
V_5 = F_33 ( V_2 , V_178 , V_79 ) ;
if ( V_5 )
return V_5 ;
return 0 ;
}
...
V_123 &= ~ ( V_181 | V_182 ) ;
F_21 ( V_128 , V_123 ) ;
V_5 = F_51 ( V_2 , F_58 ( 0x34 , 4 ) ,
0xFFFF ) ;
if ( V_5 )
return V_5 ;
V_5 = F_50 ( V_2 , F_58 ( 0x34 , 9 ) ,
& V_131 ) ;
if ( V_5 )
return V_5 ;
V_131 |= 0x3F ;
V_5 = F_51 ( V_2 , F_58 ( 0x34 , 9 ) ,
V_131 ) ;
if ( V_5 )
return V_5 ;
V_5 = F_50 ( V_2 ,
...
F_21 ( V_146 , V_186 ) ;
do {
V_5 = F_32 ( V_2 , V_176 , & V_131 ) ;
if ( V_5 )
return V_5 ;
V_5 = F_32 ( V_2 , V_176 , & V_187 ) ;
if ( V_5 )
return V_5 ;
V_74 ++ ;
} while ( ( V_131 != V_187 ) && ( V_74 < V_191 ) );
if ( V_121 == V_192 )
V_131 |= V_177 ;
else
V_131 &= ~ V_177 ;
return F_33 ( V_2 , V_176 , V_131 ) ;
}
...
static T_1 F_50 ( struct V_1 * V_2 , T_2 V_78 ,
T_3 * V_79 )
{
T_2 V_194 ;
T_1 V_5 = 0 ;
...
static T_1 F_51 ( struct V_1 * V_2 , T_2 V_78 ,
T_3 V_79 )
{
T_2 V_194 ;
T_1 V_5 = 0 ;
