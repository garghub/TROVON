...
V_117 -> V_162 = F_58 ( V_117 -> V_162 , 65535U ) ;
}
V_117 -> V_167 = ( F_59 ( F_60 ( V_32 ) -> V_168 ) <<
V_117 -> V_14 . V_166 ) ;
...
struct V_1 * F_62 ( struct V_1 * V_2 , struct V_31 * V_32 ,
struct V_106 * V_107 ,
struct V_106 * * V_181 )
{
struct V_35 V_36 ;
const T_2 * V_37 ;
struct V_1 * V_182 ;
const struct V_33 * V_34 = F_60 ( V_32 ) ;
T_3 V_183 = F_63 ( V_34 ) & ( V_184 | V_185 | V_186 ) ;
int V_38 = 0 ;
V_36 . V_39 = 0 ;
...
if ( V_182 == NULL )
goto V_202;
F_64 ( V_2 , V_107 , V_181 ) ;
F_65 ( V_2 , V_107 ) ;
F_66 ( V_2 , V_107 , V_182 ) ;
return V_182 ;
V_202:
if ( ! V_203 ) {
F_41 ( V_107 ) -> V_197 = 1 ;
...
F_67 ( V_2 , V_107 , V_181 ) ;
return NULL ;
}
int F_68 ( struct V_1 * V_206 , struct V_1 * V_182 ,
struct V_31 * V_32 )
{
int V_207 = 0 ;
int V_66 = V_182 -> V_208 ;
if ( ! F_69 ( V_182 ) ) {
V_207 = F_70 ( V_182 , V_32 , F_60 ( V_32 ) ,
V_32 -> V_174 ) ;
