...
V_80 -> V_94 = NULL ;
if ( V_133 -> V_145 )
F_97 ( V_133 -> V_145 , V_137 ) ;
}
V_133 -> V_24 = NULL ;
V_133 -> V_146 = F_21 ( V_8 ) ;
V_133 -> V_147 = F_14 ( V_8 ) -> V_148 ;
if ( V_24 != NULL ) {
V_133 -> V_24 = F_98 ( V_137 , V_24 ) ;
if ( V_24 != V_16 -> V_24 )
F_58 ( V_2 , V_24 , V_24 -> V_92 ) ;
}
F_2 ( V_137 ) -> V_158 = 0 ;
...
if ( ! F_113 ( V_2 , V_178 , V_8 ) )
goto V_177;
return F_114 ( V_2 , V_8 , 1 ) ? - 1 : 0 ;
V_174:
if ( ! F_113 ( NULL , V_178 , V_8 ) )
goto V_170;
if ( V_18 -> V_100 != V_101 ) {
F_75 ( V_8 ) -> V_114 =
V_179 ;
...
static int F_115 ( struct V_1 * V_2 , struct V_180 * V_181 ,
int V_182 )
{
...
V_186 -> V_5 = & V_6 ;
V_2 -> V_143 = V_144 ;
V_33 = F_122 ( V_2 , (struct V_180 * ) & sin , sizeof( sin ) ) ;
if ( V_33 ) {
V_186 -> V_158 = V_207 ;
V_186 -> V_5 = & V_215 ;
V_2 -> V_143 = F_100 ;
...
if ( V_38 . V_221 == NULL )
return - V_222 ;
return F_134 ( & V_35 -> V_98 . V_99 , V_223 ,
V_224 , V_13 , V_35 ) ;
}
static void T_8 F_135 ( struct V_35 * V_35 )
{
F_136 ( V_35 -> V_98 . V_99 ) ;
}
static int T_9 F_137 ( void )
{
int V_33 = F_138 ( & V_225 , 1 ) ;
if ( V_33 != 0 )
goto V_41;
V_33 = F_139 ( & V_226 , V_13 ) ;
if ( V_33 != 0 )
goto V_227;
F_140 ( & V_228 ) ;
V_33 = F_141 ( & V_229 ) ;
