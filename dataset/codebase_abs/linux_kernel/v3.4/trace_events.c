...
static int
F_98 ( struct V_2 * V_20 , struct V_124 * V_125 ,
const struct V_120 * V_27 ,
const struct V_120 * V_42 ,
const struct V_120 * V_52 ,
const struct V_120 * V_121 )
...
V_136 -> V_125 = V_125 ;
V_136 -> V_27 = V_129 ;
V_136 -> V_27 . V_137 = V_125 ;
V_136 -> V_42 = V_130 ;
V_136 -> V_42 . V_137 = V_125 ;
V_136 -> V_52 = V_131 ;
V_136 -> V_52 . V_137 = V_125 ;
V_136 -> V_121 = V_132 ;
V_136 -> V_121 . V_137 = V_125 ;
F_6 ( & V_136 -> V_78 , & V_138 ) ;
return V_136 ;
}
static void F_109 ( struct V_124 * V_125 )
{
struct V_135 * V_136 = NULL ;
struct V_2 * * V_20 , * * V_139 , * * V_140 ;
V_139 = V_125 -> V_141 ;
V_140 = V_125 -> V_141 + V_125 -> V_142 ;
if ( V_139 == V_140 )
return;
V_136 = F_108 ( V_125 ) ;
if ( ! V_136 )
...
static void F_111 ( struct V_124 * V_125 )
{
struct V_135 * V_136 ;
...
static T_5 int F_114 ( char * V_148 )
{
F_115 ( V_149 , V_148 , V_150 ) ;
V_151 = 1 ;
V_152 = 1 ;
return 1 ;
}
...
if ( ! V_114 )
return 0 ;
V_116 = F_95 ( L_32 , 0444 , V_114 ,
( void * ) & V_154 ,
& V_155 ) ;
if ( ! V_116 )
F_92 ( L_17
L_33 ) ;
V_116 = F_95 ( L_34 , 0644 , V_114 ,
( void * ) & V_156 ,
& V_157 ) ;
if ( ! V_116 )
F_92 ( L_17
...
if ( ! V_115 )
return 0 ;
F_96 ( L_36 , 0444 , V_115 ,
V_158 ,
& V_159 ) ;
F_96 ( L_37 , 0444 , V_115 ,
V_160 ,
& V_159 ) ;
...
F_98 ( * V_20 , NULL , & V_129 ,
& V_130 ,
& V_131 ,
& V_132 ) ;
}
while ( true ) {
V_153 = F_36 ( & V_60 , L_39 ) ;
if ( ! V_153 )
break;
if ( ! * V_153 )
continue;
...
static T_5 void F_118 ( struct V_162 * V_163 )
{
F_119 ( & V_164 ) ;
F_120 ( & V_165 ) ;
F_121 ( 1 ) ;
...
static T_5 int F_125 ( void * V_167 )
{
void * V_168 ;
V_168 = F_70 ( 1234 , V_15 ) ;
if ( ! V_168 )
F_28 ( L_42 ) ;
F_126 ( F_118 ) ;
F_7 ( V_168 ) ;
...
static void
F_136 ( unsigned long V_172 , unsigned long V_173 )
{
struct V_174 * V_28 ;
struct V_175 * V_69 ;
struct V_176 * V_116 ;
...
V_116 -> V_172 = V_172 ;
V_116 -> V_173 = V_173 ;
F_145 ( V_69 , V_28 , V_44 , V_179 ) ;
V_93:
F_146 ( & F_141 ( V_180 , V_178 ) ) ;
F_147 () ;
}
