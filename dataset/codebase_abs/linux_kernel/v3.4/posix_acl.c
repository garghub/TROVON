...
struct V_8 * V_52 = NULL , * V_40 = NULL ;
T_3 V_30 = * V_29 ;
int V_31 = 0 ;
F_8 (pa, acl, pe) {
switch( V_10 -> V_21 ) {
...
if ( ! V_52 )
return - V_51 ;
V_52 -> V_16 &= ( V_30 >> 3 ) | ~ V_32 ;
V_30 &= ( V_52 -> V_16 << 3 ) | ~ V_33 ;
}
* V_29 = ( * V_29 & ~ V_34 ) | V_30 ;
return V_31 ;
}
...
if ( ! V_52 )
return - V_51 ;
V_52 -> V_16 = ( V_30 & V_33 ) >> 3 ;
}
return 0 ;
}
int
F_17 ( struct V_1 * * V_2 , T_1 V_53 , T_3 * V_29 )
{
struct V_1 * V_9 = F_5 ( * V_2 , V_53 ) ;
int V_54 = - V_35 ;
if ( V_9 ) {
V_54 = F_15 ( V_9 , V_29 ) ;
if ( V_54 < 0 ) {
...
int
F_19 ( struct V_1 * * V_2 , T_1 V_53 , T_3 V_30 )
{
struct V_1 * V_9 = F_5 ( * V_2 , V_53 ) ;
int V_54 = - V_35 ;
if ( V_9 ) {
