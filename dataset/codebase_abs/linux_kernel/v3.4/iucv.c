...
static int T_5 F_30 ( struct V_42 * V_43 ,
...
static int F_34 ( T_6 V_60 , T_7 V_61 [ 16 ] )
{
union V_6 * V_7 ;
V_7 = V_21 [ F_8 () ] ;
memset ( V_7 , 0 , sizeof( union V_6 ) ) ;
...
int F_56 ( struct V_38 * V_86 , struct V_71 * V_72 ,
T_7 V_61 [ 16 ] , void * V_87 )
{
union V_6 * V_7 ;
int V_27 ;
F_57 () ;
...
int F_59 ( struct V_38 * V_86 , struct V_71 * V_72 ,
T_7 V_93 [ 8 ] , T_7 system [ 8 ] , T_7 V_61 [ 16 ] ,
void * V_87 )
{
union V_6 * V_7 ;
int V_27 ;
...
int F_62 ( struct V_38 * V_86 , T_7 V_61 [ 16 ] )
{
union V_6 * V_7 ;
int V_27 ;
F_57 () ;
...
int F_63 ( struct V_38 * V_86 , T_7 V_61 [ 16 ] )
{
union V_6 * V_7 ;
int V_27 ;
F_57 () ;
...
int F_64 ( struct V_38 * V_86 , T_7 V_61 [ 16 ] )
{
int V_27 ;
F_54 () ;
if ( F_16 ( & V_28 ) ) {
...
int F_65 ( struct V_38 * V_86 , struct V_101 * V_102 ,
T_8 V_103 )
{
union V_6 * V_7 ;
int V_27 ;
...
V_27 = F_2 ( V_111 , V_7 ) ;
if ( ! V_27 ) {
V_102 -> V_112 = ( * ( T_8 * ) & V_7 -> V_104 . V_113 ) >> 8 ;
...
static int F_66 ( struct V_38 * V_86 ,
struct V_101 * V_102 ,
T_7 V_91 , void * V_116 ,
T_4 V_117 , T_4 * V_118 )
{
...
V_122 = F_67 ( T_4 , V_117 , V_120 -> V_124 ) ;
memcpy ( ( T_7 * ) ( V_125 ) V_120 -> V_126 ,
V_121 , V_122 ) ;
V_121 += V_122 ;
V_117 -= V_122 ;
}
} else {
memcpy ( V_116 , V_121 , F_67 ( T_4 , V_117 , 8 ) ) ;
}
return 0 ;
}
int F_68 ( struct V_38 * V_86 , struct V_101 * V_102 ,
T_7 V_91 , void * V_116 , T_4 V_117 , T_4 * V_118 )
{
union V_6 * V_7 ;
int V_27 ;
if ( V_102 -> V_91 & V_127 )
return F_66 ( V_86 , V_102 , V_91 ,
V_116 , V_117 , V_118 ) ;
if ( F_16 ( & V_28 ) ) {
V_27 = - V_41 ;
goto V_40;
...
V_7 = V_6 [ F_8 () ] ;
memset ( V_7 , 0 , sizeof( union V_6 ) ) ;
V_7 -> V_29 . V_30 = ( T_8 ) ( V_125 ) V_116 ;
V_7 -> V_29 . V_128 = ( T_8 ) V_117 ;
...
V_116 , V_117 , V_118 ) ;
F_57 () ;
V_27 = F_68 ( V_86 , V_102 , V_91 , V_116 , V_117 , V_118 ) ;
F_58 () ;
return V_27 ;
}
...
memcpy ( V_7 -> V_135 . V_136 , V_134 , F_67 ( T_4 , V_117 , 8 ) ) ;
} else {
V_7 -> V_29 . V_30 = ( T_8 ) ( V_125 ) V_134 ;
V_7 -> V_29 . V_128 = ( T_8 ) V_117 ;
V_7 -> V_29 . V_63 = V_86 -> V_60 ;
V_7 -> V_29 . V_90 = V_91 ;
V_7 -> V_29 . V_105 = V_102 -> V_106 ;
...
T_7 V_91 , T_8 V_103 , void * V_116 , T_4 V_117 )
{
union V_6 * V_7 ;
int V_27 ;
if ( F_16 ( & V_28 ) ) {
...
int V_27 ;
F_57 () ;
V_27 = F_72 ( V_86 , V_102 , V_91 , V_103 , V_116 , V_117 ) ;
F_58 () ;
return V_27 ;
}
...
V_7 -> V_135 . V_107 = V_103 ;
V_7 -> V_135 . V_115 = V_102 -> V_114 ;
V_7 -> V_135 . V_142 = ( T_8 ) ( V_125 ) V_140 ;
V_7 -> V_135 . V_143 = ( T_8 ) V_141 ;
memcpy ( V_7 -> V_135 . V_136 , V_116 , 8 ) ;
} else {
V_7 -> V_29 . V_63 = V_86 -> V_60 ;
...
V_7 -> V_29 . V_30 = ( T_8 ) ( V_125 ) V_116 ;
V_7 -> V_29 . V_128 = ( T_8 ) V_117 ;
V_7 -> V_29 . V_142 = ( T_8 ) ( V_125 ) V_140 ;
V_7 -> V_29 . V_143 = ( T_8 ) V_141 ;
}
V_27 = F_2 ( V_139 , V_7 ) ;
if ( ! V_27 )
V_102 -> V_106 = V_7 -> V_29 . V_105 ;
...
static void F_75 ( struct V_31 * V_19 )
{
struct F_75 * V_144 = ( void * ) V_19 ;
struct V_71 * V_72 ;
struct V_38 * V_86 ;
char * error ;
F_76 ( V_39 [ V_144 -> V_63 ] ) ;
error = V_145 ;
V_86 = F_77 ( V_144 -> V_88 , V_144 -> V_90 , V_146 ) ;
if ( ! V_86 )
goto V_147;
V_86 -> V_60 = V_144 -> V_63 ;
V_39 [ V_86 -> V_60 ] = V_86 ;
F_78 ( V_144 -> V_94 , 8 ) ;
F_79 (handler, &iucv_handler_list, list) {
if ( ! V_72 -> V_148 )
continue;
F_80 ( & V_86 -> V_70 , & V_72 -> V_79 ) ;
V_86 -> V_72 = V_72 ;
...
static void F_81 ( struct V_31 * V_19 )
{
struct F_81 * V_150 = ( void * ) V_19 ;
...
static void F_87 ( unsigned long V_166 )
{
typedef void T_9 ( struct V_31 * );
static T_9 * V_167 [] = {
[ 0x02 ] = F_81 ,
[ 0x03 ] = F_82 ,
[ 0x04 ] = F_83 ,
...
static void F_93 ( struct V_172 * V_173 )
{
F_88 ( V_174 ) ;
struct V_66 * V_67 , * V_68 ;
F_46 ( & V_80 ) ;
...
static void F_94 ( struct V_176 V_176 ,
unsigned int V_177 , unsigned long V_178 )
{
struct V_31 * V_67 ;
struct V_66 * V_173 ;
F_95 ( F_8 () ) . V_179 [ V_180 ] ++ ;
V_67 = V_31 [ F_8 () ] ;
if ( V_67 -> V_63 >= V_17 ) {
F_96 ( V_67 -> V_63 >= V_17 ) ;
...
F_76 ( V_67 -> V_171 < 0x01 || V_67 -> V_171 > 0x09 ) ;
V_173 = F_97 ( sizeof( struct V_66 ) , V_146 ) ;
if ( ! V_173 ) {
F_15 ( L_11 ) ;
return;
}
