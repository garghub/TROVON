...
static T_2 F_111 ( struct V_207 * V_204 , char T_3 * V_110 ,
T_4 V_212 , T_5 * V_213 )
{
...
if ( V_77 > V_212 )
V_77 = V_212 ;
if ( F_112 ( V_110 , V_214 -> V_13 + 3 , V_77 ) )
V_77 = - V_211 ;
else
* V_213 += V_77 ;
}
...
static T_2 F_113 ( struct V_207 * V_204 , const char T_3 * V_110 ,
T_4 V_212 , T_5 * V_213 )
{
struct V_15 * V_16 = V_204 -> V_210 ;
struct V_11 * V_214 ;
...
static int F_114 ( struct V_15 * V_16 , T_1 * V_74 , long V_213 )
{
V_74 [ 0 ] = V_213 & 0xff ;
V_74 [ 1 ] = ( V_213 >> 8 ) & 0xff ;
if ( V_16 -> V_220 == 3 )
...
static T_2 F_115 ( struct V_15 * V_16 , int V_12 ,
...
goto V_222;
if ( F_112 ( V_110 + V_77 , V_214 -> V_13 + V_221 + 1 , V_13 [ V_221 ] ) ) {
V_177 = - V_211 ;
goto V_222;
}
* V_213 += V_13 [ V_221 ] ;
...
static T_2 F_116 ( struct V_207 * V_204 , char T_3 * V_110 ,
T_4 V_212 , T_5 * V_213 )
{
struct V_15 * V_16 = V_204 -> V_210 ;
if ( V_212 == 0 )
...
V_212 = 0x06000 - * V_213 ;
if ( V_16 -> V_22 & V_194 )
return F_115 ( V_16 , V_224 , V_110 , V_212 , V_213 ) ;
else
return F_115 ( V_16 , V_225 , V_110 , V_212 , V_213 ) ;
}
...
static T_2 F_118 ( struct V_15 * V_16 , int V_12 ,
...
static T_2 F_119 ( struct V_207 * V_204 , const char T_3 * V_110 ,
T_4 V_212 , T_5 * V_213 )
{
struct V_15 * V_16 = V_204 -> V_210 ;
T_2 V_177 , V_77 = 0 ;
...
F_9 ( & V_16 -> V_232 ) ;
while ( V_212 > 0 ) {
V_177 = F_117 ( V_16 , V_228 , V_213 ) ;
if ( V_177 )
break;
V_177 = F_118 ( V_16 , V_229 , V_110 , 64 , V_213 ) ;
if ( V_177 < 0 )
break;
V_77 += V_177 ;
* V_213 += V_177 ;
...
static void F_120 ( char * V_233 , T_4 V_234 , const T_1 * V_16 ,
const T_4 V_235 )
{
int V_19 , V_20 ;
...
if ( ! V_4 -> V_238 )
return;
V_237 = F_38 ( F_122 , V_239 ) ;
if ( ! V_237 )
return;
snprintf ( V_237 , F_122 , L_34 ,
V_10 -> V_2 , V_28 ) ;
F_123 ( V_4 , V_237 ) ;
...
V_13 [ 0 ] = V_10 -> V_2 ;
F_124 ( V_10 , V_13 ) ;
F_120 ( V_237 , F_122 , V_13 , V_28 ) ;
F_123 ( V_4 , V_237 ) ;
}
switch ( V_10 -> V_2 ) {
case V_165 :
snprintf ( V_237 , F_122 , L_36 ,
L_37 , V_10 -> V_2 , V_28 - 1 ) ;
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_38 , V_13 [ 1 ] ) ;
F_123 ( V_4 , V_237 ) ;
break;
case V_142 :
snprintf ( V_237 , F_122 , L_36 ,
...
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_40 , V_13 [ 1 ] ) ;
F_123 ( V_4 , V_237 ) ;
break;
case V_160 :
snprintf ( V_237 , F_122 , L_36 ,
...
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_42 , V_13 [ 1 ] ) ;
F_123 ( V_4 , V_237 ) ;
break;
case V_195 :
snprintf ( V_237 , F_122 , L_36 ,
...
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_47 ,
V_13 [ 2 ] , V_13 [ 1 ] ) ;
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_48 , V_13 [ 3 ] ) ;
F_123 ( V_4 , V_237 ) ;
break;
case V_219 :
snprintf ( V_237 , F_122 , L_36 ,
...
F_123 ( V_4 , V_237 ) ;
if ( V_13 [ 3 ] == 0 ) {
snprintf ( V_237 , F_122 , L_50 ) ;
} else if ( V_13 [ 3 ] + 4 <= V_28 ) {
snprintf ( V_237 , F_122 , L_51 ) ;
F_123 ( V_4 , V_237 ) ;
F_120 ( V_237 , F_122 , V_13 + 4 , V_13 [ 3 ] ) ;
} else {
snprintf ( V_237 , F_122 , L_52 ) ;
}
F_123 ( V_4 , V_237 ) ;
break;
case V_230 :
...
switch ( V_16 -> V_220 ) {
case 2 :
snprintf ( V_237 , F_122 , L_54 ,
V_13 [ 2 ] , V_13 [ 1 ] ) ;
break;
case 3 :
snprintf ( V_237 , F_122 , L_55 ,
V_13 [ 3 ] , V_13 [ 2 ] , V_13 [ 1 ] ) ;
break;
default:
snprintf ( V_237 , F_122 , L_56 ) ;
}
F_123 ( V_4 , V_237 ) ;
break;
case V_225 :
...
break;
case 3 :
snprintf ( V_237 , F_122 , L_58 ,
V_13 [ 3 ] , V_13 [ 2 ] , V_13 [ 1 ] ) ;
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_48 , V_13 [ 4 ] ) ;
break;
default:
snprintf ( V_237 , F_122 , L_56 ) ;
}
...
snprintf ( V_237 , F_122 , L_51 ) ;
F_123 ( V_4 , V_237 ) ;
F_120 ( V_237 , F_122 , V_13 + 5 , V_13 [ 4 ] ) ;
} else {
snprintf ( V_237 , F_122 , L_52 ) ;
}
break;
...
switch ( V_10 -> V_2 ) {
case V_245 :
snprintf ( V_237 , F_122 , L_67 ,
L_68 , V_10 -> V_2 , V_14 - 1 ) ;
F_123 ( V_4 , V_237 ) ;
if ( V_13 [ 2 ] < F_127 ( V_246 ) )
snprintf ( V_237 , F_122 , L_69 ,
V_13 [ 2 ] , V_246 [ V_13 [ 2 ] ] , V_13 [ 1 ] ) ;
else
snprintf ( V_237 , F_122 , L_70 ,
V_13 [ 2 ] , V_13 [ 1 ] ) ;
F_123 ( V_4 , V_237 ) ;
break;
case V_247 :
...
F_123 ( V_4 , V_237 ) ;
if ( V_13 [ 1 ] == 0 )
snprintf ( V_237 , F_122 , L_72 ) ;
else if ( V_13 [ 2 ] == 0 )
snprintf ( V_237 , F_122 , L_73 ,
V_13 [ 1 ] , V_13 [ 1 ] ) ;
else
snprintf ( V_237 , F_122 , L_74 ,
...
F_123 ( V_4 , V_237 ) ;
if ( V_13 [ 1 ] == 0 ) {
snprintf ( V_237 , F_122 , L_76 ) ;
F_123 ( V_4 , V_237 ) ;
} else if ( V_13 [ 1 ] + 1 <= V_14 ) {
snprintf ( V_237 , F_122 , L_77 ,
V_13 [ 1 ] - 1 ) ;
F_123 ( V_4 , V_237 ) ;
F_120 ( V_237 , F_122 , V_13 + 2 , V_13 [ 1 ] - 1 ) ;
F_123 ( V_4 , V_237 ) ;
} else {
snprintf ( V_237 , F_122 , L_78 ,
V_13 [ 1 ] - 1 ) ;
F_123 ( V_4 , V_237 ) ;
}
break;
...
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_85 ,
V_13 [ 1 ] , V_13 [ 2 ] , V_13 [ 3 ] , V_13 [ 4 ] ) ;
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_86 ,
V_13 [ 5 ] ) ;
F_123 ( V_4 , V_237 ) ;
break;
case V_242 :
...
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_87 ,
( V_13 [ 2 ] << 8 ) | V_13 [ 1 ] ) ;
F_123 ( V_4 , V_237 ) ;
snprintf ( V_237 , F_122 , L_88 ,
( V_13 [ 4 ] << 8 ) | V_13 [ 3 ] ) ;
F_123 ( V_4 , V_237 ) ;
break;
case V_243 :
...
F_129 ( & V_16 -> V_232 ) ;
if ( V_253 )
V_16 -> V_254 = F_130 ( L_89 , 0600 ,
V_4 -> V_255 , V_16 , & V_256 ) ;
if ( V_249 || V_250 )
V_16 -> V_257 = F_130 ( L_90 ,
...
V_16 -> V_34 -> V_27 = V_10 ;
F_135 ( & V_16 -> V_34 -> V_25 ) ;
}
F_13 ( & V_16 -> V_30 , V_18 ) ;
}
F_126 ( V_16 , V_4 , V_10 , V_13 , V_14 ) ;
return 1 ;
}
static int F_136 ( struct V_3 * V_4 , T_8 V_266 )
{
if ( F_137 ( V_266 ) )
return 0 ;
F_72 ( F_5 ( V_4 ) ) ;
...
F_143 ( V_268 , V_184 , V_185 ) ;
F_144 ( V_277 , V_268 -> V_278 ) ;
for ( V_19 = 0 ; V_19 < V_186 ; V_19 ++ )
F_143 ( V_268 , V_279 , V_16 -> V_187 [ V_19 ] ) ;
error = F_145 ( V_268 ) ;
if ( error ) {
F_97 ( V_4 , L_100 ) ;
F_146 ( V_268 ) ;
...
static inline int F_149 ( struct V_15 * V_16 , struct V_1 * V_10 )
{
return 0 ;
}
static inline void F_150 ( struct V_15 * V_16 )
{
}
static int F_151 ( struct V_3 * V_4 , struct V_15 * V_16 )
{
int error ;
error = F_96 ( V_4 ) ;
if ( error )
...
F_98 ( V_4 , L_101 ,
F_66 ( & V_4 -> V_114 ) ) ;
error = F_140 ( V_16 , F_152 ( V_247 , V_4 ) ) ;
if ( error )
goto V_177;
error = F_149 ( V_16 , F_152 ( V_248 , V_4 ) ) ;
if ( error )
goto V_177;
error = F_49 ( V_16 ) ;
if ( error )
