...
V_85 -> V_59 ,
V_85 -> V_67 ) ;
if ( F_25 ( & ( V_4 -> V_87 ) , V_85 ) ) {
F_10 ( & V_4 -> V_35 -> V_4 , L_22 ) ;
F_27 ( V_4 ) ;
F_28 ( V_4 ) ;
return;
}
if ( F_25 ( & ( V_4 -> V_38 ) , V_85 ) ) {
V_4 -> V_25 = V_88 ;
return;
}
F_18 (cb_pos, cb_next,
...
static int F_30 ( struct V_10 * V_11 , struct V_70 * V_90 )
{
return ( V_11 -> V_58 == V_90 -> V_59 &&
V_11 -> V_47 == V_90 -> V_46 ) ;
}
...
struct V_91 * V_92 ;
int V_93 ;
for ( V_93 = 0 ; V_93 < V_4 -> V_94 ; V_93 ++ ) {
V_92 = & V_4 -> V_95 [ V_93 ] ;
if ( V_92 && V_90 -> V_46 == V_92 -> V_96 ) {
if ( V_92 -> V_97 . V_98 ) {
V_92 -> V_99 ++ ;
...
struct V_78 * V_103 )
{
return ( V_11 -> V_58 == V_103 -> V_59 &&
V_11 -> V_47 == V_103 -> V_46 ) ;
}
...
V_4 -> V_106 = 0 ;
V_4 -> V_107 = false ;
} else if ( V_101 == & V_4 -> V_38 )
V_4 -> V_36 = 0 ;
V_43 =
(struct V_42 * ) & V_4 -> V_108 [ 0 ] ;
V_43 -> V_59 = 0 ;
V_43 -> V_46 = 0 ;
V_43 -> V_50 =
sizeof( struct V_84 ) ;
...
(struct V_84 * )
& V_4 -> V_108 [ 1 ] ;
V_105 -> V_59 = V_101 -> V_58 ;
V_105 -> V_46 = V_101 -> V_47 ;
V_105 -> V_110 = V_111 ;
V_105 -> V_67 = 0 ;
V_4 -> V_112 = 2 ;
break;
...
break;
case V_145 :
V_100 = (struct V_70 * ) V_114 ;
F_33 ( V_4 , V_100 ) ;
F_10 ( & V_4 -> V_35 -> V_4 , L_38 ) ;
break;
case V_146 :
V_119 = (struct V_118 * ) V_114 ;
if ( V_119 -> V_67 || ! V_4 -> V_95 ) {
F_10 ( & V_4 -> V_35 -> V_4 , L_39 ) ;
F_38 ( V_4 , 1 ) ;
return;
}
if ( V_4 -> V_95 [ V_4 -> V_147 ]
. V_96 == V_119 -> V_148 ) {
V_4 -> V_95 [ V_4 -> V_147 ] . V_97
= V_119 -> V_149 ;
if ( V_4 -> V_132 == V_133 &&
V_4 -> V_134 ==
V_150 ) {
...
V_11 -> V_67 = - V_53 ;
V_13 -> V_55 = 0 ;
F_24 ( & V_13 -> V_32 , & V_77 -> V_34 . V_32 ) ;
return - V_53 ;
}
F_24 ( & V_13 -> V_32 , & V_4 -> V_63 . V_34 . V_32 ) ;
return 0 ;
}
...
static int F_52 ( struct V_40 * V_77 ,
struct V_3 * V_4 ,
T_3 * V_69 )
{
struct V_42 * V_43 ;
...
V_101 -> V_58 ,
V_101 -> V_47 ) ;
if ( V_101 -> V_58 == V_43 -> V_59 &&
V_101 -> V_47 == V_43 -> V_46 )
break;
}
if ( & V_101 -> V_174 == & V_4 -> V_175 ) {
...
static int F_55 ( struct V_40 * V_77 ,
struct V_3 * V_4 ,
T_3 * V_69 )
{
struct V_10 * V_11 ;
...
switch ( V_178 -> V_14 ) {
case V_188 :
V_171 = F_22 ( V_4 , V_69 , V_178 , V_11 , V_77 ) ;
if ( V_171 )
return V_171 ;
break;
case V_19 :
V_171 = F_46 ( V_4 , V_69 , V_178 , V_11 , V_77 ) ;
if ( V_171 )
return V_171 ;
break;
case V_89 :
if ( F_58 ( V_4 , V_11 ) )
continue;
V_171 = F_47 ( V_4 , V_69 , V_178 , V_11 , V_77 ) ;
if ( V_171 )
return V_171 ;
break;
default:
