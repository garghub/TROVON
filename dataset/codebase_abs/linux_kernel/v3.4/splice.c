...
return - V_98 ;
V_95 = ( V_93 -> V_10 & V_99 ) ? V_100 : 0 ;
if ( V_93 -> V_39 < V_93 -> V_101 )
V_95 |= V_102 ;
...
goto V_105;
if ( V_4 -> V_5 != V_5 ) {
char * V_106 = V_4 -> V_41 -> V_107 ( V_2 , V_4 , 1 ) ;
char * V_108 = F_64 ( V_5 ) ;
memcpy ( V_108 + V_37 , V_106 + V_4 -> V_37 , V_68 ) ;
F_65 ( V_5 ) ;
F_66 ( V_108 ) ;
V_4 -> V_41 -> V_109 ( V_2 , V_4 , V_106 ) ;
}
...
V_24 = F_70 ( V_2 , V_93 ) ;
if ( V_24 > 0 )
V_24 = F_69 ( V_2 , V_93 , V_112 ) ;
} while ( V_24 > 0 );
F_72 ( V_2 , V_93 ) ;
return V_93 -> V_115 ? V_93 -> V_115 : V_24 ;
}
T_1 F_74 ( struct V_1 * V_2 , struct V_53 * V_105 ,
...
F_22 ( V_2 ) ;
V_24 = F_73 ( V_2 , & V_93 , V_112 ) ;
F_27 ( V_2 ) ;
return V_24 ;
}
T_1
F_75 ( struct V_1 * V_2 , struct V_53 * V_105 ,
T_2 * V_55 , T_3 V_39 , unsigned int V_10 )
{
struct V_6 * V_7 = V_105 -> V_56 ;
...
int V_24 ;
void * V_121 ;
V_121 = V_4 -> V_41 -> V_107 ( V_2 , V_4 , 0 ) ;
V_24 = F_54 ( V_93 -> V_94 . V_53 , V_121 + V_4 -> V_37 , V_93 -> V_39 , V_93 -> V_81 ) ;
V_4 -> V_41 -> V_109 ( V_2 , V_4 , V_121 ) ;
return V_24 ;
}
static T_1 F_83 ( struct V_1 * V_2 ,
struct V_53 * V_105 , T_2 * V_55 ,
T_3 V_39 , unsigned int V_10 )
{
T_1 V_24 ;
V_24 = F_74 ( V_2 , V_105 , V_55 , V_39 , V_10 , F_82 ) ;
if ( V_24 > 0 )
* V_55 += V_24 ;
return V_24 ;
}
T_1 F_84 ( struct V_1 * V_2 , struct V_53 * V_105 ,
T_2 * V_55 , T_3 V_39 , unsigned int V_10 )
{
return F_74 ( V_2 , V_105 , V_55 , V_39 , V_10 , F_60 ) ;
}
static long F_85 ( struct V_1 * V_2 , struct V_53 * V_105 ,
T_2 * V_55 , T_3 V_39 , unsigned int V_10 )
{
T_1 (* F_86)( struct V_1 * , struct V_53 * ,
T_2 * , T_3 , unsigned int );
int V_24 ;
if ( F_40 ( ! ( V_105 -> V_122 & V_123 ) ) )
return - V_124 ;
if ( F_40 ( V_105 -> V_125 & V_126 ) )
return - V_98 ;
V_24 = F_87 ( V_127 , V_105 , V_55 , V_39 ) ;
if ( F_40 ( V_24 < 0 ) )
return V_24 ;
if ( V_105 -> V_96 && V_105 -> V_96 -> F_86 )
F_86 = V_105 -> V_96 -> F_86 ;
else
F_86 = F_83 ;
return F_86 ( V_2 , V_105 , V_55 , V_39 , V_10 ) ;
}
...
int V_24 ;
if ( F_40 ( ! ( V_54 -> V_122 & V_128 ) ) )
return - V_124 ;
V_24 = F_87 ( V_129 , V_54 , V_55 , V_39 ) ;
if ( F_40 ( V_24 < 0 ) )
return V_24 ;
...
T_3 V_39 ;
int V_49 , V_10 ;
V_131 = V_54 -> V_132 . V_133 -> V_134 -> V_131 ;
if ( F_40 ( ! F_91 ( V_131 ) && ! F_92 ( V_131 ) ) )
return - V_98 ;
V_2 = V_29 -> V_135 ;
if ( F_40 ( ! V_2 ) ) {
V_2 = F_93 ( NULL ) ;
...
{
struct V_53 * V_53 = V_93 -> V_94 . V_53 ;
return F_85 ( V_2 , V_53 , & V_53 -> V_139 , V_93 -> V_101 ,
V_93 -> V_10 ) ;
}
long F_95 ( struct V_53 * V_54 , T_2 * V_55 , struct V_53 * V_105 ,
T_3 V_39 , unsigned int V_10 )
{
struct V_92 V_93 = {
. V_39 = V_39 ,
...
static long F_96 ( struct V_53 * V_54 , T_2 V_83 * V_140 ,
struct V_53 * V_105 , T_2 V_83 * V_141 ,
T_3 V_39 , unsigned int V_10 )
{
struct V_1 * V_142 ;
struct V_1 * V_143 ;
...
if ( ! ( V_54 -> V_122 & V_128 ) )
return - V_124 ;
if ( ! ( V_105 -> V_122 & V_123 ) )
return - V_124 ;
if ( V_142 == V_143 )
return - V_98 ;
return F_98 ( V_142 , V_143 , V_39 , V_10 ) ;
}
if ( V_142 ) {
if ( V_140 )
return - V_145 ;
if ( V_141 ) {
if ( ! ( V_105 -> V_122 & V_146 ) )
return - V_98 ;
if ( F_99 ( & V_37 , V_141 , sizeof( T_2 ) ) )
return - V_147 ;
V_144 = & V_37 ;
} else
V_144 = & V_105 -> V_139 ;
V_24 = F_85 ( V_142 , V_105 , V_144 , V_39 , V_10 ) ;
if ( V_141 && F_100 ( V_141 , V_144 , sizeof( T_2 ) ) )
V_24 = - V_147 ;
return V_24 ;
}
if ( V_143 ) {
...
V_144 = & V_54 -> V_139 ;
V_24 = F_88 ( V_54 , V_144 , V_143 , V_39 , V_10 ) ;
if ( V_140 && F_100 ( V_140 , V_144 , sizeof( T_2 ) ) )
V_24 = - V_147 ;
return V_24 ;
}
return - V_98 ;
}
static int F_101 ( const struct V_77 V_83 * V_149 ,
unsigned int V_150 , struct V_5 * * V_36 ,
struct V_51 * V_38 , int V_151 ,
unsigned int V_152 )
{
int V_32 = 0 , error = 0 ;
while ( V_150 ) {
unsigned long V_144 , V_153 ;
struct V_77 V_154 ;
void V_83 * V_155 ;
T_3 V_39 ;
int V_49 ;
error = - V_147 ;
if ( F_99 ( & V_154 , V_149 , sizeof( V_154 ) ) )
break;
V_155 = V_154 . V_90 ;
V_39 = V_154 . V_91 ;
error = 0 ;
...
break;
error = - V_147 ;
if ( ! F_102 ( V_156 , V_155 , V_39 ) )
break;
V_144 = ( unsigned long ) V_155 & ~ V_157 ;
error = - V_98 ;
if ( V_151 && ( V_144 || V_39 & ~ V_157 ) )
break;
V_153 = ( V_144 + V_39 + V_158 - 1 ) >> V_159 ;
if ( V_153 > V_152 - V_32 )
V_153 = V_152 - V_32 ;
error = F_103 ( ( unsigned long ) V_155 , V_153 ,
0 , & V_36 [ V_32 ] ) ;
if ( F_40 ( error <= 0 ) )
break;
for ( V_49 = 0 ; V_49 < error ; V_49 ++ ) {
const int V_74 = F_41 ( T_3 , V_39 , V_158 - V_144 ) ;
V_38 [ V_32 ] . V_37 = V_144 ;
V_38 [ V_32 ] . V_39 = V_74 ;
V_144 = 0 ;
V_39 -= V_74 ;
V_32 ++ ;
...
char * V_106 ;
int V_24 ;
if ( ! F_105 ( V_93 -> V_94 . V_160 , V_93 -> V_39 ) ) {
V_106 = V_4 -> V_41 -> V_107 ( V_2 , V_4 , 1 ) ;
V_24 = F_106 ( V_93 -> V_94 . V_160 , V_106 + V_4 -> V_37 ,
V_93 -> V_39 ) ;
V_4 -> V_41 -> V_109 ( V_2 , V_4 , V_106 ) ;
if ( ! V_24 ) {
V_24 = V_93 -> V_39 ;
...
V_106 = V_4 -> V_41 -> V_107 ( V_2 , V_4 , 0 ) ;
V_24 = V_93 -> V_39 ;
if ( F_100 ( V_93 -> V_94 . V_160 , V_106 + V_4 -> V_37 , V_93 -> V_39 ) )
V_24 = - V_147 ;
V_4 -> V_41 -> V_109 ( V_2 , V_4 , V_106 ) ;
V_105:
if ( V_24 > 0 )
V_93 -> V_94 . V_160 += V_24 ;
return V_24 ;
}
static long F_107 ( struct V_53 * V_53 , const struct V_77 V_83 * V_149 ,
unsigned long V_161 , unsigned int V_10 )
{
struct V_1 * V_2 ;
struct V_92 V_93 ;
T_1 V_162 ;
...
void V_83 * V_155 ;
T_3 V_39 ;
error = F_108 ( V_155 , & V_149 -> V_90 ) ;
if ( F_40 ( error ) )
break;
error = F_108 ( V_39 , & V_149 -> V_91 ) ;
if ( F_40 ( error ) )
break;
if ( F_40 ( ! V_39 ) )
break;
...
if ( F_40 ( ! F_102 ( V_163 , V_155 , V_39 ) ) ) {
error = - V_147 ;
break;
}
V_93 . V_39 = 0 ;
V_93 . V_101 = V_39 ;
V_93 . V_10 = V_10 ;
V_93 . V_94 . V_160 = V_155 ;
V_93 . V_81 = 0 ;
V_162 = F_73 ( V_2 , & V_93 , F_104 ) ;
if ( V_162 < 0 ) {
if ( ! V_24 )
V_24 = V_162 ;
break;
...
static long F_109 ( struct V_53 * V_53 , const struct V_77 V_83 * V_149 ,
unsigned long V_161 , unsigned int V_10 )
{
struct V_1 * V_2 ;
struct V_5 * V_36 [ V_50 ] ;
...
if ( F_29 ( V_2 , & V_21 ) )
return - V_52 ;
V_21 . V_23 = F_101 ( V_149 , V_161 , V_21 . V_36 ,
V_21 . V_38 , V_10 & V_42 ,
V_2 -> V_32 ) ;
if ( V_21 . V_23 <= 0 )
V_24 = V_21 . V_23 ;
...
static int F_98 ( struct V_1 * V_142 ,
struct V_1 * V_143 ,
T_3 V_39 , unsigned int V_10 )
{
struct V_3 * V_165 , * V_166 ;
int V_24 = 0 , V_167 ;
bool V_168 = false ;
V_169:
V_24 = F_110 ( V_142 , V_10 ) ;
if ( V_24 )
return V_24 ;
...
if ( ! V_142 -> V_31 && ! V_142 -> V_118 )
break;
if ( ! V_142 -> V_31 || V_143 -> V_31 >= V_143 -> V_32 ) {
if ( V_24 )
break;
if ( V_10 & V_44 ) {
V_24 = - V_45 ;
...
V_165 = V_142 -> V_35 + V_142 -> V_34 ;
V_167 = ( V_143 -> V_34 + V_143 -> V_31 ) & ( V_143 -> V_32 - 1 ) ;
V_166 = V_143 -> V_35 + V_167 ;
if ( V_39 >= V_165 -> V_39 ) {
* V_166 = * V_165 ;
V_165 -> V_41 = NULL ;
V_143 -> V_31 ++ ;
V_142 -> V_34 = ( V_142 -> V_34 + 1 ) & ( V_142 -> V_32 - 1 ) ;
V_142 -> V_31 -- ;
V_168 = true ;
} else {
V_165 -> V_41 -> V_170 ( V_142 , V_165 ) ;
* V_166 = * V_165 ;
V_166 -> V_10 &= ~ V_15 ;
V_166 -> V_39 = V_39 ;
V_143 -> V_31 ++ ;
V_165 -> V_37 += V_166 -> V_39 ;
V_165 -> V_39 -= V_166 -> V_39 ;
}
V_24 += V_166 -> V_39 ;
V_39 -= V_166 -> V_39 ;
} while ( V_39 );
...
static int F_113 ( struct V_1 * V_142 ,
struct V_1 * V_143 ,
T_3 V_39 , unsigned int V_10 )
{
struct V_3 * V_165 , * V_166 ;
int V_24 = 0 , V_49 = 0 , V_167 ;
F_112 ( V_142 , V_143 ) ;
do {
if ( ! V_143 -> V_27 ) {
F_23 ( V_28 , V_29 , 0 ) ;
...
if ( V_49 >= V_142 -> V_31 || V_143 -> V_31 >= V_143 -> V_32 )
break;
V_165 = V_142 -> V_35 + ( ( V_142 -> V_34 + V_49 ) & ( V_142 -> V_32 - 1 ) ) ;
V_167 = ( V_143 -> V_34 + V_143 -> V_31 ) & ( V_143 -> V_32 - 1 ) ;
V_165 -> V_41 -> V_170 ( V_142 , V_165 ) ;
V_166 = V_143 -> V_35 + V_167 ;
* V_166 = * V_165 ;
...
static long F_114 ( struct V_53 * V_54 , struct V_53 * V_105 , T_3 V_39 ,
unsigned int V_10 )
{
struct V_1 * V_142 = F_97 ( V_54 ) ;
struct V_1 * V_143 = F_97 ( V_105 ) ;
int V_24 = - V_98 ;
...
V_24 = F_111 ( V_143 , V_10 ) ;
if ( ! V_24 )
V_24 = F_113 ( V_142 , V_143 , V_39 , V_10 ) ;
}
}
return V_24 ;
}
