...
static int T_8 F_40 ( struct V_3 * V_3 )
{
int V_9 = 0 ;
int V_57 ;
for ( V_57 = 0 ; V_57 < F_41 ( V_79 ) ; V_57 ++ ) {
V_9 = F_3 ( V_3 ,
V_79 [ V_57 ] . V_80 ,
V_79 [ V_57 ] . V_81 ) ;
if ( V_9 )
...
static int T_8 F_43 ( struct V_11 * V_83 ,
...
int V_9 ;
int V_57 ;
V_3 = F_44 ( sizeof( struct V_3 ) , V_89 ) ;
if ( ! V_3 ) {
F_6 ( & V_83 -> V_2 , L_33 ) ;
return - V_69 ;
}
...
if ( V_9 )
goto V_82;
V_9 = F_49 ( V_83 -> V_33 , NULL , F_22 ,
V_98 , L_42 , V_3 ) ;
F_50 ( V_83 -> V_33 ) ;
if ( V_9 )
goto V_99;
V_9 = F_51 ( & V_83 -> V_2 , & V_100 ) ;
if ( V_9 )
goto V_101;
for ( V_57 = 0 ; V_57 < F_41 ( V_102 ) ; V_57 ++ ) {
V_102 [ V_57 ] . V_88 = V_87 ;
V_102 [ V_57 ] . V_103 = sizeof( struct V_86 ) ;
}
V_9 = F_52 ( & V_83 -> V_2 , 0 , V_102 ,
F_41 ( V_102 ) , NULL , 0 ) ;
F_35 ( V_3 ) ;
return 0 ;
V_101:
...
static int T_9 F_55 ( struct V_11 * V_83 )
{
struct V_3 * V_3 = F_56 ( V_83 ) ;
F_57 ( & V_83 -> V_2 ) ;
F_39 () ;
F_53 ( V_3 -> V_15 ) ;
F_58 ( V_83 -> V_33 , V_3 ) ;
