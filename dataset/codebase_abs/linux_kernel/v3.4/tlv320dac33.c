...
case V_108 :
V_9 -> V_109 = V_110 ;
V_9 -> V_78 = F_52 ( V_9 -> V_111 , 32 ) ;
break;
case V_112 :
V_9 -> V_109 = V_113 ;
V_9 -> V_78 = F_52 ( V_9 -> V_111 , 64 ) ;
break;
default:
F_6 ( V_2 -> V_14 , L_11 ,
F_51 ( V_107 ) ) ;
...
switch ( V_51 -> V_121 -> V_122 ) {
case 44100 :
case 48000 :
V_114 = F_53 ( V_51 -> V_121 -> V_122 , V_9 -> V_123 ) ;
V_115 = F_54 ( V_51 -> V_121 -> V_122 ,
V_9 -> V_123 ) ;
break;
default:
F_6 ( V_2 -> V_14 , L_10 ,
...
V_117 = F_1 ( V_2 , V_133 ) ;
F_7 ( V_2 , V_133 , V_117 ) ;
F_11 ( V_2 , V_134 , V_114 ) ;
F_7 ( V_2 , V_135 , 96 ) ;
F_7 ( V_2 , V_136 , F_55 ( 2 ) |
F_56 ( 1 ) ) ;
F_7 ( V_2 , V_137 , F_57 ( 4 ) ) ;
V_116 = F_1 ( V_2 , V_36 ) ;
V_116 |= V_38 | V_39 | V_40 ;
F_7 ( V_2 , V_36 , V_116 ) ;
F_46 ( V_2 ) ;
if ( V_9 -> V_55 ) {
F_7 ( V_2 , V_138 , F_58 ( 1 ) ) ;
F_7 ( V_2 , V_139 , 1 ) ;
F_11 ( V_2 , V_140 , V_115 ) ;
F_7 ( V_2 , V_141 , V_142 ) ;
} else {
F_7 ( V_2 , V_138 , V_143 ) ;
F_7 ( V_2 , V_139 , 0 ) ;
...
struct V_1 * V_2 = V_104 -> V_2 ;
struct V_8 * V_9 = F_4 ( V_2 ) ;
unsigned int V_155 = V_51 -> V_121 -> V_155 ;
unsigned int V_122 = V_51 -> V_121 -> V_122 ;
unsigned int V_156 ;
if ( ! V_9 -> V_55 )
return;
switch ( V_9 -> V_55 ) {
...
break;
case V_81 :
V_9 -> V_153 = F_62 ( V_155 , V_122 ,
V_9 -> V_78 ) + 9 ;
if ( V_9 -> V_153 > ( V_9 -> V_109 - V_83 ) )
V_9 -> V_153 = V_9 -> V_109 - V_83 ;
if ( V_9 -> V_153 < ( V_83 + 10 ) )
V_9 -> V_153 = ( V_83 + 10 ) ;
V_9 -> V_82 =
F_38 ( V_51 -> V_121 -> V_122 ,
V_9 -> V_153 - V_83 + 1 ) ;
V_9 -> V_75 = 0 ;
break;
default:
...
static int F_63 ( struct V_100 * V_51 , int V_159 ,
struct V_101 * V_102 )
{
struct V_103 * V_104 = V_51 -> V_105 ;
struct V_1 * V_2 = V_104 -> V_2 ;
...
static int F_65 ( struct V_101 * V_175 ,
...
static int T_4 F_78 ( struct V_210 * V_211 ,
const struct V_212 * V_213 )
{
struct V_214 * V_215 ;
struct V_8 * V_9 ;
int V_11 , V_33 ;
if ( V_211 -> V_14 . V_216 == NULL ) {
F_6 ( & V_211 -> V_14 , L_19 ) ;
return - V_205 ;
}
V_215 = V_211 -> V_14 . V_216 ;
V_9 = F_79 ( & V_211 -> V_14 , sizeof( struct V_8 ) ,
V_217 ) ;
if ( V_9 == NULL )
return - V_208 ;
V_9 -> V_13 = V_211 ;
...
F_82 ( V_211 , V_9 ) ;
V_9 -> V_44 = V_215 -> V_44 ;
V_9 -> V_111 = V_215 -> V_111 ;
V_9 -> V_149 = V_215 -> V_149 ;
V_9 -> V_157 = V_215 -> V_157 ;
if ( ! V_9 -> V_157 )
V_9 -> V_157 = 10000 ;
V_9 -> V_94 = V_211 -> V_94 ;
V_9 -> V_55 = V_173 ;
...
V_9 -> V_43 [ V_33 ] . V_219 = V_220 [ V_33 ] ;
V_11 = F_85 ( & V_211 -> V_14 , F_21 ( V_9 -> V_43 ) ,
V_9 -> V_43 ) ;
if ( V_11 != 0 ) {
F_6 ( & V_211 -> V_14 , L_22 , V_11 ) ;
goto V_221;
}
V_11 = F_86 ( & V_211 -> V_14 ,
& V_222 , & V_223 , 1 ) ;
if ( V_11 < 0 )
goto V_224;
return V_11 ;
...
static int T_5 F_89 ( struct V_210 * V_211 )
{
struct V_8 * V_9 = F_90 ( V_211 ) ;
if ( F_13 ( V_9 -> V_12 ) )
F_18 ( V_9 -> V_2 , 0 ) ;
if ( V_9 -> V_44 >= 0 )
F_88 ( V_9 -> V_44 ) ;
