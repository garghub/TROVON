...
if ( V_33 [ V_41 ] . V_8 & V_10 )
V_159 |= V_156 ;
if ( ( V_139 & V_159 ) != V_159 )
continue;
if ( V_144 == V_162 &&
V_33 [ V_41 ] . V_51 > 1 )
continue;
V_13 -> V_15 [ V_41 ] . V_49 =
V_135 -> V_163 [ V_33 [ V_41 ] . V_51 - 1 ] ;
...
V_83 -> V_94 . V_164 = V_83 -> V_165 ;
V_83 -> V_94 . V_58 = V_83 -> V_58 ;
return V_92 . V_166 ( V_78 , V_80 , V_69 , & V_83 -> V_94 ) ;
}
static void
...
{
struct V_35 * V_36 = V_78 ;
F_36 ( V_78 , V_80 , V_69 , V_81 , V_36 -> V_128 -> V_167 . V_168 ) ;
}
static void
F_41 ( void * V_78 , struct V_79 * V_80 ,
struct V_61 * V_69 , void * V_81 ,
T_2 V_169 , enum V_132 V_133 )
{
F_36 ( V_78 , V_80 , V_69 , V_81 , V_133 ) ;
}
static void *
F_42 ( void * V_78 , struct V_61 * V_69 , T_3 V_170 )
{
struct V_79 * V_80 ;
struct V_82 * V_83 ;
struct V_35 * V_36 = V_78 ;
struct V_171 * V_128 = V_36 -> V_128 ;
int V_129 = 0 ;
int V_41 ;
for ( V_41 = 0 ; V_41 < V_172 ; V_41 ++ ) {
V_80 = V_128 -> V_173 -> V_174 [ V_41 ] ;
if ( V_80 && V_80 -> V_175 > V_129 )
V_129 = V_80 -> V_175 ;
}
V_83 = F_43 ( sizeof( struct V_12 ) , V_170 ) ;
if ( ! V_83 )
return NULL ;
V_83 -> V_165 = F_43 ( sizeof( struct V_176 ) * V_129 , V_170 ) ;
if ( ! V_83 -> V_165 )
goto error;
V_83 -> V_58 = F_44 ( V_177 * V_129 , V_170 ) ;
if ( ! V_83 -> V_58 )
goto V_178;
return V_83 ;
V_178:
...
static void *
F_47 ( struct V_171 * V_128 , struct V_179 * V_180 )
{
return V_92 . V_181 ( V_128 , V_180 ) ;
}
static void
F_48 ( void * V_78 )
{
...
F_49 ( void )
{
int V_182 , V_41 , V_183 ;
T_4 V_184 [ V_7 ] ;
memset ( V_58 , 0xff , sizeof( V_58 ) ) ;
for ( V_182 = 0 ; V_182 < V_177 ; V_182 ++ ) {
for ( V_41 = 0 ; V_41 < V_7 ; V_41 ++ ) {
F_50 ( V_184 , sizeof( V_184 ) ) ;
V_183 = ( V_41 + V_184 [ V_41 ] ) % V_7 ;
while ( V_58 [ V_182 ] [ V_183 ] != 0xff )
V_183 = ( V_183 + 1 ) % V_7 ;
V_58 [ V_182 ] [ V_183 ] = V_41 ;
}
}
}
int T_5
