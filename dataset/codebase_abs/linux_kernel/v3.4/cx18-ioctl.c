...
long F_108 ( struct V_22 * V_267 , unsigned int V_102 ,
unsigned long V_103 )
{
struct V_268 * V_269 = F_109 ( V_267 ) ;
struct V_25 * V_26 = F_110 ( V_267 ) ;
struct V_27 * V_28 = V_26 -> V_28 ;
long V_270 ;
F_104 ( & V_28 -> V_271 ) ;
if ( V_272 & V_273 )
V_269 -> V_274 = V_275 | V_276 ;
V_270 = F_111 ( V_267 , V_102 , V_103 ) ;
V_269 -> V_274 = 0 ;
F_105 ( & V_28 -> V_271 ) ;
return V_270 ;
}
void F_112 ( struct V_268 * V_277 )
{
V_277 -> V_278 = & V_279 ;
}
