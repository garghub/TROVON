...
F_42 ( V_68 ) ;
V_66 -> V_82 = F_43 ( V_2 -> V_22 ) ;
V_66 -> V_83 = F_43 ( V_2 -> V_23 ) ;
...
V_71 = F_25 ( V_14 -> V_40 -> V_87 ) - V_14 -> V_40 -> V_87 ;
if ( V_71 )
memset ( F_45 ( V_14 -> V_40 , V_71 ) , 0 , V_71 ) ;
if ( V_14 == V_2 -> V_10 )
V_10 = F_46 ( V_68 ) ;
V_74 += V_14 -> V_40 -> V_87 ;
memcpy ( F_45 ( V_68 , V_14 -> V_40 -> V_87 ) ,
V_14 -> V_40 -> V_88 , V_14 -> V_40 -> V_87 ) ;
F_3 ( L_6 ,
L_7 , V_14 ,
F_47 ( F_48 (
V_14 -> V_46 -> type ) ) ,
...
V_77 ) ;
if ( ! V_94 ) {
if ( ! ( V_73 -> V_95 -> V_96 & V_97 ) ) {
T_1 V_98 = F_51 ( ( T_5 * ) V_66 , V_74 ) ;
V_66 -> V_84 = F_52 ( V_98 ) ;
} else {
V_68 -> V_99 = V_100 ;
V_68 -> V_101 = ( F_53 ( V_68 ) -
V_68 -> V_102 ) ;
V_68 -> V_103 = F_54 ( struct V_33 , V_84 ) ;
}
}
(* V_65 -> V_104 -> V_12 )( V_68 -> V_28 ) ;
if ( V_17 && V_17 -> V_55 . V_105 != V_65 ) {
V_17 -> V_55 . V_105 = V_65 ;
}
if ( V_7 ) {
struct V_48 * V_49 ;
unsigned long V_106 ;
if ( F_55 ( V_17 , V_107 ) && V_17 -> V_108 ) {
V_49 = & V_17 -> V_50 [ V_109 ] ;
V_106 = V_17 -> V_110 [ V_109 ] ;
if ( ! F_56 ( V_49 , V_62 + V_106 ) )
F_57 ( V_17 ) ;
}
}
F_3 ( L_13 ,
...
if ( ! F_9 ( V_17 -> V_27 . V_28 ) -> V_127 && F_4 ( V_2 ) &&
V_118 && F_55 ( V_17 , V_107 ) ) {
unsigned V_128 = V_16 -> V_129 - V_2 -> V_4 ;
unsigned V_87 = V_14 -> V_40 -> V_87 + V_121 -> V_130 ;
if ( ( V_87 < V_128 ) && V_14 -> V_131 -> V_132 ) {
V_38 = V_44 ;
goto V_59;
}
}
