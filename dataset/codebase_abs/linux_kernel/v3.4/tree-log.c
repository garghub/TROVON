...
log = V_4 -> V_8 ;
F_2 ( & F_89 ( V_70 ) -> V_7 ) ;
V_5 = F_162 ( V_2 , log , V_95 , V_96 , F_45 ( V_70 ) ,
V_98 , & V_99 ) ;
F_4 ( & F_89 ( V_70 ) -> V_7 ) ;
if ( V_5 == - V_182 ) {
V_4 -> V_15 -> V_171 = V_2 -> V_60 ;
...
static T_2 int F_163 ( struct V_1 * V_2 ,
struct V_3 * log ,
struct V_31 * V_32 ,
int V_131 , T_1 V_98 ,
T_1 V_195 , T_1 V_196 )
...
V_69 = F_39 ( V_32 -> V_48 [ 0 ] , V_32 -> V_49 [ 0 ] ,
struct V_135 ) ;
F_164 ( V_32 -> V_48 [ 0 ] , V_69 , V_196 ) ;
F_37 ( V_32 -> V_48 [ 0 ] ) ;
F_23 ( V_32 ) ;
return 0 ;
}
static T_2 int F_165 ( struct V_1 * V_2 ,
...
V_5 = F_167 ( V_4 , V_32 , V_117 , V_131 ) ;
if ( V_5 == 0 ) {
struct V_34 V_204 ;
F_87 ( V_32 -> V_48 [ 0 ] , & V_204 ,
V_32 -> V_49 [ 0 ] ) ;
if ( V_131 == V_204 . type )
V_195 = F_168 ( V_198 , V_204 . V_66 ) + 1 ;
}
goto V_205;
}
V_5 = F_167 ( V_4 , V_32 , V_117 , V_131 ) ;
...
static T_2 int F_169 ( struct V_1 * V_2 ,
struct V_3 * V_4 , struct V_70 * V_70 ,
struct V_31 * V_32 ,
struct V_31 * V_197 )
{
...
static T_2 int F_171 ( struct V_1 * V_2 ,
struct V_3 * log ,
struct V_31 * V_197 ,
struct V_20 * V_202 ,
...
if ( F_174 ( V_213 + V_148 ) == V_155 ) {
int V_61 ;
V_212 = F_39 ( V_202 , V_207 + V_148 ,
struct V_68 ) ;
if ( F_175 ( V_202 , V_212 ) < V_2 -> V_60 )
continue;
...
if ( V_209 == V_217 )
V_206 = V_154 ;
V_5 = F_170 ( V_2 , log , V_32 , V_117 , V_206 ) ;
} else {
V_5 = F_178 ( V_2 , log , V_70 , 0 , 0 ) ;
}
if ( V_5 ) {
V_6 = V_5 ;
goto V_192;
...
V_5 = F_171 ( V_2 , log , V_197 , V_202 , V_222 ,
V_223 , V_209 ) ;
if ( V_5 ) {
V_6 = V_5 ;
goto V_192;
...
F_23 ( V_32 ) ;
F_23 ( V_197 ) ;
V_5 = F_169 ( V_2 , V_4 , V_70 , V_32 , V_197 ) ;
if ( V_5 ) {
V_6 = V_5 ;
goto V_192;
}
...
static T_2 int F_179 ( struct V_1 * V_2 ,
struct V_70 * V_70 ,
struct V_226 * V_160 ,
struct V_227 * V_228 ,
T_1 V_229 )
...
{
struct V_226 * V_160 = F_181 ( V_226 ) ;
int V_5 ;
V_5 = F_184 ( V_2 , V_4 , V_226 -> V_233 , V_160 , 0 ) ;
F_182 ( V_160 ) ;
return V_5 ;
}
int F_187 ( struct V_3 * V_17 )
{
int V_5 ;
struct V_31 * V_32 ;
struct V_1 * V_2 ;
...
V_242 . type = V_244 ;
V_242 . V_66 = ( T_1 ) - 1 ;
V_23 . V_146 = F_191 ( V_15 , & V_242 ) ;
if ( F_72 ( V_23 . V_146 ) ) {
V_5 = F_159 ( V_23 . V_146 ) ;
F_189 ( V_15 , V_5 , L_5
L_6 ) ;
goto error;
}
V_23 . V_146 -> V_8 = log ;
F_192 ( V_2 , V_23 . V_146 ) ;
V_5 = F_127 ( V_2 , log , & V_23 ) ;
F_48 ( V_5 ) ;
if ( V_23 . V_149 == V_153 ) {
