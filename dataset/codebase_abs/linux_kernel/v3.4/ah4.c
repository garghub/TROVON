...
if ( V_35 -> V_91 )
goto error;
V_38 = F_56 ( sizeof( * V_38 ) , V_92 ) ;
if ( ! V_38 )
return - V_50 ;
V_2 = F_57 ( V_35 -> V_90 -> V_93 , 0 , 0 ) ;
if ( F_58 ( V_2 ) )
goto error;
V_38 -> V_2 = V_2 ;
if ( F_59 ( V_2 , V_35 -> V_90 -> V_94 ,
( V_35 -> V_90 -> V_95 + 7 ) / 8 ) )
goto error;
V_89 = F_60 ( V_35 -> V_90 -> V_93 , 0 ) ;
F_61 ( ! V_89 ) ;
if ( V_89 -> V_96 . V_97 . V_98 / 8 !=
F_2 ( V_2 ) ) {
F_62 ( L_2 ,
V_99 , V_35 -> V_90 -> V_93 ,
F_2 ( V_2 ) ,
V_89 -> V_96 . V_97 . V_98 / 8 ) ;
goto error;
}
V_38 -> V_74 = V_89 -> V_96 . V_97 . V_98 / 8 ;
V_38 -> V_43 = V_35 -> V_90 -> V_100 / 8 ;
F_61 ( V_38 -> V_43 > V_101 ) ;
if ( V_35 -> V_56 . V_57 & V_58 )
V_35 -> V_56 . V_102 = F_29 ( sizeof( struct V_40 ) +
V_38 -> V_43 ) ;
else
V_35 -> V_56 . V_102 = F_30 ( sizeof( struct V_40 ) +
V_38 -> V_43 ) ;
if ( V_35 -> V_56 . V_103 == V_104 )
V_35 -> V_56 . V_102 += sizeof( struct V_13 ) ;
V_35 -> V_33 = V_38 ;
return 0 ;
error:
if ( V_38 ) {
...
{
if ( F_66 ( & V_105 , V_86 ) < 0 ) {
F_62 ( L_3 , V_99 ) ;
return - V_106 ;
}
if ( F_67 ( & V_107 , V_53 ) < 0 ) {
F_62 ( L_4 , V_99 ) ;
F_68 ( & V_105 , V_86 ) ;
return - V_106 ;
}
...
{
if ( F_70 ( & V_107 , V_53 ) < 0 )
F_62 ( L_5 , V_99 ) ;
if ( F_68 ( & V_105 , V_86 ) < 0 )
F_62 ( L_6 , V_99 ) ;
}
