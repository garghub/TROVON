...
T_7 V_147 )
{
static int V_148 [ V_97 ] V_120 ;
static int V_149 [ V_97 ] V_120 ;
const T_2 V_77 = V_78 - V_79 ;
int V_89 = 1 , V_90 = 0 ;
T_2 V_124 , V_150 , V_110 ;
int V_108 , V_151 , V_152 ( V_153 ) ;
int V_154 , V_106 , V_94 ;
...
V_150 = F_104 ( T_2 , V_124 , V_63 ) ;
V_110 = F_105 ( V_150 , V_114 ) ;
V_108 = V_110 / V_150 ;
...
if ( V_18 == V_155 )
break;
if ( V_148 [ V_155 ] == V_106 && V_147 &&
( V_147 ( V_18 , V_155 ) > V_157 ||
V_147 ( V_155 , V_18 ) > V_157 ) ) {
V_106 ++ ;
...
V_154 = V_158 ;
for ( V_108 = V_151 ; V_108 ; V_108 -- ) {
int V_159 = 0 , V_160 = 0 ;
if ( V_110 % V_108 || ( ( V_110 / V_108 ) & ~ V_132 ) )
continue;
for ( V_106 = 0 ; V_106 < V_89 ; V_106 ++ ) {
int V_161 = F_106 ( V_149 [ V_106 ] , V_108 ) ;
V_159 += V_161 ;
V_160 += V_161 * V_108 - V_149 [ V_106 ] ;
}
if ( V_160 > F_87 () / 3 )
continue;
if ( V_159 > V_154 )
...
V_91 -> V_114 = V_114 ;
V_91 -> V_110 = V_110 ;
for ( V_106 = 0 , V_94 = 0 ; V_149 [ V_106 ] ; V_106 ++ ) {
...
T_9 V_163 )
{
void * V_80 = ( void * ) V_164 ;
void * * V_165 = NULL ;
struct V_88 * V_91 ;
T_2 V_124 , V_166 , V_167 ;
int V_106 , V_49 , V_168 ;
V_91 = F_103 ( V_112 , V_113 , V_114 ,
V_147 ) ;
if ( F_109 ( V_91 ) )
return F_110 ( V_91 ) ;
V_124 = V_91 -> V_77 + V_91 -> V_112 + V_91 -> V_113 ;
V_166 = F_83 ( V_91 -> V_89 * sizeof( void * ) ) ;
V_165 = F_82 ( V_166 ) ;
if ( ! V_165 ) {
V_168 = - V_45 ;
goto V_169;
...
V_18 = V_116 -> V_96 [ V_49 ] ;
F_32 ( V_18 == V_97 ) ;
V_30 = V_162 ( V_18 , V_116 -> V_90 * V_91 -> V_111 , V_114 ) ;
if ( ! V_30 ) {
V_168 = - V_45 ;
goto V_170;
}
...
for ( V_106 = 0 ; V_106 < V_91 -> V_89 ; V_106 ++ ) {
struct V_115 * V_116 = & V_91 -> V_95 [ V_106 ] ;
void * V_30 = V_165 [ V_106 ] ;
for ( V_49 = 0 ; V_49 < V_116 -> V_90 ; V_49 ++ , V_30 += V_91 -> V_111 ) {
if ( V_116 -> V_96 [ V_49 ] == V_97 ) {
V_163 ( V_30 , V_91 -> V_111 ) ;
continue;
}
memcpy ( V_30 , V_171 , V_91 -> V_77 ) ;
V_163 ( V_30 + V_124 , V_91 -> V_111 - V_124 ) ;
}
}
V_167 = 0 ;
for ( V_106 = 0 ; V_106 < V_91 -> V_89 ; V_106 ++ ) {
V_91 -> V_95 [ V_106 ] . V_136 = V_165 [ V_106 ] - V_80 ;
V_167 = F_104 ( T_2 , V_167 ,
V_91 -> V_95 [ V_106 ] . V_136 ) ;
}
V_167 += V_91 -> V_111 ;
if ( V_167 > ( V_172 - V_173 ) * 3 / 4 ) {
F_52 ( L_21
L_22 , V_167 ,
...
V_168 = F_117 ( V_185 , & V_181 [ V_94 * V_179 ] ,
V_179 ) ;
if ( V_168 < 0 )
F_118 ( L_27 , V_168 ) ;
memcpy ( ( void * ) V_185 , V_171 , V_91 -> V_77 ) ;
}
F_54 ( L_28 ,
V_179 , V_178 , V_177 . V_1 , V_91 -> V_77 ,
V_91 -> V_112 , V_91 -> V_113 ) ;
V_168 = F_91 ( V_91 , V_177 . V_1 ) ;
goto V_186;
V_183:
while ( -- V_182 >= 0 )
V_163 ( F_119 ( V_181 [ V_182 ] ) , V_28 ) ;
V_168 = - V_45 ;
V_186:
