...
struct V_36 * V_37 ;
struct V_14 * V_15 = V_16 -> V_17 -> V_14 ;
V_37 = F_25 ( V_15 , F_26 ( V_16 -> V_32 , 0 ) ) ;
if ( ! V_37 )
goto V_58;
F_40 (func, &slot->funcs, sibling) {
if ( V_13 -> V_17 ) {
...
struct V_133 * V_134 ;
int V_135 ;
V_134 = F_104 ( sizeof( * V_134 ) , V_42 ) ;
if ( ! V_134 )
return;
V_134 -> V_1 = V_1 ;
V_134 -> type = type ;
V_134 -> V_3 = V_3 ;
F_105 ( & V_134 -> V_132 , V_13 ) ;
V_135 = F_106 ( V_136 , & V_134 -> V_132 ) ;
if ( ! V_135 )
F_19 ( V_134 ) ;
}
...
static void F_109 ( struct V_131 * V_132 )
{
struct V_12 * V_13 ;
char V_126 [ 64 ] ;
struct V_127 V_128 = { . V_129 = sizeof( V_126 ) ,
