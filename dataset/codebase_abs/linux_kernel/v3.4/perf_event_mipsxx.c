...
static unsigned int F_91 ( const struct V_73 * V_74 )
{
#ifdef F_68
...
static const struct V_73 * F_92 ( int V_2 )
{
...
static const struct V_73 * F_94 ( T_1 V_79 )
{
...
return - V_84 ;
F_96 (sibling, &leader->sibling_list, group_entry) {
...
return - V_84 ;
V_74 = F_92 ( V_24 -> V_66 . V_79 ) ;
} else if ( V_69 == V_24 -> V_66 . type ) {
V_74 = F_94 ( V_24 -> V_66 . V_79 ) ;
...
static const struct V_73 * F_114 ( T_1 V_79 )
{
...
V_124 > 127 ? V_129 : V_128 ;
#ifdef F_68
if ( F_117 ( V_124 , V_125 ) )
V_126 . V_75 = V_130 ;
else if ( F_50 ( F_118 ( V_124 ) ) )
V_126 . V_75 = V_102 ;
else
V_126 . V_75 = V_132 ;
#endif
...
V_124 > 127 ? V_129 : V_128 ;
#ifdef F_68
if ( F_121 ( V_124 , V_125 ) )
V_126 . V_75 = V_130 ;
else if ( F_50 ( F_122 ( V_124 ) ) )
V_126 . V_75 = V_102 ;
else
V_126 . V_75 = V_132 ;
#endif
...
static const struct V_73 * F_123 ( T_1 V_79 )
{
unsigned int V_124 = V_79 & 0xff ;
unsigned int V_125 = V_124 & 0x7f ;
V_126 . V_10 = V_135 ;
