...
void T_6
F_67 ( int V_92 , int (* F_68)( unsigned long , unsigned int , struct V_1 * ) ,
int V_22 , int V_23 , const char * V_93 )
{
if ( V_92 < 0 || V_92 >= F_69 ( V_94 ) )
F_70 () ;
V_94 [ V_92 ] . F_68 = F_68 ;
V_94 [ V_92 ] . V_22 = V_22 ;
V_94 [ V_92 ] . V_23 = V_23 ;
...
{
const struct V_94 * V_95 = V_94 + F_72 ( V_3 ) ;
struct V_24 V_96 ;
if ( ! V_95 -> F_68 ( V_7 , V_3 & ~ V_52 , V_2 ) )
return;
F_8 ( V_10 L_14 ,
V_95 -> V_93 , V_3 , V_7 ) ;
V_96 . V_37 = V_95 -> V_22 ;
V_96 . V_38 = 0 ;
V_96 . V_39 = V_95 -> V_23 ;
V_96 . V_40 = ( void V_41 * ) V_7 ;
F_73 ( L_15 , V_2 , & V_96 , V_3 , 0 ) ;
}
void T_6
F_74 ( int V_92 , int (* F_68)( unsigned long , unsigned int , struct V_1 * ) ,
int V_22 , int V_23 , const char * V_93 )
{
if ( V_92 < 0 || V_92 >= F_69 ( V_97 ) )
F_70 () ;
V_97 [ V_92 ] . F_68 = F_68 ;
V_97 [ V_92 ] . V_22 = V_22 ;
V_97 [ V_92 ] . V_23 = V_23 ;
...
T_7 void T_8
F_75 ( unsigned long V_7 , unsigned int V_98 , struct V_1 * V_2 )
{
const struct V_94 * V_95 = V_97 + F_72 ( V_98 ) ;
struct V_24 V_96 ;
if ( ! V_95 -> F_68 ( V_7 , V_98 | V_52 , V_2 ) )
return;
F_8 ( V_10 L_16 ,
V_95 -> V_93 , V_98 , V_7 ) ;
V_96 . V_37 = V_95 -> V_22 ;
