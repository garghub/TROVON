...
T_5 * V_41 , int V_57 )
{
F_25 ( V_3 , V_41 , V_3 -> V_58 ) ;
F_25 ( V_3 , V_30 -> V_59 , V_3 -> V_60 ) ;
return 0 ;
}
static void F_56 ( struct V_2 * V_3 , struct V_29 * V_30 ,
const T_5 * V_41 )
{
F_31 ( V_3 , V_41 , V_3 -> V_58 ) ;
F_31 ( V_3 , V_30 -> V_59 , V_3 -> V_60 ) ;
}
...
struct V_73 * V_74 = V_20 -> V_64 -> V_75 ;
int V_76 = V_20 -> V_64 -> V_77 ;
return F_69 ( V_3 , V_74 , V_76 ) ;
}
...
V_30 -> V_31 = & V_20 -> V_3 ;
V_30 -> V_87 = & V_20 -> V_87 ;
V_30 -> V_99 = ( void V_100 * ) V_101 ;
V_30 -> V_102 = ( void V_100 * ) V_103 ;
V_30 -> V_104 = 0 ;
V_3 = & V_20 -> V_3 ;
V_3 -> V_31 = V_30 ;
V_3 -> V_105 = V_106 ;
...
if ( V_61 ) {
#ifdef F_85
V_30 -> V_33 . V_108 = & V_109 ;
#endif
V_30 -> V_94 = F_53 ;
V_30 -> V_95 = F_54 ;
V_30 -> V_33 . V_110 = F_19 ;
V_30 -> V_33 . V_111 = F_17 ;
V_30 -> V_33 . V_35 = V_112 ;
V_30 -> V_33 . V_113 = F_18 ;
V_30 -> V_33 . V_114 = F_55 ;
V_30 -> V_33 . V_115 = F_56 ;
} else {
V_30 -> V_33 . V_35 = V_116 ;
}
if ( F_75 ( V_3 ) ) {
V_62 = - V_72 ;
goto V_117;
...
static int F_86 ( struct V_4 * V_7 , T_9 V_119 )
{
