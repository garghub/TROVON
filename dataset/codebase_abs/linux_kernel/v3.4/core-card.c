...
const struct V_109 * V_29 ,
struct V_57 * V_57 )
{
static T_4 V_110 = F_49 ( - 1 ) ;
V_6 -> V_110 = F_50 ( & V_110 ) ;
V_6 -> V_29 = V_29 ;
V_6 -> V_57 = V_57 ;
V_6 -> V_111 = 0 ;
V_6 -> V_112 = 0 ;
...
static int F_69 ( struct V_136 * V_138 )
{
return - V_128 ;
}
void F_70 ( struct V_121 * V_121 )
{
