...
static int F_83 ( struct V_60 * V_61 , struct V_17 * V_18 )
{
struct V_46 * V_167 = F_73 ( V_18 ) ;
struct V_36 * V_195 ;
struct V_1 * V_2 ;
...
F_87 ( V_2 , V_18 -> V_240 -> V_241 ) ;
F_87 ( V_2 , V_18 -> V_242 -> V_241 ) ;
V_194 = V_18 -> V_242 ;
if ( ! V_194 ) {
F_16 ( & V_18 -> V_2 , L_96 ,
V_12 ) ;
...
int V_8 ;
F_4 ( L_81 , V_12 , V_18 -> V_21 ) ;
V_195 = F_91 ( V_18 -> V_22 ) ;
V_167 = F_73 ( V_18 ) ;
if ( V_195 == NULL || V_167 == NULL )
return;
V_167 -> V_211 = 1 ;
F_20 ( V_167 , ( V_64 * V_244 ) / 100 , 1 ) ;
F_88 ( V_18 -> V_242 ) ;
F_88 ( V_18 -> V_240 ) ;
V_167 -> V_218 = 0 ;
F_4 ( L_99 , V_12 ) ;
...
static int F_93 ( struct V_60 * V_61 , struct V_17 * V_18 ,
...
if ( V_167 -> V_211 == 1 )
return - V_78 ;
V_246 = F_94 ( & V_167 -> V_70 , V_6 , V_246 ,
& V_167 -> V_66 ) ;
F_82 ( V_61 ) ;
return V_246 ;
}
...
V_167 -> V_218 = 1 ;
F_29 ( & V_167 -> V_66 , V_63 ) ;
F_11 ( V_34 , & V_18 -> V_2 , V_12 , V_246 ,
V_18 -> V_240 -> V_197 ) ;
V_18 -> V_240 -> V_250 = V_246 ;
V_248 = F_74 ( V_18 -> V_240 , V_209 ) ;
if ( V_248 ) {
F_81 ( V_18 ,
L_101 ,
V_12 , V_248 ) ;
...
V_168 = V_167 -> V_180 ;
V_159 = V_167 -> V_234 ;
V_248 = ( ( V_159 & V_161 ) ? V_301 : 0 )
| ( ( V_159 & V_163 ) ? V_300 : 0 )
| ( ( V_168 & V_181 ) ? V_303 : 0 )
| ( ( V_168 & V_304 ) ? V_305 : 0 )
| ( ( V_168 & V_306 ) ? V_307 : 0 )
| ( ( V_168 & V_308 ) ? V_309 : 0 ) ;
F_4 ( L_133 , V_12 , V_248 ) ;
F_29 ( & V_167 -> V_66 , V_63 ) ;
return V_248 ;
}
...
static void F_128 ( struct V_128 * V_22 )
{
int V_37 ;
struct V_46 * V_167 ;
F_4 ( L_63 , V_12 ) ;
...
static T_10 F_129 ( struct V_91 * V_2 ,
struct V_341 * V_342 , char * V_343 )
{
struct V_17 * V_18 = F_130 ( V_2 ) ;
struct V_46 * V_167 = F_73 ( V_18 ) ;
return sprintf ( V_343 , L_66 , V_167 -> V_265 ) ;
}
static T_10 F_131 ( struct V_91 * V_2 ,
struct V_341 * V_342 , const char * V_344 , T_11 V_246 )
{
struct V_17 * V_18 = F_130 ( V_2 ) ;
struct V_46 * V_167 = F_73 ( V_18 ) ;
unsigned int V_345 = F_132 ( V_344 , NULL , 0 ) ;
