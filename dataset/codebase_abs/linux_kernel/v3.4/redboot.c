...
F_5 ( V_29 L_3 ,
V_4 -> V_32 , V_23 ) ;
V_15 = F_7 ( V_4 , V_23 , V_4 -> V_27 , & V_17 ,
( void * ) V_10 ) ;
if ( V_15 )
goto V_33;
if ( V_17 != V_4 -> V_27 ) {
...
if ( F_8 ( V_10 [ V_16 ] . V_26 ) == V_4 -> V_27 ||
( V_10 [ V_16 ] . V_26 > V_4 -> V_27
&& F_8 ( V_10 [ V_16 ] . V_26 ) < V_4 -> V_27 ) ) {
int V_34 ;
V_22 = F_8 ( V_10 [ V_16 ] . V_26 ) / sizeof ( struct V_1 ) ;
...
if ( ! F_1 ( & V_10 [ V_16 ] ) )
break;
V_41 = F_10 ( sizeof( struct V_12 ) , V_43 ) ;
...
#endif
V_11 = F_11 ( sizeof( * V_11 ) * V_9 + V_21 + V_20 , V_43 ) ;
if ( ! V_11 ) {
V_15 = - V_31 ;
goto V_33;
}
