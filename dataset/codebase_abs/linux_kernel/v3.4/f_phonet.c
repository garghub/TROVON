...
F_19 ( V_11 , V_11 -> V_93 [ V_90 ] , V_41 | V_80 ) ;
}
F_37 ( & V_26 -> V_31 ) ;
return 0 ;
}
...
static T_3
int F_42 ( struct V_94 * V_95 , struct V_2 * V_3 )
{
...
V_106 . V_105 =
V_103 . V_105 ;
V_11 -> V_4 . V_107 = V_108 ;
V_11 -> V_4 . V_109 = V_110 ;
V_16 = - V_68 ;
for ( V_90 = 0 ; V_90 < V_92 ; V_90 ++ ) {
struct V_9 * V_10 ;
V_10 = F_45 ( V_11 -> V_70 , V_111 ) ;
if ( ! V_10 )
goto V_67;
V_10 -> V_38 = F_23 ;
V_11 -> V_93 [ V_90 ] = V_10 ;
}
V_11 -> V_34 = F_45 ( V_11 -> V_40 , V_111 ) ;
if ( ! V_11 -> V_34 )
goto V_67;
F_46 ( V_86 , L_1 ) ;
F_46 ( V_86 , L_2 , V_86 -> V_84 -> V_112 ,
V_11 -> V_70 -> V_112 , V_11 -> V_40 -> V_112 ) ;
return 0 ;
V_67:
if ( V_11 -> V_70 )
V_11 -> V_70 -> V_12 = NULL ;
...
static void
F_47 ( struct V_94 * V_95 , struct V_2 * V_3 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
int V_90 ;
if ( V_11 -> V_34 )
...
for ( V_90 = 0 ; V_90 < V_92 ; V_90 ++ )
if ( V_11 -> V_93 [ V_90 ] )
F_48 ( V_11 -> V_70 , V_11 -> V_93 [ V_90 ] ) ;
F_49 ( V_11 ) ;
}
int T_3 F_50 ( struct V_94 * V_95 )
{
struct V_1 * V_11 ;
int V_67 , V_113 ;
V_113 = sizeof( * V_11 ) + ( V_92 * sizeof( struct V_9 * ) ) ;
V_11 = F_51 ( V_113 , V_111 ) ;
if ( ! V_11 )
return - V_68 ;
V_11 -> V_6 = V_6 ;
V_11 -> V_4 . V_112 = L_4 ;
...
V_11 -> V_4 . V_118 = F_41 ;
F_52 ( & V_11 -> V_71 . V_31 ) ;
V_67 = F_53 ( V_95 , & V_11 -> V_4 ) ;
if ( V_67 )
F_49 ( V_11 ) ;
return V_67 ;
}
int T_3 F_54 ( struct V_83 * V_84 )
{
struct V_25 * V_26 ;
int V_67 ;
F_55 ( V_6 ) ;
