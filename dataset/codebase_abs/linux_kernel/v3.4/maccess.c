...
{
unsigned long V_14 ;
F_10 ( ( unsigned long ) V_11 + V_4 >= sizeof( struct V_15 ) ) ;
F_11 () ;
F_12 ( V_14 , 0 , 0 ) ;
F_13 ( 0 , 28 ) ;
F_5 ( V_11 + F_14 () , V_2 , V_4 ) ;
F_15 ( V_14 , 0 , 0 ) ;
F_16 () ;
}
int F_17 ( void T_6 * V_11 , void * V_2 , T_1 V_4 )
{
int V_16 = 0 , V_3 , V_8 ;
char * V_17 ;
V_17 = ( char * ) F_18 ( V_18 ) ;
...
V_8 = - V_9 ;
while ( V_16 < V_4 ) {
V_3 = F_19 ( V_20 , V_4 - V_16 ) ;
if ( F_5 ( V_17 , V_2 + V_16 , V_3 ) )
goto V_21;
if ( F_20 ( V_11 + V_16 , V_17 , V_3 ) )
goto V_21;
V_16 += V_3 ;
}
V_8 = 0 ;
...
int F_22 ( void * V_11 , void T_6 * V_2 , T_1 V_4 )
{
int V_16 = 0 , V_3 , V_8 ;
char * V_17 ;
V_17 = ( char * ) F_18 ( V_18 ) ;
