...
F_4 ( L_12 , V_14 , V_67 -> V_68 ) ;
if ( F_34 ( V_67 -> V_69 != V_34 -> V_26 -> V_27 ) )
return false ;
V_34 -> V_70 = V_67 ;
return true ;
}
static int F_35 ( struct V_25 * V_58 )
{
...
V_8 = & V_2 -> V_9 ;
V_67 = & V_8 -> V_67 ;
V_67 -> V_68 = V_78 ? V_75 -> V_81 :
V_75 -> V_82 ;
} else {
V_8 = & V_2 -> V_43 ;
V_67 = & V_8 -> V_67 ;
V_67 -> V_68 = V_78 ? V_75 -> V_83 :
V_75 -> V_84 ;
}
V_67 -> V_69 = V_75 -> V_69 ;
V_8 -> V_34 = F_38 ( V_79 , F_33 , V_67 ) ;
if ( ! V_8 -> V_34 ) {
F_19 ( V_27 , L_14 ) ;
return - V_85 ;
}
...
static int F_39 ( struct V_25 * V_58 )
{
struct V_3 * V_4 = V_5 ;
struct V_26 * V_27 = V_58 -> V_28 -> V_29 -> V_27 ;
struct V_1 * V_2 = F_24 ( V_58 ) ;
...
static int F_45 ( struct V_25 * V_58 , int V_88 )
{
struct V_3 * V_4 = V_5 ;
struct V_26 * V_27 = V_58 -> V_28 -> V_29 -> V_27 ;
struct V_1 * V_2 = F_24 ( V_58 ) ;
...
static T_9 F_47 ( struct V_25 * V_58 )
{
struct V_26 * V_27 = V_58 -> V_28 -> V_29 -> V_27 ;
struct V_3 * V_4 = V_5 ;
T_1 T_2 * V_6 = V_4 -> V_7 ;
...
struct V_3 * V_4 = V_5 ;
struct V_96 * V_97 = F_49 ( V_29 -> V_27 ) ;
int V_61 ;
int V_98 ;
...
( * V_2 ) -> V_28 = V_28 ;
F_52 ( & ( * V_2 ) -> V_9 . V_17 , F_23 ,
( unsigned long ) & ( * V_2 ) -> V_9 ) ;
F_52 ( & ( * V_2 ) -> V_43 . V_17 , F_23 ,
( unsigned long ) & ( * V_2 ) -> V_43 ) ;
}
F_53 ( V_29 -> V_27 , L_24 ) ;
return 0 ;
V_104:
F_54 ( V_101 [ V_97 -> V_99 ] ) ;
F_19 ( V_29 -> V_27 , L_25 ) ;
return V_61 ;
}
static void F_55 ( struct V_95 * V_28 )
{
struct V_96 * V_97 = F_49 ( V_28 -> V_29 -> V_27 ) ;
