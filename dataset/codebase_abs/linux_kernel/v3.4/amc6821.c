...
struct V_6 * V_7 ;
int V_82 ;
V_7 = F_38 ( sizeof( struct V_6 ) , V_83 ) ;
if ( ! V_7 ) {
F_11 ( & V_14 -> V_2 , L_15 ) ;
return - V_84 ;
}
...
if ( V_82 )
goto V_85;
V_82 = F_42 ( & V_14 -> V_2 . V_86 , & V_87 ) ;
if ( V_82 )
goto V_85;
V_7 -> V_88 = F_43 ( & V_14 -> V_2 ) ;
if ( ! F_44 ( V_7 -> V_88 ) )
return 0 ;
V_82 = F_45 ( V_7 -> V_88 ) ;
F_11 ( & V_14 -> V_2 , L_16 ) ;
F_46 ( & V_14 -> V_2 . V_86 , & V_87 ) ;
V_85:
F_47 ( V_7 ) ;
return V_82 ;
}
...
int V_104 ;
F_9 ( & V_7 -> V_17 ) ;
if ( F_50 ( V_105 , V_7 -> V_106 + V_102 ) ||
! V_7 -> V_56 ) {
for ( V_104 = 0 ; V_104 < V_107 ; V_104 ++ )
V_7 -> V_10 [ V_104 ] = F_20 ( V_14 ,
V_18 [ V_104 ] ) ;
V_7 -> V_22 = F_20 ( V_14 ,
V_108 ) ;
V_7 -> V_27 = F_20 ( V_14 ,
