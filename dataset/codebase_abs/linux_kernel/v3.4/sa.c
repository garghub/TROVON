...
V_61 -> V_62 = F_19 ( F_20 () ) ;
F_12 ( V_4 , V_63 ,
( T_2 ) ( V_64 ) V_4 -> V_65 , 0 , 0 , 0 , 0 , 0 ,
NULL , NULL , NULL , NULL , NULL ) ;
}
static int F_21 ( struct V_3 * V_4 , int V_66 )
{
return - V_67 ;
}
static int F_22 ( struct V_3 * V_4 )
{
long V_68 = F_4 ( V_4 , V_69 ) ;
if ( V_68 & V_70 )
return - 1 ;
if ( V_68 & V_71 )
return - 2 ;
...
static int F_23 ( struct V_3 * V_4 , T_2 V_73 )
{
if ( ! V_73 ) {
F_24 ( V_4 -> V_74 . V_75 ) ;
return 0 ;
}
V_4 -> V_76 = V_4 -> V_74 . V_75 = F_25 ( V_4 -> V_77 -> V_76 , V_73 ) ;
return ( V_4 -> V_76 == NULL ) ? - 1 : 0 ;
}
...
V_78 = V_4 -> V_80 ;
V_79 = V_4 -> V_79 ;
if ( F_23 ( V_4 , V_4 -> V_81 ) ) {
F_27 ( V_82 L_1 , V_79 ) ;
goto V_83;
}
if ( F_4 ( V_4 , V_69 ) & V_70 ) {
F_27 ( V_82 L_2 , V_79 , V_78 ) ;
goto V_83;
}
if ( F_4 ( V_4 , V_69 ) & V_71 ) {
F_27 ( V_82 L_3 , V_79 , V_78 ) ;
goto V_83;
}
V_48 = V_56 ;
while ( ! ( F_4 ( V_4 , V_69 ) & V_72 ) ) {
if ( F_28 ( V_56 , V_48 + V_84 * V_57 ) ) {
V_68 = F_4 ( V_4 , V_69 ) ;
F_27 ( V_82 L_4 ,
V_79 , V_78 , V_68 ) ;
goto V_83;
...
goto V_97;
V_4 -> V_98 = 0 ;
if ( F_32 ( V_4 -> V_99 -> V_1 , V_4 -> V_85 . V_93 ,
V_100 | V_101 ,
L_5 , ( void * ) V_4 ) < 0 ) {
F_27 ( V_82 L_6 ,
V_79 , V_78 ) ;
