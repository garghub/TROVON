...
if ( ! F_2 ( V_10 , V_2 ) )
return 0 ;
return F_3 ( V_2 , NULL , V_4 , V_8 , F_4 ( V_6 -> V_4 ) . V_11 ,
V_6 -> V_12 -> V_13 , V_14 , V_6 -> V_12 ) ;
}
static int F_5 ( struct V_15 * V_16 , struct V_3 * V_17 ,
...
if ( V_2 == NULL )
goto V_34;
V_19 = F_9 ( V_2 , V_8 -> V_25 . V_36 ) ;
if ( V_19 )
goto V_37;
V_19 = - V_38 ;
V_21 = F_10 ( F_11 ( ( sizeof( struct V_39 ) +
sizeof( struct V_40 ) +
64 ) ) , V_41 ) ;
if ( ! V_21 )
goto V_37;
...
V_19 = F_14 ( V_43 , V_21 , F_4 ( V_17 ) . V_11 ,
V_44 ) ;
if ( V_19 > 0 )
V_19 = 0 ;
V_37:
...
static void F_16 ( struct V_15 * V_45 , struct V_3 * V_4 , struct V_5 * V_6 ,
...
static void F_22 ( struct V_3 * V_4 , struct V_5 * V_6 ,
struct V_7 * V_46 , struct V_9 * V_10 )
{
F_16 ( & V_15 , V_4 , V_6 , V_46 , V_10 ) ;
}
static int F_23 ( struct V_3 * V_17 , const struct V_18 * V_12 ,
struct V_7 * V_8 )
{
return F_5 ( & V_15 , V_17 , V_12 , V_8 ) ;
}
static void F_24 ( struct V_1 * V_2 , struct V_39 * V_46 ,
void * V_69 )
{
V_46 -> V_70 = F_25 ( V_2 ) ;
V_46 -> V_71 = F_26 ( V_2 ) ;
...
struct V_7 * V_46 , struct V_9 * V_10 )
{
F_16 ( & V_72 , V_4 , V_6 , V_46 , V_10 ) ;
}
static int F_28 ( struct V_3 * V_17 , const struct V_18 * V_12 ,
struct V_7 * V_8 )
{
return F_5 ( & V_72 , V_17 , V_12 , V_8 ) ;
}
