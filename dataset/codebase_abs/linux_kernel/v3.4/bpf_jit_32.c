...
V_152 ) != 2 ) ;
V_47 = F_19 ( struct V_1 , V_152 ) ;
F_9 ( F_46 ( V_52 , V_29 , V_47 ) , V_11 ) ;
F_42 ( V_20 , V_52 , V_11 ) ;
break;
case V_39 :
F_64 ( V_153 , V_52 , V_48 , V_154 - 1 , V_11 ) ;
F_57 ( F_58 ( struct V_155 , V_156 ) != 4 ) ;
V_47 = F_19 ( struct V_155 , V_156 ) ;
F_9 ( F_20 ( V_20 , V_52 , V_47 ) , V_11 ) ;
break;
case V_40 :
V_11 -> V_25 |= V_28 ;
V_47 = F_19 ( struct V_1 , V_157 ) ;
F_9 ( F_20 ( V_52 , V_29 , V_47 ) , V_11 ) ;
F_9 ( F_63 ( V_52 , 0 ) , V_11 ) ;
F_49 ( V_122 , V_11 ) ;
F_57 ( F_58 ( struct V_158 ,
V_159 ) != 4 ) ;
V_47 = F_19 ( struct V_158 , V_159 ) ;
F_9 ( F_20 ( V_20 , V_52 , V_47 ) , V_11 ) ;
break;
case V_41 :
V_11 -> V_25 |= V_28 ;
F_57 ( F_58 ( struct V_1 , V_160 ) != 4 ) ;
V_47 = F_19 ( struct V_1 , V_160 ) ;
...
V_11 . V_15 = V_163 ;
V_11 . V_80 = - 1 ;
V_11 . V_63 = F_78 ( V_167 , 4 * ( V_11 . V_15 -> V_16 + 1 ) ) ;
if ( V_11 . V_63 == NULL )
return;
if ( F_71 ( F_56 ( & V_11 ) ) )
goto V_168;
V_164 = V_11 . V_13 ;
F_15 ( & V_11 ) ;
V_11 . V_64 = ( V_11 . V_13 - V_164 ) * 4 ;
#if V_68 < 7
V_164 = V_11 . V_13 ;
F_23 ( & V_11 ) ;
V_11 . V_65 = ( V_11 . V_13 - V_164 ) * 4 ;
V_11 . V_13 += V_11 . V_61 ;
if ( V_11 . V_61 ) {
V_11 . V_62 = F_78 ( V_167 , 4 * V_11 . V_61 ) ;
if ( V_11 . V_62 == NULL )
goto V_168;
}
#else
...
#endif
V_165 = 4 * V_11 . V_13 ;
V_11 . V_12 = F_79 ( F_80 ( sizeof( struct V_169 ) ,
V_165 ) ) ;
...
F_56 ( & V_11 ) ;
F_23 ( & V_11 ) ;
F_81 ( ( T_4 ) V_11 . V_12 , ( T_4 ) ( V_11 . V_12 + V_11 . V_13 ) ) ;
#if V_68 < 7
if ( V_11 . V_61 )
F_82 ( V_11 . V_62 ) ;
#endif
if ( V_166 > 1 )
F_83 ( V_170 , L_1 ,
V_171 , 16 , 4 , V_11 . V_12 ,
V_165 , false ) ;
V_163 -> V_172 = ( void * ) V_11 . V_12 ;
V_168:
F_82 ( V_11 . V_63 ) ;
return;
}
static void F_84 ( struct V_169 * V_173 )
{
F_85 ( NULL , V_173 ) ;
}
void F_86 ( struct V_88 * V_163 )
{
struct V_169 * V_173 ;
if ( V_163 -> V_172 != V_174 ) {
V_173 = (struct V_169 * ) V_163 -> V_172 ;
F_87 ( V_173 , F_84 ) ;
F_88 ( V_173 ) ;
}
}
