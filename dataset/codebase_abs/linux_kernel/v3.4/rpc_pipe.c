...
. V_123 = V_159 ,
. V_33 = strlen ( V_159 ) ,
. V_139 = F_97 ( V_159 , strlen ( V_159 ) ) ,
} ;
return F_93 ( V_50 -> V_160 , & V_116 ) ;
}
void F_118 ( struct V_161 * V_161 )
{
struct V_162 * V_163 = F_119 ( V_161 , V_164 ) ;
F_120 ( & V_163 -> V_165 ) ;
}
struct V_49 * F_121 ( const struct V_161 * V_161 )
{
struct V_162 * V_163 = F_119 ( V_161 , V_164 ) ;
F_28 ( & V_163 -> V_165 ) ;
if ( V_163 -> V_166 )
...
void F_122 ( const struct V_161 * V_161 )
{
struct V_162 * V_163 = F_119 ( V_161 , V_164 ) ;
F_123 ( V_163 -> V_166 == NULL ) ;
F_30 ( & V_163 -> V_165 ) ;
}
static int
F_124 ( struct V_49 * V_50 , void * V_30 , int V_167 )
{
struct V_42 * V_42 ;
struct V_19 * V_168 ;
...
V_50 -> V_175 = & V_176 ;
V_50 -> V_177 = 1 ;
V_42 = F_60 ( V_50 , V_111 | 0755 ) ;
V_50 -> V_160 = V_168 = F_125 ( V_42 ) ;
if ( ! V_168 )
return - V_124 ;
...
static struct V_19 *
F_130 ( struct V_184 * V_185 ,
int V_38 , const char * V_186 , void * V_30 )
{
return F_131 ( V_185 , V_38 , V_187 -> V_188 -> V_189 , F_124 ) ;
}
