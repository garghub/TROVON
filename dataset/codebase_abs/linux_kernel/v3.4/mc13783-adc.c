...
if ( ! F_11 ( V_19 ) ) {
V_15 = F_18 ( & V_19 -> V_2 . V_30 , & V_36 ) ;
if ( V_15 )
goto V_37;
}
V_7 -> V_38 = F_19 ( & V_19 -> V_2 ) ;
if ( F_20 ( V_7 -> V_38 ) ) {
V_15 = F_21 ( V_7 -> V_38 ) ;
F_22 ( & V_19 -> V_2 ,
L_4 , V_15 ) ;
...
V_39:
if ( ! F_11 ( V_19 ) )
F_23 ( & V_19 -> V_2 . V_30 , & V_36 ) ;
V_37:
if ( V_25 -> V_20 & V_33 )
F_23 ( & V_19 -> V_2 . V_30 , & V_34 ) ;
V_35:
...
static int T_4 F_25 ( struct V_18 * V_19 )
{
struct V_6 * V_7 = F_12 ( V_19 ) ;
T_2 V_20 = F_8 ( V_19 ) -> V_20 ;
F_26 ( V_7 -> V_38 ) ;
