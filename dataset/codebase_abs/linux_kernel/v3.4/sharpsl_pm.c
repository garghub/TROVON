...
{
int V_86 [ 5 ] , V_84 , V_3 , V_65 ;
F_13 ( V_4 . V_44 , L_37 ) ;
V_65 = V_4 . V_5 -> V_34 ( V_35 ) ;
if ( V_65 && ( V_4 . V_11 == V_12 ) ) {
V_4 . V_5 -> V_59 ( 0 ) ;
F_44 ( 100 ) ;
V_4 . V_5 -> V_92 ( 1 ) ;
...
V_84 = F_32 ( V_86 ) ;
F_13 ( V_4 . V_44 , L_38 , V_65 , V_84 , V_4 . V_5 -> V_34 ( V_43 ) ) ;
if ( ( V_65 && ( V_84 < V_4 . V_5 -> V_120 ) ) ||
( ! V_65 && ( V_84 < V_4 . V_5 -> V_121 ) ) )
return - 1 ;
return 0 ;
}
...
static T_4 F_46 ( struct V_127 * V_44 , struct V_128 * V_129 , char * V_130 )
{
return sprintf ( V_130 , L_47 , V_4 . V_32 . V_45 ) ;
}
static T_4 F_47 ( struct V_127 * V_44 , struct V_128 * V_129 , char * V_130 )
{
return sprintf ( V_130 , L_47 , V_4 . V_32 . V_46 ) ;
}
static void F_48 ( struct V_131 * V_132 )
{
V_132 -> V_133 = V_4 . V_32 . V_33 ;
if ( V_4 . V_11 == V_12 )
V_132 -> V_134 = V_135 ;
else
V_132 -> V_134 = V_4 . V_32 . V_47 ;
V_132 -> V_136 = ( 1 << V_132 -> V_134 ) ;
V_132 -> V_137 = V_4 . V_32 . V_45 ;
}
static int T_5 F_49 ( struct V_101 * V_102 )
{
int V_138 ;
if ( ! V_102 -> V_44 . V_139 )
return - V_140 ;
V_4 . V_44 = & V_102 -> V_44 ;
V_4 . V_5 = V_102 -> V_44 . V_139 ;
V_4 . V_11 = V_61 ;
V_4 . V_48 = 0 ;
F_50 ( & V_4 . V_68 ) ;
V_4 . V_68 . V_141 = F_25 ;
...
F_51 ( L_48 , & V_55 ) ;
V_4 . V_5 -> V_142 () ;
F_52 ( V_4 . V_5 -> V_143 , L_49 ) ;
F_53 ( V_4 . V_5 -> V_143 ) ;
F_52 ( V_4 . V_5 -> V_144 , L_50 ) ;
F_53 ( V_4 . V_5 -> V_144 ) ;
F_52 ( V_4 . V_5 -> V_145 , L_51 ) ;
F_53 ( V_4 . V_5 -> V_145 ) ;
if ( F_54 ( F_55 ( V_4 . V_5 -> V_143 ) , F_27 , V_146 | V_147 | V_148 , L_52 , F_27 ) ) {
F_14 ( V_4 . V_44 , L_53 , F_55 ( V_4 . V_5 -> V_143 ) ) ;
}
if ( F_54 ( F_55 ( V_4 . V_5 -> V_145 ) , F_31 , V_146 | V_148 , L_54 , F_31 ) ) {
F_14 ( V_4 . V_44 , L_53 , F_55 ( V_4 . V_5 -> V_145 ) ) ;
}
if ( V_4 . V_5 -> V_149 ) {
if ( F_54 ( F_55 ( V_4 . V_5 -> V_149 ) , F_31 , V_146 | V_148 , L_55 , F_31 ) ) {
F_14 ( V_4 . V_44 , L_53 , F_55 ( V_4 . V_5 -> V_149 ) ) ;
}
}
if ( V_4 . V_5 -> V_38 ) {
if ( F_54 ( F_55 ( V_4 . V_5 -> V_144 ) , F_30 , V_146 | V_147 , L_56 , F_30 ) ) {
F_14 ( V_4 . V_44 , L_53 , F_55 ( V_4 . V_5 -> V_144 ) ) ;
}
}
V_138 = F_56 ( & V_102 -> V_44 , & V_150 ) ;
V_138 |= F_56 ( & V_102 -> V_44 , & V_151 ) ;
if ( V_138 != 0 )
F_11 ( & V_102 -> V_44 , L_57 , V_138 ) ;
V_152 = F_48 ;
#ifdef F_57
F_58 ( & V_153 ) ;
#endif
...
{
F_58 ( NULL ) ;
F_60 ( & V_102 -> V_44 , & V_150 ) ;
F_60 ( & V_102 -> V_44 , & V_151 ) ;
F_61 ( V_55 ) ;
F_62 ( F_55 ( V_4 . V_5 -> V_143 ) , F_27 ) ;
F_62 ( F_55 ( V_4 . V_5 -> V_145 ) , F_31 ) ;
if ( V_4 . V_5 -> V_149 )
F_62 ( F_55 ( V_4 . V_5 -> V_149 ) , F_31 ) ;
if ( V_4 . V_5 -> V_38 )
F_62 ( F_55 ( V_4 . V_5 -> V_144 ) , F_30 ) ;
F_63 ( V_4 . V_5 -> V_145 ) ;
F_63 ( V_4 . V_5 -> V_144 ) ;
F_63 ( V_4 . V_5 -> V_143 ) ;
if ( V_4 . V_5 -> exit )
