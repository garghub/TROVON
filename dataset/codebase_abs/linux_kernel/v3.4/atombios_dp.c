...
V_156 = V_167 -> V_162 ;
if ( V_167 -> V_118 [ V_145 ] >= 0x11 &&
V_167 -> V_118 [ V_124 ] & V_190 )
V_156 |= V_191 ;
F_9 ( V_167 -> V_39 , V_192 , V_156 ) ;
V_156 = F_24 ( V_167 -> V_136 ) ;
F_9 ( V_167 -> V_39 , V_193 , V_156 ) ;
if ( F_3 ( V_167 -> V_12 ) || ! V_167 -> V_172 )
F_41 ( V_167 -> V_147 ,
V_194 , 0 ) ;
else
F_29 ( V_167 -> V_12 , V_195 ,
...
V_167 . V_172 = true ;
V_15 = F_2 ( V_16 , V_138 ) ;
if ( F_49 ( V_12 -> V_20 . V_21 , V_15 , & V_205 , & V_206 ) ) {
if ( V_206 > 1 ) {
V_167 . V_172 = false ;
}
}
...
V_167 . V_180 |= V_212 ;
V_167 . V_202 = F_10 ( V_39 , V_213 ) ;
V_156 = F_10 ( V_39 , V_124 ) ;
if ( F_50 ( V_12 ) && ( V_156 & V_214 ) )
V_167 . V_204 = true ;
else
V_167 . V_204 = false ;
