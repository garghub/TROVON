...
V_127 -> V_129 = V_130 ;
V_127 -> V_131 = V_13 ;
V_127 -> V_132 = sizeof( struct V_133 ) ;
V_127 -> V_134 = & V_135 ;
V_127 -> V_136 = & V_137 ;
V_111 = F_66 ( V_127 ) ;
if ( V_111 )
...
{
struct V_12 * V_13 = V_74 -> V_140 ;
return F_79 ( V_74 , V_13 -> V_26 , V_143 ) ;
}
static int F_80 ( struct V_74 * V_74 , struct V_144 * V_145 )
{
struct V_12 * V_13 = V_74 -> V_140 ;
return F_81 ( V_74 , V_13 -> V_26 , V_145 ) ;
}
...
int V_59 ;
int V_111 ;
V_22 = F_69 ( sizeof *V_22 , V_138 ) ;
if ( ! V_22 )
return - V_139 ;
F_83 ( & V_22 -> V_72 ) ;
V_22 -> V_141 = F_84 ( & V_147 -> V_23 , NULL ) ;
if ( F_71 ( V_22 -> V_141 ) ) {
V_111 = F_72 ( V_22 -> V_141 ) ;
goto V_152;
}
V_59 = F_85 ( V_147 , 0 ) ;
V_151 = F_86 ( V_147 , V_153 , 0 ) ;
if ( V_59 < 0 || V_151 == NULL ) {
F_87 ( & V_147 -> V_23 , L_23 ) ;
V_111 = - V_154 ;
goto V_155;
}
V_111 = F_88 ( & V_147 -> V_23 , & V_22 -> V_51 ) ;
if ( V_111 )
goto V_155;
F_89 ( & V_22 -> V_27 ) ;
V_149 = F_90 () ;
...
* V_149 = V_157 ;
V_149 -> V_158 = & V_22 -> V_27 ;
F_91 ( V_149 , V_22 ) ;
snprintf ( V_149 -> V_90 , sizeof( V_149 -> V_90 ) , L_25 , V_157 . V_90 ) ;
V_22 -> V_149 = V_149 ;
F_92 ( & V_22 -> V_51 , V_159
L_26 , V_149 -> V_86 ) ;
F_93 ( V_147 , V_22 ) ;
if ( F_94 ( & V_147 -> V_23 , V_151 -> V_160 ,
F_95 ( V_151 ) , V_78 ) == NULL )
goto V_161;
V_22 -> V_28 = F_96 ( & V_147 -> V_23 , V_151 -> V_160 ,
F_95 ( V_151 ) ) ;
if ( ! V_22 -> V_28 )
goto V_161;
V_22 -> V_59 = V_59 ;
V_22 -> V_151 = V_151 ;
if ( F_97 ( & V_147 -> V_23 , V_22 -> V_59 , F_21 ,
0 , V_78 , V_22 ) < 0 )
goto V_161;
V_22 -> V_125 = F_98 ( & V_147 -> V_23 ) ;
if ( F_71 ( V_22 -> V_125 ) ) {
F_17 ( & V_22 -> V_51 , L_27 ) ;
V_111 = F_72 ( V_22 -> V_125 ) ;
goto V_161;
}
V_22 -> V_25 = F_99 ( & V_162 ) ;
if ( F_71 ( V_22 -> V_25 ) ) {
F_17 ( & V_22 -> V_51 , L_28 ) ;
V_111 = F_72 ( V_22 -> V_25 ) ;
goto V_163;
}
V_111 = F_100 ( V_149 , V_164 , 0 ) ;
if ( V_111 ) {
F_17 ( & V_22 -> V_51 , L_29 ) ;
goto V_165;
}
...
static int F_106 ( struct V_146 * V_147 )
{
struct V_21 * V_22 = F_107 ( V_147 ) ;
F_92 ( & V_22 -> V_51 , L_30 V_159 ) ;
F_108 ( V_22 -> V_149 ) ;
F_101 ( V_22 -> V_25 ) ;
F_102 ( V_22 -> V_125 ) ;
F_104 ( & V_22 -> V_51 ) ;
