...
static struct V_21 * F_20 ( unsigned long V_2 , struct V_4 * V_5 )
{
struct V_21 * V_22 ;
if ( ! V_5 -> V_24 )
return NULL ;
F_21 ( ! F_22 ( & V_5 -> V_15 -> V_25 ) ) ;
V_22 = F_23 ( V_5 -> V_15 , V_2 ) ;
if ( V_22 && V_22 -> V_26 <= V_2 && F_24 ( V_22 ) )
return V_22 ;
return NULL ;
}
static struct V_21 * F_20 ( unsigned long V_2 , struct V_4 * V_5 )
...
int F_25 ( unsigned long V_2 , unsigned long V_3 ,
struct V_4 * V_5 )
{
T_4 * V_16 ;
unsigned long V_11 ;
...
if ( V_5 -> V_29 )
V_7 = V_5 -> V_29 ( V_16 , V_2 , V_11 , V_5 ) ;
if ( ! V_7 &&
