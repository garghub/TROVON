...
static inline int F_80 ( int V_100 , T_5 V_43 , struct V_109 * V_110 )
{
int V_111 = 0 ;
int V_112 ;
if ( ! ( V_100 & V_86 ) )
...
V_100 |= V_115 ;
if ( V_100 & V_77 ) {
V_100 &= V_116 | V_117 | V_77 ;
V_112 = 0 ;
} else {
V_112 = V_118 | F_81 ( V_100 ) ;
}
V_110 -> V_119 = V_100 ;
if ( V_100 & V_89 )
V_112 |= V_26 ;
...
struct V_4 * F_82 ( const char * V_127 , int V_100 , T_5 V_43 )
{
struct V_109 V_110 ;
int V_128 = F_80 ( V_100 , V_43 , & V_110 ) ;
return F_83 ( V_129 , V_127 , & V_110 , V_128 ) ;
}
struct V_4 * F_84 ( struct V_1 * V_1 , struct V_69 * V_25 ,
const char * V_127 , int V_100 )
{
struct V_109 V_110 ;
int V_128 = F_80 ( V_100 , 0 , & V_110 ) ;
if ( V_100 & V_86 )
return F_52 ( - V_9 ) ;
if ( ! V_127 && ( V_100 & V_116 ) )
if ( ! V_1 -> V_16 -> V_130 -> V_128 )
return F_52 ( - V_131 ) ;
return F_85 ( V_1 , V_25 , V_127 , & V_110 , V_128 ) ;
}
long F_86 ( int V_132 , const char T_2 * V_127 , int V_100 , T_5 V_43 )
{
struct V_109 V_110 ;
int V_128 = F_80 ( V_100 , V_43 , & V_110 ) ;
char * V_133 = F_87 ( V_127 ) ;
int V_31 = F_88 ( V_133 ) ;
if ( ! F_61 ( V_133 ) ) {
V_31 = F_89 ( V_100 ) ;
if ( V_31 >= 0 ) {
struct V_4 * V_70 = F_83 ( V_132 , V_133 , & V_110 , V_128 ) ;
if ( F_61 ( V_70 ) ) {
F_75 ( V_31 ) ;
V_31 = F_88 ( V_70 ) ;
} else {
...
int F_92 ( struct V_4 * V_5 , T_8 V_134 )
{
int V_135 = 0 ;
if ( ! F_93 ( V_5 ) ) {
F_94 ( V_136 L_1 ) ;
...
if ( V_5 -> V_54 && V_5 -> V_54 -> V_137 )
V_135 = V_5 -> V_54 -> V_137 ( V_5 , V_134 ) ;
