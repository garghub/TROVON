...
int V_53 ;
if ( V_2 -> V_61 )
return V_2 -> V_61 ( V_2 -> V_59 ) ;
V_53 = F_1 ( V_2 , V_10 ,
V_60 ) ;
return V_53 * 12500 + 600000 ;
}
static int F_30 ( struct V_8 * V_9 , int V_50 ,
int V_51 , unsigned * V_52 )
{
struct V_1 * V_2 = F_6 ( V_9 ) ;
if ( V_2 -> V_58 )
return V_2 -> V_58 ( V_2 -> V_59 , V_50 ) ;
...
struct V_1 * V_2 = F_6 ( V_9 ) ;
int V_53 ;
if ( ( V_50 / 1000 < V_2 -> V_63 ) || ( V_51 / 1000 > V_2 -> V_64 ) )
return - V_57 ;
...
static int F_37 ( struct V_8 * V_9 , unsigned V_47 )
{
struct V_1 * V_2 = F_6 ( V_9 ) ;
int V_65 = 0 ;
switch ( V_2 -> V_66 ) {
...
static int
F_38 ( struct V_8 * V_9 , int V_50 , int V_51 ,
unsigned int * V_52 )
{
struct V_1 * V_2 = F_6 ( V_9 ) ;
int V_53 = 0 ;
...
if ( V_50 == 0 )
V_53 = 0 ;
else if ( ( V_50 >= 600000 ) && ( V_50 <= 1300000 ) ) {
int V_69 ;
...
if ( V_50 == 0 )
V_53 = 0 ;
else if ( ( V_50 >= 700000 ) && ( V_50 <= 1420000 ) ) {
int V_69 ;
...
* V_52 = V_53 ;
return F_3 ( V_2 , V_10 , V_70 ,
V_53 ) ;
}
static int F_39 ( struct V_8 * V_9 )
{
struct V_1 * V_2 = F_6 ( V_9 ) ;
return F_1 ( V_2 , V_10 , V_70 ) ;
}
...
static int T_2 F_42 ( struct V_73 * V_74 )
{
int V_75 , V_38 ;
struct V_1 * V_2 ;
struct V_76 * V_77 ;
...
V_38 = V_74 -> V_38 ;
V_77 = V_74 -> V_85 . V_88 ;
for ( V_75 = 0 , V_2 = NULL ; V_75 < F_45 ( V_84 ) ; V_75 ++ ) {
V_2 = V_84 [ V_75 ] . V_59 ;
if ( ! V_2 || V_2 -> V_86 . V_38 != V_38 )
continue;
break;
}
V_81 = V_77 -> V_89 ;
...
V_9 = F_46 ( & V_2 -> V_86 , & V_74 -> V_85 , V_77 , V_2 ,
V_74 -> V_85 . V_87 ) ;
if ( F_47 ( V_9 ) ) {
F_48 ( & V_74 -> V_85 , L_1 ,
V_2 -> V_86 . V_110 , F_49 ( V_9 ) ) ;
return F_49 ( V_9 ) ;
}
F_50 ( V_74 , V_9 ) ;
if ( F_51 () )
...
static int T_3 F_52 ( struct V_73 * V_74 )
{
F_53 ( F_54 ( V_74 ) ) ;
return 0 ;
}
