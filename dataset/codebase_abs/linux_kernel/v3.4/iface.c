...
V_110 = V_30 -> V_129 ;
F_78 ( V_30 , NULL , V_130 ) ;
if ( V_56 || ( V_110 != V_30 -> V_129 ) )
F_42 ( V_30 , V_56 ) ;
F_79 ( & V_30 -> V_131 , V_40 ) ;
for ( V_108 = 0 ; V_108 < V_132 ; V_108 ++ ) {
F_80 (&local->pending[i], skb, tmp) {
struct V_133 * V_134 = F_81 ( V_106 ) ;
if ( V_134 -> V_47 . V_7 == & V_6 -> V_7 ) {
F_82 ( V_106 , & V_30 -> V_135 [ V_108 ] ) ;
F_83 ( V_106 ) ;
}
}
}
F_84 ( & V_30 -> V_131 , V_40 ) ;
}
...
F_56 ( & V_30 -> V_112 ) ;
F_87 ( & V_30 -> V_113 , & V_2 -> V_114 , V_2 -> V_115 ) ;
F_58 ( & V_30 -> V_112 ) ;
F_88 ( & V_30 -> V_77 , & V_30 -> V_142 ) ;
}
...
struct V_105 * V_106 )
{
return F_95 ( F_2 ( V_2 ) , V_106 ) ;
}
static T_4 F_96 ( struct V_1 * V_2 ,
struct V_105 * V_106 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_29 * V_30 = V_6 -> V_30 ;
...
return 0 ;
if ( V_106 -> V_154 < 4 ||
V_106 -> V_154 < F_97 ( V_151 -> V_155 ) + 2 )
return 0 ;
V_149 = ( void * ) ( ( V_156 * ) V_106 -> V_152 + F_97 ( V_151 -> V_155 ) ) ;
return F_98 ( V_30 , V_106 , V_149 ) ;
}
...
static void F_101 ( struct V_163 * V_127 )
{
struct V_5 * V_6 =
...
V_165 = ( void * ) & V_106 -> V_172 ;
F_105 ( & V_6 -> V_7 , V_165 -> V_173 ,
V_165 -> V_174 ) ;
} else if ( F_106 ( V_169 -> V_176 ) &&
V_169 -> V_37 . V_177 . V_178 == V_179 ) {
int V_154 = V_106 -> V_154 ;
F_39 ( & V_30 -> V_180 ) ;
V_53 = F_107 ( V_6 , V_169 -> V_16 ) ;
if ( V_53 ) {
...
V_6 -> V_2 -> V_159 = & V_160 ;
V_6 -> V_193 . V_28 = type ;
V_6 -> V_64 = F_122 ( V_194 ) ;
V_6 -> V_65 = false ;
V_6 -> V_195 = 0 ;
V_6 -> V_2 -> type = V_196 ;
F_123 ( & V_6 -> V_128 ) ;
F_124 ( & V_6 -> V_127 , F_101 ) ;
switch ( type ) {
case V_70 :
type = V_24 ;
V_6 -> V_7 . type = type ;
V_6 -> V_7 . V_192 = true ;
case V_24 :
F_123 ( & V_6 -> V_37 . V_38 . V_126 ) ;
F_125 ( & V_6 -> V_37 . V_38 . V_63 ) ;
break;
case V_69 :
type = V_66 ;
V_6 -> V_7 . type = type ;
...
F_49 ( V_6 , false ) ;
F_89 ( V_6 -> V_2 ) ;
V_17 = F_132 ( V_30 , V_6 , V_201 , V_192 ) ;
if ( V_17 )
type = V_6 -> V_7 . type ;
F_121 ( V_6 , type ) ;
V_103 = F_15 ( V_6 -> V_2 , false ) ;
F_102 ( V_103 , L_4 , V_103 ) ;
return V_17 ;
}
...
if ( F_137 ( V_213 ) + F_138 ( V_213 ) != F_139 ( V_213 ) ) {
F_4 ( V_11 L_5 ) ;
break;
}
...
int V_17 , V_108 ;
F_10 () ;
V_32 = F_141 ( sizeof( * V_6 ) + V_30 -> V_77 . V_227 ,
V_12 , F_99 , V_30 -> V_77 . V_153 , 1 ) ;
if ( ! V_32 )
return - V_93 ;
F_142 ( V_32 , F_143 ( V_30 -> V_77 . V_78 ) ) ;
...
F_145 ( V_32 , F_146 ( V_30 -> V_77 . V_78 ) ) ;
V_6 = F_147 ( V_32 ) ;
...
if ( V_241 )
memcpy ( V_6 -> V_245 [ V_108 ] ,
V_241 -> V_246 . V_247 . V_248 ,
sizeof( V_6 -> V_245 [ V_108 ] ) ) ;
else
memset ( V_6 -> V_245 [ V_108 ] , 0 ,
sizeof( V_6 -> V_245 [ V_108 ] ) ) ;
}
F_121 ( V_6 , type ) ;
if ( V_226 ) {
...
const char * V_251 )
{
if ( ! ( V_30 -> V_77 . V_84 . V_40 & V_252 ) )
return 0 ;
#ifdef F_3
F_160 ( V_30 -> V_77 . V_78 , L_6 , V_251 ) ;
#endif
V_30 -> V_77 . V_84 . V_40 &= ~ V_252 ;
return V_253 ;
}
...
struct V_5 * V_6 ;
int V_254 = 0 ;
bool V_255 = false , V_166 = false , V_256 = false ;
struct V_257 * V_258 ;
...
F_11 (sdata, &local->interfaces, list) {
if ( ! F_6 ( V_6 ) ) {
V_6 -> V_7 . V_206 . V_262 = true ;
continue;
}
V_6 -> V_263 = V_6 -> V_7 . V_206 . V_262 ;
if ( V_6 -> V_7 . type == V_66 &&
! V_6 -> V_37 . V_211 . V_264 &&
! V_6 -> V_37 . V_211 . V_265 &&
! V_6 -> V_37 . V_211 . V_266 ) {
V_6 -> V_7 . V_206 . V_262 = true ;
continue;
}
if ( V_6 -> V_7 . type == V_33 &&
! V_6 -> V_37 . V_267 . V_268 ) {
V_6 -> V_7 . V_206 . V_262 = true ;
continue;
}
V_6 -> V_7 . V_206 . V_262 = false ;
V_254 ++ ;
}
F_11 (wk, &local->work_list, list) {
V_255 = true ;
V_258 -> V_6 -> V_7 . V_206 . V_262 = false ;
}
if ( V_30 -> V_111 &&
! ( V_30 -> V_77 . V_40 & V_269 ) ) {
V_166 = true ;
V_30 -> V_111 -> V_7 . V_206 . V_262 = false ;
}
if ( V_30 -> V_270 )
V_256 = true ;
F_11 (sdata, &local->interfaces, list) {
...
V_6 -> V_7 . type == V_26 )
continue;
if ( V_6 -> V_263 == V_6 -> V_7 . V_206 . V_262 )
continue;
if ( ! F_6 ( V_6 ) )
continue;
F_30 ( V_6 , V_271 ) ;
}
if ( V_255 || V_166 || V_256 )
V_259 |= V_272 ;
else
V_260 |= V_272 ;
if ( V_254 )
...
static int F_168 ( struct V_275 * V_276 ,
unsigned long V_91 ,
void * V_32 )
{
struct V_1 * V_2 = V_32 ;
