...
V_168 = F_142 ( sizeof( V_168 [ 0 ] ) * V_165 , V_106 ) ;
V_167 = F_142 ( sizeof( V_167 [ 0 ] ) * V_165 , V_106 ) ;
if ( ! V_167 || ! V_168 )
goto V_176;
...
void F_209 ( struct V_107 * * V_168 , int V_165 )
{
int V_97 ;
...
static void F_213 ( struct V_178 * V_179 , struct V_107 * V_181 )
{
if ( V_182 ) {
...
if ( V_181 -> V_114 )
F_216 ( V_179 , L_9 , V_181 -> V_114 ) ;
if ( V_181 -> V_122 )
F_216 ( V_179 , L_10 , V_181 -> V_122 ) ;
if ( V_181 -> V_186 )
F_216 ( V_179 , L_11 , ( unsigned long long ) V_181 -> V_186 ) ;
if ( V_181 -> V_59 & V_117 )
F_216 ( V_179 , L_12 ) ;
if ( V_181 -> V_59 & V_134 )
F_216 ( V_179 , L_13 ) ;
...
static int F_219 ( struct V_188 * V_188 , struct V_189 * V_189 )
{
unsigned int * V_190 = NULL ;
int V_19 ;
if ( V_182 ) {
V_190 = F_220 ( V_185 * sizeof( unsigned int ) , V_106 ) ;
if ( V_190 == NULL )
return - V_15 ;
}
V_19 = F_221 ( V_189 , & V_191 ) ;
if ( ! V_19 ) {
