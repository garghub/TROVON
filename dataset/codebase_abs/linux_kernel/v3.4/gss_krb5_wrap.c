...
static T_3
F_31 ( struct V_28 * V_29 , T_3 V_5 , struct V_3 * V_4 , T_6 V_79 )
{
unsigned int V_80 = V_79 % ( V_4 -> V_7 - V_5 - V_47 ) ;
if ( V_80 == 0 )
return 0 ;
F_11 ( L_3
L_4 , V_44 , V_79 , V_80 ) ;
...
T_3 V_64 ;
F_11 ( L_1 , V_44 ) ;
if ( V_29 -> V_43 -> V_86 == NULL )
return V_56 ;
if ( F_15 ( V_4 , V_5 , V_47 ) )
return V_56 ;
V_16 = V_81 = V_4 -> V_14 [ 0 ] . V_15 + V_5 ;
* V_16 ++ = ( unsigned char ) ( ( V_87 >> 8 ) & 0xff ) ;
* V_16 ++ = ( unsigned char ) ( V_87 & 0xff ) ;
if ( ( V_29 -> V_82 & V_88 ) == 0 )
V_82 |= V_89 ;
if ( ( V_29 -> V_82 & V_90 ) != 0 )
V_82 |= V_91 ;
...
* V_85 = F_34 ( V_29 -> V_94 ++ ) ;
F_20 ( & V_57 ) ;
V_64 = (* V_29 -> V_43 -> V_86 )( V_29 , V_5 , V_4 , V_84 , V_24 ) ;
if ( V_64 )
return V_64 ;
V_38 = F_12 () ;
return ( V_29 -> V_67 < V_38 ) ? V_68 : V_69 ;
...
static T_3
F_35 ( struct V_28 * V_29 , int V_5 , struct V_3 * V_4 )
{
T_5 V_38 ;
T_4 V_71 ;
T_1 * V_16 ;
...
unsigned int V_98 ;
F_11 ( L_1 , V_44 ) ;
if ( V_29 -> V_43 -> V_99 == NULL )
return V_56 ;
V_16 = V_4 -> V_14 [ 0 ] . V_15 + V_5 ;
if ( F_36 ( * ( ( V_50 * ) V_16 ) ) != V_87 )
return V_77 ;
V_82 = V_16 [ 2 ] ;
if ( ( ! V_29 -> V_59 && ( V_82 & V_89 ) ) ||
( V_29 -> V_59 && ! ( V_82 & V_89 ) ) )
return V_78 ;
if ( ( V_82 & V_92 ) == 0 ) {
F_11 ( L_5 , V_44 ) ;
...
if ( V_16 [ 3 ] != 0xff )
return V_77 ;
V_84 = F_37 ( ( V_50 * ) ( V_16 + 4 ) ) ;
V_79 = F_37 ( ( V_50 * ) ( V_16 + 6 ) ) ;
V_71 = F_38 ( ( T_7 * ) ( V_16 + 8 ) ) ;
if ( V_79 != 0 ) {
V_64 = F_31 ( V_29 , V_5 , V_4 , V_79 ) ;
if ( V_64 )
return V_56 ;
}
V_64 = (* V_29 -> V_43 -> V_99 )( V_29 , V_5 , V_4 ,
& V_95 , & V_96 ) ;
if ( V_64 )
return V_56 ;
V_64 = F_39 ( V_4 ,
...
if ( memcmp ( V_16 , V_97 , 6 )
|| memcmp ( V_16 + 8 , V_97 + 8 , 8 ) ) {
F_11 ( L_7 , V_44 ) ;
return V_56 ;
}
V_38 = F_12 () ;
if ( V_38 > V_29 -> V_67 )
return V_68 ;
V_98 = F_40 (unsigned int, buf->head[0].iov_len, buf->len) ;
V_98 -= V_5 + V_47 + V_95 ;
F_6 ( V_5 + V_47 + V_95 + V_98 >
V_4 -> V_14 [ 0 ] . V_13 ) ;
memmove ( V_16 , V_16 + V_47 + V_95 , V_98 ) ;
V_4 -> V_14 [ 0 ] . V_13 -= V_47 + V_95 ;
V_4 -> V_7 -= V_47 + V_95 ;
return V_69 ;
}
T_3
F_41 ( struct V_100 * V_101 , int V_5 ,
struct V_3 * V_4 , struct V_30 * * V_24 )
{
...
case V_105 :
case V_106 :
return F_32 ( V_29 , V_5 , V_4 , V_24 ) ;
}
}
T_3
F_42 ( struct V_100 * V_101 , int V_5 , struct V_3 * V_4 )
{
struct V_28 * V_29 = V_101 -> V_102 ;
switch ( V_29 -> V_60 ) {
default:
