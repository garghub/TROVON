...
T_2 * V_51 ;
V_53 -> V_90 = 0 ;
V_51 = ( T_2 * ) ( ( ( V_34 * ) & V_53 -> V_104 ) + V_53 -> V_104 . V_109 ) ;
while ( * V_51 != 0xffff ) {
V_53 -> V_90 ++ ;
V_51 ++ ;
}
...
V_53 -> V_124 = ( T_2 * ) F_30 ( ( ( V_106 ) V_8 -> V_16 . V_96 . V_122 << 4 )
+ V_8 -> V_16 . V_96 . V_125 ) ;
V_53 -> V_126 = ( V_34 * ) V_53 -> V_124 + V_53 -> V_124 [ 1 ] ;
V_53 -> V_127 = ( V_34 * ) V_53 -> V_124 + V_53 -> V_124 [ 2 ] ;
F_9 ( V_110 L_23
L_24 ,
( T_2 ) V_8 -> V_16 . V_96 . V_122 , ( T_2 ) V_8 -> V_16 . V_96 . V_125 ) ;
F_9 ( V_110 L_25
L_26 , V_53 -> V_126 ,
V_53 -> V_127 ) ;
if ( V_53 -> V_124 [ 3 ] ) {
...
static int T_1 F_31 ( struct V_128 * V_51 ,
struct V_48 * V_49 )
{
if ( V_49 -> V_129 . V_130 ) {
F_32 ( & V_49 -> V_47 , V_51 ) ;
...
static int T_1 F_44 ( struct V_48 * V_49 )
{
struct V_152 * V_153 ;
struct V_154 * V_145 ;
struct V_128 * V_51 ;
...
V_192 -> V_207 = ( T_2 ) ( 100 * ( V_192 -> V_206 /
...
static void T_1 F_71 ( struct V_48 * V_49 ,
struct V_50 * V_51 )
{
unsigned int V_216 ;
unsigned int V_217 ;
...
static void T_1 F_72 ( struct V_48 * V_49 )
{
#ifdef F_73
...
static void T_1 F_76 ( struct V_48 * V_49 )
{
#ifdef F_50
switch ( V_232 ) {
case 1 :
...
static T_3 F_81 ( struct V_241 * V_242 ,
...
static T_3 F_84 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_3 F_85 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_3 F_86 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_3 F_87 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_3 F_88 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_3 F_89 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_3 F_90 ( struct V_241 * V_242 ,
struct V_243 * V_244 , const char * V_19 , T_4 V_164 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
if ( V_164 > 0 ) {
...
static int T_1 F_91 ( struct V_246 * V_242 )
{
struct V_48 * V_49 ;
struct V_50 * V_51 = NULL ;
struct V_52 * V_53 ;
...
static int T_1 F_110 ( char * V_258 )
{
char * V_259 ;
if ( ! V_258 || ! * V_258 )
return 0 ;
...
static T_3 F_113 ( struct V_260 * V_242 , char * V_19 )
{
return snprintf ( V_19 , V_233 , L_64 , V_23 ) ;
}
static T_3 F_114 ( struct V_260 * V_242 , const char * V_19 ,
T_4 V_164 )
{
