...
{
int error = 0 ;
while ( F_51 ( & V_14 -> V_50 ) > 0 )
F_19 ( 100 ) ;
F_48 ( V_14 ) ;
F_52 ( F_51 ( & V_14 -> V_50 ) != 0 ) ;
error = F_53 ( V_14 ) ;
if ( error )
F_54 ( V_14 , L_1
L_2 ) ;
...
struct V_54 * V_55 )
{
struct V_13 * V_14 = F_61 ( F_62 ( V_55 ) ,
struct V_13 , V_52 ) ;
int error ;
if ( ! ( V_14 -> V_56 & V_57 ) ) {
...
struct V_13 * V_14 )
{
if ( ! ( V_14 -> V_58 -> V_62 & V_63 ) )
return;
F_13 () ;
if ( F_65 ( & V_14 -> V_64 , V_65 ) ) {
F_58 ( V_51 , & V_14 -> V_66 ,
F_59 ( V_53 / 6 * 10 ) ) ;
}
F_15 () ;
...
V_30 = 0 ;
V_20 = 0 ;
while ( ( V_16 = F_98 ( V_14 , V_30 , V_65 ) ) ) {
...
if ( ! V_24 [ V_26 ] )
continue;
error = F_87 ( V_24 [ V_26 ] , V_16 , V_17 ) ;
if ( error && V_19 != V_11 )
V_19 = error ;
}
* V_79 -= V_25 ;
F_18 () ;
} while ( V_22 && ! V_21 && * V_79 > 0 );
if ( V_80 && ! V_21 )
V_16 -> V_82 = V_18 ;
else
V_16 -> V_82 = 0 ;
