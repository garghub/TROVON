...
return F_94 ( V_89 , V_47 , V_69 , & V_153 ) ;
}
}
static int
F_95 ( struct V_88 * V_89 , struct V_46 * V_47 , struct V_52 * V_53 ,
struct V_29 * V_34 [] , enum V_156 V_157 ,
T_5 V_75 , bool V_158 )
{
int V_18 ;
T_5 V_159 = 0 ;
bool V_160 = V_75 & V_72 , V_161 = false ;
do {
F_41 ( & V_53 -> V_56 ) ;
V_18 = V_53 -> V_57 -> V_162 ( V_53 , V_34 , V_157 , & V_159 , V_75 , V_161 ) ;
F_42 ( & V_53 -> V_56 ) ;
V_161 = true ;
} while ( V_18 == - V_60 &&
V_53 -> V_57 -> V_163 &&
( V_18 = V_53 -> V_57 -> V_163 ( V_53 , V_161 ) ) == 0 );
if ( ! V_18 || ( V_18 == - V_164 && V_160 ) )
return 0 ;
if ( V_159 && V_158 ) {
struct V_68 * V_165 , * V_69 = F_81 ( V_47 ) ;
struct V_46 * V_166 ;
struct V_167 * V_168 ;
T_2 V_169 = sizeof( * V_168 ) + V_130 ( V_69 ) ;
int V_126 = F_82 ( sizeof( struct V_78 ) ) ;
struct V_29 * V_127 [ V_128 + 1 ] ;
struct V_29 * V_170 ;
T_5 * V_171 ;
V_166 = F_96 ( V_169 , V_27 ) ;
if ( V_166 == NULL )
return - V_99 ;
V_165 = F_97 ( V_166 , F_86 ( V_47 ) . V_73 ,
V_69 -> V_141 , V_172 , V_169 , 0 ) ;
V_168 = F_61 ( V_165 ) ;
V_168 -> error = V_18 ;
memcpy ( & V_168 -> V_173 , V_69 , V_69 -> V_130 ) ;
V_170 = ( void * ) & V_168 -> V_173 + V_126 ;
F_83 ( V_127 , V_128 ,
V_170 , V_69 -> V_130 - V_126 ,
V_174 ) ;
V_171 = F_39 ( V_127 [ V_175 ] ) ;
* V_171 = V_159 ;
F_98 ( V_89 , V_166 , F_86 ( V_47 ) . V_73 , V_176 ) ;
return - V_177 ;
}
return V_18 ;
}
...
if ( V_53 == NULL )
return - V_109 ;
if ( F_35 ( V_34 , V_178 , V_90 [ V_98 ] ,
V_53 -> type -> V_180 ) )
return - V_36 ;
F_46 ( & V_53 -> V_56 ) ;
V_18 = V_53 -> V_57 -> V_162 ( V_53 , V_34 , V_59 , NULL , 0 , 0 ) ;
F_47 ( & V_53 -> V_56 ) ;
if ( V_18 == - V_60 )
V_18 = 1 ;
return V_18 < 0 ? V_18 : V_18 > 0 ? 0 : - V_164 ;
}
static int
...
return - V_109 ;
V_53 = V_44 [ V_42 ] ;
V_166 = F_96 ( V_183 , V_27 ) ;
if ( V_166 == NULL )
return - V_99 ;
V_182 = F_59 ( V_166 , F_86 ( V_47 ) . V_73 , V_69 -> V_141 , 0 ,
V_184 ) ;
if ( ! V_182 )
goto V_185;
F_90 ( V_166 , V_67 , V_20 ) ;
F_91 ( V_166 , V_94 , V_53 -> V_3 ) ;
F_91 ( V_166 , V_95 , V_53 -> type -> V_3 ) ;
F_90 ( V_166 , V_97 , V_53 -> V_4 ) ;
F_90 ( V_166 , V_96 , V_53 -> V_5 ) ;
F_92 ( V_166 , V_182 ) ;
V_18 = F_98 ( V_89 , V_166 , F_86 ( V_47 ) . V_73 , V_176 ) ;
if ( V_18 < 0 )
return V_18 ;
return 0 ;
V_150:
...
goto V_185;
F_90 ( V_166 , V_67 , V_20 ) ;
F_91 ( V_166 , V_95 , V_93 ) ;
F_90 ( V_166 , V_97 , V_4 ) ;
F_90 ( V_166 , V_96 , V_17 ) ;
F_90 ( V_166 , V_187 , V_16 ) ;
F_92 ( V_166 , V_182 ) ;
F_10 ( L_28 , V_182 -> V_130 ) ;
V_18 = F_98 ( V_89 , V_166 , F_86 ( V_47 ) . V_73 , V_176 ) ;
if ( V_18 < 0 )
return V_18 ;
return 0 ;
...
static int
F_108 ( struct V_88 * V_189 , int V_190 , void T_6 * V_191 , int * V_151 )
{
unsigned * V_192 ;
void * V_193 ;
int V_194 = * V_151 , V_18 = 0 ;
if ( ! F_109 ( V_195 ) )
return - V_196 ;
if ( V_190 != V_197 )
return - V_198 ;
...
if ( ! V_193 )
return - V_99 ;
if ( F_111 ( V_193 , V_191 , * V_151 ) != 0 ) {
V_18 = - V_14 ;
goto V_155;
}
V_192 = ( unsigned * ) V_193 ;
if ( * V_192 < V_199 ) {
struct V_200 * V_201 = V_193 ;
if ( V_201 -> V_83 != V_20 ) {
V_18 = - V_202 ;
goto V_155;
}
...
case V_199 : {
struct V_200 * V_201 = V_193 ;
if ( * V_151 != sizeof( struct V_200 ) ) {
V_18 = - V_21 ;
goto V_155;
}
V_201 -> V_83 = V_20 ;
V_18 = F_112 ( V_191 , V_201 ,
sizeof( struct V_200 ) ) ;
goto V_155;
}
case V_203 : {
struct V_204 * V_205 = V_193 ;
if ( * V_151 != sizeof( struct V_204 ) ) {
V_18 = - V_21 ;
goto V_155;
}
V_205 -> V_53 . V_3 [ V_100 - 1 ] = '\0' ;
F_13 () ;
V_205 -> V_53 . V_42 = F_62 ( V_205 -> V_53 . V_3 ) ;
F_9 () ;
goto V_206;
}
case V_207 : {
struct V_204 * V_205 = V_193 ;
if ( * V_151 != sizeof( struct V_204 ) ||
V_205 -> V_53 . V_42 >= V_66 ) {
V_18 = - V_21 ;
goto V_155;
}
F_13 () ;
strncpy ( V_205 -> V_53 . V_3 ,
V_44 [ V_205 -> V_53 . V_42 ]
? V_44 [ V_205 -> V_53 . V_42 ] -> V_3 : L_29 ,
V_100 ) ;
F_9 () ;
goto V_206;
}
