...
V_12 = ( void * ) F_12 ( V_9 , F_10 ( V_7 ) ) ;
if ( F_13 ( ! V_12 ) )
return NULL ;
memset ( V_12 , 0x0 , V_7 ) ;
V_13 = F_14 ( V_12 ) ;
* V_8 = V_18 -> V_21 ( V_16 , V_13 , V_7 ,
V_22 ) ;
if ( ! * V_8 ) {
F_15 ( V_23 L_1 , V_24 ) ;
F_16 ( ( unsigned long ) V_12 , F_10 ( V_7 ) ) ;
return NULL ;
}
return V_12 ;
}
static void F_17 ( struct V_1 * V_2 , T_2 V_7 , void * V_25 ,
T_3 V_8 , struct V_10 * V_11 )
{
struct V_15 * V_16 = F_5 ( V_2 ) ;
struct V_17 * V_18 = F_6 ( V_16 ) ;
F_2 ( V_2 -> V_4 != & V_5 ) ;
V_18 -> V_26 ( V_16 , V_8 , 0 ) ;
F_16 ( ( unsigned long ) V_25 , F_10 ( V_7 ) ) ;
}
static T_3 F_18 ( struct V_1 * V_2 , struct V_19 * V_19 ,
unsigned long V_27 , T_2 V_7 ,
enum V_28 V_29 ,
struct V_10 * V_11 )
{
void * V_25 = F_11 ( V_19 ) + V_27 ;
T_3 V_30 ;
unsigned long V_13 ;
struct V_15 * V_16 = F_5 ( V_2 ) ;
struct V_17 * V_18 = F_6 ( V_16 ) ;
...
V_13 = F_14 ( V_25 ) ;
if ( V_31 )
V_30 = V_18 -> V_21 ( V_16 , V_13 ,
V_7 , V_22 ) ;
else
V_30 = V_18 -> V_33 ( V_16 , V_13 , V_7 ,
V_22 ) ;
if ( ! V_30 ) {
F_15 ( V_23 L_1 , V_24 ) ;
return 0 ;
...
T_2 V_7 , enum V_28 V_29 ,
struct V_10 * V_11 )
{
struct V_15 * V_16 = F_5 ( V_2 ) ;
struct V_17 * V_18 = F_6 ( V_16 ) ;
F_2 ( V_2 -> V_4 != & V_5 ) ;
V_18 -> V_26 ( V_16 , V_30 , V_29 ) ;
}
static void F_21 ( struct V_1 * V_2 , struct V_34 * V_35 ,
int V_36 , enum V_28 V_29 ,
struct V_10 * V_11 )
{
int V_37 ;
struct V_15 * V_16 = F_5 ( V_2 ) ;
