...
if ( V_16 . V_58 > V_69 )
return - V_19 ;
if ( ( V_9 = F_37 ( V_16 . V_70 ) ) == NULL )
return - V_19 ;
switch ( V_16 . type ) {
case V_71 :
if ( F_47 ( V_16 . V_12 , 7 ) == 7 ) {
V_66 = - V_19 ;
break;
}
V_66 = F_10 ( & V_16 . V_2 ,
...
int F_50 ( struct V_77 * V_78 , T_5 * V_13 )
{
T_1 * V_79 , * V_80 ;
struct V_7 * V_7 ;
struct V_1 * V_1 ;
...
if ( ( V_83 = F_53 ( V_78 , V_9 -> V_89 , 0 , V_26 ) ) == NULL ) {
F_14 ( V_1 ) ;
F_16 ( V_1 ) ;
F_12 ( V_9 ) ;
return 0 ;
...
static void * F_57 ( struct V_91 * V_92 , T_6 * V_93 )
{
F_2 ( & V_6 ) ;
return F_58 ( & V_40 , * V_93 ) ;
}
static void * F_59 ( struct V_91 * V_92 , void * V_94 , T_6 * V_93 )
{
return F_60 ( V_94 , & V_40 , V_93 ) ;
}
static void F_61 ( struct V_91 * V_92 , void * V_94 )
{
F_6 ( & V_6 ) ;
}
static int F_62 ( struct V_91 * V_92 , void * V_94 )
{
char V_95 [ 11 ] ;
int V_17 ;
if ( V_94 == V_96 )
...
struct V_1 * V_1 = F_64 ( V_94 , struct V_1 ,
V_39 ) ;
F_13 ( V_1 ) ;
F_65 ( V_92 , L_3 ,
F_66 ( V_95 , & V_1 -> V_2 ) ,
...
static int F_67 ( struct V_97 * V_97 , struct V_98 * V_98 )
{
return F_68 ( V_98 , & V_99 ) ;
}
static void * F_69 ( struct V_91 * V_92 , T_6 * V_93 )
{
F_2 ( & V_10 ) ;
return F_58 ( & V_37 , * V_93 ) ;
}
static void * F_70 ( struct V_91 * V_92 , void * V_94 , T_6 * V_93 )
{
return F_60 ( V_94 , & V_37 , V_93 ) ;
}
static void F_71 ( struct V_91 * V_92 , void * V_94 )
{
F_6 ( & V_10 ) ;
}
static int F_72 ( struct V_91 * V_92 , void * V_94 )
{
char V_95 [ 11 ] ;
int V_17 ;
if ( V_94 == V_96 )
...
F_65 ( V_92 , L_10 ,
F_66 ( V_95 , & V_7 -> V_28 -> V_60 [ V_17 ] ) ) ;
}
F_63 ( V_92 , L_6 ) ;
}
return 0 ;
}
static int F_73 ( struct V_97 * V_97 , struct V_98 * V_98 )
{
return F_68 ( V_98 , & V_100 ) ;
}
void T_7 F_74 ( void )
{
