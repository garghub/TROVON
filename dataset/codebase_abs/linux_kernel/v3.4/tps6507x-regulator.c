...
return V_10 ;
V_10 &= V_9 ;
return V_2 -> V_25 [ V_15 ] -> V_37 [ V_10 ] * 1000 ;
}
...
if ( V_15 < V_17 || V_15 > V_18 )
return - V_19 ;
if ( V_38 >= V_2 -> V_25 [ V_15 ] -> V_39 )
return - V_19 ;
else
return V_2 -> V_25 [ V_15 ] -> V_37 [ V_38 ] * 1000 ;
}
...
V_2 -> V_58 [ V_51 ] . V_61 = V_25 -> V_39 ;
V_2 -> V_58 [ V_51 ] . V_62 = & V_63 ;
V_2 -> V_58 [ V_51 ] . type = V_64 ;
V_2 -> V_58 [ V_51 ] . V_65 = V_66 ;
V_48 = F_23 ( & V_2 -> V_58 [ V_51 ] ,
V_42 -> V_12 , V_47 , V_2 , NULL ) ;
if ( F_24 ( V_48 ) ) {
F_5 ( V_42 -> V_12 ,
L_3 ,
V_41 -> V_59 ) ;
...
static int T_3 F_29 ( struct V_40 * V_41 )
{
struct V_42 * V_42 = F_30 ( V_41 ) ;
