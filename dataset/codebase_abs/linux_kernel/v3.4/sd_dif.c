...
F_38 ( V_9 ) ;
F_32 ( V_19 , V_28 , L_7 ,
V_71 , V_58 , V_57 , F_12 ( V_9 -> V_16 ) ,
F_13 ( V_9 -> V_17 ) ) ;
return - V_72 ;
}
void F_39 ( struct V_73 * V_74 , unsigned int V_75 )
{
const int V_55 = sizeof( struct V_8 ) ;
struct V_27 * V_28 ;
struct V_56 * V_56 ;
...
V_50 V_57 , V_58 ;
V_28 = V_27 ( V_74 -> V_51 -> V_76 ) ;
if ( V_28 -> V_34 == V_39 || V_75 == 0 )
return;
V_54 = V_74 -> V_31 -> V_14 ;
V_24 = V_75 / V_54 ;
V_57 = F_40 ( V_74 -> V_51 ) & 0xffffffff ;
if ( V_54 == 4096 )
V_57 >>= 3 ;
