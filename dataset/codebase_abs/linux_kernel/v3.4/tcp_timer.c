...
struct V_84 * V_85 = F_48 ( V_2 ) ;
if ( V_2 -> V_86 == V_87 ) {
F_49 (KERN_DEBUG pr_fmt(L_1),
&inet->inet_daddr,
...
struct V_90 * V_91 = F_51 ( V_2 ) ;
F_49 (KERN_DEBUG pr_fmt(L_2),
&np->daddr,
ntohs(inet->inet_dport), inet->inet_num,
tp->snd_una, tp->snd_nxt) ;
}
#endif
if ( V_16 - V_13 -> V_92 > V_18 ) {
F_3 ( V_2 ) ;
goto V_70;
}
F_52 ( V_2 , 0 ) ;
...
V_94 = V_98 ;
} else if ( V_28 -> V_95 == V_99 ) {
V_94 = V_100 ;
} else if ( ( V_28 -> V_95 == V_101 ) ||
V_13 -> V_102 ) {
if ( F_55 ( V_13 ) )
V_94 = V_103 ;
else
...
if ( F_53 ( V_2 , F_22 ( V_2 ) ) > 0 ) {
if ( ! V_28 -> V_45 )
V_28 -> V_45 = 1 ;
F_58 ( V_2 , V_106 ,
F_15 ( V_28 -> V_57 , V_107 ) ,
V_18 ) ;
goto V_70;
}
V_28 -> V_83 ++ ;
...
V_28 -> V_45 <= V_111 ) {
V_28 -> V_83 = 0 ;
V_28 -> V_57 = F_15 ( F_60 ( V_13 ) , V_18 ) ;
} else {
V_28 -> V_57 = F_15 ( V_28 -> V_57 << 1 , V_18 ) ;
}
F_58 ( V_2 , V_106 , V_28 -> V_57 , V_18 ) ;
...
F_28 ( V_2 ) ;
if ( F_29 ( V_2 ) ) {
F_30 ( V_2 , & V_28 -> V_113 , V_64 + ( V_114 / 20 ) ) ;
goto V_66;
}
if ( V_2 -> V_49 == V_67 || ! V_28 -> V_115 )
goto V_70;
if ( F_32 ( V_28 -> V_116 , V_64 ) ) {
F_30 ( V_2 , & V_28 -> V_113 , V_28 -> V_116 ) ;
goto V_70;
}
V_112 = V_28 -> V_115 ;
V_28 -> V_115 = 0 ;
...
void F_63 ( struct V_1 * V_2 , struct V_119 * V_120 )
{
F_5 ( F_6 ( V_2 ) , V_105 ) ;
}
void F_64 ( struct V_1 * V_2 , int V_121 )
{
if ( ( 1 << V_2 -> V_49 ) & ( V_122 | V_123 ) )
return;
if ( V_121 && ! F_27 ( V_2 , V_124 ) )
F_65 ( V_2 , F_66 ( F_8 ( V_2 ) ) ) ;
else if ( ! V_121 )
F_67 ( V_2 ) ;
}
...
if ( V_2 -> V_49 == V_127 && F_27 ( V_2 , V_56 ) ) {
if ( V_13 -> V_128 >= 0 ) {
const int V_129 = F_68 ( V_2 ) - V_19 ;
if ( V_129 > 0 ) {
F_69 ( V_2 , V_127 , V_129 ) ;
goto V_70;
}
}
F_10 ( V_2 , V_22 ) ;
...
if ( ! F_27 ( V_2 , V_124 ) || V_2 -> V_49 == V_67 )
goto V_70;
V_125 = F_66 ( V_13 ) ;
if ( V_13 -> V_21 || F_43 ( V_2 ) )
goto V_131;
