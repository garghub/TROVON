...
static void F_95 ( const struct V_40 * V_36 ,
const int V_128 )
{
...
static int F_153 ( struct V_40 * V_36 )
{
struct V_5 * V_6 = F_27 ( V_36 ) ;
unsigned int V_28 ;
int V_20 , V_225 ;
...
if ( ! V_6 -> V_11 )
goto V_229;
if ( V_36 -> V_230 > 1500 && ! V_6 -> V_101 ) {
F_63 ( V_6 ) ;
if ( ! V_6 -> V_101 )
goto V_229;
}
for ( V_20 = 0 ; V_20 < 32 ; V_20 ++ )
F_8 ( V_6 , F_159 ( V_20 ) , 0 ) ;
F_4 ( V_231 ,
F_160 ( 0x3ff ) ) ;
F_4 ( F_161 ( V_6 -> V_9 -> V_77 . V_75 ) ,
F_162 ( 256 ) ) ;
F_4 ( F_163 ( V_6 -> V_11 -> V_77 . V_75 ) ,
F_164 ( 32 ) ) ;
F_8 ( V_6 , V_232 ,
F_165 ( V_6 -> V_9 -> V_77 . V_75 ) |
F_166 ( V_6 -> V_9 -> V_77 . V_75 ) ) ;
F_12 ( F_114 ( V_6 -> V_7 ) ,
V_233 |
V_234 |
V_235 |
...
F_167 ( V_36 ) ;
F_168 ( & V_6 -> V_198 ) ;
snprintf ( V_6 -> V_248 , sizeof( V_6 -> V_248 ) , L_24 ,
V_36 -> V_210 ) ;
V_225 = F_169 ( V_6 -> V_11 -> V_77 . V_191 , F_142 , V_249 ,
V_6 -> V_248 , V_6 -> V_11 ) ;
if ( V_225 ) {
F_47 ( & V_6 -> V_16 -> V_36 , L_25 ,
V_6 -> V_11 -> V_77 . V_191 , V_225 ) ;
goto V_250;
}
snprintf ( V_6 -> V_251 , sizeof( V_6 -> V_251 ) , L_26 ,
V_36 -> V_210 ) ;
V_225 = F_169 ( V_6 -> V_9 -> V_77 . V_191 , F_138 , V_249 ,
V_6 -> V_251 , V_6 -> V_9 ) ;
if ( V_225 ) {
F_47 ( & V_6 -> V_16 -> V_36 , L_25 ,
V_6 -> V_9 -> V_77 . V_191 , V_225 ) ;
goto V_252;
}
if ( V_6 -> V_207 )
F_170 ( V_6 -> V_207 ) ;
F_171 ( & V_6 -> V_11 -> V_200 ) ;
V_6 -> V_11 -> V_200 . V_253 = F_140 ;
V_6 -> V_11 -> V_200 . V_54 = ( unsigned long ) V_6 -> V_11 ;
V_6 -> V_11 -> V_200 . V_254 = V_201 + V_255 ;
F_172 ( & V_6 -> V_11 -> V_200 ) ;
return 0 ;
V_252:
F_173 ( V_6 -> V_11 -> V_77 . V_191 , V_6 -> V_11 ) ;
V_250:
F_174 ( & V_6 -> V_198 ) ;
F_175 ( V_36 ) ;
V_229:
...
int V_258 = F_15 ( V_6 ) -> V_77 . V_75 ;
F_12 ( F_119 ( V_258 ) ,
V_259 ) ;
for ( V_257 = 0 ; V_257 < V_260 ; V_257 ++ ) {
V_256 = F_10 ( F_119 ( V_258 ) ) ;
if ( ! ( V_256 & V_261 ) )
break;
F_177 () ;
}
...
{
unsigned int V_256 , V_257 ;
int V_262 = F_14 ( V_6 ) -> V_77 . V_75 ;
F_12 ( F_115 ( V_262 ) ,
V_263 ) ;
for ( V_257 = 0 ; V_257 < V_260 ; V_257 ++ ) {
V_256 = F_10 ( F_115 ( V_262 ) ) ;
if ( ! ( V_256 & V_264 ) )
break;
F_177 () ;
}
...
static int F_180 ( struct V_40 * V_36 )
{
struct V_5 * V_6 = F_27 ( V_36 ) ;
unsigned int V_256 ;
int V_262 , V_258 , V_20 ;
V_262 = F_14 ( V_6 ) -> V_77 . V_75 ;
V_258 = F_15 ( V_6 ) -> V_77 . V_75 ;
if ( V_6 -> V_207 ) {
F_181 ( V_6 -> V_207 ) ;
F_182 ( V_6 -> V_207 ) ;
}
F_183 ( & V_6 -> V_11 -> V_200 ) ;
F_175 ( V_36 ) ;
F_174 ( & V_6 -> V_198 ) ;
V_256 = F_10 ( F_114 ( V_6 -> V_7 ) ) ;
if ( V_256 & ( V_235 |
V_236 |
V_237 ) )
F_116 ( V_267 L_30 , V_256 ) ;
V_256 = F_10 ( F_115 ( V_262 ) ) ;
if ( V_256 & ( V_238 |
V_239 |
V_240 |
V_241 ) )
F_116 ( V_267 L_31 , V_256 ) ;
V_256 = F_10 ( F_119 ( V_258 ) ) ;
if ( V_256 & ( V_94 | V_95 |
V_96 | V_97 ) )
F_116 ( V_267 L_32 , V_256 ) ;
F_132 ( F_15 ( V_6 ) ) ;
...
F_19 ( V_6 ) ;
F_173 ( V_6 -> V_11 -> V_77 . V_191 , V_6 -> V_11 ) ;
F_173 ( V_6 -> V_9 -> V_77 . V_191 , V_6 -> V_9 ) ;
...
static void F_184 ( const struct V_12 * V_13 ,
const T_4 * V_268 ,
const unsigned int * V_269 ,
struct V_10 * V_123 ,
struct V_72 * V_102 )
{
T_3 V_270 ;
...
const int V_273 = F_186 ( V_13 ) ;
const int V_65 = F_40 ( V_13 ) -> V_130 ;
int V_274 , V_20 , V_132 , V_275 , V_276 , V_277 ;
T_4 V_278 ;
V_270 = V_279 | V_280 |
V_281 | F_187 ( V_102 -> V_86 ) |
V_282 | F_188 ( V_13 -> V_33 - V_272 ) |
F_189 ( V_273 >> 2 ) | V_283 ;
switch ( F_31 ( V_13 ) -> V_60 ) {
case V_61 :
V_270 |= V_284 ;
V_271 = V_268 [ 0 ] + F_190 ( V_13 ) + 16 ;
break;
case V_285 :
V_270 |= V_286 ;
V_271 = V_268 [ 0 ] + F_190 ( V_13 ) + 6 ;
break;
default:
F_191 () ;
}
V_132 = V_102 -> V_81 ;
V_275 = V_132 ;
F_192 ( V_102 , V_132 ++ ) = V_270 ;
V_278 = V_102 -> V_77 . V_83 + ( V_132 & ( V_80 - 1 ) ) * 8 + 2 ;
F_192 ( V_102 , V_132 ++ ) = 0 ;
F_192 ( V_102 , V_132 ) = F_193 ( V_269 [ 0 ] - V_272 ) | F_194 ( V_268 [ 0 ] + V_272 ) ;
for ( V_20 = 1 ; V_20 <= V_65 ; V_20 ++ )
F_192 ( V_102 , V_132 + V_20 ) = F_193 ( V_269 [ V_20 ] ) | F_194 ( V_268 [ V_20 ] ) ;
V_132 += V_20 ;
if ( V_132 & 1 )
V_132 ++ ;
V_276 = V_132 ;
F_192 ( V_102 , V_132 ++ ) = V_281 | F_187 ( V_102 -> V_86 ) |
F_188 ( 2 ) | V_283 ;
F_192 ( V_102 , V_132 ++ ) = F_193 ( 2 ) | F_194 ( V_271 ) | V_287 ;
F_192 ( V_102 , V_132 ++ ) = F_193 ( 2 ) | F_194 ( V_278 ) ;
V_132 ++ ;
V_277 = ! V_102 -> V_288 ;
V_102 -> V_288 = V_277 ;
F_192 ( V_102 , V_132 ++ ) = V_289 | V_290 | V_291 |
V_292 | F_195 ( V_102 -> V_84 [ V_277 ] ) ;
F_192 ( V_102 , V_132 ++ ) = 0 ;
F_192 ( V_102 , V_132 ++ ) = V_289 | V_290 | V_291 |
V_293 | F_195 ( V_102 -> V_84 [ ! V_277 ] ) ;
F_192 ( V_102 , V_132 ++ ) = 0 ;
V_102 -> V_81 = V_132 & ( V_80 - 1 ) ;
V_274 = V_132 - V_275 ;
F_12 ( F_196 ( V_102 -> V_77 . V_75 ) , ( V_274 ) >> 1 ) ;
V_132 = V_123 -> V_81 ;
F_135 ( V_123 , V_132 ++ ) = V_289 | V_290 | V_291 |
V_294 | F_195 ( V_102 -> V_84 [ V_277 ] ) ;
F_135 ( V_123 , V_132 ++ ) = 0 ;
F_135 ( V_123 , V_132 ++ ) = V_289 | V_290 | V_291 |
V_295 | F_195 ( V_102 -> V_84 [ ! V_277 ] ) ;
F_135 ( V_123 , V_132 ++ ) = 0 ;
V_123 -> V_81 = V_132 ;
F_12 ( F_196 ( V_123 -> V_77 . V_75 ) , 2 ) ;
}
static int F_197 ( struct V_12 * V_13 , struct V_40 * V_36 )
{
...
const int V_273 = F_186 ( V_13 ) ;
F_17 ( & V_123 -> V_106 ) ;
V_296 = V_190 | V_297 | V_298 ;
V_65 = F_40 ( V_13 ) -> V_130 ;
V_268 [ 0 ] = F_100 ( V_6 -> V_68 , V_13 -> V_54 , F_39 ( V_13 ) ,
V_69 ) ;
V_269 [ 0 ] = F_39 ( V_13 ) ;
if ( F_101 ( V_6 -> V_68 , V_268 [ 0 ] ) )
goto V_299;
for ( V_20 = 0 ; V_20 < V_65 ; V_20 ++ ) {
T_5 * V_70 = & F_40 ( V_13 ) -> V_71 [ V_20 ] ;
V_268 [ V_20 + 1 ] = F_198 ( & V_6 -> V_68 -> V_36 , V_70 , 0 ,
F_42 ( V_70 ) , V_300 ) ;
V_269 [ V_20 + 1 ] = F_42 ( V_70 ) ;
if ( F_199 ( & V_6 -> V_68 -> V_36 , V_268 [ V_20 + 1 ] ) ) {
V_65 = V_20 ;
goto V_299;
}
}
if ( V_13 -> V_170 == V_301 && V_13 -> V_33 <= 1540 ) {
switch ( F_31 ( V_13 ) -> V_60 ) {
case V_61 :
V_296 |= V_302 ;
V_296 |= F_200 ( V_273 >> 2 ) ;
...
V_148 = V_296 | F_202 ( V_13 -> V_33 ) ;
F_133 ( & V_123 -> V_104 , V_28 ) ;
if ( F_203 ( V_123 ) < V_65 + 14 ) {
F_175 ( V_36 ) ;
goto V_304;
}
if ( V_6 -> V_101 && V_13 -> V_170 == V_301 && V_13 -> V_33 > 1540 ) {
V_102 = V_6 -> V_98 [ V_6 -> V_305 ] ;
V_6 -> V_305 = ( V_6 -> V_305 + 1 ) % V_6 -> V_101 ;
F_184 ( V_13 , V_268 , V_269 , V_123 , V_102 ) ;
}
V_132 = V_123 -> V_81 ;
...
F_193 ( V_269 [ V_20 ] ) | F_194 ( V_268 [ V_20 ] ) ;
F_134 ( V_123 , V_132 + V_20 ) . V_129 = V_268 [ V_20 ] ;
}
if ( V_65 & 1 )
V_65 ++ ;
V_123 -> V_81 = ( V_132 + V_65 + 1 ) & ( V_121 - 1 ) ;
V_36 -> V_166 . V_306 ++ ;
V_36 -> V_166 . V_307 += V_13 -> V_33 ;
F_136 ( & V_123 -> V_104 , V_28 ) ;
F_12 ( F_196 ( V_123 -> V_77 . V_75 ) , ( V_65 + 2 ) >> 1 ) ;
return V_308 ;
V_304:
F_136 ( & V_123 -> V_104 , V_28 ) ;
V_299:
while ( V_65 -- )
F_38 ( V_6 -> V_68 , V_268 [ V_65 ] , V_269 [ V_65 ] ,
V_69 ) ;
return V_309 ;
}
static void F_204 ( struct V_40 * V_36 )
{
const struct V_5 * V_6 = F_27 ( V_36 ) ;
unsigned int V_28 ;
V_28 = F_6 ( V_6 , V_29 ) ;
...
static int F_205 ( struct V_311 * V_198 , int V_312 )
{
struct V_5 * V_6 = F_206 ( V_198 , struct V_5 , V_198 ) ;
int V_313 ;
F_132 ( F_15 ( V_6 ) ) ;
V_313 = F_120 ( F_14 ( V_6 ) , V_312 ) ;
if ( V_313 < V_312 ) {
F_207 ( V_198 ) ;
F_106 ( V_6 ) ;
F_109 ( V_6 ) ;
...
static void F_208 ( struct V_40 * V_36 )
{
const struct V_5 * V_6 = F_27 ( V_36 ) ;
F_209 ( V_6 -> V_11 -> V_77 . V_191 ) ;
F_142 ( V_6 -> V_11 -> V_77 . V_191 , V_6 -> V_11 ) ;
F_210 ( V_6 -> V_11 -> V_77 . V_191 ) ;
F_209 ( V_6 -> V_9 -> V_77 . V_191 ) ;
F_138 ( V_6 -> V_9 -> V_77 . V_191 , V_6 -> V_9 ) ;
F_210 ( V_6 -> V_9 -> V_77 . V_191 ) ;
}
static int F_211 ( struct V_40 * V_36 , int V_314 )
{
struct V_5 * V_6 = F_27 ( V_36 ) ;
unsigned int V_3 ;
...
V_3 = F_6 ( V_6 , V_319 ) ;
V_3 &= ~ V_320 ;
V_3 |= F_214 ( V_314 + V_321 + 4 ) ;
F_8 ( V_6 , V_319 , V_3 ) ;
V_36 -> V_230 = V_314 ;
V_6 -> V_135 = V_314 + V_321 + V_322 + V_136 + 128 ;
V_318:
if ( V_315 ) {
F_12 ( F_114 ( V_6 -> V_7 ) ,
V_144 | V_233 ) ;
...
static int T_7
F_215 ( struct V_15 * V_16 , const struct V_323 * V_324 )
{
struct V_40 * V_36 ;
struct V_5 * V_6 ;
int V_325 , V_225 ;
...
if ( V_325 )
return V_325 ;
V_36 = F_217 ( sizeof( struct V_5 ) ) ;
if ( V_36 == NULL ) {
V_325 = - V_120 ;
goto V_326;
}
F_218 ( V_16 , V_36 ) ;
F_219 ( V_36 , & V_16 -> V_36 ) ;
V_6 = F_27 ( V_36 ) ;
V_6 -> V_16 = V_16 ;
V_6 -> V_165 = V_36 ;
F_220 ( V_36 , & V_6 -> V_198 , F_205 , 64 ) ;
V_36 -> V_327 = V_328 | V_329 | V_330 |
V_331 | V_332 ;
V_6 -> V_175 . V_333 = V_334 ;
V_6 -> V_175 . V_335 = V_336 ;
V_6 -> V_175 . V_337 = V_6 -> V_338 ;
V_6 -> V_175 . V_339 = F_29 ;
V_6 -> V_175 . V_327 = V_340 | V_341 ;
V_6 -> V_175 . V_36 = V_6 -> V_165 ;
V_6 -> V_175 . V_170 = V_171 ;
V_6 -> V_175 . V_342 = V_171 ;
V_6 -> V_68 = F_221 ( V_343 , 0xa007 , NULL ) ;
if ( ! V_6 -> V_68 ) {
F_47 ( & V_6 -> V_16 -> V_36 , L_33 ) ;
V_325 = - V_344 ;
goto V_318;
}
V_6 -> V_345 = F_221 ( V_343 , 0xa001 , NULL ) ;
if ( ! V_6 -> V_345 ) {
...
V_36 -> V_347 = & V_348 ;
V_36 -> V_230 = V_349 ;
V_6 -> V_135 = V_36 -> V_230 + V_321 + V_322 + V_136 + 128 ;
V_36 -> V_350 = & V_351 ;
if ( V_325 )
goto V_318;
V_6 -> V_352 = F_222 ( V_353 , V_354 ) ;
V_6 -> V_352 = ( V_355 << 1 ) - 1 ;
V_325 = F_223 ( V_36 ) ;
if ( V_325 ) {
...
F_116 ( V_209 L_37 ,
V_36 -> V_210 , V_6 -> type == V_245 ? L_38 : L_39 ,
V_6 -> V_7 , V_36 -> V_47 ) ;
return V_325 ;
V_318:
if ( V_6 -> V_345 )
...
static void T_8 F_227 ( struct V_15 * V_16 )
{
struct V_40 * V_165 = F_228 ( V_16 ) ;
struct V_5 * V_6 ;
if ( ! V_165 )
return;
V_6 = F_27 ( V_165 ) ;
