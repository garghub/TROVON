...
static int F_18 ( struct V_70 * V_39 , struct V_71 * V_72 )
{
struct V_73 * V_21 = V_39 -> V_6 ;
F_7 ( L_13 , V_72 -> V_74 , V_72 -> V_24 ) ;
if ( ( V_72 -> V_24 & V_75 ) != V_75 )
return 0 ;
F_19 ( V_21 -> V_47 -> V_76 != 1 ) ;
F_19 ( F_20 ( & V_21 -> V_47 -> V_77 ) != 0 ) ;
F_7 ( L_14 , V_78 ) ;
if ( F_21 ( V_21 -> V_47 , V_78 ) )
return - V_69 ;
return 0 ;
}
int F_22 ( struct V_70 * V_39 ,
struct V_1 * V_2 )
{
struct V_73 * V_21 = V_39 -> V_6 ;
struct V_4 * V_5 = V_2 -> V_6 ;
...
int V_9 ;
struct V_14 * V_79 ;
struct V_80 * V_11 = (struct V_80 * ) V_2 -> V_11 ;
...
return 0 ;
V_88:
F_3 ( L_15 , V_39 , V_2 -> V_20 , V_9 ) ;
return V_9 ;
}
int F_28 ( struct V_70 * V_39 ,
struct V_1 * V_2 ,
struct V_94 * V_11 )
{
struct V_73 * V_21 = V_39 -> V_6 ;
...
int V_9 = 0 ;
struct V_35 * V_36 ;
V_20 = ( V_97 T_2 ) V_11 -> V_20 ;
V_96 = F_29 ( V_11 -> V_98 ) ;
V_95 = F_23 ( V_11 -> V_99 ) ;
F_7 ( L_16 ,
V_100 , ( int ) V_20 , ( int ) V_96 , ( int ) V_95 ) ;
V_49 = F_30 ( V_101 . V_102 , V_103 ) ;
if ( V_49 == NULL ) {
F_3 ( L_17 ) ;
return - V_69 ;
}
V_49 -> type = V_104 ;
V_49 -> V_13 . V_24 = V_55 ;
memcpy ( & V_49 -> V_105 , V_11 , sizeof( struct V_71 ) ) ;
F_31 ( V_2 , V_49 ) ;
V_8 = & V_5 -> V_23 [ V_34 ] ;
V_36 = & V_49 -> V_37 [ 1 ] ;
V_36 -> V_43 = V_8 -> V_27 . V_30 + V_95 ;
V_36 -> V_44 = V_96 ;
V_36 -> V_45 = V_8 -> V_27 . V_45 ;
V_49 -> V_46 = 2 ;
if ( V_95 + V_96 > V_5 -> V_16 [ V_34 ] . V_19 ) {
F_3 ( L_18
L_19 ,
V_95 , V_96 ,
...
return 0 ;
V_106:
F_32 ( V_101 . V_102 , V_49 ) ;
F_3 ( L_21 , V_39 , V_9 ) ;
return V_9 ;
}
int F_33 ( struct V_70 * V_39 ,
struct V_1 * V_2 )
{
struct V_73 * V_21 = V_39 -> V_6 ;
struct V_4 * V_5 = V_2 -> V_6 ;
...
F_10 ( V_51 -> V_52 ,
V_47 -> V_111 , V_2 -> V_112 ,
V_38 ) ;
memcpy ( V_21 -> V_47 -> V_113 , V_2 -> V_16 ,
V_2 -> V_112 ) ;
F_34 ( V_51 -> V_52 ,
V_47 -> V_111 , V_2 -> V_112 ,
V_38 ) ;
V_36 -> V_43 = V_21 -> V_47 -> V_111 ;
V_36 -> V_44 = V_2 -> V_112 ;
...
struct V_21 * V_47 )
{
struct V_73 * V_39 = V_47 -> V_21 ;
struct V_71 * V_11 ;
T_1 V_115 ;
int V_116 , V_117 , V_118 , V_9 ;
if ( ( char * ) V_60 == V_47 -> V_119 ) {
V_115 = V_47 -> V_120 ;
V_116 = V_121 ;
} else {
V_115 = V_60 -> V_53 ;
...
F_10 ( V_47 -> V_51 -> V_52 , V_115 ,
V_116 , V_18 ) ;
V_11 = & V_60 -> V_105 ;
F_7 ( L_23 , V_11 -> V_74 ,
V_11 -> V_20 , ( int ) ( V_114 - V_54 ) ) ;
F_37 ( V_39 -> V_70 , V_11 ,
V_60 -> V_16 , V_114 - V_54 ) ;
F_34 ( V_47 -> V_51 -> V_52 , V_115 ,
V_116 , V_18 ) ;
V_39 -> V_47 -> V_76 -- ;
if ( V_115 == V_47 -> V_120 )
return;
