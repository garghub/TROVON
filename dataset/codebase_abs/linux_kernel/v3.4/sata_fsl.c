...
F_70 ( V_63 , V_63 -> V_169 ^ V_167 ) ;
return;
} else if ( ( V_63 -> V_169 & ( 1 << V_170 ) ) ) {
F_3 ( 1 , V_8 + V_88 ) ;
V_44 = F_65 ( V_63 , V_170 ) ;
F_5 ( L_67 ,
F_6 ( V_8 + V_88 ) ) ;
if ( V_44 ) {
F_71 ( V_44 ) ;
...
static T_7 F_72 ( int V_171 , void * V_172 )
{
...
struct V_1 * V_2 = NULL ;
T_4 V_104 ;
struct F_51 V_182 = V_183 [ 0 ] ;
const struct F_51 * V_184 [] = { & V_182 , NULL } ;
F_76 ( & V_179 -> V_19 , L_72 ) ;
V_8 = F_77 ( V_179 -> V_19 . V_185 , 0 ) ;
if ( ! V_8 )
goto V_186;
V_98 = V_8 + 0x100 ;
V_92 = V_8 + 0x140 ;
if ( ! F_78 ( V_179 -> V_19 . V_185 , L_73 ) ) {
V_104 = F_6 ( V_92 + V_187 ) ;
V_104 = V_104 & 0xffffffe0 ;
F_3 ( V_104 | V_188 , V_92 + V_187 ) ;
}
F_5 ( L_74 , F_6 ( V_92 + V_187 ) ) ;
...
V_6 -> V_98 = V_98 ;
V_6 -> V_92 = V_92 ;
V_171 = F_79 ( V_179 -> V_19 . V_185 , 0 ) ;
if ( V_171 < 0 ) {
F_80 ( & V_179 -> V_19 , L_77 ) ;
goto V_186;
}
V_6 -> V_171 = V_171 ;
if ( F_78 ( V_179 -> V_19 . V_185 , L_78 ) )
V_6 -> V_47 = V_189 ;
else
V_6 -> V_47 = V_190 ;
V_2 = F_81 ( & V_179 -> V_19 , V_184 , V_191 ) ;
if ( ! V_2 ) {
V_180 = - V_112 ;
goto V_186;
}
V_2 -> V_7 = V_6 ;
F_74 ( V_2 ) ;
F_82 ( V_2 , V_171 , F_72 , V_192 ,
& V_193 ) ;
F_83 ( & V_179 -> V_19 , V_2 ) ;
V_6 -> V_194 . V_195 = F_7 ;
V_6 -> V_194 . V_196 = F_8 ;
F_84 ( & V_6 -> V_194 . V_21 ) ;
V_6 -> V_194 . V_21 . V_197 = L_79 ;
V_6 -> V_194 . V_21 . V_198 = V_199 | V_200 ;
V_180 = F_85 ( V_2 -> V_19 , & V_6 -> V_194 ) ;
if ( V_180 )
goto V_186;
return 0 ;
V_186:
if ( V_2 ) {
F_83 ( & V_179 -> V_19 , NULL ) ;
F_86 ( V_2 ) ;
}
if ( V_8 )
F_87 ( V_8 ) ;
...
{
struct V_1 * V_2 = F_10 ( & V_179 -> V_19 ) ;
struct V_5 * V_6 = V_2 -> V_7 ;
F_89 ( & V_179 -> V_19 , & V_6 -> V_194 ) ;
F_86 ( V_2 ) ;
F_83 ( & V_179 -> V_19 , NULL ) ;
F_90 ( V_6 -> V_171 ) ;
F_87 ( V_6 -> V_8 ) ;
...
static int F_91 ( struct V_178 * V_201 , T_8 V_202 )
{
struct V_1 * V_2 = F_10 ( & V_201 -> V_19 ) ;
return F_92 ( V_2 , V_202 ) ;
}
static int F_93 ( struct V_178 * V_201 )
{
struct V_1 * V_2 = F_10 ( & V_201 -> V_19 ) ;
struct V_5 * V_6 = V_2 -> V_7 ;
int V_203 ;
void T_1 * V_8 = V_6 -> V_8 ;
struct V_67 * V_63 = V_2 -> V_176 [ 0 ] ;
struct V_30 * V_31 = V_63 -> V_7 ;
V_203 = F_74 ( V_2 ) ;
if ( V_203 ) {
F_80 ( & V_201 -> V_19 , L_80 ) ;
return V_203 ;
}
F_3 ( V_31 -> V_114 & 0xffffffff , V_8 + V_116 ) ;
F_3 ( ( F_6 ( V_8 + V_105 )
