...
static inline int F_71 ( T_5 V_128 , T_5 V_129 )
{
return V_128 == V_130 || V_128 == V_129 ;
}
static struct V_131 * F_72 ( struct V_2 * V_3 )
{
struct V_131 * V_132 ;
for ( V_132 = V_133 ; ; V_132 ++ )
if ( F_71 ( V_132 -> V_5 , V_3 -> V_5 ) &&
F_71 ( V_132 -> V_6 , V_3 -> V_6 ) &&
F_71 ( V_132 -> V_134 , V_3 -> V_7 ) &&
F_71 ( V_132 -> V_135 , V_3 -> V_8 ) )
break;
return V_132 ;
}
static inline int F_73 ( struct V_2 * V_3 ,
const struct V_29 * V_30 )
{
if ( V_30 -> V_33 & V_136 )
return 0 ;
...
static int T_6
F_74 ( struct V_2 * V_3 , struct V_29 * V_30 )
{
const struct V_138 * V_139 ;
int V_140 , V_141 , V_142 = - 1 , V_65 ;
if ( ( ( ( V_3 -> V_83 >> 8 ) != V_143 ) &&
( ( V_3 -> V_83 >> 8 ) != V_144 ) ) ||
( V_3 -> V_83 & 0xff ) > 6 )
return - V_46 ;
for ( V_139 = V_145 ;
V_139 < V_145 + F_40 ( V_145 ) ;
V_139 ++ ) {
if ( V_3 -> V_5 == V_139 -> V_5 &&
V_3 -> V_6 == V_139 -> V_6 )
return - V_46 ;
}
V_140 = V_141 = 0 ;
for ( V_65 = 0 ; V_65 < V_18 ; V_65 ++ ) {
if ( F_6 ( V_3 , V_65 ) & V_146 ) {
V_141 ++ ;
if ( V_142 == - 1 )
V_142 = V_65 ;
}
...
static inline int
F_75 ( const struct V_29 * V_30 ,
const struct V_29 * V_147 )
{
return
V_30 -> V_79 == V_147 -> V_79 &&
V_30 -> V_148 == V_147 -> V_148 &&
V_30 -> V_34 == V_147 -> V_34 &&
V_30 -> V_35 == V_147 -> V_35 &&
V_30 -> V_32 == V_147 -> V_32 ;
}
struct V_9 *
F_76 ( struct V_2 * V_3 , const struct V_29 * V_30 )
{
struct V_11 V_149 ;
struct V_9 * V_10 ;
struct V_131 * V_132 ;
...
V_10 = F_78 ( sizeof( struct V_9 ) +
sizeof( unsigned int ) * V_150 ,
V_153 ) ;
if ( ! V_10 ) {
V_10 = F_77 ( - V_22 ) ;
goto V_154;
...
V_10 -> V_3 = V_3 ;
V_10 -> V_132 = V_132 ;
memset ( & V_149 , 0 , sizeof( struct V_11 ) ) ;
V_149 . V_33 = V_155 | V_156 | V_157 ;
V_149 . V_158 = V_30 -> V_148 * 16 ;
V_149 . V_137 = F_73 ( V_3 , V_30 ) ;
V_149 . V_3 = & V_3 -> V_3 ;
for ( V_65 = 0 ; V_65 < V_150 ; V_65 ++ ) {
if ( V_132 -> V_159 ( V_10 , V_30 , & V_149 , V_65 ) )
break;
#ifdef F_79
F_2 ( V_47 L_20 ,
V_149 . V_25 , V_149 . V_137 , V_149 . V_23 ) ;
#endif
V_10 -> line [ V_65 ] = F_80 ( & V_149 ) ;
if ( V_10 -> line [ V_65 ] < 0 ) {
...
struct V_131 * V_132 ;
int V_65 ;
for ( V_65 = 0 ; V_65 < V_10 -> V_160 ; V_65 ++ )
F_82 ( V_10 -> line [ V_65 ] ) ;
for ( V_65 = 0 ; V_65 < V_18 ; V_65 ++ ) {
if ( V_10 -> V_21 [ V_65 ] )
F_19 ( V_10 -> V_21 [ V_65 ] ) ;
...
int V_65 ;
if ( V_10 -> V_132 -> V_151 )
V_10 -> V_132 -> V_151 ( V_10 -> V_3 ) ;
for ( V_65 = 0 ; V_65 < V_10 -> V_160 ; V_65 ++ )
if ( V_10 -> line [ V_65 ] >= 0 )
F_87 ( V_10 -> line [ V_65 ] ) ;
}
static int T_6
F_88 ( struct V_2 * V_3 , const struct V_138 * V_161 )
{
struct V_131 * V_132 ;
struct V_9 * V_10 ;
const struct V_29 * V_30 ;
...
V_132 = F_72 ( V_3 ) ;
if ( V_132 -> V_163 ) {
V_36 = V_132 -> V_163 ( V_3 ) ;
if ( V_36 )
return V_36 ;
}
if ( V_161 -> V_164 >= F_40 ( V_165 ) ) {
F_2 ( V_108 L_22 ,
V_161 -> V_164 ) ;
return - V_19 ;
}
V_30 = & V_165 [ V_161 -> V_164 ] ;
V_36 = F_89 ( V_3 ) ;
F_90 ( V_3 ) ;
if ( V_36 )
return V_36 ;
if ( V_161 -> V_164 == V_166 ) {
memcpy ( & V_162 , V_30 , sizeof( struct V_29 ) ) ;
V_30 = & V_162 ;
V_36 = F_74 ( V_3 , & V_162 ) ;
if ( V_36 )
goto V_167;
} else {
memcpy ( & V_162 , & V_165 [ V_166 ] ,
sizeof( struct V_29 ) ) ;
V_36 = F_74 ( V_3 , & V_162 ) ;
if ( V_36 == 0 && F_75 ( V_30 , & V_162 ) )
F_1 ( L_23 ,
V_3 ) ;
}
V_10 = F_76 ( V_3 , V_30 ) ;
...
static void T_3 F_95 ( struct V_2 * V_3 )
{
struct V_9 * V_10 = F_96 ( V_3 ) ;
F_92 ( V_3 , NULL ) ;
F_81 ( V_10 ) ;
F_94 ( V_3 ) ;
}
static int F_97 ( struct V_2 * V_3 , T_7 V_168 )
{
struct V_9 * V_10 = F_96 ( V_3 ) ;
if ( V_10 )
F_84 ( V_10 ) ;
F_90 ( V_3 ) ;
F_98 ( V_3 , F_99 ( V_3 , V_168 ) ) ;
return 0 ;
}
...
static T_8 F_103 ( struct V_2 * V_3 )
{
int V_36 ;
V_36 = F_89 ( V_3 ) ;
if ( V_36 )
