...
F_15 ( & V_30 ) = V_3 -> V_35 ;
V_32 = F_16 ( V_5 ,
& V_30 , 1 , V_3 -> V_14 , V_36 ) ;
break;
case V_37 :
V_32 = F_17 ( V_5 ,
V_3 -> V_35 , V_3 -> V_34 , V_3 -> V_38 , V_3 -> V_14 ) ;
break;
default:
F_18 ( & V_5 -> V_39 -> V_40 , L_1 ) ;
return - V_41 ;
}
if ( ! V_32 ) {
F_18 ( & V_5 -> V_39 -> V_40 , L_2 ) ;
return - V_41 ;
}
V_32 -> V_42 = V_3 -> V_43 ;
V_32 -> V_44 = V_3 -> V_45 ;
...
{
F_21 ( (struct V_4 * ) V_25 ) ;
return 0 ;
}
static inline int F_22 ( unsigned V_25 )
{
return F_23 ( (struct V_4 * ) V_25 ) ;
}
void * F_24 ( void )
{
return & V_46 ;
