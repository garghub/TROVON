...
{
struct V_6 * V_7 = V_21 -> V_7 ;
bool V_84 = F_42 ( V_7 , & V_21 -> V_25 ) ;
bool V_85 = F_42 ( V_7 , V_25 ) ;
struct V_8 * V_86 = & V_7 -> V_9 [ V_21 -> V_25 . V_2 ] ;
struct V_8 * V_87 = & V_7 -> V_9 [ V_25 -> V_2 ] ;
int V_24 = 0 ;
if ( V_84 || V_85 ||
( ( V_25 -> V_23 & V_21 -> V_25 . V_23 & V_88 ) == 0 ) ) {
V_24 = F_43 ( V_86 , true ) ;
if ( F_25 ( V_24 != 0 ) )
goto V_89;
F_44 ( V_21 ) ;
...
if ( ! ( V_86 -> V_1 & V_90 ) &&
! ( V_87 -> V_1 & V_90 ) )
V_24 = F_48 ( V_21 , V_81 , V_82 , V_83 , V_25 ) ;
else if ( V_7 -> V_75 -> V_94 )
V_24 = V_7 -> V_75 -> V_94 ( V_21 , V_81 , V_49 ,
V_82 , V_83 , V_25 ) ;
else
V_24 = F_49 ( V_21 , V_81 , V_82 , V_83 , V_25 ) ;
if ( V_24 ) {
if ( V_7 -> V_75 -> V_92 ) {
struct V_80 V_95 = * V_25 ;
* V_25 = V_21 -> V_25 ;
V_21 -> V_25 = V_95 ;
V_7 -> V_75 -> V_92 ( V_21 , V_25 ) ;
V_21 -> V_25 = * V_25 ;
...
V_93:
if ( V_21 -> V_96 ) {
V_24 = V_7 -> V_75 -> V_97 ( V_7 , V_21 -> V_25 . V_23 ) ;
if ( V_24 )
F_3 ( L_12 ) ;
V_21 -> V_96 = false ;
}
if ( V_21 -> V_25 . V_43 ) {
V_21 -> V_98 = ( V_21 -> V_25 . V_99 << V_77 ) +
V_7 -> V_9 [ V_21 -> V_25 . V_2 ] . V_12 ;
V_21 -> V_100 = V_21 -> V_25 . V_23 ;
} else
V_21 -> V_98 = 0 ;
return 0 ;
V_89:
V_87 = & V_7 -> V_9 [ V_21 -> V_25 . V_2 ] ;
if ( ( V_87 -> V_1 & V_90 ) && V_21 -> V_46 ) {
F_50 ( V_21 -> V_46 ) ;
F_12 ( V_21 -> V_46 ) ;
V_21 -> V_46 = NULL ;
}
...
{
if ( V_21 -> V_7 -> V_75 -> V_92 )
V_21 -> V_7 -> V_75 -> V_92 ( V_21 , NULL ) ;
if ( V_21 -> V_46 ) {
F_50 ( V_21 -> V_46 ) ;
F_12 ( V_21 -> V_46 ) ;
V_21 -> V_46 = NULL ;
...
V_110:
F_28 ( & V_7 -> V_103 ) ;
V_24 = F_55 ( V_21 , false , V_49 , V_83 ) ;
F_27 ( & V_7 -> V_103 ) ;
if ( F_25 ( V_24 != 0 ) )
return V_24 ;
F_28 ( & V_34 -> V_64 ) ;
...
static int F_58 ( struct V_6 * V_7 , bool V_111 )
{
...
V_114 = F_59 ( & V_112 -> V_45 ,
struct V_20 , V_45 ) ;
F_21 ( & V_114 -> V_38 ) ;
}
F_27 ( & V_34 -> V_64 ) ;
V_24 = F_57 ( V_112 , false , ! V_111 ,
! V_111 ) ;
F_60 ( & V_112 -> V_38 , F_9 ) ;
V_112 = V_114 ;
if ( V_24 || ! V_112 )
...
static void F_61 ( struct V_117 * V_118 )
{
struct V_6 * V_7 =
...
if ( F_35 ( V_21 -> V_119 != NULL ) ) {
F_63 ( & V_21 -> V_120 , & V_7 -> V_121 ) ;
F_64 ( V_21 -> V_119 ) ;
V_21 -> V_119 = NULL ;
}
F_65 ( & V_7 -> V_122 ) ;
...
{
return F_70 ( & V_7 -> V_108 ) ;
}
void F_71 ( struct V_6 * V_7 , int V_124 )
{
if ( V_124 )
F_56 ( & V_7 -> V_108 ,
( ( V_109 / 100 ) < 1 ) ? 1 : V_109 / 100 ) ;
...
V_24 = F_73 ( V_21 , & V_23 , & V_125 , V_49 ,
V_82 , V_83 ) ;
if ( V_24 ) {
if ( V_24 != - V_126 ) {
F_3 ( L_14 ,
...
V_82 , V_83 ) ;
F_60 ( & V_21 -> V_38 , F_9 ) ;
if ( F_35 ( V_24 == 0 || V_24 == - V_126 ) )
return V_24 ;
goto V_110;
}
V_24 = F_24 ( V_21 , false , V_82 , false , 0 ) ;
if ( F_25 ( V_24 == - V_63 ) ) {
F_27 ( & V_34 -> V_64 ) ;
if ( F_35 ( ! V_83 ) )
V_24 = F_16 ( V_21 , V_49 ) ;
...
F_10 ( V_24 != 0 ) ;
F_32 ( V_21 , V_55 , true ) ;
V_24 = F_72 ( V_21 , V_49 , V_82 , V_83 ) ;
F_38 ( V_21 ) ;
F_60 ( & V_21 -> V_38 , F_9 ) ;
return V_24 ;
}
void F_52 ( struct V_20 * V_21 , struct V_80 * V_25 )
{
...
T_1 V_136 )
{
T_1 V_137 = V_136 & V_88 ;
T_1 V_138 = V_136 & ~ V_88 ;
if ( ( V_100 & V_137 ) != 0 )
V_138 |= ( V_100 & V_137 ) ;
...
if ( ! V_146 )
continue;
V_143 = F_76 ( V_9 , V_21 -> V_25 . V_23 ,
V_143 ) ;
F_78 ( & V_143 , V_23 -> V_23 [ V_3 ] ,
~ V_148 ) ;
if ( V_2 == V_16 )
break;
...
V_25 . V_127 . V_129 = 0 ;
V_24 = F_73 ( V_21 , V_23 , & V_25 , V_49 , V_82 , V_83 ) ;
if ( V_24 )
goto V_113;
V_24 = F_41 ( V_21 , & V_25 , false , V_49 , V_82 , V_83 ) ;
V_113:
if ( V_24 && V_25 . V_43 )
F_52 ( V_21 , & V_25 ) ;
return V_24 ;
...
( V_25 -> V_99 < V_23 -> V_130 ||
V_25 -> V_99 + V_25 -> V_26 > V_23 -> V_131 ) )
return - 1 ;
for ( V_3 = 0 ; V_3 < V_23 -> V_27 ; V_3 ++ ) {
...
if ( V_24 < 0 ) {
V_24 = F_80 ( V_21 , V_23 , V_49 , V_82 , V_83 ) ;
if ( V_24 )
return V_24 ;
} else {
...
V_21 -> V_152 = V_152 & V_156 ;
V_21 -> V_158 = 0 ;
V_21 -> V_25 . V_23 = ( V_159 | V_139 ) ;
V_21 -> V_59 = false ;
V_21 -> V_154 = V_154 ;
V_21 -> V_39 = V_39 ;
F_89 ( & V_21 -> V_34 -> V_36 ) ;
...
unsigned V_161 )
{
unsigned V_162 = ( F_92 ( V_160 ) ) >> V_77 ;
T_3 V_13 = 0 ;
V_13 += F_93 ( V_161 ) ;
V_13 += F_92 ( V_162 * sizeof( void * ) ) ;
V_13 += F_93 ( sizeof( struct V_163 ) ) ;
return V_13 ;
}
...
V_13 += F_93 ( V_161 ) ;
V_13 += F_92 ( V_162 * sizeof( void * ) ) ;
V_13 += F_92 ( V_162 * sizeof( V_164 ) ) ;
V_13 += F_93 ( sizeof( struct V_165 ) ) ;
return V_13 ;
}
...
if ( F_25 ( V_24 != 0 ) )
return V_24 ;
V_21 = F_96 ( sizeof( * V_21 ) , V_166 ) ;
if ( F_25 ( V_21 == NULL ) ) {
F_15 ( V_48 , V_39 ) ;
return - V_79 ;
}
V_24 = F_84 ( V_7 , V_21 , V_13 , type , V_23 , V_150 ,
V_152 , V_49 ,
V_154 , V_39 , NULL ) ;
if ( F_35 ( V_24 == 0 ) )
* V_123 = V_21 ;
...
F_101 ( & V_9 -> V_173 ) ;
F_88 ( & V_9 -> V_157 ) ;
V_24 = V_7 -> V_75 -> V_174 ( V_7 , type , V_9 ) ;
if ( V_24 )
return V_24 ;
V_9 -> V_7 = V_7 ;
V_24 = 0 ;
...
F_88 ( & V_34 -> V_54 ) ;
F_88 ( & V_34 -> V_186 ) ;
F_111 ( & V_34 -> V_176 , V_187 ) ;
V_24 = F_112 ( V_34 -> V_48 , & V_34 -> V_176 ) ;
if ( F_25 ( V_24 != 0 ) ) {
F_3 ( L_23 ) ;
goto V_188;
}
...
goto V_192;
V_7 -> V_121 = V_193 ;
V_24 = F_124 ( & V_7 -> V_190 , V_191 , 0x10000000 ) ;
if ( F_25 ( V_24 != 0 ) )
goto V_194;
F_125 ( & V_7 -> V_108 , F_61 ) ;
V_7 -> V_195 = true ;
F_88 ( & V_7 -> V_45 ) ;
V_7 -> V_196 = NULL ;
V_7 -> V_34 = V_34 ;
...
bool F_42 ( struct V_6 * V_7 , struct V_80 * V_25 )
{
...
{
struct V_6 * V_7 = V_21 -> V_7 ;
T_5 V_98 = ( T_5 ) V_21 -> V_198 ;
T_5 V_199 = ( ( T_5 ) V_21 -> V_25 . V_26 ) << V_77 ;
if ( ! V_7 -> V_196 )
return;
F_126 ( V_7 -> V_196 , V_98 , V_199 , 1 ) ;
F_66 ( V_21 ) ;
}
...
{
struct V_6 * V_7 = V_21 -> V_7 ;
struct V_200 * * V_201 = & V_7 -> V_121 . V_200 ;
struct V_200 * V_202 = NULL ;
struct V_20 * V_203 ;
unsigned long V_98 = V_21 -> V_119 -> V_99 ;
unsigned long V_204 ;
while ( * V_201 ) {
V_202 = * V_201 ;
V_203 = F_129 ( V_202 , struct V_20 , V_120 ) ;
V_204 = V_203 -> V_119 -> V_99 ;
if ( V_98 < V_204 )
V_201 = & V_202 -> V_205 ;
else if ( V_98 > V_204 )
V_201 = & V_202 -> V_206 ;
...
F_130 ( & V_21 -> V_120 , V_202 , V_201 ) ;
F_131 ( & V_21 -> V_120 , & V_7 -> V_121 ) ;
}
...
int V_24 ;
V_207:
V_24 = F_132 ( & V_7 -> V_190 ) ;
if ( F_25 ( V_24 != 0 ) )
return V_24 ;
F_67 ( & V_7 -> V_122 ) ;
V_21 -> V_119 = F_133 ( & V_7 -> V_190 ,
V_21 -> V_25 . V_26 , 0 , 0 ) ;
if ( F_25 ( V_21 -> V_119 == NULL ) ) {
V_24 = - V_79 ;
goto V_113;
}
V_21 -> V_119 = F_134 ( V_21 -> V_119 ,
V_21 -> V_25 . V_26 , 0 ) ;
if ( F_25 ( V_21 -> V_119 == NULL ) ) {
F_65 ( & V_7 -> V_122 ) ;
goto V_207;
...
F_128 ( V_21 ) ;
F_65 ( & V_7 -> V_122 ) ;
V_21 -> V_198 = ( ( T_4 ) V_21 -> V_119 -> V_99 ) << V_77 ;
return 0 ;
V_113:
F_65 ( & V_7 -> V_122 ) ;
return V_24 ;
...
bool V_208 , bool V_49 , bool V_56 )
{
struct V_101 * V_75 = V_21 -> V_7 -> V_75 ;
struct V_6 * V_7 = V_21 -> V_7 ;
void * V_42 ;
void * V_102 ;
int V_24 = 0 ;
...
return 0 ;
while ( V_21 -> V_42 ) {
if ( V_75 -> V_209 ( V_21 -> V_42 , V_21 -> V_102 ) ) {
void * V_210 = V_21 -> V_42 ;
V_21 -> V_42 = NULL ;
F_135 ( V_211 , & V_21 -> V_158 ) ;
F_27 ( & V_7 -> V_103 ) ;
V_75 -> V_107 ( & V_210 ) ;
F_28 ( & V_7 -> V_103 ) ;
continue;
...
if ( F_25 ( V_24 != 0 ) )
goto V_116;
if ( ( V_21 -> V_25 . V_23 & V_214 ) != V_214 ) {
struct V_80 V_125 ;
V_125 = V_21 -> V_25 ;
V_125 . V_43 = NULL ;
V_125 . V_23 = V_159 | V_139 ;
V_125 . V_2 = V_16 ;
...
F_127 ( V_21 ) ;
if ( V_21 -> V_7 -> V_75 -> V_215 )
V_21 -> V_7 -> V_75 -> V_215 ( V_21 ) ;
V_24 = F_139 ( V_21 -> V_46 , V_21 -> V_154 ) ;
V_116:
F_37 ( & V_21 -> V_51 , 0 ) ;
F_29 ( & V_21 -> V_50 ) ;
F_60 ( & V_21 -> V_38 , F_9 ) ;
