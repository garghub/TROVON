...
static T_3
F_146 ( struct V_153 * V_304 , char T_4 * V_6 , T_5 V_70 ,
T_6 * V_31 )
{
struct V_71 * V_72 = V_304 -> V_316 ;
struct V_1 * V_2 = V_72 -> V_2 ;
...
if ( F_40 ( V_2 , V_129 ) )
return - V_171 ;
return F_147 ( & V_72 -> V_169 , V_6 , V_70 , V_31 , 0 ,
V_304 -> V_300 & V_301 ) ;
}
if ( V_72 -> type == V_130 ) {
if ( ! F_37 ( V_72 , V_131 ) )
return - V_171 ;
return F_147 ( & V_72 -> V_248 , V_6 , V_70 , V_31 , 0 ,
V_304 -> V_300 & V_301 ) ;
}
return 0 ;
}
static unsigned int F_148 ( struct V_153 * V_304 , T_7 * V_328 )
{
struct V_71 * V_72 = V_304 -> V_316 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_53 ;
...
if ( ! F_37 ( V_72 , V_129 ) )
return V_329 ;
return F_149 ( V_304 , & V_72 -> V_169 , V_328 ) ;
} else if ( V_72 -> type == V_130 ) {
if ( ! F_37 ( V_72 , V_131 ) )
return V_329 ;
return F_149 ( V_304 , & V_72 -> V_248 , V_328 ) ;
} else {
return V_329 ;
}
}
static int F_150 ( struct V_153 * V_304 , struct V_330 * V_331 )
{
struct V_71 * V_72 = V_304 -> V_316 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_53 ;
...
return V_53 ;
if ( V_72 -> type == V_128 )
V_53 = F_151 ( & V_72 -> V_169 , V_331 ) ;
else if ( V_72 -> type == V_130 )
V_53 = F_151 ( & V_72 -> V_248 , V_331 ) ;
F_38 ( L_59 ,
( unsigned long ) V_331 -> V_332 ,
( unsigned long ) V_331 -> V_333 - ( unsigned long ) V_331 -> V_332 ,
V_53 ) ;
return V_53 ;
}
static struct V_306 * F_152 ( struct V_1 * V_2 ,
const struct V_306 * V_334 ,
const char * V_335 )
{
struct V_306 * V_336 ;
V_336 = F_153 () ;
...
V_336 -> V_337 = F_136 ;
V_336 -> V_338 = V_339 ;
V_336 -> V_319 = & V_2 -> V_319 ;
snprintf ( V_336 -> V_187 , sizeof( V_336 -> V_187 ) , L_60 ,
V_2 -> V_187 , V_335 ) ;
F_154 ( V_336 , V_2 ) ;
return V_336 ;
}
...
F_159 ( V_2 ) ;
F_160 ( V_2 ) ;
V_2 -> V_193 = F_152 ( V_2 , & V_342 , L_62 ) ;
if ( ! V_2 -> V_193 ) {
F_49 ( L_63 ) ;
return - V_147 ;
}
