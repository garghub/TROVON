...
& V_100 ) ;
if ( V_55 -> type -> V_147 )
V_55 -> type -> V_147 ( V_55 , & V_100 ) ;
if ( V_55 -> type -> V_101 ( V_55 , F_45 ,
& V_100 ) )
return - V_102 ;
V_146:
if ( F_117 ( V_62 , & V_100 , 0 ) < 0 )
F_20 ( L_40
L_41
L_42 ,
F_48 ( V_71 -> V_30 ) ,
...
T_1 V_56 , T_1 V_57 , void * V_58 )
{
unsigned V_148 = ( * ( unsigned * ) V_58 ) ;
struct V_59 * V_60 = F_47 ( V_47 -> V_48 ) ;
return V_60 && ( V_60 -> V_149 & V_148 ) ;
}
static bool F_120 ( struct V_6 * V_7 , unsigned V_148 )
{
struct V_21 * V_55 ;
unsigned V_43 = 0 ;
while ( V_43 < F_74 ( V_7 ) ) {
...
continue;
if ( V_55 -> type -> V_101 &&
V_55 -> type -> V_101 ( V_55 , F_119 , & V_148 ) )
return 1 ;
}
return 0 ;
}
...
V_55 = F_75 ( V_7 , V_43 ++ ) ;
if ( ! V_55 -> type -> V_101 ||
! V_55 -> type -> V_101 ( V_55 , F_122 , NULL ) )
return 0 ;
}
return 1 ;
}
...
static void F_131 ( struct V_6 * V_7 , unsigned V_158 )
{
int V_43 = V_7 -> V_23 ;
...
} else if ( V_55 -> type -> V_159 )
V_55 -> type -> V_159 ( V_55 ) ;
V_55 ++ ;
}
}
...
struct V_21 * V_55 = V_7 -> V_26 + V_43 ;
if ( V_55 -> type -> V_161 )
V_55 -> type -> V_161 ( V_55 ) ;
}
return 0 ;
}
void F_135 ( struct V_6 * V_7 , struct V_162 * V_163 )
{
F_59 ( & V_163 -> V_40 , & V_7 -> V_33 ) ;
}
int F_136 ( struct V_6 * V_7 , int V_164 )
{
struct V_38 * V_39 ;
struct V_35 * V_32 = F_90 ( V_7 ) ;
struct V_162 * V_163 ;
...
for ( V_43 = 0 ; V_43 < V_7 -> V_23 ; V_43 ++ ) {
V_55 = V_7 -> V_26 + V_43 ;
if ( V_55 -> type -> V_167 && V_55 -> type -> V_167 ( V_55 ) )
return 1 ;
}
return 0 ;
}
...
return 1 ;
if ( V_55 -> type -> V_101 &&
V_55 -> type -> V_101 ( V_55 , F_142 , NULL ) )
return 1 ;
}
return 0 ;
}
