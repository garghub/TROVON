...
V_66 = F_34 ( V_62 ) ;
if ( ! F_35 ( V_62 -> V_71 , V_66 , V_72 ) ) {
F_32 ( & V_60 -> V_8 , L_28 ) ;
return - V_73 ;
}
V_10 = F_36 ( V_62 -> V_71 , V_66 ) ;
if ( ! V_10 ) {
F_32 ( & V_60 -> V_8 , L_29 ) ;
V_68 = - V_19 ;
goto V_74;
}
V_2 = F_37 ( sizeof( struct V_1 ) , V_75 ) ;
if ( ! V_2 ) {
F_32 ( & V_60 -> V_8 , L_30 ) ;
V_68 = - V_76 ;
goto V_77;
}
strcpy ( V_2 -> V_7 . V_78 , V_60 -> V_78 ) ;
V_2 -> V_7 . V_79 = V_80 ;
V_2 -> V_7 . V_81 = & V_82 ;
V_2 -> V_7 . V_8 . V_83 = & V_60 -> V_8 ;
V_2 -> V_7 . V_84 = V_60 -> V_85 ;
V_2 -> V_7 . V_8 . V_86 = V_60 -> V_8 . V_86 ;
V_2 -> V_37 = V_37 ;
V_2 -> V_10 = V_10 ;
V_2 -> V_62 = V_62 ;
V_2 -> V_21 = F_38 ( & V_60 -> V_8 , L_31 ) ;
if ( F_39 ( V_2 -> V_21 ) ) {
V_68 = F_40 ( V_2 -> V_21 ) ;
F_32 ( & V_60 -> V_8 , L_32 ) ;
goto V_87;
}
V_68 = F_41 ( V_2 -> V_37 , F_23 , 0 , V_60 -> V_78 , V_2 ) ;
if ( V_68 ) {
...
F_43 ( & V_2 -> V_7 , V_2 ) ;
V_67 = V_89 ;
V_68 = F_44 ( V_60 -> V_8 . V_86 ,
L_34 , & V_67 ) ;
if ( V_68 < 0 && V_64 && V_64 -> V_67 )
V_67 = V_64 -> V_67 ;
F_18 ( V_2 , V_67 ) ;
F_13 ( 0 , V_2 -> V_10 + V_25 ) ;
F_13 ( 0 , V_2 -> V_10 + V_11 ) ;
...
F_51 ( V_10 ) ;
V_74:
F_52 ( V_62 -> V_71 , F_34 ( V_62 ) ) ;
return V_68 ;
}
static int T_6 F_53 ( struct V_59 * V_60 )
{
struct V_1 * V_2 = F_54 ( V_60 ) ;
F_2 ( & V_2 -> V_7 . V_8 , L_41 ) ;
F_55 ( & V_2 -> V_7 ) ;
F_47 ( V_60 , NULL ) ;
F_48 ( V_2 -> V_37 , V_2 ) ;
F_13 ( 0 , V_2 -> V_10 + V_92 ) ;
F_13 ( 0 , V_2 -> V_10 + V_23 ) ;
F_13 ( 0 , V_2 -> V_10 + V_25 ) ;
F_13 ( 0 , V_2 -> V_10 + V_11 ) ;
F_49 ( V_2 -> V_21 ) ;
F_51 ( V_2 -> V_10 ) ;
F_52 ( V_2 -> V_62 -> V_71 , F_34 ( V_2 -> V_62 ) ) ;
F_50 ( V_2 ) ;
return 0 ;
}
static int T_1 F_56 ( void )
{
return F_57 ( & V_93 , F_30 ) ;
}
