...
{
struct V_3 * V_4 = F_13 ( V_58 ) ;
if ( V_59 == V_60 || V_59 == V_61 )
F_9 ( V_4 ) ;
}
static int T_5 F_27 ( struct V_57 * V_58 )
{
struct V_3 * V_4 ;
struct V_62 * V_63 ;
int V_40 ;
if ( V_58 -> V_64 != - 1 )
return - V_65 ;
V_63 = F_28 ( V_58 , V_66 , 0 ) ;
if ( ! V_63 )
return - V_65 ;
V_4 = F_29 ( & V_58 -> V_8 , sizeof( struct V_3 ) , V_67 ) ;
if ( ! V_4 )
return - V_68 ;
V_4 -> V_8 = & V_58 -> V_8 ;
V_4 -> V_1 = F_30 ( V_58 , 0 ) ;
if ( V_4 -> V_1 >= 0 ) {
V_40 = F_31 ( V_4 -> V_8 , V_4 -> V_1 , F_1 , 0 ,
L_4 , V_4 ) ;
if ( V_40 ) {
F_3 ( V_69 , V_4 -> V_8 ,
L_5 ,
...
V_4 -> V_5 = F_32 ( V_4 -> V_8 , V_63 -> V_70 , F_33 ( V_63 ) ) ;
if ( ! V_4 -> V_5 )
return - V_68 ;
V_71 . V_72 = & V_58 -> V_8 ;
V_40 = F_34 ( & V_71 ) ;
...
static int T_6 F_36 ( struct V_57 * V_58 )
{
F_35 ( V_58 , NULL ) ;
F_37 ( & V_71 ) ;
V_26 = NULL ;
...
static int F_38 ( struct V_57 * V_58 , T_7 V_74 )
{
struct V_3 * V_4 = F_13 ( V_58 ) ;
F_9 ( V_4 ) ;
return 0 ;
