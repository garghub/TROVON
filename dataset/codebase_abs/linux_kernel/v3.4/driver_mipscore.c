...
if ( V_13 -> V_33 . V_43 & V_44 )
return F_19 ( & V_13 -> V_33 ) ;
if ( V_13 -> V_30 . V_4 ) {
F_20 ( & V_13 -> V_30 , & V_39 , & V_40 , & V_41 ) ;
} else if ( V_13 -> V_33 . V_4 ) {
F_21 ( & V_13 -> V_33 , & V_39 , & V_40 , & V_41 ) ;
} else
return 0 ;
if ( ( V_39 == V_45 ) || ( V_13 -> V_46 == 0x5365 ) ) {
V_42 = 200000000 ;
} else {
V_42 = F_22 ( V_39 , V_40 , V_41 ) ;
}
if ( V_39 == V_47 ) {
V_42 *= 2 ;
}
...
if ( ! V_2 -> V_4 )
return;
F_11 (KERN_INFO PFX L_14 ) ;
V_13 = V_2 -> V_4 -> V_13 ;
V_48 = F_24 ( V_13 ) ;
if ( ! V_48 )
V_48 = 100000000 ;
V_49 = 1000000000 / V_48 ;
if ( V_13 -> V_30 . V_4 )
F_25 ( & V_13 -> V_30 , V_49 ) ;
else if ( V_13 -> V_33 . V_4 )
F_26 ( & V_13 -> V_33 , V_49 ) ;
...
if ( V_4 -> V_21 > 5 )
continue;
switch ( V_4 -> V_51 . V_52 ) {
case V_53 :
if ( ( V_13 -> V_46 == 0x4710 ) && ( V_21 <= 4 ) ) {
F_9 ( V_4 , V_21 ++ ) ;
}
break;
case V_54 :
