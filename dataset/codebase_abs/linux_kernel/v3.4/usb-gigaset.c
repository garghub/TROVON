...
V_74 -> V_83 = V_110 ;
V_74 -> V_85 = V_109 -> V_124 ;
V_74 -> V_96 = F_44 ( V_110 , V_95 ) ;
if ( ! V_74 -> V_96 ) {
F_7 ( V_5 -> V_18 , L_39 ) ;
V_104 = - V_125 ;
goto error;
}
V_74 -> V_84 = F_58 ( 0 , V_95 ) ;
if ( ! V_74 -> V_84 ) {
F_7 ( V_5 -> V_18 , L_40 ) ;
V_104 = - V_125 ;
goto error;
...
V_110 = F_52 ( V_109 -> V_123 ) ;
V_74 -> V_126 = V_110 ;
V_74 -> V_127 = V_109 -> V_124 ;
V_74 -> V_62 = F_44 ( V_110 , V_95 ) ;
if ( ! V_74 -> V_62 ) {
F_7 ( V_5 -> V_18 , L_42 ) ;
V_104 = - V_125 ;
goto error;
...
F_63 ( V_74 -> V_97 ) ;
F_57 ( V_101 , NULL ) ;
V_74 -> V_97 = V_74 -> V_84 = NULL ;
V_74 -> V_62 = V_74 -> V_96 = NULL ;
F_64 ( V_74 -> V_9 ) ;
V_74 -> V_9 = NULL ;
V_74 -> V_101 = NULL ;
F_65 ( V_5 ) ;
...
static int F_69 ( struct V_100 * V_131 , T_4 V_132 )
{
struct V_4 * V_5 = F_67 ( V_131 ) ;
V_5 -> V_68 = 0 ;
F_62 ( V_5 -> V_10 . V_11 -> V_97 ) ;
F_42 ( & V_5 -> V_70 ) ;
F_62 ( V_5 -> V_10 . V_11 -> V_84 ) ;
F_3 ( V_133 , L_45 ) ;
return 0 ;
}
static int F_70 ( struct V_100 * V_131 )
{
struct V_4 * V_5 = F_67 ( V_131 ) ;
int V_134 ;
V_5 -> V_68 = 1 ;
V_134 = F_26 ( V_5 -> V_10 . V_11 -> V_97 , V_95 ) ;
if ( V_134 ) {
F_7 ( V_5 -> V_18 , L_46 , - V_134 ) ;
return V_134 ;
}
F_3 ( V_133 , L_47 ) ;
return 0 ;
}
static int F_71 ( struct V_100 * V_131 )
{
return F_69 ( V_131 , V_135 ) ;
}
static int T_5 F_72 ( void )
{
int V_136 ;
V_120 = F_73 ( V_137 , V_138 ,
V_122 , V_139 ,
& V_140 , V_141 ) ;
if ( V_120 == NULL )
goto error;
...
int V_144 ;
F_78 ( V_120 ) ;
for ( V_144 = 0 ; V_144 < V_120 -> V_145 ; V_144 ++ )
F_79 ( V_120 -> V_5 + V_144 ) ;
F_80 ( & V_142 ) ;
F_76 ( V_120 ) ;
V_120 = NULL ;
}
