...
{
int V_34 = 0 ;
if ( ! F_28 ( & V_47 -> V_48 , V_47 -> V_53 . V_54 ,
F_29 ( & V_47 -> V_53 ) , L_3 ) ) {
F_25 ( & V_47 -> V_48 , L_4 ) ;
V_34 = - V_55 ;
goto V_49;
}
V_4 = F_30 ( & V_47 -> V_48 , sizeof( * V_4 ) , V_56 ) ;
if ( ! V_4 ) {
F_25 ( & V_47 -> V_48 , L_5 ) ;
V_34 = - V_57 ;
goto V_49;
}
V_4 -> V_10 = F_31 ( & V_47 -> V_48 , V_47 -> V_53 . V_54 ,
F_29 ( & V_47 -> V_53 ) ) ;
if ( ! V_4 -> V_10 ) {
V_34 = - V_57 ;
F_25 ( & V_47 -> V_48 , L_6 ) ;
...
static int T_7 F_39 ( struct V_50 * V_47 )
{
F_40 ( & V_59 ) ;
F_38 ( V_4 -> V_5 ) ;
return 0 ;
}
static int F_41 ( struct V_61 * V_48 )
{
if ( F_24 ( V_45 , & V_4 -> V_29 ) ) {
F_10 () ;
F_26 ( V_4 -> V_5 ) ;
}
return 0 ;
}
static int F_42 ( struct V_61 * V_48 )
{
int V_34 = 0 ;
if ( F_24 ( V_45 , & V_4 -> V_29 ) ) {
V_34 = F_20 ( V_4 -> V_5 ) ;
