...
V_7 -> V_155 . V_213 = 1 ;
V_7 -> V_16 . V_214 = 0 ;
V_7 -> V_215 . V_216 = V_217 ;
V_7 -> V_215 . V_218 = ( V_219 * )
V_220 ;
V_7 -> V_215 . V_221 = ( V_219 * )
V_222 ;
V_7 -> V_215 . V_223 = V_224 ;
return 0 ;
}
static void F_123 ( struct V_212 * V_225 )
{
struct V_6 * V_7 = F_121 ( & V_225 -> V_2 ) ;
F_50 ( V_7 , 0 , 1 ) ;
F_124 ( V_7 -> V_226 , F_94 ( V_7 , 0xffffffff ) == 0 ) ;
if ( V_225 -> V_13 == V_227 )
F_125 ( V_225 ) ;
if ( V_7 -> V_2 ) {
F_126 ( V_7 -> V_2 ) ;
...
case V_177 :
V_7 -> V_2 = F_128 ( 0 , L_50 , V_228 ) ;
break;
case V_17 :
V_7 -> V_2 = F_128 ( 0 , L_51 , V_228 ) ;
V_7 -> V_2 -> V_35 |= V_229 ;
break;
default:
V_7 -> V_2 = F_129 ( 0 ) ;
...
F_132 ( V_7 -> V_2 , & V_7 -> V_151 , F_69 , V_241 ) ;
...
V_7 -> V_16 . V_214 = 0 ;
V_7 -> V_13 = V_120 ;
memset ( & V_7 -> V_128 , 0 , sizeof( struct V_249 ) ) ;
F_139 ( V_7 ) ;
F_48 ( V_114 , 2 , L_54 ) ;
V_11 = F_140 ( V_7 ) ;
if ( V_11 ) {
...
static int F_152 ( struct V_212 * V_225 ,
int V_113 )
{
struct V_6 * V_7 = F_121 ( & V_225 -> V_2 ) ;
int V_11 = 0 , V_254 = 0 , V_255 = 0 ;
enum V_242 V_243 ;
F_135 ( & V_7 -> V_244 ) ;
F_135 ( & V_7 -> V_245 ) ;
F_48 ( V_114 , 3 , L_57 ) ;
...
V_254 = F_148 ( F_150 ( V_7 ) ) ;
V_255 = F_148 ( F_13 ( V_7 ) ) ;
if ( ! V_11 )
V_11 = ( V_254 ) ? V_254 : V_255 ;
if ( V_11 )
F_87 ( V_114 , 2 , L_39 , V_11 ) ;
if ( V_243 == V_14 )
V_7 -> V_13 = V_251 ;
F_146 ( & V_225 -> V_2 . V_252 , V_253 ) ;
F_147 ( & V_7 -> V_245 ) ;
F_147 ( & V_7 -> V_244 ) ;
return 0 ;
}
static int F_125 ( struct V_212 * V_225 )
{
return F_152 ( V_225 , 0 ) ;
}
static int V_224 ( void * V_257 )
{
struct V_6 * V_7 ;
int V_11 = 0 ;
V_7 = (struct V_6 * ) V_257 ;
F_15 ( V_7 , 2 , L_58 ) ;
if ( ! F_154 ( V_7 , V_108 ) )
return 0 ;
F_15 ( V_7 , 2 , L_59 ) ;
...
static void F_160 ( struct V_212 * V_171 )
{
struct V_6 * V_7 = F_121 ( & V_171 -> V_2 ) ;
F_50 ( V_7 , 0 , 1 ) ;
if ( ( V_171 -> V_13 == V_227 ) && V_7 -> V_16 . V_214 )
F_138 ( V_7 , V_256 ) ;
F_56 ( V_7 , 0 ) ;
F_57 ( V_7 ) ;
}
static int F_161 ( struct V_212 * V_171 )
{
struct V_6 * V_7 = F_121 ( & V_171 -> V_2 ) ;
if ( V_7 -> V_2 )
F_162 ( V_7 -> V_2 ) ;
...
static int F_163 ( struct V_212 * V_171 )
{
struct V_6 * V_7 = F_121 ( & V_171 -> V_2 ) ;
int V_11 = 0 ;
if ( V_171 -> V_13 == V_258 )
...
static int F_165 ( struct V_6 * V_7 , int V_88 ,
struct V_100 * V_101 )
{
unsigned long V_35 ;
int V_11 = 0 ;
F_15 ( V_7 , 5 , L_66 ) ;
F_124 ( V_7 -> V_226 ,
F_166 ( & V_7 -> V_117 . V_259 , 0 , 1 ) == 0 ) ;
F_167 ( V_7 , V_88 , V_101 ) ;
F_15 ( V_7 , 6 , L_67 ) ;
F_168 ( F_169 ( V_7 -> V_117 . V_162 ) , V_35 ) ;
V_11 = F_170 ( V_7 -> V_117 . V_162 , & V_7 -> V_117 . V_260 ,
( V_261 ) V_101 , 0 , 0 ) ;
F_171 ( F_169 ( V_7 -> V_117 . V_162 ) , V_35 ) ;
if ( V_11 ) {
F_16 ( 2 , L_68
L_69 , V_11 ) ;
F_6 ( V_7 , 2 , L_70 , V_11 ) ;
F_172 ( V_101 -> V_262 , V_101 ) ;
F_173 ( & V_7 -> V_117 . V_259 , 0 ) ;
F_174 ( & V_7 -> V_226 ) ;
}
return V_11 ;
}
static int F_175 ( struct V_6 * V_7 ,
struct V_100 * V_101 , int V_263 )
{
T_5 V_264 , V_265 ;
F_15 ( V_7 , 4 , L_71 ) ;
F_176 ( V_7 , V_101 , V_266 ) ;
V_264 = ( T_5 ) ( V_103 + V_263 ) ;
V_265 = ( T_5 ) V_263 ;
memcpy ( F_177 ( V_101 -> V_47 ) , & V_264 , 2 ) ;
memcpy ( F_178 ( V_101 -> V_47 ) , & V_265 , 2 ) ;
memcpy ( F_179 ( V_101 -> V_47 ) , & V_265 , 2 ) ;
memcpy ( F_180 ( V_101 -> V_47 ) , & V_265 , 2 ) ;
return F_165 ( V_7 , V_264 , V_101 ) ;
}
int F_181 ( struct V_1 * V_2 , void * V_47 , int V_263 )
{
struct V_100 * V_101 ;
struct V_6 * V_7 ;
int V_11 ;
...
( V_7 -> V_13 != V_15 ) )
return - V_12 ;
V_101 = F_182 ( & V_7 -> V_117 ) ;
memcpy ( V_101 -> V_47 + V_103 , V_47 , V_263 ) ;
V_11 = F_175 ( V_7 , V_101 , V_263 ) ;
return V_11 ;
}
int F_183 ( unsigned char * V_39 , struct V_1 * * V_2 ,
int (* F_184)( struct V_1 * , void * ) ,
...
return - V_12 ;
F_15 ( V_7 , 2 , L_73 ) ;
if ( ( F_184 == NULL ) || ( V_144 == NULL ) )
return - V_30 ;
V_7 -> V_143 . F_184 = F_184 ;
