...
{
char * V_216 [ 4 ] , * V_217 , * V_218 , V_161 = '\0' , * V_3 ;
int V_21 , V_219 , V_220 , V_221 = 0 , V_222 = 0 , V_189 ;
if ( V_25 > 2 )
return V_29 ;
if ( V_25 ) {
char * V_13 ;
V_221 = F_85 ( V_26 [ 1 ] , & V_13 , 0 ) ;
if ( * V_13 )
V_221 = 0 ;
if ( V_25 > 1 ) {
V_222 = F_10 ( V_26 [ 2 ] , & V_13 , 0 ) ;
if ( * V_13 || V_222 < 0 )
V_222 = 0 ;
}
}
V_21 = F_11 ( L_54 , & V_219 ) ;
if ( ! V_21 && V_219 ) {
...
if ( V_216 [ 2 ] == V_216 [ 3 ] )
return 0 ;
V_220 = V_216 [ 1 ] - V_216 [ 0 ] ;
V_217 = V_216 [ 2 ] ;
V_218 = V_216 [ 3 ] ;
#define F_87 ( V_3 ) (((p - syslog_data[0]) % logsize) + syslog_data[0])
for ( V_189 = 0 , V_3 = V_217 ; V_3 < V_218 ; ++ V_3 ) {
V_161 = * F_87 ( V_3 ) ;
if ( V_161 == '\n' )
++ V_189 ;
}
...
F_16 ( L_116
L_117 , V_189 ) ;
else if ( V_222 - V_221 >= V_189 )
F_16 ( L_118
L_119 , V_189 , V_189 - V_222 ) ;
if ( V_222 ) {
for (; V_217 < V_218 && V_222 ; ++ V_217 ) {
if ( * F_87 ( V_217 ) == '\n' )
-- V_222 ;
}
if ( V_217 < V_218 )
...
for ( V_3 = V_217 ; V_3 < V_218 && V_221 ; ++ V_3 ) {
if ( * F_87 ( V_3 ) == '\n' )
++ V_221 ;
}
V_218 = V_3 ;
} else if ( V_221 > 0 ) {
int V_223 = V_189 - ( V_222 + V_221 ) ;
if ( V_222 >= V_189 ) {
F_16 ( L_120
L_121 , V_189 ) ;
V_223 = V_189 ;
...
if ( F_31 ( V_88 ) )
return 0 ;
while ( V_217 < V_218 && ( V_161 = * F_87 ( V_217 ) ) &&
( V_3 - V_224 ) < sizeof( V_224 ) - 1 ) {
++ V_217 ;
* V_3 ++ = V_161 ;
if ( V_161 == '\n' )
break;
...
{
int V_10 , V_225 , V_226 = 1 ;
char V_208 , V_227 = '?' ;
F_16 ( L_124 , F_50 () ) ;
F_16 ( L_125 ) ;
for ( V_225 = - 1 , V_10 = 0 ; V_10 < V_228 ; V_10 ++ ) {
if ( ! F_89 ( V_10 ) ) {
V_208 = 'F' ;
} else {
V_208 = ' ' ;
...
if ( V_25 != 1 )
return V_29 ;
V_21 = F_12 ( V_26 [ 1 ] , & V_229 ) ;
if ( V_21 )
return V_21 ;
if ( ( V_229 > V_228 ) || ! F_89 ( V_229 ) )
return V_193 ;
V_230 = V_229 ;
return V_147 ;
}
...
{
int V_231 = 0 , V_232 = 0 ;
unsigned long V_233 = F_93 ( L_130 ) ,
V_234 = F_93 ( L_131 ) ;
unsigned long V_2 ;
const struct V_1 * V_3 , * V_235 ;
F_94 (cpu) {
V_3 = F_1 ( V_2 ) ;
if ( F_95 ( V_3 , V_233 ) )
++ V_231 ;
...
int V_2 ;
unsigned long V_236 ;
if ( ! V_3 || F_99 ( & V_236 , ( char * ) V_3 , sizeof( unsigned long ) ) )
return;
V_2 = F_48 ( V_3 ) ;
F_16 ( L_138 ,
( void * ) V_3 , V_3 -> V_122 , V_3 -> V_237 -> V_122 ,
F_46 ( V_3 ) , F_48 ( V_3 ) ,
F_90 ( V_3 ) ,
( void * ) ( & V_3 -> V_238 ) ,
V_3 == F_1 ( F_50 () ) ? '*' : ' ' ,
...
{
struct V_1 * V_235 , * V_3 ;
unsigned long V_240 , V_2 ;
if ( V_25 == 0 )
F_92 () ;
F_16 ( L_142 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_143 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_144 ) ;
V_240 = F_93 ( V_25 ? V_26 [ 1 ] : NULL ) ;
F_94 (cpu) {
if ( F_31 ( V_88 ) )
return 0 ;
V_3 = F_1 ( V_2 ) ;
...
if ( V_21 )
return V_24 ;
V_3 = F_102 ( ( V_241 ) V_20 , & V_242 ) ;
if ( ! V_3 ) {
F_16 ( L_146 , ( V_241 ) V_20 ) ;
return 0 ;
}
}
F_45 ( V_3 ) ;
...
if ( F_31 ( V_88 ) )
goto V_246;
sprintf ( V_224 , L_111 V_125 L_29 , V_61 , V_243 ) ;
V_21 = F_29 ( V_224 ) ;
if ( V_21 )
goto V_246;
V_41 = V_243 + V_244 ;
if ( F_63 ( & V_243 , V_41 , sizeof( V_243 ) ) )
goto V_246;
}
V_246:
F_26 ( V_61 ) ;
...
static void F_108 ( struct V_260 * V_261 , struct V_262 * V_263 )
{
static int V_264 [] = { 31 , 29 , 31 , 30 , 31 , 30 , 31 ,
31 , 30 , 31 , 30 , 31 } ;
memset ( V_263 , 0 , sizeof( * V_263 ) ) ;
V_263 -> V_265 = V_261 -> V_266 % ( 24 * 60 * 60 ) ;
V_263 -> V_267 = V_261 -> V_266 / ( 24 * 60 * 60 ) +
( 2 * 365 + 1 ) ;
V_263 -> V_268 = V_263 -> V_265 / 60 % 60 ;
V_263 -> V_269 = V_263 -> V_265 / 60 / 60 ;
V_263 -> V_265 = V_263 -> V_265 % 60 ;
V_263 -> V_270 = 68 + 4 * ( V_263 -> V_267 / ( 4 * 365 + 1 ) ) ;
V_263 -> V_267 %= ( 4 * 365 + 1 ) ;
V_264 [ 1 ] = 29 ;
while ( V_263 -> V_267 >= V_264 [ V_263 -> V_271 ] ) {
V_263 -> V_267 -= V_264 [ V_263 -> V_271 ] ;
if ( ++ V_263 -> V_271 == 12 ) {
V_263 -> V_271 = 0 ;
++ V_263 -> V_270 ;
V_264 [ 1 ] = 28 ;
...
static void F_109 ( struct V_272 * V_20 )
{
struct V_260 V_273 ;
F_110 ( & V_273 ) ;
memset ( V_20 , 0 , sizeof( * V_20 ) ) ;
V_20 -> V_273 = V_273 . V_266 ;
V_20 -> V_274 [ 0 ] = V_275 [ 0 ] ;
V_20 -> V_274 [ 1 ] = V_275 [ 1 ] ;
V_20 -> V_274 [ 2 ] = V_275 [ 2 ] ;
V_20 -> V_276 = V_277 - 1 ;
F_111 ( V_20 ) ;
return;
}
...
if ( V_25 )
return V_29 ;
F_16 ( L_158 , V_279 . V_40 . V_280 ) ;
F_16 ( L_159 , V_279 . V_40 . V_281 ) ;
F_16 ( L_160 , V_279 . V_40 . V_282 ) ;
F_16 ( L_161 , V_279 . V_40 . V_283 ) ;
F_16 ( L_162 , V_279 . V_40 . V_284 ) ;
F_16 ( L_163 , V_279 . V_40 . V_285 ) ;
F_16 ( L_164 , F_113 ( V_286 ) ) ;
V_278 = F_114 () ;
F_108 ( & V_278 , & V_263 ) ;
F_16 ( L_165
L_166 ,
1900 + V_263 . V_270 , V_263 . V_271 + 1 , V_263 . V_267 ,
V_263 . V_269 , V_263 . V_268 , V_263 . V_265 ,
V_287 . V_288 ) ;
F_109 ( & V_20 ) ;
F_16 ( L_167 ) ;
if ( V_20 . V_273 > ( 24 * 60 * 60 ) ) {
int V_289 = V_20 . V_273 / ( 24 * 60 * 60 ) ;
V_20 . V_273 %= ( 24 * 60 * 60 ) ;
F_16 ( L_168 , V_289 , V_289 == 1 ? L_1 : L_169 ) ;
}
F_16 ( L_170 , V_20 . V_273 / ( 60 * 60 ) , ( V_20 . V_273 / 60 ) % 60 ) ;
#define F_115 ( T_10 ) ((x) >> FSHIFT)
#define F_116 ( T_10 ) LOAD_INT(((x) & (FIXED_1-1)) * 100)
F_16 ( L_171 ,
F_115 ( V_20 . V_274 [ 0 ] ) , F_116 ( V_20 . V_274 [ 0 ] ) ,
F_115 ( V_20 . V_274 [ 1 ] ) , F_116 ( V_20 . V_274 [ 1 ] ) ,
F_115 ( V_20 . V_274 [ 2 ] ) , F_116 ( V_20 . V_274 [ 2 ] ) ) ;
#undef F_115
#undef F_116
#define F_117 ( T_10 ) ((x) << (PAGE_SHIFT - 10))
F_16 ( L_172
L_173 ,
V_20 . V_290 , V_20 . V_291 , V_20 . V_292 ) ;
return 0 ;
}
...
char V_162 [ 64 ] ;
int V_2 , V_21 , V_38 = 1 ;
unsigned long V_41 , V_293 , V_20 , V_165 = 0 , V_294 = ~ 0UL ;
if ( V_25 < 1 || V_25 > 3 )
return V_29 ;
V_21 = F_18 ( V_25 , V_26 , & V_38 , & V_293 , NULL , NULL ) ;
if ( V_21 )
return V_21 ;
if ( V_25 >= 2 ) {
...
return V_187 ;
sprintf ( V_162 , L_174 , ( int ) ( 2 * V_165 ) ) ;
if ( V_25 >= 3 ) {
V_21 = F_12 ( V_26 [ 3 ] , & V_294 ) ;
if ( V_21 )
return V_21 ;
if ( ! F_89 ( V_294 ) ) {
F_16 ( L_175 , V_294 ) ;
...
if ( F_31 ( V_88 ) )
return 0 ;
if ( V_294 != ~ 0UL && V_294 != V_2 )
continue;
V_41 = V_293 + F_120 ( V_2 ) ;
V_21 = F_63 ( & V_20 , V_41 , V_165 ) ;
if ( V_21 ) {
F_16 ( L_176 V_295 L_177
L_178 , V_2 , V_41 , V_21 ) ;
continue;
}
F_16 ( L_176 , V_2 ) ;
...
T_4 * V_298 ;
F_34 (kp, i) {
if ( V_298 -> V_92 && ( strcmp ( V_298 -> V_92 , V_103 ) == 0 ) ) {
F_16 ( L_190
L_191 , V_103 , V_296 , V_67 ) ;
return 1 ;
}
}
F_34 (kp, i) {
...
if ( V_10 >= V_94 ) {
T_4 * V_299 = F_28 ( ( V_94 - V_300 +
V_301 ) * sizeof( * V_299 ) , V_68 ) ;
if ( ! V_299 ) {
F_16 ( L_192
L_193 ) ;
return 1 ;
...
if ( V_302 ) {
memcpy ( V_299 , V_302 ,
( V_94 - V_300 ) * sizeof( * V_299 ) ) ;
F_26 ( V_302 ) ;
}
memset ( V_299 + V_94 , 0 ,
V_301 * sizeof( * V_299 ) ) ;
V_302 = V_299 ;
V_298 = V_302 + V_94 - V_300 ;
V_94 += V_301 ;
}
V_298 -> V_92 = V_103 ;
V_298 -> V_96 = V_296 ;
...
short V_297 )
{
return F_122 ( V_103 , V_296 , V_66 , V_67 , V_297 ,
V_99 ) ;
}
...
F_34 (kp, i)
V_298 -> V_92 = NULL ;
F_122 ( L_77 , F_66 , L_194 ,
L_195 , 1 ,
V_100 ) ;
F_122 ( L_76 , F_66 , L_196 ,
L_197 , 0 , V_100 ) ;
F_122 ( L_79 , F_66 , L_198 ,
L_199 , 0 , V_100 ) ;
F_122 ( L_78 , F_66 , L_194 ,
L_200 , 0 , V_100 ) ;
...
L_213 , 0 , V_99 ) ;
F_122 ( L_214 , V_304 , L_205 ,
L_215 , 1 , V_99 ) ;
F_122 ( L_216 , V_304 , L_217 ,
L_218 , 0 , V_99 ) ;
F_122 ( L_219 , V_304 , L_220 ,
L_221 , 0 , V_99 ) ;
F_122 ( L_222 , V_304 , L_1 ,
L_223 , 0 , V_99 ) ;
F_122 ( L_224 , V_304 , L_194 ,
L_225 , 0 ,
V_99 ) ;
...
{
int V_10 , V_21 ;
for ( V_10 = 0 ; V_308 [ V_10 ] ; ++ V_10 ) {
V_21 = F_29 ( V_308 [ V_10 ] ) ;
if ( V_21 )
F_16 ( L_269 ,
V_308 [ V_10 ] , V_21 ) ;
}
...
void T_13 F_126 ( int V_309 )
{
static int V_310 = V_311 ;
int V_10 ;
if ( V_310 == V_312 || V_309 <= V_310 )
return;
for ( V_10 = V_310 ; V_10 < V_309 ; V_10 ++ ) {
switch ( V_10 ) {
case V_311 :
F_124 () ;
F_127 () ;
