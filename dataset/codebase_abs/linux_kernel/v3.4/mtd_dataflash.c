...
static int T_7
F_29 ( struct V_1 * V_2 , char * V_71 ,
int V_72 , int V_73 , int V_74 , char V_65 )
{
struct V_10 * V_11 ;
struct V_6 * V_64 ;
struct V_75 V_76 ;
struct V_77 * V_78 = V_2 -> V_5 . V_79 ;
char * V_80 = L_21 ;
int V_81 = 0 ;
...
V_64 -> V_95 = F_18 ;
V_64 -> V_11 = V_11 ;
V_64 -> V_5 . V_96 = & V_2 -> V_5 ;
if ( V_65 >= 'c' )
V_80 = F_28 ( V_64 , V_65 ) ;
F_31 ( & V_2 -> V_5 , L_23 ,
V_71 , ( long long ) ( ( V_64 -> V_85 + 1023 ) >> 10 ) ,
V_73 , V_80 ) ;
F_32 ( & V_2 -> V_5 , V_11 ) ;
V_76 . V_97 = V_2 -> V_5 . V_97 ;
V_81 = F_33 ( V_64 , NULL , & V_76 ,
V_78 ? V_78 -> V_98 : NULL ,
V_78 ? V_78 -> V_99 : 0 ) ;
if ( ! V_81 )
return 0 ;
