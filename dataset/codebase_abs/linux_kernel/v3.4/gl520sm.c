...
V_20 = F_57 ( & V_18 -> V_2 . V_61 , & V_66 ) ;
if ( V_20 )
goto V_67;
V_7 -> V_68 = F_58 ( & V_18 -> V_2 ) ;
if ( F_59 ( V_7 -> V_68 ) ) {
V_20 = F_60 ( V_7 -> V_68 ) ;
goto V_67;
}
...
static int F_18 ( struct V_17 * V_18 , T_2 V_72 )
{
if ( ( V_72 >= 0x07 ) && ( V_72 <= 0x0c ) )
return F_66 ( V_18 , V_72 ) ;
else
return F_67 ( V_18 , V_72 ) ;
}
static int F_17 ( struct V_17 * V_18 , T_2 V_72 , T_4 V_73 )
{
if ( ( V_72 >= 0x07 ) && ( V_72 <= 0x0c ) )
return F_68 ( V_18 , V_72 , V_73 ) ;
else
return F_69 ( V_18 , V_72 , V_73 ) ;
}
...
int V_74 , V_75 ;
F_14 ( & V_7 -> V_21 ) ;
if ( F_70 ( V_76 , V_7 -> V_77 + 2 * V_78 ) || ! V_7 -> V_79 ) {
F_50 ( & V_18 -> V_2 , L_6 ) ;
V_7 -> V_40 = F_18 ( V_18 , V_80 ) ;
V_7 -> V_29 = F_18 ( V_18 , V_30 ) ;
V_7 -> V_8 = F_18 ( V_18 ,
V_81 ) & 0x1f ;
for ( V_75 = 0 ; V_75 < 4 ; V_75 ++ ) {
V_7 -> V_13 [ V_75 ] = F_18 ( V_18 ,
V_82 [ V_75 ] ) ;
V_74 = F_18 ( V_18 , V_83 [ V_75 ] ) ;
V_7 -> V_14 [ V_75 ] = V_74 & 0xff ;
V_7 -> V_15 [ V_75 ] = ( V_74 >> 8 ) & 0xff ;
}
V_74 = F_18 ( V_18 , V_84 ) ;
V_7 -> V_24 [ 0 ] = ( V_74 >> 8 ) & 0xff ;
V_7 -> V_24 [ 1 ] = V_74 & 0xff ;
V_74 = F_18 ( V_18 , V_28 ) ;
V_7 -> V_26 [ 0 ] = ( V_74 >> 8 ) & 0xff ;
V_7 -> V_26 [ 1 ] = V_74 & 0xff ;
...
V_39 [ 0 ] ) ;
V_74 = F_18 ( V_18 , V_33 ) ;
V_7 -> V_25 [ 0 ] = ( V_74 >> 6 ) & 0x03 ;
V_7 -> V_25 [ 1 ] = ( V_74 >> 4 ) & 0x03 ;
V_7 -> V_27 = ( V_74 >> 2 ) & 0x01 ;
V_7 -> V_40 &= V_7 -> V_31 ;
V_74 = F_18 ( V_18 , V_55 ) ;
V_7 -> V_41 = ! ( ( V_74 >> 2 ) & 1 ) ;
if ( V_7 -> V_64 ) {
