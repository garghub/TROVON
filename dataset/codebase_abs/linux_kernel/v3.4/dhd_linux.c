...
F_63 ( & V_2 -> V_61 , 0 ) ;
memcpy ( V_9 -> V_42 , V_2 -> V_148 , V_31 ) ;
...
int
F_66 ( struct V_75 * V_63 , int V_12 , char * V_3 , T_4 * V_149 )
{
struct V_6 * V_7 ;
struct V_15 * V_9 ;
struct V_76 * V_48 = F_30 ( V_63 ) ;
...
V_9 = F_69 ( sizeof( struct V_6 ) , V_3 , V_150 ) ;
if ( ! V_9 ) {
F_2 ( ERROR , L_45 ) ;
return - V_70 ;
}
...
V_7 -> V_65 = V_12 ;
if ( V_149 != NULL )
memcpy ( & V_7 -> V_149 , V_149 , V_31 ) ;
if ( F_70 ( V_2 , V_7 -> V_65 ) ) {
F_2 ( ERROR , L_46 ) ;
F_68 ( V_7 -> V_9 ) ;
V_2 -> V_8 [ V_12 ] = NULL ;
return - V_109 ;
...
F_2 ( V_11 , L_47 ,
V_151 -> V_152 , V_7 -> V_9 -> V_3 ) ;
return 0 ;
}
void F_71 ( struct V_1 * V_2 , int V_12 )
{
struct V_6 * V_7 ;
F_2 ( V_11 , L_43 , V_12 ) ;
V_7 = V_2 -> V_8 [ V_12 ] ;
...
int F_75 ( T_3 V_155 , struct V_75 * V_63 )
{
struct V_1 * V_2 = NULL ;
int V_27 = 0 ;
F_2 ( V_11 , L_17 ) ;
V_2 = F_76 ( sizeof( struct V_1 ) , V_32 ) ;
if ( ! V_2 )
return - V_70 ;
F_77 ( & V_2 -> V_156 ) ;
V_2 -> V_66 = V_155 ;
...
struct V_1 * V_2 = V_48 -> V_2 ;
F_2 ( V_11 , L_50 ) ;
V_27 = V_48 -> V_160 ( V_63 ) ;
if ( V_27 != 0 ) {
F_2 ( ERROR , L_51 , V_27 ) ;
return V_27 ;
}
F_12 ( L_52 , V_2 -> V_161 , V_159 ,
V_158 , sizeof( V_158 ) ) ;
F_82 ( V_2 , 0 , V_107 , V_158 ,
sizeof( V_158 ) ) ;
memcpy ( V_2 -> V_161 , V_158 , V_159 ) ;
F_83 ( V_2 -> V_161 , V_162 ) ;
F_83 ( V_2 -> V_161 , V_163 ) ;
F_83 ( V_2 -> V_161 , V_164 ) ;
F_83 ( V_2 -> V_161 , V_165 ) ;
F_83 ( V_2 -> V_161 , V_166 ) ;
F_83 ( V_2 -> V_161 , V_167 ) ;
F_83 ( V_2 -> V_161 , V_168 ) ;
F_83 ( V_2 -> V_161 , V_169 ) ;
F_83 ( V_2 -> V_161 , V_170 ) ;
F_83 ( V_2 -> V_161 , V_171 ) ;
F_83 ( V_2 -> V_161 , V_172 ) ;
F_83 ( V_2 -> V_161 , V_173 ) ;
F_83 ( V_2 -> V_161 , V_174 ) ;
F_83 ( V_2 -> V_161 , V_175 ) ;
F_83 ( V_2 -> V_161 , V_176 ) ;
F_83 ( V_2 -> V_161 , V_177 ) ;
F_83 ( V_2 -> V_161 , V_178 ) ;
F_83 ( V_2 -> V_161 , V_179 ) ;
V_2 -> V_180 = 1 ;
V_2 -> V_181 [ 0 ] = L_53 ;
V_27 = F_84 ( V_2 ) ;
if ( V_27 < 0 )
...
int F_70 ( struct V_1 * V_2 , int V_12 )
{
struct V_15 * V_9 ;
T_4 V_182 [ V_31 ] = {
...
V_9 -> V_153 = & V_154 ;
if ( V_12 != 0 ) {
memcpy ( V_182 , V_2 -> V_148 , V_31 ) ;
}
if ( V_12 == 1 ) {
F_2 ( V_11 , L_54 ) ;
V_182 [ 0 ] |= 0X02 ;
}
V_9 -> V_183 = V_91 + V_2 -> V_66 ;
V_9 -> V_184 = & V_185 ;
V_2 -> V_186 = V_9 -> V_187 + V_9 -> V_183 +
V_2 -> V_66 ;
memcpy ( V_9 -> V_42 , V_182 , V_31 ) ;
if ( ! V_12 ) {
...
if ( V_2 ) {
F_88 ( V_2 ) ;
V_2 -> V_48 -> V_189 ( V_2 -> V_63 ) ;
}
}
void F_80 ( struct V_75 * V_63 )
{
int V_4 ;
struct V_76 * V_48 = F_30 ( V_63 ) ;
struct V_1 * V_2 = V_48 -> V_2 ;
...
int F_95 ( struct V_1 * V_2 , const T_4 * V_24 , int V_198 )
{
int V_27 = 0 ;
struct V_199 * V_200 ;
T_8 V_201 ;
...
V_201 = F_96 () ;
F_97 ( V_203 ) ;
V_200 = F_98 ( L_58 , V_204 | V_205 , 0640 ) ;
if ( ! V_200 ) {
F_2 ( ERROR , L_59 ) ;
V_27 = - 1 ;
goto exit;
}
V_200 -> V_206 -> V_207 ( V_200 , ( char T_6 * ) V_24 , V_198 , & V_202 ) ;
exit:
F_11 ( V_24 ) ;
if ( V_200 )
F_99 ( V_200 , V_151 -> V_208 ) ;
F_97 ( V_201 ) ;
return V_27 ;
}
