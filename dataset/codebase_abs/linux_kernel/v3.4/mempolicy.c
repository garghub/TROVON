...
struct V_9 * F_178 ( struct V_9 * V_184 ,
struct V_9 * V_185 )
{
if ( ! F_170 ( V_185 ) )
return V_185 ;
...
bool F_179 ( struct V_9 * V_187 , struct V_9 * V_188 )
{
if ( ! V_187 || ! V_188 )
return false ;
...
static struct V_189 *
F_180 ( struct V_190 * V_191 , unsigned long V_85 , unsigned long V_69 )
{
struct V_192 * V_193 = V_191 -> V_194 . V_192 ;
while ( V_193 ) {
struct V_189 * V_43 = F_181 ( V_193 , struct V_189 , V_2 ) ;
if ( V_85 >= V_43 -> V_69 )
V_193 = V_193 -> V_195 ;
...
struct V_192 * V_88 = F_182 ( V_193 ) ;
if ( ! V_88 )
break;
V_32 = F_181 ( V_88 , struct V_189 , V_2 ) ;
if ( V_32 -> V_69 <= V_85 )
break;
V_193 = V_88 ;
}
return F_181 ( V_193 , struct V_189 , V_2 ) ;
}
static void F_183 ( struct V_190 * V_191 , struct V_189 * V_58 )
{
...
while ( * V_43 ) {
V_197 = * V_43 ;
V_2 = F_181 ( V_197 , struct V_189 , V_2 ) ;
...
F_184 ( & V_58 -> V_2 , V_197 , V_43 ) ;
F_185 ( & V_58 -> V_2 , & V_191 -> V_194 ) ;
F_19 ( L_4 , V_58 -> V_85 , V_58 -> V_69 ,
V_58 -> V_36 ? V_58 -> V_36 -> V_28 : 0 ) ;
}
struct V_9 *
F_186 ( struct V_190 * V_191 , unsigned long V_198 )
{
...
return NULL ;
F_187 ( & V_191 -> V_200 ) ;
V_199 = F_180 ( V_191 , V_198 , V_198 + 1 ) ;
if ( V_199 ) {
F_71 ( V_199 -> V_36 ) ;
V_10 = V_199 -> V_36 ;
}
...
static void F_189 ( struct V_190 * V_191 , struct V_189 * V_193 )
{
F_19 ( L_5 , V_193 -> V_85 , V_193 -> V_69 ) ;
F_190 ( & V_193 -> V_2 , & V_191 -> V_194 ) ;
F_72 ( V_193 -> V_36 ) ;
F_26 ( V_201 , V_193 ) ;
}
static struct V_189 * F_191 ( unsigned long V_85 , unsigned long V_69 ,
struct V_9 * V_10 )
{
...
static int F_192 ( struct V_190 * V_191 , unsigned long V_85 ,
unsigned long V_69 , struct V_189 * V_58 )
{
struct V_189 * V_193 , * V_202 = NULL ;
V_203:
F_187 ( & V_191 -> V_200 ) ;
V_193 = F_180 ( V_191 , V_85 , V_69 ) ;
while ( V_193 && V_193 -> V_85 < V_69 ) {
struct V_192 * V_82 = F_193 ( & V_193 -> V_2 ) ;
if ( V_193 -> V_85 >= V_85 ) {
if ( V_193 -> V_69 <= V_69 )
F_189 ( V_191 , V_193 ) ;
else
...
if ( ! V_202 ) {
F_188 ( & V_191 -> V_200 ) ;
V_202 = F_191 ( V_69 , V_193 -> V_69 , V_193 -> V_36 ) ;
if ( ! V_202 )
return - V_41 ;
goto V_203;
}
...
if ( ! V_82 )
break;
V_193 = F_181 ( V_82 , struct V_189 , V_2 ) ;
}
if ( V_58 )
F_183 ( V_191 , V_58 ) ;
F_188 ( & V_191 -> V_200 ) ;
...
void F_194 ( struct V_190 * V_191 , struct V_9 * V_176 )
{
int V_13 ;
V_191 -> V_194 = V_204 ;
F_195 ( & V_191 -> V_200 ) ;
...
int F_196 ( struct V_190 * V_210 ,
struct V_61 * V_62 , struct V_9 * V_211 )
{
int V_86 ;
struct V_189 * V_58 = NULL ;
unsigned long V_212 = F_197 ( V_62 ) ;
F_19 ( L_6 ,
V_62 -> V_96 ,
...
if ( V_211 ) {
V_58 = F_191 ( V_62 -> V_96 , V_62 -> V_96 + V_212 , V_211 ) ;
if ( ! V_58 )
return - V_41 ;
}
V_86 = F_192 ( V_210 , V_62 -> V_96 , V_62 -> V_96 + V_212 , V_58 ) ;
if ( V_86 && V_58 )
F_26 ( V_201 , V_58 ) ;
return V_86 ;
}
void F_198 ( struct V_190 * V_43 )
{
struct V_189 * V_193 ;
struct V_192 * V_82 ;
if ( ! V_43 -> V_194 . V_192 )
return;
F_187 ( & V_43 -> V_200 ) ;
V_82 = F_199 ( & V_43 -> V_194 ) ;
while ( V_82 ) {
V_193 = F_181 ( V_82 , struct V_189 , V_2 ) ;
V_82 = F_193 ( & V_193 -> V_2 ) ;
F_190 ( & V_193 -> V_2 , & V_43 -> V_194 ) ;
F_72 ( V_193 -> V_36 ) ;
F_26 ( V_201 , V_193 ) ;
}
F_188 ( & V_43 -> V_200 ) ;
...
unsigned long V_216 = F_203 ( V_76 ) ;
if ( V_213 < V_216 ) {
V_213 = V_216 ;
V_214 = V_76 ;
}
if ( ( V_216 << V_105 ) >= ( 16 << 20 ) )
F_91 ( V_76 , F_147 ) ;
}
if ( F_142 ( F_10 ( F_147 ) ) )
F_91 ( V_214 , F_147 ) ;
...
int F_206 ( char * V_217 , struct V_9 * * V_176 , int V_218 )
{
...
int F_209 ( char * V_223 , int V_224 , struct V_9 * V_10 , int V_218 )
{
char * V_43 = V_223 ;
int V_225 ;
T_1 V_17 ;
...
return - V_226 ;
* V_43 ++ = ':' ;
V_43 += F_210 ( V_43 , V_223 + V_224 - V_43 , V_17 ) ;
}
return V_43 - V_223 ;
}
