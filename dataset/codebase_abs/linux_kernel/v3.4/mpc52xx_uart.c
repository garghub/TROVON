...
F_87 ( struct V_8 * V_9 )
{
return V_9 -> type == V_136 ? L_14 : NULL ;
}
static void
F_88 ( struct V_8 * V_9 )
{
...
int V_139 ;
if ( V_9 -> V_88 & V_137 )
V_9 -> V_138 = F_91 ( V_9 -> V_61 ,
sizeof( struct V_1 ) ) ;
if ( ! V_9 -> V_138 )
return - V_140 ;
V_139 = F_92 ( V_9 -> V_61 , sizeof( struct V_1 ) ,
L_10 ) != NULL ? 0 : - V_141 ;
if ( V_139 && ( V_9 -> V_88 & V_137 ) ) {
F_54 ( V_9 -> V_138 ) ;
V_9 -> V_138 = NULL ;
}
return V_139 ;
...
static int
F_94 ( struct V_8 * V_9 , struct V_143 * V_144 )
{
if ( V_144 -> type != V_145 && V_144 -> type != V_136 )
return - V_140 ;
if ( ( V_144 -> V_35 != V_9 -> V_35 ) ||
( V_144 -> V_146 != V_147 ) ||
( V_144 -> V_148 != V_9 -> V_31 ) ||
( V_144 -> V_149 != ( void * ) V_9 -> V_61 ) ||
( V_144 -> V_150 != 0 ) )
return - V_140 ;
return 0 ;
}
...
F_95 ( struct V_8 * V_9 )
{
struct V_151 * V_152 = V_9 -> V_153 -> V_9 . V_152 ;
unsigned char V_87 , V_154 ;
unsigned short V_79 ;
while ( V_69 -> V_155 ( V_9 ) ) {
V_87 = V_69 -> V_156 ( V_9 ) ;
#ifdef F_96
if ( F_97 ( V_9 , V_87 ) ) {
V_9 -> V_157 = 0 ;
...
F_3 ( & F_5 ( V_9 ) -> V_97 , V_170 ) ;
}
F_99 ( V_152 , V_87 , V_154 ) ;
if ( V_79 & V_171 ) {
F_99 ( V_152 , 0 , V_172 ) ;
V_9 -> V_159 . V_173 ++ ;
}
...
F_101 ( V_152 ) ;
F_102 ( & V_9 -> V_89 ) ;
return V_69 -> V_155 ( V_9 ) ;
}
static inline int
F_103 ( struct V_8 * V_9 )
{
struct V_174 * V_175 = & V_9 -> V_153 -> V_175 ;
if ( V_9 -> V_90 ) {
V_69 -> V_176 ( V_9 , V_9 -> V_90 ) ;
V_9 -> V_159 . V_177 ++ ;
V_9 -> V_90 = 0 ;
return 1 ;
}
if ( F_104 ( V_175 ) || F_105 ( V_9 ) ) {
F_70 ( V_9 ) ;
return 0 ;
}
while ( V_69 -> V_178 ( V_9 ) ) {
V_69 -> V_176 ( V_9 , V_175 -> V_179 [ V_175 -> V_180 ] ) ;
V_175 -> V_180 = ( V_175 -> V_180 + 1 ) & ( V_181 - 1 ) ;
V_9 -> V_159 . V_177 ++ ;
if ( F_104 ( V_175 ) )
break;
}
if ( F_106 ( V_175 ) < V_182 )
F_107 ( V_9 ) ;
if ( F_104 ( V_175 ) ) {
F_70 ( V_9 ) ;
return 0 ;
...
int * V_30 , int * V_167 , int * V_195 , int * V_196 )
{
struct V_1 T_1 * V_2 = F_5 ( V_9 ) ;
unsigned char V_107 ;
F_111 ( L_15 , V_9 ) ;
F_3 ( & V_2 -> V_97 , V_133 ) ;
V_107 = F_20 ( & V_2 -> V_134 ) ;
* V_30 = V_197 ;
switch ( V_107 & V_198 ) {
case V_113 :
* V_195 = 5 ;
...
* V_167 = V_107 & V_122 ? 'o' : 'e' ;
}
static void
F_112 ( struct V_199 * V_200 , const char * V_201 , unsigned int V_202 )
{
struct V_8 * V_9 = & V_203 [ V_200 -> V_204 ] ;
unsigned int V_205 , V_109 ;
V_69 -> V_206 ( V_9 ) ;
V_109 = 5000000 ;
while ( ! F_67 ( V_9 ) && -- V_109 )
F_83 ( 1 ) ;
for ( V_205 = 0 ; V_205 < V_202 ; V_205 ++ , V_201 ++ ) {
if ( * V_201 == '\n' )
V_69 -> V_176 ( V_9 , '\r' ) ;
V_69 -> V_176 ( V_9 , * V_201 ) ;
V_109 = 20000 ;
while ( ! F_67 ( V_9 ) && -- V_109 )
F_83 ( 1 ) ;
}
...
static int T_4
F_113 ( struct V_199 * V_200 , char * V_208 )
{
struct V_8 * V_9 = & V_203 [ V_200 -> V_204 ] ;
struct V_32 * V_33 = V_209 [ V_200 -> V_204 ] ;
unsigned int V_31 ;
struct V_210 V_211 ;
int V_77 ;
int V_30 = V_197 ;
...
int V_196 = 'n' ;
F_111 ( L_16 ,
V_200 , V_200 -> V_204 , V_208 ) ;
if ( ( V_200 -> V_204 < 0 ) || ( V_200 -> V_204 >= V_212 ) ) {
F_111 ( L_17 , V_200 -> V_204 ) ;
return - V_140 ;
}
if ( ! V_33 ) {
F_111 ( L_18 , V_200 -> V_204 ) ;
return - V_140 ;
}
F_111 ( L_19 ,
V_200 -> V_204 , V_209 [ V_200 -> V_204 ] -> V_213 ) ;
V_77 = F_114 ( V_33 , 0 , & V_211 ) ;
if ( V_77 ) {
F_111 ( L_20 , V_200 -> V_204 ) ;
return V_77 ;
}
V_31 = F_115 ( V_33 ) ;
if ( V_31 == 0 ) {
...
V_9 -> V_31 = V_31 ;
V_9 -> V_214 = & V_215 ;
V_9 -> V_61 = V_211 . V_216 ;
V_9 -> V_138 = F_91 ( V_211 . V_216 , sizeof( struct V_1 ) ) ;
V_9 -> V_35 = F_27 ( V_33 , 0 ) ;
if ( V_9 -> V_138 == NULL )
return - V_140 ;
F_111 ( L_22 ,
( void * ) V_9 -> V_61 , V_9 -> V_138 ,
V_9 -> V_35 , V_9 -> V_31 ) ;
if ( V_208 )
F_117 ( V_208 , & V_30 , & V_167 , & V_195 , & V_196 ) ;
else
F_110 ( V_9 , & V_30 , & V_167 , & V_195 , & V_196 ) ;
F_111 ( L_23 ,
V_30 , V_195 , V_167 , V_196 ) ;
return F_118 ( V_9 , V_200 , V_30 , V_167 , V_195 , V_196 ) ;
}
static int T_4
F_119 ( void )
{
...
static int T_7 F_122 ( struct V_218 * V_219 )
{
int V_220 = - 1 ;
unsigned int V_31 ;
struct V_8 * V_9 = NULL ;
...
if ( V_209 [ V_220 ] == V_219 -> V_67 . V_221 )
break;
if ( V_220 >= V_212 )
return - V_140 ;
F_111 ( L_24 ,
V_209 [ V_220 ] -> V_213 , V_220 ) ;
V_31 = F_115 ( V_219 -> V_67 . V_221 ) ;
if ( V_31 == 0 ) {
F_63 ( & V_219 -> V_67 , L_21 ) ;
return - V_140 ;
}
V_9 = & V_203 [ V_220 ] ;
F_116 ( & V_9 -> V_89 ) ;
...
V_9 -> V_214 = & V_215 ;
V_9 -> V_67 = & V_219 -> V_67 ;
V_77 = F_114 ( V_219 -> V_67 . V_221 , 0 , & V_211 ) ;
if ( V_77 )
return V_77 ;
V_9 -> V_61 = V_211 . V_216 ;
if ( ! V_9 -> V_61 ) {
F_63 ( & V_219 -> V_67 , L_25 ) ;
return - V_140 ;
}
V_69 -> V_225 ( V_9 , V_219 -> V_67 . V_221 ) ;
if ( V_9 -> V_35 == 0 ) {
F_63 ( & V_219 -> V_67 , L_26 ) ;
return - V_140 ;
}
F_63 ( & V_219 -> V_67 , L_27 ,
( void * ) V_9 -> V_61 , V_9 -> V_35 , V_9 -> V_31 ) ;
V_77 = F_123 ( & V_226 , V_9 ) ;
if ( V_77 )
return V_77 ;
F_124 ( & V_219 -> V_67 , ( void * ) V_9 ) ;
return 0 ;
}
static int
F_125 ( struct V_218 * V_219 )
{
struct V_8 * V_9 = F_126 ( & V_219 -> V_67 ) ;
F_124 ( & V_219 -> V_67 , NULL ) ;
if ( V_9 )
F_127 ( & V_226 , V_9 ) ;
return 0 ;
}
static int
F_128 ( struct V_218 * V_219 , T_8 V_153 )
{
struct V_8 * V_9 = (struct V_8 * ) F_126 ( & V_219 -> V_67 ) ;
if ( V_9 )
F_129 ( & V_226 , V_9 ) ;
return 0 ;
}
static int
F_130 ( struct V_218 * V_219 )
{
struct V_8 * V_9 = (struct V_8 * ) F_126 ( & V_219 -> V_67 ) ;
if ( V_9 )
F_131 ( & V_226 , V_9 ) ;
