...
void F_74 ( struct V_206 * V_207 )
{
struct V_52 * V_208 =
F_75 ( V_207 , struct V_52 , V_209 ) ;
struct V_51 * V_52 ;
struct V_61 * V_62 ;
F_30 () ;
V_52 = V_208 -> V_46 ;
...
static inline int
F_77 ( int V_27 , struct V_211 T_1 * V_29 ,
...
if ( ! V_30 && V_32 -> V_32 != V_48 )
return - V_36 ;
V_32 -> V_43 = F_78 ( ( (struct V_212 * ) V_32 ) -> V_43 ) ;
V_34 = F_16 ( V_52 , V_32 ) ;
if ( V_34 )
return V_34 ;
...
static inline int
F_80 ( unsigned int V_27 , struct V_214 T_1 * V_50 ,
...
case V_35 :
case V_47 :
V_69 = F_77 ( V_27 , V_68 , V_30 , & V_32 ) ;
break;
case V_189 :
V_69 = F_79 ( V_68 , V_30 , & V_32 , V_52 ) ;
break;
case V_58 :
case V_59 :
F_63 () ;
V_69 = F_80 ( V_27 , V_68 , V_30 , V_52 ) ;
F_65 () ;
break;
case V_75 :
case V_77 :
...
if ( V_52 -> V_130 . V_131 == V_133 ) {
if ( F_83 ( V_52 -> V_135 , V_52 -> V_130 . V_205 , 1 ) != 0 ) {
F_70 ( V_52 ) ;
if ( V_217 != V_52 -> V_99 ) {
if ( V_52 -> V_99 == V_98 )
F_31 ( 1 ) ;
...
if ( F_83 ( V_52 -> V_135 , V_52 -> V_130 . V_204 , 1 ) == 0 ) {
return;
}
F_70 ( V_52 ) ;
}
...
int F_85 ( unsigned int V_220 , int V_221 )
{
int V_222 ;
F_30 () ;
if ( V_223 ) {
