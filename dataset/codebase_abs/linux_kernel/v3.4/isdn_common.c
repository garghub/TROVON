...
case V_212 :
if ( V_66 ) {
if ( F_89 ( & V_201 , V_203 , sizeof( V_201 ) ) )
return - V_177 ;
return F_90 ( & V_201 , V_203 ) ;
} else
return - V_211 ;
#endif
default:
...
case V_215 :
if ( V_66 ) {
if ( F_89 ( V_198 , V_203 , sizeof( V_198 ) ) )
return - V_177 ;
V_8 = V_198 ;
} else {
V_8 = NULL ;
}
V_197 = F_91 ( & V_7 -> V_216 ) ;
...
case V_217 :
if ( V_66 ) {
if ( F_89 ( V_199 , V_203 , sizeof( V_199 ) - 1 ) )
return - V_177 ;
} else
return - V_211 ;
V_197 = F_91 ( & V_7 -> V_216 ) ;
...
case V_219 :
if ( V_66 ) {
if ( F_89 ( & V_202 , V_203 , sizeof( V_202 ) ) )
return - V_177 ;
return F_95 ( & V_202 ) ;
} else
return - V_211 ;
...
return - V_177 ;
for ( V_5 = 0 ; V_5 < V_25 ; V_5 ++ ) {
if ( F_89 ( V_7 -> V_238 . V_239 [ V_5 ] . V_240 . V_241 , V_9 ,
V_236 ) )
return - V_177 ;
V_9 += V_236 ;
if ( F_89 ( V_7 -> V_238 . V_239 [ V_5 ] . V_240 . V_243 , V_9 , V_237 ) )
return - V_177 ;
V_9 += V_237 ;
if ( F_89 ( V_7 -> V_238 . V_239 [ V_5 ] . V_240 . V_242 , V_9 , V_21 ) )
return - V_177 ;
V_9 += V_21 ;
}
return 0 ;
...
int V_5 ;
char * V_9 ;
if ( F_89 ( & V_200 , V_203 , sizeof( T_17 ) ) )
return - V_177 ;
V_200 . V_113 [ sizeof( V_200 . V_113 ) - 1 ] = 0 ;
if ( strlen ( V_200 . V_113 ) ) {
if ( ( V_9 = strchr ( V_200 . V_113 , ',' ) ) )
...
#ifdef F_76
if ( V_158 <= V_185 )
return ( F_105 ( V_158 - V_186 , V_163 , V_60 , V_66 ) ) ;
#endif
return - V_178 ;
#undef V_198
#undef V_199
...
static int
F_107 ( struct V_257 * V_258 , struct V_163 * V_259 )
{
...
static int
F_110 ( struct V_257 * V_258 , struct V_163 * V_259 )
{
T_14 V_158 = F_72 ( V_258 ) ;
F_73 ( & V_170 ) ;
if ( V_158 == V_171 ) {
...
int
F_113 ( int V_126 , int V_262 , int V_263 , int V_264
...
continue;
if ( ! strcmp ( F_112 ( V_109 , V_270 ) , L_22 ) )
continue;
...
struct V_54 * V_55 = F_118 ( V_277 + V_10 , V_279 ) ;
if ( ! V_55 )
return - V_181 ;
F_119 ( V_55 , V_277 ) ;
...
int
F_121 ( int V_168 , int V_276 , int V_281 , struct V_54 * V_55 )
{
int V_197 ;
...
if ( V_7 -> V_57 [ V_65 ] ) {
F_28 ( & V_7 -> V_58 [ V_65 ] ) ;
V_282 = F_122 ( V_7 -> V_57 [ V_65 ] , V_55 ) ;
F_30 ( & V_7 -> V_58 [ V_65 ] ) ;
if ( ! V_282 )
return 0 ;
...
F_50 ( V_270 -> V_131 ) ;
if ( ! ( V_270 -> V_131 = F_126 ( sizeof( int ) * V_289 , V_279 ) ) ) {
F_8 ( V_62 L_51 ) ;
return - 1 ;
}
if ( ( V_287 ) && ( V_270 -> V_132 ) )
F_50 ( V_270 -> V_132 ) ;
if ( ! ( V_270 -> V_132 = F_126 ( sizeof( int ) * V_289 , V_279 ) ) ) {
F_8 ( V_62 L_52 ) ;
if ( ! V_287 )
F_50 ( V_270 -> V_131 ) ;
return - 1 ;
...
for ( V_249 = 0 ; V_249 < V_289 ; V_249 ++ ) {
F_125 ( & V_270 -> V_59 [ V_249 ] ) ;
F_125 ( & V_270 -> V_89 [ V_249 ] ) ;
}
V_7 -> V_130 += V_286 ;
...
if ( ! ( V_270 = F_126 ( sizeof( T_1 ) , V_180 ) ) ) {
F_8 ( V_62 L_57 ) ;
return 0 ;
}
...
V_7 -> V_318 [ V_5 ] = - 1 ;
strcpy ( V_7 -> V_79 [ V_5 ] , L_46 ) ;
F_125 ( & V_7 -> V_238 . V_239 [ V_5 ] . V_319 ) ;
F_125 ( & V_7 -> V_238 . V_239 [ V_5 ] . V_320 ) ;
}
if ( F_139 ( V_321 , L_60 , & V_322 ) ) {
F_8 ( V_62 L_61 ) ;
F_140 ( V_7 ) ;
return - V_315 ;
}
...
#endif
strcpy ( V_313 , V_323 ) ;
F_8 ( V_324 L_64 , F_132 ( V_313 ) ) ;
strcpy ( V_313 , V_325 ) ;
F_8 ( L_65 , F_132 ( V_313 ) ) ;
strcpy ( V_313 , V_326 ) ;
F_8 ( L_65 , F_132 ( V_313 ) ) ;
strcpy ( V_313 , V_327 ) ;
F_8 ( L_65 , F_132 ( V_313 ) ) ;
