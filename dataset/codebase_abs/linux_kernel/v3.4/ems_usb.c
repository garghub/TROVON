...
{
int V_82 ;
memcpy ( & V_3 -> V_104 [ V_83 ] , V_17 ,
V_17 -> V_29 + V_90 ) ;
memset ( & V_3 -> V_104 [ 0 ] , 0 , V_83 ) ;
...
{
V_3 -> V_106 . V_17 . V_107 . V_108 . V_55 . V_105 = V_105 ;
...
V_115 = F_32 ( V_3 -> V_92 , V_133 , V_14 , & V_1 -> V_95 ) ;
if ( ! V_115 ) {
F_6 ( V_6 , L_8 ) ;
F_33 ( V_1 ) ;
goto V_136;
}
V_17 = (struct V_16 * ) & V_115 [ V_83 ] ;
V_17 -> V_17 . V_26 . V_27 = V_19 -> V_25 & V_137 ;
...
if ( ! V_4 ) {
F_35 ( V_1 ) ;
F_20 ( V_3 -> V_92 , V_133 , V_115 , V_1 -> V_95 ) ;
F_36 ( V_6 , L_14 ) ;
return V_143 ;
}
V_4 -> V_3 = V_3 ;
...
static int F_59 ( struct V_5 * V_6 , enum V_145 V_105 )
{
struct V_2 * V_3 = F_44 ( V_6 ) ;
if ( ! V_3 -> V_132 )
return - V_146 ;
...
{
struct V_2 * V_3 = F_44 ( V_6 ) ;
struct V_149 * V_150 = & V_3 -> V_42 . V_151 ;
T_1 V_152 , V_153 ;
V_152 = ( ( V_150 -> V_154 - 1 ) & 0x3f ) | ( ( ( V_150 -> V_155 - 1 ) & 0x3 ) << 6 ) ;
V_153 = ( ( V_150 -> V_156 + V_150 -> V_157 - 1 ) & 0xf ) |
( ( ( V_150 -> V_158 - 1 ) & 0x7 ) << 4 ) ;
if ( V_3 -> V_42 . V_159 & V_160 )
V_153 |= 0x80 ;
F_3 ( V_6 , L_18 , V_152 , V_153 ) ;
V_3 -> V_106 . V_17 . V_107 . V_108 . V_55 . V_152 = V_152 ;
V_3 -> V_106 . V_17 . V_107 . V_108 . V_55 . V_153 = V_153 ;
return F_25 ( V_3 , & V_3 -> V_106 ) ;
}
static void F_61 ( struct V_16 * V_17 )
{
struct V_161 * V_55 =
& V_17 -> V_17 . V_107 . V_108 . V_55 ;
V_17 -> type = V_162 ;
V_17 -> V_29 = sizeof( struct V_163 ) ;
V_17 -> V_112 = 0 ;
V_17 -> V_17 . V_107 . V_164 = V_165 ;
V_55 -> V_166 = 0x00 ;
V_55 -> V_167 = 0x00 ;
V_55 -> V_168 = 0x00 ;
V_55 -> V_169 = 0x00 ;
...
V_3 -> V_6 = V_6 ;
V_3 -> V_42 . V_39 = V_179 ;
V_3 -> V_42 . clock . V_180 = V_181 ;
V_3 -> V_42 . V_182 = & V_183 ;
V_3 -> V_42 . V_184 = F_60 ;
V_3 -> V_42 . V_185 = F_59 ;
V_3 -> V_42 . V_186 = V_160 ;
V_6 -> V_187 = & V_188 ;
V_6 -> V_189 |= V_190 ;
F_66 ( & V_3 -> V_120 ) ;
F_66 ( & V_3 -> V_129 ) ;
