...
V_6 = F_22 ( sizeof *V_6 , V_54 ) ;
if ( ! V_6 )
return - V_55 ;
if ( ! F_23 ( & V_47 -> V_2 ) )
F_24 ( & V_47 -> V_2 , 1 ) ;
F_25 ( V_47 , V_6 ) ;
V_6 -> V_56 = F_26 ( V_49 -> V_57 , F_27 ( V_49 ) ) ;
if ( ! V_6 -> V_56 ) {
F_21 ( & V_47 -> V_2 , L_12 ) ;
V_51 = - V_55 ;
goto V_58;
}
V_6 -> V_59 = F_26 ( V_50 -> V_57 , F_27 ( V_50 ) ) ;
if ( ! V_6 -> V_59 ) {
F_21 ( & V_47 -> V_2 , L_13 ) ;
V_51 = - V_55 ;
goto V_60;
...
V_20 &= ~ ( V_22 | V_23 ) ;
F_9 ( V_6 , V_21 , V_20 ) ;
V_6 -> V_43 = F_28 ( V_47 -> V_63 , & V_47 -> V_2 ,
& V_64 , V_65 ) ;
if ( F_29 ( V_6 -> V_43 ) ) {
V_51 = F_30 ( V_6 -> V_43 ) ;
goto V_66;
...
struct V_5 * V_6 = F_38 ( V_47 ) ;
T_1 V_20 = F_4 ( V_6 , V_21 ) ;
V_6 -> V_69 = V_20 & ( V_22 | V_23 ) ;
F_9 ( V_6 , V_21 , V_20 & ~ V_6 -> V_69 ) ;
}
