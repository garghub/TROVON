...
int F_61 ( struct V_1 * V_2 , int V_86 ,
struct V_122 * V_123 ,
struct V_45 * V_88 ,
struct V_45 * V_124 ,
struct V_125 * V_126 )
...
int F_62 ( struct V_1 * V_2 , T_1 V_18 ,
T_2 V_19 , T_2 V_153 , T_1 V_154 )
{
return F_31 ( V_2 , ( V_19 | ( V_153 << 63 ) ) , V_18 , V_154 ,
V_155 , V_53 ,
V_65 ) ;
}
int F_63 ( struct V_1 * V_2 , int V_86 ,
struct V_122 * V_123 ,
struct V_45 * V_88 ,
struct V_45 * V_124 ,
struct V_125 * V_126 )
...
int F_65 ( struct V_1 * V_2 , int V_86 ,
struct V_122 * V_123 ,
struct V_45 * V_88 ,
struct V_45 * V_124 ,
struct V_125 * V_126 )
...
if ( V_86 != V_2 -> V_11 . V_110 )
return 0 ;
return F_64 ( V_2 , V_86 ,
V_123 -> V_103 , V_124 ) ;
}
void F_66 ( struct V_1 * V_2 , T_2 * V_157 )
{
if ( ! F_37 ( V_2 ) ) {
* V_157 = 0 ;
return;
