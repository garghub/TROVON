...
int F_99 ( struct V_309 * V_264 , char * V_317 , char * * V_318 , T_7 V_145 ,
int V_28 , int V_319 )
{
int V_320 , V_321 = 0 , V_322 ;
struct V_323 * V_324 ;
T_1 * V_1 ;
char * V_310 = V_317 ;
if ( V_319 == 1 )
...
V_310 += sprintf ( V_310 , L_111 ,
V_1 -> V_4 + V_5 , V_1 -> V_22 . V_100 ) ;
#ifdef F_23
V_310 += sprintf ( V_310 , L_112 ,
V_1 -> V_4 + V_325 , V_1 -> V_22 . V_100 ) ;
#endif
V_310 += sprintf ( V_310 , L_113
L_114
L_115
L_116
L_117
...
V_1 -> V_170 . V_307 ) ;
for ( V_322 = 0 ; V_322 < 9 ; V_322 ++ ) {
unsigned int V_326 , V_93 ;
V_310 += sprintf ( V_310 , L_119 , V_322 == 8 ? 'H' : ( '0' + V_322 ) ) ;
V_326 = V_1 -> V_94 [ V_322 ] - 10 ;
if ( ( signed int ) V_326 < 0 )
V_326 += V_96 ;
V_93 = V_1 -> V_97 [ V_322 ] [ V_326 ] . V_98 ;
for (; V_326 != V_1 -> V_94 [ V_322 ] ; V_326 = ( V_326 + 1 ) & ( V_96 - 1 ) ) {
if ( V_1 -> V_97 [ V_322 ] [ V_326 ] . V_98 ) {
V_310 += sprintf ( V_310 , L_120 ,
V_1 -> V_97 [ V_322 ] [ V_326 ] . V_100 ? '-' : ' ' ,
V_1 -> V_97 [ V_322 ] [ V_326 ] . V_101 ,
V_1 -> V_97 [ V_322 ] [ V_326 ] . V_82 ,
( V_1 -> V_97 [ V_322 ] [ V_326 ] . V_98 - V_93 ) < 100 ?
( V_1 -> V_97 [ V_322 ] [ V_326 ] . V_98 - V_93 ) : 99 ) ;
V_93 = V_1 -> V_97 [ V_322 ] [ V_326 ] . V_98 ;
}
}
}
V_310 += sprintf ( V_310 , L_121 ) ;
F_100 (scd, instance) {
V_310 += sprintf ( V_310 , L_122 ) ;
V_310 += sprintf ( V_310 , L_123 , V_324 -> V_102 , V_324 -> V_169 ) ;
if ( V_324 -> V_327 )
V_310 += sprintf ( V_310 , L_124 ,
V_324 -> V_166 ? L_125 : L_126 ,
V_324 -> V_167 ) ;
else
V_310 += sprintf ( V_310 , L_127 ) ;
if ( V_1 -> V_78 [ V_324 -> V_102 ] . V_254 & 15 )
V_310 += sprintf ( V_310 , L_128 ,
V_1 -> V_78 [ V_324 -> V_102 ] . V_254 & 15 ,
F_32 ( V_1 -> V_78 [ V_324 -> V_102 ] . V_254 ) ) ;
else
V_310 += sprintf ( V_310 , L_129 ) ;
V_320 = V_310 - V_317 ;
if ( V_320 + V_321 < V_145 ) {
V_321 += V_320 ;
V_310 = V_317 ;
}
V_320 = V_310 - V_317 ;
if ( V_320 + V_321 > V_145 + V_28 ) {
F_101 ( V_324 ) ;
break;
}
}
V_320 = V_310 - V_317 ;
* V_318 = V_317 + ( V_145 - V_321 ) ;
V_320 -= V_145 - V_321 ;
if ( V_320 > V_28 )
V_320 = V_28 ;
return V_320 ;
...
static int T_8
F_102 ( struct V_328 * V_329 , const struct V_330 * V_102 )
{
struct V_309 * V_1 ;
T_1 * V_331 ;
int V_288 ;
...
if ( V_288 )
goto V_332;
V_1 = F_104 ( & V_333 , sizeof( T_1 ) ) ;
if ( ! V_1 ) {
V_288 = - V_334 ;
goto V_335;
}
V_331 = ( T_1 * ) V_1 -> V_291 ;
V_331 -> V_4 = F_105 ( V_329 , V_336 , 0 , 0 ) ;
V_331 -> V_46 = F_105 ( V_329 , V_337 , 0 , 0 ) ;
if ( ! V_331 -> V_4 || ! V_331 -> V_46 )
goto V_338;
V_1 -> V_100 = V_329 -> V_100 ;
V_331 -> V_1 = V_1 ;
V_331 -> V_22 . V_100 = V_1 -> V_100 ;
V_329 -> V_339 = V_331 -> V_46 + V_48 ;
V_329 -> V_340 = 0x0a ;
V_288 = F_106 ( V_1 -> V_100 , F_86 , V_341 , L_130 , V_331 ) ;
if ( V_288 ) {
F_8 ( V_54 L_131 ,
V_1 -> V_18 , V_331 -> V_22 . V_100 , V_288 ) ;
goto V_338;
}
memset ( & V_331 -> V_170 , 0 , sizeof ( V_331 -> V_170 ) ) ;
F_107 ( & V_331 -> V_150 . V_151 ) ;
F_107 ( & V_331 -> V_150 . V_153 ) ;
F_108 ( & V_331 -> V_22 . V_225 ) ;
F_20 ( V_331 ) ;
V_288 = F_109 ( V_1 , & V_329 -> V_342 ) ;
if ( V_288 )
goto V_343;
F_110 ( V_1 ) ;
goto V_332;
V_343:
F_111 ( V_1 -> V_100 , V_331 ) ;
F_112 ( & V_331 -> V_22 . V_225 ) ;
F_113 ( & V_331 -> V_150 . V_153 ) ;
F_113 ( & V_331 -> V_150 . V_151 ) ;
V_338:
F_114 ( V_329 , V_331 -> V_46 ) ;
F_114 ( V_329 , V_331 -> V_4 ) ;
F_115 ( V_1 ) ;
V_335:
F_116 ( V_329 ) ;
V_332:
...
static void T_9 F_117 ( struct V_328 * V_329 )
{
struct V_309 * V_1 = F_118 ( V_329 ) ;
T_1 * V_331 = ( T_1 * ) V_1 -> V_291 ;
F_119 ( V_329 , NULL ) ;
F_120 ( V_1 ) ;
F_2 ( 0x80 , V_331 -> V_46 + V_47 ) ;
F_111 ( V_1 -> V_100 , V_331 ) ;
F_112 ( & V_331 -> V_22 . V_225 ) ;
F_113 ( & V_331 -> V_150 . V_153 ) ;
F_113 ( & V_331 -> V_150 . V_151 ) ;
