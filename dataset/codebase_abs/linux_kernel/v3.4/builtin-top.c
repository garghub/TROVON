...
if ( V_147 . V_157 ) {
V_18 = F_68 ( V_12 -> V_158 , & V_53 -> V_58 . V_160 ,
V_57 -> V_59 ) ;
if ( V_18 )
return;
}
...
V_181 -> V_195 = 1 ;
V_181 -> V_196 = 1 ;
V_181 -> V_197 = V_7 -> V_197 ;
V_198:
if ( V_7 -> V_199 )
V_181 -> V_200 = V_181 -> V_201 = 0 ;
V_202:
V_181 -> V_203 = V_7 -> V_204 ? 0 : 1 ;
V_205:
if ( F_78 ( V_43 , V_7 -> V_89 -> V_206 ,
V_7 -> V_89 -> V_207 , V_7 -> V_184 ,
V_183 ) < 0 ) {
int V_18 = V_127 ;
if ( V_18 == V_208 || V_18 == V_209 ) {
F_79 () ;
goto V_210;
} else if ( V_18 == V_211 ) {
if ( ! V_7 -> V_199 &&
( V_181 -> V_200 || V_181 -> V_201 ) ) {
F_80 ( L_74
L_75 ) ;
V_7 -> V_199 = true ;
goto V_198;
...
if ( F_81 ( V_89 , V_7 -> V_220 , false ) < 0 ) {
F_18 ( L_86 ,
...
T_7 V_159 ;
int V_164 ;
V_7 -> V_118 = F_85 ( NULL , V_225 , false , false , NULL ) ;
if ( V_7 -> V_118 == NULL )
return - V_226 ;
V_164 = F_82 ( V_7 ) ;
if ( V_164 )
goto V_227;
if ( V_7 -> V_228 || V_7 -> V_229 != V_230 )
F_86 ( & V_7 -> V_134 , V_7 -> V_89 -> V_207 ,
F_75 ,
& V_7 -> V_118 -> V_231 ) ;
else
F_87 ( & V_7 -> V_134 , F_75 ,
...
F_88 ( V_7 -> V_118 ) ;
F_52 ( V_7 -> V_89 -> V_93 , V_7 -> V_89 -> V_232 , 100 ) ;
F_76 ( V_7 ) ;
if ( F_89 ( & V_159 , NULL , ( V_41 > 0 ? F_57 :
F_60 ) , V_7 ) ) {
printf ( L_89 ) ;
exit ( - 1 ) ;
}
if ( V_7 -> V_233 ) {
struct V_234 V_235 ;
V_235 . V_236 = V_7 -> V_233 ;
if ( F_90 ( 0 , V_237 , & V_235 ) ) {
printf ( L_90 ) ;
exit ( - 1 ) ;
}
}
...
F_76 ( V_7 ) ;
if ( V_238 == V_7 -> V_167 )
V_164 = F_52 ( V_7 -> V_89 -> V_93 , V_7 -> V_89 -> V_232 , 100 ) ;
}
V_227:
F_91 ( V_7 -> V_118 ) ;
V_7 -> V_118 = NULL ;
...
static int
F_92 ( const struct V_239 * V_240 , const char * V_10 , int V_241 )
{
struct V_6 * V_7 = (struct V_6 * ) V_240 -> V_242 ;
char * V_243 , * V_244 ;
char * V_245 ;
if ( V_241 ) {
V_7 -> V_221 = true ;
...
if ( ! V_10 )
return 0 ;
V_243 = strtok ( ( char * ) V_10 , L_91 ) ;
if ( ! V_243 )
return - 1 ;
if ( ! strncmp ( V_243 , L_92 , strlen ( V_10 ) ) )
V_222 . V_223 = V_246 ;
else if ( ! strncmp ( V_243 , L_93 , strlen ( V_10 ) ) )
V_222 . V_223 = V_247 ;
else if ( ! strncmp ( V_243 , L_94 , strlen ( V_10 ) ) )
V_222 . V_223 = V_248 ;
else if ( ! strncmp ( V_243 , L_95 , strlen ( V_10 ) ) ) {
V_222 . V_223 = V_224 ;
V_147 . V_157 = false ;
return 0 ;
} else
return - 1 ;
V_243 = strtok ( NULL , L_91 ) ;
if ( ! V_243 )
goto V_249;
V_222 . V_250 = strtod ( V_243 , & V_245 ) ;
if ( V_243 == V_245 )
return - 1 ;
...
goto V_249;
if ( V_244 [ 0 ] != 'c' ) {
V_222 . V_251 = strtod ( V_244 , & V_245 ) ;
V_244 = strtok ( NULL , L_91 ) ;
if ( ! V_244 )
goto V_249;
}
if ( ! strcmp ( V_244 , L_96 ) )
V_222 . V_252 = V_253 ;
else if ( ! strcmp ( V_244 , L_97 ) )
V_222 . V_252 = V_254 ;
else
return - 1 ;
V_249:
...
int F_93 ( int V_255 , const char * * V_256 , const char * T_8 V_9 )
{
struct V_52 * V_121 ;
int V_257 = - V_226 ;
struct V_6 V_7 = {
...
char V_258 [] = L_99 ;
const struct V_239 V_259 [] = {
F_94 ( 'e' , L_100 , & V_7 . V_89 , L_100 ,
L_101 ,
V_260 ) ,
F_95 ( 'c' , L_102 , & V_7 . V_261 ,
L_103 ) ,
F_96 ( 'p' , L_104 , & V_7 . V_262 , L_104 ,
L_105 ) ,
F_96 ( 't' , L_106 , & V_7 . V_228 , L_106 ,
L_107 ) ,
F_97 ( 'a' , L_108 , & V_7 . V_263 ,
L_109 ) ,
F_96 ( 'C' , L_110 , & V_7 . V_264 , L_110 ,
L_111 ) ,
F_96 ( 'k' , L_112 , & V_147 . V_155 ,
L_113 , L_114 ) ,
F_97 ( 'K' , L_115 , & V_7 . V_72 ,
L_116 ) ,
F_98 ( 'm' , L_117 , & V_7 . V_220 , L_118 ) ,
F_95 ( 'r' , L_119 , & V_7 . V_233 ,
L_120 ) ,
F_95 ( 'd' , L_121 , & V_7 . V_88 ,
L_122 ) ,
F_97 ( 'D' , L_123 , & V_7 . V_117 ,
L_124 ) ,
F_95 ( 'f' , L_125 , & V_7 . V_91 ,
L_126 ) ,
F_97 ( 'g' , L_127 , & V_7 . V_184 ,
L_128 ) ,
F_97 ( 'i' , L_129 , & V_7 . V_197 ,
L_130 ) ,
F_96 ( 0 , L_131 , & V_7 . V_265 , L_132 ,
L_133 ) ,
F_97 ( 'z' , L_134 , & V_7 . V_51 ,
L_135 ) ,
F_95 ( 'F' , L_136 , & V_7 . V_188 ,
L_137 ) ,
F_95 ( 'E' , L_138 , & V_7 . V_8 ,
L_139 ) ,
F_97 ( 'U' , L_140 , & V_7 . V_71 ,
L_141 ) ,
F_97 ( 0 , L_142 , & V_7 . V_266 , L_143 ) ,
F_97 ( 0 , L_144 , & V_7 . V_267 , L_145 ) ,
F_99 ( 'v' , L_146 , & V_215 ,
L_147 ) ,
F_96 ( 's' , L_148 , & V_268 , L_149 ,
L_150 ) ,
F_97 ( 'n' , L_151 , & V_147 . V_269 ,
L_152 ) ,
F_100 ( 'G' , L_153 , & V_7 , L_154 ,
L_155
L_156 , & F_92 ,
V_258 ) ,
F_97 ( 0 , L_157 , & V_147 . V_270 ,
L_158 ) ,
F_96 ( 0 , L_159 , & V_147 . V_271 , L_160 ,
L_161 ) ,
F_96 ( 0 , L_162 , & V_147 . V_272 , L_163 ,
L_164 ) ,
F_96 ( 0 , L_165 , & V_147 . V_273 , L_166 ,
L_167 ) ,
F_97 ( 0 , L_168 , & V_147 . V_274 ,
L_169 ) ,
F_97 ( 0 , L_170 , & V_147 . V_275 ,
L_171 ) ,
F_96 ( 'M' , L_172 , & V_276 , L_173 ,
L_174 ) ,
F_96 ( 'u' , L_175 , & V_7 . V_124 , L_176 , L_177 ) ,
F_101 ()
} ;
V_7 . V_89 = F_102 ( NULL , NULL ) ;
if ( V_7 . V_89 == NULL )
return - V_226 ;
V_147 . V_277 = false ;
V_255 = F_103 ( V_255 , V_256 , V_259 , V_278 , 0 ) ;
if ( V_255 )
F_104 ( V_278 , V_259 ) ;
if ( V_268 == V_279 )
V_268 = L_178 ;
...
V_41 = 1 ;
F_106 ( false ) ;
V_7 . V_229 = F_107 ( V_7 . V_124 , V_7 . V_228 , V_7 . V_262 ) ;
if ( V_7 . V_124 != NULL && V_7 . V_229 == V_230 - 1 )
goto V_280;
if ( V_7 . V_228 && V_7 . V_264 ) {
printf ( L_179 ) ;
F_8 ( 1 ) ;
V_7 . V_264 = NULL ;
}
if ( V_7 . V_262 )
V_7 . V_228 = V_7 . V_262 ;
if ( F_108 ( V_7 . V_89 , V_7 . V_262 ,
V_7 . V_228 , V_7 . V_229 , V_7 . V_264 ) < 0 )
F_104 ( V_278 , V_259 ) ;
if ( ! V_7 . V_89 -> V_90 &&
F_109 ( V_7 . V_89 ) < 0 ) {
F_7 ( L_180 ) ;
...
F_53 (pos, &top.evlist->entries, node) {
if ( ! V_121 -> V_181 . V_282 )
V_121 -> V_181 . V_282 = V_7 . V_261 ;
}
V_7 . V_48 = F_54 ( V_7 . V_89 -> V_86 . V_85 , struct V_52 , V_116 ) ;
V_147 . V_283 = sizeof( struct V_15 ) ;
V_147 . V_284 = ( V_147 . V_155 == NULL ) ;
if ( F_110 () < 0 )
return - 1 ;
F_111 ( & V_285 , V_147 . V_286 , L_182 , stdout ) ;
F_111 ( & V_287 , V_147 . V_288 , L_183 , stdout ) ;
F_111 ( & V_289 , V_147 . V_290 , L_184 , stdout ) ;
V_7 . V_161 = V_289 . V_291 . V_85 != NULL ;
F_1 ( & V_7 . V_1 ) ;
if ( V_7 . V_8 == 0 ) {
struct V_109 V_110 = {
. V_111 = F_5 ,
