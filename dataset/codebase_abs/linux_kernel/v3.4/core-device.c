...
if ( F_31 ( V_42 , V_55 , V_16 , & V_95 [ V_16 ] ) != V_101 )
goto V_102;
...
V_16 ++ ;
for (; V_16 < V_4 ; V_16 ++ ) {
if ( F_31 ( V_42 , V_55 , V_16 , & V_95 [ V_16 ] ) !=
V_101 )
goto V_102;
...
F_42 ( V_93 ) ;
V_64 = 0 ;
V_42 -> V_108 = V_95 [ 2 ] >> 12 & 0xf ;
V_42 -> V_109 = V_95 [ 2 ] >> 30 & 1 ;
V_42 -> V_110 = V_95 [ 2 ] >> 31 & 1 ;
V_102:
F_42 ( V_95 ) ;
return V_64 ;
}
...
V_28 -> V_42 . V_112 = & V_113 ;
V_28 -> V_42 . type = & V_111 ;
...
struct V_54 * F_54 ( T_5 V_116 )
{
struct V_54 * V_42 ;
F_20 ( & V_65 ) ;
V_42 = F_55 ( & V_117 , F_56 ( V_116 ) ) ;
if ( V_42 )
F_51 ( V_42 ) ;
F_21 ( & V_65 ) ;
return V_42 ;
...
unsigned long V_118 )
{
F_58 ( V_119 , & V_42 -> V_120 , V_118 ) ;
}
static void F_59 ( struct V_121 * V_120 )
{
struct V_54 * V_42 =
F_12 ( V_120 , struct V_54 , V_120 . V_120 ) ;
int V_122 = F_56 ( V_42 -> V_42 . V_116 ) ;
if ( F_60 ( F_61 () ,
V_42 -> V_56 -> V_123 + V_124 )
&& ! F_62 ( & V_42 -> V_56 -> V_125 ) ) {
F_57 ( V_42 , V_124 ) ;
return;
}
if ( F_63 ( & V_42 -> V_126 ,
...
static void F_76 ( struct V_121 * V_120 )
{
struct V_54 * V_42 =
F_12 ( V_120 , struct V_54 , V_120 . V_120 ) ;
F_77 ( V_42 ) ;
...
V_127 ,
V_135 ) == V_127 ) {
struct V_136 * V_137 = V_134 -> V_103 ;
struct V_136 * V_138 = V_133 -> V_103 ;
V_134 -> V_103 = V_138 ;
V_134 -> V_103 -> V_84 = V_134 ;
V_133 -> V_103 = V_137 ;
V_133 -> V_103 -> V_84 = V_133 ;
...
static void F_88 ( struct V_121 * V_120 )
{
struct V_54 * V_42 =
F_12 ( V_120 , struct V_54 , V_120 . V_120 ) ;
struct V_92 * V_56 = V_42 -> V_56 ;
...
F_81 ( V_56 , L_13 ,
V_42 -> V_58 ) ;
if ( V_42 -> V_103 == V_56 -> V_140 )
F_83 ( V_56 , 0 ) ;
F_67 ( & V_42 -> V_42 ) ;
}
return;
}
V_152 = F_90 ( V_56 -> V_42 ,
V_42 , F_78 ) ;
if ( V_152 ) {
F_91 ( V_152 ) ;
F_67 ( & V_42 -> V_42 ) ;
...
F_51 ( V_42 ) ;
F_40 ( & V_65 ) ;
V_64 = F_93 ( & V_117 , V_99 ) ?
F_94 ( & V_117 , V_42 , & V_122 ) :
- V_53 ;
F_41 ( & V_65 ) ;
if ( V_64 < 0 )
goto error;
V_42 -> V_42 . V_112 = & V_113 ;
V_42 -> V_42 . type = & V_131 ;
V_42 -> V_42 . V_79 = V_56 -> V_42 ;
V_42 -> V_42 . V_116 = F_95 ( V_157 , V_122 ) ;
F_47 ( & V_42 -> V_42 , L_14 , V_122 ) ;
...
if ( F_31 ( V_42 , V_55 , V_16 , & V_160 ) != V_101 )
return V_161 ;
if ( V_16 == 0 && V_160 == 0 )
return V_162 ;
...
static void F_98 ( struct V_121 * V_120 )
{
struct V_54 * V_42 =
F_12 ( V_120 , struct V_54 , V_120 . V_120 ) ;
struct V_92 * V_56 = V_42 -> V_56 ;
...
void F_101 ( struct V_92 * V_56 , struct V_136 * V_103 , int V_169 )
{
struct V_54 * V_42 ;
switch ( V_169 ) {
case V_170 :
V_171:
V_42 = F_46 ( sizeof( * V_42 ) , V_172 ) ;
if ( V_42 == NULL )
break;
F_100 ( & V_42 -> V_126 , V_154 ) ;
V_42 -> V_56 = F_102 ( V_56 ) ;
V_42 -> V_103 = F_103 ( V_103 ) ;
V_42 -> V_58 = V_103 -> V_58 ;
V_42 -> V_55 = V_56 -> V_55 ;
V_42 -> V_173 = V_103 == V_56 -> V_174 ;
F_104 ( & V_42 -> V_175 ) ;
F_105 ( & V_42 -> V_176 ) ;
V_103 -> V_84 = V_42 ;
F_106 ( & V_42 -> V_120 , F_88 ) ;
F_57 ( V_42 , V_177 ) ;
break;
case V_178 :
case V_179 :
...
F_80 () ;
V_42 -> V_55 = V_56 -> V_55 ;
if ( F_89 ( & V_42 -> V_126 ) == V_135 ) {
F_82 ( & V_42 -> V_120 , F_76 ) ;
F_57 ( V_42 , 0 ) ;
}
break;
case V_181 :
