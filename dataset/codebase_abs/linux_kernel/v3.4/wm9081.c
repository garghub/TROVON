...
F_17 ( V_66 -> V_2 , L_16 ,
V_126 [ V_178 ] . V_91 ) ;
V_181 |= ( V_126 [ V_178 ] . V_198
<< V_199 ) ;
V_178 = 0 ;
V_179 = abs ( V_97 -> V_127 - V_200 [ 0 ] . V_201 ) ;
for ( V_84 = 1 ; V_84 < F_13 ( V_200 ) ; V_84 ++ ) {
V_180 = abs ( V_97 -> V_127 - V_200 [ V_84 ] . V_201 ) ;
if ( V_180 < V_179 ) {
V_178 = V_84 ;
V_179 = V_180 ;
}
...
F_17 ( V_66 -> V_2 , L_17 ,
V_200 [ V_178 ] . V_201 ) ;
V_181 |= ( V_200 [ V_178 ] . V_202
<< V_203 ) ;
V_178 = 0 ;
V_179 = V_204 ;
for ( V_84 = 0 ; V_84 < F_13 ( V_205 ) ; V_84 ++ ) {
V_180 = ( ( V_97 -> V_123 * 10 ) / V_205 [ V_84 ] . div )
- V_97 -> V_125 ;
if ( V_180 < 0 )
break;
if ( V_180 < V_179 ) {
...
V_97 -> V_125 = ( V_97 -> V_123 * 10 ) / V_205 [ V_178 ] . div ;
F_17 ( V_66 -> V_2 , L_18 ,
V_205 [ V_178 ] . div , V_97 -> V_125 ) ;
V_183 |= V_205 [ V_178 ] . V_206 ;
F_17 ( V_66 -> V_2 , L_19 , V_97 -> V_125 / V_97 -> V_127 ) ;
V_184 |= V_97 -> V_125 / V_97 -> V_127 ;
if ( V_97 -> V_207 . V_208 ) {
struct V_209 * V_207 = & V_97 -> V_207 ;
struct V_210 * V_211 ;
int V_212 ;
V_178 = 0 ;
V_179 = abs ( V_207 -> V_213 [ 0 ] . V_201 - V_97 -> V_127 ) ;
for ( V_84 = 0 ; V_84 < V_207 -> V_208 ; V_84 ++ ) {
V_180 = abs ( V_207 -> V_213 [ V_84 ] . V_201 -
V_97 -> V_127 ) ;
if ( V_180 < V_179 ) {
V_179 = V_180 ;
V_178 = V_84 ;
...
V_211 = & V_207 -> V_213 [ V_178 ] ;
F_17 ( V_66 -> V_2 , L_20 ,
V_211 -> V_214 , V_211 -> V_201 ) ;
V_212 = F_7 ( V_66 , V_39 ) & V_215 ;
if ( V_212 & V_215 )
F_9 ( V_66 , V_39 , 0 ) ;
for ( V_84 = 1 ; V_84 < F_13 ( V_211 -> V_216 ) ; V_84 ++ )
F_9 ( V_66 , V_39 + V_84 , V_211 -> V_216 [ V_84 ] ) ;
V_212 |= ( V_211 -> V_216 [ 0 ] & ~ V_215 ) ;
F_9 ( V_66 , V_39 , V_212 ) ;
}
F_9 ( V_66 , V_16 , V_181 ) ;
F_9 ( V_66 , V_24 , V_152 ) ;
...
static int F_30 ( struct V_149 * V_217 , int V_218 )
{
struct V_65 * V_66 = V_217 -> V_66 ;
unsigned int V_3 ;
V_3 = F_7 ( V_66 , V_31 ) ;
if ( V_218 )
V_3 |= V_219 ;
...
static int F_31 ( struct V_65 * V_66 , int V_220 ,
int V_221 , unsigned int V_222 , int V_223 )
{
struct V_96 * V_97 = F_16 ( V_66 ) ;
switch ( V_220 ) {
case V_121 :
...
unsigned int V_224 , unsigned int V_225 , int V_191 , int V_226 )
{
struct V_65 * V_66 = V_150 -> V_66 ;
struct V_96 * V_97 = F_16 ( V_66 ) ;
...
struct V_96 * V_97 = F_16 ( V_66 ) ;
int V_101 ;
V_66 -> V_228 = V_97 -> V_59 ;
V_101 = F_34 ( V_66 , 8 , 16 , V_229 ) ;
if ( V_101 != 0 ) {
F_18 ( V_66 -> V_2 , L_21 , V_101 ) ;
return V_101 ;
}
F_19 ( V_66 , V_6 ,
V_230 , V_230 ) ;
...
static T_3 int F_37 ( struct V_233 * V_234 ,
const struct V_235 * V_236 )
{
struct V_96 * V_97 ;
unsigned int V_3 ;
int V_101 ;
V_97 = F_38 ( & V_234 -> V_2 , sizeof( struct V_96 ) ,
V_237 ) ;
if ( V_97 == NULL )
return - V_238 ;
F_39 ( V_234 , V_97 ) ;
V_97 -> V_59 = F_40 ( V_234 , & V_239 ) ;
if ( F_41 ( V_97 -> V_59 ) ) {
V_101 = F_42 ( V_97 -> V_59 ) ;
F_18 ( & V_234 -> V_2 , L_23 , V_101 ) ;
goto V_240;
}
V_101 = F_43 ( V_97 -> V_59 , V_4 , & V_3 ) ;
if ( V_101 != 0 ) {
F_18 ( & V_234 -> V_2 , L_24 , V_101 ) ;
goto V_241;
}
if ( V_3 != 0x9081 ) {
F_18 ( & V_234 -> V_2 , L_25 , V_3 ) ;
V_101 = - V_72 ;
goto V_241;
}
V_101 = F_3 ( V_97 -> V_59 ) ;
...
if ( F_44 ( & V_234 -> V_2 ) )
memcpy ( & V_97 -> V_207 , F_44 ( & V_234 -> V_2 ) ,
sizeof( V_97 -> V_207 ) ) ;
V_3 = 0 ;
if ( V_97 -> V_207 . V_242 )
V_3 |= V_243 ;
...
static T_4 int F_48 ( struct V_233 * V_248 )
{
struct V_96 * V_97 = F_49 ( V_248 ) ;
F_50 ( & V_248 -> V_2 ) ;
F_47 ( V_97 -> V_59 ) ;
return 0 ;
}
