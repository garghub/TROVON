...
V_4 -> V_14 = V_14 ;
V_4 -> V_39 = V_39 ;
snprintf ( V_4 -> V_156 , sizeof( V_4 -> V_156 ) , L_13 ,
V_160 [ V_2 -> V_8 ] . V_156 ) ;
snprintf ( V_4 -> V_161 , sizeof( V_4 -> V_161 ) , L_14 ,
F_43 ( V_2 -> V_162 ) ) ;
V_66 -> V_43 = V_2 ;
V_66 -> V_163 = F_37 ;
V_66 -> V_164 = F_38 ;
...
F_50 ( V_183 . type , L_16 , V_190 ) ;
switch ( V_2 -> V_8 ) {
case V_191 :
case V_192 :
V_2 -> V_189 . V_156 = L_17 ;
if ( V_193 == 0 ) {
V_2 -> V_189 . V_194 = F_22 ;
...
case V_219 :
case V_220 :
V_2 -> V_189 . V_156 = L_25 ;
V_2 -> V_189 . V_194 = F_18 ;
V_2 -> V_189 . V_67 = V_221 ;
V_2 -> V_189 . type = V_222 ;
V_183 . V_30 = 0x2d ;
break;
case V_223 :
case V_224 :
...
if ( V_2 -> V_189 . V_156 )
V_183 . V_226 = & V_2 -> V_189 ;
F_52 ( & V_2 -> V_202 , & V_183 ) ;
}
...
F_3 ( V_11 , V_12 ) ;
F_2 ( V_11 , V_12 ) ;
V_228 = F_4 ( V_13 >> 2 ) & V_4 -> V_18 ;
F_53 ( V_2 -> V_5 -> V_2 , V_228 ? V_229 : V_230 ) ;
if ( ! V_4 -> V_42 ) {
V_227 = V_41 + F_27 ( 15 ) ;
F_26 ( & V_4 -> V_40 , V_227 ) ;
V_4 -> V_42 = true ;
