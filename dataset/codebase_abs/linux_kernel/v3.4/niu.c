...
V_584 = V_583 ;
while ( V_584 -- ) {
V_570 += V_493 -> V_566 [ V_585 ] . V_484 -> V_490 ;
V_585 = F_207 ( V_4 , V_493 , V_585 ) ;
}
V_493 -> V_585 = V_585 ;
F_215 () ;
F_216 ( V_582 , V_583 , V_570 ) ;
V_217:
if ( F_70 ( F_217 ( V_582 ) &&
...
T_1 V_609 ;
#if 1
V_609 = F_16 ( F_229 ( V_493 -> V_520 ) ) ;
V_604 = F_16 ( F_230 ( V_493 -> V_520 ) ) & V_610 ;
#else
...
( ( T_1 ) V_606 << V_616 ) |
( ( T_1 ) V_605 << V_617 ) ) ;
F_18 ( F_229 ( V_493 -> V_520 ) , V_609 ) ;
if ( V_604 > 10 )
F_224 ( V_4 , V_493 , 0x7FFF ) ;
return V_606 ;
}
static int F_232 ( struct V_3 * V_4 , struct V_12 * V_13 , int V_603 )
{
...
static int F_235 ( struct V_534 * V_535 , int V_603 )
{
struct V_12 * V_13 = F_236 ( V_535 , struct V_12 , V_535 ) ;
struct V_3 * V_4 = V_13 -> V_4 ;
int V_606 ;
V_606 = F_232 ( V_4 , V_13 , V_603 ) ;
if ( V_606 < V_603 ) {
F_237 ( V_535 ) ;
F_19 ( V_4 , V_13 , 1 ) ;
}
...
{
T_1 V_609 = F_16 ( F_229 ( V_493 -> V_520 ) ) ;
int V_10 = 0 ;
if ( V_609 & ( V_641 |
V_642 ) )
V_10 = - V_21 ;
...
F_238 ( V_4 , V_493 , V_609 ) ;
}
F_18 ( F_229 ( V_493 -> V_520 ) ,
V_609 & V_643 ) ;
return V_10 ;
}
static void F_241 ( struct V_3 * V_4 , struct V_563 * V_493 ,
T_1 V_586 )
{
...
static int F_242 ( struct V_3 * V_4 , struct V_563 * V_493 )
{
T_1 V_586 , V_652 , V_653 ;
V_586 = F_16 ( F_243 ( V_493 -> V_623 ) ) ;
V_652 = F_16 ( F_244 ( V_493 -> V_623 ) ) ;
V_653 = F_16 ( F_245 ( V_493 -> V_623 ) ) ;
F_10 ( V_4 -> V_11 , L_61 ,
V_493 -> V_623 ,
( unsigned long long ) V_586 ,
( unsigned long long ) V_652 ,
( unsigned long long ) V_653 ) ;
F_241 ( V_4 , V_493 , V_586 ) ;
return - V_8 ;
}
...
static void F_250 ( struct V_3 * V_4 , T_1 V_609 )
{
F_10 ( V_4 -> V_11 , L_63 ) ;
if ( V_609 & V_764 )
F_239 ( L_64 ) ;
...
V_779 = ( V_780 |
V_781 ) ;
F_18 ( F_229 ( V_493 -> V_520 ) , V_779 ) ;
F_166 ( V_4 , V_621 , V_473 , V_4 -> V_11 ,
L_76 , V_67 , ( unsigned long long ) V_609 ) ;
}
static void F_254 ( struct V_3 * V_4 , struct V_563 * V_493 ,
int V_18 )
{
V_493 -> V_588 = F_16 ( F_243 ( V_493 -> V_623 ) ) ;
F_166 ( V_4 , V_621 , V_473 , V_4 -> V_11 ,
L_77 , V_67 , ( unsigned long long ) V_493 -> V_588 ) ;
}
static void F_255 ( struct V_3 * V_4 , int V_29 , T_1 V_618 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
T_3 V_620 , V_619 ;
int V_26 ;
...
V_13 -> V_776 = V_776 ;
V_13 -> V_777 = V_777 ;
F_255 ( V_4 , V_13 -> V_17 , V_618 ) ;
F_258 ( & V_13 -> V_535 ) ;
}
}
static T_8 F_259 ( int V_782 , void * V_783 )
{
...
__func__, lp, ldg) ;
F_63 ( & V_4 -> V_155 , V_87 ) ;
V_618 = F_16 ( F_262 ( V_29 ) ) ;
V_776 = F_16 ( F_263 ( V_29 ) ) ;
V_777 = F_16 ( F_264 ( V_29 ) ) ;
if ( F_260 ( V_4 ) )
F_239 ( L_80 ,
...
int V_10 = F_252 ( V_4 , V_13 , V_618 , V_776 , V_777 ) ;
if ( V_10 )
goto V_217;
}
if ( F_71 ( V_618 & ~ ( ( T_1 ) 1 << V_785 ) ) )
F_256 ( V_4 , V_13 , V_618 , V_776 , V_777 ) ;
else
F_19 ( V_4 , V_13 , 1 ) ;
V_217:
F_65 ( & V_4 -> V_155 , V_87 ) ;
...
static void F_267 ( struct V_3 * V_4 , struct V_563 * V_493 )
{
if ( V_493 -> V_608 ) {
V_4 -> V_304 -> V_787 ( V_4 -> V_508 ,
sizeof( struct V_794 ) ,
...
struct V_492 * V_493 )
{
F_271 ( sizeof( struct V_607 ) != 64 ) ;
V_493 -> V_501 = F_272 ( V_496 * sizeof( struct V_485 * ) ,
V_800 ) ;
if ( ! V_493 -> V_501 )
return - V_506 ;
...
static void F_273 ( struct V_3 * V_4 , struct V_563 * V_493 )
{
...
static void F_275 ( struct V_3 * V_4 , struct V_492 * V_493 )
{
T_4 V_805 ;
V_805 = F_231 ( V_495 , 15 ) ;
V_493 -> V_515 = 1 << V_805 ;
...
V_625 = F_277 ( V_624 , sizeof( struct V_492 ) ,
V_800 ) ;
V_10 = - V_506 ;
if ( ! V_625 )
goto V_811;
...
V_587 = F_277 ( V_622 , sizeof( struct V_563 ) ,
V_800 ) ;
V_10 = - V_506 ;
if ( ! V_587 )
goto V_811;
...
F_278 () ;
V_4 -> V_587 = V_587 ;
F_280 ( V_4 -> V_11 , V_622 ) ;
for ( V_26 = 0 ; V_26 < V_4 -> V_622 ; V_26 ++ ) {
struct V_563 * V_493 = & V_4 -> V_587 [ V_26 ] ;
V_493 -> V_4 = V_4 ;
V_493 -> V_623 = V_808 + V_26 ;
V_10 = F_274 ( V_4 , V_493 ) ;
if ( V_10 )
goto V_811;
}
return 0 ;
...
static int F_286 ( struct V_3 * V_4 , int V_36 )
{
T_1 V_2 ;
F_18 ( F_287 ( V_36 ) , 0 ) ;
F_18 ( F_288 ( V_36 ) , 0 ) ;
...
static void F_296 ( struct V_3 * V_4 , T_1 V_827 )
{
unsigned long V_87 ;
T_1 V_2 ;
F_165 ( V_4 , V_87 ) ;
V_2 = F_16 ( V_828 ) ;
V_2 &= ~ F_297 ( V_4 -> V_30 ) ;
V_2 |= ( V_827 << F_298 ( V_4 -> V_30 ) ) ;
F_167 ( V_4 , V_87 ) ;
}
static void F_299 ( struct V_3 * V_4 , int V_14 )
{
T_1 V_2 = 0 ;
if ( V_14 ) {
int V_26 ;
...
F_18 ( F_300 ( V_4 -> V_30 ) , V_2 ) ;
}
static int F_301 ( struct V_3 * V_4 , struct V_563 * V_493 )
{
...
F_18 ( F_305 ( V_36 ) , V_493 -> V_788 >> 32 ) ;
F_18 ( F_306 ( V_36 ) , V_493 -> V_788 & V_834 ) ;
F_18 ( F_243 ( V_36 ) , 0 ) ;
V_493 -> V_593 = 0 ;
return 0 ;
}
...
F_18 ( F_308 ( V_841 , V_842 ) ,
V_839 -> V_844 [ V_842 ] ) ;
}
F_18 ( F_309 ( V_4 -> V_30 ) , V_4 -> V_25 -> V_845 [ V_4 -> V_30 ] ) ;
}
...
F_18 ( F_311 ( V_4 -> V_30 ) , V_2 ) ;
}
static int F_312 ( struct V_3 * V_4 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
...
{
return F_314 ( V_4 , F_315 ( V_36 ) ,
V_852 , 1000 , 10 ,
L_88 ) ;
}
static int F_316 ( struct V_3 * V_4 , int V_36 )
{
T_1 V_2 ;
F_18 ( F_317 ( V_36 ) , 0 ) ;
F_18 ( F_318 ( V_36 ) , 0 ) ;
...
static void F_325 ( struct V_3 * V_4 , struct V_492 * V_493 )
{
T_1 V_2 ;
...
F_18 ( F_326 ( V_493 -> V_520 ) , V_2 ) ;
}
static int F_327 ( struct V_492 * V_493 , T_1 * V_860 )
{
T_1 V_2 = 0 ;
* V_860 = 0 ;
switch ( V_493 -> V_515 ) {
...
static int F_328 ( struct V_3 * V_4 , int V_36 , int V_14 )
{
T_1 V_2 = F_16 ( F_315 ( V_36 ) ) ;
int V_6 ;
if ( V_14 )
V_2 |= V_884 ;
else
...
static int F_329 ( struct V_3 * V_4 , struct V_492 * V_493 )
{
...
return V_10 ;
F_325 ( V_4 , V_493 ) ;
F_18 ( F_330 ( V_36 ) , V_886 ) ;
F_18 ( F_229 ( V_36 ) ,
( V_615 |
V_780 |
V_781 |
V_887 ) ) ;
F_18 ( F_315 ( V_36 ) , V_493 -> V_788 >> 32 ) ;
F_18 ( F_331 ( V_36 ) ,
( ( V_493 -> V_788 & V_888 ) |
V_889 ) ) ;
F_18 ( F_332 ( V_36 ) ,
...
( V_937 |
( 0 << V_938 ) |
( F_340 ( V_4 -> V_30 ) << V_939 ) ) ) ;
return F_341 ( V_4 , V_936 , V_940 ,
1000 , 100 ) ;
}
static int F_342 ( struct V_3 * V_4 , int V_375 , T_1 * V_35 )
{
int V_10 ;
V_10 = F_341 ( V_4 , V_936 , V_940 ,
1000 , 100 ) ;
if ( V_10 ) {
F_10 ( V_4 -> V_11 , L_89 ,
...
V_10 = F_339 ( V_4 , V_26 , V_35 ) ;
if ( V_10 )
return V_10 ;
V_10 = F_342 ( V_4 , V_26 , V_943 ) ;
if ( V_10 )
return V_10 ;
}
F_343 ( V_4 ) ;
F_18 ( F_346 ( V_4 -> V_30 ) , 0 ) ;
F_18 ( V_948 , V_949 ) ;
( void ) F_16 ( V_948 ) ;
F_18 ( V_950 , V_951 ) ;
return 0 ;
}
static void F_347 ( struct V_3 * V_4 , int V_375 , T_1 * V_35 )
{
T_1 V_2 = F_12 ( V_952 ) ;
...
static void F_348 ( struct V_3 * V_4 , int V_375 , T_1 * V_35 )
{
F_14 ( V_960 , V_375 ) ;
V_35 [ 0 ] = F_12 ( V_961 ) ;
V_35 [ 1 ] = F_12 ( V_962 ) ;
...
static void F_363 ( struct V_3 * V_4 , T_1 F_231 , T_1 V_944 )
{
T_1 V_2 ;
V_2 = F_6 ( V_1020 ) ;
V_2 &= ~ ( V_1021 |
...
static void F_364 ( struct V_3 * V_4 , T_1 F_231 , T_1 V_944 )
{
T_1 V_2 ;
F_9 ( V_1040 , F_231 ) ;
F_9 ( V_1041 , V_944 ) ;
...
F_189 ( F_231 & 0x7 ) ;
if ( V_4 -> V_87 & V_366 )
F_363 ( V_4 , F_231 , V_944 ) ;
else
F_364 ( V_4 , F_231 , V_944 ) ;
}
...
static int F_367 ( struct V_3 * V_4 )
{
int V_6 ;
F_9 ( V_1051 , V_1052 ) ;
V_6 = 1000 ;
...
static int F_368 ( struct V_3 * V_4 )
{
if ( V_4 -> V_87 & V_366 )
return F_366 ( V_4 ) ;
else
...
static void F_378 ( struct V_3 * V_4 , int V_14 )
{
T_1 V_2 = F_6 ( V_1094 ) ;
V_2 &= ~ ( V_1102 |
V_1098 ) ;
...
static void F_379 ( struct V_3 * V_4 , int V_14 )
{
if ( V_4 -> V_87 & V_366 )
F_377 ( V_4 , V_14 ) ;
else
...
static int F_380 ( struct V_3 * V_4 )
{
int V_10 ;
F_98 ( V_4 ) ;
V_10 = F_358 ( V_4 ) ;
...
static void F_383 ( struct V_3 * V_4 , struct V_563 * V_493 )
{
( void ) F_284 ( V_4 , V_493 -> V_623 ) ;
}
...
static void F_387 ( struct V_3 * V_4 , struct V_492 * V_493 )
{
int V_36 = V_493 -> V_520 ;
( void ) F_313 ( V_4 , V_36 ) ;
F_18 ( F_330 ( V_36 ) , V_1107 ) ;
F_18 ( F_229 ( V_36 ) , 0 ) ;
( void ) F_328 ( V_4 , V_36 , 0 ) ;
}
...
static int F_393 ( struct V_3 * V_4 )
{
...
for ( V_26 = 0 ; V_26 < V_4 -> V_28 ; V_26 ++ ) {
struct V_12 * V_13 = & V_4 -> V_29 [ V_26 ] ;
V_10 = F_394 ( V_13 -> V_782 , F_259 , V_1118 ,
...
static void F_399 ( struct V_3 * V_4 )
{
int V_26 ;
for ( V_26 = 0 ; V_26 < V_4 -> V_28 ; V_26 ++ )
F_400 ( & V_4 -> V_29 [ V_26 ] . V_535 ) ;
}
static int F_401 ( struct V_308 * V_11 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
int V_10 ;
F_102 ( V_11 ) ;
V_10 = F_276 ( V_4 ) ;
if ( V_10 )
...
static void F_407 ( struct V_3 * V_4 , struct V_308 * V_11 )
{
F_408 ( & V_4 -> V_1123 ) ;
F_399 ( V_4 ) ;
F_409 ( V_11 ) ;
...
static int F_411 ( struct V_308 * V_11 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
F_407 ( V_4 , V_11 ) ;
F_396 ( V_4 ) ;
...
static void F_417 ( struct V_3 * V_4 ,
struct V_1130 * V_1131 )
{
...
static struct V_1130 * F_418 ( struct V_308 * V_11 ,
struct V_1130 * V_1131 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
if ( F_419 ( V_11 ) ) {
...
static void F_421 ( struct V_3 * V_4 , T_4 * V_1138 )
{
int V_26 ;
for ( V_26 = 0 ; V_26 < 16 ; V_26 ++ )
F_9 ( F_372 ( V_26 ) , V_1138 [ V_26 ] ) ;
}
static void F_422 ( struct V_3 * V_4 , T_4 * V_1138 )
{
if ( V_4 -> V_87 & V_366 )
F_420 ( V_4 , V_1138 ) ;
else
...
static void F_423 ( struct V_308 * V_11 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
...
if ( V_11 -> V_87 & V_1142 )
V_4 -> V_87 |= V_1106 ;
if ( ( V_11 -> V_87 & V_1143 ) || ( ! F_424 ( V_11 ) ) )
V_4 -> V_87 |= V_1105 ;
V_1139 = F_425 ( V_11 ) ;
if ( V_1139 > F_117 ( V_4 ) ) {
V_1139 = 0 ;
...
F_428 (ha, dev) {
T_3 V_1145 = F_429 ( V_1146 , V_1141 -> V_362 ) ;
V_1145 >>= 24 ;
...
static int F_430 ( struct V_308 * V_11 , void * V_498 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
struct V_1147 * V_362 = V_498 ;
unsigned long V_87 ;
if ( ! F_431 ( V_362 -> V_1148 ) )
return - V_1149 ;
...
static int F_432 ( struct V_308 * V_11 , struct V_1150 * V_1151 , int V_1152 )
{
return - V_1153 ;
}
...
static void F_438 ( struct V_1156 * V_1157 )
{
struct V_3 * V_4 = F_236 ( V_1157 , struct V_3 , V_1123 ) ;
unsigned long V_87 ;
int V_10 ;
F_63 ( & V_4 -> V_155 , V_87 ) ;
if ( ! F_419 ( V_4 -> V_11 ) ) {
...
static void F_439 ( struct V_308 * V_11 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
...
static void F_441 ( struct V_563 * V_493 , int V_375 ,
...
static T_1 F_443 ( struct V_483 * V_484 , struct V_1164 * V_1165 ,
...
switch ( V_484 -> V_560 ) {
case F_445 ( V_1177 ) :
V_1172 = F_446 ( V_484 ) -> V_560 ;
V_1171 = F_446 ( V_484 ) -> V_1171 ;
break;
case F_445 ( V_1178 ) :
V_1172 = F_447 ( V_484 ) -> V_1179 ;
V_1171 = ( 40 >> 2 ) ;
V_428 = 1 ;
break;
default:
...
static T_10 F_450 ( struct V_483 * V_484 ,
struct V_308 * V_11 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
...
F_452 ( V_582 ) ;
F_226 ( V_4 -> V_508 , L_123 , V_11 -> V_1117 ) ;
V_493 -> V_1137 ++ ;
return V_1203 ;
}
if ( V_484 -> V_490 < V_1204 ) {
unsigned int V_1166 = V_1204 - V_484 -> V_490 ;
if ( F_453 ( V_484 , V_1166 ) )
goto V_217;
F_454 ( V_484 , V_1166 ) ;
}
V_490 = sizeof( struct V_567 ) + 15 ;
if ( F_455 ( V_484 ) < V_490 ) {
struct V_483 * V_1205 ;
V_1205 = F_456 ( V_484 , V_490 ) ;
if ( ! V_1205 ) {
V_493 -> V_1137 ++ ;
goto V_1206;
}
...
V_341 = (struct V_567 * ) F_459 ( V_484 , V_1199 ) ;
V_490 = V_484 -> V_490 - sizeof( struct V_567 ) ;
V_341 -> V_87 = F_442 ( F_443 ( V_484 , V_1165 , V_1198 , V_490 ) ) ;
V_341 -> V_1207 = 0 ;
V_490 = F_208 ( V_484 ) ;
...
if ( V_1211 > V_579 )
V_1211 = V_579 ;
F_441 ( V_493 , V_798 , V_502 , V_1211 , V_1202 , V_1200 ) ;
V_1202 = V_1200 = 0 ;
...
V_490 = F_211 ( V_1212 ) ;
V_502 = V_4 -> V_304 -> V_507 ( V_4 -> V_508 , F_460 ( V_1212 ) ,
V_1212 -> V_1213 , V_490 ,
V_575 ) ;
V_493 -> V_566 [ V_798 ] . V_484 = NULL ;
V_493 -> V_566 [ V_798 ] . V_502 = V_502 ;
F_441 ( V_493 , V_798 , V_502 , V_490 , 0 , 0 ) ;
V_798 = F_210 ( V_493 , V_798 ) ;
}
F_461 ( V_582 , V_484 -> V_490 ) ;
if ( V_798 < V_493 -> V_798 )
V_493 -> V_799 ^= V_1214 ;
V_493 -> V_798 = V_798 ;
F_18 ( F_285 ( V_493 -> V_623 ) , V_493 -> V_799 | ( V_798 << 3 ) ) ;
if ( F_70 ( F_218 ( V_493 ) <= ( V_1215 + 1 ) ) ) {
F_452 ( V_582 ) ;
...
static int F_462 ( struct V_308 * V_11 , int V_1217 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
...
static void F_463 ( struct V_308 * V_11 ,
struct V_1221 * V_1222 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
struct V_1223 * V_1224 = & V_4 -> V_1224 ;
F_464 ( V_1222 -> V_1225 , V_1226 , sizeof( V_1222 -> V_1225 ) ) ;
F_464 ( V_1222 -> V_1227 , V_1228 , sizeof( V_1222 -> V_1227 ) ) ;
snprintf ( V_1222 -> V_1229 , sizeof( V_1222 -> V_1229 ) , L_124 ,
V_1224 -> V_1230 , V_1224 -> V_1231 ) ;
if ( V_4 -> V_25 -> V_339 != V_343 )
F_464 ( V_1222 -> V_1232 , F_465 ( V_4 -> V_1233 ) ,
sizeof( V_1222 -> V_1232 ) ) ;
}
static int F_466 ( struct V_308 * V_11 , struct V_1234 * V_1152 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
struct V_38 * V_13 ;
V_13 = & V_4 -> V_39 ;
...
static int F_468 ( struct V_308 * V_11 , struct V_1234 * V_1152 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
struct V_38 * V_13 = & V_4 -> V_39 ;
V_13 -> V_174 = V_1152 -> V_174 ;
V_13 -> V_302 = F_469 ( V_1152 ) ;
V_13 -> V_301 = V_1152 -> V_301 ;
V_13 -> V_285 = V_1152 -> V_285 ;
return F_114 ( V_4 ) ;
}
static T_3 F_470 ( struct V_308 * V_11 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
return V_4 -> V_1241 ;
}
static void F_471 ( struct V_308 * V_11 , T_3 V_1242 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
V_4 -> V_1241 = V_1242 ;
}
static int F_472 ( struct V_308 * V_11 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
if ( V_4 -> V_39 . V_285 )
return F_114 ( V_4 ) ;
...
static int F_473 ( struct V_308 * V_11 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
return V_4 -> V_1243 ;
}
static int F_474 ( struct V_308 * V_11 ,
...
static void F_476 ( int V_1248 , T_5 * V_1249 )
{
switch ( V_1248 ) {
case V_1250 :
case V_1251 :
...
static int F_477 ( T_1 V_421 , int * V_1248 )
{
switch ( V_421 ) {
case V_1263 :
* V_1248 = V_1250 ;
...
static int F_478 ( int V_1248 , T_1 * V_421 )
{
switch ( V_1248 ) {
case V_1250 :
* V_421 = V_1263 ;
...
static int F_480 ( T_1 V_1275 , T_1 * V_928 )
{
T_1 V_403 = 0 ;
if ( V_1275 & V_1277 )
V_403 |= V_1276 ;
...
static int F_481 ( struct V_3 * V_4 , struct V_1291 * V_1292 )
{
T_1 V_421 ;
V_1292 -> V_35 = 0 ;
if ( ! F_478 ( V_1292 -> V_1248 , & V_421 ) )
return - V_21 ;
if ( V_4 -> V_25 -> V_927 [ V_421 - V_425 ] &
V_1293 )
V_1292 -> V_35 = V_1294 ;
else
V_1292 -> V_35 = F_479 ( V_4 -> V_25 -> V_928 [ V_421 -
V_425 ] ) ;
return 0 ;
}
static void F_482 ( struct V_908 * V_341 ,
struct V_1295 * V_1296 )
{
T_3 V_584 ;
T_4 V_1297 ;
V_584 = ( V_341 -> V_403 [ 3 ] & V_1298 ) >> V_1299 ;
V_1296 -> V_1300 . V_1301 . V_1302 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_403 [ 3 ] & V_1303 ) >> V_1304 ;
V_1296 -> V_1300 . V_1301 . V_1305 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1298 ) >> V_1299 ;
V_1296 -> V_1306 . V_1301 . V_1302 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1303 ) >> V_1304 ;
V_1296 -> V_1306 . V_1301 . V_1305 = F_483 ( V_584 ) ;
...
V_1311 ) >> 16 ;
V_1296 -> V_1300 . V_1301 . V_1312 = F_445 ( V_1297 ) ;
V_1297 = ( ( V_341 -> V_403 [ 2 ] & V_1310 ) >>
V_1311 ) & 0xffff ;
V_1296 -> V_1300 . V_1301 . V_1313 = F_445 ( V_1297 ) ;
V_1297 = ( ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ) >> 16 ;
V_1296 -> V_1306 . V_1301 . V_1312 = F_445 ( V_1297 ) ;
V_1297 = ( ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ) & 0xffff ;
V_1296 -> V_1306 . V_1301 . V_1313 = F_445 ( V_1297 ) ;
break;
case V_1257 :
case V_1260 :
V_584 = ( V_341 -> V_403 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1300 . V_1314 . V_1315 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1306 . V_1314 . V_1315 = F_483 ( V_584 ) ;
break;
case V_1272 :
V_584 = ( V_341 -> V_403 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1300 . V_1316 . V_1317 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1306 . V_1316 . V_1317 = F_483 ( V_584 ) ;
...
static int F_484 ( struct V_3 * V_4 ,
...
if ( ! V_341 -> V_914 ) {
F_485 ( V_4 -> V_11 , L_125 ,
V_25 -> V_375 , ( T_4 ) V_1292 -> V_1323 . V_1324 , V_386 ) ;
return - V_21 ;
}
V_421 = ( V_341 -> V_403 [ 0 ] & V_1325 ) >>
V_1326 ;
V_860 = F_477 ( V_421 , & V_1296 -> V_1248 ) ;
if ( V_860 < 0 ) {
F_485 ( V_4 -> V_11 , L_126 ,
V_25 -> V_375 ) ;
V_860 = - V_21 ;
goto V_217;
}
...
static int F_487 ( struct V_308 * V_11 , struct V_1291 * V_1152 ,
T_3 * V_1331 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
int V_860 = 0 ;
...
static int F_488 ( struct V_3 * V_4 , struct V_1291 * V_1292 )
{
T_1 V_421 ;
T_1 V_928 = 0 ;
unsigned long V_87 ;
...
static void F_489 ( struct V_1295 * V_1296 ,
struct V_908 * V_341 ,
...
V_1341 = F_490 ( V_1296 -> V_1300 . V_1301 . V_1302 ) ;
V_1343 = F_490 ( V_1296 -> V_1306 . V_1301 . V_1302 ) ;
V_1342 = F_490 ( V_1296 -> V_1300 . V_1301 . V_1305 ) ;
V_1344 = F_490 ( V_1296 -> V_1306 . V_1301 . V_1305 ) ;
...
case V_1252 :
case V_1254 :
V_1346 = F_444 ( V_1296 -> V_1300 . V_1301 . V_1312 ) ;
V_1348 = F_444 ( V_1296 -> V_1306 . V_1301 . V_1312 ) ;
V_1347 = F_444 ( V_1296 -> V_1300 . V_1301 . V_1313 ) ;
V_1349 = F_444 ( V_1296 -> V_1306 . V_1301 . V_1313 ) ;
V_341 -> V_403 [ 2 ] |= ( ( ( T_1 ) V_1346 << 16 ) | V_1347 ) ;
V_341 -> V_911 [ 2 ] |= ( ( ( T_1 ) V_1348 << 16 ) | V_1349 ) ;
F_476 ( V_1296 -> V_1248 , & V_1249 ) ;
break;
case V_1257 :
case V_1260 :
V_1315 = F_490 ( V_1296 -> V_1300 . V_1314 . V_1315 ) ;
V_1345 = F_490 ( V_1296 -> V_1306 . V_1314 . V_1315 ) ;
V_341 -> V_403 [ 2 ] |= V_1315 ;
V_341 -> V_911 [ 2 ] |= V_1345 ;
F_476 ( V_1296 -> V_1248 , & V_1249 ) ;
break;
case V_1272 :
V_1315 = F_490 ( V_1296 -> V_1300 . V_1316 . V_1317 ) ;
V_1345 = F_490 ( V_1296 -> V_1306 . V_1316 . V_1317 ) ;
V_341 -> V_403 [ 2 ] |= V_1315 ;
V_341 -> V_911 [ 2 ] |= V_1345 ;
...
static int F_491 ( struct V_3 * V_4 ,
struct V_1291 * V_1292 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
...
case V_1257 :
case V_1260 :
F_489 ( V_1296 , V_341 , V_1352 , V_421 ) ;
break;
case V_1251 :
case V_1253 :
case V_1255 :
...
static int F_492 ( struct V_3 * V_4 , T_3 V_1361 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
T_4 V_386 ;
...
static int F_493 ( struct V_308 * V_11 , struct V_1291 * V_1152 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
int V_860 = 0 ;
switch ( V_1152 -> V_1152 ) {
...
break;
case V_1363 :
V_860 = F_491 ( V_4 , V_1152 ) ;
break;
case V_1364 :
V_860 = F_492 ( V_4 , V_1152 -> V_1323 . V_1324 ) ;
break;
default:
V_860 = - V_21 ;
break;
...
static void F_494 ( struct V_308 * V_11 , T_3 V_1365 , T_5 * V_35 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
int V_26 ;
if ( V_1365 != V_1366 )
...
static int F_495 ( struct V_308 * V_11 , int V_1365 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
if ( V_1365 != V_1366 )
return - V_21 ;
...
static void F_496 ( struct V_308 * V_11 ,
...
static T_1 F_497 ( struct V_3 * V_4 )
{
if ( V_4 -> V_87 & V_366 )
return F_6 ( V_269 ) ;
else
...
static void F_498 ( struct V_3 * V_4 , T_1 V_2 )
{
if ( V_4 -> V_87 & V_366 )
F_9 ( V_269 , V_2 ) ;
else
...
static void F_499 ( struct V_3 * V_4 , int V_14 )
{
T_1 V_2 , V_1 , V_397 ;
if ( V_4 -> V_87 & V_366 ) {
V_1 = V_269 ;
...
static int F_500 ( struct V_308 * V_11 ,
enum V_1376 V_1377 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
if ( ! F_419 ( V_11 ) )
...
break;
case V_1383 :
F_498 ( V_4 , V_4 -> V_1380 ) ;
}
return 0 ;
}
static int F_501 ( struct V_3 * V_4 , struct V_24 * V_25 ,
int V_29 , int V_18 )
{
...
V_25 -> V_27 [ V_18 ] = V_29 ;
if ( V_4 -> V_25 -> V_339 == V_343 ) {
if ( F_16 ( F_502 ( V_18 ) ) != V_29 ) {
F_226 ( V_4 -> V_508 , L_132 ,
V_4 -> V_30 , V_18 , V_29 ,
( unsigned long long ) F_16 ( F_502 ( V_18 ) ) ) ;
return - V_21 ;
}
} else
F_18 ( F_502 ( V_18 ) , V_29 ) ;
return 0 ;
}
static int F_503 ( struct V_3 * V_4 , int V_1386 )
{
...
static int F_504 ( struct V_3 * V_4 , int V_29 , int V_1389 , int V_1390 )
{
if ( ( V_29 < V_1384 || V_29 > V_1385 ) ||
( V_1389 < 0 || V_1389 > 3 ) ||
( V_1390 < 0 || V_1390 > 0x1f ) )
return - V_21 ;
F_18 ( F_505 ( V_29 ) , ( V_1389 << V_1391 ) | V_1390 ) ;
return 0 ;
}
static int T_12 F_506 ( struct V_3 * V_4 , T_3 V_362 )
{
...
static int T_12 F_507 ( struct V_3 * V_4 , T_3 V_335 )
{
int V_10 = F_506 ( V_4 , V_335 ) ;
T_4 V_2 ;
if ( V_10 < 0 )
return V_10 ;
V_2 = ( V_10 << 8 ) ;
V_10 = F_506 ( V_4 , V_335 + 1 ) ;
if ( V_10 < 0 )
return V_10 ;
V_2 |= ( V_10 & 0xff ) ;
return V_2 ;
}
static int T_12 F_508 ( struct V_3 * V_4 , T_3 V_335 )
{
int V_10 = F_506 ( V_4 , V_335 ) ;
T_4 V_2 ;
if ( V_10 < 0 )
...
static int T_12 F_509 ( struct V_3 * V_4 ,
T_3 V_335 ,
char * V_1401 ,
int V_1402 )
{
...
static void T_12 F_510 ( struct V_3 * V_4 )
{
struct V_1223 * V_1224 = & V_4 -> V_1224 ;
...
static int T_12 F_511 ( struct V_3 * V_4 ,
T_3 V_1182 , T_3 V_1407 )
{
unsigned int V_1408 = 0 ;
#define F_512 0x00000001
#define F_513 0x00000002
#define F_514 0x00000004
#define F_515 0x00000008
#define F_516 0x00000010
#define F_517 0x00000020
#define F_518 0x0000003f
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_136 , V_1182 , V_1407 ) ;
while ( V_1182 < V_1407 ) {
...
V_10 = F_506 ( V_4 , V_1182 + 2 ) ;
if ( V_10 < 0 )
return V_10 ;
V_490 = V_10 ;
V_1182 += 3 ;
V_1409 = F_506 ( V_4 , V_1182 + 4 ) ;
V_10 = F_509 ( V_4 , V_1182 + 5 , V_1401 , 64 ) ;
if ( V_10 < 0 )
return V_10 ;
V_1410 = NULL ;
V_1411 = 0 ;
...
F_226 ( V_4 -> V_508 , L_143 , V_1401 , V_1409 ) ;
return - V_21 ;
}
if ( V_1410 ) {
...
* V_1410 ++ = F_506 ( V_4 , V_335 + V_26 ) ;
}
V_1182 += V_490 ;
}
return 0 ;
}
static void T_12 F_519 ( struct V_3 * V_4 , T_3 V_1182 )
{
T_3 V_486 ;
int V_10 ;
V_10 = F_508 ( V_4 , V_1182 + 1 ) ;
if ( V_10 < 0 )
return;
V_486 = V_10 + 3 ;
...
T_3 V_1407 ;
V_10 = F_506 ( V_4 , V_1422 ) ;
if ( V_10 != 0x90 )
return;
V_10 = F_508 ( V_4 , V_1422 + 1 ) ;
if ( V_10 < 0 )
return;
V_1422 = V_1182 + V_486 + 3 ;
V_1407 = V_1182 + V_486 + V_10 ;
V_486 += V_10 ;
V_10 = F_511 ( V_4 , V_1422 , V_1407 ) ;
if ( V_10 < 0 || V_10 == 1 )
return;
}
}
static T_3 T_12 F_520 ( struct V_3 * V_4 )
{
T_3 V_1182 = 0 , V_1407 = V_1421 , V_860 ;
int V_10 ;
while ( V_1182 < V_1407 ) {
V_860 = V_1182 ;
V_10 = F_507 ( V_4 , V_1182 + 0 ) ;
if ( V_10 != 0x55aa )
return 0 ;
V_10 = F_507 ( V_4 , V_1182 + 23 ) ;
if ( V_10 < 0 )
return 0 ;
V_1182 += V_10 ;
V_10 = F_507 ( V_4 , V_1182 + 0 ) ;
if ( V_10 != 0x5043 )
return 0 ;
V_10 = F_507 ( V_4 , V_1182 + 2 ) ;
if ( V_10 != 0x4952 )
return 0 ;
V_10 = F_506 ( V_4 , V_1182 + 20 ) ;
if ( V_10 < 0 )
return 0 ;
if ( V_10 != 0x01 ) {
V_10 = F_506 ( V_4 , V_860 + 2 ) ;
if ( V_10 < 0 )
return 0 ;
V_1182 = V_860 + ( V_10 * 512 ) ;
continue;
}
V_10 = F_508 ( V_4 , V_1182 + 8 ) ;
if ( V_10 < 0 )
return V_10 ;
V_860 += V_10 ;
V_10 = F_506 ( V_4 , V_860 + 0 ) ;
if ( V_10 != 0x82 )
return 0 ;
return V_860 ;
}
...
static void T_12 F_523 ( struct V_3 * V_4 )
{
struct V_308 * V_11 = V_4 -> V_11 ;
struct V_1223 * V_1224 = & V_4 -> V_1224 ;
T_5 V_1436 ;
if ( ! F_431 ( & V_1224 -> V_1417 [ 0 ] ) ) {
...
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
} else if ( F_521 ( V_4 , V_4 -> V_1224 . V_1419 ) ) {
...
static int T_12 F_524 ( struct V_3 * V_4 )
{
struct V_308 * V_11 = V_4 -> V_11 ;
int V_490 , V_26 ;
T_1 V_2 , V_1439 ;
...
return - V_21 ;
for ( V_26 = 0 ; V_26 < V_2 ; V_26 += 4 ) {
T_1 V_584 = F_16 ( F_475 ( 14 + ( V_26 / 4 ) ) ) ;
...
static int T_12 F_525 ( struct V_3 * V_4 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
if ( V_4 -> V_30 <= 1 )
V_4 -> V_87 |= V_366 ;
...
static int T_12 F_526 ( struct V_24 * V_25 ,
struct V_276 * V_498 ,
...
static int T_12 F_528 ( struct V_276 * V_498 , int V_30 )
{
int V_26 ;
...
static int T_12 F_529 ( struct V_276 * V_498 , int * V_1472 )
{
int V_30 , V_1332 ;
V_1332 = 0 ;
* V_1472 = 32 ;
...
static int T_12 F_530 ( struct V_276 * V_498 , int * V_1472 )
{
* V_1472 = 32 ;
...
static void T_12 F_532 ( struct V_24 * V_25 ,
...
static void T_12 F_534 ( struct V_24 * V_25 ,
int V_1474 , int V_1475 )
{
...
V_1491 -> V_844 [ V_842 ] =
V_1486 + V_1490 ;
F_239 ( L_176 , V_1491 -> V_844 [ V_842 ] ) ;
if ( ++ V_1490 == V_1489 )
V_1490 = 0 ;
}
F_239 ( L_177 ) ;
...
V_1492 , V_1494 ) ;
V_10 = F_526 ( V_25 , V_1222 , V_1462 , V_1463 , V_30 ,
V_1466 ) ;
if ( V_10 )
break;
V_1462 = F_29 ( V_4 , V_30 ,
...
static int T_12 F_536 ( struct V_3 * V_4 , struct V_24 * V_25 )
{
...
V_10 = F_535 ( V_4 , V_25 , V_1222 ) ;
if ( V_10 )
return V_10 ;
V_1474 = F_529 ( V_1222 , & V_1496 ) ;
V_1475 = F_530 ( V_1222 , & V_1497 ) ;
...
F_532 ( V_25 , V_1474 , V_1475 ) ;
F_534 ( V_25 , V_1474 , V_1475 ) ;
return 0 ;
V_1499:
F_527 ( L_179 , V_1497 ) ;
return - V_21 ;
...
static int T_12 F_538 ( struct V_3 * V_4 )
{
struct V_906 * V_907 = & V_4 -> V_478 ;
...
static void T_12 F_539 ( struct V_3 * V_4 )
{
struct V_38 * V_13 = & V_4 -> V_39 ;
V_13 -> V_174 = ( V_288 |
V_290 |
...
static void T_12 F_541 ( struct V_3 * V_4 , T_5 * V_1512 )
{
...
V_10 = F_542 ( V_1233 , V_1514 , V_1517 ) ;
if ( V_10 < 0 ) {
V_4 -> V_87 &= ~ V_1521 ;
return;
}
...
static int T_12 F_543 ( struct V_3 * V_4 , T_5 * V_1512 )
{
#ifdef F_544
struct V_1522 * V_1523 = V_4 -> V_1523 ;
const T_3 * V_1524 ;
int V_26 ;
V_1524 = F_545 ( V_1523 -> V_11 . V_1525 , L_181 , NULL ) ;
if ( ! V_1524 )
return - V_8 ;
...
static int T_12 F_546 ( struct V_3 * V_4 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
T_5 V_1512 [ V_1515 ] ;
int V_1528 , V_1529 ;
...
for ( V_26 = 0 ; V_26 < V_4 -> V_28 ; V_26 ++ ) {
struct V_12 * V_13 = & V_4 -> V_29 [ V_26 ] ;
F_547 ( V_4 -> V_11 , & V_13 -> V_535 , F_235 , 64 ) ;
V_13 -> V_4 = V_4 ;
V_13 -> V_17 = V_1512 [ V_26 ] ;
V_13 -> V_15 = 2 ;
if ( V_4 -> V_25 -> V_339 != V_343 ) {
V_10 = F_504 ( V_4 , V_13 -> V_17 , V_30 , V_26 ) ;
if ( V_10 )
return V_10 ;
}
}
V_1530 = 0 ;
V_10 = F_501 ( V_4 , V_25 , V_1512 [ V_1530 ] ,
F_548 ( V_30 ) ) ;
if ( V_10 )
return V_10 ;
V_1530 ++ ;
...
static void T_13 F_549 ( struct V_3 * V_4 )
{
if ( V_4 -> V_87 & V_1521 )
F_550 ( V_4 -> V_1233 ) ;
}
...
V_1533 = F_552 ( V_4 -> V_1233 ) ;
V_1419 = F_545 ( V_1533 , L_142 , & V_1409 ) ;
if ( ! V_1419 ) {
F_10 ( V_11 , L_182 ,
V_1533 -> V_1535 ) ;
return - V_21 ;
...
if ( F_521 ( V_4 , V_4 -> V_1224 . V_1419 ) ) {
F_10 ( V_11 , L_184 ,
V_1533 -> V_1535 , V_4 -> V_1224 . V_1419 ) ;
return - V_21 ;
}
V_1534 = F_545 ( V_1533 , L_140 , & V_1409 ) ;
if ( ! V_1534 ) {
F_10 ( V_11 , L_185 ,
V_1533 -> V_1535 ) ;
return - V_21 ;
...
memcpy ( V_11 -> V_1104 , V_11 -> V_1437 , V_11 -> V_1438 ) ;
V_1412 = F_545 ( V_1533 , L_137 , & V_1409 ) ;
if ( V_1412 )
strcpy ( V_4 -> V_1224 . V_1412 , V_1412 ) ;
if ( F_553 ( V_1533 , L_189 , & V_1409 ) ) {
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
}
return 0 ;
...
static int T_12 F_554 ( struct V_3 * V_4 )
{
int V_10 , V_1536 ;
T_3 V_486 ;
V_10 = F_551 ( V_4 ) ;
...
{
struct V_1522 * V_1542 = F_556 ( V_11 ) ;
...
static T_14 F_559 ( struct V_508 * V_11 ,
struct V_1539 * V_1540 , char * V_1541 )
{
return F_558 ( V_11 , V_1540 , V_1541 , 1 ) ;
}
static T_14 F_560 ( struct V_508 * V_11 ,
struct V_1539 * V_1540 , char * V_1541 )
{
return F_558 ( V_11 , V_1540 , V_1541 , 1 ) ;
}
static T_14 F_561 ( struct V_508 * V_11 ,
struct V_1539 * V_1540 , char * V_1541 )
{
struct V_1522 * V_1542 = F_556 ( V_11 ) ;
struct V_24 * V_498 = V_1542 -> V_11 . V_1543 ;
...
static struct V_24 * T_12 F_562 ( struct V_3 * V_4 ,
union V_1549 * V_1465 ,
T_5 V_543 )
{
...
struct V_24 * V_498 ;
int V_26 ;
V_1542 = F_563 ( L_205 , V_1550 ,
NULL , 0 ) ;
if ( F_564 ( V_1542 ) )
return NULL ;
for ( V_26 = 0 ; F_565 ( V_1551 [ V_26 ] ) ; V_26 ++ ) {
int V_10 = F_566 ( & V_1542 -> V_11 ,
& V_1551 [ V_26 ] ) ;
if ( V_10 )
goto V_1552;
}
V_498 = F_272 ( sizeof( * V_498 ) , V_800 ) ;
if ( ! V_498 )
goto V_1552;
V_498 -> V_375 = V_1550 ++ ;
...
V_498 -> V_339 = V_543 ;
F_567 ( & V_498 -> V_1553 ) ;
F_568 ( & V_498 -> V_1554 , 0 ) ;
F_569 ( & V_498 -> V_1553 , & V_1555 ) ;
F_570 ( & V_498 -> V_155 ) ;
V_498 -> V_902 = 7500 ;
V_498 -> V_441 = V_1556 ;
...
static struct V_24 * T_12 F_572 ( struct V_3 * V_4 ,
union V_1549 * V_1465 ,
T_5 V_543 )
{
...
F_573 ( & V_1560 ) ;
V_498 = NULL ;
F_574 (tmp, &niu_parent_list, list) {
...
if ( ! V_498 )
V_498 = F_562 ( V_4 , V_1465 , V_543 ) ;
if ( V_498 ) {
char V_1561 [ 6 ] ;
int V_10 ;
sprintf ( V_1561 , L_206 , V_30 ) ;
V_10 = F_575 ( & V_498 -> V_1542 -> V_11 . V_1562 ,
& V_4 -> V_508 -> V_1562 ,
V_1561 ) ;
if ( ! V_10 ) {
...
static void F_578 ( struct V_3 * V_4 )
{
...
sprintf ( V_1561 , L_206 , V_30 ) ;
F_573 ( & V_1560 ) ;
F_579 ( & V_498 -> V_1542 -> V_11 . V_1562 , V_1561 ) ;
V_498 -> V_1426 [ V_30 ] = NULL ;
V_4 -> V_25 = NULL ;
if ( F_580 ( & V_498 -> V_1554 ) ) {
F_581 ( & V_498 -> V_1553 ) ;
F_571 ( V_498 -> V_1542 ) ;
}
F_577 ( & V_1560 ) ;
}
static void * F_582 ( struct V_508 * V_11 , T_15 V_487 ,
T_1 * V_1563 , T_6 V_1564 )
{
T_16 V_1565 ;
void * V_860 ;
V_860 = F_583 ( V_11 , V_487 , & V_1565 , V_1564 ) ;
if ( V_860 )
* V_1563 = V_1565 ;
return V_860 ;
}
static void F_584 ( struct V_508 * V_11 , T_15 V_487 ,
void * V_1566 , T_1 V_1563 )
{
F_585 ( V_11 , V_487 , V_1566 , V_1563 ) ;
}
static T_1 F_586 ( struct V_508 * V_11 , struct V_485 * V_485 ,
unsigned long V_486 , T_15 V_487 ,
enum V_1567 V_1568 )
{
return F_587 ( V_11 , V_485 , V_486 , V_487 , V_1568 ) ;
}
static void F_588 ( struct V_508 * V_11 , T_1 V_1569 ,
T_15 V_487 , enum V_1567 V_1568 )
{
F_589 ( V_11 , V_1569 , V_487 , V_1568 ) ;
}
static T_1 F_590 ( struct V_508 * V_11 , void * V_1566 ,
T_15 V_487 ,
enum V_1567 V_1568 )
{
return F_591 ( V_11 , V_1566 , V_487 , V_1568 ) ;
}
static void F_592 ( struct V_508 * V_11 , T_1 V_1569 ,
T_15 V_487 ,
enum V_1567 V_1568 )
{
F_593 ( V_11 , V_1569 , V_487 , V_1568 ) ;
}
static void T_12 F_594 ( void )
{
static int V_1570 ;
if ( V_1570 ++ == 0 )
F_48 ( L_193 , V_1227 ) ;
}
static struct V_308 * T_12 F_595 (
...
struct V_308 * V_11 ;
struct V_3 * V_4 ;
V_11 = F_596 ( sizeof( struct V_3 ) , V_1483 ) ;
if ( ! V_11 )
return NULL ;
F_597 ( V_11 , V_1571 ) ;
V_4 = F_402 ( V_11 ) ;
...
V_4 -> V_1241 = V_1573 ;
F_570 ( & V_4 -> V_155 ) ;
F_598 ( & V_4 -> V_1123 , F_438 ) ;
V_4 -> V_30 = V_30 ;
return V_11 ;
}
static void T_12 F_599 ( struct V_308 * V_11 )
{
V_11 -> V_1574 = & V_1575 ;
V_11 -> V_1576 = & V_1577 ;
V_11 -> V_1578 = V_1579 ;
}
static void T_12 F_600 ( struct V_3 * V_4 )
{
struct V_308 * V_11 = V_4 -> V_11 ;
...
static void T_12 F_601 ( struct V_308 * V_11 )
{
V_11 -> V_1580 = V_1581 | V_1582 | V_553 ;
V_11 -> V_552 |= V_11 -> V_1580 | V_1583 ;
}
static int T_12 F_602 ( struct V_1516 * V_1233 ,
...
V_10 = F_603 ( V_1233 ) ;
if ( V_10 ) {
F_226 ( & V_1233 -> V_11 , L_217 ) ;
return V_10 ;
}
if ( ! ( F_604 ( V_1233 , 0 ) & V_1589 ) ||
! ( F_604 ( V_1233 , 2 ) & V_1589 ) ) {
F_226 ( & V_1233 -> V_11 , L_218 ) ;
V_10 = - V_8 ;
goto V_1590;
}
V_10 = F_605 ( V_1233 , V_1226 ) ;
if ( V_10 ) {
F_226 ( & V_1233 -> V_11 , L_219 ) ;
goto V_1590;
}
V_1586 = F_606 ( V_1233 ) ;
if ( V_1586 <= 0 ) {
F_226 ( & V_1233 -> V_11 , L_220 ) ;
goto V_1591;
}
V_11 = F_595 ( & V_1233 -> V_11 , V_1233 , NULL ,
& V_1592 , F_607 ( V_1233 -> V_1593 ) ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1591;
}
...
V_1585 . V_1594 . V_1595 = F_608 ( V_1233 -> V_1596 ) ;
V_1585 . V_1594 . V_1596 = V_1233 -> V_1596 -> V_1597 ;
V_1585 . V_1594 . V_508 = F_609 ( V_1233 -> V_1593 ) ;
V_4 -> V_25 = F_572 ( V_4 , & V_1585 ,
V_1546 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
goto V_1598;
}
F_610 ( V_1233 , V_1586 + V_1599 , & V_1588 ) ;
V_1588 &= ~ V_1600 ;
V_1588 |= ( V_1601 |
V_1602 |
V_1603 |
V_1604 |
V_1605 ) ;
F_611 ( V_1233 , V_1586 + V_1599 , V_1588 ) ;
V_1587 = F_612 ( 44 ) ;
V_10 = F_613 ( V_1233 , V_1587 ) ;
if ( ! V_10 ) {
V_11 -> V_552 |= V_1606 ;
V_10 = F_614 ( V_1233 , V_1587 ) ;
if ( V_10 ) {
F_226 ( & V_1233 -> V_11 , L_221 ) ;
goto V_1607;
}
}
if ( V_10 || V_1587 == F_612 ( 32 ) ) {
V_10 = F_613 ( V_1233 , F_612 ( 32 ) ) ;
if ( V_10 ) {
F_226 ( & V_1233 -> V_11 , L_222 ) ;
goto V_1607;
}
}
F_601 ( V_11 ) ;
V_11 -> V_1608 |= V_1609 ;
V_4 -> V_1504 = F_615 ( V_1233 , 0 ) ;
if ( ! V_4 -> V_1504 ) {
F_226 ( & V_1233 -> V_11 , L_223 ) ;
V_10 = - V_506 ;
goto V_1607;
}
F_616 ( V_1233 ) ;
...
if ( V_10 ) {
if ( V_10 != - V_8 )
F_226 ( & V_1233 -> V_11 , L_224 ) ;
goto V_1610;
}
V_10 = F_618 ( V_11 ) ;
if ( V_10 ) {
F_226 ( & V_1233 -> V_11 , L_225 ) ;
goto V_1610;
}
F_619 ( V_1233 , V_11 ) ;
F_600 ( V_4 ) ;
...
static void T_13 F_624 ( struct V_1516 * V_1233 )
{
struct V_308 * V_11 = F_625 ( V_1233 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_402 ( V_11 ) ;
F_626 ( V_11 ) ;
if ( V_4 -> V_1504 ) {
...
static int F_627 ( struct V_1516 * V_1233 , T_17 V_1377 )
{
struct V_308 * V_11 = F_625 ( V_1233 ) ;
struct V_3 * V_4 = F_402 ( V_11 ) ;
unsigned long V_87 ;
...
static int F_630 ( struct V_1516 * V_1233 )
{
struct V_308 * V_11 = F_625 ( V_1233 ) ;
struct V_3 * V_4 = F_402 ( V_11 ) ;
unsigned long V_87 ;
...
static void * F_633 ( struct V_508 * V_11 , T_15 V_487 ,
T_1 * V_1611 , T_6 V_1564 )
{
unsigned long V_1612 = F_634 ( V_487 ) ;
unsigned long V_485 = F_635 ( V_1564 , V_1612 ) ;
if ( V_485 == 0UL )
return NULL ;
...
static void F_637 ( struct V_508 * V_11 , T_15 V_487 ,
void * V_1566 , T_1 V_1563 )
{
unsigned long V_1612 = F_634 ( V_487 ) ;
F_638 ( ( unsigned long ) V_1566 , V_1612 ) ;
}
static T_1 F_639 ( struct V_508 * V_11 , struct V_485 * V_485 ,
unsigned long V_486 , T_15 V_487 ,
enum V_1567 V_1568 )
{
return F_640 ( V_485 ) + V_486 ;
}
static void F_641 ( struct V_508 * V_11 , T_1 V_1569 ,
T_15 V_487 , enum V_1567 V_1568 )
{
}
static T_1 F_642 ( struct V_508 * V_11 , void * V_1566 ,
T_15 V_487 ,
enum V_1567 V_1568 )
{
return F_636 ( V_1566 ) ;
}
static void F_643 ( struct V_508 * V_11 , T_1 V_1569 ,
T_15 V_487 ,
enum V_1567 V_1568 )
{
}
static int T_12 F_644 ( struct V_1522 * V_1523 )
{
union V_1549 V_1585 ;
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
int V_10 ;
F_594 () ;
V_1 = F_545 ( V_1523 -> V_11 . V_1525 , L_226 , NULL ) ;
if ( ! V_1 ) {
F_226 ( & V_1523 -> V_11 , L_227 ,
V_1523 -> V_11 . V_1525 -> V_1535 ) ;
return - V_8 ;
}
V_11 = F_595 ( & V_1523 -> V_11 , NULL , V_1523 ,
& V_1613 , V_1 [ 0 ] & 0x1 ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1614;
...
V_4 = F_402 ( V_11 ) ;
memset ( & V_1585 , 0 , sizeof( V_1585 ) ) ;
V_1585 . V_1615 = F_645 ( V_1523 -> V_11 . V_1525 ) ;
V_4 -> V_25 = F_572 ( V_4 , & V_1585 ,
V_343 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
...
F_601 ( V_11 ) ;
V_4 -> V_1504 = F_646 ( & V_1523 -> V_1616 [ 1 ] , 0 ,
F_647 ( & V_1523 -> V_1616 [ 1 ] ) ,
L_228 ) ;
if ( ! V_4 -> V_1504 ) {
...
V_4 -> V_1617 = F_646 ( & V_1523 -> V_1616 [ 2 ] , 0 ,
F_647 ( & V_1523 -> V_1616 [ 2 ] ) ,
L_229 ) ;
if ( ! V_4 -> V_1617 ) {
...
V_4 -> V_1618 = F_646 ( & V_1523 -> V_1616 [ 3 ] , 0 ,
F_647 ( & V_1523 -> V_1616 [ 3 ] ) ,
L_231 ) ;
if ( ! V_4 -> V_1618 ) {
...
F_648 ( & V_1523 -> V_11 , V_11 ) ;
F_600 ( V_4 ) ;
return 0 ;
V_1610:
if ( V_4 -> V_1617 ) {
F_649 ( & V_1523 -> V_1616 [ 2 ] , V_4 -> V_1617 ,
F_647 ( & V_1523 -> V_1616 [ 2 ] ) ) ;
V_4 -> V_1617 = NULL ;
}
if ( V_4 -> V_1618 ) {
F_649 ( & V_1523 -> V_1616 [ 3 ] , V_4 -> V_1618 ,
F_647 ( & V_1523 -> V_1616 [ 3 ] ) ) ;
V_4 -> V_1618 = NULL ;
}
if ( V_4 -> V_1504 ) {
F_649 ( & V_1523 -> V_1616 [ 1 ] , V_4 -> V_1504 ,
F_647 ( & V_1523 -> V_1616 [ 1 ] ) ) ;
V_4 -> V_1504 = NULL ;
}
V_1607:
...
static int T_13 F_650 ( struct V_1522 * V_1523 )
{
struct V_308 * V_11 = F_651 ( & V_1523 -> V_11 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_402 ( V_11 ) ;
F_626 ( V_11 ) ;
if ( V_4 -> V_1617 ) {
...
F_578 ( V_4 ) ;
F_621 ( V_11 ) ;
F_648 ( & V_1523 -> V_11 , NULL ) ;
}
return 0 ;
}
static int T_18 F_652 ( void )
{
int V_10 = 0 ;
F_271 ( V_509 < 4 * 1024 ) ;
V_1573 = F_653 ( V_1619 , V_1620 ) ;
#ifdef F_544
V_10 = F_654 ( & V_1621 ) ;
#endif
if ( ! V_10 ) {
