...
static int F_95 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
unsigned int V_180 ;
unsigned int V_35 ;
...
static struct V_249 * F_111 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
F_71 ( V_28 ) ;
V_28 -> V_159 . V_195 += F_7 ( V_2 , V_239 ) ;
...
static T_6 F_115 ( int V_135 , void * V_261 )
{
...
static int F_122 ( struct V_23 * V_28 , void * V_272 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
...
static int F_124 ( struct V_23 * V_28 , struct V_278 * V_279 , int V_280 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
if ( ! F_123 ( V_28 ) || ! V_2 -> V_88 )
return - V_281 ;
return F_125 ( V_2 -> V_88 , V_279 , V_280 ) ;
}
static int
F_126 ( struct V_23 * V_28 , struct V_282 * V_280 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
V_280 -> V_283 = 1 ;
V_280 -> V_284 = 1 ;
return F_127 ( V_2 -> V_88 , V_280 ) ;
}
static int
F_128 ( struct V_23 * V_28 , struct V_282 * V_280 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
return F_129 ( V_2 -> V_88 , V_280 ) ;
}
static void F_130 ( struct V_23 * V_28 ,
struct V_285 * V_286 )
{
F_131 ( V_286 -> V_287 , V_288 , sizeof( V_286 -> V_287 ) ) ;
F_131 ( V_286 -> V_289 , V_290 , sizeof( V_286 -> V_289 ) ) ;
F_131 ( V_286 -> V_291 , F_63 ( V_28 -> V_28 . V_153 ) ,
sizeof( V_286 -> V_291 ) ) ;
}
static int F_132 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
return F_133 ( V_2 -> V_88 ) ;
}
static T_1 F_134 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
return V_2 -> V_292 ;
}
static void F_135 ( struct V_23 * V_28 , T_1 V_293 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
V_2 -> V_292 = V_293 ;
}
static int F_136 ( struct V_23 * V_28 )
{
return ( ( ( V_294 - V_295 ) / 4 + 1 ) + ( V_296 - V_99 ) + 1 + 32 ) *
sizeof( T_1 ) ;
}
static void
F_137 ( struct V_23 * V_28 , struct V_297 * V_298 ,
void * V_15 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
struct V_87 * V_88 = V_2 -> V_88 ;
...
static int F_139 ( struct V_1 * V_2 , T_1 V_300 )
{
int V_180 = 100 ;
T_1 V_301 ;
...
static int F_142 ( struct V_23 * V_28 )
{
return V_307 ;
}
...
int V_29 ;
F_138 ( V_2 ) ;
V_247 = F_144 ( V_309 -> V_247 , V_307 ) ;
for ( V_29 = 0 ; V_29 < V_247 ; V_29 ++ ) {
int V_25 = F_140 ( V_2 , V_29 , V_310 ) ;
if ( V_25 < 0 ) {
V_309 -> V_247 = 0 ;
return V_25 ;
}
...
static int F_145 ( struct V_23 * V_28 ,
struct V_308 * V_309 , T_4 * V_9 )
{
int V_25 ;
struct V_1 * V_2 = F_24 ( V_28 ) ;
F_138 ( V_2 ) ;
F_139 ( V_2 , V_311 ) ;
V_25 = F_141 ( V_2 , V_309 -> V_34 , * V_9 ) ;
F_139 ( V_2 , V_312 ) ;
V_309 -> V_247 = 1 ;
return V_25 ;
}
static void T_5 F_146 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
...
static int T_5 F_147 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
unsigned int V_313 ;
...
F_150 ( V_28 ) ;
V_28 -> V_5 |= V_319 ;
F_151 ( V_28 , & V_2 -> V_184 , F_74 , V_320 ) ;
V_28 -> V_321 = & V_322 ;
V_28 -> V_323 = & V_324 ;
return 0 ;
}
static int T_7 F_152 ( struct V_21 * V_22 )
{
struct V_23 * V_28 ;
struct V_1 * V_2 ;
struct V_325 * V_326 ;
...
F_154 ( V_22 , NULL ) ;
F_155 ( V_28 ) ;
F_156 ( V_28 -> V_135 , V_28 ) ;
V_326 = F_157 ( V_22 , V_327 ,
L_104 ) ;
if ( ! V_326 )
V_326 = F_158 ( V_22 , V_327 , 0 ) ;
F_159 ( V_326 -> V_328 , F_160 ( V_326 ) ) ;
F_161 ( V_2 -> V_7 ) ;
( void ) F_28 ( V_22 ) ;
F_32 ( V_22 ) ;
F_162 ( V_28 ) ;
...
if ( ! V_331 )
return - V_129 ;
V_4 -> V_132 = F_164 ( V_331 ) ;
V_332 = F_165 ( V_331 ) ;
if ( V_332 )
memcpy ( V_4 -> V_332 , V_332 , V_91 ) ;
F_166 ( V_331 , L_105 , & V_4 -> V_334 ) ;
F_166 ( V_331 , L_106 , & V_333 ) ;
if ( V_333 == 4 )
V_4 -> V_5 |= V_6 ;
else
V_4 -> V_5 |= V_8 ;
if ( F_167 ( V_331 , L_107 , NULL ) )
V_4 -> V_226 = V_335 ;
if ( F_167 ( V_331 , L_108 , NULL ) )
V_4 -> V_228 = V_336 ;
if ( F_167 ( V_331 , L_109 , NULL ) )
V_4 -> V_5 |= V_57 ;
if ( F_167 ( V_331 , L_110 , NULL ) )
V_4 -> V_5 |= V_59 ;
if ( F_167 ( V_331 , L_111 , NULL ) )
V_4 -> V_5 |= V_318 ;
return 0 ;
}
...
static int T_5 F_168 ( struct V_21 * V_22 )
{
...
V_340 = F_160 ( V_326 ) ;
V_339 = F_158 ( V_22 , V_344 , 0 ) ;
if ( ! V_339 ) {
F_170 ( L_114 ) ;
V_342 = - V_129 ;
goto V_343;
}
if ( ! F_171 ( V_326 -> V_328 , V_340 , V_288 ) ) {
V_342 = - V_274 ;
goto V_343;
}
V_28 = F_172 ( sizeof( struct V_1 ) ) ;
if ( ! V_28 ) {
V_342 = - V_143 ;
goto V_345;
}
F_173 ( V_28 , & V_22 -> V_28 ) ;
V_2 = F_24 ( V_28 ) ;
V_28 -> V_135 = V_339 -> V_328 ;
V_341 = V_339 -> V_5 & V_346 ;
V_2 -> V_7 = F_174 ( V_326 -> V_328 , V_340 ) ;
V_2 -> V_28 = V_28 ;
V_2 -> V_292 = ( ( 1 << V_347 ) - 1 ) ;
F_154 ( V_22 , V_28 ) ;
V_342 = F_30 ( V_22 ) ;
...
F_14 ( V_2 , V_191 , 0 ) ;
F_14 ( V_2 , V_189 , 0xFFFFFFFF ) ;
V_342 = F_175 ( V_28 -> V_135 , F_115 ,
V_341 | V_352 , V_28 -> V_134 , V_28 ) ;
if ( V_342 ) {
F_36 ( V_2 , V_130 ,
L_117 , V_28 -> V_135 ) ;
goto V_349;
...
static int F_179 ( struct V_355 * V_28 )
{
struct V_23 * V_24 = F_180 ( V_28 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
F_14 ( V_2 , V_315 ,
V_356 | V_357 |
V_358 | V_359 ) ;
...
static int F_181 ( struct V_355 * V_28 )
{
struct V_23 * V_24 = F_180 ( V_28 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
unsigned int V_314 = 100 ;
