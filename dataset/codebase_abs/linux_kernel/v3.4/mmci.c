...
static int T_3 F_85 ( struct V_221 * V_62 ,
const struct V_222 * V_223 )
{
struct V_49 * V_50 = V_62 -> V_62 . V_224 ;
struct V_11 * V_12 = V_223 -> V_31 ;
struct V_1 * V_2 ;
struct V_115 * V_21 ;
int V_111 ;
if ( ! V_50 ) {
...
V_111 = F_86 ( V_62 , V_225 ) ;
if ( V_111 )
goto V_202;
V_21 = F_87 ( sizeof( struct V_1 ) , & V_62 -> V_62 ) ;
if ( ! V_21 ) {
V_111 = - V_109 ;
goto V_226;
}
...
V_2 -> V_214 = F_88 ( V_62 ) ;
V_2 -> V_228 = F_89 ( V_62 ) ;
F_47 ( F_10 ( V_21 ) , L_20 , V_2 -> V_214 ) ;
F_47 ( F_10 ( V_21 ) , L_21 , V_2 -> V_228 ) ;
V_2 -> V_3 = F_90 ( & V_62 -> V_62 , NULL ) ;
if ( F_91 ( V_2 -> V_3 ) ) {
V_111 = F_92 ( V_2 -> V_3 ) ;
V_2 -> V_3 = NULL ;
goto V_229;
...
V_2 -> V_50 = V_50 ;
V_2 -> V_12 = V_12 ;
V_2 -> V_14 = F_95 ( V_2 -> V_3 ) ;
if ( V_2 -> V_14 > 100000000 ) {
V_111 = F_96 ( V_2 -> V_3 , 100000000 ) ;
if ( V_111 < 0 )
goto V_232;
V_2 -> V_14 = F_95 ( V_2 -> V_3 ) ;
F_47 ( F_10 ( V_21 ) , L_22 ,
...
V_2 -> V_83 = V_62 -> V_233 . V_234 ;
V_2 -> V_5 = F_97 ( V_62 -> V_233 . V_234 , F_98 ( & V_62 -> V_233 ) ) ;
if ( ! V_2 -> V_5 ) {
V_111 = - V_109 ;
goto V_232;
}
V_21 -> V_235 = & V_236 ;
if ( V_12 -> V_16 )
V_21 -> V_237 = F_5 ( V_2 -> V_14 , 257 ) ;
else
V_21 -> V_237 = F_5 ( V_2 -> V_14 , 512 ) ;
if ( V_50 -> V_238 )
V_21 -> V_238 = F_60 ( V_2 -> V_14 , V_50 -> V_238 ) ;
else
V_21 -> V_238 = F_60 ( V_2 -> V_14 , V_239 ) ;
F_47 ( F_10 ( V_21 ) , L_23 , V_21 -> V_238 ) ;
#ifdef F_99
V_2 -> V_199 = F_100 ( & V_62 -> V_62 , L_24 ) ;
if ( F_91 ( V_2 -> V_199 ) )
V_2 -> V_199 = NULL ;
else {
int V_33 = F_101 ( V_2 -> V_199 ) ;
if ( V_33 < 0 )
F_22 ( & V_62 -> V_62 , L_25 ,
V_33 ) ;
else {
V_2 -> V_21 -> V_240 = ( T_1 ) V_33 ;
if ( V_50 -> V_241 )
F_23 ( & V_62 -> V_62 ,
L_26
L_27 ) ;
...
#endif
if ( V_2 -> V_199 == NULL )
V_21 -> V_240 = V_50 -> V_241 ;
V_21 -> V_242 = V_50 -> V_243 ;
V_21 -> V_244 = V_50 -> V_245 ;
V_21 -> V_246 = V_247 ;
V_21 -> V_248 = ( 1 << V_12 -> V_249 ) - 1 ;
V_21 -> V_63 = V_21 -> V_248 ;
V_21 -> V_250 = 1 << 11 ;
V_21 -> V_251 = V_21 -> V_248 >> 11 ;
F_102 ( & V_2 -> V_191 ) ;
F_2 ( 0 , V_2 -> V_5 + V_36 ) ;
F_2 ( 0 , V_2 -> V_5 + V_38 ) ;
F_2 ( 0xfff , V_2 -> V_5 + V_192 ) ;
if ( F_103 ( V_50 -> V_219 ) ) {
V_111 = F_104 ( V_50 -> V_219 , V_225 L_28 ) ;
if ( V_111 == 0 )
V_111 = F_105 ( V_50 -> V_219 ) ;
if ( V_111 == 0 )
V_2 -> V_219 = V_50 -> V_219 ;
else if ( V_111 != - V_119 )
goto V_252;
V_111 = F_106 ( F_107 ( V_50 -> V_219 ) ,
F_82 ,
V_253 | V_254 ,
V_225 L_28 , V_2 ) ;
if ( V_111 >= 0 )
V_2 -> V_227 = F_107 ( V_50 -> V_219 ) ;
}
if ( F_103 ( V_50 -> V_218 ) ) {
V_111 = F_104 ( V_50 -> V_218 , V_225 L_29 ) ;
if ( V_111 == 0 )
V_111 = F_105 ( V_50 -> V_218 ) ;
if ( V_111 == 0 )
...
&& V_2 -> V_227 < 0 )
V_21 -> V_242 |= V_256 ;
V_111 = F_108 ( V_62 -> V_181 [ 0 ] , F_67 , V_257 , V_225 L_30 , V_2 ) ;
if ( V_111 )
goto V_258;
if ( V_62 -> V_181 [ 1 ] == V_259 || ! V_62 -> V_181 [ 1 ] )
V_2 -> V_34 = true ;
else {
V_111 = F_108 ( V_62 -> V_181 [ 1 ] , F_62 , V_257 ,
V_225 L_31 , V_2 ) ;
if ( V_111 )
goto V_260;
}
F_2 ( V_261 , V_2 -> V_5 + V_36 ) ;
F_109 ( V_62 , V_21 ) ;
F_18 ( & V_62 -> V_62 , L_32 ,
F_110 ( V_21 ) , F_111 ( V_62 ) , F_88 ( V_62 ) ,
F_89 ( V_62 ) , ( unsigned long long ) V_62 -> V_233 . V_234 ,
...
static int T_6 F_123 ( struct V_221 * V_62 )
{
struct V_115 * V_21 = F_124 ( V_62 ) ;
F_109 ( V_62 , NULL ) ;
if ( V_21 ) {
struct V_1 * V_2 = F_44 ( V_21 ) ;
F_74 ( & V_62 -> V_62 ) ;
...
static int F_127 ( struct V_61 * V_62 )
{
struct V_221 * V_262 = F_128 ( V_62 ) ;
struct V_115 * V_21 = F_124 ( V_262 ) ;
int V_111 = 0 ;
if ( V_21 ) {
struct V_1 * V_2 = F_44 ( V_21 ) ;
V_111 = F_129 ( V_21 ) ;
...
static int F_130 ( struct V_61 * V_62 )
{
struct V_221 * V_262 = F_128 ( V_62 ) ;
struct V_115 * V_21 = F_124 ( V_262 ) ;
int V_111 = 0 ;
