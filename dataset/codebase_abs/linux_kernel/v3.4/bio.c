...
F_51 ( V_70 ) ,
F_52 ( V_70 ) / ( V_86 >> 9 ) + 1 ) ;
return F_50 ( unsigned , V_85 , V_38 ) ;
}
static int F_53 ( struct V_69 * V_70 , struct V_4 * V_4 , struct V_87
...
int F_55 ( struct V_69 * V_70 , struct V_4 * V_4 , struct V_87 * V_87 ,
unsigned int V_88 , unsigned int V_89 )
{
return F_53 ( V_70 , V_4 , V_87 , V_88 , V_89 ,
F_56 ( V_70 ) ) ;
}
int F_57 ( struct V_4 * V_4 , struct V_87 * V_87 , unsigned int V_88 ,
unsigned int V_89 )
{
struct V_69 * V_70 = F_49 ( V_4 -> V_75 ) ;
return F_53 ( V_70 , V_4 , V_87 , V_88 , V_89 , F_52 ( V_70 ) ) ;
}
static void F_58 ( struct V_100 * V_101 , struct V_4 * V_4 ,
...
static struct V_100 * F_60 ( int V_110 ,
unsigned int V_104 ,
T_1 V_35 )
{
struct V_100 * V_101 ;
...
static int F_61 ( struct V_4 * V_4 , struct V_28 * V_106 ,
struct V_102 * V_103 , int V_104 ,
...
F_62 (bvec, bio, i, 0 ) {
char * V_116 = F_63 ( V_92 -> V_67 ) ;
unsigned int V_66 = V_106 [ V_8 ] . V_66 ;
while ( V_66 && V_114 < V_104 ) {
unsigned int V_117 ;
char T_2 * V_118 ;
V_117 = F_50 (unsigned int,
iov[iov_idx].iov_len - iov_off, bv_len) ;
V_118 = V_103 [ V_114 ] . V_119 + V_115 ;
if ( ! V_82 ) {
if ( V_111 )
V_82 = F_64 ( V_118 , V_116 ,
V_117 ) ;
if ( V_112 )
V_82 = F_65 ( V_116 , V_118 ,
V_117 ) ;
if ( V_82 )
V_82 = - V_120 ;
}
...
int V_82 = 0 ;
if ( ! F_43 ( V_4 , V_122 ) )
V_82 = F_61 ( V_4 , V_101 -> V_106 , V_101 -> V_107 ,
V_101 -> V_108 , F_68 ( V_4 ) == V_123 ,
0 , V_101 -> V_105 ) ;
F_59 ( V_101 ) ;
F_39 ( V_4 ) ;
return V_82 ;
...
V_87 = F_71 ( V_70 -> V_139 | V_35 ) ;
if ( ! V_87 ) {
V_82 = - V_133 ;
break;
}
}
if ( F_55 ( V_70 , V_4 , V_87 , V_117 , V_89 ) < V_117 )
break;
V_88 -= V_117 ;
V_89 = 0 ;
}
...
( V_125 && V_125 -> V_112 ) ) {
V_82 = F_61 ( V_4 , V_4 -> V_47 , V_103 , V_104 , 0 , 1 , 0 ) ;
if ( V_82 )
goto V_140;
}
F_58 ( V_101 , V_4 , V_103 , V_104 , V_125 ? 0 : 1 ) ;
return V_4 ;
V_140:
if ( ! V_125 )
F_35 (bvec, bio, i)
...
struct V_4 * F_72 ( struct V_69 * V_70 , struct V_124 * V_125 ,
...
V_103 . V_121 = V_88 ;
return F_69 ( V_70 , V_125 , & V_103 , 1 , V_126 , V_35 ) ;
}
...
return F_70 ( - V_133 ) ;
V_82 = - V_133 ;
V_138 = F_75 ( V_85 , sizeof( struct V_87 * ) , V_35 ) ;
if ( ! V_138 )
goto V_24;
for ( V_8 = 0 ; V_8 < V_104 ; V_8 ++ ) {
unsigned long V_128 = ( unsigned long ) V_103 [ V_8 ] . V_119 ;
...
if ( V_117 > V_88 )
V_117 = V_88 ;
if ( F_55 ( V_70 , V_4 , V_138 [ V_142 ] , V_117 , V_89 ) <
V_117 )
break;
V_88 -= V_117 ;
V_89 = 0 ;
...
V_103 . V_119 = ( void T_2 * ) V_128 ;
V_103 . V_121 = V_88 ;
return F_79 ( V_70 , V_84 , & V_103 , 1 , V_126 , V_35 ) ;
}
...
{
struct V_4 * V_4 ;
V_4 = F_73 ( V_70 , V_84 , V_103 , V_104 , V_126 ,
V_35 ) ;
if ( F_80 ( V_4 ) )
return V_4 ;
F_81 ( V_4 ) ;
...
if ( V_117 > V_88 )
V_117 = V_88 ;
if ( F_55 ( V_70 , V_4 , F_88 ( V_65 ) , V_117 ,
V_89 ) < V_117 )
break;
V_65 += V_117 ;
V_88 -= V_117 ;
...
struct V_4 * F_89 ( struct V_69 * V_70 , void * V_65 , unsigned int V_88 ,
T_1 V_35 )
{
struct V_4 * V_4 ;
V_4 = F_86 ( V_70 , V_65 , V_88 , V_35 ) ;
if ( F_80 ( V_4 ) )
return V_4 ;
if ( V_4 -> V_79 == V_88 )
return V_4 ;
...
{
struct V_28 * V_92 ;
const int V_151 = F_68 ( V_4 ) == V_123 ;
struct V_100 * V_101 = V_4 -> V_109 ;
int V_8 ;
char * V_46 = V_101 -> V_107 [ 0 ] . V_119 ;
F_62 (bvec, bio, i, 0 ) {
char * V_152 = F_63 ( V_92 -> V_67 ) ;
...
struct V_4 * F_91 ( struct V_69 * V_70 , void * V_65 , unsigned int V_88 ,
T_1 V_35 , int V_153 )
{
struct V_4 * V_4 ;
struct V_28 * V_92 ;
int V_8 ;
V_4 = F_72 ( V_70 , NULL , ( unsigned long ) V_65 , V_88 , 1 , V_35 ) ;
if ( F_80 ( V_4 ) )
return V_4 ;
if ( ! V_153 ) {
void * V_46 = V_65 ;
