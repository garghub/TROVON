...
static const struct V_51 * T_6 F_68 ( struct V_137 * V_138 )
{
...
struct V_143 V_116 ;
int V_144 , V_97 ;
F_69 ( & V_116 , V_138 -> V_145 ) ;
while ( F_70 ( & V_116 , & V_144 , & V_97 ) )
if ( V_144 == V_146 )
switch ( V_97 ) {
case V_147 :
return & V_139 ;
...
static int T_6 F_71 ( struct V_62 * V_149 )
{
struct V_132 * V_61 = V_132 ( V_149 ) ;
struct V_137 * V_150 = F_72 ( V_61 ) ;
struct V_136 * V_92 ;
struct V_49 * V_49 ;
T_4 V_151 ;
int V_21 ;
V_21 = F_73 ( - 1 , NULL , V_152 , sizeof( * V_49 ) , & V_92 ) ;
if ( V_21 < 0 )
return V_21 ;
F_74 ( V_92 , V_149 ) ;
V_49 = V_92 -> V_50 ;
...
F_75 ( & V_49 -> V_65 ) ;
V_49 -> V_61 = F_76 ( V_61 ) ;
V_49 -> V_51 = F_68 ( V_150 ) ;
if ( ! V_49 -> V_51 ) {
V_21 = - V_153 ;
goto V_154;
}
V_21 = F_77 ( & V_49 -> V_56 , V_61 , 0 ) ;
if ( V_21 < 0 )
goto V_154;
V_21 = F_78 ( & V_49 -> V_55 , V_61 , V_155 ) ;
if ( V_21 < 0 )
goto V_71;
V_92 -> V_156 = F_63 ;
...
F_79 ( & V_61 -> V_62 ) , 100 << V_150 -> V_160 ) ;
...
static int T_7 F_83 ( struct V_62 * V_138 )
{
struct V_49 * V_49 = F_84 ( V_138 ) ;
F_85 ( & V_49 -> V_55 ) ;
F_86 ( V_49 -> V_92 ) ;
F_25 ( & V_49 -> V_65 ) ;
F_15 ( V_49 ) ;
...
static void F_88 ( struct V_132 * V_61 )
{
struct V_49 * V_49 = F_84 ( & V_61 -> V_62 ) ;
F_89 ( V_49 -> V_61 ) ;
if ( F_90 ( & V_49 -> V_56 ) < 0 ) {
F_85 ( & V_49 -> V_55 ) ;
F_25 ( & V_49 -> V_65 ) ;
