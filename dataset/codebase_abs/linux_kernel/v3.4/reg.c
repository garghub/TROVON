...
( int ) F_53 ( V_62 -> V_64 ) ) ;
V_98 -> V_118 = ( int ) F_54 ( V_62 -> V_63 ) ;
V_98 -> V_115 = F_41 ( V_98 -> V_115 , V_98 -> V_118 ) ;
}
...
V_98 = & V_104 -> V_109 [ V_101 ] ;
if ( F_58 ( V_98 -> V_83 != V_120 -> V_98 . V_83 ) )
return;
if ( V_98 -> V_117 )
return;
V_98 -> V_117 = true ;
...
return 0 ;
case V_89 :
V_140 = F_52 ( V_6 -> V_106 ) ;
if ( F_76 ( ! F_11 ( V_139 -> V_10 ) ) )
return - V_66 ;
if ( V_6 -> V_88 ==
V_89 ) {
if ( V_140 != V_82 ) {
...
static void F_83 ( struct V_138 * V_153 ,
enum V_94 V_154 )
{
int V_30 = 0 ;
...
F_6 ( ! V_153 -> V_10 ) ;
if ( F_84 ( V_153 -> V_106 ) )
V_82 = F_52 ( V_153 -> V_106 ) ;
if ( V_154 == V_96 &&
! V_82 ) {
F_4 ( V_153 ) ;
return;
}
V_30 = F_81 ( V_82 , V_153 ) ;
if ( V_30 == - V_142 && V_82 &&
V_82 -> V_65 & V_113 ) {
F_69 ( V_82 , V_154 ) ;
return;
...
static void F_94 ( struct V_138 * V_27 )
{
...
static void F_100 ( char * V_10 , bool V_170 )
{
V_10 [ 0 ] = '9' ;
V_10 [ 1 ] = '7' ;
if ( F_15 () ) {
...
static bool F_105 ( T_3 V_175 )
{
if ( V_175 == F_106 ( 12 , V_176 ) ||
V_175 == F_106 ( 13 , V_176 ) ||
V_175 == F_106 ( 14 , V_176 ) )
return true ;
return false ;
}
...
int F_119 ( struct V_186 * V_39 , struct V_187 * V_164 )
{
if ( V_6 && ! V_6 -> V_147 ) {
if ( F_120 ( V_164 , L_55 ,
V_6 -> V_10 [ 0 ] ,
