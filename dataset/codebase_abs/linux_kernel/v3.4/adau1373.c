...
if ( V_103 ) {
if ( V_103 -> V_109 > F_33 ( V_103 -> V_110 ) )
return - V_32 ;
if ( ! F_29 ( V_103 -> V_111 ) ||
! F_29 ( V_103 -> V_112 ) )
return - V_32 ;
for ( V_75 = 0 ; V_75 < V_103 -> V_109 ; ++ V_75 ) {
F_27 ( V_7 , V_75 ,
V_103 -> V_110 [ V_75 ] ) ;
}
F_34 ( V_7 , V_113 ,
...
static int T_2 F_41 ( struct V_137 * V_138 ,
const struct V_139 * V_28 )
{
struct V_14 * V_14 ;
int V_107 ;
V_14 = F_42 ( & V_138 -> V_104 , sizeof( * V_14 ) , V_140 ) ;
if ( ! V_14 )
return - V_141 ;
F_43 ( & V_138 -> V_104 , V_14 ) ;
V_107 = F_44 ( & V_138 -> V_104 , & V_142 ,
V_143 , F_33 ( V_143 ) ) ;
return V_107 ;
}
static int T_3 F_45 ( struct V_137 * V_138 )
{
F_46 ( & V_138 -> V_104 ) ;
return 0 ;
}
