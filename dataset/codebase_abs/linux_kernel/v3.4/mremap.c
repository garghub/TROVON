...
if ( V_8 -> V_40 & V_82 )
V_77 |= V_83 ;
V_76 = F_59 ( V_8 -> V_23 , V_14 , V_39 , V_8 -> V_50 +
( ( V_3 - V_8 -> V_51 ) >> V_52 ) ,
V_77 ) ;
if ( V_76 & ~ V_78 )
goto V_84;
...
static int F_60 ( struct V_7 * V_8 , unsigned long V_85 )
{
...
return 0 ;
if ( F_59 ( NULL , V_8 -> V_51 , V_86 - V_8 -> V_51 ,
0 , V_81 ) & ~ V_78 )
return 0 ;
return 1 ;
}
unsigned long F_61 ( unsigned long V_3 ,
unsigned long V_38 , unsigned long V_39 ,
unsigned long V_87 , unsigned long V_14 )
{
struct V_1 * V_2 = V_60 -> V_2 ;
struct V_7 * V_8 ;
unsigned long V_76 = - V_74 ;
...
if ( V_38 == V_8 -> V_54 - V_3 ) {
if ( F_60 ( V_8 , V_39 - V_38 ) ) {
int V_90 = ( V_39 - V_38 ) >> V_52 ;
if ( F_63 ( V_8 , V_8 -> V_51 , V_3 + V_39 ,
V_8 -> V_50 , NULL ) ) {
V_76 = - V_48 ;
goto V_79;
}
V_2 -> V_55 += V_90 ;
F_43 ( V_2 , V_8 -> V_40 , V_8 -> V_23 , V_90 ) ;
if ( V_8 -> V_40 & V_57 ) {
V_2 -> V_58 += V_90 ;
F_46 ( V_8 , V_3 + V_38 ,
V_3 + V_39 ) ;
