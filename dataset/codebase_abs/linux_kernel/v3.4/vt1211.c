...
{
struct V_6 * V_7 = F_11 ( V_10 ) ;
return sprintf ( V_46 , L_10 , V_7 -> V_78 ) ;
}
...
static int T_4 F_62 ( struct V_83 * V_84 )
{
struct V_9 * V_10 = & V_84 -> V_10 ;
struct V_6 * V_7 ;
struct V_92 * V_52 ;
int V_85 , V_59 ;
V_7 = F_63 ( sizeof( struct V_6 ) , V_93 ) ;
if ( ! V_7 ) {
V_59 = - V_94 ;
F_64 ( V_10 , L_11 ) ;
goto EXIT;
}
V_52 = F_65 ( V_84 , V_95 , 0 ) ;
if ( ! F_66 ( V_52 -> V_96 , F_67 ( V_52 ) , V_97 ) ) {
V_59 = - V_98 ;
F_64 ( V_10 , L_12 ,
( unsigned long ) V_52 -> V_96 , ( unsigned long ) V_52 -> V_99 ) ;
goto V_100;
}
V_7 -> V_8 = V_52 -> V_96 ;
V_7 -> V_78 = V_97 ;
...
static int T_5 F_77 ( struct V_83 * V_84 )
{
struct V_6 * V_7 = F_78 ( V_84 ) ;
struct V_92 * V_52 ;
F_79 ( V_7 -> V_102 ) ;
F_59 ( V_84 ) ;
F_69 ( V_84 , NULL ) ;
...
static int T_6 F_80 ( unsigned short V_104 )
{
struct V_92 V_52 = {
. V_96 = V_104 ,
. V_99 = V_104 + 0x7f ,
...
static int T_6 F_87 ( int V_1 , unsigned short * V_104 )
{
int V_59 = - V_107 ;
int V_108 ;
F_6 ( V_1 ) ;
V_108 = V_109 ? V_109 : F_3 ( V_1 , V_110 ) ;
if ( V_108 != V_111 )
goto EXIT;
F_5 ( V_1 , V_112 ) ;
if ( ( F_3 ( V_1 , V_113 ) & 1 ) == 0 ) {
F_88 ( L_18 ) ;
goto EXIT;
}
* V_104 = ( ( F_3 ( V_1 , V_114 ) << 8 ) |
( F_3 ( V_1 , V_114 + 1 ) ) ) & 0xff00 ;
if ( * V_104 == 0 ) {
F_88 ( L_19 ) ;
goto EXIT;
}
...
V_59 = F_87 ( V_116 , & V_104 ) ;
if ( V_59 ) {
V_59 = F_87 ( V_117 , & V_104 ) ;
if ( V_59 )
goto EXIT;
}
if ( ( V_20 < - 1 ) || ( V_20 > 31 ) ) {
