...
V_117 -> V_22 . V_160 = 64 << ( ( V_120 >> 22 ) & 7 ) ;
...
V_117 -> V_130 . V_160 = 64 << ( ( V_120 >> 13 ) & 7 ) ;
...
V_177 [ V_117 -> V_22 . V_27 ] , V_117 -> V_22 . V_127 ) ;
F_104 ( L_6 ,
V_100 >> 10 , V_177 [ V_117 -> V_130 . V_27 ] ,
...
{
unsigned long V_17 , V_4 , V_178 , V_20 , V_179 ;
unsigned int V_118 = F_97 () ;
struct V_116 * V_117 = & V_21 ;
if ( V_118 & V_163 )
return 0 ;
V_178 = ( unsigned long ) & V_180 ;
V_178 &= ~ ( ( 4 * 1024 * 1024 ) - 1 ) ;
V_20 = V_178 + ( 4 * 1024 * 1024 ) ;
F_17 ( V_17 ) ;
V_179 = ( 64 * 1024 ) ;
for ( V_4 = V_178 ; V_4 < V_20 ; V_4 = ( V_178 + V_179 ) ) {
unsigned long * V_181 = ( unsigned long * ) V_4 ;
...
F_79 ( V_184 , V_178 ) ;
V_179 = ( 128 * 1024 ) ;
for ( V_4 = V_178 + ( 128 * 1024 ) ; V_4 < V_20 ; V_4 = V_178 + V_179 ) {
F_79 ( V_185 , V_4 ) ;
__asm__ __volatile__("nop; nop; nop; nop;");
if ( ! F_106 () )
break;
...
V_4 -= V_178 ;
V_49 = V_4 ;
V_117 -> V_186 . V_127 = 16 << ( ( V_118 & V_187 ) >> 22 ) ;
V_117 -> V_186 . V_27 = 1 ;
V_117 -> V_130 . V_25 = 0 ;
return 1 ;
}
...
struct V_116 * V_117 = & V_21 ;
V_49 = 512 * 1024 ;
V_117 -> V_186 . V_127 = 32 ;
V_117 -> V_186 . V_27 = 4 ;
V_117 -> V_186 . V_25 = 0 ;
V_117 -> V_186 . V_23 = V_49 / ( V_117 -> V_186 . V_27 ) ;
V_117 -> V_186 . V_160 = V_49 / ( V_117 -> V_186 . V_127 * V_117 -> V_186 . V_27 ) ;
F_108 ( L_10 ,
V_49 >> 10 , V_177 [ V_117 -> V_186 . V_27 ] , V_117 -> V_186 . V_127 ) ;
V_117 -> V_132 |= V_188 ;
}
...
case V_71 :
case V_72 :
V_49 = 0x80000 << ( ( V_118 & V_191 ) >> 16 ) ;
V_117 -> V_186 . V_127 = 64 << ( ( V_118 >> 13 ) & 1 ) ;
V_117 -> V_186 . V_27 = 2 ;
V_117 -> V_186 . V_25 = 0 ;
V_189 = 1 ;
break;
...
#ifdef F_115
if ( F_116 () ) {
V_49 = V_117 -> V_186 . V_27 * V_117 -> V_186 . V_160 * V_117 -> V_186 . V_127 ;
F_104 ( L_11 ,
V_49 >> 10 ,
V_177 [ V_117 -> V_186 . V_27 ] , V_117 -> V_186 . V_127 ) ;
}
#else
if ( ! ( V_117 -> V_186 . V_17 & V_198 ) )
F_101 ( L_12 ) ;
#endif
return;
}
...
static int T_6 F_121 ( char * V_202 )
{
F_122 ( & V_202 , & V_203 ) ;
return 1 ;
}
...
static int T_6 F_127 ( char * V_202 )
{
V_207 = 1 ;
return 1 ;
}
