...
static int F_42 ( struct V_97 * V_98 , unsigned long V_99 ,
void * V_100 )
{
struct V_9 * V_10 =
...
return V_105 ;
V_10 -> V_109 = 0 ;
F_45 ( & V_8 -> V_110 . V_111 ) ;
F_46 ( V_8 ) ;
F_47 ( & V_8 -> V_110 . V_111 ) ;
return V_105 ;
}
...
static int T_3 F_56 ( const struct V_94 * V_95 )
{
F_9 ( L_9 , V_95 -> V_96 ) ;
return 1 ;
}
...
if ( F_6 ( V_8 ) )
return true ;
return F_60 ( V_8 ) && ! F_61 ( V_8 ) ;
}
bool F_62 ( struct V_7 * V_8 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_1 * V_1 ;
struct V_147 * V_147 ;
...
V_1 = F_63 ( sizeof( struct V_1 ) , V_156 ) ;
if ( ! V_1 ) {
return false ;
}
V_148 = F_63 ( sizeof( struct V_148 ) , V_156 ) ;
if ( ! V_148 ) {
F_53 ( V_1 ) ;
return false ;
}
...
V_3 = & V_147 -> V_4 ;
V_6 = & V_148 -> V_4 ;
F_64 ( V_8 , & V_148 -> V_4 , & V_157 ,
V_158 ) ;
F_65 ( V_8 , & V_147 -> V_4 , & V_159 ,
V_160 ) ;
F_66 ( V_148 , V_147 ) ;
V_147 -> type = V_161 ;
V_147 -> V_162 = ( 1 << V_163 ) ;
...
goto V_180;
V_149 = F_8 ( V_19 ) ;
V_62 = ( V_149 & V_181 ) ? 1 : 0 ;
V_60 = F_73 ( V_8 , V_62 ) ;
if ( V_60 && ( V_149 & V_21 ) ) {
V_1 -> V_32 = F_74 ( V_8 , V_60 ) ;
if ( V_1 -> V_32 ) {
V_1 -> V_32 -> type |=
V_178 ;
goto V_65;
...
if ( F_6 ( V_8 ) ) {
T_1 V_182 ;
V_62 = ( F_8 ( V_16 ) & V_181 ) ? 1 : 0 ;
V_182 = F_8 ( V_183 ) ;
if ( V_62 == 0 && ( V_182 & V_184 ) )
F_7 ( V_183 , V_182 & ~ V_185 ) ;
if ( V_62 )
V_182 |= V_184 ;
else
V_182 &= ~ V_184 ;
