...
return V_5 ;
V_55 = V_28 -> V_29 ;
if ( V_33 -> V_14 . integer . V_14 [ 0 ] == V_55 )
return 0 ;
...
F_7 (slave, &master->slaves, list) {
V_28 -> V_29 = V_55 ;
V_54 -> V_9 = V_2 -> V_2 . V_9 ;
F_8 ( V_2 , V_54 ) ;
V_28 -> V_29 = V_33 -> V_14 . integer . V_14 [ 0 ] ;
F_9 ( V_2 , V_54 ) ;
}
F_3 ( V_54 ) ;
if ( V_28 -> V_30 && ! V_5 )
...
struct V_36 * V_57 = V_2 -> V_48 ;
struct V_58 V_59 = V_57 -> V_44 ;
memcpy ( V_57 , & V_2 -> V_2 , sizeof( * V_57 ) ) ;
memcpy ( V_57 -> V_47 , V_2 -> V_2 . V_47 ,
V_57 -> V_12 * sizeof( * V_57 -> V_47 ) ) ;
V_57 -> V_44 = V_59 ;
F_3 ( V_2 ) ;
}
F_3 ( V_28 ) ;
}
struct V_36 * F_25 ( char * V_60 ,
...
V_41 [ 0 ] == V_66 ||
V_41 [ 0 ] == V_67 ) ) {
V_48 -> V_47 [ 0 ] . V_49 |= V_68 ;
memcpy ( V_28 -> V_41 , V_41 , sizeof( V_28 -> V_41 ) ) ;
V_48 -> V_41 . V_69 = V_28 -> V_41 ;
}
return V_48 ;
}
