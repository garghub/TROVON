...
int F_35 ( struct V_1 * V_11 , T_3 V_97 )
{
...
int F_38 ( struct V_1 * V_11 , T_3 V_97 , T_7 V_101 , int V_137 )
{
int V_63 = 0 ;
struct V_2 * V_3 = V_11 -> V_17 ;
struct V_4 * V_5 = V_3 -> V_6 ;
...
int F_40 ( struct V_2 * V_3 , T_3 V_97 , T_7 V_144 )
{
int V_63 ;
struct V_4 * V_5 = V_3 -> V_6 ;
int V_116 = V_97 >> V_5 -> V_51 ;
...
F_34 ( V_3 , V_145 , V_97 , 0x00 , ( T_2 * ) & V_144 ) ;
V_63 = F_9 ( V_3 , V_10 , ( 1 << V_5 -> V_39 -> V_146 ) ) ;
if ( V_63 ) {
F_3 ( V_76 L_12 ,
V_3 -> V_67 , V_97 , V_144 ) ;
goto V_115;
