...
F_43 ( V_78 -> V_81 , V_82 , sizeof( V_78 -> V_81 ) ) ;
snprintf ( V_78 -> V_83 , sizeof( V_78 -> V_83 ) ,
L_19 , V_6 -> V_43 ) ;
}
static int F_44 ( struct V_5 * V_6 , struct V_84 * V_85 )
{
...
static T_5 F_54 ( struct V_103 * V_104 ,
struct V_5 * V_6 )
{
unsigned int V_29 = V_6 -> V_43 ;
...
F_56 ( V_29 + V_106 , V_104 -> V_92 , ( V_104 -> V_32 + 3 ) >> 2 ) ;
...
static struct V_123 * F_70 ( struct V_5 * V_6 )
{
struct V_3 * V_4 = F_4 ( V_6 ) ;
unsigned long V_13 ;
struct V_1 * V_2 = V_4 -> V_9 ;
...
struct V_103 * V_104 ;
V_104 = F_71 ( V_6 , V_136 + 5 ) ;
F_53 ( V_6 , L_42 ,
V_136 , V_130 ) ;
if ( V_104 != NULL ) {
F_72 ( V_104 , 2 ) ;
F_73 ( V_29 + V_137 , F_74 ( V_104 , V_136 ) ,
( V_136 + 3 ) >> 2 ) ;
V_104 -> V_138 = F_75 ( V_104 , V_6 ) ;
F_76 ( V_104 ) ;
V_6 -> V_97 . V_139 ++ ;
...
if ( V_6 -> V_13 & V_147 )
V_143 |= V_148 | V_149 ;
else if ( ! F_77 ( V_6 ) || ( V_6 -> V_13 & V_150 ) )
V_143 |= V_148 ;
