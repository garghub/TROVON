...
{
struct V_82 V_83 ;
snprintf ( V_83 . type , V_84 , L_1 , L_2 ) ;
snprintf ( V_83 . V_85 , V_84 , L_1 ,
V_67 -> V_73 . V_85 ? : L_3 ) ;
V_83 . V_44 = V_67 -> V_86 ;
...
static void F_55 ( struct V_91 * V_92 , struct V_66 * V_67 )
{
struct V_56 * V_93 = & V_67 -> V_73 ;
F_56 ( V_92 , L_4 ) ;
F_56 ( V_92 , L_5 , V_67 -> V_94 & V_95 ?
L_6 : L_7 ) ;
F_56 ( V_92 , L_8 , V_67 -> V_86 ) ;
F_56 ( V_92 , L_9 , V_93 -> V_63 ) ;
F_56 ( V_92 , L_10 , V_93 -> V_64 ) ;
F_56 ( V_92 , L_11 , V_93 -> V_34 ) ;
F_56 ( V_92 , L_12 , V_93 -> V_85 ? : L_3 ) ;
}
...
{
struct V_82 V_83 ;
snprintf ( V_83 . type , V_84 , L_1 , L_13 ) ;
snprintf ( V_83 . V_85 , V_84 , L_1 ,
V_67 -> V_73 . V_85 ? : L_14 ) ;
V_83 . V_44 = V_67 -> V_86 ;
V_83 . V_63 = V_67 -> V_73 . V_63 ;
...
static void F_60 ( struct V_91 * V_92 , struct V_66 * V_67 )
{
struct V_56 * V_93 = & V_67 -> V_73 ;
F_56 ( V_92 , L_15 ) ;
F_56 ( V_92 , L_5 , V_67 -> V_94 & V_95 ?
...
if ( ! F_66 ( V_112 ) )
goto V_116;
V_105 . V_103 . V_117 = sizeof( V_105 ) ;
V_105 . V_103 . V_118 = V_119 ;
V_105 . V_3 . type = type | V_96 ;
V_105 . V_3 . V_68 = V_68 | V_96 ;
V_102 [ 0 ] = & V_105 . V_103 ;
V_107 . V_103 . V_117 = sizeof( V_107 ) ;
V_107 . V_103 . V_118 = V_120 ;
memcpy ( V_107 . V_3 . V_121 , V_67 -> V_113 , V_84 ) ;
V_102 [ 1 ] = & V_107 . V_103 ;
V_102 [ 2 ] = NULL ;
if ( ( V_67 -> V_94 & V_97 ) ==
V_98 )
...
if ( ! V_109 )
goto V_123;
V_111 = V_109 -> V_124 ( V_102 ) ;
V_22 = F_64 ( V_111 ) ;
if ( F_65 ( V_111 ) )
goto V_125;
if ( ( V_22 = F_68 ( V_109 , V_111 ) ) ) {
V_109 -> free ( V_111 ) ;
goto V_125;
}
V_22 = - V_115 ;
...
struct V_66 * F_72 ( const char * V_121 , T_2 type , T_2 V_68 )
{
struct V_66 * V_67 ;
V_67 = F_73 ( V_121 , type , V_68 ) ;
if ( F_65 ( V_67 ) )
return V_67 ;
if ( ( V_67 -> V_94 & V_97 ) ==
V_114 )
...
return V_67 ;
F_71 ( V_67 ) ;
V_67 = F_73 ( V_121 , type | V_126 ,
V_68 & ~ V_126 ) ;
if ( F_65 ( V_67 ) )
return V_67 ;
if ( ( V_67 -> V_94 & V_97 ) ==
V_114 ) {
if ( ( V_67 -> V_94 ^ type ^ ~ V_68 ) & V_126 ) {
F_71 ( V_67 ) ;
V_67 = F_74 ( - V_122 ) ;
}
return V_67 ;
...
int F_76 ( struct V_127 * V_128 , const char * V_121 ,
T_2 type , T_2 V_68 )
{
struct V_66 * V_67 ;
int V_22 ;
type = F_77 ( type ) ;
V_68 = F_78 ( V_68 ) ;
V_67 = F_72 ( V_121 , type , V_68 ) ;
if ( F_65 ( V_67 ) )
return F_64 ( V_67 ) ;
V_22 = F_79 ( & V_128 -> V_25 , V_67 , V_128 -> V_25 . V_111 , V_68 ) ;
F_71 ( V_67 ) ;
return V_22 ;
}
struct V_53 * F_80 ( const char * V_129 ,
T_2 type , T_2 V_68 )
{
struct V_23 * V_24 ;
int V_22 ;
