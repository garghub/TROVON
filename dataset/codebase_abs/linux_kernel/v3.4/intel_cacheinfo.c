...
if ( V_129 )
return V_129 ;
V_101 = sizeof ( V_130 ) / sizeof ( struct V_128 * ) ;
if ( F_16 ( V_62 ) )
V_101 += 2 ;
if ( F_16 ( V_74 ) )
V_101 += 1 ;
...
static T_3 F_66 ( struct V_134 * V_135 , struct V_128 * V_132 , char * V_60 )
{
struct V_136 * V_137 = F_67 ( V_132 ) ;
struct V_138 * V_54 = F_68 ( V_135 ) ;
T_3 V_67 ;
V_67 = V_137 -> F_66 ?
V_137 -> F_66 ( F_42 ( V_54 -> V_64 , V_54 -> V_55 ) ,
V_60 , V_54 -> V_64 ) :
0 ;
return V_67 ;
}
static T_3 F_69 ( struct V_134 * V_135 , struct V_128 * V_132 ,
const char * V_60 , T_4 V_69 )
{
struct V_136 * V_137 = F_67 ( V_132 ) ;
struct V_138 * V_54 = F_68 ( V_135 ) ;
T_3 V_67 ;
V_67 = V_137 -> F_69 ?
V_137 -> F_69 ( F_42 ( V_54 -> V_64 , V_54 -> V_55 ) ,
V_60 , V_69 , V_54 -> V_64 ) :
0 ;
return V_67 ;
}
static void T_1 F_70 ( unsigned int V_64 )
{
...
static int T_1 F_71 ( unsigned int V_64 )
{
int V_70 ;
if ( V_95 == 0 )
return - V_120 ;
...
static int T_1 F_72 ( struct V_142 * V_143 )
{
...
V_147 . V_130 = F_65 () ;
#endif
V_96 = F_73 ( & ( V_145 -> V_135 ) ,
& V_147 ,
F_38 ( V_139 , V_64 ) ,
L_12 , V_66 ) ;
if ( F_53 ( V_96 ) ) {
for ( V_100 = 0 ; V_100 < V_66 ; V_100 ++ )
F_76 ( & ( F_74 ( V_64 , V_100 ) -> V_135 ) ) ;
F_76 ( F_38 ( V_139 , V_64 ) ) ;
F_70 ( V_64 ) ;
return V_96 ;
}
F_77 ( & ( V_145 -> V_135 ) , V_148 ) ;
}
F_46 ( V_64 , F_24 ( V_149 ) ) ;
F_77 ( F_38 ( V_139 , V_64 ) , V_148 ) ;
return 0 ;
}
static void T_1 F_78 ( struct V_142 * V_143 )
{
unsigned int V_64 = V_143 -> V_144 ;
unsigned long V_66 ;
if ( F_38 ( V_117 , V_64 ) == NULL )
return;
if ( ! F_79 ( V_64 , F_24 ( V_149 ) ) )
return;
F_49 ( V_64 , F_24 ( V_149 ) ) ;
for ( V_66 = 0 ; V_66 < V_95 ; V_66 ++ )
F_76 ( & ( F_74 ( V_64 , V_66 ) -> V_135 ) ) ;
F_76 ( F_38 ( V_139 , V_64 ) ) ;
F_70 ( V_64 ) ;
}
static int T_1 F_80 ( struct V_150 * V_151 ,
