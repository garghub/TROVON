...
unsigned char V_17 [ V_18 + 1 ] ;
int V_3 ;
V_17 [ 1 ] = F_15 ( V_16 -> V_26 ) ;
V_17 [ 2 ] = F_15 ( V_16 -> V_27 ) ;
V_17 [ 3 ] = F_15 ( V_16 -> V_28 ) ;
V_17 [ 4 ] = F_15 ( V_16 -> V_29 ) ;
V_17 [ 5 ] = F_15 ( V_16 -> V_30 + 1 ) ;
V_17 [ 6 ] = F_15 ( V_16 -> V_31 - 100 ) ;
V_3 = F_1 ( & V_19 , V_21 ) ;
if ( V_3 < 0 )
goto V_32;
V_19 &= ~ V_33 ;
...
{
unsigned char V_37 [ V_18 + 1 ] ;
int V_3 ;
V_3 = F_8 ( V_12 , 0 ) ;
if ( V_3 )
goto V_32;
V_37 [ 1 ] = F_15 ( V_35 -> time . V_26 ) ;
V_37 [ 2 ] = F_15 ( V_35 -> time . V_27 ) ;
V_37 [ 3 ] = F_15 ( V_35 -> time . V_28 ) ;
V_37 [ 4 ] = F_15 ( V_35 -> time . V_29 ) ;
V_37 [ 5 ] = F_15 ( V_35 -> time . V_30 + 1 ) ;
V_37 [ 6 ] = F_15 ( V_35 -> time . V_31 - 100 ) ;
V_3 = F_16 ( V_4 , V_37 ,
( V_5 [ V_36 ] ) , V_18 ) ;
if ( V_3 ) {
F_10 ( V_12 , L_11 , V_3 ) ;
...
static int T_3 F_22 ( struct V_52 * V_53 )
{
struct V_54 * V_39 ;
int V_3 = - V_55 ;
...
static int T_4 F_34 ( struct V_52 * V_53 )
{
...
static int F_39 ( struct V_52 * V_53 , T_5 V_67 )
{
V_68 = V_8 ;
F_7 ( V_66 ) ;
return 0 ;
