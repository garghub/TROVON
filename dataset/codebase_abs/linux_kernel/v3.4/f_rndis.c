...
V_102 . V_100 =
V_93 . V_100 ;
V_3 -> V_103 = F_47 ( V_104 ) ;
if ( ! V_3 -> V_103 )
goto V_68;
}
if ( F_4 ( V_81 -> V_22 -> V_62 ) ) {
V_105 . V_100 =
V_91 . V_100 ;
V_106 . V_100 =
V_92 . V_100 ;
...
return 0 ;
V_68:
if ( F_4 ( V_81 -> V_22 -> V_62 ) && V_3 -> V_108 )
F_50 ( V_3 -> V_108 ) ;
if ( F_5 ( V_81 -> V_22 -> V_62 ) && V_3 -> V_103 )
F_50 ( V_3 -> V_103 ) ;
if ( V_3 -> V_97 )
F_50 ( V_3 -> V_97 ) ;
if ( V_17 -> V_20 ) {
F_51 ( V_17 -> V_20 -> V_25 ) ;
F_52 ( V_17 -> V_28 , V_17 -> V_20 ) ;
}
if ( V_17 -> V_28 )
V_17 -> V_28 -> V_66 = NULL ;
if ( V_17 -> V_4 . V_73 -> V_67 )
V_17 -> V_4 . V_73 -> V_66 = NULL ;
if ( V_17 -> V_4 . V_72 -> V_67 )
V_17 -> V_4 . V_72 -> V_66 = NULL ;
ERROR ( V_22 , L_19 , V_3 -> V_35 , V_26 ) ;
return V_26 ;
}
static void
F_53 ( struct V_80 * V_81 , struct V_2 * V_3 )
{
struct V_1 * V_17 = F_1 ( V_3 ) ;
F_54 ( V_17 -> V_23 ) ;
F_55 () ;
...
static inline bool F_56 ( struct V_80 * V_81 )
{
return true ;
}
int
F_57 ( struct V_80 * V_81 , V_38 V_112 [ V_113 ] )
{
struct V_1 * V_17 ;
int V_26 ;
if ( ! F_56 ( V_81 ) || ! V_112 )
...
V_26 = - V_94 ;
V_17 = F_60 ( sizeof *V_17 , V_95 ) ;
if ( ! V_17 )
goto V_68;
memcpy ( V_17 -> V_112 , V_112 , V_113 ) ;
V_17 -> V_4 . V_75 = 0 ;
V_17 -> V_4 . V_118 = sizeof( struct V_15 ) ;
V_17 -> V_4 . V_119 = F_6 ;
V_17 -> V_4 . V_120 = V_121 ;
V_17 -> V_4 . V_5 . V_35 = L_20 ;
V_17 -> V_4 . V_5 . V_122 = V_123 ;
V_17 -> V_4 . V_5 . V_124 = F_42 ;
V_17 -> V_4 . V_5 . V_125 = F_53 ;
V_17 -> V_4 . V_5 . V_126 = F_26 ;
V_17 -> V_4 . V_5 . V_127 = F_21 ;
V_17 -> V_4 . V_5 . V_128 = F_35 ;
V_26 = F_61 ( V_81 , & V_17 -> V_4 . V_5 ) ;
if ( V_26 ) {
F_51 ( V_17 ) ;
V_68:
F_55 () ;
