...
{
return F_26 ( NULL , 0 , & V_58 , V_44 , & V_44 -> V_55 ) ;
}
void T_3 F_27 ( void )
{
...
V_62 = 0x81000000 ;
V_63 = V_64 ;
V_59 = ( unsigned int ) V_65 - V_66 ;
for ( V_60 = 0x00100000 ; V_60 < 0x10000000 ; V_60 <<= 1 )
if ( V_60 >= V_59 )
break;
* V_67 = ( V_60 - 1 ) & 0x0ffc0000 ;
* V_68 = 0 ;
* V_69 = 0x80000000 ;
* V_70 = 0 ;
* V_71 = 0 ;
