...
static int F_226 ( unsigned char T_7 * V_304 , int V_417 )
{
int V_82 , V_248 , V_335 ;
F_21 () ;
for ( V_82 = 0 ; V_82 < 16 ; V_82 ++ )
if ( V_417 ) {
F_140 ( V_336 [ V_82 ] , V_304 ++ ) ;
F_140 ( V_337 [ V_82 ] , V_304 ++ ) ;
F_140 ( V_338 [ V_82 ] , V_304 ++ ) ;
} else {
F_227 ( V_336 [ V_82 ] , V_304 ++ ) ;
F_227 ( V_337 [ V_82 ] , V_304 ++ ) ;
F_227 ( V_338 [ V_82 ] , V_304 ++ ) ;
}
if ( V_417 ) {
for ( V_82 = 0 ; V_82 < V_110 ; V_82 ++ )
if ( F_45 ( V_82 ) ) {
...
int F_229 ( unsigned char T_7 * V_304 )
{
int V_418 ;
F_71 () ;
V_418 = F_226 ( V_304 , 0 ) ;
...
static int F_230 ( struct V_4 * V_5 , struct V_419 * V_420 )
{
struct V_421 V_422 ;
int V_418 = - V_158 ;
int V_9 ;
if ( V_420 -> V_305 ) {
V_422 . V_305 = F_56 ( V_423 , V_127 ) ;
if ( ! V_422 . V_305 )
return - V_128 ;
} else
V_422 . V_305 = NULL ;
...
V_418 = V_5 -> V_16 -> F_230 ( V_5 , & V_422 ) ;
else
V_418 = - V_424 ;
F_72 () ;
if ( V_418 )
goto V_425;
V_9 = ( V_422 . V_134 + 7 ) / 8 * 32 * V_422 . V_426 ;
if ( V_420 -> V_305 && V_422 . V_426 > V_420 -> V_426 )
V_418 = - V_427 ;
if ( ! ( V_420 -> V_373 & V_428 ) ) {
if ( V_422 . V_134 > V_420 -> V_134 || V_422 . V_135 > V_420 -> V_135 )
V_418 = - V_427 ;
} else {
if ( V_422 . V_134 != 8 )
V_418 = - V_429 ;
else if ( ( V_420 -> V_135 && V_422 . V_135 > V_420 -> V_135 ) ||
V_422 . V_135 > 32 )
V_418 = - V_427 ;
}
if ( V_418 )
goto V_425;
V_420 -> V_135 = V_422 . V_135 ;
V_420 -> V_134 = V_422 . V_134 ;
V_420 -> V_426 = V_422 . V_426 ;
if ( V_420 -> V_305 && F_231 ( V_420 -> V_305 , V_422 . V_305 , V_9 ) )
V_418 = - V_308 ;
V_425:
F_57 ( V_422 . V_305 ) ;
return V_418 ;
...
if ( ! V_420 -> V_135 ) {
int V_431 , V_82 ;
T_2 T_7 * V_432 = V_420 -> V_305 ;
T_2 V_433 ;
if ( ! ( V_420 -> V_373 & V_428 ) )
return - V_158 ;
for ( V_431 = 32 ; V_431 > 0 ; V_431 -- )
for ( V_82 = 0 ; V_82 < V_420 -> V_426 ; V_82 ++ ) {
...
if ( V_420 -> V_134 <= 0 || V_420 -> V_134 > 32 || V_420 -> V_135 > 32 )
return - V_158 ;
V_430 = ( V_420 -> V_134 + 7 ) / 8 * 32 * V_420 -> V_426 ;
if ( V_430 > V_423 )
return - V_427 ;
V_422 . V_426 = V_420 -> V_426 ;
V_422 . V_135 = V_420 -> V_135 ;
V_422 . V_134 = V_420 -> V_134 ;
V_422 . V_305 = F_233 ( V_420 -> V_305 , V_430 ) ;
if ( F_179 ( V_422 . V_305 ) )
return F_212 ( V_422 . V_305 ) ;
F_71 () ;
if ( V_5 -> V_89 != V_286 )
V_418 = - V_158 ;
else if ( V_5 -> V_16 -> F_232 )
V_418 = V_5 -> V_16 -> F_232 ( V_5 , & V_422 , V_420 -> V_373 ) ;
else
V_418 = - V_424 ;
F_72 () ;
F_57 ( V_422 . V_305 ) ;
...
{
struct V_421 V_422 = { . V_134 = V_420 -> V_134 , . V_135 = V_420 -> V_135 } ;
char V_366 [ V_435 ] ;
char * V_26 = V_366 ;
int V_418 ;
if ( ! V_420 -> V_305 )
V_26 = NULL ;
else if ( F_235 ( V_366 , V_420 -> V_305 , V_435 - 1 ) < 0 )
return - V_308 ;
else
V_366 [ V_435 - 1 ] = 0 ;
F_71 () ;
...
if ( V_5 -> V_16 -> F_234 )
V_418 = V_5 -> V_16 -> F_234 ( V_5 , & V_422 , V_26 ) ;
else
V_418 = - V_424 ;
F_72 () ;
if ( ! V_418 ) {
...
V_418 = V_5 -> V_16 -> F_236 ( V_5 , V_346 ) ;
F_72 () ;
return V_418 ;
}
...
unsigned short * F_239 ( struct V_4 * V_5 , int V_442 , int V_13 )
{
...
T_1 F_242 ( struct V_4 * V_5 , const T_1 * V_443 )
{
if ( ( unsigned long ) V_443 == V_5 -> V_76 && V_84 != - 1 )
return V_84 ;
return F_19 ( V_443 ) ;
}
void F_243 ( struct V_4 * V_5 , T_1 V_444 , T_1 * V_443 )
{
F_28 ( V_444 , V_443 ) ;
