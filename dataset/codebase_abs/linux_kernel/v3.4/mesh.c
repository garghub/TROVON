...
V_57 -> V_62 = V_62 ;
V_57 -> V_66 = V_65 + V_69 ;
memcpy ( V_57 -> V_59 , V_59 , V_70 ) ;
F_29 ( & V_57 -> V_56 , & V_49 -> V_55 [ V_64 ] . V_56 ) ;
return 0 ;
}
int
F_30 ( struct V_71 * V_72 , struct V_12 * V_13 )
{
struct V_16 * V_17 = & V_13 -> V_3 . V_18 ;
T_1 * V_73 , V_74 ;
...
struct V_16 * V_17 = & V_13 -> V_3 . V_18 ;
T_1 * V_73 ;
if ( F_31 ( V_72 ) < 2 + V_17 -> V_28 )
return - V_52 ;
V_73 = F_32 ( V_72 , 2 + V_17 -> V_28 ) ;
* V_73 ++ = V_81 ;
* V_73 ++ = V_17 -> V_28 ;
if ( V_17 -> V_28 )
...
int
F_35 ( struct V_71 * V_72 , struct V_12 * V_13 )
{
struct V_16 * V_17 = & V_13 -> V_3 . V_18 ;
T_1 V_82 , V_83 ;
const T_1 * V_11 ;
...
return 0 ;
V_82 = F_36 ( V_17 -> V_27 , V_17 -> V_84 , 0 ) ;
if ( V_82 ) {
V_83 = V_17 -> V_84 - V_82 ;
V_11 = V_17 -> V_27 + V_82 ;
if ( F_31 ( V_72 ) < V_83 )
return - V_52 ;
memcpy ( F_32 ( V_72 , V_83 ) , V_11 , V_83 ) ;
}
return 0 ;
}
int
F_37 ( struct V_71 * V_72 , struct V_12 * V_13 )
{
struct V_16 * V_17 = & V_13 -> V_3 . V_18 ;
T_1 V_83 = 0 ;
const T_1 * V_11 ;
...
* V_73 ++ = V_94 ;
* V_73 ++ = 1 ;
* V_73 ++ = F_39 ( V_15 -> V_24 . V_90 . V_91 -> V_95 ) ;
}
return 0 ;
}
...
V_15 -> V_43 == V_99 )
return 0 ;
if ( F_31 ( V_72 ) < 2 + sizeof( struct V_100 ) )
return - V_52 ;
V_73 = F_32 ( V_72 , 2 + sizeof( struct V_100 ) ) ;
F_41 ( V_73 , & V_87 -> V_97 , V_87 -> V_97 . V_101 ) ;
return 0 ;
}
...
return 0 ;
if ( F_31 ( V_72 ) < 2 + sizeof( struct V_106 ) )
return - V_52 ;
V_73 = F_32 ( V_72 , 2 + sizeof( struct V_106 ) ) ;
F_43 ( V_73 , V_97 , V_91 , V_104 ) ;
return 0 ;
}
...
F_47 ( V_108 , & V_17 -> V_20 ) ;
F_48 ( & V_17 -> V_112 ) ;
}
}
int F_49 ( struct V_113 * V_114 , T_3 * V_115 ,
const T_1 * V_116 , const T_1 * V_117 )
{
if ( F_50 ( V_116 ) ) {
* V_115 |= F_51 ( V_118 ) ;
memcpy ( V_114 -> V_119 , V_116 , V_70 ) ;
memcpy ( V_114 -> V_120 , V_117 , V_70 ) ;
memcpy ( V_114 -> V_121 , V_117 , V_70 ) ;
return 24 ;
} else {
* V_115 |= F_51 ( V_118 | V_122 ) ;
memset ( V_114 -> V_119 , 0 , V_70 ) ;
memcpy ( V_114 -> V_120 , V_117 , V_70 ) ;
memcpy ( V_114 -> V_121 , V_116 , V_70 ) ;
memcpy ( V_114 -> V_123 , V_117 , V_70 ) ;
return 30 ;
}
}
int F_52 ( struct V_60 * V_124 ,
...
F_54 ( F_55 ( V_13 -> V_3 . V_18 . V_130 ) , & V_124 -> V_62 ) ;
V_13 -> V_3 . V_18 . V_130 ++ ;
if ( V_125 && ! V_126 ) {
V_124 -> V_131 |= V_132 ;
V_127 += V_70 ;
memcpy ( V_124 -> V_133 , V_125 , V_70 ) ;
} else if ( V_125 && V_126 ) {
V_124 -> V_131 |= V_134 ;
V_127 += 2 * V_70 ;
memcpy ( V_124 -> V_133 , V_125 , V_70 ) ;
memcpy ( V_124 -> V_135 , V_126 , V_70 ) ;
}
return 6 + V_127 ;
}
...
{
struct V_16 * V_17 = & V_13 -> V_3 . V_18 ;
if ( F_69 ( V_22 , & V_17 -> V_23 ) )
F_70 ( & V_17 -> V_140 ) ;
if ( F_69 ( V_107 , & V_17 -> V_23 ) )
F_70 ( & V_17 -> V_143 ) ;
if ( F_69 ( V_109 , & V_17 -> V_23 ) )
F_70 ( & V_17 -> V_112 ) ;
F_46 ( V_17 ) ;
}
...
F_61 ( V_13 , V_150 ) ;
F_75 ( V_15 , NULL ) ;
F_48 ( & V_13 -> V_3 . V_18 . V_140 ) ;
F_48 ( & V_13 -> V_3 . V_18 . V_112 ) ;
F_76 ( & V_13 -> V_25 ) ;
V_15 -> V_144 -- ;
F_77 ( & V_15 -> V_145 ) ;
F_73 ( V_15 ) ;
...
if ( V_152 == V_160 &&
F_27 ( V_2 -> V_161 , V_13 -> V_146 . V_162 ) )
return;
...
F_92 ( V_13 ) ;
if ( F_69 ( V_185 , & V_17 -> V_20 ) )
F_93 () ;
if ( F_69 ( V_186 , & V_17 -> V_20 ) )
F_94 () ;
if ( F_69 ( V_19 , & V_17 -> V_20 ) )
F_56 ( V_13 , V_17 ) ;
if ( F_69 ( V_108 , & V_17 -> V_20 ) )
F_64 ( V_13 ) ;
}
