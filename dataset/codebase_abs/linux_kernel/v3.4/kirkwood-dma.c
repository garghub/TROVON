...
static void F_37 ( struct V_78 * V_79 )
{
struct V_35 * V_36 ;
struct V_81 * V_82 ;
int V_60 ;
...
if ( ! V_82 -> V_59 )
continue;
F_38 ( V_79 -> V_86 -> V_84 , V_82 -> V_87 ,
V_82 -> V_59 , V_82 -> V_47 ) ;
V_82 -> V_59 = NULL ;
}
}
static int T_5 F_39 ( struct V_95 * V_96 )
{
return F_40 ( & V_96 -> V_84 , & V_97 ) ;
}
static int T_6 F_41 ( struct V_95 * V_96 )
{
F_42 ( & V_96 -> V_84 ) ;
return 0 ;
}
