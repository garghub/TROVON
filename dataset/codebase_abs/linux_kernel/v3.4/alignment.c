...
F_44 ( V_75 ) ;
if ( F_45 ( V_32 ) ) {
V_41 = F_46 ( V_60 , ( T_5 * ) ( V_71 & ~ 1 ) ) ;
if ( ! V_41 ) {
if ( F_2 () >= V_76 &&
F_47 ( V_60 ) ) {
T_5 V_69 = 0 ;
V_41 = F_46 ( V_69 , ( T_5 * ) ( V_71 + 2 ) ) ;
V_30 = ( V_60 << 16 ) | V_69 ;
V_74 = 1 ;
} else {
V_73 = 2 ;
...
#ifdef F_62
struct V_101 * V_102 ;
V_102 = F_63 ( L_18 , V_103 | V_104 , NULL ,
& V_105 ) ;
if ( ! V_102 )
return - V_106 ;
#endif
...
F_64 ( V_108 , F_39 , V_93 , V_96 ,
L_19 ) ;
if ( F_2 () <= V_1 ) {
F_64 ( 3 , F_39 , V_93 , V_96 ,
L_19 ) ;
}
return 0 ;
}
