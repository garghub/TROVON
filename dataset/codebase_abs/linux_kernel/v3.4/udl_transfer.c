...
int * V_29 , int * V_30 )
{
const T_4 * V_31 , * V_32 , * V_33 ;
T_5 V_34 = 0 + ( V_27 / V_9 ) * 2 ;
struct V_23 * V_23 = * V_24 ;
T_4 * V_11 = * V_26 ;
T_4 * V_35 = ( T_4 * ) V_23 -> V_36 + V_23 -> V_37 ;
V_31 = ( T_4 * ) ( V_25 + V_27 ) ;
V_33 = V_31 ;
V_32 = V_33 + V_28 ;
while ( V_33 < V_32 ) {
F_2 ( & V_33 ,
V_32 , & V_34 ,
( T_4 * * ) & V_11 , ( T_4 * ) V_35 , V_9 ) ;
if ( V_11 >= V_35 ) {
int V_38 = V_11 - ( T_4 * ) V_23 -> V_36 ;
if ( F_10 ( V_22 , V_23 , V_38 ) )
return 1 ;
* V_30 += V_38 ;
V_23 = F_11 ( V_22 ) ;
if ( ! V_23 )
