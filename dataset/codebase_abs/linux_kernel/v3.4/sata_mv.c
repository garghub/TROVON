...
static int F_213 ( struct V_541 * V_126 , T_9 V_557 )
{
struct V_15 * V_16 = F_211 ( V_126 ) ;
if ( V_16 )
return F_214 ( V_16 , V_557 ) ;
else
return 0 ;
}
...
if ( V_429 )
return V_429 ;
V_429 = F_225 ( V_126 , 1 << V_566 , V_329 ) ;
if ( V_429 == - V_567 )
F_226 ( V_126 ) ;
if ( V_429 )
return V_429 ;
V_16 -> V_552 = F_227 ( V_126 ) ;
...
F_228 ( V_21 , V_566 , - 1 , L_74 ) ;
F_228 ( V_21 , V_566 , V_210 , L_75 ) ;
}
V_429 = F_187 ( V_16 ) ;
if ( V_429 )
return V_429 ;
if ( V_568 && F_229 ( V_126 ) == 0 )
V_18 -> V_170 |= V_399 ;
F_37 ( V_126 , 0x68 ) ;
F_221 ( V_16 ) ;
F_230 ( V_126 ) ;
F_231 ( V_126 ) ;
return F_206 ( V_16 , V_126 -> V_396 , F_134 , V_555 ,
