...
F_62 ( V_2 , V_40 , V_136 , V_61 , V_62 , V_137 ) ;
if ( V_2 -> V_42 -> V_138 )
...
void F_63 ( struct V_81 * V_40 , T_2 V_136 ,
...
return;
V_125 -> type = V_141 ;
V_125 -> V_142 . V_61 = ( ( T_1 * ) V_125 ) + sizeof( * V_125 ) ;
V_125 -> V_142 . V_62 = V_62 ;
memcpy ( ( void * ) V_125 -> V_142 . V_61 , V_61 , V_62 ) ;
...
V_139 -> V_55 = V_144 -> V_19 [ V_148 ] . V_55 ;
if ( V_139 -> V_63 . V_152 == 0 )
V_139 -> V_63 . V_152 = V_149 ;
if ( V_139 -> V_63 . V_153 == 0 ) {
V_139 -> V_63 . V_153 = 1 ;
V_139 -> V_63 . V_154 [ 0 ] = V_149 ;
}
}
}
if ( ! V_2 -> V_42 -> V_139 ) {
...
if ( V_139 -> V_53 ) {
V_4 -> V_18 -> V_19 . V_53 = V_4 -> V_18 -> V_53 ;
memcpy ( V_4 -> V_18 -> V_53 , V_139 -> V_53 , V_71 ) ;
}
if ( V_139 -> V_61 ) {
V_4 -> V_18 -> V_61 = F_66 ( V_139 -> V_61 , V_139 -> V_62 ,
V_27 ) ;
...
V_15 = V_2 -> V_42 -> V_158 ( & V_2 -> V_11 , V_40 , V_136 ) ;
if ( V_15 )
return V_15 ;
}
if ( V_4 -> V_7 == V_121 )
...
int V_15 ;
F_5 ( V_40 -> V_82 ) ;
V_15 = F_68 ( V_2 , V_40 , V_136 , V_101 ) ;
F_6 ( V_40 -> V_82 ) ;
return V_15 ;
}
void F_71 ( struct V_81 * V_40 ,
struct V_160 * V_76 )
{
struct V_3 * V_4 = V_40 -> V_82 ;
struct V_1 * V_2 = F_12 ( V_4 -> V_11 ) ;
...
return;
memcpy ( V_53 , V_76 -> V_119 . V_53 , V_71 ) ;
F_24 ( V_2 , V_40 , V_53 , NULL , 0 ,
V_66 , false ) ;
}
