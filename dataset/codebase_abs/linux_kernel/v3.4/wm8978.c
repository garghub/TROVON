...
struct V_26 * V_27 = F_8 ( V_6 ) ;
T_2 V_79 = F_15 ( V_6 , V_56 ) & ~ 0x60 ;
T_2 V_80 = F_15 ( V_6 , V_81 ) & ~ 0xe ;
T_2 V_82 = F_15 ( V_6 , V_47 ) ;
enum V_83 V_84 = V_82 & 0x100 ?
V_52 : V_53 ;
...
if ( V_27 -> V_32 < 0 ) {
if ( V_85 < V_27 -> V_29 || V_85 > 12 * V_27 -> V_29 )
return - V_25 ;
for ( V_21 = 0 ; V_21 < F_6 ( V_22 ) ; V_21 ++ ) {
V_86 = abs ( V_27 -> V_29 * 3 -
V_85 * 3 * V_24 [ V_21 ] / V_22 [ V_21 ] ) ;
if ( V_86 < V_87 ) {
V_87 = V_86 ;
V_89 = V_21 ;
}
...
if ( V_86 )
F_3 ( V_6 -> V_2 , L_8 ,
V_85 * V_24 [ V_89 ] / V_22 [ V_89 ] / 256 ,
V_27 -> V_51 == V_53 ?
L_9 : L_10 ) ;
F_9 ( V_6 -> V_2 , L_11 , V_33 ,
F_17 ( V_74 ) , F_18 ( V_74 ) , V_89 ) ;
F_10 ( V_6 , V_47 , 0xe0 , V_89 << 5 ) ;
F_11 ( V_6 , V_56 , V_79 ) ;
F_11 ( V_6 , V_81 , V_80 ) ;
if ( V_27 -> V_51 != V_84 ) {
if ( V_27 -> V_51 == V_52 )
...
static int F_19 ( struct V_41 * V_75 , int V_94 )
{
struct V_5 * V_6 = V_75 -> V_6 ;
F_9 ( V_6 -> V_2 , L_12 , V_33 , V_94 ) ;
if ( V_94 )
F_10 ( V_6 , V_95 , 0x40 , 0x40 ) ;
else
F_10 ( V_6 , V_95 , 0x40 , 0 ) ;
return 0 ;
}
static int F_20 ( struct V_5 * V_6 ,
enum V_96 V_97 )
{
T_2 V_98 = F_15 ( V_6 , V_36 ) & ~ 3 ;
switch ( V_97 ) {
case V_99 :
case V_100 :
V_98 |= 1 ;
...
F_9 ( V_6 -> V_2 , L_13 , V_33 , V_97 , V_98 ) ;
V_6 -> V_102 . V_103 = V_97 ;
return 0 ;
}
...
int V_44 = 0 , V_21 ;
V_27 -> V_51 = V_52 ;
V_6 -> V_108 = V_27 -> V_107 ;
V_44 = F_27 ( V_6 , 7 , 9 , V_109 ) ;
if ( V_44 < 0 ) {
F_28 ( V_6 -> V_2 , L_14 , V_44 ) ;
return V_44 ;
}
for ( V_21 = 0 ; V_21 < F_6 ( V_110 ) ; V_21 ++ )
F_10 ( V_6 , V_110 [ V_21 ] , 0x100 , 0x100 ) ;
F_20 ( V_6 , V_101 ) ;
return 0 ;
}
...
static T_3 int F_30 ( struct V_111 * V_112 ,
const struct V_113 * V_114 )
{
struct V_26 * V_27 ;
int V_44 ;
V_27 = F_31 ( & V_112 -> V_2 , sizeof( struct V_26 ) ,
V_115 ) ;
if ( V_27 == NULL )
return - V_116 ;
V_27 -> V_107 = F_32 ( V_112 , & V_117 ) ;
if ( F_33 ( V_27 -> V_107 ) ) {
V_44 = F_34 ( V_27 -> V_107 ) ;
F_28 ( & V_112 -> V_2 , L_15 , V_44 ) ;
return V_44 ;
}
F_35 ( V_112 , V_27 ) ;
V_44 = F_36 ( V_27 -> V_107 , V_4 , 0 ) ;
if ( V_44 != 0 ) {
F_28 ( & V_112 -> V_2 , L_16 , V_44 ) ;
goto V_118;
}
V_44 = F_37 ( & V_112 -> V_2 ,
& V_119 , & V_120 , 1 ) ;
if ( V_44 != 0 ) {
F_28 ( & V_112 -> V_2 , L_17 , V_44 ) ;
goto V_118;
}
return 0 ;
V_118:
...
static T_4 int F_39 ( struct V_111 * V_121 )
{
struct V_26 * V_27 = F_40 ( V_121 ) ;
F_41 ( & V_121 -> V_2 ) ;
F_38 ( V_27 -> V_107 ) ;
return 0 ;
}
