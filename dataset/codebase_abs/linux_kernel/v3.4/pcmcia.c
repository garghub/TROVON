...
F_42 ( V_60 -> V_66 != 2 ,
L_22 ) ;
V_52 -> V_94 . V_95 = V_60 -> V_63 [ 1 ] ;
V_52 -> V_94 . V_96 = V_60 -> V_63 [ 1 ] ;
V_52 -> V_94 . V_97 = V_60 -> V_63 [ 1 ] ;
V_52 -> V_94 . V_98 = V_60 -> V_63 [ 1 ] ;
break;
case V_99 :
F_42 ( ( V_60 -> V_66 != 3 ) &&
( V_60 -> V_66 != 5 ) ,
L_23 ) ;
V_52 -> V_100 = V_60 -> V_63 [ 1 ] |
( ( T_3 ) V_60 -> V_63 [ 2 ] << 8 ) ;
break;
case V_101 :
F_42 ( V_60 -> V_66 != 5 ,
...
V_52 -> V_103 = V_60 -> V_63 [ 2 ] ;
V_52 -> V_104 = V_60 -> V_63 [ 3 ] ;
V_52 -> V_105 = V_60 -> V_63 [ 4 ] ;
break;
}
return - V_106 ;
error:
...
static T_8 F_45 ( struct V_112 * V_113 ,
struct V_114 * V_115 ,
char * V_40 )
{
struct V_58 * V_116 =
F_46 ( V_113 , struct V_58 , V_23 ) ;
struct V_1 * V_2 ;
V_2 = F_47 ( V_116 ) ;
if ( ! V_2 )
return - V_107 ;
...
static T_8 F_49 ( struct V_112 * V_113 ,
struct V_114 * V_115 ,
...
static int F_51 ( struct V_1 * V_2 , T_1 V_117 )
{
T_1 V_14 ;
int V_9 ;
V_9 = F_4 ( V_2 , V_117 , & V_14 ) ;
if ( V_9 )
return V_9 ;
V_14 &= ~ V_118 ;
V_14 |= V_119 | V_120 | V_121 ;
V_9 = F_1 ( V_2 , V_117 , V_14 ) ;
if ( V_9 )
return V_9 ;
F_36 ( 40 ) ;
return 0 ;
