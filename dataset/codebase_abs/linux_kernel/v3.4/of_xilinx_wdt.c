...
T_1 * V_50 ;
V_43 = 0 ;
V_50 = ( T_1 * ) F_24 ( V_47 -> V_51 . V_52 -> V_53 ,
L_4 , NULL ) ;
if ( V_50 == NULL ) {
F_25 ( L_5 ) ;
V_43 = 1 ;
}
V_48 = F_26 ( V_47 -> V_51 . V_52 , 0 , & V_3 . V_54 ) ;
if ( V_48 ) {
F_25 ( L_6 ) ;
return V_48 ;
}
...
if ( ! F_27 ( V_3 . V_54 . V_57 ,
V_3 . V_54 . V_58 - V_3 . V_54 . V_57 + 1 , V_59 ) ) {
V_48 = - V_60 ;
F_28 ( L_11 ) ;
goto V_61;
}
V_3 . V_4 = F_29 ( V_3 . V_54 . V_57 , V_3 . V_54 . V_58 - V_3 . V_54 . V_57 + 1 ) ;
if ( V_3 . V_4 == NULL ) {
V_48 = - V_62 ;
F_28 ( L_12 ) ;
goto V_63;
...
F_31 ( V_3 . V_4 ) ;
V_63:
F_32 ( V_3 . V_54 . V_57 , F_33 ( & V_3 . V_54 ) ) ;
V_61:
return V_48 ;
}
