...
if ( V_41 -> V_133 == V_134 )
F_34 ( V_2 , V_4 ) ;
V_86 = F_35 ( V_41 , V_2 -> V_135 , V_82 -> V_58 . V_124 . V_136 ,
...
static void
F_36 ( struct V_40 * V_41 , T_4 * V_148 )
{
struct V_1 * V_2 ;
struct V_42 * V_149 ;
struct V_3 * V_4 ;
...
F_54 ( V_41 , V_2 -> V_135 , V_198 , V_199 ) ;
V_199 -> V_129 = V_130 ;
...
F_34 ( V_2 , V_4 ) ;
if ( F_35 ( V_41 , V_2 -> V_135 , V_50 -> V_58 . V_224 . V_136 ,
...
F_73 ( V_41 , V_220 -> V_54 , V_220 -> V_229 ) ;
F_38 ( V_220 ) ;
F_32 ( V_83 , V_41 -> V_126 ) ;
F_3 ( V_2 , V_35 , V_102 ,
L_18
...
if ( V_220 ) {
F_94 ( V_41 , V_220 -> V_54 , V_220 -> V_229 ) ;
F_38 ( V_220 ) ;
}
F_72 ( V_4 ) ;
F_95 ( & V_203 -> V_53 ) ;
...
struct V_40 * V_41 = V_2 -> V_41 ;
struct V_42 * V_43 = (struct V_42 * ) V_201 ;
F_121 ( V_2 , & V_41 -> V_66 . V_69 [ V_41 -> V_66 . V_246 ] ,
V_4 -> V_247 , 0 , V_248 ) ;
F_44 ( V_2 , V_4 , V_43 , V_172 ) ;
return V_4 -> V_73 ;
}
...
{
T_1 V_252 , V_86 ;
T_1 (* F_137) ( struct V_1 * , struct V_3 * , void * ,
T_1 );
T_1 V_253 = 0 ;
if ( F_71 ( V_4 ) )
V_253 = 1 ;
...
F_137 = V_255 [ ( V_252 * V_256 ) + V_202 ] ;
V_86 = ( F_137 ) ( V_2 , V_4 , V_201 , V_202 ) ;
if ( V_253 ) {
F_3 ( V_2 , V_72 , V_36 ,
L_26 ,
