...
static int F_49 ( struct V_19 * V_86 )
{
int V_87 ;
F_29 ( & V_86 -> V_40 ) ;
V_87 = ( V_86 -> V_27 == NULL ) || ! F_6 ( & V_86 -> V_22 ) ;
F_37 ( & V_86 -> V_40 ) ;
return V_87 ;
}
...
static int F_56 ( struct V_47 * V_48 , unsigned char V_91 )
{
struct V_19 * V_20 = V_48 -> V_63 ;
unsigned long V_57 ;
int V_28 ;
F_20 ( L_16 ,
V_20 -> V_38 , V_48 , V_91 , F_57 ( 0 ) ) ;
F_54 ( & V_20 -> V_40 , V_57 ) ;
V_28 = F_8 ( & V_20 -> V_22 , & V_91 , 1 ) ;
F_55 ( & V_20 -> V_40 , V_57 ) ;
return V_28 ;
}
...
static int F_62 ( struct V_47 * V_48 , int V_94 )
{
struct V_19 * V_20 = V_48 -> V_63 ;
int V_28 = 0 ;
struct V_83 * V_84 ;
...
V_84 = V_20 -> V_27 ;
if ( V_84 && V_84 -> V_95 )
V_28 = V_84 -> V_95 ( V_84 , V_94 ) ;
F_37 ( & V_20 -> V_40 ) ;
return V_28 ;
}
static int T_2
F_63 ( unsigned V_38 , struct V_96 * V_97 )
{
struct V_19 * V_20 ;
...
int T_2 F_69 ( struct V_99 * V_100 , unsigned V_11 )
{
unsigned V_66 ;
struct V_96 V_97 ;
int V_28 ;
if ( V_11 == 0 || V_11 > V_101 )
return - V_102 ;
V_103 = F_70 ( V_11 ) ;
if ( ! V_103 )
return - V_6 ;
...
V_103 -> type = V_105 ;
V_103 -> V_106 = V_107 ;
V_103 -> V_57 = V_108 | V_109 ;
V_103 -> V_110 = V_111 ;
V_103 -> V_110 . V_112 =
V_113 | V_114 | V_115 | V_116 | V_117 ;
V_103 -> V_110 . V_118 = 9600 ;
V_103 -> V_110 . V_119 = 9600 ;
V_97 . V_120 = F_71 ( 9600 ) ;
V_97 . V_121 = 8 ;
V_97 . V_122 = V_123 ;
V_97 . V_124 = V_125 ;
F_72 ( V_103 , & V_126 ) ;
...
for ( V_66 = 0 ; V_66 < V_11 ; V_66 ++ ) {
struct V_129 * V_130 ;
V_130 = F_76 ( V_103 , V_66 , & V_100 -> V_131 ) ;
if ( F_77 ( V_130 ) )
F_32 ( L_24 ,
V_42 , V_66 , F_78 ( V_130 ) ) ;
}
F_24 ( L_25 , V_42 ,
...
int F_86 ( struct V_83 * V_84 , V_39 V_38 )
{
struct V_19 * V_20 ;
unsigned long V_57 ;
int V_28 ;
...
if ( V_20 -> V_77 == 0 && ! V_20 -> V_78 )
F_3 ( & V_20 -> V_22 ) ;
F_41 ( V_84 -> V_46 , & V_20 -> V_45 , NULL ) ;
F_41 ( V_84 -> V_46 , & V_20 -> V_52 , NULL ) ;
F_41 ( V_84 -> V_26 , & V_20 -> V_25 , NULL ) ;
V_20 -> V_69 = V_20 -> V_49 =
