...
if ( V_19 & V_41 )
V_30 -> V_42 = V_29 -> V_22 [ 23 ] ;
}
return 0 ;
}
unsigned long F_34 ( struct V_11 * V_43 )
{
return V_43 -> V_18 . V_14 . V_37 ;
}
T_4 int F_35 ( struct V_13 * V_14 )
{
int error ;
char * V_44 ;
V_44 = F_36 ( ( const char T_3 * ) V_14 -> V_22 [ 26 ] ) ;
error = F_37 ( V_44 ) ;
if ( F_38 ( V_44 ) )
goto V_45;
error = F_39 ( V_44 ,
...
int F_41 ( const char * V_44 ,
const char * const V_46 [] ,
const char * const V_47 [] )
{
return F_42 ( V_44 , V_46 , V_47 , V_48 ) ;
}
unsigned long
F_43 ( struct V_11 * V_28 )
{
struct V_49 V_50 ;
unsigned long V_51 ;
int V_52 = 0 ;
