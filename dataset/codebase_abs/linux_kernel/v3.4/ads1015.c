...
struct V_34 * V_35 ;
if ( ! V_2 -> V_22 . V_36
|| ! F_19 ( V_2 -> V_22 . V_36 , NULL ) )
return - V_37 ;
F_20 (client->dev.of_node, node) {
const T_4 * V_38 ;
int V_39 ;
unsigned int V_3 ;
unsigned int V_7 = V_40 ;
unsigned int V_9 = V_41 ;
V_38 = F_21 ( V_35 , L_2 , & V_39 ) ;
...
unsigned int V_29 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_44 * V_45 = F_25 ( & V_2 -> V_22 ) ;
if ( V_45 ) {
...
int V_48 ;
unsigned int V_29 ;
V_6 = F_28 ( sizeof( struct V_5 ) , V_49 ) ;
if ( ! V_6 ) {
V_48 = - V_50 ;
goto exit;
}
...
continue;
V_48 = F_31 ( & V_2 -> V_22 , & V_32 [ V_29 ] . V_33 ) ;
if ( V_48 )
goto V_51;
}
V_6 -> V_30 = F_32 ( & V_2 -> V_22 ) ;
if ( F_33 ( V_6 -> V_30 ) ) {
V_48 = F_34 ( V_6 -> V_30 ) ;
goto V_51;
}
