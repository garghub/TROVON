...
struct V_242 * V_243 )
{
struct V_101 * args = F_124 ( V_243 ,
struct V_101 , V_243 ) ;
unsigned long V_244 ;
F_125 ( & V_244 , V_245 ) ;
args -> V_246 = F_112 ( args ) ;
F_126 ( args -> V_247 ) ;
F_127 ( & V_244 , V_245 ) ;
}
int
...
F_129 ( V_247 ) ;
args -> V_247 = & V_247 ;
F_130 ( & args -> V_243 , F_123 ) ;
F_131 ( V_248 , & args -> V_243 ) ;
F_132 ( & V_247 ) ;
return args -> V_246 ;
}
int
...
if ( ! error )
F_134 ( V_66 , args . V_67 , args . V_45 , V_4 , 0 ) ;
V_96:
F_85 ( args . V_75 ) ;
return error ;
}
...
V_110 = F_135 ( sizeof( struct V_249 ) , V_254 ) ;
if ( ! V_110 ) {
F_136 ( V_66 -> V_153 , V_67 , V_3 , V_4 ) ;
F_137 ( V_66 ) ;
return;
}
V_110 -> V_67 = V_67 ;
...
F_138 ( & V_110 -> V_256 ) ;
V_110 -> V_51 = V_51 ;
F_139 ( V_66 -> V_153 , V_67 , V_3 , V_4 ) ;
V_75 = F_84 ( V_66 -> V_153 , V_110 -> V_67 ) ;
F_140 ( & V_75 -> V_219 ) ;
V_252 = & V_75 -> V_221 . V_251 ;
while ( * V_252 ) {
V_253 = * V_252 ;
V_250 = F_141 ( V_253 , struct V_249 , V_251 ) ;
if ( V_110 -> V_3 < V_250 -> V_3 ) {
V_252 = & ( * V_252 ) -> V_257 ;
ASSERT ( V_110 -> V_3 + V_110 -> V_255 <= V_250 -> V_3 ) ;
} else if ( V_110 -> V_3 > V_250 -> V_3 ) {
V_252 = & ( * V_252 ) -> V_258 ;
ASSERT ( V_3 >= V_250 -> V_3 + V_250 -> V_255 ) ;
} else {
ASSERT ( 0 ) ;
}
}
F_142 ( & V_110 -> V_251 , V_253 , V_252 ) ;
F_143 ( & V_110 -> V_251 , & V_75 -> V_221 ) ;
F_144 ( & V_110 -> V_256 , & V_66 -> V_259 ) ;
F_145 ( & V_75 -> V_219 ) ;
F_85 ( V_75 ) ;
}
int
...
V_252 = V_75 -> V_221 . V_251 ;
while ( V_252 ) {
V_250 = F_141 ( V_252 , struct V_249 , V_251 ) ;
if ( V_3 < V_250 -> V_3 ) {
if ( V_3 + V_4 > V_250 -> V_3 )
V_260 = - 1 ;
V_252 = V_252 -> V_257 ;
} else if ( V_3 > V_250 -> V_3 ) {
if ( V_3 < V_250 -> V_3 + V_250 -> V_255 )
V_260 = - 1 ;
V_252 = V_252 -> V_258 ;
} else {
V_260 = ( V_250 -> V_255 == V_4 ) ? 1 : - 1 ;
break;
}
}
F_145 ( & V_75 -> V_219 ) ;
...
if ( V_148 )
goto V_265;
if ( V_262 < V_48 && V_263 > V_261 ) {
goto V_265;
} else if ( V_262 >= V_48 && V_263 <= V_261 ) {
F_148 ( & V_250 -> V_251 , & V_75 -> V_221 ) ;
V_250 -> V_255 = 0 ;
return false ;
} else if ( V_261 < V_263 ) {
V_250 -> V_3 = V_261 ;
} else if ( V_262 < V_48 ) {
V_250 -> V_255 = V_48 - V_250 -> V_3 ;
} else {
ASSERT ( 0 ) ;
}
F_149 ( V_65 , V_75 -> V_266 , V_48 , V_49 ) ;
return true ;
V_265:
F_145 ( & V_75 -> V_219 ) ;
F_65 ( V_65 , V_138 ) ;
F_150 ( V_65 , V_75 -> V_266 , V_48 , V_49 ) ;
F_140 ( & V_75 -> V_219 ) ;
return false ;
}
void
...
while ( V_252 ) {
struct V_249 * V_250 =
F_141 ( V_252 , struct V_249 , V_251 ) ;
T_1 V_262 = V_250 -> V_3 ;
T_1 V_263 = V_262 + V_250 -> V_255 ;
if ( V_48 + V_49 <= V_262 ) {
V_252 = V_252 -> V_257 ;
...
if ( ! F_146 ( V_65 , V_75 , V_250 , V_48 , V_49 ,
V_148 ) )
goto V_132;
}
F_145 ( & V_75 -> V_219 ) ;
...
struct V_251 * V_252 ;
ASSERT ( V_4 > 0 ) ;
F_140 ( & args -> V_75 -> V_219 ) ;
V_132:
V_48 = V_3 ;
V_49 = V_4 ;
V_252 = args -> V_75 -> V_221 . V_251 ;
while ( V_252 && V_49 >= args -> V_21 ) {
struct V_249 * V_250 =
F_141 ( V_252 , struct V_249 , V_251 ) ;
T_1 V_261 = V_48 + V_49 ;
T_1 V_262 = V_250 -> V_3 ;
...
if ( V_262 - V_48 >= args -> V_40 ) {
V_261 = V_262 ;
} else if ( V_261 - V_263 >= args -> V_40 * 4 ) {
V_48 = V_263 ;
} else if ( V_262 - V_48 >= args -> V_21 ) {
V_261 = V_262 ;
} else {
goto V_267;
}
...
F_145 ( & args -> V_75 -> V_219 ) ;
if ( V_48 != V_3 || V_49 != V_4 ) {
F_151 ( args -> V_65 , args -> V_67 , V_3 , V_4 ,
V_48 , V_49 ) ;
}
* V_50 = V_48 ;
* V_37 = V_49 ;
...
V_267:
F_145 ( & args -> V_75 -> V_219 ) ;
F_151 ( args -> V_65 , args -> V_67 , V_3 , V_4 , V_48 , 0 ) ;
* V_50 = V_48 ;
* V_37 = 0 ;
}
static void
...
{
if ( V_250 -> V_255 ) {
F_153 ( V_65 , V_250 -> V_67 , V_250 -> V_3 ,
V_250 -> V_255 ) ;
F_148 ( & V_250 -> V_251 , & V_75 -> V_221 ) ;
}
F_154 ( & V_250 -> V_256 ) ;
...
bool V_269 )
{
struct V_249 * V_250 , * V_270 ;
struct V_74 * V_75 = NULL ;
T_8 V_67 = V_70 ;
F_157 (busyp, n, list, list) {
if ( V_250 -> V_67 != V_67 ) {
if ( V_75 ) {
F_145 ( & V_75 -> V_219 ) ;
F_85 ( V_75 ) ;
}
V_75 = F_84 ( V_65 , V_250 -> V_67 ) ;
F_140 ( & V_75 -> V_219 ) ;
V_67 = V_250 -> V_67 ;
}
if ( V_269 && V_250 -> V_255 &&
! ( V_250 -> V_51 & V_271 ) )
V_250 -> V_51 = V_264 ;
else
F_152 ( V_65 , V_75 , V_250 ) ;
}
if ( V_75 ) {
F_145 ( & V_75 -> V_219 ) ;
F_85 ( V_75 ) ;
...
struct V_268 * V_273 )
{
return F_124 ( V_7 , struct V_249 , V_256 ) -> V_67 -
F_124 ( V_273 , struct V_249 , V_256 ) -> V_67 ;
}
