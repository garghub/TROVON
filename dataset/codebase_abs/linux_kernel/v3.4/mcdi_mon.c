...
V_32 -> V_43 . V_54 = F_23 ;
V_20 = F_25 ( & V_2 -> V_55 -> V_30 , & V_32 -> V_43 ) ;
if ( V_20 == 0 )
++ V_17 -> V_51 ;
return V_20 ;
}
...
if ( V_62 == 0 )
return 0 ;
if ( V_61 < F_28 ( F_29 ( V_62 ) ) )
return - V_67 ;
V_20 = F_30 ( V_2 , & V_17 -> V_22 ,
4 * V_69 ) ;
if ( V_20 )
return V_20 ;
F_31 ( & V_17 -> V_38 ) ;
F_6 ( V_2 ) ;
V_51 = 1 + 6 * F_29 ( V_62 ) ;
V_17 -> V_50 = F_32 ( V_51 , sizeof( * V_17 -> V_50 ) , V_70 ) ;
if ( ! V_17 -> V_50 ) {
V_20 = - V_71 ;
goto V_72;
}
V_17 -> V_29 = F_33 ( & V_2 -> V_55 -> V_30 ) ;
if ( F_34 ( V_17 -> V_29 ) ) {
V_20 = F_35 ( V_17 -> V_29 ) ;
goto V_72;
}
