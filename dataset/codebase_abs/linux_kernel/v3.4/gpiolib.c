...
struct V_6 * F_81 ( const void * V_88 ,
...
int F_87 ( unsigned V_8 , unsigned long V_11 , const char * V_3 )
{
int V_27 ;
V_27 = F_53 ( V_8 , V_3 ) ;
if ( V_27 )
...
int F_88 ( const struct V_8 * V_102 , T_3 V_103 )
{
int V_16 , V_27 ;
for ( V_16 = 0 ; V_16 < V_103 ; V_16 ++ , V_102 ++ ) {
V_27 = F_87 ( V_102 -> V_8 , V_102 -> V_11 , V_102 -> V_3 ) ;
if ( V_27 )
goto V_104;
}
return 0 ;
...
void F_89 ( const struct V_8 * V_102 , T_3 V_103 )
{
while ( V_103 -- )
F_55 ( ( V_102 ++ ) -> V_8 ) ;
}
const char * F_90 ( struct V_6 * V_7 , unsigned V_5 )
{
...
if ( V_33 == 0 )
F_16 ( V_36 , & V_4 -> V_11 ) ;
F_92 ( V_7 -> V_9 + V_8 , 0 , V_38 ) ;
F_91 ( V_7 -> V_9 + V_8 , 0 , V_33 ) ;
V_106:
return V_33 ;
V_93:
F_17 ( & V_25 , V_11 ) ;
...
int F_93 ( unsigned V_8 , unsigned V_108 )
{
unsigned long V_11 ;
struct V_6 * V_7 ;
struct V_1 * V_4 = & V_1 [ V_8 ] ;
...
F_17 ( & V_25 , V_11 ) ;
F_86 ( V_7 -> V_95 ) ;
return V_7 -> V_109 ( V_7 , V_8 , V_108 ) ;
V_93:
F_17 ( & V_25 , V_11 ) ;
if ( V_33 )
F_13 ( L_29 ,
...
int F_94 ( unsigned V_8 )
{
struct V_6 * V_7 ;
int V_38 ;
V_7 = F_9 ( V_8 ) ;
F_85 ( V_7 -> V_95 ) ;
V_38 = V_7 -> V_105 ? V_7 -> V_105 ( V_7 , V_8 - V_7 -> V_9 ) : 0 ;
F_92 ( V_8 , 1 , V_38 ) ;
return V_38 ;
}
...
void F_97 ( unsigned V_8 , int V_38 )
{
struct V_6 * V_7 ;
V_7 = F_9 ( V_8 ) ;
F_85 ( V_7 -> V_95 ) ;
...
V_7 -> V_107 ( V_7 , V_8 - V_7 -> V_9 , V_38 ) ;
}
...
int F_99 ( unsigned V_8 )
{
struct V_6 * V_7 ;
V_7 = F_9 ( V_8 ) ;
return V_7 -> V_110 ? V_7 -> V_110 ( V_7 , V_8 - V_7 -> V_9 ) : - V_111 ;
}
...
static void F_100 ( struct V_112 * V_113 , struct V_6 * V_7 )
{
unsigned V_16 ;
unsigned V_8 = V_7 -> V_9 ;
struct V_1 * V_114 = & V_1 [ V_8 ] ;
int V_115 ;
for ( V_16 = 0 ; V_16 < V_7 -> V_15 ; V_16 ++ , V_8 ++ , V_114 ++ ) {
if ( ! F_11 ( V_10 , & V_114 -> V_11 ) )
continue;
V_115 = F_11 ( V_36 , & V_114 -> V_11 ) ;
F_101 ( V_113 , L_32 ,
V_8 , V_114 -> V_3 ,
V_115 ? L_7 : L_33 ,
V_7 -> V_105
? ( V_7 -> V_105 ( V_7 , V_16 ) ? L_34 : L_35 )
: L_36 ) ;
F_101 ( V_113 , L_37 ) ;
}
}
static int F_102 ( struct V_112 * V_113 , void * V_116 )
{
struct V_6 * V_7 = NULL ;
unsigned V_8 ;
int V_117 = 0 ;
...
if ( V_29 )
F_101 ( V_113 , L_39 ,
V_29 -> V_118 ? V_29 -> V_118 -> V_69 : L_40 ,
F_103 ( V_29 ) ) ;
if ( V_7 -> V_3 )
F_101 ( V_113 , L_41 , V_7 -> V_3 ) ;
if ( V_7 -> V_95 )
F_101 ( V_113 , L_42 ) ;
F_101 ( V_113 , L_43 ) ;
V_117 = 1 ;
...
static int F_104 ( struct V_120 * V_120 , struct V_121 * V_121 )
{
return F_105 ( V_121 , F_102 , NULL ) ;
}
static int T_1 F_106 ( void )
{
( void ) F_107 ( L_44 , V_122 | V_123 ,
NULL , NULL , & V_124 ) ;
return 0 ;
}
