...
F_20 ( V_33 ) ;
( ( V_261 * ) V_88 ) [ 0 ] = F_125 ( V_33 -> V_35 ) ;
( ( V_261 * ) V_88 ) [ 1 ] = F_125 ( V_33 -> V_35 >> 16 ) ;
break;
case V_262 :
V_62 = - V_230 ;
break;
...
F_28 ( & V_11 -> V_15 . V_271 -> V_19 , L_19 , V_142 ) ;
F_78 ( & V_33 -> V_13 -> V_30 ) ;
V_33 -> V_45 = V_46 ;
F_20 ( V_33 ) ;
V_11 -> V_141 = V_272 ;
...
static inline T_2 F_131 ( char * V_88 , T_6 V_274 , struct V_144 * V_144 )
{
...
T_6 V_275 ;
V_275 = F_131 ( V_88 , V_115 - V_274 , V_151 -> V_144 ) ;
V_88 += V_275 ;
V_274 += V_275 ;
}
F_31 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
...
V_33 -> V_159 . V_276 = ( unsigned long ) V_33 ;
V_33 -> V_45 = V_160 ;
V_33 -> V_145 = 0 ;
F_34 ( & V_33 -> V_155 ) ;
F_5 ( V_33 ) -> V_277 = V_278 ;
F_5 ( V_33 ) -> V_141 = V_273 ;
F_5 ( V_33 ) -> V_279 = 1 ;
#ifdef F_64
F_5 ( V_33 ) -> V_15 . V_280 = 1 ;
#endif
return 0 ;
return F_70 ( F_6 ( V_33 ) , & V_281 ) ;
}
...
V_11 -> V_22 = V_283 ;
V_11 -> V_15 . V_271 -> V_22 = V_70 ;
} else {
V_133 . V_24 = F_4 ( V_11 ) ;
V_133 . V_24 -> V_13 = & V_133 ;
V_11 -> V_22 = V_34 ;
V_11 -> V_15 . V_271 -> V_22 = V_23 ;
}
return 0 ;
}
static int F_144 ( struct V_10 * V_11 , struct V_284 * V_154 ,
struct V_285 * * V_286 , unsigned int V_287 ,
unsigned int V_288 , T_1 V_80 )
{
struct V_9 * V_33 = F_4 ( V_11 ) ;
unsigned long V_79 ;
int V_289 ;
...
return - V_67 ;
F_30 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
for ( V_119 = 0 ; V_119 < V_287 ; V_119 ++ ) {
V_143 = F_82 ( & V_286 [ V_119 ] -> V_60 ) ;
if ( ( 1 << V_143 ) & V_33 -> V_145 ) {
V_290 = - V_67 ;
goto V_291;
}
V_289 = F_25 ( & V_286 [ V_119 ] -> V_292 ) ;
if ( ! V_289 ) {
V_290 = - V_67 ;
goto V_291;
}
...
V_33 -> V_145 |= 1 << V_143 ;
F_89 ( V_33 ,
F_83 ( & V_286 [ V_119 ] -> V_60 ) , V_290 ) ;
}
V_291:
F_31 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
return V_290 ;
}
static int F_145 ( struct V_10 * V_11 , struct V_284 * V_154 ,
struct V_285 * * V_286 , unsigned int V_287 ,
T_1 V_80 )
{
struct V_9 * V_33 = F_4 ( V_11 ) ;
...
struct V_10 * V_24 ;
int V_62 ;
F_141 ( & V_132 -> V_19 , L_57 V_294 L_58 , V_295 ) ;
if ( ! V_107 . V_108 )
V_9 . V_79 = V_283 ;
...
static int F_152 ( struct V_131 * V_132 )
{
struct V_17 * V_13 ;
