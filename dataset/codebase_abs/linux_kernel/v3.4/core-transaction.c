...
void F_76 ( struct V_6 * V_7 , struct V_26 * V_114 )
{
struct V_96 * V_97 ;
unsigned long long V_44 ;
if ( V_114 -> V_60 != V_30 && V_114 -> V_60 != V_28 )
return;
if ( F_77 ( F_59 ( V_114 -> V_49 [ 0 ] ) ) ) {
F_78 ( V_7 , V_114 ) ;
return;
}
V_97 = F_68 ( V_7 , V_114 ) ;
...
V_44 = ( ( T_3 ) F_79 ( V_114 -> V_49 [ 1 ] ) << 32 ) |
V_114 -> V_49 [ 2 ] ;
if ( ! F_51 ( V_44 , V_97 -> V_46 ) )
F_74 ( V_7 , V_114 , V_97 , V_44 ) ;
else
F_75 ( V_7 , V_114 , V_97 , V_44 ) ;
}
void F_80 ( struct V_6 * V_7 , struct V_26 * V_114 )
{
struct V_1 * V_2 ;
unsigned long V_9 ;
V_56 * V_23 ;
...
static void F_82 ( struct V_6 * V_7 , struct V_96 * V_97 ,
...
V_111 = F_85 ( V_111 , 800u , 3u * 8000u ) ;
V_7 -> V_113 = V_111 ;
