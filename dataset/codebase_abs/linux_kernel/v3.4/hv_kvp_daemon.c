...
V_112 . V_142 = 0 ;
F_37 ( & V_112 , 1 , - 1 ) ;
V_97 = F_38 ( V_8 , V_143 , sizeof( V_143 ) , 0 ) ;
if ( V_97 < 0 ) {
F_4 ( V_10 , L_26 , V_97 ) ;
F_35 ( V_8 ) ;
return - 1 ;
}
V_113 = (struct V_90 * ) V_143 ;
V_114 = (struct V_88 * ) F_39 ( V_113 ) ;
V_116 = (struct V_115 * ) V_114 -> V_135 ;
switch ( V_116 -> V_136 . V_137 ) {
case V_138 :
V_44 = ( char * ) V_116 -> V_144 . V_145 . V_146 ;
V_147 = malloc ( strlen ( V_44 ) + 1 ) ;
if ( V_147 ) {
strcpy ( V_147 , V_44 ) ;
F_4 ( V_120 , L_27 ,
V_147 ) ;
...
V_116 -> V_144 . V_149 . V_135 . V_34 ,
V_116 -> V_144 . V_149 . V_135 . V_35 ,
V_116 -> V_144 . V_149 . V_135 . V_38 ,
V_116 -> V_144 . V_149 . V_135 . V_39 ) )
strcpy ( V_116 -> V_144 . V_149 . V_135 . V_34 , L_11 ) ;
break;
case V_150 :
...
V_116 -> V_144 . V_152 . V_34 ,
V_116 -> V_144 . V_152 . V_35 ) )
strcpy ( V_116 -> V_144 . V_152 . V_34 , L_11 ) ;
break;
default:
break;
}
if ( V_116 -> V_136 . V_137 != V_153 )
goto V_154;
if ( V_116 -> V_136 . V_1 != V_155 ) {
F_15 ( V_116 -> V_136 . V_1 ,
V_116 -> V_144 . V_156 . V_42 ,
V_116 -> V_144 . V_156 . V_135 . V_34 ,
V_40 ,
V_116 -> V_144 . V_156 . V_135 . V_38 ,
V_41 ) ;
goto V_154;
}
V_116 = (struct V_115 * ) V_114 -> V_135 ;
V_118 = ( char * ) V_116 -> V_144 . V_156 . V_135 . V_34 ;
V_117 = ( char * ) V_116 -> V_144 . V_156 . V_135 . V_38 ;
switch ( V_116 -> V_144 . V_156 . V_42 ) {
case V_157 :
F_23 ( V_117 ,
V_41 ) ;
strcpy ( V_118 , L_28 ) ;
