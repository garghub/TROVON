...
ASSERT ( V_18 -> V_21 == V_3 ) ;
ASSERT ( V_20 != NULL ) ;
ASSERT ( ( V_66 <= V_67 ) && ( V_67 < F_5 ( V_18 ) ) ) ;
ASSERT ( V_18 -> V_68 == NULL ||
V_18 -> V_68 == V_69 ) ;
F_17 ( V_18 ) ;
ASSERT ( F_20 ( & V_20 -> V_31 ) > 0 ) ;
V_18 -> V_68 = V_69 ;
...
ASSERT ( ! ( F_19 ( V_18 ) ) ) ;
ASSERT ( F_18 ( V_18 ) ) ;
ASSERT ( ! ( V_20 -> V_24 & ( V_29 | V_72 ) ) ) ;
ASSERT ( ! ( V_20 -> V_26 . V_27 & V_73 ) ) ;
ASSERT ( V_20 -> V_26 . V_27 & V_28 ) ;
ASSERT ( V_20 -> V_13 . V_59 -> V_60 & V_61 ) ;
ASSERT ( V_3 -> V_53 & V_54 ) ;
return;
}
F_16 ( V_18 ) ;
V_20 -> V_24 |= V_25 ;
V_20 -> V_24 &= ~ ( V_74 | V_29 | V_72 ) ;
V_20 -> V_26 . V_27 &= ~ V_73 ;
V_20 -> V_26 . V_27 |= V_28 ;
memset ( ( char * ) ( V_20 -> V_26 . V_75 ) , 0 ,
( V_20 -> V_26 . V_76 * sizeof( T_5 ) ) ) ;
V_20 -> V_13 . V_59 -> V_60 |= V_61 ;
V_3 -> V_53 |= V_54 ;
}
void
