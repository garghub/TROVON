...
struct V_39 * V_40 = NULL ;
struct V_59 V_48 ;
V_2 = F_26 ( sizeof( struct V_1 ) , V_60 ) ;
if ( ! V_2 )
return - V_61 ;
V_12 -> V_62 = 16 ;
V_15 = F_27 ( V_12 ) ;
...
static int T_3 F_36 ( struct V_58 * V_12 )
{
...
static int F_38 ( struct V_58 * V_12 , T_4 V_71 )
{
int V_15 = 0 ;
struct V_1 * V_2 = F_24 ( & V_12 -> V_24 ) ;
F_39 ( & V_12 -> V_24 , L_18 , V_2 -> V_35 ) ;
V_72 = V_2 -> V_35 ;
V_15 = F_18 ( V_2 , V_53 ) ;
return V_15 ;
}
static int F_40 ( struct V_58 * V_12 )
{
int V_15 = 0 ;
struct V_1 * V_2 = F_24 ( & V_12 -> V_24 ) ;
if ( V_72 == V_52 )
V_2 -> V_35 = V_53 ;
F_39 ( & V_12 -> V_24 , L_19 , V_72 ) ;
V_15 = F_18 ( V_2 , V_72 ) ;
return V_15 ;
}
static void F_41 ( struct V_58 * V_12 )
{
struct V_1 * V_2 = F_24 ( & V_12 -> V_24 ) ;
F_18 ( V_2 , V_53 ) ;
}
