...
const char T_4 * V_122 , V_95 V_123 , T_5 * V_124 )
{
char * V_37 ;
V_37 = F_12 ( V_123 + 1 , V_42 ) ;
if ( V_37 == NULL )
return - V_125 ;
if ( F_88 ( V_37 , V_122 , V_123 ) ) {
V_123 = - V_126 ;
goto V_40;
}
V_37 [ V_123 ] = '\0' ;
F_85 ( V_118 , V_127 , V_37 , V_123 ) ;
V_40:
F_9 ( V_37 ) ;
return V_123 ;
}
...
if ( V_118 == NULL )
return 0 ;
V_129 = F_90 ( L_43 , 0200 , NULL , & V_130 ) ;
if ( V_129 == NULL ) {
F_21 ( V_120 L_50
L_51 ) ;
return 0 ;
...
{
if ( ! strncmp ( V_57 , V_132 , strlen ( V_132 ) ) ) {
V_57 += strlen ( V_132 ) ;
V_118 = V_57 ;
}
...
static int F_94 ( struct V_1 * V_133 , unsigned long V_134 ,
void * V_34 )
{
char * V_135 = V_34 ;
if ( V_118 == NULL )
return 0 ;
F_85 ( V_118 , V_136 , V_135 ,
strlen ( V_135 ) + 1 ) ;
return 0 ;
}
