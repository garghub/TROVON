...
static T_3 F_61 ( struct V_22 * V_23 , struct V_24 * V_62 ,
char * V_26 )
{
struct V_1 * V_2 = F_15 ( V_23 ) ;
...
struct V_1 * V_2 ;
int V_19 , V_4 = 0 , V_103 ;
T_2 V_104 , V_105 ;
V_2 = F_70 ( sizeof( * V_2 ) , V_106 ) ;
if ( V_2 == NULL )
return - V_107 ;
F_71 ( & V_2 -> V_36 ) ;
F_72 ( V_16 , V_2 ) ;
...
case V_101 :
V_2 -> V_89 = 0x0e ;
V_103 = F_27 ( V_79 ) & 0x07 ;
break;
case V_102 :
V_2 -> V_89 = 0x3e ;
V_103 = F_27 ( V_79 ) & 0x03 ;
if ( V_103 == 0x03 )
V_103 += F_27 ( V_109 ) ;
break;
default:
...
if ( ! ( V_105 & V_111 ) )
V_2 -> V_87 = 1 ;
if ( V_97 -> V_108 == V_99 && V_103 >= 1 )
V_2 -> V_87 = ! V_2 -> V_87 ;
V_2 -> V_63 = F_27 ( V_65 ) ;
if ( ( V_2 -> V_63 & V_112 ) == 0x0 )
V_2 -> V_85 = 1 ;
if ( V_97 -> V_108 == V_102 ) {
if ( ( V_2 -> V_63 & V_112 ) == 0x1 &&
! ( V_105 & V_113 ) )
V_2 -> V_85 = 1 ;
}
if ( V_97 -> V_108 == V_101 || V_97 -> V_108 == V_102 ) {
if ( ! ( V_105 & V_113 ) ||
( V_2 -> V_63 & V_112 ) == 0x1 )
V_2 -> V_89 |= ( 1 << 0 ) ;
}
...
if ( ! ( V_67 & V_115 ) )
V_2 -> V_89 |= ( 1 << 4 ) ;
V_2 -> V_94 = ! ( F_27 ( V_49 ) & V_116 ) ;
}
V_104 = F_27 ( V_117 ) ;
if ( V_104 & V_118 ) {
V_2 -> V_11 = ( 0x3 << 3 ) | 0x3 ;
} else {
V_2 -> V_11 = ( ( V_2 -> V_63 & V_119 ) >> 4 ) |
( ( V_2 -> V_63 & V_120 ) >> 3 ) ;
}
V_2 -> V_11 &= V_2 -> V_89 ;
for ( V_19 = 0 ; V_19 < V_121 ; V_19 ++ )
F_52 ( V_16 , V_19 ) ;
V_4 = F_73 ( & V_16 -> V_23 . V_83 , & V_84 ) ;
if ( V_4 )
goto V_122;
if ( V_2 -> V_85 ) {
V_4 = F_73 ( & V_16 -> V_23 . V_83 , & V_86 ) ;
if ( V_4 )
goto V_123;
}
if ( V_2 -> V_87 ) {
V_4 = F_73 ( & V_16 -> V_23 . V_83 , & V_88 ) ;
if ( V_4 )
goto V_123;
}
if ( V_2 -> V_89 & ( 1 << 0 ) ) {
V_4 = F_73 ( & V_16 -> V_23 . V_83 , & V_90 ) ;
if ( V_4 )
goto V_123;
}
if ( V_2 -> V_89 & ( 1 << 3 ) ) {
V_4 = F_73 ( & V_16 -> V_23 . V_83 , & V_91 ) ;
if ( V_4 )
goto V_123;
}
if ( V_2 -> V_89 & ( 1 << 4 ) ) {
V_4 = F_73 ( & V_16 -> V_23 . V_83 , & V_92 ) ;
if ( V_4 )
goto V_123;
}
if ( V_2 -> V_89 & ( 1 << 5 ) ) {
V_4 = F_73 ( & V_16 -> V_23 . V_83 , & V_93 ) ;
if ( V_4 )
goto V_123;
}
if ( V_2 -> V_94 ) {
V_2 -> V_66 = F_74 () ;
V_4 = F_73 ( & V_16 -> V_23 . V_83 , & V_95 ) ;
if ( V_4 )
goto V_123;
}
V_2 -> V_124 = F_75 ( & V_16 -> V_23 ) ;
if ( F_76 ( V_2 -> V_124 ) ) {
V_4 = F_77 ( V_2 -> V_124 ) ;
goto V_123;
}
F_78 ( & V_16 -> V_23 , L_12 ,
V_98 [ V_97 -> V_108 ] , V_103 ) ;
...
int V_19 ;
F_21 ( & V_2 -> V_36 ) ;
if ( F_82 ( V_127 , V_2 -> V_128 + V_129 * 2 ) ||
! V_2 -> V_130 ) {
V_2 -> V_31 = F_27 ( V_131 ) << 8 ;
V_2 -> V_31 |= F_27 ( V_132 ) ;
V_126 = ( F_27 ( V_133 ) << 8 ) |
F_27 ( V_134 ) ;
...
( ( V_126 >> ( ( V_19 + 5 ) * 2 ) ) & 3 ) ;
if ( V_2 -> V_89 & ( 1 << 5 ) ) {
V_2 -> V_31 |= F_27 ( V_136 ) << 24 ;
V_126 = F_27 ( V_137 ) ;
V_2 -> V_33 [ V_59 ] [ 5 ] = F_27 ( V_138 ) << 2 |
( ( V_126 >> 4 ) & 3 ) ;
}
...
if ( V_2 -> V_94 )
V_2 -> V_67 = F_27 ( V_114 ) & 0x3f ;
V_2 -> V_128 = V_127 ;
}
if ( F_82 ( V_127 , V_2 -> V_140 + V_129 * 60 ) ||
! V_2 -> V_130 ) {
V_2 -> V_63 = F_27 ( V_65 ) ;
V_2 -> V_5 = F_27 ( V_49 ) ;
for ( V_19 = 0 ; V_19 < V_37 ; V_19 ++ ) {
