...
static long
F_48 ( struct V_2 * V_2 , unsigned int V_39 , unsigned long V_40 )
{
F_49 ( sizeof( T_4 ) != sizeof( V_77 ) ) ;
switch ( V_39 ) {
case V_58 :
case V_60 :
case V_61 : {
V_77 T_2 * V_78 = F_50 ( V_40 ) ;
T_4 V_42 ;
T_7 V_79 ;
int V_80 ;
V_79 = F_51 () ;
...
T_7 V_79 ;
int V_80 ;
V_80 = F_53 ( V_72 . V_42 , & V_83 -> V_42 ) ;
V_80 |= F_53 ( V_72 . V_75 , & V_83 -> V_75 ) ;
if ( V_80 )
return - V_74 ;
V_79 = F_51 () ;
F_52 ( V_81 ) ;
