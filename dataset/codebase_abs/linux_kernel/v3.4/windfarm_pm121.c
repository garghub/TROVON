...
static struct V_25 * F_23 ( struct V_25 * V_98 ,
const char * V_99 ,
unsigned int V_100 )
{
if ( V_15 [ V_100 ] == NULL && ! strcmp ( V_98 -> V_18 , V_99 ) ) {
if ( F_24 ( V_98 ) == 0 )
V_15 [ V_100 ] = V_98 ;
}
return V_15 [ V_100 ] ;
}
static void F_25 ( struct V_25 * V_98 )
{
int V_101 = 1 ;
if ( V_102 )
return;
V_101 = F_23 ( V_98 , L_26 , V_103 ) && V_101 ;
V_101 = F_23 ( V_98 , L_27 , V_104 ) && V_101 ;
V_101 = F_23 ( V_98 , L_28 , V_73 ) && V_101 ;
V_101 = F_23 ( V_98 , L_29 , V_85 ) && V_101 ;
if ( V_101 )
V_102 = 1 ;
}
...
struct V_51 * * V_105 )
{
if ( * V_105 == NULL && ! strcmp ( V_52 -> V_18 , V_99 ) ) {
if ( F_27 ( V_52 ) == 0 )
* V_105 = V_52 ;
}
return * V_105 ;
}
static void F_28 ( struct V_51 * V_106 )
{
int V_101 = 1 ;
if ( V_107 )
return;
V_101 = F_26 ( V_106 , L_30 ,
& V_87 ) && V_101 ;
V_101 = F_26 ( V_106 , L_31 ,
& V_108 ) && V_101 ;
V_101 = F_26 ( V_106 , L_32 ,
& V_109 ) && V_101 ;
V_101 = F_26 ( V_106 , L_33 ,
& V_88 ) && V_101 ;
V_101 = F_26 ( V_106 , L_34 ,
& V_110 ) && V_101 ;
V_101 = F_26 ( V_106 , L_35 ,
& V_111 ) && V_101 ;
V_101 = F_26 ( V_106 , L_36 ,
& V_112 ) && V_101 ;
V_101 = F_26 ( V_106 , L_37 ,
& V_113 ) && V_101 ;
V_101 = F_26 ( V_106 , L_38 ,
& V_114 ) && V_101 ;
if ( V_101 )
V_107 = 1 ;
}
static int F_29 ( struct V_115 * V_116 ,
unsigned long V_117 , void * V_118 )
{
switch ( V_117 ) {
case V_119 :
F_5 ( L_39 ,
( (struct V_25 * ) V_118 ) -> V_18 ) ;
F_25 ( V_118 ) ;
break;
case V_120 :
F_5 ( L_40 ,
( (struct V_51 * ) V_118 ) -> V_18 ) ;
F_28 ( V_118 ) ;
break;
case V_121 :
if ( V_102 && V_107 )
...
static int T_2 F_33 ( struct V_126 * V_127 )
{
F_34 ( & V_128 ) ;
return 0 ;
}
