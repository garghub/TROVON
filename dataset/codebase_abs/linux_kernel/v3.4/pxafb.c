...
if ( V_119 -> V_161 ++ == 0 ) {
F_49 () ;
F_50 ( & V_119 -> V_2 -> V_26 , V_117 ) ;
F_51 () ;
}
return 0 ;
}
static int F_52 ( struct V_23 * V_24 , int V_159 )
{
struct V_118 * V_119 = (struct V_118 * ) V_24 ;
if ( V_119 -> V_161 == 1 ) {
...
static int F_53 ( struct V_46 * V_27 ,
struct V_23 * V_24 )
{
struct V_118 * V_119 = (struct V_118 * ) V_24 ;
struct V_46 * V_166 = & V_119 -> V_2 -> V_26 . V_27 ;
int V_167 , V_168 , V_138 , V_48 ;
V_167 = F_54 ( V_27 -> V_139 ) ;
V_168 = F_55 ( V_27 -> V_139 ) ;
...
if ( ( V_167 * V_48 ) % 32 )
return - V_49 ;
V_27 -> V_67 = F_56 ( V_27 -> V_67 * V_48 , 32 ) / V_48 ;
...
V_120 = F_58 ( V_119 -> V_26 . V_39 . V_78 * V_27 -> V_86 ) ;
if ( V_119 -> V_171 ) {
...
V_168 = F_55 ( V_27 -> V_139 ) ;
V_138 = F_45 ( V_27 -> V_139 ) ;
V_119 -> V_131 [ 0 ] = F_60 ( V_27 -> V_67 ) | F_61 ( V_27 -> V_68 ) |
F_62 ( V_48 ) ;
V_119 -> V_131 [ 1 ] = F_63 ( V_167 ) | F_64 ( V_168 ) ;
if ( V_119 -> V_169 == V_173 )
V_119 -> V_131 [ 1 ] |= F_65 ( V_138 ) ;
...
static int T_3 F_71 ( struct V_1 * V_187 ,
struct V_118 * V_119 )
{
V_119 -> V_171 = F_72 ( F_58 ( V_187 -> V_172 ) ,
V_188 | V_189 ) ;
if ( V_119 -> V_171 == NULL )
return - V_190 ;
V_119 -> V_122 = F_73 ( V_119 -> V_171 ) ;
V_119 -> V_172 = F_58 ( V_187 -> V_172 ) ;
F_74 ( & V_119 -> V_26 . V_191 ) ;
V_119 -> V_26 . V_39 . V_192 = V_119 -> V_122 ;
V_119 -> V_26 . V_39 . V_87 = V_187 -> V_172 ;
F_75 ( & V_119 -> V_26 . V_191 ) ;
...
F_66 ( V_2 , V_119 , V_65 ) ;
V_37 = F_77 ( & V_119 -> V_26 ) ;
if ( V_37 ) {
F_78 ( V_2 -> V_91 , L_5 , V_65 ) ;
continue;
}
V_37 = F_71 ( V_2 , V_119 ) ;
if ( V_37 ) {
...
static void T_4 F_81 ( struct V_1 * V_2 )
{
int V_65 ;
if ( ! F_68 () )
return;
...
static inline unsigned int F_83 ( struct V_1 * V_2 ,
unsigned int V_56 )
{
unsigned long long V_196 ;
V_196 = ( unsigned long long ) ( F_84 ( V_2 -> V_197 ) / 10000 ) ;
V_196 *= V_56 ;
F_85 ( V_196 , 100000000 * 2 ) ;
return ( unsigned int ) V_196 ;
}
static inline void F_86 ( struct V_1 * V_2 , unsigned int V_196 )
{
unsigned long V_198 ;
...
V_198 = F_84 ( V_2 -> V_197 ) / ( V_196 * V_2 -> V_26 . V_27 . V_69 ) ;
V_2 -> V_199 = V_198 ;
}
unsigned long F_87 ( struct V_200 * V_91 )
{
struct V_1 * V_2 = F_88 ( V_91 ) ;
if ( ! V_2 || ( V_2 -> V_6 != V_9 ) )
return 0 ;
return V_2 -> V_199 ;
}
...
V_204 = F_89 ( struct V_206 , V_202 [ V_101 ] ) ;
V_202 -> V_207 = V_121 ;
V_202 -> V_208 = 0 ;
V_202 -> V_209 = V_120 ;
...
V_205 = F_89 ( struct V_206 , V_203 [ V_42 ] ) ;
...
V_204 = F_89 ( struct V_206 , V_202 [ V_219 ] ) ;
V_218 = F_89 ( struct V_206 , V_220 ) ;
V_202 -> V_110 = V_2 -> V_211 + V_204 ;
...
int F_91 ( struct V_23 * V_24 )
{
struct V_1 * V_2 = F_92 ( V_24 , struct V_1 , V_26 ) ;
T_2 V_223 ;
int V_37 = 0 ;
...
int F_94 ( struct V_23 * V_24 , V_222 * V_247 , int V_248 )
{
int V_65 ;
struct V_1 * V_2 = F_92 ( V_24 , struct V_1 , V_26 ) ;
...
static unsigned int F_96 ( unsigned V_251 , unsigned long V_252 )
{
...
unsigned long V_254 = F_84 ( V_2 -> V_197 ) ;
...
V_2 -> V_236 =
F_98 ( V_27 -> V_67 ) |
F_99 ( F_96 ( V_255 , V_254 ) ) |
F_100 ( F_96 ( V_256 , V_254 ) ) |
F_101 ( F_96 ( V_257 , V_254 ) ) ;
V_2 -> V_238 = F_102 ( V_27 -> V_68 ) ;
V_2 -> V_240 = V_2 -> V_51 | F_103 ( F_96 ( V_258 , V_254 ) ) ;
V_2 -> V_240 |= ( V_27 -> V_75 & V_265 ) ? V_266 : 0 ;
V_2 -> V_240 |= ( V_27 -> V_75 & V_267 ) ? V_268 : 0 ;
V_2 -> V_269 = 1 ;
}
static int F_104 ( void * V_270 )
{
...
F_67 ( & V_2 -> V_245 ) ;
F_67 ( & V_2 -> V_273 ) ;
V_2 -> V_275 = F_113 ( F_104 , V_2 ,
L_12 ) ;
if ( F_114 ( V_2 -> V_275 ) ) {
F_105 ( L_13 , V_137 ) ;
return F_115 ( V_2 -> V_275 ) ;
}
return 0 ;
}
static inline int F_112 ( struct V_1 * V_2 ) { return 0 ; }
static void F_116 ( struct V_1 * V_2 ,
struct V_46 * V_27 )
{
unsigned int V_276 , V_196 = F_83 ( V_2 , V_27 -> V_56 ) ;
V_2 -> V_236 =
F_98 ( V_27 -> V_67 ) +
F_101 ( V_27 -> V_69 ) +
F_99 ( V_27 -> V_70 ) +
...
static inline void F_121 ( struct V_1 * V_2 , int V_289 )
{
F_28 ( L_14 , V_289 ? L_15 : L_16 ) ;
if ( V_2 -> V_290 )
V_2 -> V_290 ( V_289 ) ;
}
static inline void F_122 ( struct V_1 * V_2 , int V_289 )
{
...
static T_7 F_127 ( int V_295 , void * V_296 )
{
...
if ( V_300 & F_41 ( 1 ) )
F_109 ( & V_2 -> V_194 [ 0 ] . V_135 ) ;
if ( V_300 & F_41 ( 2 ) )
F_109 ( & V_2 -> V_194 [ 1 ] . V_135 ) ;
F_3 ( V_2 , V_134 , V_300 ) ;
}
#endif
return V_301 ;
}
static void F_129 ( struct V_1 * V_2 , T_1 V_6 )
{
T_1 V_302 ;
F_74 ( & V_2 -> V_272 ) ;
V_302 = V_2 -> V_6 ;
...
static void F_130 ( struct V_308 * V_309 )
{
struct V_1 * V_2 =
F_92 ( V_309 , struct V_1 , V_12 ) ;
T_1 V_6 = F_131 ( & V_2 -> V_8 , - 1 ) ;
F_129 ( V_2 , V_6 ) ;
}
static int
F_132 ( struct V_310 * V_311 , unsigned long V_5 , void * V_312 )
{
struct V_1 * V_2 = F_133 ( V_311 , V_313 ) ;
T_1 V_196 ;
switch ( V_5 ) {
case V_314 :
#ifdef F_128
...
break;
case V_315 :
V_196 = F_83 ( V_2 , V_2 -> V_26 . V_27 . V_56 ) ;
F_86 ( V_2 , V_196 ) ;
...
static int
F_134 ( struct V_310 * V_311 , unsigned long V_5 , void * V_312 )
{
struct V_1 * V_2 = F_133 ( V_311 , V_316 ) ;
...
static int F_135 ( struct V_200 * V_91 )
{
struct V_1 * V_2 = F_88 ( V_91 ) ;
F_129 ( V_2 , V_305 ) ;
return 0 ;
}
static int F_136 ( struct V_200 * V_91 )
{
struct V_1 * V_2 = F_88 ( V_91 ) ;
F_129 ( V_2 , V_307 ) ;
return 0 ;
}
static int T_3 F_137 ( struct V_1 * V_2 )
{
int V_120 = F_58 ( V_2 -> V_172 ) ;
V_2 -> V_171 = F_72 ( V_120 , V_188 | V_189 ) ;
if ( V_2 -> V_171 == NULL )
return - V_190 ;
V_2 -> V_122 = F_73 ( V_2 -> V_171 ) ;
V_2 -> V_172 = V_120 ;
...
V_2 -> V_51 = F_139 ( ( V_90 -> V_321 >> 10 ) & 0xff ) ;
...
static struct V_1 * T_3 F_140 ( struct V_200 * V_91 )
{
struct V_1 * V_2 ;
void * V_341 ;
struct V_58 * V_90 = V_91 -> V_92 ;
V_2 = F_141 ( sizeof( struct V_1 ) + sizeof( V_34 ) * 16 , V_188 ) ;
if ( ! V_2 )
return NULL ;
memset ( V_2 , 0 , sizeof( struct V_1 ) ) ;
V_2 -> V_91 = V_91 ;
V_2 -> V_197 = F_142 ( V_91 , NULL ) ;
if ( F_114 ( V_2 -> V_197 ) ) {
F_143 ( V_2 ) ;
return NULL ;
}
...
#endif
F_144 ( & V_2 -> V_351 ) ;
F_145 ( & V_2 -> V_12 , F_130 ) ;
F_146 ( & V_2 -> V_272 ) ;
F_67 ( & V_2 -> V_294 ) ;
return V_2 ;
}
static int T_3 F_147 ( struct V_200 * V_91 , const char * V_352 )
{
struct V_58 * V_90 = V_91 -> V_92 ;
...
V_354 = V_65 ;
if ( ! V_356 && ! V_357 ) {
V_48 = F_148 ( & V_353 [ V_65 + 1 ] , NULL , 0 ) ;
V_356 = 1 ;
} else
goto V_358;
break;
case 'x' :
if ( ! V_357 ) {
V_68 = F_148 ( & V_353 [ V_65 + 1 ] , NULL , 0 ) ;
V_357 = 1 ;
} else
goto V_358;
break;
...
if ( V_65 < 0 && V_357 ) {
V_67 = F_148 ( V_353 , NULL , 0 ) ;
V_355 = 1 ;
}
V_358:
if ( V_355 ) {
F_149 ( V_91 , L_27 , V_67 , V_68 ) ;
...
static int T_3 F_150 ( struct V_200 * V_91 , char * V_352 )
{
struct V_58 * V_90 = V_91 -> V_92 ;
struct V_57 * V_60 = & V_90 -> V_62 [ 0 ] ;
char V_359 [ 64 ] ;
...
F_78 ( V_91 , L_69 , V_352 ) ;
return - V_49 ;
}
if ( V_359 [ 0 ] != '\0' )
F_149 ( V_91 , L_70 , V_359 ) ;
return 0 ;
}
static int T_3 F_152 ( struct V_200 * V_91 , char * V_372 )
{
char * V_352 ;
int V_37 ;
if ( ! V_372 || ! * V_372 )
return 0 ;
F_153 ( V_91 , L_71 , V_372 ? V_372 : L_72 ) ;
while ( ( V_352 = F_154 ( & V_372 , L_73 ) ) != NULL ) {
V_37 = F_150 ( V_91 , V_352 ) ;
if ( V_37 )
return V_37 ;
}
return 0 ;
...
return - V_160 ;
if ( V_372 )
F_157 ( V_373 , V_372 , sizeof( V_373 ) ) ;
return 0 ;
}
static void T_3 F_158 ( struct V_200 * V_91 ,
struct V_58 * V_90 )
{
if ( V_90 -> V_321 )
return;
...
static int T_3 F_160 ( struct V_376 * V_91 )
{
struct V_1 * V_2 ;
struct V_58 * V_90 ;
struct V_377 * V_378 ;
int V_295 , V_37 ;
F_153 ( & V_91 -> V_91 , L_84 ) ;
V_90 = V_91 -> V_91 . V_92 ;
V_37 = - V_190 ;
V_2 = NULL ;
if ( ! V_90 )
goto V_379;
V_37 = F_152 ( & V_91 -> V_91 , V_373 ) ;
if ( V_37 < 0 )
goto V_379;
F_158 ( & V_91 -> V_91 , V_90 ) ;
F_153 ( & V_91 -> V_91 , L_85 ,
V_90 -> V_62 -> V_67 ,
V_90 -> V_62 -> V_68 ,
V_90 -> V_62 -> V_48 ) ;
if ( V_90 -> V_62 -> V_67 == 0 ||
...
V_378 = F_161 ( V_91 , V_384 , 0 ) ;
if ( V_378 == NULL ) {
F_78 ( & V_91 -> V_91 , L_88 ) ;
V_37 = - V_160 ;
goto V_385;
}
V_378 = F_162 ( V_378 -> V_121 , F_163 ( V_378 ) , V_91 -> V_353 ) ;
if ( V_378 == NULL ) {
F_78 ( & V_91 -> V_91 , L_89 ) ;
V_37 = - V_386 ;
goto V_385;
}
V_2 -> V_4 = F_164 ( V_378 -> V_121 , F_163 ( V_378 ) ) ;
if ( V_2 -> V_4 == NULL ) {
F_78 ( & V_91 -> V_91 , L_90 ) ;
V_37 = - V_386 ;
goto V_387;
}
V_2 -> V_388 = F_58 ( sizeof( struct V_206 ) ) ;
V_2 -> V_97 = F_165 ( V_2 -> V_91 , V_2 -> V_388 ,
& V_2 -> V_211 , V_188 ) ;
if ( V_2 -> V_97 == NULL ) {
F_78 ( & V_91 -> V_91 , L_91 ) ;
V_37 = - V_190 ;
...
V_37 = F_167 ( V_295 , F_127 , 0 , L_94 , V_2 ) ;
if ( V_37 ) {
F_78 ( & V_91 -> V_91 , L_95 , V_37 ) ;
V_37 = - V_386 ;
goto V_391;
}
V_37 = F_112 ( V_2 ) ;
...
F_76 ( V_2 ) ;
#ifdef F_27
V_2 -> V_313 . V_394 = F_132 ;
V_2 -> V_316 . V_394 = F_134 ;
F_169 ( & V_2 -> V_313 ,
V_395 ) ;
F_169 ( & V_2 -> V_316 ,
V_396 ) ;
...
F_170 ( V_295 , V_2 ) ;
V_391:
F_82 ( V_2 -> V_171 , V_2 -> V_172 ) ;
V_390:
F_171 ( & V_91 -> V_91 , V_2 -> V_388 ,
V_2 -> V_97 , V_2 -> V_211 ) ;
V_389:
F_172 ( V_2 -> V_4 ) ;
V_387:
F_173 ( V_378 -> V_121 , F_163 ( V_378 ) ) ;
V_385:
F_174 ( V_2 -> V_197 ) ;
F_168 ( V_91 , NULL ) ;
F_143 ( V_2 ) ;
...
static int T_4 F_175 ( struct V_376 * V_91 )
{
struct V_1 * V_2 = F_176 ( V_91 ) ;
struct V_377 * V_378 ;
int V_295 ;
struct V_23 * V_24 ;
if ( ! V_2 )
