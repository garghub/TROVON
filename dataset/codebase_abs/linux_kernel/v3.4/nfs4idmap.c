...
{
struct V_58 * V_59 ;
V_59 = V_57 -> V_60 ? V_57 -> V_60 : V_57 -> V_61 ;
return V_59 -> V_9 ;
}
static T_2
F_46 ( struct V_56 * V_57 , int type , const char * V_9 , T_3 V_62 ,
T_4 * V_8 )
{
struct V_4 * V_50 , V_63 = {
. type = type ,
} ;
int V_64 ;
if ( V_62 + 1 > sizeof( V_63 . V_9 ) )
return V_65 ;
memcpy ( V_63 . V_9 , V_9 , V_62 ) ;
V_63 . V_9 [ V_62 ] = '\0' ;
F_3 ( V_63 . V_10 , F_45 ( V_57 ) , sizeof( V_63 . V_10 ) ) ;
V_64 = F_47 ( V_57 , F_39 , & V_63 , & V_53 , & V_50 ) ;
if ( V_64 == - V_52 )
return V_65 ;
if ( V_64 )
return F_48 ( V_64 ) ;
...
static int
F_49 ( struct V_56 * V_57 , int type , T_4 V_8 , char * V_9 )
{
struct V_4 * V_50 , V_63 = {
. V_8 = V_8 ,
. type = type ,
...
int V_64 ;
F_3 ( V_63 . V_10 , F_45 ( V_57 ) , sizeof( V_63 . V_10 ) ) ;
V_64 = F_47 ( V_57 , F_26 , & V_63 , & V_49 , & V_50 ) ;
if ( V_64 == - V_52 )
return sprintf ( V_9 , L_1 , V_8 ) ;
if ( V_64 )
return V_64 ;
V_64 = strlen ( V_50 -> V_9 ) ;
F_50 ( V_64 > V_48 ) ;
memcpy ( V_9 , V_50 -> V_9 , V_64 ) ;
F_29 ( & V_50 -> V_6 , & V_49 ) ;
return V_64 ;
}
static bool
F_51 ( struct V_56 * V_57 , int type , const char * V_9 , T_3 V_62 , T_4 * V_8 )
{
int V_64 ;
char V_35 [ 11 ] ;
if ( V_62 + 1 > sizeof( V_35 ) )
return false ;
memcpy ( V_35 , V_9 , V_62 ) ;
V_35 [ V_62 ] = '\0' ;
V_64 = F_52 ( V_9 , 10 , V_8 ) ;
return V_64 == 0 ;
}
static T_2
F_53 ( struct V_56 * V_57 , int type , const char * V_9 , T_3 V_62 , T_4 * V_8 )
{
if ( V_66 && V_57 -> V_67 < V_68 )
if ( F_51 ( V_57 , type , V_9 , V_62 , V_8 ) )
return 0 ;
return F_46 ( V_57 , type , V_9 , V_62 , V_8 ) ;
}
static int
F_54 ( struct V_56 * V_57 , int type , T_4 V_8 , char * V_9 )
{
if ( V_66 && V_57 -> V_67 < V_68 )
return sprintf ( V_9 , L_1 , V_8 ) ;
return F_49 ( V_57 , type , V_8 , V_9 ) ;
}
T_2
F_55 ( struct V_56 * V_57 , const char * V_9 , T_5 V_62 ,
T_6 * V_8 )
{
return F_53 ( V_57 , V_45 , V_9 , V_62 , V_8 ) ;
}
T_2
F_56 ( struct V_56 * V_57 , const char * V_9 , T_5 V_62 ,
T_6 * V_8 )
{
return F_53 ( V_57 , V_18 , V_9 , V_62 , V_8 ) ;
}
int
F_57 ( struct V_56 * V_57 , T_6 V_8 , char * V_9 )
{
return F_54 ( V_57 , V_45 , V_8 , V_9 ) ;
}
int
F_58 ( struct V_56 * V_57 , T_6 V_8 , char * V_9 )
{
return F_54 ( V_57 , V_18 , V_8 , V_9 ) ;
}
