...
V_106 += F_67 ( & F_65 ( V_44 ) -> V_5 [ V_92 ] ) ;
V_105 -> V_72 = V_105 -> V_109 = V_44 -> V_109 - V_106 ;
V_44 -> V_109 -= V_105 -> V_72 ;
...
F_68 ( V_44 , V_44 -> V_111 - F_69 ( V_44 ) ) ;
for ( V_64 = V_44 -> V_71 ; V_64 ; V_64 = V_64 -> V_71 ) {
V_44 -> V_109 += V_64 -> V_72 ;
V_44 -> V_72 += V_64 -> V_72 ;
if ( V_44 -> V_87 != V_64 -> V_87 )
V_44 -> V_87 = V_89 ;
else if ( V_44 -> V_87 == V_112 )
V_44 -> V_110 = F_70 ( V_44 -> V_110 , V_64 -> V_110 ) ;
V_44 -> V_31 += V_64 -> V_31 ;
}
...
int F_74 ( struct V_29 * V_30 , V_13 V_26 )
{
struct V_19 * V_22 ;
struct V_3 * V_3 ;
V_3 = V_30 -> V_47 ? F_75 ( V_30 -> V_47 ) : F_75 ( F_76 ( V_30 ) -> V_47 ) ;
F_26 ( V_3 , V_115 ) ;
if ( F_4 ( & V_3 -> V_4 . V_5 . V_7 ) > V_3 -> V_4 . V_5 . V_116 )
F_21 ( V_3 ) ;
if ( ( V_22 = F_36 ( V_3 , F_30 ( V_30 ) , V_26 ) ) != NULL ) {
int V_117 ;
F_25 ( & V_22 -> V_18 . V_37 ) ;
V_117 = F_45 ( V_22 , V_30 ) ;
F_35 ( & V_22 -> V_18 . V_37 ) ;
F_17 ( V_22 ) ;
return V_117 ;
}
...
struct V_29 * F_77 ( struct V_29 * V_30 , V_13 V_26 )
{
const struct V_45 * V_25 ;
V_13 V_72 ;
if ( V_30 -> V_20 != F_71 ( V_118 ) )
return V_30 ;
if ( ! F_78 ( V_30 , sizeof( struct V_45 ) ) )
return V_30 ;
V_25 = F_30 ( V_30 ) ;
if ( V_25 -> V_79 < 5 || V_25 -> V_119 != 4 )
return V_30 ;
if ( ! F_78 ( V_30 , V_25 -> V_79 * 4 ) )
return V_30 ;
V_25 = F_30 ( V_30 ) ;
V_72 = F_48 ( V_25 -> V_113 ) ;
if ( V_30 -> V_72 < V_72 || V_72 < ( V_25 -> V_79 * 4 ) )
return V_30 ;
if ( F_79 ( F_30 ( V_30 ) ) ) {
V_30 = F_80 ( V_30 , V_102 ) ;
if ( V_30 ) {
if ( F_51 ( V_30 , V_72 ) )
return V_30 ;
memset ( F_46 ( V_30 ) , 0 , sizeof( struct V_120 ) ) ;
if ( F_74 ( V_30 , V_26 ) )
return NULL ;
V_30 -> V_121 = 0 ;
}
...
static int T_5 F_81 ( struct V_3 * V_3 )
{
struct V_122 * V_123 ;
struct V_124 * V_125 ;
V_123 = V_126 ;
if ( ! F_82 ( V_3 , & V_127 ) ) {
V_123 = F_83 ( V_123 , sizeof( V_126 ) , V_128 ) ;
if ( V_123 == NULL )
goto V_129;
V_123 [ 0 ] . V_111 = & V_3 -> V_4 . V_5 . V_116 ;
V_123 [ 1 ] . V_111 = & V_3 -> V_4 . V_5 . V_130 ;
V_123 [ 2 ] . V_111 = & V_3 -> V_4 . V_5 . V_67 ;
}
V_125 = F_84 ( V_3 , V_131 , V_123 ) ;
if ( V_125 == NULL )
goto V_132;
V_3 -> V_4 . V_133 = V_125 ;
return 0 ;
...
static void T_6 F_86 ( struct V_3 * V_3 )
{
struct V_122 * V_123 ;
V_123 = V_3 -> V_4 . V_133 -> V_134 ;
F_87 ( V_3 -> V_4 . V_133 ) ;
F_85 ( V_123 ) ;
}
...
static inline int F_81 ( struct V_3 * V_3 )
{
return 0 ;
}
...
static int T_5 F_90 ( struct V_3 * V_3 )
{
V_3 -> V_4 . V_5 . V_116 = 256 * 1024 ;
V_3 -> V_4 . V_5 . V_130 = 192 * 1024 ;
V_3 -> V_4 . V_5 . V_67 = V_136 ;
F_91 ( & V_3 -> V_4 . V_5 ) ;
return F_81 ( V_3 ) ;
}
static void T_6 F_92 ( struct V_3 * V_3 )
{
F_86 ( V_3 ) ;
F_93 ( & V_3 -> V_4 . V_5 , & V_14 ) ;
}
void T_7 F_94 ( void )
{
F_88 () ;
...
V_14 . V_140 = F_15 ;
V_14 . V_141 = NULL ;
V_14 . V_142 = sizeof( struct V_19 ) ;
V_14 . V_143 = F_9 ;
V_14 . V_144 = F_24 ;
V_14 . V_145 = 10 * 60 * V_146 ;
F_96 ( & V_14 ) ;
}
