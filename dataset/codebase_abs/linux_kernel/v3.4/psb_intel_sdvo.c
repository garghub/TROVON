...
struct V_45 * V_46 )
{
struct V_184 * V_185 = V_6 -> V_10 -> V_186 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_46 -> V_22 & V_187 )
return V_188 ;
if ( V_1 -> V_189 > V_46 -> clock )
return V_190 ;
if ( V_1 -> V_191 < V_46 -> clock )
return V_192 ;
if ( V_1 -> V_90 ) {
...
if ( ( F_57 ( V_46 -> V_92 * 4 , 64 ) * V_46 -> V_93 ) >
V_185 -> V_194 )
return V_195 ;
return V_196 ;
}
static bool F_58 ( struct V_1 * V_1 , struct V_197 * V_198 )
{
F_26 ( sizeof( * V_198 ) != 8 ) ;
if ( ! F_23 ( V_1 ,
V_199 ,
...
F_59 ( struct V_1 * V_1 )
{
int V_198 = V_1 -> V_198 . V_211 & 0xf ;
return V_198 & - V_198 ;
}
static struct V_212 *
F_60 ( struct V_5 * V_6 )
{
struct V_1 * V_213 = F_3 ( V_6 ) ;
return F_61 ( V_6 , & V_213 -> V_214 ) ;
}
static struct V_212 *
F_62 ( struct V_5 * V_6 )
{
...
struct V_212 * V_212 ;
V_212 = F_60 ( V_6 ) ;
if ( V_212 == NULL && F_59 ( V_1 ) ) {
T_2 V_214 , V_219 = V_1 -> V_47 ;
for ( V_214 = V_1 -> V_47 >> 1 ; V_214 > 1 ; V_214 >>= 1 ) {
V_1 -> V_47 = V_214 ;
V_212 = F_60 ( V_6 ) ;
if ( V_212 )
break;
...
V_32 = V_220 ;
if ( V_212 != NULL ) {
if ( V_212 -> V_221 & V_222 ) {
V_32 = V_223 ;
if ( V_1 -> V_224 ) {
V_1 -> V_164 = F_64 ( V_212 ) ;
V_1 -> V_176 = F_65 ( V_212 ) ;
}
} else
V_32 = V_225 ;
V_6 -> V_226 . V_227 = NULL ;
F_66 ( V_212 ) ;
}
if ( V_32 == V_223 ) {
struct V_7 * V_7 = F_5 ( V_6 ) ;
if ( V_7 -> V_228 )
V_1 -> V_176 = V_7 -> V_228 > 0 ;
}
return V_32 ;
}
static enum V_218
F_67 ( struct V_5 * V_6 , bool V_229 )
{
T_4 V_36 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
struct V_7 * V_7 = F_5 ( V_6 ) ;
...
V_144 = 1 << V_1 -> V_145 ;
memcpy ( & V_240 , & V_144 ,
V_77 ( sizeof( V_144 ) , sizeof( struct V_239 ) ) ) ;
...
if ( ! F_18 ( V_1 , & V_241 , 3 ) )
return;
for ( V_13 = 0 ; V_13 < F_16 ( V_243 ) ; V_13 ++ )
if ( V_241 & ( 1 << V_13 ) ) {
struct V_45 * V_244 ;
V_244 = F_74 ( V_6 -> V_10 ,
& V_243 [ V_13 ] ) ;
...
V_247:
F_79 (newmode, &connector->probed_modes, head) {
if ( V_245 -> type & V_249 ) {
V_1 -> V_91 =
F_74 ( V_6 -> V_10 , V_245 ) ;
F_47 ( V_1 -> V_91 ,
...
return false ;
V_212 = F_60 ( V_6 ) ;
if ( V_212 != NULL && V_212 -> V_221 & V_222 )
V_269 = F_65 ( V_212 ) ;
return V_269 ;
}
static int
...
T_5 V_28 ;
int V_26 ;
V_26 = F_90 ( V_6 , V_271 , V_8 ) ;
if ( V_26 )
return V_26 ;
if ( V_271 == V_185 -> V_273 ) {
int V_13 = V_8 ;
bool V_269 ;
if ( V_13 == V_7 -> V_228 )
return 0 ;
...
if ( V_271 == V_185 -> V_275 ) {
if ( V_8 == ! ! V_1 -> V_276 )
return 0 ;
V_1 -> V_276 = V_8 ? V_277 : 0 ;
goto V_274;
}
#define F_91 ( V_31 , T_8 ) \
...
F_91 (hpos, HPOS)
F_91 (vpos, VPOS)
F_91 (saturation, SATURATION)
F_91 (contrast, CONTRAST)
F_91 (hue, HUE)
F_91 (brightness, BRIGHTNESS)
F_91 (sharpness, SHARPNESS)
F_91 (flicker_filter, FLICKER_FILTER)
F_91 (flicker_filter_2d, FLICKER_FILTER_2D)
F_91 (flicker_filter_adaptive, FLICKER_FILTER_ADAPTIVE)
F_91 (tv_chroma_filter, TV_CHROMA_FILTER)
F_91 (tv_luma_filter, TV_LUMA_FILTER)
F_91 (dot_crawl, DOT_CRAWL)
}
return - V_279 ;
V_285:
if ( ! F_22 ( V_1 , V_28 , & V_272 , 2 ) )
return - V_290 ;
V_274:
if ( V_1 -> V_4 . V_4 . V_154 ) {
struct V_153 * V_154 = V_1 -> V_4 . V_4 . V_154 ;
F_93 ( V_154 , & V_154 -> V_46 , V_154 -> V_291 ,
V_154 -> V_292 , V_154 -> V_293 ) ;
}
return 0 ;
#undef F_91
}
...
static void
F_99 ( struct V_184 * V_185 ,
struct V_1 * V_213 , T_1 V_294 )
{
struct V_295 * V_296 ;
if ( F_100 ( V_294 ) )
V_296 = & ( V_185 -> V_297 [ 0 ] ) ;
...
V_296 = & ( V_185 -> V_297 [ 1 ] ) ;
if ( V_296 -> V_298 )
V_213 -> V_47 = 1 << ( ( V_296 -> V_299 & 0xf0 ) >> 4 ) ;
else
F_98 ( V_213 ) ;
}
static void
F_101 ( struct V_184 * V_185 ,
struct V_1 * V_213 , T_1 V_294 )
{
struct V_295 * V_296 ;
T_2 V_300 , V_301 ;
...
if ( V_300 < V_306 ) {
V_213 -> V_27 = & V_185 -> V_215 [ V_300 ] . V_217 ;
F_102 ( V_213 -> V_27 , V_301 ) ;
F_103 ( V_213 -> V_27 , true ) ;
} else
V_213 -> V_27 = & V_185 -> V_215 [ V_302 ] . V_217 ;
}
static bool
F_104 ( struct V_1 * V_1 , int V_307 )
{
return F_39 ( V_1 ) ;
}
static T_2
F_105 ( struct V_9 * V_10 , int V_14 )
{
struct V_184 * V_185 = V_10 -> V_186 ;
...
static void
F_106 ( struct V_7 * V_6 ,
struct V_1 * V_3 )
{
F_107 ( V_3 -> V_4 . V_4 . V_10 ,
& V_6 -> V_4 . V_4 ,
& V_310 ,
V_6 -> V_4 . V_4 . V_311 ) ;
F_108 ( & V_6 -> V_4 . V_4 ,
...
V_6 -> V_4 . V_4 . V_313 = 0 ;
V_6 -> V_4 . V_4 . V_314 = 0 ;
V_6 -> V_4 . V_4 . V_226 . V_315 = V_316 ;
F_109 ( & V_6 -> V_4 , & V_3 -> V_4 ) ;
F_110 ( & V_6 -> V_4 . V_4 ) ;
}
static void
...
static bool
F_112 ( struct V_1 * V_1 , int V_307 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_317 * V_318 ;
struct V_7 * V_7 ;
V_7 = F_113 ( sizeof( struct V_7 ) , V_319 ) ;
if ( ! V_7 )
return false ;
if ( V_307 == 0 ) {
V_1 -> V_320 |= V_321 ;
...
static bool
F_117 ( struct V_1 * V_1 , int V_307 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_317 * V_318 ;
...
static bool
F_118 ( struct V_1 * V_1 , int V_307 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_317 * V_318 ;
...
V_1 -> V_320 = 0 ;
memcpy ( V_348 , & V_1 -> V_198 . V_211 , 2 ) ;
F_12 ( L_34 ,
F_14 ( V_1 ) ,
V_348 [ 0 ] , V_348 [ 1 ] ) ;
return false ;
...
return false ;
V_7 -> V_351 = 0 ;
for ( V_13 = 0 ; V_13 < V_278 ; V_13 ++ )
if ( V_144 & ( 1 << V_13 ) )
V_7 -> V_280 [ V_7 -> V_351 ++ ] = V_13 ;
V_7 -> V_268 =
F_120 ( V_10 , V_352 ,
L_35 , V_7 -> V_351 ) ;
if ( ! V_7 -> V_268 )
...
F_121 (
V_7 -> V_268 , V_13 ,
V_13 , V_353 [ V_7 -> V_280 [ V_13 ] ] ) ;
V_1 -> V_145 = V_7 -> V_280 [ 0 ] ;
F_122 ( & V_7 -> V_4 . V_4 ,
V_7 -> V_268 , 0 ) ;
return true ;
}
...
return false ;
V_7 -> V_283 = V_356 [ 0 ] ;
V_7 -> V_281 = V_356 [ 0 ] - V_36 ;
V_7 -> V_282 = V_7 -> V_281 ;
V_7 -> V_251 =
F_124 ( V_10 , 0 , L_36 , 0 , V_356 [ 0 ] ) ;
if ( ! V_7 -> V_251 )
return false ;
F_122 ( V_6 ,
V_7 -> V_251 ,
...
return false ;
V_7 -> V_288 = V_356 [ 0 ] ;
V_7 -> V_286 = V_356 [ 0 ] - V_36 ;
V_7 -> V_287 = V_7 -> V_286 ;
V_7 -> V_253 =
F_124 ( V_10 , 0 , L_40 , 0 , V_356 [ 0 ] ) ;
if ( ! V_7 -> V_253 )
return false ;
F_122 ( V_6 ,
V_7 -> V_253 ,
...
if ( F_81 ( V_7 ) )
return F_123 ( V_1 , V_7 , V_355 . V_241 ) ;
else if( F_82 ( V_7 ) )
return F_126 ( V_1 , V_7 , V_355 . V_241 ) ;
else
return true ;
}
static int F_127 ( struct V_379 * V_217 ,
struct V_19 * V_20 ,
int V_380 )
{
struct V_1 * V_213 = V_217 -> V_381 ;
if ( ! F_21 ( V_213 , V_213 -> V_47 ) )
return - V_290 ;
return V_213 -> V_27 -> V_382 -> V_383 ( V_213 -> V_27 , V_20 , V_380 ) ;
}
static T_1 F_128 ( struct V_379 * V_217 )
{
struct V_1 * V_213 = V_217 -> V_381 ;
return V_213 -> V_27 -> V_382 -> V_384 ( V_213 -> V_27 ) ;
}
static bool
F_129 ( struct V_1 * V_213 ,
struct V_9 * V_10 )
{
V_213 -> V_214 . V_385 = V_386 ;
V_213 -> V_214 . V_387 = V_388 ;
snprintf ( V_213 -> V_214 . V_31 , V_389 , L_46 ) ;
V_213 -> V_214 . V_10 . V_390 = & V_10 -> V_391 -> V_10 ;
V_213 -> V_214 . V_381 = V_213 ;
V_213 -> V_214 . V_382 = & V_392 ;
return F_130 ( & V_213 -> V_214 ) == 0 ;
}
bool F_131 ( struct V_9 * V_10 , int V_14 )
{
struct V_184 * V_185 = V_10 -> V_186 ;
struct V_393 * V_393 ;
struct V_1 * V_1 ;
int V_13 ;
V_1 = F_113 ( sizeof( struct V_1 ) , V_319 ) ;
if ( ! V_1 )
return false ;
V_1 -> V_14 = V_14 ;
V_1 -> V_21 = F_105 ( V_10 , V_14 ) >> 1 ;
F_101 ( V_185 , V_1 , V_14 ) ;
if ( ! F_129 ( V_1 , V_10 ) ) {
F_66 ( V_1 ) ;
return false ;
}
V_393 = & V_1 -> V_4 ;
V_393 -> type = V_394 ;
F_132 ( V_10 , & V_393 -> V_4 , & V_395 , 0 ) ;
for ( V_13 = 0 ; V_13 < 0x40 ; V_13 ++ ) {
T_2 V_396 ;
if ( ! F_10 ( V_1 , V_13 , & V_396 ) ) {
F_12 ( L_47 ,
F_100 ( V_14 ) ? 'B' : 'C' ) ;
goto V_333;
}
...
V_185 -> V_397 |= V_399 ;
F_133 ( & V_393 -> V_4 , & V_400 ) ;
if ( ! F_58 ( V_1 , & V_1 -> V_198 ) )
goto V_333;
if ( F_119 ( V_1 ,
V_1 -> V_198 . V_211 ) != true ) {
F_12 ( L_48 ,
F_100 ( V_14 ) ? 'B' : 'C' ) ;
goto V_333;
}
...
L_52 ,
F_14 ( V_1 ) ,
V_1 -> V_198 . V_200 , V_1 -> V_198 . V_201 ,
V_1 -> V_198 . V_202 ,
V_1 -> V_189 / 1000 ,
V_1 -> V_191 / 1000 ,
( V_1 -> V_198 . V_205 & 0x1 ) ? 'Y' : 'N' ,
( V_1 -> V_198 . V_205 & 0x2 ) ? 'Y' : 'N' ,
V_1 -> V_198 . V_211 &
( V_321 | V_338 ) ? 'Y' : 'N' ,
V_1 -> V_198 . V_211 &
( V_322 | V_339 ) ? 'Y' : 'N' ) ;
