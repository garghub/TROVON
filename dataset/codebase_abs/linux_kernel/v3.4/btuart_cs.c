...
static int F_54 ( struct V_111 * V_13 , void * V_119 )
{
int * V_120 = V_119 ;
if ( V_120 == 0 )
V_13 -> V_121 = 16 ;
...
static int F_56 ( struct V_111 * V_13 ,
void * V_119 )
{
...
if ( ! F_57 ( V_112 , F_54 , & V_120 ) )
goto V_129;
if ( ! F_57 ( V_112 , F_56 , NULL ) )
goto V_129;
F_5 ( L_9 ) ;
goto V_130;
V_129:
V_128 = F_58 ( V_112 , F_21 ) ;
if ( V_128 != 0 )
goto V_130;
V_128 = F_59 ( V_112 ) ;
if ( V_128 != 0 )
