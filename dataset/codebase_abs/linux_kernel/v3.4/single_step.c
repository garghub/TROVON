...
switch ( V_24 ) {
case 2 :
V_29 = F_26 ( & V_43 , V_26 , sizeof( V_43 ) ) ;
V_2 = V_25 ? ( ( short ) V_43 ) : V_43 ;
break;
case 4 :
V_29 = F_26 ( & V_2 , V_26 , sizeof( V_2 ) ) ;
break;
default:
F_27 () ;
}
...
extern T_2 V_63 ;
extern T_2 V_64 ;
struct V_58 * V_35 = ( void * ) F_37 () ;
struct V_18 * V_19 = V_35 -> V_60 ;
int V_65 = F_40 ( V_35 , V_66 ) ;
T_2 T_4 * V_67 , * V_52 ;
T_2 V_20 ;
int V_68 ;
int V_69 = V_70 ;
...
F_41 () ;
if ( V_19 == NULL ) {
V_19 = F_42 ( sizeof( struct V_18 ) , V_72 ) ;
if ( V_19 == NULL ) {
F_43 ( L_19 ) ;
return;
}
V_67 = ( void T_4 * ) F_44 ( NULL , 0 , 64 ,
V_73 | V_74 | V_75 ,
V_76 | V_77 ,
0 ) ;
if ( F_45 ( ( void V_78 * ) V_67 ) ) {
F_38 ( V_19 ) ;
F_43 ( L_20 ) ;
return;
}
...
case V_104 :
{
unsigned long V_105 = F_55 (
V_106 ) ;
unsigned long V_107 = F_55 (
V_108 ) ;
if ( F_56 ( V_107 ) == V_109 ) {
V_19 -> V_85 = V_105 ;
V_22 -> V_110 = V_107 ;
...
void F_68 ( struct V_21 * V_22 , int V_126 )
{
unsigned long * V_127 = & F_69 ( V_128 ) ;
struct V_58 * V_35 = ( void * ) F_37 () ;
int V_65 = F_40 ( V_35 , V_66 ) ;
unsigned long V_129 = F_55 ( V_130 ) ;
if ( V_65 == 0 ) {
F_70 ( V_131 , 0 ) ;
