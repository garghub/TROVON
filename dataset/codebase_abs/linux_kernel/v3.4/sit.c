...
bool V_149 = false ;
if ( F_78 ( V_90 ) )
V_148 = F_79 ( F_78 ( V_90 ) , & V_135 -> V_26 ) ;
if ( V_148 == NULL ) {
if ( F_80 () )
F_81 ( V_150 L_2 ) ;
goto V_146;
}
V_98 = ( const struct V_97 * ) & V_148 -> V_151 ;
V_145 = F_82 ( V_98 ) ;
if ( ( V_145 & V_152 ) &&
F_50 ( V_98 ) )
V_128 = V_98 -> V_99 [ 3 ] ;
...
V_139 = F_84 ( F_53 ( V_3 ) , & V_143 , NULL ,
V_128 , V_134 -> V_25 ,
0 , 0 ,
V_155 , F_85 ( V_117 ) ,
V_118 -> V_23 . V_27 ) ;
...
if ( V_136 ) {
V_144 = F_88 ( & V_139 -> V_128 ) - sizeof( struct V_91 ) ;
if ( V_144 < 68 ) {
V_3 -> V_12 . V_160 ++ ;
F_87 ( V_139 ) ;
goto V_146;
...
F_78 ( V_90 ) -> V_162 -> V_163 ( F_78 ( V_90 ) , V_144 ) ;
if ( V_90 -> V_67 > V_144 ) {
F_89 ( V_90 , V_164 , 0 , V_144 ) ;
F_87 ( V_139 ) ;
goto V_146;
}
}
...
V_141 = F_91 ( V_140 ) + sizeof( struct V_91 ) ;
if ( F_92 ( V_90 ) < V_141 || F_93 ( V_90 ) ||
( F_94 ( V_90 ) && ! F_95 ( V_90 , 0 ) ) ) {
struct V_89 * V_165 = F_96 ( V_90 , V_141 ) ;
if ( ! V_165 ) {
F_87 ( V_139 ) ;
V_3 -> V_12 . V_166 ++ ;
F_97 ( V_90 ) ;
...
if ( V_90 -> V_168 )
F_98 ( V_165 , V_90 -> V_168 ) ;
F_97 ( V_90 ) ;
V_90 = V_165 ;
V_135 = F_49 ( V_90 ) ;
}
V_90 -> V_169 = V_90 -> V_121 ;
F_99 ( V_90 , sizeof( struct V_91 ) ) ;
F_66 ( V_90 ) ;
memset ( & ( F_67 ( V_90 ) -> V_170 ) , 0 , sizeof( F_67 ( V_90 ) -> V_170 ) ) ;
F_67 ( V_90 ) -> V_29 = 0 ;
F_100 ( V_90 ) ;
F_101 ( V_90 , & V_139 -> V_128 ) ;
V_24 = F_64 ( V_90 ) ;
V_24 -> V_171 = 4 ;
V_24 -> V_172 = sizeof( struct V_91 ) >> 2 ;
V_24 -> V_137 = V_136 ;
V_24 -> V_122 = V_155 ;
V_24 -> V_117 = F_102 ( V_117 , F_77 ( V_135 ) ) ;
V_24 -> V_26 = V_143 . V_26 ;
V_24 -> V_25 = V_143 . V_25 ;
if ( ( V_24 -> V_112 = V_134 -> V_112 ) == 0 )
V_24 -> V_112 = V_135 -> V_173 ;
F_103 ( V_90 ) ;
V_7 = F_70 ( V_3 -> V_7 ) ;
F_104 ( V_7 , & V_3 -> V_12 ) ;
return V_167 ;
...
if ( V_24 -> V_26 ) {
struct V_138 * V_139 = F_84 ( F_53 ( V_3 ) , & V_143 , NULL ,
V_24 -> V_26 , V_24 -> V_25 ,
0 , 0 ,
V_155 ,
F_85 ( V_24 -> V_117 ) ,
...
V_140 = F_106 ( F_53 ( V_3 ) , V_118 -> V_23 . V_27 ) ;
if ( V_140 ) {
V_3 -> V_176 = V_140 -> V_176 + sizeof( struct V_91 ) ;
...
static int
F_107 ( struct V_2 * V_3 , struct V_177 * V_178 , int V_179 )
{
int V_80 = 0 ;
struct V_32 V_79 ;
struct V_60 V_59 ;
...
V_19 = NULL ;
if ( V_3 == V_21 -> V_39 ) {
if ( F_31 ( & V_79 , V_178 -> V_183 . V_184 , sizeof( V_79 ) ) ) {
V_80 = - V_69 ;
break;
}
...
if ( F_36 ( V_178 -> V_183 . V_184 , & V_79 ,
sizeof( V_79 ) ) )
goto V_185;
#ifdef F_16
} else {
...
if ( F_36 ( V_178 -> V_183 . V_184 , & V_40 ,
sizeof( V_40 ) ) )
goto V_185;
#endif
}
...
goto V_185;
V_80 = - V_81 ;
if ( V_79 . V_24 . V_171 != 4 || V_79 . V_24 . V_122 != V_155 ||
V_79 . V_24 . V_172 != 5 || ( V_79 . V_24 . V_137 & F_68 ( ~ V_189 ) ) )
goto V_185;
if ( V_79 . V_24 . V_112 )
V_79 . V_24 . V_137 |= F_68 ( V_189 ) ;
V_19 = F_20 ( V_14 , & V_79 , V_179 == V_186 ) ;
if ( V_3 != V_21 -> V_39 && V_179 == V_187 ) {
if ( V_19 != NULL ) {
if ( V_19 -> V_3 != V_3 ) {
V_80 = - V_82 ;
break;
...
if ( ( ( V_3 -> V_29 & V_175 ) && ! V_79 . V_24 . V_26 ) ||
( ! ( V_3 -> V_29 & V_175 ) && V_79 . V_24 . V_26 ) ) {
V_80 = - V_81 ;
break;
}
V_19 = F_17 ( V_3 ) ;
...
memcpy ( V_3 -> V_190 , & V_79 . V_24 . V_25 , 4 ) ;
memcpy ( V_3 -> V_191 , & V_79 . V_24 . V_26 , 4 ) ;
F_14 ( V_21 , V_19 ) ;
F_109 ( V_3 ) ;
}
}
...
if ( F_36 ( V_178 -> V_183 . V_184 , & V_19 -> V_23 , sizeof( V_79 ) ) )
V_80 = - V_69 ;
} else
V_80 = ( V_179 == V_186 ? - V_84 : - V_111 ) ;
break;
case V_192 :
V_80 = - V_188 ;
if ( ! F_32 ( V_72 ) )
...
if ( ! ( V_19 = F_17 ( V_3 ) ) )
goto V_185;
V_80 = F_30 ( V_19 , V_178 -> V_183 . V_184 ) ;
break;
case V_194 :
case V_195 :
case V_196 :
...
goto V_185;
V_80 = - V_69 ;
if ( F_31 ( & V_59 , V_178 -> V_183 . V_184 , sizeof( V_59 ) ) )
goto V_185;
V_80 = - V_111 ;
if ( ! ( V_19 = F_17 ( V_3 ) ) )
goto V_185;
...
case V_194 :
case V_196 :
V_80 = F_39 ( V_19 , & V_59 , V_179 == V_196 ) ;
break;
}
F_109 ( V_3 ) ;
break;
...
goto V_185;
V_80 = - V_69 ;
if ( F_31 ( & V_40 , V_178 -> V_183 . V_184 ,
sizeof( V_40 ) ) )
goto V_185;
V_19 = F_17 ( V_3 ) ;
if ( V_179 != V_199 ) {
...
goto V_185;
F_111 ( & V_41 , & V_40 . V_41 ,
V_40 . V_43 ) ;
if ( ! F_112 ( & V_41 , & V_40 . V_41 ) )
goto V_185;
if ( V_40 . V_44 )
V_42 = V_40 . V_42 &
F_19 ( 0xffffffffUL <<
...
static int F_113 ( struct V_2 * V_3 , int V_200 )
{
if ( V_200 < V_161 || V_200 > 0xFFF8 - sizeof( struct V_91 ) )
return - V_81 ;
V_3 -> V_144 = V_200 ;
return 0 ;
}
...
V_3 -> V_203 = F_27 ;
V_3 -> type = V_204 ;
V_3 -> V_176 = V_205 + sizeof( struct V_91 ) ;
V_3 -> V_144 = V_206 - sizeof( struct V_91 ) ;
V_3 -> V_29 = V_207 ;
V_3 -> V_55 &= ~ V_208 ;
V_3 -> V_28 = 0 ;
V_3 -> V_209 = 4 ;
...
struct V_13 * V_118 = F_17 ( V_3 ) ;
V_118 -> V_3 = V_3 ;
memcpy ( V_3 -> V_190 , & V_118 -> V_23 . V_24 . V_25 , 4 ) ;
memcpy ( V_3 -> V_191 , & V_118 -> V_23 . V_24 . V_26 , 4 ) ;
F_105 ( V_3 ) ;
...
static int T_8 F_117 ( struct V_2 * V_3 )
{
struct V_13 * V_118 = F_17 ( V_3 ) ;
...
static void T_9 F_118 ( struct V_20 * V_21 , struct V_213 * V_86 )
{
int V_34 ;
...
static int T_8 F_120 ( struct V_14 * V_14 )
{
struct V_20 * V_21 = F_6 ( V_14 , V_22 ) ;
struct V_13 * V_19 ;
int V_80 ;
V_21 -> V_35 [ 0 ] = V_21 -> V_31 ;
V_21 -> V_35 [ 1 ] = V_21 -> V_215 ;
V_21 -> V_35 [ 2 ] = V_21 -> V_216 ;
V_21 -> V_35 [ 3 ] = V_21 -> V_217 ;
...
F_23 ( V_21 -> V_39 , V_14 ) ;
V_80 = F_117 ( V_21 -> V_39 ) ;
if ( V_80 )
goto V_219;
F_15 ( V_21 -> V_39 , V_21 ) ;
if ( ( V_80 = F_121 ( V_21 -> V_39 ) ) )
goto V_220;
V_19 = F_17 ( V_21 -> V_39 ) ;
...
static void T_9 F_122 ( struct V_14 * V_14 )
{
struct V_20 * V_21 = F_6 ( V_14 , V_22 ) ;
F_123 ( V_221 ) ;
F_124 () ;
F_118 ( V_21 , & V_221 ) ;
F_119 ( V_21 -> V_39 , & V_221 ) ;
F_125 ( & V_221 ) ;
F_126 () ;
}
