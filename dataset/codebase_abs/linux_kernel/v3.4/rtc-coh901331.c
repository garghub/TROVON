...
F_4 ( V_4 -> V_5 ) ;
F_22 ( V_27 , V_4 ) ;
V_4 -> V_9 = F_36 ( L_5 , & V_27 -> V_13 , & V_46 ,
V_47 ) ;
if ( F_33 ( V_4 -> V_9 ) ) {
V_30 = F_34 ( V_4 -> V_9 ) ;
goto V_48;
...
static int F_37 ( struct V_26 * V_27 , T_4 V_50 )
{
struct V_3 * V_4 = F_7 ( & V_27 -> V_13 ) ;
if ( F_38 ( & V_27 -> V_13 ) ) {
F_39 ( V_4 -> V_1 ) ;
