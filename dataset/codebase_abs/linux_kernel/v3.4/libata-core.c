...
static int F_227 ( struct V_4 * V_5 , T_6 V_535 ,
...
static int F_229 ( struct V_21 * V_15 , T_6 V_535 )
{
struct V_4 * V_5 = F_230 ( V_15 ) ;
unsigned int V_536 = V_540 ;
int V_180 ;
if ( V_535 . V_541 == V_542 )
V_536 |= V_543 | V_544 ;
V_180 = F_227 ( V_5 , V_535 , 0 , V_536 , 1 ) ;
return V_180 ;
}
static int F_231 ( struct V_21 * V_15 )
{
if ( F_232 ( V_15 ) )
return 0 ;
return F_229 ( V_15 , V_545 ) ;
}
static int F_233 ( struct V_21 * V_15 )
{
if ( F_232 ( V_15 ) )
F_234 ( V_15 ) ;
return F_229 ( V_15 , V_546 ) ;
}
static int F_235 ( struct V_21 * V_15 )
{
if ( F_232 ( V_15 ) )
return 0 ;
return F_229 ( V_15 , V_547 ) ;
}
static int F_236 ( struct V_21 * V_15 )
{
struct V_4 * V_5 = F_230 ( V_15 ) ;
int V_180 ;
V_180 = F_227 ( V_5 , V_548 , V_526 ,
V_543 | V_540 , 1 ) ;
return V_180 ;
}
...
int F_243 ( struct V_491 * V_430 , T_6 V_535 )
{
V_430 -> V_15 -> V_549 . V_550 = V_535 ;
return 0 ;
}
void F_244 ( struct V_491 * V_430 )
{
V_430 -> V_15 -> V_549 . V_550 = V_548 ;
}
...
V_15 -> V_48 = 0 ;
F_68 ( V_5 -> V_209 , V_42 ) ;
memset ( ( void * ) V_15 + V_552 , 0 ,
V_553 - V_552 ) ;
V_15 -> V_44 = V_363 ;
V_15 -> V_45 = V_363 ;
V_15 -> V_46 = V_363 ;
}
void F_246 ( struct V_4 * V_5 , struct V_2 * V_3 , int V_38 )
{
int V_25 ;
memset ( ( void * ) V_3 + V_554 , 0 ,
V_555 - V_554 ) ;
V_3 -> V_5 = V_5 ;
V_3 -> V_38 = V_38 ;
V_3 -> V_217 = V_221 ;
...
T_2 V_135 ;
int V_180 ;
V_180 = F_124 ( V_3 , V_356 , & V_3 -> V_558 ) ;
if ( V_180 )
return V_180 ;
V_135 = ( V_3 -> V_558 >> 4 ) & 0xf ;
if ( V_135 )
V_3 -> V_40 &= ( 1 << V_135 ) - 1 ;
F_12 ( V_3 ) ;
V_3 -> V_275 = V_3 -> V_40 ;
...
struct V_4 * F_249 ( struct V_491 * V_430 )
{
struct V_4 * V_5 ;
F_30 ( L_124 ) ;
V_5 = F_250 ( sizeof( * V_5 ) , V_559 ) ;
if ( ! V_5 )
return NULL ;
V_5 -> V_210 |= V_560 | V_211 ;
...
V_5 -> V_562 = 0x00FF ;
#elif F_251 ( V_563 )
V_5 -> V_562 = V_564 | V_565 | V_566 | V_567 | V_568 ;
#else
V_5 -> V_562 = V_564 | V_568 | V_567 ;
#endif
F_252 ( & V_5 -> V_569 ) ;
F_253 ( & V_5 -> V_570 , V_571 ) ;
...
V_5 -> V_577 . V_580 = ( unsigned long ) V_5 ;
V_5 -> V_33 = V_34 ;
F_246 ( V_5 , & V_5 -> V_3 , 0 ) ;
#ifdef F_259
V_5 -> V_581 . V_582 = 1 ;
...
static void F_261 ( struct V_21 * V_584 , void * V_585 )
{
struct V_491 * V_430 = F_262 ( V_584 ) ;
int V_25 ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ ) {
struct V_4 * V_5 = V_430 -> V_587 [ V_25 ] ;
if ( ! V_5 )
continue;
if ( V_5 -> V_287 )
F_263 ( V_5 -> V_287 ) ;
...
F_264 ( V_5 -> V_12 ) ;
F_264 ( V_5 ) ;
V_430 -> V_587 [ V_25 ] = NULL ;
}
F_265 ( V_584 , NULL ) ;
}
struct V_491 * F_266 ( struct V_21 * V_15 , int V_588 )
{
struct V_491 * V_430 ;
T_5 V_589 ;
int V_25 ;
F_30 ( L_124 ) ;
if ( ! F_267 ( V_15 , NULL , V_559 ) )
return NULL ;
V_589 = sizeof( struct V_491 ) + ( V_588 + 1 ) * sizeof( void * ) ;
V_430 = F_268 ( F_261 , V_589 , V_559 ) ;
if ( ! V_430 )
goto V_260;
F_269 ( V_15 , V_430 ) ;
F_265 ( V_15 , V_430 ) ;
...
V_430 -> V_15 = V_15 ;
V_430 -> V_586 = V_588 ;
for ( V_25 = 0 ; V_25 < V_588 ; V_25 ++ ) {
struct V_4 * V_5 ;
V_5 = F_249 ( V_430 ) ;
if ( ! V_5 )
goto V_260;
V_5 -> V_591 = V_25 ;
V_430 -> V_587 [ V_25 ] = V_5 ;
}
F_271 ( V_15 , NULL ) ;
return V_430 ;
V_260:
...
struct V_491 * F_273 ( struct V_21 * V_15 ,
const struct V_592 * const * V_593 ,
int V_586 )
{
const struct V_592 * V_594 ;
struct V_491 * V_430 ;
int V_25 , V_595 ;
V_430 = F_266 ( V_15 , V_586 ) ;
if ( ! V_430 )
return NULL ;
for ( V_25 = 0 , V_595 = 0 , V_594 = NULL ; V_25 < V_430 -> V_586 ; V_25 ++ ) {
struct V_4 * V_5 = V_430 -> V_587 [ V_25 ] ;
if ( V_593 [ V_595 ] )
V_594 = V_593 [ V_595 ++ ] ;
V_5 -> V_44 = V_594 -> V_44 ;
...
V_5 -> V_46 = V_594 -> V_46 ;
V_5 -> V_42 |= V_594 -> V_42 ;
V_5 -> V_3 . V_42 |= V_594 -> V_596 ;
V_5 -> V_213 = V_594 -> V_597 ;
if ( ! V_430 -> V_213 && ( V_594 -> V_597 != & V_598 ) )
V_430 -> V_213 = V_594 -> V_597 ;
}
return V_430 ;
}
int F_274 ( struct V_4 * V_5 )
{
struct V_2 * V_3 ;
F_87 ( V_5 -> V_12 ) ;
F_87 ( V_5 -> V_42 & V_599 ) ;
V_3 = F_250 ( sizeof( * V_3 ) , V_559 ) ;
if ( ! V_3 )
return - V_600 ;
F_246 ( V_5 , V_3 , 1 ) ;
V_5 -> V_12 = V_3 ;
...
static void F_275 ( struct V_21 * V_584 , void * V_585 )
{
struct V_491 * V_430 = F_262 ( V_584 ) ;
int V_25 ;
F_87 ( ! ( V_430 -> V_42 & V_601 ) ) ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ ) {
struct V_4 * V_5 = V_430 -> V_587 [ V_25 ] ;
if ( V_5 -> V_213 -> V_602 )
V_5 -> V_213 -> V_602 ( V_5 ) ;
}
if ( V_430 -> V_213 -> V_603 )
V_430 -> V_213 -> V_603 ( V_430 ) ;
}
static void F_276 ( struct V_604 * V_213 )
{
static F_277 ( V_209 ) ;
const struct V_604 * V_451 ;
void * * V_605 = ( void * * ) V_213 ;
void * * V_606 = ( void * * ) & V_213 -> V_607 ;
void * * V_608 ;
if ( ! V_213 || ! V_213 -> V_607 )
return;
F_278 ( & V_209 ) ;
for ( V_451 = V_213 -> V_607 ; V_451 ; V_451 = V_451 -> V_607 ) {
void * * V_609 = ( void * * ) V_451 ;
for ( V_608 = V_605 ; V_608 < V_606 ; V_608 ++ , V_609 ++ )
if ( ! * V_608 )
* V_608 = * V_609 ;
}
for ( V_608 = V_605 ; V_608 < V_606 ; V_608 ++ )
if ( F_279 ( * V_608 ) )
* V_608 = NULL ;
V_213 -> V_607 = NULL ;
F_280 ( & V_209 ) ;
}
int F_281 ( struct V_491 * V_430 )
{
int V_610 = 0 ;
void * V_611 = NULL ;
int V_25 , V_180 ;
...
void F_286 ( struct V_491 * V_430 , struct V_21 * V_15 ,
unsigned long V_42 , struct V_604 * V_213 )
{
F_270 ( & V_430 -> V_209 ) ;
F_252 ( & V_430 -> V_590 ) ;
V_430 -> V_15 = V_15 ;
...
V_511 -> V_613 |= V_614 ;
V_511 -> V_465 |= V_526 ;
V_511 -> V_42 |= V_543 | V_540 ;
V_5 -> V_210 &= ~ V_560 ;
V_5 -> V_210 |= V_615 ;
F_215 ( V_5 ) ;
F_68 ( V_5 -> V_209 , V_42 ) ;
}
int F_288 ( struct V_4 * V_5 )
{
int V_180 = 0 ;
if ( V_5 -> V_213 -> V_214 ) {
F_287 ( V_5 ) ;
...
static void F_289 ( void * V_580 , T_7 V_616 )
{
struct V_4 * V_5 = V_580 ;
if ( ! ( V_5 -> V_430 -> V_42 & V_438 ) && V_5 -> V_591 != 0 )
F_290 ( V_616 ) ;
( void ) F_288 ( V_5 ) ;
F_290 ( V_616 ) ;
F_291 ( V_5 , 1 ) ;
}
int F_292 ( struct V_491 * V_430 , struct V_617 * V_618 )
{
int V_25 , V_180 ;
if ( ! ( V_430 -> V_42 & V_601 ) ) {
F_283 ( V_430 -> V_15 , L_153 ) ;
F_87 ( 1 ) ;
return - V_117 ;
}
for ( V_25 = V_430 -> V_586 ; V_430 -> V_587 [ V_25 ] ; V_25 ++ )
F_264 ( V_430 -> V_587 [ V_25 ] ) ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ )
V_430 -> V_587 [ V_25 ] -> V_31 = F_293 ( & V_619 ) ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ ) {
V_180 = F_294 ( V_430 -> V_15 , V_430 -> V_587 [ V_25 ] ) ;
if ( V_180 ) {
goto V_620;
}
}
V_180 = F_295 ( V_430 , V_618 ) ;
if ( V_180 )
goto V_620;
F_296 ( V_430 ) ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ ) {
...
V_620:
while ( -- V_25 >= 0 ) {
F_299 ( V_430 -> V_587 [ V_25 ] ) ;
}
return V_180 ;
}
int F_300 ( struct V_491 * V_430 , int V_621 ,
T_8 V_622 , unsigned long V_623 ,
struct V_617 * V_618 )
{
int V_25 , V_180 ;
V_180 = F_281 ( V_430 ) ;
...
if ( ! V_621 ) {
F_87 ( V_622 ) ;
return F_292 ( V_430 , V_618 ) ;
}
V_180 = F_301 ( V_430 -> V_15 , V_621 , V_622 , V_623 ,
F_302 ( V_430 -> V_15 ) , V_430 ) ;
if ( V_180 )
return V_180 ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ )
F_303 ( V_430 -> V_587 [ V_25 ] , L_156 , V_621 ) ;
V_180 = F_292 ( V_430 , V_618 ) ;
if ( V_180 )
F_304 ( V_430 -> V_15 , V_621 , V_430 ) ;
return V_180 ;
}
...
F_68 ( V_5 -> V_209 , V_42 ) ;
F_228 ( V_5 ) ;
F_87 ( ! ( V_5 -> V_210 & V_626 ) ) ;
F_306 ( & V_5 -> V_570 ) ;
V_624:
if ( V_5 -> V_11 ) {
int V_25 ;
for ( V_25 = 0 ; V_25 < V_627 ; V_25 ++ )
F_307 ( & V_5 -> V_11 [ V_25 ] ) ;
}
F_299 ( V_5 ) ;
F_308 ( V_5 -> V_287 ) ;
}
void F_309 ( struct V_491 * V_430 )
{
int V_25 ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ )
F_305 ( V_430 -> V_587 [ V_25 ] ) ;
F_310 ( V_430 ) ;
}
void F_311 ( struct V_628 * V_629 )
{
struct V_21 * V_15 = & V_629 -> V_15 ;
struct V_491 * V_430 = F_262 ( V_15 ) ;
F_309 ( V_430 ) ;
}
int F_312 ( struct V_628 * V_629 , const struct V_630 * V_131 )
{
unsigned long V_354 = 0 ;
switch ( V_131 -> V_631 ) {
case 1 : {
T_2 V_632 = 0 ;
F_313 ( V_629 , V_131 -> V_531 , & V_632 ) ;
V_354 = V_632 ;
break;
}
case 2 : {
T_4 V_633 = 0 ;
F_314 ( V_629 , V_131 -> V_531 , & V_633 ) ;
V_354 = V_633 ;
break;
}
case 4 : {
T_1 V_634 = 0 ;
F_315 ( V_629 , V_131 -> V_531 , & V_634 ) ;
V_354 = V_634 ;
break;
}
default:
...
void F_316 ( struct V_628 * V_629 , T_6 V_535 )
{
F_317 ( V_629 ) ;
F_318 ( V_629 ) ;
if ( V_535 . V_541 & V_635 )
F_319 ( V_629 , V_636 ) ;
}
int F_320 ( struct V_628 * V_629 )
{
int V_180 ;
F_319 ( V_629 , V_637 ) ;
F_321 ( V_629 ) ;
...
int F_324 ( struct V_628 * V_629 , T_6 V_535 )
{
struct V_491 * V_430 = F_262 ( & V_629 -> V_15 ) ;
int V_180 = 0 ;
V_180 = F_243 ( V_430 , V_535 ) ;
if ( V_180 )
return V_180 ;
F_316 ( V_629 , V_535 ) ;
return 0 ;
}
int F_325 ( struct V_628 * V_629 )
{
struct V_491 * V_430 = F_262 ( & V_629 -> V_15 ) ;
int V_180 ;
V_180 = F_320 ( V_629 ) ;
...
static int T_9 F_326 ( char * * V_451 ,
struct V_27 * V_638 ,
const char * * V_251 )
{
static struct V_639 V_640 [] V_641 = {
{ L_158 , . V_33 = V_338 } ,
{ L_159 , . V_33 = V_339 } ,
{ L_160 , . V_33 = V_490 } ,
{ L_161 , . V_33 = V_340 } ,
...
{ L_203 , . V_41 = V_642 } ,
{ L_204 , . V_41 = V_643 } ,
{ L_205 , . V_41 = V_642 | V_643 } ,
} ;
char * V_434 = * V_451 , * V_147 = * V_451 ;
char * V_142 , * V_532 , * V_644 ;
const struct V_639 * V_645 = NULL ;
int V_646 = 0 , V_25 ;
while ( * V_147 != '\0' && * V_147 != ',' )
V_147 ++ ;
if ( * V_147 == '\0' )
...
if ( V_147 ) {
* V_147 ++ = '\0' ;
V_638 -> V_21 = F_328 ( V_147 , & V_644 , 10 ) ;
if ( V_147 == V_644 || * V_644 != '\0' ) {
* V_251 = L_206 ;
return - V_117 ;
}
}
V_638 -> V_30 = F_328 ( V_142 , & V_644 , 10 ) ;
if ( V_147 == V_644 || * V_644 != '\0' ) {
* V_251 = L_207 ;
return - V_117 ;
}
V_647:
for ( V_25 = 0 ; V_25 < F_37 ( V_640 ) ; V_25 ++ ) {
const struct V_639 * V_648 = & V_640 [ V_25 ] ;
if ( strncasecmp ( V_532 , V_648 -> V_35 , strlen ( V_532 ) ) )
continue;
V_646 ++ ;
V_645 = V_648 ;
if ( strcasecmp ( V_532 , V_648 -> V_35 ) == 0 ) {
V_646 = 1 ;
break;
}
}
...
for ( V_147 = V_653 ; * V_147 ; V_147 ++ )
if ( * V_147 == ',' )
V_650 ++ ;
V_29 = F_250 ( sizeof( V_29 [ 0 ] ) * V_650 , V_559 ) ;
if ( ! V_29 ) {
F_330 ( V_654 L_210
L_211 ) ;
return;
}
for ( V_451 = V_653 ; * V_451 != '\0' ; V_451 = V_23 ) {
const char * V_251 = L_67 ;
struct V_27 V_655 = { . V_30 = - 1 , . V_21 = - 1 } ;
V_23 = V_451 ;
if ( F_326 ( & V_23 , & V_655 , & V_251 ) ) {
F_330 ( V_654 L_212
L_213 ,
V_451 , V_251 ) ;
continue;
...
F_330 ( V_267 L_214 V_657 L_215 ) ;
return 0 ;
V_260:
return V_180 ;
}
static void T_10 F_336 ( void )
{
F_337 ( V_656 ) ;
F_338 () ;
F_335 () ;
...
void F_168 ( struct V_4 * V_5 , unsigned int V_659 )
{
bool V_660 = V_5 && V_5 -> V_430 -> V_661 == V_662 ;
if ( V_660 )
F_77 ( V_5 ) ;
F_174 ( V_659 ) ;
if ( V_660 )
...
T_1 F_341 ( struct V_4 * V_5 , void T_11 * V_531 , T_1 V_358 , T_1 V_532 ,
...
static unsigned int F_343 ( struct V_192 * V_193 )
{
return V_212 ;
}
...
int F_345 ( const struct V_4 * V_5 , const char * V_663 ,
const char * V_664 , ... )
{
struct V_665 V_666 ;
T_12 args ;
...
V_666 . V_664 = V_664 ;
V_666 . V_668 = & args ;
V_667 = F_330 ( L_216 , V_663 , V_5 -> V_31 , & V_666 ) ;
va_end ( args ) ;
return V_667 ;
}
int F_346 ( const struct V_2 * V_3 , const char * V_663 ,
const char * V_664 , ... )
{
struct V_665 V_666 ;
T_12 args ;
...
V_667 = F_330 ( L_217 ,
V_663 , V_3 -> V_5 -> V_31 , V_3 -> V_38 , & V_666 ) ;
else
V_667 = F_330 ( L_216 ,
V_663 , V_3 -> V_5 -> V_31 , & V_666 ) ;
va_end ( args ) ;
return V_667 ;
}
int F_347 ( const struct V_14 * V_15 , const char * V_663 ,
const char * V_664 , ... )
{
struct V_665 V_666 ;
T_12 args ;
...
V_666 . V_668 = & args ;
V_667 = F_330 ( L_217 ,
V_663 , V_15 -> V_3 -> V_5 -> V_31 , V_15 -> V_3 -> V_38 + V_15 -> V_24 ,
& V_666 ) ;
va_end ( args ) ;
return V_667 ;
}
void F_348 ( const struct V_21 * V_15 , const char * V_669 )
{
F_349 ( V_267 , V_15 , L_218 , V_669 ) ;
}
