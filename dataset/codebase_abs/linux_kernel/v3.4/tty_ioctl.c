...
return V_80 ;
F_5 ( & V_2 -> V_7 ) ;
memcpy ( & V_79 , V_2 -> V_19 , sizeof( struct V_18 ) ) ;
F_7 ( & V_2 -> V_7 ) ;
if ( V_78 & V_81 ) {
if ( F_37 ( & V_79 ,
...
{
F_5 ( & V_2 -> V_7 ) ;
memcpy ( V_86 , V_2 -> V_19 , sizeof( struct V_18 ) ) ;
F_7 ( & V_2 -> V_7 ) ;
}
static void F_42 ( struct V_1 * V_2 , struct V_18 * V_86 )
{
F_5 ( & V_2 -> V_7 ) ;
memcpy ( V_86 , V_2 -> V_60 , sizeof( struct V_18 ) ) ;
F_7 ( & V_2 -> V_7 ) ;
}
...
return - V_83 ;
F_5 ( & V_148 -> V_7 ) ;
memcpy ( V_148 -> V_60 , & V_86 , sizeof( struct V_18 ) ) ;
F_7 ( & V_148 -> V_7 ) ;
return 0 ;
#else
case V_169 :
