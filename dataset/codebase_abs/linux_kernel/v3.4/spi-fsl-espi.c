...
if ( ( V_3 -> V_39 / V_28 ) > 64 ) {
V_7 -> V_18 |= V_38 ;
V_27 = F_12 ( V_3 -> V_39 , V_28 * 16 * 4 ) ;
F_13 ( V_27 > 33 , L_1
L_2 , F_14 ( & V_2 -> V_40 ) ,
V_28 , V_3 -> V_39 / ( 4 * 16 * ( 32 + 1 ) ) ) ;
if ( V_27 > 33 )
V_27 = 33 ;
} else {
V_27 = F_12 ( V_3 -> V_39 , V_28 * 4 ) ;
}
if ( V_27 )
V_27 -- ;
if ( V_27 < 2 )
...
F_5 ( & V_10 -> V_53 ,
( F_20 ( V_2 -> V_13 ) | F_21 ( V_25 -> V_41 - 1 ) ) ) ;
V_47 = F_15 ( V_3 , V_25 , V_41 ) ;
if ( V_47 )
return V_47 ;
F_22 ( & V_3 -> V_51 ) ;
F_5 ( & V_10 -> V_44 , 0 ) ;
...
T_3 V_93 , V_15 ;
T_5 V_94 ;
while ( F_39 ( V_91 ) < F_40 ( 4 , V_4 -> V_41 ) ) {
F_41 () ;
V_91 = F_4 ( & V_10 -> V_95 ) ;
}
if ( V_4 -> V_41 >= 4 ) {
...
static struct V_103 * T_8 F_48 ( struct V_104 * V_40 ,
...
T_3 V_110 ;
int V_71 , V_47 = 0 ;
V_5 = F_49 ( V_40 , sizeof( struct V_3 ) ) ;
if ( ! V_5 ) {
V_47 = - V_73 ;
goto V_111;
}
F_50 ( V_40 , V_5 ) ;
V_47 = F_51 ( V_40 , V_106 , V_98 ) ;
if ( V_47 )
goto V_112;
V_5 -> V_113 = F_37 ;
V_3 = F_2 ( V_5 ) ;
V_3 -> V_114 = F_36 ;
V_3 -> V_115 = F_46 ;
V_3 -> V_10 = F_52 ( V_106 -> V_116 , F_53 ( V_106 ) ) ;
if ( ! V_3 -> V_10 ) {
V_47 = - V_73 ;
goto V_112;
}
V_10 = V_3 -> V_10 ;
V_47 = F_54 ( V_3 -> V_98 , F_44 ,
0 , L_9 , V_3 ) ;
if ( V_47 )
goto V_117;
if ( V_3 -> V_16 & V_118 ) {
...
static int F_59 ( struct V_104 * V_40 )
{
struct V_124 * V_125 = V_40 -> V_126 ;
struct V_107 * V_108 = V_40 -> V_109 ;
const T_3 * V_127 ;
int V_41 ;
V_127 = F_60 ( V_125 , L_11 , & V_41 ) ;
...
static int T_8 F_61 ( struct V_129 * V_130 )
{
...
if ( V_47 )
goto V_111;
V_47 = F_63 ( V_125 , 0 , & V_106 ) ;
if ( V_47 )
goto V_111;
V_47 = F_64 ( V_125 , 0 , & V_98 ) ;
if ( ! V_47 ) {
V_47 = - V_30 ;
goto V_111;
}
V_5 = F_48 ( V_40 , & V_106 , V_98 . V_116 ) ;
if ( F_65 ( V_5 ) ) {
V_47 = F_66 ( V_5 ) ;
goto V_111;
}
...
static int T_9 F_67 ( struct V_129 * V_40 )
{
return F_68 ( & V_40 -> V_40 ) ;
}
