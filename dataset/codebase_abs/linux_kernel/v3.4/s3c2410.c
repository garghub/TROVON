...
switch ( V_5 -> V_24 ) {
case V_38 :
V_46 -> V_86 . V_134 = F_43 ;
V_46 -> V_86 . V_130 = F_46 ;
break;
case V_25 :
V_46 -> V_86 . V_134 = F_44 ;
V_46 -> V_86 . V_130 = F_47 ;
break;
case V_40 :
V_46 -> V_86 . V_134 = F_45 ;
V_46 -> V_86 . V_130 = F_48 ;
break;
}
} else {
V_46 -> V_86 . V_80 = V_135 ;
}
if ( V_31 -> V_136 != NULL )
V_46 -> V_86 . V_137 = V_31 -> V_136 ;
if ( V_31 -> V_138 )
V_46 -> V_86 . V_80 = V_139 ;
...
int V_153 ;
int V_154 ;
V_24 = F_75 ( V_104 ) -> V_155 ;
F_13 ( L_20 , V_104 ) ;
V_5 = F_76 ( sizeof( * V_5 ) , V_156 ) ;
if ( V_5 == NULL ) {
F_17 ( & V_104 -> V_7 , L_21 ) ;
V_152 = - V_157 ;
goto V_158;
...
F_63 ( V_104 , V_5 ) ;
F_77 ( & V_5 -> V_119 . V_159 ) ;
F_78 ( & V_5 -> V_119 . V_160 ) ;
...
V_151 = V_104 -> V_150 ;
V_145 = F_80 ( V_151 ) ;
V_5 -> V_110 = F_81 ( V_151 -> V_162 , V_145 , V_104 -> V_112 ) ;
if ( V_5 -> V_110 == NULL ) {
F_17 ( & V_104 -> V_7 , L_24 ) ;
V_152 = - V_161 ;
goto V_158;
...
V_5 -> V_36 = & V_104 -> V_7 ;
V_5 -> V_22 = V_21 ;
V_5 -> V_41 = F_82 ( V_151 -> V_162 , V_145 ) ;
V_5 -> V_24 = V_24 ;
if ( V_5 -> V_41 == NULL ) {
F_17 ( & V_104 -> V_7 , L_24 ) ;
V_152 = - V_163 ;
...
if ( V_152 != 0 )
goto V_158;
V_149 = ( V_21 != NULL ) ? V_21 -> V_149 : NULL ;
V_153 = ( V_21 != NULL ) ? V_21 -> V_153 : 1 ;
V_5 -> V_108 = V_153 ;
V_145 = V_153 * sizeof( * V_5 -> V_105 ) ;
V_5 -> V_105 = F_76 ( V_145 , V_156 ) ;
if ( V_5 -> V_105 == NULL ) {
F_17 ( & V_104 -> V_7 , L_26 ) ;
V_152 = - V_157 ;
goto V_158;
...
V_47 = V_5 -> V_105 ;
for ( V_154 = 0 ; V_154 < V_153 ; V_154 ++ , V_47 ++ ) {
F_13 ( L_27 , V_154 , V_47 , V_5 ) ;
F_72 ( V_5 , V_47 , V_149 ) ;
V_47 -> V_164 = F_83 ( & V_47 -> V_3 ,
( V_149 ) ? V_149 -> V_54 : 1 ,
NULL ) ;
if ( V_47 -> V_164 == 0 ) {
F_73 ( V_5 , V_47 ) ;
...
static int F_85 ( struct V_6 * V_7 , T_3 V_165 )
{
struct V_4 * V_5 = F_5 ( V_7 ) ;
if ( V_5 ) {
V_5 -> V_166 = F_28 ( V_5 -> V_52 ) ;
F_29 ( V_5 -> V_166 | V_5 -> V_53 , V_5 -> V_52 ) ;
F_8 ( V_5 , V_109 ) ;
}
return 0 ;
}
