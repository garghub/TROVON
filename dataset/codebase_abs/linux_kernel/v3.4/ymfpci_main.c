...
F_174 ( V_2 -> V_143 , V_355 ,
& V_2 -> V_356 ) ;
F_174 ( V_2 -> V_143 , V_357 ,
& V_2 -> V_358 ) ;
F_11 ( V_2 , V_234 , 0 ) ;
F_11 ( V_2 , V_236 , 0 ) ;
F_153 ( V_2 ) ;
F_166 ( V_143 ) ;
F_175 ( V_143 ) ;
F_176 ( V_143 , F_177 ( V_143 , V_350 ) ) ;
return 0 ;
}
int F_178 ( struct V_289 * V_143 )
{
struct V_288 * V_111 = F_170 ( V_143 ) ;
struct V_1 * V_2 = V_111 -> V_16 ;
unsigned int V_25 ;
...
F_185 ( V_2 -> V_15 ) ;
F_151 ( V_2 -> V_143 , V_355 ,
V_2 -> V_356 ) ;
F_151 ( V_2 -> V_143 , V_357 ,
V_2 -> V_358 ) ;
if ( V_2 -> V_31 > 0 ) {
F_52 ( & V_2 -> V_30 ) ;
...
int T_4 F_186 ( struct V_288 * V_111 ,
struct V_289 * V_143 ,
...
V_2 -> V_24 = V_143 -> V_365 ;
V_2 -> V_366 = F_189 ( V_143 , 0 ) ;
V_2 -> V_4 = F_190 ( V_2 -> V_366 , 0x8000 ) ;
F_183 ( V_143 ) ;
V_2 -> V_62 = - 1 ;
if ( ( V_2 -> V_343 = F_191 ( V_2 -> V_366 , 0x8000 , L_2 ) ) == NULL ) {
F_17 ( V_12 L_24 , V_2 -> V_366 , V_2 -> V_366 + 0x8000 - 1 ) ;
F_159 ( V_2 ) ;
return - V_13 ;
}
if ( F_192 ( V_143 -> V_161 , F_73 , V_367 ,
V_368 , V_2 ) ) {
...
#ifdef F_160
V_2 -> V_344 = F_193 ( V_352 * sizeof( T_2 ) ) ;
if ( V_2 -> V_344 == NULL ) {
F_159 ( V_2 ) ;
return - V_56 ;
}
#endif
if ( ( V_116 = F_194 ( V_111 , V_369 , V_2 , & V_250 ) ) < 0 ) {
F_159 ( V_2 ) ;
return V_116 ;
}
F_145 ( V_111 , V_2 ) ;
F_195 ( V_111 , & V_143 -> V_296 ) ;
* V_362 = V_2 ;
return 0 ;
}
