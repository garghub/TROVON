...
{
struct V_77 * V_143 ;
struct V_111 * V_144 = F_66 () ;
struct V_39 * V_31 ;
int V_130 ;
struct V_145 * V_146 ;
T_1 V_4 ;
struct V_147 * V_148 = V_128 -> V_76 . V_149 ;
V_143 = F_43 ( V_144 , struct V_77 , V_28 ) ;
V_31 = & V_143 -> V_31 ;
F_67 ( V_144 , V_102 ) ;
V_31 -> V_34 = V_143 -> V_28 . V_34 ;
V_146 = F_68 ( V_128 , V_150 , 0 ) ;
if ( ! V_146 )
return - V_151 ;
V_5 = F_69 ( V_146 -> V_152 , sizeof( struct V_153 ) ) ;
V_143 -> V_19 = (struct V_153 * ) V_5 ;
V_148 -> V_154 = ( void * ) V_5 ;
if ( V_148 -> V_155 && V_148 -> V_155 ( V_128 ) != 0 )
return - V_156 ;
if ( V_148 -> V_157 ) {
V_158 = F_1 ;
V_159 = F_5 ;
...
V_143 -> V_118 = F_70 ( V_128 , 0 ) ;
V_130 = F_71 ( V_143 -> V_118 , F_56 ,
V_160 , V_161 , V_143 ) ;
if ( V_130 ) {
F_72 ( V_143 -> V_28 . V_76 , L_15 ,
V_143 -> V_118 , V_130 ) ;
F_73 ( V_143 -> V_19 ) ;
F_34 ( V_143 -> V_28 . V_34 ) ;
F_34 ( V_143 ) ;
return V_130 ;
}
V_4 = F_12 ( & V_143 -> V_19 -> V_73 ) ;
V_4 &= ~ V_162 ;
F_10 ( V_4 , & V_143 -> V_19 -> V_73 ) ;
V_4 = F_12 ( & V_143 -> V_19 -> V_73 ) ;
V_4 |= V_163 ;
F_10 ( V_4 , & V_143 -> V_19 -> V_73 ) ;
while ( F_12 ( & V_143 -> V_19 -> V_73 ) & V_163 )
;
V_4 = V_164 | ( V_148 -> V_165 ? V_166 : 0 ) ;
F_10 ( V_4 , & V_143 -> V_19 -> V_167 ) ;
V_4 = F_12 ( & V_143 -> V_19 -> V_14 ) ;
V_4 &= ~ ( V_168 | V_169 ) ;
switch ( V_148 -> V_170 ) {
case V_171 :
V_4 |= V_172 ;
...
F_10 ( V_4 , & V_143 -> V_19 -> V_14 ) ;
if ( V_148 -> V_177 ) {
V_4 = F_74 ( & V_143 -> V_19 -> V_178 ) ;
V_4 |= V_179 ;
F_75 ( V_4 , & V_143 -> V_19 -> V_178 ) ;
}
V_4 = F_12 ( & V_143 -> V_19 -> V_10 ) ;
V_4 &= ~ V_180 ;
V_4 |= V_181 | V_12 ;
F_10 ( V_4 , & V_143 -> V_19 -> V_10 ) ;
if ( F_12 ( & V_143 -> V_19 -> V_10 ) & V_101 ) {
V_143 -> V_28 . V_29 = V_102 ;
V_143 -> V_31 . V_89 = 1 ;
} else {
V_143 -> V_28 . V_29 = V_182 ;
V_143 -> V_31 . V_89 = 0 ;
}
F_49 ( L_16 , V_143 -> V_31 . V_89 ) ;
V_4 = F_12 ( & V_143 -> V_19 -> V_10 ) ;
V_4 |= V_183 ;
V_4 &= ~ ( V_12 | V_184 ) ;
F_10 ( V_4 , & V_143 -> V_19 -> V_10 ) ;
...
char * V_188 = V_187 ;
unsigned V_189 = V_190 ;
unsigned long V_191 ;
int V_192 ;
F_77 ( & V_31 -> V_133 , V_191 ) ;
V_192 = F_78 ( V_188 , V_189 ,
V_136 L_17 L_18 ,
V_193 ) ;
V_189 -= V_192 ;
V_188 += V_192 ;
...
V_189 -= V_192 ;
V_188 += V_192 ;
F_80 ( & V_31 -> V_133 , V_191 ) ;
return V_190 - V_189 ;
}
static long F_81 ( struct V_203 * V_203 , unsigned int V_204 ,
unsigned long V_205 )
{
T_1 V_79 = 0 ;
switch ( V_204 ) {
...
break;
case V_207 :
V_18 -> V_31 . V_208 = V_205 ;
break;
case V_209 :
V_18 -> V_31 . V_95 = V_205 ;
break;
case V_210 :
V_18 -> V_31 . V_96 = V_205 ;
break;
case V_211 :
V_18 -> V_31 . V_109 = V_205 ;
break;
default:
break;
}
...
static int F_82 ( struct V_212 * V_212 , struct V_203 * V_203 )
{
return 0 ;
}
static int F_83 ( struct V_212 * V_212 , struct V_203 * V_203 )
{
return 0 ;
}
...
V_213 = F_86 ( V_214 , V_142 , & V_215 ) ;
if ( V_213 ) {
F_85 ( & V_128 -> V_76 , L_43 ) ;
return V_213 ;
}
V_213 = F_87 ( & V_128 -> V_76 , & V_216 ) ;
if ( V_213 )
...
struct V_147 * V_148 = V_128 -> V_76 . V_149 ;
F_63 ( NULL ) ;
F_90 ( V_18 -> V_118 , V_18 ) ;
F_73 ( ( void * ) V_5 ) ;
F_33 () ;
F_34 ( V_18 -> V_28 . V_34 ) ;
F_34 ( V_18 ) ;
F_91 ( & V_128 -> V_76 , & V_216 ) ;
F_92 ( V_214 , V_142 ) ;
if ( V_148 -> exit )
V_148 -> exit ( V_128 ) ;
return 0 ;
