...
static inline void F_9 ( struct V_1 * V_2 , T_1 V_9 , int V_15 )
{
int V_6 = V_2 -> V_6 ;
V_9 <<= V_2 -> V_8 ;
V_9 |= V_2 -> V_9 [ V_6 ] ;
...
int F_11 ( struct V_1 * V_2 , int V_16 )
{
int V_4 , V_6 , V_17 , V_18 , V_19 ;
unsigned char V_20 ;
V_4 = V_2 -> V_5 ;
V_6 = V_2 -> V_6 ;
if ( F_12 ( V_4 == V_6 ) ) {
...
V_18 = 0 ;
V_19 = V_10 ;
while ( V_19 < V_17 && V_18 < V_6 )
V_2 -> V_9 [ V_19 ++ ] = V_2 -> V_9 [ V_18 ++ ] ;
if ( V_19 <= V_17 ) {
memset ( V_2 -> V_9 + V_19 , V_2 -> V_3 ,
V_10 + V_11 - V_19 ) ;
}
V_17 = V_18 ;
}
...
static inline void F_38 ( unsigned char * V_18 , unsigned V_28 ,
struct V_45 * V_46 )
{
...
static inline void F_39 ( unsigned char * V_18 , unsigned V_28 ,
struct V_45 * V_46 )
{
struct V_61 * V_86 ;
int V_87 ;
...
while ( V_28 > 0 ) {
V_19 = F_40 ( V_86 , V_28 < V_87 ? V_28 : V_87 ) ;
while ( V_28 > 0 && V_87 > 0 ) {
* V_19 ++ = F_23 ( * V_18 ++ ) ;
V_28 -- ;
V_87 -- ;
...
void F_41 ( unsigned char * V_18 , unsigned V_28 ,
struct V_45 * V_46 )
{
switch ( V_46 -> V_49 ) {
case V_50 :
...
static void F_42 ( unsigned char * V_18 , int V_88 , struct V_89 * V_90 )
{
