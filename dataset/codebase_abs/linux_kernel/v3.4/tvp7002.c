...
V_56 -> V_31 = V_67 ;
V_30 = F_1 ( V_3 ) ;
F_9 ( V_3 , V_68 , & V_62 , & error ) ;
F_9 ( V_3 , V_69 , & V_63 , & error ) ;
if ( error < 0 )
return error ;
F_9 ( V_3 , V_70 , & V_64 , & error ) ;
F_9 ( V_3 , V_71 , & V_65 , & error ) ;
if ( error < 0 )
return error ;
V_60 = V_62 | ( ( V_72 & V_63 ) << V_73 ) ;
V_61 = V_64 | ( ( V_72 & V_65 ) << V_73 ) ;
V_59 = ( V_63 & V_74 ) >> V_75 ;
...
if ( V_58 -> V_77 == 0xffff )
break;
if ( V_61 >= V_58 -> V_77 && V_61 <= V_58 -> V_78 )
break;
}
if ( V_66 == V_33 ) {
F_21 ( 1 , V_55 , V_3 , L_5 ,
