...
continue;
F_138 ( V_217 -> V_220 [ V_173 ] , L_44 , V_214 -> V_167 ) ;
}
} else if ( V_233 ) {
...
if ( V_225 [ V_173 ] -> V_242 != & V_223 )
return V_225 [ V_173 ] ;
return NULL ;
}
static int F_155 ( struct V_213 * V_214 ,
const struct F_27 * const * V_225 ,
struct V_230 * V_231 , void * V_243 ,
int V_244 , bool V_245 )
{
struct V_24 * V_69 = & V_214 -> V_69 ;
const struct F_27 * V_246 ;
struct V_216 * V_217 = NULL ;
int V_172 ;
F_36 ( L_26 ) ;
V_246 = F_154 ( V_225 ) ;
if ( ! V_246 ) {
F_139 ( & V_214 -> V_69 , L_45 ) ;
return - V_247 ;
}
if ( ! F_141 ( V_69 , NULL , V_227 ) )
return - V_228 ;
...
const struct F_27 * const * V_225 ,
struct V_230 * V_231 , void * V_243 , int V_250 )
{
return F_155 ( V_214 , V_225 , V_231 , V_243 , V_250 , 0 ) ;
}
...
struct V_112 * V_113 ;
unsigned int V_254 , V_246 ;
V_246 = 0 ;
F_161 (qc->sg, sg, qc->n_elem, si) {
T_6 V_255 , V_86 ;
T_6 V_256 , V_257 ;
V_255 = ( T_6 ) F_162 ( V_113 ) ;
V_256 = F_163 ( V_113 ) ;
while ( V_256 ) {
V_86 = V_255 & 0xffff ;
V_257 = V_256 ;
if ( ( V_86 + V_256 ) > 0x10000 )
V_257 = 0x10000 - V_86 ;
V_252 [ V_246 ] . V_255 = F_164 ( V_255 ) ;
V_252 [ V_246 ] . V_258 = F_164 ( V_257 & 0xffff ) ;
F_32 ( L_46 , V_246 , V_255 , V_257 ) ;
V_246 ++ ;
V_256 -= V_257 ;
V_255 += V_257 ;
}
}
V_252 [ V_246 - 1 ] . V_258 |= F_164 ( V_259 ) ;
}
...
V_252 [ V_246 ] . V_255 = F_164 ( V_255 ) ;
if ( V_260 == 0 ) {
V_252 [ V_246 ] . V_258 = F_164 ( 0x8000 ) ;
V_260 = 0x8000 ;
V_252 [ ++ V_246 ] . V_255 = F_164 ( V_255 + 0x8000 ) ;
}
V_252 [ V_246 ] . V_258 = F_164 ( V_260 ) ;
F_32 ( L_46 , V_246 , V_255 , V_257 ) ;
V_246 ++ ;
V_256 -= V_257 ;
V_255 += V_257 ;
...
V_266 = F_96 ( V_2 , V_82 , V_265 ) ;
if ( F_41 ( V_82 -> V_126 ) && F_169 ( V_82 -> V_40 . V_101 ) )
F_64 ( V_110 , L_48 , V_264 ) ;
return V_266 ;
}
T_3 V_249 ( int V_167 , void * V_168 )
{
return F_99 ( V_167 , V_168 , F_170 ) ;
}
...
T_1 V_264 ;
V_264 = V_2 -> V_5 -> V_267 ( V_2 ) ;
if ( V_82 -> V_126 == V_273 && ( V_264 & V_270 ) ) {
V_82 -> V_126 = V_271 ;
V_272 = true ;
}
V_2 -> V_5 -> V_269 ( V_82 ) ;
...
if ( ! V_274 )
return;
F_23 ( F_2 ( V_274 + V_276 ) , V_274 + V_276 ) ;
}
...
T_1 V_277 ;
F_176 () ;
F_177 ( V_2 -> V_278 , V_2 -> V_3 . V_275 + V_279 ) ;
V_277 = F_2 ( V_2 -> V_3 . V_275 + V_280 ) ;
V_277 &= ~ ( V_281 | V_282 ) ;
if ( ! V_72 )
V_277 |= V_281 ;
F_23 ( V_277 , V_2 -> V_3 . V_275 + V_280 ) ;
...
T_1 V_277 ;
V_277 = F_2 ( V_2 -> V_3 . V_275 + V_280 ) ;
F_23 ( V_277 | V_282 , V_2 -> V_3 . V_275 + V_280 ) ;
}
void F_179 ( struct V_81 * V_82 )
{
struct V_1 * V_2 = V_82 -> V_2 ;
void T_2 * V_274 = V_2 -> V_3 . V_275 ;
F_23 ( F_2 ( V_274 + V_280 ) & ~ V_282 ,
V_274 + V_280 ) ;
F_8 ( V_2 ) ;
}
...
{
unsigned long V_245 = F_128 ( V_214 , 4 ) ;
T_1 V_287 ;
if ( V_245 == 0 )
return - V_288 ;
V_287 = F_185 ( V_245 + 0x02 ) ;
F_186 ( V_287 & 0x60 , V_245 + 0x02 ) ;
V_287 = F_185 ( V_245 + 0x02 ) ;
if ( V_287 & 0x80 )
return - V_239 ;
return 0 ;
}
static void F_187 ( struct V_216 * V_217 , const char * V_289 )
{
int V_173 ;
F_139 ( V_217 -> V_69 , L_49 , V_289 ) ;
for ( V_173 = 0 ; V_173 < 2 ; V_173 ++ ) {
V_217 -> V_220 [ V_173 ] -> V_283 = 0 ;
V_217 -> V_220 [ V_173 ] -> V_284 = 0 ;
}
}
...
V_172 = F_189 ( V_214 , V_290 ) ;
if ( V_172 )
F_187 ( V_217 , L_51 ) ;
if ( ! V_172 ) {
V_172 = F_190 ( V_214 , V_290 ) ;
if ( V_172 )
F_187 ( V_217 ,
L_52 ) ;
}
...
for ( V_173 = 0 ; V_173 < 2 ; V_173 ++ ) {
struct V_1 * V_2 = V_217 -> V_220 [ V_173 ] ;
void T_2 * V_245 = V_217 -> V_222 [ 4 ] + 8 * V_173 ;
if ( F_132 ( V_2 ) )
continue;
V_2 -> V_3 . V_275 = V_245 ;
if ( ( ! ( V_2 -> V_42 & V_291 ) ) &&
...
int V_244 )
{
return F_155 ( V_214 , V_225 , V_231 , V_243 , V_244 , 1 ) ;
}
