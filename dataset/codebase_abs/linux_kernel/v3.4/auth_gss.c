...
struct V_47 * V_55 ;
F_31 ( & V_52 -> V_56 ) ;
V_55 = F_40 ( V_52 , V_48 -> V_53 ) ;
if ( V_55 == NULL ) {
F_2 ( & V_48 -> V_3 ) ;
F_43 ( & V_48 -> V_49 , & V_52 -> V_57 ) ;
} else
V_48 = V_55 ;
F_32 ( & V_52 -> V_56 ) ;
return V_48 ;
...
{
switch ( V_48 -> V_58 . V_59 ) {
case 0 :
if ( V_48 -> V_2 == NULL )
break;
F_12 ( V_61 , & V_6 -> V_7 . V_9 ) ;
F_6 ( & V_6 -> V_7 , V_48 -> V_2 ) ;
break;
case - V_39 :
F_10 ( V_61 , & V_6 -> V_7 . V_9 ) ;
}
V_6 -> V_62 = V_36 ;
V_6 -> V_63 = NULL ;
F_46 ( & V_48 -> V_50 , V_48 -> V_58 . V_59 ) ;
...
{
struct V_6 * V_6 = F_7 ( V_65 -> V_66 -> V_67 ,
struct V_6 , V_7 ) ;
struct V_47 * V_48 = V_6 -> V_63 ;
struct V_51 * V_52 = V_48 -> V_52 ;
F_31 ( & V_52 -> V_56 ) ;
F_50 ( V_6 , V_48 ) ;
F_32 ( & V_52 -> V_56 ) ;
V_65 -> V_68 = V_48 -> V_58 . V_59 ;
F_35 ( V_48 ) ;
}
static void F_52 ( struct V_47 * V_48 )
{
V_48 -> V_58 . V_20 = & V_48 -> V_53 ;
V_48 -> V_58 . V_15 = sizeof( V_48 -> V_53 ) ;
}
static void F_53 ( struct V_47 * V_48 ,
struct V_69 * V_70 ,
const char * V_71 )
{
struct V_27 * V_72 = V_48 -> V_73 -> V_72 ;
char * V_12 = V_48 -> V_74 ;
int V_15 = 0 ;
V_48 -> V_58 . V_15 = sprintf ( V_48 -> V_74 , L_4 ,
V_72 -> V_75 ,
V_48 -> V_53 ) ;
V_12 += V_48 -> V_58 . V_15 ;
if ( V_70 -> V_76 ) {
V_15 = sprintf ( V_12 , L_5 , V_70 -> V_76 ) ;
V_12 += V_15 ;
V_48 -> V_58 . V_15 += V_15 ;
}
if ( V_71 != NULL ) {
V_15 = sprintf ( V_12 , L_6 , V_71 ) ;
V_12 += V_15 ;
V_48 -> V_58 . V_15 += V_15 ;
}
if ( V_72 -> V_77 ) {
V_15 = sprintf ( V_12 , L_7 , V_72 -> V_77 ) ;
V_12 += V_15 ;
V_48 -> V_58 . V_15 += V_15 ;
}
V_15 = sprintf ( V_12 , L_8 ) ;
V_48 -> V_58 . V_15 += V_15 ;
V_48 -> V_58 . V_20 = V_48 -> V_74 ;
F_36 ( V_48 -> V_58 . V_15 > V_78 ) ;
}
...
static struct V_47 *
F_55 ( struct V_79 * V_79 , struct V_69 * V_70 ,
T_3 V_53 , const char * V_71 )
{
struct V_47 * V_48 ;
int V_80 ;
...
static struct V_47 *
F_59 ( struct V_69 * V_70 , struct V_79 * V_79 , struct V_4 * V_5 )
{
struct V_6 * V_6 = F_7 ( V_5 ,
struct V_6 , V_7 ) ;
struct V_47 * V_81 , * V_48 ;
T_3 V_53 = V_5 -> V_82 ;
V_81 = F_55 ( V_79 , V_70 , V_53 , V_6 -> V_83 ) ;
if ( F_17 ( V_81 ) )
return V_81 ;
V_48 = F_42 ( V_81 ) ;
if ( V_48 == V_81 ) {
int V_14 = F_60 ( V_81 -> V_52 , & V_81 -> V_58 ) ;
if ( V_14 ) {
F_49 ( V_81 ) ;
V_48 = F_15 ( V_14 ) ;
}
...
{
struct V_4 * V_5 = V_65 -> V_66 -> V_67 ;
struct V_79 * V_79 = F_7 ( V_5 -> V_87 ,
struct V_79 , V_88 ) ;
struct V_6 * V_6 = F_7 ( V_5 ,
struct V_6 , V_7 ) ;
struct V_47 * V_48 ;
...
F_31 ( & V_52 -> V_56 ) ;
if ( V_6 -> V_63 != NULL )
F_65 ( & V_6 -> V_63 -> V_50 , V_65 , NULL ) ;
else if ( V_48 -> V_2 == NULL && V_48 -> V_58 . V_59 >= 0 ) {
V_65 -> V_91 = 0 ;
V_6 -> V_63 = V_48 ;
F_2 ( & V_48 -> V_3 ) ;
F_65 ( & V_48 -> V_50 , V_65 , F_51 ) ;
} else {
F_50 ( V_6 , V_48 ) ;
V_33 = V_48 -> V_58 . V_59 ;
}
...
V_93:
F_28 ( L_13 ,
V_65 -> V_89 , V_5 -> V_82 , V_33 ) ;
return V_33 ;
}
static inline int
F_66 ( struct V_79 * V_79 , struct V_6 * V_6 )
{
struct V_51 * V_52 ;
...
V_52 = V_48 -> V_52 ;
for (; ; ) {
F_69 ( & V_48 -> V_60 , & V_94 , V_98 ) ;
F_31 ( & V_52 -> V_56 ) ;
if ( V_48 -> V_2 != NULL || V_48 -> V_58 . V_59 < 0 ) {
break;
}
F_32 ( & V_52 -> V_56 ) ;
if ( F_70 ( V_99 ) ) {
...
static T_4
F_73 ( struct V_102 * V_103 , const char T_5 * V_104 , T_1 V_105 )
{
const void * V_12 , * V_13 ;
void * V_106 ;
struct V_47 * V_48 ;
struct V_51 * V_52 = F_74 ( V_103 -> V_107 -> V_108 ) -> V_52 ;
struct V_1 * V_2 ;
T_3 V_53 ;
T_4 V_33 = - V_109 ;
if ( V_105 > V_110 )
goto V_93;
V_33 = - V_22 ;
V_106 = F_75 ( V_105 , V_21 ) ;
if ( ! V_106 )
goto V_93;
V_33 = - V_17 ;
if ( F_76 ( V_106 , V_104 , V_105 ) )
goto V_33;
V_13 = ( const void * ) ( ( char * ) V_106 + V_105 ) ;
V_12 = F_13 ( V_106 , V_13 , & V_53 , sizeof( V_53 ) ) ;
if ( F_17 ( V_12 ) ) {
V_33 = F_29 ( V_12 ) ;
goto V_33;
}
...
F_45 ( & V_48 -> V_49 ) ;
F_32 ( & V_52 -> V_56 ) ;
V_12 = F_26 ( V_12 , V_13 , V_2 , V_48 -> V_73 -> V_72 ) ;
if ( F_17 ( V_12 ) ) {
V_33 = F_29 ( V_12 ) ;
switch ( V_33 ) {
case - V_40 :
...
{
struct V_51 * V_52 = F_74 ( V_118 ) -> V_52 ;
struct V_47 * V_48 ;
V_121:
F_31 ( & V_52 -> V_56 ) ;
F_41 (gss_msg, &pipe->in_downcall, list) {
if ( ! F_37 ( & V_48 -> V_58 . V_49 ) )
continue;
V_48 -> V_58 . V_59 = - V_122 ;
F_2 ( & V_48 -> V_3 ) ;
F_44 ( V_48 ) ;
F_32 ( & V_52 -> V_56 ) ;
F_35 ( V_48 ) ;
...
static void
F_84 ( struct V_123 * V_58 )
{
struct V_47 * V_48 = F_7 ( V_58 , struct V_47 , V_58 ) ;
if ( V_58 -> V_59 < 0 ) {
F_28 ( L_19 ,
V_48 ) ;
F_2 ( & V_48 -> V_3 ) ;
...
static void F_85 ( struct V_88 * V_73 )
{
struct V_79 * V_79 ;
V_79 = F_7 ( V_73 , struct V_79 , V_88 ) ;
if ( V_79 -> V_52 [ 0 ] -> V_125 )
F_86 ( V_79 -> V_52 [ 0 ] -> V_125 ) ;
if ( V_79 -> V_52 [ 1 ] -> V_125 )
F_86 ( V_79 -> V_52 [ 1 ] -> V_125 ) ;
}
static int F_87 ( struct V_88 * V_73 )
{
int V_33 ;
struct V_79 * V_79 ;
struct V_69 * V_70 ;
V_79 = F_7 ( V_73 , struct V_79 , V_88 ) ;
V_70 = V_79 -> V_96 ;
V_79 -> V_52 [ 1 ] -> V_125 = F_88 ( V_70 -> V_126 ,
L_20 ,
V_70 , V_79 -> V_52 [ 1 ] ) ;
if ( F_17 ( V_79 -> V_52 [ 1 ] -> V_125 ) )
return F_29 ( V_79 -> V_52 [ 1 ] -> V_125 ) ;
V_79 -> V_52 [ 0 ] -> V_125 = F_88 ( V_70 -> V_126 ,
V_79 -> V_72 -> V_75 ,
V_70 , V_79 -> V_52 [ 0 ] ) ;
if ( F_17 ( V_79 -> V_52 [ 0 ] -> V_125 ) ) {
V_33 = F_29 ( V_79 -> V_52 [ 0 ] -> V_125 ) ;
goto V_127;
}
return 0 ;
V_127:
...
static int F_93 ( struct V_69 * V_70 ,
struct V_88 * V_73 )
{
struct V_128 * V_128 = F_90 ( V_70 ) ;
struct V_129 * V_130 ;
...
static struct V_88 *
F_94 ( struct V_69 * V_70 , T_6 V_131 )
{
struct V_79 * V_79 ;
struct V_88 * V_73 ;
int V_33 = - V_22 ;
...
if ( ! F_95 ( V_132 ) )
return F_15 ( V_33 ) ;
if ( ! ( V_79 = F_75 ( sizeof( * V_79 ) , V_133 ) ) )
goto V_134;
V_79 -> V_96 = V_70 ;
V_33 = - V_113 ;
V_79 -> V_72 = F_96 ( V_131 ) ;
if ( ! V_79 -> V_72 ) {
F_63 ( V_86 L_22 ,
V_116 , V_131 ) ;
goto V_135;
}
V_79 -> V_136 = F_97 ( V_79 -> V_72 , V_131 ) ;
if ( V_79 -> V_136 == 0 )
goto V_137;
V_73 = & V_79 -> V_88 ;
V_73 -> V_138 = V_139 >> 2 ;
...
F_25 ( & V_73 -> V_145 , 1 ) ;
F_98 ( & V_79 -> V_146 ) ;
V_79 -> V_52 [ 1 ] = F_99 ( & V_147 ,
V_148 ) ;
if ( F_17 ( V_79 -> V_52 [ 1 ] ) ) {
V_33 = F_29 ( V_79 -> V_52 [ 1 ] ) ;
goto V_137;
}
V_79 -> V_52 [ 0 ] = F_99 ( & V_149 ,
V_148 ) ;
if ( F_17 ( V_79 -> V_52 [ 0 ] ) ) {
V_33 = F_29 ( V_79 -> V_52 [ 0 ] ) ;
goto V_150;
}
V_33 = F_93 ( V_70 , V_73 ) ;
if ( V_33 )
...
static void
F_104 ( struct V_79 * V_79 )
{
F_89 ( V_79 -> V_96 , & V_79 -> V_88 ) ;
F_101 ( V_79 -> V_52 [ 0 ] ) ;
F_101 ( V_79 -> V_52 [ 1 ] ) ;
F_102 ( V_79 -> V_72 ) ;
F_39 ( V_79 ) ;
...
{
struct V_79 * V_79 = F_7 ( V_146 , struct V_79 , V_146 ) ;
F_104 ( V_79 ) ;
}
static void
F_106 ( struct V_88 * V_73 )
{
struct V_79 * V_79 ;
F_28 ( L_23 ,
V_73 , V_73 -> V_144 ) ;
F_107 ( V_73 ) ;
V_79 = F_7 ( V_73 , struct V_79 , V_88 ) ;
F_108 ( & V_79 -> V_146 , F_105 ) ;
}
static int
F_109 ( struct V_4 * V_5 )
{
struct V_6 * V_6 = F_7 ( V_5 , struct V_6 , V_7 ) ;
struct V_79 * V_79 = F_7 ( V_5 -> V_87 , struct V_79 , V_88 ) ;
struct V_64 * V_65 ;
if ( V_6 -> V_10 == NULL ||
F_8 ( V_11 , & V_5 -> V_9 ) == 0 )
return 0 ;
...
V_5 -> V_154 = & V_155 ;
F_110 ( V_5 ) ;
V_65 = F_111 ( V_79 -> V_96 , V_5 , V_156 | V_157 ) ;
if ( ! F_17 ( V_65 ) )
F_112 ( V_65 ) ;
F_113 ( V_5 ) ;
return 1 ;
...
static struct V_4 *
F_123 ( struct V_88 * V_73 , struct V_162 * V_163 , int V_164 )
{
return F_124 ( V_73 , V_163 , V_164 ) ;
}
static struct V_4 *
F_125 ( struct V_88 * V_73 , struct V_162 * V_163 , int V_164 )
{
struct V_79 * V_79 = F_7 ( V_73 , struct V_79 , V_88 ) ;
struct V_6 * V_5 = NULL ;
int V_33 = - V_22 ;
F_28 ( L_26 ,
V_163 -> V_53 , V_73 -> V_144 ) ;
if ( ! ( V_5 = F_23 ( sizeof( * V_5 ) , V_21 ) ) )
goto V_165;
F_126 ( & V_5 -> V_7 , V_163 , V_73 , & V_166 ) ;
V_5 -> V_7 . V_9 = 1UL << V_8 ;
V_5 -> V_167 = V_79 -> V_136 ;
V_5 -> V_83 = NULL ;
if ( V_163 -> V_168 )
V_5 -> V_83 = V_163 -> V_169 ;
F_127 ( & V_79 -> V_146 ) ;
return & V_5 -> V_7 ;
V_165:
F_28 ( L_27 , V_33 ) ;
...
static int
F_128 ( struct V_88 * V_73 , struct V_4 * V_5 )
{
struct V_79 * V_79 = F_7 ( V_73 , struct V_79 , V_88 ) ;
struct V_6 * V_6 = F_7 ( V_5 , struct V_6 , V_7 ) ;
int V_33 ;
...
if ( V_6 -> V_83 == NULL )
return 0 ;
return strcmp ( V_163 -> V_169 , V_6 -> V_83 ) == 0 ;
}
if ( V_6 -> V_83 != NULL )
return 0 ;
return V_170 -> V_82 == V_163 -> V_53 ;
}
static T_7 *
F_130 ( struct V_64 * V_65 , T_7 * V_12 )
{
struct V_171 * V_172 = V_65 -> V_66 ;
struct V_4 * V_5 = V_172 -> V_67 ;
...
static int F_137 ( struct V_64 * V_65 )
{
struct V_4 * V_190 = V_65 -> V_66 -> V_67 ;
struct V_6 * V_6 = F_7 ( V_190 ,
struct V_6 ,
V_7 ) ;
struct V_88 * V_73 = V_190 -> V_87 ;
struct V_162 V_163 = {
. V_53 = V_190 -> V_82 ,
. V_169 = V_6 -> V_83 ,
. V_168 = ( V_6 -> V_83 != NULL ? 1 : 0 ) ,
} ;
struct V_4 * V_191 ;
V_191 = F_123 ( V_73 , & V_163 , V_192 ) ;
if ( F_17 ( V_191 ) )
return F_29 ( V_191 ) ;
V_65 -> V_66 -> V_67 = V_191 ;
F_113 ( V_190 ) ;
return 0 ;
}
...
if ( F_139 ( V_85 , V_193 , V_194 ) )
return 1 ;
}
return 0 ;
}
static int
F_140 ( struct V_64 * V_65 )
{
struct V_4 * V_5 = V_65 -> V_66 -> V_67 ;
int V_32 = 0 ;
if ( F_138 ( V_5 ) )
...
static int
F_141 ( struct V_64 * V_65 )
{
return - V_40 ;
}
static T_7 *
F_142 ( struct V_64 * V_65 , T_7 * V_12 )
{
struct V_4 * V_5 = V_65 -> V_66 -> V_67 ;
struct V_1 * V_2 = F_19 ( V_5 ) ;
T_7 V_196 ;
...
if ( V_174 ) {
F_28 ( L_31
L_32 , V_65 -> V_89 , V_174 ) ;
goto V_199;
}
V_5 -> V_87 -> V_200 = F_145 ( V_15 ) + 2 ;
F_3 ( V_2 ) ;
F_28 ( L_33 ,
V_65 -> V_89 ) ;
...
V_5 -> V_87 -> V_140 = V_5 -> V_87 -> V_200 + ( V_12 - V_239 )
+ ( V_240 - V_159 -> V_186 ) ;
V_241:
