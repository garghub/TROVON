...
V_2 , V_4 , V_24 , V_11 ) ;
V_38 = 0 ;
for ( V_39 = 0 ; V_39 < V_37 ; V_39 ++ , V_14 = ( void * ) V_14 + V_19 ) {
F_14 ( F_42 ( V_14 ) ) ;
if ( ! F_29 ( V_14 ) ) {
F_18 ( V_14 ) ;
V_38 ++ ;
...
struct V_43 * V_44 )
{
V_44 -> V_45 = F_11 ( V_14 -> V_46 ) ;
V_44 -> V_47 = F_44 ( V_14 -> V_48 ) ;
V_44 -> V_49 = F_44 ( V_14 -> V_50 ) ;
V_44 -> V_51 = F_44 ( V_14 -> V_52 ) ;
V_44 -> V_53 = F_44 ( V_14 -> V_54 ) ;
V_44 -> V_55 = F_44 ( V_14 -> V_56 ) ;
V_44 -> V_57 = F_44 ( V_14 -> V_58 . V_59 ) ;
}
static T_3 F_45 ( struct V_1 * V_2 , T_1 * V_60 ,
void * V_61 , unsigned V_62 , T_2 V_63 )
{
struct V_13 * V_14 ;
struct V_43 * V_44 = V_61 ;
struct V_9 * V_10 ;
T_2 V_19 = F_2 ( V_2 ) -> V_18 ;
T_1 V_64 = F_26 ( V_2 ) , V_4 = * V_60 ;
void * V_11 ;
int V_12 , V_26 ;
int V_37 , V_39 ;
if ( V_4 == 0 )
return - V_32 ;
F_46 ( & F_2 ( V_2 ) -> V_28 ) ;
for ( V_12 = 0 ; V_4 < V_64 && V_12 < V_63 ; V_4 += V_37 ) {
V_37 = F_6 ( V_2 , V_4 , V_64 ) ;
...
for ( V_39 = 0 ; V_39 < V_37 && V_12 < V_63 ; V_39 ++ , V_14 = ( void * ) V_14 + V_19 ) {
if ( ! F_29 ( V_14 ) ) {
F_43 ( V_2 , V_14 ,
V_44 ) ;
V_44 = ( void * ) V_44 + V_62 ;
...
static T_3 F_48 ( struct V_1 * V_2 , T_1 * V_60 ,
void * V_61 , unsigned V_62 , T_2 V_63 )
{
struct V_9 * V_10 ;
struct V_17 * V_25 ;
...
T_3 F_49 ( struct V_1 * V_2 , T_1 * V_60 , int V_70 ,
void * V_61 , unsigned V_62 , T_2 V_63 )
{
switch ( V_70 ) {
case V_71 :
return F_45 ( V_2 , V_60 , V_61 , V_62 , V_63 ) ;
case V_72 :
return F_48 ( V_2 , V_60 , V_61 , V_62 , V_63 ) ;
default:
return - V_27 ;
}
}
...
T_1 V_5 = V_4 ;
T_3 V_63 ;
V_63 = F_45 ( V_2 , & V_5 , & V_44 , sizeof( V_44 ) , 1 ) ;
if ( V_63 < 0 )
return V_63 ;
else if ( V_63 == 0 || V_44 . V_47 != V_4 )
return - V_32 ;
else if ( F_51 ( & V_44 ) )
return - V_73 ;
...
{
struct V_9 * V_23 , * V_76 , * V_77 , * V_24 ;
struct V_17 * V_25 ;
struct V_13 * V_14 ;
struct V_74 * V_75 ;
T_1 V_7 , V_78 ;
unsigned long V_67 , V_79 ;
void * V_11 ;
int V_26 ;
if ( V_4 == 0 )
return - V_32 ;
...
V_11 = F_34 ( V_24 -> V_31 ) ;
V_14 = F_16 ( V_2 , V_4 , V_24 , V_11 ) ;
V_14 -> V_58 . V_59 = F_55 ( V_7 ) ;
V_14 -> V_58 . V_81 = F_55 ( V_78 ) ;
F_56 ( V_14 ) ;
F_36 ( V_11 ) ;
V_11 = F_34 ( V_77 -> V_31 ) ;
V_75 = F_52 (
...
{
struct V_9 * V_23 , * V_84 , * V_77 , * V_24 ;
struct V_17 * V_25 ;
struct V_13 * V_14 ;
struct V_74 * V_75 ;
T_1 V_66 , V_78 ;
...
V_11 = F_34 ( V_24 -> V_31 ) ;
V_14 = F_16 ( V_2 , V_4 , V_24 , V_11 ) ;
V_14 -> V_58 . V_59 = F_55 ( 0 ) ;
V_14 -> V_58 . V_81 = F_55 ( 0 ) ;
F_58 ( V_14 ) ;
F_36 ( V_11 ) ;
V_11 = F_34 ( V_23 -> V_31 ) ;
V_25 = F_15 ( V_2 , V_23 , V_11 ) ;
...
int F_60 ( struct V_1 * V_2 , T_1 V_4 , int V_70 )
{
int V_26 ;
switch ( V_70 ) {
case V_71 :
if ( F_61 ( V_2 -> V_86 , V_4 ) )
V_26 = - V_73 ;
else
V_26 = F_57 ( V_2 , V_4 ) ;
return V_26 ;
...
int F_62 ( struct V_1 * V_2 , struct V_87 * V_88 )
{
struct V_9 * V_10 ;
struct V_17 * V_25 ;
void * V_11 ;
...
V_25 = F_15 ( V_2 , V_10 , V_11 ) ;
V_88 -> V_89 = F_26 ( V_2 ) ;
V_88 -> V_90 = F_44 ( V_25 -> V_33 ) ;
V_88 -> V_91 = F_44 ( V_25 -> V_83 ) ;
F_36 ( V_11 ) ;
F_31 ( V_10 ) ;
V_29:
F_47 ( & F_2 ( V_2 ) -> V_28 ) ;
...
int F_63 ( struct V_92 * V_93 , T_2 V_94 ,
struct V_95 * V_96 , struct V_1 * * V_97 )
{
struct V_1 * V_2 ;
int V_98 ;
V_2 = F_64 ( V_93 , NULL , V_99 ) ;
if ( F_25 ( ! V_2 ) )
return - V_100 ;
if ( ! ( V_2 -> V_101 & V_102 ) )
goto V_65;
V_98 = F_65 ( V_2 , V_103 , 0 ) ;
if ( V_98 )
goto V_104;
F_66 ( V_2 , V_94 ,
sizeof( struct V_17 ) ) ;
