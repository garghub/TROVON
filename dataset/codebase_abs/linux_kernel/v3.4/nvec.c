...
F_77 ( & V_2 -> V_50 , F_37 ) ;
F_77 ( & V_2 -> V_40 , F_29 ) ;
V_2 -> V_39 = F_78 ( L_51 , V_109 , 2 ) ;
V_47 = F_79 ( V_2 -> V_33 , V_110 , L_52 ) ;
if ( V_47 < 0 ) {
F_9 ( V_2 -> V_23 , L_53 ) ;
goto V_101;
}
V_47 = F_80 ( V_2 -> V_60 , F_45 , 0 , L_51 , V_2 ) ;
if ( V_47 ) {
F_9 ( V_2 -> V_23 , L_54 ) ;
goto V_101;
}
...
static int T_6 F_85 ( struct V_89 * V_90 )
{
...
static int F_91 ( struct V_89 * V_90 , T_7 V_54 )
{
struct V_1 * V_2 = F_86 ( V_90 ) ;
struct V_15 * V_9 ;
F_15 ( V_2 -> V_23 , L_60 ) ;
