...
V_209 |= ( ( ! V_5 -> V_207 ) && ( V_5 -> V_208 ) ) ;
return V_209 ;
}
static int F_106 ( struct V_203 * V_204 , int V_210 )
{
struct V_4 * V_5 = F_102 ( V_204 ) ;
...
static int F_109 ( struct V_203 * V_204 , int V_210 )
{
struct V_4 * V_5 = F_102 ( V_204 ) ;
V_5 -> V_207 = V_210 ;
if ( F_104 ( V_5 ) )
...
static int F_110 ( struct V_203 * V_204 , unsigned V_211 )
{
struct V_4 * V_5 ;
V_5 = F_102 ( V_204 ) ;
if ( V_5 -> V_208 )
return F_111 ( V_5 -> V_208 , V_211 ) ;
return - V_112 ;
}
...
static T_2 void F_113 ( struct V_4 * V_90 )
{
int V_48 ;
struct V_44 * V_45 ;
...
static int F_118 ( struct V_220 * V_11 ,
int (* F_119)( struct V_203 * ) )
{
struct V_4 * V_5 = V_221 ;
int V_222 ;
if ( ! V_11 || V_11 -> V_223 < V_215 || ! F_119
|| ! V_11 -> V_224 || ! V_11 -> V_225 )
return - V_172 ;
if ( ! V_5 )
return - V_10 ;
if ( V_5 -> V_11 )
...
F_98 ( V_5 , 1 ) ;
V_222 = F_120 ( & V_5 -> V_78 . V_90 ) ;
if ( V_222 ) {
F_19 ( V_5 -> V_90 , L_72 , V_222 ) ;
goto V_227;
}
V_222 = F_119 ( & V_5 -> V_78 ) ;
if ( V_222 ) {
F_19 ( V_5 -> V_90 , L_73 ,
V_11 -> V_11 . V_16 , V_222 ) ;
goto V_228;
}
F_50 ( V_5 -> V_90 , L_74 ,
V_11 -> V_11 . V_16 ) ;
if ( V_5 -> V_208 ) {
V_222 = F_121 ( V_5 -> V_208 -> V_229 ,
& V_5 -> V_78 ) ;
if ( V_222 ) {
F_19 ( V_5 -> V_90 , L_75 ) ;
goto V_230;
...
static int F_124 ( struct V_220 * V_11 )
{
struct V_4 * V_5 = V_221 ;
if ( ! V_5 )
return - V_10 ;
if ( ! V_11 || V_11 != V_5 -> V_11 || ! V_11 -> V_231 )
return - V_172 ;
F_123 ( V_5 , V_11 ) ;
F_108 ( V_5 ) ;
F_98 ( V_5 , 0 ) ;
...
V_11 -> V_11 . V_16 ) ;
if ( V_5 -> V_208 )
return F_121 ( V_5 -> V_208 -> V_229 , NULL ) ;
return 0 ;
}
...
if ( F_59 ( F_37 ( V_45 ) ) )
goto V_238;
V_235 . V_234 [ V_48 ] = F_9 ( V_45 , V_156 ) ;
}
V_236 = ! F_37 ( V_45 ) ;
while ( ! F_37 ( V_45 ) ) {
V_48 = F_9 ( V_45 , V_156 ) ;
...
F_42 ( V_45 , L_78 ,
V_235 . V_233 . V_239 , V_235 . V_233 . V_240 ,
F_127 ( V_235 . V_233 . V_241 ) , F_127 ( V_235 . V_233 . V_242 ) ,
F_127 ( V_235 . V_233 . V_243 ) ) ;
if ( F_59 ( V_236 ) )
goto V_238;
if ( V_235 . V_233 . V_239 & V_150 )
F_40 ( V_5 , V_181 ) ;
else
F_40 ( V_5 , V_182 ) ;
F_33 ( V_45 , V_57 | V_63 ) ;
F_66 ( & V_45 -> V_148 , V_145 ) ;
V_48 = V_5 -> V_11 -> V_225 ( & V_5 -> V_78 , & V_235 . V_233 ) ;
F_69 ( & V_45 -> V_148 , V_145 ) ;
if ( V_48 < 0 )
goto V_238;
V_12:
...
F_42 ( V_45 , L_79 ,
F_9 ( V_45 , V_56 ) , V_48 ) ;
F_33 ( V_45 , V_59 | V_244 ) ;
F_40 ( V_5 , V_189 ) ;
goto V_12;
}
static void F_128 ( struct V_4 * V_5 , int V_245 , int V_246 )
{
T_1 V_247 ;
struct V_44 * V_45 = & V_5 -> V_44 [ 0 ] ;
...
V_247 = F_9 ( V_45 , V_56 ) ;
F_42 ( V_45 , L_80 ,
F_41 ( V_5 ) , V_47 , V_247 , F_9 ( V_45 , V_69 ) ,
( V_245 << 1 | V_246 ) ) ;
if ( V_247 & V_60 ) {
F_42 ( V_45 , L_81 ) ;
F_74 ( V_45 , - V_248 ) ;
...
static void F_129 ( struct V_4 * V_5 , int V_92 )
{
struct V_232 V_47 ;
F_50 ( V_5 -> V_90 , L_84 , V_92 ) ;
V_5 -> V_92 = V_92 ;
V_5 -> V_101 = 0 ;
V_5 -> V_103 = 0 ;
V_47 . V_239 = 0 ;
...
V_47 . V_243 = 0 ;
F_40 ( V_5 , V_179 ) ;
V_5 -> V_11 -> V_225 ( & V_5 -> V_78 , & V_47 ) ;
F_33 ( & V_5 -> V_44 [ 0 ] , V_253 ) ;
}
static void F_130 ( struct V_4 * V_5 , int V_100 , int V_102 )
{
struct V_232 V_47 ;
F_50 ( V_5 -> V_90 , L_85 , V_100 , V_102 ) ;
V_5 -> V_101 = V_100 ;
V_5 -> V_103 = V_102 ;
V_47 . V_239 = V_254 ;
V_47 . V_240 = V_255 ;
...
static void F_131 ( int V_256 , struct V_4 * V_5 )
{
int V_48 ;
struct V_44 * V_45 ;
T_1 V_257 = F_3 ( V_5 , V_36 ) & V_258 ;
T_1 V_259 = F_3 ( V_5 , V_37 ) & V_260 ;
if ( V_257 & V_261 ) {
V_5 -> V_44 [ 0 ] . V_39 . V_68 ++ ;
F_29 ( V_5 , V_36 , F_132 ( 0 , V_261 ) ) ;
F_128 ( V_5 , ! ! ( V_257 & V_262 ) ,
! ! ( V_257 & V_263 ) ) ;
}
V_257 >>= 2 ;
for ( V_48 = 1 ; V_257 != 0 && V_48 < 16 ; V_257 >>= 2 , V_48 ++ ) {
if ( ! ( V_257 & V_261 ) )
continue;
F_29 ( V_5 , V_36 , F_132 ( V_48 , V_261 ) ) ;
F_56 ( V_48 >= F_133 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_133 ( V_5 -> V_44 ) ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
V_45 -> V_39 . V_68 ++ ;
F_89 ( V_45 ) ;
}
}
for ( V_48 = 16 ; V_259 != 0 && V_48 < 24 ; V_259 >>= 2 , V_48 ++ ) {
F_29 ( V_5 , V_37 , F_132 ( V_48 - 16 , V_261 ) ) ;
if ( ! ( V_259 & V_261 ) )
continue;
F_56 ( V_48 >= F_133 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_133 ( V_5 -> V_44 ) ) {
...
V_5 -> V_39 . V_41 ++ ;
if ( V_5 -> V_78 . V_173 != V_174
&& V_5 -> V_11 && V_5 -> V_11 -> V_265 )
V_5 -> V_11 -> V_265 ( & V_5 -> V_78 ) ;
F_43 ( V_5 ) ;
}
...
V_5 -> V_39 . V_42 ++ ;
if ( V_5 -> V_78 . V_173 != V_174
&& V_5 -> V_11 && V_5 -> V_11 -> V_267 )
V_5 -> V_11 -> V_267 ( & V_5 -> V_78 ) ;
}
static void F_136 ( struct V_4 * V_5 )
{
unsigned V_92 , V_93 , V_98 , V_268 ;
T_1 V_109 = F_3 ( V_5 , V_17 ) ;
F_29 ( V_5 , V_37 , V_269 ) ;
V_5 -> V_39 . V_43 ++ ;
...
memset ( & V_5 -> V_39 , 0 , sizeof V_5 -> V_39 ) ;
F_74 ( V_45 , - V_237 ) ;
F_33 ( V_45 , V_244 | V_63 ) ;
F_43 ( V_5 ) ;
}
static T_5 F_138 ( int V_256 , void * V_271 )
{
struct V_4 * V_5 = V_271 ;
T_1 V_257 = F_3 ( V_5 , V_36 ) ;
T_1 V_259 = F_3 ( V_5 , V_37 ) ;
T_1 V_109 = F_3 ( V_5 , V_17 ) ;
T_1 V_272 ;
F_139 ( V_5 -> V_90 , L_88
L_89 , V_257 , V_259 , V_109 ) ;
V_272 = V_259 & 0xf8000000 ;
if ( F_59 ( V_272 & V_264 ) )
F_134 ( V_5 ) ;
if ( F_59 ( V_272 & V_266 ) )
F_135 ( V_5 ) ;
...
if ( F_59 ( V_272 & V_270 ) )
F_137 ( V_5 ) ;
if ( ( V_257 & V_258 ) | ( V_259 & V_260 ) )
F_131 ( V_256 , V_5 ) ;
return V_273 ;
}
static int T_2 F_140 ( struct V_274 * V_275 )
{
struct V_276 * V_277 ;
struct V_4 * V_5 = & V_278 ;
int V_222 = 0 , V_279 ;
V_277 = F_141 ( V_275 , V_280 , 0 ) ;
if ( ! V_277 )
return - V_281 ;
V_5 -> V_256 = F_142 ( V_275 , 0 ) ;
if ( V_5 -> V_256 < 0 )
return V_5 -> V_256 ;
V_5 -> V_90 = & V_275 -> V_90 ;
V_5 -> V_196 = V_275 -> V_90 . V_282 ;
V_5 -> V_208 = F_143 () ;
V_279 = V_5 -> V_196 -> V_197 ;
if ( F_99 ( V_279 ) ) {
V_222 = F_144 ( V_279 , L_90 ) ;
if ( V_222 == 0 )
F_145 ( V_279 ,
V_5 -> V_196 -> V_198 ) ;
}
if ( V_222 ) {
F_19 ( & V_275 -> V_90 , L_91 ,
V_279 , V_222 ) ;
return V_222 ;
}
V_5 -> V_212 = F_146 ( & V_275 -> V_90 , NULL ) ;
if ( F_16 ( V_5 -> V_212 ) ) {
V_222 = F_147 ( V_5 -> V_212 ) ;
goto V_283;
}
V_222 = - V_284 ;
V_5 -> V_277 = F_148 ( V_277 -> V_285 , F_149 ( V_277 ) ) ;
if ( ! V_5 -> V_277 ) {
F_19 ( & V_275 -> V_90 , L_92 ) ;
goto V_286;
}
F_150 ( & V_5 -> V_78 . V_90 ) ;
V_5 -> V_78 . V_90 . V_287 = & V_275 -> V_90 ;
V_5 -> V_78 . V_90 . V_288 = NULL ;
V_5 -> V_207 = 0 ;
V_221 = V_5 ;
F_151 ( V_275 , V_5 ) ;
F_113 ( V_5 ) ;
F_49 ( V_5 ) ;
V_222 = F_152 ( V_5 -> V_256 , F_138 ,
V_289 , V_14 , V_5 ) ;
if ( V_222 != 0 ) {
F_19 ( V_5 -> V_90 , L_93 ,
V_14 , V_290 , V_222 ) ;
...
V_222 = F_153 ( & V_275 -> V_90 , & V_5 -> V_78 ) ;
if ( V_222 )
goto V_292;
F_14 ( V_5 ) ;
return 0 ;
...
static int T_6 F_157 ( struct V_274 * V_271 )
{
struct V_4 * V_5 = F_158 ( V_271 ) ;
int V_279 = V_5 -> V_196 -> V_197 ;
F_159 ( & V_5 -> V_78 ) ;
F_160 ( V_5 -> V_11 ) ;
F_154 ( V_5 -> V_256 , V_5 ) ;
F_20 ( V_5 ) ;
...
static void F_163 ( struct V_274 * V_271 )
{
struct V_4 * V_5 = F_158 ( V_271 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_108 ( V_5 ) ;
}
static int F_164 ( struct V_274 * V_271 , T_7 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_158 ( V_271 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
V_5 -> V_247 = F_9 ( V_45 , V_56 ) ;
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
V_45 -> V_293 = F_9 ( V_45 , V_56 ) ;
V_45 -> V_294 = F_9 ( V_45 , V_17 ) ;
F_42 ( V_45 , L_94 ,
V_45 -> V_293 , V_45 -> V_294 ) ;
}
F_108 ( V_5 ) ;
V_5 -> V_295 = V_5 -> V_202 ;
F_98 ( V_5 , 0 ) ;
...
static int F_165 ( struct V_274 * V_271 )
{
int V_48 ;
struct V_4 * V_5 = F_158 ( V_271 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
F_35 ( V_45 , V_56 , V_5 -> V_247 & ( V_59 | V_61 ) ) ;
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
F_35 ( V_45 , V_56 , V_45 -> V_293 ) ;
F_35 ( V_45 , V_17 , V_45 -> V_294 ) ;
F_42 ( V_45 , L_94 ,
V_45 -> V_293 , V_45 -> V_294 ) ;
}
F_98 ( V_5 , V_5 -> V_295 ) ;
...
static int T_2 F_167 ( void )
{
if ( ! F_168 () && ! F_169 () )
return - V_10 ;
F_170 ( V_296 L_95 , V_14 , V_15 ) ;
return F_171 ( & V_297 , F_140 ) ;
}
