...
{
const struct V_23 * V_24 = V_6 -> V_14 . V_51 ;
struct V_3 * V_4 ;
struct V_7 * V_7 ;
int error ;
int V_30 ;
...
V_4 = F_13 ( sizeof( struct V_3 ) , V_55 ) ;
V_7 = F_14 () ;
if ( ! V_4 || ! V_7 ) {
F_3 ( & V_6 -> V_14 , L_11 ) ;
error = - V_56 ;
...
V_7 -> V_58 = L_12 ;
V_7 -> V_50 . V_59 = V_60 ;
V_7 -> V_14 . V_61 = & V_6 -> V_14 ;
V_7 -> V_62 [ 0 ] = F_15 ( V_63 ) | F_15 ( V_64 ) ;
V_7 -> V_65 = V_4 -> V_19 ;
V_7 -> V_66 = sizeof( V_4 -> V_19 [ 0 ] ) ;
V_7 -> V_67 = V_4 -> V_46 ;
for ( V_30 = 0 ; V_30 < V_24 -> V_54 ; V_30 ++ ) {
F_16 ( V_7 , V_63 , V_24 -> V_53 [ V_30 ] ) ;
V_4 -> V_19 [ V_30 ] = V_24 -> V_53 [ V_30 ] ;
}
...
static int F_27 ( struct V_72 * V_14 )
{
...
static int F_31 ( struct V_72 * V_14 )
{
struct V_5 * V_6 = F_28 ( V_14 ) ;
struct V_3 * V_4 = F_25 ( V_6 ) ;
if ( F_29 ( & V_6 -> V_14 ) )
