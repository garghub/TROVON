...
struct V_1 * V_2 = F_13 ( V_37 ) ;
enum V_173 V_22 ;
V_22 = F_85 ( V_37 , V_133 , V_175 ) ;
F_86 ( V_175 , F_44 ( V_37 ) ) ;
if ( V_22 == V_176 && V_2 -> V_90 )
V_22 = V_177 ;
return V_22 ;
}
static void
...
V_188 |
V_189 ;
while ( V_6 < F_89 ( V_190 ) ) {
if ( V_190 [ V_6 ] . V_191 <= V_182 )
break;
V_6 ++ ;
}
break;
...
V_156 |= V_190 [ V_6 ] . V_200 ;
F_56 ( F_3 ( V_2 ) ,
L_25 ,
V_190 [ V_6 ] . V_191 , V_181 , V_182 ) ;
V_2 -> V_38 = V_179 ;
V_2 -> V_156 = V_156 ;
}
static int
F_90 ( struct V_36 * V_37 , enum V_201 V_202 ,
unsigned long V_203 )
{
unsigned long V_46 ;
struct V_1 * V_2 = F_13 ( V_37 ) ;
...
void F_91 ( struct V_208 * V_209 , const int * V_210 ,
struct V_116 * V_39 )
{
int V_211 ;
int V_6 = 0 ;
struct V_1 * V_2 ;
F_32 ( & V_209 -> V_212 ) ;
for ( V_211 = 0 ; V_210 [ V_211 ] != - 1 ; V_211 += 2 ) {
for ( V_6 = V_210 [ V_211 ] ; V_6 <= V_210 [ V_211 + 1 ] ; V_6 ++ ) {
V_2 = & V_39 -> V_120 [ V_6 ] ;
V_2 -> V_39 = V_39 ;
V_2 -> V_37 . V_128 = V_209 ;
V_2 -> V_41 = V_6 ;
F_92 ( & V_2 -> V_48 ) ;
V_2 -> V_106 = 0 ;
V_2 -> V_100 = 0 ;
...
static int T_5 F_94 ( struct V_214 * V_215 )
{
int V_107 = 0 ;
struct V_216 * V_217 ;
struct V_116 * V_39 ;
int V_111 ;
struct V_218 * V_219 ;
V_219 = F_95 ( V_215 , V_220 , 0 ) ;
if ( ! V_219 )
goto V_221;
if ( F_96 ( V_219 -> V_222 ,
F_97 ( V_219 ) ,
V_215 -> V_50 . V_223 -> V_224 ) == NULL ) {
V_107 = - V_127 ;
goto V_225;
}
V_217 = V_215 -> V_50 . V_226 ;
if ( ! V_217 )
goto V_227;
V_39 = F_5 ( F_98 ( sizeof( struct V_116 ) , 4 ) +
V_217 -> V_29 *
sizeof( struct V_1 ) ,
V_26 ) ;
if ( ! V_39 )
goto V_228;
V_39 -> V_120 = ( ( void * ) V_39 ) + F_98 ( sizeof( struct V_116 ) , 4 ) ;
V_39 -> V_52 = F_99 ( V_219 -> V_222 , F_97 ( V_219 ) ) ;
if ( ! V_39 -> V_52 ) {
V_107 = - V_229 ;
goto V_230;
}
V_39 -> V_50 = & V_215 -> V_50 ;
V_39 -> V_28 = V_217 ;
F_92 ( & V_39 -> V_18 . V_48 ) ;
V_39 -> V_18 . V_16 = 0 ;
F_100 ( V_17 , V_39 ) ;
...
V_107 = F_104 ( & V_39 -> V_20 , & V_215 -> V_50 ,
sizeof( struct V_3 ) ,
32 ) ;
if ( V_107 )
goto V_234;
F_91 ( & V_39 -> V_235 , V_39 -> V_28 -> V_236 ,
V_39 ) ;
F_105 ( V_39 -> V_235 . V_237 ) ;
F_106 ( V_238 , V_39 -> V_235 . V_237 ) ;
V_39 -> V_235 . V_239 = F_70 ;
V_39 -> V_235 . V_240 = F_72 ;
V_39 -> V_235 . V_241 = F_79 ;
V_39 -> V_235 . V_242 = F_84 ;
V_39 -> V_235 . V_243 = F_87 ;
V_39 -> V_235 . V_129 = F_90 ;
V_39 -> V_235 . V_50 = & V_215 -> V_50 ;
V_107 = F_107 ( & V_39 -> V_235 ) ;
if ( V_107 )
goto V_244;
F_91 ( & V_39 -> V_245 , V_39 -> V_28 -> V_246 ,
V_39 ) ;
F_105 ( V_39 -> V_245 . V_237 ) ;
F_106 ( V_247 , V_39 -> V_245 . V_237 ) ;
V_39 -> V_245 . V_239 = F_70 ;
V_39 -> V_245 . V_240 = F_72 ;
V_39 -> V_245 . V_248 = F_75 ;
V_39 -> V_245 . V_242 = F_84 ;
V_39 -> V_245 . V_243 = F_87 ;
V_39 -> V_245 . V_129 = F_90 ;
V_39 -> V_245 . V_50 = & V_215 -> V_50 ;
V_39 -> V_245 . V_249 = 2 ;
V_107 = F_107 ( & V_39 -> V_245 ) ;
if ( V_107 )
goto V_250;
F_108 ( & V_215 -> V_50 , L_28 ,
( T_8 ) V_39 -> V_52 ) ;
return V_107 ;
V_250:
F_109 ( & V_39 -> V_235 ) ;
...
V_228:
V_227:
F_113 ( V_215 -> V_218 -> V_222 ,
F_97 ( V_215 -> V_218 ) ) ;
V_225:
V_221:
return V_107 ;
}
static int T_6 F_114 ( struct V_214 * V_215 )
{
struct V_116 * V_39 = F_115 ( V_215 ) ;
F_109 ( & V_39 -> V_245 ) ;
F_109 ( & V_39 -> V_235 ) ;
F_110 ( & V_39 -> V_20 ) ;
F_111 ( F_102 ( V_215 , 0 ) , V_39 ) ;
