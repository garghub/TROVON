...
V_2 -> V_71 = F_123 ( strrchr ( V_42 -> V_207 , '/' ) + 1 , NULL , 0 ) ;
F_124 ( & V_42 -> V_42 , V_2 ) ;
V_157 = F_110 ( V_42 , V_2 ) ;
if ( V_157 ) {
F_9 ( V_2 ) ;
F_124 ( & V_42 -> V_42 , NULL ) ;
return V_157 ;
}
return 0 ;
}
...
static int F_127 ( struct V_197 * V_42 )
{
struct V_1 * V_2 = F_128 ( & V_42 -> V_42 ) ;
int V_157 ;
...
V_157 = F_137 ( V_213 , V_2 -> V_41 -> V_228 ,
L_55 , L_35 , & V_116 ,
L_56 , L_35 , & V_117 ,
NULL ) ;
if ( ! V_157 ) {
...
static void F_142 ( struct V_197 * V_42 ,
enum V_234 V_235 )
{
struct V_1 * V_2 = F_128 ( & V_42 -> V_42 ) ;
...
static int F_143 ( struct V_197 * V_41 )
{
struct V_1 * V_2 = F_128 ( & V_41 -> V_42 ) ;
struct V_26 * V_35 = NULL ;
struct V_48 * V_242 ;
...
static int F_146 ( struct V_197 * V_42 )
{
struct V_1 * V_2 = F_128 ( & V_42 -> V_42 ) ;
return V_2 -> V_233 && V_2 -> V_41 ;
}
static int F_147 ( struct V_26 * V_35 , T_2 V_36 )
{
...
static int F_148 ( struct V_48 * V_242 , T_2 V_36 )
{
