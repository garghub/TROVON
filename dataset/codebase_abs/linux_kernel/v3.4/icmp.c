...
goto V_114;
F_81 ( & V_140 ) ;
V_35 . V_38 . V_141 [ 1 ] = F_82 ( ( V_140 . V_142 % 86400 ) * V_143 +
V_140 . V_144 / V_145 ) ;
V_35 . V_38 . V_141 [ 2 ] = V_35 . V_38 . V_141 [ 1 ] ;
if ( F_83 ( V_33 , 0 , & V_35 . V_38 . V_141 [ 0 ] , 4 ) )
F_84 () ;
V_35 . V_38 . V_39 = * F_27 ( V_33 ) ;
...
F_91 ( F_37 ( V_33 ) -> V_58 , V_150 ) )
break;
}
if ( ! V_150 && F_72 () ) {
F_92 ( L_4 ,
V_154 , V_19 -> V_128 , & F_37 ( V_33 ) -> V_58 ) ;
}
}
}
...
struct V_7 * V_8 = F_34 ( V_33 ) ;
struct V_2 * V_2 = F_21 ( V_8 -> V_13 . V_19 ) ;
if ( ! F_95 ( NULL , V_157 , V_33 ) ) {
struct V_158 * V_159 = F_96 ( V_33 ) ;
int V_160 ;
...
goto V_164;
V_160 = F_63 ( V_33 ) ;
F_97 ( V_33 , sizeof( * V_39 ) ) ;
if ( ! F_98 ( NULL , V_157 , V_33 ) )
goto V_164;
F_97 ( V_33 , V_160 ) ;
}
F_23 ( V_2 , V_165 ) ;
...
int V_172 , V_74 ;
V_2 -> V_3 . F_1 =
F_109 ( V_173 * sizeof( struct V_1 * ) , V_174 ) ;
if ( V_2 -> V_3 . F_1 == NULL )
return - V_175 ;
F_105 (i) {
struct V_1 * V_4 ;
V_74 = F_110 ( & V_4 , V_176 ,
V_177 , V_66 , V_2 ) ;
if ( V_74 < 0 )
goto V_178;
V_2 -> V_3 . F_1 [ V_172 ] = V_4 ;
V_4 -> V_179 = 2 * F_111 ( 64 * 1024 ) ;
F_112 ( V_4 , V_180 ) ;
