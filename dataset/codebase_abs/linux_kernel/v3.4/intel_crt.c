...
static int T_5 F_48 ( const struct V_114 * V_115 )
{
F_19 ( L_10 , V_115 -> V_116 ) ;
return 1 ;
}
...
if ( F_50 ( V_118 ) )
return;
V_50 = F_51 ( sizeof( struct V_1 ) , V_119 ) ;
if ( ! V_50 )
return;
V_117 = F_51 ( sizeof( struct V_117 ) , V_119 ) ;
if ( ! V_117 ) {
F_28 ( V_50 ) ;
return;
}
...
F_52 ( V_9 , & V_117 -> V_4 ,
& V_120 , V_121 ) ;
F_53 ( V_9 , & V_50 -> V_4 . V_4 , & V_122 ,
V_123 ) ;
F_54 ( V_117 , & V_50 -> V_4 ) ;
V_50 -> V_4 . type = V_68 ;
V_50 -> V_4 . V_124 = ( 1 << V_125 |
1 << V_126 |
1 << V_127 ) ;
V_50 -> V_4 . V_128 = ( 1 << 0 ) | ( 1 << 1 ) ;
if ( F_9 ( V_9 ) )
V_3 -> V_129 = 0 ;
else
V_3 -> V_129 = 1 ;
V_3 -> V_130 = 0 ;
F_55 ( & V_50 -> V_4 . V_4 , & V_131 ) ;
F_56 ( V_3 , & V_132 ) ;
F_57 ( V_3 ) ;
if ( F_38 ( V_9 ) )
V_3 -> V_133 = V_134 ;
