...
static int F_18 ( struct V_1 * V_1 , bool V_55 )
{
struct V_5 * V_6 = F_8 ( & V_1 -> V_4 ) ;
int V_13 ;
if ( ! V_55 ) {
...
if ( V_13 < 0 )
return V_13 ;
V_63 = F_22 ( V_60 -> V_72 , V_58 -> V_72 ) ;
V_64 = F_22 ( V_60 -> V_74 , V_58 -> V_74 ) ;
V_65 = 1 << ( F_23 ( V_63 ) - 1 ) ;
V_66 = 1 << ( F_23 ( V_64 ) - 1 ) ;
V_13 = F_5 ( V_6 , V_75 ,
( ( V_65 - 1 ) << 4 ) | ( V_63 - 1 ) ) ;
...
if ( V_13 < 0 )
return V_13 ;
V_61 = 346 * V_66 + 64 + ( 80 >> F_24 (unsigned int, xbin, 3 ) ) ;
V_62 = V_77 ;
...
static int F_25 ( struct V_2 * V_4 , int V_80 )
{
...
static struct V_57 *
F_29 ( struct V_1 * V_1 , struct V_81 * V_82 ,
unsigned int V_85 , T_3 V_96 )
{
switch ( V_96 ) {
case V_97 :
return F_30 ( V_82 , V_85 ) ;
case V_98 :
return & V_1 -> V_58 ;
default:
return NULL ;
...
static struct V_59 *
F_31 ( struct V_1 * V_1 , struct V_81 * V_82 ,
unsigned int V_85 , T_3 V_96 )
{
switch ( V_96 ) {
case V_97 :
return F_32 ( V_82 , V_85 ) ;
case V_98 :
return & V_1 -> V_60 ;
default:
return NULL ;
...
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
V_100 -> V_58 = * F_29 ( V_1 , V_82 , V_100 -> V_85 ,
V_100 -> V_96 ) ;
return 0 ;
}
...
unsigned int V_103 ;
unsigned int V_104 ;
V_102 = F_31 ( V_1 , V_82 , V_58 -> V_85 ,
V_58 -> V_96 ) ;
V_72 = F_35 (unsigned int, ALIGN(format->format.width, 2),
max(__crop->width / 7, MT9P031_WINDOW_WIDTH_MIN),
__crop->width) ;
V_74 = F_35 (unsigned int, ALIGN(format->format.height, 2),
max(__crop->height / 8, MT9P031_WINDOW_HEIGHT_MIN),
__crop->height) ;
V_103 = F_22 ( V_102 -> V_72 , V_72 ) ;
V_104 = F_22 ( V_102 -> V_74 , V_74 ) ;
V_101 = F_29 ( V_1 , V_82 , V_58 -> V_85 ,
V_58 -> V_96 ) ;
...
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
V_60 -> V_106 = * F_31 ( V_1 , V_82 , V_60 -> V_85 ,
V_60 -> V_96 ) ;
return 0 ;
}
...
struct V_59 * V_102 ;
struct V_59 V_106 ;
V_106 . V_68 = F_38 ( F_39 ( V_60 -> V_106 . V_68 , 2 ) , V_107 ,
V_108 ) ;
V_106 . V_70 = F_38 ( F_39 ( V_60 -> V_106 . V_70 , 2 ) , V_109 ,
V_110 ) ;
V_106 . V_72 = F_38 ( F_39 ( V_60 -> V_106 . V_72 , 2 ) ,
V_111 ,
V_112 ) ;
V_106 . V_74 = F_38 ( F_39 ( V_60 -> V_106 . V_74 , 2 ) ,
V_113 ,
V_114 ) ;
V_106 . V_72 = F_40 ( V_106 . V_72 , V_115 - V_106 . V_68 ) ;
V_106 . V_74 = F_40 ( V_106 . V_74 , V_116 - V_106 . V_70 ) ;
V_102 = F_31 ( V_1 , V_82 , V_60 -> V_85 , V_60 -> V_96 ) ;
if ( V_106 . V_72 != V_102 -> V_72 || V_106 . V_74 != V_102 -> V_74 ) {
V_101 = F_29 ( V_1 , V_82 , V_60 -> V_85 ,
V_60 -> V_96 ) ;
...
static int F_42 ( struct V_2 * V_4 , int V_55 )
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
int V_13 = 0 ;
F_43 ( & V_1 -> V_141 ) ;
...
static int F_48 ( struct V_2 * V_4 , struct V_81 * V_82 )
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
struct V_57 * V_58 ;
struct V_59 * V_60 ;
...
{
struct V_36 * V_37 = V_6 -> V_43 . V_160 ;
struct V_161 * V_162 = F_51 ( V_6 -> V_43 . V_163 ) ;
struct V_1 * V_1 ;
unsigned int V_164 ;
int V_13 ;
if ( V_37 == NULL ) {
...
V_1 = F_54 ( sizeof( * V_1 ) , V_167 ) ;
if ( V_1 == NULL )
return - V_168 ;
V_1 -> V_37 = V_37 ;
V_1 -> V_12 = V_169 ;
V_1 -> V_15 = V_132 ;
F_55 ( & V_1 -> V_56 , F_56 ( V_170 ) + 4 ) ;
F_57 ( & V_1 -> V_56 , & V_171 ,
V_121 , V_172 ,
V_173 , 1 ,
V_174 ) ;
...
F_57 ( & V_1 -> V_56 , & V_171 ,
V_129 , 0 , 1 , 1 , 0 ) ;
for ( V_164 = 0 ; V_164 < F_56 ( V_170 ) ; ++ V_164 )
F_58 ( & V_1 -> V_56 , & V_170 [ V_164 ] , NULL ) ;
V_1 -> V_4 . V_178 = & V_1 -> V_56 ;
if ( V_1 -> V_56 . error )
F_59 ( V_179 L_8 ,
V_180 , V_1 -> V_56 . error ) ;
F_60 ( & V_1 -> V_141 ) ;
F_61 ( & V_1 -> V_4 , V_6 , & V_181 ) ;
V_1 -> V_4 . V_182 = & V_183 ;
V_1 -> V_85 . V_184 = V_185 ;
V_13 = F_62 ( & V_1 -> V_4 . V_186 , 1 , & V_1 -> V_85 , 0 ) ;
if ( V_13 < 0 )
goto V_187;
V_1 -> V_4 . V_184 |= V_188 ;
V_1 -> V_60 . V_72 = V_91 ;
...
V_1 -> V_58 . V_72 = V_91 ;
V_1 -> V_58 . V_74 = V_94 ;
V_1 -> V_58 . V_154 = V_155 ;
V_1 -> V_58 . V_156 = V_157 ;
V_13 = F_11 ( V_1 ) ;
V_187:
if ( V_13 < 0 ) {
F_63 ( & V_1 -> V_56 ) ;
