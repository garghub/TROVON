...
V_26 = F_175 ( V_62 , V_40 , V_67 , & V_347 ) ;
}
F_1 () ;
return V_26 ;
}
memset ( V_349 , 0 , ( V_350 * sizeof( struct V_54 * ) ) ) ;
V_338 = V_351 [ V_337 ] ;
if ( V_67 -> V_340 < V_338 )
return - V_266 ;
if ( V_67 -> V_340 > V_338 ) {
...
unsigned V_352 = V_170 -> V_56 ;
if ( V_352 ) {
if ( V_352 > V_353 [ V_337 ] )
return - V_266 ;
V_349 [ V_352 - 1 ] = V_170 ;
}
...
if ( V_11 == NULL )
return - V_270 ;
return V_11 ( V_40 , V_67 , ( void * ) & V_349 [ 0 ] ) ;
}
...
static int F_180 ( struct V_354 * V_355 , unsigned long V_356 , void * V_357 )
{
struct V_28 * V_29 = V_357 ;
switch ( V_356 ) {
case V_358 :
case V_359 :
case V_360 :
...
int V_72 ;
V_350 = 0 ;
for ( V_72 = 0 ; V_72 < F_186 ( V_353 ) ; V_72 ++ )
if ( V_353 [ V_72 ] > V_350 )
V_350 = V_353 [ V_72 ] ;
V_349 = F_132 ( V_350 * sizeof( struct V_54 * ) , V_15 ) ;
if ( ! V_349 )
F_21 ( L_9 ) ;
if ( F_187 ( & V_374 ) )
F_21 ( L_10 ) ;
F_188 ( V_371 , V_375 ) ;
F_189 ( & V_376 ) ;
F_20 ( V_12 , V_377 , F_164 ,
F_105 , F_168 ) ;
F_20 ( V_12 , V_378 , F_145 , NULL , NULL ) ;
F_20 ( V_12 , V_259 , F_158 , NULL , NULL ) ;
F_20 ( V_12 , V_379 , F_148 , NULL , NULL ) ;
F_20 ( V_12 , V_380 , NULL , F_170 , NULL ) ;
F_20 ( V_12 , V_381 , NULL , F_170 , NULL ) ;
}
