...
{
strcpy ( V_167 -> V_168 , V_169 ) ;
strcpy ( V_167 -> V_170 , V_171 ) ;
}
static int F_65 ( struct V_1 * V_2 , struct V_172 * V_164 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_66 ( & V_6 -> V_124 , V_164 ) ;
}
static int F_67 ( struct V_1 * V_2 , struct V_172 * V_164 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_68 ( & V_6 -> V_124 , V_164 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_72 ( & V_6 -> V_124 ) ;
}
static struct V_1 * F_73 ( struct V_173 * V_7 )
{
struct V_1 * V_2 ;
V_2 = F_74 ( sizeof( struct V_5 ) ) ;
if ( V_2 == NULL )
return NULL ;
...
V_6 -> V_2 = V_2 ;
F_85 ( V_2 , & V_183 -> V_2 ) ;
F_86 ( V_2 , & V_6 -> V_61 , F_21 , 64 ) ;
F_77 ( V_183 , V_2 ) ;
V_6 -> V_185 = F_87 ( V_187 -> V_193 , F_88 ( V_187 ) ,
F_89 ( & V_183 -> V_2 ) ) ;
if ( V_6 -> V_185 == NULL ) {
F_90 ( & V_183 -> V_2 , L_11 ) ;
V_44 = - V_157 ;
...
V_6 -> V_184 = F_91 ( V_187 -> V_193 , F_88 ( V_187 ) ) ;
if ( V_6 -> V_184 == NULL ) {
F_90 ( & V_183 -> V_2 , L_12 ) ;
V_44 = - V_158 ;
goto V_192;
...
{
F_95 (KERN_INFO DRV_MODULE_NAME L_15 DRV_MODULE_VERSION L_16 ) ;
return F_97 ( & V_199 ) ;
}
