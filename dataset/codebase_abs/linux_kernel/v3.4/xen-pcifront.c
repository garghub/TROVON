...
static void F_64 ( struct V_116 * V_77 )
{
struct V_1 * V_4 =
...
static T_7 F_67 ( int V_33 , void * V_24 )
{
struct V_1 * V_4 = V_24 ;
F_4 ( V_4 ) ;
return V_117 ;
...
static struct V_1 * F_72 ( struct V_121 * V_23 )
{
struct V_1 * V_4 ;
V_4 = F_73 ( sizeof( struct V_1 ) , V_88 ) ;
if ( V_4 == NULL )
goto V_43;
V_4 -> V_20 =
(struct V_122 * ) F_74 ( V_88 ) ;
if ( V_4 -> V_20 == NULL ) {
F_50 ( V_4 ) ;
V_4 = NULL ;
goto V_43;
...
static void F_79 ( struct V_1 * V_4 )
{
...
F_81 ( V_4 -> V_33 , V_4 ) ;
if ( V_4 -> V_32 != V_124 )
F_82 ( V_4 -> V_23 , V_4 -> V_32 ) ;
if ( V_4 -> V_125 != V_126 )
F_83 ( V_4 -> V_125 , 0 ,
( unsigned long ) V_4 -> V_20 ) ;
else
F_84 ( ( unsigned long ) V_4 -> V_20 ) ;
F_75 ( & V_4 -> V_23 -> V_24 , NULL ) ;
F_50 ( V_4 ) ;
}
...
int V_28 = 0 ;
struct V_127 V_128 ;
V_28 = F_86 ( V_4 -> V_23 , F_87 ( V_4 -> V_20 ) ) ;
if ( V_28 < 0 )
goto V_43;
V_4 -> V_125 = V_28 ;
V_28 = F_88 ( V_4 -> V_23 , & V_4 -> V_32 ) ;
if ( V_28 )
goto V_43;
V_28 = F_89 ( V_4 -> V_32 , F_67 ,
0 , L_42 , V_4 ) ;
if ( V_28 < 0 )
return V_28 ;
V_4 -> V_33 = V_28 ;
...
V_28 = F_92 ( V_128 , V_4 -> V_23 -> V_130 ,
L_45 , L_46 , V_4 -> V_125 ) ;
if ( ! V_28 )
V_28 = F_92 ( V_128 , V_4 -> V_23 -> V_130 ,
L_47 , L_46 , V_4 -> V_32 ) ;
...
static int T_4 F_95 ( struct V_1 * V_4 )
{
int V_28 = - V_134 ;
int V_61 , V_135 , V_136 ;
char V_137 [ 64 ] ;
unsigned int V_5 , V_6 ;
if ( F_96 ( V_4 -> V_23 -> V_130 ) !=
V_133 )
goto V_43;
V_28 = F_68 ( V_4 ) ;
if ( V_28 ) {
...
V_28 = F_97 ( V_138 , V_4 -> V_23 -> V_139 ,
L_54 , L_55 , & V_135 ) ;
if ( V_28 == - V_140 ) {
F_98 ( V_4 -> V_23 , V_28 ,
L_56 ) ;
...
if ( F_99 ( V_136 >= ( sizeof( V_137 ) - 1 ) ) ) {
V_28 = - V_89 ;
goto V_43;
}
V_28 = F_97 ( V_138 , V_4 -> V_23 -> V_139 , V_137 ,
L_59 , & V_5 , & V_6 ) ;
if ( V_28 != 2 ) {
if ( V_28 >= 0 )
V_28 = - V_66 ;
...
V_28 = F_94 ( V_4 -> V_23 , V_145 ) ;
V_43:
return V_28 ;
}
static int T_4 F_101 ( struct V_1 * V_4 )
{
int V_28 = - V_134 ;
int V_61 , V_135 , V_136 ;
unsigned int V_5 , V_6 ;
...
V_141 )
goto V_43;
V_28 = F_97 ( V_138 , V_4 -> V_23 -> V_139 , L_62 , L_55 ,
& V_147 ) ;
if ( V_28 != 1 ) {
if ( V_28 >= 0 )
V_28 = - V_66 ;
...
if ( F_99 ( V_150 >= ( sizeof( V_137 ) - 1 ) ) ) {
V_28 = - V_89 ;
goto V_43;
}
V_28 = F_97 ( V_138 , V_4 -> V_23 -> V_139 , V_137 , L_55 ,
& V_98 ) ;
if ( V_28 != 1 )
V_98 = V_151 ;
if ( V_98 != V_144 )
...
V_58 = F_40 ( V_44 , F_103 ( V_148 , V_149 ) ) ;
if ( ! V_58 ) {
F_7 ( & V_4 -> V_23 -> V_24 ,
L_69 ,
V_5 , V_6 , V_148 , V_149 ) ;
...
V_28 = F_94 ( V_4 -> V_23 , V_146 ) ;
V_43:
return V_28 ;
}
static void T_8 F_104 ( struct V_121 * V_23 ,
enum V_142 V_152 )
{
struct V_1 * V_4 = F_105 ( & V_23 -> V_24 ) ;
switch ( V_152 ) {
case V_151 :
case V_153 :
case V_154 :
...
static int F_106 ( struct V_121 * V_23 ,
const struct V_156 * V_157 )
{
int V_28 = 0 ;
struct V_1 * V_4 = F_72 ( V_23 ) ;
if ( V_4 == NULL ) {
V_28 = - V_89 ;
F_91 ( V_23 , V_28 ,
L_72 ) ;
...
static int F_107 ( struct V_121 * V_23 )
{
struct V_1 * V_4 = F_105 ( & V_23 -> V_24 ) ;
if ( V_4 )
F_79 ( V_4 ) ;
