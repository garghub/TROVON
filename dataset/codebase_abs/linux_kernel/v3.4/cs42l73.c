...
struct V_107 * V_108 )
{
struct V_159 * V_160 = V_156 -> V_161 ;
struct V_110 * V_111 = V_160 -> V_111 ;
struct V_112 * V_113 = F_7 ( V_111 ) ;
...
V_113 -> V_149 [ V_127 ] . V_131 |= V_106 [ V_162 ] . V_131 ;
V_113 -> V_149 [ V_127 ] . V_130 &= 0xFC ;
V_113 -> V_149 [ V_127 ] . V_130 |= V_163 ;
} else {
V_113 -> V_149 [ V_127 ] . V_130 &= 0xFC ;
V_113 -> V_149 [ V_127 ] . V_130 |= V_164 ;
}
...
enum V_165 V_166 )
{
struct V_112 * V_167 = F_7 ( V_111 ) ;
switch ( V_166 ) {
case V_168 :
F_18 ( V_111 , V_15 , V_169 , 0 ) ;
F_18 ( V_111 , V_10 , V_170 , 0 ) ;
break;
case V_171 :
break;
case V_172 :
if ( V_111 -> V_173 . V_174 == V_175 ) {
F_22 ( V_167 -> V_176 , false ) ;
F_23 ( V_167 -> V_176 ) ;
}
F_18 ( V_111 , V_10 , V_170 , 1 ) ;
break;
case V_175 :
F_18 ( V_111 , V_10 , V_170 , 1 ) ;
F_18 ( V_111 , V_15 , V_169 , 1 ) ;
break;
}
V_111 -> V_173 . V_174 = V_166 ;
return 0 ;
}
static int F_24 ( struct V_107 * V_108 , int V_177 )
{
struct V_110 * V_111 = V_108 -> V_111 ;
int V_127 = V_108 -> V_127 ;
...
int V_181 ;
struct V_112 * V_167 = F_7 ( V_111 ) ;
V_111 -> V_182 = V_167 -> V_176 ;
V_181 = F_30 ( V_111 , 8 , 8 , V_183 ) ;
if ( V_181 < 0 ) {
F_11 ( V_111 -> V_2 , L_6 , V_181 ) ;
return V_181 ;
}
F_22 ( V_167 -> V_176 , true ) ;
F_21 ( V_111 , V_172 ) ;
V_167 -> V_117 = V_122 ;
V_167 -> V_104 = 0 ;
return V_181 ;
...
static T_3 int F_32 ( struct V_184 * V_184 ,
const struct V_185 * V_127 )
{
struct V_112 * V_167 ;
int V_181 ;
unsigned int V_186 = 0 ;
unsigned int V_3 ;
V_167 = F_33 ( & V_184 -> V_2 , sizeof( struct V_112 ) ,
V_187 ) ;
if ( ! V_167 ) {
F_11 ( & V_184 -> V_2 , L_7 ) ;
return - V_188 ;
...
F_34 ( V_184 , V_167 ) ;
V_167 -> V_176 = F_35 ( V_184 , & V_189 ) ;
if ( F_36 ( V_167 -> V_176 ) ) {
V_181 = F_37 ( V_167 -> V_176 ) ;
F_11 ( & V_184 -> V_2 , L_8 , V_181 ) ;
goto V_190;
}
V_181 = F_38 ( V_167 -> V_176 , V_6 , & V_3 ) ;
V_186 = ( V_3 & 0xFF ) << 12 ;
V_181 = F_38 ( V_167 -> V_176 , V_7 , & V_3 ) ;
V_186 |= ( V_3 & 0xFF ) << 4 ;
V_181 = F_38 ( V_167 -> V_176 , V_8 , & V_3 ) ;
V_186 |= ( V_3 & 0xF0 ) >> 4 ;
if ( V_186 != V_191 ) {
V_181 = - V_192 ;
F_11 ( & V_184 -> V_2 ,
...
V_181 = F_38 ( V_167 -> V_176 , V_9 , & V_3 ) ;
if ( V_181 < 0 ) {
F_11 ( & V_184 -> V_2 , L_10 ) ;
goto V_193;
}
...
static T_4 int F_42 ( struct V_184 * V_196 )
{
struct V_112 * V_167 = F_43 ( V_196 ) ;
F_44 ( & V_196 -> V_2 ) ;
F_41 ( V_167 -> V_176 ) ;
return 0 ;
}
