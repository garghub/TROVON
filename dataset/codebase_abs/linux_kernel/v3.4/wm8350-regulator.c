...
int V_13 ;
T_1 V_7 ;
if ( V_180 -> V_181 < V_28 || V_180 -> V_181 > V_17 )
return - V_182 ;
switch ( V_180 -> V_181 ) {
case V_28 :
V_7 = F_10 ( V_11 , V_64 ) ;
...
V_10 = F_59 ( & V_183 [ V_180 -> V_181 ] , & V_180 -> V_62 ,
V_180 -> V_62 . V_184 ,
F_58 ( & V_180 -> V_62 ) , NULL ) ;
if ( F_60 ( V_10 ) ) {
F_26 ( & V_180 -> V_62 , L_10 ,
V_183 [ V_180 -> V_181 ] . V_185 ) ;
return F_61 ( V_10 ) ;
}
V_13 = F_62 ( V_11 , V_183 [ V_180 -> V_181 ] . V_171 ,
F_53 , 0 , L_11 , V_10 ) ;
if ( V_13 < 0 ) {
F_63 ( V_10 ) ;
...
struct V_11 * V_11 = F_8 ( V_10 ) ;
F_66 ( V_11 , V_183 [ V_180 -> V_181 ] . V_171 , V_10 ) ;
F_63 ( V_10 ) ;
return 0 ;
}
...
V_187 -> V_193 = V_11 ;
V_180 -> V_62 . V_184 = V_187 ;
V_180 -> V_62 . V_194 = V_11 -> V_62 ;
F_69 ( V_180 , V_11 ) ;
V_13 = F_70 ( V_180 ) ;
if ( V_13 != 0 ) {
F_26 ( V_11 -> V_62 , L_14 ,
...
int F_72 ( struct V_11 * V_11 , int V_195 , int V_49 , int V_12 ,
struct V_196 * V_197 )
{
struct V_198 * V_199 ;
struct V_179 * V_180 ;
int V_13 ;
if ( V_195 >= F_2 ( V_11 -> V_19 . V_199 ) || V_195 < 0 ) {
F_26 ( V_11 -> V_62 , L_15 , V_195 ) ;
return - V_182 ;
}
V_199 = & V_11 -> V_19 . V_199 [ V_195 ] ;
if ( V_199 -> V_180 ) {
F_26 ( V_11 -> V_62 , L_16 , V_195 ) ;
return - V_6 ;
}
V_180 = F_68 ( L_17 , V_195 ) ;
if ( V_180 == NULL ) {
F_26 ( V_11 -> V_62 , L_18 , V_195 ) ;
return - V_192 ;
}
V_199 -> V_200 . V_201 = V_201 ( & V_180 -> V_62 ) ;
V_199 -> V_200 . V_202 = L_19 ;
V_199 -> V_203 . V_204 = 1 ;
V_199 -> V_203 . V_205 = & V_199 -> V_200 ;
V_199 -> V_203 . V_206 . V_1 = 0 ;
V_199 -> V_203 . V_206 . V_2 = V_197 -> V_2 ;
V_199 -> V_203 . V_206 . V_207
= V_208 | V_209 ;
V_199 -> V_203 . V_206 . V_210 = V_85 ;
V_13 = F_67 ( V_11 , V_12 , & V_199 -> V_203 ) ;
if ( V_13 != 0 ) {
F_71 ( V_180 ) ;
return V_13 ;
}
V_199 -> V_211 . V_201 = V_201 ( & V_180 -> V_62 ) ;
V_199 -> V_211 . V_202 = L_20 ;
V_199 -> V_212 . V_204 = 1 ;
V_199 -> V_212 . V_205 = & V_199 -> V_211 ;
V_199 -> V_212 . V_206 . V_210 = V_85 ;
V_199 -> V_212 . V_206 . V_207 = V_209 ;
V_13 = F_67 ( V_11 , V_49 , & V_199 -> V_212 ) ;
if ( V_13 != 0 ) {
F_71 ( V_180 ) ;
return V_13 ;
}
