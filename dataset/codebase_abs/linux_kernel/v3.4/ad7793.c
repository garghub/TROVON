...
static T_4 F_40 ( int V_31 , void * V_90 )
{
struct V_1 * V_2 = F_26 ( V_90 ) ;
V_2 -> V_27 = true ;
F_41 ( & V_2 -> V_32 ) ;
F_31 ( V_31 ) ;
V_2 -> V_30 = true ;
...
F_31 ( V_2 -> V_17 -> V_31 ) ;
V_2 -> V_30 = true ;
V_2 -> V_78 -> V_37 . V_96 = & V_2 -> V_17 -> V_37 ;
V_2 -> V_78 -> V_97 = V_56 ;
V_18 = F_48 ( V_2 -> V_78 ) ;
V_56 -> V_78 = V_2 -> V_78 ;
if ( V_18 )
...
static T_6 F_53 ( struct V_99 * V_37 ,
struct V_100 * V_101 ,
char * V_102 )
{
struct V_55 * V_56 = F_54 ( V_37 ) ;
struct V_1 * V_2 = F_26 ( V_56 ) ;
return sprintf ( V_102 , L_6 ,
V_103 [ F_55 ( V_2 -> V_23 ) ] ) ;
}
static T_6 F_56 ( struct V_99 * V_37 ,
struct V_100 * V_101 ,
const char * V_102 ,
T_3 V_12 )
{
...
F_59 ( & V_56 -> V_105 ) ;
V_18 = F_60 ( V_102 , 10 , & V_104 ) ;
if ( V_18 )
return V_18 ;
V_18 = - V_16 ;
for ( V_35 = 0 ; V_35 < F_19 ( V_103 ) ; V_35 ++ )
if ( V_104 == V_103 [ V_35 ] ) {
F_57 ( & V_56 -> V_105 ) ;
V_2 -> V_23 &= ~ F_55 ( - 1 ) ;
V_2 -> V_23 |= F_55 ( V_35 ) ;
...
static T_6 F_61 ( struct V_99 * V_37 ,
...
int V_35 , V_12 = 0 ;
for ( V_35 = 0 ; V_35 < F_19 ( V_2 -> V_47 ) ; V_35 ++ )
V_12 += sprintf ( V_102 + V_12 , L_7 , V_2 -> V_47 [ V_35 ] [ 0 ] ,
V_2 -> V_47 [ V_35 ] [ 1 ] ) ;
V_12 += sprintf ( V_102 + V_12 , L_8 ) ;
return V_12 ;
}
...
V_18 = F_10 ( V_2 , V_108 -> V_70 ,
V_108 -> V_52 . V_53 / 8 , & V_110 ) ;
F_59 ( & V_56 -> V_105 ) ;
if ( V_18 < 0 )
return V_18 ;
* V_7 = ( V_110 >> V_108 -> V_52 . V_112 ) &
( ( 1 << ( V_108 -> V_52 . V_53 ) ) - 1 ) ;
if ( ! V_111 )
...
static int T_7 F_67 ( struct V_122 * V_17 )
{
struct V_123 * V_44 = V_17 -> V_37 . V_124 ;
struct V_1 * V_2 ;
struct V_55 * V_56 ;
int V_18 , V_35 , V_125 = 0 ;
if ( ! V_44 ) {
F_20 ( & V_17 -> V_37 , L_9 ) ;
return - V_126 ;
}
...
F_73 ( V_17 , V_56 ) ;
V_2 -> V_17 = V_17 ;
V_56 -> V_37 . V_96 = & V_17 -> V_37 ;
V_56 -> V_91 = F_46 ( V_17 ) -> V_91 ;
V_56 -> V_88 = V_131 ;
V_56 -> V_63 = V_2 -> V_50 -> V_51 ;
V_56 -> V_132 = V_2 -> V_132 ;
V_56 -> V_133 = 7 ;
V_56 -> V_134 = & V_135 ;
for ( V_35 = 0 ; V_35 < V_56 -> V_133 ; V_35 ++ ) {
F_74 ( V_35 , & V_2 -> V_132 [ V_35 ] ) ;
F_74 ( V_56 ->
V_63 [ V_56 -> V_133 - 1 ] . V_136 ,
& V_2 -> V_132 [ V_35 ] ) ;
}
F_75 ( & V_2 -> V_32 ) ;
V_18 = F_34 ( V_56 ) ;
...
static int F_82 ( struct V_122 * V_17 )
{
