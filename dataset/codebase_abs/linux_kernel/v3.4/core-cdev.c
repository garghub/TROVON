...
if ( V_1 -> V_194 == NULL || V_73 -> V_90 != 0 )
return - V_93 ;
return F_124 ( V_1 -> V_194 ) ;
}
static int F_125 ( struct V_1 * V_1 , union V_70 * V_71 )
{
struct V_238 * V_73 = & V_71 -> V_239 ;
struct V_49 * V_50 = V_1 -> V_3 -> V_50 ;
struct V_240 V_241 = { 0 , 0 } ;
T_7 V_242 ;
int V_44 = 0 ;
F_126 () ;
V_242 = V_50 -> V_243 -> V_244 ( V_50 , V_245 ) ;
switch ( V_73 -> V_246 ) {
case V_247 : F_127 ( & V_241 ) ; break;
case V_248 : F_128 ( & V_241 ) ; break;
case V_249 : F_129 ( & V_241 ) ; break;
default:
V_44 = - V_93 ;
}
F_130 () ;
V_73 -> V_250 = V_241 . V_250 ;
V_73 -> V_251 = V_241 . V_251 ;
V_73 -> V_252 = V_242 ;
return V_44 ;
}
static int F_131 ( struct V_1 * V_1 , union V_70 * V_71 )
{
struct V_253 * V_73 = & V_71 -> V_254 ;
struct V_238 V_255 ;
V_255 . V_246 = V_247 ;
F_125 ( V_1 , (union V_70 * ) & V_255 ) ;
V_73 -> V_256 = V_255 . V_250 * V_257 + V_255 . V_251 / V_258 ;
V_73 -> V_252 = V_255 . V_252 ;
return 0 ;
}
static void F_132 ( struct V_259 * V_8 )
{
struct V_260 * V_68 ;
struct V_4 * V_5 =
F_4 ( V_8 , struct V_4 , V_8 . V_8 ) ;
struct V_1 * V_1 = V_5 -> V_1 ;
int V_54 , V_192 , V_261 , V_262 ;
bool V_217 , free , V_263 ;
F_35 ( & V_1 -> V_22 ) ;
V_54 = V_1 -> V_3 -> V_54 ;
V_262 = V_5 -> V_262 ;
if ( V_262 == V_264 &&
F_133 ( F_134 () ,
V_1 -> V_3 -> V_50 -> V_265 + V_266 ) ) {
F_9 ( V_5 , F_135 ( V_266 , 3 ) ) ;
V_217 = true ;
} else {
V_217 = V_262 == V_267 &&
V_5 -> V_54 == V_54 ;
...
goto V_46;
V_261 = V_5 -> V_261 ;
F_136 ( V_1 -> V_3 -> V_50 , V_54 ,
V_5 -> V_199 , & V_192 , & V_261 ,
V_262 == V_264 ||
V_262 == V_267 ||
V_262 == V_269 ) ;
if ( V_192 == - V_91 &&
( V_262 == V_264 || V_262 == V_267 ) )
goto V_46;
V_263 = V_192 >= 0 || V_261 > 0 ;
F_35 ( & V_1 -> V_22 ) ;
if ( V_5 -> V_262 == V_264 )
V_5 -> V_262 = V_267 ;
if ( V_5 -> V_262 == V_267 && ! V_263 &&
! V_1 -> V_39 &&
...
F_38 ( & V_1 -> V_22 ) ;
if ( V_262 == V_264 && V_192 >= 0 )
V_5 -> V_199 = 1ULL << V_192 ;
if ( V_262 == V_267 && V_263 )
goto V_46;
if ( V_262 == V_264 || V_262 == V_269 ) {
V_68 = V_5 -> V_271 ;
V_5 -> V_271 = NULL ;
} else {
V_68 = V_5 -> V_272 ;
...
struct V_273 * V_104 , int V_262 )
{
struct V_260 * V_274 , * V_275 ;
struct V_4 * V_5 ;
int V_44 ;
if ( ( V_104 -> V_199 == 0 && V_104 -> V_261 == 0 ) ||
V_104 -> V_261 > V_276 ||
V_104 -> V_261 < 0 )
return - V_93 ;
V_5 = F_71 ( sizeof( * V_5 ) , V_20 ) ;
V_274 = F_71 ( sizeof( * V_274 ) , V_20 ) ;
V_275 = F_71 ( sizeof( * V_275 ) , V_20 ) ;
if ( V_5 == NULL || V_274 == NULL || V_275 == NULL ) {
V_44 = - V_21 ;
goto V_277;
}
F_139 ( & V_5 -> V_8 , F_132 ) ;
...
V_5 -> V_261 = V_104 -> V_261 ;
V_5 -> V_271 = V_274 ;
V_5 -> V_272 = V_275 ;
V_274 -> V_4 . V_51 = V_104 -> V_51 ;
V_274 -> V_4 . type = V_278 ;
V_275 -> V_4 . V_51 = V_104 -> V_51 ;
V_275 -> V_4 . type = V_279 ;
if ( V_262 == V_264 ) {
V_5 -> V_10 . V_11 = V_12 ;
V_44 = F_59 ( V_1 , & V_5 -> V_10 , V_20 ) ;
if ( V_44 < 0 )
...
if ( V_73 -> V_47 < V_281 + V_282 )
return - V_283 ;
return F_70 ( V_1 , V_73 , V_284 | 0x3f , V_285 ) ;
}
static int F_146 ( struct V_1 * V_1 , union V_70 * V_71 )
{
struct V_286 * V_73 = & V_71 -> V_287 ;
struct V_103 V_104 ;
int V_288 ;
if ( V_73 -> V_106 > V_1 -> V_3 -> V_50 -> V_289 ||
V_73 -> V_96 > 1024 << V_73 -> V_106 )
return - V_109 ;
if ( V_73 -> V_218 > 3 || V_73 -> V_192 > 63 || V_73 -> V_219 > 15 )
return - V_93 ;
V_288 = F_147 ( V_73 -> V_218 , V_73 -> V_192 , V_73 -> V_219 ) ;
V_104 . V_107 = V_108 ;
V_104 . V_96 = V_73 -> V_96 ;
V_104 . V_51 = V_73 -> V_51 ;
V_104 . V_37 = V_73 -> V_37 ;
V_104 . V_54 = V_73 -> V_54 ;
return F_70 ( V_1 , & V_104 , V_288 , V_73 -> V_106 ) ;
}
static void F_148 ( struct V_290 * V_208 ,
struct V_49 * V_50 , int V_291 )
{
struct V_292 * V_68 =
F_4 ( V_208 , struct V_292 , V_66 ) ;
switch ( V_291 ) {
case V_293 : V_68 -> V_294 . V_94 = V_101 ; break;
case V_295 : V_68 -> V_294 . V_94 = V_101 ; break;
case V_296 :
case V_297 :
case V_298 : V_68 -> V_294 . V_94 = V_299 ; break;
case V_300 : V_68 -> V_294 . V_94 = V_301 ; break;
case V_302 : V_68 -> V_294 . V_94 = V_303 ; break;
default: V_68 -> V_294 . V_94 = V_291 ; break;
}
V_68 -> V_294 . V_37 [ 0 ] = V_208 -> V_304 ;
F_27 ( V_68 -> V_1 , & V_68 -> V_30 , & V_68 -> V_294 ,
sizeof( V_68 -> V_294 ) + V_68 -> V_294 . V_96 , NULL , 0 ) ;
F_7 ( V_68 -> V_1 ) ;
}
static int F_149 ( struct V_1 * V_1 , union V_70 * V_71 )
{
struct V_305 * V_73 = & V_71 -> V_306 ;
struct V_49 * V_50 = V_1 -> V_3 -> V_50 ;
struct V_292 * V_68 ;
if ( ! V_1 -> V_3 -> V_165 )
return - V_166 ;
...
F_1 ( V_1 ) ;
V_68 -> V_1 = V_1 ;
V_68 -> V_66 . V_106 = V_285 ;
V_68 -> V_66 . V_54 = V_73 -> V_54 ;
V_68 -> V_66 . V_174 [ 0 ] = V_307 << 4 ;
V_68 -> V_66 . V_174 [ 1 ] = V_73 -> V_37 [ 0 ] ;
V_68 -> V_66 . V_174 [ 2 ] = V_73 -> V_37 [ 1 ] ;
V_68 -> V_66 . V_173 = 12 ;
V_68 -> V_66 . F_45 = F_148 ;
V_68 -> V_294 . V_51 = V_73 -> V_51 ;
V_68 -> V_294 . type = V_308 ;
if ( F_150 ( V_73 -> V_37 ) )
V_68 -> V_294 . V_96 = 4 ;
V_50 -> V_243 -> V_113 ( V_50 , & V_68 -> V_66 ) ;
return 0 ;
}
static int F_151 ( struct V_1 * V_1 , union V_70 * V_71 )
{
struct V_309 * V_73 = & V_71 -> V_310 ;
struct V_49 * V_50 = V_1 -> V_3 -> V_50 ;
if ( ! V_1 -> V_3 -> V_165 )
return - V_166 ;
F_35 ( & V_50 -> V_22 ) ;
F_152 ( & V_1 -> V_27 , & V_50 -> V_311 ) ;
V_1 -> V_312 = V_73 -> V_51 ;
F_38 ( & V_50 -> V_22 ) ;
return 0 ;
}
void F_153 ( struct V_49 * V_50 , struct V_290 * V_66 )
{
struct V_1 * V_1 ;
struct V_313 * V_68 ;
unsigned long V_35 ;
...
V_68 -> V_294 . V_51 = V_1 -> V_312 ;
V_68 -> V_294 . type = V_314 ;
V_68 -> V_294 . V_94 = V_101 ;
V_68 -> V_294 . V_96 = 8 ;
V_68 -> V_294 . V_37 [ 0 ] = V_66 -> V_174 [ 1 ] ;
V_68 -> V_294 . V_37 [ 1 ] = V_66 -> V_174 [ 2 ] ;
F_27 ( V_1 , & V_68 -> V_30 ,
& V_68 -> V_294 , sizeof( V_68 -> V_294 ) + 8 , NULL , 0 ) ;
}
F_30 ( & V_50 -> V_22 , V_35 ) ;
}
static int F_154 ( struct V_1 * V_1 ,
unsigned int V_315 , void T_1 * V_71 )
{
union V_70 V_40 ;
int V_44 ;
if ( F_19 ( V_1 -> V_3 ) )
return - V_19 ;
if ( F_155 ( V_315 ) != '#' ||
F_156 ( V_315 ) >= F_39 ( V_316 ) ||
F_157 ( V_315 ) > sizeof( V_40 ) )
return - V_317 ;
if ( F_158 ( V_315 ) == V_318 )
memset ( & V_40 , 0 , F_157 ( V_315 ) ) ;
if ( F_158 ( V_315 ) & V_319 )
if ( F_72 ( & V_40 , V_71 , F_157 ( V_315 ) ) )
return - V_45 ;
V_44 = V_316 [ F_156 ( V_315 ) ] ( V_1 , & V_40 ) ;
if ( V_44 < 0 )
return V_44 ;
if ( F_158 ( V_315 ) & V_318 )
if ( F_41 ( V_71 , & V_40 , F_157 ( V_315 ) ) )
return - V_45 ;
return V_44 ;
}
static long F_159 ( struct V_16 * V_16 ,
unsigned int V_315 , unsigned long V_71 )
{
return F_154 ( V_16 -> V_29 , V_315 , ( void T_1 * ) V_71 ) ;
}
static long F_160 ( struct V_16 * V_16 ,
unsigned int V_315 , unsigned long V_71 )
{
return F_154 ( V_16 -> V_29 , V_315 , F_14 ( V_71 ) ) ;
}
static int F_161 ( struct V_16 * V_16 , struct V_320 * V_321 )
{
struct V_1 * V_1 = V_16 -> V_29 ;
enum V_322 V_323 ;
unsigned long V_38 ;
...
return - V_93 ;
if ( V_321 -> V_210 & ~ V_326 )
return - V_93 ;
V_1 -> V_210 = V_321 -> V_210 ;
V_38 = V_321 -> V_327 - V_321 -> V_210 ;
V_211 = V_38 >> V_212 ;
if ( V_38 & ~ V_326 )
return - V_93 ;
if ( V_321 -> V_324 & V_328 )
V_323 = V_329 ;
else
V_323 = V_330 ;
V_44 = F_162 ( & V_1 -> V_40 , V_1 -> V_3 -> V_50 ,
V_211 , V_323 ) ;
if ( V_44 < 0 )
return V_44 ;
V_44 = F_163 ( & V_1 -> V_40 , V_321 ) ;
if ( V_44 < 0 )
F_164 ( & V_1 -> V_40 , V_1 -> V_3 -> V_50 ) ;
return V_44 ;
}
...
static int F_168 ( struct V_15 * V_15 , struct V_16 * V_16 )
{
struct V_1 * V_1 = V_16 -> V_29 ;
...
V_1 -> V_39 = true ;
F_38 ( & V_1 -> V_22 ) ;
F_169 ( V_1 -> V_26 , ! F_166 ( V_1 ) ) ;
F_52 ( & V_1 -> V_23 , F_167 , V_1 ) ;
F_170 ( & V_1 -> V_23 ) ;
F_171 ( & V_1 -> V_23 ) ;
F_172 (event, next_event, &client->event_list, link)
F_6 ( V_30 ) ;
F_7 ( V_1 ) ;
return 0 ;
}
static unsigned int F_173 ( struct V_16 * V_16 , T_12 * V_332 )
{
struct V_1 * V_1 = V_16 -> V_29 ;
unsigned int V_333 = 0 ;
F_174 ( V_16 , & V_1 -> V_25 , V_332 ) ;
if ( F_19 ( V_1 -> V_3 ) )
V_333 |= V_334 | V_335 ;
if ( ! F_34 ( & V_1 -> V_24 ) )
V_333 |= V_336 | V_337 ;
