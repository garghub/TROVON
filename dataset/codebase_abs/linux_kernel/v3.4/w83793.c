...
static T_4
F_33 ( struct V_10 * V_11 , struct V_12 * V_13 , char * V_14 )
{
struct V_16 * V_17 =
F_15 ( V_13 ) ;
int V_22 = V_17 -> V_22 ;
...
F_26 ( V_28 , F_35 ( V_18 ) ,
( V_1 >> 8 ) & 0xff ) ;
F_26 ( V_28 , F_35 ( V_18 ) + 1 , V_1 & 0xff ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
static T_4
F_36 ( struct V_10 * V_11 , struct V_12 * V_13 , char * V_14 )
{
struct V_16 * V_17 =
F_15 ( V_13 ) ;
struct V_8 * V_9 = F_14 ( V_11 ) ;
...
V_9 -> V_42 [ V_18 ] [ V_22 ] =
F_24 ( V_28 , F_39 ( V_18 , V_22 ) ) & 0xc0 ;
V_9 -> V_42 [ V_18 ] [ V_22 ] |= V_1 ;
F_26 ( V_28 , F_39 ( V_18 , V_22 ) ,
V_9 -> V_42 [ V_18 ] [ V_22 ] ) ;
}
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
...
static T_4
F_40 ( struct V_10 * V_11 , struct V_12 * V_13 , char * V_14 )
{
struct V_16 * V_17 =
F_15 ( V_13 ) ;
int V_22 = V_17 -> V_22 ;
...
static T_4
F_47 ( struct V_10 * V_11 , struct V_12 * V_13 , char * V_14 )
{
struct V_16 * V_17 =
F_15 ( V_13 ) ;
int V_22 = V_17 -> V_22 ;
...
static T_4
F_48 ( struct V_10 * V_11 , struct V_12 * V_13 ,
const char * V_14 , T_5 V_20 )
{
struct V_16 * V_17 =
F_15 ( V_13 ) ;
...
static T_4
F_52 ( struct V_10 * V_11 , struct V_12 * V_13 , char * V_14 )
{
struct V_16 * V_17 =
F_15 ( V_13 ) ;
int V_22 = V_17 -> V_22 ;
...
static T_4
F_53 ( struct V_10 * V_11 , struct V_12 * V_13 ,
const char * V_14 , T_5 V_20 )
{
struct V_27 * V_28 = F_21 ( V_11 ) ;
struct V_8 * V_9 = F_22 ( V_28 ) ;
...
F_23 ( & V_9 -> V_32 ) ;
V_9 -> V_74 [ V_18 ] [ V_22 ] =
F_24 ( V_28 , F_54 ( V_18 , V_22 ) ) & 0xc0 ;
V_9 -> V_74 [ V_18 ] [ V_22 ] |= V_1 ;
F_26 ( V_28 , F_54 ( V_18 , V_22 ) ,
V_9 -> V_74 [ V_18 ] [ V_22 ] ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
static T_4
F_55 ( struct V_10 * V_11 , struct V_12 * V_13 , char * V_14 )
{
struct V_16 * V_17 =
F_15 ( V_13 ) ;
int V_22 = V_17 -> V_22 ;
...
static T_4
F_56 ( struct V_10 * V_11 , struct V_12 * V_13 ,
const char * V_14 , T_5 V_20 )
{
struct V_27 * V_28 = F_21 ( V_11 ) ;
struct V_8 * V_9 = F_22 ( V_28 ) ;
...
F_23 ( & V_9 -> V_32 ) ;
V_9 -> V_75 [ V_18 ] [ V_22 ] =
F_24 ( V_28 , F_57 ( V_18 , V_22 ) ) & 0x80 ;
V_9 -> V_75 [ V_18 ] [ V_22 ] |= V_1 ;
F_26 ( V_28 , F_57 ( V_18 , V_22 ) ,
V_9 -> V_75 [ V_18 ] [ V_22 ] ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
static T_4
F_58 ( struct V_10 * V_11 , struct V_12 * V_13 , char * V_14 )
{
struct V_16 * V_17 =
F_15 ( V_13 ) ;
int V_22 = V_17 -> V_22 ;
...
static T_4
F_59 ( struct V_10 * V_11 , struct V_12 * V_13 ,
const char * V_14 , T_5 V_20 )
{
struct V_16 * V_17 =
F_15 ( V_13 ) ;
...
static int F_61 ( struct V_8 * V_9 , int V_84 )
{
int V_85 , V_86 ;
V_86 = F_62 ( V_84 , 60 ) ;
if ( V_86 > 255 )
...
static int F_67 ( struct V_93 * V_93 , struct V_94 * V_95 )
{
struct V_8 * V_96 , * V_9 = NULL ;
int V_97 ;
if ( ! F_68 ( & V_98 ) )
return - V_99 ;
F_69 (pos, &watchdog_data_list, list) {
if ( V_96 -> V_100 . V_101 == F_70 ( V_93 ) ) {
V_9 = V_96 ;
break;
}
}
V_97 = F_71 ( 0 , & V_9 -> V_97 ) ;
if ( ! V_97 )
F_72 ( & V_9 -> V_6 ) ;
F_27 ( & V_98 ) ;
if ( V_97 )
...
F_65 ( V_9 ) ;
V_95 -> V_103 = V_9 ;
return F_73 ( V_93 , V_95 ) ;
}
static int F_74 ( struct V_93 * V_93 , struct V_94 * V_95 )
{
...
static T_4 F_78 ( struct V_94 * V_95 , const char T_7 * V_14 ,
T_5 V_20 , T_8 * V_105 )
{
T_4 V_85 ;
struct V_8 * V_9 = V_95 -> V_103 ;
...
static long F_80 ( struct V_94 * V_95 , unsigned int V_109 ,
unsigned long V_110 )
{
struct V_111 V_112 = {
. V_113 = V_114 |
...
if ( ! V_106 )
V_112 . V_113 |= V_119 ;
if ( F_81 ( ( void T_7 * ) V_110 , & V_112 , sizeof( V_112 ) ) )
V_85 = - V_108 ;
break;
case V_120 :
V_1 = V_9 -> V_121 ? V_116 : 0 ;
V_85 = F_82 ( V_1 , ( int T_7 * ) V_110 ) ;
break;
case V_122 :
V_85 = F_82 ( 0 , ( int T_7 * ) V_110 ) ;
break;
case V_123 :
V_85 = F_64 ( V_9 ) ;
break;
...
break;
case V_125 :
if ( F_79 ( V_1 , ( int T_7 * ) V_110 ) ) {
V_85 = - V_108 ;
break;
}
V_85 = F_61 ( V_9 , V_1 ) ;
if ( V_85 > 0 )
V_85 = F_82 ( V_85 , ( int T_7 * ) V_110 ) ;
break;
case V_126 :
if ( F_79 ( V_1 , ( int T_7 * ) V_110 ) ) {
V_85 = - V_108 ;
...
static int F_83 ( struct V_130 * V_131 , unsigned long V_132 ,
void * V_133 )
{
struct V_8 * V_9 = NULL ;
if ( V_132 == V_134 || V_132 == V_135 ) {
F_23 ( & V_98 ) ;
F_69 (data, &watchdog_data_list, list) {
if ( V_9 -> V_100 . V_101 )
F_66 ( V_9 ) ;
}
F_27 ( & V_98 ) ;
...
F_87 ( & V_138 ) ;
F_88 ( V_9 -> V_139 ) ;
for ( V_73 = 0 ; V_73 < F_89 ( V_140 ) ; V_73 ++ )
F_90 ( V_11 ,
& V_140 [ V_73 ] . V_141 ) ;
for ( V_73 = 0 ; V_73 < F_89 ( V_142 ) ; V_73 ++ )
F_90 ( V_11 , & V_142 [ V_73 ] . V_141 ) ;
for ( V_73 = 0 ; V_73 < F_89 ( V_143 ) ; V_73 ++ )
F_90 ( V_11 , & V_143 [ V_73 ] . V_141 ) ;
F_90 ( V_11 , & V_144 ) ;
for ( V_73 = 0 ; V_73 < F_89 ( V_145 ) ; V_73 ++ )
F_90 ( V_11 , & V_145 [ V_73 ] . V_141 ) ;
for ( V_73 = 0 ; V_73 < F_89 ( V_146 ) ; V_73 ++ )
F_90 ( V_11 , & V_146 [ V_73 ] . V_141 ) ;
for ( V_73 = 0 ; V_73 < F_89 ( V_147 ) ; V_73 ++ )
F_90 ( V_11 , & V_147 [ V_73 ] . V_141 ) ;
if ( V_9 -> V_148 [ 0 ] != NULL )
F_91 ( V_9 -> V_148 [ 0 ] ) ;
if ( V_9 -> V_148 [ 1 ] != NULL )
F_91 ( V_9 -> V_148 [ 1 ] ) ;
...
if ( ! ( V_47 & 0x08 ) )
V_9 -> V_148 [ 0 ] = F_95 ( V_153 , 0x48 + ( V_47 & 0x7 ) ) ;
if ( ! ( V_47 & 0x80 ) ) {
if ( ( V_9 -> V_148 [ 0 ] != NULL )
&& ( ( V_47 & 0x7 ) == ( ( V_47 >> 4 ) & 0x7 ) ) ) {
F_94 ( & V_28 -> V_11 ,
L_13
L_14 , V_9 -> V_148 [ 0 ] -> V_151 ) ;
V_21 = - V_88 ;
goto V_157;
}
V_9 -> V_148 [ 1 ] = F_95 ( V_153 ,
0x48 + ( ( V_47 >> 4 ) & 0x7 ) ) ;
}
return 0 ;
V_157:
...
if ( ! F_97 ( V_153 , V_162 ) )
return - V_88 ;
V_160 = F_98 ( V_28 , V_163 ) ;
V_47 = V_160 & 0x80 ? 0x5c : 0xa3 ;
if ( V_47 != F_98 ( V_28 , V_164 ) ) {
F_99 ( L_15 ) ;
return - V_88 ;
}
if ( ( V_160 & 0x07 ) == 0
...
V_161 = F_98 ( V_28 , V_166 ) ;
if ( V_161 != 0x7b )
return - V_88 ;
F_100 ( V_159 -> type , L_17 , V_167 ) ;
return 0 ;
}
...
int V_171 = F_89 ( V_145 ) / 7 ;
int V_172 = F_89 ( V_146 ) / 5 ;
int V_173 = F_89 ( V_147 ) / 6 ;
V_9 = F_102 ( sizeof( struct V_8 ) , V_174 ) ;
if ( ! V_9 ) {
V_21 = - V_175 ;
goto exit;
}
F_103 ( V_28 , V_9 ) ;
V_9 -> V_160 = F_98 ( V_28 , V_163 ) ;
F_104 ( & V_9 -> V_32 ) ;
F_104 ( & V_9 -> V_87 ) ;
F_105 ( & V_9 -> V_137 ) ;
F_106 ( & V_9 -> V_6 ) ;
...
if ( ! ( V_9 -> V_181 & ( 1 << V_73 ) ) )
continue;
V_21 = F_107 ( V_11 , & V_143 [ V_73 ] . V_141 ) ;
if ( V_21 )
goto V_184;
}
if ( V_9 -> V_181 ) {
V_9 -> V_15 = F_108 () ;
V_21 = F_107 ( V_11 , & V_144 ) ;
if ( V_21 )
goto V_184;
}
for ( V_73 = 0 ; V_73 < F_89 ( V_142 ) ; V_73 ++ ) {
V_21 = F_107 ( V_11 , & V_142 [ V_73 ] . V_141 ) ;
if ( V_21 )
goto V_184;
}
...
V_9 -> V_139 = F_109 ( V_11 ) ;
if ( F_110 ( V_9 -> V_139 ) ) {
V_21 = F_111 ( V_9 -> V_139 ) ;
goto V_184;
}
V_21 = F_112 ( & V_138 ) ;
if ( V_21 != 0 ) {
...
struct V_8 * V_9 = F_22 ( V_28 ) ;
int V_73 , V_185 ;
if ( ! ( F_117 ( V_193 , V_9 -> V_194 + V_195 * 300 )
|| ! V_9 -> V_36 ) )
return;
for ( V_73 = 1 ; V_73 < 3 ; V_73 ++ ) {
for ( V_185 = 0 ; V_185 < F_89 ( V_9 -> V_76 ) ; V_185 ++ ) {
V_9 -> V_76 [ V_185 ] [ V_73 ] =
...
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_39 ) ; V_73 ++ ) {
if ( ! ( V_9 -> V_177 & ( 1 << V_73 ) ) )
continue;
V_9 -> V_39 [ V_73 ] =
F_24 ( V_28 , F_35 ( V_73 ) ) << 8 ;
V_9 -> V_39 [ V_73 ] |=
F_24 ( V_28 , F_35 ( V_73 ) + 1 ) ;
}
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_66 ) ; V_73 ++ ) {
if ( ! ( V_9 -> V_183 & ( 1 << V_73 ) ) )
continue;
V_9 -> V_66 [ V_73 ] =
F_24 ( V_28 , F_49 ( V_73 ) ) ;
...
V_9 -> V_74 [ V_73 ] [ V_185 ] =
F_24 ( V_28 , F_54 ( V_73 , V_185 ) ) ;
V_9 -> V_75 [ V_73 ] [ V_185 ] =
F_24 ( V_28 ,
F_57 ( V_73 , V_185 ) ) ;
}
}
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_50 ) ; V_73 ++ )
V_9 -> V_50 [ V_73 ] =
F_24 ( V_28 , V_52 [ V_73 ] ) ;
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_71 ) ; V_73 ++ ) {
V_9 -> V_71 [ V_73 ] =
F_24 ( V_28 , F_51 ( V_73 ) ) ;
}
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_42 ) ; V_73 ++ ) {
if ( ! ( V_9 -> V_178 & ( 1 << V_73 ) ) )
continue;
V_9 -> V_42 [ V_73 ] [ V_196 ] =
F_24 ( V_28 , F_39 ( V_73 , V_196 ) ) ;
V_9 -> V_42 [ V_73 ] [ V_197 ] =
F_24 ( V_28 , F_39 ( V_73 , V_197 ) ) ;
V_9 -> V_41 [ V_73 ] =
F_24 ( V_28 , F_38 ( V_73 ) ) ;
}
...
F_24 ( V_28 , V_64 ) ;
V_9 -> V_33 = F_24 ( V_28 , V_34 ) ;
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_26 ) ; V_73 ++ )
...
int V_73 ;
F_23 ( & V_9 -> V_32 ) ;
if ( ! ( F_117 ( V_193 , V_9 -> V_198 + V_195 * 2 )
|| ! V_9 -> V_36 ) )
goto V_199;
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_76 ) ; V_73 ++ )
V_9 -> V_76 [ V_73 ] [ V_200 ] =
F_24 ( V_28 , V_81 [ V_73 ] [ V_200 ] ) ;
V_9 -> V_77 [ V_200 ] =
F_24 ( V_28 , V_80 [ V_200 ] ) ;
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_38 ) ; V_73 ++ ) {
if ( ! ( V_9 -> V_177 & ( 1 << V_73 ) ) )
continue;
V_9 -> V_38 [ V_73 ] =
F_24 ( V_28 , F_118 ( V_73 ) ) << 8 ;
V_9 -> V_38 [ V_73 ] |=
F_24 ( V_28 , F_118 ( V_73 ) + 1 ) ;
}
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_43 ) ; V_73 ++ ) {
if ( ! ( V_9 -> V_183 & ( 1 << V_73 ) ) )
continue;
V_9 -> V_43 [ V_73 ] [ V_44 ] =
...
for ( V_73 = 0 ; V_73 < F_89 ( V_9 -> V_25 ) ; V_73 ++ )
V_9 -> V_25 [ V_73 ] =
F_24 ( V_28 , F_119 ( V_73 ) ) ;
if ( V_9 -> V_181 & 0x01 )
...
V_205 = F_120 ( V_28 , V_3 & 0xff , V_207 ) ;
V_199:
return V_205 ;
}
