...
static bool F_42 ( struct V_48 * V_49 , void * V_68 )
{
struct V_1 * V_2 = V_49 -> V_57 -> V_2 ;
struct V_10 * V_11 = F_2 ( V_2 -> V_12 ) ;
...
T_3 V_72 ;
int V_13 ;
if ( ! F_43 ( V_73 , & V_49 -> V_18 ) ||
F_5 ( V_60 , & V_49 -> V_18 ) )
return false ;
V_72 = V_2 -> V_61 -> V_62 -> V_74 ( V_49 ) ;
V_13 = F_44 ( V_49 -> V_75 , V_72 ) ;
if ( F_11 ( V_13 ) ) {
F_45 ( V_2 , L_5 ) ;
F_38 ( V_50 , & V_49 -> V_18 ) ;
F_39 ( V_49 ) ;
...
static bool F_52 ( struct V_48 * V_49 , void * V_68 )
{
struct V_1 * V_2 = V_49 -> V_57 -> V_2 ;
struct V_10 * V_11 = F_2 ( V_2 -> V_12 ) ;
struct V_69 * V_70 = V_49 -> V_71 ;
...
static bool F_59 ( struct V_48 * V_49 , void * V_68 )
{
struct V_1 * V_2 = V_49 -> V_57 -> V_2 ;
struct V_69 * V_70 = V_49 -> V_71 ;
...
void F_61 ( struct V_56 * V_57 , bool V_98 )
{
struct V_53 * V_99 ;
unsigned int V_14 ;
if ( V_98 )
F_57 ( V_57 , V_58 , V_91 , NULL ,
F_59 ) ;
switch ( V_57 -> V_86 ) {
case V_87 :
case V_88 :
...
int V_15 ;
V_57 -> V_76 = F_72 ( V_104 ) ;
if ( V_57 -> V_86 == V_92 ) {
V_15 = F_55 ( V_11 , V_57 -> V_76 ) ;
V_57 -> V_105 = V_105 ( V_11 , V_15 , 0 ) ;
} else {
V_15 = F_47 ( V_11 , V_57 -> V_76 ) ;
...
{
struct V_106 * V_107 = F_74 ( V_2 -> V_12 ) ;
...
if ( ! V_2 -> V_81 -> V_76 || ! V_2 -> V_111 -> V_76 ) {
ERROR ( V_2 , L_8 ) ;
return - V_115 ;
}
...
{
V_2 -> V_22 . V_23 = F_87 ( V_24 , V_118 ) ;
if ( ! V_2 -> V_22 . V_23 )
goto exit;
V_2 -> V_120 = F_87 ( V_2 -> V_61 -> V_121 , V_118 ) ;
if ( ! V_2 -> V_120 )
goto exit;
V_2 -> V_119 = F_87 ( V_2 -> V_61 -> V_122 , V_118 ) ;
if ( ! V_2 -> V_119 )
goto exit;
return 0 ;
exit:
...
int F_104 ( struct V_106 * V_123 , T_4 V_136 )
{
struct V_125 * V_126 = F_102 ( V_123 ) ;
struct V_1 * V_2 = V_126 -> V_129 ;
return F_105 ( V_2 , V_136 ) ;
}
int F_106 ( struct V_106 * V_123 )
{
struct V_125 * V_126 = F_102 ( V_123 ) ;
struct V_1 * V_2 = V_126 -> V_129 ;
return F_107 ( V_2 ) ;
