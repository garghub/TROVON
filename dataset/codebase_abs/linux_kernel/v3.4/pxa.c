...
struct V_1 * V_172 )
{
struct V_175 * V_176 = V_174 -> V_171 . V_177 ;
int V_75 ;
if ( ! V_176 )
return 1 ;
V_75 = F_65 ( V_176 , L_1 ) ;
if ( V_75 < 0 ) {
F_66 ( & V_174 -> V_171 , L_2 , V_75 ) ;
return V_75 ;
}
V_172 -> V_4 . line = V_75 ;
return 0 ;
}
static int F_67 ( struct V_173 * V_171 )
{
struct V_1 * V_172 ;
struct V_178 * V_179 , * V_180 ;
int V_75 ;
V_179 = F_68 ( V_171 , V_181 , 0 ) ;
V_180 = F_68 ( V_171 , V_182 , 0 ) ;
if ( ! V_179 || ! V_180 )
return - V_169 ;
V_172 = F_69 ( sizeof( struct V_1 ) , V_183 ) ;
if ( ! V_172 )
return - V_184 ;
V_172 -> V_105 = F_70 ( & V_171 -> V_171 , NULL ) ;
if ( F_71 ( V_172 -> V_105 ) ) {
V_75 = F_72 ( V_172 -> V_105 ) ;
goto V_185;
}
V_172 -> V_4 . type = V_153 ;
V_172 -> V_4 . V_186 = V_187 ;
V_172 -> V_4 . V_188 = V_179 -> V_189 ;
V_172 -> V_4 . V_65 = V_180 -> V_189 ;
V_172 -> V_4 . V_49 = 64 ;
V_172 -> V_4 . V_190 = & V_191 ;
V_172 -> V_4 . V_171 = & V_171 -> V_171 ;
V_172 -> V_4 . V_74 = V_192 | V_193 ;
V_172 -> V_4 . V_104 = F_33 ( V_172 -> V_105 ) ;
V_75 = F_64 ( V_171 , V_172 ) ;
if ( V_75 > 0 )
V_172 -> V_4 . line = V_171 -> V_194 ;
else if ( V_75 < 0 )
goto V_195;
snprintf ( V_172 -> V_106 , V_196 - 1 , L_3 , V_172 -> V_4 . line + 1 ) ;
V_172 -> V_4 . V_5 = F_73 ( V_179 -> V_189 , F_74 ( V_179 ) ) ;
if ( ! V_172 -> V_4 . V_5 ) {
V_75 = - V_184 ;
goto V_195;
}
V_163 [ V_172 -> V_4 . line ] = V_172 ;
F_75 ( & V_167 , & V_172 -> V_4 ) ;
F_76 ( V_171 , V_172 ) ;
return 0 ;
V_195:
F_77 ( V_172 -> V_105 ) ;
...
static int F_79 ( struct V_173 * V_171 )
{
struct V_1 * V_172 = F_80 ( V_171 ) ;
F_76 ( V_171 , NULL ) ;
F_81 ( & V_167 , & V_172 -> V_4 ) ;
F_77 ( V_172 -> V_105 ) ;
F_78 ( V_172 ) ;
return 0 ;
}
