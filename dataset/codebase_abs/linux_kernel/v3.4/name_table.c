...
if ( ( V_10 -> V_12 == V_34 ) && ( V_10 -> V_9 == V_9 ) &&
...
if ( ! V_10 )
return NULL ;
F_17 ( & V_10 -> V_45 , & V_39 -> V_45 ) ;
V_39 -> V_46 ++ ;
if ( F_18 ( V_7 ) ) {
F_17 ( & V_10 -> V_44 , & V_39 -> V_44 ) ;
V_39 -> V_47 ++ ;
}
if ( V_7 == V_48 ) {
F_17 ( & V_10 -> V_43 , & V_39 -> V_43 ) ;
V_39 -> V_49 ++ ;
}
F_19 (s, st, &nseq->subscriptions, nameseq_list) {
F_20 ( V_36 ,
V_10 -> V_4 ,
V_10 -> V_5 ,
V_50 ,
...
static struct V_3 * F_21 ( struct V_20 * V_23 , T_1 V_51 ,
...
static void F_24 ( struct V_20 * V_23 ,
struct V_35 * V_36 )
{
struct V_17 * V_19 = V_23 -> V_25 ;
F_17 ( & V_36 -> V_55 , & V_23 -> V_28 ) ;
if ( ! V_19 )
return;
...
if ( ! V_63 )
return NULL ;
V_10 = F_21 ( V_63 , V_4 , V_7 , V_12 , V_9 ) ;
...
struct V_3 * F_43 ( T_1 type , T_1 V_4 , T_1 V_5 ,
...
int F_47 ( T_1 type , T_1 V_4 , T_1 V_12 , T_1 V_9 )
{
struct V_3 * V_10 ;
F_44 ( & V_65 ) ;
...
static void F_53 ( struct V_17 * V_19 , struct V_76 * V_77 , T_1 V_78 ,
T_1 V_79 )
{
char V_80 [ 27 ] ;
const char * V_81 [] = { L_10 , L_11 , L_12 , L_13 } ;
struct V_3 * V_10 ;
struct V_38 * V_39 ;
F_54 ( V_77 , L_14 , V_19 -> V_4 , V_19 -> V_5 ) ;
if ( V_78 == 2 ) {
F_54 ( V_77 , L_15 ) ;
return;
}
...
F_16 (publ, &info->zone_list, zone_list) {
sprintf ( V_80 , L_16 ,
F_55 ( V_10 -> V_7 ) , F_56 ( V_10 -> V_7 ) ,
F_57 ( V_10 -> V_7 ) , V_10 -> V_12 ) ;
F_54 ( V_77 , L_17 , V_80 ) ;
if ( V_78 > 3 ) {
F_54 ( V_77 , L_18 , V_10 -> V_9 ,
V_81 [ V_10 -> V_6 ] ) ;
}
if ( ! F_58 ( & V_10 -> V_45 , & V_39 -> V_45 ) )
F_54 ( V_77 , L_19 , L_20 ) ;
} ;
F_54 ( V_77 , L_15 ) ;
}
static void V_55 ( struct V_20 * V_63 , struct V_76 * V_77 , T_1 V_78 ,
T_1 type , T_1 V_82 , T_1 V_83 , T_1 V_79 )
{
struct V_17 * V_19 ;
char V_84 [ 11 ] ;
if ( V_63 -> V_32 == 0 )
return;
sprintf ( V_84 , L_21 , V_63 -> type ) ;
if ( V_78 == 1 ) {
F_54 ( V_77 , L_22 , V_84 ) ;
return;
}
...
F_54 ( V_77 , L_23 , V_84 ) ;
F_35 ( & V_63 -> V_24 ) ;
F_53 ( V_19 , V_77 , V_78 , V_79 ) ;
F_39 ( & V_63 -> V_24 ) ;
sprintf ( V_84 , L_24 , L_20 ) ;
}
}
}
static void F_59 ( struct V_76 * V_77 , T_1 V_78 )
{
const char * V_85 [] = {
L_25 ,
L_26 ,
...
static void F_60 ( struct V_76 * V_77 , T_1 V_87 ,
...
struct V_90 * F_61 ( const void * V_91 , int V_92 )
{
struct V_90 * V_77 ;
struct V_93 * V_94 ;
struct V_95 * V_96 ;
struct V_76 V_97 ;
int V_98 ;
if ( ! F_62 ( V_91 , V_92 , V_99 ) )
return F_63 ( V_100 ) ;
V_77 = F_64 ( F_65 ( V_101 ) ) ;
if ( ! V_77 )
return NULL ;
V_96 = (struct V_95 * ) V_77 -> V_102 ;
F_66 ( & V_97 , F_67 ( V_96 ) , V_101 ) ;
V_94 = (struct V_93 * ) F_67 ( V_91 ) ;
F_33 ( & V_65 ) ;
F_60 ( & V_97 , F_68 ( V_94 -> V_78 ) , F_68 ( V_94 -> type ) ,
F_68 ( V_94 -> V_82 ) , F_68 ( V_94 -> V_83 ) ) ;
F_40 ( & V_65 ) ;
V_98 = F_69 ( & V_97 ) ;
F_70 ( V_77 , F_65 ( V_98 ) ) ;
F_71 ( V_96 , V_103 , NULL , V_98 ) ;
return V_77 ;
}
int F_72 ( void )
{
