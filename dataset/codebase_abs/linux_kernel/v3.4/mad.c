...
static void F_133 ( struct V_133 * V_134 )
{
struct V_42 * V_43 ;
struct V_133 * V_288 ;
struct V_205 * V_289 ;
...
V_134 -> V_222 += V_287 ;
if ( V_286 ) {
F_134 (list_item, &mad_agent_priv->wait_list) {
V_288 = F_130 ( V_289 ,
struct V_133 ,
V_87 ) ;
if ( F_131 ( V_134 -> V_222 ,
V_288 -> V_222 ) )
break;
}
}
...
F_129 ( & V_43 -> V_75 ) ;
F_132 ( V_43 -> V_59 -> V_39 -> V_103 ,
& V_43 -> V_75 , V_286 ) ;
}
}
void F_135 ( struct V_133 * V_134 ,
int V_218 )
{
...
static void F_139 ( struct V_91 * V_59 )
{
struct V_133 * V_134 ;
struct V_105 * V_106 ;
unsigned long V_6 ;
...
static void F_140 ( struct V_1 * V_39 ,
struct V_121 * V_122 )
{
struct V_105 * V_106 ;
struct V_91 * V_59 ;
...
static void F_142 ( struct V_305 * V_306 )
{
struct V_1 * V_39 ;
struct V_121 V_122 ;
V_39 = F_53 ( V_306 , struct V_1 , V_306 ) ;
F_143 ( V_39 -> V_307 , V_308 ) ;
while ( F_144 ( V_39 -> V_307 , 1 , & V_122 ) == 1 ) {
...
static int F_148 ( struct V_133 * V_134 )
{
int V_40 ;
if ( ! V_134 -> V_225 )
return - V_314 ;
...
V_106 = F_130 ( V_59 -> V_296 . V_109 . V_180 ,
struct V_105 , V_109 ) ;
V_231 = F_53 ( V_106 ,
struct V_230 ,
V_106 ) ;
...
V_254 -> V_299 = V_300 ;
V_254 -> V_332 = V_333 ;
V_40 = F_141 ( V_60 , V_254 , V_303 | V_334 ) ;
if ( V_40 ) {
F_62 (KERN_ERR PFX L_27
L_30 , i, ret) ;
goto V_99;
