...
T_2 V_82 ;
unsigned V_83 ;
if ( F_32 ( V_42 -> V_84 , V_42 -> V_85 ) )
return - V_16 ;
V_83 = F_33 ( V_42 -> V_84 ,
V_42 -> V_85 ) ;
V_82 = F_34 ( V_42 -> V_84 ,
V_42 -> V_85 ) *
V_42 -> V_76 [ 0 ] . V_77 . V_86 / 8 ;
if ( V_80 -> V_87 ) {
V_82 += sizeof( V_88 ) ;
if ( V_82 % sizeof( V_88 ) )
V_82 += sizeof( V_88 ) - ( V_82 % sizeof( V_88 ) ) ;
}
if ( V_42 -> V_81 -> V_89 -> V_90 )
V_42 -> V_81 -> V_89 ->
V_90 ( V_42 -> V_81 , V_82 ) ;
V_2 -> V_23 = ( V_2 -> V_23 & ~ F_12 ( - 1 ) ) |
F_12 ( V_91 ) ;
V_2 -> V_22 = ( V_2 -> V_22 & ~ F_11 ( - 1 ) ) |
F_11 ( 1 << V_42 -> V_76 [ V_83 ] . V_92 ) ;
F_7 ( V_2 , V_25 , 3 , V_2 -> V_22 ) ;
F_13 ( V_2 -> V_17 -> V_26 ) ;
...
static T_3 F_37 ( int V_31 , void * V_93 )
{
struct V_94 * V_95 = V_93 ;
struct V_41 * V_42 = V_95 -> V_42 ;
struct V_79 * V_80 = V_42 -> V_81 ;
struct V_1 * V_2 = F_31 ( V_42 ) ;
V_88 V_96 [ 2 ] ;
T_4 * V_97 = ( T_4 * ) V_96 ;
...
if ( V_80 -> V_87 )
V_96 [ 1 ] = V_95 -> V_98 ;
V_80 -> V_89 -> V_99 ( V_80 , ( T_1 * ) V_96 , V_95 -> V_98 ) ;
F_38 ( V_42 -> V_100 ) ;
V_2 -> V_30 = false ;
F_14 ( V_2 -> V_17 -> V_31 ) ;
return V_101 ;
...
static T_3 F_45 ( int V_31 , void * V_112 )
{
struct V_1 * V_2 = F_31 ( V_112 ) ;
V_2 -> V_27 = true ;
F_46 ( & V_2 -> V_32 ) ;
F_36 ( V_31 ) ;
V_2 -> V_30 = true ;
...
V_2 -> V_100 -> V_114 = & V_115 ;
V_18 = F_52 ( V_2 -> V_17 -> V_31 ,
F_45 ,
V_116 ,
F_51 ( V_2 -> V_17 ) -> V_113 ,
V_42 ) ;
...
F_36 ( V_2 -> V_17 -> V_31 ) ;
V_2 -> V_30 = true ;
V_2 -> V_100 -> V_40 . V_118 = & V_2 -> V_17 -> V_40 ;
V_2 -> V_100 -> V_119 = V_42 ;
V_18 = F_53 ( V_2 -> V_100 ) ;
...
static T_5 F_58 ( struct V_121 * V_40 ,
struct V_122 * V_123 ,
char * V_124 )
{
struct V_41 * V_42 = F_59 ( V_40 ) ;
struct V_1 * V_2 = F_31 ( V_42 ) ;
return sprintf ( V_124 , L_6 , V_2 -> V_53 /
( V_2 -> V_66 * 1024 * F_27 ( V_2 -> V_23 ) ) ) ;
}
static T_5 F_60 ( struct V_121 * V_40 ,
struct V_122 * V_123 ,
const char * V_124 ,
T_2 V_12 )
{
...
div = V_2 -> V_53 / ( V_125 * V_2 -> V_66 * 1024 ) ;
if ( div < 1 || div > 1023 ) {
V_18 = - V_16 ;
goto V_29;
}
...
static T_5 F_65 ( struct V_121 * V_40 ,
...
int V_38 , V_12 = 0 ;
for ( V_38 = 0 ; V_38 < F_19 ( V_2 -> V_73 ) ; V_38 ++ )
V_12 += sprintf ( V_124 + V_12 , L_7 , V_2 -> V_73 [ V_38 ] [ 0 ] ,
V_2 -> V_73 [ V_38 ] [ 1 ] ) ;
V_12 += sprintf ( V_124 + V_12 , L_8 ) ;
return V_12 ;
}
static T_5 F_66 ( struct V_121 * V_40 ,
struct V_122 * V_123 ,
char * V_124 )
{
struct V_41 * V_42 = F_59 ( V_40 ) ;
struct V_1 * V_2 = F_31 ( V_42 ) ;
return sprintf ( V_124 , L_6 , ! ! ( V_2 -> V_23 & V_128 ) ) ;
}
static T_5 F_67 ( struct V_121 * V_40 ,
struct V_122 * V_123 ,
char * V_124 )
{
struct V_41 * V_42 = F_59 ( V_40 ) ;
struct V_1 * V_2 = F_31 ( V_42 ) ;
return sprintf ( V_124 , L_6 , ! ! ( V_2 -> V_129 & V_130 ) ) ;
}
static T_5 F_68 ( struct V_121 * V_40 ,
struct V_122 * V_123 ,
const char * V_124 ,
T_2 V_12 )
{
...
switch ( ( V_133 ) V_132 -> V_92 ) {
case V_134 :
if ( V_7 )
V_2 -> V_129 |= V_130 ;
else
V_2 -> V_129 &= ~ V_130 ;
F_7 ( V_2 , V_134 , 1 , V_2 -> V_129 ) ;
break;
case V_28 :
if ( V_7 )
V_2 -> V_23 |= V_128 ;
...
V_18 = F_10 ( V_2 , V_136 -> V_92 ,
V_136 -> V_77 . V_78 / 8 , & V_138 ) ;
F_64 ( & V_42 -> V_126 ) ;
if ( V_18 < 0 )
return V_18 ;
* V_7 = ( V_138 >> V_136 -> V_77 . V_140 ) &
( ( 1 << ( V_136 -> V_77 . V_78 ) ) - 1 ) ;
switch ( V_136 -> type ) {
case V_141 :
if ( ! V_139 )
* V_7 -= ( 1 << ( V_136 -> V_77 . V_78 - 1 ) ) ;
break;
case V_142 :
* V_7 -= 0x800000 ;
* V_7 /= 2815 ;
...
* V_137 = V_2 -> V_73 [ F_28 ( V_2 -> V_22 ) ] [ 1 ] ;
F_64 ( & V_42 -> V_126 ) ;
return V_145 ;
case V_142 :
* V_7 = 1000 ;
...
static int T_6 F_75 ( struct V_149 * V_17 )
{
struct V_43 * V_44 = V_17 -> V_40 . V_150 ;
struct V_1 * V_2 ;
struct V_41 * V_42 ;
int V_18 , V_38 , V_151 = 0 ;
if ( ! V_44 ) {
F_20 ( & V_17 -> V_40 , L_9 ) ;
return - V_152 ;
}
...
V_42 = F_76 ( sizeof( * V_2 ) ) ;
if ( V_42 == NULL )
return - V_102 ;
V_2 = F_31 ( V_42 ) ;
V_2 -> V_5 = F_77 ( & V_17 -> V_40 , L_11 ) ;
if ( ! F_78 ( V_2 -> V_5 ) ) {
V_18 = F_79 ( V_2 -> V_5 ) ;
if ( V_18 )
goto V_153;
...
F_81 ( V_17 , V_42 ) ;
V_2 -> V_17 = V_17 ;
V_2 -> V_34 = F_51 ( V_17 ) -> V_155 ;
V_42 -> V_40 . V_118 = & V_17 -> V_40 ;
V_42 -> V_113 = F_51 ( V_17 ) -> V_113 ;
V_42 -> V_110 = V_156 ;
V_42 -> V_76 = V_157 ;
V_42 -> V_158 = F_19 ( V_157 ) ;
V_42 -> V_159 = V_2 -> V_159 ;
if ( V_2 -> V_34 == V_35 )
V_42 -> V_160 = & V_161 ;
else
V_42 -> V_160 = & V_162 ;
for ( V_38 = 0 ; V_38 < V_42 -> V_158 ; V_38 ++ )
V_2 -> V_159 [ V_38 ] = ( 1 << V_38 ) | ( 1 <<
V_42 -> V_76 [ V_42 -> V_158 - 1 ] .
V_163 ) ;
F_82 ( & V_2 -> V_32 ) ;
V_18 = F_39 ( V_42 ) ;
if ( V_18 )
...
static int F_89 ( struct V_149 * V_17 )
{
