...
{
V_23 -> V_25 . V_5 = F_14 ( V_24 -> V_5 ) ;
V_23 -> V_25 . V_6 = F_15 ( V_24 -> V_6 ) ;
}
static int
F_16 ( struct V_26 * V_27 , const struct V_11 * V_12 ,
...
struct V_1 V_13 = { } ;
if ( ! F_17 ( V_12 , V_33 -> V_36 & V_37 ,
& V_13 . V_6 , & V_13 . V_7 ) )
return - V_38 ;
F_18 ( V_12 , V_33 -> V_36 & V_39 , & V_13 . V_5 ) ;
return V_34 ( V_27 , & V_13 , F_19 ( V_33 , V_23 ) , V_33 -> V_40 ) ;
}
static int
F_20 ( struct V_26 * V_27 , struct V_41 * V_42 [] ,
enum V_30 V_31 , T_1 * V_43 , T_1 V_36 , bool V_44 )
{
const struct V_22 * V_23 = V_27 -> V_13 ;
T_2 V_34 = V_27 -> V_35 -> V_31 [ V_31 ] ;
struct V_1 V_13 = { } ;
T_1 V_5 , V_45 = 0 , V_46 = 0 , V_6 , V_47 ;
T_1 V_21 = V_23 -> V_21 ;
bool V_48 = false ;
int V_49 ;
if ( F_21 ( ! V_42 [ V_14 ] ||
...
if ( V_42 [ V_52 ] )
* V_43 = F_24 ( V_42 [ V_52 ] ) ;
V_49 = F_25 ( V_42 [ V_14 ] , & V_13 . V_5 ) ;
if ( V_49 )
return V_49 ;
if ( V_42 [ V_15 ] )
V_13 . V_6 = F_26 ( V_42 [ V_15 ] ) ;
else
return - V_51 ;
if ( V_42 [ V_16 ] ) {
V_13 . V_7 = F_27 ( V_42 [ V_16 ] ) ;
V_48 = F_28 ( V_13 . V_7 ) ;
if ( V_13 . V_7 == 0 )
return - V_53 ;
} else
...
return F_31 ( V_49 , V_36 ) ? 0 : V_49 ;
}
V_5 = F_14 ( V_13 . V_5 ) ;
if ( V_42 [ V_58 ] ) {
V_49 = F_32 ( V_42 [ V_58 ] , & V_45 ) ;
if ( V_49 )
return V_49 ;
if ( V_5 > V_45 )
F_33 ( V_5 , V_45 ) ;
} else if ( V_42 [ V_59 ] ) {
T_3 V_60 = F_27 ( V_42 [ V_59 ] ) ;
if ( V_60 > 32 )
return - V_61 ;
F_34 ( V_5 , V_45 , V_60 ) ;
} else
V_45 = V_5 ;
V_47 = V_6 = F_15 ( V_13 . V_6 ) ;
if ( V_48 && V_42 [ V_50 ] ) {
V_47 = F_35 ( V_42 [ V_50 ] ) ;
if ( V_6 > V_47 )
F_33 ( V_6 , V_47 ) ;
...
V_46 = V_44 && V_5 == V_23 -> V_25 . V_5 ? V_23 -> V_25 . V_6 : V_6 ;
for (; V_46 <= V_47 ; V_46 ++ ) {
V_13 . V_5 = F_11 ( V_5 ) ;
V_13 . V_6 = F_37 ( V_46 ) ;
V_49 = V_34 ( V_27 , & V_13 , V_21 , V_36 ) ;
if ( V_49 && ! F_31 ( V_49 , V_36 ) )
return V_49 ;
else
V_49 = 0 ;
}
