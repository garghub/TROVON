...
case 5 :
if ( F_24 ( V_4 -> V_10 . V_11 , 8 ) )
V_903 = V_905 ;
else if ( F_24 ( V_4 -> V_10 . V_11 , 9 ) )
V_903 = V_906 ;
break;
case 7 :
V_903 = V_907 ;
...
F_67 ( 10 ) ;
F_86 ( V_4 , V_910 , 0x1 , 0x1 ) ;
F_86 ( V_4 , V_911 , 0x2 ,
0x1 ) ;
}
F_86 ( V_4 , V_912 , 0x1 , 0x1 ) ;
F_67 ( 10 ) ;
F_86 ( V_4 , V_912 , 0x3 , 0x3 ) ;
for ( V_240 = 0 ; V_240 < V_913 ; V_240 ++ ) {
V_909 = F_53 ( V_4 , V_914 ) ;
if ( V_909 & 0x1 )
break;
F_67 ( 100 ) ;
}
...
L_2 ) )
return 0 ;
F_86 ( V_4 , V_912 , 0x2 , 0x0 ) ;
V_909 = F_53 ( V_4 , V_914 ) & 0x3e ;
F_86 ( V_4 , V_912 , 0x1 , 0x0 ) ;
if ( V_4 -> V_10 . V_277 == 5 ) {
F_86 ( V_4 , V_910 , 0x1 , 0x0 ) ;
F_86 ( V_4 , V_911 , 0x2 ,
0x0 ) ;
}
if ( ( V_4 -> V_10 . V_277 <= 4 ) || ( V_4 -> V_10 . V_277 == 6 ) ) {
...
V_918 |
V_919 ) ;
F_48 ( V_4 , V_918 | V_919 ,
V_917 | 0x7 ) ;
F_67 ( 10 ) ;
F_48 ( V_4 , V_920 | V_919 ,
0x1 ) ;
F_67 ( 10 ) ;
F_48 ( V_4 , V_920 | V_919 ,
0x9 ) ;
...
{
F_86 ( V_4 , V_930 , 0x1 , 0x1 ) ;
F_86 ( V_4 , V_931 , 0x78 , 0x78 ) ;
F_86 ( V_4 , V_932 , 0x80 , 0x80 ) ;
F_96 ( 2 ) ;
F_86 ( V_4 , V_931 , 0x78 , 0x0 ) ;
F_86 ( V_4 , V_932 , 0x80 , 0x0 ) ;
if ( V_4 -> V_40 ) {
F_137 ( V_4 ) ;
F_138 ( V_4 ) ;
}
F_86 ( V_4 , V_933 , 0x8 , 0x0 ) ;
}
static void F_140 ( struct V_3 * V_4 )
{
const struct V_934 * V_935 = NULL ;
const struct V_934 * V_936 = NULL ;
const struct V_934 * V_937 = NULL ;
if ( F_24 ( V_4 -> V_10 . V_11 , 3 ) ) {
V_935 = V_938 ;
V_936 = V_939 ;
V_937 = V_940 ;
...
F_141 ( V_4 , V_935 , ( T_2 ) V_919 ) ;
F_141 ( V_4 , V_936 , ( T_2 ) V_635 ) ;
F_141 ( V_4 , V_936 , ( T_2 ) V_636 ) ;
F_141 ( V_4 , V_937 , ( T_2 ) V_490 ) ;
F_141 ( V_4 , V_937 , ( T_2 ) V_491 ) ;
}
static void F_142 ( struct V_3 * V_4 )
{
F_86 ( V_4 , V_959 , 0xb , 0xb ) ;
F_86 ( V_4 , V_960 , 0x2 , 0x2 ) ;
F_86 ( V_4 , V_961 , 0x2 , 0x2 ) ;
F_67 ( 1000 ) ;
F_86 ( V_4 , V_961 , 0x2 , 0x0 ) ;
if ( ( V_4 -> V_61 -> V_67 & V_962 )
|| ( V_4 -> V_61 -> V_67 & V_963 ) )
F_86 ( V_4 , V_918 , 0xf4 , 0x0 ) ;
else
F_86 ( V_4 , V_918 , 0xfc , 0x0 ) ;
F_86 ( V_4 , V_964 , 0x1 , 0x0 ) ;
if ( V_4 -> V_40 )
F_137 ( V_4 ) ;
}
...
F_86 ( V_4 , V_974 , 0x3F , 0x2C ) ;
F_48 ( V_4 , V_975 , 0x3C ) ;
F_59 ( V_4 , V_975 ,
~ ( V_976 | V_977 ) ) ;
F_54 ( V_4 , V_978 , V_979 ) ;
F_54 ( V_4 , V_975 , V_977 ) ;
F_67 ( 1000 ) ;
F_54 ( V_4 , V_975 , V_976 ) ;
F_93 ( ( ( F_53 ( V_4 , V_980 ) &
V_981 ) != V_981 ) , 2000 ) ;
if ( F_94 ( ( F_53 ( V_4 , V_980 ) &
V_981 ) != V_981 ,
L_5 ) )
return;
F_59 ( V_4 , V_978 ,
...
void F_147 ( struct V_3 * V_4 , bool V_993 )
{
if ( V_993 ) {
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) ) {
if ( ! V_4 -> V_260 ) {
...
static bool
F_148 ( struct V_3 * V_4 , T_3 V_1000 , int * V_1001 ,
const struct V_1002 * * V_1003 ,
const struct V_1004 * * V_1005 ,
const struct V_1006 * * V_1007 ,
const struct V_1008 * * V_1009 )
{
T_3 V_240 ;
const struct V_1002 * V_1010 = NULL ;
const struct V_1004 * V_1011 = NULL ;
const struct V_1006 * V_1012 = NULL ;
T_1 V_26 = 0 ;
int V_357 = 0 ;
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) ) {
if ( F_24 ( V_4 -> V_10 . V_11 , 7 ) ) {
...
switch ( V_4 -> V_10 . V_277 ) {
case 5 :
if ( V_4 -> V_10 . V_1014 == 0x0 ) {
V_1012 =
V_1015 ;
V_26 = F_58 (
V_1015 ) ;
} else if ( V_4 -> V_10 . V_1014 == 0x1 ) {
V_1012 =
V_1016 ;
V_26 = F_58 (
V_1016 ) ;
...
if ( V_4 -> V_10 . V_277 == 5 ) {
if ( V_1012 [ V_240 ] . V_1020 == V_1000 )
break;
} else {
if ( V_1010 [ V_240 ] . V_1020 == V_1000 )
break;
}
}
if ( V_240 >= V_26 )
...
for ( V_240 = 0 ; V_240 < F_58 ( V_1008 ) ; V_240 ++ )
if ( V_1008 [ V_240 ] . V_1020 == V_1000 )
break;
if ( V_240 >= F_58 ( V_1008 ) )
goto V_1019;
* V_1009 = & V_1008 [ V_240 ] ;
V_357 = V_1008 [ V_240 ] . V_357 ;
}
* V_1001 = V_357 ;
return true ;
V_1019:
...
T_4 F_56 ( struct V_3 * V_4 , T_3 V_1000 )
{
int V_357 ;
const struct V_1002 * V_1003 = NULL ;
const struct V_1004 * V_1005 = NULL ;
const struct V_1006 * V_1007 = NULL ;
const struct V_1008 * V_1009 = NULL ;
if ( V_1000 == 0 )
V_1000 = F_29 ( V_4 -> V_41 ) ;
F_148 ( V_4 , V_1000 , & V_357 , & V_1003 , & V_1005 , & V_1007 , & V_1009 ) ;
if ( F_12 ( V_4 -> V_41 ) )
return V_609 ;
...
const struct V_1004 * V_1031 )
{
const struct V_934 * V_935 = NULL ;
F_48 ( V_4 ,
V_1077 | V_919 ,
V_1031 -> V_1078 ) ;
F_48 ( V_4 , V_1079 | V_919 ,
V_1031 -> V_1080 ) ;
F_48 ( V_4 , V_1081 | V_919 ,
V_1031 -> V_1082 ) ;
F_48 ( V_4 , V_1083 | V_919 ,
V_1031 -> V_1084 ) ;
F_48 ( V_4 , V_1085 | V_919 ,
V_1031 -> V_1086 ) ;
F_48 ( V_4 , V_1087 | V_919 ,
V_1031 -> V_1088 ) ;
F_48 ( V_4 , V_1089 | V_919 ,
V_1031 -> V_1090 ) ;
F_48 ( V_4 , V_1091 | V_919 ,
V_1031 -> V_1092 ) ;
F_48 ( V_4 , V_1093 | V_919 ,
V_1031 -> V_1094 ) ;
F_48 ( V_4 , V_1095 | V_919 ,
V_1031 -> V_1096 ) ;
F_48 ( V_4 , V_1097 | V_919 ,
V_1031 -> V_1098 ) ;
F_48 ( V_4 , V_1099 | V_919 ,
V_1031 -> V_1100 ) ;
F_48 ( V_4 , V_1101 | V_919 ,
V_1031 -> V_1102 ) ;
F_48 ( V_4 , V_1103 | V_919 ,
V_1031 -> V_1104 ) ;
F_48 ( V_4 , V_1105 | V_919 ,
V_1031 -> V_1106 ) ;
F_48 ( V_4 , V_1107 | V_919 ,
V_1031 -> V_1108 ) ;
F_48 ( V_4 , V_1109 | V_919 ,
V_1031 -> V_1110 ) ;
F_48 ( V_4 ,
V_1111 | V_490 ,
V_1031 -> V_1112 ) ;
...
F_48 ( V_4 , V_1135 |
V_919 ,
( T_2 ) V_935 [ 0x49 - 2 ] . V_1136 ) ;
else
F_48 ( V_4 , V_1135 |
V_919 ,
( T_2 ) V_935 [ 0x49 - 2 ] . V_1137 ) ;
...
const struct V_1008 * V_1009 = NULL ;
if ( ! F_148
( V_4 , F_29 ( V_1236 ) , & V_357 , & V_1003 , & V_1005 , & V_1007 , & V_1009 ) )
return;
...
F_153 ( V_4 , V_1003 , V_1007 ) ;
F_154 ( V_4 , V_1236 ,
( V_4 -> V_10 . V_277 == 5 ) ?
( const struct V_1237 * ) & ( V_1007 -> V_1242 ) :
( const struct V_1237 * ) & ( V_1003 -> V_1242 ) ) ;
} else {
F_86 ( V_4 ,
V_959 | V_919 ,
0x4 ,
...
F_151 ( V_4 , V_1005 ) ;
F_154 ( V_4 , V_1236 ,
( const struct V_1237 * ) & ( V_1005 -> V_1242 ) ) ;
}
} else {
F_86 ( V_4 , V_968 , 0x70 ,
( F_28 ( V_1236 ) ? ( 0x02 << 4 )
...
static void F_219 ( struct V_3 * V_4 , T_4 V_1742 )
{
T_2 V_1743 ;
T_2 V_1744 = 0 ;
T_2 V_1745 = 0 ;
...
static void F_220 ( struct V_3 * V_4 , T_4 V_1742 )
{
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) ) {
if ( V_1742 == V_102 ) {
if ( F_28 ( V_4 -> V_41 ) ) {
...
static void F_221 ( struct V_3 * V_4 , T_4 V_1742 )
{
T_4 V_1760 ;
T_2 V_1761 , V_1762 ;
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) )
...
V_1760 = ( V_1742 == V_102 ) ? 1 : 0 ;
V_4 -> V_1546 [ 0 ] = F_3 ( V_4 , 0xa2 ) ;
V_4 -> V_1546 [ 1 ] =
F_3 ( V_4 , ( V_1742 == V_102 ) ? 0xa6 : 0xa7 ) ;
V_4 -> V_1546 [ 2 ] =
F_3 ( V_4 , ( V_1742 == V_102 ) ? 0x8f : 0xa5 ) ;
...
0x29b , ( 0x1 << 0 ) , ( 0 ) << 0 ) ;
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) ) {
F_38 ( V_4 , 0xa2 , ( 0xf << 0 ) , ( 1 << V_1760 ) << 0 ) ;
F_38 ( V_4 , 0xa2 , ( 0xf << 12 ) , ( 1 << ( 1 - V_1742 ) ) << 12 ) ;
} else {
F_38 ( V_4 , 0xa2 , ( 0xf << 12 ) , ( 1 << V_1760 ) << 12 ) ;
F_38 ( V_4 , 0xa2 , ( 0xf << 0 ) , ( 1 << V_1760 ) << 0 ) ;
F_38 ( V_4 , 0xa2 , ( 0xf << 4 ) , ( 1 << V_1742 ) << 4 ) ;
F_38 ( V_4 , 0xa2 , ( 0xf << 8 ) , ( 1 << V_1742 ) << 8 ) ;
}
F_38 ( V_4 , ( ( V_1742 == V_102 ) ? 0xa6 : 0xa7 ) , ( 0x1 << 2 ) , 0 ) ;
F_38 ( V_4 , ( V_1742 == V_102 ) ? 0x8f : 0xa5 ,
( 0x1 << 2 ) , ( 0x1 << 2 ) ) ;
if ( F_23 ( V_4 -> V_10 . V_11 , 7 ) ) {
F_38 ( V_4 , ( ( V_1742 == V_102 ) ? 0xa6 : 0xa7 ) ,
( 0x1 << 0 ) | ( 0x1 << 1 ) , 0 ) ;
F_38 ( V_4 , ( V_1742 == V_102 ) ?
0x8f : 0xa5 ,
...
static void F_222 ( struct V_3 * V_4 , T_4 V_1742 )
{
F_5 ( V_4 , 0xa2 , V_4 -> V_1546 [ 0 ] ) ;
F_5 ( V_4 , ( V_1742 == V_102 ) ? 0xa6 : 0xa7 ,
V_4 -> V_1546 [ 1 ] ) ;
F_5 ( V_4 , ( V_1742 == V_102 ) ? 0x8f : 0xa5 ,
V_4 -> V_1546 [ 2 ] ) ;
...
static void
F_223 ( struct V_3 * V_4 , T_4 V_1742 ,
T_2 * V_1763 , T_4 V_1691 )
{
T_2 V_1485 ;
struct V_1715 V_1716 [ V_1725 ] ;
T_4 V_1760 ;
struct V_792 V_1764 , V_1765 ;
T_1 V_1721 , V_1722 , V_1766 , V_1767 = 0 , V_1768 = 0 ,
V_1769 = 10000 ;
V_109 V_1770 , V_1771 , V_1772 ;
bool V_1773 = false ;
T_4 V_1774 = 3 ;
V_104 V_1775 = 0 , V_1776 = 0 ;
V_104 V_1777 = 3 ;
T_4 V_1778 = V_1779 ;
const struct V_1780 * V_1781 ;
T_2 V_1782 , V_1783 , V_1784 , V_1785 , V_1786 ;
int V_1787 ;
V_104 V_757 ;
T_2 V_1788 [ 2 ] ;
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) )
...
V_1760 = 1 - V_1742 ;
V_1485 = 1024 ;
V_1770 = ( V_1691 == 0 ) ? 13 : 13 ;
F_98 ( V_4 , 0 , & V_1764 ) ;
V_1765 . V_795 = V_1765 . V_694 = V_1765 . V_693 = V_1765 . V_695 = 0x0 ;
F_98 ( V_4 , 1 , & V_1765 ) ;
if ( F_28 ( V_4 -> V_41 ) ) {
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) )
V_1774 = 3 ;
...
do {
V_1782 = ( F_2 ( V_4 -> V_10 . V_11 , 7 ) ) ?
0 : V_1781 [ V_1777 ] . V_1782 ;
V_1783 = V_1781 [ V_1777 ] . V_1783 ;
V_1784 = V_1781 [ V_1777 ] . V_1784 ;
V_1785 = V_1781 [ V_1777 ] . V_1785 ;
V_1786 = V_1781 [ V_1777 ] . V_1786 ;
V_757 = V_1781 [ V_1777 ] . V_757 ;
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) )
F_167 (
V_4 ,
V_1299 ,
...
( V_1785 << 2 ) | V_1786 ) , 0x3 ,
0 ) ;
V_4 -> V_1793 [ V_1760 ] = V_757 ;
if ( V_757 == - 1 ) {
V_1788 [ 0 ] = 0x8ff0 | V_4 -> V_870 ;
V_1788 [ 1 ] = 0x8ff0 | V_4 -> V_870 ;
F_6 ( V_4 , V_304 ,
2 , 0x110 , 16 ,
V_1788 ) ;
} else {
F_88 ( V_4 , V_1760 + 1 , V_757 ,
false ) ;
}
F_73 ( V_4 , ( F_34 ( V_4 -> V_41 ) ) ?
V_1794 :
V_1795 ,
V_1796 , 0 , V_1691 , false ) ;
F_208 ( V_4 , V_1716 , V_1485 , 32 , 0 ) ;
V_1721 = ( V_1716 [ V_1742 ] . V_1721 + V_1485 / 2 ) / V_1485 ;
V_1722 = ( V_1716 [ V_1742 ] . V_1722 + V_1485 / 2 ) / V_1485 ;
V_1766 = V_1721 + V_1722 ;
switch ( V_1778 ) {
case V_1779 :
if ( V_1766 > V_1769 ) {
V_1778 = V_1797 ;
...
V_1782 = V_1781 [ V_1775 ] . V_1782 ;
V_1783 = V_1781 [ V_1775 ] . V_1783 ;
V_1784 = V_1781 [ V_1775 ] . V_1784 ;
V_1785 = V_1781 [ V_1775 ] . V_1785 ;
V_1786 = V_1781 [ V_1775 ] . V_1786 ;
V_757 = V_1781 [ V_1775 ] . V_757 ;
V_1771 = F_216 ( V_1767 ) ;
V_1772 = V_1770 - V_1771 ;
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) ) {
V_1787 = ( int ) V_1783 + V_1772 ;
if ( V_1787 + ( int ) V_1784 > 10 )
V_1783 = 10 - V_1784 ;
else
V_1783 = ( T_2 ) F_83 ( V_1787 , 0 ) ;
F_167 (
V_4 ,
V_1299 ,
( ( V_1783 << 12 ) |
...
V_1782 = ( T_2 ) F_83 ( F_175 ( ( ( int ) V_1782 ) + V_1772 , 10 ) , 0 ) ;
F_66 ( V_4 , ( 0x1 << 12 ) ,
( ( V_1782 << 12 ) |
( V_1783 << 10 ) |
( V_1784 << 8 ) |
...
static void
F_224 ( struct V_3 * V_4 , T_4 V_1742 , T_2 * V_1763 ,
T_4 V_1691 )
{
F_223 ( V_4 , V_1742 , V_1763 , V_1691 ) ;
}
static T_4
F_225 ( struct V_3 * V_4 , T_4 V_1800 , T_4 V_1801 )
{
T_1 V_1802 [ 2 ] = { 9500 , 21000 } ;
T_1 V_1803 [ 2 ] = { 3000 , 6000 } ;
T_1 V_1804 , V_1805 ;
T_1 V_1806 [ 2 ] = { 28606 , 18468 } ;
T_1 V_1807 , V_1808 , V_1809 = 0 ;
T_2 V_1810 = 128 ;
T_2 V_1811 = 128 ;
T_2 V_1812 = 159 ;
T_2 V_1813 ;
...
T_2 V_1822 ;
T_2 V_809 = 4 ;
T_2 V_1823 , V_1824 [ 2 ] = { 2 , 4 } ;
T_2 V_1825 = 7 , V_1826 = 7 ;
V_104 V_1827 ;
T_2 V_1828 , V_1829 = 0 , V_1830 = 0 ;
T_1 V_1831 = 0 , V_1832 = 0 ;
T_2 V_1485 , V_1833 = 10 ;
struct V_1715 V_1716 [ V_1725 ] ;
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) )
return 0 ;
V_1485 = ( 1 << V_1833 ) ;
...
V_1815 = V_490 ;
V_1816 =
( V_1801 == 0 ) ? V_635 : V_636 ;
} else {
V_1815 = V_491 ;
V_1816 =
( V_1801 == 0 ) ? V_636 : V_635 ;
}
V_1813 =
F_53 ( V_4 ,
( V_1834 |
...
( V_1835 |
V_1815 ) ) ;
V_1817 = ( ( F_3 ( V_4 , 0x48 ) >> 8 ) & 1 ) ;
V_1818 [ 0 ] = F_3 ( V_4 , 0x267 ) ;
V_1818 [ 1 ] = F_3 ( V_4 , 0x268 ) ;
V_1818 [ 2 ] = F_3 ( V_4 , 0x269 ) ;
V_1819 [ 0 ] = F_3 ( V_4 , 0x26a ) ;
V_1819 [ 1 ] = F_3 ( V_4 , 0x26b ) ;
V_1818 [ 3 ] = F_3 ( V_4 , 0x26c ) ;
V_1818 [ 4 ] = F_3 ( V_4 , 0x26d ) ;
V_1818 [ 5 ] = F_3 ( V_4 , 0x26e ) ;
V_1819 [ 2 ] = F_3 ( V_4 , 0x26f ) ;
V_1819 [ 3 ] = F_3 ( V_4 , 0x270 ) ;
V_1820 [ 0 ] = F_3 ( V_4 , 0xe7 ) ;
V_1820 [ 1 ] = F_3 ( V_4 , 0xec ) ;
V_1821 [ 0 ] = F_3 ( V_4 , 0xf8 ) ;
V_1821 [ 1 ] = F_3 ( V_4 , 0xfa ) ;
V_1822 = F_3 ( V_4 , ( V_1800 == 0 ) ? 0x7a : 0x7d ) ;
F_48 ( V_4 , ( V_1834 | V_1816 ) ,
V_1811 ) ;
F_48 ( V_4 ,
( V_1835 | V_1815 ) ,
V_1812 ) ;
...
F_37 ( V_4 , ( V_1800 == 0 ) ? 0xe7 : 0xec , ( 0x1 << 8 ) ) ;
F_37 ( V_4 , ( V_1800 == 0 ) ? 0xec : 0xe7 , ( 0x1 << 15 ) ) ;
F_37 ( V_4 , ( V_1800 == 0 ) ? 0xe7 : 0xec , ( 0x1 << 9 ) ) ;
F_37 ( V_4 , ( V_1800 == 0 ) ? 0xe7 : 0xec , ( 0x1 << 10 ) ) ;
F_38 ( V_4 , ( V_1800 == 0 ) ? 0xfa : 0xf8 ,
( 0x7 << 10 ) , ( V_809 << 10 ) ) ;
F_38 ( V_4 , ( V_1800 == 0 ) ? 0xf8 : 0xfa ,
( 0x7 << 0 ) , ( V_1826 << 0 ) ) ;
F_38 ( V_4 , ( V_1800 == 0 ) ? 0xf8 : 0xfa ,
( 0x7 << 4 ) , ( V_1825 << 4 ) ) ;
F_38 ( V_4 , ( V_1800 == 0 ) ? 0x7a : 0x7d ,
( 0x7 << 8 ) , ( V_1823 << 8 ) ) ;
V_1827 = 16 ;
V_1828 = V_1810 + V_1827 ;
while ( V_1827 >= 0 ) {
F_48 ( V_4 ,
( V_812 |
V_1815 ) , V_1828 ) ;
if ( V_1827 == 16 ) {
F_73 ( V_4 , V_1805 , V_1796 ,
0 , 1 , false ) ;
F_67 ( 2 ) ;
F_208 ( V_4 , V_1716 , V_1485 , 32 , 0 ) ;
if ( V_1800 == 0 )
...
( V_1833 + 1 ) ,
1 ) ;
F_73 ( V_4 , V_1804 , V_1796 ,
0 , 1 , false ) ;
F_67 ( 2 ) ;
}
F_208 ( V_4 , V_1716 , V_1485 , 32 , 0 ) ;
if ( V_1800 == 0 )
V_1832 = ( V_1716 [ 0 ] . V_1721 + V_1716 [ 0 ] . V_1722 ) >>
( V_1833 + 1 ) ;
else
V_1832 =
( V_1716 [ 1 ] . V_1721 +
V_1716 [ 1 ] . V_1722 ) >> ( V_1833 + 1 ) ;
V_1808 = ( T_3 ) ( ( V_1832 << 16 ) / V_1831 ) ;
if ( V_1827 == 0 )
V_1827 -- ;
else if ( V_1827 == 1 ) {
V_1829 = V_1828 ;
V_1828 += ( V_1808 > V_1807 ) ? 1 : - 1 ;
V_1809 = V_1808 ;
V_1827 -- ;
} else {
V_1827 = ( V_1827 >> 1 ) ;
V_1828 += ( ( V_1808 > V_1807 ) ?
V_1827 : ( - V_1827 ) ) ;
}
if ( V_1827 == - 1 ) {
V_1830 =
...
( V_1835 | V_1815 ) ,
V_1814 ) ;
F_38 ( V_4 , 0x48 , ( 0x1 << 8 ) , ( V_1817 << 8 ) ) ;
F_5 ( V_4 , 0x267 , V_1818 [ 0 ] ) ;
F_5 ( V_4 , 0x268 , V_1818 [ 1 ] ) ;
F_5 ( V_4 , 0x269 , V_1818 [ 2 ] ) ;
F_5 ( V_4 , 0x26a , V_1819 [ 0 ] ) ;
F_5 ( V_4 , 0x26b , V_1819 [ 1 ] ) ;
F_5 ( V_4 , 0x26c , V_1818 [ 3 ] ) ;
F_5 ( V_4 , 0x26d , V_1818 [ 4 ] ) ;
F_5 ( V_4 , 0x26e , V_1818 [ 5 ] ) ;
F_5 ( V_4 , 0x26f , V_1819 [ 2 ] ) ;
F_5 ( V_4 , 0x270 , V_1819 [ 3 ] ) ;
F_5 ( V_4 , 0xe7 , V_1820 [ 0 ] ) ;
F_5 ( V_4 , 0xec , V_1820 [ 1 ] ) ;
F_5 ( V_4 , 0xf8 , V_1821 [ 0 ] ) ;
F_5 ( V_4 , 0xfa , V_1821 [ 1 ] ) ;
F_5 ( V_4 , ( V_1800 == 0 ) ? 0x7a : 0x7d , V_1822 ) ;
V_4 -> V_811 = false ;
return V_1830 - 0x80 ;
}
...
V_1430 = F_132 (
(struct V_1 * ) V_4 ) ;
for ( V_1742 = 0 ; V_1742 < V_4 -> V_10 . V_261 ; V_1742 ++ ) {
V_1840 =
( ( V_1430 & ( 1 << V_1742 ) ) == 0 ) ? true : false ;
F_221 ( V_4 , V_1742 ) ;
F_219 ( V_4 , V_1742 ) ;
if ( ( ! V_1840 ) && ( ( V_1691 == 0 ) || ( V_1691 == 2 ) ) ) {
F_224 ( V_4 , V_1742 , NULL , 0 ) ;
F_73 ( V_4 ,
( F_34 (
V_4 -> V_41 ) ) ?
V_1794 :
...
F_120 (
(struct V_1 * ) V_4 , 3 ) ;
F_224 ( V_4 , V_1742 , NULL ,
1 ) ;
V_1836 [ V_1742 ] =
F_225 ( V_4 , V_1742 , 1 ) ;
V_4 -> V_813 = V_1836 [ V_1742 ] ;
if ( V_1430 == 1 )
F_120 (
(struct V_1 * ) V_4 ,
V_1430 ) ;
...
for ( V_1742 = 0 ; V_1742 < V_4 -> V_10 . V_261 ; V_1742 ++ ) {
V_1837 =
( ( ( int ) V_1836 [ V_1742 ] - 12 ) >> 1 ) + 10 ;
V_1838 = ( ( int ) V_1836 [ V_1742 ] - 12 ) + 10 ;
if ( F_52 ( V_4 ) ) {
V_1838 +=
( V_4 -> V_292 == V_293 ) ? 24 : 12 ;
V_1839 = ( V_4 -> V_292 == V_293 ) ?
0x0e : 0x13 ;
F_65 ( V_4 , V_662 , V_653 , V_1742 ,
V_1842 , V_1839 ) ;
}
V_1837 = F_83 ( F_198 ( T_4 , V_1837 , 31 ) ,
0 ) ;
...
{
struct V_1715 V_1716 [ V_1725 ] ;
T_4 V_312 , V_1742 , V_1760 ;
T_2 V_1843 [] = { 0x3 , 0x3 , 0x1 } ;
T_2 V_1844 [] = { 0x7 , 0x2 , 0x0 } ;
T_2 V_1845 [] = { 0x2 , 0x0 , 0x0 } ;
V_109 V_1846 , V_1847 , V_1848 , V_1849 ;
V_109 V_1770 , V_1771 , V_1850 ;
T_2 V_1277 , V_1851 , V_1852 ;
T_2 V_1853 , V_1854 ;
T_2 V_1485 ;
T_1 V_1721 , V_1722 , V_1855 [ 3 ] ;
T_4 V_1856 , V_1857 ;
T_2 V_669 , V_1858 , V_1859 ;
T_2 V_1519 ;
T_2 V_1693 [ 2 ] ;
T_2 V_1530 [ 2 ] ;
struct V_1525 V_1694 [ 2 ] ;
...
V_1760 = 1 - V_312 ;
V_1277 = F_3 ( V_4 , 0xa2 ) ;
V_1851 = F_3 ( V_4 , ( V_1742 == V_102 ) ?
0xa6 : 0xa7 ) ;
V_1852 = F_3 ( V_4 , 0xa5 ) ;
V_1853 = F_3 ( V_4 , ( V_1742 == V_102 ) ?
0x91 : 0x92 ) ;
V_1854 = F_3 ( V_4 , ( V_1760 == V_102 ) ?
0x91 : 0x92 ) ;
F_38 ( V_4 , 0xa2 , ( 0xf << 12 ) , ( 1 << V_1760 ) << 12 ) ;
F_38 ( V_4 , 0xa2 , ( 0xf << 0 ) , ( 1 << V_1760 ) << 0 ) ;
F_37 ( V_4 , ( ( V_1742 == V_102 ) ? 0xa6 : 0xa7 ) ,
( ( 0x1 << 1 ) | ( 0x1 << 2 ) ) ) ;
F_37 ( V_4 , 0xa5 , ( ( 0x1 << 1 ) | ( 0x1 << 2 ) ) ) ;
if ( ( ( V_4 -> V_251 ) & 0xff000000 ) )
F_5 ( V_4 ,
( V_1742 == V_102 ) ? 0x91 : 0x92 ,
( F_28 ( V_4 -> V_41 ) ?
0x140 : 0x110 ) ) ;
else
F_5 ( V_4 ,
...
( F_28 ( V_4 -> V_41 ) ?
0x180 : 0x120 ) ) ;
F_5 ( V_4 , ( V_1760 == V_102 ) ? 0x91 : 0x92 ,
( F_28 ( V_4 -> V_41 ) ? 0x148 :
0x114 ) ) ;
V_669 = V_1861 | V_1862 ;
if ( V_1742 == V_102 ) {
...
F_86 ( V_4 , V_1863 , V_669 ,
V_1858 ) ;
F_86 ( V_4 , V_1864 , V_669 ,
V_1859 ) ;
}
for ( V_1856 = 0 ; V_1856 < 4 ; V_1856 ++ ) {
if ( V_752 )
F_96 ( V_1841 ) ;
if ( V_1856 < 3 ) {
V_1849 = V_1843 [ V_1856 ] ;
V_1846 = V_1844 [ V_1856 ] ;
V_1847 = V_1845 [ V_1856 ] ;
} else {
if ( V_1855 [ 1 ] > 10000 ) {
V_1849 = V_1843 [ 2 ] ;
V_1846 = V_1844 [ 2 ] ;
...
V_1850 = V_1770 - V_1771 ;
V_1848 += V_1850 ;
V_1848 = F_83 ( F_198 ( T_2 , V_1848 , 10 ) , 0 ) ;
if ( V_1857 == 1 )
V_1846 = V_1848 ;
else
V_1847 = V_1848 ;
...
V_1485 , 32 ,
0 ) ;
V_1721 = ( V_1716 [ V_1742 ] . V_1721 +
V_1485 / 2 ) / V_1485 ;
V_1722 = ( V_1716 [ V_1742 ] . V_1722 +
V_1485 / 2 ) / V_1485 ;
V_1855 [ V_1856 ] = V_1721 + V_1722 ;
} else {
F_215 ( V_4 ,
( 1 <<
V_1742 ) ) ;
...
F_59 ( V_4 , V_1863 , ~ V_669 ) ;
F_59 ( V_4 , V_1864 , ~ V_669 ) ;
F_5 ( V_4 , ( V_1760 == V_102 ) ? 0x91 :
0x92 , V_1854 ) ;
F_5 ( V_4 , ( V_1742 == V_102 ) ? 0x91 :
0x92 , V_1853 ) ;
F_5 ( V_4 , 0xa5 , V_1852 ) ;
F_5 ( V_4 , ( V_1742 == V_102 ) ? 0xa6 :
0xa7 , V_1851 ) ;
F_5 ( V_4 , 0xa2 , V_1277 ) ;
if ( V_1697 != 0 )
break;
...
T_3 V_321 ;
T_1 V_1865 ;
T_2 V_1866 , V_1867 , V_1557 , V_1868 ;
T_4 V_1869 [ 2 ] , V_536 ;
T_5 V_276 ;
if ( V_4 -> V_241 )
F_32 ( V_4 , true ) ;
if ( V_4 -> V_61 -> V_69 < 4 ) {
V_1869 [ 0 ] = V_1869 [ 1 ] = 72 ;
} else {
V_536 = F_56 ( V_4 , 0 ) ;
switch ( V_536 ) {
case V_609 :
...
break;
default:
V_1869 [ 0 ] = V_1869 [ 1 ] = 91 ;
break;
}
}
if ( F_2 ( V_4 -> V_10 . V_11 , 7 ) )
V_1869 [ 0 ] = V_1869 [ 1 ] = 30 ;
else if ( F_2 ( V_4 -> V_10 . V_11 , 3 ) )
V_1869 [ 0 ] = V_1869 [ 1 ] = 40 ;
if ( F_23 ( V_4 -> V_10 . V_11 , 7 ) ) {
if ( ( V_1869 [ 0 ] < 40 ) || ( V_1869 [ 0 ] > 100 ) ||
( V_1869 [ 1 ] < 40 ) || ( V_1869 [ 1 ] > 100 ) )
V_1869 [ 0 ] = V_1869 [ 1 ] = 91 ;
}
V_4 -> V_262 [ V_102 ] . V_878 = V_1869 [ 0 ] ;
V_4 -> V_262 [ V_106 ] . V_878 = V_1869 [ 1 ] ;
V_4 -> V_262 [ V_102 ] . V_1870 = V_1869 [ 0 ] ;
V_4 -> V_262 [ V_106 ] . V_1870 = V_1869 [ 1 ] ;
for ( V_321 = 0 ; V_321 < V_4 -> V_10 . V_261 ; V_321 ++ ) {
T_3 V_1516 = V_4 -> V_10 . V_11 ;
if ( F_2 ( V_1516 , 3 ) ) {
if ( F_52 ( V_4 ) ) {
...
V_1865 = V_873 [ V_1869 [ V_321 ] ] ;
}
if ( F_2 ( V_1516 , 3 ) )
V_1866 = ( V_1865 >> 16 ) & ( ( 1 << ( 32 - 16 + 1 ) ) - 1 ) ;
else
V_1866 = ( V_1865 >> 16 ) & ( ( 1 << ( 28 - 16 + 1 ) ) - 1 ) ;
if ( F_2 ( V_1516 , 7 ) )
V_1867 = ( V_1865 >> 8 ) & ( ( 1 << ( 10 - 8 + 1 ) ) - 1 ) ;
else
V_1867 = ( V_1865 >> 8 ) & ( ( 1 << ( 13 - 8 + 1 ) ) - 1 ) ;
V_1557 = ( V_1865 >> 0 ) & ( ( 1 << ( 7 - 0 + 1 ) ) - 1 ) ;
if ( F_2 ( V_1516 , 3 ) )
F_38 ( V_4 , ( ( V_321 == V_102 ) ? 0x8f :
0xa5 ) , ( 0x1 << 8 ) , ( 0x1 << 8 ) ) ;
else
F_38 ( V_4 , 0xa5 , ( 0x1 << 14 ) , ( 0x1 << 14 ) ) ;
F_5 ( V_4 , ( V_321 == V_102 ) ? 0xaa : 0xab , V_1867 ) ;
F_6 ( V_4 , 7 , 1 , ( 0x110 + V_321 ) , 16 ,
& V_1866 ) ;
F_8 ( V_4 , 15 , 1 , 87 , 16 , & V_1868 ) ;
V_1868 &= ( ( V_321 == V_102 ) ? 0x00ff : 0xff00 ) ;
V_1868 |= ( ( V_321 == V_102 ) ? ( V_1557 << 8 ) : ( V_1557 << 0 ) ) ;
F_6 ( V_4 , 15 , 1 , 87 , 16 , & V_1868 ) ;
if ( F_52 ( V_4 ) ) {
F_8 ( V_4 ,
( V_321 ==
V_102 ?
...
static void
F_229 ( T_4 * V_1872 , T_2 * V_1873 ,
T_4 V_1874 , T_4 V_1875 ,
T_4 V_1876 )
{
T_4 V_1877 ;
T_4 V_1878 , V_1879 ;
T_4 V_1880 ;
for ( V_1877 = V_1875 ; V_1877 <= V_1876 ; V_1877 ++ ) {
V_1878 = ( V_1877 - V_1875 ) >> 2 ;
V_1879 = ( V_1877 - V_1875 ) & 0x3 ;
V_1880 = ( V_1873 [ V_1878 ] >> 4 * V_1879 ) & 0xf ;
V_1872 [ V_1877 ] = V_1874 - 2 * V_1880 ;
}
}
static void
F_230 ( T_4 * V_1872 , T_4 V_1873 ,
T_4 V_1875 , T_4 V_1876 )
{
T_4 V_1877 ;
for ( V_1877 = V_1875 ; V_1877 <= V_1876 ; V_1877 ++ )
V_1872 [ V_1877 ] -= 2 * V_1873 ;
}
void
F_231 ( T_4 * V_1881 , T_4 V_1882 ,
T_4 V_1883 , T_4 V_1884 )
{
T_4 V_1885 , V_1886 ;
V_1886 = V_1884 ;
for ( V_1885 = V_1882 ; V_1885 <= V_1883 - 1 ; V_1885 ++ ) {
V_1881 [ V_1885 ] = V_1881 [ V_1886 ] ;
V_1886 += ( V_1885 == V_1882 ) ? 2 : 1 ;
}
V_1881 [ V_1883 ] = V_1881 [ V_1883 - 1 ] ;
}
void
F_232 ( T_4 * V_1881 , T_4 V_1884 ,
T_4 V_1887 , T_4 V_1882 )
{
T_4 V_1885 , V_1886 ;
for ( V_1885 = V_1884 , V_1886 = V_1882 ;
V_1885 <= V_1887 ; V_1885 ++ , V_1886 ++ ) {
V_1881 [ V_1885 ] = V_1881 [ V_1886 ] ;
if ( V_1885 == V_1884 )
V_1881 [ ++ V_1885 ] = V_1881 [ V_1886 ] ;
}
...
{
T_3 V_1885 , V_1886 , V_75 ;
T_4 V_1888 = 0 , V_1889 = 0 , V_1890 = 0 ;
T_4 V_1874 = 0 ;
T_2 V_1891 [ 2 ] , * V_1892 = NULL ;
T_4 * V_1893 = NULL ;
for ( V_75 = 0 ; V_75 < ( V_99 + V_100 ) ;
V_75 ++ ) {
switch ( V_75 ) {
case 0 :
V_1874 = F_175 ( V_4 -> V_101 [ 0 ] . V_103 ,
V_4 -> V_101 [ 1 ] . V_103 ) ;
V_1891 [ 0 ] = V_4 -> V_121 ;
F_229 ( V_4 -> V_1894 ,
V_1891 ,
...
break;
case 1 :
V_1874 = F_175 ( V_4 -> V_101 [ 0 ] . V_134 ,
V_4 -> V_101 [ 1 ] . V_134 ) ;
V_1891 [ 0 ] = ( T_2 ) ( V_4 -> V_149 & 0xffff ) ;
V_1891 [ 1 ] =
...
break;
case 2 :
V_1874 = F_175 ( V_4 -> V_101 [ 0 ] . V_160 ,
V_4 -> V_101 [ 1 ] . V_160 ) ;
V_1891 [ 0 ] = ( T_2 ) ( V_4 -> V_173 & 0xffff ) ;
V_1891 [ 1 ] =
...
break;
case 3 :
V_1874 = F_175 ( V_4 -> V_101 [ 0 ] . V_184 ,
V_4 -> V_101 [ 1 ] . V_184 ) ;
V_1891 [ 0 ] = ( T_2 ) ( V_4 -> V_197 & 0xffff ) ;
V_1891 [ 1 ] =
...
T_2 V_1914 [ 2 ] ;
if ( F_233 ( V_4 ) ) {
V_1914 [ 0 ] = F_190 ( V_4 , V_102 ) ;
V_1914 [ 1 ] = F_190 ( V_4 , V_106 ) ;
V_1564 = ( V_1914 [ 0 ] << 8 ) | V_1914 [ 1 ] ;
} else {
...
void F_118 ( struct V_3 * V_4 , T_4 V_1915 )
{
T_2 V_669 = 0 , V_13 = 0 , V_1916 = 0 ;
T_4 V_299 ;
T_3 V_321 ;
T_1 V_27 ;
T_1 V_26 ;
...
if ( F_23 ( V_4 -> V_10 . V_11 , 2 ) &&
V_4 -> V_292 == V_293 )
F_57 ( V_4 -> V_61 -> V_78 , V_1918 , V_1919 ,
V_1919 , V_641 ) ;
} else {
F_6 ( V_4 , V_709 , 84 , 64 ,
8 , V_4 -> V_681 ) ;
F_6 ( V_4 , V_710 , 84 , 64 ,
8 , V_4 -> V_681 ) ;
V_1916 = ( V_1915 == V_64 ) ? 0x1 : 0x0 ;
V_669 = ( 0x1 << 14 ) | ( 0x1 << 13 ) ;
V_13 = ( V_1916 << 14 ) | ( V_1916 << 13 ) ;
if ( F_2 ( V_4 -> V_10 . V_11 , 3 ) ) {
V_669 |= ( 0x1 << 15 ) ;
V_13 |= ( V_1916 << 15 ) ;
}
...
F_8 ( V_4 , 15 , 1 , 87 , 16 ,
& V_1927 ) ;
V_1927 >>= ( ( V_321 == V_102 ) ? 8 : 0 ) ;
V_1927 &= 0xff ;
V_4 -> V_262 [ V_321 ] . V_1557 = ( T_4 ) V_1927 ;
F_8 ( V_4 , 15 , 2 ,
( 80 + 2 * V_321 ) , 16 ,
& V_4 ->
V_262 [ V_321 ] .
...
( V_1923 + V_757 ) , 32 ,
& V_799 ) ;
V_1925 = ( V_799 >> 10 ) & ( ( 1 << ( 19 - 10 + 1 ) ) - 1 ) ;
V_1926 = ( V_799 >> 0 ) & ( ( 1 << ( 9 - 0 + 1 ) ) - 1 ) ;
if ( V_1920 ) {
V_325 [ 0 ] = ( T_2 ) V_1925 ;
V_325 [ 1 ] = ( T_2 ) V_1926 ;
F_6 ( V_4 , 15 , 2 ,
...
void
F_236 ( struct V_3 * V_4 , T_3 V_1020 , T_4 * V_1930 ,
T_4 V_1931 )
{
T_4 V_536 ;
...
switch ( V_536 ) {
case V_609 :
* V_1930 = V_4 -> V_1894 [ V_1931 ] ;
break;
case V_617 :
* V_1930 = V_4 -> V_1895 [ V_1931 ] ;
break;
case V_616 :
* V_1930 = V_4 -> V_1896 [ V_1931 ] ;
break;
case V_618 :
* V_1930 = V_4 -> V_1897 [ V_1931 ] ;
break;
default:
* V_1930 = V_4 -> V_1894 [ V_1931 ] ;
break;
...
void F_32 ( struct V_3 * V_4 , bool V_1932 )
{
T_2 V_1399 [] = { 0xffff , 0xffff } ;
if ( V_1932 ) {
if ( V_4 -> V_857 == 0 ) {
...
void F_237 ( struct V_3 * V_4 , bool V_1934 )
{
F_130 ( V_4 -> V_61 -> V_78 ) ;
if ( V_1934 ) {
if ( V_4 -> V_857 == 0 )
