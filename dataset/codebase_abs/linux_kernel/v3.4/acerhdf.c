...
if ( V_32 == V_34 && V_20 )
F_14 () ;
else if ( V_32 == V_33 && ! V_20 )
F_15 () ;
return 0 ;
}
static int F_19 ( struct V_16 * V_17 , int V_35 ,
enum V_36 * type )
{
if ( V_35 == 0 )
* type = V_37 ;
...
static int F_20 ( struct V_16 * V_17 , int V_35 ,
unsigned long * V_1 )
{
if ( V_35 == 0 )
* V_1 = V_18 ;
...
static int T_2 F_26 ( struct V_47 * V_45 )
{
return 0 ;
}
static int F_27 ( struct V_47 * V_45 )
{
return 0 ;
}
static int F_28 ( const char * V_48 , const char * V_49 )
{
unsigned long V_50 = 0 , V_51 = 0 ;
V_50 = strlen ( V_48 ) ;
V_51 = strlen ( V_49 ) ;
if ( V_50 >= V_51 &&
! strncmp ( V_48 , V_49 , V_51 ) )
return 1 ;
return 0 ;
}
static int F_29 ( void )
{
char const * V_52 , * V_53 , * V_54 ;
...
F_31 ( L_21 ,
V_52 , V_53 , V_54 ) ;
for ( V_56 = V_63 ; V_56 -> V_52 [ 0 ] ; V_56 ++ ) {
if ( F_28 ( V_52 , V_56 -> V_52 ) &&
F_28 ( V_54 , V_56 -> V_54 ) &&
F_28 ( V_53 , V_56 -> V_53 ) ) {
V_3 = V_56 ;
break;
