...
if ( ! F_19 ( & V_32 -> V_25 ) )
return - V_134 ;
F_79 ( V_32 -> V_26 -> V_53 -> V_135 ) ;
return 0 ;
}
void F_80 ( struct V_23 * V_32 )
{
#ifdef F_81
struct V_135 * V_135 = V_32 -> V_26 -> V_53 -> V_135 ;
if ( V_135 && F_82 ( V_135 ) != 0 )
F_83 ( V_135 ) ;
#endif
F_22 ( & V_32 -> V_25 ) ;
}
...
struct V_23 * V_136 )
{
struct V_137 * V_20 = ( V_136 ? & V_136 -> V_138 : & V_13 -> V_139 ) ;
struct V_23 * V_19 = NULL ;
unsigned long V_16 ;
F_12 ( V_13 -> V_140 , V_16 ) ;
while ( V_20 -> V_19 != & V_13 -> V_139 ) {
V_19 = F_15 ( V_20 -> V_19 , struct V_23 , V_138 ) ;
if ( ! F_78 ( V_19 ) )
break;
V_19 = NULL ;
V_20 = V_20 -> V_19 ;
}
F_17 ( V_13 -> V_140 , V_16 ) ;
if ( V_136 )
F_80 ( V_136 ) ;
return V_19 ;
}
void F_85 ( struct V_95 * V_96 , void * V_141 ,
void (* F_86)( struct V_23 * , void * ) )
{
struct V_12 * V_13 = F_87 ( V_96 -> V_24 . V_142 ) ;
struct V_23 * V_32 ;
F_88 (sdev, shost) {
if ( ( V_32 -> V_143 == V_96 -> V_143 ) &&
( V_32 -> V_144 == V_96 -> V_144 ) )
F_86 ( V_32 , V_141 ) ;
}
}
void F_89 ( struct V_95 * V_96 , void * V_141 ,
void (* F_86)( struct V_23 * , void * ) )
{
struct V_12 * V_13 = F_87 ( V_96 -> V_24 . V_142 ) ;
struct V_23 * V_32 ;
...
struct V_23 * F_91 ( struct V_95 * V_96 ,
T_3 V_81 )
{
struct V_23 * V_32 ;
...
struct V_23 * F_93 ( struct V_95 * V_96 ,
T_3 V_81 )
{
struct V_23 * V_32 ;
struct V_12 * V_13 = F_87 ( V_96 -> V_24 . V_142 ) ;
...
T_3 V_143 , T_3 V_144 , T_3 V_81 )
{
struct V_23 * V_32 ;
F_92 (sdev, &shost->__devices, siblings) {
if ( V_32 -> V_143 == V_143 && V_32 -> V_144 == V_144 &&
V_32 -> V_81 == V_81 )
return V_32 ;
}
return NULL ;
...
unsigned long V_16 ;
F_12 ( V_13 -> V_140 , V_16 ) ;
V_32 = F_94 ( V_13 , V_143 , V_144 , V_81 ) ;
if ( V_32 && F_78 ( V_32 ) )
V_32 = NULL ;
F_17 ( V_13 -> V_140 , V_16 ) ;
return V_32 ;
