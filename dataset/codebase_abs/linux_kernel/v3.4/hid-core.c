...
static const struct V_170 * F_76 ( struct V_2 * V_169 ,
struct V_141 * V_142 )
{
struct V_210 * V_211 ;
F_70 ( & V_142 -> V_215 ) ;
...
static int F_78 ( struct V_3 * V_106 , struct V_208 * V_209 )
{
struct V_141 * V_142 = F_23 ( V_209 , struct V_141 , V_130 ) ;
struct V_2 * V_169 = F_23 ( V_106 , struct V_2 , V_106 ) ;
if ( ( V_169 -> V_185 & V_193 ) &&
! strncmp ( V_142 -> V_144 , L_54 , 14 ) )
return 1 ;
if ( ! F_76 ( V_169 , V_142 ) )
return 0 ;
if ( ! strncmp ( V_142 -> V_144 , L_55 , 8 ) && ! V_218 )
return ! F_56 ( V_169 , V_219 ) ;
return 1 ;
}
...
V_169 -> V_130 = V_142 ;
if ( V_142 -> V_221 ) {
V_97 = V_142 -> V_221 ( V_169 , V_4 ) ;
} else {
V_97 = F_81 ( V_169 ) ;
if ( ! V_97 )
V_97 = F_82 ( V_169 , V_222 ) ;
}
if ( V_97 )
V_169 -> V_130 = NULL ;
}
...
static int F_83 ( struct V_3 * V_106 )
{
struct V_2 * V_169 = F_23 ( V_106 , struct V_2 , V_106 ) ;
struct V_141 * V_142 ;
if ( F_80 ( & V_169 -> V_163 ) )
...
static int F_85 ( struct V_3 * V_106 , struct V_223 * V_224 )
{
struct V_2 * V_169 = F_23 ( V_106 , struct V_2 , V_106 ) ;
if ( F_86 ( V_224 , L_56 ,
V_169 -> V_171 , V_169 -> V_172 , V_169 -> V_173 ) )
return - V_214 ;
if ( F_86 ( V_224 , L_57 , V_169 -> V_144 ) )
return - V_214 ;
if ( F_86 ( V_224 , L_58 , V_169 -> V_206 ) )
return - V_214 ;
if ( F_86 ( V_224 , L_59 , V_169 -> V_225 ) )
return - V_214 ;
if ( F_86 ( V_224 , L_60 ,
V_169 -> V_171 , V_169 -> V_172 , V_169 -> V_173 ) )
return - V_214 ;
...
static bool F_87 ( struct V_2 * V_169 )
{
switch ( V_169 -> V_172 ) {
case V_226 :
if ( V_169 -> V_173 >= V_227 &&
V_169 -> V_173 <= V_228 )
return true ;
break;
case V_229 :
if ( V_169 -> V_173 >= V_230 &&
V_169 -> V_173 <= V_231 )
return true ;
if ( V_169 -> V_173 == V_232 &&
! strcmp ( V_169 -> V_144 , L_61 ) )
return true ;
break;
case V_233 :
if ( V_169 -> V_173 >= V_234 &&
V_169 -> V_173 <= V_235 )
return true ;
break;
case V_236 :
if ( V_169 -> V_173 >= V_237 &&
V_169 -> V_173 <= V_238 )
return true ;
break;
case V_239 :
if ( V_169 -> V_173 == V_240 &&
V_169 -> type == V_241 )
return true ;
break;
}
...
F_56 ( V_169 , V_243 ) )
return true ;
return ! ! F_56 ( V_169 , V_244 ) ;
}
int F_88 ( struct V_2 * V_169 )
{
static T_8 V_4 = F_89 ( 0 ) ;
int V_97 ;
if ( F_35 ( V_169 -> V_245 & V_246 ) )
return - V_164 ;
if ( ! ( V_169 -> V_185 & V_247 )
&& ( F_87 ( V_169 ) || ( V_169 -> V_185 & V_248 ) ) )
return - V_162 ;
F_90 ( & V_169 -> V_106 , L_62 , V_169 -> V_171 ,
V_169 -> V_172 , V_169 -> V_173 , F_91 ( & V_4 ) ) ;
F_92 ( V_169 , F_93 ( & V_169 -> V_106 ) ) ;
V_97 = F_94 ( & V_169 -> V_106 ) ;
if ( ! V_97 )
V_169 -> V_245 |= V_246 ;
else
F_95 ( V_169 ) ;
...
return F_97 ( V_97 ) ;
F_98 ( & V_169 -> V_106 ) ;
V_169 -> V_106 . V_249 = F_22 ;
V_169 -> V_106 . V_171 = & V_250 ;
V_169 -> V_28 = F_99 ( V_251 ,
sizeof( struct V_27 ) , V_9 ) ;
if ( V_169 -> V_28 == NULL )
goto V_252;
V_169 -> V_33 = V_251 ;
for ( V_45 = 0 ; V_45 < V_107 ; V_45 ++ )
F_100 ( & V_169 -> V_6 [ V_45 ] . V_13 ) ;
F_101 ( & V_169 -> V_253 ) ;
F_100 ( & V_169 -> V_254 ) ;
F_102 ( & V_169 -> V_163 , 1 ) ;
return V_169 ;
...
static void F_104 ( struct V_2 * V_169 )
{
if ( V_169 -> V_245 & V_246 ) {
F_105 ( & V_169 -> V_106 ) ;
F_95 ( V_169 ) ;
V_169 -> V_245 &= ~ V_246 ;
}
}
void F_106 ( struct V_2 * V_169 )
{
F_104 ( V_169 ) ;
F_103 ( & V_169 -> V_106 ) ;
}
int F_107 ( struct V_141 * V_142 , struct V_255 * V_256 ,
const char * V_257 )
{
int V_97 ;
V_142 -> V_130 . V_144 = V_142 -> V_144 ;
V_142 -> V_130 . V_171 = & V_250 ;
V_142 -> V_130 . V_256 = V_256 ;
V_142 -> V_130 . V_257 = V_257 ;
F_100 ( & V_142 -> V_216 ) ;
F_108 ( & V_142 -> V_215 ) ;
V_97 = F_109 ( & V_142 -> V_130 ) ;
if ( V_97 )
return V_97 ;
V_97 = F_110 ( & V_142 -> V_130 , & V_258 ) ;
if ( V_97 )
F_111 ( & V_142 -> V_130 ) ;
return V_97 ;
}
...
{
F_113 ( & V_142 -> V_130 , & V_258 ) ;
F_111 ( & V_142 -> V_130 ) ;
F_73 ( V_142 ) ;
}
int F_114 ( struct V_2 * V_58 )
{
struct V_259 * V_260 ;
int V_45 ;
if ( ! ( V_58 -> V_145 & V_146 ) )
...
for ( V_45 = 0 ; V_45 < F_115 ( V_261 ) ; V_45 ++ )
if ( V_260 -> V_262 -> V_263 [ V_45 ] )
return 1 ;
}
return 0 ;
}
