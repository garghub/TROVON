...
int V_38 , int V_92 , const char * V_93 )
{
unsigned long V_94 ;
...
if ( V_92 >= V_15 -> V_22 [ V_38 ] . V_13 || V_92 < 0 ) {
F_49 ( V_15 , V_88 ,
L_41
L_39 , V_92 ,
V_15 -> V_22 [ V_38 ] . V_13 ) ;
...
L_43 ,
V_89 , V_90 ,
V_15 -> V_22 [ V_38 ] . V_95 , V_91 , V_38 , V_92 ,
V_15 -> V_22 [ V_38 ] . V_14 [ V_92 ] . V_5 , V_93 ) ;
V_15 -> V_4 ++ ;
V_15 -> V_22 [ V_38 ] . V_4 ++ ;
V_15 -> V_22 [ V_38 ] . V_14 [ V_92 ] . V_4 ++ ;
if ( V_15 -> V_96 & V_97 ) {
V_94 = V_15 -> V_98 ?
V_15 -> V_98 ( V_15 , V_89 ) :
V_89 ;
...
void F_63 ( struct V_16 * V_15 , const char * V_93 )
{
if ( F_64 () )
F_49 ( V_15 , V_73 ,
L_44 , V_93 ) ;
...
unsigned long V_89 ,
unsigned long V_90 , int V_38 , const char * V_93 )
{
int V_100 = V_101 * 4 ;
char V_102 [ V_100 + 1 ] ;
char * V_103 = V_102 ;
...
V_104 = snprintf ( V_103 , V_100 + 1 , L_45 ,
V_15 -> V_22 [ V_38 ] . V_14 [ 0 ] . V_5 ) ;
V_100 -= V_104 ;
V_103 += V_104 ;
for ( V_2 = 1 ; ( V_2 < V_15 -> V_22 [ V_38 ] . V_13 ) && ( V_100 > 0 ) ;
V_2 ++ ) {
V_104 = snprintf ( V_103 , V_100 + 1 , L_46 ,
...
L_47
L_48 , V_89 ,
V_90 , V_15 -> V_22 [ V_38 ] . V_95 , V_38 ,
V_102 , V_93 ) ;
if ( F_68 () )
F_69 ( L_49
L_50 , V_15 -> V_42 ,
V_89 , V_90 ,
V_15 -> V_22 [ V_38 ] . V_95 , V_38 , V_102 , V_93 ) ;
V_15 -> V_106 ++ ;
V_15 -> V_22 [ V_38 ] . V_106 ++ ;
}
void F_66 ( struct V_16 * V_15 , const char * V_93 )
{
if ( F_68 () )
F_69 ( L_51 , V_15 -> V_42 ) ;
if ( F_67 () )
...
if ( V_108 >= V_15 -> V_22 [ V_6 ] . V_13 ) {
F_49 ( V_15 , V_88 ,
L_54
L_39 ,
V_108 , V_15 -> V_22 [ V_6 ] . V_13 ) ;
F_66 ( V_15 , L_40 ) ;
return;
}
...
V_15 -> V_22 [ V_6 ] . V_106 ++ ;
V_104 = snprintf ( V_103 , V_100 + 1 , L_45 ,
V_15 -> V_22 [ V_6 ] . V_14 [ V_108 ] . V_5 ) ;
V_100 -= V_104 ;
V_103 += V_104 ;
V_104 = snprintf ( V_103 , V_100 + 1 , L_56 ,
V_15 -> V_22 [ V_6 ] . V_14 [ V_109 ] . V_5 ) ;
if ( F_67 () )
F_49 ( V_15 , V_105 ,
L_57
L_48 , V_6 , V_108 , V_109 ,
V_102 , V_93 ) ;
if ( F_68 () )
F_69 ( L_57
L_48 , V_6 , V_108 ,
...
unsigned int V_6 , unsigned int V_92 , char * V_93 )
{
if ( V_6 >= V_15 -> V_21 ) {
F_49 ( V_15 , V_88 ,
L_53 ,
...
if ( V_92 >= V_15 -> V_22 [ V_6 ] . V_13 ) {
F_49 ( V_15 , V_88 ,
L_58 ,
V_92 , V_15 -> V_22 [ V_6 ] . V_13 ) ;
F_63 ( V_15 , L_40 ) ;
return;
}
if ( F_64 () )
...
L_59 ,
V_6 , V_92 ,
V_15 -> V_22 [ V_6 ] . V_14 [ V_92 ] . V_5 , V_93 ) ;
V_15 -> V_4 ++ ;
V_15 -> V_22 [ V_6 ] . V_4 ++ ;
V_15 -> V_22 [ V_6 ] . V_14 [ V_92 ] . V_4 ++ ;
}
