...
struct V_26 * V_7 = V_113 -> V_7 ;
struct V_43 * V_44 = F_14 ( V_7 ) ;
int V_115 = F_20 ( V_110 ) ;
int V_116 = 0 ;
int V_117 ;
int V_118 ;
if ( ! V_44 -> V_72 ) {
F_17 ( V_7 -> V_85 , L_3 , V_119 ) ;
return - V_120 ;
}
...
static int F_23 ( struct V_139 * V_85 )
{
struct V_140 * V_141 = F_24 ( V_85 ) ;
return V_141 -> V_142 ;
}
static int F_25 ( struct V_139 * V_85 )
{
struct V_140 * V_141 = F_24 ( V_85 ) ;
struct V_26 * V_7 = (struct V_26 * ) V_141 -> V_143 ;
int V_27 ;
if ( F_23 ( V_85 ) )
return 0 ;
V_27 = ( 1600 - V_141 -> V_144 / 1000 ) / 50 ;
V_27 = F_9 ( V_27 , 0x0 , 0xf ) ;
V_141 -> V_144 = ( 1600 - V_27 * 50 ) * 1000 ;
F_2 ( V_7 , V_145 ,
V_146 , V_27 ) ;
F_2 ( V_7 , V_14 ,
V_147 ,
...
static int F_26 ( struct V_139 * V_85 )
{
struct V_140 * V_141 = F_24 ( V_85 ) ;
struct V_26 * V_7 = (struct V_26 * ) V_141 -> V_143 ;
F_2 ( V_7 , V_14 ,
...
static int F_27 ( struct V_139 * V_85 )
{
struct V_140 * V_141 = F_24 ( V_85 ) ;
return V_141 -> V_144 ;
}
...
struct V_140 * V_141 ;
struct V_43 * V_44 = F_14 ( V_7 ) ;
V_141 = F_29 ( sizeof( struct V_140 ) , V_151 ) ;
if ( ! V_141 ) {
F_17 ( V_7 -> V_85 , L_4 ) ;
return - V_152 ;
}
V_141 -> V_153 . V_154 = F_30 ( F_31 ( V_7 -> V_85 ) , V_151 ) ;
if ( ! V_141 -> V_153 . V_154 ) {
F_32 ( V_141 ) ;
F_17 ( V_7 -> V_85 , L_5 ) ;
return - V_152 ;
}
V_141 -> V_153 . type = V_155 ;
V_141 -> V_153 . V_156 = V_157 ;
V_141 -> V_153 . V_158 = & V_159 ;
V_141 -> V_153 . V_160 = 1 ;
V_141 -> V_143 = V_7 ;
V_141 -> V_144 = V_144 ;
V_141 -> V_85 = F_33 ( & V_141 -> V_153 , V_7 -> V_85 ,
V_150 , V_141 , NULL ) ;
if ( F_34 ( V_141 -> V_85 ) ) {
int V_118 = F_35 ( V_141 -> V_85 ) ;
F_17 ( V_7 -> V_85 , L_6 ) ;
F_32 ( V_141 -> V_153 . V_154 ) ;
F_32 ( V_141 ) ;
return V_118 ;
}
V_44 -> V_141 = V_141 ;
...
V_118 = F_50 ( V_7 -> V_85 , F_40 ( V_44 -> V_169 ) ,
V_44 -> V_169 ) ;
if ( V_118 ) {
F_36 ( V_7 ) ;
F_17 ( V_7 -> V_85 , L_11 , V_118 ) ;
return V_118 ;
}
F_51 ( V_7 -> V_85 , L_12 ) ;
return 0 ;
...
int V_118 ;
struct V_43 * V_44 = F_14 ( V_7 ) ;
V_118 = F_55 ( V_7 , 16 , 16 , V_224 ) ;
if ( V_118 < 0 ) {
F_17 ( V_7 -> V_85 , L_15 , V_118 ) ;
return V_118 ;
}
V_118 = F_52 ( V_7 ) ;
if ( V_118 )
...
static int F_57 ( struct V_26 * V_7 )
{
struct V_43 * V_44 = F_14 ( V_7 ) ;
F_38 ( V_7 , V_168 ) ;
F_42 ( F_40 ( V_44 -> V_169 ) ,
...
static T_3 int F_58 ( struct V_239 * V_240 ,
const struct V_241 * V_242 )
{
struct V_43 * V_44 ;
int V_118 ;
V_44 = F_59 ( & V_240 -> V_85 , sizeof( struct V_43 ) ,
V_151 ) ;
if ( ! V_44 )
return - V_152 ;
F_60 ( V_240 , V_44 ) ;
V_118 = F_61 ( & V_240 -> V_85 ,
& V_243 , & V_244 , 1 ) ;
return V_118 ;
}
static T_4 int F_62 ( struct V_239 * V_240 )
{
F_63 ( & V_240 -> V_85 ) ;
return 0 ;
}
