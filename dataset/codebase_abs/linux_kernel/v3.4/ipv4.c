...
T_2 V_122 , T_2 V_56 )
{
return F_46 ( V_122 , V_56 , V_79 -> V_90 , V_42 , V_79 -> V_123 ) ;
}
...
if ( F_52 ( V_2 ) )
goto V_129;
V_128 = F_53 ( V_2 , V_113 , V_79 ) ;
if ( V_128 == NULL )
goto V_130;
V_127 = F_2 ( V_128 ) ;
V_126 = F_54 ( V_113 ) ;
V_127 -> V_50 = V_126 -> V_131 ;
V_127 -> V_48 = V_126 -> V_132 ;
V_127 -> V_40 = V_126 -> V_132 ;
V_127 -> V_22 = V_126 -> V_31 ;
V_126 -> V_31 = NULL ;
V_127 -> V_133 = F_30 ( V_79 ) ;
V_127 -> V_134 = F_50 ( V_79 ) -> V_135 ;
V_127 -> V_58 = V_59 ;
if ( V_56 == NULL && ( V_56 = F_55 ( V_2 , V_128 , V_113 ) ) == NULL )
goto V_136;
F_15 ( V_128 , V_56 ) ;
F_22 ( V_128 , F_20 ( V_56 ) ) ;
if ( F_56 ( V_2 , V_128 ) < 0 )
goto V_136;
F_57 ( V_128 , NULL ) ;
return V_128 ;
...
const struct V_63 * V_64 = F_50 ( V_79 ) ;
struct V_16 V_17 = {
. V_140 = F_64 ( V_79 ) -> V_141 ,
. V_14 = V_64 -> V_47 ,
. V_47 = V_64 -> V_14 ,
. V_142 = F_7 ( V_2 ) ,
. V_143 = V_2 -> V_144 ,
. V_145 = V_84 ( V_79 ) -> V_93 ,
. V_146 = V_84 ( V_79 ) -> V_94 ,
} ;
F_65 ( V_79 , F_66 ( & V_17 ) ) ;
...
if ( V_79 != NULL ) {
const struct V_125 * V_126 = F_54 ( V_113 ) ;
struct V_84 * V_85 = V_84 ( V_79 ) ;
V_85 -> V_124 = F_45 ( V_79 , V_126 -> V_132 ,
V_126 -> V_131 ) ;
V_20 = F_72 ( V_79 , V_2 , V_126 -> V_132 ,
V_126 -> V_131 ,
V_126 -> V_31 ) ;
V_20 = F_73 ( V_20 ) ;
}
...
static void F_74 ( struct V_1 * V_2 , struct V_78 * V_150 )
{
int V_20 ;
const struct V_63 * V_151 ;
struct V_78 * V_79 ;
struct V_66 * V_56 ;
struct V_88 * V_88 = F_26 ( F_75 ( V_150 ) -> V_89 ) ;
struct V_1 * V_152 = V_88 -> V_153 . V_154 ;
if ( V_84 ( V_150 ) -> V_155 == V_156 )
return;
if ( F_64 ( V_150 ) -> V_157 != V_158 )
return;
V_56 = F_63 ( V_88 , V_152 , V_150 ) ;
if ( V_56 == NULL )
return;
V_79 = F_76 ( V_152 , V_150 ) ;
if ( V_79 == NULL )
goto V_60;
V_151 = F_50 ( V_150 ) ;
V_84 ( V_79 ) -> V_124 = F_45 ( V_79 , V_151 -> V_47 ,
V_151 -> V_14 ) ;
F_77 ( V_79 , F_78 ( V_56 ) ) ;
F_33 ( V_152 ) ;
V_20 = F_72 ( V_79 , V_152 ,
...
struct V_112 * V_113 ;
struct V_162 * V_163 ;
const T_2 V_164 = F_83 ( V_79 ) -> V_165 ;
struct V_166 * V_167 = F_84 ( V_79 ) ;
...
goto V_173;
V_163 = F_39 ( V_113 ) ;
if ( F_90 ( V_2 , V_163 , V_79 ) )
goto V_173;
if ( F_91 ( V_2 , V_79 , V_113 ) )
goto V_173;
V_126 = F_54 ( V_113 ) ;
V_126 -> V_132 = F_50 ( V_79 ) -> V_14 ;
V_126 -> V_131 = F_50 ( V_79 ) -> V_47 ;
V_163 -> V_174 = V_167 -> V_175 ;
V_163 -> V_176 = V_163 -> V_174 ;
V_163 -> V_115 = F_49 ( V_79 ) ;
V_163 -> V_116 = V_163 -> V_115 ;
V_163 -> V_177 = V_164 ;
if ( F_69 ( V_2 , V_113 , NULL ) )
goto V_173;
F_92 ( V_2 , V_113 , V_178 ) ;
return 0 ;
V_173:
F_93 ( V_113 ) ;
V_170:
...
if ( V_2 -> V_67 == V_68 ) {
struct V_1 * V_139 = F_60 ( V_2 , V_79 ) ;
if ( V_139 == NULL )
goto V_181;
if ( V_139 != V_2 ) {
if ( F_96 ( V_2 , V_139 , V_79 ) )
goto V_180;
return 0 ;
}
}
...
if ( V_85 -> V_186 < F_102 ( V_79 ) / sizeof( T_3 ) ) {
F_101 ( L_3 , V_85 -> V_186 ) ;
return 1 ;
}
if ( ! F_100 ( V_79 , V_85 -> V_186 * sizeof( T_3 ) ) ) {
F_101 ( L_4 , V_85 -> V_186 ) ;
return 1 ;
}
if ( ( V_85 -> V_155 < V_187 ||
...
if ( V_182 > V_79 -> V_90 ) {
F_101 ( L_6 ,
V_85 -> V_190 , V_79 -> V_90 ) ;
return 1 ;
}
V_79 -> V_123 = F_105 ( V_79 , 0 , V_182 , 0 ) ;
return 0 ;
}
...
V_85 = V_84 ( V_79 ) ;
F_84 ( V_79 ) -> V_175 = F_35 ( V_85 ) ;
F_84 ( V_79 ) -> V_193 = V_85 -> V_155 ;
F_107 ( L_8 ,
F_103 ( V_85 -> V_155 ) ,
& V_64 -> V_47 , F_108 ( V_85 -> V_94 ) ,
& V_64 -> V_14 , F_108 ( V_85 -> V_93 ) ,
( unsigned long long ) F_84 ( V_79 ) -> V_175 ) ;
if ( F_109 ( V_79 ) ) {
F_84 ( V_79 ) -> V_194 = V_195 ;
F_110 ( L_9 ) ;
} else {
F_84 ( V_79 ) -> V_194 = F_111 ( V_79 ) ;
...
if ( ! F_113 ( V_2 , V_199 , V_79 ) )
goto V_198;
F_114 ( V_79 ) ;
return F_115 ( V_2 , V_79 , 1 ) ;
V_196:
if ( ! F_113 ( NULL , V_199 , V_79 ) )
goto V_192;
if ( V_85 -> V_155 != V_156 ) {
F_84 ( V_79 ) -> V_168 =
V_200 ;
...
if ( V_92 . V_204 == NULL )
return - V_205 ;
return F_120 ( & V_88 -> V_153 . V_154 , V_206 ,
V_207 , V_42 , V_88 ) ;
}
static void T_10 F_121 ( struct V_88 * V_88 )
{
F_122 ( V_88 -> V_153 . V_154 ) ;
}
static int T_11 F_123 ( void )
{
int V_20 = F_124 ( & V_208 , 1 ) ;
if ( V_20 != 0 )
goto V_60;
V_20 = F_125 ( & V_209 , V_42 ) ;
if ( V_20 != 0 )
goto V_210;
F_126 ( & V_211 ) ;
V_20 = F_127 ( & V_212 ) ;
