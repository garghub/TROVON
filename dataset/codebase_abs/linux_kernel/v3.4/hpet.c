...
V_30 -> V_64 > 1 ? L_8 : L_9 ) ;
for ( V_58 = 0 ; V_58 < V_30 -> V_64 ; V_58 ++ )
F_36 ( V_168 L_10 , V_58 > 0 ? L_11 : L_9 , V_138 -> V_101 [ V_58 ] ) ;
F_36 ( V_168 L_12 ) ;
V_152 = V_30 -> V_112 ;
...
struct V_42 V_3 * V_43 ;
V_43 = & V_28 -> V_171 [ V_10 - V_30 -> V_13 ] ;
V_10 -> V_12 = V_30 ;
V_10 -> V_16 = V_28 ;
V_10 -> V_32 = V_43 ;
if ( V_138 -> V_172 & ( 1 << V_58 ) ) {
V_10 -> V_14 = V_65 ;
continue;
}
F_59 ( & V_10 -> V_36 ) ;
...
V_174 . V_175 . V_176 = V_4 ;
F_61 ( & V_174 , V_30 -> V_112 ) ;
V_30 -> V_177 = & V_174 ;
V_173 = & V_174 ;
}
#endif
...
static T_10 F_62 ( struct V_178 * V_179 , void * V_8 )
{
struct V_137 * V_138 ;
T_10 V_180 ;
struct V_181 V_5 ;
V_138 = V_8 ;
V_180 = F_63 ( V_179 , & V_5 ) ;
if ( F_64 ( V_180 ) ) {
V_138 -> V_139 = V_5 . V_182 ;
V_138 -> V_159 = F_65 ( V_5 . V_182 , V_5 . V_183 ) ;
if ( F_53 ( V_138 ) ) {
F_66 ( V_138 -> V_159 ) ;
return V_184 ;
}
} else if ( V_179 -> type == V_185 ) {
struct V_186 * V_187 ;
V_187 = & V_179 -> V_8 . V_188 ;
if ( ! V_187 )
return V_189 ;
V_138 -> V_139 = V_187 -> V_190 ;
V_138 -> V_159 = F_65 ( V_187 -> V_190 ,
V_191 ) ;
if ( F_53 ( V_138 ) ) {
F_66 ( V_138 -> V_159 ) ;
return V_184 ;
}
} else if ( V_179 -> type == V_192 ) {
struct V_193 * V_194 ;
int V_58 , V_7 ;
V_194 = & V_179 -> V_8 . V_195 ;
for ( V_58 = 0 ; V_58 < V_194 -> V_196 ; V_58 ++ ) {
V_7 = F_17 ( NULL , V_194 -> V_197 [ V_58 ] ,
V_194 -> V_198 , V_194 -> V_199 ) ;
if ( V_7 < 0 )
return V_200 ;
...
static int F_70 ( struct V_202 * V_203 , int type )
{
return - V_61 ;
}
