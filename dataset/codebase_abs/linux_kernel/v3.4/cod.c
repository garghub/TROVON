...
int V_36 = 0 ;
if ( V_72 <= V_73 )
strncpy ( V_71 , V_63 -> V_74 , V_72 ) ;
else
V_36 = - V_21 ;
return V_36 ;
}
int F_19 ( struct V_25 * V_63 , T_4 * V_75 )
{
* V_75 = V_63 -> V_76 ;
return 0 ;
}
int F_20 ( struct V_25 * V_63 ,
struct V_77 * * V_78 )
{
int V_36 = 0 ;
...
int F_21 ( struct V_23 * V_24 , char * V_79 ,
T_4 * V_80 , T_4 * V_81 )
{
struct V_25 * V_63 ;
int V_36 = 0 ;
...
int F_22 ( struct V_25 * V_63 , char * V_83 ,
T_4 * V_84 )
{
struct V_85 * V_86 ;
F_23 ( V_87 , L_1 ,
...
int F_24 ( struct V_25 * V_63 , T_4 V_92 , char * args [] ,
...
int F_25 ( struct V_25 * V_26 , char * V_106 ,
...
int F_27 ( struct V_25 * V_26 , char * V_106 ,
T_7 V_96 )
{
int V_36 = 0 ;
struct V_69 * V_24 ;
...
int F_28 ( struct V_23 * V_24 , char * V_79 ,
