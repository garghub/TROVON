...
{
struct V_5 * V_6 = (struct V_5 * ) V_2 -> V_18 ;
F_7 ( V_2 , V_6 -> V_15 ) ;
F_5 ( V_6 ) ;
}
...
return V_6 -> V_13 + F_9 ( V_2 , V_19 ) ;
}
static void F_10 ( struct V_1 * V_2 , struct V_20 * V_20 )
{
struct V_5 * V_6 = V_2 -> V_18 ;
V_20 -> V_21 = V_6 -> V_15 -> V_22 ;
if ( F_11 ( V_20 ) )
V_20 -> V_19 = F_8 ( V_2 , V_20 -> V_19 ) ;
}
static int F_12 ( struct V_1 * V_2 , struct V_20 * V_20 ,
union V_23 * V_24 )
{
F_10 ( V_2 , V_20 ) ;
return V_25 ;
...
int V_34 = 0 ;
if ( V_6 -> V_13 ||
V_2 -> V_35 != F_15 ( V_15 -> V_22 -> V_36 ) >> V_37 )
V_34 = F_16 ( NULL , V_31 ) ;
return V_34 ? : F_17 ( V_15 -> V_22 , V_15 -> V_38 , V_31 , V_32 ) ;
}
static int F_18 ( struct V_1 * V_2 , struct V_39 * V_40 ,
struct V_41 * V_42 , int V_43 )
{
struct V_5 * V_6 = V_2 -> V_18 ;
struct V_44 * V_45 = F_19 ( V_6 -> V_15 -> V_22 ) ;
if ( ! V_45 -> V_46 )
return V_43 ;
V_40 -> V_21 = V_6 -> V_15 -> V_22 ;
V_40 -> V_19 = F_8 ( V_2 , V_40 -> V_19 ) ;
