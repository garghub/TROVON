...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_509 ( sizeof( struct V_1382 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_476 ;
...
static int T_14 F_515 ( struct V_477 * V_1385 ,
...
F_518 ( V_1385 ) ;
V_557 = F_519 ( V_1385 , F_520 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_521 ( V_1385 , F_520 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_528 ) ;
goto V_1391;
}
F_522 ( V_1385 , V_23 ) ;
V_557 = F_523 ( V_1385 , V_1327 ) ;
if ( V_557 )
goto V_1391;
F_524 ( V_1385 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_525 ( V_1385 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_526 ( V_1385 , 0 ) ;
V_23 -> V_1392 = V_415 ;
V_137 = F_527 ( V_1385 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1389 ;
goto V_1393;
}
...
F_409 ( V_23 , 1 ) ;
V_557 = F_528 ( V_1385 -> V_1336 , F_480 , V_1395 , V_1327 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_532 , V_1385 -> V_1336 ) ;
goto V_1394;
}
F_511 ( V_167 , & V_1385 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1396 = F_469 ;
V_23 -> V_163 -> V_896 = F_496 ;
V_23 -> V_163 -> V_1397 = F_466 ;
#ifdef F_291
...
V_167 -> V_1405 = & V_1406 ;
V_167 -> V_1407 = & V_1408 ;
V_167 -> V_1336 = V_1385 -> V_1336 ;
V_167 -> V_1409 = ( unsigned long ) V_23 -> V_22 ;
V_167 -> V_1410 = F_529 ( V_1385 , 0 ) ;
V_167 -> V_1411 = V_167 -> V_1410 + F_526 ( V_1385 , 0 ) - 1 ;
V_557 = F_530 ( & V_1385 -> V_166 . V_1412 , & V_1413 ) ;
if ( V_557 ) {
F_46 ( L_533 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1414;
...
F_514 ( V_23 -> V_167 ) ;
V_1415:
F_532 ( & V_1385 -> V_166 . V_1412 , & V_1413 ) ;
V_1414:
F_533 ( V_1385 -> V_1336 , V_23 ) ;
V_1394:
F_534 ( V_23 -> V_22 ) ;
V_1393:
F_535 ( V_1385 ) ;
...
static void T_16 F_537 ( struct V_477 * V_1385 )
{
struct V_17 * V_23 = F_538 ( V_1385 ) ;
...
static int F_541 ( struct V_477 * V_1385 , T_17 V_664 )
{
struct V_17 * V_23 = F_538 ( V_1385 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
...
F_543 ( V_1385 ) ;
F_536 ( V_1385 ) ;
F_544 ( V_1385 , F_545 ( V_1385 , V_664 ) ) ;
V_23 -> V_1417 = F_546 () ;
return 0 ;
}
static int F_547 ( struct V_477 * V_1385 )
{
struct V_17 * V_23 = F_538 ( V_1385 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
...
F_525 ( V_1385 , 0x40 , V_21 & 0xffff00ff ) ;
F_549 ( V_166 ) ;
V_23 -> V_1356 = F_546 () - V_23 -> V_1417 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_550 ( struct V_477 * V_1385 )
{
struct V_17 * V_23 = F_538 ( V_1385 ) ;
F_161 ( V_23 ) ;
F_536 ( V_1385 ) ;
}
static int T_18 F_551 ( void )
{
int V_432 ;
...
V_432 = F_553 ( & V_1419 . V_1326 , & V_1420 ) ;
if ( V_432 ) {
F_46 ( L_544 ) ;
F_554 ( & V_1419 ) ;
return V_432 ;
...
static void T_19 F_555 ( void )
{
F_556 ( & V_1419 . V_1326 , & V_1420 ) ;
F_554 ( & V_1419 ) ;
}
