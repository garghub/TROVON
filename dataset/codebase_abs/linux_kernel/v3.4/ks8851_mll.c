...
struct V_1 * V_2 ;
T_2 V_209 , V_4 ;
V_207 = F_100 ( V_204 , V_210 , 0 ) ;
V_208 = F_100 ( V_204 , V_210 , 1 ) ;
if ( ! F_101 ( V_207 -> V_211 , F_102 ( V_207 ) , V_88 ) )
goto V_212;
if ( ! F_101 ( V_208 -> V_211 , F_102 ( V_208 ) , V_88 ) )
goto V_213;
...
V_2 = F_38 ( V_23 ) ;
V_2 -> V_23 = V_23 ;
V_2 -> V_10 = F_105 ( V_207 -> V_211 , F_102 ( V_207 ) ) ;
if ( ! V_2 -> V_10 )
goto V_215;
V_2 -> V_9 = F_105 ( V_208 -> V_211 , F_102 ( V_208 ) ) ;
if ( ! V_2 -> V_9 )
goto V_216;
...
V_2 -> V_151 . V_223 = 1 ;
V_2 -> V_151 . V_224 = 0xf ;
V_2 -> V_151 . V_225 = F_88 ;
V_2 -> V_151 . V_226 = F_89 ;
F_93 ( V_23 , L_15 , V_159 ) ;
V_2 -> V_159 = F_109 ( V_159 , ( V_227 |
V_228 |
V_229 ) ) ;
F_16 ( V_2 ) ;
if ( ( F_4 ( V_2 , V_230 ) & ~ V_231 ) != V_232 ) {
F_92 ( V_23 , L_16 ) ;
V_86 = - V_233 ;
goto V_234;
}
...
F_114 ( V_23 ) ;
V_214:
F_115 ( V_208 -> V_211 , F_102 ( V_208 ) ) ;
V_213:
F_115 ( V_207 -> V_211 , F_102 ( V_207 ) ) ;
V_212:
return V_86 ;
}
static int T_6 F_116 ( struct V_203 * V_204 )
{
struct V_53 * V_23 = F_117 ( V_204 ) ;
struct V_1 * V_2 = F_38 ( V_23 ) ;
struct V_206 * V_238 = F_100 ( V_204 , V_210 , 0 ) ;
F_118 ( V_2 -> V_57 ) ;
F_119 ( V_23 ) ;
F_113 ( V_2 -> V_10 ) ;
F_114 ( V_23 ) ;
F_115 ( V_238 -> V_211 , F_102 ( V_238 ) ) ;
F_111 ( V_204 , NULL ) ;
return 0 ;
}
