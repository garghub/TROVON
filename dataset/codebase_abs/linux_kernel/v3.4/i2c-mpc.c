...
static T_1 F_45 ( struct V_69 * V_59 )
{
return V_84 | V_85
| V_86 | V_87 ;
}
static int T_3 F_46 ( struct V_88 * V_89 )
{
...
int V_23 = 0 ;
int V_92 ;
V_91 = F_47 ( V_93 , & V_89 -> V_24 ) ;
if ( ! V_91 )
return - V_39 ;
V_2 = F_48 ( sizeof( * V_2 ) , V_94 ) ;
if ( ! V_2 )
return - V_95 ;
V_2 -> V_24 = & V_89 -> V_24 ;
F_49 ( & V_2 -> V_11 ) ;
...
V_2 -> V_59 . V_24 . V_96 = F_55 ( V_89 -> V_24 . V_96 ) ;
V_23 = F_56 ( & V_2 -> V_59 ) ;
if ( V_23 < 0 ) {
F_50 ( V_2 -> V_24 , L_28 ) ;
goto V_104;
...
static int T_6 F_61 ( struct V_88 * V_89 )
{
struct V_1 * V_2 = F_62 ( & V_89 -> V_24 ) ;
F_63 ( & V_2 -> V_59 ) ;
F_53 ( & V_89 -> V_24 , NULL ) ;
if ( V_2 -> V_6 )
F_58 ( V_2 -> V_6 , V_2 ) ;
