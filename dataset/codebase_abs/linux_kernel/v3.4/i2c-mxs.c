...
static int F_18 ( struct V_28 * V_29 , struct V_30 V_43 [] ,
int V_44 )
{
int V_18 ;
int V_45 ;
for ( V_18 = 0 ; V_18 < V_44 ; V_18 ++ ) {
V_45 = F_13 ( V_29 , & V_43 [ V_18 ] , V_18 == ( V_44 - 1 ) ) ;
if ( V_45 )
return V_45 ;
}
return V_44 ;
...
static T_3 F_20 ( int V_49 , void * V_50 )
{
struct V_1 * V_2 = V_50 ;
T_2 V_51 = F_9 ( V_2 -> V_3 + V_52 ) & V_4 ;
bool V_53 ;
if ( ! V_51 )
return V_54 ;
if ( V_51 & V_55 )
...
V_58 | V_59 ) )
V_2 -> V_37 = - V_60 ;
V_53 = ( F_9 ( V_2 -> V_3 + V_24 ) &
V_61 ) == 0 ;
if ( V_53 || V_2 -> V_37 )
F_21 ( & V_2 -> V_36 ) ;
F_3 ( V_51 , V_2 -> V_3 + V_62 ) ;
return V_63 ;
}
static int T_4 F_22 ( struct V_64 * V_65 )
{
struct V_66 * V_34 = & V_65 -> V_34 ;
struct V_1 * V_2 ;
struct V_28 * V_29 ;
struct V_67 * V_68 ;
T_5 V_69 ;
int V_45 , V_70 ;
V_2 = F_23 ( V_34 , sizeof( struct V_1 ) , V_71 ) ;
if ( ! V_2 )
return - V_72 ;
V_68 = F_24 ( V_65 , V_73 , 0 ) ;
if ( ! V_68 )
return - V_74 ;
V_69 = F_25 ( V_68 ) ;
if ( ! F_26 ( V_34 , V_68 -> V_75 , V_69 , V_68 -> V_76 ) )
return - V_77 ;
V_2 -> V_3 = F_27 ( V_34 , V_68 -> V_75 , V_69 ) ;
if ( ! V_2 -> V_3 )
return - V_77 ;
V_70 = F_28 ( V_65 , 0 ) ;
if ( V_70 < 0 )
return V_70 ;
V_45 = F_29 ( V_34 , V_70 , F_20 , 0 , F_30 ( V_34 ) , V_2 ) ;
if ( V_45 )
return V_45 ;
V_2 -> V_34 = V_34 ;
F_31 ( V_65 , V_2 ) ;
F_1 ( V_2 ) ;
V_29 = & V_2 -> V_78 ;
F_32 ( V_29 -> V_76 , L_4 , sizeof( V_29 -> V_76 ) ) ;
V_29 -> V_79 = V_80 ;
V_29 -> V_81 = & V_82 ;
V_29 -> V_34 . V_83 = V_34 ;
V_29 -> V_84 = V_65 -> V_85 ;
...
static int T_6 F_36 ( struct V_64 * V_65 )
{
struct V_1 * V_2 = F_37 ( V_65 ) ;
int V_33 ;
V_33 = F_38 ( & V_2 -> V_78 ) ;
if ( V_33 )
return - V_77 ;
F_3 ( V_86 , V_2 -> V_3 + V_87 ) ;
F_31 ( V_65 , NULL ) ;
return 0 ;
}
