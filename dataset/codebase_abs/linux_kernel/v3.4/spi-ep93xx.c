...
if ( ! V_101 )
return F_43 ( - V_38 ) ;
V_87 = F_55 ( V_97 , V_95 -> V_119 , V_101 , V_86 , V_120 ) ;
if ( ! V_87 ) {
F_56 ( V_97 -> V_118 -> V_35 , V_95 -> V_119 , V_95 -> V_101 , V_86 ) ;
return F_43 ( - V_38 ) ;
}
return V_87 ;
}
...
V_122 = F_41 ( V_2 , V_105 ) ;
if ( F_60 ( V_122 ) ) {
F_22 ( & V_2 -> V_34 -> V_35 , L_6 , F_61 ( V_122 ) ) ;
...
if ( F_60 ( V_87 ) ) {
F_57 ( V_2 , V_105 ) ;
F_22 ( & V_2 -> V_34 -> V_35 , L_7 , F_61 ( V_122 ) ) ;
V_45 -> V_52 = F_61 ( V_87 ) ;
return;
}
V_122 -> V_124 = F_58 ;
...
static int T_6 F_92 ( struct V_158 * V_34 )
{
struct V_159 * V_32 ;
struct V_160 * V_161 ;
struct V_1 * V_2 ;
struct V_162 * V_163 ;
int error ;
V_161 = V_34 -> V_35 . V_164 ;
V_32 = F_93 ( & V_34 -> V_35 , sizeof( * V_2 ) ) ;
if ( ! V_32 ) {
F_22 ( & V_34 -> V_35 , L_14 ) ;
return - V_38 ;
}
...
V_32 -> V_165 = F_28 ;
V_32 -> V_61 = F_34 ;
V_32 -> V_166 = V_34 -> V_167 ;
V_32 -> V_168 = V_161 -> V_168 ;
V_32 -> V_169 = V_65 | V_64 | V_29 ;
F_94 ( V_34 , V_32 ) ;
V_2 = F_21 ( V_32 ) ;
V_2 -> V_9 = F_95 ( & V_34 -> V_35 , NULL ) ;
if ( F_60 ( V_2 -> V_9 ) ) {
F_22 ( & V_34 -> V_35 , L_15 ) ;
error = F_61 ( V_2 -> V_9 ) ;
goto V_170;
...
V_2 -> V_34 = V_34 ;
V_2 -> V_138 = F_98 ( V_34 , 0 ) ;
if ( V_2 -> V_138 < 0 ) {
error = - V_171 ;
F_22 ( & V_34 -> V_35 , L_16 ) ;
goto V_172;
}
V_163 = F_99 ( V_34 , V_173 , 0 ) ;
if ( ! V_163 ) {
F_22 ( & V_34 -> V_35 , L_17 ) ;
error = - V_154 ;
goto V_172;
}
V_163 = F_100 ( V_163 -> V_174 , F_101 ( V_163 ) , V_34 -> V_153 ) ;
if ( ! V_163 ) {
F_22 ( & V_34 -> V_35 , L_18 ) ;
error = - V_171 ;
goto V_172;
}
V_2 -> V_109 = V_163 -> V_174 + V_73 ;
V_2 -> V_5 = F_102 ( V_163 -> V_174 , F_101 ( V_163 ) ) ;
if ( ! V_2 -> V_5 ) {
F_22 ( & V_34 -> V_35 , L_19 ) ;
error = - V_154 ;
goto V_175;
}
error = F_103 ( V_2 -> V_138 , F_80 , 0 ,
L_20 , V_2 ) ;
if ( error ) {
F_22 ( & V_34 -> V_35 , L_21 ) ;
goto V_176;
}
if ( V_161 -> V_177 && F_84 ( V_2 ) )
F_53 ( & V_34 -> V_35 , L_22 ) ;
V_2 -> V_59 = F_104 ( L_23 ) ;
if ( ! V_2 -> V_59 ) {
F_22 ( & V_34 -> V_35 , L_24 ) ;
...
F_108 ( & V_34 -> V_35 , L_26 ,
( unsigned long ) V_163 -> V_174 , V_2 -> V_138 ) ;
return 0 ;
V_179:
F_109 ( V_2 -> V_59 ) ;
V_178:
...
static int T_7 F_115 ( struct V_158 * V_34 )
{
struct V_159 * V_32 = F_116 ( V_34 ) ;
