...
{
if ( F_108 ( V_13 -> V_166 ) )
F_109 ( V_164 , F_110 ( V_13 -> V_166 ) ,
F_108 ( V_13 -> V_166 ) ,
V_13 -> V_166 -> V_167 ) ;
if ( V_13 -> V_17 . V_67 & F_25 ( V_168 ) )
F_52 ( V_164 , V_13 -> V_169 ,
sizeof( V_13 -> V_170 ) , V_75 ) ;
}
static unsigned int F_111 ( T_6 * V_26 , T_6 * V_171 )
{
int V_172 ;
int V_173 = ( V_26 [ 0 ] >> 6 ) & 0x03 ;
if ( V_173 == 2 || V_173 == 3 ) {
return V_174 << 16 ;
}
V_171 [ 0 ] = 0x70 | V_173 | ( V_26 [ 1 ] & 0x80 ) ;
V_171 [ 1 ] = 0x0 ;
V_171 [ 2 ] = ( ( V_26 [ 1 ] << 1 ) & 0xe0 ) | ( V_26 [ 1 ] & 0x0f ) ;
V_171 [ 3 ] = V_26 [ 4 ] ;
V_171 [ 4 ] = V_26 [ 5 ] ;
V_171 [ 5 ] = V_26 [ 6 ] ;
V_171 [ 6 ] = V_26 [ 7 ] ;
...
case V_179 :
case V_180 :
return V_181 << 16 | V_172 ;
default:
return V_174 << 16 ;
}
}
static void F_112 ( struct V_12 * V_53 ,
struct V_26 * V_27 )
{
struct V_165 * V_13 =
...
if ( V_182 == V_181 << 16 && F_114 ( * V_27 ) > 1 )
V_182 = F_111 ( F_115 ( * V_27 ) ,
V_13 -> V_166 -> V_188 ) ;
} else {
V_182 = V_185 << 16 ;
F_59 ( V_13 -> V_2 ) ;
...
V_13 -> V_166 -> V_182 = V_182 ;
V_13 -> V_166 -> V_189 ( V_13 -> V_166 ) ;
}
static int F_116 ( struct V_165 * V_13 ,
struct V_6 * V_10 , struct V_1 * V_2 )
{
struct V_190 * V_191 = F_110 ( V_13 -> V_166 ) ;
int V_142 , V_192 ;
V_192 = F_117 ( V_10 -> V_15 -> V_10 , V_191 , F_108 ( V_13 -> V_166 ) ,
V_13 -> V_166 -> V_167 ) ;
if ( V_192 == 0 )
goto V_193;
if ( V_192 == 1 ) {
V_13 -> V_17 . V_194 . V_43 =
F_25 ( V_2 -> V_8 -> V_108 ) ;
V_13 -> V_17 . V_194 . V_44 =
F_25 ( F_118 ( V_191 ) ) ;
V_13 -> V_17 . V_67 |=
F_25 ( F_119 ( F_120 ( V_191 ) ) ) ;
return 0 ;
}
F_121 (sg, sg, n, i) {
V_13 -> V_170 [ V_142 ] . V_43 = F_25 ( F_120 ( V_191 ) << 16 ) ;
V_13 -> V_170 [ V_142 ] . V_44 = F_25 ( F_118 ( V_191 ) ) ;
}
V_13 -> V_169 =
F_40 ( V_10 -> V_15 -> V_10 , V_13 -> V_170 ,
sizeof( V_13 -> V_170 ) , V_75 ) ;
if ( F_41 ( V_10 -> V_15 -> V_10 , V_13 -> V_169 ) )
goto V_195;
V_13 -> V_17 . V_194 . V_43 = F_25 ( V_2 -> V_8 -> V_108 ) ;
V_13 -> V_17 . V_194 . V_44 = F_25 ( V_13 -> V_169 ) ;
V_13 -> V_17 . V_67 |= F_25 ( V_168 |
F_119 ( V_192 ) ) ;
return 0 ;
V_195:
F_109 ( V_10 -> V_15 -> V_10 , F_110 ( V_13 -> V_166 ) ,
F_108 ( V_13 -> V_166 ) , V_13 -> V_166 -> V_167 ) ;
V_193:
return - V_61 ;
}
static int F_122 ( struct V_87 * V_88 ,
struct V_196 * V_166 )
{
...
struct V_165 * V_13 ;
int V_21 , V_50 = V_197 ;
if ( V_166 -> V_167 == V_198 ) {
F_22 ( F_6 ( V_2 ) , L_16 ) ;
V_166 -> V_182 = V_174 << 16 ;
V_166 -> V_189 ( V_166 ) ;
return 0 ;
}
...
V_21 = V_10 -> V_21 ;
F_68 () ;
if ( F_108 ( V_166 ) && F_116 ( V_13 , V_10 , V_2 ) < 0 )
goto V_79;
memcpy ( V_13 -> V_17 . V_202 , V_166 -> V_203 , V_166 -> V_204 ) ;
V_13 -> V_55 . V_39 = F_112 ;
V_13 -> V_55 . V_35 =
F_40 ( V_10 -> V_15 -> V_10 , & V_13 -> V_17 ,
sizeof( V_13 -> V_17 ) , V_75 ) ;
if ( F_41 ( V_10 -> V_15 -> V_10 , V_13 -> V_55 . V_35 ) ) {
...
F_129 ( V_101 -> V_208 , V_152 ) ;
return 0 ;
}
static int F_130 ( struct V_196 * V_166 )
{
struct V_1 * V_2 = V_166 -> V_10 -> V_89 ;
F_14 ( F_6 ( V_2 ) , L_18 ) ;
F_53 ( V_2 ) ;
...
static T_7 F_131 ( struct V_10 * V_148 ,
struct V_224 * V_225 , char * V_226 )
{
struct V_100 * V_101 = F_132 ( V_148 ) ;
struct V_1 * V_2 ;
if ( ! V_101 )
return 0 ;
V_2 = V_101 -> V_89 ;
