...
static int F_24 ( struct V_46 * V_47 , struct V_48 * V_49 )
{
...
static int F_53 ( struct V_46 * V_47 , int V_109 )
{
struct V_2 * V_2 = F_4 ( V_47 , struct V_2 , V_10 ) ;
struct V_8 * V_9 = F_16 ( V_47 ) ;
int V_12 = 0 ;
...
static int F_57 ( struct V_46 * V_47 , unsigned int V_132 ,
enum V_3 * V_4 )
{
if ( V_132 >= F_2 ( V_6 ) )
return - V_15 ;
...
{
struct V_8 * V_9 = F_16 ( V_47 ) ;
struct V_135 * V_136 = F_59 ( V_9 ) ;
V_134 -> V_137 = V_138 | V_139 |
V_140 | V_141 |
V_142 ;
V_134 -> type = V_143 ;
V_134 -> V_137 = F_60 ( V_136 , V_134 ) ;
return 0 ;
}
...
{
struct V_2 * V_2 ;
struct V_146 * V_147 = F_62 ( V_9 -> V_17 . V_148 ) ;
struct V_135 * V_136 = F_59 ( V_9 ) ;
int V_12 ;
if ( ! V_136 ) {
F_32 ( & V_9 -> V_17 , L_11 ) ;
...
V_2 = F_65 ( sizeof( struct V_2 ) , V_150 ) ;
if ( ! V_2 )
return - V_151 ;
F_66 ( & V_2 -> V_10 , V_9 , & V_152 ) ;
F_67 ( & V_2 -> V_116 , 5 ) ;
F_68 ( & V_2 -> V_116 , & V_153 ,
V_117 , 0 , 1 , 1 , 0 ) ;
F_68 ( & V_2 -> V_116 , & V_153 ,
V_119 , 0 , 1 , 1 , 0 ) ;
F_68 ( & V_2 -> V_116 , & V_153 ,
V_123 , 0 , 1 , 1 , 1 ) ;
V_2 -> V_108 = F_68 ( & V_2 -> V_116 , & V_153 ,
V_121 , 0 , 63 * 2 * 2 , 1 , 32 ) ;
F_69 ( & V_2 -> V_116 ,
& V_153 , V_122 , 1 , 0 ,
V_154 ) ;
