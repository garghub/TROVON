...
V_78 = F_64 ( V_9 , V_31 -> V_142 , V_31 -> V_145 , V_31 -> V_144 ) ;
if ( V_78 ) {
F_62 ( V_2 -> V_99 , L_8 , V_78 ) ;
return - V_146 ;
}
return 0 ;
}
static int F_65 ( struct V_131 * V_147 ,
...
{
F_56 ( V_2 , V_124 ) ;
F_56 ( V_2 , V_2 -> V_115 . V_152 ) ;
return 0 ;
}
static int F_68 ( struct V_1 * V_2 )
{
struct V_30 * V_31 ;
struct V_153 * V_154 = F_69 ( V_2 -> V_99 ) ;
struct V_155 * V_156 = F_16 ( V_2 -> V_99 ,
struct V_155 , V_99 ) ;
int V_78 = 0 ;
V_31 = F_70 ( sizeof( struct V_30 ) , V_157 ) ;
if ( V_31 == NULL )
return - V_158 ;
F_71 ( V_2 , V_31 ) ;
V_31 -> V_2 = V_2 ;
V_2 -> V_10 = F_72 ( V_2 -> V_99 -> V_159 ) ;
if ( V_154 && V_154 -> V_62 && V_154 -> V_63 ) {
V_31 -> V_62 = V_154 -> V_62 ;
V_31 -> V_63 = V_154 -> V_63 ;
} else {
V_31 -> V_62 = 1 ;
V_31 -> V_63 = 1 ;
}
if ( V_154 && V_154 -> V_64 && V_154 -> V_65 ) {
V_31 -> V_64 = V_154 -> V_64 ;
V_31 -> V_65 = V_154 -> V_65 ;
} else {
V_31 -> V_64 = 1 ;
V_31 -> V_65 = 1 ;
}
V_31 -> V_160 = F_73 ( V_156 , 0 ) ;
if ( V_31 -> V_160 < 0 ) {
F_62 ( V_2 -> V_99 , L_10 ) ;
V_78 = - V_101 ;
goto V_161;
}
V_31 -> V_67 = F_74 ( L_11 , 0 , 0 ) ;
if ( ! V_31 -> V_67 ) {
V_78 = - V_158 ;
goto V_161;
}
F_75 ( & V_31 -> V_89 . V_47 , F_36 ) ;
F_75 ( & V_31 -> V_33 . V_47 , F_15 ) ;
F_75 ( & V_31 -> V_44 . V_47 , F_20 ) ;
F_76 ( & V_31 -> V_85 ) ;
F_77 ( & V_31 -> V_33 . V_52 ) ;
F_77 ( & V_31 -> V_44 . V_52 ) ;
V_78 = F_78 ( V_31 -> V_160 , NULL , F_37 ,
0 , L_12 , V_2 ) ;
if ( V_78 ) {
F_62 ( V_2 -> V_99 , L_13 , V_78 ) ;
goto V_162;
}
F_8 ( V_2 ) ;
V_78 = F_56 ( V_2 , V_124 ) ;
...
static int T_4 F_83 ( struct V_155 * V_156 )
{
return F_84 ( & V_156 -> V_99 , & V_163 ,
V_164 , F_11 ( V_164 ) ) ;
}
static int T_5 F_85 ( struct V_155 * V_156 )
{
F_86 ( & V_156 -> V_99 ) ;
return 0 ;
}
