...
int F_36 ( unsigned int V_41 , const struct V_62 * V_62 ,
unsigned int V_63 )
{
if ( ! V_64 )
return V_9 ;
if ( ! F_37 ( V_32 , V_62 ) ) {
int V_47 = F_38 ( V_65 , V_62 ) ;
if ( V_47 < V_66 )
return F_4 ( V_47 ) ;
if ( V_63 )
return - 1 ;
...
static void F_41 ( struct V_51 * V_72 ) { }
static void F_42 ( struct V_51 * V_72 ) { }
static int F_43 ( struct V_68 * V_69 , unsigned int V_41 ,
T_3 V_73 )
{
struct V_21 * V_21 ;
F_5 ( L_9 , V_41 , V_73 ) ;
...
void T_2 F_51 ( struct V_21 * V_21 )
{
F_52 ( & V_21 -> V_86 , & V_87 ) ;
}
