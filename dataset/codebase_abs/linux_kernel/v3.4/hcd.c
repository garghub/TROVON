...
static void F_135 ( struct V_274 * V_275 )
{
struct V_11 * V_12 = F_131 ( V_275 , struct V_11 , V_276 ) ;
...
F_140 ( V_277 , & V_12 -> V_276 ) ;
}
F_26 ( & V_39 , V_92 ) ;
}
int F_141 ( struct V_114 * V_115 , unsigned V_278 )
{
struct V_11 * V_12 ;
int V_36 = - V_279 ;
...
T_8 F_143 ( int V_281 , void * V_282 )
{
...
struct V_11 * F_149 ( const struct V_289 * V_20 ,
struct V_110 * V_49 , const char * V_16 ,
struct V_11 * V_290 )
{
struct V_11 * V_12 ;
V_12 = F_150 ( sizeof( * V_12 ) + V_20 -> V_291 , V_292 ) ;
if ( ! V_12 ) {
F_15 ( V_49 , L_32 ) ;
return NULL ;
}
if ( V_290 == NULL ) {
V_12 -> V_293 = F_151 ( sizeof( * V_12 -> V_293 ) ,
V_292 ) ;
if ( ! V_12 -> V_293 ) {
F_152 ( V_12 ) ;
F_15 ( V_49 , L_33 ) ;
...
V_12 -> V_15 . V_76 = V_49 ;
V_12 -> V_15 . V_16 = V_16 ;
V_12 -> V_15 . V_194 = ( V_49 -> V_295 != NULL ) ;
F_156 ( & V_12 -> V_99 ) ;
V_12 -> V_99 . V_296 = F_29 ;
V_12 -> V_99 . V_13 = ( unsigned long ) V_12 ;
#ifdef F_157
F_158 ( & V_12 -> V_276 , F_135 ) ;
#endif
V_12 -> V_20 = V_20 ;
...
struct V_11 * F_159 ( const struct V_289 * V_20 ,
struct V_110 * V_49 , const char * V_16 )
{
return F_149 ( V_20 , V_49 , V_16 , NULL ) ;
}
static void F_160 ( struct V_294 * V_294 )
{
struct V_11 * V_12 = F_131 ( V_294 , struct V_11 , V_294 ) ;
if ( F_148 ( V_12 ) )
F_152 ( V_12 -> V_293 ) ;
else
...
if ( V_299 & V_300 )
V_299 &= ~ V_301 ;
snprintf ( V_12 -> V_302 , sizeof( V_12 -> V_302 ) , L_35 ,
V_12 -> V_20 -> V_21 , V_12 -> V_15 . V_125 ) ;
V_103 = F_166 ( V_298 , & F_143 , V_299 ,
V_12 -> V_302 , V_12 ) ;
if ( V_103 != 0 ) {
F_62 ( V_12 -> V_15 . V_76 ,
L_36 ,
...
V_12 -> V_281 = V_298 ;
F_52 ( V_12 -> V_15 . V_76 , L_37 , V_298 ,
...
int V_103 ;
struct V_1 * V_257 ;
F_52 ( V_12 -> V_15 . V_76 , L_41 , V_12 -> V_17 ) ;
if ( V_118 < 0 || V_118 > 1 )
...
F_62 ( V_12 -> V_15 . V_76 , L_44 ) ;
goto V_310;
}
V_12 -> V_94 = 1 ;
if ( F_14 ( V_12 -> V_15 . V_76 )
&& F_14 ( & V_12 -> V_15 . V_48 -> V_49 ) )
F_15 ( V_12 -> V_15 . V_76 , L_45 ) ;
if ( F_148 ( V_12 ) && V_298 ) {
V_103 = F_165 ( V_12 , V_298 , V_299 ) ;
if ( V_103 )
goto V_311;
}
V_12 -> V_260 = V_273 ;
...
if ( V_103 < 0 ) {
F_62 ( V_12 -> V_15 . V_76 , L_46 , V_103 ) ;
goto V_313;
}
V_257 -> V_314 = F_171 ( 500u , V_12 -> V_315 ) ;
if ( ( V_103 = F_56 ( V_12 ) ) != 0 )
goto V_316;
V_103 = F_172 ( & V_257 -> V_49 . V_317 , & V_318 ) ;
if ( V_103 < 0 ) {
F_48 ( V_134 L_47 ,
V_103 ) ;
goto V_319;
...
F_52 ( V_12 -> V_15 . V_76 , L_48 , V_12 -> V_260 ) ;
F_107 ( V_257 ) ;
F_181 ( & V_257 -> V_49 . V_317 , & V_318 ) ;
F_24 ( V_263 , & V_12 -> V_92 ) ;
if ( F_174 ( V_12 -> V_260 ) )
V_12 -> V_260 = V_264 ;
F_15 ( V_12 -> V_15 . V_76 , L_49 ) ;
F_8 ( & V_39 ) ;
V_12 -> V_148 = 0 ;
F_10 ( & V_39 ) ;
#ifdef F_157
...
void
F_182 ( struct V_322 * V_49 )
{
struct V_11 * V_12 = F_183 ( V_49 ) ;
if ( V_12 -> V_20 -> V_323 )
V_12 -> V_20 -> V_323 ( V_12 ) ;
}
int F_184 ( struct V_324 * V_325 )
{
if ( V_326 )
return - V_170 ;
V_326 = V_325 ;
