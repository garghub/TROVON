...
V_60 -> V_63 = V_63 ;
V_64 -> V_60 = V_60 ;
F_55 ( & V_64 -> V_66 , F_52 , ( unsigned long ) V_64 ) ;
return ( 0 ) ;
}
int F_56 ( T_11 * V_60 )
{
...
static int
F_62 ( void * V_68 , void T_13 * V_69 , const void * V_70 , int V_31 )
{
if ( F_63 ( V_69 , V_70 , V_31 ) ) {
return ( - V_71 ) ;
}
return ( V_31 ) ;
}
static int
F_64 ( void * V_68 , void * V_69 , const void T_13 * V_70 , int V_31 )
{
if ( F_65 ( V_69 , V_70 , V_31 ) ) {
return ( - V_71 ) ;
}
return ( V_31 ) ;
}
...
static T_14 F_69 ( struct V_73 * V_73 , const char T_13 * V_75 ,
T_4 V_76 , T_15 * V_77 )
{
int V_23 = - V_78 ;
if ( ! V_73 -> V_74 ) {
V_73 -> V_74 = F_70 ( V_73 , V_75 ,
V_76 ,
F_64 ) ;
}
if ( ! V_73 -> V_74 ) {
...
static T_14 F_72 ( struct V_73 * V_73 , char T_13 * V_75 ,
T_4 V_76 , T_15 * V_77 )
{
int V_23 = - V_78 ;
if ( ! V_73 -> V_74 ) {
...
static unsigned int F_74 ( struct V_73 * V_73 , T_16 * V_84 )
{
if ( ! V_73 -> V_74 ) {
return ( V_85 ) ;
}
...
static int T_18 F_79 ( struct V_14 * V_15 ,
...
F_11 ( V_15 , V_100 , V_95 ) ;
}
if ( ! ( V_93 = F_82 ( V_15 , V_92 -> V_97 ) ) ) {
F_9 ((L_19,
DRIVERLNAME,
CardProperties[ent->driver_data].Name,
pdev->bus->number,
...
static void T_20 F_84 ( struct V_14 * V_15 )
{
void * V_93 = F_85 ( V_15 ) ;
F_9 ((L_20,
pdev->bus->number, pdev->devfn))
