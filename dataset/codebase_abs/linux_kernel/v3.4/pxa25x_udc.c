...
if ( V_25 -> V_141 ) {
V_171 = F_72 ( V_25 -> V_141 -> V_177 ,
& V_25 -> V_40 ) ;
if ( V_171 ) {
F_13 ( L_72 ) ;
if ( V_39 -> V_178 )
V_39 -> V_178 ( & V_25 -> V_40 ) ;
goto V_179;
}
}
F_53 ( V_25 ) ;
...
if ( ! V_25 )
return - V_125 ;
if ( ! V_39 || V_39 != V_25 -> V_39 || ! V_39 -> V_178 )
return - V_32 ;
F_76 () ;
V_25 -> F_53 = 0 ;
F_53 ( V_25 ) ;
...
F_77 () ;
if ( V_25 -> V_141 )
( void ) F_72 ( V_25 -> V_141 -> V_177 , NULL ) ;
V_39 -> V_178 ( & V_25 -> V_40 ) ;
V_25 -> V_40 . V_25 . V_39 = NULL ;
V_25 -> V_39 = NULL ;
F_71 ( & V_25 -> V_40 . V_25 ) ;
...
F_18 ( & V_25 -> V_23 [ V_123 ] , - V_187 ) ;
}
static void F_82 ( unsigned long V_182 )
{
struct V_24 * V_25 = ( void * ) V_182 ;
F_76 () ;
if ( V_25 -> V_60 == V_122
&& ( V_76 & V_155 ) == 0
&& ( V_76 & V_156 ) == 0 ) {
...
if ( ( V_188 & V_77 ) != 0 && V_25 -> V_60 != V_61 ) {
F_18 ( V_23 , 0 ) ;
F_84 ( & V_25 -> V_180 ) ;
F_30 ( V_25 ) ;
}
...
F_85 ( V_193 . V_190 . V_201 ) ,
F_85 ( V_193 . V_190 . V_202 ) ,
F_85 ( V_193 . V_190 . V_203 ) ) ;
V_25 -> V_204 = ( V_193 . V_190 . V_199 & V_205 )
== V_206 ;
V_25 -> V_105 = 0 ;
V_25 -> V_81 = 1 ;
...
if ( V_193 . V_190 . V_199 & V_113 )
V_25 -> V_60 = V_101 ;
else
V_25 -> V_60 = V_103 ;
V_123 = V_25 -> V_39 -> V_174 ( & V_25 -> V_40 , & V_193 . V_190 ) ;
if ( V_123 < 0 ) {
if ( V_25 -> V_105 ) {
F_86 ( L_79 ,
V_193 . V_190 . V_200 , V_123 ) ;
return;
}
F_15 ( V_47 , L_80
L_81 , V_76 , V_123 ) ;
...
|| V_25 -> V_204 || V_193 . V_190 . V_203 ) )
F_36 ( V_25 , 0 , L_83 ) ;
else
F_36 ( V_25 , V_87 , L_84 ) ;
}
return;
} else if ( F_29 ( ( V_188 & ( V_78 | V_77 ) )
== ( V_78 | V_77 ) ) ) {
unsigned V_123 ;
F_15 ( V_47 , L_85 ) ;
F_18 ( V_23 , - V_195 ) ;
...
T_3 V_223 = V_79 & ~ V_12 ;
T_3 V_224 = V_147 & ~ V_13 ;
int V_123 ;
if ( F_35 ( ! V_223 && ! V_224 ) )
continue;
F_15 ( V_70 , L_92 , V_224 , V_223 ) ;
if ( V_223 & V_80 ) {
V_25 -> V_23 [ 0 ] . V_45 ++ ;
F_83 ( V_25 ) ;
V_220 = 1 ;
...
static void F_90 ( struct V_225 * V_25 )
{
F_13 ( L_93 , V_31 , F_91 ( V_25 ) ) ;
}
static int T_6 F_92 ( struct V_226 * V_227 )
{
struct V_24 * V_25 = & V_228 ;
int V_171 , V_181 ;
T_3 V_229 ;
...
if ( V_181 < 0 )
return - V_125 ;
V_25 -> V_139 = F_96 ( & V_227 -> V_25 , NULL ) ;
if ( F_97 ( V_25 -> V_139 ) ) {
V_171 = F_98 ( V_25 -> V_139 ) ;
goto V_249;
}
F_99 ( L_96 , V_232 , V_181 ,
V_25 -> V_106 ? L_11 : L_97 ,
V_250 L_38
) ;
V_25 -> V_25 = & V_227 -> V_25 ;
V_25 -> V_2 = V_227 -> V_25 . V_251 ;
V_25 -> V_141 = F_100 () ;
if ( F_2 ( V_25 -> V_2 -> V_6 ) ) {
...
F_104 ( & V_25 -> V_180 ) ;
V_25 -> V_180 . V_253 = F_82 ;
V_25 -> V_180 . V_254 = ( unsigned long ) V_25 ;
F_105 ( & V_25 -> V_40 . V_25 ) ;
V_25 -> V_40 . V_25 . V_255 = & V_227 -> V_25 ;
V_25 -> V_40 . V_25 . V_256 = V_227 -> V_25 . V_256 ;
V_3 = V_25 ;
F_106 ( V_227 , V_25 ) ;
F_57 ( V_25 ) ;
F_67 ( V_25 ) ;
V_25 -> V_136 = 0 ;
V_171 = F_107 ( V_181 , F_88 ,
0 , V_232 , V_25 ) ;
if ( V_171 != 0 ) {
F_93 ( L_100 ,
V_232 , V_181 , V_171 ) ;
...
#endif
F_110 ( V_25 ) ;
V_171 = F_111 ( & V_227 -> V_25 , & V_25 -> V_40 ) ;
if ( ! V_171 )
return V_171 ;
F_112 ( V_25 ) ;
#ifdef F_108
...
static void F_117 ( struct V_226 * V_182 )
{
F_1 () ;
}
static int T_7 F_118 ( struct V_226 * V_227 )
{
struct V_24 * V_25 = F_119 ( V_227 ) ;
F_120 ( & V_25 -> V_40 ) ;
if ( V_25 -> V_39 )
return - V_175 ;
V_25 -> F_53 = 0 ;
...
static int F_121 ( struct V_226 * V_25 , T_8 V_262 )
{
...
static int F_122 ( struct V_226 * V_25 )
{
struct V_24 * V_134 = F_119 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
...
{
F_124 ( L_103 , V_232 , V_263 ) ;
return F_125 ( & V_264 , F_92 ) ;
}
