...
static struct V_18 * F_10 ( struct V_2 * V_19 , T_1 V_1 ,
char * V_10 , int V_20 )
{
int V_11 = F_7 ( V_1 , V_10 ) ;
...
static inline struct V_18 * F_20 ( struct V_2 * V_19 , T_1 V_1 ,
char * V_10 , int V_20 )
{
struct V_18 * V_21 ;
F_21 ( & V_19 -> V_29 ) ;
V_21 = F_10 ( V_19 , V_1 , V_10 , V_20 ) ;
F_22 ( & V_19 -> V_29 ) ;
return V_21 ;
}
...
static int F_82 ( struct V_154 * V_155 , void * V_156 )
{
struct V_18 * V_26 ;
char * V_157 ;
if ( V_156 == V_158 ) {
...
static inline struct V_18 * F_85 ( struct V_2 * V_19 , T_3 V_159 )
{
struct V_18 * V_26 ;
int V_12 ;
for ( V_12 = 0 ; V_12 < V_36 ; V_12 ++ ) {
...
static void * F_86 ( struct V_154 * V_155 , T_3 * V_159 )
__acquires( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_87 ( V_155 ) ) ;
T_3 V_160 = * V_159 ;
F_12 ( & V_19 -> V_29 ) ;
return V_160 ? F_85 ( V_19 , -- V_160 ) : V_158 ;
}
static void * F_88 ( struct V_154 * V_155 , void * V_156 , T_3 * V_159 )
{
struct V_2 * V_19 = F_2 ( F_87 ( V_155 ) ) ;
struct V_18 * V_26 ;
++ * V_159 ;
...
static void F_89 ( struct V_154 * V_155 , void * V_156 )
__releases( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_87 ( V_155 ) ) ;
F_15 ( & V_19 -> V_29 ) ;
}
static int F_90 ( struct V_161 * V_161 , struct V_162 * V_162 )
{
return F_91 ( V_161 , V_162 , & V_163 ,
sizeof( struct V_164 ) ) ;
}
static T_4 int F_92 ( struct V_3 * V_3 )
{
struct V_2 * V_19 = F_2 ( V_3 ) ;
struct V_165 * V_166 ;
F_93 ( & V_19 -> V_29 ) ;
V_166 = F_94 ( V_3 , L_3 , V_167 , & V_168 ) ;
#ifdef F_95
if ( ! V_166 )
return - V_81 ;
#endif
...
static T_5 void F_96 ( struct V_3 * V_3 )
{
F_97 ( V_3 , L_3 ) ;
}
