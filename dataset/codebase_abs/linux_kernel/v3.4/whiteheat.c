...
if ( V_112 & V_108 )
V_25 -> V_58 &= ~ V_107 ;
F_64 ( V_23 , V_25 -> V_58 & V_107 ) ;
F_65 ( V_23 , V_25 -> V_58 & V_109 ) ;
return 0 ;
}
...
V_116 . V_126 = V_127 ;
V_116 . V_128 = V_127 ;
if ( F_67 ( V_117 , & V_116 , sizeof( V_116 ) ) )
return - V_129 ;
break;
default:
break;
...
static void F_69 ( struct V_90 * V_91 , int V_133 )
{
struct V_19 * V_23 = V_91 -> V_104 ;
F_70 ( V_23 , V_133 ) ;
}
...
F_2 ( L_24 , V_13 , V_23 -> V_93 ) ;
F_53 ( & V_25 -> V_55 , V_57 ) ;
F_60 (tmp, &info->tx_urbs_submitted) {
V_37 = F_32 ( V_39 , struct V_36 , V_74 ) ;
...
static void F_73 ( struct V_90 * V_91 )
{
struct V_19 * V_23 = V_91 -> V_104 ;
struct V_24 * V_25 = F_29 ( V_23 ) ;
int V_136 ;
...
static int F_81 ( struct V_19 * V_23 , T_1 V_30 ,
T_1 * V_16 , T_1 V_147 )
{
struct V_19 * V_20 ;
struct V_21 * V_22 ;
...
V_160 . V_191 = F_84 ( V_91 ) ;
V_160 . V_192 = F_85 ( V_91 ) ;
F_2 ( L_55 ,
V_13 , V_160 . V_191 , V_160 . V_192 ) ;
V_160 . V_193 = F_86 ( V_91 ) ;
F_2 ( L_56 , V_13 , V_160 . V_193 ) ;
F_87 ( V_91 , V_160 . V_193 , V_160 . V_193 ) ;
V_160 . V_194 = 0 ;
F_81 ( V_23 , V_195 ,
( T_1 * ) & V_160 , sizeof( V_160 ) ) ;
}
static int F_65 ( struct V_19 * V_23 , T_1 V_196 )
{
struct V_197 V_198 ;
V_198 . V_23 = V_23 -> V_93 - V_23 -> V_2 -> V_120 + 1 ;
V_198 . V_199 = V_196 ;
return F_81 ( V_23 , V_200 ,
...
V_201 . V_199 = V_196 ;
return F_81 ( V_23 , V_202 ,
( T_1 * ) & V_201 , sizeof( V_201 ) ) ;
}
static int F_70 ( struct V_19 * V_23 , T_1 V_196 )
{
struct V_197 V_203 ;
V_203 . V_23 = V_23 -> V_93 - V_23 -> V_2 -> V_120 + 1 ;
V_203 . V_199 = V_196 ;
return F_81 ( V_23 , V_204 ,
...
V_207 . V_208 = V_205 ;
return F_81 ( V_23 , V_209 ,
( T_1 * ) & V_207 , sizeof( V_207 ) ) ;
}
static int F_62 ( struct V_19 * V_23 )
{
struct V_154 V_210 ;
V_210 . V_23 = V_23 -> V_93 - V_23 -> V_2 -> V_120 + 1 ;
return F_81 ( V_23 , V_145 ,
...
static struct V_36 * F_76 ( struct V_34 * V_34 ,
struct V_38 * V_212 )
{
struct V_36 * V_37 ;
struct V_38 * V_39 ;
...
{
struct V_24 * V_25 =
F_88 ( V_215 , struct V_24 , V_59 ) ;
struct V_19 * V_23 = V_25 -> V_23 ;
struct V_90 * V_91 = F_89 ( & V_23 -> V_23 ) ;
struct V_36 * V_37 ;
struct V_34 * V_34 ;
unsigned long V_57 ;
struct V_38 * V_39 ;
