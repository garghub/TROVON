...
if ( V_55 == V_487 )
F_277 ( V_485 , V_2 -> V_312 ) ;
else if ( V_55 == V_488 )
F_278 ( V_485 , V_2 -> V_312 ) ;
...
V_509:
F_65 ( & V_2 -> V_30 -> V_45 , L_54
L_55 , V_508 , V_2 -> V_512 ) ;
F_34 ( V_2 -> V_18 ) ;
F_182 ( V_2 , 0 ) ;
}
static void
...
{
T_1 V_55 , V_520 = 0 , V_521 = 0 ;
F_292 ( V_520 ) ;
F_293 ( V_520 ) ;
F_104 ( V_2 , V_522 , V_520 ) ;
F_294 ( V_521 ) ;
F_295 ( V_521 ) ;
F_296 ( V_521 ) ;
F_297 ( V_521 ) ;
F_104 ( V_2 , V_523 , V_521 ) ;
F_37 ( & V_2 -> V_30 -> V_45 , L_63
L_64 ) ;
V_2 -> V_219 = 1 ;
if ( F_55 ( V_2 ) )
return;
...
T_17 V_112 , int V_524 )
{
if ( F_31 ( V_525 , & V_2 -> V_55 ) )
return;
F_298 ( & V_2 -> V_507 , V_112 ) ;
F_299 ( V_526 , & V_2 -> V_507 ,
F_300 ( V_524 ) ) ;
}
static void
...
F_179 ( V_2 , F_288 , 0 ) ;
F_285 ( V_2 , V_514 , L_76 ) ;
}
return 1 ;
}
static void
V_319 ( struct V_505 * V_506 )
{
struct V_1 * V_2 = F_269 ( V_506 ,
struct V_1 , V_507 . V_506 ) ;
if ( F_31 ( V_275 , & V_2 -> V_55 ) )
...
{
struct V_29 * V_543 ;
int V_485 = V_30 -> V_544 ;
while ( V_485 -- > 0 ) {
V_543 = F_305 ( F_306
( V_30 -> V_545 ) , V_30 -> V_545 -> V_546 ,
F_307 ( F_308 ( V_30 -> V_544 ) , V_485 ) ) ;
if ( ! V_543 )
continue;
if ( V_543 -> V_547 != V_322 ) {
F_309 ( V_543 ) ;
return 0 ;
}
F_309 ( V_543 ) ;
...
static int F_310 ( struct V_29 * V_30 )
{
int V_57 , V_548 ;
struct V_1 * V_2 = F_187 ( V_30 ) ;
struct V_17 * V_18 = V_2 -> V_18 ;
...
static T_18 F_311 ( struct V_29 * V_30 ,
T_19 V_55 )
{
struct V_1 * V_2 = F_187 ( V_30 ) ;
struct V_17 * V_18 = V_2 -> V_18 ;
...
static int
F_316 ( struct V_1 * V_2 , T_1 V_31 )
{
return - V_51 ;
}
static int
F_317 ( struct V_1 * V_2 , T_1 V_55 , T_1 V_556 )
{
return - V_51 ;
}
static T_20
F_318 ( struct V_137 * V_45 ,
struct V_557 * V_558 , const char * V_559 , T_21 V_438 )
{
struct V_1 * V_2 = F_319 ( V_45 ) ;
unsigned long V_560 ;
int V_81 = - V_551 ;
if ( ! ( V_2 -> V_182 & V_561 ) )
goto V_233;
if ( ! F_31 ( V_54 , & V_2 -> V_55 ) )
goto V_233;
if ( F_320 ( V_559 , 2 , & V_560 ) )
goto V_233;
if ( ! V_2 -> V_123 -> V_562 ( V_2 , ! ! V_560 ) )
V_81 = V_438 ;
V_233:
return V_81 ;
}
static T_20
F_321 ( struct V_137 * V_45 ,
struct V_557 * V_558 , char * V_559 )
{
struct V_1 * V_2 = F_319 ( V_45 ) ;
int V_563 = 0 ;
if ( V_2 -> V_182 & V_561 )
V_563 = ! ! ( V_2 -> V_49 & V_564 ) ;
return sprintf ( V_559 , L_77 , V_563 ) ;
}
static T_20
...
{
struct V_1 * V_2 = F_319 ( V_45 ) ;
return sprintf ( V_559 , L_77 ,
! ! ( V_2 -> V_49 & V_565 ) ) ;
}
int F_324 ( struct V_17 * V_18 , T_2 V_566 , T_2 V_485 )
{
if ( ! V_170 && ! V_64 ) {
F_256 ( V_18 , L_78 ) ;
return - V_551 ;
}
if ( ( V_485 > V_566 ) || ( V_485 < 2 ) || ! F_325 ( V_485 ) ) {
F_256 ( V_18 , L_79
L_80 , V_566 ) ;
return - V_551 ;
}
...
int F_326 ( struct V_1 * V_2 , T_2 V_103 )
{
struct V_17 * V_18 = V_2 -> V_18 ;
int V_57 = 0 ;
if ( F_151 ( V_275 , & V_2 -> V_55 ) )
...
static int
F_327 ( struct V_1 * V_2 , T_5 V_567 , T_2 * V_55 ,
T_2 * V_556 )
{
* V_556 = F_328 ( V_567 ) ;
* V_55 = F_329 ( V_567 ) ;
F_285 ( V_2 , V_514 , L_82 , * V_556 , * V_55 ) ;
if ( ! * V_55 ) {
* V_556 = V_568 ;
return 0 ;
} else if ( * V_55 > V_569 )
return - V_551 ;
if ( ( ! * V_556 ) || ( * V_556 > V_568 ) )
return - V_551 ;
return 0 ;
}
static T_20
F_330 ( struct V_137 * V_45 ,
struct V_557 * V_558 , const char * V_559 , T_21 V_438 )
{
struct V_1 * V_2 = F_319 ( V_45 ) ;
int V_20 = V_2 -> V_20 ;
...
if ( V_438 != sizeof( T_5 ) )
return V_93 ;
memcpy ( & V_567 , V_559 , sizeof( T_5 ) ) ;
V_57 = F_327 ( V_2 , V_567 , & V_570 , & V_571 ) ;
if ( V_57 )
return V_57 ;
if ( V_2 -> V_67 -> V_572 == V_570 )
return V_438 ;
F_120 () ;
if ( ! V_2 -> V_67 -> V_572 )
if ( F_151 ( V_573 , & V_2 -> V_55 ) ) {
F_122 () ;
return - V_276 ;
}
if ( F_31 ( V_275 , & V_2 -> V_55 ) ) {
...
if ( ! F_31 ( V_54 , & V_2 -> V_55 ) ) {
V_57 = F_149 ( V_2 -> V_18 , V_574 ) ;
if ( V_57 )
goto V_263;
F_77 ( V_575 , & V_2 -> V_55 ) ;
}
V_57 = F_331 ( V_2 , V_570 , V_571 ) ;
if ( ! V_57 ) {
V_57 = V_438 ;
V_2 -> V_67 -> V_572 = V_570 ;
}
if ( F_124 ( V_575 , & V_2 -> V_55 ) )
F_146 ( V_2 -> V_18 , V_20 ) ;
V_263:
if ( ! V_2 -> V_67 -> V_572 )
F_80 ( V_573 , & V_2 -> V_55 ) ;
...
static T_20
F_332 ( struct V_137 * V_45 ,
struct V_557 * V_558 , char * V_559 )
{
struct V_1 * V_2 = F_319 ( V_45 ) ;
return sprintf ( V_559 , L_77 , V_2 -> V_67 -> V_572 ) ;
}
static int
...
return - V_41 ;
if ( V_376 < V_577 ) {
if ( F_334 ( V_376 , V_578 ,
V_579 ) )
V_576 = 8 ;
else
return - V_551 ;
}
if ( ( V_14 != V_576 ) || ( V_376 & ( V_576 - 1 ) ) )
return - V_551 ;
return 0 ;
}
static T_20
F_335 ( struct V_580 * V_581 , struct V_582 * V_583 ,
struct V_584 * V_558 ,
char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
T_1 V_103 ;
T_12 V_585 ;
int V_81 ;
V_81 = F_333 ( V_2 , V_376 , V_14 ) ;
if ( V_81 != 0 )
return V_81 ;
if ( F_334 ( V_376 , V_578 , V_579 ) ) {
F_336 ( V_2 , V_376 , & V_585 ) ;
memcpy ( V_559 , & V_585 , V_14 ) ;
} else {
V_103 = F_54 ( V_2 , V_376 ) ;
memcpy ( V_559 , & V_103 , V_14 ) ;
}
return V_14 ;
}
static T_20
F_337 ( struct V_580 * V_581 , struct V_582 * V_583 ,
struct V_584 * V_558 ,
char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
...
return V_81 ;
if ( F_334 ( V_376 , V_578 , V_579 ) ) {
memcpy ( & V_585 , V_559 , V_14 ) ;
F_338 ( V_2 , V_376 , V_585 ) ;
} else {
memcpy ( & V_103 , V_559 , V_14 ) ;
...
static T_20
F_340 ( struct V_580 * V_581 , struct V_582 * V_583 ,
struct V_584 * V_558 ,
char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
...
T_12 V_103 ;
int V_81 ;
V_81 = F_339 ( V_2 , V_376 , V_14 ) ;
if ( V_81 != 0 )
return V_81 ;
if ( F_341 ( V_2 , V_376 , & V_103 ) )
return - V_41 ;
memcpy ( V_559 , & V_103 , V_14 ) ;
return V_14 ;
}
static T_20
F_342 ( struct V_580 * V_581 , struct V_582 * V_583 ,
struct V_584 * V_558 ,
char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
...
return V_81 ;
memcpy ( & V_103 , V_559 , V_14 ) ;
if ( F_343 ( V_2 , V_376 , V_103 ) )
return - V_41 ;
return V_14 ;
}
static int
F_344 ( struct V_1 * V_2 ,
struct V_586 * V_587 , int V_13 )
{
T_2 V_588 , V_589 , V_590 ;
T_2 V_591 ;
int V_36 ;
for ( V_36 = 0 ; V_36 < V_13 ; V_36 ++ ) {
V_588 = V_587 [ V_36 ] . V_68 ;
V_591 = V_587 [ V_36 ] . V_225 ;
if ( V_588 >= V_83
|| V_591 >= V_83 )
return V_93 ;
if ( V_2 -> V_84 [ V_588 ] . type != V_110 )
return V_93 ;
if ( V_2 -> V_84 [ V_591 ] . type != V_110 )
return V_93 ;
V_589 = V_2 -> V_84 [ V_588 ] . V_95 ;
V_590 = V_2 -> V_84 [ V_591 ] . V_95 ;
if ( V_589 != V_590 )
return V_93 ;
}
return 0 ;
...
static T_20
F_345 ( struct V_580 * V_581 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
struct V_586 * V_587 ;
T_1 V_92 , V_592 , V_68 ;
int V_13 , V_593 , V_36 , V_81 ;
V_13 = V_14 / sizeof( struct V_586 ) ;
V_593 = V_14 % sizeof( struct V_586 ) ;
if ( V_593 )
return V_93 ;
V_587 = (struct V_586 * ) V_559 ;
V_81 = F_344 ( V_2 , V_587 , V_13 ) ;
if ( V_81 )
return V_81 ;
for ( V_36 = 0 ; V_36 < V_13 ; V_36 ++ ) {
V_68 = V_587 [ V_36 ] . V_68 ;
V_592 = ! ! V_587 [ V_36 ] . V_592 ;
...
V_68 = V_587 [ V_36 ] . V_68 ;
V_92 = V_2 -> V_84 [ V_68 ] . V_95 ;
V_2 -> V_84 [ V_68 ] . V_224 = ! ! V_587 [ V_36 ] . V_592 ;
V_2 -> V_84 [ V_68 ] . V_225 = V_92 ;
}
return V_14 ;
}
static T_20
F_346 ( struct V_580 * V_581 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
struct V_586 V_587 [ V_83 ] ;
int V_36 ;
if ( V_14 != sizeof( V_587 ) )
return V_93 ;
for ( V_36 = 0 ; V_36 < V_83 ; V_36 ++ ) {
if ( V_2 -> V_84 [ V_36 ] . type != V_110 )
continue;
V_587 [ V_36 ] . V_592 = V_2 -> V_84 [ V_36 ] . V_224 ;
V_587 [ V_36 ] . V_225 = 0 ;
V_587 [ V_36 ] . V_68 = V_36 ;
}
memcpy ( V_559 , & V_587 , V_14 ) ;
return V_14 ;
}
static int
...
static T_20
F_349 ( struct V_580 * V_580 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
...
V_593 = V_14 % sizeof( struct V_186 ) ;
if ( V_593 )
return V_93 ;
V_187 = (struct V_186 * ) V_559 ;
V_81 = F_347 ( V_2 , V_187 , V_13 ) ;
if ( V_81 )
return V_81 ;
for ( V_36 = 0 ; V_36 < V_13 ; V_36 ++ ) {
if ( V_2 -> V_114 == V_104 )
...
static T_20
F_350 ( struct V_580 * V_580 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
...
if ( V_2 -> V_84 [ V_68 ] . type != V_110 )
return V_93 ;
if ( ! F_352 ( V_597 [ V_36 ] . V_97 ) ||
! F_352 ( V_597 [ V_36 ] . V_99 ) )
return V_93 ;
}
return 0 ;
}
static T_20
F_353 ( struct V_580 * V_580 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
struct V_175 V_176 ;
struct V_596 * V_597 ;
int V_36 , V_13 , V_593 , V_81 ;
T_2 V_68 ;
V_13 = V_14 / sizeof( struct V_596 ) ;
V_593 = V_14 % sizeof( struct V_596 ) ;
if ( V_593 )
return V_93 ;
V_597 = (struct V_596 * ) V_559 ;
V_81 = F_351 ( V_2 , V_597 , V_13 ) ;
if ( V_81 )
return V_81 ;
for ( V_36 = 0 ; V_36 < V_13 ; V_36 ++ ) {
V_68 = V_597 [ V_36 ] . V_68 ;
...
return V_81 ;
V_176 . V_68 = V_68 ;
V_176 . V_222 = V_597 [ V_36 ] . V_97 ;
V_176 . V_223 = V_597 [ V_36 ] . V_99 ;
V_81 = F_90 ( V_2 , & V_176 ) ;
if ( V_81 )
return V_81 ;
...
static T_20
F_354 ( struct V_580 * V_580 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
...
V_597 [ V_36 ] . V_114 = ( T_2 ) V_176 . V_114 ;
V_597 [ V_36 ] . V_598 = V_176 . V_178 ;
V_597 [ V_36 ] . V_599 = V_176 . V_182 ;
V_597 [ V_36 ] . V_97 = V_176 . V_222 ;
V_597 [ V_36 ] . V_99 = V_176 . V_223 ;
V_597 [ V_36 ] . V_600 = V_176 . V_180 ;
V_597 [ V_36 ] . V_601 = V_176 . V_181 ;
}
memcpy ( V_559 , & V_597 , V_14 ) ;
return V_14 ;
}
static T_20
F_355 ( struct V_580 * V_580 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
struct V_602 V_603 ;
int V_81 ;
if ( V_14 != sizeof( struct V_602 ) )
return V_93 ;
if ( V_376 >= V_83 )
return V_93 ;
memset ( & V_603 , 0 , V_14 ) ;
V_81 = F_356 ( V_2 , V_376 , V_604 ,
& V_603 . V_605 ) ;
if ( V_81 )
return V_81 ;
V_81 = F_356 ( V_2 , V_376 , V_606 ,
& V_603 . V_607 ) ;
if ( V_81 )
return V_81 ;
memcpy ( V_559 , & V_603 , V_14 ) ;
return V_14 ;
}
static T_20
F_357 ( struct V_580 * V_580 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
...
return V_93 ;
memset ( & V_608 , 0 , V_14 ) ;
V_81 = F_358 ( V_2 , V_376 , V_604 ,
& V_608 . V_605 ) ;
if ( V_81 )
return V_81 ;
V_81 = F_358 ( V_2 , V_376 , V_606 ,
& V_608 . V_607 ) ;
if ( V_81 )
return V_81 ;
memcpy ( V_559 , & V_608 , V_14 ) ;
return V_14 ;
}
static T_20
F_359 ( struct V_580 * V_580 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
...
static T_20
F_361 ( struct V_580 * V_580 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
...
static T_20
F_362 ( struct V_580 * V_580 , struct V_582 * V_583 ,
struct V_584 * V_558 , char * V_559 , T_22 V_376 , T_21 V_14 )
{
struct V_137 * V_45 = F_269 ( V_583 , struct V_137 , V_583 ) ;
struct V_1 * V_2 = F_319 ( V_45 ) ;
struct V_611 V_612 [ V_83 ] ;
struct V_79 * V_80 ;
int V_36 , V_81 ;
if ( V_14 != sizeof( V_612 ) )
return V_93 ;
V_80 = F_51 ( V_83 , sizeof( * V_80 ) , V_16 ) ;
if ( ! V_80 )
return - V_21 ;
...
for ( V_36 = 0 ; V_36 < V_83 ; V_36 ++ ) {
V_612 [ V_36 ] . V_68 = V_80 [ V_36 ] . V_92 ;
V_612 [ V_36 ] . V_613 = V_80 [ V_36 ] . type ;
V_612 [ V_36 ] . V_598 = V_80 [ V_36 ] . V_96 ;
V_612 [ V_36 ] . V_97 = V_80 [ V_36 ] . V_98 ;
V_612 [ V_36 ] . V_99 = V_80 [ V_36 ] . V_100 ;
memcpy ( & V_612 [ V_36 ] . V_614 , & V_80 [ V_36 ] . V_615 , V_40 ) ;
}
memcpy ( V_559 , & V_612 , V_14 ) ;
F_9 ( V_80 ) ;
return V_14 ;
}
static void
...
struct V_17 * V_45 , unsigned long V_627 )
{
struct V_628 * V_629 ;
V_629 = F_368 ( V_45 ) ;
if ( ! V_629 )
...
static void
F_79 ( struct V_17 * V_18 , unsigned long V_627 )
{
struct V_1 * V_2 = F_30 ( V_18 ) ;
struct V_17 * V_45 ;
T_5 V_192 ;
F_367 ( V_2 , V_18 , V_627 ) ;
F_373 (vid, adapter->vlans, VLAN_N_VID) {
V_45 = F_374 ( V_18 , V_192 ) ;
if ( ! V_45 )
continue;
F_367 ( V_2 , V_45 , V_627 ) ;
}
}
static int F_375 ( struct V_634 * V_635 ,
unsigned long V_627 , void * V_636 )
{
struct V_1 * V_2 ;
struct V_17 * V_45 = (struct V_17 * ) V_636 ;
V_637:
if ( V_45 == NULL )
goto V_325;
if ( V_45 -> V_638 & V_639 ) {
...
static int
F_378 ( struct V_634 * V_635 ,
unsigned long V_627 , void * V_636 )
{
struct V_1 * V_2 ;
struct V_17 * V_45 ;
struct V_641 * V_630 = (struct V_641 * ) V_636 ;
V_45 = V_630 -> V_642 ? V_630 -> V_642 -> V_45 : NULL ;
V_637:
if ( V_45 == NULL )
goto V_325;
if ( V_45 -> V_638 & V_639 ) {
...
switch ( V_627 ) {
case V_277 :
F_370 ( V_2 , V_630 -> V_631 , V_632 ) ;
break;
case V_194 :
F_370 ( V_2 , V_630 -> V_631 , V_633 ) ;
break;
default:
break;
}
...
static void
F_79 ( struct V_17 * V_45 , unsigned long V_627 )
{ }
static int T_23 F_379 ( void )
{
int V_81 ;
F_380 ( V_643 L_96 , V_644 ) ;
V_526 = F_381 ( L_97 ) ;
if ( V_526 == NULL ) {
F_380 ( V_645 L_98 ) ;
return - V_21 ;
