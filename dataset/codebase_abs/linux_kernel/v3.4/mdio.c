...
const struct V_145 * V_53 )
{
int V_146 , V_147 ;
F_11 ( ! ( V_2 -> V_15 & V_34 ) ) ;
V_147 = V_2 -> V_8 ( V_2 -> V_9 , V_2 -> V_3 , V_36 ,
V_115 ) ;
V_146 = ( ( V_147 & ~ ( V_48 | V_50 ) ) |
F_12 ( ( V_53 -> V_148 ? V_149 : 0 ) |
( V_53 -> V_150 ? V_151 : 0 ) ) ) ;
if ( V_146 != V_147 ) {
...
if ( ( V_2 -> V_65 & V_59 ) &&
F_14 ( V_153 -> V_158 ) ) {
V_3 = F_15 ( V_153 -> V_158 ) ;
V_17 = F_16 ( V_153 -> V_158 ) ;
} else if ( ( V_2 -> V_65 & V_57 ) &&
V_153 -> V_158 < 0x20 ) {
V_3 = V_153 -> V_158 ;
V_17 = V_161 ;
V_18 &= 0x1f ;
} else if ( ( V_2 -> V_65 & V_162 ) &&
V_2 -> V_3 != V_157 &&
V_153 -> V_158 == V_2 -> V_3 ) {
V_3 = V_2 -> V_3 ;
switch ( V_18 ) {
...
if ( V_154 == V_159 ) {
int V_170 = V_2 -> V_8 ( V_2 -> V_9 , V_3 , V_17 , V_18 ) ;
if ( V_170 < 0 )
return V_170 ;
V_153 -> V_171 = V_170 ;
return 0 ;
