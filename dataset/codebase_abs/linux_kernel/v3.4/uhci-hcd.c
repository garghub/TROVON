...
for ( V_82 = V_117 + 1 ; V_82 < V_118 ; ++ V_82 )
V_2 -> V_6 [ V_82 ] -> V_119 = F_3 ( V_2 , V_2 -> V_120 ) ;
V_2 -> V_120 -> V_119 = F_64 ( V_2 ) ;
V_2 -> V_121 -> V_119 = F_3 ( V_2 , V_2 -> V_121 ) ;
F_65 ( V_2 , V_2 -> V_87 , 0 , F_66 ( 0 ) |
( 0x7f << V_122 ) | V_123 , 0 ) ;
V_2 -> V_87 -> V_119 = F_64 ( V_2 ) ;
V_2 -> V_120 -> V_124 = V_2 -> V_121 -> V_124 =
F_67 ( V_2 , V_2 -> V_87 ) ;
...
struct V_113 * V_130 ;
F_29 ( & V_2 -> V_41 ) ;
V_130 = (struct V_113 * ) V_129 -> V_131 ;
if ( V_130 == NULL )
goto V_132;
while ( V_130 -> V_133 != V_134 ) {
++ V_2 -> V_135 ;
F_27 ( & V_2 -> V_41 ) ;
F_75 ( V_2 -> V_100 ,
V_130 -> V_133 == V_134 ) ;
...
if ( F_81 () )
return - V_140 ;
F_82 ( V_141 L_32 V_142 L_33 ,
V_38 ? L_34 : L_7 ) ;
F_30 ( V_143 , & V_144 ) ;
if ( V_83 ) {
V_78 = F_83 ( V_79 , V_109 ) ;
if ( ! V_78 )
goto V_145;
V_105 = F_84 ( L_35 , V_146 ) ;
if ( ! V_105 )
goto V_147;
}
V_148 = F_85 ( L_36 ,
