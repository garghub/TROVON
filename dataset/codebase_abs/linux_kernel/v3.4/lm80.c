...
struct V_11 * V_12 ;
int V_18 ;
V_12 = F_30 ( sizeof( struct V_11 ) , V_46 ) ;
if ( ! V_12 ) {
V_18 = - V_47 ;
goto exit;
}
...
static int F_15 ( struct V_15 * V_16 , T_4 V_22 , T_4 V_53 )
{
return F_40 ( V_16 , V_22 , V_53 ) ;
}
...
if ( V_12 -> error )
F_33 ( V_16 ) ;
if ( F_41 ( V_58 , V_12 -> V_59 + 2 * V_60 ) || ! V_12 -> V_61 ) {
F_42 ( & V_16 -> V_5 , L_8 ) ;
for ( V_31 = 0 ; V_31 <= 6 ; V_31 ++ ) {
V_55 = F_21 ( V_16 , F_43 ( V_31 ) ) ;
if ( V_55 < 0 )
goto abort;
V_12 -> V_62 [ V_31 ] = V_55 ;
V_55 = F_21 ( V_16 , F_44 ( V_31 ) ) ;
if ( V_55 < 0 )
goto abort;
V_12 -> V_63 [ V_31 ] = V_55 ;
V_55 = F_21 ( V_16 , F_45 ( V_31 ) ) ;
if ( V_55 < 0 )
goto abort;
V_12 -> V_64 [ V_31 ] = V_55 ;
}
...
goto abort;
V_12 -> V_66 [ 1 ] = V_55 ;
V_55 = F_21 ( V_16 , F_16 ( 2 ) ) ;
if ( V_55 < 0 )
goto abort;
V_12 -> V_20 [ 1 ] = V_55 ;
V_56 = V_55 = F_21 ( V_16 , V_68 ) ;
if ( V_55 < 0 )
goto abort;
V_55 = F_21 ( V_16 , V_54 ) ;
if ( V_55 < 0 )
goto abort;
V_12 -> V_2 = ( V_56 << 8 ) | ( V_55 & 0xf0 ) ;
V_55 = F_21 ( V_16 , V_69 ) ;
if ( V_55 < 0 )
goto abort;
V_12 -> V_70 = V_55 ;
...
if ( V_55 < 0 )
goto abort;
V_12 -> V_13 [ 0 ] = ( V_55 >> 2 ) & 0x03 ;
V_12 -> V_13 [ 1 ] = ( V_55 >> 4 ) & 0x03 ;
V_56 = V_55 = F_21 ( V_16 , V_77 ) ;
if ( V_55 < 0 )
goto abort;
V_55 = F_21 ( V_16 , V_38 ) ;
if ( V_55 < 0 )
goto abort;
V_12 -> V_25 = V_56 + ( V_55 << 8 ) ;
V_12 -> V_59 = V_58 ;
V_12 -> V_61 = 1 ;
V_12 -> error = 0 ;
}
