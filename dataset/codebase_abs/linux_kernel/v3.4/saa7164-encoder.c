...
static int F_51 ( struct V_127 * V_29 ,
struct V_184 * V_15 )
{
switch ( V_15 -> V_12 ) {
case V_107 :
...
static int F_53 ( struct V_58 * V_58 , void * V_59 ,
struct V_184 * V_15 )
{
...
struct V_1 * V_2 ;
struct V_60 * V_61 ;
V_2 = (struct V_1 * ) F_65 ( F_66 ( V_58 ) ) ;
if ( ! V_2 )
return - V_32 ;
V_4 = V_2 -> V_4 ;
F_2 ( V_5 , L_1 , V_6 ) ;
V_61 = F_67 ( sizeof( * V_61 ) , V_200 ) ;
if ( NULL == V_61 )
return - V_53 ;
V_58 -> V_62 = V_61 ;
V_61 -> V_2 = V_2 ;
...
static int F_68 ( struct V_58 * V_58 )
{
struct V_60 * V_61 = V_58 -> V_62 ;
struct V_1 * V_2 = V_61 -> V_2 ;
struct V_3 * V_4 = V_2 -> V_4 ;
F_2 ( V_5 , L_1 , V_6 ) ;
if ( F_69 ( & V_61 -> V_201 , 1 , 0 ) == 1 ) {
if ( F_70 ( & V_2 -> V_202 ) == 0 ) {
F_58 ( V_2 ) ;
}
}
...
V_63 V_203 ;
F_7 ( & V_2 -> V_25 ) ;
if ( ! F_73 ( & V_2 -> V_204 . V_27 ) ) {
V_24 = F_74 ( & V_2 -> V_204 . V_27 ,
struct V_23 , V_27 ) ;
if ( V_205 ) {
V_203 = F_75 ( 0 , V_24 -> V_206 , V_24 -> V_207 ) ;
if ( V_203 != V_24 -> V_203 ) {
F_17 ( V_52
L_48 ,
V_6 ,
...
static T_2 F_76 ( struct V_58 * V_58 , char T_3 * V_208 ,
T_4 V_148 , T_5 * V_196 )
{
struct V_60 * V_61 = V_58 -> V_62 ;
struct V_1 * V_2 = V_61 -> V_2 ;
...
static unsigned int F_83 ( struct V_58 * V_58 , T_7 * V_222 )
{
struct V_60 * V_61 =
...
int F_85 ( struct V_58 * V_58 , void * V_61 ,
struct V_230 * V_231 )
{
...
int F_88 ( struct V_58 * V_58 , void * V_61 ,
struct V_232 * V_233 )
{
struct V_1 * V_2 = ( (struct V_60 * ) V_61 ) -> V_2 ;
struct V_3 * V_4 = V_2 -> V_4 ;
