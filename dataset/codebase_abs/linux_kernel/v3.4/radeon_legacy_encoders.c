...
static enum V_130 F_74 ( struct V_1 * V_2 ,
struct V_89 * V_131 )
{
struct V_11 * V_12 = V_2 -> V_12 ;
struct V_13 * V_14 = V_12 -> V_15 ;
...
bool V_137 = true ;
struct V_285 * V_58 ;
F_75 (crtc, &dev->mode_config.crtc_list, head) {
...
static struct V_160 * F_76 ( struct V_3 * V_2 )
{
struct V_11 * V_12 = V_2 -> V_88 . V_12 ;
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_160 * V_161 = NULL ;
bool V_300 ;
V_161 = F_77 ( sizeof( struct V_160 ) , V_91 ) ;
if ( ! V_161 )
return NULL ;
if ( V_14 -> V_26 )
V_300 = F_78 ( V_2 , V_161 ) ;
else
...
static struct V_203 * F_81 ( struct V_3 * V_2 )
{
struct V_11 * V_12 = V_2 -> V_88 . V_12 ;
struct V_13 * V_14 = V_12 -> V_15 ;
...
if ( V_14 -> V_26 )
return NULL ;
V_161 = F_77 ( sizeof( struct V_203 ) , V_91 ) ;
if ( ! V_161 )
return NULL ;
V_300 = F_82 ( V_2 , V_161 ) ;
if ( V_300 == false )
F_83 ( V_2 , V_161 ) ;
return V_161 ;
}
void
F_84 ( struct V_11 * V_12 , T_1 V_301 , T_1 V_302 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_1 * V_2 ;
struct V_3 * V_3 ;
F_75 (encoder, &dev->mode_config.encoder_list, head) {
V_3 = F_2 ( V_2 ) ;
if ( V_3 -> V_301 == V_301 ) {
V_3 -> V_303 |= V_302 ;
return;
...
V_3 = F_77 ( sizeof( struct V_3 ) , V_91 ) ;
if ( ! V_3 )
return;
V_2 = & V_3 -> V_88 ;
if ( V_14 -> V_304 & V_305 )
...
break;
case V_315 :
F_85 ( V_12 , V_2 , & V_316 , V_317 ) ;
F_86 ( V_2 , & V_318 ) ;
V_3 -> V_25 = F_76 ( V_3 ) ;
break;
case V_319 :
F_85 ( V_12 , V_2 , & V_320 , V_321 ) ;
F_86 ( V_2 , & V_322 ) ;
if ( V_14 -> V_26 )
V_3 -> V_25 = F_89 ( V_3 ) ;
else
