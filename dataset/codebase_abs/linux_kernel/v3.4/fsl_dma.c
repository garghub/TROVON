...
if ( ! V_46 -> V_28 -> V_51 )
V_46 -> V_28 -> V_51 = V_49 ;
if ( V_48 -> V_52 [ V_11 ] . V_2 ) {
V_32 = F_17 ( V_53 , V_46 -> V_28 ,
V_54 . V_55 ,
& V_48 -> V_52 [ V_11 ] . V_2 -> V_56 ) ;
if ( V_32 ) {
F_12 ( V_46 -> V_28 , L_3 ) ;
return V_32 ;
}
}
if ( V_48 -> V_52 [ V_57 ] . V_2 ) {
V_32 = F_17 ( V_53 , V_46 -> V_28 ,
V_54 . V_55 ,
& V_48 -> V_52 [ V_57 ] . V_2 -> V_56 ) ;
if ( V_32 ) {
F_12 ( V_46 -> V_28 , L_4 ) ;
F_18 ( & V_48 -> V_52 [ V_11 ] . V_2 -> V_56 ) ;
return V_32 ;
}
}
return 0 ;
...
struct V_27 * V_28 = V_25 -> V_29 -> V_28 ;
struct V_60 * V_61 =
F_20 ( V_25 -> V_29 -> V_62 , struct V_60 , V_63 ) ;
struct V_5 * V_6 ;
...
V_109 = F_38 ( V_59 , V_108 - V_6 -> V_20 ) ;
if ( V_109 == V_59 -> V_94 )
V_109 = 0 ;
return V_109 ;
}
...
struct V_1 * V_2 ;
unsigned int V_68 ;
for ( V_68 = 0 ; V_68 < F_44 ( V_48 -> V_52 ) ; V_68 ++ ) {
V_2 = V_48 -> V_52 [ V_68 ] . V_2 ;
if ( V_2 ) {
F_18 ( & V_2 -> V_56 ) ;
V_2 -> V_56 . V_119 = NULL ;
V_2 -> V_56 . V_78 = 0 ;
...
static int T_8 F_49 ( struct V_124 * V_125 )
{
struct V_60 * V_61 ;
...
V_61 = F_51 ( sizeof( * V_61 ) + strlen ( V_123 -> V_131 ) , V_72 ) ;
if ( ! V_61 ) {
F_12 ( & V_125 -> V_28 , L_17 ) ;
F_48 ( V_122 ) ;
return - V_73 ;
}
strcpy ( V_61 -> V_132 , V_123 -> V_131 ) ;
V_61 -> V_63 . V_133 = & V_134 ;
V_61 -> V_63 . V_135 = F_15 ;
V_61 -> V_63 . V_136 = F_43 ;
V_61 -> V_75 = V_128 . V_137 + F_52 ( struct V_138 , V_139 ) ;
V_61 -> V_76 = V_128 . V_137 + F_52 ( struct V_138 , V_140 ) ;
V_129 = F_53 ( V_122 , L_18 , NULL ) ;
if ( V_129 )
V_61 -> V_77 = F_54 ( V_129 ) ;
else
V_61 -> V_77 = 8 ;
F_48 ( V_122 ) ;
V_32 = F_55 ( & V_125 -> V_28 , & V_61 -> V_63 ) ;
if ( V_32 ) {
F_12 ( & V_125 -> V_28 , L_19 ) ;
F_56 ( V_61 ) ;
return V_32 ;
}
V_61 -> V_67 = F_57 ( V_123 , 0 ) ;
V_61 -> V_22 = F_58 ( V_123 , 0 ) ;
F_59 ( & V_125 -> V_28 , V_61 ) ;
return 0 ;
}
static int T_10 F_60 ( struct V_124 * V_125 )
{
struct V_60 * V_61 = F_61 ( & V_125 -> V_28 ) ;
F_62 ( & V_125 -> V_28 ) ;
F_63 ( V_61 -> V_67 ) ;
F_64 ( V_61 -> V_22 ) ;
F_56 ( V_61 ) ;
