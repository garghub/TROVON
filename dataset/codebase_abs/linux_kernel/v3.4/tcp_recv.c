...
F_3 ( L_10 ,
V_19 , V_48 , V_14 -> V_19 ,
F_28 ( & V_44 -> V_58 -> V_59 -> V_60 ) ) ;
return V_19 - V_48 ;
}
static int F_29 ( struct V_24 * V_25 , T_3 V_49 )
{
struct V_43 * V_44 = V_25 -> V_45 ;
struct V_61 * V_62 = V_44 -> V_58 ;
T_2 V_38 ;
struct V_40 V_41 ;
V_41 . V_25 = V_25 ;
V_41 . V_49 = V_49 ;
...
struct V_61 * V_62 = V_44 -> V_58 ;
int V_17 = 0 ;
F_3 ( L_12 , V_25 , V_44 , V_62 ) ;
F_32 ( V_62 -> V_59 ) ;
V_17 = F_29 ( V_25 , V_64 ) ;
F_33 ( V_62 -> V_59 ) ;
return V_17 ;
}
void F_34 ( struct V_62 * V_59 , int V_65 )
{
void (* F_35)( struct V_62 * V_59 , int V_65 );
struct V_24 * V_25 ;
struct V_43 * V_44 ;
F_3 ( L_13 , V_59 , V_65 ) ;
F_36 ( & V_59 -> V_66 ) ;
...
F_35 = V_44 -> V_69 ;
F_37 ( V_70 ) ;
if ( F_29 ( V_25 , V_71 ) == - V_50 )
F_38 ( V_72 , & V_25 -> V_73 , 0 ) ;
V_18:
F_39 ( & V_59 -> V_66 ) ;
F_35 ( V_59 , V_65 ) ;
}
