...
goto V_18;
F_26 ( V_13 ) ;
V_42 -> V_48 [ V_62 ] . V_40 = F_35 ( V_75 , V_13 ,
& V_76 ) ;
if ( V_42 -> V_48 [ V_62 ] . V_40 ) {
V_47 -> V_56 = V_42 -> V_48 [ V_62 ] . V_40 -> V_70 . V_71 ;
V_42 -> V_48 [ V_62 ] . V_40 -> V_70 . V_71 = F_16 ;
...
static T_3 F_43 ( struct V_98 * V_99 )
{
return V_100 ;
}
...
V_112 . V_99 = & V_2 -> V_69 ;
V_112 . V_14 = 0xa0 >> 1 ;
V_9 = F_48 ( & V_112 , V_110 , sizeof( V_110 ) ) ;
if ( F_5 ( V_9 ) )
return 0 ;
F_49 ( & V_112 , & V_13 -> V_113 ,
( 0x84 == V_110 [ 0xa0 ] ) ?
