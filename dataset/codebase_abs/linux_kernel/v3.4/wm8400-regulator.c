...
return - V_9 ;
if ( V_10 < 1700000 ) {
V_4 = F_11 ( V_10 - 900000 , 50000 ) ;
if ( ( V_4 * 50000 ) + 900000 > V_11 )
return - V_9 ;
F_12 ( ( V_4 * 50000 ) + 900000 < V_10 ) ;
} else {
V_4 = F_11 ( V_10 - 1700000 , 100000 ) ;
if ( ( V_4 * 100000 ) + 1700000 > V_11 )
return - V_9 ;
F_12 ( ( V_4 * 100000 ) + 1700000 < V_10 ) ;
V_4 += 0xf ;
}
* V_7 = V_4 ;
return F_6 ( V_3 , V_5 + F_4 ( V_2 ) ,
...
if ( V_10 < 850000 )
return - V_9 ;
V_4 = F_11 ( V_10 - 850000 , 25000 ) ;
if ( 850000 + ( 25000 * V_4 ) > V_11 )
return - V_9 ;
F_12 ( 850000 + ( 25000 * V_4 ) < V_10 ) ;
* V_7 = V_4 ;
return F_6 ( V_3 , V_14 + V_12 ,
V_16 , V_4 ) ;
}
...
static int F_21 ( struct V_1 * V_2 , unsigned int V_26 )
{
struct V_3 * V_3 = F_2 ( V_2 ) ;
int V_12 = ( F_4 ( V_2 ) - V_13 ) * 2 ;
int V_18 ;
...
{
struct V_3 * V_3 = F_24 ( V_32 , struct V_3 , V_33 [ V_32 -> V_34 ] ) ;
struct V_1 * V_35 ;
V_35 = F_25 ( & V_33 [ V_32 -> V_34 ] , & V_32 -> V_2 ,
...
{
struct V_1 * V_35 = F_30 ( V_32 ) ;
F_28 ( V_32 , NULL ) ;
F_31 ( V_35 ) ;
return 0 ;
}
int F_32 ( struct V_37 * V_2 , int V_38 ,
struct V_39 * V_40 )
{
struct V_3 * V_3 = F_33 ( V_2 ) ;
