...
case F_18 ( 2 ) :
case F_18 ( 3 ) :
F_107 ( V_23 , V_7 , V_61 & 0xff ) ;
F_107 ( V_23 , V_7 + 1 , V_61 >> 8 ) ;
break;
default:
F_107 ( V_23 , V_7 , V_61 ) ;
break;
...
int V_137 = F_35 ( V_23 ,
V_138 ) ;
V_18 -> V_43 [ 0 ] = V_135 & 0x0f ;
V_18 -> V_43 [ 1 ] = V_137 & 0x0f ;
V_18 -> V_43 [ 2 ] = V_137 >> 4 ;
V_18 -> V_43 [ 3 ] = V_135 >> 4 ;
V_18 -> V_43 [ 4 ] = V_130 >> 4 ;
V_18 -> V_47 [ 0 ] = V_128 & 0x0f ;
V_18 -> V_47 [ 1 ] = V_130 & 0x0f ;
V_18 -> V_47 [ 2 ] = V_128 >> 4 ;
}
V_18 -> V_126 = V_125 ;
}
