...
{
struct V_54 * V_54 = F_105 ( V_17 , struct V_54 , V_114 ) ;
struct V_23 * V_43 = V_54 -> V_43 ;
if ( F_103 ( V_54 ) )
F_64 ( V_54 , V_115 ) ;
F_106 ( & V_43 -> V_81 ) ;
...
{
struct V_54 * V_54 ;
V_54 = F_108 ( sizeof( * V_54 ) , V_116 ) ;
if ( V_54 ) {
F_109 ( & V_54 -> V_56 ) ;
F_109 ( & V_54 -> V_117 ) ;
F_110 ( & V_54 -> V_114 , F_104 ) ;
V_54 -> V_10 = V_118 ;
}
return V_54 ;
}
static struct V_54 * F_111 ( struct V_23 * V_43 , bool V_119 )
{
bool V_120 = V_43 -> V_1 == V_6 ;
struct V_54 * V_54 = NULL ;
int V_121 = - 1 ;
F_112 ( & V_43 -> V_81 ) ;
while ( F_113 ( & V_43 -> V_122 , & V_121 ) ) {
F_106 ( & V_43 -> V_81 ) ;
if ( ! F_114 ( & V_43 -> V_122 , V_116 ) )
goto V_123;
F_112 ( & V_43 -> V_81 ) ;
}
F_106 ( & V_43 -> V_81 ) ;
...
V_54 -> V_121 = V_121 ;
if ( ! V_120 )
V_54 -> V_57 = F_115 ( V_124 ,
V_54 ,
F_116 ( V_43 -> V_1 ) ,
L_1 , V_43 -> V_1 , V_121 ) ;
else
V_54 -> V_57 = F_117 ( V_124 , V_54 ,
L_2 , V_121 ) ;
if ( F_118 ( V_54 -> V_57 ) )
goto V_123;
if ( V_119 && ! V_120 )
...
static void F_125 ( unsigned long V_129 )
{
...
struct V_54 * V_54 ;
unsigned long V_102 ;
V_54 = F_126 ( V_43 -> V_55 . V_130 , struct V_54 , V_56 ) ;
...
if ( V_1 == V_6 )
V_1 = 0 ;
if ( ! F_129 ( V_1 , V_9 -> V_132 ) )
F_55 ( V_9 -> V_133 -> V_57 ) ;
return true ;
}
static void F_130 ( unsigned long V_129 )
{
struct V_23 * V_43 = ( void * ) V_129 ;
struct V_13 * V_17 ;
F_112 ( & V_43 -> V_81 ) ;
...
return;
V_36 -> V_143 = - 1 ;
if ( F_61 ( & V_36 -> V_9 -> V_144 ) )
F_140 ( & V_36 -> V_9 -> V_145 -> V_146 ) ;
}
static void F_141 ( struct V_54 * V_54 , struct V_13 * V_17 )
__releases( &gcwq->lock
static void F_142 ( struct V_54 * V_54 )
{
while ( ! F_45 ( & V_54 -> V_117 ) ) {
struct V_13 * V_17 = F_53 ( & V_54 -> V_117 ,
struct V_13 , V_56 ) ;
F_141 ( V_54 , V_17 ) ;
}
}
...
F_141 ( V_54 , V_17 ) ;
if ( F_52 ( ! F_45 ( & V_54 -> V_117 ) ) )
F_142 ( V_54 ) ;
} else {
F_134 ( V_17 , & V_54 -> V_117 , NULL ) ;
F_142 ( V_54 ) ;
}
} while ( F_47 ( V_43 ) );
F_62 ( V_54 , V_118 , false ) ;
V_151:
...
V_133 -> V_43 = V_43 ;
F_103 ( V_133 ) ;
F_32 ( ! F_45 ( & V_133 -> V_117 ) ) ;
F_151 (work, n, &gcwq->worklist, entry)
if ( F_39 ( V_17 ) == V_36 )
F_134 ( V_17 , V_117 , & V_138 ) ;
F_142 ( V_133 ) ;
if ( F_47 ( V_43 ) )
F_54 ( V_43 ) ;
F_106 ( & V_43 -> V_81 ) ;
...
{
struct V_159 * V_160 = F_105 ( V_17 , struct V_159 , V_17 ) ;
F_140 ( & V_160 -> V_146 ) ;
}
...
F_154 ( & V_160 -> V_17 , F_152 ) ;
F_155 ( V_94 , F_10 ( & V_160 -> V_17 ) ) ;
F_156 ( & V_160 -> V_146 ) ;
if ( V_54 )
...
if ( V_143 >= 0 && F_61 ( & V_9 -> V_144 ) )
F_140 ( & V_9 -> V_145 -> V_146 ) ;
return V_165 ;
}
void F_160 ( struct V_8 * V_9 )
{
struct V_166 V_167 = {
. V_168 = F_161 ( V_167 . V_168 ) ,
. V_143 = - 1 ,
. V_146 = F_162 ( V_167 . V_146 ) ,
} ;
int V_169 ;
F_163 ( & V_9 -> V_170 ) ;
F_164 ( & V_9 -> V_170 ) ;
...
V_9 -> V_88 = V_169 ;
if ( ! V_9 -> V_145 ) {
F_32 ( V_9 -> V_143 != V_167 . V_143 ) ;
V_9 -> V_145 = & V_167 ;
if ( ! F_157 ( V_9 , V_9 -> V_143 ,
V_9 -> V_88 ) ) {
V_9 -> V_143 = V_169 ;
V_9 -> V_145 = NULL ;
goto V_173;
...
F_32 ( V_9 -> V_143 == V_167 . V_143 ) ;
F_74 ( & V_167 . V_168 , & V_9 -> V_174 ) ;
F_157 ( V_9 , - 1 , V_9 -> V_88 ) ;
}
} else {
F_74 ( & V_167 . V_168 , & V_9 -> V_172 ) ;
}
F_166 ( & V_9 -> V_171 ) ;
F_167 ( & V_167 . V_146 ) ;
if ( V_9 -> V_145 != & V_167 )
...
F_32 ( ! F_45 ( & V_9 -> V_172 ) &&
V_9 -> V_143 != F_30 ( V_9 -> V_88 ) ) ;
V_9 -> V_143 = F_30 ( V_9 -> V_143 ) ;
if ( ! F_45 ( & V_9 -> V_172 ) ) {
...
if ( F_45 ( & V_9 -> V_174 ) ) {
F_32 ( V_9 -> V_143 != V_9 -> V_88 ) ;
break;
}
F_32 ( V_9 -> V_143 == V_9 -> V_88 ) ;
F_32 ( V_9 -> V_143 != V_107 -> V_143 ) ;
F_102 ( & V_107 -> V_168 ) ;
V_9 -> V_145 = V_107 ;
if ( F_157 ( V_9 , V_9 -> V_143 , - 1 ) )
break;
V_9 -> V_145 = NULL ;
}
V_173:
...
V_179 = ! V_36 -> V_89 && F_45 ( & V_36 -> V_92 ) ;
...
static bool F_173 ( struct V_13 * V_17 , struct V_159 * V_160 ,
bool V_181 )
{
struct V_54 * V_54 = NULL ;
struct V_23 * V_43 ;
...
goto V_182;
F_153 ( V_36 , V_160 , V_17 , V_54 ) ;
F_106 ( & V_43 -> V_81 ) ;
if ( V_36 -> V_9 -> V_183 == 1 || V_36 -> V_9 -> V_10 & V_131 )
F_163 ( & V_36 -> V_9 -> V_170 ) ;
else
F_176 ( & V_36 -> V_9 -> V_170 ) ;
...
V_54 = F_69 ( V_43 , V_17 ) ;
if ( F_52 ( V_54 ) )
F_153 ( V_54 -> V_82 , & V_160 , V_17 , V_54 ) ;
F_106 ( & V_43 -> V_81 ) ;
if ( F_52 ( V_54 ) ) {
F_167 ( & V_160 . V_146 ) ;
F_21 ( & V_160 . V_17 ) ;
...
{
return F_84 ( V_186 , V_17 ) ;
}
int F_189 ( int V_1 , struct V_13 * V_17 )
{
return F_85 ( V_1 , V_186 , V_17 ) ;
}
int F_190 ( struct V_96 * V_97 ,
unsigned long V_98 )
{
return F_91 ( V_186 , V_97 , V_98 ) ;
}
int F_191 ( int V_1 ,
struct V_96 * V_97 , unsigned long V_98 )
{
return F_92 ( V_1 , V_186 , V_97 , V_98 ) ;
}
int F_192 ( T_2 V_14 )
{
int V_1 ;
struct V_13 T_3 * V_187 ;
V_187 = F_193 ( struct V_13 ) ;
if ( ! V_187 )
return - V_188 ;
F_194 () ;
F_195 (cpu) {
struct V_13 * V_17 = F_27 ( V_187 , V_1 ) ;
F_110 ( V_17 , V_14 ) ;
F_189 ( V_1 , V_17 ) ;
}
F_195 (cpu)
F_177 ( F_27 ( V_187 , V_1 ) ) ;
F_196 () ;
F_197 ( V_187 ) ;
return 0 ;
}
...
int F_199 ( T_2 V_189 , struct V_190 * V_191 )
{
if ( ! F_200 () ) {
V_189 ( & V_191 -> V_17 ) ;
return 0 ;
}
F_110 ( & V_191 -> V_17 , V_189 ) ;
F_188 ( & V_191 -> V_17 ) ;
return 1 ;
}
int F_201 ( void )
...
const T_4 V_193 = F_203 ( T_4 , 1 << V_40 ,
F_204 (unsigned long long) ) ;
if ( ! ( V_9 -> V_10 & V_11 ) )
V_9 -> V_28 . V_29 = F_205 ( V_192 , V_193 ) ;
else {
void * V_194 ;
V_194 = F_108 ( V_192 + V_193 + sizeof( void * ) , V_116 ) ;
if ( V_194 ) {
V_9 -> V_28 . V_30 = F_206 ( V_194 , V_193 ) ;
* ( void * * ) ( V_9 -> V_28 . V_30 + 1 ) = V_194 ;
}
}
F_32 ( ! F_207 ( V_9 -> V_28 . V_66 , V_193 ) ) ;
...
if ( V_90 < 1 || V_90 > V_195 )
F_210 ( V_198 L_4
L_5 ,
V_90 , V_180 , 1 , V_195 ) ;
return F_211 ( V_90 , 1 , V_195 ) ;
}
struct V_8 * F_212 ( const char * V_199 ,
unsigned int V_10 ,
int V_90 ,
struct V_200 * V_201 ,
const char * V_202 , ... )
...
va_start ( args , V_202 ) ;
F_213 ( V_203 , args ) ;
V_204 = vsnprintf ( NULL , 0 , V_199 , args ) + 1 ;
V_9 = F_108 ( sizeof( * V_9 ) + V_204 , V_116 ) ;
if ( ! V_9 )
goto V_205;
vsnprintf ( V_9 -> V_180 , V_204 , V_199 , V_203 ) ;
va_end ( args ) ;
va_end ( V_203 ) ;
if ( V_10 & V_206 )
V_10 |= V_131 ;
...
V_10 |= V_76 ;
V_90 = V_90 ? : V_207 ;
V_90 = F_209 ( V_90 , V_10 , V_9 -> V_180 ) ;
V_9 -> V_10 = V_10 ;
V_9 -> V_183 = V_90 ;
F_214 ( & V_9 -> V_171 ) ;
F_158 ( & V_9 -> V_144 , 0 ) ;
...
goto V_205;
V_9 -> V_133 = V_133 = F_107 () ;
if ( ! V_133 )
goto V_205;
V_133 -> V_57 = F_117 ( F_145 , V_9 , L_6 ,
V_9 -> V_180 ) ;
if ( F_118 ( V_133 -> V_57 ) )
goto V_205;
...
F_170 ( & V_176 ) ;
if ( V_209 && V_9 -> V_10 & V_210 )
F_159 (cpu, wq)
F_25 ( V_1 , V_9 ) -> V_90 = 0 ;
F_98 ( & V_9 -> V_168 , & V_211 ) ;
F_171 ( & V_176 ) ;
return V_9 ;
V_205:
if ( V_9 ) {
...
{
unsigned int V_1 ;
V_90 = F_209 ( V_90 , V_9 -> V_10 , V_9 -> V_180 ) ;
F_170 ( & V_176 ) ;
V_9 -> V_183 = V_90 ;
F_159 (cpu, wq) {
struct V_23 * V_43 = F_22 ( V_1 ) ;
...
static int T_6 F_224 ( void * V_129 )
{
...
if ( F_226 ( false , V_219 ) < 0 )
break;
}
do {
V_215 = F_225 ( ! F_45 ( & V_43 -> V_55 ) ) ;
while ( ! F_45 ( & V_43 -> V_55 ) )
F_123 ( F_53 ( & V_43 -> V_55 ,
struct V_54 , V_56 ) ) ;
} while ( V_43 -> V_52 && V_215 >= 0 );
F_13 ( ! F_45 ( & V_43 -> V_55 ) ) ;
F_79 (worker, i, pos, gcwq) {
...
continue;
F_16 ( V_114 ) ;
F_72 ( F_25 ( V_43 -> V_1 , V_186 ) , V_114 ,
V_54 -> V_117 . V_107 ,
F_28 ( V_142 ) ) ;
}
V_43 -> V_10 &= ~ V_50 ;
...
switch ( V_223 ) {
case V_229 :
F_32 ( V_43 -> V_136 || V_43 -> V_216 != V_220 ) ;
V_43 -> V_136 = V_225 ;
V_43 -> V_216 = V_233 ;
F_55 ( V_43 -> V_136 ) ;
F_227 ( V_43 , V_217 ) ;
...
V_244 -> V_93 = V_244 -> V_189 ( V_244 -> V_245 ) ;
F_140 ( & V_244 -> V_246 ) ;
return 0 ;
}
long F_232 ( unsigned int V_1 , long (* V_189)( void * ) , void * V_245 )
{
struct V_58 * V_247 ;
struct V_243 V_244 = {
...
struct V_8 * V_9 ;
F_112 ( & V_43 -> V_81 ) ;
F_32 ( V_43 -> V_10 & V_212 ) ;
V_43 -> V_10 |= V_212 ;
F_71 (wq, &workqueues, list) {
struct V_27 * V_36 = F_25 ( V_1 , V_9 ) ;
if ( V_36 && V_9 -> V_10 & V_210 )
V_36 -> V_90 = 0 ;
}
F_106 ( & V_43 -> V_81 ) ;
}
