...
struct V_1 * * V_70 = V_50 -> args . V_70 ;
int V_71 = V_50 -> args . V_72 >> V_73 ;
F_2 ( L_15 , V_18 ,
V_50 -> V_74 , V_68 , ( unsigned int ) V_50 -> args . V_75 ) ;
V_28 = F_14 ( V_50 ) ;
if ( ! V_28 )
goto V_76;
V_28 -> V_19 = F_41 ;
V_4 = ( T_1 ) ( V_68 >> V_77 ) ;
for ( V_64 = V_71 ; V_64 < V_50 -> V_74 ; V_64 ++ ) {
if ( ! V_67 ) {
F_45 ( V_3 ) ;
F_45 ( V_66 ) ;
V_20 = F_24 ( V_23 , V_20 ) ;
...
V_20 = F_24 ( V_23 , V_20 ) ;
F_2 ( L_16 , V_18 ) ;
F_48 ( V_70 [ V_64 ] , 0 , V_41 ) ;
F_1 ( V_70 [ V_64 ] ) ;
F_36 ( V_70 [ V_64 ] ) ;
} else {
struct V_2 * V_81 ;
V_81 = ( V_65 && V_66 ) ? V_66 : V_3 ;
V_20 = F_30 ( V_20 , V_50 -> V_74 - V_64 , V_23 ,
V_4 , V_70 [ V_64 ] , V_81 ,
F_33 , V_28 ) ;
if ( F_49 ( V_20 ) ) {
V_50 -> V_52 = F_50 ( V_20 ) ;
...
V_50 -> V_85 . V_86 = 1 ;
V_50 -> V_85 . V_75 = V_50 -> V_83 -> V_84 - V_68 ;
} else {
V_50 -> V_85 . V_75 = ( V_4 << V_77 ) - V_68 ;
}
V_78:
F_45 ( V_3 ) ;
F_45 ( V_66 ) ;
...
struct V_2 * V_3 ;
struct V_92 * V_93 ;
F_2 ( L_18 , V_18 , V_69 , V_75 ) ;
if ( V_75 == 0 )
return;
V_4 = ( V_69 & ( long ) ( V_94 ) ) >> V_77 ;
V_91 = ( V_69 + V_75 + V_41 - 1 ) & ( long ) ( V_94 ) ;
V_91 >>= V_77 ;
while ( V_4 < V_91 ) {
T_1 V_95 ;
...
static struct V_1 *
F_73 ( struct V_83 * V_83 , T_5 V_113 ,
struct V_2 * V_66 )
{
struct V_1 * V_1 ;
int V_115 = 0 ;
...
{
int V_64 , V_110 , V_119 , V_71 , V_120 = 0 ;
struct V_20 * V_20 = NULL ;
struct V_2 * V_3 = NULL , * V_66 = NULL ;
T_1 V_4 , V_121 = 0 , V_67 = 0 ;
struct V_10 * V_28 ;
T_2 V_69 = V_97 -> args . V_69 ;
T_6 V_75 = V_97 -> args . V_75 ;
struct V_1 * * V_70 = V_97 -> args . V_70 ;
struct V_1 * V_1 ;
T_5 V_113 ;
T_7 V_122 ;
int V_123 =
F_80 ( V_97 -> V_83 ) -> V_124 >> V_73 ;
F_2 ( L_23 , V_18 , V_75 , V_69 ) ;
V_28 = F_14 ( V_97 ) ;
if ( ! V_28 )
goto V_125;
V_28 -> V_19 = F_63 ;
...
V_71 = V_97 -> args . V_72 >> V_73 ;
for ( V_64 = V_71 ; V_64 < V_97 -> V_74 ; V_64 ++ ) {
if ( ! V_67 ) {
F_45 ( V_3 ) ;
V_20 = F_24 ( V_128 , V_20 ) ;
...
V_20 = F_30 ( V_20 , V_97 -> V_74 - V_64 , V_128 ,
V_4 , V_70 [ V_64 ] , V_3 ,
F_59 , V_28 ) ;
if ( F_49 ( V_20 ) ) {
V_97 -> V_52 = F_50 ( V_20 ) ;
...
V_129:
V_97 -> V_85 . V_75 = ( V_121 << V_77 ) - ( V_69 ) ;
if ( V_75 < V_97 -> V_85 . V_75 ) {
V_97 -> V_85 . V_75 = V_75 ;
}
V_78:
F_45 ( V_3 ) ;
...
V_70 = F_95 ( V_177 * sizeof( struct V_1 * ) , V_13 ) ;
if ( V_70 == NULL ) {
F_21 ( V_166 ) ;
return F_31 ( - V_40 ) ;
}
for ( V_64 = 0 ; V_64 < V_177 ; V_64 ++ ) {
V_70 [ V_64 ] = F_111 ( V_13 ) ;
if ( ! V_70 [ V_64 ] ) {
V_12 = F_31 ( - V_40 ) ;
goto V_182;
}
}
memcpy ( & V_166 -> V_183 , V_174 , sizeof( * V_174 ) ) ;
V_166 -> V_184 = V_185 ;
V_166 -> V_70 = V_70 ;
V_166 -> V_72 = 0 ;
V_166 -> V_186 = V_111 * V_177 ;
V_166 -> V_187 = 0 ;
F_2 ( L_31 , V_18 , V_166 -> V_183 . V_11 ) ;
V_178 = F_112 ( V_170 , V_166 ) ;
F_2 ( L_32 , V_18 , V_178 ) ;
if ( V_178 ) {
V_12 = F_31 ( V_178 ) ;
goto V_182;
}
V_12 = F_113 ( V_170 , V_166 ) ;
V_182:
for ( V_64 = 0 ; V_64 < V_177 ; V_64 ++ )
F_114 ( V_70 [ V_64 ] ) ;
F_21 ( V_70 ) ;
...
static int
F_115 ( struct V_169 * V_170 , const struct V_171 * V_172 )
{
...
V_188 = F_95 ( sizeof( struct V_163 ) , V_13 ) ;
if ( ! V_188 ) {
V_155 = - V_40 ;
goto V_193;
}
F_96 ( & V_188 -> V_194 ) ;
F_97 ( & V_188 -> V_195 ) ;
V_190 = F_15 ( sizeof( struct V_189 ) , V_13 ) ;
if ( ! V_190 ) {
V_155 = - V_40 ;
goto V_193;
}
V_190 -> V_86 = 0 ;
while ( ! V_190 -> V_86 ) {
V_155 = F_117 ( V_170 , V_172 , V_190 ) ;
if ( V_155 )
goto V_193;
F_2 ( L_34 ,
V_18 , V_190 -> V_196 , V_190 -> V_86 ) ;
for ( V_64 = 0 ; V_64 < V_190 -> V_196 ; V_64 ++ ) {
V_191 = F_109 ( V_170 , V_172 ,
& V_190 -> V_183 [ V_64 ] ) ;
if ( F_49 ( V_191 ) ) {
V_155 = F_50 ( V_191 ) ;
goto V_193;
...
{
struct V_163 * V_188 = V_170 -> V_197 ;
F_2 ( L_11 , V_18 ) ;
F_107 ( V_188 ) ;
F_2 ( L_36 , V_18 ) ;
return 0 ;
}
static struct V_199 * F_120 ( struct V_200 * V_201 ,
struct V_202 * V_203 )
{
struct V_199 * V_204 , * V_199 ;
V_204 = F_121 ( V_201 , V_205 ) ;
if ( V_204 == NULL )
return F_31 ( - V_206 ) ;
V_199 = F_122 ( V_204 , L_37 , NULL , V_203 ) ;
F_123 ( V_204 ) ;
return V_199 ;
}
static void F_124 ( struct V_200 * V_201 ,
struct V_202 * V_203 )
{
if ( V_203 -> V_199 )
F_125 ( V_203 -> V_199 ) ;
}
static int F_126 ( struct V_207 * V_208 , unsigned long V_209 ,
void * V_210 )
{
struct V_200 * V_201 = V_210 ;
struct V_211 * V_211 = V_201 -> V_212 ;
struct V_213 * V_214 = F_127 ( V_211 , V_215 ) ;
struct V_199 * V_199 ;
int V_110 = 0 ;
if ( ! F_128 ( V_216 ) )
return 0 ;
...
switch ( V_209 ) {
case V_218 :
V_199 = F_120 ( V_201 , V_214 -> V_217 ) ;
if ( F_49 ( V_199 ) ) {
V_110 = F_50 ( V_199 ) ;
break;
}
V_214 -> V_217 -> V_199 = V_199 ;
break;
case V_219 :
if ( V_214 -> V_217 -> V_199 )
F_124 ( V_201 , V_214 -> V_217 ) ;
break;
default:
V_110 = - V_220 ;
break;
...
static struct V_199 * F_130 ( struct V_211 * V_211 ,
struct V_202 * V_203 )
{
struct V_200 * V_221 ;
struct V_199 * V_199 ;
...
if ( ! V_221 )
return NULL ;
V_199 = F_120 ( V_221 , V_203 ) ;
F_132 ( V_211 ) ;
return V_199 ;
}
static void F_133 ( struct V_211 * V_211 ,
struct V_202 * V_203 )
{
struct V_200 * V_221 ;
V_221 = F_131 ( V_211 ) ;
...
static int F_134 ( struct V_211 * V_211 )
{
struct V_213 * V_214 = F_127 ( V_211 , V_215 ) ;
struct V_199 * V_199 ;
F_135 ( & V_214 -> V_222 ) ;
V_214 -> V_217 = F_136 ( & V_223 , 0 ) ;
if ( F_49 ( V_214 -> V_217 ) )
return F_50 ( V_214 -> V_217 ) ;
V_199 = F_130 ( V_211 , V_214 -> V_217 ) ;
if ( F_49 ( V_199 ) ) {
F_137 ( V_214 -> V_217 ) ;
return F_50 ( V_199 ) ;
}
...
static void F_138 ( struct V_211 * V_211 )
{
struct V_213 * V_214 = F_127 ( V_211 , V_215 ) ;
F_133 ( V_211 , V_214 -> V_217 ) ;
F_137 ( V_214 -> V_217 ) ;
V_214 -> V_217 = NULL ;
}
