...
enum V_53 V_37 ;
const char * V_26 ;
V_40 . V_7 = F_26 ( V_49 , 0 , & V_37 ) ;
V_40 . V_16 = V_37 & V_54 ;
V_40 . V_28 = F_27 ( V_49 , L_2 , NULL ) ? : V_49 -> V_28 ;
V_40 . V_29 =
F_27 ( V_49 , L_3 , NULL ) ;
V_26 = F_27 ( V_49 , L_4 , NULL ) ;
if ( V_26 ) {
if ( ! strcmp ( V_26 , L_5 ) )
V_40 . V_31 = V_32 ;
...
int V_60 , V_25 = 0 ;
if ( V_58 && V_58 -> V_41 ) {
V_50 = F_25 ( F_22 ( V_58 -> V_41 ) ,
V_52 ) ;
if ( ! V_50 )
return - V_61 ;
V_50 -> V_41 = V_58 -> V_41 ;
for ( V_60 = 0 ; V_60 < V_50 -> V_41 ; V_60 ++ ) {
V_25 = F_8 ( & V_58 -> V_56 [ V_60 ] ,
& V_50 -> V_56 [ V_60 ] ,
& V_44 -> V_47 , V_58 -> F_7 ) ;
if ( V_25 < 0 ) {
for ( V_60 = V_60 - 1 ; V_60 >= 0 ; V_60 -- )
F_19 ( & V_50 -> V_56 [ V_60 ] ) ;
F_29 ( V_50 ) ;
return V_25 ;
}
...
{
struct V_42 * V_50 = F_33 ( & V_44 -> V_47 ) ;
int V_60 ;
for ( V_60 = 0 ; V_60 < V_50 -> V_41 ; V_60 ++ )
F_19 ( & V_50 -> V_56 [ V_60 ] ) ;
F_34 ( & V_44 -> V_47 , NULL ) ;
