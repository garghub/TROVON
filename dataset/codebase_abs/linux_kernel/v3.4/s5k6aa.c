...
static int F_77 ( struct V_1 * V_7 , struct V_186 * V_187 ,
struct V_209 * V_210 )
{
struct V_5 * V_5 = F_3 ( V_7 ) ;
struct V_116 * V_117 ;
...
static int F_79 ( struct V_1 * V_7 , struct V_186 * V_187 ,
struct V_209 * V_210 )
{
struct V_5 * V_5 = F_3 ( V_7 ) ;
...
int V_33 = 0 ;
F_62 ( & V_5 -> V_168 ) ;
F_76 ( V_5 , & V_210 -> V_212 ) ;
if ( V_210 -> V_202 == V_204 ) {
V_117 = F_78 ( V_187 , V_210 -> V_214 ) ;
V_213 = F_75 ( V_187 , 0 ) ;
} else {
if ( V_5 -> V_166 ) {
V_33 = - V_215 ;
...
* V_117 = V_210 -> V_212 ;
V_213 -> V_14 = F_80 (unsigned int, crop->width, mf->width,
S5K6AA_WIN_WIDTH_MAX) ;
V_213 -> V_16 = F_80 (unsigned int, crop->height, mf->height,
S5K6AA_WIN_HEIGHT_MAX) ;
V_213 -> V_127 = F_80 (unsigned int, crop->left, 0 ,
S5K6AA_WIN_WIDTH_MAX - crop->width) ;
V_213 -> V_129 = F_80 (unsigned int, crop->top, 0 ,
...
static int F_81 ( struct V_1 * V_7 , struct V_186 * V_187 ,
struct V_216 * V_213 )
{
struct V_5 * V_5 = F_3 ( V_7 ) ;
struct V_121 * V_217 ;
...
V_213 -> V_217 . V_127 = F_80 (unsigned int, crop->rect.left, 0 , max_x) ;
V_213 -> V_217 . V_129 = F_80 (unsigned int, crop->rect.top, 0 , max_y) ;
* V_220 = V_213 -> V_217 ;
F_63 ( & V_5 -> V_168 ) ;
F_8 ( 1 , V_39 , V_7 , L_10 ,
...
break;
case V_235 :
V_178 = F_11 ( V_26 , F_84 ( V_148 ) , V_3 -> V_28 ) ;
if ( V_178 )
break;
V_178 = F_11 ( V_26 , V_145 , 1 ) ;
break;
...
{
F_86 ( V_7 -> V_170 , V_7 -> V_236 ) ;
return 0 ;
}
static int F_87 ( struct V_5 * V_5 )
{
const struct V_237 * V_238 = & V_239 ;
struct V_75 * V_6 = & V_5 -> V_6 ;
struct V_240 * V_241 = & V_6 -> V_4 ;
int V_33 = F_88 ( V_241 , 16 ) ;
if ( V_33 )
return V_33 ;
V_6 -> V_74 = F_89 ( V_241 , V_238 , V_222 ,
0 , 1 , 1 , 1 ) ;
V_6 -> V_79 = F_90 ( V_241 , & V_75 [ 0 ] , NULL ) ;
V_6 -> V_82 = F_90 ( V_241 , & V_75 [ 1 ] , NULL ) ;
V_6 -> V_85 = F_90 ( V_241 , & V_75 [ 2 ] , NULL ) ;
F_91 ( 4 , & V_6 -> V_74 , 0 , false ) ;
V_6 -> V_242 = F_89 ( V_241 , V_238 , V_229 , 0 , 1 , 1 , 0 ) ;
V_6 -> V_70 = F_89 ( V_241 , V_238 , V_243 , 0 , 1 , 1 , 0 ) ;
F_92 ( 2 , & V_6 -> V_242 ) ;
V_6 -> V_244 = F_93 ( V_241 , V_238 ,
V_228 ,
V_245 , 0 , V_98 ) ;
V_6 -> V_88 = F_89 ( V_241 , V_238 , V_246 ,
0 , 6000000U , 1 , 100000U ) ;
V_6 -> V_92 = F_89 ( V_241 , V_238 , V_247 ,
0 , 256 , 1 , 256 ) ;
F_91 ( 3 , & V_6 -> V_244 , 0 , false ) ;
F_93 ( V_241 , V_238 , V_230 ,
V_101 , 0 ,
V_101 ) ;
F_93 ( V_241 , V_238 , V_225 ,
V_111 , ~ 0x6f , V_107 ) ;
F_89 ( V_241 , V_238 , V_235 ,
0 , 256 , 1 , 0 ) ;
F_89 ( V_241 , V_238 , V_231 , - 127 , 127 , 1 , 0 ) ;
F_89 ( V_241 , V_238 , V_223 , - 127 , 127 , 1 , 0 ) ;
F_89 ( V_241 , V_238 , V_226 , - 127 , 127 , 1 , 0 ) ;
F_89 ( V_241 , V_238 , V_233 , - 127 , 127 , 1 , 0 ) ;
if ( V_241 -> error ) {
V_33 = V_241 -> error ;
F_94 ( V_241 ) ;
return V_33 ;
...
static int F_95 ( struct V_1 * V_7 , struct V_186 * V_187 )
{
struct V_116 * V_212 = F_78 ( V_187 , 0 ) ;
struct V_121 * V_213 = F_75 ( V_187 , 0 ) ;
...
static int F_99 ( struct V_1 * V_7 )
{
struct V_5 * V_5 = F_3 ( V_7 ) ;
int V_33 ;
F_62 ( & V_5 -> V_168 ) ;
...
static int F_100 ( int V_254 , int V_28 , const char * V_236 )
{
unsigned long V_34 = V_28 ? V_255 : V_256 ;
int V_33 ;
if ( ! F_53 ( V_254 ) )
return 0 ;
V_33 = F_101 ( V_254 , V_34 , V_236 ) ;
if ( ! V_33 )
F_102 ( V_254 , 0 ) ;
return V_33 ;
}
static void F_103 ( struct V_5 * V_5 )
{
int V_11 ;
for ( V_11 = 0 ; V_11 < F_29 ( V_5 -> V_159 ) ; V_11 ++ ) {
if ( ! F_53 ( V_5 -> V_159 [ V_11 ] . V_159 ) )
continue;
F_104 ( V_5 -> V_159 [ V_11 ] . V_159 ) ;
V_5 -> V_159 [ V_11 ] . V_159 = - V_57 ;
}
}
static int F_105 ( struct V_5 * V_5 ,
...
V_33 = F_100 ( V_159 -> V_159 , V_159 -> V_160 , L_14 ) ;
if ( V_33 ) {
F_103 ( V_5 ) ;
return V_33 ;
}
...
F_54 ( V_159 -> V_159 , 0 ) ;
V_159 = & V_258 -> V_261 ;
V_33 = F_100 ( V_159 -> V_159 , V_159 -> V_160 , L_15 ) ;
if ( V_33 ) {
F_103 ( V_5 ) ;
return V_33 ;
}
...
int V_11 , V_33 ;
if ( V_258 == NULL ) {
F_107 ( & V_26 -> V_263 , L_16 ) ;
return - V_57 ;
}
if ( V_258 -> V_53 == 0 ) {
F_107 ( & V_26 -> V_263 , L_17 ) ;
return - V_57 ;
}
V_5 = F_108 ( sizeof( * V_5 ) , V_265 ) ;
if ( ! V_5 )
return - V_266 ;
F_109 ( & V_5 -> V_168 ) ;
V_5 -> V_53 = V_258 -> V_53 ;
...
V_7 = & V_5 -> V_7 ;
F_110 ( V_7 , V_26 , & V_269 ) ;
F_111 ( V_7 -> V_236 , V_270 , sizeof( V_7 -> V_236 ) ) ;
V_7 -> V_271 = & V_272 ;
V_7 -> V_34 |= V_273 ;
V_5 -> V_214 . V_34 = V_274 ;
V_7 -> V_275 . type = V_276 ;
V_33 = F_112 ( & V_7 -> V_275 , 1 , & V_5 -> V_214 , 0 ) ;
if ( V_33 )
goto V_277;
V_33 = F_105 ( V_5 , V_258 ) ;
if ( V_33 )
goto V_278;
for ( V_11 = 0 ; V_11 < V_161 ; V_11 ++ )
V_5 -> V_162 [ V_11 ] . V_279 = V_280 [ V_11 ] ;
V_33 = F_113 ( & V_26 -> V_263 , V_161 ,
V_5 -> V_162 ) ;
if ( V_33 ) {
F_107 ( & V_26 -> V_263 , L_18 ) ;
goto V_281;
}
V_33 = F_87 ( V_5 ) ;
if ( V_33 )
