...
if ( ! V_11 -> V_34 )
goto V_35;
V_11 -> V_1 = F_20 ( sizeof( * V_11 -> V_1 ) , V_36 ) ;
if ( ! V_11 -> V_1 )
goto V_35;
F_21 ( & V_11 -> V_1 -> V_9 ) ;
F_22 ( & V_11 -> V_1 -> V_10 ) ;
...
{
return F_27 ( V_16 , V_40 , NULL ) ;
}
static int F_28 ( struct V_15 * V_15 , struct V_16 * V_16 )
{
struct V_41 * V_42 = (struct V_41 * ) V_15 -> V_18 ;
return F_27 ( V_16 , V_43 , V_42 ) ;
}
static int F_29 ( struct V_15 * V_15 , struct V_16 * V_16 )
{
struct V_41 * V_42 = (struct V_41 * ) V_15 -> V_18 ;
return F_27 ( V_16 , V_44 , V_42 ) ;
}
static int F_30 ( struct V_15 * V_15 , struct V_16 * V_16 )
{
struct V_41 * V_42 = (struct V_41 * ) V_15 -> V_18 ;
return F_27 ( V_16 , V_45 , V_42 ) ;
}
static int F_31 ( struct V_15 * V_15 , struct V_16 * V_16 )
{
struct V_41 * V_42 = (struct V_41 * ) V_15 -> V_18 ;
return F_27 ( V_16 , V_46 , V_42 ) ;
}
static int F_32 ( struct V_15 * V_15 , struct V_16 * V_16 )
{
struct V_41 * V_42 = (struct V_41 * ) V_15 -> V_18 ;
return F_27 ( V_16 , V_47 , V_42 ) ;
}
static int F_33 ( struct V_15 * V_15 , struct V_16 * V_16 )
{
struct V_41 * V_42 = (struct V_41 * ) V_15 -> V_18 ;
return F_27 ( V_16 , V_48 , V_42 ) ;
}
void F_34 ( void )
{
struct V_49 * V_50 ;
...
goto V_54;
V_50 = & V_55 ;
V_16 = F_23 ( V_50 -> V_56 . V_57 ,
V_37 | V_50 -> V_56 . V_58 ,
V_51 , NULL , & V_50 -> V_59 ) ;
if ( ! V_16 )
F_37 ( L_3 , V_50 -> V_56 . V_57 ) ;
V_54:
return;
}
void F_38 ( void )
...
int F_40 ( struct V_41 * V_60 )
{
struct V_11 * V_11 = F_41 ( V_60 ) ;
struct V_49 * * V_50 ;
struct V_32 * V_16 ;
if ( ! V_51 )
goto V_54;
V_11 -> V_34 = F_35 ( V_60 -> V_57 , V_51 ) ;
if ( ! V_11 -> V_34 )
goto V_54;
F_42 ( V_11 ) ;
F_19 ( V_11 ) ;
for ( V_50 = V_61 ; * V_50 ; ++ V_50 ) {
V_16 = F_23 ( ( ( * V_50 ) -> V_56 ) . V_57 ,
V_37 | ( ( * V_50 ) -> V_56 ) . V_58 ,
V_11 -> V_34 ,
V_60 , & ( * V_50 ) -> V_59 ) ;
