...
static int F_13 ( struct V_17 * V_18 , struct V_2 * V_3 )
{
return F_14 ( V_3 , V_18 , V_19 , F_15 ( V_19 ) ) ;
}
static int F_16 ( struct V_20 * V_21 , const struct V_22 * V_23 ,
struct V_24 * V_25 )
{
...
static unsigned long F_22 ( struct V_22 * V_23 , V_16 V_35 )
{
return 0UL ;
}
