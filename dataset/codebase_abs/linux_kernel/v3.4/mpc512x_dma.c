...
unsigned long V_53 ;
F_19 ( & V_6 -> V_31 , V_53 ) ;
V_86 = F_41 ( V_4 , V_58 , V_85 ) ;
F_20 ( & V_6 -> V_31 , V_53 ) ;
return V_86 ;
}
static struct V_51 *
F_42 ( struct V_2 * V_4 , T_5 V_87 , T_5 V_88 ,
T_6 V_89 , unsigned long V_53 )
{
struct V_5 * V_9 = F_3 ( V_4 ) ;
struct V_1 * V_6 = F_1 ( V_4 ) ;
...
if ( F_45 ( V_88 | V_87 | V_89 , 32 ) ) {
V_17 -> V_91 = V_92 ;
V_17 -> V_93 = V_92 ;
V_17 -> V_94 = 32 ;
V_17 -> V_95 = 32 ;
} else if ( ! V_9 -> V_96 && F_45 ( V_88 | V_87 | V_89 , 16 ) ) {
V_17 -> V_91 = V_97 ;
V_17 -> V_93 = V_97 ;
V_17 -> V_94 = 16 ;
V_17 -> V_95 = 16 ;
} else if ( F_45 ( V_88 | V_87 | V_89 , 4 ) ) {
V_17 -> V_91 = V_98 ;
V_17 -> V_93 = V_98 ;
V_17 -> V_94 = 4 ;
V_17 -> V_95 = 4 ;
} else if ( F_45 ( V_88 | V_87 | V_89 , 2 ) ) {
V_17 -> V_91 = V_99 ;
V_17 -> V_93 = V_99 ;
V_17 -> V_94 = 2 ;
V_17 -> V_95 = 2 ;
...
static int T_7 F_46 ( struct V_106 * V_107 )
{
struct V_108 * V_109 = V_107 -> V_60 . V_110 ;
struct V_111 * V_60 = & V_107 -> V_60 ;
struct V_112 * V_42 ;
struct V_5 * V_9 ;
struct V_1 * V_6 ;
struct V_113 V_114 ;
...
if ( F_49 ( V_109 , L_18 ) ) {
V_9 -> V_96 = 1 ;
V_9 -> V_120 = F_48 ( V_109 , 1 ) ;
if ( V_9 -> V_120 == V_118 ) {
F_23 ( V_60 , L_17 ) ;
return - V_119 ;
}
}
V_117 = F_50 ( V_109 , 0 , & V_114 ) ;
if ( V_117 ) {
F_23 ( V_60 , L_19 ) ;
return V_117 ;
}
V_115 = V_114 . V_21 ;
V_116 = F_51 ( & V_114 ) ;
if ( ! F_52 ( V_60 , V_115 , V_116 , V_121 ) ) {
F_23 ( V_60 , L_20 ) ;
return - V_122 ;
}
V_9 -> V_24 = F_53 ( V_60 , V_115 , V_116 ) ;
if ( ! V_9 -> V_24 ) {
F_23 ( V_60 , L_21 ) ;
return - V_76 ;
}
V_9 -> V_17 = (struct V_23 * ) ( ( V_123 * ) ( V_9 -> V_24 )
+ V_124 ) ;
V_117 = F_54 ( V_60 , V_9 -> V_36 , & F_14 , 0 , V_121 ,
V_9 ) ;
if ( V_117 ) {
F_23 ( V_60 , L_22 ) ;
return - V_119 ;
...
if ( V_9 -> V_96 ) {
V_117 = F_54 ( V_60 , V_9 -> V_120 , & F_14 , 0 ,
V_121 , V_9 ) ;
if ( V_117 ) {
F_23 ( V_60 , L_23 ) ;
return - V_119 ;
...
F_56 ( & V_6 -> V_35 ) ;
F_55 ( & V_6 -> V_31 ) ;
F_33 ( & V_6 -> V_4 . V_108 , & V_42 -> V_7 ) ;
}
F_59 ( & V_9 -> V_48 , F_22 , ( unsigned long ) V_9 ) ;
if ( ! V_9 -> V_96 ) {
F_60 ( & V_9 -> V_24 -> V_133 , V_134 |
V_135 | V_136 ) ;
...
F_60 ( & V_9 -> V_24 -> V_142 , 0 ) ;
} else {
F_60 ( & V_9 -> V_24 -> V_133 , V_136 ) ;
F_60 ( & V_9 -> V_24 -> V_143 , V_144 ) ;
F_60 ( & V_9 -> V_24 -> V_140 , 0 ) ;
...
static int T_9 F_65 ( struct V_106 * V_107 )
{
struct V_111 * V_60 = & V_107 -> V_60 ;
