...
struct V_1 * V_2 ;
int V_386 ;
for ( V_386 = 0 ; ( V_386 < V_453 ) && V_454 [ V_386 ] && V_455 [ V_386 ] ; V_386 ++ ) {
if ( V_19 >= V_20 )
F_4 ( L_144 ,
V_454 [ V_386 ] , V_455 [ V_386 ] , V_456 [ V_386 ] ) ;
V_2 = F_209 () ;
if ( ! V_2 ) {
if ( V_19 >= V_457 )
F_4 ( L_145 ) ;
...
V_2 -> V_137 = ( unsigned int ) V_454 [ V_386 ] ;
V_2 -> V_177 = ( unsigned int ) V_455 [ V_386 ] ;
V_2 -> V_177 = F_221 ( V_2 -> V_177 ) ;
V_2 -> V_353 = ( unsigned int ) V_456 [ V_386 ] ;
V_2 -> V_349 = V_458 ;
V_2 -> V_414 = 16 ;
V_2 -> V_416 = 0 ;
F_207 ( V_2 ) ;
...
F_4 ( L_148 , V_439 , V_375 ) ;
F_220 () ;
if ( ( V_24 = F_228 ( & V_461 ) ) < 0 )
...
{
F_50 ( V_463 + V_2 -> V_464 , V_2 -> V_137 + V_138 ) ;
if ( V_2 -> V_349 == V_350 )
F_51 ( V_2 -> V_137 + V_138 ) ;
}
static void F_34 ( struct V_1 * V_2 , T_2 V_463 )
{
F_50 ( V_463 + V_2 -> V_465 , V_2 -> V_137 ) ;
if ( V_2 -> V_349 == V_350 )
F_51 ( V_2 -> V_137 ) ;
}
static void F_62 ( struct V_1 * V_2 , T_2 V_466 , T_2 V_467 )
{
F_50 ( V_466 + V_2 -> V_465 , V_2 -> V_137 ) ;
F_50 ( V_467 , V_2 -> V_137 ) ;
if ( V_2 -> V_349 == V_350 )
F_51 ( V_2 -> V_137 ) ;
}
static T_2 F_63 ( struct V_1 * V_2 , T_2 V_466 )
{
F_50 ( V_466 + V_2 -> V_465 , V_2 -> V_137 ) ;
...
{
F_50 ( V_466 + V_2 -> V_464 , V_2 -> V_137 + V_138 ) ;
F_50 ( V_467 , V_2 -> V_137 + V_138 ) ;
if ( V_2 -> V_349 == V_350 )
F_51 ( V_2 -> V_137 + V_138 ) ;
}
...
case V_483 : V_467 |= V_197 ; break;
case V_484 : V_467 |= V_197 + V_57 ; break;
case V_485 : V_467 |= V_196 ; break;
case V_486 : V_467 |= V_196 + V_57 ; break;
case V_487 : V_467 |= V_196 + V_197 ; break;
case V_488 : V_467 |= V_196 + V_197 + V_57 ; break;
}
if ( ( V_2 -> V_36 . V_489 & V_490 ) == V_491 )
V_467 |= V_162 ;
else if ( ( V_2 -> V_36 . V_489 & V_490 ) == V_492 )
V_467 |= ( V_198 | V_180 | V_162 ) ;
...
V_467 |= ( V_198 | V_180 | V_162 | V_167 ) ;
F_27 ( V_2 , V_370 , V_467 ) ;
F_124 ( V_2 ) ;
F_129 ( V_2 , V_497 ) ;
if ( V_2 -> V_349 == V_350 )
...
case V_482 :
case V_483 :
case V_484 : V_467 |= V_167 ; break;
case V_485 :
case V_486 : V_467 |= V_162 ; break;
case V_487 :
case V_488 : V_467 |= V_162 + V_167 ; break;
}
}
...
if ( V_2 -> V_349 == V_350 ) {
F_62 ( V_2 , V_522 , 0xa00b ) ;
}
else
F_62 ( V_2 , V_522 , 0x800b ) ;
F_62 ( V_2 , V_164 , 0xf200 ) ;
F_62 ( V_2 , V_169 , 0xf200 ) ;
F_62 ( V_2 , V_523 , 0x9000 ) ;
F_63 ( V_2 , V_164 ) ;
F_63 ( V_2 , V_169 ) ;
F_62 ( V_2 , V_161 , 0x0303 ) ;
V_467 = 0x8080 ;
switch ( V_2 -> V_36 . V_524 ) {
case V_525 : V_467 |= V_180 ; break;
case V_526 : V_467 |= V_513 ; break;
case V_527 : V_467 |= V_513 + V_180 ; break;
}
switch ( V_2 -> V_36 . V_475 ) {
case V_528 : V_467 |= V_167 + V_198 ; break;
case V_529 : V_467 |= V_167 ; break;
case V_530 : V_467 |= V_162 ; break;
case V_531 : V_467 |= V_162 + V_167 ; break;
}
F_27 ( V_2 , V_532 , V_467 ) ;
if ( V_2 -> V_349 == V_350 ) {
F_62 ( V_2 , V_533 , 0x0000 ) ;
}
else
F_62 ( V_2 , V_533 , 0x2000 ) ;
F_10 ( V_2 ) ;
F_86 ( V_2 ) ;
}
...
F_27 ( V_2 , V_517 , ( T_2 ) ( ( F_25 ( V_2 , V_517 ) & ~ V_163 ) | V_168 ) ) ;
...
V_508 = 14745600 ;
V_510 = ( T_2 ) ( V_508 / V_222 ) ;
if ( ! ( ( ( V_508 % V_222 ) * 2 ) / V_222 ) )
V_510 -- ;
F_27 ( V_2 , V_535 , V_510 ) ;
F_27 ( V_2 , V_517 , ( T_2 ) ( ( F_25 ( V_2 , V_517 ) & ~ V_163 ) | V_168 ) ) ;
F_27 ( V_2 , V_295 , ( T_2 ) ( ( F_25 ( V_2 , V_295 ) & 0xfff8 ) | 0x0004 ) ) ;
} else {
F_27 ( V_2 , V_517 , ( T_2 ) ( F_25 ( V_2 , V_517 ) & ~ V_168 ) ) ;
}
}
...
do
{
* ( ( unsigned long * ) & ( V_2 -> V_384 [ V_536 ++ ] . V_13 ) ) = V_379 ;
if ( V_536 == V_2 -> V_382 )
V_536 = 0 ;
} while( V_536 != V_537 );
V_541 = true ;
...
V_398 = V_2 -> V_384 [ V_538 ] . V_394 ;
F_62 ( V_2 , V_545 , ( T_2 ) V_398 ) ;
F_62 ( V_2 , V_546 , ( T_2 ) ( V_398 >> 16 ) ) ;
F_31 ( V_2 , V_143 ) ;
F_30 ( V_2 , V_132 + V_67 ) ;
F_91 ( V_2 , V_67 ) ;
F_62 ( V_2 , V_547 , V_135 + V_170 ) ;
F_62 ( V_2 , V_523 , ( T_2 ) ( F_63 ( V_2 , V_523 ) | V_163 ) ) ;
F_34 ( V_2 , V_548 ) ;
...
F_34 ( V_2 , V_72 ) ;
V_552 = V_2 -> V_385 [ V_2 -> V_554 ] . V_555 ;
if ( V_2 -> V_36 . V_37 == V_203 )
V_2 -> V_385 [ V_2 -> V_554 ] . V_555 = 0 ;
F_27 ( V_2 , V_556 , ( T_2 ) V_552 ) ;
F_35 ( V_2 , V_73 ) ;
V_398 = V_2 -> V_385 [ V_2 -> V_554 ] . V_394 ;
F_62 ( V_2 , V_557 , ( T_2 ) V_398 ) ;
F_62 ( V_2 , V_558 , ( T_2 ) ( V_398 >> 16 ) ) ;
F_33 ( V_2 , V_498 ) ;
F_30 ( V_2 , V_69 ) ;
F_91 ( V_2 , V_69 ) ;
if ( V_2 -> V_36 . V_37 == V_203 &&
V_2 -> V_381 > 1 ) {
F_62 ( V_2 , V_559 , V_170 | V_135 ) ;
F_62 ( V_2 , V_523 , ( T_2 ) ( F_63 ( V_2 , V_523 ) | V_168 ) ) ;
}
F_34 ( V_2 , V_560 ) ;
F_129 ( V_2 , V_561 ) ;
...
V_563 [ 0 ] = V_2 -> V_187 [ V_2 -> V_80 ++ ] ;
V_2 -> V_80 = V_2 -> V_80 & ( V_230 - 1 ) ;
V_563 [ 1 ] = V_2 -> V_187 [ V_2 -> V_80 ++ ] ;
V_2 -> V_80 = V_2 -> V_80 & ( V_230 - 1 ) ;
F_50 ( * ( ( T_2 * ) V_563 ) , V_2 -> V_137 + V_565 ) ;
V_2 -> V_78 -= 2 ;
V_2 -> V_54 . V_298 += 2 ;
} else {
F_50 ( ( F_51 ( V_2 -> V_137 + V_138 ) & 0x0780 ) | ( V_566 + V_134 ) ,
V_2 -> V_137 + V_138 ) ;
if ( V_2 -> V_239 ) {
...
int V_386 ;
V_392 V_567 ;
volatile V_392 * V_568 = ( V_392 * ) ( V_2 -> V_422 + 0x50 ) ;
V_392 * V_569 = ( V_392 * ) ( V_2 -> V_422 + 0x28 ) ;
V_2 -> V_570 |= V_571 ;
* V_568 = V_2 -> V_570 ;
...
F_35 ( V_2 , V_73 ) ;
F_33 ( V_2 , V_498 ) ;
F_50 ( 0 , V_2 -> V_137 + V_565 ) ;
F_129 ( V_2 , V_561 ) ;
F_234 ( V_2 , V_551 ) ;
for ( V_386 = 0 ; V_386 < 1000 ; V_386 ++ )
if ( F_25 ( V_2 , V_50 ) & ( V_167 + V_480 + V_135 + V_163 ) )
break;
F_232 ( V_2 , 0 ) ;
F_231 ( V_2 ) ;
V_2 -> V_36 . V_37 = V_579 ;
...
F_27 ( V_2 , V_507 , 0x0f64 ) ;
if ( V_2 -> V_349 == V_350 )
F_27 ( V_2 , V_535 , ( T_2 ) ( ( 691200 / V_222 ) - 1 ) ) ;
else
F_27 ( V_2 , V_535 , ( T_2 ) ( ( 921600 / V_222 ) - 1 ) ) ;
F_27 ( V_2 , V_517 ,
( T_2 ) ( ( F_25 ( V_2 , V_517 ) & ~ V_163 ) | V_168 ) ) ;
F_27 ( V_2 , V_295 ,
...
static void F_241 ( struct V_1 * V_2 , unsigned int V_598 , unsigned int V_599 )
{
bool V_600 = false ;
V_393 * V_601 ;
unsigned int V_602 ;
V_602 = V_598 ;
while( ! V_600 ) {
V_601 = & ( V_2 -> V_384 [ V_602 ] ) ;
if ( V_602 == V_599 ) {
V_600 = true ;
}
* ( ( unsigned long * ) & ( V_601 -> V_13 ) ) = V_379 ;
V_602 ++ ;
if ( V_602 == V_2 -> V_382 )
V_602 = 0 ;
}
...
while( ! V_2 -> V_384 [ V_599 ] . V_49 ) {
if ( V_2 -> V_384 [ V_599 ] . V_13 )
goto V_606;
V_599 ++ ;
if ( V_599 == V_2 -> V_382 )
V_599 = 0 ;
...
V_605 = true ;
if ( V_605 ) {
V_603 = V_495 - V_2 -> V_384 [ V_599 ] . V_555 ;
...
if ( V_19 >= V_614 )
F_242 ( V_2 , V_2 -> V_384 [ V_598 ] . V_399 ,
F_104 ( int , V_603 , V_379 ) , 0 ) ;
if ( V_603 ) {
if ( ( ( V_2 -> V_36 . V_489 & V_610 ) &&
( ( V_603 + 1 ) > V_2 -> V_238 ) ) ||
( V_603 > V_2 -> V_238 ) )
...
V_617 = V_615 ;
V_601 = & ( V_2 -> V_384 [ V_337 ] ) ;
memcpy ( V_616 , V_601 -> V_399 , V_617 ) ;
V_616 += V_617 ;
V_615 -= V_617 ;
if ( ++ V_337 == V_2 -> V_382 )
V_337 = 0 ;
...
#if V_85
if ( V_2 -> V_86 )
F_243 ( V_2 , V_2 -> V_401 , V_603 ) ;
else
#endif
F_5 ( V_10 , V_2 -> V_401 , V_2 -> V_620 , V_603 ) ;
}
}
F_241 ( V_2 , V_598 , V_599 ) ;
V_604 = true ;
V_606:
if ( V_2 -> V_250 && V_2 -> V_165 ) {
if ( ! V_2 -> V_384 [ V_599 ] . V_49 &&
V_2 -> V_384 [ V_599 ] . V_13 ) {
F_9 ( & V_2 -> V_22 , V_12 ) ;
F_21 ( V_2 ) ;
F_11 ( & V_2 -> V_22 , V_12 ) ;
}
...
unsigned long V_12 ;
struct V_9 * V_10 = V_2 -> V_42 . V_10 ;
V_621 = V_622 = V_2 -> V_544 ;
++ V_622 ;
if ( V_622 == V_2 -> V_382 )
V_622 = 0 ;
if ( V_2 -> V_384 [ V_621 ] . V_49 != 0 ||
( V_2 -> V_384 [ V_621 ] . V_13 == 0 &&
V_2 -> V_384 [ V_622 ] . V_13 == 0 ) ) {
V_49 = V_2 -> V_384 [ V_621 ] . V_49 ;
if ( V_49 & ( V_607 + V_65 +
V_608 + V_609 ) ) {
if ( V_49 & V_607 )
V_2 -> V_54 . V_355 ++ ;
...
if ( V_49 ) {
if ( V_2 -> V_384 [ V_621 ] . V_555 )
V_603 = V_495 - V_2 -> V_384 [ V_621 ] . V_555 ;
else
V_603 = V_379 ;
}
else
...
__FILE__ , __LINE__ , V_2 -> V_21 , V_49 , V_603 ) ;
if ( V_19 >= V_614 )
F_242 ( V_2 , V_2 -> V_384 [ V_621 ] . V_399 ,
F_104 ( int , V_603 , V_379 ) , 0 ) ;
if ( V_603 ) {
V_601 = & ( V_2 -> V_384 [ V_621 ] ) ;
memcpy ( V_2 -> V_401 , V_601 -> V_399 , V_603 ) ;
V_2 -> V_54 . V_354 ++ ;
F_5 ( V_10 , V_2 -> V_401 , V_2 -> V_620 , V_603 ) ;
}
F_241 ( V_2 , V_621 , V_621 ) ;
V_604 = true ;
}
if ( V_2 -> V_250 && V_2 -> V_165 ) {
if ( ! V_2 -> V_384 [ V_621 ] . V_49 &&
V_2 -> V_384 [ V_621 ] . V_13 ) {
F_9 ( & V_2 -> V_22 , V_12 ) ;
F_21 ( V_2 ) ;
F_11 ( & V_2 -> V_22 , V_12 ) ;
}
...
V_2 -> V_385 [ V_386 ] . V_555 = V_413 ;
V_2 -> V_385 [ V_386 ] . V_13 = V_413 ;
while( V_413 ) {
V_601 = & V_2 -> V_385 [ V_386 ++ ] ;
if ( V_386 == V_2 -> V_380 )
V_386 = 0 ;
if ( V_413 > V_379 )
V_623 = V_379 ;
...
V_623 = V_413 ;
if ( V_2 -> V_349 == V_350 )
F_244 ( V_601 -> V_399 , V_412 , V_623 ) ;
else
memcpy ( V_601 -> V_399 , V_412 , V_623 ) ;
V_601 -> V_13 = V_623 ;
V_412 += V_623 ;
V_413 -= V_623 ;
++ V_2 -> V_171 ;
...
{
static unsigned short V_624 [] =
{ 0x0000 , 0xffff , 0xaaaa , 0x5555 , 0x1234 , 0x6969 , 0x9696 , 0x0f0f } ;
static unsigned int V_625 = F_246 ( V_624 ) ;
unsigned int V_386 ;
bool V_24 = true ;
unsigned long V_12 ;
F_9 ( & V_2 -> V_22 , V_12 ) ;
...
if ( V_24 ) {
for ( V_386 = 0 ; V_386 < V_625 ; V_386 ++ ) {
F_27 ( V_2 , V_535 , V_624 [ V_386 ] ) ;
F_27 ( V_2 , V_515 , V_624 [ ( V_386 + 1 ) % V_625 ] ) ;
F_27 ( V_2 , V_556 , V_624 [ ( V_386 + 2 ) % V_625 ] ) ;
F_27 ( V_2 , V_494 , V_624 [ ( V_386 + 3 ) % V_625 ] ) ;
F_27 ( V_2 , V_479 , V_624 [ ( V_386 + 4 ) % V_625 ] ) ;
F_62 ( V_2 , V_626 , V_624 [ ( V_386 + 5 ) % V_625 ] ) ;
if ( ( F_25 ( V_2 , V_535 ) != V_624 [ V_386 ] ) ||
( F_25 ( V_2 , V_515 ) != V_624 [ ( V_386 + 1 ) % V_625 ] ) ||
( F_25 ( V_2 , V_556 ) != V_624 [ ( V_386 + 2 ) % V_625 ] ) ||
( F_25 ( V_2 , V_494 ) != V_624 [ ( V_386 + 3 ) % V_625 ] ) ||
( F_25 ( V_2 , V_479 ) != V_624 [ ( V_386 + 4 ) % V_625 ] ) ||
( F_63 ( V_2 , V_626 ) != V_624 [ ( V_386 + 5 ) % V_625 ] ) ) {
V_24 = false ;
break;
}
}
...
F_11 ( & V_2 -> V_22 , V_12 ) ;
V_552 = F_249 ;
V_2 -> V_385 [ 0 ] . V_13 = V_552 ;
V_2 -> V_385 [ 0 ] . V_555 = V_552 ;
V_2 -> V_385 [ 0 ] . V_49 = 0x4000 ;
V_629 = V_2 -> V_385 [ 0 ] . V_399 ;
for ( V_386 = 0 ; V_386 < V_552 ; V_386 ++ )
* V_629 ++ = V_386 ;
V_2 -> V_384 [ 0 ] . V_49 = 0 ;
V_2 -> V_384 [ 0 ] . V_13 = V_552 + 4 ;
memset ( V_2 -> V_384 [ 0 ] . V_399 , 0 , V_552 + 4 ) ;
V_2 -> V_385 [ 1 ] . V_13 = 0 ;
V_2 -> V_384 [ 1 ] . V_13 = 0 ;
F_9 ( & V_2 -> V_22 , V_12 ) ;
F_35 ( V_2 , V_148 ) ;
V_398 = V_2 -> V_384 [ 0 ] . V_394 ;
F_62 ( V_2 , V_545 , ( unsigned short ) V_398 ) ;
F_62 ( V_2 , V_546 , ( unsigned short ) ( V_398 >> 16 ) ) ;
F_63 ( V_2 , V_164 ) ;
F_34 ( V_2 , V_548 ) ;
F_27 ( V_2 , V_493 , ( unsigned short ) ( ( F_25 ( V_2 , V_493 ) & 0xfffc ) | 0x0002 ) ) ;
F_11 ( & V_2 -> V_22 , V_12 ) ;
V_627 = V_324 + F_192 ( 100 ) ;
for(; ; ) {
if ( F_157 ( V_324 , V_627 ) ) {
V_24 = false ;
break;
}
F_9 ( & V_2 -> V_22 , V_12 ) ;
...
F_9 ( & V_2 -> V_22 , V_12 ) ;
F_27 ( V_2 , V_556 , ( unsigned short ) V_2 -> V_385 [ 0 ] . V_13 ) ;
F_35 ( V_2 , V_73 ) ;
V_398 = V_2 -> V_385 [ 0 ] . V_394 ;
F_62 ( V_2 , V_557 , ( unsigned short ) V_398 ) ;
F_62 ( V_2 , V_558 , ( unsigned short ) ( V_398 >> 16 ) ) ;
...
V_49 = F_25 ( V_2 , V_68 ) ;
F_11 ( & V_2 -> V_22 , V_12 ) ;
while ( ! ( V_49 & ( V_534 + V_575 + V_480 + V_170 + V_163 ) ) ) {
if ( F_157 ( V_324 , V_627 ) ) {
V_24 = false ;
break;
}
...
{
static unsigned long V_624 [] =
{ 0x0 , 0x55555555 , 0xaaaaaaaa , 0x66666666 , 0x99999999 , 0xffffffff , 0x12345678 } ;
unsigned long V_625 = F_246 ( V_624 ) ;
unsigned long V_386 ;
unsigned long V_634 = V_635 /sizeof( unsigned long ) ;
unsigned long * V_636 ;
if ( V_2 -> V_349 != V_350 )
return true ;
V_636 = ( unsigned long * ) V_2 -> V_388 ;
for ( V_386 = 0 ; V_386 < V_625 ; V_386 ++ ) {
* V_636 = V_624 [ V_386 ] ;
if ( * V_636 != V_624 [ V_386 ] )
return false ;
}
for ( V_386 = 0 ; V_386 < V_634 ; V_386 ++ ) {
* V_636 = V_386 * 4 ;
V_636 ++ ;
}
V_636 = ( unsigned long * ) V_2 -> V_388 ;
...
memset ( V_2 -> V_388 , 0 , V_635 ) ;
return true ;
}
static void F_244 ( char * V_637 , const char * V_638 ,
unsigned short V_13 )
{
#define F_250 64
unsigned short V_639 = V_13 / F_250 ;
unsigned short V_602 ;
unsigned long V_640 ;
for ( V_602 = 0 ; V_602 < V_639 ; V_602 ++ )
{
memcpy ( V_637 , V_638 , F_250 ) ;
V_640 = * ( ( volatile unsigned long * ) V_637 ) ;
V_637 += F_250 ;
V_638 += F_250 ;
}
memcpy ( V_637 , V_638 , V_13 % F_250 ) ;
}
static void F_242 ( struct V_1 * V_2 , const char * V_11 , int V_13 , int V_641 )
{
int V_386 ;
int V_642 ;
if ( V_641 )
...
static void V_190 ( unsigned long V_643 )
{
struct V_1 * V_2 = (struct V_1 * ) V_643 ;
unsigned long V_12 ;
if ( V_19 >= V_20 )
F_4 ( L_169 ,
__FILE__ , __LINE__ , V_2 -> V_21 ) ;
...
static int F_251 ( struct V_645 * V_646 , unsigned short V_481 ,
unsigned short V_146 )
{
struct V_1 * V_2 = F_252 ( V_646 ) ;
unsigned char V_647 ;
unsigned short V_648 ;
if ( V_2 -> V_42 . V_13 )
return - V_345 ;
switch ( V_481 )
{
case V_649 : V_647 = V_516 ; break;
case V_650 : V_647 = V_484 ; break;
case V_651 : V_647 = V_485 ; break;
case V_652 : V_647 = V_486 ; break;
case V_653 : V_647 = V_487 ; break;
default: return - V_294 ;
}
switch ( V_146 )
{
case V_654 : V_648 = V_655 ; break;
case V_656 : V_648 = V_491 ; break;
case V_657 : V_648 = V_492 ; break;
default: return - V_294 ;
}
V_2 -> V_36 . V_481 = V_647 ;
V_2 -> V_36 . V_489 = V_648 ;
if ( V_2 -> V_86 )
F_87 ( V_2 ) ;
return 0 ;
}
static T_9 F_253 ( struct V_658 * V_659 ,
struct V_645 * V_646 )
{
struct V_1 * V_2 = F_252 ( V_646 ) ;
unsigned long V_12 ;
if ( V_19 >= V_20 )
F_4 ( V_660 L_170 , __FILE__ , V_646 -> V_3 ) ;
F_254 ( V_646 ) ;
V_2 -> V_78 = V_659 -> V_661 ;
F_101 ( V_2 , V_659 -> V_11 , V_659 -> V_661 ) ;
V_646 -> V_611 . V_662 ++ ;
V_646 -> V_611 . V_663 += V_659 -> V_661 ;
F_255 ( V_659 ) ;
V_646 -> V_664 = V_324 ;
F_9 ( & V_2 -> V_22 , V_12 ) ;
if ( ! V_2 -> V_43 )
...
static int F_256 ( struct V_645 * V_646 )
{
struct V_1 * V_2 = F_252 ( V_646 ) ;
int V_24 ;
unsigned long V_12 ;
if ( V_19 >= V_20 )
F_4 ( L_171 , __FILE__ , V_646 -> V_3 ) ;
if ( ( V_24 = F_257 ( V_646 ) ) )
return V_24 ;
F_9 ( & V_2 -> V_344 , V_12 ) ;
if ( V_2 -> V_42 . V_13 != 0 || V_2 -> V_86 != 0 ) {
F_4 ( V_666 L_172 , V_646 -> V_3 ) ;
F_11 ( & V_2 -> V_344 , V_12 ) ;
return - V_345 ;
}
V_2 -> V_86 = 1 ;
...
static int F_259 ( struct V_645 * V_646 )
{
struct V_1 * V_2 = F_252 ( V_646 ) ;
unsigned long V_12 ;
if ( V_19 >= V_20 )
F_4 ( L_173 , __FILE__ , V_646 -> V_3 ) ;
F_254 ( V_646 ) ;
F_83 ( V_2 ) ;
F_260 ( V_646 ) ;
F_9 ( & V_2 -> V_344 , V_12 ) ;
...
static int F_261 ( struct V_645 * V_646 , struct V_667 * V_668 , int V_299 )
{
const T_10 V_669 = sizeof( V_670 ) ;
V_670 V_671 ;
V_670 T_4 * line = V_668 -> V_672 . V_673 . V_674 ;
struct V_1 * V_2 = F_252 ( V_646 ) ;
unsigned int V_12 ;
if ( V_19 >= V_20 )
F_4 ( L_174 , __FILE__ , V_646 -> V_3 ) ;
if ( V_2 -> V_42 . V_13 )
return - V_345 ;
if ( V_299 != V_675 )
return F_262 ( V_646 , V_668 , V_299 ) ;
switch( V_668 -> V_672 . type ) {
case V_676 :
V_668 -> V_672 . type = V_677 ;
if ( V_668 -> V_672 . V_669 < V_669 ) {
V_668 -> V_672 . V_669 = V_669 ;
return - V_678 ;
}
V_12 = V_2 -> V_36 . V_12 & ( V_679 | V_501 |
V_502 | V_503 |
V_680 | V_504 |
V_505 | V_506 ) ;
switch ( V_12 ) {
case ( V_679 | V_680 ) : V_671 . V_681 = V_682 ; break;
case ( V_502 | V_505 ) : V_671 . V_681 = V_683 ; break;
case ( V_679 | V_505 ) : V_671 . V_681 = V_684 ; break;
case ( V_679 | V_506 ) : V_671 . V_681 = V_685 ; break;
default: V_671 . V_681 = V_686 ;
}
V_671 . V_687 = V_2 -> V_36 . V_514 ;
V_671 . V_578 = V_2 -> V_36 . V_578 ? 1 : 0 ;
if ( F_263 ( line , & V_671 , V_669 ) )
return - V_243 ;
return 0 ;
case V_677 :
if( ! F_78 ( V_688 ) )
return - V_689 ;
if ( F_264 ( & V_671 , line , V_669 ) )
return - V_243 ;
switch ( V_671 . V_681 )
{
case V_682 : V_12 = V_679 | V_680 ; break;
case V_685 : V_12 = V_679 | V_506 ; break;
case V_683 : V_12 = V_502 | V_505 ; break;
case V_684 : V_12 = V_679 | V_505 ; break;
case V_686 : V_12 = V_2 -> V_36 . V_12 &
( V_679 | V_501 |
V_502 | V_503 |
V_680 | V_504 |
V_505 | V_506 ) ; break;
...
if ( V_671 . V_578 != 0 && V_671 . V_578 != 1 )
return - V_294 ;
V_2 -> V_36 . V_12 &= ~ ( V_679 | V_501 |
V_502 | V_503 |
V_680 | V_504 |
V_505 | V_506 ) ;
V_2 -> V_36 . V_12 |= V_12 ;
V_2 -> V_36 . V_578 = V_671 . V_578 ;
if ( V_12 & ( V_502 | V_505 ) )
V_2 -> V_36 . V_514 = V_671 . V_687 ;
else
V_2 -> V_36 . V_514 = 0 ;
if ( V_2 -> V_86 )
F_87 ( V_2 ) ;
...
static void F_265 ( struct V_645 * V_646 )
{
struct V_1 * V_2 = F_252 ( V_646 ) ;
unsigned long V_12 ;
if ( V_19 >= V_20 )
...
static void F_243 ( struct V_1 * V_2 , char * V_231 , int V_669 )
{
struct V_658 * V_659 = F_268 ( V_669 ) ;
struct V_645 * V_646 = V_2 -> V_113 ;
if ( V_19 >= V_20 )
F_4 ( L_176 , V_646 -> V_3 ) ;
if ( V_659 == NULL ) {
F_4 ( V_692 L_177 ,
...
memcpy ( F_269 ( V_659 , V_669 ) , V_231 , V_669 ) ;
V_659 -> V_694 = F_270 ( V_659 , V_646 ) ;
V_646 -> V_611 . V_695 ++ ;
V_646 -> V_611 . V_696 += V_669 ;
F_271 ( V_659 ) ;
}
...
V_646 -> V_698 = V_2 -> V_137 ;
V_646 -> V_455 = V_2 -> V_177 ;
V_646 -> V_456 = V_2 -> V_353 ;
V_646 -> V_699 = & V_700 ;
V_646 -> V_701 = 10 * V_224 ;
V_646 -> V_702 = 50 ;
V_697 = F_273 ( V_646 ) ;
V_697 -> V_703 = F_251 ;
V_697 -> V_641 = F_253 ;
if ( ( V_24 = F_274 ( V_646 ) ) ) {
F_4 ( V_666 L_179 , __FILE__ ) ;
F_275 ( V_646 ) ;
return V_24 ;
}
V_2 -> V_113 = V_646 ;
...
static int T_12 F_277 ( struct V_704 * V_646 ,
...
V_2 -> V_137 = F_279 ( V_646 , 2 ) ;
V_2 -> V_177 = V_646 -> V_455 ;
V_2 -> V_351 = F_279 ( V_646 , 3 ) ;
V_2 -> V_352 = F_279 ( V_646 , 0 ) ;
V_2 -> V_420 = V_2 -> V_352 & ( V_423 - 1 ) ;
V_2 -> V_352 &= ~ ( V_423 - 1 ) ;
V_2 -> V_349 = V_350 ;
V_2 -> V_414 = 8 ;
V_2 -> V_416 = V_707 ;
if ( V_646 -> V_708 == 0x0210 ) {
...
static void T_13 F_280 ( struct V_704 * V_646 )
{
}
