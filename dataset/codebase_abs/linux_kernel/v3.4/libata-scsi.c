...
L_28 ,
V_22 -> V_199 ) ;
F_74 ( V_196 , V_22 -> V_199 - 1 ) ;
if ( V_2 -> V_13 & V_204 )
F_75 ( V_205 , V_22 -> V_206 ) ;
if ( V_2 -> V_13 & V_207 ) {
int V_208 ;
V_208 = F_76 ( V_22 -> V_30 -> V_209 , F_77 ( V_2 -> V_89 ) ) ;
V_208 = F_76 ( V_210 - 1 , V_208 ) ;
F_78 ( V_22 , V_211 , V_208 ) ;
}
F_79 ( V_196 , false ) ;
V_2 -> V_22 = V_22 ;
return 0 ;
...
F_7 ( V_10 -> V_18 , V_13 ) ;
V_215 = F_76 ( V_215 , V_22 -> V_30 -> V_209 ) ;
V_215 = F_76 ( V_215 , F_77 ( V_2 -> V_89 ) ) ;
V_215 = F_76 ( V_215 , V_210 - 1 ) ;
if ( V_22 -> V_215 == V_215 )
return - V_17 ;
F_78 ( V_22 , V_211 , V_215 ) ;
return V_215 ;
}
int F_86 ( struct V_21 * V_22 , int V_215 ,
int V_216 )
{
struct V_9 * V_10 = F_3 ( V_22 -> V_30 ) ;
return F_83 ( V_10 , V_22 , V_215 , V_216 ) ;
}
...
static void F_92 ( const T_3 * V_219 , T_7 * V_242 , T_8 * V_243 )
{
T_7 V_244 = 0 ;
T_8 V_42 = 0 ;
F_91 ( L_30 ) ;
...
static void F_93 ( const T_3 * V_219 , T_7 * V_242 , T_8 * V_243 )
{
T_7 V_244 = 0 ;
T_8 V_42 = 0 ;
F_91 ( L_31 ) ;
...
if ( V_142 -> V_221 < 10 )
goto V_222;
F_92 ( V_219 , & V_185 , & V_246 ) ;
} else if ( V_219 [ 0 ] == V_248 ) {
if ( V_142 -> V_221 < 16 )
goto V_222;
F_93 ( V_219 , & V_185 , & V_246 ) ;
} else
goto V_222;
if ( ! V_246 )
goto V_249;
...
V_29 = F_99 ( & V_135 -> V_148 , V_135 -> V_2 , V_185 , V_246 , V_259 ,
V_135 -> V_268 ) ;
if ( F_63 ( V_29 == 0 ) )
return 0 ;
if ( V_29 == - V_269 )
...
static void * F_105 ( struct V_52 * V_53 , bool V_286 ,
unsigned long * V_13 )
{
F_5 ( & V_287 , * V_13 ) ;
...
static inline void F_107 ( struct V_52 * V_53 , bool V_290 ,
unsigned long * V_13 )
{
if ( V_290 )
...
static unsigned int F_112 ( struct V_291 * args , T_3 * V_292 )
{
const T_3 V_294 [] = {
0 ,
0x80 ,
...
V_148 . V_177 = 0x1 ;
V_148 . V_176 = 0x1 ;
F_116 ( & V_148 , 0 , 1 , & V_292 [ 36 ] ) ;
V_292 [ 36 ] = 0x34 ;
V_292 [ 56 ] = V_303 ;
memcpy ( & V_292 [ 60 ] , & args -> V_89 [ 0 ] , 512 ) ;
return 0 ;
}
static unsigned int F_117 ( struct V_291 * args , T_3 * V_292 )
{
T_6 V_304 ;
V_292 [ 1 ] = 0xb0 ;
V_292 [ 3 ] = 0x3c ;
V_304 = 1 << F_118 ( args -> V_89 ) ;
F_119 ( V_304 , & V_292 [ 6 ] ) ;
if ( F_120 ( args -> V_89 ) ) {
F_121 ( 65535 * 512 / 8 , & V_292 [ 36 ] ) ;
F_122 ( 1 , & V_292 [ 28 ] ) ;
}
return 0 ;
}
static unsigned int F_123 ( struct V_291 * args , T_3 * V_292 )
{
int V_305 = F_124 ( args -> V_89 ) ;
int V_306 = F_125 ( args -> V_89 ) ;
V_292 [ 1 ] = 0xb1 ;
V_292 [ 3 ] = 0x3c ;
V_292 [ 4 ] = V_306 >> 8 ;
V_292 [ 5 ] = V_306 ;
...
static unsigned int F_126 ( struct V_291 * args , T_3 * V_292 )
{
V_292 [ 1 ] = 0xb2 ;
V_292 [ 3 ] = 0x4 ;
V_292 [ 5 ] = 1 << 6 ;
...
static unsigned int F_127 ( struct V_291 * args , T_3 * V_292 )
{
F_91 ( L_34 ) ;
return 0 ;
}
static unsigned int F_128 ( T_6 * V_89 , T_3 * V_5 )
{
...
static unsigned int F_131 ( T_3 * V_5 )
{
memcpy ( V_5 , V_308 , sizeof( V_308 ) ) ;
return sizeof( V_308 ) ;
}
static unsigned int F_132 ( T_3 * V_5 )
{
memcpy ( V_5 , V_309 , sizeof( V_309 ) ) ;
return sizeof( V_309 ) ;
}
static int F_133 ( T_6 * V_89 )
{
...
if ( ! F_134 ( V_89 ) )
return 0 ;
F_135 ( V_89 , V_310 , V_92 , sizeof( V_310 ) ) ;
F_135 ( V_89 , V_311 , V_94 , sizeof( V_311 ) ) ;
...
static unsigned int F_136 ( struct V_291 * args , T_3 * V_292 )
{
...
V_320 = 0 ;
if ( F_133 ( args -> V_89 ) && ( V_2 -> V_13 & V_251 ) &&
...
static unsigned int F_137 ( struct V_291 * args , T_3 * V_292 )
{
struct V_25 * V_2 = args -> V_2 ;
...
T_6 V_333 ;
V_199 = F_72 ( V_2 -> V_89 ) ;
V_332 = F_118 ( V_2 -> V_89 ) ;
V_333 = F_138 ( V_2 -> V_89 , V_332 ) ;
F_91 ( L_34 ) ;
...
static unsigned int F_140 ( struct V_291 * args , T_3 * V_292 )
{
F_91 ( L_34 ) ;
V_292 [ 3 ] = 8 ;
return 0 ;
...
static inline int F_142 ( struct V_9 * V_10 )
{
...
F_145 ( V_135 ) ;
F_146 ( & V_135 -> V_337 , V_53 -> V_60 , V_107 ) ;
F_103 ( V_135 , & V_135 -> V_337 , 1 ) ;
V_135 -> V_277 = V_112 ;
...
static void F_147 ( struct V_134 * V_135 )
{
struct V_52 * V_53 = V_135 -> V_136 ;
...
static unsigned int F_148 ( struct V_134 * V_135 )
{
struct V_52 * V_142 = V_135 -> V_136 ;
struct V_25 * V_2 = V_135 -> V_2 ;
...
V_135 -> V_148 . V_150 = V_340 ;
F_53 ( V_135 ) ;
if ( ! V_348 && ! V_349 && F_149 ( V_135 ) )
V_349 = 1 ;
V_146 = F_76 ( F_150 ( V_135 ) , ( unsigned int ) 63 * 1024 ) ;
if ( V_146 & 0x1 )
V_146 ++ ;
...
static struct V_25 * F_151 ( struct V_9 * V_10 , int V_40 )
{
if ( ! F_152 ( V_10 ) ) {
if ( F_63 ( V_40 < F_153 ( & V_10 -> V_24 ) ) )
...
struct V_25 * V_2 = V_135 -> V_2 ;
const T_3 * V_219 = V_142 -> V_220 ;
if ( ( V_148 -> V_225 = F_154 ( V_219 [ 1 ] ) ) == V_360 )
goto V_222;
if ( V_219 [ 0 ] == V_114 ) {
if ( V_219 [ 1 ] & 0x01 ) {
V_148 -> V_361 = V_219 [ 3 ] ;
...
static unsigned int F_157 ( struct V_134 * V_135 )
{
struct V_147 * V_148 = & V_135 -> V_148 ;
struct V_52 * V_142 = V_135 -> V_136 ;
struct V_25 * V_2 = V_135 -> V_2 ;
...
if ( ! F_52 ( V_142 ) )
goto V_222;
V_5 = F_158 ( F_159 ( F_51 ( V_142 ) ) ) ;
V_400 = F_160 ( V_5 , 512 , V_185 , V_246 ) ;
V_148 -> V_225 = V_358 ;
V_148 -> V_361 = 0 ;
V_148 -> V_152 = V_401 ;
...
static inline T_9 F_161 ( struct V_25 * V_2 , T_3 V_53 )
{
switch ( V_53 ) {
case V_266 :
case V_264 :
...
static inline void F_163 ( struct V_9 * V_10 ,
struct V_52 * V_53 )
{
#ifdef F_164
...
static inline int F_165 ( struct V_52 * V_142 ,
struct V_25 * V_2 )
{
...
goto V_407;
V_272 = F_161 ( V_2 , V_406 ) ;
} else {
if ( F_17 ( ! V_142 -> V_221 ) )
goto V_407;
V_272 = NULL ;
if ( F_63 ( ( V_406 != V_114 ) || ! V_408 ) ) {
int V_42 = F_166 ( V_406 ) ;
...
int F_168 ( struct V_7 * V_8 , struct V_52 * V_53 )
{
struct V_9 * V_10 ;
struct V_25 * V_2 ;
struct V_21 * V_98 = V_53 -> V_1 ;
...
void F_167 ( struct V_25 * V_2 , struct V_52 * V_53 )
{
struct V_291 args ;
...
int F_170 ( struct V_425 * V_30 , struct V_426 * V_427 )
{
int V_158 , V_29 ;
...
struct V_7 * V_8 ;
V_29 = - V_109 ;
V_8 = F_171 ( V_427 , sizeof( struct V_9 * ) ) ;
if ( ! V_8 )
goto V_430;
V_8 -> V_431 = 1 ;
* (struct V_9 * * ) & V_8 -> V_432 [ 0 ] = V_10 ;
V_10 -> V_433 = V_8 ;
V_8 -> V_434 = V_435 ;
V_8 -> V_436 = V_10 -> V_175 ;
V_8 -> V_437 = 16 ;
V_8 -> V_438 = 1 ;
V_8 -> V_439 = 1 ;
V_8 -> V_440 = 16 ;
V_8 -> V_441 = 1 ;
V_29 = F_172 ( V_10 -> V_433 ,
& V_10 -> V_442 , V_10 -> V_30 -> V_2 ) ;
if ( V_29 )
goto V_443;
}
return 0 ;
V_443:
F_173 ( V_30 -> V_429 [ V_158 ] -> V_433 ) ;
V_430:
while ( -- V_158 >= 0 ) {
struct V_7 * V_8 = V_30 -> V_429 [ V_158 ] -> V_433 ;
F_174 ( V_8 ) ;
F_173 ( V_8 ) ;
}
return V_29 ;
}
void F_175 ( struct V_9 * V_10 , int V_444 )
{
int V_445 = 5 ;
struct V_25 * V_446 = NULL ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
V_447:
F_176 (link, ap, EDGE) {
F_177 (dev, link, ENABLED) {
struct V_21 * V_22 ;
int V_355 = 0 , V_89 = 0 ;
if ( V_2 -> V_22 )
continue;
...
V_355 = V_24 -> V_448 ;
V_22 = F_179 ( V_10 -> V_433 , V_355 , V_89 , 0 ,
NULL ) ;
if ( ! F_180 ( V_22 ) ) {
V_2 -> V_22 = V_22 ;
F_181 ( V_22 ) ;
...
F_184 ( V_450 , & V_10 -> V_451 ,
F_185 ( V_116 ) ) ;
}
int F_186 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 ) {
F_187 ( V_2 -> V_22 , V_452 ) ;
return 1 ;
}
return 0 ;
}
static void F_188 ( struct V_25 * V_2 )
{
struct V_9 * V_10 = V_2 -> V_24 -> V_10 ;
struct V_21 * V_22 ;
unsigned long V_13 ;
F_189 ( & V_10 -> V_433 -> V_453 ) ;
F_5 ( V_10 -> V_18 , V_13 ) ;
V_22 = V_2 -> V_22 ;
V_2 -> V_22 = NULL ;
if ( V_22 ) {
...
void F_197 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 )
F_198 ( V_2 -> V_22 , V_205 ,
V_456 ) ;
}
void F_199 ( struct V_457 * V_458 )
{
struct V_9 * V_10 =
F_200 ( V_458 , struct V_9 , V_451 . V_458 ) ;
int V_158 ;
if ( V_10 -> V_36 & V_459 ) {
F_97 ( L_54 ) ;
return;
...
F_196 ( & V_10 -> V_354 [ V_158 ] ) ;
F_175 ( V_10 , 0 ) ;
F_192 ( & V_10 -> V_460 ) ;
F_97 ( L_36 ) ;
}
int F_201 ( struct V_7 * V_8 , unsigned int V_355 ,
...
if ( ! V_10 -> V_61 -> V_170 )
return - V_34 ;
if ( V_356 != V_462 && V_356 )
return - V_17 ;
if ( ! F_152 ( V_10 ) ) {
if ( V_355 != V_462 && V_355 )
return - V_17 ;
V_40 = V_89 ;
} else {
if ( V_89 != V_462 && V_89 )
...
struct V_23 * V_24 ;
F_176 (link, ap, EDGE) {
struct V_463 * V_464 = & V_24 -> V_48 ;
V_464 -> V_465 |= V_466 ;
V_464 -> V_84 |= V_85 ;
}
} else {
struct V_25 * V_2 = F_151 ( V_10 , V_40 ) ;
if ( V_2 ) {
struct V_463 * V_464 = & V_2 -> V_24 -> V_48 ;
V_464 -> V_465 |= 1 << V_2 -> V_40 ;
V_464 -> V_84 |= V_85 ;
} else
V_29 = - V_17 ;
}
...
void F_202 ( struct V_457 * V_458 )
{
struct V_9 * V_10 =
F_200 ( V_458 , struct V_9 , V_467 ) ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
unsigned long V_13 ;
F_189 ( & V_10 -> V_460 ) ;
...
struct V_9 * F_204 ( struct V_425 * V_30 ,
struct V_468 * V_469 ,
struct V_7 * V_8 )
{
struct V_9 * V_10 ;
...
V_10 -> V_470 = 0 ;
V_10 -> V_18 = & V_30 -> V_18 ;
V_10 -> V_471 = V_469 -> V_471 ;
V_10 -> V_472 = V_469 -> V_472 ;
V_10 -> V_473 = V_469 -> V_473 ;
V_10 -> V_13 |= V_469 -> V_13 ;
V_10 -> V_61 = V_469 -> V_474 ;
V_10 -> V_475 = V_476 ;
return V_10 ;
}
...
void F_208 ( struct V_9 * V_10 )
{
F_209 ( V_10 ) ;
}
int F_210 ( struct V_9 * V_10 )
{
return F_211 ( V_10 ) ;
}
int F_212 ( struct V_9 * V_10 )
{
int V_29 = V_10 -> V_61 -> V_478 ( V_10 ) ;
if ( V_29 )
return V_29 ;
V_10 -> V_175 = F_213 ( & V_479 ) ;
return 0 ;
}
void F_214 ( struct V_9 * V_10 )
{
if ( V_10 -> V_61 -> V_480 )
V_10 -> V_61 -> V_480 ( V_10 ) ;
F_43 ( V_10 ) ;
}
int F_215 ( struct V_21 * V_22 , struct V_9 * V_10 )
{
F_61 ( V_22 ) ;
F_66 ( V_22 , V_10 -> V_24 . V_1 ) ;
return 0 ;
}
int F_216 ( struct V_52 * V_53 , struct V_9 * V_10 )
{
int V_29 = 0 ;
F_163 ( V_10 , V_53 ) ;
if ( F_63 ( F_84 ( V_10 -> V_24 . V_1 ) ) )
V_29 = F_165 ( V_53 , V_10 -> V_24 . V_1 ) ;
else {
V_53 -> V_57 = ( V_410 << 16 ) ;
V_53 -> V_76 ( V_53 ) ;
}
