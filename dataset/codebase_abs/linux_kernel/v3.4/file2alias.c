...
static int F_45 ( const char * V_57 , struct V_239 * V_13 ,
char * V_21 )
{
V_13 -> V_240 = F_9 ( V_13 -> V_240 ) ;
V_13 -> V_241 = F_9 ( V_13 -> V_241 ) ;
V_13 -> V_242 = F_9 ( V_13 -> V_242 ) ;
V_13 -> V_60 = F_9 ( V_13 -> V_60 ) ;
strcpy ( V_21 , L_105 ) ;
F_5 ( V_21 , L_106 , V_13 -> V_60 != V_243 , V_13 -> V_60 ) ;
F_5 ( V_21 , L_107 , V_13 -> V_241 != V_244 , V_13 -> V_241 ) ;
F_5 ( V_21 , L_108 , V_13 -> V_242 != V_245 , V_13 -> V_242 ) ;
strcat ( V_21 , L_109 ) ;
if ( V_13 -> V_240 != V_246 )
sprintf ( V_21 + strlen ( V_21 ) , L_110 , V_13 -> V_240 ) ;
return 1 ;
}
static bool F_46 ( const char * V_56 , unsigned V_247 , const char * V_248 )
{
if ( V_247 != strlen ( V_248 ) )
return false ;
return memcmp ( V_56 , V_248 , V_247 ) == 0 ;
}
...
unsigned int V_8 ;
char V_21 [ 500 ] ;
int (* F_48)( const char * , void * V_249 , char * V_21 ) = V_119 ;
...
void F_49 ( struct V_19 * V_20 , struct V_250 * V_251 ,
T_3 * V_252 , const char * V_253 )
{
void * V_7 ;
char * V_254 = NULL ;
const char * V_56 ;
unsigned int V_247 ;
if ( ! V_252 -> V_255 || F_50 ( V_251 , V_252 ) >= V_251 -> V_256 )
return;
if ( F_51 ( V_252 -> V_257 ) != V_258 )
return;
V_56 = strstr ( V_253 , L_111 ) ;
if ( ! V_56 )
return;
V_56 += strlen ( L_111 ) ;
V_247 = strlen ( V_56 ) ;
if ( V_247 < strlen ( L_112 ) )
return;
if ( strcmp ( V_56 + V_247 - strlen ( L_112 ) , L_112 ) )
return;
V_247 -= strlen ( L_112 ) ;
if ( V_251 -> V_259 [ F_50 ( V_251 , V_252 ) ] . V_260 & V_261 ) {
V_254 = calloc ( 1 , V_252 -> V_262 ) ;
V_7 = V_254 ;
} else {
V_7 = ( void * ) V_251 -> V_263
+ V_251 -> V_259 [ F_50 ( V_251 , V_252 ) ] . V_264
+ V_252 -> V_265 ;
}
if ( F_46 ( V_56 , V_247 , L_30 ) )
F_10 ( V_7 , V_252 -> V_262 , V_20 ) ;
else if ( F_46 ( V_56 , V_247 , L_57 ) )
F_20 ( V_7 , V_252 -> V_262 , V_20 ) ;
else if ( F_46 ( V_56 , V_247 , L_113 ) )
F_21 ( V_7 , V_252 -> V_262 , V_20 ) ;
else {
struct V_266 * * V_236 ;
F_52 ( V_267 ) ;
for ( V_236 = V_268 ; V_236 < V_269 ; V_236 ++ ) {
if ( F_46 ( V_56 , V_247 , ( * V_236 ) -> V_4 ) ) {
F_47 ( V_7 , V_252 -> V_262 , ( * V_236 ) -> V_6 ,
...
void F_53 ( struct V_270 * V_271 , struct V_19 * V_20 )
{
F_6 ( V_271 , L_9 ) ;
F_54 ( V_271 , V_20 -> V_40 . V_236 , V_20 -> V_40 . V_272 ) ;
