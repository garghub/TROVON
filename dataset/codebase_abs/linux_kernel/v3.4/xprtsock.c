...
static void * F_163 ( struct V_73 * V_74 , T_4 V_276 )
{
struct V_54 * V_54 ;
struct V_277 * V_4 ;
F_133 ( V_276 > V_278 - sizeof( struct V_277 ) ) ;
V_54 = F_164 ( V_21 ) ;
if ( ! V_54 )
return NULL ;
V_4 = F_165 ( V_54 ) ;
...
static void F_166 ( void * V_279 )
{
struct V_277 * V_4 ;
if ( ! V_279 )
return;
V_4 = F_27 ( V_279 , struct V_277 , V_180 ) ;
...
V_64 = F_169 ( V_37 , V_280 ,
F_170 ( V_280 -> V_70 [ 0 ] . V_50 ) , V_281 ,
...
V_8 = V_82 -> V_78 -> V_287 ;
V_286 = F_27 ( V_8 , struct V_285 , V_288 ) ;
if ( ! F_172 ( & V_8 -> V_289 ) ) {
F_173 ( & V_8 -> V_290 , V_74 , NULL ) ;
if ( ! F_172 ( & V_8 -> V_289 ) )
return - V_84 ;
F_174 ( & V_8 -> V_290 , V_74 ) ;
}
if ( F_31 ( V_291 , & V_8 -> V_292 ) )
V_64 = - V_90 ;
else
V_64 = F_168 ( V_82 ) ;
F_175 ( & V_8 -> V_289 ) ;
...
static struct V_7 * F_180 ( struct V_298 * args ,
unsigned int V_299 ,
unsigned int V_300 )
{
struct V_7 * V_8 ;
...
V_8 = F_181 ( args -> V_303 , sizeof( * V_301 ) , V_299 ,
V_300 ) ;
if ( V_8 == NULL ) {
F_2 ( L_88
L_89 ) ;
...
V_301 = F_27 ( V_8 , struct V_75 , V_8 ) ;
memcpy ( & V_8 -> V_9 , args -> V_305 , args -> V_38 ) ;
V_8 -> V_38 = args -> V_38 ;
if ( args -> V_219 )
memcpy ( & V_301 -> V_219 , args -> V_219 , args -> V_38 ) ;
else {
int V_57 ;
V_57 = F_178 ( args -> V_305 -> V_16 ,
(struct V_6 * ) & V_301 -> V_219 ) ;
if ( V_57 != 0 ) {
F_60 ( V_8 ) ;
return F_141 ( V_57 ) ;
}
...
static struct V_7 * F_182 ( struct V_298 * args )
{
struct V_10 * V_15 = (struct V_10 * ) args -> V_305 ;
struct V_75 * V_76 ;
struct V_7 * V_8 ;
struct V_7 * V_83 ;
V_8 = F_180 ( args , V_306 ,
V_307 ) ;
if ( F_149 ( V_8 ) )
return V_8 ;
V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
V_8 -> V_308 = 0 ;
V_8 -> V_309 = sizeof( V_92 ) / sizeof( T_1 ) ;
V_8 -> V_310 = V_311 ;
V_8 -> V_312 = V_313 ;
V_8 -> V_122 = V_196 ;
V_8 -> V_314 = V_315 ;
...
static struct V_7 * F_185 ( struct V_298 * args )
{
struct V_6 * V_9 = args -> V_305 ;
struct V_7 * V_8 ;
struct V_75 * V_76 ;
struct V_7 * V_83 ;
V_8 = F_180 ( args , V_321 ,
V_321 ) ;
if ( F_149 ( V_8 ) )
return V_8 ;
V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
...
switch ( V_9 -> V_16 ) {
case V_22 :
if ( ( (struct V_11 * ) V_9 ) -> V_326 != F_186 ( 0 ) )
F_130 ( V_8 ) ;
F_183 ( & V_76 -> V_126 ,
F_148 ) ;
F_15 ( V_8 , L_93 , V_327 ) ;
break;
case V_25 :
if ( ( (struct V_12 * ) V_9 ) -> V_328 != F_186 ( 0 ) )
F_130 ( V_8 ) ;
F_183 ( & V_76 -> V_126 ,
F_148 ) ;
F_15 ( V_8 , L_93 , V_329 ) ;
...
static struct V_7 * F_187 ( struct V_298 * args )
{
struct V_6 * V_9 = args -> V_305 ;
struct V_7 * V_8 ;
struct V_75 * V_76 ;
...
static struct V_7 * F_188 ( struct V_298 * args )
{
struct V_6 * V_9 = args -> V_305 ;
struct V_7 * V_8 ;
struct V_75 * V_76 ;
...
V_8 -> V_19 [ V_32 ] ) ;
F_189 ( V_8 ) ;
args -> V_287 -> V_335 = V_8 ;
V_8 -> V_287 = args -> V_287 ;
V_334 = F_27 ( args -> V_287 , struct V_285 , V_288 ) ;
V_76 -> V_37 = V_334 -> V_337 ;
V_76 -> V_79 = V_334 -> V_338 ;
F_146 ( V_8 ) ;
if ( F_184 ( V_127 ) )
return V_8 ;
F_190 ( V_8 ) ;
...
static int F_198 ( const char * V_345 ,
...
if ( ! V_345 )
return - V_259 ;
V_83 = F_199 ( V_345 , 0 , & V_350 ) ;
if ( V_83 == - V_259 || V_350 < V_348 || V_350 > V_349 )
return - V_259 ;
* ( ( unsigned int * ) V_347 -> V_179 ) = V_350 ;
return 0 ;
}
static int F_200 ( const char * V_345 , const struct V_346 * V_347 )
{
return F_198 ( V_345 , V_347 ,
V_351 ,
V_352 ) ;
}
static int F_201 ( const char * V_345 ,
const struct V_346 * V_347 )
{
return F_198 ( V_345 , V_347 ,
V_353 ,
...
static int F_202 ( const char * V_345 ,
const struct V_346 * V_347 )
{
return F_198 ( V_345 , V_347 ,
V_353 ,
