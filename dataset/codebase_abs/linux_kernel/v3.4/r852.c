...
V_10 -> V_164 . V_169 = 2 ;
V_10 -> V_164 . V_170 = F_38 ;
V_10 -> V_164 . V_171 = F_39 ;
V_10 -> V_164 . V_172 = F_40 ;
V_10 -> V_164 . V_173 = F_41 ;
...
if ( V_2 -> V_130 ) {
F_42 ( V_2 ) ;
V_2 -> V_10 -> V_183 ( V_2 -> V_8 , 0 ) ;
V_2 -> V_10 -> V_76 ( V_2 -> V_8 , V_184 , - 1 , - 1 ) ;
V_2 -> V_10 -> V_183 ( V_2 -> V_8 , - 1 ) ;
}
F_46 ( V_2 ) ;
return 0 ;
}
