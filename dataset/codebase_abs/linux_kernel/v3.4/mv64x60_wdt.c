...
static int T_6 F_23 ( struct V_55 * V_56 )
{
struct V_57 * V_58 = V_56 -> V_56 . V_59 ;
struct V_60 * V_61 ;
int V_15 = 10 ;
V_16 = 133 ;
if ( V_58 ) {
...
V_16 ++ ;
V_16 *= 1000000 ;
V_61 = F_24 ( V_56 , V_62 , 0 ) ;
if ( ! V_61 )
return - V_63 ;
V_7 = F_25 ( V_61 -> V_64 , F_26 ( V_61 ) ) ;
if ( V_7 == NULL )
return - V_65 ;
F_10 ( V_15 ) ;
F_9 () ;
...
static int T_7 F_28 ( struct V_55 * V_56 )
{
F_29 ( & V_66 ) ;
F_9 () ;
F_30 ( V_7 ) ;
