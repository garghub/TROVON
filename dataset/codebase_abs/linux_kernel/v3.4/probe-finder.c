...
V_129 -> V_132 = F_75 ( V_81 ) ;
} else if ( ! F_84 ( V_87 ) ) {
if ( V_127 -> V_124 )
V_129 -> V_132 = F_81 ( V_87 , V_81 ) ;
else {
...
V_81 -> V_25 += V_127 -> V_32 ;
V_129 -> V_132 = F_63 ( V_87 , V_81 ) ;
}
} else
V_129 -> V_132 = F_85 ( V_87 ,
F_82 , ( void * ) V_81 ) ;
return V_133 ;
}
static int F_86 ( struct V_80 * V_81 )
{
struct V_128 V_134 = { . V_104 = ( void * ) V_81 ,
. V_132 = 0 } ;
F_87 ( & V_81 -> V_86 , F_83 , & V_134 , 0 ) ;
return V_134 . V_132 ;
}
static int F_88 ( T_12 * V_17 , T_13 * V_135 , void * V_104 )
{
struct V_136 * V_129 = V_104 ;
if ( F_89 ( V_17 , V_135 -> V_137 , V_129 -> V_87 ) ) {
if ( F_47 ( V_129 -> V_87 ) != V_96 )
return V_131 ;
if ( F_48 ( V_129 -> V_87 , V_129 -> V_109 ) ) {
if ( ! F_89 ( V_17 , V_135 -> V_138 , V_129 -> V_86 ) )
return V_131 ;
if ( V_129 -> V_107 &&
...
& V_143 , 0 ) ;
if ( V_143 . V_7 ) {
V_42 = F_83 ( & V_81 -> V_87 , & V_144 ) ;
if ( V_42 )
goto V_7;
}
}
while ( ! F_93 ( V_10 -> V_17 , V_139 , & V_140 , & V_141 , NULL , NULL , NULL ) ) {
V_142 = F_89 ( V_10 -> V_17 , V_139 + V_141 , & V_81 -> V_86 ) ;
if ( ! V_142 )
continue;
if ( V_127 -> V_107 )
...
{
struct V_145 * V_146 =
F_96 ( V_81 , struct V_145 , V_81 ) ;
struct V_147 * V_148 ;
int V_42 , V_149 ;
if ( V_146 -> V_150 == V_146 -> V_151 ) {
F_40 ( L_64 ,
V_146 -> V_151 ) ;
return - V_59 ;
}
V_148 = & V_146 -> V_152 [ V_146 -> V_150 ++ ] ;
V_42 = F_60 ( & V_81 -> V_87 , V_81 -> V_25 ,
V_81 -> V_111 -> V_112 . V_89 , & V_148 -> V_112 ) ;
if ( V_42 < 0 )
return V_42 ;
F_3 ( L_65 , V_148 -> V_112 . V_94 ,
V_148 -> V_112 . V_32 ) ;
V_148 -> V_153 = V_81 -> V_111 -> V_153 ;
V_148 -> args = F_4 ( sizeof( struct V_35 ) * V_148 -> V_153 ) ;
if ( V_148 -> args == NULL )
return - V_8 ;
for ( V_149 = 0 ; V_149 < V_81 -> V_111 -> V_153 ; V_149 ++ ) {
V_81 -> V_82 = & V_81 -> V_111 -> args [ V_149 ] ;
V_81 -> V_36 = & V_148 -> args [ V_149 ] ;
V_42 = F_56 ( V_84 , V_81 ) ;
if ( V_42 != 0 )
return V_42 ;
}
...
struct V_154 * V_111 ,
struct V_147 * * V_152 , int V_151 )
{
struct V_145 V_146 = {
. V_81 = { . V_111 = V_111 , . V_102 = F_95 } ,
. V_151 = V_151 } ;
int V_42 ;
* V_152 = F_4 ( sizeof( struct V_147 ) * V_151 ) ;
if ( * V_152 == NULL )
return - V_8 ;
V_146 . V_152 = * V_152 ;
V_146 . V_150 = 0 ;
V_42 = F_90 ( V_10 , & V_146 . V_81 ) ;
if ( V_42 < 0 ) {
free ( * V_152 ) ;
* V_152 = NULL ;
return V_42 ;
}
return ( V_42 < 0 ) ? V_42 : V_146 . V_150 ;
}
static int F_98 ( T_4 * V_75 , void * V_104 )
{
struct V_155 * V_156 = V_104 ;
struct V_157 * V_158 ;
char V_62 [ V_159 ] ;
int V_76 , V_42 ;
V_158 = & V_156 -> V_160 [ V_156 -> V_161 - 1 ] ;
V_76 = F_47 ( V_75 ) ;
if ( V_76 == V_162 ||
V_76 == V_163 ) {
V_42 = F_35 ( V_75 , V_156 -> V_81 . V_25 ,
V_156 -> V_81 . V_34 , NULL ) ;
if ( V_42 == 0 ) {
V_42 = F_99 ( V_75 , V_62 , V_159 ) ;
F_23 ( L_66 , V_62 ) ;
if ( V_42 > 0 )
F_100 ( V_158 -> V_164 , V_62 ) ;
}
}
if ( V_156 -> V_165 && F_101 ( V_75 , V_156 -> V_81 . V_25 ) )
return V_166 ;
else
return V_167 ;
}
...
{
struct V_155 * V_156 =
F_96 ( V_81 , struct V_155 , V_81 ) ;
struct V_157 * V_158 ;
T_4 V_75 ;
int V_42 ;
if ( V_156 -> V_161 == V_156 -> V_168 ) {
F_40 ( L_64 , V_156 -> V_168 ) ;
return - V_59 ;
}
V_158 = & V_156 -> V_160 [ V_156 -> V_161 ++ ] ;
V_42 = F_60 ( & V_81 -> V_87 , V_81 -> V_25 ,
V_81 -> V_111 -> V_112 . V_89 , & V_158 -> V_112 ) ;
if ( V_42 < 0 )
return V_42 ;
F_3 ( L_65 , V_158 -> V_112 . V_94 ,
V_158 -> V_112 . V_32 ) ;
V_158 -> V_164 = F_103 ( true , NULL ) ;
if ( V_158 -> V_164 == NULL )
return - V_8 ;
V_156 -> V_165 = true ;
F_104 ( V_84 , F_98 , ( void * ) V_156 , & V_75 ) ;
if ( ! V_156 -> V_169 )
goto V_170;
V_156 -> V_165 = false ;
F_104 ( & V_81 -> V_86 , F_98 , ( void * ) V_156 , & V_75 ) ;
V_170:
if ( F_105 ( V_158 -> V_164 ) ) {
F_106 ( V_158 -> V_164 ) ;
V_158 -> V_164 = NULL ;
}
return V_42 ;
...
struct V_154 * V_111 ,
struct V_157 * * V_160 ,
int V_168 , bool V_169 )
{
struct V_155 V_156 = {
. V_81 = { . V_111 = V_111 , . V_102 = F_102 } ,
. V_168 = V_168 , . V_169 = V_169 } ;
int V_42 ;
* V_160 = F_4 ( sizeof( struct V_157 ) * V_168 ) ;
if ( * V_160 == NULL )
return - V_8 ;
V_156 . V_160 = * V_160 ;
V_156 . V_161 = 0 ;
V_42 = F_90 ( V_10 , & V_156 . V_81 ) ;
if ( V_42 < 0 ) {
while ( V_156 . V_161 -- ) {
if ( V_156 . V_160 [ V_156 . V_161 ] . V_112 . V_94 )
free ( V_156 . V_160 [ V_156 . V_161 ] . V_112 . V_94 ) ;
if ( V_156 . V_160 [ V_156 . V_161 ] . V_164 )
F_106 ( V_156 . V_160 [ V_156 . V_161 ] . V_164 ) ;
}
free ( V_156 . V_160 ) ;
* V_160 = NULL ;
return V_42 ;
}
return ( V_42 < 0 ) ? V_42 : V_156 . V_161 ;
}
...
T_2 V_175 , V_176 ;
const char * V_113 = NULL , * V_177 = NULL , * V_178 ;
int V_179 = 0 , V_115 = 0 , V_42 = 0 ;
V_25 += V_10 -> V_18 ;
if ( ! F_109 ( V_10 -> V_17 , ( T_2 ) V_25 - V_10 -> V_18 , & V_172 ) ) {
F_40 ( L_67 ,
V_25 ) ;
V_42 = - V_27 ;
goto V_180;
}
F_110 ( & V_172 , V_25 , & V_113 , & V_115 ) ;
if ( F_64 ( & V_172 , ( T_2 ) V_25 , & V_173 ) ) {
V_178 = F_38 ( & V_173 ) ;
if ( ! V_178 ||
F_61 ( & V_173 , & V_176 ) != 0 ||
F_70 ( & V_173 , & V_179 ) != 0 )
goto V_181;
V_177 = V_178 ;
if ( V_25 == ( unsigned long ) V_176 )
V_115 = V_179 ;
else if ( F_111 ( & V_173 , ( T_2 ) V_25 ,
& V_174 ) ) {
if ( F_61 ( & V_174 , & V_175 ) == 0 &&
V_175 == V_25 )
V_115 = F_112 ( & V_174 ) ;
else {
V_178 = F_38 ( & V_174 ) ;
...
V_181:
if ( V_115 )
V_171 -> line = V_115 - V_179 ;
else if ( V_177 )
V_171 -> V_32 = V_25 - ( unsigned long ) V_176 ;
if ( V_177 ) {
V_171 -> V_109 = F_24 ( V_177 ) ;
if ( V_171 -> V_109 == NULL ) {
V_42 = - V_8 ;
goto V_180;
}
...
V_180:
if ( V_42 == 0 && ( V_113 || V_177 ) )
V_42 = 1 ;
return V_42 ;
}
static int F_113 ( const char * V_182 , unsigned int V_115 ,
struct V_183 * V_184 )
{
if ( ! V_184 -> V_11 ) {
V_184 -> V_11 = F_24 ( V_182 ) ;
if ( V_184 -> V_11 == NULL )
return - V_8 ;
}
return F_1 ( & V_184 -> V_185 , V_115 ) ;
}
static int F_114 ( const char * V_113 , int V_115 ,
T_2 V_25 V_28 ,
void * V_104 )
{
struct V_186 * V_187 = V_104 ;
if ( ( F_74 ( V_113 , V_187 -> V_113 ) != 0 ) ||
( V_187 -> V_188 > V_115 || V_187 -> V_189 < V_115 ) )
return 0 ;
if ( F_113 ( V_113 , V_115 , V_187 -> V_184 ) < 0 )
return - V_27 ;
return 0 ;
}
static int F_115 ( T_4 * V_87 , struct V_186 * V_187 )
{
int V_42 ;
V_42 = F_76 ( V_87 ? : & V_187 -> V_86 , F_114 , V_187 ) ;
if ( V_42 >= 0 )
if ( ! F_11 ( & V_187 -> V_184 -> V_185 ) )
V_42 = V_187 -> V_7 = 1 ;
else
V_42 = 0 ;
else {
free ( V_187 -> V_184 -> V_11 ) ;
V_187 -> V_184 -> V_11 = NULL ;
}
return V_42 ;
}
...
{
struct V_128 * V_129 = V_104 ;
struct V_186 * V_187 = V_129 -> V_104 ;
struct V_183 * V_184 = V_187 -> V_184 ;
if ( V_184 -> V_107 && F_74 ( V_184 -> V_107 , F_69 ( V_87 ) ) )
return V_131 ;
if ( F_47 ( V_87 ) == V_96 &&
F_48 ( V_87 , V_184 -> V_109 ) ) {
V_187 -> V_113 = F_69 ( V_87 ) ;
F_70 ( V_87 , & V_184 -> V_32 ) ;
F_3 ( L_68 , V_187 -> V_113 , V_184 -> V_32 ) ;
V_187 -> V_188 = V_184 -> V_32 + V_184 -> V_190 ;
if ( V_187 -> V_188 < 0 )
V_187 -> V_188 = V_114 ;
V_187 -> V_189 = V_184 -> V_32 + V_184 -> V_180 ;
if ( V_187 -> V_189 < 0 )
V_187 -> V_189 = V_114 ;
F_3 ( L_69 , V_187 -> V_188 , V_187 -> V_189 ) ;
V_184 -> V_190 = V_187 -> V_188 ;
V_184 -> V_180 = V_187 -> V_189 ;
if ( F_84 ( V_87 ) )
V_129 -> V_132 = F_85 ( V_87 ,
F_116 , V_187 ) ;
else
V_129 -> V_132 = F_115 ( V_87 , V_187 ) ;
return V_133 ;
}
return V_131 ;
}
...
{
struct V_128 V_129 = { . V_104 = ( void * ) V_187 , . V_132 = 0 } ;
F_87 ( & V_187 -> V_86 , F_117 , & V_129 , 0 ) ;
return V_129 . V_132 ;
}
int F_119 ( struct V_9 * V_10 , struct V_183 * V_184 )
{
struct V_186 V_187 = { . V_184 = V_184 , . V_7 = 0 } ;
int V_42 = 0 ;
T_14 V_139 = 0 , V_140 ;
T_7 V_141 ;
T_4 * V_142 ;
...
if ( V_184 -> V_109 ) {
struct V_136 V_143 = {
. V_109 = V_184 -> V_109 , . V_107 = V_184 -> V_107 ,
. V_86 = & V_187 . V_86 , . V_87 = & V_187 . V_87 , . V_7 = 0 } ;
struct V_128 V_192 = {
. V_104 = ( void * ) & V_187 , . V_132 = 0 } ;
F_92 ( V_10 -> V_17 , F_88 ,
& V_143 , 0 ) ;
if ( V_143 . V_7 ) {
F_117 ( & V_187 . V_87 , & V_192 ) ;
if ( V_187 . V_7 )
goto V_7;
}
}
while ( ! V_187 . V_7 && V_42 >= 0 ) {
if ( F_93 ( V_10 -> V_17 , V_139 , & V_140 , & V_141 ,
NULL , NULL , NULL ) != 0 )
break;
V_142 = F_89 ( V_10 -> V_17 , V_139 + V_141 , & V_187 . V_86 ) ;
if ( ! V_142 )
continue;
if ( V_184 -> V_107 )
V_187 . V_113 = F_94 ( & V_187 . V_86 , V_184 -> V_107 ) ;
else
V_187 . V_113 = 0 ;
if ( ! V_184 -> V_107 || V_187 . V_113 ) {
if ( V_184 -> V_109 )
V_42 = F_118 ( & V_187 ) ;
else {
V_187 . V_188 = V_184 -> V_190 ;
V_187 . V_189 = V_184 -> V_180 ;
V_42 = F_115 ( NULL , & V_187 ) ;
}
}
V_139 = V_140 ;
}
V_7:
if ( V_187 . V_7 ) {
V_191 = F_120 ( & V_187 . V_86 ) ;
if ( V_191 ) {
V_184 -> V_191 = F_24 ( V_191 ) ;
if ( ! V_184 -> V_191 )
V_42 = - V_8 ;
}
}
F_3 ( L_70 , V_184 -> V_11 ) ;
return ( V_42 < 0 ) ? V_42 : V_187 . V_7 ;
}
