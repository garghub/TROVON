...
V_7 = V_242 [ 0 ] ;
F_33 ( & V_7 , 0 ) ;
if ( V_1 -> V_4 . V_4 . V_34 && V_1 -> V_4 . V_4 . V_34 -> V_243 ) {
type = F_23 ( V_1 , V_6 ) ;
} else if ( V_241 ) {
struct V_244 V_245 ;
if ( F_34 ( & V_1 -> V_4 , V_6 ,
...
struct V_1 * V_1 = F_3 ( V_6 ) ;
const struct V_19 * V_19 = F_9 ( V_1 ) ;
if ( V_19 -> V_83 < 480 && V_250 -> V_251 == 480 )
V_250 -> type |= V_252 ;
...
int V_51 , V_253 = 0 ;
T_2 V_245 ;
for ( V_51 = 0 ; V_51 < F_38 ( V_254 ) ;
V_51 ++ ) {
const struct V_255 * V_256 = & V_254 [ V_51 ] ;
unsigned int V_257 = V_256 -> V_258 ;
unsigned int V_259 = V_256 -> V_260 ;
if ( V_19 -> V_261 && V_256 -> V_258 > V_19 -> V_261 )
continue;
if ( V_256 -> V_258 > 1024 && ( ! V_19 -> V_121
&& ! V_19 -> V_238 ) )
continue;
V_250 = F_39 ( V_6 -> V_9 ) ;
if ( ! V_250 )
continue;
strncpy ( V_250 -> V_23 , V_256 -> V_23 , V_262 ) ;
V_250 -> V_263 = V_257 ;
V_250 -> V_264 = V_257 + 1 ;
V_250 -> V_71 = V_257 + 64 ;
if ( V_250 -> V_71 <= V_250 -> V_264 )
V_250 -> V_71 = V_250 -> V_264 + 1 ;
V_250 -> V_73 = V_257 + 96 ;
V_250 -> V_251 = V_259 ;
V_250 -> V_265 = V_259 + 1 ;
...
V_245 = ( T_2 ) V_19 -> V_26 * V_250 -> V_267 ;
V_245 *= V_250 -> V_73 ;
V_245 = F_40 ( V_245 , 1000000 ) ;
V_250 -> clock = ( int ) V_245 ;
V_250 -> type = V_268 ;
F_36 ( V_6 , V_250 ) ;
F_41 ( V_6 , V_250 ) ;
V_253 ++ ;
...
static int
F_46 ( struct V_5 * V_6 , struct V_269 * V_270 ,
T_3 V_271 )
{
...
int V_272 = 0 ;
bool V_273 = false ;
V_272 = F_31 ( V_6 , V_270 , V_271 ) ;
if ( V_272 < 0 )
goto V_274;
if ( V_270 == V_9 -> V_32 . V_275 &&
V_1 -> V_198 [ V_199 ] != V_271 ) {
V_1 -> V_198 [ V_199 ] = V_271 ;
V_273 = true ;
} else if ( V_270 == V_9 -> V_32 . V_276 &&
V_1 -> V_198 [ V_201 ] != V_271 ) {
V_1 -> V_198 [ V_201 ] = V_271 ;
V_273 = true ;
} else if ( V_270 == V_9 -> V_32 . V_277 &&
V_1 -> V_198 [ V_200 ] != V_271 ) {
V_1 -> V_198 [ V_200 ] = V_271 ;
V_273 = true ;
} else if ( V_270 == V_9 -> V_32 . V_278 &&
V_1 -> V_198 [ V_202 ] != V_271 ) {
V_1 -> V_198 [ V_202 ] = V_271 ;
V_273 = true ;
} else if ( V_270 == V_9 -> V_32 . V_239 ) {
if ( V_271 >= F_38 ( V_22 ) ) {
V_272 = - V_279 ;
goto V_274;
}
if ( ! strcmp ( V_1 -> V_20 , V_22 [ V_271 ] . V_23 ) )
goto V_274;
V_1 -> V_20 = V_22 [ V_271 ] . V_23 ;
V_273 = true ;
} else {
V_272 = - V_279 ;
goto V_274;
...
if ( V_273 && V_34 )
F_47 ( V_34 , & V_34 -> V_7 , V_34 -> V_280 ,
V_34 -> V_281 , V_34 -> V_282 ) ;
V_274:
return V_272 ;
}
...
return 1 ;
V_272 = 0 ;
for ( V_21 = 0 ; V_21 < V_11 -> V_285 ; V_21 ++ ) {
V_284 = V_11 -> V_286 + V_21 ;
...
struct V_291 * V_291 ;
struct V_292 * V_292 ;
T_1 V_293 , V_294 , V_215 ;
char * V_295 [ F_38 ( V_22 ) ] ;
int V_21 , V_296 = 0 ;
if ( ( F_7 ( V_14 ) & V_297 ) == V_298 )
return;
if ( ! F_48 ( V_9 ) ) {
F_28 ( L_6 ) ;
return;
...
( V_294 & V_227 ) != 0 )
return;
V_1 = F_50 ( sizeof( struct V_1 ) , V_300 ) ;
if ( ! V_1 ) {
return;
}
V_292 = F_50 ( sizeof( struct V_292 ) , V_300 ) ;
if ( ! V_292 ) {
F_45 ( V_1 ) ;
return;
}
...
F_51 ( V_9 , V_6 , & V_302 ,
V_67 ) ;
F_52 ( V_9 , & V_291 -> V_4 , & V_303 ,
V_304 ) ;
F_53 ( V_292 , V_291 ) ;
V_291 -> type = V_305 ;
V_291 -> V_306 = ( 1 << 0 ) | ( 1 << 1 ) ;
V_291 -> V_307 = ( 1 << V_308 ) ;
V_291 -> V_4 . V_309 = ( ( 1 << 0 ) | ( 1 << 1 ) ) ;
V_291 -> V_4 . V_310 = ( 1 << V_305 ) ;
V_1 -> type = V_57 ;
V_1 -> V_198 [ V_199 ] = 54 ;
V_1 -> V_198 [ V_200 ] = 36 ;
V_1 -> V_198 [ V_201 ] = 46 ;
V_1 -> V_198 [ V_202 ] = 37 ;
V_1 -> V_20 = V_22 [ V_296 ] . V_23 ;
F_54 ( & V_291 -> V_4 , & V_311 ) ;
F_55 ( V_6 , & V_312 ) ;
V_6 -> V_313 = false ;
V_6 -> V_314 = false ;
for ( V_21 = 0 ; V_21 < F_38 ( V_22 ) ; V_21 ++ )
V_295 [ V_21 ] = ( char * ) V_22 [ V_21 ] . V_23 ;
F_56 ( V_9 ,
F_38 ( V_22 ) ,
V_295 ) ;
