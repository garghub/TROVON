...
{
int V_34 = 0 ;
if ( F_143 ( V_67 , V_69 ) == 1 ) {
struct V_73 * V_73 ;
T_4 V_61 ;
V_61 = F_108 ( V_119 -> V_63 ) ;
V_73 = F_101 ( * V_67 ) ;
F_144 ( V_67 ) ;
F_145 ( V_119 , V_67 , V_99 ) ;
F_130 ( V_73 ) ;
F_19 ( F_132 ( V_73 ) < 0 ) ;
...
int F_147 ( struct V_68 * V_69 , T_5 * V_67 ,
...
int F_148 ( struct V_68 * V_69 , struct V_68 * V_123 ,
unsigned long V_124 ,
...
V_34 = F_143 ( V_127 , V_69 ) ;
if ( V_34 == 1 ) {
V_67 = F_150 ( V_63 , V_124 , V_127 ) ;
F_19 ( ! F_72 ( * V_128 ) ) ;
...
int F_151 ( struct V_68 * V_69 , T_5 * V_67 ,
...
if ( F_143 ( V_67 , V_69 ) == 1 ) {
T_5 V_75 ;
V_75 = F_150 ( V_63 , V_99 , V_67 ) ;
V_75 = F_152 ( V_75 , V_130 ) ;
...
int F_143 ( T_5 * V_67 , struct V_68 * V_69 )
{
...
if ( V_85 & ~ V_87 )
goto V_16;
V_132 = F_154 ( V_63 , V_85 ) ;
if ( ! F_155 ( * V_132 ) )
goto V_16;
V_133 = F_156 ( V_132 , V_85 ) ;
if ( ! F_157 ( * V_133 ) )
goto V_16;
V_67 = F_158 ( V_133 , V_85 ) ;
if ( F_72 ( * V_67 ) )
goto V_16;
if ( F_101 ( * V_67 ) != V_73 )
goto V_16;
...
static int F_159 ( struct V_73 * V_73 ,
struct V_68 * V_69 ,
unsigned long V_85 )
{
struct V_62 * V_63 = V_69 -> V_122 ;
...
int V_34 = 0 ;
F_71 ( & V_63 -> V_64 ) ;
V_67 = F_153 ( V_73 , V_63 , V_85 ,
V_134 ) ;
if ( V_67 ) {
F_160 ( V_69 , V_85 , V_67 ) ;
V_34 = 1 ;
}
F_73 ( & V_63 -> V_64 ) ;
return V_34 ;
}
static void F_161 ( struct V_73 * V_73 )
{
int V_108 ;
struct V_1 * V_1 = F_162 ( V_73 ) ;
int V_136 = 0 ;
F_163 ( & V_1 -> V_137 ) ;
F_164 ( V_73 ) ;
F_165 ( V_73 ) ;
...
V_136 += F_132 ( V_138 ) ;
F_166 ( V_136 < 0 ) ;
F_166 ( F_167 ( & V_138 -> V_139 ) != 0 ) ;
F_168 ( F_132 ( V_73 ) + F_132 ( V_138 ) + 1 ,
& V_138 -> V_139 ) ;
F_169 () ;
...
F_166 ( ! F_172 ( V_138 ) ) ;
F_166 ( ! F_173 ( V_138 ) ) ;
F_174 ( V_1 , V_73 , V_138 ) ;
}
F_175 ( V_136 , & V_73 -> V_139 ) ;
F_166 ( F_167 ( & V_73 -> V_139 ) <= 0 ) ;
F_176 ( V_73 , V_150 ) ;
F_177 ( V_1 , V_151 , V_51 ) ;
F_178 ( V_73 ) ;
F_179 ( V_73 ) ;
F_180 ( & V_1 -> V_137 ) ;
...
static int F_182 ( struct V_73 * V_73 ,
struct V_68 * V_69 ,
unsigned long V_85 )
{
struct V_62 * V_63 = V_69 -> V_122 ;
...
F_129 () ;
F_79 ( V_63 , V_85 , V_67 , F_186 ( * V_67 ) ) ;
F_187 ( V_69 , V_85 , V_85 + V_90 ) ;
F_122 ( V_63 , V_67 , V_61 ) ;
V_34 = 1 ;
}
F_73 ( & V_63 -> V_64 ) ;
...
static void F_188 ( struct V_73 * V_73 ,
struct V_104 * V_104 )
{
int V_152 , V_153 ;
struct V_154 * V_155 ;
...
F_166 ( F_189 ( V_73 ) ) ;
V_152 = 0 ;
F_190 (avc, &anon_vma->head, same_anon_vma) {
struct V_68 * V_69 = V_155 -> V_69 ;
unsigned long V_99 = F_191 ( V_73 , V_69 ) ;
F_166 ( F_192 ( V_69 ) ) ;
if ( V_99 == - V_156 )
continue;
V_152 += F_159 ( V_73 , V_69 , V_99 ) ;
}
if ( V_152 != F_132 ( V_73 ) )
F_13 ( V_20 L_15 ,
V_152 , F_132 ( V_73 ) ) ;
F_166 ( V_152 != F_132 ( V_73 ) ) ;
F_161 ( V_73 ) ;
V_153 = 0 ;
F_190 (avc, &anon_vma->head, same_anon_vma) {
struct V_68 * V_69 = V_155 -> V_69 ;
...
static inline struct V_163 * F_201 ( void )
{
if ( ! V_13 )
return NULL ;
return F_202 ( V_13 , V_94 ) ;
}
static inline void F_203 ( struct V_163 * V_163 )
{
F_204 ( V_13 , V_163 ) ;
}
static int T_3 F_54 ( void )
{
V_14 = F_205 ( V_164 * sizeof( struct V_165 ) ,
V_94 ) ;
if ( ! V_14 )
return - V_15 ;
return 0 ;
}
static struct V_163 * F_206 ( struct V_62 * V_63 )
{
struct V_163 * V_163 ;
struct V_165 * V_166 ;
struct V_167 * V_168 ;
...
% V_164 ] ;
V_163 -> V_63 = V_63 ;
F_209 ( & V_163 -> V_169 , V_166 ) ;
}
static inline int F_210 ( struct V_62 * V_63 )
{
return F_167 ( & V_63 -> V_170 ) == 0 ;
}
...
if ( V_69 -> V_177 )
return 0 ;
F_19 ( F_215 ( V_69 ) || V_69 -> V_70 & V_161 ) ;
...
static void F_225 ( T_7 * V_88 , T_7 * V_180 )
{
while ( -- V_180 >= V_88 ) {
T_7 V_181 = * V_180 ;
if ( ! F_126 ( V_181 ) )
...
if ( ! F_229 ( V_181 ) || ! F_230 ( V_181 ) ) {
F_225 ( V_88 , V_180 ) ;
goto V_16;
}
V_73 = F_231 ( V_69 , V_85 , V_181 ) ;
if ( F_9 ( ! V_73 ) ) {
F_225 ( V_88 , V_180 ) ;
goto V_16;
}
...
F_252 ( V_69 -> V_104 ) ;
V_88 = F_95 ( V_67 , V_85 ) ;
V_185 = F_253 ( V_63 , V_67 ) ;
F_71 ( & V_63 -> V_64 ) ;
V_107 = F_121 ( V_69 , V_85 , V_67 ) ;
F_73 ( & V_63 -> V_64 ) ;
F_71 ( V_185 ) ;
V_183 = F_228 ( V_69 , V_85 , V_88 ) ;
F_73 ( V_185 ) ;
if ( F_9 ( ! V_183 ) ) {
F_128 ( V_88 ) ;
F_71 ( & V_63 -> V_64 ) ;
...
F_254 ( V_69 -> V_104 ) ;
F_240 ( V_88 , V_114 , V_69 , V_85 , V_185 ) ;
F_128 ( V_88 ) ;
F_70 ( V_114 ) ;
V_61 = F_255 ( V_107 ) ;
F_19 ( F_181 ( V_61 ) != 1 ) ;
...
if ( ! F_251 ( * V_67 ) || F_94 ( * V_67 ) )
goto V_16;
V_88 = F_257 ( V_63 , V_67 , V_85 , & V_185 ) ;
...
if ( ! F_229 ( V_181 ) || ! F_230 ( V_181 ) )
goto V_191;
V_73 = F_231 ( V_69 , V_190 , V_181 ) ;
if ( F_9 ( ! V_73 ) )
goto V_191;
if ( V_168 == - 1 )
V_168 = F_114 ( V_73 ) ;
F_19 ( F_65 ( V_73 ) ) ;
if ( ! F_236 ( V_73 ) || F_235 ( V_73 ) || ! F_170 ( V_73 ) )
goto V_191;
if ( F_181 ( V_73 ) != 1 )
goto V_191;
if ( F_237 ( V_181 ) || F_238 ( V_73 ) ||
...
F_258 ( V_88 , V_185 ) ;
if ( V_34 )
F_244 ( V_63 , V_85 , V_186 , V_69 , V_168 ) ;
V_16:
return V_34 ;
}
static void F_259 ( struct V_163 * V_163 )
{
struct V_62 * V_63 = V_163 -> V_63 ;
F_19 ( V_192 != 1 && ! F_260 ( & V_172 ) ) ;
if ( F_210 ( V_63 ) ) {
F_217 ( & V_163 -> V_169 ) ;
F_110 ( & V_163 -> V_173 ) ;
F_203 ( V_163 ) ;
...
static void F_264 ( struct V_73 * * V_186 )
{
