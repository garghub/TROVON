...
V_57 = V_59 - V_55 ;
for ( V_56 = 0 ; V_56 < V_57 && ! F_31 ( & V_43 ) ; V_56 ++ ) {
V_2 = F_28 () ;
F_40 ( V_2 ) ;
}
V_59 -= V_56 ;
...
static T_3 F_44 ( struct V_64 * V_64 , char T_4 * V_65 ,
T_5 V_66 , T_6 * V_67 )
{
char V_68 [ V_15 + 1 ] ;
unsigned long V_8 ;
...
return 0 ;
F_7 ( & V_13 , V_8 ) ;
V_69 = F_45 ( V_68 , V_15 + 1 , L_5 , V_10 ) ;
F_8 ( & V_13 , V_8 ) ;
return F_46 ( V_65 , V_66 , V_67 , V_68 , V_69 ) ;
}
static T_3 F_47 ( struct V_64 * V_64 , const char T_4 * V_70 ,
T_5 V_66 , T_6 * V_67 )
{
char V_68 [ V_15 ] ;
unsigned long V_8 ;
T_5 V_69 ;
int V_56 ;
V_69 = F_48 ( V_66 , ( T_5 ) ( V_15 - 1 ) ) ;
if ( F_49 ( V_68 , V_70 , V_69 ) )
return - V_71 ;
V_68 [ V_69 ] = 0 ;
F_50 ( & V_13 , V_8 ) ;
if ( ! isalnum ( V_68 [ 0 ] ) ) {
...
static int F_58 ( struct V_4 * V_5 , struct V_1 * * V_85 )
{
struct V_1 * V_2 ;
unsigned long V_8 ;
int V_66 = 0 , V_56 ;
...
static int F_63 ( struct V_86 * V_87 , unsigned long V_88 , void * V_89 )
{
struct V_4 * V_5 = V_89 ;
struct V_1 * V_90 ( V_2 ) ;
int V_66 ;
...
if ( V_48 )
return;
V_87 = F_38 ( sizeof( struct V_86 ) , V_60 ) ;
if ( V_87 == NULL ) {
F_32 ( L_23 ) ;
return;
}
...
static inline bool F_77 ( void * V_101 , unsigned long V_69 , void * V_102 , void * V_103 )
{
...
static void F_78 ( struct V_4 * V_5 , void * V_101 , unsigned long V_69 )
{
if ( F_77 ( V_101 , V_69 , V_108 , V_109 ) ||
F_77 ( V_101 , V_69 , V_110 , V_111 ) )
F_64 ( V_5 , NULL , L_48 , V_101 , V_69 ) ;
}
...
static int T_7 F_104 ( char * V_96 )
{
int V_56 ;
