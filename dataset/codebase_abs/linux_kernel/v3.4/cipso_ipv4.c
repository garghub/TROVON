...
T_1 V_125 = 0 ;
for (; ; ) {
V_83 = F_58 ( V_27 -> V_117 . V_118 . V_83 ,
V_83 + 1 ) ;
if ( V_83 < 0 )
break;
if ( ( V_125 + 2 ) > V_110 )
...
return - V_119 ;
for (; ; ) {
V_16 = F_58 ( V_27 -> V_117 . V_118 . V_83 ,
V_16 + 1 ) ;
if ( V_16 < 0 )
break;
...
return - V_119 ;
V_132 [ V_134 ++ ] = V_16 ;
V_16 = F_68 ( V_27 -> V_117 . V_118 . V_83 ,
V_16 ) ;
if ( V_16 < 0 )
return - V_98 ;
V_135 += sizeof( T_3 ) ;
...
V_27 -> V_36 |= V_147 ;
if ( V_146 > 4 ) {
V_27 -> V_117 . V_118 . V_83 =
F_75 ( V_50 ) ;
if ( V_27 -> V_117 . V_118 . V_83 == NULL )
return - V_21 ;
V_44 = F_59 ( V_54 ,
& V_150 [ 4 ] ,
V_146 - 4 ,
...
static int F_82 ( const struct V_52 * V_54 ,
const unsigned char * V_150 ,
struct V_26 * V_27 )
{
...
int F_83 ( const struct V_42 * V_43 , unsigned char * * V_154 )
{
...
void F_85 ( struct V_42 * V_43 , int error , T_1 V_167 )
{
if ( F_86 ( V_43 ) -> V_168 == V_169 || error != - V_170 )
return;
if ( V_167 )
F_87 ( V_43 , V_171 , V_172 , 0 ) ;
else
F_87 ( V_43 , V_171 , V_173 , 0 ) ;
}
static int F_88 ( unsigned char * V_140 , T_1 V_174 ,
...
return 0 ;
V_174 = V_136 ;
V_140 = F_90 ( V_174 , V_50 ) ;
if ( V_140 == NULL ) {
V_44 = - V_21 ;
goto V_183;
}
V_44 = F_88 ( V_140 , V_174 , V_54 , V_27 ) ;
if ( V_44 < 0 )
goto V_183;
V_174 = V_44 ;
V_158 = ( V_174 + 3 ) & ~ 3 ;
...
V_140 = NULL ;
V_180 = F_91 ( V_176 ) ;
V_178 = F_92 ( V_180 -> V_187 , F_93 ( V_176 ) ) ;
if ( V_180 -> V_188 ) {
V_182 = F_94 ( V_176 ) ;
if ( V_178 )
...
static int F_100 ( struct V_177 * * V_197 )
{
int V_198 = 0 ;
...
void F_101 ( struct V_175 * V_176 )
{
int V_198 ;
struct V_177 * V_155 ;
struct V_179 * V_180 ;
V_180 = F_91 ( V_176 ) ;
V_155 = F_92 ( V_180 -> V_187 , 1 ) ;
if ( V_155 == NULL || V_155 -> V_155 . V_81 == 0 )
return;
V_198 = F_100 ( & V_180 -> V_187 ) ;
if ( V_180 -> V_188 && V_198 > 0 ) {
struct V_181 * V_182 = F_94 ( V_176 ) ;
V_182 -> V_189 -= V_198 ;
V_182 -> V_190 ( V_176 , V_182 -> V_191 ) ;
}
}
void F_102 ( struct V_192 * V_193 )
{
struct V_177 * V_155 ;
struct V_194 * V_195 ;
V_195 = F_98 ( V_193 ) ;
...
static int F_103 ( const unsigned char * V_81 ,
struct V_26 * V_27 )
{
int V_44 = - V_207 ;
T_1 V_53 ;
...
break;
case V_67 :
V_44 = F_78 ( V_54 , & V_81 [ 6 ] , V_27 ) ;
break;
case V_66 :
V_44 = F_80 ( V_54 , & V_81 [ 6 ] , V_27 ) ;
break;
case V_69 :
V_44 = F_82 ( V_54 , & V_81 [ 6 ] , V_27 ) ;
break;
}
if ( V_44 == 0 )
V_27 -> type = V_38 ;
...
int F_104 ( struct V_175 * V_176 , struct V_26 * V_27 )
{
struct V_177 * V_155 ;
int V_209 = - V_207 ;
F_47 () ;
V_155 = F_105 ( F_91 ( V_176 ) -> V_187 ) ;
if ( V_155 && V_155 -> V_155 . V_81 )
V_209 = F_103 ( V_155 -> V_155 . V_184 +
V_155 -> V_155 . V_81 -
sizeof( struct V_186 ) ,
V_27 ) ;
F_49 () ;
...
int F_106 ( struct V_42 * V_43 ,
const struct V_52 * V_54 ,
const struct V_26 * V_27 )
{
int V_44 ;
struct V_186 * V_210 ;
struct V_211 * V_155 = & F_107 ( V_43 ) -> V_155 ;
...
V_44 = F_108 ( V_43 , F_109 ( V_43 ) + V_212 ) ;
if ( V_44 < 0 )
return V_44 ;
if ( V_212 > 0 ) {
V_210 = F_86 ( V_43 ) ;
...
int F_114 ( const struct V_42 * V_43 ,
struct V_26 * V_27 )
{
return F_103 ( F_23 ( V_43 ) , V_27 ) ;
}
