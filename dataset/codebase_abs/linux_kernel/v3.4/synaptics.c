...
static void F_29 ( struct V_4 * V_4 , unsigned int V_47 )
{
struct V_17 * V_18 = V_4 -> V_19 ;
if ( V_47 >= 80 ) {
V_18 -> V_5 |= V_48 ;
...
{
struct V_4 * V_51 = F_31 ( V_50 -> V_51 ) ;
char V_52 = V_53 ;
if ( F_3 ( V_51 , V_16 ) )
return - 1 ;
if ( F_4 ( & V_51 -> V_8 , & V_52 , V_9 ) )
return - 1 ;
return 0 ;
}
...
{
struct V_17 * V_18 = V_4 -> V_19 ;
struct V_4 * V_58 = F_31 ( V_18 -> V_54 ) ;
if ( V_58 ) {
if ( V_58 -> V_61 == 4 )
V_18 -> V_5 |= V_62 ;
else
...
V_50 -> V_31 . type = V_64 ;
F_42 ( V_50 -> V_15 , L_10 , sizeof( V_50 -> V_15 ) ) ;
F_42 ( V_50 -> V_65 , L_11 , sizeof( V_50 -> V_15 ) ) ;
V_50 -> V_66 = F_30 ;
V_50 -> V_67 = F_32 ;
V_50 -> V_68 = F_35 ;
V_50 -> V_51 = V_4 -> V_8 . V_50 ;
V_4 -> V_69 = F_39 ;
F_43 ( V_4 , L_12 ,
V_50 -> V_15 , V_4 -> V_65 ) ;
F_44 ( V_50 ) ;
...
V_73 -> V_1 = ( ( ( V_55 [ 4 ] & 0xf0 ) << 4 ) | V_55 [ 2 ] ) << 1 ;
...
bool V_92 , int V_78 , int V_1 )
{
F_53 ( V_90 , V_91 ) ;
F_54 ( V_90 , V_93 , V_92 ) ;
if ( V_92 ) {
F_55 ( V_90 , V_94 , V_78 ) ;
F_55 ( V_90 , V_95 , F_1 ( V_1 ) ) ;
}
}
...
F_57 ( V_96 -> V_1 , V_97 -> V_1 ) ) ;
F_52 ( V_90 , 1 , true , F_58 ( V_96 -> V_78 , V_97 -> V_78 ) ,
F_58 ( V_96 -> V_1 , V_97 -> V_1 ) ) ;
} else if ( V_98 == 1 ) {
F_52 ( V_90 , 0 , true , V_96 -> V_78 , V_96 -> V_1 ) ;
...
F_36 ( V_4 -> V_57 ) ) {
if ( V_18 -> V_54 )
F_37 ( V_18 -> V_54 , V_4 -> V_57 ) ;
} else
F_72 ( V_4 ) ;
return V_130 ;
}
return F_76 ( V_4 , V_4 -> V_129 - 1 , V_18 -> V_119 ) ?
V_131 : V_132 ;
}
...
static T_2 F_89 ( struct V_4 * V_4 ,
void * V_153 , char * V_55 )
{
struct V_17 * V_18 = V_4 -> V_19 ;
return sprintf ( V_55 , L_15 , V_18 -> V_45 ? '1' : '0' ) ;
}
static T_2 F_90 ( struct V_4 * V_4 ,
...
F_94 ( & V_4 -> V_8 . V_50 -> V_90 ,
& V_159 . V_160 ) ;
F_6 ( V_4 ) ;
F_95 ( V_18 ) ;
V_4 -> V_19 = NULL ;
}
static int F_96 ( struct V_4 * V_4 )
{
struct V_17 * V_18 = V_4 -> V_19 ;
...
static int F_102 ( struct V_4 * V_4 , bool V_43 )
{
struct V_17 * V_18 ;
int V_156 = - 1 ;
if ( V_43 && V_165 ) {
...
V_4 -> V_19 = V_18 = F_41 ( sizeof( struct V_17 ) , V_63 ) ;
if ( ! V_18 )
return - V_167 ;
F_97 ( V_4 ) ;
if ( F_22 ( V_4 ) ) {
...
F_85 ( V_4 -> V_90 , V_18 ) ;
V_4 -> V_169 = ( ( V_18 -> V_22 & 0x00ff0000 ) >> 8 ) |
...
int F_107 ( struct V_4 * V_4 )
{
return F_102 ( V_4 , true ) ;
}
int F_108 ( struct V_4 * V_4 )
{
return F_102 ( V_4 , false ) ;
}
bool F_109 ( void )
{
return true ;
