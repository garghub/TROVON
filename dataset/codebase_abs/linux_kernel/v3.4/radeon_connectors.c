...
static enum V_26
F_55 ( struct V_1 * V_2 , bool V_107 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_8 * V_8 = F_2 ( V_2 ) ;
...
F_49 ( L_9 ,
F_19 ( V_2 ) ) ;
if ( ( V_6 -> V_134 == V_138 || V_6 -> V_134 == V_139 ) && V_8 -> V_47 . V_140 ) {
V_96 = V_50 ;
F_49 ( L_10 , F_19 ( V_2 ) ) ;
V_8 -> V_101 = NULL ;
}
...
V_142 = F_2 ( V_141 ) ;
if ( V_142 -> V_130 &&
( V_142 -> V_101 -> V_143 . V_144 ==
V_8 -> V_101 -> V_143 . V_144 ) ) {
if ( V_141 -> V_13 != V_145 ) {
if ( ! F_4 ( V_6 , V_8 -> V_9 . V_9 ) ) {
F_41 ( V_8 -> V_108 ) ;
V_8 -> V_108 = NULL ;
...
V_158 -> V_173 = F_71 ( V_8 ) ;
if ( F_4 ( V_6 , V_8 -> V_9 . V_9 ) ) {
V_96 = V_39 ;
if ( V_158 -> V_173 == V_174 )
F_70 ( V_8 ) ;
} else {
if ( V_158 -> V_173 == V_174 ) {
if ( F_70 ( V_8 ) )
...
if ( V_8 -> V_101 && V_179 -> V_192 ) {
if ( V_8 -> V_101 -> V_143 . V_144 == V_179 -> V_144 ) {
V_8 -> V_130 = true ;
V_130 = true ;
}
if ( V_8 -> V_193 && V_183 -> V_194 &&
( V_8 -> V_183 . V_195 == V_183 -> V_195 ) ) {
V_8 -> V_130 = false ;
V_130 = false ;
}
}
...
V_8 = F_75 ( sizeof( struct V_8 ) , V_196 ) ;
if ( ! V_8 )
return;
V_2 = & V_8 -> V_47 ;
V_8 -> V_176 = V_176 ;
...
V_8 -> V_9 = * V_9 ;
V_8 -> V_183 = * V_183 ;
if ( V_183 -> V_194 || V_183 -> V_197 ) {
V_8 -> V_193 = F_76 ( V_6 , & V_183 -> V_198 ) ;
if ( ! V_8 -> V_193 )
F_49 ( L_11 ) ;
}
if ( V_186 ) {
V_158 = F_75 ( sizeof( struct V_157 ) , V_196 ) ;
if ( ! V_158 )
goto V_199;
V_158 -> V_180 = V_180 ;
V_8 -> V_110 = V_158 ;
F_77 ( V_4 , & V_8 -> V_47 , & V_200 , V_13 ) ;
F_78 ( & V_8 -> V_47 , & V_201 ) ;
if ( V_179 -> V_192 ) {
if ( V_13 == V_160 )
V_158 -> V_159 = F_79 ( V_4 , V_179 , L_12 ) ;
else
V_158 -> V_159 = F_79 ( V_4 , V_179 , L_13 ) ;
if ( ! V_158 -> V_159 )
F_49 ( L_14 ) ;
V_8 -> V_101 = F_76 ( V_6 , V_179 ) ;
if ( ! V_8 -> V_101 )
F_49 ( L_15 ) ;
}
switch ( V_13 ) {
...
F_78 ( & V_8 -> V_47 , & V_216 ) ;
V_8 -> V_92 = true ;
if ( V_6 -> V_134 == V_220 || V_6 -> V_134 == V_221 )
V_8 -> V_92 = false ;
F_80 ( & V_8 -> V_47 ,
V_6 -> V_69 . V_91 ,
V_8 -> V_92 ) ;
