...
V_2 -> V_100 . V_99 = F_55 ( V_6 ,
V_2 -> V_19 -> V_21 . V_79 -> V_133 ) ;
if ( V_2 -> V_100 . V_99 )
V_2 -> V_100 . V_134 = F_55 ( L_11 ,
V_2 -> V_100 . V_99 ) ;
F_59 ( V_2 ) ;
}
...
return;
sprintf ( V_6 , L_10 , V_2 -> T_8 ) ;
if ( ! F_65 ( V_99 -> V_135 , V_99 , V_99 -> V_135 , V_6 ) )
F_66 ( V_136 L_12
L_13 , V_6 ) ;
}
