...
if ( F_31 ( ! V_27 ) )
return - V_62 ;
V_150 = F_118 ( V_3 -> V_123 , V_155 ) ;
if ( F_49 ( V_150 ) ) {
F_119 ( & V_150 -> V_156 , V_14 ) ;
V_148 -> V_54 = V_150 ;
V_150 -> V_27 = V_27 ;
}
F_55 ( V_27 , V_14 ) ;
...
char * V_165 , unsigned int V_166 )
{
unsigned int V_27 , V_167 = 0 ;
struct V_2 * V_3 = (struct V_2 * ) V_42 -> V_43 ;
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
char V_168 [ V_3 -> V_30 + 1 ] ;
switch ( type ) {
case V_169 :
F_133 ( L_35 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ ) {
F_133 ( L_36 , V_3 -> V_25 [ V_27 ] . V_38 -> V_39 ) ;
V_168 [ V_27 ] = F_131 ( & ( V_3 -> V_25 [ V_27 ] ) ) ;
}
V_168 [ V_27 ] = '\0' ;
F_133 ( L_37 ,
( unsigned long long ) log -> type -> V_83 ( log ) ,
( unsigned long long ) V_3 -> V_78 , V_168 ) ;
V_167 += log -> type -> V_170 ( log , type , V_165 + V_167 , V_166 - V_167 ) ;
break;
case V_171 :
V_167 = log -> type -> V_170 ( log , type , V_165 , V_166 ) ;
F_133 ( L_38 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ )
