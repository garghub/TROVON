...
static int T_5 F_64 ( struct V_54 * V_55 ,
...
F_72 ( V_35 -> V_49 ) ;
V_35 -> V_53 = F_51 ( V_8 , V_35 -> V_49 , V_81 , 256 ) ;
if ( F_52 ( V_35 -> V_53 ) ) {
V_32 = F_53 ( V_35 -> V_53 ) ;
F_25 ( & V_44 ) ;
F_44 ( & V_35 -> V_45 ) ;
...
return;
F_12 ( 0 , L_11 , 8 ) ;
while ( V_86 < V_13 && NULL != ( V_87 = strchr ( string + V_86 , '\n' ) ) ) {
V_85 = V_87 - string + V_86 ;
if ( V_86 + V_85 > V_13 )
break;
F_12 ( 0 , string + V_86 , V_85 ) ;
F_12 ( 0 , L_12 , 2 ) ;
V_86 += V_85 + 1 ;
}
if ( V_86 < V_13 )
F_12 ( 0 , string + V_86 , V_13 - V_86 ) ;
}
void F_79 ( const char * V_29 )
{
F_18 ( 0 , V_29 , strlen ( V_29 ) ) ;
}
void F_80 ( const char * V_88 , ... )
{
static char V_23 [ 512 ] ;
T_8 V_89 ;
va_start ( V_89 , V_88 ) ;
vsnprintf ( V_23 , sizeof( V_23 ) , V_88 , V_89 ) ;
va_end ( V_89 ) ;
F_79 ( V_23 ) ;
}
