...
if ( V_107 == V_110 )
return - V_111 ;
V_16 = F_71 ( V_74 -> V_112 -> V_113 -> V_114 ) ;
V_4 = F_20 ( V_16 ) ;
if ( ! V_4 ) {
V_41 = - V_115 ;
goto V_44;
...
F_73 ( & V_4 -> V_12 ) ;
F_10 ( L_17 ) ;
if ( ( ( V_107 == V_119 ) && ( V_4 -> V_100 != V_102 ) ) ||
( ( V_107 == V_120 ) && ( V_4 -> V_100 != V_101 ) ) ) {
F_10 ( L_18 , V_4 -> V_100 ) ;
V_41 = - V_111 ;
goto V_121;
}
...
static int F_75 ( struct V_106 * V_106 , struct V_74 * V_74 )
{
struct V_68 * V_69 = V_74 -> V_75 ;
F_10 ( L_19 ) ;
F_72 ( & V_69 -> V_4 -> V_12 ) ;
...
static T_5 F_77 ( struct V_74 * V_74 , T_5 V_123 , int V_124 )
{
T_5 V_125 ;
if ( ( V_74 -> V_108 & V_109 ) != V_119 )
return - V_126 ;
if ( V_123 % V_86 )
return - V_126 ;
switch ( V_124 ) {
...
V_4 -> V_135 -> V_137 = & V_138 ;
V_4 -> V_135 -> V_14 = F_84 ( V_133 , V_132 ) ;
V_4 -> V_135 -> V_139 = V_138 . V_139 ;
V_41 = F_85 ( V_4 -> V_135 , V_4 -> V_135 -> V_14 , 1 ) ;
if ( V_41 )
goto V_140;
if ( V_4 -> V_3 -> V_7 . V_141 == V_142 ) {
if ( V_4 -> V_100 == V_102 )
sprintf ( V_134 , L_22 , F_26 ( & V_3 -> V_14 ) ) ;
if ( V_4 -> V_100 == V_101 )
sprintf ( V_134 , L_23 , F_26 ( & V_3 -> V_14 ) ) ;
} else if ( V_4 -> V_3 -> V_7 . V_141 == V_143 ) {
sprintf ( V_134 , L_24 , F_26 ( & V_3 -> V_14 ) ) ;
} else {
V_41 = - V_66 ;
goto V_140;
}
V_4 -> V_55 = F_86 ( V_144 , NULL , V_4 -> V_135 -> V_14 ,
NULL , L_25 , V_134 ) ;
if ( F_42 ( V_4 -> V_55 ) ) {
V_41 = F_43 ( V_4 -> V_55 ) ;
F_10 ( L_26 , V_41 ) ;
...
static int F_88 ( struct V_2 * V_3 , int V_145 )
{
struct V_1 * V_4 ;
int V_41 ;
F_10 ( L_27 , V_3 ) ;
...
if ( ! V_145 && ( F_89 ( & V_4 -> V_13 ) > 2 ) ) {
F_10 ( L_28 ) ;
V_41 = - V_21 ;
goto V_129;
}
F_90 ( V_144 , V_4 -> V_135 -> V_14 ) ;
F_87 ( V_4 -> V_135 ) ;
V_4 -> V_135 = NULL ;
V_41 = 0 ;
V_129:
...
V_148 = F_94 ( L_31 , 4 , 1 , 4 * sizeof( long ) ) ;
if ( ! V_148 )
return - V_32 ;
V_41 = F_95 ( V_148 , & V_149 ) ;
if ( V_41 )
goto V_150;
F_96 ( V_148 , 6 ) ;
V_144 = F_97 ( V_151 , L_31 ) ;
if ( F_42 ( V_144 ) ) {
V_41 = F_43 ( V_144 ) ;
goto V_150;
}
...
if ( V_41 )
goto V_152;
V_41 = F_99 ( & V_14 , 0 , V_153 , L_31 ) ;
if ( V_41 ) {
F_25 ( L_32
L_33 , V_41 ) ;
goto V_154;
}
V_136 = F_84 ( F_82 ( V_14 ) , 0 ) ;
F_100 ( L_34 , V_20 ) ;
return 0 ;
V_154:
F_101 ( & V_18 ) ;
