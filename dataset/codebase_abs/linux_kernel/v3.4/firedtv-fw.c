...
static int F_34 ( struct V_4 * V_77 )
{
struct V_2 * V_3 ;
char V_78 [ V_79 ] ;
int V_80 , V_43 , V_42 ;
...
F_37 ( & V_3 -> V_85 ) ;
F_39 ( & V_3 -> V_86 , V_87 ) ;
V_80 = F_40 ( F_41 ( V_77 ) -> V_88 , V_89 ,
V_78 , sizeof( V_78 ) ) ;
for ( V_43 = F_42 ( V_90 ) ; -- V_43 ; )
if ( strlen ( V_90 [ V_43 ] ) <= V_80 &&
strncmp ( V_78 , V_90 [ V_43 ] , V_80 ) == 0 )
break;
V_3 -> type = V_43 ;
V_42 = F_43 ( V_3 , V_77 ) ;
if ( V_42 )
...
static int F_52 ( struct V_4 * V_77 )
{
struct V_2 * V_3 = F_53 ( V_77 ) ;
F_54 ( V_3 ) ;
F_44 ( & V_75 ) ;
F_50 ( & V_3 -> V_91 ) ;
F_46 ( & V_75 ) ;
...
static void F_55 ( struct F_41 * V_93 )
{
struct V_2 * V_3 = F_53 ( & V_93 -> V_4 ) ;
if ( V_3 -> V_56 >= 0 )
F_56 ( V_3 , V_3 -> V_76 ,
V_3 -> V_56 ) ;
}
