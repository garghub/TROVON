...
struct V_1 * V_2 = V_148 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
T_1 V_28 , V_154 , V_155 , V_156 ;
if ( F_48 ( V_153 ) == 4 ) {
V_155 = F_1 ( V_2 , V_81 ) ;
V_28 = F_1 ( V_2 , V_31 ) ;
if ( ( V_28 & V_150 ) &&
( ( V_155 & V_157 ) == V_158 ) )
F_44 ( V_2 , V_144 -> V_151 , 1 ) ;
else
return - V_115 ;
}
if ( V_10 -> V_111 )
...
break;
default:
F_40 ( V_2 -> V_35 , L_8 , V_171 ,
F_50 ( V_153 ) ) ;
return - V_115 ;
}
if ( V_155 != V_156 || V_28 != V_154 ) {
if ( V_10 -> V_29 ) {
F_10 ( V_2 , 0 ) ;
F_3 ( V_2 , V_31 , V_28 ) ;
F_3 ( V_2 , V_81 , V_155 ) ;
...
V_10 -> V_111 = 1 ;
V_10 -> V_133 = F_49 ( V_153 ) ;
V_10 -> V_135 = F_51 ( V_153 ,
V_134 ) -> V_177 ;
V_10 -> V_137 = F_48 ( V_153 ) ;
if ( V_10 -> V_130 )
F_42 ( V_10 , V_144 ) ;
return 0 ;
}
static int F_52 ( struct V_145 * V_178 ,
...
static int F_53 ( struct V_145 * V_178 ,
unsigned int V_182 )
{
struct V_1 * V_2 = V_178 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
...
static int F_54 ( struct V_145 * V_146 , int V_192 )
{
...
struct V_147 * V_148 = V_144 -> V_149 ;
struct V_1 * V_2 = V_148 -> V_2 ;
F_55 ( V_2 , V_144 -> V_151 , 0 ) ;
}
static int F_58 ( struct V_126 * V_144 ,
struct V_152 * V_153 , struct V_145 * V_146 )
{
struct V_147 * V_148 = V_144 -> V_149 ;
struct V_1 * V_2 = V_148 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
T_1 V_154 , V_28 ;
F_55 ( V_2 , V_144 -> V_151 , 1 ) ;
V_154 = F_1 ( V_2 , V_31 )
& ~ ( V_159 ) ;
V_28 = V_154 ;
switch ( F_49 ( V_153 ) ) {
...
static int F_59 ( struct V_145 * V_178 ,
int V_179 , unsigned int V_180 , int V_181 )
{
struct V_1 * V_2 = V_178 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
...
static int F_60 ( struct V_145 * V_178 ,
unsigned int V_182 )
{
struct V_1 * V_2 = V_178 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
...
static int F_61 ( struct V_145 * V_146 , int V_192 )
{
struct V_1 * V_2 = V_146 -> V_2 ;
...
{
struct V_9 * V_10 ;
V_10 = F_65 ( sizeof( struct V_9 ) , V_204 ) ;
if ( V_10 == NULL ) {
F_40 ( V_2 -> V_35 , L_13 ) ;
return - V_205 ;
}
...
static int T_2 F_70 ( struct V_206 * V_207 )
{
struct V_40 * V_41 = V_207 -> V_35 . V_83 ;
if ( ! V_41 ) {
F_40 ( & V_207 -> V_35 , L_14 ) ;
return - V_115 ;
}
return F_71 ( & V_207 -> V_35 , & V_208 ,
V_209 , F_72 ( V_209 ) ) ;
}
static int T_3 F_73 ( struct V_206 * V_207 )
{
F_74 ( & V_207 -> V_35 ) ;
return 0 ;
}
