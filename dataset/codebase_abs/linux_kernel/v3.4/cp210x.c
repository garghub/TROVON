...
{
int V_11 ;
F_9 ( L_5 , V_16 , V_2 -> V_27 ) ;
V_11 = F_14 ( V_2 , V_28 ,
V_29 ) ;
if ( V_11 ) {
F_4 ( & V_2 -> V_15 , L_6 , V_16 ) ;
return V_11 ;
}
F_17 ( V_26 , V_2 ) ;
if ( V_26 )
...
V_36 = V_26 -> V_34 -> V_35 ;
V_75 = V_72 -> V_35 ;
if ( V_26 -> V_34 -> V_73 != V_72 -> V_73 )
F_18 ( V_26 , V_2 , V_72 ) ;
if ( ( V_36 & V_43 ) != ( V_75 & V_43 ) ) {
F_1 ( V_2 , V_42 , & V_40 , 2 ) ;
V_40 &= ~ V_44 ;
switch ( V_36 & V_43 ) {
case V_46 :
