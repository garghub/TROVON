...
int V_3 , V_81 , V_22 ;
V_6 = F_65 ( sizeof( struct V_5 ) , V_91 ) ;
if ( ! V_6 ) {
V_22 = - V_92 ;
goto V_93;
}
...
V_22 = F_69 ( & V_14 -> V_95 , & V_96 ) ;
if ( V_22 )
goto V_97;
V_81 = F_5 ( V_10 , V_98 ) ;
if ( ! ( V_81 & 0x40 ) ) {
V_22 = F_69 ( & V_14 -> V_95 , & V_99 [ 0 ] ) ;
if ( V_22 )
goto V_100;
}
if ( ! ( V_81 & 0x20 ) ) {
V_22 = F_69 ( & V_14 -> V_95 , & V_99 [ 1 ] ) ;
if ( V_22 )
goto V_100;
}
V_81 = F_5 ( V_10 , V_101 ) ;
if ( V_81 & 0x40 ) {
V_22 = F_69 ( & V_14 -> V_95 , & V_99 [ 2 ] ) ;
if ( V_22 )
goto V_100;
}
if ( V_81 & 0x04 ) {
V_22 = F_69 ( & V_14 -> V_95 , & V_99 [ 3 ] ) ;
if ( V_22 )
goto V_100;
}
V_6 -> V_102 = F_70 ( V_14 ) ;
...
V_100:
F_73 ( & V_14 -> V_95 , & V_96 ) ;
for ( V_3 = 0 ; V_3 < F_74 ( V_99 ) ; V_3 ++ )
F_73 ( & V_14 -> V_95 , & V_99 [ V_3 ] ) ;
V_97:
if ( V_6 -> V_77 [ 0 ] != NULL )
F_60 ( V_6 -> V_77 [ 0 ] ) ;
if ( V_6 -> V_77 [ 1 ] != NULL )
...
V_112 = F_5 ( V_10 , V_47 ) ;
V_6 -> V_39 [ 0 ] = V_112 & 0x03 ;
V_6 -> V_39 [ 1 ] = ( V_112 >> 2 ) & 0x03 ;
V_6 -> V_39 [ 2 ] = ( V_112 >> 4 ) & 0x03 ;
for ( V_3 = 0 ; V_3 < 3 ; V_3 ++ ) {
...
V_6 -> V_25 [ 0 ] = V_111 [ 0 ] & 0x07 ;
V_6 -> V_25 [ 1 ] = ( V_111 [ 0 ] >> 4 ) & 0x07 ;
V_6 -> V_25 [ 2 ] = V_111 [ 1 ] & 0x07 ;
V_6 -> V_25 [ 3 ] = ( V_111 [ 1 ] >> 4 ) & 0x07 ;
V_6 -> V_25 [ 4 ] = V_111 [ 2 ] & 0x07 ;
V_6 -> V_25 [ 5 ] = ( V_111 [ 2 ] >> 4 ) & 0x07 ;
V_6 -> V_25 [ 6 ] = V_111 [ 3 ] & 0x07 ;
V_6 -> V_36 = F_5 ( V_10 , V_125 ) +
( F_5 ( V_10 , V_126 ) << 8 ) +
( F_5 ( V_10 , V_127 ) << 16 ) ;
V_6 -> V_48 = ( F_5 ( V_10 ,
V_128 ) >> 5 ) & 0x01 ;
...
V_112 = F_5 ( V_10 , V_60 [ 0 ] ) ;
V_6 -> V_57 [ 0 ] = V_112 & 0x0f ;
V_6 -> V_57 [ 1 ] = ( V_112 >> 4 ) & 0x0f ;
V_6 -> V_57 [ 2 ] = F_5 ( V_10 ,
V_60 [ 2 ] ) & 0x0f ;
for ( V_3 = 0 ; V_3 < 3 ; V_3 ++ ) {
...
V_112 = F_5 ( V_10 ,
V_66 [ V_3 ] [ 0 ] ) ;
V_6 -> V_64 [ V_3 ] [ 0 ] = V_112 & 0x0f ;
V_6 -> V_64 [ V_3 ] [ 1 ] = ( V_112 >> 4 ) & 0x0f ;
V_112 = F_5 ( V_10 ,
V_66 [ V_3 ] [ 2 ] ) ;
V_6 -> V_64 [ V_3 ] [ 2 ] = ( V_112 >> 4 ) & 0x0f ;
V_6 -> V_64 [ V_3 ] [ 3 ] = V_112 & 0x0f ;
}
V_6 -> V_114 = V_113 ;
V_6 -> V_52 = 1 ;
}
...
static void F_82 ( struct V_5 * V_6 , struct V_13 * V_14 )
{
int V_3 = 0 , V_110 = 0 ;
F_80 ( V_14 , L_13 ) ;
F_80 ( V_14 , L_14 ) ;
for ( V_3 = 0 ; V_3 < 9 ; V_3 ++ ) {
F_80 ( V_14 , L_15 , V_3 , V_6 -> V_7 [ V_3 ] ) ;
F_80 ( V_14 , L_16 , V_3 , V_6 -> V_117 [ V_3 ] ) ;
F_80 ( V_14 , L_17 , V_3 , V_6 -> V_119 [ V_3 ] ) ;
}
F_80 ( V_14 , L_18 , V_6 -> V_8 & 0xff ) ;
F_80 ( V_14 , L_19 , V_6 -> V_8 >> 8 ) ;
F_80 ( V_14 , L_20 ) ;
for ( V_3 = 0 ; V_3 < 7 ; V_3 ++ ) {
F_80 ( V_14 , L_21 , V_3 , V_6 -> V_123 [ V_3 ] ) ;
F_80 ( V_14 , L_22 , V_3 , V_6 -> V_24 [ V_3 ] ) ;
F_80 ( V_14 , L_23 , V_3 , V_6 -> V_37 [ V_3 ] ) ;
}
F_80 ( V_14 , L_24 ) ;
for ( V_3 = 0 ; V_3 < 3 ; V_3 ++ )
F_80 ( V_14 , L_25 , V_3 , V_6 -> V_31 [ V_3 ] ) ;
for ( V_3 = 0 ; V_3 < 2 ; V_3 ++ ) {
for ( V_110 = 0 ; V_110 < 6 ; V_110 ++ ) {
F_80 ( V_14 , L_26 , V_3 , V_110 ,
V_6 -> V_34 [ V_3 ] [ V_110 ] ) ;
}
}
for ( V_3 = 0 ; V_3 < 7 ; V_3 ++ )
F_80 ( V_14 , L_27 , V_3 , V_6 -> V_25 [ V_3 ] ) ;
F_80 ( V_14 , L_28 ) ;
F_80 ( V_14 , L_29 ) ;
}
