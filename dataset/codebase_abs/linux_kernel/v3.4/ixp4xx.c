...
V_22 = F_22 ( sizeof( struct V_21 ) , V_33 ) ;
if( ! V_22 ) {
V_30 = - V_34 ;
goto Error;
}
F_15 ( V_17 , V_22 ) ;
V_22 -> V_4 . V_35 = V_36 ;
V_22 -> V_4 . V_37 = F_23 ( V_17 -> V_28 ) ;
V_22 -> V_4 . V_38 = 2 ;
V_22 -> V_4 . V_39 = F_24 ( & V_17 -> V_17 ) ;
V_22 -> V_4 . V_40 = F_7 ;
V_22 -> V_4 . V_41 = F_11 ;
V_22 -> V_4 . V_42 = F_8 ;
V_22 -> V_24 = F_25 ( V_17 -> V_28 -> V_29 ,
F_23 ( V_17 -> V_28 ) ,
L_1 ) ;
if ( ! V_22 -> V_24 ) {
F_26 ( V_43 L_2 ) ;
...
V_22 -> V_4 . V_8 = F_27 ( V_17 -> V_28 -> V_29 ,
F_23 ( V_17 -> V_28 ) ) ;
if ( ! V_22 -> V_4 . V_8 ) {
F_26 ( V_43 L_3 ) ;
V_30 = - V_44 ;
