...
static int F_41 ( struct V_51 * V_52 [] , struct V_51 * V_53 [] )
{
if ( V_52 [ V_54 ] ) {
if ( F_42 ( V_52 [ V_54 ] ) != V_55 )
return - V_56 ;
if ( ! F_43 ( F_44 ( V_52 [ V_54 ] ) ) )
return - V_57 ;
}
return 0 ;
}
static int T_3 F_45 ( int V_58 )
{
struct V_2 * V_59 ;
int V_60 ;
V_59 = F_46 ( sizeof( struct V_4 ) ,
L_1 , F_28 ) ;
if ( ! V_59 )
return - V_61 ;
V_59 -> V_62 = & V_63 ;
...
F_49 () ;
V_60 = F_50 ( & V_63 ) ;
for ( V_64 = 0 ; V_64 < V_65 && ! V_60 ; V_64 ++ )
V_60 = F_45 ( V_64 ) ;
if ( V_60 )
F_51 ( & V_63 ) ;
F_52 () ;
