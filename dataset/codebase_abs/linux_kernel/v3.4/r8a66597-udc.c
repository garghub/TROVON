...
static int T_6 F_130 ( struct V_295 * V_296 )
{
struct V_1 * V_1 = F_131 ( & V_296 -> V_297 ) ;
F_132 ( & V_1 -> V_15 ) ;
F_133 ( & V_1 -> V_272 ) ;
F_134 ( V_1 -> V_5 ) ;
if ( V_1 -> V_46 -> V_298 )
F_134 ( V_1 -> V_299 ) ;
F_135 ( F_136 ( V_296 , 0 ) , V_1 ) ;
...
#endif
F_140 ( & V_1 -> V_15 . V_297 ) ;
F_118 ( V_1 ) ;
return 0 ;
}
static void F_141 ( struct V_278 * V_21 , struct V_281 * V_301 )
{
}
...
{
struct V_302 * V_303 ;
V_303 = F_143 ( V_296 , V_304 , L_20 ) ;
if ( ! V_303 ) {
F_17 ( & V_296 -> V_297 , L_21 ) ;
return - V_111 ;
}
V_1 -> V_299 = F_144 ( V_303 -> V_305 , F_145 ( V_303 ) ) ;
if ( V_1 -> V_299 == NULL ) {
F_17 ( & V_296 -> V_297 , L_22 ) ;
return - V_81 ;
}
return 0 ;
}
static int T_7 F_146 ( struct V_295 * V_296 )
{
#ifdef F_137
char V_306 [ 8 ] ;
#endif
struct V_302 * V_303 , * V_307 ;
int V_255 ;
void T_8 * V_5 = NULL ;
struct V_1 * V_1 = NULL ;
int V_31 = 0 ;
int V_54 ;
unsigned long V_308 ;
V_303 = F_147 ( V_296 , V_304 , 0 ) ;
if ( ! V_303 ) {
V_31 = - V_111 ;
F_17 ( & V_296 -> V_297 , L_23 ) ;
goto V_309;
}
V_307 = F_147 ( V_296 , V_310 , 0 ) ;
V_255 = V_307 -> V_305 ;
V_308 = V_307 -> V_277 & V_311 ;
if ( V_255 < 0 ) {
V_31 = - V_111 ;
F_17 ( & V_296 -> V_297 , L_24 ) ;
goto V_309;
}
V_5 = F_144 ( V_303 -> V_305 , F_145 ( V_303 ) ) ;
if ( V_5 == NULL ) {
V_31 = - V_81 ;
F_17 ( & V_296 -> V_297 , L_25 ) ;
goto V_309;
}
V_1 = F_116 ( sizeof( struct V_1 ) , V_215 ) ;
if ( V_1 == NULL ) {
V_31 = - V_81 ;
F_17 ( & V_296 -> V_297 , L_26 ) ;
goto V_309;
}
F_148 ( & V_1 -> V_14 ) ;
F_149 ( & V_296 -> V_297 , V_1 ) ;
V_1 -> V_46 = V_296 -> V_297 . V_312 ;
V_1 -> V_160 = V_308 == V_313 ;
V_1 -> V_15 . V_314 = & V_315 ;
F_150 ( & V_1 -> V_15 . V_297 , L_27 ) ;
V_1 -> V_15 . V_291 = V_231 ;
V_1 -> V_15 . V_297 . V_316 = & V_296 -> V_297 ;
V_1 -> V_15 . V_297 . V_317 = V_296 -> V_297 . V_317 ;
V_1 -> V_15 . V_297 . V_318 = V_296 -> V_297 . V_318 ;
V_1 -> V_15 . V_319 = V_320 ;
V_31 = F_151 ( & V_1 -> V_15 . V_297 ) ;
if ( V_31 < 0 ) {
F_17 ( & V_296 -> V_297 , L_28 ) ;
goto V_309;
}
F_152 ( & V_1 -> V_272 ) ;
V_1 -> V_272 . V_321 = F_109 ;
V_1 -> V_272 . V_322 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
#ifdef F_137
if ( V_1 -> V_46 -> V_47 ) {
snprintf ( V_306 , sizeof( V_306 ) , L_29 , V_296 -> V_323 ) ;
V_1 -> V_300 = F_153 ( & V_296 -> V_297 , V_306 ) ;
if ( F_154 ( V_1 -> V_300 ) ) {
F_17 ( & V_296 -> V_297 , L_30 ,
V_306 ) ;
V_31 = F_155 ( V_1 -> V_300 ) ;
goto V_324;
}
F_156 ( V_1 -> V_300 ) ;
}
#endif
if ( V_1 -> V_46 -> V_298 ) {
V_31 = F_142 ( V_1 , V_296 ) ;
if ( V_31 < 0 )
goto V_325;
}
F_12 ( V_1 ) ;
V_31 = F_157 ( V_255 , F_106 , V_326 ,
V_320 , V_1 ) ;
if ( V_31 < 0 ) {
F_17 ( & V_296 -> V_297 , L_31 , V_31 ) ;
goto V_325;
}
F_14 ( & V_1 -> V_15 . V_327 ) ;
V_1 -> V_15 . V_214 = & V_1 -> V_21 [ 0 ] . V_21 ;
F_14 ( & V_1 -> V_15 . V_214 -> V_327 ) ;
for ( V_54 = 0 ; V_54 < V_27 ; V_54 ++ ) {
struct V_57 * V_21 = & V_1 -> V_21 [ V_54 ] ;
if ( V_54 != 0 ) {
F_14 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_327 ) ;
F_119 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_327 ,
& V_1 -> V_15 . V_327 ) ;
}
V_21 -> V_1 = V_1 ;
F_14 ( & V_21 -> V_22 ) ;
V_21 -> V_21 . V_319 = V_328 [ V_54 ] ;
V_21 -> V_21 . V_314 = & V_329 ;
V_21 -> V_21 . V_82 = 512 ;
}
...
V_31 = F_158 ( & V_296 -> V_297 , & V_1 -> V_15 ) ;
if ( V_31 )
goto V_331;
F_159 ( & V_296 -> V_297 , L_32 , V_332 ) ;
return 0 ;
V_331:
F_117 ( & V_1 -> V_21 [ 0 ] . V_21 , V_1 -> V_213 ) ;
V_330:
