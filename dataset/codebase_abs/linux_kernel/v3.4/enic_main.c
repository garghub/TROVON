...
if ( V_179 )
return V_179 ;
F_147 ( V_112 , V_205 , V_198 -> V_208 ) ;
F_147 ( V_112 , V_226 , V_223 ) ;
if ( V_198 -> V_206 & V_210 )
F_148 ( V_112 , V_209 , V_211 ,
V_198 -> V_51 ) ;
if ( V_198 -> V_206 & V_213 )
F_148 ( V_112 , V_212 , V_215 ,
V_198 -> V_214 ) ;
if ( V_198 -> V_206 & V_217 )
F_148 ( V_112 , V_216 , V_215 ,
V_198 -> V_218 ) ;
return 0 ;
V_227:
return - V_228 ;
