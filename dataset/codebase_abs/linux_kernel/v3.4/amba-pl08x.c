...
static enum V_131 F_53 ( struct V_2 * V_3 ,
T_5 V_126 , struct V_132 * V_133 )
{
struct V_1 * V_13 = F_1 ( V_3 ) ;
enum V_131 V_112 ;
V_112 = F_54 ( V_3 , V_126 , V_133 ) ;
if ( V_112 == V_134 )
return V_112 ;
F_55 ( V_133 , F_16 ( V_13 ) ) ;
if ( V_13 -> V_127 == V_135 )
return V_136 ;
return V_137 ;
}
...
{
T_1 V_28 = 0 ;
if ( ! ( V_27 & V_138 ) || ( ( V_27 & V_97 ) && ( V_26 & V_138 ) ) )
V_28 |= V_139 ;
if ( ! ( V_26 & V_138 ) || ( ( V_26 & V_97 ) && ! ( V_27 & V_97 ) ) )
V_28 |= V_140 ;
return V_28 ;
}
...
static T_1 F_58 ( enum V_143 V_107 )
{
switch ( V_107 ) {
case V_144 :
return V_45 ;
...
static T_1 F_59 ( T_1 V_147 )
{
int V_61 ;
for ( V_61 = 0 ; V_61 < F_60 ( V_148 ) ; V_61 ++ )
if ( V_148 [ V_61 ] . V_149 <= V_147 )
break;
return V_148 [ V_61 ] . V_150 ;
}
...
struct V_15 * V_16 = V_13 -> V_17 ;
enum V_143 V_153 ;
T_1 V_107 , V_154 , V_147 ;
T_1 V_28 = 0 ;
if ( ! V_13 -> V_116 )
return - V_155 ;
V_13 -> V_156 = V_152 -> V_119 ;
if ( V_152 -> V_119 == V_120 ) {
V_153 = V_152 -> V_157 ;
V_147 = V_152 -> V_158 ;
} else if ( V_152 -> V_119 == V_122 ) {
V_153 = V_152 -> V_159 ;
V_147 = V_152 -> V_160 ;
} else {
F_34 ( & V_16 -> V_23 -> V_24 ,
...
V_28 |= V_154 << V_163 ;
V_28 |= V_154 << V_164 ;
V_13 -> V_165 = V_152 -> V_165 ;
if ( V_13 -> V_156 == V_122 ) {
V_13 -> V_99 = V_152 -> V_99 ;
V_13 -> V_166 = F_57 ( V_28 ) | V_80 |
F_56 ( V_13 -> V_161 -> V_167 ,
V_16 -> V_168 ) ;
} else {
V_13 -> V_100 = V_152 -> V_100 ;
V_13 -> V_169 = F_57 ( V_28 ) | V_83 |
F_56 ( V_16 -> V_168 ,
V_13 -> V_161 -> V_167 ) ;
}
F_35 ( & V_16 -> V_23 -> V_24 ,
...
unsigned long V_48 )
{
struct V_4 * V_14 = F_67 ( sizeof( * V_14 ) , V_93 ) ;
if ( V_14 ) {
...
struct V_2 * V_3 , T_3 V_174 , T_3 V_26 ,
...
V_58 = F_67 ( sizeof( struct V_57 ) , V_93 ) ;
if ( ! V_58 ) {
F_39 ( V_16 , V_14 ) ;
...
F_51 ( & V_58 -> V_110 , & V_14 -> V_173 ) ;
V_14 -> V_119 = V_175 ;
V_58 -> V_99 = V_26 ;
V_58 -> V_100 = V_174 ;
V_58 -> V_59 = V_59 ;
V_14 -> V_29 |= V_176 << V_103 ;
V_14 -> V_28 = V_16 -> V_117 -> V_177 . V_28 &
~ ( V_139 | V_140 ) ;
V_14 -> V_28 |= V_83 | V_80 ;
if ( V_16 -> V_62 -> V_178 )
V_14 -> V_28 |= F_56 ( V_16 -> V_168 ,
V_16 -> V_168 ) ;
V_112 = F_65 ( V_13 , V_14 ) ;
if ( V_112 )
return NULL ;
return & V_14 -> V_6 ;
}
static struct V_5 * F_71 (
struct V_2 * V_3 , struct V_179 * V_180 ,
unsigned int V_181 , enum V_182 V_119 ,
unsigned long V_48 , void * V_183 )
{
struct V_1 * V_13 = F_1 ( V_3 ) ;
struct V_15 * V_16 = V_13 -> V_17 ;
struct V_4 * V_14 ;
...
if ( V_13 -> V_165 )
V_186 = ( V_119 == V_120 ) ? V_188 :
V_189 ;
else
V_186 = ( V_119 == V_120 ) ? V_190 :
V_191 ;
V_14 -> V_29 |= V_186 << V_103 ;
F_72 (sgl, sg, sg_len, tmp) {
V_58 = F_67 ( sizeof( struct V_57 ) , V_93 ) ;
if ( ! V_58 ) {
F_39 ( V_16 , V_14 ) ;
...
F_51 ( & V_58 -> V_110 , & V_14 -> V_173 ) ;
V_58 -> V_59 = F_73 ( V_184 ) ;
if ( V_119 == V_120 ) {
V_58 -> V_99 = F_74 ( V_184 ) ;
V_58 -> V_100 = V_185 ;
} else {
V_58 -> V_99 = V_185 ;
V_58 -> V_100 = F_74 ( V_184 ) ;
}
}
V_112 = F_65 ( V_13 , V_14 ) ;
if ( V_112 )
...
static void F_81 ( unsigned long V_212 )
{
...
static T_7 F_83 ( int V_215 , void * V_24 )
{
...
{
T_1 V_28 = F_57 ( V_3 -> V_161 -> V_28 ) ;
V_3 -> V_116 = true ;
V_3 -> V_114 = V_3 -> V_161 -> V_224 ;
V_3 -> V_99 = V_3 -> V_161 -> V_86 ;
V_3 -> V_100 = V_3 -> V_161 -> V_86 ;
V_3 -> V_166 = V_28 | V_80 |
F_56 ( V_3 -> V_161 -> V_167 , V_3 -> V_17 -> V_168 ) ;
V_3 -> V_169 = V_28 | V_83 |
F_56 ( V_3 -> V_17 -> V_168 , V_3 -> V_161 -> V_167 ) ;
}
static int F_86 ( struct V_15 * V_16 ,
struct V_225 * V_226 , unsigned int V_63 , bool V_116 )
{
struct V_1 * V_3 ;
int V_61 ;
F_69 ( & V_226 -> V_63 ) ;
for ( V_61 = 0 ; V_61 < V_63 ; V_61 ++ ) {
V_3 = F_67 ( sizeof( * V_3 ) , V_227 ) ;
if ( ! V_3 ) {
F_34 ( & V_16 -> V_23 -> V_24 ,
L_48 , V_94 ) ;
return - V_228 ;
...
V_3 -> V_127 = V_171 ;
if ( V_116 ) {
V_3 -> V_161 = & V_16 -> V_117 -> V_229 [ V_61 ] ;
F_85 ( V_3 ) ;
} else {
V_3 -> V_161 = & V_16 -> V_117 -> V_177 ;
V_3 -> V_114 = F_87 ( V_227 , L_49 , V_61 ) ;
if ( ! V_3 -> V_114 ) {
F_43 ( V_3 ) ;
return - V_228 ;
}
...
static const char * F_93 ( enum V_232 V_127 )
{
switch ( V_127 ) {
case V_171 :
return L_55 ;
...
static int F_94 ( struct V_233 * V_234 , void * V_212 )
{
...
static int F_96 ( struct V_236 * V_236 , struct V_237 * V_237 )
{
return F_97 ( V_237 , F_94 , V_236 -> V_238 ) ;
}
...
static int F_101 ( struct V_242 * V_23 , const struct V_243 * V_25 )
{
struct V_15 * V_16 ;
const struct V_244 * V_62 = V_25 -> V_212 ;
int V_112 = 0 ;
int V_61 ;
V_112 = F_102 ( V_23 , NULL ) ;
if ( V_112 )
return V_112 ;
V_16 = F_67 ( sizeof( * V_16 ) , V_227 ) ;
if ( ! V_16 ) {
V_112 = - V_228 ;
goto V_245;
}
F_103 ( & V_23 -> V_24 ) ;
F_104 ( & V_23 -> V_24 ) ;
F_105 ( V_246 , V_16 -> memcpy . V_247 ) ;
V_16 -> memcpy . V_24 = & V_23 -> V_24 ;
V_16 -> memcpy . V_248 = F_45 ;
V_16 -> memcpy . V_249 = F_46 ;
V_16 -> memcpy . V_250 = F_70 ;
V_16 -> memcpy . V_251 = F_52 ;
V_16 -> memcpy . V_252 = F_53 ;
V_16 -> memcpy . V_253 = F_63 ;
V_16 -> memcpy . V_254 = F_75 ;
F_105 ( V_255 , V_16 -> V_116 . V_247 ) ;
V_16 -> V_116 . V_24 = & V_23 -> V_24 ;
V_16 -> V_116 . V_248 = F_45 ;
V_16 -> V_116 . V_249 = F_46 ;
V_16 -> V_116 . V_251 = F_52 ;
V_16 -> V_116 . V_252 = F_53 ;
V_16 -> V_116 . V_253 = F_63 ;
V_16 -> V_116 . V_256 = F_71 ;
V_16 -> V_116 . V_254 = F_75 ;
V_16 -> V_117 = F_106 ( & V_23 -> V_24 ) ;
if ( ! V_16 -> V_117 ) {
F_34 ( & V_23 -> V_24 , L_70 ) ;
goto V_257;
}
...
V_16 -> V_168 = V_16 -> V_117 -> V_168 ;
}
V_16 -> V_92 = F_107 ( V_258 , & V_16 -> V_23 -> V_24 ,
V_259 , V_260 , 0 ) ;
if ( ! V_16 -> V_92 ) {
V_112 = - V_228 ;
goto V_261;
...
F_89 ( & V_16 -> V_49 ) ;
V_16 -> V_10 = F_108 ( V_23 -> V_262 . V_263 , F_109 ( & V_23 -> V_262 ) ) ;
if ( ! V_16 -> V_10 ) {
V_112 = - V_228 ;
goto V_264;
}
...
V_112 = F_110 ( V_23 -> V_215 [ 0 ] , F_83 , V_265 ,
V_258 , V_16 ) ;
if ( V_112 ) {
F_34 ( & V_23 -> V_24 , L_71 ,
V_94 , V_23 -> V_215 [ 0 ] ) ;
...
V_16 -> V_64 = F_111 ( ( V_62 -> V_63 * sizeof( * V_16 -> V_64 ) ) ,
V_227 ) ;
if ( ! V_16 -> V_64 ) {
F_34 ( & V_23 -> V_24 , L_72
L_73 ,
...
V_112 = F_86 ( V_16 , & V_16 -> memcpy ,
V_16 -> V_62 -> V_63 , false ) ;
if ( V_112 <= 0 ) {
F_113 ( & V_16 -> V_23 -> V_24 ,
L_77 ,
V_94 , V_112 ) ;
goto V_268;
}
V_16 -> memcpy . V_269 = V_112 ;
V_112 = F_86 ( V_16 , & V_16 -> V_116 ,
V_16 -> V_117 -> V_270 , true ) ;
if ( V_112 <= 0 ) {
F_113 ( & V_16 -> V_23 -> V_24 ,
L_78 ,
V_94 , V_112 ) ;
...
V_16 -> V_116 . V_269 = V_112 ;
V_112 = F_114 ( & V_16 -> memcpy ) ;
if ( V_112 ) {
F_113 ( & V_16 -> V_23 -> V_24 ,
L_79 ,
V_94 , V_112 ) ;
...
F_115 ( V_23 , V_16 ) ;
F_98 ( V_16 ) ;
F_91 ( & V_16 -> V_23 -> V_24 , L_81 ,
F_116 ( V_23 ) , F_117 ( V_23 ) ,
...
V_130 = F_125 ( & V_203 ) ;
if ( V_130 )
F_126 (KERN_WARNING DRIVER_NAME
L_82 ,
retval) ;
return V_130 ;
}
