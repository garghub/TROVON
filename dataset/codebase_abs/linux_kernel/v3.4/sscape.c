...
static int T_2 F_75 ( struct V_131 * V_132 , unsigned int V_133 )
{
if ( V_90 [ V_133 ] == V_134 )
return 0 ;
if ( V_76 [ V_133 ] == V_135 ||
...
static int T_2 F_76 ( struct V_131 * V_132 , unsigned int V_52 )
{
struct V_2 * V_49 ;
struct V_1 * V_27 ;
int V_36 ;
...
static int T_3 F_82 ( struct V_131 * V_141 , unsigned int V_52 )
{
F_81 ( F_83 ( V_141 ) ) ;
F_80 ( V_141 , NULL ) ;
return 0 ;
}
static inline int T_2 F_84 ( int V_133 )
{
while ( V_133 < V_142 && V_90 [ V_133 ] != V_134 )
++ V_133 ;
return V_133 ;
}
static int T_2 F_85 ( struct V_143 * V_144 ,
...
static void T_3 F_94 ( struct V_143 * V_144 )
{
F_81 ( F_95 ( V_144 ) ) ;
F_93 ( V_144 , NULL ) ;
}
