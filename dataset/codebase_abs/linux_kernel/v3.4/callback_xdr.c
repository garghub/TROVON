...
static T_1 F_38 ( struct V_8 * V_9 , const T_2 * V_21 , T_1 * * V_109 )
{
T_1 V_110 [ 2 ] ;
T_1 * V_6 ;
...
static T_1 F_39 ( struct V_8 * V_9 , const T_2 * V_21 , V_53 V_113 )
{
T_1 * V_6 ;
if ( ! ( V_21 [ 0 ] & V_114 ) )
return 0 ;
...
static T_1 F_41 ( struct V_8 * V_9 , const T_2 * V_21 , V_53 V_17 )
{
T_1 * V_6 ;
if ( ! ( V_21 [ 0 ] & V_115 ) )
return 0 ;
...
static T_1 F_42 ( struct V_8 * V_9 , const struct V_116 * time )
{
T_1 * V_6 ;
V_6 = F_36 ( V_9 , 12 ) ;
if ( F_9 ( ! V_6 ) )
return F_2 ( V_14 ) ;
V_6 = F_40 ( V_6 , time -> V_117 ) ;
* V_6 = F_2 ( time -> V_118 ) ;
return 0 ;
}
static T_1 F_43 ( struct V_8 * V_9 , const T_2 * V_21 , const struct V_116 * time )
{
if ( ! ( V_21 [ 1 ] & V_119 ) )
return 0 ;
...
static T_1 F_45 ( struct V_8 * V_9 , struct V_121 * V_26 )
{
T_1 V_27 ;
...
if ( F_9 ( V_27 != 0 ) )
return V_27 ;
V_26 -> V_35 = F_36 ( V_9 , 4 ) ;
if ( F_9 ( V_26 -> V_35 == NULL ) )
return F_2 ( V_14 ) ;
return 0 ;
}
static T_1 F_46 ( struct V_8 * V_9 , T_2 V_36 , T_1 V_122 )
{
T_1 * V_6 ;
V_6 = F_36 ( V_9 , 8 ) ;
if ( F_9 ( V_6 == NULL ) )
...
static T_1 F_47 ( struct V_1 * V_2 , struct V_8 * V_9 , const struct V_123 * V_122 )
{
T_1 * V_109 = NULL ;
T_1 V_27 = V_122 -> V_27 ;
if ( F_9 ( V_27 != 0 ) )
goto V_39;
V_27 = F_38 ( V_9 , V_122 -> V_21 , & V_109 ) ;
if ( F_9 ( V_27 != 0 ) )
goto V_39;
V_27 = F_39 ( V_9 , V_122 -> V_21 , V_122 -> V_124 ) ;
if ( F_9 ( V_27 != 0 ) )
goto V_39;
V_27 = F_41 ( V_9 , V_122 -> V_21 , V_122 -> V_17 ) ;
if ( F_9 ( V_27 != 0 ) )
goto V_39;
V_27 = F_43 ( V_9 , V_122 -> V_21 , & V_122 -> ctime ) ;
if ( F_9 ( V_27 != 0 ) )
goto V_39;
V_27 = F_44 ( V_9 , V_122 -> V_21 , & V_122 -> V_125 ) ;
...
{
T_1 * V_6 ;
unsigned V_27 = V_122 -> V_127 ;
if ( F_9 ( V_27 != 0 ) )
goto V_39;
F_48 ( V_9 , & V_122 -> V_128 ) ;
...
static T_1
F_50 ( int V_133 , unsigned int V_134 , struct V_135 * * V_36 )
{
if ( V_134 == V_136 ) {
if ( V_133 != 0 )
return F_2 ( V_137 ) ;
...
static void F_55 ( struct V_162 * V_163 )
{
if ( V_163 -> V_164 != V_161 )
F_51 ( V_163 -> V_165 -> V_166 ) ;
}
static T_1
F_50 ( int V_133 , unsigned int V_134 , struct V_135 * * V_36 )
{
...
static T_1
F_56 ( unsigned int V_134 , struct V_135 * * V_36 )
{
switch ( V_134 ) {
case V_139 :
case V_140 :
...
static T_1 F_57 ( T_2 V_32 , int V_133 ,
struct V_1 * V_2 ,
...
V_27 = V_32 ? F_50 ( V_133 , V_134 , & V_36 ) :
F_56 ( V_134 , & V_36 ) ;
if ( V_27 == F_2 ( V_152 ) )
V_134 = V_170 ;
if ( V_27 )
...
if ( F_15 ( V_27 == 0 ) )
V_27 = V_36 -> F_57 ( V_3 , V_4 , V_163 ) ;
} else
V_27 = F_2 ( V_14 ) ;
V_171:
V_122 = F_46 ( V_168 , V_134 , V_27 ) ;
if ( F_9 ( V_122 ) )
return V_122 ;
...
static T_1 F_58 ( struct V_1 * V_2 , void * V_3 , void * V_4 )
{
struct V_25 V_177 = { 0 } ;
...
. V_165 = NULL ,
. V_164 = V_161 ,
. V_179 = V_2 -> V_180 -> V_181 ,
} ;
unsigned int V_35 = 0 ;
F_19 ( L_12 , V_31 ) ;
F_59 ( & V_167 , & V_2 -> V_182 , V_2 -> V_182 . V_183 [ 0 ] . V_184 ) ;
V_6 = ( T_1 * ) ( ( char * ) V_2 -> V_185 . V_183 [ 0 ] . V_184 + V_2 -> V_185 . V_183 [ 0 ] . V_186 ) ;
F_60 ( & V_168 , & V_2 -> V_185 , V_6 ) ;
V_27 = F_17 ( & V_167 , & V_177 ) ;
if ( V_27 == F_61 ( V_14 ) )
return V_187 ;
if ( V_177 . V_32 == 0 ) {
V_163 . V_165 = F_62 ( V_2 -> V_180 -> V_181 , V_177 . V_33 ) ;
if ( ! V_163 . V_165 || ! F_63 ( V_163 . V_165 , V_2 ) )
return V_188 ;
}
V_178 . V_28 = V_177 . V_28 ;
V_178 . V_29 = V_177 . V_29 ;
if ( F_45 ( & V_168 , & V_178 ) != 0 )
return V_189 ;
while ( V_27 == 0 && V_35 != V_177 . V_35 ) {
V_27 = F_57 ( V_177 . V_32 , V_35 , V_2 ,
