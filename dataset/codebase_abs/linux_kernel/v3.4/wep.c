...
struct V_15 * V_16 = (struct V_15 * ) V_14 -> V_17 ;
T_6 V_42 = V_16 -> V_20 ;
if ( ! F_36 ( V_42 ) && ! F_37 ( V_42 ) )
return V_43 ;
if ( ! ( V_41 -> V_44 & V_45 ) ) {
if ( F_38 ( V_39 -> V_14 ) )
return V_46 ;
if ( V_39 -> V_47 && F_33 ( V_39 -> V_14 , V_39 -> V_24 ) )
V_39 -> V_47 -> V_48 ++ ;
if ( F_30 ( V_39 -> V_2 , V_39 -> V_14 , V_39 -> V_24 ) )
return V_46 ;
} else if ( ! ( V_41 -> V_44 & V_49 ) ) {
if ( ! F_39 ( V_39 -> V_14 , F_16 ( V_42 ) + V_4 ) )
return V_46 ;
if ( V_39 -> V_47 && F_33 ( V_39 -> V_14 , V_39 -> V_24 ) )
V_39 -> V_47 -> V_48 ++ ;
F_18 ( V_39 -> V_2 , V_39 -> V_14 , V_39 -> V_24 ) ;
if ( F_40 ( V_39 -> V_14 , V_39 -> V_14 -> V_32 - V_22 ) )
return V_46 ;
}
return V_43 ;
}
static int F_41 ( struct V_50 * V_51 , struct V_13 * V_14 )
{
struct V_52 * V_53 = F_42 ( V_14 ) ;
if ( ! V_53 -> V_54 . V_55 ) {
if ( F_26 ( V_51 -> V_2 , V_14 , V_51 -> V_24 -> V_36 . V_24 ,
V_51 -> V_24 -> V_36 . V_10 ,
V_51 -> V_24 -> V_36 . V_12 ) )
return - 1 ;
} else if ( V_53 -> V_54 . V_55 -> V_56 &
V_57 ) {
if ( ! F_11 ( V_51 -> V_2 , V_14 ,
V_51 -> V_24 -> V_36 . V_10 ,
V_51 -> V_24 -> V_36 . V_12 ) )
return - 1 ;
}
