...
static int F_118 ( struct V_5 * V_530 , char * V_531 , char * * V_532 , T_8 V_335 , int V_533 , int V_534 )
{
...
V_536 = V_2 -> V_537 ;
V_535 = V_2 -> V_538 ;
V_535 += sprintf ( & V_536 [ V_535 ] , L_173 , V_2 -> V_38 , V_2 -> V_29 ) ;
V_535 += sprintf ( & V_536 [ V_535 ] , L_174 ) ;
for ( V_202 = 0 ; V_202 < V_2 -> V_224 ; V_202 ++ ) {
struct V_439 * V_307 = & V_2 -> V_307 [ V_202 ] ;
if ( ! V_307 -> V_332 )
continue;
V_535 += sprintf ( & V_536 [ V_535 ] , L_175 , V_202 , ( V_307 -> V_353 ? ( V_307 -> V_308 ? L_176 : ( V_2 -> V_232 & ( 1 << V_202 )
? L_177 : L_178 ) )
: L_179 ) ) ;
V_535 += sprintf ( & V_536 [ V_535 ] ,
L_180 , V_2 -> V_269 [ V_202 ] , V_2 -> V_310 [ V_202 ] , V_421 [ V_202 ] . V_462 , V_421 [ V_202 ] . V_429 ) ;
}
V_535 += sprintf ( & V_536 [ V_535 ] , L_181 ) ;
for ( V_202 = 0 ; V_202 < V_2 -> V_224 ; V_202 ++ ) {
struct V_439 * V_307 = & V_2 -> V_307 [ V_202 ] ;
if ( ! V_307 -> V_332 )
continue;
V_535 += sprintf ( & V_536 [ V_535 ] , L_182 , V_202 , V_421 [ V_202 ] . V_490 , V_421 [ V_202 ] . V_496 ) ;
if ( V_421 [ V_202 ] . V_491 . V_539 > 0 )
V_535 += sprintf ( & V_536 [ V_535 ] , L_183 , V_421 [ V_202 ] . V_491 . V_539 , V_421 [ V_202 ] . V_491 . V_540 ) ;
else
V_535 += sprintf ( & V_536 [ V_535 ] , L_184 , V_421 [ V_202 ] . V_491 . V_540 ) ;
if ( V_421 [ V_202 ] . V_497 . V_539 > 0 )
V_535 += sprintf ( & V_536 [ V_535 ] , L_185 , V_421 [ V_202 ] . V_497 . V_539 , V_421 [ V_202 ] . V_497 . V_540 ) ;
else
V_535 += sprintf ( & V_536 [ V_535 ] , L_186 , V_421 [ V_202 ] . V_497 . V_540 ) ;
}
V_535 += sprintf ( & V_536 [ V_535 ] , L_187 ) ;
for ( V_202 = 0 ; V_202 < V_2 -> V_224 ; V_202 ++ ) {
struct V_439 * V_307 = & V_2 -> V_307 [ V_202 ] ;
if ( ! V_307 -> V_332 )
continue;
...
V_535 += sprintf ( & V_536 [ V_535 ] , L_190 ) ;
for ( V_202 = 0 ; V_202 < V_2 -> V_224 ; V_202 ++ ) {
struct V_439 * V_307 = & V_2 -> V_307 [ V_202 ] ;
if ( ! V_307 -> V_332 )
continue;
...
V_535 += sprintf ( & V_536 [ V_535 ] , L_191 ) ;
for ( V_202 = 0 ; V_202 < V_2 -> V_224 ; V_202 ++ ) {
struct V_439 * V_307 = & V_2 -> V_307 [ V_202 ] ;
if ( ! V_307 -> V_332 )
continue;
V_535 += sprintf ( & V_536 [ V_535 ] , L_192 , V_202 , V_421 [ V_202 ] . V_541 , V_421 [ V_202 ] . V_542 , V_421 [ V_202 ] . V_431 , V_421 [ V_202 ] . V_543 , V_421 [ V_202 ] . V_544 , V_421 [ V_202 ] . V_422 , V_421 [ V_202 ] . V_468 , V_421 [ V_202 ] . V_545 , V_421 [ V_202 ] . V_546 ) ;
}
V_535 += sprintf ( & V_536 [ V_535 ] , L_193 , V_2 -> V_455 ) ;
V_535 += sprintf ( & V_536 [ V_535 ] , L_194 , V_2 -> V_456 ) ;
if ( V_535 >= V_547 )
F_8 ( L_195 , V_2 , V_535 , V_547 ) ;
if ( ( V_535 -= V_335 ) <= 0 )
return 0 ;
if ( V_535 >= V_533 )
V_535 = V_533 ;
memcpy ( V_531 , V_2 -> V_537 + V_335 , V_535 ) ;
* V_532 = V_531 ;
return V_535 ;
}
static void F_119 ( enum V_548 V_549 , char * V_550 , struct V_1 * V_2 , ... )
{
static char V_536 [ V_551 ] ;
static bool V_552 = true ;
T_9 V_553 ;
int V_535 = 0 ;
va_start ( V_553 , V_2 ) ;
V_535 = vsprintf ( V_536 , V_550 , V_553 ) ;
va_end ( V_553 ) ;
if ( V_549 == V_554 ) {
static int V_555 = 0 ;
strcpy ( & V_2 -> V_537 [ V_2 -> V_538 ] , V_536 ) ;
V_2 -> V_538 += V_535 ;
if ( ++ V_555 <= 2 )
F_78 ( L_196 , V_556 [ V_549 ] , V_536 ) ;
} else if ( V_549 == V_557 ) {
strcpy ( & V_2 -> V_537 [ V_2 -> V_538 ] , V_536 ) ;
V_2 -> V_538 += V_535 ;
if ( V_552 ) {
if ( V_536 [ 0 ] != '\n' || V_535 > 1 )
F_78 ( L_197 , V_556 [ V_549 ] , V_2 -> V_370 , V_536 ) ;
} else
F_78 ( L_198 , V_536 ) ;
} else {
if ( V_552 ) {
...
F_78 ( L_199 , V_556 [ V_549 ] , V_536 ) ;
} else
F_78 ( L_198 , V_536 ) ;
}
V_552 = ( V_536 [ V_535 - 1 ] == '\n' ) ;
}
static bool T_2 F_120 ( char * * V_558 , char * V_559 )
{
char * V_560 = * V_558 ;
while ( * V_559 != '\0' ) {
char V_561 = * V_560 ++ ;
...
static int T_2 F_121 ( char * V_563 )
{
while ( true ) {
...
while ( * V_563 != '\0' && * V_563 != ';' ) {
if ( F_120 ( & V_563 , L_200 ) ) {
unsigned long V_88 = F_122 ( V_563 , & V_563 , 0 ) ;
V_99 . V_101 = true ;
switch ( V_88 ) {
case 0x330 :
V_99 . V_102 = true ;
...
break;
default:
F_8 ( L_201 L_202 , NULL , V_88 ) ;
return 0 ;
}
} else if ( F_120 ( & V_563 , L_203 ) )
V_99 . V_100 = true ;
else if ( F_120 ( & V_563 , L_204 ) )
V_99 . V_164 = true ;
else if ( F_120 ( & V_563 , L_205 ) )
V_99 . V_361 = true ;
else if ( F_120 ( & V_563 , L_206 ) )
V_99 . V_564 = true ;
else if ( F_120 ( & V_563 , L_207 ) )
V_99 . V_165 = true ;
else if ( F_120 ( & V_563 , L_208 ) )
V_99 . V_166 = true ;
else if ( F_120 ( & V_563 , L_209 ) || F_120 ( & V_563 , L_210 ) ) {
for ( V_202 = 0 ; V_202 < V_268 ; V_202 ++ ) {
unsigned short V_269 = F_122 ( V_563 , & V_563 , 0 ) ;
if ( V_269 > V_502 ) {
F_8 ( L_201 L_211 , NULL , V_269 ) ;
return 0 ;
}
...
F_8 ( L_201 L_212 , NULL , V_563 ) ;
return 0 ;
}
}
if ( * V_563 != ']' ) {
F_8 ( L_201 L_213 , NULL , V_563 ) ;
return 0 ;
} else
V_563 ++ ;
} else if ( F_120 ( & V_563 , L_214 ) || F_120 ( & V_563 , L_215 ) ) {
unsigned short V_269 = F_122 ( V_563 , & V_563 , 0 ) ;
...
for ( V_202 = 0 ; V_202 < V_268 ; V_202 ++ )
V_270 -> V_269 [ V_202 ] = V_269 ;
} else if ( F_120 ( & V_563 , L_216 ) || F_120 ( & V_563 , L_217 ) ) {
if ( F_120 ( & V_563 , L_218 ) ) {
V_270 -> V_232 = 0x0000 ;
V_270 -> V_276 = 0x0000 ;
} else if ( F_120 ( & V_563 , L_219 ) ) {
V_270 -> V_232 = 0xFFFF ;
V_270 -> V_276 = 0xFFFF ;
} else if ( F_120 ( & V_563 , L_220 ) ) {
V_270 -> V_232 = 0x0000 ;
V_270 -> V_276 = 0xFFFF ;
} else {
unsigned short V_565 ;
for ( V_202 = 0 , V_565 = 1 ; V_202 < V_268 ; V_202 ++ , V_565 <<= 1 )
switch ( * V_563 ++ ) {
case 'Y' :
V_270 -> V_232 |= V_565 ;
V_270 -> V_276 |= V_565 ;
...
else if ( F_120 ( & V_563 , L_221 ) || F_120 ( & V_563 , L_222 ) ) {
unsigned short V_277 = F_122 ( V_563 , & V_563 , 0 ) ;
if ( V_277 > 5 * 60 ) {
F_8 ( L_201 L_223 , NULL , V_277 ) ;
return 0 ;
}
V_270 -> V_277 = V_277 ;
} else if ( F_120 ( & V_563 , L_224 ) )
V_270 -> V_330 . V_331 = true ;
else if ( F_120 ( & V_563 , L_225 ) )
V_77 . V_142 = true ;
else if ( F_120 ( & V_563 , L_226 ) )
V_77 . V_185 = true ;
else if ( F_120 ( & V_563 , L_227 ) )
V_77 . V_78 = true ;
else if ( F_120 ( & V_563 , L_228 ) )
V_77 . V_434 = true ;
else if ( F_120 ( & V_563 , L_229 ) ) {
V_77 . V_142 = true ;
V_77 . V_185 = true ;
V_77 . V_78 = true ;
V_77 . V_434 = true ;
...
if ( * V_563 == ',' )
V_563 ++ ;
else if ( * V_563 != ';' && * V_563 != '\0' ) {
F_8 ( L_230 L_231 , NULL , V_563 ) ;
* V_563 = '\0' ;
}
}
if ( ! ( V_367 == 0 || V_91 == 0 || V_367 == V_91 ) ) {
F_8 ( L_201 L_232 , NULL ) ;
return 0 ;
}
for ( V_202 = 0 ; V_202 < V_268 ; V_202 ++ )
if ( V_270 -> V_269 [ V_202 ] == 1 ) {
unsigned short V_565 = 1 << V_202 ;
V_270 -> V_232 &= ~ V_565 ;
V_270 -> V_276 |= V_565 ;
}
if ( * V_563 == ';' )
...
static int T_2 F_71 ( char * V_566 )
{
int V_567 [ 3 ] ;
( void ) F_123 ( V_566 , F_124 ( V_567 ) , V_567 ) ;
if ( V_567 [ 0 ] != 0 ) {
F_8 ( L_233 L_234 , NULL ) ;
return 0 ;
}
if ( V_566 == NULL || * V_566 == '\0' )
return 0 ;
return F_121 ( V_566 ) ;
}
static void T_5 F_125 ( void )
{
struct V_1 * V_568 , * V_569 ;
F_126 (ha, next, &BusLogic_host_list, host_list)
F_83 ( V_568 ) ;
}
