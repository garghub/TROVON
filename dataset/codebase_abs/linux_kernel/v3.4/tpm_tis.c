...
static int F_73 ( struct V_98 * V_2 , T_8 V_96 )
{
return F_66 ( & V_2 -> V_2 , V_96 ) ;
}
static int F_74 ( struct V_98 * V_2 )
{
struct V_7 * V_8 = F_75 ( & V_2 -> V_2 ) ;
if ( V_8 -> V_10 . V_23 )
F_59 ( V_8 ) ;
return F_69 ( & V_2 -> V_2 ) ;
}
...
if ( V_19 < 0 )
return V_19 ;
if ( F_80 ( V_101 = F_81 ( L_22 , - 1 , NULL , 0 ) ) )
return F_82 ( V_101 ) ;
if( ( V_19 = F_38 ( & V_101 -> V_2 , V_102 , V_103 , 0 ) ) != 0 ) {
F_83 ( V_101 ) ;
F_84 ( & V_100 ) ;
}
return V_19 ;
}
static void T_11 F_85 ( void )
{
struct V_104 * V_65 , * V_105 ;
struct V_7 * V_8 ;
F_54 ( & V_92 ) ;
