...
V_149 |= 1 << 11 ;
V_149 |= 1 << 12 ;
if ( F_75 ( V_115 -> V_151 [ 0 ] . V_164 ) )
F_65 ( V_115 -> V_151 [ 0 ] . V_164 , 0 ) ;
if ( F_75 ( V_115 -> V_151 [ 0 ] . V_165 ) )
F_65 ( V_115 -> V_151 [ 0 ] . V_165 , 0 ) ;
break;
case 0 :
break;
default:
...
if ( F_75 ( V_115 -> V_151 [ 1 ] . V_164 ) )
F_65 ( V_115 -> V_151 [ 1 ] . V_164 , 0 ) ;
if ( F_75 ( V_115 -> V_151 [ 1 ] . V_165 ) )
F_65 ( V_115 -> V_151 [ 1 ] . V_165 , 0 ) ;
break;
case 0 :
break;
default:
...
struct V_88 * T_2
F_77 ( unsigned int V_89 , struct V_167 * V_115 ,
...
struct V_88 * T_2
F_84 ( unsigned int V_89 , struct V_202 * V_115 )
{
struct {
struct V_202 V_107 ;
...
if ( F_74 ( V_90 , V_115 , sizeof( V_205 ) ) )
goto V_191;
if ( F_75 ( V_115 -> V_207 ) )
F_65 ( V_115 -> V_207 , 0 ) ;
...
sizeof( struct V_224 ) ) )
goto V_153;
if ( F_85 ( V_90 , V_115 -> V_213 , V_214 ) )
goto V_153;
F_50 ( V_90 ) ;
return V_90 ;
V_153:
...
struct V_88 * T_2
F_88 ( unsigned int V_89 , struct V_228 * V_115 )
{
struct V_88 * V_90 ;
if ( V_89 != 0 || ! V_115 )
return NULL ;
...
struct V_88 * T_2
F_89 ( unsigned int V_89 , struct V_234 * V_115 ,
unsigned int V_45 )
{
struct V_88 * V_90 ;
struct V_235 * V_236 ;
...
struct V_88 * T_2
F_90 ( unsigned int V_89 , struct V_247 * V_115 )
{
struct V_88 * V_90 ;
struct V_235 * V_248 ;
T_1 V_91 ;
...
if ( ! V_268 )
goto V_153;
if ( F_97 ( V_268 , 0x24000000 , 0x8000 , - 1 ) )
goto V_269;
V_270 = V_268 ;
return 0 ;
V_269:
