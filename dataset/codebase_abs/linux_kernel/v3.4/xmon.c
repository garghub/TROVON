...
static void
F_118 ( int V_135 , unsigned long V_147 )
{
unsigned int V_144 [ 2 ] ;
...
F_118 ( V_156 , V_147 ) ;
case 'r' :
printf ( L_125 , V_156 , F_117 ( V_156 ) ) ;
break;
}
F_108 () ;
}
...
static void
F_120 ( unsigned char * V_147 , int V_103 )
{
int V_164 ;
switch ( V_103 ) {
case 2 :
F_121 ( V_147 [ 0 ] , V_147 [ 1 ] , V_164 ) ;
break;
case 4 :
F_121 ( V_147 [ 0 ] , V_147 [ 3 ] , V_164 ) ;
F_121 ( V_147 [ 1 ] , V_147 [ 2 ] , V_164 ) ;
break;
case 8 :
F_121 ( V_147 [ 0 ] , V_147 [ 7 ] , V_164 ) ;
F_121 ( V_147 [ 1 ] , V_147 [ 6 ] , V_164 ) ;
F_121 ( V_147 [ 2 ] , V_147 [ 5 ] , V_164 ) ;
F_121 ( V_147 [ 3 ] , V_147 [ 4 ] , V_164 ) ;
break;
}
}
static void
...
static void F_123 ( unsigned long V_91 , long V_173 )
{
...
static void
F_125 ( unsigned long V_91 , long V_173 )
{
...
static int
F_126 ( unsigned long V_180 , long V_87 , int V_181 ,
T_2 V_182 )
{
int V_176 , V_183 ;
unsigned long V_184 ;
...
{
return F_126 ( V_180 , V_87 , V_181 , V_188 ) ;
}
void
F_128 ( unsigned long V_93 )
{
...
V_77 = 0 ;
F_101 ( ( void * ) & V_195 ) ;
F_130 ( ( unsigned char * ) V_191 , ( unsigned char * ) V_193 , V_194 , V_195 ) ;
break;
}
}
static void
F_130 ( unsigned char * V_196 , unsigned char * V_197 , unsigned V_198 , unsigned V_199 )
{
...
&& ( ( F_127 ( V_147 ) ^ V_192 ) & V_202 ) == 0 ) {
printf ( L_148 , V_65 , F_127 ( V_147 ) ) ;
if ( ++ V_135 >= 10 )
break;
}
}
...
if ( F_133 ( line , sizeof( line ) ) == NULL ) {
V_213 = NULL ;
return V_50 ;
}
V_213 = line ;
...
V_58 = 1 ;
F_1 () ;
V_104 = F_107 ( V_32 , & V_103 , & V_27 , & V_218 ,
V_106 ) ;
F_1 () ;
F_115 ( 200 ) ;
}
...
V_160 V_268 = F_140 ( V_251 ) ;
V_160 V_269 = F_141 ( V_270 ) ;
V_161 V_271 = 0 ;
V_161 V_272 ;
...
void F_152 ( struct V_308 * V_309 )
{
struct V_310 * V_310 ;
F_153 (spu, list, full_list) {
...
F_1 () ;
V_310 = V_313 [ V_60 ] . V_310 ;
F_158 ( V_310 , V_313 [ V_60 ] . V_320 ) ;
F_160 ( & V_310 -> V_318 -> V_319 ,
V_313 [ V_60 ] . V_317 ) ;
F_1 () ;
F_115 ( 200 ) ;
printf ( L_223 , V_60 ) ;
...
static void F_161 ( struct V_310 * V_310 )
{
printf ( L_225 , V_310 ) ;
F_162 ( V_310 , L_226 , V_311 ) ;
F_162 ( V_310 , L_130 , V_104 ) ;
F_162 ( V_310 , L_227 , V_322 ) ;
F_162 ( V_310 , L_228 , V_316 ) ;
F_162 ( V_310 , L_227 , V_323 ) ;
F_162 ( V_310 , L_226 , V_324 ) ;
F_162 ( V_310 , L_227 , V_28 ) ;
F_162 ( V_310 , L_229 , V_325 ) ;
F_162 ( V_310 , L_227 , V_326 ) ;
F_162 ( V_310 , L_227 , V_327 ) ;
F_162 ( V_310 , L_227 , V_328 ) ;
F_162 ( V_310 , L_227 , V_329 [ 0 ] ) ;
F_162 ( V_310 , L_227 , V_329 [ 1 ] ) ;
F_162 ( V_310 , L_227 , V_329 [ 2 ] ) ;
F_162 ( V_310 , L_226 , V_330 ) ;
F_162 ( V_310 , L_229 , V_133 ) ;
F_162 ( V_310 , L_228 , V_331 ) ;
F_162 ( V_310 , L_228 , V_332 ) ;
F_162 ( V_310 , L_228 , V_333 ) ;
F_162 ( V_310 , L_228 , V_334 ) ;
F_162 ( V_310 , L_227 , V_335 ) ;
F_162 ( V_310 , L_228 , V_318 ) ;
F_163 ( L_226 , V_318 -> V_319 ,
F_156 ( & V_310 -> V_318 -> V_319 ) ) ;
F_163 ( L_226 , V_318 -> V_336 ,
F_156 ( & V_310 -> V_318 -> V_336 ) ) ;
F_163 ( L_226 , V_318 -> V_337 ,
F_156 ( & V_310 -> V_318 -> V_337 ) ) ;
F_162 ( V_310 , L_228 , V_338 ) ;
F_162 ( V_310 , L_228 , V_339 ) ;
}
int
F_164 ( unsigned long V_180 , long V_87 , int V_181 )
{
return F_126 ( V_180 , V_87 , V_181 , V_340 ) ;
}
static void F_165 ( unsigned long V_341 , int V_342 )
{
