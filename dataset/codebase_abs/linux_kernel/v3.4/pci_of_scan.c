...
static void T_3 F_27 ( struct V_1 * V_20 ,
struct V_40 * V_41 , int V_85 )
{
struct V_1 * V_86 ;
const T_1 * V_87 ;
int V_88 , V_42 ;
...
if ( ! F_29 ( V_86 ) )
continue;
V_87 = F_2 ( V_86 , L_35 , & V_88 ) ;
if ( V_87 == NULL || V_88 < 20 )
continue;
V_42 = ( V_87 [ 0 ] >> 8 ) & 0xff ;
V_22 = F_10 ( V_86 , V_41 , V_42 ) ;
if ( ! V_22 )
continue;
F_5 ( L_36 , V_22 -> V_63 ) ;
}
