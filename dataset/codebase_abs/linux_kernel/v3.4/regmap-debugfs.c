...
V_20 = V_18 + V_19 + 3 ;
for ( V_23 = 0 ; V_23 < V_9 -> V_26 + 1 ; V_23 ++ ) {
if ( ! F_7 ( V_9 , V_23 ) )
continue;
if ( F_8 ( V_9 , V_23 ) )
continue;
...
while ( * V_31 == ' ' )
V_31 ++ ;
V_32 = F_14 ( V_31 , & V_31 , 16 ) ;
while ( * V_31 == ' ' )
V_31 ++ ;
if ( F_15 ( V_31 , 16 , & V_33 ) )
return - V_25 ;
F_16 ( V_34 ) ;
F_17 ( V_9 , V_32 , V_33 ) ;
return V_3 ;
...
{
V_9 -> V_35 = F_22 ( F_23 ( V_9 -> V_15 ) ,
V_36 ) ;
if ( ! V_9 -> V_35 ) {
F_24 ( V_9 -> V_15 , L_6 ) ;
return;
}
F_25 ( L_7 , 0400 , V_9 -> V_35 ,
V_9 , & V_37 ) ;
if ( V_9 -> V_26 ) {
F_25 ( L_8 , 0400 , V_9 -> V_35 ,
V_9 , & V_38 ) ;
F_25 ( L_9 , 0400 , V_9 -> V_35 ,
V_9 , & V_39 ) ;
}
if ( V_9 -> V_40 ) {
F_26 ( L_10 , 0400 , V_9 -> V_35 ,
& V_9 -> V_41 ) ;
F_26 ( L_11 , 0400 , V_9 -> V_35 ,
& V_9 -> V_42 ) ;
F_26 ( L_12 , 0400 , V_9 -> V_35 ,
& V_9 -> V_43 ) ;
}
}
