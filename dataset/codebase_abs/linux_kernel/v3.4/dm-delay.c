...
break;
case V_67 :
F_47 ( L_13 , V_3 -> V_42 -> V_68 ,
( unsigned long long ) V_3 -> V_39 ,
V_3 -> V_40 ) ;
if ( V_3 -> V_43 )
F_47 ( L_14 , V_3 -> V_43 -> V_68 ,
...
struct V_2 * V_3 = V_30 -> V_54 ;
int V_70 = 0 ;
V_70 = V_69 ( V_30 , V_3 -> V_42 , V_3 -> V_39 , V_30 -> V_71 , V_1 ) ;
if ( V_70 )
goto V_44;
if ( V_3 -> V_43 )
V_70 = V_69 ( V_30 , V_3 -> V_43 , V_3 -> V_46 , V_30 -> V_71 , V_1 ) ;
V_44:
return V_70 ;
}
