...
static int F_40 ( struct V_1 * V_1 , unsigned long V_33 )
{
unsigned long V_39 = F_13 ( V_1 -> V_32 ) ;
T_2 V_24 = F_7 ( V_77 ) ;
...
static unsigned long F_41 ( struct V_1 * V_1 , unsigned long V_33 )
{
unsigned long V_39 = F_13 ( V_1 -> V_32 ) ;
if ( V_33 * 7 <= V_39 + V_39 / 20 )
return V_39 / 7 ;
...
static unsigned long F_42 ( struct V_1 * V_1 )
{
struct V_81 * V_82 ;
T_2 V_24 , V_71 , V_72 ;
int V_83 , V_84 ;
...
static int F_45 ( struct V_1 * V_1 , unsigned long V_33 )
{
unsigned long V_39 = F_13 ( V_1 -> V_32 ) ;
struct V_81 * V_82 ;
...
static unsigned long F_46 ( struct V_1 * V_1 , unsigned long V_33 )
{
unsigned long V_39 = F_13 ( V_1 -> V_32 ) ;
T_2 div = V_39 / V_33 ;
...
static int F_47 ( struct V_1 * V_1 , struct V_1 * V_32 )
{
struct V_104 * V_105 ;
int V_83 , V_84 ;
T_2 V_24 ;
...
if ( ! V_105 -> V_107 [ V_83 ] || V_105 -> V_107 [ V_83 ] == & V_108 )
return - V_36 ;
V_24 = F_7 ( V_105 -> V_23 ) ;
V_24 &= ~ V_105 -> V_49 ;
...
F_56 (np, NULL, L_1 ) {
T_2 V_33 ;
if ( F_57 ( V_126 , L_2 , & V_33 ) )
continue;
if ( F_58 ( V_126 , L_3 ) )
V_4 = V_33 ;
else if ( F_58 ( V_126 , L_4 ) )
V_3 = V_33 ;
else if ( F_58 ( V_126 , L_5 ) )
V_2 = V_33 ;
}
for ( V_83 = 0 ; V_83 < F_43 ( V_129 ) ; V_83 ++ )
F_59 ( & V_129 [ V_83 ] ) ;
F_8 ( 0x3 << V_130 | 0x3 << V_131 | 0x3 << V_132 , V_133 ) ;
F_8 ( 0x3 << V_134 | 0x3 << V_135 | 0x3 << V_136 , V_137 ) ;
F_8 ( 0x3 << V_136 | 0x3 << V_138 , V_139 ) ;
F_8 ( 0x3 << V_140 | 0x3 << V_141 | 0x3 << V_142 , V_143 ) ;
F_8 ( 0x3 << V_130 , V_144 ) ;
F_8 ( 0 , V_145 ) ;
F_8 ( 0 , V_146 ) ;
F_60 ( & V_147 ) ;
...
F_61 ( & V_159 , 49500000 ) ;
F_62 ( & V_160 , & V_93 ) ;
V_126 = F_63 ( NULL , NULL , L_6 ) ;
V_127 = F_64 ( V_126 , 0 ) ;
F_65 ( ! V_127 ) ;
V_128 = F_66 ( V_126 , 0 ) ;
F_67 ( & V_161 , V_127 , V_128 ) ;
return 0 ;
}
