...
struct V_3 * V_128 =
V_49 -> V_2 -> V_5 ;
struct V_129 * V_130 = V_128 -> V_129 ;
if ( V_130 ) {
V_130 -> V_131 . V_132 = V_116 ;
F_46 ( V_130 ) ;
}
#endif
}
...
int V_87 ;
V_54 =
F_50 ( sizeof( struct V_54 ) , V_141 ) ;
if ( ! V_54 ) {
F_5 ( V_2 -> V_2 , L_16 ) ;
return;
}
V_137 =
F_50 ( sizeof( struct V_137 ) , V_141 ) ;
if ( ! V_137 ) {
F_5 ( V_2 -> V_2 , L_17 ) ;
goto V_142;
}
V_56 = F_50 ( sizeof( struct V_55 ) , V_141 ) ;
if ( ! V_56 ) {
F_5 ( V_2 -> V_2 , L_18 ) ;
goto V_143;
}
...
V_4 -> V_158 ,
V_25 ) ;
V_56 -> V_107 = F_57 ( V_2 , V_159 , L_19 ) ;
if ( ! V_56 -> V_107 ) {
F_58 ( V_88 ,
& V_2 -> V_160 -> V_2 , L_20 ) ;
goto V_161;
...
V_4 -> V_14 = V_56 -> V_107 ;
V_56 -> V_113 = F_57 ( V_2 , V_162 , L_21 ) ;
if ( ! V_56 -> V_113 ) {
F_58 ( V_88 , & V_2 -> V_160 -> V_2 ,
L_22 L_23 ) ;
goto V_163;
}
