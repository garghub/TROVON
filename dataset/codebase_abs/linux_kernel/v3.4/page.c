...
unsigned V_64 , unsigned V_65 )
{
unsigned V_66 , V_67 ;
struct V_1 * V_8 , * V_30 ;
unsigned V_68 = 0 ;
for ( V_8 = V_30 = F_32 ( V_2 ) , V_66 = 0 ;
V_8 != V_30 || ! V_66 ;
V_66 = V_67 , V_8 = V_8 -> V_29 ) {
V_67 = V_66 + V_8 -> V_24 ;
if ( V_67 > V_64 && V_66 < V_65 && ! F_33 ( V_8 ) )
V_68 ++ ;
}
return V_68 ;
}
...
if ( V_10 -> V_80 -> V_62 == 0 )
return 0 ;
V_4 = V_76 >> ( V_9 - V_10 -> V_14 ) ;
V_77 = 1U << ( V_9 - V_10 -> V_14 ) ;
F_44 ( & V_50 , 0 ) ;
V_52:
V_50 . V_81 = F_73 ( V_10 -> V_80 , V_4 , V_54 ,
V_50 . V_55 ) ;
if ( V_50 . V_81 == 0 )
return V_78 ;
if ( V_78 > 0 && V_50 . V_55 [ 0 ] -> V_4 > V_4 )
goto V_82;
V_79 = V_50 . V_55 [ 0 ] -> V_4 << ( V_9 - V_10 -> V_14 ) ;
V_38 = 0 ;
do {
V_2 = V_50 . V_55 [ V_38 ] ;
F_47 ( V_2 ) ;
...
} while ( ++ V_79 , V_8 = V_8 -> V_29 , V_8 != V_30 );
} else {
if ( V_78 > 0 )
goto V_83;
V_79 += V_77 ;
