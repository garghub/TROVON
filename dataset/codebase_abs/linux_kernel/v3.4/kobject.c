...
int V_12 = strlen ( F_5 ( V_10 ) ) ;
V_9 -= V_12 ;
strncpy ( V_11 + V_9 , F_5 ( V_10 ) , V_12 ) ;
* ( V_11 + -- V_9 ) = '/' ;
}
F_10 ( L_1 , F_5 ( V_2 ) ,
V_2 , V_13 , V_11 ) ;
...
static void F_49 ( struct V_20 * V_20 )
{
F_47 ( F_50 ( V_20 , struct V_1 , V_20 ) ) ;
}
...
struct V_1 * F_54 ( const char * V_26 , struct V_1 * V_10 )
{
struct V_1 * V_2 ;
int V_35 ;
V_2 = F_53 () ;
...
void F_55 ( struct V_16 * V_52 )
{
F_21 ( & V_52 -> V_2 ) ;
F_23 ( & V_52 -> V_19 ) ;
F_56 ( & V_52 -> V_17 ) ;
}
static T_3 F_57 ( struct V_1 * V_2 , struct V_5 * V_6 ,
char * V_53 )
{
struct V_54 * V_55 ;
T_3 V_56 = - V_57 ;
V_55 = F_50 ( V_6 , struct V_54 , V_6 ) ;
if ( V_55 -> V_58 )
V_56 = V_55 -> V_58 ( V_2 , V_55 , V_53 ) ;
return V_56 ;
}
static T_3 F_58 ( struct V_1 * V_2 , struct V_5 * V_6 ,
const char * V_53 , T_4 V_59 )
{
struct V_54 * V_55 ;
T_3 V_56 = - V_57 ;
V_55 = F_50 ( V_6 , struct V_54 , V_6 ) ;
...
void F_60 ( struct V_16 * V_52 )
{
if ( ! V_52 )
return;
F_27 ( & V_52 -> V_2 ) ;
}
struct V_1 * F_61 ( struct V_16 * V_16 , const char * V_26 )
{
struct V_1 * V_52 ;
struct V_1 * V_56 = NULL ;
F_15 ( & V_16 -> V_17 ) ;
F_62 (k, &kset->list, entry) {
if ( F_5 ( V_52 ) && ! strcmp ( F_5 ( V_52 ) , V_26 ) ) {
V_56 = F_26 ( V_52 ) ;
break;
}
}
...
{
struct V_16 * V_16 = F_50 ( V_2 , struct V_16 , V_2 ) ;
F_10 ( L_20 ,
F_5 ( V_2 ) , V_2 , V_13 ) ;
F_30 ( V_16 ) ;
}
static struct V_16 * F_64 ( const char * V_26 ,
...
struct V_16 * F_65 ( const char * V_26 ,
const struct V_63 * V_64 ,
struct V_1 * V_65 )
{
struct V_16 * V_16 ;
int error ;
V_16 = F_64 ( V_26 , V_64 , V_65 ) ;
if ( ! V_16 )
return NULL ;
error = F_59 ( V_16 ) ;
if ( error ) {
...
int F_66 ( const struct V_67 * V_68 )
{
...
const struct V_67 * F_68 ( struct V_1 * V_10 )
{
...
const struct V_67 * F_69 ( struct V_1 * V_2 )
{
return F_68 ( V_2 -> V_10 ) ;
}
void * F_70 ( enum V_69 type )
{
void * V_77 = NULL ;
F_15 ( & V_70 ) ;
if ( ( type > V_72 ) && ( type < V_71 ) &&
...
const void * F_72 ( enum V_69 type , struct V_78 * V_79 )
{
const void * V_77 = NULL ;
F_15 ( & V_70 ) ;
if ( ( type > V_72 ) && ( type < V_71 ) &&
V_74 [ type ] )
V_77 = V_74 [ type ] -> F_73 ( V_79 ) ;
F_17 ( & V_70 ) ;
return V_77 ;
}
const void * F_74 ( enum V_69 type )
{
const void * V_77 = NULL ;
F_15 ( & V_70 ) ;
if ( ( type > V_72 ) && ( type < V_71 ) &&
...
void F_76 ( enum V_69 type , void * V_77 )
{
F_15 ( & V_70 ) ;
if ( ( type > V_72 ) && ( type < V_71 ) &&
