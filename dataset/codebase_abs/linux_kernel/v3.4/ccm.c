...
if ( V_21 -> V_86 != 16 )
goto V_87;
V_67 = F_71 ( sizeof( * V_67 ) + sizeof( * V_70 ) , V_88 ) ;
V_22 = - V_89 ;
if ( ! V_67 )
goto V_87;
V_70 = F_55 ( V_67 ) ;
V_22 = F_72 ( & V_70 -> V_21 , V_21 , V_67 ,
V_85 ) ;
if ( V_22 )
goto V_90;
F_73 ( & V_70 -> V_18 , V_67 ) ;
V_22 = F_74 ( & V_70 -> V_18 , V_77 , 0 ,
F_75 ( V_80 -> type ,
V_80 -> V_83 ) ) ;
if ( V_22 )
goto V_91;
...
static struct V_66 * F_82 ( struct V_74 * * V_75 )
{
int V_22 ;
const char * V_78 ;
char V_77 [ V_98 ] ;
...
static struct V_66 * F_85 ( struct V_74 * * V_75 )
{
int V_22 ;
const char * V_77 ;
const char * V_78 ;
...
static int F_86 ( struct V_11 * V_116 , const V_5 * V_13 ,
unsigned int V_14 )
{
...
V_23 ) ;
V_22 = F_88 ( V_118 , V_13 , V_14 ) ;
F_14 ( V_116 , F_12 ( V_118 ) &
V_24 ) ;
return V_22 ;
}
static int F_89 ( struct V_11 * V_116 ,
unsigned int V_26 )
{
struct V_117 * V_16 = F_9 ( V_116 ) ;
switch ( V_26 ) {
...
return F_90 ( V_16 -> V_118 , V_26 ) ;
}
static struct V_2 * F_91 ( struct V_2 * V_3 )
{
struct V_2 * V_120 = F_5 ( V_3 ) ;
struct V_11 * V_12 = F_3 ( V_3 ) ;
struct V_117 * V_16 = F_9 ( V_12 ) ;
struct V_11 * V_118 = V_16 -> V_118 ;
V_5 * V_31 = F_4 ( ( V_5 * ) ( V_120 + 1 ) + F_92 ( V_118 ) ,
F_2 ( V_118 ) + 1 ) ;
V_31 [ 0 ] = 3 ;
memcpy ( V_31 + 1 , V_16 -> V_119 , 3 ) ;
memcpy ( V_31 + 4 , V_3 -> V_31 , 8 ) ;
F_93 ( V_120 , V_118 ) ;
F_94 ( V_120 , V_3 -> V_121 . V_52 , V_3 -> V_121 . V_122 ,
V_3 -> V_121 . V_9 ) ;
F_95 ( V_120 , V_3 -> V_61 , V_3 -> V_58 , V_3 -> V_29 , V_31 ) ;
F_96 ( V_120 , V_3 -> V_55 , V_3 -> V_34 ) ;
return V_120 ;
}
...
static int F_101 ( struct V_65 * V_20 )
{
struct V_66 * V_67 = ( void * ) V_20 -> V_68 ;
...
static void F_104 ( struct V_65 * V_20 )
{
struct V_117 * V_16 = F_56 ( V_20 ) ;
F_105 ( V_16 -> V_118 ) ;
}
static struct V_66 * F_106 ( struct V_74 * * V_75 )
{
struct V_79 * V_80 ;
struct V_66 * V_67 ;
struct V_123 * V_124 ;
...
if ( F_58 ( V_125 ) )
return F_69 ( V_22 ) ;
V_67 = F_71 ( sizeof( * V_67 ) + sizeof( * V_124 ) , V_88 ) ;
if ( ! V_67 )
return F_69 ( - V_89 ) ;
V_124 = F_55 ( V_67 ) ;
F_107 ( V_124 , V_67 ) ;
V_22 = F_108 ( V_124 , V_125 , 0 ,
F_75 ( V_80 -> type , V_80 -> V_83 ) ) ;
if ( V_22 )
goto V_126;
V_96 = F_109 ( V_124 ) ;
V_22 = - V_27 ;
...
V_67 -> V_96 . V_110 = F_101 ;
V_67 -> V_96 . V_111 = F_104 ;
V_67 -> V_96 . V_107 . V_112 = F_86 ;
V_67 -> V_96 . V_107 . V_113 = F_89 ;
V_67 -> V_96 . V_107 . V_114 = F_97 ;
V_67 -> V_96 . V_107 . V_115 = F_99 ;
