...
return - V_10 ;
V_7 = F_33 ( & V_87 -> V_16 , sizeof( * V_7 ) , V_93 ) ;
if ( ! V_7 )
return - V_94 ;
V_6 [ V_87 -> V_17 ] = V_7 ;
V_7 -> V_17 = V_87 -> V_17 ;
...
V_89 = F_37 ( V_87 , V_97 , 0 ) ;
V_7 -> V_20 = F_38 ( & V_87 -> V_16 , V_89 ) ;
if ( ! V_7 -> V_20 ) {
F_6 ( & V_87 -> V_16 , L_16 ) ;
V_14 = - V_98 ;
goto V_99;
}
V_90 = F_37 ( V_87 , V_100 , 0 ) ;
if ( ! V_90 ) {
V_14 = - V_98 ;
F_6 ( & V_87 -> V_16 , L_17 ,
V_14 ) ;
...
V_7 -> V_16 = & V_87 -> V_16 ;
V_14 = F_40 ( & V_87 -> V_16 , V_7 -> V_80 , F_30 , 0 ,
L_19 , V_7 ) ;
if ( V_14 ) {
F_6 ( & V_87 -> V_16 , L_20 ) ;
goto V_99;
}
V_7 -> V_55 . V_103 = F_39 ( V_87 , 1 ) ;
if ( V_7 -> V_55 . V_103 < 0 ) {
V_14 = V_7 -> V_55 . V_103 ;
F_6 ( & V_87 -> V_16 , L_21 ,
V_14 ) ;
...
static int T_3 F_48 ( struct V_86 * V_87 )
{
struct V_6 * V_7 = F_49 ( V_87 ) ;
F_50 ( V_7 -> V_105 ) ;
F_46 ( & V_87 -> V_16 ) ;
F_47 ( V_7 -> V_24 ) ;
return 0 ;
