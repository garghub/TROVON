...
V_4 -> V_33 = 0 ;
} else if ( V_4 -> V_33 & V_180 ) {
V_4 -> V_33 ^= V_180 ;
V_96 = F_28 ( ( ( char * ) V_4 -> V_78 - ( char * ) V_4 ) + V_4 -> V_47 ) ;
V_4 -> V_28 . V_30 [ 0 ] = F_33 ( V_96 ) ;
V_4 -> V_28 . V_30 [ 1 ] = F_34 ( V_96 ) ;
V_4 -> V_28 . V_29 = V_291 ;
} else if ( V_4 -> V_33 & V_292 ) {
V_4 -> V_33 ^= V_292 ;
V_4 -> V_28 . V_29 = V_293 ;
V_4 -> V_28 . V_30 [ 0 ] = 0 ;
V_4 -> V_28 . V_30 [ 1 ] = 0 ;
} else if ( V_4 -> V_33 & V_162 ) {
if ( V_4 -> V_161 ) {
if ( ! V_4 -> V_39 ) {
V_4 -> V_39 = 1 ;
F_35 ( V_2 , V_292 ) ;
