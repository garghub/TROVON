...
static int T_5 F_111 ( struct V_18 * V_19 )
{
struct V_12 * V_12 ;
void T_1 * V_302 ;
unsigned long V_303 ;
...
static int F_126 ( struct V_18 * V_19 , unsigned int V_331 , void T_6 * V_332 )
{
struct V_12 * V_12 = F_6 ( V_19 ) ;
if ( V_331 == V_333 ) {
...
void T_6 * V_349 , int V_350 )
{
return - V_232 ;
}
static int F_130 ( struct V_39 * V_40 , int V_347 , int V_348 ,
void T_6 * V_349 , unsigned int V_350 )
{
return - V_232 ;
}
...
static int F_136 ( struct V_18 * V_19 , T_7 * V_355 , char * V_356 )
{
struct V_357 * V_358 ;
struct V_359 * V_1 ;
...
F_143 ( & V_361 ) ;
for ( V_10 = 0 ; V_10 < V_12 -> V_13 ; V_10 ++ ) {
struct V_28 * V_366 = V_12 -> V_15 + V_10 ;
unsigned long V_367 ;
if ( -- V_360 ) continue;
V_367 = ( unsigned long ) V_12 -> V_141 + V_12 -> V_31 ;
return sprintf ( V_356 , L_185 ,
V_366 -> V_16 - V_367 , V_366 -> V_16 - V_367 + ( 1 << V_366 -> V_17 ) - 1 ,
1 << V_366 -> V_17 ) ;
}
return 0 ;
}
static int T_5 F_144 ( struct V_66 * V_66 ,
...
goto V_372;
V_184 = & V_12 -> V_184 ;
V_184 -> V_354 = F_146 ( V_66 , V_373 , & V_184 -> V_61 ) ;
if ( ! V_184 -> V_354 )
goto V_374;
V_19 = F_147 ( V_90 , & V_66 -> V_19 , & V_375 , - 1 , NULL ) ;
if ( ! V_19 )
goto V_376;
V_19 -> V_315 = V_12 ;
F_148 ( V_66 , V_19 ) ;
V_12 -> V_66 = V_66 ;
V_12 -> V_285 = V_369 -> V_377 ;
V_371 = F_104 ( V_19 ) ;
if ( V_371 < 0 )
goto V_378;
V_371 = F_111 ( V_19 ) ;
...
F_149 ( V_19 ) ;
V_376:
F_150 ( V_66 , V_373 , V_184 -> V_354 , V_184 -> V_61 ) ;
V_374:
F_118 ( V_12 ) ;
V_372:
F_151 ( V_66 ) ;
...
static void T_8 F_152 ( struct V_66 * V_382 )
{
struct V_18 * V_19 = F_153 ( V_382 ) ;
struct V_12 * V_300 = F_6 ( V_19 ) ;
struct V_370 * V_184 = & V_300 -> V_184 ;
F_110 ( V_19 ) ;
F_149 ( V_19 ) ;
F_150 ( V_382 , V_373 , V_184 -> V_354 , V_184 -> V_61 ) ;
F_118 ( V_300 ) ;
F_151 ( V_382 ) ;
}
