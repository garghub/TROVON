...
if ( V_12 -> V_68 ) {
T_5 V_111 = 0 ;
while ( V_111 < V_73 -> V_2 . V_26 ) {
if ( F_47 ( V_12 , V_111 + V_73 -> V_15 ) )
V_73 -> V_2 . V_13 . V_70 ++ ;
V_111 += V_73 -> V_2 . V_95 ;
}
}
...
if ( V_71 -> V_12 == V_12 ) {
if ( ( V_114 >= V_71 -> V_15 ) &&
( V_114 < ( V_71 -> V_15 + V_71 -> V_2 . V_26 ) ) )
goto V_115;
if ( ( V_104 >= V_71 -> V_15 ) &&
( V_104 < ( V_71 -> V_15 + V_71 -> V_2 . V_26 ) ) )
goto V_115;
}
F_52 ( & V_113 -> V_77 , & V_116 ) ;
F_38 ( & V_76 ) ;
F_53 ( & V_113 -> V_2 ) ;
return V_55 ;
V_115:
...
T_5 V_80 = 0 ;
int V_102 ;
F_42 ( V_96 L_10 , V_119 , V_12 -> V_72 ) ;
for ( V_102 = 0 ; V_102 < V_119 ; V_102 ++ ) {
V_73 = F_39 ( V_12 , V_118 + V_102 , V_102 , V_80 ) ;
if ( F_49 ( V_73 ) )
return F_50 ( V_73 ) ;
F_34 ( & V_76 ) ;
F_52 ( & V_73 -> V_77 , & V_116 ) ;
F_38 ( & V_76 ) ;
F_53 ( & V_73 -> V_2 ) ;
...
static struct V_120 * F_56 ( const char * V_72 )
{
struct V_120 * V_71 , * V_55 = NULL ;
F_57 ( & V_121 ) ;
...
int F_60 ( struct V_120 * V_71 )
{
F_57 ( & V_121 ) ;
F_52 ( & V_71 -> V_77 , & V_122 ) ;
F_59 ( & V_121 ) ;
return 0 ;
}
int F_61 ( struct V_120 * V_71 )
{
F_57 ( & V_121 ) ;
F_37 ( & V_71 -> V_77 ) ;
F_59 ( & V_121 ) ;
...
int F_62 ( struct V_1 * V_12 , const char * * V_123 ,
struct V_78 * * V_124 ,
struct V_125 * V_126 )
{
struct V_120 * V_127 ;
...
if ( ! V_123 )
V_123 = V_128 ;
for ( ; V_55 <= 0 && * V_123 ; V_123 ++ ) {
V_127 = F_56 ( * V_123 ) ;
if ( ! V_127 && ! F_63 ( L_11 , * V_123 ) )
V_127 = F_56 ( * V_123 ) ;
if ( ! V_127 )
continue;
V_55 = (* V_127 -> V_129 )( V_12 , V_124 , V_126 ) ;
if ( V_55 > 0 ) {
F_42 ( V_96 L_12 ,
V_55 , V_127 -> V_72 , V_12 -> V_72 ) ;
}
F_64 ( V_127 ) ;
}
return V_55 ;
