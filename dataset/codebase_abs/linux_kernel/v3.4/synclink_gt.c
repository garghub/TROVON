...
static T_1 F_258 ( struct V_1 * V_2 , unsigned int V_507 )
{
F_259 () ;
return F_260 ( ( void V_508 * ) V_458 ) ;
}
static void F_261 ( struct V_1 * V_2 , unsigned int V_507 , T_1 V_174 )
{
F_259 () ;
F_262 ( V_174 , ( void V_508 * ) V_458 ) ;
}
static T_14 F_99 ( struct V_1 * V_2 , unsigned int V_507 )
{
F_259 () ;
return F_263 ( ( void V_508 * ) V_458 ) ;
}
static void F_100 ( struct V_1 * V_2 , unsigned int V_507 , T_14 V_174 )
{
F_259 () ;
F_264 ( V_174 , ( void V_508 * ) V_458 ) ;
}
static T_8 F_164 ( struct V_1 * V_2 , unsigned int V_507 )
{
F_259 () ;
return F_265 ( ( void V_508 * ) V_458 ) ;
}
static void F_165 ( struct V_1 * V_2 , unsigned int V_507 , T_8 V_174 )
{
F_259 () ;
F_266 ( V_174 , ( void V_508 * ) V_458 ) ;
}
...
static void F_269 ( struct V_1 * V_2 , T_9 V_510 )
{
unsigned int div ;
...
F_100 ( V_2 , V_409 , ( unsigned short ) ( F_99 ( V_2 , V_409 ) | V_513 ) ) ;
F_165 ( V_2 , V_514 , V_2 -> V_15 [ 0 ] . V_452 ) ;
if ( V_2 -> V_68 . V_69 != V_89 ) {
...
F_165 ( V_2 , V_516 , V_2 -> V_11 [ V_2 -> V_337 ] . V_452 ) ;
...
V_339 |= V_267 ;
F_100 ( V_2 , V_389 , V_339 ) ;
F_261 ( V_2 , V_509 , 0x69 ) ;
F_197 ( V_2 ) ;
V_339 = V_317 + V_513 + V_267 ;
if ( ( F_164 ( V_2 , V_520 ) & V_355 ) && V_2 -> V_68 . V_85 &&
...
V_339 |= V_317 + V_521 ;
break;
case V_280 : V_339 |= V_513 + V_521 ; break;
case V_281 : V_339 |= V_317 ; break;
case V_279 : V_339 |= V_521 ; break;
}
if ( V_2 -> V_412 & V_413 )
V_339 |= V_414 ;
switch( V_2 -> V_68 . V_136 )
{
case V_522 : V_339 |= V_316 ; break;
case V_523 : V_339 |= V_524 ; break;
case V_525 : V_339 |= V_524 + V_316 ; break;
case V_187 : V_339 |= V_526 ; break;
case V_189 : V_339 |= V_526 + V_316 ; break;
case V_191 : V_339 |= V_526 + V_524 ; break;
case V_527 : V_339 |= V_526 + V_524 + V_316 ; break;
}
switch ( V_2 -> V_68 . V_139 & V_528 )
{
case V_195 : V_339 |= V_517 ; break;
case V_197 : V_339 |= V_517 + V_355 ; break;
}
if ( V_2 -> V_68 . V_141 != V_529 )
V_339 |= V_177 ;
switch ( V_2 -> V_68 . V_140 )
{
case V_530 : V_339 |= V_334 ; break;
case V_531 : V_339 |= V_335 ; break;
case V_532 : V_339 |= V_334 + V_335 ; break;
}
if ( V_2 -> V_68 . V_22 & V_518 )
V_339 |= V_267 ;
F_100 ( V_2 , V_176 , V_339 ) ;
...
{
case V_533 : V_339 = 0x7e ; break;
case V_534 : V_339 = 0xff ; break;
case V_535 : V_339 = 0x00 ; break;
case V_536 : V_339 = 0x55 ; break;
case V_537 : V_339 = 0xaa ; break;
default: V_339 = 0x7e ; break;
}
F_261 ( V_2 , V_538 , ( unsigned char ) V_339 ) ;
V_339 = 0 ;
switch( V_2 -> V_68 . V_69 ) {
case V_282 :
V_339 |= V_317 + V_521 ;
...
if ( V_2 -> V_68 . V_137 )
V_339 |= V_266 + V_267 ;
F_261 ( V_2 , V_509 , ( unsigned char ) V_339 ) ;
...
F_189 ( V_2 ) ;
F_197 ( V_2 ) ;
F_100 ( V_2 , V_409 , V_317 + V_513 + V_267 ) ;
if ( V_2 -> V_68 . V_135 )
F_268 ( V_2 ) ;
}
...
if ( V_2 -> V_385 & V_540 ) {
V_539 = ( V_539 & ~ ( V_177 + V_334 ) ) | V_335 ;
F_261 ( V_2 , V_538 , ( unsigned char ) ( ( V_2 -> V_385 >> 8 ) & 0xff ) ) ;
} else if ( ! ( V_539 & V_177 ) ) {
V_539 &= ~ ( V_334 + V_335 ) ;
}
...
case V_542 :
case V_543 : V_339 = 0xaa ; break;
case V_544 :
case V_545 : V_339 = 0x00 ; break;
default: V_339 = 0xff ;
}
}
F_261 ( V_2 , V_546 , V_339 ) ;
}
...
if ( V_2 -> V_412 & V_553 )
V_339 |= V_267 ;
F_261 ( V_2 , V_554 , V_339 ) ;
}
static void F_33 ( struct V_1 * V_2 )
{
unsigned char V_339 = F_258 ( V_2 , V_554 ) ;
if ( V_2 -> V_62 & V_64 )
V_339 |= V_288 ;
else
V_339 &= ~ V_288 ;
...
F_145 ( ( L_164 ,
V_2 -> V_8 , V_12 , V_557 ) ) ;
F_138 ( V_2 , V_2 -> V_15 [ V_258 ] . V_73 , F_45 ( int , V_557 , V_2 -> V_315 ) , L_94 ) ;
if ( V_557 ) {
if ( ! ( V_2 -> V_68 . V_139 & V_561 ) ) {
V_557 -= V_559 ;
V_559 = 0 ;
...
V_2 -> V_117 . V_161 ++ ;
while( V_564 ) {
int V_566 = F_45 ( int , V_564 , V_2 -> V_315 ) ;
...
static unsigned int V_4 = F_279 ( V_575 ) ;
unsigned int V_6 ;
int V_148 = 0 ;
for ( V_6 = 0 ; V_6 < V_4 ; V_6 ++ ) {
...
V_2 -> V_358 = ( F_164 ( V_2 , V_520 ) & V_334 ) ? 1 : 0 ;
