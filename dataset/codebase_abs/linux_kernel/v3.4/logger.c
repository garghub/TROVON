T_1 F_1 ( struct V_1 * log , T_1 V_2 )
{
...
T_4 F_24 ( struct V_42 * V_43 , const struct V_44 * V_45 ,
...
static int F_28 ( struct V_64 * V_64 , struct V_4 * V_4 )
{
struct V_1 * log ;
int V_21 ;
V_21 = F_29 ( V_64 , V_4 ) ;
if ( V_21 )
return V_21 ;
log = F_30 ( F_31 ( V_64 -> V_65 ) ) ;
if ( ! log )
return - V_66 ;
if ( V_4 -> V_5 & V_6 ) {
struct V_7 * V_8 ;
V_8 = F_32 ( sizeof( struct V_7 ) , V_67 ) ;
if ( ! V_8 )
return - V_68 ;
V_8 -> log = log ;
F_33 ( & V_8 -> V_69 ) ;
...
static int F_35 ( struct V_64 * V_71 , struct V_4 * V_4 )
{
if ( V_4 -> V_5 & V_6 ) {
struct V_7 * V_8 = V_4 -> V_9 ;
struct V_1 * log = V_8 -> log ;
...
static long F_40 ( struct V_4 * V_4 , unsigned int V_76 , unsigned long V_77 )
{
...
static struct V_1 * F_30 ( int V_85 )
{
if ( V_86 . V_87 . V_85 == V_85 )
return & V_86 ;
if ( V_88 . V_87 . V_85 == V_85 )
return & V_88 ;
if ( V_89 . V_87 . V_85 == V_85 )
return & V_89 ;
if ( V_90 . V_87 . V_85 == V_85 )
return & V_90 ;
return NULL ;
}
static int T_8 F_41 ( struct V_1 * log )
{
int V_21 ;
V_21 = F_42 ( & log -> V_87 ) ;
if ( F_16 ( V_21 ) ) {
...
F_43 ( V_93 L_3 ,
( unsigned long ) log -> V_3 >> 10 , log -> V_87 . V_92 ) ;
return 0 ;
}
