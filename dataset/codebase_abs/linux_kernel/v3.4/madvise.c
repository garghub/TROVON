...
return - V_25 ;
if ( ! V_6 -> V_38 || ! V_6 -> V_38 -> V_45
|| ! V_6 -> V_38 -> V_45 -> V_61 ) {
return - V_25 ;
}
if ( ( V_6 -> V_15 & ( V_62 | V_63 ) ) != ( V_62 | V_63 ) )
return - V_64 ;
V_58 = V_6 -> V_38 -> V_45 ;
V_59 = ( T_2 ) ( V_8 - V_6 -> V_35 )
+ ( ( T_2 ) V_6 -> V_34 << V_36 ) ;
V_60 = ( T_2 ) ( V_9 - V_6 -> V_35 - 1 )
+ ( ( T_2 ) V_6 -> V_34 << V_36 ) ;
F_14 ( & V_65 -> V_11 -> V_66 ) ;
error = F_15 ( V_58 -> V_61 , V_59 , V_60 ) ;
F_16 ( & V_65 -> V_11 -> V_66 ) ;
return error ;
}
static int F_17 ( int V_67 , unsigned long V_8 , unsigned long V_9 )
{
int V_68 = 0 ;
if ( ! F_18 ( V_69 ) )
return - V_70 ;
