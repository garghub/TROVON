...
if ( V_6 -> V_7 & ( V_47 | V_48 ) )
F_2 ( V_6 , L_7 ,
V_38 -> V_49 -> V_50 , V_38 -> V_49 -> V_51 ,
V_38 -> V_33 ) ;
if ( ( V_38 -> V_33 & ( V_34 | V_52 ) ) == V_52 ) {
if ( ! ( V_2 = F_14 ( sizeof( struct V_1 ) , V_53 ) ) ) {
F_13 ( & V_42 ) ;
return ( - V_19 ) ;
}
V_2 -> V_6 = V_6 ;
...
V_2 -> V_20 = V_21 ;
V_38 -> V_18 = V_2 ;
} else if ( ( V_38 -> V_33 & ( V_34 | V_52 ) ) == V_34 ) {
if ( ! ( V_41 = F_14 ( V_54 * 2 + 2 , V_53 ) ) ) {
F_13 ( & V_42 ) ;
return ( - V_19 ) ;
}
V_38 -> V_18 = V_41 ;
...
{
T_5 * V_6 ;
unsigned char V_65 [ 20 ] ;
V_66 = F_22 ( V_67 , V_68 . V_69 ) ;
if ( ! V_66 ) {
F_23 ( V_70 L_11 ) ;
return ( - 1 ) ;
}
V_6 = V_43 ;
while ( V_6 ) {
sprintf ( V_65 , L_12 , V_71 , V_6 -> V_55 ) ;
if ( ( V_6 -> V_44 = ( void * ) F_24 ( V_65 ,
V_72 | V_73 | V_74 ,
V_66 ,
& V_75 ) ) != NULL ) {
F_25 ( V_6 ) ;
