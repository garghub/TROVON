...
static void
F_43 ( struct V_101 * V_102 , const char * V_103 ,
unsigned int V_35 )
{
F_44 ( & V_99 , V_103 , V_35 , F_41 ) ;
}
static void T_2
...
V_105 = * V_88 | ( * V_89 << 8 ) ;
* V_59 = V_2 -> V_70 / ( 16 * ( V_105 + 1 ) ) ;
}
}
static int T_2 F_46 ( struct V_101 * V_102 , char * V_106 )
{
struct V_1 * V_2 = & V_99 ;
int V_59 = 9600 ;
int V_104 = 8 ;
...
V_59 = 57600 ;
if ( V_106 )
F_48 ( V_106 , & V_59 , & V_24 , & V_104 , & V_107 ) ;
else
F_45 ( V_2 , & V_59 , & V_24 , & V_104 ) ;
return F_49 ( V_2 , V_102 , V_59 , V_24 , V_104 , V_107 ) ;
}
