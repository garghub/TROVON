...
T_5
F_212 ( struct V_139 * V_14 , struct V_138 * V_5 ,
...
return V_576 ;
if ( F_213 ( V_5 , V_37 , V_574 -> V_7 ) != NULL )
return V_577 ;
if ( V_5 -> V_23 . V_518 ==
F_186 ( V_5 -> V_202 ) )
return V_578 ;
V_14 -> V_74 = F_214 ( V_5 -> V_202 ) ;
if ( ! V_14 -> V_74 )
return V_578 ;
V_14 -> V_111 = V_111 ;
V_574 -> V_579 = V_57 ;
...
T_5
F_215 ( struct V_139 * V_14 , struct V_138 * V_5 ,
T_2 V_37 , struct V_141 * V_574 ,
struct V_569 * V_111 )
{
T_5 V_580 ;
V_580 = F_212 ( V_14 , V_5 , V_37 , V_574 , V_111 ) ;
...
V_212 -> V_583 = F_221 ( V_584 , V_14 -> V_585 ) ;
}
struct V_139 *
F_213 ( struct V_138 * V_5 , T_2 V_37 , V_71 V_586 )
{
struct V_139 * V_14 ;
struct V_587 * V_23 ;
F_2 ( V_5 , V_37 ) ;
...
void
F_222 ( void * V_32 , void * V_588 , T_5 V_589 )
{
