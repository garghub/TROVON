...
V_32 = F_18 ( V_30 , L_4 ) ;
F_19 ( V_32 == NULL ) ;
V_8 = F_20 ( V_32 , V_2 -> V_7 , 0600 , V_2 ) ;
F_21 ( V_32 ) ;
return V_8 ;
}
int F_22 ( struct V_33 * V_33 , struct V_1 * V_2 )
{
struct V_29 * V_34 ;
int V_8 = 0 ;
V_34 = F_23 ( V_33 ) ;
...
void F_25 ( struct V_29 * V_30 , struct V_1 * V_2 )
{
if ( V_2 -> V_35 . V_36 . V_32 )
F_26 ( V_2 ) ;
}
void F_27 ( struct V_33 * V_33 , struct V_1 * V_2 )
{
struct V_29 * V_34 ;
V_34 = F_23 ( V_33 ) ;
if ( V_34 ) {
