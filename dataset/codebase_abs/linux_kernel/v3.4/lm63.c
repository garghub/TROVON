...
struct V_1 * V_2 ;
int V_66 ;
V_2 = F_65 ( sizeof( struct V_1 ) , V_121 ) ;
if ( ! V_2 ) {
V_66 = - V_122 ;
goto exit;
}
...
goto V_125;
if ( V_2 -> V_28 & 0x04 ) {
V_66 = F_68 ( & V_11 -> V_22 . V_86 , & V_126 ) ;
if ( V_66 )
goto V_127;
}
if ( V_2 -> V_48 == V_49 ) {
V_66 = F_69 ( & V_11 -> V_22 , & V_128 ) ;
if ( V_66 )
goto V_127;
...
F_73 ( & V_11 -> V_22 . V_86 , & V_126 ) ;
if ( V_2 -> V_48 == V_49 ) {
F_74 ( & V_11 -> V_22 , & V_128 ) ;
F_73 ( & V_11 -> V_22 . V_86 , & V_129 ) ;
}
V_125:
F_75 ( V_2 ) ;
exit:
