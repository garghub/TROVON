...
struct V_265 * V_266 )
{
strncpy ( V_266 -> V_267 , L_17 , sizeof( V_266 -> V_267 ) - 1 ) ;
strncpy ( V_266 -> V_268 , L_18 , sizeof( V_266 -> V_268 ) - 1 ) ;
strncpy ( V_266 -> V_269 , L_19 , sizeof( V_266 -> V_269 ) - 1 ) ;
strncpy ( V_266 -> V_270 , L_19 , sizeof( V_266 -> V_270 ) - 1 ) ;
}
...
static int
F_96 ( struct V_1 * V_2 , struct V_271 * V_272 )
{
struct V_3 * V_4 = F_5 ( V_2 ) ;
F_14 ( & V_4 -> V_25 ) ;
switch( V_272 -> V_273 ) {
...
static void
F_102 ( struct V_1 * V_321 )
{
V_101 ( V_103 , V_321 , NULL ) ;
}
static int
F_103 ( void )
{
