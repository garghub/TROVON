...
V_2 -> V_116 = V_116 ;
V_2 -> V_4 = F_34 ( V_116 -> V_41 , F_35 ( V_116 ) ) ;
if ( ! V_2 -> V_4 ) {
V_72 = - V_121 ;
goto V_119;
}
strcpy ( V_9 -> V_27 . V_122 , V_113 -> V_123 ) ;
V_9 -> V_124 = & V_125 ;
V_9 -> V_27 . type = V_126 ;
V_9 -> V_27 . V_127 = V_128 ;
V_9 -> V_16 . V_129 = V_130 ;
