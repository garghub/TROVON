...
static int F_73 ( struct V_133 * V_13 , char * V_149 )
{
F_18 () ;
if ( ! V_149 || ! * V_149 )
return 0 ;
...
* V_151 = 0 ;
V_73 = F_75 ( V_151 + 1 , & V_150 , 0 ) ;
if ( F_10 ( * V_150 != ',' && * V_150 != 0 ) ) {
F_74 ( L_7 , V_149 , V_151 + 1 ) ;
return - V_46 ;
}
switch ( V_151 - V_149 ) {
case 5 :
...
static struct V_126 *
F_76 ( struct V_156 * V_157 , int V_50 ,
...
if ( F_10 ( V_16 < 0 ) )
return F_78 ( V_16 ) ;
V_16 = F_73 ( & V_13 , V_149 ) ;
if ( F_10 ( V_16 < 0 ) )
return F_78 ( V_16 ) ;
V_13 . V_135 = V_135 ;
return F_79 ( V_157 , V_50 , & V_13 , F_70 ) ;
}
static void
F_80 ( struct V_102 * V_103 )
{
F_18 () ;
F_81 ( V_103 ) ;
if ( V_103 -> V_128 )
...
{
F_18 () ;
if ( F_10 ( F_89 ( & V_10 -> V_159 ) ) ) {
F_24 ( L_17 , V_161 ) ;
F_90 ( V_10 ) ;
F_91 ( F_92 ( & V_10 -> V_18 . V_21 ) ||
F_92 ( & V_10 -> V_12 . V_92 ) ) ;
F_33 ( V_10 ) ;
}
}
...
{
F_18 () ;
if ( F_99 ( V_49 , & V_10 -> V_50 ) )
F_100 ( V_10 ) ;
F_91 ( V_10 -> V_25 ) ;
if ( V_10 -> V_162 )
F_101 ( V_10 -> V_162 , V_10 -> V_163 ) ;
F_33 ( V_10 -> V_164 ) ;
F_33 ( V_10 -> V_165 ) ;
F_33 ( V_10 -> V_166 ) ;
}
...
static int F_102 ( struct V_9 * V_10 , struct V_173 * V_174 )
{
struct V_175 * * V_176 ;
int V_177 ;
F_18 () ;
if ( F_49 ( V_10 -> V_43 != V_48
|| F_103 ( V_178 , & V_10 -> V_50 ) ) )
return - V_55 ;
V_177 = F_104 ( V_174 , V_10 -> V_171 ) ;
if ( F_10 ( V_177 < 0 ) )
return V_177 ;
V_10 -> V_15 = F_105 ( V_174 -> V_25 -> V_26 , V_67 ) ;
if ( F_10 ( ! V_10 -> V_15 ) )
return - V_68 ;
V_10 -> V_15 -> F_47 = F_3 ;
V_10 -> V_15 -> V_11 = V_10 ;
...
F_18 () ;
if ( ! F_49 ( ! V_10 -> V_25 ) ) {
F_107 ( V_10 -> V_25 -> V_26 , V_10 -> V_15 ) ;
V_10 -> V_15 = NULL ;
V_10 -> V_25 = NULL ;
F_82 ( V_10 ) ;
F_108 ( V_178 , & V_10 -> V_50 ) ;
}
}
...
F_18 () ;
V_63 = V_10 -> V_163 ;
V_162 = F_109 ( V_63 , sizeof( * V_162 ) , V_67 ) ;
if ( ! V_162 )
return - V_68 ;
V_88 = V_162 ;
...
static void F_101 ( struct V_87 * V_162 , unsigned V_63 )
{
struct V_87 * V_88 = V_162 ;
F_18 () ;
for (; V_63 ; -- V_63 , ++ V_88 ) {
F_91 ( F_110 ( & V_88 -> V_40 ) ||
F_92 ( & V_88 -> V_92 ) ) ;
if ( V_88 -> V_126 ) {
F_111 ( V_88 -> V_126 ) ;
F_68 ( V_88 -> V_126 ) ;
...
V_76 -> V_10 = V_10 ;
F_87 ( V_10 ) ;
V_16 = F_113 ( V_186 , & V_76 -> V_4 ) ;
if ( F_10 ( V_16 ) )
F_114 ( V_76 ) ;
return V_16 ;
}
static void F_114 ( struct V_1 * V_76 )
{
F_18 () ;
F_82 ( V_76 -> V_10 ) ;
F_33 ( V_76 -> V_201 ) ;
...
static int F_119 ( struct V_1 * V_76 )
{
...
if ( F_38 ( ! V_16 ) ) {
V_88 -> V_6 = V_6 ;
V_88 -> V_93 = F_121 ( V_203 ) ;
V_88 -> V_94 = F_122 ( V_203 ) ;
} else {
break;
}
F_123 ( & V_88 -> V_92 ) ;
...
static int T_5 F_124 ( char * V_13 , unsigned V_14 ,
...
#define F_125 ( T_8 ) 1
#define F_126 ( T_8 ) (val)
#define F_127 ( T_8 ) ((val) & USB_ENDPOINT_NUMBER_MASK)
#define F_128 ( type , T_8 ) do { \
...
goto V_218;
F_128 ( V_219 , V_203 -> V_220 ) ;
if ( V_203 -> V_221 )
F_128 ( STRING , V_203 -> V_221 ) ;
}
break;
case V_222 : {
...
static int T_5 F_129 ( unsigned V_63 , char * V_13 , unsigned V_14 ,
T_6 V_206 , void * V_207 )
{
...
if ( ! V_13 )
return V_238 - V_14 ;
V_16 = F_124 ( V_13 , V_14 , V_206 , V_207 ) ;
if ( F_10 ( V_16 < 0 ) ) {
...
static int F_130 ( enum V_240 type ,
...
if ( F_10 ( V_14 < 3 ) )
goto V_258;
V_157 -> V_259 = F_132 ( V_13 ) ;
V_157 -> V_181 = V_183 ;
++ V_157 ;
V_13 += 2 ;
V_14 -= 2 ;
do {
T_1 V_24 = F_133 ( V_13 , V_14 ) ;
if ( F_10 ( V_24 == V_14 ) )
goto V_258;
if ( F_38 ( V_257 ) ) {
V_183 -> V_183 = V_13 ;
...
F_136 ( & V_10 -> V_18 . V_21 ) ;
}
static void F_137 ( struct V_9 * V_10 ,
enum V_260 type )
{
unsigned long V_50 ;
F_116 ( & V_10 -> V_18 . V_21 . V_22 , V_50 ) ;
F_134 ( V_10 , type ) ;
F_118 ( & V_10 -> V_18 . V_21 . V_22 , V_50 ) ;
}
static int F_138 ( enum V_240 type , T_7 * V_241 ,
struct V_208 * V_205 ,
void * V_207 )
{
...
F_139 ( L_38 , V_203 , V_203 -> V_210 ) ;
return 0 ;
}
static int F_141 ( enum V_240 type , T_7 * V_241 ,
struct V_208 * V_205 ,
void * V_207 )
{
struct V_1 * V_76 = V_207 ;
...
int V_182 = F_142 ( V_76 -> V_200 , & V_76 -> V_4 ) ;
if ( F_10 ( V_182 < 0 ) )
return V_182 ;
...
const int V_281 = F_143 ( V_76 -> V_25 ) &&
V_76 -> V_10 -> V_170 ;
int V_16 ;
struct {
...
break;
case V_295 :
V_16 = F_144 ( V_76 , F_6 ( V_289 -> V_292 ) ) ;
if ( F_10 ( V_16 < 0 ) )
return V_16 ;
break;
default:
...
V_10 -> V_18 . V_19 . V_292 = F_145 ( V_16 ) ;
F_134 ( V_10 , V_61 ) ;
F_118 ( & V_10 -> V_18 . V_21 . V_22 , V_50 ) ;
return 0 ;
}
...
{
F_18 () ;
F_137 ( F_1 ( V_3 ) -> V_10 , V_265 ) ;
}
static void V_199 ( struct V_2 * V_3 )
{
F_18 () ;
F_137 ( F_1 ( V_3 ) -> V_10 , V_264 ) ;
}
static int F_144 ( struct V_1 * V_76 , T_7 V_101 )
{
