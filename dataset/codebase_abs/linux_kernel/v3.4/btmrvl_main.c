...
if ( V_11 ) {
if ( F_22 ( V_2 , V_11 ) )
V_2 -> V_23 . V_60 -> V_89 . V_104 ++ ;
else
V_2 -> V_23 . V_60 -> V_89 . V_105 += V_11 -> V_74 ;
F_8 ( V_11 ) ;
}
}
return 0 ;
...
V_2 -> V_3 = F_63 ( sizeof( * V_2 -> V_3 ) , V_117 ) ;
if ( ! V_2 -> V_3 ) {
F_11 ( L_40 ) ;
goto V_119;
}
...
F_64 ( & V_2 -> V_102 ) ;
F_28 ( & V_2 -> V_8 . V_9 ) ;
V_2 -> V_8 . V_115 = F_65 ( F_43 ,
& V_2 -> V_8 , L_42 ) ;
V_2 -> V_23 . V_116 = V_116 ;
V_2 -> V_23 . V_100 = true ;
return V_2 ;
V_119:
F_31 ( V_2 ) ;
