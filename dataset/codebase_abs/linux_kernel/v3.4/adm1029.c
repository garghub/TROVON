...
struct V_8 * V_9 ;
int V_40 ;
V_9 = F_22 ( sizeof( struct V_8 ) , V_41 ) ;
if ( ! V_9 ) {
V_40 = - V_42 ;
goto exit;
}
...
V_40 = F_26 ( & V_17 -> V_2 . V_44 , & V_45 ) ;
if ( V_40 )
goto V_43;
V_9 -> V_46 = F_27 ( & V_17 -> V_2 ) ;
if ( F_28 ( V_9 -> V_46 ) ) {
V_40 = F_29 ( V_9 -> V_46 ) ;
goto V_47;
}
...
struct V_8 * V_9 = F_10 ( V_17 ) ;
F_12 ( & V_9 -> V_20 ) ;
if ( F_34 ( V_50 , V_9 -> V_51 + V_52 * 2 )
|| ! V_9 -> V_53 ) {
int V_54 ;
F_35 ( & V_17 -> V_2 , L_9 ) ;
for ( V_54 = 0 ; V_54 < F_36 ( V_55 ) ; V_54 ++ ) {
V_9 -> V_10 [ V_54 ] =
F_13 ( V_17 ,
V_55 [ V_54 ] ) ;
}
for ( V_54 = 0 ; V_54 < F_36 ( V_56 ) ; V_54 ++ ) {
V_9 -> V_13 [ V_54 ] =
F_13 ( V_17 ,
V_56 [ V_54 ] ) ;
}
for ( V_54 = 0 ; V_54 < F_36 ( V_21 ) ; V_54 ++ ) {
V_9 -> V_14 [ V_54 ] =
F_13 ( V_17 ,
V_21 [ V_54 ] ) ;
}
