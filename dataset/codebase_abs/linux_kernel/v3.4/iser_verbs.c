...
static
struct V_11 * F_34 ( struct V_86 * V_83 )
{
struct V_11 * V_7 ;
F_35 ( & V_87 . V_88 ) ;
F_36 (device, &ig.device_list, ig_list)
if ( V_7 -> V_13 -> V_89 == V_83 -> V_7 -> V_89 )
goto V_90;
V_7 = F_37 ( sizeof *V_7 , V_46 ) ;
if ( V_7 == NULL )
goto V_91;
V_7 -> V_13 = V_83 -> V_7 ;
if ( F_5 ( V_7 ) ) {
...
static void F_40 ( struct V_11 * V_7 )
{
F_35 ( & V_87 . V_88 ) ;
V_7 -> V_94 -- ;
...
static void F_45 ( struct V_33 * V_34 , int V_85 )
{
...
void F_48 ( struct V_33 * V_34 )
{
F_49 ( & V_34 -> V_94 ) ;
}
int F_50 ( struct V_33 * V_34 , int V_85 )
{
if ( F_51 ( & V_34 -> V_94 ) ) {
F_45 ( V_34 , V_85 ) ;
return 1 ;
...
{
int V_104 = 0 ;
F_42 ( V_34 , V_105 , V_106 ) ;
V_104 = F_53 ( V_34 -> V_83 ) ;
if ( V_104 )
F_2 ( L_9 ,
V_34 , V_104 ) ;
F_54 ( V_34 -> V_107 ,
...
static int F_55 ( struct V_86 * V_83 )
{
struct V_33 * V_34 ;
...
static int F_57 ( struct V_86 * V_83 )
{
struct V_11 * V_7 ;
struct V_33 * V_34 ;
int V_39 ;
...
static int F_59 ( struct V_86 * V_83 )
{
struct V_108 V_109 ;
int V_39 ;
...
static void F_61 ( struct V_86 * V_83 )
{
struct V_33 * V_34 ;
V_34 = (struct V_33 * ) V_83 -> V_3 ;
V_34 -> V_99 = V_105 ;
...
static int F_62 ( struct V_86 * V_83 )
{
struct V_33 * V_34 ;
int V_39 ;
V_34 = (struct V_33 * ) V_83 -> V_3 ;
...
static int F_65 ( struct V_86 * V_83 , struct V_119 * V_4 )
{
int V_39 = 0 ;
F_2 ( L_13 ,
...
V_104 = F_73 ( V_34 -> V_83 , V_138 , V_139 , 1000 ) ;
if ( V_104 ) {
F_2 ( L_18 , V_104 ) ;
goto V_146;
}
...
void F_77 ( struct V_150 * V_167 )
{
int V_39 ;
F_76 ( L_23 , V_167 -> V_164 ) ;
V_39 = F_78 ( (struct V_152 * ) V_167 -> V_164 ) ;
if ( V_39 )
F_2 ( L_24 , V_39 ) ;
V_167 -> V_164 = NULL ;
}
int F_79 ( struct V_33 * V_34 )
{
...
V_169 . V_178 = NULL ;
V_34 -> V_117 ++ ;
V_173 = F_80 ( V_34 -> V_84 , & V_169 , & V_170 ) ;
if ( V_173 ) {
F_2 ( L_25 , V_173 ) ;
V_34 -> V_117 -- ;
}
...
int F_81 ( struct V_33 * V_34 , int V_179 )
{
struct V_168 * V_169 , * V_170 ;
int V_180 , V_173 ;
...
V_169 -> V_178 = NULL ;
V_34 -> V_117 += V_179 ;
V_173 = F_80 ( V_34 -> V_84 , V_34 -> V_169 , & V_170 ) ;
if ( V_173 ) {
F_2 ( L_25 , V_173 ) ;
V_34 -> V_117 -= V_179 ;
} else
...
int F_82 ( struct V_33 * V_34 , struct V_187 * V_188 )
{
int V_173 ;
...
V_190 . V_197 = V_198 ;
F_49 ( & V_34 -> V_118 ) ;
V_173 = F_84 ( V_34 -> V_84 , & V_190 , & V_191 ) ;
if ( V_173 ) {
F_2 ( L_26 , V_173 ) ;
F_85 ( & V_34 -> V_118 ) ;
}
...
static void F_86 ( struct V_187 * V_199 ,
struct V_33 * V_34 )
{
if ( V_199 && V_199 -> type == V_200 )
F_87 ( V_87 . V_201 , V_199 ) ;
if ( V_34 -> V_117 == 0 &&
F_64 ( & V_34 -> V_118 ) == 0 ) {
if ( F_42 ( V_34 , V_105 ,
V_106 ) )
...
static int F_88 ( struct V_11 * V_7 )
{
