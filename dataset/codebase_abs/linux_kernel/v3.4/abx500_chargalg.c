...
static int T_4 F_57 ( struct V_226 * V_227 )
{
struct V_2 * V_3 = F_54 ( V_227 ) ;
F_49 ( V_3 ) ;
F_58 ( V_3 -> V_7 ) ;
...
static int T_5 F_63 ( struct V_226 * V_227 )
{
struct V_228 * V_229 ;
int V_111 = 0 ;
struct V_2 * V_3 =
F_64 ( sizeof( struct V_2 ) , V_230 ) ;
if ( ! V_3 )
return - V_231 ;
V_3 -> V_4 = & V_227 -> V_4 ;
V_229 = V_227 -> V_4 . V_232 ;
V_3 -> V_233 = V_229 -> V_234 ;
V_3 -> V_30 = V_229 -> V_235 ;
V_3 -> V_58 . V_123 = L_37 ;
V_3 -> V_58 . type = V_132 ;
V_3 -> V_58 . V_127 = V_236 ;
V_3 -> V_58 . V_124 = F_65 ( V_236 ) ;
V_3 -> V_58 . V_130 = F_45 ;
V_3 -> V_58 . V_122 = V_3 -> V_233 -> V_122 ;
V_3 -> V_58 . V_121 = V_3 -> V_233 -> V_121 ;
V_3 -> V_58 . V_237 =
F_38 ;
F_66 ( & V_3 -> V_34 ) ;
V_3 -> V_34 . V_238 = F_1 ;
