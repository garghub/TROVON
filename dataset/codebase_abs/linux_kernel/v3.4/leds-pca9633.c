...
V_25 = V_6 -> V_28 . V_29 ;
if ( V_25 ) {
if ( V_25 -> V_30 <= 0 || V_25 -> V_30 > 4 ) {
F_8 ( & V_6 -> V_28 , L_1 ) ;
return - V_31 ;
}
}
V_4 = F_9 ( 4 , sizeof( * V_4 ) , V_32 ) ;
if ( ! V_4 )
return - V_33 ;
F_10 ( V_6 , V_4 ) ;
...
V_4 [ V_26 ] . V_6 = V_6 ;
V_4 [ V_26 ] . V_9 = V_26 ;
if ( V_25 && V_26 < V_25 -> V_30 ) {
if ( V_25 -> V_34 [ V_26 ] . V_35 )
snprintf ( V_4 [ V_26 ] . V_35 ,
sizeof( V_4 [ V_26 ] . V_35 ) , L_2 ,
V_25 -> V_34 [ V_26 ] . V_35 ) ;
if ( V_25 -> V_34 [ V_26 ] . V_36 )
V_4 [ V_26 ] . V_18 . V_36 =
V_25 -> V_34 [ V_26 ] . V_36 ;
} else {
...
static int T_3 F_16 ( struct V_21 * V_6 )
{
struct V_3 * V_4 = F_17 ( V_6 ) ;
int V_26 ;
for ( V_26 = 0 ; V_26 < 4 ; V_26 ++ ) {
F_13 ( & V_4 [ V_26 ] . V_18 ) ;
F_14 ( & V_4 [ V_26 ] . V_2 ) ;
