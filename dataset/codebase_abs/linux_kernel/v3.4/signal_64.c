...
return V_14 ;
F_47 ( V_103 , V_132 ) ;
F_48 ( V_132 , V_113 , V_103 , V_2 , 0 ) ;
return 0 ;
}
static inline void F_49 ( unsigned long V_134 , struct V_1 * V_2 ,
struct V_135 * V_106 )
{
switch ( V_2 -> V_5 [ V_6 ] ) {
case V_136 :
...
V_137:
V_2 -> V_5 [ V_6 ] = V_138 ;
V_2 -> V_10 |= ( V_139 | V_140 ) ;
break;
case V_141 :
if ( ! ( V_106 -> V_107 & V_142 ) )
goto V_137;
case V_143 :
V_2 -> V_5 [ V_6 ] = V_134 ;
V_2 -> V_27 -= 4 ;
...
static void F_50 ( struct V_1 * V_2 , unsigned long V_134 )
{
struct V_102 V_103 ;
int V_144 ;
T_4 * V_112 ;
...
#ifdef F_52
if ( F_9 ( V_26 ) ) {
extern void V_147 ( T_4 * , struct V_1 * ) ;
V_147 ( V_112 , V_2 ) ;
return;
}
#endif
V_132 = F_53 ( & V_113 , & V_103 , V_2 , NULL ) ;
V_144 = 0 ;
if ( F_51 ( V_2 ) &&
( V_2 -> V_10 & ( V_140 | V_139 ) ) ) {
V_144 = 1 ;
...
void F_54 ( struct V_1 * V_2 , unsigned long V_134 , unsigned long V_149 )
{
if ( V_149 & V_150 )
F_50 ( V_2 , V_134 ) ;
if ( V_149 & V_151 ) {
