...
continue;
V_11 = F_12 ( * V_33 ) ;
if ( ! V_11 || V_11 -> V_19 != & V_39 )
continue;
V_3 = F_13 ( V_11 -> V_40 -> V_41 ) -> V_42 ;
if ( V_3 -> V_43 & V_44 )
continue;
break;
}
...
V_28 = V_9 [ V_27 ] . V_5 ;
sprintf ( V_31 , L_2 , V_26 , V_30 ) ;
V_48 . V_51 = strlen ( V_31 ) + 1 ;
V_48 . V_52 = V_28 ;
V_48 . V_53 = V_54 ;
V_24 = F_3 ( V_11 , & V_48 , sizeof( V_48 ) , V_14 ) ;
if ( V_24 )
goto V_55;
V_24 = F_3 ( V_11 , V_31 , V_48 . V_51 , V_14 ) ;
if ( V_24 )
goto V_55;
...
goto V_55;
do {
V_46 = F_1 ( V_27 , V_3 , V_22 , V_47 , & V_45 ) ;
if ( V_46 > 0 ) {
V_24 = F_3 ( V_11 , V_22 , V_46 , V_14 ) ;
if ( V_24 )
goto V_55;
V_29 += V_46 ;
}
} while ( V_46 == V_47 && V_29 < V_28 );
if ( V_46 < 0 ) {
V_24 = V_46 ;
goto V_55;
}
...
if ( V_24 )
return V_24 ;
for ( V_56 = 0 ; V_9 [ V_56 ] . V_30 != NULL ; V_56 ++ ) {
V_24 = F_17 ( V_3 , V_56 , V_11 , V_33 , V_14 ) ;
if ( V_24 ) {
F_16 ( V_3 ) ;
return V_24 ;
}
