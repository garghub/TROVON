...
static struct V_16 * T_6 F_13 ( void )
{
return F_14 ( sizeof( struct V_16 ) , V_39 ) ;
}
static T_3 T_6 F_15 ( char * V_40 )
{
int V_41 ;
T_3 V_22 ;
T_7 * V_42 ;
...
static int T_6 F_17 ( char * V_40 , T_2 * V_46 ,
struct V_14 * V_15 )
{
...
static int T_6 F_21 ( char * V_40 , T_2 * V_46 ,
struct V_14 * V_15 )
{
int V_41 , V_47 = 0 , V_48 = 0 ;
char * V_12 ;
...
static void T_6 F_24 ( char * V_40 ,
struct V_14 * V_15 )
{
T_4 V_70 ;
T_7 * V_42 ;
...
{
unsigned char V_75 [ V_89 ] ;
T_3 V_73 ;
int V_48 = 0 ;
V_73 = V_74 ;
V_48 = F_6 ( V_75 , V_89 , & V_73 , 0 ) ;
if ( V_48 < 0 )
return V_48 ;
...
void F_35 ( void )
{
struct V_14 * V_93 , * V_38 ;
if ( V_90 ) {
F_36 ( V_90 -> V_94 , V_90 -> V_95 ) ;
V_90 = NULL ;
}
F_37 (pos, next, &vmcore_list) {
struct V_16 * V_18 ;
V_18 = F_12 ( V_93 , struct V_16 , V_37 ) ;
F_38 ( & V_18 -> V_37 ) ;
F_19 ( V_18 ) ;
}
F_19 ( V_32 ) ;
