...
static int T_6 F_29 ( struct V_83 * V_84 )
{
...
return F_33 ( V_10 ) ;
V_18 = F_10 ( V_10 ) ;
V_19 = F_34 ( sizeof( struct V_1 ) , V_97 ) ;
if ( ! V_19 ) {
V_95 = - V_98 ;
goto V_99;
}
...
V_18 -> V_20 = V_19 ;
V_71 = F_35 ( F_36 ( V_10 -> V_102 ) , NULL ) ;
if ( F_32 ( V_71 ) ) {
F_37 ( F_36 ( V_10 -> V_102 ) , L_6 ) ;
V_95 = F_33 ( V_71 ) ;
goto V_103;
}
F_38 ( V_71 ) ;
...
V_19 -> V_41 |= V_42 ;
if ( F_5 ( V_19 ) )
F_7 ( 0x08100810 , V_10 -> V_15 + V_108 ) ;
V_22 = & V_19 -> V_22 ;
if ( F_26 ( V_84 , V_22 ) < 0 ) {
if ( ! V_10 -> V_102 -> V_109 -> V_110 ) {
F_37 ( F_36 ( V_10 -> V_102 ) , L_7 ) ;
V_95 = - V_111 ;
goto V_112;
}
V_19 -> V_22 = * ( (struct V_21 * )
V_10 -> V_102 -> V_109 -> V_110 ) ;
}
if ( V_22 -> V_72 == V_73 ) {
V_95 = F_39 ( V_22 -> V_74 , V_113 , L_8 ) ;
if ( V_95 ) {
F_40 ( F_36 ( V_10 -> V_102 ) ,
L_9 ) ;
V_22 -> V_74 = - V_111 ;
}
} else {
...
switch ( V_22 -> V_34 ) {
case V_35 :
V_95 = F_39 ( V_22 -> V_24 , V_113 , L_10 ) ;
if ( V_95 ) {
F_37 ( F_36 ( V_10 -> V_102 ) ,
L_11 ) ;
goto V_114;
}
V_95 = F_41 ( F_42 ( V_22 -> V_24 ) , F_24 ,
V_115 | V_116 ,
F_43 ( V_10 -> V_102 ) , V_10 ) ;
if ( V_95 ) {
F_37 ( F_36 ( V_10 -> V_102 ) , L_12 ) ;
goto V_117;
}
case V_91 :
V_10 -> V_104 &= ~ V_118 ;
...
static int T_7 F_51 ( struct V_83 * V_84 )
{
struct V_9 * V_10 = F_52 ( V_84 ) ;
struct V_17 * V_18 = F_10 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
struct V_21 * V_22 = & V_19 -> V_22 ;
