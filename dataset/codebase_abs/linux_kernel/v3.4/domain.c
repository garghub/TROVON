...
V_69 -> V_104 = 0 ;
V_29:
error = F_42 ( V_16 , & V_22 , V_105 , V_106 , V_46 ,
V_19 , V_76 , V_24 . V_107 , V_77 , error ) ;
V_85:
F_40 ( V_16 ) ;
F_43 ( V_70 ) ;
return error ;
...
struct V_68 * V_109 = V_67 -> V_11 -> V_79 ;
if ( ( V_109 -> V_16 == V_16 ) ||
( F_8 ( V_109 -> V_16 ) ) )
return;
V_99 -> V_110 = 0 ;
F_48 ( V_16 , V_109 -> V_16 ) ;
}
void F_49 ( struct V_66 * V_67 )
{
return;
}
static char * F_50 ( const char * V_111 , const char * V_112 )
{
char * V_19 = F_51 ( strlen ( V_111 ) + strlen ( V_112 ) + 3 , V_105 ) ;
if ( V_19 )
sprintf ( V_19 , L_8 , V_111 , V_112 ) ;
return V_19 ;
}
int F_52 ( const char * V_113 [] , int V_114 , T_2 V_104 , bool V_115 )
{
...
if ( V_114 ) {
struct V_8 * V_119 ;
V_119 = F_54 ( V_16 ) ? V_16 -> V_120 : V_16 ;
for ( V_3 = 0 ; V_3 < V_114 && ! V_117 ; V_3 ++ )
V_117 = F_27 ( V_119 , V_113 [ V_3 ] ) ;
if ( ! V_117 ) {
if ( ! F_38 ( V_119 ) || V_115 ) {
if ( F_55 ( & V_119 -> V_35 . V_64 ) )
error = - V_121 ;
else
error = - V_91 ;
goto V_13;
}
V_19 = F_50 ( V_119 -> V_35 . V_61 , V_113 [ 0 ] ) ;
V_76 = V_19 ;
V_117 = F_39 ( V_16 , 1 ) ;
if ( ! V_117 ) {
V_77 = L_10 ;
...
V_29:
if ( ! V_115 )
error = F_42 ( V_16 , & V_22 , V_105 , V_124 , V_20 ,
V_19 , V_61 , 0 , V_77 , error ) ;
F_30 ( V_18 ) ;
F_40 ( V_76 ) ;
F_11 ( V_11 ) ;
return error ;
