...
static int F_70 ( struct V_2 * V_3 , struct V_183 * V_184 )
{
struct V_18 * V_19 ;
int V_72 ;
int V_154 ;
int V_185 ;
unsigned int V_30 ;
F_36 ( V_73 L_20 , V_3 -> V_186 ) ;
V_154 = F_71 ( V_3 , sizeof( struct V_187 ) ) ;
if ( V_154 < 0 )
return V_154 ;
F_72 ( & V_5 -> V_6 ) ;
V_154 = F_73 ( V_3 , V_184 -> V_172 [ 0 ] , V_184 -> V_172 [ 1 ] ) ;
if ( V_154 < 0 )
return V_154 ;
V_154 = F_74 ( V_5 -> V_8 ) ;
if ( V_154 < 0 ) {
...
F_75 ( V_3 , & V_5 -> V_8 -> V_188 -> V_3 ) ;
V_5 -> V_9 = F_76 ( V_5 -> V_8 ) ;
if ( V_5 -> V_9 == NULL )
return - V_189 ;
V_3 -> V_190 = V_191 -> V_192 ;
V_30 = F_77 ( V_5 -> V_8 ) ;
F_36 ( V_73 L_10 , V_3 -> V_190 ) ;
if ( V_191 -> V_193 ) {
V_154 = F_68 ( V_3 , V_184 -> V_172 ) ;
if ( V_154 < 0 )
return V_154 ;
}
if ( ! V_191 -> V_194 )
...
V_185 = 1 ;
V_154 = F_78 ( V_3 , V_185 ) ;
if ( V_154 < 0 )
return V_154 ;
if ( ! V_191 -> V_194 ) {
for ( V_72 = 0 ; V_72 < V_191 -> V_195 ; V_72 ++ ) {
F_79 ( V_3 , V_3 -> V_32 + V_72 ,
F_15 ,
...
F_31 ( 0 , V_5 -> V_8 -> V_13 + F_81 ( 0 ) ) ;
F_9 ( 0x00 ,
V_5 -> V_8 -> V_13 +
V_54 ) ;
V_154 = F_82 ( V_30 , F_24 , V_219 ,
L_23 , V_3 ) ;
if ( V_154 < 0 )
F_36 ( V_162 L_24 ) ;
V_3 -> V_30 = V_30 ;
...
static int F_73 ( struct V_2 * V_3 , int V_220 , int V_221 )
{
struct V_34 * V_8 ;
int V_72 ;
for ( V_8 = V_222 ; V_8 ; V_8 = V_8 -> V_223 ) {
if ( V_8 -> V_224 )
continue;
if ( V_220 || V_221 ) {
if ( V_220 != V_8 -> V_188 -> V_220 -> V_225 ||
V_221 != F_88 ( V_8 -> V_188 -> V_226 ) )
continue;
}
for ( V_72 = 0 ; V_72 < V_227 ; V_72 ++ ) {
if ( F_89 ( V_8 ) == V_228 [ V_72 ] . V_229 ) {
V_3 -> V_230 = V_228 + V_72 ;
V_5 -> V_8 = V_8 ;
return 0 ;
}
}
