...
void F_64 ( long V_118 , unsigned long V_123 ,
unsigned long * V_124 )
{
unsigned long V_29 ;
unsigned int * V_119 ;
...
goto V_122;
( * V_119 ) ++ ;
F_65 ( V_118 , V_123 , V_124 ) ;
F_66 () ;
( * V_119 ) -- ;
V_122:
F_63 ( V_29 ) ;
}
int F_67 ( struct V_125 * V_126 )
{
int V_77 ;
unsigned long V_124 [ V_127 ] ;
V_77 = F_44 ( V_128 , V_124 ) ;
V_126 -> V_129 = V_124 [ 0 ] ;
V_126 -> V_130 = V_124 [ 1 ] ;
V_126 -> V_131 = ( V_124 [ 2 ] >> 2 * 8 ) & 0xffff ;
V_126 -> V_132 = V_124 [ 2 ] & 0xffff ;
V_126 -> V_133 = ( V_124 [ 3 ] >> 7 * 8 ) & 0xff ;
V_126 -> V_134 = ( V_124 [ 3 ] >> 6 * 8 ) & 0xff ;
V_126 -> V_135 = V_124 [ 3 ] & 0xffffffffffff ;
V_126 -> V_136 = V_124 [ 4 ] ;
V_126 -> V_137 = V_124 [ 5 ] ;
V_126 -> V_138 = V_124 [ 6 ] ;
return V_77 ;
}
int F_68 ( struct V_139 * V_140 )
{
int V_77 ;
unsigned long V_124 [ V_127 ] = { 0 } ;
V_77 = F_44 ( V_141 , V_124 ) ;
V_140 -> V_142 = V_124 [ 0 ] ;
V_140 -> V_143 = V_124 [ 1 ] ;
V_140 -> V_144 = V_124 [ 2 ] ;
V_140 -> V_145 = V_124 [ 3 ] ;
