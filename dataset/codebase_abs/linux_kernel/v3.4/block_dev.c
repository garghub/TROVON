...
struct V_53 * V_53 = V_48 -> V_54 ;
T_3 V_71 ;
F_157 ( V_48 -> V_216 != V_65 ) ;
V_71 = F_173 ( V_48 , V_50 , V_52 , & V_48 -> V_216 ) ;
if ( V_71 > 0 || V_71 == - V_217 ) {
T_3 V_108 ;
V_108 = F_174 ( V_53 , V_65 , V_71 ) ;
if ( V_108 < 0 && V_71 > 0 )
V_71 = V_108 ;
}
return V_71 ;
...
{
struct V_30 * V_218 = F_1 ( V_62 -> V_23 -> V_56 ) -> V_5 . V_122 ;
if ( V_218 && V_218 -> V_219 -> V_220 )
return V_218 -> V_219 -> V_220 ( V_218 , V_62 , V_57 ) ;
return F_176 ( V_62 ) ;
}
int F_177 ( struct V_4 * V_5 , unsigned V_214 , unsigned long V_215 )
{
int V_58 ;
T_9 V_221 = F_178 () ;
F_179 ( V_222 ) ;
...
struct V_4 * F_163 ( const char * V_223 )
{
struct V_4 * V_5 ;
struct V_2 * V_2 ;
struct V_201 V_201 ;
...
if ( ! V_223 || ! * V_223 )
return F_45 ( - V_27 ) ;
error = F_180 ( V_223 , V_224 , & V_201 ) ;
if ( error )
return F_45 ( error ) ;
V_2 = V_201 . V_101 -> V_225 ;
error = - V_226 ;
if ( ! F_181 ( V_2 -> V_125 ) )
goto V_227;
error = - V_202 ;
