...
int F_11 ( struct V_1 * V_2 , char * V_3 , int V_4 , T_1 V_5 ,
int V_6 )
{
int V_13 ;
if ( ! V_2 )
...
int F_12 ( struct V_1 * V_2 , int V_4 , int V_16 )
{
struct V_7 * V_8 = F_2 ( V_2 , struct V_7 , V_2 ) ;
if ( ! V_2 )
return - V_17 ;
