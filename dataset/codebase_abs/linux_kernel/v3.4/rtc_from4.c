...
T_3 * V_43 ;
int V_42 ;
V_13 -> V_25 ( V_2 , V_65 , - 1 , - 1 ) ;
if ( V_59 == V_66 ) {
for ( V_42 = 0 ; V_42 < 4 ; V_42 ++ ) {
if ( ! ( V_19 & 1 << ( V_42 + 1 ) ) )
continue;
V_13 -> V_25 ( V_2 , ( V_67 + V_42 + 1 ) ,
- 1 , - 1 ) ;
V_62 = V_13 -> V_68 ( V_2 ) ;
V_13 -> V_25 ( V_2 , V_69 , - 1 , - 1 ) ;
if ( ! ( V_62 & V_70 ) )
V_61 |= 1 << ( V_42 + 1 ) ;
}
} else if ( V_59 == V_71 ) {
unsigned long V_72 = V_2 -> V_73 . V_72 ;
V_13 -> V_25 ( V_2 , V_67 , - 1 , - 1 ) ;
V_62 = V_13 -> V_68 ( V_2 ) ;
V_13 -> V_25 ( V_2 , V_69 , - 1 , - 1 ) ;
if ( ! ( V_62 & V_70 ) ) {
V_61 |= 1 << 1 ;
...
V_62 = F_16 ( V_2 , V_60 , V_64 , & V_63 , V_43 ) ;
if ( V_62 || ( V_2 -> V_73 . V_72 - V_72 ) > 1 )
V_61 |= 1 << 1 ;
F_17 ( V_43 ) ;
}
V_74:
...
{
struct V_5 * V_13 ;
unsigned short V_78 , V_79 , V_80 ;
int V_42 ;
int V_81 ;
V_82 = F_15 ( sizeof( struct V_1 ) + sizeof( struct V_5 ) , V_76 ) ;
if ( ! V_82 ) {
F_19 ( L_3 ) ;
return - V_83 ;
}
V_13 = (struct V_5 * ) ( & V_82 [ 1 ] ) ;
memset ( V_82 , 0 , sizeof( struct V_1 ) ) ;
