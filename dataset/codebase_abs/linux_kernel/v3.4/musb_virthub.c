...
V_1 -> V_14 |= V_27 ;
V_1 -> V_28 = V_23 + F_8 ( 20 ) ;
}
}
static void F_11 ( struct V_1 * V_1 , bool V_29 )
{
T_1 V_6 ;
void T_2 * V_7 = V_1 -> V_8 ;
...
int F_17 ( struct V_48 * V_49 , char * V_50 )
{
struct V_1 * V_1 = F_18 ( V_49 ) ;
int V_51 = 0 ;
