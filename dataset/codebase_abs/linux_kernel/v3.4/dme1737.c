...
{
return F_3 ( ( V_4 < 0 ? V_4 - 500 : V_4 + 500 ) / 1000 ,
- 128 , 127 ) ;
}
...
int V_83 ;
V_18 = F_107 ( sizeof( struct V_17 ) , V_171 ) ;
if ( ! V_18 ) {
V_83 = - V_172 ;
goto exit;
}
...
V_18 -> V_175 = F_110 ( V_21 ) ;
if ( F_111 ( V_18 -> V_175 ) ) {
F_100 ( V_21 , L_42 ) ;
V_83 = F_112 ( V_18 -> V_175 ) ;
goto V_138;
}
return 0 ;
V_138:
...
static int T_6 F_116 ( int V_120 , unsigned short * V_22 )
{
int V_83 = 0 , V_1 ;
...
static int T_6 F_118 ( unsigned short V_22 )
{
struct V_181 V_3 = {
. V_182 = V_22 ,
. V_183 = V_22 + V_184 - 1 ,
...
if ( V_83 )
goto exit;
V_187 = F_120 ( L_36 , V_22 ) ;
if ( ! V_187 ) {
F_117 ( L_44 ) ;
V_83 = - V_172 ;
goto exit;
}
V_83 = F_121 ( V_187 , & V_3 , 1 ) ;
if ( V_83 ) {
F_117 ( L_45 , V_83 ) ;
goto V_188;
}
...
static int T_7 F_124 ( struct V_189 * V_187 )
{
T_1 V_159 , V_23 ;
struct V_181 * V_3 ;
struct V_17 * V_18 ;
struct V_23 * V_21 = & V_187 -> V_21 ;
int V_83 ;
V_3 = F_125 ( V_187 , V_186 , 0 ) ;
if ( ! F_126 ( V_3 -> V_182 , V_184 , L_36 ) ) {
F_100 ( V_21 , L_47 ,
...
F_113 ( V_18 ) ;
V_191:
F_128 ( V_3 -> V_182 , V_184 ) ;
exit:
return V_83 ;
}
static int T_8 F_129 ( struct V_189 * V_187 )
{
struct V_17 * V_18 = F_130 ( V_187 ) ;
F_115 ( V_18 -> V_175 ) ;
F_91 ( & V_187 -> V_21 ) ;
F_128 ( V_18 -> V_22 , V_184 ) ;
F_127 ( V_187 , NULL ) ;
F_113 ( V_18 ) ;
return 0 ;
}
