...
if ( V_33 -> V_100 != & V_101 )
return;
V_99 = V_22 -> V_102 - V_33 -> V_103 . V_104 ;
if ( F_90 ( ( T_3 ) V_99 < 0 ) )
V_99 = 0 ;
F_109 ( V_33 -> V_103 . V_105 . V_106 ,
F_110 ( V_33 -> V_103 . V_105 . V_106 , V_99 ) ) ;
V_33 -> V_103 . V_107 += V_99 ;
F_111 ( V_33 , V_99 ) ;
V_33 -> V_103 . V_104 = V_22 -> V_102 ;
F_112 ( V_33 , V_99 ) ;
F_113 ( V_22 , V_99 ) ;
if ( ! F_11 () )
return;
...
static void
F_115 ( struct V_21 * V_21 , int V_63 , int V_108 )
{
struct V_22 * V_22 = F_27 ( V_21 ) ;
if ( V_22 -> V_59 && V_63 < V_108 )
F_116 ( & V_22 -> V_57 -> V_109 , V_22 -> V_46 , V_63 ) ;
}
static void
F_117 ( struct V_21 * V_21 , int V_63 , int V_108 )
{
struct V_22 * V_22 = F_27 ( V_21 ) ;
if ( V_22 -> V_59 && V_21 -> V_32 . V_33 != V_108 )
F_116 ( & V_22 -> V_57 -> V_109 , V_22 -> V_46 , V_21 -> V_32 . V_33 ) ;
}
static inline
void F_115 ( struct V_21 * V_21 , int V_63 , int V_108 ) {}
static inline
void F_117 ( struct V_21 * V_21 , int V_63 , int V_108 ) {}
static void
F_118 ( struct V_21 * V_21 , int V_63 )
{
int V_108 = V_21 -> V_32 . V_33 ;
if ( V_63 < V_108 )
V_21 -> V_32 . V_33 = V_63 ;
F_115 ( V_21 , V_63 , V_108 ) ;
}
static void
...
{
F_120 ( ! F_125 ( F_103 ( V_42 ) ) ) ;
F_120 ( ! V_21 -> V_67 ) ;
V_21 -> V_67 -- ;
F_119 ( V_21 , F_103 ( V_42 ) ) ;
F_51 ( V_42 , V_21 ) ;
F_123 ( V_42 , V_21 ) ;
}
static void F_127 ( struct V_41 * V_42 , bool V_110 )
{
struct V_21 * V_21 = F_28 ( V_42 ) ;
struct V_23 * V_24 = & V_21 -> V_26 ;
struct V_21 * V_111 = F_72 ( V_42 ) ;
struct V_112 * V_28 = V_24 -> V_28 + F_103 ( V_42 ) ;
if ( V_111 && ( F_79 ( V_111 ) || ! V_111 -> V_67 ) )
return;
if ( ! V_21 -> V_67 )
F_68 ( V_21 ) ;
if ( V_110 )
...
{
struct V_41 * V_113 = NULL ;
F_114 (rt_se) {
V_42 -> V_113 = V_113 ;
V_113 = V_42 ;
}
for ( V_42 = V_113 ; V_42 ; V_42 = V_42 -> V_113 ) {
if ( F_60 ( V_42 ) )
F_130 ( V_42 ) ;
}
}
static void F_75 ( struct V_41 * V_42 , bool V_110 )
{
F_132 ( V_42 ) ;
F_114 (rt_se)
F_127 ( V_42 , V_110 ) ;
...
if ( V_80 & V_114 )
V_42 -> V_115 = 0 ;
F_75 ( V_42 , V_80 & V_116 ) ;
if ( ! F_134 ( V_22 , V_56 ) && V_56 -> V_43 . V_62 > 1 )
F_54 ( V_22 , V_56 ) ;
F_135 ( V_22 ) ;
}
...
static void
F_138 ( struct V_21 * V_21 , struct V_41 * V_42 , int V_110 )
{
if ( F_60 ( V_42 ) ) {
struct V_23 * V_24 = & V_21 -> V_26 ;
struct V_112 * V_28 = V_24 -> V_28 + F_103 ( V_42 ) ;
...
static void F_141 ( struct V_22 * V_22 , struct V_40 * V_56 , int V_110 )
{
struct V_41 * V_42 = & V_56 -> V_43 ;
struct V_21 * V_21 ;
F_114 (rt_se) {
V_21 = F_28 ( V_42 ) ;
F_138 ( V_21 , V_42 , V_110 ) ;
}
}
...
static int
F_143 ( struct V_40 * V_56 , int V_117 , int V_80 )
{
struct V_40 * V_33 ;
struct V_22 * V_22 ;
int V_46 ;
...
return;
if ( V_56 -> V_43 . V_62 != 1
&& F_151 ( & V_22 -> V_57 -> V_109 , V_56 , NULL ) )
return;
if ( ! F_151 ( & V_22 -> V_57 -> V_109 , V_22 -> V_33 , NULL ) )
return;
F_141 ( V_22 , V_56 , 1 ) ;
F_76 ( V_22 -> V_33 ) ;
}
...
struct V_112 * V_28 ;
int V_122 ;
V_122 = F_121 ( V_24 -> V_29 ) ;
F_93 ( V_122 >= V_27 ) ;
V_28 = V_24 -> V_28 + V_122 ;
...
if ( ! V_34 ) {
V_122 = F_166 ( V_24 -> V_29 , V_27 , V_122 + 1 ) ;
goto V_124;
}
}
return V_34 ;
}
static int F_148 ( struct V_40 * V_125 )
{
struct V_126 * V_127 ;
struct V_69 * V_128 = F_167 ( V_129 ) ;
int V_130 = F_82 () ;
int V_46 = F_144 ( V_125 ) ;
if ( F_90 ( ! V_128 ) )
return - 1 ;
if ( V_125 -> V_43 . V_62 == 1 )
return - 1 ;
if ( ! F_151 ( & F_39 ( V_125 ) -> V_57 -> V_109 , V_125 , V_128 ) )
return - 1 ;
if ( F_161 ( V_46 , V_128 ) )
return V_46 ;
if ( ! F_161 ( V_130 , V_128 ) )
V_130 = - 1 ;
F_145 () ;
F_168 (cpu, sd) {
if ( V_127 -> V_80 & V_131 ) {
...
static struct V_22 * F_172 ( struct V_40 * V_125 , struct V_22 * V_22 )
{
...
if ( V_133 -> V_43 . V_32 . V_33 > V_125 -> V_63 )
break;
F_174 ( V_22 , V_133 ) ;
V_133 = NULL ;
}
...
return 0 ;
#ifdef F_177
if ( F_90 ( F_160 ( V_22 , V_137 ) ) )
return 0 ;
#endif
V_139:
if ( F_90 ( V_137 == V_22 -> V_33 ) ) {
F_120 ( 1 ) ;
return 0 ;
}
if ( F_90 ( V_137 -> V_63 < V_22 -> V_33 -> V_63 ) ) {
F_76 ( V_22 -> V_33 ) ;
return 0 ;
}
F_178 ( V_137 ) ;
V_133 = F_172 ( V_137 , V_22 ) ;
if ( ! V_133 ) {
struct V_40 * V_125 ;
V_125 = F_175 ( V_22 ) ;
if ( F_144 ( V_137 ) == V_22 -> V_46 && V_125 == V_137 ) {
goto V_118;
}
if ( ! V_125 )
goto V_118;
...
static int F_184 ( struct V_22 * V_140 )
{
int V_130 = V_140 -> V_46 , V_138 = 0 , V_46 ;
struct V_40 * V_56 ;
struct V_22 * V_141 ;
if ( F_106 ( ! F_40 ( V_140 ) ) )
return 0 ;
...
continue;
V_141 = F_33 ( V_46 ) ;
if ( V_141 -> V_43 . V_32 . V_34 >=
V_140 -> V_43 . V_32 . V_33 )
continue;
F_173 ( V_140 , V_141 ) ;
if ( V_141 -> V_43 . V_67 <= 1 )
goto V_142;
V_56 = F_163 ( V_141 , V_130 ) ;
if ( V_56 && ( V_56 -> V_63 < V_140 -> V_43 . V_32 . V_33 ) ) {
F_120 ( V_56 == V_141 -> V_33 ) ;
F_120 ( ! V_56 -> V_136 ) ;
if ( V_56 -> V_63 < V_141 -> V_33 -> V_63 )
goto V_142;
V_138 = 1 ;
F_180 ( V_141 , V_56 , 0 ) ;
F_181 ( V_56 , V_130 ) ;
...
static void F_185 ( struct V_22 * V_22 , struct V_40 * V_143 )
{
if ( V_22 -> V_43 . V_32 . V_33 > V_143 -> V_63 )
F_184 ( V_22 ) ;
}
...
const struct V_69 * V_144 )
{
int V_73 = F_86 ( V_144 ) ;
F_93 ( ! F_147 ( V_56 ) ) ;
if ( V_56 -> V_136 && ( V_73 != V_56 -> V_43 . V_62 ) ) {
struct V_22 * V_22 = F_39 ( V_56 ) ;
if ( ! F_134 ( V_22 , V_56 ) ) {
if ( V_56 -> V_43 . V_62 > 1 )
F_58 ( V_22 , V_56 ) ;
...
F_42 ( V_22 ) ;
F_97 ( V_22 ) ;
F_116 ( & V_22 -> V_57 -> V_109 , V_22 -> V_46 , V_22 -> V_43 . V_32 . V_33 ) ;
}
...
F_46 ( V_22 ) ;
F_89 ( V_22 ) ;
F_116 ( & V_22 -> V_57 -> V_109 , V_22 -> V_46 , V_145 ) ;
}
static void F_191 ( struct V_22 * V_22 , struct V_40 * V_56 )
{
if ( V_56 -> V_136 && ! V_22 -> V_43 . V_67 )
F_184 ( V_22 ) ;
}
void F_192 ( void )
{
...
{
int V_146 = 1 ;
if ( V_56 -> V_136 && V_22 -> V_33 != V_56 ) {
#ifdef V_31
if ( V_22 -> V_43 . V_36 && F_176 ( V_22 ) &&
V_22 != F_39 ( V_56 ) )
V_146 = 0 ;
#endif
if ( V_146 && V_56 -> V_63 < V_22 -> V_33 -> V_63 )
F_76 ( V_22 -> V_33 ) ;
}
}
static void
F_196 ( struct V_22 * V_22 , struct V_40 * V_56 , int V_147 )
{
if ( ! V_56 -> V_136 )
return;
if ( V_22 -> V_33 == V_56 ) {
...
V_148 = F_198 ( V_56 , V_150 ) ;
V_149 = F_199 ( V_56 , V_150 ) ;
if ( V_148 != V_151 ) {
unsigned long V_34 ;
V_56 -> V_43 . V_115 ++ ;
V_34 = F_200 ( F_102 ( V_148 , V_149 ) , V_152 / V_153 ) ;
if ( V_56 -> V_43 . V_115 > V_34 )
V_56 -> V_154 . V_155 = V_56 -> V_103 . V_107 ;
}
}
static void F_201 ( struct V_22 * V_22 , struct V_40 * V_56 , int V_156 )
{
F_108 ( V_22 ) ;
F_197 ( V_22 , V_56 ) ;
if ( V_56 -> V_157 != V_158 )
...
if ( -- V_56 -> V_43 . V_159 )
return;
V_56 -> V_43 . V_159 = V_160 ;
if ( V_56 -> V_43 . V_50 . V_143 != V_56 -> V_43 . V_50 . V_34 ) {
F_141 ( V_22 , V_56 , 0 ) ;
F_202 ( V_56 ) ;
}
}
...
static unsigned int F_204 ( struct V_22 * V_22 , struct V_40 * V_125 )
{
if ( V_125 -> V_157 == V_158 )
return V_160 ;
else
return 0 ;
}
void F_205 ( struct V_161 * V_162 , int V_46 )
{
T_4 V_75 ;
struct V_21 * V_21 ;
F_145 () ;
F_91 (rt_rq, iter, cpu_rq(cpu))
F_206 ( V_162 , V_46 , V_21 ) ;
F_149 () ;
}
