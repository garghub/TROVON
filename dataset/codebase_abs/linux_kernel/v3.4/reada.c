...
V_52 -> V_59 ) ;
for ( V_103 = 0 ; V_103 < V_52 -> V_64 ; ++ V_103 ) {
F_15 ( V_106 L_8 ,
V_52 -> V_62 [ V_103 ] -> V_105 ) ;
}
if ( V_60 -> V_86 == V_52 )
F_15 ( V_106 L_9 ,
V_60 -> V_87 - V_52 -> V_5 ) ;
...
V_13 -> V_77 [ V_9 ] -> V_5 ,
V_13 -> V_77 [ V_9 ] -> V_55 ) ;
for ( V_103 = 0 ; V_103 < V_13 -> V_77 [ V_9 ] -> V_64 ; ++ V_103 ) {
F_15 ( V_106 L_8 ,
V_13 -> V_77 [ V_9 ] -> V_62 [ V_103 ] -> V_105 ) ;
}
}
F_15 ( V_106 L_10 ) ;
