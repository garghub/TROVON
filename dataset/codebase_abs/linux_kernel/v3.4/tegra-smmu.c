...
sizeof( V_13 -> V_71 [ 0 ] ) * V_84 , V_85 ) ;
if ( ! V_13 -> V_71 ) {
F_40 ( V_2 -> V_63 ,
L_4 ) ;
return - V_86 ;
}
V_13 -> V_32 = F_39 ( V_85 | V_87 ) ;
if ( ! V_13 -> V_32 ) {
F_40 ( V_2 -> V_63 ,
L_5 ) ;
...
static int F_52 ( struct V_90 * V_91 , unsigned long V_51 ,
T_4 V_92 , T_2 V_93 , int V_94 )
{
struct V_12 * V_13 = V_91 -> V_95 ;
unsigned long V_81 = F_53 ( V_92 ) ;
unsigned long V_20 ;
F_29 ( V_13 -> V_2 -> V_63 , L_6 , V_13 -> V_15 , V_51 , V_92 ) ;
if ( ! F_54 ( V_81 ) )
return - V_86 ;
F_15 ( & V_13 -> V_21 , V_20 ) ;
F_49 ( V_13 , V_51 , V_81 ) ;
...
static T_2 F_55 ( struct V_90 * V_91 , unsigned long V_51 ,
T_2 V_93 )
{
struct V_12 * V_13 = V_91 -> V_95 ;
unsigned long V_20 ;
...
static T_4 F_56 ( struct V_90 * V_91 ,
unsigned long V_51 )
{
struct V_12 * V_13 = V_91 -> V_95 ;
unsigned long * V_52 ;
...
T_1 V_9 ;
int V_99 ;
V_98 = F_47 ( V_2 -> V_63 , sizeof( * V_8 ) , V_85 ) ;
if ( ! V_98 )
return - V_86 ;
V_98 -> V_63 = V_63 ;
V_98 -> V_13 = V_13 ;
...
F_29 ( V_2 -> V_63 , L_11 , F_62 ( V_8 -> V_63 ) ) ;
return 0 ;
V_103:
F_67 ( V_98 ) ;
F_64 ( & V_13 -> V_102 ) ;
...
V_2 -> V_42 = 0 ;
V_2 -> V_13 = F_47 ( V_63 ,
sizeof( V_2 -> V_13 [ 0 ] ) * V_2 -> V_30 , V_85 ) ;
if ( ! V_2 -> V_13 ) {
F_40 ( V_63 , L_19 ) ;
V_99 = - V_86 ;
goto V_124;
