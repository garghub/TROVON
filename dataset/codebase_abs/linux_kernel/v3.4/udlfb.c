...
static void F_64 ( struct V_176 * V_177 )
{
struct V_178 * V_179 = F_61 ( V_177 , struct V_178 ,
V_180 . V_177 ) ;
F_65 ( & V_179 -> V_32 -> V_181 . V_182 ) ;
}
...
F_72 ( & V_32 -> V_172 , F_60 ) ;
}
static void F_73 ( struct V_176 * V_177 )
{
struct V_31 * V_32 = F_61 ( V_177 , struct V_31 ,
V_186 . V_177 ) ;
F_66 ( V_32 ) ;
}
...
if ( F_77 ( & V_40 -> V_183 . V_184 [ V_110 ] , V_40 ) )
F_92 ( & V_40 -> V_183 . V_184 [ V_110 ] ,
& V_40 -> V_185 ) ;
else {
if ( V_110 == 0 )
V_40 -> V_183 . V_212
...
return - V_57 ;
V_111 = F_89 ( V_32 , V_45 , V_228 , V_230 ) ;
if ( V_111 )
return V_111 ;
...
for ( V_110 = 0 ; V_110 < F_124 ( V_267 ) ; V_110 ++ ) {
V_33 = F_125 ( V_40 -> V_32 , & V_267 [ V_110 ] ) ;
if ( V_33 ) {
F_63 ( L_39 , V_33 ) ;
}
}
V_33 = F_126 ( V_40 -> V_32 , & V_268 ) ;
if ( V_33 ) {
F_63 ( L_40 , V_33 ) ;
}
F_78 ( L_41
...
if ( V_40 ) {
for ( V_110 = 0 ; V_110 < F_124 ( V_267 ) ; V_110 ++ )
F_130 ( V_40 -> V_32 , & V_267 [ V_110 ] ) ;
F_131 ( V_40 -> V_32 , & V_268 ) ;
F_132 ( V_40 ) ;
}
F_117 ( V_238 , NULL ) ;
V_32 -> V_146 = NULL ;
...
F_133 ( & V_32 -> V_181 . V_209 , V_202 ) ;
F_134 ( & V_179 -> V_276 , & V_32 -> V_181 . V_277 ) ;
V_32 -> V_181 . V_278 ++ ;
F_135 ( & V_32 -> V_181 . V_209 , V_202 ) ;
if ( V_141 )
F_75 ( & V_179 -> V_180 , 0 ) ;
else
F_65 ( & V_32 -> V_181 . V_182 ) ;
}
...
F_137 ( V_175 ) ;
F_135 ( & V_32 -> V_181 . V_209 , V_202 ) ;
V_179 = F_138 ( V_175 , struct V_178 , V_276 ) ;
V_35 = V_179 -> V_35 ;
F_139 ( V_35 -> V_32 , V_32 -> V_181 . V_50 ,
...
static int F_118 ( struct V_31 * V_32 , int V_122 , T_10 V_50 )
{
int V_110 = 0 ;
struct V_35 * V_35 ;
struct V_178 * V_179 ;
char * V_1 ;
F_141 ( & V_32 -> V_181 . V_209 ) ;
V_32 -> V_181 . V_50 = V_50 ;
F_122 ( & V_32 -> V_181 . V_277 ) ;
while ( V_110 < V_122 ) {
V_179 = F_109 ( sizeof( struct V_178 ) , V_145 ) ;
if ( ! V_179 )
break;
V_179 -> V_32 = V_32 ;
F_119 ( & V_179 -> V_180 ,
...
V_179 -> V_35 = V_35 ;
V_1 = F_143 ( V_32 -> V_146 , V_263 , V_145 ,
& V_35 -> V_280 ) ;
if ( ! V_1 ) {
F_52 ( V_179 ) ;
F_140 ( V_35 ) ;
...
F_144 ( V_35 , V_32 -> V_146 , F_145 ( V_32 -> V_146 , 1 ) ,
V_1 , V_50 , F_34 , V_179 ) ;
V_35 -> V_281 |= V_282 ;
F_134 ( & V_179 -> V_276 , & V_32 -> V_181 . V_277 ) ;
V_110 ++ ;
}
F_146 ( & V_32 -> V_181 . V_182 , V_110 ) ;
...
unsigned long V_202 ;
V_111 = F_147 ( & V_32 -> V_181 . V_182 , V_283 ) ;
if ( V_111 ) {
F_105 ( & V_32 -> V_275 , 1 ) ;
F_63 ( L_47 ,
...
F_133 ( & V_32 -> V_181 . V_209 , V_202 ) ;
F_148 ( F_149 ( & V_32 -> V_181 . V_277 ) ) ;
V_276 = V_32 -> V_181 . V_277 . V_279 ;
F_137 ( V_276 ) ;
V_32 -> V_181 . V_278 -- ;
F_135 ( & V_32 -> V_181 . V_209 , V_202 ) ;
V_179 = F_138 ( V_276 , struct V_178 , V_276 ) ;
V_35 = V_179 -> V_35 ;
error:
return V_35 ;
}
...
{
int V_111 ;
F_148 ( V_105 > V_32 -> V_181 . V_50 ) ;
V_35 -> V_102 = V_105 ;
V_111 = F_150 ( V_35 , V_145 ) ;
if ( V_111 ) {
F_34 ( V_35 ) ;
F_105 ( & V_32 -> V_275 , 1 ) ;
F_51 ( L_48 , V_111 ) ;
