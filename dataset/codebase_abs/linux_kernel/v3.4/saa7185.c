...
static int F_15 ( struct V_2 * V_3 , struct V_29 * V_30 )
{
struct V_4 * V_5 = F_4 ( V_3 ) ;
return F_16 ( V_5 , V_30 , V_31 , 0 ) ;
}
...
struct V_1 * V_8 ;
struct V_2 * V_3 ;
if ( ! F_10 ( V_5 -> V_13 , V_35 ) )
return - V_36 ;
F_18 ( V_5 , L_2 ,
V_5 -> V_37 << 1 , V_5 -> V_13 -> V_38 ) ;
V_8 = F_19 ( sizeof( struct V_1 ) , V_39 ) ;
if ( V_8 == NULL )
return - V_40 ;
V_8 -> V_19 = V_20 ;
V_3 = & V_8 -> V_3 ;
F_20 ( V_3 , V_5 , & V_41 ) ;
V_34 = F_9 ( V_3 , V_18 , sizeof( V_18 ) ) ;
if ( V_34 >= 0 )
V_34 = F_9 ( V_3 , V_21 , sizeof( V_21 ) ) ;
if ( V_34 < 0 )
F_7 ( 1 , V_9 , V_3 , L_3 , V_34 ) ;
else
F_7 ( 1 , V_9 , V_3 , L_4 ,
F_3 ( V_3 ) >> 5 ) ;
return 0 ;
