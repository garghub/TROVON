...
if ( V_8 && ( sscanf ( V_9 [ 0 ] , L_5 , & V_28 , & V_30 ) != 1 ) ) {
* error = L_6 ;
return - V_31 ;
}
if ( ( V_8 == 2 ) &&
( sscanf ( V_9 [ 1 ] , L_5 , & V_26 , & V_30 ) != 1 ||
V_26 > V_32 ) ) {
* error = L_7 ;
return - V_31 ;
}
...
static int F_20 ( struct V_14 * V_33 , struct V_14 * V_34 ,
T_2 V_35 )
{
T_2 V_36 , V_37 , V_38 , V_39 ;
V_36 = F_12 ( & V_33 -> V_25 ) ;
V_37 = F_12 ( & V_34 -> V_25 ) ;
if ( V_33 -> V_26 == V_34 -> V_26 )
return V_36 - V_37 ;
if ( V_36 == V_37 ||
! V_33 -> V_26 || ! V_34 -> V_26 )
return V_34 -> V_26 - V_33 -> V_26 ;
V_36 += V_35 ;
V_37 += V_35 ;
if ( F_21 ( V_36 >= V_40 ||
V_37 >= V_40 ) ) {
...
unsigned * V_28 , T_2 V_42 )
{
struct V_1 * V_2 = V_7 -> V_11 ;
struct V_14 * V_15 = NULL , * V_43 = NULL ;
if ( F_23 ( & V_2 -> V_4 ) )
return NULL ;
F_19 ( V_2 -> V_4 . V_16 , & V_2 -> V_4 ) ;
F_24 (pi, &s->valid_paths, list)
if ( ! V_43 || ( F_20 ( V_15 , V_43 , V_42 ) < 0 ) )
V_43 = V_15 ;
if ( ! V_43 )
return NULL ;
* V_28 = V_43 -> V_28 ;
