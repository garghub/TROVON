...
static int F_71 ( T_5 * V_105 , struct V_24 * V_25 )
{
int V_106 ;
struct V_7 * V_7 ;
for ( V_106 = 0 ; V_106 < V_107 ; V_106 ++ ) {
V_7 = & V_105 -> V_108 [ V_106 ] ;
if ( ! F_72 ( V_7 ) )
continue;
V_25 -> V_30 = 0 ;
V_25 -> V_34 = 0 ;
...
F_67 ( & V_25 -> V_31 ) ;
F_67 ( & V_25 -> V_48 ) ;
if ( V_25 -> V_69 == - 1 || ! F_73 ( V_7 , V_25 -> V_69 ) )
F_58 ( V_7 , V_25 ) ;
if ( V_25 -> V_69 > 0 ) {
int V_109 = F_55 ( V_7 , V_25 -> V_69 ,
F_54 ( V_7 ) , 0 , 0 ) ;
if ( V_109 && V_25 -> V_69 > V_7 -> V_110 )
V_7 -> V_110 = V_25 -> V_69 + 1 ;
else if ( ! V_109 && V_25 -> V_53 )
F_74 ( V_7 , V_25 -> V_69 ) ;
}
F_44 ( ! F_50 ( & V_25 -> V_31 ) ) ;
F_44 ( ! F_50 ( & V_25 -> V_48 ) ) ;
...
int F_75 ( T_5 * V_105 , int V_69 )
{
struct V_24 V_25 = {
. V_69 = V_69 ,
. V_53 = false ,
} ;
return F_71 ( V_105 , & V_25 ) ;
}
static int F_76 ( int V_111 )
{
struct V_24 V_25 = {
. V_69 = - 1 ,
. V_53 = true ,
} ;
return F_71 ( F_77 ( V_111 ) , & V_25 ) ;
}
...
int F_81 ( struct V_112 * V_113 , int V_114 ,
...
int F_82 ( struct V_112 * V_113 , int V_114 ,
void T_6 * V_115 , T_7 * V_116 , T_8 * V_117 )
{
F_83 ( V_113 , V_114 , V_115 , V_116 , V_117 ) ;
return 0 ;
}
T_9 F_84 ( struct V_118 * V_119 ,
struct V_120 * V_121 ,
const char * V_122 , T_7 V_5 )
{
int V_111 = V_119 -> V_123 ;
if ( V_111 >= 0 && V_111 < V_124 && F_85 ( V_111 ) ) {
F_79 () ;
F_76 ( V_111 ) ;
}
return V_5 ;
}
int F_86 ( struct V_125 * V_125 )
{
return F_87 ( & V_125 -> V_119 , & V_126 ) ;
}
void F_88 ( struct V_125 * V_125 )
{
return F_89 ( & V_125 -> V_119 , & V_126 ) ;
}
