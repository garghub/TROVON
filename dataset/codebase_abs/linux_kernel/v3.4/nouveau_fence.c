...
int
F_16 ( struct V_8 * V_9 , struct V_1 * * V_23 ,
bool V_24 )
{
struct V_1 * V_5 ;
int V_25 = 0 ;
...
if ( V_25 )
return V_25 ;
if ( F_24 ( V_9 -> V_5 . V_13 == V_9 -> V_5 . V_17 - 1 ) ) {
F_5 ( V_9 ) ;
F_25 ( V_9 -> V_5 . V_13 ==
V_9 -> V_5 . V_17 - 1 ) ;
}
...
int V_25 ;
if ( V_29 -> V_31 < V_32 ) {
V_25 = F_64 ( V_9 , V_74 , V_75 ) ;
if ( V_25 )
return V_25 ;
V_25 = F_23 ( V_9 , 2 ) ;
if ( V_25 )
return V_25 ;
F_28 ( V_9 , V_34 , V_76 , 1 ) ;
F_30 ( V_9 , V_74 ) ;
F_31 ( V_9 ) ;
}
if ( F_43 ( V_11 ) && V_29 -> V_54 < 0x84 ) {
struct V_77 * V_58 = & V_29 -> V_5 . V_60 -> V_60 . V_58 ;
V_25 = F_65 ( V_9 , V_78 ,
V_58 -> V_59 << V_79 ,
V_58 -> V_53 , V_80 ,
V_81 , & V_73 ) ;
if ( V_25 )
return V_25 ;
V_25 = F_66 ( V_9 , V_64 , V_73 ) ;
F_67 ( NULL , & V_73 ) ;
if ( V_25 )
return V_25 ;
} else
if ( F_43 ( V_11 ) ) {
V_25 = F_68 ( V_29 -> V_5 . V_60 , V_9 -> V_82 ,
& V_9 -> V_5 . V_62 ) ;
if ( V_25 )
return V_25 ;
}
...
F_15 ( & V_9 -> V_5 . V_14 ) ;
F_71 ( V_29 -> V_5 . V_60 , & V_9 -> V_5 . V_62 ) ;
}
int
F_72 ( struct V_10 * V_11 )
{
struct V_28 * V_29 = V_11 -> V_30 ;
int V_53 = ( V_29 -> V_54 < 0x84 ) ? 4096 : 16384 ;
int V_25 ;
if ( F_43 ( V_11 ) ) {
V_25 = F_73 ( V_11 , V_53 , 0 , V_83 ,
0 , 0 , & V_29 -> V_5 . V_60 ) ;
if ( V_25 )
return V_25 ;
V_25 = F_74 ( V_29 -> V_5 . V_60 , V_83 ) ;
if ( V_25 )
goto V_56;
V_25 = F_75 ( V_29 -> V_5 . V_60 ) ;
if ( V_25 )
goto V_56;
V_25 = F_76 ( & V_29 -> V_5 . V_57 , 0 ,
