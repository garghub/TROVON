...
V_2 -> V_145 |= V_146 ;
V_10 = F_60 ( sizeof( struct V_53 ) , V_147 ) ;
if ( ! V_10 )
return - V_148 ;
...
F_62 ( & V_2 -> V_167 ) ;
F_62 ( & V_2 -> V_168 ) ;
F_63 ( & V_2 -> V_169 , V_170 ,
( unsigned long ) V_2 ) ;
F_63 ( & V_2 -> V_171 , V_172 ,
( unsigned long ) V_2 ) ;
F_64 ( & V_2 -> V_173 , V_174 ) ;
F_65 ( & V_2 -> V_175 , V_176 ) ;
F_65 ( & V_2 -> V_177 , V_178 ) ;
F_66 ( & V_2 -> F_16 . V_179 , V_180 ,
( unsigned long ) V_2 ) ;
F_67 ( V_55 , & V_79 ) ;
V_55 -> V_181 = V_79 << 2 ;
V_26 = F_68 ( V_10 ) ;
...
V_12 -> V_205 = 5000 ;
V_12 -> V_206 = 10 ;
V_12 -> V_207 = sizeof( struct V_208 ) ;
V_12 -> V_209 = sizeof( struct V_210 ) ;
V_12 -> V_211 = sizeof( struct V_212 ) +
sizeof( struct V_213 ) + 4 ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_126 )
V_12 -> V_13 -> V_214 [ V_128 ] =
& V_2 -> V_127 [ V_128 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_136 )
V_12 -> V_13 -> V_214 [ V_137 ] =
& V_2 -> V_127 [ V_137 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_215 ) {
if ( V_2 -> V_10 -> V_100 . V_101 & V_126 )
F_49 ( V_2 ,
& V_2 -> V_127 [ V_128 ] . V_216 ) ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_136 )
F_49 ( V_2 ,
& V_2 -> V_127 [ V_137 ] . V_216 ) ;
}
F_73 ( V_12 , V_55 -> V_217 ) ;
}
...
if ( V_26 )
return - V_125 ;
V_2 -> V_221 = F_76 ( V_219 . V_222 ) ;
V_2 -> V_223 = F_76 ( V_219 . V_224 ) ;
snprintf ( V_12 -> V_13 -> V_225 , V_226 , L_16 ,
V_2 -> V_221 ,
V_2 -> V_223 ) ;
F_22 ( V_2 -> V_8 , L_17 ,
V_2 -> V_221 ,
...
if ( error != 0 )
goto V_232;
error = F_78 ( & V_55 -> V_233 , V_2 -> V_12 -> V_13 ,
F_23 ) ;
if ( error )
goto V_234;
V_57 = & V_55 -> V_233 ;
...
goto V_241;
if ( ! F_84 ( V_57 ) ) {
error = F_85 ( V_12 -> V_13 , V_57 -> V_242 ) ;
if ( error )
goto V_243;
}
error = F_86 ( V_2 -> V_10 ) ;
...
V_2 -> V_45 ,
V_2 -> V_47 ) ;
F_87 ( V_2 -> V_10 , V_230 , sizeof( V_230 ) ) ;
F_88 ( V_12 -> V_13 , L_21 , V_230 ) ;
F_89 ( V_2 ) ;
F_90 ( V_2 ) ;
return 0 ;
V_243:
...
int F_91 ( struct V_244 * V_245 , struct V_246 * V_8 ,
T_1 V_24 , char * V_144 , T_2 V_25 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_26 ;
V_12 = F_92 ( sizeof( struct V_1 ) , & V_247 ) ;
if ( ! V_12 )
return - V_148 ;
V_2 = V_12 -> V_2 ;
V_2 -> V_12 = V_12 ;
...
void F_97 ( struct V_244 * V_245 , bool V_250 )
{
if ( V_245 -> V_248 ) {
if ( V_250 )
V_245 -> V_248 -> V_10 -> V_151 |= V_251 ;
F_9 ( V_245 -> V_248 ) ;
F_95 ( V_245 -> V_248 ) ;
F_96 ( V_245 -> V_248 -> V_12 ) ;
}
}
void F_98 ( struct V_244 * V_245 )
{
F_99 ( V_245 -> V_248 , V_252 ) ;
}
int F_100 ( struct V_244 * V_245 )
{
struct V_1 * V_2 = V_245 -> V_248 ;
int V_26 ;
V_26 = F_1 ( V_2 ) ;
if ( V_26 )
return V_26 ;
