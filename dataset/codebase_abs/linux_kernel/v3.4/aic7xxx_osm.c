...
: V_2 -> V_66 ,
V_218 , & V_61 ) ;
if ( V_59 -> V_242 . V_290 != V_59 -> V_291 . V_290
|| V_59 -> V_242 . V_292 != V_59 -> V_291 . V_292
|| V_59 -> V_242 . V_243 != V_59 -> V_291 . V_243
|| V_59 -> V_242 . V_293 != V_59 -> V_291 . V_293 )
if ( V_88 == 0 )
break;
V_64 = V_218 ;
if ( V_62 == 'B' )
...
+ ( F_135 ( V_50 ) ? V_295 : 0 )
+ ( F_136 ( V_50 ) ? V_296 : 0 ) ;
if ( V_59 -> V_242 . V_290 == F_46 ( V_50 )
&& V_59 -> V_242 . V_292 == F_137 ( V_50 )
&& V_59 -> V_242 . V_243 == F_138 ( V_50 )
&& V_59 -> V_242 . V_293 == V_286 )
if ( V_88 == 0 )
break;
F_46 ( V_50 ) = V_59 -> V_242 . V_290 ;
F_137 ( V_50 ) = V_59 -> V_242 . V_292 ;
F_138 ( V_50 ) = V_59 -> V_242 . V_243 ;
F_134 ( V_50 ) = V_59 -> V_242 . V_293 & V_294 ? 1 : 0 ;
F_135 ( V_50 ) = V_59 -> V_242 . V_293 & V_295 ? 1 : 0 ;
F_136 ( V_50 ) = V_59 -> V_242 . V_293 & V_296 ? 1 : 0 ;
F_139 ( V_50 ) ;
break;
}
case V_297 :
...
if ( V_3 -> V_31 & V_319 ) {
T_5 V_320 ;
V_320 = F_158 ( sizeof( struct V_321 )
- F_159 ( V_3 ) ,
( T_11 ) V_322 ) ;
memcpy ( V_20 -> V_300 ,
F_160 ( V_2 , V_3 ) , V_320 ) ;
if ( V_320 < V_322 )
memset ( & V_20 -> V_300 [ V_320 ] , 0 ,
V_322 - V_320 ) ;
V_20 -> V_47 |= ( V_323 << 24 ) ;
#ifdef F_82
if ( V_161 & V_324 ) {
...
F_2 ( L_46 ,
V_320 ) ;
for ( V_18 = 0 ; V_18 < V_320 ; V_18 ++ ) {
if ( ( V_18 & 0xF ) == 0 )
F_2 ( L_5 ) ;
F_2 ( L_47 , V_20 -> V_300 [ V_18 ] ) ;
}
F_2 ( L_5 ) ;
}
#endif
...
F_2 ( L_41 ) ;
for ( V_364 = 0 ; V_364 < V_20 -> V_257 ; V_364 ++ )
F_2 ( L_42 , V_20 -> V_260 [ V_364 ] ) ;
F_2 ( L_5 ) ;
F_28 ( V_2 , & V_31 ) ;
V_42 = F_27 ( V_20 -> V_43 ) ;
if ( V_42 == NULL ) {
...
if ( V_359 == NULL && V_156 == V_106 ) {
F_168 (pending_scb, &ahc->pending_scbs, pending_links) {
if ( F_169 ( V_2 , V_359 , F_170 ( V_20 ) ,
F_63 ( V_20 ) + 'A' ,
V_81 ,
V_201 , V_82 ) )
break;
...
F_172 ( V_2 ) ;
V_366 = TRUE ;
if ( ( V_359 -> V_31 & V_276 ) == 0 ) {
F_166 ( V_91 , V_20 , L_55 ) ;
goto V_369;
}
F_2 ( L_56 ,
F_45 ( V_2 ) , V_365 ? L_57 : L_58 ) ;
F_147 ( V_2 ) ;
V_368 = TRUE ;
if ( V_156 == V_105 ) {
...
V_20 -> V_43 -> V_62 + 'A' ,
V_20 -> V_43 -> V_219 , V_359 -> V_229 -> V_10 ,
V_82 , 0 ,
V_372 ) > 0 ) {
V_368 = FALSE ;
}
if ( V_368 && ( F_8 ( V_2 , V_373 ) & V_374 ) == 0 ) {
struct V_3 * V_375 ;
V_375 = F_174 ( V_2 , F_8 ( V_2 , V_376 ) ) ;
if ( V_375 == V_359 )
V_368 = FALSE ;
else if ( V_156 != V_105
&& F_8 ( V_2 , V_377 ) == V_359 -> V_229 -> V_240
&& F_8 ( V_2 , V_378 ) == F_5 ( V_359 ) )
V_368 = FALSE ;
}
V_362 = F_8 ( V_2 , V_379 ) ;
V_360 = F_8 ( V_2 , V_380 ) ;
...
V_363 = F_8 ( V_2 , V_377 ) ;
if ( V_362 != V_381
&& ( V_359 -> V_229 -> V_10 == V_361
|| ( V_156 == V_106
&& F_175 ( V_2 , V_363 ) == F_170 ( V_20 ) ) ) ) {
V_359 = F_174 ( V_2 , V_361 ) ;
V_359 -> V_31 |= V_312 | V_156 ;
F_12 ( V_2 , V_382 , V_383 ) ;
F_12 ( V_2 , V_384 , V_362 | V_385 ) ;
F_166 ( V_91 , V_20 , L_60 ) ;
V_367 = TRUE ;
} else if ( V_368 ) {
V_359 -> V_229 -> V_239 |= V_249 | V_386 ;
V_359 -> V_31 |= V_312 | V_156 ;
...
FALSE ) ;
if ( ( V_2 -> V_31 & V_387 ) == 0 ) {
F_12 ( V_2 , V_380 , V_359 -> V_229 -> V_10 ) ;
F_12 ( V_2 , V_388 ,
F_8 ( V_2 , V_388 ) | V_249 ) ;
}
...
static void F_182 ( struct V_49 * V_50 , int V_292 )
{
struct V_34 * V_390 = F_32 ( V_50 -> V_42 . V_109 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_390 -> V_38 ) ;
struct V_56 V_57 ;
unsigned long V_31 ;
F_40 ( & V_57 , V_390 -> V_172 , V_50 -> V_65 , 0 ,
V_50 -> V_62 + 'A' , V_82 ) ;
F_28 ( V_2 , & V_31 ) ;
F_42 ( V_2 , & V_57 , V_292 , V_83 , FALSE ) ;
F_30 ( V_2 , & V_31 ) ;
}
static void F_183 ( struct V_49 * V_50 , int V_290 )
{
struct V_34 * V_390 = F_32 ( V_50 -> V_42 . V_109 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_390 -> V_38 ) ;
struct V_60 * V_61 ;
...
= F_39 ( V_2 ,
V_50 -> V_62 + 'A' ,
V_390 -> V_172 , V_50 -> V_65 , & V_61 ) ;
struct V_56 V_57 ;
unsigned int V_293 = V_59 -> V_291 . V_293 ;
unsigned long V_31 ;
unsigned long V_243 = V_59 -> V_291 . V_243 ;
...
V_392 = F_184 ( V_2 , & V_290 , & V_293 , V_68 ) ;
F_28 ( V_2 , & V_31 ) ;
F_41 ( V_2 , & V_57 , V_392 , V_290 , V_243 ,
V_293 , V_83 , FALSE ) ;
F_30 ( V_2 , & V_31 ) ;
}
...
unsigned long V_31 ;
const struct V_391 * V_392 = NULL ;
F_40 ( & V_57 , V_390 -> V_172 , V_50 -> V_65 , 0 ,
V_50 -> V_62 + 'A' , V_82 ) ;
if ( V_243 != 0 ) {
V_392 = F_184 ( V_2 , & V_290 , & V_293 , V_68 ) ;
V_290 = V_59 -> V_291 . V_290 ;
V_293 = V_59 -> V_291 . V_293 ;
}
F_28 ( V_2 , & V_31 ) ;
F_41 ( V_2 , & V_57 , V_392 , V_290 , V_243 ,
V_293 , V_83 , FALSE ) ;
...
static void F_186 ( struct V_49 * V_50 , int V_394 )
{
struct V_34 * V_390 = F_32 ( V_50 -> V_42 . V_109 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_390 -> V_38 ) ;
struct V_60 * V_61 ;
...
unsigned int V_293 = V_59 -> V_291 . V_293
& ~ V_294 ;
unsigned int V_290 = V_59 -> V_291 . V_290 ;
unsigned int V_292 = V_59 -> V_291 . V_292 ;
unsigned long V_31 ;
const struct V_391 * V_392 ;
if ( V_394 && F_35 ( V_50 ) ) {
V_293 |= V_294 ;
...
V_392 = F_184 ( V_2 , & V_290 , & V_293 , V_68 ) ;
F_28 ( V_2 , & V_31 ) ;
F_41 ( V_2 , & V_57 , V_392 , V_290 , V_59 -> V_291 . V_243 ,
V_293 , V_83 , FALSE ) ;
F_30 ( V_2 , & V_31 ) ;
}
static void F_187 ( struct V_34 * V_390 )
{
struct V_1 * V_2 = * (struct V_1 * * ) V_390 -> V_38 ;
unsigned long V_31 ;
T_21 V_395 ;
