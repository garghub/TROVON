...
struct V_7 * V_8 ;
int V_17 ;
V_8 = F_29 ( sizeof( struct V_7 ) , V_44 ) ;
if ( ! V_8 ) {
F_25 ( L_15 ) ;
V_17 = - V_45 ;
goto V_46;
...
V_8 -> type = V_43 -> V_47 ;
F_31 ( & V_8 -> V_18 ) ;
if ( V_8 -> type != V_48 && ! V_19 )
F_32 ( V_16 ) ;
V_17 = F_33 ( & V_16 -> V_2 . V_49 , & V_50 ) ;
if ( V_17 )
goto V_51;
V_8 -> V_52 = F_34 ( & V_16 -> V_2 ) ;
if ( F_35 ( V_8 -> V_52 ) ) {
V_17 = F_36 ( V_8 -> V_52 ) ;
goto V_53;
}
...
struct V_7 * V_8 = F_10 ( V_16 ) ;
F_12 ( & V_8 -> V_18 ) ;
if ( F_41 ( V_55 , V_8 -> V_56 + V_57 + V_57 / 2 )
|| ! V_8 -> V_58 ) {
int V_59 ;
F_42 ( & V_16 -> V_2 , L_16 ) ;
