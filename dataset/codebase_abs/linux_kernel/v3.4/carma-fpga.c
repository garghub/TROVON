...
static T_6 F_71 ( struct V_84 * V_21 , struct V_120 * V_121 ,
char * V_7 )
{
...
static T_6 F_73 ( struct V_84 * V_21 , struct V_120 * V_121 ,
...
V_134 = F_48 ( V_68 , struct V_6 , V_15 ) ;
F_16 ( & V_134 -> V_15 ) ;
F_53 ( & V_4 -> V_67 ) ;
F_17 ( V_4 -> V_21 , & V_134 -> V_8 ) ;
V_130 -> V_7 = V_134 ;
V_130 -> V_140 = 0 ;
V_136:
V_135 = V_134 -> V_16 - V_130 -> V_140 ;
V_65 = V_134 -> V_8 . V_141 + V_130 -> V_140 ;
V_122 = F_84 ( V_122 , V_135 ) ;
if ( F_85 ( V_131 , V_65 , V_122 ) )
return - V_142 ;
V_135 -= V_122 ;
if ( V_135 > 0 ) {
V_130 -> V_140 += V_122 ;
...
F_52 ( & V_4 -> V_67 ) ;
V_130 -> V_7 = NULL ;
if ( ! V_4 -> V_69 || V_134 -> V_16 != V_4 -> V_23 ) {
V_133 = true ;
goto V_125;
}
F_20 ( & V_134 -> V_15 , & V_4 -> free ) ;
V_125:
F_53 ( & V_4 -> V_67 ) ;
if ( V_133 ) {
F_17 ( V_4 -> V_21 , & V_134 -> V_8 ) ;
...
static unsigned int F_86 ( struct V_115 * V_126 , struct V_143 * V_144 )
{
struct V_129 * V_130 = V_126 -> V_127 ;
struct V_3 * V_4 = V_130 -> V_4 ;
unsigned int V_145 = 0 ;
F_87 ( V_126 , & V_4 -> V_70 , V_144 ) ;
if ( ! F_47 ( & V_4 -> V_68 ) )
V_145 |= V_146 | V_147 ;
return V_145 ;
}
static int F_88 ( struct V_115 * V_126 , struct V_148 * V_149 )
{
struct V_129 * V_130 = V_126 -> V_127 ;
struct V_3 * V_4 = V_130 -> V_4 ;
unsigned long V_112 , V_150 , V_151 , V_152 ;
V_112 = V_149 -> V_153 << V_154 ;
V_150 = V_149 -> V_155 - V_149 -> V_156 ;
V_151 = V_4 -> V_157 - V_112 ;
V_152 = ( V_4 -> V_29 + V_112 ) >> V_154 ;
if ( V_150 > V_151 ) {
F_21 ( V_4 -> V_21 , L_37 ) ;
return - V_124 ;
}
V_149 -> V_158 |= V_159 | V_160 ;
V_149 -> V_161 = F_89 ( V_149 -> V_161 ) ;
return F_90 ( V_149 , V_149 -> V_156 , V_152 , V_150 ,
V_149 -> V_161 ) ;
}
static bool F_91 ( struct V_75 * V_76 , void * V_65 )
{
if ( V_76 -> V_162 == 0 && V_76 -> V_84 -> V_92 == 0 )
return false ;
return true ;
}
static int F_92 ( struct V_163 * V_164 )
{
struct V_165 * V_166 = V_164 -> V_21 . V_166 ;
struct V_84 * V_167 ;
struct V_3 * V_4 ;
struct V_168 V_169 ;
T_9 V_145 ;
...
F_10 ( & V_4 -> V_68 ) ;
F_97 ( & V_4 -> V_70 ) ;
V_4 -> V_128 . V_170 = V_171 ;
V_4 -> V_128 . V_172 = V_107 ;
V_4 -> V_128 . V_173 = & V_174 ;
V_11 = F_98 ( V_166 , 0 , & V_169 ) ;
if ( V_11 ) {
F_21 ( & V_164 -> V_21 , L_39 ) ;
V_11 = - V_175 ;
goto V_176;
}
V_4 -> V_29 = V_169 . V_177 ;
V_4 -> V_157 = F_99 ( & V_169 ) ;
V_4 -> V_51 = F_100 ( V_166 , 0 ) ;
if ( ! V_4 -> V_51 ) {
F_21 ( & V_164 -> V_21 , L_40 ) ;
V_11 = - V_27 ;
goto V_176;
}
F_101 ( V_145 ) ;
...
F_102 ( V_180 , V_145 ) ;
F_102 ( V_181 , V_145 ) ;
V_4 -> V_76 = F_103 ( V_145 , F_91 , NULL ) ;
if ( ! V_4 -> V_76 ) {
F_21 ( & V_164 -> V_21 , L_41 ) ;
V_11 = - V_175 ;
goto V_182;
}
V_4 -> V_91 = F_104 ( V_166 , 0 ) ;
if ( V_4 -> V_91 == V_183 ) {
F_21 ( & V_164 -> V_21 , L_42 ) ;
V_11 = - V_175 ;
goto V_184;
}
F_31 ( V_99 , V_4 -> V_51 + V_185 ) ;
V_11 = F_105 ( & V_4 -> V_128 ) ;
if ( V_11 ) {
F_21 ( & V_164 -> V_21 , L_43 ) ;
goto V_186;
}
V_11 = F_65 ( V_4 ) ;
if ( V_11 ) {
F_21 ( & V_164 -> V_21 , L_44 ) ;
goto V_187;
}
V_167 = V_4 -> V_128 . V_167 ;
F_93 ( V_167 , V_4 ) ;
V_11 = F_106 ( & V_167 -> V_188 , & V_189 ) ;
if ( V_11 ) {
F_21 ( & V_164 -> V_21 , L_45 ) ;
goto V_190;
}
F_107 ( & V_164 -> V_21 , L_46 ) ;
return 0 ;
V_190:
F_69 ( V_4 ) ;
V_187:
...
static int F_112 ( struct V_163 * V_164 )
{
struct V_3 * V_4 = F_72 ( & V_164 -> V_21 ) ;
struct V_84 * V_167 = V_4 -> V_128 . V_167 ;
F_113 ( & V_167 -> V_188 , & V_189 ) ;
F_69 ( V_4 ) ;
F_56 ( V_4 ) ;
F_108 ( & V_4 -> V_128 ) ;
F_109 ( V_4 -> V_91 ) ;
