...
static T_3 F_19 ( struct V_17 * V_17 , const char T_4 * V_23 ,
T_5 V_24 , T_6 * V_25 )
{
struct V_1 * V_2 = V_17 -> V_22 ;
if ( V_24 ) {
...
static long F_22 ( struct V_17 * V_17 , unsigned int V_27 ,
unsigned long V_28 )
{
struct V_1 * V_2 ;
int V_29 ;
...
static int T_7 F_30 ( struct V_45 * V_46 )
{
struct V_47 * V_48 , * V_49 ;
struct V_1 * V_2 ;
int V_50 ;
V_48 = F_31 ( V_46 , V_51 , 0 ) ;
if ( ! V_48 ) {
V_50 = - V_52 ;
goto V_53;
}
...
V_49 = F_32 ( V_48 -> V_55 , F_33 ( V_48 ) , V_46 -> V_56 ) ;
if ( ! V_49 ) {
V_50 = - V_19 ;
goto V_54;
}
V_2 = F_34 ( sizeof( struct V_1 ) , V_57 ) ;
if ( ! V_2 ) {
V_50 = - V_58 ;
goto V_59;
}
...
V_2 -> V_49 = V_49 ;
V_2 -> V_14 = & V_46 -> V_14 ;
V_2 -> V_3 = F_35 ( V_48 -> V_55 , F_33 ( V_48 ) ) ;
if ( ! V_2 -> V_3 ) {
V_50 = - V_58 ;
goto V_60;
}
...
static int T_8 F_45 ( struct V_45 * V_46 )
{
struct V_1 * V_2 = F_13 ( V_46 ) ;
struct V_47 * V_48 = F_31 ( V_46 , V_51 , 0 ) ;
F_40 ( V_2 -> V_14 ) ;
if ( ! V_48 )
return - V_52 ;
F_46 ( & ( V_2 -> V_61 ) ) ;
...
static int F_47 ( struct V_45 * V_46 , T_9 V_69 )
{
struct V_1 * V_2 = F_13 ( V_46 ) ;
if ( V_2 -> V_18 ) {
F_10 ( V_2 -> V_14 ) ;
