...
V_22 = args -> V_22 ;
args -> V_101 = 0 ;
error = F_72 ( args -> V_51 , args -> V_22 , args -> V_101 , - 1 , & V_113 ,
V_24 ) ;
if ( error )
return ( error ) ;
ASSERT ( V_113 != NULL ) ;
...
return ( error ) ;
ASSERT ( V_113 != NULL ) ;
( void ) F_82 ( V_113 , args ) ;
if ( ( V_108 = F_83 ( V_113 , V_22 ) ) ) {
F_35 ( args -> V_40 , args -> V_39 ) ;
error = F_84 ( V_113 , args , V_108 ) ;
if ( ! error ) {
...
T_11 * V_113 ;
V_76 -> V_97 -> V_101 = 0 ;
error = F_72 ( NULL , V_76 -> V_22 , 0 , - 1 , & V_113 , V_24 ) ;
if ( error )
return F_47 ( error ) ;
ASSERT ( V_113 != NULL ) ;
V_122 = V_113 -> V_123 ;
if ( F_89 ( V_122 -> V_124 . V_125 . V_126 != F_90 ( V_127 ) ) ) {
F_91 ( L_1 , V_128 ,
V_76 -> V_22 -> V_28 , V_122 ) ;
F_74 ( NULL , V_113 ) ;
return F_47 ( V_129 ) ;
}
error = F_92 ( V_113 , V_76 ) ;
F_74 ( NULL , V_113 ) ;
return F_47 ( error ) ;
}
STATIC int
...
V_109 = F_76 ( V_131 -> V_113 , V_130 -> args ) ;
if ( V_109 == V_61 ) {
...
F_77 ( V_130 -> V_136 . V_131 [ 0 ] . V_113 ) ;
V_130 -> V_136 . V_131 [ 0 ] . V_113 = NULL ;
error = F_72 ( args -> V_51 , args -> V_22 , 0 , - 1 , & V_113 ,
V_24 ) ;
if ( error )
goto V_66;
...
F_74 ( args -> V_51 , V_130 -> V_136 . V_131 [ V_144 ] . V_113 ) ;
...
if ( V_113 ) {
V_145 = V_113 -> V_123 ;
switch ( F_106 ( V_145 -> V_124 . V_125 . V_126 ) ) {
case V_147 :
F_107 ( V_76 ) ;
F_74 ( NULL , V_113 ) ;
V_113 = NULL ;
...
case V_127 :
V_122 = V_113 -> V_123 ;
if ( V_97 -> V_21 > F_108 ( V_122 -> V_148 [
F_106 ( V_122 -> V_124 . V_83 ) - 1 ] . V_21 ) ) {
F_107 ( V_76 ) ;
F_74 ( NULL , V_113 ) ;
V_113 = NULL ;
} else if ( V_97 -> V_21 <=
F_108 ( V_122 -> V_148 [ 0 ] . V_21 ) ) {
F_107 ( V_76 ) ;
F_74 ( NULL , V_113 ) ;
V_113 = NULL ;
}
...
F_90 ( V_127 ) )
break;
if ( F_89 ( V_145 -> V_124 . V_125 . V_126 !=
F_90 ( V_147 ) ) ) {
F_91 ( L_3 ,
V_128 ,
V_76 -> V_22 -> V_28 ,
...
V_146 = V_145 -> V_146 ;
for ( V_144 = 0 ; V_144 < F_106 ( V_145 -> V_124 . V_83 ) ;
V_146 ++ , V_144 ++ ) {
if ( V_97 -> V_21
<= F_108 ( V_146 -> V_21 ) ) {
V_97 -> V_101 = F_108 ( V_146 -> V_149 ) ;
F_110 ( V_76 ,
V_146 ) ;
break;
}
}
if ( V_144 == F_106 ( V_145 -> V_124 . V_83 ) ) {
F_74 ( NULL , V_113 ) ;
return ( 0 ) ;
}
F_74 ( NULL , V_113 ) ;
...
for (; ; ) {
V_122 = V_113 -> V_123 ;
if ( F_89 ( V_122 -> V_124 . V_125 . V_126 !=
F_90 ( V_127 ) ) ) {
F_91 ( L_4 ,
V_128 ,
V_76 -> V_22 -> V_28 , V_122 ) ;
...
break;
V_97 -> V_101 = F_108 ( V_122 -> V_124 . V_125 . V_150 ) ;
F_74 ( NULL , V_113 ) ;
error = F_72 ( NULL , V_76 -> V_22 , V_97 -> V_101 , - 1 ,
& V_113 , V_24 ) ;
if ( error )
...
while ( V_20 > 0 ) {
V_155 = V_152 ;
error = F_111 ( args -> V_22 , ( V_159 ) V_158 ,
...
V_153 = F_112 ( V_33 , V_151 [ V_144 ] . V_161 ) ;
V_157 = F_113 ( V_33 , V_151 [ V_144 ] . V_164 ) ;
error = F_114 ( V_33 , V_33 -> V_165 , V_153 ,
V_157 , V_166 | V_167 ,
& V_113 ) ;
if ( error )
return ( error ) ;
V_156 = ( V_20 < F_115 ( V_113 ) )
? V_20 : F_115 ( V_113 ) ;
F_116 ( V_113 , 0 , V_156 , V_154 , V_168 ) ;
F_117 ( V_113 ) ;
V_154 += V_156 ;
V_20 -= V_156 ;
...
V_169 = 0 ;
error = F_118 ( args -> V_51 , args -> V_22 , V_157 , & V_169 ,
V_24 ) ;
if ( error ) {
return ( error ) ;
}
...
F_35 ( args -> V_40 , args -> V_39 ) ;
V_155 = 1 ;
error = F_119 ( args -> V_51 , V_22 , ( V_159 ) V_158 ,
V_157 ,
V_160 | V_171 ,
...
ASSERT ( ( V_151 . V_161 != V_162 ) &&
( V_151 . V_161 != V_163 ) ) ;
V_153 = F_112 ( V_33 , V_151 . V_161 ) ,
V_157 = F_113 ( V_33 , V_151 . V_164 ) ;
V_113 = F_120 ( V_33 -> V_165 , V_153 , V_157 ,
V_166 | V_167 ) ;
if ( ! V_113 )
return V_172 ;
V_156 = ( V_20 < F_115 ( V_113 ) ) ? V_20 :
F_115 ( V_113 ) ;
F_116 ( V_113 , 0 , V_156 , V_170 , V_173 ) ;
if ( V_156 < F_115 ( V_113 ) )
F_121 ( V_113 , V_156 , F_115 ( V_113 ) - V_156 ) ;
error = F_122 ( V_113 ) ;
F_117 ( V_113 ) ;
if ( error )
return error ;
...
V_153 = F_112 ( V_33 , V_151 . V_161 ) ,
V_157 = F_113 ( V_33 , V_151 . V_164 ) ;
V_113 = F_123 ( V_33 -> V_165 , V_153 , V_157 , V_175 ) ;
if ( V_113 ) {
F_124 ( V_113 ) ;
F_117 ( V_113 ) ;
V_113 = NULL ;
...
while ( ! V_174 ) {
F_35 ( args -> V_40 , args -> V_39 ) ;
error = F_125 ( args -> V_51 , args -> V_22 , V_158 , V_157 ,
V_160 | V_171 ,
