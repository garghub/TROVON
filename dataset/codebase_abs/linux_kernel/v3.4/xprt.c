...
unsigned V_59 = V_18 -> V_60 . V_61 -> V_62 ;
...
struct V_19 * V_20 ;
if ( ! F_64 ( & V_16 -> free ) ) {
V_20 = F_96 ( V_16 -> free . V_138 , struct V_19 , V_110 ) ;
F_97 ( & V_20 -> V_110 ) ;
goto V_139;
}
V_20 = F_88 ( V_16 , V_140 ) ;
if ( ! F_98 ( V_20 ) )
goto V_139;
switch ( F_99 ( V_20 ) ) {
case - V_136 :
...
struct V_15 * F_107 ( struct V_142 * V_142 , T_4 V_143 ,
unsigned int V_144 ,
unsigned int V_145 )
{
struct V_15 * V_16 ;
struct V_19 * V_20 ;
int V_146 ;
V_16 = F_91 ( V_143 , V_147 ) ;
if ( V_16 == NULL )
goto V_8;
F_108 ( V_16 , V_142 ) ;
for ( V_146 = 0 ; V_146 < V_144 ; V_146 ++ ) {
V_20 = F_91 ( sizeof( struct V_19 ) , V_147 ) ;
if ( ! V_20 )
break;
F_103 ( & V_20 -> V_110 , & V_16 -> free ) ;
}
...
{
return ( V_150 T_2 ) V_16 -> V_101 ++ ;
}
static inline void F_114 ( struct V_15 * V_16 )
{
V_16 -> V_101 = F_115 () ;
}
static void F_101 ( struct V_17 * V_18 , struct V_15 * V_16 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
F_116 ( & V_20 -> V_110 ) ;
...
return;
V_16 = V_20 -> V_57 ;
if ( V_18 -> V_153 -> V_154 != NULL )
V_18 -> V_153 -> V_154 ( V_18 , V_18 -> V_155 ) ;
else if ( V_18 -> V_65 )
F_118 ( V_18 , V_18 -> V_65 -> V_156 ) ;
F_24 ( & V_16 -> V_42 ) ;
V_16 -> V_43 -> V_47 ( V_16 , V_18 ) ;
if ( V_16 -> V_43 -> V_157 )
V_16 -> V_43 -> V_157 ( V_18 ) ;
if ( ! F_64 ( & V_20 -> V_110 ) )
F_97 ( & V_20 -> V_110 ) ;
V_16 -> V_158 = V_80 ;
if ( F_64 ( & V_16 -> V_90 ) && F_81 ( V_16 ) )
F_119 ( & V_16 -> V_59 ,
V_16 -> V_158 + V_16 -> V_114 ) ;
F_25 ( & V_16 -> V_42 ) ;
if ( V_20 -> V_151 )
V_16 -> V_43 -> V_159 ( V_20 -> V_151 ) ;
if ( V_20 -> V_160 != NULL )
F_120 ( V_20 -> V_160 ) ;
V_18 -> V_21 = NULL ;
if ( V_20 -> V_152 )
...
static void F_108 ( struct V_15 * V_16 , struct V_142 * V_142 )
{
F_109 ( & V_16 -> V_161 , 1 ) ;
F_124 ( & V_16 -> V_42 ) ;
F_124 ( & V_16 -> V_141 ) ;
...
V_16 -> V_50 = V_165 ;
V_16 -> V_166 = 0 ;
F_126 ( & V_16 -> V_167 , L_31 ) ;
F_126 ( & V_16 -> V_55 , L_32 ) ;
F_127 ( & V_16 -> V_36 , L_33 ) ;
F_127 ( & V_16 -> V_129 , L_34 ) ;
F_114 ( V_16 ) ;
V_16 -> V_149 = F_128 ( V_142 ) ;
}
struct V_15 * F_129 ( struct V_168 * args )
{
struct V_15 * V_16 ;
struct V_1 * V_3 ;
F_2 ( & V_6 ) ;
...
F_132 ( & V_16 -> V_59 ) ;
if ( strlen ( args -> V_99 ) > V_172 ) {
F_133 ( V_16 ) ;
return F_89 ( - V_173 ) ;
}
V_16 -> V_99 = F_134 ( args -> V_99 , V_147 ) ;
if ( V_16 -> V_99 == NULL ) {
F_133 ( V_16 ) ;
return F_89 ( - V_136 ) ;
}
