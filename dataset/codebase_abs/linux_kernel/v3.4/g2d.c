...
F_101 ( & V_27 -> V_145 , 0 ) ;
F_102 ( & V_27 -> V_130 ) ;
V_144 = F_103 ( V_140 , V_146 , 0 ) ;
if ( ! V_144 ) {
F_104 ( & V_140 -> V_27 , L_6 ) ;
V_35 = - V_147 ;
goto V_148;
}
V_27 -> V_149 = F_105 ( V_144 -> V_150 , F_106 ( V_144 ) ,
F_107 ( & V_140 -> V_27 ) ) ;
if ( ! V_27 -> V_149 ) {
F_104 ( & V_140 -> V_27 , L_7 ) ;
V_35 = - V_147 ;
goto V_148;
}
V_27 -> V_151 = F_108 ( V_144 -> V_150 , F_106 ( V_144 ) ) ;
if ( ! V_27 -> V_151 ) {
F_104 ( & V_140 -> V_27 , L_8 ) ;
V_35 = - V_147 ;
goto V_152;
}
V_27 -> V_153 = F_109 ( & V_140 -> V_27 , L_9 ) ;
if ( F_110 ( V_27 -> V_153 ) ) {
F_104 ( & V_140 -> V_27 , L_10 ) ;
V_35 = - V_154 ;
goto V_155;
}
V_35 = F_111 ( V_27 -> V_153 ) ;
if ( V_35 ) {
F_104 ( & V_140 -> V_27 , L_11 ) ;
goto V_156;
}
V_27 -> V_135 = F_109 ( & V_140 -> V_27 , L_12 ) ;
if ( F_110 ( V_27 -> V_135 ) ) {
F_104 ( & V_140 -> V_27 , L_13 ) ;
V_35 = - V_154 ;
goto V_157;
}
V_35 = F_111 ( V_27 -> V_135 ) ;
if ( V_35 ) {
F_104 ( & V_140 -> V_27 , L_14 ) ;
goto V_158;
}
V_144 = F_103 ( V_140 , V_159 , 0 ) ;
if ( ! V_144 ) {
F_104 ( & V_140 -> V_27 , L_15 ) ;
V_35 = - V_154 ;
goto V_160;
}
V_27 -> V_136 = V_144 -> V_150 ;
V_35 = F_112 ( V_27 -> V_136 , F_89 , 0 , V_140 -> V_91 , V_27 ) ;
if ( V_35 ) {
F_104 ( & V_140 -> V_27 , L_16 ) ;
goto V_158;
}
V_27 -> V_28 = F_113 ( & V_140 -> V_27 ) ;
if ( F_6 ( V_27 -> V_28 ) ) {
V_35 = F_7 ( V_27 -> V_28 ) ;
goto V_161;
}
V_35 = F_114 ( & V_140 -> V_27 , & V_27 -> V_68 ) ;
if ( V_35 )
goto V_162;
V_142 = F_115 () ;
if ( ! V_142 ) {
...
* V_142 = V_164 ;
V_142 -> V_165 = & V_27 -> V_128 ;
V_35 = F_116 ( V_142 , V_166 , 0 ) ;
if ( V_35 ) {
F_22 ( & V_27 -> V_68 , L_18 ) ;
goto V_167;
}
F_117 ( V_142 , V_27 ) ;
snprintf ( V_142 -> V_91 , sizeof( V_142 -> V_91 ) , L_19 , V_164 . V_91 ) ;
V_27 -> V_142 = V_142 ;
F_34 ( & V_27 -> V_68 , L_20 ,
V_142 -> V_168 ) ;
F_118 ( V_140 , V_27 ) ;
V_27 -> V_73 = F_119 ( & V_169 ) ;
if ( F_6 ( V_27 -> V_73 ) ) {
F_22 ( & V_27 -> V_68 , L_21 ) ;
V_35 = F_7 ( V_27 -> V_73 ) ;
goto V_170;
...
{
struct V_63 * V_27 = (struct V_63 * ) F_130 ( V_140 ) ;
F_34 ( & V_27 -> V_68 , L_22 V_79 ) ;
F_131 ( V_27 -> V_73 ) ;
F_120 ( V_27 -> V_142 ) ;
F_122 ( & V_27 -> V_68 ) ;
F_123 ( V_27 -> V_28 ) ;
