...
goto V_147;
V_141 -> V_148 = V_143 ;
if ( F_8 ( V_19 -> V_26 . V_149 == NULL ) )
V_19 -> V_26 . V_149 =
V_141 -> V_150 -> V_151 . V_152 -> V_153 -> V_154 ;
return 0 ;
V_147:
F_77 ( V_143 ) ;
return V_24 ;
}
static long F_90 ( struct V_155 * V_150 , unsigned int V_156 ,
unsigned long V_157 )
{
struct V_140 * V_141 = V_150 -> V_158 ;
struct V_61 * V_62 = V_141 -> V_159 -> V_62 ;
...
V_174 . V_172 = V_172 ;
V_24 = V_172 -> V_181 -> V_182 ( & V_174 ) ;
F_96 ( V_24 != 0 ) ;
}
}
static void F_45 ( struct V_183 * V_184 )
{
F_97 ( & V_184 -> V_107 ) ;
F_42 ( & V_184 -> V_185 ) ;
F_37 ( & V_184 -> V_186 ) ;
...
{
struct V_183 * V_184 ;
V_184 = F_35 ( sizeof( * V_184 ) , V_65 ) ;
if ( F_8 ( V_184 == NULL ) )
return - V_66 ;
F_45 ( V_184 ) ;
F_46 ( & V_184 -> V_107 , true , V_108 ) ;
V_188 -> V_148 = V_184 ;
return 0 ;
}
...
struct V_187 * V_188 )
{
struct V_183 * V_184 = V_183 ( V_188 ) ;
V_188 -> V_148 = NULL ;
F_77 ( V_184 ) ;
}
...
struct V_18 * V_19 = F_79 ( V_62 ) ;
struct V_142 * V_143 = V_142 ( V_141 ) ;
struct V_183 * V_190 = V_19 -> V_109 ;
struct V_183 * V_184 = V_183 ( V_141 -> V_188 ) ;
int V_24 = 0 ;
if ( ! V_19 -> V_85 ) {
V_24 = F_26 ( V_19 , true ) ;
if ( F_8 ( V_24 != 0 ) )
...
if ( V_190 ) {
F_24 ( V_190 != & V_19 -> V_106 ) ;
V_24 = F_101 ( & V_190 -> V_107 , false , V_143 -> V_145 ) ;
if ( F_8 ( V_24 != 0 ) )
goto V_192;
F_46 ( & V_190 -> V_107 , true , V_108 ) ;
...
F_46 ( & V_184 -> V_107 , false , V_108 ) ;
if ( ! V_189 ) {
F_103 ( & V_184 -> V_107 ) ;
F_24 ( V_143 -> V_146 != V_141 -> V_188 ) ;
F_87 ( & V_143 -> V_146 ) ;
}
V_19 -> V_109 = V_184 ;
return 0 ;
...
struct V_183 * V_184 = V_183 ( V_141 -> V_188 ) ;
int V_24 ;
V_143 -> V_146 = F_105 ( V_141 -> V_188 ) ;
V_24 = F_101 ( & V_184 -> V_107 , false , V_143 -> V_145 ) ;
F_106 ( V_19 , false , 0 ) ;
if ( F_8 ( ( V_24 != 0 ) ) ) {
F_14 ( L_47 ) ;
F_87 ( & V_143 -> V_146 ) ;
...
static void F_108 ( struct V_194 * V_67 )
{
struct V_61 * V_62 = F_109 ( V_67 ) ;
F_110 ( V_62 ) ;
}
static int V_137 ( struct V_195 * V_196 , unsigned long V_197 ,
void * V_198 )
{
struct V_18 * V_19 =
F_111 ( V_196 , struct V_18 , V_135 ) ;
struct V_183 * V_184 = V_19 -> V_109 ;
switch ( V_197 ) {
case V_199 :
case V_200 :
F_112 ( & V_184 -> V_107 ) ;
...
static int F_115 ( struct V_194 * V_67 , T_4 V_33 )
{
struct V_61 * V_62 = F_109 ( V_67 ) ;
struct V_18 * V_19 = F_79 ( V_62 ) ;
if ( V_19 -> V_45 != 0 ) {
...
static int F_119 ( struct V_194 * V_67 )
{
F_118 ( V_67 , V_207 ) ;
F_120 ( V_67 ) ;
return F_121 ( V_67 ) ;
}
static int F_122 ( struct V_208 * V_209 )
{
struct V_194 * V_67 = F_123 ( V_209 ) ;
struct V_210 V_23 ;
V_23 . V_211 = 0 ;
...
static void F_126 ( struct V_208 * V_209 )
{
struct V_194 * V_67 = F_123 ( V_209 ) ;
struct V_61 * V_62 = F_109 ( V_67 ) ;
struct V_18 * V_19 = F_79 ( V_62 ) ;
...
static int F_127 ( struct V_194 * V_67 , const struct V_213 * V_214 )
{
return F_128 ( V_67 , V_214 , & V_163 ) ;
}
static int T_5 F_129 ( void )
{
int V_24 ;
V_24 = F_130 ( & V_163 , & V_215 ) ;
if ( V_24 )
F_14 ( L_51 ) ;
return V_24 ;
}
