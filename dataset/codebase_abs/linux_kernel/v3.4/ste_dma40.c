...
static enum V_325 F_135 ( struct V_275 * V_4 ,
T_3 V_192 ,
struct V_326 * V_327 )
{
...
V_34 = F_136 ( V_4 , V_192 , V_327 ) ;
if ( V_34 != V_328 )
F_137 ( V_327 , F_108 ( V_4 ) ) ;
if ( F_107 ( V_3 ) )
V_34 = V_329 ;
return V_34 ;
}
...
& V_3 -> V_175 , false ) ;
V_3 -> V_235 = V_355 ;
V_3 -> V_363 = V_352 -> V_289 ;
F_67 ( V_3 -> V_8 -> V_5 ,
L_51
L_52 ,
F_143 ( V_4 ) ,
( V_352 -> V_289 == V_292 ) ? L_53 : L_54 ,
V_353 , V_354 ,
V_356 , V_357 ) ;
return 0 ;
}
static int F_144 ( struct V_275 * V_4 , enum V_364 V_365 ,
unsigned long V_366 )
{
struct V_2 * V_3 = F_85 ( V_4 , struct V_2 , V_4 ) ;
if ( V_3 -> V_11 == NULL ) {
...
static void T_9 F_145 ( struct V_104 * V_8 , struct V_372 * V_373 ,
struct V_2 * V_374 , int V_222 ,
int V_375 )
{
int V_33 = 0 ;
struct V_2 * V_3 ;
F_24 ( & V_373 -> V_376 ) ;
for ( V_33 = V_222 ; V_33 < V_222 + V_375 ; V_33 ++ ) {
V_3 = & V_374 [ V_33 ] ;
V_3 -> V_8 = V_8 ;
V_3 -> V_4 . V_1 = V_373 ;
F_146 ( & V_3 -> V_38 ) ;
...
static void F_148 ( struct V_104 * V_8 , struct V_372 * V_5 )
{
...
if ( F_105 ( V_381 , V_5 -> V_266 ) )
V_5 -> V_382 = F_131 ;
if ( F_105 ( V_383 , V_5 -> V_266 ) )
V_5 -> V_384 = F_133 ;
V_5 -> V_385 = F_123 ;
V_5 -> V_386 = F_127 ;
V_5 -> V_387 = F_138 ;
...
{
int V_193 ;
F_145 ( V_8 , & V_8 -> V_391 , V_8 -> V_392 ,
0 , V_8 -> V_393 ) ;
F_150 ( V_8 -> V_391 . V_266 ) ;
F_151 ( V_268 , V_8 -> V_391 . V_266 ) ;
F_151 ( V_383 , V_8 -> V_391 . V_266 ) ;
F_148 ( V_8 , & V_8 -> V_391 ) ;
V_193 = F_152 ( & V_8 -> V_391 ) ;
if ( V_193 ) {
F_96 ( V_8 -> V_5 , L_55 ) ;
goto V_394;
}
F_145 ( V_8 , & V_8 -> V_395 , V_8 -> V_392 ,
V_8 -> V_393 , V_8 -> V_73 -> V_396 ) ;
F_150 ( V_8 -> V_395 . V_266 ) ;
F_151 ( V_267 , V_8 -> V_395 . V_266 ) ;
F_151 ( V_381 , V_8 -> V_395 . V_266 ) ;
F_148 ( V_8 , & V_8 -> V_395 ) ;
V_193 = F_152 ( & V_8 -> V_395 ) ;
if ( V_193 ) {
F_96 ( V_8 -> V_5 ,
L_56 ) ;
goto V_397;
}
F_145 ( V_8 , & V_8 -> V_398 , V_8 -> V_399 ,
0 , V_390 ) ;
F_150 ( V_8 -> V_398 . V_266 ) ;
F_151 ( V_268 , V_8 -> V_398 . V_266 ) ;
F_151 ( V_267 , V_8 -> V_398 . V_266 ) ;
F_151 ( V_381 , V_8 -> V_398 . V_266 ) ;
F_151 ( V_383 , V_8 -> V_391 . V_266 ) ;
F_148 ( V_8 , & V_8 -> V_398 ) ;
V_193 = F_152 ( & V_8 -> V_398 ) ;
if ( V_193 ) {
F_96 ( V_8 -> V_5 ,
L_57 ) ;
goto V_400;
...
{
struct V_401 * V_402 = F_155 ( V_5 ) ;
struct V_104 * V_8 = F_156 ( V_402 ) ;
int V_34 = 0 ;
if ( ! F_157 ( V_5 ) )
return - V_129 ;
if ( V_8 -> V_403 )
V_34 = F_158 ( V_8 -> V_403 ) ;
return V_34 ;
}
...
for ( V_33 = 0 ; V_8 -> V_73 -> V_416 [ V_33 ] != - 1 ; V_33 ++ ) {
int V_4 = V_8 -> V_73 -> V_416 [ V_33 ] ;
V_8 -> V_107 [ V_4 ] . V_245 = V_248 ;
V_8 -> V_107 [ V_4 ] . V_246 = V_248 ;
V_8 -> V_107 [ V_4 ] . V_108 = true ;
V_410 |= F_164 ( F_165 ( V_4 ) ,
V_414 ) ;
V_410 |= F_164 ( F_165 ( V_4 ) ,
V_415 ) ;
V_408 -- ;
...
F_30 ( V_407 , V_8 -> V_9 + V_405 ) ;
V_8 -> V_404 = V_410 ;
return V_408 ;
}
static struct V_104 * T_9 F_167 ( struct V_401 * V_402 )
{
struct V_290 * V_73 ;
struct V_418 * V_418 = NULL ;
void T_1 * V_9 = NULL ;
struct V_419 * V_188 = NULL ;
...
T_2 V_421 ;
T_10 V_113 ;
V_418 = F_168 ( & V_402 -> V_5 , NULL ) ;
if ( F_169 ( V_418 ) ) {
F_96 ( & V_402 -> V_5 , L_60 ) ;
goto V_422;
}
F_170 ( V_418 ) ;
V_188 = F_171 ( V_402 , V_423 , L_61 ) ;
if ( ! V_188 )
goto V_422;
...
V_8 -> V_73 = V_73 ;
V_8 -> V_5 = & V_402 -> V_5 ;
V_8 -> V_399 = ( ( void * ) V_8 ) + F_45 ( sizeof( struct V_104 ) , 4 ) ;
V_8 -> V_392 = & V_8 -> V_399 [ V_105 ] ;
...
static int T_9 F_188 ( struct V_401 * V_402 )
{
int V_193 ;
int V_34 = - V_455 ;
struct V_104 * V_8 ;
