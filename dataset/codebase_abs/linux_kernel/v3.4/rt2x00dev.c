...
static T_2 * F_60 ( T_2 * V_20 , unsigned int V_99 , T_2 V_100 )
{
struct V_101 * V_102 = ( void * ) V_20 ;
T_2 * V_103 , * V_104 ;
V_103 = ( T_2 * ) V_102 -> V_105 . V_106 . V_107 ;
V_104 = V_20 + V_99 ;
while ( V_103 < V_104 ) {
if ( V_103 + 2 + V_103 [ 1 ] > V_104 )
return NULL ;
if ( V_103 [ 0 ] == V_100 )
return V_103 ;
V_103 += 2 + V_103 [ 1 ] ;
...
{
struct V_1 * V_2 =
F_25 ( V_27 , struct V_1 , V_108 ) ;
if ( ! F_3 ( V_31 , & V_2 -> V_11 ) )
return;
if ( ! F_3 ( V_33 , & V_2 -> V_11 ) )
F_62 ( V_2 , & V_2 -> V_29 -> V_109 ,
V_110 ) ;
}
...
struct V_111 * V_112 )
{
struct V_113 * V_114 = ( void * ) V_35 -> V_20 ;
struct V_115 * V_116 ;
T_2 * V_117 ;
T_2 V_118 ;
bool V_119 ;
if ( F_64 ( ! F_65 ( V_114 -> V_120 ) ||
! ( V_2 -> V_29 -> V_109 . V_11 & V_121 ) ) )
return;
if ( V_35 -> V_99 <= 40 + V_122 )
return;
if ( ! ( V_112 -> V_123 & V_124 ) ||
! V_2 -> V_125 )
return;
V_2 -> V_126 = V_127 ;
V_117 = F_60 ( V_35 -> V_20 , V_35 -> V_99 - V_122 , V_128 ) ;
if ( ! V_117 )
return;
if ( V_117 [ 1 ] < sizeof( * V_116 ) )
return;
V_118 = V_117 [ 1 ] ;
V_116 = (struct V_115 * ) & V_117 [ 2 ] ;
V_119 = F_66 ( V_116 , V_118 , V_2 -> V_125 ) ;
V_119 |= ( V_116 -> V_129 & 0x01 ) ;
if ( ! V_119 && ! F_3 ( V_33 , & V_2 -> V_11 ) )
F_67 ( V_2 -> V_130 , & V_2 -> V_108 ) ;
}
...
unsigned int V_55 ;
int signal = V_112 -> signal ;
int type = ( V_112 -> V_123 & V_135 ) ;
switch ( V_112 -> V_136 ) {
case V_137 :
case V_138 :
if ( V_112 -> V_123 & V_139 )
signal = F_69 ( V_112 -> V_136 , signal ) ;
V_132 = & V_2 -> V_140 [ V_2 -> V_141 ] ;
for ( V_55 = 0 ; V_55 < V_132 -> V_142 ; V_55 ++ ) {
V_134 = F_70 ( V_132 -> V_143 [ V_55 ] . V_144 ) ;
if ( ( ( type == V_145 ) &&
( V_134 -> V_146 == signal ) ) ||
( ( type == V_147 ) &&
( V_134 -> V_148 == signal ) ) ||
...
V_2 -> V_7 -> V_12 -> V_156 ( V_42 , & V_112 ) ;
if ( F_74 ( V_112 . V_157 == 0 ||
V_112 . V_157 > V_42 -> V_49 -> V_158 ) ) {
F_71 ( V_2 , L_4 ,
V_112 . V_157 , V_42 -> V_49 -> V_158 ) ;
F_75 ( V_42 -> V_35 ) ;
goto V_159;
...
( V_112 . V_123 & V_162 ) )
F_48 ( V_42 -> V_35 , V_54 ) ;
F_77 ( V_42 -> V_35 , V_112 . V_157 ) ;
V_56 = F_68 ( V_2 , & V_112 ) ;
if ( V_112 . V_136 == V_150 ||
V_112 . V_136 == V_151 )
V_112 . V_11 |= V_163 ;
F_63 ( V_2 , V_42 -> V_35 , & V_112 ) ;
F_78 ( V_2 , V_42 -> V_35 , & V_112 ) ;
F_79 ( V_2 , & V_112 ) ;
F_50 ( V_2 , V_164 , V_42 -> V_35 ) ;
V_153 = F_80 ( V_42 -> V_35 ) ;
V_153 -> V_165 = V_112 . V_166 ;
V_153 -> V_167 = V_2 -> V_141 ;
V_153 -> V_168 = V_2 -> V_169 ;
V_153 -> V_56 = V_56 ;
V_153 -> signal = V_112 . V_170 ;
V_153 -> V_171 = V_112 . V_11 ;
...
const T_3 V_186 , const struct V_133 * V_134 )
{
V_42 -> V_11 = 0 ;
V_42 -> V_148 = V_134 -> V_148 ;
V_42 -> V_144 = V_186 ;
V_42 -> V_187 = V_186 ;
if ( V_134 -> V_11 & V_188 )
V_42 -> V_11 |= V_189 ;
...
V_2 -> V_140 [ V_180 ] . V_205 = 14 ;
V_2 -> V_140 [ V_180 ] . V_142 = V_194 ;
V_2 -> V_140 [ V_180 ] . V_193 = V_193 ;
V_2 -> V_140 [ V_180 ] . V_143 = V_78 ;
V_29 -> V_206 -> V_140 [ V_180 ] =
& V_2 -> V_140 [ V_180 ] ;
memcpy ( & V_2 -> V_140 [ V_180 ] . V_207 ,
& V_191 -> V_208 , sizeof( V_191 -> V_208 ) ) ;
}
if ( V_191 -> V_203 & V_209 ) {
V_2 -> V_140 [ V_181 ] . V_205 =
V_191 -> V_198 - 14 ;
V_2 -> V_140 [ V_181 ] . V_142 =
V_194 - 4 ;
V_2 -> V_140 [ V_181 ] . V_193 = & V_193 [ 14 ] ;
V_2 -> V_140 [ V_181 ] . V_143 = & V_78 [ 4 ] ;
V_29 -> V_206 -> V_140 [ V_181 ] =
& V_2 -> V_140 [ V_181 ] ;
memcpy ( & V_2 -> V_140 [ V_181 ] . V_207 ,
& V_191 -> V_208 , sizeof( V_191 -> V_208 ) ) ;
}
return 0 ;
V_201:
...
F_89 ( V_2 -> V_29 ) ;
if ( F_64 ( V_2 -> V_29 -> V_206 -> V_140 [ V_180 ] ) ) {
F_87 ( V_2 -> V_29 -> V_206 -> V_140 [ V_180 ] -> V_193 ) ;
F_87 ( V_2 -> V_29 -> V_206 -> V_140 [ V_180 ] -> V_143 ) ;
V_2 -> V_29 -> V_206 -> V_140 [ V_180 ] = NULL ;
V_2 -> V_29 -> V_206 -> V_140 [ V_181 ] = NULL ;
}
...
F_107 ( & V_2 -> V_238 ) ;
F_7 ( V_31 , & V_2 -> V_11 ) ;
V_2 -> V_29 -> V_239 = sizeof( struct V_22 ) ;
V_2 -> V_29 -> V_206 -> V_240 = F_108 ( V_241 ) ;
if ( V_2 -> V_7 -> V_242 -> V_221 > 0 )
V_2 -> V_29 -> V_206 -> V_240 |=
F_108 ( V_37 ) |
F_108 ( V_36 ) |
F_108 ( V_38 ) |
F_108 ( V_39 ) ;
V_2 -> V_130 =
F_109 ( F_110 ( V_2 -> V_29 -> V_206 ) , 0 ) ;
if ( ! V_2 -> V_130 ) {
V_231 = - V_200 ;
goto exit;
}
F_111 ( & V_2 -> V_28 , F_24 ) ;
F_112 ( & V_2 -> V_30 , F_27 ) ;
F_111 ( & V_2 -> V_108 , F_61 ) ;
V_231 = V_2 -> V_7 -> V_12 -> V_243 ( V_2 ) ;
if ( V_231 ) {
ERROR ( V_2 , L_6 ) ;
goto exit;
}
...
int F_129 ( struct V_1 * V_2 , T_5 V_247 )
{
F_130 ( V_2 , L_8 ) ;
...
F_131 ( V_2 ) ;
F_125 ( V_2 ) ;
if ( V_2 -> V_7 -> V_12 -> V_13 ( V_2 , V_248 ) )
F_71 ( V_2 , L_9
L_10 ) ;
return 0 ;
}
