...
#endif
V_17 = F_67 ( sizeof( struct V_16 ) , V_90 ) ;
if ( ! V_17 ) {
V_23 = - V_91 ;
goto V_92;
}
...
V_23 = F_71 ( & V_2 -> V_10 . V_95 , & V_96 ) ;
if ( V_23 )
goto V_97;
V_88 = F_1 ( V_2 , V_98 ) & 0x10 ;
if ( V_88 ) {
V_23 = F_71 ( & V_2 -> V_10 . V_95 ,
& V_99 ) ;
if ( V_23 )
goto V_100;
}
V_17 -> V_101 = F_72 ( V_10 ) ;
if ( F_73 ( V_17 -> V_101 ) ) {
V_23 = F_74 ( V_17 -> V_101 ) ;
goto V_102;
}
return 0 ;
V_102:
if ( V_88 )
F_75 ( & V_2 -> V_10 . V_95 , & V_99 ) ;
V_100:
F_75 ( & V_2 -> V_10 . V_95 , & V_96 ) ;
V_97:
if ( V_17 -> V_74 [ 0 ] != NULL )
F_61 ( V_17 -> V_74 [ 0 ] ) ;
if ( V_17 -> V_74 [ 1 ] != NULL )
...
V_103 = F_1 ( V_2 , V_25 [ 1 ] ) ;
F_3 ( V_2 , V_25 [ 1 ] , V_103 & 0xef ) ;
if ( V_106 ) {
V_103 = F_1 ( V_2 , V_108 ) ;
if ( V_103 & 1 ) {
F_3 ( V_2 , V_108 ,
...
T_1 V_33 ;
F_15 ( & V_17 -> V_24 ) ;
if ( F_80 ( V_112 , V_17 -> V_113 + ( V_114 * 3 ) )
|| ! V_17 -> V_115 ) {
F_66 ( V_10 , L_10 ) ;
...
V_17 -> V_28 [ 0 ] = ( V_111 [ 0 ] >> 4 ) & 0x03 ;
V_17 -> V_28 [ 1 ] = ( V_111 [ 0 ] >> 6 ) & 0x03 ;
V_17 -> V_28 [ 2 ] = ( V_111 [ 1 ] >> 6 ) & 0x03 ;
V_17 -> V_28 [ 3 ] = V_111 [ 2 ] & 0x07 ;
V_17 -> V_28 [ 4 ] = ( V_111 [ 2 ] >> 4 ) & 0x07 ;
V_33 = F_1 ( V_2 , V_40 ) ;
for ( V_8 = 0 ; V_8 < 3 ; V_8 ++ )
...
V_17 -> V_43 [ 0 ] = ( V_111 [ 0 ] >> 2 ) & 0x03 ;
V_17 -> V_43 [ 1 ] = ( V_111 [ 0 ] >> 4 ) & 0x03 ;
V_17 -> V_43 [ 2 ] = ( V_111 [ 1 ] >> 2 ) & 0x03 ;
for ( V_8 = 0 ; V_8 < 3 ; V_8 ++ ) {
...
V_17 -> V_52 [ 0 ] = V_111 [ 0 ] & 0x0f ;
V_17 -> V_52 [ 1 ] = ( V_111 [ 0 ] >> 4 ) & 0x0f ;
V_17 -> V_52 [ 2 ] = V_111 [ 1 ] & 0x0f ;
for ( V_8 = 0 ; V_8 < 3 ; V_8 ++ ) {
...
static void F_81 ( struct V_16 * V_17 , struct V_9 * V_10 )
{
int V_8 = 0 , V_110 = 0 ;
F_66 ( V_10 , L_11 ) ;
F_66 ( V_10 , L_12 , V_116 ) ;
for ( V_8 = 0 ; V_8 < V_116 ; V_8 ++ ) {
F_66 ( V_10 , L_13 , V_8 , V_17 -> V_117 [ V_8 ] ) ;
F_66 ( V_10 , L_14 , V_8 , V_17 -> V_121 [ V_8 ] ) ;
F_66 ( V_10 , L_15 , V_8 , V_17 -> V_119 [ V_8 ] ) ;
}
F_66 ( V_10 , L_16 , V_94 ) ;
for ( V_8 = 0 ; V_8 < V_94 ; V_8 ++ ) {
F_66 ( V_10 , L_17 , V_8 , V_17 -> V_123 [ V_8 ] ) ;
F_66 ( V_10 , L_18 , V_8 , V_17 -> V_27 [ V_8 ] ) ;
F_66 ( V_10 , L_19 , V_8 , V_17 -> V_28 [ V_8 ] ) ;
}
F_66 ( V_10 , L_20 , V_130 ) ;
for ( V_8 = 0 ; V_8 < 3 ; V_8 ++ )
F_66 ( V_10 , L_21 , V_8 , ( T_1 ) V_17 -> V_55 [ V_8 ] ) ;
for ( V_8 = 0 ; V_8 < 2 ; V_8 ++ ) {
for ( V_110 = 0 ; V_110 < 3 ; V_110 ++ ) {
F_66 ( V_10 , L_22 , V_8 , V_110 ,
( V_131 ) V_17 -> V_58 [ V_8 ] [ V_110 ] ) ;
}
}
F_66 ( V_10 , L_23 ) ;
