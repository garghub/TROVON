...
static int F_121 ( struct V_325 * V_279 )
{
struct V_340 * V_341 = V_279 -> V_342 ;
struct V_343 * V_344 = F_122 ( V_341 ) ;
struct V_187 * V_188 = F_62 ( V_279 ) ;
V_188 -> V_2 = V_344 -> V_2 ;
V_279 -> V_345 . V_346 = sizeof( struct V_189 ) ;
return 0 ;
}
static int F_123 ( struct V_1 * V_2 , struct V_347 * V_248 )
{
struct V_343 * V_341 ;
int V_275 ;
V_341 = F_124 ( sizeof( struct V_343 ) , V_348 ) ;
if ( ! V_341 )
return - V_349 ;
...
V_341 -> V_341 . V_369 = F_121 ;
V_341 -> V_2 = V_2 ;
F_125 ( & V_341 -> V_370 , & V_2 -> V_371 ) ;
V_275 = F_126 ( & V_341 -> V_341 ) ;
if ( V_275 ) {
F_127 ( & V_341 -> V_370 ) ;
F_128 ( V_341 ) ;
}
...
static int T_10 F_134 ( struct V_373 * V_54 , const struct V_374 * V_375 )
{
int V_275 , V_8 ;
struct V_1 * V_2 ;
char V_11 [ 8 ] ;
...
V_2 = F_124 ( sizeof( struct V_1 ) + sizeof( struct V_340 ) ,
V_348 ) ;
if ( ! V_2 ) {
V_275 = - V_349 ;
goto V_381;
...
V_2 -> V_224 [ V_8 ] = NULL ;
F_147 ( V_54 , V_2 ) ;
F_148 ( & V_2 -> V_308 , F_133 , ( unsigned long ) V_2 ) ;
F_149 ( & V_2 -> V_305 , 1 ) ;
V_275 = F_150 ( V_2 -> V_310 , F_81 , V_383 , V_2 -> V_11 , V_2 ) ;
if ( V_275 ) {
...
static void T_11 F_158 ( struct V_373 * V_54 )
{
int V_8 ;
struct V_1 * V_2 ;
V_2 = F_159 ( V_54 ) ;
