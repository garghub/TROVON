...
static int T_5 F_48 ( struct V_112 * V_113 )
{
struct V_1 * V_2 ;
...
int V_56 ;
int V_81 = 0 ;
V_118 = F_49 ( V_113 , V_122 , 0 ) ;
if ( ! V_118 ) {
F_41 ( & V_113 -> V_19 , L_6 ) ;
return - V_82 ;
}
V_119 = F_50 ( V_118 -> V_123 , F_51 ( V_118 ) , V_113 -> V_124 ) ;
if ( ! V_119 ) {
F_41 ( & V_113 -> V_19 , L_7 ) ;
return - V_109 ;
}
V_5 = F_52 ( V_119 -> V_123 , F_51 ( V_119 ) ) ;
if ( ! V_5 ) {
F_41 ( & V_113 -> V_19 , L_8 ) ;
return - V_125 ;
}
V_118 = F_49 ( V_113 , V_126 , 0 ) ;
if ( ! V_118 ) {
F_41 ( & V_113 -> V_19 , L_9 ) ;
V_81 = - V_82 ;
goto V_127;
...
V_56 = V_118 -> V_123 ;
V_41 = F_53 ( & V_113 -> V_19 , NULL ) ;
if ( F_54 ( V_41 ) ) {
F_41 ( & V_113 -> V_19 , L_10 ) ;
V_81 = F_55 ( V_41 ) ;
goto V_128;
}
V_120 = F_53 ( & V_113 -> V_19 , L_11 ) ;
if ( F_54 ( V_120 ) ) {
F_41 ( & V_113 -> V_19 , L_12 ) ;
V_81 = F_55 ( V_120 ) ;
goto V_129;
}
V_2 = F_56 ( sizeof( struct V_1 ) , V_130 ) ;
if ( ! V_2 ) {
V_81 = - V_125 ;
goto V_131;
}
...
V_121 = F_57 ( V_2 -> V_19 -> V_136 ,
L_13 , NULL ) ;
if ( V_121 )
V_2 -> V_46 = F_58 ( V_121 ) ;
}
if ( V_113 -> V_19 . V_136 )
V_2 -> V_6 = F_59 ( V_113 -> V_19 . V_136 ,
L_14 ) ;
...
V_81 = F_62 ( V_2 -> V_56 , F_31 , 0 , V_113 -> V_124 , V_2 ) ;
if ( V_81 ) {
...
F_69 ( V_41 ) ;
V_128:
F_70 ( V_119 -> V_123 , F_51 ( V_119 ) ) ;
V_127:
F_71 ( V_5 ) ;
return V_81 ;
}
static int T_7 F_72 ( struct V_112 * V_113 )
{
...
F_69 ( V_2 -> V_120 ) ;
F_69 ( V_2 -> V_41 ) ;
F_70 ( V_2 -> V_119 -> V_123 ,
F_51 ( V_2 -> V_119 ) ) ;
F_71 ( V_2 -> V_5 ) ;
F_68 ( V_2 ) ;
return 0 ;
}
static int F_75 ( struct V_112 * V_113 , T_8 V_145 )
{
struct V_1 * V_2 = F_73 ( V_113 ) ;
F_76 ( & V_2 -> V_132 ) ;
V_2 -> V_108 = true ;
...
static int F_78 ( struct V_112 * V_113 )
{
struct V_1 * V_2 = F_73 ( V_113 ) ;
int V_81 ;
F_76 ( & V_2 -> V_132 ) ;
