...
if ( V_24 == 0 )
F_64 ( V_284 , ( void * ) V_272 ) ;
return V_274 ;
}
static int T_7 F_65 ( struct V_271 * V_272 )
{
struct V_51 * V_52 = F_66 ( V_272 ) ;
struct V_22 * V_23 ;
struct V_18 * V_105 ;
int V_24 ;
F_6 ( NULL , V_52 ) ;
...
F_64 ( F_60 ( V_272 , 0 ) , ( void * ) V_272 ) ;
return 0 ;
}
static int F_69 ( struct V_285 * V_272 )
{
struct V_51 * V_52 = F_70 ( V_272 ) ;
F_6 ( NULL , V_52 ) ;
V_32 -> V_77 = 0 ;
F_5 () ;
return 0 ;
}
static int F_71 ( struct V_285 * V_272 )
{
struct V_51 * V_52 = F_70 ( V_272 ) ;
struct V_18 * V_105 ;
int V_19 ;
