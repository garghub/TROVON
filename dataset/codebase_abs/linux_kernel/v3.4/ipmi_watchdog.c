...
static int F_54 ( struct V_114 * V_115 , struct V_77 * V_116 )
{
switch ( F_55 ( V_115 ) ) {
case V_117 :
if ( F_56 ( 0 , & V_118 ) )
...
static unsigned int F_58 ( struct V_77 * V_77 , T_7 * V_104 )
{
unsigned int V_121 = 0 ;
F_59 ( V_77 , & V_111 , V_104 ) ;
F_46 ( & V_105 ) ;
if ( V_106 )
V_121 |= ( V_122 | V_123 ) ;
F_50 ( & V_105 ) ;
...
static int F_60 ( int V_124 , struct V_77 * V_77 , int V_125 )
{
int V_126 ;
V_126 = F_61 ( V_124 , V_77 , V_125 , & V_127 ) ;
return ( V_126 ) ;
}
static int F_62 ( struct V_114 * V_115 , struct V_77 * V_116 )
{
if ( F_55 ( V_115 ) == V_117 ) {
if ( V_101 == 42 ) {
V_36 = V_37 ;
...
static int
F_79 ( unsigned int V_1 , struct V_147 * V_148 )
{
if ( V_144 ) {
V_144 = 2 ;
return V_149 ;
...
static void F_82 ( int V_163 , struct V_164 * V_164 )
{
F_11 ( V_163 ) ;
}
static void F_83 ( int V_163 )
{
F_10 ( V_163 ) ;
}
...
static int F_86 ( const char * V_165 , char * V_166 )
{
if ( V_166 )
strcpy ( V_166 , V_173 ) ;
if ( ! V_165 )
