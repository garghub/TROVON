...
static void F_6 ( struct V_10 * V_11 , int div , int * V_12 )
{
int V_13 ;
V_11 -> V_14 = 0 ;
...
static int F_7 ( struct V_10 * V_11 , long V_19 , long V_20 , int V_21 )
{
long V_22 , V_23 ;
int V_24 ;
...
static void F_9 ( struct V_10 * V_11 , int div , int * V_12 )
{
F_6 ( V_11 , div , V_12 ) ;
V_11 -> V_28 = 0 ;
...
static void F_10 ( struct V_10 * V_11 , unsigned long V_15 ,
unsigned long V_14 )
{
...
static int F_11 ( struct V_10 * V_11 , long V_19 , long V_20 )
{
...
static int F_12 ( struct V_10 * V_11 , unsigned char V_31 )
{
int V_26 , V_24 ;
struct V_10 V_32 ;
V_32 = * V_11 ;
for ( V_26 = 0 ; V_26 < 8 ; V_26 ++ ) {
V_24 = F_7 ( V_11 , V_11 -> V_18 - V_11 -> V_12 [ V_26 ] ,
...
for ( V_26 = 0 ; V_26 < 8 ; V_26 ++ )
V_33 |= F_11 ( V_11 , V_18 - V_11 -> V_12 [ V_26 ] ,
V_11 -> V_12 [ V_26 ] ) << V_26 ;
return V_33 ;
}
static int F_14 ( int V_18 , int * V_12 , unsigned char * V_34 ,
...
F_6 ( & V_11 , V_18 , V_12 ) ;
while ( V_39 < ( * V_36 ) && ! F_12 ( & V_11 , V_34 [ V_39 ] ) )
V_39 ++ ;
F_8 ( & V_11 ) ;
if ( V_38 > V_39 ) {
return - 1 ;
...
static int F_15 ( unsigned char * V_34 ,
unsigned char * V_35 ,
T_1 * V_36 , T_1 * V_37 )
{
int V_12 [ 8 ] ;
...
V_24 = F_14 ( 256 , V_12 , V_34 , V_35 + 8 , & V_41 ,
& V_42 ) ;
if ( V_24 )
return V_24 ;
V_42 += 8 ;
...
static void F_16 ( int V_18 , int * V_12 ,
unsigned char * V_43 ,
...
static int F_18 ( unsigned char * V_34 ,
unsigned char * V_35 ,
T_1 V_36 , T_1 V_37 )
{
int V_12 [ 8 ] ;
...
for ( V_13 = 0 ; V_13 < 8 ; V_13 ++ )
V_12 [ V_13 ] = V_34 [ V_13 ] ;
F_16 ( 256 , V_12 , V_34 + 8 , V_35 , V_36 - 8 ,
V_37 ) ;
return 0 ;
}
int F_19 ( void )
