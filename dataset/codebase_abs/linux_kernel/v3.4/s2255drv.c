...
V_48 -> V_334 = V_330 ;
V_48 -> V_335 = F_130 ( V_329 [ 4 ] ) ;
break;
case V_336 :
V_326 += V_199 ;
V_328 += V_199 ;
if ( F_130 ( V_329 [ 1 ] ) >= V_314 )
break;
V_327 = V_206 [ F_130 ( V_329 [ 1 ] ) ] ;
if ( V_327 >= V_314 )
break;
...
static void F_131 ( struct V_1 * V_25 ,
struct V_319 * V_320 )
{
int V_204 ;
F_12 ( 50 , L_89 ) ;
...
int V_350 ;
if ( ! V_349 ) {
V_350 = F_132 ( V_25 -> V_39 , F_133 ( V_25 -> V_39 , 0 ) ,
V_344 ,
V_351 | V_352 |
V_353 ,
V_346 , V_345 , V_347 ,
...
V_350 = F_132 ( V_25 -> V_39 , F_134 ( V_25 -> V_39 , 0 ) ,
V_344 , V_351 | V_352 ,
V_346 , V_345 , V_347 ,
V_348 , V_354 * 5 ) ;
}
...
static int F_135 ( struct V_1 * V_25 )
{
int V_45 ;
int V_153 ;
...
static int F_136 ( struct V_47 * V_48 )
{
unsigned long V_23 ;
unsigned long V_358 ;
F_12 ( 1 , L_95 ) ;
...
V_48 -> V_78 . V_79 [ V_23 ] . V_80 = F_137 ( V_358 ) ;
F_12 ( 1 , L_96 ,
...
F_12 ( 1 , L_99 ,
V_48 -> V_78 . V_79 [ V_23 ] . V_80 ) ;
F_139 ( V_48 -> V_78 . V_79 [ V_23 ] . V_80 ) ;
}
...
F_142 ( V_25 ) ;
for ( V_23 = 0 ; V_23 < V_314 ; V_23 ++ )
F_138 ( & V_25 -> V_48 [ V_23 ] ) ;
F_74 ( V_25 -> V_182 . V_331 ) ;
return 0 ;
}
static void F_143 ( struct V_36 * V_367 )
{
struct V_319 * V_320 ;
struct V_1 * V_25 ;
int V_41 ;
...
V_182 = F_144 ( V_25 -> V_39 , V_25 -> V_370 ) ;
...
static void F_142 ( struct V_1 * V_25 )
{
struct V_319 * V_182 = & V_25 -> V_182 ;
V_182 -> V_87 = 0 ;
if ( V_182 -> V_371 ) {
...
F_20 , F_17 ,
V_25 -> V_290 ) ;
F_146 ( & V_25 -> V_305 , V_375 + V_354 ) ;
}
static int F_147 ( struct V_376 * V_313 ,
...
V_25 -> V_242 = F_130 ( * V_397 ) ;
if ( V_25 -> V_242 < V_398 )
F_14 ( V_296 L_128 ) ;
if ( V_25 -> V_245 == 0x2257 &&
V_25 -> V_242 < V_256 )
F_14 ( V_318 L_129
L_130 , V_256 ) ;
}
...
static void F_157 ( struct V_376 * V_313 )
{
struct V_1 * V_25 = F_1 ( F_158 ( V_313 ) ) ;
int V_23 ;
