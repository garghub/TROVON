...
static void F_105 ( struct V_8 * V_9 , struct V_43 * V_44 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
struct V_61 * V_62 = F_65 ( V_44 ) ;
int V_13 ;
...
static int F_108 ( struct V_8 * V_9 , struct V_84 * V_171 ,
struct V_172 * V_173 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
struct V_43 * V_44 ;
...
continue;
V_85 = (struct V_84 * ) V_44 -> V_89 ;
if ( F_110 ( ! memcmp ( V_85 -> V_174 , V_171 -> V_90 , V_15 ) ) )
{
V_82 = 1 ;
break;
}
...
int F_111 ( struct V_8 * V_9 , const T_1 * V_175 , unsigned int V_176 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
struct V_172 V_173 ;
...
V_173 . V_188 = V_189 [ F_112 ( & V_11 -> V_16 ) - 1 ] . V_190 ;
V_173 . V_191 = V_192 ;
V_173 . signal = F_3 ( V_9 , V_70 -> V_193 ) ;
V_75 = F_113 ( V_175 , V_70 ) ;
...
V_175 += V_181 ;
if ( ! V_178 &&
F_108 ( V_9 , (struct V_84 * ) V_175 , & V_173 )
&& ! V_11 -> V_28 )
return 0 ;
V_179 = F_114 ( ( T_4 * ) V_175 ) ;
V_180 = F_115 ( V_179 ) ^ F_116 ( V_179 ) ;
V_44 = F_117 ( V_176 + ( V_180 ? 2 : 0 ) ) ;
if ( V_44 == NULL )
return - V_146 ;
if ( V_180 ) {
F_118 ( V_44 , 2 ) ;
}
memcpy ( F_119 ( V_44 , V_176 ) , V_175 , V_176 ) ;
memcpy ( F_120 ( V_44 ) , & V_173 , sizeof( V_173 ) ) ;
F_121 ( V_9 , V_44 ) ;
return 0 ;
}
...
V_11 -> type = V_198 ;
V_11 -> V_31 = NULL ;
F_63 ( & V_11 -> V_16 , 0 , 0 , V_198 ) ;
F_31 ( & V_11 -> V_16 , NULL ) ;
F_86 ( V_11 ) ;
}
static int F_124 ( struct V_8 * V_9 , T_2 V_202 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
...
F_17 ( & V_11 -> V_21 ) ;
return F_59 ( & V_11 -> V_16 , V_204 -> V_52 -> V_92 ) ;
}
...
static void F_129 ( struct V_205 * V_206 )
{
T_3 V_207 ;
unsigned long V_25 ;
struct V_10 * V_11 = F_130 ( V_206 , struct V_10 , V_208 ) ;
F_27 ( & V_11 -> V_21 , V_25 ) ;
V_207 = F_104 ( * ( T_4 * ) ( V_11 -> V_209 + 4 ) ) ;
F_28 ( & V_11 -> V_21 , V_25 ) ;
if ( V_207 & V_210 ) {
F_125 ( V_11 ) ;
} else {
...
F_34 ( & V_34 ) ;
F_132 (ha, mc_list) {
F_58 ( F_6 ( V_11 ) , L_15 , V_214 -> V_14 ) ;
F_133 ( & V_34 , V_214 -> V_14 ) ;
}
...
F_17 ( & V_11 -> V_21 ) ;
F_60 ( V_11 , V_226 -> V_236 ) ;
}
}
static T_5 F_139 ( struct V_8 * V_9 , struct V_197 * V_31 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
return F_140 ( & V_11 -> V_16 ) ;
}
struct V_8 * F_141 ( struct V_237 * V_157 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
V_9 = F_142 ( sizeof( struct V_10 ) , & V_238 ) ;
if ( ! V_9 ) {
F_58 ( & V_157 -> V_239 , L_18 ) ;
return NULL ;
}
V_11 = F_4 ( V_9 ) ;
...
F_147 ( V_11 ) ;
F_148 ( V_11 ) ;
F_149 ( & V_11 -> V_208 , F_129 ) ;
F_150 ( V_9 , & V_157 -> V_239 ) ;
return V_9 ;
}
static void F_151 ( struct V_205 * V_206 )
{
struct V_10 * V_11 =
F_130 ( V_206 , struct V_10 , V_47 . V_252 . V_206 ) ;
struct V_43 * V_47 ;
unsigned long V_253 ;
int V_53 , V_54 ;
if ( ! F_126 ( V_42 , & V_11 -> V_25 ) )
...
V_254:
F_154 ( V_24 , & V_11 -> V_47 . V_252 ,
V_255 ) ;
}
static void F_148 ( struct V_10 * V_11 )
{
F_155 ( & V_11 -> V_47 . V_252 , F_151 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_156 ( & V_11 -> V_47 . V_252 ) ;
F_86 ( V_11 ) ;
}
static void F_157 ( struct V_205 * V_206 )
{
struct V_10 * V_11 =
F_130 ( V_206 , struct V_10 , V_256 . V_257 . V_206 ) ;
struct V_17 * V_16 = & V_11 -> V_16 ;
int V_258 ;
int V_13 ;
if ( ! F_126 ( V_42 , & V_11 -> V_25 ) )
...
V_259:
F_154 ( V_24 , & V_11 -> V_256 . V_257 ,
V_262 ) ;
}
static void F_147 ( struct V_10 * V_11 )
{
F_155 ( & V_11 -> V_256 . V_257 , F_157 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_156 ( & V_11 -> V_256 . V_257 ) ;
F_158 ( & V_11 -> V_16 , V_263 ) ;
}
