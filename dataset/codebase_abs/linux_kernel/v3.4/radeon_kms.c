...
if ( F_8 ( V_2 ) ) {
V_6 |= V_12 ;
} else if ( F_9 ( V_2 -> V_11 ) ) {
V_6 |= V_13 ;
} else {
V_6 |= V_14 ;
}
V_7 = F_10 ( V_4 , V_2 , V_2 -> V_11 , V_6 ) ;
if ( V_7 ) {
F_11 ( & V_2 -> V_11 -> V_2 , L_1 ) ;
goto V_15;
}
V_8 = F_12 ( V_4 ) ;
if ( V_8 )
F_13 ( & V_2 -> V_11 -> V_2 , L_2 ) ;
V_7 = F_14 ( V_4 ) ;
if ( V_7 )
F_11 ( & V_2 -> V_11 -> V_2 , L_3 ) ;
V_15:
if ( V_7 )
F_1 ( V_2 ) ;
return V_7 ;
...
V_19 = V_4 -> V_57 . V_61 . V_88 ;
else if ( V_4 -> V_42 >= V_43 )
V_19 = V_4 -> V_57 . V_62 . V_89 ;
else if ( V_4 -> V_42 >= V_63 )
V_19 = V_4 -> V_57 . V_64 . V_89 ;
else if ( V_4 -> V_42 >= V_65 )
V_19 = V_4 -> V_57 . V_66 . V_89 ;
else {
return - V_53 ;
}
break;
...
int F_27 ( struct V_1 * V_2 , struct V_16 * V_90 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
V_90 -> V_91 = NULL ;
if ( V_4 -> V_42 >= V_60 ) {
struct V_92 * V_93 ;
int V_7 ;
V_93 = F_6 ( sizeof( * V_93 ) , V_9 ) ;
if ( F_28 ( ! V_93 ) ) {
return - V_10 ;
}
V_7 = F_29 ( V_4 , & V_93 -> V_94 ) ;
if ( V_7 ) {
F_30 ( V_4 , & V_93 -> V_94 ) ;
F_4 ( V_93 ) ;
return V_7 ;
...
T_2 F_33 ( struct V_1 * V_2 , int V_30 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
return F_34 ( V_4 , V_30 ) ;
}
int F_35 ( struct V_1 * V_2 , int V_30 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_30 < 0 || V_30 >= V_4 -> V_47 ) {
F_23 ( L_10 , V_30 ) ;
...
V_4 -> V_95 . V_96 [ V_30 ] = true ;
return F_36 ( V_4 ) ;
}
void F_37 ( struct V_1 * V_2 , int V_30 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_30 < 0 || V_30 >= V_4 -> V_47 ) {
F_23 ( L_10 , V_30 ) ;
...
V_4 -> V_95 . V_96 [ V_30 ] = false ;
F_36 ( V_4 ) ;
}
int F_38 ( struct V_1 * V_2 , int V_30 ,
int * V_97 ,
struct V_98 * V_99 ,
unsigned V_6 )
{
struct V_29 * V_100 ;
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_30 < 0 || V_30 >= V_2 -> V_101 ) {
F_23 ( L_10 , V_30 ) ;
return - V_53 ;
}
V_100 = & V_4 -> V_27 . V_48 [ V_30 ] -> V_49 ;
return F_39 ( V_2 , V_30 , V_97 ,
V_99 , V_6 ,
V_100 ) ;
}
int F_40 ( struct V_1 * V_2 , void * V_21 ,
struct V_16 * V_90 )
{
return - V_53 ;
}
