...
const struct V_4 * V_5 )
{
return F_84 ( V_3 , (union V_171 * ) V_5 , V_48 ) ;
}
static struct V_1 * F_85 ( struct V_2 * V_3 ,
struct V_2 * V_172 )
{
return F_1 ( V_3 , & F_15 ( V_172 ) -> V_14 ) ;
}
...
static int F_87 ( struct V_2 * V_3 , char T_8 * V_173 ,
int V_174 )
{
struct V_175 V_176 ;
struct V_25 * V_177 = (struct V_25 * ) & V_176 . V_178 ;
if ( V_174 < sizeof( V_176 ) )
return - V_46 ;
if ( F_88 ( & V_176 , V_173 , sizeof( V_176 ) ) )
return - V_179 ;
if ( V_177 -> V_47 != V_48 )
return - V_46 ;
if ( ! V_176 . V_180 ) {
if ( F_89 ( & V_177 -> V_56 ) )
return F_90 ( V_3 , (union V_171 * ) & V_177 -> V_56 . V_19 [ 3 ] ,
V_73 ) ;
return F_90 ( V_3 , (union V_171 * ) & V_177 -> V_56 ,
V_48 ) ;
}
if ( V_176 . V_180 > V_181 )
return - V_46 ;
if ( F_89 ( & V_177 -> V_56 ) )
return F_91 ( V_3 , (union V_171 * ) & V_177 -> V_56 . V_19 [ 3 ] ,
V_73 , V_176 . V_182 , V_176 . V_180 , V_183 ) ;
return F_91 ( V_3 , (union V_171 * ) & V_177 -> V_56 ,
V_48 , V_176 . V_182 , V_176 . V_180 , V_183 ) ;
}
static int F_92 ( struct V_184 * V_185 ,
const struct V_4 * V_14 ,
const struct V_4 * V_13 , int V_186 )
{
struct V_187 * V_188 ;
struct V_189 V_190 ;
V_188 = & V_185 -> V_191 . V_192 ;
V_188 -> V_13 = * V_13 ;
V_188 -> V_14 = * V_14 ;
V_188 -> V_193 = F_93 ( V_16 ) ;
V_188 -> V_12 = F_93 ( V_186 ) ;
F_94 ( & V_190 , V_188 , sizeof( * V_188 ) ) ;
return F_95 ( & V_185 -> V_194 , & V_190 , sizeof( * V_188 ) ) ;
}
static int F_96 ( char * V_195 , struct V_1 * V_196 ,
...
if ( F_98 ( V_198 ) )
goto V_200;
if ( F_92 ( V_185 , V_14 , V_13 , V_124 -> V_201 << 2 ) )
goto V_200;
if ( F_99 ( V_185 , V_124 ) )
goto V_200;
if ( F_100 ( V_185 , V_196 ) )
goto V_200;
if ( F_101 ( V_198 , V_195 ) )
goto V_200;
F_102 () ;
return 0 ;
V_200:
...
static int F_103 ( char * V_195 , struct V_1 * V_196 ,
...
const struct V_113 * V_202 = F_11 ( V_18 ) ;
V_13 = & V_202 -> V_13 ;
V_14 = & V_202 -> V_14 ;
}
V_185 = F_97 () ;
...
if ( F_98 ( V_198 ) )
goto V_200;
if ( F_92 ( V_185 , V_14 , V_13 , V_18 -> V_12 ) )
goto V_200;
if ( F_99 ( V_185 , V_124 ) )
goto V_200;
if ( F_104 ( V_185 , V_18 , V_124 -> V_201 << 2 ) )
goto V_200;
if ( F_100 ( V_185 , V_196 ) )
goto V_200;
if ( F_101 ( V_198 , V_195 ) )
...
static int F_105 ( struct V_2 * V_3 , const struct V_17 * V_18 )
{
const T_9 * V_203 = NULL ;
struct V_1 * V_204 ;
const struct V_113 * V_202 = F_11 ( V_18 ) ;
const struct V_112 * V_124 = F_12 ( V_18 ) ;
int V_205 ;
T_6 V_206 [ 16 ] ;
V_204 = F_1 ( V_3 , & V_202 -> V_13 ) ;
V_203 = F_106 ( V_124 ) ;
if ( ! V_204 && ! V_203 )
return 0 ;
if ( V_204 && ! V_203 ) {
...
V_204 ,
NULL , NULL , V_18 ) ;
if ( V_205 || memcmp ( V_203 , V_206 , 16 ) != 0 ) {
if ( F_107 () ) {
F_108 ( V_209 L_2 ,
V_205 ? L_3 : L_4 ,
& V_202 -> V_13 , F_109 ( V_124 -> V_21 ) ,
& V_202 -> V_14 , F_109 ( V_124 -> V_20 ) ) ;
}
return 1 ;
}
return 0 ;
...
T_5 V_226 , struct V_1 * V_196 , int V_227 , T_6 V_167 )
{
const struct V_112 * V_124 = F_12 ( V_18 ) ;
struct V_112 * V_228 ;
struct V_17 * V_229 ;
...
V_168 += V_234 ;
#endif
V_229 = F_127 ( V_235 + sizeof( struct V_113 ) + V_168 ,
V_236 ) ;
if ( V_229 == NULL )
return;
F_128 ( V_229 , V_235 + sizeof( struct V_113 ) + V_168 ) ;
V_228 = (struct V_112 * ) F_129 ( V_229 , V_168 ) ;
F_130 ( V_229 ) ;
...
if ( ! F_32 ( V_42 ) ) {
F_133 ( V_229 , V_42 ) ;
F_76 ( V_230 , V_229 , & V_40 , NULL , V_167 ) ;
F_80 ( V_126 , V_245 ) ;
if ( V_227 )
F_80 ( V_126 , V_246 ) ;
return;
...
return;
F_137 () ;
V_196 = F_1 ( V_247 , & V_217 -> V_13 ) ;
if ( ! V_196 )
goto V_248;
V_205 = F_103 ( V_206 , V_196 , NULL , NULL , V_18 ) ;
if ( V_205 || memcmp ( V_203 , V_206 , 16 ) != 0 )
goto V_248;
} else {
V_196 = V_3 ? F_1 ( V_3 , & V_217 -> V_13 ) : NULL ;
}
#endif
if ( V_124 -> V_224 )
...
( V_124 -> V_201 << 2 ) ;
F_125 ( V_18 , V_125 , V_237 , 0 , 0 , V_196 , 1 , 0 ) ;
#ifdef F_25
V_248:
if ( V_247 ) {
F_138 () ;
...
struct V_1 * V_196 , T_6 V_167 )
{
F_125 ( V_18 , V_125 , V_224 , V_225 , V_226 , V_196 , 0 , V_167 ) ;
}
...
F_168 ( V_311 L_6 ,
& V_158 -> V_160 , F_109 ( F_12 ( V_18 ) -> V_21 ) ) ;
goto V_307;
}
V_268 = F_9 ( V_18 ) ;
}
...
F_169 ( V_3 , V_18 , V_148 ) ;
if ( F_70 ( V_3 , V_148 ,
(struct V_155 * ) & V_265 ) ||
V_270 )
goto V_289;
F_170 ( V_3 , V_148 , V_313 ) ;
return 0 ;
V_307:
F_60 ( V_42 ) ;
V_289:
...
static struct V_2 * F_172 ( struct V_2 * V_3 , struct V_17 * V_18 ,
struct V_147 * V_148 ,
struct V_41 * V_42 )
{
struct V_157 * V_158 ;
...
#endif
if ( V_18 -> V_193 == F_132 ( V_271 ) ) {
V_319 = F_173 ( V_3 , V_18 , V_148 , V_42 ) ;
if ( V_319 == NULL )
return NULL ;
...
V_314 = F_15 ( V_319 ) ;
memcpy ( V_314 , V_32 , sizeof( struct V_31 ) ) ;
V_314 -> V_14 = V_158 -> V_160 ;
V_314 -> V_13 = V_158 -> V_161 ;
V_314 -> V_88 = V_158 -> V_161 ;
V_319 -> V_62 = V_158 -> V_162 ;
V_317 -> V_331 = NULL ;
V_314 -> V_323 = NULL ;
V_314 -> V_324 = NULL ;
...
V_314 -> V_325 = NULL ;
if ( V_158 -> V_170 != NULL ) {
V_314 -> V_325 = F_176 ( V_158 -> V_170 , V_236 ) ;
F_83 ( V_158 -> V_170 ) ;
V_158 -> V_170 = NULL ;
if ( V_314 -> V_325 )
F_177 ( V_314 -> V_325 , V_319 ) ;
}
V_314 -> V_96 = NULL ;
V_314 -> V_326 = F_63 ( V_18 ) ;
V_314 -> V_327 = F_11 ( V_18 ) -> V_134 ;
...
V_317 -> V_87 = V_97 ;
#ifdef F_25
if ( ( V_196 = F_1 ( V_3 , & V_314 -> V_14 ) ) != NULL ) {
F_91 ( V_319 , (union V_171 * ) & V_314 -> V_14 ,
V_48 , V_196 -> V_196 , V_196 -> V_336 , V_236 ) ;
}
#endif
if ( F_183 ( V_3 , V_319 ) < 0 ) {
F_69 ( V_319 ) ;
goto V_133;
}
F_5 ( V_319 , NULL ) ;
...
static T_2 F_184 ( struct V_17 * V_18 )
{
if ( V_18 -> V_210 == V_219 ) {
...
V_18 -> V_216 = ~ F_185 ( F_7 ( V_18 -> V_12 ,
& F_11 ( V_18 ) -> V_13 ,
& F_11 ( V_18 ) -> V_14 , 0 ) ) ;
if ( V_18 -> V_12 <= 76 ) {
return F_186 ( V_18 ) ;
...
goto V_340;
if ( V_32 -> V_293 . V_332 )
V_339 = F_176 ( V_18 , V_236 ) ;
if ( V_3 -> V_6 == V_341 ) {
F_188 ( V_3 , V_18 ) ;
if ( F_189 ( V_3 , V_18 , F_12 ( V_18 ) , V_18 -> V_12 ) )
goto V_342;
if ( V_339 )
goto V_343;
return 0 ;
}
if ( V_18 -> V_12 < F_190 ( V_18 ) || F_191 ( V_18 ) )
goto V_344;
if ( V_3 -> V_6 == V_137 ) {
...
F_188 ( V_3 , V_18 ) ;
if ( F_194 ( V_3 , V_18 , F_12 ( V_18 ) , V_18 -> V_12 ) )
goto V_342;
if ( V_339 )
goto V_343;
return 0 ;
...
V_32 -> V_328 = F_174 ( F_11 ( V_18 ) ) ;
if ( F_162 ( V_3 , V_339 ) ) {
F_177 ( V_339 , V_3 ) ;
V_339 = F_195 ( & V_32 -> V_325 , V_339 ) ;
} else {
F_193 ( V_339 ) ;
V_339 = F_195 ( & V_32 -> V_325 , NULL ) ;
}
}
F_83 ( V_339 ) ;
return 0 ;
...
goto V_352;
V_124 = F_12 ( V_18 ) ;
if ( V_124 -> V_201 < sizeof( struct V_112 ) / 4 )
goto V_354;
if ( ! F_115 ( V_18 , V_124 -> V_201 * 4 ) )
goto V_352;
if ( ! F_197 ( V_18 ) && F_184 ( V_18 ) )
goto V_354;
V_124 = F_12 ( V_18 ) ;
V_122 = F_11 ( V_18 ) ;
F_150 ( V_18 ) -> V_125 = F_52 ( V_124 -> V_125 ) ;
F_150 ( V_18 ) -> V_346 = ( F_150 ( V_18 ) -> V_125 + V_124 -> V_249 + V_124 -> V_250 +
V_18 -> V_12 - V_124 -> V_201 * 4 ) ;
F_150 ( V_18 ) -> V_237 = F_52 ( V_124 -> V_237 ) ;
F_150 ( V_18 ) -> V_269 = 0 ;
F_150 ( V_18 ) -> V_355 = F_198 ( V_122 ) ;
F_150 ( V_18 ) -> V_356 = 0 ;
V_3 = F_199 ( & V_128 , V_18 , V_124 -> V_21 , V_124 -> V_20 ) ;
if ( ! V_3 )
goto V_357;
V_358:
if ( V_3 -> V_6 == V_131 )
...
return V_349 ? - 1 : 0 ;
V_357:
if ( ! F_200 ( NULL , V_361 , V_18 ) )
goto V_352;
if ( V_18 -> V_12 < ( V_124 -> V_201 << 2 ) || F_191 ( V_18 ) ) {
V_354:
F_80 ( V_126 , V_345 ) ;
} else {
F_134 ( NULL , V_18 ) ;
...
switch ( F_207 ( F_48 ( V_3 ) , V_18 , V_124 ) ) {
case V_366 :
{
struct V_2 * V_367 ;
V_367 = F_136 ( F_43 ( V_18 -> V_127 ) , & V_128 ,
& F_11 ( V_18 ) -> V_14 ,
...
static struct V_103 * F_209 ( struct V_2 * V_3 , bool * V_371 )
{
struct V_37 * V_38 = (struct V_37 * ) F_210 ( V_3 ) ;
struct V_31 * V_32 = F_15 ( V_3 ) ;
struct V_103 * V_104 ;
if ( ! V_38 ||
! F_22 ( & V_32 -> V_14 , & V_38 -> V_102 . V_5 ) ) {
V_104 = F_211 ( & V_32 -> V_14 , 1 ) ;
* V_371 = true ;
} else {
if ( ! V_38 -> V_372 )
F_212 ( V_38 , 1 ) ;
...
{
const struct V_373 * V_374 = F_214 ( V_3 ) ;
const struct V_251 * V_252 = F_48 ( V_3 ) ;
if ( V_252 -> V_375 == V_73 )
return F_215 ( V_3 ) ;
return F_211 ( & V_374 -> V_376 , 1 ) ;
}
...
if ( V_279 > 0 ) {
V_34 -> V_280 =
F_221 ( sizeof( * V_34 -> V_280 ) ,
V_3 -> V_394 ) ;
if ( V_34 -> V_280 != NULL )
F_222 ( & V_34 -> V_280 -> V_395 ) ;
}
V_3 -> V_396 = V_397 [ 1 ] ;
V_3 -> V_398 = V_399 [ 1 ] ;
F_4 () ;
...
static void F_228 ( struct V_400 * V_125 ,
const struct V_2 * V_3 , struct V_147 * V_148 , int V_401 , int V_402 )
{
int V_403 = V_148 -> V_404 - V_405 ;
const struct V_4 * V_406 = & F_71 ( V_148 ) -> V_161 ;
...
L_8 ,
V_401 ,
V_406 -> V_19 [ 0 ] , V_406 -> V_19 [ 1 ] ,
V_406 -> V_19 [ 2 ] , V_406 -> V_19 [ 3 ] ,
F_109 ( F_72 ( V_148 ) -> V_164 ) ,
V_20 -> V_19 [ 0 ] , V_20 -> V_19 [ 1 ] ,
V_20 -> V_19 [ 2 ] , V_20 -> V_19 [ 3 ] ,
F_109 ( F_72 ( V_148 ) -> V_163 ) ,
V_151 ,
0 , 0 ,
1 ,
F_230 ( V_403 ) ,
...
static void F_231 ( struct V_400 * V_125 , struct V_2 * V_407 , int V_401 )
{
const struct V_4 * V_20 , * V_406 ;
T_10 V_408 , V_409 ;
int V_410 ;
unsigned long V_411 ;
const struct V_27 * V_28 = F_14 ( V_407 ) ;
const struct V_33 * V_34 = F_16 ( V_407 ) ;
const struct V_29 * V_30 = F_3 ( V_407 ) ;
const struct V_31 * V_32 = F_15 ( V_407 ) ;
V_20 = & V_32 -> V_14 ;
V_406 = & V_32 -> V_88 ;
V_408 = F_109 ( V_28 -> V_114 ) ;
V_409 = F_109 ( V_28 -> V_95 ) ;
if ( V_30 -> V_412 == V_413 ) {
V_410 = 1 ;
V_411 = V_30 -> V_414 ;
} else if ( V_30 -> V_412 == V_415 ) {
V_410 = 4 ;
V_411 = V_30 -> V_414 ;
} else if ( F_232 ( & V_407 -> V_416 ) ) {
V_410 = 2 ;
V_411 = V_407 -> V_416 . V_404 ;
} else {
V_410 = 0 ;
V_411 = V_405 ;
}
...
V_401 ,
V_406 -> V_19 [ 0 ] , V_406 -> V_19 [ 1 ] ,
V_406 -> V_19 [ 2 ] , V_406 -> V_19 [ 3 ] , V_409 ,
V_20 -> V_19 [ 0 ] , V_20 -> V_19 [ 1 ] ,
V_20 -> V_19 [ 2 ] , V_20 -> V_19 [ 3 ] , V_408 ,
V_407 -> V_6 ,
V_34 -> V_66 - V_34 -> V_138 ,
( V_407 -> V_6 == V_137 ) ? V_407 -> V_417 : ( V_34 -> V_347 - V_34 -> V_418 ) ,
V_410 ,
F_230 ( V_411 - V_405 ) ,
V_30 -> V_419 ,
F_233 ( V_407 ) ,
V_30 -> V_420 ,
F_234 ( V_407 ) ,
F_235 ( & V_407 -> V_421 ) , V_407 ,
F_230 ( V_30 -> V_378 ) ,
F_230 ( V_30 -> V_422 . V_423 ) ,
( V_30 -> V_422 . V_424 << 1 ) | V_30 -> V_422 . V_425 ,
V_34 -> V_380 ,
F_236 ( V_34 ) ? - 1 : V_34 -> V_381
) ;
}
static void F_237 ( struct V_400 * V_125 ,
struct V_251 * V_252 , int V_401 )
{
const struct V_4 * V_20 , * V_406 ;
T_10 V_408 , V_409 ;
const struct V_373 * V_374 = F_214 ( (struct V_2 * ) V_252 ) ;
int V_403 = V_252 -> V_426 - V_405 ;
if ( V_403 < 0 )
V_403 = 0 ;
V_20 = & V_374 -> V_376 ;
V_406 = & V_374 -> V_427 ;
V_408 = F_109 ( V_252 -> V_428 ) ;
V_409 = F_109 ( V_252 -> V_429 ) ;
F_229 ( V_125 ,
L_7
L_8 ,
V_401 ,
...
V_20 -> V_19 [ 2 ] , V_20 -> V_19 [ 3 ] , V_408 ,
V_252 -> V_430 , 0 , 0 ,
3 , F_230 ( V_403 ) , 0 , 0 , 0 , 0 ,
F_235 ( & V_252 -> V_431 ) , V_252 ) ;
}
static int F_238 ( struct V_400 * V_125 , void * V_432 )
{
struct V_433 * V_434 ;
if ( V_432 == V_435 ) {
F_239 ( V_125 ,
...
case V_438 :
case V_439 :
F_231 ( V_125 , V_432 , V_434 -> V_440 ) ;
break;
case V_441 :
F_228 ( V_125 , V_434 -> V_442 , V_432 , V_434 -> V_440 , V_434 -> V_402 ) ;
break;
case V_443 :
F_237 ( V_125 , V_432 , V_434 -> V_440 ) ;
break;
}
V_133:
return 0 ;
}
int T_11 F_240 ( struct V_126 * V_126 )
{
return F_241 ( V_126 , & V_444 ) ;
}
void F_242 ( struct V_126 * V_126 )
{
F_243 ( V_126 , & V_444 ) ;
}
static int T_11 F_244 ( struct V_126 * V_126 )
{
return F_245 ( & V_126 -> V_231 . F_16 , V_445 ,
V_446 , V_16 , V_126 ) ;
}
static void T_12 F_246 ( struct V_126 * V_126 )
{
F_247 ( V_126 -> V_231 . F_16 ) ;
}
static void T_12 F_248 ( struct V_447 * V_448 )
{
F_249 ( & V_128 , & V_100 , V_48 ) ;
}
int T_13 F_250 ( void )
{
int V_349 ;
V_349 = F_251 ( & V_449 , V_16 ) ;
if ( V_349 )
goto V_133;
V_349 = F_252 ( & V_450 ) ;
if ( V_349 )
