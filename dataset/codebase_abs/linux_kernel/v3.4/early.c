...
{
#ifdef F_6
unsigned long V_82 = ( unsigned long ) V_27 + ( 4UL << 20 ) ;
if ( ! V_28 || ! V_29 )
return;
if ( V_28 >= V_82 )
return;
memmove ( ( void * ) V_82 , ( void * ) V_28 , V_29 ) ;
V_28 = V_82 ;
#endif
}
...
V_84 = V_21 + V_14 ;
V_83 = V_21 + V_14 + 1 ;
V_68 = F_42 ( V_83 , V_85 - V_14 - 1 ) ;
if ( V_68 ) {
if ( * V_83 == '=' )
memmove ( V_21 , V_83 + 1 , V_68 ) ;
else
* V_84 = ' ' ;
}
}
static inline int F_43 ( const char * V_86 )
{
int V_5 ;
