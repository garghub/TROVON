...
( unsigned long long ) V_3 -> V_99 ,
V_3 -> V_100
) ;
for ( V_94 = 0 ; V_94 < V_3 -> V_7 ; V_94 ++ )
F_44 ( L_10 , V_3 -> V_47 [ V_94 ] ) ;
F_44 ( L_11 ) ;
if ( ! V_3 -> V_37 )
F_44 ( L_12 ) ;
else
for ( V_94 = 0 ; V_94 < V_3 -> V_37 ; V_94 ++ )
F_44 ( L_10 , V_3 -> V_36 [ V_94 ] ) ;
break;
}
return 0 ;
}
static int F_45 ( struct V_76 * V_15 , unsigned V_101 ,
unsigned long V_102 )
{
struct V_2 * V_3 = V_15 -> V_79 ;
int V_28 = 0 ;
if ( V_3 -> V_14 ||
V_15 -> V_52 != F_46 ( V_3 -> V_81 -> V_82 -> V_103 ) >> V_83 )
V_28 = F_47 ( NULL , V_101 ) ;
return V_28 ? : F_48 ( V_3 -> V_81 -> V_82 , V_3 -> V_81 -> V_104 ,
V_101 , V_102 ) ;
}
static int F_49 ( struct V_76 * V_15 , struct V_105 * V_106 ,
struct V_49 * V_107 , int V_108 )
{
struct V_2 * V_3 = V_15 -> V_79 ;
struct V_109 * V_110 = F_50 ( V_3 -> V_81 -> V_82 ) ;
if ( ! V_110 -> V_111 )
return V_108 ;
V_106 -> V_80 = V_3 -> V_81 -> V_82 ;
V_106 -> V_13 = F_6 ( V_3 , V_106 -> V_13 ) ;
return F_51 ( V_108 , V_110 -> V_111 ( V_110 , V_106 , V_107 ) ) ;
}
static int F_52 ( struct V_76 * V_15 ,
T_4 V_112 , void * V_27 )
{
struct V_2 * V_3 = V_15 -> V_79 ;
return V_112 ( V_15 , V_3 -> V_81 , V_3 -> V_14 , V_15 -> V_52 , V_27 ) ;
}
static void F_53 ( struct V_76 * V_15 , struct V_113 * V_114 )
{
struct V_2 * V_3 = V_15 -> V_79 ;
if ( V_114 -> V_115 < 1 << V_3 -> V_48 )
V_114 -> V_115 = 1 << V_3 -> V_48 ;
if ( V_114 -> V_116 < 1 << V_3 -> V_48 )
V_114 -> V_116 = 1 << V_3 -> V_48 ;
F_54 ( V_114 , V_114 -> V_115 ) ;
}
...
static int F_62 ( struct V_76 * V_15 , unsigned V_117 , char * * V_118 )
{
struct V_2 * V_3 ;
unsigned V_119 ;
...
T_2 V_121 ;
char V_122 ;
V_3 = F_63 ( sizeof( struct V_2 ) , V_123 ) ;
if ( ! V_3 ) {
V_15 -> error = L_13 ;
return - V_124 ;
}
...
if ( sscanf ( V_118 [ 0 ] , L_16 , & V_119 , & V_122 ) != 1 ||
V_119 < 0 || V_119 > 1 ) {
V_15 -> error = L_17 ;
V_28 = - V_127 ;
goto V_128;
...
V_3 -> V_24 = V_119 ;
V_28 = F_65 ( V_15 , V_118 [ 1 ] , V_126 , & V_3 -> V_81 ) ;
if ( V_28 ) {
V_15 -> error = L_18 ;
goto V_128;
}
V_28 = F_65 ( V_15 , V_118 [ 2 ] , V_126 , & V_3 -> V_98 ) ;
if ( V_28 ) {
V_15 -> error = L_18 ;
goto V_128;
}
if ( sscanf ( V_118 [ 3 ] , L_19 , & V_119 , & V_122 ) != 1 ||
! V_119 || ( V_119 & ( V_119 - 1 ) ) ||
V_119 < V_129 ( V_3 -> V_81 -> V_82 ) ||
V_119 > V_130 ) {
V_15 -> error = L_20 ;
V_28 = - V_127 ;
goto V_128;
}
V_3 -> V_48 = F_66 ( V_119 ) - 1 ;
if ( sscanf ( V_118 [ 4 ] , L_19 , & V_119 , & V_122 ) != 1 ||
! V_119 || ( V_119 & ( V_119 - 1 ) ) ||
V_119 < V_129 ( V_3 -> V_98 -> V_82 ) ||
V_119 > V_131 ) {
V_15 -> error = L_21 ;
V_28 = - V_127 ;
goto V_128;
}
V_3 -> V_25 = F_66 ( V_119 ) - 1 ;
if ( sscanf ( V_118 [ 5 ] , L_22 , & V_120 , & V_122 ) != 1 ||
V_120 << ( V_3 -> V_48 - V_83 ) !=
( T_2 ) V_120 << ( V_3 -> V_48 - V_83 ) ) {
V_15 -> error = L_23 ;
V_28 = - V_127 ;
goto V_128;
}
...
if ( sscanf ( V_118 [ 6 ] , L_22 , & V_120 , & V_122 ) != 1 ||
V_120 << ( V_3 -> V_25 - V_83 ) !=
( T_2 ) V_120 << ( V_3 -> V_25 - V_83 ) ) {
V_15 -> error = L_25 ;
V_28 = - V_127 ;
goto V_128;
}
V_3 -> V_99 = V_120 ;
V_3 -> V_100 = F_67 ( V_118 [ 7 ] , V_123 ) ;
if ( ! V_3 -> V_100 ) {
V_15 -> error = L_26 ;
V_28 = - V_124 ;
goto V_128;
}
V_3 -> V_33 = F_68 ( V_3 -> V_100 , 0 , 0 ) ;
if ( F_13 ( V_3 -> V_33 ) ) {
V_15 -> error = L_27 ;
V_28 = F_14 ( V_3 -> V_33 ) ;
V_3 -> V_33 = NULL ;
...
V_3 -> V_47 = F_71 ( V_3 -> V_7 , V_123 ) ;
if ( ! V_3 -> V_47 ) {
V_15 -> error = L_29 ;
V_28 = - V_124 ;
goto V_128;
}
if ( strlen ( V_118 [ 8 ] ) != V_3 -> V_7 * 2 ||
F_72 ( V_3 -> V_47 , V_118 [ 8 ] , V_3 -> V_7 ) ) {
V_15 -> error = L_30 ;
V_28 = - V_127 ;
goto V_128;
}
if ( strcmp ( V_118 [ 9 ] , L_12 ) ) {
V_3 -> V_37 = strlen ( V_118 [ 9 ] ) / 2 ;
V_3 -> V_36 = F_71 ( V_3 -> V_37 , V_123 ) ;
if ( ! V_3 -> V_36 ) {
V_15 -> error = L_31 ;
V_28 = - V_124 ;
goto V_128;
}
if ( strlen ( V_118 [ 9 ] ) != V_3 -> V_37 * 2 ||
F_72 ( V_3 -> V_36 , V_118 [ 9 ] , V_3 -> V_37 ) ) {
V_15 -> error = L_32 ;
V_28 = - V_127 ;
goto V_128;
}
...
T_2 V_134 ;
V_3 -> V_23 [ V_41 ] = V_121 ;
V_134 = F_8 ( V_3 , V_3 -> V_84 , V_41 ) ;
V_134 = ( V_134 >> V_3 -> V_18 ) +
! ! ( V_134 & ( ( 1 << V_3 -> V_18 ) - 1 ) ) ;
if ( V_121 + V_134 < V_121 ) {
V_15 -> error = L_34 ;
V_28 = - V_133 ;
goto V_128;
}
...
V_3 -> V_64 = F_75 ( V_135 ,
V_136 * sizeof( struct V_49 ) ) ;
if ( ! V_3 -> V_64 ) {
V_15 -> error = L_38 ;
V_28 = - V_124 ;
goto V_128;
}
V_3 -> V_69 = F_76 ( L_39 , V_137 | V_138 | V_139 , F_77 () ) ;
if ( ! V_3 -> V_69 ) {
V_15 -> error = L_40 ;
V_28 = - V_124 ;
goto V_128;
