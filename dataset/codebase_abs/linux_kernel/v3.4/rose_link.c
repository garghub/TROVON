...
break;
case V_32 :
F_20 ( V_33 L_1 , V_16 -> V_4 [ 3 ] , V_16 -> V_4 [ 4 ] , V_16 -> V_4 [ 5 ] , V_16 -> V_4 [ 6 ] ) ;
break;
default:
F_20 ( V_33 L_2 , V_26 ) ;
break;
...
if ( ( V_16 = F_23 ( V_36 , V_40 ) ) == NULL )
return;
F_24 ( V_16 , V_37 + V_38 ) ;
V_35 = F_25 ( V_16 , V_39 + 3 ) ;
* V_35 ++ = V_41 ;
* V_35 ++ = V_42 ;
* V_35 ++ = 0x00 ;
* V_35 ++ = V_28 ;
...
void F_26 ( struct V_1 * V_2 , unsigned int V_43 , unsigned char V_44 , unsigned char V_45 )
{
struct V_15 * V_16 ;
unsigned char * V_35 ;
int V_36 ;
...
void F_27 ( struct V_15 * V_16 , struct V_1 * V_2 )
{
unsigned char * V_35 ;
if ( V_2 -> V_47 ) {
F_28 ( V_16 , V_2 ) ;
