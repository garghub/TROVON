...
static void T_7 F_105 ( struct V_10 * V_11 ,
struct V_204 * V_205 )
{
struct V_206 * V_130 = & V_11 -> V_130 ;
T_1 V_207 ;
enum V_208 V_9 ;
if ( F_106 ( V_205 , L_101 , & V_207 ) == 0 )
V_130 -> V_209 = 1 ;
V_130 -> V_191 = F_107 ( V_205 , L_102 , 0 ,
& V_9 ) ;
V_130 -> V_190 = ( V_9 & V_210 ) ? 1 : 0 ;
V_130 -> V_135 = F_107 ( V_205 , L_103 , 0 ,
& V_9 ) ;
V_130 -> V_131 = ( V_9 & V_210 ) ? 1 : 0 ;
}
static int T_7 F_108 ( struct V_203 * V_211 )
{
struct V_188 * V_189 = & V_211 -> V_189 ;
struct V_10 * V_11 ;
int V_199 ;
struct V_212 * V_213 ;
if ( ! V_189 -> V_214 ) {
...
if ( ( V_211 -> V_212 [ 0 ] . V_9 != V_216 )
|| ( V_211 -> V_212 [ 1 ] . V_9 != V_217 ) ) {
F_27 ( L_106 ) ;
return - V_174 ;
}
V_213 = F_109 ( V_211 , V_216 , 0 ) ;
if ( ! V_213 )
return - V_218 ;
if ( ! F_110 ( V_213 -> V_219 , F_111 ( V_213 ) , V_33 ) ) {
F_27 ( L_107 ) ;
return - V_201 ;
}
V_11 = & V_198 ;
V_11 -> V_95 . V_189 . V_220 = V_189 ;
if ( V_211 -> V_189 . V_221 )
F_105 ( V_11 , V_211 -> V_189 . V_221 ) ;
else
memcpy ( & V_11 -> V_130 , V_189 -> V_214 ,
sizeof( struct V_206 ) ) ;
V_11 -> V_211 = V_211 ;
V_11 -> V_36 = 0 ;
F_112 ( & V_11 -> V_12 ) ;
if ( F_63 () ) {
if ( F_113 ( V_11 -> V_130 . V_135 ) ) {
F_27 ( L_108 ) ;
V_199 = - V_174 ;
goto V_222;
}
V_199 = F_114 ( V_11 -> V_130 . V_135 , L_109 ) ;
if ( V_199 ) {
F_27 ( L_110 ) ;
goto V_222;
}
F_115 ( V_11 -> V_130 . V_135 ,
V_11 -> V_130 . V_131 ) ;
}
if ( F_65 () || F_67 () ) {
V_11 -> V_4 [ 0 ] . V_15 = 64 ;
...
V_11 -> V_123 = F_116 ( V_213 -> V_219 , F_111 ( V_213 ) ) ;
if ( ! V_11 -> V_123 ) {
V_199 = - V_223 ;
goto V_224;
}
F_56 ( V_11 ) ;
V_11 -> V_126 = F_117 ( V_189 , L_111 ) ;
V_11 -> V_127 = F_117 ( V_189 , L_112 ) ;
if ( F_118 ( V_11 -> V_126 ) || F_118 ( V_11 -> V_127 ) ) {
F_27 ( L_113 ) ;
V_199 = - V_174 ;
goto V_225;
}
V_199 = F_119 ( & V_11 -> V_95 . V_189 ) ;
if ( V_199 < 0 ) {
F_120 ( & V_11 -> V_95 . V_189 ) ;
goto V_225;
}
F_59 ( V_11 -> V_126 ) ;
F_23 ( V_11 , V_134 , V_141 ) ;
...
F_61 ( V_11 -> V_126 ) ;
V_11 -> V_226 = F_121 ( V_211 , 0 ) ;
V_199 = F_122 ( V_11 -> V_226 , F_85 ,
0 , V_33 , V_11 ) ;
if ( V_199 < 0 ) {
F_27 ( L_114 , V_11 -> V_226 ) ;
goto V_227;
}
if ( F_113 ( V_11 -> V_130 . V_191 ) ) {
V_199 = F_114 ( V_11 -> V_130 . V_191 , L_115 ) ;
if ( V_199 < 0 ) {
F_27 ( L_116 ) ;
goto V_228;
}
F_123 ( V_11 -> V_130 . V_191 ) ;
V_11 -> V_35 = F_93 ( V_11 -> V_130 . V_191 ) ^
V_11 -> V_130 . V_190 ;
if ( V_11 -> V_130 . V_209 ) {
F_124 ( & V_11 -> V_194 , F_92 ) ;
F_125 ( & V_11 -> V_195 , F_96 ,
( unsigned long ) V_11 ) ;
F_95 ( & V_11 -> V_195 ,
V_196 + V_197 ) ;
} else {
if ( F_122 ( F_126 ( V_11 -> V_130 . V_191 ) ,
F_89 , 0 , V_33 , V_11 ) ) {
F_27 ( L_117 ,
V_11 -> V_130 . V_191 ) ;
V_199 = - V_201 ;
...
V_199 = F_127 ( V_189 , & V_11 -> V_95 ) ;
if ( V_199 )
goto V_230;
F_101 ( V_189 , V_11 ) ;
F_128 ( V_189 , 1 ) ;
F_14 ( V_11 ) ;
F_129 ( L_119 , V_33 , V_34 ) ;
return 0 ;
V_230:
if ( F_113 ( V_11 -> V_130 . V_191 ) && ! V_11 -> V_130 . V_209 )
F_130 ( F_126 ( V_11 -> V_130 . V_191 ) , V_11 ) ;
V_229:
if ( F_113 ( V_11 -> V_130 . V_191 ) )
F_131 ( V_11 -> V_130 . V_191 ) ;
V_228:
F_130 ( V_11 -> V_226 , V_11 ) ;
V_227:
F_132 ( & V_11 -> V_95 . V_189 ) ;
V_225:
F_133 ( V_11 -> V_123 ) ;
V_224:
if ( F_63 () )
F_131 ( V_11 -> V_130 . V_135 ) ;
V_222:
F_134 ( V_213 -> V_219 , F_111 ( V_213 ) ) ;
F_27 ( L_120 , V_33 , V_199 ) ;
return V_199 ;
}
static int T_8 F_135 ( struct V_203 * V_211 )
{
struct V_10 * V_11 = F_104 ( V_211 ) ;
struct V_212 * V_213 ;
unsigned long V_9 ;
F_27 ( L_121 ) ;
F_136 ( & V_11 -> V_95 ) ;
...
static int F_138 ( struct V_203 * V_211 , T_9 V_231 )
{
struct V_10 * V_11 = F_104 ( V_211 ) ;
int V_232 = V_11 -> V_39 && F_139 ( & V_211 -> V_189 ) ;
unsigned long V_9 ;
...
F_141 ( V_11 -> V_226 ) ;
V_11 -> V_233 = V_232 ;
if ( F_113 ( V_11 -> V_130 . V_191 ) && ! V_11 -> V_130 . V_209 && V_232 )
F_141 ( V_11 -> V_130 . V_191 ) ;
return 0 ;
}
static int F_142 ( struct V_203 * V_211 )
{
struct V_10 * V_11 = F_104 ( V_211 ) ;
unsigned long V_9 ;
if ( F_113 ( V_11 -> V_130 . V_191 ) && ! V_11 -> V_130 . V_209 &&
V_11 -> V_233 )
F_143 ( V_11 -> V_130 . V_191 ) ;
if ( V_11 -> V_233 )
F_143 ( V_11 -> V_226 ) ;
else {
F_2 ( & V_11 -> V_12 , V_9 ) ;
