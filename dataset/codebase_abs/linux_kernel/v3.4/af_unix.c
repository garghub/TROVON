...
goto V_95;
if ( V_193 -> V_201 ) {
V_89 = F_17 ( V_22 , V_193 -> V_201 , & V_8 ) ;
if ( V_89 < 0 )
goto V_95;
V_197 = V_89 ;
} else {
...
goto V_95;
V_4 = F_159 ( V_12 , V_23 , V_193 -> V_199 & V_203 , & V_89 ) ;
if ( V_4 == NULL )
goto V_95;
...
F_1 ( V_195 -> V_2 , V_4 ) ;
F_160 ( V_4 ) ;
V_89 = F_161 ( F_162 ( V_4 , V_23 ) , V_193 -> V_205 , V_23 ) ;
if ( V_89 )
goto V_204;
V_160 = F_124 ( V_12 , V_193 -> V_199 & V_203 ) ;
V_157:
if ( ! V_56 ) {
V_89 = - V_60 ;
if ( V_22 == NULL )
...
while ( V_209 < V_23 ) {
V_208 = V_23 - V_209 ;
if ( V_208 > ( ( V_12 -> V_46 >> 1 ) - 64 ) )
V_208 = ( V_12 -> V_46 >> 1 ) - 64 ;
if ( V_208 > V_214 )
V_208 = V_214 ;
V_4 = F_159 ( V_12 , V_208 , V_193 -> V_199 & V_203 ,
& V_89 ) ;
if ( V_4 == NULL )
goto V_211;
V_208 = F_167 ( int , V_208 , F_168 ( V_4 ) ) ;
V_89 = F_153 ( V_195 -> V_2 , V_4 , ! V_210 ) ;
if ( V_89 < 0 ) {
F_62 ( V_4 ) ;
goto V_211;
}
V_184 = V_89 + 1 ;
V_210 = true ;
V_89 = F_161 ( F_162 ( V_4 , V_208 ) , V_193 -> V_205 , V_208 ) ;
if ( V_89 ) {
F_62 ( V_4 ) ;
goto V_211;
}
...
static int F_170 ( struct V_191 * V_191 , struct V_87 * V_11 ,
struct V_192 * V_193 , T_3 V_23 )
{
int V_89 ;
struct V_11 * V_12 = V_11 -> V_12 ;
...
static int F_172 ( struct V_191 * V_218 , struct V_87 * V_11 ,
struct V_192 * V_193 , T_3 V_208 ,
int V_153 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
if ( V_12 -> V_73 != V_170 )
return - V_181 ;
return F_173 ( V_218 , V_11 , V_193 , V_208 , V_153 ) ;
}
static void F_174 ( struct V_192 * V_193 , struct V_11 * V_12 )
{
struct V_36 * V_37 = F_31 ( V_12 ) ;
V_193 -> V_201 = 0 ;
if ( V_37 -> V_19 ) {
V_193 -> V_201 = V_37 -> V_19 -> V_23 ;
memcpy ( V_193 -> V_196 , V_37 -> V_19 -> V_38 , V_37 -> V_19 -> V_23 ) ;
}
}
static int F_173 ( struct V_191 * V_218 , struct V_87 * V_11 ,
struct V_192 * V_193 , T_3 V_208 ,
int V_153 )
{
struct V_194 * V_195 = F_156 ( V_218 ) ;
struct V_1 V_198 ;
struct V_11 * V_12 = V_11 -> V_12 ;
struct V_36 * V_37 = F_31 ( V_12 ) ;
int V_219 = V_153 & V_203 ;
struct V_3 * V_4 ;
int V_89 ;
int V_220 , V_221 ;
V_89 = - V_94 ;
...
goto V_95;
V_193 -> V_201 = 0 ;
V_89 = F_175 ( & V_37 -> V_98 ) ;
if ( V_89 ) {
V_89 = F_126 ( F_176 ( V_12 , V_219 ) ) ;
goto V_95;
}
V_221 = F_177 ( V_12 , V_153 ) ;
V_4 = F_178 ( V_12 , V_153 , & V_220 , & V_221 , & V_89 ) ;
if ( ! V_4 ) {
F_11 ( V_12 ) ;
...
V_51 | V_52 | V_53 ) ;
if ( V_193 -> V_196 )
F_174 ( V_193 , V_4 -> V_12 ) ;
if ( V_208 > V_4 -> V_23 - V_221 )
V_208 = V_4 -> V_23 - V_221 ;
else if ( V_208 < V_4 -> V_23 - V_221 )
V_193 -> V_199 |= V_222 ;
V_89 = F_179 ( V_4 , V_221 , V_193 -> V_205 , V_208 ) ;
if ( V_89 )
goto V_204;
if ( F_49 ( V_12 , V_207 ) )
F_180 ( V_193 , V_12 , V_4 ) ;
if ( ! V_195 -> V_2 ) {
V_195 -> V_2 = & V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
}
F_181 ( V_195 -> V_2 , F_143 ( V_4 ) . V_90 , F_143 ( V_4 ) . V_92 ) ;
F_3 ( V_195 -> V_2 , V_4 ) ;
if ( ! ( V_153 & V_223 ) ) {
if ( F_143 ( V_4 ) . V_182 )
F_142 ( V_195 -> V_2 , V_4 ) ;
...
V_89 = ( V_153 & V_222 ) ? V_4 -> V_23 - V_221 : V_208 ;
F_184 ( V_11 , V_193 , V_195 -> V_2 , V_153 ) ;
V_204:
F_137 ( V_12 , V_4 ) ;
V_96:
F_76 ( & V_37 -> V_98 ) ;
...
static long F_185 ( struct V_11 * V_12 , long V_160 )
{
F_119 ( V_50 ) ;
F_11 ( V_12 ) ;
for (; ; ) {
F_186 ( F_187 ( V_12 ) , & V_50 , V_162 ) ;
if ( ! F_46 ( & V_12 -> V_14 ) ||
V_12 -> V_59 ||
( V_12 -> V_70 & V_163 ) ||
F_127 ( V_85 ) ||
! V_160 )
break;
F_188 ( V_224 , & V_12 -> V_62 -> V_153 ) ;
F_13 ( V_12 ) ;
V_160 = F_121 ( V_160 ) ;
F_11 ( V_12 ) ;
F_189 ( V_224 , & V_12 -> V_62 -> V_153 ) ;
}
F_122 ( F_187 ( V_12 ) , & V_50 ) ;
F_13 ( V_12 ) ;
return V_160 ;
}
static int F_190 ( struct V_191 * V_218 , struct V_87 * V_11 ,
struct V_192 * V_193 , T_3 V_208 ,
int V_153 )
{
struct V_194 * V_195 = F_156 ( V_218 ) ;
...
if ( V_153 & V_200 )
goto V_95;
V_227 = F_191 ( V_12 , V_153 & V_228 , V_208 ) ;
V_160 = F_176 ( V_12 , V_153 & V_203 ) ;
V_193 -> V_201 = 0 ;
if ( ! V_195 -> V_2 ) {
V_195 -> V_2 = & V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
...
V_229 = F_167 (unsigned int, skb->len - skip, size) ;
if ( F_194 ( V_193 -> V_205 , V_4 -> V_232 + V_221 , V_229 ) ) {
if ( V_225 == 0 )
V_225 = - V_233 ;
break;
}
...
static int F_198 ( struct V_87 * V_11 , int V_140 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
struct V_11 * V_56 ;
V_140 = ( V_140 + 1 ) & ( V_163 | V_212 ) ;
if ( ! V_140 )
return 0 ;
F_11 ( V_12 ) ;
V_12 -> V_70 |= V_140 ;
...
F_43 ( V_56 , V_79 , V_235 ) ;
}
if ( V_56 )
F_60 ( V_56 ) ;
return 0 ;
}
long F_199 ( struct V_11 * V_12 )
{
struct V_3 * V_4 ;
long V_236 = 0 ;
if ( V_12 -> V_73 == V_81 )
...
long F_201 ( struct V_11 * V_12 )
{
return F_202 ( V_12 ) ;
}
static int F_203 ( struct V_87 * V_11 , unsigned int V_237 , unsigned long V_238 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
long V_236 = 0 ;
int V_89 ;
...
case V_239 :
V_236 = F_201 ( V_12 ) ;
V_89 = F_204 ( V_236 , ( int V_240 * ) V_238 ) ;
break;
case V_241 :
V_236 = F_199 ( V_12 ) ;
if ( V_236 < 0 )
...
static unsigned int F_205 ( struct V_243 * V_243 , struct V_87 * V_11 , T_4 * V_50 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
unsigned int V_244 ;
F_206 ( V_243 , F_187 ( V_12 ) , V_50 ) ;
V_244 = 0 ;
if ( V_12 -> V_59 )
V_244 |= V_245 ;
if ( V_12 -> V_70 == V_71 )
...
V_244 |= V_246 ;
if ( F_36 ( V_12 ) )
V_244 |= V_51 | V_52 | V_53 ;
return V_244 ;
}
static unsigned int F_207 ( struct V_243 * V_243 , struct V_87 * V_11 ,
T_4 * V_50 )
{
...
if ( ! ( F_208 ( V_50 ) & ( V_53 | V_52 | V_51 ) ) )
return V_244 ;
V_250 = F_36 ( V_12 ) ;
V_56 = F_10 ( V_12 ) ;
if ( V_56 ) {
if ( F_6 ( V_56 ) != V_12 ) {
F_206 ( V_243 , & F_31 ( V_56 ) -> V_57 , V_50 ) ;
if ( F_8 ( V_56 ) )
V_250 = 0 ;
}
F_60 ( V_56 ) ;
...
F_188 ( V_253 , & V_12 -> V_62 -> V_153 ) ;
return V_244 ;
}
static struct V_11 * F_209 ( int * V_41 )
{
for ( * V_41 = 0 ; * V_41 <= V_10 ; ( * V_41 ) ++ ) {
if ( ! F_210 ( & V_128 [ * V_41 ] ) )
return F_211 ( & V_128 [ * V_41 ] ) ;
}
return NULL ;
}
static struct V_11 * F_212 ( int * V_41 , struct V_11 * V_16 )
{
struct V_11 * V_254 = F_213 ( V_16 ) ;
if ( V_254 )
return V_254 ;
...
static struct V_11 * F_214 ( struct V_255 * V_256 , T_5 V_257 )
{
struct V_258 * V_259 = V_256 -> V_260 ;
T_5 V_261 = 0 ;
struct V_11 * V_16 ;
for ( V_16 = F_209 ( & V_259 -> V_41 ) ; V_16 ; V_16 = F_212 ( & V_259 -> V_41 , V_16 ) ) {
if ( F_33 ( V_16 ) != F_215 ( V_256 ) )
continue;
if ( V_261 == V_257 )
return V_16 ;
++ V_261 ;
...
static void * F_216 ( struct V_255 * V_256 , T_5 * V_257 )
__acquires( V_31 )
{
F_26 ( & V_31 ) ;
return * V_257 ? F_214 ( V_256 , * V_257 - 1 ) : V_262 ;
}
static void * F_217 ( struct V_255 * V_256 , void * V_263 , T_5 * V_257 )
{
struct V_258 * V_259 = V_256 -> V_260 ;
struct V_11 * V_12 = V_263 ;
++ * V_257 ;
if ( V_263 == V_262 )
V_12 = F_209 ( & V_259 -> V_41 ) ;
else
V_12 = F_212 ( & V_259 -> V_41 , V_12 ) ;
while ( V_12 && ( F_33 ( V_12 ) != F_215 ( V_256 ) ) )
V_12 = F_212 ( & V_259 -> V_41 , V_12 ) ;
return V_12 ;
}
static void F_218 ( struct V_255 * V_256 , void * V_263 )
__releases( V_31 )
{
F_27 ( & V_31 ) ;
}
static int F_219 ( struct V_255 * V_256 , void * V_263 )
{
if ( V_263 == V_262 )
F_220 ( V_256 , L_4
L_5 ) ;
else {
struct V_11 * V_16 = V_263 ;
struct V_36 * V_37 = F_31 ( V_16 ) ;
F_11 ( V_16 ) ;
F_221 ( V_256 , L_6 ,
V_16 ,
F_37 ( & V_16 -> V_264 ) ,
0 ,
V_16 -> V_73 == V_81 ? V_265 : 0 ,
V_16 -> V_75 ,
V_16 -> V_62 ?
( V_16 -> V_73 == V_170 ? V_173 : V_115 ) :
( V_16 -> V_73 == V_170 ? V_266 : V_267 ) ,
F_222 ( V_16 ) ) ;
if ( V_37 -> V_19 ) {
int V_41 , V_23 ;
F_223 ( V_256 , ' ' ) ;
...
for ( ; V_41 < V_23 ; V_41 ++ )
F_223 ( V_256 , V_37 -> V_19 -> V_38 -> V_28 [ V_41 ] ) ;
}
F_13 ( V_16 ) ;
F_223 ( V_256 , '\n' ) ;
}
...
static int F_225 ( struct V_40 * V_40 , struct V_243 * V_243 )
{
return F_226 ( V_40 , V_243 , & V_268 ,
sizeof( struct V_258 ) ) ;
}
...
static void T_7 F_232 ( struct V_32 * V_32 )
{
F_231 ( V_32 ) ;
F_233 ( V_32 , L_7 ) ;
}
...
int V_270 = - 1 ;
struct V_3 * V_271 ;
F_235 ( sizeof( struct V_272 ) > sizeof( V_271 -> V_273 ) ) ;
V_270 = F_236 ( & V_102 , 1 ) ;
if ( V_270 != 0 ) {
F_51 ( V_274 L_8 ,
V_275 ) ;
