...
V_99 -> V_54 . V_55 / 8 ;
V_47 -> V_35 =
F_59 ( NULL , V_99 -> V_69 . V_71 , & V_47 -> V_136 ,
V_137 ) ;
if ( NULL == V_47 -> V_35 ) {
F_27 (KERN_ERR DRIVER_NAME
L_10 ) ;
...
V_99 -> V_123 = & V_124 ;
V_99 -> V_82 = F_60 ( sizeof( T_2 ) * 16 , V_137 ) ;
if ( ! V_99 -> V_82 ) {
F_27 (KERN_ERR DRIVER_NAME
L_11 ) ;
V_100 = - V_72 ;
...
V_47 -> V_91 = F_62 ( V_96 , 0 ) ;
if ( V_47 -> V_91 < 0 ) {
V_100 = - V_64 ;
goto V_144;
}
if ( F_63 ( V_47 -> V_91 , F_50 , 0 ,
L_14 , V_47 ) < 0 ) {
F_27 (KERN_ERR DRIVER_NAME
L_15 ) ;
V_100 = - V_43 ;
...
V_150 = F_68 ( V_41 , & V_96 -> V_86 , NULL , & V_151 ) ;
V_150 -> V_98 . V_152 = 255 , F_27 ( V_153 L_19 ) ;
#endif
return 0 ;
V_145:
F_69 ( V_47 -> V_91 , V_47 ) ;
...
static int F_79 ( struct V_95 * V_96 , T_7 V_154 )
{
struct V_46 * V_99 = F_76 ( V_96 ) ;
F_16 ( F_36 () & ~ V_52 ) ;
F_39 ( V_24 ) ;
