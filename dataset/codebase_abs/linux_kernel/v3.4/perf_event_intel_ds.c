...
{
struct V_4 * V_43 = & F_25 ( V_4 ) ;
unsigned long V_45 = V_43 -> V_86 [ 0 ] . V_45 ;
unsigned long V_87 , V_46 = V_43 -> V_86 [ 0 ] . V_46 ;
unsigned long V_65 = V_61 -> V_65 ;
int V_88 = 0 ;
if ( ! V_12 . V_89 . V_90 )
return 1 ;
if ( ! V_43 -> V_91 . V_92 || ! V_45 || ! V_46 )
return 0 ;
...
if ( ! F_40 ( V_65 ) ) {
int V_98 , V_66 = V_96 ;
V_98 = F_41 ( V_95 , ( void V_99 * ) V_46 , V_66 ) ;
if ( V_98 != V_66 )
return 0 ;
V_97 = V_95 ;
} else
...
struct V_60 * V_102 , void * V_103 )
{
struct V_4 * V_43 = & F_25 ( V_4 ) ;
struct V_104 * V_13 = V_103 ;
struct V_58 V_59 ;
struct V_60 V_61 ;
if ( ! F_47 ( V_49 ) )
return;
...
if ( V_49 -> V_73 . V_74 > 1 && F_39 ( & V_61 ) )
V_61 . V_47 |= V_107 ;
else
V_61 . V_47 &= ~ V_107 ;
if ( F_48 ( V_49 ) )
V_59 . V_108 = & V_43 -> V_91 ;
if ( F_49 ( V_49 , & V_59 , & V_61 ) )
F_50 ( V_49 , 0 ) ;
}
static void F_51 ( struct V_60 * V_102 )
{
struct V_4 * V_43 = & F_25 ( V_4 ) ;
struct V_2 * V_3 = V_43 -> V_3 ;
struct V_48 * V_49 = V_43 -> V_50 [ 0 ] ;
struct V_104 * V_52 , * V_53 ;
int V_109 ;
if ( ! V_12 . V_33 )
return;
V_52 = (struct V_104 * ) ( unsigned long ) V_3 -> V_19 ;
V_53 = (struct V_104 * ) ( unsigned long ) V_3 -> V_20 ;
V_3 -> V_20 = V_3 -> V_19 ;
if ( ! F_52 ( 0 , V_43 -> V_110 ) )
return;
F_53 ( ! V_49 ) ;
if ( ! V_49 -> V_73 . V_74 )
return;
...
F_53 ( V_109 > 1 ) ;
V_52 += V_109 - 1 ;
F_46 ( V_49 , V_102 , V_52 ) ;
}
static void F_54 ( struct V_60 * V_102 )
{
struct V_4 * V_43 = & F_25 ( V_4 ) ;
struct V_2 * V_3 = V_43 -> V_3 ;
...
F_53 ( V_109 > V_114 ) ;
for ( ; V_52 < V_53 ; V_52 ++ ) {
F_55 (bit, (unsigned long *)&at->status, MAX_PEBS_EVENTS) {
V_49 = V_43 -> V_50 [ V_113 ] ;
if ( ! F_52 ( V_113 , V_43 -> V_110 ) )
continue;
F_53 ( ! V_49 ) ;
if ( ! V_49 -> V_73 . V_74 )
continue;
if ( F_56 ( V_113 , ( unsigned long * ) & V_112 ) )
continue;
break;
}
if ( ! V_49 || V_113 >= V_114 )
...
if ( ! F_58 ( V_115 ) )
return;
V_12 . V_23 = F_58 ( V_116 ) ;
V_12 . V_13 = F_58 ( V_117 ) ;
if ( V_12 . V_13 ) {
char V_118 = V_12 . V_89 . V_90 ? '+' : '-' ;
int V_119 = V_12 . V_89 . V_120 ;
switch ( V_119 ) {
case 0 :
F_59 ( V_121 L_1 , V_118 ) ;
V_12 . V_18 = sizeof( struct V_104 ) ;
V_12 . V_122 = F_51 ;
break;
case 1 :
F_59 ( V_121 L_2 , V_118 ) ;
V_12 . V_18 = sizeof( struct V_111 ) ;
V_12 . V_122 = F_54 ;
break;
default:
F_59 ( V_121 L_3 , V_119 , V_118 ) ;
V_12 . V_13 = 0 ;
}
}
}
