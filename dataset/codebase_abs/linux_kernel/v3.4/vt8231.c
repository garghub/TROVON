...
if ( ! F_51 ( V_44 -> V_47 , V_48 ,
V_49 . V_50 . V_40 ) ) {
F_45 ( & V_42 -> V_8 , L_6 ,
( unsigned long ) V_44 -> V_47 , ( unsigned long ) V_44 -> V_51 ) ;
return - V_52 ;
}
V_3 = F_52 ( sizeof( struct V_2 ) , V_53 ) ;
if ( ! V_3 ) {
V_21 = - V_54 ;
goto V_55;
}
...
F_54 ( & V_3 -> V_22 ) ;
F_55 ( V_3 ) ;
V_21 = F_56 ( & V_42 -> V_8 . V_56 , & V_57 ) ;
if ( V_21 )
goto V_58;
V_3 -> V_59 = F_3 ( V_3 , V_60 ) ;
for ( V_45 = 0 ; V_45 < F_57 ( V_61 ) ; V_45 ++ ) {
if ( F_58 ( V_45 , V_3 -> V_59 ) ) {
V_21 = F_56 ( & V_42 -> V_8 . V_56 ,
& V_61 [ V_45 ] ) ;
if ( V_21 )
goto V_62;
}
}
for ( V_45 = 0 ; V_45 < F_57 ( V_63 ) ; V_45 ++ ) {
if ( F_59 ( V_45 , V_3 -> V_59 ) ) {
V_21 = F_56 ( & V_42 -> V_8 . V_56 ,
& V_63 [ V_45 ] ) ;
if ( V_21 )
goto V_62;
...
V_62:
for ( V_45 = 0 ; V_45 < F_57 ( V_63 ) ; V_45 ++ )
F_63 ( & V_42 -> V_8 . V_56 , & V_63 [ V_45 ] ) ;
for ( V_45 = 0 ; V_45 < F_57 ( V_61 ) ; V_45 ++ )
F_63 ( & V_42 -> V_8 . V_56 , & V_61 [ V_45 ] ) ;
F_63 ( & V_42 -> V_8 . V_56 , & V_57 ) ;
V_58:
F_53 ( V_42 , NULL ) ;
F_64 ( V_3 ) ;
V_55:
...
static int T_4 F_66 ( struct V_41 * V_42 )
{
struct V_2 * V_3 = F_67 ( V_42 ) ;
int V_45 ;
F_68 ( V_3 -> V_64 ) ;
for ( V_45 = 0 ; V_45 < F_57 ( V_63 ) ; V_45 ++ )
F_63 ( & V_42 -> V_8 . V_56 , & V_63 [ V_45 ] ) ;
...
T_5 V_67 ;
F_15 ( & V_3 -> V_22 ) ;
if ( F_69 ( V_68 , V_3 -> V_69 + V_70 + V_70 / 2 )
|| ! V_3 -> V_71 ) {
...
static int T_6 F_71 ( unsigned short V_78 )
{
struct V_43 V_44 = {
. V_47 = V_78 ,
. V_51 = V_78 + V_48 - 1 ,
...
static int T_6 F_78 ( struct V_81 * V_8 ,
...
V_78 ) ;
if ( V_85 !=
F_80 ( V_8 , V_86 , V_78 | 1 ) )
return - V_52 ;
}
if ( V_85 != F_81 ( V_8 , V_86 ,
& V_20 ) )
return - V_52 ;
V_78 = V_20 & ~ ( V_48 - 1 ) ;
if ( V_78 == 0 ) {
