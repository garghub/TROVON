...
static int F_39 ( struct V_18 * V_19 , char * V_4 , int V_5 )
{
if( V_5 < 100 )
return - 1 ;
sprintf ( V_4 , L_55 ,
...
static int F_40 ( char * V_107 , char * * V_108 , T_4 V_109 ,
int V_110 , int * V_111 , void * V_13 )
{
int V_112 , V_5 , V_113 = 0 ;
int V_70 = V_114 ;
struct V_18 * V_19 ;
V_5 = sprintf ( V_107 , L_56 ) ;
for ( V_19 = V_104 ; V_19 != NULL ; V_19 = V_19 -> V_34 )
{
V_112 = F_39 ( V_19 , V_107 + V_5 , V_70 - V_5 ) ;
if ( V_112 < 0 )
break;
V_5 += V_112 ;
if ( V_5 + V_113 < V_109 ) {
