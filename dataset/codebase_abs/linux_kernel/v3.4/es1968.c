...
static int F_168 ( struct V_292 * V_149 )
{
struct V_1 * V_2 = V_149 -> V_293 ;
return F_160 ( V_2 ) ;
}
static int T_5 F_169 ( struct V_250 * V_150 ,
struct V_211 * V_111 ,
int V_115 ,
int V_294 ,
int V_295 ,
...
if ( F_178 ( V_111 -> V_178 , F_107 , V_302 ,
V_303 , V_2 ) ) {
...
for ( V_21 = 0 ; V_21 < ( int ) F_179 ( V_304 ) ; V_21 ++ ) {
if ( V_2 -> type == V_304 [ V_21 ] . type &&
V_205 == V_304 [ V_21 ] . V_269 ) {
V_251 = 1 ;
break;
}
}
...
V_2 -> V_251 = V_251 ;
F_118 ( V_2 ) ;
if ( ( V_112 = F_180 ( V_150 , V_305 , V_2 , & V_195 ) ) < 0 ) {
F_160 ( V_2 ) ;
return V_112 ;
}
F_181 ( V_150 , & V_111 -> V_113 ) ;
#ifdef F_163
V_112 = F_182 ( & V_111 -> V_113 , & V_2 -> V_291 ) ;
if ( V_112 < 0 ) {
F_160 ( V_2 ) ;
return V_112 ;
}
V_2 -> V_276 . V_291 = & V_2 -> V_291 ;
V_2 -> V_276 . V_18 = V_2 ;
V_2 -> V_276 . V_297 = V_297 ;
V_2 -> V_276 . V_195 = & V_306 ;
F_183 ( V_2 -> V_276 . V_150 , L_23 , sizeof( V_2 -> V_276 . V_150 ) ) ;
sprintf ( V_2 -> V_276 . V_307 , L_24 , F_145 ( V_111 ) ) ;
if ( ! F_184 ( & V_2 -> V_276 ) )
F_91 ( V_146 L_25 ) ;
#endif
* V_298 = V_2 ;
...
V_112 = F_186 ( V_20 [ V_113 ] , V_173 [ V_113 ] , V_313 , 0 , & V_150 ) ;
if ( V_112 < 0 )
return V_112 ;
if ( V_115 [ V_113 ] < 128 )
V_115 [ V_113 ] = 128 ;
...
strcpy ( V_150 -> V_319 , L_27 ) ;
break;
case V_320 :
strcpy ( V_150 -> V_266 , L_28 ) ;
strcpy ( V_150 -> V_319 , L_29 ) ;
break;
case V_321 :
strcpy ( V_150 -> V_266 , L_30 ) ;
strcpy ( V_150 -> V_319 , L_31 ) ;
break;
}
...
unsigned short V_205 ;
F_114 ( V_2 -> V_111 , V_206 , & V_205 ) ;
for ( V_21 = 0 ; V_21 < F_179 ( V_323 ) ; V_21 ++ ) {
if ( V_2 -> type == V_323 [ V_21 ] . type &&
V_205 == V_323 [ V_21 ] . V_269 ) {
V_322 [ V_113 ] = 0 ;
break;
}
}
...
if ( ! V_2 -> clock )
F_88 ( V_2 ) ;
sprintf ( V_150 -> V_329 , L_35 ,
V_150 -> V_319 , V_2 -> V_5 , V_2 -> V_178 ) ;
...
static void T_8 F_191 ( struct V_211 * V_111 )
{
F_187 ( F_124 ( V_111 ) ) ;
F_190 ( V_111 , NULL ) ;
}
