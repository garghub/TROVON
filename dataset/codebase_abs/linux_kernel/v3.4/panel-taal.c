...
if ( V_65 -> V_128 ) {
int V_129 = V_65 -> V_67 ;
V_8 = F_85 ( V_129 , V_130 , L_21 ) ;
if ( V_8 ) {
F_7 ( & V_7 -> V_11 , L_22 ) ;
goto V_131;
}
V_8 = F_86 ( F_40 ( V_129 ) , V_132 ,
V_133 ,
L_23 , V_7 ) ;
if ( V_8 ) {
F_7 ( & V_7 -> V_11 , L_24 ) ;
...
V_8 = F_88 ( V_7 , & V_19 -> V_28 ) ;
if ( V_8 ) {
F_7 ( & V_7 -> V_11 , L_26 ) ;
goto V_137;
}
V_8 = F_89 ( V_7 , V_19 -> V_28 , V_138 ) ;
if ( V_8 ) {
F_7 ( & V_7 -> V_11 , L_27 ) ;
goto V_139;
}
V_8 = F_90 ( & V_7 -> V_11 . V_140 , & V_141 ) ;
if ( V_8 ) {
F_7 ( & V_7 -> V_11 , L_28 ) ;
goto V_139;
}
...
static void T_5 F_96 ( struct V_6 * V_7 )
{
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
struct V_16 * V_65 = F_12 ( V_7 ) ;
struct V_70 * V_109 ;
F_49 ( & V_7 -> V_11 , L_29 ) ;
F_97 ( & V_7 -> V_11 . V_140 , & V_141 ) ;
F_91 ( V_7 , V_19 -> V_28 ) ;
if ( V_65 -> V_128 ) {
int V_129 = V_65 -> V_67 ;
F_92 ( F_40 ( V_129 ) , V_7 ) ;
...
static void F_107 ( int V_13 , void * V_17 )
{
struct V_6 * V_7 = V_17 ;
...
int V_157 ;
int V_8 ;
V_157 = F_108 ( & V_19 -> V_117 , 1 , 0 ) ;
if ( V_157 ) {
F_34 ( & V_19 -> V_135 ) ;
V_8 = F_109 ( V_7 , V_19 -> V_28 , F_107 ,
V_7 ) ;
if ( V_8 )
goto V_13;
}
...
static void V_136 ( struct V_159 * V_160 )
{
struct V_18 * V_19 = F_110 ( V_160 , struct V_18 ,
V_135 . V_160 ) ;
...
static int F_38 ( struct V_6 * V_7 , bool V_161 )
{
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
struct V_16 * V_65 = F_12 ( V_7 ) ;
int V_8 ;
if ( V_161 )
V_8 = F_21 ( V_19 , V_162 , 0 ) ;
else
V_8 = F_19 ( V_19 , V_163 ) ;
if ( ! V_65 -> V_128 )
F_114 ( V_7 , V_161 ) ;
if ( V_19 -> V_32 -> V_33 . V_164 )
F_24 ( V_19 -> V_32 -> V_33 . V_164 ) ;
return V_8 ;
}
static int F_115 ( struct V_6 * V_7 , bool V_161 )
{
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
int V_8 ;
F_50 ( & V_19 -> V_77 ) ;
...
static int F_117 ( struct V_6 * V_7 , T_1 V_43 )
{
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
int V_8 ;
...
static T_1 F_118 ( struct V_6 * V_7 )
{
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
int V_8 ;
F_50 ( & V_19 -> V_77 ) ;
...
static int F_119 ( struct V_6 * V_7 , bool V_161 )
{
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
int V_8 ;
F_49 ( & V_7 -> V_11 , L_47 , V_161 ) ;
F_50 ( & V_19 -> V_77 ) ;
if ( V_19 -> V_44 == V_161 )
goto V_165;
F_51 ( V_7 ) ;
...
static int F_121 ( struct V_6 * V_7 , int V_166 )
{
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
T_1 V_37 , V_38 , V_39 ;
int V_8 ;
...
V_8 = F_124 ( V_7 , V_19 -> V_28 , V_169 ) ;
if ( V_8 )
goto V_69;
while ( V_170 < V_167 ) {
T_1 V_26 = V_168 ? 0x2e : 0x3e ;
V_168 = 0 ;
V_8 = F_18 ( V_7 , V_19 -> V_28 , V_26 ,
V_27 + V_170 , V_167 - V_170 ) ;
if ( V_8 < 0 ) {
F_7 ( & V_7 -> V_11 , L_48 ) ;
goto V_171;
}
...
static void V_122 ( struct V_159 * V_160 )
{
struct V_18 * V_19 = F_110 ( V_160 , struct V_18 ,
V_64 . V_160 ) ;
struct V_6 * V_7 = V_19 -> V_7 ;
F_50 ( & V_19 -> V_77 ) ;
if ( V_7 -> V_152 != V_154 || ! V_19 -> V_78 ) {
F_53 ( & V_19 -> V_77 ) ;
return;
}
F_51 ( V_7 ) ;
...
static void V_121 ( struct V_159 * V_160 )
{
struct V_18 * V_19 = F_110 ( V_160 , struct V_18 ,
V_62 . V_160 ) ;
struct V_6 * V_7 = V_19 -> V_7 ;
