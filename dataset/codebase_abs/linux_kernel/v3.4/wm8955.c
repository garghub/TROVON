...
static int F_23 ( struct V_97 * V_98 , int V_105 ,
unsigned int V_106 , int V_107 )
{
struct V_33 * V_34 = V_98 -> V_34 ;
struct V_48 * V_108 = F_10 ( V_34 ) ;
int div ;
switch ( V_105 ) {
case V_109 :
if ( V_106 > 15000000 ) {
...
F_6 ( V_98 -> V_2 , L_8 , V_105 , V_106 ) ;
return 0 ;
}
static int F_24 ( struct V_97 * V_98 , unsigned int V_111 )
{
struct V_33 * V_34 = V_98 -> V_34 ;
T_2 V_112 = 0 ;
switch ( V_111 & V_113 ) {
...
static int F_25 ( struct V_97 * V_131 , int V_132 )
{
struct V_33 * V_34 = V_131 -> V_34 ;
int V_52 ;
if ( V_132 )
V_52 = V_133 ;
else
V_52 = 0 ;
F_13 ( V_34 , V_6 , V_133 , V_52 ) ;
return 0 ;
}
...
break;
case V_142 :
if ( V_34 -> V_143 . V_144 == V_145 ) {
V_51 = F_27 ( F_11 ( V_49 -> V_146 ) ,
V_49 -> V_146 ) ;
if ( V_51 != 0 ) {
F_12 ( V_34 -> V_2 ,
L_9 ,
...
V_148 |
V_138 , 0 ) ;
F_30 ( F_11 ( V_49 -> V_146 ) ,
V_49 -> V_146 ) ;
break;
}
V_34 -> V_143 . V_144 = V_135 ;
return 0 ;
}
...
{
struct V_48 * V_49 = F_10 ( V_34 ) ;
struct V_151 * V_152 = F_35 ( V_34 -> V_2 ) ;
int V_51 , V_50 ;
V_34 -> V_153 = V_49 -> V_147 ;
V_51 = F_36 ( V_34 , 7 , 9 , V_154 ) ;
if ( V_51 != 0 ) {
F_12 ( V_34 -> V_2 , L_10 , V_51 ) ;
return V_51 ;
}
for ( V_50 = 0 ; V_50 < F_11 ( V_49 -> V_146 ) ; V_50 ++ )
V_49 -> V_146 [ V_50 ] . V_155 = V_156 [ V_50 ] ;
V_51 = F_37 ( V_34 -> V_2 , F_11 ( V_49 -> V_146 ) ,
V_49 -> V_146 ) ;
if ( V_51 != 0 ) {
...
F_26 ( V_34 , V_142 ) ;
F_30 ( F_11 ( V_49 -> V_146 ) , V_49 -> V_146 ) ;
return 0 ;
V_158:
F_30 ( F_11 ( V_49 -> V_146 ) , V_49 -> V_146 ) ;
V_157:
F_38 ( F_11 ( V_49 -> V_146 ) , V_49 -> V_146 ) ;
return V_51 ;
}
...
static T_3 int F_40 ( struct V_175 * V_176 ,
const struct V_177 * V_178 )
{
struct V_48 * V_49 ;
int V_51 ;
V_49 = F_41 ( & V_176 -> V_2 , sizeof( struct V_48 ) ,
V_179 ) ;
if ( V_49 == NULL )
return - V_180 ;
V_49 -> V_147 = F_42 ( V_176 , & V_181 ) ;
if ( F_43 ( V_49 -> V_147 ) ) {
V_51 = F_44 ( V_49 -> V_147 ) ;
F_12 ( & V_176 -> V_2 , L_13 ,
V_51 ) ;
return V_51 ;
}
...
static T_4 int F_48 ( struct V_175 * V_185 )
{
struct V_48 * V_49 = F_49 ( V_185 ) ;
F_50 ( & V_185 -> V_2 ) ;
F_47 ( V_49 -> V_147 ) ;
return 0 ;
}
