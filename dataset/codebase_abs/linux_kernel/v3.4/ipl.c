...
{
T_7 V_179 ;
V_179 = F_89 ( V_121 , V_121 -> V_33 . V_51 , 0 ) ;
F_90 ( & V_180 . V_181 , & V_179 , sizeof( V_179 ) ) ;
F_90 ( & V_180 . V_182 , & V_121 ,
sizeof( V_121 ) ) ;
F_83 ( V_91 ) ;
}
...
static T_4 F_114 ( struct V_42 * V_43 ,
struct V_44 * V_45 , char * V_46 )
{
...
static void T_3 F_124 ( char * V_115 , char * V_219 , int V_220 )
{
int V_221 , V_222 ;
V_222 = 0 ;
...
static int T_3 F_125 ( char * V_223 )
{
if ( ! V_87 )
return 1 ;
F_124 ( V_188 , V_223 , 127 ) ;
V_188 [ 127 ] = 0 ;
V_203 . V_202 = & V_224 ;
return 1 ;
}
...
if ( ! V_87 )
return 1 ;
F_124 ( V_194 , V_223 , 127 ) ;
V_194 [ 127 ] = 0 ;
V_210 . V_202 = & V_224 ;
return 1 ;
}
static int F_129 ( struct V_225 * V_226 ,
...
return;
V_29 |= V_32 ;
V_219 = ( void * ) ( unsigned long ) V_180 . V_240 ;
V_115 = ( void * ) V_241 ;
memmove ( V_115 , V_219 , V_161 ) ;
V_180 . V_240 = V_241 ;
}
void F_135 ( struct V_242 * V_243 )
{
F_136 ( & V_244 ) ;
F_137 ( & V_243 -> V_245 , & V_246 ) ;
F_138 ( & V_244 ) ;
}
void F_139 ( struct V_242 * V_243 )
{
F_136 ( & V_244 ) ;
F_140 ( & V_243 -> V_245 ) ;
F_138 ( & V_244 ) ;
...
void F_145 ( void (* F_146)( void * ) , void * V_88 )
{
struct V_247 * V_248 ;
V_248 = (struct V_247 * ) ( unsigned long ) F_147 () ;
V_248 -> V_249 = V_180 . V_249 ;
V_250 = ( T_7 ) ( unsigned long ) V_248 ;
F_148 ( 0 ) ;
F_149 ( 0 , 28 ) ;
V_180 . V_251 . V_252 = V_253 | V_254 ;
V_180 . V_251 . V_20 =
V_255 | ( unsigned long ) V_256 ;
V_180 . V_257 . V_252 = V_253 | V_254 ;
V_180 . V_257 . V_20 =
