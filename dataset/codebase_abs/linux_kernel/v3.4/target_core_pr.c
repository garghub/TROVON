...
V_255 = F_73 ( V_263 , V_259 , 0600 ) ;
if ( F_74 ( V_255 ) || ! V_255 || ! V_255 -> V_265 ) {
F_10 ( L_96
L_70 , V_263 ) ;
return ( F_75 ( V_255 ) < 0 ? F_75 ( V_255 ) : - V_266 ) ;
}
V_257 [ 0 ] . V_267 = & V_3 [ 0 ] ;
if ( ! V_135 )
...
V_258 = F_76 () ;
F_77 ( F_78 () ) ;
V_20 = F_79 ( V_255 , & V_257 [ 0 ] , 1 , & V_255 -> V_269 ) ;
F_77 ( V_258 ) ;
if ( V_20 < 0 ) {
F_12 ( L_97 , V_263 ) ;
F_80 ( V_255 , NULL ) ;
...
V_20 = F_71 ( V_15 , V_3 , V_135 ,
V_246 ) ;
if ( V_20 != 0 )
return V_20 ;
V_20 = F_72 ( V_15 , V_3 , 0 ) ;
if ( V_20 != 0 )
return V_20 ;
return V_20 ;
}
...
case V_43 :
case V_44 :
V_20 = F_85 ( V_8 , V_15 , type , V_282 , V_274 ) ;
break;
default:
F_10 ( L_143
L_144 , type ) ;
...
break;
case V_98 :
V_20 = F_87 ( V_8 , type , V_282 , V_274 ) ;
break;
case V_91 :
V_20 = F_88 ( V_8 , V_274 ) ;
break;
case V_92 :
V_20 = F_93 ( V_8 , type , V_282 ,
V_274 , V_129 , 0 ) ;
break;
case V_93 :
V_20 = F_93 ( V_8 , type , V_282 ,
...
int F_104 ( struct V_14 * V_15 , int V_321 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
...
V_322 -> V_36 = V_326 ;
V_322 -> V_327 . V_328 = & F_102 ;
V_322 -> V_327 . V_329 = & F_103 ;
F_12 ( L_231
