...
static int F_14 ( struct V_18 * V_19 , struct V_20 * V_10 )
{
struct V_2 * V_3 = F_13 ( V_19 ) ;
...
static int F_23 ( struct V_18 * V_19 , struct V_66 * V_67 )
{
struct V_2 * V_3 = F_13 ( V_19 ) ;
struct V_1 * V_28 = F_1 ( V_3 ) ;
...
T_2 V_93 , V_94 ;
T_1 V_58 ;
V_12 = F_6 ( V_3 , V_95 , & V_93 ) ;
if ( V_12 < 0 )
return V_12 ;
V_58 = V_93 << 8 ;
V_12 = F_6 ( V_3 , V_96 , & V_94 ) ;
if ( V_12 < 0 )
return V_12 ;
V_58 |= V_94 ;
F_31 ( & V_3 -> V_14 , L_4 , V_58 ) ;
if ( V_58 != 0x5642 )
return - V_62 ;
return 0 ;
}
...
{
struct V_1 * V_28 ;
struct V_99 * V_100 = F_33 ( V_3 ) ;
int V_12 ;
if ( ! V_100 ) {
F_8 ( & V_3 -> V_14 , L_5 ) ;
return - V_21 ;
}
V_28 = F_34 ( sizeof( struct V_1 ) , V_101 ) ;
if ( ! V_28 )
return - V_102 ;
F_35 ( & V_28 -> V_4 , V_3 , & V_103 ) ;
V_28 -> V_52 = & V_9 [ 0 ] ;
V_28 -> V_30 . V_29 = V_104 ;
V_28 -> V_30 . V_31 = V_105 ;
V_28 -> V_30 . V_40 = ( V_71 - V_104 ) / 2 ;
V_28 -> V_30 . V_41 = ( V_72 - V_105 ) / 2 ;
V_28 -> V_30 . V_29 = V_104 ;
V_28 -> V_30 . V_31 = V_105 ;
V_28 -> V_32 = V_104 + V_73 ;
V_28 -> V_33 = V_75 ;
V_12 = F_30 ( V_3 ) ;
if ( V_12 < 0 )
goto error;
