...
F_102 ( V_49 -> V_136 -> V_230 , & V_126 -> V_263 ) ;
V_126 -> V_163 = F_103 ( V_2 -> V_127 ) ;
memcpy ( V_126 -> V_161 , V_49 -> V_264 , V_49 -> V_162 ) ;
V_126 -> V_265 = 0 ;
V_126 -> V_266 = 0 ;
V_126 -> V_267 = V_2 -> V_112 . V_114 ;
V_126 -> V_268 = V_2 -> V_160 ;
if ( F_104 ( V_49 , V_262 ) ) {
switch ( V_262 [ 0 ] ) {
case V_269 :
V_126 -> V_266 = V_270 ;
...
memset ( V_49 -> V_288 , 0 , sizeof( V_49 -> V_288 ) ) ;
if ( V_280 )
...
V_274 = (struct V_240 * )
& ( V_142 -> V_222 . V_223 . V_224 . V_274 . V_293 ) ;
F_91 ( V_2 , V_274 , V_216 ) ;
...
V_2 -> V_127 = F_26 ( V_49 ) ;
V_49 -> V_54 . V_55 = ( char * ) V_2 ;
V_295 = F_112 ( V_14 -> V_296 , F_51 () ) ;
if ( V_49 -> V_259 == V_297 ) {
V_2 -> V_160 = V_298 ;
V_295 -> V_299 ++ ;
V_295 -> V_300 += V_2 -> V_127 ;
} else if ( V_49 -> V_259 == V_301 ) {
V_2 -> V_160 = V_302 ;
V_295 -> V_303 ++ ;
V_295 -> V_304 += V_2 -> V_127 ;
} else {
V_2 -> V_160 = 0 ;
V_295 -> V_305 ++ ;
}
