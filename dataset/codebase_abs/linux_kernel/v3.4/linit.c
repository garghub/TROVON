...
F_67 ( V_163 , V_176 | V_177 |
V_178 ) ;
error = F_68 ( V_163 ) ;
if ( error )
goto V_179;
error = - V_113 ;
if ( V_3 [ V_167 ] . V_180 & V_181 )
V_174 = F_69 ( 31 ) ;
else
V_174 = F_69 ( 32 ) ;
if ( F_70 ( V_163 , V_174 ) ||
...
goto V_182;
F_72 ( V_163 ) ;
V_169 = F_73 ( & V_183 , sizeof( struct V_26 ) ) ;
if ( ! V_169 )
goto V_182;
V_169 -> V_164 = V_163 -> V_164 ;
V_169 -> V_184 = F_74 ( V_163 , 0 ) ;
V_169 -> V_173 = V_173 ;
V_169 -> V_185 = 16 ;
V_27 = (struct V_26 * ) V_169 -> V_29 ;
V_27 -> V_186 = V_169 ;
V_27 -> V_163 = V_163 ;
V_27 -> V_187 = V_183 . V_187 ;
V_27 -> V_115 = V_169 -> V_173 ;
V_27 -> V_137 = V_167 ;
F_75 ( & V_27 -> V_20 ) ;
V_27 -> V_83 = F_76 ( sizeof( struct V_82 ) * ( V_169 -> V_52 + V_81 ) , V_188 ) ;
if ( ! V_27 -> V_83 )
goto V_189;
F_77 ( & V_27 -> V_190 ) ;
V_27 -> V_191 = V_192 ;
if ( ( * V_3 [ V_167 ] . V_193 ) ( V_27 ) )
goto V_194;
if ( V_27 -> V_195 ) {
if ( V_175 )
F_22 ( V_196 L_23
...
V_27 -> V_162 = F_78 ( V_197 , V_27 , V_71 ) ;
if ( F_79 ( V_27 -> V_162 ) ) {
F_22 ( V_70 L_29 ) ;
...
goto V_198;
V_27 -> V_199 = V_3 [ V_167 ] . V_200 ;
error = F_81 ( V_27 ) ;
if ( error < 0 )
goto V_198;
if ( ( V_3 [ V_167 ] . V_180 & V_201 ) &&
( V_169 -> V_202 > 34 ) ) {
V_169 -> V_202 = 34 ;
V_169 -> V_203 = ( V_169 -> V_202 * 8 ) + 112 ;
}
if ( ( V_3 [ V_167 ] . V_180 & V_204 ) &&
( V_169 -> V_202 > 17 ) ) {
V_169 -> V_202 = 17 ;
V_169 -> V_203 = ( V_169 -> V_202 * 8 ) + 112 ;
}
error = F_82 ( V_163 ,
( V_27 -> V_145 . V_205 & V_206 ) ?
( V_169 -> V_203 << 9 ) : 65536 ) ;
if ( error )
goto V_198;
if ( V_3 [ V_167 ] . V_180 & V_201 )
...
V_27 -> V_207 = 0 ;
if ( V_27 -> V_208 || V_36 || V_27 -> V_30 )
V_169 -> V_154 = V_27 -> V_199 ;
else
V_169 -> V_154 = 0 ;
F_83 ( V_27 , 0 ) ;
F_84 ( V_27 ) ;
...
if ( V_169 -> V_155 < V_27 -> V_209 )
V_169 -> V_155 = V_27 -> V_209 ;
if ( V_169 -> V_155 < V_210 )
V_169 -> V_155 = V_210 ;
else
V_169 -> V_211 = V_169 -> V_155 ;
V_169 -> V_212 = V_213 ;
F_86 ( V_163 , V_169 ) ;
...
F_89 ( V_27 ) ;
if ( V_27 -> V_214 )
F_90 ( V_27 -> V_163 , V_27 -> V_215 , V_27 -> V_214 ,
V_27 -> V_216 ) ;
F_7 ( V_27 -> V_217 ) ;
F_91 ( V_27 , 0 ) ;
F_7 ( V_27 -> V_83 ) ;
