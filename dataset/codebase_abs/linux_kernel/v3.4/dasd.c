...
void F_177 ( struct V_1 * V_2 , int V_264 )
{
V_2 -> V_244 |= V_264 ;
}
void F_145 ( struct V_1 * V_2 , int V_264 )
{
V_2 -> V_244 &= ~ V_264 ;
if ( ! V_2 -> V_244 )
F_69 ( & V_265 ) ;
}
void F_178 ( struct V_96 * V_97 )
{
struct V_1 * V_2 ;
unsigned long V_190 ;
V_2 = V_97 -> V_107 ;
...
void F_182 ( struct V_96 * V_97 , void * V_19 )
{
...
static inline int F_183 ( struct V_96 * V_97 )
{
struct V_1 * V_2 ;
int V_40 ;
V_2 = V_97 -> V_107 ;
F_172 ( F_144 ( V_2 -> V_56 ) ) ;
V_40 = ( V_97 -> V_253 == V_266 ) ;
F_174 ( F_144 ( V_2 -> V_56 ) ) ;
return V_40 ;
}
static int F_184 ( struct V_96 * V_97 )
{
struct V_1 * V_2 ;
T_6 V_267 ;
if ( V_97 -> V_199 == V_268 )
...
if ( V_97 -> V_199 == V_255 ) {
V_267 = V_2 -> V_42 -> V_270 ( V_97 ) ;
V_267 ( V_97 ) ;
return 1 ;
}
if ( V_97 -> V_199 == V_271 )
F_185 ( V_97 , & V_97 -> V_227 ) ;
if ( V_97 -> V_272 ) {
F_186 ( V_2 , V_97 ) ;
return 1 ;
}
...
return ( V_97 -> V_199 == V_268 ) ;
}
static int F_188 ( struct V_96 * V_273 , int V_274 )
{
struct V_1 * V_2 ;
int V_40 ;
struct V_100 V_15 ;
...
V_273 -> V_199 = V_268 ;
V_2 = V_273 -> V_107 ;
F_179 ( & V_273 -> V_275 , & V_15 ) ;
for ( V_97 = V_273 ; F_187 ( V_97 ) ;
V_97 = F_189 ( & V_15 ,
struct V_96 , V_275 ) ) {
if ( F_184 ( V_97 ) )
continue;
...
F_81 ( V_265 , F_183 ( V_97 ) ) ;
}
V_273 -> V_150 = F_135 () ;
if ( ( V_273 -> V_199 != V_254 ) &&
( V_273 -> V_207 != - V_277 ) )
F_185 ( V_273 , & V_273 -> V_227 ) ;
if ( V_273 -> V_199 == V_254 )
V_40 = 0 ;
else if ( V_273 -> V_207 )
V_40 = V_273 -> V_207 ;
...
V_97 -> V_253 = V_278 ;
V_97 -> V_199 = V_226 ;
F_179 ( & V_97 -> V_243 , V_2 -> V_15 . V_228 ) ;
F_73 ( V_2 ) ;
F_174 ( F_144 ( V_2 -> V_56 ) ) ;
F_81 ( V_265 , F_183 ( V_97 ) ) ;
if ( V_97 -> V_199 == V_254 )
...
void F_197 ( struct V_33 * V_34 , int V_223 )
{
if ( V_223 == 0 )
F_147 ( & V_34 -> V_16 ) ;
else
...
T_6 V_267 ;
if ( V_97 -> V_199 == V_254 )
F_39 ( V_279 , V_2 , L_1 , L_86 ) ;
else
F_136 ( & V_2 -> V_56 -> V_57 , L_87 ) ;
V_267 = V_2 -> V_42 -> V_280 ( V_97 ) ;
V_267 ( V_97 ) ;
}
...
return;
if ( V_283 -> V_26 < V_69 ) {
while ( ( V_99 = F_199 ( V_34 -> V_281 ) ) )
F_200 ( V_99 , - V_205 ) ;
return;
}
while ( ( V_99 = F_201 ( V_282 ) ) ) {
if ( V_283 -> V_79 & V_284 &&
F_84 ( V_99 ) == V_285 ) {
F_39 ( V_183 , V_283 ,
L_88 ,
...
V_97 = V_283 -> V_42 -> V_286 ( V_283 , V_34 , V_99 ) ;
if ( F_30 ( V_97 ) ) {
if ( F_102 ( V_97 ) == - V_206 )
break;
if ( F_102 ( V_97 ) == - V_4 )
...
V_97 -> V_199 = V_268 ;
F_202 ( V_99 ) ;
F_181 ( & V_97 -> V_275 , & V_34 -> V_15 ) ;
F_82 ( V_34 , V_97 , V_99 ) ;
}
}
static void F_203 ( struct V_96 * V_97 )
{
struct V_98 * V_99 ;
int V_199 ;
int error = 0 ;
...
V_199 = V_97 -> V_34 -> V_63 -> V_42 -> V_287 ( V_97 , V_99 ) ;
if ( V_199 <= 0 )
...
V_97 = F_158 ( V_101 , struct V_96 , V_275 ) ;
if ( V_97 -> V_199 != V_254 &&
V_97 -> V_199 != V_271 &&
V_97 -> V_199 != V_255 &&
V_97 -> V_199 != V_256 )
continue;
if ( V_97 -> V_199 == V_256 ) {
V_63 -> V_42 -> V_269 ( V_97 ) ;
goto V_288;
}
if ( V_97 -> V_199 == V_255 ) {
V_267 = V_63 -> V_42 -> V_270 ( V_97 ) ;
if ( F_30 ( V_267 ( V_97 ) ) )
continue;
goto V_288;
}
...
V_97 -> V_150 = F_135 () ;
F_163 ( & V_97 -> V_275 , V_252 ) ;
}
}
static void F_206 ( struct V_96 * V_97 , void * V_19 )
{
F_58 ( V_97 -> V_34 ) ;
}
...
static void F_209 ( struct V_96 * V_97 , void * V_19 )
{
F_69 ( & V_241 ) ;
}
...
break;
V_97 -> F_165 = F_209 ;
for ( V_167 = 0 ; V_97 != NULL ; V_97 = V_97 -> V_272 , V_167 ++ )
F_163 ( & V_97 -> V_275 , & V_262 ) ;
if ( V_167 > 1 )
goto V_288;
}
F_94 ( & V_34 -> V_38 ) ;
...
static void F_210 ( struct V_281 * V_282 )
{
struct V_33 * V_34 ;
V_34 = V_282 -> V_292 ;
F_85 ( & V_34 -> V_38 ) ;
...
{
int V_40 ;
V_34 -> V_281 = F_211 ( F_210 ,
& V_34 -> V_36 ) ;
if ( V_34 -> V_281 == NULL )
return - V_4 ;
V_34 -> V_281 -> V_292 = V_34 ;
F_212 ( V_34 -> V_281 -> V_293 ) ;
V_34 -> V_281 -> V_293 = NULL ;
V_40 = F_213 ( V_34 -> V_281 , L_91 ) ;
if ( V_40 ) {
F_214 ( V_34 -> V_281 ) ;
return V_40 ;
}
...
V_294 = V_34 -> V_63 -> V_42 -> V_295 << V_34 -> V_68 ;
}
F_215 ( V_34 -> V_281 ,
V_34 -> V_70 ) ;
F_216 ( V_34 -> V_281 , V_294 ) ;
F_217 ( V_34 -> V_281 , - 1L ) ;
F_218 ( V_34 -> V_281 , V_9 ) ;
F_219 ( V_34 -> V_281 , V_9 - 1 ) ;
}
...
static int F_220 ( struct V_296 * V_83 , T_7 V_175 )
{
struct V_1 * V_63 ;
int V_40 ;
...
static int F_226 ( struct V_71 * V_72 , T_7 V_175 )
{
struct V_1 * V_63 ;
V_63 = F_221 ( V_72 ) ;
if ( ! V_63 )
...
static int F_227 ( struct V_296 * V_83 , struct V_301 * V_302 )
{
struct V_1 * V_63 ;
V_63 = F_221 ( V_83 -> V_84 ) ;
if ( ! V_63 )
...
V_63 -> V_42 -> V_303 ( V_63 -> V_34 , V_302 ) ;
V_302 -> V_304 = F_228 ( V_83 ) >> V_63 -> V_34 -> V_68 ;
F_23 ( V_63 ) ;
return 0 ;
}
static void
...
if ( ! V_311 )
return 0 ;
F_237 ( V_2 -> V_56 , & V_308 ) ;
memset ( & V_310 , 0 , sizeof( V_310 ) ) ;
V_310 . V_312 = V_308 . V_313 ;
V_310 . V_314 = sizeof( V_310 ) ;
V_40 = V_309 ( & V_310 ) ;
if ( V_40 == 0 || V_40 == 2 ) {
return V_310 . V_315 & 0x80 ;
} else {
F_117 ( V_60 , L_96 ,
V_308 . V_313 , V_40 ) ;
return 0 ;
...
static void F_238 ( void * V_19 , T_8 V_316 )
{
...
if ( V_317 )
F_240 ( L_97 ,
F_35 ( & V_56 -> V_57 ) , V_317 ) ;
}
int F_241 ( struct V_224 * V_56 ,
struct V_318 * V_42 )
{
int V_317 ;
V_317 = F_242 ( V_56 ) ;
...
V_56 -> V_319 = & F_154 ;
if ( ( F_243 ( V_56 , V_320 ) > 0 ) ||
( V_321 && F_244 ( F_35 ( & V_56 -> V_57 ) ) != 0 ) )
F_245 ( F_238 , V_56 ) ;
return 0 ;
}
void F_246 ( struct V_224 * V_56 )
{
struct V_1 * V_2 ;
struct V_33 * V_34 ;
V_56 -> V_319 = NULL ;
...
int F_260 ( struct V_224 * V_56 , int V_326 )
{
struct V_1 * V_2 ;
int V_317 ;
V_2 = F_151 ( V_56 ) ;
...
void F_261 ( struct V_224 * V_56 , int * V_331 )
{
int V_332 ;
T_9 V_333 , V_334 ;
struct V_1 * V_2 ;
...
if ( F_30 ( V_2 ) )
return;
for ( V_332 = 0 ; V_332 < 8 ; V_332 ++ ) {
V_334 = 0x80 >> V_332 ;
if ( V_331 [ V_332 ] & V_335 ) {
V_333 = V_2 -> V_214 . V_215 ;
V_2 -> V_214 . V_215 &= ~ V_334 ;
V_2 -> V_214 . V_218 &= ~ V_334 ;
V_2 -> V_214 . V_219 &= ~ V_334 ;
if ( V_333 && ! V_2 -> V_214 . V_215 )
F_142 ( V_2 ) ;
}
if ( V_331 [ V_332 ] & V_336 ) {
V_2 -> V_214 . V_215 &= ~ V_334 ;
V_2 -> V_214 . V_218 &= ~ V_334 ;
V_2 -> V_214 . V_219 &= ~ V_334 ;
V_2 -> V_214 . V_220 |= V_334 ;
F_73 ( V_2 ) ;
}
if ( V_331 [ V_332 ] & V_337 ) {
F_39 ( V_60 , V_2 , L_1 ,
L_116 ) ;
if ( V_2 -> V_42 -> V_95 )
V_2 -> V_42 -> V_95 ( V_2 ) ;
...
int F_262 ( struct V_1 * V_2 , T_9 V_213 )
{
...
if ( V_2 -> V_34 )
F_58 ( V_2 -> V_34 ) ;
F_257 ( V_339 , & V_2 -> V_190 ) ;
F_23 ( V_2 ) ;
return 0 ;
}
static struct V_96 * F_266 ( struct V_1 * V_2 ,
void * V_342 ,
int V_343 ,
int V_184 )
{
...
V_344 = ( unsigned long * ) ( V_97 -> V_19 ) ;
V_192 -> V_347 = ( V_348 ) ( V_349 ) V_344 ;
V_192 -> V_190 = V_350 ;
V_344 = F_268 ( V_344 , V_342 , V_343 ) ;
} else {
V_192 -> V_347 = ( V_348 ) ( V_349 ) V_342 ;
V_192 -> V_190 = 0 ;
}
V_192 -> V_351 = V_343 ;
V_97 -> V_107 = V_2 ;
...
int F_269 ( struct V_1 * V_2 , int V_184 ,
void * V_342 , int V_343 )
{
int V_317 ;
struct V_96 * V_97 ;
V_97 = F_266 ( V_2 , V_342 , V_343 ,
V_184 ) ;
if ( F_30 ( V_97 ) )
return F_102 ( V_97 ) ;
V_317 = F_193 ( V_97 ) ;
F_130 ( V_97 , V_97 -> V_352 ) ;
return V_317 ;
}
char * F_270 ( struct V_227 * V_227 )
{
struct V_353 * V_353 = NULL ;
char * V_354 = NULL ;
if ( F_271 ( & V_227 -> V_231 ) && ( V_227 -> V_231 . V_355 . V_356 == 0x01 ) ) {
if ( V_227 -> V_231 . V_355 . V_357 )
V_353 = F_272 ( (struct V_357 * ) ( unsigned long )
V_227 -> V_231 . V_355 . V_357 ) ;
if ( V_353 && V_353 -> V_358 == 64 && V_353 -> V_190 )
switch ( V_353 -> V_190 & 0x07 ) {
case 1 :
...
} else if ( V_227 -> V_362 . V_363 . V_364 . V_365 ) {
V_354 = V_227 -> V_366 ;
}
return V_354 ;
}
...
F_274 ( & V_241 ) ;
F_274 ( & V_265 ) ;
V_306 = F_36 ( L_33 , 1 , 1 , 8 * sizeof( long ) ) ;
if ( V_306 == NULL ) {
V_40 = - V_4 ;
goto V_367;
}
