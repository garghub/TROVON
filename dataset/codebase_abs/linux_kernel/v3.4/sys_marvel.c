...
static int
F_22 ( struct V_38 * V_39 , T_2 V_40 , T_2 V_41 )
{
struct V_42 * V_43 = V_39 -> V_44 ;
struct V_45 * V_45 = V_43 -> V_44 ;
struct V_6 * V_6 = V_45 -> V_6 ;
int V_46 , V_47 ;
T_3 V_48 ;
T_3 V_49 ;
T_2 V_50 ;
...
V_48 = 0 ;
if ( V_46 )
F_25 ( V_39 , V_46 + V_53 , & V_48 ) ;
if ( V_48 & V_54 ) {
V_47 = V_55 ;
if ( V_48 & V_56 )
V_47 = V_57 ;
F_25 ( V_39 , V_46 + V_47 , & V_49 ) ;
V_3 = V_49 & 0x1ff ;
V_3 += 0x80 ;
#if 1
F_5 ( L_6 ,
...
V_66 -> V_67 = F_37 ( V_66 -> time ) ;
}
static void
F_38 ( void * V_64 )
{
struct V_65 * V_66 = V_64 ;
V_66 -> V_67 = F_39 ( V_66 -> time ) ;
}
static unsigned int
F_40 ( struct V_68 * time )
{
#ifdef F_41
struct V_65 V_66 ;
if ( F_42 () != V_27 ) {
V_66 . time = time ;
F_43 ( V_27 , F_36 , & V_66 , 1 ) ;
return V_66 . V_67 ;
}
#endif
return F_37 ( time ) ;
...
static int
F_44 ( struct V_68 * time )
{
#ifdef F_41
struct V_65 V_66 ;
if ( F_42 () != V_27 ) {
V_66 . time = time ;
F_43 ( V_27 , F_38 , & V_66 , 1 ) ;
return V_66 . V_67 ;
}
#endif
return F_39 ( time ) ;
...
{
int V_69 = F_46 () ;
struct V_6 * V_6 = F_4 ( V_69 ) ;
unsigned int V_26 ;
if ( ! V_6 )
return;
F_5 ( L_9 , V_69 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_28 . V_13 , V_69 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_29 . V_13 , V_69 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_30 . V_13 , V_69 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_31 . V_13 , V_69 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_32 . V_13 , V_69 ) ;
for ( V_26 = 0 ; V_26 < 0x60 ; ++ V_26 )
F_13 ( V_6 , V_26 , V_69 ) ;
F_13 ( V_6 , 0x74 , V_69 ) ;
F_13 ( V_6 , 0x75 , V_69 ) ;
