...
V_83 = F_56 ( V_74 , V_9 -> V_35 , & F_10 , 0 , V_125 ,
V_9 ) ;
if ( V_83 ) {
F_50 ( V_74 , L_10 ) ;
V_83 = - V_62 ;
...
V_50 -> V_133 = F_46 ;
F_57 ( & V_50 -> V_7 ) ;
F_58 ( V_134 , V_50 -> V_135 ) ;
F_58 ( V_136 , V_50 -> V_135 ) ;
F_58 ( V_137 , V_50 -> V_135 ) ;
F_58 ( V_138 , V_50 -> V_135 ) ;
...
static int T_8 F_69 ( struct V_109 * V_110 )
{
struct V_106 * V_74 = & V_110 -> V_74 ;
struct V_5 * V_9 = F_70 ( V_74 ) ;
F_71 ( & V_9 -> V_50 ) ;
F_65 ( V_74 , V_9 -> V_35 , V_9 ) ;
F_66 ( V_9 -> V_35 ) ;
F_67 ( V_9 -> V_17 ) ;
