...
V_5 -> V_50 = V_33 -> V_51 ;
V_5 -> V_52 = F_39 ( V_33 ) ;
if ( ! F_40 ( V_5 -> V_50 , V_5 -> V_52 ,
V_36 -> V_53 ) ) {
V_7 = - V_54 ;
goto V_49;
}
V_5 -> V_9 = F_41 ( V_5 -> V_50 , V_5 -> V_52 ) ;
if ( V_5 -> V_9 == NULL ) {
F_42 ( & V_31 -> V_13 , L_4 ) ;
V_7 = - V_46 ;
goto V_55;
