...
struct V_17 * V_18 = F_8 ( V_2 ) ;
int V_62 , V_19 ;
V_62 = F_23 ( V_2 , 7 , 9 , V_18 -> V_74 ) ;
if ( V_62 != 0 ) {
F_10 ( V_2 -> V_26 , L_4 , V_62 ) ;
return V_62 ;
}
for ( V_19 = 0 ; V_19 < F_5 ( V_18 -> V_70 ) ; V_19 ++ )
V_18 -> V_70 [ V_19 ] . V_75 = V_76 [ V_19 ] ;
...
static T_2 int F_28 ( struct V_84 * V_85 ,
const struct V_86 * V_87 )
{
struct V_17 * V_18 ;
int V_62 ;
V_18 = F_29 ( sizeof( struct V_17 ) , V_88 ) ;
if ( V_18 == NULL )
return - V_89 ;
F_30 ( V_85 , V_18 ) ;
V_18 -> V_74 = V_90 ;
...
static T_3 int F_33 ( struct V_84 * V_93 )
{
F_34 ( & V_93 -> V_26 ) ;
F_32 ( F_35 ( V_93 ) ) ;
return 0 ;
}
static int T_2 F_36 ( struct V_94 * V_95 )
{
struct V_17 * V_18 ;
int V_62 ;
V_18 = F_29 ( sizeof( struct V_17 ) , V_88 ) ;
...
static int T_3 F_38 ( struct V_94 * V_95 )
{
F_34 ( & V_95 -> V_26 ) ;
F_32 ( F_39 ( V_95 ) ) ;
return 0 ;
