...
V_25 -> V_65 = NULL ;
if ( V_7 -> V_66 . V_67 != 0x00 ) {
V_20 = F_17 ( sizeof( * V_20 ) , V_68 ) ;
if ( ! V_20 )
return;
V_20 -> V_48 = ( V_62 -> V_69 << 8 ) | V_62 -> V_70 ;
V_20 -> V_46 = ( V_62 -> V_71 << 8 ) | V_62 -> V_72 ;
V_20 -> V_73 = V_20 -> V_48 + \
( ( V_62 -> V_74 << 8 ) | \
V_62 -> V_75 ) ;
V_20 -> V_76 = V_20 -> V_73 + \
( ( V_62 -> V_77 << 8 ) | \
V_62 -> V_78 ) ;
V_20 -> V_79 = V_20 -> V_48 + ( ( V_62 -> V_80 << 8 ) | \
V_62 -> V_81 ) ;
V_20 -> V_82 = \
V_20 -> V_46 + ( ( V_62 -> V_83 << 4 ) | \
V_62 -> V_84 ) ;
V_20 -> V_85 = \
V_20 -> V_82 + ( ( V_62 -> V_86 << 4 ) | \
V_62 -> V_87 ) ;
V_20 -> V_88 = V_20 -> V_46 + \
( ( V_62 -> V_89 << 8 ) | V_62 -> V_90 ) ;
V_20 -> clock = V_62 -> V_91 * 10 ;
#if 0
