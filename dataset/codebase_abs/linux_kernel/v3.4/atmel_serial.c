...
static void F_122 ( struct V_2 * V_4 , int V_69 )
{
while ( ! ( F_15 ( V_4 ) & V_23 ) )
F_109 () ;
F_39 ( V_4 , V_69 ) ;
}
static void F_123 ( struct V_243 * V_244 , const char * V_245 , T_1 V_107 )
{
...
static void T_5 F_125 ( struct V_2 * V_4 , int * V_152 ,
int * V_84 , int * V_248 )
{
unsigned int V_249 , V_151 ;
V_151 = F_126 ( V_4 ) & V_250 ;
if ( ! V_151 )
return;
V_249 = F_8 ( V_4 ) & V_154 ;
if ( V_249 == V_167 )
...
F_89 ( V_246 [ V_244 -> V_247 ] . V_144 ) ;
F_7 ( V_4 , - 1 ) ;
F_20 ( V_4 , V_53 | V_139 ) ;
F_20 ( V_4 , V_140 | V_54 ) ;
if ( V_251 )
F_128 ( V_251 , & V_152 , & V_84 , & V_248 , & V_252 ) ;
else
F_125 ( V_4 , & V_152 , & V_84 , & V_248 ) ;
return F_129 ( V_4 , V_244 , V_152 , V_84 , V_248 , V_252 ) ;
}
