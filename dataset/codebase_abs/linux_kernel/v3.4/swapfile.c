...
static inline int F_84 ( struct V_97 * V_98 , T_9 * V_115 ,
unsigned long V_100 , unsigned long V_111 ,
T_1 V_6 , struct V_7 * V_7 )
{
T_8 * V_114 ;
unsigned long V_28 ;
int V_8 ;
V_114 = F_85 ( V_115 , V_100 ) ;
do {
V_28 = F_86 ( V_100 , V_111 ) ;
if ( F_87 ( V_114 ) )
continue;
...
V_115 = F_91 ( V_98 -> V_105 , V_100 ) ;
do {
V_28 = F_92 ( V_100 , V_111 ) ;
if ( F_93 ( V_115 ) )
continue;
V_8 = F_84 ( V_98 , V_115 , V_100 , V_28 , V_6 , V_7 ) ;
if ( V_8 )
return V_8 ;
...
if ( V_98 -> V_124 && ( V_8 = F_88 ( V_98 , V_6 , V_7 ) ) )
break;
}
F_98 ( & V_120 -> V_121 ) ;
return ( V_8 < 0 ) ? V_8 : 0 ;
...
T_2 F_117 ( struct V_7 * V_7 , struct V_92 * * V_19 )
{
T_1 V_6 ;
V_6 . V_10 = F_40 ( V_7 ) ;
return F_59 ( V_6 , V_19 ) ;
}
static void F_118 ( struct V_3 * V_94 )
{
while ( ! F_119 ( & V_94 -> V_16 . V_27 ) ) {
struct V_11 * V_12 ;
...
static int
F_122 ( struct V_3 * V_94 , unsigned long V_21 ,
...
V_146 = F_123 ( sizeof( * V_12 ) , V_20 ) ;
if ( V_146 == NULL )
return - V_106 ;
V_146 -> V_21 = V_21 ;
V_146 -> V_18 = V_18 ;
V_146 -> V_13 = V_13 ;
F_124 ( & V_146 -> V_27 , & V_94 -> V_16 . V_27 ) ;
return 1 ;
}
static int F_125 ( struct V_3 * V_94 , T_2 * V_147 )
{
struct V_148 * V_148 ;
unsigned V_149 ;
unsigned long V_150 ;
...
if ( F_126 ( V_148 -> V_160 ) ) {
V_8 = F_122 ( V_94 , 0 , V_94 -> V_46 , 0 ) ;
* V_147 = V_94 -> V_40 ;
goto V_67;
}
V_151 = V_148 -> V_161 ;
...
V_152 = 0 ;
V_150 = 0 ;
V_153 = F_127 ( V_148 ) >> V_151 ;
while ( ( V_152 + V_149 ) <= V_153 &&
V_150 < V_94 -> V_46 ) {
unsigned V_162 ;
T_2 V_163 ;
V_163 = F_128 ( V_148 , V_152 ) ;
if ( V_163 == 0 )
goto V_164;
if ( V_163 & ( V_149 - 1 ) ) {
V_152 ++ ;
...
static unsigned F_130 ( struct V_170 * V_170 , T_10 * V_171 )
{
struct V_172 * V_173 = V_170 -> V_174 ;
F_131 ( V_170 , & V_175 , V_171 ) ;
if ( V_173 -> V_176 != F_104 ( & V_177 ) ) {
V_173 -> V_176 = F_104 ( & V_177 ) ;
return V_178 | V_179 | V_180 | V_181 ;
}
return V_178 | V_179 ;
}
static void * F_132 ( struct V_172 * V_182 , T_11 * V_183 )
{
struct V_3 * V_4 ;
int type ;
T_11 V_184 = * V_183 ;
...
static void * F_135 ( struct V_172 * V_182 , void * V_187 , T_11 * V_183 )
{
...
static void F_136 ( struct V_172 * V_182 , void * V_187 )
{
F_137 ( & V_185 ) ;
}
static int F_138 ( struct V_172 * V_182 , void * V_187 )
{
struct V_3 * V_4 = V_187 ;
struct V_170 * V_170 ;
int V_188 ;
...
V_170 = V_4 -> V_157 ;
V_188 = F_140 ( V_182 , & V_170 -> V_189 , L_4 ) ;
F_141 ( V_182 , L_5 ,
V_188 < 40 ? 40 - V_188 : 1 , L_6 ,
F_126 ( V_170 -> V_189 . V_190 -> V_191 -> V_160 ) ?
L_7 : L_8 ,
V_4 -> V_40 << ( V_17 - 10 ) ,
V_4 -> V_41 << ( V_17 - 10 ) ,
V_4 -> V_64 ) ;
...
static int F_142 ( struct V_148 * V_148 , struct V_170 * V_170 )
{
struct V_172 * V_173 ;
int V_8 ;
V_8 = F_143 ( V_170 , & V_192 ) ;
if ( V_8 )
return V_8 ;
V_173 = V_170 -> V_174 ;
V_173 -> V_176 = F_104 ( & V_177 ) ;
...
static int F_153 ( struct V_3 * V_66 , struct V_148 * V_148 )
{
int error ;
if ( F_126 ( V_148 -> V_160 ) ) {
V_66 -> V_19 = F_56 ( F_154 ( V_148 ) ) ;
...
V_66 -> V_200 = F_156 ( V_66 -> V_19 ) ;
error = F_157 ( V_66 -> V_19 , V_113 ) ;
if ( error < 0 )
return error ;
V_66 -> V_36 |= V_87 ;
} else if ( F_158 ( V_148 -> V_160 ) ) {
...
if ( F_161 ( V_205 -> V_209 . V_210 ) == 1 ) {
F_162 ( & V_205 -> V_209 . V_210 ) ;
F_162 ( & V_205 -> V_209 . V_211 ) ;
F_162 ( & V_205 -> V_209 . V_212 ) ;
for ( V_126 = 0 ; V_126 < V_205 -> V_209 . V_212 ; V_126 ++ )
F_162 ( & V_205 -> V_209 . V_213 [ V_126 ] ) ;
}
...
if ( ! V_206 )
return 0 ;
V_207 = F_127 ( V_148 ) >> V_17 ;
if ( V_207 && V_206 > V_207 ) {
F_31 ( V_214
L_13 ) ;
return 0 ;
}
if ( V_205 -> V_209 . V_212 && F_158 ( V_148 -> V_160 ) )
return 0 ;
...
{
int V_15 = 0 ;
while ( ! V_15 && F_168 ( V_6 , 1 ) == - V_106 )
V_15 = F_171 ( V_6 , V_227 ) ;
return V_15 ;
}
int F_172 ( T_1 V_6 )
{
...
if ( ! ( V_79 & V_82 ) )
goto V_67;
V_235 = F_176 ( V_229 ) + V_5 ;
V_79 = * V_235 ;
F_177 ( V_235 ) ;
if ( ( V_79 & ~ V_82 ) != V_236 )
goto V_67;
}
F_124 ( & V_7 -> V_233 , & V_65 -> V_233 ) ;
V_7 = NULL ;
V_67:
F_19 ( & V_48 ) ;
V_231:
...
V_5 &= ~ V_232 ;
V_7 = F_14 ( V_65 -> V_233 . V_28 , struct V_7 , V_233 ) ;
V_235 = F_176 ( V_7 ) + V_5 ;
if ( V_79 == V_83 )
goto V_237;
if ( V_79 == ( V_83 | V_82 ) ) {
while ( * V_235 == ( V_236 | V_82 ) ) {
F_177 ( V_235 ) ;
V_7 = F_14 ( V_7 -> V_233 . V_28 , struct V_7 , V_233 ) ;
F_116 ( V_7 == V_65 ) ;
V_235 = F_176 ( V_7 ) + V_5 ;
}
if ( * V_235 == V_236 ) {
...
* V_235 += 1 ;
F_177 ( V_235 ) ;
V_7 = F_14 ( V_7 -> V_233 . V_125 , struct V_7 , V_233 ) ;
while ( V_7 != V_65 ) {
V_235 = F_176 ( V_7 ) + V_5 ;
* V_235 = V_82 ;
F_177 ( V_235 ) ;
...
V_65 = F_174 ( V_4 -> V_52 + V_5 ) ;
if ( F_40 ( V_65 ) ) {
struct V_24 * V_238 , * V_28 ;
F_114 (this, next, &head->lru) {
struct V_7 * V_7 ;
V_7 = F_14 ( V_238 , struct V_7 , V_233 ) ;
F_120 ( V_238 ) ;
F_178 ( V_7 ) ;
}
}
