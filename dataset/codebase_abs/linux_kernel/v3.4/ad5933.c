...
T_4 V_70 ;
int V_6 ;
if ( F_36 ( V_47 -> V_71 , V_47 -> V_72 ) )
return - V_33 ;
V_70 = F_37 ( V_47 -> V_71 ,
V_47 -> V_72 ) *
V_73 [ 1 ] . V_74 . V_75 / 8 ;
if ( V_47 -> V_76 -> V_77 -> V_78 )
V_47 -> V_76 -> V_77 ->
V_78 ( V_47 -> V_76 , V_70 ) ;
V_6 = F_7 ( V_9 ) ;
if ( V_6 < 0 )
...
static void F_45 ( struct V_90 * V_82 )
{
struct V_8 * V_9 = F_46 ( V_82 ,
struct V_8 , V_82 . V_82 ) ;
struct V_46 * V_47 = F_47 ( V_9 -> V_2 ) ;
struct V_91 * V_92 = V_47 -> V_76 ;
signed short V_45 [ 2 ] ;
unsigned char V_93 ;
F_21 ( & V_47 -> V_50 ) ;
if ( V_9 -> V_81 == V_80 ) {
F_6 ( V_9 , V_94 ) ;
V_9 -> V_81 = V_94 ;
F_39 ( & V_9 -> V_82 , V_9 -> V_95 ) ;
F_22 ( & V_47 -> V_50 ) ;
return;
}
F_4 ( V_9 -> V_2 , V_21 , 1 , & V_93 ) ;
if ( V_93 & V_96 ) {
int V_97 = F_37 ( V_47 -> V_71 ,
V_47 -> V_72 ) ;
F_4 ( V_9 -> V_2 ,
F_48 ( 1 , V_47 -> V_71 ) ?
V_98 : V_99 ,
...
V_92 -> V_77 -> V_100 ( V_92 , ( T_1 * ) V_45 , F_49 () ) ;
} else {
F_39 ( & V_9 -> V_82 , V_9 -> V_95 ) ;
F_22 ( & V_47 -> V_50 ) ;
return;
...
static int T_5 F_50 ( struct V_1 * V_2 ,
const struct V_103 * V_104 )
{
int V_6 , V_105 = 0 ;
struct V_106 * V_107 = V_2 -> V_7 . V_108 ;
struct V_8 * V_9 ;
struct V_46 * V_47 = F_51 ( sizeof( * V_9 ) ) ;
if ( V_47 == NULL )
return - V_85 ;
V_9 = F_19 ( V_47 ) ;
F_52 ( V_2 , V_47 ) ;
...
if ( V_6 )
goto V_123;
V_6 = F_58 ( V_47 , & V_73 [ 1 ] , 2 ) ;
if ( V_6 )
goto V_124;
F_59 ( V_47 , V_47 -> V_76 , 0 ) ;
F_59 ( V_47 , V_47 -> V_76 , 1 ) ;
V_6 = F_14 ( V_9 ) ;
if ( V_6 )
goto V_125;
V_6 = F_60 ( V_47 ) ;
...
static T_6 int F_66 ( struct V_1 * V_2 )
{
