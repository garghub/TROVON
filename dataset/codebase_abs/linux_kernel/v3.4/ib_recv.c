...
V_157 -> V_162 = F_98 ( V_159 -> V_132 ) ;
V_157 -> V_163 = 1 ;
if ( V_159 -> V_133 )
F_99 ( V_77 , V_159 -> V_133 ) ;
...
F_100 ( V_77 , V_77 -> V_78 , V_77 -> V_171 ,
& V_63 -> V_67 , V_172 ) ;
V_157 -> V_173 = F_98 ( V_130 -> V_169 ) ;
V_157 -> V_174 = 1 ;
}
...
void F_101 ( struct V_177 * V_178 , void * V_179 )
{
...
struct V_182 V_183 ;
struct V_3 * V_4 ;
while ( F_104 ( V_2 -> V_184 , 1 , & V_183 ) > 0 ) {
F_22 ( L_21 ,
( unsigned long long ) V_183 . V_15 , V_183 . V_185 ,
F_105 ( V_183 . V_185 ) , V_183 . V_186 ,
F_62 ( V_183 . V_187 . V_188 ) ) ;
F_36 ( V_189 ) ;
V_4 = & V_2 -> V_6 [ F_106 ( & V_2 -> V_7 ) ] ;
F_31 ( V_2 -> V_68 -> V_69 , & V_4 -> V_12 -> V_61 , 1 , V_70 ) ;
if ( V_183 . V_185 == V_190 ) {
F_95 ( V_77 , V_4 , V_183 . V_186 , V_157 ) ;
} else {
...
void F_109 ( unsigned long V_191 )
{
struct V_1 * V_2 = (struct V_1 * ) V_191 ;
struct V_80 * V_77 = V_2 -> V_77 ;
struct V_156 V_157 = { 0 , } ;
F_103 ( V_2 , & V_157 ) ;
F_110 ( V_2 -> V_184 , V_192 ) ;
F_103 ( V_2 , & V_157 ) ;
if ( V_157 . V_174 )
F_67 ( V_2 , V_157 . V_173 , V_157 . V_124 ) ;
if ( V_157 . V_163 && V_157 . V_162 > V_2 -> V_193 ) {
F_111 ( V_77 , V_157 . V_162 , NULL ) ;
