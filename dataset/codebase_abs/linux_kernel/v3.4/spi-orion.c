...
if ( V_22 -> V_26 && V_22 -> V_26 < V_1 -> V_65 ) {
F_17 ( & V_12 -> V_39 ,
L_5
L_9
L_10 ,
...
static int T_5 F_38 ( struct V_70 * V_71 )
{
struct V_72 * V_17 ;
struct V_1 * V_12 ;
struct V_73 * V_74 ;
...
int V_54 = 0 ;
V_18 = V_71 -> V_39 . V_76 ;
V_17 = F_39 ( & V_71 -> V_39 , sizeof *V_12 ) ;
if ( V_17 == NULL ) {
F_40 ( & V_71 -> V_39 , L_11 ) ;
return - V_77 ;
}
...
V_12 -> V_17 = V_17 ;
V_12 -> V_18 = V_18 ;
V_12 -> V_64 = F_10 ( V_18 -> V_19 , 4 ) ;
V_12 -> V_65 = F_10 ( V_18 -> V_19 , 30 ) ;
V_74 = F_42 ( V_71 , V_85 , 0 ) ;
if ( V_74 == NULL ) {
V_54 = - V_86 ;
goto V_46;
}
if ( ! F_43 ( V_74 -> V_87 , F_44 ( V_74 ) ,
F_45 ( & V_71 -> V_39 ) ) ) {
V_54 = - V_88 ;
goto V_46;
}
V_12 -> V_3 = F_46 ( V_74 -> V_87 , V_89 ) ;
F_47 ( & V_12 -> V_48 , F_24 ) ;
F_48 ( & V_12 -> V_49 ) ;
F_49 ( & V_12 -> V_50 ) ;
if ( F_31 ( V_12 ) < 0 )
...
return V_54 ;
V_90:
F_51 ( V_74 -> V_87 , F_44 ( V_74 ) ) ;
V_46:
F_52 ( V_17 ) ;
return V_54 ;
}
static int T_6 F_53 ( struct V_70 * V_71 )
{
struct V_72 * V_17 ;
struct V_1 * V_12 ;
struct V_73 * V_74 ;
