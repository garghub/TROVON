...
static void F_37 ( struct V_69 * V_64 )
{
F_33 ( V_64 , V_79 ) ;
F_33 ( V_64 , V_16 ) ;
}
static int T_3 F_38 ( struct V_81 * V_82 )
{
return F_39 ( & V_82 -> V_21 , & V_83 ) ;
}
static int T_4 F_40 ( struct V_81 * V_82 )
{
F_41 ( & V_82 -> V_21 ) ;
return 0 ;
}
