...
static int F_155 ( struct V_258 * V_259 , T_9 V_271 )
{
return 0 ;
}
...
static int T_3 F_157 ( struct V_272 * V_67 )
{
#ifdef F_158
const struct V_273 * V_274 ;
struct V_4 * V_138 ;
struct V_235 V_235 ;
const T_10 * V_152 , * V_147 , * V_149 ;
struct V_275 * V_276 = V_67 -> V_67 . V_277 ;
int V_192 ;
int V_278 ;
F_67 ( & V_67 -> V_67 , L_68 ) ;
V_274 = F_159 ( V_279 , & V_67 -> V_67 ) ;
if ( ! V_274 )
return - V_156 ;
V_192 = F_160 ( V_276 , 0 , & V_235 ) ;
if ( V_192 ) {
F_26 ( & V_67 -> V_67 , V_280 L_69 ) ;
return V_192 ;
}
V_152 = F_161 ( V_276 , L_70 , & V_278 ) ;
if ( V_152 && V_278 != 4 ) {
F_26 ( & V_67 -> V_67 , V_280 L_71 ) ;
return - V_156 ;
}
V_147 = F_161 ( V_276 , L_72 , & V_278 ) ;
if ( V_147 && V_278 != 4 ) {
F_26 ( & V_67 -> V_67 , V_280 L_73 ) ;
return - V_156 ;
}
V_149 = F_161 ( V_276 , L_74 , & V_278 ) ;
if ( V_149 && V_278 != 4 ) {
F_26 ( & V_67 -> V_67 , V_280 L_75 ) ;
return - V_156 ;
}
V_138 = F_108 () ;
if ( ! V_138 ) {
...
V_138 -> V_121 . V_152 = V_152 ? F_162 ( V_152 ) : V_282 ;
V_138 -> V_121 . V_147 = V_147 ? F_162 ( V_147 ) : V_187 ;
V_138 -> V_121 . V_149 = V_149 ? F_162 ( V_149 ) : 0 ;
V_138 -> V_44 = F_163 ( V_67 -> V_67 . V_277 , 0 ) ;
V_138 -> V_67 = & V_67 -> V_67 ;
F_164 ( & V_67 -> V_67 , L_77 ,
V_138 -> V_121 . V_146 , V_138 -> V_121 . V_152 , V_138 -> V_121 . V_147 ,
V_138 -> V_44 ) ;
F_165 ( & V_67 -> V_67 , V_138 ) ;
if ( F_113 ( V_138 ) ) {
F_116 ( V_138 ) ;
return - V_283 ;
}
...
static int T_7 F_166 ( struct V_272 * V_67 )
{
#ifdef F_158
F_115 ( F_167 ( & V_67 -> V_67 ) ) ;
#endif
return 0 ;
}
...
V_285 , V_63 ) ;
V_15 = F_172 ( V_285 , V_286 , & V_4 -> V_288 ) ;
V_31:
F_116 ( V_285 ) ;
return V_15 ;
}
...
static int F_174 ( struct V_291 * V_292 , void * V_160 )
{
struct V_4 * V_134 = V_292 -> V_293 ;
return F_175 ( V_292 , L_87 , V_294 [ V_134 -> V_131 ] ) ;
}
static int F_176 ( struct V_295 * V_295 , struct V_296 * V_296 )
{
return F_177 ( V_296 , F_174 , F_178 ( V_295 ) -> V_12 ) ;
}
static int F_179 ( struct V_291 * V_292 , void * V_160 )
{
struct V_4 * V_134 = V_292 -> V_293 ;
F_175 ( V_292 , L_88 ,
...
static int F_181 ( struct V_295 * V_295 , struct V_296 * V_296 )
{
return F_177 ( V_296 , F_179 , F_178 ( V_295 ) -> V_12 ) ;
}
static int F_182 ( struct V_291 * V_292 , void * V_160 )
{
struct V_4 * V_134 = V_292 -> V_293 ;
return F_175 ( V_292 ,
L_100 ,
...
{
return F_177 ( V_296 , F_182 , F_178 ( V_295 ) -> V_12 ) ;
}
static int F_184 ( struct V_4 * V_4 )
{
...
static void F_188 ( struct V_4 * V_4 )
{
struct V_5 * V_6 = V_4 -> V_9 ;
V_6 -> V_11 [ 0 ] = V_6 -> V_12 [ 0 ] | 4 ;
V_6 -> V_11 [ 1 ] = V_6 -> V_12 [ 1 ] ;
...
static int F_189 ( struct V_1 * V_309 ,
unsigned long V_310 ,
void * V_311 )
{
...
static inline void F_193 ( struct V_4 * V_4 )
{
if ( V_4 -> V_7 ) {
if ( V_4 -> V_95 != NULL )
F_194 ( V_4 -> V_95 ) ;
...
static int F_199 ( struct V_4 * V_138 )
{
struct V_4 * V_189 ;
F_200 (e, &smi_infos, link) {
...
V_126 -> V_34 = F_171 ( V_126 -> V_32 -> V_312 () , V_169 ) ;
if ( ! V_126 -> V_34 ) {
F_12 (KERN_ERR PFX
L_109 ) ;
V_15 = - V_179 ;
...
V_126 -> V_151 = V_126 -> V_32 -> V_327 ( V_126 -> V_34 ,
& V_126 -> V_121 ) ;
...
F_29 ( & V_126 -> V_86 , 0 ) ;
V_126 -> V_91 = 0 ;
for ( V_165 = 0 ; V_165 < V_329 ; V_165 ++ )
F_29 ( & V_126 -> V_330 [ V_165 ] , 0 ) ;
V_126 -> V_45 = 1 ;
F_29 ( & V_126 -> V_46 , 0 ) ;
V_126 -> V_103 = V_331 ;
V_331 ++ ;
...
static void F_115 ( struct V_4 * V_351 )
{
int V_15 = 0 ;
unsigned long V_90 ;
if ( ! V_351 )
...
F_206 ( & V_351 -> V_46 ) ;
F_193 ( V_351 ) ;
F_33 ( & V_351 -> V_93 , V_90 ) ;
while ( V_351 -> V_9 || ( V_351 -> V_38 != V_54 ) ) {
F_35 ( & V_351 -> V_93 , V_90 ) ;
F_49 ( V_351 ) ;
F_169 ( 1 ) ;
F_33 ( & V_351 -> V_93 , V_90 ) ;
}
...
if ( V_351 -> V_7 )
V_15 = F_207 ( V_351 -> V_7 ) ;
if ( V_15 ) {
F_12 (KERN_ERR PFX L_129 ,
rv) ;
}
if ( V_351 -> V_32 )
V_351 -> V_32 -> V_339 ( V_351 -> V_34 ) ;
F_116 ( V_351 -> V_34 ) ;
if ( V_351 -> V_270 )
V_351 -> V_270 ( V_351 ) ;
if ( V_351 -> V_154 )
