...
V_106:
if ( ! V_88 -> V_80 ) {
V_88 -> V_80 = F_64 ( V_88 -> V_18 , V_88 -> V_104 + V_88 -> V_95 ,
V_88 -> V_97 ) ;
if ( F_3 ( ! V_88 -> V_80 ) )
return - V_33 ;
}
V_105 = F_71 ( V_88 -> V_80 , V_31 -> V_67 , V_31 -> V_66 , F_32 ( V_31 ) ) ;
if ( V_105 == V_31 -> V_66 ) {
V_88 -> V_95 ++ ;
return 0 ;
}
...
V_107 = F_69 ( V_4 , & V_88 , V_31 , V_108 ) ;
if ( F_3 ( V_107 ) )
goto V_110;
}
F_30 (bh, &segbuf->sb_payload_buffers, b_assoc_buffers) {
