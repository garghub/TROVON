...
V_220 = ( V_228 + 1 ) * sizeof( struct V_216 ) ;
...
{
struct V_12 * V_13 = F_84 ( - V_232 ) ;
struct V_71 * V_29 = & V_5 -> V_233 ;
struct V_21 * V_22 ;
if ( strncmp ( V_234 , L_50 , 4 ) == 0 )
return F_84 ( - V_232 ) ;
...
{
struct V_12 * V_13 =
F_83 ( V_42 , V_46 , V_237 , V_23 , NULL ) ;
if ( F_93 ( V_13 ) )
return F_94 ( V_13 ) ;
F_76 ( V_13 ) ;
return 0 ;
...
T_1 V_245 ;
if ( V_45 == V_243 )
for ( V_45 = 0 ; V_45 < V_5 -> V_246 ; ++ V_45 ) {
if ( V_5 -> V_247 )
V_245 = V_5 -> V_246 - V_45 - 1 ;
else
V_245 = V_45 ;
F_99 ( & V_5 -> V_233 , V_46 ,
V_245 , V_23 , V_197 ) ;
...
L_51 ,
V_70 , V_46 , V_45 , V_23 ) ) ;
if ( ( ( V_46 != V_243 ) && ( V_46 > V_5 -> V_248 ) ) ||
( ( V_45 != V_243 ) && ( V_45 >= V_5 -> V_246 ) ) ||
( ( V_23 != V_243 ) && ( V_23 > V_5 -> V_211 ) ) )
return - V_249 ;
F_86 ( & V_5 -> V_236 ) ;
if ( ! V_5 -> V_206 )
F_1 () ;
...
if ( V_5 -> V_65 -> V_254 )
V_5 -> V_65 -> V_254 ( V_5 ) ;
while ( ! V_5 -> V_65 -> V_251 ( V_5 , V_253 - V_252 ) )
F_4 ( 10 ) ;
} else {
F_102 ( V_5 , V_243 , V_243 ,
V_243 , 0 ) ;
}
}
static int F_112 ( void * V_255 )
{
...
V_257 = F_114 ( F_112 , V_2 , L_54 , V_5 -> V_82 ) ;
if ( F_93 ( V_257 ) )
F_112 ( V_2 ) ;
}
...
if ( ! F_87 ( V_5 ) )
goto V_37;
V_22 = F_41 ( & V_5 -> V_233 , 0 , V_5 -> V_242 ) ;
if ( ! V_22 )
goto V_37;
V_13 = F_17 ( V_22 , 0 , NULL ) ;
if ( V_13 )
...
{
F_52 ( V_13 -> V_45 != V_13 -> V_42 -> V_242 ) ;
F_30 ( V_13 ) ;
}
