...
static int F_17 ( struct V_6 * V_7 , bool V_22 )
{
int V_14 ;
struct V_12 * V_13 = F_8 ( V_7 ) ;
F_10 ( & V_13 -> V_16 ) ;
...
int V_25 ;
struct V_12 * V_13 ;
V_13 = F_21 ( sizeof( struct V_12 ) , V_26 ) ;
if ( V_13 == NULL ) {
F_19 ( & V_7 -> V_2 , L_7 ) ;
return - V_27 ;
}
F_22 ( V_7 , V_13 ) ;
V_25 = F_23 ( & V_7 -> V_2 . V_28 , & V_29 ) ;
if ( V_25 ) {
F_19 ( & V_7 -> V_2 , L_8 ) ;
goto V_30;
}
...
static int F_34 ( struct V_6 * V_7 , T_4 V_31 )
{
F_17 ( V_7 , false ) ;
return 0 ;
}
