...
V_183 = F_35 ( V_41 ) ;
V_185 = F_36 ( V_41 ) ;
V_188 = F_37 ( V_41 , V_4 -> clock ) ;
if ( ( V_42 -> V_199 & ( V_200 | V_201 ) ) ||
( F_38 ( V_41 ) != V_202 ) ) {
if ( V_183 ) {
struct V_203 * V_203 = F_39 ( V_183 ) ;
struct V_204 * V_205 =
V_203 -> V_206 ;
V_186 = V_205 -> V_186 ;
}
...
int V_12 ;
V_12 = F_3 ( V_13 , V_220 ) ;
if ( ! F_40 ( V_9 -> V_31 . V_32 , V_12 , & V_218 ,
& V_219 ) )
return V_184 ;
memset ( & args , 0 , sizeof( args ) ) ;
switch ( V_218 ) {
...
F_5 ( V_9 -> V_31 . V_32 ,
V_12 , ( V_33 * ) & args ) ;
V_184 = F_41 ( args . V_169 . V_221 ) * 10 ;
break;
case 3 :
...
F_5 ( V_9 -> V_31 . V_32 ,
V_12 , ( V_33 * ) & args ) ;
V_184 = F_43 ( args . V_151 . V_236 . V_237 ) * 10 ;
...
args . V_245 . V_262 = F_46 ( V_253 * 100000 ) ;
...
break;
case 6 :
args . V_247 . V_248 = F_46 ( V_18 << 24 | clock / 10 ) ;
args . V_247 . V_238 = V_251 ;
args . V_247 . V_255 = F_4 ( V_252 ) ;
args . V_247 . V_262 = F_46 ( V_253 * 100000 ) ;
...
if ( V_42 -> V_43 & ( V_44 ) )
F_51 ( V_180 , V_184 , & V_271 , & V_252 , & V_253 ,
& V_251 , & V_241 ) ;
else if ( F_7 ( V_9 ) )
...
V_298 = F_56 ( V_2 -> V_293 ) ;
V_299 = V_2 -> V_293 ;
}
V_301 = V_298 -> V_301 ;
V_303 = F_57 ( V_301 ) ;
V_317 = F_58 ( V_303 , false ) ;
if ( F_59 ( V_317 != 0 ) )
return V_317 ;
if ( V_296 )
V_304 = F_60 ( V_303 ) ;
else {
V_317 = F_61 ( V_303 , V_318 , & V_304 ) ;
if ( F_59 ( V_317 != 0 ) ) {
F_62 ( V_303 ) ;
return - V_319 ;
}
}
F_63 ( V_303 , & V_307 , NULL ) ;
F_62 ( V_303 ) ;
switch ( V_299 -> V_320 ) {
case 8 :
V_305 = ( F_64 ( V_321 ) |
...
V_305 |= F_68 ( V_339 ) ;
F_69 ( V_307 , & V_308 , & V_309 , & V_310 , & V_311 ) ;
V_305 |= F_70 ( V_311 ) ;
V_305 |= F_71 ( V_308 ) ;
V_305 |= F_72 ( V_309 ) ;
V_305 |= F_73 ( V_310 ) ;
...
F_28 ( V_348 + V_11 -> V_349 ,
F_74 ( V_304 ) ) ;
F_28 ( V_350 + V_11 -> V_349 ,
F_74 ( V_304 ) ) ;
F_28 ( V_351 + V_11 -> V_349 ,
( T_9 ) V_304 & V_352 ) ;
F_28 ( V_353 + V_11 -> V_349 ,
( T_9 ) V_304 & V_352 ) ;
F_28 ( V_354 + V_11 -> V_349 , V_305 ) ;
F_28 ( V_355 + V_11 -> V_349 , V_312 ) ;
F_28 ( V_356 + V_11 -> V_349 , 0 ) ;
F_28 ( V_357 + V_11 -> V_349 , 0 ) ;
F_28 ( V_358 + V_11 -> V_349 , 0 ) ;
F_28 ( V_359 + V_11 -> V_349 , 0 ) ;
F_28 ( V_360 + V_11 -> V_349 , V_299 -> V_361 ) ;
F_28 ( V_362 + V_11 -> V_349 , V_299 -> V_363 ) ;
V_306 = V_299 -> V_364 [ 0 ] / ( V_299 -> V_320 / 8 ) ;
F_28 ( V_365 + V_11 -> V_349 , V_306 ) ;
F_28 ( V_366 + V_11 -> V_349 , 1 ) ;
F_28 ( V_367 + V_11 -> V_349 ,
V_299 -> V_363 ) ;
V_294 &= ~ 3 ;
V_295 &= ~ 1 ;
F_28 ( V_368 + V_11 -> V_349 ,
( V_294 << 16 ) | V_295 ) ;
V_315 = V_2 -> V_4 . V_369 ;
V_316 = ( V_2 -> V_4 . V_370 + 1 ) & ~ 1 ;
F_28 ( V_371 + V_11 -> V_349 ,
( V_315 << 16 ) | V_316 ) ;
V_314 = F_27 ( V_372 + V_11 -> V_349 ) ;
V_314 &= ~ V_373 ;
F_28 ( V_372 + V_11 -> V_349 , V_314 ) ;
F_28 ( V_374 + V_11 -> V_349 , 0 ) ;
if ( ! V_296 && V_293 && V_293 != V_2 -> V_293 ) {
V_298 = F_56 ( V_293 ) ;
V_303 = F_57 ( V_298 -> V_301 ) ;
V_317 = F_58 ( V_303 , false ) ;
if ( F_59 ( V_317 != 0 ) )
return V_317 ;
F_75 ( V_303 ) ;
...
if ( V_9 -> V_70 >= V_195 ) {
if ( V_11 -> V_18 ) {
F_28 ( V_390 , F_74 ( V_304 ) ) ;
F_28 ( V_391 , F_74 ( V_304 ) ) ;
} else {
F_28 ( V_392 , F_74 ( V_304 ) ) ;
F_28 ( V_393 , F_74 ( V_304 ) ) ;
}
}
F_28 ( V_394 + V_11 -> V_349 ,
( T_9 ) V_304 ) ;
F_28 ( V_395 +
V_11 -> V_349 , ( T_9 ) V_304 ) ;
F_28 ( V_396 + V_11 -> V_349 , V_305 ) ;
if ( V_9 -> V_70 >= V_385 )
F_28 ( V_397 + V_11 -> V_349 , V_312 ) ;
F_28 ( V_398 + V_11 -> V_349 , 0 ) ;
F_28 ( V_399 + V_11 -> V_349 , 0 ) ;
F_28 ( V_400 + V_11 -> V_349 , 0 ) ;
F_28 ( V_401 + V_11 -> V_349 , 0 ) ;
F_28 ( V_402 + V_11 -> V_349 , V_299 -> V_361 ) ;
F_28 ( V_403 + V_11 -> V_349 , V_299 -> V_363 ) ;
V_306 = V_299 -> V_364 [ 0 ] / ( V_299 -> V_320 / 8 ) ;
F_28 ( V_404 + V_11 -> V_349 , V_306 ) ;
F_28 ( V_405 + V_11 -> V_349 , 1 ) ;
F_28 ( V_406 + V_11 -> V_349 ,
V_299 -> V_363 ) ;
V_294 &= ~ 3 ;
V_295 &= ~ 1 ;
F_28 ( V_407 + V_11 -> V_349 ,
( V_294 << 16 ) | V_295 ) ;
V_315 = V_2 -> V_4 . V_369 ;
V_316 = ( V_2 -> V_4 . V_370 + 1 ) & ~ 1 ;
F_28 ( V_408 + V_11 -> V_349 ,
( V_315 << 16 ) | V_316 ) ;
V_314 = F_27 ( V_409 + V_11 -> V_349 ) ;
V_314 &= ~ V_410 ;
F_28 ( V_409 + V_11 -> V_349 , V_314 ) ;
F_28 ( V_411 + V_11 -> V_349 , 0 ) ;
if ( ! V_296 && V_293 && V_293 != V_2 -> V_293 ) {
V_298 = F_56 ( V_293 ) ;
V_303 = F_57 ( V_298 -> V_301 ) ;
V_317 = F_58 ( V_303 , false ) ;
...
int F_78 ( struct V_1 * V_2 , int V_294 , int V_295 ,
struct V_292 * V_412 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
if ( F_26 ( V_9 ) )
return F_53 ( V_2 , V_412 , V_294 , V_295 , 0 ) ;
else if ( F_7 ( V_9 ) )
return F_77 ( V_2 , V_412 , V_294 , V_295 , 0 ) ;
else
return F_79 ( V_2 , V_412 , V_294 , V_295 , 0 ) ;
}
int F_80 ( struct V_1 * V_2 ,
struct V_292 * V_293 ,
int V_294 , int V_295 , enum V_413 V_75 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
if ( F_26 ( V_9 ) )
return F_53 ( V_2 , V_293 , V_294 , V_295 , 1 ) ;
else if ( F_7 ( V_9 ) )
return F_77 ( V_2 , V_293 , V_294 , V_295 , 1 ) ;
else
...
V_414 &= ~ V_418 ;
F_28 ( V_417 , V_414 ) ;
F_28 ( V_419 , F_27 ( V_420 ) ) ;
F_28 ( V_421 , F_27 ( V_422 ) ) ;
break;
}
}
...
{
if ( F_18 ( V_9 ) )
F_45 ( V_9 , V_9 -> clock . V_431 ) ;
else if ( F_26 ( V_9 ) ) {
struct V_147 V_148 ;
bool V_181 = F_49 ( V_9 , & V_148 ,
V_432 ,
V_9 -> clock . V_431 ) ;
if ( V_181 )
...
struct V_3 * V_4 ,
struct V_3 * V_5 ,
int V_294 , int V_295 , struct V_292 * V_412 )
{
struct V_11 * V_11 = F_2 ( V_2 ) ;
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
