...
V_74 = 0 ;
while ( ( V_4 = V_76 [ V_74 ++ ] ) != NULL ) {
V_13 = F_35 ( & V_7 -> V_2 , V_4 ) ;
if ( V_13 )
F_34 ( L_10 ) ;
}
V_13 = F_36 ( & V_73 -> V_2 . V_77 , & V_7 -> V_2 . V_77 ,
F_37 ( & V_7 -> V_2 ) ) ;
if ( V_13 )
F_34 ( L_11 ) ;
}
...
struct V_3 * V_4 ;
int V_74 = 0 ;
F_39 ( & V_73 -> V_2 . V_77 , F_37 ( & V_7 -> V_2 ) ) ;
while ( ( V_4 = V_76 [ V_74 ++ ] ) != NULL )
F_40 ( & V_7 -> V_2 , V_4 ) ;
if ( V_7 -> V_78 )
V_7 -> V_78 -> V_79 ( V_7 -> V_78 ) ;
}
static int F_41 ( struct V_1 * V_2 , void * V_80 )
{
int V_13 ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
if ( V_7 -> V_9 != V_81 ) {
...
{
int V_13 ;
struct V_85 * V_86 = F_43 () ;
V_13 = F_44 ( V_86 , NULL , NULL , F_41 ) ;
if ( V_13 ) {
F_45 () ;
return V_13 ;
}
...
static int F_46 ( struct V_1 * V_2 , void * V_80 )
{
int V_13 ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
if ( V_7 -> V_82 && V_7 -> V_14 -> V_87 ) {
...
{
struct V_85 * V_86 = F_43 () ;
return F_44 ( V_86 , NULL , NULL , F_46 ) ;
}
static int F_47 ( struct V_1 * V_2 , void * V_80 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
if ( V_7 -> V_9 != V_10 )
V_7 -> V_14 -> V_16 ( V_7 ) ;
...
int F_53 ( struct V_1 * V_2 , void * V_80 )
{
return 1 ;
}
struct V_6 * F_54 ( void * V_80 ,
int (* F_53)( struct V_6 * V_7 , void * V_80 ) )
{
struct V_6 * V_7 = NULL ;
