...
if ( V_17 >= sizeof( struct V_185 ) &&
F_80 ( & V_184 . V_186 , V_118 ,
sizeof( struct V_185 ) ) )
break;
}
if ( ! V_184 . V_187 ) {
if ( V_184 . V_186 . V_8 == F_81 ( V_188 ) ) {
V_42 -> V_189 = 0 ;
V_42 -> V_190 = 0 ;
V_28 = 0 ;
break;
}
V_176 = F_82 ( F_69 ( V_43 ) , V_184 . V_186 . V_8 ) ;
if ( V_176 )
V_184 . V_187 = V_176 -> V_177 ;
} else
V_176 = F_78 ( F_69 ( V_43 ) , V_184 . V_187 ) ;
V_28 = - V_180 ;
if ( ! V_176 )
break;
F_79 ( V_176 ) ;
V_28 = - V_51 ;
if ( V_43 -> V_181 &&
V_184 . V_187 != V_43 -> V_181 )
break;
V_42 -> V_189 = V_184 . V_187 ;
V_42 -> V_190 = V_184 . V_186 . V_8 ;
V_28 = 0 ;
break;
}
case V_191 :
...
memset ( & V_184 , 0 , sizeof( V_184 ) ) ;
if ( F_80 ( & V_184 , V_118 , sizeof( struct V_194 ) ) )
break;
}
if ( V_117 == V_191 )
...
V_184 . V_210 = V_217 -> V_37 ;
V_184 . V_186 . V_8 = 0 ;
V_184 . V_187 = V_225 . V_230 ;
V_28 = F_83 ( V_43 , & V_184 ) ;
if ( V_28 && V_28 != - V_76 )
break;
V_225 . V_230 = V_184 . V_187 ;
V_207 = V_212 ;
V_208 = 1 ;
} else {
V_207 = V_212 ;
...
char T_6 * V_118 , int T_6 * V_17 , unsigned V_44 )
{
struct V_41 * V_42 = F_20 ( V_43 ) ;
int V_119 ;
int V_34 ;
