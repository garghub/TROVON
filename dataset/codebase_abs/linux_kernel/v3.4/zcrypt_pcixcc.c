...
if ( ! V_4 . V_26 )
return - V_121 ;
V_4 . V_122 = ( ( ( unsigned long long ) V_123 -> V_124 ) << 32 ) +
F_27 ( & V_125 ) ;
V_4 . V_113 = & V_112 ;
...
if ( V_119 )
goto V_126;
for ( V_128 = 0 ; V_128 < 6 ; V_128 ++ ) {
F_41 ( 300 ) ;
V_119 = F_42 ( V_36 -> V_37 , & V_122 , V_76 , 4096 ) ;
if ( V_119 == 0 && V_122 == 0x0102030405060708ULL )
break;
}
if ( V_128 >= 6 ) {
V_119 = - V_129 ;
...
if ( V_119 )
goto V_126;
for ( V_128 = 0 ; V_128 < 2 * V_131 ; V_128 ++ ) {
F_44 ( 1000 / V_131 ) ;
V_119 = F_42 ( V_36 -> V_37 , & V_122 , V_4 . V_26 , 4096 ) ;
if ( V_119 == 0 && V_122 == 0x0102030405060708ULL )
break;
}
if ( V_128 >= 2 * V_131 ) {
