...
unsigned long V_205 ;
T_9 V_51 ;
if ( V_8 -> type == V_206 || V_8 -> type == V_207 ) {
V_205 = V_202 -> V_208 << V_199 ;
V_74 = V_204 -> V_209 ;
V_51 = F_78 ( ( V_74 & ~ V_210 ) + V_204 -> V_13 ) ;
V_74 &= V_210 ;
if ( ( V_202 -> V_211 - V_202 -> V_212 + V_205 ) > V_51 )
return - V_14 ;
V_205 += V_74 ;
V_202 -> V_208 = V_205 >> V_199 ;
V_202 -> V_213 |= V_214 | V_215 ;
#ifdef F_79
if ( V_1 -> V_216 & V_217 || V_205 >= F_80 ( V_218 ) )
V_202 -> V_219 = F_79 ( V_202 -> V_219 ) ;
#endif
if ( F_81 ( V_202 , V_202 -> V_212 , V_205 >> V_199 ,
V_202 -> V_211 - V_202 -> V_212 ,
V_202 -> V_219 ) )
return - V_220 ;
return 0 ;
}
return - V_200 ;
#else
return V_202 -> V_213 & V_221 ? 0 : - V_200 ;
#endif
}
static struct V_222 * F_82 ( struct V_223 * V_224 ,
int V_42 , const char * V_225 , void * V_105 )
{
return F_83 ( V_224 , L_6 , & V_226 , NULL , V_227 ) ;
}
static int T_10 F_84 ( void )
{
int V_18 ;
V_18 = F_85 ( V_228 , 0 , 1 << V_229 ,
L_7 , & V_230 ) ;
if ( V_18 < 0 ) {
F_86 ( L_8
L_9 , V_228 ) ;
...
return V_18 ;
V_231:
F_88 ( V_228 , 0 , 1 << V_229 , L_7 ) ;
return V_18 ;
}
static void T_11 F_89 ( void )
{
F_90 ( & V_23 ) ;
F_88 ( V_228 , 0 , 1 << V_229 , L_7 ) ;
}
