...
int F_75 ( struct V_21 * V_21 , void * V_74 ,
struct V_145 * V_146 )
{
struct V_1 * V_26 = F_3 ( V_74 ) ;
if ( V_146 -> type != V_104 &&
...
struct V_232 * V_233 ;
int V_29 ;
V_23 = F_22 ( sizeof( struct V_22 ) , V_30 ) ;
if ( ! V_23 )
return - V_31 ;
F_149 ( & V_23 -> V_204 ) ;
F_150 ( & V_23 -> V_162 ) ;
V_23 -> V_206 = & V_231 -> V_206 ;
V_233 = F_151 ( V_231 , V_234 , 0 ) ;
if ( ! V_233 ) {
F_152 ( & V_231 -> V_206 , L_6 ) ;
V_29 = - V_235 ;
goto V_236;
}
V_23 -> V_237 = F_153 ( V_233 -> V_238 , F_154 ( V_233 ) ,
V_231 -> V_94 ) ;
if ( ! V_23 -> V_237 ) {
F_152 ( & V_231 -> V_206 , L_7 ) ;
V_29 = - V_239 ;
goto V_236;
}
V_23 -> V_8 = F_155 ( V_233 -> V_238 , F_154 ( V_233 ) ) ;
if ( ! V_23 -> V_8 ) {
F_152 ( & V_231 -> V_206 , L_8 ) ;
V_29 = - V_239 ;
goto V_240;
}
F_156 ( & V_231 -> V_206 , L_9 ,
V_23 -> V_8 , V_23 -> V_237 , V_233 ) ;
V_23 -> V_219 = V_29 = F_157 ( V_231 , 0 ) ;
if ( V_29 < 0 ) {
F_152 ( & V_231 -> V_206 , L_10 ) ;
goto V_241;
}
V_29 = F_158 ( V_23 -> V_219 , F_131 , 0 ,
F_159 ( & V_231 -> V_206 ) , V_23 ) ;
if ( V_29 ) {
F_152 ( & V_231 -> V_206 , L_11 , V_23 -> V_219 ) ;
goto V_241;
}
V_23 -> V_242 = F_160 ( & V_231 -> V_206 , L_12 ) ;
if ( F_28 ( V_23 -> V_242 ) ) {
F_152 ( & V_231 -> V_206 , L_13 ) ;
V_29 = F_29 ( V_23 -> V_242 ) ;
goto V_243;
}
F_156 ( & V_231 -> V_206 , L_14 , V_23 -> V_242 ) ;
F_161 ( V_23 -> V_242 ) ;
V_29 = F_162 ( & V_231 -> V_206 , & V_23 -> V_139 ) ;
if ( V_29 ) {
F_152 ( & V_231 -> V_206 , L_15 ) ;
goto V_244;
}
V_23 -> V_40 = F_163 ( & V_245 ) ;
if ( F_28 ( V_23 -> V_40 ) ) {
F_57 ( & V_23 -> V_139 , L_16 ) ;
V_29 = F_29 ( V_23 -> V_40 ) ;
goto V_246;
}
V_23 -> V_200 = F_164 ( & V_231 -> V_206 ) ;
if ( F_28 ( V_23 -> V_200 ) ) {
F_57 ( & V_23 -> V_139 , L_17 ) ;
V_29 = F_29 ( V_23 -> V_200 ) ;
goto V_247;
}
V_23 -> V_33 = F_165 () ;
if ( ! V_23 -> V_33 ) {
F_57 ( & V_23 -> V_139 , L_18 ) ;
V_29 = - V_31 ;
goto V_248;
}
F_45 ( V_23 -> V_33 -> V_94 , V_78 ,
sizeof( V_23 -> V_33 -> V_94 ) ) ;
V_23 -> V_33 -> V_249 = & V_250 ;
V_23 -> V_33 -> V_251 = & V_252 ;
V_23 -> V_33 -> V_253 = - 1 ;
V_23 -> V_33 -> V_254 = V_255 ;
V_23 -> V_33 -> V_204 = & V_23 -> V_204 ;
V_23 -> V_33 -> V_139 = & V_23 -> V_139 ;
V_29 = F_166 ( V_23 -> V_33 , V_256 , - 1 ) ;
if ( V_29 ) {
F_57 ( & V_23 -> V_139 , L_19 ) ;
goto V_257;
}
...
F_45 ( V_23 -> V_258 -> V_94 , V_78 ,
sizeof( V_23 -> V_258 -> V_94 ) ) ;
V_23 -> V_258 -> V_249 = & V_250 ;
V_23 -> V_258 -> V_251 = & V_252 ;
V_23 -> V_258 -> V_253 = - 1 ;
V_23 -> V_258 -> V_254 = V_255 ;
V_23 -> V_258 -> V_204 = & V_23 -> V_204 ;
V_23 -> V_258 -> V_139 = & V_23 -> V_139 ;
V_29 = F_166 ( V_23 -> V_258 , V_256 , - 1 ) ;
if ( V_29 ) {
F_57 ( & V_23 -> V_139 , L_19 ) ;
goto V_260;
}
F_167 ( V_23 -> V_258 , V_23 ) ;
F_168 ( & V_23 -> V_139 ,
L_21 ,
V_23 -> V_258 -> V_89 ) ;
F_169 ( V_231 , V_23 ) ;
F_170 ( & V_231 -> V_206 ) ;
F_168 ( & V_23 -> V_139 , L_22 ) ;
return 0 ;
V_260:
V_255 ( V_23 -> V_258 ) ;
V_259:
...
F_176 ( V_23 -> V_242 ) ;
V_243:
F_177 ( V_23 -> V_219 , V_23 ) ;
V_241:
F_178 ( V_23 -> V_8 ) ;
V_240:
F_179 ( V_23 -> V_237 ) ;
F_180 ( V_23 -> V_237 -> V_238 , F_154 ( V_23 -> V_237 ) ) ;
V_236:
F_32 ( V_23 ) ;
return V_29 ;
}
...
static int F_184 ( struct V_261 * V_206 )
{
return 0 ;
}
static int F_185 ( struct V_261 * V_206 )
{
struct V_22 * V_23 = F_186 ( V_206 ) ;
F_11 ( V_23 -> V_8 ) ;
F_13 ( V_23 -> V_8 ) ;
F_15 ( V_23 -> V_8 ) ;
F_17 ( V_23 -> V_8 ) ;
