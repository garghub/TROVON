...
F_11 ( T_1 * V_5 )
{
struct V_16 * V_24 = V_5 -> V_31 ;
if ( ! V_24 )
return;
if ( ! V_24 -> V_18 )
return;
V_24 -> V_2 -> V_32 . V_33 ++ ;
V_24 -> V_2 -> V_32 . V_34 += V_24 -> V_19 [ V_24 -> V_20 ] -> V_35 ;
...
void
F_12 ( T_1 * V_5 , unsigned char * V_36 , unsigned short V_35 )
{
struct V_16 * V_24 = V_5 -> V_31 ;
struct V_1 * V_2 ;
struct V_22 * V_23 ;
...
memcpy ( F_15 ( V_23 , V_35 ) , V_36 , V_35 ) ;
V_23 -> V_41 = F_16 ( V_23 , V_2 ) ;
V_2 -> V_32 . V_42 ++ ;
F_17 ( V_23 ) ;
}
struct V_22 *
