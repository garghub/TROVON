...
struct V_10 * V_11 = F_5 ( V_4 ) ;
return sprintf ( V_7 , L_4 , ( V_11 -> V_29 >> V_28 ) & 1 ) ;
}
...
int V_28 = F_4 ( V_6 ) -> V_9 ;
struct V_10 * V_11 = F_5 ( V_4 ) ;
return sprintf ( V_7 , L_4 , ( V_11 -> V_23 >> V_28 ) & 1 ) ;
}
...
return F_39 ( V_17 , V_57 ) ;
else
return F_40 ( V_17 , V_57 ) ;
}
static int F_16 ( struct V_16 * V_17 , T_1 V_57 , T_4 V_58 )
{
if ( ( V_57 >= 0x07 ) && ( V_57 <= 0x0c ) )
return F_41 ( V_17 , V_57 , V_58 ) ;
else
return F_42 ( V_17 , V_57 , V_58 ) ;
}
...
int V_19 ;
F_14 ( & V_11 -> V_21 ) ;
if ( F_43 ( V_59 , V_11 -> V_60 + V_61 + V_61 / 2 )
|| ! V_11 -> V_62 ) {
F_44 ( & V_17 -> V_4 , L_6 ) ;
V_11 -> V_29 = F_15 ( V_17 , V_63 ) ;
V_11 -> V_23 = F_15 ( V_17 , V_24 ) ;
V_19 = F_15 ( V_17 , V_64 ) ;
