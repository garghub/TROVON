...
static int F_44 ( struct V_31 * V_8 , struct V_69 * V_70 )
{
struct V_6 * V_7 = V_8 -> V_36 ;
T_3 V_55 = V_70 -> V_71 ;
T_3 V_58 = V_70 -> V_58 ;
int V_26 ;
if ( ( V_55 & V_7 -> V_72 ) || ( V_58 & V_7 -> V_72 ) )
return - V_67 ;
while ( V_58 ) {
V_26 = F_37 ( V_8 , V_55 ) ;
if ( V_26 > 0 )
...
static int F_45 ( struct V_31 * V_8 , struct V_69 * V_70 )
{
int V_26 ;
V_26 = F_44 ( V_8 , V_70 ) ;
V_70 -> V_74 = V_26 ? V_75 : V_76 ;
F_46 ( V_70 ) ;
return V_26 ;
}
static int F_47 ( struct V_6 * V_7 )
{
T_1 V_10 [ 4 ] , * V_77 = V_10 , * V_78 = V_10 + 1 ;
struct V_1 * V_3 ;
struct V_31 * V_8 ;
int V_26 ;
...
{
T_1 V_10 [ 2 ] , * V_77 = V_10 , * V_78 = V_10 + 1 ;
int V_26 ;
V_26 = F_7 ( V_7 , V_10 ) ;
if ( V_26 < 0 )
return V_26 ;
...
static int F_53 ( struct V_95 * V_96 ,
const struct V_97 * V_2 )
{
struct V_6 * V_7 ;
struct V_98 * V_99 ;
struct V_100 * V_101 ,
* V_102 = NULL , * V_103 = NULL , * V_104 = NULL ;
int V_43 , V_26 = - V_44 ;
...
F_54 ( & V_7 -> V_5 ) ;
F_55 ( V_96 , V_7 ) ;
V_7 -> V_9 = F_56 ( F_57 ( V_96 ) ) ;
V_7 -> V_96 = V_96 ;
V_99 = V_96 -> V_105 ;
for ( V_43 = 0 ; V_43 < V_99 -> V_106 . V_107 ; ++ V_43 ) {
V_101 = & V_99 -> V_108 [ V_43 ] . V_106 ;
if ( F_58 ( V_101 ) ) {
V_102 = V_101 ;
} else if ( F_59 ( V_101 ) ) {
if ( V_43 == 0 )
