...
static inline void F_14 ( int V_68 , int V_69 , int V_70 )
{
F_15 ( V_68 , V_70 & 0x1 ) ;
F_15 ( V_69 , ( V_70 >> 1 ) & 0x1 ) ;
}
static inline void F_16 ( int V_71 , int V_70 )
{
F_15 ( V_71 , V_70 & 0x1 ) ;
}
...
if ( F_20 ( V_73 -> V_81 ) &&
F_20 ( V_73 -> V_82 ) ) {
for ( V_77 = 0 ; V_77 < F_3 ( V_33 -> V_80 ) ; V_77 ++ ) {
...
& V_14 ,
& V_41 ) ;
V_37 = F_21 ( V_35 , V_13 , V_67 ) ;
F_14 ( V_73 -> V_81 ,
V_73 -> V_82 , V_33 -> V_56 ) ;
V_79 ++ ;
V_83:
F_19 ( V_33 -> V_74 , L_5 ,
V_35 -> V_85 , F_22 ( V_73 -> V_81 ) ,
F_22 ( V_73 -> V_82 ) ) ;
break;
} else {
V_37 = F_21 ( V_35 , V_13 , V_67 ) ;
...
if ( F_20 ( V_73 -> V_87 ) ) {
for ( V_77 = 0 ; V_77 < F_3 ( V_33 -> V_86 ) ; V_77 ++ ) {
...
F_16 ( V_73 -> V_87 , V_33 -> V_59 ) ;
V_88:
F_19 ( V_33 -> V_74 , L_7 , V_35 -> V_85 ,
F_22 ( V_73 -> V_87 ) ) ;
} else {
V_37 = F_21 ( V_35 , V_13 , V_67 ) ;
}
...
if ( V_76 > 0 )
F_23 ( V_76 / ( ( V_7 & 0x0f ) + 1 ) ) ;
return V_37 ;
}
static T_2 int F_24 ( struct V_91 * V_92 )
{
struct V_93 * V_36 = F_25 ( V_92 -> V_74 . V_94 ) ;
struct V_72 * V_73 = F_18 ( V_36 -> V_74 ) ;
struct V_1 * * V_2 ;
struct V_32 * V_33 ;
struct V_34 * V_35 ;
int V_67 , V_37 , V_95 ;
if ( ! V_73 ) {
F_26 ( V_92 -> V_74 . V_94 , L_8 ) ;
return - V_96 ;
}
V_33 = F_27 ( sizeof( struct V_32 ) , V_97 ) ;
if ( ! V_33 )
return - V_98 ;
V_95 = sizeof( struct V_1 * ) * V_73 -> V_99 ;
V_33 -> V_2 = F_27 ( V_95 , V_97 ) ;
if ( ! V_33 -> V_2 ) {
F_28 ( V_33 ) ;
return - V_98 ;
}
...
V_2 [ V_67 ] = F_34 ( & V_117 [ V_118 ] , V_33 -> V_74 ,
V_73 -> V_117 [ V_67 ] . V_123 , V_33 , NULL ) ;
if ( F_35 ( V_2 [ V_67 ] ) ) {
V_37 = F_36 ( V_2 [ V_67 ] ) ;
F_26 ( V_33 -> V_74 , L_15 ) ;
V_2 [ V_67 ] = NULL ;
