...
V_75 = F_26 ( NULL , V_76 , V_57 ) ;
if ( ! V_75 )
continue;
F_27 ( & V_75 -> V_17 , L_10 , V_17 -> V_53 , V_73 -> V_77 >> 12 ) ;
V_75 -> V_17 . V_23 = & V_17 -> V_17 ;
V_75 -> V_78 [ 0 ] = V_17 -> V_78 ;
V_75 -> V_78 [ 1 ] = V_17 -> V_78 ;
V_75 -> V_79 = V_73 -> V_53 ;
V_75 -> V_17 . V_80 = V_73 -> V_80 ;
V_33 = F_28 ( V_75 , & V_17 -> V_56 ) ;
if ( V_33 ) {
F_29 ( & V_75 -> V_17 , L_11 , V_33 ) ;
F_30 ( V_75 ) ;
}
}
return 0 ;
...
static int F_32 ( struct V_16 * V_17 , void * V_6 )
{
F_33 ( V_17 ) ;
return 0 ;
}
static void F_34 ( struct V_51 * V_17 )
{
struct V_4 * V_5 = F_35 ( V_17 ) ;
int V_52 ;
F_36 ( & V_17 -> V_17 , NULL , F_32 ) ;
for ( V_52 = 0 ; V_52 < F_23 ( V_5 -> V_69 ) ; V_52 ++ )
F_37 ( V_5 -> V_69 [ V_52 ] ) ;
F_22 ( V_17 , NULL ) ;
F_19 ( V_5 -> V_11 ) ;
