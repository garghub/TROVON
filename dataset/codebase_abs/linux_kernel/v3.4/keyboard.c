...
static int F_7 ( unsigned int V_11 )
{
struct V_7 V_8 = {
. V_10 = {
. V_12 = 0 ,
...
static int F_11 ( unsigned int V_11 , unsigned int V_14 )
{
struct V_7 V_8 = {
. V_10 = {
. V_12 = 0 ,
...
static unsigned int F_35 ( struct V_36 * V_37 , unsigned int V_38 )
{
...
static void F_76 ( struct V_36 * V_37 , unsigned char V_92 , char V_93 )
{
}
...
static void F_80 ( struct V_36 * V_37 , unsigned int V_92 , char V_93 )
{
if ( V_93 )
return;
if ( V_62 )
...
if ( V_93 )
return;
V_62 = ( V_62 ? F_35 ( V_37 , V_92 ) : V_92 ) ;
}
static void F_82 ( struct V_36 * V_37 , unsigned char V_92 , char V_93 )
{
F_80 ( V_37 , F_83 ( V_92 ) , V_93 ) ;
}
static void F_84 ( struct V_36 * V_37 , unsigned char V_92 , char V_93 )
{
F_81 ( V_37 , V_92 , V_93 ) ;
}
...
if ( V_93 )
return;
if ( ( unsigned ) V_92 < F_28 ( V_101 ) ) {
if ( V_101 [ V_92 ] )
F_24 ( V_37 , V_101 [ V_92 ] ) ;
} else
F_79 ( L_2 , V_92 ) ;
}
...
if ( V_93 )
return;
F_25 ( V_37 , V_102 [ V_92 ] , F_38 ( V_68 , V_103 ) ) ;
}
...
if ( V_93 )
return;
if ( F_38 ( V_68 , V_76 ) && ! V_53 [ V_106 ] ) {
F_25 ( V_37 , V_105 [ V_92 ] , 1 ) ;
return;
}
if ( ! F_90 ( V_68 , V_77 ) ) {
switch ( V_92 ) {
case F_31 ( V_107 ) :
case F_31 ( V_108 ) :
F_87 ( V_37 , F_31 ( V_109 ) , 0 ) ;
return;
case F_31 ( V_110 ) :
F_87 ( V_37 , F_31 ( V_111 ) , 0 ) ;
return;
case F_31 ( V_112 ) :
F_87 ( V_37 , F_31 ( V_113 ) , 0 ) ;
return;
case F_31 ( V_114 ) :
F_88 ( V_37 , F_31 ( V_115 ) , 0 ) ;
return;
case F_31 ( V_116 ) :
F_87 ( V_37 , F_31 ( V_117 ) , 0 ) ;
return;
case F_31 ( V_118 ) :
F_88 ( V_37 , F_31 ( V_119 ) , 0 ) ;
return;
case F_31 ( V_120 ) :
F_88 ( V_37 , F_31 ( V_121 ) , 0 ) ;
return;
case F_31 ( V_122 ) :
F_87 ( V_37 , F_31 ( V_123 ) , 0 ) ;
return;
case F_31 ( V_124 ) :
F_88 ( V_37 , F_31 ( V_125 ) , 0 ) ;
return;
case F_31 ( V_126 ) :
F_87 ( V_37 , F_31 ( V_127 ) , 0 ) ;
return;
case F_31 ( V_128 ) :
F_25 ( V_37 , 'G' , F_38 ( V_68 , V_76 ) ) ;
return;
}
}
F_21 ( V_37 , V_104 [ V_92 ] ) ;
if ( V_92 == F_31 ( V_129 ) && F_38 ( V_68 , V_71 ) )
F_21 ( V_37 , 10 ) ;
}
static void F_91 ( struct V_36 * V_37 , unsigned char V_92 , char V_93 )
{
int V_130 = V_52 ;
if ( V_30 )
return;
...
F_21 ( V_37 , V_131 & 0xff ) ;
V_131 = - 1 ;
}
}
static void F_93 ( struct V_36 * V_37 , unsigned char V_92 , char V_93 )
{
if ( V_93 )
return;
if ( F_38 ( V_68 , V_132 ) ) {
...
static void F_97 ( struct V_36 * V_37 , unsigned char V_92 , char V_93 )
{
F_91 ( V_37 , V_92 , V_93 ) ;
if ( V_93 || V_30 )
return;
...
static void F_99 ( struct V_36 * V_37 , unsigned int V_135 , char V_93 )
{
static unsigned long V_136 ;
static unsigned V_137 ;
if ( ! V_138 )
F_81 ( V_37 , V_63 | V_135 , V_93 ) ;
else {
V_137 |= V_135 ;
V_136 ++ ;
if ( V_136 == V_138 ) {
F_80 ( V_37 , V_63 | V_137 , V_93 ) ;
V_136 = 0 ;
V_137 = 0 ;
}
}
}
static void F_100 ( struct V_36 * V_37 , unsigned char V_92 , char V_93 )
{
...
unsigned char F_104 ( void )
{
return V_143 ;
}
void F_105 ( struct V_144 * V_68 , unsigned int V_145 )
{
unsigned long V_12 ;
F_33 ( & V_61 , V_12 ) ;
if ( ! ( V_145 & ~ 7 ) ) {
...
static inline unsigned char F_107 ( void )
{
...
static int F_108 ( struct V_4 * V_5 , void * V_6 )
{
unsigned char V_151 = * ( unsigned char * ) V_6 ;
if ( F_13 ( V_158 , V_5 -> V_9 -> V_20 ) ) {
F_14 ( V_5 , V_158 , V_159 , ! ! ( V_151 & 0x01 ) ) ;
F_14 ( V_5 , V_158 , V_160 , ! ! ( V_151 & 0x02 ) ) ;
F_14 ( V_5 , V_158 , V_161 , ! ! ( V_151 & 0x04 ) ) ;
F_14 ( V_5 , V_162 , V_163 , 0 ) ;
}
return 0 ;
}
int F_109 ( int V_164 , int V_165 )
{
unsigned long V_12 ;
struct V_144 * V_68 = V_150 + V_164 ;
int V_166 ;
F_33 ( & V_61 , V_12 ) ;
V_166 = F_90 ( V_68 , V_165 ) ;
F_34 ( & V_61 , V_12 ) ;
return V_166 ;
}
void F_110 ( int V_164 , int V_151 )
{
struct V_144 * V_68 = V_150 + V_164 ;
F_105 ( V_68 , V_151 ) ;
}
void F_111 ( int V_164 )
{
struct V_144 * V_68 = V_150 + V_164 ;
F_92 ( V_68 , V_167 ) ;
F_106 () ;
...
static void F_113 ( unsigned long V_168 )
{
unsigned char V_151 = F_107 () ;
if ( V_151 != V_143 ) {
F_8 ( & V_16 , & V_151 ,
F_108 ) ;
V_143 = V_151 ;
...
static int F_114 ( struct V_36 * V_37 , unsigned int V_14 ,
unsigned char V_93 )
{
int V_169 ;
switch ( V_14 ) {
...
if ( V_169 & 0x100 )
F_21 ( V_37 , 0xe0 ) ;
F_21 ( V_37 , ( V_169 & 0x7f ) | V_93 ) ;
break;
}
return 0 ;
}
static int F_114 ( struct V_36 * V_37 , unsigned int V_14 , unsigned char V_93 )
{
if ( V_14 > 127 )
return - 1 ;
F_21 ( V_37 , V_14 | V_93 ) ;
...
static void F_115 ( unsigned char V_6 )
{
...
static void F_116 ( unsigned int V_14 , int V_178 , int V_179 )
{
struct V_36 * V_37 = V_91 [ V_80 ] . V_8 ;
...
V_180 = F_29 ( F_125 ( V_200 , V_14 - V_198 + 1 ) ) ;
else
return;
type = F_30 ( V_180 ) ;
if ( type < 0xf0 ) {
...
return;
(* F_126 [ type ])( V_37 , V_180 & 0xff , ! V_178 ) ;
V_185 . V_143 = V_68 -> V_152 ;
F_124 ( & V_3 , V_206 , & V_185 ) ;
if ( type != V_58 )
V_68 -> V_134 = 0 ;
}
static void F_127 ( struct V_4 * V_5 , unsigned int V_207 ,
unsigned int V_208 , int V_92 )
{
F_69 ( & V_61 ) ;
if ( V_207 == V_209 && V_208 == V_210 && F_128 ( V_5 -> V_9 ) )
F_115 ( V_92 ) ;
if ( V_207 == V_211 )
F_116 ( V_208 , V_92 , F_128 ( V_5 -> V_9 ) ) ;
F_72 ( & V_61 ) ;
F_129 ( & V_212 ) ;
V_213 = 1 ;
F_130 () ;
}
static bool F_131 ( struct V_214 * V_215 , struct V_18 * V_9 )
{
int V_47 ;
if ( F_13 ( V_19 , V_9 -> V_20 ) )
return true ;
if ( F_13 ( V_211 , V_9 -> V_20 ) ) {
for ( V_47 = V_216 ; V_47 < V_190 ; V_47 ++ )
if ( F_13 ( V_47 , V_9 -> V_217 ) )
return true ;
...
static int F_132 ( struct V_214 * V_215 , struct V_18 * V_9 ,
const struct V_219 * V_220 )
{
struct V_4 * V_5 ;
int error ;
V_5 = F_133 ( sizeof( struct V_4 ) , V_221 ) ;
if ( ! V_5 )
return - V_222 ;
V_5 -> V_9 = V_9 ;
V_5 -> V_215 = V_215 ;
...
V_150 [ V_47 ] . V_152 = V_226 ;
V_150 [ V_47 ] . V_227 = V_226 ;
V_150 [ V_47 ] . V_147 = V_149 ;
V_150 [ V_47 ] . V_133 = V_228 ;
V_150 [ V_47 ] . V_134 = 0 ;
V_150 [ V_47 ] . V_229 = V_230 ;
V_150 [ V_47 ] . V_69 = V_231 ? V_70 : V_232 ;
}
error = F_144 ( & V_16 ) ;
if ( error )
return error ;
...
int F_145 ( unsigned int V_233 , void T_3 * V_234 , int V_235 )
{
...
struct V_240 * V_62 ;
int V_47 ;
V_62 = F_146 ( V_241 * sizeof( struct V_240 ) ,
V_221 ) ;
if ( V_62 == NULL )
return - V_222 ;
F_33 ( & V_61 , V_12 ) ;
...
F_34 ( & V_61 , V_12 ) ;
if ( F_147 ( V_238 , & V_237 -> V_242 ) )
V_166 = - V_243 ;
else if ( F_148 ( V_237 -> V_240 , V_62 ,
...
void * V_45 ;
V_45 = F_146 ( V_241 * sizeof( struct V_246 ) ,
V_221 ) ;
if ( V_45 == NULL )
return - V_222 ;
F_33 ( & V_61 , V_12 ) ;
...
if ( F_147 ( V_238 , & V_237 -> V_242 ) )
V_166 = - V_243 ;
else if ( F_148 ( V_237 -> V_246 , V_45 ,
...
if ( ! V_235 )
return - V_249 ;
if ( F_149 ( V_248 , & V_237 -> V_242 ) )
return - V_243 ;
if ( V_248 >= V_241 )
return - V_250 ;
if ( V_248 ) {
V_62 = F_146 ( sizeof( struct V_240 ) * V_248 ,
V_221 ) ;
if ( V_62 == NULL )
return - V_222 ;
if ( F_150 ( V_62 , V_237 -> V_240 ,
...
return - V_250 ;
if ( V_248 ) {
V_45 = F_146 ( V_248 * sizeof( struct V_246 ) ,
V_221 ) ;
if ( V_45 == NULL )
return - V_222 ;
if ( F_150 ( V_45 , V_237 -> V_246 ,
...
int F_151 ( int V_164 , unsigned int V_252 )
{
struct V_144 * V_68 = V_150 + V_164 ;
int V_166 = 0 ;
unsigned long V_12 ;
...
int F_152 ( int V_164 , unsigned int V_252 )
{
struct V_144 * V_68 = V_150 + V_164 ;
int V_166 = 0 ;
unsigned long V_12 ;
...
int F_155 ( int V_233 , struct V_260 T_3 * V_261 ,
int V_235 )
{
struct V_260 V_262 ;
int V_263 = 0 ;
if ( F_150 ( & V_262 , V_261 , sizeof( struct V_260 ) ) )
return - V_243 ;
switch ( V_233 ) {
case V_264 :
V_263 = F_7 ( V_262 . V_11 ) ;
if ( V_263 >= 0 )
V_263 = F_147 ( V_263 , & V_261 -> V_14 ) ;
break;
case V_265 :
if ( ! V_235 )
return - V_249 ;
V_263 = F_11 ( V_262 . V_11 , V_262 . V_14 ) ;
break;
}
return V_263 ;
}
int F_156 ( int V_233 , struct V_266 T_3 * V_267 , int V_235 ,
int V_164 )
{
struct V_144 * V_68 = V_150 + V_164 ;
struct V_266 V_262 ;
T_4 * V_181 , * V_268 , V_51 , V_269 ;
unsigned long V_12 ;
if ( F_150 ( & V_262 , V_267 , sizeof( struct V_266 ) ) )
return - V_243 ;
if ( ! F_157 ( V_270 ) )
V_235 = 0 ;
switch ( V_233 ) {
...
V_181 = V_56 [ V_272 ] ;
if ( V_181 ) {
V_51 = F_29 ( V_181 [ V_47 ] ) ;
if ( V_68 -> V_69 != V_70 && F_30 ( V_51 ) >= V_273 )
V_51 = V_274 ;
} else
V_51 = ( V_47 ? V_274 : V_275 ) ;
F_34 ( & V_61 , V_12 ) ;
return F_147 ( V_51 , & V_267 -> V_276 ) ;
case V_277 :
if ( ! V_235 )
return - V_249 ;
if ( ! V_47 && V_278 == V_275 ) {
...
if ( F_30 ( V_278 ) < V_273 ) {
if ( F_31 ( V_278 ) > V_281 [ F_30 ( V_278 ) ] )
return - V_250 ;
} else
if ( V_68 -> V_69 != V_70 )
return - V_250 ;
#if ! F_158 ( V_282 ) && ! F_158 ( V_283 )
if ( ! V_47 )
break;
#endif
V_268 = F_146 ( sizeof( V_284 ) , V_221 ) ;
if ( ! V_268 )
return - V_222 ;
F_33 ( & V_61 , V_12 ) ;
V_181 = V_56 [ V_272 ] ;
...
V_181 [ V_48 ] = F_29 ( V_274 ) ;
V_280 ++ ;
} else
F_137 ( V_268 ) ;
V_269 = F_29 ( V_181 [ V_47 ] ) ;
if ( V_278 == V_269 )
goto V_287;
if ( ( ( V_269 == V_98 ) || ( V_278 == V_98 ) ) && ! F_157 ( V_288 ) ) {
F_34 ( & V_61 , V_12 ) ;
return - V_249 ;
}
V_181 [ V_47 ] = F_29 ( V_278 ) ;
if ( ! V_272 && ( F_30 ( V_269 ) == V_57 || F_30 ( V_278 ) == V_57 ) )
F_27 () ;
V_287:
F_34 ( & V_61 , V_12 ) ;
break;
...
int F_159 ( int V_233 , struct V_289 T_3 * V_290 , int V_235 )
{
struct V_289 * V_291 ;
char * V_292 ;
T_5 * V_293 ;
...
if ( ! F_157 ( V_270 ) )
V_235 = 0 ;
V_291 = F_146 ( sizeof( * V_291 ) , V_221 ) ;
if ( ! V_291 ) {
V_166 = - V_222 ;
goto V_299;
}
if ( F_150 ( V_291 , V_290 , sizeof( struct V_289 ) ) ) {
V_166 = - V_243 ;
goto V_299;
}
...
int F_160 ( int V_164 , int V_233 , unsigned long V_252 , int V_235 )
{
struct V_144 * V_68 = V_150 + V_164 ;
unsigned long V_12 ;
unsigned char V_310 ;
...
case V_311 :
F_33 ( & V_61 , V_12 ) ;
V_310 = V_68 -> V_152 | ( V_68 -> V_227 << 4 ) ;
F_34 ( & V_61 , V_12 ) ;
return F_147 ( V_310 , ( char T_3 * ) V_252 ) ;
case V_312 :
if ( ! V_235 )
return - V_249 ;
if ( V_252 & ~ 0x77 )
...
{
struct V_144 * V_68 = V_150 + V_164 ;
return F_38 ( V_68 , V_132 ) ? V_259 : V_258 ;
}
void F_163 ( int V_164 )
{
unsigned long V_12 ;
F_33 ( & V_61 , V_12 ) ;
V_150 [ V_164 ] . V_69 = V_231 ? V_70 : V_232 ;
F_34 ( & V_61 , V_12 ) ;
}
int F_164 ( void )
{
...
V_68 -> V_134 = 0 ;
V_68 -> V_147 = V_149 ;
V_68 -> V_152 = V_68 -> V_227 ;
F_34 ( & V_61 , V_12 ) ;
}
int F_166 ( int V_164 , int V_316 )
{
struct V_144 * V_68 = V_150 + V_164 ;
return F_38 ( V_68 , V_316 ) ;
}
void F_167 ( int V_164 , int V_316 )
{
struct V_144 * V_68 = V_150 + V_164 ;
unsigned long V_12 ;
F_33 ( & V_61 , V_12 ) ;
...
void F_168 ( int V_164 , int V_316 )
{
struct V_144 * V_68 = V_150 + V_164 ;
unsigned long V_12 ;
F_33 ( & V_61 , V_12 ) ;
