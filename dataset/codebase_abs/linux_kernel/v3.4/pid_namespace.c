...
do {
F_34 ( V_52 ) ;
V_45 = F_35 ( - 1 , NULL , V_53 , NULL ) ;
} while ( V_45 != - V_54 );
if ( V_43 -> V_55 )
V_56 -> signal -> V_57 = V_43 -> V_55 ;
F_36 ( V_43 ) ;
return;
}
static int F_37 ( struct V_58 * V_59 , int V_60 ,
void T_1 * V_61 , T_2 * V_62 , T_3 * V_63 )
{
struct V_58 V_64 = * V_59 ;
if ( V_60 && ! F_38 ( V_65 ) )
return - V_66 ;
V_64 . V_67 = & V_56 -> V_68 -> V_43 -> V_69 ;
return F_39 ( & V_64 , V_60 , V_61 , V_62 , V_63 ) ;
}
int F_40 ( struct V_17 * V_43 , int V_70 )
{
if ( V_43 == & V_71 )
return 0 ;
switch ( V_70 ) {
