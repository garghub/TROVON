...
{
struct V_44 * V_44 = F_11 ( V_43 ) ;
int error = - V_45 ;
if ( V_44 ) {
error = F_6 ( & V_44 -> V_46 , V_39 ) ;
F_12 ( V_44 ) ;
}
return error ;
}
static int F_13 ( struct V_27 * V_39 , struct V_32 T_1 * V_47 )
{
struct V_32 V_28 ;
if ( sizeof( V_28 ) == sizeof( * V_39 ) )
memcpy ( & V_28 , V_39 , sizeof( * V_39 ) ) ;
else {
if ( sizeof V_28 . V_48 == 4 ) {
if ( ( V_39 -> V_48 | V_39 -> V_49 | V_39 -> V_50 |
V_39 -> V_35 | V_39 -> V_34 ) &
0xffffffff00000000ULL )
return - V_51 ;
if ( V_39 -> V_52 != - 1 &&
( V_39 -> V_52 & 0xffffffff00000000ULL ) )
return - V_51 ;
if ( V_39 -> V_53 != - 1 &&
...
V_28 . V_34 = V_39 -> V_34 ;
V_28 . V_37 = V_39 -> V_37 ;
memset ( V_28 . V_57 , 0 , sizeof( V_28 . V_57 ) ) ;
}
if ( F_14 ( V_47 , & V_28 , sizeof( V_28 ) ) )
return - V_58 ;
return 0 ;
}
static int F_15 ( struct V_27 * V_39 , struct V_59 T_1 * V_47 )
{
struct V_59 V_28 ;
if ( sizeof( V_28 ) == sizeof( * V_39 ) )
memcpy ( & V_28 , V_39 , sizeof( * V_39 ) ) ;
...
int F_16 ( T_2 V_60 , struct V_27 * V_61 )
{
struct V_62 * V_63 = F_17 ( V_60 ) ;
int V_64 ;
if ( ! V_63 )
return - V_65 ;
V_64 = F_4 ( V_63 -> V_66 , V_61 ) ;
F_18 ( V_63 ) ;
return V_64 ;
}
