...
{
struct V_73 * V_75 = * V_74 ;
struct V_29 * V_72 =
F_2 ( V_75 , struct V_29 , V_75 ) ;
...
T_2 * V_78 )
{
struct V_79 * V_80 = F_62 ( V_77 ) -> V_80 ;
struct V_29 * V_72 ;
struct V_2 * V_81 ;
struct V_67 * V_68 = F_56 ( V_5 -> V_22 ) ;
int V_37 ;
...
V_81 = F_31 ( & V_72 -> V_3 ) ;
V_37 = F_63 ( V_80 , & V_72 -> V_75 , false ,
V_82 ,
& F_60 , NULL ) ;
if ( F_17 ( V_37 != 0 ) ) {
F_33 ( & V_81 ) ;
...
int F_67 ( struct V_88 * V_89 , void * V_90 ,
struct V_76 * V_77 )
{
struct V_91 * V_92 =
(struct V_91 * ) V_90 ;
...
V_3 = & ( F_2 ( V_75 , struct V_29 , V_75 ) -> V_3 ) ;
V_64 = V_98 ;
if ( F_70 ( V_64 , ( unsigned long ) V_92 -> V_97 ) ) {
...
return F_72 ( V_80 , V_92 -> V_99 ,
V_105 ) ;
return V_37 ;
}
int F_73 ( struct V_88 * V_89 , void * V_90 ,
struct V_76 * V_77 )
{
struct V_106 * V_92 =
(struct V_106 * ) V_90 ;
...
int F_75 ( struct V_88 * V_89 , void * V_90 ,
struct V_76 * V_77 )
{
struct V_109 * V_92 =
(struct V_109 * ) V_90 ;
return F_72 ( F_62 ( V_77 ) -> V_80 ,
V_92 -> V_99 ,
V_105 ) ;
}
...
struct V_32 * V_111 ;
struct V_4 * V_5 = V_3 -> V_5 ;
struct F_62 * V_123 = F_62 ( V_77 ) ;
unsigned long V_33 ;
V_111 = F_16 ( sizeof( * V_111 ) , V_25 ) ;
if ( F_17 ( V_111 == NULL ) )
return - V_69 ;
V_111 -> V_113 = V_113 ;
V_111 -> V_16 . V_47 = F_78 ;
V_111 -> V_16 . V_23 = F_80 ;
...
V_113 = F_16 ( sizeof( V_113 -> V_113 ) , V_25 ) ;
if ( F_17 ( V_113 == NULL ) ) {
F_86 ( L_5 ) ;
V_37 = - V_69 ;
goto V_130;
}
V_113 -> V_113 . V_75 . type = V_131 ;
V_113 -> V_113 . V_75 . V_132 = sizeof( * V_113 ) ;
V_113 -> V_113 . V_126 = V_126 ;
V_113 -> V_75 . V_113 = & V_113 -> V_113 . V_75 ;
V_113 -> V_75 . V_77 = V_77 ;
V_113 -> V_75 . V_10 = ( void ( * ) ( struct V_112 * ) ) F_5 ;
if ( V_55 & V_133 )
V_37 = F_84 ( V_77 , V_3 ,
& V_113 -> V_75 ,
& V_113 -> V_113 . V_116 ,
...
int F_87 ( struct V_88 * V_89 , void * V_90 ,
struct V_76 * V_77 )
{
struct V_24 * V_22 = F_74 ( V_89 ) ;
struct V_135 * V_92 =
...
V_3 = & ( F_2 ( V_75 , struct V_29 ,
V_75 ) -> V_3 ) ;
( void ) F_31 ( V_3 ) ;
if ( V_137 != NULL ) {
bool V_139 ;
V_37 = F_88 ( V_123 -> V_80 , V_75 ,
V_105 , & V_139 ) ;
if ( F_17 ( V_37 != 0 ) ) {
F_86 ( L_7
L_8 ) ;
