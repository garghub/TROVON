...
V_91 += sprintf ( V_91 , L_22 , V_95 [ V_92 ] ) ;
}
V_91 += sprintf ( V_91 , L_23 ) ;
return V_91 - V_23 ;
}
...
static T_3 F_89 ( struct V_87 * V_88 , struct V_89 * V_90 ,
char * V_91 )
{
return sprintf ( V_91 , L_25 , F_81 ( V_74 ) ,
F_82 ( V_74 ) ) ;
}
...
T_5 V_104 ;
int V_105 = - V_101 ;
if ( sscanf ( V_91 , L_26 , & V_102 , & V_103 ) != 2 )
goto V_106;
V_104 = F_91 ( V_102 , V_103 ) ;
if ( V_102 != F_81 ( V_104 ) || V_103 != F_82 ( V_104 ) )
goto V_106;
F_3 () ;
V_74 = V_104 ;
F_4 () ;
...
static T_3 F_92 ( struct V_87 * V_88 , struct V_89 * V_90 ,
char * V_91 )
{
return sprintf ( V_91 , L_28 , V_107 ) ;
}
static T_3 F_93 ( struct V_87 * V_88 , struct V_89 * V_90 ,
const char * V_91 , T_4 V_96 )
{
unsigned long V_108 ;
if ( sscanf ( V_91 , L_29 , & V_108 ) == 1 ) {
V_107 = V_108 ;
return V_96 ;
}
return - V_101 ;
}
static T_3 F_94 ( struct V_87 * V_88 ,
struct V_89 * V_90 , char * V_91 )
{
return sprintf ( V_91 , L_28 , V_109 ) ;
}
static T_3 F_95 ( struct V_87 * V_88 ,
struct V_89 * V_90 ,
const char * V_91 , T_4 V_96 )
{
unsigned long V_108 ;
...
{
return F_97 ( V_110 , & V_111 ) ;
}
static int T_6 F_98 ( char * V_112 )
{
if ( V_71 )
return 1 ;
strncpy ( V_76 , V_112 , 255 ) ;
return 1 ;
}
static int T_6 F_99 ( char * V_112 )
{
unsigned long long V_113 ;
if ( V_71 )
return 1 ;
if ( sscanf ( V_112 , L_30 , & V_113 ) == 1 )
V_114 = V_113 ;
return 1 ;
}
static int T_6 F_100 ( char * V_112 )
{
if ( ! strncmp ( V_112 , L_31 , 8 ) )
V_71 = 1 ;
else if ( ! strncmp ( V_112 , L_32 , 10 ) )
V_67 = 1 ;
return 1 ;
}
static int T_6 F_101 ( char * V_112 )
{
V_71 = 1 ;
return 1 ;
}
static int T_6 F_102 ( char * V_112 )
{
V_79 = 1 ;
return 1 ;
}
static int T_6 F_103 ( char * V_112 )
{
V_78 = F_104 ( V_112 , NULL , 0 ) ;
return 1 ;
}
