...
break;
case V_46 :
F_23 ( F_24 ( struct V_40 , V_86 ) != 2 ) ;
if ( F_3 ( F_14 ( struct V_40 , V_86 ) ) ) {
F_12 ( 0x0f , 0xb7 , 0x47 , F_14 ( struct V_40 , V_86 ) ) ;
} else {
F_15 ( 0x0f , 0xb7 , 0x87 ) ;
F_16 ( F_14 ( struct V_40 , V_86 ) , 4 ) ;
}
F_18 ( 0x86 , 0xc4 ) ;
break;
case V_47 :
if ( F_3 ( F_14 ( struct V_40 , V_87 ) ) ) {
F_12 ( 0x48 , 0x8b , 0x47 , F_14 ( struct V_40 , V_87 ) ) ;
} else {
F_15 ( 0x48 , 0x8b , 0x87 ) ;
F_16 ( F_14 ( struct V_40 , V_87 ) , 4 ) ;
}
F_15 ( 0x48 , 0x85 , 0xc0 ) ;
F_20 ( V_64 , V_28 - ( V_29 [ V_18 ] - 6 ) ) ;
F_23 ( F_24 ( struct V_88 , V_89 ) != 4 ) ;
F_18 ( 0x8b , 0x80 ) ;
F_16 ( F_14 ( struct V_88 , V_89 ) , 4 ) ;
break;
case V_48 :
F_23 ( F_24 ( struct V_40 , V_90 ) != 4 ) ;
if ( F_3 ( F_14 ( struct V_40 , V_90 ) ) ) {
F_15 ( 0x8b , 0x47 , F_14 ( struct V_40 , V_90 ) ) ;
} else {
F_18 ( 0x8b , 0x87 ) ;
F_16 ( F_14 ( struct V_40 , V_90 ) , 4 ) ;
}
break;
case V_49 :
F_23 ( F_24 ( struct V_40 , V_91 ) != 4 ) ;
if ( F_3 ( F_14 ( struct V_40 , V_91 ) ) ) {
F_15 ( 0x8b , 0x47 , F_14 ( struct V_40 , V_91 ) ) ;
} else {
F_18 ( 0x8b , 0x87 ) ;
...
break;
case V_51 :
F_23 ( F_24 ( struct V_40 , V_92 ) != 2 ) ;
if ( F_3 ( F_14 ( struct V_40 , V_92 ) ) ) {
F_12 ( 0x0f , 0xb7 , 0x47 , F_14 ( struct V_40 , V_92 ) ) ;
} else {
F_15 ( 0x0f , 0xb7 , 0x87 ) ;
...
F_21 ( V_19 ) ;
break;
F_27 ( V_105 , V_106 , V_107 ) ;
F_27 ( V_108 , V_109 , V_110 ) ;
F_27 ( V_111 , V_64 , V_65 ) ;
F_27 ( V_112 , V_65 , V_64 ) ;
F_27 ( V_113 , V_106 , V_107 ) ;
F_27 ( V_114 , V_109 , V_110 ) ;
F_27 ( V_115 , V_64 , V_65 ) ;
F_27 ( V_116 , V_65 , V_64 ) ;
V_117: V_20 = V_29 [ V_18 + V_31 [ V_18 ] . V_118 ] - V_29 [ V_18 ] ;
V_19 = V_29 [ V_18 + V_31 [ V_18 ] . V_119 ] - V_29 [ V_18 ] ;
if ( V_31 [ V_18 ] . V_119 == V_31 [ V_18 ] . V_118 ) {
F_21 ( V_19 ) ;
break;
}
switch ( V_31 [ V_18 ] . V_43 ) {
...
if ( V_31 [ V_18 ] . V_119 != 0 ) {
if ( V_31 [ V_18 ] . V_118 && V_20 )
V_19 += F_4 ( V_20 ) ? 2 : 5 ;
F_20 ( V_21 , V_19 ) ;
if ( V_31 [ V_18 ] . V_118 )
F_21 ( V_20 ) ;
...
if ( V_25 ) {
if ( V_34 > 1 )
F_34 ( V_121 , L_4 , V_122 ,
16 , 1 , V_25 , V_15 , false ) ;
F_5 ( V_25 , V_25 + V_15 ) ;
V_12 -> V_123 = ( void * ) V_25 ;
}
V_120:
F_30 ( V_29 ) ;
return;
}
static void F_35 ( struct V_124 * V_125 )
{
F_31 ( NULL , V_125 ) ;
}
...
{
if ( V_12 -> V_123 != V_126 ) {
struct V_124 * V_127 = (struct V_124 * ) V_12 -> V_123 ;
F_37 ( V_127 , F_35 ) ;
F_38 ( V_127 ) ;
}
}
