...
if ( V_7 -> V_35 & ( 1UL << V_172 ) )
V_173 = true ;
return F_82 ( V_7 -> V_11 ) ;
}
static int T_5 F_83 ( struct V_58 * V_59 )
{
...
V_49 -> V_169 , V_49 -> V_99 , V_49 -> V_175 ) ;
F_69 ( L_37 ,
V_49 -> V_43 ) ;
V_7 = F_84 ( sizeof( struct V_6 ) , V_66 ) ;
if ( V_7 == NULL ) {
V_61 = - V_170 ;
return 0 ;
}
...
{
struct V_183 * V_17 , * V_160 ;
F_92 (entry, next, &amd_iommu_unity_map, list) {
F_74 ( & V_17 -> V_161 ) ;
F_75 ( V_17 ) ;
}
}
static int T_5 F_93 ( struct V_113 * V_114 )
{
int V_32 ;
switch ( V_114 -> type ) {
case V_184 :
...
break;
case V_186 :
for ( V_32 = V_114 -> V_1 ; V_32 <= V_114 -> V_187 ; ++ V_32 )
F_62 ( V_32 , V_114 ) ;
break;
default:
break;
...
{
struct V_183 * V_152 = 0 ;
char * V_188 ;
V_152 = F_84 ( sizeof( * V_152 ) , V_66 ) ;
if ( V_152 == NULL )
return - V_170 ;
switch ( V_114 -> type ) {
default:
...
case V_184 :
V_188 = L_39 ;
V_152 -> V_148 = V_152 -> V_189 = V_114 -> V_1 ;
break;
case V_185 :
V_188 = L_40 ;
V_152 -> V_148 = 0 ;
...
V_152 -> V_189 = V_114 -> V_187 ;
break;
}
V_152 -> V_190 = F_95 ( V_114 -> V_117 ) ;
V_152 -> V_191 = V_152 -> V_190 + F_95 ( V_114 -> V_118 ) ;
V_152 -> V_192 = V_114 -> V_99 >> 1 ;
F_69 ( L_42
L_43 , V_188 ,
F_39 ( V_152 -> V_148 ) , F_40 ( V_152 -> V_148 ) ,
F_41 ( V_152 -> V_148 ) , F_39 ( V_152 -> V_189 ) ,
F_40 ( V_152 -> V_189 ) , F_41 ( V_152 -> V_189 ) ,
V_152 -> V_190 , V_152 -> V_191 , V_114 -> V_99 ) ;
F_78 ( & V_152 -> V_161 , & V_193 ) ;
return 0 ;
}
static int T_5 F_96 ( struct V_58 * V_59 )
{
T_3 * V_50 = ( T_3 * ) V_59 , * V_51 = ( T_3 * ) V_59 ;
struct V_113 * V_114 ;
V_51 += V_59 -> V_53 ;
...
if ( ! F_67 ( V_7 -> V_11 ) )
return;
V_209 = F_81 ( V_7 -> V_11 -> V_45 -> V_210 , F_100 ( 0 , 0 ) ) ;
if ( ! V_209 )
return;
F_5 ( V_209 , 0x60 , 0x75 | ( 1 << 7 ) ) ;
F_6 ( V_209 , 0x64 , & V_207 ) ;
if ( ! ( V_207 & 0x1 ) )
F_5 ( V_209 , 0x64 , V_207 | 1 ) ;
F_101 ( V_209 ) ;
...
F_77 ( & V_220 ) ;
V_174 = - V_62 ;
if ( F_114 ( L_44 , F_83 ) != 0 )
goto free;
if ( V_61 ) {
V_174 = V_61 ;
goto free;
}
if ( F_114 ( L_44 , F_96 ) != 0 )
goto free;
if ( V_61 ) {
V_174 = V_61 ;
goto free;
...
static int T_5 F_122 ( struct V_58 * V_59 )
{
return 0 ;
}
int T_5 F_123 ( void )
...
if ( V_229 )
return - V_62 ;
if ( F_114 ( L_44 , F_122 ) == 0 ) {
V_227 = 1 ;
V_215 = 1 ;
V_230 . V_7 . V_231 = F_118 ;
F_124 () ;
return 1 ;
}
return - V_62 ;
}
static int T_5 F_125 ( char * V_232 )
{
V_233 = true ;
return 1 ;
}
static int T_5 F_126 ( char * V_232 )
{
for (; * V_232 ; ++ V_232 ) {
