...
V_15 = F_47 ( V_87 , & V_82 -> V_83 , V_89 , V_114 ) ;
if ( F_3 ( V_15 < 0 ) ) {
if ( V_15 != - V_100 )
F_23 ( V_22 , L_13 ) ;
F_35 ( V_82 , NULL ) ;
...
V_110 += V_15 ;
V_15 = F_47 ( V_87 , & V_82 -> V_84 , V_89 , V_114 ) ;
if ( F_3 ( V_15 < 0 ) ) {
if ( V_15 != - V_100 )
F_23 ( V_22 , L_14 ) ;
F_35 ( V_82 , NULL ) ;
...
V_110 += V_15 ;
V_15 = F_47 ( V_87 , & V_82 -> V_85 , V_89 , V_114 ) ;
if ( F_3 ( V_15 < 0 ) ) {
if ( V_15 != - V_100 )
F_23 ( V_22 , L_15 ) ;
F_35 ( V_82 , NULL ) ;
...
static inline void *
F_53 ( V_102 V_116 , unsigned V_117 , unsigned V_23 )
{
void * V_42 ;
void T_3 * V_118 = ( void V_108 T_3 * ) ( V_109 ) V_116 ;
V_42 = F_54 ( V_117 * V_23 , V_17 ) ;
if ( ! V_42 )
return F_55 ( - V_18 ) ;
if ( F_56 ( V_42 , V_118 , V_117 * V_23 ) ) {
F_7 ( V_42 ) ;
return F_55 ( - V_113 ) ;
}
return V_42 ;
...
int V_15 = 0 ;
unsigned V_93 ;
V_121 = F_53 ( V_57 -> V_110 , V_57 -> V_122 , sizeof( * V_121 ) ) ;
if ( F_58 ( V_121 ) )
return F_59 ( V_121 ) ;
...
struct V_81 V_82 ;
struct V_74 * V_75 = NULL ;
int V_93 , V_135 , V_15 = 0 , V_136 = 0 ;
V_87 = F_64 ( V_10 , V_57 -> V_137 ) ;
if ( F_58 ( V_87 ) )
return F_59 ( V_87 ) ;
...
V_134 = F_53 ( V_57 -> V_134 , V_57 -> V_143 , sizeof( * V_134 ) ) ;
if ( F_58 ( V_134 ) ) {
F_65 ( & V_87 ) ;
return F_59 ( V_134 ) ;
}
...
V_7 [ V_134 [ V_93 ] . V_124 ] . V_101 ;
F_68 ( V_87 , V_4 , V_134 [ V_93 ] . V_49 ,
V_134 [ V_93 ] . V_152 ) ;
}
} else
if ( V_30 -> V_153 >= 0x25 ) {
...
F_62 ( V_4 , ( V_134 [ V_93 ] . V_49 +
V_134 [ V_93 ] . V_152 - 8 ) / 4 , V_158 ) ;
}
F_70 ( V_87 , ( ( V_42 -> V_156 << V_52 ) +
V_134 [ V_93 ] . V_49 ) | 0x20000000 ) ;
F_70 ( V_87 , 0 ) ;
for ( V_135 = 0 ; V_135 < V_157 ; V_135 ++ )
F_70 ( V_87 , 0 ) ;
}
}
