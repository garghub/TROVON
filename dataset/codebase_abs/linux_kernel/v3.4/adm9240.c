...
{
struct V_11 * V_12 = F_10 ( V_7 ) ;
return sprintf ( V_10 , L_7 , V_12 -> V_36 ) ;
}
...
struct V_11 * V_12 = F_10 ( V_7 ) ;
return sprintf ( V_10 , L_7 , ( V_12 -> V_36 >> V_37 ) & 1 ) ;
}
...
static int F_46 ( struct V_20 * V_45 ,
struct V_46 * V_47 )
{
struct V_48 * V_49 = V_45 -> V_49 ;
const char * V_50 = L_11 ;
int V_51 = V_45 -> V_52 ;
T_1 V_53 , V_54 ;
if ( ! F_47 ( V_49 , V_55 ) )
return - V_56 ;
...
F_49 ( & V_49 -> V_7 , L_17 ,
V_53 == 0x23 ? L_18 :
V_53 == 0xda ? L_19 : L_20 , V_54 ) ;
F_50 ( V_47 -> type , V_50 , V_60 ) ;
return 0 ;
}
static int F_51 ( struct V_20 * V_45 ,
const struct V_61 * V_62 )
{
struct V_11 * V_12 ;
int V_22 ;
V_12 = F_52 ( sizeof( * V_12 ) , V_63 ) ;
if ( ! V_12 ) {
V_22 = - V_64 ;
goto exit;
}
...
F_54 ( & V_12 -> V_23 ) ;
F_55 ( V_45 ) ;
V_22 = F_56 ( & V_45 -> V_7 . V_65 , & V_66 ) ;
if ( V_22 )
goto V_67;
V_12 -> V_68 = F_57 ( & V_45 -> V_7 ) ;
if ( F_58 ( V_12 -> V_68 ) ) {
V_22 = F_59 ( V_12 -> V_68 ) ;
goto V_69;
}
...
V_12 -> V_39 = F_64 () ;
F_49 ( & V_21 -> V_7 , L_21 , V_12 -> V_39 / 10 ,
V_12 -> V_39 % 10 ) ;
if ( V_70 & 1 ) {
F_49 ( & V_21 -> V_7 , L_22 ,
V_70 , V_72 ) ;
...
int V_74 ;
F_17 ( & V_12 -> V_23 ) ;
if ( F_65 ( V_75 , V_12 -> V_76 + ( V_77 * 7 / 4 ) )
|| ! V_12 -> V_44 ) {
for ( V_74 = 0 ; V_74 < 6 ; V_74 ++ ) {
...
V_12 -> V_27 [ V_74 ] = F_33 ( V_21 ,
F_68 ( V_74 ) ) ;
if ( V_12 -> V_44 && V_12 -> V_27 [ V_74 ] == 255 &&
V_12 -> V_28 [ V_74 ] < 3 ) {
F_32 ( V_21 , V_74 ,
++ V_12 -> V_28 [ V_74 ] ) ;
if ( V_12 -> V_29 [ V_74 ] < 255 &&
V_12 -> V_29 [ V_74 ] >= 2 )
V_12 -> V_29 [ V_74 ] /= 2 ;
}
}
...
if ( F_65 ( V_75 , V_12 -> V_79 + ( V_77 * 300 ) )
|| ! V_12 -> V_44 ) {
for ( V_74 = 0 ; V_74 < 6 ; V_74 ++ ) {
...
F_19 ( 1 ) ) ;
V_74 = F_33 ( V_21 , V_33 ) ;
V_12 -> V_28 [ 0 ] = ( V_74 >> 4 ) & 3 ;
V_12 -> V_28 [ 1 ] = ( V_74 >> 6 ) & 3 ;
V_12 -> V_38 = V_74 & 0x0f ;
V_12 -> V_38 |= ( F_33 ( V_21 ,
V_80 ) & 1 ) << 4 ;
V_12 -> V_40 = F_33 ( V_21 ,
