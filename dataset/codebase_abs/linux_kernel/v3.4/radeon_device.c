...
V_2 -> V_136 = false ;
F_33 ( L_22 ,
V_137 [ V_2 -> V_3 ] , V_47 -> V_138 , V_47 -> V_139 ,
V_47 -> V_48 , V_47 -> V_140 ) ;
F_80 ( & V_2 -> V_141 ) ;
F_80 ( & V_2 -> V_142 . V_106 ) ;
for ( V_5 = 0 ; V_5 < V_143 ; ++ V_5 )
F_58 ( & V_2 -> V_144 [ V_5 ] . V_106 ) ;
F_58 ( & V_2 -> V_145 ) ;
if ( V_2 -> V_3 >= V_4 )
F_81 ( & V_2 -> V_146 . V_147 ) ;
F_58 ( & V_2 -> V_148 . V_106 ) ;
F_58 ( & V_2 -> V_68 . V_106 ) ;
F_58 ( & V_2 -> V_149 ) ;
F_82 ( & V_2 -> V_150 ) ;
F_82 ( & V_2 -> V_151 . V_147 ) ;
F_83 ( & V_2 -> V_148 . V_152 ) ;
F_84 ( & V_2 -> V_153 . V_154 ) ;
F_84 ( & V_2 -> V_153 . V_155 ) ;
F_83 ( & V_2 -> V_151 . V_8 ) ;
V_2 -> V_156 . V_157 = 1 ;
V_2 -> V_156 . V_158 = 1 << 20 ;
F_83 ( & V_2 -> V_156 . V_159 ) ;
V_17 = F_85 ( V_2 ) ;
if ( V_17 )
return V_17 ;
F_68 ( V_2 ) ;
...
V_2 -> V_164 = F_90 ( V_2 -> V_47 , 2 ) ;
V_2 -> V_165 = F_91 ( V_2 -> V_47 , 2 ) ;
V_2 -> V_166 = F_92 ( V_2 -> V_164 , V_2 -> V_165 ) ;
if ( V_2 -> V_166 == NULL ) {
return - V_85 ;
}
F_33 ( L_25 , ( T_1 ) V_2 -> V_164 ) ;
F_33 ( L_26 , ( unsigned ) V_2 -> V_165 ) ;
for ( V_5 = 0 ; V_5 < V_167 ; V_5 ++ ) {
if ( F_93 ( V_2 -> V_47 , V_5 ) & V_168 ) {
V_2 -> V_169 = F_91 ( V_2 -> V_47 , V_5 ) ;
V_2 -> V_99 = F_94 ( V_2 -> V_47 , V_5 , V_2 -> V_169 ) ;
break;
}
}
if ( V_2 -> V_99 == NULL )
...
struct V_179 * V_180 = F_111 ( V_173 -> V_181 ) ;
struct V_182 * V_183 ;
if ( V_180 == NULL || V_180 -> V_184 == NULL ) {
continue;
}
V_183 = F_112 ( V_180 -> V_184 ) ;
if ( ! F_113 ( V_2 , V_183 ) ) {
...
{
unsigned V_5 ;
for ( V_5 = 0 ; V_5 < V_2 -> V_194 ; V_5 ++ ) {
if ( V_2 -> V_195 [ V_5 ] . V_192 == V_192 ) {
return 0 ;
}
}
V_5 = V_2 -> V_194 + 1 ;
...
V_2 -> V_195 [ V_2 -> V_194 ] . V_192 = V_192 ;
V_2 -> V_195 [ V_2 -> V_194 ] . V_197 = V_193 ;
V_2 -> V_194 = V_5 ;
#if F_143 ( V_198 )
F_144 ( V_192 , V_193 ,
V_2 -> V_79 -> V_199 -> V_200 ,
V_2 -> V_79 -> V_199 ) ;
F_144 ( V_192 , V_193 ,
V_2 -> V_79 -> V_201 -> V_200 ,
V_2 -> V_79 -> V_201 ) ;
#endif
return 0 ;
}
...
int F_146 ( struct V_202 * V_203 )
{
return 0 ;
}
void F_147 ( struct V_202 * V_203 )
{
}
