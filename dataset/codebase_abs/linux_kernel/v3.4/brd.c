...
int V_33 = - V_46 ;
V_4 = V_38 -> V_47 ;
if ( V_4 + ( V_38 -> V_48 >> V_23 ) >
F_31 ( V_40 -> V_42 ) )
goto V_35;
if ( F_32 ( V_38 -> V_49 & V_50 ) ) {
V_33 = 0 ;
F_23 ( V_3 , V_4 , V_38 -> V_48 ) ;
goto V_35;
}
V_31 = F_33 ( V_38 ) ;
if ( V_31 == V_51 )
...
static int F_36 ( struct V_39 * V_40 , T_1 V_4 ,
...
static int F_39 ( struct V_39 * V_40 , T_5 V_60 ,
...
static int T_6 F_43 ( char * V_69 )
{
V_70 = F_44 ( V_69 , NULL , 0 ) ;
return 1 ;
}
...
static struct V_99 * F_67 ( T_7 V_100 , int * V_101 , void * V_102 )
{
struct V_2 * V_3 ;
struct V_99 * V_103 ;
F_40 ( & V_104 ) ;
V_3 = F_60 ( F_68 ( V_100 ) >> V_86 ) ;
V_103 = V_3 ? F_69 ( V_3 -> V_85 ) : F_70 ( - V_26 ) ;
F_42 ( & V_104 ) ;
* V_101 = 0 ;
return V_103 ;
}
