...
struct V_1 * V_19 = F_2 ( V_17 , struct V_1 , V_4 ) ;
if ( ! V_19 -> V_22 || ! V_19 -> V_23 ) {
T_3 V_59 = V_101 , V_60 = V_102 ;
int V_8 = F_19 ( V_3 , & V_59 , & V_60 ,
V_112 ) ;
if ( V_8 < 0 )
return V_8 ;
}
...
V_111 -> V_113 = V_66 [ 0 ] . V_113 ;
V_111 -> V_26 = V_66 [ 0 ] . V_26 ;
}
} else {
V_111 -> V_113 = V_66 [ V_65 ] . V_113 ;
}
return 0 ;
}
...
static int F_30 ( struct V_16 * V_17 , unsigned int V_128 ,
enum V_64 * V_26 )
{
if ( V_128 >= F_20 ( V_66 ) )
return - V_49 ;
* V_26 = V_66 [ V_128 ] . V_26 ;
return 0 ;
}
...
{
struct V_2 * V_3 = F_11 ( V_17 ) ;
struct V_131 * V_132 = F_32 ( V_3 ) ;
V_130 -> V_37 = V_133 | V_134 |
V_135 | V_136 |
V_137 ;
V_130 -> type = V_138 ;
V_130 -> V_37 = F_33 ( V_132 , V_130 ) ;
return 0 ;
}
...
struct V_1 * V_19 ;
struct V_131 * V_132 = F_32 ( V_3 ) ;
struct V_141 * V_142 = F_35 ( V_3 -> V_24 . V_143 ) ;
int V_8 ;
if ( ! V_132 || ! V_132 -> V_19 ) {
F_12 ( & V_3 -> V_24 , L_7 ) ;
return - V_49 ;
...
V_19 = F_37 ( sizeof( * V_19 ) , V_146 ) ;
if ( ! V_19 )
return - V_147 ;
V_19 -> V_36 = V_132 -> V_19 ;
F_38 ( & V_19 -> V_4 , V_3 , & V_148 ) ;
F_39 ( & V_19 -> V_31 , 3 ) ;
F_40 ( & V_19 -> V_31 , & V_149 ,
V_33 , 0 , 1 , 1 , 0 ) ;
F_40 ( & V_19 -> V_31 , & V_149 ,
V_40 , 0 , 1 , 1 , 0 ) ;
F_40 ( & V_19 -> V_31 , & V_149 ,
V_44 , 0 , 256 , 1 , 0 ) ;
V_19 -> V_4 . V_150 = & V_19 -> V_31 ;
if ( V_19 -> V_31 . error ) {
int V_151 = V_19 -> V_31 . error ;
F_41 ( V_19 ) ;
return V_151 ;
}
V_8 = F_26 ( V_3 ) ;
