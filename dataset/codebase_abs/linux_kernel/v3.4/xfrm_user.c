...
return F_169 ( V_107 -> V_125 . V_207 , V_133 , V_135 , & V_138 ) ;
}
}
V_34 = F_170 ( V_135 , V_351 [ type ] , V_5 , V_338 ,
V_352 ) ;
if ( V_34 < 0 )
return V_34 ;
if ( V_340 -> V_353 == NULL )
...
F_87 () ;
return F_166 ( V_107 -> V_125 . V_207 , V_133 , 0 , V_357 , V_186 ) ;
}
...
F_70 ( V_133 , V_135 ) ;
return F_166 ( V_107 -> V_125 . V_207 , V_133 , 0 , V_359 , V_186 ) ;
}
...
static int F_189 ( struct V_81 * V_82 , struct V_246 * V_367 ,
...
if ( V_133 == NULL )
return - V_63 ;
if ( F_187 ( V_133 , V_82 , V_367 , V_240 , V_223 ) < 0 )
F_87 () ;
return F_166 ( V_107 -> V_125 . V_207 , V_133 , 0 , V_369 , V_186 ) ;
}
static struct V_238 * F_190 ( struct V_370 * V_136 , int V_371 ,
...
goto V_170;
F_70 ( V_133 , V_135 ) ;
return F_166 ( V_107 -> V_125 . V_207 , V_133 , 0 , V_380 , V_186 ) ;
V_170:
V_271:
F_80 ( V_133 ) ;
return - 1 ;
...
if ( V_133 == NULL )
return - V_63 ;
if ( F_199 ( V_133 , V_31 , V_83 , V_384 ) < 0 )
F_87 () ;
return F_166 ( V_107 -> V_125 . V_207 , V_133 , 0 , V_387 , V_186 ) ;
}
...
static int F_203 ( struct V_81 * V_82 , T_1 * V_393 ,
T_8 V_394 )
{
struct V_107 * V_107 = F_178 ( V_82 ) ;
struct V_132 * V_133 ;
...
if ( V_133 == NULL )
return - V_63 ;
if ( F_202 ( V_133 , V_82 , V_393 , V_394 ) < 0 )
F_87 () ;
return F_166 ( V_107 -> V_125 . V_207 , V_133 , 0 , V_395 , V_186 ) ;
}
static int T_9 F_204 ( struct V_107 * V_107 )
{
struct V_370 * V_207 ;
V_207 = F_205 ( V_107 , V_396 , V_397 ,
F_171 , NULL , V_398 ) ;
if ( V_207 == NULL )
return - V_63 ;
