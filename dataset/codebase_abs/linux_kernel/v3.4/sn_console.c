...
static void F_69 ( int (* F_70) ( const char * V_5 , int V_6 ) ,
...
static void
F_71 ( struct V_103 * V_104 , const char * V_5 , unsigned V_101 )
{
...
F_40 ( ! V_8 -> V_56 ) ;
if ( ! V_8 -> V_32 . V_33 ) {
F_69 ( V_8 -> V_15 -> V_27 , V_5 , V_101 ) ;
return;
}
if ( F_72 ( & V_8 -> V_32 . V_40 ) ) {
int V_106 = V_8 -> V_32 . V_33 -> V_55 . V_49 ;
int V_107 = V_8 -> V_32 . V_33 -> V_55 . V_48 ;
int V_108 , V_109 = 0 ;
for ( V_108 = 0 ; V_108 < 150 ; F_73 ( 125 ) , V_108 ++ ) {
if ( ! F_72 ( & V_8 -> V_32 . V_40 )
|| V_105 ) {
if ( ! V_105 ) {
F_36 ( & V_8 -> V_32 . V_40 ,
...
static int F_74 ( struct V_103 * V_104 , char * V_110 )
{
return 0 ;
}
static void T_3
F_75 ( struct V_103 * V_104 , const char * V_5 , unsigned V_101 )
{
F_69 ( V_14 . V_15 -> V_27 , V_5 , V_101 ) ;
}
int T_3 F_76 ( void )
{
if ( ! F_59 ( L_11 ) )
