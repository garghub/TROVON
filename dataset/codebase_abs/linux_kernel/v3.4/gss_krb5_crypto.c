...
if ( V_7 )
goto V_5;
V_7 = F_41 ( V_80 , V_78 , V_16 , V_41 ) ;
V_5:
return V_7 ;
}
T_1
F_42 ( struct V_23 * V_24 , T_1 V_78 ,
struct V_27 * V_80 , int V_92 , struct V_63 * * V_76 )
{
T_1 V_33 ;
struct V_31 V_93 ;
T_2 * V_30 ;
T_2 * V_94 ;
struct V_1 * V_89 , * V_95 ;
int V_96 ;
struct V_63 * * V_90 ;
int V_97 , V_98 ;
struct V_61 V_14 ;
...
V_96 = F_2 ( V_89 ) ;
V_78 += V_109 ;
if ( F_35 ( V_80 , V_78 , V_24 -> V_42 -> V_110 ) )
return V_40 ;
F_43 ( V_80 -> V_70 [ 0 ] . V_88 + V_78 , V_24 -> V_42 -> V_110 ) ;
V_78 -= V_109 ;
if ( V_80 -> V_111 [ 0 ] . V_88 != NULL ) {
V_94 = V_80 -> V_111 [ 0 ] . V_88 + V_80 -> V_111 [ 0 ] . V_71 ;
} else {
V_80 -> V_111 [ 0 ] . V_88 = V_80 -> V_70 [ 0 ] . V_88
+ V_80 -> V_70 [ 0 ] . V_71 ;
V_80 -> V_111 [ 0 ] . V_71 = 0 ;
V_94 = V_80 -> V_111 [ 0 ] . V_88 ;
}
memset ( V_94 , 'X' , V_92 ) ;
V_80 -> V_111 [ 0 ] . V_71 += V_92 ;
V_80 -> V_41 += V_92 ;
memcpy ( V_94 + V_92 , V_80 -> V_70 [ 0 ] . V_88 + V_78 ,
V_109 ) ;
V_80 -> V_111 [ 0 ] . V_71 += V_109 ;
V_80 -> V_41 += V_109 ;
V_93 . V_41 = V_35 ;
V_93 . V_16 = V_80 -> V_111 [ 0 ] . V_88 + V_80 -> V_111 [ 0 ] . V_71 ;
V_90 = V_80 -> V_76 ;
V_80 -> V_76 = V_76 ;
...
if ( V_33 )
return V_40 ;
V_98 = V_80 -> V_41 - V_78 - V_109 ;
V_97 = ( V_98 + V_96 - 1 ) / V_96 ;
V_99 = 0 ;
if ( V_97 > 2 )
V_99 = ( V_97 - 2 ) * V_96 ;
memset ( V_14 . V_3 , 0 , sizeof( V_14 . V_3 ) ) ;
if ( V_99 ) {
V_14 . V_69 = V_78 + V_109 ;
V_14 . V_68 = 0 ;
V_14 . V_66 = 0 ;
V_14 . V_76 = V_76 ;
V_14 . V_62 = V_80 ;
...
V_80 -> V_111 [ 0 ] . V_71 += V_24 -> V_42 -> V_43 ;
...
T_1
F_44 ( struct V_23 * V_24 , T_1 V_78 , struct V_27 * V_80 ,
T_1 * V_113 , T_1 * V_114 )
{
struct V_27 V_115 ;
T_1 V_7 = 0 ;
...
V_96 = F_2 ( V_89 ) ;
F_45 ( V_80 , & V_115 , V_78 + V_109 ,
( V_80 -> V_41 - V_78 - V_109 -
V_24 -> V_42 -> V_43 ) ) ;
V_97 = ( V_115 . V_41 + V_96 - 1 ) / V_96 ;
V_99 = 0 ;
if ( V_97 > 2 )
V_99 = ( V_97 - 2 ) * V_96 ;
memset ( V_14 . V_3 , 0 , sizeof( V_14 . V_3 ) ) ;
...
V_14 . V_14 . V_2 = V_95 ;
F_30 ( V_14 . V_82 , 4 ) ;
V_7 = F_17 ( & V_115 , 0 , V_99 , F_33 , & V_14 ) ;
if ( V_7 )
goto V_112;
}
V_7 = F_37 ( V_89 , & V_115 , V_99 , V_14 . V_3 , NULL , 0 ) ;
if ( V_7 )
goto V_112;
V_117 . V_41 = sizeof( V_118 ) ;
V_117 . V_16 = V_118 ;
V_7 = F_24 ( V_24 , NULL , 0 , & V_115 , 0 ,
V_116 , V_18 , & V_117 ) ;
if ( V_7 )
goto V_112;
V_7 = F_40 ( V_80 , V_80 -> V_41 - V_24 -> V_42 -> V_43 ,
V_119 , V_24 -> V_42 -> V_43 ) ;
if ( V_7 )
goto V_112;
if ( memcmp ( V_119 , V_118 , V_24 -> V_42 -> V_43 ) != 0 ) {
V_7 = V_120 ;
goto V_112;
}
* V_113 = V_24 -> V_42 -> V_110 ;
* V_114 = V_24 -> V_42 -> V_43 ;
V_112:
if ( V_7 && V_7 != V_120 )
V_7 = V_40 ;
return V_7 ;
...
int
F_46 ( struct V_23 * V_24 , struct V_1 * V_89 ,
unsigned char * V_121 )
{
struct V_37 * V_93 ;
struct V_17 V_14 ;
...
int V_33 ;
F_4 ( L_10 , V_44 ) ;
V_93 = F_13 ( V_24 -> V_42 -> V_47 , 0 , V_46 ) ;
if ( F_14 ( V_93 ) ) {
F_4 ( L_11 ,
V_44 , F_47 ( V_93 ) , V_24 -> V_42 -> V_47 ) ;
return F_47 ( V_93 ) ;
}
V_14 . V_2 = V_93 ;
V_14 . V_48 = 0 ;
...
if ( V_33 )
goto V_112;
V_33 = F_19 ( V_93 , V_24 -> V_125 , V_24 -> V_42 -> V_50 ) ;
if ( V_33 )
goto V_112;
F_30 ( V_10 , 1 ) ;
F_48 ( V_10 , & V_124 , 4 ) ;
V_33 = F_21 ( & V_14 , V_10 , 4 , V_122 ) ;
if ( V_33 )
goto V_112;
V_33 = F_19 ( V_93 , V_122 , V_24 -> V_42 -> V_50 ) ;
if ( V_33 )
goto V_112;
F_48 ( V_10 , V_121 , 8 ) ;
V_33 = F_21 ( & V_14 , V_10 , 8 , V_122 ) ;
if ( V_33 )
goto V_112;
V_33 = F_49 ( V_89 , V_122 , V_24 -> V_42 -> V_50 ) ;
if ( V_33 )
goto V_112;
V_33 = 0 ;
V_112:
...
int
F_50 ( struct V_23 * V_24 , struct V_1 * V_89 ,
T_3 V_126 )
{
struct V_37 * V_93 ;
struct V_17 V_14 ;
...
V_127 [ V_73 ] = V_24 -> V_125 [ V_73 ] ^ 0xf0 ;
V_33 = F_19 ( V_93 , V_127 , V_24 -> V_42 -> V_50 ) ;
if ( V_33 )
goto V_112;
F_30 ( V_10 , 1 ) ;
F_48 ( V_10 , V_124 , 4 ) ;
V_33 = F_21 ( & V_14 , V_10 , 4 , V_127 ) ;
if ( V_33 )
goto V_112;
V_33 = F_19 ( V_93 , V_127 , V_24 -> V_42 -> V_50 ) ;
if ( V_33 )
goto V_112;
V_128 [ 0 ] = ( unsigned char ) ( ( V_126 >> 24 ) & 0xff ) ;
V_128 [ 1 ] = ( unsigned char ) ( ( V_126 >> 16 ) & 0xff ) ;
V_128 [ 2 ] = ( unsigned char ) ( ( V_126 >> 8 ) & 0xff ) ;
V_128 [ 3 ] = ( unsigned char ) ( ( V_126 >> 0 ) & 0xff ) ;
F_48 ( V_10 , V_128 , 4 ) ;
V_33 = F_21 ( & V_14 , V_10 , 4 , V_127 ) ;
if ( V_33 )
goto V_112;
V_33 = F_49 ( V_89 , V_127 , V_24 -> V_42 -> V_50 ) ;
if ( V_33 )
goto V_112;
V_33 = 0 ;
V_112:
