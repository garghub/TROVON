...
F_21 ( V_44 , V_2 ) ;
V_2 -> V_45 . V_46 = V_43 ;
if ( V_13 -> V_47 == 0 && ! F_22 ( V_13 ) )
V_2 -> V_45 . V_48 = 1 ;
V_2 -> V_45 . V_49 = V_13 -> V_50 << 9 ;
if ( V_13 -> V_50 > V_43 )
V_2 -> V_45 . V_49 = 0 ;
if ( F_23 ( V_13 ) || F_24 ( V_13 ) )
F_21 ( V_51 , V_2 ) ;
}
int F_25 ( struct V_5 * V_6 , struct V_42 * V_13 ,
...
if ( F_26 ( V_55 ) -> V_60 && * F_26 ( V_55 ) -> V_60 )
V_56 = * F_26 ( V_55 ) -> V_60 ;
V_6 -> V_13 = V_13 ;
V_6 -> V_17 = F_27 ( F_13 , V_52 ) ;
if ( ! V_6 -> V_17 )
return - V_41 ;
...
F_34 ( V_6 -> V_17 , V_56 ) ;
F_35 ( V_6 -> V_17 ,
F_38 ( V_55 -> V_67 , V_55 -> V_65 / 512 ) ) ;
F_36 ( V_6 -> V_17 , V_55 -> V_62 ) ;
F_37 ( V_6 -> V_17 , V_55 -> V_66 ) ;
...
unsigned int F_52 ( struct V_5 * V_6 , struct V_22 * V_59 )
{
unsigned int V_37 ;
T_3 V_75 ;
struct V_36 * V_39 ;
int V_76 ;
if ( ! V_59 -> V_68 )
return F_53 ( V_6 -> V_17 , V_59 -> V_4 , V_59 -> V_39 ) ;
F_54 ( ! V_59 -> V_71 ) ;
V_37 = F_53 ( V_6 -> V_17 , V_59 -> V_4 , V_59 -> V_71 ) ;
V_59 -> V_77 = V_37 ;
V_75 = 0 ;
F_55 (mqrq->bounce_sg, sg, sg_len, i)
V_75 += V_39 -> V_78 ;
F_56 ( V_59 -> V_39 , V_59 -> V_68 , V_75 ) ;
return 1 ;
}
void F_57 ( struct V_22 * V_59 )
{
if ( ! V_59 -> V_68 )
return;
if ( F_58 ( V_59 -> V_4 ) != V_79 )
return;
F_59 ( V_59 -> V_71 , V_59 -> V_77 ,
V_59 -> V_68 , V_59 -> V_39 [ 0 ] . V_78 ) ;
}
void F_60 ( struct V_22 * V_59 )
{
if ( ! V_59 -> V_68 )
return;
if ( F_58 ( V_59 -> V_4 ) != V_80 )
return;
F_61 ( V_59 -> V_71 , V_59 -> V_77 ,
V_59 -> V_68 , V_59 -> V_39 [ 0 ] . V_78 ) ;
}
