...
static int T_5 F_56 ( struct V_101 * V_102 )
{
struct V_103 * V_104 = V_102 -> V_105 . V_106 ;
struct V_101 * V_10 ;
struct V_107 * V_108 ;
struct V_109 * V_109 ;
int V_110 = - V_111 ;
V_108 = F_57 ( sizeof( * V_108 ) , V_112 ) ;
if ( ! V_108 ) {
F_58 ( & V_102 -> V_105 , L_14 ) ;
goto V_113;
}
V_10 = F_59 ( L_15 , - 1 ) ;
if ( ! V_10 ) {
F_58 ( & V_102 -> V_105 , L_16 ) ;
goto V_114;
}
V_109 = F_60 ( & V_102 -> V_105 , L_17 ) ;
if ( F_61 ( V_109 ) ) {
F_58 ( & V_102 -> V_105 , L_18 ) ;
V_110 = F_62 ( V_109 ) ;
goto V_115;
}
V_110 = F_63 ( V_109 ) ;
if ( V_110 ) {
F_58 ( & V_102 -> V_105 , L_19 ) ;
goto V_116;
}
V_10 -> V_105 . V_117 = & V_102 -> V_105 ;
V_10 -> V_105 . V_118 = & V_119 ;
V_10 -> V_105 . V_120 = V_119 ;
V_108 -> V_105 = & V_102 -> V_105 ;
V_108 -> V_10 = V_10 ;
V_108 -> V_109 = V_109 ;
V_104 -> V_121 = & V_122 ;
F_64 ( V_102 , V_108 ) ;
V_110 = F_65 ( V_10 , V_102 -> V_123 ,
V_102 -> V_124 ) ;
if ( V_110 ) {
F_58 ( & V_102 -> V_105 , L_20 ) ;
goto V_125;
}
V_110 = F_66 ( V_10 , V_104 , sizeof( * V_104 ) ) ;
if ( V_110 ) {
F_58 ( & V_102 -> V_105 , L_21 ) ;
goto V_125;
}
V_110 = F_67 ( V_10 ) ;
if ( V_110 ) {
F_58 ( & V_102 -> V_105 , L_22 ) ;
goto V_125;
}
return 0 ;
V_125:
...
static int T_6 F_72 ( struct V_101 * V_102 )
{
struct V_107 * V_108 = F_73 ( V_102 ) ;
F_74 ( V_108 -> V_10 ) ;
F_70 ( V_108 -> V_10 ) ;
F_68 ( V_108 -> V_109 ) ;
F_69 ( V_108 -> V_109 ) ;
