...
struct V_147 * V_148 , * V_162 = NULL ;
T_6 V_128 , V_126 ;
T_7 V_163 , V_164 , V_122 = 0 ;
T_7 V_165 = 0 , V_166 = 0 ;
int V_119 ;
if ( ! V_146 || ( V_146 -> V_167 != 1 ) || ( V_146 -> V_168 != V_169 ) )
return NULL ;
F_41 ( F_4 ( V_9 ) , L_36 ,
V_35 , V_146 -> V_170 , V_146 -> V_171 , V_146 -> V_167 ,
V_146 -> V_172 , V_116 ) ;
V_126 = V_146 -> V_170 ;
V_128 = V_146 -> V_171 ;
for ( V_119 = 0 ; V_119 < V_146 -> V_172 ; V_119 ++ ) {
struct V_15 * V_65 ;
T_7 V_173 , V_174 ;
V_148 = V_146 -> V_114 + V_119 ;
V_174 = F_70 ( V_146 , V_148 ) ;
V_173 = F_69 ( V_146 , V_148 ) ;
V_164 = V_148 -> V_152 + V_173 ;
V_163 = V_148 -> V_152 + V_174 ;
F_41 ( F_4 ( V_9 ) ,
L_37 ,
V_35 , V_148 -> V_152 , V_173 , V_174 ) ;
if ( V_162 && V_81 &&
( V_162 -> V_152 == V_148 -> V_152 ) &&
( V_166 == V_173 ) &&
( V_165 == V_174 ) ) {
F_41 ( F_4 ( V_9 ) ,
L_38 ,
...
V_33 -> V_18 . V_66 = - V_175 ;
V_33 -> V_18 . V_116 = V_116 ;
V_33 -> V_77 = V_122 ;
return & V_33 -> V_18 ;
}
static struct V_16 *
F_72 ( struct V_7 * V_9 , T_6 V_176 , T_6 V_143 ,
T_7 V_122 , unsigned long V_116 )
{
struct V_6 * V_19 = F_2 ( V_9 ) ;
struct V_15 * V_33 = NULL , * V_81 = NULL ;
T_7 V_177 = V_122 , V_77 = 0 , V_149 ;
T_6 V_126 = V_143 , V_128 = V_176 ;
T_2 V_93 ;
T_2 V_150 = V_95
| V_106
| F_51 ( 0 )
...
unsigned long V_67 ;
F_41 ( F_4 ( V_9 ) , L_39 ,
V_35 , & V_143 , & V_176 , V_122 , V_116 ) ;
if ( F_62 ( ! V_122 ) )
return NULL ;
V_93 = F_67 ( V_9 , V_126 | V_128 ) ;
while ( V_177 ) {
struct V_15 * V_65 = NULL ;
F_41 ( F_4 ( V_9 ) , L_40 , V_35 , V_177 ) ;
F_26 ( & V_19 -> V_68 , V_67 ) ;
V_65 = F_36 ( V_19 ) ;
F_30 ( & V_19 -> V_68 , V_67 ) ;
if ( ! V_65 ) {
...
F_41 ( F_4 ( V_9 ) ,
L_44 ,
V_35 , V_65 -> V_41 . V_127 , V_65 -> V_41 . V_180 , V_65 -> V_41 . V_42 ,
V_65 -> V_41 . V_47 ) ;
return V_65 ;
}
struct V_16 *
F_74 ( struct V_7 * V_9 , T_6 V_176 , int V_178 ,
T_7 V_122 , unsigned long V_116 )
{
struct V_6 * V_19 = F_2 ( V_9 ) ;
struct V_15 * V_65 ;
F_41 ( F_4 ( V_9 ) , L_45 ,
V_35 , V_176 , V_122 , V_178 , V_116 ) ;
if ( F_62 ( ! V_122 ) )
return NULL ;
V_65 = F_73 ( V_9 , V_19 , V_176 , V_122 , V_178 ) ;
F_28 ( & V_65 -> V_80 , & V_65 -> V_73 ) ;
V_65 -> V_18 . V_66 = - V_175 ;
...
unsigned int V_115 , int V_178 ,
unsigned long V_116 )
{
struct V_6 * V_19 = F_2 ( V_9 ) ;
struct V_15 * V_65 , * V_181 = NULL ,
* V_182 = NULL , * V_33 = NULL ;
struct V_113 * V_118 , * V_183 = NULL , * V_184 = NULL ;
T_7 V_185 = 0 , V_186 = 0 , V_122 = 0 ;
int V_119 ;
if ( ! V_114 )
return NULL ;
F_41 ( F_4 ( V_9 ) , L_46 ,
V_35 , V_115 , V_178 , V_116 ) ;
F_59 (sgl, sg, sg_len, i) {
F_41 ( F_4 ( V_9 ) , L_45 ,
...
if ( V_183 )
V_185 = F_61 ( V_118 ) -
( F_61 ( V_183 ) + F_60 ( V_183 ) ) ;
if ( V_182 && V_181 ) {
if ( ( V_185 == V_186 ) &&
( F_60 ( V_184 ) == F_60 ( V_183 ) ) ) {
F_41 ( F_4 ( V_9 ) ,
L_47 ,
V_35 , V_181 , V_182 ) ;
F_42 ( V_9 , V_182 ) ;
V_182 -> V_41 . V_161 = V_185 ;
F_28 ( & V_181 -> V_80 ,
& V_19 -> V_78 ) ;
V_181 = V_182 ;
} else if ( V_186 ||
F_61 ( V_118 ) < F_61 ( V_183 ) ) {
F_40 ( V_9 , V_182 , V_181 ) ;
F_28 ( & V_65 -> V_80 ,
& V_33 -> V_73 ) ;
F_41 ( F_4 ( V_9 ) ,
L_23 ,
...
struct V_6 * V_19 = F_2 ( V_9 ) ;
struct V_1 * V_2 = F_5 ( V_19 -> V_9 . V_10 ) ;
struct V_15 * V_65 , * V_190 ;
struct V_191 * V_73 ;
enum V_187 V_120 ;
int V_192 ;
T_2 V_193 , V_30 , V_178 ;
T_3 V_93 = 0 ;
unsigned long V_116 ;
V_120 = F_77 ( V_9 , V_66 , V_189 ) ;
if ( V_120 == V_194 )
return V_120 ;
if ( ! V_189 )
return V_120 ;
...
if ( ! V_65 -> V_36 ) {
F_78 ( V_189 , V_65 -> V_77 ) ;
goto V_121;
}
V_192 = V_65 -> V_77 ;
V_30 = V_195 | V_196 ;
V_178 = V_100 | V_98 ;
if ( ( V_65 -> V_41 . V_47 & V_30 ) == V_178 ) {
F_16 ( V_2 , V_197 , V_19 -> V_30 ) ;
while ( ! ( F_14 ( V_19 , V_198 ) & V_199 ) )
F_18 () ;
}
V_193 = F_14 ( V_19 , V_39 ) & 0xfffffffc ;
V_73 = & V_65 -> V_73 ;
F_79 (desc, _desc, descs_list, desc_node) {
V_93 = F_12 ( V_65 -> V_41 . V_47 ) ;
V_192 -= ( V_65 -> V_41 . V_42 & 0xffffff ) << V_93 ;
if ( ( V_65 -> V_41 . V_82 & 0xfffffffc ) == V_193 )
break;
}
V_192 += F_14 ( V_19 , V_54 ) << V_93 ;
F_78 ( V_189 , V_192 ) ;
F_41 ( F_4 ( V_9 ) ,
L_48 ,
V_35 , V_65 , & V_65 -> V_18 . V_37 , V_120 , V_66 , V_192 ) ;
V_121:
F_30 ( & V_19 -> V_68 , V_116 ) ;
return V_120 ;
}
...
V_65 = F_38 ( & V_19 -> V_70 , struct V_15 , V_69 ) ;
V_17 = & V_65 -> V_18 ;
if ( V_17 -> V_200 && ( V_17 -> V_116 & V_201 ) )
V_17 -> V_200 ( V_17 -> V_202 ) ;
}
static void F_83 ( unsigned long V_203 )
{
struct V_6 * V_19 = (struct V_6 * ) V_203 ;
struct V_15 * V_65 ;
T_2 V_204 ;
F_41 ( F_4 ( & V_19 -> V_9 ) , L_49 ,
V_35 , V_19 -> V_21 ) ;
V_204 = V_205
| V_206
| V_207 ;
if ( F_7 ( V_19 ) ) {
F_82 ( V_19 ) ;
} else if ( ( V_19 -> V_21 & V_208 )
|| ( V_19 -> V_21 & V_204 ) ) {
struct V_16 * V_17 ;
if ( V_19 -> V_21 & V_205 )
F_44 ( F_4 ( & V_19 -> V_9 ) , L_50 ) ;
if ( V_19 -> V_21 & V_206 )
F_44 ( F_4 ( & V_19 -> V_9 ) , L_51 ) ;
if ( V_19 -> V_21 & V_207 )
F_44 ( F_4 ( & V_19 -> V_9 ) , L_52 ) ;
F_84 ( & V_19 -> V_68 ) ;
V_65 = F_38 ( & V_19 -> V_70 ,
struct V_15 ,
V_69 ) ;
...
static T_8 F_89 ( int V_209 , void * V_210 )
{
struct V_1 * V_2 = (struct V_1 * ) V_210 ;
struct V_6 * V_19 ;
T_2 V_211 , V_21 , V_212 ;
T_2 V_213 , V_214 ;
int V_119 , V_120 = V_215 ;
do {
V_211 = F_17 ( V_2 , V_216 ) ;
V_21 = F_17 ( V_2 , V_217 ) ;
V_212 = V_21 & V_211 ;
F_20 ( V_2 -> V_14 . V_11 ,
L_53 ,
V_35 , V_21 , V_211 , V_212 ) ;
if ( ! V_212 )
break;
for ( V_119 = 0 ; V_119 < V_2 -> V_14 . V_218 ; V_119 ++ ) {
if ( ! ( ( 1 << V_119 ) & V_212 ) )
continue;
V_19 = & V_2 -> V_9 [ V_119 ] ;
V_213 = F_14 ( V_19 , V_219 ) ;
V_214 = F_14 ( V_19 , V_198 ) ;
V_19 -> V_21 = V_214 & V_213 ;
F_20 ( V_2 -> V_14 . V_11 ,
L_54 ,
V_35 , V_119 , V_213 , V_214 ) ;
F_20 ( F_4 ( & V_19 -> V_9 ) ,
L_2 ,
V_35 ,
F_14 ( V_19 , V_46 ) ,
...
int V_120 ;
unsigned long V_116 ;
F_41 ( F_4 ( V_9 ) , L_55 , V_35 ) ;
F_26 ( & V_19 -> V_68 , V_116 ) ;
V_120 = F_56 ( V_9 , V_222 ) ;
F_30 ( & V_19 -> V_68 , V_116 ) ;
return V_120 ;
}
...
{
struct V_230 * V_231 = F_103 ( V_11 ) ;
struct V_1 * V_2 = F_104 ( V_231 ) ;
struct V_7 * V_9 , * V_232 ;
...
F_79 (chan, _chan, &atxdmac->dma.channels, device_node) {
struct V_6 * V_19 = F_2 ( V_9 ) ;
V_19 -> V_234 = F_14 ( V_19 , V_46 ) ;
if ( F_7 ( V_19 ) ) {
if ( ! F_9 ( V_19 ) )
F_93 ( V_9 ) ;
V_19 -> V_235 = F_14 ( V_19 , V_219 ) ;
V_19 -> V_236 = F_14 ( V_19 , V_39 ) ;
V_19 -> V_237 = F_14 ( V_19 , V_51 ) ;
}
}
V_2 -> V_238 = F_17 ( V_2 , V_216 ) ;
F_15 ( V_2 ) ;
F_106 ( V_2 -> V_239 ) ;
return 0 ;
}
...
for ( V_119 = 0 ; V_119 < V_2 -> V_14 . V_218 ; V_119 ++ ) {
V_19 = & V_2 -> V_9 [ V_119 ] ;
while ( F_14 ( V_19 , V_198 ) )
F_18 () ;
}
F_16 ( V_2 , V_62 , V_2 -> V_238 ) ;
F_16 ( V_2 , V_63 , V_2 -> V_240 ) ;
F_79 (chan, _chan, &atxdmac->dma.channels, device_node) {
V_19 = F_2 ( V_9 ) ;
F_23 ( V_19 , V_46 , V_19 -> V_234 ) ;
if ( F_7 ( V_19 ) ) {
F_23 ( V_19 , V_39 , V_19 -> V_236 ) ;
F_23 ( V_19 , V_51 , V_19 -> V_237 ) ;
F_23 ( V_19 , V_59 , V_19 -> V_235 ) ;
F_24 () ;
F_16 ( V_2 , V_63 , V_19 -> V_30 ) ;
}
}
...
struct V_241 * V_242 ;
struct V_1 * V_2 ;
int V_209 , V_152 , V_243 , V_119 , V_120 ;
void T_1 * V_244 ;
T_2 V_34 ;
V_242 = F_110 ( V_231 , V_245 , 0 ) ;
if ( ! V_242 )
return - V_25 ;
V_209 = F_111 ( V_231 , 0 ) ;
if ( V_209 < 0 )
return V_209 ;
V_244 = F_112 ( & V_231 -> V_11 , V_242 ) ;
if ( F_113 ( V_244 ) )
return F_114 ( V_244 ) ;
V_34 = F_115 ( V_244 + V_246 ) ;
V_243 = F_116 ( V_34 ) ;
if ( V_243 > V_247 ) {
F_44 ( & V_231 -> V_11 , L_61 ,
V_243 ) ;
return - V_25 ;
}
V_152 = sizeof( * V_2 ) ;
V_152 += V_243 * sizeof( struct V_6 ) ;
V_2 = F_117 ( & V_231 -> V_11 , V_152 , V_248 ) ;
if ( ! V_2 ) {
F_44 ( & V_231 -> V_11 , L_62 ) ;
return - V_249 ;
}
V_2 -> V_4 = V_244 ;
V_2 -> V_209 = V_209 ;
V_2 -> V_239 = F_118 ( & V_231 -> V_11 , L_63 ) ;
if ( F_113 ( V_2 -> V_239 ) ) {
F_44 ( & V_231 -> V_11 , L_64 ) ;
return F_114 ( V_2 -> V_239 ) ;
}
V_120 = F_119 ( V_2 -> V_209 , F_89 , 0 , L_65 , V_2 ) ;
if ( V_120 ) {
F_44 ( & V_231 -> V_11 , L_66 ) ;
return V_120 ;
}
V_120 = F_108 ( V_2 -> V_239 ) ;
if ( V_120 ) {
F_44 ( & V_231 -> V_11 , L_67 ) ;
goto V_250;
}
V_2 -> V_72 =
F_120 ( F_121 ( & V_231 -> V_11 ) , & V_231 -> V_11 ,
sizeof( struct V_15 ) , 4 , 0 ) ;
if ( ! V_2 -> V_72 ) {
F_44 ( & V_231 -> V_11 , L_68 ) ;
V_120 = - V_249 ;
goto V_251;
}
F_122 ( V_252 , V_2 -> V_14 . V_253 ) ;
F_122 ( V_254 , V_2 -> V_14 . V_253 ) ;
F_122 ( V_255 , V_2 -> V_14 . V_253 ) ;
F_122 ( V_256 , V_2 -> V_14 . V_253 ) ;
F_122 ( V_257 , V_2 -> V_14 . V_253 ) ;
F_122 ( V_258 , V_2 -> V_14 . V_253 ) ;
F_122 ( V_259 , V_2 -> V_14 . V_253 ) ;
V_2 -> V_14 . V_11 = & V_231 -> V_11 ;
V_2 -> V_14 . V_260 = F_97 ;
...
V_2 -> V_14 . V_272 = F_94 ;
V_2 -> V_14 . V_273 = F_96 ;
V_2 -> V_14 . V_274 = V_275 ;
V_2 -> V_14 . V_276 = V_275 ;
V_2 -> V_14 . V_277 = F_123 ( V_94 ) | F_123 ( V_104 ) ;
V_2 -> V_14 . V_278 = V_279 ;
F_15 ( V_2 ) ;
F_33 ( & V_2 -> V_14 . V_280 ) ;
...
F_28 ( & V_19 -> V_9 . V_281 ,
& V_2 -> V_14 . V_280 ) ;
V_19 -> V_282 = F_1 ( V_2 , V_119 ) ;
V_19 -> V_30 = 1 << V_119 ;
F_124 ( & V_19 -> V_68 ) ;
F_33 ( & V_19 -> V_70 ) ;
F_33 ( & V_19 -> V_78 ) ;
F_125 ( & V_19 -> V_220 , F_83 ,
( unsigned long ) V_19 ) ;
while ( F_14 ( V_19 , V_198 ) )
F_18 () ;
}
...
if ( V_120 ) {
F_44 ( & V_231 -> V_11 , L_69 ) ;
goto V_251;
}
V_120 = F_128 ( V_231 -> V_11 . V_283 ,
F_43 , V_2 ) ;
if ( V_120 ) {
F_44 ( & V_231 -> V_11 , L_70 ) ;
goto V_284;
}
F_129 ( & V_231 -> V_11 , L_71 ,
V_243 , V_2 -> V_4 ) ;
return 0 ;
V_284:
F_130 ( & V_2 -> V_14 ) ;
...
F_106 ( V_2 -> V_239 ) ;
V_250:
F_131 ( V_2 -> V_209 , V_2 -> V_14 . V_11 ) ;
return V_120 ;
}
static int F_132 ( struct V_230 * V_231 )
{
struct V_1 * V_2 = (struct V_1 * ) F_104 ( V_231 ) ;
int V_119 ;
F_15 ( V_2 ) ;
F_133 ( V_231 -> V_11 . V_283 ) ;
F_130 ( & V_2 -> V_14 ) ;
F_106 ( V_2 -> V_239 ) ;
F_134 ( V_2 -> V_209 ) ;
F_131 ( V_2 -> V_209 , V_2 -> V_14 . V_11 ) ;
