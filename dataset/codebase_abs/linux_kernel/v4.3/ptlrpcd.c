...
int F_63 ( int V_8 , int V_82 , const char * V_95 , struct V_6 * V_25 )
{
int V_43 ;
if ( F_64 ( V_96 , & V_25 -> V_70 ) ) {
F_65 ( L_5 ,
V_95 , V_25 ) ;
return 0 ;
}
...
F_66 ( & V_25 -> V_81 ) ;
F_67 ( & V_25 -> V_64 ) ;
F_68 ( V_25 -> V_53 , V_95 , sizeof( V_25 -> V_53 ) ) ;
V_25 -> V_29 = F_69 () ;
if ( V_25 -> V_29 == NULL ) {
V_43 = - V_92 ;
goto V_97;
}
V_43 = F_48 ( & V_25 -> V_98 . V_72 , V_73 | V_74 ) ;
if ( V_43 != 0 )
goto V_99;
{
struct V_100 * V_101 ;
...
V_101 = F_70 ( F_39 , V_25 , L_6 , V_25 -> V_53 ) ;
if ( F_71 ( V_101 ) ) {
V_43 = F_72 ( V_101 ) ;
goto V_102;
}
...
void F_76 ( struct V_6 * V_25 , int V_103 )
{
if ( ! F_42 ( V_96 , & V_25 -> V_70 ) ) {
F_65 ( L_7 , V_25 ) ;
return;
}
F_57 ( V_79 , & V_25 -> V_70 ) ;
...
V_12 = F_82 ( V_105 , V_91 ) ;
if ( ! V_12 ) {
V_43 = - V_92 ;
goto V_97;
}
snprintf ( V_95 , sizeof( V_95 ) , L_8 ) ;
F_57 ( V_108 , & V_12 -> V_13 . V_70 ) ;
V_43 = F_63 ( - 1 , V_104 , V_95 , & V_12 -> V_13 ) ;
if ( V_43 < 0 )
goto V_97;
for ( V_28 = 0 ; V_28 < V_104 ; V_28 ++ ) {
snprintf ( V_95 , sizeof( V_95 ) , L_9 , V_28 ) ;
V_43 = F_63 ( V_28 , V_104 , V_95 , & V_12 -> V_20 [ V_28 ] ) ;
if ( V_43 < 0 )
goto V_97;
}
V_12 -> V_109 = V_105 ;
