...
static T_3 F_20 ( int V_56 , void * V_68 )
{
struct V_3 * V_4 = V_68 ;
T_1 V_69 ;
V_69 = V_4 -> V_13 ( V_4 -> V_8 + V_60 ) ;
V_4 -> V_7 ( V_69 , V_4 -> V_8 + V_60 ) ;
if ( V_69 & V_19 ) {
F_21 ( & V_4 -> V_62 ) ;
}
return V_70 ;
...
V_32 = F_27 ( & V_74 -> V_85 , sizeof( struct V_3 ) ) ;
if ( ! V_32 )
return - V_90 ;
V_32 -> V_91 = V_41 | V_39 | V_43 | V_45 |
V_50 ;
V_4 = F_13 ( V_32 ) ;
V_4 -> V_36 = 0xffffffff ;
V_4 -> V_92 . V_32 = V_32 ;
...
V_4 -> V_92 . V_95 = F_16 ;
F_28 ( & V_4 -> V_62 ) ;
V_78 = F_29 ( V_74 , V_96 , 0 ) ;
V_4 -> V_8 = F_30 ( & V_74 -> V_85 , V_78 ) ;
if ( F_31 ( V_4 -> V_8 ) ) {
V_79 = F_32 ( V_4 -> V_8 ) ;
goto V_97;
}
V_32 -> V_98 = V_74 -> V_99 ;
V_32 -> V_86 = V_80 ;
V_32 -> V_85 . V_87 = V_74 -> V_85 . V_87 ;
V_4 -> V_13 = F_3 ;
V_4 -> V_7 = F_1 ;
V_4 -> V_7 ( V_46 , V_4 -> V_8 + V_28 ) ;
V_83 = V_4 -> V_13 ( V_4 -> V_8 + V_28 ) ;
V_83 &= V_46 ;
if ( V_83 != V_46 ) {
V_4 -> V_13 = F_7 ;
V_4 -> V_7 = F_5 ;
}
V_32 -> V_100 = F_33 ( V_81 ) ;
V_4 -> V_10 = V_81 / 8 ;
V_4 -> V_57 = F_22 ( V_4 ) ;
V_4 -> V_56 = F_34 ( V_74 , 0 ) ;
if ( V_4 -> V_56 >= 0 ) {
V_79 = F_35 ( & V_74 -> V_85 , V_4 -> V_56 , F_20 , 0 ,
F_36 ( & V_74 -> V_85 ) , V_4 ) ;
if ( V_79 )
goto V_97;
}
...
F_38 ( & V_74 -> V_85 , L_5 ,
( unsigned long long ) V_78 -> V_101 , V_4 -> V_8 , V_4 -> V_56 ) ;
if ( V_76 ) {
for ( V_84 = 0 ; V_84 < V_76 -> V_102 ; V_84 ++ )
F_39 ( V_32 , V_76 -> V_103 + V_84 ) ;
}
F_40 ( V_74 , V_32 ) ;
return 0 ;
V_97:
