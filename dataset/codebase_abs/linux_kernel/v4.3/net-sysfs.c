...
static T_1 F_64 ( const struct V_5 * V_58 ,
struct V_6 * V_7 , char * V_8 ,
unsigned long V_59 )
{
struct V_1 * V_2 = F_4 ( V_58 ) ;
T_1 V_10 = - V_11 ;
F_65 ( V_59 > sizeof( struct V_60 ) ||
V_59 % sizeof( V_61 ) != 0 ) ;
F_5 ( & V_12 ) ;
if ( F_1 ( V_2 ) ) {
struct V_60 V_62 ;
const struct V_60 * V_63 = F_66 ( V_2 , & V_62 ) ;
...
char * V_8 )
{
struct V_69 * V_68 = F_68 ( V_7 ) ;
struct V_70 * V_71 = F_69 ( V_67 ) ;
if ( ! V_68 -> V_72 )
return - V_73 ;
return V_68 -> V_72 ( V_71 , V_68 , V_8 ) ;
}
static T_1 F_70 ( struct V_66 * V_67 , struct V_68 * V_7 ,
...
if ( ! V_68 -> V_74 )
return - V_73 ;
return V_68 -> V_74 ( V_71 , V_68 , V_8 , V_43 ) ;
}
static T_1 F_71 ( struct V_70 * V_71 ,
...
F_75 ( V_76 -> V_81 [ V_78 ] , V_77 ) ;
V_13 = snprintf ( V_8 , V_82 , L_6 , F_76 ( V_77 ) ) ;
F_77 () ;
F_78 ( V_77 ) ;
...
if ( ! F_81 ( & V_77 , V_79 ) )
return - V_80 ;
V_20 = F_82 ( V_8 , V_13 , F_83 ( V_77 ) , V_86 ) ;
if ( V_20 ) {
F_78 ( V_77 ) ;
return V_20 ;
}
V_76 = F_84 ( F_85 (unsigned int,
...
static T_1 F_96 ( struct V_70 * V_71 ,
struct V_69 * V_7 ,
char * V_8 )
{
struct V_89 * V_90 ;
...
V_90 = F_74 ( V_71 -> V_91 ) ;
if ( V_90 )
V_41 = ( unsigned long ) V_90 -> V_77 + 1 ;
F_77 () ;
return sprintf ( V_8 , L_7 , V_41 ) ;
}
static void F_97 ( struct V_92 * V_88 )
{
struct V_89 * V_93 = F_98 ( V_88 ,
struct V_89 , V_88 ) ;
F_99 ( V_93 ) ;
}
static T_1 F_100 ( struct V_70 * V_71 ,
struct V_69 * V_7 ,
const char * V_8 , T_2 V_13 )
{
unsigned long V_77 , V_43 ;
struct V_89 * V_93 , * V_94 ;
static F_101 ( V_95 ) ;
int V_96 ;
if ( ! F_46 ( V_18 ) )
return - V_19 ;
V_96 = F_11 ( V_8 , 0 , & V_43 ) ;
if ( V_96 < 0 )
return V_96 ;
if ( V_43 ) {
V_77 = V_43 - 1 ;
...
return - V_11 ;
#else
if ( V_77 > ( V_99 - F_102 ( 1 ) )
/ sizeof( struct V_100 ) ) {
return - V_11 ;
}
#endif
V_93 = F_103 ( F_102 ( V_77 + 1 ) ) ;
if ( ! V_93 )
return - V_80 ;
V_93 -> V_77 = V_77 ;
for ( V_43 = 0 ; V_43 <= V_77 ; V_43 ++ )
V_93 -> V_101 [ V_43 ] . V_84 = V_102 ;
} else
V_93 = NULL ;
F_104 ( & V_95 ) ;
V_94 = F_89 ( V_71 -> V_91 ,
...
struct V_75 * V_76 ;
struct V_89 * V_90 ;
V_76 = F_89 ( V_71 -> V_75 , 1 ) ;
if ( V_76 ) {
F_110 ( V_71 -> V_75 , NULL ) ;
F_95 ( V_76 , V_88 ) ;
}
V_90 = F_89 ( V_71 -> V_91 , 1 ) ;
if ( V_90 ) {
F_110 ( V_71 -> V_91 , NULL ) ;
F_107 ( & V_90 -> V_88 , F_97 ) ;
}
#endif
memset ( V_67 , 0 , sizeof( * V_67 ) ) ;
F_111 ( V_71 -> V_2 ) ;
}
static const void * F_112 ( struct V_66 * V_67 )
{
struct V_70 * V_71 = F_69 ( V_67 ) ;
...
static int F_113 ( struct V_1 * V_2 , int V_107 )
{
struct V_70 * V_71 = V_2 -> V_108 + V_107 ;
struct V_66 * V_67 = & V_71 -> V_67 ;
int error = 0 ;
V_67 -> V_109 = V_2 -> V_110 ;
error = F_114 ( V_67 , & V_111 , NULL ,
L_8 , V_107 ) ;
if ( error )
goto exit;
if ( V_2 -> V_112 ) {
error = F_115 ( V_67 , V_2 -> V_112 ) ;
if ( error )
goto exit;
}
F_116 ( V_67 , V_113 ) ;
...
int
F_119 ( struct V_1 * V_2 , int V_114 , int V_115 )
{
#ifdef F_120
int V_78 ;
int error = 0 ;
...
while ( -- V_78 >= V_115 ) {
if ( V_2 -> V_112 )
F_121 ( & V_2 -> V_108 [ V_78 ] . V_67 ,
V_2 -> V_112 ) ;
F_118 ( & V_2 -> V_108 [ V_78 ] . V_67 ) ;
}
return error ;
#else
return 0 ;
...
static T_1 F_122 ( struct V_66 * V_67 ,
struct V_68 * V_7 , char * V_8 )
{
struct V_116 * V_68 = F_123 ( V_7 ) ;
struct V_117 * V_71 = F_124 ( V_67 ) ;
if ( ! V_68 -> V_72 )
return - V_73 ;
return V_68 -> V_72 ( V_71 , V_68 , V_8 ) ;
}
static T_1 F_125 ( struct V_66 * V_67 ,
struct V_68 * V_7 ,
const char * V_8 , T_2 V_43 )
{
struct V_116 * V_68 = F_123 ( V_7 ) ;
...
static T_1 F_126 ( struct V_117 * V_71 ,
struct V_116 * V_68 ,
char * V_8 )
{
unsigned long V_118 ;
...
static inline unsigned int F_129 ( struct V_117 * V_71 )
{
...
break;
F_130 ( V_78 >= V_2 -> V_120 ) ;
return V_78 ;
}
static T_1 F_131 ( struct V_117 * V_71 ,
struct V_116 * V_68 ,
char * V_8 )
{
...
{
struct V_1 * V_2 = V_71 -> V_2 ;
int V_20 , V_107 = F_129 ( V_71 ) ;
V_98 V_123 = 0 ;
V_20 = F_133 ( V_8 , 10 , & V_123 ) ;
if ( V_20 < 0 )
return V_20 ;
if ( ! F_12 () )
return F_13 () ;
...
static T_1 F_134 ( char * V_8 , unsigned int V_127 )
{
...
return sprintf ( V_8 , L_10 , F_138 ( V_130 -> V_131 ) ) ;
}
static T_1 F_139 ( struct V_117 * V_71 ,
struct V_116 * V_68 ,
const char * V_8 , T_2 V_13 )
{
struct V_130 * V_130 = & V_71 -> V_130 ;
...
if ( V_20 < 0 )
return V_20 ;
V_130 -> V_131 = F_140 ( V_127 ) ;
return V_13 ;
}
static T_1 F_141 ( struct V_117 * V_71 ,
struct V_116 * V_7 ,
char * V_8 )
{
struct V_130 * V_130 = & V_71 -> V_130 ;
...
static T_1 F_142 ( struct V_117 * V_71 ,
...
V_107 = F_129 ( V_71 ) ;
F_73 () ;
V_135 = F_74 ( V_2 -> V_136 ) ;
if ( V_135 ) {
F_143 (i) {
struct V_137 * V_76 =
F_74 ( V_135 -> V_138 [ V_78 ] ) ;
if ( V_76 ) {
int V_139 ;
...
static T_1 F_144 ( struct V_117 * V_71 ,
struct V_116 * V_68 ,
const char * V_8 , T_2 V_13 )
{
struct V_1 * V_2 = V_71 -> V_2 ;
...
V_20 = F_145 ( V_2 , V_77 , V_107 ) ;
F_78 ( V_77 ) ;
return V_20 ? : V_13 ;
}
static void F_146 ( struct V_66 * V_67 )
{
struct V_117 * V_71 = F_124 ( V_67 ) ;
memset ( V_67 , 0 , sizeof( * V_67 ) ) ;
F_111 ( V_71 -> V_2 ) ;
}
static const void * F_147 ( struct V_66 * V_67 )
{
struct V_117 * V_71 = F_124 ( V_67 ) ;
struct V_5 * V_2 = & V_71 -> V_2 -> V_2 ;
const void * V_103 = NULL ;
...
static int F_148 ( struct V_1 * V_2 , int V_107 )
{
struct V_117 * V_71 = V_2 -> V_121 + V_107 ;
struct V_66 * V_67 = & V_71 -> V_67 ;
int error = 0 ;
V_67 -> V_109 = V_2 -> V_110 ;
error = F_114 ( V_67 , & V_141 , NULL ,
L_13 , V_107 ) ;
if ( error )
goto exit;
#ifdef F_149
error = F_115 ( V_67 , & V_142 ) ;
if ( error )
goto exit;
#endif
F_116 ( V_67 , V_113 ) ;
...
int
F_150 ( struct V_1 * V_2 , int V_114 , int V_115 )
{
#ifdef F_120
int V_78 ;
int error = 0 ;
for ( V_78 = V_114 ; V_78 < V_115 ; V_78 ++ ) {
error = F_148 ( V_2 , V_78 ) ;
if ( error ) {
V_115 = V_114 ;
break;
}
...
#endif
V_146 = V_2 -> V_148 ;
error = F_119 ( V_2 , 0 , V_145 ) ;
if ( error )
goto error;
V_144 = V_145 ;
error = F_150 ( V_2 , 0 , V_146 ) ;
if ( error )
goto error;
V_143 = V_146 ;
return 0 ;
...
static const void * F_160 ( struct V_155 * V_156 )
{
return F_161 ( V_156 ) ;
}
static int F_162 ( struct V_5 * V_58 , struct V_157 * V_158 )
{
struct V_1 * V_2 = F_4 ( V_58 ) ;
int V_159 ;
V_159 = F_163 ( V_158 , L_15 , V_2 -> V_51 ) ;
if ( V_159 )
goto exit;
V_159 = F_163 ( V_158 , L_16 , V_2 -> V_160 ) ;
exit:
return V_159 ;
}
static void F_164 ( struct V_5 * V_58 )
{
struct V_1 * V_2 = F_4 ( V_58 ) ;
F_130 ( V_2 -> V_3 != V_161 ) ;
F_87 ( V_2 -> V_44 ) ;
...
static const void * F_166 ( struct V_5 * V_58 )
{
struct V_1 * V_2 ;
V_2 = F_98 ( V_58 , struct V_1 , V_2 ) ;
return F_9 ( V_2 ) ;
}
static int F_167 ( struct V_5 * V_2 , const void * V_162 )
{
int V_10 = 0 ;
if ( V_2 -> V_163 )
...
struct V_1 * F_168 ( struct V_165 * V_166 )
{
struct V_5 * V_2 ;
V_2 = F_169 ( & V_167 , NULL , V_166 , F_167 ) ;
if ( ! V_2 )
return NULL ;
return F_4 ( V_2 ) ;
}
...
int F_179 ( struct V_178 * V_179 ,
const void * V_103 )
{
return F_180 ( & V_167 , V_179 , V_103 ) ;
}
void F_181 ( struct V_178 * V_179 ,
const void * V_103 )
{
F_182 ( & V_167 , V_179 , V_103 ) ;
}
int T_4 F_183 ( void )
{
F_184 ( & V_180 ) ;
