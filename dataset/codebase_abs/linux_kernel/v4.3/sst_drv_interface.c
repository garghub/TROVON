...
( V_3 * sizeof( V_51 ) ) ;
V_52 = F_24 ( struct V_50 , V_57 ) ;
F_25 ( V_53 , V_52 , V_51 . V_57 ) ;
return 0 ;
}
...
V_56 -> V_68 = V_51 . V_67 ;
V_56 -> V_69 = V_51 . V_70 ;
V_56 -> V_71 = F_40 ( V_51 . V_72 ,
( V_73 ) V_5 -> V_74 * F_41 ( 24 ) ) ;
V_56 -> V_75 = V_51 . V_76 ;
...
static int F_43 ( struct V_92 * V_16 )
{
if ( V_16 -> V_16 == V_90 )
* V_16 = V_93 ;
...
V_101 = ( T_2 ) ( V_51 -> V_72 -
V_51 -> V_67 ) ;
V_102 = F_47 ( V_100 -> V_107 , V_101 ) ;
V_103 = F_48 ( V_100 ) ;
F_49 ( V_51 -> V_67 , V_103 , & V_104 ) ;
V_105 = F_50 ( V_100 -> V_107 , V_104 ) ;
...
static int F_51 ( struct V_31 * V_8 , struct V_97 * V_98 )
{
struct V_4 * V_5 ;
struct V_99 * V_100 ;
struct V_50 V_51 ;
...
+ ( V_3 * sizeof( V_51 ) ) ) ,
sizeof( V_51 ) ) ;
return F_46 ( V_2 , V_98 , V_100 , & V_51 ) ;
}
...
static int F_56 ( struct V_31 * V_8 , struct V_97 * V_29 )
{
int V_3 = 0 ;
struct V_4 * V_5 ;
struct V_1 * V_2 = F_12 ( V_8 ) ;
