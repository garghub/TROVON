...
struct V_263 * F_220 ( struct V_183 * V_185 ,
T_11 * V_410 , T_5 V_356 )
{
struct V_263 * V_36 ;
...
struct V_263 * F_221 ( struct V_1 * V_2 ,
T_11 * V_410 ,
T_5 V_356 )
{
struct V_263 * V_36 ;
F_93 (param, &hdev->pend_le_conns, action) {
if ( F_106 ( & V_36 -> V_410 , V_410 ) == 0 &&
V_36 -> V_356 == V_356 &&
V_36 -> V_412 )
return V_36 ;
...
V_411 -> V_356 = V_356 ;
F_110 ( & V_411 -> V_185 , & V_2 -> V_413 ) ;
F_104 ( & V_411 -> V_265 ) ;
V_411 -> V_414 = V_2 -> V_415 ;
V_411 -> V_416 = V_2 -> V_417 ;
V_411 -> V_418 = V_2 -> V_419 ;
V_411 -> V_420 = V_2 -> V_421 ;
V_411 -> V_422 = V_423 ;
...
static void F_227 ( struct V_1 * V_2 , T_5 V_425 , T_6 V_25 )
{
if ( V_425 ) {
F_45 ( L_33 , V_425 ) ;
F_117 ( V_2 ) ;
...
static void F_228 ( struct V_1 * V_2 , T_5 V_425 ,
T_6 V_25 )
{
...
static void F_232 ( struct V_1 * V_2 , T_5 V_425 ,
T_6 V_25 )
{
unsigned long V_37 , V_400 , V_426 , V_431 ;
F_19 ( L_3 , V_2 -> V_26 ) ;
if ( V_425 ) {
F_45 ( L_37 , V_425 ) ;
return;
}
if ( ! F_8 ( V_432 , & V_2 -> V_63 ) ||
! V_2 -> V_165 . V_426 )
return;
V_400 = V_2 -> V_165 . V_433 ;
V_426 = V_2 -> V_165 . V_426 ;
V_431 = V_201 ;
if ( V_431 - V_426 <= V_400 ) {
int V_434 ;
if ( V_431 >= V_426 )
V_434 = V_431 - V_426 ;
else
V_434 = V_435 - V_426 + V_431 ;
V_37 = V_400 - V_434 ;
} else {
V_37 = 0 ;
}
...
V_97 . V_14 = V_438 ;
V_97 . V_439 = V_440 ;
F_40 ( & V_41 , V_441 , sizeof( V_97 ) , & V_97 ) ;
...
F_104 ( & V_2 -> V_482 ) ;
F_104 ( & V_2 -> V_483 ) ;
F_104 ( & V_2 -> V_484 . V_185 ) ;
F_104 ( & V_2 -> V_393 ) ;
F_237 ( & V_2 -> V_250 , V_485 ) ;
F_237 ( & V_2 -> V_249 , V_486 ) ;
F_237 ( & V_2 -> V_248 , V_487 ) ;
...
{
int V_162 , error ;
if ( ! V_2 -> V_238 || ! V_2 -> V_255 || ! V_2 -> V_488 )
return - V_19 ;
switch ( V_2 -> V_64 ) {
case V_65 :
V_162 = F_246 ( & V_489 , 0 , 0 , V_195 ) ;
break;
case V_66 :
V_162 = F_246 ( & V_489 , 1 , 0 , V_195 ) ;
break;
default:
return - V_19 ;
}
...
V_2 -> V_279 = F_247 ( L_3 , V_490 | V_491 |
V_492 , 1 , V_2 -> V_26 ) ;
if ( ! V_2 -> V_279 ) {
error = - V_232 ;
goto V_33;
}
V_2 -> V_260 = F_247 ( L_3 , V_490 | V_491 |
V_492 , 1 , V_2 -> V_26 ) ;
if ( ! V_2 -> V_260 ) {
F_248 ( V_2 -> V_279 ) ;
error = - V_232 ;
...
if ( ! F_249 ( V_493 ) )
V_2 -> V_149 = F_250 ( V_2 -> V_26 , V_493 ) ;
F_251 ( & V_2 -> V_257 , L_3 , V_2 -> V_26 ) ;
error = F_252 ( & V_2 -> V_257 ) ;
if ( error < 0 )
goto V_494;
V_2 -> V_495 = F_253 ( V_2 -> V_26 , & V_2 -> V_257 ,
V_496 , & V_497 ,
V_2 ) ;
if ( V_2 -> V_495 ) {
if ( F_254 ( V_2 -> V_495 ) < 0 ) {
F_255 ( V_2 -> V_495 ) ;
V_2 -> V_495 = NULL ;
}
}
if ( V_2 -> V_495 && F_256 ( V_2 -> V_495 ) )
F_50 ( V_2 , V_234 ) ;
F_50 ( V_2 , V_148 ) ;
F_50 ( V_2 , V_258 ) ;
if ( V_2 -> V_64 == V_65 ) {
...
{
const T_5 V_503 [] = { V_504 , 0x01 , 0x00 } ;
struct V_11 * V_12 ;
V_12 = F_272 ( 3 , V_505 ) ;
if ( ! V_12 )
return - V_232 ;
F_273 ( V_12 ) -> V_309 = V_506 ;
memcpy ( F_274 ( V_12 , 3 ) , V_503 , 3 ) ;
...
int F_278 ( struct V_509 * V_510 )
{
F_19 ( L_41 , V_510 , V_510 -> V_26 ) ;
F_279 ( & V_511 ) ;
F_280 ( & V_510 -> V_185 , & V_512 ) ;
F_281 ( & V_511 ) ;
return 0 ;
}
int F_282 ( struct V_509 * V_510 )
{
F_19 ( L_41 , V_510 , V_510 -> V_26 ) ;
F_279 ( & V_511 ) ;
F_102 ( & V_510 -> V_185 ) ;
...
{
int V_33 ;
F_19 ( L_42 , V_2 -> V_26 , F_273 ( V_12 ) -> V_309 , V_12 -> V_513 ) ;
F_276 ( V_12 ) ;
F_284 ( V_2 , V_12 ) ;
if ( F_285 ( & V_2 -> V_514 ) ) {
F_286 ( V_2 , V_12 ) ;
...
if ( ! V_2 -> V_254 )
return NULL ;
V_516 = ( void * ) V_2 -> V_254 -> V_180 ;
if ( V_516 -> V_25 != F_47 ( V_25 ) )
return NULL ;
F_19 ( L_46 , V_2 -> V_26 , V_25 ) ;
return V_2 -> V_254 -> V_180 + V_517 ;
}
static void F_291 ( struct V_11 * V_12 , T_12 V_518 , T_12 V_16 )
{
struct V_519 * V_516 ;
int V_513 = V_12 -> V_513 ;
F_292 ( V_12 , V_520 ) ;
F_293 ( V_12 ) ;
V_516 = (struct V_519 * ) F_294 ( V_12 ) ;
V_516 -> V_518 = F_47 ( F_295 ( V_518 , V_16 ) ) ;
V_516 -> V_521 = F_47 ( V_513 ) ;
}
static void F_296 ( struct V_522 * V_523 , struct V_524 * V_525 ,
struct V_11 * V_12 , T_12 V_16 )
{
struct V_345 * V_264 = V_523 -> V_264 ;
struct V_1 * V_2 = V_264 -> V_2 ;
struct V_11 * V_185 ;
V_12 -> V_513 = F_297 ( V_12 ) ;
V_12 -> V_526 = 0 ;
F_273 ( V_12 ) -> V_309 = V_527 ;
switch ( V_2 -> V_64 ) {
case V_65 :
F_291 ( V_12 , V_264 -> V_518 , V_16 ) ;
break;
case V_66 :
F_291 ( V_12 , V_523 -> V_518 , V_16 ) ;
break;
default:
F_45 ( L_47 , V_2 -> V_26 , V_2 -> V_64 ) ;
return;
}
V_185 = F_298 ( V_12 ) -> V_528 ;
if ( ! V_185 ) {
F_19 ( L_48 , V_2 -> V_26 , V_12 , V_12 -> V_513 ) ;
F_277 ( V_525 , V_12 ) ;
} else {
F_19 ( L_49 , V_2 -> V_26 , V_12 , V_12 -> V_513 ) ;
F_298 ( V_12 ) -> V_528 = NULL ;
F_299 ( & V_525 -> V_475 ) ;
F_300 ( V_525 , V_12 ) ;
V_16 &= ~ V_529 ;
V_16 |= V_530 ;
do {
V_12 = V_185 ; V_185 = V_185 -> V_531 ;
F_273 ( V_12 ) -> V_309 = V_527 ;
F_291 ( V_12 , V_264 -> V_518 , V_16 ) ;
F_19 ( L_49 , V_2 -> V_26 , V_12 , V_12 -> V_513 ) ;
F_300 ( V_525 , V_12 ) ;
...
void F_302 ( struct V_522 * V_523 , struct V_11 * V_12 , T_12 V_16 )
{
struct V_1 * V_2 = V_523 -> V_264 -> V_2 ;
F_19 ( L_50 , V_2 -> V_26 , V_523 , V_16 ) ;
F_296 ( V_523 , & V_523 -> V_532 , V_12 , V_16 ) ;
...
struct V_1 * V_2 = V_264 -> V_2 ;
struct V_533 V_516 ;
F_19 ( L_51 , V_2 -> V_26 , V_12 -> V_513 ) ;
V_516 . V_518 = F_47 ( V_264 -> V_518 ) ;
V_516 . V_521 = V_12 -> V_513 ;
F_292 ( V_12 , V_534 ) ;
F_293 ( V_12 ) ;
memcpy ( F_294 ( V_12 ) , & V_516 , V_534 ) ;
F_273 ( V_12 ) -> V_309 = V_535 ;
F_277 ( & V_264 -> V_532 , V_12 ) ;
F_201 ( V_2 -> V_279 , & V_2 -> V_248 ) ;
}
static struct V_345 * F_304 ( struct V_1 * V_2 , T_10 type ,
int * V_536 )
{
struct V_537 * V_538 = & V_2 -> V_484 ;
struct V_345 * V_264 = NULL , * V_539 ;
unsigned int V_202 = 0 , F_7 = ~ 0 ;
F_181 () ;
F_175 (c, &h->list, list) {
if ( V_539 -> type != type || F_305 ( & V_539 -> V_532 ) )
continue;
if ( V_539 -> V_166 != V_540 && V_539 -> V_166 != V_541 )
continue;
V_202 ++ ;
if ( V_539 -> V_381 < F_7 ) {
F_7 = V_539 -> V_381 ;
...
break;
case V_350 :
V_542 = V_2 -> V_325 ? V_2 -> V_287 : V_2 -> V_285 ;
break;
default:
V_542 = 0 ;
F_45 ( L_52 ) ;
...
F_181 () ;
F_175 (c, &h->list, list) {
if ( V_539 -> type == type && V_539 -> V_381 ) {
F_45 ( L_55 ,
V_2 -> V_26 , & V_539 -> V_547 ) ;
F_308 ( V_539 , V_548 ) ;
}
}
F_182 () ;
}
static struct V_522 * F_309 ( struct V_1 * V_2 , T_10 type ,
int * V_536 )
{
struct V_537 * V_538 = & V_2 -> V_484 ;
struct V_522 * V_523 = NULL ;
unsigned int V_202 = 0 , F_7 = ~ 0 , V_549 = 0 ;
struct V_345 * V_264 ;
int V_542 , V_543 , V_550 = 0 ;
F_19 ( L_3 , V_2 -> V_26 ) ;
F_181 () ;
...
if ( V_264 -> type != type )
continue;
if ( V_264 -> V_166 != V_540 && V_264 -> V_166 != V_541 )
continue;
V_550 ++ ;
F_175 (tmp, &conn->chan_list, list) {
struct V_11 * V_12 ;
if ( F_305 ( & V_338 -> V_532 ) )
continue;
V_12 = F_310 ( & V_338 -> V_532 ) ;
if ( V_12 -> V_551 < V_549 )
continue;
if ( V_12 -> V_551 > V_549 ) {
V_202 = 0 ;
...
if ( F_306 ( V_2 , type ) == V_550 )
break;
}
F_182 () ;
if ( ! V_523 )
return NULL ;
switch ( V_523 -> V_264 -> type ) {
case V_544 :
V_542 = V_2 -> V_285 ;
break;
case V_552 :
...
if ( F_305 ( & V_523 -> V_532 ) )
continue;
V_12 = F_310 ( & V_523 -> V_532 ) ;
if ( V_12 -> V_551 >= V_554 - 1 )
continue;
V_12 -> V_551 = V_554 - 1 ;
F_19 ( L_57 , V_523 , V_12 ,
V_12 -> V_551 ) ;
}
if ( F_306 ( V_2 , type ) == V_202 )
break;
...
{
return F_313 ( V_12 -> V_513 - V_520 , V_2 -> V_555 ) ;
}
static void F_314 ( struct V_1 * V_2 , unsigned int V_542 )
{
if ( ! F_4 ( V_2 , V_228 ) ) {
if ( ! V_542 && F_315 ( V_201 , V_2 -> V_556 +
V_557 ) )
F_307 ( V_2 , V_544 ) ;
}
}
...
{
unsigned int V_542 = V_2 -> V_285 ;
struct V_522 * V_523 ;
struct V_11 * V_12 ;
int V_536 ;
F_314 ( V_2 , V_542 ) ;
while ( V_2 -> V_285 &&
( V_523 = F_309 ( V_2 , V_544 , & V_536 ) ) ) {
T_7 V_551 = ( F_310 ( & V_523 -> V_532 ) ) -> V_551 ;
while ( V_536 -- && ( V_12 = F_310 ( & V_523 -> V_532 ) ) ) {
F_19 ( L_58 , V_523 , V_12 ,
V_12 -> V_513 , V_12 -> V_551 ) ;
if ( V_12 -> V_551 < V_551 )
break;
V_12 = F_317 ( & V_523 -> V_532 ) ;
F_318 ( V_523 -> V_264 ,
F_273 ( V_12 ) -> V_558 ) ;
F_283 ( V_2 , V_12 ) ;
V_2 -> V_556 = V_201 ;
...
type = V_544 ;
while ( V_2 -> V_553 > 0 &&
( V_523 = F_309 ( V_2 , type , & V_536 ) ) ) {
T_7 V_551 = ( F_310 ( & V_523 -> V_532 ) ) -> V_551 ;
while ( V_536 > 0 && ( V_12 = F_310 ( & V_523 -> V_532 ) ) ) {
int V_559 ;
F_19 ( L_58 , V_523 , V_12 ,
V_12 -> V_513 , V_12 -> V_551 ) ;
if ( V_12 -> V_551 < V_551 )
...
{
F_19 ( L_3 , V_2 -> V_26 ) ;
if ( ! F_306 ( V_2 , V_544 ) && V_2 -> V_64 == V_65 )
return;
if ( ! F_306 ( V_2 , V_552 ) && V_2 -> V_64 == V_66 )
return;
switch ( V_2 -> V_50 ) {
case V_51 :
F_316 ( V_2 ) ;
...
if ( ! F_306 ( V_2 , V_545 ) )
return;
while ( V_2 -> V_286 && ( V_264 = F_304 ( V_2 , V_545 , & V_536 ) ) ) {
while ( V_536 -- && ( V_12 = F_317 ( & V_264 -> V_532 ) ) ) {
F_19 ( L_59 , V_12 , V_12 -> V_513 ) ;
F_283 ( V_2 , V_12 ) ;
V_264 -> V_381 ++ ;
if ( V_264 -> V_381 == ~ 0 )
V_264 -> V_381 = 0 ;
...
if ( ! F_306 ( V_2 , V_546 ) )
return;
while ( V_2 -> V_286 && ( V_264 = F_304 ( V_2 , V_546 ,
& V_536 ) ) ) {
while ( V_536 -- && ( V_12 = F_317 ( & V_264 -> V_532 ) ) ) {
F_19 ( L_59 , V_12 , V_12 -> V_513 ) ;
F_283 ( V_2 , V_12 ) ;
...
struct V_522 * V_523 ;
struct V_11 * V_12 ;
int V_536 , V_542 , V_338 ;
F_19 ( L_3 , V_2 -> V_26 ) ;
if ( ! F_306 ( V_2 , V_350 ) )
return;
if ( ! F_4 ( V_2 , V_228 ) ) {
if ( ! V_2 -> V_287 && V_2 -> V_326 &&
F_315 ( V_201 , V_2 -> V_560 + V_561 * 45 ) )
F_307 ( V_2 , V_350 ) ;
}
V_542 = V_2 -> V_326 ? V_2 -> V_287 : V_2 -> V_285 ;
V_338 = V_542 ;
while ( V_542 && ( V_523 = F_309 ( V_2 , V_350 , & V_536 ) ) ) {
T_7 V_551 = ( F_310 ( & V_523 -> V_532 ) ) -> V_551 ;
while ( V_536 -- && ( V_12 = F_310 ( & V_523 -> V_532 ) ) ) {
F_19 ( L_58 , V_523 , V_12 ,
V_12 -> V_513 , V_12 -> V_551 ) ;
...
static void V_487 ( struct V_329 * V_330 )
{
...
{
struct V_519 * V_516 = ( void * ) V_12 -> V_180 ;
struct V_345 * V_264 ;
T_12 V_518 , V_16 ;
F_325 ( V_12 , V_520 ) ;
V_518 = F_200 ( V_516 -> V_518 ) ;
V_16 = F_326 ( V_518 ) ;
V_518 = F_327 ( V_518 ) ;
F_19 ( L_61 , V_2 -> V_26 , V_12 -> V_513 ,
V_518 , V_16 ) ;
V_2 -> V_288 . V_562 ++ ;
F_117 ( V_2 ) ;
V_264 = F_328 ( V_2 , V_518 ) ;
F_120 ( V_2 ) ;
if ( V_264 ) {
F_318 ( V_264 , V_563 ) ;
...
{
struct V_533 * V_516 = ( void * ) V_12 -> V_180 ;
struct V_345 * V_264 ;
T_12 V_518 ;
F_325 ( V_12 , V_534 ) ;
V_518 = F_200 ( V_516 -> V_518 ) ;
F_19 ( L_63 , V_2 -> V_26 , V_12 -> V_513 , V_518 ) ;
V_2 -> V_288 . V_564 ++ ;
F_117 ( V_2 ) ;
V_264 = F_328 ( V_2 , V_518 ) ;
F_120 ( V_2 ) ;
...
void F_336 ( struct V_1 * V_2 , T_6 V_25 , T_5 V_425 ,
T_14 * V_565 ,
T_15 * V_566 )
{
struct V_11 * V_12 ;
unsigned long V_16 ;
F_19 ( L_65 , V_25 , V_425 ) ;
if ( ! F_290 ( V_2 , V_25 ) ) {
...
if ( ! V_425 && ! F_332 ( V_2 ) )
return;
if ( F_273 ( V_2 -> V_254 ) -> V_41 . V_567 ) {
* V_565 = F_273 ( V_2 -> V_254 ) -> V_41 . V_567 ;
return;
}
if ( F_273 ( V_2 -> V_254 ) -> V_41 . V_568 ) {
* V_566 = F_273 ( V_2 -> V_254 ) -> V_41 . V_568 ;
return;
}
F_337 ( & V_2 -> V_251 . V_475 , V_16 ) ;
while ( ( V_12 = F_338 ( & V_2 -> V_251 ) ) ) {
if ( F_273 ( V_12 ) -> V_41 . V_515 ) {
F_339 ( & V_2 -> V_251 , V_12 ) ;
break;
}
* V_565 = F_273 ( V_12 ) -> V_41 . V_567 ;
* V_566 = F_273 ( V_12 ) -> V_41 . V_568 ;
F_16 ( V_12 ) ;
}
F_340 ( & V_2 -> V_251 . V_475 , V_16 ) ;
}
...
static void V_486 ( struct V_329 * V_330 )
{
