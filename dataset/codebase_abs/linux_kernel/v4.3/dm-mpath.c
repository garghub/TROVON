...
static int F_114 ( struct V_9 * V_10 , unsigned int V_173 ,
unsigned long V_174 )
{
struct V_18 * V_19 = V_10 -> V_31 ;
struct V_1 * V_1 ;
...
if ( V_1 ) {
V_70 = V_1 -> V_13 . V_14 -> V_70 ;
V_175 = V_1 -> V_13 . V_14 -> V_175 ;
}
if ( ( V_1 && V_19 -> V_23 ) || ( ! V_1 && V_19 -> V_60 ) )
V_67 = - V_176 ;
else if ( ! V_70 )
V_67 = - V_71 ;
F_50 ( & V_19 -> V_22 , V_83 ) ;
if ( ! V_70 || V_10 -> V_117 != F_115 ( V_70 -> V_177 ) >> V_178 ) {
int V_179 = F_116 ( NULL , V_173 ) ;
if ( V_179 )
V_67 = V_179 ;
}
if ( V_67 == - V_176 && ! F_117 ( V_129 ) ) {
F_49 ( & V_19 -> V_22 , V_83 ) ;
if ( ! V_19 -> V_46 ) {
F_34 ( V_19 , 0 ) ;
}
...
return V_67 ? : F_118 ( V_70 , V_175 , V_173 , V_174 ) ;
}
static int F_119 ( struct V_9 * V_10 ,
T_5 V_180 , void * V_145 )
{
struct V_18 * V_19 = V_10 -> V_31 ;
struct V_5 * V_6 ;
struct V_1 * V_97 ;
...
F_29 (pg, &m->priority_groups, list) {
F_29 (p, &pg->pgpaths, list) {
V_115 = V_180 ( V_10 , V_97 -> V_13 . V_14 , V_10 -> V_181 , V_10 -> V_117 , V_145 ) ;
if ( V_115 )
goto V_133;
}
}
...
if ( F_123 ( ! V_19 -> V_55 && V_19 -> V_59 ) )
V_6 = V_19 -> V_59 ;
else if ( F_124 ( V_19 -> V_46 ) )
V_6 = V_19 -> V_46 ;
else
goto V_133;
V_182 = 1 ;
