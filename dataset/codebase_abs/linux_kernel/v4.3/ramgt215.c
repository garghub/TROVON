...
static void
F_36 ( struct V_17 * V_18 , T_1 V_97 )
{
struct V_98 * V_99 = V_18 -> V_21 . V_22 -> V_20 . V_24 -> V_99 ;
struct V_100 V_53 ;
T_1 V_101 , V_102 , V_103 ;
int V_31 ;
if ( F_37 ( V_99 , 0 , 0x2e , V_104 ) != V_97 ) {
V_31 = F_38 ( V_99 , 0 , 0x2e , V_104 , & V_53 ) ;
if ( V_31 )
return;
F_39 ( V_53 . line , & V_101 , & V_102 ) ;
V_103 = F_13 ( V_18 , V_105 ) ;
if ( V_103 & ( 8 << V_102 ) )
V_97 = ! V_97 ;
F_14 ( V_18 , V_105 , ( 0x3 << V_102 ) , ( ( V_97 | 0x2 ) << V_102 ) ) ;
F_20 ( V_18 , 20000 ) ;
}
}
static int
F_40 ( struct V_106 * V_21 , T_1 V_49 )
{
...
F_4 ( V_15 ) ;
V_110 = F_41 ( V_26 , V_49 / 1000 , & V_34 , & V_35 , & V_36 , & V_37 ,
& V_108 -> V_26 ) ;
...
V_110 = F_44 ( V_26 , V_110 , V_34 , V_35 , V_36 , V_37 , V_109 ,
...
V_110 = F_45 ( V_26 , V_108 -> V_26 . V_121 ,
& V_34 , & V_35 , & V_36 , & V_37 ,
& V_108 -> V_26 ) ;
...
V_31 = F_46 ( V_24 -> V_28 , 0x12 , 0x4000 , V_49 , & V_95 ) ;
if ( V_31 < 0 ) {
F_42 ( V_20 , L_11 ) ;
return V_31 ;
}
F_29 ( V_15 , V_68 ) ;
V_31 = F_47 ( V_18 , V_15 -> V_21 . V_22 ) ;
if ( V_31 )
return V_31 ;
...
if ( V_18 -> V_125 . V_126 && V_108 -> V_26 . V_127 )
F_36 ( V_18 , 0 ) ;
F_15 ( V_18 , 0x1002d4 , 0x00000001 ) ;
...
F_20 ( V_18 , 2000 ) ;
if ( V_24 -> V_128 == 0xa3 && V_49 <= 500000 )
...
F_20 ( V_18 , 20000 ) ;
if ( V_108 -> V_26 . V_129 ) {
F_15 ( V_18 , 0x1005a0 , V_108 -> V_26 . V_130 << 16 |
V_108 -> V_26 . V_131 << 8 |
V_108 -> V_26 . V_131 ) ;
F_15 ( V_18 , 0x1005a4 , V_108 -> V_26 . V_132 << 8 |
V_108 -> V_26 . V_133 ) ;
F_15 ( V_18 , 0x10f804 , V_108 -> V_26 . V_134 << 20 |
V_108 -> V_26 . V_135 << 16 |
V_108 -> V_26 . V_136 |
0x80000000 ) ;
...
F_14 ( V_18 , 0x100200 , 0x00001000 , ! V_108 -> V_26 . V_137 << 12 ) ;
...
if ( V_108 -> V_26 . V_142 )
V_118 |= 0x00000100 ;
if ( V_108 -> V_26 . V_143 != 0xff ) {
V_117 &= ~ 0xf0000000 ;
V_117 |= V_108 -> V_26 . V_143 << 28 ;
}
if ( V_108 -> V_26 . V_124 )
V_114 &= ~ 0x04020000 ;
...
struct V_17 * V_18 = & V_15 -> V_18 ;
struct V_23 * V_24 = V_15 -> V_21 . V_22 -> V_20 . V_24 ;
bool V_145 = F_5 ( V_24 -> V_43 , L_1 , true ) ;
if ( V_145 ) {
...
int
F_57 ( struct V_146 * V_22 , struct V_106 * * V_147 )
{
struct V_98 * V_99 = V_22 -> V_20 . V_24 -> V_99 ;
struct V_100 V_53 ;
struct V_14 * V_15 ;
T_1 V_101 , V_148 ;
int V_31 , V_4 ;
if ( ! ( V_15 = F_58 ( sizeof( * V_15 ) , V_45 ) ) )
return - V_46 ;
* V_147 = & V_15 -> V_21 ;
V_31 = F_59 ( & V_149 , V_22 , & V_15 -> V_21 ) ;
if ( V_31 )
return V_31 ;
V_15 -> V_18 . V_150 = F_60 ( 0x001610 ) ;
V_15 -> V_18 . V_151 = F_60 ( 0x001700 ) ;
V_15 -> V_18 . V_152 = F_60 ( 0x002504 ) ;
V_15 -> V_18 . V_153 = F_60 ( 0x004000 ) ;
V_15 -> V_18 . V_154 = F_60 ( 0x004004 ) ;
V_15 -> V_18 . V_155 = F_60 ( 0x004018 ) ;
V_15 -> V_18 . V_156 = F_60 ( 0x004128 ) ;
V_15 -> V_18 . V_157 = F_60 ( 0x004168 ) ;
V_15 -> V_18 . V_158 = F_60 ( 0x100080 ) ;
V_15 -> V_18 . V_159 = F_60 ( 0x100200 ) ;
V_15 -> V_18 . V_160 = F_60 ( 0x100210 ) ;
for ( V_4 = 0 ; V_4 < 9 ; V_4 ++ )
V_15 -> V_18 . V_161 [ V_4 ] = F_60 ( 0x100220 + ( V_4 * 4 ) ) ;
V_15 -> V_18 . V_162 = F_60 ( 0x100264 ) ;
V_15 -> V_18 . V_163 = F_60 ( 0x1002d0 ) ;
V_15 -> V_18 . V_164 = F_60 ( 0x1002d4 ) ;
V_15 -> V_18 . V_165 = F_60 ( 0x1002dc ) ;
V_15 -> V_18 . V_166 = F_60 ( 0x10053c ) ;
V_15 -> V_18 . V_167 = F_60 ( 0x1005a0 ) ;
V_15 -> V_18 . V_168 = F_60 ( 0x1005a4 ) ;
V_15 -> V_18 . V_169 = F_60 ( 0x100700 ) ;
V_15 -> V_18 . V_170 = F_60 ( 0x100714 ) ;
V_15 -> V_18 . V_171 = F_60 ( 0x100718 ) ;
V_15 -> V_18 . V_172 = F_60 ( 0x10071c ) ;
V_15 -> V_18 . V_173 = F_60 ( 0x100720 ) ;
V_15 -> V_18 . V_174 = F_61 ( 0x100760 , 4 , V_15 -> V_21 . V_175 ) ;
V_15 -> V_18 . V_176 = F_61 ( 0x1007a0 , 4 , V_15 -> V_21 . V_175 ) ;
V_15 -> V_18 . V_177 = F_61 ( 0x1007e0 , 4 , V_15 -> V_21 . V_175 ) ;
V_15 -> V_18 . V_178 = F_61 ( 0x100da0 , 4 , V_15 -> V_21 . V_175 ) ;
V_15 -> V_18 . V_179 = F_60 ( 0x10f804 ) ;
V_15 -> V_18 . V_180 = F_61 ( 0x1110e0 , 4 , V_15 -> V_21 . V_175 ) ;
V_15 -> V_18 . V_181 = F_60 ( 0x111100 ) ;
V_15 -> V_18 . V_182 = F_60 ( 0x111104 ) ;
V_15 -> V_18 . V_183 = F_60 ( 0x1111e0 ) ;
V_15 -> V_18 . V_184 = F_60 ( 0x111400 ) ;
V_15 -> V_18 . V_185 = F_60 ( 0x611200 ) ;
if ( V_15 -> V_21 . V_186 > 1 ) {
V_15 -> V_18 . V_187 [ 0 ] = F_62 ( 0x1002c0 , 0x1002c8 ) ;
V_15 -> V_18 . V_187 [ 1 ] = F_62 ( 0x1002c4 , 0x1002cc ) ;
V_15 -> V_18 . V_187 [ 2 ] = F_62 ( 0x1002e0 , 0x1002e8 ) ;
V_15 -> V_18 . V_187 [ 3 ] = F_62 ( 0x1002e4 , 0x1002ec ) ;
} else {
V_15 -> V_18 . V_187 [ 0 ] = F_60 ( 0x1002c0 ) ;
V_15 -> V_18 . V_187 [ 1 ] = F_60 ( 0x1002c4 ) ;
V_15 -> V_18 . V_187 [ 2 ] = F_60 ( 0x1002e0 ) ;
V_15 -> V_18 . V_187 [ 3 ] = F_60 ( 0x1002e4 ) ;
}
V_31 = F_38 ( V_99 , 0 , 0x2e , V_104 , & V_53 ) ;
if ( V_31 == 0 ) {
F_39 ( V_53 . line , & V_101 , & V_148 ) ;
V_15 -> V_18 . V_125 = F_60 ( V_101 ) ;
}
return 0 ;
}
