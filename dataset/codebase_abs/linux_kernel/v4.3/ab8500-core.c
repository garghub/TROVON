...
L_28 ,
L_29 } ;
struct V_101 * V_102 = F_60 ( & V_98 -> V_5 ) ;
const struct V_103 * V_104 = F_61 ( V_98 ) ;
...
int V_24 ;
T_2 V_15 ;
V_1 = F_62 ( & V_98 -> V_5 , sizeof( * V_1 ) , V_109 ) ;
if ( ! V_1 )
return - V_110 ;
V_1 -> V_5 = & V_98 -> V_5 ;
V_108 = F_63 ( V_98 , V_111 , 0 ) ;
if ( ! V_108 ) {
F_3 ( & V_98 -> V_5 , L_30 ) ;
return - V_112 ;
}
V_1 -> V_60 = V_108 -> V_113 ;
V_1 -> V_17 = F_6 ;
V_1 -> V_14 = F_1 ;
V_1 -> V_20 = F_4 ;
F_64 ( & V_1 -> V_13 ) ;
...
V_1 -> V_6 = F_62 ( & V_98 -> V_5 , V_1 -> V_25 ,
V_109 ) ;
if ( ! V_1 -> V_6 )
return - V_110 ;
V_1 -> V_27 = F_62 ( & V_98 -> V_5 , V_1 -> V_25 ,
V_109 ) ;
if ( ! V_1 -> V_27 )
return - V_110 ;
V_4 = F_17 ( V_1 , V_83 ,
...
if ( V_15 ) {
for ( V_24 = 0 ; V_24 < F_67 ( V_99 ) ; V_24 ++ ) {
if ( V_15 & 1 )
F_68 ( L_34 , V_99 [ V_24 ] ) ;
V_15 = V_15 >> 1 ;
}
...
if ( V_15 ) {
for ( V_24 = 0 ; V_24 < F_67 ( V_100 ) ; V_24 ++ ) {
if ( V_15 & 1 )
F_68 ( L_38 , V_100 [ V_24 ] ) ;
V_15 = V_15 >> 1 ;
}
F_68 ( L_35 ) ;
} else {
...
if ( V_4 )
return V_4 ;
V_4 = F_70 ( & V_98 -> V_5 , V_1 -> V_60 , NULL ,
F_36 ,
V_135 | V_136 ,
L_40 , V_1 ) ;
if ( V_4 )
return V_4 ;
#ifdef F_71
V_137 [ 0 ] . V_113 = V_1 -> V_60 ;
V_137 [ 0 ] . V_138 = V_1 -> V_60 ;
#endif
if ( F_44 ( V_1 ) )
V_4 = F_72 ( V_1 -> V_5 , 0 , V_139 ,
F_67 ( V_139 ) , NULL ,
0 , V_1 -> V_53 ) ;
else if ( F_43 ( V_1 ) ) {
V_4 = F_72 ( V_1 -> V_5 , 0 , V_140 ,
F_67 ( V_140 ) , NULL ,
0 , V_1 -> V_53 ) ;
if ( V_4 )
return V_4 ;
if ( F_73 ( V_1 ) )
V_4 = F_72 ( V_1 -> V_5 , 0 , V_141 ,
F_67 ( V_141 ) , NULL ,
0 , V_1 -> V_53 ) ;
else
V_4 = F_72 ( V_1 -> V_5 , 0 , V_142 ,
F_67 ( V_142 ) , NULL ,
0 , V_1 -> V_53 ) ;
} else if ( F_45 ( V_1 ) )
...
V_1 -> V_10 >= V_147 ) || F_43 ( V_1 ) )
V_4 = F_74 ( & V_1 -> V_5 -> V_148 ,
& V_149 ) ;
else
V_4 = F_74 ( & V_1 -> V_5 -> V_148 ,
& V_150 ) ;
...
{
struct V_1 * V_1 = F_76 ( V_98 ) ;
if ( ( ( F_45 ( V_1 ) || F_44 ( V_1 ) ) &&
V_1 -> V_10 >= V_147 ) || F_43 ( V_1 ) )
F_77 ( & V_1 -> V_5 -> V_148 , & V_149 ) ;
else
F_77 ( & V_1 -> V_5 -> V_148 , & V_150 ) ;
if ( ( F_45 ( V_1 ) || F_44 ( V_1 ) ) &&
V_1 -> V_10 >= V_147 )
F_77 ( & V_1 -> V_5 -> V_148 , & V_151 ) ;
F_78 ( V_1 -> V_5 ) ;
return 0 ;
}
