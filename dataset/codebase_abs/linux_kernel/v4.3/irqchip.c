...
F_23 ( & V_7 -> V_37 , & V_35 -> V_45 [ V_7 -> V_4 ] ) ;
V_34 = 0 ;
V_43:
return V_34 ;
}
...
T_1 V_32 , V_49 , V_12 = 0 ;
int V_34 ;
for ( V_32 = 0 ; V_32 < V_46 ; ++ V_32 ) {
if ( V_39 [ V_32 ] . V_4 >= V_50 )
return - V_20 ;
V_12 = F_25 ( V_12 , V_39 [ V_32 ] . V_4 ) ;
}
V_12 += 1 ;
V_47 = F_26 ( sizeof( * V_47 ) + ( V_12 * sizeof( struct V_51 ) ) ,
V_52 ) ;
if ( ! V_47 )
return - V_53 ;
V_47 -> V_12 = V_12 ;
...
V_47 -> V_15 [ V_32 ] [ V_49 ] = - 1 ;
for ( V_32 = 0 ; V_32 < V_46 ; ++ V_32 ) {
struct V_2 * V_7 ;
V_34 = - V_53 ;
V_7 = F_26 ( sizeof( * V_7 ) , V_52 ) ;
if ( ! V_7 )
goto V_43;
V_34 = - V_20 ;
if ( V_39 -> V_19 ) {
