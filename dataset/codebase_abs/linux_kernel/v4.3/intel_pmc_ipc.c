...
V_14 = F_45 ( V_50 , & V_93 , sizeof( V_93 ) ) ;
if ( V_14 ) {
F_13 ( V_2 . V_21 , L_17 ) ;
goto V_79;
}
...
V_96 = V_105 ;
if ( ! F_52 ( V_68 -> V_72 , V_96 , V_50 -> V_106 ) ) {
F_13 ( & V_50 -> V_21 , L_26 ) ;
return - V_57 ;
}
V_95 = F_30 ( V_68 -> V_72 , V_96 ) ;
if ( ! V_95 ) {
F_13 ( & V_50 -> V_21 , L_27 ) ;
F_53 ( V_68 -> V_72 , V_96 ) ;
return - V_56 ;
...
V_14 = F_56 ( & V_50 -> V_21 . V_110 , & V_111 ) ;
if ( V_14 ) {
F_13 ( & V_50 -> V_21 , L_32 ,
V_14 ) ;
goto V_112;
...
V_104 ) ;
if ( V_68 )
F_53 ( V_68 -> V_72 , V_105 ) ;
return V_14 ;
}
static int F_57 ( struct V_66 * V_50 )
{
struct V_67 * V_68 ;
F_58 ( & V_50 -> V_21 . V_110 , & V_111 ) ;
F_31 ( V_2 . V_45 , & V_2 ) ;
F_47 ( V_2 . V_94 ) ;
F_47 ( V_2 . V_80 ) ;
F_35 ( V_2 . V_6 ) ;
