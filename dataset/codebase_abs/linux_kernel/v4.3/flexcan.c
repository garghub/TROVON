...
F_3 ( V_100 , & V_12 -> V_43 ) ;
for ( V_145 = V_56 ; V_145 < F_59 ( V_12 -> V_55 ) ; V_145 ++ ) {
F_3 ( V_161 ,
...
if ( V_33 )
goto V_177;
V_33 = F_63 ( V_27 -> V_117 , F_47 , V_178 , V_27 -> V_179 , V_27 ) ;
if ( V_33 )
goto V_180;
V_33 = F_57 ( V_27 ) ;
if ( V_33 )
...
static int F_70 ( struct V_26 * V_27 , enum V_184 V_185 )
{
int V_33 ;
switch ( V_185 ) {
case V_186 :
...
int V_33 , V_117 ;
T_1 V_199 = 0 ;
V_5 = F_77 ( & V_191 -> V_27 , L_13 ) ;
if ( F_78 ( V_5 ) == - V_200 )
return - V_200 ;
else if ( F_79 ( V_5 ) )
V_5 = NULL ;
if ( V_191 -> V_27 . V_201 )
F_80 ( V_191 -> V_27 . V_201 ,
L_14 , & V_199 ) ;
if ( ! V_199 ) {
V_34 = F_81 ( & V_191 -> V_27 , L_15 ) ;
if ( F_79 ( V_34 ) ) {
F_82 ( & V_191 -> V_27 , L_16 ) ;
return F_78 ( V_34 ) ;
}
V_35 = F_81 ( & V_191 -> V_27 , L_17 ) ;
if ( F_79 ( V_35 ) ) {
F_82 ( & V_191 -> V_27 , L_18 ) ;
return F_78 ( V_35 ) ;
}
V_199 = F_83 ( V_35 ) ;
}
V_197 = F_84 ( V_191 , V_202 , 0 ) ;
V_117 = F_85 ( V_191 , 0 ) ;
if ( V_117 <= 0 )
return - V_189 ;
V_13 = F_86 ( & V_191 -> V_27 , V_197 ) ;
if ( F_79 ( V_13 ) )
return F_78 ( V_13 ) ;
V_193 = F_87 ( V_203 , & V_191 -> V_27 ) ;
if ( V_193 ) {
V_157 = V_193 -> V_41 ;
} else if ( F_88 ( V_191 ) -> V_204 ) {
V_157 = (struct V_194 * )
F_88 ( V_191 ) -> V_204 ;
} else {
return - V_189 ;
...
V_4 -> V_34 = V_34 ;
V_4 -> V_35 = V_35 ;
V_4 -> V_216 = F_90 ( & V_191 -> V_27 ) ;
V_4 -> V_157 = V_157 ;
V_4 -> V_5 = V_5 ;
F_91 ( V_27 , & V_4 -> V_109 , F_45 , V_217 ) ;
F_92 ( V_191 , V_27 ) ;
F_93 ( V_27 , & V_191 -> V_27 ) ;
V_33 = F_71 ( V_27 ) ;
if ( V_33 ) {
F_82 ( & V_191 -> V_27 , L_19 ) ;
goto V_218;
}
F_94 ( V_27 ) ;
F_95 ( & V_191 -> V_27 , L_20 ,
V_4 -> V_13 , V_27 -> V_117 ) ;
return 0 ;
V_218:
F_96 ( V_27 ) ;
...
static int T_4 F_100 ( struct V_219 * V_219 )
{
struct V_26 * V_27 = F_101 ( V_219 ) ;
struct V_3 * V_4 = F_19 ( V_27 ) ;
int V_33 ;
V_33 = F_14 ( V_4 ) ;
if ( V_33 )
...
static int T_4 F_104 ( struct V_219 * V_219 )
{
struct V_26 * V_27 = F_101 ( V_219 ) ;
struct V_3 * V_4 = F_19 ( V_27 ) ;
V_4 -> V_7 . V_97 = V_92 ;
