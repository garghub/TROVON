...
V_193 , V_185 -> V_192 ) ;
memcpy ( ( void T_5 * ) V_193 , ( void * ) V_159 -> V_16 + V_185 -> V_189 ,
V_185 -> V_191 ) ;
memset ( ( void T_5 * ) V_193 + V_185 -> V_191 , 0 ,
V_185 -> V_192 - V_185 -> V_191 ) ;
}
static int F_105 ( const struct V_158 * V_159 , void * V_194 )
{
struct V_2 * V_3 = V_194 ;
V_173 * V_161 ;
T_4 * V_185 ;
T_1 T_5 * V_193 ;
int V_195 = 0 , V_74 ;
...
static void F_107 ( const struct V_158 * V_159 , void * V_194 )
{
struct V_2 * V_3 = V_194 ;
int V_195 ;
...
V_195 = F_99 ( V_3 ) ;
if ( V_195 ) {
F_15 ( V_3 -> V_27 , L_78 , V_195 ) ;
goto V_195;
}
F_13 ( 0x1 , V_3 -> V_56 + V_203 ) ;
F_39 ( V_3 -> V_27 , L_79 ) ;
...
F_48 ( & V_3 -> V_156 ) ;
F_108 ( & V_3 -> V_51 , 0 ) ;
V_195 = F_110 ( V_204 , V_205 ,
V_163 , V_3 -> V_27 , V_104 , V_3 ,
F_107 ) ;
if ( V_195 ) {
F_15 ( V_3 -> V_27 , L_81 , V_195 ) ;
F_109 ( & V_3 -> V_156 ) ;
return V_195 ;
}
return 0 ;
