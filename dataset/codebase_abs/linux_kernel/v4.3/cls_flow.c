...
T_3 V_33 = V_5 -> V_9 -> V_31 -> V_32 -> V_34 -> V_35 ;
...
{
if ( V_5 -> V_9 && V_5 -> V_9 -> V_31 && V_5 -> V_9 -> V_31 -> V_32 ) {
T_4 V_37 = V_5 -> V_9 -> V_31 -> V_32 -> V_34 -> V_38 ;
...
static T_1 F_34 ( struct V_4 * V_5 , int V_42 , struct V_6 * V_7 )
{
switch ( V_42 ) {
case V_43 :
return F_2 ( V_5 , V_7 ) ;
...
static int F_36 ( struct V_4 * V_5 , const struct V_61 * V_62 ,
struct V_63 * V_64 )
{
struct V_65 * V_66 = F_37 ( V_62 -> V_67 ) ;
struct V_68 * V_69 ;
T_1 V_70 ;
T_1 V_71 ;
...
V_42 = F_41 ( V_70 ) - 1 ;
V_70 &= ~ ( 1 << V_42 ) ;
V_74 [ V_72 ] = F_34 ( V_5 , V_42 , & V_6 ) ;
}
if ( V_69 -> V_79 == V_80 )
V_71 = F_42 ( V_74 , V_69 -> V_78 , V_69 -> V_81 ) ;
else {
V_71 = V_74 [ 0 ] ;
...
V_71 %= V_69 -> V_86 ;
V_64 -> V_87 = 0 ;
V_64 -> V_71 = F_43 ( V_69 -> V_88 , V_69 -> V_88 + V_71 ) ;
V_73 = F_44 ( V_5 , & V_69 -> V_89 , V_64 ) ;
if ( V_73 < 0 )
continue;
return V_73 ;
}
...
F_46 ( & V_69 -> V_81 , 4 ) ;
if ( V_69 -> V_91 )
F_47 ( & V_69 -> V_92 , V_93 + V_69 -> V_91 ) ;
}
static void F_48 ( struct V_94 * V_66 )
{
struct V_68 * V_69 = F_49 ( V_66 , struct V_68 , V_95 ) ;
F_50 ( & V_69 -> V_92 ) ;
F_51 ( & V_69 -> V_89 ) ;
F_52 ( & V_69 -> V_76 ) ;
F_53 ( V_69 ) ;
}
static int F_54 ( struct V_96 * V_96 , struct V_4 * V_97 ,
struct V_61 * V_62 , unsigned long V_98 ,
T_1 V_99 , struct V_100 * * V_101 ,
unsigned long * V_90 , bool V_102 )
{
struct V_65 * V_66 = F_55 ( V_62 -> V_67 ) ;
...
if ( V_105 == NULL )
return - V_114 ;
V_113 = F_56 ( V_107 , V_108 , V_105 , V_115 ) ;
if ( V_113 < 0 )
return V_113 ;
if ( V_107 [ V_116 ] ) {
V_88 = F_57 ( V_107 [ V_116 ] ) ;
if ( F_58 ( V_88 ) == 0 )
return - V_114 ;
}
if ( V_107 [ V_117 ] ) {
V_70 = F_57 ( V_107 [ V_117 ] ) ;
V_78 = F_59 ( V_70 ) ;
if ( V_78 == 0 )
return - V_114 ;
if ( F_60 ( V_70 ) - 1 > V_75 )
return - V_118 ;
if ( ( V_70 & ( V_57 | V_58 ) ) &&
F_61 ( F_62 ( V_97 ) . V_9 ) != & V_36 )
return - V_118 ;
}
F_63 ( & V_110 , V_119 , V_120 ) ;
V_113 = F_64 ( V_96 , V_62 , V_107 , V_101 [ V_121 ] , & V_110 , V_102 ) ;
if ( V_113 < 0 )
return V_113 ;
V_113 = F_65 ( V_62 , V_107 [ V_122 ] , & V_112 ) ;
if ( V_113 < 0 )
goto V_123;
V_113 = - V_124 ;
V_104 = F_66 ( sizeof( * V_104 ) , V_125 ) ;
if ( ! V_104 )
goto V_126;
F_63 ( & V_104 -> V_89 , V_119 , V_120 ) ;
...
if ( F_67 ( V_88 ) == 0 )
V_88 = F_43 ( V_62 -> V_131 -> V_99 , V_88 ) ;
if ( F_58 ( V_88 ) == 0 )
V_88 = F_43 ( V_88 , 1 ) ;
V_104 -> V_99 = V_99 ;
V_104 -> V_82 = ~ 0U ;
...
V_104 -> V_92 . V_132 = F_45 ;
V_104 -> V_92 . V_133 = ( unsigned long ) V_104 ;
F_68 ( & V_104 -> V_92 ) ;
F_69 ( V_62 , & V_104 -> V_89 , & V_110 ) ;
F_70 ( V_62 , & V_104 -> V_76 , & V_112 ) ;
F_71 ( F_72 ( V_62 -> V_131 ) ) ;
if ( V_107 [ V_117 ] ) {
V_104 -> V_70 = V_70 ;
V_104 -> V_78 = V_78 ;
}
V_104 -> V_79 = V_79 ;
if ( V_107 [ V_134 ] )
V_104 -> V_82 = F_57 ( V_107 [ V_134 ] ) ;
if ( V_107 [ V_135 ] )
V_104 -> V_83 = F_57 ( V_107 [ V_135 ] ) ;
if ( V_107 [ V_136 ] )
V_104 -> V_84 = F_57 ( V_107 [ V_136 ] ) ;
if ( V_107 [ V_137 ] )
V_104 -> V_85 = F_57 ( V_107 [ V_137 ] ) ;
if ( V_107 [ V_138 ] )
V_104 -> V_86 = F_57 ( V_107 [ V_138 ] ) ;
if ( V_88 )
V_104 -> V_88 = V_88 ;
V_104 -> V_91 = V_91 ;
if ( V_91 )
F_47 ( & V_104 -> V_92 , V_93 + V_91 ) ;
if ( * V_90 == 0 )
F_73 ( & V_104 -> V_139 , & V_66 -> V_140 ) ;
else
F_74 ( & V_103 -> V_139 , & V_104 -> V_139 ) ;
* V_90 = ( unsigned long ) V_104 ;
if ( V_103 )
F_75 ( & V_103 -> V_95 , F_48 ) ;
return 0 ;
V_126:
F_52 ( & V_112 ) ;
F_53 ( V_104 ) ;
...
static int F_76 ( struct V_61 * V_62 , unsigned long V_90 )
{
struct V_68 * V_69 = (struct V_68 * ) V_90 ;
F_77 ( & V_69 -> V_139 ) ;
F_75 ( & V_69 -> V_95 , F_48 ) ;
...
static bool F_81 ( struct V_61 * V_62 , bool V_141 )
{
struct V_65 * V_66 = F_55 ( V_62 -> V_67 ) ;
struct V_68 * V_69 , * V_142 ;
if ( ! V_141 && ! F_82 ( & V_66 -> V_140 ) )
return false ;
F_83 (f, next, &head->filters, list) {
F_77 ( & V_69 -> V_139 ) ;
F_75 ( & V_69 -> V_95 , F_48 ) ;
}
F_84 ( V_62 -> V_67 , NULL ) ;
...
static int F_88 ( struct V_96 * V_96 , struct V_61 * V_62 , unsigned long V_143 ,
...
V_145 = F_89 ( V_5 , V_106 ) ;
if ( V_145 == NULL )
goto V_148;
if ( F_90 ( V_5 , V_117 , V_69 -> V_70 ) ||
F_90 ( V_5 , V_127 , V_69 -> V_79 ) )
goto V_148;
if ( V_69 -> V_82 != ~ 0 || V_69 -> V_83 != 0 ) {
if ( F_90 ( V_5 , V_134 , V_69 -> V_82 ) ||
F_90 ( V_5 , V_135 , V_69 -> V_83 ) )
goto V_148;
}
if ( V_69 -> V_84 &&
F_90 ( V_5 , V_136 , V_69 -> V_84 ) )
goto V_148;
if ( V_69 -> V_85 &&
F_90 ( V_5 , V_137 , V_69 -> V_85 ) )
goto V_148;
if ( V_69 -> V_86 &&
F_90 ( V_5 , V_138 , V_69 -> V_86 ) )
goto V_148;
if ( V_69 -> V_88 &&
F_90 ( V_5 , V_116 , V_69 -> V_88 ) )
goto V_148;
if ( V_69 -> V_91 &&
F_90 ( V_5 , V_128 , V_69 -> V_91 / V_129 ) )
goto V_148;
if ( F_91 ( V_5 , & V_69 -> V_89 ) < 0 )
goto V_148;
#ifdef F_92
if ( V_69 -> V_76 . V_149 . V_150 &&
F_93 ( V_5 , & V_69 -> V_76 , V_122 ) < 0 )
goto V_148;
#endif
F_94 ( V_5 , V_145 ) ;
...
static void F_97 ( struct V_61 * V_62 , struct V_151 * V_90 )
{
struct V_65 * V_66 = F_55 ( V_62 -> V_67 ) ;
struct V_68 * V_69 ;
F_87 (f, &head->filters, list) {
