...
struct V_5 * V_6 = F_89 ( & V_10 -> V_104 ,
struct V_5 , V_105 ) ;
F_90 () ;
V_106:
F_67 () ;
F_91 (wb, &bdi->wb_list, bdi_node) {
F_92 ( V_107 ) ;
struct V_21 V_108 ;
struct V_21 * V_22 ;
long V_96 ;
...
{
F_90 () ;
if ( ! V_102 || ! F_93 ( & V_10 -> V_6 ) ) {
V_101 -> V_111 = 0 ;
F_22 ( & V_10 -> V_6 , V_101 ) ;
}
}
void F_95 ( struct V_5 * V_6 , long V_96 ,
...
static void F_100 ( struct V_1 * V_1 , struct V_5 * V_6 )
{
if ( ! F_9 ( & V_6 -> V_12 ) ) {
struct V_1 * V_115 ;
V_115 = F_1 ( V_6 -> V_12 . V_116 ) ;
if ( F_101 ( V_1 -> V_59 , V_115 -> V_59 ) )
V_1 -> V_59 = V_117 ;
}
F_12 ( V_1 , V_6 , & V_6 -> V_12 ) ;
}
static void F_102 ( struct V_1 * V_1 , struct V_5 * V_6 )
{
...
F_104 ( V_1 ) ;
F_105 () ;
F_106 ( & V_1 -> V_53 , V_119 ) ;
}
static bool F_107 ( struct V_1 * V_1 , unsigned long V_120 )
{
bool V_121 = F_108 ( V_1 -> V_59 , V_120 ) ;
#ifndef F_109
V_121 = V_121 && F_110 ( V_1 -> V_59 , V_117 ) ;
#endif
return V_121 ;
}
static int F_111 ( struct V_2 * V_122 ,
struct V_2 * V_123 ,
int V_124 ,
struct V_21 * V_22 )
{
...
static void F_116 ( struct V_5 * V_6 , struct V_21 * V_22 )
{
int V_132 ;
F_13 ( & V_6 -> V_15 ) ;
F_117 ( & V_6 -> V_14 , & V_6 -> V_13 ) ;
V_132 = F_111 ( & V_6 -> V_12 , & V_6 -> V_13 , 0 , V_22 ) ;
V_132 += F_111 ( & V_6 -> V_16 , & V_6 -> V_13 ,
V_133 , V_22 ) ;
if ( V_132 )
F_3 ( V_6 ) ;
F_118 ( V_6 , V_22 , V_132 ) ;
}
static int F_119 ( struct V_1 * V_1 , struct V_69 * V_70 )
{
int V_121 ;
if ( V_1 -> V_138 -> V_140 -> F_119 && ! F_120 ( V_1 ) ) {
F_121 ( V_1 , V_70 ) ;
V_121 = V_1 -> V_138 -> V_140 -> F_119 ( V_1 , V_70 ) ;
F_122 ( V_1 , V_70 ) ;
return V_121 ;
}
return 0 ;
...
__acquires( V_1 -> V_51 )
{
F_124 ( V_141 , & V_1 -> V_53 , V_119 ) ;
T_3 * V_142 ;
V_142 = F_125 ( & V_1 -> V_53 , V_119 ) ;
while ( V_1 -> V_53 & V_118 ) {
F_59 ( & V_1 -> V_51 ) ;
F_126 ( V_142 , & V_141 , V_143 ,
V_144 ) ;
F_44 ( & V_1 -> V_51 ) ;
}
}
...
{
F_129 ( V_145 ) ;
T_3 * V_142 = F_125 ( & V_1 -> V_53 , V_119 ) ;
int V_146 ;
F_130 ( V_142 , & V_145 , V_144 ) ;
...
static void F_133 ( struct V_1 * V_1 , struct V_5 * V_6 ,
struct V_69 * V_70 )
{
if ( V_1 -> V_53 & V_54 )
return;
...
static int
F_135 ( struct V_1 * V_1 , struct V_69 * V_70 )
{
struct V_41 * V_42 = V_1 -> V_43 ;
long V_152 = V_70 -> V_152 ;
unsigned V_154 ;
int V_121 ;
F_136 ( ! ( V_1 -> V_53 & V_118 ) ) ;
F_137 ( V_1 , V_70 , V_152 ) ;
V_121 = F_138 ( V_42 , V_70 ) ;
if ( V_70 -> V_109 == V_148 && ! V_70 -> V_134 ) {
int V_155 = F_139 ( V_42 ) ;
if ( V_121 == 0 )
V_121 = V_155 ;
}
F_44 ( & V_1 -> V_51 ) ;
...
F_141 ( V_1 ) ;
if ( V_154 & ~ V_160 ) {
int V_155 = F_119 ( V_1 , V_70 ) ;
if ( V_121 == 0 )
V_121 = V_155 ;
}
F_142 ( V_1 , V_70 , V_152 ) ;
return V_121 ;
}
static int
F_143 ( struct V_1 * V_1 , struct V_5 * V_6 ,
struct V_69 * V_70 )
{
int V_121 = 0 ;
F_44 ( & V_1 -> V_51 ) ;
if ( ! F_29 ( & V_1 -> V_161 ) )
F_136 ( ! ( V_1 -> V_53 & ( V_162 | V_54 ) ) ) ;
else
F_136 ( V_1 -> V_53 & V_162 ) ;
if ( V_1 -> V_53 & V_118 ) {
if ( V_70 -> V_109 != V_148 )
goto V_139;
F_123 ( V_1 ) ;
...
if ( ! ( V_1 -> V_53 & V_163 ) &&
( V_70 -> V_109 != V_148 ||
! F_134 ( V_1 -> V_43 , V_164 ) ) )
goto V_139;
V_1 -> V_53 |= V_118 ;
F_73 ( V_70 , V_1 ) ;
V_121 = F_135 ( V_1 , V_70 ) ;
F_75 ( V_70 ) ;
F_44 ( & V_6 -> V_15 ) ;
F_44 ( & V_1 -> V_51 ) ;
if ( ! ( V_1 -> V_53 & V_163 ) )
...
static long F_144 ( struct V_5 * V_6 ,
struct V_21 * V_22 )
{
long V_165 ;
...
V_165 = F_145 ( V_165 + V_169 ,
V_169 ) ;
}
return V_165 ;
}
static long F_146 ( struct V_129 * V_130 ,
struct V_5 * V_6 ,
struct V_21 * V_22 )
{
struct V_69 V_70 = {
...
static long F_152 ( struct V_5 * V_6 ,
struct V_21 * V_22 )
{
unsigned long V_175 = V_117 ;
long V_177 = 0 ;
...
static long F_155 ( struct V_5 * V_6 , long V_96 ,
enum V_113 V_114 )
{
struct V_21 V_22 = {
. V_96 = V_96 ,
...
static long F_158 ( struct V_5 * V_6 ,
struct V_21 * V_22 )
{
...
F_116 ( V_6 , V_22 ) ;
if ( V_22 -> V_130 )
V_184 = F_146 ( V_22 -> V_130 , V_6 , V_22 ) ;
else
V_184 = F_152 ( V_6 , V_22 ) ;
F_162 ( V_6 , V_22 ) ;
F_163 ( V_6 , V_182 ) ;
if ( V_184 )
continue;
...
static struct V_21 * F_165 ( struct V_5 * V_6 )
{
...
long V_177 = 0 ;
F_5 ( V_193 , & V_6 -> V_8 ) ;
while ( ( V_22 = F_165 ( V_6 ) ) != NULL ) {
struct V_29 * V_24 = V_22 -> V_24 ;
F_172 ( V_6 , V_22 ) ;
V_177 += F_158 ( V_6 , V_22 ) ;
if ( V_22 -> V_111 )
F_61 ( V_22 ) ;
if ( V_24 && F_173 ( & V_24 -> V_25 ) )
F_174 ( & V_6 -> V_10 -> V_30 ) ;
}
V_177 += F_170 ( V_6 ) ;
V_177 += F_169 ( V_6 ) ;
...
void F_175 ( struct V_38 * V_22 )
{
struct V_5 * V_6 = F_43 ( F_176 ( V_22 ) ,
struct V_5 , V_20 ) ;
long V_194 ;
F_177 ( L_1 , F_178 ( V_6 -> V_10 -> V_195 ) ) ;
V_35 -> V_124 |= V_196 ;
if ( F_49 ( ! F_179 () ||
! F_19 ( V_18 , & V_6 -> V_8 ) ) ) {
do {
...
void F_182 ( long V_96 , enum V_113 V_114 )
{
struct V_28 * V_10 ;
if ( ! V_96 )
V_96 = F_166 () ;
F_67 () ;
F_183 (bdi, &bdi_list, bdi_list) {
struct V_5 * V_6 ;
if ( ! F_184 ( V_10 ) )
continue;
F_183 (wb, &bdi->wb_list, bdi_node)
F_95 ( V_6 , F_85 ( V_6 , V_96 ) ,
false , V_114 ) ;
}
F_69 () ;
}
static void F_185 ( struct V_38 * V_198 )
{
struct V_28 * V_10 ;
F_67 () ;
F_183 (bdi, &bdi_list, bdi_list) {
...
int F_188 ( struct V_200 * V_201 , int V_202 ,
void T_5 * V_203 , T_2 * V_204 , T_6 * V_205 )
{
int V_121 ;
V_121 = F_189 ( V_201 , V_202 , V_203 , V_204 , V_205 ) ;
if ( V_121 == 0 && V_202 )
F_20 ( V_206 , & V_199 , 0 ) ;
return V_121 ;
}
static T_7 void F_190 ( struct V_1 * V_1 )
{
...
F_192 ( V_213
L_4 ,
V_35 -> V_214 , F_193 ( V_35 ) , V_1 -> V_207 ,
...
void F_195 ( struct V_1 * V_1 , int V_124 )
{
struct V_129 * V_130 = V_1 -> V_138 ;
int V_215 ;
F_196 ( V_1 , V_124 ) ;
...
( V_215 && ( V_1 -> V_53 & V_217 ) ) )
return;
if ( F_37 ( V_218 ) )
F_190 ( V_1 ) ;
F_44 ( & V_1 -> V_51 ) ;
if ( V_215 && ( V_1 -> V_53 & V_217 ) )
goto V_219;
if ( ( V_1 -> V_53 & V_124 ) != V_124 ) {
const int V_220 = V_1 -> V_53 & V_147 ;
F_199 ( V_1 , NULL ) ;
if ( V_124 & V_217 )
V_1 -> V_53 &= ~ V_153 ;
V_1 -> V_53 |= V_124 ;
...
{
struct V_1 * V_1 , * V_224 = NULL ;
F_136 ( ! F_206 ( & V_130 -> V_179 ) ) ;
F_207 ( & V_130 -> V_225 ) ;
F_44 ( & V_130 -> V_226 ) ;
...
static void F_210 ( struct V_129 * V_130 , unsigned long V_228 ,
...
struct V_28 * V_10 = V_130 -> V_229 ;
if ( ! F_184 ( V_10 ) || V_10 == & V_230 )
return;
F_136 ( ! F_206 ( & V_130 -> V_179 ) ) ;
F_88 ( V_130 -> V_229 , & V_22 , V_102 ) ;
F_26 ( V_10 , & V_24 ) ;
}
void F_211 ( struct V_129 * V_130 ,
unsigned long V_228 ,
enum V_113 V_114 )
{
F_210 ( V_130 , V_228 , V_114 , false ) ;
}
void F_212 ( struct V_129 * V_130 , enum V_113 V_114 )
{
return F_211 ( V_130 , F_166 () , V_114 ) ;
}
bool F_213 ( struct V_129 * V_130 , unsigned long V_228 ,
enum V_113 V_114 )
{
if ( ! F_214 ( & V_130 -> V_179 ) )
return false ;
F_210 ( V_130 , V_228 , V_114 , true ) ;
F_154 ( & V_130 -> V_179 ) ;
return true ;
}
bool F_215 ( struct V_129 * V_130 , enum V_113 V_114 )
{
return F_213 ( V_130 , F_166 () , V_114 ) ;
}
void F_216 ( struct V_129 * V_130 )
{
F_92 ( V_24 ) ;
struct V_21 V_22 = {
. V_130 = V_130 ,
...
int F_217 ( struct V_1 * V_1 , int V_232 )
{
struct V_5 * V_6 = & F_31 ( V_1 ) -> V_6 ;
struct V_69 V_70 = {
. V_152 = V_99 ,
. V_109 = V_232 ? V_148 : V_110 ,
. V_172 = 0 ,
. V_173 = V_174 ,
} ;
if ( ! F_218 ( V_1 -> V_43 ) )
V_70 . V_152 = 0 ;
F_90 () ;
return F_143 ( V_1 , V_6 , & V_70 ) ;
}
int F_219 ( struct V_1 * V_1 , struct V_69 * V_70 )
{
return F_143 ( V_1 , & F_31 ( V_1 ) -> V_6 , V_70 ) ;
}
int F_220 ( struct V_1 * V_1 , int V_145 )
{
struct V_69 V_70 = {
. V_109 = V_145 ? V_148 : V_110 ,
. V_152 = 0 ,
} ;
return F_219 ( V_1 , & V_70 ) ;
}
