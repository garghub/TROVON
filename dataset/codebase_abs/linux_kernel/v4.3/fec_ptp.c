...
static int F_26 ( struct V_61 * V_62 , struct V_77 * V_9 )
{
struct V_1 * V_78 =
F_13 ( V_62 , struct V_1 , V_72 ) ;
T_3 V_10 ;
...
V_10 = F_31 ( V_9 ) ;
V_79 = V_10 & V_2 -> V_34 . V_35 ;
F_3 ( & V_2 -> V_23 , V_4 ) ;
F_4 ( V_79 , V_2 -> V_25 + V_30 ) ;
...
struct V_1 * V_2 = F_17 ( V_49 ) ;
struct V_90 V_91 ;
if ( F_34 ( & V_91 , V_89 -> V_92 , sizeof( V_91 ) ) )
return - V_93 ;
if ( V_91 . V_4 )
return - V_16 ;
switch ( V_91 . V_94 ) {
...
return F_35 ( V_89 -> V_92 , & V_91 , sizeof( V_91 ) ) ?
- V_93 : 0 ;
}
int F_36 ( struct V_48 * V_49 , struct V_88 * V_89 )
{
struct V_1 * V_2 = F_17 ( V_49 ) ;
struct V_90 V_91 ;
V_91 . V_4 = 0 ;
...
void F_40 ( struct V_107 * V_14 )
{
struct V_48 * V_49 = F_41 ( V_14 ) ;
struct V_1 * V_2 = F_17 ( V_49 ) ;
...
V_2 -> V_72 . V_120 = F_28 ;
V_2 -> V_72 . V_3 = F_32 ;
V_2 -> V_50 = F_42 ( V_2 -> V_121 ) ;
V_2 -> V_22 = V_33 / V_2 -> V_50 ;
F_43 ( & V_2 -> V_23 ) ;
F_16 ( V_49 ) ;
F_44 ( & V_2 -> V_105 , F_37 ) ;
V_2 -> V_122 = F_45 ( & V_2 -> V_72 , & V_14 -> V_15 ) ;
if ( F_46 ( V_2 -> V_122 ) ) {
V_2 -> V_122 = NULL ;
F_47 ( L_3 ) ;
}
