...
V_129 -> V_27 . V_22 |= V_203 ;
if ( ! V_141 && ( F_116 () & V_204 ) ) {
V_129 -> V_152 . V_22 |= V_188 ;
break;
}
default:
if ( V_141 || V_129 -> V_152 . V_28 > V_39 )
V_129 -> V_152 . V_22 |= V_203 ;
}
switch ( F_30 () ) {
case V_183 :
V_129 -> V_27 . V_22 |= V_178 ;
...
V_207 [ V_129 -> V_27 . V_32 ] , V_129 -> V_27 . V_149 ) ;
F_117 ( L_8 ,
V_116 >> 10 , V_207 [ V_129 -> V_152 . V_32 ] ,
...
{
unsigned long V_22 , V_3 , V_208 , V_25 , V_209 ;
unsigned int V_139 = F_110 () ;
struct V_128 * V_129 = & V_26 ;
if ( V_139 & V_182 )
return 0 ;
V_208 = ( unsigned long ) & V_210 ;
V_208 &= ~ ( ( 4 * 1024 * 1024 ) - 1 ) ;
V_25 = V_208 + ( 4 * 1024 * 1024 ) ;
F_20 ( V_22 ) ;
V_209 = ( 64 * 1024 ) ;
for ( V_3 = V_208 ; V_3 < V_25 ; V_3 = ( V_208 + V_209 ) ) {
unsigned long * V_211 = ( unsigned long * ) V_3 ;
...
F_119 ( V_214 , V_208 ) ;
V_209 = ( 128 * 1024 ) ;
for ( V_3 = V_208 + ( 128 * 1024 ) ; V_3 < V_25 ; V_3 = V_208 + V_209 ) {
F_119 ( V_215 , V_3 ) ;
__asm__ __volatile__("nop; nop; nop; nop;");
if ( ! F_120 () )
break;
...
V_3 -= V_208 ;
V_64 = V_3 ;
V_129 -> V_216 . V_149 = 16 << ( ( V_139 & V_217 ) >> 22 ) ;
V_129 -> V_216 . V_32 = 1 ;
V_129 -> V_216 . V_30 = 0 ;
return 1 ;
}
...
struct V_128 * V_129 = & V_26 ;
V_64 = 512 * 1024 ;
V_129 -> V_216 . V_149 = 32 ;
V_129 -> V_216 . V_32 = 4 ;
V_129 -> V_216 . V_30 = 0 ;
V_129 -> V_216 . V_28 = V_64 / ( V_129 -> V_216 . V_32 ) ;
V_129 -> V_216 . V_176 = V_64 / ( V_129 -> V_216 . V_149 * V_129 -> V_216 . V_32 ) ;
F_122 ( L_12 ,
V_64 >> 10 , V_207 [ V_129 -> V_216 . V_32 ] , V_129 -> V_216 . V_149 ) ;
V_129 -> V_154 |= V_218 ;
}
static void T_5 F_123 ( void )
{
struct V_128 * V_129 = & V_26 ;
unsigned int V_219 , V_143 ;
V_219 = F_124 () ;
V_143 = ( V_219 >> 4 ) & 15 ;
if ( V_143 )
V_129 -> V_216 . V_149 = 2 << V_143 ;
else
V_129 -> V_216 . V_149 = 0 ;
V_129 -> V_216 . V_176 = 64 << ( ( V_219 >> 8 ) & 15 ) ;
V_129 -> V_216 . V_32 = 1 + ( V_219 & 15 ) ;
V_64 = V_129 -> V_216 . V_176 *
V_129 -> V_216 . V_32 *
V_129 -> V_216 . V_149 ;
V_64 *= 4 ;
V_129 -> V_216 . V_30 = 0 ;
...
case V_87 :
case V_88 :
V_64 = 0x80000 << ( ( V_139 & V_222 ) >> 16 ) ;
V_129 -> V_216 . V_149 = 64 << ( ( V_139 >> 13 ) & 1 ) ;
V_129 -> V_216 . V_32 = 2 ;
V_129 -> V_216 . V_30 = 0 ;
V_220 = 1 ;
break;
...
return;
default:
if ( V_129 -> V_224 & ( V_225 | V_226 |
V_227 | V_228 |
V_229 | V_230 ) ) {
#ifdef F_131
if ( F_132 () ) {
V_64 = V_129 -> V_216 . V_32 * V_129 -> V_216 . V_176 * V_129 -> V_216 . V_149 ;
F_117 ( L_13 ,
V_64 >> 10 ,
V_207 [ V_129 -> V_216 . V_32 ] , V_129 -> V_216 . V_149 ) ;
}
#else
if ( ! ( V_129 -> V_216 . V_22 & V_231 ) )
F_115 ( L_14 ) ;
#endif
return;
}
...
static int T_5 F_137 ( char * V_235 )
{
F_138 ( & V_235 , & V_236 ) ;
return 0 ;
}
...
extern char __weak V_241 ;
switch ( F_30 () ) {
case V_185 :
case V_186 :
F_144 ( 0x100 , & V_241 , 0x80 ) ;
break;
default:
...
V_257 = ( void * ) F_108 ;
V_258 = ( void * ) F_108 ;
V_26 . V_152 . V_22 &= ~ V_203 ;
V_26 . V_154 |= V_218 ;
break;
}
}
static int F_148 ( struct V_269 * V_270 , unsigned long V_271 ,
void * V_272 )
{
switch ( V_271 ) {
case V_273 :
