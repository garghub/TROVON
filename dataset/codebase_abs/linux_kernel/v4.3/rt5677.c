...
static int F_49 ( struct V_381 * V_382 ,
...
V_212 -> V_275 [ V_386 -> V_393 ] = F_50 ( V_384 ) ;
V_390 = F_51 ( V_212 -> V_265 , V_212 -> V_275 [ V_386 -> V_393 ] ) ;
if ( V_390 < 0 ) {
F_7 ( V_217 -> V_2 , L_7 ,
...
static int F_55 ( struct V_385 * V_386 , unsigned int V_413 )
{
struct V_216 * V_217 = V_386 -> V_217 ;
struct V_211 * V_212 = F_14 ( V_217 ) ;
...
static int F_56 ( struct V_385 * V_386 ,
...
V_212 -> V_265 = V_436 ;
V_212 -> V_438 = V_435 ;
F_53 ( V_386 -> V_2 , L_12 , V_436 , V_435 ) ;
return 0 ;
}
static int F_57 ( const unsigned int V_444 ,
const unsigned int V_445 , struct V_446 * V_447 )
{
if ( V_448 > V_444 )
return - V_304 ;
return F_58 ( V_444 , V_445 , V_447 ) ;
}
static int F_59 ( struct V_385 * V_386 , int V_449 , int V_269 ,
...
static int F_60 ( struct V_385 * V_386 , unsigned int V_471 ,
...
static inline struct V_211 * F_62 ( struct V_486 * V_487 )
{
return F_63 ( V_487 , struct V_211 , V_486 ) ;
}
static void F_64 ( struct V_486 * V_487 , unsigned V_488 , int V_214 )
{
struct V_211 * V_212 = F_62 ( V_487 ) ;
switch ( V_488 ) {
case V_489 ... V_490 :
...
static int F_65 ( struct V_486 * V_487 ,
...
static int F_66 ( struct V_486 * V_487 , unsigned V_488 )
{
struct V_211 * V_212 = F_62 ( V_487 ) ;
int V_214 , V_218 ;
...
static int F_67 ( struct V_486 * V_487 , unsigned V_488 )
{
struct V_211 * V_212 = F_62 ( V_487 ) ;
switch ( V_488 ) {
case V_489 ... V_490 :
...
static void F_68 ( struct V_211 * V_212 , unsigned V_488 ,
int V_214 )
{
int V_274 ;
switch ( V_488 ) {
...
return F_70 ( V_502 , V_504 ) ;
}
static void F_71 ( struct V_513 * V_514 )
{
struct V_211 * V_212 = F_72 ( V_514 ) ;
int V_218 ;
V_212 -> V_486 = V_515 ;
V_212 -> V_486 . V_516 = V_517 ;
V_212 -> V_486 . V_2 = & V_514 -> V_2 ;
V_212 -> V_486 . V_518 = - 1 ;
V_218 = F_73 ( & V_212 -> V_486 ) ;
if ( V_218 != 0 )
F_7 ( & V_514 -> V_2 , L_17 , V_218 ) ;
}
static void F_74 ( struct V_513 * V_514 )
{
struct V_211 * V_212 = F_72 ( V_514 ) ;
F_75 ( & V_212 -> V_486 ) ;
}
...
{
struct V_519 * V_262 = F_77 ( V_217 ) ;
struct V_211 * V_212 = F_14 ( V_217 ) ;
int V_4 ;
V_212 -> V_217 = V_217 ;
if ( V_212 -> V_505 . V_520 == V_521 ) {
F_78 ( V_262 ,
V_522 ,
F_2 ( V_522 ) ) ;
} else {
...
F_68 ( V_212 , V_4 , V_212 -> V_505 . V_524 [ V_4 ] ) ;
if ( V_212 -> V_503 ) {
...
static int F_86 ( void * V_534 , unsigned int V_3 , unsigned int * V_271 )
{
struct V_513 * V_535 = V_534 ;
struct V_211 * V_212 = F_72 ( V_535 ) ;
if ( V_212 -> V_231 ) {
if ( V_3 > 0xff ) {
F_5 ( & V_212 -> V_531 ) ;
F_11 ( V_212 , V_109 ,
...
static int F_87 ( void * V_534 , unsigned int V_3 , unsigned int V_271 )
{
struct V_513 * V_535 = V_534 ;
struct V_211 * V_212 = F_72 ( V_535 ) ;
if ( V_212 -> V_231 ) {
...
static void F_88 ( struct V_211 * V_212 ,
struct V_1 * V_2 )
{
V_212 -> V_505 . V_536 = F_89 ( V_2 ,
L_18 ) ;
V_212 -> V_505 . V_537 = F_89 ( V_2 ,
L_19 ) ;
V_212 -> V_505 . V_538 = F_89 ( V_2 ,
L_20 ) ;
V_212 -> V_505 . V_539 = F_89 ( V_2 ,
L_21 ) ;
V_212 -> V_505 . V_540 = F_89 ( V_2 ,
L_22 ) ;
F_90 ( V_2 , L_23 ,
V_212 -> V_505 . V_524 , V_517 ) ;
F_91 ( V_2 , L_24 ,
& V_212 -> V_505 . V_506 ) ;
F_91 ( V_2 , L_25 ,
& V_212 -> V_505 . V_509 ) ;
...
static int F_92 ( struct V_513 * V_514 )
{
int V_218 ;
struct V_211 * V_212 = F_72 ( V_514 ) ;
if ( ! V_212 -> V_505 . V_506 &&
...
V_218 = F_93 ( V_212 -> V_230 , V_514 -> V_504 ,
V_541 | V_542 | V_543 , 0 ,
& V_544 , & V_212 -> V_503 ) ;
if ( V_218 != 0 ) {
...
static void F_94 ( struct V_513 * V_514 )
{
struct V_211 * V_212 = F_72 ( V_514 ) ;
if ( V_212 -> V_503 )
F_95 ( V_514 -> V_504 , V_212 -> V_503 ) ;
}
static int F_96 ( struct V_513 * V_514 ,
const struct V_545 * V_393 )
{
struct V_546 * V_505 = F_97 ( & V_514 -> V_2 ) ;
struct V_211 * V_212 ;
int V_218 ;
unsigned int V_271 ;
V_212 = F_98 ( & V_514 -> V_2 , sizeof( struct V_211 ) ,
V_547 ) ;
if ( V_212 == NULL )
return - V_548 ;
F_99 ( V_514 , V_212 ) ;
V_212 -> type = V_393 -> V_549 ;
if ( V_505 )
V_212 -> V_505 = * V_505 ;
else
F_88 ( V_212 , & V_514 -> V_2 ) ;
V_212 -> V_532 = F_100 ( & V_514 -> V_2 ,
L_29 , V_550 ) ;
if ( F_101 ( V_212 -> V_532 ) ) {
V_218 = F_102 ( V_212 -> V_532 ) ;
F_7 ( & V_514 -> V_2 , L_30 , V_218 ) ;
return V_218 ;
}
V_212 -> V_533 = F_100 ( & V_514 -> V_2 ,
L_31 , V_550 ) ;
if ( F_101 ( V_212 -> V_533 ) ) {
V_218 = F_102 ( V_212 -> V_533 ) ;
...
V_212 -> V_220 = F_103 ( V_514 ,
& V_551 ) ;
if ( F_101 ( V_212 -> V_220 ) ) {
V_218 = F_102 ( V_212 -> V_220 ) ;
F_7 ( & V_514 -> V_2 , L_33 ,
V_218 ) ;
return V_218 ;
}
V_212 -> V_230 = F_104 ( & V_514 -> V_2 , NULL , V_514 , & V_552 ) ;
if ( F_101 ( V_212 -> V_230 ) ) {
V_218 = F_102 ( V_212 -> V_230 ) ;
F_7 ( & V_514 -> V_2 , L_33 ,
V_218 ) ;
return V_218 ;
}
...
F_6 ( V_212 -> V_230 , V_8 , 0x10ec ) ;
V_218 = F_105 ( V_212 -> V_230 , V_555 ,
F_2 ( V_555 ) ) ;
if ( V_218 != 0 )
F_106 ( & V_514 -> V_2 , L_35 , V_218 ) ;
if ( V_212 -> V_505 . V_536 )
...
if ( V_212 -> V_505 . V_565 )
F_15 ( V_212 -> V_230 , V_40 ,
V_566 ,
V_567 ) ;
F_71 ( V_514 ) ;
F_92 ( V_514 ) ;
return F_107 ( & V_514 -> V_2 , & V_568 ,
V_569 , F_2 ( V_569 ) ) ;
}
static int F_108 ( struct V_513 * V_514 )
{
F_109 ( & V_514 -> V_2 ) ;
F_94 ( V_514 ) ;
F_74 ( V_514 ) ;
