...
static void F_11 ( struct V_2 * V_3 , struct V_39 * V_40 )
{
T_1 V_41 ;
...
V_64 -> V_66 = F_14 ( V_56 , 0 ) ;
if ( ! V_64 -> V_66 ) {
F_15 ( L_1 ) ;
V_32 = - V_67 ;
goto V_68;
}
V_32 = F_16 ( V_56 , 2 , & V_62 ) ;
if ( V_32 ) {
F_15 ( L_2 ) ;
goto V_68;
}
V_64 -> V_69 = F_17 ( V_56 , 2 ) ;
if ( ! V_64 -> V_69 ) {
F_15 ( L_3 ) ;
V_32 = - V_70 ;
goto V_68;
}
V_64 -> V_71 = F_18 ( V_64 -> V_69 + V_72 ) ;
