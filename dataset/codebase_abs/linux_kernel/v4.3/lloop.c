...
static int F_67 ( struct V_104 * V_105 , T_6 V_132 )
{
...
static void F_68 ( struct V_136 * V_137 , T_6 V_132 )
{
...
static int F_69 ( struct V_104 * V_105 , T_6 V_132 ,
...
F_71 ( & V_144 ) ;
if ( F_72 ( (struct V_143 * ) V_139 , & V_144 , sizeof( V_144 ) ) )
V_80 = - V_147 ;
break;
}
default:
...
static enum V_148 F_73 ( struct V_19 * V_103 , struct V_3 * V_3 ,
unsigned int V_138 , unsigned long V_139 ,
...
V_2 = V_156 ;
V_151 = F_74 ( V_160 , V_2 -> V_102 ) ;
if ( F_75 ( ( long ) F_76 ( V_151 ) , ( long * ) V_139 ) ) {
V_80 = - V_147 ;
goto V_96;
}
V_105 = F_77 ( V_151 , V_3 -> V_117 , NULL ) ;
if ( F_40 ( V_105 ) ) {
V_80 = F_41 ( V_105 ) ;
goto V_96;
}
F_78 ( V_3 ) ;
V_80 = F_47 ( V_2 , NULL , V_105 , V_3 ) ;
if ( V_80 ) {
F_66 ( V_3 ) ;
F_70 ( V_105 , 0 ) ;
}
...
F_27 ( V_167 , L_10 ,
V_160 , V_158 ) ;
V_152 = F_84 ( F_73 , 2 , V_164 ) ;
if ( V_152 == NULL )
goto V_168;
V_159 = F_85 ( V_158 , sizeof( * V_159 ) , V_169 ) ;
if ( ! V_159 )
goto V_168;
V_127 = F_85 ( V_158 , sizeof( * V_127 ) , V_169 ) ;
if ( ! V_127 )
goto V_170;
