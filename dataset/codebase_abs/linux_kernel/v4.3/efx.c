...
V_2 -> V_190 = F_163 ( V_105 ,
V_2 -> V_191 ) ;
V_2 -> V_192 = V_105 ;
}
for ( V_44 = 0 ; V_44 < V_2 -> V_105 ; V_44 ++ )
F_165 ( V_2 , V_44 ) -> V_193 =
V_185 [ V_44 ] . V_194 ;
}
}
if ( V_2 -> V_182 == V_189 ) {
...
if ( V_40 == 0 ) {
F_165 ( V_2 , 0 ) -> V_193 = V_2 -> V_159 -> V_193 ;
} else {
F_2 ( V_2 , V_6 , V_2 -> V_7 ,
L_53 ) ;
V_2 -> V_182 = V_195 ;
...
F_182 ( V_2 -> V_7 , V_2 -> V_192 ) ;
F_183 ( V_2 , V_208 , V_209 , true ,
true ) ;
return 0 ;
V_146:
F_175 ( V_2 ) ;
...
V_2 -> V_215 = F_190 ( V_2 -> type -> V_216 ,
sizeof( * V_2 -> V_215 ) ,
V_47 ) ;
if ( ! V_2 -> V_215 ) {
V_2 -> type -> V_217 ( V_2 ) ;
...
static unsigned int F_202 ( unsigned int V_236 , unsigned int V_237 )
{
if ( V_236 == 0 )
return 0 ;
if ( V_236 * 1000 < V_237 )
...
int F_183 ( struct V_1 * V_2 , unsigned int V_238 ,
unsigned int V_239 , bool V_240 ,
bool V_241 )
{
struct V_9 * V_10 ;
unsigned int V_242 = F_203 ( V_2 -> type -> V_243 *
V_2 -> V_244 ,
1000 ) ;
unsigned int V_245 ;
unsigned int V_246 ;
...
return - V_221 ;
V_245 = F_202 ( V_238 , V_2 -> V_244 ) ;
V_246 = F_202 ( V_239 , V_2 -> V_244 ) ;
...
void F_205 ( struct V_1 * V_2 , unsigned int * V_238 ,
unsigned int * V_239 , bool * V_240 )
{
* V_240 = V_2 -> V_25 ;
* V_239 = F_203 ( V_2 -> V_32 *
V_2 -> V_244 ,
1000 ) ;
if ( V_2 -> V_63 == 0 )
* V_238 = * V_239 ;
...
static int F_208 ( struct V_249 * V_7 , struct V_250 * V_251 , int V_252 )
{
struct V_1 * V_2 = F_209 ( V_7 ) ;
struct V_253 * V_133 = F_210 ( V_251 ) ;
if ( V_252 == V_254 )
return F_211 ( V_2 , V_251 ) ;
if ( V_252 == V_255 )
return F_212 ( V_2 , V_251 ) ;
if ( ( V_252 == V_256 || V_252 == V_257 ) &&
( V_133 -> V_258 & 0xfc00 ) == 0x0400 )
V_133 -> V_258 ^= V_259 | 0x0400 ;
return F_213 ( & V_2 -> V_260 , V_133 , V_252 ) ;
}
...
static void F_221 ( struct V_249 * V_7 )
{
struct V_1 * V_2 = F_209 ( V_7 ) ;
struct V_9 * V_10 ;
F_54 (channel, efx)
...
static struct V_267 * F_231 ( struct V_249 * V_7 ,
struct V_267 * V_268 )
{
struct V_1 * V_2 = F_209 ( V_7 ) ;
F_198 ( & V_2 -> V_233 ) ;
...
static void F_232 ( struct V_249 * V_7 )
{
struct V_1 * V_2 = F_209 ( V_7 ) ;
...
static int F_233 ( struct V_249 * V_7 , int V_271 )
{
struct V_1 * V_2 = F_209 ( V_7 ) ;
int V_40 ;
V_40 = F_1 ( V_2 ) ;
...
static int F_234 ( struct V_249 * V_7 , void * V_133 )
{
struct V_1 * V_2 = F_209 ( V_7 ) ;
...
static void F_236 ( struct V_249 * V_7 )
{
struct V_1 * V_2 = F_209 ( V_7 ) ;
if ( V_2 -> V_93 )
F_237 ( V_2 -> V_227 , & V_2 -> V_134 ) ;
}
static int F_238 ( struct V_249 * V_7 , T_6 V_133 )
{
struct V_1 * V_2 = F_209 ( V_7 ) ;
...
static int F_241 ( struct V_283 * V_284 ,
unsigned long V_285 , void * V_286 )
{
struct V_249 * V_7 = F_242 ( V_286 ) ;
if ( ( V_7 -> V_287 == & V_288 ) &&
V_285 == V_289 )
F_239 ( F_209 ( V_7 ) ) ;
return V_290 ;
...
static T_7
F_243 ( struct V_291 * V_167 , struct V_292 * V_293 , char * V_60 )
{
struct V_1 * V_2 = F_244 ( F_245 ( V_167 ) ) ;
return sprintf ( V_60 , L_71 , V_2 -> V_294 ) ;
}
static T_7 F_246 ( struct V_291 * V_167 , struct V_292 * V_293 ,
char * V_60 )
{
struct V_1 * V_2 = F_244 ( F_245 ( V_167 ) ) ;
struct V_295 * V_296 = F_247 ( V_2 ) ;
return F_248 ( V_60 , V_77 , L_71 , V_296 -> V_297 ) ;
}
static T_7 F_249 ( struct V_291 * V_167 , struct V_292 * V_293 ,
...
F_129 ( V_2 ) ;
F_256 () ;
V_40 = F_257 ( & V_2 -> V_159 -> V_167 , & V_310 ) ;
if ( V_40 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 ,
L_73 ) ;
goto V_311;
...
#ifdef F_258
V_40 = F_257 ( & V_2 -> V_159 -> V_167 , & V_312 ) ;
if ( V_40 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 ,
L_73 ) ;
goto V_313;
...
#ifdef F_258
F_259 ( & V_2 -> V_159 -> V_167 , & V_312 ) ;
#endif
F_259 ( & V_2 -> V_159 -> V_167 , & V_310 ) ;
F_264 ( V_2 -> V_7 ) ;
}
}
void F_265 ( struct V_1 * V_2 , enum V_315 V_316 )
{
F_73 ( V_2 ) ;
if ( V_316 == V_317 )
V_2 -> type -> V_318 ( V_2 ) ;
...
int F_266 ( struct V_1 * V_2 , enum V_315 V_316 , bool V_321 )
{
int V_40 ;
F_73 ( V_2 ) ;
if ( V_316 == V_317 )
...
int F_228 ( struct V_1 * V_2 , enum V_315 V_316 )
{
int V_40 , V_102 ;
bool V_325 ;
...
F_268 ( V_316 , & V_2 -> V_225 ) ;
F_138 ( V_2 -> V_159 ) ;
V_107:
V_325 = V_40 ||
V_316 == V_109 ||
V_316 == V_328 ;
V_102 = F_266 ( V_2 , V_316 , ! V_325 ) ;
if ( V_102 ) {
V_325 = true ;
if ( ! V_40 )
V_40 = V_102 ;
...
{
#ifdef F_271
struct V_329 * V_330 = F_272 ( V_2 -> V_159 ) ;
if ( F_273 ( V_330 ) ) {
return 1 ;
}
#endif
...
F_22 ( V_2 , V_6 , V_2 -> V_7 ,
L_85 ,
F_267 ( V_316 ) , F_267 ( type ) ) ;
break;
}
F_279 ( V_316 , & V_2 -> V_225 ) ;
F_252 () ;
if ( F_277 ( V_2 -> V_3 ) != V_308 )
return;
F_169 ( V_2 ) ;
F_237 ( V_340 , & V_2 -> V_334 ) ;
}
...
F_284 ( & V_2 -> V_342 ) ;
#endif
F_286 ( & V_2 -> V_334 , F_276 ) ;
F_287 ( & V_2 -> V_149 , F_206 ) ;
F_287 ( & V_2 -> V_343 , V_344 ) ;
V_2 -> V_159 = V_159 ;
V_2 -> V_345 = V_346 ;
V_2 -> V_3 = V_314 ;
...
void F_293 ( struct V_1 * V_2 , T_8 * V_268 )
{
T_8 V_355 = 0 ;
struct V_9 * V_10 ;
F_54 (channel, efx)
...
V_362 = F_302 ( V_167 , 0 , sizeof( V_360 ) , V_360 ) ;
if ( V_362 <= 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_88 ) ;
return;
}
V_363 = F_303 ( V_360 , 0 , V_362 , V_365 ) ;
if ( V_363 < 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_89 ) ;
return;
}
V_364 = F_304 ( & V_360 [ V_363 ] ) ;
V_46 = V_364 ;
V_44 = V_363 + V_366 ;
if ( V_44 + V_46 > V_362 )
V_46 = V_362 - V_44 ;
V_44 = F_305 ( V_360 , V_44 , V_46 , L_90 ) ;
if ( V_44 < 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_91 ) ;
return;
}
V_46 = F_306 ( & V_360 [ V_44 ] ) ;
V_44 += V_367 ;
if ( V_44 + V_46 > V_362 ) {
...
V_44 = V_363 + V_366 ;
V_46 = V_364 ;
V_44 = F_305 ( V_360 , V_44 , V_46 , L_94 ) ;
if ( V_44 < 0 ) {
...
static int F_315 ( struct V_159 * V_167 , int V_386 )
{
int V_40 ;
...
static int F_318 ( struct V_291 * V_167 )
{
...
V_2 -> V_225 = 0 ;
F_319 ( V_159 ) ;
return F_320 ( V_159 , V_390 ) ;
}
static int F_321 ( struct V_291 * V_167 )
{
struct V_159 * V_159 = F_245 ( V_167 ) ;
struct V_1 * V_2 = F_244 ( V_159 ) ;
int V_40 ;
V_40 = F_320 ( V_159 , V_391 ) ;
if ( V_40 )
return V_40 ;
F_322 ( V_159 ) ;
V_40 = F_137 ( V_159 ) ;
...
static int F_323 ( struct V_291 * V_167 )
{
int V_40 ;
F_316 ( V_167 ) ;
V_40 = F_318 ( V_167 ) ;
...
static T_9 F_325 ( struct V_159 * V_392 )
{
struct V_1 * V_2 = F_244 ( V_392 ) ;
T_9 V_394 = V_395 ;
int V_40 ;
...
static void F_327 ( struct V_159 * V_392 )
{
struct V_1 * V_2 = F_244 ( V_392 ) ;
int V_40 ;
F_251 () ;
