...
static int F_19 ( char * V_20 , T_4 V_22 )
{
struct V_19 V_44 ;
V_44 . V_29 = * ( V_45 * ) V_20 ;
V_44 . V_30 = * ( V_45 * ) ( & V_20 [ 8 ] ) ;
return F_5 ( V_44 , V_46 , V_22 ) ;
}
...
static int F_22 ( unsigned type , T_3 V_47 ,
struct V_31 * V_31 )
{
V_45 V_48 = ( V_45 ) V_47 ;
T_2 V_40 = ( T_2 ) V_47 ;
...
static int F_24 ( unsigned type , T_3 V_47 ,
struct V_31 * V_31 )
{
V_45 V_48 = ( V_45 ) V_47 ;
T_2 V_40 = ( T_2 ) V_47 ;
...
static void F_25 ( unsigned type , T_3 V_47 )
{
V_45 V_48 = ( V_45 ) V_47 ;
T_2 V_40 = ( T_2 ) V_47 ;
int V_37 = V_49 ;
...
if ( V_37 < 0 )
return;
for ( V_40 = V_50 ; V_40 >= 0 ; V_40 -- )
( void ) F_10 ( V_37 , F_20 ( type , V_40 ) ) ;
}
static void F_27 ( unsigned V_51 )
{
struct V_19 V_52 = V_43 ;
if ( V_49 < 0 )
V_49 =
F_5 ( V_52 , V_53 , V_54 ) ;
}
