...
{
int V_616 ;
if ( ! F_7 ( V_462 , & V_616 , L_342 , L_343 , V_614 )
|| V_616 != V_614 )
F_62 ( L_346 ) ;
}
...
sizeof( V_632 -> V_639 ) ) ;
snprintf ( V_632 -> V_641 , sizeof( V_632 -> V_641 ) , L_353 ,
( V_7 . V_642 ) ?
V_7 . V_642 : L_354 ) ;
snprintf ( V_632 -> V_643 , sizeof( V_632 -> V_643 ) ,
L_355 , V_632 -> V_639 , V_610 ,
( V_7 . V_642 ) ?
V_7 . V_642 : L_356 ) ;
if ( V_603 ) {
V_644 . V_645 = F_336 ;
