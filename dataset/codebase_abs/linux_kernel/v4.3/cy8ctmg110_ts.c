...
{
const struct V_41 * V_42 = F_16 ( & V_10 -> V_13 ) ;
struct V_1 * V_2 ;
struct V_24 * V_24 ;
int V_43 ;
if ( V_42 == NULL ) {
...
V_45 ) )
return - V_14 ;
V_2 = F_18 ( sizeof( struct V_1 ) , V_46 ) ;
V_24 = F_19 () ;
if ( ! V_2 || ! V_24 ) {
V_43 = - V_47 ;
goto V_48;
...
V_2 -> V_4 = V_42 -> V_4 ;
V_2 -> V_49 = V_42 -> V_49 ;
snprintf ( V_2 -> V_50 , sizeof( V_2 -> V_50 ) ,
L_3 , F_20 ( & V_10 -> V_13 ) ) ;
V_24 -> V_51 = V_52 L_4 ;
V_24 -> V_50 = V_2 -> V_50 ;
V_24 -> V_40 . V_53 = V_54 ;
V_24 -> V_13 . V_55 = & V_10 -> V_13 ;
V_24 -> V_56 [ 0 ] = F_21 ( V_57 ) | F_21 ( V_58 ) ;
V_24 -> V_59 [ F_22 ( V_31 ) ] = F_21 ( V_31 ) ;
F_23 ( V_24 , V_32 ,
V_60 , V_61 , 4 , 0 ) ;
F_23 ( V_24 , V_33 ,
V_62 , V_63 , 4 , 0 ) ;
if ( V_2 -> V_4 ) {
V_43 = F_24 ( V_2 -> V_4 , NULL ) ;
if ( V_43 ) {
F_6 ( & V_10 -> V_13 ,
L_5 ,
V_2 -> V_4 ) ;
...
static int T_2 F_35 ( struct V_69 * V_13 )
{
struct V_9 * V_10 = F_36 ( V_13 ) ;
...
static int T_2 F_40 ( struct V_69 * V_13 )
{
struct V_9 * V_10 = F_36 ( V_13 ) ;
struct V_1 * V_2 = F_37 ( V_10 ) ;
if ( F_38 ( & V_10 -> V_13 ) )
