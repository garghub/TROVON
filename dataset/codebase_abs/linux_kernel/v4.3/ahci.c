...
V_31 = F_69 ( V_2 , & V_116 , 1 ) ;
if ( V_31 < 0 )
goto V_119;
V_4 -> V_120 = V_116 . V_121 ;
return 1 ;
V_119:
F_32 ( & V_2 -> V_8 ,
L_58 ,
...
static int F_70 ( struct V_1 * V_2 , unsigned int V_111 ,
struct V_3 * V_4 )
{
int V_31 , V_114 ;
if ( V_4 -> V_10 & V_117 )
...
{
int V_114 ;
V_114 = F_70 ( V_2 , V_111 , V_4 ) ;
if ( V_114 >= 0 )
return V_114 ;
V_114 = F_67 ( V_2 , V_111 , V_4 ) ;
if ( V_114 >= 0 )
return V_114 ;
F_76 ( V_2 , 1 ) ;
V_4 -> V_120 = V_2 -> V_120 ;
...
static int F_77 ( struct V_1 * V_2 , const struct V_107 * V_127 )
{
unsigned int V_128 = V_127 -> V_96 ;
struct V_129 V_130 = V_131 [ V_128 ] ;
const struct V_129 * V_132 [] = { & V_130 , NULL } ;
...
F_2 ( & V_2 -> V_8 ,
L_60 ) ;
if ( V_2 -> V_5 == V_141 && V_2 -> V_7 == 0xCC06 )
V_133 = V_142 ;
...
V_31 = F_82 ( V_2 , 1 << V_133 , V_147 ) ;
if ( V_31 == - V_148 )
F_83 ( V_2 ) ;
if ( V_31 )
return V_31 ;
V_4 = F_84 ( V_8 , sizeof( * V_4 ) , V_149 ) ;
if ( ! V_4 )
return - V_150 ;
V_4 -> V_10 |= ( unsigned long ) V_130 . V_16 ;
if ( V_128 == V_151 &&
( V_2 -> V_152 == 0xa1 || V_2 -> V_152 == 0xa2 ) )
V_4 -> V_10 |= V_117 ;
if ( V_128 == V_153 && V_2 -> V_152 >= 0x40 )
V_4 -> V_10 &= ~ V_154 ;
if ( F_52 ( V_2 ) )
V_4 -> V_10 &= ~ V_155 ;
V_4 -> V_57 = F_85 ( V_2 ) [ V_133 ] ;
if ( F_61 ( V_2 ) )
V_4 -> V_10 |= V_156 ;
F_1 ( V_2 , V_4 ) ;
if ( V_4 -> V_157 & V_158 ) {
...
V_111 = F_87 ( F_88 ( V_4 -> V_157 ) , F_89 ( V_4 -> V_18 ) ) ;
V_14 = F_90 ( & V_2 -> V_8 , V_132 , V_111 ) ;
if ( ! V_14 )
return - V_150 ;
V_14 -> V_16 = V_4 ;
F_75 ( V_2 , V_111 , V_4 ) ;
if ( ! ( V_4 -> V_157 & V_167 ) || V_168 )
V_14 -> V_10 |= V_169 ;
else
F_2 ( & V_2 -> V_8 , L_64 ) ;
if ( V_130 . V_10 & V_170 )
...
for ( V_49 = 0 ; V_49 < V_14 -> V_111 ; V_49 ++ ) {
struct V_28 * V_29 = V_14 -> V_84 [ V_49 ] ;
F_92 ( V_29 , V_133 , - 1 , L_65 ) ;
F_92 ( V_29 , V_133 ,
0x100 + V_29 -> V_53 * 0x80 , L_66 ) ;
if ( V_29 -> V_10 & V_170 )
V_29 -> V_171 = V_4 -> V_172 ;
if ( ! ( V_4 -> V_18 & ( 1 << V_49 ) ) )
V_29 -> V_85 = & V_173 ;
}
F_45 ( V_14 ) ;
F_64 ( V_14 ) ;
V_31 = F_39 ( V_2 , V_4 -> V_157 & V_174 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
