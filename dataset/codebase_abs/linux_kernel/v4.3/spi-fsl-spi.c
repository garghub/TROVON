...
V_134 -> V_136 = F_78 ( V_141 * sizeof( * V_134 -> V_136 ) , V_85 ) ;
if ( ! V_134 -> V_136 )
return - V_86 ;
memset ( V_134 -> V_136 , - 1 , V_141 * sizeof( * V_134 -> V_136 ) ) ;
V_134 -> V_138 = F_35 ( V_141 * sizeof( * V_134 -> V_138 ) ,
V_85 ) ;
if ( ! V_134 -> V_138 ) {
V_66 = - V_86 ;
goto V_144;
...
int V_135 ;
enum V_145 V_21 ;
V_135 = F_79 ( V_140 , V_142 , & V_21 ) ;
if ( ! F_37 ( V_135 ) ) {
F_29 ( V_2 , L_7 , V_142 , V_135 ) ;
V_66 = V_135 ;
goto V_146;
}
V_66 = F_38 ( V_135 , F_19 ( V_2 ) ) ;
if ( V_66 ) {
F_29 ( V_2 , L_8 , V_142 , V_66 ) ;
goto V_146;
}
...
static int F_87 ( struct V_148 * V_150 )
{
struct V_118 * V_119 ;
int V_104 ;
struct V_72 * V_14 ;
...
static int F_91 ( struct V_148 * V_150 )
{
struct V_72 * V_14 = F_86 ( V_150 ) ;
struct V_12 * V_12 = F_4 ( V_14 ) ;
F_71 ( V_12 ) ;
return 0 ;
}
