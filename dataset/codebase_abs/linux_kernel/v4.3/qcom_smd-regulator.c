...
static int F_9 ( struct V_9 * V_10 , int V_23 )
{
struct V_1 * V_2 = F_4 ( V_10 ) ;
struct V_3 V_4 ;
V_4 . V_12 = V_24 ;
...
struct V_1 * V_2 ;
struct V_33 * V_6 ;
V_6 = F_11 ( V_26 -> V_34 . V_35 ) ;
if ( ! V_6 ) {
F_12 ( & V_26 -> V_34 , L_1 ) ;
return - V_36 ;
}
V_30 = F_13 ( V_37 , & V_26 -> V_34 ) ;
for ( V_28 = V_30 -> V_38 ; V_28 -> V_39 ; V_28 ++ ) {
V_2 = F_14 ( & V_26 -> V_34 , sizeof( * V_2 ) , V_40 ) ;
if ( ! V_2 )
return - V_41 ;
V_2 -> V_34 = & V_26 -> V_34 ;
V_2 -> type = V_28 -> type ;
...
V_32 . V_34 = & V_26 -> V_34 ;
V_32 . V_49 = V_2 ;
V_10 = F_15 ( & V_26 -> V_34 , & V_2 -> V_42 , & V_32 ) ;
if ( F_16 ( V_10 ) ) {
F_12 ( & V_26 -> V_34 , L_2 , V_28 -> V_39 ) ;
return F_17 ( V_10 ) ;
}
}
return 0 ;
