...
while ( ! F_107 ( V_180 ) ) {
struct V_132 * V_181 =
F_108 ( V_180 , struct V_132 ,
V_175 ) ;
F_109 ( & V_181 -> V_175 ) ;
if ( V_181 -> V_157 != V_159 ) {
F_101 ( V_181 -> V_157 ) ;
V_181 -> V_157 = V_159 ;
}
if ( ! F_68 ( V_181 -> V_119 ) ) {
...
if ( F_63 ( V_66 ) -> V_113 )
F_63 ( V_66 ) -> V_113 -> V_184 ( V_66 ) ;
F_74 ( & V_182 ) ;
F_114 ( & F_63 ( V_66 ) -> V_175 , & V_183 ) ;
F_75 ( & V_182 ) ;
F_66 ( & V_185 ) ;
V_66 -> V_133 = NULL ;
}
...
{
if ( ! F_68 ( F_63 ( V_66 ) -> V_174 ) ) {
F_116 ( F_63 ( V_66 ) -> V_174 ) ;
F_63 ( V_66 ) -> V_174 = V_70 ;
}
}
...
T_2 V_88 ;
int V_2 ;
V_103 = V_186 -> V_39 == V_187 ?
V_159 : V_186 -> V_39 ;
if ( V_103 <= V_188 && ! F_118 ( V_189 ) )
return - V_190 ;
V_88 = V_186 -> V_34 == V_33 ?
V_191 : 0 ;
V_2 = F_47 ( V_103 , V_88 ,
F_50 ,
& V_66 -> V_64 ,
...
if ( V_2 < V_101 )
return F_1 ( V_2 ) ;
F_6 ( & V_66 -> V_67 , V_186 -> V_34 ,
F_63 ( V_66 ) -> V_174 . V_108 ) ;
return 0 ;
}
static int F_119 (
struct V_65 * V_66 ,
...
return - V_9 ;
V_32 = F_14 ( V_194 + sizeof( * V_32 ) , V_69 ) ;
if ( ! V_32 )
return - V_4 ;
F_120 ( F_121 ( V_32 ) , V_193 , V_194 ) ;
...
struct V_98 * V_99 ;
V_197 = V_88 & V_199 ;
if ( V_88 & V_200 || V_88 & V_201 )
return - V_202 ;
V_2 = 0 ;
V_99 = F_123 ( & V_66 -> V_64 , V_88 , V_197 , & V_2 ) ;
if ( V_2 )
return V_2 ;
if ( ! V_99 )
return - V_203 ;
...
goto V_90;
V_198 = V_32 -> V_35 ;
if ( V_198 != V_99 -> V_194 - sizeof( * V_32 ) ) {
V_2 = - V_15 ;
goto V_90;
}
if ( V_198 > V_194 ) {
...
V_2 = F_124 ( V_99 , sizeof( * V_32 ) , V_193 , V_198 ) ;
if ( V_2 )
goto V_90;
if ( V_193 -> V_206 ) {
F_125 ( struct V_22 * , V_207 , V_193 -> V_206 ) ;
F_6 ( V_207 , V_32 -> V_23 . V_58 , V_32 -> V_23 . V_108 ) ;
V_193 -> V_208 = sizeof( * V_207 ) ;
}
V_2 = V_198 ;
V_90:
...
{
if ( V_88 & V_211 )
return F_130 ( F_63 ( V_66 ) -> V_84 , V_193 , V_194 , 0 ) ;
else
return F_131 ( F_63 ( V_66 ) -> V_84 , V_193 , V_194 , 0 ) ;
}
static T_8 F_132 (
struct V_65 * V_66 ,
struct V_192 * V_193 ,
T_6 V_194 )
{
return F_133 ( F_63 ( V_66 ) -> V_84 , V_193 , V_194 , 0 ) ;
}
