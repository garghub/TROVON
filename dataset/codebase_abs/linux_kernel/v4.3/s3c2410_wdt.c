...
V_5 -> V_93 = F_12 ( V_5 -> V_22 + V_25 ) ;
V_5 -> V_94 = F_12 ( V_5 -> V_22 + V_32 ) ;
V_7 = F_3 ( V_5 , true ) ;
if ( V_7 < 0 )
return V_7 ;
F_13 ( & V_5 -> V_40 ) ;
...
int V_7 ;
struct V_1 * V_5 = F_62 ( V_17 ) ;
F_9 ( V_5 -> V_94 , V_5 -> V_22 + V_32 ) ;
F_9 ( V_5 -> V_94 , V_5 -> V_22 + V_23 ) ;
F_9 ( V_5 -> V_93 , V_5 -> V_22 + V_25 ) ;
V_7 = F_3 ( V_5 , false ) ;
if ( V_7 < 0 )
return V_7 ;
F_23 ( V_17 , L_30 ,
( V_5 -> V_93 & V_26 ) ? L_28 : L_29 ) ;
return 0 ;
}
