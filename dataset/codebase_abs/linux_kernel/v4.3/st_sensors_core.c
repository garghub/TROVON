...
V_19 [ V_23 ] . V_104 , & V_99 ) ;
if ( V_8 < 0 ) {
F_9 ( & V_4 -> V_15 , L_14 ) ;
return V_8 ;
}
if ( V_19 [ V_23 ] . V_99 != V_99 ) {
F_9 ( & V_4 -> V_15 , L_15 ,
V_4 -> V_101 , V_99 ) ;
return - V_25 ;
}
...
T_3 F_36 ( struct V_59 * V_15 ,
struct V_105 * V_106 , char * V_107 )
{
int V_23 , V_108 = 0 ;
struct V_3 * V_4 = F_37 ( V_15 ) ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
F_32 ( & V_4 -> V_90 ) ;
for ( V_23 = 0 ; V_23 < V_26 ; V_23 ++ ) {
if ( V_11 -> V_19 -> V_20 . V_27 [ V_23 ] . V_28 == 0 )
break;
V_108 += F_38 ( V_107 + V_108 , V_109 - V_108 , L_16 ,
...
break;
V_108 += F_38 ( V_107 + V_108 , V_109 - V_108 , L_17 ,
