...
static int F_35 ( struct V_1 * V_2 , T_2 * V_137 , T_3 * V_138 ,
T_3 * V_139 )
{
struct V_18 * V_19 = F_5 ( V_2 ) ;
struct V_80 * V_35 = & V_19 -> V_35 ;
...
static int F_37 ( struct V_1 * V_2 , const T_2 * V_137 ,
