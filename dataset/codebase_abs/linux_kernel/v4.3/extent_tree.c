...
static int F_38 ( struct V_36 * V_37 , V_58 * V_25 ,
T_2 V_62 , T_2 * V_57 )
{
struct V_1 * V_7 ;
int V_51 = 0 ;
...
V_25 = F_39 ( V_25 , V_7 -> V_16 -> V_69 . V_70 ,
V_71 ) ;
V_25 = F_40 ( V_25 , V_7 -> V_8 << V_72 ) ;
V_25 = F_40 ( V_25 , V_7 -> V_9 << V_72 ) ;
V_25 = F_40 ( V_25 , 0LL ) ;
* V_25 ++ = F_41 ( V_39 ) ;
V_7 -> V_20 = V_73 ;
}
...
int
F_42 ( struct V_60 * V_61 )
{
struct V_36 * V_37 = F_43 ( F_44 ( V_61 -> V_74 ) -> V_75 ) ;
...
V_61 -> V_63 = & V_61 -> V_64 ;
V_45:
V_51 = F_38 ( V_37 , V_76 + 1 , V_62 , & V_57 ) ;
if ( F_47 ( V_51 ) ) {
F_35 ( V_61 , V_62 ) ;
V_62 = F_34 ( V_57 ) ;
V_57 = 0 ;
...
* V_76 = F_41 ( V_57 ) ;
V_61 -> V_81 = F_34 ( V_57 ) ;
if ( F_47 ( V_61 -> V_63 != & V_61 -> V_64 ) ) {
void * V_25 = V_76 , * V_28 = V_25 + V_61 -> V_81 ;
int V_67 = 0 ;
for ( ; V_25 < V_28 ; V_25 += V_66 )
V_61 -> V_63 [ V_67 ++ ] = F_50 ( V_25 ) ;
}
F_25 ( L_3 , V_77 , V_57 ) ;
return 0 ;
}
void
F_51 ( struct V_60 * V_61 , int V_82 )
{
struct V_36 * V_37 = F_43 ( F_44 ( V_61 -> V_74 ) -> V_75 ) ;
struct V_5 * V_6 = & V_37 -> V_40 ;
struct V_1 * V_7 ;
