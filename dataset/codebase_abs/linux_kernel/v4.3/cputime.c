...
V_51 = 1 ;
} while ( F_45 ( & V_48 -> V_52 , V_50 ) );
F_46 ( & V_48 -> V_52 , V_50 , V_4 ) ;
F_47 () ;
}
static void F_48 ( struct V_2 * V_16 , int V_55 ,
...
static void F_50 ( int V_56 )
{
struct V_36 * V_36 = F_32 () ;
F_48 ( V_60 , 0 , V_36 , V_56 ) ;
}
static inline void F_50 ( int V_56 ) {}
static inline void F_48 ( struct V_2 * V_16 , int V_55 ,
struct V_36 * V_36 , int V_61 ) {}
void F_51 ( struct V_2 * V_62 )
{
if ( F_52 ( V_62 ) )
F_53 ( V_62 ) ;
else
...
void F_61 ( struct V_2 * V_16 , T_3 * V_63 , T_3 * V_64 )
{
* V_63 = V_16 -> V_22 ;
* V_64 = V_16 -> V_30 ;
}
...
void F_63 ( struct V_2 * V_16 , int V_55 )
{
T_3 V_65 = F_49 ( V_58 ) ;
struct V_36 * V_36 = F_32 () ;
if ( F_64 () )
...
static unsigned long long F_74 ( struct V_2 * V_44 )
{
unsigned long long clock ;
clock = F_75 () ;
if ( clock < V_44 -> V_76 )
return 0 ;
return clock - V_44 -> V_76 ;
}
static T_3 F_76 ( struct V_2 * V_44 )
{
unsigned long long V_5 = F_74 ( V_44 ) ;
F_77 ( V_44 -> V_77 == V_78 ) ;
V_44 -> V_76 += V_5 ;
return F_38 ( V_5 ) ;
}
static void F_78 ( struct V_2 * V_44 )
{
T_3 V_79 = F_76 ( V_44 ) ;
F_28 ( V_44 , F_29 () , V_79 , F_49 ( V_79 ) ) ;
}
...
void F_56 ( struct V_2 * V_44 )
{
T_3 V_79 ;
F_79 ( & V_44 -> V_80 ) ;
V_79 = F_76 ( V_44 ) ;
V_44 -> V_77 = V_82 ;
F_21 ( V_44 , V_79 , F_49 ( V_79 ) ) ;
F_80 ( & V_44 -> V_80 ) ;
}
void F_82 ( struct V_2 * V_44 )
{
F_79 ( & V_44 -> V_80 ) ;
F_78 ( V_44 ) ;
V_44 -> V_77 = V_81 ;
...
void F_85 ( struct V_2 * V_49 , int V_6 )
{
unsigned long V_4 ;
F_86 ( & V_49 -> V_80 , V_4 ) ;
V_49 -> V_77 = V_82 ;
...
if ( V_49 -> V_4 & V_33 )
V_27 += F_74 ( V_49 ) ;
} while ( F_90 ( & V_49 -> V_80 , V_50 ) );
return V_27 ;
}
static void
F_91 ( struct V_2 * V_49 ,
T_3 * V_83 , T_3 * V_84 ,
T_3 * V_85 , T_3 * V_86 ,
T_3 * V_87 , T_3 * V_88 )
{
...
continue;
V_5 = F_74 ( V_49 ) ;
if ( V_49 -> V_77 == V_81 || V_49 -> V_4 & V_33 ) {
* V_87 = V_5 ;
} else {
if ( V_49 -> V_77 == V_82 )
* V_88 = V_5 ;
...
void F_92 ( struct V_2 * V_49 ,
T_3 * V_23 , T_3 * V_31 )
{
T_3 V_87 , V_88 ;
F_91 ( V_49 , V_23 , V_31 ,
& V_49 -> V_23 , & V_49 -> V_31 , & V_87 , & V_88 ) ;
if ( V_23 )
* V_23 += F_49 ( V_87 ) ;
if ( V_31 )
* V_31 += F_49 ( V_88 ) ;
