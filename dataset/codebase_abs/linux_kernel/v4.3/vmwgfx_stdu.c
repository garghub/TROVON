...
static void F_29 ( struct V_105 * V_106 )
{
struct V_107 * V_108 =
F_30 ( V_106 , struct V_107 , V_20 ) ;
...
return;
V_108 -> V_41 = F_31 ( T_5 , V_108 -> V_41 , V_106 -> V_117 ) ;
V_108 -> V_43 = F_31 ( T_5 , V_108 -> V_43 , V_106 -> V_118 ) ;
V_108 -> V_42 = F_32 ( T_5 , V_108 -> V_42 , V_106 -> V_120 ) ;
V_108 -> V_44 = F_32 ( T_5 , V_108 -> V_44 , V_106 -> V_121 ) ;
}
...
F_35 ( & V_108 -> V_127 -> V_20 , & V_14 -> V_13 . V_128 . V_129 ) ;
...
{
struct V_150 * V_127 =
F_30 ( V_60 , struct V_151 , V_20 ) -> V_152 ;
struct V_107 V_108 ;
int V_54 ;
V_54 = F_37 ( V_11 , V_127 , V_149 ,
false ) ;
if ( V_54 )
return V_54 ;
...
V_108 . V_127 = V_127 ;
V_108 . V_20 . V_155 = F_33 ;
V_108 . V_20 . V_156 = F_29 ;
V_108 . V_20 . V_157 = sizeof( struct V_109 ) +
V_146 * sizeof( V_110 ) +
sizeof( T_8 ) ;
if ( V_148 )
V_108 . V_20 . V_157 += sizeof( struct V_45 ) ;
V_54 = F_38 ( V_11 , V_60 , V_143 , V_145 ,
0 , 0 , V_146 , V_147 , & V_108 . V_20 ) ;
F_39 ( V_11 , V_102 , V_127 , NULL ,
V_141 ) ;
return V_54 ;
}
...
V_106 -> V_112 ++ ;
V_158 -> V_41 = F_31 ( T_5 , V_158 -> V_41 , V_106 -> V_117 ) ;
V_158 -> V_43 = F_31 ( T_5 , V_158 -> V_43 , V_106 -> V_118 ) ;
V_158 -> V_42 = F_32 ( T_5 , V_158 -> V_42 , V_106 -> V_120 ) ;
V_158 -> V_44 = F_32 ( T_5 , V_158 -> V_44 , V_106 -> V_121 ) ;
}
...
{
struct V_61 * V_170 =
F_30 ( V_164 , F_34 ( * V_170 ) , V_20 ) ;
struct V_107 V_158 ;
int V_54 ;
if ( ! V_165 )
V_165 = & V_170 -> V_93 -> V_4 ;
V_54 = F_43 ( V_165 , true ) ;
if ( V_54 )
return V_54 ;
if ( V_170 -> V_171 ) {
V_54 = F_44 ( V_165 , V_143 , V_146 , V_168 ) ;
if ( V_54 )
goto V_172;
}
V_158 . V_20 . V_155 = F_41 ;
V_158 . V_20 . V_156 = F_40 ;
...
V_158 . V_41 = V_158 . V_43 = V_138 ;
V_158 . V_42 = V_158 . V_44 = V_139 ;
V_54 = F_38 ( V_11 , V_164 , V_143 , V_145 ,
...
static int F_50 ( struct V_10 * V_11 , unsigned V_21 )
{
struct V_1 * V_2 ;
...
V_2 -> V_20 . V_32 = true ;
F_52 ( V_71 , V_69 , & V_180 ,
V_181 ) ;
V_69 -> V_182 = F_53 ( V_69 , false ) ;
F_54 ( V_71 , V_67 , & V_183 ,
V_184 ) ;
F_55 ( V_69 , V_67 ) ;
V_67 -> V_185 = ( 1 << V_21 ) ;
V_67 -> V_186 = 0 ;
