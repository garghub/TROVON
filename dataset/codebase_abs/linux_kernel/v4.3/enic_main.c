...
static void F_154 ( struct V_1 * V_1 , struct V_190 * V_33 )
{
unsigned int V_49 = F_155 ( V_1 , V_33 -> V_207 ) ;
struct V_205 * V_206 = & V_1 -> V_206 [ F_139 ( V_1 , V_33 -> V_207 ) ] ;
T_3 V_248 = V_206 -> V_249 ;
if ( V_206 -> V_249 != V_206 -> V_250 ) {
F_156 ( & V_1 -> V_49 [ V_49 ] , V_248 ) ;
V_206 -> V_250 = V_206 -> V_249 ;
}
}
static void F_157 ( struct V_1 * V_1 , struct V_190 * V_33 )
{
struct V_251 * V_252 = & V_1 -> V_244 ;
struct V_205 * V_206 = & V_1 -> V_206 [ F_139 ( V_1 , V_33 -> V_207 ) ] ;
...
for ( V_207 = 0 ; V_207 < V_260 ; V_207 ++ )
if ( V_254 < V_261 [ V_207 ] . V_262 )
break;
V_253 = ( V_246 -> V_200 >
V_246 -> V_199 << 1 ) ?
V_252 -> V_263 :
...
V_261 [ V_207 ] . V_266 / 100 ) ;
V_206 -> V_249 = ( V_248 + V_206 -> V_249 ) >> 1 ;
V_246 -> V_199 = 0 ;
V_246 -> V_200 = 0 ;
}
static int F_160 ( struct V_55 * V_54 , int V_267 )
{
struct V_36 * V_26 = V_54 -> V_62 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_268 = F_139 ( V_1 , 0 ) ;
unsigned int V_269 = F_161 ( V_1 , 0 ) ;
unsigned int V_49 = F_41 () ;
unsigned int V_270 = V_267 ;
unsigned int V_271 = - 1 ;
unsigned int V_272 , V_273 = 0 , V_274 ;
int V_69 ;
V_274 = F_162 ( & V_1 -> V_206 [ V_269 ] , V_271 ,
F_12 , NULL ) ;
if ( ! F_163 ( & V_1 -> V_33 [ V_268 ] ) ) {
if ( V_274 > 0 )
F_164 ( & V_1 -> V_49 [ V_49 ] ,
V_274 ,
0 ,
...
0 ,
0 ) ;
V_69 = F_165 ( & V_1 -> V_33 [ 0 ] , F_132 ) ;
F_166 ( & V_1 -> V_33 [ V_268 ] , V_54 ) ;
if ( V_69 )
V_273 = V_270 ;
if ( V_1 -> V_244 . V_245 )
F_157 ( V_1 , & V_1 -> V_33 [ 0 ] ) ;
if ( V_273 < V_270 ) {
F_167 ( V_54 ) ;
if ( V_1 -> V_244 . V_245 )
F_154 ( V_1 , & V_1 -> V_33 [ 0 ] ) ;
F_46 ( & V_1 -> V_49 [ V_49 ] ) ;
}
return V_273 ;
}
...
unsigned int V_49 = F_155 ( V_1 , V_33 ) ;
unsigned int V_280 = - 1 ;
unsigned int V_272 ;
if ( ! F_175 ( & V_1 -> V_33 [ V_33 ] ) )
return V_281 ;
V_272 = F_162 ( & V_1 -> V_206 [ V_206 ] , V_280 ,
F_152 , NULL ) ;
if ( V_272 > 0 )
F_164 ( & V_1 -> V_49 [ V_49 ] ,
V_272 , 0 , 0 ) ;
F_165 ( & V_1 -> V_33 [ V_33 ] , F_132 ) ;
if ( V_1 -> V_244 . V_245 )
F_157 ( V_1 , & V_1 -> V_33 [ V_33 ] ) ;
F_176 ( & V_1 -> V_33 [ V_33 ] ) ;
return V_272 ;
}
static int F_177 ( struct V_55 * V_54 , int V_267 )
{
struct V_36 * V_26 = V_54 -> V_62 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
...
unsigned int V_283 ;
V_283 = V_11 -> V_207 ;
V_206 = F_161 ( V_1 , V_283 ) ;
V_49 = F_178 ( V_1 , V_283 ) ;
V_274 = F_162 ( & V_1 -> V_206 [ V_206 ] , V_271 ,
F_12 , NULL ) ;
F_164 ( & V_1 -> V_49 [ V_49 ] , V_274 ,
0 ,
1 ) ;
if ( ! V_274 ) {
F_167 ( V_54 ) ;
...
static int F_179 ( struct V_55 * V_54 , int V_267 )
{
struct V_36 * V_26 = V_54 -> V_62 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_33 = ( V_54 - & V_1 -> V_54 [ 0 ] ) ;
unsigned int V_206 = F_139 ( V_1 , V_33 ) ;
unsigned int V_49 = F_155 ( V_1 , V_33 ) ;
unsigned int V_280 = V_267 ;
unsigned int V_272 = 0 ;
int V_69 ;
if ( ! F_163 ( & V_1 -> V_33 [ V_33 ] ) )
return V_267 ;
if ( V_267 > 0 )
V_272 = F_162 ( & V_1 -> V_206 [ V_206 ] ,
V_280 , F_152 , NULL ) ;
if ( V_272 > 0 )
F_164 ( & V_1 -> V_49 [ V_49 ] ,
V_272 ,
0 ,
0 ) ;
V_69 = F_165 ( & V_1 -> V_33 [ V_33 ] , F_132 ) ;
if ( V_69 )
V_272 = V_280 ;
if ( V_1 -> V_244 . V_245 )
F_157 ( V_1 , & V_1 -> V_33 [ V_33 ] ) ;
F_166 ( & V_1 -> V_33 [ V_33 ] , V_54 ) ;
if ( V_272 < V_280 ) {
F_167 ( V_54 ) ;
if ( V_1 -> V_244 . V_245 )
F_154 ( V_1 , & V_1 -> V_33 [ V_33 ] ) ;
F_46 ( & V_1 -> V_49 [ V_49 ] ) ;
}
return V_272 ;
}
...
V_207 = V_301 ;
V_252 -> V_263 = V_302 [ V_207 ] . V_263 ;
V_252 -> V_264 = V_302 [ V_207 ] . V_264 ;
V_252 -> V_265 = V_303 ;
for ( V_207 = 0 ; V_207 < V_1 -> V_32 ; V_207 ++ )
V_1 -> V_206 [ V_207 ] . V_250 =
V_1 -> V_304 . V_305 ;
V_252 -> V_245 = 1 ;
}
...
switch ( F_171 ( V_1 -> V_14 ) ) {
default:
F_279 ( V_26 , & V_1 -> V_54 [ 0 ] , F_160 , 64 ) ;
F_280 ( & V_1 -> V_54 [ 0 ] ) ;
break;
case V_277 :
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ ) {
...
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ )
F_279 ( V_26 , & V_1 -> V_54 [ F_161 ( V_1 , V_29 ) ] ,
F_177 , V_358 ) ;
break;
}
return 0 ;
...
goto V_377;
#ifdef F_5
V_365 = F_299 ( V_2 , V_378 ) ;
if ( V_365 ) {
F_300 ( V_2 , V_365 + V_379 ,
& V_1 -> V_9 ) ;
if ( V_1 -> V_9 ) {
V_69 = F_301 ( V_2 , V_1 -> V_9 ) ;
if ( V_69 ) {
F_237 ( V_62 , L_43
L_44 ,
V_69 ) ;
...
#endif
V_1 -> V_154 = F_302 ( V_366 , sizeof( * V_1 -> V_154 ) , V_380 ) ;
if ( ! V_1 -> V_154 ) {
V_69 = - V_64 ;
goto V_381;
}
...
F_190 ( V_1 ) ;
F_308 ( & V_1 -> V_52 , F_254 ) ;
F_308 ( & V_1 -> V_40 , F_224 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ )
F_303 ( & V_1 -> V_25 [ V_29 ] ) ;
...
static void F_319 ( struct V_361 * V_2 )
{
struct V_36 * V_26 = F_320 ( V_2 ) ;
if ( V_26 ) {
struct V_1 * V_1 = F_40 ( V_26 ) ;
F_321 ( & V_1 -> V_52 ) ;
F_321 ( & V_1 -> V_40 ) ;
...
static int T_10 F_323 ( void )
{
F_324 ( L_52 , V_408 , V_409 ) ;
return F_325 ( & V_410 ) ;
}
