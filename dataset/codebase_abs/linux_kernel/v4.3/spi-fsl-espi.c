...
void F_45 ( struct V_3 * V_4 , T_3 V_94 )
{
struct V_9 * V_10 = V_4 -> V_10 ;
if ( V_94 & V_95 ) {
T_3 V_96 , V_15 ;
T_5 V_97 ;
while ( F_46 ( V_94 ) < F_47 ( 4 , V_4 -> V_40 ) ) {
F_48 () ;
V_94 = F_4 ( & V_10 -> V_98 ) ;
}
if ( V_4 -> V_40 >= 4 ) {
...
static T_6 F_52 ( T_7 V_101 , void * V_102 )
{
...
if ( V_94 )
V_46 = V_104 ;
F_53 ( V_4 -> V_39 , L_7 , V_105 , V_94 ) ;
F_45 ( V_4 , V_94 ) ;
return V_46 ;
}
static int F_54 ( struct V_106 * V_39 )
{
struct V_81 * V_5 = F_55 ( V_39 ) ;
...
static int F_56 ( struct V_106 * V_39 )
{
struct V_81 * V_5 = F_55 ( V_39 ) ;
struct V_3 * V_3 = F_2 ( V_5 ) ;
struct V_9 * V_10 = V_3 -> V_10 ;
...
static struct V_81 * F_57 ( struct V_106 * V_39 ,
struct V_108 * V_109 , unsigned int V_101 )
{
struct V_110 * V_111 = F_58 ( V_39 ) ;
struct V_81 * V_5 ;
struct V_3 * V_3 ;
struct V_9 * V_10 ;
struct V_112 * V_113 ;
...
V_5 -> V_120 = true ;
V_3 = F_2 ( V_5 ) ;
V_3 -> V_10 = F_63 ( V_39 , V_109 ) ;
if ( F_64 ( V_3 -> V_10 ) ) {
V_46 = F_65 ( V_3 -> V_10 ) ;
goto V_121;
}
V_10 = V_3 -> V_10 ;
V_46 = F_66 ( V_39 , V_3 -> V_101 , F_52 ,
0 , L_8 , V_3 ) ;
if ( V_46 )
goto V_121;
if ( V_3 -> V_16 & V_122 ) {
...
V_114 = F_68 ( V_113 , L_9 , & V_40 ) ;
if ( ! V_114 || V_40 < sizeof( * V_114 ) )
continue;
V_71 = F_69 ( V_114 ) ;
if ( V_71 < 0 || V_71 >= V_111 -> V_123 )
continue;
V_12 = V_124 ;
V_114 = F_68 ( V_113 , L_10 , & V_40 ) ;
if ( V_114 && V_40 >= sizeof( * V_114 ) ) {
V_12 &= ~ ( F_70 ( 0xf ) ) ;
V_12 |= F_70 ( F_69 ( V_114 ) ) ;
}
V_114 = F_68 ( V_113 , L_11 , & V_40 ) ;
if ( V_114 && V_40 >= sizeof( * V_114 ) ) {
V_12 &= ~ ( F_71 ( 0xf ) ) ;
V_12 |= F_71 ( F_69 ( V_114 ) ) ;
}
F_5 ( & V_10 -> V_12 [ V_71 ] , V_12 ) ;
F_72 ( V_39 , L_12 , V_71 , V_12 ) ;
}
V_107 = V_111 -> V_125 | V_126 | V_17 ;
F_5 ( & V_10 -> V_11 , V_107 ) ;
F_73 ( V_39 , V_127 ) ;
F_74 ( V_39 ) ;
F_75 ( V_39 ) ;
...
static int F_83 ( struct V_106 * V_39 )
{
struct V_112 * V_129 = V_39 -> V_130 ;
struct V_110 * V_111 = F_58 ( V_39 ) ;
const T_3 * V_114 ;
int V_40 ;
V_114 = F_68 ( V_129 , L_14 , & V_40 ) ;
if ( ! V_114 || V_40 < sizeof( * V_114 ) ) {
F_19 ( V_39 , L_15 ) ;
return - V_52 ;
}
...
{
struct V_106 * V_39 = & V_133 -> V_39 ;
struct V_112 * V_129 = V_133 -> V_39 . V_130 ;
struct V_81 * V_5 ;
struct V_108 V_109 ;
unsigned int V_101 ;
int V_46 = - V_73 ;
...
static int F_88 ( struct V_132 * V_39 )
{
F_79 ( & V_39 -> V_39 ) ;
return 0 ;
}
static int F_89 ( struct V_106 * V_39 )
{
struct V_81 * V_5 = F_55 ( V_39 ) ;
int V_46 ;
V_46 = F_90 ( V_5 ) ;
...
static int F_93 ( struct V_106 * V_39 )
{
struct V_110 * V_111 = F_58 ( V_39 ) ;
struct V_81 * V_5 = F_55 ( V_39 ) ;
struct V_3 * V_3 ;
...
F_5 ( & V_10 -> V_53 , 0 ) ;
F_5 ( & V_10 -> V_98 , 0xffffffff ) ;
for ( V_71 = 0 ; V_71 < V_111 -> V_123 ; V_71 ++ )
