...
F_80 ( V_123 ) ;
F_78 ( V_117 ) ;
F_81 ( V_119 , & V_123 , V_124 ) ;
if ( F_79 ( V_118 ) > V_114 && ! * V_120 )
F_82 () ;
F_83 ( V_119 , & V_123 ) ;
goto V_122;
}
...
static void F_87 ( int type , struct V_112 * V_113 )
{
int V_115 = type - 1 ;
struct V_112 * V_116 = & V_108 [ V_115 ] ;
T_8 * V_117 = & V_109 [ V_115 ] ;
...
int V_20 ;
for ( V_20 = 0 ; V_20 < V_107 ; V_20 ++ ) {
while ( ! F_76 ( & V_108 [ V_20 ] ) ) {
V_113 = V_108 [ V_20 ] . V_86 ;
F_77 ( V_113 ) ;
V_125 [ V_20 ] -> F_87 ( V_113 ) ;
F_85 ( & V_110 [ V_20 ] ) ;
}
}
}
int F_92 ( int type , struct V_79 * V_48 ,
...
if ( F_84 ( V_113 ) )
return F_93 ( V_113 ) ;
V_18 = V_125 [ type - 1 ] -> F_94 ( V_113 , V_48 ,
V_43 , V_54 , V_55 ,
V_127 , V_128 ,
V_129 , V_130 ,
V_131 ) ;
...
if ( F_84 ( V_113 ) )
return F_93 ( V_113 ) ;
V_18 = V_125 [ type - 1 ] -> F_95 ( V_113 , V_132 ,
V_17 ,
V_50 , V_133 , V_134 ) ;
F_87 ( type , V_113 ) ;
return V_18 ;
}
int F_96 ( int type , unsigned char * V_135 , struct V_19 * V_136 ,
...
if ( F_84 ( V_113 ) )
return F_93 ( V_113 ) ;
V_18 = V_125 [ type - 1 ] -> F_97 ( V_113 , V_135 ,
V_136 , V_137 ,
V_134 , V_138 ) ;
F_87 ( type , V_113 ) ;
return V_18 ;
...
int F_99 ( char * V_139 , unsigned long V_140 ,
...
V_143 = V_140 ;
while ( V_144 > 0 ) {
V_145 = F_100 ( V_29 - * V_141 ,
V_29 - V_142 ) ;
V_145 = F_100 ( V_145 , V_144 ) ;
V_21 = F_8 ( V_146 ) ;
...
void F_101 ( struct V_49 * V_50 , int V_133 ,
unsigned long V_63 ,
unsigned long V_141 )
{
while ( V_63 < V_133 ) {
