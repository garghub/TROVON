...
V_35 -> V_16 = F_30 ( V_46 -> V_47 . V_48 . V_49 ) ;
V_35 -> V_2 = V_8 ;
F_24 ( & V_44 ) ;
F_25 ( & V_35 -> V_45 , & V_6 ) ;
F_26 ( & V_44 ) ;
...
V_35 -> V_54 = F_52 ( F_4 ( V_7 ) ,
V_50 , & V_62 , 256 ) ;
if ( F_53 ( V_35 -> V_54 ) )
return F_54 ( V_35 -> V_54 ) ;
V_5 = F_55 ( 1 , & V_60 ) ;
if ( V_5 < 0 )
return V_5 ;
V_35 -> V_53 = V_60 ;
...
{
struct V_1 * V_35 = F_48 ( & V_56 -> V_56 ) ;
F_37 ( V_35 ) ;
memset ( V_35 -> V_16 , 0 , V_43 ) ;
return F_49 ( V_56 , V_35 ) ;
}
...
return V_32 ;
V_35 = F_1 ( V_8 ) ;
V_35 -> V_50 = F_51 ( V_35 -> V_10 ) ;
}
if ( V_35 -> V_50 < 0 )
V_35 -> V_50 = 0 ;
else
F_72 ( V_35 -> V_50 ) ;
V_35 -> V_54 = F_52 ( V_8 , V_35 -> V_50 , V_84 , 256 ) ;
if ( F_53 ( V_35 -> V_54 ) ) {
V_32 = F_54 ( V_35 -> V_54 ) ;
F_24 ( & V_44 ) ;
F_45 ( & V_35 -> V_45 ) ;
