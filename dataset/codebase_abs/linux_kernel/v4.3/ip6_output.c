...
( ( V_156 - V_146 ) & 7 ) ||
F_101 ( V_4 ) ||
F_37 ( V_4 ) < ( V_148 + sizeof( struct V_144 ) ) )
goto V_158;
F_102 (skb, frag) {
if ( V_142 -> V_31 > V_56 ||
( ( V_142 -> V_31 & 7 ) && V_142 -> V_81 ) ||
F_37 ( V_142 ) < ( V_146 + V_148 + sizeof( struct V_144 ) ) )
goto V_159;
if ( F_103 ( V_142 ) )
goto V_159;
F_104 ( V_142 -> V_2 ) ;
...
V_85 = 0 ;
* V_153 = V_163 ;
V_143 = F_105 ( F_58 ( V_4 ) , V_146 , V_24 ) ;
if ( ! V_143 ) {
F_14 ( V_46 , F_6 ( F_2 ( V_4 ) ) ,
V_75 ) ;
V_152 = - V_164 ;
...
V_145 -> V_65 = V_65 ;
V_145 -> V_167 = 0 ;
V_145 -> V_84 = F_3 ( V_168 ) ;
V_145 -> V_169 = V_150 ;
V_156 = F_100 ( V_4 ) ;
V_4 -> V_170 = V_156 - F_110 ( V_4 ) ;
V_4 -> V_31 = V_156 ;
...
#endif
( ! ( V_42 -> V_194 & V_195 ) &&
( V_42 -> V_196 && V_42 -> V_196 != V_6 -> V_8 -> V_83 ) ) ) {
F_127 ( V_6 ) ;
V_6 = NULL ;
}
V_186:
...
static int F_129 ( struct V_46 * V_46 , struct V_1 * V_2 ,
...
V_120 = (struct V_33 * ) * V_6 ;
F_18 () ;
V_197 = F_20 ( V_120 -> V_6 . V_8 ,
F_19 ( V_120 , & V_42 -> V_16 ) ) ;
V_152 = V_197 && ! ( V_197 -> V_201 & V_202 ) ? - V_36 : 0 ;
F_25 () ;
if ( V_152 ) {
struct V_203 * V_204 ;
struct V_41 V_205 ;
int V_206 ;
V_204 = F_134 ( V_46 , & V_42 -> V_22 ,
( * V_6 ) -> V_8 , 1 ) ;
V_206 = ( V_204 && V_204 -> V_19 & V_207 ) ;
if ( V_204 )
F_135 ( V_204 ) ;
if ( V_206 ) {
F_127 ( * V_6 ) ;
memcpy ( & V_205 , V_42 , sizeof( struct V_41 ) ) ;
memset ( & V_205 . V_16 , 0 , sizeof( struct V_11 ) ) ;
* V_6 = F_132 ( V_46 , V_2 , & V_205 ) ;
V_152 = ( * V_6 ) -> error ;
if ( V_152 )
goto V_200;
}
...
int F_136 ( struct V_46 * V_46 , struct V_1 * V_2 , struct V_5 * * V_6 ,
struct V_41 * V_42 )
{
* V_6 = NULL ;
return F_129 ( V_46 , V_2 , V_6 , V_42 ) ;
}
struct V_5 * F_137 ( struct V_1 * V_2 , struct V_41 * V_42 ,
const struct V_11 * V_209 )
{
struct V_5 * V_6 = NULL ;
int V_152 ;
V_152 = F_129 ( F_34 ( V_2 ) , V_2 , & V_6 , V_42 ) ;
if ( V_152 )
return F_138 ( V_152 ) ;
if ( V_209 )
V_42 -> V_16 = * V_209 ;
if ( ! V_42 -> V_196 )
V_42 -> V_196 = V_6 -> V_8 -> V_83 ;
return F_139 ( F_34 ( V_2 ) , V_6 , F_140 ( V_42 ) , V_2 , 0 ) ;
}
struct V_5 * F_141 ( struct V_1 * V_2 , struct V_41 * V_42 ,
const struct V_11 * V_209 )
{
struct V_5 * V_6 = F_142 ( V_2 , F_35 ( V_2 ) -> V_210 ) ;
int V_152 ;
...
int V_213 , struct V_3 * V_4 ) ,
void * V_140 , int V_214 , int V_215 , int V_216 ,
int V_217 , int V_56 , unsigned int V_19 ,
const struct V_41 * V_42 )
{
struct V_3 * V_4 ;
int V_152 ;
...
return V_152 ;
F_118 ( V_4 , V_215 ) ;
F_119 ( V_4 , V_216 + V_217 ) ;
F_44 ( V_4 ) ;
V_4 -> V_177 = V_4 -> V_178 + V_216 ;
V_4 -> V_14 = F_3 ( V_15 ) ;
V_4 -> V_219 = 0 ;
F_147 ( V_212 , V_4 ) ;
} else if ( F_28 ( V_4 ) ) {
...
V_4 -> V_171 = V_175 ;
F_106 ( V_4 ) -> V_221 = ( V_56 - V_216 -
sizeof( struct V_144 ) ) & ~ 7 ;
F_106 ( V_4 ) -> V_222 = V_223 ;
F_106 ( V_4 ) -> V_224 = F_98 ( F_34 ( V_2 ) ,
& V_42 -> V_16 ,
& V_42 -> V_22 ) ;
V_220:
...
static inline struct V_225 * F_149 ( struct V_225 * V_226 ,
T_5 V_227 )
{
return V_226 ? F_105 ( V_226 , ( V_226 -> V_228 + 1 ) * 8 , V_227 ) : NULL ;
}
static inline struct V_229 * F_150 ( struct V_229 * V_226 ,
T_5 V_227 )
{
return V_226 ? F_105 ( V_226 , ( V_226 -> V_228 + 1 ) * 8 , V_227 ) : NULL ;
}
...
unsigned int V_231 )
{
if ( ! ( V_120 -> V_6 . V_19 & V_232 ) ) {
if ( ! V_4 ) {
* V_56 = V_231 - V_120 -> V_6 . V_233 ;
} else {
* V_56 = V_231 ;
}
* V_230 = ( ( * V_56 - V_216 ) & ~ 7 )
...
static int F_152 ( struct V_1 * V_2 , struct V_234 * V_235 ,
struct V_236 * V_237 ,
...
if ( F_153 ( V_237 -> V_44 ) )
return - V_36 ;
V_237 -> V_44 = F_154 ( V_44 -> V_238 , V_2 -> V_239 ) ;
if ( F_21 ( ! V_237 -> V_44 ) )
return - V_61 ;
V_237 -> V_44 -> V_238 = V_44 -> V_238 ;
V_237 -> V_44 -> V_59 = V_44 -> V_59 ;
V_237 -> V_44 -> V_58 = V_44 -> V_58 ;
V_237 -> V_44 -> V_240 = F_149 ( V_44 -> V_240 ,
V_2 -> V_239 ) ;
if ( V_44 -> V_240 && ! V_237 -> V_44 -> V_240 )
return - V_61 ;
V_237 -> V_44 -> V_241 = F_149 ( V_44 -> V_241 ,
V_2 -> V_239 ) ;
if ( V_44 -> V_241 && ! V_237 -> V_44 -> V_241 )
return - V_61 ;
V_237 -> V_44 -> V_242 = F_149 ( V_44 -> V_242 ,
V_2 -> V_239 ) ;
if ( V_44 -> V_242 && ! V_237 -> V_44 -> V_242 )
return - V_61 ;
V_237 -> V_44 -> V_116 = F_150 ( V_44 -> V_116 ,
V_2 -> V_239 ) ;
if ( V_44 -> V_116 && ! V_237 -> V_44 -> V_116 )
return - V_61 ;
}
F_111 ( & V_120 -> V_6 ) ;
V_235 -> V_243 . V_6 = & V_120 -> V_6 ;
V_235 -> V_244 . V_245 . V_246 = * V_42 ;
V_237 -> V_28 = V_55 ;
V_237 -> V_45 = V_45 ;
if ( V_120 -> V_6 . V_19 & V_232 )
...
V_56 = V_48 -> V_247 >= V_248 ?
V_120 -> V_6 . V_8 -> V_56 : F_48 ( V_120 -> V_6 . V_249 ) ;
if ( V_48 -> V_155 < V_56 ) {
if ( V_48 -> V_155 )
V_56 = V_48 -> V_155 ;
}
V_235 -> V_243 . V_250 = V_56 ;
if ( F_29 ( V_120 -> V_6 . V_249 ) )
V_235 -> V_243 . V_19 |= V_251 ;
V_235 -> V_243 . V_214 = 0 ;
return 0 ;
}
...
int V_31 , int V_213 , struct V_3 * V_4 ) ,
void * V_140 , int V_214 , int V_217 ,
unsigned int V_19 , int V_255 )
{
struct V_3 * V_4 , * V_256 = NULL ;
...
T_6 V_260 = 0 ;
T_2 V_261 = 0 ;
struct V_33 * V_120 = (struct V_33 * ) V_235 -> V_6 ;
struct V_43 * V_44 = V_237 -> V_44 ;
int V_262 = V_172 ;
V_4 = F_145 ( V_212 ) ;
if ( ! V_4 ) {
V_257 = V_44 ? V_44 -> V_59 : 0 ;
V_258 = V_120 -> V_6 . V_233 - V_120 -> V_263 ;
}
V_56 = V_235 -> V_250 ;
V_231 = V_56 ;
V_215 = F_36 ( V_120 -> V_6 . V_8 ) ;
V_216 = sizeof( struct V_50 ) + V_120 -> V_263 +
( V_44 ? V_44 -> V_58 : 0 ) ;
V_230 = ( ( V_56 - V_216 ) & ~ 7 ) + V_216 -
sizeof( struct V_144 ) ;
if ( V_56 <= sizeof( struct V_50 ) + V_264 ) {
unsigned int V_265 , V_266 ;
V_266 = sizeof( struct V_50 ) +
( V_44 ? V_44 -> V_59 + V_44 -> V_58 : 0 ) +
( F_29 ( & V_120 -> V_6 ) ?
sizeof( struct V_144 ) : 0 ) +
V_120 -> V_263 ;
if ( F_156 ( V_2 ) )
V_265 = sizeof( struct V_50 ) + V_264 ;
else
V_265 = V_56 ;
if ( ( V_235 -> V_214 + V_214 > V_56 - V_266 ) && V_255 &&
( V_2 -> V_267 == V_268 ||
V_2 -> V_267 == V_269 ) ) {
F_157 ( V_2 , V_42 , V_56 - V_266 +
sizeof( struct V_50 ) ) ;
goto V_270;
}
if ( V_235 -> V_214 + V_214 > V_265 - V_266 ) {
V_270:
F_49 ( V_2 , V_74 , V_42 ,
V_56 - V_266 +
sizeof( struct V_50 ) ) ;
...
if ( V_2 -> V_271 == V_272 || V_2 -> V_271 == V_273 ) {
F_158 ( V_2 , & V_260 ) ;
if ( V_260 & V_274 &&
V_2 -> V_275 & V_276 )
V_261 = V_2 -> V_277 ++ ;
}
if ( V_217 && V_2 -> V_267 == V_268 &&
V_214 + V_216 < V_56 &&
V_120 -> V_6 . V_8 -> V_278 & V_279 &&
! V_257 )
V_262 = V_175 ;
V_235 -> V_214 += V_214 ;
if ( ( ( V_214 > V_56 ) ||
( V_4 && F_28 ( V_4 ) ) ) &&
( V_2 -> V_267 == V_268 ) &&
( V_120 -> V_6 . V_8 -> V_278 & V_280 ) &&
( V_2 -> V_271 == V_272 ) ) {
V_152 = F_143 ( V_2 , V_212 , F_144 , V_140 , V_214 ,
V_215 , V_216 ,
V_217 , V_56 , V_19 , V_42 ) ;
if ( V_152 )
goto error;
return 0 ;
}
...
goto V_281;
while ( V_214 > 0 ) {
V_259 = ( V_235 -> V_214 <= V_56 && ! ( V_235 -> V_19 & V_251 ) ? V_56 : V_230 ) - V_4 -> V_31 ;
if ( V_259 < V_214 )
V_259 = V_230 - V_4 -> V_31 ;
if ( V_259 <= 0 ) {
char * V_89 ;
unsigned int V_282 ;
unsigned int V_283 ;
...
V_256 = V_4 ;
V_282 = V_214 + V_284 ;
if ( V_282 > ( V_235 -> V_214 <= V_56 && ! ( V_235 -> V_19 & V_251 ) ? V_56 : V_230 ) - V_216 )
V_282 = V_230 - V_216 - V_120 -> V_6 . V_286 ;
if ( ( V_19 & V_287 ) &&
! ( V_120 -> V_6 . V_8 -> V_278 & V_288 ) )
V_285 = V_56 ;
else
V_285 = V_282 + V_216 ;
V_285 += V_258 ;
if ( V_282 != V_214 + V_284 ) {
V_282 += V_120 -> V_6 . V_286 ;
}
V_285 += V_120 -> V_6 . V_286 ;
V_283 = V_282 + V_216 ;
V_285 += sizeof( struct V_144 ) ;
if ( V_217 ) {
V_4 = F_146 ( V_2 ,
V_285 + V_215 ,
( V_19 & V_218 ) , & V_152 ) ;
...
V_4 -> V_171 = V_262 ;
V_4 -> V_219 = 0 ;
F_118 ( V_4 , V_215 + sizeof( struct V_144 ) +
V_258 ) ;
F_106 ( V_4 ) -> V_260 = V_260 ;
V_260 = 0 ;
F_106 ( V_4 ) -> V_261 = V_261 ;
V_261 = 0 ;
V_89 = F_119 ( V_4 , V_283 ) ;
F_161 ( V_4 , V_257 ) ;
V_89 += V_216 ;
V_4 -> V_177 = ( V_4 -> V_178 +
V_216 ) ;
...
V_256 , V_230 ,
V_89 + V_217 , V_284 , 0 ) ;
V_256 -> V_219 = F_163 ( V_256 -> V_219 ,
V_4 -> V_219 ) ;
V_89 += V_284 ;
F_164 ( V_256 , V_230 ) ;
}
V_259 = V_282 - V_217 - V_284 ;
if ( V_259 < 0 ) {
V_152 = - V_36 ;
F_15 ( V_4 ) ;
goto error;
} else if ( V_259 > 0 && F_144 ( V_140 , V_89 + V_217 , V_85 , V_259 , V_284 , V_4 ) < 0 ) {
V_152 = - V_291 ;
F_15 ( V_4 ) ;
goto error;
}
...
if ( V_259 > V_214 )
V_259 = V_214 ;
if ( ! ( V_120 -> V_6 . V_8 -> V_278 & V_288 ) ) {
unsigned int V_292 ;
V_292 = V_4 -> V_31 ;
if ( F_144 ( V_140 , F_119 ( V_4 , V_259 ) ,
V_85 , V_259 , V_292 , V_4 ) < 0 ) {
F_165 ( V_4 , V_292 ) ;
V_152 = - V_291 ;
goto error;
}
} else {
int V_293 = F_106 ( V_4 ) -> V_294 ;
V_152 = - V_164 ;
if ( ! F_166 ( V_2 , V_254 ) )
goto error;
if ( ! F_167 ( V_4 , V_293 , V_254 -> V_295 ,
V_254 -> V_85 ) ) {
V_152 = - V_74 ;
if ( V_293 == V_296 )
goto error;
F_168 ( V_4 , V_293 , V_254 -> V_295 ,
V_254 -> V_85 , 0 ) ;
F_106 ( V_4 ) -> V_294 = ++ V_293 ;
F_169 ( V_254 -> V_295 ) ;
}
V_259 = F_170 ( int , V_259 , V_254 -> V_297 - V_254 -> V_85 ) ;
if ( F_144 ( V_140 ,
F_171 ( V_254 -> V_295 ) + V_254 -> V_85 ,
V_85 , V_259 , V_4 -> V_31 , V_4 ) < 0 )
goto V_298;
V_254 -> V_85 += V_259 ;
F_172 ( & F_106 ( V_4 ) -> V_299 [ V_293 - 1 ] , V_259 ) ;
V_4 -> V_31 += V_259 ;
V_4 -> V_170 += V_259 ;
V_4 -> V_162 += V_259 ;
F_173 ( V_259 , & V_2 -> V_289 ) ;
}
V_85 += V_259 ;
V_214 -= V_259 ;
}
...
error:
V_235 -> V_214 -= V_214 ;
F_14 ( F_34 ( V_2 ) , V_120 -> V_300 , V_29 ) ;
return V_152 ;
}
...
struct V_33 * V_120 , unsigned int V_19 , int V_255 )
{
struct V_301 * V_302 = F_175 ( V_2 ) ;
struct V_47 * V_48 = F_35 ( V_2 ) ;
int V_257 ;
int V_152 ;
if ( V_19 & V_303 )
return 0 ;
if ( F_176 ( & V_2 -> V_304 ) ) {
V_152 = F_152 ( V_2 , & V_302 -> V_235 , & V_48 -> V_235 , V_55 ,
...
V_42 = & V_302 -> V_235 . V_244 . V_245 . V_246 ;
V_217 = 0 ;
}
return F_155 ( V_2 , V_42 , & V_2 -> V_304 , & V_302 -> V_235 . V_243 ,
& V_48 -> V_235 , F_177 ( V_2 ) , F_144 ,
V_140 , V_214 , V_217 , V_19 , V_255 ) ;
}
static void F_178 ( struct V_234 * V_235 ,
struct V_236 * V_237 )
{
if ( V_237 -> V_44 ) {
F_113 ( V_237 -> V_44 -> V_240 ) ;
F_113 ( V_237 -> V_44 -> V_241 ) ;
F_113 ( V_237 -> V_44 -> V_242 ) ;
F_113 ( V_237 -> V_44 -> V_116 ) ;
F_113 ( V_237 -> V_44 ) ;
V_237 -> V_44 = NULL ;
}
if ( V_235 -> V_243 . V_6 ) {
F_127 ( V_235 -> V_243 . V_6 ) ;
V_235 -> V_243 . V_6 = NULL ;
V_235 -> V_243 . V_19 &= ~ V_251 ;
}
...
struct V_236 * V_237 )
{
struct V_3 * V_4 , * V_305 ;
struct V_3 * * V_306 ;
struct V_11 V_307 , * V_209 = & V_307 ;
struct V_47 * V_48 = F_35 ( V_2 ) ;
struct V_46 * V_46 = F_34 ( V_2 ) ;
struct V_50 * V_51 ;
struct V_43 * V_44 = V_237 -> V_44 ;
struct V_33 * V_120 = (struct V_33 * ) V_235 -> V_243 . V_6 ;
struct V_41 * V_42 = & V_235 -> V_244 . V_245 . V_246 ;
unsigned char V_52 = V_42 -> V_53 ;
V_4 = F_180 ( V_212 ) ;
if ( ! V_4 )
goto V_186;
V_306 = & ( F_106 ( V_4 ) -> V_166 ) ;
if ( V_4 -> V_89 < F_58 ( V_4 ) )
F_108 ( V_4 , F_181 ( V_4 ) ) ;
while ( ( V_305 = F_180 ( V_212 ) ) != NULL ) {
F_108 ( V_305 , F_182 ( V_4 ) ) ;
* V_306 = V_305 ;
V_306 = & ( V_305 -> V_81 ) ;
V_4 -> V_31 += V_305 -> V_31 ;
V_4 -> V_170 += V_305 -> V_31 ;
V_4 -> V_162 += V_305 -> V_162 ;
V_305 -> V_160 = NULL ;
V_305 -> V_2 = NULL ;
}
V_4 -> V_70 = F_156 ( V_2 ) ;
...
F_41 ( V_4 , V_44 , & V_52 ) ;
if ( V_44 && V_44 -> V_58 )
F_42 ( V_4 , V_44 , & V_52 , & V_209 ) ;
F_43 ( V_4 , sizeof( struct V_50 ) ) ;
F_44 ( V_4 ) ;
V_51 = F_5 ( V_4 ) ;
F_46 ( V_51 , V_237 -> V_45 ,
F_47 ( V_46 , V_4 , V_42 -> V_62 ,
V_48 -> V_63 , V_42 ) ) ;
V_51 -> V_28 = V_237 -> V_28 ;
V_51 -> V_65 = V_52 ;
V_51 -> V_22 = V_42 -> V_22 ;
V_51 -> V_16 = * V_209 ;
V_4 -> V_66 = V_2 -> V_67 ;
...
F_16 ( V_46 , V_120 -> V_300 , V_71 , V_4 -> V_31 ) ;
if ( V_52 == V_86 ) {
struct V_17 * V_18 = F_6 ( F_2 ( V_4 ) ) ;
F_183 ( V_46 , V_18 , F_184 ( V_4 ) -> V_90 ) ;
F_185 ( V_46 , V_18 , V_308 ) ;
}
F_178 ( V_235 , V_237 ) ;
V_186:
return V_4 ;
...
{
F_191 ( V_2 , & V_2 -> V_304 ,
& F_175 ( V_2 ) -> V_235 , & F_35 ( V_2 ) -> V_235 ) ;
}
...
V_235 . V_243 . V_19 = 0 ;
V_235 . V_243 . V_185 = 0 ;
V_235 . V_243 . V_44 = NULL ;
V_237 . V_44 = NULL ;
V_152 = F_152 ( V_2 , & V_235 , & V_237 , V_55 , V_45 , V_44 , V_120 , V_42 ) ;
if ( V_152 )
return F_138 ( V_152 ) ;
if ( V_255 < 0 )
V_255 = F_35 ( V_2 ) -> V_255 ;
V_152 = F_155 ( V_2 , V_42 , & V_212 , & V_235 . V_243 , & V_237 ,
& V_309 -> V_310 , F_144 , V_140 ,
V_214 + V_257 , V_217 + V_257 ,
V_19 , V_255 ) ;
if ( V_152 ) {
F_191 ( V_2 , & V_212 , & V_235 , & V_237 ) ;
return F_138 ( V_152 ) ;
}
return F_179 ( V_2 , & V_212 , & V_235 , & V_237 ) ;
}
