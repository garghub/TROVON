...
{
struct V_89 * V_90 = F_34 ( V_163 , struct V_89 , V_164 ) ;
if ( V_162 -> V_165 )
F_52 ( V_90 , V_162 -> V_165 ) ;
else
V_90 -> V_158 = V_166 ;
}
...
static bool F_69 ( struct V_161 * V_162 , struct V_50 * V_51 )
{
struct V_89 * V_90 = V_51 -> V_52 ;
...
static void F_75 ( struct V_161 * V_162 , void * V_163 )
{
struct V_50 * V_51 = V_163 ;
struct V_89 * V_90 = V_51 -> V_52 ;
F_2 ( L_15 , V_34 ,
...
if ( V_51 -> V_68 ) {
F_76 ( V_162 -> V_165 ) ;
V_162 -> V_165 = V_51 -> V_68 ;
}
switch ( V_51 -> V_184 -> V_185 ( V_51 , V_162 ) ) {
case 0 :
V_162 -> V_165 = 0 ;
F_74 ( V_162 ) ;
return;
...
{
F_56 ( V_187 , & V_90 -> V_169 ) ;
F_57 ( & V_90 -> V_164 ) ;
F_59 ( V_170 ) ;
}
static struct V_188 * F_84 ( struct V_89 * V_90 )
{
struct V_20 * V_189 ;
struct V_188 * V_190 ;
F_85 (s, &clp->cl_sessions, se_perclnt) {
F_85 (c, &s->se_conns, cn_persession) {
...
if ( V_90 -> V_147 . V_146 ) {
F_88 ( V_90 -> V_147 . V_146 ) ;
V_90 -> V_147 . V_146 = NULL ;
}
if ( F_89 ( V_187 , & V_90 -> V_169 ) )
return;
F_61 ( & V_90 -> V_171 ) ;
F_8 ( ! ( V_90 -> V_169 & V_194 ) ) ;
F_72 ( V_168 , & V_90 -> V_169 ) ;
...
struct V_207 * V_208 , enum V_209 V_8 )
{
V_51 -> V_52 = V_90 ;
