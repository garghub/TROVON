...
static int F_26 ( struct V_3 * V_4 , unsigned long V_22 )
{
return - V_44 ;
}
static void F_27 ( struct V_3 * V_4 , struct V_45 * V_22 )
{
struct V_7 * V_8 = F_14 ( V_4 -> V_9 ) ;
...
static int F_28 ( struct V_17 * V_17 , struct V_3 * V_4 , unsigned long V_50 ,
...
if ( V_52 == NULL )
goto V_54;
if ( F_30 ( V_2 , & V_8 -> V_13 ) < 0 ||
F_31 ( V_2 , & V_8 -> V_11 , V_42 ) < 0 )
goto V_54;
F_32 ( V_2 , V_52 ) ;
if ( F_33 ( V_2 , & V_8 -> V_13 ) < 0 )
goto V_54;
return V_2 -> V_55 ;
V_54:
F_34 ( V_2 , V_52 ) ;
