...
V_23 -> V_66 . V_116 = F_90 ;
V_23 -> V_66 . V_117 = F_93 ;
V_23 -> V_66 . V_118 = F_96 ;
V_23 -> V_66 . V_119 = F_99 ;
V_23 -> V_66 . V_120 = F_103 ;
V_23 -> V_66 . V_121 = F_105 ;
V_23 -> V_66 . V_98 = F_75 ;
V_23 -> V_66 . V_122 = F_102 ;
...
static int F_115 ( struct V_123 * V_33 ,
const T_2 * V_34 , unsigned int V_35 )
{
struct V_124 * V_37 = F_116 ( V_33 ) ;
struct V_123 * V_39 = V_37 -> V_39 ;
return F_117 ( V_39 , V_34 , V_35 ) ;
}
static int F_118 ( struct V_123 * V_33 ,
unsigned int V_125 )
{
struct V_124 * V_37 = F_116 ( V_33 ) ;
struct V_123 * V_39 = V_37 -> V_39 ;
return F_119 ( V_39 , V_125 ) ;
}
static void F_120 ( struct V_126 * V_16 ,
struct V_123 * V_39 ,
int V_13 ,
int (* F_39)( struct V_126 * V_16 ) )
{
struct V_127 * V_50 ;
T_3 V_59 ;
V_50 = F_121 ( V_16 ) ;
...
static void F_123 ( struct V_11 * V_128 , int V_13 )
{
struct V_124 * V_37 = F_43 ( V_128 -> V_21 ) ;
struct V_123 * V_39 = V_37 -> V_39 ;
struct V_126 * V_16 ;
V_16 = F_16 ( V_128 , struct V_126 , V_56 ) ;
F_120 ( V_16 , V_39 , V_13 , F_124 ( V_39 ) -> V_57 ) ;
}
static void F_125 ( struct V_11 * V_128 , int V_13 )
{
struct V_124 * V_37 = F_43 ( V_128 -> V_21 ) ;
struct V_123 * V_39 = V_37 -> V_39 ;
struct V_126 * V_16 ;
...
static int F_126 ( struct V_126 * V_16 ,
T_3 V_59 )
{
struct V_127 * V_50 = F_121 ( V_16 ) ;
struct V_123 * V_21 = F_127 ( V_16 ) ;
struct V_1 * V_2 = F_24 ( F_128 ( V_21 ) ) ;
V_50 -> V_18 = V_16 -> V_56 . V_18 ;
V_16 -> V_56 . V_18 = V_59 ;
return F_10 ( V_2 , & V_16 -> V_56 ) ;
}
static int F_129 ( struct V_126 * V_16 )
{
return F_126 ( V_16 , F_123 ) ;
}
static int F_130 ( struct V_126 * V_16 )
{
return F_126 ( V_16 , F_125 ) ;
}
static int F_131 ( struct V_123 * V_21 )
{
struct V_129 * V_23 = F_132 ( V_21 ) ;
struct V_130 * V_25 = V_130 ( V_23 ) ;
struct V_131 * V_61 = & V_25 -> V_132 ;
struct V_124 * V_37 = F_116 ( V_21 ) ;
struct V_123 * V_62 ;
V_62 = F_133 ( V_61 ) ;
if ( F_29 ( V_62 ) )
return F_54 ( V_62 ) ;
V_37 -> V_39 = V_62 ;
F_134 (
V_21 , F_135 ( ( unsigned ) sizeof( struct V_127 ) ,
F_136 ( V_62 ) ) ) ;
return 0 ;
}
static void F_137 ( struct V_123 * V_21 )
{
struct V_124 * V_37 = F_116 ( V_21 ) ;
F_138 ( V_37 -> V_39 ) ;
}
...
V_37 = V_130 ( V_23 ) ;
V_37 -> V_2 = V_2 ;
F_141 ( & V_37 -> V_132 , F_142 ( V_23 ) ) ;
V_13 = F_143 ( & V_37 -> V_132 , V_134 , type , V_28 ) ;
if ( V_13 )
goto V_78;
V_66 = F_144 ( & V_37 -> V_132 ) ;
V_13 = F_57 ( F_142 ( V_23 ) , & V_66 -> V_56 ) ;
if ( V_13 )
goto V_135;
V_23 -> V_66 . V_56 . V_86 = V_84 |
( V_66 -> V_56 . V_86 & V_31 ) ;
V_23 -> V_66 . V_56 . V_95 = sizeof( struct V_124 ) ;
V_23 -> V_66 . V_90 = F_145 ( V_66 ) ;
V_23 -> V_66 . V_136 = F_146 ( V_66 ) ;
V_23 -> V_66 . V_116 = F_131 ;
V_23 -> V_66 . exit = F_137 ;
V_23 -> V_66 . V_98 = F_115 ;
V_23 -> V_66 . V_137 = F_118 ;
...
struct V_99 * V_141 = F_26 ( V_23 ) ;
struct V_130 * V_142 = F_26 ( V_23 ) ;
...
struct V_144 * F_151 ( const char * V_145 ,
T_1 type , T_1 V_28 )
{
char V_146 [ V_68 ] ;
struct V_20 * V_21 ;
if ( snprintf ( V_146 , V_68 ,
L_1 , V_145 ) >= V_68 )
return F_60 ( - V_140 ) ;
type &= ~ ( V_82 | V_147 ) ;
type |= V_81 ;
V_28 &= ~ V_82 ;
V_28 |= ( V_147 | V_148 ) ;
V_21 = F_152 ( V_146 , type , V_28 ) ;
if ( F_29 ( V_21 ) )
return F_153 ( V_21 ) ;
if ( V_21 -> V_149 -> V_150 != V_151 ) {
F_154 ( V_21 ) ;
return F_60 ( - V_140 ) ;
}
return F_155 ( F_156 ( V_21 ) ) ;
}
struct V_38 * F_157 ( struct V_144 * V_21 )
{
struct V_36 * V_37 = F_31 ( & V_21 -> V_56 ) ;
return V_37 -> V_39 ;
}
void F_158 ( struct V_144 * V_21 )
{
F_159 ( & V_21 -> V_56 ) ;
}
struct V_152 * F_160 ( const char * V_145 ,
T_1 type , T_1 V_28 )
{
char V_146 [ V_68 ] ;
struct V_105 * V_21 ;
...
L_1 , V_145 ) >= V_68 )
return F_60 ( - V_140 ) ;
V_21 = F_161 ( V_146 , type , V_28 ) ;
if ( F_29 ( V_21 ) )
return F_153 ( V_21 ) ;
if ( V_21 -> V_56 . V_149 -> V_150 != V_151 ) {
F_162 ( V_21 ) ;
return F_60 ( - V_140 ) ;
}
return F_163 ( V_21 ) ;
}
struct V_102 * F_164 ( struct V_152 * V_21 )
{
struct V_101 * V_37 = F_76 ( & V_21 -> V_56 ) ;
return V_37 -> V_39 ;
}
struct V_108 * F_165 ( struct V_106 * V_16 )
{
struct V_104 * V_50 = F_84 ( V_16 ) ;
return & V_50 -> V_44 ;
}
void F_166 ( struct V_152 * V_21 )
{
F_162 ( & V_21 -> V_56 ) ;
}
struct V_153 * F_167 ( const char * V_145 ,
T_1 type , T_1 V_28 )
{
char V_146 [ V_68 ] ;
struct V_123 * V_21 ;
...
struct V_123 * F_170 ( struct V_153 * V_21 )
{
struct V_124 * V_37 ;
V_37 = F_116 ( & V_21 -> V_56 ) ;
return V_37 -> V_39 ;
}
void F_171 ( struct V_153 * V_21 )
{
F_138 ( & V_21 -> V_56 ) ;
}
