...
return F_60 ( F_61 ( V_48 ) ) ;
return F_51 ( F_62 ( V_48 ) ) ;
}
static T_5 * F_63 ( struct V_49 * V_50 )
{
void * V_51 , * V_29 ;
F_64 ( & V_50 -> V_52 ) ;
V_29 = V_50 -> V_53 . V_51 ;
...
static T_5 * F_66 ( struct V_49 * V_50 , int V_55 )
{
void * V_29 = NULL ;
struct V_45 * V_45 = F_67 ( V_56 | V_57 |
V_58 | V_59 ) ;
if ( ! V_45 )
return NULL ;
if ( ! V_55 && ! F_68 ( V_45 ) ) {
...
T_5 * F_73 ( struct V_49 * V_50 , unsigned long V_62 , int V_55 )
{
T_5 * V_63 ;
V_63 = F_63 ( V_50 ) ;
if ( V_63 )
return V_63 ;
return F_66 ( V_50 , V_55 ) ;
}
void F_74 ( struct V_49 * V_50 , unsigned long * V_64 , int V_55 )
{
...
void F_79 ( struct V_65 * V_66 , void * V_64 , int V_67 )
{
...
int F_84 ( struct V_71 * V_72 , unsigned long V_73 ,
...
V_76 = ! F_87 ( * ( V_9 ) , V_74 ) ;
if ( V_76 ) {
F_88 ( F_89 ( V_9 ) , F_90 ( V_74 ) ) ;
}
return V_76 ;
}
unsigned long F_91 ( struct V_49 * V_50 , unsigned long V_26 ,
...
#else
V_80 = F_93 ( * V_9 ) ;
* V_9 = F_94 ( ( V_80 & ~ V_78 ) | V_79 ) ;
#endif
F_95 ( V_26 , V_80 , V_78 , V_79 ) ;
if ( V_80 & V_82 )
F_96 ( V_50 , V_26 , V_9 , V_80 ) ;
return V_80 ;
}
T_4 F_97 ( struct V_71 * V_72 , unsigned long V_73 ,
T_4 * V_9 )
{
T_4 V_48 ;
F_98 ( V_73 & ~ V_83 ) ;
...
F_99 ( V_9 ) ;
F_100 () ;
F_101 ( V_72 -> V_77 , & V_48 , V_73 ) ;
return V_48 ;
}
int F_102 ( struct V_71 * V_72 ,
unsigned long V_73 , T_4 * V_9 )
{
return F_103 ( V_72 -> V_77 , V_73 , V_9 ) ;
}
...
if ( ! ( V_80 & V_84 ) ) {
if ( V_80 & V_82 )
F_96 ( V_72 -> V_77 , V_73 , V_9 , V_80 ) ;
}
F_100 () ;
}
void F_107 ( struct V_49 * V_50 , T_4 * V_9 ,
T_8 V_85 )
{
T_8 * V_86 ;
F_86 ( & V_50 -> V_52 ) ;
...
T_8 F_108 ( struct V_49 * V_50 , T_4 * V_9 )
{
T_8 V_85 ;
T_8 * V_86 ;
F_86 ( & V_50 -> V_52 ) ;
...
void F_109 ( struct V_49 * V_50 , unsigned long V_26 ,
T_4 * V_9 , T_4 V_48 )
{
#ifdef F_85
F_31 ( ( F_93 ( * V_9 ) & ( V_20 | V_40 ) ) ==
( V_20 | V_40 ) ) ;
F_86 ( & V_50 -> V_52 ) ;
F_31 ( ! F_58 ( V_48 ) ) ;
#endif
F_110 ( V_26 , F_93 ( V_48 ) ) ;
return F_11 ( V_50 , V_26 , F_89 ( V_9 ) , F_90 ( V_48 ) ) ;
}
void F_111 ( struct V_71 * V_72 , unsigned long V_73 ,
T_4 * V_9 )
{
F_91 ( V_72 -> V_77 , V_73 , V_9 , V_20 , 0 ) ;
}
void F_96 ( struct V_49 * V_50 , unsigned long V_26 ,
...
if ( ! F_113 ( V_26 ) ) {
V_89 = F_114 ( V_26 ) ;
V_91 = F_115 ( V_50 -> V_53 . V_97 , V_26 , V_89 ) ;
F_31 ( V_91 == 0 ) ;
} else {
V_91 = F_116 ( V_26 , V_17 ) ;
V_89 = V_17 ;
}
V_81 = F_117 ( F_118 () ) ;
if ( F_119 ( F_120 ( V_50 ) , V_81 ) )
V_6 |= V_98 ;
return F_121 ( V_91 , V_26 , V_9 , V_90 , V_89 , V_6 ) ;
}
static T_4 F_122 ( T_4 V_48 , T_9 V_99 )
{
F_93 ( V_48 ) |= F_30 ( V_99 ) ;
return V_48 ;
}
T_4 F_123 ( unsigned long V_100 , T_9 V_99 )
{
T_4 V_48 ;
F_93 ( V_48 ) = V_100 << V_101 ;
F_93 ( V_48 ) |= V_102 ;
V_48 = F_122 ( V_48 , V_99 ) ;
return V_48 ;
}
T_4 F_124 ( struct V_45 * V_45 , T_9 V_99 )
{
return F_123 ( F_125 ( V_45 ) , V_99 ) ;
}
T_4 F_126 ( T_4 V_48 , T_9 V_103 )
{
F_93 ( V_48 ) &= V_104 ;
V_48 = F_122 ( V_48 , V_103 ) ;
return V_48 ;
}
void F_127 ( struct V_71 * V_72 , unsigned long V_26 ,
T_4 * V_48 )
{
return;
}
T_4 F_128 ( struct V_49 * V_50 ,
