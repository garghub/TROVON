...
if ( F_135 ( V_23 ) )
return F_136 ( V_23 ) ;
V_53 -> V_399 [ V_247 ++ ] = V_23 ;
V_23 = F_23 ( V_19 , & V_400 ,
F_137 ( V_53 -> V_121 ) ) ;
if ( F_135 ( V_23 ) )
return F_136 ( V_23 ) ;
V_53 -> V_399 [ V_247 ++ ] = V_23 ;
V_23 = F_23 ( V_19 , & V_401 ,
F_137 ( V_53 -> V_73 ) ) ;
if ( F_135 ( V_23 ) )
return F_136 ( V_23 ) ;
V_53 -> V_399 [ V_247 ++ ] = V_23 ;
...
return F_136 ( V_23 ) ;
V_53 -> V_399 [ V_247 ++ ] = V_23 ;
V_53 -> V_399 [ V_247 ++ ] = & V_403 ;
V_246 = F_138 ( V_19 , V_53 -> V_41 ,
V_53 , V_53 -> V_399 ) ;
return F_139 ( V_246 ) ;
}
static void F_140 ( int V_404 )
{
int V_3 ;
V_3 = F_3 ( V_404 , V_405 ) ;
if ( V_3 & 0x10 ) {
...
if ( V_53 -> V_54 == V_56 ) {
V_53 -> V_406 = F_30 ( V_53 , V_70 ) ;
V_53 -> V_407 = F_30 ( V_53 , V_72 ) ;
}
F_52 ( & V_53 -> V_115 ) ;
return 0 ;
}
...
if ( V_53 -> V_54 == V_56 ) {
F_32 ( V_53 , V_70 , V_53 -> V_406 ) ;
F_32 ( V_53 , V_72 , V_53 -> V_407 ) ;
}
abort:
V_53 -> V_119 = false ;
F_52 ( & V_53 -> V_115 ) ;
...
static int T_8 F_144 ( int V_404 , struct V_233 * V_234 )
{
T_2 V_3 ;
int V_151 ;
int V_64 ;
...
struct V_235 V_67 ;
struct V_233 V_234 ;
int V_404 [ 2 ] = { 0x2e , 0x4e } ;
V_151 = F_149 ( & V_423 ) ;
if ( V_151 )
return V_151 ;
for ( V_34 = 0 ; V_34 < F_40 ( V_232 ) ; V_34 ++ ) {
V_422 = F_144 ( V_404 [ V_34 ] , & V_234 ) ;
if ( V_422 <= 0 )
continue;
V_421 = true ;
V_232 [ V_34 ] = F_150 ( V_6 , V_422 ) ;
if ( ! V_232 [ V_34 ] ) {
V_151 = - V_39 ;
goto V_424;
}
...
V_67 . V_41 = V_6 ;
V_67 . V_249 = V_422 + V_426 ;
V_67 . V_427 = V_422 + V_426 + V_250 - 1 ;
V_67 . V_428 = V_248 ;
V_151 = F_152 ( & V_67 ) ;
if ( V_151 ) {
F_153 ( V_232 [ V_34 ] ) ;
