...
static int F_57 ( struct V_100 * V_15 , unsigned V_122 ,
unsigned long V_123 )
{
struct V_2 * V_3 = V_15 -> V_101 ;
int V_50 = 0 ;
if ( V_3 -> V_14 ||
V_15 -> V_72 != F_58 ( V_3 -> V_40 -> V_103 -> V_124 ) >> V_105 )
V_50 = F_59 ( NULL , V_122 ) ;
return V_50 ? : F_60 ( V_3 -> V_40 -> V_103 , V_3 -> V_40 -> V_45 ,
V_122 , V_123 ) ;
}
static int F_61 ( struct V_100 * V_15 ,
T_4 V_125 , void * V_49 )
{
struct V_2 * V_3 = V_15 -> V_101 ;
return V_125 ( V_15 , V_3 -> V_40 , V_3 -> V_14 , V_15 -> V_72 , V_49 ) ;
}
static void F_62 ( struct V_100 * V_15 , struct V_126 * V_127 )
{
struct V_2 * V_3 = V_15 -> V_101 ;
if ( V_127 -> V_128 < 1 << V_3 -> V_70 )
V_127 -> V_128 = 1 << V_3 -> V_70 ;
if ( V_127 -> V_129 < 1 << V_3 -> V_70 )
V_127 -> V_129 = 1 << V_3 -> V_70 ;
F_63 ( V_127 , V_127 -> V_128 ) ;
}
static void F_64 ( struct V_100 * V_15 )
{
struct V_2 * V_3 = V_15 -> V_101 ;
if ( V_3 -> V_87 )
F_65 ( V_3 -> V_87 ) ;
...
static int F_69 ( struct V_100 * V_15 , unsigned V_130 , char * * V_131 )
{
struct V_2 * V_3 ;
struct V_132 V_133 ;
const char * V_134 ;
...
V_3 = F_70 ( sizeof( struct V_2 ) , V_142 ) ;
if ( ! V_3 ) {
V_15 -> error = L_20 ;
return - V_143 ;
}
...
if ( sscanf ( V_131 [ 0 ] , L_23 , & V_135 , & V_139 ) != 1 ||
V_135 > 1 ) {
V_15 -> error = L_24 ;
V_50 = - V_145 ;
goto V_146;
...
V_3 -> V_24 = V_135 ;
V_50 = F_72 ( V_15 , V_131 [ 1 ] , V_144 , & V_3 -> V_40 ) ;
if ( V_50 ) {
V_15 -> error = L_25 ;
goto V_146;
}
V_50 = F_72 ( V_15 , V_131 [ 2 ] , V_144 , & V_3 -> V_116 ) ;
if ( V_50 ) {
V_15 -> error = L_25 ;
goto V_146;
}
if ( sscanf ( V_131 [ 3 ] , L_23 , & V_135 , & V_139 ) != 1 ||
! V_135 || ( V_135 & ( V_135 - 1 ) ) ||
V_135 < V_147 ( V_3 -> V_40 -> V_103 ) ||
V_135 > V_148 ) {
V_15 -> error = L_26 ;
V_50 = - V_145 ;
goto V_146;
...
V_3 -> V_70 = F_73 ( V_135 ) ;
if ( sscanf ( V_131 [ 4 ] , L_23 , & V_135 , & V_139 ) != 1 ||
! V_135 || ( V_135 & ( V_135 - 1 ) ) ||
V_135 < V_147 ( V_3 -> V_116 -> V_103 ) ||
V_135 > V_149 ) {
V_15 -> error = L_27 ;
V_50 = - V_145 ;
goto V_146;
...
V_3 -> V_25 = F_73 ( V_135 ) ;
if ( sscanf ( V_131 [ 5 ] , L_28 , & V_137 , & V_139 ) != 1 ||
( T_2 ) ( V_137 << ( V_3 -> V_70 - V_105 ) )
>> ( V_3 -> V_70 - V_105 ) != V_137 ) {
V_15 -> error = L_29 ;
V_50 = - V_145 ;
goto V_146;
}
...
if ( sscanf ( V_131 [ 6 ] , L_28 , & V_137 , & V_139 ) != 1 ||
( T_2 ) ( V_137 << ( V_3 -> V_25 - V_105 ) )
>> ( V_3 -> V_25 - V_105 ) != V_137 ) {
V_15 -> error = L_31 ;
V_50 = - V_145 ;
goto V_146;
}
V_3 -> V_117 = V_137 ;
V_3 -> V_118 = F_74 ( V_131 [ 7 ] , V_142 ) ;
if ( ! V_3 -> V_118 ) {
V_15 -> error = L_32 ;
V_50 = - V_143 ;
goto V_146;
}
V_3 -> V_55 = F_75 ( V_3 -> V_118 , 0 , 0 ) ;
if ( F_20 ( V_3 -> V_55 ) ) {
V_15 -> error = L_33 ;
V_50 = F_21 ( V_3 -> V_55 ) ;
V_3 -> V_55 = NULL ;
...
V_3 -> V_6 =
sizeof( struct V_1 ) + F_77 ( V_3 -> V_55 ) ;
V_3 -> V_69 = F_47 ( V_3 -> V_7 , V_142 ) ;
if ( ! V_3 -> V_69 ) {
V_15 -> error = L_35 ;
V_50 = - V_143 ;
goto V_146;
}
if ( strlen ( V_131 [ 8 ] ) != V_3 -> V_7 * 2 ||
F_78 ( V_3 -> V_69 , V_131 [ 8 ] , V_3 -> V_7 ) ) {
V_15 -> error = L_36 ;
V_50 = - V_145 ;
goto V_146;
}
if ( strcmp ( V_131 [ 9 ] , L_17 ) ) {
V_3 -> V_59 = strlen ( V_131 [ 9 ] ) / 2 ;
V_3 -> V_58 = F_47 ( V_3 -> V_59 , V_142 ) ;
if ( ! V_3 -> V_58 ) {
V_15 -> error = L_37 ;
V_50 = - V_143 ;
goto V_146;
}
if ( strlen ( V_131 [ 9 ] ) != V_3 -> V_59 * 2 ||
F_78 ( V_3 -> V_58 , V_131 [ 9 ] , V_3 -> V_59 ) ) {
V_15 -> error = L_38 ;
V_50 = - V_145 ;
goto V_146;
}
...
V_133 . V_130 = V_130 ;
V_133 . V_131 = V_131 ;
V_50 = F_79 ( V_141 , & V_133 , & V_136 , & V_15 -> error ) ;
if ( V_50 )
goto V_146;
while ( V_136 ) {
V_136 -- ;
...
if ( ! strcasecmp ( V_134 , V_120 ) )
V_3 -> V_45 = V_46 ;
else if ( ! strcasecmp ( V_134 , V_121 ) )
V_3 -> V_45 = V_47 ;
else {
V_15 -> error = L_40 ;
V_50 = - V_145 ;
...
T_2 V_152 ;
V_3 -> V_23 [ V_64 ] = V_138 ;
V_152 = ( V_3 -> V_106 + ( ( T_2 ) 1 << ( ( V_64 + 1 ) * V_3 -> V_18 ) ) - 1 )
>> ( ( V_64 + 1 ) * V_3 -> V_18 ) ;
if ( V_138 + V_152 < V_138 ) {
V_15 -> error = L_42 ;
V_50 = - V_151 ;
goto V_146;
}
...
if ( F_82 ( V_3 -> V_51 ) < V_3 -> V_95 ) {
V_15 -> error = L_44 ;
V_50 = - V_151 ;
goto V_146;
}
V_15 -> V_62 = F_83 ( sizeof( struct V_4 ) + V_3 -> V_6 + V_3 -> V_7 * 2 , F_84 ( struct V_4 ) ) ;
V_3 -> V_87 = F_85 ( L_45 , V_153 | V_154 | V_155 , F_86 () ) ;
if ( ! V_3 -> V_87 ) {
V_15 -> error = L_46 ;
V_50 = - V_143 ;
goto V_146;
