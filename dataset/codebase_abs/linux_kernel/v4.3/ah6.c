...
if ( V_62 -> V_128 )
goto error;
V_65 = F_63 ( sizeof( * V_65 ) , V_129 ) ;
if ( ! V_65 )
return - V_83 ;
V_2 = F_64 ( V_62 -> V_127 -> V_130 , 0 , 0 ) ;
if ( F_65 ( V_2 ) )
goto error;
V_65 -> V_2 = V_2 ;
if ( F_66 ( V_2 , V_62 -> V_127 -> V_131 ,
( V_62 -> V_127 -> V_132 + 7 ) / 8 ) )
goto error;
V_126 = F_67 ( V_62 -> V_127 -> V_130 , 0 ) ;
F_68 ( ! V_126 ) ;
...
static int F_72 ( struct V_58 * V_59 , int V_55 )
{
return 0 ;
}
static int T_4 F_73 ( void )
{
if ( F_74 ( & V_140 , V_123 ) < 0 ) {
F_69 ( L_6 , V_141 ) ;
return - V_142 ;
}
if ( F_75 ( & V_143 , V_85 ) < 0 ) {
F_69 ( L_7 , V_141 ) ;
F_76 ( & V_140 , V_123 ) ;
return - V_142 ;
}
...
{
if ( F_78 ( & V_143 , V_85 ) < 0 )
F_69 ( L_8 , V_141 ) ;
if ( F_76 ( & V_140 , V_123 ) < 0 )
F_69 ( L_9 , V_141 ) ;
}
