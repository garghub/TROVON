...
F_8 () ;
V_110 . V_111 = V_79 - V_66 ;
V_65 = F_61 ( & V_13 -> V_59 , & V_110 ) ;
if ( V_65 < 0 ) {
F_51 ( V_13 , L_17 , V_65 ) ;
goto V_112;
}
...
F_16 ( V_13 , & V_113 ) ;
V_114 = F_34 ( & V_113 ) ;
if ( V_18 -> V_44 == V_114 + 1 ) {
struct V_16 V_115 ;
F_71 ( V_114 - 1 , & V_115 . time ) ;
V_115 . V_37 = 0 ;
V_65 = F_32 ( V_13 , & V_115 ) ;
} else if ( V_18 -> V_44 > V_114 + 1 ) {
V_65 = - V_80 ;
}
return V_65 ;
}
...
unsigned char V_116 ;
F_23 ( & V_24 ) ;
V_18 -> V_71 = V_116 = F_24 ( V_33 ) ;
if ( V_116 & ( V_51 | V_38 | V_52 ) ) {
unsigned char V_4 ;
if ( F_73 ( V_13 ) )
V_4 = V_3 & ~ V_38 ;
else
...
V_123 . V_94 = V_124 . V_126 ;
V_123 . V_95 = V_124 . V_125 ;
V_123 . V_96 = V_124 . V_68 ;
if ( V_124 . V_45 & V_127 )
F_62 ( V_13 , L_30 ) ;
V_13 -> V_128 = & V_123 ;
F_88 ( V_13 , 1 ) ;
...
static int F_89 ( struct V_129 * V_130 , const struct V_131 * V_132 )
{
F_87 ( & V_130 -> V_13 ) ;
if ( F_90 ( V_130 , 0 ) == 0x70 && ! F_91 ( V_130 , 0 ) )
return F_46 ( & V_130 -> V_13 ,
F_92 ( V_130 , V_133 , 0 ) , 8 ) ;
else
return F_46 ( & V_130 -> V_13 ,
F_92 ( V_130 , V_133 , 0 ) ,
F_93 ( V_130 , 0 ) ) ;
}
static void T_9 F_94 ( struct V_129 * V_130 )
{
F_68 ( & V_130 -> V_13 ) ;
}
...
static T_11 void F_96 ( struct V_136 * V_137 )
{
struct V_138 * V_139 = V_137 -> V_13 . V_140 ;
struct V_14 time ;
int V_141 ;
const T_12 * V_11 ;
if ( ! V_139 )
return;
V_11 = F_97 ( V_139 , L_31 , NULL ) ;
if ( V_11 )
F_30 ( F_98 ( V_11 ) , V_33 ) ;
V_11 = F_97 ( V_139 , L_32 , NULL ) ;
if ( V_11 )
...
static inline void F_96 ( struct V_136 * V_137 ) {}
static int T_11 F_100 ( struct V_136 * V_137 )
{
struct V_74 * V_74 ;
int V_20 ;
F_96 ( V_137 ) ;
F_87 ( & V_137 -> V_13 ) ;
if ( V_82 )
V_74 = F_101 ( V_137 , V_133 , 0 ) ;
else
V_74 = F_101 ( V_137 , V_143 , 0 ) ;
V_20 = F_102 ( V_137 , 0 ) ;
if ( V_20 < 0 )
V_20 = - 1 ;
return F_46 ( & V_137 -> V_13 , V_74 , V_20 ) ;
}
static int T_9 F_103 ( struct V_136 * V_137 )
{
F_68 ( & V_137 -> V_13 ) ;
return 0 ;
}
