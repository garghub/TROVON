...
struct V_1 * V_2 = F_43 ( V_155 ) ;
const struct V_202 * V_203 ;
F_50 ( V_155 -> V_15 , L_28 , V_156 , V_72 ) ;
F_9 ( V_2 -> V_166 . V_26 . V_27 ) ;
V_2 -> V_166 . V_26 . V_28 = V_217 ;
V_2 -> V_166 . V_26 . V_30 = sizeof( struct V_218 )
- sizeof( struct V_31 ) ;
V_203 = & V_204 ;
F_14 ( V_155 -> V_15 , L_29 , V_203 -> V_206 ) ;
if ( V_156 )
V_2 -> V_166 . V_146 = V_219 ;
else
...
V_85 -> V_151 , V_134 ) ;
V_25 . V_26 . V_28 = V_224 ;
V_25 . V_26 . V_30 = sizeof( struct V_221 )
- sizeof( struct V_31 ) ;
...
static int F_53 ( struct V_121 * V_70 ,
struct V_43 * V_124 , int V_125 )
{
int V_19 = 0 ;
struct V_225 V_25 ;
...
F_20 ( 2 , V_25 . V_26 . V_27 ,
V_85 -> V_151 , V_134 ) ;
V_25 . V_26 . V_28 = V_226 ;
V_25 . V_26 . V_30 = sizeof( struct V_225 )
- sizeof( struct V_31 ) ;
V_25 . V_227 . V_228 . V_229 . V_230 = 2 ;
V_25 . V_227 . V_228 . V_229 . V_172 = V_85 -> V_172 ;
V_25 . V_227 . V_228 . V_229 . V_231 = 1 ;
V_25 . V_69 = 0 ;
V_19 = F_5 ( V_2 , V_153 , V_41 ,
V_42 , 0 , & V_25 ,
sizeof( V_25 . V_26 ) + V_25 . V_26 . V_30 ) ;
...
static int F_54 ( struct V_232 * V_15 )
{
int V_73 = 0 ;
struct V_75 * V_76 ;
for ( V_73 = 0 ; V_73 < F_55 ( V_233 ) ; V_73 ++ ) {
V_76 = (struct V_75 * ) V_233 [ V_73 ] . V_49 ;
V_76 -> V_82 = F_56 ( V_15 , V_76 -> V_55 , V_78 ) ;
if ( V_76 -> V_82 == NULL )
return - V_79 ;
}
return 0 ;
}
static bool F_57 ( struct V_121 * V_70 )
{
switch ( V_70 -> V_72 ) {
case V_234 :
case V_235 :
...
int F_58 ( struct V_154 * V_155 , int V_240 , int V_102 )
{
struct V_1 * V_2 = F_43 ( V_155 ) ;
struct V_121 * V_70 ;
struct V_241 * V_242 = NULL ;
F_14 ( V_155 -> V_15 , L_33 , V_155 -> V_57 , V_240 ) ;
if ( V_240 == V_243 ) {
F_14 ( V_155 -> V_15 , L_34 ,
V_155 -> V_244 -> V_57 ) ;
V_70 = V_155 -> V_244 ;
F_59 (w, p) {
if ( V_242 -> V_245 && ! V_242 -> V_245 ( V_70 , V_242 -> V_246 ) )
continue;
if ( V_242 -> V_247 && V_242 -> V_246 -> V_71 &&
F_57 ( V_242 -> V_246 ) ) {
struct V_84 * V_85 = V_242 -> V_246 -> V_123 ;
F_14 ( V_155 -> V_15 , L_35 ,
V_242 -> V_246 -> V_57 ) ;
F_6 ( & V_2 -> V_23 ) ;
F_33 ( V_85 , V_2 , V_102 ) ;
F_7 ( & V_2 -> V_23 ) ;
...
if ( V_242 -> V_245 && ! V_242 -> V_245 ( V_70 , V_242 -> V_246 ) )
continue;
if ( V_242 -> V_247 && V_242 -> V_249 -> V_71 &&
F_57 ( V_242 -> V_249 ) ) {
struct V_84 * V_85 = V_242 -> V_249 -> V_123 ;
F_14 ( V_155 -> V_15 , L_36 ,
V_242 -> V_249 -> V_57 ) ;
F_6 ( & V_2 -> V_23 ) ;
F_33 ( V_85 , V_2 , V_102 ) ;
F_7 ( & V_2 -> V_23 ) ;
...
static int F_61 ( struct V_43 * V_88 ,
struct V_121 * V_70 , int type )
{
struct V_86 * V_250 = NULL ;
struct V_61 * V_62 = F_32 ( V_70 -> V_122 ) ;
struct V_84 * V_85 = V_70 -> V_123 ;
int V_19 = 0 ;
V_250 = F_56 ( V_62 -> V_15 , sizeof( * V_250 ) , V_78 ) ;
if ( ! V_250 )
return - V_79 ;
if ( type == V_251 ) {
...
V_95 -> V_70 = V_70 ;
V_250 -> V_88 = V_88 ;
F_62 ( & V_250 -> V_252 , & V_85 -> V_253 ) ;
} else if ( type == V_254 ) {
struct V_75 * V_76 = ( void * ) V_88 -> V_49 ;
V_76 -> V_70 = V_70 ;
V_250 -> V_88 = V_88 ;
F_62 ( & V_250 -> V_252 , & V_85 -> V_255 ) ;
} else {
F_2 ( V_62 -> V_15 , L_37 ,
type , V_88 -> V_72 . V_57 ) ;
V_19 = - V_16 ;
...
static int F_63 ( struct V_121 * V_70 ,
struct V_256 * V_257 )
{
struct V_43 * V_88 ;
int V_258 , V_19 = 0 ;
struct V_259 * V_260 = V_257 -> V_90 . V_260 -> V_259 ;
char * V_261 ;
F_64 ( & V_260 -> V_262 ) ;
F_23 (kctl, &card->controls, list) {
V_261 = strchr ( V_88 -> V_72 . V_57 , ' ' ) ;
if ( V_261 == NULL )
continue;
V_258 = V_261 - ( char * ) V_88 -> V_72 . V_57 ;
if ( strncmp ( V_88 -> V_72 . V_57 , V_70 -> V_57 , V_258 ) )
continue;
if ( strstr ( V_88 -> V_72 . V_57 , L_38 ) )
V_19 = F_61 ( V_88 , V_70 , V_251 ) ;
else if ( strstr ( V_88 -> V_72 . V_57 , L_39 ) )
V_19 = F_61 ( V_88 , V_70 , V_254 ) ;
else if ( strstr ( V_88 -> V_72 . V_57 , L_40 ) &&
strstr ( V_88 -> V_72 . V_57 , L_41 ) ) {
struct V_94 * V_95 =
( void * ) V_88 -> V_49 ;
V_95 -> V_70 = V_70 ;
...
static void F_66 ( struct V_256 * V_257 ,
struct V_84 * V_85 )
{
struct V_121 * V_70 ;
unsigned int V_7 = strlen ( V_85 -> V_263 ) ;
F_23 (w, &platform->component.card->widgets, list) {
if ( ! strncmp ( V_85 -> V_263 , V_70 -> V_57 , V_7 ) ) {
V_85 -> V_264 = V_70 ;
break;
}
}
}
static int F_67 ( struct V_256 * V_257 )
{
struct V_121 * V_70 ;
int V_19 = 0 ;
F_23 (w, &platform->component.card->widgets, list) {
if ( F_57 ( V_70 ) && ( V_70 -> V_123 ) ) {
struct V_84 * V_85 = V_70 -> V_123 ;
F_14 ( V_257 -> V_15 , L_44 ,
V_70 -> V_72 , V_70 -> V_57 ) ;
F_68 ( & V_85 -> V_255 ) ;
F_68 ( & V_85 -> V_253 ) ;
V_19 = F_63 ( V_70 , V_257 ) ;
if ( V_19 < 0 )
return V_19 ;
if ( V_85 -> V_263 != NULL )
F_66 ( V_257 , V_85 ) ;
...
int F_69 ( struct V_256 * V_257 )
{
int V_73 , V_19 = 0 ;
struct V_265 * V_122 =
F_70 ( & V_257 -> V_90 ) ;
struct V_1 * V_2 = F_71 ( V_257 ) ;
unsigned int V_266 = F_55 ( V_267 ) / 3 ;
V_2 -> V_11 = F_56 ( V_257 -> V_15 ,
V_13 , V_78 ) ;
if ( ! V_2 -> V_11 )
return - V_79 ;
F_72 ( V_122 , V_268 ,
...
V_270 [ V_73 ] . V_102 = V_271 ;
V_270 [ V_73 ] . V_110 = V_272 ;
V_270 [ V_73 ] . V_111 = V_272 ;
V_270 [ V_73 ] . V_114 = V_273 ;
}
V_19 = F_75 ( V_257 , V_267 ,
F_55 ( V_267 ) ) ;
if ( V_19 )
return V_19 ;
V_19 = F_54 ( V_257 -> V_15 ) ;
if ( V_19 )
return V_19 ;
V_19 = F_75 ( V_257 , V_233 ,
F_55 ( V_233 ) ) ;
if ( V_19 )
return V_19 ;
V_19 = F_75 ( V_257 , V_274 ,
F_55 ( V_274 ) ) ;
if ( V_19 )
return V_19 ;
V_19 = F_67 ( V_257 ) ;
