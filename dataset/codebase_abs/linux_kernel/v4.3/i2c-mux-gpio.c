...
if ( ! V_24 )
return - V_28 ;
V_2 -> V_5 . V_29 = F_11 ( V_24 ) ;
F_12 ( & V_24 -> V_20 ) ;
V_2 -> V_5 . V_30 = F_13 ( V_19 ) ;
V_25 = F_14 ( & V_17 -> V_20 ,
...
F_15 (np, child) {
F_16 ( V_23 , L_4 , V_25 + V_4 ) ;
V_4 ++ ;
}
V_2 -> V_5 . V_25 = V_25 ;
if ( F_16 ( V_19 , L_5 , & V_2 -> V_5 . V_12 ) )
V_2 -> V_5 . V_12 = V_33 ;
V_2 -> V_5 . V_6 = F_17 ( V_19 , L_6 ) ;
if ( V_2 -> V_5 . V_6 < 0 ) {
F_8 ( & V_17 -> V_20 , L_7 ) ;
return - V_34 ;
}
...
struct V_1 * V_2 ;
struct V_9 * V_29 ;
int (* F_20) ( struct V_9 * , void * , T_1 );
unsigned V_35 , V_7 ;
int V_4 , V_26 ;
V_2 = F_14 ( & V_17 -> V_20 , sizeof( * V_2 ) , V_31 ) ;
if ( ! V_2 ) {
F_8 ( & V_17 -> V_20 , L_9 ) ;
return - V_32 ;
}
...
memcpy ( & V_2 -> V_5 , F_22 ( & V_17 -> V_20 ) ,
sizeof( V_2 -> V_5 ) ) ;
}
if ( V_2 -> V_5 . V_13 ) {
struct V_13 * V_36 ;
V_36 = F_23 ( V_2 -> V_5 . V_13 ,
F_5 ) ;
if ( ! V_36 )
return - V_28 ;
V_7 = V_36 -> V_37 ;
...
V_29 = F_24 ( V_2 -> V_5 . V_29 ) ;
if ( ! V_29 )
return - V_28 ;
V_2 -> V_29 = V_29 ;
V_2 -> V_7 = V_7 ;
V_2 -> V_10 = F_14 ( & V_17 -> V_20 ,
...
for ( V_4 = 0 ; V_4 < V_2 -> V_5 . V_6 ; V_4 ++ ) {
V_26 = F_25 ( V_7 + V_2 -> V_5 . V_8 [ V_4 ] , L_11 ) ;
if ( V_26 ) {
F_8 ( & V_17 -> V_20 , L_12 ,
V_2 -> V_5 . V_8 [ V_4 ] ) ;
goto V_39;
}
V_26 = F_26 ( V_7 + V_2 -> V_5 . V_8 [ V_4 ] ,
V_35 & ( 1 << V_4 ) ) ;
if ( V_26 ) {
F_8 ( & V_17 -> V_20 ,
L_13 ,
...
V_2 -> V_10 [ V_4 ] = F_27 ( V_29 , & V_17 -> V_20 , V_2 , V_40 ,
V_2 -> V_5 . V_25 [ V_4 ] , V_42 ,
F_3 , F_20 ) ;
if ( ! V_2 -> V_10 [ V_4 ] ) {
V_26 = - V_27 ;
F_8 ( & V_17 -> V_20 , L_14 , V_4 ) ;
goto V_44;
}
}
F_28 ( & V_17 -> V_20 , L_15 ,
...
{
struct V_1 * V_2 = F_33 ( V_17 ) ;
int V_4 ;
for ( V_4 = 0 ; V_4 < V_2 -> V_5 . V_30 ; V_4 ++ )
F_29 ( V_2 -> V_10 [ V_4 ] ) ;
for ( V_4 = 0 ; V_4 < V_2 -> V_5 . V_6 ; V_4 ++ )
F_30 ( V_2 -> V_7 + V_2 -> V_5 . V_8 [ V_4 ] ) ;
F_31 ( V_2 -> V_29 ) ;
return 0 ;
}
