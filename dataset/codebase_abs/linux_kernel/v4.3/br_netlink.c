...
memcpy ( & V_119 , V_114 ,
sizeof( struct V_23 ) ) ;
for ( V_120 = V_114 -> V_8 ; V_120 <= V_57 -> V_8 ; V_120 ++ ) {
V_119 . V_8 = V_120 ;
V_62 = F_47 ( V_67 , V_30 , V_109 , & V_119 ) ;
if ( V_62 )
break;
}
V_114 = NULL ;
...
if ( V_34 > V_121 )
return - V_117 ;
if ( V_30 -> V_67 -> V_122 == V_123 )
return - V_124 ;
if ( ! F_26 ( V_30 -> V_18 ) ||
( ! F_58 ( V_30 -> V_18 ) && V_34 != V_125 ) )
return - V_126 ;
F_59 ( V_30 , V_34 ) ;
F_60 ( V_30 ) ;
F_61 ( V_30 -> V_67 ) ;
...
static void F_62 ( struct V_29 * V_30 , struct V_92 * V_127 [] ,
int V_128 , unsigned long V_129 )
{
if ( V_127 [ V_128 ] ) {
T_4 V_130 = F_63 ( V_127 [ V_128 ] ) ;
if ( V_130 )
V_30 -> V_9 |= V_129 ;
else
V_30 -> V_9 &= ~ V_129 ;
...
static int F_64 ( struct V_29 * V_30 , struct V_92 * V_127 [] )
{
int V_62 ;
unsigned long V_131 = V_30 -> V_9 ;
F_62 ( V_30 , V_127 , V_39 , V_32 ) ;
F_62 ( V_30 , V_127 , V_40 , V_41 ) ;
F_62 ( V_30 , V_127 , V_44 , V_45 ) ;
F_62 ( V_30 , V_127 , V_42 , V_43 ) ;
F_62 ( V_30 , V_127 , V_46 , V_47 ) ;
F_62 ( V_30 , V_127 , V_48 , V_49 ) ;
F_62 ( V_30 , V_127 , V_50 , V_51 ) ;
F_62 ( V_30 , V_127 , V_52 , V_53 ) ;
if ( V_127 [ V_37 ] ) {
V_62 = F_65 ( V_30 , F_66 ( V_127 [ V_37 ] ) ) ;
if ( V_62 )
return V_62 ;
}
if ( V_127 [ V_35 ] ) {
V_62 = F_67 ( V_30 , F_68 ( V_127 [ V_35 ] ) ) ;
if ( V_62 )
return V_62 ;
}
if ( V_127 [ V_33 ] ) {
V_62 = F_57 ( V_30 , F_63 ( V_127 [ V_33 ] ) ) ;
if ( V_62 )
return V_62 ;
}
F_69 ( V_30 , V_131 ^ V_30 -> V_9 ) ;
return 0 ;
}
...
struct V_92 * V_133 ;
struct V_29 * V_30 ;
struct V_92 * V_127 [ V_134 + 1 ] ;
int V_62 = 0 ;
V_132 = F_71 ( V_70 , sizeof( struct V_24 ) , V_94 ) ;
V_133 = F_71 ( V_70 , sizeof( struct V_24 ) , V_100 ) ;
if ( ! V_132 && ! V_133 )
return 0 ;
V_30 = F_46 ( V_18 ) ;
if ( ! V_30 && ! V_133 )
...
if ( V_30 && V_132 ) {
if ( V_132 -> F_54 & V_95 ) {
V_62 = F_72 ( V_127 , V_134 ,
V_132 , V_135 ) ;
if ( V_62 )
return V_62 ;
F_73 ( & V_30 -> V_67 -> V_136 ) ;
V_62 = F_64 ( V_30 , V_127 ) ;
F_74 ( & V_30 -> V_67 -> V_136 ) ;
} else {
if ( F_55 ( V_132 ) < sizeof( T_4 ) )
return - V_117 ;
F_73 ( & V_30 -> V_67 -> V_136 ) ;
V_62 = F_57 ( V_30 , F_63 ( V_132 ) ) ;
F_74 ( & V_30 -> V_67 -> V_136 ) ;
}
if ( V_62 )
goto V_137;
...
int F_75 ( struct V_17 * V_18 , struct V_69 * V_70 , T_2 V_9 )
{
struct V_92 * V_133 ;
struct V_29 * V_30 ;
int V_62 = 0 ;
...
static int F_76 ( struct V_92 * V_127 [] , struct V_92 * V_138 [] )
{
if ( V_127 [ V_88 ] ) {
if ( F_55 ( V_127 [ V_88 ] ) != V_139 )
return - V_117 ;
if ( ! F_77 ( F_56 ( V_127 [ V_88 ] ) ) )
return - V_140 ;
}
if ( ! V_138 )
return 0 ;
...
static int F_81 ( struct V_101 * V_145 , struct V_17 * V_18 ,
struct V_92 * V_127 [] , struct V_92 * V_138 [] )
{
struct V_22 * V_67 = F_11 ( V_18 ) ;
if ( V_127 [ V_88 ] ) {
F_73 ( & V_67 -> V_136 ) ;
F_82 ( V_67 , F_56 ( V_127 [ V_88 ] ) ) ;
F_74 ( & V_67 -> V_136 ) ;
}
return F_83 ( V_18 ) ;
}
static int F_84 ( struct V_17 * V_146 ,
struct V_17 * V_18 ,
struct V_92 * V_127 [] ,
struct V_92 * V_138 [] )
{
struct V_22 * V_67 = F_11 ( V_146 ) ;
int V_147 ;
if ( ! V_138 )
return 0 ;
F_73 ( & V_67 -> V_136 ) ;
V_147 = F_64 ( F_46 ( V_18 ) , V_138 ) ;
F_74 ( & V_67 -> V_136 ) ;
return V_147 ;
}
static int F_85 ( struct V_27 * V_28 ,
const struct V_17 * V_146 ,
const struct V_17 * V_18 )
{
return F_17 ( V_28 , F_46 ( V_18 ) ) ;
}
static T_3 F_86 ( const struct V_17 * V_146 ,
const struct V_17 * V_18 )
{
return F_14 () ;
}
static int F_87 ( struct V_17 * V_146 , struct V_92 * V_127 [] ,
struct V_92 * V_138 [] )
{
struct V_22 * V_67 = F_11 ( V_146 ) ;
int V_62 ;
...
return 0 ;
if ( V_138 [ V_148 ] ) {
V_62 = F_88 ( V_67 , F_66 ( V_138 [ V_148 ] ) ) ;
if ( V_62 )
return V_62 ;
}
if ( V_138 [ V_149 ] ) {
V_62 = F_89 ( V_67 , F_66 ( V_138 [ V_149 ] ) ) ;
if ( V_62 )
return V_62 ;
}
if ( V_138 [ V_150 ] ) {
V_62 = F_90 ( V_67 , F_66 ( V_138 [ V_150 ] ) ) ;
if ( V_62 )
return V_62 ;
}
if ( V_138 [ V_151 ] ) {
T_1 V_152 = F_66 ( V_138 [ V_151 ] ) ;
V_67 -> V_152 = F_91 ( V_152 ) ;
}
if ( V_138 [ V_153 ] ) {
T_1 V_122 = F_66 ( V_138 [ V_153 ] ) ;
F_92 ( V_67 , V_122 ) ;
}
if ( V_138 [ V_154 ] ) {
T_1 V_36 = F_68 ( V_138 [ V_154 ] ) ;
F_93 ( V_67 , V_36 ) ;
}
if ( V_138 [ V_155 ] ) {
T_4 V_156 = F_63 ( V_138 [ V_155 ] ) ;
V_62 = F_94 ( V_67 , V_156 ) ;
if ( V_62 )
return V_62 ;
}
#ifdef F_78
if ( V_138 [ V_141 ] ) {
T_5 V_157 = F_79 ( V_138 [ V_141 ] ) ;
V_62 = F_95 ( V_67 , V_157 ) ;
if ( V_62 )
return V_62 ;
}
#endif
...
static T_3 F_96 ( const struct V_17 * V_146 )
{
...
static int F_97 ( struct V_27 * V_28 , const struct V_17 * V_146 )
{
struct V_22 * V_67 = F_11 ( V_146 ) ;
T_1 V_158 = F_98 ( V_67 -> V_158 ) ;
T_1 V_159 = F_98 ( V_67 -> V_159 ) ;
T_1 V_160 = F_98 ( V_67 -> V_161 ) ;
T_1 V_152 = F_98 ( V_67 -> V_152 ) ;
T_1 V_122 = V_67 -> V_122 ;
T_2 V_36 = ( V_67 -> V_162 . V_163 [ 0 ] << 8 ) | V_67 -> V_162 . V_163 [ 1 ] ;
T_4 V_164 = F_99 ( V_67 ) ;
if ( F_20 ( V_28 , V_148 , V_158 ) ||
F_20 ( V_28 , V_149 , V_159 ) ||
F_20 ( V_28 , V_150 , V_160 ) ||
F_20 ( V_28 , V_151 , V_152 ) ||
F_20 ( V_28 , V_153 , V_122 ) ||
F_19 ( V_28 , V_154 , V_36 ) ||
F_18 ( V_28 , V_155 , V_164 ) )
return - V_54 ;
#ifdef F_78
if ( F_100 ( V_28 , V_141 , V_67 -> V_157 ) )
return - V_54 ;
#endif
return 0 ;
}
static T_3 F_101 ( const struct V_17 * V_18 )
{
struct V_1 * V_2 ;
if ( F_7 ( V_18 ) )
V_2 = F_8 ( F_46 ( V_18 ) ) ;
