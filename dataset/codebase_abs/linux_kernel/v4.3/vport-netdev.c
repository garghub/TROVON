...
static unsigned int F_42 ( const struct V_1 * V_2 )
{
unsigned int V_36 = V_2 -> V_37 - V_6 ;
if ( V_2 -> V_38 == F_43 ( V_39 ) )
V_36 -= V_40 ;
return V_36 ;
}
void F_44 ( struct V_3 * V_3 , struct V_1 * V_2 )
{
int V_41 = V_3 -> V_4 -> V_41 ;
if ( F_3 ( F_42 ( V_2 ) > V_41 && ! F_45 ( V_2 ) ) ) {
F_46 ( L_1 ,
V_3 -> V_4 -> V_18 ,
F_42 ( V_2 ) , V_41 ) ;
V_3 -> V_4 -> V_42 . V_43 ++ ;
