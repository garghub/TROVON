...
const struct V_131 * V_151 )
{
const struct V_149 * V_152 ;
if ( V_14 -> V_144 != V_153 )
return;
for ( V_152 = V_150 ; V_152 -> V_154 ; V_152 ++ ) {
if ( ( V_14 -> V_91 . V_155 & 0xffff0000 ) != ( V_152 -> V_154 << 16 ) )
continue;
if ( V_14 -> V_91 . V_156 != V_152 -> V_14 )
continue;
if ( F_50 ( V_14 , V_152 -> V_9 ) ) {
V_14 -> V_144 = V_152 -> V_157 ;
#ifdef F_52
V_14 -> V_130 = V_152 -> V_113 ;
F_26 ( V_14 , L_50 ,
...
if ( V_14 -> V_129 && V_159 ) {
while ( V_159 -> V_113 ) {
if ( ! strcmp ( V_14 -> V_129 , V_159 -> V_113 ) ) {
V_14 -> V_144 = V_159 -> V_126 ;
V_14 -> V_130 = V_159 -> V_113 ;
V_14 -> V_133 = V_151 ;
F_26 ( V_14 , L_53 ,
V_14 -> V_91 . V_92 , V_14 -> V_130 ) ;
return;
...
if ( V_161 ) {
V_162 = F_54 ( V_14 -> V_164 -> V_165 , V_161 ) ;
if ( V_162 ) {
V_126 = V_162 -> V_157 ;
#ifdef F_52
V_113 = V_162 -> V_113 ;
F_26 ( V_14 , L_54 ,
V_14 -> V_91 . V_92 , V_113 , V_162 -> V_166 ? L_36 : L_55 ) ;
#endif
}
}
if ( V_126 < 0 && V_161 ) {
for ( V_162 = V_161 ; V_162 -> V_154 || V_162 -> V_167 ; V_162 ++ ) {
unsigned int V_168 =
V_162 -> V_167 | ( V_162 -> V_154 << 16 ) ;
unsigned int V_169 = 0xffff0000 | V_162 -> V_166 ;
if ( ( V_14 -> V_91 . V_155 & V_169 ) == ( V_168 & V_169 ) ) {
V_126 = V_162 -> V_157 ;
#ifdef F_52
V_113 = V_162 -> V_113 ;
F_26 ( V_14 , L_56 ,
