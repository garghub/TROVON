...
V_149 -> V_107 ( V_149 ) ;
error = F_88 ( & V_35 -> V_3 . V_157 , & V_158 ) ;
if ( error )
goto V_183;
F_64 ( V_1 ) ;
V_45:
...
static int F_90 ( struct V_35 * V_35 )
{
struct V_1 * V_1 = F_16 ( V_35 ) ;
struct V_1 * V_149 = NULL ;
unsigned char type ;
...
T_4 F_91 ( struct V_184 * V_3 , struct V_185 * V_186 ,
char * V_187 )
{
struct V_35 * V_35 = F_92 ( V_3 ) ;
struct V_188 * V_189 = F_93 ( V_186 ) ;
struct V_1 * V_1 ;
V_1 = F_16 ( V_35 ) ;
return V_189 -> V_190 ( V_1 , V_189 -> V_44 , V_187 ) ;
}
T_4 F_94 ( struct V_184 * V_3 , struct V_185 * V_186 ,
...
static T_4 F_96 ( struct V_1 * V_1 , void * V_195 , char * V_187 )
{
unsigned int * V_196 = ( unsigned int * ) ( ( char * ) V_1 + ( T_3 ) V_195 ) ;
return sprintf ( V_187 , L_28 , * V_196 ) ;
}
static T_4 F_97 ( struct V_1 * V_1 , void * V_195 , const char * V_187 , T_3 V_191 )
{
unsigned int * V_196 = ( unsigned int * ) ( ( char * ) V_1 + ( T_3 ) V_195 ) ;
unsigned int V_197 ;
int V_198 ;
V_198 = F_98 ( V_187 , 10 , & V_197 ) ;
if ( V_198 )
return V_198 ;
* V_196 = V_197 ;
return V_191 ;
}
static T_4 F_99 ( struct V_1 * V_1 , void * V_44 , char * V_187 )
{
return sprintf ( V_187 , L_29 , F_59 ( V_1 -> type ) -> V_40 ) ;
}
static T_4 F_100 ( struct V_1 * V_1 , void * V_44 , const char * V_187 , T_3 V_191 )
{
struct V_35 * V_35 = V_1 -> V_31 . V_35 ;
struct V_1 * V_149 = NULL ;
...
static T_4 F_104 ( struct V_1 * V_1 , void * V_44 , const char * V_187 , T_3 V_191 )
{
unsigned int V_197 ;
int V_198 ;
V_198 = F_98 ( V_187 , 10 , & V_197 ) ;
...
static int F_105 ( const char * V_207 , const struct V_208 * V_209 )
{
const struct V_139 * V_159 ;
if ( ! V_207 )
return - V_203 ;
...
static int F_106 ( char * V_212 , const struct V_208 * V_209 )
{
