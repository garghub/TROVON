...
static void F_101 ( struct V_173 * V_100 )
{
...
F_111 ( & V_6 -> V_178 ) ;
V_6 -> V_175 . V_14 = V_14 ;
V_6 -> V_175 . V_181 = F_93 ;
V_6 -> V_175 . V_182 = F_93 ;
V_6 -> V_175 . V_183 = F_95 ;
V_6 -> V_175 . V_184 = F_96 ;
if ( V_154 ) {
int V_103 ;
V_103 = F_112 ( V_94 -> V_152 , F_100 ,
V_185 | V_186 |
V_187 ,
V_14 , V_94 ) ;
if ( V_103 ) {
...
static int F_115 ( struct V_189 * V_190 ,
T_7 V_167 )
{
struct V_5 * V_6 ;
V_6 = F_116 ( V_190 ) ;
if ( ! V_6 )
return - V_17 ;
return F_117 ( V_6 -> V_155 ) ;
}
static int F_118 ( struct V_189 * V_190 )
{
struct V_5 * V_6 ;
V_6 = F_116 ( V_190 ) ;
if ( ! V_6 )
...
V_73 = F_125 ( V_115 , L_35 ,
& V_6 -> V_201 ) ;
if ( V_73 )
V_6 -> V_201 = V_202 ;
V_6 -> V_54 = F_126 ( V_115 ,
L_36 ) ;
V_103 = F_127 ( V_190 , V_203 , 0 ) ;
if ( ! V_103 ) {
F_17 ( V_6 -> V_12 , L_37 ) ;
return - V_204 ;
}
V_6 -> V_103 = F_128 ( V_6 -> V_12 , V_103 -> V_104 ,
F_129 ( V_103 ) , V_28 ) ;
if ( ! V_6 -> V_103 ) {
F_17 ( V_6 -> V_12 , L_38 ) ;
return - V_205 ;
}
V_6 -> V_111 = F_129 ( V_6 -> V_103 ) ;
V_6 -> V_27 = F_130 ( V_6 -> V_12 , V_6 -> V_103 -> V_104 , V_6 -> V_111 ) ;
if ( ! V_6 -> V_27 ) {
F_17 ( V_6 -> V_12 , L_39 ) ;
return - V_204 ;
}
F_131 ( & V_6 -> V_11 , V_112 ) ;
F_131 ( & V_6 -> V_36 , V_112 ) ;
F_132 ( V_190 , V_6 ) ;
switch ( V_6 -> V_24 ) {
case 8 :
V_6 -> V_26 = F_1 ;
...
if ( V_73 < 0 )
goto free;
V_6 -> V_155 = F_133 ( & V_6 -> V_100 , V_6 -> V_12 , V_6 ) ;
if ( F_134 ( V_6 -> V_155 ) ) {
F_17 ( V_6 -> V_12 , L_40 ) ;
V_73 = F_135 ( V_6 -> V_155 ) ;
goto free;
}
V_73 = F_86 ( V_115 , V_6 ) ;
if ( V_73 < 0 )
