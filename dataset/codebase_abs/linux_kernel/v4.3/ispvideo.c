...
V_32 -> V_42 = 0 ;
V_32 -> V_184 = F_78 ( V_6 -> V_76 -> clock [ V_185 ] ) ;
V_32 -> V_186 = V_32 -> V_184 ;
...
goto V_188;
V_6 -> V_189 = V_54 ;
V_6 -> V_190 = V_61 -> V_50 . V_52 . V_10 . V_12 ;
V_54 = F_12 ( V_6 , V_32 ) ;
if ( V_54 < 0 )
goto V_188;
if ( V_6 -> type == V_45 )
...
static int
F_87 ( struct V_109 * V_109 , void * V_110 , struct V_200 * V_46 )
{
if ( V_46 -> V_30 > 0 )
return - V_55 ;
...
struct V_62 * V_63 ;
int V_54 = 0 ;
V_202 = F_91 ( sizeof( * V_202 ) , V_203 ) ;
if ( V_202 == NULL )
return - V_204 ;
F_92 ( & V_202 -> V_61 , & V_6 -> V_6 ) ;
F_93 ( & V_202 -> V_61 ) ;
...
V_63 -> V_92 = & V_210 ;
V_63 -> V_211 = & V_212 ;
V_63 -> V_213 = sizeof( struct V_72 ) ;
V_63 -> V_214 = V_215 ;
V_54 = F_97 ( & V_202 -> V_63 ) ;
if ( V_54 < 0 ) {
F_96 ( V_6 -> V_76 ) ;
goto V_198;
}
memset ( & V_202 -> V_50 , 0 , sizeof( V_202 -> V_50 ) ) ;
V_202 -> V_50 . type = V_6 -> type ;
V_202 -> V_151 . V_152 = 1 ;
V_202 -> V_6 = V_6 ;
V_109 -> V_216 = & V_202 -> V_61 ;
V_198:
if ( V_54 < 0 ) {
F_98 ( & V_202 -> V_61 ) ;
F_99 ( V_202 ) ;
...
{
struct V_5 * V_6 = F_54 ( V_109 ) ;
struct V_217 * V_61 = V_109 -> V_216 ;
struct V_60 * V_202 = F_57 ( V_61 ) ;
...
static unsigned int F_102 ( struct V_109 * V_109 , T_3 * V_218 )
{
struct V_60 * V_61 = F_57 ( V_109 -> V_216 ) ;
struct V_5 * V_6 = F_54 ( V_109 ) ;
int V_54 ;
F_13 ( & V_6 -> V_108 ) ;
V_54 = F_103 ( & V_61 -> V_63 , V_109 , V_218 ) ;
F_18 ( & V_6 -> V_108 ) ;
return V_54 ;
}
static int F_104 ( struct V_109 * V_109 , struct V_219 * V_220 )
{
struct V_60 * V_61 = F_57 ( V_109 -> V_216 ) ;
return F_105 ( & V_61 -> V_63 , V_220 ) ;
}
...
int F_118 ( struct V_5 * V_6 , struct V_237 * V_238 )
{
int V_54 ;
V_6 -> V_6 . V_239 = V_238 ;
V_54 = F_119 ( & V_6 -> V_6 , V_232 , - 1 ) ;
if ( V_54 < 0 )
F_120 ( V_6 -> V_76 -> V_77 ,
L_10 ,
V_240 , V_54 ) ;
