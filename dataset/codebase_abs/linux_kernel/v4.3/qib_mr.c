...
struct V_70 *
F_32 ( struct V_71 * V_72 , int V_73 )
{
unsigned V_45 = V_73 * sizeof( T_1 ) ;
struct V_70 * V_74 ;
if ( V_45 > V_75 )
return F_11 ( - V_56 ) ;
V_74 = F_4 ( sizeof( * V_74 ) , V_14 ) ;
if ( ! V_74 )
return F_11 ( - V_21 ) ;
V_74 -> V_76 = F_4 ( V_45 , V_14 ) ;
if ( ! V_74 -> V_76 )
goto V_77;
return V_74 ;
V_77:
...
void F_33 ( struct V_70 * V_74 )
{
F_7 ( V_74 -> V_76 ) ;
F_7 ( V_74 ) ;
}
struct V_2 * F_34 ( struct V_6 * V_7 , int V_48 ,
struct V_78 * V_79 )
{
struct V_1 * V_80 ;
int V_9 ;
struct V_2 * V_25 ;
int V_11 = - V_21 ;
V_9 = ( V_79 -> V_81 + V_12 - 1 ) / V_12 ;
V_80 = F_4 ( sizeof( * V_80 ) + V_9 * sizeof( V_80 -> V_5 . V_13 [ 0 ] ) , V_14 ) ;
if ( ! V_80 )
goto V_15;
V_11 = F_3 ( & V_80 -> V_5 , V_7 , V_79 -> V_81 ) ;
if ( V_11 )
goto V_15;
V_11 = F_12 ( & V_80 -> V_5 , 0 ) ;
if ( V_11 )
goto V_28;
V_80 -> V_3 . V_33 = V_80 -> V_5 . V_32 ;
V_80 -> V_3 . V_32 = V_80 -> V_5 . V_32 ;
V_80 -> V_5 . V_29 = V_48 ;
V_80 -> V_5 . V_19 = V_79 -> V_81 ;
V_80 -> V_5 . V_62 = V_79 -> V_62 ;
V_25 = & V_80 -> V_3 ;
V_31:
return V_25 ;
V_28:
...
int F_35 ( struct V_2 * V_3 , T_1 * V_76 ,
int V_82 , T_1 V_40 )
{
...
T_2 V_86 ;
int V_25 ;
V_10 = F_36 ( & V_80 -> V_5 . V_18 ) ;
if ( V_10 > 2 )
return - V_65 ;
if ( V_82 > V_80 -> V_5 . V_19 ) {
V_25 = - V_56 ;
goto V_15;
}
V_84 = & F_37 ( V_3 -> V_87 ) -> V_88 ;
F_38 ( & V_84 -> V_89 , V_85 ) ;
V_80 -> V_5 . V_39 = V_40 ;
V_80 -> V_5 . V_40 = V_40 ;
V_86 = 1 << V_80 -> V_5 . V_62 ;
V_80 -> V_5 . V_44 = V_82 * V_86 ;
V_9 = 0 ;
V_38 = 0 ;
for ( V_10 = 0 ; V_10 < V_82 ; V_10 ++ ) {
V_80 -> V_5 . V_13 [ V_9 ] -> V_41 [ V_38 ] . V_42 = ( void * ) V_76 [ V_10 ] ;
V_80 -> V_5 . V_13 [ V_9 ] -> V_41 [ V_38 ] . V_44 = V_86 ;
if ( ++ V_38 == V_12 ) {
V_9 ++ ;
V_38 = 0 ;
}
...
struct V_83 * V_84 ;
unsigned long V_85 ;
F_41 (fmr, fmr_list, ibfmr.list) {
V_84 = & F_37 ( V_80 -> V_3 . V_87 ) -> V_88 ;
F_38 ( & V_84 -> V_89 , V_85 ) ;
V_80 -> V_5 . V_39 = 0 ;
V_80 -> V_5 . V_40 = 0 ;
V_80 -> V_5 . V_44 = 0 ;
...
void F_43 ( struct V_92 * V_93 )
{
struct V_4 * V_5 = F_2 ( V_93 , struct V_4 , V_93 ) ;
F_44 ( & V_5 -> V_17 ) ;
}
