...
F_23 ( F_24 ( V_26 ) , 0 , V_29 ) ;
F_25 ( & V_17 , V_31 ) ;
return V_26 ;
}
int F_26 ( unsigned long V_33 )
{
int V_15 ;
unsigned long V_31 ;
F_21 ( & V_17 , V_31 ) ;
...
unsigned long F_28 ( unsigned long V_33 , unsigned long V_29 )
{
unsigned long V_26 ;
unsigned long V_31 ;
F_21 ( & V_17 , V_31 ) ;
V_18 . V_32 = 1 ;
V_26 = F_29 ( & V_18 , V_33 , V_29 , L_6 ) ;
F_25 ( & V_17 , V_31 ) ;
return V_26 ;
}
...
unsigned long F_30 ( void T_2 * V_34 )
{
return V_34 - ( void T_2 * ) V_27 ;
}
T_6 F_31 ( void T_2 * V_34 )
{
...
{
return F_33 ( V_37 , struct V_35 , V_37 ) ;
}
static void F_34 ( struct V_36 * V_37 )
{
struct V_35 * V_38 = F_32 ( V_37 ) ;
struct V_39 T_2 * V_40 = V_37 -> V_41 ;
V_38 -> V_42 = F_2 ( & V_40 -> V_43 ) ;
}
static int F_35 ( struct V_44 * V_45 , unsigned int V_46 )
{
struct V_36 * V_37 = F_36 ( V_45 ) ;
struct V_39 T_2 * V_40 = V_37 -> V_41 ;
T_4 V_47 ;
V_47 = 1 << ( 31 - V_46 ) ;
return ! ! ( F_2 ( & V_40 -> V_43 ) & V_47 ) ;
}
static void F_37 ( struct V_36 * V_37 , T_4 V_47 ,
int V_48 )
{
struct V_35 * V_38 = F_32 ( V_37 ) ;
struct V_39 T_2 * V_40 = V_37 -> V_41 ;
...
static void F_38 ( struct V_44 * V_45 , unsigned int V_46 , int V_48 )
{
struct V_36 * V_37 = F_36 ( V_45 ) ;
struct V_35 * V_38 = F_32 ( V_37 ) ;
unsigned long V_31 ;
...
static int F_39 ( struct V_44 * V_45 , unsigned int V_46 , int V_50 )
{
struct V_36 * V_37 = F_36 ( V_45 ) ;
struct V_35 * V_38 = F_32 ( V_37 ) ;
struct V_39 T_2 * V_40 = V_37 -> V_41 ;
...
static int F_41 ( struct V_44 * V_45 , unsigned int V_46 )
{
struct V_36 * V_37 = F_36 ( V_45 ) ;
struct V_35 * V_38 = F_32 ( V_37 ) ;
struct V_39 T_2 * V_40 = V_37 -> V_41 ;
