...
static T_2 F_38 ( int V_17 , void * V_41 )
{
...
static T_2 F_40 ( int V_17 , void * V_41 )
{
struct V_3 * V_4 = V_41 ;
...
continue;
V_47 |= F_38 ( V_17 , & V_4 -> V_17 [ V_48 ] ) ;
}
}
return V_47 ;
}
static int F_41 ( struct V_49 * V_50 , unsigned int V_51 ,
T_3 V_52 )
{
...
F_42 ( V_51 , V_50 -> V_53 ) ;
F_43 ( V_51 , & V_54 ) ;
F_44 ( V_51 , & V_4 -> V_55 , V_56 ) ;
return 0 ;
}
static int F_45 ( struct V_57 * V_23 )
{
...
const char * V_67 = F_48 ( V_24 ) ;
int V_68 ;
int V_69 ;
int V_48 ;
V_4 = F_49 ( V_24 , sizeof( * V_4 ) , V_70 ) ;
if ( ! V_4 ) {
F_50 ( V_24 , L_10 ) ;
return - V_71 ;
}
...
V_7 -> V_1 = F_61 ( V_24 , V_65 [ V_48 ] -> V_79 ,
F_60 ( V_65 [ V_48 ] ) ) ;
if ( ! V_7 -> V_1 ) {
F_50 ( V_24 , L_17 ) ;
V_69 = - V_81 ;
...
for ( V_48 = 0 ; V_48 < V_4 -> V_80 ; V_48 ++ ) {
if ( F_64 ( V_24 , V_4 -> V_17 [ V_48 ] . V_29 ,
F_38 , 0 , V_67 ,
& V_4 -> V_17 [ V_48 ] ) ) {
F_50 ( V_24 , L_20 ) ;
V_69 = - V_94 ;
...
static int F_69 ( struct V_57 * V_23 )
{
struct V_3 * V_4 = F_70 ( V_23 ) ;
F_66 ( V_4 -> V_49 ) ;
F_67 ( & V_23 -> V_24 ) ;
F_68 ( & V_23 -> V_24 ) ;
return 0 ;
