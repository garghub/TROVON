...
V_11 -> V_161 = ( 1 << ( V_335 +
V_26 -> V_333 . V_336 ) ) - 1 ;
V_332 = F_128 ( V_26 -> V_333 . V_337 ) ;
V_11 -> V_179 = V_332 ;
}
F_26 ( V_2 , V_331 ) ;
V_331 -> V_130 = true ;
* V_330 = V_331 -> V_59 = V_331 -> V_338 ;
V_331 -> V_67 = - 1 ;
...
void F_129 ( struct V_1 * V_2 , struct V_30 * V_26 , T_1 V_6 )
{
...
void F_130 ( struct V_30 * V_26 , struct V_1 * V_2 ,
struct V_45 * V_11 )
{
struct V_5 * V_6 ;
struct V_3 * V_4 ;
...
F_131 ( & V_6 -> V_8 ) ;
F_2 ( V_2 , V_4 ) ;
F_71 ( V_26 , V_18 , V_339 ) ;
}
}
void F_132 ( struct V_1 * V_2 , struct V_45 * V_11 )
{
struct V_5 * V_6 ;
struct V_3 * V_4 ;
int V_18 ;
...
void F_133 ( struct V_1 * V_2 , struct V_30 * V_26 ,
T_1 V_18 )
{
struct V_5 * V_6 ;
struct V_45 * V_11 ;
...
V_4 = V_6 -> V_4 ;
F_1 ( V_2 , V_4 ) ;
V_6 -> V_129 = V_341 << V_26 -> V_333 . V_336 ;
if ( F_22 ( V_6 ) ) {
F_4 ( V_2 , V_4 , V_6 ) ;
F_79 ( V_2 , V_4 ) ;
}
...
void F_134 ( struct V_103 * V_43 ,
struct V_30 * V_26 ,
T_1 V_342 , int V_91 ,
enum V_343 V_344 ,
bool V_345 )
{
struct V_1 * V_2 = V_43 -> V_346 ;
struct V_45 * V_11 = (struct V_45 * ) V_26 -> V_13 ;
struct V_3 * V_4 = V_2 -> V_38 . V_311 ;
struct V_22 * V_35 ;
struct V_7 V_102 ;
struct V_31 * V_347 = NULL , * V_32 ;
struct V_106 * V_188 ;
int V_348 = 0 ;
int V_120 ;
F_32 ( & V_102 ) ;
for ( V_120 = 0 ; V_342 && V_91 ; V_120 ++ , V_342 >>= 1 ) {
struct V_5 * V_6 ;
if ( ! ( V_342 & 1 ) )
continue;
V_6 = F_21 ( V_11 , V_120 ) ;
...
struct V_3 * F_135 ( struct V_1 * V_2 , int V_350 , int V_351 )
{
struct V_226 * V_227 = V_2 -> V_86 ;
struct V_352 V_353 ;
...
V_4 -> V_144 = 0 ;
V_4 -> V_142 = false ;
V_2 -> V_38 . V_378 |= 1 << V_74 ;
V_4 -> V_379 = V_4 -> V_380 = 0 ;
for ( V_120 = 0 ; V_120 < V_381 ; V_120 ++ )
F_32 ( & V_4 -> V_382 [ V_120 ] ) ;
}
return & V_2 -> V_38 . V_4 [ V_74 ] ;
}
int F_139 ( struct V_1 * V_2 , int V_383 ,
struct V_352 * V_384 )
{
struct V_226 * V_227 = V_2 -> V_86 ;
int error = 0 ;
struct V_352 V_353 ;
F_140 ( V_2 -> V_38 . V_4 [ V_383 ] . V_74 != V_383 ) ;
F_141 ( V_227 , V_383 , & V_353 ) ;
V_353 . V_364 = V_384 -> V_364 ;
V_353 . V_366 = V_384 -> V_366 ;
V_353 . V_367 = V_384 -> V_367 ;
V_353 . V_385 = V_384 -> V_385 ;
V_353 . V_386 = V_384 -> V_386 ;
if ( ! F_142 ( V_227 , V_383 , & V_353 ) ) {
F_143 ( F_113 ( V_2 -> V_86 ) ,
L_1 , V_383 ) ;
error = - V_387 ;
} else {
F_144 ( V_227 , V_383 ) ;
...
{
struct V_352 V_353 ;
struct V_388 * V_389 = & V_2 -> V_390 -> V_391 ;
int V_383 = V_2 -> V_391 . V_392 -> V_74 ;
F_141 ( V_2 -> V_86 , V_383 , & V_353 ) ;
V_353 . V_386 = ( F_146 ( V_389 -> V_393 ) *
V_394 ) / 100 ;
F_139 ( V_2 , V_383 , & V_353 ) ;
return 0 ;
}
static void F_147 ( struct V_1 * V_2 , struct V_3 * V_4 ,
struct V_7 * V_8 )
{
struct V_31 * V_32 , * V_395 ;
struct V_7 V_53 ;
struct V_54 V_55 ;
memset ( & V_55 , 0 , sizeof( V_55 ) ) ;
V_55 . V_118 = V_119 ;
...
int V_146 = V_4 -> V_380 ;
while ( ! F_6 ( & V_4 -> V_382 [ V_146 ] ) ) {
F_147 ( V_2 , V_4 , & V_4 -> V_382 [ V_146 ] ) ;
F_38 ( V_146 , V_381 ) ;
}
V_4 -> V_380 = V_146 ;
}
...
int V_120 ;
V_94 V_396 = 0 ;
if ( F_37 ( V_397 , & V_261 -> V_398 ) )
return true ;
F_151 ( V_227 ) ;
for ( V_120 = 0 ; V_120 < V_399 ; V_120 ++ ) {
if ( ! F_137 ( V_2 , V_120 ) )
continue;
if ( ! V_2 -> V_38 . V_4 [ V_120 ] . V_143 )
continue;
if ( F_152 ( V_227 , V_2 -> V_38 . V_4 [ V_120 ] . V_74 ) )
V_396 |= F_153 ( V_120 ) ;
}
if ( V_396 ) {
F_154 ( V_2 , V_400 ) ;
...
V_2 -> V_38 . V_378 &= ~ ( 1 << V_4 -> V_74 ) ;
}
void F_79 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_260 * V_261 = F_113 ( V_2 -> V_86 ) ;
struct V_5 * V_6 , * V_402 ;
struct V_7 * V_403 ;
bool V_348 = false ;
if ( V_4 -> V_153 < 0 )
return;
if ( F_37 ( V_404 , & V_261 -> V_398 ) )
return;
F_48 ( & V_2 -> V_405 ) ;
V_403 = & V_2 -> V_390 -> V_17 [ V_4 -> V_153 ] ;
if ( F_6 ( V_403 ) ) {
F_50 ( & V_2 -> V_405 ) ;
return;
}
F_60 () ;
V_402 = F_158 ( V_403 -> V_72 , struct V_5 , V_8 ) ;
while ( ! F_6 ( V_403 ) ) {
bool V_325 = false ;
if ( V_2 -> V_390 -> V_41 )
break;
V_6 = F_51 ( V_403 , struct V_5 , V_8 ) ;
F_131 ( & V_6 -> V_8 ) ;
...
if ( F_6 ( V_407 ) )
return;
V_410 = ! ! ( V_227 -> V_87 . V_174 & V_175 ) ;
V_32 = F_51 ( V_407 , struct V_31 , V_8 ) ;
V_104 = F_158 ( V_407 -> V_72 , struct V_31 , V_8 ) ;
F_155 ( V_261 , V_411 , L_3 ,
V_4 -> V_74 , V_4 -> V_143 ) ;
if ( V_410 && F_6 ( & V_4 -> V_382 [ V_4 -> V_379 ] ) ) {
F_160 ( V_407 , & V_4 -> V_382 [ V_4 -> V_379 ] ) ;
F_38 ( V_4 -> V_379 , V_381 ) ;
V_409 = true ;
} else {
F_160 ( V_407 , & V_4 -> V_376 ) ;
if ( V_4 -> V_374 ) {
F_161 ( V_227 , V_4 -> V_374 , V_32 -> V_309 ) ;
F_155 ( V_261 , V_412 , L_4 ,
V_4 -> V_74 , V_4 -> V_374 ,
F_162 ( V_32 -> V_309 ) , V_32 -> V_85 ) ;
} else if ( ! V_410 )
V_409 = true ;
V_4 -> V_374 = V_104 -> V_85 ;
}
if ( V_409 ) {
F_44 ( V_4 -> V_74 , V_409 ) ;
F_163 ( V_227 , V_4 -> V_74 , V_32 -> V_309 ) ;
F_155 ( V_261 , V_412 , L_5 ,
...
{
struct V_22 * V_23 = F_9 ( V_21 ) ;
struct V_415 * V_416 = V_23 -> V_133 . V_416 ;
...
V_231 = 2 * V_12 -> V_419 . V_231 ;
} else {
struct V_1 * V_2 = V_43 -> V_346 ;
V_231 = V_2 -> V_390 -> V_421 ;
}
memset ( V_36 , 0 , sizeof( * V_36 ) ) ;
V_36 -> V_4 = - 1 ;
if ( V_416 )
V_36 -> V_172 = V_416 -> V_422 ;
else if ( V_11 && F_169 ( V_71 -> V_77 ) && V_11 -> V_423 > 0 )
V_36 -> V_172 = V_11 -> V_423 ;
else
V_36 -> V_172 = V_173 ;
V_36 -> V_321 = V_321 ;
V_36 -> V_196 = V_196 ;
...
T_2 F_115 ( struct V_1 * V_2 , T_2 V_424 , V_94 V_263 )
{
struct V_226 * V_227 = V_2 -> V_86 ;
struct V_425 * V_426 = V_227 -> V_426 ;
if ( ( V_227 -> V_87 . V_174 & V_427 ) && F_170 ( V_426 ) &&
( V_424 == 0x7 ) && ( V_263 < 0x90 ) )
return 0x3 ;
...
V_32 = F_47 ( V_2 ) ;
if ( ! V_32 ) {
F_155 ( V_261 , V_412 , L_6 ) ;
return NULL ;
}
F_55 ( V_32 ) ;
if ( V_6 && F_173 ( V_71 -> V_77 ) ) {
V_428 = F_174 ( V_71 -> V_429 ) & V_430 ;
V_25 = V_6 -> V_338 ;
V_71 -> V_429 = F_45 ( V_6 -> V_338 << V_28 ) ;
if ( V_428 )
V_71 -> V_429 |= F_45 ( V_428 ) ;
if ( ! F_175 ( V_71 -> V_77 ) )
F_38 ( V_6 -> V_338 , V_66 ) ;
V_32 -> V_58 . V_25 = V_25 ;
}
...
if ( V_35 -> V_51 & V_432 )
V_10 -> V_433 += 0x10 ;
V_71 -> V_429 &= F_45 ( V_430 ) ;
V_71 -> V_429 |= F_45 ( V_10 -> V_433 ) ;
}
...
struct V_70 * V_71 = (struct V_70 * ) V_21 -> V_76 ;
struct V_22 * V_35 = F_9 ( V_21 ) ;
struct V_30 * V_26 = V_435 -> V_26 ;
struct V_29 * V_12 = V_35 -> V_133 . V_12 ;
struct V_9 * V_10 ;
struct V_1 * V_2 = V_43 -> V_346 ;
int V_149 = V_21 -> V_258 + V_436 ;
int V_437 , V_438 ;
if ( V_26 )
V_435 -> V_11 = (struct V_45 * ) V_26 -> V_13 ;
else if ( V_12 && F_169 ( V_71 -> V_77 ) ) {
V_10 = ( void * ) V_12 -> V_13 ;
V_435 -> V_11 = & V_10 -> V_439 ;
}
if ( V_35 -> V_133 . V_416 )
V_149 += V_35 -> V_133 . V_416 -> V_440 ;
F_178 ( F_113 ( V_2 -> V_86 ) , V_21 ) ;
if ( ( V_12 && V_12 -> type != V_441 &&
V_12 -> type != V_442 ) ||
! F_169 ( V_71 -> V_77 ) )
V_35 -> V_51 |= V_183 ;
V_437 = F_180 ( V_71 -> V_77 ) ;
V_438 = V_437 & 3 ;
if ( V_438 && V_21 -> V_258 > V_437 ) {
if ( F_181 ( V_21 ) < V_438 )
return - V_443 ;
F_182 ( V_21 , V_438 ) ;
memmove ( V_21 -> V_76 , V_21 -> V_76 + V_438 , V_437 ) ;
}
...
struct V_1 * V_2 = V_43 -> V_346 ;
struct V_3 * V_4 = V_435 -> V_4 ;
struct V_5 * V_6 = NULL ;
struct V_31 * V_32 ;
bool V_214 , V_444 = false , V_445 ;
int V_37 , V_446 ;
if ( V_12 )
V_10 = ( void * ) V_12 -> V_13 ;
if ( V_35 -> V_51 & V_447 )
V_435 -> V_448 = true ;
V_445 = ! ! ( V_35 -> V_133 . V_51 & V_449 ) ;
V_446 = F_179 ( V_43 , V_21 , V_435 ) ;
if ( V_446 )
return V_446 ;
V_71 = (struct V_70 * ) V_21 -> V_76 ;
V_37 = F_184 ( V_21 ) ;
...
if ( ( ( V_10 && V_10 -> V_16 != V_2 -> V_390 ) ||
V_2 -> V_390 -> V_41 ) && ! V_435 -> V_448 ) {
if ( ! V_435 -> V_11 )
V_435 -> V_11 = & V_10 -> V_439 ;
V_214 = true ;
V_444 = true ;
...
if ( V_435 -> V_11 && V_214 )
V_6 = F_20 ( V_2 , V_435 -> V_11 , V_21 ) ;
if ( ! V_444 && V_445 ) {
F_2 ( V_2 , V_4 ) ;
V_4 = V_2 -> V_38 . V_311 ;
F_1 ( V_2 , V_4 ) ;
} else if ( V_435 -> V_11 && V_214 ) {
F_17 ( V_6 -> V_4 != V_435 -> V_4 ) ;
if ( V_35 -> V_51 & V_183 )
V_6 -> V_137 = true ;
F_44 ( V_4 -> V_74 , V_450 ) ;
F_70 ( & V_6 -> V_48 , V_21 ) ;
...
V_32 -> V_58 . V_253 = V_435 -> V_452 ;
if ( V_435 -> V_452 )
V_32 -> V_58 . V_453 = V_454 ;
F_13 ( V_12 , V_26 , V_32 ) ;
...
void F_187 ( struct V_103 * V_43 , struct V_29 * V_12 ,
struct V_20 * V_21 )
{
struct V_1 * V_2 = V_43 -> V_346 ;
struct V_434 V_435 = {
...
struct V_257 V_35 = {} ;
struct V_70 * V_71 ;
struct V_31 * V_347 = NULL ;
struct V_31 * V_32 ;
F_188 ( V_102 ) ;
int V_145 = 0 ;
int V_455 ;
V_455 =
V_2 -> V_390 -> V_391 . V_393 * 1000 *
V_2 -> V_390 -> V_391 . V_456 / V_457 ;
do {
struct V_19 * V_36 = F_8 ( V_21 ) ;
if ( F_179 ( V_43 , V_21 , & V_435 ) )
break;
V_32 = F_28 ( V_2 , V_435 . V_4 , NULL , V_21 ) ;
if ( ! V_32 )
break;
V_32 -> V_105 = V_32 ;
F_13 ( V_12 , NULL , V_32 ) ;
...
if ( V_71 -> V_77 & F_45 ( V_458 ) ) {
V_71 -> V_77 &= ~ F_45 ( V_458 ) ;
F_46 ( V_2 -> V_79 , V_32 -> V_80 ,
sizeof( * V_71 ) , V_81 ) ;
}
F_1 ( V_2 , V_435 . V_4 ) ;
F_122 ( V_2 , V_32 , V_435 . V_4 , 0 ) ;
F_126 ( V_2 , V_435 . V_4 , & V_102 , false ) ;
F_44 ( V_435 . V_4 -> V_74 , V_414 ) ;
F_2 ( V_2 , V_435 . V_4 ) ;
}
static void F_42 ( struct V_1 * V_2 , struct V_20 * V_21 ,
int V_459 , struct V_3 * V_4 )
{
struct V_22 * V_23 = F_9 ( V_21 ) ;
struct V_260 * V_261 = F_113 ( V_2 -> V_86 ) ;
struct V_70 * V_71 = (struct V_70 * ) V_21 -> V_76 ;
int V_437 , V_438 ;
unsigned long V_51 ;
F_155 ( V_261 , V_412 , L_8 , V_21 ) ;
if ( V_2 -> V_86 -> V_460 )
F_190 ( V_461 , & V_2 -> V_86 -> V_460 -> V_462 ) ;
if ( ! ( V_459 & V_68 ) ) {
if ( V_23 -> V_51 & V_313 )
V_23 -> V_51 |= V_463 ;
else
...
V_437 = F_180 ( V_71 -> V_77 ) ;
V_438 = V_437 & 3 ;
if ( V_438 && V_21 -> V_258 > V_437 + V_438 ) {
memmove ( V_21 -> V_76 + V_438 , V_21 -> V_76 , V_437 ) ;
F_191 ( V_21 , V_438 ) ;
}
F_192 ( & V_2 -> V_465 , V_51 ) ;
if ( ( V_2 -> V_466 & V_467 ) && ! V_4 -> V_143 ) {
V_2 -> V_466 &= ~ V_467 ;
F_155 ( V_261 , V_468 ,
L_9 ,
V_2 -> V_466 & ( V_469 |
...
if ( V_55 -> V_118 & V_135 )
V_23 -> V_51 |= V_472 ;
F_194 ( V_2 -> V_79 , V_32 -> V_80 , V_21 -> V_258 , V_81 ) ;
V_32 -> V_80 = 0 ;
if ( V_2 -> V_228 )
goto V_473;
if ( V_32 -> V_58 . V_253 ) {
...
F_198 ( V_2 , V_32 , V_55 , V_4 , V_459 ) ;
F_42 ( V_2 , V_21 , V_459 , V_4 ) ;
}
V_473:
V_32 -> V_33 = NULL ;
F_192 ( & V_2 -> V_38 . V_82 , V_51 ) ;
...
T_2 V_120 , V_476 ;
if ( V_90 )
V_23 -> V_477 . V_478 = V_55 -> V_479 ;
V_476 = V_55 -> V_122 ;
F_17 ( V_476 >= V_43 -> V_480 ) ;
if ( V_23 -> V_51 & V_52 ) {
V_23 -> V_51 |= V_481 ;
F_140 ( V_92 > V_91 ) ;
}
V_23 -> V_477 . V_482 = V_91 ;
V_23 -> V_477 . V_483 = V_91 - V_92 ;
if ( ( V_55 -> V_118 & V_135 ) == 0 &&
( V_23 -> V_51 & V_313 ) == 0 ) {
if ( F_49 ( V_55 -> V_125 & ( V_484 |
V_485 ) ) &&
F_169 ( V_71 -> V_77 ) &&
V_227 -> V_486 >= V_2 -> V_86 -> V_487 . V_488 )
V_23 -> V_477 . V_34 [ V_476 ] . V_69 =
V_43 -> V_489 ;
}
for ( V_120 = V_476 + 1 ; V_120 < V_43 -> V_480 ; V_120 ++ ) {
V_23 -> V_477 . V_34 [ V_120 ] . V_69 = 0 ;
V_23 -> V_477 . V_34 [ V_120 ] . V_146 = - 1 ;
}
V_23 -> V_477 . V_34 [ V_476 ] . V_69 = V_55 -> V_121 + 1 ;
}
static void F_199 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_226 * V_227 = V_2 -> V_86 ;
struct V_260 * V_261 = F_113 ( V_227 ) ;
struct V_31 * V_32 , * V_395 , * V_490 = NULL ;
struct V_7 V_53 ;
struct V_491 * V_492 ;
struct V_54 V_55 ;
int V_477 ;
F_155 ( V_261 , V_411 , L_10 ,
V_4 -> V_74 , F_200 ( V_2 -> V_86 , V_4 -> V_74 ) ,
V_4 -> V_374 ) ;
F_1 ( V_2 , V_4 ) ;
for (; ; ) {
if ( F_37 ( V_404 , & V_261 -> V_398 ) )
...
V_32 = F_51 ( & V_4 -> V_376 , struct V_31 , V_8 ) ;
V_490 = NULL ;
if ( V_32 -> V_58 . V_89 ) {
V_490 = V_32 ;
if ( F_201 ( & V_490 -> V_8 , & V_4 -> V_376 ) )
break;
V_32 = F_158 ( V_490 -> V_8 . V_493 , struct V_31 ,
V_8 ) ;
}
V_395 = V_32 -> V_105 ;
V_492 = V_395 -> V_85 ;
memset ( & V_55 , 0 , sizeof( V_55 ) ) ;
V_477 = F_202 ( V_227 , V_492 , & V_55 ) ;
if ( V_477 == - V_494 )
break;
F_44 ( V_4 -> V_74 , V_495 ) ;
V_395 -> V_58 . V_89 = true ;
F_32 ( & V_53 ) ;
if ( ! F_203 ( & V_395 -> V_8 ) )
F_148 ( & V_53 ,
& V_4 -> V_376 , V_395 -> V_8 . V_72 ) ;
if ( V_490 ) {
F_52 ( & V_490 -> V_8 ) ;
F_53 ( V_2 , V_490 ) ;
}
...
{
struct V_226 * V_227 = V_2 -> V_86 ;
V_94 V_496 = ( ( 1 << V_399 ) - 1 ) & V_227 -> V_497 ;
int V_120 ;
for ( V_120 = 0 ; V_120 < V_399 ; V_120 ++ ) {
if ( F_137 ( V_2 , V_120 ) && ( V_496 & ( 1 << V_120 ) ) )
F_199 ( V_2 , & V_2 -> V_38 . V_4 [ V_120 ] ) ;
}
}
...
if ( F_37 ( V_404 , & V_261 -> V_398 ) )
break;
V_477 = F_202 ( V_227 , NULL , ( void * ) & V_55 ) ;
if ( V_477 == - V_494 )
break;
if ( V_477 == - V_387 ) {
F_155 ( V_261 , V_412 , L_11 ) ;
break;
}
if ( V_55 . V_499 == V_2 -> V_391 . V_500 ) {
V_2 -> V_391 . V_501 = true ;
V_2 -> V_391 . V_502 = ! ( V_55 . V_118 & V_141 ) ;
if ( F_18 () ) {
F_206 ( V_2 , NULL ,
V_503 ) ;
}
...
V_4 = & V_2 -> V_38 . V_4 [ V_55 . V_499 ] ;
F_1 ( V_2 , V_4 ) ;
F_44 ( V_4 -> V_74 , V_495 ) ;
V_498 = & V_4 -> V_382 [ V_4 -> V_380 ] ;
if ( F_6 ( V_498 ) ) {
F_2 ( V_2 , V_4 ) ;
return;
}
V_32 = F_51 ( V_498 , struct V_31 , V_8 ) ;
if ( V_32 -> V_58 . V_89 ) {
F_52 ( & V_32 -> V_8 ) ;
F_53 ( V_2 , V_32 ) ;
V_32 = F_51 ( V_498 , struct V_31 , V_8 ) ;
...
V_395 = V_32 -> V_105 ;
F_32 ( & V_53 ) ;
if ( F_201 ( & V_395 -> V_8 , V_498 ) ) {
F_160 ( V_498 , & V_53 ) ;
F_38 ( V_4 -> V_380 , V_381 ) ;
if ( ! F_6 ( & V_4 -> V_376 ) ) {
struct V_7 V_102 ;
F_32 ( & V_102 ) ;
V_4 -> V_374 = NULL ;
F_160 ( & V_4 -> V_376 , & V_102 ) ;
...
static int F_208 ( struct V_1 * V_2 , int V_504 )
{
struct V_505 * V_506 = & V_2 -> V_507 ;
T_2 V_508 = V_2 -> V_86 -> V_87 . V_508 ;
V_506 -> V_509 = V_504 * V_508 ;
V_506 -> V_510 = F_209 ( V_2 -> V_79 , V_506 -> V_509 ,
& V_506 -> V_511 , V_512 ) ;
if ( ! V_506 -> V_510 )
return - V_443 ;
return 0 ;
...
{
int V_513 ;
V_513 = F_208 ( V_2 , V_514 ) ;
if ( ! V_513 )
F_211 ( V_2 -> V_86 , V_2 -> V_507 . V_510 ,
V_2 -> V_507 . V_511 ,
V_514 ) ;
return V_513 ;
}
int F_212 ( struct V_1 * V_2 , int V_515 )
{
struct V_260 * V_261 = F_113 ( V_2 -> V_86 ) ;
int error = 0 ;
F_138 ( & V_2 -> V_38 . V_82 ) ;
error = F_213 ( V_2 , & V_2 -> V_38 . V_516 , & V_2 -> V_38 . V_83 ,
L_12 , V_515 , 1 , 1 ) ;
if ( error != 0 ) {
F_143 ( V_261 ,
L_13 , error ) ;
...
error = F_213 ( V_2 , & V_2 -> V_391 . V_517 , & V_2 -> V_391 . V_518 ,
L_14 , V_457 , 1 , 1 ) ;
if ( error != 0 ) {
F_143 ( V_261 ,
L_15 , error ) ;
...
F_214 ( & V_2 -> V_519 , V_520 ) ;
if ( V_2 -> V_86 -> V_87 . V_174 & V_175 )
error = F_210 ( V_2 ) ;
return error ;
}
void F_215 ( struct V_1 * V_2 , struct V_45 * V_11 )
{
struct V_5 * V_6 ;
int V_18 , V_521 ;
for ( V_18 = 0 , V_6 = & V_11 -> V_6 [ V_18 ] ;
...
V_36 -> V_172 = V_173 ;
V_36 -> V_196 = V_21 -> V_258 + V_436 ;
V_36 -> V_321 = V_524 ;
V_32 = F_28 ( V_2 , V_435 -> V_4 , NULL , V_21 ) ;
if ( ! V_32 ) {
F_155 ( V_261 , V_412 , L_17 ) ;
return - V_523 ;
}
F_13 ( V_2 -> V_525 , NULL , V_32 ) ;
F_161 ( V_2 -> V_86 , V_32 -> V_85 , V_32 -> V_309 ) ;
F_218 ( V_2 -> V_86 , V_435 -> V_4 -> V_74 ) ;
F_165 ( V_2 , V_435 -> V_4 , NULL , V_21 ) ;
return 0 ;
}
