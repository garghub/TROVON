...
if ( V_8 && * V_11 )
fprintf ( V_16 , L_7 , V_11 ) ;
V_14 += vfprintf ( V_16 , V_12 , args ) ;
if ( V_8 && * V_11 )
fprintf ( V_16 , L_7 , V_15 ) ;
return V_14 ;
}
...
{
return F_10 ( V_16 , V_11 , V_12 , args ) ;
}
...
int F_15 ( T_3 * V_16 , const char * V_11 ,
...
int F_17 ( T_3 * V_16 , const char * V_12 , double V_20 )
{
int V_14 ;
const char * V_11 ;
V_11 = F_16 ( V_20 ) ;
...
int F_18 ( char * V_9 , T_1 V_10 , const char * V_12 , double V_2 )
{
const char * V_11 = F_16 ( V_2 ) ;
return F_13 ( V_9 , V_10 , V_11 , V_12 , V_2 ) ;
}
int F_19 ( char * V_9 , T_1 V_10 , const char * V_12 , ... )
{
T_2 args ;
double V_20 ;
va_start ( args , V_12 ) ;
...
va_end ( args ) ;
return F_18 ( V_9 , V_10 , V_12 , V_20 ) ;
}
