...
{
struct V_87 * V_88 ;
V_88 = F_54 ( L_14 , 0440 , V_11 -> V_89 , & V_90 ) ;
if ( ! V_88 )
goto V_91;
V_88 = F_54 ( L_14 , V_92 , V_11 -> V_93 ,
& V_94 ) ;
if ( ! V_88 )
goto V_95;
return 0 ;
...
{
struct V_97 * V_98 ;
V_98 = F_58 ( V_99 , sizeof( V_99 ) ,
V_100 ) ;
if ( ! V_98 )
goto V_101;
V_98 [ 1 ] . V_102 = & V_11 -> V_17 . V_68 ;
V_98 [ 2 ] . V_102 = & V_11 -> V_17 . V_18 ;
V_98 [ 3 ] . V_102 = & V_11 -> V_17 . V_103 ;
V_98 [ 4 ] . V_102 = & V_11 -> V_17 . V_104 ;
if ( V_11 -> V_105 != & V_106 )
V_98 [ 0 ] . V_107 = NULL ;
V_11 -> V_17 . V_108 = F_59 ( V_11 , L_15 , V_98 ) ;
if ( ! V_11 -> V_17 . V_108 )
goto V_109;
return 0 ;
V_109:
...
{
struct V_97 * V_98 ;
V_98 = V_11 -> V_17 . V_108 -> V_110 ;
F_62 ( V_11 -> V_17 . V_108 ) ;
F_60 ( V_98 ) ;
}
static int F_57 ( struct V_11 * V_11 )
{
