...
static struct V_2 * F_63 ( struct V_68 * V_68 , struct V_69 * V_2 , int V_70 , T_2 V_71 , int V_72 )
{
struct V_2 * V_3 ;
V_3 = F_64 ( V_68 , V_73 , V_71 , & V_74 , V_72 ) ;
if ( ! V_3 )
return NULL ;
F_65 ( V_2 , V_3 ) ;
F_66 ( & F_61 ( V_3 ) -> V_75 ) ;
...
static int F_70 ( struct V_68 * V_68 , struct V_69 * V_2 , int V_81 ,
int V_72 )
{
struct V_2 * V_3 ;
F_2 ( L_13 , V_2 ) ;
...
return - V_84 ;
V_2 -> V_85 = & V_86 ;
V_3 = F_63 ( V_68 , V_2 , V_81 , V_87 , V_72 ) ;
if ( ! V_3 )
return - V_37 ;
F_60 ( V_3 , NULL ) ;
return 0 ;
...
static int F_88 ( struct V_69 * V_2 , struct V_42 * V_43 ,
T_3 V_44 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_22 ;
...
if ( ! F_28 ( V_15 ) ) {
struct V_117 V_118 ;
F_33 ( & V_118 . V_119 , & V_16 -> V_28 ) ;
V_118 . V_120 = 0x00 ;
F_91 ( V_15 , V_121 , sizeof( V_118 ) , & V_118 ) ;
} else {
struct V_122 V_118 ;
F_33 ( & V_118 . V_119 , & V_16 -> V_28 ) ;
V_118 . V_123 = F_92 ( V_16 -> V_123 ) ;
V_118 . V_124 = F_93 ( 0x00001f40 ) ;
V_118 . V_125 = F_93 ( 0x00001f40 ) ;
V_118 . V_126 = F_92 ( V_33 ) ;
switch ( V_33 & V_127 ) {
case V_128 :
if ( V_16 -> V_123 & V_129 )
V_118 . V_130 = F_92 ( 0x0008 ) ;
else
V_118 . V_130 = F_92 ( 0x000D ) ;
V_118 . V_131 = 0x02 ;
break;
case V_132 :
V_118 . V_130 = F_92 ( 0xffff ) ;
V_118 . V_131 = 0xff ;
break;
}
F_91 ( V_15 , V_133 ,
...
static int F_94 ( struct V_69 * V_2 , struct V_42 * V_43 ,
T_3 V_44 , int V_67 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
...
F_58 ( V_3 ) ;
if ( V_3 -> V_4 == V_65 &&
F_95 ( V_136 , & F_61 ( V_3 ) -> V_67 ) ) {
F_90 ( V_135 -> V_16 -> V_13 , V_135 -> V_33 ) ;
V_3 -> V_4 = V_61 ;
F_59 ( V_3 ) ;
return 0 ;
}
F_59 ( V_3 ) ;
return F_96 ( V_2 , V_43 , V_44 , V_67 ) ;
}
static int F_97 ( struct V_69 * V_2 , int V_137 , int V_138 , char T_5 * V_139 , unsigned int V_140 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_44 , V_22 = 0 ;
struct V_141 V_142 ;
...
if ( F_98 ( V_143 , ( T_6 T_5 * ) V_139 ) ) {
V_22 = - V_50 ;
break;
}
if ( V_143 )
F_99 ( V_136 , & F_61 ( V_3 ) -> V_67 ) ;
else
F_100 ( V_136 , & F_61 ( V_3 ) -> V_67 ) ;
break;
case V_145 :
if ( V_3 -> V_4 != V_79 && V_3 -> V_4 != V_97 &&
V_3 -> V_4 != V_65 ) {
...
if ( F_102 ( ( char * ) & V_142 , V_139 , V_44 ) ) {
V_22 = - V_50 ;
break;
}
if ( V_142 . V_33 != V_34 &&
...
static int F_103 ( struct V_69 * V_2 , int V_138 , char T_5 * V_139 , int T_5 * V_140 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_147 V_148 ;
struct V_149 V_150 ;
...
if ( F_104 ( V_139 , ( char * ) & V_148 , V_44 ) )
V_22 = - V_50 ;
break;
case V_152 :
if ( V_3 -> V_4 != V_39 &&
...
if ( F_104 ( V_139 , ( char * ) & V_150 , V_44 ) )
V_22 = - V_50 ;
break;
default:
V_22 = - V_146 ;
...
static int F_105 ( struct V_69 * V_2 , int V_137 , int V_138 , char T_5 * V_139 , int T_5 * V_140 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_44 , V_22 = 0 ;
struct V_141 V_142 ;
F_2 ( L_9 , V_3 ) ;
if ( V_137 == V_156 )
return F_103 ( V_2 , V_138 , V_139 , V_140 ) ;
if ( F_98 ( V_44 , V_140 ) )
return - V_50 ;
F_58 ( V_3 ) ;
switch ( V_138 ) {
...
if ( F_106 ( F_95 ( V_136 , & F_61 ( V_3 ) -> V_67 ) ,
( T_6 T_5 * ) V_139 ) )
V_22 = - V_50 ;
break;
case V_145 :
...
if ( F_104 ( V_139 , ( char * ) & V_142 , V_44 ) )
V_22 = - V_50 ;
break;
default:
V_22 = - V_146 ;
...
static int F_107 ( struct V_69 * V_2 , int V_157 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_22 = 0 ;
F_2 ( L_18 , V_2 , V_3 ) ;
...
int F_113 ( struct V_14 * V_15 , T_1 * V_119 , T_7 * V_67 )
{
struct V_2 * V_3 ;
int V_165 = 0 ;
...
if ( V_3 -> V_4 != V_53 )
continue;
if ( ! F_46 ( & F_15 ( V_3 ) -> V_27 , & V_15 -> V_119 ) ||
! F_46 ( & F_15 ( V_3 ) -> V_27 , V_56 ) ) {
V_165 |= V_167 ;
if ( F_95 ( V_136 , & F_61 ( V_3 ) -> V_67 ) )
* V_67 |= V_168 ;
break;
}
}
...
static void F_114 ( struct V_12 * V_13 , T_7 V_169 )
{
...
F_20 ( V_13 , F_115 ( V_169 ) ) ;
}
static void F_116 ( struct V_12 * V_13 , T_7 V_170 )
{
if ( V_13 -> type != V_32 && V_13 -> type != V_31 )
return;
F_2 ( L_22 , V_13 , V_170 ) ;
F_20 ( V_13 , F_115 ( V_170 ) ) ;
}
void F_117 ( struct V_12 * V_13 , struct V_45 * V_46 )
{
struct V_11 * V_16 = V_13 -> V_17 ;
if ( ! V_16 )
goto V_51;
...
static int F_118 ( struct V_171 * V_172 , void * V_173 )
{
struct V_2 * V_3 ;
F_48 ( & V_55 . V_19 ) ;
F_45 (sk, &sco_sk_list.head) {
F_119 ( V_172 , L_24 , & F_15 ( V_3 ) -> V_27 ,
& F_15 ( V_3 ) -> V_28 , V_3 -> V_4 ) ;
}
F_49 ( & V_55 . V_19 ) ;
return 0 ;
}
static int F_120 ( struct V_174 * V_174 , struct V_175 * V_175 )
{
return F_121 ( V_175 , F_118 , V_174 -> V_176 ) ;
}
int T_8 F_122 ( void )
{
int V_22 ;
...
if ( V_22 < 0 )
return V_22 ;
V_22 = F_125 ( V_163 , & V_177 ) ;
if ( V_22 < 0 ) {
F_126 ( L_25 ) ;
goto error;
}
V_22 = F_127 ( & V_178 , L_26 , & V_55 , NULL ) ;
if ( V_22 < 0 ) {
F_126 ( L_27 ) ;
F_128 ( V_163 ) ;
goto error;
