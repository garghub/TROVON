...
F_14 ( L_37 ,
F_38 ( F_35 ( V_60 ) ) ) ;
return F_39 ( V_15 ? F_40 ( V_15 ) : - V_74 ) ;
}
V_15 -> V_41 = F_41 ( V_60 ) ;
if ( F_37 ( V_15 -> V_41 ) ) {
F_14 ( L_38 ,
F_42 ( V_60 ) , F_40 ( V_15 -> V_41 ) ) ;
goto V_75;
}
F_43 ( & V_15 -> V_23 ) ;
F_44 ( & V_15 -> V_76 ) ;
...
static void F_54 ( struct V_169 * V_169 )
{
struct V_14 * V_15 , * V_170 ;
struct V_70 * V_60 ;
bool V_171 = false ;
V_60 = F_55 ( V_169 , struct V_14 , V_168 ) -> V_78 ;
F_17 ( & V_53 ) ;
F_56 (us_ibdev, tmp,
...
F_58 ( ! V_171 , L_43 , F_42 ( V_60 ) ) ;
F_25 ( & V_53 ) ;
}
static struct V_14 * F_59 ( struct V_173 * V_9 )
{
struct V_14 * V_15 ;
...
V_5 -> V_9 = F_71 ( V_78 ) ;
if ( F_37 ( V_5 -> V_9 ) ) {
V_67 = V_5 -> V_9 ? F_40 ( V_5 -> V_9 ) : - V_183 ;
F_14 ( L_46 ,
F_42 ( V_78 ) , V_67 ) ;
goto V_187;
}
