...
static void F_19 ( struct V_39 * V_40 , void * V_1 )
{
struct V_3 * V_4 = V_1 ;
if ( V_4 -> V_25 )
F_20 ( V_4 -> V_25 ) ;
}
static int F_21 ( struct V_39 * V_40 , void * V_1 )
{
struct V_3 * V_4 = V_1 ;
struct V_41 * V_42 = F_22 ( V_40 ) ;
...
if ( V_21 )
return V_21 ;
V_47 = F_28 ( V_40 , & V_49 . V_50 ) ;
if ( F_6 ( V_47 ) )
return F_8 ( V_47 ) ;
V_4 = F_29 ( V_13 , sizeof( * V_4 ) , V_51 ) ;
if ( ! V_4 )
return - V_52 ;
V_21 = F_4 ( V_4 , V_13 ) ;
if ( V_21 ) {
...
V_47 -> exit = F_19 ;
V_47 -> V_55 = F_1 ;
V_21 = F_21 ( V_40 , V_47 -> V_53 ) ;
if ( V_21 )
return V_21 ;
return F_30 ( & V_40 -> V_13 , V_47 , & V_49 ) ;
}
