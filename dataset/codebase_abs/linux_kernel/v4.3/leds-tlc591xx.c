...
return - V_58 ;
V_10 = F_22 ( V_29 , sizeof( * V_10 ) , V_59 ) ;
if ( ! V_10 )
return - V_60 ;
V_10 -> V_1 = F_23 ( V_43 , & V_61 ) ;
if ( F_24 ( V_10 -> V_1 ) ) {
V_3 = F_25 ( V_10 -> V_1 ) ;
F_9 ( V_29 , L_3 , V_3 ) ;
return V_3 ;
...
F_29 ( V_49 , L_5 , NULL ) ? : V_49 -> V_41 ;
V_10 -> V_33 [ V_53 ] . V_24 . V_62 =
F_29 ( V_49 , L_6 , NULL ) ;
}
return F_16 ( V_29 , V_10 , V_36 ) ;
}
static int
F_30 ( struct V_42 * V_43 )
{
struct V_9 * V_10 = F_31 ( V_43 ) ;
F_13 ( V_10 , V_38 ) ;
return 0 ;
}
