...
void F_287 ( struct V_14 * V_57 , T_2 V_19 , void * * V_242 )
{
F_288 ( V_57 , V_19 , V_242 ) ;
}
bool F_289 ( struct V_14 * V_57 , T_4 V_16 , T_2 V_19 ,
void * * V_242 )
{
return F_290 ( V_57 , V_16 , V_19 , V_242 ) ;
}
void *
F_291 ( struct V_14 * V_15 , T_4 V_16 , T_2 V_19 )
{
void * V_137 ;
...
static T_9 void *
F_296 ( T_2 V_19 , T_4 V_16 , int V_64 , unsigned long V_205 )
{
struct V_14 * V_15 ;
V_15 = F_201 ( V_19 , V_16 ) ;
if ( F_41 ( F_202 ( V_15 ) ) )
return V_15 ;
return F_294 ( V_15 , V_16 , V_64 , V_19 ) ;
}
void * F_297 ( T_2 V_19 , T_4 V_16 , int V_64 )
{
return F_296 ( V_19 , V_16 , V_64 , V_290 ) ;
}
void * F_298 ( T_2 V_19 , T_4 V_16 ,
int V_64 , unsigned long V_205 )
{
return F_296 ( V_19 , V_16 , V_64 , V_205 ) ;
}
static T_9 void * F_299 ( T_2 V_19 , T_4 V_16 ,
unsigned long V_205 )
{
struct V_14 * V_15 ;
void * V_137 ;
...
void * F_300 ( T_2 V_19 , T_4 V_16 )
{
return F_299 ( V_19 , V_16 , V_290 ) ;
}
void * F_301 ( T_2 V_19 , T_4 V_16 , unsigned long V_205 )
{
return F_299 ( V_19 , V_16 , V_205 ) ;
}
...
F_235 ( V_1 ) ;
V_292 = F_14 ( V_1 ) ;
F_303 ( V_1 , V_292 -> V_206 ) ;
F_304 ( V_1 , V_292 -> V_206 ) ;
F_280 ( V_292 , ( void * ) V_1 , V_290 ) ;
F_270 ( V_16 ) ;
}
static int F_307 ( struct V_14 * V_15 , T_4 V_82 )
{
int V_64 ;
struct V_3 * V_84 ;
struct V_36 * V_293 ;
...
static int F_308 ( struct V_14 * V_15 , int V_76 ,
...
F_217 ( V_243 ) ;
V_296:
return F_307 ( V_15 , V_82 ) ;
}
static int F_310 ( struct V_14 * V_15 , int V_76 ,
int V_79 , int V_8 , T_4 V_82 )
{
int V_137 ;
struct V_14 * V_292 ;
V_137 = F_308 ( V_15 , V_76 , V_79 , V_8 , V_82 ) ;
if ( V_164 < V_174 )
return V_137 ;
if ( ( V_137 < 0 ) || ! F_311 ( V_15 ) )
return V_137 ;
F_312 ( & V_126 ) ;
F_313 (c, cachep) {
F_308 ( V_292 , V_76 , V_79 , V_8 , V_82 ) ;
}
return V_137 ;
}
...
V_79 = ( V_76 + 1 ) / 2 ;
V_298:
V_118 = F_310 ( V_15 , V_76 , V_79 , V_8 , V_82 ) ;
if ( V_118 )
F_27 ( V_53 L_36 ,
V_15 -> V_54 , - V_118 ) ;
return V_118 ;
...
F_39 () ;
V_86:
F_321 ( V_71 , F_322 ( V_304 ) ) ;
}
void F_323 ( struct V_14 * V_15 , struct V_305 * V_306 )
{
struct V_22 * V_22 ;
unsigned long V_183 ;
unsigned long V_184 ;
...
void F_324 ( struct V_310 * V_311 , struct V_14 * V_15 )
{
#if V_288
{
...
{
unsigned long V_324 = F_326 ( & V_15 -> V_324 ) ;
unsigned long V_325 = F_326 ( & V_15 -> V_325 ) ;
unsigned long V_326 = F_326 ( & V_15 -> V_326 ) ;
unsigned long V_327 = F_326 ( & V_15 -> V_327 ) ;
F_325 ( V_311 , L_44 ,
V_324 , V_325 , V_326 , V_327 ) ;
}
#endif
}
T_10 F_327 ( struct V_328 * V_328 , const char T_11 * V_329 ,
...
static inline int F_329 ( unsigned long * V_84 , unsigned long V_338 )
{
unsigned long * V_242 ;
int V_339 ;
if ( ! V_338 )
...
static void F_330 ( unsigned long * V_84 , struct V_14 * V_292 ,
struct V_22 * V_22 )
{
void * V_242 ;
int V_88 ;
...
continue;
if ( ! F_329 ( V_84 , ( unsigned long ) * F_11 ( V_292 , V_242 ) ) )
return;
}
}
static void F_331 ( struct V_310 * V_311 , unsigned long V_341 )
{
#ifdef F_332
unsigned long V_34 , V_19 ;
char V_342 [ V_343 ] , V_54 [ V_344 ] ;
if ( F_333 ( V_341 , & V_19 , & V_34 , V_342 , V_54 ) == 0 ) {
F_325 ( V_311 , L_46 , V_54 , V_34 , V_19 ) ;
if ( V_342 [ 0 ] )
F_325 ( V_311 , L_47 , V_342 ) ;
return;
}
#endif
F_325 ( V_311 , L_48 , ( void * ) V_341 ) ;
}
static int F_334 ( struct V_310 * V_311 , void * V_242 )
{
...
if ( V_262 [ 0 ] == V_262 [ 1 ] ) {
F_111 ( & V_126 ) ;
V_311 -> V_345 = F_335 ( V_262 [ 0 ] * 4 * sizeof( unsigned long ) , V_108 ) ;
if ( ! V_311 -> V_345 ) {
V_311 -> V_345 = V_262 ;
F_110 ( & V_126 ) ;
return - V_109 ;
...
F_325 ( V_311 , L_49 , V_54 , V_262 [ 2 * V_88 + 3 ] ) ;
F_331 ( V_311 , V_262 [ 2 * V_88 + 2 ] ) ;
F_336 ( V_311 , '\n' ) ;
}
return 0 ;
}
static int F_337 ( struct V_346 * V_346 , struct V_328 * V_328 )
{
unsigned long * V_84 ;
V_84 = F_338 ( V_328 , & V_347 , V_49 ) ;
if ( ! V_84 )
return - V_109 ;
* V_84 = V_49 / ( 2 * sizeof( unsigned long ) ) ;
return 0 ;
}
static int T_3 F_339 ( void )
{
#ifdef V_40
F_340 ( L_50 , 0 , NULL , & V_348 ) ;
#endif
return 0 ;
}
T_2 F_341 ( const void * V_1 )
{
F_9 ( ! V_1 ) ;
if ( F_41 ( V_1 == V_349 ) )
return 0 ;
