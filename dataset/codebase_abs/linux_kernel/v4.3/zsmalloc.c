...
static void * F_10 ( char * V_9 , T_1 V_10 ,
...
F_70 ( V_165 , & V_166 , & V_168 ) ;
F_70 ( V_164 , & V_167 , & V_169 ) ;
...
{
unsigned long V_182 ;
V_182 = F_39 ( V_45 , V_73 ) -
F_39 ( V_45 , V_74 ) ;
V_182 /= F_25 ( V_45 -> V_13 ,
V_45 -> V_28 ) ;
return V_182 * V_45 -> V_28 ;
}
...
F_47 ( & V_45 -> V_70 ) ;
while ( ( V_183 = F_140 ( V_45 ) ) ) {
F_31 ( ! F_26 ( V_183 ) ) ;
if ( ! F_141 ( V_45 ) )
break;
V_179 . V_69 = 0 ;
V_179 . V_166 = V_183 ;
while ( ( V_184 = F_138 ( V_45 ) ) ) {
V_179 . V_167 = V_184 ;
...
break;
F_139 ( V_2 , V_45 , V_184 ) ;
if ( F_139 ( V_2 , V_45 , V_183 ) == V_88 )
V_2 -> V_48 . V_185 += V_45 -> V_28 ;
F_48 ( & V_45 -> V_70 ) ;
F_143 () ;
F_47 ( & V_45 -> V_70 ) ;
}
if ( V_183 )
F_139 ( V_2 , V_45 , V_183 ) ;
F_48 ( & V_45 -> V_70 ) ;
}
...
return V_2 -> V_48 . V_185 ;
}
void F_145 ( struct V_1 * V_2 , struct F_145 * V_48 )
{
memcpy ( V_48 , & V_2 -> V_48 , sizeof( struct F_145 ) ) ;
}
static unsigned long F_146 ( struct V_186 * V_186 ,
struct V_187 * V_188 )
{
unsigned long V_189 ;
struct V_1 * V_2 = F_147 ( V_186 , struct V_1 ,
V_186 ) ;
V_189 = V_2 -> V_48 . V_185 ;
V_189 = F_144 ( V_2 ) - V_189 ;
return V_189 ? V_189 : V_190 ;
}
static unsigned long F_148 ( struct V_186 * V_186 ,
struct V_187 * V_188 )
{
int V_56 ;
struct V_44 * V_45 ;
...
{
V_2 -> V_186 . V_193 = F_146 ;
V_2 -> V_186 . V_194 = F_148 ;
V_2 -> V_186 . V_195 = 0 ;
V_2 -> V_186 . V_196 = V_197 ;
return F_152 ( & V_2 -> V_186 ) ;
}
struct V_1 * F_11 ( char * V_9 , T_1 V_5 )
{
int V_56 ;
struct V_1 * V_2 ;
struct V_44 * V_198 = NULL ;
V_2 = F_153 ( sizeof( * V_2 ) , V_138 ) ;
if ( ! V_2 )
return NULL ;
...
V_28 = F_64 ( V_13 ) ;
if ( V_198 ) {
if ( F_124 ( V_198 , V_13 , V_28 ) ) {
V_2 -> V_44 [ V_56 ] = V_198 ;
continue;
}
}
V_45 = F_153 ( sizeof( struct V_44 ) , V_138 ) ;
if ( ! V_45 )
goto V_199;
V_45 -> V_13 = V_13 ;
V_45 -> V_69 = V_56 ;
