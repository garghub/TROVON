...
V_20 -> V_28 ) ;
if ( V_20 -> V_30 == V_31 )
V_76 |= F_28 ( & V_20 -> V_33 , 1 ) ;
else
V_76 |= F_27 ( & V_20 -> V_33 , 0 ) ;
if ( V_76 )
return 3 ;
V_75 = F_29 ( V_20 -> V_86 , V_74 ? 125000 : 1000000 ) ;
V_76 |= F_27 ( & V_20 -> V_86 , V_75 ) ;
if ( V_76 )
return 4 ;
return 0 ;
}
static void F_30 ( unsigned int V_56 ,
T_2 * V_88 ,
T_2 * V_89 )
{
if ( V_56 < 8 )
...
static int F_31 ( struct V_5 * V_6 , int V_90 )
{
struct V_69 * V_70 = F_10 ( V_6 ) ;
struct V_8 * V_9 = V_6 -> V_10 ;
int V_91 ;
V_9 -> V_92 [ 0 ] = V_90 ;
return F_32 ( V_70 , F_33 ( V_70 , 1 ) ,
V_9 -> V_92 , V_93 ,
& V_91 , V_94 ) ;
}
static int F_34 ( struct V_5 * V_6 , int V_95 )
{
struct V_69 * V_70 = F_10 ( V_6 ) ;
struct V_8 * V_9 = V_6 -> V_10 ;
int V_96 ;
...
{
struct V_8 * V_9 = V_6 -> V_10 ;
unsigned int V_56 = F_19 ( V_109 -> V_111 ) ;
T_2 V_88 = 0 ;
T_2 V_89 = 0 ;
T_2 V_105 = 0 ;
int V_22 ;
...
int V_22 ;
F_5 ( & V_9 -> V_16 ) ;
V_22 = F_41 ( V_6 , V_15 , V_109 , V_110 ) ;
F_6 ( & V_9 -> V_16 ) ;
return V_22 ;
}
...
{
int V_22 ;
V_22 = F_47 ( V_6 , V_15 , V_109 , V_110 , 0 ) ;
if ( V_22 )
return V_22 ;
return V_109 -> V_114 ;
}
...
static void F_50 ( struct V_5 * V_6 , int V_7 )
{
struct V_8 * V_9 = V_6 -> V_10 ;
if ( V_7 ) {
if ( V_9 -> V_121 )
...
F_54 ( V_1 , V_70 , F_33 ( V_70 , 4 ) ,
V_1 -> V_43 , V_9 -> V_124 ,
F_52 , V_6 ) ;
return F_11 ( V_1 , V_37 ) ;
}
...
case V_140 :
return F_51 ( V_6 , V_15 ) ;
case V_141 :
V_110 [ 1 ] = V_9 -> V_122 ;
return 0 ;
case V_142 :
return F_55 ( V_6 , V_15 , V_110 [ 1 ] ) ;
case V_143 :
V_110 [ 1 ] = V_9 -> V_130 ;
return 0 ;
case V_144 :
F_57 ( V_6 , V_15 , V_56 , V_110 [ 1 ] , ( V_110 [ 2 ] != 0 ) ) ;
return 0 ;
case V_145 :
return - V_102 ;
}
...
static int F_60 ( struct V_5 * V_6 , int V_56 )
{
struct V_8 * V_9 = V_6 -> V_10 ;
T_2 V_105 ;
T_1 V_21 ;
...
if ( V_22 < 0 )
return V_22 ;
V_21 = F_8 ( F_39 ( ( V_115 * ) ( V_9 -> V_98 + 1 ) ) ) ;
V_21 &= 0x00ffffff ;
V_21 ^= 0x00800000 ;
return ( int ) V_21 ;
}
static int F_61 ( struct V_5 * V_6 ,
const T_3 * V_110 , T_4 V_146 ,
unsigned long V_41 )
{
struct V_69 * V_70 = F_10 ( V_6 ) ;
T_2 * V_136 ;
...
struct V_1 * V_1 ;
int V_4 ;
V_9 -> V_92 = F_68 ( V_93 , V_149 ) ;
V_9 -> V_29 = F_68 ( V_44 , V_149 ) ;
V_9 -> V_98 = F_68 ( V_99 , V_149 ) ;
V_9 -> V_11 = F_69 ( V_9 -> V_12 , sizeof( V_1 ) , V_149 ) ;
V_9 -> V_50 = F_69 ( V_9 -> V_51 , sizeof( V_1 ) , V_149 ) ;
...
V_1 -> V_6 = V_70 ;
V_1 -> V_41 = NULL ;
V_1 -> V_153 = F_71 ( V_70 , 6 ) ;
V_1 -> V_71 = V_72 ;
V_1 -> V_43 = F_68 ( V_44 , V_149 ) ;
if ( ! V_1 -> V_43 )
return - V_148 ;
V_1 -> V_154 = F_13 ;
V_1 -> V_63 = 1 ;
...
V_1 -> V_6 = V_70 ;
V_1 -> V_41 = NULL ;
V_1 -> V_153 = F_72 ( V_70 , 2 ) ;
V_1 -> V_71 = V_72 ;
V_1 -> V_43 = F_68 ( V_61 , V_149 ) ;
if ( ! V_1 -> V_43 )
return - V_148 ;
V_1 -> V_154 = F_21 ;
V_1 -> V_63 = 1 ;
...
unsigned long V_155 )
{
struct V_156 * V_157 = F_76 ( V_6 ) ;
struct V_69 * V_70 = F_10 ( V_6 ) ;
struct V_8 * V_9 ;
struct V_14 * V_15 ;
int V_65 ;
int V_22 ;
V_9 = F_77 ( V_6 , sizeof( * V_9 ) ) ;
if ( ! V_9 )
return - V_148 ;
F_78 ( & V_9 -> V_16 , 1 ) ;
F_79 ( V_157 , V_9 ) ;
...
if ( V_22 )
return V_22 ;
V_22 = F_80 ( V_70 , V_157 -> V_164 -> V_165 . V_166 ,
3 ) ;
if ( V_22 < 0 ) {
F_12 ( V_6 -> V_38 ,
L_10 ) ;
...
V_22 = F_81 ( V_6 , & V_70 -> V_6 , V_167 ,
F_61 , 0 ) ;
if ( V_22 )
return V_22 ;
V_22 = F_82 ( V_6 , ( V_9 -> V_74 ) ? 4 : 3 ) ;
if ( V_22 )
return V_22 ;
V_15 = & V_6 -> V_168 [ 0 ] ;
V_6 -> V_42 = V_15 ;
