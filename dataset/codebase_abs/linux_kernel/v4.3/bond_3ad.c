...
void F_78 ( struct V_225 * V_226 )
{
struct V_1 * V_5 = F_79 ( V_226 , struct V_1 ,
V_227 . V_226 ) ;
struct V_4 * V_4 ;
struct V_95 * V_96 ;
struct V_3 * V_3 ;
...
F_85 ( V_5 -> V_232 , & V_5 -> V_227 , V_233 ) ;
}
...
if ( ! V_4 )
return - 1 ;
V_242 -> V_243 = V_4 -> V_172 ;
V_242 -> V_244 = V_4 -> V_93 ;
V_242 -> V_75 = V_4 -> V_173 ;
V_242 -> V_59 = V_4 -> V_174 ;
F_44 ( V_242 -> V_8 ,
V_4 -> V_8 . V_9 ) ;
return 0 ;
}
int F_96 ( struct V_1 * V_5 , struct V_242 * V_242 )
{
int V_234 ;
F_4 () ;
V_234 = F_95 ( V_5 , V_242 ) ;
F_7 () ;
return V_234 ;
}
...
struct V_3 * V_3 )
{
struct V_52 * V_52 , V_245 ;
if ( V_99 -> V_106 != V_107 )
return V_235 ;
if ( ! F_26 ( F_98 ( V_99 ) -> V_111 , V_112 ) )
return V_235 ;
V_52 = F_99 ( V_99 , 0 , sizeof( V_245 ) , & V_245 ) ;
if ( ! V_52 )
return V_235 ;
return F_86 ( V_52 , V_3 , V_99 -> V_246 ) ;
}
