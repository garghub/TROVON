...
struct V_1 * V_89 )
{
static const char V_90 [ V_91 ] V_92 ( ( F_25 ( sizeof( long ) ) ) ) ;
...
unsigned int V_98 ;
V_95 = 0 ;
V_7 = V_88 -> V_71 ? V_88 -> V_71 -> V_60 : V_90 ;
V_8 = V_88 -> V_72 ? V_88 -> V_72 -> V_60 : V_90 ;
V_97 . V_13 = false ;
V_97 . V_71 = V_88 -> V_71 ;
V_97 . V_72 = V_88 -> V_72 ;
V_97 . V_99 = V_100 ;
V_97 . V_101 = V_69 ;
F_26 ( V_89 -> V_102 & ( 1 << V_69 ) ) ;
F_27 () ;
V_98 = F_28 () ;
V_75 = V_89 -> V_75 ;
F_29 () ;
V_96 = F_30 () ;
V_93 = V_75 -> V_79 ;
V_94 = (struct V_44 * * ) V_75 -> V_94 [ V_96 ] ;
if ( F_31 ( & V_103 ) )
V_94 += V_75 -> V_104 * F_32 ( V_105 ) ;
V_49 = F_14 ( V_93 , V_75 -> V_80 [ V_69 ] ) ;
do {
...
V_109 = F_34 ( & V_49 -> V_114 ) ;
F_35 ( * V_109 , V_6 -> V_115 , 1 ) ;
V_56 = F_16 ( V_49 ) ;
F_26 ( V_56 -> V_58 . V_59 . V_57 ) ;
#if F_36 ( V_116 )
if ( F_37 ( V_6 -> V_117 ) )
F_19 ( V_6 , V_69 , V_88 -> V_71 , V_88 -> V_72 ,
V_89 -> V_60 , V_75 , V_49 ) ;
#endif
...
static int
F_41 ( const struct V_74 * V_124 ,
unsigned int V_102 , void * V_125 )
{
unsigned int V_69 ;
for ( V_69 = 0 ; V_69 < V_126 ; V_69 ++ ) {
unsigned int V_127 = V_124 -> V_80 [ V_69 ] ;
...
= ( void * ) F_16 ( V_49 ) ;
int V_129 = V_49 -> V_130 & ( 1 << V_69 ) ;
if ( V_49 -> V_130 & ( 1 << V_126 ) ) {
F_42 ( L_12 ,
V_69 , V_127 , V_49 -> V_130 ) ;
return 0 ;
}
V_49 -> V_130 |= ( ( 1 << V_69 ) | ( 1 << V_126 ) ) ;
...
static void F_44 ( struct V_106 * V_137 , struct V_78 * V_78 )
{
struct V_138 V_41 ;
V_41 . V_78 = V_78 ;
...
F_45 ( V_41 . V_112 -> V_140 ) ;
}
static int
F_46 ( const struct V_44 * V_49 , const char * V_60 )
{
const struct V_48 * V_56 ;
if ( ! F_10 ( & V_49 -> V_16 ) ) {
F_11 ( L_22 , V_49 , V_60 ) ;
...
static int F_47 ( struct V_106 * V_137 , struct V_143 * V_41 )
{
const struct V_9 * V_16 = V_41 -> V_144 ;
int V_14 ;
V_41 -> V_112 = V_137 -> V_58 . V_59 . V_112 ;
V_41 -> V_113 = V_137 -> V_62 ;
V_14 = F_48 ( V_41 , V_137 -> V_58 . V_145 - sizeof( * V_137 ) ,
...
static int
F_49 ( struct V_106 * V_137 , struct V_143 * V_41 )
{
struct V_146 * V_112 ;
int V_14 ;
V_112 = F_50 ( V_100 , V_137 -> V_58 . V_131 . V_60 ,
...
V_14 = F_47 ( V_137 , V_41 ) ;
if ( V_14 )
goto V_148;
return 0 ;
V_148:
F_45 ( V_137 -> V_58 . V_59 . V_112 -> V_140 ) ;
return V_14 ;
}
static int F_53 ( struct V_44 * V_49 , struct V_78 * V_78 , const char * V_60 )
{
...
int V_14 ;
V_56 = F_17 ( V_49 ) ;
V_14 = F_54 ( & V_41 , V_56 -> V_58 . V_142 - sizeof( * V_56 ) ,
...
static int
F_55 ( struct V_44 * V_49 , struct V_78 * V_78 , const char * V_60 ,
unsigned int V_133 )
{
struct V_48 * V_56 ;
struct V_151 * V_57 ;
...
if ( V_14 )
return V_14 ;
V_49 -> V_114 . V_128 = F_56 () ;
if ( F_57 ( V_49 -> V_114 . V_128 ) )
return - V_154 ;
V_152 = 0 ;
V_153 . V_78 = V_78 ;
V_153 . V_89 = V_60 ;
...
V_153 . V_99 = V_100 ;
F_33 (ematch, e) {
V_14 = F_49 ( V_107 , & V_153 ) ;
if ( V_14 != 0 )
goto V_155;
++ V_152 ;
}
V_56 = F_17 ( V_49 ) ;
V_57 = F_58 ( V_100 , V_56 -> V_58 . V_131 . V_60 ,
...
V_14 = F_53 ( V_49 , V_78 , V_60 ) ;
if ( V_14 )
goto V_148;
return 0 ;
V_148:
F_45 ( V_56 -> V_58 . V_59 . V_57 -> V_140 ) ;
V_155:
F_33 (ematch, e) {
if ( V_152 -- == 0 )
break;
...
F_59 ( V_49 -> V_114 . V_128 ) ;
return V_14 ;
}
static bool F_60 ( const struct V_44 * V_49 )
{
const struct V_48 * V_56 ;
unsigned int V_65 ;
if ( ! F_15 ( & V_49 -> V_16 ) )
...
{
unsigned int V_159 ;
if ( ( unsigned long ) V_49 % F_62 ( struct V_44 ) != 0 ||
...
static void F_63 ( struct V_44 * V_49 , struct V_78 * V_78 )
{
struct V_160 V_41 ;
struct V_48 * V_56 ;
struct V_106 * V_107 ;
...
F_45 ( V_41 . V_57 -> V_140 ) ;
F_59 ( V_49 -> V_114 . V_128 ) ;
}
static int
F_64 ( struct V_78 * V_78 , struct V_74 * V_124 , void * V_125 ,
...
return V_14 ;
++ V_163 ;
if ( strcmp ( F_17 ( V_77 ) -> V_58 . V_131 . V_60 ,
V_61 ) == 0 )
++ V_124 -> V_104 ;
}
...
if ( ! F_41 ( V_124 , V_162 -> V_102 , V_125 ) )
return - V_166 ;
V_163 = 0 ;
F_21 (iter, entry0, newinfo->size) {
V_14 = F_55 ( V_77 , V_78 , V_162 -> V_60 , V_162 -> V_133 ) ;
if ( V_14 != 0 )
break;
++ V_163 ;
}
...
unsigned int V_163 ;
F_66 (cpu) {
T_2 * V_50 = & F_67 ( V_167 , V_96 ) ;
V_163 = 0 ;
F_21 (iter, t->entries, t->size) {
struct V_108 * V_168 ;
T_3 V_169 , V_128 ;
unsigned int V_170 ;
V_168 = F_68 ( & V_77 -> V_114 , V_96 ) ;
do {
V_170 = F_69 ( V_50 ) ;
V_169 = V_168 -> V_169 ;
V_128 = V_168 -> V_128 ;
} while ( F_70 ( V_50 , V_170 ) );
F_35 ( V_114 [ V_163 ] , V_169 , V_128 ) ;
++ V_163 ;
}
}
}
...
unsigned int V_171 ;
struct V_108 * V_114 ;
const struct V_74 * V_75 = V_89 -> V_75 ;
V_171 = sizeof( struct V_108 ) * V_75 -> V_164 ;
V_114 = F_72 ( V_171 ) ;
if ( V_114 == NULL )
return F_73 ( - V_154 ) ;
F_65 ( V_75 , V_114 ) ;
...
static int F_81 ( const struct V_44 * V_49 ,
const struct V_74 * V_2 ,
const void * V_45 , struct V_74 * V_124 )
{
const struct V_106 * V_107 ;
const struct V_48 * V_56 ;
unsigned int V_181 ;
...
F_33 (ematch, e)
V_174 += F_82 ( V_107 -> V_58 . V_59 . V_112 ) ;
V_56 = F_16 ( V_49 ) ;
V_174 += F_83 ( V_56 -> V_58 . V_59 . V_57 ) ;
V_124 -> V_133 -= V_174 ;
...
if ( ! V_124 || ! V_2 )
return - V_141 ;
memcpy ( V_124 , V_2 , F_76 ( struct V_74 , V_79 ) ) ;
V_124 -> V_183 = 0 ;
V_176 = V_2 -> V_79 ;
F_86 ( V_83 , V_2 -> V_164 ) ;
F_21 (iter, loc_cpu_entry, info->size) {
V_14 = F_81 ( V_77 , V_2 , V_176 , V_124 ) ;
if ( V_14 != 0 )
return V_14 ;
}
return 0 ;
}
static int F_87 ( struct V_78 * V_78 , void T_4 * V_131 ,
...
if ( F_88 ( V_60 , V_131 , sizeof( V_60 ) ) != 0 )
return - V_177 ;
V_60 [ V_185 - 1 ] = '\0' ;
#ifdef F_89
if ( V_184 )
...
static int
F_97 ( struct V_78 * V_78 , struct V_188 T_4 * V_189 ,
const int * V_115 )
{
int V_14 ;
struct V_188 V_190 ;
...
V_56 = F_92 ( V_78 , V_83 , V_190 . V_60 ) ;
if ( ! F_93 ( V_56 ) ) {
struct V_74 * V_75 = V_56 -> V_75 ;
F_11 ( L_39 , V_75 -> V_164 ) ;
if ( V_190 . V_133 == V_75 -> V_133 )
V_14 = F_74 ( V_75 -> V_133 ,
V_56 , V_189 -> V_191 ) ;
else {
F_11 ( L_40 ,
V_75 -> V_133 , V_190 . V_133 ) ;
V_14 = - V_192 ;
}
F_45 ( V_56 -> V_140 ) ;
F_95 ( V_56 ) ;
...
static int
F_98 ( struct V_78 * V_78 , const char * V_60 , unsigned int V_102 ,
struct V_74 * V_124 , unsigned int V_193 ,
void T_4 * V_194 )
{
int V_14 ;
struct V_1 * V_56 ;
...
V_195 = F_99 ( V_56 , V_193 , V_124 , & V_14 ) ;
if ( ! V_195 )
goto V_197;
F_11 ( L_42 ,
...
static int
F_102 ( struct V_78 * V_78 , const void T_4 * V_131 , unsigned int V_115 )
{
int V_14 ;
struct V_161 V_168 ;
struct V_74 * V_124 ;
...
V_14 = F_64 ( V_78 , V_124 , V_176 , & V_168 ) ;
if ( V_14 != 0 )
goto V_199;
F_11 ( L_44 ) ;
V_14 = F_98 ( V_78 , V_168 . V_60 , V_168 . V_102 , V_124 ,
...
static int
F_104 ( struct V_78 * V_78 , const void T_4 * V_131 , unsigned int V_115 ,
int V_184 )
{
unsigned int V_163 ;
struct V_201 V_168 ;
...
struct V_108 * V_168 ;
V_168 = F_34 ( & V_77 -> V_114 ) ;
F_35 ( * V_168 , V_202 [ V_163 ] . V_169 , V_202 [ V_163 ] . V_128 ) ;
++ V_163 ;
}
F_38 ( V_98 ) ;
V_206:
...
static int
F_106 ( struct V_44 * V_49 , void T_4 * * V_207 ,
...
if ( F_75 ( V_208 , V_49 , sizeof( struct V_44 ) ) != 0 ||
...
V_56 = F_17 ( V_49 ) ;
V_14 = F_108 ( V_56 , V_207 , V_133 ) ;
if ( V_14 )
return V_14 ;
V_86 = V_49 -> V_86 - ( V_209 - * V_133 ) ;
if ( F_109 ( V_63 , & V_208 -> V_63 ) != 0 ||
...
static void F_111 ( struct V_182 * V_49 )
{
struct V_48 * V_56 ;
struct V_106 * V_107 ;
F_33 (ematch, e)
F_45 ( V_107 -> V_58 . V_59 . V_112 -> V_140 ) ;
V_56 = F_112 ( V_49 ) ;
F_45 ( V_56 -> V_58 . V_59 . V_57 -> V_140 ) ;
}
static int
F_113 ( struct V_182 * V_49 ,
struct V_74 * V_124 ,
unsigned int * V_133 ,
const unsigned char * V_45 ,
const unsigned char * V_156 ,
...
F_11 ( L_46 , V_49 ) ;
if ( ( unsigned long ) V_49 % F_62 ( struct V_182 ) != 0 ||
...
V_14 = F_46 ( (struct V_44 * ) V_49 , V_60 ) ;
if ( V_14 )
return V_14 ;
V_174 = sizeof( struct V_44 ) - sizeof( struct V_182 ) ;
...
V_152 = 0 ;
F_33 (ematch, e) {
V_14 = F_110 ( V_107 , V_60 , & V_49 -> V_16 , & V_174 ) ;
if ( V_14 != 0 )
goto V_211;
++ V_152 ;
}
...
static int
F_114 ( struct V_182 * V_49 , void * * V_207 ,
unsigned int * V_133 , const char * V_60 ,
struct V_74 * V_124 , unsigned char * V_45 )
{
struct V_48 * V_56 ;
struct V_44 * V_212 ;
unsigned int V_209 ;
...
static int F_117 ( struct V_44 * V_49 , struct V_78 * V_78 ,
const char * V_60 )
{
unsigned int V_152 ;
int V_14 = 0 ;
...
goto V_199;
V_14 = - V_166 ;
if ( ! F_41 ( V_124 , V_102 , V_215 ) )
goto V_199;
V_163 = 0 ;
F_21 (iter1, entry1, newinfo->size) {
V_14 = F_117 ( V_217 , V_78 , V_60 ) ;
if ( V_14 != 0 )
break;
++ V_163 ;
...
static int
F_119 ( struct V_78 * V_78 , void T_4 * V_131 , unsigned int V_115 )
{
int V_14 ;
struct V_220 V_168 ;
struct V_74 * V_124 ;
...
V_14 = F_118 ( V_78 , V_168 . V_60 , V_168 . V_102 ,
...
static int
F_126 ( struct V_78 * V_78 , struct V_229 T_4 * V_189 ,
int * V_115 )
{
int V_14 ;
struct V_229 V_190 ;
...
struct V_1 * F_131 ( struct V_78 * V_78 ,
const struct V_1 * V_89 ,
const struct V_161 * V_162 )
{
int V_14 ;
...
V_14 = F_64 ( V_78 , V_124 , V_176 , V_162 ) ;
if ( V_14 != 0 )
goto V_238;
V_237 = F_132 ( V_78 , V_89 , & V_236 , V_124 ) ;
if ( F_51 ( V_237 ) ) {
V_14 = F_52 ( V_237 ) ;
goto V_238;
}
...
void F_133 ( struct V_78 * V_78 , struct V_1 * V_89 )
{
struct V_74 * V_75 ;
void * V_176 ;
...
F_63 ( V_77 , V_78 ) ;
if ( V_75 -> V_164 > V_75 -> V_183 )
F_45 ( V_240 ) ;
F_100 ( V_75 ) ;
}
static inline bool
F_135 ( T_7 V_241 , T_7 V_242 , T_7 V_243 ,
T_7 type , T_7 V_244 ,
bool V_245 )
{
...
static bool
F_136 ( const struct V_5 * V_6 , struct V_40 * V_41 )
{
...
if ( V_41 -> V_12 != 0 )
return false ;
V_247 = F_137 ( V_6 , V_41 -> V_110 , sizeof( V_248 ) , & V_248 ) ;
if ( V_247 == NULL ) {
F_11 ( L_58 ) ;
V_41 -> V_13 = true ;
return false ;
}
return F_135 ( V_250 -> type ,
V_250 -> V_244 [ 0 ] ,
V_250 -> V_244 [ 1 ] ,
V_247 -> V_251 , V_247 -> V_252 ,
! ! ( V_250 -> V_28 & V_253 ) ) ;
}
static int F_138 ( const struct V_143 * V_41 )
{
const struct V_249 * V_250 = V_41 -> V_113 ;
return ( V_250 -> V_28 & ~ V_253 ) ? - V_141 : 0 ;
}
static int T_8 F_139 ( struct V_78 * V_78 )
{
return F_140 ( V_78 , V_100 ) ;
}
static void T_9 F_141 ( struct V_78 * V_78 )
{
F_142 ( V_78 , V_100 ) ;
}
...
if ( V_14 < 0 )
goto V_255;
V_14 = F_145 ( V_256 , F_146 ( V_256 ) ) ;
if ( V_14 < 0 )
goto V_257;
V_14 = F_147 ( V_258 , F_146 ( V_258 ) ) ;
if ( V_14 < 0 )
goto V_259;
V_14 = F_148 ( & V_260 ) ;
if ( V_14 < 0 )
