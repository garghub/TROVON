...
void F_97 ( const struct V_19 * V_20 ,
...
int F_99 ( const struct V_19 * V_20 , struct V_1 * V_88 ,
enum V_123 V_124 )
{
int V_69 ;
F_48 ( V_20 , V_88 , V_124 < V_126 ) ;
...
static int F_103 ( const struct V_19 * V_20 , struct V_23 * V_24 ,
...
int F_104 ( const struct V_19 * V_20 , struct V_21 * V_143 )
{
struct V_144 * V_145 ;
...
V_24 -> V_103 = V_22 ;
V_24 -> V_147 = 1 ;
V_69 = F_105 ( V_20 , V_24 , V_148 , V_22 ) ;
if ( V_69 != 0 ) {
F_106 ( V_20 , V_24 ) ;
return V_24 -> V_149 ;
}
...
void F_108 ( const struct V_19 * V_20 , struct V_1 * V_88 ,
int V_151 , int V_152 )
{
F_48 ( V_20 , V_88 , F_57 ( V_88 ) ) ;
...
void F_109 ( const struct V_19 * V_20 , void * V_154 ,
...
int F_111 ( const struct V_19 * V_20 , struct V_1 * V_2 )
{
return F_72 ( V_20 , V_2 , F_79 ( V_159 ) ,
( const struct V_19 * ,
const struct V_5 * ) ) ;
}
T_5 F_112 ( const struct V_21 * V_22 , T_1 V_30 )
{
return ( T_5 ) V_30 << V_160 ;
}
T_1 F_113 ( const struct V_21 * V_22 , T_5 V_161 )
{
return V_161 >> V_160 ;
}
int F_114 ( const struct V_21 * V_22 )
{
return 1 << V_160 ;
}
void F_115 ( struct V_1 * V_2 , struct V_5 * V_8 ,
struct V_21 * V_22 ,
const struct V_162 * V_163 )
{
F_116 ( & V_8 -> V_55 , & V_2 -> V_53 ) ;
V_8 -> V_9 = V_22 ;
V_8 -> V_56 = V_163 ;
V_8 -> V_45 = V_2 ;
}
