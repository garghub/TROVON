...
int F_46 ( struct V_55 * V_56 , void * V_62 )
{
struct V_63 * V_60 = (struct V_63 * ) V_56 -> V_64 ;
struct V_6 * V_7 = F_47 ( V_60 ) ;
struct V_65 * V_66 ;
struct V_1 * V_2 ;
int V_67 = 0 ;
V_66 = F_48 ( V_56 ) ;
...
enum V_71
F_51 ( struct V_72 * V_73 , unsigned int * V_74 ,
T_2 * V_75 )
{
enum V_71 V_57 = V_76 ;
struct V_77 * V_77 ;
...
T_3 V_84 ;
T_2 * V_85 ;
if ( ! F_52 ( V_73 , * V_74 + V_86 ) )
return V_76 ;
V_77 = F_53 ( V_73 ) ;
V_84 = V_77 -> V_87 ;
* V_74 += V_86 ;
if ( V_84 == F_54 ( V_88 ) ) {
if ( ! F_52 ( V_73 , * V_74 + V_89 ) )
return V_76 ;
V_82 = F_55 ( V_73 ) ;
V_84 = V_82 -> V_90 ;
* V_74 += V_89 ;
...
if ( ! F_52 ( V_73 , * V_74 + sizeof( * V_80 ) ) )
return V_76 ;
V_80 = (struct V_80 * ) ( V_73 -> V_92 + * V_74 ) ;
* V_74 += sizeof( * V_80 ) ;
switch ( V_84 ) {
case F_54 ( V_91 ) :
if ( V_80 -> V_98 == F_54 ( 67 ) )
V_57 = V_99 ;
else if ( V_80 -> V_100 == F_54 ( 67 ) )
V_57 = V_101 ;
break;
case F_54 ( V_96 ) :
if ( V_80 -> V_98 == F_54 ( 547 ) )
V_57 = V_99 ;
else if ( V_80 -> V_100 == F_54 ( 547 ) )
V_57 = V_101 ;
break;
}
V_83 = * V_74 + V_102 ;
if ( V_57 == V_101 &&
F_52 ( V_73 , V_83 + V_103 ) ) {
...
if ( * V_85 != V_103 )
return V_76 ;
F_56 ( V_75 , V_73 -> V_92 + V_83 ) ;
}
return V_57 ;
}
bool F_57 ( struct V_6 * V_7 ,
struct V_72 * V_73 )
{
