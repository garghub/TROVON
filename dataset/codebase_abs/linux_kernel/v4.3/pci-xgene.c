...
static void F_36 ( void * V_1 , T_4 V_76 , T_4 V_24 )
{
F_7 ( F_14 ( V_76 ) , V_1 ) ;
F_7 ( F_15 ( V_76 ) | V_77 , V_1 + 0x04 ) ;
F_7 ( F_14 ( V_24 ) , V_1 + 0x10 ) ;
F_7 ( F_15 ( V_24 ) , V_1 + 0x14 ) ;
}
static int F_37 ( T_6 * V_78 , T_4 V_24 )
{
if ( ( V_24 > 4 ) && ( V_24 < V_79 ) && ! ( * V_78 & ( 1 << 1 ) ) ) {
* V_78 |= ( 1 << 1 ) ;
return 1 ;
}
if ( ( V_24 > V_80 ) && ( V_24 < V_81 ) && ! ( * V_78 & ( 1 << 0 ) ) ) {
* V_78 |= ( 1 << 0 ) ;
return 0 ;
}
if ( ( V_24 > V_82 ) && ( V_24 < V_81 ) && ! ( * V_78 & ( 1 << 2 ) ) ) {
* V_78 |= ( 1 << 2 ) ;
return 2 ;
}
return - V_75 ;
...
if ( V_84 -> V_2 & V_71 )
V_2 |= V_90 ;
V_88 = F_1 ( ( T_1 ) V_51 , V_2 ) ;
switch ( V_89 ) {
case 0 :
F_13 ( V_18 , V_91 , V_2 , V_24 ) ;
V_85 = V_11 + V_21 ;
F_7 ( V_88 , V_85 ) ;
F_7 ( F_15 ( V_51 ) , V_85 + 0x4 ) ;
V_86 = V_18 + V_92 ;
break;
case 1 :
V_85 = V_18 + V_93 ;
F_7 ( V_88 , V_85 ) ;
F_7 ( F_14 ( V_32 ) , V_18 + V_94 ) ;
V_86 = V_18 + V_95 ;
break;
case 2 :
V_85 = V_18 + V_96 ;
F_7 ( V_88 , V_85 ) ;
F_7 ( F_15 ( V_51 ) , V_85 + 0x4 ) ;
F_7 ( F_14 ( V_32 ) , V_18 + V_97 ) ;
F_7 ( F_15 ( V_32 ) , V_18 + V_97 + 0x4 ) ;
V_86 = V_18 + V_98 ;
break;
}
F_36 ( V_86 , V_52 , ~ ( V_24 - 1 ) ) ;
}
...
int V_105 ;
V_100 -> V_102 = V_102 ;
V_100 -> V_106 = F_40 ( V_102 ) ;
V_100 -> V_107 = V_100 -> V_106 + V_103 + V_104 ;
V_100 -> V_84 = F_41 ( V_102 , L_9 , & V_105 ) ;
if ( ! V_100 -> V_84 )
return - V_108 ;
V_100 -> V_109 = V_100 -> V_84 + V_105 / sizeof( V_110 ) ;
return 0 ;
}
static int F_42 ( struct V_6 * V_7 )
{
struct V_101 * V_107 = V_7 -> V_102 ;
struct V_83 V_84 ;
struct V_99 V_100 ;
struct V_67 * V_42 = V_7 -> V_42 ;
T_6 V_78 = 0 ;
...
F_43 (&parser, &range) {
T_4 V_109 = V_84 . V_51 + V_84 . V_24 - 1 ;
F_34 ( V_7 -> V_42 , L_11 ,
V_84 . V_2 , V_84 . V_51 , V_109 , V_84 . V_52 ) ;
F_38 ( V_7 , & V_84 , & V_78 ) ;
}
return 0 ;
}
...
{
int V_111 ;
for ( V_111 = V_92 ; V_111 <= V_62 ; V_111 += 4 )
F_7 ( 0x0 , V_7 -> V_18 + V_111 ) ;
}
...
{
struct V_101 * V_115 ;
V_115 = F_48 ( V_5 -> V_42 . V_116 ,
L_14 , 0 ) ;
if ( ! V_115 )
return - V_43 ;
V_5 -> V_117 = F_49 ( V_115 ) ;
if ( ! V_5 -> V_117 )
return - V_43 ;
F_50 ( V_115 ) ;
V_5 -> V_117 -> V_42 = & V_5 -> V_42 ;
return 0 ;
}
static int F_51 ( struct V_44 * V_45 )
{
struct V_101 * V_118 = V_45 -> V_42 . V_116 ;
struct V_6 * V_7 ;
T_5 V_119 = 0 ;
struct V_4 * V_5 ;
int V_68 ;
F_52 ( V_47 ) ;
V_7 = F_53 ( & V_45 -> V_42 , sizeof( * V_7 ) , V_120 ) ;
if ( ! V_7 )
return - V_121 ;
V_7 -> V_102 = F_54 ( V_45 -> V_42 . V_116 ) ;
V_7 -> V_42 = & V_45 -> V_42 ;
V_7 -> V_28 = V_122 ;
if ( F_55 ( V_7 -> V_102 , L_15 ) )
V_7 -> V_28 = V_29 ;
V_68 = F_23 ( V_7 , V_45 ) ;
if ( V_68 )
return V_68 ;
...
if ( V_68 )
return V_68 ;
V_68 = F_56 ( V_118 , 0 , 0xff , & V_47 , & V_119 ) ;
if ( V_68 )
return V_68 ;
V_68 = F_45 ( V_7 , & V_47 , V_119 ) ;
if ( V_68 )
return V_68 ;
V_5 = F_57 ( & V_45 -> V_42 , 0 ,
& V_123 , V_7 , & V_47 ) ;
if ( ! V_5 )
return - V_121 ;
if ( F_58 ( V_124 ) )
