...
void * V_48 = NULL ;
void * V_49 = NULL ;
memset ( V_19 . V_50 , 0 , sizeof( void * ) * V_51 ) ;
memset ( V_19 . V_52 , 0 ,
sizeof( void * ) * V_51 ) ;
memset ( V_19 . V_53 , 0 ,
sizeof( void * ) * V_51 ) ;
...
sizeof( void * ) * V_51 ) ;
V_5 = F_1 () ;
V_19 . V_57 = F_10 ( 0 , V_58 , 0 ) ;
F_11 ( V_59 , V_19 . V_57 ) ;
F_8 ( V_60 , V_46 . V_61 ) ;
V_48 = F_12 ( V_62 , V_63 , V_64 ) ;
if ( ! V_48 )
goto V_65;
V_46 . V_66 = 1 ;
V_46 . V_67 = F_13 ( V_48 ) ;
...
{
T_6 V_84 ;
V_84 = ( F_3 ( V_91 , V_90 , NULL ) & 0xFFFF ) ;
return V_84 ;
}
...
F_33 (cpu) {
V_19 . V_55 [ V_103 ] = F_34 ( V_111 , V_116 ) ;
if ( V_19 . V_55 [ V_103 ] == NULL ) {
F_32 ( L_3 ) ;
goto V_117;
}
F_35 ( V_19 . V_55 [ V_103 ] , V_118 , V_103 ) ;
V_19 . V_56 [ V_103 ] = F_31 ( V_113 , V_116 ) ;
if ( V_19 . V_56 [ V_103 ] == NULL ) {
F_32 ( L_4 ) ;
goto V_117;
}
F_28 ( V_19 . V_56 [ V_103 ] , V_103 ) ;
V_19 . V_52 [ V_103 ] =
( void * ) F_36 ( V_116 ) ;
if ( V_19 . V_52 [ V_103 ] == NULL ) {
F_32 ( L_5 ) ;
goto V_117;
}
V_19 . V_50 [ V_103 ] =
...
{
F_38 ( V_19 . V_55 [ V_103 ] ) ;
F_38 ( V_19 . V_56 [ V_103 ] ) ;
if ( V_19 . V_50 [ V_103 ] )
F_39 ( ( unsigned long ) V_19 . V_50 [ V_103 ] ) ;
if ( V_19 . V_52 [ V_103 ] )
F_39 ( ( unsigned long ) V_19 . V_52 [ V_103 ] ) ;
if ( V_19 . V_53 [ V_103 ] )
F_39 ( ( unsigned long ) V_19 . V_53 [ V_103 ] ) ;
}
void F_40 ( void )
{
int V_103 ;
...
return;
F_8 ( V_129 , V_120 ) ;
F_8 ( V_130 , V_122 . V_61 ) ;
V_122 . V_131 = 1 ;
V_122 . V_132 = F_4 ( V_19 . V_52 [ V_103 ] )
>> V_133 ;
F_11 ( V_130 , V_122 . V_61 ) ;
F_8 ( V_134 , V_124 . V_61 ) ;
V_124 . V_135 = 1 ;
V_124 . V_136 = F_4 ( V_19 . V_50 [ V_103 ] )
>> V_133 ;
F_11 ( V_134 , V_124 . V_61 ) ;
F_8 ( V_137 + V_101 , V_126 . V_61 ) ;
V_126 . V_61 = 0 ;
V_126 . V_138 = V_139 ;
V_126 . V_140 = false ;
V_126 . V_141 = true ;
F_11 ( V_137 + V_101 , V_126 . V_61 ) ;
F_8 ( V_142 , V_128 . V_61 ) ;
V_128 . V_66 = 1 ;
F_11 ( V_142 , V_128 . V_61 ) ;
V_19 . V_143 = true ;
F_8 ( V_144 , V_54 ) ;
V_19 . V_54 [ V_103 ] = ( T_2 ) V_54 ;
F_43 ( & V_19 . V_145 [ V_103 ] ) ;
if ( V_68 . V_69 & V_146 )
F_44 ( V_19 . V_56 [ V_103 ] ,
V_147 ,
V_148 ,
V_149 ) ;
return;
