...
struct V_3 * V_2 ;
struct V_67 * V_68 ;
V_2 = F_20 ( & V_64 -> V_5 , sizeof( * V_2 ) , V_69 ) ;
if ( ! V_2 )
return - V_70 ;
F_21 ( & V_2 -> V_10 ) ;
V_66 = F_22 ( V_64 , V_71 , 0 ) ;
V_2 -> V_11 = F_23 ( & V_64 -> V_5 , V_66 ) ;
if ( F_24 ( V_2 -> V_11 ) )
return F_25 ( V_2 -> V_11 ) ;
V_68 = (struct V_67 * )
F_26 ( V_72 , & V_64 -> V_5 ) ;
V_2 -> V_59 = ( const struct V_73 * ) V_68 -> V_2 ;
F_27 ( V_64 , V_2 ) ;
return 0 ;
}
