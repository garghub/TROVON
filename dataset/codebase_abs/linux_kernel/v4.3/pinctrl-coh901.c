...
{
unsigned int V_48 = F_27 ( V_47 ) ;
struct V_49 * V_50 = F_28 ( V_47 ) ;
struct V_2 * V_3 = F_29 ( V_47 ) ;
struct V_1 * V_5 = F_1 ( V_3 ) ;
struct V_37 * V_38 = & V_5 -> V_39 [ V_48 - V_3 -> V_6 ] ;
...
if ( V_10 != 0 ) {
int V_54 ;
F_31 (irqoffset, &val, U300_GPIO_PINS_PER_PORT) {
int V_4 = V_51 + V_54 ;
int V_55 = F_32 ( V_3 -> V_56 , V_4 ) ;
F_21 ( V_5 -> V_32 , L_8 ,
V_55 , V_4 ) ;
F_33 ( V_55 ) ;
...
static int T_2 F_37 ( struct V_66 * V_67 )
{
struct V_1 * V_5 ;
struct V_68 * V_69 ;
int V_70 = 0 ;
...
T_1 V_72 ;
int V_62 ;
V_5 = F_38 ( & V_67 -> V_32 , sizeof( struct V_1 ) , V_73 ) ;
if ( V_5 == NULL )
return - V_74 ;
V_5 -> V_3 = V_75 ;
...
V_5 -> V_3 . V_6 = 0 ;
V_5 -> V_32 = & V_67 -> V_32 ;
V_69 = F_39 ( V_67 , V_78 , 0 ) ;
V_5 -> V_6 = F_40 ( & V_67 -> V_32 , V_69 ) ;
if ( F_41 ( V_5 -> V_6 ) )
return F_42 ( V_5 -> V_6 ) ;
V_5 -> V_79 = F_43 ( V_5 -> V_32 , NULL ) ;
if ( F_41 ( V_5 -> V_79 ) ) {
V_70 = F_42 ( V_5 -> V_79 ) ;
F_19 ( V_5 -> V_32 , L_11 ) ;
return V_70 ;
...
for ( V_62 = 0 ; V_62 < F_51 ( V_98 ) ; V_62 ++ ) {
struct V_99 * V_100 = & V_98 [ V_62 ] ;
V_70 = F_52 ( & V_5 -> V_3 , L_20 ,
...
static int T_3 F_56 ( struct V_66 * V_67 )
{
struct V_1 * V_5 = F_57 ( V_67 ) ;
