...
static int F_42 ( struct V_295 * V_296 ,
...
static int F_44 ( struct V_369 * V_370 , unsigned int V_371 ,
unsigned int V_372 )
{
unsigned int V_373 ;
unsigned int div ;
...
static int F_48 ( struct V_1 * V_2 , int V_388 , int V_389 ,
...
return F_55 ( V_5 -> V_294 , V_259 + V_419 ,
V_340 | V_423 |
V_420 , V_65 ) ;
}
...
unsigned int V_88 ;
int V_48 ;
V_48 = F_58 ( V_5 -> V_294 , V_259 + V_419 , & V_88 ) ;
if ( V_48 < 0 )
return V_48 ;
return ( V_88 & V_420 ) != 0 ;
}
...
static T_3 F_77 ( int V_60 , void * V_460 )
{
...
static T_3 F_79 ( int V_60 , void * V_460 )
{
T_3 V_48 = V_462 ;
T_3 V_65 ;
do {
V_65 = F_77 ( V_60 , V_460 ) ;
if ( V_65 != V_462 )
V_48 = V_65 ;
} while ( V_65 != V_462 );
return V_48 ;
...
V_48 = F_86 ( V_57 -> V_60 , NULL ,
F_79 ,
V_477 , L_50 , V_2 ) ;
else
V_48 = F_86 ( V_57 -> V_60 , NULL , F_77 ,
V_477 , L_50 , V_2 ) ;
if ( V_48 == 0 ) {
F_6 ( V_2 , V_271 ,
V_483 , 0 ) ;
...
int V_48 , V_12 ;
unsigned int V_88 ;
V_5 = F_90 ( & V_57 -> V_29 , sizeof( struct V_4 ) ,
V_474 ) ;
if ( V_5 == NULL )
return - V_489 ;
F_91 ( V_57 , V_5 ) ;
V_5 -> V_29 = & V_57 -> V_29 ;
if ( F_92 ( & V_57 -> V_29 ) )
memcpy ( & V_5 -> V_7 , F_92 ( & V_57 -> V_29 ) ,
sizeof( V_5 -> V_7 ) ) ;
if ( V_5 -> V_7 . V_293 > 0 ) {
V_48 = F_93 ( V_5 -> V_7 . V_293 ,
V_490 , L_52 ) ;
if ( V_48 < 0 ) {
F_24 ( & V_57 -> V_29 , L_53 ,
V_5 -> V_7 . V_293 , V_48 ) ;
...
V_48 = F_94 ( & V_57 -> V_29 , F_5 ( V_5 -> V_292 ) ,
V_5 -> V_292 ) ;
if ( V_48 != 0 ) {
...
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_292 ) ; V_12 ++ ) {
V_48 = F_95 ( V_5 -> V_292 [ V_12 ] . V_500 ,
& V_5 -> V_495 [ V_12 ] ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 ,
L_55 ,
...
V_5 -> V_294 = F_96 ( V_57 , & V_501 ) ;
if ( F_97 ( V_5 -> V_294 ) ) {
V_48 = F_98 ( V_5 -> V_294 ) ;
F_24 ( & V_57 -> V_29 , L_56 , V_48 ) ;
goto V_502;
}
V_48 = F_58 ( V_5 -> V_294 , V_89 , & V_88 ) ;
if ( V_48 < 0 ) {
...
V_48 = F_58 ( V_5 -> V_294 , V_128 , & V_88 ) ;
if ( V_48 < 0 ) {
F_24 ( & V_57 -> V_29 , L_59 ,
V_48 ) ;
goto V_503;
...
F_55 ( V_5 -> V_294 , V_97 ,
V_515 , V_515 ) ;
F_55 ( V_5 -> V_294 , V_101 ,
V_516 , V_516 ) ;
F_55 ( V_5 -> V_294 , V_102 ,
V_516 , V_516 ) ;
F_55 ( V_5 -> V_294 , V_103 ,
V_517 , V_517 ) ;
F_55 ( V_5 -> V_294 , V_104 ,
V_517 , V_517 ) ;
F_55 ( V_5 -> V_294 , V_105 ,
V_516 , V_516 ) ;
F_55 ( V_5 -> V_294 , V_106 ,
V_516 , V_516 ) ;
F_55 ( V_5 -> V_294 , V_107 ,
V_517 , V_517 ) ;
F_55 ( V_5 -> V_294 , V_108 ,
V_517 , V_517 ) ;
F_55 ( V_5 -> V_294 , V_183 ,
V_518 , V_518 ) ;
F_55 ( V_5 -> V_294 , V_184 ,
V_518 , V_518 ) ;
F_55 ( V_5 -> V_294 , V_213 ,
V_519 , V_519 ) ;
F_55 ( V_5 -> V_294 , V_214 ,
V_519 , V_519 ) ;
F_55 ( V_5 -> V_294 , V_185 ,
V_520 , V_520 ) ;
F_55 ( V_5 -> V_294 , V_186 ,
V_520 , V_520 ) ;
F_55 ( V_5 -> V_294 , V_215 ,
V_521 , V_521 ) ;
F_55 ( V_5 -> V_294 , V_216 ,
V_521 , V_521 ) ;
F_55 ( V_5 -> V_294 ,
V_160 ,
V_522 |
...
V_560 ,
1 << V_547 | 1 ) ;
V_48 = F_58 ( V_5 -> V_294 , V_259 , & V_88 ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 , L_62 , V_48 ) ;
goto V_503;
}
if ( V_88 & V_340 )
F_55 ( V_5 -> V_294 , V_148 ,
V_561 ,
V_561 ) ;
V_48 = F_58 ( V_5 -> V_294 , V_260 , & V_88 ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 , L_63 , V_48 ) ;
goto V_503;
}
if ( V_88 & V_341 )
F_55 ( V_5 -> V_294 , V_171 ,
V_562 ,
V_562 ) ;
F_60 ( V_5 ) ;
V_48 = F_101 ( & V_57 -> V_29 ,
& V_563 , V_564 ,
F_5 ( V_564 ) ) ;
if ( V_48 < 0 )
goto V_565;
...
static int F_103 ( struct V_56 * V_566 )
{
struct V_4 * V_5 = F_104 ( V_566 ) ;
int V_12 ;
F_105 ( & V_566 -> V_29 ) ;
F_62 ( V_5 ) ;
if ( V_5 -> V_7 . V_293 > 0 ) {
