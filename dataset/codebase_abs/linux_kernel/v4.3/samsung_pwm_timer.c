...
{
return ~ F_32 ( V_8 . V_51 ) ;
}
static T_8 T_7 F_33 ( void )
{
return F_31 ( NULL ) ;
}
...
void T_5 F_42 ( void T_9 * V_9 ,
unsigned int * V_56 , struct V_57 * V_14 )
{
V_8 . V_9 = V_9 ;
memcpy ( & V_8 . V_14 , V_14 , sizeof( V_8 . V_14 ) ) ;
memcpy ( V_8 . V_34 , V_56 , V_55 * sizeof( * V_56 ) ) ;
V_8 . V_41 = F_43 ( NULL , L_4 ) ;
if ( F_44 ( V_8 . V_41 ) )
F_38 ( L_5 ) ;
F_41 () ;
}
static void T_5 F_45 ( struct V_58 * V_59 ,
...
int V_64 ;
memcpy ( & V_8 . V_14 , V_14 , sizeof( V_8 . V_14 ) ) ;
for ( V_64 = 0 ; V_64 < V_55 ; ++ V_64 )
V_8 . V_34 [ V_64 ] = F_46 ( V_59 , V_64 ) ;
F_47 (np, L_6 , prop, cur, val) {
if ( V_63 >= V_55 ) {
F_48 ( L_7 ,
V_65 ) ;
continue;
}
V_8 . V_14 . V_54 |= 1 << V_63 ;
}
V_8 . V_9 = F_49 ( V_59 , 0 ) ;
if ( ! V_8 . V_9 ) {
F_50 ( L_8 , V_65 ) ;
...
V_8 . V_41 = F_51 ( V_59 , L_4 ) ;
if ( F_44 ( V_8 . V_41 ) )
F_38 ( L_5 ) ;
F_41 () ;
}
static void T_5 F_52 ( struct V_58 * V_59 )
{
F_45 ( V_59 , & V_66 ) ;
}
static void T_5 F_53 ( struct V_58 * V_59 )
{
F_45 ( V_59 , & V_67 ) ;
}
static void T_5 F_54 ( struct V_58 * V_59 )
{
F_45 ( V_59 , & V_68 ) ;
}
static void T_5 F_55 ( struct V_58 * V_59 )
{
F_45 ( V_59 , & V_69 ) ;
}
