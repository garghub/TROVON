...
{
struct V_111 * V_119 ;
V_119 = F_53 ( V_118 , V_22 -> V_120 , V_36 ) ;
if ( V_119 ) {
...
* V_57 = (struct V_109 * ) * V_126 ;
* V_126 += F_55 ( F_49 ( * V_57 ) ) ;
}
} else {
if ( V_123 ) {
...
if ( V_129 != V_133 && V_22 -> V_71 )
V_120 += F_55 ( F_49 ( V_22 -> V_71 ) ) ;
...
if ( V_130 )
goto V_86;
V_130 = F_54 ( V_22 ? V_22 -> V_71 : NULL , V_123 , V_124 ,
V_129 != V_133 ,
(struct V_109 * * ) & V_119 -> V_71 , & V_126 ) ;
if ( V_130 )
goto V_86;
...
return NULL ;
* V_141 = V_140 -> V_4 ;
V_140 -> V_4 = * ( (struct V_58 * ) V_22 -> V_71 ) -> V_32 ;
return V_141 ;
}
