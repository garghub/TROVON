...
struct V_32 * V_110 = NULL ;
V_101 = F_47 ( & V_4 -> V_111 , sizeof( * V_101 ) , V_112 ) ;
if ( ! V_101 ) {
F_42 ( V_4 , L_11 ) ;
return - V_47 ;
}
F_48 ( V_4 , V_101 ) ;
V_101 -> V_104 = V_2 -> V_113 ;
F_49 ( & V_101 -> V_76 ) ;
F_49 ( & V_101 -> V_40 ) ;
F_50 ( & V_101 -> V_58 ) ;
V_57 = F_51 ( V_4 ) ;
...
V_101 -> V_118 = F_47 ( & V_4 -> V_111 , V_108 *
sizeof( struct V_119 ) ,
V_112 ) ;
if ( V_101 -> V_118 == NULL ) {
F_42 ( V_4 , L_15 ) ;
...
if ( V_11 -> type == V_12 ||
V_11 -> type == V_13 ) {
V_33 = F_47 ( & V_4 -> V_111 , sizeof( * V_33 ) ,
V_112 ) ;
if ( ! V_33 ) {
F_42 ( V_4 , L_16 ) ;
V_57 = - V_47 ;
...
V_33 -> V_4 = V_4 ;
V_33 -> V_120 = V_4 -> V_121 ;
V_33 -> V_122 = V_4 -> V_123 ;
V_33 -> V_82 = V_11 -> V_82 ;
V_33 -> V_71 = F_47 ( & V_4 -> V_111 ,
sizeof( struct V_58 ) ,
V_112 ) ;
if ( ! V_33 -> V_71 ) {
V_57 = - V_47 ;
...
F_56 ( V_4 ) ;
F_8 ( & V_53 -> V_76 , V_39 ) ;
for ( V_7 = 0 ; V_7 < V_53 -> V_115 ; ++ V_7 ) {
struct V_32 * V_33 =
V_53 -> V_118 [ V_7 ] . V_124 ;
if ( V_33 -> V_73 . V_77 )
F_39 ( & V_33 -> V_73 . V_74 ) ;
}
F_9 ( & V_53 -> V_76 , V_39 ) ;
