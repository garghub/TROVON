...
F_184 ( V_277 . V_278 , V_275 -> V_278 ,
sizeof( V_277 . V_278 ) ) ;
V_277 . V_279 = V_275 -> V_279 ;
F_185 () ;
F_134 ( & V_15 -> V_280 ) ;
V_156 = F_186 ( V_2 , & V_277 , V_275 -> V_281 ) ;
F_135 ( & V_15 -> V_280 ) ;
F_187 () ;
} else {
F_134 ( & V_15 -> V_280 ) ;
V_156 = F_188 ( V_2 , V_275 -> V_281 ) ;
F_135 ( & V_15 -> V_280 ) ;
}
goto V_282;
}
...
static void
F_189 ( struct V_295 * V_9 , struct V_54 * V_102 )
{
struct V_120 * V_121 ;
struct V_100 V_237 ;
char * V_175 ;
...
continue;
if ( V_299 >= V_297 -> V_185 )
goto V_67;
memset ( & V_300 , 0 , sizeof( V_300 ) ) ;
F_189 ( & V_300 , V_55 ) ;
if ( F_191 ( & V_298 -> V_301 [ V_299 ] ,
& V_300 , sizeof( V_300 ) ) ) {
V_156 = - V_271 ;
goto V_67;
}
...
static inline int
F_192 ( struct V_2 * V_2 , const struct V_302 * V_297 ,
struct V_302 T_6 * V_298 )
{
struct V_54 * V_55 ;
union V_42 V_4 = { . V_46 = V_297 -> V_4 } ;
int V_156 = 0 ;
F_58 () ;
if ( V_297 -> V_53 )
V_55 = F_39 ( V_2 , V_184 , V_297 -> V_53 ) ;
else
V_55 = F_35 ( V_2 , V_184 , V_297 -> V_59 , & V_4 ,
V_297 -> V_43 ) ;
F_59 () ;
if ( V_55 ) {
int V_299 = 0 ;
...
memset ( & V_300 , 0 , sizeof( V_300 ) ) ;
F_69 (dest, &svc->destinations, n_list) {
if ( V_299 >= V_297 -> V_135 )
break;
if ( V_75 -> V_40 != V_55 -> V_40 )
continue;
V_300 . V_4 = V_75 -> V_4 . V_46 ;
V_300 . V_43 = V_75 -> V_43 ;
V_300 . V_122 = F_15 ( & V_75 -> V_122 ) ;
V_300 . V_124 = F_15 ( & V_75 -> V_124 ) ;
V_300 . V_129 = V_75 -> V_129 ;
V_300 . V_131 = V_75 -> V_131 ;
V_300 . V_153 = F_15 ( & V_75 -> V_153 ) ;
V_300 . V_154 = F_15 ( & V_75 -> V_154 ) ;
V_300 . V_155 = F_15 ( & V_75 -> V_155 ) ;
F_78 ( & V_237 , & V_75 -> V_76 ) ;
F_81 ( & V_300 . V_76 , & V_237 ) ;
if ( F_191 ( & V_298 -> V_301 [ V_299 ] ,
& V_300 , sizeof( V_300 ) ) ) {
V_156 = - V_271 ;
break;
...
static inline void
F_193 ( struct V_2 * V_2 , struct V_240 * V_171 )
{
#if F_174 ( V_241 ) || F_174 ( V_242 )
struct V_243 * V_244 ;
#endif
...
static int
F_194 ( struct V_258 * V_259 , int V_260 , void T_6 * V_261 , int * V_262 )
{
unsigned char V_263 [ V_304 ] ;
int V_156 = 0 ;
unsigned int V_305 ;
struct V_2 * V_2 = F_179 ( V_259 ) ;
struct V_14 * V_15 = F_41 ( V_2 ) ;
...
if ( ! F_181 ( F_179 ( V_259 ) -> V_265 , V_266 ) )
return - V_267 ;
if ( V_260 < V_268 || V_260 > V_306 )
return - V_144 ;
V_305 = V_307 [ F_182 ( V_260 ) ] ;
if ( * V_262 < ( int ) V_305 ) {
F_103 ( 1 , L_57 , * V_262 , V_305 ) ;
return - V_144 ;
}
if ( F_183 ( V_263 , V_261 , V_305 ) != 0 )
return - V_271 ;
if ( V_260 == V_308 ) {
struct V_274 V_309 [ 2 ] ;
memset ( & V_309 , 0 , sizeof( V_309 ) ) ;
F_134 ( & V_15 -> V_280 ) ;
if ( V_15 -> V_310 & V_311 ) {
V_309 [ 0 ] . V_281 = V_311 ;
F_184 ( V_309 [ 0 ] . V_278 , V_15 -> V_312 . V_278 ,
sizeof( V_309 [ 0 ] . V_278 ) ) ;
V_309 [ 0 ] . V_279 = V_15 -> V_312 . V_279 ;
}
if ( V_15 -> V_310 & V_313 ) {
V_309 [ 1 ] . V_281 = V_313 ;
F_184 ( V_309 [ 1 ] . V_278 , V_15 -> V_314 . V_278 ,
sizeof( V_309 [ 1 ] . V_278 ) ) ;
V_309 [ 1 ] . V_279 = V_15 -> V_314 . V_279 ;
}
if ( F_191 ( V_261 , & V_309 , sizeof( V_309 ) ) != 0 )
V_156 = - V_271 ;
F_135 ( & V_15 -> V_280 ) ;
return V_156 ;
}
...
sprintf ( V_316 , L_58 ,
F_160 ( V_229 ) , V_230 ) ;
if ( F_191 ( V_261 , V_316 , strlen ( V_316 ) + 1 ) != 0 ) {
V_156 = - V_271 ;
goto V_67;
}
...
if ( F_191 ( V_261 , & V_319 , sizeof( V_319 ) ) != 0 )
V_156 = - V_271 ;
}
break;
case V_322 :
...
struct V_296 * V_297 ;
int V_321 ;
V_297 = (struct V_296 * ) V_263 ;
V_321 = sizeof( * V_297 ) +
sizeof( struct V_295 ) * V_297 -> V_185 ;
if ( * V_262 != V_321 ) {
F_28 ( L_59 , * V_262 , V_321 ) ;
V_156 = - V_144 ;
goto V_67;
}
V_156 = F_190 ( V_2 , V_297 , V_261 ) ;
}
break;
case V_323 :
{
...
struct V_54 * V_55 ;
union V_42 V_4 ;
V_300 = (struct V_295 * ) V_263 ;
V_4 . V_46 = V_300 -> V_4 ;
F_58 () ;
if ( V_300 -> V_53 )
V_55 = F_39 ( V_2 , V_184 , V_300 -> V_53 ) ;
else
V_55 = F_35 ( V_2 , V_184 ,
V_300 -> V_59 , & V_4 ,
V_300 -> V_43 ) ;
...
if ( V_55 ) {
F_189 ( V_300 , V_55 ) ;
if ( F_191 ( V_261 , V_300 , sizeof( * V_300 ) ) != 0 )
V_156 = - V_271 ;
} else
V_156 = - V_289 ;
}
...
struct V_302 * V_297 ;
int V_321 ;
V_297 = (struct V_302 * ) V_263 ;
V_321 = sizeof( * V_297 ) +
sizeof( struct V_303 ) * V_297 -> V_135 ;
if ( * V_262 != V_321 ) {
F_28 ( L_59 , * V_262 , V_321 ) ;
V_156 = - V_144 ;
goto V_67;
}
V_156 = F_192 ( V_2 , V_297 , V_261 ) ;
}
break;
case V_325 :
{
struct V_240 V_326 ;
F_193 ( V_2 , & V_326 ) ;
if ( F_191 ( V_261 , & V_326 , sizeof( V_326 ) ) != 0 )
V_156 = - V_271 ;
}
break;
default:
...
static int F_195 ( struct V_327 * V_328 , int V_329 ,
struct V_100 * V_237 )
{
struct V_330 * V_331 = F_196 ( V_328 , V_329 ) ;
if ( ! V_331 )
return - V_332 ;
if ( F_197 ( V_328 , V_333 , ( V_110 ) V_237 -> V_104 ) ||
F_197 ( V_328 , V_334 , ( V_110 ) V_237 -> V_105 ) ||
F_197 ( V_328 , V_335 , ( V_110 ) V_237 -> V_106 ) ||
F_198 ( V_328 , V_336 , V_237 -> V_107 ) ||
F_198 ( V_328 , V_337 , V_237 -> V_108 ) ||
F_197 ( V_328 , V_338 , ( V_110 ) V_237 -> V_111 ) ||
F_197 ( V_328 , V_339 , ( V_110 ) V_237 -> V_112 ) ||
F_197 ( V_328 , V_340 , ( V_110 ) V_237 -> V_113 ) ||
F_197 ( V_328 , V_341 , ( V_110 ) V_237 -> V_114 ) ||
F_197 ( V_328 , V_342 , ( V_110 ) V_237 -> V_115 ) )
goto V_343;
F_199 ( V_328 , V_331 ) ;
return 0 ;
V_343:
...
static int F_201 ( struct V_327 * V_328 , int V_329 ,
struct V_100 * V_237 )
{
struct V_330 * V_331 = F_196 ( V_328 , V_329 ) ;
if ( ! V_331 )
return - V_332 ;
if ( F_198 ( V_328 , V_333 , V_237 -> V_104 ) ||
F_198 ( V_328 , V_334 , V_237 -> V_105 ) ||
F_198 ( V_328 , V_335 , V_237 -> V_106 ) ||
F_198 ( V_328 , V_336 , V_237 -> V_107 ) ||
F_198 ( V_328 , V_337 , V_237 -> V_108 ) ||
F_198 ( V_328 , V_338 , V_237 -> V_111 ) ||
F_198 ( V_328 , V_339 , V_237 -> V_112 ) ||
F_198 ( V_328 , V_340 , V_237 -> V_113 ) ||
F_198 ( V_328 , V_341 , V_237 -> V_114 ) ||
F_198 ( V_328 , V_342 , V_237 -> V_115 ) )
goto V_343;
F_199 ( V_328 , V_331 ) ;
return 0 ;
V_343:
...
static int F_202 ( struct V_327 * V_328 ,
struct V_54 * V_55 )
{
struct V_120 * V_121 ;
struct V_173 * V_174 ;
...
struct V_100 V_237 ;
char * V_175 ;
V_344 = F_196 ( V_328 , V_347 ) ;
if ( ! V_344 )
return - V_332 ;
if ( F_203 ( V_328 , V_348 , V_55 -> V_40 ) )
goto V_343;
if ( V_55 -> V_53 ) {
if ( F_197 ( V_328 , V_349 , V_55 -> V_53 ) )
goto V_343;
} else {
if ( F_203 ( V_328 , V_350 , V_55 -> V_59 ) ||
F_204 ( V_328 , V_351 , sizeof( V_55 -> V_4 ) , & V_55 -> V_4 ) ||
F_205 ( V_328 , V_352 , V_55 -> V_43 ) )
goto V_343;
}
V_121 = F_65 ( V_55 -> V_136 , 1 ) ;
V_175 = V_121 ? V_121 -> V_195 : L_18 ;
V_174 = F_65 ( V_55 -> V_174 , 1 ) ;
if ( F_206 ( V_328 , V_353 , V_175 ) ||
( V_174 && F_206 ( V_328 , V_354 , V_174 -> V_195 ) ) ||
F_204 ( V_328 , V_355 , sizeof( V_12 ) , & V_12 ) ||
F_197 ( V_328 , V_356 , V_55 -> V_181 / V_182 ) ||
F_207 ( V_328 , V_357 , V_55 -> V_180 ) )
goto V_343;
F_78 ( & V_237 , & V_55 -> V_76 ) ;
if ( F_195 ( V_328 , V_358 , & V_237 ) )
goto V_343;
if ( F_201 ( V_328 , V_359 , & V_237 ) )
goto V_343;
F_199 ( V_328 , V_344 ) ;
return 0 ;
V_343:
...
static int F_208 ( struct V_327 * V_328 ,
struct V_54 * V_55 ,
struct V_360 * V_361 )
{
void * V_362 ;
V_362 = F_209 ( V_328 , F_210 ( V_361 -> V_328 ) . V_363 , V_361 -> V_364 -> V_365 ,
& V_366 , V_367 ,
V_368 ) ;
if ( ! V_362 )
return - V_332 ;
if ( F_202 ( V_328 , V_55 ) < 0 )
goto V_343;
F_211 ( V_328 , V_362 ) ;
return 0 ;
V_343:
...
if ( V_376 ) {
V_253 -> V_59 = V_68 ;
V_253 -> V_53 = F_218 ( V_376 ) ;
} else {
V_253 -> V_59 = F_217 ( V_377 ) ;
F_219 ( & V_253 -> V_4 , V_378 , sizeof( V_253 -> V_4 ) ) ;
V_253 -> V_43 = F_220 ( V_375 ) ;
V_253 -> V_53 = 0 ;
}
F_58 () ;
if ( V_253 -> V_53 )
...
return - V_144 ;
F_219 ( & V_12 , V_382 , sizeof( V_12 ) ) ;
if ( V_55 )
V_253 -> V_12 = V_55 -> V_12 ;
V_253 -> V_12 = ( V_253 -> V_12 & ~ V_12 . V_346 ) |
( V_12 . V_12 & V_12 . V_346 ) ;
V_253 -> V_175 = F_221 ( V_381 ) ;
V_253 -> V_177 = V_383 ? F_221 ( V_383 ) : NULL ;
V_253 -> V_181 = F_218 ( V_384 ) ;
V_253 -> V_180 = F_222 ( V_385 ) ;
}
return 0 ;
}
static struct V_54 * F_223 ( struct V_2 * V_2 ,
struct V_330 * V_369 )
{
struct V_170 V_253 ;
struct V_54 * V_55 ;
int V_156 ;
V_156 = F_215 ( V_2 , & V_253 , V_369 , 0 , & V_55 ) ;
return V_156 ? F_224 ( V_156 ) : V_55 ;
}
static int F_225 ( struct V_327 * V_328 , struct V_74 * V_75 )
{
struct V_330 * V_386 ;
struct V_100 V_237 ;
V_386 = F_196 ( V_328 , V_387 ) ;
if ( ! V_386 )
return - V_332 ;
if ( F_204 ( V_328 , V_388 , sizeof( V_75 -> V_4 ) , & V_75 -> V_4 ) ||
F_205 ( V_328 , V_389 , V_75 -> V_43 ) ||
F_197 ( V_328 , V_390 ,
( F_15 ( & V_75 -> V_122 ) &
V_90 ) ) ||
F_197 ( V_328 , V_391 ,
F_15 ( & V_75 -> V_124 ) ) ||
F_197 ( V_328 , V_392 , V_75 -> V_129 ) ||
F_197 ( V_328 , V_393 , V_75 -> V_131 ) ||
F_197 ( V_328 , V_394 ,
F_15 ( & V_75 -> V_153 ) ) ||
F_197 ( V_328 , V_395 ,
F_15 ( & V_75 -> V_154 ) ) ||
F_197 ( V_328 , V_396 ,
F_15 ( & V_75 -> V_155 ) ) ||
F_203 ( V_328 , V_397 , V_75 -> V_40 ) )
goto V_343;
F_78 ( & V_237 , & V_75 -> V_76 ) ;
if ( F_195 ( V_328 , V_398 , & V_237 ) )
goto V_343;
if ( F_201 ( V_328 , V_399 , & V_237 ) )
goto V_343;
F_199 ( V_328 , V_386 ) ;
return 0 ;
V_343:
...
static int F_226 ( struct V_327 * V_328 , struct V_74 * V_75 ,
struct V_360 * V_361 )
{
void * V_362 ;
V_362 = F_209 ( V_328 , F_210 ( V_361 -> V_328 ) . V_363 , V_361 -> V_364 -> V_365 ,
...
static int F_227 ( struct V_327 * V_328 ,
struct V_360 * V_361 )
{
int V_189 = 0 ;
int V_238 = V_361 -> args [ 0 ] ;
...
struct V_2 * V_2 = F_214 ( V_328 ) ;
F_134 ( & V_193 ) ;
if ( F_228 ( V_361 -> V_364 , V_402 , V_372 ,
V_401 , V_403 ) )
goto V_176;
V_55 = F_223 ( V_2 , V_372 [ V_347 ] ) ;
if ( F_229 ( V_55 ) || V_55 == NULL )
goto V_176;
F_69 (dest, &svc->destinations, n_list) {
if ( ++ V_189 <= V_238 )
continue;
if ( F_226 ( V_328 , V_75 , V_361 ) < 0 ) {
V_189 -- ;
goto V_343;
}
}
...
return - V_144 ;
memset ( V_117 , 0 , sizeof( * V_117 ) ) ;
F_219 ( & V_117 -> V_4 , V_378 , sizeof( V_117 -> V_4 ) ) ;
V_117 -> V_43 = F_220 ( V_375 ) ;
if ( V_405 )
V_117 -> V_40 = F_217 ( V_405 ) ;
else
V_117 -> V_40 = 0 ;
if ( V_370 ) {
...
return - V_144 ;
V_117 -> V_122 = F_218 ( V_407 )
& V_90 ;
V_117 -> V_124 = F_218 ( V_408 ) ;
V_117 -> V_129 = F_218 ( V_409 ) ;
V_117 -> V_131 = F_218 ( V_410 ) ;
}
return 0 ;
}
static int F_231 ( struct V_327 * V_328 , T_3 V_281 ,
struct V_276 * T_5 )
{
struct V_330 * V_411 ;
V_411 = F_196 ( V_328 , V_412 ) ;
if ( ! V_411 )
return - V_332 ;
if ( F_197 ( V_328 , V_413 , V_281 ) ||
F_206 ( V_328 , V_414 , T_5 -> V_278 ) ||
F_197 ( V_328 , V_415 , T_5 -> V_279 ) ||
F_203 ( V_328 , V_416 , T_5 -> V_417 ) ||
F_203 ( V_328 , V_418 , T_5 -> V_419 ) ||
F_232 ( V_328 , V_420 , T_5 -> V_421 ) )
goto V_343;
#ifdef F_24
if ( T_5 -> V_422 == V_48 ) {
if ( F_233 ( V_328 , V_423 ,
& T_5 -> V_424 . V_141 ) )
goto V_343;
} else
#endif
...
static int F_235 ( struct V_327 * V_328 , T_3 V_281 ,
struct V_276 * T_5 ,
struct V_360 * V_361 )
{
void * V_362 ;
...
static int F_236 ( struct V_327 * V_328 ,
struct V_360 * V_361 )
{
struct V_2 * V_2 = F_214 ( V_328 ) ;
struct V_14 * V_15 = F_41 ( V_2 ) ;
F_134 ( & V_15 -> V_280 ) ;
if ( ( V_15 -> V_310 & V_311 ) && ! V_361 -> args [ 0 ] ) {
if ( F_235 ( V_328 , V_311 ,
& V_15 -> V_312 , V_361 ) < 0 )
goto V_343;
V_361 -> args [ 0 ] = 1 ;
}
if ( ( V_15 -> V_310 & V_313 ) && ! V_361 -> args [ 1 ] ) {
if ( F_235 ( V_328 , V_313 ,
& V_15 -> V_314 , V_361 ) < 0 )
goto V_343;
V_361 -> args [ 1 ] = 1 ;
}
...
static int F_237 ( struct V_2 * V_2 , struct V_330 * * V_372 )
{
struct V_14 * V_15 = F_41 ( V_2 ) ;
struct V_276 T_5 ;
struct V_330 * V_427 ;
...
V_372 [ V_415 ] ) )
return - V_144 ;
F_184 ( T_5 . V_278 , F_221 ( V_372 [ V_414 ] ) ,
sizeof( T_5 . V_278 ) ) ;
T_5 . V_279 = F_218 ( V_372 [ V_415 ] ) ;
V_427 = V_372 [ V_416 ] ;
if ( V_427 )
T_5 . V_417 = F_217 ( V_427 ) ;
V_427 = V_372 [ V_425 ] ;
if ( V_427 ) {
T_5 . V_422 = V_184 ;
T_5 . V_424 . V_46 = F_238 ( V_427 ) ;
if ( ! F_239 ( T_5 . V_424 . V_46 ) )
return - V_144 ;
} else {
V_427 = V_372 [ V_423 ] ;
if ( V_427 ) {
...
int V_428 ;
T_5 . V_422 = V_48 ;
T_5 . V_424 . V_141 = F_240 ( V_427 ) ;
V_428 = F_91 ( & T_5 . V_424 . V_141 ) ;
if ( ! ( V_428 & V_429 ) )
return - V_144 ;
#else
return - V_380 ;
...
V_427 = V_372 [ V_418 ] ;
if ( V_427 )
T_5 . V_419 = F_217 ( V_427 ) ;
V_427 = V_372 [ V_420 ] ;
if ( V_427 )
T_5 . V_421 = F_241 ( V_427 ) ;
if ( V_15 -> V_123 > 0 )
return - V_144 ;
F_185 () ;
F_134 ( & V_15 -> V_280 ) ;
...
static int F_242 ( struct V_2 * V_2 , struct V_330 * * V_372 )
{
struct V_14 * V_15 = F_41 ( V_2 ) ;
int V_156 ;
if ( ! V_372 [ V_413 ] )
...
static int F_243 ( struct V_2 * V_2 , struct V_330 * * V_372 )
{
struct V_240 V_326 ;
F_193 ( V_2 , & V_326 ) ;
if ( V_372 [ V_430 ] )
V_326 . V_245 = F_218 ( V_372 [ V_430 ] ) ;
if ( V_372 [ V_431 ] )
V_326 . V_246 =
F_218 ( V_372 [ V_431 ] ) ;
if ( V_372 [ V_432 ] )
V_326 . V_247 = F_218 ( V_372 [ V_432 ] ) ;
return F_173 ( V_2 , & V_326 ) ;
}
static int F_244 ( struct V_327 * V_328 , struct V_433 * V_319 )
{
int V_156 = - V_144 , V_260 ;
struct V_2 * V_2 ;
struct V_14 * V_15 ;
V_2 = F_214 ( V_328 ) ;
V_15 = F_41 ( V_2 ) ;
V_260 = V_319 -> V_434 -> V_260 ;
if ( V_260 == V_426 || V_260 == V_435 ) {
struct V_330 * V_436 [ V_437 + 1 ] ;
...
goto V_67;
if ( V_260 == V_426 )
V_156 = F_237 ( V_2 , V_436 ) ;
else
V_156 = F_242 ( V_2 , V_436 ) ;
}
V_67:
return V_156 ;
}
static int F_245 ( struct V_327 * V_328 , struct V_433 * V_319 )
{
struct V_54 * V_55 = NULL ;
struct V_170 V_253 ;
struct V_116 V_117 ;
...
if ( V_260 == V_368 || V_260 == V_444 )
V_439 = 1 ;
V_156 = F_215 ( V_2 , & V_253 ,
V_319 -> V_372 [ V_347 ] ,
V_439 , & V_55 ) ;
if ( V_156 )
goto V_67;
...
if ( V_117 . V_40 != V_55 -> V_40 && V_260 != V_446 ) {
if ( F_41 ( V_2 ) -> V_310 ) {
V_156 = - V_144 ;
goto V_67;
}
...
static int F_246 ( struct V_327 * V_328 , struct V_433 * V_319 )
{
struct V_327 * V_448 ;
void * V_449 ;
int V_156 , V_260 , V_450 ;
struct V_2 * V_2 ;
V_2 = F_214 ( V_328 ) ;
V_260 = V_319 -> V_434 -> V_260 ;
if ( V_260 == V_451 )
...
V_448 = F_247 ( V_455 , V_147 ) ;
if ( ! V_448 )
return - V_148 ;
F_134 ( & V_193 ) ;
V_449 = F_248 ( V_448 , V_319 , & V_366 , 0 , V_450 ) ;
if ( V_449 == NULL )
goto V_343;
switch ( V_260 ) {
case V_451 :
...
#endif
#ifdef V_242
if ( F_197 ( V_448 , V_432 , V_326 . V_247 ) )
goto V_343;
#endif
break;
}
case V_452 :
if ( F_197 ( V_448 , V_456 ,
V_229 ) ||
F_197 ( V_448 , V_457 ,
V_230 ) )
goto V_343;
...
static int T_12 F_256 ( struct V_2 * V_2 )
{
int V_189 ;
struct V_14 * V_15 = F_41 ( V_2 ) ;
struct V_203 * V_459 ;
...
F_100 ( & V_15 -> V_33 ) ;
if ( ! F_38 ( V_2 , & V_460 ) ) {
V_459 = F_257 ( V_461 , sizeof( V_461 ) , V_147 ) ;
if ( V_459 == NULL )
return - V_148 ;
if ( V_2 -> V_265 != & V_462 )
V_459 [ 0 ] . V_463 = NULL ;
...
V_189 = 0 ;
V_15 -> V_24 = 1024 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_24 ;
V_15 -> V_32 = 10 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_32 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_26 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_29 ;
#ifdef F_258
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_464 ;
#endif
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_34 ;
V_15 -> V_465 = 1 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_465 ;
V_15 -> V_466 = 1 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_466 ;
V_15 -> V_467 = 1 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_467 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_468 ;
V_15 -> V_469 = F_259 () / 32 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_469 ;
V_15 -> V_470 = 0 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_470 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_471 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_472 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_473 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_474 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_475 ;
V_15 -> V_476 [ 0 ] = V_477 ;
V_15 -> V_476 [ 1 ] = V_478 ;
V_459 [ V_189 ] . V_167 = & V_15 -> V_476 ;
V_459 [ V_189 ++ ] . V_479 = sizeof( V_15 -> V_476 ) ;
V_15 -> V_480 = V_481 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_480 ;
V_15 -> V_482 = F_260 ( int , V_483 , 0 , 3 ) ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_482 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_484 ;
V_15 -> V_485 = 1 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_485 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_486 ;
V_15 -> V_487 = 1 ;
V_459 [ V_189 ++ ] . V_167 = & V_15 -> V_487 ;
V_15 -> V_488 = F_261 ( V_2 , L_62 , V_459 ) ;
if ( V_15 -> V_488 == NULL ) {
if ( ! F_38 ( V_2 , & V_460 ) )
F_49 ( V_459 ) ;
return - V_148 ;
...
static void T_13 F_263 ( struct V_2 * V_2 )
{
struct V_14 * V_15 = F_41 ( V_2 ) ;
F_264 ( & V_15 -> V_37 ) ;
...
static int T_12 F_256 ( struct V_2 * V_2 ) { return 0 ; }
static void T_13 F_263 ( struct V_2 * V_2 ) { }
int T_12 F_267 ( struct V_2 * V_2 )
{
int V_17 , V_189 ;
struct V_14 * V_15 = F_41 ( V_2 ) ;
for ( V_189 = 0 ; V_189 < V_490 ; V_189 ++ )
F_268 ( & V_15 -> V_85 [ V_189 ] ) ;
F_121 ( & V_15 -> V_161 ) ;
F_100 ( & V_15 -> V_96 ) ;
F_269 ( & V_15 -> V_99 , F_114 ,
( unsigned long ) V_2 ) ;
F_9 ( & V_15 -> V_69 , 0 ) ;
F_9 ( & V_15 -> V_73 , 0 ) ;
...
F_95 (i) {
struct V_149 * V_491 ;
V_491 = F_96 ( V_15 -> V_202 . V_77 , V_17 ) ;
F_97 ( & V_491 -> V_152 ) ;
}
F_100 ( & V_15 -> V_202 . V_103 ) ;
F_270 ( L_63 , 0 , V_2 -> V_492 , & V_493 ) ;
F_270 ( L_64 , 0 , V_2 -> V_492 , & V_494 ) ;
F_270 ( L_65 , 0 , V_2 -> V_492 ,
& V_495 ) ;
if ( F_256 ( V_2 ) )
goto V_496;
return 0 ;
...
void T_13 F_271 ( struct V_2 * V_2 )
{
struct V_14 * V_15 = F_41 ( V_2 ) ;
F_75 ( V_2 ) ;
F_263 ( V_2 ) ;
F_272 ( L_65 , V_2 -> V_492 ) ;
F_272 ( L_64 , V_2 -> V_492 ) ;
F_272 ( L_63 , V_2 -> V_492 ) ;
F_48 ( V_15 -> V_202 . V_77 ) ;
}
int T_11 F_273 ( void )
{
