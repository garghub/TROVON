...
switch ( V_4 ) {
case V_12 :
F_3 ( V_9 , 0x00d97c + V_10 , 0x00000001 , 0x00000001 ) ;
break;
case V_13 :
F_3 ( V_9 , 0x00d970 + V_10 , 0x0000c003 , 0x0000c001 ) ;
F_3 ( V_9 , 0x00d97c + V_10 , 0x00000001 , 0x00000000 ) ;
break;
case V_14 :
F_3 ( V_9 , 0x00d970 + V_10 , 0x0000c003 , 0x00000002 ) ;
F_3 ( V_9 , 0x00d97c + V_10 , 0x00000001 , 0x00000000 ) ;
break;
default:
F_4 ( 1 ) ;
