...
T_1 V_31 ;
V_25 = V_26 ;
V_6 -> V_15 = V_25 -> clock * 1000 ;
V_27 = V_25 -> V_32 - V_25 -> V_33 ;
V_28 = V_25 -> V_32 - V_25 -> V_33 + V_25 -> V_34 ;
V_29 = V_25 -> V_35 - V_25 -> V_36 - 1 ;
V_30 = V_25 -> V_35 - V_25 -> V_36 + V_25 -> V_37 - 1 ;
F_6 ( L_8 ,
V_25 -> V_32 , V_25 -> V_35 , V_27 , V_28 , V_29 , V_30 ) ;
F_22 ( V_6 , V_38 ,
F_23 ( V_25 -> V_32 - 1 ) |
F_24 ( V_25 -> V_35 - 1 ) ) ;
F_22 ( V_6 , V_39 ,
...
struct V_1 * F_32 ( struct V_6 * V_6 )
{
struct V_1 * V_2 = NULL ;
struct V_5 * V_5 ;
int V_10 ;
V_5 = F_33 ( V_6 -> V_4 -> V_4 ,
sizeof( * V_5 ) , V_51 ) ;
if ( ! V_5 ) {
V_10 = - V_52 ;
goto V_53;
