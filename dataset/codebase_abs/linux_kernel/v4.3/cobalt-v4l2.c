...
static int F_80 ( struct V_174 * V_174 , void * V_175 ,
struct V_3 * V_240 )
{
struct V_9 * V_10 = F_60 ( V_174 ) ;
...
static int F_82 ( struct V_174 * V_174 , void * V_175 ,
struct V_3 * V_240 )
{
struct V_9 * V_10 = F_60 ( V_174 ) ;
struct V_243 * V_16 = & V_240 -> V_4 . V_16 ;
...
case V_77 :
default:
V_16 -> V_244 = F_83 ( V_16 -> V_244 & ~ 0x3 ,
V_16 -> V_46 * V_247 ) ;
V_16 -> V_242 = V_77 ;
break;
case V_115 :
...
static int F_88 ( struct V_174 * V_174 , void * V_175 ,
struct V_3 * V_240 )
{
struct V_9 * V_10 = F_60 ( V_174 ) ;
struct V_243 * V_16 = & V_240 -> V_4 . V_16 ;
struct V_67 V_68 = { 0 } ;
T_3 V_78 ;
if ( F_85 ( V_174 , V_175 , V_240 ) )
return - V_18 ;
if ( F_75 ( & V_10 -> V_2 ) && ( V_16 -> V_242 != V_10 -> V_64 ||
...
V_10 -> V_76 = V_16 -> V_76 ;
V_68 . V_69 = V_70 ;
F_89 ( & V_68 . V_72 , V_16 , V_78 ) ;
F_27 ( V_10 -> V_81 , V_82 , V_83 , NULL , & V_68 ) ;
return 0 ;
}
static int F_90 ( struct V_174 * V_174 , void * V_175 ,
struct V_251 * V_252 )
{
struct V_9 * V_10 = F_60 ( V_174 ) ;
if ( V_252 -> V_34 > 1 )
...
static int F_92 ( struct V_174 * V_174 , void * V_175 , unsigned int V_54 )
{
struct V_9 * V_10 = F_60 ( V_174 ) ;
if ( V_54 >= 2 )
return - V_18 ;
...
static int F_93 ( struct V_174 * V_174 , void * V_175 ,
struct V_259 * V_260 )
{
if ( V_260 -> V_34 )
return - V_18 ;
...
static int F_95 ( struct V_174 * V_174 , void * V_175 , unsigned int V_54 )
{
return V_54 ? - V_18 : 0 ;
}
...
static int F_97 ( struct V_174 * V_174 , void * V_263 , struct V_264 * V_265 )
{
struct V_9 * V_10 = F_60 ( V_174 ) ;
T_3 V_82 = V_265 -> V_82 ;
int V_37 ;
...
static int F_98 ( struct V_268 * V_263 ,
const struct V_269 * V_270 )
{
switch ( V_270 -> type ) {
case V_271 :
return F_99 ( V_263 , V_270 , 4 , NULL ) ;
}
return F_100 ( V_263 , V_270 ) ;
}
static int F_101 ( struct V_174 * V_174 , void * V_263 , struct V_272 * V_273 )
{
if ( V_273 -> type != V_274 )
return - V_18 ;
...
static int F_102 ( struct V_19 * V_19 , int V_281 )
{
...
V_37 = F_102 ( V_19 , V_281 ) ;
if ( V_37 )
return V_37 ;
}
return 0 ;
}
void F_112 ( struct V_19 * V_19 )
{
int V_281 ;
for ( V_281 = 0 ; V_281 < V_321 ; V_281 ++ ) {
struct V_9 * V_10 = V_19 -> V_284 + V_281 ;
