...
static T_1
F_72 ( struct V_27 * V_28 , struct V_29 * V_30 , char * V_31 )
{
struct V_60 * V_61 ;
V_61 = F_40 ( V_28 ) ;
...
struct V_60 * V_61 = F_40 ( V_28 ) ;
unsigned int V_114 ;
if ( F_59 ( V_31 , 10 , & V_114 ) )
return - V_24 ;
V_61 -> V_113 = F_78 ( V_114 ) ;
return V_114 ;
}
static T_3 F_79 ( struct V_115 * V_116 ,
...
if ( V_122 -> V_2 != V_123 )
return 0 ;
error = F_81 ( & V_122 -> V_28 ) ;
if ( error ) {
F_82 ( & V_122 -> V_28 , L_22 , error ) ;
return error ;
}
F_83 ( & V_122 -> V_28 ) ;
V_122 -> V_2 = V_124 ;
...
void F_99 ( struct V_60 * V_61 )
{
struct V_27 * V_28 = & V_61 -> V_62 ;
if ( V_61 -> V_129 ) {
if ( F_66 ( V_61 , V_131 ) != 0 )
return;
F_100 ( V_61 -> V_78 ) ;
F_101 ( & V_61 -> V_128 ) ;
F_102 ( V_28 ) ;
...
{
struct V_13 * V_14 = F_109 ( V_122 -> V_28 . V_65 ) ;
unsigned long V_52 ;
struct V_60 * V_61 ;
F_22 ( V_14 -> V_56 , V_52 ) ;
V_136:
F_110 (sdev, &shost->__devices, siblings) {
...
{
struct V_13 * V_14 = F_109 ( V_28 -> V_65 ) ;
struct V_121 * V_122 , * V_11 = NULL ;
unsigned long V_52 ;
F_22 ( V_14 -> V_56 , V_52 ) ;
F_110 (starget, &shost->__targets, siblings) {
if ( V_122 -> V_2 == V_137 )
continue;
...
int F_115 ( struct V_83 * V_139 )
{
V_139 -> V_140 = & V_92 ;
return F_116 ( V_139 ) ;
}
int F_117 ( struct V_141 * V_142 )
{
V_142 -> V_143 = & V_93 ;
return F_118 ( V_142 ) ;
}
...
V_61 -> V_62 . type = & V_85 ;
F_123 ( & V_61 -> V_62 , L_27 ,
V_61 -> V_70 -> V_147 , V_61 -> V_20 , V_61 -> V_21 , V_61 -> V_22 ) ;
F_122 ( & V_61 -> V_128 ) ;
V_61 -> V_128 . V_65 = F_124 ( & V_61 -> V_62 ) ;
V_61 -> V_128 . V_143 = & V_93 ;
F_123 ( & V_61 -> V_128 , L_27 ,
V_61 -> V_70 -> V_147 , V_61 -> V_20 , V_61 -> V_21 , V_61 -> V_22 ) ;
...
F_125 ( & V_61 -> V_62 ) ;
F_22 ( V_14 -> V_56 , V_52 ) ;
F_126 ( & V_61 -> V_72 , & V_122 -> V_153 ) ;
F_126 ( & V_61 -> V_71 , & V_14 -> V_154 ) ;
F_24 ( V_14 -> V_56 , V_52 ) ;
F_114 ( & V_122 -> V_138 ) ;
}
int F_127 ( const struct V_27 * V_28 )
{
