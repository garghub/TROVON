...
struct V_8 * V_9 ;
if ( type == V_60 ) {
F_31 (msi_data, &msi_head, list)
if ( V_9 -> V_50 & V_51 )
return - V_61 ;
}
V_58 = F_32 ( V_42 -> V_46 , L_4 , 0 ) ;
if ( V_58 ) {
if ( F_33 ( V_58 , L_5 ) ||
F_33 ( V_58 , L_6 ) ||
F_33 ( V_58 , L_7 ) )
...
V_18 = F_36 ( V_9 -> V_30 , V_12 ) ;
if ( V_18 == V_37 ) {
F_34 ( & V_33 -> V_62 , L_10 , V_12 ) ;
F_20 ( & V_9 -> V_28 , V_12 , 1 ) ;
V_27 = - V_65 ;
goto V_64;
}
...
static T_7 F_38 ( int V_36 , void * V_52 )
{
unsigned int V_66 ;
struct V_8 * V_9 ;
int V_67 = - 1 ;
...
static int F_54 ( struct V_8 * V_85 , struct V_83 * V_62 ,
int V_89 , int V_90 )
{
struct V_71 * V_72 = NULL ;
int V_91 , V_86 , V_73 ;
V_91 = F_55 ( V_62 -> V_62 . V_31 , V_90 ) ;
if ( V_91 == V_37 ) {
F_34 ( & V_62 -> V_62 , L_13 ,
V_53 , V_90 ) ;
return 0 ;
}
V_72 = F_56 ( sizeof( struct V_71 ) , V_92 ) ;
if ( ! V_72 ) {
F_34 ( & V_62 -> V_62 , L_14 ) ;
return - V_59 ;
}
...
F_20 ( & V_85 -> V_28 ,
F_44 ( V_85 , V_89 , V_86 ) , 1 ) ;
return 0 ;
}
static int F_59 ( struct V_83 * V_62 )
{
...
T_1 V_89 ;
struct V_41 * V_106 ;
V_97 = F_60 ( V_107 , & V_62 -> V_62 ) ;
if ( ! V_97 )
return - V_61 ;
V_105 = V_97 -> V_52 ;
F_61 ( V_108 L_17 ) ;
V_85 = F_56 ( sizeof( struct V_8 ) , V_92 ) ;
if ( ! V_85 ) {
F_34 ( & V_62 -> V_62 , L_18 ) ;
return - V_59 ;
}
F_62 ( V_62 , V_85 ) ;
V_85 -> V_30 = F_63 ( V_62 -> V_62 . V_31 ,
V_29 , & V_109 , V_85 ) ;
if ( V_85 -> V_30 == NULL ) {
F_34 ( & V_62 -> V_62 , L_19 ) ;
V_101 = - V_59 ;
...
V_101 = F_64 ( V_62 -> V_62 . V_31 , 0 , & V_99 ) ;
if ( V_101 ) {
F_34 ( & V_62 -> V_62 , L_20 ,
V_62 -> V_62 . V_31 -> V_63 ) ;
goto V_110;
}
V_85 -> V_79 = F_65 ( V_99 . V_112 , F_66 ( & V_99 ) ) ;
if ( ! V_85 -> V_79 ) {
V_101 = - V_59 ;
F_34 ( & V_62 -> V_62 , L_21 ,
V_62 -> V_62 . V_31 -> V_63 ) ;
...
if ( F_64 ( V_62 -> V_62 . V_31 , 1 , & V_100 ) )
...
if ( F_33 ( V_62 -> V_62 . V_31 , L_24 ) ||
F_33 ( V_62 -> V_62 . V_31 , L_7 ) ) {
V_85 -> V_15 = V_114 ;
V_85 -> V_54 = V_115 ;
if ( V_7 )
F_68 ( & V_62 -> V_62 , L_25 ,
...
V_101 = F_54 ( V_85 , V_62 , V_89 + V_102 ,
V_90 ) ;
if ( V_101 )
goto V_110;
}
...
F_70 ( & V_85 -> V_87 , & V_121 ) ;
F_31 (phb, &hose_list, list_node) {
