...
if ( ! V_66 )
return F_35 ( - V_120 ) ;
F_36 ( V_112 , L_6 , & V_66 -> V_96 ) ;
if ( F_37 ( V_112 , L_7 , NULL ) )
V_66 -> V_94 = true ;
V_66 -> V_65 = F_34 ( V_8 , sizeof( struct V_64 ) , V_119 ) ;
if ( ! V_66 -> V_65 )
return F_35 ( - V_120 ) ;
V_66 -> V_65 -> V_44 = F_38 ( V_112 , L_8 , 0 ) ;
F_36 ( V_112 , L_9 , ( T_1 * ) & V_66 -> V_65 -> V_67 ) ;
F_36 ( V_112 , L_10 , & V_118 ) ;
...
static int F_40 ( struct V_124 * V_125 , const struct V_126 * V_98 )
{
struct V_1 * V_2 ;
struct V_93 * V_66 ;
int V_5 ;
...
V_2 = F_34 ( & V_125 -> V_8 , sizeof( struct V_1 ) , V_119 ) ;
if ( ! V_2 )
return - V_120 ;
V_2 -> V_99 = V_127 [ V_98 -> V_108 ] ;
V_2 -> V_7 = F_42 ( V_125 , & V_130 ) ;
if ( F_31 ( V_2 -> V_7 ) ) {
V_5 = F_32 ( V_2 -> V_7 ) ;
