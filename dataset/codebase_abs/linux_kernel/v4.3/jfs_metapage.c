...
V_50 = F_76 ( V_18 , 1 ) ;
V_50 -> V_82 = V_39 -> V_47 -> V_83 ;
V_50 -> V_78 . V_84 = V_67 << ( V_39 -> V_22 - 9 ) ;
V_50 -> V_85 = F_65 ;
V_50 -> V_51 = V_10 ;
V_71 = V_12 ;
V_70 = V_41 << V_39 -> V_22 ;
...
static int F_79 ( struct V_90 * V_91 , struct V_10 * V_10 )
{
struct V_39 * V_39 = V_10 -> V_20 -> V_21 ;
struct V_50 * V_50 = NULL ;
int V_61 ;
...
void F_103 ( struct V_39 * V_112 , T_4 V_113 , int V_41 )
{
T_3 V_40 ;
int V_99 = V_73 - V_112 -> V_22 ;
int V_114 = 1 << V_99 ;
struct V_101 * V_20 =
F_67 ( V_112 -> V_47 ) -> V_104 -> V_105 ;
struct V_1 * V_2 ;
struct V_10 * V_10 ;
unsigned int V_12 ;
for ( V_40 = V_113 & ~ ( V_114 - 1 ) ; V_40 < V_113 + V_41 ;
V_40 += V_114 ) {
V_10 = F_104 ( V_20 , V_40 >> V_99 ) ;
if ( ! V_10 )
continue;
for ( V_12 = 0 ; V_12 < V_57 ; V_12 += V_58 ) {
V_2 = F_17 ( V_10 , V_12 ) ;
...
static int F_105 ( struct V_115 * V_116 , void * V_117 )
{
F_106 ( V_116 ,
L_22
L_23
...
static int F_107 ( struct V_39 * V_39 , struct V_90 * V_90 )
{
return F_108 ( V_90 , F_105 , NULL ) ;
}
