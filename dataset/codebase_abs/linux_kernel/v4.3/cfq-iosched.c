...
unsigned int V_143 = F_139 ( V_176 . V_177 . V_178 ) ?
V_179 : V_180 ;
if ( F_140 ( V_28 ) == & V_176 )
V_143 *= 2 ;
V_174 -> V_143 = V_143 ;
...
bool V_181 = F_139 ( V_176 . V_177 . V_178 ) ;
unsigned int V_143 = V_181 ? V_179 : V_180 ;
if ( V_32 == & V_176 )
V_143 *= 2 ;
F_122 ( F_144 ( & V_32 -> V_177 , V_143 , V_181 , true , false ) ) ;
F_122 ( F_144 ( & V_32 -> V_177 , V_143 , V_181 , true , true ) ) ;
}
...
{
unsigned int F_83 = V_181 ? V_196 : V_197 ;
unsigned int F_84 = V_181 ? V_198 : V_199 ;
...
static int F_144 ( struct V_208 * V_177 , T_2 V_190 ,
bool V_181 , bool V_209 , bool V_195 )
{
unsigned int F_83 = V_181 ? V_196 : V_197 ;
unsigned int F_84 = V_181 ? V_198 : V_199 ;
struct V_32 * V_32 = F_160 ( V_177 ) ;
struct V_29 * V_30 ;
struct V_26 * V_202 ;
int V_203 = 0 ;
...
static int F_177 ( struct V_208 * V_177 , struct V_212 * V_213 ,
T_2 V_190 )
{
return F_144 ( V_177 , V_190 , false , false , false ) ;
}
static int F_178 ( struct V_208 * V_177 ,
struct V_212 * V_213 , T_2 V_190 )
{
return F_144 ( V_177 , V_190 , false , false , true ) ;
}
...
goto V_355;
F_128 ( V_47 -> V_226 ) ;
V_47 -> V_226 -> V_143 = 2 * V_180 ;
V_47 -> V_226 -> V_145 = 2 * V_180 ;
#endif
