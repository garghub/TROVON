...
static int F_43 ( struct V_13 * V_7 ,
struct V_51 * V_52 )
{
struct V_58 * V_59 ;
struct V_36 * V_32 ;
...
int V_45 ;
enum V_65 V_66 ;
V_18 = F_45 ( V_7 , sizeof( struct V_17 ) ,
V_67 ) ;
if ( ! V_18 )
return - V_68 ;
V_45 = F_46 ( V_59 , L_7 , 0 , & V_66 ) ;
if ( V_45 < 0 )
return V_45 ;
V_18 -> V_20 = V_45 ;
V_18 -> V_21 = V_66 & V_69 ;
...
V_30 = F_45 ( V_7 , V_52 -> V_29 * sizeof( unsigned ) ,
V_67 ) ;
if ( ! V_30 )
return - V_68 ;
...
static int F_52 ( struct V_24 * V_6 )
{
int V_22 ;
struct V_3 * V_4 ;
struct V_51 * V_52 = F_53 ( & V_6 -> V_7 ) ;
V_4 = F_45 ( & V_6 -> V_7 , sizeof( struct V_3 ) ,
V_67 ) ;
if ( ! V_4 )
return - V_68 ;
#ifdef F_54
...
V_71 ) ;
if ( F_58 ( V_4 -> V_70 ) )
return F_59 ( V_4 -> V_70 ) ;
#ifdef F_54
V_4 -> V_54 = F_60 ( V_6 -> V_7 . V_64 ,
L_13 ,
V_4 ,
& V_72 ) ;
#else
V_4 -> V_54 = F_61 ( L_13 , V_4 ,
& V_72 ) ;
#endif
F_62 ( & V_6 -> V_7 , L_14 ) ;
return 0 ;
...
static void F_66 ( struct V_24 * V_6 )
{
F_63 ( V_6 ) ;
}
...
static int F_68 ( struct V_13 * V_7 )
{
struct V_3 * V_4 = F_8 ( V_7 ) ;
if ( V_4 -> V_30 )
F_20 ( V_4 , V_4 -> V_73 ) ;
