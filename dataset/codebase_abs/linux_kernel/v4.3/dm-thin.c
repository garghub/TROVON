...
{
const char * V_223 = F_142 ( V_43 -> V_76 ) ;
F_124 ( L_20 , V_223 ) ;
if ( F_234 ( V_43 -> V_120 ) ) {
F_230 ( L_21 , V_223 ) ;
F_137 ( V_43 , V_159 ) ;
...
static void F_105 ( struct V_43 * V_43 , const char * V_224 , int V_58 )
{
F_124 ( L_23 ,
F_142 ( V_43 -> V_76 ) , V_224 , V_58 ) ;
F_233 ( V_43 ) ;
F_137 ( V_43 , V_148 ) ;
}
...
static int F_239 ( struct V_225 * V_153 , struct V_28 * V_28 )
{
int V_58 ;
...
static int F_241 ( struct V_229 * V_230 , int V_231 )
{
struct V_214 * V_215 = F_208 ( V_230 , struct V_214 , V_232 ) ;
struct V_30 * V_31 ;
if ( F_135 ( V_215 -> V_43 ) == V_146 )
return 1 ;
V_31 = F_17 ( V_215 -> V_233 -> V_23 ) ;
return F_242 ( & V_31 -> V_234 , V_231 ) ;
}
...
{
struct V_30 * V_31 = F_17 ( V_215 -> V_233 -> V_23 ) ;
return V_31 && F_18 ( V_31 ) ;
}
static bool F_245 ( T_2 V_235 , T_6 V_236 )
{
return ! F_75 ( V_235 , V_236 ) ;
}
static void F_246 ( struct V_214 * V_215 )
{
struct V_43 * V_43 = V_215 -> V_43 ;
struct V_22 * V_237 = V_215 -> V_233 -> V_23 ;
struct V_238 * V_239 = & F_17 ( V_237 ) -> V_240 ;
...
if ( ! F_244 ( V_215 ) )
V_241 = L_24 ;
else if ( V_239 -> V_244 < V_43 -> V_45 )
V_241 = L_25 ;
if ( V_241 ) {
F_141 ( L_26 , F_247 ( V_237 , V_242 ) , V_241 ) ;
V_215 -> V_216 . V_217 = false ;
}
}
static int F_248 ( struct V_43 * V_43 , struct V_225 * V_153 )
{
...
static void F_249 ( struct V_43 * V_43 , struct V_225 * V_153 )
{
if ( V_43 -> V_153 == V_153 )
V_43 -> V_153 = NULL ;
}
static void F_250 ( struct V_245 * V_140 )
{
V_140 -> V_212 = V_147 ;
V_140 -> V_141 = true ;
V_140 -> V_246 = true ;
...
struct V_22 * V_247 ,
unsigned long V_235 ,
int V_248 , char * * error )
{
int V_58 ;
void * V_249 ;
struct V_43 * V_43 ;
struct V_250 * V_120 ;
bool V_251 = V_248 ? false : true ;
V_120 = F_261 ( V_247 , V_235 , V_251 ) ;
if ( F_262 ( V_120 ) ) {
* error = L_28 ;
return (struct V_43 * ) V_120 ;
}
V_43 = F_263 ( sizeof( * V_43 ) , V_252 ) ;
if ( ! V_43 ) {
* error = L_29 ;
V_249 = F_264 ( - V_38 ) ;
goto V_253;
...
V_43 -> V_54 = F_269 ( L_32 V_257 , V_258 ) ;
if ( ! V_43 -> V_54 ) {
* error = L_33 ;
V_249 = F_264 ( - V_38 ) ;
goto V_259;
...
struct V_22 * V_247 ,
unsigned long V_235 , int V_248 ,
char * * error , int * V_268 )
{
struct V_43 * V_43 = F_55 ( V_247 ) ;
if ( V_43 ) {
if ( V_43 -> V_76 != V_76 ) {
* error = L_38 ;
return F_264 ( - V_269 ) ;
...
V_43 = F_260 ( V_76 , V_247 , V_235 , V_248 , error ) ;
* V_268 = 1 ;
}
}
return V_43 ;
}
static void F_279 ( struct V_225 * V_153 )
{
struct V_214 * V_215 = V_153 -> V_218 ;
F_280 ( & V_69 . V_70 ) ;
F_249 ( V_215 -> V_43 , V_153 ) ;
F_277 ( V_215 -> V_43 ) ;
F_281 ( V_153 , V_215 -> V_247 ) ;
F_281 ( V_153 , V_215 -> V_233 ) ;
F_259 ( V_215 ) ;
F_282 ( & V_69 . V_70 ) ;
}
static int F_283 ( struct V_270 * V_271 , struct V_245 * V_140 ,
struct V_225 * V_153 )
{
int V_58 ;
unsigned V_272 ;
...
if ( ! V_271 -> V_272 )
return 0 ;
V_58 = F_284 ( V_275 , V_271 , & V_272 , & V_153 -> error ) ;
if ( V_58 )
return - V_149 ;
while ( V_272 && ! V_58 ) {
V_273 = F_285 ( V_271 ) ;
V_272 -- ;
if ( ! strcasecmp ( V_273 , L_41 ) )
V_140 -> V_141 = false ;
else if ( ! strcasecmp ( V_273 , L_42 ) )
V_140 -> V_246 = false ;
else if ( ! strcasecmp ( V_273 , L_43 ) )
V_140 -> V_217 = false ;
else if ( ! strcasecmp ( V_273 , L_44 ) )
V_140 -> V_212 = V_148 ;
else if ( ! strcasecmp ( V_273 , L_45 ) )
V_140 -> V_158 = true ;
else {
V_153 -> error = L_46 ;
V_58 = - V_149 ;
...
{
return F_288 ( V_23 -> V_276 ) >> V_88 ;
}
static void F_289 ( struct V_22 * V_23 )
{
T_2 V_277 = F_287 ( V_23 ) ;
char V_278 [ V_243 ] ;
if ( V_277 > V_279 )
F_141 ( L_48 ,
F_247 ( V_23 , V_278 ) , V_280 ) ;
}
...
{
T_2 V_277 = F_290 ( V_23 ) ;
F_75 ( V_277 , V_281 ) ;
return V_277 ;
}
static T_1 F_292 ( struct V_214 * V_215 )
{
T_1 V_282 = F_291 ( V_215 -> V_247 -> V_23 ) / 4 ;
return F_293 ( ( T_1 ) 1024ULL , V_282 ) ;
}
static int F_294 ( struct V_225 * V_153 , unsigned V_272 , char * * V_283 )
{
int V_58 , V_284 = 0 ;
struct V_214 * V_215 ;
struct V_43 * V_43 ;
...
F_250 ( & V_140 ) ;
F_295 ( & V_271 , 4 ) ;
V_58 = F_283 ( & V_271 , & V_140 , V_153 ) ;
if ( V_58 )
goto V_286;
V_285 = V_287 | ( ( V_140 . V_212 == V_148 ) ? 0 : V_288 ) ;
V_58 = F_296 ( V_153 , V_283 [ 0 ] , V_285 , & V_247 ) ;
if ( V_58 ) {
V_153 -> error = L_50 ;
goto V_286;
}
F_289 ( V_247 -> V_23 ) ;
V_58 = F_296 ( V_153 , V_283 [ 1 ] , V_287 | V_288 , & V_233 ) ;
if ( V_58 ) {
V_153 -> error = L_51 ;
goto V_289;
}
if ( F_297 ( V_283 [ 2 ] , 10 , & V_235 ) || ! V_235 ||
V_235 < V_290 ||
V_235 > V_291 ||
V_235 & ( V_290 - 1 ) ) {
V_153 -> error = L_52 ;
...
if ( F_298 ( V_283 [ 3 ] , 10 , ( unsigned long long * ) & V_151 ) ) {
V_153 -> error = L_53 ;
V_58 = - V_149 ;
goto V_114;
}
V_215 = F_299 ( sizeof( * V_215 ) , V_252 ) ;
if ( ! V_215 ) {
V_58 = - V_38 ;
goto V_114;
}
V_43 = F_278 ( F_300 ( V_153 -> V_154 ) , V_247 -> V_23 ,
V_235 , V_140 . V_212 == V_148 , & V_153 -> error , & V_284 ) ;
if ( F_262 ( V_43 ) ) {
V_58 = F_268 ( V_43 ) ;
goto V_292;
}
if ( ! V_284 && V_140 . V_246 != V_43 -> V_140 . V_246 ) {
V_153 -> error = L_54 ;
V_58 = - V_149 ;
goto V_293;
}
...
V_215 -> V_233 = V_233 ;
V_215 -> V_151 = V_151 ;
V_215 -> V_216 = V_215 -> V_294 = V_140 ;
V_153 -> V_295 = 1 ;
V_153 -> V_296 = true ;
if ( V_140 . V_246 && V_140 . V_217 ) {
V_153 -> V_297 = 1 ;
V_153 -> V_298 = true ;
}
V_153 -> V_218 = V_215 ;
...
if ( V_58 )
goto V_293;
V_215 -> V_232 . V_299 = F_241 ;
F_302 ( V_153 -> V_154 , & V_215 -> V_232 ) ;
F_282 ( & V_69 . V_70 ) ;
return 0 ;
V_293:
F_277 ( V_43 ) ;
...
static int F_303 ( struct V_225 * V_153 , struct V_28 * V_28 )
{
int V_58 ;
struct V_214 * V_215 = V_153 -> V_218 ;
struct V_43 * V_43 = V_215 -> V_43 ;
unsigned long V_27 ;
F_63 ( & V_43 -> V_17 , V_27 ) ;
V_28 -> V_41 = V_215 -> V_233 -> V_23 ;
V_58 = V_227 ;
F_64 ( & V_43 -> V_17 , V_27 ) ;
return V_58 ;
}
static int F_304 ( struct V_225 * V_153 , bool * V_300 )
{
int V_58 ;
struct V_214 * V_215 = V_153 -> V_218 ;
struct V_43 * V_43 = V_215 -> V_43 ;
...
static int F_307 ( struct V_225 * V_153 , bool * V_300 )
{
int V_58 ;
struct V_214 * V_215 = V_153 -> V_218 ;
struct V_43 * V_43 = V_215 -> V_43 ;
...
static int F_310 ( struct V_225 * V_153 )
{
int V_58 ;
bool V_304 , V_305 ;
struct V_214 * V_215 = V_153 -> V_218 ;
...
static void F_315 ( struct V_225 * V_153 )
{
struct V_214 * V_215 = V_153 -> V_218 ;
struct V_43 * V_43 = V_215 -> V_43 ;
unsigned long V_27 ;
...
static void F_316 ( struct V_225 * V_153 )
{
struct V_214 * V_215 = V_153 -> V_218 ;
struct V_43 * V_43 = V_215 -> V_43 ;
unsigned long V_27 ;
...
static void F_317 ( struct V_225 * V_153 )
{
struct V_214 * V_215 = V_153 -> V_218 ;
struct V_43 * V_43 = V_215 -> V_43 ;
unsigned long V_27 ;
...
static void F_318 ( struct V_225 * V_153 )
{
struct V_214 * V_215 = V_153 -> V_218 ;
struct V_43 * V_43 = V_215 -> V_43 ;
F_319 ( & V_43 -> V_206 ) ;
...
static int F_321 ( unsigned V_272 , unsigned V_308 )
{
if ( V_272 != V_308 ) {
F_141 ( L_65 ,
V_272 , V_308 ) ;
...
static int F_323 ( unsigned V_272 , char * * V_283 , struct V_43 * V_43 )
{
T_8 V_310 ;
int V_58 ;
V_58 = F_321 ( V_272 , 2 ) ;
...
static int F_325 ( unsigned V_272 , char * * V_283 , struct V_43 * V_43 )
{
T_8 V_310 ;
T_8 V_313 ;
int V_58 ;
...
static int F_327 ( unsigned V_272 , char * * V_283 , struct V_43 * V_43 )
{
T_8 V_310 ;
int V_58 ;
V_58 = F_321 ( V_272 , 2 ) ;
...
static int F_329 ( unsigned V_272 , char * * V_283 , struct V_43 * V_43 )
{
T_8 V_314 , V_315 ;
int V_58 ;
V_58 = F_321 ( V_272 , 3 ) ;
if ( V_58 )
return V_58 ;
if ( F_298 ( V_283 [ 1 ] , 10 , ( unsigned long long * ) & V_314 ) ) {
F_141 ( L_70 , V_283 [ 1 ] ) ;
return - V_149 ;
}
if ( F_298 ( V_283 [ 2 ] , 10 , ( unsigned long long * ) & V_315 ) ) {
F_141 ( L_71 , V_283 [ 2 ] ) ;
return - V_149 ;
}
...
static int F_331 ( unsigned V_272 , char * * V_283 , struct V_43 * V_43 )
{
int V_58 ;
V_58 = F_321 ( V_272 , 1 ) ;
if ( V_58 )
...
static int F_333 ( unsigned V_272 , char * * V_283 , struct V_43 * V_43 )
{
int V_58 ;
V_58 = F_321 ( V_272 , 1 ) ;
if ( V_58 )
...
static int F_335 ( struct V_225 * V_153 , unsigned V_272 , char * * V_283 )
{
int V_58 = - V_149 ;
struct V_214 * V_215 = V_153 -> V_218 ;
struct V_43 * V_43 = V_215 -> V_43 ;
...
if ( ! strcasecmp ( V_283 [ 0 ] , L_76 ) )
V_58 = F_323 ( V_272 , V_283 , V_43 ) ;
else if ( ! strcasecmp ( V_283 [ 0 ] , L_77 ) )
V_58 = F_325 ( V_272 , V_283 , V_43 ) ;
else if ( ! strcasecmp ( V_283 [ 0 ] , L_78 ) )
V_58 = F_327 ( V_272 , V_283 , V_43 ) ;
else if ( ! strcasecmp ( V_283 [ 0 ] , L_79 ) )
V_58 = F_329 ( V_272 , V_283 , V_43 ) ;
else if ( ! strcasecmp ( V_283 [ 0 ] , L_80 ) )
V_58 = F_331 ( V_272 , V_283 , V_43 ) ;
else if ( ! strcasecmp ( V_283 [ 0 ] , L_81 ) )
V_58 = F_333 ( V_272 , V_283 , V_43 ) ;
else
F_141 ( L_82 , V_283 [ 0 ] ) ;
if ( ! V_58 )
( void ) F_138 ( V_43 ) ;
...
static void F_336 ( struct V_245 * V_140 , char * V_155 ,
unsigned V_316 , unsigned V_317 )
{
unsigned V_130 = ! V_140 -> V_141 + ! V_140 -> V_246 +
...
static void F_338 ( struct V_225 * V_153 , T_9 type ,
...
case V_328 :
F_337 ( L_105 ,
F_343 ( V_242 , V_215 -> V_247 -> V_23 -> V_329 ) ,
F_343 ( V_325 , V_215 -> V_233 -> V_23 -> V_329 ) ,
( unsigned long ) V_43 -> V_45 ,
( unsigned long long ) V_215 -> V_151 ) ;
F_336 ( & V_215 -> V_294 , V_155 , V_316 , V_317 ) ;
break;
}
return;
V_105:
...
static int F_344 ( struct V_225 * V_153 ,
T_11 F_35 , void * V_330 )
{
struct V_214 * V_215 = V_153 -> V_218 ;
return F_35 ( V_153 , V_215 -> V_233 , 0 , V_153 -> V_51 , V_330 ) ;
}
static void F_345 ( struct V_225 * V_153 , struct V_238 * V_240 )
{
struct V_214 * V_215 = V_153 -> V_218 ;
struct V_43 * V_43 = V_215 -> V_43 ;
T_2 V_331 = V_240 -> V_332 >> V_88 ;
if ( V_240 -> V_333 < V_43 -> V_45 ) {
while ( ! F_245 ( V_43 -> V_45 , V_240 -> V_333 ) ) {
if ( ( V_240 -> V_333 & ( V_240 -> V_333 - 1 ) ) == 0 )
V_240 -> V_333 -- ;
V_240 -> V_333 = F_346 ( V_240 -> V_333 ) ;
}
}
if ( V_331 < V_43 -> V_45 ||
! F_245 ( V_331 , V_43 -> V_45 ) ) {
if ( F_245 ( V_43 -> V_45 , V_240 -> V_333 ) )
F_347 ( V_240 , V_240 -> V_333 << V_88 ) ;
else
F_347 ( V_240 , V_43 -> V_45 << V_88 ) ;
F_348 ( V_240 , V_43 -> V_45 << V_88 ) ;
}
if ( ! V_215 -> V_216 . V_246 ) {
V_240 -> V_334 = 0 ;
return;
}
F_246 ( V_215 ) ;
...
static void F_349 ( struct V_225 * V_153 )
{
struct V_46 * V_47 = V_153 -> V_218 ;
unsigned long V_27 ;
...
static int F_353 ( struct V_225 * V_153 , unsigned V_272 , char * * V_283 )
{
int V_58 ;
struct V_46 * V_47 ;
...
V_47 = V_153 -> V_218 = F_299 ( sizeof( * V_47 ) , V_252 ) ;
if ( ! V_47 ) {
V_153 -> error = L_107 ;
V_58 = - V_38 ;
goto V_286;
...
V_47 -> V_184 = V_337 ;
if ( V_272 == 3 ) {
V_58 = F_296 ( V_153 , V_283 [ 2 ] , V_287 , & V_90 ) ;
if ( V_58 ) {
V_153 -> error = L_108 ;
goto V_338;
}
...
V_58 = F_296 ( V_153 , V_283 [ 0 ] , F_354 ( V_153 -> V_154 ) , & V_52 ) ;
if ( V_58 ) {
V_153 -> error = L_109 ;
goto V_339;
}
V_47 -> V_52 = V_52 ;
if ( F_322 ( V_283 [ 1 ] , ( unsigned long long * ) & V_47 -> V_310 , 0 ) ) {
V_153 -> error = L_110 ;
V_58 = - V_149 ;
goto V_340;
}
...
static int F_360 ( struct V_225 * V_153 , struct V_28 * V_28 )
{
V_28 -> V_39 . V_40 = F_361 ( V_153 , V_28 -> V_39 . V_40 ) ;
return F_239 ( V_153 , V_28 ) ;
}
static int F_362 ( struct V_225 * V_153 , struct V_28 * V_28 , int V_105 )
{
unsigned long V_27 ;
struct V_94 * V_95 = F_82 ( V_28 , sizeof( struct V_94 ) ) ;
struct V_80 V_307 ;
...
static void F_364 ( struct V_225 * V_153 )
{
struct V_46 * V_47 = V_153 -> V_218 ;
if ( F_365 ( V_153 ) )
V_210 ( V_47 , F_222 ) ;
}
static void F_366 ( struct V_225 * V_153 )
{
struct V_46 * V_47 = V_153 -> V_218 ;
V_210 ( V_47 , F_223 ) ;
}
static int F_367 ( struct V_225 * V_153 )
{
struct V_46 * V_47 = V_153 -> V_218 ;
if ( V_47 -> V_90 )
...
static void F_368 ( struct V_225 * V_153 , T_9 type ,
unsigned V_318 , char * V_155 , unsigned V_317 )
{
int V_58 ;
T_12 V_316 = 0 ;
...
case V_328 :
F_337 ( L_120 ,
F_343 ( V_242 , V_47 -> V_52 -> V_23 -> V_329 ) ,
( unsigned long ) V_47 -> V_310 ) ;
if ( V_47 -> V_90 )
F_337 ( L_121 , F_343 ( V_242 , V_47 -> V_90 -> V_23 -> V_329 ) ) ;
break;
}
}
return;
...
static int F_371 ( struct V_225 * V_153 ,
T_11 F_35 , void * V_330 )
{
T_2 V_348 ;
struct V_46 * V_47 = V_153 -> V_218 ;
...
static void F_372 ( struct V_225 * V_153 , struct V_238 * V_240 )
{
struct V_46 * V_47 = V_153 -> V_218 ;
struct V_43 * V_43 = V_47 -> V_43 ;
struct V_238 * V_349 = F_373 ( V_43 -> V_76 ) ;
if ( ! V_349 -> V_334 )
return;
V_240 -> V_334 = V_43 -> V_45 << V_88 ;
V_240 -> V_244 = 2048 * 1024 * 16 ;
}
