...
static bool F_12 ( struct V_43 * V_44 , struct V_43 * V_45 )
{
...
V_7 -> V_51 . V_46 == 0 )
return 0 ;
return V_7 -> V_13 == V_5 -> V_13 &&
F_12 ( & V_7 -> V_49 , & V_5 -> V_49 ) &&
F_12 ( & V_7 -> V_51 , & V_5 -> V_51 ) &&
F_12 ( & V_7 -> V_50 , & V_5 -> V_50 ) &&
F_12 ( & V_7 -> V_52 , & V_5 -> V_52 ) ;
}
...
int V_57 ;
if ( V_7 -> V_53 ) {
for ( V_57 = 0 ; V_57 < F_16 ( V_58 ) ; ++ V_57 ) {
struct V_48 * V_59 = & V_58 [ V_57 ] ;
if ( V_7 -> V_53 == V_59 -> V_53 ) {
F_14 ( V_7 , V_59 ) ;
* V_55 = V_59 -> V_56 ;
return 0 ;
}
...
static int F_58 ( struct V_1 * V_2 , T_5 V_181 , T_5 V_49 , T_5 V_51 ,
T_5 V_50 , T_5 V_52 , int V_182 )
{
struct V_6 * V_7 = & V_2 -> V_7 ;
int V_16 = 0 ;
...
if ( V_181 < 16 ) {
T_4 V_193 ;
V_193 = ( ( V_49 >> ( 16 - V_7 -> V_49 . V_46 ) ) <<
V_7 -> V_49 . V_31 ) |
( ( V_51 >> ( 16 - V_7 -> V_51 . V_46 ) ) <<
V_7 -> V_51 . V_31 ) |
( V_50 >> ( 16 - V_7 -> V_50 . V_46 ) ) ;
...
static int F_59 ( T_5 V_181 , T_5 V_49 , T_5 V_51 , T_5 V_50 ,
T_5 V_52 , struct V_1 * V_151 )
{
F_6 ( L_25 ) ;
return F_58 ( V_151 , V_181 , V_49 , V_51 , V_50 , V_52 , 1 ) ;
}
static int F_60 ( struct V_195 * V_196 , struct V_1 * V_151 )
{
int V_197 , V_198 , V_16 ;
T_2 * V_49 , * V_51 , * V_50 , * V_52 ;
T_2 V_199 = 0xffff ;
F_6 ( L_26 ) ;
V_49 = V_196 -> V_49 ;
V_51 = V_196 -> V_51 ;
...
if ( V_52 )
V_199 = * V_52 ++ ;
V_16 = F_58 ( V_151 , V_198 ++ , * V_49 ++ , * V_51 ++ , * V_50 ++ , V_199 ,
V_197 == V_196 -> V_175 - 1 ) ;
if ( V_16 != 0 )
return V_16 ;
}
...
for ( V_57 = 0 ; V_57 < V_202 -> V_269 ; V_57 ++ ) {
struct V_101 * V_252 = V_202 -> V_270 [ V_57 ] . V_252 ;
if ( V_202 -> V_270 [ V_57 ] . V_212 )
F_65 ( V_202 , V_252 ) ;
if ( V_252 -> V_206 != V_271 )
V_252 -> V_109 -> V_217 ( V_252 ) ;
V_252 -> V_109 -> V_272 ( V_252 ) ;
F_104 ( V_252 ) ;
}
if ( V_202 -> V_259 != NULL ) {
F_105 ( V_202 -> V_259 ) ;
...
V_27 -> V_202 = V_202 ;
V_27 -> V_103 = V_57 ;
V_27 -> V_30 = & V_202 -> V_274 [ V_57 ] ;
V_27 -> V_30 -> V_103 = V_57 ;
F_110 ( & V_27 -> V_30 -> V_275 ) ;
V_27 -> V_39 = V_276 ? V_40 :
V_277 ;
V_27 -> V_153 = V_278 ;
V_202 -> V_224 ++ ;
}
...
static int F_113 ( const char * V_279 ,
struct V_101 * V_102 ,
struct V_115 * V_116 , T_3 * V_280 )
{
struct V_1 * V_2 ;
struct V_6 * V_7 ;
struct V_281 * V_263 ;
int V_16 ;
#ifdef F_114
if ( strcmp ( V_279 , L_58 ) == 0 ) {
* V_116 = V_282 ;
* V_280 = 24 ;
return 0 ;
} else if ( strcmp ( V_279 , L_59 ) == 0 ) {
* V_116 = V_283 ;
* V_280 = 24 ;
return 0 ;
}
...
V_2 -> V_263 = V_263 ;
V_16 = F_116 ( V_7 , V_2 , V_279 , NULL , 0 , NULL , 24 ) ;
if ( V_16 == 0 ) {
V_16 = - V_60 ;
goto V_154;
}
...
V_116 -> V_118 = F_117 ( V_7 -> V_117 ) * 1000 ;
...
V_116 -> V_289 = V_7 -> V_75 ;
V_116 -> V_290 = V_7 -> V_76 ;
...
struct V_101 * V_102 , char * V_279 )
{
int V_16 ;
T_3 V_280 ;
struct V_115 V_116 , V_292 ;
struct V_203 * V_204 ;
V_16 = F_113 ( V_279 , V_102 , & V_116 , & V_280 ) ;
if ( V_16 )
return V_16 ;
V_204 = F_63 ( V_202 , V_102 ) ;
V_204 -> V_293 = V_280 ;
...
if ( V_292 . V_289 != V_116 . V_289 ||
V_292 . V_290 != V_116 . V_290 )
return - V_60 ;
}
}
...
{
struct V_203 * V_204 ;
F_120 ( V_252 -> V_109 -> V_296 == NULL ) ;
V_204 = F_63 ( V_202 , V_252 ) ;
if ( V_204 -> V_293 != 0 )
return V_204 -> V_293 ;
return V_252 -> V_109 -> V_296 ( V_252 ) ;
}
static int F_121 ( struct V_201 * V_202 )
{
char * V_297 , * V_298 , * V_299 ;
int V_16 = 0 ;
V_297 = F_122 ( V_300 , V_229 ) ;
if ( ! V_297 )
return - V_230 ;
V_298 = V_297 ;
while ( ! V_16 && ( V_299 = F_123 ( & V_298 , L_60 ) ) != NULL ) {
char * V_19 , * V_301 , * V_279 ;
struct V_101 * V_102 ;
int V_57 ;
V_19 = strchr ( V_299 , ':' ) ;
if ( ! V_19 ) {
...
V_102 = NULL ;
for ( V_57 = 0 ; V_57 < V_202 -> V_269 ; ++ V_57 ) {
if ( strcmp ( V_202 -> V_270 [ V_57 ] . V_252 -> V_302 ,
V_301 ) == 0 ) {
V_102 = V_202 -> V_270 [ V_57 ] . V_252 ;
break;
}
}
if ( ! V_102 ) {
...
static void F_124 ( struct V_303 * V_59 ,
struct V_101 * V_102 ,
struct V_115 * V_24 )
{
if ( V_102 -> V_109 -> V_114 ) {
...
V_24 -> V_289 = V_59 -> V_75 ;
V_24 -> V_290 = V_59 -> V_76 ;
V_24 -> V_118 = F_117 ( V_59 -> V_117 ) * 1000 ;
...
struct V_304 * V_305 ;
T_3 * V_306 ;
int V_16 , V_57 , V_307 , V_175 ;
if ( ! V_102 -> V_109 -> V_308 )
return - V_309 ;
V_175 = 0x80 * 2 ;
V_306 = F_126 ( V_175 , V_229 ) ;
if ( V_306 == NULL )
return - V_230 ;
V_16 = V_102 -> V_109 -> V_308 ( V_102 , V_306 , V_175 ) ;
if ( V_16 < 0 )
goto V_310;
V_305 = F_115 ( sizeof( * V_305 ) , V_229 ) ;
if ( V_305 == NULL ) {
V_16 = - V_230 ;
goto V_310;
}
F_127 ( V_306 , V_305 ) ;
V_307 = - 1 ;
for ( V_57 = 0 ; V_57 < V_305 -> V_311 ; ++ V_57 ) {
struct V_303 * V_59 ;
struct V_115 V_24 ;
V_59 = & V_305 -> V_312 [ V_57 ] ;
if ( V_59 -> V_117 == 0 )
continue;
...
if ( V_145 -> V_164 )
V_145 -> V_268 ( V_145 ) ;
V_16 = V_145 -> V_322 ( V_145 , V_320 ) ;
if ( V_16 )
F_130 ( V_202 -> V_219 ,
L_66 ,
V_145 -> V_302 , V_320 -> V_302 ) ;
}
return 0 ;
}
static struct V_101 *
F_133 ( struct V_201 * V_202 )
{
const char * V_323 ;
int V_57 ;
V_323 = F_134 () ;
...
for ( V_57 = 0 ; V_57 < V_202 -> V_269 ; ++ V_57 ) {
struct V_101 * V_252 ;
V_252 = V_202 -> V_270 [ V_57 ] . V_252 ;
if ( V_252 -> V_302 && strcmp ( V_323 , V_252 -> V_302 ) == 0 )
return V_252 ;
if ( strcmp ( V_323 , V_252 -> V_324 ) == 0 )
return V_252 ;
}
return NULL ;
}
...
int V_103 ;
V_252 = V_202 -> V_270 [ V_57 ] . V_252 ;
if ( V_252 -> V_219 -> V_325 == NULL )
continue;
V_103 = F_135 ( V_252 -> V_219 -> V_325 , L_67 ) ;
if ( V_103 == 0 )
return V_252 ;
}
return V_202 -> V_270 [ 0 ] . V_252 ;
}
...
return - V_329 ;
if ( V_327 -> V_330 != 0 ) {
F_78 ( & V_327 -> V_219 , L_69 ) ;
V_16 = - V_309 ;
goto V_331;
}
V_202 = F_138 ( & V_327 -> V_219 , sizeof( struct V_201 ) ,
V_229 ) ;
if ( V_202 == NULL ) {
V_16 = - V_230 ;
goto V_331;
...
F_144 ( V_252 ) ;
if ( ! V_252 -> V_109 ) {
F_130 ( & V_327 -> V_219 , L_72 ,
V_252 -> V_302 ) ;
F_104 ( V_252 ) ;
continue;
}
V_204 = & V_202 -> V_270 [ V_202 -> V_269 ++ ] ;
V_204 -> V_252 = V_252 ;
if ( V_252 -> V_166 & V_209 )
V_204 -> V_210 = V_316 ;
else
...
if ( V_202 -> V_269 == 0 ) {
F_78 ( & V_327 -> V_219 , L_73 ) ;
V_16 = - V_329 ;
goto V_333;
}
V_202 -> V_105 = F_145 () ;
for ( V_57 = 0 ; V_57 < V_202 -> V_105 ; V_57 ++ )
V_202 -> V_106 [ V_57 ] = F_146 ( V_57 ) ;
V_202 -> V_334 = F_147 () ;
for ( V_57 = 0 ; V_57 < V_202 -> V_334 ; V_57 ++ )
V_202 -> V_335 [ V_57 ] = F_148 ( V_57 ) ;
V_328 = F_133 ( V_202 ) ;
if ( V_328 == NULL ) {
...
if ( V_16 ) {
F_78 ( V_202 -> V_219 , L_75 ) ;
goto V_333;
}
if ( V_300 && strlen ( V_300 ) > 0 ) {
if ( F_121 ( V_202 ) )
F_130 ( & V_327 -> V_219 , L_76 ) ;
} else if ( V_328 && V_328 -> V_109 -> V_295 &&
V_328 -> V_109 -> V_294 ) {
struct V_115 V_24 ;
V_16 = F_125 ( V_328 , & V_24 ) ;
if ( V_16 == 0 )
V_328 -> V_109 -> V_295 ( V_328 , & V_24 ) ;
}
V_16 = F_108 ( V_202 ) ;
if ( V_16 )
goto V_333;
for ( V_57 = 0 ; V_57 < V_202 -> V_334 ; V_57 ++ ) {
struct V_319 * V_320 ;
V_320 = V_202 -> V_335 [ V_57 ] ;
V_16 = V_320 -> V_165 ( V_320 ) ;
if ( V_16 )
F_130 ( V_202 -> V_219 , L_77 ) ;
}
F_6 ( L_78 ) ;
if ( V_328 ) {
...
V_16 = F_149 ( V_202 ) ;
if ( V_16 ) {
F_78 ( V_202 -> V_219 , L_82 ) ;
goto V_333;
}
if ( V_328 ) {
T_2 V_20 , V_22 ;
V_328 -> V_109 -> V_231 ( V_328 , & V_20 , & V_22 ) ;
F_150 ( V_202 -> V_219 , L_83 ,
V_328 -> V_302 , V_20 , V_22 ) ;
}
return 0 ;
V_333:
F_101 ( V_202 ) ;
F_151 () ;
V_331:
F_78 ( & V_327 -> V_219 , L_84 ) ;
return V_16 ;
}
static int F_152 ( struct V_326 * V_327 )
{
struct V_201 * V_202 = F_153 ( V_327 ) ;
F_154 ( V_202 ) ;
F_101 ( V_202 ) ;
F_151 () ;
return 0 ;
