...
const struct V_56 * V_30 = & V_2 -> V_30 ;
const struct V_43 * V_44 = V_30 -> V_44 ;
static const char * V_75 [ 2 ] = { L_8 , L_6 } ;
static const char * V_76 [ 4 ] = {
L_9 , L_10 ,
L_11 , L_12
} ;
...
static const char * V_78 [ 2 ] = { L_5 , L_7 } ;
if ( ! V_44 && V_30 -> V_57 -> V_44 )
V_44 = V_30 -> V_57 -> V_44 ;
if ( V_44 ) {
F_18 ( V_2 , V_44 ,
...
static int
F_27 ( struct V_1 * V_2 , int V_98 , int V_99 ,
int V_3 )
{
return - 1 ;
}
static void
F_28 ( struct V_1 * V_2 , int V_98 , int V_99 ,
int V_3 , T_1 V_4 )
{
}
...
{
const struct V_11 * type = V_2 -> V_12 -> V_13 ;
const struct V_43 * V_100 = V_2 -> V_30 . V_44 ;
struct V_35 * V_36 ;
struct V_101 * V_101 ;
int V_31 ;
V_36 = F_30 ( & V_2 -> V_30 , sizeof( * V_36 ) , V_102 ) ;
if ( ! V_36 )
return - V_103 ;
V_2 -> V_36 = V_36 ;
V_36 -> type = type ;
if ( type -> V_42 ) {
V_31 = F_14 ( V_100 , L_17 ,
& V_36 -> V_41 ) ;
if ( V_31 )
V_36 -> V_41 = - 1 ;
if ( V_36 -> V_41 > 3 ) {
...
V_101 = F_31 ( & V_2 -> V_30 , L_19 ) ;
if ( ! F_32 ( V_101 ) ) {
unsigned long V_104 = F_33 ( V_101 ) ;
bool V_105 ;
V_36 -> V_39 = type -> V_106 ;
V_105 = F_34 ( V_100 ,
L_20 ) ;
if ( V_104 > 24500000 && V_104 < 25500000 ) {
V_36 -> V_40 = V_105 ;
} else if ( V_104 > 49500000 && V_104 < 50500000 ) {
V_36 -> V_40 = ! V_105 ;
} else {
F_9 ( & V_2 -> V_30 , L_21 , V_104 ) ;
return - V_28 ;
}
}
if ( V_2 -> V_107 & V_108 ) {
