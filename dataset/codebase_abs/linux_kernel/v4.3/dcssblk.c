...
static long
F_74 ( struct V_81 * V_82 , T_4 V_110 ,
void T_5 * * V_111 , unsigned long * V_112 )
{
struct V_3 * V_4 ;
...
V_113 = V_110 * 512 ;
V_115 = ( void * ) ( V_4 -> V_23 + V_113 ) ;
* V_112 = F_75 ( V_115 ) >> V_116 ;
* V_111 = ( void T_5 * ) V_115 ;
return V_114 - V_113 ;
}
static void
F_76 ( void )
