...
int
F_12 ( T_2 V_38 , struct V_39 * V_40 )
{
struct V_29 * V_30 ;
F_13 (expr, &expr_list->el_exprs, re_link) {
...
int
F_14 ( struct V_39 * V_40 , int V_25 , T_2 * * V_41 )
{
struct V_29 * V_30 ;
T_2 * V_42 ;
int V_43 = 0 ;
...
{
while ( ! F_17 ( & V_40 -> V_44 ) ) {
struct V_29 * V_30 ;
V_30 = F_18 ( V_40 -> V_44 . V_17 ,
struct V_29 , V_45 ) ;
F_19 ( & V_30 -> V_45 ) ;
F_11 ( V_30 , sizeof( * V_30 ) ) ;
}
F_11 ( V_40 , sizeof( * V_40 ) ) ;
}
int
F_20 ( char * V_1 , int V_10 , unsigned V_24 , unsigned V_25 ,
struct V_39 * * V_46 )
{
struct V_39 * V_40 ;
struct V_29 * V_30 ;
...
V_47 = F_9 ( & V_32 , V_24 , V_25 , 1 , & V_30 ) ;
if ( V_47 != 0 )
break;
F_22 ( & V_30 -> V_45 ,
& V_40 -> V_44 ) ;
...
V_47 = F_9 ( & V_27 , V_24 , V_25 , 0 , & V_30 ) ;
if ( V_47 == 0 ) {
F_22 ( & V_30 -> V_45 ,
& V_40 -> V_44 ) ;
}
...
int
F_24 ( char * V_1 , int V_10 , struct V_48 * V_49 )
{
struct V_39 * V_50 ;
struct V_16 V_27 ;
int V_47 ;
...
V_47 = F_20 ( V_19 . V_20 , V_19 . V_21 , 0 , 255 , & V_50 ) ;
if ( V_47 != 0 )
goto V_15;
F_22 ( & V_50 -> V_51 , V_49 ) ;
V_9 ++ ;
...
int
F_25 ( T_2 V_52 , struct V_48 * V_49 )
{
struct V_39 * V_50 ;
int V_9 = 0 ;
F_26 (el, list, el_link) {
if ( ! F_12 ( V_52 & 0xff , V_50 ) )
return 0 ;
V_52 >>= 8 ;
V_9 ++ ;
}
