...
if ( ! V_21 -> V_195 )
return - V_62 ;
V_132 = F_49 ( V_21 -> V_195 , & V_196 ,
V_140 . V_197 , L_71 , V_81 ) ;
if ( V_132 < 0 )
return V_132 ;
V_21 -> V_194 = F_50 ( L_72 , V_21 -> V_195 ) ;
if ( ! V_21 -> V_194 )
return - V_62 ;
V_21 -> V_193 = F_50 ( L_73 , V_21 -> V_195 ) ;
if ( ! V_21 -> V_193 )
return - V_62 ;
V_21 -> V_192 = F_50 ( L_74 , V_21 -> V_195 ) ;
if ( ! V_21 -> V_192 )
return - V_62 ;
...
F_51 ( & V_21 -> V_164 ) ;
V_132 = F_52 ( V_21 -> V_195 , & V_21 -> V_174 ) ;
if ( V_132 < 0 )
return V_132 ;
V_132 = F_52 ( V_21 -> V_195 , & V_21 -> V_175 ) ;
if ( V_132 < 0 )
return V_132 ;
V_132 = F_52 ( V_21 -> V_195 , & V_21 -> V_164 ) ;
if ( V_132 < 0 )
return V_132 ;
V_52 = 0 ;
F_3 (mem, &dev->mem_props, list) {
V_58 -> V_159 = F_53 ( sizeof( struct V_158 ) , V_200 ) ;
if ( ! V_58 -> V_159 )
return - V_62 ;
V_132 = F_49 ( V_58 -> V_159 , & V_201 ,
...
V_52 = 0 ;
F_3 (cache, &dev->cache_props, list) {
V_79 -> V_159 = F_53 ( sizeof( struct V_158 ) , V_200 ) ;
if ( ! V_79 -> V_159 )
return - V_62 ;
...
V_52 = 0 ;
F_3 (iolink, &dev->io_link_props, list) {
V_104 -> V_159 = F_53 ( sizeof( struct V_158 ) , V_200 ) ;
if ( ! V_104 -> V_159 )
return - V_62 ;
...
if ( ! V_140 . V_202 )
return - V_62 ;
V_132 = F_49 ( V_140 . V_202 ,
& V_203 , & V_204 -> V_159 ,
L_77 ) ;
if ( V_132 < 0 )
return V_132 ;
V_140 . V_197 = F_50 ( L_78 ,
V_140 . V_202 ) ;
if ( ! V_140 . V_197 )
return - V_62 ;
...
if ( ! V_7 )
return 0 ;
V_207 [ 0 ] = V_7 -> V_9 -> V_208 ;
V_207 [ 1 ] = V_7 -> V_9 -> V_209 ;
V_207 [ 2 ] = V_7 -> V_9 -> V_210 ;
V_207 [ 3 ] = V_7 -> V_9 -> V_5 ;
V_207 [ 4 ] = V_7 -> V_9 -> V_211 -> V_212 ;
V_207 [ 5 ] = ( T_1 ) ( V_7 -> V_187 -> V_213 ( V_7 -> V_189 )
& 0xffffffff ) ;
V_207 [ 6 ] = ( T_1 ) ( V_7 -> V_187 -> V_213 ( V_7 -> V_189 ) >> 32 ) ;
for ( V_52 = 0 , V_206 = 0 ; V_52 < 7 ; V_52 ++ )
V_206 ^= F_66 ( V_207 [ V_52 ] , V_214 ) ;
return V_206 ;
}
...
V_21 -> V_24 . V_181 = ( V_7 -> V_9 -> V_211 -> V_212 << 24 ) +
( V_7 -> V_9 -> V_208 & 0xffffff ) ;
if ( V_21 -> V_7 -> V_182 -> V_219 == V_220 ) {
V_21 -> V_24 . V_31 |= V_221 ;
F_14 ( L_94 ) ;
}
V_217 = 0 ;
V_19:
