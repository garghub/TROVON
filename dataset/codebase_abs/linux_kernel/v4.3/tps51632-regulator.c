...
V_12 = F_13 ( V_10 , sizeof( * V_12 ) , V_39 ) ;
if ( ! V_12 )
return NULL ;
V_12 -> V_40 = F_14 ( V_10 , V_10 -> V_38 ,
V_35 ) ;
if ( ! V_12 -> V_40 ) {
F_5 ( V_10 , L_6 ) ;
return NULL ;
...
V_5 = F_13 ( & V_47 -> V_10 , sizeof( * V_5 ) , V_39 ) ;
if ( ! V_5 )
return - V_56 ;
V_5 -> V_10 = & V_47 -> V_10 ;
...
V_5 -> V_35 . V_71 = V_32 ;
V_5 -> V_35 . V_72 = V_73 ;
V_5 -> V_8 = F_20 ( V_47 , & V_74 ) ;
if ( F_21 ( V_5 -> V_8 ) ) {
V_7 = F_22 ( V_5 -> V_8 ) ;
F_5 ( & V_47 -> V_10 , L_13 , V_7 ) ;
return V_7 ;
}
F_23 ( V_47 , V_5 ) ;
V_7 = F_6 ( V_5 , V_12 ) ;
if ( V_7 < 0 ) {
F_5 ( V_5 -> V_10 , L_14 , V_7 ) ;
return V_7 ;
}
V_51 . V_10 = & V_47 -> V_10 ;
V_51 . V_75 = V_12 -> V_40 ;
...
V_2 = F_24 ( & V_47 -> V_10 , & V_5 -> V_35 , & V_51 ) ;
if ( F_21 ( V_2 ) ) {
F_5 ( V_5 -> V_10 , L_15 ) ;
return F_22 ( V_2 ) ;
}
