...
union V_44 V_45 ;
int V_46 = - V_47 ;
V_31 = F_11 ( & V_41 -> V_48 , sizeof( * V_31 ) , V_49 ) ;
if ( ! V_31 )
return - V_50 ;
V_43 = F_12 ( V_41 , V_51 , 0 ) ;
if ( V_43 == NULL ) {
F_13 ( & V_41 -> V_48 , L_1 ) ;
return - V_52 ;
}
V_31 -> V_53 = V_43 -> V_54 ;
V_31 -> V_55 = F_14 ( V_43 ) ;
if ( ! F_15 ( & V_41 -> V_48 , V_31 -> V_53 , V_31 -> V_55 ,
V_43 -> V_56 ) ) {
F_13 ( & V_41 -> V_48 , L_2 ) ;
return - V_52 ;
}
V_31 -> V_10 =
( T_1 ) F_16 ( & V_41 -> V_48 , V_31 -> V_53 , V_31 -> V_55 ) ;
if ( ! V_31 -> V_10 ) {
F_13 ( & V_41 -> V_48 , L_3 ) ;
return - V_50 ;
}
...
V_45 . T_1 = 0 ;
V_45 . V_12 . V_58 = 1 ;
F_1 ( V_45 . T_1 , V_31 -> V_10 + V_59 ) ;
V_31 -> V_30 -> V_32 = V_31 ;
V_31 -> V_30 -> V_60 = V_31 -> V_61 ;
V_31 -> V_30 -> V_56 = L_4 ;
snprintf ( V_31 -> V_30 -> V_62 , V_63 , L_5 , V_31 -> V_10 ) ;
V_31 -> V_30 -> V_64 = & V_41 -> V_48 ;
V_31 -> V_30 -> V_65 = F_8 ;
V_31 -> V_30 -> V_66 = F_9 ;
F_18 ( V_41 , V_31 ) ;
V_46 = F_19 ( V_31 -> V_30 , V_41 -> V_48 . V_67 ) ;
if ( V_46 )
goto V_68;
F_20 ( & V_41 -> V_48 , L_6 V_69 L_7 ) ;
return 0 ;
V_68:
F_21 ( V_31 -> V_30 ) ;
V_57:
