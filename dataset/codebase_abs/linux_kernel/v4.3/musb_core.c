...
static T_1 F_14 ( T_3 V_25 , T_4 V_6 )
{
return 0x80 + ( 0x08 * V_25 ) + V_6 ;
}
static T_3 F_15 ( const void T_2 * V_7 , unsigned V_6 )
{
return F_16 ( V_7 + V_6 ) ;
}
static void F_17 ( void T_2 * V_7 , unsigned V_6 , T_3 V_24 )
{
F_18 ( V_24 , V_7 + V_6 ) ;
}
static T_4 F_19 ( const void T_2 * V_7 , unsigned V_6 )
{
return F_20 ( V_7 + V_6 ) ;
}
static void F_21 ( void T_2 * V_7 , unsigned V_6 , T_4 V_24 )
{
F_22 ( V_24 , V_7 + V_6 ) ;
}
static T_1 F_23 ( const void T_2 * V_7 , unsigned V_6 )
{
return F_24 ( V_7 + V_6 ) ;
}
static void F_25 ( void T_2 * V_7 , unsigned V_6 , T_1 V_24 )
{
F_26 ( V_24 , V_7 + V_6 ) ;
}
static void F_27 ( struct V_28 * V_29 , T_4 V_30 ,
const T_3 * V_31 )
{
...
if ( F_31 ( ( 0x01 & ( unsigned long ) V_31 ) == 0 ) ) {
T_4 V_34 = 0 ;
if ( ( 0x02 & ( unsigned long ) V_31 ) == 0 ) {
if ( V_30 >= 4 ) {
F_32 ( V_32 , V_31 + V_34 , V_30 >> 2 ) ;
V_34 += V_30 & ~ 0x03 ;
}
if ( V_30 & 0x02 ) {
F_22 ( * ( T_4 * ) & V_31 [ V_34 ] , V_32 ) ;
V_34 += 2 ;
}
} else {
if ( V_30 >= 2 ) {
...
if ( F_31 ( ( 0x01 & ( unsigned long ) V_35 ) == 0 ) ) {
T_4 V_34 = 0 ;
...
if ( V_30 & 0x02 ) {
* ( T_4 * ) & V_35 [ V_34 ] = F_20 ( V_32 ) ;
V_34 += 2 ;
}
} else {
if ( V_30 >= 2 ) {
F_37 ( V_32 , V_35 , V_30 >> 1 ) ;
V_34 = V_30 & ~ 0x01 ;
}
}
if ( V_30 & 0x01 )
...
void F_39 ( struct V_28 * V_29 , T_4 V_30 , T_3 * V_35 )
{
return V_29 -> V_1 -> V_36 . V_37 ( V_29 , V_30 , V_35 ) ;
}
void F_40 ( struct V_28 * V_29 , T_4 V_30 , const T_3 * V_31 )
{
...
V_1 -> V_89 = V_90 ;
V_1 -> V_105 = V_1 -> V_106 ;
F_43 ( V_1 -> V_41 , V_107 , V_1 -> V_105 ) ;
V_1 -> V_108 = V_1 -> V_106 & 0xfffe ;
F_43 ( V_1 -> V_41 , V_109 , V_1 -> V_108 ) ;
...
V_119 = F_73 ( V_26 , V_121 ) ;
V_119 = F_73 ( V_26 , V_122 ) ;
}
static void F_74 ( struct V_1 * V_1 )
{
void T_2 * V_39 = V_1 -> V_41 ;
V_1 -> V_105 = V_1 -> V_106 ;
F_43 ( V_39 , V_107 , V_1 -> V_105 ) ;
V_1 -> V_108 = V_1 -> V_106 & 0xfffe ;
F_43 ( V_39 , V_109 , V_1 -> V_108 ) ;
F_6 ( V_39 , V_110 , 0xf7 ) ;
}
...
static int
F_84 ( struct V_1 * V_1 , struct V_28 * V_29 ,
...
V_6 = F_84 ( V_1 , V_29 + V_166 , V_131 ++ , V_6 ) ;
if ( V_6 < 0 ) {
F_94 ( L_39 ,
V_164 , V_166 ) ;
return V_6 ;
...
V_166 ++ ;
V_1 -> V_170 = F_86 ( V_166 , V_1 -> V_170 ) ;
}
F_93 ( V_163 L_40 ,
V_164 ,
...
static int F_97 ( T_4 V_171 , struct V_1 * V_1 )
{
T_3 V_59 ;
char * type ;
...
V_1 -> V_191 = F_100 ( V_26 ) ;
snprintf ( V_173 , 32 , L_55 , F_101 ( V_1 -> V_191 ) ,
F_102 ( V_1 -> V_191 ) ,
...
unsigned long V_25 ;
T_3 V_67 ;
if ( ! V_1 -> V_66 && ! V_1 -> V_209 && ! V_1 -> V_210 )
return V_69 ;
V_67 = F_5 ( V_1 -> V_41 , V_87 ) ;
F_30 ( V_1 -> V_33 , L_64 ,
F_67 ( V_1 ) ? L_12 : L_13 ,
V_1 -> V_66 , V_1 -> V_209 , V_1 -> V_210 ) ;
if ( V_1 -> V_66 )
V_208 |= F_52 ( V_1 , V_1 -> V_66 , V_67 ) ;
if ( V_1 -> V_209 & 1 ) {
if ( F_67 ( V_1 ) )
V_208 |= F_106 ( V_1 ) ;
else
...
void F_114 ( struct V_1 * V_1 , T_3 V_25 , T_3 V_211 )
{
if ( ! V_25 ) {
if ( ! F_115 ( V_1 ) ) {
if ( F_67 ( V_1 ) )
...
static T_6
F_116 ( struct V_2 * V_3 , struct V_212 * V_213 , char * V_214 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_46 ;
int V_12 = - V_169 ;
F_45 ( & V_1 -> V_47 , V_46 ) ;
V_12 = sprintf ( V_214 , L_65 , F_47 ( V_1 -> V_48 -> V_49 -> V_50 ) ) ;
F_49 ( & V_1 -> V_47 , V_46 ) ;
return V_12 ;
}
static T_6
F_117 ( struct V_2 * V_3 , struct V_212 * V_213 ,
const char * V_214 , T_7 V_152 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_46 ;
int V_175 ;
F_45 ( & V_1 -> V_47 , V_46 ) ;
if ( F_118 ( V_214 , L_12 ) )
V_175 = F_119 ( V_1 , V_215 ) ;
else if ( F_118 ( V_214 , L_13 ) )
V_175 = F_119 ( V_1 , V_216 ) ;
else if ( F_118 ( V_214 , L_66 ) )
V_175 = F_119 ( V_1 , V_217 ) ;
else
V_175 = - V_169 ;
F_49 ( & V_1 -> V_47 , V_46 ) ;
...
static T_6
F_120 ( struct V_2 * V_3 , struct V_212 * V_213 ,
const char * V_214 , T_7 V_152 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_46 ;
unsigned long V_218 ;
if ( sscanf ( V_214 , L_67 , & V_218 ) < 1 ) {
F_66 ( V_3 , L_68 ) ;
return - V_169 ;
}
F_45 ( & V_1 -> V_47 , V_46 ) ;
V_1 -> V_98 = V_218 ? F_121 ( int , V_218 , V_99 ) : 0 ;
if ( V_1 -> V_48 -> V_49 -> V_50 == V_55 )
V_1 -> V_53 = 0 ;
F_60 ( V_1 , V_76 + F_53 ( V_218 ) ) ;
F_49 ( & V_1 -> V_47 , V_46 ) ;
return V_152 ;
}
static T_6
F_122 ( struct V_2 * V_3 , struct V_212 * V_213 , char * V_214 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_46 ;
unsigned long V_218 ;
...
V_219 = F_123 ( V_1 ) ;
F_49 ( & V_1 -> V_47 , V_46 ) ;
return sprintf ( V_214 , L_69 ,
V_219 ? L_70 : L_71 , V_218 ) ;
}
static T_6
F_124 ( struct V_2 * V_3 , struct V_212 * V_213 ,
const char * V_214 , T_7 V_152 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned short V_220 ;
if ( sscanf ( V_214 , L_72 , & V_220 ) != 1
|| ( V_220 != 1 ) ) {
F_66 ( V_3 , L_73 ) ;
return - V_169 ;
}
...
static void F_126 ( struct V_221 * V_24 )
{
struct V_1 * V_1 = F_127 ( V_24 , struct V_1 , V_118 ) ;
if ( V_1 -> V_48 -> V_49 -> V_50 != V_1 -> V_222 ) {
V_1 -> V_222 = V_1 -> V_48 -> V_49 -> V_50 ;
F_128 ( & V_1 -> V_33 -> V_223 , NULL , L_74 ) ;
}
}
...
struct V_224 * V_138 , void T_2 * V_26 )
{
struct V_1 * V_1 ;
struct V_28 * V_225 ;
int V_25 ;
int V_12 ;
V_1 = F_132 ( V_3 , sizeof( * V_1 ) , V_226 ) ;
if ( ! V_1 )
return NULL ;
F_133 ( & V_1 -> V_227 ) ;
F_133 ( & V_1 -> V_228 ) ;
...
V_1 -> V_232 = - V_233 ;
V_1 -> V_138 = V_138 ;
F_134 ( V_1 -> V_138 -> V_168 > V_234 ) ;
for ( V_25 = 0 , V_225 = V_1 -> V_40 ;
...
static void F_143 ( struct V_221 * V_238 )
{
struct V_1 * V_1 ;
unsigned long V_46 ;
V_1 = F_127 ( V_238 , struct V_1 , V_239 . V_238 ) ;
F_45 ( & V_1 -> V_47 , V_46 ) ;
if ( V_1 -> V_64 & V_240 )
F_144 ( V_1 , false ) ;
F_49 ( & V_1 -> V_47 , V_46 ) ;
...
static int
F_145 ( struct V_2 * V_3 , int V_232 , void T_2 * V_241 )
{
int V_175 ;
struct V_1 * V_1 ;
struct V_242 * V_243 = F_146 ( V_3 ) ;
if ( ! V_243 ) {
F_30 ( V_3 , L_75 ) ;
V_175 = - V_233 ;
goto V_244;
}
V_1 = F_131 ( V_3 , V_243 -> V_138 , V_241 ) ;
if ( ! V_1 ) {
V_175 = - V_245 ;
goto V_244;
}
F_147 ( & V_1 -> V_47 ) ;
V_1 -> V_246 = V_243 -> V_247 ;
V_1 -> V_248 = V_243 -> V_248 ;
V_1 -> V_249 = V_243 -> V_250 ;
V_1 -> V_126 = V_243 -> V_136 ;
F_5 = F_15 ;
F_6 = F_17 ;
F_73 = F_19 ;
F_43 = F_21 ;
...
if ( V_1 -> V_249 -> V_195 )
V_1 -> V_36 . V_195 = V_1 -> V_249 -> V_195 ;
if ( V_1 -> V_36 . V_195 & V_256 ) {
V_1 -> V_36 . V_205 = F_13 ;
V_1 -> V_36 . V_257 = F_12 ;
} else {
V_1 -> V_36 . V_205 = F_11 ;
...
if ( V_1 -> V_249 -> V_205 )
V_1 -> V_36 . V_205 = V_1 -> V_249 -> V_205 ;
if ( V_1 -> V_249 -> V_257 )
V_1 -> V_36 . V_257 = V_1 -> V_249 -> V_257 ;
if ( V_1 -> V_249 -> V_205 )
V_1 -> V_36 . V_205 = V_1 -> V_249 -> V_205 ;
if ( V_1 -> V_249 -> V_257 )
V_1 -> V_36 . V_257 = V_1 -> V_249 -> V_257 ;
if ( V_1 -> V_249 -> V_156 )
V_156 = V_1 -> V_249 -> V_156 ;
else
V_156 = 4 ;
if ( V_1 -> V_249 -> V_193 )
V_1 -> V_36 . V_193 = V_1 -> V_249 -> V_193 ;
else
V_1 -> V_36 . V_193 = F_9 ;
if ( V_1 -> V_249 -> V_258 )
V_1 -> V_36 . V_258 = V_1 -> V_249 -> V_258 ;
else
V_1 -> V_36 . V_258 = F_14 ;
if ( V_1 -> V_249 -> V_259 )
F_5 = V_1 -> V_249 -> V_259 ;
...
F_6 = V_1 -> V_249 -> V_260 ;
if ( V_1 -> V_249 -> V_261 )
F_73 = V_1 -> V_249 -> V_261 ;
if ( V_1 -> V_249 -> V_262 )
F_43 = V_1 -> V_249 -> V_262 ;
if ( V_1 -> V_249 -> V_263 )
V_251 = V_1 -> V_249 -> V_263 ;
if ( V_1 -> V_249 -> V_264 )
V_252 = V_1 -> V_249 -> V_264 ;
#ifndef F_153
if ( ! V_1 -> V_249 -> V_265 || ! V_1 -> V_249 -> V_266 ) {
F_66 ( V_3 , L_76 ) ;
goto V_255;
}
V_267 = V_1 -> V_249 -> V_265 ;
V_268 = V_1 -> V_249 -> V_266 ;
#endif
if ( V_1 -> V_249 -> V_37 )
V_1 -> V_36 . V_37 = V_1 -> V_249 -> V_37 ;
else
V_1 -> V_36 . V_37 = F_35 ;
if ( V_1 -> V_249 -> V_38 )
V_1 -> V_36 . V_38 = V_1 -> V_249 -> V_38 ;
else
V_1 -> V_36 . V_38 = F_27 ;
if ( ! V_1 -> V_48 -> V_269 ) {
...
V_267 ( V_1 , V_1 -> V_41 ) ;
if ( F_154 ( V_1 -> V_273 ) ) {
V_175 = F_155 ( V_1 -> V_273 ) ;
goto V_274;
}
}
F_79 ( V_1 ) ;
F_75 ( V_1 ) ;
F_156 ( & V_1 -> V_118 , F_126 ) ;
F_157 ( & V_1 -> V_239 , F_143 ) ;
F_157 ( & V_1 -> V_275 , V_276 ) ;
V_175 = F_97 ( V_243 -> V_138 -> V_277
? V_188
: V_278 , V_1 ) ;
if ( V_175 < 0 )
goto V_279;
F_158 ( & V_1 -> V_102 , F_44 , ( unsigned long ) V_1 ) ;
if ( F_159 ( V_232 , V_1 -> V_254 , 0 , F_160 ( V_3 ) , V_1 ) ) {
F_66 ( V_3 , L_77 , V_232 ) ;
V_175 = - V_233 ;
goto V_279;
}
...
if ( V_243 -> V_280 ) {
T_3 V_281 = F_163 ( V_1 -> V_41 ) ;
V_281 |= V_282 ;
F_164 ( V_1 -> V_41 , V_281 ) ;
}
...
if ( V_175 < 0 )
goto V_286;
V_175 = F_168 ( & V_1 -> V_33 -> V_223 , & V_236 ) ;
if ( V_175 )
goto V_287;
F_7 ( V_1 -> V_33 ) ;
return 0 ;
...
int V_288 = F_175 ( V_129 , L_80 ) ;
struct V_289 * V_290 ;
void T_2 * V_291 ;
if ( V_288 <= 0 )
return - V_233 ;
V_290 = F_176 ( V_129 , V_292 , 0 ) ;
V_291 = F_177 ( V_3 , V_290 ) ;
if ( F_154 ( V_291 ) )
return F_155 ( V_291 ) ;
return F_145 ( V_3 , V_288 , V_291 ) ;
}
static int F_178 ( struct V_128 * V_129 )
{
struct V_2 * V_3 = & V_129 -> V_3 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
F_169 ( V_1 ) ;
...
void T_2 * V_294 ;
V_1 -> V_295 . V_296 = F_73 ( V_293 , V_297 ) ;
V_1 -> V_295 . V_298 = F_5 ( V_293 , V_123 ) ;
V_1 -> V_295 . V_281 = F_163 ( V_1 -> V_41 ) ;
...
void T_2 * V_294 ;
T_3 V_11 ;
F_43 ( V_293 , V_297 , V_1 -> V_295 . V_296 ) ;
F_6 ( V_293 , V_123 , V_1 -> V_295 . V_298 ) ;
F_164 ( V_1 -> V_41 , V_1 -> V_295 . V_281 ) ;
V_11 = F_5 ( V_293 , V_14 ) ;
V_11 &= V_15 | V_327 ;
V_1 -> V_295 . V_11 &= ~ ( V_15 | V_327 ) ;
V_11 |= V_1 -> V_295 . V_11 ;
F_6 ( V_293 , V_14 , V_11 ) ;
F_43 ( V_293 , V_107 , V_1 -> V_105 ) ;
F_43 ( V_293 , V_109 , V_1 -> V_108 ) ;
