...
F_107 ( V_27 , V_162 , sizeof( V_27 ) ) ;
V_161 = F_108 ( V_27 , 0440 , V_102 -> V_163 , & V_164 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_161 )
goto V_119;
F_106 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_107 ( V_27 , V_165 , sizeof( V_27 ) ) ;
V_161 = F_108 ( V_27 , 0440 , V_102 -> V_163 , & V_166 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_161 )
goto V_167;
F_106 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_107 ( V_27 , V_168 , sizeof( V_27 ) ) ;
V_161 = F_108 ( V_27 , 0440 , V_102 -> V_163 , & V_169 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_161 )
goto V_170;
#endif
...
void F_110 ( struct V_102 * V_102 , T_1 V_3 )
{
#ifdef F_105
char V_27 [ V_159 ] ;
F_106 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
...
static int T_9 F_111 ( struct V_102 * V_102 )
{
int V_9 ;
for ( V_9 = 0 ; V_9 < V_171 ; V_9 ++ )
F_112 ( & V_102 -> V_5 . V_122 [ V_9 ] ) ;
return 0 ;
}
...
int V_172 ;
F_50 (i) {
F_114 ( & F_115 ( V_173 , V_9 ) ) ;
}
V_5 = F_48 ( sizeof( struct V_54 ) * V_171 , V_96 ) ;
if ( ! V_5 )
return - V_59 ;
for ( V_9 = 0 ; V_9 < V_171 ; V_9 ++ ) {
F_116 ( & V_5 [ V_9 ] . V_6 ) ;
