...
case V_116 :
if ( F_22 ( V_10 ) == V_117 ) {
V_14 = F_23 ( V_64 -> V_118 ) ;
if ( V_14 < 0 ) {
F_24 ( V_10 -> V_2 , L_6 , V_14 ) ;
return V_14 ;
}
...
F_13 ( V_10 , V_50 ,
V_138 , V_138 ) ;
F_6 ( V_10 , V_139 , 0x50 | ( 1 << 8 ) ) ;
F_6 ( V_10 , V_140 , 0x50 | ( 1 << 8 ) ) ;
return 0 ;
}
static int F_30 ( struct V_141 * V_142 ,
const struct V_143 * V_144 )
{
struct V_63 * V_64 ;
int V_14 ;
V_64 = F_31 ( & V_142 -> V_2 , sizeof( struct V_63 ) ,
V_145 ) ;
if ( V_64 == NULL )
return - V_146 ;
F_32 ( V_142 , V_64 ) ;
...
static int F_34 ( struct V_141 * V_149 )
{
F_35 ( & V_149 -> V_2 ) ;
return 0 ;
}
