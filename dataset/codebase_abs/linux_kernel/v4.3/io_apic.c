...
V_172 = F_207 ( V_270 ) ;
if ( V_172 -> V_219 )
V_172 -> V_219 ( V_270 , V_56 , false ) ;
}
}
static struct V_272 * T_2 F_208 ( void )
{
unsigned long V_273 ;
struct V_272 * V_274 ;
char * V_275 ;
...
if ( V_276 == 0 )
return NULL ;
V_273 = V_277 + sizeof( struct V_272 ) ;
V_273 *= V_276 ;
V_275 = F_209 ( V_273 ) ;
V_274 = ( void * ) V_275 ;
V_275 += sizeof( struct V_272 ) * V_276 ;
V_276 = 0 ;
F_22 (i) {
V_274 [ V_276 ] . V_278 = V_275 ;
V_274 [ V_276 ] . V_53 = V_279 | V_280 ;
snprintf ( V_275 , V_277 , L_98 , V_22 ) ;
V_275 += V_277 ;
V_276 ++ ;
V_2 [ V_22 ] . V_281 = V_274 ;
}
V_282 = V_274 ;
return V_274 ;
}
void T_2 F_210 ( void )
{
unsigned long V_283 , V_33 = V_284 ;
struct V_272 * V_285 ;
int V_22 ;
V_285 = F_208 () ;
F_22 (i) {
...
V_287:
#endif
V_283 = ( unsigned long ) F_211 ( V_288 ) ;
V_283 = F_212 ( V_283 ) ;
}
F_213 ( V_33 , V_283 ) ;
F_14 ( V_23 , L_102 ,
F_214 ( V_33 ) + ( V_283 & ~ V_289 ) ,
V_283 ) ;
V_33 ++ ;
V_285 -> V_290 = V_283 ;
V_285 -> V_291 = V_283 + V_292 - 1 ;
V_285 ++ ;
}
}
void T_2 F_215 ( void )
...
return - 1 ;
V_9 = F_3 ( V_8 ) ;
if ( F_217 ( V_111 > V_9 -> V_10 ) )
return - 1 ;
return V_111 - V_9 -> V_11 ;
}
static int F_218 ( int V_33 )
{
union V_153 V_154 ;
union V_155 V_156 ;
union V_157 V_158 ;
...
{
int V_33 ;
for ( V_33 = 0 ; V_33 < V_295 ; V_33 ++ )
if ( V_2 [ V_33 ] . V_37 == 0 )
return V_33 ;
return V_295 ;
}
int F_220 ( int V_266 , T_1 V_296 , T_1 V_11 ,
struct V_250 * V_211 )
{
bool V_297 = ! ! V_125 ;
struct V_6 * V_9 ;
...
V_2 [ V_33 ] . V_3 . type = V_301 ;
V_2 [ V_33 ] . V_3 . V_53 = V_302 ;
V_2 [ V_33 ] . V_3 . V_5 = V_296 ;
F_213 ( V_284 + V_33 , V_296 ) ;
if ( F_218 ( V_33 ) ) {
F_221 ( V_284 + V_33 ) ;
return - V_303 ;
}
V_2 [ V_33 ] . V_3 . V_4 = F_197 ( V_33 , V_266 ) ;
V_2 [ V_33 ] . V_3 . V_304 = F_202 ( V_33 ) ;
V_167 = F_193 ( V_33 ) ;
V_10 = V_11 + V_167 - 1 ;
F_22 (ioapic) {
V_9 = F_3 ( V_8 ) ;
...
static void F_226 ( T_1 V_111 , struct V_58 * V_46 ,
struct V_101 * V_102 )
{
...
static void F_227 ( struct V_210 * V_211 , struct V_58 * V_46 ,
struct V_36 * V_52 )
{
memset ( V_52 , 0 , sizeof( * V_52 ) ) ;
V_52 -> V_78 = V_40 -> V_305 ;
V_52 -> V_150 = V_40 -> V_306 ;
...
int F_228 ( struct V_14 * V_121 , unsigned int V_307 ,
unsigned int V_308 , void * V_236 )
{
int V_218 , V_8 , V_12 ;
struct V_210 * V_211 ;
struct V_72 * V_72 ;
...
if ( ! V_102 || V_308 > 1 )
return - V_298 ;
V_72 = F_97 ( V_121 , V_307 ) ;
if ( ! V_72 )
return - V_298 ;
V_8 = F_229 ( V_121 ) ;
V_12 = V_102 -> V_113 ;
if ( F_100 ( V_121 , ( V_309 ) V_12 ) > 0 )
return - V_299 ;
V_46 = F_17 ( sizeof( * V_46 ) , V_38 ) ;
if ( ! V_46 )
return - V_62 ;
V_102 -> V_310 = & V_46 -> V_52 ;
V_218 = F_230 ( V_121 , V_307 , V_308 , V_102 ) ;
if ( V_218 < 0 ) {
F_20 ( V_46 ) ;
return V_218 ;
}
F_231 ( & V_46 -> V_64 ) ;
V_72 -> V_311 = V_102 -> V_113 ;
V_72 -> V_172 = ( V_121 -> V_217 == V_252 ) ?
& V_173 : & V_174 ;
V_72 -> V_73 = V_46 ;
F_226 ( F_5 ( V_8 , V_12 ) , V_46 , V_102 ) ;
V_211 = F_151 ( V_72 ) ;
F_44 ( V_46 , F_85 ( V_102 ) , V_8 , V_12 ) ;
F_175 ( V_53 ) ;
if ( V_102 -> V_310 )
F_227 ( V_211 , V_46 , V_102 -> V_310 ) ;
F_86 ( V_307 , V_46 -> V_76 ) ;
if ( V_307 < F_7 () )
V_206 -> V_56 ( V_307 ) ;
F_141 ( V_53 ) ;
F_14 ( V_23 , V_87
...
V_307 , V_46 -> V_76 , V_46 -> V_103 , V_211 -> V_221 ) ;
return 0 ;
}
void F_232 ( struct V_14 * V_121 , unsigned int V_307 ,
unsigned int V_308 )
{
struct V_72 * V_72 ;
struct V_58 * V_46 ;
...
if ( V_72 && V_72 -> V_73 ) {
V_46 = V_72 -> V_73 ;
F_41 ( V_46 , F_229 ( V_121 ) ,
( int ) V_72 -> V_311 ) ;
F_217 ( ! F_121 ( & V_46 -> V_64 ) ) ;
F_20 ( V_72 -> V_73 ) ;
}
F_233 ( V_121 , V_307 , V_308 ) ;
}
void F_234 ( struct V_14 * V_121 ,
struct V_72 * V_72 )
{
unsigned long V_53 ;
struct V_60 * V_52 ;
...
void F_235 ( struct V_14 * V_121 ,
struct V_72 * V_72 )
{
F_36 ( F_229 ( V_121 ) ,
( int ) V_72 -> V_311 ) ;
}
int F_229 ( struct V_14 * V_121 )
{
return ( int ) ( long ) V_121 -> V_312 ;
}
