...
int F_11 ( unsigned int V_62 , int V_43 ,
struct V_58 * V_9 ,
int V_8 )
{
int V_63 ;
...
struct V_56 * F_20 ( unsigned int V_62 ,
struct V_58 * V_9 ,
int V_8 ,
struct V_73 * V_74 )
{
