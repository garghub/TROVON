...
goto V_135;
V_143:
V_2 -> V_24 . V_44 . V_147 = & V_2 -> V_139 ;
}
V_107 = F_58 ( & V_2 -> V_7 ) ;
if ( V_107 < 0 )
goto V_135;
if ( V_87 -> V_148 )
V_107 = F_59 ( & V_2 -> V_7 , NULL , NULL ,
V_87 -> V_148 , V_87 -> V_149 ) ;
else {
struct V_150 V_151 ;
V_151 . V_86 = V_84 -> V_85 . V_86 ;
V_107 = F_59 ( & V_2 -> V_7 , NULL , & V_151 ,
NULL , 0 ) ;
}
if ( V_107 < 0 )
goto V_135;
