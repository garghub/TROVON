...
if ( ! strncmp ( V_78 , L_22 , ( V_80 ) V_77 -> V_81 ) )
return 0 ;
if ( ! strncmp ( V_78 , L_23 , ( V_80 ) V_77 -> V_81 ) )
return - V_60 ;
F_37 ( V_59 -> V_25 , L_24 , V_29 , V_78 ) ;
return - V_6 ;
}
...
F_18 ( V_59 -> V_25 , L_27 , V_29 ) ;
F_19 ( V_59 -> V_25 , L_28 , V_29 , V_77 -> V_81 ,
sizeof( * V_90 ) ) ;
V_49 = - V_6 ;
goto V_38;
}
...
V_93 -> V_68 = V_92 -> V_68 ;
V_78 = F_49 ( V_95 , L_34 , NULL ) ;
V_82 = F_49 ( V_95 , L_35 , NULL ) ;
V_96 = F_49 ( V_95 , L_36 , NULL ) ;
if ( ! V_78 || ! V_82 || ! V_96 ) {
F_18 ( V_92 -> V_25 , L_37 , V_29 ) ;
V_49 = - V_6 ;
goto V_100;
}
if ( V_91 && ( strncmp ( V_91 -> V_101 , L_34 , V_91 -> V_81 ) ||
strncmp ( V_91 -> V_101 , L_35 , V_91 -> V_81 ) ||
...
V_117 = snprintf ( V_114 , V_115 , L_43 ,
