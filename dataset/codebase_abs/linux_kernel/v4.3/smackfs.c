...
V_188 = V_54 ;
while ( ( V_58 = F_101 ( & V_188 , L_17 ) ) != NULL ) {
if ( ! * V_58 )
continue;
V_7 = F_14 ( V_58 , 0 ) ;
if ( F_15 ( V_7 ) ) {
...
V_180 -> V_132 = V_7 ;
F_10 ( & V_180 -> V_34 , & V_190 ) ;
}
F_19 ( V_54 ) ;
if ( V_25 == - V_60 && F_68 ( & V_190 ) )
V_25 = V_63 ;
if ( V_25 >= 0 ) {
F_7 ( & V_191 ) ;
F_96 ( & V_178 , & V_190 ) ;
...
F_102 (sop, sop2, &list_tmp, list)
F_19 ( V_180 ) ;
return V_25 ;
}
static T_1 F_103 ( struct V_61 * V_170 , char T_2 * V_62 ,
T_3 V_175 , T_4 * V_64 )
{
char * V_144 = L_18 ;
T_1 V_25 = - V_60 ;
...
static T_1 F_105 ( struct V_61 * V_170 , char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
char V_171 [ 32 ] ;
T_1 V_25 ;
...
static void * F_107 ( struct V_75 * V_76 , T_4 * V_77 )
{
struct V_195 * V_196 = F_108 () ;
return F_25 ( V_76 , V_77 , & V_196 -> V_73 ) ;
}
static void * F_109 ( struct V_75 * V_76 , void * V_79 , T_4 * V_77 )
{
struct V_195 * V_196 = F_108 () ;
return F_29 ( V_76 , V_79 , V_77 , & V_196 -> V_73 ) ;
}
...
{
return F_40 ( V_61 , & V_197 ) ;
}
static T_1 F_112 ( struct V_61 * V_61 , const char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
struct V_195 * V_196 = F_108 () ;
return F_22 ( V_61 , V_62 , V_63 , V_64 , & V_196 -> V_73 ,
& V_196 -> V_74 , V_67 ) ;
}
static T_1 F_113 ( struct V_61 * V_61 , const char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 , int V_65 )
{
struct V_13 V_50 ;
char * V_54 ;
int V_198 ;
V_54 = F_114 ( V_61 , V_62 , V_63 ) ;
if ( F_15 ( V_54 ) )
return F_16 ( V_54 ) ;
if ( V_65 == V_67 ) {
if ( V_63 < V_69 )
return - V_60 ;
V_198 = F_20 ( V_54 , & V_50 , 0 ) ;
} else {
V_198 = F_21 ( V_54 , & V_50 , 0 , 3 ) ;
}
if ( V_198 >= 0 )
V_198 = V_28 ( V_50 . V_27 , V_50 . V_26 ,
V_50 . V_29 , NULL ) ;
else if ( V_198 != - V_53 )
return V_198 ;
V_54 [ 0 ] = V_198 >= 0 ? '1' : '0' ;
...
T_3 V_63 , T_4 * V_64 )
{
return F_113 ( V_61 , V_62 , V_63 , V_64 , V_67 ) ;
}
static int F_117 ( struct V_75 * V_76 , void * V_79 )
{
struct V_15 * V_34 = V_79 ;
struct V_22 * V_23 =
F_38 ( V_34 , struct V_22 , V_34 ) ;
F_32 ( V_76 , V_23 -> V_35 , V_199 ) ;
return 0 ;
}
static int F_118 ( struct V_82 * V_82 , struct V_61 * V_61 )
{
...
static void * F_120 ( struct V_75 * V_76 , T_4 * V_77 )
{
struct V_195 * V_196 = F_108 () ;
return F_25 ( V_76 , V_77 , & V_196 -> V_73 ) ;
}
static void * F_121 ( struct V_75 * V_76 , void * V_79 , T_4 * V_77 )
{
struct V_195 * V_196 = F_108 () ;
return F_29 ( V_76 , V_79 , V_77 , & V_196 -> V_73 ) ;
}
...
struct V_20 * V_14 =
F_38 ( V_34 , struct V_20 , V_34 ) ;
F_32 ( V_76 , V_14 , V_199 ) ;
return 0 ;
}
static int F_123 ( struct V_82 * V_82 , struct V_61 * V_61 )
{
return F_40 ( V_61 , & V_201 ) ;
}
...
static T_1 F_125 ( struct V_61 * V_61 , const char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
return F_113 ( V_61 , V_62 , V_63 , V_64 , V_127 ) ;
}
...
static T_1 F_130 ( struct V_61 * V_170 , char T_2 * V_62 ,
T_3 V_175 , T_4 * V_64 )
{
struct V_6 * V_7 ;
T_1 V_25 = - V_60 ;
...
static T_1 F_132 ( struct V_61 * V_170 , char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
char V_171 [ 32 ] ;
T_1 V_25 ;
...
static int F_134 ( struct V_210 * V_211 , void * V_54 , int V_212 )
{
int V_25 ;
struct V_82 * V_213 ;
...
V_25 = F_137 ( V_211 , V_262 , V_215 ) ;
if ( V_25 != 0 ) {
F_45 ( V_263 L_42 ,
V_91 , V_25 ) ;
return V_25 ;
}
V_213 = F_138 ( V_211 -> V_264 ) ;
return 0 ;
}
static struct V_265 * F_139 ( struct V_266 * V_267 ,
int V_268 , const char * V_269 , void * V_54 )
{
return F_140 ( V_267 , V_268 , V_54 , F_134 ) ;
}
static int T_7 F_141 ( struct V_6 * V_7 )
{
V_7 -> V_107 . V_270 = V_7 -> V_81 ;
V_7 -> V_107 . V_268 =
V_271 | V_272 ;
