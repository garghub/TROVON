...
static int F_13 ( struct V_2 * V_3 , const struct V_20 * V_8 )
{
...
{
T_1 V_22 = F_7 ( V_3 , 0x09 ) & 7 ;
T_1 V_23 = F_7 ( V_3 , 0x04 ) ;
int V_24 = F_7 ( V_3 , 0x08 ) & 0x3f ;
F_15 ( V_3 , L_2 , V_22 ,
( V_23 & 0x80 ) ? L_3 : L_4 ) ;
if ( V_24 >= 32 )
V_24 = V_24 - 64 ;
...
return - V_29 ;
F_18 ( V_11 , L_6 ,
V_11 -> V_30 << 1 , V_11 -> V_27 -> V_31 ) ;
V_26 = F_19 ( & V_11 -> V_32 , sizeof( * V_26 ) , V_33 ) ;
if ( V_26 == NULL )
return - V_34 ;
V_3 = & V_26 -> V_3 ;
F_20 ( V_3 , V_11 , & V_35 ) ;
