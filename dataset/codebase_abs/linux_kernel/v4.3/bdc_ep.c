...
V_43 * V_2 -> V_4 . V_29 ) ;
V_121 = F_59 ( & V_2 -> V_99 , struct V_32 ,
V_99 ) ;
if ( V_33 == V_121 )
V_120 = true ;
if ( V_118 && ! V_120 ) {
...
static int F_61 ( struct V_1 * V_2 , T_1 V_129 )
{
struct V_5 * V_5 ;
int V_87 ;
V_5 = V_2 -> V_5 ;
...
V_99 ) ;
V_85 = & V_33 -> V_85 ;
V_151 = F_68 ( F_69 ( V_144 -> V_18 [ 3 ] ) ) ;
if ( V_151 == V_153 && V_85 -> V_79 > 1 ) {
V_126 = F_69 ( V_144 -> V_18 [ 0 ] ) ;
V_125 = V_126 ;
V_126 = F_69 ( V_144 -> V_18 [ 1 ] ) ;
V_125 |= ( ( T_4 ) V_126 << 32 ) ;
...
V_149 = F_69 ( V_150 -> V_18 [ 2 ] ) & 0x1FFFFF ;
V_149 -= F_70 ( F_69 ( V_144 -> V_18 [ 2 ] ) ) ;
V_148 += V_149 ;
V_33 -> V_36 . V_111 = V_148 ;
} else {
V_33 -> V_36 . V_111 = V_33 -> V_36 . V_37 -
F_70 ( F_69 ( V_144 -> V_18 [ 2 ] ) ) ;
F_2 ( V_5 -> V_8 ,
L_47 ,
...
void F_71 ( struct V_5 * V_5 , struct V_143 * V_144 )
{
struct V_156 * V_67 ;
T_1 V_157 ;
F_2 ( V_5 -> V_8 ,
...
static int F_73 ( struct V_5 * V_5 , struct V_156 * V_158 )
{
...
case V_189 :
return F_76 ( V_5 , V_61 , V_165 , V_166 ) ;
case V_190 :
F_2 ( V_5 -> V_8 , L_61 ) ;
if ( V_61 != V_191 )
return - V_45 ;
...
* ( V_198 * ) V_5 -> V_199 = F_80 ( V_197 ) ;
V_5 -> V_116 . V_36 . V_37 = 2 ;
V_5 -> V_116 . V_36 . V_200 = & V_5 -> V_199 ;
F_53 ( V_5 ) ;
return 0 ;
}
static void F_81 ( struct V_103 * V_201 , struct V_114 * V_202 )
{
}
...
static void F_87 ( struct V_5 * V_5 , struct V_143 * V_144 )
{
F_2 ( V_5 -> V_8 , L_31 , V_9 ) ;
switch ( V_5 -> V_64 ) {
case V_203 :
...
void F_88 ( struct V_5 * V_5 , struct V_143 * V_144 )
{
struct V_1 * V_2 ;
T_1 V_151 ;
T_5 V_94 ;
V_94 = ( F_69 ( V_144 -> V_18 [ 3 ] ) >> 4 ) & 0x1f ;
V_2 = V_5 -> V_54 [ V_94 ] ;
...
static int F_90 ( struct V_103 * V_201 ,
...
static int F_95 ( struct V_103 * V_201 ,
struct V_114 * V_202 )
{
struct V_32 * V_33 ;
unsigned long V_55 ;
...
static int F_97 ( struct V_103 * V_201 , int V_129 )
{
unsigned long V_55 ;
struct V_1 * V_2 ;
struct V_5 * V_5 ;
...
static struct V_114 * F_98 ( struct V_103 * V_201 ,
T_6 V_229 )
{
struct V_32 * V_33 ;
struct V_1 * V_2 ;
...
static void F_99 ( struct V_103 * V_201 ,
struct V_114 * V_202 )
{
struct V_32 * V_33 ;
V_33 = F_92 ( V_202 ) ;
...
static int F_102 ( struct V_103 * V_201 )
{
unsigned long V_55 ;
struct V_1 * V_2 ;
struct V_5 * V_5 ;
...
V_2 -> V_63 = V_63 ;
if ( V_63 )
V_2 -> V_103 . V_240 . V_241 = true ;
else
V_2 -> V_103 . V_240 . V_242 = true ;
if ( V_53 == 1 ) {
V_2 -> V_94 = 1 ;
V_5 -> V_54 [ V_2 -> V_94 ] = V_2 ;
snprintf ( V_2 -> V_10 , sizeof( V_2 -> V_10 ) , L_110 , V_53 - 1 ) ;
F_104 ( & V_2 -> V_103 , V_243 ) ;
V_2 -> V_103 . V_240 . V_244 = true ;
V_2 -> V_106 = NULL ;
...
V_2 -> V_103 . V_240 . V_245 = true ;
V_2 -> V_103 . V_240 . V_246 = true ;
V_2 -> V_103 . V_240 . V_247 = true ;
V_2 -> V_103 . V_248 = 0 ;
F_33 ( & V_2 -> V_103 . V_133 , & V_5 -> V_71 . V_133 ) ;
}
V_2 -> V_103 . V_249 = & V_250 ;
