...
for ( V_6 = 0 ; V_6 < V_7 ; V_6 ++ , V_121 ++ ) {
T_1 V_14 ;
F_32 ( & V_14 , ( void V_15 * ) V_121 , sizeof( V_14 ) ) ;
F_14 ( V_5 , V_123 , V_14 ) ;
}
}
V_43 . V_51 = V_10 ;
...
static T_2 F_33 ( struct V_1 * V_2 , void * V_124 )
{
struct V_125 * V_126 = V_124 ;
T_2 V_127 ;
if ( F_34 ( V_2 ) )
return - V_128 ;
V_127 = F_35 ( V_2 , V_124 ) ;
if ( ! V_127 ) {
F_36 ( V_2 -> V_71 , V_126 -> V_129 ) ;
F_25 ( V_2 ) ;
}
return V_127 ;
}
...
static T_2 F_50 ( struct V_137 * V_138 )
{
...
V_2 -> V_130 &= ~ V_150 ;
V_142 = F_54 ( V_138 , V_151 , 0 ) ;
V_5 -> V_152 = F_55 ( V_56 , V_142 ) ;
if ( F_56 ( V_5 -> V_152 ) ) {
V_16 = F_57 ( V_5 -> V_152 ) ;
goto V_153;
}
F_58 ( V_56 , L_2 , V_5 -> V_152 ) ;
V_140 = F_59 ( V_56 -> V_143 ) ;
if ( V_140 )
F_36 ( V_2 -> V_71 , V_140 ) ;
else
F_60 ( V_2 ) ;
V_5 -> V_63 = F_61 ( V_138 , 0 ) ;
if ( ! V_5 -> V_63 ) {
F_62 ( V_56 , L_3 ) ;
V_16 = - V_144 ;
goto V_153;
...
static T_2 F_68 ( struct V_137 * V_138 )
{
struct V_1 * V_2 = F_69 ( V_138 ) ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
F_70 ( V_2 ) ;
F_67 ( V_2 ) ;
F_66 ( & V_5 -> V_54 ) ;
