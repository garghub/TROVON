...
type = ( V_113 == V_4 -> V_156 ) ? V_157 :
V_158 ;
V_21 = F_77 ( V_17 , & V_4 -> V_141 [ V_113 ] ,
1 << V_4 -> V_22 , type , V_159 ,
F_78 ( V_159 ) , V_113 ) ;
if ( V_21 )
return V_21 ;
}
V_154 = & V_4 -> V_141 [ V_4 -> V_156 ] ;
V_4 -> V_2 = F_79 ( V_17 , & V_154 -> V_32 ,
V_4 -> V_22 , V_160 ,
& V_161 , V_4 ) ;
if ( F_80 ( V_4 -> V_2 ) ) {
F_12 ( V_4 ) ;
...
static void F_83 ( struct V_151 * V_23 , struct V_151 * V_152 ,
void * V_153 )
{
struct V_3 * V_4 = F_76 ( V_23 ) ;
F_68 ( V_4 -> V_2 ) ;
...
if ( ! V_23 -> V_169 )
return - V_170 ;
V_4 = F_86 ( V_23 , sizeof( * V_4 ) , V_171 ) ;
if ( ! V_4 )
return - V_172 ;
V_4 -> V_23 = V_23 ;
V_4 -> V_5 = true ;
V_166 = F_87 ( V_23 -> V_169 , L_13 ) ;
if ( V_166 )
V_4 -> V_34 = true ;
F_88 ( V_166 ) ;
V_4 -> V_13 = F_89 ( V_23 -> V_169 , 0 ) ;
if ( ! V_4 -> V_13 )
return - V_172 ;
V_4 -> V_137 = F_90 ( V_23 , L_14 ) ;
if ( F_80 ( V_4 -> V_137 ) ) {
F_91 ( V_23 , L_15 ) ;
V_21 = F_81 ( V_4 -> V_137 ) ;
goto V_173;
}
V_4 -> V_138 = F_90 ( V_23 , L_16 ) ;
if ( F_80 ( V_4 -> V_138 ) ) {
F_91 ( V_23 , L_17 ) ;
V_21 = F_81 ( V_4 -> V_138 ) ;
goto V_173;
}
V_4 -> V_139 = F_90 ( V_23 , L_18 ) ;
if ( F_80 ( V_4 -> V_139 ) ) {
F_91 ( V_23 , L_19 ) ;
V_21 = F_81 ( V_4 -> V_139 ) ;
goto V_173;
}
V_4 -> V_31 = F_90 ( V_23 , L_20 ) ;
if ( F_80 ( V_4 -> V_31 ) ) {
F_91 ( V_23 , L_21 ) ;
V_21 = F_81 ( V_4 -> V_31 ) ;
goto V_173;
}
V_168 = F_92 ( V_164 , V_174 ,
V_4 -> V_34 ? L_22 : L_23 ) ;
if ( ! V_168 ) {
F_91 ( V_23 , L_24 ) ;
V_21 = - V_175 ;
...
V_21 = F_93 ( V_23 , V_168 -> V_176 , F_71 ,
0 , L_25 , V_4 ) ;
if ( V_21 ) {
F_91 ( V_23 , L_24 ) ;
goto V_173;
...
{
struct V_3 * V_4 = F_76 ( & V_164 -> V_23 ) ;
F_99 ( & V_164 -> V_23 ) ;
F_100 ( V_4 -> V_13 ) ;
F_102 ( & V_164 -> V_23 , & V_177 ) ;
return 0 ;
}
