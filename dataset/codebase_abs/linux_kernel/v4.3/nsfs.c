...
static int F_28 ( struct V_54 * V_55 , struct V_1 * V_1 )
{
struct V_4 * V_4 = F_2 ( V_1 ) ;
const struct V_5 * V_6 = V_1 -> V_7 ;
F_29 ( V_55 , L_1 , V_6 -> V_8 , V_4 -> V_9 ) ;
return 0 ;
}
static struct V_1 * F_30 ( struct V_56 * V_57 ,
int V_58 , const char * V_59 , void * V_60 )
{
return F_31 ( V_57 , L_4 , & V_61 ,
& V_62 , V_63 ) ;
}
void T_2 F_32 ( void )
{
