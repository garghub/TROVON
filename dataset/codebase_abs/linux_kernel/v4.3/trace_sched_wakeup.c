...
static void
F_65 ( void * V_51 , struct V_52 * V_90 )
{
struct V_3 * V_4 ;
int V_7 = F_66 () ;
unsigned long V_19 ;
...
F_55 ( V_90 ) ;
F_55 ( V_91 ) ;
if ( V_89 || ( V_92 && ! F_67 ( V_90 ) ) ||
( V_93 && ! F_67 ( V_90 ) && ! F_68 ( V_90 ) ) ||
( ! F_67 ( V_90 ) && ( V_90 -> V_69 >= V_88 || V_90 -> V_69 >= V_91 -> V_69 ) ) )
return;
V_5 = F_3 () ;
V_6 = F_7 ( & F_6 ( V_18 -> V_11 . V_4 , V_7 ) -> V_6 ) ;
if ( F_8 ( V_6 != 1 ) )
...
V_4 = F_6 ( V_18 -> V_11 . V_4 , V_84 ) ;
V_4 -> V_87 = F_58 ( V_7 ) ;
F_53 ( V_18 , V_90 , V_91 , V_19 , V_5 ) ;
F_42 ( V_18 , V_86 , V_95 , V_19 , V_5 ) ;
V_94:
F_62 ( & V_82 ) ;
V_12:
F_9 ( & F_6 ( V_18 -> V_11 . V_4 , V_7 ) -> V_6 ) ;
...
{
int V_104 = V_99 & V_101 ;
int V_105 = V_99 & V_100 ;
F_80 ( V_2 ) ;
F_29 ( V_2 ) ;
F_84 ( V_2 , V_101 , V_104 ) ;
F_84 ( V_2 , V_100 , V_105 ) ;
F_90 ( V_2 ) ;
V_102 = false ;
}
