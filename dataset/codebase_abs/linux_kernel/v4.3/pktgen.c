...
if ( ! ( V_22 -> V_37 & V_79 ) ) {
V_244 -> V_317 = V_318 ;
} else if ( V_50 -> V_319 & V_320 ) {
V_244 -> V_317 = V_321 ;
V_244 -> V_322 = 0 ;
F_150 ( V_244 , V_262 -> V_311 , V_262 -> V_312 ) ;
} else {
T_13 V_322 = F_151 ( V_244 , F_152 ( V_244 ) , V_272 + 8 , 0 ) ;
...
V_324 = V_272 + sizeof( struct V_194 ) ;
V_293 -> V_305 = F_124 ( V_22 -> V_107 ) ;
V_293 -> V_306 = F_124 ( V_22 -> V_106 ) ;
V_293 -> V_120 = F_124 ( V_324 ) ;
V_293 -> V_307 = 0 ;
...
if ( ! ( V_22 -> V_37 & V_79 ) ) {
V_244 -> V_317 = V_318 ;
} else if ( V_50 -> V_319 & V_329 ) {
V_244 -> V_317 = V_321 ;
V_244 -> V_330 = F_156 ( V_244 ) - V_244 -> V_331 ;
V_244 -> V_332 = F_157 ( struct V_194 , V_307 ) ;
V_293 -> V_307 = ~ F_158 ( & V_262 -> V_311 , & V_262 -> V_312 , V_324 , V_310 , 0 ) ;
} else {
T_13 V_322 = F_151 ( V_244 , F_152 ( V_244 ) , V_324 , 0 ) ;
V_293 -> V_307 = F_158 ( & V_262 -> V_311 , & V_262 -> V_312 , V_324 , V_310 , V_322 ) ;
if ( V_293 -> V_307 == 0 )
V_293 -> V_307 = V_323 ;
}
return V_244 ;
...
{
T_14 V_338 , V_339 , V_340 ;
char * V_341 = V_22 -> V_110 ;
T_5 V_342 = F_90 ( V_22 -> V_93 ,
V_22 -> V_98 ) ;
T_5 V_25 = F_167 ( V_22 -> V_94 ) ;
V_341 += sprintf ( V_341 , L_259 ,
( unsigned long long ) F_20 ( V_342 ) ,
( unsigned long long ) F_20 ( F_90 ( V_342 , V_25 ) ) ,
( unsigned long long ) F_20 ( V_25 ) ,
( unsigned long long ) V_22 -> V_96 ,
V_22 -> V_134 , V_284 ) ;
V_340 = F_168 ( V_22 -> V_96 * V_136 ,
F_78 ( V_342 ) ) ;
V_338 = V_340 * 8 * V_22 -> V_134 ;
V_339 = V_338 ;
F_19 ( V_339 , 1000000 ) ;
V_341 += sprintf ( V_341 , L_260 ,
...
if ( V_343 == NULL )
V_343 = V_22 ;
else if ( F_81 ( V_22 -> V_218 , V_343 -> V_218 ) < 0 )
V_343 = V_22 ;
}
F_46 () ;
return V_343 ;
...
{
struct V_344 * V_345 , * V_119 ;
struct V_21 * V_346 ;
F_161 () ;
F_173 (q, n, &t->if_list) {
V_346 = F_174 ( V_345 , struct V_21 , V_347 ) ;
if ( ! V_346 -> V_163 )
continue;
F_126 ( V_346 -> V_244 ) ;
V_346 -> V_244 = NULL ;
...
{
F_178 ( V_154 -> V_348 -> V_349 , V_154 -> V_183 -> V_171 ) ;
}
static void F_179 ( struct V_21 * V_22 )
{
T_5 V_350 = F_18 () ;
F_86 () ;
V_22 -> V_94 += F_78 ( F_90 ( F_18 () , V_350 ) ) ;
}
static void F_180 ( struct V_21 * V_22 )
{
T_5 V_350 = F_18 () ;
while ( F_181 ( & ( V_22 -> V_244 -> V_351 ) ) != 1 ) {
if ( F_88 ( V_12 ) )
break;
if ( F_182 () )
F_179 ( V_22 ) ;
...
V_22 -> V_218 = F_80 ( F_18 () , V_354 ) ;
return;
}
if ( ! V_22 -> V_244 || ( V_22 -> V_143 &&
++ V_22 -> V_355 >= V_22 -> V_30 ) ) {
F_126 ( V_22 -> V_244 ) ;
...
V_22 -> V_96 ++ ;
V_22 -> V_99 ++ ;
if ( F_181 ( & V_244 -> V_351 ) != V_70 ) {
F_191 ( V_70 - 1 , & V_244 -> V_351 ) ;
break;
}
#ifdef F_192
V_244 -> V_358 = 0 ;
...
V_353 = F_193 ( V_50 , V_22 -> V_244 ) ;
F_189 () ;
F_194 ( V_50 , V_353 , F_102 () ) ;
if ( F_131 ( F_195 ( V_353 ) ) ) {
V_155 = V_359 ;
V_22 -> V_143 = 0 ;
goto V_360;
}
F_188 ( V_70 , & V_22 -> V_244 -> V_351 ) ;
V_361:
V_155 = F_196 ( V_22 -> V_244 , V_50 , V_353 , -- V_70 > 0 ) ;
switch ( V_155 ) {
case V_362 :
V_22 -> V_143 = 1 ;
V_22 -> V_96 ++ ;
V_22 -> V_99 ++ ;
V_22 -> V_333 += V_22 -> V_356 ;
if ( V_70 > 0 && ! F_195 ( V_353 ) )
goto V_361;
break;
case V_363 :
case V_364 :
...
case V_366 :
case V_359 :
F_197 ( & ( V_22 -> V_244 -> V_351 ) ) ;
V_22 -> V_143 = 0 ;
}
if ( F_131 ( V_70 ) )
F_191 ( V_70 , & V_22 -> V_244 -> V_351 ) ;
V_360:
F_198 ( V_50 , V_353 ) ;
V_156:
F_199 () ;
...
static int F_200 ( void * V_367 )
{
F_201 ( V_368 ) ;
struct V_153 * V_154 = V_367 ;
struct V_21 * V_22 = NULL ;
int V_369 = V_154 -> V_369 ;
F_43 ( F_102 () != V_369 ) ;
F_202 ( & V_154 -> V_370 ) ;
F_203 ( & V_154 -> V_371 ) ;
F_32 ( L_264 , V_369 , F_204 ( V_12 ) ) ;
F_205 () ;
while ( ! F_206 () ) {
V_22 = F_170 ( V_154 ) ;
...
if ( V_154 -> V_158 & V_335 ) {
F_171 ( V_154 ) ;
V_154 -> V_158 &= ~ ( V_335 ) ;
}
if ( V_154 -> V_158 & V_337 ) {
F_160 ( V_154 ) ;
V_154 -> V_158 &= ~ ( V_337 ) ;
}
...
F_32 ( L_265 , V_154 -> V_348 -> V_349 ) ;
F_171 ( V_154 ) ;
F_32 ( L_266 , V_154 -> V_348 -> V_349 ) ;
F_176 ( V_154 ) ;
F_32 ( L_267 , V_154 -> V_348 -> V_349 ) ;
F_177 ( V_154 ) ;
return 0 ;
}
...
{
struct V_21 * V_341 , * V_22 = NULL ;
T_3 V_120 = strlen ( V_160 ) ;
F_44 () ;
F_45 (p, &t->if_list, list)
if ( strncmp ( V_341 -> V_31 , V_160 , V_120 ) == 0 ) {
if ( V_341 -> V_31 [ V_120 ] ) {
if ( V_161 || V_341 -> V_31 [ V_120 ] != '@' )
continue;
}
V_22 = V_341 ;
break;
...
V_22 -> V_224 = F_215 ( V_150 * sizeof( struct V_378 ) ,
V_71 ) ;
if ( V_22 -> V_224 == NULL ) {
F_216 ( V_22 ) ;
return - V_377 ;
...
V_22 -> V_232 = V_246 ;
V_22 -> V_233 = V_385 ;
V_22 -> V_386 . V_387 = V_229 ;
V_22 -> V_249 . V_169 = V_22 -> V_50 ;
F_217 ( & V_22 -> V_249 , V_388 , false ) ;
V_22 -> V_249 . V_389 = & V_22 -> V_249 ;
V_22 -> V_249 . V_390 = & V_22 -> V_386 ;
#endif
...
static int T_15 F_219 ( int V_369 , struct V_10 * V_11 )
{
struct V_153 * V_154 ;
struct V_391 * V_392 ;
struct V_393 * V_341 ;
...
F_228 ( V_341 , V_369 ) ;
V_154 -> V_348 = V_341 ;
V_392 = F_61 ( V_154 -> V_348 -> V_349 , 0600 , V_11 -> V_171 ,
& V_396 , V_154 ) ;
if ( ! V_392 ) {
F_48 ( L_271 ,
V_383 , V_154 -> V_348 -> V_349 ) ;
F_229 ( V_341 ) ;
F_226 ( & V_154 -> V_394 ) ;
F_216 ( V_154 ) ;
return - V_18 ;
...
F_210 ( V_154 ) ;
F_173 (q, n, &t->if_list) {
V_341 = F_174 ( V_345 , struct V_21 , V_347 ) ;
if ( V_341 == V_22 )
F_234 ( & V_341 -> V_347 ) ;
}
F_212 ( V_154 ) ;
...
F_221 ( & V_11 -> V_395 ) ;
V_11 -> V_177 = false ;
V_11 -> V_171 = F_237 ( V_383 , V_11 -> V_183 -> V_398 ) ;
if ( ! V_11 -> V_171 ) {
F_30 ( L_277 , V_383 ) ;
return - V_185 ;
}
V_392 = F_238 ( V_399 , 0600 , V_11 -> V_171 , & V_400 ) ;
if ( V_392 == NULL ) {
F_48 ( L_278 , V_399 ) ;
V_155 = - V_18 ;
goto remove;
...
return 0 ;
V_401:
F_178 ( V_399 , V_11 -> V_171 ) ;
remove:
F_178 ( V_383 , V_11 -> V_183 -> V_398 ) ;
return V_155 ;
}
...
V_11 -> V_177 = true ;
F_49 ( & V_157 ) ;
F_243 ( & V_11 -> V_395 , & V_347 ) ;
F_51 ( & V_157 ) ;
F_173 (q, n, &list) {
V_154 = F_174 ( V_345 , struct V_153 , V_394 ) ;
F_226 ( & V_154 -> V_394 ) ;
F_229 ( V_154 -> V_348 ) ;
F_244 ( V_154 -> V_348 ) ;
F_216 ( V_154 ) ;
