...
static int F_46 ( struct V_76 * V_48 , unsigned V_77 ,
T_2 V_11 )
{
int V_41 ;
T_1 V_45 ;
...
int F_59 ( struct V_38 * V_39 , T_5 V_40 ,
T_2 * V_19 , void * V_31 , T_5 * V_91 ,
int * V_92 )
__dm_written_to_disk( V_31 )
{
...
static int F_60 ( struct V_66 * V_48 , T_5 V_67 , bool V_100 ,
T_2 * V_68 , T_5 * V_101 )
{
int V_24 , V_41 ;
T_3 V_25 ;
...
static int F_61 ( struct V_38 * V_39 , T_5 V_40 ,
...
F_44 ( & V_53 , V_39 ) ;
for ( V_57 = 0 ; V_57 < V_39 -> V_58 ; V_57 ++ ) {
V_41 = F_60 ( & V_53 , V_40 , V_100 , V_102 + V_57 ,
...
T_2 * V_102 )
{
return F_61 ( V_39 , V_40 , true , V_102 ) ;
}
int F_63 ( struct V_38 * V_39 , T_5 V_40 ,
T_2 * V_102 )
{
return F_61 ( V_39 , V_40 , false , V_102 ) ;
}
static int F_64 ( struct V_38 * V_39 , T_5 V_67 ,
int (* F_65)( void * V_28 , T_2 * V_19 , void * V_103 ) ,
void * V_28 )
{
int V_41 ;
unsigned V_24 , V_104 ;
...
if ( F_4 ( V_10 -> V_15 . V_25 ) & V_26 ) {
V_41 = F_64 ( V_39 , F_9 ( V_10 , V_24 ) , F_65 , V_28 ) ;
if ( V_41 )
goto V_64;
} else {
V_19 = F_5 ( * F_67 ( V_10 , V_24 ) ) ;
V_41 = F_65 ( V_28 , & V_19 , F_10 ( V_10 , V_24 ) ) ;
if ( V_41 )
goto V_64;
}
}
...
{
F_69 ( V_39 -> V_58 > 1 ) ;
return F_64 ( V_39 , V_40 , F_65 , V_28 ) ;
}
