...
V_4 -> V_144 = V_27 -> V_144 ;
if ( F_69 ( V_4 -> V_26 ) )
F_70 ( V_4 , V_27 ) ;
if ( F_69 ( V_4 -> V_145 ) )
memcpy ( V_4 -> V_145 , V_27 -> V_145 , V_4 -> V_146 ) ;
#if F_71 ( V_147 )
V_4 -> V_148 = V_27 -> V_148 ;
#endif
V_4 -> V_149 = V_27 -> V_149 ;
if ( F_72 ( V_27 -> V_139 ,
V_8 ( V_4 ) -> V_25 ) ) {
V_4 -> V_150 = & V_151 ;
V_4 -> V_152 = V_27 -> V_152 ;
} else {
V_4 -> V_150 = & V_153 ;
V_4 -> V_152 = V_27 -> V_152 + V_17 ;
}
V_4 -> V_88 = & V_154 ;
F_73 ( V_4 , & V_155 ) ;
F_63 ( V_4 , F_65 ( V_4 ) ) ;
...
struct V_8 * V_9 = V_8 ( V_4 ) ;
int V_158 ;
for ( V_158 = 0 ; V_158 < F_76 ( V_9 -> V_56 ) ; V_158 ++ ) {
while ( ( V_157 = V_9 -> V_56 [ V_158 ] ) != NULL ) {
V_9 -> V_56 [ V_158 ] = V_157 -> V_58 ;
F_77 ( V_157 ) ;
}
}
}
...
struct V_163 * V_164 )
{
F_83 ( V_164 -> V_165 , V_166 , sizeof( V_164 -> V_165 ) ) ;
F_83 ( V_164 -> V_167 , V_168 , sizeof( V_164 -> V_167 ) ) ;
F_83 ( V_164 -> V_169 , L_2 , sizeof( V_164 -> V_169 ) ) ;
}
static int F_84 ( struct V_3 * V_4 ,
struct V_170 * V_164 )
{
const struct V_8 * V_9 = V_8 ( V_4 ) ;
const struct V_171 * V_87 = V_9 -> V_27 -> V_171 ;
if ( V_87 -> V_172 ) {
return V_87 -> V_172 ( V_9 -> V_27 , V_164 ) ;
} else {
V_164 -> V_173 = V_174 |
V_175 ;
V_164 -> V_176 = - 1 ;
...
static struct V_177 * F_85 ( struct V_3 * V_4 , struct V_177 * V_38 )
{
struct V_37 * V_78 ;
T_3 V_178 = 0 , V_42 = 0 ;
int V_158 ;
F_86 (i) {
T_4 V_179 , V_180 , V_181 , V_182 , V_183 ;
unsigned int V_184 ;
V_78 = F_87 ( V_8 ( V_4 ) -> V_37 , V_158 ) ;
do {
V_184 = F_88 ( & V_78 -> V_39 ) ;
V_179 = V_78 -> V_185 ;
V_180 = V_78 -> V_186 ;
V_181 = V_78 -> V_187 ;
V_182 = V_78 -> V_40 ;
V_183 = V_78 -> V_41 ;
} while ( F_89 ( & V_78 -> V_39 , V_184 ) );
V_38 -> V_185 += V_179 ;
V_38 -> V_186 += V_180 ;
V_38 -> V_188 += V_181 ;
V_38 -> V_40 += V_182 ;
...
static int F_91 ( struct V_3 * V_4 , struct V_189 * V_190 )
{
struct V_8 * V_9 = V_8 ( V_4 ) ;
struct V_3 * V_27 = V_9 -> V_27 ;
struct V_28 * V_28 ;
