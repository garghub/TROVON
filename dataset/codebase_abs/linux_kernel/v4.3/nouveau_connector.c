...
struct V_15 * V_17 = V_15 ( V_3 ) ;
struct V_22 * V_23 = V_22 ( V_3 -> V_5 ) ;
struct V_160 * V_14 = V_17 -> V_45 -> V_14 ;
if ( V_14 -> V_161 != V_162 ||
V_23 -> V_26 . V_46 . V_163 >= 0x46 )
return 165000 ;
else if ( V_23 -> V_26 . V_46 . V_163 >= 0x40 )
return 155000 ;
else if ( V_23 -> V_26 . V_46 . V_163 >= 0x18 )
return 135000 ;
else
return 112000 ;
}
...
struct V_1 * V_6 = V_17 -> V_45 ;
struct V_7 * V_16 = F_4 ( V_6 ) ;
unsigned V_164 = 25000 , V_165 = V_164 ;
...
case V_38 :
V_165 = F_58 ( V_3 ) ;
if ( V_167 && V_6 -> V_14 -> V_168 )
V_165 *= 2 ;
break;
case V_39 :
V_165 = V_6 -> V_14 -> V_169 . V_170 ;
if ( ! V_165 )
V_165 = 350000 ;
break;
case V_73 :
...
case V_31 :
V_165 = V_6 -> V_171 . V_172 ;
V_165 *= V_6 -> V_171 . V_173 ;
...
return F_65 ( V_3 , V_111 ) ;
}
static int
F_66 ( struct V_182 * V_183 )
{
struct V_15 * V_17 =
F_67 ( V_183 , F_68 ( * V_17 ) , V_18 ) ;
struct V_2 * V_3 = & V_17 -> V_55 ;
struct V_22 * V_23 = V_22 ( V_3 -> V_5 ) ;
const struct V_184 * V_185 = V_183 -> V_178 ;
const char * V_40 = V_3 -> V_40 ;
if ( V_185 -> V_186 & V_187 ) {
} else {
bool V_188 = ( V_185 -> V_186 != V_189 ) ;
F_48 ( V_23 , L_7 , V_188 ? L_8 : L_9 , V_40 ) ;
if ( V_188 )
F_65 ( V_3 , V_177 ) ;
else
F_65 ( V_3 , V_190 ) ;
...
static T_2
F_70 ( struct V_192 * V_193 , struct V_194 * V_195 )
{
struct V_15 * V_17 =
F_67 ( V_193 , F_68 ( * V_17 ) , V_20 ) ;
struct V_1 * V_6 ;
struct V_196 * V_20 ;
int V_32 ;
...
if ( V_32 )
return V_32 ;
V_32 = F_73 ( V_20 , false , V_195 -> V_199 , V_195 -> V_200 ,
V_195 -> V_201 , V_195 -> V_197 ) ;
F_74 ( V_20 ) ;
if ( V_32 >= 0 ) {
V_195 -> V_202 = V_32 ;
return V_195 -> V_197 ;
...
case V_210 :
case V_211 :
case V_54 : return V_212 ;
case V_213 : return V_214 ;
case V_101 :
case V_102 : return V_159 ;
case V_215 :
case V_216 :
case V_217 : return V_218 ;
case V_29 : return V_219 ;
case V_220 :
case V_221 :
...
struct V_2 *
F_76 ( struct V_4 * V_5 , int V_225 )
{
const struct V_226 * V_227 = & V_228 ;
struct V_22 * V_23 = V_22 ( V_5 ) ;
...
V_17 = F_77 ( sizeof( * V_17 ) , V_44 ) ;
if ( ! V_17 )
return F_78 ( - V_230 ) ;
V_3 = & V_17 -> V_55 ;
V_17 -> V_225 = V_225 ;
V_17 -> V_14 = F_79 ( V_5 , V_225 ) ;
if ( V_17 -> V_14 ) {
T_3 V_231 = F_80 ( V_17 -> V_14 [ 0 ] ) ;
if ( F_81 ( V_5 ) [ 3 ] >= 4 )
V_231 |= ( T_3 ) F_80 ( V_17 -> V_14 [ 2 ] ) << 16 ;
...
if ( F_83 ( V_5 , 0x0421 , 0x1458 , 0x344c ) ) {
if ( V_17 -> type == V_221 )
V_17 -> type = V_54 ;
}
if ( F_83 ( V_5 , 0x0402 , 0x1458 , 0x3455 ) ) {
if ( V_17 -> type == V_221 )
V_17 -> type = V_54 ;
}
} else {
...
if ( V_17 -> type == V_232 ) {
struct V_22 * V_23 = V_22 ( V_5 ) ;
struct V_233 * V_234 = & V_23 -> V_79 . V_14 ;
T_3 V_235 = 0 ;
int V_9 ;
for ( V_9 = 0 ; V_9 < V_234 -> V_236 ; V_9 ++ ) {
if ( V_234 -> V_231 [ V_9 ] . V_3 == V_17 -> V_225 )
V_235 |= ( 1 << V_234 -> V_231 [ V_9 ] . type ) ;
}
if ( V_235 & ( 1 << V_31 ) ) {
if ( V_235 & ( 1 << V_38 ) )
V_17 -> type = V_217 ;
...
switch ( ( type = F_75 ( V_17 -> type ) ) ) {
case V_159 :
V_32 = F_84 ( V_5 , 0 , & V_229 , & V_229 ) ;
if ( V_32 ) {
F_32 ( V_23 , L_11 ) ;
F_8 ( V_17 ) ;
return F_78 ( V_32 ) ;
...
V_3 -> V_49 = false ;
V_3 -> V_50 = false ;
F_86 ( V_5 , V_3 , V_227 , type ) ;
F_87 ( V_3 , & V_239 ) ;
if ( V_17 -> type == V_54 )
F_88 ( & V_3 -> V_55 , V_5 -> V_56 . V_57 , 0 ) ;
if ( V_94 -> V_114 &&
( type == V_214 ||
type == V_212 ||
type == V_223 ||
...
V_32 = F_89 (&disp->disp, nouveau_connector_hotplug, true,
NV04_DISP_NTFY_CONN,
