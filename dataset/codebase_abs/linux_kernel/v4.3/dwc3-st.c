...
struct V_8 * V_8 ;
int V_42 ;
V_5 = F_15 ( V_22 , sizeof( * V_5 ) , V_43 ) ;
if ( ! V_5 )
return - V_44 ;
V_36 = F_16 ( V_34 , V_45 , L_2 ) ;
...
static int F_34 ( struct V_37 * V_22 )
{
struct V_4 * V_5 = F_35 ( V_22 ) ;
F_29 ( V_5 -> V_50 ) ;
F_29 ( V_5 -> V_51 ) ;
F_36 ( V_22 ) ;
return 0 ;
}
static int F_37 ( struct V_37 * V_22 )
{
struct V_4 * V_5 = F_35 ( V_22 ) ;
int V_42 ;
F_38 ( V_22 ) ;
