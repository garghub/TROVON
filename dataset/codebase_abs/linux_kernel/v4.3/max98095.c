...
V_126 = 0 ;
V_127 = V_133 ;
for ( V_17 = 0 ; V_17 < V_121 -> V_131 ; V_17 ++ ) {
if ( strcmp ( V_121 -> V_134 [ V_17 ] . V_119 , V_29 -> V_135 [ V_30 ] ) == 0 &&
abs ( V_121 -> V_134 [ V_17 ] . V_50 - V_125 ) < V_127 ) {
V_126 = V_17 ;
V_127 = abs ( V_121 -> V_134 [ V_17 ] . V_50 - V_125 ) ;
}
}
F_37 ( V_12 -> V_2 , L_8 ,
V_121 -> V_134 [ V_126 ] . V_119 ,
V_121 -> V_134 [ V_126 ] . V_50 , V_125 ) ;
V_124 = & V_121 -> V_134 [ V_126 ] ;
V_128 = ( V_45 == 0 ) ? V_136 : V_137 ;
V_129 = F_28 ( V_12 , V_138 ) ;
F_13 ( V_12 , V_138 , V_128 , 0 ) ;
F_49 ( & V_29 -> V_139 ) ;
F_13 ( V_12 , V_7 , V_140 , V_140 ) ;
F_4 ( V_12 , V_45 , 0 , V_124 -> V_141 ) ;
F_4 ( V_12 , V_45 , 1 , V_124 -> V_142 ) ;
F_4 ( V_12 , V_45 , 2 , V_124 -> V_143 ) ;
F_4 ( V_12 , V_45 , 3 , V_124 -> V_144 ) ;
F_4 ( V_12 , V_45 , 4 , V_124 -> V_145 ) ;
F_13 ( V_12 , V_7 , V_140 , 0 ) ;
F_50 ( & V_29 -> V_139 ) ;
F_13 ( V_12 , V_138 , V_128 , V_129 ) ;
return 0 ;
}
...
struct V_58 * V_59 ;
V_59 = & V_29 -> V_13 [ V_45 ] ;
V_27 -> V_31 . V_146 . V_147 [ 0 ] = V_59 -> V_132 ;
return 0 ;
}
...
for ( V_150 = 0 ; V_150 < V_29 -> V_130 ; V_150 ++ ) {
if ( strcmp ( V_148 [ V_17 ] . V_119 , V_29 -> V_135 [ V_150 ] ) == 0 )
break;
}
if ( V_150 != V_29 -> V_130 )
continue;
V_151 = F_54 ( V_29 -> V_135 ,
sizeof( char * ) * ( V_29 -> V_130 + 1 ) ,
V_155 ) ;
if ( V_151 == NULL )
continue;
V_151 [ V_29 -> V_130 ] = V_148 [ V_17 ] . V_119 ;
V_29 -> V_130 ++ ;
V_29 -> V_135 = V_151 ;
}
V_29 -> V_154 . V_156 = V_29 -> V_135 ;
V_29 -> V_154 . V_157 = V_29 -> V_130 ;
...
abs ( V_121 -> V_163 [ V_17 ] . V_50 - V_125 ) < V_127 ) {
V_126 = V_17 ;
V_127 = abs ( V_121 -> V_163 [ V_17 ] . V_50 - V_125 ) ;
}
}
F_37 ( V_12 -> V_2 , L_8 ,
V_121 -> V_163 [ V_126 ] . V_119 ,
V_121 -> V_163 [ V_126 ] . V_50 , V_125 ) ;
V_124 = & V_121 -> V_163 [ V_126 ] ;
V_128 = ( V_45 == 0 ) ? V_165 : V_166 ;
V_129 = F_28 ( V_12 , V_138 ) ;
F_13 ( V_12 , V_138 , V_128 , 0 ) ;
F_49 ( & V_29 -> V_139 ) ;
F_13 ( V_12 , V_7 , V_140 , V_140 ) ;
F_9 ( V_12 , V_45 , 0 , V_124 -> V_141 ) ;
F_9 ( V_12 , V_45 , 1 , V_124 -> V_142 ) ;
F_13 ( V_12 , V_7 , V_140 , 0 ) ;
F_50 ( & V_29 -> V_139 ) ;
F_13 ( V_12 , V_138 , V_128 , V_129 ) ;
return 0 ;
...
return V_45 ;
V_59 = & V_29 -> V_13 [ V_45 ] ;
V_27 -> V_31 . V_146 . V_147 [ 0 ] = V_59 -> V_162 ;
return 0 ;
}
