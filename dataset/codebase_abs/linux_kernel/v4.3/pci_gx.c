...
void F_67 ( struct V_105 * V_127 )
{
}
char * T_4 F_68 ( char * V_117 )
{
...
static void F_69 ( struct V_100 * V_158 )
{
F_70 ( & V_158 -> V_101 , V_159 ) ;
F_71 ( & V_158 -> V_101 , V_156 ) ;
V_158 -> V_101 . V_160 . V_161 =
V_162 ;
V_158 -> V_101 . V_163 = V_162 ;
}
void T_11 * F_72 ( T_1 V_164 , unsigned long V_4 )
{
...
void T_11 * F_73 ( unsigned long V_169 , unsigned int V_4 )
{
struct V_58 * V_59 = NULL ;
T_1 V_165 ;
T_1 V_166 ;
...
void F_74 ( void T_11 * V_170 )
{
F_75 ( V_170 ) ;
}
void F_76 ( struct V_100 * V_101 , void T_11 * V_170 )
{
F_75 ( V_170 ) ;
}
static int F_77 ( struct V_105 * V_127 , unsigned int V_171 , int V_122 ,
int V_4 , T_12 * V_172 )
{
struct V_58 * V_59 = V_127 -> V_104 ;
T_2 * V_60 = V_59 -> V_61 ;
int V_173 = V_127 -> V_174 & 0xff ;
int V_102 = F_78 ( V_171 ) ;
int V_175 = F_79 ( V_171 ) ;
int V_176 = 1 ;
T_13 V_177 ;
void * V_178 ;
if ( F_80 ( V_127 ) ) {
...
F_83 ( V_4 , * V_172 , V_173 , V_102 , V_175 , V_122 ) ;
return 0 ;
V_181:
switch ( V_4 ) {
case 4 :
...
static int F_84 ( struct V_105 * V_127 , unsigned int V_171 , int V_122 ,
int V_4 , T_12 V_172 )
{
struct V_58 * V_59 = V_127 -> V_104 ;
T_2 * V_60 = V_59 -> V_61 ;
...
case 4 :
F_46 ( V_178 , V_185 ) ;
F_85 ( V_4 , V_185 , V_173 , V_102 , V_175 , V_122 ) ;
break;
case 2 :
F_86 ( V_178 , V_186 ) ;
F_85 ( V_4 , V_186 , V_173 , V_102 , V_175 , V_122 ) ;
break;
case 1 :
F_87 ( V_178 , V_187 ) ;
F_85 ( V_4 , V_187 , V_173 , V_102 , V_175 , V_122 ) ;
break;
default:
return V_184 ;
}
...
static unsigned int F_88 ( struct V_51 * V_52 )
{
if ( F_89 ( V_52 ) )
F_90 ( V_52 ) ;
return 0 ;
...
int F_95 ( struct V_100 * V_158 , struct V_188 * V_57 )
{
struct V_58 * V_59 ;
T_2 * V_60 ;
struct V_189 V_190 ;
