...
F_9 ( struct V_18 * V_5 )
{
struct V_40 * V_41 = V_5 -> V_42 . V_43 . V_44 . V_41 ;
int V_30 , V_45 , V_46 ;
for ( V_45 = 0 , V_46 = 0 ; V_45 < 4 ; V_45 ++ ) {
for ( V_30 = 0 ; V_30 < V_5 -> V_33 ; V_30 ++ ) {
if ( V_45 < V_5 -> V_47 [ V_30 ] ) {
F_10 ( V_41 , F_11 ( V_30 , V_45 , 0x698 ) , V_46 ) ;
F_10 ( V_41 , F_12 ( V_30 , 0x0c10 + V_45 * 4 ) , V_46 ) ;
F_10 ( V_41 , F_11 ( V_30 , V_45 , 0x088 ) , V_46 ) ;
V_46 ++ ;
}
F_10 ( V_41 , F_12 ( V_30 , 0x0c08 ) , V_5 -> V_47 [ V_30 ] ) ;
F_10 ( V_41 , F_12 ( V_30 , 0x0c8c ) , V_5 -> V_47 [ V_30 ] ) ;
}
}
}
static void
...
F_16 ( V_5 ) ;
F_17 ( V_5 ) ;
F_10 ( V_41 , 0x4064d0 , 0x00000001 ) ;
for ( V_48 = 1 ; V_48 < 8 ; V_48 ++ )
F_10 ( V_41 , 0x4064d0 + ( V_48 * 0x04 ) , 0x00000000 ) ;
F_10 ( V_41 , 0x406500 , 0x00000001 ) ;
F_10 ( V_41 , 0x405b00 , ( V_5 -> V_26 << 8 ) | V_5 -> V_33 ) ;
F_18 ( V_5 ) ;
F_19 ( V_5 , V_4 -> V_54 ) ;
F_10 ( V_41 , 0x404154 , 0x00000400 ) ;
F_20 ( V_5 , V_4 -> V_55 ) ;
F_21 ( V_41 , 0x419e00 , 0x00808080 , 0x00808080 ) ;
F_21 ( V_41 , 0x419ccc , 0x80000000 , 0x80000000 ) ;
F_21 ( V_41 , 0x419f80 , 0x80000000 , 0x80000000 ) ;
F_21 ( V_41 , 0x419f88 , 0x80000000 , 0x80000000 ) ;
}
