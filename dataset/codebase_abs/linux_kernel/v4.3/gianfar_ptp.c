...
if ( F_27 ( V_1 -> V_13 , F_8 , 0 , V_89 , V_1 ) ) {
F_25 ( L_10 ) ;
goto V_87;
}
V_1 -> V_90 = F_28 ( V_74 , V_91 , 0 ) ;
if ( ! V_1 -> V_90 ) {
F_25 ( L_11 ) ;
goto V_92;
}
if ( F_29 ( & V_93 , V_1 -> V_90 ) ) {
F_25 ( L_12 ) ;
goto V_92;
}
F_30 ( & V_1 -> V_34 ) ;
V_1 -> V_5 = F_31 ( V_1 -> V_90 -> V_94 ,
F_32 ( V_1 -> V_90 ) ) ;
if ( ! V_1 -> V_5 ) {
F_25 ( L_13 ) ;
goto V_95;
...
F_4 ( & V_1 -> V_5 -> V_12 , V_1 -> V_12 ) ;
F_5 ( V_1 ) ;
F_4 ( & V_1 -> V_5 -> V_78 , V_78 | V_100 | V_101 | V_102 | V_103 ) ;
F_15 ( & V_1 -> V_34 , V_53 ) ;
