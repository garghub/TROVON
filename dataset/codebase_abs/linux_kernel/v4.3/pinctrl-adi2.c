...
if ( V_2 == NULL )
return - V_35 ;
V_6 = F_51 ( V_2 -> V_85 , struct V_5 , V_48 ) ;
F_15 ( & V_6 -> V_27 , V_24 ) ;
F_9 ( V_6 , F_1 ( V_2 , V_3 ) ,
F_52 ( * V_59 ) ) ;
...
static void F_59 ( struct V_89 * V_48 , unsigned V_14 )
{
F_60 ( V_48 -> V_49 + V_14 ) ;
}
...
static void F_62 ( struct V_89 * V_48 , unsigned V_14 ,
int V_90 )
{
...
static int F_63 ( struct V_89 * V_48 , unsigned V_14 ,
int V_90 )
{
struct V_5 * V_6 = F_51 ( V_48 , struct V_5 , V_48 ) ;
struct V_16 * V_17 = V_6 -> V_17 ;
...
return F_66 ( V_6 -> V_70 , V_14 ) ;
}
static int F_67 ( struct V_10 * V_12 , bool V_57 , T_1 V_93 ,
struct V_69 * V_70 )
{
struct V_25 * V_17 = V_12 -> V_17 ;
T_2 V_94 ;
...
struct V_100 * V_101 ;
struct V_10 * V_12 ;
V_12 = F_69 ( V_99 , sizeof( struct V_10 ) , V_102 ) ;
if ( ! V_12 ) {
F_70 ( V_99 , L_3 ) ;
return - V_103 ;
}
V_101 = F_71 ( V_97 , V_104 , 0 ) ;
V_12 -> V_49 = F_72 ( V_99 , V_101 ) ;
if ( F_73 ( V_12 -> V_49 ) )
return F_74 ( V_12 -> V_49 ) ;
V_12 -> V_17 = (struct V_25 * ) V_12 -> V_49 ;
V_101 = F_71 ( V_97 , V_105 , 0 ) ;
if ( ! V_101 ) {
F_70 ( V_99 , L_4 ) ;
return - V_35 ;
}
...
F_77 ( V_12 -> V_34 , F_37 ,
V_12 ) ;
F_78 ( & V_12 -> V_108 , & V_109 ) ;
return 0 ;
}
static int F_79 ( struct V_96 * V_97 )
{
struct V_10 * V_12 = F_80 ( V_97 ) ;
F_81 ( & V_12 -> V_108 ) ;
F_82 ( V_12 -> V_34 , V_110 ) ;
return 0 ;
}
static int F_83 ( struct V_69 * V_23 , unsigned int V_34 ,
T_4 V_7 )
{
...
if ( ! V_120 )
return - V_55 ;
V_6 = F_69 ( V_99 , sizeof( struct V_5 ) , V_102 ) ;
if ( ! V_6 ) {
F_70 ( V_99 , L_3 ) ;
return - V_103 ;
}
V_101 = F_71 ( V_97 , V_104 , 0 ) ;
V_6 -> V_49 = F_72 ( V_99 , V_101 ) ;
if ( F_73 ( V_6 -> V_49 ) )
...
V_6 -> V_48 . V_132 = F_65 ;
if ( V_120 -> V_133 > 0 )
V_6 -> V_48 . V_49 = V_120 -> V_133 ;
else
V_6 -> V_48 . V_49 = V_123 ;
V_6 -> V_48 . V_134 = V_6 -> V_115 ;
...
V_120 -> V_136 ) ;
V_121 [ V_122 - 1 ] = 0 ;
V_40 = F_91 ( & V_6 -> V_48 , V_121 ,
0 , V_120 -> V_137 , V_6 -> V_115 ) ;
if ( V_40 ) {
F_70 ( & V_97 -> V_99 , L_10 ,
V_121 ) ;
goto V_138;
}
F_78 ( & V_6 -> V_108 , & V_139 ) ;
return 0 ;
V_138:
F_92 ( & V_6 -> V_48 ) ;
V_135:
...
static int F_94 ( struct V_96 * V_97 )
{
struct V_5 * V_6 = F_80 ( V_97 ) ;
T_1 V_14 ;
F_81 ( & V_6 -> V_108 ) ;
F_92 ( & V_6 -> V_48 ) ;
if ( V_6 -> V_12 ) {
...
{
struct V_73 * V_74 ;
V_74 = F_69 ( & V_97 -> V_99 , sizeof( * V_74 ) , V_102 ) ;
if ( ! V_74 )
return - V_103 ;
V_74 -> V_99 = & V_97 -> V_99 ;
F_97 ( & V_74 -> V_75 ) ;
V_140 . V_80 = V_74 -> V_75 -> V_80 ;
V_140 . V_141 = V_74 -> V_75 -> V_141 ;
V_74 -> V_142 = F_98 ( & V_140 , & V_97 -> V_99 , V_74 ) ;
if ( F_73 ( V_74 -> V_142 ) ) {
F_70 ( & V_97 -> V_99 , L_11 ) ;
return F_74 ( V_74 -> V_142 ) ;
}
F_76 ( V_97 , V_74 ) ;
return 0 ;
}
