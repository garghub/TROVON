...
F_6 ( L_50 , V_5 , V_32 ,
V_7 -> V_54 ) ;
memcpy ( F_53 ( V_32 , 1 ) , & F_54 ( V_32 ) -> V_85 , 1 ) ;
if ( ! F_55 ( V_86 , & V_7 -> V_53 ) ) {
F_10 ( & V_7 -> V_35 , V_32 ) ;
return 0 ;
}
F_48 ( & V_7 -> V_40 , V_53 ) ;
...
static int F_59 ( struct V_4 * V_5 , const void * V_69 , int V_87 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
if ( ! F_55 ( V_88 , & V_5 -> V_53 ) )
return - V_89 ;
V_7 -> V_83 = F_60 ( V_5 -> V_76 , V_7 -> V_83 , V_69 , V_87 ,
V_90 , F_61 ( V_90 ) ) ;
if ( F_62 ( V_7 -> V_83 ) ) {
int V_30 = F_63 ( V_7 -> V_83 ) ;
F_5 ( L_56 , V_5 -> V_76 -> V_91 , V_30 ) ;
V_7 -> V_83 = NULL ;
return V_30 ;
}
return V_87 ;
...
static int F_66 ( struct V_75 * V_76 , T_3 V_106 )
{
struct V_4 * V_5 = F_35 ( V_76 ) ;
struct V_6 * V_7 = V_5 -> V_8 ;
struct V_31 * V_32 ;
...
if ( V_5 -> V_114 )
V_92 = V_5 -> V_114 ;
else if ( V_5 -> V_115 -> V_114 )
V_92 = V_5 -> V_115 -> V_114 ;
if ( V_92 )
F_72 ( V_5 , V_92 ) ;
V_92 = 0 ;
if ( V_5 -> V_116 )
V_92 = V_5 -> V_116 ;
else if ( V_5 -> V_115 -> V_116 )
V_92 = V_5 -> V_115 -> V_116 ;
if ( V_92 ) {
V_112 = F_65 ( V_92 ) ;
F_70 ( L_59 , V_76 -> V_91 , V_92 ) ;
V_113 = F_66 ( V_76 , V_112 ) ;
if ( V_113 ) {
F_5 ( L_60 ,
V_76 -> V_91 , V_113 ) ;
return V_113 ;
...
V_113 = F_73 ( V_76 , V_112 ) ;
if ( ! V_113 ) {
F_74 ( V_86 , & V_7 -> V_53 ) ;
F_34 ( V_76 ) ;
}
V_5 -> V_76 -> V_117 = V_118 ;
return V_113 ;
}
int T_4 F_75 ( void )
{
