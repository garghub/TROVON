...
switch ( V_45 ) {
case 0 :
F_7 ( V_48 -> V_84 , 0x08 , 0x02 ) ;
break;
case 1 :
F_7 ( V_48 -> V_84 , 0x08 , 0x04 ) ;
break;
case 2 :
F_7 ( V_48 -> V_84 , 0x08 , 0x05 ) ;
break;
default:
return - V_52 ;
}
...
V_48 -> V_45 == 1 ? L_13 :
L_14 ) ;
F_26 ( V_3 , L_15 , V_48 -> V_85 == 0 ? L_16 :
V_48 -> V_85 == 1 ? L_17 :
V_48 -> V_85 == 2 ? L_18 :
L_14 ) ;
return F_27 ( V_3 ) ;
...
{
struct V_20 * V_84 ;
struct V_89 * V_23 = V_21 -> V_23 ;
struct V_1 * V_48 ;
struct V_2 * V_3 ;
T_2 * V_90 ;
struct V_4 * V_5 = F_8 ( V_23 ) ;
struct V_12 * V_13 = V_5 -> V_14 ;
V_84 = F_29 ( V_23 , V_91 >> 1 ) ;
if ( V_84 == NULL )
return - V_33 ;
...
V_48 -> V_100 = 0 ;
V_48 -> V_84 = V_84 ;
if ( F_17 ( V_84 , V_101 ) < 0 ) {
F_35 ( & V_21 -> V_35 , L_21 ) ;
goto V_102;
}
if ( F_17 ( V_21 , V_103 ) < 0 ) {
F_35 ( & V_21 -> V_35 , L_22 ) ;
goto V_102;
}
if ( F_18 ( V_21 , V_56 ) < 0 ) {
