...
const struct V_1 * V_2 , char * V_6 , int V_13 )
{
return F_12 ( V_6 , V_13 , L_7 ,
F_41 ( & V_2 -> V_45 . V_48 . V_83 . V_84 ) ) ;
}
static T_1 F_42 (
const struct V_1 * V_2 , char * V_6 , int V_13 )
{
struct V_31 * V_32 = V_2 -> V_32 ;
T_8 V_85 ;
V_85 = F_43 ( V_32 , (struct V_1 * ) V_2 ) ;
return F_12 ( V_6 , V_13 , L_8 , ( unsigned long long ) V_85 ) ;
}
static T_1 F_44 (
struct V_1 * V_2 , const char * V_6 , int V_13 )
{
...
int V_7 ;
int V_86 = 0 ;
if ( strncmp ( V_6 , L_9 , 5 ) == 0 ) {
if ( V_32 -> V_87 -> V_88 ) {
F_45 ( V_32 , V_2 ) ;
F_46 ( V_32 -> V_34 . V_35 , L_10 ) ;
}
} else {
if ( V_13 > 10 && V_6 [ 1 ] == '=' ) {
if ( V_6 [ 0 ] == '+' )
...
V_7 = F_47 ( V_6 , 10 , & V_85 ) ;
if ( V_7 < 0 )
return V_7 ;
if ( V_86 )
V_85 = F_43 ( V_32 , V_2 ) + V_86 * V_85 ;
if ( V_32 -> V_87 -> V_89 ) {
F_48 ( V_32 , V_2 , V_85 ) ;
F_46 ( V_32 -> V_34 . V_35 ,
L_11 , V_85 ) ;
...
{
char V_6 [ 10 + V_153 ] ;
sprintf ( V_6 , L_14 , V_2 -> T_9 ) ;
V_2 -> V_21 . V_112 = F_59 ( V_6 ,
V_2 -> V_32 -> V_34 . V_35 -> V_154 ) ;
if ( V_2 -> V_21 . V_112 )
V_2 -> V_155 . V_156 = F_59 ( L_15 ,
V_2 -> V_21 . V_112 ) ;
F_63 ( V_2 ) ;
}
...
F_67 ( V_2 -> V_21 . V_112 ) ;
V_2 -> V_21 . V_112 = NULL ;
V_2 -> V_155 . V_156 = NULL ;
}
void F_68 ( struct V_1 * V_2 )
{
struct V_110 * V_111 ;
char V_6 [ 10 + V_153 ] ;
V_111 = V_2 -> V_21 . V_112 ;
if ( ! V_111 )
return;
sprintf ( V_6 , L_14 , V_2 -> T_9 ) ;
if ( ! F_69 ( V_111 -> V_157 , V_111 , V_111 -> V_157 , V_6 ) )
F_70 ( V_2 ,
L_16 ,
V_6 ) ;
}
