...
V_7 = F_35 ( V_6 . V_19 , sizeof( V_7 [ 0 ] ) , V_51 ) ;
if ( ! V_7 ) {
V_11 = - V_18 ;
goto V_50;
}
...
F_11 ( & V_31 ) ;
V_2 = F_26 ( V_9 , V_6 . V_25 , V_6 . V_19 ) ;
if ( V_2 ) {
for ( V_10 = 0 ; V_10 < V_6 . V_19 ; V_10 ++ ) {
...
V_72 = F_45 ( sizeof( * V_72 ) , V_20 ) ;
if ( ! V_72 )
return - V_18 ;
F_11 ( & V_31 ) ;
F_30 ( L_3 , V_47 ,
V_9 , V_72 , V_69 -> V_78 , V_19 ) ;
V_2 = F_26 ( V_9 , V_69 -> V_78 << V_75 , V_19 ) ;
if ( V_2 == NULL ) {
V_41 = - V_59 ;
F_30 ( L_4 ,
V_47 ) ;
...
V_2 -> V_4 ++ ;
V_41 = F_46 ( V_69 , V_69 -> V_74 + V_10 * V_26 ,
V_2 -> V_27 ) ;
if ( V_41 )
goto V_79;
