...
V_4 = F_15 ( & V_27 -> V_12 , sizeof( * V_4 ) , V_33 ) ;
if ( ! V_4 )
return - V_34 ;
if ( F_14 ( V_29 , L_3 , NULL ) )
V_9 = F_13 ( V_27 , V_4 ) ;
else
V_9 = F_17 ( V_27 , V_4 ) ;
if ( V_9 )
return V_9 ;
V_42 = F_19 ( & V_27 -> V_12 , V_29 ,
& V_36 ) ;
if ( ! V_42 )
return - V_34 ;
V_45 . V_30 = V_29 ;
...
V_45 . V_46 = V_4 ;
V_45 . V_42 = V_42 ;
V_4 -> V_10 = F_20 ( & V_27 -> V_12 , NULL ) ;
if ( F_21 ( V_4 -> V_10 ) ) {
F_6 ( & V_27 -> V_12 , L_7 ) ;
return F_22 ( V_4 -> V_10 ) ;
}
V_43 = F_23 ( & V_27 -> V_12 ,
& V_36 , & V_45 ) ;
if ( F_21 ( V_43 ) ) {
