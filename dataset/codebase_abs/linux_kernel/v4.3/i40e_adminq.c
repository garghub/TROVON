...
V_156 = ( F_23 ( V_7 , V_7 -> V_8 . V_20 . V_12 ) & V_158 ) ;
if ( V_156 == V_121 ) {
V_36 = V_159 ;
goto V_160;
}
...
V_153 -> V_2 = * V_2 ;
V_60 = F_50 ( V_2 -> V_60 ) ;
V_153 -> V_163 = F_53 ( V_60 , V_153 -> V_164 ) ;
if ( V_153 -> V_165 != NULL && ( V_153 -> V_163 != 0 ) )
memcpy ( V_153 -> V_165 , V_7 -> V_8 . V_20 . V_50 . V_51 [ V_155 ] . V_52 ,
V_153 -> V_163 ) ;
F_44 ( V_7 , V_123 , L_13 ) ;
F_48 ( V_7 , V_146 , ( void * ) V_2 , V_153 -> V_165 ,
V_7 -> V_8 . V_54 ) ;
