...
{
struct V_1 * V_2 ;
int V_38 = F_37 ( args -> V_39 * args -> V_40 , 8 ) ;
V_38 = F_38 ( V_38 , 64 ) ;
if ( args -> V_41 < V_38 )
args -> V_41 = V_38 ;
if ( args -> V_14 < args -> V_41 * args -> V_42 )
args -> V_14 = args -> V_41 * args -> V_42 ;
V_2 = F_26 ( V_30 , V_9 , args -> V_14 ,
& args -> V_31 ) ;
return F_39 ( V_2 ) ;
}
struct V_43 * F_40 ( struct V_4 * V_5 )
{
struct V_1 * V_2 = F_9 ( V_5 ) ;
struct V_7 * V_8 = V_5 -> V_9 ;
struct V_43 * V_44 ;
int V_20 ;
V_44 = F_20 ( sizeof( * V_44 ) , V_16 ) ;
if ( ! V_44 )
return F_21 ( - V_17 ) ;
V_20 = F_41 ( V_8 -> V_9 , V_44 , V_2 -> V_13 ,
V_2 -> V_15 , V_5 -> V_14 ,
& V_2 -> V_10 ) ;
if ( V_20 ) {
F_5 ( L_4 , V_20 ) ;
...
{
struct V_1 * V_2 = F_9 ( V_5 ) ;
if ( F_43 ( V_12 , & V_2 -> V_10 ) )
return NULL ;
return V_2 -> V_13 ;
}
void F_44 ( struct V_4 * V_5 , void * V_45 )
{
}
