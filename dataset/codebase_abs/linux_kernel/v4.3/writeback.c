...
unsigned V_102 , V_91 , V_103 ;
bool V_104 = false ;
V_91 = F_75 ( & V_2 -> V_5 , F_66 ( & V_99 -> V_105 ) ) ;
...
if ( V_91 == V_2 -> V_5 . V_95 )
goto V_25;
V_103 = F_83 ( V_2 -> V_5 . V_97 ,
V_2 -> V_5 . V_95 , V_91 ) ;
V_99 -> V_105 = F_84 ( V_2 -> V_5 . V_106 ,
V_91 * V_2 -> V_5 . V_93 , 0 ) ;
F_85 ( V_2 -> V_5 . V_4 , V_99 ,
& F_84 ( V_2 -> V_5 . V_106 ,
V_103 * V_2 -> V_5 . V_93 , 0 ) ,
F_80 ) ;
if ( F_86 ( & V_99 -> V_107 ) )
return;
V_91 = V_103 ;
...
{
struct V_98 * V_99 = & V_2 -> V_69 ;
struct V_100 V_108 = F_84 ( V_2 -> V_5 . V_106 , V_109 , 0 ) ;
bool V_110 = false ;
if ( V_2 -> V_111 ) {
F_81 ( V_2 ) ;
if ( F_86 ( & V_99 -> V_107 ) )
...
if ( F_88 ( & V_99 -> V_105 , & V_108 ) >= 0 ) {
V_99 -> V_105 = F_84 ( V_2 -> V_5 . V_106 , 0 , 0 ) ;
V_110 = true ;
}
F_85 ( V_2 -> V_5 . V_4 , V_99 , & V_108 , F_80 ) ;
return F_88 ( & V_99 -> V_105 , & V_108 ) >= 0 && V_110 ;
}
static int F_89 ( void * V_112 )
{
...
static int F_100 ( struct V_117 * V_118 , struct V_119 * V_120 ,
struct V_100 * V_101 )
{
struct V_121 * V_122 = F_12 ( V_118 ,
struct V_121 , V_122 ) ;
if ( F_101 ( V_101 ) > V_122 -> V_84 )
return V_123 ;
if ( F_33 ( V_101 ) )
F_74 ( V_120 -> V_4 , F_101 ( V_101 ) ,
...
struct V_121 V_122 ;
F_103 ( & V_122 . V_122 , - 1 ) ;
V_122 . V_84 = V_2 -> V_5 . V_106 ;
F_104 ( & V_122 . V_122 , V_2 -> V_5 . V_4 , & F_84 ( V_122 . V_84 , 0 , 0 ) ,
F_100 , 0 ) ;
