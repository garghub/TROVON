...
static enum V_77 F_36 ( struct V_2 * V_3 ,
...
enum V_77 V_81 ;
T_4 V_82 = 0 ;
V_81 = F_37 ( & V_41 -> V_4 . V_3 , V_78 , V_80 ) ;
if ( V_81 == V_83 )
return V_81 ;
F_16 ( & V_41 -> V_4 . V_54 , V_53 ) ;
V_40 = V_41 -> V_6 ;
V_81 = V_41 -> V_84 ;
V_56 = F_38 ( & V_41 -> V_4 , V_78 ) ;
if ( V_56 ) {
...
static void F_45 ( struct V_66 * V_67 , T_5 V_90 ,
...
return NULL ;
V_93 = F_47 ( V_92 , V_97 ) ;
V_67 = F_48 ( sizeof( * V_67 ) + V_93 * sizeof( V_67 -> V_69 [ 0 ] ) , V_98 ) ;
if ( ! V_67 ) {
F_29 ( V_3 -> V_63 -> V_59 , L_6 , & V_41 -> V_4 ) ;
return NULL ;
}
V_67 -> V_88 = F_49 ( ( unsigned long ) & V_67 -> V_69 [ 0 ] ) ;
V_67 -> V_85 = V_92 ;
V_67 -> V_89 = V_93 ;
V_93 = 0 ;
if ( ! V_41 -> V_76 ) {
...
do {
V_96 = F_50 ( T_4 , V_92 , V_97 ) ;
F_45 ( V_67 , V_90 , V_91 , V_96 , V_93 ++ , V_41 -> V_76 ) ;
if ( V_41 -> V_101 == V_102 ) {
V_91 += V_96 ;
...
return F_51 ( & V_41 -> V_4 , & V_67 -> V_56 , V_53 ) ;
}
static struct V_95 * F_52 (
...
F_45 ( V_67 , V_90 , V_91 , V_92 , V_93 ++ , V_41 -> V_76 ) ;
V_112 += V_92 ;
V_109 -= V_92 ;
} while ( V_109 );
}
...
static void F_63 ( struct V_64 * V_56 )
{
struct V_66 * V_67 =
F_2 ( V_56 , struct V_66 , V_56 ) ;
F_64 ( V_67 ) ;
}
static struct V_2 * F_65 ( struct V_138 * V_139 ,
struct V_140 * V_141 )
{
...
if ( V_143 > V_13 -> V_144 )
return NULL ;
return F_66 ( & ( V_13 -> V_145 [ V_143 ] . V_4 . V_3 ) ) ;
}
...
V_151 = F_68 ( V_147 , V_152 , 0 ) ;
if ( ! V_151 )
return - V_120 ;
V_13 = F_69 ( & V_147 -> V_59 , sizeof( * V_13 ) , V_153 ) ;
if ( ! V_13 )
return - V_154 ;
V_13 -> V_9 = F_70 ( & V_147 -> V_59 , V_151 ) ;
if ( F_71 ( V_13 -> V_9 ) )
return F_72 ( V_13 -> V_9 ) ;
V_149 = F_73 ( V_155 , & V_147 -> V_59 ) ;
if ( V_149 ) {
F_74 ( ( & V_147 -> V_59 ) -> V_156 ,
L_10 , & V_13 -> V_74 ) ;
F_74 ( ( & V_147 -> V_59 ) -> V_156 ,
L_11 , & V_13 -> V_144 ) ;
}
V_13 -> V_157 = F_75 ( & V_147 -> V_59 , NULL ) ;
if ( F_71 ( V_13 -> V_157 ) ) {
F_76 ( & V_147 -> V_59 , L_12 ) ;
return F_72 ( V_13 -> V_157 ) ;
}
V_38 = F_77 ( V_147 , 0 ) ;
V_81 = F_78 ( & V_147 -> V_59 , V_38 ,
F_12 , 0 , V_158 , V_13 ) ;
if ( V_81 )
return V_81 ;
V_13 -> V_6 = F_69 ( & V_147 -> V_59 ,
...
F_79 ( & V_13 -> V_58 . V_159 ) ;
F_80 ( V_160 , V_13 -> V_58 . V_161 ) ;
F_80 ( V_162 , V_13 -> V_58 . V_161 ) ;
V_13 -> V_58 . V_59 = & V_147 -> V_59 ;
V_13 -> V_58 . V_163 = F_34 ;
V_13 -> V_58 . V_164 = F_36 ;
V_13 -> V_58 . V_165 = F_46 ;
V_13 -> V_58 . V_166 = F_52 ;
V_13 -> V_58 . V_167 = F_40 ;
V_13 -> V_58 . V_168 = F_56 ;
V_13 -> V_58 . V_169 = F_61 ;
V_13 -> V_58 . V_170 = F_62 ;
V_13 -> V_58 . V_171 = F_57 ;
V_13 -> V_58 . V_172 = V_173 ;
V_13 -> V_145 = F_69 ( & V_147 -> V_59 ,
...
F_79 ( & V_41 -> V_68 ) ;
V_41 -> V_4 . V_174 = F_63 ;
F_81 ( & V_41 -> V_4 , & V_13 -> V_58 ) ;
}
V_81 = F_82 ( V_13 -> V_157 ) ;
if ( V_81 < 0 ) {
F_76 ( & V_147 -> V_59 , L_13 , V_81 ) ;
return V_81 ;
}
F_11 ( V_13 , true ) ;
V_81 = F_83 ( & V_13 -> V_58 ) ;
if ( V_81 )
return V_81 ;
V_81 = F_84 ( ( & V_147 -> V_59 ) -> V_156 ,
F_65 , V_13 ) ;
if ( V_81 )
goto V_175;
F_85 ( & V_13 -> V_54 ) ;
F_79 ( & V_13 -> V_75 ) ;
F_86 ( & V_13 -> V_60 , F_26 , ( unsigned long ) V_13 ) ;
F_87 ( V_147 , V_13 ) ;
F_88 ( & V_147 -> V_59 , L_14 ) ;
return 0 ;
V_175:
F_89 ( & V_13 -> V_58 ) ;
return V_81 ;
...
{
struct V_1 * V_41 , * V_71 ;
struct V_12 * V_13 = F_91 ( V_147 ) ;
F_89 ( & V_13 -> V_58 ) ;
F_92 ( ( & V_147 -> V_59 ) -> V_156 ) ;
F_27 (c, cn, &d->slave.channels, vc.chan.device_node) {
F_25 ( & V_41 -> V_4 . V_3 . V_176 ) ;
F_93 ( & V_41 -> V_4 . V_60 ) ;
}
F_93 ( & V_13 -> V_60 ) ;
F_94 ( V_13 -> V_157 ) ;
...
static int F_97 ( struct V_63 * V_59 )
{
struct V_12 * V_13 = F_96 ( V_59 ) ;
int V_81 = 0 ;
V_81 = F_82 ( V_13 -> V_157 ) ;
if ( V_81 < 0 ) {
F_76 ( V_13 -> V_58 . V_59 , L_13 , V_81 ) ;
return V_81 ;
}
F_11 ( V_13 , true ) ;
return 0 ;
