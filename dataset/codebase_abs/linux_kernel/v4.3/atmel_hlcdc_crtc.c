...
struct V_1 * V_3 = F_1 ( V_5 ) ;
if ( V_5 -> V_11 -> V_65 ) {
V_5 -> V_11 -> V_65 -> V_66 = F_31 ( V_5 ) ;
F_32 ( F_33 ( V_5 ) != 0 ) ;
V_3 -> V_65 = V_5 -> V_11 -> V_65 ;
V_5 -> V_11 -> V_65 = NULL ;
}
}
...
F_39 ( & V_51 -> V_70 , V_37 ) ;
V_65 = V_3 -> V_65 ;
if ( V_65 && V_65 -> V_4 . V_71 == V_68 ) {
V_65 -> V_4 . V_72 ( & V_65 -> V_4 ) ;
F_40 ( V_51 , V_3 -> V_73 ) ;
V_3 -> V_65 = NULL ;
}
F_41 ( & V_51 -> V_70 , V_37 ) ;
...
{
struct V_74 * V_7 = V_51 -> V_75 ;
struct V_76 * V_77 = V_7 -> V_77 ;
struct V_1 * V_3 ;
int V_78 ;
int V_79 ;
V_3 = F_47 ( sizeof( * V_3 ) , V_80 ) ;
if ( ! V_3 )
return - V_81 ;
V_3 -> V_7 = V_7 ;
V_78 = F_48 ( V_51 , & V_3 -> V_4 ,
& V_77 -> V_82 -> V_4 ,
V_77 -> V_83 ? & V_77 -> V_83 -> V_4 : NULL ,
& V_84 ) ;
if ( V_78 < 0 )
goto V_85;
V_3 -> V_73 = F_31 ( & V_3 -> V_4 ) ;
if ( V_77 -> V_83 )
V_77 -> V_83 -> V_4 . V_86 = 1 << V_3 -> V_73 ;
for ( V_79 = 0 ; V_79 < V_77 -> V_87 ; V_79 ++ )
V_77 -> V_88 [ V_79 ] -> V_4 . V_86 = 1 << V_3 -> V_73 ;
F_49 ( & V_3 -> V_4 , & V_89 ) ;
F_50 ( & V_3 -> V_4 ) ;
V_7 -> V_3 = & V_3 -> V_4 ;
return 0 ;
