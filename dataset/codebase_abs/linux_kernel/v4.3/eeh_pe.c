...
void F_42 ( struct V_3 * V_6 , int V_42 )
{
F_15 ( V_6 , F_35 , & V_42 ) ;
if ( ! ( V_42 & V_50 ) )
return;
...
static void * F_48 ( void * V_12 , void * V_23 )
{
...
struct V_93 * V_94 = F_52 ( V_92 ) ;
const char * V_95 = NULL ;
if ( ! V_94 )
goto V_96;
if ( F_53 ( V_92 ) ) {
V_95 = F_54 ( V_94 , L_20 , NULL ) ;
if ( ! V_95 )
V_95 = F_54 ( V_94 , L_21 , NULL ) ;
if ( V_95 )
goto V_96;
V_94 = V_94 -> V_10 ;
if ( ! V_94 )
