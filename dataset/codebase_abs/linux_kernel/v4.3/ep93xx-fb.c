...
{
if ( V_9 -> V_80 )
F_26 ( V_9 -> V_79 , V_9 -> V_27 . V_78 ,
V_9 -> V_80 , V_9 -> V_27 . V_66 ) ;
}
static int F_28 ( struct V_104 * V_105 )
{
struct V_106 * V_13 = F_29 ( & V_105 -> V_79 ) ;
struct V_8 * V_9 ;
struct V_1 * V_2 ;
struct V_107 * V_108 ;
char * V_109 ;
...
if ( ! V_13 )
return - V_37 ;
V_9 = F_30 ( sizeof( struct V_1 ) , & V_105 -> V_79 ) ;
if ( ! V_9 )
return - V_102 ;
V_9 -> V_79 = & V_105 -> V_79 ;
F_31 ( V_105 , V_9 ) ;
V_2 = V_9 -> V_10 ;
V_2 -> V_13 = V_13 ;
V_72 = F_32 ( & V_9 -> V_110 , 256 , 0 ) ;
if ( V_72 )
goto V_111;
V_72 = F_23 ( V_9 ) ;
if ( V_72 )
goto V_112;
V_108 = F_33 ( V_105 , V_113 , 0 ) ;
if ( ! V_108 ) {
V_72 = - V_114 ;
goto V_115;
}
V_2 -> V_108 = V_108 ;
V_2 -> V_4 = F_34 ( & V_105 -> V_79 , V_108 -> V_41 ,
F_35 ( V_108 ) ) ;
if ( ! V_2 -> V_4 ) {
V_72 = - V_114 ;
goto V_115;
}
strcpy ( V_9 -> V_27 . V_116 , V_105 -> V_117 ) ;
V_9 -> V_118 = & V_119 ;
V_9 -> V_27 . type = V_120 ;
V_9 -> V_27 . V_121 = V_122 ;
V_9 -> V_16 . V_123 = V_124 ;
V_9 -> V_16 . V_125 = V_126 ;
V_9 -> V_14 = V_127 ;
V_9 -> V_128 = - 1 ;
V_9 -> V_129 = V_130 ;
V_9 -> V_86 = & V_2 -> V_86 ;
F_36 ( L_3 , & V_109 ) ;
V_72 = F_37 ( & V_9 -> V_16 , V_9 , V_109 ,
NULL , 0 , NULL , 16 ) ;
if ( V_72 == 0 ) {
F_25 ( V_9 -> V_79 , L_4 ) ;
V_72 = - V_37 ;
