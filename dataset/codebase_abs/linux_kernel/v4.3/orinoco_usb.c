...
static void F_112 ( T_8 * V_199 ) __acquires( V_199 )
{
F_63 ( V_199 ) ;
}
static void F_113 ( T_8 * V_199 ) __releases( V_199 )
{
F_64 ( V_199 ) ;
}
static int F_114 ( struct V_200 * V_201 ,
const struct V_202 * V_144 )
{
struct V_203 * V_15 = F_115 ( V_201 ) ;
struct V_39 * V_40 ;
struct V_129 * V_130 ;
...
int V_89 = 0 ;
int V_79 ;
V_40 = F_116 ( sizeof( * V_12 ) , & V_15 -> V_22 ,
F_93 , NULL ) ;
if ( ! V_40 ) {
F_31 ( L_53 ) ;
goto exit;
...
static void F_129 ( struct V_200 * V_227 )
{
struct V_11 * V_12 = F_130 ( V_227 ) ;
F_128 ( V_227 , NULL ) ;
F_100 ( V_12 ) ;
