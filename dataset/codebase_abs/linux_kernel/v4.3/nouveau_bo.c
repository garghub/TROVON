...
int V_49 ;
V_49 = F_34 ( V_26 , false , false , false , NULL ) ;
if ( V_49 )
return V_49 ;
...
{
int V_49 ;
V_49 = F_34 ( & V_29 -> V_26 , false , false , false , NULL ) ;
if ( V_49 )
return V_49 ;
if ( ! V_29 -> V_67 )
...
if ( V_10 -> V_132 . V_133 ) {
return F_60 ( V_27 , V_10 -> V_132 . V_133 , V_6 ,
V_128 , V_130 ) ;
}
#endif
return F_61 ( V_27 , V_6 , V_128 , V_130 ) ;
}
static int
F_62 ( struct V_127 * V_27 , T_2 V_8 )
{
return 0 ;
}
static int
F_63 ( struct V_127 * V_27 , T_2 type ,
struct V_134 * V_135 )
{
struct V_9 * V_10 = F_16 ( V_27 ) ;
switch ( type ) {
...
static void
F_65 ( struct V_25 * V_26 , struct V_90 * V_75 )
{
struct V_28 * V_29 = V_28 ( V_26 ) ;
switch ( V_26 -> V_70 . V_99 ) {
case V_100 :
...
static int
F_66 ( struct V_151 * V_152 , T_1 V_153 )
{
int V_49 = F_67 ( V_152 , 2 ) ;
if ( V_49 == 0 ) {
F_68 ( V_152 , V_154 , 0x0000 , 1 ) ;
F_69 ( V_152 , V_153 & 0x0000ffff ) ;
F_70 ( V_152 ) ;
}
return V_49 ;
}
static int
F_71 ( struct V_151 * V_152 , struct V_25 * V_26 ,
struct V_155 * V_156 , struct V_155 * V_157 )
{
struct V_101 * V_158 = V_156 -> V_102 ;
int V_49 = F_67 ( V_152 , 10 ) ;
if ( V_49 == 0 ) {
F_68 ( V_152 , V_154 , 0x0400 , 8 ) ;
F_69 ( V_152 , F_72 ( V_158 -> V_159 [ 0 ] . V_160 ) ) ;
F_69 ( V_152 , F_73 ( V_158 -> V_159 [ 0 ] . V_160 ) ) ;
F_69 ( V_152 , F_72 ( V_158 -> V_159 [ 1 ] . V_160 ) ) ;
F_69 ( V_152 , F_73 ( V_158 -> V_159 [ 1 ] . V_160 ) ) ;
F_69 ( V_152 , V_41 ) ;
F_69 ( V_152 , V_41 ) ;
F_69 ( V_152 , V_41 ) ;
F_69 ( V_152 , V_157 -> V_71 ) ;
F_74 ( V_152 , V_154 , 0x0300 , 0x0386 ) ;
}
return V_49 ;
}
static int
F_75 ( struct V_151 * V_152 , T_1 V_153 )
{
int V_49 = F_67 ( V_152 , 2 ) ;
if ( V_49 == 0 ) {
F_68 ( V_152 , V_154 , 0x0000 , 1 ) ;
...
static int
F_76 ( struct V_151 * V_152 , struct V_25 * V_26 ,
struct V_155 * V_156 , struct V_155 * V_157 )
{
struct V_101 * V_158 = V_156 -> V_102 ;
...
if ( V_49 )
return V_49 ;
F_68 ( V_152 , V_154 , 0x030c , 8 ) ;
F_69 ( V_152 , F_72 ( V_161 ) ) ;
F_69 ( V_152 , F_73 ( V_161 ) ) ;
F_69 ( V_152 , F_72 ( V_162 ) ) ;
F_69 ( V_152 , F_73 ( V_162 ) ) ;
F_69 ( V_152 , V_41 ) ;
F_69 ( V_152 , V_41 ) ;
F_69 ( V_152 , V_41 ) ;
F_69 ( V_152 , V_164 ) ;
F_68 ( V_152 , V_154 , 0x0300 , 1 ) ;
F_69 ( V_152 , 0x00000110 ) ;
V_163 -= V_164 ;
V_161 += ( V_41 * V_164 ) ;
V_162 += ( V_41 * V_164 ) ;
}
...
if ( V_49 )
return V_49 ;
F_68 ( V_152 , V_154 , 0x0238 , 2 ) ;
F_69 ( V_152 , F_72 ( V_162 ) ) ;
F_69 ( V_152 , F_73 ( V_162 ) ) ;
F_68 ( V_152 , V_154 , 0x030c , 6 ) ;
F_69 ( V_152 , F_72 ( V_161 ) ) ;
F_69 ( V_152 , F_73 ( V_161 ) ) ;
F_69 ( V_152 , V_41 ) ;
F_69 ( V_152 , V_41 ) ;
...
static int
F_80 ( struct V_151 * V_152 , struct V_25 * V_26 ,
struct V_155 * V_156 , struct V_155 * V_157 )
{
struct V_101 * V_158 = V_156 -> V_102 ;
int V_49 = F_67 ( V_152 , 7 ) ;
if ( V_49 == 0 ) {
F_79 ( V_152 , V_154 , 0x0320 , 6 ) ;
F_69 ( V_152 , F_72 ( V_158 -> V_159 [ 0 ] . V_160 ) ) ;
F_69 ( V_152 , F_73 ( V_158 -> V_159 [ 0 ] . V_160 ) ) ;
F_69 ( V_152 , F_72 ( V_158 -> V_159 [ 1 ] . V_160 ) ) ;
F_69 ( V_152 , F_73 ( V_158 -> V_159 [ 1 ] . V_160 ) ) ;
F_69 ( V_152 , 0x00000000 ) ;
F_69 ( V_152 , V_157 -> V_71 << V_72 ) ;
}
return V_49 ;
}
static int
...
static int
F_82 ( struct V_151 * V_152 , T_1 V_153 )
{
int V_49 = F_67 ( V_152 , 6 ) ;
if ( V_49 == 0 ) {
F_79 ( V_152 , V_154 , 0x0000 , 1 ) ;
F_69 ( V_152 , V_153 ) ;
F_79 ( V_152 , V_154 , 0x0180 , 3 ) ;
F_69 ( V_152 , V_152 -> V_10 -> V_165 . V_153 ) ;
F_69 ( V_152 , V_152 -> V_166 . V_153 ) ;
F_69 ( V_152 , V_152 -> V_166 . V_153 ) ;
}
return V_49 ;
}
static int
F_83 ( struct V_151 * V_152 , struct V_25 * V_26 ,
struct V_155 * V_156 , struct V_155 * V_157 )
{
struct V_101 * V_158 = V_156 -> V_102 ;
...
V_49 = F_67 ( V_152 , 18 + 6 * ( V_168 + V_169 ) ) ;
if ( V_49 )
return V_49 ;
V_170 = F_84 ( V_167 , ( T_6 ) ( 4 * 1024 * 1024 ) ) ;
V_171 = 16 * 4 ;
V_172 = V_170 / V_171 ;
if ( V_168 ) {
F_79 ( V_152 , V_154 , 0x0200 , 7 ) ;
F_69 ( V_152 , 0 ) ;
F_69 ( V_152 , 0 ) ;
F_69 ( V_152 , V_171 ) ;
F_69 ( V_152 , V_172 ) ;
...
F_79 ( V_152 , V_154 , 0x0200 , 1 ) ;
F_69 ( V_152 , 1 ) ;
}
if ( V_169 ) {
F_79 ( V_152 , V_154 , 0x021c , 7 ) ;
F_69 ( V_152 , 0 ) ;
F_69 ( V_152 , 0 ) ;
F_69 ( V_152 , V_171 ) ;
F_69 ( V_152 , V_172 ) ;
...
F_79 ( V_152 , V_154 , 0x021c , 1 ) ;
F_69 ( V_152 , 1 ) ;
}
F_79 ( V_152 , V_154 , 0x0238 , 2 ) ;
F_69 ( V_152 , F_72 ( V_161 ) ) ;
F_69 ( V_152 , F_72 ( V_162 ) ) ;
F_79 ( V_152 , V_154 , 0x030c , 8 ) ;
F_69 ( V_152 , F_73 ( V_161 ) ) ;
...
F_69 ( V_152 , V_171 ) ;
F_69 ( V_152 , V_172 ) ;
F_69 ( V_152 , 0x00000101 ) ;
F_69 ( V_152 , 0x00000000 ) ;
F_79 ( V_152 , V_154 , V_173 , 1 ) ;
F_69 ( V_152 , 0 ) ;
V_167 -= V_170 ;
V_161 += V_170 ;
V_162 += V_170 ;
...
static int
F_85 ( struct V_151 * V_152 , T_1 V_153 )
{
int V_49 = F_67 ( V_152 , 4 ) ;
if ( V_49 == 0 ) {
F_79 ( V_152 , V_154 , 0x0000 , 1 ) ;
F_69 ( V_152 , V_153 ) ;
F_79 ( V_152 , V_154 , 0x0180 , 1 ) ;
F_69 ( V_152 , V_152 -> V_10 -> V_165 . V_153 ) ;
}
return V_49 ;
}
static inline T_2
F_86 ( struct V_25 * V_26 ,
...
static int
F_87 ( struct V_151 * V_152 , struct V_25 * V_26 ,
struct V_155 * V_156 , struct V_155 * V_157 )
{
...
if ( V_49 )
return V_49 ;
F_79 ( V_152 , V_154 , V_176 , 2 ) ;
F_69 ( V_152 , F_86 ( V_26 , V_152 , V_156 ) ) ;
F_69 ( V_152 , F_86 ( V_26 , V_152 , V_157 ) ) ;
V_163 = V_157 -> V_71 ;
while ( V_163 ) {
int V_164 = ( V_163 > 2047 ) ? 2047 : V_163 ;
V_49 = F_67 ( V_152 , 11 ) ;
...
static int
F_88 ( struct V_9 * V_10 , struct V_25 * V_26 ,
struct V_155 * V_70 )
{
...
int V_49 ;
V_49 = F_89 ( V_10 -> V_53 . V_54 , V_6 , V_178 -> V_40 ,
V_180 , & V_178 -> V_159 [ 0 ] ) ;
if ( V_49 )
return V_49 ;
V_49 = F_89 ( V_10 -> V_53 . V_54 , V_6 , V_179 -> V_40 ,
V_180 , & V_178 -> V_159 [ 1 ] ) ;
if ( V_49 ) {
F_90 ( & V_178 -> V_159 [ 0 ] ) ;
return V_49 ;
}
F_91 ( & V_178 -> V_159 [ 0 ] , V_178 ) ;
F_91 ( & V_178 -> V_159 [ 1 ] , V_179 ) ;
return 0 ;
}
static int
F_92 ( struct V_25 * V_26 , int V_97 , bool V_181 ,
...
int V_49 ;
if ( V_10 -> V_14 . V_35 . V_36 >= V_37 ) {
V_49 = F_88 ( V_10 , V_26 , V_157 ) ;
if ( V_49 )
return V_49 ;
}
F_93 ( & V_183 -> V_185 , V_186 ) ;
V_49 = F_94 ( V_28 ( V_26 ) , V_152 , true , V_181 ) ;
if ( V_49 == 0 ) {
V_49 = V_10 -> V_64 . V_187 ( V_152 , V_26 , & V_26 -> V_70 , V_157 ) ;
if ( V_49 == 0 ) {
V_49 = F_95 ( V_152 , false , & V_19 ) ;
if ( V_49 == 0 ) {
V_49 = F_96 ( V_26 ,
& V_19 -> V_188 ,
V_97 ,
...
int V_190 ;
T_7 V_191 ;
int (* F_99)( struct V_151 * ,
struct V_25 * ,
struct V_155 * , struct V_155 * );
int (* F_100)( struct V_151 * , T_1 V_153 );
} V_192 [] = {
...
if ( V_152 == NULL )
continue;
V_49 = F_101 ( & V_152 -> V_184 ,
V_193 -> V_191 | ( V_193 -> V_190 << 16 ) ,
V_193 -> V_191 , NULL , 0 ,
& V_10 -> V_64 . V_196 ) ;
if ( V_49 == 0 ) {
V_49 = V_193 -> F_100 ( V_152 , V_10 -> V_64 . V_196 . V_153 ) ;
if ( V_49 ) {
F_102 ( & V_10 -> V_64 . V_196 ) ;
continue;
}
V_10 -> V_64 . V_187 = V_193 -> F_99 ;
V_10 -> V_64 . V_152 = V_152 ;
V_189 = V_193 -> V_189 ;
break;
}
} while ( ( ++ V_193 ) -> F_99 );
F_103 ( V_10 , L_12 , V_189 ) ;
}
static int
F_104 ( struct V_25 * V_26 , bool V_97 , bool V_181 ,
bool V_116 , struct V_155 * V_157 )
{
struct V_74 V_197 = {
. V_81 = 0 ,
...
V_198 = * V_157 ;
V_198 . V_102 = NULL ;
V_49 = F_105 ( V_26 , & V_73 , & V_198 , V_181 , V_116 ) ;
if ( V_49 )
return V_49 ;
V_49 = F_106 ( V_26 -> V_64 , & V_198 ) ;
if ( V_49 )
goto V_104;
V_49 = F_92 ( V_26 , true , V_181 , V_116 , & V_198 ) ;
if ( V_49 )
goto V_104;
V_49 = F_107 ( V_26 , true , V_116 , V_157 ) ;
V_104:
F_108 ( V_26 , & V_198 ) ;
return V_49 ;
}
static int
F_109 ( struct V_25 * V_26 , bool V_97 , bool V_181 ,
bool V_116 , struct V_155 * V_157 )
{
struct V_74 V_197 = {
. V_81 = 0 ,
...
if ( V_49 )
return V_49 ;
V_49 = F_107 ( V_26 , true , V_116 , & V_198 ) ;
if ( V_49 )
goto V_104;
V_49 = F_92 ( V_26 , true , V_181 , V_116 , V_157 ) ;
if ( V_49 )
goto V_104;
V_104:
F_108 ( V_26 , & V_198 ) ;
...
static void
F_110 ( struct V_25 * V_26 , struct V_155 * V_157 )
{
struct V_28 * V_29 = V_28 ( V_26 ) ;
struct V_199 * V_159 ;
if ( V_26 -> V_200 != F_15 )
...
static int
F_113 ( struct V_25 * V_26 , struct V_155 * V_157 ,
struct V_3 * * V_201 )
{
struct V_9 * V_10 = F_16 ( V_26 -> V_27 ) ;
struct V_1 * V_2 = V_10 -> V_2 ;
...
static void
F_114 ( struct V_25 * V_26 ,
struct V_3 * V_201 ,
struct V_3 * * V_202 )
{
struct V_9 * V_10 = F_16 ( V_26 -> V_27 ) ;
struct V_1 * V_2 = V_10 -> V_2 ;
struct V_19 * V_19 = F_115 ( V_26 -> V_203 ) ;
F_11 ( V_2 , * V_202 , V_19 ) ;
* V_202 = V_201 ;
}
static int
F_116 ( struct V_25 * V_26 , bool V_97 , bool V_181 ,
bool V_116 , struct V_155 * V_157 )
{
struct V_9 * V_10 = F_16 ( V_26 -> V_27 ) ;
struct V_28 * V_29 = V_28 ( V_26 ) ;
...
if ( V_10 -> V_64 . V_187 ) {
if ( V_157 -> V_99 == V_136 )
V_49 = F_104 ( V_26 , V_97 , V_181 ,
V_116 , V_157 ) ;
else if ( V_156 -> V_99 == V_136 )
V_49 = F_109 ( V_26 , V_97 , V_181 ,
V_116 , V_157 ) ;
else
V_49 = F_92 ( V_26 , V_97 , V_181 ,
V_116 , V_157 ) ;
if ( ! V_49 )
goto V_104;
}
V_49 = F_118 ( V_26 , true , V_181 , V_116 ) ;
if ( V_49 == 0 )
V_49 = F_119 ( V_26 , V_97 , V_116 , V_157 ) ;
V_104:
if ( V_10 -> V_14 . V_35 . V_36 < V_37 ) {
if ( V_49 )
F_114 ( V_26 , NULL , & V_201 ) ;
else
F_114 ( V_26 , V_201 , & V_29 -> V_12 ) ;
}
return V_49 ;
}
static int
F_120 ( struct V_25 * V_26 , struct V_204 * V_31 )
{
struct V_28 * V_29 = V_28 ( V_26 ) ;
return F_121 ( & V_29 -> V_30 . V_205 , V_31 ) ;
}
static int
F_122 ( struct V_127 * V_27 , struct V_155 * V_70 )
{
...
if ( V_10 -> V_14 . V_35 . V_36 >= V_37 ) {
struct V_209 * V_210 = F_64 ( & V_10 -> V_14 ) ;
int V_40 = 12 ;
if ( V_10 -> V_14 . V_35 . V_36 >= V_211 )
V_40 = V_158 -> V_40 ;
V_49 = F_123 ( V_210 , V_158 -> V_6 << 12 , V_40 ,
& V_158 -> V_212 ) ;
if ( V_49 )
return V_49 ;
F_91 ( & V_158 -> V_212 , V_158 ) ;
...
static void
F_124 ( struct V_127 * V_27 , struct V_155 * V_70 )
{
struct V_101 * V_158 = V_70 -> V_102 ;
...
#ifdef F_131
if ( F_132 () ) {
return F_129 ( ( void * ) V_64 , V_2 -> V_2 ) ;
}
#endif
V_216 = F_133 ( V_64 ) ;
if ( V_216 ) {
...
void
F_141 ( struct V_28 * V_29 , struct V_22 * V_19 , bool V_227 )
{
...
struct V_199 *
F_144 ( struct V_28 * V_29 , struct V_228 * V_54 )
{
struct V_199 * V_159 ;
F_111 (vma, &nvbo->vma_list, head) {
if ( V_159 -> V_54 == V_54 )
...
int
F_145 ( struct V_28 * V_29 , struct V_228 * V_54 ,
struct V_199 * V_159 )
{
const T_1 V_6 = V_29 -> V_26 . V_70 . V_71 << V_72 ;
int V_49 ;
V_49 = F_89 ( V_54 , V_6 , V_29 -> V_40 ,
V_180 , V_159 ) ;
if ( V_49 )
return V_49 ;
...
V_29 -> V_40 != V_159 -> V_54 -> V_55 -> V_51 ) )
F_91 ( V_159 , V_29 -> V_26 . V_70 . V_102 ) ;
