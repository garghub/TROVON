...
{
struct V_28 * V_29 = F_83 ( V_15 -> V_32 . V_27 ) ;
struct V_30 * V_31 = V_29 -> V_32 ;
int V_72 = F_84 ( V_31 -> V_139 ) ;
int V_140 = F_85 ( V_31 -> V_139 ) ;
F_86 ( V_139 , V_31 -> V_139 ) ;
V_139 -> V_27 = V_31 -> V_139 ;
V_139 -> V_24 = 0 ;
return F_87 ( V_139 ) ? :
F_88 ( V_139 , V_31 -> V_33 , V_72 ) ? :
F_89 ( V_139 , V_15 -> V_35 , V_140 , V_15 -> V_35 ) ;
}
...
static void F_91 ( struct V_14 * V_15 , int V_52 )
{
struct V_17 * V_18 = F_9 ( V_15 ) ;
struct V_1 * V_2 = V_18 -> V_2 ;
if ( ! V_52 ) {
...
V_18 -> V_3 = 0 ;
if ( V_18 -> V_24 & F_12 ( V_127 ) ) {
if ( ( V_18 -> V_58 + V_18 -> V_122 + V_18 -> V_123 ) < 9 ) {
F_57 ( V_18 ) ;
return 0 ;
...
V_184 = F_141 ( V_183 , V_187 , 0 ) ;
if ( ! V_184 ) {
F_22 ( V_53 , L_35 ) ;
V_52 = - V_186 ;
goto V_52;
}
V_2 -> V_57 = V_184 -> V_188 ;
V_2 -> V_22 = & V_189 ;
V_52:
return V_52 ;
}
...
int V_52 , V_21 , V_190 ;
T_1 V_191 ;
V_2 = F_144 ( V_53 , sizeof( struct V_1 ) , V_192 ) ;
if ( V_2 == NULL ) {
F_22 ( V_53 , L_36 ) ;
V_52 = - V_193 ;
goto V_194;
...
V_2 -> V_106 = V_175 . V_188 ;
V_52 = F_151 ( V_53 , V_2 -> V_170 , V_2 -> V_22 -> V_197 ,
V_198 , F_152 ( V_53 ) , V_2 ) ;
if ( V_52 ) {
F_22 ( V_53 , L_37 ,
V_2 -> V_170 , V_52 ) ;
goto V_194;
...
V_191 = F_1 ( V_2 , F_158 ( V_2 ) ) ;
F_159 ( & V_183 -> V_53 ) ;
F_160 ( V_53 , L_40 ,
( V_191 & V_2 -> V_22 -> V_202 ) >> V_2 -> V_22 -> V_203 ,
( V_191 & V_2 -> V_22 -> V_204 ) >> V_2 -> V_22 -> V_205 ) ;
F_161 ( & V_131 . V_132 ) ;
F_162 ( & V_2 -> V_195 , & V_131 . V_206 ) ;
F_163 ( & V_131 . V_132 ) ;
for ( V_21 = 0 ; V_21 < V_2 -> V_22 -> V_207 ; V_21 ++ ) {
for ( V_190 = 0 ; V_190 < V_2 -> V_22 -> V_208 [ V_21 ] . V_209 ; V_190 ++ ) {
V_52 = F_164 (
& V_2 -> V_22 -> V_208 [ V_21 ] . V_210 [ V_190 ] ) ;
if ( V_52 )
goto V_211;
...
for ( V_190 = V_2 -> V_22 -> V_208 [ V_21 ] . V_212 - 1 ; V_190 >= 0 ; V_190 -- )
F_165 (
& V_2 -> V_22 -> V_208 [ V_21 ] . V_210 [ V_190 ] ) ;
V_201:
F_166 ( V_53 ) ;
...
static int F_172 ( struct V_173 * V_53 )
{
F_159 ( V_53 ) ;
return 0 ;
}
static int F_173 ( struct V_173 * V_53 )
{
int V_52 = F_21 ( V_53 ) ;
if ( V_52 < 0 ) {
F_22 ( V_53 , L_1 , V_52 ) ;
