...
static int F_58 ( struct V_23 * V_24 , T_2 * V_94 ,
...
struct V_81 * V_82 , int V_145 )
{
struct V_12 * V_19 ;
unsigned short V_7 ;
if ( ! F_53 ( & V_82 -> V_24 -> V_124 ) )
return 0 ;
if ( ! F_69 ( V_45 , V_145 + V_61 ) )
return 0 ;
V_7 = F_66 ( V_45 , V_145 ) ;
V_19 = F_20 ( V_82 -> V_24 ,
V_82 -> V_16 , V_7 ) ;
...
int F_94 ( struct V_149 * V_150 , void * V_151 )
{
struct V_49 * V_58 = (struct V_49 * ) V_150 -> V_152 ;
...
int F_98 ( struct V_149 * V_150 , void * V_151 )
{
struct V_49 * V_58 = (struct V_49 * ) V_150 -> V_152 ;
struct V_23 * V_24 = F_95 ( V_58 ) ;
struct V_25 * V_5 = V_24 -> V_26 . V_33 ;
