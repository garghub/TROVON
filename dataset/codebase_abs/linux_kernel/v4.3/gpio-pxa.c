...
{
int V_15 = 0 , V_96 ;
struct V_97 * V_98 = V_80 -> V_99 . V_53 ;
const struct V_100 * V_101 =
F_49 ( V_102 , & V_80 -> V_99 ) ;
const struct V_83 * V_103 ;
...
return - V_38 ;
V_115 = F_56 ( V_80 , L_9 ) ;
V_116 = F_56 ( V_80 , L_10 ) ;
V_117 = F_56 ( V_80 , L_11 ) ;
if ( ( V_115 > 0 && V_116 <= 0 ) || ( V_115 <= 0 && V_116 > 0 )
|| ( V_117 <= 0 ) )
return - V_38 ;
V_110 = F_57 ( V_80 , V_119 , 0 ) ;
if ( ! V_110 )
return - V_38 ;
V_47 = F_58 ( V_110 -> V_120 , F_59 ( V_110 ) ) ;
if ( ! V_47 )
return - V_38 ;
if ( V_115 > 0 )
V_118 = 2 ;
V_111 = F_60 ( & V_80 -> V_99 , NULL ) ;
if ( F_61 ( V_111 ) ) {
F_50 ( & V_80 -> V_99 , L_12 ,
F_62 ( V_111 ) ) ;
F_53 ( V_47 ) ;
...
F_21 ( V_37 , V_113 ? V_113 -> V_121 : NULL ) ;
F_34 (gpio, c) {
F_15 ( 0 , V_2 -> V_5 + V_62 ) ;
F_15 ( 0 , V_2 -> V_5 + V_60 ) ;
F_15 ( ~ 0 , V_2 -> V_5 + V_77 ) ;
