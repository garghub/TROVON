...
V_7 = V_2 -> V_7 ;
while ( V_7 ) {
F_28 ( V_31 L_6 , V_7 -> V_32 , V_7 -> V_32 ) ;
if ( V_7 -> V_33 )
F_28 ( V_34 L_7 ,
V_7 -> V_33 , V_7 -> V_33 ) ;
F_28 ( V_34 L_8 ) ;
...
static void F_32 ( struct V_1 * V_2 , T_1 V_29 )
{
static int V_36 = 100 ;
if ( V_36 > 0 ) {
V_36 -- ;
...
static inline int
F_33 ( unsigned int V_5 , struct V_1 * V_2 ,
T_1 V_29 )
{
struct V_11 * V_7 ;
if ( ! V_37 )
...
void F_34 ( struct V_1 * V_2 , T_1 V_29 )
{
unsigned int V_5 ;
if ( V_2 -> V_16 & V_18 ||
F_13 ( V_2 ) )
