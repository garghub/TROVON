...
if ( ! ( V_31 -> V_40 & V_41 ) )
continue;
if ( ! F_14 ( & V_34 -> V_58 , & V_52 -> V_59 ) )
F_15 ( & V_34 -> V_58 , & V_52 -> V_59 ) ;
}
V_55 += V_18 * sizeof( V_60 ) ;
V_54 -> V_61 += V_18 ;
if ( ! F_7 ( & V_29 -> V_62 ) )
F_16 ( & V_29 -> V_62 , & V_54 -> V_63 ) ;
if ( V_54 -> V_12 -> V_9 == 0 ) {
...
F_20 ( V_54 -> V_52 -> V_75 -> V_77 , V_54 -> V_78 ,
V_54 -> V_79 , abort ) ;
F_21 ( & V_54 -> V_63 ) ;
F_22 ( V_74 , & V_54 -> V_63 ,
...
V_92 . V_48 = & V_91 ;
V_92 . V_46 = V_54 -> V_78 ;
error = F_33 ( log , & V_92 , V_3 , & V_54 -> V_79 , NULL , 0 ) ;
if ( error )
goto V_112;
V_113:
F_13 ( & V_52 -> V_82 ) ;
...
continue;
if ( ! V_85 -> V_93 ) {
F_35 ( & V_52 -> V_83 , & V_52 -> V_82 ) ;
goto V_113;
}
}
F_17 ( & V_52 -> V_82 ) ;
V_93 = F_36 ( log -> V_76 , V_3 , & V_87 , false ) ;
if ( V_93 == - 1 )
goto V_114;
V_54 -> V_115 . V_116 = F_19 ;
V_54 -> V_115 . V_117 = V_54 ;
error = F_37 ( log -> V_76 , V_87 , & V_54 -> V_115 ) ;
if ( error )
goto V_114;
F_13 ( & V_52 -> V_82 ) ;
V_54 -> V_93 = V_93 ;
...
struct V_120 * V_121 )
{
struct V_51 * V_52 = F_41 ( V_121 , struct V_51 ,
V_122 ) ;
F_26 ( V_52 -> V_75 ) ;
}
static void
...
if ( V_52 -> V_11 -> V_68 < F_43 ( log ) )
return;
F_13 ( & V_52 -> V_82 ) ;
if ( V_52 -> V_96 < V_52 -> V_100 ) {
V_52 -> V_96 = V_52 -> V_100 ;
F_44 ( log -> V_76 -> V_123 , & V_52 -> V_122 ) ;
}
F_17 ( & V_52 -> V_82 ) ;
}
static void
...
if ( V_93 )
* V_93 = V_29 -> V_127 ;
F_36 ( V_74 , V_29 -> V_65 , NULL , V_125 ) ;
F_51 ( V_29 ) ;
F_52 ( V_29 , V_29 -> V_127 , false ) ;
F_42 ( log ) ;
F_53 ( & V_52 -> V_95 ) ;
}
T_1
