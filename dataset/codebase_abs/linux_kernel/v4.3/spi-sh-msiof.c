...
if ( V_61 )
V_147 = F_72 ( V_111 , V_2 -> V_100 * 4 ) ;
if ( V_62 )
V_147 = F_72 ( V_111 , V_2 -> V_101 * 4 ) ;
if ( V_63 <= 8 ) {
if ( V_147 & 3 )
break;
F_70 = F_65 ;
...
static struct V_150 * F_76 ( struct V_130 * V_34 )
{
struct V_150 * V_30 ;
struct V_78 * V_79 = V_34 -> V_81 ;
T_1 V_151 = 1 ;
V_30 = F_77 ( V_34 , sizeof( struct V_150 ) , V_152 ) ;
if ( ! V_30 )
return NULL ;
F_78 ( V_79 , L_8 , & V_151 ) ;
F_78 ( V_79 , L_9 ,
...
static struct V_156 * F_79 ( struct V_130 * V_34 ,
enum V_157 V_158 , unsigned int V_159 , T_7 V_160 )
{
T_8 V_10 ;
struct V_156 * V_161 ;
struct V_162 V_163 ;
...
F_80 ( V_10 ) ;
F_81 ( V_164 , V_10 ) ;
V_161 = F_82 ( V_10 , V_165 ,
( void * ) ( unsigned long ) V_159 , V_34 ,
V_158 == V_166 ? L_13 : L_14 ) ;
if ( ! V_161 ) {
F_19 ( V_34 , L_15 ) ;
return NULL ;
}
...
{
struct V_173 * V_33 = V_2 -> V_33 ;
struct V_130 * V_34 = & V_33 -> V_34 ;
const struct V_150 * V_30 = F_86 ( V_34 ) ;
unsigned int V_174 , V_175 ;
const struct V_176 * V_177 ;
struct V_91 * V_80 ;
struct V_130 * V_178 , * V_179 ;
if ( V_34 -> V_81 ) {
V_174 = 0 ;
V_175 = 0 ;
} else if ( V_30 && V_30 -> V_174 && V_30 -> V_175 ) {
V_174 = V_30 -> V_174 ;
V_175 = V_30 -> V_175 ;
} else {
return 0 ;
}
V_177 = F_87 ( V_33 , V_180 , 1 ) ;
if ( ! V_177 )
V_177 = F_87 ( V_33 , V_180 , 0 ) ;
V_80 = V_2 -> V_80 ;
V_80 -> V_129 = F_79 ( V_34 , V_166 ,
V_174 ,
V_177 -> V_181 + V_72 ) ;
if ( ! V_80 -> V_129 )
return - V_182 ;
V_80 -> V_119 = F_79 ( V_34 , V_183 ,
V_175 ,
V_177 -> V_181 + V_75 ) ;
if ( ! V_80 -> V_119 )
goto V_184;
V_2 -> V_148 = ( void * ) F_88 ( V_152 | V_185 ) ;
if ( ! V_2 -> V_148 )
goto V_186;
V_2 -> V_149 = ( void * ) F_88 ( V_152 | V_185 ) ;
if ( ! V_2 -> V_149 )
goto V_187;
V_178 = V_80 -> V_129 -> V_130 -> V_34 ;
V_2 -> V_131 = F_89 ( V_178 , V_2 -> V_148 , V_188 ,
V_132 ) ;
if ( F_90 ( V_178 , V_2 -> V_131 ) )
goto V_189;
V_179 = V_80 -> V_119 -> V_130 -> V_34 ;
V_2 -> V_120 = F_89 ( V_179 , V_2 -> V_149 , V_188 ,
V_121 ) ;
if ( F_90 ( V_179 , V_2 -> V_120 ) )
goto V_190;
F_91 ( V_34 , L_17 ) ;
return 0 ;
V_190:
F_92 ( V_178 , V_2 -> V_131 , V_188 , V_132 ) ;
V_189:
...
static int F_95 ( struct V_173 * V_33 )
{
struct V_176 * V_191 ;
struct V_91 * V_80 ;
...
F_97 ( V_33 , V_2 ) ;
V_2 -> V_80 = V_80 ;
V_193 = F_98 ( V_196 , & V_33 -> V_34 ) ;
if ( V_193 ) {
V_2 -> V_25 = V_193 -> V_11 ;
V_2 -> V_30 = F_76 ( & V_33 -> V_34 ) ;
} else {
V_2 -> V_25 = ( const void * ) V_33 -> V_197 -> V_198 ;
...
V_191 = F_87 ( V_33 , V_180 , 0 ) ;
V_2 -> V_6 = F_104 ( & V_33 -> V_34 , V_191 ) ;
if ( F_101 ( V_2 -> V_6 ) ) {
V_94 = F_102 ( V_2 -> V_6 ) ;
goto V_200;
}
V_94 = F_105 ( & V_33 -> V_34 , V_194 , F_9 , 0 ,
F_75 ( & V_33 -> V_34 ) , V_2 ) ;
if ( V_94 ) {
F_54 ( & V_33 -> V_34 , L_22 ) ;
goto V_200;
...
if ( V_2 -> V_30 -> V_154 )
V_2 -> V_101 = V_2 -> V_30 -> V_154 ;
V_80 -> V_202 = V_86 | V_87 | V_90 ;
V_80 -> V_202 |= V_89 | V_88 ;
V_80 -> V_203 = V_2 -> V_25 -> V_26 ;
V_80 -> V_204 = V_33 -> V_159 ;
V_80 -> V_34 . V_81 = V_33 -> V_34 . V_81 ;
V_80 -> V_155 = V_2 -> V_30 -> V_155 ;
V_80 -> V_205 = F_42 ;
V_80 -> V_206 = F_47 ;
V_80 -> V_207 = F_107 ( 8 , 32 ) ;
V_80 -> V_208 = true ;
V_80 -> V_209 = F_69 ;
V_94 = F_85 ( V_2 ) ;
if ( V_94 < 0 )
...
static int F_111 ( struct V_173 * V_33 )
{
