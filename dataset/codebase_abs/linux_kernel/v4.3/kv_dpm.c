...
static int F_153 ( void * V_458 )
{
int V_66 ;
struct V_1 * V_2 = (struct V_1 * ) V_458 ;
V_66 = F_154 ( V_2 , 230 , & V_2 -> V_8 . V_9 . V_203 . V_198 ) ;
if ( V_66 )
return V_66 ;
V_66 = F_154 ( V_2 , 231 , & V_2 -> V_8 . V_9 . V_203 . V_198 ) ;
if ( V_66 )
return V_66 ;
V_2 -> V_8 . V_9 . V_460 = V_461 ;
V_2 -> V_8 . V_9 . V_462 = V_461 ;
V_2 -> V_8 . V_9 . V_274 = V_273 ;
V_2 -> V_8 . V_463 = V_2 -> clock . V_463 ;
V_2 -> V_8 . V_464 = V_2 -> clock . V_464 ;
V_2 -> V_8 . V_465 = V_2 -> clock . V_463 ;
V_2 -> V_8 . V_466 = V_2 -> clock . V_464 ;
V_2 -> V_8 . V_200 = V_467 ;
if ( V_459 == 0 )
return 0 ;
F_155 ( & V_2 -> V_8 . V_9 . V_203 . V_468 , V_469 ) ;
F_156 ( & V_2 -> V_8 . V_470 ) ;
V_66 = F_132 ( V_2 ) ;
if ( V_66 )
goto V_471;
