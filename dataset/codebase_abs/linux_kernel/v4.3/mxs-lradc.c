...
{
F_40 ( V_2 -> V_63 , V_64 , V_2 -> V_65 ) ;
F_40 ( V_2 -> V_63 , V_66 , V_2 -> V_67 ) ;
F_40 ( V_2 -> V_63 , V_68 , V_2 -> V_69 ) ;
F_41 ( V_2 -> V_63 , V_70 , 1 ) ;
F_42 ( V_2 -> V_63 ) ;
}
...
static void F_44 ( struct V_1 * V_2 , bool V_72 )
{
if ( V_72 && F_12 ( V_2 ) ) {
V_2 -> V_73 = true ;
F_39 ( V_2 ) ;
...
static int F_46 ( struct V_74 * V_74 , int V_75 , int * V_3 )
{
struct V_1 * V_2 = F_47 ( V_74 ) ;
int V_76 ;
V_76 = F_48 ( & V_2 -> V_77 ) ;
if ( ! V_76 )
return - V_78 ;
...
static int F_53 ( struct V_74 * V_74 , int * V_3 )
{
int V_76 , V_88 , V_89 ;
V_76 = F_46 ( V_74 , 8 , & V_88 ) ;
if ( V_76 != V_87 )
return V_76 ;
V_76 = F_46 ( V_74 , 9 , & V_89 ) ;
if ( V_76 != V_87 )
return V_76 ;
* V_3 = V_89 - V_88 ;
return V_87 ;
...
case V_93 :
if ( V_75 -> type == V_94 )
return F_53 ( V_74 , V_3 ) ;
return F_46 ( V_74 , V_75 -> V_40 , V_3 ) ;
case V_95 :
if ( V_75 -> type == V_94 ) {
* V_3 = 0 ;
* V_91 = 253000 ;
...
static int F_55 ( struct V_74 * V_74 ,
const struct V_90 * V_75 ,
int V_3 , int V_91 , long V_92 )
{
struct V_1 * V_2 = F_47 ( V_74 ) ;
...
static int F_58 ( struct V_74 * V_74 ,
const struct V_90 * V_75 ,
long V_92 )
{
return V_108 ;
}
static T_2 F_59 ( struct V_109 * V_47 ,
struct V_110 * V_111 ,
char * V_112 ,
int V_29 )
{
struct V_74 * V_113 = F_60 ( V_47 ) ;
struct V_1 * V_2 = F_47 ( V_113 ) ;
int V_114 , V_115 = 0 ;
for ( V_114 = 0 ; V_114 < F_61 ( V_2 -> V_104 [ V_29 ] ) ; V_114 ++ )
...
static T_2 F_62 ( struct V_109 * V_47 ,
struct V_110 * V_111 ,
char * V_112 )
{
struct V_116 * V_117 = F_63 ( V_111 ) ;
return F_59 ( V_47 , V_111 , V_112 ,
V_117 -> V_118 ) ;
}
static int F_64 ( struct V_119 * V_47 )
{
...
static void F_67 ( struct V_119 * V_47 )
{
struct V_1 * V_2 = F_65 ( V_47 ) ;
F_66 ( V_2 ) ;
}
...
V_120 -> V_129 = F_64 ;
V_120 -> V_130 = F_67 ;
F_70 ( V_131 , V_120 -> V_132 ) ;
F_70 ( V_133 , V_120 -> V_132 ) ;
F_70 ( V_70 , V_120 -> V_134 ) ;
F_71 ( V_120 , V_64 , 0 , V_135 , 0 , 0 ) ;
F_71 ( V_120 , V_66 , 0 , V_135 , 0 , 0 ) ;
F_71 ( V_120 , V_68 , 0 , V_135 ,
0 , 0 ) ;
V_2 -> V_63 = V_120 ;
F_72 ( V_120 , V_2 ) ;
V_76 = F_73 ( V_120 ) ;
...
static T_3 F_77 ( int V_136 , void * V_137 )
{
...
static T_3 F_81 ( int V_136 , void * V_144 )
{
...
F_83 ( V_113 , V_2 -> V_152 , V_146 -> V_153 ) ;
F_84 ( V_113 -> V_142 ) ;
return V_143 ;
}
static int F_85 ( struct V_154 * V_142 , bool V_155 )
{
struct V_74 * V_113 = F_86 ( V_142 ) ;
struct V_1 * V_2 = F_47 ( V_113 ) ;
const T_4 V_156 = V_155 ? V_6 : V_7 ;
F_4 ( V_2 , V_36 , F_24 ( 0 ) + V_156 ) ;
return 0 ;
}
static int F_87 ( struct V_74 * V_113 )
{
int V_76 ;
struct V_154 * V_142 ;
struct V_1 * V_2 = F_47 ( V_113 ) ;
V_142 = F_88 ( L_6 , V_113 -> V_123 , V_113 -> V_125 ) ;
if ( V_142 == NULL )
return - V_122 ;
...
static void F_92 ( struct V_74 * V_113 )
{
struct V_1 * V_2 = F_47 ( V_113 ) ;
F_93 ( V_2 -> V_142 ) ;
F_91 ( V_2 -> V_142 ) ;
}
static int F_94 ( struct V_74 * V_113 )
{
struct V_1 * V_2 = F_47 ( V_113 ) ;
...
const T_4 V_148 = V_31 |
( ( V_149 - 1 ) << V_150 ) ;
const int V_115 = F_95 ( V_113 -> V_164 ,
V_165 ) ;
if ( ! V_115 )
return - V_102 ;
V_76 = F_48 ( & V_2 -> V_77 ) ;
if ( ! V_76 )
return - V_78 ;
V_2 -> V_152 = F_96 ( V_115 , sizeof( * V_2 -> V_152 ) , V_166 ) ;
if ( ! V_2 -> V_152 ) {
V_76 = - V_122 ;
goto V_167;
}
...
static int F_99 ( struct V_74 * V_113 )
{
struct V_1 * V_2 = F_47 ( V_113 ) ;
F_3 ( V_2 , V_169 |
V_36 , F_24 ( 0 ) ) ;
...
static bool F_101 ( struct V_74 * V_113 ,
const unsigned long * V_43 )
{
struct V_1 * V_2 = F_47 ( V_113 ) ;
const int V_171 = F_95 ( V_43 , V_165 ) ;
int V_172 = 0 ;
...
static int F_109 ( struct V_193 * V_194 )
{
const struct V_195 * V_196 =
F_110 ( V_197 , & V_194 -> V_47 ) ;
...
V_204 = F_112 ( V_194 , V_208 , 0 ) ;
V_2 -> V_47 = & V_194 -> V_47 ;
V_2 -> V_5 = F_113 ( V_47 , V_204 ) ;
if ( F_114 ( V_2 -> V_5 ) )
return F_115 ( V_2 -> V_5 ) ;
V_2 -> V_209 = F_116 ( & V_194 -> V_47 , NULL ) ;
if ( F_114 ( V_2 -> V_209 ) ) {
F_108 ( V_47 , L_16 ) ;
return F_115 ( V_2 -> V_209 ) ;
}
V_76 = F_117 ( V_2 -> V_209 ) ;
if ( V_76 != 0 ) {
F_108 ( V_47 , L_17 ) ;
return V_76 ;
}
V_205 = F_106 ( V_2 , V_201 ) ;
if ( V_205 == 0 )
V_2 -> V_141 = V_210 ;
else
V_2 -> V_141 = V_211 ;
for ( V_114 = 0 ; V_114 < V_199 -> V_212 ; V_114 ++ ) {
V_2 -> V_136 [ V_114 ] = F_118 ( V_194 , V_114 ) ;
if ( V_2 -> V_136 [ V_114 ] < 0 ) {
V_76 = V_2 -> V_136 [ V_114 ] ;
goto V_213;
}
V_76 = F_119 ( V_47 , V_2 -> V_136 [ V_114 ] ,
F_77 , 0 ,
...
if ( V_2 -> V_8 == V_9 ) {
V_113 -> V_220 = V_221 ;
V_113 -> V_222 = F_61 ( V_221 ) ;
} else {
V_113 -> V_220 = V_223 ;
V_113 -> V_222 = F_61 ( V_223 ) ;
}
V_76 = F_123 ( V_113 , & V_224 ,
& F_81 ,
& V_225 ) ;
if ( V_76 )
goto V_213;
...
for ( V_206 = 0 ; V_206 < F_61 ( V_2 -> V_104 [ V_114 ] ) ; V_206 ++ ) {
V_207 = ( ( V_227 ) V_2 -> V_97 [ V_114 ] * 100000000 ) >>
( V_48 - V_206 ) ;
V_2 -> V_104 [ V_114 ] [ V_206 ] . V_106 =
F_124 ( V_207 , 100000000 ) * 10 ;
