...
{
struct V_3 * V_4 = V_23 -> V_31 ;
struct V_98 * V_99 = & V_4 -> V_27 . V_100 . V_99 ;
int V_69 ;
V_69 = F_36 ( V_2 , V_4 , V_57 , V_99 -> V_101 ,
V_99 -> V_101 + V_99 -> V_102 - 1 ) ;
return V_69 ;
}
...
int V_69 ;
T_4 V_139 = V_4 -> V_27 . V_100 . V_99 . V_101 ;
long V_140 = V_4 -> V_27 . V_100 . V_99 . V_102 ;
...
if ( ! F_4 ( V_2 , V_4 , V_12 ) )
return 0 ;
V_69 = F_64 ( V_2 , V_33 , V_4 , V_139 , V_141 , & V_143 ) ;
if ( V_69 != 0 )
return V_69 ;
else if ( V_143 != 0 )
goto V_144;
F_65 ( V_145 , V_2 , & V_33 -> V_37 ,
L_6 ,
V_12 -> V_146 , V_140 , V_139 , F_66 ( V_12 ) ) ;
...
V_69 = F_69 ( V_16 -> V_153 , V_16 -> V_74 ) ;
break;
case V_155 :
V_69 = F_70 ( V_138 , & V_139 ,
...
return 0 ;
if ( F_78 ( V_4 ) ) {
V_139 = V_4 -> V_27 . V_105 . V_108 . V_101 = F_66 ( V_12 ) ;
...
V_69 = F_79 ( V_16 -> V_153 , V_16 -> V_74 ) ;
if ( V_69 > 0 ) {
if ( V_69 < V_140 )
V_4 -> V_20 = 0 ;
V_4 -> V_159 += V_69 ;
...
V_164 -> V_28 . V_168 = F_81 ( V_164 -> V_103 , V_166 ) ;
V_164 -> V_28 . V_169 = 1 ;
if ( V_166 -> V_46 ) {
F_17 ( V_170 ,
L_9 ,
V_166 -> V_46 , V_166 -> V_46 -> V_171 , V_166 -> V_46 -> V_172 ,
( long ) V_166 -> V_46 -> V_80 , F_82 ( V_166 -> V_46 ) ,
F_83 ( V_166 -> V_46 ) , V_166 -> V_173 ) ;
if ( F_84 ( ! ( V_164 -> V_28 . V_168 & V_174 ) ) ) {
F_85 ( V_166 -> V_46 ) ;
...
L_14 ,
F_18 ( F_19 ( & V_33 -> V_37 ) ) ) ;
V_186 = F_88 ( V_33 , V_185 -> V_104 + 1 ) - 1 ;
F_3 ( F_33 ( V_33 , V_186 ) == V_185 -> V_104 ) ;
V_69 = F_64 ( V_2 , V_33 , V_4 , 0 , V_186 + 1 , NULL ) ;
if ( V_69 != 0 )
return V_69 ;
if ( V_185 -> V_190 ) {
...
F_91 ( V_187 ) ;
V_121 = F_66 ( V_12 ) ;
if ( F_84 ( ( V_187 -> V_171 != V_12 -> V_192 ) ||
( F_92 ( V_187 ) > V_121 ) ) ) {
F_17 ( V_170 , L_15 ) ;
V_69 = + 1 ;
goto V_144;
...
V_46 = F_93 ( V_2 , V_33 , V_185 -> V_104 , V_187 , V_195 ) ;
if ( F_94 ( V_46 ) ) {
V_69 = F_95 ( V_46 ) ;
goto V_144;
}
...
struct V_196 * V_197 ;
F_98 ( V_2 , V_4 , V_46 ) ;
V_197 = F_99 ( F_100 ( V_46 , & V_198 ) ) ;
F_101 ( F_102 ( V_33 ) , V_197 ) ;
V_69 = F_103 ( V_2 , V_4 , V_46 , V_199 ) ;
F_3 ( F_104 ( V_46 , V_4 ) ) ;
V_187 = NULL ;
if ( V_69 < 0 ) {
F_105 ( V_2 , V_4 , V_46 ) ;
...
V_185 -> V_202 = V_121 - F_88 ( V_33 , V_185 -> V_104 ) ;
else
V_185 -> V_202 = F_108 ( V_33 ) ;
F_109 ( & V_46 -> V_49 , L_3 , V_4 ) ;
V_185 -> V_48 = V_46 ;
V_144:
if ( V_187 != NULL )
F_110 ( V_187 ) ;
...
struct V_196 * V_197 = F_99 ( V_204 ) ;
struct V_45 * V_46 = V_204 -> V_206 ;
struct V_12 * V_12 = F_10 ( V_33 ) ;
struct V_207 * V_208 = F_74 ( V_12 ) ;
...
V_208 -> V_218 . V_220 )
F_113 ( V_208 , V_12 , V_212 , V_46 -> V_221 ,
V_197 -> V_222 ) ;
V_17 = F_114 ( V_2 , V_4 , V_46 ) ;
if ( V_17 != - V_223 ) {
F_115 ( V_224 , V_2 , V_46 , L_17 ,
V_17 == - V_194 ? L_18 :
L_19 , V_17 ) ;
if ( V_17 != - V_194 )
return V_17 ;
...
V_216 = & V_4 -> V_217 ;
F_120 ( V_216 , V_46 ) ;
V_69 = F_121 ( V_2 , V_4 , V_229 , V_216 , 0 ) ;
F_3 ( F_104 ( V_46 , V_4 ) ) ;
if ( V_229 == V_230 )
F_122 ( V_2 , V_4 , & V_216 -> V_226 ) ;
F_123 ( V_2 , V_216 ) ;
return V_69 ;
}
...
{
struct V_122 * V_123 = F_54 ( V_2 ) ;
T_4 V_186 = F_88 ( V_33 , V_231 -> V_221 ) ;
int V_69 ;
F_55 ( V_33 ) ;
V_69 = F_125 ( V_2 , V_33 , V_123 ) ;
F_57 ( V_33 ) ;
if ( V_69 == 0 ) {
if ( V_123 -> V_234 <= V_186 ) {
char * V_235 = F_126 ( V_197 -> V_214 ) ;
memset ( V_235 , 0 , F_108 ( V_33 ) ) ;
F_127 ( V_235 ) ;
} else if ( V_197 -> V_222 )
V_197 -> V_225 = 1 ;
else
V_69 = F_119 ( V_2 , V_4 , V_231 , V_197 , V_230 ) ;
if ( V_69 == 0 )
F_116 ( V_2 , V_231 , 1 ) ;
}
return V_69 ;
...
struct V_46 * V_187 = V_197 -> V_214 ;
int V_69 ;
F_129 ( F_130 ( V_2 , V_231 ) ) ;
F_3 ( V_187 -> V_171 -> V_236 == F_10 ( V_33 ) ) ;
V_69 = 0 ;
F_115 ( V_170 , V_2 , V_231 , L_20 , V_232 , V_233 ) ;
if ( ! F_131 ( V_187 ) ) {
if ( V_232 == 0 && V_233 == V_152 ) {
F_115 ( V_170 , V_2 , V_231 , L_21 ) ;
F_132 ( V_46 , 0x11 ) ;
} else
V_69 = F_124 ( V_2 , V_23 -> V_31 , V_33 ,
V_231 , V_197 , V_232 , V_233 ) ;
} else
F_115 ( V_170 , V_2 , V_231 , L_22 ) ;
return V_69 ;
}
...
F_65 ( V_145 , V_2 , & V_33 -> V_37 , L_23 ) ;
F_115 ( V_170 , V_2 , V_231 , L_24 , V_232 , V_233 ) ;
if ( ! F_134 ( V_187 ) ) {
V_237 = V_238 ;
V_69 = F_103 ( V_2 , V_4 , V_231 , V_199 ) ;
if ( V_69 == 0 ) {
F_97 ( V_187 ) ;
F_101 ( F_102 ( V_33 ) , V_197 ) ;
} else if ( V_69 == - V_200 ) {
T_7 V_193 = F_66 ( V_12 ) >> V_239 ;
bool V_240 = true ;
if ( V_193 > V_231 -> V_221 ) {
V_233 = V_152 ;
V_240 = false ;
} else if ( V_193 == V_231 -> V_221 ) {
int V_241 = F_66 ( V_12 ) & ~ V_77 ;
if ( V_233 < V_241 )
V_233 = V_241 ;
}
if ( V_240 )
F_135 ( V_2 , V_231 , 0 , V_233 ) ;
V_69 = F_119 ( V_2 , V_4 , V_231 , V_197 , V_199 ) ;
if ( V_69 )
F_71 ( L_25 ,
...
V_121 = F_88 ( V_33 , V_231 -> V_221 ) + V_233 ;
F_47 ( V_12 ) ;
if ( V_69 == 0 ) {
if ( V_121 > F_66 ( V_12 ) ) {
F_139 ( V_12 , V_121 ) ;
...
int F_140 ( const struct V_1 * V_2 , struct V_32 * V_33 ,
struct V_3 * V_4 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_15 * V_16 = F_6 ( V_2 ) ;
...
V_16 -> V_18 , V_4 -> V_40 ) ;
F_141 ( V_16 , V_245 ) ;
F_142 ( V_4 , & V_16 -> V_245 , V_33 , & V_246 ) ;
V_6 -> V_149 = 0 ;
V_69 = 0 ;
