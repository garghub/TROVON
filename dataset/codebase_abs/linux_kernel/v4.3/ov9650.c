...
if ( V_176 -> V_177 == V_178 ) {
if ( V_155 != NULL ) {
V_145 = F_56 ( V_7 , V_155 , V_176 -> V_184 ) ;
* V_145 = V_176 -> V_167 ;
}
} else {
if ( V_5 -> V_35 ) {
...
static int F_64 ( struct V_1 * V_7 , struct V_196 * V_197 )
{
struct V_144 * V_145 = F_56 ( V_7 , V_197 -> V_184 , 0 ) ;
F_48 ( V_145 ) ;
return 0 ;
}
...
V_5 = F_73 ( & V_9 -> V_202 , sizeof( * V_5 ) , V_213 ) ;
if ( ! V_5 )
return - V_214 ;
F_74 ( & V_5 -> V_36 ) ;
V_5 -> V_9 = V_9 ;
...
V_7 = & V_5 -> V_7 ;
F_75 ( V_7 , V_9 , & V_215 ) ;
F_76 ( V_7 -> V_119 , V_216 , sizeof( V_7 -> V_119 ) ) ;
V_7 -> V_217 = & V_218 ;
V_7 -> V_15 |= V_219 |
V_220 ;
V_17 = F_65 ( V_5 , V_199 ) ;
...
V_17 = F_77 ( & V_7 -> V_222 , 1 , & V_5 -> V_184 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
V_17 = F_40 ( V_5 ) ;
if ( V_17 < 0 )
