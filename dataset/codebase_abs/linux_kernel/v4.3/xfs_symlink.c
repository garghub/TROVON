...
ASSERT ( V_2 -> V_15 . V_104 > 0 && V_2 -> V_15 . V_104 <= 2 ) ;
V_51 = F_27 ( V_5 , V_105 ) ;
error = F_30 ( V_51 , & F_31 ( V_5 ) -> V_106 , 0 , 0 ) ;
if ( error ) {
F_55 ( V_51 ) ;
return error ;
}
F_17 ( V_2 , V_75 ) ;
F_36 ( V_51 , V_2 , 0 ) ;
V_103 = ( int ) V_2 -> V_15 . V_16 ;
V_2 -> V_15 . V_16 = 0 ;
F_41 ( V_51 , V_2 , V_89 ) ;
V_101 = 0 ;
F_34 ( & V_53 , & V_54 ) ;
V_17 = F_59 ( V_8 ) ;
error = F_3 ( V_2 , 0 , F_2 ( V_5 , V_103 ) ,
V_8 , & V_17 , 0 ) ;
if ( error )
goto V_107;
for ( V_102 = 0 ; V_102 < V_17 ; V_102 ++ ) {
V_11 = F_43 ( V_51 , V_5 -> V_25 ,
F_4 ( V_5 , V_8 [ V_102 ] . V_23 ) ,
F_60 ( V_5 , V_8 [ V_102 ] . V_24 ) , 0 ) ;
if ( ! V_11 ) {
error = - V_27 ;
goto V_108;
}
...
error = F_62 ( V_51 , V_2 , 0 , V_103 , 0 , V_17 ,
& V_54 , & V_53 , & V_101 ) ;
if ( error )
goto V_108;
ASSERT ( V_101 ) ;
...
if ( V_2 -> V_39 . V_110 )
F_40 ( V_2 , - V_2 -> V_39 . V_110 , V_83 ) ;
ASSERT ( V_2 -> V_39 . V_110 == 0 ) ;
F_18 ( V_2 , V_75 ) ;
return 0 ;
V_108:
F_54 ( & V_53 ) ;
