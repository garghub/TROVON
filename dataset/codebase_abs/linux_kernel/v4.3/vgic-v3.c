...
static V_34 F_10 ( const struct V_2 * V_3 )
{
...
static void F_11 ( struct V_2 * V_3 , struct V_45 * V_46 )
{
...
static void F_14 ( struct V_2 * V_3 , struct V_45 * V_46 )
{
V_34 V_47 ;
...
V_11 -> V_82 = false ;
if ( F_20 ( V_67 , L_2 , & V_72 ) )
V_72 = 1 ;
V_72 += 3 ;
if ( F_21 ( V_67 , V_72 , & V_74 ) ) {
F_22 ( L_3 ) ;
V_11 -> V_83 = 0 ;
} else if ( ! F_23 ( V_74 . V_84 ) ) {
F_24 ( L_4 ,
( unsigned long long ) V_74 . V_84 ) ;
V_11 -> V_83 = 0 ;
} else if ( ! F_23 ( F_25 ( & V_74 ) ) ) {
F_24 ( L_5 ,
( unsigned long long ) F_25 ( & V_74 ) ,
V_85 ) ;
V_11 -> V_83 = 0 ;
} else {
V_11 -> V_83 = V_74 . V_84 ;
