...
static int F_11 ( struct V_1 * V_2 , unsigned long V_17 ,
unsigned long V_3 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
unsigned long V_6 = 0 ;
...
struct V_20 * F_13 ( struct V_21 * V_22 ,
...
V_5 -> V_12 = V_12 ;
V_5 -> V_14 = V_14 ;
V_5 -> V_13 = ( F_16 ( V_25 ) - 1 ) << V_14 ;
V_5 -> V_16 = V_16 ;
V_5 -> V_15 = ( F_16 ( V_26 ) - 1 ) << V_16 ;
V_5 -> V_6 = V_27 ;
V_5 -> V_11 = V_11 ;
V_5 -> V_2 . V_29 = & V_29 ;
V_20 = F_17 ( V_22 , & V_5 -> V_2 ) ;
if ( F_18 ( V_20 ) )
F_19 ( V_5 ) ;
return V_20 ;
}
