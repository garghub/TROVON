...
{
struct V_53 * V_53 = F_40 ( V_62 , struct V_53 , V_62 ) ;
struct V_41 * V_38 ;
struct V_63 * V_64 ;
T_2 V_40 ;
int V_27 , V_65 ;
...
if ( ! ( V_64 -> V_70 & ( V_71 | V_72 | V_73 ) ) ) {
F_57 ( & V_38 -> V_67 ) ;
F_52 ( V_53 ) ;
goto V_69;
}
V_27 = F_58 ( V_38 , V_64 , V_40 , V_65 ) ;
if ( V_27 & V_74 ) {
F_57 ( & V_38 -> V_67 ) ;
F_52 ( V_53 ) ;
goto V_69;
...
static int F_59 ( struct V_75 * V_76 , unsigned long V_77 , void * V_78 )
{
struct V_79 * V_80 ;
struct V_17 * V_17 ;
struct V_7 * V_8 ;
...
int V_27 ;
V_80 = V_78 ;
V_47 = V_80 -> V_47 & 0x1ff ;
V_51 = ( V_80 -> V_47 >> 9 ) & 1 ;
V_27 = V_81 ;
V_8 = F_4 ( V_80 -> F_1 ) ;
if ( V_8 == NULL )
goto V_69;
V_17 = F_22 ( V_8 , V_80 -> V_18 ) ;
if ( V_17 == NULL || V_17 -> V_32 ) {
F_51 ( V_8 -> V_2 , V_80 -> V_18 ,
V_56 , V_47 ) ;
goto V_82;
}
F_5 ( & V_17 -> V_28 , V_9 ) ;
...
int F_63 ( struct V_1 * V_2 , int V_18 ,
struct V_84 * V_85 )
{
struct V_17 * V_17 ;
struct V_7 * V_8 ;
...
void F_73 ( struct V_1 * V_2 , int V_18 )
{
struct V_17 * V_17 ;
struct V_7 * V_8 ;
T_1 V_3 ;
...
int F_74 ( struct V_1 * V_2 , int V_95 )
{
struct V_7 * V_8 ;
struct V_12 * V_13 ;
unsigned long V_9 ;
...
if ( ! F_64 () )
return - V_86 ;
if ( V_95 <= 0 || V_95 > ( V_97 + 1 ) )
return - V_87 ;
V_3 = F_1 ( V_2 ) ;
V_8 = F_60 ( sizeof( * V_8 ) , V_88 ) ;
if ( V_8 == NULL )
return - V_29 ;
F_67 ( & V_8 -> V_28 ) ;
F_66 ( & V_8 -> V_16 ) ;
...
V_8 -> V_3 = V_3 ;
V_96 = V_95 ;
for ( V_8 -> V_24 = 0 ; ( V_96 - 1 ) & ~ 0x1ff ; V_96 >>= 9 )
V_8 -> V_24 += 1 ;
F_65 ( & V_8 -> V_11 , 1 ) ;
V_8 -> V_36 = V_95 ;
V_27 = - V_29 ;
V_8 -> V_25 = ( void * ) F_19 ( V_88 ) ;
if ( V_8 -> V_25 == NULL )
goto V_98;
V_8 -> V_15 = F_75 ( & V_99 ) ;
if ( V_8 -> V_15 == NULL )
goto V_100;
F_76 ( V_8 -> V_15 ) ;
V_27 = F_77 ( V_8 -> V_15 , V_95 ) ;
if ( V_27 )
goto V_101;
V_13 = F_9 ( & V_2 -> V_14 ) ;
if ( ! V_13 )
goto V_101;
V_27 = F_78 ( V_8 -> V_15 , V_13 ) ;
if ( V_27 != 0 )
goto V_102;
F_12 ( V_13 ) ;
F_5 ( & V_10 , V_9 ) ;
