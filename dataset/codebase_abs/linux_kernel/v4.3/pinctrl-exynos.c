...
V_8 = V_10 -> V_63 ;
for ( V_72 = 0 ; V_72 < V_10 -> V_74 ; ++ V_72 , ++ V_8 ) {
if ( V_8 -> V_75 != V_76 )
continue;
V_8 -> V_55 = F_31 ( V_8 -> V_77 ,
V_8 -> V_78 , & V_79 , V_8 ) ;
if ( ! V_8 -> V_55 ) {
F_18 ( V_47 , L_5 ) ;
V_45 = - V_73 ;
...
{
struct V_7 * V_8 = F_5 ( V_5 ) ;
unsigned long V_88 = 1UL << ( 2 * V_8 -> V_14 + V_5 -> V_19 ) ;
F_36 ( L_6 , V_87 ? L_7 : L_8 , V_5 -> V_61 ) ;
if ( ! V_87 )
V_86 |= V_88 ;
else
V_86 &= ~ V_88 ;
...
if ( V_3 -> V_95 )
V_3 -> V_95 ( & V_90 -> V_4 ) ;
V_93 = F_26 ( V_8 -> V_55 , V_92 -> V_61 ) ;
F_27 ( V_93 ) ;
V_3 -> V_96 ( & V_90 -> V_4 ) ;
F_41 ( V_3 , V_90 ) ;
}
static inline void F_42 ( unsigned long V_97 ,
struct V_55 * V_98 )
{
unsigned int V_61 ;
while ( V_97 ) {
...
{
struct V_2 * V_3 = F_39 ( V_90 ) ;
struct V_99 * V_92 = F_38 ( V_90 ) ;
struct V_9 * V_10 = V_92 -> V_100 [ 0 ] -> V_11 ;
unsigned long V_97 ;
unsigned long V_15 ;
int V_72 ;
F_40 ( V_3 , V_90 ) ;
for ( V_72 = 0 ; V_72 < V_92 -> V_74 ; ++ V_72 ) {
struct V_7 * V_59 = V_92 -> V_100 [ V_72 ] ;
V_97 = F_7 ( V_10 -> V_18 + V_59 -> V_2 -> V_21
+ V_59 -> V_14 ) ;
V_15 = F_7 ( V_10 -> V_18 + V_59 -> V_2 -> V_13
+ V_59 -> V_14 ) ;
F_42 ( V_97 & ~ V_15 , V_59 -> V_55 ) ;
}
F_41 ( V_3 , V_90 ) ;
}
...
V_104 = F_32 ( V_47 , V_8 -> V_78
* sizeof( * V_104 ) , V_83 ) ;
if ( ! V_104 ) {
F_18 ( V_47 , L_11 ) ;
return - V_84 ;
}
for ( V_107 = 0 ; V_107 < V_8 -> V_78 ; ++ V_107 ) {
V_61 = F_51 ( V_8 -> V_77 , V_107 ) ;
if ( ! V_61 ) {
F_18 ( V_47 , L_12 ,
V_8 -> V_48 , V_107 ) ;
continue;
}
V_104 [ V_107 ] . V_61 = V_107 ;
V_104 [ V_107 ] . V_8 = V_8 ;
F_52 ( V_61 ,
F_37 ,
& V_104 [ V_107 ] ) ;
...
V_105 = F_32 ( V_47 , sizeof( * V_105 )
+ V_106 * sizeof( struct V_7 * ) , V_83 ) ;
if ( ! V_105 ) {
F_18 ( V_47 , L_14 ) ;
return - V_84 ;
}
...
struct V_7 * V_8 )
{
struct V_82 * V_114 = V_8 -> V_81 ;
void T_4 * V_115 = V_11 -> V_18 ;
V_114 -> V_28 = F_7 ( V_115 + V_116
+ V_8 -> V_14 ) ;
V_114 -> V_117 = F_7 ( V_115 + V_118
+ 2 * V_8 -> V_14 ) ;
V_114 -> V_119 = F_7 ( V_115 + V_118
+ 2 * V_8 -> V_14 + 4 ) ;
F_54 ( L_15 , V_8 -> V_48 , V_114 -> V_28 ) ;
F_54 ( L_16 , V_8 -> V_48 , V_114 -> V_117 ) ;
F_54 ( L_17 , V_8 -> V_48 , V_114 -> V_119 ) ;
}
static void F_55 ( struct V_9 * V_11 )
{
struct V_7 * V_8 = V_11 -> V_63 ;
int V_72 ;
for ( V_72 = 0 ; V_72 < V_11 -> V_74 ; ++ V_72 , ++ V_8 )
if ( V_8 -> V_75 == V_76 )
F_53 ( V_11 , V_8 ) ;
}
static void F_56 (
...
F_54 ( L_19 , V_8 -> V_48 ,
F_7 ( V_115 + V_118
+ 2 * V_8 -> V_14 ) , V_114 -> V_117 ) ;
F_54 ( L_20 , V_8 -> V_48 ,
F_7 ( V_115 + V_118
+ 2 * V_8 -> V_14 + 4 ) , V_114 -> V_119 ) ;
F_8 ( V_114 -> V_28 , V_115 + V_116
+ V_8 -> V_14 ) ;
F_8 ( V_114 -> V_117 , V_115 + V_118
+ 2 * V_8 -> V_14 ) ;
F_8 ( V_114 -> V_119 , V_115 + V_118
+ 2 * V_8 -> V_14 + 4 ) ;
}
