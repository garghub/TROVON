...
static void F_9 ( struct V_1 * V_2 , bool V_35 )
{
if ( F_10 ( V_2 -> V_36 ) )
F_11 ( V_2 -> V_36 , V_35 ) ;
}
...
{
struct V_1 * V_2 ;
struct V_39 * V_40 = F_13 ( & V_6 -> V_32 ) ;
struct V_22 * V_22 ;
int error ;
if ( ! F_14 ( V_6 -> V_15 , V_41 ) ) {
F_15 ( & V_6 -> V_32 , L_1 ) ;
return - V_42 ;
}
if ( ! V_6 -> V_20 ) {
...
V_2 = F_16 ( & V_6 -> V_32 , sizeof( * V_2 ) , V_44 ) ;
if ( ! V_2 )
return - V_45 ;
V_22 = F_17 ( & V_6 -> V_32 ) ;
if ( ! V_22 )
...
V_2 -> V_36 = F_18 ( V_6 -> V_32 . V_46 , 0 ) ;
else
V_2 -> V_36 = - V_47 ;
if ( F_10 ( V_2 -> V_36 ) ) {
error = F_19 ( & V_6 -> V_32 , V_2 -> V_36 , NULL ) ;
if ( error ) {
F_15 ( & V_6 -> V_32 ,
L_3 ,
V_2 -> V_36 ) ;
...
F_20 ( V_54 , V_22 -> V_53 ) ;
F_20 ( V_55 , V_22 -> V_53 ) ;
F_21 ( V_22 , V_28 , 0 , V_56 , 0 , 0 ) ;
F_21 ( V_22 , V_29 , V_57 , V_58 , 0 , 0 ) ;
F_21 ( V_22 , V_30 , V_59 , V_60 , 0 , 0 ) ;
error = F_22 ( & V_6 -> V_32 , V_6 -> V_20 ,
NULL , F_3 ,
V_61 ,
V_6 -> V_48 , V_2 ) ;
if ( error ) {
...
static int T_3 F_28 ( struct V_62 * V_32 )
{
struct V_5 * V_6 = F_29 ( V_32 ) ;
struct V_1 * V_2 = F_27 ( V_6 ) ;
if ( F_30 ( & V_6 -> V_32 ) ) {
F_31 ( V_6 -> V_20 ) ;
} else {
...
static int T_3 F_33 ( struct V_62 * V_32 )
{
struct V_5 * V_6 = F_29 ( V_32 ) ;
struct V_1 * V_2 = F_27 ( V_6 ) ;
if ( F_30 ( & V_6 -> V_32 ) ) {
