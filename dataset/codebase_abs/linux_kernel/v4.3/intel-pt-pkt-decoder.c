...
return V_9 ;
V_6 -> V_8 = 2 ;
V_6 -> V_7 = F_21 ( * ( V_29 * ) ( V_3 + 1 ) ) ;
break;
case 2 :
if ( V_4 < 5 )
return V_9 ;
V_6 -> V_8 = 4 ;
V_6 -> V_7 = F_22 ( * ( V_30 * ) ( V_3 + 1 ) ) ;
break;
case 3 :
case 6 :
if ( V_4 < 7 )
...
switch ( V_25 & 0x1f ) {
case 0x0D :
return F_20 ( V_35 , V_25 , V_3 , V_4 , V_6 ) ;
case 0x11 :
return F_20 ( V_36 , V_25 , V_3 , V_4 ,
V_6 ) ;
case 0x01 :
return F_20 ( V_37 , V_25 , V_3 , V_4 ,
V_6 ) ;
case 0x1D :
return F_20 ( V_38 , V_25 , V_3 , V_4 , V_6 ) ;
case 0x19 :
switch ( V_25 ) {
case 0x99 :
...
{
int V_39 ;
V_39 = F_26 ( V_3 , V_4 , V_6 ) ;
if ( V_39 > 0 ) {
while ( V_39 < 8 && V_4 > ( T_1 ) V_39 && ! V_3 [ V_39 ] )
V_39 += 1 ;
}
return V_39 ;
}
...
case V_14 :
case V_18 :
return snprintf ( V_3 , V_40 , L_1 , V_42 ) ;
case V_11 : {
T_1 V_44 = V_40 ;
V_39 = snprintf ( V_3 , V_44 , L_2 , V_42 ) ;
if ( V_39 < 0 )
return V_39 ;
V_3 += V_39 ;
V_44 -= V_39 ;
...
if ( V_7 & V_10 )
V_39 = snprintf ( V_3 , V_44 , L_3 ) ;
else
V_39 = snprintf ( V_3 , V_44 , L_4 ) ;
if ( V_39 < 0 )
return V_39 ;
V_3 += V_39 ;
V_44 -= V_39 ;
...
V_39 = snprintf ( V_3 , V_44 , L_5 , V_6 -> V_8 ) ;
if ( V_39 < 0 )
return V_39 ;
V_44 -= V_39 ;
return V_40 - V_44 ;
...
case V_38 :
if ( ! ( V_6 -> V_8 ) )
return snprintf ( V_3 , V_40 , L_6 , V_42 ) ;
case V_28 :
case V_17 :
case V_34 :
case V_24 :
case V_15 :
case V_33 :
return snprintf ( V_3 , V_40 , L_7 , V_42 , V_7 ) ;
case V_22 :
return snprintf ( V_3 , V_40 , L_8 , V_42 ,
( unsigned ) V_7 , V_6 -> V_8 ) ;
case V_31 :
return snprintf ( V_3 , V_40 , L_9 , V_42 , V_7 ) ;
case V_32 :
return snprintf ( V_3 , V_40 , L_10 ,
V_42 , ( unsigned ) ( V_7 >> 1 ) & 1 ,
( unsigned ) V_7 & 1 ) ;
case V_12 :
V_41 = V_6 -> V_7 & V_13 ? 1 : 0 ;
V_7 &= ~ V_13 ;
V_39 = snprintf ( V_3 , V_40 , L_11 ,
V_42 , V_7 , V_41 ) ;
return V_39 ;
default:
break;
}
return snprintf ( V_3 , V_40 , L_12 ,
V_42 , V_7 , V_6 -> V_8 ) ;
}
