...
static void F_15 ( struct V_25 * V_9 )
{
unsigned int V_1 = F_16 ( V_9 ) ;
struct V_26 * V_27 = F_17 ( V_9 ) ;
struct V_28 * V_14 = F_18 ( V_27 ) ;
struct V_19 * V_20 , * V_29 = F_19 ( V_27 ) ;
struct V_3 * V_4 = F_20 ( V_1 ) ;
V_14 -> V_30 ( V_27 ) ;
F_11 (entry, vlist) {
unsigned long V_31 , V_32 ;
struct V_25 * V_33 = F_21 ( V_20 -> V_1 ) ;
if ( V_33 ) {
V_32 = ( unsigned long ) F_22 ( V_33 ) ;
V_31 = F_23 ( V_4 , F_24 ( V_32 ) , 0 ) ;
if ( V_34 [ F_25 ( V_32 ) ] ( V_31 , V_32 , 0 ) )
F_26 ( V_33 ) ;
}
}
V_14 -> V_35 ( V_27 ) ;
}
static unsigned long T_2 F_27 ( struct V_36 * V_37 ,
struct V_3 * V_4 ,
unsigned int V_38 )
{
unsigned int V_39 = V_40 + ( V_37 -> V_41 >> 3 ) - 1 ;
return F_28 ( V_39 , V_42 , F_29 ( V_4 , V_37 -> V_43 ) ,
0 , 1 , ( V_37 -> V_41 - 1 ) - V_38 ) ;
}
static void T_2 F_30 ( struct V_44 * V_9 ,
struct V_3 * V_4 ,
struct V_36 * V_37 )
{
struct V_10 * V_45 ;
...
V_46 = V_45 - V_7 ;
F_2 ( & V_4 -> V_49 , V_5 ) ;
for ( V_47 = 0 ; V_47 < F_32 ( V_37 -> V_50 ) ; V_47 ++ ) {
struct V_51 * V_20 ;
int V_52 ;
if ( ! V_37 -> V_50 [ V_47 ] )
continue;
V_20 = F_33 ( sizeof( * V_20 ) , V_53 ) ;
if ( ! V_20 )
break;
V_20 -> V_46 = V_46 ;
V_20 -> V_8 = V_37 -> V_50 [ V_47 ] ;
V_20 -> V_32 = F_27 ( V_37 , V_4 , V_47 ) ;
V_52 = F_34 ( & V_4 -> V_16 , V_20 -> V_8 , V_20 ) ;
if ( F_8 ( V_52 < 0 ) )
break;
F_35 ( & V_4 -> V_16 , V_20 -> V_8 ,
V_17 ) ;
}
F_3 ( & V_4 -> V_49 , V_5 ) ;
}
void T_2 F_36 ( struct V_44 * V_9 , struct V_3 * V_4 )
{
int V_47 ;
if ( ! V_9 -> V_54 . V_55 )
return;
for ( V_47 = 0 ; V_47 < V_9 -> V_54 . V_56 ; V_47 ++ )
F_30 ( V_9 , V_4 , V_9 -> V_54 . V_55 + V_47 ) ;
}
...
V_59:
V_58 = F_38 ( & V_4 -> V_16 ,
( void * * * ) V_57 , 0 , F_32 ( V_57 ) ,
V_17 ) ;
for ( V_47 = 0 ; V_47 < V_58 ; V_47 ++ ) {
struct V_51 * V_20 ;
int V_1 ;
V_20 = F_39 ( ( void * * ) V_57 [ V_47 ] ) ;
if ( F_8 ( ! V_20 ) )
continue;
if ( F_40 ( V_20 ) )
goto V_59;
