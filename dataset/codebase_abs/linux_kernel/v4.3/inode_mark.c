...
{
struct V_1 * V_1 , * V_20 , * V_21 = NULL ;
F_2 ( & V_19 -> V_22 ) ;
F_20 (inode, next_i, &sb->s_inodes, i_sb_list) {
struct V_1 * V_23 ;
F_2 ( & V_1 -> V_2 ) ;
...
V_23 = NULL ;
F_4 ( & V_1 -> V_2 ) ;
while ( & V_20 -> V_29 != & V_19 -> V_30 ) {
F_2 ( & V_20 -> V_2 ) ;
if ( ! ( V_20 -> V_24 & ( V_25 | V_26 ) ) &&
F_21 ( & V_20 -> V_28 ) ) {
F_22 ( V_20 ) ;
V_21 = V_20 ;
F_4 ( & V_20 -> V_2 ) ;
...
F_4 ( & V_20 -> V_2 ) ;
V_20 = F_23 ( V_20 -> V_29 . V_31 ,
struct V_1 , V_29 ) ;
}
F_4 ( & V_19 -> V_22 ) ;
if ( V_23 )
F_24 ( V_23 ) ;
F_25 ( V_1 , V_32 , V_1 , V_33 , NULL , 0 ) ;
F_26 ( V_1 ) ;
F_24 ( V_1 ) ;
F_2 ( & V_19 -> V_22 ) ;
}
