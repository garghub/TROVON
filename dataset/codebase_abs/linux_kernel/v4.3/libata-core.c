...
dev->max_sectors) ;
if ( V_15 -> V_48 & V_365 )
V_15 -> V_158 = F_130 (unsigned int, ATA_MAX_SECTORS_1024,
dev->max_sectors) ;
if ( V_15 -> V_48 & V_366 )
V_15 -> V_158 = V_359 ;
if ( V_5 -> V_215 -> V_367 )
...
{
T_1 V_1 , V_386 , V_387 ;
if ( F_124 ( V_3 , V_388 , & V_1 ) )
return;
F_124 ( V_3 , V_389 , & V_386 ) ;
if ( F_142 ( V_3 ) ) {
V_387 = ( V_1 >> 4 ) & 0xf ;
F_143 ( V_3 , L_111 ,
...
static int F_147 ( struct V_2 * V_3 , T_1 * V_386 )
{
...
{
T_1 V_386 ;
if ( F_124 ( V_3 , V_389 , & V_386 ) )
return 1 ;
return F_147 ( V_3 , & V_386 ) ;
}
int F_149 ( struct V_2 * V_3 )
{
T_1 V_386 ;
int V_182 ;
if ( ( V_182 = F_124 ( V_3 , V_389 , & V_386 ) ) )
return V_182 ;
if ( ! F_147 ( V_3 , & V_386 ) )
return 0 ;
if ( ( V_182 = F_150 ( V_3 , V_389 , V_386 ) ) )
return V_182 ;
return 1 ;
}
static void F_151 ( const struct V_397 * V_398 , struct V_397 * V_399 , int V_400 , int V_401 )
{
V_399 -> V_402 = F_152 ( V_398 -> V_402 * 1000 , V_400 ) ;
V_399 -> V_403 = F_152 ( V_398 -> V_403 * 1000 , V_400 ) ;
V_399 -> V_404 = F_152 ( V_398 -> V_404 * 1000 , V_400 ) ;
V_399 -> V_405 = F_152 ( V_398 -> V_405 * 1000 , V_400 ) ;
V_399 -> V_406 = F_152 ( V_398 -> V_406 * 1000 , V_400 ) ;
V_399 -> V_407 = F_152 ( V_398 -> V_407 * 1000 , V_400 ) ;
V_399 -> V_408 = F_152 ( V_398 -> V_408 * 1000 , V_400 ) ;
V_399 -> V_409 = F_152 ( V_398 -> V_409 * 1000 , V_400 ) ;
V_399 -> V_410 = F_152 ( V_398 -> V_410 * 1000 , V_401 ) ;
}
void F_153 ( const struct V_397 * V_411 , const struct V_397 * V_412 ,
struct V_397 * V_413 , unsigned int V_414 )
{
if ( V_414 & V_415 ) V_413 -> V_402 = V_331 ( V_411 -> V_402 , V_412 -> V_402 ) ;
if ( V_414 & V_416 ) V_413 -> V_403 = V_331 ( V_411 -> V_403 , V_412 -> V_403 ) ;
if ( V_414 & V_417 ) V_413 -> V_404 = V_331 ( V_411 -> V_404 , V_412 -> V_404 ) ;
if ( V_414 & V_418 ) V_413 -> V_405 = V_331 ( V_411 -> V_405 , V_412 -> V_405 ) ;
if ( V_414 & V_419 ) V_413 -> V_406 = V_331 ( V_411 -> V_406 , V_412 -> V_406 ) ;
if ( V_414 & V_420 ) V_413 -> V_407 = V_331 ( V_411 -> V_407 , V_412 -> V_407 ) ;
if ( V_414 & V_421 ) V_413 -> V_408 = V_331 ( V_411 -> V_408 , V_412 -> V_408 ) ;
if ( V_414 & V_422 ) V_413 -> V_409 = V_331 ( V_411 -> V_409 , V_412 -> V_409 ) ;
if ( V_414 & V_423 ) V_413 -> V_410 = V_331 ( V_411 -> V_410 , V_412 -> V_410 ) ;
}
const struct V_397 * F_154 ( T_2 V_134 )
{
...
F_153 ( & V_149 , V_398 , V_398 , V_422 | V_418 ) ;
}
F_151 ( V_398 , V_398 , V_400 , V_401 ) ;
if ( V_424 > V_250 ) {
F_156 ( V_245 , V_245 -> V_248 , & V_149 , V_400 , V_401 ) ;
F_153 ( & V_149 , V_398 , V_398 , V_431 ) ;
}
...
T_2 F_157 ( unsigned int V_432 , int V_409 )
{
...
int F_140 ( struct V_14 * V_15 , unsigned int V_436 )
{
char V_243 [ 32 ] ;
...
int F_162 ( struct V_2 * V_3 , struct V_14 * * V_451 )
{
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_14 * V_15 ;
...
int F_165 ( struct V_2 * V_3 , unsigned long V_464 ,
...
V_467 = F_167 ( V_465 , V_470 ) ;
else
V_467 = F_167 ( V_465 , V_471 ) ;
F_85 ( V_3 == V_3 -> V_5 -> V_12 ) ;
if ( F_168 ( V_467 , V_464 ) )
V_467 = V_464 ;
while ( 1 ) {
unsigned long V_472 = V_466 ;
int V_473 , V_387 ;
V_473 = V_387 = F_166 ( V_3 ) ;
if ( V_473 > 0 )
return 0 ;
if ( V_473 == - V_263 ) {
if ( F_169 ( V_3 ) )
...
if ( V_473 )
return V_473 ;
if ( F_168 ( V_472 , V_464 ) )
return - V_474 ;
if ( ! V_468 && F_168 ( V_472 , V_465 + 5 * V_475 ) &&
( V_464 - V_472 > 3 * V_475 ) ) {
F_146 ( V_3 ,
L_126
L_127 , V_387 ) ;
...
int F_173 ( struct V_2 * V_3 , unsigned long V_464 ,
int (* F_166)( struct V_2 * V_3 ) )
{
F_172 ( V_3 -> V_5 , V_476 ) ;
return F_165 ( V_3 , V_464 , F_166 ) ;
}
int F_174 ( struct V_2 * V_3 , const unsigned long * V_477 ,
unsigned long V_464 )
{
...
T_1 V_481 , V_482 ;
int V_182 ;
V_398 = F_167 ( V_466 , V_477 [ 2 ] ) ;
if ( F_171 ( V_398 , V_464 ) )
V_464 = V_398 ;
if ( ( V_182 = F_124 ( V_3 , V_388 , & V_482 ) ) )
return V_182 ;
V_482 &= 0xf ;
V_481 = V_482 ;
V_480 = V_466 ;
...
V_481 = V_482 ;
V_480 = V_466 ;
if ( F_168 ( V_466 , V_464 ) )
return - V_483 ;
}
}
int F_175 ( struct V_2 * V_3 , const unsigned long * V_477 ,
unsigned long V_464 )
{
int V_376 = V_484 ;
T_1 V_386 , V_485 ;
...
F_146 ( V_3 , L_129 ,
V_484 - V_376 ) ;
if ( ( V_182 = F_174 ( V_3 , V_477 , V_464 ) ) )
return V_182 ;
if ( ! ( V_182 = F_124 ( V_3 , V_486 , & V_485 ) ) )
V_182 = F_150 ( V_3 , V_486 , V_485 ) ;
return V_182 != - V_119 ? V_182 : 0 ;
}
int F_176 ( struct V_2 * V_3 , enum V_487 V_488 ,
bool V_489 )
{
...
V_182 = F_150 ( V_3 , V_389 , V_386 ) ;
if ( V_182 )
return V_182 ;
if ( V_490 )
F_178 ( 10 ) ;
V_174 -> V_25 . V_485 &= ~ V_493 ;
return F_150 ( V_3 , V_486 , V_493 ) ;
}
int F_179 ( struct V_2 * V_3 , unsigned long V_464 )
{
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_173 * V_174 = & V_3 -> V_175 ;
const unsigned long * V_494 = F_180 ( V_174 ) ;
int V_182 ;
if ( V_174 -> V_25 . V_495 & V_496 )
return 0 ;
if ( V_5 -> V_42 & V_449 ) {
V_182 = F_175 ( V_3 , V_494 , V_464 ) ;
...
int F_182 ( struct V_2 * V_3 , const unsigned long * V_494 ,
unsigned long V_464 ,
bool * V_498 , int (* F_166)( struct V_2 * ) )
{
T_1 V_386 ;
int V_182 ;
F_30 ( L_131 ) ;
...
if ( ( V_182 = F_183 ( V_3 , V_389 , V_386 ) ) )
goto V_460;
F_172 ( V_3 -> V_5 , 1 ) ;
V_182 = F_175 ( V_3 , V_494 , V_464 ) ;
if ( V_182 )
...
V_499 = F_167 ( V_466 ,
V_500 ) ;
if ( F_168 ( V_499 , V_464 ) )
V_499 = V_464 ;
F_165 ( V_3 , V_499 , F_166 ) ;
}
V_182 = - V_283 ;
goto V_460;
}
...
unsigned long V_464 )
{
const unsigned long * V_494 = F_180 ( & V_3 -> V_175 ) ;
bool V_498 ;
int V_182 ;
V_182 = F_182 ( V_3 , V_494 , V_464 , & V_498 , NULL ) ;
return V_498 ? - V_283 : V_182 ;
}
void F_187 ( struct V_2 * V_3 , unsigned int * V_374 )
{
T_1 V_485 ;
F_30 ( L_131 ) ;
if ( ! F_124 ( V_3 , V_486 , & V_485 ) )
F_150 ( V_3 , V_486 , V_485 ) ;
F_141 ( V_3 ) ;
F_30 ( L_134 ) ;
}
static int F_188 ( struct V_14 * V_15 , unsigned int V_501 ,
const T_4 * V_502 )
{
const T_4 * V_503 = V_15 -> V_144 ;
unsigned char V_504 [ 2 ] [ V_315 + 1 ] ;
...
F_41 ( V_503 , V_504 [ 0 ] , V_329 , sizeof( V_504 [ 0 ] ) ) ;
F_41 ( V_502 , V_504 [ 1 ] , V_329 , sizeof( V_504 [ 1 ] ) ) ;
...
int F_161 ( struct V_14 * V_15 , unsigned int V_501 ,
unsigned int V_508 )
{
...
{
unsigned char V_509 [ V_315 + 1 ] ;
unsigned char V_510 [ V_313 + 1 ] ;
const struct V_511 * V_512 = V_513 ;
F_41 ( V_15 -> V_144 , V_509 , V_329 , sizeof( V_509 ) ) ;
F_41 ( V_15 -> V_144 , V_510 , V_328 , sizeof( V_510 ) ) ;
while ( V_512 -> V_509 ) {
if ( F_190 ( V_512 -> V_509 , V_509 ) ) {
if ( V_512 -> V_510 == NULL )
return V_512 -> V_48 ;
if ( F_190 ( V_512 -> V_510 , V_510 ) )
return V_512 -> V_48 ;
}
V_512 ++ ;
}
...
return 0 ;
V_159 = F_53 ( V_15 , & V_68 , NULL , V_163 , NULL , 0 , 15000 ) ;
F_30 ( L_149 , V_159 ) ;
return V_159 ;
}
...
if ( V_195 -> V_203 )
F_200 ( V_5 -> V_15 , V_230 , V_195 -> V_526 , V_525 ) ;
V_195 -> V_42 &= ~ V_527 ;
V_195 -> V_230 = NULL ;
}
...
int F_223 ( struct V_4 * V_5 , T_1 V_220 )
{
int V_549 = 0 ;
T_1 V_550 ;
...
while ( V_550 ) {
struct V_194 * V_195 ;
unsigned int V_108 = F_225 ( V_550 ) ;
V_195 = F_226 ( V_5 , V_108 ) ;
if ( V_195 ) {
F_81 ( V_195 ) ;
V_549 ++ ;
}
...
int F_124 ( struct V_2 * V_3 , int V_559 , T_1 * V_560 )
{
if ( F_13 ( V_3 ) ) {
if ( F_101 ( V_3 ) )
...
return F_233 ( V_3 , V_559 , V_560 ) ;
}
int F_150 ( struct V_2 * V_3 , int V_559 , T_1 V_560 )
{
if ( F_13 ( V_3 ) ) {
if ( F_101 ( V_3 ) )
...
return F_234 ( V_3 , V_559 , V_560 ) ;
}
int F_183 ( struct V_2 * V_3 , int V_559 , T_1 V_560 )
{
if ( F_13 ( V_3 ) ) {
int V_182 ;
if ( F_101 ( V_3 ) ) {
...
static void F_235 ( struct V_4 * V_5 , T_6 V_563 ,
...
static void F_237 ( struct V_4 * V_5 , T_6 V_563 )
{
F_235 ( V_5 , V_563 , 0 , V_568 , false ) ;
}
static void F_238 ( struct V_4 * V_5 , T_6 V_563 )
{
F_235 ( V_5 , V_563 , 0 , V_568 , true ) ;
}
static int F_239 ( struct V_21 * V_15 )
{
struct V_4 * V_5 = F_240 ( V_15 ) ;
if ( F_241 ( V_15 ) )
return 0 ;
F_237 ( V_5 , V_569 ) ;
return 0 ;
...
{
F_237 ( F_240 ( V_15 ) , V_571 ) ;
return 0 ;
}
static void F_244 ( struct V_4 * V_5 , T_6 V_563 )
{
F_235 ( V_5 , V_563 , V_554 , V_572 , false ) ;
}
static void F_245 ( struct V_4 * V_5 , T_6 V_563 )
{
F_235 ( V_5 , V_563 , V_554 , V_572 , true ) ;
}
static int F_246 ( struct V_21 * V_15 )
{
F_245 ( F_240 ( V_15 ) , V_573 ) ;
F_247 ( V_15 ) ;
F_248 ( V_15 ) ;
F_249 ( V_15 ) ;
return 0 ;
...
{
F_237 ( F_240 ( V_15 ) , V_574 ) ;
return 0 ;
}
static int F_253 ( struct V_21 * V_15 )
{
F_244 ( F_240 ( V_15 ) , V_575 ) ;
return 0 ;
}
void F_254 ( struct V_4 * V_5 )
{
F_238 ( V_5 , V_569 ) ;
}
void F_255 ( struct V_4 * V_5 )
{
F_245 ( V_5 , V_573 ) ;
}
int F_256 ( struct V_518 * V_273 , T_6 V_563 )
{
V_273 -> V_15 -> V_576 . V_577 = V_563 ;
return 0 ;
}
void F_257 ( struct V_518 * V_273 )
{
V_273 -> V_15 -> V_576 . V_577 = V_578 ;
}
void F_258 ( struct V_14 * V_15 )
{
...
void F_259 ( struct V_4 * V_5 , struct V_2 * V_3 , int V_38 )
{
int V_25 ;
...
T_2 V_136 ;
int V_182 ;
V_182 = F_124 ( V_3 , V_389 , & V_3 -> V_586 ) ;
if ( V_182 )
return V_182 ;
...
struct V_4 * F_262 ( struct V_518 * V_273 )
{
struct V_4 * V_5 ;
F_30 ( L_131 ) ;
V_5 = F_263 ( sizeof( * V_5 ) , V_587 ) ;
if ( ! V_5 )
return NULL ;
...
#endif
F_265 ( & V_5 -> V_598 ) ;
F_266 ( & V_5 -> V_599 , V_600 ) ;
F_267 ( & V_5 -> V_601 , V_602 ) ;
F_268 ( & V_5 -> V_603 ) ;
F_269 ( & V_5 -> V_604 ) ;
F_270 ( & V_5 -> V_605 ) ;
F_271 ( & V_5 -> V_606 ) ;
...
static void F_274 ( struct V_21 * V_613 , void * V_614 )
{
struct V_518 * V_273 = F_275 ( V_613 ) ;
int V_25 ;
...
struct V_518 * F_279 ( struct V_21 * V_15 , int V_617 )
{
struct V_518 * V_273 ;
T_5 V_618 ;
int V_25 ;
F_30 ( L_131 ) ;
if ( ! F_280 ( V_15 , NULL , V_587 ) )
return NULL ;
V_618 = sizeof( struct V_518 ) + ( V_617 + 1 ) * sizeof( void * ) ;
V_273 = F_281 ( F_274 , V_618 , V_587 ) ;
if ( ! V_273 )
goto V_264;
F_282 ( V_15 , V_273 ) ;
F_278 ( V_15 , V_273 ) ;
...
struct V_518 * F_286 ( struct V_21 * V_15 ,
...
struct V_518 * V_273 ;
int V_25 , V_337 ;
V_273 = F_279 ( V_15 , V_615 ) ;
if ( ! V_273 )
return NULL ;
for ( V_25 = 0 , V_337 = 0 , V_623 = NULL ; V_25 < V_273 -> V_615 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_616 [ V_25 ] ;
if ( V_622 [ V_337 ] )
V_623 = V_622 [ V_337 ++ ] ;
V_5 -> V_44 = V_623 -> V_44 ;
...
int F_287 ( struct V_4 * V_5 )
{
struct V_2 * V_3 ;
F_85 ( V_5 -> V_12 ) ;
F_85 ( V_5 -> V_42 & V_627 ) ;
V_3 = F_263 ( sizeof( * V_3 ) , V_587 ) ;
if ( ! V_3 )
return - V_628 ;
F_259 ( V_5 , V_3 , 1 ) ;
V_5 -> V_12 = V_3 ;
...
static void F_288 ( struct V_21 * V_613 , void * V_614 )
{
struct V_518 * V_273 = F_275 ( V_613 ) ;
int V_25 ;
...
static void F_289 ( struct V_632 * V_215 )
{
static F_290 ( V_211 ) ;
...
void F_299 ( struct V_518 * V_273 , struct V_21 * V_15 ,
struct V_632 * V_215 )
{
F_283 ( & V_273 -> V_211 ) ;
F_265 ( & V_273 -> V_619 ) ;
...
static void F_302 ( void * V_609 , T_7 V_647 )
{
...
int F_305 ( struct V_518 * V_273 , struct V_648 * V_649 )
{
int V_25 , V_182 ;
V_273 -> V_641 = F_306 ( V_649 -> V_294 , 1 , V_295 - 1 ) ;
if ( ! ( V_273 -> V_42 & V_629 ) ) {
F_296 ( V_273 -> V_15 , L_160 ) ;
F_85 ( 1 ) ;
return - V_119 ;
}
for ( V_25 = V_273 -> V_615 ; V_273 -> V_616 [ V_25 ] ; V_25 ++ )
F_277 ( V_273 -> V_616 [ V_25 ] ) ;
for ( V_25 = 0 ; V_25 < V_273 -> V_615 ; V_25 ++ ) {
V_273 -> V_616 [ V_25 ] -> V_31 = F_307 ( & V_650 ) ;
V_273 -> V_616 [ V_25 ] -> V_589 = V_25 + 1 ;
}
for ( V_25 = 0 ; V_25 < V_273 -> V_615 ; V_25 ++ ) {
V_182 = F_308 ( V_273 -> V_15 , V_273 -> V_616 [ V_25 ] ) ;
if ( V_182 ) {
goto V_651;
}
}
V_182 = F_309 ( V_273 , V_649 ) ;
if ( V_182 )
goto V_651;
for ( V_25 = 0 ; V_25 < V_273 -> V_615 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_616 [ V_25 ] ;
...
V_651:
while ( -- V_25 >= 0 ) {
F_312 ( V_273 -> V_616 [ V_25 ] ) ;
}
return V_182 ;
}
int F_313 ( struct V_518 * V_273 , int V_652 ,
...
if ( ! V_652 ) {
F_85 ( V_653 ) ;
return F_305 ( V_273 , V_649 ) ;
}
V_182 = F_314 ( V_273 -> V_15 , V_652 , V_653 , V_654 ,
F_315 ( V_273 -> V_15 ) , V_273 ) ;
if ( V_182 )
return V_182 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_615 ; V_25 ++ )
F_316 ( V_273 -> V_616 [ V_25 ] , L_163 , V_652 ) ;
V_182 = F_305 ( V_273 , V_649 ) ;
if ( V_182 )
F_317 ( V_273 -> V_15 , V_652 , V_273 ) ;
return V_182 ;
}
...
void F_323 ( struct V_518 * V_273 )
{
int V_25 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_615 ; V_25 ++ )
F_318 ( V_273 -> V_616 [ V_25 ] ) ;
F_324 ( V_273 ) ;
}
void F_325 ( struct V_659 * V_660 )
{
struct V_518 * V_273 = F_326 ( V_660 ) ;
F_323 ( V_273 ) ;
}
int F_327 ( struct V_659 * V_660 , const struct V_661 * V_132 )
{
unsigned long V_387 = 0 ;
switch ( V_132 -> V_662 ) {
case 1 : {
T_2 V_663 = 0 ;
F_328 ( V_660 , V_132 -> V_559 , & V_663 ) ;
V_387 = V_663 ;
break;
}
case 2 : {
T_4 V_664 = 0 ;
F_329 ( V_660 , V_132 -> V_559 , & V_664 ) ;
V_387 = V_664 ;
break;
}
case 4 : {
T_1 V_665 = 0 ;
F_330 ( V_660 , V_132 -> V_559 , & V_665 ) ;
V_387 = V_665 ;
break;
}
default:
...
void F_331 ( struct V_659 * V_660 , T_6 V_563 )
{
F_332 ( V_660 ) ;
F_333 ( V_660 ) ;
...
int F_339 ( struct V_659 * V_660 , T_6 V_563 )
{
struct V_518 * V_273 = F_326 ( V_660 ) ;
int V_182 = 0 ;
V_182 = F_256 ( V_273 , V_563 ) ;
if ( V_182 )
return V_182 ;
F_331 ( V_660 , V_563 ) ;
return 0 ;
}
int F_340 ( struct V_659 * V_660 )
{
struct V_518 * V_273 = F_326 ( V_660 ) ;
int V_182 ;
V_182 = F_335 ( V_660 ) ;
...
int F_341 ( struct V_670 * V_660 )
{
struct V_518 * V_273 = F_342 ( V_660 ) ;
F_323 ( V_273 ) ;
return 0 ;
}
static int T_9 F_343 ( char * * V_482 ,
struct V_27 * V_671 ,
const char * * V_255 )
{
static const struct V_672 V_673 [] V_674 = {
{ L_165 , . V_33 = V_370 } ,
{ L_166 , . V_33 = V_371 } ,
{ L_167 , . V_33 = V_517 } ,
{ L_168 , . V_33 = V_372 } ,
...
{ L_176 , . V_50 = V_308 } ,
{ L_177 , . V_49 = V_270 } ,
{ L_178 , . V_47 = 1 << ( V_121 + 0 ) } ,
{ L_179 , . V_47 = 1 << ( V_121 + 1 ) } ,
{ L_180 , . V_47 = 1 << ( V_121 + 2 ) } ,
{ L_181 , . V_47 = 1 << ( V_121 + 3 ) } ,
{ L_182 , . V_47 = 1 << ( V_121 + 4 ) } ,
{ L_183 , . V_47 = 1 << ( V_121 + 5 ) } ,
{ L_184 , . V_47 = 1 << ( V_121 + 6 ) } ,
{ L_185 , . V_47 = 1 << ( V_123 + 0 ) } ,
{ L_186 , . V_47 = 1 << ( V_123 + 1 ) } ,
{ L_187 , . V_47 = 1 << ( V_123 + 2 ) } ,
{ L_188 , . V_47 = 1 << ( V_123 + 3 ) } ,
{ L_189 , . V_47 = 1 << ( V_123 + 4 ) } ,
{ L_190 , . V_47 = 1 << ( V_125 + 0 ) } ,
{ L_191 , . V_47 = 1 << ( V_125 + 0 ) } ,
{ L_192 , . V_47 = 1 << ( V_125 + 0 ) } ,
{ L_193 , . V_47 = 1 << ( V_125 + 1 ) } ,
{ L_194 , . V_47 = 1 << ( V_125 + 1 ) } ,
{ L_195 , . V_47 = 1 << ( V_125 + 1 ) } ,
{ L_196 , . V_47 = 1 << ( V_125 + 2 ) } ,
{ L_197 , . V_47 = 1 << ( V_125 + 2 ) } ,
{ L_198 , . V_47 = 1 << ( V_125 + 2 ) } ,
{ L_199 , . V_47 = 1 << ( V_125 + 3 ) } ,
{ L_200 , . V_47 = 1 << ( V_125 + 3 ) } ,
{ L_201 , . V_47 = 1 << ( V_125 + 3 ) } ,
{ L_202 , . V_47 = 1 << ( V_125 + 4 ) } ,
{ L_203 , . V_47 = 1 << ( V_125 + 4 ) } ,
{ L_204 , . V_47 = 1 << ( V_125 + 4 ) } ,
{ L_205 , . V_47 = 1 << ( V_125 + 5 ) } ,
{ L_206 , . V_47 = 1 << ( V_125 + 5 ) } ,
{ L_207 , . V_47 = 1 << ( V_125 + 5 ) } ,
{ L_208 , . V_47 = 1 << ( V_125 + 6 ) } ,
{ L_209 , . V_47 = 1 << ( V_125 + 6 ) } ,
{ L_210 , . V_47 = 1 << ( V_125 + 6 ) } ,
{ L_211 , . V_47 = 1 << ( V_125 + 7 ) } ,
{ L_212 , . V_41 = V_675 } ,
{ L_213 , . V_41 = V_676 } ,
{ L_214 , . V_41 = V_675 | V_676 } ,
{ L_215 , . V_41 = V_677 } ,
{ L_216 , . V_49 = V_356 } ,
{ L_217 , . V_49 = V_316 } ,
} ;
...
if ( V_149 ) {
* V_149 ++ = '\0' ;
V_671 -> V_21 = F_345 ( V_149 , & V_678 , 10 ) ;
if ( V_149 == V_678 || * V_678 != '\0' ) {
* V_255 = L_218 ;
return - V_119 ;
}
}
V_671 -> V_30 = F_345 ( V_144 , & V_678 , 10 ) ;
if ( V_149 == V_678 || * V_678 != '\0' ) {
* V_255 = L_219 ;
return - V_119 ;
}
...
if ( * V_149 == ',' )
V_684 ++ ;
V_29 = F_263 ( sizeof( V_29 [ 0 ] ) * V_684 , V_587 ) ;
if ( ! V_29 ) {
F_347 ( V_688 L_222
L_223 ) ;
return;
...
F_347 ( V_271 L_226 V_691 L_227 ) ;
return 0 ;
V_264:
return V_182 ;
}
static void T_10 F_353 ( void )
{
F_354 ( V_690 ) ;
F_355 () ;
F_352 () ;
...
void F_172 ( struct V_4 * V_5 , unsigned int V_693 )
{
...
T_1 F_358 ( struct V_4 * V_5 , void T_11 * V_559 , T_1 V_391 , T_1 V_560 ,
unsigned long V_478 , unsigned long V_204 )
{
unsigned long V_464 ;
T_1 V_387 ;
V_387 = F_359 ( V_559 ) ;
V_464 = F_167 ( V_466 , V_204 ) ;
while ( ( V_387 & V_391 ) == V_560 && F_171 ( V_466 , V_464 ) ) {
F_172 ( V_5 , V_478 ) ;
V_387 = F_359 ( V_559 ) ;
}
return V_387 ;
}
bool F_360 ( struct V_2 * V_3 )
{
...
static unsigned int F_361 ( struct V_194 * V_195 )
{
return V_214 ;
}
...
void F_363 ( const struct V_4 * V_5 , const char * V_702 ,
const char * V_703 , ... )
{
struct V_704 V_705 ;
T_12 args ;
...
V_705 . V_703 = V_703 ;
V_705 . V_706 = & args ;
F_347 ( L_228 , V_702 , V_5 -> V_31 , & V_705 ) ;
va_end ( args ) ;
}
void F_364 ( const struct V_2 * V_3 , const char * V_702 ,
const char * V_703 , ... )
{
struct V_704 V_705 ;
T_12 args ;
...
void F_365 ( const struct V_14 * V_15 , const char * V_702 ,
const char * V_703 , ... )
{
struct V_704 V_705 ;
T_12 args ;
...
void F_366 ( const struct V_21 * V_15 , const char * V_707 )
{
F_367 ( V_271 , V_15 , L_230 , V_707 ) ;
}
