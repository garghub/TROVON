...
T_1 V_115 ;
if ( V_27 -> V_116 [ V_20 ] . V_31 == 0 )
break;
if ( V_27 -> V_116 [ V_20 ] . V_117 != 0 ) {
T_1 V_110 =
V_27 -> V_116 [ V_20 ] . V_118 ;
T_1 V_119 = V_29 [ V_110 ] &
V_27 -> V_116 [ V_20 ] . V_117 ;
if ( V_119 == 0 )
continue;
}
V_115 = V_29 [ V_27 -> V_116 [ V_20 ] . V_110 ] &
V_27 -> V_116 [ V_20 ] . V_31 ;
if ( V_115 != V_27 -> V_116 [ V_20 ] . V_120 ) {
F_2 ( L_20 ,
* V_29 ,
V_27 -> V_116 [ V_20 ] . V_31 ,
V_27 -> V_116 [ V_20 ] . V_120 ,
V_115 , V_16 -> V_32 ) ;
return false ;
}
}
...
bool V_103 )
{
T_1 * V_29 , * V_123 , * V_124 ;
struct V_26 V_68 = { 0 } ;
bool V_104 = false ;
int V_21 = 0 ;
V_123 = F_36 ( V_122 , V_121 ,
V_88 , V_89 ) ;
if ( F_50 ( V_123 ) ) {
F_2 ( L_21 ) ;
return F_51 ( V_123 ) ;
}
V_124 = V_123 + ( V_89 / sizeof( * V_124 ) ) ;
V_29 = V_123 ;
while ( V_29 < V_124 ) {
const struct V_26 * V_27 ;
T_1 V_71 ;
...
if ( V_27 -> V_29 . V_30 == V_127 ) {
V_21 = - V_128 ;
break;
}
if ( V_27 -> V_69 & V_129 )
V_71 = V_27 -> V_71 . V_130 ;
else
V_71 = ( ( * V_29 & V_27 -> V_71 . V_31 ) + V_131 ) ;
if ( ( V_124 - V_29 ) < V_71 ) {
F_2 ( L_23 ,
* V_29 ,
V_71 ,
