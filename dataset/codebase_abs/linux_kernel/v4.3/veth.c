...
static int F_46 ( struct V_97 * V_98 [] , struct V_97 * V_33 [] )
{
if ( V_98 [ V_99 ] ) {
if ( F_47 ( V_98 [ V_99 ] ) != V_100 )
return - V_75 ;
if ( ! F_48 ( F_49 ( V_98 [ V_99 ] ) ) )
return - V_101 ;
}
if ( V_98 [ V_102 ] ) {
if ( ! F_35 ( F_50 ( V_98 [ V_102 ] ) ) )
return - V_75 ;
}
return 0 ;
}
static int F_51 ( struct V_103 * V_104 , struct V_1 * V_2 ,
...
struct V_112 * V_113 ;
struct V_103 * V_103 ;
if ( V_33 != NULL && V_33 [ V_114 ] != NULL ) {
struct V_97 * V_115 ;
V_115 = V_33 [ V_114 ] ;
V_113 = F_49 ( V_115 ) ;
V_105 = F_52 ( V_108 ,
F_49 ( V_115 ) + sizeof( struct V_112 ) ,
F_47 ( V_115 ) - sizeof( struct V_112 ) ) ;
if ( V_105 < 0 )
return V_105 ;
V_105 = F_46 ( V_108 , NULL ) ;
if ( V_105 < 0 )
return V_105 ;
V_110 = V_108 ;
} else {
...
if ( V_110 [ V_116 ] ) {
F_53 ( V_106 , V_110 [ V_116 ] , V_107 ) ;
V_111 = V_117 ;
} else {
snprintf ( V_106 , V_107 , V_22 L_1 ) ;
V_111 = V_118 ;
}
V_103 = F_54 ( V_104 , V_110 ) ;
if ( F_55 ( V_103 ) )
return F_56 ( V_103 ) ;
V_36 = F_57 ( V_103 , V_106 , V_111 ,
& V_119 , V_110 ) ;
if ( F_55 ( V_36 ) ) {
F_58 ( V_103 ) ;
return F_56 ( V_36 ) ;
...
goto V_121;
F_34 ( V_36 ) ;
V_105 = F_61 ( V_36 , V_113 ) ;
if ( V_105 < 0 )
goto V_122;
if ( V_98 [ V_99 ] == NULL )
F_59 ( V_2 ) ;
if ( V_98 [ V_116 ] )
F_53 ( V_2 -> V_123 , V_98 [ V_116 ] , V_107 ) ;
else
snprintf ( V_2 -> V_123 , V_107 , V_22 L_1 ) ;
V_105 = F_60 ( V_2 ) ;
if ( V_105 < 0 )
goto V_124;
F_34 ( V_2 ) ;
...
static void F_64 ( struct V_1 * V_2 , struct V_125 * V_126 )
{
struct V_34 * V_35 ;
struct V_1 * V_36 ;
V_35 = F_9 ( V_2 ) ;
...
static struct V_103 * F_67 ( const struct V_1 * V_2 )
{
struct V_34 * V_35 = F_9 ( V_2 ) ;
struct V_1 * V_36 = F_10 ( V_35 -> V_36 ) ;
