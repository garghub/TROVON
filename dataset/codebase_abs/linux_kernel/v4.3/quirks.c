...
static int F_223 ( struct V_1 * V_2 , T_2 V_347 )
{
#ifdef F_224
...
return - V_351 ;
V_350 = F_225 ( L_121 , 0 , & V_349 ) ;
if ( F_194 ( V_350 ) )
return - V_351 ;
V_347 &= ( V_352 | V_353 | V_354 | V_355 ) ;
return V_347 & ~ ( V_352 | V_353 ) ? 0 : 1 ;
#else
return - V_351 ;
#endif
}
...
{
int V_29 ;
if ( ! F_221 ( V_2 ) || F_192 ( V_2 ) != V_356 )
return false ;
for ( V_29 = 0 ; V_29 < F_227 ( V_357 ) ; V_29 ++ )
if ( V_357 [ V_29 ] == V_2 -> V_87 )
return true ;
return false ;
}
static int F_228 ( struct V_1 * V_2 , T_2 V_347 )
{
T_2 V_33 = V_2 -> V_109 & V_358 ?
V_359 : 0 ;
if ( ! F_226 ( V_2 ) )
return - V_328 ;
return V_347 & ~ V_33 ? 0 : 1 ;
}
static int F_229 ( struct V_1 * V_2 , T_2 V_347 )
{
V_347 &= ~ ( V_360 | V_361 | V_352 |
V_353 | V_362 | V_355 ) ;
return V_347 ? 0 : 1 ;
}
int F_230 ( struct V_1 * V_2 , T_2 V_347 )
{
const struct V_363 * V_29 ;
int V_364 ;
for ( V_29 = V_363 ; V_29 -> V_365 ; V_29 ++ ) {
if ( ( V_29 -> V_161 == V_2 -> V_161 ||
V_29 -> V_161 == ( T_2 ) V_278 ) &&
( V_29 -> V_87 == V_2 -> V_87 ||
V_29 -> V_87 == ( T_2 ) V_278 ) ) {
V_364 = V_29 -> V_365 ( V_2 , V_347 ) ;
if ( V_364 >= 0 )
return V_364 ;
}
}
...
{
T_1 V_132 , V_366 , V_367 ;
void T_4 * V_368 ;
F_232 ( V_2 -> V_51 , F_114 ( 31 , 0 ) ,
V_369 , & V_132 ) ;
if ( ! ( V_132 & V_370 ) )
return - V_371 ;
V_368 = F_83 ( V_132 & V_372 ,
F_233 ( V_373 ) ) ;
if ( ! V_368 )
return - V_317 ;
V_366 = F_85 ( V_368 + V_374 ) ;
V_366 &= V_375 | V_376 ;
if ( V_366 != ( V_375 | V_376 ) ) {
V_367 = F_85 ( V_368 + V_373 ) ;
if ( V_367 & V_377 ) {
F_6 ( & V_2 -> V_2 , L_122 ) ;
V_367 &= ~ V_377 ;
F_86 ( V_367 , V_368 + V_373 ) ;
}
}
F_88 ( V_368 ) ;
return 0 ;
...
{
T_1 V_378 ;
F_10 ( V_2 , V_379 , & V_378 ) ;
if ( ! ( V_378 & V_380 ) ) {
F_6 ( & V_2 -> V_2 , L_123 ) ;
V_378 |= V_380 ;
F_53 ( V_2 , V_379 , V_378 ) ;
}
}
...
{
const struct V_381 * V_29 ;
int V_364 ;
for ( V_29 = V_381 ; V_29 -> V_382 ; V_29 ++ ) {
if ( ( V_29 -> V_161 == V_2 -> V_161 ||
V_29 -> V_161 == ( T_2 ) V_278 ) &&
( V_29 -> V_87 == V_2 -> V_87 ||
V_29 -> V_87 == ( T_2 ) V_278 ) ) {
V_364 = V_29 -> V_382 ( V_2 ) ;
if ( V_364 >= 0 )
return;
}
}
...
T_2 V_384 , * V_385 ;
struct V_386 * V_387 ;
if ( V_54 -> V_388 || F_145 ( V_54 , V_389 ) )
return;
V_39 = F_145 ( V_54 , V_390 ) ;
if ( ! V_39 )
return;
F_5 ( V_54 , V_39 + 1 , & V_383 ) ;
if ( V_383 )
return;
V_39 = 0x50 ;
F_32 ( V_54 , V_39 , & V_384 ) ;
if ( V_384 == ( 0x0000 | V_389 ) ) {
T_1 V_350 ;
#ifndef F_238
#define F_238 7
#endif
int V_40 = F_238 * sizeof( T_2 ) ;
V_54 -> V_388 = V_39 ;
F_32 ( V_54 , V_39 + V_391 , & V_384 ) ;
V_54 -> V_392 = V_384 ;
F_32 ( V_54 , V_39 + V_393 , & V_384 ) ;
V_54 -> V_246 = V_384 & V_394 ;
V_54 -> V_28 = V_395 ;
if ( F_10 ( V_54 , V_396 , & V_350 ) !=
V_397 || ( V_350 == 0xffffffff ) )
V_54 -> V_28 = V_396 ;
if ( F_239 ( V_54 , V_389 ) )
return;
V_387 = F_240 ( sizeof( * V_387 ) + V_40 , V_398 ) ;
if ( ! V_387 )
return;
V_387 -> V_385 . V_399 = V_389 ;
V_387 -> V_385 . V_400 = 0 ;
V_387 -> V_385 . V_40 = V_40 ;
V_385 = ( T_2 * ) & V_387 -> V_385 . V_401 [ 0 ] ;
F_241 ( V_54 , V_313 , & V_385 [ V_29 ++ ] ) ;
F_241 ( V_54 , V_402 , & V_385 [ V_29 ++ ] ) ;
F_241 ( V_54 , V_403 , & V_385 [ V_29 ++ ] ) ;
F_241 ( V_54 , V_404 , & V_385 [ V_29 ++ ] ) ;
F_241 ( V_54 , V_405 , & V_385 [ V_29 ++ ] ) ;
F_241 ( V_54 , V_406 , & V_385 [ V_29 ++ ] ) ;
F_241 ( V_54 , V_407 , & V_385 [ V_29 ++ ] ) ;
F_242 ( & V_387 -> V_408 , & V_54 -> V_409 ) ;
}
}
