...
static void F_54 ( struct V_29 * V_30 , T_2 V_190 , T_2 V_183 )
{
V_30 -> V_93 = 0 ;
F_52 ( & V_30 -> V_92 ) ;
...
static void F_55 ( T_4 * V_91 , T_2 V_192 , T_2 V_193 )
{
...
static T_4 F_56 ( T_2 * V_197 , T_6 V_198 , T_6 V_199 )
{
T_4 V_91 = 0 ;
...
static int F_58 ( struct V_29 * V_30 , unsigned int V_211 ,
T_2 * V_206 , T_1 V_207 )
{
...
static int F_59 ( struct V_29 * V_30 , const struct V_202 * V_203 )
{
struct V_38 * V_33 = & V_30 -> V_32 -> V_33 ;
struct V_213 V_214 ;
int V_40 ;
...
V_206 = F_60 ( V_207 , V_84 ) ;
if ( ! V_206 ) {
F_9 ( V_33 , L_57 ) ;
return - V_85 ;
}
V_40 = F_57 ( V_30 , V_203 , V_204 , V_205 ,
V_206 , V_207 ) ;
if ( V_40 )
goto V_223;
if ( V_30 -> V_224 < V_205 ) {
...
F_25 ( V_33 , L_59 ,
V_216 , V_93 ) ;
V_40 = F_58 ( V_30 , V_205 ,
V_206 , V_207 ) ;
if ( V_40 )
goto V_223;
F_54 ( V_30 , V_225 , V_226 ) ;
V_40 = F_49 ( V_30 ) ;
if ( V_40 )
goto V_223;
F_50 ( V_33 , L_60 ) ;
...
T_2 V_228 ;
T_3 V_229 ;
V_227 = V_30 -> V_59 . V_88 * sizeof( struct V_1 ) ;
V_89 = F_60 ( V_227 , V_84 ) ;
if ( ! V_89 ) {
F_9 ( & V_30 -> V_32 -> V_33 , L_57 ) ;
return - V_85 ;
}
error = F_18 ( V_32 , V_220 , V_227 ,
V_89 ) ;
if ( error ) {
F_22 ( V_89 ) ;
return error ;
...
V_240 . V_113 = 1023 ;
if ( V_241 & V_244 ) {
V_30 -> V_117 = V_240 . V_113 ;
V_30 -> V_118 = V_240 . V_112 ;
} else {
V_30 -> V_117 = V_240 . V_112 ;
V_30 -> V_118 = V_240 . V_113 ;
}
F_5 ( & V_32 -> V_33 ,
L_64 , V_30 -> V_117 , V_30 -> V_118 ) ;
return 0 ;
}
...
int V_87 ;
V_104 -> V_257 = L_67 ;
F_73 ( V_258 , V_104 -> V_259 ) ;
F_74 ( V_104 , V_260 , V_261 ) ;
F_74 ( V_104 , V_262 , V_261 ) ;
F_74 ( V_104 , V_128 ,
V_261 ) ;
F_74 ( V_104 , V_129 ,
V_261 ) ;
...
V_104 -> V_257 = L_71 ;
V_104 -> V_266 = V_30 -> V_266 ;
V_104 -> V_111 . V_267 = V_268 ;
V_104 -> V_33 . V_269 = V_33 ;
V_104 -> V_270 = V_271 ;
V_104 -> V_272 = V_273 ;
F_75 ( V_104 , V_263 , V_274 ) ;
F_78 ( V_104 , V_260 , 0 , V_30 -> V_117 , 0 , 0 ) ;
F_78 ( V_104 , V_262 , 0 , V_30 -> V_118 , 0 , 0 ) ;
if ( V_30 -> V_235 == V_9 ||
( V_30 -> V_235 == V_237 &&
V_30 -> V_148 ) ) {
F_78 ( V_104 , V_275 , 0 , 255 , 0 , 0 ) ;
}
if ( V_107 -> V_108 ) {
F_72 ( V_104 , V_30 ) ;
V_265 |= V_276 ;
...
static void F_83 ( const struct V_202 * V_203 , void * V_282 )
{
F_84 ( V_282 , V_203 ) ;
F_85 ( V_203 ) ;
}
...
error = F_67 ( V_30 ) ;
if ( error ) {
F_9 ( & V_32 -> V_33 , L_76 , error ) ;
return error ;
}
error = F_62 ( V_30 ) ;
if ( error )
goto V_285;
error = F_87 ( V_286 , true , V_287 ,
& V_32 -> V_33 , V_84 , V_30 ,
F_83 ) ;
if ( error ) {
F_9 ( & V_32 -> V_33 , L_77 ,
...
static int F_88 ( struct V_29 * V_30 , T_2 V_288 )
{
struct V_38 * V_33 = & V_30 -> V_32 -> V_33 ;
int error ;
struct V_289 * V_290 ;
struct V_289 V_291 = { . V_292 = 0 , . V_293 = 0 } ;
if ( V_288 == V_294 )
V_290 = & V_291 ;
else
V_290 = & V_30 -> V_295 ;
error = F_19 ( V_30 -> V_32 , V_30 -> V_224 ,
sizeof( V_30 -> V_295 ) , V_290 ) ;
if ( error )
return error ;
F_5 ( V_33 , L_78 ,
V_290 -> V_292 , V_290 -> V_293 ) ;
return 0 ;
}
...
sizeof( V_30 -> V_295 ) , & V_30 -> V_295 ) ;
if ( error )
return error ;
if ( V_30 -> V_295 . V_292 == 0 || V_30 -> V_295 . V_293 == 0 ) {
if ( ! V_56 ) {
F_5 ( V_33 , L_79 ) ;
F_49 ( V_30 ) ;
V_56 = true ;
...
F_5 ( V_33 , L_80 ) ;
V_30 -> V_295 . V_292 = 20 ;
V_30 -> V_295 . V_293 = 100 ;
return F_88 ( V_30 , V_296 ) ;
}
}
F_5 ( V_33 , L_81 ,
V_30 -> V_295 . V_292 , V_30 -> V_295 . V_293 ) ;
return 0 ;
}
...
if ( V_203 ) {
error = F_59 ( V_30 , V_203 ) ;
if ( error )
F_25 ( V_33 , L_83 , error ) ;
}
if ( V_30 -> V_235 ) {
error = F_76 ( V_30 ) ;
if ( error )
...
F_50 ( V_33 ,
L_85 ,
V_59 -> V_60 , V_59 -> V_219 , V_59 -> V_234 >> 4 ,
V_59 -> V_234 & 0xf , V_59 -> V_297 , V_59 -> V_88 ) ;
return 0 ;
}
static T_7 F_89 ( struct V_38 * V_33 ,
struct V_298 * V_299 , char * V_52 )
{
struct V_29 * V_30 = F_90 ( V_33 ) ;
struct V_213 * V_59 = & V_30 -> V_59 ;
return F_91 ( V_52 , V_300 , L_86 ,
V_59 -> V_234 >> 4 , V_59 -> V_234 & 0xf , V_59 -> V_297 ) ;
}
static T_7 F_92 ( struct V_38 * V_33 ,
struct V_298 * V_299 , char * V_52 )
{
struct V_29 * V_30 = F_90 ( V_33 ) ;
struct V_213 * V_59 = & V_30 -> V_59 ;
return F_91 ( V_52 , V_300 , L_87 ,
V_59 -> V_60 , V_59 -> V_219 ) ;
}
static T_7 F_93 ( char * V_52 , int V_43 ,
struct V_1 * V_86 , int V_208 ,
const T_2 * V_42 )
{
int V_87 ;
if ( F_2 ( V_86 ) > 1 )
V_43 += F_91 ( V_52 + V_43 , V_300 - V_43 ,
L_88 , V_208 ) ;
for ( V_87 = 0 ; V_87 < F_1 ( V_86 ) ; V_87 ++ )
V_43 += F_91 ( V_52 + V_43 , V_300 - V_43 ,
L_89 , V_87 , V_42 [ V_87 ] , V_42 [ V_87 ] ) ;
V_43 += F_91 ( V_52 + V_43 , V_300 - V_43 , L_90 ) ;
return V_43 ;
}
...
V_43 += F_91 ( V_52 + V_43 , V_300 - V_43 ,
L_91 , V_86 -> type ) ;
for ( V_301 = 0 ; V_301 < F_2 ( V_86 ) ; V_301 ++ ) {
T_3 V_209 = F_1 ( V_86 ) ;
T_3 V_46 = V_86 -> V_103 + V_301 * V_209 ;
error = F_18 ( V_30 -> V_32 , V_46 , V_209 , V_302 ) ;
if ( error )
goto V_303;
V_43 = F_93 ( V_52 , V_43 , V_86 , V_301 , V_302 ) ;
}
}
V_303:
F_22 ( V_302 ) ;
...
static int F_95 ( struct V_38 * V_33 ,
const struct V_202 * V_304 )
{
unsigned int V_305 = 0 ;
char V_306 ;
while ( V_305 < V_304 -> V_209 ) {
V_306 = * ( V_304 -> V_30 + V_305 ) ;
if ( V_306 < '0' || ( V_306 > '9' && V_306 < 'A' ) || V_306 > 'F' )
return 0 ;
V_305 ++ ;
}
F_9 ( V_33 , L_92 ) ;
...
static int F_96 ( struct V_38 * V_33 , const char * V_307 )
{
struct V_29 * V_30 = F_90 ( V_33 ) ;
const struct V_202 * V_304 = NULL ;
unsigned int V_308 ;
unsigned int V_305 = 0 ;
unsigned int V_56 = 0 ;
unsigned int V_309 = 0 ;
int V_40 ;
V_40 = F_97 ( & V_304 , V_307 , V_33 ) ;
if ( V_40 ) {
F_9 ( V_33 , L_93 , V_307 ) ;
return V_40 ;
}
V_40 = F_95 ( V_33 , V_304 ) ;
if ( V_40 )
goto F_85;
if ( ! V_30 -> V_181 ) {
V_30 -> V_181 = true ;
...
if ( V_40 )
goto F_51;
V_308 = ( ( * ( V_304 -> V_30 + V_305 ) << 8 ) | * ( V_304 -> V_30 + V_305 + 1 ) ) ;
V_308 += 2 ;
V_40 = F_12 ( V_30 , V_304 -> V_30 + V_305 , V_308 ) ;
if ( V_40 )
goto F_51;
...
if ( V_309 % 50 == 0 )
F_5 ( V_33 , L_96 ,
V_309 , V_305 , V_304 -> V_209 ) ;
}
V_40 = F_6 ( V_30 , & V_30 -> V_71 ,
V_284 ) ;
if ( V_40 )
goto F_51;
F_5 ( V_33 , L_97 , V_309 , V_305 ) ;
...
static T_7 F_98 ( struct V_38 * V_33 ,
struct V_298 * V_299 ,
const char * V_52 , T_1 V_43 )
{
struct V_29 * V_30 = F_90 ( V_33 ) ;
int error ;
error = F_96 ( V_33 , V_312 ) ;
if ( error ) {
F_9 ( V_33 , L_98 , error ) ;
V_43 = error ;
} else {
...
static void F_99 ( struct V_29 * V_30 )
{
switch ( V_30 -> V_107 -> V_313 ) {
case V_314 :
F_49 ( V_30 ) ;
F_28 ( V_30 ,
V_9 , V_315 , 0x83 ) ;
...
static int V_271 ( struct V_104 * V_33 )
{
struct V_29 * V_30 = F_101 ( V_33 ) ;
F_99 ( V_30 ) ;
return 0 ;
}
static void V_273 ( struct V_104 * V_33 )
{
struct V_29 * V_30 = F_101 ( V_33 ) ;
F_100 ( V_30 ) ;
}
static const struct V_106 * F_102 ( struct V_81 * V_32 )
{
struct V_106 * V_107 ;
struct V_318 * V_319 = V_32 -> V_33 . V_320 ;
T_4 * V_321 ;
int V_322 , V_40 ;
if ( ! V_319 )
return F_103 ( - V_323 ) ;
V_107 = F_104 ( & V_32 -> V_33 , sizeof( * V_107 ) , V_84 ) ;
if ( ! V_107 )
return F_103 ( - V_85 ) ;
if ( F_105 ( V_319 , L_100 , & V_322 ) ) {
V_107 -> V_108 = V_322 / sizeof( T_4 ) ;
V_321 = F_104 ( & V_32 -> V_33 ,
V_107 -> V_108 * sizeof( V_321 [ 0 ] ) ,
V_84 ) ;
if ( ! V_321 )
return F_103 ( - V_85 ) ;
V_40 = F_106 ( V_319 , L_100 ,
V_321 , V_107 -> V_108 ) ;
if ( V_40 )
F_25 ( & V_32 -> V_33 ,
L_101 , V_40 ) ;
...
static const struct V_106 * F_107 ( struct V_81 * V_32 )
{
struct V_324 * V_325 ;
...
return F_103 ( - V_323 ) ;
while ( V_329 -> V_333 ) {
if ( ! strcmp ( F_110 ( V_325 ) , V_329 -> V_333 ) )
return & V_329 -> V_107 ;
V_329 ++ ;
}
return F_103 ( - V_323 ) ;
...
F_111 ( struct V_81 * V_32 )
{
const struct V_106 * V_107 ;
V_107 = F_112 ( & V_32 -> V_33 ) ;
if ( V_107 )
return V_107 ;
V_107 = F_102 ( V_32 ) ;
if ( ! F_113 ( V_107 ) || F_114 ( V_107 ) != - V_323 )
return V_107 ;
V_107 = F_107 ( V_32 ) ;
if ( ! F_113 ( V_107 ) || F_114 ( V_107 ) != - V_323 )
return V_107 ;
...
static int F_115 ( struct V_81 * V_32 , const struct V_334 * V_111 )
{
struct V_29 * V_30 ;
const struct V_106 * V_107 ;
int error ;
...
if ( F_113 ( V_107 ) )
return F_114 ( V_107 ) ;
V_30 = F_60 ( sizeof( struct V_29 ) , V_84 ) ;
if ( ! V_30 ) {
F_9 ( & V_32 -> V_33 , L_57 ) ;
return - V_85 ;
}
snprintf ( V_30 -> V_266 , sizeof( V_30 -> V_266 ) , L_103 ,
V_32 -> V_53 -> V_335 , V_32 -> V_46 ) ;
V_30 -> V_32 = V_32 ;
V_30 -> V_107 = V_107 ;
...
F_117 ( & V_30 -> V_95 ) ;
F_117 ( & V_30 -> V_92 ) ;
error = F_118 ( V_32 -> V_179 , NULL , F_46 ,
V_107 -> V_336 | V_337 ,
V_32 -> V_257 , V_30 ) ;
if ( error ) {
F_9 ( & V_32 -> V_33 , L_104 ) ;
...
if ( error )
goto V_338;
error = F_119 ( & V_32 -> V_33 . V_339 , & V_340 ) ;
if ( error ) {
F_9 ( & V_32 -> V_33 , L_105 ,
error ) ;
goto V_341;
...
F_66 ( V_30 ) ;
V_338:
F_120 ( V_32 -> V_179 , V_30 ) ;
V_278:
F_22 ( V_30 ) ;
return error ;
}
static int F_121 ( struct V_81 * V_32 )
{
struct V_29 * V_30 = F_122 ( V_32 ) ;
F_123 ( & V_32 -> V_33 . V_339 , & V_340 ) ;
F_120 ( V_30 -> V_179 , V_30 ) ;
F_64 ( V_30 ) ;
F_66 ( V_30 ) ;
F_22 ( V_30 ) ;
return 0 ;
...
static int T_8 F_128 ( struct V_38 * V_33 )
{
struct V_81 * V_32 = F_125 ( V_33 ) ;
struct V_29 * V_30 = F_122 ( V_32 ) ;
struct V_104 * V_104 = V_30 -> V_104 ;
