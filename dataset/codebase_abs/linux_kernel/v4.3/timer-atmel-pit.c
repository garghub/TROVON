...
static void T_5 F_23 ( struct V_1 * V_10 )
{
unsigned long V_31 ;
unsigned V_32 ;
int V_33 ;
...
V_10 -> V_5 . V_45 = V_46 ;
V_10 -> V_5 . V_47 = 32 ;
V_10 -> V_5 . V_48 = F_33 ( V_31 , V_49 , V_10 -> V_5 . V_47 ) ;
V_10 -> V_5 . V_39 = 100 ;
V_10 -> V_5 . V_50 = F_34 ( 0 ) ;
V_10 -> V_5 . V_51 = F_13 ;
V_10 -> V_5 . V_52 = F_14 ;
V_10 -> V_5 . V_53 = F_18 ;
V_10 -> V_5 . V_54 = F_15 ;
...
static void T_5 F_36 ( struct V_55 * V_56 )
{
struct V_1 * V_10 ;
V_10 = F_37 ( sizeof( * V_10 ) , V_57 ) ;
if ( ! V_10 )
F_31 ( F_32 ( L_4 ) ) ;
V_10 -> V_6 = F_38 ( V_56 , 0 ) ;
if ( ! V_10 -> V_6 )
F_31 ( F_32 ( L_5 ) ) ;
V_10 -> V_34 = F_39 ( V_56 , 0 ) ;
if ( F_40 ( V_10 -> V_34 ) )
V_10 -> V_34 = F_41 ( NULL , L_6 ) ;
if ( F_40 ( V_10 -> V_34 ) )
F_31 ( F_32 ( L_7 ) ) ;
V_10 -> V_23 = F_42 ( V_56 , 0 ) ;
if ( ! V_10 -> V_23 )
F_31 ( F_32 ( L_8 ) ) ;
F_23 ( V_10 ) ;
}
