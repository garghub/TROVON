...
F_14 ( V_22 -> V_34 , V_22 -> V_28 , V_22 -> V_35 ) ;
}
...
static T_5 F_15 ( int V_24 , void * V_25 )
{
struct V_1 * V_22 = V_25 ;
if ( F_9 ( V_22 ) )
return V_38 ;
...
static void F_16 ( struct V_1 * V_22 )
{
V_22 -> V_28 = true ;
F_17 () ;
F_18 ( & V_22 -> V_34 ) ;
...
static int F_20 ( struct V_26 * V_26 )
{
struct V_1 * V_22 = F_21 ( V_26 ) ;
int V_39 ;
V_22 -> V_28 = false ;
F_17 () ;
F_22 ( V_22 -> V_24 ) ;
...
static int F_24 ( struct V_40 * V_7 )
{
struct V_41 * V_6 = F_25 ( V_7 ) ;
struct V_1 * V_22 = F_26 ( V_6 ) ;
return ! F_27 ( V_22 -> V_42 ) ;
}
static int F_28 ( struct V_41 * V_6 , struct V_1 * V_22 )
{
...
if ( ! F_29 ( V_44 , L_7 , & V_46 ) )
V_22 -> V_29 = V_46 ;
else
V_22 -> V_29 = V_20 ;
if ( ! F_29 ( V_44 , L_8 , & V_46 ) )
V_22 -> V_49 = V_46 ;
if ( ! F_29 ( V_44 , L_9 , & V_46 ) )
V_22 -> V_50 = V_46 ;
if ( ! F_29 ( V_44 , L_10 , & V_46 ) )
V_22 -> V_51 = V_46 ;
if ( ! F_30 ( V_44 , L_11 , & V_47 ) )
V_22 -> V_35 = F_31 ( V_47 ) ;
else
V_22 -> V_35 = F_31 ( 1 ) ;
if ( ! F_29 ( V_44 , L_12 , & V_46 ) ) {
V_22 -> V_21 = V_46 ;
} else {
F_3 ( & V_6 -> V_7 , L_13 ) ;
return - V_48 ;
