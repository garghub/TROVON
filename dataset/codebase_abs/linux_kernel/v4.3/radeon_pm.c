...
char * V_100 )
{
struct V_101 * V_82 = F_35 ( V_97 ) ;
struct V_1 * V_2 = V_82 -> V_102 ;
int V_103 = V_2 -> V_8 . V_23 ;
return snprintf ( V_100 , V_104 , L_12 ,
( V_103 == V_24 ) ? L_13 :
( V_103 == V_33 ) ? L_14 :
( V_103 == V_36 ) ? L_15 :
( V_103 == V_37 ) ? L_16 : L_17 ) ;
}
...
if ( ( V_2 -> V_89 & V_106 ) &&
( V_82 -> V_107 != V_108 ) )
return snprintf ( V_100 , V_104 , L_24 ) ;
return snprintf ( V_100 , V_104 , L_12 ,
( V_121 == V_123 ) ? L_13 :
...
return sprintf ( V_100 , L_25 , V_129 == V_131 ? 1 : 2 ) ;
}
...
char * V_100 )
{
return sprintf ( V_100 , L_25 , 0 ) ;
}
static T_2 F_50 ( struct V_96 * V_97 ,
struct V_98 * V_99 ,
char * V_100 )
{
return sprintf ( V_100 , L_25 , 255 ) ;
}
...
return V_132 ;
V_136 = ( V_136 * 255 ) / 100 ;
return sprintf ( V_100 , L_25 , V_136 ) ;
}
...
V_138 = 0 ;
return snprintf ( V_100 , V_104 , L_26 , V_138 ) ;
}
...
{
struct V_96 * V_97 = F_59 ( V_146 , struct V_96 , V_146 ) ;
struct V_1 * V_2 = F_35 ( V_97 ) ;
...
if ( V_177 && ( F_70 ( V_2 ) >= 120 ) )
V_177 = false ;
return V_177 ;
}
static struct V_180 * F_71 ( struct V_1 * V_2 ,
enum V_3 V_173 )
{
int V_6 ;
struct V_180 * V_181 ;
...
void F_79 ( struct V_1 * V_2 , bool V_222 )
{
enum V_3 V_173 ;
...
void F_81 ( struct V_1 * V_2 , bool V_222 )
{
if ( V_222 ) {
F_3 ( & V_2 -> V_8 . V_15 ) ;
...
V_2 -> V_231 ) {
if ( V_2 -> V_8 . V_232 )
F_87 ( V_2 , V_2 -> V_8 . V_232 ,
V_233 ) ;
if ( V_2 -> V_8 . V_234 )
F_87 ( V_2 , V_2 -> V_8 . V_234 ,
V_235 ) ;
if ( V_2 -> V_8 . V_65 )
...
for ( V_6 = 0 ; V_6 < V_2 -> V_8 . V_16 . V_185 ; V_6 ++ ) {
F_74 ( L_34 , V_6 ) ;
F_75 ( V_2 , & V_2 -> V_8 . V_16 . V_181 [ V_6 ] ) ;
}
}
...
if ( V_125 )
return V_125 ;
F_103 ( & V_2 -> V_8 . V_16 . V_142 . V_172 , F_67 ) ;
F_3 ( & V_2 -> V_8 . V_15 ) ;
F_104 ( V_2 ) ;
V_2 -> V_8 . V_16 . V_214 = V_2 -> V_8 . V_16 . V_213 = V_2 -> V_8 . V_16 . V_205 ;
if ( V_220 == 1 )
...
if ( V_2 -> V_8 . V_14 ) {
if ( ! V_2 -> V_8 . V_293 ) {
V_125 = F_107 ( V_2 -> V_97 , & V_294 ) ;
if ( V_125 )
F_92 ( L_38 ) ;
V_125 = F_107 ( V_2 -> V_97 , & V_295 ) ;
if ( V_125 )
F_92 ( L_38 ) ;
V_125 = F_107 ( V_2 -> V_97 , & V_296 ) ;
if ( V_125 )
F_92 ( L_39 ) ;
V_125 = F_107 ( V_2 -> V_97 , & V_297 ) ;
if ( V_125 )
F_92 ( L_40 ) ;
if ( ! V_125 )
V_2 -> V_8 . V_293 = true ;
...
F_6 ( & V_2 -> V_8 . V_15 ) ;
F_39 ( & V_2 -> V_8 . V_115 ) ;
F_110 ( V_2 -> V_97 , & V_296 ) ;
F_110 ( V_2 -> V_97 , & V_297 ) ;
}
F_65 ( V_2 ) ;
F_111 ( V_2 -> V_8 . V_10 ) ;
}
...
F_84 ( V_2 ) ;
F_6 ( & V_2 -> V_8 . V_15 ) ;
F_110 ( V_2 -> V_97 , & V_294 ) ;
F_110 ( V_2 -> V_97 , & V_295 ) ;
F_110 ( V_2 -> V_97 , & V_296 ) ;
F_110 ( V_2 -> V_97 , & V_297 ) ;
}
F_113 ( V_2 ) ;
...
V_310 = F_121 ( V_2 -> V_82 , V_299 , 0 , & V_308 , & V_309 , NULL , NULL ) ;
if ( ( V_310 & V_312 ) &&
! ( V_310 & V_313 ) )
V_311 = false ;
}
...
struct V_101 * V_97 = V_328 -> V_330 -> V_97 ;
...
F_126 ( V_325 , L_49 , V_2 -> V_8 . V_65 ) ;
if ( ( V_2 -> V_18 >= V_278 ) && ( V_2 -> V_89 & V_91 ) )
F_126 ( V_325 , L_50 , V_2 -> V_8 . V_68 ) ;
else
F_126 ( V_325 , L_50 , F_128 ( V_2 ) ) ;
F_126 ( V_325 , L_51 , V_2 -> V_8 . V_67 ) ;
if ( V_2 -> V_20 -> V_8 . V_332 )
F_126 ( V_325 , L_52 , F_129 ( V_2 ) ) ;
if ( V_2 -> V_8 . V_236 )
F_126 ( V_325 , L_53 , V_2 -> V_8 . V_236 ) ;
if ( V_2 -> V_20 -> V_8 . V_333 )
F_126 ( V_325 , L_54 , F_130 ( V_2 ) ) ;
}
return 0 ;
}
