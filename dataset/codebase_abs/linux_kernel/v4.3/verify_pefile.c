...
int V_76 ;
F_2 ( L_14 , V_4 -> V_85 ) ;
V_81 = F_13 ( V_86 [ V_4 -> V_85 ] , 0 , 0 ) ;
if ( F_14 ( V_81 ) )
return ( F_15 ( V_81 ) == - V_87 ) ? - V_88 : F_15 ( V_81 ) ;
...
if ( V_76 < 0 )
goto error;
F_4 ( L_17 , V_4 -> V_89 , V_84 ) ;
if ( memcmp ( V_84 , V_4 -> V_84 , V_4 -> V_89 ) != 0 ) {
F_4 ( L_18 ) ;
V_76 = - V_39 ;
} else {
F_4 ( L_19 ) ;
...
return F_15 ( V_46 ) ;
V_4 . V_46 = V_46 ;
V_76 = F_25 ( V_4 . V_46 , & V_100 , & V_21 , false ) ;
if ( V_76 < 0 || V_21 == 0 ) {
F_26 ( L_21 ) ;
V_76 = - V_90 ;
goto error;
