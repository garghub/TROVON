...
void F_13 ( struct V_6 * V_7 , bool V_52 )
{
struct V_9 * V_8 = F_2 ( V_7 ) ;
T_1 V_10 = 0 ;
if ( ! F_14 ( V_8 ) )
...
static void F_18 ( struct V_9 * V_8 )
{
T_1 V_10 ;
V_10 = F_19 ( V_8 , V_60 ) ;
V_10 |= V_61 ;
...
if ( V_106 & 1 << V_100 ) {
F_34 ( & V_7 -> V_7 , L_10 , V_100 ) ;
F_35 ( V_2 , V_100 , V_109 ) ;
}
}
return 0 ;
}
...
V_2 -> V_99 = F_38 ( V_108 , sizeof( int ) , V_118 ) ;
if ( ! V_2 -> V_99 ) {
F_39 ( V_8 -> V_1 ) ;
return - V_110 ;
}
...
int V_121 ;
int V_5 ;
V_120 = F_41 ( V_118 , L_14 , V_8 -> V_122 ) ;
if ( ! V_120 )
return - V_110 ;
V_8 -> V_104 = F_42 ( V_91 , NULL , V_120 ) ;
F_43 ( V_120 ) ;
if ( ! V_8 -> V_104 ) {
F_24 ( V_66 , L_15 ) ;
return - V_96 ;
}
V_5 = F_44 ( V_8 -> V_1 , V_8 -> V_104 ) ;
if ( V_5 ) {
F_24 ( V_66 , L_16 ) ;
return V_5 ;
}
V_8 -> V_95 = F_45 ( V_91 , L_17 , 0 ) ;
if ( ! V_8 -> V_95 && F_46 ( V_91 ) ) {
V_5 = F_47 ( V_91 ) ;
if ( V_5 )
return V_5 ;
V_8 -> V_95 = F_48 ( V_91 ) ;
...
static int F_52 ( struct V_9 * V_8 )
{
struct V_65 * V_66 = & V_8 -> V_67 -> V_7 ;
...
static int F_58 ( struct V_9 * V_8 )
{
struct V_90 * V_91 = V_8 -> V_67 -> V_7 . V_92 ;
if ( V_91 )
return F_40 ( V_8 ) ;
