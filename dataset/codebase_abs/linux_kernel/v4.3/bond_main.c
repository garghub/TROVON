...
static int F_244 ( struct V_323 * V_324 ,
unsigned long V_311 , void * V_325 )
{
struct V_14 * V_326 = F_245 ( V_325 ) ;
F_56 ( V_326 , L_97 , V_311 ) ;
if ( ! ( V_326 -> V_160 & V_222 ) )
return V_310 ;
if ( V_326 -> V_82 & V_236 ) {
F_56 ( V_326 , L_98 ) ;
return F_239 ( V_311 , V_326 ) ;
}
if ( V_326 -> V_82 & V_178 ) {
F_56 ( V_326 , L_99 ) ;
return F_240 ( V_311 , V_326 ) ;
}
return V_310 ;
}
...
if ( ! F_254 ( V_337 ) )
V_20 = V_337 -> V_289 ;
} else if ( V_13 -> V_289 == F_222 ( V_343 ) ) {
...
V_333 -> V_341 . V_341 = F_257 ( V_13 , V_338 , V_20 ) ;
return true ;
}
T_3 F_258 ( struct V_10 * V_11 , struct V_12 * V_13 )
{
struct V_332 V_346 ;
T_3 V_347 ;
if ( V_11 -> V_52 . V_339 == V_348 ||
! F_248 ( V_11 , V_13 , & V_346 ) )
return F_246 ( V_13 ) ;
if ( V_11 -> V_52 . V_339 == V_340 ||
...
V_347 ^= ( V_350 T_3 ) F_259 ( & V_346 ) ^
( V_350 T_3 ) F_260 ( & V_346 ) ;
V_347 ^= ( V_347 >> 16 ) ;
V_347 ^= ( V_347 >> 8 ) ;
return V_347 ;
}
...
static int F_269 ( struct V_14 * V_19 , struct V_48 * V_49 , int V_385 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
...
if ( F_270 ( & V_386 , V_387 , sizeof( V_181 ) ) )
return - V_397 ;
V_26 = F_183 ( V_19 , & V_386 ) ;
if ( V_26 == 0 &&
F_271 ( V_387 , & V_386 , sizeof( V_181 ) ) )
return - V_397 ;
return V_26 ;
case V_398 :
case V_399 :
V_389 = (struct V_186 T_9 * ) V_49 -> V_396 ;
if ( F_270 ( & V_388 , V_389 , sizeof( V_186 ) ) )
return - V_397 ;
V_26 = F_184 ( V_19 , & V_388 ) ;
if ( V_26 == 0 &&
F_271 ( V_389 , & V_388 , sizeof( V_186 ) ) )
return - V_397 ;
return V_26 ;
default:
break;
...
V_392 = F_209 ( V_19 ) ;
if ( ! F_272 ( V_392 -> V_400 , V_401 ) )
return - V_202 ;
V_15 = F_273 ( V_392 , V_49 -> V_402 ) ;
...
case V_409 :
case V_410 :
F_274 ( & V_391 , V_15 -> V_59 ) ;
V_26 = F_275 ( V_11 , V_411 , & V_391 ) ;
break;
default:
V_26 = - V_212 ;
}
...
static void F_276 ( struct V_14 * V_19 , int V_412 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
if ( V_412 & V_83 )
F_34 ( V_11 ,
...
static void F_277 ( struct V_14 * V_19 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_24 * V_25 ;
struct V_22 * V_22 ;
...
static int F_278 ( struct V_413 * V_414 )
{
...
static int F_280 ( struct V_14 * V_16 ,
struct V_415 * V_416 )
{
if ( V_416 -> V_16 == V_16 )
V_416 -> V_418 = F_278 ;
...
static int F_281 ( struct V_14 * V_19 , int V_420 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_22 * V_22 , * V_23 ;
struct V_24 * V_25 ;
...
static int F_282 ( struct V_14 * V_19 , void * V_198 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_22 * V_22 , * V_23 ;
...
static void F_285 ( struct V_10 * V_11 , struct V_12 * V_13 , int V_246 )
{
struct V_24 * V_25 ;
struct V_22 * V_22 ;
int V_200 = V_246 ;
...
F_287 ( V_11 -> V_16 , V_13 ) ;
}
static T_3 F_288 ( struct V_10 * V_11 )
{
T_3 V_246 ;
struct V_426 V_427 ;
...
static int F_291 ( struct V_12 * V_13 , struct V_14 * V_19 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_336 * V_337 = F_252 ( V_13 ) ;
struct V_22 * V_22 ;
T_3 V_246 ;
if ( V_337 -> V_289 == V_430 && V_13 -> V_289 == F_222 ( V_296 ) ) {
V_22 = F_68 ( V_11 -> V_69 ) ;
if ( V_22 )
F_2 ( V_11 , V_13 , V_22 -> V_16 ) ;
else
...
void F_294 ( struct V_10 * V_11 , unsigned long V_111 )
{
...
int V_169 = 0 ;
#ifdef F_296
F_297 ( F_298 ( & V_11 -> V_437 ) ) ;
#endif
V_434 = F_83 ( F_299 ( struct V_433 , V_438 [ V_11 -> V_185 ] ) ,
V_127 ) ;
if ( ! V_434 ) {
V_169 = - V_128 ;
F_300 ( L_110 ) ;
...
static int F_303 ( struct V_12 * V_13 , struct V_14 * V_16 )
{
struct V_10 * V_11 = F_11 ( V_16 ) ;
struct V_22 * V_22 ;
struct V_433 * V_443 ;
...
if ( F_292 ( V_441 ) ) {
V_22 = V_443 -> V_438 [ F_258 ( V_11 , V_13 ) % V_441 ] ;
F_2 ( V_11 , V_13 , V_22 -> V_16 ) ;
} else {
F_287 ( V_16 , V_13 ) ;
}
...
break;
if ( F_65 ( V_22 ) && V_22 -> V_29 == V_30 ) {
struct V_12 * V_444 = F_306 ( V_13 , V_171 ) ;
if ( ! V_444 ) {
F_194 ( L_112 ,
V_19 -> V_59 , V_445 ) ;
continue;
...
static inline int F_307 ( struct V_10 * V_11 ,
struct V_12 * V_13 )
{
struct V_22 * V_22 = NULL ;
struct V_24 * V_25 ;
...
static T_2 F_308 ( struct V_14 * V_16 , struct V_12 * V_13 ,
void * V_446 , T_10 V_447 )
{
T_2 V_448 = F_309 ( V_13 ) ? F_310 ( V_13 ) : 0 ;
...
static T_11 F_311 ( struct V_12 * V_13 , struct V_14 * V_16 )
{
struct V_10 * V_11 = F_11 ( V_16 ) ;
if ( F_312 ( V_11 ) &&
! F_307 ( V_11 , V_13 ) )
...
static T_11 F_316 ( struct V_12 * V_13 , struct V_14 * V_16 )
{
struct V_10 * V_11 = F_11 ( V_16 ) ;
T_11 V_169 = V_431 ;
if ( F_5 ( F_317 ( V_16 ) ) )
...
F_319 ( V_32 , V_34 ? : V_35 ) ;
return 0 ;
}
static void F_320 ( struct V_14 * V_19 ,
struct V_452 * V_453 )
{
F_321 ( V_453 -> V_454 , V_455 , sizeof( V_453 -> V_454 ) ) ;
F_321 ( V_453 -> V_456 , V_457 , sizeof( V_453 -> V_456 ) ) ;
...
static int F_331 ( struct V_477 * V_52 )
{
...
T_8 V_257 ;
if ( ! F_339 ( V_507 [ V_200 ] , - 1 , ( T_5 * ) & V_257 , - 1 , NULL ) ||
! F_340 ( V_257 ) ) {
F_335 ( L_141 ,
V_507 [ V_200 ] ) ;
V_226 = 0 ;
...
F_342 ( L_149 , V_507 [ V_200 ] ) ;
F_342 ( L_150 ) ;
} else if ( V_496 ) {
F_301 ( L_151 ) ;
}
if ( V_229 && ! F_343 ( V_183 ) ) {
F_335 ( L_152 ,
V_229 , F_1 ( V_183 ) ) ;
V_229 = NULL ;
}
...
static void F_345 ( struct V_14 * V_16 ,
struct V_521 * V_448 ,
void * V_522 )
{
F_346 ( & V_448 -> V_523 ,
...
F_346 ( & V_16 -> V_525 ,
& V_526 ) ;
F_348 ( V_16 , F_345 , NULL ) ;
V_16 -> V_527 = & V_528 ;
}
static int F_349 ( struct V_14 * V_19 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_529 * V_530 = F_350 ( F_209 ( V_19 ) , V_531 ) ;
F_56 ( V_19 , L_160 ) ;
V_11 -> V_73 = F_351 ( V_19 -> V_59 ) ;
if ( ! V_11 -> V_73 )
return - V_128 ;
F_347 ( V_19 ) ;
F_352 ( & V_11 -> V_476 , & V_530 -> V_532 ) ;
F_353 ( V_11 ) ;
F_354 ( V_11 ) ;
if ( F_355 ( V_19 -> V_86 ) &&
V_19 -> V_87 == V_533 )
...
unsigned int F_356 ( void )
{
return V_500 ;
}
int F_357 ( struct V_392 * V_392 , const char * V_59 )
{
struct V_14 * V_19 ;
struct V_10 * V_11 ;
struct V_534 * V_535 ;
...
static int T_12 F_362 ( struct V_392 * V_392 )
{
struct V_529 * V_530 = F_350 ( V_392 , V_531 ) ;
V_530 -> V_392 = V_392 ;
F_363 ( & V_530 -> V_532 ) ;
F_364 ( V_530 ) ;
F_365 ( V_530 ) ;
...
static void T_13 F_366 ( struct V_392 * V_392 )
{
struct V_529 * V_530 = F_350 ( V_392 , V_531 ) ;
...
F_368 ( V_530 ) ;
F_129 () ;
F_369 (bond, tmp_bond, &bn->dev_list, bond_list)
F_370 ( V_11 -> V_16 , & V_542 ) ;
F_371 ( & V_542 ) ;
F_45 () ;
F_372 ( V_530 ) ;
}
static int T_14 F_373 ( void )
{
int V_200 ;
int V_26 ;
F_334 ( L_163 , V_543 ) ;
