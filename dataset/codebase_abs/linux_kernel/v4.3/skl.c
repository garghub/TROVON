...
static int F_33 ( struct V_32 * V_10 )
{
struct V_1 * V_2 = F_25 ( V_10 ) ;
struct V_8 * V_9 = F_26 ( V_2 ) ;
struct V_12 * V_13 = F_6 ( V_9 ) ;
...
static int F_45 ( struct V_7 * V_7 )
{
...
static int F_51 ( struct V_8 * V_9 , int V_44 )
{
struct V_12 * V_13 = F_6 ( V_9 ) ;
...
if ( V_59 < 0 )
return V_59 ;
V_7 = F_61 ( & V_2 -> V_10 , sizeof( * V_7 ) , V_60 ) ;
if ( ! V_7 ) {
F_43 ( V_2 ) ;
return - V_42 ;
}
V_9 = & V_7 -> V_9 ;
F_62 ( V_9 , & V_2 -> V_10 , & V_61 , V_57 ) ;
V_9 -> V_13 . V_62 = 1 ;
V_7 -> V_2 = V_2 ;
V_9 -> V_13 . V_63 = 0 ;
* V_58 = V_7 ;
...
if ( V_59 < 0 )
return V_59 ;
V_13 -> V_44 = F_65 ( V_2 , 0 ) ;
V_13 -> V_39 = F_66 ( V_2 , 0 ) ;
if ( V_13 -> V_39 == NULL ) {
F_22 ( V_13 -> V_10 , L_10 ) ;
return - V_68 ;
}
...
if ( ! F_70 ( V_13 -> V_10 , F_71 ( 64 ) ) ) {
F_72 ( V_13 -> V_10 , F_71 ( 64 ) ) ;
} else {
F_70 ( V_13 -> V_10 , F_71 ( 32 ) ) ;
F_72 ( V_13 -> V_10 , F_71 ( 32 ) ) ;
}
V_65 = ( V_64 >> 8 ) & 0x0f ;
V_66 = ( V_64 >> 12 ) & 0x0f ;
if ( ! V_66 && ! V_65 )
