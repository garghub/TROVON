...
int F_41 ( struct V_137 * V_138 , struct V_31 * V_32 )
{
struct V_38 * V_73 = V_32 -> V_42 ;
T_1 V_139 = V_138 -> V_140 ;
if ( V_73 -> V_52 ) {
F_42 ( V_138 , L_49 ) ;
F_43 ( V_138 , V_73 -> V_52 , L_50 ) ;
F_44 ( V_138 , ',' ) ;
}
if ( V_73 -> V_53 )
F_42 ( V_138 , L_51 ) ;
if ( V_73 -> V_61 & V_116 )
F_45 ( V_138 , L_52 , & V_73 -> V_34 ) ;
if ( V_73 -> V_61 & V_126 )
F_42 ( V_138 , L_53 ) ;
if ( V_73 -> V_61 & V_129 )
F_42 ( V_138 , L_54 ) ;
...
F_45 ( V_138 , L_59 ,
F_46 ( V_73 -> V_97 ) / 1000 ) ;
if ( V_138 -> V_140 != V_139 )
V_138 -> V_140 -- ;
return 0 ;
}
T_4 F_47 ( struct V_31 * V_32 )
{
return V_32 -> V_58 . V_141 -> V_142 ;
}
...
V_144 ;
if ( F_51 ( V_32 , V_155 ) )
V_146 = & V_32 -> V_42 -> V_113 ;
F_52 ( & V_32 -> V_50 , V_146 ,
V_32 -> V_143 ,
V_32 -> V_144 ,
F_51 ( V_32 , V_156 ) ,
F_51 ( V_32 , V_157 ) ) ;
...
{
return V_32 -> V_58 . V_59 && V_32 -> V_58 . V_59 -> V_162 &&
V_32 -> V_159 . V_163 && V_32 -> V_159 . V_163 -> V_162 ;
}
int F_62 ( struct V_31 * V_32 , unsigned long V_164 )
{
unsigned long V_165 = V_32 -> V_42 -> V_99 ;
long V_70 ;
V_70 = F_63 ( & V_32 -> V_58 ) ;
if ( V_70 < 0 )
return V_70 ;
while ( ! F_61 ( V_32 ) ) {
if ( V_165 && F_64 ( V_166 , V_164 + V_165 ) )
return - V_167 ;
F_17 ( L_62 ) ;
V_70 = F_65 ( V_32 -> V_148 ,
F_61 ( V_32 ) || ( V_32 -> V_149 < 0 ) ,
F_66 ( V_165 ) ) ;
if ( V_70 < 0 )
return V_70 ;
if ( V_32 -> V_149 < 0 )
