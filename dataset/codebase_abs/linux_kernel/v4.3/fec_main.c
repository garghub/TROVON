...
V_4 -> V_22 ;
V_498 = F_243 ( & V_4 -> V_86 -> V_87 , V_499 , & V_125 ,
V_381 ) ;
if ( ! V_498 ) {
return - V_89 ;
}
...
V_35 -> V_503 = & V_504 ;
V_35 -> V_505 = & V_506 ;
F_36 ( V_507 , V_4 -> V_97 + V_192 ) ;
F_244 ( V_35 , & V_4 -> V_211 , F_128 , V_508 ) ;
if ( V_4 -> V_74 & V_509 )
V_35 -> V_272 |= V_273 ;
if ( V_4 -> V_74 & V_510 ) {
V_35 -> V_511 = V_512 ;
V_35 -> V_272 |= ( V_513 | V_514
| V_496 | V_515 | V_516 ) ;
V_4 -> V_150 |= V_151 ;
}
if ( V_4 -> V_74 & V_75 ) {
...
if ( ! V_306 )
return;
F_246 ( V_306 , L_27 , & V_519 ) ;
if ( V_519 > 1000 )
V_519 = 1 ;
V_518 = F_247 ( V_306 , L_28 , 0 ) ;
if ( ! F_248 ( V_518 ) )
return;
V_368 = F_249 ( & V_86 -> V_87 , V_518 ,
V_520 , L_29 ) ;
if ( V_368 ) {
...
static void
F_252 ( struct V_365 * V_86 , int * V_521 , int * V_522 )
{
struct V_305 * V_306 = V_86 -> V_87 . V_307 ;
int V_368 ;
* V_521 = * V_522 = 1 ;
...
return;
V_368 = F_246 ( V_306 , L_31 , V_521 ) ;
if ( V_368 )
* V_521 = 1 ;
V_368 = F_246 ( V_306 , L_32 , V_522 ) ;
if ( V_368 )
* V_522 = 1 ;
...
if ( V_111 )
goto V_538;
V_4 -> V_539 = F_269 ( & V_86 -> V_87 , L_43 ) ;
if ( ! F_33 ( V_4 -> V_539 ) ) {
V_111 = F_270 ( V_4 -> V_539 ) ;
if ( V_111 ) {
F_164 ( & V_86 -> V_87 ,
L_44 , V_111 ) ;
goto V_540;
