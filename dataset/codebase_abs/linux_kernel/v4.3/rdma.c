...
void F_48 ( struct V_89 * V_90 )
{
struct V_41 * V_41 = F_33 ( V_90 -> V_84 ) ;
F_47 ( V_41 ) ;
F_24 ( V_41 ) ;
F_16 ( V_90 -> V_87 ) ;
V_90 -> V_87 = NULL ;
...
static int F_49 ( struct V_1 V_91 [] , int V_92 )
{
int V_93 = 0 ;
unsigned int V_40 ;
unsigned int V_54 ;
...
int F_51 ( struct V_23 * V_24 , struct V_98 * V_99 ,
struct V_100 * V_101 )
{
struct V_94 * args ;
...
int V_44 = 0 ;
if ( V_101 -> V_110 < F_52 ( sizeof( struct V_94 ) )
|| V_99 -> V_103 . V_88 )
return - V_60 ;
args = F_53 ( V_101 ) ;
if ( V_24 -> V_55 == 0 ) {
...
if ( args -> V_97 > V_106 ) {
V_107 = F_54 ( F_55 ( V_24 ) , V_108 , V_61 ) ;
if ( ! V_107 ) {
V_44 = - V_62 ;
goto V_111;
}
}
if ( F_39 ( V_107 , (struct V_1 V_70 * ) ( unsigned long ) args -> V_96 , V_108 ) ) {
V_44 = - V_45 ;
goto V_57;
}
V_40 = F_49 ( V_107 , args -> V_97 ) ;
if ( V_40 < 0 ) {
V_44 = - V_60 ;
goto V_57;
}
...
F_29 ( ! V_40 ) ;
V_102 -> V_84 = F_56 ( V_99 , V_40 ) ;
if ( ! V_102 -> V_84 ) {
V_44 = - V_62 ;
goto V_57;
}
if ( V_102 -> V_116 || V_102 -> V_120 ) {
V_102 -> V_87 = F_57 ( sizeof( struct V_122 ) , V_61 ) ;
if ( ! V_102 -> V_87 ) {
V_44 = - V_62 ;
goto V_57;
}
...
V_102 -> V_127 = F_42 ( args -> V_52 ) ;
V_102 -> V_128 = args -> V_129 . V_3 + F_58 ( args -> V_52 ) ;
V_104 = 0 ;
F_8 ( L_7 ,
...
V_24 -> V_131 = V_91 -> V_3 ;
V_24 -> V_132 = V_91 -> V_4 ;
V_44 = F_22 ( V_91 -> V_3 , V_130 , V_42 , ! V_102 -> V_85 ) ;
if ( V_44 < 0 )
goto V_57;
else
V_44 = 0 ;
...
T_2 V_19 ;
int V_137 = 0 ;
if ( V_101 -> V_110 < F_52 ( sizeof( T_1 ) ) ||
V_99 -> V_138 != 0 )
return - V_60 ;
memcpy ( & V_99 -> V_138 , F_53 ( V_101 ) , sizeof( V_99 -> V_138 ) ) ;
V_19 = F_42 ( V_99 -> V_138 ) ;
F_11 ( & V_24 -> V_30 , V_27 ) ;
V_17 = F_2 ( & V_24 -> V_31 , V_19 , NULL ) ;
if ( ! V_17 )
V_137 = - V_60 ;
...
struct V_100 * V_101 )
{
if ( V_101 -> V_110 < F_52 ( sizeof( struct V_46 ) ) ||
V_99 -> V_138 != 0 )
return - V_60 ;
return F_25 ( V_24 , F_53 ( V_101 ) , & V_99 -> V_138 , & V_99 -> V_103 . V_140 ) ;
}
int F_64 ( struct V_23 * V_24 , struct V_98 * V_99 ,
struct V_100 * V_101 )
{
struct V_41 * V_41 = NULL ;
struct V_141 * args ;
int V_44 = 0 ;
if ( V_101 -> V_110 < F_52 ( sizeof( struct V_141 ) )
|| V_99 -> V_142 . V_88 )
return - V_60 ;
args = F_53 ( V_101 ) ;
switch ( V_101 -> V_143 ) {
...
V_44 = F_22 ( args -> V_163 , 1 , & V_41 , 1 ) ;
if ( V_44 != 1 )
goto V_137;
V_44 = 0 ;
F_31 ( V_99 -> V_142 . V_84 , V_41 , 8 , F_66 ( args -> V_163 ) ) ;
if ( V_99 -> V_142 . V_116 || V_99 -> V_142 . V_120 ) {
V_99 -> V_142 . V_87 = F_57 ( sizeof( * V_99 -> V_142 . V_87 ) , V_61 ) ;
if ( ! V_99 -> V_142 . V_87 ) {
V_44 = - V_62 ;
goto V_137;
}
...
V_99 -> V_142 . V_127 = F_42 ( args -> V_52 ) ;
V_99 -> V_142 . V_128 = args -> V_164 + F_58 ( args -> V_52 ) ;
return V_44 ;
V_137:
if ( V_41 )
F_24 ( V_41 ) ;
