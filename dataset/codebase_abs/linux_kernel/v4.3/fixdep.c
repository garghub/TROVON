...
static void F_6 ( const char * V_15 , int V_16 )
{
...
static void F_7 ( const char * V_18 , T_1 V_9 )
{
...
continue;
V_20 += 7 ;
for ( V_21 = V_20 ; V_21 < V_18 + V_9 ; V_21 ++ ) {
...
static int F_8 ( char * V_28 , char * V_29 )
{
...
static void F_9 ( const char * V_31 )
{
struct V_32 V_33 ;
int V_34 ;
void * V_18 ;
...
V_18 = F_13 ( NULL , V_33 . V_36 , V_37 , V_38 , V_34 , 0 ) ;
if ( ( long ) V_18 == - 1 ) {
perror ( L_9 ) ;
F_12 ( V_34 ) ;
return;
...
static void F_15 ( void * V_18 , T_1 V_9 )
{
char * V_15 = V_18 ;
char * V_19 = V_15 + V_9 ;
char * V_20 ;
...
V_15 ++ ;
V_20 = V_15 ;
while ( V_20 < V_19 && * V_20 != ' ' && * V_20 != '\\' && * V_20 != '\n' )
V_20 ++ ;
V_40 = ( * ( V_20 - 1 ) == ':' ) ;
if ( V_40 ) {
V_42 = 1 ;
} else {
memcpy ( V_28 , V_15 , V_20 - V_15 ) ;
V_28 [ V_20 - V_15 ] = 0 ;
if ( F_8 ( V_28 , L_10 ) &&
F_8 ( V_28 , L_11 ) &&
F_8 ( V_28 , L_12 ) &&
...
{
static char V_44 [] V_45 ( ( F_18 ( sizeof( int ) ) ) ) = L_23 ;
int * V_20 = ( int * ) V_44 ;
if ( * V_20 != V_22 ) {
fprintf ( V_1 , L_24 ,
* V_20 ) ;
