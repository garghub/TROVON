...
V_80 = F_37 ( V_5 , V_40 , V_58 -> V_86 . V_87 >> V_63 ) ;
if ( V_80 ) {
F_9 ( L_6 , V_80 ) ;
return V_80 ;
}
V_58 -> V_88 = F_38 ( F_22 ( V_67 -> V_68 , 0 ) ,
F_39 ( V_67 -> V_68 , 0 ) ) ;
return 0 ;
}
...
void F_18 ( struct V_27 * V_28 , int V_89 )
{
T_2 V_90 = 0 ;
unsigned V_91 ;
V_28 -> V_51 . V_51 = V_28 -> V_92 ;
V_28 -> V_51 . V_93 = V_28 -> V_92 ;
if ( V_89 & V_94 )
V_28 -> V_92 [ V_90 ++ ] . V_34 = V_45 | V_44 | V_94 ;
if ( V_89 & V_50 )
V_28 -> V_92 [ V_90 ++ ] . V_34 = V_37 | V_50 ;
if ( ! V_90 )
V_28 -> V_92 [ V_90 ++ ] . V_34 = V_37 | V_50 ;
V_28 -> V_51 . V_95 = V_90 ;
V_28 -> V_51 . V_96 = V_90 ;
for ( V_91 = 0 ; V_91 < V_90 ; ++ V_91 ) {
V_28 -> V_92 [ V_91 ] . V_97 = 0 ;
V_28 -> V_92 [ V_91 ] . V_98 = 0 ;
}
}
int F_43 ( struct V_81 * V_67 , int V_15 , int V_99 ,
T_1 V_34 , struct V_27 * * V_100 )
{
struct V_1 * V_58 = V_67 -> V_101 ;
struct V_27 * V_49 ;
T_3 V_102 ;
int V_80 ;
...
F_18 ( V_49 , V_94 | V_50 ) ;
V_102 = F_45 ( & V_58 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_80 = F_46 ( & V_58 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_104 , & V_49 -> V_51 ,
V_99 >> V_63 , false , NULL , V_102 ,
NULL , NULL , F_12 ) ;
if ( V_80 )
return V_80 ;
* V_100 = V_49 ;
...
int F_48 ( struct V_27 * V_28 , T_2 V_105 , T_4 * V_106 )
{
int V_91 , V_80 ;
if ( V_28 -> V_107 ) {
V_28 -> V_107 ++ ;
...
F_18 ( V_28 , V_105 ) ;
for ( V_91 = 0 ; V_91 < V_28 -> V_51 . V_95 ; V_91 ++ )
V_28 -> V_92 [ V_91 ] . V_34 |= V_108 ;
...
int F_53 ( struct V_52 * V_53 , struct V_111 * V_112 )
{
struct V_113 * V_114 ;
struct V_1 * V_58 ;
if ( F_54 ( V_112 -> V_115 < V_85 ) )
return - V_46 ;
V_114 = V_53 -> V_116 ;
V_58 = V_114 -> V_117 -> V_67 -> V_101 ;
return F_55 ( V_53 , V_112 , & V_58 -> V_4 . V_5 ) ;
}
