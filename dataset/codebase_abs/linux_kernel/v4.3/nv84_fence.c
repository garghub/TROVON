...
F_20 ( struct V_1 * V_2 )
{
struct V_40 * V_41 = ( void * ) V_2 -> V_42 . V_43 ;
struct V_30 * V_31 = V_2 -> V_32 -> V_6 ;
struct V_4 * V_5 ;
int V_11 , V_36 ;
V_5 = V_2 -> V_6 = F_21 ( sizeof( * V_5 ) , V_44 ) ;
if ( ! V_5 )
return - V_45 ;
F_22 ( V_2 , & V_5 -> V_25 ) ;
V_5 -> V_25 . V_46 = F_10 ;
...
V_11 = F_23 ( V_31 -> V_33 , V_41 -> V_49 , & V_5 -> V_24 ) ;
if ( V_11 == 0 ) {
V_11 = F_23 ( V_31 -> V_50 , V_41 -> V_49 ,
& V_5 -> V_23 ) ;
}
for ( V_36 = 0 ; ! V_11 && V_36 < V_2 -> V_32 -> V_35 -> V_37 . V_38 ; V_36 ++ ) {
struct V_39 * V_33 = F_15 ( V_2 -> V_32 -> V_35 , V_36 ) ;
V_11 = F_23 ( V_33 , V_41 -> V_49 , & V_5 -> V_7 [ V_36 ] ) ;
}
if ( V_11 )
F_14 ( V_2 ) ;
return V_11 ;
...
static bool
F_24 ( struct V_51 * V_32 )
{
struct V_30 * V_31 = V_32 -> V_6 ;
int V_36 ;
V_31 -> V_52 = F_25 ( V_31 -> V_25 . V_53 * sizeof( T_2 ) ) ;
if ( V_31 -> V_52 ) {
for ( V_36 = 0 ; V_36 < V_31 -> V_25 . V_53 ; V_36 ++ )
V_31 -> V_52 [ V_36 ] = F_13 ( V_31 -> V_33 , V_36 * 4 ) ;
}
return V_31 -> V_52 != NULL ;
}
static void
F_26 ( struct V_51 * V_32 )
{
struct V_30 * V_31 = V_32 -> V_6 ;
int V_36 ;
if ( V_31 -> V_52 ) {
for ( V_36 = 0 ; V_36 < V_31 -> V_25 . V_53 ; V_36 ++ )
F_17 ( V_31 -> V_33 , V_36 * 4 , V_31 -> V_52 [ V_36 ] ) ;
F_27 ( V_31 -> V_52 ) ;
V_31 -> V_52 = NULL ;
}
}
static void
F_28 ( struct V_51 * V_32 )
{
struct V_30 * V_31 = V_32 -> V_6 ;
F_29 ( V_31 -> V_50 ) ;
if ( V_31 -> V_50 )
...
int
F_33 ( struct V_51 * V_32 )
{
struct V_54 * V_55 = F_34 ( & V_32 -> V_56 ) ;
struct V_30 * V_31 ;
T_2 V_57 ;
int V_11 ;
V_31 = V_32 -> V_6 = F_21 ( sizeof( * V_31 ) , V_44 ) ;
if ( ! V_31 )
return - V_45 ;
V_31 -> V_25 . V_58 = F_28 ;
V_31 -> V_25 . V_52 = F_24 ;
...
V_31 -> V_25 . V_60 = F_20 ;
V_31 -> V_25 . V_61 = F_14 ;
V_31 -> V_25 . V_53 = V_55 -> V_62 ;
V_31 -> V_25 . V_63 = F_35 ( V_31 -> V_25 . V_53 ) ;
V_31 -> V_25 . V_64 = true ;
V_57 = V_32 -> V_56 . V_65 . V_66 != 0 ? V_67 :
V_68 | V_69 ;
V_11 = F_36 ( V_32 -> V_35 , 16 * V_31 -> V_25 . V_53 , 0 , V_57 , 0 ,
0 , NULL , NULL , & V_31 -> V_33 ) ;
if ( V_11 == 0 ) {
V_11 = F_37 ( V_31 -> V_33 , V_57 , false ) ;
if ( V_11 == 0 ) {
V_11 = F_38 ( V_31 -> V_33 ) ;
if ( V_11 )
F_30 ( V_31 -> V_33 ) ;
...
if ( V_11 == 0 )
V_11 = F_36 ( V_32 -> V_35 , 16 * V_31 -> V_25 . V_53 , 0 ,
V_68 | V_69 , 0 ,
0 , NULL , NULL , & V_31 -> V_50 ) ;
if ( V_11 == 0 ) {
V_11 = F_37 ( V_31 -> V_50 , V_68 , false ) ;
if ( V_11 == 0 ) {
V_11 = F_38 ( V_31 -> V_50 ) ;
if ( V_11 )
F_30 ( V_31 -> V_50 ) ;
