...
int F_47 ( struct V_1 * V_2 , struct V_21 * V_167 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_9 ;
V_167 -> V_168 = NULL ;
...
V_9 = F_50 ( V_4 -> V_173 . V_174 , false ) ;
if ( V_9 ) {
F_51 ( V_4 , V_172 ) ;
F_8 ( V_170 ) ;
return V_9 ;
}
V_172 -> V_175 = F_52 ( V_4 , V_172 ,
V_4 -> V_173 . V_174 ) ;
V_9 = F_53 ( V_4 , V_172 -> V_175 ,
V_176 ,
V_177 |
V_178 ) ;
if ( V_9 ) {
...
{
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_4 -> V_49 >= V_73 && V_167 -> V_168 ) {
struct V_169 * V_170 = V_167 -> V_168 ;
...
if ( ! V_9 ) {
if ( V_172 -> V_175 )
F_55 ( V_4 , V_172 -> V_175 ) ;
F_56 ( V_4 -> V_173 . V_174 ) ;
}
F_51 ( V_4 , V_172 ) ;
}
F_8 ( V_170 ) ;
...
T_3 F_60 ( struct V_1 * V_2 , int V_38 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
return F_61 ( V_4 , V_38 ) ;
}
int F_62 ( struct V_1 * V_2 , int V_38 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_179 ;
int V_9 ;
...
F_63 ( & V_4 -> V_180 . V_181 , V_179 ) ;
V_4 -> V_180 . V_182 [ V_38 ] = true ;
V_9 = F_64 ( V_4 ) ;
F_65 ( & V_4 -> V_180 . V_181 , V_179 ) ;
return V_9 ;
}
void F_66 ( struct V_1 * V_2 , int V_38 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_179 ;
if ( V_38 < 0 || V_38 >= V_4 -> V_56 ) {
...
F_63 ( & V_4 -> V_180 . V_181 , V_179 ) ;
V_4 -> V_180 . V_182 [ V_38 ] = false ;
F_64 ( V_4 ) ;
F_65 ( & V_4 -> V_180 . V_181 , V_179 ) ;
}
int F_67 ( struct V_1 * V_2 , int V_38 ,
int * V_183 ,
struct V_184 * V_185 ,
unsigned V_8 )
{
struct V_37 * V_186 ;
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_38 < 0 || V_38 >= V_2 -> V_187 ) {
F_32 ( L_15 , V_38 ) ;
return - V_62 ;
}
V_186 = & V_4 -> V_32 . V_57 [ V_38 ] -> V_58 ;
if ( ! V_186 )
return - V_62 ;
return F_68 ( V_2 , V_38 , V_183 ,
V_185 , V_8 ,
V_186 , & V_186 -> V_188 ) ;
}
