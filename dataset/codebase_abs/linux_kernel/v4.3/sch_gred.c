...
V_7 -> V_31 = F_54 ( V_7 ) -> V_84
* F_55 ( F_54 ( V_7 ) ) ;
return F_40 ( V_7 , V_70 [ V_85 ] ) ;
}
static int F_56 ( struct V_6 * V_7 , struct V_17 * V_18 )
{
struct V_1 * V_2 = F_11 ( V_7 ) ;
struct V_49 * V_35 , * V_86 = NULL ;
int V_8 ;
T_3 V_87 [ V_54 ] ;
struct V_51 V_52 = {
. V_9 = V_2 -> V_9 ,
...
if ( V_86 == NULL )
goto V_89;
if ( F_58 ( V_18 , V_85 , sizeof( V_52 ) , & V_52 ) )
goto V_89;
for ( V_8 = 0 ; V_8 < V_54 ; V_8 ++ ) {
struct V_10 * V_11 = V_2 -> V_12 [ V_8 ] ;
V_87 [ V_8 ] = V_11 ? V_11 -> V_35 . V_60 : 0 ;
}
if ( F_58 ( V_18 , V_78 , sizeof( V_87 ) , V_87 ) )
goto V_89;
...
V_69 . V_91 = V_11 -> V_38 . V_39 ;
V_69 . V_92 = V_11 -> V_38 . V_43 ;
...
V_69 . V_94 = V_22 >> V_11 -> V_35 . V_66 ;
V_90:
if ( F_60 ( V_18 , sizeof( V_69 ) , & V_69 ) < 0 )
goto V_89;
}
F_61 ( V_18 , V_35 ) ;
return F_61 ( V_18 , V_86 ) ;
V_89:
F_62 ( V_18 , V_86 ) ;
return - V_95 ;
}
