...
V_8 -> V_164 = F_88 ( & V_11 -> V_10 , L_19 ) ;
if ( F_82 ( V_8 -> V_164 ) ) {
F_3 ( & V_11 -> V_10 , L_23 ) ;
return F_83 ( V_8 -> V_164 ) ;
}
V_8 -> V_165 = F_88 ( & V_11 -> V_10 , L_24 ) ;
if ( F_82 ( V_8 -> V_165 ) ) {
F_3 ( & V_11 -> V_10 , L_25 ) ;
return F_83 ( V_8 -> V_165 ) ;
}
for ( V_13 = 0 ; V_13 < V_166 ; V_13 ++ ) {
sprintf ( V_157 , L_26 , V_13 ) ;
V_8 -> V_56 [ V_13 ] = F_88 ( & V_11 -> V_10 , V_157 ) ;
if ( F_82 ( V_8 -> V_56 [ V_13 ] ) ) {
F_3 ( & V_11 -> V_10 , L_27 , V_157 ) ;
return F_83 ( V_8 -> V_56 [ V_13 ] ) ;
}
}
if ( F_89 ( V_11 -> V_10 . V_153 , L_28 ) ) {
V_8 -> V_58 = 3 ;
V_53 [ V_52 ] = V_167 ;
V_53 [ V_54 ] = V_168 ;
} else {
...
V_8 -> V_20 = 10 ;
V_14 = F_90 ( V_152 , L_30 ,
& V_8 -> V_94 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_31 ) ;
return - V_21 ;
}
V_14 = F_90 ( V_152 , L_32 ,
& V_8 -> V_90 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_33 ) ;
return - V_21 ;
...
F_93 ( & V_11 -> V_10 ) ;
F_94 ( & V_8 -> V_15 ) ;
V_14 = F_95 ( & V_11 -> V_10 , & V_171 ,
& V_172 , 1 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_35 ) ;
return V_14 ;
}
V_14 = F_96 ( & V_11 -> V_10 , & V_173 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_36 ) ;
return V_14 ;
}
...
{
struct V_7 * V_8 = F_99 ( V_10 ) ;
int V_13 , V_14 ;
V_14 = F_100 ( V_8 -> V_164 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_100 ( V_8 -> V_165 ) ;
if ( V_14 )
goto V_174;
for ( V_13 = 0 ; V_13 < V_166 ; V_13 ++ ) {
V_14 = F_100 ( V_8 -> V_56 [ V_13 ] ) ;
if ( V_14 )
goto V_175;
}
return 0 ;
...
struct V_7 * V_8 = F_99 ( V_10 ) ;
T_1 V_176 ;
F_50 ( V_8 -> V_22 , V_23 , & V_176 ) ;
F_6 ( V_8 -> V_22 , V_23 ,
V_177 , 0 ) ;
F_104 ( V_8 -> V_22 , false ) ;
F_107 ( V_8 -> V_22 ) ;
F_6 ( V_8 -> V_22 , V_23 ,
V_177 , V_176 ) ;
return 0 ;
