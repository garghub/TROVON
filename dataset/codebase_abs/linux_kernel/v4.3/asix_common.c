...
int F_31 ( struct V_1 * V_2 , int V_44 )
{
int V_18 = ( V_44 ? 1 : 0 ) ;
T_1 V_45 [ 2 ] ;
...
int F_34 ( struct V_1 * V_2 , T_1 V_33 )
{
int V_8 ;
...
int F_37 ( struct V_1 * V_2 , T_2 V_52 )
{
int V_8 ;
F_32 ( V_2 -> V_24 , L_11 , V_52 ) ;
...
int F_39 ( struct V_1 * V_2 , T_2 V_52 )
{
int V_8 ;
F_32 ( V_2 -> V_24 , L_14 , V_52 ) ;
...
int F_40 ( struct V_1 * V_2 , T_2 V_4 , int V_56 )
{
int V_8 ;
F_32 ( V_2 -> V_24 , L_16 , V_4 ) ;
...
int F_48 ( struct V_58 * V_76 , int V_77 , int V_78 )
{
...
void F_51 ( struct V_58 * V_76 , int V_77 , int V_78 , int V_83 )
{
struct V_1 * V_2 = F_43 ( V_76 ) ;
V_48 V_79 = F_52 ( V_83 ) ;
F_32 ( V_2 -> V_24 , L_19 ,
...
void F_53 ( struct V_58 * V_24 , struct V_85 * V_86 )
{
struct V_1 * V_2 = F_43 ( V_24 ) ;
T_1 V_87 ;
...
int F_54 ( struct V_58 * V_24 , struct V_85 * V_86 )
{
struct V_1 * V_2 = F_43 ( V_24 ) ;
T_1 V_87 = 0 ;
if ( V_86 -> V_90 & V_91 )
...
int F_55 ( struct V_58 * V_24 )
{
return V_96 ;
}
int F_56 ( struct V_58 * V_24 , struct V_97 * V_98 ,
T_1 * V_7 )
{
struct V_1 * V_2 = F_43 ( V_24 ) ;
T_2 * V_99 ;
...
V_99 = F_57 ( sizeof( T_2 ) * ( V_101 - V_100 + 1 ) ,
V_105 ) ;
if ( ! V_99 )
return - V_106 ;
...
int F_59 ( struct V_58 * V_24 , struct V_97 * V_98 ,
T_1 * V_7 )
{
struct V_1 * V_2 = F_43 ( V_24 ) ;
T_2 * V_99 ;
...
void F_60 ( struct V_58 * V_24 , struct V_112 * V_113 )
{
F_61 ( V_24 , V_113 ) ;
F_62 ( V_113 -> V_114 , V_115 , sizeof( V_113 -> V_114 ) ) ;
F_62 ( V_113 -> V_116 , V_117 , sizeof( V_113 -> V_116 ) ) ;
V_113 -> V_118 = V_96 ;
}
int F_63 ( struct V_58 * V_24 , void * V_119 )
{
struct V_1 * V_2 = F_43 ( V_24 ) ;
struct V_59 * V_7 = (struct V_59 * ) & V_2 -> V_7 ;
