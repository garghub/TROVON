...
V_8 -> V_4 [ * V_2 ] -> V_45 ) ;
F_42 ( V_47 , * V_2 ) ;
V_8 -> V_4 [ * V_2 ] -> V_45 = NULL ;
}
F_43 ( & V_47 -> V_73 , V_33 ) ;
if ( V_8 -> V_4 [ * V_2 ] -> V_9 == V_15 ) {
struct V_48 * V_49 ;
F_27 (p, &drm_dev->mode_config.plane_list, head) {
struct V_50 * V_51 = F_28 ( V_49 ) ;
...
F_17 ( & V_8 -> V_4 [ * V_2 ] -> V_1 ) ;
}
return 0 ;
}
int F_44 ( struct V_46 * V_6 , int V_2 )
{
...
void F_46 ( struct V_46 * V_47 , int V_2 )
{
