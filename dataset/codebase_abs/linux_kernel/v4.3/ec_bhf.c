...
unsigned V_54 , V_55 ;
void T_2 * V_56 ;
V_54 = F_29 ( V_2 -> V_57 + V_58 ) ;
for ( V_55 = 0 ; V_55 < V_54 ; V_55 ++ ) {
T_3 type = F_30 ( V_2 -> V_57 + V_55 * V_59 +
V_60 ) ;
if ( type == V_61 )
break;
}
...
V_2 -> V_63 = F_29 ( V_56 + V_64 ) ;
V_2 -> V_65 = F_29 ( V_56 + V_66 ) ;
V_2 -> V_67 = V_2 -> V_57 + F_32 ( V_56 + V_68 ) ;
V_2 -> V_69 = V_2 -> V_67 + F_32 ( V_2 -> V_67 + V_70 ) ;
V_2 -> V_11 = V_2 -> V_67 + F_32 ( V_2 -> V_67 + V_71 ) ;
V_2 -> V_3 = V_2 -> V_67 + F_32 ( V_2 -> V_67 + V_72 ) ;
return 0 ;
}
static T_4 F_33 ( struct V_41 * V_42 ,
struct V_73 * V_26 )
{
struct V_1 * V_2 = F_34 ( V_26 ) ;
struct V_15 * V_16 ;
unsigned V_17 ;
...
V_85 = F_32 ( V_2 -> V_86 + V_82 ) ;
V_85 &= V_87 ;
V_22 -> V_17 = F_41 ( int , ~ V_85 + 1 , V_81 ) ;
V_22 -> V_88 = 2 * V_22 -> V_17 ;
V_22 -> V_89 = F_42 ( V_53 , V_22 -> V_88 , & V_22 -> V_90 ,
V_91 ) ;
if ( V_22 -> V_89 == NULL ) {
F_31 ( V_53 , L_3 ) ;
return - V_92 ;
...
V_2 -> V_27 [ V_55 ] . V_18 . V_24 = F_44 ( V_25 ) ;
}
...
V_94 = 0 ;
V_94 |= V_95 ;
V_16 -> V_18 . V_94 = F_44 ( V_94 ) ;
V_16 -> V_18 . V_30 = 0 ;
F_15 ( V_2 , V_16 ) ;
}
}
static int F_46 ( struct V_73 * V_26 )
{
struct V_1 * V_2 = F_34 ( V_26 ) ;
struct V_52 * V_53 = F_22 ( V_2 ) ;
int V_96 = 0 ;
F_1 ( V_2 ) ;
V_96 = F_40 ( V_2 , & V_2 -> V_33 , V_2 -> V_65 ,
...
F_45 ( V_2 ) ;
V_96 = F_40 ( V_2 , & V_2 -> V_21 , V_2 -> V_63 ,
...
F_43 ( V_2 ) ;
F_47 ( V_26 ) ;
F_48 ( & V_2 -> V_47 , V_101 , V_102 ) ;
V_2 -> V_47 . V_103 = F_23 ;
F_49 ( & V_2 -> V_47 , F_27 ( 0 , V_50 ) ,
V_102 ) ;
return 0 ;
V_99:
F_50 ( V_53 , V_2 -> V_33 . V_88 , V_2 -> V_33 . V_89 ,
V_2 -> V_33 . V_88 ) ;
V_98:
return V_96 ;
}
static int F_51 ( struct V_73 * V_26 )
{
struct V_1 * V_2 = F_34 ( V_26 ) ;
struct V_52 * V_53 = F_22 ( V_2 ) ;
F_52 ( & V_2 -> V_47 ) ;
F_1 ( V_2 ) ;
F_53 ( V_26 ) ;
F_50 ( V_53 , V_2 -> V_21 . V_88 ,
V_2 -> V_21 . V_89 , V_2 -> V_21 . V_90 ) ;
F_50 ( V_53 , V_2 -> V_33 . V_88 ,
V_2 -> V_33 . V_89 , V_2 -> V_33 . V_90 ) ;
return 0 ;
}
static struct V_104 *
F_54 ( struct V_73 * V_26 ,
struct V_104 * V_105 )
{
struct V_1 * V_2 = F_34 ( V_26 ) ;
V_105 -> V_106 = F_29 ( V_2 -> V_3 + V_5 ) +
F_29 ( V_2 -> V_3 + V_6 ) +
F_29 ( V_2 -> V_3 + V_4 ) ;
V_105 -> V_107 = F_32 ( V_2 -> V_3 + V_9 ) ;
V_105 -> V_108 = F_32 ( V_2 -> V_3 + V_8 ) ;
V_105 -> V_109 = F_29 ( V_2 -> V_3 + V_10 ) ;
V_105 -> V_110 = V_2 -> V_77 ;
V_105 -> V_111 = V_2 -> V_44 ;
return V_105 ;
}
static int F_55 ( struct V_112 * V_53 , const struct V_113 * V_114 )
{
struct V_73 * V_26 ;
struct V_1 * V_2 ;
void T_2 * V_86 ;
...
if ( V_96 < 0 )
goto V_125;
F_66 ( V_26 -> V_126 , V_2 -> V_69 + V_127 , 6 ) ;
V_96 = F_67 ( V_26 ) ;
if ( V_96 < 0 )
goto V_125;
return 0 ;
...
static void F_73 ( struct V_112 * V_53 )
{
struct V_73 * V_26 = F_74 ( V_53 ) ;
struct V_1 * V_2 = F_34 ( V_26 ) ;
F_75 ( V_26 ) ;
F_68 ( V_26 ) ;
F_69 ( V_53 , V_2 -> V_86 ) ;
