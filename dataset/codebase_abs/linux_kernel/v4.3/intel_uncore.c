...
{
return F_109 ( ( F_94 ( V_63 ) & V_152 ) == V_153 , V_154 ) ;
}
static int F_118 ( struct V_45 * V_7 )
{
struct V_5 * V_6 = V_7 -> V_47 ;
struct V_155 * V_156 ;
int V_70 ;
F_119 (engine, dev_priv, i) {
F_113 ( F_120 ( V_156 -> V_157 ) ,
F_75 ( V_158 ) ) ;
if ( F_117 ( V_6 ,
F_120 ( V_156 -> V_157 ) ,
V_159 ,
...
bool F_121 ( struct V_45 * V_7 )
{
return F_122 ( V_7 ) != NULL ;
}
void F_123 ( struct V_45 * V_7 )
{
struct V_5 * V_6 = V_7 -> V_47 ;
if ( F_52 ( V_7 ) &&
( F_13 ( V_6 , V_58 ) & V_59 ) ) {
