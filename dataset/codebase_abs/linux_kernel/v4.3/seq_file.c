...
void F_25 ( struct V_1 * V_2 , const char * V_51 , const char * V_52 )
{
...
void F_26 ( struct V_1 * V_2 , const char * V_55 , T_5 args )
{
int V_56 ;
if ( V_2 -> V_3 < V_2 -> V_4 ) {
...
void F_27 ( struct V_1 * V_2 , const char * V_55 , ... )
{
T_5 args ;
va_start ( args , V_55 ) ;
F_26 ( V_2 , V_55 , args ) ;
...
int F_29 ( struct V_1 * V_2 , const struct V_57 * V_57 , const char * V_52 )
{
char * V_5 ;
T_4 V_4 = F_30 ( V_2 , & V_5 ) ;
int V_58 = - 1 ;
if ( V_4 ) {
char * V_13 = F_31 ( V_57 , V_5 , V_4 ) ;
if ( ! F_12 ( V_13 ) ) {
...
{
return F_29 ( V_2 , & V_10 -> V_59 , V_52 ) ;
}
int F_34 ( struct V_1 * V_2 , const struct V_57 * V_57 ,
const struct V_57 * V_60 , const char * V_52 )
{
char * V_5 ;
T_4 V_4 = F_30 ( V_2 , & V_5 ) ;
int V_58 = - V_61 ;
...
F_32 ( V_2 , V_58 ) ;
return V_58 < 0 && V_58 != - V_61 ? V_58 : 0 ;
}
int F_36 ( struct V_1 * V_2 , struct V_63 * V_63 , const char * V_52 )
{
char * V_5 ;
T_4 V_4 = F_30 ( V_2 , & V_5 ) ;
int V_58 = - 1 ;
if ( V_4 ) {
char * V_13 = F_37 ( V_63 , V_5 , V_4 ) ;
if ( ! F_12 ( V_13 ) ) {
char * V_53 = F_28 ( V_5 , V_13 , V_52 ) ;
if ( V_53 )
V_58 = V_53 - V_5 ;
...
static void * F_39 ( struct V_1 * V_13 , void * V_64 , T_1 * V_23 )
{
++ * V_23 ;
return NULL ;
}
static void F_40 ( struct V_1 * V_13 , void * V_64 )
{
}
...
void F_47 ( struct V_1 * V_2 , char V_54 )
{
if ( V_2 -> V_3 >= V_2 -> V_4 )
return;
V_2 -> V_5 [ V_2 -> V_3 ++ ] = V_54 ;
}
void F_48 ( struct V_1 * V_2 , const char * V_51 )
{
...
void F_49 ( struct V_1 * V_2 , char V_75 ,
...
void F_51 ( struct V_1 * V_2 , char V_75 , long long V_76 )
{
if ( V_76 < 0 ) {
...
int F_52 ( struct V_1 * V_68 , const void * V_65 , T_4 V_56 )
{
if ( V_68 -> V_3 + V_56 < V_68 -> V_4 ) {
memcpy ( V_68 -> V_5 + V_68 -> V_3 , V_65 , V_56 ) ;
V_68 -> V_3 += V_56 ;
return 0 ;
}
F_1 ( V_68 ) ;
...
int V_81 , int V_82 , const void * V_5 , T_4 V_56 ,
bool V_83 )
{
const T_6 * V_84 = V_5 ;
int V_85 , V_86 , V_87 = V_56 ;
int V_67 ;
if ( V_81 != 16 && V_81 != 32 )
V_81 = 16 ;
for ( V_85 = 0 ; V_85 < V_56 && ! F_14 ( V_2 ) ; V_85 += V_81 ) {
V_86 = F_18 ( V_87 , V_81 ) ;
V_87 -= V_81 ;
switch ( V_80 ) {
case V_88 :
F_27 ( V_2 , L_3 , V_79 , V_84 + V_85 ) ;
break;
case V_89 :
F_27 ( V_2 , L_4 , V_79 , V_85 ) ;
break;
default:
F_27 ( V_2 , L_5 , V_79 ) ;
break;
}
V_67 = F_55 ( V_84 + V_85 , V_86 , V_81 , V_82 ,
V_2 -> V_5 + V_2 -> V_3 , V_2 -> V_4 - V_2 -> V_3 ,
V_83 ) ;
if ( V_67 >= V_2 -> V_4 - V_2 -> V_3 ) {
F_1 ( V_2 ) ;
} else {
V_2 -> V_3 += V_67 ;
F_47 ( V_2 , '\n' ) ;
...
struct V_90 * F_56 ( struct V_90 * V_91 , T_1 V_23 )
{
struct V_90 * V_92 ;
F_57 (lh, head)
if ( V_23 -- == 0 )
...
struct V_90 * F_58 ( struct V_90 * V_91 , T_1 V_23 )
{
if ( ! V_23 )
return V_91 ;
return F_56 ( V_91 , V_23 - 1 ) ;
}
struct V_90 * F_59 ( void * V_64 , struct V_90 * V_91 , T_1 * V_33 )
{
struct V_90 * V_92 ;
V_92 = ( (struct V_90 * ) V_64 ) -> V_30 ;
++ * V_33 ;
return V_92 == V_91 ? NULL : V_92 ;
}
struct V_93 * F_60 ( struct V_94 * V_91 , T_1 V_23 )
{
struct V_93 * V_95 ;
F_61 (node, head)
if ( V_23 -- == 0 )
...
struct V_93 * F_62 ( struct V_94 * V_91 , T_1 V_23 )
{
if ( ! V_23 )
return V_96 ;
return F_60 ( V_91 , V_23 - 1 ) ;
}
struct V_93 * F_63 ( void * V_64 , struct V_94 * V_91 ,
T_1 * V_33 )
{
struct V_93 * V_95 = V_64 ;
++ * V_33 ;
if ( V_64 == V_96 )
return V_91 -> V_97 ;
else
...
struct V_93 * F_64 ( struct V_94 * V_91 ,
T_1 V_23 )
{
struct V_93 * V_95 ;
F_65 (node, head)
...
struct V_93 * F_66 ( struct V_94 * V_91 ,
T_1 V_23 )
{
if ( ! V_23 )
return V_96 ;
return F_64 ( V_91 , V_23 - 1 ) ;
}
struct V_93 * F_67 ( void * V_64 ,
struct V_94 * V_91 ,
T_1 * V_33 )
{
struct V_93 * V_95 = V_64 ;
...
return F_68 ( V_95 -> V_30 ) ;
}
struct V_93 *
F_69 ( struct V_94 T_7 * V_91 , int * V_98 , T_1 V_23 )
{
struct V_93 * V_95 ;
F_70 (*cpu) {
...
struct V_93 *
F_71 ( void * V_64 , struct V_94 T_7 * V_91 ,
int * V_98 , T_1 * V_23 )
{
struct V_93 * V_95 = V_64 ;
++ * V_23 ;
if ( V_95 -> V_30 )
return V_95 -> V_30 ;
for ( * V_98 = F_72 ( * V_98 , V_99 ) ; * V_98 < V_100 ;
* V_98 = F_72 ( * V_98 , V_99 ) ) {
struct V_94 * V_101 = F_73 ( V_91 , * V_98 ) ;
if ( ! F_74 ( V_101 ) )
return V_101 -> V_97 ;
}
return NULL ;
