...
int F_46 ( struct V_8 * V_9 , unsigned char * * V_45 ,
T_1 V_25 )
{
...
static int
F_48 ( struct V_1 * V_2 , struct V_23 * V_15 , int V_52 )
{
...
if ( V_52 )
V_53 -> V_39 -> F_48 ( V_2 , V_24 , V_55 , V_52 ) ;
}
return V_52 ;
}
static void F_49 ( struct V_58 * V_19 )
{
struct V_8 * V_9 = F_50 ( V_19 , struct V_8 , V_11 . V_19 ) ;
struct V_10 * V_11 = & V_9 -> V_11 ;
struct V_1 * V_2 ;
struct V_37 * V_53 ;
V_2 = F_51 ( V_9 -> V_59 ) ;
...
int F_59 ( struct V_8 * V_9 , int V_61 )
{
if ( V_61 < V_33 )
return - V_62 ;
V_9 -> V_11 . V_21 = V_61 ;
