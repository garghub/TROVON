...
V_45 . V_5 = V_60 -> V_64 ;
V_45 . V_6 = V_60 -> V_65 ;
V_45 . V_31 [ 0 ] = V_45 . V_5 * ( ( V_60 -> V_66 + 7 ) / 8 ) ;
V_45 . V_56 = F_24 ( V_60 -> V_66 ,
V_60 -> V_67 ) ;
V_54 = V_45 . V_31 [ 0 ] * V_45 . V_6 ;
...
return F_28 ( V_34 ) ;
V_34 -> V_37 = V_61 ;
V_18 = F_29 ( V_51 -> V_48 , & V_61 -> V_15 , & V_45 , V_55 ) ;
if ( V_18 )
return V_18 ;
V_61 -> V_32 = V_32 ;
V_61 -> V_54 = V_54 ;
...
V_61 -> V_49 . V_63 = V_63 ;
strcpy ( V_34 -> V_69 . V_70 , L_4 ) ;
V_34 -> V_24 = V_71 ;
V_34 -> V_72 = & V_73 ;
F_31 ( V_34 , V_63 -> V_31 [ 0 ] , V_63 -> V_53 ) ;
F_32 ( V_34 , & V_61 -> V_49 , V_60 -> V_74 ,
V_60 -> V_75 ) ;
V_34 -> V_76 -> V_77 [ 0 ] . V_16 = V_51 -> V_48 -> V_78 . V_79 ;
V_34 -> V_76 -> V_77 [ 0 ] . V_54 = V_51 -> V_80 . V_81 ;
V_34 -> V_69 . V_82 = V_51 -> V_48 -> V_78 . V_79 ;
V_34 -> V_69 . V_83 = V_51 -> V_80 . V_81 ;
V_34 -> V_84 = V_32 ;
V_34 -> V_85 = V_54 ;
V_34 -> V_69 . V_86 = 0 ;
V_34 -> V_69 . V_87 = 0 ;
F_30 ( L_5 , V_34 -> V_69 . V_82 ) ;
F_30 ( L_6 , ( unsigned long ) V_34 -> V_69 . V_82 ) ;
F_30 ( L_7 , ( unsigned long ) V_34 -> V_69 . V_83 ) ;
F_30 ( L_8 , V_63 -> V_53 ) ;
F_30 ( L_9 , V_63 -> V_31 [ 0 ] ) ;
return 0 ;
}
static int F_33 ( struct V_47 * V_48 ,
struct V_1 * V_61 )
{
struct V_88 * V_15 = & V_61 -> V_15 ;
F_34 ( & V_61 -> V_49 ) ;
F_35 ( & V_61 -> V_49 ) ;
if ( V_15 -> V_9 ) {
F_36 ( V_15 -> V_9 ) ;
...
int V_18 ;
int V_89 = 24 ;
V_61 = F_42 ( sizeof( struct V_1 ) , V_90 ) ;
if ( ! V_61 )
return - V_68 ;
V_51 -> V_91 . V_61 = V_61 ;
F_43 ( & V_61 -> V_25 ) ;
F_44 ( V_51 -> V_48 , & V_61 -> V_49 ,
& V_92 ) ;
V_18 = F_45 ( V_51 -> V_48 , & V_61 -> V_49 ,
V_51 -> V_93 , V_94 ) ;
if ( V_18 )
return V_18 ;
V_18 = F_46 ( & V_61 -> V_49 ) ;
...
return V_18 ;
F_47 ( V_51 -> V_48 ) ;
return F_48 ( & V_61 -> V_49 , V_89 ) ;
}
void F_49 ( struct V_50 * V_51 )
{
if ( ! V_51 -> V_91 . V_61 )
return;
F_33 ( V_51 -> V_48 , V_51 -> V_91 . V_61 ) ;
F_50 ( V_51 -> V_91 . V_61 ) ;
V_51 -> V_91 . V_61 = NULL ;
}
