...
{
struct V_75 * V_76 = V_5 -> V_41 -> V_77 ;
struct V_75 * V_78 ;
struct V_79 * V_80 ;
struct V_2 * V_3 = & V_5 -> V_3 ;
int V_16 , V_67 = 0 ;
V_78 = F_50 ( V_76 , L_10 , 0 ) ;
if ( ! V_78 )
return - V_81 ;
V_80 = F_51 ( V_78 ) ;
F_52 ( V_78 ) ;
...
for ( V_16 = 0 ; V_16 < F_53 ( V_82 ) ; V_16 ++ ) {
V_67 = F_54 ( V_3 , F_55 ( & V_80 -> V_41 ) ,
V_82 [ V_16 ] . V_9 ,
V_82 [ V_16 ] . V_83 ,
V_82 [ V_16 ] . V_84 ) ;
if ( V_67 ) {
...
struct V_2 * V_3 = & V_5 -> V_3 ;
int V_16 ;
V_89 = F_59 ( V_5 -> V_41 , V_3 -> V_90 , sizeof( * V_89 ) , V_91 ) ;
if ( ! V_89 )
return - V_92 ;
for ( V_16 = 0 ; V_16 < V_3 -> V_90 ; V_16 ++ ) {
V_89 [ V_16 ] . V_93 = V_16 ;
V_89 [ V_16 ] . V_94 = F_60 ( V_5 -> V_41 , V_91 ,
L_13 , V_16 ) ;
if ( ! V_89 [ V_16 ] . V_94 )
return - V_92 ;
}
V_87 -> V_94 = F_55 ( V_5 -> V_41 ) ;
V_87 -> V_95 = & V_96 ;
V_87 -> V_89 = V_89 ;
V_87 -> V_97 = V_3 -> V_90 ;
V_87 -> V_98 = & V_99 ;
V_5 -> V_100 = F_61 ( V_87 , V_5 -> V_41 , V_5 ) ;
if ( F_62 ( V_5 -> V_100 ) ) {
F_27 ( V_5 -> V_41 , L_14 ) ;
return F_63 ( V_5 -> V_100 ) ;
}
return 0 ;
}
...
static int F_66 ( struct V_79 * V_101 )
{
struct V_102 * V_41 = & V_101 -> V_41 ;
struct V_103 * V_104 ;
struct V_1 * V_5 ;
struct V_2 * V_3 ;
T_1 V_105 ;
...
V_108 = F_67 ( V_111 , V_41 ) ;
if ( ! V_108 )
return - V_81 ;
V_110 = V_108 -> V_112 ;
V_105 = V_110 -> V_113 ;
V_5 = F_68 ( V_41 , sizeof( * V_5 ) , V_91 ) ;
if ( ! V_5 )
return - V_92 ;
V_5 -> V_41 = V_41 ;
F_69 ( V_101 , V_5 ) ;
V_104 = F_70 ( V_101 , V_114 , 0 ) ;
V_5 -> V_12 = F_71 ( V_41 , V_104 ) ;
if ( F_62 ( V_5 -> V_12 ) ) {
F_27 ( V_41 , L_15 ) ;
return F_63 ( V_5 -> V_12 ) ;
}
V_104 = F_70 ( V_101 , V_114 , 1 ) ;
if ( V_104 ) {
V_5 -> V_59 = F_71 ( V_41 , V_104 ) ;
if ( F_62 ( V_5 -> V_59 ) ) {
F_27 ( V_41 , L_15 ) ;
return F_63 ( V_5 -> V_59 ) ;
}
}
F_72 ( & V_5 -> V_31 ) ;
V_3 = & V_5 -> V_3 ;
...
V_106 = F_74 ( V_101 , 0 ) ;
if ( V_106 ) {
V_67 = F_75 ( V_3 , & V_121 , 0 ,
V_122 , V_123 ) ;
if ( V_67 ) {
F_27 ( V_41 , L_18 ) ;
goto V_124;
}
F_76 ( V_3 , & V_121 , V_106 ,
F_11 ) ;
}
return 0 ;
V_124:
