...
if ( ! V_28 )
return - V_214 ;
F_188 ( V_17 , V_28 + V_294 , & V_293 ) ;
V_293 |= V_295 ;
F_189 ( V_17 , V_28 + V_294 , V_293 ) ;
return 0 ;
}
...
if ( ! V_28 )
return false ;
F_188 ( V_17 , V_28 + V_301 , & V_146 ) ;
return ( V_146 & V_302 ) ? true : false ;
}
...
T_3 V_45 )
{
T_8 V_235 = V_312 & ~ V_166 ;
T_8 V_103 , V_245 , V_187 ;
unsigned int V_163 ;
unsigned long V_244 = 0 ;
int V_27 ;
V_163 = F_86 ( V_312 , V_161 , V_38 ) ;
V_312 &= V_166 ;
F_63 ( V_91 ) ;
if ( V_163 > 1 )
F_63 ( V_87 ) ;
...
if ( F_137 ( V_32 , false , V_311 ) )
goto V_51;
goto V_104;
}
V_245 = V_103 ;
for ( V_27 = 0 ; V_27 < V_163 ; ++ V_27 ) {
V_187 = F_210 ( V_32 , V_245 , V_312 , V_317 ) ;
if ( V_187 == V_254 )
goto V_319;
V_312 += V_38 ;
V_245 += V_38 ;
...
unsigned int V_163 ;
if ( ( V_321 == V_254 ) ||
( V_321 + V_161 > V_32 -> V_39 ) )
return;
V_322 = V_321 ;
V_163 = F_86 ( V_321 , V_161 , V_38 ) ;
V_321 &= V_166 ;
V_245 = V_321 ;
for ( V_27 = 0 ; V_27 < V_163 ; ++ V_27 ) {
F_211 ( V_32 , V_245 ) ;
...
F_216 ( V_90 , V_161 ) ;
F_148 ( V_32 , V_321 , V_163 ) ;
if ( V_79 || V_32 -> V_253 ) {
F_107 ( & V_32 -> V_4 , V_322 , V_161 ) ;
V_32 -> V_253 = false ;
}
}
...
V_45 = * V_15 -> V_45 ;
F_6 ( & V_4 -> V_184 , V_8 ) ;
V_35 = F_212 ( V_15 , V_4 -> V_52 , V_312 , V_161 , V_317 , false ,
V_45 ) ;
if ( V_35 == V_254 )
goto V_51;
F_110 ( V_4 ) ;
...
static void F_220 ( struct V_14 * V_15 , T_8 V_321 , T_6 V_161 ,
enum V_323 V_317 , struct V_324 * V_325 )
{
unsigned long V_8 ;
struct V_1 * V_4 ;
F_63 ( V_82 ) ;
...
return;
F_6 ( & V_4 -> V_184 , V_8 ) ;
F_215 ( V_4 -> V_52 , V_321 , V_161 , V_317 ) ;
F_110 ( V_4 ) ;
F_8 ( & V_4 -> V_184 , V_8 ) ;
}
static int F_221 ( struct V_14 * V_15 , struct V_326 * V_327 ,
int V_328 , enum V_323 V_317 ,
struct V_324 * V_325 )
{
unsigned long V_8 ;
struct V_1 * V_4 ;
...
V_312 = F_223 ( V_164 ) ;
V_164 -> V_330 = F_212 ( V_15 , V_4 -> V_52 ,
V_312 , V_164 -> V_331 , V_317 , false ,
V_45 ) ;
if ( V_164 -> V_330 ) {
V_164 -> V_332 = V_164 -> V_331 ;
V_329 ++ ;
} else
goto V_333;
}
...
if ( V_164 -> V_330 )
F_215 ( V_4 -> V_52 , V_164 -> V_330 ,
V_164 -> V_332 , V_317 ) ;
V_164 -> V_330 = V_164 -> V_332 = 0 ;
}
V_329 = 0 ;
goto V_51;
}
static void F_224 ( struct V_14 * V_15 , struct V_326 * V_327 ,
int V_328 , enum V_323 V_317 ,
struct V_324 * V_325 )
{
unsigned long V_8 ;
...
V_161 = F_228 ( V_161 ) ;
V_45 = V_15 -> V_335 ;
V_334 &= ~ ( V_336 | V_337 | V_338 ) ;
V_334 |= V_339 ;
V_208 = F_226 ( V_334 | V_340 , F_213 ( V_161 ) ) ;
if ( ! V_208 ) {
if ( ! ( V_334 & V_341 ) )
return NULL ;
...
V_45 = * V_15 -> V_45 ;
F_6 ( & V_4 -> V_184 , V_8 ) ;
* V_321 = F_212 ( V_15 , V_4 -> V_52 , F_218 ( V_208 ) ,
V_161 , V_316 , true , V_45 ) ;
if ( * V_321 == V_254 ) {
F_8 ( & V_4 -> V_184 , V_8 ) ;
goto V_234;
}
...
goto V_343;
F_6 ( & V_4 -> V_184 , V_8 ) ;
F_215 ( V_4 -> V_52 , V_321 , V_161 , V_316 ) ;
F_110 ( V_4 ) ;
F_8 ( & V_4 -> V_184 , V_8 ) ;
V_343:
if ( ! F_230 ( V_15 , V_208 , V_161 >> V_40 ) )
...
unsigned long V_8 ;
F_153 ( & V_259 , V_8 ) ;
while ( ! F_239 ( & V_4 -> V_291 ) ) {
V_142 = F_240 ( & V_4 -> V_291 ,
struct V_5 , V_257 ) ;
F_198 ( V_142 ) ;
}
F_155 ( & V_259 , V_8 ) ;
...
return NULL ;
V_349 -> V_200 = V_266 ;
V_349 -> V_202 = ( void * ) F_113 ( V_9 ) ;
if ( ! V_349 -> V_202 ) {
F_241 ( V_349 ) ;
return NULL ;
}
V_349 -> V_4 . V_351 . V_352 = 0 ;
V_349 -> V_4 . V_351 . V_353 = ~ 0ULL ;
V_349 -> V_4 . V_351 . V_354 = true ;
break;
case V_355 :
V_48 = F_170 () ;
if ( ! V_48 ) {
...
static int F_249 ( struct V_2 * V_3 , unsigned long V_356 ,
T_9 V_312 , T_6 V_204 , int V_357 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
int V_211 = 0 ;
int V_187 ;
...
V_211 |= V_220 ;
F_250 ( & V_4 -> V_348 ) ;
V_187 = F_130 ( V_4 , V_356 , V_312 , V_211 , V_204 ) ;
F_251 ( & V_4 -> V_348 ) ;
return V_187 ;
}
static T_6 F_252 ( struct V_2 * V_3 , unsigned long V_356 ,
T_6 V_204 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
T_6 V_223 ;
...
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
unsigned long V_360 , V_231 ;
T_3 * V_199 , V_212 ;
if ( V_4 -> V_200 == V_263 )
return V_356 ;
V_199 = F_126 ( V_4 , V_356 , & V_231 ) ;
if ( ! V_199 || ! F_123 ( * V_199 ) )
return 0 ;
V_360 = V_231 - 1 ;
V_212 = * V_199 & V_361 ;
return ( V_212 & ~ V_360 ) | ( V_356 & V_360 ) ;
}
static bool F_254 ( enum V_362 V_363 )
{
switch ( V_363 ) {
case V_364 :
return true ;
...
continue;
V_370 = F_4 ( sizeof( * V_370 ) , V_9 ) ;
if ( ! V_370 ) {
F_41 ( L_33 ,
F_39 ( V_15 ) ) ;
return;
}
V_370 -> V_245 = V_142 -> V_36 ;
V_370 -> V_331 = V_142 -> V_37 - V_142 -> V_36 ;
if ( V_142 -> V_211 & V_218 )
V_370 -> V_211 |= V_358 ;
if ( V_142 -> V_211 & V_220 )
V_370 -> V_211 |= V_359 ;
F_7 ( & V_370 -> V_257 , V_123 ) ;
}
}
static void F_256 ( struct V_14 * V_15 ,
struct V_368 * V_123 )
{
struct V_369 * V_142 , * V_371 ;
F_257 (entry, next, head, list)
F_11 ( V_142 ) ;
}
int F_258 ( struct V_372 * V_373 )
{
return F_259 ( & V_138 , V_373 ) ;
}
int F_260 ( struct V_372 * V_373 )
{
return F_261 ( & V_138 , V_373 ) ;
}
...
int F_263 ( struct V_2 * V_3 , int V_374 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
unsigned long V_8 ;
int V_375 , V_187 ;
if ( V_374 <= 0 || V_374 > ( V_376 + 1 ) )
return - V_214 ;
for ( V_375 = 0 ; ( V_374 - 1 ) & ~ 0x1ff ; V_374 >>= 9 )
V_375 += 1 ;
if ( V_375 > V_377 )
return - V_214 ;
F_6 ( & V_4 -> V_184 , V_8 ) ;
V_187 = - V_215 ;
if ( V_4 -> V_292 > 0 || V_4 -> V_8 & V_281 )
goto V_51;
V_187 = - V_63 ;
V_4 -> V_273 = ( void * ) F_113 ( V_311 ) ;
if ( V_4 -> V_273 == NULL )
goto V_51;
V_4 -> V_272 = V_375 ;
V_4 -> V_8 |= V_281 ;
...
static T_3 * F_269 ( T_3 * V_262 , int V_206 , int V_135 , bool V_378 )
{
int V_226 ;
T_3 * V_199 ;
while ( true ) {
...
int V_384 ;
V_381 = 1 << ( 9 * ( V_377 + 1 ) ) ;
V_381 = F_279 ( V_381 , ( 1 << 20 ) ) ;
V_380 -> V_8 |= V_385 ;
V_380 -> V_381 = F_279 ( F_280 ( V_17 ) , V_381 ) ;
V_384 = F_281 ( V_17 ) ;
if ( V_384 & V_386 )
V_380 -> V_8 |= V_387 ;
if ( V_384 & V_388 )
...
static void F_282 ( T_1 V_6 , struct V_390 * V_391 )
{
T_3 V_392 ;
V_392 = V_58 [ V_6 ] . V_54 [ 2 ] ;
V_392 &= ~ V_393 ;
V_392 |= F_115 ( V_391 -> V_391 ) ;
V_392 |= V_394 ;
V_392 |= V_395 ;
V_392 |= V_396 ;
V_58 [ V_6 ] . V_54 [ 2 ] = V_392 ;
}
static struct V_390 * F_283 ( T_1 V_6 , bool V_397 )
{
...
V_391 = F_4 ( sizeof( * V_391 ) , V_311 ) ;
if ( ! V_391 )
goto V_51;
F_242 ( & V_391 -> V_184 ) ;
if ( V_397 )
V_391 -> V_399 = 32 ;
V_391 -> V_391 = F_284 ( V_400 , V_311 ) ;
if ( ! V_391 -> V_391 ) {
F_11 ( V_391 ) ;
V_391 = NULL ;
goto V_51;
}
memset ( V_391 -> V_391 , 0 , V_401 * sizeof( T_2 ) ) ;
if ( V_397 ) {
int V_27 ;
for ( V_27 = 0 ; V_27 < 32 ; ++ V_27 )
V_391 -> V_391 [ V_27 ] = V_402 ;
}
V_398 [ V_6 ] = V_391 ;
F_282 ( V_6 , V_391 ) ;
F_96 ( V_22 , V_6 ) ;
...
unsigned long V_8 ;
int V_226 , V_403 ;
V_391 = F_283 ( V_6 , false ) ;
if ( ! V_391 )
return - V_404 ;
F_6 ( & V_391 -> V_184 , V_8 ) ;
for ( V_403 = 0 , V_226 = V_391 -> V_399 ;
V_226 < V_401 ;
++ V_226 ) {
if ( V_391 -> V_391 [ V_226 ] == 0 )
V_403 += 1 ;
else
V_403 = 0 ;
if ( V_403 == V_102 ) {
for (; V_403 != 0 ; -- V_403 )
V_391 -> V_391 [ V_226 - V_403 + 1 ] = V_402 ;
V_226 -= V_102 - 1 ;
goto V_51;
}
}
...
static int F_286 ( T_1 V_6 , int V_226 , union V_406 V_406 )
{
struct V_390 * V_391 ;
struct V_66 * V_22 ;
unsigned long V_8 ;
...
static int F_288 ( struct V_408 * V_380 )
{
int V_6 = - 1 ;
switch ( V_380 -> type ) {
case V_409 :
V_6 = F_289 ( V_380 -> V_410 ) ;
break;
case V_411 :
V_6 = F_290 ( V_380 -> V_412 ) ;
break;
case V_413 :
case V_414 :
V_6 = F_15 ( & V_380 -> V_415 -> V_15 ) ;
break;
default:
F_117 ( 1 ) ;
break;
...
static struct V_416 * F_291 ( struct V_408 * V_380 )
{
struct V_66 * V_22 ;
int V_6 ;
if ( ! V_380 )
...
static struct V_416 * F_292 ( struct V_408 * V_380 )
{
struct V_66 * V_22 ;
int V_6 ;
if ( ! V_380 )
...
static void F_293 ( struct V_419 * V_54 ,
struct V_420 * V_420 ,
struct V_408 * V_380 ,
int V_6 , int V_226 , int V_421 )
{
struct V_422 * V_423 = & V_54 -> V_422 ;
struct V_424 * V_425 = & V_54 -> V_426 ;
union V_406 * V_406 = & V_54 -> V_427 ;
struct V_428 * V_142 ;
V_54 -> V_422 . V_6 = V_6 ;
V_54 -> V_422 . V_226 = V_226 + V_421 ;
V_406 -> V_407 = 0 ;
V_406 -> V_429 . V_430 = V_420 -> V_430 ;
V_406 -> V_429 . V_431 = V_432 -> V_433 ;
V_406 -> V_429 . V_434 = V_420 -> V_435 ;
V_406 -> V_429 . V_436 = V_432 -> V_437 ;
V_406 -> V_429 . V_438 = 1 ;
switch ( V_380 -> type ) {
case V_409 :
V_142 = V_380 -> V_439 ;
...
V_142 -> V_430 = V_226 ;
V_142 -> V_250 = 0 ;
V_142 -> V_440 = V_380 -> V_441 ;
V_142 -> V_442 = V_380 -> V_443 ;
if ( V_380 -> V_441 )
V_142 -> V_250 = 1 ;
break;
case V_411 :
...
static int F_294 ( struct V_416 * V_4 , unsigned int V_447 ,
unsigned int V_448 , void * V_449 )
{
struct V_408 * V_380 = V_449 ;
struct V_450 * V_450 ;
struct V_419 * V_54 ;
struct V_420 * V_451 ;
int V_27 , V_187 , V_6 ;
...
if ( V_6 < 0 )
return - V_214 ;
V_187 = F_295 ( V_4 , V_447 , V_448 , V_449 ) ;
if ( V_187 < 0 )
return V_187 ;
if ( V_380 -> type == V_409 ) {
if ( F_283 ( V_6 , true ) )
...
V_226 = F_285 ( V_6 , V_448 ) ;
}
if ( V_226 < 0 ) {
F_296 ( L_34 ) ;
goto V_454;
}
for ( V_27 = 0 ; V_27 < V_448 ; V_27 ++ ) {
V_450 = F_297 ( V_4 , V_447 + V_27 ) ;
V_451 = F_298 ( V_450 ) ;
if ( ! V_450 || ! V_451 ) {
V_187 = - V_214 ;
goto V_455;
...
if ( ! V_54 )
goto V_455;
V_450 -> V_456 = ( V_6 << 16 ) + V_27 ;
V_450 -> V_457 = V_54 ;
V_450 -> V_458 = & V_459 ;
F_293 ( V_54 , V_451 , V_380 , V_6 , V_226 , V_27 ) ;
F_299 ( V_447 + V_27 , V_460 ) ;
}
return 0 ;
V_455:
for ( V_27 -- ; V_27 >= 0 ; V_27 -- ) {
...
V_454:
F_300 ( V_4 , V_447 , V_448 ) ;
return V_187 ;
}
static void F_301 ( struct V_416 * V_4 , unsigned int V_447 ,
unsigned int V_448 )
{
struct V_422 * V_423 ;
struct V_450 * V_450 ;
...
for ( V_27 = 0 ; V_27 < V_448 ; V_27 ++ ) {
V_450 = F_297 ( V_4 , V_447 + V_27 ) ;
if ( V_450 && V_450 -> V_457 ) {
V_54 = V_450 -> V_457 ;
V_423 = & V_54 -> V_422 ;
F_287 ( V_423 -> V_6 , V_423 -> V_226 ) ;
F_11 ( V_54 ) ;
}
}
F_300 ( V_4 , V_447 , V_448 ) ;
}
static void F_302 ( struct V_416 * V_4 ,
struct V_450 * V_450 )
{
struct V_419 * V_54 = V_450 -> V_457 ;
struct V_422 * V_423 = & V_54 -> V_422 ;
F_286 ( V_423 -> V_6 , V_423 -> V_226 , V_54 -> V_427 ) ;
}
static void F_303 ( struct V_416 * V_4 ,
struct V_450 * V_450 )
{
struct V_419 * V_54 = V_450 -> V_457 ;
struct V_422 * V_423 = & V_54 -> V_422 ;
...
static int F_304 ( struct V_450 * V_54 ,
const struct V_461 * V_250 , bool V_462 )
{
struct V_419 * V_463 = V_54 -> V_457 ;
struct V_422 * V_423 = & V_463 -> V_422 ;
struct V_420 * V_451 = F_298 ( V_54 ) ;
struct V_450 * V_464 = V_54 -> V_465 ;
int V_187 ;
V_187 = V_464 -> V_458 -> V_466 ( V_464 , V_250 , V_462 ) ;
if ( V_187 < 0 || V_187 == V_467 )
return V_187 ;
V_463 -> V_427 . V_429 . V_430 = V_451 -> V_430 ;
V_463 -> V_427 . V_429 . V_434 = V_451 -> V_435 ;
F_286 ( V_423 -> V_6 , V_423 -> V_226 , V_463 -> V_427 ) ;
F_305 ( V_451 ) ;
return V_467 ;
}
static void F_306 ( struct V_450 * V_450 , struct V_424 * V_425 )
{
struct V_419 * V_463 = V_450 -> V_457 ;
* V_425 = V_463 -> V_426 ;
}
int F_307 ( struct V_66 * V_22 )
{
V_22 -> V_417 = F_308 ( NULL , & V_468 , V_22 ) ;
if ( ! V_22 -> V_417 )
return - V_63 ;
V_22 -> V_417 -> V_464 = F_309 () ;
V_22 -> V_418 = F_310 ( V_22 -> V_417 ) ;
return 0 ;
}
