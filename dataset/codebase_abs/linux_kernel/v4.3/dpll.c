...
static void T_2 * F_11 ( T_3 V_16 , T_4 V_17 )
{
T_5 V_18 ;
struct V_19 * V_20 ;
...
struct V_8 * F_12 ( struct V_22 * V_23 )
{
struct V_5 * V_1 ;
...
if ( V_26 -> V_31 < 2 )
return F_13 ( - V_32 ) ;
V_9 = F_14 ( NULL , V_26 -> V_33 [ 0 ] ) ;
V_10 = F_14 ( NULL , V_26 -> V_33 [ 1 ] ) ;
if ( F_15 ( V_9 ) || F_15 ( V_10 ) )
return F_13 ( - V_34 ) ;
V_7 = F_16 ( sizeof( * V_7 ) , V_35 ) ;
V_1 = F_16 ( sizeof( * V_1 ) , V_35 ) ;
if ( ! V_7 || ! V_1 ) {
V_8 = F_13 ( - V_36 ) ;
goto V_12;
}
...
V_14 . V_31 = V_26 -> V_31 ;
V_14 . V_15 = V_26 -> V_33 ;
V_7 -> V_40 = F_11 ( V_26 -> V_16 , V_26 -> V_40 ) ;
V_7 -> V_41 = F_11 ( V_26 -> V_16 , V_26 -> V_41 ) ;
V_7 -> V_42 = F_11 ( V_26 -> V_16 , V_26 -> V_42 ) ;
V_7 -> V_43 = F_11 ( V_26 -> V_16 , V_26 -> V_43 ) ;
V_7 -> V_44 = V_26 -> V_44 ;
V_7 -> V_45 = V_26 -> V_45 ;
V_7 -> V_46 = V_26 -> V_46 ;
V_7 -> V_47 = V_26 -> V_47 ;
...
V_15 = F_16 ( sizeof( char * ) * V_14 -> V_31 , V_35 ) ;
if ( ! V_15 )
goto V_12;
F_22 ( V_4 , V_15 , V_14 -> V_31 ) ;
V_14 -> V_15 = V_15 ;
V_7 -> V_40 = F_23 ( V_4 , 0 ) ;
if ( ! V_7 -> V_46 ) {
V_7 -> V_42 = F_23 ( V_4 , 1 ) ;
