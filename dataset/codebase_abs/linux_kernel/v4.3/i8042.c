...
static void F_70 ( struct V_105 * V_103 )
{
F_58 ( false ) ;
}
...
V_4 = F_72 ( sizeof( struct V_4 ) , V_106 ) ;
if ( ! V_4 )
return - V_107 ;
...
F_73 ( V_4 -> V_117 , L_48 , sizeof( V_4 -> V_117 ) ) ;
F_73 ( V_4 -> V_118 , V_119 , sizeof( V_4 -> V_118 ) ) ;
F_73 ( V_4 -> V_120 , V_121 ,
sizeof( V_4 -> V_120 ) ) ;
V_11 -> V_4 = V_4 ;
V_11 -> V_47 = V_45 ;
return 0 ;
}
static int T_2 F_74 ( int V_122 )
{
struct V_4 * V_4 ;
...
V_4 -> V_103 . V_116 = & V_83 -> V_103 ;
if ( V_122 < 0 ) {
F_73 ( V_4 -> V_117 , L_49 , sizeof( V_4 -> V_117 ) ) ;
F_73 ( V_4 -> V_118 , V_123 , sizeof( V_4 -> V_118 ) ) ;
F_73 ( V_4 -> V_120 , V_124 ,
sizeof( V_4 -> V_120 ) ) ;
V_4 -> V_115 = F_23 ;
} else {
...
bool F_84 ( const struct V_4 * V_11 )
{
int V_13 ;
for ( V_13 = 0 ; V_13 < V_104 ; V_13 ++ )
...
static int T_2 F_91 ( struct V_105 * V_103 )
{
int error ;
V_83 = V_103 ;
if ( V_96 ) {
...
static int F_92 ( struct V_105 * V_103 )
{
F_82 () ;
F_85 () ;
F_58 ( false ) ;
...
if ( V_144 )
goto V_145;
V_143 = F_96 ( & V_146 , F_91 , NULL , 0 , NULL , 0 ) ;
if ( F_97 ( V_143 ) ) {
V_144 = F_98 ( V_143 ) ;
goto V_145;
}
