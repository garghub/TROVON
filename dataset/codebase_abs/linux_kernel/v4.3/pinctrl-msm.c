...
static void F_31 ( struct V_2 * V_4 , unsigned V_59 )
{
int V_61 = V_4 -> V_62 + V_59 ;
return F_32 ( V_61 ) ;
}
...
V_66 = ! ! ( V_30 & F_20 ( V_21 -> V_44 ) ) ;
V_65 = ( V_30 >> V_21 -> V_31 ) & 7 ;
V_67 = ( V_30 >> V_21 -> V_41 ) & 7 ;
V_68 = ( V_30 >> V_21 -> V_39 ) & 3 ;
F_34 ( V_64 , L_7 , V_21 -> V_12 , V_66 ? L_8 : L_9 , V_65 ) ;
F_34 ( V_64 , L_10 , F_17 ( V_67 ) ) ;
F_34 ( V_64 , L_11 , V_69 [ V_68 ] ) ;
}
static void F_35 ( struct V_63 * V_64 , struct V_2 * V_4 )
{
unsigned V_61 = V_4 -> V_62 ;
unsigned V_24 ;
for ( V_24 = 0 ; V_24 < V_4 -> V_70 ; V_24 ++ , V_61 ++ ) {
F_33 ( V_64 , NULL , V_4 , V_24 , V_61 ) ;
F_36 ( V_64 , L_12 ) ;
}
}
...
V_23 &= ~ F_20 ( V_21 -> V_83 ) ;
F_14 ( V_23 , V_7 -> V_29 + V_21 -> V_79 ) ;
if ( F_44 ( V_72 -> V_80 , V_7 -> V_85 ) )
F_37 ( V_7 , V_21 , V_72 ) ;
F_15 ( & V_7 -> V_28 , V_22 ) ;
}
static int F_45 ( struct V_71 * V_72 , unsigned int type )
{
struct V_2 * V_3 = F_39 ( V_72 ) ;
struct V_1 * V_7 = F_1 ( V_3 ) ;
const struct V_20 * V_21 ;
...
static int F_48 ( struct V_71 * V_72 , unsigned int V_99 )
{
struct V_2 * V_3 = F_39 ( V_72 ) ;
struct V_1 * V_7 = F_1 ( V_3 ) ;
unsigned long V_22 ;
...
{
struct V_2 * V_3 = F_51 ( V_102 ) ;
const struct V_20 * V_21 ;
struct V_1 * V_7 = F_1 ( V_3 ) ;
struct V_103 * V_4 = F_52 ( V_102 ) ;
int V_104 ;
int V_105 = 0 ;
T_1 V_23 ;
int V_24 ;
...
V_48 = F_62 ( & V_7 -> V_4 , F_60 ( V_7 -> V_58 ) , 0 , 0 , V_4 -> V_70 ) ;
if ( V_48 ) {
F_24 ( V_7 -> V_58 , L_15 ) ;
F_63 ( & V_7 -> V_4 ) ;
return V_48 ;
...
F_65 ( V_4 , & V_113 , V_7 -> V_100 ,
F_50 ) ;
return 0 ;
}
static int F_66 ( struct V_116 * V_117 , unsigned long V_118 ,
void * V_119 )
{
...
{
F_66 ( & V_123 -> V_120 , 0 , NULL ) ;
}
static void F_69 ( struct V_1 * V_7 )
{
int V_24 ;
const struct V_124 * V_65 = V_7 -> V_8 -> V_18 ;
for ( V_24 = 0 ; V_24 < V_7 -> V_8 -> V_16 ; V_24 ++ )
if ( ! strcmp ( V_65 [ V_24 ] . V_12 , L_17 ) ) {
V_7 -> V_120 . V_125 = F_66 ;
V_7 -> V_120 . V_126 = 128 ;
if ( F_70 ( & V_7 -> V_120 ) )
F_24 ( V_7 -> V_58 ,
L_18 ) ;
...
int F_71 ( struct V_128 * V_129 ,
const struct V_130 * V_131 )
{
struct V_1 * V_7 ;
struct V_132 * V_133 ;
int V_48 ;
V_7 = F_72 ( & V_129 -> V_58 , sizeof( * V_7 ) , V_134 ) ;
if ( ! V_7 ) {
...
V_7 -> V_4 = V_136 ;
F_73 ( & V_7 -> V_28 ) ;
V_133 = F_74 ( V_129 , V_137 , 0 ) ;
V_7 -> V_29 = F_75 ( & V_129 -> V_58 , V_133 ) ;
if ( F_76 ( V_7 -> V_29 ) )
return F_77 ( V_7 -> V_29 ) ;
F_69 ( V_7 ) ;
V_7 -> V_100 = F_78 ( V_129 , 0 ) ;
if ( V_7 -> V_100 < 0 ) {
F_24 ( & V_129 -> V_58 , L_20 ) ;
return V_7 -> V_100 ;
}
V_138 . V_12 = F_60 ( & V_129 -> V_58 ) ;
V_138 . V_13 = V_7 -> V_8 -> V_13 ;
V_138 . V_15 = V_7 -> V_8 -> V_15 ;
V_7 -> V_7 = F_79 ( & V_138 , & V_129 -> V_58 , V_7 ) ;
if ( F_76 ( V_7 -> V_7 ) ) {
...
F_81 ( V_129 , V_7 ) ;
F_82 ( & V_129 -> V_58 , L_22 ) ;
return 0 ;
}
int F_83 ( struct V_128 * V_129 )
{
struct V_1 * V_7 = F_84 ( V_129 ) ;
F_63 ( & V_7 -> V_4 ) ;
F_80 ( V_7 -> V_7 ) ;
F_85 ( & V_7 -> V_120 ) ;
return 0 ;
