...
{
struct V_4 * V_4 = F_30 ( V_2 -> V_43 ) ;
struct V_3 * V_141 ;
int V_13 ;
T_1 V_12 ;
V_141 = F_31 ( V_2 -> V_43 , sizeof( struct V_3 ) ,
V_142 ) ;
if ( V_141 == NULL )
return - V_143 ;
F_32 ( V_2 , V_141 ) ;
...
static struct V_149 * F_35 ( struct V_150 * V_43 )
{
struct V_4 * V_4 = F_30 ( V_43 ) ;
return V_4 -> V_149 ;
}
static int F_36 ( struct V_151 * V_152 )
{
return F_37 ( & V_152 -> V_43 , & V_153 ,
& V_154 , 1 ) ;
}
