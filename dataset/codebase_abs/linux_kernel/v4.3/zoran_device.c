...
V_2 -> V_228 = 0 ;
V_2 -> V_219 = 0 ;
V_2 -> V_220 = 0x7fffffff ;
}
static T_1
F_39 ( struct V_1 * V_2 )
{
T_1 V_229 ;
if ( ( V_229 = F_2 ( V_137 ) & 0x78000000 ) ) {
if ( V_229 & V_230 ) {
F_3 ( V_230 , V_137 ) ;
V_2 -> V_215 ++ ;
}
...
V_139 ) ;
F_32 ( V_2 , 0 ) ;
V_5 = ( V_2 -> V_12 . V_30 [ 1 ] << V_242 ) |
( 0 << V_243 ) ;
F_3 ( V_5 , V_244 ) ;
if ( V_2 -> V_12 . V_245 == V_246 &&
V_2 -> V_12 . V_247 == V_248 ) {
if ( V_2 -> V_249 )
F_41 ( V_2 -> V_249 , 0 , 1 ) ;
F_8 ( V_2 , 0 , 0 , 0 ) ;
}
...
struct V_252 V_253 ;
int V_254 =
V_2 -> V_168 . V_255 / V_2 -> V_184 . V_185 ;
V_2 -> V_109 = V_34 ;
V_253 . V_114 = V_2 -> V_184 . V_202 ;
V_253 . V_116 = V_2 -> V_184 . V_192 ;
V_253 . V_106 = V_2 -> V_184 . V_204 ;
V_253 . V_112 = V_2 -> V_184 . V_194 ;
V_253 . V_256 =
V_2 -> V_184 . V_68 | ( V_2 -> V_184 . V_69 << 8 ) ;
V_253 . V_257 = V_2 -> V_184 . V_258 . V_257 ;
switch ( V_34 ) {
case V_40 : {
struct V_259 V_260 ;
struct V_261 V_262 ;
F_33 ( V_2 , 0 ) ;
F_43 ( V_2 , V_263 , V_264 , 1 ) ;
F_44 ( V_2 , V_263 , V_265 , 0 , 0 , 0 ) ;
F_16 ( V_2 , 0 ) ;
V_260 . V_266 = V_2 -> V_184 . V_258 . V_267 ;
V_260 . V_268 = V_2 -> V_184 . V_258 . V_269 ;
memcpy ( V_260 . V_270 , V_2 -> V_184 . V_258 . V_271 , 60 ) ;
V_2 -> V_272 -> V_273 ( V_2 -> V_272 , V_274 ,
sizeof( struct V_259 ) , & V_260 ) ;
V_262 . V_268 = V_2 -> V_184 . V_258 . V_275 ;
memcpy ( V_262 . V_270 , V_2 -> V_184 . V_258 . V_276 , 60 ) ;
V_2 -> V_272 -> V_273 ( V_2 -> V_272 , V_277 ,
sizeof( struct V_261 ) , & V_262 ) ;
V_2 -> V_272 -> V_273 ( V_2 -> V_272 , V_278 ,
sizeof( int ) , & V_254 ) ;
V_2 -> V_272 -> V_279 ( V_2 -> V_272 , V_2 -> V_71 , & V_253 ,
& V_2 -> V_12 . V_78 ) ;
V_2 -> V_272 -> V_280 ( V_2 -> V_272 , V_281 ) ;
if ( V_2 -> V_249 ) {
V_2 -> V_249 -> V_273 ( V_2 -> V_249 , V_278 ,
sizeof( int ) , & V_254 ) ;
V_2 -> V_249 -> V_279 ( V_2 -> V_249 , V_2 -> V_71 , & V_253 ,
& V_2 -> V_12 . V_78 ) ;
V_2 -> V_249 -> V_280 ( V_2 -> V_249 , V_281 ) ;
}
F_34 ( V_2 ) ;
F_36 ( V_2 , V_34 ) ;
F_38 ( V_2 ) ;
...
case V_35 :
F_43 ( V_2 , V_263 , V_264 , 0 ) ;
F_33 ( V_2 , 1 ) ;
F_44 ( V_2 , V_263 , V_265 , 1 , 0 , 0 ) ;
F_16 ( V_2 , 0 ) ;
if ( V_2 -> V_249 ) {
V_2 -> V_249 -> V_279 ( V_2 -> V_249 , V_2 -> V_71 , & V_253 ,
& V_2 -> V_12 . V_78 ) ;
V_2 -> V_249 -> V_280 ( V_2 -> V_249 , V_282 ) ;
}
V_2 -> V_272 -> V_279 ( V_2 -> V_272 , V_2 -> V_71 , & V_253 ,
& V_2 -> V_12 . V_78 ) ;
V_2 -> V_272 -> V_280 ( V_2 -> V_272 , V_282 ) ;
F_34 ( V_2 ) ;
F_36 ( V_2 , V_34 ) ;
F_38 ( V_2 ) ;
F_6 ( 2 , V_14 L_27 ,
...
case V_41 :
default:
F_19 ( ~ ( V_2 -> V_12 . V_239 | V_240 ) ,
V_139 ) ;
F_3 ( V_2 -> V_12 . V_239 | V_240 ,
V_137 ) ;
F_19 ( ~ V_251 , V_187 ) ;
F_45 ( 50 ) ;
F_33 ( V_2 , 0 ) ;
...
F_46 ( struct V_1 * V_2 )
{
int V_284 , V_18 , V_285 ;
V_285 =
( V_2 -> V_184 . V_286 ==
1 ) ? V_173 : ( V_173 >> 1 ) ;
while ( ( V_2 -> V_159 - V_2 -> V_160 ) < V_285 &&
V_2 -> V_159 < V_2 -> V_158 ) {
V_284 = V_2 -> V_287 [ V_2 -> V_159 & V_288 ] ;
if ( V_2 -> V_184 . V_286 == 1 ) {
V_18 = ( V_2 -> V_159 -
V_2 -> V_166 ) & V_289 ;
if ( ! ( V_2 -> V_174 [ V_18 ] & F_35 ( 1 ) ) )
break;
V_2 -> V_174 [ V_18 ] =
F_35 ( V_2 -> V_168 . V_170 [ V_284 ] . V_290 . V_291 ) ;
} else {
V_18 = ( ( V_2 -> V_159 -
V_2 -> V_166 ) & 1 ) * 2 ;
if ( ! ( V_2 -> V_174 [ V_18 ] & F_35 ( 1 ) ) )
...
V_2 -> V_168 . V_170 [ V_284 ] . V_171 = V_292 ;
V_2 -> V_159 ++ ;
}
if ( V_2 -> V_109 == V_35 )
V_2 -> V_167 ++ ;
...
V_284 = V_2 -> V_287 [ V_2 -> V_160 & V_288 ] ;
V_170 = & V_2 -> V_168 . V_170 [ V_284 ] ;
F_49 ( & V_170 -> V_296 . V_297 ) ;
if ( V_2 -> V_109 == V_40 ) {
V_170 -> V_296 . V_298 = ( V_174 & 0x7fffff ) >> 1 ;
V_293 = ( ( V_174 >> 24 ) + V_2 -> V_165 ) & 0xff ;
V_294 = ( V_293 - V_2 -> V_162 ) & 0xff ;
V_2 -> V_162 += V_294 ;
} else {
V_170 -> V_296 . V_298 = 0 ;
}
...
! ( V_300 & V_302 ) ) {
F_17 ( V_2 ) ;
V_2 -> V_272 -> V_280 ( V_2 -> V_272 , V_34 ) ;
F_36 ( V_2 , V_2 -> V_109 ) ;
F_40 ( V_2 ) ;
if ( V_2 -> V_164 <= 8 )
F_6 ( 2 , V_14 L_29 ,
...
for ( V_18 = 0 ; V_18 < V_2 -> V_168 . V_169 ; V_18 ++ ) {
if ( F_48 ( V_2 -> V_174 [ V_20 ] ) == V_2 -> V_168 . V_170 [ V_18 ] . V_290 . V_291 )
F_11 ( V_307 L_32 , V_20 , V_18 ) ;
}
}
F_11 ( V_307 L_4 ) ;
}
if ( V_2 -> V_184 . V_286 == 1 )
V_18 = ( V_2 -> V_160 - V_2 -> V_166 ) & V_289 ;
else
...
for ( V_20 = 0 ; V_20 < V_173 ; V_20 ++ )
V_2 -> V_174 [ V_20 ] = V_308 [ ( V_18 + V_20 ) & V_289 ] ;
V_2 -> V_166 += V_18 ;
V_2 -> V_166 &= V_289 ;
}
if ( V_2 -> V_109 == V_40 )
...
V_2 -> V_315 . V_170 [ V_2 -> V_142 ] . V_171 = V_299 ;
V_2 -> V_315 . V_170 [ V_2 -> V_142 ] . V_296 . V_293 = V_2 -> V_316 ;
F_49 ( & V_2 -> V_315 . V_170 [ V_2 -> V_142 ] . V_296 . V_297 ) ;
V_2 -> V_142 = V_143 ;
V_2 -> V_147 ++ ;
}
}
...
if ( V_2 -> V_142 == V_143 &&
V_2 -> V_147 != V_2 -> V_148 ) {
int V_284 = V_2 -> V_317 [ V_2 -> V_147 & V_318 ] ;
T_1 V_5 ;
V_2 -> V_142 = V_284 ;
V_5 = V_2 -> V_315 . V_170 [ V_284 ] . V_319 . V_320 ;
F_3 ( V_5 , V_118 ) ;
...
if ( V_2 -> V_228 > V_2 -> V_219 )
V_2 -> V_219 = V_2 -> V_228 ;
if ( V_2 -> V_228 < V_2 -> V_220 )
V_2 -> V_220 = V_2 -> V_228 ;
}
if ( V_17 > 2 && V_2 -> V_234 < 6 ) {
int V_18 ;
F_11 ( V_14 L_39 ,
F_7 ( V_2 ) , V_2 -> V_162 ) ;
...
#endif
if ( ( V_303 & V_2 -> V_12 . V_239 ) ||
V_2 -> V_228 > 25 ||
V_2 -> V_163 == 1 ||
( ( V_2 -> V_109 == V_35 ) &&
( V_2 -> V_234 && ( V_2 -> V_228 > V_2 -> V_184 . V_185 ) ) ) ) {
F_51 ( V_2 , V_303 , V_304 ) ;
}
V_129 ++ ;
if ( V_129 > 10 ) {
F_6 ( 2 , V_135 L_41 ,
...
F_43 ( V_2 , V_263 , V_331 , V_2 -> V_42 ) ;
F_43 ( V_2 , V_263 , V_265 ,
V_2 -> V_12 . V_332 [ V_2 -> V_332 ] . V_333 , 0 , 0 ) ;
F_44 ( V_2 , V_330 , V_329 , 0 ) ;
F_44 ( V_2 , V_263 , V_334 , V_2 -> V_42 ) ;
F_44 ( V_2 , V_263 , V_265 , 0 , 0 , 0 ) ;
F_16 ( V_2 , 1 ) ;
F_16 ( V_2 , 0 ) ;
F_60 ( V_2 ) ;
