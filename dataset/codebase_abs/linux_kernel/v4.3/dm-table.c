...
static struct V_137 * F_86 ( struct V_6 * V_7 ,
bool V_138 )
{
...
V_140 = F_86 ( V_7 , false ) ;
if ( ! V_140 )
return 0 ;
if ( ! F_88 ( F_91 ( V_30 ) ) ) {
V_7 -> V_131 = 1 ;
return F_92 ( F_91 ( V_30 ) , NULL ) ;
}
if ( F_88 ( V_140 ) &&
F_89 ( F_91 ( V_30 ) , V_140 ) < 0 ) {
F_19 ( L_35
L_36 ,
F_20 ( V_7 -> V_30 ) ,
V_140 -> V_143 ) ;
...
{
struct V_137 * V_140 = NULL ;
if ( ! F_87 ( F_91 ( V_7 -> V_30 ) ) )
return;
V_140 = F_86 ( V_7 , true ) ;
if ( V_140 )
F_92 ( F_91 ( V_7 -> V_30 ) ,
F_87 ( V_140 ) ) ;
else if ( F_88 ( F_91 ( V_7 -> V_30 ) ) )
F_19 ( L_44 ,
F_20 ( V_7 -> V_30 ) ) ;
else
F_19 ( L_45 ,
...
static int F_107 ( struct V_21 * V_49 , struct V_40 * V_46 ,
T_1 V_50 , T_1 V_51 , void * V_52 )
{
...
static bool F_108 ( struct V_6 * V_7 , unsigned V_152 )
{
struct V_21 * V_49 ;
unsigned V_42 = 0 ;
while ( V_42 < F_54 ( V_7 ) ) {
...
return true ;
if ( V_49 -> type -> V_96 &&
V_49 -> type -> V_96 ( V_49 , F_107 , & V_152 ) )
return true ;
}
return false ;
}
static bool F_109 ( struct V_6 * V_7 )
{
struct V_21 * V_49 ;
unsigned V_42 = 0 ;
while ( V_42 < F_54 ( V_7 ) ) {
...
static int F_110 ( struct V_21 * V_49 , struct V_40 * V_46 ,
T_1 V_50 , T_1 V_51 , void * V_52 )
{
struct V_53 * V_54 = F_29 ( V_46 -> V_47 ) ;
return V_54 && F_111 ( V_54 ) ;
}
...
{
struct V_53 * V_54 = F_29 ( V_46 -> V_47 ) ;
return V_54 && ! F_115 ( V_157 , & V_54 -> V_158 ) ;
}
...
return false ;
if ( ! V_49 -> type -> V_96 ||
V_49 -> type -> V_96 ( V_49 , F_117 , NULL ) )
return false ;
}
return true ;
}
...
return true ;
if ( V_49 -> type -> V_96 &&
V_49 -> type -> V_96 ( V_49 , F_119 , NULL ) )
return true ;
}
return false ;
}
void F_122 ( struct V_6 * V_7 , struct V_53 * V_54 ,
struct V_55 * V_56 )
{
unsigned V_152 = 0 ;
V_54 -> V_56 = * V_56 ;
...
T_2 F_127 ( struct V_6 * V_7 )
{
return V_7 -> V_27 ;
}
static void F_128 ( struct V_6 * V_7 , enum V_169 V_27 )
{
int V_42 = V_7 -> V_28 ;
...
void F_133 ( struct V_6 * V_7 , struct V_178 * V_179 )
{
F_41 ( & V_179 -> V_39 , & V_7 -> V_33 ) ;
}
int F_134 ( struct V_6 * V_7 , int V_180 )
{
struct V_37 * V_38 ;
struct V_34 * V_32 = F_73 ( V_7 ) ;
struct V_178 * V_179 ;
...
struct V_29 * F_138 ( struct V_6 * V_7 )
{
return V_7 -> V_30 ;
}
...
F_142 ( V_183 -> V_185 , V_184 ) ;
F_143 ( V_183 ) ;
F_144 ( V_183 -> V_185 , V_184 ) ;
}
}
}
