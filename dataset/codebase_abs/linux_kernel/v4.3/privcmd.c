...
if ( V_68 == 2 ) {
if ( F_42 ( V_79 . V_67 , sizeof( int ) * V_79 . V_52 ) ) {
V_4 = - V_5 ;
goto V_54;
}
}
F_25 ( & V_48 -> V_55 ) ;
V_33 = F_27 ( V_48 , V_79 . V_84 ) ;
if ( ! V_33 ||
V_33 -> V_85 != & V_86 ) {
V_4 = - V_39 ;
goto V_87;
...
if ( V_33 -> V_57 == NULL ) {
if ( V_79 . V_84 != V_33 -> V_56 ||
V_79 . V_84 + ( V_80 << V_37 ) != V_33 -> V_40 ) {
V_4 = - V_39 ;
goto V_87;
}
if ( F_23 ( V_50 ) ) {
V_4 = F_35 ( V_33 , V_79 . V_52 ) ;
if ( V_4 < 0 )
goto V_87;
} else
V_33 -> V_57 = V_59 ;
...
static long F_44 ( struct V_88 * V_88 ,
unsigned int V_89 , unsigned long V_16 )
{
int V_4 = - V_51 ;
...
{
struct V_10 * * V_9 = V_33 -> V_57 ;
int V_76 = ( V_33 -> V_40 - V_33 -> V_56 ) >> V_37 ;
int V_34 ;
if ( ! F_23 ( V_50 ) || ! V_76 || ! V_9 )
return;
V_34 = F_46 ( V_33 , V_76 , V_9 ) ;
if ( V_34 == 0 )
F_47 ( V_76 , V_9 ) ;
else
F_48 ( L_2 ,
...
static int F_49 ( struct V_32 * V_33 , struct V_94 * V_95 )
{
F_50 ( V_96 L_3 ,
...
static int V_45 ( struct V_88 * V_88 , struct V_32 * V_33 )
{
V_33 -> V_100 |= V_101 | V_102 | V_103 |
V_104 | V_105 ;
V_33 -> V_85 = & V_86 ;
V_33 -> V_57 = NULL ;
return 0 ;
}
static int F_51 ( T_4 * V_106 , struct V_10 * V_107 ,
unsigned long V_84 , void * V_16 )
{
return F_52 ( * V_106 ) ? 0 : - V_108 ;
}
static int F_43 (
struct V_32 * V_33 ,
unsigned long V_84 ,
unsigned long V_80 )
{
return F_53 ( V_33 -> V_109 , V_84 , V_80 << V_37 ,
F_51 , NULL ) != 0 ;
}
