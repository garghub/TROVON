...
unsigned V_5 ;
unsigned int V_84 ;
V_56 = F_49 ( V_132 , L_5 , V_128 , & V_137 ) ;
if ( V_56 )
goto V_138;
if ( F_50 ( V_137 , L_6 ) )
V_5 = 1 ;
else if ( F_50 ( V_137 , L_7 ) )
V_5 = 0 ;
else {
F_51 ( V_130 , L_8 , V_137 ) ;
goto V_138;
}
V_56 = F_52 ( V_137 + 2 , 0 , & V_84 ) ;
if ( V_56 )
goto V_138;
V_56 = - V_139 ;
if ( V_84 > V_105 || ! V_84 )
...
V_136 -> V_23 = V_24 ;
V_136 -> V_140 = V_141 ;
V_32 = F_54 ( V_130 -> V_133 , V_137 ) ;
if ( ! V_32 ) {
F_51 ( V_130 , L_9 , V_137 ) ;
V_56 = - V_142 ;
goto V_138;
}
V_2 -> V_32 = V_32 ;
...
struct V_102 *
F_58 ( struct V_7 * V_7 , void T_3 * V_143 )
{
struct V_53 * V_6 ;
int V_56 = 0 ;
...
V_6 = F_59 ( sizeof( * V_6 ) , V_144 ) ;
if ( ! V_6 )
goto V_145;
F_60 ( & V_6 -> V_58 , V_146 , V_79 ) ;
V_6 -> V_58 . V_147 = F_15 ;
F_53 ( & V_6 -> V_62 ) ;
V_6 -> V_7 = V_7 ;
V_6 -> V_6 . V_148 = F_36 ;
