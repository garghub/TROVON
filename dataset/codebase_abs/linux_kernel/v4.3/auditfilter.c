...
static int F_111 ( struct V_18 * V_20 , int type ,
enum V_201 * V_202 )
{
int V_17 ;
...
case V_90 :
V_203 = F_112 ( V_174 ) ;
V_204 = F_97 ( V_203 , V_2 -> V_43 , V_2 -> V_59 ) ;
break;
case V_79 :
V_204 = F_99 ( F_113 () , V_2 -> V_43 , V_2 -> V_127 ) ;
break;
case V_85 :
V_204 = F_104 ( F_114 () , V_2 -> V_43 , V_2 -> V_128 ) ;
break;
case V_83 :
...
break;
case V_107 :
V_204 = F_97 ( F_115 ( V_174 ) ,
V_2 -> V_43 , V_2 -> V_59 ) ;
break;
case V_78 :
V_204 = F_97 ( type , V_2 -> V_43 , V_2 -> V_59 ) ;
break;
case V_3 :
case V_4 :
case V_5 :
...
switch ( V_20 -> V_66 ) {
case V_72 : * V_202 = V_206 ; break;
case V_67 : * V_202 = V_207 ; break;
}
return 1 ;
}
int F_118 ( int type )
{
enum V_201 V_202 = V_206 ;
struct V_15 * V_16 ;
int V_208 , V_136 ;
V_136 = 1 ;
F_119 () ;
F_120 (e, &audit_filter_list[AUDIT_FILTER_USER], list) {
V_208 = F_111 ( & V_16 -> V_20 , type , & V_202 ) ;
if ( V_208 ) {
if ( V_208 > 0 && V_202 == V_206 )
V_136 = 0 ;
break;
}
}
...
if ( F_123 ( & V_148 [ V_70 ] ) )
goto V_209;
F_120 (e, &audit_filter_list[AUDIT_FILTER_TYPE],
list) {
int V_17 ;
...
static int F_124 ( struct V_18 * V_166 )
{
...
F_127 ( & V_166 -> V_211 , & V_210 -> V_20 . V_211 ) ;
F_128 ( & V_28 -> V_47 , & V_210 -> V_47 ) ;
F_129 ( & V_166 -> V_47 , & V_210 -> V_20 . V_47 ) ;
}
F_74 ( & V_28 -> V_27 , F_6 ) ;
return V_61 ;
}
...
F_60 ( & V_152 ) ;
for ( V_17 = 0 ; V_17 < V_167 ; V_17 ++ ) {
F_131 (r, n, &audit_rules_list[i], list) {
int V_169 = F_124 ( V_166 ) ;
if ( ! V_61 )
V_61 = V_169 ;
}
}
