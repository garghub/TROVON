...
{
unsigned long V_32 = V_33 + F_23 ( 250 ) ;
T_1 V_5 ;
while ( F_24 ( V_33 , V_32 ) ) {
V_5 = F_1 ( V_2 , V_34 ) ;
if ( ( V_5 & V_35 ) == 0 &&
( V_5 & V_36 ) != 0 )
return 0 ;
...
static int F_39 ( struct V_58 * V_25 )
{
const struct V_59 * V_60 ;
struct V_1 * V_2 ;
struct V_61 * V_62 ;
int V_6 ;
V_60 = F_40 ( V_63 , V_25 -> V_20 . V_19 ) ;
if ( ! V_60 )
return - V_26 ;
V_2 = F_41 ( & V_25 -> V_20 , sizeof( * V_2 ) , V_22 ) ;
if ( ! V_2 )
return - V_23 ;
V_2 -> V_10 = V_60 -> V_46 ;
V_2 -> V_20 = & V_25 -> V_20 ;
V_62 = F_42 ( V_25 , V_64 , 0 ) ;
V_2 -> V_4 = F_43 ( & V_25 -> V_20 , V_62 ) ;
if ( F_44 ( V_2 -> V_4 ) )
return F_45 ( V_2 -> V_4 ) ;
F_46 ( & V_2 -> V_30 ) ;
V_2 -> V_7 = F_47 ( & V_25 -> V_20 , NULL ) ;
if ( F_44 ( V_2 -> V_7 ) ) {
F_17 ( & V_25 -> V_20 , L_5 ) ;
return F_45 ( V_2 -> V_7 ) ;
}
...
static int F_50 ( struct V_58 * V_25 )
{
