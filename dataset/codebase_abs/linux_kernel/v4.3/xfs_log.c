...
int error ;
F_198 ( V_37 , V_61 ) ;
error = F_199 ( V_37 , V_61 , V_294 , NULL ) ;
if ( error )
F_55 ( V_37 , L_95 , V_115 , error ) ;
}
STATIC void
...
V_360 = F_206 ( V_44 , V_359 ) ;
V_44 += sizeof( V_272 ) * V_360 ;
while ( ! V_360 ||
F_206 ( V_44 , V_359 ) > V_360 ) {
V_44 += sizeof( V_272 ) ;
V_360 ++ ;
}
...
struct V_15 * V_16 ;
int V_363 ;
V_16 = F_207 ( V_358 , V_362 ) ;
if ( ! V_16 )
return NULL ;
V_363 = F_205 ( log -> V_152 , V_44 ) ;
F_129 ( & V_16 -> V_357 , 1 ) ;
V_16 -> V_17 = V_364 ;
F_9 ( & V_16 -> V_365 ) ;
V_16 -> V_21 = V_363 ;
...
{
int V_370 ;
if ( F_210 ( V_143 ) == log -> V_347 ) {
V_370 =
log -> V_189 - ( log -> V_190 - F_156 ( V_143 ) ) ;
if ( V_370 < F_124 ( V_59 -> V_97 ) + F_124 ( log -> V_171 ) )
F_209 ( log -> V_152 , L_99 , V_115 ) ;
} else {
ASSERT ( F_210 ( V_143 ) + 1 == log -> V_347 ) ;
if ( F_156 ( V_143 ) == log -> V_190 )
F_209 ( log -> V_152 , L_100 , V_115 ) ;
