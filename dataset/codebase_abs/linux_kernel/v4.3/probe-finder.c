...
return F_47 ( V_85 -> V_29 , V_85 -> V_86 ) ;
if ( V_85 -> V_86 -> V_80 )
V_85 -> V_29 -> V_80 = F_27 ( V_85 -> V_86 -> V_80 ) ;
else {
V_36 = F_48 ( V_85 -> V_86 , V_12 , 32 ) ;
if ( V_36 < 0 )
return V_36 ;
V_89 = strchr ( V_12 , ':' ) ;
if ( V_89 )
...
if ( ! F_49 ( V_88 , V_85 -> V_86 -> V_87 , V_85 -> V_25 , & V_24 ) ) {
if ( ! F_49 ( & V_85 -> V_90 , V_85 -> V_86 -> V_87 ,
0 , & V_24 ) ) {
F_26 ( L_41 ,
V_85 -> V_86 -> V_87 ) ;
V_36 = - V_10 ;
...
static int F_50 ( T_1 * V_27 , T_7 * V_8 ,
T_2 V_91 , bool V_92 ,
struct V_93 * V_94 )
{
T_2 V_95 , V_96 ;
...
static int F_52 ( T_1 * V_88 , struct V_84 * V_85 )
{
T_4 V_101 ;
T_5 V_33 ;
int V_36 ;
...
if ( F_55 ( & V_85 -> V_90 , V_85 -> V_25 , & V_85 -> V_27 ) ) {
F_26 ( L_49 ,
F_24 ( & V_85 -> V_27 ) ) ;
return 0 ;
} else {
...
V_85 -> V_104 != NULL ) {
T_9 * V_105 ;
if ( F_57 ( V_85 -> V_104 , V_85 -> V_25 , & V_105 ) != 0 ||
F_58 ( V_105 , & V_85 -> V_26 , & V_33 ) != 0 ) {
F_26 ( L_52 ,
( V_106 ) V_85 -> V_25 ) ;
return - V_10 ;
}
...
static int F_59 ( T_1 * V_108 , void * V_109 )
{
...
static T_1 * F_63 ( struct V_84 * V_85 , T_1 * V_78 )
{
struct V_110 V_111 = {
...
F_64 ( & V_85 -> V_90 , V_85 -> V_25 , F_59 , & V_111 ) ;
return V_111 . V_47 ? V_78 : NULL ;
}
static int F_65 ( const char * V_118 , int V_120 ,
T_2 V_25 , void * V_109 )
{
struct V_84 * V_85 = V_109 ;
T_1 * V_88 , V_78 ;
int V_36 ;
if ( V_120 != V_85 -> V_113 || F_66 ( V_118 , V_85 -> V_118 ) != 0 )
return 0 ;
V_85 -> V_25 = V_25 ;
V_88 = F_63 ( V_85 , & V_78 ) ;
if ( ! V_88 ) {
...
{
return F_68 ( & V_85 -> V_90 , F_65 , V_85 ) ;
}
...
while ( ( V_126 = F_70 ( & line , & V_125 , V_124 ) ) > 0 ) {
if ( line [ V_126 - 1 ] == '\n' )
line [ V_126 - 1 ] = '\0' ;
if ( F_71 ( line , V_123 ) ) {
F_72 ( V_122 , V_128 ) ;
...
static int F_73 ( const char * V_118 , int V_120 ,
T_2 V_25 , void * V_109 )
{
struct V_84 * V_85 = V_109 ;
T_1 * V_88 , V_78 ;
int V_36 ;
if ( ! F_74 ( V_85 -> V_130 , V_120 ) ||
F_66 ( V_118 , V_85 -> V_118 ) != 0 )
return 0 ;
F_11 ( L_57 ,
...
static int F_75 ( T_1 * V_27 , struct V_84 * V_85 )
{
int V_36 = 0 ;
char * V_131 ;
if ( F_76 ( V_85 -> V_130 ) ) {
const char * V_132 ;
V_132 = F_77 ( & V_85 -> V_90 ) ;
V_36 = F_78 ( V_85 -> V_118 , V_132 , & V_131 ) ;
if ( V_36 < 0 ) {
F_26 ( L_58 ) ;
return V_36 ;
}
V_36 = F_69 ( V_85 -> V_130 , V_131 ,
V_85 -> V_116 -> V_117 . V_133 ) ;
free ( V_131 ) ;
if ( V_36 <= 0 )
return V_36 ;
}
return F_68 ( V_27 , F_73 , V_85 ) ;
}
static int F_79 ( T_1 * V_134 , void * V_109 )
{
struct V_84 * V_85 = V_109 ;
...
F_11 ( L_60 ,
( V_106 ) V_85 -> V_25 ) ;
V_36 = F_52 ( V_134 , V_85 ) ;
}
return V_36 ;
}
static int F_80 ( T_1 * V_27 , void * V_109 )
{
struct V_137 * V_138 = V_109 ;
struct V_84 * V_85 = V_138 -> V_109 ;
struct V_135 * V_136 = & V_85 -> V_116 -> V_117 ;
if ( ! F_53 ( V_27 ) ||
! F_61 ( V_27 , V_136 -> V_114 ) )
return V_139 ;
if ( V_136 -> V_112 && F_66 ( V_136 -> V_112 , F_60 ( V_27 ) ) )
return V_139 ;
F_11 ( L_61 , F_24 ( V_27 ) ) ;
V_85 -> V_118 = F_60 ( V_27 ) ;
if ( V_136 -> line ) {
F_62 ( V_27 , & V_85 -> V_113 ) ;
V_85 -> V_113 += V_136 -> line ;
V_138 -> V_140 = F_67 ( V_85 ) ;
} else if ( F_81 ( V_27 ) ) {
F_21 ( V_27 , & V_85 -> V_25 ) ;
if ( V_136 -> V_133 )
V_138 -> V_140 = F_75 ( V_27 , V_85 ) ;
else {
V_85 -> V_25 += V_136 -> V_23 ;
V_138 -> V_140 = F_52 ( V_27 , V_85 ) ;
}
} else if ( ! V_42 . V_141 ) {
V_138 -> V_140 = F_82 ( V_27 ,
F_79 , ( void * ) V_85 ) ;
if ( V_138 -> V_140 == - V_10 && F_83 ( V_136 -> V_114 ) )
V_138 -> V_140 = 0 ;
}
if ( F_83 ( V_136 -> V_114 ) && V_138 -> V_140 >= 0 ) {
V_138 -> V_140 = 0 ;
return V_139 ;
}
return V_142 ;
...
. V_140 = 0 } ;
F_85 ( & V_85 -> V_90 , F_80 , & V_143 , 0 ) ;
return V_143 . V_140 ;
}
static int F_86 ( T_12 * V_2 , T_13 * V_144 , void * V_109 )
{
struct V_145 * V_138 = V_109 ;
if ( F_87 ( V_2 , V_144 -> V_146 , V_138 -> V_27 ) ) {
if ( F_22 ( V_138 -> V_27 ) != V_147 )
return V_139 ;
if ( F_61 ( V_138 -> V_27 , V_138 -> V_114 ) ) {
if ( ! F_87 ( V_2 , V_144 -> V_148 , V_138 -> V_90 ) )
return V_139 ;
if ( V_138 -> V_112 &&
F_66 ( V_138 -> V_112 , F_60 ( V_138 -> V_27 ) ) )
return V_139 ;
V_138 -> V_47 = 1 ;
return V_142 ;
}
...
if ( V_153 == NULL )
return - V_41 ;
if ( F_90 ( V_153 , & V_154 ) == NULL )
return - V_41 ;
if ( F_91 ( V_153 , & V_154 , & V_155 , L_62 , NULL ) &&
V_155 . V_156 == V_157 ) {
V_85 -> V_104 = F_92 ( V_153 ) ;
} else {
V_85 -> V_104 = F_93 ( V_2 -> V_2 ) ;
}
#endif
V_149 = 0 ;
V_85 -> V_130 = F_94 ( NULL ) ;
if ( ! V_85 -> V_130 )
return - V_51 ;
if ( V_136 -> V_114 && ! F_83 ( V_136 -> V_114 ) ) {
struct V_145 V_158 = {
. V_114 = V_136 -> V_114 ,
. V_112 = V_136 -> V_112 ,
. V_90 = & V_85 -> V_90 ,
...
& V_158 , 0 ) ;
if ( V_158 . V_47 ) {
V_36 = F_80 ( & V_85 -> V_27 , & V_159 ) ;
if ( V_36 )
goto V_47;
}
}
while ( ! F_96 ( V_2 -> V_2 , V_149 , & V_150 , & V_151 , NULL , NULL , NULL ) ) {
V_152 = F_87 ( V_2 -> V_2 , V_149 + V_151 , & V_85 -> V_90 ) ;
if ( ! V_152 )
continue;
if ( V_136 -> V_112 )
V_85 -> V_118 = F_97 ( & V_85 -> V_90 , V_136 -> V_112 ) ;
else
V_85 -> V_118 = NULL ;
...
static int F_99 ( T_1 * V_78 , void * V_109 )
{
...
if ( F_100 ( V_78 , V_161 -> V_85 -> V_25 ) )
return V_165 ;
else
return V_166 ;
}
static int F_101 ( T_1 * V_88 , struct V_84 * V_85 ,
struct V_167 * args )
{
T_1 V_78 ;
int V_168 ;
...
V_36 = F_50 ( & V_85 -> V_27 , V_175 -> V_8 , V_85 -> V_25 ,
...
static int F_106 ( T_1 * V_78 , void * V_109 )
{
...
V_37 = F_109 ( V_78 , & V_12 ) ;
if ( ! V_37 && V_42 . V_43 &&
! V_191 ) {
F_108 ( & V_12 , L_71 ) ;
V_37 = F_110 ( & V_186 -> V_85 . V_27 ,
V_78 , & V_12 ) ;
}
F_11 ( L_72 , V_12 . V_12 ) ;
if ( V_37 == 0 ) {
...
if ( V_186 -> V_192 && F_100 ( V_78 , V_186 -> V_85 . V_25 ) )
return V_165 ;
else
return V_166 ;
}
static int F_114 ( T_1 * V_88 , struct V_84 * V_85 )
{
struct V_185 * V_186 =
F_104 ( V_85 , struct V_185 , V_85 ) ;
struct V_187 * V_188 ;
T_1 V_78 ;
int V_36 ;
...
V_36 = F_50 ( & V_85 -> V_27 , V_186 -> V_8 , V_85 -> V_25 ,
V_85 -> V_116 -> V_117 . V_92 , & V_188 -> V_117 ) ;
if ( V_36 < 0 )
return V_36 ;
F_11 ( L_67 , V_188 -> V_117 . V_98 ,
V_188 -> V_117 . V_23 ) ;
V_188 -> V_162 = F_115 ( NULL , NULL ) ;
if ( V_188 -> V_162 == NULL )
return - V_51 ;
V_186 -> V_192 = true ;
F_102 ( V_88 , F_106 , ( void * ) V_186 , & V_78 ) ;
if ( ! V_42 . V_195 )
goto V_17;
V_186 -> V_192 = false ;
F_102 ( & V_85 -> V_90 , F_106 , ( void * ) V_186 , & V_78 ) ;
V_17:
if ( F_116 ( V_188 -> V_162 ) ) {
F_117 ( V_188 -> V_162 ) ;
V_188 -> V_162 = NULL ;
}
return V_36 ;
...
V_186 . V_189 = * V_189 ;
V_186 . V_190 = 0 ;
V_36 = F_88 ( V_2 , & V_186 . V_85 ) ;
if ( V_36 < 0 ) {
while ( V_186 . V_190 -- ) {
F_10 ( & V_186 . V_189 [ V_186 . V_190 ] . V_117 . V_98 ) ;
F_117 ( V_186 . V_189 [ V_186 . V_190 ] . V_162 ) ;
}
F_10 ( V_189 ) ;
return V_36 ;
}
...
int F_119 ( struct V_1 * V_2 , unsigned long V_25 ,
struct V_135 * V_196 )
{
...
if ( ! F_120 ( V_2 -> V_2 , ( T_2 ) V_25 , & V_197 ) ) {
F_26 ( L_73 ,
V_25 ) ;
V_36 = - V_41 ;
goto V_182;
}
F_121 ( & V_197 , V_25 , & V_118 , & V_120 ) ;
if ( F_54 ( & V_197 , ( T_2 ) V_25 , & V_198 ) ) {
...
static int F_125 ( const char * V_206 , unsigned int V_120 ,
struct V_207 * V_208 )
{
if ( ! V_208 -> V_3 ) {
...
return F_72 ( V_208 -> V_209 , V_120 ) ;
}
static int F_126 ( const char * V_118 , int V_120 ,
T_2 V_25 V_210 ,
void * V_109 )
{
struct V_211 * V_212 = V_109 ;
int V_213 ;
if ( ( F_66 ( V_118 , V_212 -> V_118 ) != 0 ) ||
( V_212 -> V_214 > V_120 || V_212 -> V_215 < V_120 ) )
return 0 ;
V_213 = F_125 ( V_118 , V_120 , V_212 -> V_208 ) ;
if ( V_213 < 0 && V_213 != - V_216 )
return V_213 ;
return 0 ;
}
static int F_127 ( T_1 * V_27 , struct V_211 * V_212 )
{
int V_36 ;
V_36 = F_68 ( V_27 ? : & V_212 -> V_90 , F_126 , V_212 ) ;
if ( V_36 >= 0 )
if ( ! F_76 ( V_212 -> V_208 -> V_209 ) )
V_36 = V_212 -> V_47 = 1 ;
else
V_36 = 0 ;
else {
...
static int F_128 ( T_1 * V_134 , void * V_109 )
{
int V_36 = F_127 ( V_134 , V_109 ) ;
return V_36 < 0 ? V_36 : 0 ;
}
static int F_129 ( T_1 * V_27 , void * V_109 )
{
struct V_137 * V_138 = V_109 ;
struct V_211 * V_212 = V_138 -> V_109 ;
struct V_207 * V_208 = V_212 -> V_208 ;
if ( V_208 -> V_112 && F_66 ( V_208 -> V_112 , F_60 ( V_27 ) ) )
return V_139 ;
if ( F_53 ( V_27 ) &&
F_61 ( V_27 , V_208 -> V_114 ) ) {
V_212 -> V_118 = F_60 ( V_27 ) ;
F_62 ( V_27 , & V_208 -> V_23 ) ;
...
F_85 ( & V_212 -> V_90 , F_129 , & V_138 , 0 ) ;
return V_138 . V_140 ;
}
int F_131 ( struct V_1 * V_2 , struct V_207 * V_208 )
{
...
& V_158 , 0 ) ;
if ( V_158 . V_47 ) {
F_129 ( & V_212 . V_27 , & V_218 ) ;
if ( V_212 . V_47 )
goto V_47;
}
}
while ( ! V_212 . V_47 && V_36 >= 0 ) {
if ( F_96 ( V_2 -> V_2 , V_149 , & V_150 , & V_151 ,
NULL , NULL , NULL ) != 0 )
break;
V_152 = F_87 ( V_2 -> V_2 , V_149 + V_151 , & V_212 . V_90 ) ;
if ( ! V_152 )
continue;
if ( V_208 -> V_112 )
V_212 . V_118 = F_97 ( & V_212 . V_90 , V_208 -> V_112 ) ;
else
V_212 . V_118 = 0 ;
...
int F_78 ( const char * V_219 , const char * V_132 ,
char * * V_220 )
{
