...
int V_79 ;
int V_60 ;
V_2 = F_33 ( & V_64 -> V_68 , sizeof( * V_2 ) , V_80 ) ;
if ( ! V_2 )
return - V_81 ;
V_5 = F_24 ( V_64 -> V_68 . V_69 , L_11 ) ;
if ( F_25 ( V_5 ) ) {
V_60 = F_26 ( V_5 ) ;
F_19 ( & V_64 -> V_68 , L_12 , V_60 ) ;
return V_60 ;
}
V_2 -> V_6 = V_5 ;
V_2 -> V_36 = V_77 -> V_2 ;
if ( V_2 -> V_36 -> V_37 == V_82 ) {
F_2 ( V_5 , V_83 + V_11 , V_84 |
V_85 | V_86 ) ;
F_2 ( V_5 , V_10 + V_13 ,
V_87 ) ;
}
...
if ( V_2 -> V_43 < 0 )
return V_2 -> V_43 ;
V_60 = F_35 ( & V_64 -> V_68 , V_2 -> V_43 ,
F_28 , F_30 ,
0 , L_13 , V_2 ) ;
if ( V_60 < 0 ) {
F_19 ( & V_64 -> V_68 , L_14 , V_60 ) ;
return V_60 ;
}
F_36 ( V_64 , V_2 ) ;
V_60 = F_22 ( V_64 ) ;
...
F_2 ( V_5 , V_17 + V_11 , V_30 ) ;
F_2 ( V_5 , V_17 + V_11 , V_31 ) ;
F_2 ( V_5 , V_88 + V_11 , V_89 ) ;
F_2 ( V_5 , V_90 + V_13 , V_91 ) ;
F_2 ( V_5 , V_17 + V_13 , V_30 ) ;
V_2 -> V_59 = F_37 ( V_92 ) ;
if ( F_25 ( V_2 -> V_59 ) ) {
V_60 = F_26 ( V_2 -> V_59 ) ;
...
static int F_47 ( struct V_32 * V_68 )
{
struct V_1 * V_2 = F_48 ( V_68 ) ;
struct V_4 * V_5 = V_2 -> V_6 ;
F_2 ( V_5 , V_17 + V_11 , V_31 ) ;
F_2 ( V_5 , V_17 + V_13 , V_30 ) ;
V_2 -> V_27 = V_97 ;
...
static int F_49 ( struct V_32 * V_68 )
{
struct V_1 * V_2 = F_48 ( V_68 ) ;
struct V_4 * V_5 = V_2 -> V_6 ;
F_40 ( V_2 -> V_94 ) ;
