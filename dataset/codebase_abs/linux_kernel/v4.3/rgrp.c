...
void F_100 ( struct V_159 * V_190 )
{
struct V_69 * V_22 = V_190 -> V_191 -> V_118 ;
int V_194 = F_101 ( V_195 , & V_190 -> V_191 -> V_196 ) |
F_101 ( V_197 , & V_190 -> V_191 -> V_196 ) ;
if ( V_22 && V_194 )
F_99 ( V_22 ) ;
}
int F_102 ( struct V_74 * V_75 , T_2 V_14 ,
struct V_198 * V_199 ,
...
if ( V_205 >= V_200 ) {
V_206 = F_103 ( V_203 , V_66 , V_205 , V_100 , 0 ) ;
if ( V_206 )
goto V_141;
V_207 += V_205 ;
}
...
V_141:
if ( V_75 -> V_188 . V_212 )
F_104 ( V_75 , L_14 , V_206 ) ;
V_75 -> V_188 . V_212 = 0 ;
return - V_124 ;
}
int F_105 ( struct V_213 * V_214 , void T_8 * V_215 )
{
struct V_126 * V_126 = F_106 ( V_214 ) ;
struct V_74 * V_75 = F_36 ( V_126 ) ;
struct V_216 * V_217 = F_107 ( V_75 -> V_204 -> V_218 ) ;
struct V_198 * V_199 ;
struct V_69 * V_22 ;
struct V_69 * V_219 ;
struct V_159 V_190 ;
...
T_2 V_66 , V_7 , V_200 ;
unsigned int V_77 ;
unsigned V_224 = V_75 -> V_122 . V_225 ;
if ( ! F_108 ( V_226 ) )
return - V_227 ;
if ( ! F_109 ( V_217 ) )
return - V_228 ;
if ( F_110 ( & V_221 , V_215 , sizeof( V_221 ) ) )
return - V_229 ;
V_222 = F_77 ( V_75 ) ;
if ( V_222 )
return V_222 ;
...
V_200 = F_111 ( T_2 , V_221 . V_200 ,
V_217 -> V_230 . V_231 ) >> V_224 ;
if ( V_7 <= V_66 || V_200 > V_75 -> V_152 )
return - V_48 ;
V_22 = F_27 ( V_75 , V_66 , 0 ) ;
V_219 = F_27 ( V_75 , V_7 , 0 ) ;
if ( ( F_31 ( V_75 ) == F_33 ( V_219 ) )
&& ( V_66 > V_219 -> V_46 + V_219 -> V_49 ) )
return - V_48 ;
while ( 1 ) {
V_222 = F_79 ( V_22 -> V_116 , V_232 , 0 , & V_190 ) ;
if ( V_222 )
goto V_67;
if ( ! ( V_22 -> V_149 & V_233 ) ) {
for ( V_77 = 0 ; V_77 < V_22 -> V_57 ; V_77 ++ ) {
...
V_222 = F_112 ( V_75 , V_234 , 0 ) ;
if ( V_222 == 0 ) {
V_199 = V_22 -> V_78 [ 0 ] . V_17 ;
V_22 -> V_149 |= V_233 ;
F_113 ( V_22 -> V_116 , V_199 ) ;
F_82 ( V_22 , V_199 -> V_18 ) ;
F_86 ( V_22 -> V_145 , V_199 -> V_18 ) ;
F_114 ( V_75 ) ;
}
}
F_80 ( & V_190 ) ;
...
if ( F_115 ( V_215 , & V_221 , sizeof( V_221 ) ) )
return - V_229 ;
return V_222 ;
}
...
V_133 = * V_132 ;
V_235 = F_11 ( V_236 , V_36 -> V_39 , V_86 ) ;
if ( V_235 > 0 )
V_132 = & ( ( * V_132 ) -> V_91 ) ;
else if ( V_235 < 0 )
V_132 = & ( ( * V_132 ) -> V_90 ) ;
...
static void F_117 ( struct V_69 * V_22 , struct V_92 * V_93 ,
...
struct V_35 * V_36 = V_93 -> V_98 ;
T_4 V_240 ;
T_4 V_241 = V_22 -> V_187 - V_22 -> V_108 ;
int V_222 ;
struct V_126 * V_126 = & V_93 -> V_94 ;
if ( F_118 ( V_126 -> V_242 ) )
V_240 = 1 ;
else {
V_240 = F_111 ( T_4 , F_53 ( & V_36 -> V_243 ) , V_239 -> V_244 ) ;
V_240 = F_119 ( V_240 , V_245 , V_241 ) ;
}
if ( ( V_22 -> V_187 < V_22 -> V_108 ) || ( V_241 < V_240 ) )
return;
...
return;
V_222 = F_120 ( & V_2 , V_61 , & V_240 , V_93 , true , V_239 ) ;
if ( V_222 == 0 ) {
V_36 -> V_38 = V_2 ;
V_36 -> V_39 = V_240 ;
...
static T_2 F_121 ( struct V_69 * V_22 , T_2 V_44 ,
T_4 V_76 ,
...
V_250 = F_121 ( V_2 -> V_22 , V_44 , V_240 , V_93 ) ;
if ( V_250 == V_44 ) {
...
static int F_120 ( struct V_1 * V_2 , T_1 V_30 , T_4 * V_247 ,
const struct V_92 * V_93 , bool V_251 ,
const struct V_238 * V_239 )
{
struct V_198 * V_199 ;
int V_252 ;
...
return - V_261 ;
if ( ( V_255 == 0 ) && ( V_254 == 0 ) &&
( * V_247 < V_2 -> V_22 -> V_109 ) )
V_2 -> V_22 -> V_109 = * V_247 ;
if ( V_249 . V_34 ) {
* V_2 = V_249 . V_2 ;
* V_247 = V_249 . V_34 ;
return 0 ;
...
static void F_124 ( struct V_69 * V_22 , T_2 * V_262 , T_2 V_263 )
{
T_2 V_44 ;
struct V_74 * V_75 = V_22 -> V_55 ;
struct V_114 * V_115 ;
...
while ( 1 ) {
F_40 ( & V_75 -> V_265 ) ;
error = F_120 ( & V_2 , V_182 , NULL , NULL ,
true , NULL ) ;
F_43 ( & V_75 -> V_265 ) ;
if ( error == - V_261 )
break;
...
continue;
* V_262 = V_44 ;
error = F_74 ( V_75 , V_44 , & V_267 , V_143 , & V_115 ) ;
if ( error )
continue;
V_93 = V_115 -> V_118 ;
if ( V_93 || F_125 ( V_268 , & V_115 -> V_269 ) == 0 )
F_58 ( V_115 ) ;
else
V_264 ++ ;
if ( V_264 > V_270 )
...
static bool F_126 ( const struct V_69 * V_22 , int V_271 )
{
const struct V_114 * V_115 = V_22 -> V_116 ;
const struct V_74 * V_75 = V_115 -> V_272 . V_273 ;
struct V_274 * V_275 ;
T_2 V_276 , V_277 ;
T_2 V_278 , V_279 = 0 ;
T_9 V_280 ;
...
F_127 () ;
F_128 (cpu) {
V_275 = & F_129 ( V_75 -> V_285 , V_283 ) -> V_286 [ V_287 ] ;
if ( V_275 -> V_288 [ V_289 ] ) {
V_279 += V_275 -> V_288 [ V_289 ] ;
V_284 ++ ;
}
}
V_275 = & F_130 ( V_75 -> V_285 ) -> V_286 [ V_287 ] ;
if ( V_284 )
F_131 ( V_279 , V_284 ) ;
V_276 = V_275 -> V_288 [ V_290 ] ;
V_282 = V_275 -> V_288 [ V_291 ] +
V_115 -> V_292 . V_288 [ V_291 ] ;
F_132 () ;
V_278 = V_115 -> V_292 . V_288 [ V_289 ] ;
V_277 = V_115 -> V_292 . V_288 [ V_290 ] ;
...
static bool F_133 ( const struct V_35 * V_36 ,
T_2 V_293 )
{
T_2 V_294 ;
V_294 = F_134 ( F_135 ( F_136 () ,
V_36 -> V_38 . V_22 -> V_116 -> V_295 ) ) ;
return V_294 > ( V_293 * 1000 * 1000 ) ;
}
static T_4 F_137 ( const struct V_92 * V_93 )
{
const struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
T_4 V_263 ;
F_138 ( & V_263 , sizeof( V_263 ) ) ;
return V_263 % V_75 -> V_135 ;
}
static bool F_139 ( struct V_69 * * V_130 , const struct V_69 * V_296 )
{
...
static inline int F_140 ( struct V_69 * V_22 )
{
struct V_114 * V_115 = V_22 -> V_116 ;
if ( V_115 -> V_297 != V_298 && F_141 ( & V_115 -> V_299 ) &&
! F_101 ( V_300 , & V_115 -> V_196 ) &&
! F_101 ( V_195 , & V_115 -> V_196 ) )
return 1 ;
if ( V_22 -> V_149 & V_151 )
return 1 ;
return 0 ;
}
int F_142 ( struct V_92 * V_93 , struct V_238 * V_239 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
...
if ( V_75 -> V_188 . V_189 )
V_302 |= V_193 ;
if ( F_96 ( V_75 , V_239 -> V_244 ) )
return - V_48 ;
if ( F_47 ( V_36 ) ) {
V_296 = V_36 -> V_38 . V_22 ;
} else if ( V_93 -> V_303 && F_26 ( V_93 -> V_303 , V_93 -> V_95 ) ) {
V_36 -> V_38 . V_22 = V_296 = V_93 -> V_303 ;
} else {
F_35 ( V_93 ) ;
V_36 -> V_38 . V_22 = V_296 = F_27 ( V_75 , V_93 -> V_95 , 1 ) ;
}
if ( F_118 ( V_93 -> V_94 . V_242 ) && ( V_239 -> V_304 & V_305 ) )
V_263 = F_137 ( V_93 ) ;
...
if ( ! F_47 ( V_36 ) ) {
if ( V_271 == 0 &&
! F_140 ( V_36 -> V_38 . V_22 ) )
goto V_307;
if ( ( V_271 < 2 ) &&
F_133 ( V_36 , 1000 ) &&
F_126 ( V_36 -> V_38 . V_22 , V_271 ) )
goto V_307;
}
...
if ( ( V_36 -> V_38 . V_22 -> V_149 & ( V_310 |
V_311 ) ) ||
( V_271 == 0 && V_239 -> V_244 > V_36 -> V_38 . V_22 -> V_109 ) )
goto V_309;
if ( V_75 -> V_188 . V_189 )
F_91 ( V_36 -> V_38 . V_22 ) ;
if ( ! F_47 ( V_36 ) )
F_117 ( V_36 -> V_38 . V_22 , V_93 , V_239 ) ;
if ( ! F_47 ( V_36 ) && ( V_271 < 1 ) )
goto V_312;
if ( V_36 -> V_38 . V_22 -> V_187 >= V_239 -> V_244 ||
( V_271 == 2 && V_239 -> V_313 &&
V_36 -> V_38 . V_22 -> V_187 >= V_239 -> V_313 ) ) {
V_93 -> V_303 = V_36 -> V_38 . V_22 ;
V_239 -> V_314 = V_93 -> V_303 -> V_187 ;
return 0 ;
}
V_312:
if ( V_36 -> V_38 . V_22 -> V_149 & V_186 )
F_124 ( V_36 -> V_38 . V_22 , & V_262 ,
V_93 -> V_96 ) ;
V_309:
if ( F_47 ( V_36 ) )
F_51 ( V_36 ) ;
...
if ( V_271 == 2 )
F_143 ( V_75 , NULL , V_315 ) ;
}
return - V_261 ;
}
void F_144 ( struct V_92 * V_93 )
{
struct V_35 * V_36 = V_93 -> V_98 ;
if ( V_36 -> V_308 . V_191 )
F_80 ( & V_36 -> V_308 ) ;
}
static unsigned char F_145 ( struct V_69 * V_22 , T_2 V_44 )
{
struct V_1 V_2 = { . V_22 = V_22 , } ;
int V_222 ;
V_222 = F_16 ( & V_2 , V_44 ) ;
...
static void F_146 ( const struct V_1 * V_2 , bool V_316 ,
unsigned int * V_59 )
{
...
* V_59 = 1 ;
V_44 = F_12 ( V_2 ) ;
F_113 ( V_2 -> V_22 -> V_116 , F_2 ( V_2 ) -> V_17 ) ;
F_1 ( V_2 , true , V_316 ? V_318 : V_319 ) ;
V_44 ++ ;
while ( * V_59 < V_317 ) {
V_222 = F_16 ( & V_130 , V_44 ) ;
if ( V_222 || F_8 ( & V_130 ) != V_61 )
break;
F_113 ( V_130 . V_22 -> V_116 , F_2 ( & V_130 ) -> V_17 ) ;
F_1 ( & V_130 , true , V_319 ) ;
( * V_59 ) ++ ;
V_44 ++ ;
}
}
static struct V_69 * F_147 ( struct V_74 * V_75 , T_2 V_320 ,
T_4 V_321 , unsigned char V_4 )
{
struct V_1 V_2 ;
struct V_9 * V_10 , * V_322 = NULL ;
V_2 . V_22 = F_27 ( V_75 , V_320 , 1 ) ;
if ( ! V_2 . V_22 ) {
if ( F_148 ( V_75 ) )
...
if ( V_10 != V_322 ) {
if ( ! V_10 -> V_25 ) {
V_10 -> V_25 = F_149 ( V_10 -> V_17 -> V_68 ,
V_100 | V_323 ) ;
memcpy ( V_10 -> V_25 + V_10 -> V_19 ,
V_10 -> V_17 -> V_18 + V_10 -> V_19 ,
V_10 -> V_12 ) ;
}
F_113 ( V_2 . V_22 -> V_116 , V_10 -> V_17 ) ;
V_322 = V_10 ;
}
F_1 ( & V_2 , false , V_4 ) ;
F_18 ( & V_2 ) ;
...
void F_150 ( struct V_103 * V_104 , const struct V_114 * V_115 )
{
...
F_28 ( & V_22 -> V_112 ) ;
for ( V_59 = F_32 ( & V_22 -> V_107 ) ; V_59 ; V_59 = F_34 ( & V_324 -> V_102 ) ) {
V_324 = F_29 ( V_59 , struct V_35 , V_102 ) ;
F_44 ( V_104 , V_324 ) ;
}
F_30 ( & V_22 -> V_112 ) ;
}
static void F_151 ( struct V_69 * V_22 )
{
struct V_74 * V_75 = V_22 -> V_55 ;
F_104 ( V_75 , L_17 ,
( unsigned long long ) V_22 -> V_23 ) ;
F_104 ( V_75 , L_18 ) ;
F_150 ( NULL , V_22 -> V_116 ) ;
V_22 -> V_149 |= V_311 ;
}
static void F_152 ( struct V_92 * V_93 ,
...
F_28 ( & V_22 -> V_112 ) ;
if ( F_47 ( V_36 ) ) {
if ( F_153 ( & V_36 -> V_38 , V_2 ) ) {
V_44 = F_12 ( V_2 ) ;
V_222 = F_16 ( & V_36 -> V_38 , V_44 + V_34 ) ;
V_325 = F_154 ( V_36 -> V_39 , V_34 ) ;
V_36 -> V_39 -= V_325 ;
V_22 -> V_108 -= V_325 ;
F_48 ( V_36 , V_326 ) ;
if ( V_36 -> V_39 && ! V_222 )
goto V_67;
F_155 ( V_327 , & V_36 -> V_243 ) ;
}
F_46 ( V_36 ) ;
}
V_67:
...
const struct V_92 * V_93 , bool V_316 )
{
T_2 V_41 ;
if ( F_47 ( V_93 -> V_98 ) ) {
* V_2 = V_93 -> V_98 -> V_38 ;
...
if ( ! V_316 && F_26 ( V_2 -> V_22 , V_93 -> V_95 ) )
V_41 = V_93 -> V_95 ;
else
V_41 = V_2 -> V_22 -> V_246 + V_2 -> V_22 -> V_46 ;
F_16 ( V_2 , V_41 ) ;
}
int F_157 ( struct V_92 * V_93 , T_2 * V_328 , unsigned int * V_329 ,
bool V_316 , T_2 * V_330 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_198 * V_331 ;
struct V_1 V_2 = { . V_22 = V_93 -> V_303 , } ;
unsigned int V_332 ;
T_2 V_44 ;
int error ;
F_156 ( & V_2 , V_93 , V_316 ) ;
error = F_120 ( & V_2 , V_61 , NULL , V_93 , false , NULL ) ;
if ( error == - V_261 ) {
F_156 ( & V_2 , V_93 , V_316 ) ;
error = F_120 ( & V_2 , V_61 , NULL , NULL , false ,
NULL ) ;
}
if ( error ) {
F_104 ( V_75 , L_19 ,
( unsigned long long ) V_93 -> V_96 , error , * V_329 ,
F_101 ( V_110 , & V_2 . V_22 -> V_78 -> V_111 ) ,
V_2 . V_22 -> V_109 ) ;
goto V_333;
}
F_146 ( & V_2 , V_316 , V_329 ) ;
V_44 = F_12 ( & V_2 ) ;
V_2 . V_22 -> V_246 = V_44 - V_2 . V_22 -> V_46 ;
if ( F_47 ( V_93 -> V_98 ) )
F_152 ( V_93 , & V_2 , * V_329 ) ;
V_332 = * V_329 ;
if ( V_316 )
V_332 -- ;
if ( ! V_316 ) {
V_93 -> V_95 = V_44 + V_332 - 1 ;
error = F_158 ( V_93 , & V_331 ) ;
if ( error == 0 ) {
struct V_334 * V_335 =
(struct V_334 * ) V_331 -> V_18 ;
F_113 ( V_93 -> V_158 , V_331 ) ;
...
F_113 ( V_2 . V_22 -> V_116 , V_2 . V_22 -> V_78 [ 0 ] . V_17 ) ;
F_82 ( V_2 . V_22 , V_2 . V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_86 ( V_2 . V_22 -> V_145 , V_2 . V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_159 ( V_75 , 0 , - ( T_9 ) * V_329 , V_316 ? 1 : 0 ) ;
if ( V_316 )
F_160 ( V_75 , V_44 , * V_329 ) ;
F_161 ( V_93 , * V_329 , V_93 -> V_94 . V_338 , V_93 -> V_94 . V_339 ) ;
V_2 . V_22 -> V_187 -= * V_329 ;
F_162 ( V_93 , V_2 . V_22 , V_44 , * V_329 ,
V_316 ? V_318 : V_319 ) ;
* V_328 = V_44 ;
return 0 ;
V_333:
...
void F_163 ( struct V_92 * V_93 , T_2 V_320 , T_4 V_321 , int V_340 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_69 * V_22 ;
V_22 = F_147 ( V_75 , V_320 , V_321 , V_61 ) ;
if ( ! V_22 )
return;
F_162 ( V_93 , V_22 , V_320 , V_321 , V_61 ) ;
V_22 -> V_79 += V_321 ;
V_22 -> V_149 &= ~ V_233 ;
F_113 ( V_22 -> V_116 , V_22 -> V_78 [ 0 ] . V_17 ) ;
F_82 ( V_22 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_86 ( V_22 -> V_145 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
if ( V_340 || V_93 -> V_341 )
F_164 ( V_93 , V_320 , V_321 ) ;
}
void F_165 ( struct V_92 * V_93 , T_2 V_320 , T_4 V_321 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
F_163 ( V_93 , V_320 , V_321 , 1 ) ;
F_159 ( V_75 , 0 , + V_321 , 0 ) ;
F_161 ( V_93 , - ( T_9 ) V_321 , V_93 -> V_94 . V_338 , V_93 -> V_94 . V_339 ) ;
}
void F_166 ( struct V_126 * V_126 )
{
struct V_92 * V_93 = F_64 ( V_126 ) ;
struct V_74 * V_75 = F_36 ( V_126 ) ;
struct V_69 * V_22 ;
T_2 V_342 = V_93 -> V_96 ;
V_22 = F_147 ( V_75 , V_342 , 1 , V_182 ) ;
if ( ! V_22 )
return;
F_162 ( V_93 , V_22 , V_342 , 1 , V_182 ) ;
F_113 ( V_22 -> V_116 , V_22 -> V_78 [ 0 ] . V_17 ) ;
F_82 ( V_22 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_86 ( V_22 -> V_145 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_87 ( V_22 , 1 ) ;
}
static void F_167 ( struct V_69 * V_22 , T_2 V_342 )
{
struct V_74 * V_75 = V_22 -> V_55 ;
struct V_69 * V_343 ;
V_343 = F_147 ( V_75 , V_342 , 1 , V_61 ) ;
if ( ! V_343 )
return;
F_168 ( V_75 , V_22 == V_343 ) ;
if ( ! V_22 -> V_80 )
F_7 ( V_22 ) ;
V_22 -> V_80 -- ;
V_22 -> V_79 ++ ;
...
void F_169 ( struct V_69 * V_22 , struct V_92 * V_93 )
{
F_167 ( V_22 , V_93 -> V_96 ) ;
F_162 ( V_93 , V_22 , V_93 -> V_96 , 1 , V_61 ) ;
F_161 ( V_93 , - 1 , V_93 -> V_94 . V_338 , V_93 -> V_94 . V_339 ) ;
F_164 ( V_93 , V_93 -> V_96 , 1 ) ;
}
int F_170 ( struct V_74 * V_75 , T_2 V_344 , unsigned int type )
{
struct V_69 * V_22 ;
struct V_159 V_345 ;
int error = - V_48 ;
V_22 = F_27 ( V_75 , V_344 , 1 ) ;
if ( ! V_22 )
goto V_141;
error = F_79 ( V_22 -> V_116 , V_162 , 0 , & V_345 ) ;
if ( error )
goto V_141;
if ( F_145 ( V_22 , V_344 ) != type )
error = - V_346 ;
F_80 ( & V_345 ) ;
V_141:
return error ;
}
void F_171 ( struct V_92 * V_93 , struct V_347 * V_348 ,
T_2 V_44 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_69 * V_22 ;
...
unsigned int V_349 ;
unsigned int V_77 ;
if ( F_96 ( V_75 , ! V_348 -> V_350 ) )
return;
if ( V_93 -> V_303 && F_26 ( V_93 -> V_303 , V_44 ) )
V_22 = V_93 -> V_303 ;
else
...
void F_172 ( struct V_347 * V_348 , unsigned int V_30 )
{
unsigned int V_77 ;
V_348 -> V_350 = F_62 ( V_348 -> V_351 , sizeof( struct V_159 ) ,
V_100 | V_323 ) ;
for ( V_77 = 0 ; V_77 < V_348 -> V_351 ; V_77 ++ )
F_173 ( V_348 -> V_352 [ V_77 ] -> V_116 ,
V_30 , 0 ,
& V_348 -> V_350 [ V_77 ] ) ;
}
void F_174 ( struct V_347 * V_348 )
{
unsigned int V_77 ;
F_38 ( V_348 -> V_352 ) ;
if ( V_348 -> V_350 ) {
for ( V_77 = 0 ; V_77 < V_348 -> V_351 ; V_77 ++ )
F_175 ( & V_348 -> V_350 [ V_77 ] ) ;
F_38 ( V_348 -> V_350 ) ;
V_348 -> V_350 = NULL ;
}
}
