...
F_92 (itnim, &im_port->itnim_mapped_list, list_entry) {
if ( V_183 == V_17 -> V_184 )
return V_17 ;
}
return NULL ;
...
{
struct V_185 * V_186 = F_97 ( F_98 ( V_93 ) ) ;
struct V_14 * V_15 ;
struct V_188 * V_78 ;
if ( ! V_186 || F_99 ( V_186 ) )
return - V_194 ;
...
char V_223 [ V_224 ] ;
struct V_225 * V_226 = F_104 ( & V_13 -> V_78 ) ;
F_105 ( V_32 ) =
F_106 ( ( F_107 ( V_105 -> V_227 ) ) ) ;
F_108 ( V_32 ) =
F_106 ( ( F_109 ( V_105 -> V_227 ) ) ) ;
...
F_113 ( V_32 ) [ 2 ] = 1 ;
F_113 ( V_32 ) [ 7 ] = 1 ;
F_114 ( V_223 , V_13 -> V_231 . V_232 . V_233 . V_234 . V_235 . V_223 ,
V_224 ) ;
sprintf ( F_115 ( V_32 ) , L_15 , V_223 ) ;
F_116 ( V_32 ) = F_101 ( & V_13 -> V_78 ) ;
F_117 ( V_32 ) = V_226 -> V_236 . V_237 ;
}
static void
...
V_239 . V_241 =
F_106 ( F_40 ( & V_17 -> V_81 ) ) ;
V_239 . V_242 =
F_120 ( F_41 ( & V_17 -> V_81 ) ) ;
V_239 . V_243 = V_244 ;
V_17 -> V_185 = V_185 =
F_121 ( V_53 -> V_50 , 0 , & V_239 ) ;
if ( ! V_185 )
return;
V_185 -> V_245 =
F_122 ( & V_17 -> V_81 ) ;
V_185 -> V_246 = F_123 ( & V_17 -> V_81 ) ;
V_15 = V_185 -> V_187 ;
V_15 -> V_17 = V_17 ;
V_239 . V_243 |= V_247 ;
if ( V_239 . V_243 != V_244 )
F_124 ( V_185 , V_239 . V_243 ) ;
if ( ( V_185 -> V_248 != - 1 )
&& ( V_185 -> V_248 < V_91 ) )
...
static int
F_127 ( struct V_10 * V_11 , void (* V_205) ( struct V_10 * ) )
{
struct V_52 * V_53 =
...
int V_60 ;
int V_252 = 0 ;
struct V_185 * V_186 = F_97 ( F_98 ( V_11 -> V_31 ) ) ;
V_60 = F_99 ( V_186 ) ;
if ( V_60 ) {
V_11 -> V_26 = V_60 ;
V_205 ( V_11 ) ;
