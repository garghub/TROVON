...
return - V_23 ;
V_26 -> type = V_28 ;
V_26 -> V_18 . V_29 = 27000000 ;
V_26 -> V_18 . V_30 = 148500000 ;
return 0 ;
}
static int F_11 ( struct V_2 * V_3 , int V_31 )
{
struct V_14 * V_15 = F_6 ( V_3 ) ;
struct V_16 * V_17 = & V_15 -> V_17 ;
T_1 V_11 [ 2 ] ;
...
{
struct V_1 * V_13 ;
V_13 = F_13 ( sizeof( * V_13 ) , V_34 ) ;
if ( ! V_13 )
return - V_35 ;
V_13 -> V_22 = (struct V_5 * ) V_33 -> V_36 ;
F_14 ( & V_13 -> V_3 , V_15 , & V_37 ) ;
F_7 ( & V_15 -> V_17 , L_6 ) ;
return 0 ;
}
