...
if ( F_33 ( V_71 ) )
return F_34 ( V_71 ) ;
F_53 ( & F_23 ( V_2 -> V_18 ) -> V_72 ) ;
if ( F_67 ( V_71 ) ) {
V_10 -> V_16 = F_23 ( V_71 ) -> V_73 -> V_74 ;
V_10 -> V_15 = F_23 ( V_71 ) -> V_75 ;
}
F_68 ( V_71 ) ;
return 0 ;
}
...
int F_73 ( struct V_25 * V_26 , struct V_77 * * V_63 )
{
...
struct V_4 * V_82 ,
struct V_4 * V_83 ,
T_2 V_22 , void * V_84 , int V_85 ,
const unsigned char * V_49 , T_2 V_86 )
{
struct V_7 * V_7 ;
struct V_1 * V_2 ;
...
switch ( V_85 ) {
case ( V_87 ) :
V_7 = F_23 ( ( (struct V_13 * ) V_84 ) -> V_18 ) ;
break;
case ( V_88 ) :
V_7 = (struct V_7 * ) V_84 ;
break;
...
if ( V_22 & ( V_89 | V_90 ) && V_7 )
F_47 ( V_2 , V_49 , V_7 -> V_73 -> V_74 , V_7 -> V_75 , 0 ) ;
...
T_1 V_16 ;
F_84 () ;
V_103 = F_85 ( V_101 -> V_104 -> V_103 ) ;
V_15 = V_103 -> V_105 -> V_75 ;
V_16 = V_103 -> V_105 -> V_73 -> V_74 ;
F_86 () ;
