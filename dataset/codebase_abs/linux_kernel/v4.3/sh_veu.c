...
{
struct V_37 * V_38 = V_49 -> V_178 ;
return F_77 ( V_49 , V_38 -> V_75 -> V_36 , V_180 ) ;
}
static int F_78 ( struct V_49 * V_49 , struct V_181 * V_182 )
{
struct V_37 * V_38 = V_49 -> V_178 ;
return F_79 ( V_49 , V_38 -> V_75 -> V_36 , V_182 ) ;
}
static T_3 F_80 ( int V_183 , void * V_184 )
{
...
static T_3 F_82 ( int V_183 , void * V_184 )
{
struct V_13 * V_14 = V_184 ;
struct V_20 * V_187 ;
struct V_20 * V_188 ;
...
V_187 = F_83 ( V_14 -> V_36 ) ;
V_188 = F_84 ( V_14 -> V_36 ) ;
if ( ! V_188 || ! V_187 )
return V_191 ;
V_187 -> V_159 . V_192 = V_188 -> V_159 . V_192 ;
V_187 -> V_159 . V_193 &= ~ V_194 ;
V_187 -> V_159 . V_193 |=
V_188 -> V_159 . V_193 & V_194 ;
V_187 -> V_159 . V_195 = V_188 -> V_159 . V_195 ;
F_85 ( & V_14 -> V_172 ) ;
F_86 ( V_188 , V_196 ) ;
F_86 ( V_187 , V_196 ) ;
F_87 ( & V_14 -> V_172 ) ;
...
struct V_202 * V_203 ;
int V_183 , V_106 ;
V_201 = F_89 ( V_199 , V_204 , 0 ) ;
V_183 = F_90 ( V_199 , 0 ) ;
if ( ! V_201 || V_183 <= 0 ) {
F_91 ( & V_199 -> V_29 , L_16 ) ;
return - V_205 ;
}
V_14 = F_92 ( & V_199 -> V_29 , sizeof( * V_14 ) , V_176 ) ;
if ( ! V_14 )
return - V_177 ;
V_14 -> V_120 = F_93 ( V_201 ) == 0x22c ;
V_14 -> V_16 = F_94 ( & V_199 -> V_29 , V_201 ) ;
if ( F_95 ( V_14 -> V_16 ) )
return F_96 ( V_14 -> V_16 ) ;
V_106 = F_97 ( & V_199 -> V_29 , V_183 , F_82 , F_80 ,
0 , L_17 , V_14 ) ;
if ( V_106 < 0 )
return V_106 ;
V_106 = F_98 ( & V_199 -> V_29 , & V_14 -> V_107 ) ;
if ( V_106 < 0 ) {
F_91 ( & V_199 -> V_29 , L_18 ) ;
return V_106 ;
}
V_203 = & V_14 -> V_203 ;
V_14 -> V_157 = F_99 ( & V_199 -> V_29 ) ;
if ( F_95 ( V_14 -> V_157 ) ) {
V_106 = F_96 ( V_14 -> V_157 ) ;
goto V_206;
}
* V_203 = V_207 ;
V_203 -> V_107 = & V_14 -> V_107 ;
F_100 ( & V_14 -> V_172 ) ;
F_101 ( & V_14 -> V_173 ) ;
V_203 -> V_172 = & V_14 -> V_173 ;
F_102 ( V_203 , V_14 ) ;
V_14 -> V_29 = & V_199 -> V_29 ;
V_14 -> V_25 = V_208 ;
V_14 -> V_32 = V_209 ;
V_14 -> V_47 = F_103 ( & V_210 ) ;
if ( F_95 ( V_14 -> V_47 ) ) {
...
{
struct V_214 * V_107 = F_113 ( V_199 ) ;
