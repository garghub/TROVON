...
T_1 V_30 , V_31 ;
int V_10 ;
F_2 ( & V_2 -> V_11 , L_3 , V_4 ) ;
if ( F_3 ( args -> V_6 , 0 , 0 , false ) ) {
F_2 ( & V_2 -> V_11 ,
L_4 ,
args -> V_6 . V_12 , args -> V_6 . V_32 , args -> V_6 . V_33 ) ;
if ( ! V_8 )
return - V_34 ;
if ( args -> V_6 . V_32 < V_35 )
return - V_36 ;
if ( args -> V_6 . V_32 >= V_8 -> V_14 )
return - V_36 ;
} else
return V_10 ;
V_24 = V_8 -> V_37 ;
...
struct V_7 * V_8 = V_2 -> V_9 -> V_8 ;
int V_10 ;
F_2 ( & V_2 -> V_11 , L_7 , V_4 ) ;
if ( F_3 ( args -> V_6 , 0 , 0 , false ) ) {
F_2 ( & V_2 -> V_11 ,
L_8 ,
args -> V_6 . V_12 , args -> V_6 . V_45 , args -> V_6 . V_17 ) ;
if ( ! V_8 )
return - V_34 ;
} else
return V_10 ;
if ( args -> V_6 . V_17 >= 0 ) {
V_10 |= F_10 ( V_8 , args -> V_6 . V_45 , args -> V_6 . V_17 ) ;
} else {
...
static int
F_11 ( struct V_46 * V_11 , T_1 V_47 , void * V_3 , T_1 V_4 )
{
