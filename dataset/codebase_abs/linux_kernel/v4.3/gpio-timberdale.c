...
V_56 = F_27 ( V_49 , V_60 , 0 ) ;
if ( ! V_56 ) {
F_26 ( V_53 , L_2 ) ;
return - V_17 ;
}
V_7 = F_28 ( V_53 , sizeof( struct V_6 ) , V_61 ) ;
if ( ! V_7 ) {
F_26 ( V_53 , L_3 ) ;
return - V_17 ;
}
V_7 -> V_16 = V_58 -> V_16 ;
F_29 ( & V_7 -> V_9 ) ;
if ( ! F_30 ( V_53 , V_56 -> V_62 , F_31 ( V_56 ) ,
V_63 ) ) {
F_26 ( V_53 , L_4 ) ;
return - V_64 ;
}
V_7 -> V_10 = F_32 ( V_53 , V_56 -> V_62 , F_31 ( V_56 ) ) ;
if ( ! V_7 -> V_10 ) {
F_26 ( V_53 , L_5 ) ;
return - V_65 ;
}
V_54 = & V_7 -> V_2 ;
V_54 -> V_66 = F_33 ( & V_49 -> V_53 ) ;
V_54 -> V_67 = V_68 ;
V_54 -> V_53 = & V_49 -> V_53 ;
V_54 -> V_69 = F_7 ;
V_54 -> V_70 = F_8 ;
V_54 -> V_71 = F_9 ;
V_54 -> V_72 = F_10 ;
V_54 -> V_73 = ( V_20 >= 0 && V_7 -> V_16 > 0 ) ? F_11 : NULL ;
V_54 -> V_74 = NULL ;
V_54 -> V_75 = V_58 -> V_76 ;
V_54 -> V_30 = V_58 -> V_59 ;
V_54 -> V_77 = false ;
