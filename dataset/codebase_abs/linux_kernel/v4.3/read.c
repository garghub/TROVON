...
int F_57 ( struct V_95 * V_95 , struct V_5 * V_5 )
{
struct V_29 * V_30 ;
struct V_9 * V_9 = F_58 ( V_5 ) -> V_96 ;
int error ;
F_26 ( L_2 ,
V_5 , V_6 , F_59 ( V_5 ) ) ;
F_50 ( V_9 , V_97 ) ;
...
static int
F_68 ( void * V_102 , struct V_5 * V_5 )
{
...
if ( V_33 == 0 )
return F_5 ( V_5 ) ;
V_32 = F_17 ( V_104 -> V_30 , V_5 , NULL , 0 , V_33 ) ;
if ( F_18 ( V_32 ) )
goto V_105;
if ( V_33 < V_6 )
F_20 ( V_5 , V_33 , V_6 ) ;
if ( ! F_21 ( V_104 -> V_8 , V_32 ) ) {
...
int F_69 ( struct V_95 * V_107 , struct V_108 * V_109 ,
...
goto V_51;
if ( V_107 == NULL ) {
V_104 . V_30 = F_62 ( V_9 , NULL , V_101 ) ;
if ( V_104 . V_30 == NULL )
return - V_100 ;
} else
V_104 . V_30 = F_63 ( F_64 ( V_107 ) ) ;
V_112 = F_70 ( V_104 . V_30 , V_9 , V_109 ,
V_52 , & V_110 ) ;
if ( V_112 == 0 )
goto V_114;
F_9 ( & V_8 , V_9 , false ,
& V_35 ) ;
V_112 = F_71 ( V_109 , V_52 , F_68 , & V_104 ) ;
F_22 ( & V_8 ) ;
F_14 ( V_8 . V_25 != 1 ) ;
V_34 = & V_8 . V_26 [ 0 ] ;
F_23 ( V_9 ) -> V_36 += V_34 -> V_37 ;
V_111 = ( V_34 -> V_37 + V_6 - 1 ) >>
V_115 ;
F_46 ( V_9 , V_98 , V_111 ) ;
V_114:
F_67 ( V_104 . V_30 ) ;
