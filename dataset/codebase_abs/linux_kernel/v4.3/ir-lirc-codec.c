...
static int F_32 ( void * V_78 )
{
return 0 ;
}
static void F_33 ( void * V_78 )
{
return;
}
...
int V_81 = - V_82 ;
unsigned long V_83 ;
V_9 = F_35 ( sizeof( struct V_79 ) , V_84 ) ;
if ( ! V_9 )
return V_81 ;
V_10 = F_35 ( sizeof( struct V_80 ) , V_84 ) ;
if ( ! V_10 )
goto V_85;
V_81 = F_36 ( V_10 , sizeof( int ) , V_37 ) ;
if ( V_81 )
goto V_86;
V_83 = V_87 ;
if ( V_2 -> V_39 ) {
...
if ( V_2 -> V_72 )
V_83 |= V_95 ;
snprintf ( V_9 -> V_96 , sizeof( V_9 -> V_96 ) , L_5 ,
V_2 -> V_97 ) ;
V_9 -> V_98 = - 1 ;
V_9 -> V_83 = V_83 ;
