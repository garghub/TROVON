...
return - V_12 ;
V_14 = & V_6 -> V_14 ;
V_72 = F_33 ( V_14 , V_73 , 0 , V_74 ) ;
if ( F_34 ( V_72 ) ) {
F_7 ( V_14 , L_8 ) ;
return F_35 ( V_72 ) ;
}
V_3 = F_36 ( V_72 ) ;
F_37 ( V_14 , L_9 , F_38 ( V_72 ) , V_3 ) ;
return V_3 ;
}
...
F_41 ( V_6 , V_25 ) ;
F_42 ( & V_2 -> V_46 ) ;
V_25 -> V_14 . V_78 = & V_6 -> V_14 ;
V_25 -> V_79 = & V_80 ;
V_25 -> V_81 = V_82 ;
V_25 -> V_83 = V_84 ;
V_25 -> V_85 = V_86 ;
V_25 -> V_87 = F_22 ( V_86 ) ;
V_3 = F_2 ( V_2 -> V_6 , V_88 , 0x00 ) ;
if ( V_3 < 0 ) {
F_7 ( & V_6 -> V_14 , L_11 ) ;
return V_3 ;
}
...
static int F_54 ( struct V_70 * V_14 )
{
struct V_1 * V_2 ;
V_2 = F_12 ( F_52 ( F_55 ( V_14 ) ) ) ;
return F_8 ( V_2 , V_2 -> V_15 & ( ~ V_17 ) ) ;
}
static int F_56 ( struct V_70 * V_14 )
{
struct V_1 * V_2 ;
V_2 = F_12 ( F_52 ( F_55 ( V_14 ) ) ) ;
return F_8 ( V_2 , V_2 -> V_15 | V_17 ) ;
