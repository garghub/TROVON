...
F_23 () ;
F_24 () ;
F_25 ( V_8 -> V_27 , ( const V_28 * ) V_23 ) ;
F_26 () ;
F_27 () ;
return F_28 ( V_8 -> V_5 , V_23 , V_24 ) ;
}
...
F_23 () ;
F_24 () ;
F_31 ( V_17 -> V_19 , V_8 -> V_27 , V_29 , V_31 ) ;
F_26 () ;
F_27 () ;
V_29 += V_31 ;
V_30 -= V_31 ;
...
static int F_32 ( struct V_15 * V_16 , T_1 * V_34 )
{
int V_35 ;
struct V_7 * V_8 = F_3 ( F_10 ( V_16 -> V_2 ) ) ;
struct V_14 * V_17 = F_17 ( V_16 ) ;
if ( V_32 ) {
return F_33 ( & V_17 -> V_21 , V_34 ) ;
} else {
if ( V_17 -> V_18 ) {
