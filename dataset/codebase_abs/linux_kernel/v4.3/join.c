...
V_2 -> V_82 = V_15 ;
memset ( V_197 -> V_90 , 0 , V_204 ) ;
memcpy ( V_197 -> V_90 , V_195 -> V_90 , V_195 -> V_91 ) ;
F_2 ( V_8 , V_9 , L_30 ,
V_197 -> V_90 ) ;
memset ( V_15 -> V_90 . V_90 , 0 , V_204 ) ;
memcpy ( V_15 -> V_90 . V_90 , V_195 -> V_90 , V_195 -> V_91 ) ;
V_15 -> V_90 . V_91 = V_195 -> V_91 ;
V_197 -> V_205 = V_206 ;
V_15 -> V_205 = V_207 ;
V_197 -> V_86 = F_3 ( V_2 -> V_86 ) ;
V_15 -> V_86 = V_2 -> V_86 ;
#define F_39 3
#define F_40 1
V_197 -> V_95 . V_94 . V_167 = F_39 ;
V_197 -> V_95 . V_94 . V_12 = F_40 ;
if ( ! F_41 ( V_2 , V_8 -> V_208 ,
( V_55 ) V_2 -> V_209 , 0 ) ) {
struct V_210 * V_211 ;
V_211 = F_41 ( V_2 , V_8 -> V_208 ,
V_212 , 0 ) ;
if ( V_211 )
V_2 -> V_209 = ( T_1 ) V_211 -> V_164 ;
}
if ( ! V_2 -> V_209 ) {
F_2 ( V_8 , ERROR ,
L_31 ) ;
...
L_32 ,
V_2 -> V_209 ) ;
V_2 -> V_100 . V_163 . V_164 = V_2 -> V_209 ;
V_2 -> V_100 . V_165 = V_8 -> V_208 ;
V_15 -> V_164 = V_2 -> V_209 ;
V_197 -> V_95 . V_94 . V_96 =
V_2 -> V_209 ;
memcpy ( & V_15 -> V_95 , & V_197 -> V_95 ,
sizeof( union V_213 ) ) ;
#define F_42 6
#define F_43 2
V_197 -> V_214 . V_215 . V_167 = F_42 ;
V_197 -> V_214 . V_215 . V_12 = F_43 ;
V_197 -> V_214 . V_215 . V_216
= F_3 ( V_2 -> V_216 ) ;
memcpy ( & V_15 -> V_214 , & V_197 -> V_214 ,
sizeof( union V_217 ) ) ;
V_15 -> V_87 |= V_218 ;
V_78 = V_218 ;
if ( V_2 -> V_106 . V_219 ) {
...
memset ( V_197 -> V_34 , 0 , sizeof( V_197 -> V_34 ) ) ;
F_10 ( V_2 , V_197 -> V_34 ) ;
if ( ( V_8 -> V_208 & V_224 ) &&
( V_2 -> V_174 & V_225 ) ) {
if ( F_44 ( V_2 , V_226 ,
...
for ( V_30 = 0 ; V_30 < sizeof( V_197 -> V_34 ) ; V_30 ++ )
if ( ! V_197 -> V_34 [ V_30 ] )
break;
V_2 -> V_100 . V_101 = V_30 ;
memcpy ( & V_2 -> V_100 . V_102 ,
& V_197 -> V_34 , V_2 -> V_100 . V_101 ) ;
F_2 ( V_8 , V_9 , L_37 ,
V_197 -> V_34 ) ;
F_2 ( V_8 , V_9 , L_38 ) ;
if ( F_17 ( V_8 ) ) {
...
if ( V_8 -> V_232 ) {
V_200 = (struct V_199 * ) V_79 ;
memset ( V_200 , 0 , sizeof( struct V_199 ) ) ;
V_200 -> V_19 . type = F_3 ( V_233 ) ;
V_200 -> V_19 . V_12 =
F_3 ( sizeof( struct V_234 ) ) ;
V_120 = F_19 (
V_2 -> V_8 -> V_112 ) ;
F_45 ( V_2 , V_120 , & V_200 -> V_200 ) ;
if ( V_8 -> V_228 ==
V_235 ) {
V_55 V_236 ;
V_236 = F_15 ( V_200 -> V_200 . V_136 ) ;
V_236 &= ~ V_237 ;
V_236 &= ~ V_238 ;
V_200 -> V_200 . V_136 = F_3 ( V_236 ) ;
}
V_79 += sizeof( struct V_199 ) ;
V_198 += sizeof( struct V_199 ) ;
V_202 = (struct V_201 * ) V_79 ;
memset ( V_202 , 0 , sizeof( struct V_201 ) ) ;
V_202 -> V_19 . type = F_3 ( V_239 ) ;
V_202 -> V_19 . V_12 =
F_3 ( sizeof( struct V_240 ) ) ;
V_202 -> V_241 . V_242 =
( T_1 ) V_2 -> V_100 . V_163 . V_164 ;
if ( V_8 -> V_228 ) {
V_202 -> V_241 . V_243 = V_8 -> V_228 ;
V_202 -> V_241 . V_243 |=
V_244 ;
}
V_202 -> V_241 . V_245 =
F_3 ( V_246 ) ;
V_202 -> V_241 . V_247 [ 0 ] = 0xff ;
V_79 += sizeof( struct V_201 ) ;
V_198 +=
sizeof( struct V_201 ) ;
}
V_59 -> V_131 =
F_3 ( ( V_55 ) ( sizeof( struct V_196 )
+ V_132 + V_198 ) ) ;
if ( V_8 -> V_208 == V_133 )
V_78 &= ~ V_134 ;
else
...
V_2 -> V_82 = V_15 ;
V_59 -> V_80 = F_3 ( V_251 ) ;
V_249 -> V_163 . V_205 = V_206 ;
V_249 -> V_163 . V_86
= F_3 ( V_15 -> V_86 ) ;
memcpy ( & V_249 -> V_163 . V_252 ,
& V_15 -> V_84 , V_253 ) ;
memcpy ( & V_249 -> V_163 . V_90 ,
& V_15 -> V_90 . V_90 , V_15 -> V_90 . V_91 ) ;
memcpy ( & V_249 -> V_163 . V_95 ,
& V_15 -> V_95 ,
sizeof( union V_213 ) ) ;
memcpy ( & V_249 -> V_163 . V_214 ,
& V_15 -> V_214 , sizeof( union V_217 ) ) ;
V_78 = V_15 -> V_87 ;
V_78 &= V_135 ;
F_2 ( V_2 -> V_8 , V_9 ,
L_42 ,
...
;
V_77 = V_30 ;
memset ( V_249 -> V_163 . V_102 , 0 ,
sizeof( V_249 -> V_163 . V_102 ) ) ;
memcpy ( V_249 -> V_163 . V_102 ,
V_15 -> V_42 , V_77 ) ;
V_2 -> V_100 . V_101 = V_77 ;
...
V_231 , & V_79 ) ;
V_59 -> V_131 = F_3
( ( V_55 ) ( sizeof( struct V_248 )
+ V_132 + V_198 ) ) ;
V_249 -> V_163 . V_87 = F_3 ( V_78 ) ;
return 0 ;
}
...
struct V_14 * V_15 ;
V_55 V_256 ;
V_255 = & V_142 -> V_62 . V_255 ;
V_15 = V_2 -> V_82 ;
V_256 = F_15 ( V_142 -> V_257 ) ;
if ( V_256 ) {
...
L_60 ,
V_2 -> V_100 . V_165 ) ;
return F_44 ( V_2 , V_251 ,
V_227 , 0 , V_15 , true ) ;
}
static int F_57 ( struct V_1 * V_2 , T_1 * V_264 )
{
T_1 V_84 [ V_253 ] ;
int V_27 ;
if ( ! V_264 || F_58 ( V_264 ) )
...
memcpy ( V_84 , V_264 , V_253 ) ;
V_27 = F_44 ( V_2 , V_265 ,
V_227 , 0 , V_84 , true ) ;
return V_27 ;
}
int F_59 ( struct V_1 * V_2 , T_1 * V_264 )
{
int V_27 = 0 ;
if ( ! V_2 -> V_158 )
return 0 ;
...
break;
case V_207 :
return F_44 ( V_2 , V_267 ,
V_227 , 0 , NULL , true ) ;
case V_268 :
return F_44 ( V_2 , V_269 ,
V_227 , 0 , NULL , true ) ;
default:
break;
}
...
struct V_1 * V_2 ;
int V_30 ;
for ( V_30 = 0 ; V_30 < V_8 -> V_270 ; V_30 ++ ) {
V_2 = V_8 -> V_2 [ V_30 ] ;
if ( V_2 )
F_59 ( V_2 , NULL ) ;
}
