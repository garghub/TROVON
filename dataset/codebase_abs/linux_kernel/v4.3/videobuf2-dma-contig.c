...
if ( ! V_2 || V_11 -> V_14 )
return;
F_11 ( V_11 -> V_18 , V_2 -> V_6 , V_2 -> V_19 , V_11 -> V_20 ) ;
}
...
return - V_29 ;
V_2 = & V_53 -> V_2 ;
V_35 = F_33 ( V_2 , V_11 -> V_21 -> V_57 , V_28 ) ;
if ( V_35 ) {
F_17 ( V_53 ) ;
return - V_29 ;
}
V_54 = V_11 -> V_21 -> V_6 ;
V_55 = V_2 -> V_6 ;
for ( V_7 = 0 ; V_7 < V_2 -> V_57 ; ++ V_7 ) {
F_34 ( V_55 , F_35 ( V_54 ) , V_54 -> V_58 , V_54 -> V_59 ) ;
V_54 = F_36 ( V_54 ) ;
V_55 = F_36 ( V_55 ) ;
}
V_53 -> V_20 = V_60 ;
...
V_2 = & V_53 -> V_2 ;
if ( V_53 -> V_20 != V_60 )
F_38 ( V_14 -> V_18 , V_2 -> V_6 , V_2 -> V_57 ,
V_53 -> V_20 ) ;
F_16 ( V_2 ) ;
F_17 ( V_53 ) ;
V_14 -> V_56 = NULL ;
...
{
struct V_52 * V_53 = V_14 -> V_56 ;
struct V_61 * V_62 = & V_14 -> V_15 -> V_62 ;
struct V_1 * V_2 ;
F_40 ( V_62 ) ;
V_2 = & V_53 -> V_2 ;
if ( V_53 -> V_20 == V_20 ) {
...
V_2 -> V_19 = F_42 ( V_14 -> V_18 , V_2 -> V_6 , V_2 -> V_57 ,
V_20 ) ;
if ( ! V_2 -> V_19 ) {
F_30 ( L_5 ) ;
F_41 ( V_62 ) ;
...
F_57 ( V_72 ) ;
F_58 ( V_73 , & V_72 ) ;
F_59 ( V_11 -> V_18 , V_2 -> V_6 , V_2 -> V_57 ,
V_11 -> V_20 , & V_72 ) ;
V_71 = F_60 ( V_11 -> V_74 ) ;
F_61 ( F_55 ( V_71 ) ) ;
...
V_2 -> V_19 = F_77 ( V_11 -> V_18 , V_2 -> V_6 , V_2 -> V_57 ,
V_11 -> V_20 , & V_72 ) ;
if ( V_2 -> V_19 <= 0 ) {
F_30 ( L_5 ) ;
V_35 = - V_63 ;
