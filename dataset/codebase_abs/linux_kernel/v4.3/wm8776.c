...
if ( F_10 ( V_6 , V_31 ) & V_11 ) {
for ( V_40 = 0 ; V_40 < F_11 ( V_41 ) ; V_40 ++ ) {
if ( V_37 -> V_42 [ V_8 -> V_12 -> V_13 ] / F_12 ( V_35 )
== V_41 [ V_40 ] )
break;
}
if ( V_40 == F_11 ( V_41 ) ) {
F_9 ( V_6 -> V_2 ,
L_2 ,
V_37 -> V_42 [ V_8 -> V_12 -> V_13 ] , F_12 ( V_35 ) ) ;
return - V_18 ;
}
F_13 ( V_6 -> V_2 , L_3 , V_41 [ V_40 ] ) ;
F_5 ( V_6 , V_31 ,
0x7 << V_39 , V_40 << V_39 ) ;
} else {
F_13 ( V_6 -> V_2 , L_4 ) ;
...
static int F_14 ( struct V_7 * V_8 , int V_43 )
{
struct V_5 * V_6 = V_8 -> V_6 ;
...
struct V_5 * V_6 = V_8 -> V_6 ;
struct V_36 * V_37 = F_7 ( V_6 ) ;
if ( F_16 ( V_8 -> V_12 -> V_13 >= F_11 ( V_37 -> V_42 ) ) )
return - V_18 ;
...
struct V_36 * V_37 ;
int V_56 ;
V_37 = F_22 ( & V_60 -> V_2 , sizeof( struct V_36 ) ,
V_61 ) ;
if ( V_37 == NULL )
return - V_62 ;
V_37 -> V_54 = F_23 ( V_60 , & V_63 ) ;
if ( F_24 ( V_37 -> V_54 ) )
return F_25 ( V_37 -> V_54 ) ;
F_26 ( V_60 , V_37 ) ;
V_56 = F_27 ( & V_60 -> V_2 ,
& V_64 , V_65 , F_11 ( V_65 ) ) ;
return V_56 ;
...
struct V_36 * V_37 ;
int V_56 ;
V_37 = F_22 ( & V_67 -> V_2 , sizeof( struct V_36 ) ,
V_61 ) ;
if ( V_37 == NULL )
return - V_62 ;
V_37 -> V_54 = F_31 ( V_67 , & V_63 ) ;
if ( F_24 ( V_37 -> V_54 ) )
return F_25 ( V_37 -> V_54 ) ;
F_32 ( V_67 , V_37 ) ;
V_56 = F_27 ( & V_67 -> V_2 ,
...
static int F_33 ( struct V_66 * V_69 )
{
F_29 ( & V_69 -> V_2 ) ;
return 0 ;
}
