...
if ( ! V_12 -> V_37 )
return 0 ;
V_4 = V_12 -> V_14 . V_15 -> V_4 ;
if ( V_12 -> V_21 > V_4 -> V_7
|| V_12 -> V_21 < V_4 -> V_26 )
V_12 -> V_21 = V_36 -> V_38 ;
return 0 ;
}
static T_1 F_10 ( struct V_16 * V_16 ,
...
static T_1 F_11 ( struct V_16 * V_16 , const char * V_39 ,
T_2 V_40 )
{
struct V_1 * V_2 = V_16 -> V_18 ;
unsigned int V_41 ;
...
static T_1 F_14 ( struct V_16 * V_16 ,
const char * V_39 , T_2 V_40 )
{
struct V_1 * V_2 = V_16 -> V_18 ;
...
static T_1 F_18 ( struct V_16 * V_16 , const char * V_39 ,
T_2 V_40 )
{
struct V_1 * V_2 = V_16 -> V_18 ;
unsigned int V_41 ;
...
static int F_19 ( struct V_16 * V_16 , bool V_53 )
{
struct V_1 * V_18 ;
V_18 = F_20 ( sizeof( * V_18 ) , V_54 ) ;
if ( ! V_18 ) {
F_21 ( L_2 , V_55 ) ;
return - V_56 ;
}
...
static void F_24 ( struct V_16 * V_16 , bool V_53 )
{
if ( V_53 )
F_25 ( & V_61 ,
V_62 ) ;
