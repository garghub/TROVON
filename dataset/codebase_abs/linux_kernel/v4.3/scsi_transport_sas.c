...
if ( ! V_56 )
return - V_33 ;
V_84 = F_112 ( V_3 , 1 , 0x19 , V_56 , V_104 , 30 * V_108 , 3 ,
& V_107 , NULL ) ;
error = - V_71 ;
if ( ! F_113 ( V_84 ) )
goto V_58;
...
static int F_114 ( struct V_44 * V_45 , struct V_24 * V_25 )
{
struct V_13 * V_14 ;
struct V_46 * V_47 ;
if ( ! F_115 ( V_25 ) )
...
static int F_116 ( struct V_44 * V_45 ,
struct V_24 * V_25 )
{
struct V_13 * V_14 ;
struct V_46 * V_47 ;
...
struct V_4 * F_121 ( struct V_81 * V_68 )
{
...
V_128 = 0 ;
F_124 ( & V_5 -> V_25 , 0 , V_5 -> V_79 , V_128 , 0 ) ;
}
return 0 ;
}
...
int F_115 ( const struct V_24 * V_25 )
{
return V_25 -> F_20 == F_119 ||
V_25 -> F_20 == F_118 ;
}
static int F_130 ( struct V_13 * V_14 , T_4 V_130 ,
T_4 V_131 , T_3 V_128 )
{
struct V_26 * V_27 = F_17 ( V_14 ) ;
struct V_4 * V_5 ;
...
void F_142 ( struct V_132 * V_52 )
{
struct V_46 * V_47 = F_9 ( V_52 ) ;
F_143 ( & V_47 -> V_52 . V_48 ) ;
F_143 ( & V_47 -> V_75 ) ;
F_143 ( & V_47 -> V_80 ) ;
F_143 ( & V_47 -> V_114 ) ;
F_143 ( & V_47 -> V_115 ) ;
