...
static struct V_19 * F_52 ( struct V_2 * V_2 ,
struct V_21 * V_22 ,
struct V_46 * V_86 ,
...
V_89 -> V_70 . V_71 . V_71 . V_79 : V_88 -> V_68 ) ;
V_22 -> V_68 = V_68 ;
V_22 -> V_80 = V_69 ;
V_22 -> V_81 = F_46 ( V_72 ) ;
V_22 -> V_82 = V_83 ;
V_22 -> V_93 = type ;
V_22 -> V_94 = V_23 ;
V_22 -> V_84 = F_15 ( V_86 -> V_30 ) ;
F_47 ( V_86 , F_48 ( V_22 ) ) ;
V_20 = F_53 ( V_2 , V_22 ) ;
if ( F_50 ( V_20 ) )
return V_20 ;
V_90 = V_20 ;
V_20 = (struct V_19 * ) F_54 ( V_2 , & V_20 -> V_25 ,
F_48 ( V_22 ) , NULL , 0 ) ;
if ( ! F_50 ( V_20 ) ) {
if ( V_20 != V_90 )
return V_20 ;
} else if ( F_55 ( V_20 ) == - V_95 ) {
V_20 = NULL ;
} else
return V_20 ;
V_92 = F_56 ( V_86 , F_48 ( & V_91 ) , V_96 ) ;
if ( V_92 )
goto V_97;
if ( F_57 ( V_2 , V_86 -> V_30 ,
V_91 . V_68 ) == V_98 ) {
V_90 = F_53 ( V_2 , & V_91 ) ;
if ( F_50 ( V_90 ) )
V_92 = F_55 ( V_90 ) ;
...
V_100 = V_86 -> V_101 ;
F_58 ( V_86 , NULL ) ;
V_92 = F_59 ( V_86 , V_91 . V_38 , V_91 . V_68 ,
...
if ( V_92 )
goto V_97;
V_90 = (struct V_19 * ) F_54 ( V_2 , & V_90 -> V_25 ,
F_48 ( & V_91 ) , NULL ,
V_102 ) ;
if ( ! F_50 ( V_90 ) ) {
F_60 ( & V_20 -> V_25 ) ;
...
void F_62 ( struct V_46 * V_86 , int type , int V_23 , T_3 V_103 )
{
struct V_87 * V_88 ;
int V_104 ;
struct V_48 * V_49 ;
struct V_19 * V_20 = F_40 ( V_86 ) ;
struct V_54 V_55 ;
struct V_21 V_22 ;
T_3 V_68 ;
T_4 V_72 ;
...
V_88 = F_44 ( V_86 ) ;
if ( ( T_4 * ) V_88 < V_86 -> V_105 ||
( F_63 ( V_86 ) + sizeof( * V_88 ) ) >
F_64 ( V_86 ) )
goto V_27;
if ( V_86 -> V_106 != V_107 )
goto V_27;
...
if ( F_70 ( V_20 ) &&
V_2 -> V_3 . V_121 )
V_30 = F_71 ( V_2 , F_72 ( V_86 ) ) ;
if ( V_30 )
V_68 = F_73 ( V_30 , 0 , V_122 ) ;
else
V_68 = 0 ;
F_74 () ;
}
V_72 = V_51 [ type ] . error ? ( ( V_88 -> V_72 & V_123 ) |
V_124 ) :
V_88 -> V_72 ;
V_69 = F_41 ( V_2 , V_86 -> V_69 ) ;
if ( F_42 ( & V_49 -> V_70 . V_71 . V_71 , V_86 ) )
goto V_85;
...
V_55 . V_76 = 0 ;
V_55 . V_72 = - 1 ;
V_20 = F_52 ( V_2 , & V_22 , V_86 , V_88 , V_68 , V_72 , V_69 ,
type , V_23 , V_49 ) ;
if ( F_50 ( V_20 ) )
goto V_85;
if ( ! F_14 ( V_2 , V_20 , & V_22 , type , V_23 ) )
goto V_127;
V_104 = F_76 ( & V_20 -> V_25 ) ;
if ( V_104 > 576 )
V_104 = 576 ;
V_104 -= sizeof( struct V_87 ) + V_49 -> V_70 . V_71 . V_71 . V_77 ;
V_104 -= sizeof( struct V_61 ) ;
V_49 -> V_56 = V_86 -> V_44 - V_49 -> V_43 ;
if ( V_49 -> V_56 > V_104 )
V_49 -> V_56 = V_104 ;
...
static void F_78 ( struct V_46 * V_47 , T_1 V_103 )
{
const struct V_87 * V_88 = ( const struct V_87 * ) V_47 -> V_52 ;
const struct V_128 * V_129 ;
int V_113 = V_88 -> V_113 ;
if ( ! F_79 ( V_47 , V_88 -> V_116 * 4 + 8 ) ) {
F_29 ( F_27 ( V_47 -> V_30 ) , V_130 ) ;
return;
}
F_80 ( V_47 , V_113 , V_103 ) ;
V_129 = F_81 ( V_131 [ V_113 ] ) ;
if ( V_129 && V_129 -> V_132 )
V_129 -> V_132 ( V_47 , V_103 ) ;
}
static bool F_82 ( int V_133 )
{
bool V_134 ;
F_69 () ;
V_134 = F_81 ( V_131 [ V_133 ] ) -> V_135 ;
F_74 () ;
return V_134 ;
}
static bool F_83 ( struct V_46 * V_47 )
{
const struct V_87 * V_88 ;
struct V_61 * V_53 ;
struct V_2 * V_2 ;
T_1 V_103 = 0 ;
V_2 = F_27 ( F_84 ( V_47 ) -> V_30 ) ;
if ( ! F_79 ( V_47 , sizeof( struct V_87 ) ) )
goto V_136;
V_53 = F_33 ( V_47 ) ;
...
goto V_27;
case 0 :
V_103 = F_86 ( V_53 -> V_125 . V_142 . V_143 ) ;
}
break;
case V_144 :
F_85 ( L_2 ,
...
V_103 = F_87 ( V_53 -> V_125 . V_126 ) >> 24 ;
if ( ! V_2 -> V_3 . V_147 &&
F_57 ( V_2 , V_47 -> V_30 , V_88 -> V_38 ) == V_148 ) {
F_88 ( L_3 ,
& F_44 ( V_47 ) -> V_68 ,
V_53 -> type , V_53 -> V_23 ,
& V_88 -> V_38 , V_47 -> V_30 -> V_149 ) ;
goto V_27;
}
F_78 ( V_47 , V_103 ) ;
V_27:
...
static bool F_89 ( struct V_46 * V_47 )
{
...
F_78 ( V_47 , F_33 ( V_47 ) -> V_125 . V_126 ) ;
return true ;
}
...
goto V_136;
F_92 ( & V_153 ) ;
V_49 . V_52 . V_154 [ 1 ] = F_93 ( ( V_153 . V_155 % 86400 ) * V_156 +
V_153 . V_157 / V_158 ) ;
V_49 . V_52 . V_154 [ 2 ] = V_49 . V_52 . V_154 [ 1 ] ;
if ( F_94 ( V_47 , 0 , & V_49 . V_52 . V_154 [ 0 ] , 4 ) )
F_95 () ;
V_49 . V_52 . V_53 = * F_33 ( V_47 ) ;
V_49 . V_52 . V_53 . type = V_159 ;
...
return true ;
V_136:
F_29 ( F_27 ( F_84 ( V_47 ) -> V_30 ) , V_130 ) ;
return false ;
}
...
struct V_2 * V_2 = F_27 ( V_20 -> V_25 . V_30 ) ;
bool V_160 ;
if ( ! F_98 ( NULL , V_161 , V_47 ) ) {
struct V_162 * V_163 = F_99 ( V_47 ) ;
int V_164 ;
if ( ! ( V_163 && V_163 -> V_165 [ V_163 -> V_44 - 1 ] -> V_166 . V_31 &
V_167 ) )
goto V_168;
if ( ! F_79 ( V_47 , sizeof( * V_53 ) + sizeof( struct V_87 ) ) )
goto V_168;
V_164 = F_75 ( V_47 ) ;
F_100 ( V_47 , sizeof( * V_53 ) ) ;
if ( ! F_101 ( NULL , V_161 , V_47 ) )
goto V_168;
F_100 ( V_47 , V_164 ) ;
}
F_29 ( V_2 , V_169 ) ;
...
V_160 = V_51 [ V_53 -> type ] . F_105 ( V_47 ) ;
if ( V_160 ) {
F_106 ( V_47 ) ;
return 0 ;
}
...
F_113 (i) {
struct V_1 * V_4 ;
V_92 = F_119 ( & V_4 , V_180 ,
V_181 , V_83 , V_2 ) ;
if ( V_92 < 0 )
goto V_182;
* F_115 ( V_2 -> V_3 . F_1 , V_178 ) = V_4 ;
V_4 -> V_183 = 2 * F_120 ( 64 * 1024 ) ;
F_121 ( V_4 , V_184 ) ;
F_43 ( V_4 ) -> V_185 = V_186 ;
}
V_2 -> V_3 . V_150 = 0 ;
V_2 -> V_3 . V_173 = 1 ;
V_2 -> V_3 . V_147 = 1 ;
