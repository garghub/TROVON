...
struct V_46 * V_47 ;
int V_20 , V_12 , V_48 ;
V_47 = F_22 ( V_44 -> V_49 , L_2 ) ;
if ( ! V_47 )
return - V_50 ;
V_12 = F_23 ( V_43 , V_47 , V_51 ,
V_52 ) ;
if ( V_12 < 0 )
goto V_53;
for ( V_48 = 0 ; V_48 < F_24 ( V_4 -> V_10 ) ; V_48 ++ ) {
V_4 -> V_10 [ V_48 ] =
F_25 ( V_44 , L_3 , V_48 ,
V_54 ) ;
if ( F_26 ( V_4 -> V_10 [ V_48 ] ) ) {
V_12 = F_27 ( V_4 -> V_10 [ V_48 ] ) ;
F_28 ( V_43 , L_4 , V_48 , V_12 ) ;
goto V_53;
}
if ( ! V_4 -> V_10 [ V_48 ] ) {
F_29 ( V_43 , L_5 , V_48 ) ;
...
{
struct V_60 * V_60 = F_33 ( V_59 -> V_43 . V_61 ) ;
struct V_62 * V_63 = V_60 -> V_64 ;
struct V_65 V_66 = {} ;
struct V_1 * V_67 ;
struct V_3 * V_4 ;
int V_12 , V_48 ;
V_4 = F_34 ( & V_59 -> V_43 , sizeof( * V_4 ) , V_68 ) ;
if ( ! V_4 )
return - V_69 ;
V_12 = F_21 ( & V_59 -> V_43 , & V_63 -> V_43 ,
V_60 -> V_13 , V_4 ) ;
if ( V_12 < 0 )
return V_12 ;
F_35 ( V_59 , V_4 ) ;
...
V_66 . V_71 = V_4 ;
V_66 . V_13 = V_60 -> V_13 ;
V_66 . V_49 = V_51 [ V_48 ] . V_49 ;
V_66 . V_70 = V_51 [ V_48 ] . V_70 ;
V_67 = F_36 ( & V_59 -> V_43 ,
& V_72 [ V_48 ] , & V_66 ) ;
if ( F_26 ( V_67 ) ) {
F_28 ( & V_63 -> V_43 ,
