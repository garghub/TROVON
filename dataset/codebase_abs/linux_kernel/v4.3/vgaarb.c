...
while ( V_35 ) {
V_63 = V_35 -> V_65 ;
if ( V_63 && V_63 == V_12 -> V_11 -> V_35 -> V_65 )
V_12 -> V_37 = false ;
V_35 = V_35 -> V_66 ;
}
}
...
T_11 V_138 , V_139 , V_140 ;
unsigned long V_24 ;
int V_110 ;
V_140 = V_141 . V_142 + V_141 . V_143 ;
for ( V_110 = 0 ; V_110 < V_144 ; V_110 ++ ) {
V_24 = F_69 ( V_12 -> V_11 , V_110 ) ;
if ( ( V_24 & V_145 ) == 0 )
continue;
...
if ( ! V_138 || ! V_139 )
continue;
if ( V_141 . V_142 < V_138 || V_140 >= V_139 )
continue;
if ( ! F_5 () )
F_36 ( L_9 ,
F_37 ( V_12 -> V_11 ) ) ;
