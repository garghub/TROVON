...
if ( V_29 == V_44 ) {
V_76 = & V_37 -> V_168 ;
for ( V_30 = 0 ; V_30 < sizeof( V_160 -> V_169 ) / 2 ; V_30 ++ )
V_160 -> V_169 [ V_30 ] = F_31 ( F_14 ( V_76 ++ ) ) ;
V_76 = & V_37 -> V_99 . V_100 . V_148 ;
for ( V_30 = 0 ; V_30 < sizeof( V_160 -> V_170 ) / 2 ; V_30 ++ )
V_160 -> V_170 [ V_30 ] = F_31 ( F_14 ( V_76 ++ ) ) ;
V_76 = & V_37 -> V_99 . V_100 . V_45 ;
for ( V_30 = 0 ; V_30 < sizeof( V_160 -> V_171 ) / 2 ; V_30 ++ )
...
F_5 ( & V_37 -> V_83 , 0x00 ) ;
V_76 = & V_37 -> V_174 ;
for ( V_30 = 0 ; V_30 < sizeof( V_160 -> V_175 ) / 2 ; V_30 ++ )
...
for ( V_30 = 0 ; V_30 < V_2 -> V_197 ; V_30 ++ ) {
if ( V_30 == 8 )
V_76 = & V_37 -> V_198 . V_199 . V_50 ;
V_160 -> V_171 [ V_30 ] = F_31 ( F_14 ( V_76 ++ ) ) ;
}
V_76 = & V_37 -> V_99 . V_196 . V_200 [ 0 ] ;
for ( V_30 = 0 ; V_30 < sizeof( V_160 -> V_173 ) / 2 ; V_30 ++ )
...
F_23 ( V_37 , V_2 ) ;
V_76 = & V_37 -> V_211 ;
for ( V_30 = 0 ; V_30 < sizeof( V_160 -> V_212 ) / 4 ; V_30 ++ )
