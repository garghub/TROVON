...
static void F_106 ( struct V_192 * V_192 )
{
F_103 ( V_192 -> V_193 , V_192 -> V_194 ) ;
F_107 ( V_192 ) ;
}
static int
F_108 ( struct V_1 * V_2 )
{
union V_195 * V_196 = & V_2 -> V_196 ;
struct V_154 V_64 ;
struct V_63 * V_63 ;
T_6 V_74 , V_197 ;
int V_198 = 0 ;
V_74 = V_196 -> V_199 . V_200 ;
V_197 = V_196 -> V_199 . V_201 -> V_202 ;
F_109 () ;
if ( F_110 ( & V_196 -> V_199 , V_197 ) ) {
V_74 = V_196 -> V_199 . V_203 ;
F_58 ( L_31 ,
V_197 , V_74 , V_197 - V_74 , V_2 -> V_20 . V_83 ) ;
return - V_75 ;
}
while ( V_74 != V_197 ) {
if ( F_111 ( & V_196 -> V_199 , V_74 ) )
break;
if ( F_67 () ) {
V_198 = 1 ;
break;
...
switch ( V_2 -> V_204 ) {
case V_205 :
memcpy ( & V_64 , F_112 ( & V_196 -> V_206 , V_74 ) , sizeof( V_64 ) ) ;
break;
case V_207 :
F_113 ( & V_64 , F_112 ( & V_196 -> V_208 , V_74 ) ) ;
break;
case V_209 :
F_114 ( & V_64 , F_112 ( & V_196 -> V_210 , V_74 ) ) ;
break;
default:
F_115 () ;
}
V_196 -> V_199 . V_200 = ++ V_74 ;
F_116 () ;
switch ( V_64 . V_72 ) {
case V_153 :
case V_211 :
...
V_218 = V_64 -> V_72 == V_212 ?
V_64 -> V_163 . V_164 . V_219 : V_64 -> V_72 ;
if ( ( V_64 -> V_72 == V_212 ) &&
( V_218 != V_153 ) &&
( V_218 != V_211 ) ) {
F_42 ( L_32 , V_218 ) ;
...
V_160 = V_64 -> V_72 == V_212 ?
V_64 -> V_163 . V_164 . V_222 : V_64 -> V_163 . V_223 . V_222 ;
if ( F_50 ( V_160 == 0 && V_72 != V_221 ) ||
F_50 ( ( V_64 -> V_72 != V_212 ) &&
( V_160 > V_39 ) ) ||
F_50 ( ( V_64 -> V_72 == V_212 ) &&
( V_160 > V_224 ) ) ) {
F_42 ( L_33 , V_160 ) ;
...
V_157 . V_79 = 0 ;
V_63 -> V_2 = V_2 ;
V_63 -> V_126 = V_64 -> V_163 . V_223 . V_126 ;
V_63 -> V_72 = V_218 ;
V_63 -> V_127 = V_171 ;
V_63 -> V_133 = V_160 ;
if ( V_64 -> V_72 != V_212 ) {
V_157 . V_82 = V_64 -> V_163 . V_223 . V_47 ;
V_157 . V_81 = V_64 -> V_163 . V_223 . V_81 ;
for ( V_10 = 0 ; V_10 < V_160 ; V_10 ++ ) {
V_40 [ V_10 ] -> V_32 = V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_32 ;
V_156 [ V_10 ] . V_166 = V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_167 -
V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_168 + 1 ;
V_156 [ V_10 ] . V_169 = ( V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_168 << 9 ) ;
if ( ( V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_167 >= ( V_170 >> 9 ) ) ||
( V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_167 <
V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_168 ) )
goto V_177;
...
V_156 [ V_10 ] . V_166 << 9 ,
V_156 [ V_10 ] . V_169 ) == 0 ) ) {
int V_226 = F_122 ( int , ( V_160 - V_10 ) , V_227 ) ;
V_192 = F_123 ( V_149 , V_226 ) ;
if ( F_50 ( V_192 == NULL ) )
goto V_228;
V_214 [ V_215 ++ ] = V_192 ;
V_192 -> V_229 = V_157 . V_84 ;
V_192 -> V_193 = V_63 ;
V_192 -> V_230 = F_106 ;
V_192 -> V_231 . V_232 = V_157 . V_81 ;
}
...
F_101 ( & V_63 -> V_191 , V_215 ) ;
F_124 ( & V_217 ) ;
for ( V_10 = 0 ; V_10 < V_215 ; V_10 ++ )
F_125 ( V_72 , V_214 [ V_10 ] ) ;
F_126 ( & V_217 ) ;
if ( V_72 == V_76 )
V_2 -> V_233 += V_157 . V_79 ;
else if ( V_72 & V_176 )
V_2 -> V_234 += V_157 . V_79 ;
return 0 ;
V_225:
F_85 ( V_2 , V_63 -> V_132 ,
V_63 -> V_133 ) ;
V_177:
F_80 ( V_2 , V_64 -> V_163 . V_223 . V_126 , V_218 , V_184 ) ;
F_46 ( V_2 , V_63 ) ;
F_127 ( 1 ) ;
return - V_186 ;
V_228:
...
unsigned short V_235 , int V_236 )
{
struct V_237 V_238 ;
unsigned long V_4 ;
union V_195 * V_196 = & V_2 -> V_196 ;
...
switch ( V_2 -> V_204 ) {
case V_205 :
memcpy ( F_128 ( & V_196 -> V_206 , V_196 -> V_206 . V_203 ) ,
& V_238 , sizeof( V_238 ) ) ;
break;
case V_207 :
memcpy ( F_128 ( & V_196 -> V_208 , V_196 -> V_208 . V_203 ) ,
& V_238 , sizeof( V_238 ) ) ;
break;
case V_209 :
memcpy ( F_128 ( & V_196 -> V_210 , V_196 -> V_210 . V_203 ) ,
& V_238 , sizeof( V_238 ) ) ;
break;
default:
F_115 () ;
