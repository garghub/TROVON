...
if ( V_41 -> V_48 != 0 )
goto V_93;
if ( F_54 ( V_86 ) && ! F_55 ( V_84 , V_15 , V_94 ) )
goto V_93;
V_21 = - V_27 ;
V_89 = F_56 ( V_95 ) ;
V_90 = ( char * ) V_89 ;
...
V_72 = F_58 ( V_72 ) ;
V_49 -> V_45 = F_59 ( V_72 , & V_72 , 10 ) ;
if ( ! isspace ( * V_72 ) )
goto V_93;
V_72 = F_58 ( V_72 ) ;
V_49 -> V_50 = F_59 ( V_72 , & V_72 , 10 ) ;
if ( ! isspace ( * V_72 ) )
goto V_93;
V_72 = F_58 ( V_72 ) ;
V_49 -> V_30 = F_59 ( V_72 , & V_72 , 10 ) ;
...
T_9 F_63 ( struct V_84 * V_84 , const char T_10 * V_85 ,
T_11 V_99 , T_8 * V_71 )
{
struct V_64 * V_65 = V_84 -> V_88 ;
struct V_2 * V_15 = V_65 -> V_67 ;
struct V_2 * V_100 = F_42 ( V_65 ) ;
if ( ! V_15 -> V_31 )
return - V_24 ;
if ( ( V_100 != V_15 ) && ( V_100 != V_15 -> V_31 ) )
return - V_24 ;
return F_53 ( V_84 , V_85 , V_99 , V_71 , V_101 ,
...
if ( ( V_100 != V_15 ) && ( V_100 != V_15 -> V_31 ) )
return - V_24 ;
return F_53 ( V_84 , V_85 , V_99 , V_71 , V_102 ,
...
if ( ( V_100 != V_15 ) && ( V_100 != V_15 -> V_31 ) )
return - V_24 ;
return F_53 ( V_84 , V_85 , V_99 , V_71 , - 1 ,
& V_15 -> V_61 , & V_15 -> V_31 -> V_61 ) ;
}
static bool F_60 ( const struct V_84 * V_84 ,
struct V_2 * V_15 , int V_86 ,
struct V_40 * V_75 )
{
const struct V_1 * V_1 = V_84 -> V_103 ;
if ( ( V_75 -> V_48 == 1 ) && ( V_75 -> V_49 [ 0 ] . V_30 == 1 ) &&
F_66 ( V_15 -> V_17 , V_1 -> V_18 ) ) {
T_3 V_42 = V_75 -> V_49 [ 0 ] . V_50 ;
if ( V_86 == V_101 ) {
T_1 V_51 = F_26 ( V_15 -> V_31 , V_42 ) ;
if ( F_66 ( V_51 , V_1 -> V_18 ) )
return true ;
} else if ( V_86 == V_102 ) {
...
if ( ! F_54 ( V_86 ) )
return true ;
if ( F_68 ( V_15 -> V_31 , V_86 ) &&
F_55 ( V_84 , V_15 -> V_31 , V_86 ) )
return true ;
return false ;
}
int F_69 ( struct V_64 * V_65 , void * V_66 )
{
struct V_2 * V_15 = V_65 -> V_67 ;
unsigned long V_105 = F_70 ( V_15 -> V_33 ) ;
F_43 ( V_65 , L_2 ,
( V_105 & V_104 ) ?
L_3 : L_4 ) ;
return 0 ;
}
T_9 F_71 ( struct V_84 * V_84 , const char T_10 * V_85 ,
T_11 V_30 , T_8 * V_71 )
{
struct V_64 * V_65 = V_84 -> V_88 ;
struct V_2 * V_15 = V_65 -> V_67 ;
...
bool F_72 ( const struct V_2 * V_15 )
{
bool V_108 ;
F_12 ( & V_32 ) ;
V_108 = V_15 -> V_57 . V_48 != 0 ;
V_108 = V_108 && ( V_15 -> V_33 & V_104 ) ;
F_13 ( & V_32 ) ;
return V_108 ;
}
static inline struct V_2 * F_73 ( struct V_109 * V_15 )
{
return F_74 ( V_15 , struct V_2 , V_15 ) ;
}
static struct V_109 * F_75 ( struct V_110 * V_111 )
{
struct V_2 * V_3 ;
F_76 () ;
V_3 = F_77 ( F_78 ( V_111 ) -> V_3 ) ;
F_79 () ;
return V_3 ? & V_3 -> V_15 : NULL ;
}
static void F_80 ( struct V_109 * V_15 )
{
F_81 ( F_73 ( V_15 ) ) ;
}
static int F_82 ( struct V_112 * V_112 , struct V_109 * V_15 )
{
struct V_2 * V_3 = F_73 ( V_15 ) ;
struct V_1 * V_1 ;
if ( V_3 == F_83 () )
return - V_92 ;
if ( ! F_84 ( V_113 ) )
return - V_92 ;
if ( V_113 -> V_114 -> V_115 != 1 )
return - V_92 ;
if ( ! F_68 ( V_3 , V_94 ) )
return - V_24 ;
V_1 = F_17 () ;
