...
static void F_110 ( struct V_81 * V_114 )
{
struct V_106 * V_107 = V_114 -> V_136 ;
struct V_2 * V_3 = V_107 -> V_3 ;
unsigned V_137 = F_51 ( V_114 ) ;
int error ;
if ( V_137 == V_65 )
F_100 ( V_3 , V_114 ) ;
error = V_114 -> V_135 ;
...
V_114 -> V_136 = V_107 ;
V_114 -> V_139 = F_110 ;
V_114 -> V_140 = V_3 -> V_141 -> V_142 ;
V_114 -> V_143 = V_107 -> V_105 -> V_143 ;
}
static int F_112 ( struct V_106 * V_107 , T_4 V_144 )
{
struct V_2 * V_3 = V_107 -> V_3 ;
struct V_81 * V_114 ;
V_114 = F_113 ( V_107 -> V_105 , V_144 , V_3 -> V_43 ) ;
if ( ! V_114 )
return 1 ;
F_106 ( V_107 ) ;
F_99 ( V_107 , V_114 ) ;
V_114 -> V_84 . V_145 = V_3 -> V_146 + V_107 -> V_77 ;
F_114 ( V_114 ) ;
return 0 ;
}
static void F_115 ( struct V_147 * V_148 )
{
struct V_106 * V_107 = F_116 ( V_148 , struct V_106 , V_148 ) ;
F_106 ( V_107 ) ;
if ( F_112 ( V_107 , V_102 ) )
V_107 -> error = - V_42 ;
F_107 ( V_107 ) ;
}
static void F_117 ( struct V_106 * V_107 )
{
struct V_2 * V_3 = V_107 -> V_3 ;
F_118 ( & V_107 -> V_148 , F_115 ) ;
F_119 ( V_3 -> V_149 , & V_107 -> V_148 ) ;
}
static void F_120 ( struct V_106 * V_107 )
{
struct V_81 * V_114 = V_107 -> V_63 . V_82 ;
F_114 ( V_114 ) ;
}
static int F_121 ( void * V_55 )
{
struct V_2 * V_3 = V_55 ;
struct V_106 * V_107 ;
while ( 1 ) {
...
struct V_152 V_153 ;
F_122 ( V_154 , V_155 ) ;
F_123 ( & V_3 -> V_156 . V_157 ) ;
V_158:
if ( ! F_124 ( & V_3 -> V_151 ) )
goto V_159;
F_125 ( V_160 ) ;
F_126 ( & V_3 -> V_156 , & V_154 ) ;
F_127 ( & V_3 -> V_156 . V_157 ) ;
if ( F_96 ( F_128 () ) ) {
F_129 ( V_155 , V_161 ) ;
F_130 ( & V_3 -> V_156 , & V_154 ) ;
break;
}
F_131 () ;
F_129 ( V_155 , V_161 ) ;
F_123 ( & V_3 -> V_156 . V_157 ) ;
F_132 ( & V_3 -> V_156 , & V_154 ) ;
goto V_158;
V_159:
V_151 = V_3 -> V_151 ;
V_3 -> V_151 = V_162 ;
F_127 ( & V_3 -> V_156 . V_157 ) ;
F_104 ( F_133 ( V_151 . V_163 ) ) ;
F_134 ( & V_153 ) ;
do {
V_107 = F_135 ( F_136 ( & V_151 ) ) ;
F_137 ( & V_107 -> V_163 , & V_151 ) ;
F_120 ( V_107 ) ;
} while ( ! F_124 ( & V_151 ) );
F_138 ( & V_153 ) ;
}
...
static void F_139 ( struct V_106 * V_107 , int V_164 )
{
struct V_81 * V_114 = V_107 -> V_63 . V_82 ;
struct V_2 * V_3 = V_107 -> V_3 ;
unsigned long V_26 ;
...
V_114 -> V_84 . V_145 = V_3 -> V_146 + V_107 -> V_77 ;
if ( F_140 ( ! V_164 ) && F_141 ( V_167 , & V_3 -> V_26 ) ) {
F_114 ( V_114 ) ;
return;
}
F_142 ( & V_3 -> V_156 . V_157 , V_26 ) ;
V_165 = & V_3 -> V_151 . V_163 ;
V_166 = NULL ;
V_77 = V_107 -> V_77 ;
while ( * V_165 ) {
V_166 = * V_165 ;
if ( V_77 < F_135 ( V_166 ) -> V_77 )
V_165 = & ( * V_165 ) -> V_168 ;
else
V_165 = & ( * V_165 ) -> V_169 ;
}
F_143 ( & V_107 -> V_163 , V_166 , V_165 ) ;
F_144 ( & V_107 -> V_163 , & V_3 -> V_151 ) ;
F_145 ( & V_3 -> V_156 ) ;
F_146 ( & V_3 -> V_156 . V_157 , V_26 ) ;
}
...
static void F_149 ( struct V_106 * V_107 )
{
F_107 ( V_107 ) ;
}
...
struct V_106 * V_107 = F_116 ( V_63 , struct V_106 , V_63 ) ;
struct V_2 * V_3 = V_107 -> V_3 ;
if ( error == - V_112 ) {
F_151 ( & V_63 -> V_88 ) ;
return;
...
{
struct V_2 * V_3 = V_107 -> V_3 ;
F_118 ( & V_107 -> V_148 , F_152 ) ;
F_119 ( V_3 -> V_175 , & V_107 -> V_148 ) ;
}
static int F_153 ( T_1 * V_22 , char * V_176 , unsigned int V_113 )
{
char V_177 [ 3 ] ;
unsigned int V_59 ;
V_177 [ 2 ] = '\0' ;
...
static int F_157 ( struct V_2 * V_3 , char * V_178 )
{
unsigned V_59 ;
int V_21 ;
V_3 -> V_4 = F_158 ( V_3 -> V_52 * sizeof( struct V_1 * ) ,
V_41 ) ;
if ( ! V_3 -> V_4 )
return - V_42 ;
for ( V_59 = 0 ; V_59 < V_3 -> V_52 ; V_59 ++ ) {
V_3 -> V_4 [ V_59 ] = F_159 ( V_178 , 0 , 0 ) ;
...
static int F_162 ( struct V_2 * V_3 , char * V_22 )
{
int V_31 = - V_37 ;
...
goto V_78;
if ( V_3 -> V_23 && F_153 ( V_3 -> V_22 , V_22 , V_3 -> V_23 ) < 0 )
goto V_78;
F_163 ( V_181 , & V_3 -> V_26 ) ;
V_31 = F_160 ( V_3 ) ;
V_78:
memset ( V_22 , '0' , V_180 ) ;
return V_31 ;
...
V_3 -> V_185 = F_173 ( V_186 , V_41 ) ;
if ( ! V_3 -> V_185 )
goto V_195;
V_187 = V_186 ;
V_191 = F_174 ( & V_187 , L_17 ) ;
V_35 = F_174 ( & V_191 , L_19 ) ;
if ( ! V_191 )
V_3 -> V_52 = 1 ;
...
V_3 -> V_51 = V_3 -> V_52 ;
V_3 -> V_179 = 0 ;
V_3 -> V_35 = F_173 ( V_35 , V_41 ) ;
if ( ! V_3 -> V_35 )
goto V_195;
V_188 = F_174 ( & V_187 , L_17 ) ;
V_190 = F_174 ( & V_187 , L_17 ) ;
V_189 = F_174 ( & V_190 , L_19 ) ;
if ( V_187 )
F_176 ( L_22 ) ;
...
static int F_178 ( struct V_32 * V_33 , unsigned int V_206 , char * * V_207 )
{
struct V_2 * V_3 ;
...
V_3 -> V_23 = V_23 ;
V_33 -> V_182 = V_3 ;
V_193 = F_172 ( V_33 , V_207 [ 0 ] , V_207 [ 1 ] ) ;
if ( V_193 < 0 )
goto V_40;
V_3 -> V_91 = sizeof( struct V_89 ) ;
V_3 -> V_91 += F_179 ( F_1 ( V_3 ) ) ;
V_3 -> V_91 = F_71 ( V_3 -> V_91 , F_180 ( struct V_6 ) ) ;
...
V_193 = - V_42 ;
V_3 -> V_101 = F_181 ( V_217 , V_3 -> V_91 +
...
sizeof( struct V_6 ) + V_210 + V_3 -> V_8 ,
V_218 ) ;
V_3 -> V_129 = F_182 ( V_219 , 0 ) ;
if ( ! V_3 -> V_129 ) {
V_33 -> error = L_45 ;
goto V_40;
}
V_3 -> V_43 = F_183 ( V_217 , 0 ) ;
if ( ! V_3 -> V_43 ) {
V_33 -> error = L_46 ;
goto V_40;
}
...
V_3 -> V_87 = V_209 ;
V_193 = F_185 ( V_33 , V_207 [ 3 ] , F_186 ( V_33 -> V_220 ) , & V_3 -> V_141 ) ;
if ( V_193 ) {
V_33 -> error = L_49 ;
goto V_40;
}
...
V_212 . V_206 = V_206 ;
V_212 . V_207 = V_207 ;
V_193 = F_187 ( V_215 , & V_212 , & V_208 , & V_33 -> error ) ;
if ( V_193 )
goto V_40;
V_193 = - V_37 ;
while ( V_208 -- ) {
...
F_163 ( V_222 , & V_3 -> V_26 ) ;
else if ( ! strcasecmp ( V_213 , L_54 ) )
F_163 ( V_167 , & V_3 -> V_26 ) ;
else {
V_33 -> error = L_55 ;
goto V_40;
}
...
V_193 = - V_42 ;
V_3 -> V_149 = F_189 ( L_56 , V_223 , 1 ) ;
if ( ! V_3 -> V_149 ) {
V_33 -> error = L_57 ;
goto V_40;
}
if ( F_141 ( V_222 , & V_3 -> V_26 ) )
V_3 -> V_175 = F_189 ( L_58 , V_224 | V_223 , 1 ) ;
else
V_3 -> V_175 = F_189 ( L_58 , V_224 | V_223 | V_225 ,
F_190 () ) ;
if ( ! V_3 -> V_175 ) {
V_33 -> error = L_59 ;
goto V_40;
...
F_191 ( & V_3 -> V_156 ) ;
V_3 -> V_151 = V_162 ;
V_3 -> V_183 = F_192 ( F_121 , V_3 , L_60 ) ;
if ( F_14 ( V_3 -> V_183 ) ) {
...
static int F_194 ( struct V_32 * V_33 , struct V_81 * V_81 )
{
struct V_106 * V_107 ;
struct V_2 * V_3 = V_33 -> V_182 ;
if ( F_96 ( V_81 -> V_143 & ( V_228 | V_229 ) ) ) {
V_81 -> V_140 = V_3 -> V_141 -> V_142 ;
if ( F_148 ( V_81 ) )
V_81 -> V_84 . V_145 = V_3 -> V_146 +
F_195 ( V_33 , V_81 -> V_84 . V_145 ) ;
return V_230 ;
}
V_107 = F_86 ( V_81 , V_3 -> V_108 ) ;
F_105 ( V_107 , V_3 , V_81 , F_195 ( V_33 , V_81 -> V_84 . V_145 ) ) ;
V_107 -> V_63 . V_90 = (struct V_89 * ) ( V_107 + 1 ) ;
if ( F_51 ( V_107 -> V_105 ) == V_138 ) {
if ( F_112 ( V_107 , V_119 ) )
F_117 ( V_107 ) ;
} else
F_111 ( V_107 ) ;
return V_231 ;
}
static void F_196 ( struct V_32 * V_33 , T_6 type ,
...
break;
case V_238 :
F_197 ( L_62 , V_3 -> V_185 ) ;
if ( V_3 -> V_23 > 0 )
for ( V_59 = 0 ; V_59 < V_3 -> V_23 ; V_59 ++ )
F_197 ( L_63 , V_3 -> V_22 [ V_59 ] ) ;
else
F_197 ( L_17 ) ;
F_197 ( L_64 , ( unsigned long long ) V_3 -> V_87 ,
V_3 -> V_141 -> V_239 , ( unsigned long long ) V_3 -> V_146 ) ;
V_236 += ! ! V_33 -> V_221 ;
V_236 += F_141 ( V_222 , & V_3 -> V_26 ) ;
V_236 += F_141 ( V_167 , & V_3 -> V_26 ) ;
if ( V_236 ) {
F_197 ( L_65 , V_236 ) ;
if ( V_33 -> V_221 )
F_197 ( L_66 ) ;
...
{
struct V_2 * V_3 = V_33 -> V_182 ;
F_163 ( V_240 , & V_3 -> V_26 ) ;
}
static int F_199 ( struct V_32 * V_33 )
{
struct V_2 * V_3 = V_33 -> V_182 ;
if ( ! F_141 ( V_181 , & V_3 -> V_26 ) ) {
F_200 ( L_69 ) ;
return - V_241 ;
}
return 0 ;
}
static void F_201 ( struct V_32 * V_33 )
{
struct V_2 * V_3 = V_33 -> V_182 ;
F_165 ( V_240 , & V_3 -> V_26 ) ;
}
static int F_202 ( struct V_32 * V_33 , unsigned V_206 , char * * V_207 )
{
struct V_2 * V_3 = V_33 -> V_182 ;
int V_193 = - V_37 ;
if ( V_206 < 2 )
...
if ( ! F_141 ( V_240 , & V_3 -> V_26 ) ) {
F_176 ( L_71 ) ;
return - V_37 ;
}
if ( V_206 == 3 && ! strcasecmp ( V_207 [ 1 ] , L_72 ) ) {
V_193 = F_162 ( V_3 , V_207 [ 2 ] ) ;
if ( V_193 )
return V_193 ;
if ( V_3 -> V_97 && V_3 -> V_97 -> V_205 )
V_193 = V_3 -> V_97 -> V_205 ( V_3 ) ;
...
static int F_203 ( struct V_32 * V_33 ,
T_7 V_243 , void * V_55 )
{
struct V_2 * V_3 = V_33 -> V_182 ;
return V_243 ( V_33 , V_3 -> V_141 , V_3 -> V_146 , V_33 -> V_121 , V_55 ) ;
}
static void F_204 ( struct V_32 * V_33 , struct V_244 * V_245 )
{
V_245 -> V_246 = V_116 ;
}
