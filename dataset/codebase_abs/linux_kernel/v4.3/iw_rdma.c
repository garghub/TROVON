...
static int F_78 ( struct V_135 * V_85 )
{
struct V_81 * V_82 = V_85 -> V_94 ;
struct V_136 V_137 , * V_138 ;
int V_46 ;
F_79 ( V_82 -> V_128 , V_82 -> V_139 ++ ) ;
V_85 -> V_140 = V_82 -> V_128 -> V_129 ;
memset ( & V_137 , 0 , sizeof( V_137 ) ) ;
V_137 . V_141 = V_142 ;
V_137 . V_143 = V_144 ;
V_137 . V_145 . V_146 . V_147 = V_85 -> V_99 . V_40 ;
V_137 . V_145 . V_146 . V_129 = V_85 -> V_140 ;
V_137 . V_145 . V_146 . V_131 = V_82 -> V_131 ;
V_137 . V_145 . V_146 . V_148 = V_85 -> V_99 . V_38 ;
V_137 . V_145 . V_146 . V_149 = V_55 ;
V_137 . V_145 . V_146 . V_150 = V_151 |
V_152 |
V_153 ;
V_137 . V_145 . V_146 . V_154 = 0 ;
V_137 . V_155 = V_156 ;
V_138 = & V_137 ;
V_46 = F_80 ( V_82 -> V_4 -> V_157 , & V_137 , & V_138 ) ;
F_13 ( V_138 != & V_137 ) ;
if ( V_46 )
F_81 ( V_48 L_7 ,
V_158 , __LINE__ , V_46 ) ;
...
{
struct V_136 V_159 , * V_138 ;
int V_46 = 0 ;
if ( ! V_82 -> V_4 -> V_157 || ! V_82 -> V_128 )
goto V_127;
memset ( & V_159 , 0 , sizeof( V_159 ) ) ;
V_159 . V_141 = V_160 ;
V_159 . V_143 = V_161 ;
V_159 . V_162 . V_163 = V_82 -> V_128 -> V_129 ;
V_159 . V_155 = V_156 ;
V_138 = & V_159 ;
V_46 = F_80 ( V_82 -> V_4 -> V_157 , & V_159 , & V_138 ) ;
if ( V_46 ) {
F_81 ( V_48 L_7 ,
V_158 , __LINE__ , V_46 ) ;
goto V_127;
