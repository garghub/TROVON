...
static int F_40 ( struct V_106 * V_107 , unsigned int V_127 )
{
struct V_53 * V_54 = V_107 -> V_54 ;
F_37 ( V_54 -> V_2 , L_12 , V_122 , V_127 ) ;
if ( 50 == V_127 )
F_28 ( V_54 ,
V_110 , 0x1000 , 0x1000 ) ;
else
...
static T_1 F_43 ( int V_135 , void * V_136 )
{
...
static int F_56 ( struct V_141 * V_139 ,
const struct V_142 * V_143 )
{
struct V_144 * V_68 = F_57 ( & V_139 -> V_2 ) ;
struct V_55 * V_56 ;
struct V_1 * V_2 = & V_139 -> V_2 ;
const struct V_145 * V_146 ;
int V_57 , V_137 ;
V_56 = F_58 ( & V_139 -> V_2 , sizeof( * V_56 ) ,
V_147 ) ;
if ( NULL == V_56 )
return - V_148 ;
V_56 -> V_70 = F_59 ( & V_139 -> V_2 , NULL , V_139 , & V_149 ) ;
if ( F_60 ( V_56 -> V_70 ) ) {
V_137 = F_61 ( V_56 -> V_70 ) ;
F_34 ( & V_139 -> V_2 , L_13 ,
V_137 ) ;
return V_137 ;
}
...
V_56 -> V_59 [ V_57 ] . V_60 ) ;
for ( V_57 = 0 ; V_57 < F_63 ( V_154 ) ; V_57 ++ )
F_15 ( V_56 -> V_70 , V_154 [ V_57 ] . V_3 ,
V_154 [ V_57 ] . V_60 ) ;
if ( V_68 )
V_56 -> V_68 = * V_68 ;
V_146 = F_64 ( V_2 -> V_155 -> V_156 , V_2 ) ;
if ( V_146 ) {
...
for ( V_57 = 0 ; V_57 < V_158 ; V_57 ++ )
F_15 ( V_56 -> V_70 ,
F_5 ( V_159 [ V_57 ] ) ,
V_160 ) ;
if ( ! V_56 -> V_68 . V_69 ) {
F_15 ( V_56 -> V_70 , V_74 , 0x0000 ) ;
F_15 ( V_56 -> V_70 , V_161 , 0x0816 ) ;
F_12 ( V_56 -> V_70 ,
V_73 , 0xf000 , 0xb000 ) ;
} else {
F_12 ( V_56 -> V_70 ,
...
F_31 ( 10 ) ;
F_15 ( V_56 -> V_70 , V_163 , 0x0000 ) ;
F_12 ( V_56 -> V_70 ,
V_164 , 0x0082 , 0x0082 ) ;
F_12 ( V_56 -> V_70 , V_138 , 0x2 , 0x2 ) ;
V_56 -> V_71 = - 1 ;
if ( V_56 -> V_139 -> V_135 ) {
V_137 = F_65 ( V_56 -> V_139 -> V_135 , NULL , F_43 ,
V_165 | V_166 , L_15 , V_56 ) ;
if ( V_137 != 0 ) {
F_34 ( & V_139 -> V_2 ,
L_16 , V_137 ) ;
return V_137 ;
...
V_137 = F_66 ( & V_139 -> V_2 , & V_167 ,
V_168 , F_63 ( V_168 ) ) ;
return V_137 ;
}
static int F_67 ( struct V_141 * V_139 )
{
struct V_55 * V_56 = F_68 ( V_139 ) ;
if ( V_139 -> V_135 )
F_69 ( V_139 -> V_135 , V_56 ) ;
F_70 ( & V_139 -> V_2 ) ;
return 0 ;
}
