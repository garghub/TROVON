...
#else
V_10 = F_33 ( NULL , V_85 ) ;
V_66 = F_53 ( V_10 , F_41 , V_96 , L_16 , NULL ) ;
#endif
if ( V_66 ) {
F_54 ( L_17 , V_10 ) ;
F_55 () ;
...
static void F_58 ( int V_1 , unsigned int V_101 )
{
}
void T_5 F_59 ( struct V_57 * V_102 )
{
if ( strcmp ( V_102 -> type , L_19 ) == 0 && strcmp ( V_102 -> V_35 , L_20 ) == 0 ) {
struct V_61 * V_8 ;
V_8 = F_48 ( V_102 , L_21 , ( void * ) 0 ) ;
if ( V_8 ) {
int V_103 ;
V_102 -> V_35 = F_60 ( 5 + 1 ) ;
memcpy ( & V_103 , V_8 -> V_82 , V_8 -> V_104 ) ;
...
void F_61 ( unsigned int V_105 , unsigned int V_1 )
{
