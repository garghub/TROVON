...
static int F_47 ( struct V_2 * V_4 , struct V_137 * V_138 )
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
struct V_36 * V_43 ;
struct V_13 * V_14 ;
V_14 = F_18 ( V_4 , V_138 -> V_39 , 0 ) ;
V_14 -> V_56 = V_139 ;
V_14 -> V_58 = V_140 ;
V_14 -> V_23 = V_70 ;
V_14 -> V_61 = V_73 ;
V_43 = F_16 ( V_4 , V_138 -> V_39 , 0 ) ;
if ( V_1 -> V_16 -> V_141 )
V_43 -> V_63 = V_66 ;
else
V_43 -> V_63 = V_142 ;
...
static int F_48 ( struct V_2 * V_4 , struct V_137 * V_138 )
{
return F_38 ( V_4 , 0 ) ;
}
static struct V_147 *
F_49 ( struct V_76 * V_77 )
{
struct V_147 * V_30 = NULL ;
struct V_148 V_149 ;
struct V_150 * V_151 ;
struct V_152 * V_153 ;
if ( ! F_50 ( V_154 ) || ! V_77 -> V_79 . V_155 )
return V_77 -> V_79 . V_156 ;
V_151 = F_51 ( V_77 -> V_79 . V_155 , NULL ) ;
if ( ! V_151 )
return NULL ;
if ( F_52 ( V_151 , & V_149 ) < 0 )
goto V_130;
V_30 = F_53 ( & V_77 -> V_79 , sizeof( * V_30 ) , V_157 ) ;
if ( ! V_30 )
goto V_130;
V_153 = F_54 ( V_151 , L_7 , NULL ) ;
if ( V_153 ) {
T_3 * V_114 ;
T_4 V_158 = V_153 -> V_159 / sizeof( * V_114 ) ;
V_114 = F_55 ( & V_77 -> V_79 , V_158 ,
sizeof( * V_114 ) , V_157 ) ;
if ( ! V_114 )
goto V_130;
if ( F_56 ( V_151 , L_7 ,
...
V_30 -> V_31 = ! ! ( V_149 . V_161 . V_162 . V_163 &
V_164 ) ;
V_130:
F_57 ( V_151 ) ;
return V_30 ;
...
{
struct V_147 * V_30 = F_49 ( V_77 ) ;
struct V_1 * V_1 ;
unsigned int V_131 ;
int V_11 ;
if ( ! F_59 ( V_77 -> V_167 ,
V_168 ) ) {
F_28 ( & V_77 -> V_167 -> V_79 ,
L_8 ) ;
return - V_169 ;
}
V_1 = F_53 ( & V_77 -> V_79 , sizeof( * V_1 ) , V_157 ) ;
if ( ! V_1 )
return - V_170 ;
V_1 -> V_7 = F_60 ( V_77 , & V_171 ) ;
if ( F_61 ( V_1 -> V_7 ) )
return F_62 ( V_1 -> V_7 ) ;
V_1 -> V_25 = F_63 ( & V_77 -> V_79 , NULL ) ;
if ( F_61 ( V_1 -> V_25 ) )
return F_62 ( V_1 -> V_25 ) ;
F_64 ( & V_1 -> V_128 ) ;
V_1 -> V_30 = V_30 ;
V_1 -> V_16 = ( const void * ) V_166 -> V_172 ;
F_65 ( & V_1 -> V_35 , 10 ) ;
F_66 ( & V_1 -> V_35 , & V_173 ,
V_99 , 0 , 1 , 1 , 1 ) ;
F_66 ( & V_1 -> V_35 , & V_173 ,
...
V_178 ) ;
F_66 ( & V_1 -> V_35 , & V_173 ,
V_106 , V_1 -> V_16 -> V_17 -> V_179 ,
V_1 -> V_16 -> V_17 -> V_180 , 1 ,
V_181 ) ;
F_66 ( & V_1 -> V_35 , & V_173 ,
...
V_183 ) ;
F_66 ( & V_1 -> V_35 , & V_173 ,
V_109 , V_1 -> V_16 -> V_17 -> V_184 ,
V_1 -> V_16 -> V_17 -> V_185 , 1 ,
V_186 ) ;
V_1 -> V_118 = F_68 ( & V_1 -> V_35 ,
& V_173 , V_117 ,
F_46 ( V_187 ) - 1 , 0 , 0 ,
V_187 ) ;
V_1 -> V_123 = F_69 ( & V_1 -> V_35 ,
& V_188 , NULL ) ;
F_70 ( 2 , & V_1 -> V_118 ) ;
V_1 -> V_78 =
F_66 ( & V_1 -> V_35 , & V_173 ,
...
if ( V_30 -> V_114 [ V_131 ] == V_30 -> V_160 )
V_190 = V_131 ;
}
V_1 -> V_113 =
F_71 ( & V_1 -> V_35 ,
...
V_1 -> V_43 . V_145 = V_146 ;
V_1 -> V_21 = 1 ;
V_1 -> V_50 = 1 ;
V_1 -> V_10 = V_105 | V_100 ;
V_1 -> V_18 = V_183 ;
V_1 -> V_26 = V_193 ;
F_72 ( & V_1 -> V_4 , V_77 , & V_194 ) ;
V_1 -> V_4 . V_195 = & V_196 ;
V_1 -> V_4 . V_163 |= V_197 ;
V_1 -> V_39 . V_163 = V_198 ;
V_11 = F_73 ( & V_1 -> V_4 . V_199 , 1 , & V_1 -> V_39 , 0 ) ;
if ( V_11 < 0 )
goto V_192;
