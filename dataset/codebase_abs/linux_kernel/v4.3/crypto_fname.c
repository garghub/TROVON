...
if ( V_68 ) {
memcpy ( V_37 , & V_68 -> V_71 , 4 ) ;
memcpy ( V_37 + 4 , & V_68 -> V_72 , 4 ) ;
} else
memset ( V_37 , 0 , 8 ) ;
...
struct V_18 * V_19 )
{
struct V_18 V_17 = { . V_48 = ( unsigned char * ) V_74 -> V_48 ,
. V_40 = V_74 -> V_75 } ;
return F_29 ( V_11 , V_68 , & V_17 , V_19 ) ;
}
int F_32 ( struct V_11 * V_11 ,
const struct V_16 * V_17 ,
struct V_18 * V_19 )
{
int V_3 ;
...
int F_33 ( struct V_11 * V_77 , const struct V_16 * V_17 ,
...
V_80 -> V_83 . V_48 = ( unsigned char * ) V_17 -> V_48 ;
V_80 -> V_83 . V_40 = V_17 -> V_40 ;
return 0 ;
}
V_69 = F_35 ( V_77 ) ;
if ( V_69 )
...
V_23 = F_8 ( V_77 ) -> V_24 ;
if ( V_23 ) {
V_69 = F_27 ( V_77 , V_17 -> V_40 ,
& V_80 -> V_84 ) ;
if ( V_69 < 0 )
return V_69 ;
V_69 = F_6 ( V_77 , V_17 , & V_80 -> V_84 ) ;
if ( V_69 < 0 )
goto V_85;
V_80 -> V_83 . V_48 = V_80 -> V_84 . V_48 ;
V_80 -> V_83 . V_40 = V_80 -> V_84 . V_40 ;
return 0 ;
}
if ( ! V_78 )
return - V_76 ;
if ( V_17 -> V_48 [ 0 ] == '_' )
V_81 = 1 ;
if ( ( V_81 && ( V_17 -> V_40 != 33 ) ) ||
( ! V_81 && ( V_17 -> V_40 > 43 ) ) )
return - V_86 ;
V_80 -> V_84 . V_48 = F_10 ( 32 , V_87 ) ;
if ( V_80 -> V_84 . V_48 == NULL )
return - V_43 ;
V_69 = F_25 ( V_17 -> V_48 + V_81 , V_17 -> V_40 - V_81 ,
V_80 -> V_84 . V_48 ) ;
if ( V_69 < 0 ) {
V_69 = - V_86 ;
goto V_85;
...
V_80 -> V_84 . V_40 = V_69 ;
if ( V_81 ) {
memcpy ( & V_80 -> V_68 . V_71 , V_80 -> V_84 . V_48 , 4 ) ;
memcpy ( & V_80 -> V_68 . V_72 , V_80 -> V_84 . V_48 + 4 , 4 ) ;
} else {
V_80 -> V_83 . V_48 = V_80 -> V_84 . V_48 ;
V_80 -> V_83 . V_40 = V_80 -> V_84 . V_40 ;
}
