...
static int F_31 ( struct V_47 * V_27 )
{
struct V_1 * V_2 = F_30 ( V_27 ) ;
F_17 ( V_2 , V_34 ) ;
return 0 ;
}
static int F_32 ( struct V_47 * V_27 )
{
struct V_1 * V_2 = F_30 ( V_27 ) ;
F_28 ( & V_2 -> V_8 -> V_9 , L_3 ) ;
F_16 ( V_2 , V_34 ) ;
F_33 ( & V_2 -> V_27 , V_2 -> V_10 ) ;
return 0 ;
}
static int F_34 ( unsigned long V_48 ,
struct V_47 * V_27 )
{
struct V_1 * V_2 = F_30 ( V_27 ) ;
T_1 V_21 ;
int V_49 ;
V_21 = F_14 ( V_2 , F_11 ( V_2 ) + V_48 ) ;
V_49 = F_11 ( V_2 ) < ( V_21 - 1 ) ;
return ! V_49 ;
}
...
F_36 ( V_27 , 1 , 2 , 0xffffffff ) ;
}
static int F_37 ( struct V_57 * V_8 )
{
struct V_1 * V_2 ;
struct V_58 * V_59 ;
int V_25 ;
V_2 = F_38 ( & V_8 -> V_9 , sizeof( * V_2 ) , V_60 ) ;
if ( V_2 == NULL )
return - V_61 ;
V_2 -> V_8 = V_8 ;
F_39 ( V_8 , V_2 ) ;
...
V_59 = F_41 ( V_8 , V_63 , 0 ) ;
V_2 -> V_4 = F_42 ( & V_8 -> V_9 , V_59 ) ;
if ( F_43 ( V_2 -> V_4 ) )
return F_44 ( V_2 -> V_4 ) ;
V_2 -> V_7 = F_45 ( & V_8 -> V_9 , L_6 ) ;
if ( F_43 ( V_2 -> V_7 ) ) {
F_7 ( & V_8 -> V_9 , L_7 ) ;
return F_44 ( V_2 -> V_7 ) ;
}
if ( F_46 ( & V_8 -> V_9 , V_25 , F_15 ,
V_64 | V_65 | V_66 ,
F_26 ( & V_8 -> V_9 ) , V_2 ) ) {
F_7 ( & V_8 -> V_9 , L_8 ) ;
return - V_67 ;
