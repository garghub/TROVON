...
for ( V_36 = 0 ; V_36 < F_43 ( V_191 ) ; V_36 ++ ) {
if ( V_2 -> V_27 & V_192 & ( 1 << V_36 ) )
F_71 ( & V_6 -> V_6 , L_25 ,
V_191 [ V_36 ] ) ;
}
V_2 -> V_27 &= ~ V_192 ;
...
F_73 ( V_6 ) ;
V_2 -> V_193 = F_74 ( V_6 , V_194 ) ;
if ( ! V_2 -> V_193 ) {
F_4 ( & V_6 -> V_6 ,
L_27 ) ;
return - V_195 ;
}
V_116 = F_75 ( & V_6 -> V_137 [ V_194 ] ) ;
if ( V_116 ) {
return - V_195 ;
}
V_116 = F_76 ( V_6 , 1 << V_194 ,
F_77 ( & V_6 -> V_6 ) ) ;
if ( V_116 ) {
F_4 ( & V_6 -> V_6 ,
L_28 ,
V_2 -> V_193 ,
( unsigned long long ) F_78 ( V_6 , V_194 ) ) ;
return V_116 ;
}
...
F_6 ( F_2 ( F_26 ( V_2 ) ) &
~ ( V_84 | V_60 ) , F_26 ( V_2 ) ) ;
V_2 -> V_26 . V_18 = V_199 / 5 ;
if ( V_2 -> V_27 & V_28 ) {
T_2 V_200 , V_51 ;
F_22 ( V_2 -> V_5 , V_52 , & V_51 ) ;
if ( V_51 & V_53 )
F_15 ( & V_6 -> V_6 , L_31 ) ;
F_22 ( V_2 -> V_5 , V_201 , & V_200 ) ;
if ( V_200 & V_202 ) {
F_79 ( & V_6 -> V_6 , L_32 ) ;
V_2 -> V_27 &= ~ V_28 ;
}
...
if ( V_2 -> V_27 & V_28 ) {
F_80 ( & V_2 -> V_31 ) ;
V_116 = F_81 ( & V_6 -> V_6 , V_6 -> V_49 , F_21 ,
V_203 ,
F_77 ( & V_6 -> V_6 ) , V_2 ) ;
if ( V_116 ) {
F_4 ( & V_6 -> V_6 , L_33 ,
...
{
struct V_1 * V_2 = F_85 ( V_6 ) ;
F_54 ( V_2 ) ;
F_86 ( & V_2 -> V_26 ) ;
F_29 ( V_6 , V_62 , V_2 -> V_196 ) ;
F_55 ( V_2 -> V_169 ) ;
}
static int F_87 ( struct V_5 * V_6 , T_10 V_205 )
{
struct V_1 * V_2 = F_85 ( V_6 ) ;
F_88 ( V_6 ) ;
F_29 ( V_6 , V_62 , V_2 -> V_196 ) ;
F_89 ( V_6 , F_90 ( V_6 , V_205 ) ) ;
return 0 ;
}
