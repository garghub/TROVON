...
int F_76 ( struct V_11 * V_12 , unsigned long V_69 ,
struct V_66 * V_67 )
{
struct V_1 * V_2 = V_12 -> V_2 ;
F_77 ( & V_2 -> V_64 ) ;
...
V_67 -> V_68 = V_12 ;
V_67 -> V_79 = F_78 ( F_79 ( V_67 -> V_73 ) ) ;
F_40 ( V_12 ) ;
return 0 ;
}
int F_80 ( struct V_14 * V_15 , struct V_66 * V_67 )
{
...
F_21 ( & V_2 -> V_64 ) ;
return - V_29 ;
} else if ( ! F_84 ( V_84 , V_15 ) ) {
F_21 ( & V_2 -> V_64 ) ;
return - V_86 ;
}
V_12 = F_85 ( V_84 , struct V_11 , V_20 ) ;
V_35 = F_76 ( V_12 , F_86 ( V_84 ) << V_46 , V_67 ) ;
F_21 ( & V_2 -> V_64 ) ;
return V_35 ;
}
