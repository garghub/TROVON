...
{
V_5 -> V_537 . V_473 = F_277 ( L_48 ,
V_538 | V_539 , 1 , V_5 -> V_74 ) ;
if ( ! V_5 -> V_537 . V_473 )
return - V_450 ;
F_278 ( & V_5 -> V_537 . V_463 , V_540 ) ;
F_182 ( & V_5 -> V_537 . V_464 ) ;
return 0 ;
}
enum V_541 F_279 ( struct V_542 * V_543 , unsigned int V_74 )
{
struct V_43 * V_22 = V_543 -> V_22 ;
struct V_13 * V_14 ;
struct V_4 * V_5 ;
struct V_71 * V_72 , * V_452 ;
struct V_356 * V_11 ;
...
V_11 -> V_551 = V_74 ;
V_11 -> V_552 = & V_553 ;
sprintf ( V_11 -> V_554 , L_49 , V_74 ) ;
V_11 -> V_347 = V_5 ;
V_5 -> V_196 = F_284 ( F_285 ( V_478 , V_74 ) ) ;
V_5 -> V_196 -> V_555 = V_5 -> V_196 ;
V_432 -> V_487 . V_556 = F_241 ;
V_432 -> V_487 . V_480 = V_5 ;
F_286 ( V_432 , V_557 ) ;
F_287 ( V_432 , V_307 | V_305 ) ;
F_288 ( V_432 , V_413 >> 8 ) ;
F_289 ( V_432 , V_558 ) ;
V_432 -> V_559 = & V_22 -> V_23 ;
...
V_5 -> V_562 = V_563 ;
V_5 -> V_564 = V_563 ;
V_544 = F_291 ( & V_479 , V_5 , V_74 , V_74 + 1 , V_80 ) ;
if ( V_544 < 0 ) {
if ( V_544 == - V_565 )
V_110 = V_546 ;
goto V_566;
...
F_36 ( & V_5 -> V_58 ) ;
V_544 = F_291 ( & V_22 -> V_474 , V_5 , V_73 , V_73 + 1 , V_80 ) ;
if ( V_544 < 0 ) {
if ( V_544 == - V_565 )
V_110 = V_546 ;
goto V_567;
...
F_36 ( & V_5 -> V_58 ) ;
V_544 = F_291 ( & V_14 -> V_75 , V_72 , V_73 , V_73 + 1 , V_80 ) ;
if ( V_544 < 0 ) {
if ( V_544 == - V_565 )
V_110 = V_570 ;
goto V_569;
...
F_305 ( V_5 -> V_456 ) ;
F_302 () ;
F_306 ( & V_5 -> V_58 , V_573 , F_206 ) ;
}
static int T_8 F_307 ( void )
{
int V_110 ;
if ( V_443 < V_574 || V_443 > V_575 ) {
F_308 ( L_50 , V_443 ) ;
#ifdef F_309
return - V_576 ;
#else
...
goto V_513;
V_110 = - V_450 ;
V_476 = F_313 ( L_38 , V_580 | V_581 , NULL , & V_582 , NULL ) ;
if ( ! V_476 ) {
F_308 ( L_53 ) ;
goto V_513;
}
...
void F_189 ( struct V_587 * V_128 )
{
if ( V_128 == NULL )
return;
F_318 ( V_128 -> V_188 , V_588 | V_351 | V_589 ) ;
F_318 ( V_128 -> V_590 , V_588 | V_351 | V_589 ) ;
F_55 ( V_128 -> V_120 ) ;
F_55 ( V_128 ) ;
}
static void F_319 ( struct V_102 * V_591 )
{
struct V_104 * V_24 ;
F_71 ( & V_591 -> V_106 ) ;
V_24 = V_591 -> V_104 ;
...
void F_323 ( struct V_4 * V_5 , void * V_233 )
{
struct V_593 * V_100 = V_233 ;
T_4 V_254 ;
int V_158 ;
memset ( V_100 , 0 , sizeof( * V_100 ) ) ;
V_100 -> V_594 = F_90 ( F_105 ( V_5 -> V_196 ) ) ;
for ( V_158 = V_162 ; V_158 < V_163 ; V_158 ++ )
V_100 -> V_164 [ V_158 ] = F_90 ( V_5 -> V_128 -> V_160 . V_164 [ V_158 ] ) ;
V_100 -> V_44 = F_64 ( V_5 -> V_128 -> V_160 . V_44 ) ;
V_100 -> V_92 = F_64 ( V_595 ) ;
V_100 -> V_596 = F_64 ( V_5 -> V_128 -> V_160 . V_596 ) ;
V_100 -> V_597 = F_64 ( V_5 -> V_128 -> V_160 . V_597 ) ;
V_100 -> V_598 = F_64 ( V_5 -> V_453 -> V_599 ) ;
V_100 -> V_600 = F_64 ( V_601 ) ;
V_100 -> V_602 = F_90 ( V_5 -> V_128 -> V_160 . V_602 ) ;
V_100 -> V_603 = F_64 ( V_5 -> V_128 -> V_160 . V_603 ) ;
V_100 -> V_604 = F_64 ( V_5 -> V_412 ) ;
V_100 -> V_605 = F_64 ( V_5 -> V_128 -> V_160 . V_605 ) ;
V_100 -> V_606 = F_64 ( V_5 -> V_128 -> V_160 . V_606 ) ;
F_97 ( V_5 , F_324 ( V_5 -> V_128 ) == V_5 -> V_128 -> V_160 . V_607 ) ;
V_254 = V_5 -> V_128 -> V_160 . V_607 ;
if ( F_325 ( V_5 , V_5 -> V_128 , V_254 , V_608 ) ) {
F_11 ( V_5 , L_64 ) ;
F_326 ( V_5 , 1 , V_609 ) ;
}
}
...
struct V_593 * V_100 ;
F_61 ( V_163 != 4 ) ;
F_61 ( sizeof( struct V_593 ) != 4096 ) ;
F_327 ( & V_5 -> V_399 ) ;
if ( ! F_328 ( V_610 , & V_5 -> V_44 ) )
return;
if ( ! F_89 ( V_5 , V_611 ) )
return;
V_100 = F_329 ( V_5 , V_291 ) ;
if ( ! V_100 )
goto V_324;
F_323 ( V_5 , V_100 ) ;
V_5 -> V_128 -> V_160 . V_594 = F_105 ( V_5 -> V_196 ) ;
F_330 ( V_5 ) ;
V_324:
F_85 ( V_5 ) ;
}
static int F_331 ( struct V_4 * V_5 ,
struct V_593 * V_612 ,
struct V_613 * V_614 )
{
T_5 V_605 = F_332 ( V_612 -> V_605 ) ;
T_5 V_606 = F_332 ( V_612 -> V_606 ) ;
T_3 V_615 ;
if ( V_605 == 0 && V_606 == 0 ) {
V_605 = 1 ;
V_606 = V_616 / 8 ;
...
if ( V_605 == 0 || V_606 == 0 )
goto V_110;
V_615 = ( T_3 ) V_605 * V_606 ;
if ( V_615 > ( 16 * 1024 * 1024 / 4 ) )
goto V_110;
if ( V_615 < V_616 / 8 )
goto V_110;
V_614 -> V_606 = V_606 ;
...
static int F_333 ( struct V_4 * V_5 , struct V_587 * V_345 )
{
T_4 V_617 = F_105 ( V_345 -> V_590 ) ;
struct V_613 * V_614 = & V_345 -> V_160 ;
T_9 V_618 ;
T_9 V_619 ;
if ( V_614 -> V_597 < 0 ) {
if ( V_614 -> V_603 > V_614 -> V_597 )
goto V_110;
V_618 = - V_614 -> V_597 ;
V_619 = V_614 -> V_597 - V_614 -> V_603 ;
} else {
if ( V_614 -> V_597 != V_620 )
goto V_110;
if ( V_614 -> V_603 < V_614 -> V_597 + V_614 -> V_615 * V_620 )
goto V_110;
V_618 = V_614 -> V_603 - V_620 ;
V_619 = V_614 -> V_596 - V_614 -> V_603 ;
}
if ( V_614 -> V_621 >= 0 ) {
if ( V_614 -> V_596 != V_622
|| V_614 -> V_597 != V_620
|| V_614 -> V_603 != V_620 + V_616
|| V_614 -> V_605 != 1
|| V_614 -> V_606 != V_616 / 8 )
goto V_110;
}
if ( V_617 < V_614 -> V_596 )
goto V_110;
if ( V_617 - V_614 -> V_596 < F_334 ( V_345 ) )
goto V_110;
if ( ( V_618 & 7 ) || ( V_618 < V_616 ) )
goto V_110;
if ( V_618 != V_614 -> V_615 * V_620 )
goto V_110;
if ( V_614 -> V_603 & 7 )
goto V_110;
if ( V_619 < ( V_614 -> V_594 + 7 ) / V_620 / 8 / 512 )
goto V_110;
return 0 ;
V_110:
F_11 ( V_5 , L_66
...
L_68 ,
V_614 -> V_621 ,
V_614 -> V_605 , V_614 -> V_606 ,
V_614 -> V_597 , V_614 -> V_603 , V_614 -> V_596 ,
( unsigned long long ) V_614 -> V_594 ,
( unsigned long long ) V_617 ) ;
return - V_576 ;
}
int F_335 ( struct V_4 * V_5 , struct V_587 * V_345 )
{
struct V_593 * V_100 ;
T_5 V_92 , V_44 ;
int V_158 , V_333 = V_572 ;
if ( V_5 -> V_10 . V_11 != V_363 )
return V_623 ;
V_100 = F_329 ( V_5 , V_291 ) ;
if ( ! V_100 )
return V_545 ;
V_345 -> V_160 . V_621 = V_345 -> V_120 -> V_621 ;
V_345 -> V_160 . V_607 = F_324 ( V_345 ) ;
if ( F_325 ( V_5 , V_345 , V_345 -> V_160 . V_607 , V_624 ) ) {
F_11 ( V_5 , L_69 ) ;
V_333 = V_625 ;
goto V_110;
}
V_92 = F_332 ( V_100 -> V_92 ) ;
V_44 = F_332 ( V_100 -> V_44 ) ;
if ( V_92 == V_595 ||
( V_92 == V_626 && ! ( V_44 & V_627 ) ) ) {
F_11 ( V_5 , L_70 ) ;
V_333 = V_628 ;
goto V_110;
}
...
if ( F_332 ( V_100 -> V_600 ) != V_601 ) {
F_11 ( V_5 , L_73 ,
F_332 ( V_100 -> V_600 ) , V_601 ) ;
goto V_110;
}
V_345 -> V_160 . V_594 = F_336 ( V_100 -> V_594 ) ;
for ( V_158 = V_162 ; V_158 < V_163 ; V_158 ++ )
V_345 -> V_160 . V_164 [ V_158 ] = F_336 ( V_100 -> V_164 [ V_158 ] ) ;
V_345 -> V_160 . V_44 = F_332 ( V_100 -> V_44 ) ;
V_345 -> V_160 . V_602 = F_336 ( V_100 -> V_602 ) ;
V_345 -> V_160 . V_596 = F_332 ( V_100 -> V_596 ) ;
V_345 -> V_160 . V_597 = F_332 ( V_100 -> V_597 ) ;
V_345 -> V_160 . V_603 = F_332 ( V_100 -> V_603 ) ;
if ( F_331 ( V_5 , V_100 , & V_345 -> V_160 ) )
goto V_110;
if ( F_333 ( V_5 , V_345 ) )
goto V_110;
if ( F_332 ( V_100 -> V_603 ) != V_345 -> V_160 . V_603 ) {
F_11 ( V_5 , L_74 ,
F_332 ( V_100 -> V_603 ) , V_345 -> V_160 . V_603 ) ;
goto V_110;
}
if ( F_332 ( V_100 -> V_596 ) != V_345 -> V_160 . V_596 ) {
F_11 ( V_5 , L_75 ,
F_332 ( V_100 -> V_596 ) , V_345 -> V_160 . V_596 ) ;
goto V_110;
}
V_333 = V_572 ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
...
unsigned int V_360 ;
V_360 = F_332 ( V_100 -> V_604 ) ;
V_360 = F_337 ( V_360 , V_413 ) ;
V_5 -> V_412 = V_360 ;
}
F_14 ( & V_5 -> V_22 -> V_23 ) ;
V_110:
...
void F_338 ( struct V_4 * V_5 , unsigned int line , const char * F_32 )
{
if ( ! F_339 ( V_610 , & V_5 -> V_44 ) ) {
F_340 ( & V_5 -> V_399 , V_631 + V_632 ) ;
V_5 -> V_633 . line = line ;
V_5 -> V_633 . F_32 = F_32 ;
}
}
...
{
if ( ! F_339 ( V_610 , & V_5 -> V_44 ) )
F_340 ( & V_5 -> V_399 , V_631 + 5 * V_632 ) ;
}
void F_342 ( struct V_4 * V_5 ) __must_hold( T_10 )
{
int V_158 ;
for ( V_158 = V_173 ; V_158 < V_174 ; V_158 ++ )
V_5 -> V_128 -> V_160 . V_164 [ V_158 + 1 ] = V_5 -> V_128 -> V_160 . V_164 [ V_158 ] ;
}
void F_343 ( struct V_4 * V_5 , int V_634 , T_3 V_203 ) __must_hold( T_10 )
{
if ( V_634 == V_162 ) {
if ( V_5 -> V_10 . V_349 == V_350 )
V_203 |= 1 ;
...
V_5 -> V_128 -> V_160 . V_164 [ V_634 ] = V_203 ;
F_341 ( V_5 ) ;
}
void F_345 ( struct V_4 * V_5 , int V_634 , T_3 V_203 ) __must_hold( T_10 )
{
unsigned long V_44 ;
F_24 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
F_343 ( V_5 , V_634 , V_203 ) ;
F_26 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
}
void F_99 ( struct V_4 * V_5 , int V_634 , T_3 V_203 ) __must_hold( T_10 )
{
unsigned long V_44 ;
F_24 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
if ( V_5 -> V_128 -> V_160 . V_164 [ V_634 ] ) {
F_342 ( V_5 ) ;
V_5 -> V_128 -> V_160 . V_164 [ V_173 ] = V_5 -> V_128 -> V_160 . V_164 [ V_634 ] ;
}
F_343 ( V_5 , V_634 , V_203 ) ;
F_26 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
}
void F_346 ( struct V_4 * V_5 ) __must_hold( T_10 )
{
T_3 V_203 ;
unsigned long long V_635 ;
F_98 ( & V_203 , sizeof( T_3 ) ) ;
F_9 ( & V_5 -> V_128 -> V_160 . V_161 ) ;
V_635 = V_5 -> V_128 -> V_160 . V_164 [ V_172 ] ;
if ( V_635 )
F_159 ( V_5 , L_76 , V_635 ) ;
V_5 -> V_128 -> V_160 . V_164 [ V_172 ] = V_5 -> V_128 -> V_160 . V_164 [ V_162 ] ;
F_343 ( V_5 , V_162 , V_203 ) ;
F_14 ( & V_5 -> V_128 -> V_160 . V_161 ) ;
F_95 ( V_5 , L_77 ) ;
F_100 ( V_5 ) ;
}
void F_347 ( struct V_4 * V_5 , T_3 V_203 ) __must_hold( T_10 )
{
unsigned long V_44 ;
...
unsigned long long V_635 = V_5 -> V_128 -> V_160 . V_164 [ V_172 ] ;
if ( V_635 )
F_159 ( V_5 , L_76 , V_635 ) ;
...
static int V_397 ( struct V_492 * V_391 , int V_636 )
{
struct V_4 * V_5 =
F_207 ( V_391 , struct V_4 , V_390 . V_391 ) ;
struct V_390 * V_637 = & V_5 -> V_390 ;
int V_333 = - V_115 ;
F_97 ( V_5 , F_217 ( & V_5 -> V_366 ) == 0 ) ;
if ( F_84 ( V_5 ) ) {
F_353 ( V_5 , V_637 -> V_638 , V_637 -> V_44 ) ;
V_333 = V_637 -> V_639 ( V_5 ) ;
F_354 ( V_5 ) ;
F_85 ( V_5 ) ;
}
F_355 ( V_640 , & V_5 -> V_44 ) ;
F_7 ( & V_5 -> V_12 ) ;
if ( V_637 -> V_495 )
V_637 -> V_495 ( V_5 , V_333 ) ;
F_160 ( V_641 , & V_5 -> V_44 ) ;
V_637 -> V_638 = NULL ;
V_637 -> V_44 = 0 ;
return 0 ;
}
void F_356 ( struct V_4 * V_5 ,
int (* V_639)( struct V_4 * ) ,
void (* V_495)( struct V_4 * , int ) ,
char * V_638 , enum V_642 V_44 )
{
F_97 ( V_5 , V_46 == F_22 ( V_5 ) -> V_14 -> V_463 . V_55 ) ;
F_97 ( V_5 , ! F_92 ( V_641 , & V_5 -> V_44 ) ) ;
F_97 ( V_5 , ! F_92 ( V_640 , & V_5 -> V_44 ) ) ;
F_97 ( V_5 , F_190 ( & V_5 -> V_390 . V_391 . V_388 ) ) ;
if ( V_5 -> V_390 . V_638 )
F_11 ( V_5 , L_78 ,
V_638 , V_5 -> V_390 . V_638 ) ;
V_5 -> V_390 . V_639 = V_639 ;
V_5 -> V_390 . V_495 = V_495 ;
V_5 -> V_390 . V_638 = V_638 ;
V_5 -> V_390 . V_44 = V_44 ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
F_150 ( V_640 , & V_5 -> V_44 ) ;
if ( F_217 ( & V_5 -> V_366 ) == 0 ) {
if ( ! F_339 ( V_641 , & V_5 -> V_44 ) )
F_249 ( & F_22 ( V_5 ) -> V_14 -> V_431 ,
& V_5 -> V_390 . V_391 ) ;
}
F_14 ( & V_5 -> V_22 -> V_23 ) ;
}
int F_357 ( struct V_4 * V_5 , int (* V_639)( struct V_4 * ) ,
char * V_638 , enum V_642 V_44 )
{
int V_333 ;
F_97 ( V_5 , V_46 != F_22 ( V_5 ) -> V_14 -> V_463 . V_55 ) ;
...
void F_349 ( struct V_4 * V_5 , int V_644 ) __must_hold( T_10 )
{
...
int F_128 ( struct V_587 * V_345 , int V_644 )
{
...
const char * F_361 ( enum V_89 V_90 )
{
...
int F_363 ( struct V_4 * V_5 , struct V_675 * V_158 )
{
struct V_118 * V_119 ;
F_364 ( V_67 ) ;
long V_676 ;
...
V_676 = V_119 -> V_274 ? V_119 -> V_676 * V_632 / 10 * V_119 -> V_274 : V_678 ;
F_49 () ;
V_158 -> V_679 = true ;
F_365 ( & V_5 -> V_12 , & V_67 , V_680 ) ;
F_14 ( & V_5 -> V_22 -> V_23 ) ;
V_676 = F_366 ( V_676 ) ;
F_367 ( & V_5 -> V_12 , & V_67 ) ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
...
return F_370 ( V_683 -> V_10 ) ;
}
static char *
F_371 ( unsigned int type ) {
static char * V_689 [] = {
[ V_690 ] = L_128 ,
[ V_691 ] = L_129 ,
[ V_692 ] = L_130 ,
...
unsigned int
F_372 ( struct V_4 * V_5 , unsigned int type )
{
static struct V_682 V_701 = { 0 , 0 } ;
unsigned int V_702 = (
( V_703 == 0 ||
( ( 1 << F_48 ( V_5 ) ) & V_703 ) != 0 ) &&
( ( ( F_369 ( & V_701 ) % 100 ) + 1 ) <= V_704 ) ) ;
if ( V_702 ) {
V_705 ++ ;
if ( F_373 ( & V_706 ) )
F_159 ( V_5 , L_139 ,
