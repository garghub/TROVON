...
static int F_55 ( struct V_89 * V_90 , unsigned int V_108 )
{
struct V_84 * V_91 = F_46 ( V_90 ) ;
struct V_2 * V_3 = F_39 ( V_91 ) ;
const struct V_1 * V_5 ;
...
V_15 = V_13 / V_20 ;
V_16 = V_13 % V_20 ;
F_25 ( F_9 ( V_16 ) , V_5 -> V_21 + V_110 + V_15 * 4 ) ;
V_109 = F_6 ( V_5 -> V_21 + V_111 + V_15 * 4 ) ;
if ( V_108 )
V_109 |= F_9 ( V_16 ) ;
else
V_109 &= ~ F_9 ( V_16 ) ;
F_25 ( V_109 , V_5 -> V_21 + V_111 + V_15 * 4 ) ;
F_56 ( V_3 -> V_11 , L_11 , V_108 ? L_12 : L_13 , V_4 ) ;
return 0 ;
}
...
unsigned long V_113 , V_114 , V_16 ;
V_113 = F_6 ( V_5 -> V_21 + V_92 + V_15 * 4 ) ;
V_114 = F_6 ( V_5 -> V_21 + V_5 -> V_94 +
V_15 * 4 ) ;
V_113 &= V_114 ;
...
static int F_67 ( struct V_2 * V_3 , int V_115 )
{
int V_81 ;
V_3 -> V_85 = V_120 ;
