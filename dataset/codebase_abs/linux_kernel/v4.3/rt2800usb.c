...
{
if ( V_86 == V_87 )
F_53 ( V_2 , V_88 , 0xff , 0 , 2 ) ;
else
F_53 ( V_2 , V_89 , 0xff , 0xff , 2 ) ;
return 0 ;
}
...
struct V_105 * V_106 )
{
struct V_107 * V_108 = F_60 ( V_19 -> V_103 ) ;
T_2 * V_109 = ( T_2 * ) V_19 -> V_103 -> V_52 ;
T_1 V_110 ;
F_61 ( V_109 , 0 , & V_110 ) ;
F_4 ( & V_110 , V_111 ,
F_62 ( V_19 -> V_103 -> V_53 , 4 ) - V_104 ) ;
F_4 ( & V_110 , V_112 ,
...
{
return F_62 ( V_19 -> V_103 -> V_53 , 4 ) + 4 ;
}
static enum V_123
