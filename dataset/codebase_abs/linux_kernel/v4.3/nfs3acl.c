...
if ( error )
goto V_36;
error = V_10 -> V_33 -> V_34 ( V_10 , V_3 -> V_24 , V_20 ) ;
if ( error )
goto V_37;
...
static int F_17 ( struct V_1 * V_2 , T_1 * V_38 ,
struct V_6 * args )
{
V_38 = F_18 ( V_38 , & args -> V_11 ) ;
if ( ! V_38 )
return 0 ;
args -> V_15 = F_19 ( * V_38 ) ; V_38 ++ ;
...
V_43 = F_22 ( & V_2 -> V_41 , V_42 , NULL ,
( args -> V_15 & V_18 ) ?
& args -> V_24 : NULL ) ;
if ( V_43 > 0 )
V_43 = F_22 ( & V_2 -> V_41 , V_42 + V_43 , NULL ,
( args -> V_15 & V_25 ) ?
& args -> V_28 : NULL ) ;
return ( V_43 > 0 ) ;
}
static int F_23 ( struct V_1 * V_2 , T_1 * V_38 ,
struct V_7 * V_4 )
{
struct V_45 * V_45 = V_4 -> V_11 . V_14 ;
V_38 = F_24 ( V_2 , V_38 , & V_4 -> V_11 ) ;
if ( V_4 -> V_46 == 0 && V_45 && F_25 ( V_45 ) ) {
struct V_10 * V_10 = F_6 ( V_45 ) ;
...
V_43 = F_29 ( & V_2 -> V_47 , V_42 , V_10 ,
V_4 -> V_24 ,
V_4 -> V_15 & V_18 , 0 ) ;
if ( V_43 > 0 )
V_43 = F_29 ( & V_2 -> V_47 , V_42 + V_43 , V_10 ,
V_4 -> V_28 ,
V_4 -> V_15 & V_25 ,
V_52 ) ;
if ( V_43 <= 0 )
...
static int F_30 ( struct V_1 * V_2 , T_1 * V_38 ,
struct V_30 * V_4 )
{
V_38 = F_24 ( V_2 , V_38 , & V_4 -> V_11 ) ;
return F_27 ( V_2 , V_38 ) ;
}
static int F_31 ( struct V_1 * V_2 , T_1 * V_38 ,
struct V_7 * V_4 )
{
F_32 ( & V_4 -> V_11 ) ;
F_12 ( V_4 -> V_24 ) ;
