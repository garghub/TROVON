...
static int F_75 ( struct V_63 * V_50 , int V_125 )
{
...
F_29 ( V_49 ) ;
V_49 -> V_50 = NULL ;
F_79 ( V_49 -> V_23 -> V_10 -> V_136 ) ;
}
static void F_80 ( struct V_59 * V_60 , int V_137 )
{
int V_138 ;
if ( V_60 && V_60 -> V_139 &&
V_60 -> V_10 -> V_140 == V_137 ) {
if ( V_60 -> V_10 -> remove ) {
V_138 = V_60 -> V_10 -> remove ( V_60 ) ;
if ( V_138 < 0 )
F_71 ( V_60 -> V_23 ,
L_34 ,
V_60 -> V_53 , V_138 ) ;
...
static void F_81 ( struct V_63 * V_50 , int V_125 , int V_137 )
{
struct V_26 * V_27 = & V_50 -> V_27 [ V_125 ] ;
int V_3 ;
if ( V_27 -> V_141 ) {
...
for ( V_3 = 0 ; V_3 < V_27 -> V_87 ; V_3 ++ )
F_80 ( V_27 -> V_88 [ V_3 ] , V_137 ) ;
F_80 ( V_27 -> V_95 , V_137 ) ;
}
static void F_83 ( struct V_63 * V_50 , int V_125 ,
int V_137 )
{
struct V_26 * V_27 = & V_50 -> V_27 [ V_125 ] ;
struct V_59 * V_95 = V_27 -> V_95 ;
...
struct V_48 * V_49 ;
int V_3 ;
if ( V_62 && V_62 -> V_49 . V_10 -> V_140 == V_137 )
F_76 ( & V_62 -> V_49 ) ;
for ( V_3 = 0 ; V_3 < V_27 -> V_87 ; V_3 ++ ) {
V_49 = V_27 -> V_88 [ V_3 ] -> V_49 ;
if ( V_49 -> V_10 -> V_140 == V_137 )
F_76 ( V_49 ) ;
}
if ( V_95 ) {
if ( V_95 -> V_49 -> V_10 -> V_140 == V_137 )
F_76 ( V_95 -> V_49 ) ;
}
}
static void F_84 ( struct V_63 * V_50 )
{
int V_60 , V_137 ;
for ( V_137 = V_142 ; V_137 <= V_143 ;
V_137 ++ ) {
for ( V_60 = 0 ; V_60 < V_50 -> V_85 ; V_60 ++ )
F_81 ( V_50 , V_60 , V_137 ) ;
}
for ( V_137 = V_142 ; V_137 <= V_143 ;
V_137 ++ ) {
for ( V_60 = 0 ; V_60 < V_50 -> V_85 ; V_60 ++ )
F_83 ( V_50 , V_60 , V_137 ) ;
}
V_50 -> V_85 = 0 ;
}
static void F_85 ( struct V_63 * V_50 ,
struct V_48 * V_49 )
{
int V_3 ;
if ( V_50 -> V_144 == NULL )
...
static int F_86 ( struct V_63 * V_50 ,
struct V_48 * V_49 )
{
struct V_103 * V_102 = F_28 ( V_49 ) ;
struct V_59 * V_60 ;
int V_14 ;
if ( ! strcmp ( V_49 -> V_53 , L_32 ) )
return 0 ;
if ( V_49 -> V_50 ) {
if ( V_49 -> V_50 != V_50 ) {
F_71 ( V_49 -> V_23 ,
...
if ( V_49 -> V_156 )
F_91 ( V_49 , V_49 -> V_156 ,
V_49 -> V_157 ) ;
if ( V_49 -> V_158 )
F_92 ( V_102 , V_49 -> V_158 ,
V_49 -> V_159 ) ;
F_93 ( & V_102 -> V_160 , & V_50 -> V_161 ) ;
if ( V_49 -> V_5 )
F_93 ( & V_49 -> V_5 -> V_135 , & V_50 -> V_162 ) ;
return 0 ;
V_153:
F_29 ( V_49 ) ;
V_49 -> V_50 = NULL ;
...
{
int V_14 = 0 ;
V_27 -> V_23 = F_96 ( sizeof( struct V_22 ) , V_40 ) ;
if ( ! V_27 -> V_23 )
return - V_41 ;
F_97 ( V_27 -> V_23 ) ;
V_27 -> V_23 -> V_123 = V_27 -> V_50 -> V_23 ;
V_27 -> V_23 -> V_163 = F_94 ;
V_27 -> V_23 -> V_164 = V_165 ;
F_98 ( V_27 -> V_23 , L_40 , V_53 ) ;
F_99 ( V_27 -> V_23 , V_27 ) ;
F_100 ( & V_27 -> V_166 ) ;
F_101 ( & V_27 -> V_167 [ V_99 ] . V_168 ) ;
F_101 ( & V_27 -> V_167 [ V_101 ] . V_168 ) ;
F_101 ( & V_27 -> V_167 [ V_99 ] . V_169 ) ;
F_101 ( & V_27 -> V_167 [ V_101 ] . V_169 ) ;
V_14 = F_102 ( V_27 -> V_23 ) ;
if ( V_14 < 0 ) {
F_103 ( V_27 -> V_23 ) ;
F_71 ( V_27 -> V_50 -> V_23 ,
L_41 , V_14 ) ;
...
static int F_104 ( struct V_63 * V_50 , int V_125 ,
int V_137 )
{
struct V_26 * V_27 = & V_50 -> V_27 [ V_125 ] ;
struct V_61 * V_62 = V_27 -> V_62 ;
...
if ( V_62 -> V_49 . V_10 -> V_170 == V_137 ) {
V_14 = F_86 ( V_50 , & V_62 -> V_49 ) ;
if ( V_14 < 0 )
return V_14 ;
}
return 0 ;
}
static int F_105 ( struct V_59 * V_60 , int V_137 )
{
int V_14 ;
if ( ! V_60 -> V_139 && V_60 -> V_10 -> V_170 == V_137 ) {
if ( V_60 -> V_10 -> V_154 ) {
V_14 = V_60 -> V_10 -> V_154 ( V_60 ) ;
if ( V_14 < 0 ) {
F_71 ( V_60 -> V_23 ,
L_42 ,
V_60 -> V_53 , V_14 ) ;
...
static int F_106 ( struct V_63 * V_50 ,
struct V_126 * V_71 ,
struct V_26 * V_27 )
{
struct V_59 * V_95 = V_27 -> V_95 ;
...
static int F_108 ( struct V_63 * V_50 , int V_125 , int V_137 )
{
struct V_126 * V_71 = & V_50 -> V_71 [ V_125 ] ;
struct V_26 * V_27 = & V_50 -> V_27 [ V_125 ] ;
struct V_59 * V_95 = V_27 -> V_95 ;
int V_3 , V_14 ;
F_49 ( V_50 -> V_23 , L_45 ,
V_50 -> V_53 , V_125 , V_137 ) ;
V_27 -> V_29 = V_29 ;
V_14 = F_105 ( V_95 , V_137 ) ;
if ( V_14 )
return V_14 ;
for ( V_3 = 0 ; V_3 < V_27 -> V_87 ; V_3 ++ ) {
V_14 = F_105 ( V_27 -> V_88 [ V_3 ] , V_137 ) ;
if ( V_14 )
return V_14 ;
}
if ( V_137 != V_143 )
...
if ( V_71 -> V_179 )
F_109 ( V_27 , V_71 -> V_179 ) ;
V_14 = F_95 ( V_27 , V_71 -> V_53 ) ;
if ( V_14 )
return V_14 ;
#ifdef F_110
if ( V_71 -> V_180 )
...
V_27 -> V_49 = F_72 ( V_185 -> V_187 , V_53 ) ;
if ( ! V_27 -> V_49 ) {
if ( V_185 -> V_187 )
V_53 = F_116 ( V_185 -> V_187 ) ;
F_71 ( V_50 -> V_23 , L_49 , V_53 ) ;
return - V_133 ;
}
V_27 -> V_5 = V_27 -> V_49 -> V_5 ;
return 0 ;
}
static int F_117 ( struct V_63 * V_50 , int V_125 )
{
struct V_26 * V_27 = & V_50 -> V_183 [ V_125 ] ;
struct V_184 * V_185 = & V_50 -> V_185 [ V_125 ] ;
int V_14 ;
V_14 = F_86 ( V_50 , V_27 -> V_49 ) ;
if ( V_14 < 0 )
return V_14 ;
if ( V_185 -> V_178 ) {
...
return F_95 ( V_27 , V_185 -> V_53 ) ;
}
static void F_118 ( struct V_63 * V_50 , int V_125 )
{
struct V_26 * V_27 = & V_50 -> V_183 [ V_125 ] ;
...
static int F_122 ( struct V_63 * V_50 )
{
struct V_4 * V_5 ;
int V_14 , V_3 , V_137 ;
F_35 ( & V_58 ) ;
F_123 ( & V_50 -> V_196 , V_197 ) ;
for ( V_3 = 0 ; V_3 < V_50 -> V_73 ; V_3 ++ ) {
V_14 = F_75 ( V_50 , V_3 ) ;
if ( V_14 != 0 )
goto V_198;
...
V_14 = F_124 ( V_50 -> V_23 , V_200 , V_201 ,
V_50 -> V_136 , 0 , & V_50 -> V_82 ) ;
if ( V_14 < 0 ) {
F_71 ( V_50 -> V_23 ,
L_52 ,
V_50 -> V_53 , V_14 ) ;
...
F_41 ( V_50 ) ;
V_50 -> V_102 . V_155 = V_107 ;
V_50 -> V_102 . V_23 = V_50 -> V_23 ;
V_50 -> V_102 . V_50 = V_50 ;
F_93 ( & V_50 -> V_102 . V_160 , & V_50 -> V_161 ) ;
#ifdef F_110
F_27 ( & V_50 -> V_102 , V_50 -> V_51 ) ;
#endif
#ifdef F_125
F_126 ( & V_50 -> V_110 , F_66 ) ;
#endif
if ( V_50 -> V_151 )
F_88 ( & V_50 -> V_102 , V_50 -> V_151 ,
V_50 -> V_152 ) ;
if ( V_50 -> V_202 )
F_88 ( & V_50 -> V_102 , V_50 -> V_202 ,
V_50 -> V_203 ) ;
if ( V_50 -> V_154 ) {
V_14 = V_50 -> V_154 ( V_50 ) ;
if ( V_14 < 0 )
goto V_204;
}
for ( V_137 = V_142 ; V_137 <= V_143 ;
...
F_128 ( V_50 ) ;
if ( V_50 -> V_156 )
F_129 ( V_50 , V_50 -> V_156 , V_50 -> V_157 ) ;
if ( V_50 -> V_158 )
F_92 ( & V_50 -> V_102 , V_50 -> V_158 ,
V_50 -> V_159 ) ;
if ( V_50 -> V_207 )
F_92 ( & V_50 -> V_102 , V_50 -> V_207 ,
V_50 -> V_208 ) ;
snprintf ( V_50 -> V_82 -> V_209 , sizeof( V_50 -> V_82 -> V_209 ) ,
L_40 , V_50 -> V_53 ) ;
snprintf ( V_50 -> V_82 -> V_210 , sizeof( V_50 -> V_82 -> V_210 ) ,
L_40 , V_50 -> V_211 ? V_50 -> V_211 : V_50 -> V_53 ) ;
snprintf ( V_50 -> V_82 -> V_10 , sizeof( V_50 -> V_82 -> V_10 ) ,
L_40 , V_50 -> V_212 ? V_50 -> V_212 : V_50 -> V_53 ) ;
for ( V_3 = 0 ; V_3 < F_130 ( V_50 -> V_82 -> V_10 ) ; V_3 ++ ) {
...
static int F_134 ( struct V_214 * V_215 )
{
struct V_63 * V_50 = F_135 ( V_215 ) ;
if ( ! V_50 )
return - V_15 ;
F_26 ( & V_215 -> V_23 ,
L_57 ,
...
static int F_138 ( struct V_214 * V_215 )
{
struct V_63 * V_50 = F_135 ( V_215 ) ;
F_139 ( V_50 ) ;
return 0 ;
...
struct V_216 * F_142 ( const struct V_217 * V_218 ,
...
V_211 = V_221 . V_53 ;
if ( V_220 ) {
V_53 = F_24 ( V_40 , L_58 , V_220 , V_211 ) ;
if ( ! V_53 )
return NULL ;
V_221 . V_53 = V_53 ;
} else {
...
V_222 = F_143 ( & V_221 , V_219 ) ;
F_16 ( V_53 ) ;
return V_222 ;
}
static int F_144 ( struct V_82 * V_50 , struct V_22 * V_23 ,
...
V_138 = F_145 ( V_50 , F_142 ( V_224 , V_219 ,
V_224 -> V_53 , V_220 ) ) ;
if ( V_138 < 0 ) {
F_71 ( V_23 , L_59 ,
V_224 -> V_53 , V_138 ) ;
...
struct V_216 * F_146 ( struct V_63 * V_225 ,
const char * V_53 )
{
...
int F_91 ( struct V_48 * V_49 ,
const struct V_217 * V_156 , unsigned int V_157 )
{
struct V_82 * V_50 = V_49 -> V_50 -> V_82 ;
return F_144 ( V_50 , V_49 -> V_23 , V_156 ,
V_157 , V_49 -> V_149 , V_49 ) ;
}
int F_148 ( struct V_4 * V_5 ,
const struct V_217 * V_156 , unsigned int V_157 )
{
return F_91 ( & V_5 -> V_49 , V_156 ,
V_157 ) ;
}
int F_149 ( struct V_61 * V_62 ,
const struct V_217 * V_156 , unsigned int V_157 )
{
return F_91 ( & V_62 -> V_49 , V_156 ,
V_157 ) ;
}
int F_129 ( struct V_63 * V_225 ,
const struct V_217 * V_156 , int V_157 )
{
struct V_82 * V_50 = V_225 -> V_82 ;
return F_144 ( V_50 , V_225 -> V_23 , V_156 , V_157 ,
NULL , V_225 ) ;
}
int F_150 ( struct V_59 * V_60 ,
const struct V_217 * V_156 , int V_157 )
{
struct V_82 * V_50 = V_60 -> V_49 -> V_50 -> V_82 ;
return F_144 ( V_50 , V_60 -> V_23 , V_156 , V_157 ,
NULL , V_60 ) ;
}
int F_151 ( struct V_59 * V_60 , int V_228 ,
...
int F_152 ( struct V_4 * V_5 , int V_228 ,
...
int F_154 ( struct V_59 * V_60 , int V_235 , int V_232 ,
...
int F_155 ( struct V_4 * V_5 , int V_235 , int V_232 ,
unsigned int V_236 , unsigned int V_237 )
{
if ( V_5 -> V_10 -> V_238 )
...
int F_156 ( struct V_59 * V_60 , unsigned int V_239 )
{
...
int F_121 ( struct V_59 * V_60 , unsigned int V_241 )
{
if ( V_60 -> V_10 == NULL )
return - V_15 ;
...
static int F_157 ( unsigned int V_243 ,
unsigned int * V_244 ,
unsigned int * V_245 )
{
if ( * V_244 || * V_245 )
...
int F_160 ( struct V_59 * V_60 , int V_254 )
{
...
int F_161 ( struct V_59 * V_60 , int V_256 ,
int V_257 )
{
if ( ! V_60 -> V_10 )
return - V_189 ;
...
static int F_162 ( struct V_63 * V_50 ,
struct V_126 * V_71 )
{
if ( V_71 -> V_186 || V_71 -> V_187 ||
V_71 -> V_259 ) {
V_71 -> V_87 = 1 ;
V_71 -> V_127 = F_163 ( V_50 -> V_23 ,
sizeof( struct V_120 ) ,
V_40 ) ;
if ( ! V_71 -> V_127 )
return - V_41 ;
...
V_50 -> V_27 [ V_3 ] . V_88 = F_163 ( V_50 -> V_23 ,
sizeof( struct V_59 * ) *
...
int F_139 ( struct V_63 * V_50 )
{
if ( V_50 -> V_81 ) {
V_50 -> V_81 = false ;
F_141 ( V_50 ) ;
F_137 ( V_50 ) ;
F_49 ( V_50 -> V_23 , L_67 , V_50 -> V_53 ) ;
}
return 0 ;
}
static char * F_165 ( struct V_22 * V_23 , int * V_227 )
{
char * V_264 , V_53 [ V_265 ] ;
int V_266 , V_267 ;
if ( V_148 ( V_23 ) == NULL )
return NULL ;
F_166 ( V_53 , V_148 ( V_23 ) , V_265 ) ;
V_264 = strstr ( V_53 , V_23 -> V_10 -> V_53 ) ;
if ( V_264 ) {
if ( sscanf ( & V_264 [ strlen ( V_23 -> V_10 -> V_53 ) ] , L_68 , V_227 ) == 1 ) {
if ( * V_227 == - 1 )
V_264 [ strlen ( V_23 -> V_10 -> V_53 ) ] = '\0' ;
}
} else {
if ( sscanf ( V_53 , L_69 , & V_266 , & V_267 ) == 2 ) {
char V_268 [ V_265 ] ;
* V_227 = ( ( V_266 & 0xffff ) << 16 ) + V_267 ;
snprintf ( V_268 , V_265 , L_70 , V_23 -> V_10 -> V_53 , V_53 ) ;
F_166 ( V_53 , V_268 , V_265 ) ;
} else
* V_227 = 0 ;
}
return F_167 ( V_53 , V_40 ) ;
}
static inline char * F_168 ( struct V_22 * V_23 ,
struct V_89 * V_269 )
{
if ( V_269 -> V_53 == NULL ) {
F_71 ( V_23 ,
...
return F_167 ( V_269 -> V_53 , V_40 ) ;
}
static void F_169 ( struct V_48 * V_49 )
{
struct V_59 * V_60 , * V_270 ;
F_170 (dai, _dai, &component->dai_list, list) {
F_49 ( V_49 -> V_23 , L_72 ,
V_60 -> V_53 ) ;
F_77 ( & V_60 -> V_160 ) ;
F_16 ( V_60 -> V_53 ) ;
...
unsigned int V_3 ;
int V_14 ;
F_49 ( V_23 , L_73 , V_148 ( V_23 ) , V_16 ) ;
V_49 -> V_269 = V_269 ;
V_49 -> V_272 = V_16 ;
for ( V_3 = 0 ; V_3 < V_16 ; V_3 ++ ) {
V_60 = F_96 ( sizeof( struct V_59 ) , V_40 ) ;
if ( V_60 == NULL ) {
V_14 = - V_41 ;
goto V_138;
}
...
V_60 -> V_53 = F_165 ( V_23 , & V_60 -> V_227 ) ;
} else {
V_60 -> V_53 = F_168 ( V_23 , & V_269 [ V_3 ] ) ;
if ( V_269 [ V_3 ] . V_227 )
...
F_93 ( & V_60 -> V_160 , & V_49 -> V_274 ) ;
F_49 ( V_23 , L_74 , V_60 -> V_53 ) ;
}
return 0 ;
V_138:
F_169 ( V_49 ) ;
...
{
struct V_103 * V_102 ;
V_49 -> V_53 = F_165 ( V_23 , & V_49 -> V_227 ) ;
if ( ! V_49 -> V_53 ) {
F_71 ( V_23 , L_75 ) ;
return - V_41 ;
}
...
{
int V_282 = F_176 ( V_49 -> V_108 ) ;
if ( V_282 > 0 )
V_49 -> V_282 = V_282 ;
}
void F_177 ( struct V_48 * V_49 ,
struct V_108 * V_108 )
{
V_49 -> V_108 = V_108 ;
F_175 ( V_49 ) ;
}
void F_178 ( struct V_48 * V_49 )
{
F_179 ( V_49 -> V_108 ) ;
V_49 -> V_108 = NULL ;
}
...
{
if ( ! V_49 -> V_283 && ! V_49 -> V_284 ) {
if ( ! V_49 -> V_108 )
V_49 -> V_108 = F_181 ( V_49 -> V_23 , NULL ) ;
if ( V_49 -> V_108 )
F_175 ( V_49 ) ;
}
F_93 ( & V_49 -> V_160 , & V_285 ) ;
F_101 ( & V_49 -> V_262 ) ;
}
...
static void F_184 ( struct V_48 * V_49 )
{
F_77 ( & V_49 -> V_160 ) ;
}
int F_185 ( struct V_22 * V_23 ,
const struct V_280 * V_286 ,
struct V_89 * V_269 ,
int V_272 )
{
struct V_48 * V_287 ;
int V_14 ;
V_287 = F_96 ( sizeof( * V_287 ) , V_40 ) ;
if ( ! V_287 ) {
F_71 ( V_23 , L_76 ) ;
return - V_41 ;
}
V_14 = F_174 ( V_287 , V_286 , V_23 ) ;
if ( V_14 )
goto V_288;
V_287 -> V_289 = true ;
V_287 -> V_290 = true ;
V_14 = F_171 ( V_287 , V_269 , V_272 , true ) ;
if ( V_14 < 0 ) {
F_71 ( V_23 , L_77 , V_14 ) ;
goto V_291;
}
...
void F_186 ( struct V_22 * V_23 )
{
struct V_48 * V_287 ;
F_35 ( & V_58 ) ;
F_36 (cmpnt, &component_list, list) {
if ( V_23 == V_287 -> V_23 && V_287 -> V_290 )
goto V_264;
}
F_37 ( & V_58 ) ;
return;
...
{
struct V_61 * V_62 = F_189 ( V_49 ) ;
return V_62 -> V_10 -> V_154 ( V_62 ) ;
}
...
int F_191 ( struct V_22 * V_23 , struct V_61 * V_62 ,
const struct V_293 * V_294 )
{
int V_14 ;
V_14 = F_174 ( & V_62 -> V_49 ,
& V_294 -> V_295 , V_23 ) ;
if ( V_14 )
return V_14 ;
V_62 -> V_23 = V_23 ;
V_62 -> V_10 = V_294 ;
if ( V_294 -> V_154 )
V_62 -> V_49 . V_154 = F_188 ;
if ( V_294 -> remove )
V_62 -> V_49 . remove = F_190 ;
#ifdef F_110
V_62 -> V_49 . V_52 = L_78 ;
#endif
F_35 ( & V_58 ) ;
F_180 ( & V_62 -> V_49 ) ;
F_93 ( & V_62 -> V_160 , & V_296 ) ;
F_37 ( & V_58 ) ;
F_49 ( V_23 , L_79 ,
V_62 -> V_49 . V_53 ) ;
return 0 ;
}
int F_192 ( struct V_22 * V_23 ,
const struct V_293 * V_294 )
{
struct V_61 * V_62 ;
int V_14 ;
F_49 ( V_23 , L_80 , V_148 ( V_23 ) ) ;
V_62 = F_96 ( sizeof( struct V_61 ) , V_40 ) ;
if ( V_62 == NULL )
return - V_41 ;
V_14 = F_191 ( V_23 , V_62 , V_294 ) ;
if ( V_14 )
F_16 ( V_62 ) ;
return V_14 ;
}
void F_193 ( struct V_61 * V_62 )
{
F_35 ( & V_58 ) ;
F_77 ( & V_62 -> V_160 ) ;
F_184 ( & V_62 -> V_49 ) ;
...
struct V_61 * F_194 ( struct V_22 * V_23 )
{
struct V_61 * V_62 ;
F_35 ( & V_58 ) ;
F_36 (platform, &platform_list, list) {
...
static void F_196 ( struct V_297 * V_72 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_130 ( V_298 ) ; V_3 ++ )
if ( V_72 -> V_299 & V_298 [ V_3 ] )
V_72 -> V_299 |= V_298 [ V_3 ] ;
}
static int F_197 ( struct V_48 * V_49 )
{
struct V_4 * V_5 = F_32 ( V_49 ) ;
return V_5 -> V_10 -> V_154 ( V_5 ) ;
}
...
{
struct V_4 * V_5 = F_32 ( V_49 ) ;
return V_5 -> V_10 -> V_283 ( V_5 , V_6 , V_1 ) ;
}
static int F_200 ( struct V_48 * V_49 ,
unsigned int V_6 , unsigned int * V_1 )
{
struct V_4 * V_5 = F_32 ( V_49 ) ;
* V_1 = V_5 -> V_10 -> V_284 ( V_5 , V_6 ) ;
return 0 ;
}
static int F_201 ( struct V_103 * V_102 ,
enum V_300 V_301 )
{
struct V_4 * V_5 = F_202 ( V_102 ) ;
return V_5 -> V_10 -> V_302 ( V_5 , V_301 ) ;
}
int F_203 ( struct V_22 * V_23 ,
...
struct V_59 * V_60 ;
int V_14 , V_3 ;
F_49 ( V_23 , L_82 , V_148 ( V_23 ) ) ;
V_5 = F_96 ( sizeof( struct V_4 ) , V_40 ) ;
if ( V_5 == NULL )
return - V_41 ;
V_5 -> V_49 . V_5 = V_5 ;
V_14 = F_174 ( & V_5 -> V_49 ,
...
goto V_288;
if ( V_304 -> V_156 ) {
V_5 -> V_49 . V_156 = V_304 -> V_156 ;
V_5 -> V_49 . V_157 = V_304 -> V_157 ;
}
if ( V_304 -> V_151 ) {
V_5 -> V_49 . V_151 = V_304 -> V_151 ;
V_5 -> V_49 . V_152 = V_304 -> V_152 ;
}
if ( V_304 -> V_158 ) {
V_5 -> V_49 . V_158 = V_304 -> V_158 ;
V_5 -> V_49 . V_159 = V_304 -> V_159 ;
}
if ( V_304 -> V_154 )
V_5 -> V_49 . V_154 = F_197 ;
if ( V_304 -> remove )
V_5 -> V_49 . remove = F_198 ;
if ( V_304 -> V_283 )
V_5 -> V_49 . V_283 = F_199 ;
if ( V_304 -> V_284 )
V_5 -> V_49 . V_284 = F_200 ;
V_5 -> V_49 . V_289 = V_304 -> V_289 ;
V_102 = F_62 ( V_5 ) ;
V_102 -> V_106 = V_304 -> V_106 ;
V_102 -> V_305 = V_304 -> V_305 ;
if ( V_304 -> V_277 )
V_102 -> V_277 = V_304 -> V_277 ;
if ( V_304 -> V_302 )
V_102 -> V_302 = F_201 ;
V_5 -> V_23 = V_23 ;
V_5 -> V_10 = V_304 ;
V_5 -> V_49 . V_282 = V_304 -> V_13 ;
#ifdef F_110
V_5 -> V_49 . V_55 = F_31 ;
V_5 -> V_49 . V_52 = L_83 ;
#endif
if ( V_304 -> V_306 )
V_5 -> V_49 . V_108 = V_304 -> V_306 ( V_23 ) ;
for ( V_3 = 0 ; V_3 < V_272 ; V_3 ++ ) {
F_196 ( & V_269 [ V_3 ] . V_307 ) ;
F_196 ( & V_269 [ V_3 ] . V_308 ) ;
}
V_14 = F_171 ( & V_5 -> V_49 , V_269 , V_272 , false ) ;
if ( V_14 < 0 ) {
F_71 ( V_23 , L_77 , V_14 ) ;
goto V_291;
}
...
V_311 = V_50 -> V_23 -> V_119 ;
V_14 = F_208 ( V_311 , V_310 , 0 , & V_50 -> V_53 ) ;
if ( V_14 < 0 && V_14 != - V_15 ) {
F_71 ( V_50 -> V_23 ,
L_87 ,
V_310 , V_14 ) ;
...
int F_209 ( struct V_63 * V_50 ,
const char * V_310 )
{
struct V_118 * V_311 = V_50 -> V_23 -> V_119 ;
struct V_171 * V_313 ;
const char * V_221 , * V_314 ;
int V_3 , V_80 , V_315 , V_14 ;
V_315 = F_210 ( V_311 , V_310 ) ;
if ( V_315 < 0 ) {
F_71 ( V_50 -> V_23 ,
L_88 , V_310 ) ;
return - V_15 ;
...
V_313 = F_211 ( V_50 -> V_23 , V_315 , sizeof( * V_313 ) ,
V_40 ) ;
if ( ! V_313 ) {
F_71 ( V_50 -> V_23 ,
L_91 ) ;
...
for ( V_80 = 0 ; V_80 < F_130 ( V_316 ) ; V_80 ++ ) {
if ( ! strncmp ( V_221 , V_316 [ V_80 ] . V_53 ,
strlen ( V_316 [ V_80 ] . V_53 ) ) ) {
V_313 [ V_3 ] = V_316 [ V_80 ] ;
break;
}
}
if ( V_80 >= F_130 ( V_316 ) ) {
...
V_313 [ V_3 ] . V_53 = V_314 ;
}
V_50 -> V_202 = V_313 ;
V_50 -> V_203 = V_315 ;
return 0 ;
}
int F_212 ( struct V_118 * V_311 ,
unsigned int * V_243 ,
unsigned int * V_246 )
{
T_6 V_1 ;
...
V_320 = F_163 ( V_50 -> V_23 , V_318 * sizeof( * V_320 ) ,
V_40 ) ;
if ( ! V_320 ) {
F_71 ( V_50 -> V_23 ,
L_97 ) ;
...
unsigned int F_218 ( struct V_118 * V_311 ,
const char * V_220 ,
struct V_118 * * V_322 ,
struct V_118 * * V_323 )
{
...
V_14 = F_216 ( V_311 , V_324 , & V_317 ) ;
if ( V_14 == 0 ) {
for ( V_3 = 0 ; V_3 < F_130 ( V_328 ) ; V_3 ++ ) {
if ( strcmp ( V_317 , V_328 [ V_3 ] . V_53 ) == 0 ) {
V_325 |= V_328 [ V_3 ] . V_1 ;
break;
}
}
...
if ( F_219 ( V_311 , V_324 , NULL ) )
V_325 |= V_338 ;
else
V_325 |= V_339 ;
snprintf ( V_324 , sizeof( V_324 ) , L_111 , V_220 ) ;
V_326 = ! ! F_219 ( V_311 , V_324 , NULL ) ;
snprintf ( V_324 , sizeof( V_324 ) , L_112 , V_220 ) ;
V_327 = ! ! F_219 ( V_311 , V_324 , NULL ) ;
...
V_326 = ! ! F_219 ( V_311 , V_324 , NULL ) ;
if ( V_326 && V_322 )
* V_322 = F_220 ( V_311 , V_324 , 0 ) ;
snprintf ( V_324 , sizeof( V_324 ) , L_114 , V_220 ) ;
V_327 = ! ! F_219 ( V_311 , V_324 , NULL ) ;
if ( V_327 && V_323 )
* V_323 = F_220 ( V_311 , V_324 , 0 ) ;
switch ( ( V_326 << 4 ) + V_327 ) {
case 0x11 :
V_325 |= V_192 ;
break;
...
static int F_221 ( struct V_343 * args ,
const char * * V_124 )
{
struct V_48 * V_17 ;
struct V_118 * V_122 ;
...
int F_222 ( struct V_118 * V_119 ,
const char * * V_124 )
{
struct V_343 args ;
int V_14 ;
V_14 = F_223 ( V_119 , L_115 ,
L_116 , 0 , & args ) ;
if ( V_14 )
return V_14 ;
V_14 = F_221 ( & args , V_124 ) ;
F_224 ( args . V_311 ) ;
return V_14 ;
}
int F_225 ( struct V_22 * V_23 ,
struct V_118 * V_119 ,
struct V_126 * V_71 )
{
struct V_343 args ;
...
V_223 < V_71 -> V_87 ;
V_223 ++ , V_49 ++ ) {
V_14 = F_223 ( V_119 , V_53 ,
L_116 ,
V_223 , & args ) ;
if ( V_14 )
goto V_138;
V_49 -> V_119 = args . V_311 ;
V_14 = F_221 ( & args , & V_49 -> V_124 ) ;
if ( V_14 < 0 )
goto V_138;
}
return 0 ;
