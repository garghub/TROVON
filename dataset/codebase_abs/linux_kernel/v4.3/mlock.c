...
static int F_70 ( unsigned long V_35 , T_5 V_65 , int V_66 )
{
unsigned long V_67 , V_36 , V_68 ;
...
if ( V_68 > V_36 )
V_68 = V_36 ;
error = F_64 ( V_33 , & V_49 , V_67 , V_68 , V_50 ) ;
if ( error )
break;
V_67 = V_68 ;
if ( V_67 < V_49 -> V_63 )
...
if ( V_73 == V_74 )
goto V_18;
for ( V_33 = V_56 -> V_52 -> V_76 ; V_33 ; V_33 = V_49 -> V_72 ) {
T_3 V_50 ;
V_50 = V_33 -> V_41 & ~ V_42 ;
if ( V_73 & V_77 )
V_50 |= V_42 ;
F_64 ( V_33 , & V_49 , V_33 -> V_58 , V_33 -> V_63 , V_50 ) ;
F_74 () ;
}
V_18:
return 0 ;
}
int F_75 ( T_5 V_78 , struct V_79 * V_80 )
{
unsigned long V_81 , V_82 ;
int V_83 = 0 ;
V_82 = ( V_78 + V_40 - 1 ) >> V_48 ;
V_81 = F_2 ( V_1 ) ;
if ( V_81 == V_84 )
V_83 = 1 ;
V_81 >>= V_48 ;
...
void F_79 ( T_5 V_78 , struct V_79 * V_80 )
{
F_76 ( & V_85 ) ;
V_80 -> V_86 -= ( V_78 + V_40 - 1 ) >> V_48 ;
F_78 ( & V_85 ) ;
F_80 ( V_80 ) ;
}
