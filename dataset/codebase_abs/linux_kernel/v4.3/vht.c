...
T_1 V_112 = 0 ;
T_4 V_113 ;
V_42 = V_110 -> V_114 . V_115 -> V_116 [ V_107 ] ;
if ( V_105 & V_117 )
return 0 ;
V_113 = V_105 & V_118 ;
V_113 >>= V_119 ;
V_113 += 1 ;
if ( V_46 -> V_46 . V_102 != V_113 ) {
V_46 -> V_46 . V_102 = V_113 ;
V_112 |= V_120 ;
}
if ( V_108 )
return V_112 ;
...
V_111 = F_9 ( V_46 ) ;
if ( V_111 != V_46 -> V_46 . V_81 ) {
V_46 -> V_46 . V_81 = V_111 ;
V_112 |= V_126 ;
}
return V_112 ;
}
...
{
struct V_109 * V_110 = V_2 -> V_110 ;
struct V_41 * V_42 = V_110 -> V_114 . V_115 -> V_116 [ V_107 ] ;
T_1 V_112 = F_17 ( V_2 , V_46 , V_105 ,
V_107 , V_108 ) ;
if ( V_112 > 0 )
F_19 ( V_110 , V_42 , V_46 , V_112 ) ;
}
void F_20 ( T_5 V_4 ,
T_3 V_127 [ V_128 ] )
{
int V_13 ;
T_3 V_129 , V_12 = F_5 ( V_4 ) ;
for ( V_13 = 0 ; V_13 < V_128 ; V_13 ++ ) {
V_129 = ( V_12 >> V_13 * 2 ) & V_40 ;
switch ( V_129 ) {
case V_130 :
V_127 [ V_13 ] = 0x00FF ;
break;
