...
V_383 = V_393 ;
V_443 = F_193 ( V_6 , & V_151 -> V_379 . V_118 , V_383 ) ;
if ( V_443 -> V_444 == V_445 )
V_443 -> V_444 = V_446 ;
V_262 = F_194 ( V_6 , & V_151 -> V_379 . V_118 ,
V_383 , V_436 ,
V_447 ,
V_448 ) ;
}
...
V_226 = V_289 ;
else if ( F_196 ( V_262 ) == - V_449 )
V_226 = V_302 ;
else if ( F_196 ( V_262 ) == - V_450 )
V_226 = V_303 ;
else
V_226 = V_451 ;
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_428 ,
...
F_34 ( V_6 ) ;
if ( ! F_42 ( V_6 ) ) {
V_30 = F_110 ( V_15 , V_6 -> V_55 , V_452 ,
V_313 ) ;
goto V_306;
}
...
V_155 -> V_299 ( V_155 , V_453 ) ;
F_120 ( V_155 ) ;
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_452 , 0 ,
V_379 , sizeof( * V_379 ) ) ;
V_306:
F_35 ( V_6 ) ;
return V_30 ;
...
V_151 . V_455 = V_455 ;
V_30 = F_141 ( V_6 , V_454 , sizeof( V_151 ) , & V_151 ) ;
} else
V_30 = F_141 ( V_6 , V_454 , sizeof( V_379 -> V_118 ) ,
& V_379 -> V_118 ) ;
if ( V_30 < 0 )
F_120 ( V_155 ) ;
V_456:
...
T_2 V_8 )
{
struct V_459 * V_151 = V_7 ;
F_9 ( L_5 ) ;
if ( V_8 != sizeof( * V_151 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_460 ,
V_288 ) ;
return F_200 ( V_15 , V_6 , & V_151 -> V_379 ,
V_460 ,
V_461 , 0 ) ;
...
F_56 ( V_149 , V_471 , sizeof( V_151 ) , & V_151 ) ;
}
...
F_9 ( L_8 , V_226 ) ;
F_34 ( V_6 ) ;
V_155 = F_47 ( V_473 , V_6 ) ;
if ( ! V_155 )
goto V_306;
V_151 = V_155 -> V_158 ;
if ( V_226 )
F_110 ( V_155 -> V_15 , V_6 -> V_55 , V_473 ,
F_1 ( V_226 ) ) ;
else
F_11 ( V_155 -> V_15 , V_6 -> V_55 , V_473 , 0 ,
V_151 , sizeof( * V_151 ) ) ;
F_120 ( V_155 ) ;
V_306:
F_35 ( V_6 ) ;
...
sizeof( V_6 -> V_224 ) ) ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_473 , 0 ,
V_7 , V_8 ) ;
goto V_290;
}
...
V_155 = F_111 ( V_15 , V_473 , V_6 , V_7 , V_8 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_290;
}
...
T_2 V_37 , struct V_475 * V_476 )
{
struct V_477 V_478 ;
T_3 V_28 = sizeof( V_478 ) ;
struct V_133 * V_155 ;
F_9 ( L_16 , V_6 -> V_79 , V_226 ) ;
V_155 = F_47 ( V_479 , V_6 ) ;
if ( ! V_155 )
return;
if ( V_226 || ! V_476 ) {
F_110 ( V_155 -> V_15 , V_6 -> V_55 , V_479 ,
V_226 ? F_1 ( V_226 ) : V_3 ) ;
goto remove;
}
memset ( & V_478 , 0 , sizeof( V_478 ) ) ;
if ( V_37 == V_480 ) {
struct V_481 * V_18 = ( void * ) V_476 -> V_7 ;
if ( V_476 -> V_8 < sizeof( * V_18 ) ) {
F_110 ( V_155 -> V_15 , V_6 -> V_55 ,
V_479 ,
V_3 ) ;
goto remove;
}
memcpy ( V_478 . V_482 , V_18 -> V_483 , sizeof( V_18 -> V_483 ) ) ;
memcpy ( V_478 . V_484 , V_18 -> rand , sizeof( V_18 -> rand ) ) ;
V_28 -= sizeof( V_478 . V_485 ) + sizeof( V_478 . V_486 ) ;
} else {
struct V_487 * V_18 = ( void * ) V_476 -> V_7 ;
if ( V_476 -> V_8 < sizeof( * V_18 ) ) {
F_110 ( V_155 -> V_15 , V_6 -> V_55 ,
V_479 ,
V_3 ) ;
...
memcpy ( V_478 . V_482 , V_18 -> V_482 , sizeof( V_18 -> V_482 ) ) ;
memcpy ( V_478 . V_484 , V_18 -> V_484 , sizeof( V_18 -> V_484 ) ) ;
memcpy ( V_478 . V_485 , V_18 -> V_485 , sizeof( V_18 -> V_485 ) ) ;
memcpy ( V_478 . V_486 , V_18 -> V_486 , sizeof( V_18 -> V_486 ) ) ;
}
F_11 ( V_155 -> V_15 , V_6 -> V_55 , V_479 ,
V_304 , & V_478 , V_28 ) ;
remove:
F_120 ( V_155 ) ;
}
...
F_34 ( V_6 ) ;
if ( ! F_42 ( V_6 ) ) {
V_30 = F_110 ( V_15 , V_6 -> V_55 , V_479 ,
V_313 ) ;
goto V_306;
}
if ( ! F_38 ( V_6 ) ) {
...
V_155 = F_111 ( V_15 , V_479 , V_6 , NULL , 0 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_306;
}
F_66 ( & V_149 , V_6 ) ;
if ( F_212 ( V_6 ) )
F_56 ( & V_149 , V_488 , 0 , NULL ) ;
else
F_56 ( & V_149 , V_480 , 0 , NULL ) ;
...
struct V_493 * V_151 = V_7 ;
T_1 * V_484 , * V_482 , * V_486 , * V_485 ;
T_1 V_226 ;
if ( F_216 ( V_151 -> V_379 . type ) ) {
if ( memcmp ( V_151 -> V_484 , V_494 , 16 ) ||
memcmp ( V_151 -> V_482 , V_494 , 16 ) ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 ,
V_489 ,
V_288 ,
V_379 , sizeof( * V_379 ) ) ;
...
if ( ! memcmp ( V_151 -> V_486 , V_494 , 16 ) ||
! memcmp ( V_151 -> V_485 , V_494 , 16 ) ) {
V_486 = NULL ;
V_485 = NULL ;
} else {
V_486 = V_151 -> V_486 ;
...
F_165 ( L_18 , V_8 ) ;
V_30 = F_110 ( V_15 , V_6 -> V_55 , V_489 ,
V_288 ) ;
}
V_306:
F_35 ( V_6 ) ;
...
F_221 ( V_6 ) ;
memset ( & V_151 , 0 , sizeof( V_151 ) ) ;
memcpy ( & V_151 . V_498 , V_498 , sizeof( V_151 . V_498 ) ) ;
V_151 . V_153 = V_499 ;
F_56 ( V_149 , V_500 , sizeof( V_151 ) , & V_151 ) ;
return true ;
}
...
V_502 . type = V_505 ;
V_502 . V_325 = F_10 ( V_325 ) ;
V_502 . V_327 = F_10 ( V_506 ) ;
V_502 . V_212 = V_201 ;
F_56 ( V_149 , V_507 , sizeof( V_502 ) ,
& V_502 ) ;
memset ( & V_504 , 0 , sizeof( V_504 ) ) ;
V_504 . V_198 = V_508 ;
V_504 . V_509 = V_510 ;
F_56 ( V_149 , V_511 , sizeof( V_504 ) ,
& V_504 ) ;
return true ;
}
...
F_9 ( L_19 , V_226 ) ;
F_34 ( V_6 ) ;
V_155 = F_47 ( V_517 , V_6 ) ;
if ( ! V_155 )
V_155 = F_47 ( V_518 , V_6 ) ;
if ( V_155 ) {
V_155 -> V_299 ( V_155 , F_1 ( V_226 ) ) ;
F_120 ( V_155 ) ;
}
...
break;
case V_513 :
if ( F_22 ( V_514 , & V_6 -> V_53 ) )
V_248 = F_100 ( V_520 ) ;
else
V_248 = F_100 ( V_6 -> V_521 ) ;
break;
case V_512 :
V_248 = 0 ;
break;
...
& V_6 -> V_53 ) &&
V_6 -> V_232 . V_523 ) {
V_6 -> V_232 . V_524 = V_525 ;
V_6 -> V_232 . V_526 = V_248 ;
}
F_99 ( V_6 -> V_255 ,
& V_6 -> V_238 , V_248 ) ;
}
...
F_34 ( V_6 ) ;
if ( ! F_42 ( V_6 ) ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_517 ,
V_313 ,
& V_151 -> type , sizeof( V_151 -> type ) ) ;
goto V_290;
}
if ( V_6 -> V_232 . V_233 != V_519 ||
F_20 ( V_6 , V_528 ) ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_517 ,
V_289 , & V_151 -> type ,
sizeof( V_151 -> type ) ) ;
...
V_155 = F_111 ( V_15 , V_517 , V_6 , V_7 , V_8 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_290;
}
...
void * V_7 , T_2 V_8 )
{
struct V_531 * V_151 = V_7 ;
struct V_133 * V_155 ;
struct V_148 V_149 ;
const T_2 V_532 = ( ( V_371 - sizeof( * V_151 ) ) / 16 ) ;
T_2 V_533 , V_374 ;
T_1 V_226 ;
int V_30 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
...
V_155 -> V_299 = F_228 ;
F_227 ( V_6 ) ;
V_6 -> V_232 . V_523 = true ;
V_6 -> V_232 . type = V_151 -> type ;
V_6 -> V_232 . V_534 = V_151 -> V_534 ;
V_6 -> V_232 . V_533 = V_533 ;
if ( V_533 > 0 ) {
V_6 -> V_232 . V_360 = F_230 ( V_151 -> V_360 , V_533 * 16 ,
V_35 ) ;
if ( ! V_6 -> V_232 . V_360 ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 ,
V_518 ,
...
F_34 ( V_6 ) ;
if ( ! F_233 ( V_6 ) ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_535 ,
V_303 , & V_537 -> type ,
sizeof( V_537 -> type ) ) ;
goto V_306;
}
if ( V_6 -> V_232 . type != V_537 -> type ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_535 ,
V_288 ,
& V_537 -> type , sizeof( V_537 -> type ) ) ;
goto V_306;
}
V_155 = F_111 ( V_15 , V_535 , V_6 , V_7 , V_8 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_306;
}
...
F_120 ( V_155 ) ;
if ( V_30 == - V_294 ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_535 , 0 ,
& V_537 -> type , sizeof( V_537 -> type ) ) ;
F_108 ( V_6 , V_519 ) ;
}
V_306:
...
T_2 V_8 )
{
struct V_538 * V_151 = V_7 ;
struct V_230 * V_231 ;
int V_30 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
F_34 ( V_6 ) ;
if ( ! F_233 ( V_6 ) ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_539 ,
V_3 , & V_151 -> V_379 ,
sizeof( V_151 -> V_379 ) ) ;
goto V_290;
}
...
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_539 , 0 ,
& V_151 -> V_379 , sizeof( V_151 -> V_379 ) ) ;
V_290:
F_35 ( V_6 ) ;
return V_30 ;
...
T_2 V_8 )
{
struct V_544 * V_151 = V_7 ;
T_1 V_226 ;
int V_30 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
if ( ! F_170 ( V_151 -> V_379 . type ) )
return F_11 ( V_15 , V_6 -> V_55 , V_545 ,
V_288 ,
& V_151 -> V_379 , sizeof( V_151 -> V_379 ) ) ;
F_34 ( V_6 ) ;
V_30 = F_238 ( & V_6 -> V_546 , & V_151 -> V_379 . V_118 ,
V_151 -> V_379 . type ) ;
if ( V_30 < 0 ) {
V_226 = V_3 ;
goto V_456;
}
F_7 ( V_547 , V_6 , & V_151 -> V_379 , sizeof( V_151 -> V_379 ) ,
V_15 ) ;
V_226 = V_304 ;
V_456:
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_545 , V_226 ,
& V_151 -> V_379 , sizeof( V_151 -> V_379 ) ) ;
F_35 ( V_6 ) ;
return V_30 ;
}
...
T_2 V_8 )
{
struct V_548 * V_151 = V_7 ;
T_1 V_226 ;
int V_30 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
if ( ! F_170 ( V_151 -> V_379 . type ) )
return F_11 ( V_15 , V_6 -> V_55 , V_549 ,
V_288 ,
& V_151 -> V_379 , sizeof( V_151 -> V_379 ) ) ;
F_34 ( V_6 ) ;
V_30 = F_240 ( & V_6 -> V_546 , & V_151 -> V_379 . V_118 ,
V_151 -> V_379 . type ) ;
if ( V_30 < 0 ) {
V_226 = V_288 ;
goto V_456;
}
F_7 ( V_550 , V_6 , & V_151 -> V_379 , sizeof( V_151 -> V_379 ) ,
V_15 ) ;
V_226 = V_304 ;
V_456:
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_549 , V_226 ,
& V_151 -> V_379 , sizeof( V_151 -> V_379 ) ) ;
F_35 ( V_6 ) ;
return V_30 ;
}
...
T_2 V_8 )
{
struct V_551 * V_151 = V_7 ;
struct V_148 V_149 ;
int V_30 ;
T_9 V_552 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
V_552 = F_129 ( V_151 -> V_552 ) ;
if ( V_552 > 0x0002 )
return F_110 ( V_15 , V_6 -> V_55 , V_553 ,
V_288 ) ;
F_34 ( V_6 ) ;
V_6 -> V_182 = V_552 ;
V_6 -> V_184 = F_129 ( V_151 -> V_554 ) ;
V_6 -> V_185 = F_129 ( V_151 -> V_555 ) ;
V_6 -> V_186 = F_129 ( V_151 -> V_19 ) ;
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_553 , 0 ,
NULL , 0 ) ;
F_66 ( & V_149 , V_6 ) ;
F_69 ( & V_149 ) ;
F_67 ( & V_149 , NULL ) ;
...
void * V_7 , T_2 V_8 )
{
struct V_557 * V_151 = V_7 ;
int V_30 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
if ( ! F_40 ( V_6 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_558 ,
V_302 ) ;
if ( F_42 ( V_6 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_558 ,
V_303 ) ;
if ( F_28 ( & V_151 -> V_118 , V_72 ) ) {
if ( ! F_28 ( & V_151 -> V_118 , V_559 ) )
return F_110 ( V_15 , V_6 -> V_55 ,
V_558 ,
V_288 ) ;
if ( ( V_151 -> V_118 . V_560 [ 5 ] & 0xc0 ) != 0xc0 )
return F_110 ( V_15 , V_6 -> V_55 ,
V_558 ,
V_288 ) ;
}
...
V_6 -> V_563 = V_325 ;
V_6 -> V_564 = V_327 ;
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_562 , 0 ,
NULL , 0 ) ;
if ( F_20 ( V_6 , V_237 ) &&
V_6 -> V_232 . V_233 == V_519 ) {
struct V_148 V_149 ;
F_66 ( & V_149 , V_6 ) ;
F_94 ( & V_149 ) ;
F_248 ( & V_149 ) ;
...
F_9 ( L_8 , V_226 ) ;
F_34 ( V_6 ) ;
V_155 = F_47 ( V_565 , V_6 ) ;
if ( ! V_155 )
goto V_306;
if ( V_226 ) {
F_110 ( V_155 -> V_15 , V_6 -> V_55 , V_565 ,
F_1 ( V_226 ) ) ;
} else {
struct V_157 * V_151 = V_155 -> V_158 ;
if ( V_151 -> V_159 )
...
if ( ! F_20 ( V_6 , V_108 ) ||
V_6 -> V_91 < V_92 )
return F_110 ( V_15 , V_6 -> V_55 , V_565 ,
V_302 ) ;
if ( V_151 -> V_159 != 0x00 && V_151 -> V_159 != 0x01 )
return F_110 ( V_15 , V_6 -> V_55 , V_565 ,
V_288 ) ;
F_34 ( V_6 ) ;
if ( F_47 ( V_565 , V_6 ) ) {
V_30 = F_110 ( V_15 , V_6 -> V_55 , V_565 ,
V_289 ) ;
goto V_306;
}
if ( ! ! V_151 -> V_159 == F_20 ( V_6 , V_105 ) ) {
V_30 = F_88 ( V_15 , V_565 ,
V_6 ) ;
goto V_306;
}
if ( ! F_42 ( V_6 ) ) {
...
if ( ! V_151 -> V_159 ) {
V_30 = F_110 ( V_15 , V_6 -> V_55 , V_566 ,
V_303 ) ;
goto V_306;
} else {
if ( ! F_20 ( V_6 , V_108 ) &&
...
V_155 = F_111 ( V_15 , V_566 , V_6 , V_7 , V_8 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_306;
}
...
if ( ! F_39 ( V_6 ) &&
! F_20 ( V_6 , V_109 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_567 ,
V_302 ) ;
if ( F_20 ( V_6 , V_108 ) &&
F_39 ( V_6 ) &&
! F_20 ( V_6 , V_111 ) )
...
if ( F_47 ( V_567 , V_6 ) ) {
V_30 = F_110 ( V_15 , V_6 -> V_55 , V_567 ,
V_289 ) ;
goto V_290;
}
V_159 = ! ! V_151 -> V_159 ;
if ( V_159 == F_20 ( V_6 , V_114 ) &&
( V_151 -> V_159 == 0x02 ) == F_20 ( V_6 , V_568 ) ) {
V_30 = F_88 ( V_15 , V_567 , V_6 ) ;
goto V_290;
}
V_155 = F_111 ( V_15 , V_567 , V_6 , V_7 , V_8 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_290;
}
F_66 ( & V_149 , V_6 ) ;
F_56 ( & V_149 , V_569 , 1 , & V_159 ) ;
...
F_9 ( L_7 , V_6 -> V_79 ) ;
if ( V_151 -> V_159 != 0x00 && V_151 -> V_159 != 0x01 && V_151 -> V_159 != 0x02 )
return F_110 ( V_15 , V_6 -> V_55 , V_571 ,
V_288 ) ;
F_34 ( V_6 ) ;
if ( V_151 -> V_159 )
V_305 = ! F_84 ( V_6 , V_115 ) ;
...
if ( F_42 ( V_6 ) && V_570 &&
F_20 ( V_6 , V_111 ) ) {
T_1 V_572 = ( V_151 -> V_159 == 0x02 ) ? 0x01 : 0x00 ;
F_141 ( V_6 , V_344 ,
sizeof( V_572 ) , & V_572 ) ;
}
V_30 = F_88 ( V_15 , V_571 , V_6 ) ;
if ( V_30 < 0 )
goto V_306;
if ( V_305 )
V_30 = F_113 ( V_6 , V_15 ) ;
...
static int F_256 ( struct V_11 * V_15 , struct V_5 * V_6 , void * V_573 ,
T_2 V_8 )
{
struct V_574 * V_151 = V_573 ;
bool V_305 ;
int V_30 ;
F_9 ( L_7 , V_6 -> V_79 ) ;
if ( ! F_40 ( V_6 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_575 ,
V_302 ) ;
if ( V_151 -> V_576 != 0x00 && V_151 -> V_576 != 0x01 )
return F_110 ( V_15 , V_6 -> V_55 , V_575 ,
V_288 ) ;
if ( F_42 ( V_6 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_575 ,
...
memcpy ( V_6 -> V_578 , V_151 -> V_578 , sizeof( V_6 -> V_578 ) ) ;
F_82 ( V_6 , V_219 ) ;
} else {
V_305 = F_80 ( V_6 , V_116 ) ;
memset ( V_6 -> V_578 , 0 , sizeof( V_6 -> V_578 ) ) ;
F_76 ( V_6 , V_219 ) ;
}
V_30 = F_88 ( V_15 , V_575 , V_6 ) ;
if ( V_30 < 0 )
goto V_306;
if ( V_305 )
V_30 = F_113 ( V_6 , V_15 ) ;
...
static bool F_257 ( struct V_579 * V_578 )
{
switch ( V_578 -> V_379 . type ) {
case V_391 :
return true ;
case V_404 :
if ( ( V_578 -> V_379 . V_118 . V_560 [ 5 ] & 0xc0 ) != 0xc0 )
return false ;
return true ;
}
return false ;
}
static int F_258 ( struct V_11 * V_15 , struct V_5 * V_6 , void * V_573 ,
T_2 V_8 )
{
struct V_580 * V_151 = V_573 ;
const T_2 V_581 = ( ( V_371 - sizeof( * V_151 ) ) /
sizeof( struct V_579 ) ) ;
T_2 V_582 , V_374 ;
int V_29 , V_30 ;
F_9 ( L_7 , V_6 -> V_79 ) ;
...
V_302 ) ;
V_582 = F_129 ( V_151 -> V_582 ) ;
if ( V_582 > V_581 ) {
F_165 ( L_24 , V_582 ) ;
return F_110 ( V_15 , V_6 -> V_55 , V_583 ,
V_288 ) ;
}
V_374 = sizeof( * V_151 ) + V_582 * sizeof( struct V_579 ) ;
if ( V_374 != V_8 ) {
F_165 ( L_25 ,
V_374 , V_8 ) ;
return F_110 ( V_15 , V_6 -> V_55 , V_583 ,
...
F_9 ( L_26 , V_6 -> V_79 , V_582 ) ;
for ( V_29 = 0 ; V_29 < V_582 ; V_29 ++ ) {
struct V_579 * V_377 = & V_151 -> V_584 [ V_29 ] ;
if ( ! F_257 ( V_377 ) )
return F_110 ( V_15 , V_6 -> V_55 ,
V_583 ,
V_288 ) ;
...
F_259 ( V_6 ) ;
for ( V_29 = 0 ; V_29 < V_582 ; V_29 ++ ) {
struct V_579 * V_578 = & V_151 -> V_584 [ V_29 ] ;
T_1 V_383 ;
if ( V_578 -> V_379 . type == V_391 )
V_383 = V_392 ;
else
V_383 = V_393 ;
F_260 ( V_6 , & V_578 -> V_379 . V_118 , V_383 , V_578 -> V_159 ,
V_72 ) ;
}
F_82 ( V_6 , V_577 ) ;
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_583 , 0 , NULL , 0 ) ;
F_35 ( V_6 ) ;
return V_30 ;
}
static bool F_261 ( struct V_585 * V_377 )
{
if ( V_377 -> V_586 != 0x00 && V_377 -> V_586 != 0x01 )
return false ;
switch ( V_377 -> V_379 . type ) {
case V_391 :
return true ;
case V_404 :
if ( ( V_377 -> V_379 . V_118 . V_560 [ 5 ] & 0xc0 ) != 0xc0 )
return false ;
return true ;
}
return false ;
...
F_9 ( L_7 , V_6 -> V_79 ) ;
if ( ! F_40 ( V_6 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_588 ,
V_302 ) ;
V_373 = F_129 ( V_151 -> V_373 ) ;
if ( V_373 > V_370 ) {
F_165 ( L_27 , V_373 ) ;
...
for ( V_29 = 0 ; V_29 < V_373 ; V_29 ++ ) {
struct V_585 * V_377 = & V_151 -> V_378 [ V_29 ] ;
if ( ! F_261 ( V_377 ) )
return F_110 ( V_15 , V_6 -> V_55 ,
V_588 ,
V_288 ) ;
...
V_589 , V_377 -> V_159 , V_377 -> V_599 , V_377 -> V_600 ,
V_377 -> rand ) ;
}
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_588 , 0 ,
NULL , 0 ) ;
F_35 ( V_6 ) ;
return V_30 ;
}
...
if ( V_226 == V_304 ) {
V_18 . V_534 = V_262 -> V_534 ;
V_18 . V_602 = V_262 -> V_602 ;
V_18 . V_603 = V_262 -> V_603 ;
} else {
V_18 . V_534 = V_604 ;
V_18 . V_602 = V_177 ;
V_18 . V_603 = V_177 ;
}
V_30 = F_11 ( V_155 -> V_15 , V_155 -> V_54 , V_605 ,
V_226 , & V_18 , sizeof( V_18 ) ) ;
F_184 ( V_262 ) ;
F_186 ( V_262 ) ;
return V_30 ;
...
F_9 ( L_8 , V_1 ) ;
F_34 ( V_6 ) ;
V_151 = F_267 ( V_6 , V_607 ) ;
if ( ! V_151 ) {
V_151 = F_267 ( V_6 , V_608 ) ;
V_226 = V_304 ;
} else {
V_226 = F_1 ( V_1 ) ;
}
...
V_18 . V_379 . type = V_151 -> V_379 . type ;
if ( ! F_170 ( V_151 -> V_379 . type ) )
return F_11 ( V_15 , V_6 -> V_55 , V_605 ,
V_288 ,
& V_18 , sizeof( V_18 ) ) ;
F_34 ( V_6 ) ;
if ( ! F_42 ( V_6 ) ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_605 ,
V_313 , & V_18 ,
sizeof( V_18 ) ) ;
goto V_306;
}
...
struct V_133 * V_155 ;
F_66 ( & V_149 , V_6 ) ;
V_616 . V_274 = F_10 ( V_262 -> V_274 ) ;
F_56 ( & V_149 , V_607 , sizeof( V_616 ) ,
& V_616 ) ;
if ( ! F_216 ( V_151 -> V_379 . type ) ||
V_262 -> V_602 == V_177 ) {
V_615 . V_274 = F_10 ( V_262 -> V_274 ) ;
V_615 . type = 0x00 ;
F_56 ( & V_149 , V_608 ,
sizeof( V_615 ) , & V_615 ) ;
}
if ( V_262 -> V_603 == V_177 ) {
V_615 . V_274 = F_10 ( V_262 -> V_274 ) ;
V_615 . type = 0x01 ;
F_56 ( & V_149 , V_608 ,
sizeof( V_615 ) , & V_615 ) ;
...
if ( V_6 ) {
V_18 . V_618 = F_30 ( V_6 -> clock ) ;
F_275 ( V_6 ) ;
}
if ( V_262 ) {
V_18 . V_619 = F_30 ( V_262 -> clock ) ;
V_18 . V_620 = F_10 ( V_262 -> V_621 ) ;
}
V_434:
...
V_18 . V_379 . type = V_151 -> V_379 . type ;
if ( V_151 -> V_379 . type != V_380 )
return F_11 ( V_15 , V_6 -> V_55 , V_625 ,
V_288 ,
& V_18 , sizeof( V_18 ) ) ;
F_34 ( V_6 ) ;
if ( ! F_42 ( V_6 ) ) {
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_625 ,
V_313 , & V_18 ,
sizeof( V_18 ) ) ;
goto V_306;
}
...
V_155 = F_111 ( V_15 , V_625 , V_6 , V_7 , V_8 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_306;
}
...
F_66 ( & V_149 , V_6 ) ;
memset ( & V_317 , 0 , sizeof( V_317 ) ) ;
F_56 ( & V_149 , V_623 , sizeof( V_317 ) , & V_317 ) ;
if ( V_262 ) {
F_272 ( V_262 ) ;
V_155 -> V_429 = F_197 ( V_262 ) ;
...
struct V_5 * V_6 = V_149 -> V_6 ;
struct V_442 * V_627 ;
V_627 = F_193 ( V_6 , V_379 , V_383 ) ;
if ( ! V_627 )
return - V_628 ;
if ( V_627 -> V_444 == V_444 )
return 0 ;
F_280 ( & V_627 -> V_629 ) ;
switch ( V_444 ) {
case V_446 :
...
T_8 * V_118 , T_1 type , T_1 V_629 )
{
struct V_637 V_243 ;
F_87 ( & V_243 . V_379 . V_118 , V_118 ) ;
V_243 . V_379 . type = type ;
V_243 . V_629 = V_629 ;
F_7 ( V_638 , V_6 , & V_243 , sizeof( V_243 ) , V_15 ) ;
}
...
return F_11 ( V_15 , V_6 -> V_55 , V_639 ,
V_288 ,
& V_151 -> V_379 , sizeof( V_151 -> V_379 ) ) ;
if ( V_151 -> V_629 != 0x00 && V_151 -> V_629 != 0x01 && V_151 -> V_629 != 0x02 )
return F_11 ( V_15 , V_6 -> V_55 , V_639 ,
V_288 ,
& V_151 -> V_379 , sizeof( V_151 -> V_379 ) ) ;
F_66 ( & V_149 , V_6 ) ;
F_34 ( V_6 ) ;
V_155 = F_111 ( V_15 , V_639 , V_6 , V_7 , V_8 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_306;
}
...
if ( V_151 -> V_629 == 0x02 )
V_641 = V_636 ;
else if ( V_151 -> V_629 == 0x01 )
V_641 = V_635 ;
else
V_641 = V_633 ;
if ( ! F_285 ( & V_151 -> V_379 . V_118 , V_383 ) ) {
V_30 = V_155 -> V_299 ( V_155 , V_288 ) ;
F_120 ( V_155 ) ;
goto V_306;
}
...
V_642:
F_282 ( V_15 , V_6 , & V_151 -> V_379 . V_118 , V_151 -> V_379 . type , V_151 -> V_629 ) ;
...
static void F_286 ( struct V_11 * V_15 , struct V_5 * V_6 ,
T_8 * V_118 , T_1 type )
{
struct V_643 V_243 ;
F_87 ( & V_243 . V_379 . V_118 , V_118 ) ;
V_243 . V_379 . type = type ;
F_7 ( V_644 , V_6 , & V_243 , sizeof( V_243 ) , V_15 ) ;
}
static void F_287 ( struct V_5 * V_6 , T_1 V_226 , T_2 V_37 )
{
struct V_133 * V_155 ;
F_9 ( L_8 , V_226 ) ;
F_34 ( V_6 ) ;
V_155 = F_47 ( V_645 , V_6 ) ;
if ( ! V_155 )
goto V_306;
V_155 -> V_299 ( V_155 , F_1 ( V_226 ) ) ;
F_120 ( V_155 ) ;
...
static int F_288 ( struct V_11 * V_15 , struct V_5 * V_6 ,
void * V_7 , T_2 V_8 )
{
struct V_646 * V_151 = V_7 ;
struct V_133 * V_155 ;
struct V_148 V_149 ;
int V_30 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
F_66 ( & V_149 , V_6 ) ;
F_34 ( V_6 ) ;
V_155 = F_111 ( V_15 , V_645 , V_6 , V_7 , V_8 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_306;
}
...
F_127 ( & V_149 ) ;
F_286 ( V_15 , V_6 , & V_151 -> V_379 . V_118 ,
V_151 -> V_379 . type ) ;
goto V_434;
}
if ( V_151 -> V_379 . type == V_391 )
...
V_627 = F_289 ( V_6 , & V_151 -> V_379 . V_118 ,
V_383 ) ;
if ( ! V_627 ) {
V_30 = V_155 -> V_299 ( V_155 ,
V_288 ) ;
...
F_16 ( V_627 ) ;
F_147 ( & V_149 ) ;
F_286 ( V_15 , V_6 , & V_151 -> V_379 . V_118 , V_151 -> V_379 . type ) ;
} else {
struct V_442 * V_443 , * V_363 ;
struct V_647 * V_560 , * V_648 ;
if ( V_151 -> V_379 . type ) {
V_30 = V_155 -> V_299 ( V_155 ,
V_288 ) ;
F_120 ( V_155 ) ;
...
F_286 ( V_15 , V_6 , & V_560 -> V_118 , V_560 -> V_649 ) ;
F_116 ( & V_560 -> V_298 ) ;
F_16 ( V_560 ) ;
}
F_127 ( & V_149 ) ;
F_104 (p, tmp, &hdev->le_conn_params, list) {
if ( V_443 -> V_444 == V_446 )
continue;
F_286 ( V_15 , V_6 , & V_443 -> V_379 , V_443 -> V_383 ) ;
if ( V_443 -> V_631 ) {
V_443 -> V_444 = V_445 ;
continue;
}
...
static int F_290 ( struct V_11 * V_15 , struct V_5 * V_6 , void * V_7 ,
T_2 V_8 )
{
struct V_650 * V_151 = V_7 ;
const T_2 V_651 = ( ( V_371 - sizeof( * V_151 ) ) /
sizeof( struct V_652 ) ) ;
T_2 V_653 , V_374 ;
int V_29 ;
if ( ! F_40 ( V_6 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_654 ,
V_302 ) ;
V_653 = F_129 ( V_151 -> V_653 ) ;
if ( V_653 > V_651 ) {
F_165 ( L_34 ,
V_653 ) ;
return F_110 ( V_15 , V_6 -> V_55 , V_654 ,
...
F_9 ( L_36 , V_6 -> V_79 , V_653 ) ;
F_34 ( V_6 ) ;
F_291 ( V_6 ) ;
for ( V_29 = 0 ; V_29 < V_653 ; V_29 ++ ) {
struct V_652 * V_158 = & V_151 -> V_627 [ V_29 ] ;
struct V_442 * V_655 ;
T_2 V_656 , V_657 , V_658 , V_248 ;
T_1 V_383 ;
...
V_656 = F_292 ( V_158 -> V_205 ) ;
V_657 = F_292 ( V_158 -> V_207 ) ;
V_658 = F_292 ( V_158 -> V_658 ) ;
V_248 = F_292 ( V_158 -> V_248 ) ;
F_9 ( L_39 ,
V_656 , V_657 , V_658 , V_248 ) ;
if ( F_293 ( V_656 , V_657 , V_658 , V_248 ) < 0 ) {
F_165 ( L_38 ) ;
continue;
}
V_655 = F_193 ( V_6 , & V_158 -> V_379 . V_118 ,
V_383 ) ;
if ( ! V_655 ) {
F_165 ( L_40 ) ;
continue;
...
F_35 ( V_6 ) ;
return F_11 ( V_15 , V_6 -> V_55 , V_654 , 0 ,
NULL , 0 ) ;
}
static int F_294 ( struct V_11 * V_15 , struct V_5 * V_6 ,
void * V_7 , T_2 V_8 )
{
struct V_663 * V_151 = V_7 ;
bool V_305 ;
int V_30 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
if ( F_42 ( V_6 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_664 ,
V_303 ) ;
if ( V_151 -> V_665 != 0x00 && V_151 -> V_665 != 0x01 )
return F_110 ( V_15 , V_6 -> V_55 , V_664 ,
V_288 ) ;
if ( ! F_22 ( V_68 , & V_6 -> V_53 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_664 ,
...
static int F_298 ( struct V_11 * V_15 , struct V_5 * V_6 ,
void * V_7 , T_2 V_8 )
{
struct V_667 * V_151 = V_7 ;
bool V_305 ;
int V_30 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
if ( F_42 ( V_6 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_668 ,
V_303 ) ;
if ( ! F_28 ( & V_151 -> V_118 , V_72 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_668 ,
V_288 ) ;
...
static inline T_2 F_299 ( T_1 * V_190 , T_2 V_669 , T_1 type , T_1 * V_7 ,
T_1 V_16 )
{
V_190 [ V_669 ++ ] = sizeof( type ) + V_16 ;
V_190 [ V_669 ++ ] = type ;
memcpy ( & V_190 [ V_669 ] , V_7 , V_16 ) ;
V_669 += V_16 ;
return V_669 ;
}
static void F_300 ( struct V_5 * V_6 , T_1 V_226 ,
T_2 V_37 , struct V_475 * V_476 )
{
const struct V_670 * V_537 ;
struct V_671 * V_478 ;
T_1 * V_672 , * V_673 , * V_674 , * V_675 ;
struct V_133 * V_155 ;
T_2 V_669 ;
int V_30 ;
F_9 ( L_16 , V_6 -> V_79 , V_226 ) ;
V_155 = F_47 ( V_676 , V_6 ) ;
if ( ! V_155 )
return;
V_537 = V_155 -> V_158 ;
if ( V_226 ) {
...
V_478 = F_14 ( sizeof( * V_478 ) + V_669 , V_35 ) ;
if ( ! V_478 )
goto V_456;
if ( V_226 )
goto V_677;
V_669 = F_299 ( V_478 -> V_190 , 0 , V_678 ,
V_6 -> V_196 , 3 ) ;
if ( V_672 && V_673 ) {
V_669 = F_299 ( V_478 -> V_190 , V_669 ,
V_679 , V_672 , 16 ) ;
V_669 = F_299 ( V_478 -> V_190 , V_669 ,
V_680 , V_673 , 16 ) ;
}
...
V_677:
V_478 -> type = V_537 -> type ;
V_478 -> V_669 = F_10 ( V_669 ) ;
V_30 = F_11 ( V_155 -> V_15 , V_6 -> V_55 ,
V_676 , V_226 ,
V_478 , sizeof( * V_478 ) + V_669 ) ;
if ( V_30 < 0 || V_226 )
goto V_456;
F_25 ( V_155 -> V_15 , V_683 ) ;
V_30 = F_5 ( V_684 , V_6 ,
V_478 , sizeof( * V_478 ) + V_669 ,
V_683 , V_155 -> V_15 ) ;
V_456:
...
static int F_301 ( struct V_5 * V_6 , struct V_11 * V_15 ,
struct V_670 * V_151 )
{
struct V_133 * V_155 ;
struct V_148 V_149 ;
int V_30 ;
V_155 = F_111 ( V_15 , V_676 , V_6 ,
V_151 , sizeof( * V_151 ) ) ;
if ( ! V_155 )
return - V_36 ;
F_66 ( & V_149 , V_6 ) ;
...
static int F_302 ( struct V_11 * V_15 , struct V_5 * V_6 ,
void * V_7 , T_2 V_16 )
{
struct V_670 * V_151 = V_7 ;
struct V_671 * V_18 ;
T_3 V_42 ;
T_2 V_669 ;
T_1 V_226 , V_164 , V_685 , V_379 [ 7 ] , V_483 [ 16 ] , rand [ 16 ] ;
int V_30 ;
F_9 ( L_4 , V_6 -> V_79 ) ;
if ( F_42 ( V_6 ) ) {
switch ( V_151 -> type ) {
...
V_669 = F_299 ( V_18 -> V_190 , V_669 , V_686 ,
V_379 , sizeof( V_379 ) ) ;
if ( F_20 ( V_6 , V_113 ) )
V_685 = 0x02 ;
else
V_685 = 0x01 ;
V_669 = F_299 ( V_18 -> V_190 , V_669 , V_687 ,
& V_685 , sizeof( V_685 ) ) ;
if ( F_20 ( V_6 , V_114 ) ) {
V_669 = F_299 ( V_18 -> V_190 , V_669 ,
V_688 ,
...
if ( ! F_20 ( V_6 , V_108 ) )
V_164 |= V_172 ;
V_669 = F_299 ( V_18 -> V_190 , V_669 , V_173 ,
& V_164 , sizeof( V_164 ) ) ;
break;
}
F_35 ( V_6 ) ;
...
V_18 -> V_669 = F_10 ( V_669 ) ;
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_676 ,
V_226 , V_18 , sizeof( * V_18 ) + V_669 ) ;
if ( V_30 < 0 || V_226 )
goto V_456;
V_30 = F_5 ( V_684 , V_6 ,
V_18 , sizeof( * V_18 ) + V_669 ,
V_683 , V_15 ) ;
V_456:
F_16 ( V_18 ) ;
return V_30 ;
}
static T_6 F_305 ( struct V_5 * V_6 )
{
T_6 V_164 = 0 ;
V_164 |= V_168 ;
V_164 |= V_170 ;
...
F_9 ( L_4 , V_6 -> V_79 ) ;
if ( ! F_40 ( V_6 ) )
return F_110 ( V_15 , V_6 -> V_55 , V_692 ,
V_303 ) ;
F_34 ( V_6 ) ;
V_42 = sizeof( * V_18 ) ;
...
V_18 -> V_698 = V_6 -> V_693 ;
} else {
V_18 -> V_698 = 0 ;
}
F_35 ( V_6 ) ;
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_692 ,
V_304 , V_18 , V_42 ) ;
F_16 ( V_18 ) ;
return V_30 ;
}
static bool F_307 ( struct V_5 * V_6 , T_6 V_699 , T_1 * V_7 ,
T_1 V_8 , bool V_700 )
{
T_1 V_139 = V_140 ;
int V_29 , V_701 ;
bool V_702 = false ;
bool V_703 = false ;
T_6 V_704 = V_170 | V_171 |
V_166 ;
if ( V_700 && ( V_699 & V_704 ) ) {
V_702 = true ;
V_139 -= 3 ;
}
if ( V_700 && ( V_699 & V_165 ) ) {
V_703 = true ;
V_139 -= 3 ;
}
if ( V_8 > V_139 )
return false ;
for ( V_29 = 0 , V_701 = 0 ; V_29 < V_8 ; V_29 += ( V_701 + 1 ) ) {
V_701 = V_7 [ V_29 ] ;
if ( V_702 && V_7 [ V_29 + 1 ] == V_173 )
return false ;
if ( V_703 && V_7 [ V_29 + 1 ] == V_178 )
return false ;
if ( V_29 + V_701 >= V_8 )
return false ;
}
...
static void F_308 ( struct V_5 * V_6 , T_1 V_226 ,
T_2 V_37 )
{
struct V_133 * V_155 ;
struct V_705 * V_151 ;
...
if ( F_106 ( & V_6 -> V_260 ) )
F_73 ( & V_149 ) ;
if ( ! F_310 ( & V_149 . V_709 ) )
F_67 ( & V_149 , NULL ) ;
F_35 ( V_6 ) ;
}
static int F_311 ( struct V_11 * V_15 , struct V_5 * V_6 ,
void * V_7 , T_2 V_16 )
{
struct V_705 * V_151 = V_7 ;
struct V_706 V_18 ;
T_6 V_164 ;
T_6 V_691 ;
T_1 V_226 ;
T_2 V_248 , V_253 ;
unsigned int V_710 = V_6 -> V_693 ;
T_1 V_711 = 0 ;
struct V_144 * V_258 ;
int V_30 ;
struct V_133 * V_155 ;
...
V_226 = F_125 ( V_6 ) ;
if ( V_226 )
return F_110 ( V_15 , V_6 -> V_55 , V_707 ,
V_226 ) ;
V_164 = F_312 ( V_151 -> V_164 ) ;
V_248 = F_129 ( V_151 -> V_248 ) ;
...
F_34 ( V_6 ) ;
if ( V_248 && ! F_42 ( V_6 ) ) {
V_30 = F_110 ( V_15 , V_6 -> V_55 , V_707 ,
V_303 ) ;
goto V_306;
}
if ( F_47 ( V_707 , V_6 ) ||
...
if ( ! F_307 ( V_6 , V_164 , V_151 -> V_7 , V_151 -> V_175 , true ) ||
! F_307 ( V_6 , V_164 , V_151 -> V_7 + V_151 -> V_175 ,
V_151 -> V_147 , false ) ) {
V_30 = F_110 ( V_15 , V_6 -> V_55 , V_707 ,
V_288 ) ;
goto V_306;
}
V_30 = F_313 ( V_6 , V_151 -> V_143 , V_164 ,
...
! V_711 ) {
V_18 . V_143 = V_151 -> V_143 ;
V_30 = F_11 ( V_15 , V_6 -> V_55 , V_707 ,
V_304 , & V_18 , sizeof( V_18 ) ) ;
goto V_306;
}
V_155 = F_111 ( V_15 , V_707 , V_6 , V_7 ,
V_16 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_306;
...
F_66 ( & V_149 , V_6 ) ;
V_30 = F_98 ( & V_149 , V_711 , true ) ;
if ( ! V_30 )
V_30 = F_67 ( & V_149 , F_308 ) ;
if ( V_30 < 0 )
F_120 ( V_155 ) ;
V_306:
F_35 ( V_6 ) ;
...
static void F_314 ( struct V_5 * V_6 , T_1 V_226 ,
T_2 V_37 )
{
struct V_133 * V_155 ;
struct V_713 * V_151 ;
...
static int F_315 ( struct V_11 * V_15 , struct V_5 * V_6 ,
void * V_7 , T_2 V_16 )
{
struct V_713 * V_151 = V_7 ;
struct V_714 V_18 ;
struct V_133 * V_155 ;
struct V_148 V_149 ;
int V_30 ;
...
F_47 ( V_712 , V_6 ) ||
F_47 ( V_347 , V_6 ) ) {
V_30 = F_110 ( V_15 , V_6 -> V_55 , V_712 ,
V_289 ) ;
goto V_306;
}
if ( ! F_20 ( V_6 , V_134 ) ) {
...
V_155 = F_111 ( V_15 , V_712 , V_6 , V_7 ,
V_16 ) ;
if ( ! V_155 ) {
V_30 = - V_36 ;
goto V_306;
}
V_30 = F_67 ( & V_149 , F_314 ) ;
if ( V_30 < 0 )
F_120 ( V_155 ) ;
V_306:
F_35 ( V_6 ) ;
...
V_243 . V_63 = V_6 -> V_63 ;
F_3 ( V_718 , V_6 , & V_243 , sizeof( V_243 ) ,
V_64 ) ;
}
void F_295 ( struct V_5 * V_6 )
{
struct V_715 V_243 ;
T_1 V_226 = V_719 ;
if ( F_22 ( V_52 , & V_6 -> V_53 ) )
...
V_243 . V_63 = V_6 -> V_63 ;
F_3 ( V_722 , V_6 , & V_243 , sizeof( V_243 ) ,
V_64 ) ;
}
static void F_316 ( struct V_148 * V_149 )
{
struct V_5 * V_6 = V_149 -> V_6 ;
struct V_442 * V_443 ;
...
case V_635 :
case V_636 :
F_281 ( & V_443 -> V_629 , & V_6 -> V_632 ) ;
break;
case V_633 :
F_281 ( & V_443 -> V_629 , & V_6 -> V_634 ) ;
break;
default:
break;
}
...
static void F_317 ( struct V_5 * V_6 , T_1 V_226 , T_2 V_37 )
{
struct V_296 V_297 = { NULL , V_6 } ;
F_9 ( L_8 , V_226 ) ;
if ( ! V_226 ) {
...
! F_320 ( V_6 ) ) {
T_1 V_572 = 0x01 ;
F_56 ( & V_149 , V_345 , sizeof( V_572 ) , & V_572 ) ;
if ( F_212 ( V_6 ) && ! F_321 ( V_6 ) ) {
T_1 V_724 = 0x01 ;
F_56 ( & V_149 , V_569 ,
sizeof( V_724 ) , & V_724 ) ;
}
...
V_723 = F_20 ( V_6 , V_110 ) ;
if ( V_723 != F_22 ( V_340 , & V_6 -> V_164 ) )
F_56 ( & V_149 , V_341 ,
sizeof( V_723 ) , & V_723 ) ;
if ( F_37 ( V_6 ) ) {
if ( F_20 ( V_6 , V_105 ) )
...
return F_67 ( & V_149 , F_317 ) ;
}
int F_112 ( struct V_5 * V_6 , T_1 V_725 )
{
struct V_296 V_297 = { NULL , V_6 } ;
T_1 V_226 , V_726 [] = { 0 , 0 , 0 } ;
int V_30 ;
if ( ! F_20 ( V_6 , V_220 ) )
return 0 ;
if ( V_725 ) {
...
V_226 = V_313 ;
F_145 ( 0 , V_6 , F_121 , & V_226 ) ;
if ( memcmp ( V_6 -> V_196 , V_726 , sizeof( V_726 ) ) != 0 )
F_6 ( V_728 , V_6 ,
V_726 , sizeof( V_726 ) , NULL ) ;
F_113:
...
void F_324 ( struct V_5 * V_6 , int V_30 )
{
struct V_133 * V_155 ;
T_1 V_226 ;
...
void F_326 ( struct V_5 * V_6 , struct V_731 * V_377 ,
bool V_732 )
{
struct V_733 V_243 ;
...
memcpy ( V_243 . V_377 . V_159 , V_377 -> V_159 , V_735 ) ;
V_243 . V_377 . V_382 = V_377 -> V_382 ;
F_7 ( V_736 , V_6 , & V_243 , sizeof( V_243 ) , NULL ) ;
}
static T_1 F_327 ( struct V_737 * V_738 )
{
switch ( V_738 -> type ) {
case V_591 :
case V_592 :
...
void F_328 ( struct V_5 * V_6 , struct V_737 * V_377 , bool V_732 )
{
struct V_739 V_243 ;
memset ( & V_243 , 0 , sizeof( V_243 ) ) ;
if ( V_377 -> V_649 == V_393 &&
( V_377 -> V_118 . V_560 [ 5 ] & 0xc0 ) != 0xc0 )
V_243 . V_734 = 0x00 ;
else
V_243 . V_734 = V_732 ;
F_87 ( & V_243 . V_377 . V_379 . V_118 , & V_377 -> V_118 ) ;
V_243 . V_377 . V_379 . type = F_177 ( V_203 , V_377 -> V_649 ) ;
V_243 . V_377 . type = F_327 ( V_377 ) ;
V_243 . V_377 . V_599 = V_377 -> V_599 ;
V_243 . V_377 . V_600 = V_377 -> V_600 ;
V_243 . V_377 . rand = V_377 -> rand ;
if ( V_377 -> type == V_591 )
V_243 . V_377 . V_586 = 1 ;
memcpy ( V_243 . V_377 . V_159 , V_377 -> V_159 , V_377 -> V_599 ) ;
memset ( V_243 . V_377 . V_159 + V_377 -> V_599 , 0 ,
sizeof( V_243 . V_377 . V_159 ) - V_377 -> V_599 ) ;
F_7 ( V_740 , V_6 , & V_243 , sizeof( V_243 ) , NULL ) ;
}
void F_329 ( struct V_5 * V_6 , struct V_741 * V_578 )
{
struct V_742 V_243 ;
memset ( & V_243 , 0 , sizeof( V_243 ) ) ;
if ( F_28 ( & V_578 -> V_743 , V_72 ) )
V_243 . V_734 = 0x01 ;
else
V_243 . V_734 = 0x00 ;
F_87 ( & V_243 . V_743 , & V_578 -> V_743 ) ;
F_87 ( & V_243 . V_578 . V_379 . V_118 , & V_578 -> V_118 ) ;
V_243 . V_578 . V_379 . type = F_177 ( V_203 , V_578 -> V_383 ) ;
memcpy ( V_243 . V_578 . V_159 , V_578 -> V_159 , sizeof( V_578 -> V_159 ) ) ;
F_7 ( V_744 , V_6 , & V_243 , sizeof( V_243 ) , NULL ) ;
}
void F_330 ( struct V_5 * V_6 , struct V_745 * V_746 ,
bool V_732 )
{
struct V_747 V_243 ;
memset ( & V_243 , 0 , sizeof( V_243 ) ) ;
if ( V_746 -> V_649 == V_393 &&
( V_746 -> V_118 . V_560 [ 5 ] & 0xc0 ) != 0xc0 )
V_243 . V_734 = 0x00 ;
else
V_243 . V_734 = V_732 ;
F_87 ( & V_243 . V_377 . V_379 . V_118 , & V_746 -> V_118 ) ;
V_243 . V_377 . V_379 . type = F_177 ( V_203 , V_746 -> V_649 ) ;
V_243 . V_377 . type = V_746 -> type ;
memcpy ( V_243 . V_377 . V_159 , V_746 -> V_159 , sizeof( V_746 -> V_159 ) ) ;
F_7 ( V_748 , V_6 , & V_243 , sizeof( V_243 ) , NULL ) ;
}
void F_331 ( struct V_5 * V_6 , T_8 * V_118 ,
T_1 V_649 , T_1 V_734 , T_2 V_205 ,
T_2 V_207 , T_2 V_658 , T_2 V_248 )
{
struct V_749 V_243 ;
if ( ! F_285 ( V_118 , V_649 ) )
return;
memset ( & V_243 , 0 , sizeof( V_243 ) ) ;
F_87 ( & V_243 . V_379 . V_118 , V_118 ) ;
V_243 . V_379 . type = F_177 ( V_203 , V_649 ) ;
V_243 . V_734 = V_734 ;
V_243 . V_205 = F_10 ( V_205 ) ;
V_243 . V_207 = F_10 ( V_207 ) ;
V_243 . V_658 = F_10 ( V_658 ) ;
V_243 . V_248 = F_10 ( V_248 ) ;
F_7 ( V_750 , V_6 , & V_243 , sizeof( V_243 ) , NULL ) ;
}
void F_332 ( struct V_5 * V_6 , struct V_261 * V_262 ,
T_6 V_164 , T_1 * V_79 , T_1 V_137 )
{
char V_751 [ 512 ] ;
struct V_752 * V_243 = ( void * ) V_751 ;
T_2 V_669 = 0 ;
F_87 ( & V_243 -> V_379 . V_118 , & V_262 -> V_281 ) ;
V_243 -> V_379 . type = F_177 ( V_262 -> type , V_262 -> V_409 ) ;
V_243 -> V_164 = F_333 ( V_164 ) ;
if ( V_262 -> V_753 > 0 ) {
memcpy ( & V_243 -> V_190 [ V_669 ] ,
V_262 -> V_754 , V_262 -> V_753 ) ;
V_669 = V_262 -> V_753 ;
} else {
if ( V_137 > 0 )
V_669 = F_299 ( V_243 -> V_190 , 0 , V_142 ,
V_79 , V_137 ) ;
if ( memcmp ( V_262 -> V_196 , L_41 , 3 ) != 0 )
V_669 = F_299 ( V_243 -> V_190 , V_669 ,
V_678 ,
V_262 -> V_196 , 3 ) ;
}
V_243 -> V_669 = F_10 ( V_669 ) ;
F_7 ( V_755 , V_6 , V_751 ,
sizeof( * V_243 ) + V_669 , NULL ) ;
}
...
V_243 . V_275 = V_275 ;
F_7 ( V_758 , V_6 , & V_243 , sizeof( V_243 ) , V_15 ) ;
if ( V_15 )
F_146 ( V_15 ) ;
...
F_7 ( V_760 , V_6 , & V_243 , sizeof( V_243 ) , NULL ) ;
}
void F_340 ( struct V_5 * V_6 , T_8 * V_118 , T_1 V_761 )
{
struct V_762 V_243 ;
F_87 ( & V_243 . V_379 . V_118 , V_118 ) ;
V_243 . V_379 . type = V_380 ;
V_243 . V_761 = V_761 ;
F_7 ( V_763 , V_6 , & V_243 , sizeof( V_243 ) , NULL ) ;
}
...
F_87 ( & V_243 . V_379 . V_118 , V_118 ) ;
V_243 . V_379 . type = F_177 ( V_403 , V_383 ) ;
return F_7 ( V_769 , V_6 , & V_243 , sizeof( V_243 ) ,
NULL ) ;
}
...
F_87 ( & V_243 . V_379 . V_118 , V_118 ) ;
V_243 . V_379 . type = F_177 ( V_403 , V_383 ) ;
V_243 . V_455 = F_333 ( V_455 ) ;
V_243 . V_770 = V_770 ;
return F_7 ( V_772 , V_6 , & V_243 , sizeof( V_243 ) , NULL ) ;
}
...
V_243 . V_226 = V_226 ;
V_155 = F_182 ( V_262 ) ;
F_7 ( V_774 , V_262 -> V_6 , & V_243 , sizeof( V_243 ) ,
...
return;
memset ( & V_243 , 0 , sizeof( V_243 ) ) ;
memcpy ( V_243 . V_79 , V_79 , V_775 ) ;
memcpy ( V_243 . V_224 , V_6 -> V_224 , V_776 ) ;
V_155 = F_47 ( V_473 , V_6 ) ;
if ( ! V_155 ) {
...
F_6 ( V_474 , V_6 , & V_243 , sizeof( V_243 ) ,
V_155 ? V_155 -> V_15 : NULL ) ;
}
...
if ( ! F_20 ( V_6 , V_237 ) )
return;
if ( F_271 ( V_525 + V_777 ,
V_6 -> V_232 . V_524 +
V_6 -> V_232 . V_526 ) )
return;
F_99 ( V_6 -> V_255 , & V_6 -> V_778 ,
V_777 ) ;
}
static bool F_359 ( struct V_5 * V_6 , T_10 V_534 , T_1 * V_190 ,
T_2 V_669 , T_1 * V_779 , T_1 V_147 )
{
if ( V_6 -> V_232 . V_534 != V_604 &&
( V_534 == V_604 ||
( V_534 < V_6 -> V_232 . V_534 &&
! F_22 ( V_522 , & V_6 -> V_53 ) ) ) )
return false ;
if ( V_6 -> V_232 . V_533 != 0 ) {
if ( ! F_360 ( V_190 , V_669 , V_6 -> V_232 . V_533 ,
V_6 -> V_232 . V_360 ) &&
! F_360 ( V_779 , V_147 ,
V_6 -> V_232 . V_533 ,
V_6 -> V_232 . V_360 ) )
...
T_1 V_383 , T_1 * V_196 , T_10 V_534 , T_6 V_164 ,
T_1 * V_190 , T_2 V_669 , T_1 * V_779 , T_1 V_147 )
{
char V_751 [ 512 ] ;
struct V_780 * V_243 = ( void * ) V_751 ;
T_3 V_781 ;
if ( ! F_233 ( V_6 ) ) {
if ( V_403 == V_279 )
return;
if ( V_403 == V_203 && F_106 ( & V_6 -> V_634 ) )
return;
}
if ( V_6 -> V_232 . V_523 ) {
if ( ! F_359 ( V_6 , V_534 , V_190 , V_669 , V_779 ,
V_147 ) )
return;
}
if ( sizeof( * V_243 ) + V_669 + V_147 + 5 > sizeof( V_751 ) )
return;
memset ( V_751 , 0 , sizeof( V_751 ) ) ;
if ( V_534 == V_604 && ! V_6 -> V_232 . V_529 &&
V_403 == V_279 )
V_534 = 0 ;
F_87 ( & V_243 -> V_379 . V_118 , V_118 ) ;
V_243 -> V_379 . type = F_177 ( V_403 , V_383 ) ;
...
if ( V_669 > 0 )
memcpy ( V_243 -> V_190 , V_190 , V_669 ) ;
if ( V_196 && ! F_362 ( V_243 -> V_190 , V_669 , V_678 ) )
V_669 = F_299 ( V_243 -> V_190 , V_669 , V_678 ,
V_196 , 3 ) ;
if ( V_147 > 0 )
memcpy ( V_243 -> V_190 + V_669 , V_779 , V_147 ) ;
V_243 -> V_669 = F_10 ( V_669 + V_147 ) ;
V_781 = sizeof( * V_243 ) + V_669 + V_147 ;
F_7 ( V_782 , V_6 , V_243 , V_781 , NULL ) ;
}
void F_363 ( struct V_5 * V_6 , T_8 * V_118 , T_1 V_403 ,
T_1 V_383 , T_10 V_534 , T_1 * V_79 , T_1 V_137 )
{
struct V_780 * V_243 ;
char V_751 [ sizeof( * V_243 ) + V_775 + 2 ] ;
T_2 V_669 ;
V_243 = (struct V_780 * ) V_751 ;
memset ( V_751 , 0 , sizeof( V_751 ) ) ;
F_87 ( & V_243 -> V_379 . V_118 , V_118 ) ;
V_243 -> V_379 . type = F_177 ( V_403 , V_383 ) ;
V_243 -> V_534 = V_534 ;
V_669 = F_299 ( V_243 -> V_190 , 0 , V_142 , V_79 ,
V_137 ) ;
V_243 -> V_669 = F_10 ( V_669 ) ;
F_7 ( V_782 , V_6 , V_243 , sizeof( * V_243 ) + V_669 , NULL ) ;
}
void F_364 ( struct V_5 * V_6 , T_1 V_783 )
{
struct V_784 V_243 ;
F_9 ( L_42 , V_6 -> V_79 , V_783 ) ;
memset ( & V_243 , 0 , sizeof( V_243 ) ) ;
V_243 . type = V_6 -> V_232 . type ;
V_243 . V_783 = V_783 ;
F_7 ( V_785 , V_6 , & V_243 , sizeof( V_243 ) , NULL ) ;
}
