...
V_14 -> V_34 = 0xff ;
for ( V_15 = 0 ; V_15 < F_39 ( V_46 ) ; V_15 ++ ) {
if ( ! strcmp ( V_46 [ V_15 ] ,
F_17 ( V_14 -> V_33 ) ) ) {
V_14 -> V_34 = V_15 ;
break;
...
if ( V_14 -> V_34 == 0xff ) {
F_12 ( L_16 ,
V_43 -> V_45 , F_17 ( V_14 -> V_33 ) ) ;
F_40 ( V_14 -> V_33 ) ;
return - V_35 ;
}
return 0 ;
}
static int F_41 ( const void * V_47 , const void * V_48 )
{
const struct V_13 * V_49 = V_47 ;
const struct V_13 * V_50 = V_48 ;
if ( V_49 -> V_18 < V_50 -> V_18 )
return - 1 ;
else if ( V_49 -> V_18 == V_50 -> V_18 )
return 0 ;
else
return 1 ;
}
...
int V_52 = F_43 ( V_43 ) ;
int V_15 = 0 , V_29 ;
V_5 -> V_17 = F_44 ( V_52 , sizeof( struct V_13 ) ,
V_53 ) ;
if ( ! V_5 -> V_17 )
return - V_54 ;
V_5 -> V_16 = V_52 ;
...
struct V_55 * F_47 ( void T_3 * V_56 , struct V_42 * V_57 ,
T_4 * V_37 )
{
struct V_4 * V_5 ;
struct V_58 V_59 ;
...
V_59 . V_65 = F_39 ( V_46 ) ;
V_5 -> V_2 . V_59 = & V_59 ;
V_55 = F_51 ( NULL , & V_5 -> V_2 ) ;
if ( F_37 ( V_55 ) )
return V_55 ;
V_5 -> V_38 = F_52 (
& V_5 -> V_2 , F_9 ( & V_5 -> V_2 ) ) -> V_55 ;
V_5 -> V_36 = false ;
F_53 ( V_55 , L_21 , L_22 ) ;
F_21 ( V_55 ) ;
return V_55 ;
