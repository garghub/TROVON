...
F_170 ( V_8 , V_2 ) ;
if ( F_175 ( V_8 , V_2 , F_4 ( V_2 ) , V_2 -> V_157 ) ) {
V_303 = V_8 ;
goto V_310;
}
return 0 ;
...
V_2 -> V_315 = V_316 ;
if ( F_180 ( V_8 ) ) {
struct V_81 * V_67 = F_181 ( V_8 -> V_305 ) ;
if ( V_67 )
V_67 = F_182 ( V_67 , 0 ) ;
if ( V_67 &&
...
bool F_184 ( struct V_7 * V_8 , struct V_1 * V_2 )
{
struct V_13 * V_14 = F_7 ( V_8 ) ;
if ( V_317 || ! V_14 -> V_318 . V_319 )
return false ;
if ( V_2 -> V_157 <= F_185 ( V_2 ) &&
...
V_2 -> V_113 = NULL ;
F_207 ( V_8 ) ;
F_7 ( V_8 ) -> V_347 += F_208 ( T_7 , 1 , F_209 ( V_2 ) -> V_348 ) ;
V_330 = 0 ;
if ( ! F_13 ( V_8 ) ) {
if ( ! F_184 ( V_8 , V_2 ) )
V_330 = F_169 ( V_8 , V_2 ) ;
} else if ( F_59 ( F_210 ( V_8 , V_2 ,
V_8 -> V_323 + V_8 -> V_349 ) ) ) {
F_71 ( V_8 ) ;
F_45 ( V_94 , V_350 ) ;
goto V_345;
...
switch ( F_211 ( F_56 ( V_8 ) , V_2 , V_105 ) ) {
case V_351 : {
struct V_7 * V_352 = F_212 ( F_50 ( V_2 -> V_113 ) ,
& V_114 ,
V_102 -> V_4 , V_105 -> V_6 ,
V_102 -> V_3 , V_105 -> V_5 ,
F_53 ( V_2 ) ) ;
...
static void * F_227 ( struct V_362 * V_91 , void * V_363 )
{
struct V_107 * V_108 ;
struct V_364 * V_249 ;
struct V_7 * V_8 = V_363 ;
struct V_365 * V_366 ;
struct V_367 * V_368 = V_91 -> V_369 ;
struct V_94 * V_94 = F_228 ( V_91 ) ;
if ( ! V_8 ) {
V_366 = & V_114 . V_370 [ V_368 -> V_371 ] ;
F_229 ( & V_366 -> V_372 ) ;
V_8 = F_230 ( & V_366 -> V_159 ) ;
V_368 -> V_208 = 0 ;
goto V_373;
}
V_366 = & V_114 . V_370 [ V_368 -> V_371 ] ;
...
struct V_92 * V_93 = V_363 ;
V_108 = F_25 ( V_368 -> V_377 ) ;
V_93 = V_93 -> V_378 ;
while ( 1 ) {
while ( V_93 ) {
if ( V_93 -> V_379 -> V_230 == V_368 -> V_230 ) {
V_363 = V_93 ;
goto V_122;
}
V_93 = V_93 -> V_378 ;
}
if ( ++ V_368 -> V_380 >= V_108 -> V_381 . V_382 -> V_383 )
break;
V_384:
V_93 = V_108 -> V_381 . V_382 -> V_385 [ V_368 -> V_380 ] ;
}
V_8 = F_231 ( V_368 -> V_377 ) ;
V_368 -> V_375 = V_386 ;
F_232 ( & V_108 -> V_381 . V_387 ) ;
} else {
V_108 = F_25 ( V_8 ) ;
F_229 ( & V_108 -> V_381 . V_387 ) ;
if ( F_233 ( & V_108 -> V_381 ) )
goto V_388;
F_232 ( & V_108 -> V_381 . V_387 ) ;
V_8 = F_231 ( V_8 ) ;
}
V_373:
F_234 (sk, node) {
if ( ! F_235 ( F_19 ( V_8 ) , V_94 ) )
continue;
if ( V_8 -> V_389 == V_368 -> V_230 ) {
V_363 = V_8 ;
goto V_122;
}
V_108 = F_25 ( V_8 ) ;
...
static void * F_237 ( struct V_362 * V_91 , T_10 * V_392 )
{
struct V_367 * V_368 = V_91 -> V_369 ;
void * V_393 ;
V_368 -> V_371 = 0 ;
V_368 -> V_208 = 0 ;
V_393 = F_227 ( V_91 , NULL ) ;
while ( V_393 && * V_392 ) {
V_393 = F_227 ( V_91 , V_393 ) ;
-- * V_392 ;
}
return V_393 ;
}
static inline bool F_238 ( const struct V_367 * V_368 )
{
return F_239 ( & V_114 . V_394 [ V_368 -> V_371 ] . V_395 ) ;
}
static void * F_240 ( struct V_362 * V_91 )
{
struct V_367 * V_368 = V_91 -> V_369 ;
struct V_94 * V_94 = F_228 ( V_91 ) ;
void * V_393 = NULL ;
V_368 -> V_208 = 0 ;
for (; V_368 -> V_371 <= V_114 . V_396 ; ++ V_368 -> V_371 ) {
struct V_7 * V_8 ;
struct V_364 * V_249 ;
T_11 * V_372 = F_241 ( & V_114 , V_368 -> V_371 ) ;
if ( F_238 ( V_368 ) )
continue;
F_229 ( V_372 ) ;
F_242 (sk, node, &tcp_hashinfo.ehash[st->bucket].chain) {
if ( V_8 -> V_389 != V_368 -> V_230 ||
! F_235 ( F_19 ( V_8 ) , V_94 ) ) {
continue;
}
...
static void * F_243 ( struct V_362 * V_91 , void * V_363 )
{
struct V_7 * V_8 = V_363 ;
struct V_364 * V_249 ;
struct V_367 * V_368 = V_91 -> V_369 ;
...
V_8 = F_231 ( V_8 ) ;
F_234 (sk, node) {
if ( V_8 -> V_389 == V_368 -> V_230 && F_235 ( F_19 ( V_8 ) , V_94 ) )
return V_8 ;
}
F_232 ( F_241 ( & V_114 , V_368 -> V_371 ) ) ;
++ V_368 -> V_371 ;
return F_240 ( V_91 ) ;
}
static void * F_244 ( struct V_362 * V_91 , T_10 V_392 )
{
struct V_367 * V_368 = V_91 -> V_369 ;
void * V_393 ;
V_368 -> V_371 = 0 ;
V_393 = F_240 ( V_91 ) ;
while ( V_393 && V_392 ) {
V_393 = F_243 ( V_91 , V_393 ) ;
-- V_392 ;
}
return V_393 ;
}
static void * F_245 ( struct V_362 * V_91 , T_10 V_392 )
{
void * V_393 ;
struct V_367 * V_368 = V_91 -> V_369 ;
V_368 -> V_375 = V_386 ;
V_393 = F_237 ( V_91 , & V_392 ) ;
if ( ! V_393 ) {
V_368 -> V_375 = V_397 ;
V_393 = F_244 ( V_91 , V_392 ) ;
}
return V_393 ;
}
static void * F_246 ( struct V_362 * V_91 )
{
struct V_367 * V_368 = V_91 -> V_369 ;
int V_208 = V_368 -> V_208 ;
int V_398 = V_368 -> V_374 ;
void * V_393 = NULL ;
switch ( V_368 -> V_375 ) {
case V_376 :
case V_386 :
...
static void * F_247 ( struct V_362 * V_91 , T_10 * V_392 )
{
struct V_367 * V_368 = V_91 -> V_369 ;
void * V_393 ;
if ( * V_392 && * V_392 == V_368 -> V_399 ) {
V_393 = F_246 ( V_91 ) ;
if ( V_393 )
goto V_122;
}
...
V_368 -> V_371 = 0 ;
V_368 -> V_208 = 0 ;
V_393 = * V_392 ? F_245 ( V_91 , * V_392 - 1 ) : V_400 ;
V_122:
V_368 -> V_399 = * V_392 ;
return V_393 ;
}
static void * F_248 ( struct V_362 * V_91 , void * V_401 , T_10 * V_392 )
{
struct V_367 * V_368 = V_91 -> V_369 ;
void * V_393 = NULL ;
if ( V_401 == V_400 ) {
...
static void F_249 ( struct V_362 * V_91 , void * V_401 )
{
struct V_367 * V_368 = V_91 -> V_369 ;
switch ( V_368 -> V_375 ) {
case V_376 :
if ( V_401 ) {
struct V_107 * V_108 = F_25 ( V_368 -> V_377 ) ;
F_232 ( & V_108 -> V_381 . V_387 ) ;
}
case V_386 :
if ( V_401 != V_400 )
F_232 ( & V_114 . V_370 [ V_368 -> V_371 ] . V_372 ) ;
break;
case V_397 :
if ( V_401 )
F_232 ( F_241 ( & V_114 , V_368 -> V_371 ) ) ;
...
int F_250 ( struct V_402 * V_402 , struct V_403 * V_403 )
{
struct V_404 * V_405 = F_251 ( V_402 ) ;
struct V_367 * V_406 ;
int V_37 ;
V_37 = F_252 ( V_402 , V_403 , & V_405 -> V_407 ,
sizeof( struct V_367 ) ) ;
if ( V_37 < 0 )
return V_37 ;
V_406 = ( (struct V_362 * ) V_403 -> V_408 ) -> V_369 ;
V_406 -> V_230 = V_405 -> V_230 ;
V_406 -> V_399 = 0 ;
return 0 ;
}
int F_253 ( struct V_94 * V_94 , struct V_404 * V_405 )
{
int V_393 = 0 ;
struct V_409 * V_410 ;
V_405 -> V_407 . V_411 = F_247 ;
V_405 -> V_407 . V_412 = F_248 ;
V_405 -> V_407 . V_413 = F_249 ;
V_410 = F_254 ( V_405 -> V_414 , V_415 , V_94 -> V_416 ,
V_405 -> V_417 , V_405 ) ;
if ( ! V_410 )
V_393 = - V_247 ;
return V_393 ;
}
void F_255 ( struct V_94 * V_94 , struct V_404 * V_405 )
{
F_256 ( V_405 -> V_414 , V_94 -> V_416 ) ;
}
static void F_257 ( const struct V_92 * V_93 ,
struct V_362 * V_418 , int V_419 , T_12 V_390 )
{
const struct V_225 * V_226 = F_101 ( V_93 ) ;
long V_420 = V_93 -> V_421 . V_422 - V_78 ;
F_258 ( V_418 , L_4
L_5 ,
V_419 ,
V_226 -> V_227 ,
...
F_259 ( V_420 ) ,
V_93 -> V_425 ,
F_260 ( F_261 ( V_418 ) , V_390 ) ,
0 ,
0 ,
0 ,
V_93 ) ;
}
static void F_262 ( struct V_7 * V_8 , struct V_362 * V_418 , int V_419 )
{
int V_426 ;
unsigned long V_427 ;
const struct V_13 * V_14 = F_7 ( V_8 ) ;
...
const struct V_28 * V_29 = F_11 ( V_8 ) ;
struct V_428 * V_429 = V_108 -> V_381 . V_429 ;
T_3 V_5 = V_29 -> V_63 ;
T_3 V_430 = V_29 -> V_431 ;
T_13 V_432 = F_52 ( V_29 -> V_68 ) ;
T_13 V_433 = F_52 ( V_29 -> V_49 ) ;
int V_434 ;
if ( V_108 -> V_435 == V_147 ||
V_108 -> V_435 == V_436 ||
V_108 -> V_435 == V_437 ) {
V_426 = 1 ;
V_427 = V_108 -> V_438 ;
} else if ( V_108 -> V_435 == V_439 ) {
V_426 = 4 ;
V_427 = V_108 -> V_438 ;
} else if ( F_263 ( & V_8 -> V_440 ) ) {
V_426 = 2 ;
V_427 = V_8 -> V_440 . V_422 ;
} else {
V_426 = 0 ;
V_427 = V_78 ;
}
...
V_434 = F_208 ( int , V_14 -> V_218 - V_14 -> V_442 , 0 ) ;
F_258 ( V_418 , L_6
L_7 ,
V_419 , V_430 , V_433 , V_5 , V_432 , V_8 -> V_116 ,
V_14 -> V_17 - V_14 -> V_111 ,
V_434 ,
V_426 ,
F_259 ( V_427 - V_78 ) ,
V_108 -> V_140 ,
F_260 ( F_261 ( V_418 ) , F_236 ( V_8 ) ) ,
V_108 -> V_443 ,
F_264 ( V_8 ) ,
F_265 ( & V_8 -> V_444 ) , V_8 ,
F_266 ( V_108 -> V_142 ) ,
F_266 ( V_108 -> V_445 . V_446 ) ,
( V_108 -> V_445 . V_447 << 1 ) | V_108 -> V_445 . V_448 ,
V_14 -> V_449 ,
V_8 -> V_116 == V_127 ?
( V_429 ? V_429 -> V_450 : 0 ) :
( F_267 ( V_14 ) ? - 1 : V_14 -> V_451 ) ) ;
}
static void F_268 ( const struct V_209 * V_210 ,
struct V_362 * V_418 , int V_419 )
{
long V_420 = V_210 -> V_452 . V_422 - V_78 ;
T_3 V_5 , V_430 ;
T_13 V_432 , V_433 ;
V_5 = V_210 -> V_453 ;
V_430 = V_210 -> V_454 ;
V_432 = F_52 ( V_210 -> V_455 ) ;
V_433 = F_52 ( V_210 -> V_456 ) ;
F_258 ( V_418 , L_4
L_8 ,
V_419 , V_430 , V_433 , V_5 , V_432 , V_210 -> V_457 , 0 , 0 ,
3 , F_259 ( V_420 ) , 0 , 0 , 0 , 0 ,
F_265 ( & V_210 -> V_458 ) , V_210 ) ;
}
static int F_269 ( struct V_362 * V_91 , void * V_401 )
{
struct V_367 * V_368 ;
struct V_7 * V_8 = V_401 ;
F_270 ( V_91 , V_459 - 1 ) ;
if ( V_401 == V_400 ) {
F_271 ( V_91 , L_9
L_10
...
case V_397 :
if ( V_8 -> V_116 == V_117 )
F_268 ( V_401 , V_91 , V_368 -> V_374 ) ;
else
F_262 ( V_401 , V_91 , V_368 -> V_374 ) ;
break;
case V_376 :
F_257 ( V_401 , V_91 , V_368 -> V_374 , V_368 -> V_390 ) ;
break;
}
V_122:
F_272 ( V_91 , '\n' ) ;
...
static int T_14 F_273 ( struct V_94 * V_94 )
{
return F_253 ( V_94 , & V_460 ) ;
}
static void T_15 F_274 ( struct V_94 * V_94 )
{
F_255 ( V_94 , & V_460 ) ;
}
int T_16 F_275 ( void )
...
static void T_15 F_279 ( struct V_94 * V_94 )
{
int V_462 ;
F_280 (cpu)
F_281 ( * F_282 ( V_94 -> V_194 . F_7 , V_462 ) ) ;
F_283 ( V_94 -> V_194 . F_7 ) ;
}
static int T_14 F_284 ( struct V_94 * V_94 )
{
int V_463 , V_462 ;
V_94 -> V_194 . F_7 = F_285 ( struct V_7 * ) ;
if ( ! V_94 -> V_194 . F_7 )
return - V_247 ;
F_280 (cpu) {
struct V_7 * V_8 ;
V_463 = F_286 ( & V_8 , V_464 , V_465 ,
V_57 , V_94 ) ;
if ( V_463 )
goto V_466;
* F_282 ( V_94 -> V_194 . F_7 , V_462 ) = V_8 ;
}
V_94 -> V_194 . V_467 = 2 ;
V_94 -> V_194 . V_468 = 1 ;
V_94 -> V_194 . V_469 = V_470 ;
V_94 -> V_194 . V_471 = V_472 ;
V_94 -> V_194 . V_473 = V_474 ;
return 0 ;
V_466:
F_279 ( V_94 ) ;
return V_463 ;
}
static void T_15 F_287 ( struct V_475 * V_476 )
{
F_288 ( & V_114 , & V_65 , V_42 ) ;
}
