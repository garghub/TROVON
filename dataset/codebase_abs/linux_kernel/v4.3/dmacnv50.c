...
{
struct V_36 * V_21 = V_17 -> V_2 . V_6 -> V_21 ;
struct V_59 * V_23 = & V_21 -> V_2 . V_22 . V_23 ;
struct V_19 * V_20 = V_23 -> V_20 ;
int V_44 = V_17 -> V_2 . V_44 ;
F_19 ( V_20 , 0x610200 + ( V_44 * 0x0010 ) , 0x00001010 , 0x00001000 ) ;
F_19 ( V_20 , 0x610200 + ( V_44 * 0x0010 ) , 0x00000003 , 0x00000000 ) ;
if ( F_20 (device, 2000 ,
if (!(nvkm_rd32(device, 0x610200 + (chid * 0x10)) & 0x001e0000))
break;
) < 0 ) {
F_21 ( V_23 , L_1 , V_44 ,
F_22 ( V_20 , 0x610200 + ( V_44 * 0x10 ) ) ) ;
}
F_19 ( V_20 , 0x610028 , 0x00010001 << V_44 , 0x00000000 << V_44 ) ;
}
static int
...
struct V_19 * V_20 = V_23 -> V_20 ;
int V_44 = V_17 -> V_2 . V_44 ;
F_19 ( V_20 , 0x610028 , 0x00010000 << V_44 , 0x00010000 << V_44 ) ;
F_24 ( V_20 , 0x610204 + ( V_44 * 0x0010 ) , V_17 -> V_46 ) ;
F_24 ( V_20 , 0x610208 + ( V_44 * 0x0010 ) , 0x00010000 ) ;
F_24 ( V_20 , 0x61020c + ( V_44 * 0x0010 ) , V_44 ) ;
F_19 ( V_20 , 0x610200 + ( V_44 * 0x0010 ) , 0x00000010 , 0x00000010 ) ;
F_24 ( V_20 , 0x640000 + ( V_44 * 0x1000 ) , 0x00000000 ) ;
F_24 ( V_20 , 0x610200 + ( V_44 * 0x0010 ) , 0x00000013 ) ;
if ( F_20 (device, 2000 ,
