...
div = V_34 ;
if ( F_28 ( V_11 ) & V_35 ) {
unsigned long V_36 = V_22 ;
unsigned long V_37 = 0 ;
struct V_38 * V_39 = V_33 -> V_40 [ V_33 -> V_41 [ 0 ] . V_15 ] ;
unsigned long V_42 = V_39 ? F_29 ( V_39 ) : 0 ;
for ( div = V_43 / V_22 ; V_36 &&
div <= V_44 / V_22 ; ++ div ) {
...
V_11 -> V_18 = V_56 ;
V_11 -> V_11 . V_55 = V_55 ;
V_11 -> V_38 = F_43 ( & V_33 -> V_7 -> V_8 ,
& V_11 -> V_11 ) ;
if ( F_44 ( V_11 -> V_38 ) ) {
F_3 ( & V_33 -> V_7 -> V_8 , L_11 ,
V_53 [ V_56 ] ) ;
return F_45 ( V_11 -> V_38 ) ;
}
}
return 0 ;
}
...
struct V_38 * V_15 = F_48 ( & V_33 -> V_7 -> V_8 ,
V_65 [ V_56 ] ) ;
if ( F_44 ( V_15 ) ) {
...
V_85 , & V_55 ) ;
for ( V_56 = 0 ; V_56 < F_47 ( V_33 -> V_83 ) ; ++ V_56 )
V_33 -> V_86 [ V_56 ] = V_33 -> V_83 [ V_56 ] . V_38 ;
return V_63 ;
}
