...
V_24 -> V_26 = V_4 ;
V_24 -> V_31 = 1 ;
if ( V_22 -> V_32 != V_33 && V_24 -> V_26 -> V_30 )
V_24 -> V_26 -> V_30 ( V_22 ) ;
}
...
F_37 ( F_38 ( & V_15 ) ) ;
F_8 () ;
V_4 = F_39 ( V_15 . V_41 , struct V_1 , V_14 ) ;
strncpy ( V_2 , V_4 -> V_2 , V_20 ) ;
F_6 () ;
}
void F_40 ( char * V_38 , T_3 V_39 )
{
struct V_1 * V_4 ;
T_3 V_40 = 0 ;
* V_38 = '\0' ;
...
char * V_43 , * V_44 , * V_2 ;
int V_7 = 0 ;
V_43 = V_44 = F_42 ( V_42 , V_45 ) ;
if ( ! V_44 )
return - V_46 ;
F_13 ( & V_11 ) ;
while ( ( V_2 = F_43 ( & V_44 , L_7 ) ) && * V_2 ) {
V_4 = F_1 ( V_2 ) ;
if ( ! V_4 ) {
V_7 = - V_35 ;
goto V_27;
...
int F_46 ( struct V_21 * V_22 , const char * V_2 )
{
struct V_23 * V_24 = F_25 ( V_22 ) ;
const struct V_1 * V_4 ;
int V_47 = 0 ;
...
T_1 F_49 ( struct V_52 * V_53 , T_1 V_54 )
{
T_1 V_55 = F_50 ( V_53 -> V_56 + V_54 , V_53 -> V_57 ) ;
V_54 -= V_55 - V_53 -> V_56 ;
V_53 -> V_56 = F_50 ( V_55 , V_53 -> V_58 ) ;
return V_54 ;
}
void F_51 ( struct V_52 * V_53 , T_1 V_59 , T_1 V_54 )
{
if ( V_53 -> V_60 >= V_59 ) {
V_53 -> V_60 = 0 ;
V_53 -> V_56 ++ ;
...
V_53 -> V_56 = F_50 ( V_53 -> V_56 , V_53 -> V_58 ) ;
}
void F_52 ( struct V_21 * V_22 , T_1 V_62 , T_1 V_54 )
{
struct V_52 * V_53 = F_53 ( V_22 ) ;
if ( ! F_54 ( V_22 ) )
return;
if ( F_55 ( V_53 ) ) {
V_54 = F_49 ( V_53 , V_54 ) ;
...
F_51 ( V_53 , V_53 -> V_56 , V_54 ) ;
}
T_1 F_56 ( struct V_21 * V_22 )
{
const struct V_52 * V_53 = F_53 ( V_22 ) ;
return F_57 ( V_53 -> V_56 >> 1U , 2U ) ;
}
