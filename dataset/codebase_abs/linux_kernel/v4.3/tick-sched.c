...
static void F_110 ( struct V_1 * V_16 , T_1 V_4 )
{
F_3 ( V_4 ) ;
F_111 () ;
F_112 () ;
...
if ( F_7 ( V_16 -> V_56 == V_81 ) ) {
V_16 -> V_79 = ( T_1 ) { . V_8 = V_82 / V_83 } ;
return false ;
}
if ( F_116 () )
return false ;
...
static inline void F_134 ( struct V_1 * V_16 , int V_91 )
{
if ( ! V_44 )
return;
V_16 -> V_56 = V_91 ;
...
static enum V_96 F_145 ( struct V_97 * V_98 )
{
struct V_1 * V_16 =
F_146 ( V_98 , struct V_1 , V_54 ) ;
struct V_17 * V_18 = F_133 () ;
T_1 V_4 = F_84 () ;
F_15 ( V_4 ) ;
if ( V_18 )
...
T_1 V_4 = F_84 () ;
F_139 ( & V_16 -> V_54 , V_93 , V_94 ) ;
V_16 -> V_54 . V_102 = F_145 ;
F_90 ( & V_16 -> V_54 , F_14 () ) ;
if ( V_101 ) {
T_4 V_103 = F_8 ( V_9 ) >> 1 ;
F_150 ( V_103 , F_151 () ) ;
V_103 *= F_16 () ;
F_152 ( & V_16 -> V_54 , V_103 ) ;
}
F_91 ( & V_16 -> V_54 , V_4 , V_9 ) ;
F_92 ( & V_16 -> V_54 , V_58 ) ;
F_134 ( V_16 , V_57 ) ;
