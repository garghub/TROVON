...
static int F_71 ( struct V_128 * V_171 ,
struct V_172 * V_39 )
{
struct V_24 * V_25 = F_72 ( V_171 ) ;
int V_173 ;
V_25 -> V_39 = V_39 ;
V_25 -> F_54 = 1 ;
if ( ! F_63 ( V_25 -> V_141 ) ) {
V_173 = F_73 ( V_25 -> V_141 -> V_174 ,
& V_25 -> V_40 ) ;
if ( V_173 )
goto V_175;
}
...
static void
F_75 ( struct V_24 * V_25 , struct V_172 * V_39 )
{
int V_123 ;
...
static void
F_57 ( struct V_24 * V_25 , struct V_172 * V_39 )
{
int V_123 ;
if ( V_25 -> V_40 . V_41 == V_42 )
V_39 = NULL ;
...
static int F_78 ( struct V_128 * V_171 )
{
struct V_24 * V_25 = F_72 ( V_171 ) ;
F_79 () ;
V_25 -> F_54 = 0 ;
...
F_80 () ;
if ( ! F_63 ( V_25 -> V_141 ) )
( void ) F_73 ( V_25 -> V_141 -> V_174 , NULL ) ;
V_25 -> V_39 = NULL ;
F_74 ( V_25 ) ;
return 0 ;
}
static T_5
F_81 ( int V_178 , void * V_179 )
{
struct V_24 * V_25 = V_179 ;
int V_136 ;
V_25 -> V_83 . V_159 ++ ;
switch ( V_178 ) {
case V_180 :
...
F_18 ( & V_25 -> V_23 [ V_123 ] , - V_184 ) ;
}
static void F_85 ( unsigned long V_179 )
{
struct V_24 * V_25 = ( void * ) V_179 ;
F_79 () ;
if ( V_25 -> V_59 == V_122
&& ( V_75 & V_155 ) == 0
&& ( V_75 & V_156 ) == 0 ) {
...
if ( ( V_185 & V_76 ) != 0 && V_25 -> V_59 != V_60 ) {
F_18 ( V_23 , 0 ) ;
F_87 ( & V_25 -> V_176 ) ;
F_31 ( V_25 ) ;
}
...
V_190 . V_188 [ V_123 ] = ( T_4 ) V_81 ;
}
if ( F_36 ( ( V_75 & V_97 ) != 0 ) )
goto V_193;
V_195:
F_15 ( V_47 , L_72 ,
V_190 . V_187 . V_196 , V_190 . V_187 . V_197 ,
F_88 ( V_190 . V_187 . V_198 ) ,
F_88 ( V_190 . V_187 . V_199 ) ,
F_88 ( V_190 . V_187 . V_200 ) ) ;
V_25 -> V_201 = ( V_190 . V_187 . V_196 & V_202 )
== V_203 ;
V_25 -> V_105 = 0 ;
V_25 -> V_80 = 1 ;
switch ( V_190 . V_187 . V_197 ) {
case V_204 :
if ( V_190 . V_187 . V_196 == V_205 ) {
V_206:
V_25 -> V_105 = 1 ;
F_84 ( V_25 ) ;
}
...
if ( V_190 . V_187 . V_196 & V_113 )
V_25 -> V_59 = V_101 ;
else
V_25 -> V_59 = V_103 ;
V_123 = V_25 -> V_39 -> V_210 ( & V_25 -> V_40 , & V_190 . V_187 ) ;
if ( V_123 < 0 ) {
if ( V_25 -> V_105 ) {
F_89 ( L_75 ,
V_190 . V_187 . V_197 , V_123 ) ;
return;
}
F_15 ( V_47 , L_76
L_77 , V_75 , V_123 ) ;
...
|| V_25 -> V_201 || V_190 . V_187 . V_200 ) )
F_37 ( V_25 , 0 , L_79 ) ;
else
F_37 ( V_25 , V_86 , L_80 ) ;
}
return;
} else if ( F_29 ( ( V_185 & ( V_77 | V_76 ) )
== ( V_77 | V_76 ) ) ) {
unsigned V_123 ;
F_15 ( V_47 , L_81 ) ;
F_18 ( V_23 , - V_192 ) ;
for ( V_123 = 0 ; V_123 < 8 ; V_123 ++ )
V_190 . V_188 [ V_123 ] = ( T_4 ) V_81 ;
if ( ( V_190 . V_187 . V_196 & V_211 )
> V_212 )
goto V_194;
if ( V_190 . V_189 [ 0 ] == 0 && V_190 . V_189 [ 1 ] == 0 )
goto V_194;
goto V_195;
} else {
V_75 = V_185 & ( V_76 | V_77 ) ;
}
break;
case V_101 :
if ( V_185 & V_77 ) {
...
static void F_93 ( struct V_223 * V_25 )
{
...
if ( V_178 < 0 )
return - V_125 ;
V_25 -> V_139 = F_100 ( & V_225 -> V_25 , NULL ) ;
if ( F_101 ( V_25 -> V_139 ) )
return F_102 ( V_25 -> V_139 ) ;
F_103 ( L_93 , V_228 , V_178 ,
V_25 -> V_106 ? L_11 : L_94 ,
V_248 L_38
) ;
V_25 -> V_25 = & V_225 -> V_25 ;
V_25 -> V_2 = F_104 ( & V_225 -> V_25 ) ;
V_25 -> V_141 = F_105 ( & V_225 -> V_25 , V_249 ) ;
if ( F_2 ( V_25 -> V_2 -> V_6 ) ) {
V_173 = F_106 ( & V_225 -> V_25 , V_25 -> V_2 -> V_6 ,
L_95 ) ;
if ( V_173 ) {
F_107 ( & V_225 -> V_25 ,
L_96 ,
...
F_109 ( & V_25 -> V_176 ) ;
V_25 -> V_176 . V_251 = F_85 ;
V_25 -> V_176 . V_252 = ( unsigned long ) V_25 ;
V_3 = V_25 ;
F_110 ( V_225 , V_25 ) ;
F_58 ( V_25 ) ;
F_69 ( V_25 ) ;
V_25 -> V_136 = 0 ;
V_173 = F_111 ( & V_225 -> V_25 , V_178 , F_91 , 0 ,
V_228 , V_25 ) ;
if ( V_173 != 0 ) {
F_97 ( L_97 ,
V_228 , V_178 , V_173 ) ;
...
#endif
F_114 ( V_25 ) ;
V_173 = F_115 ( & V_225 -> V_25 , & V_25 -> V_40 ) ;
if ( ! V_173 )
return V_173 ;
F_116 ( V_25 ) ;
V_250:
...
static void F_117 ( struct V_224 * V_179 )
{
F_1 () ;
}
static int F_118 ( struct V_224 * V_225 )
{
struct V_24 * V_25 = F_119 ( V_225 ) ;
if ( V_25 -> V_39 )
return - V_254 ;
F_120 ( & V_25 -> V_40 ) ;
V_25 -> F_54 = 0 ;
...
static int F_121 ( struct V_224 * V_25 , T_6 V_255 )
{
...
static int F_122 ( struct V_224 * V_25 )
{
struct V_24 * V_134 = F_119 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
