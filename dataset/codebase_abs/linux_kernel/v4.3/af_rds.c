...
{
struct V_4 * V_5 = F_2 ( V_3 ) ;
F_51 ( ( & V_5 -> V_8 != V_5 -> V_8 . V_81 ||
& V_5 -> V_8 != V_5 -> V_8 . V_82 ) ) ;
}
static int F_52 ( struct V_1 * V_2 , struct V_2 * V_3 , int V_83 )
{
struct V_4 * V_5 ;
F_53 ( V_2 , V_3 ) ;
V_2 -> V_84 = & V_85 ;
...
static int F_58 ( struct V_94 * V_94 , struct V_1 * V_2 , int V_83 ,
int V_95 )
{
struct V_2 * V_3 ;
if ( V_2 -> type != V_96 || V_83 )
return - V_97 ;
V_3 = F_59 ( V_94 , V_98 , V_99 , & V_100 , V_95 ) ;
if ( ! V_3 )
return - V_101 ;
return F_52 ( V_2 , V_3 , V_83 ) ;
}
...
static void F_63 ( struct V_1 * V_2 , unsigned int V_50 ,
struct V_102 * V_103 ,
struct V_104 * V_105 )
{
struct V_4 * V_5 ;
...
F_11 ( & V_7 ) ;
F_64 (rs, &rds_sock_list, rs_item) {
F_65 ( & V_5 -> V_12 ) ;
F_64 (inc, &rs->rs_recv_queue, i_item) {
V_108 ++ ;
if ( V_108 <= V_50 )
F_66 ( V_107 , V_103 , V_107 -> V_110 ,
V_5 -> V_26 , 1 ) ;
}
F_67 ( & V_5 -> V_12 ) ;
}
...
static void F_68 ( struct V_1 * V_2 , unsigned int V_50 ,
struct V_102 * V_103 ,
struct V_104 * V_105 )
{
struct V_113 V_114 ;
...
goto V_6;
F_64 (rs, &rds_sock_list, rs_item) {
V_114 . V_115 = F_29 ( V_5 ) ;
V_114 . V_116 = F_69 ( V_5 ) ;
V_114 . V_117 = V_5 -> V_26 ;
V_114 . V_118 = V_5 -> V_19 ;
V_114 . V_119 = V_5 -> V_25 ;
V_114 . V_120 = V_5 -> V_22 ;
V_114 . V_121 = F_70 ( F_19 ( V_5 ) ) ;
F_71 ( V_103 , & V_114 , sizeof( V_114 ) ) ;
}
V_6:
V_105 -> V_111 = V_9 ;
