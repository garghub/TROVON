...
{
struct V_87 * V_96 = F_58 ( V_119 ) ;
struct V_1 * V_2 = F_37 ( V_96 ) ;
struct V_120 * V_88 = F_59 ( V_119 ) ;
unsigned long V_121 ;
T_2 V_97 ;
F_60 ( V_88 , V_119 ) ;
...
unsigned V_122 , V_3 ;
V_3 = V_2 -> V_55 [ V_97 ] ;
V_122 = F_62 ( V_96 -> V_123 , V_3 ) ;
F_63 ( V_122 ) ;
}
F_64 ( V_88 , V_119 ) ;
}
static int F_65 ( struct V_1 * V_2 , int V_122 )
{
...
if ( F_5 ( V_2 , V_119 -> V_90 ) )
continue;
V_155 = & V_2 -> V_147 [ V_41 ] ;
V_4 = F_1 ( V_2 , V_119 -> V_90 , V_31 ) ;
V_155 -> V_156 = F_4 ( V_4 ) & ~ V_92 ;
V_4 = F_1 ( V_2 , V_119 -> V_90 , V_13 ) ;
V_155 -> V_157 = F_4 ( V_4 ) ;
}
return 0 ;
}
