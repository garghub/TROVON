...
struct V_33 * F_58 ( struct V_4 * V_5 ,
struct V_83 * V_84 )
{
struct V_83 * V_85 ;
struct V_33 * V_34 ;
...
F_62 (np, child) {
V_9 [ V_75 ] . V_39 = V_75 ;
F_63 ( V_85 , L_18 , & V_9 [ V_75 ] . V_36 ) ;
F_64 ( V_85 , L_19 , & V_9 [ V_75 ] . V_22 ) ;
F_64 ( V_85 , L_20 , & V_9 [ V_75 ] . V_26 ) ;
V_9 [ V_75 ] . V_40 =
F_65 ( V_85 , L_21 , NULL ) ;
V_75 ++ ;
}
F_63 ( V_84 , L_22 , & V_34 -> V_44 ) ;
F_64 ( V_84 , L_23 , & V_34 -> V_88 ) ;
V_34 -> V_70 = F_66 ( V_84 , L_24 , 0 ) ;
F_64 ( V_84 , L_25 , ( T_1 * ) & V_34 -> V_89 ) ;
return V_34 ;
}
