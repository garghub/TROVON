...
int V_42 = V_20 -> V_183 -> V_184 ( V_20 , V_39 ) ;
if ( V_42 != V_172 )
return V_42 ;
}
...
static int F_187 ( void * V_252 , struct V_23 * V_173 ,
...
static void F_189 ( void * V_252 , struct V_23 * V_173 ,
unsigned int V_253 , unsigned int V_254 )
{
struct V_1 * V_2 = F_175 ( V_173 ) ;
F_28 ( V_2 -> V_58 ) ;
...
if ( V_139 > 65535 )
return - V_302 ;
V_300 = F_229 ( 8 + V_139 , V_256 ) ;
if ( ! V_300 )
return - V_257 ;
memcpy ( V_300 + 8 , V_33 , V_139 ) ;
V_139 += 8 ;
V_300 [ 0 ] = 0 ;
V_300 [ 1 ] = 0 ;
V_300 [ 2 ] = V_252 -> V_303 ;
...
if ( V_139 > 255 || V_252 -> V_306 > 255 ||
V_252 -> V_305 )
return - V_302 ;
V_300 = F_229 ( 4 + V_139 , V_256 ) ;
if ( ! V_300 )
return - V_257 ;
memcpy ( V_300 + 4 , V_33 , V_139 ) ;
V_139 += 4 ;
V_300 [ 0 ] = 0 ;
V_300 [ 1 ] = V_252 -> V_303 ;
V_300 [ 2 ] = V_252 -> V_304 ;
...
V_42 = F_230 ( V_20 , V_2 , V_41 , V_300 , V_139 ,
V_54 , V_36 , V_37 , NULL ) ;
F_28 ( V_300 ) ;
return V_42 ;
}
...
memset ( V_33 , 0 , V_139 ) ;
V_28 = F_230 ( V_20 , V_2 , V_189 , V_33 , V_139 ,
V_54 , V_36 , V_37 , NULL ) ;
if ( V_301 && ! F_232 ( V_28 ) &&
( F_112 ( V_28 ) & V_166 ) ) {
if ( F_233 ( V_54 ) ) {
...
V_252 -> V_171 = V_33 [ 0 ] * 256 + V_33 [ 1 ] + 2 ;
V_252 -> V_303 = V_33 [ 2 ] ;
V_252 -> V_304 = V_33 [ 3 ] ;
...
V_252 -> V_171 = V_33 [ 0 ] + 1 ;
V_252 -> V_303 = V_33 [ 1 ] ;
V_252 -> V_304 = V_33 [ 2 ] ;
V_252 -> V_306 = V_33 [ 3 ] ;
}
V_252 -> V_310 = V_310 ;
} else if ( ( F_234 ( V_28 ) == V_316 ) &&
F_233 ( V_54 ) &&
V_54 -> V_140 == V_146 && V_311 ) {
V_311 -- ;
goto V_313;
}
return V_28 ;
...
int
F_235 ( struct V_7 * V_20 , int V_36 , int V_37 ,
struct V_53 * V_317 )
{
char V_2 [] = {
V_318 , 0 , 0 , 0 , 0 , 0 ,
...
int
F_236 ( struct V_7 * V_20 , enum V_319 V_320 )
{
enum V_319 V_321 = V_20 -> V_190 ;
if ( V_320 == V_321 )
return 0 ;
switch ( V_320 ) {
case V_322 :
...
static void F_239 ( struct V_7 * V_20 , struct V_325 * V_326 )
{
int V_327 = 0 ;
char * V_328 [ 3 ] ;
switch ( V_326 -> V_329 ) {
...
V_328 [ V_327 ++ ] = NULL ;
F_240 ( & V_20 -> V_24 . V_337 , V_338 , V_328 ) ;
}
void F_241 ( struct V_79 * V_80 )
{
struct V_7 * V_20 ;
enum V_339 V_329 ;
F_47 ( V_340 ) ;
V_20 = F_59 ( V_80 , struct V_7 , V_341 ) ;
for ( V_329 = V_342 ; V_329 <= V_343 ; V_329 ++ )
if ( F_242 ( V_329 , V_20 -> V_344 ) )
F_243 ( V_20 , V_329 , V_256 ) ;
while ( 1 ) {
struct V_325 * V_326 ;
struct V_345 * V_346 , * V_69 ;
unsigned long V_26 ;
F_11 ( & V_20 -> V_108 , V_26 ) ;
F_48 ( & V_20 -> V_340 , & V_340 ) ;
F_14 ( & V_20 -> V_108 , V_26 ) ;
if ( F_49 ( & V_340 ) )
break;
F_244 (this, tmp, &event_list) {
V_326 = F_50 ( V_346 , struct V_325 , V_347 ) ;
F_245 ( & V_326 -> V_347 ) ;
F_239 ( V_20 , V_326 ) ;
F_28 ( V_326 ) ;
}
...
void F_246 ( struct V_7 * V_20 , struct V_325 * V_326 )
{
unsigned long V_26 ;
#if 0
...
#endif
F_11 ( & V_20 -> V_108 , V_26 ) ;
F_147 ( & V_326 -> V_347 , & V_20 -> V_340 ) ;
F_247 ( & V_20 -> V_341 ) ;
F_14 ( & V_20 -> V_108 , V_26 ) ;
}
struct V_325 * F_248 ( enum V_339 V_329 ,
T_2 V_348 )
{
struct V_325 * V_326 = F_26 ( sizeof( struct V_325 ) , V_348 ) ;
if ( ! V_326 )
return NULL ;
V_326 -> V_329 = V_329 ;
F_155 ( & V_326 -> V_347 ) ;
...
void F_243 ( struct V_7 * V_20 ,
enum V_339 V_329 , T_2 V_348 )
{
struct V_325 * V_326 = F_248 ( V_329 , V_348 ) ;
if ( ! V_326 ) {
F_133 ( V_194 , V_20 , L_30 ,
V_329 ) ;
return;
}
F_246 ( V_20 , V_326 ) ;
...
int
F_249 ( struct V_7 * V_20 )
{
int V_349 = F_236 ( V_20 , V_198 ) ;
if ( V_349 )
return V_349 ;
F_56 ( V_20 -> V_21 ) ;
...
static void
F_252 ( struct V_7 * V_20 , void * V_252 )
{
F_249 ( V_20 ) ;
}
void
F_253 ( struct V_8 * V_9 )
{
F_254 ( V_9 , NULL , F_252 ) ;
}
static void
F_255 ( struct V_7 * V_20 , void * V_252 )
{
F_251 ( V_20 ) ;
}
void
F_256 ( struct V_8 * V_9 )
{
F_254 ( V_9 , NULL , F_255 ) ;
}
int
F_257 ( struct V_7 * V_20 )
{
struct V_21 * V_22 = V_20 -> V_21 ;
unsigned long V_26 ;
int V_349 = 0 ;
V_349 = F_236 ( V_20 , V_196 ) ;
if ( V_349 ) {
V_349 = F_236 ( V_20 , V_197 ) ;
if ( V_349 )
return V_349 ;
}
if ( V_22 -> V_29 ) {
...
static void
F_262 ( struct V_7 * V_20 , void * V_252 )
{
F_257 ( V_20 ) ;
}
static int
F_263 ( struct V_6 * V_266 , void * V_252 )
{
if ( F_264 ( V_266 ) )
F_254 ( F_265 ( V_266 ) , NULL ,
F_262 ) ;
return 0 ;
}
void
F_266 ( struct V_6 * V_266 )
{
if ( F_264 ( V_266 ) )
F_254 ( F_265 ( V_266 ) , NULL ,
F_262 ) ;
else
F_267 ( V_266 , NULL , F_263 ) ;
}
static void
F_268 ( struct V_7 * V_20 , void * V_252 )
{
F_260 ( V_20 , * (enum V_319 * ) V_252 ) ;
}
static int
F_269 ( struct V_6 * V_266 , void * V_252 )
{
if ( F_264 ( V_266 ) )
F_254 ( F_265 ( V_266 ) , V_252 ,
F_268 ) ;
return 0 ;
}
void
F_270 ( struct V_6 * V_266 , enum V_319 V_350 )
{
if ( F_264 ( V_266 ) )
F_254 ( F_265 ( V_266 ) , & V_350 ,
F_268 ) ;
else
F_267 ( V_266 , & V_350 , F_269 ) ;
}
void * F_271 ( struct V_85 * V_86 , int V_351 ,
T_5 * V_352 , T_5 * V_139 )
{
int V_288 ;
T_5 V_353 = 0 , V_354 = 0 ;
...
F_171 ( V_194 L_31
L_32 ,
V_225 , V_353 , * V_352 , V_351 ) ;
F_272 ( 1 ) ;
return NULL ;
}
* V_352 = * V_352 - V_354 + V_235 -> V_352 ;
V_355 = F_275 ( F_276 ( V_235 ) , ( * V_352 >> V_265 ) ) ;
* V_352 &= ~ V_356 ;
V_353 = V_357 - * V_352 ;
if ( * V_139 > V_353 )
* V_139 = V_353 ;
...
void F_281 ( struct V_7 * V_20 )
{
if ( F_120 ( F_43 ( & V_20 -> V_359 ) <= 0 ) )
return;
F_32 ( & V_20 -> V_359 ) ;
}
