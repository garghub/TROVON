...
static int F_114 ( struct V_18 * V_19 , int V_184 ,
struct V_22 * V_27 )
{
struct V_13 * V_14 = F_20 ( V_19 ) ;
...
for ( V_123 = 0 ; V_123 < F_133 ( V_219 ) ; V_123 ++ ) {
sprintf ( V_218 , L_39 , V_213 , V_219 [ V_123 ] . V_213 ) ;
if ( F_134 ( V_215 , V_218 , NULL ) )
V_8 |= V_219 [ V_123 ] . V_4 ;
}
V_217 -> V_8 = V_8 ;
...
V_233 = F_138 ( V_234 , & V_226 -> V_66 ) ;
if ( V_233 ) {
V_11 = V_233 -> V_2 ;
F_132 ( L_41 , V_215 , & V_217 . V_235 , & V_226 -> V_66 ) ;
F_132 ( L_42 , V_215 , & V_217 . V_236 , & V_226 -> V_66 ) ;
}
} else {
...
V_231 = F_139 ( V_226 , V_242 , 0 ) ;
V_134 = F_140 ( V_226 , 0 ) ;
if ( ! V_231 || ( int ) V_134 <= 0 ) {
F_36 ( & V_226 -> V_66 , L_44 ) ;
return - V_241 ;
}
V_6 = F_141 ( & V_226 -> V_66 , sizeof( * V_6 ) , V_243 ) ;
if ( ! V_6 ) {
F_36 ( & V_226 -> V_66 , L_45 ) ;
return - V_244 ;
}
V_6 -> V_10 = F_142 ( & V_226 -> V_66 ,
V_231 -> V_153 , F_143 ( V_231 ) ) ;
if ( ! V_6 -> V_10 ) {
...
V_14 -> V_6 = V_6 ;
F_135 ( V_14 , & V_217 . V_235 ) ;
F_136 ( V_14 , & V_217 . V_235 ) ;
...
V_14 -> V_6 = V_6 ;
F_135 ( V_14 , & V_217 . V_236 ) ;
F_136 ( V_14 , & V_217 . V_236 ) ;
V_7 = F_38 ( V_14 , & V_226 -> V_66 ) ;
if ( V_7 < 0 ) {
...
F_145 ( & V_226 -> V_66 ) ;
F_146 ( & V_226 -> V_66 , V_6 ) ;
V_7 = F_147 ( & V_226 -> V_66 , V_134 , & F_87 , 0 ,
F_148 ( & V_226 -> V_66 ) , V_6 ) ;
if ( V_7 ) {
F_36 ( & V_226 -> V_66 , L_49 ) ;
goto V_247;
}
V_7 = F_149 ( & V_226 -> V_66 , & V_248 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_226 -> V_66 , L_50 ) ;
goto V_247;
}
V_7 = F_150 ( & V_226 -> V_66 , & V_249 ,
V_250 , F_133 ( V_250 ) ) ;
if ( V_7 < 0 ) {
...
static int F_153 ( struct V_225 * V_226 )
{
struct V_5 * V_6 ;
V_6 = F_154 ( & V_226 -> V_66 ) ;
F_152 ( & V_226 -> V_66 ) ;
F_155 ( & V_226 -> V_66 ) ;
F_151 ( & V_226 -> V_66 ) ;
F_39 ( & V_6 -> V_29 ) ;
