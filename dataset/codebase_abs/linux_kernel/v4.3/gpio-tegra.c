...
static int F_80 ( struct V_87 * V_88 , void * V_89 )
{
int V_67 ;
int V_68 ;
for ( V_67 = 0 ; V_67 < V_48 ; V_67 ++ ) {
...
static int F_82 ( struct V_90 * V_90 , struct V_91 * V_91 )
{
return F_83 ( V_91 , F_80 , & V_90 -> V_92 ) ;
}
