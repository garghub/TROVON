...
V_2 -> V_24 [ V_70 ] = F_90 ( V_74 , V_70 ) ;
V_2 -> V_46 [ V_70 ] . V_2 = V_2 ;
V_2 -> V_46 [ V_70 ] . V_28 = V_70 ;
F_91 ( & V_2 -> V_49 [ V_70 ] ) ;
V_128 = strlen ( F_92 ( V_2 -> V_11 ) ) + 16 ;
V_86 = F_79 ( V_2 -> V_11 , V_128 , V_82 ) ;
if ( ! V_86 )
return - V_83 ;
snprintf ( V_86 , V_128 , L_20 , F_92 ( V_2 -> V_11 ) , V_70 ) ;
V_95 = F_93 ( V_11 , V_2 -> V_24 [ V_70 ] ,
F_28 , V_131 ,
V_86 , & V_2 -> V_46 [ V_70 ] ) ;
if ( V_95 ) {
...
V_2 -> V_132 = F_95 ( & V_133 , V_11 , V_2 ) ;
if ( F_83 ( V_2 -> V_132 ) ) {
F_96 ( & V_2 -> V_16 ) ;
return F_84 ( V_2 -> V_132 ) ;
}
V_2 -> V_134 = V_135 ;
V_2 -> V_134 . V_4 = V_2 -> V_16 . V_4 ;
V_2 -> V_134 . V_136 = & V_2 -> V_16 ;
F_97 ( V_2 -> V_132 , & V_2 -> V_134 ) ;
return 0 ;
}
static int F_98 ( struct V_116 * V_117 )
{
struct V_1 * V_2 = F_99 ( V_117 ) ;
F_100 ( V_2 -> V_132 ) ;
F_96 ( & V_2 -> V_16 ) ;
return 0 ;
}
