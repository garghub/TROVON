...
V_4 -> V_40 += V_6 -> V_17 ;
V_6 -> V_17 = 1 ;
V_39 = ( V_4 -> V_40 * V_6 -> V_11 ) >> V_41 ;
if ( V_39 >= V_4 -> V_33 ) {
V_4 -> V_33 = F_16 ( V_4 -> V_33 + V_39 / V_4 -> V_33 ,
( T_1 ) V_4 -> V_42 ) ;
V_4 -> V_40 = 0 ;
}
}
...
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 = F_3 ( V_2 ) ;
return F_18 ( V_4 -> V_33 - ( ( V_4 -> V_33 * V_6 -> V_13 ) >> V_43 ) , 2U ) ;
}
static T_5 F_19 ( struct V_1 * V_2 , T_1 V_44 , int * V_45 ,
union V_46 * V_47 )
{
const struct V_5 * V_6 = F_3 ( V_2 ) ;
if ( V_44 & ( 1 << ( V_48 - 1 ) ) ) {
V_47 -> V_49 . V_50 = 1 ;
V_47 -> V_49 . V_51 = V_6 -> V_9 ;
V_47 -> V_49 . V_52 = V_6 -> V_15 ;
V_47 -> V_49 . V_53 = 0 ;
if ( V_47 -> V_49 . V_51 > 0 ) {
T_3 V_23 = V_6 -> V_10 ;
F_8 ( V_23 , V_47 -> V_49 . V_51 ) ;
V_47 -> V_49 . V_53 = V_23 ;
}
* V_45 = V_48 ;
