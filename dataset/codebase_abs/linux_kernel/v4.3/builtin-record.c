...
int F_83 ( const struct V_148 * V_149 ,
const char * V_150 ,
int V_151 )
{
int V_52 ;
struct V_66 * V_1 = (struct V_66 * ) V_149 -> V_152 ;
V_1 -> V_153 = true ;
V_144 . V_154 = ! V_151 ;
if ( V_151 ) {
V_144 . V_145 = V_155 ;
...
V_52 = F_84 ( V_150 , & V_144 ) ;
if ( ! V_52 )
F_82 () ;
return V_52 ;
}
int F_85 ( const struct V_148 * V_149 ,
const char * V_150 V_13 ,
int V_151 V_13 )
{
struct V_66 * V_1 = (struct V_66 * ) V_149 -> V_152 ;
V_1 -> V_153 = true ;
V_144 . V_154 = true ;
if ( V_144 . V_145 == V_155 )
V_144 . V_145 = V_156 ;
F_82 () ;
return 0 ;
}
static int F_86 ( const char * V_157 , const char * V_152 , void * V_158 )
{
if ( ! strcmp ( V_157 , L_39 ) )
V_157 = L_40 ;
return F_87 ( V_157 , V_152 , V_158 ) ;
}
static int F_88 ( const struct V_148 * V_149 , const char * V_142 , int V_151 )
{
struct V_66 * V_54 = (struct V_66 * ) V_149 -> V_152 ;
const struct V_159 * V_160 ;
const char * V_161 = V_142 ;
if ( V_151 ) {
V_54 -> V_162 = 0 ;
return 0 ;
}
...
return - 1 ;
V_54 -> V_162 = true ;
if ( sscanf ( V_142 , L_41 , & V_54 -> V_163 ) == 1 )
return 0 ;
if ( ! strncasecmp ( V_142 , L_42 , 6 ) )
V_142 += 6 ;
for ( V_160 = V_164 ; V_160 -> V_165 ; V_160 ++ ) {
if ( ! strcasecmp ( V_142 , V_160 -> V_165 ) ) {
V_54 -> V_163 = V_160 -> V_163 ;
return 0 ;
}
}
V_54 -> V_162 = false ;
...
static int F_89 ( const struct V_148 * V_149 ,
const char * V_142 ,
int V_151 V_13 )
{
struct V_66 * V_54 = V_149 -> V_152 ;
char * V_166 , * V_167 ;
unsigned int V_74 ;
int V_52 ;
if ( ! V_142 )
...
int F_92 ( int V_98 , const char * * V_99 , const char * T_9 V_13 )
{
int V_47 ;
struct V_1 * V_2 = & V_1 ;
char V_171 [ V_172 ] ;
...
return - V_169 ;
F_94 ( F_86 , V_2 ) ;
V_98 = F_95 ( V_98 , V_99 , V_173 , V_174 ,
V_175 ) ;
if ( ! V_98 && F_65 ( & V_2 -> V_54 . V_72 ) )
F_96 ( V_174 , V_173 ) ;
if ( V_176 && ! V_2 -> V_54 . V_72 . V_177 ) {
F_32 ( L_44
L_45 ) ;
F_96 ( V_174 , V_173 ) ;
}
...
if ( ! V_2 -> V_53 ) {
V_2 -> V_53 = F_98 ( V_2 -> V_19 , & V_47 ) ;
if ( V_47 )
return V_47 ;
}
V_47 = F_99 ( V_2 -> V_53 , & V_2 -> V_54 ,
V_2 -> V_54 . V_179 ) ;
if ( V_47 )
return V_47 ;
V_47 = - V_169 ;
...
if ( V_2 -> V_54 . V_72 . V_184 && ! V_2 -> V_54 . V_185 )
V_2 -> V_54 . V_186 = true ;
V_47 = F_103 ( & V_2 -> V_54 . V_72 ) ;
if ( V_47 ) {
F_104 ( & V_2 -> V_54 . V_72 , V_47 , V_171 , V_172 ) ;
F_30 ( L_55 , V_171 ) ;
}
V_47 = F_105 ( & V_2 -> V_54 . V_72 ) ;
if ( V_47 ) {
int V_187 = V_70 ;
F_104 ( & V_2 -> V_54 . V_72 , V_47 , V_171 , V_172 ) ;
F_32 ( L_55 , V_171 ) ;
...
V_47 = - V_169 ;
if ( F_106 ( V_2 -> V_19 , & V_2 -> V_54 . V_72 ) < 0 )
F_96 ( V_174 , V_173 ) ;
V_47 = F_107 ( V_2 -> V_53 , V_2 -> V_19 , & V_2 -> V_54 ) ;
if ( V_47 )
goto V_183;
if ( F_108 ( & V_2 -> V_54 ) ) {
V_47 = - V_168 ;
