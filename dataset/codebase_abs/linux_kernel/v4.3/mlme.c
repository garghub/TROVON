...
int V_158 , V_71 ;
V_149 = F_68 ( V_148 , struct V_149 , V_148 ) ;
...
continue;
V_156 = V_154 -> V_166 + F_100 (
V_167 ) ;
if ( F_101 ( V_168 , V_156 ) ) {
V_154 -> V_164 = V_169 ;
V_154 -> V_166 = V_168 ;
F_102 ( & V_151 , V_154 ,
V_170 ) ;
...
F_70 () ;
if ( V_155 )
F_104 ( V_172 , & V_13 -> V_159 ,
V_157 ) ;
}
void F_105 ( struct V_11 * V_11 ,
struct V_150 * V_151 ,
T_4 V_40 )
{
struct V_12 * V_13 = F_2 ( V_11 ) ;
unsigned long V_156 ;
F_106 ( V_11 , V_151 ) ;
F_107 ( V_11 , V_151 , V_165 ) ;
V_156 = F_100 ( V_167 ) ;
F_104 ( V_172 , & V_13 -> V_159 ,
V_156 ) ;
F_103 ( V_13 , V_151 , V_173 , NULL , V_40 ) ;
}
void F_108 ( struct V_1 * V_25 ,
...
V_156 = V_9 -> V_178 +
F_100 ( V_9 -> V_179 ) ;
F_22 ( ! F_101 ( V_168 , V_156 ) ) ;
F_107 ( V_11 , V_151 , V_180 ) ;
break;
case V_181 :
break;
default:
...
V_9 -> V_176 = false ;
F_103 ( V_13 , V_151 , V_175 , V_25 , V_40 ) ;
}
