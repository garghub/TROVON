...
bool V_69 = false ;
struct V_20 * V_70 ;
T_1 V_71 = V_65 -> V_72 / V_67 -> V_54 . V_49 ;
T_1 V_73 , V_74 ;
T_1 T_3 V_75 ;
T_4 V_76 ;
T_2 V_41 = V_77 ;
V_76 = V_65 -> V_78 * V_67 -> V_48 ;
V_73 = F_32 ( V_76 , V_29 ) ;
V_74 = V_76 ;
V_68 = F_30 ( V_3 , V_74 ) ;
if ( ! V_68 )
...
V_68 -> V_37 ] ;
if ( V_66 )
V_41 = F_33 ( V_65 , V_65 -> V_78 , V_71 , 0 ,
V_70 , V_73 ) ;
else
V_41 = F_33 ( V_65 , V_65 -> V_78 , V_71 , 0 ,
V_65 -> V_79 , 0 ) ;
if ( ! V_41 )
F_34 ( V_65 , V_71 , V_66 , V_70 , V_73 ) ;
if ( V_69 )
F_8 ( V_70 ) ;
return V_41 ;
}
...
return - V_9 ;
V_105 = V_107 ;
while ( ( V_106 = F_44 ( & V_107 , L_32 ) ) != NULL ) {
if ( ! * V_106 )
continue;
