...
{
struct V_34 * V_34 = F_35 ( V_73 -> V_74 ? V_73 -> V_74 : V_73 -> V_75 ) ;
const struct V_76 * V_77 = V_73 -> V_78 ;
union V_6 V_1 ;
struct V_28 V_29 ;
const struct V_28 * V_79 = & V_29 ;
const struct V_35 * V_36 = & V_80 ;
enum V_81 V_82 ;
const struct V_12 * V_83 ;
unsigned int V_84 ;
V_83 = F_36 ( V_71 , & V_82 ) ;
if ( V_83 != NULL ) {
V_79 = & V_83 -> V_85 [ V_86 ] . V_29 ;
V_36 = F_37 ( V_83 ) ;
} else if ( ! F_38 ( V_71 , F_39 ( V_71 ) ,
V_73 -> V_21 , & V_29 ) ) {
goto V_87;
}
if ( V_73 -> V_21 == V_65 ) {
const struct V_88 * V_89 = F_40 ( V_71 ) ;
memcpy ( & V_1 . V_10 , ( V_77 -> V_90 & V_91 ) ?
& V_89 -> V_92 : & V_89 -> V_93 , sizeof( V_1 . V_10 ) ) ;
} else {
const struct V_94 * V_89 = F_41 ( V_71 ) ;
V_1 . V_23 = ( V_77 -> V_90 & V_91 ) ?
V_89 -> V_92 : V_89 -> V_93 ;
}
V_84 = F_31 ( V_34 , V_77 -> V_63 , V_79 , & V_1 ,
& V_77 -> V_7 , V_73 -> V_21 , V_36 ) ;
if ( V_84 == 0 )
goto V_87;
return ( V_84 > V_77 -> V_95 ) ^
! ! ( V_77 -> V_90 & V_96 ) ;
V_87:
V_73 -> V_87 = true ;
return false ;
}
static int F_42 ( const struct V_97 * V_73 )
{
...
V_77 -> V_63 = F_48 ( sizeof( struct V_62 ) , V_99 ) ;
if ( V_77 -> V_63 == NULL ) {
F_49 ( V_73 -> V_21 ) ;
return - V_100 ;
}
for ( V_9 = 0 ; V_9 < F_4 ( V_77 -> V_63 -> V_67 ) ; ++ V_9 )
V_77 -> V_63 -> V_67 [ V_9 ] = V_101 ;
for ( V_9 = 0 ; V_9 < F_4 ( V_77 -> V_63 -> V_66 ) ; ++ V_9 )
V_77 -> V_63 -> V_66 [ V_9 ] = V_101 ;
return 0 ;
}
static void F_50 ( struct V_44 * V_102 )
{
struct V_30 * V_13 ;
struct V_46 * V_49 ;
struct V_40 * V_41 ;
struct V_52 * V_33 ;
while ( ( V_33 = F_51 ( V_102 ) ) != NULL ) {
...
static void F_52 ( const struct V_103 * V_73 )
{
const struct V_76 * V_77 = V_73 -> V_78 ;
unsigned int V_9 ;
F_49 ( V_73 -> V_21 ) ;
for ( V_9 = 0 ; V_9 < F_4 ( V_77 -> V_63 -> V_67 ) ; ++ V_9 )
F_50 ( & V_77 -> V_63 -> V_67 [ V_9 ] ) ;
for ( V_9 = 0 ; V_9 < F_4 ( V_77 -> V_63 -> V_66 ) ; ++ V_9 )
F_50 ( & V_77 -> V_63 -> V_66 [ V_9 ] ) ;
F_53 ( V_77 -> V_63 ) ;
}
