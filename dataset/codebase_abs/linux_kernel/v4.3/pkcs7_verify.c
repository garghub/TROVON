...
goto error;
V_28 = V_33 | V_34 ;
V_12 = F_14 ( V_8 , & V_28 , 1 ) ;
if ( V_12 < 0 )
goto error;
V_12 = F_10 ( V_8 , V_4 -> V_27 ,
V_4 -> V_35 , V_11 ) ;
if ( V_12 < 0 )
goto error;
F_11 ( L_6 , 8 , V_11 ) ;
...
V_49 = V_37 -> V_56 ;
if ( V_49 ) {
F_13 ( L_19 , V_49 -> V_46 , V_49 -> V_25 ) ;
for ( V_47 = V_2 -> V_39 ; V_47 ; V_47 = V_47 -> V_40 ) {
F_13 ( L_20 ,
V_47 -> V_13 , V_47 -> V_41 -> V_46 , V_47 -> V_41 -> V_25 ) ;
if ( F_19 ( V_47 -> V_41 , V_49 ) )
goto V_62;
}
} else {
V_49 = V_37 -> V_57 ;
...
V_12 = F_26 ( V_4 -> V_45 -> V_43 , & V_4 -> V_14 ) ;
if ( V_12 < 0 )
return V_12 ;
F_11 ( L_28 , V_4 -> V_13 ) ;
return F_20 ( V_2 , V_4 ) ;
