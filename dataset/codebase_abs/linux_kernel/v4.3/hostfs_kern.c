...
static const char * F_122 ( struct V_9 * V_9 , void * * V_185 )
{
char * V_18 = F_11 () ;
if ( V_18 ) {
char * V_186 = F_10 ( V_9 ) ;
...
static void F_123 ( struct V_2 * V_187 , void * V_185 )
{
F_7 ( V_185 ) ;
}
static int F_124 ( struct V_26 * V_27 , void * V_188 , int V_189 )
{
struct V_2 * V_190 ;
char * V_191 , * V_192 = V_188 ;
int V_30 ;
V_27 -> V_193 = 1024 ;
V_27 -> V_194 = 10 ;
V_27 -> V_195 = V_40 ;
...
V_30 = - V_22 ;
V_27 -> V_16 = V_191 =
F_17 ( strlen ( V_7 ) + strlen ( V_192 ) + 2 , V_25 ) ;
if ( V_191 == NULL )
goto V_86;
sprintf ( V_191 , L_6 , V_7 , V_192 ) ;
V_190 = F_21 ( V_27 ) ;
if ( ! V_190 )
goto V_86;
V_30 = F_74 ( V_190 , V_191 ) ;
if ( V_30 )
goto V_131;
if ( F_125 ( V_190 -> V_117 ) ) {
char * V_10 = F_15 ( V_191 ) ;
if ( F_6 ( V_10 ) )
V_30 = F_82 ( V_10 ) ;
else
V_30 = F_74 ( V_190 , V_10 ) ;
F_18 ( V_10 ) ;
if ( V_30 )
goto V_131;
}
V_30 = - V_22 ;
V_27 -> V_202 = F_126 ( V_190 ) ;
if ( V_27 -> V_202 == NULL )
goto V_86;
return 0 ;
V_131:
...
static struct V_9 * F_127 ( struct V_203 * type ,
int V_88 , const char * V_204 ,
void * V_205 )
{
return F_128 ( type , V_88 , V_205 , F_124 ) ;
}
static void F_129 ( struct V_26 * V_206 )
{
F_130 ( V_206 ) ;
F_18 ( V_206 -> V_16 ) ;
}
