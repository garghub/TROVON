...
#ifdef F_94
F_114 ( ! V_122 -> V_108 ) ;
F_114 ( ( unsigned long ) V_110 & ~ V_161 ) ;
#endif
F_114 ( ! V_6 ) ;
F_114 ( ( unsigned long ) V_6 & ~ V_161 ) ;
F_114 ( V_122 -> V_142 < V_154 ) ;
F_114 ( V_122 -> V_142 & ~ V_161 ) ;
F_114 ( V_122 -> V_142 < V_92 ) ;
F_114 ( V_122 -> V_144 < V_162 ) ;
F_114 ( F_115 ( V_122 ) < 0 ) ;
V_157 = F_116 ( V_122 -> V_120 *
sizeof( V_157 [ 0 ] ) , 0 ) ;
V_158 = F_116 ( V_122 -> V_120 *
sizeof( V_158 [ 0 ] ) , 0 ) ;
V_160 = F_116 ( V_163 * sizeof( V_160 [ 0 ] ) , 0 ) ;
V_159 = F_116 ( V_163 * sizeof( V_159 [ 0 ] ) , 0 ) ;
...
F_114 ( V_20 >= V_163 ) ;
F_114 ( ! F_117 ( V_20 ) ) ;
F_114 ( V_160 [ V_20 ] != V_164 ) ;
V_160 [ V_20 ] = V_125 + V_33 ;
V_159 [ V_20 ] = V_147 -> V_165 + V_33 * V_122 -> V_142 ;
if ( V_117 == V_128 ||
...
V_155 = F_116 ( V_81 , 0 ) ;
F_50 ( & V_155 -> V_43 ) ;
F_51 ( & V_155 -> V_50 , F_40 ) ;
V_155 -> V_6 = V_6 ;
V_155 -> V_35 = V_150 ;
V_155 -> V_48 = F_119 ( V_150 ) ;
V_155 -> V_98 = true ;
...
static int T_6 F_121 ( char * V_172 )
{
if ( ! V_172 )
return - V_173 ;
if ( 0 )
;
#ifdef F_122
else if ( ! strcmp ( V_172 , L_17 ) )
V_174 = V_175 ;
#endif
#ifdef F_123
else if ( ! strcmp ( V_172 , L_18 ) )
V_174 = V_176 ;
#endif
else
F_75 ( L_19 , V_172 ) ;
...
static int V_179 [ V_128 ] V_152 ;
const T_2 V_108 = V_109 - V_110 ;
int V_120 = 1 , V_121 = 0 ;
T_2 V_154 , V_180 , V_141 ;
int V_139 , V_181 , V_182 ( V_183 ) ;
int V_184 , V_137 , V_125 ;
unsigned int V_20 , V_185 ;
struct V_119 * V_122 ;
unsigned int * V_127 ;
memset ( V_178 , 0 , sizeof( V_178 ) ) ;
memset ( V_179 , 0 , sizeof( V_179 ) ) ;
V_154 = F_105 ( V_108 + V_143 +
F_30 ( T_2 , V_144 , V_162 ) ) ;
V_144 = V_154 - V_108 - V_143 ;
V_180 = F_30 ( T_2 , V_154 , V_92 ) ;
V_141 = F_125 ( V_180 , V_145 ) ;
V_139 = V_141 / V_180 ;
while ( V_141 % V_139 || ( ( V_141 / V_139 ) & ~ V_161 ) )
V_139 -- ;
V_181 = V_139 ;
F_72 (cpu) {
V_137 = 0 ;
...
if ( V_20 == V_185 )
break;
if ( V_178 [ V_185 ] == V_137 && V_177 &&
( V_177 ( V_20 , V_185 ) > V_187 ||
V_177 ( V_185 , V_20 ) > V_187 ) ) {
V_137 ++ ;
...
V_184 = V_188 ;
for ( V_139 = V_181 ; V_139 ; V_139 -- ) {
int V_189 = 0 , V_190 = 0 ;
if ( V_141 % V_139 || ( ( V_141 / V_139 ) & ~ V_161 ) )
continue;
for ( V_137 = 0 ; V_137 < V_120 ; V_137 ++ ) {
int V_191 = F_126 ( V_179 [ V_137 ] , V_139 ) ;
V_189 += V_191 ;
V_190 += V_191 * V_139 - V_179 [ V_137 ] ;
}
if ( V_190 > F_109 () / 3 )
continue;
if ( V_189 > V_184 )
...
V_122 -> V_145 = V_145 ;
V_122 -> V_141 = V_141 ;
for ( V_137 = 0 , V_125 = 0 ; V_179 [ V_137 ] ; V_137 ++ ) {
struct V_146 * V_147 = & V_122 -> V_126 [ V_137 ] ;
V_147 -> V_165 = V_125 * V_122 -> V_142 ;
F_72 (cpu)
if ( V_178 [ V_20 ] == V_137 )
...
T_10 V_193 )
{
void * V_111 = ( void * ) V_194 ;
void * * V_195 = NULL ;
struct V_119 * V_122 ;
T_2 V_154 , V_196 , V_197 ;
int V_137 , V_33 , V_198 ;
V_122 = F_124 ( V_143 , V_144 , V_145 ,
V_177 ) ;
if ( F_129 ( V_122 ) )
return F_130 ( V_122 ) ;
V_154 = V_122 -> V_108 + V_122 -> V_143 + V_122 -> V_144 ;
V_196 = F_105 ( V_122 -> V_120 * sizeof( void * ) ) ;
V_195 = F_104 ( V_196 , 0 ) ;
if ( ! V_195 ) {
V_198 = - V_58 ;
goto V_199;
...
V_20 = V_147 -> V_127 [ V_33 ] ;
F_48 ( V_20 == V_128 ) ;
V_32 = V_192 ( V_20 , V_147 -> V_121 * V_122 -> V_142 , V_145 ) ;
if ( ! V_32 ) {
V_198 = - V_58 ;
goto V_200;
}
...
for ( V_137 = 0 ; V_137 < V_122 -> V_120 ; V_137 ++ ) {
struct V_146 * V_147 = & V_122 -> V_126 [ V_137 ] ;
void * V_32 = V_195 [ V_137 ] ;
for ( V_33 = 0 ; V_33 < V_147 -> V_121 ; V_33 ++ , V_32 += V_122 -> V_142 ) {
if ( V_147 -> V_127 [ V_33 ] == V_128 ) {
V_193 ( V_32 , V_122 -> V_142 ) ;
continue;
}
memcpy ( V_32 , V_201 , V_122 -> V_108 ) ;
V_193 ( V_32 + V_154 , V_122 -> V_142 - V_154 ) ;
}
}
V_197 = 0 ;
for ( V_137 = 0 ; V_137 < V_122 -> V_120 ; V_137 ++ ) {
V_122 -> V_126 [ V_137 ] . V_165 = V_195 [ V_137 ] - V_111 ;
V_197 = F_30 ( T_2 , V_197 ,
V_122 -> V_126 [ V_137 ] . V_165 ) ;
}
V_197 += V_122 -> V_142 ;
if ( V_197 > V_202 * 3 / 4 ) {
F_75 ( L_20
...
F_77 ( L_22 ,
F_31 ( V_154 ) , V_111 , V_122 -> V_108 , V_122 -> V_143 ,
V_122 -> V_144 , V_122 -> V_142 ) ;
V_198 = F_113 ( V_122 , V_111 ) ;
goto V_199;
V_200:
for ( V_137 = 0 ; V_137 < V_122 -> V_120 ; V_137 ++ )
if ( V_195 [ V_137 ] )
...
T_2 V_208 ;
struct V_17 * * V_209 ;
int V_125 , V_33 , V_78 , V_198 ;
snprintf ( V_206 , sizeof( V_206 ) , L_23 , V_30 >> 10 ) ;
V_122 = F_124 ( V_143 , 0 , V_30 , NULL ) ;
if ( F_129 ( V_122 ) )
return F_130 ( V_122 ) ;
F_48 ( V_122 -> V_120 != 1 ) ;
F_48 ( V_122 -> V_126 [ 0 ] . V_121 != F_109 () ) ;
V_207 = V_122 -> V_142 >> V_25 ;
V_208 = F_105 ( V_207 * F_109 () *
sizeof( V_209 [ 0 ] ) ) ;
V_209 = F_116 ( V_208 , 0 ) ;
V_78 = 0 ;
...
V_205 . V_57 = V_211 ;
V_205 . V_9 = F_109 () * V_122 -> V_142 ;
F_134 ( & V_205 , V_30 ) ;
for ( V_125 = 0 ; V_125 < F_109 () ; V_125 ++ ) {
unsigned long V_212 =
( unsigned long ) V_205 . V_3 + V_125 * V_122 -> V_142 ;
for ( V_33 = 0 ; V_33 < V_207 ; V_33 ++ )
V_203 ( V_212 + ( V_33 << V_25 ) ) ;
V_198 = F_135 ( V_212 , & V_209 [ V_125 * V_207 ] ,
V_207 ) ;
if ( V_198 < 0 )
F_136 ( L_26 , V_198 ) ;
memcpy ( ( void * ) V_212 , V_201 , V_122 -> V_108 ) ;
}
F_77 ( L_27 ,
V_207 , V_206 , V_205 . V_3 , V_122 -> V_108 ,
V_122 -> V_143 , V_122 -> V_144 ) ;
V_198 = F_113 ( V_122 , V_205 . V_3 ) ;
goto V_213;
V_210:
while ( -- V_78 >= 0 )
V_193 ( F_137 ( V_209 [ V_78 ] ) , V_30 ) ;
V_198 = - V_58 ;
V_213:
F_107 ( F_98 ( V_209 ) , V_208 ) ;
F_106 ( V_122 ) ;
return V_198 ;
}
...
if ( V_198 < 0 )
F_136 ( L_28 ) ;
V_215 = ( unsigned long ) V_112 - ( unsigned long ) V_110 ;
F_72 (cpu)
