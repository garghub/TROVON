...
int V_48 ;
V_74 -> V_76 = NULL ;
V_141 = ( F_101 () || F_102 () ) ? V_142 : V_143 ;
V_46 = F_103 ( sizeof( * V_46 ) , V_141 ) ;
if ( ! V_46 )
goto V_144;
V_46 -> V_72 = F_104 ( struct V_110 , V_141 ) ;
if ( ! V_46 -> V_72 )
goto V_145;
F_105 (cpu) {
...
static int
F_110 ( struct V_24 * V_25 , T_3 V_146 , T_3 V_147 , int V_148 )
{
if ( V_147 == V_116 )
V_42 = ! V_148 ;
return 0 ;
...
static T_6
F_111 ( struct V_149 * V_150 , const char T_7 * V_151 , T_4 V_152 ,
T_8 * V_153 )
{
unsigned long V_137 ;
int V_2 ;
V_2 = F_112 ( V_151 , V_152 , 10 , & V_137 ) ;
if ( V_2 )
return V_2 ;
V_49 = V_137 ;
* V_153 += V_152 ;
...
static T_6
F_113 ( struct V_149 * V_150 , char T_7 * V_151 , T_4 V_152 ,
T_8 * V_153 )
{
char V_154 [ 15 ] ;
int V_155 ;
V_155 = sprintf ( V_154 , L_50 , V_49 ) ;
return F_114 ( V_151 , V_152 , V_153 , V_154 , V_155 ) ;
}
...
if ( F_117 ( V_157 ) )
return 0 ;
F_118 ( L_51 , 0644 , V_157 ,
NULL , & V_158 ) ;
return 0 ;
}
static T_9 int F_119 ( void )
{
V_59 = snprintf ( NULL , 0 , L_4 , V_159 - 1 ) ;
if ( ! F_120 ( & V_160 ) ) {
F_107 ( L_52 ) ;
return 1 ;
}
