...
V_90 -> V_141 = V_90 -> V_97 * V_90 -> V_138 ;
V_90 -> V_142 |= V_143 ;
V_44:
return V_8 ;
}
static T_1
F_23 ( struct V_144 * V_145 ,
struct V_115 * * V_7 ,
unsigned long * V_26 , T_7 * V_116 )
{
struct V_146 * V_118 ;
...
unsigned long V_119 ;
V_119 = V_145 -> V_118 ;
V_118 = (struct V_146 * ) V_119 ;
V_8 = V_12 -> V_13 ( V_145 -> V_120 , V_145 ,
V_118 -> V_118 , V_26 , V_7 ) ;
if ( V_8 != V_16 )
return V_8 ;
* V_116 = V_118 -> V_121 ;
...
static T_1
F_26 ( void * * V_147 , unsigned long V_26 , T_7 * V_126 , T_7 * V_127 )
{
struct V_148 * V_149 = NULL , * V_150 ;
T_6 V_151 = V_152 ;
unsigned long V_153 ;
T_7 * V_82 = ( T_7 * ) V_147 ; ;
T_1 V_8 ;
int V_84 ;
V_150 = NULL ;
V_153 = V_26 / sizeof( T_7 ) ;
for ( V_84 = 0 ; V_84 < V_153 ; V_84 ++ ) {
T_6 V_154 = V_81 ;
T_7 V_155 , V_5 , V_156 , V_157 ;
void * V_158 ;
T_7 V_3 = V_82 [ V_84 ] ;
V_8 = F_4 ( V_37 , V_3 ,
& V_151 , ( void * * ) & V_149 ) ;
if ( V_8 != V_16 )
continue;
F_4 ( V_37 , V_3 , & V_154 , & V_158 ) ;
V_8 = V_12 -> V_13 ( ( unsigned long ) V_149 -> V_159 , V_149 ,
& V_155 , & V_5 , & V_156 , & V_157 ) ;
if ( V_8 == V_16 && ( ! V_150 || V_158 ) ) {
* V_126 = V_155 ;
* V_127 = V_5 ;
if ( V_158 )
break;
...
static T_1
F_27 ( void * * V_147 , unsigned long V_26 , T_7 * V_126 , T_7 * V_127 )
{
struct V_148 * V_149 = NULL , * V_150 ;
T_6 V_151 = V_152 ;
unsigned long V_153 ;
...
static T_1 F_28 ( struct V_89 * V_90 , T_6 * V_151 ,
unsigned long V_26 )
{
T_1 V_8 ;
T_7 V_126 , V_127 ;
...
V_8 = F_4 ( V_86 ,
V_87 ,
V_151 , NULL , & V_26 , V_147 ) ;
if ( V_8 != V_16 )
goto V_88;
V_127 = 0 ;
V_126 = 0 ;
if ( V_12 -> V_25 )
V_8 = F_27 ( V_147 , V_26 , & V_126 , & V_127 ) ;
else
V_8 = F_26 ( V_147 , V_26 , & V_126 , & V_127 ) ;
if ( ! V_126 && ! V_127 )
goto V_88;
V_90 -> V_136 = V_137 ;
V_90 -> V_96 = 32 ;
...
V_8 = F_4 ( V_86 ,
V_87 ,
& V_160 , NULL , & V_26 , V_123 ) ;
if ( V_8 == V_19 )
V_8 = F_25 ( V_90 , & V_160 , V_26 ) ;
if ( V_8 != V_16 ) {
V_26 = 0 ;
V_8 = F_4 ( V_86 ,
V_87 ,
& V_151 , NULL , & V_26 , V_147 ) ;
if ( V_8 == V_19 )
F_28 ( V_90 , & V_151 , V_26 ) ;
}
}
struct V_77 * F_30 ( struct V_162 * V_163 )
{
struct V_77 * V_77 ;
struct V_164 * V_165 ;
struct V_166 * V_85 ;
...
V_3 = ( void * ) ( unsigned long ) V_12 -> V_177 ;
if ( V_17 -> V_85 . V_178 != V_179 )
return NULL ;
if ( V_12 -> V_25 )
F_31 ( V_12 ) ;
else
...
V_168 = & V_77 -> V_167 ;
V_165 = & V_77 -> V_164 ;
memcpy ( & V_85 -> V_180 , V_33 -> V_181 + 512 , 512 ) ;
V_85 -> V_182 = 1 ;
V_85 -> V_183 = 0xffff ;
V_85 -> V_184 = 0xAA55 ;
V_85 -> V_185 = 0x21 ;
V_172 = F_34 ( V_17 , V_33 , & V_171 ) ;
if ( ! V_172 )
goto V_186;
V_85 -> V_187 = ( unsigned long ) V_172 ;
V_77 -> V_188 = ( T_3 ) ( unsigned long ) V_172 >> 32 ;
V_85 -> V_189 = 0 ;
V_85 -> V_176 = 0 ;
...
if ( V_8 != V_16 )
goto V_190;
V_85 -> V_189 = V_175 & 0xffffffff ;
V_85 -> V_176 = V_176 & 0xffffffff ;
V_77 -> V_194 = ( T_3 ) V_175 >> 32 ;
V_77 -> V_195 = ( T_3 ) V_176 >> 32 ;
return V_77 ;
V_190:
F_37 ( V_17 , V_171 , V_85 -> V_187 ) ;
V_186:
...
struct V_167 * V_168 = & V_78 -> V_167 ;
struct V_199 * V_202 = NULL ;
T_7 V_197 ;
T_7 V_203 ;
int V_84 ;
V_197 = 0 ;
V_203 = V_168 -> V_204 / V_168 -> V_205 ;
for ( V_84 = 0 ; V_84 < V_203 ; V_84 ++ ) {
T_20 * V_206 ;
unsigned int V_207 = 0 ;
unsigned long V_119 = V_168 -> V_208 ;
#ifdef F_40
V_119 |= ( T_3 ) V_168 -> V_209 << 32 ;
#endif
V_206 = ( T_20 * ) ( V_119 + ( V_84 * V_168 -> V_205 ) ) ;
switch ( V_206 -> type ) {
case V_210 :
case V_211 :
case V_212 :
...
( V_202 -> V_27 + V_202 -> V_26 ) == V_206 -> V_230 ) {
V_202 -> V_26 += V_206 -> V_231 << 12 ;
continue;
}
if ( V_197 == F_41 ( V_78 -> V_201 ) ) {
T_7 V_232 = ( V_203 - V_84 ) * sizeof( struct V_199 ) +
sizeof( struct V_62 ) ;
if ( ! V_196 || V_200 < V_232 )
return V_19 ;
V_201 = (struct V_199 * ) V_196 -> V_60 ;
}
V_201 -> V_27 = V_206 -> V_230 ;
V_201 -> V_26 = V_206 -> V_231 << V_233 ;
V_201 -> type = V_207 ;
V_202 = V_201 ++ ;
V_197 ++ ;
}
if ( V_197 > F_41 ( V_78 -> V_201 ) ) {
T_7 V_234 = V_197 - F_41 ( V_78 -> V_201 ) ;
F_38 ( V_78 , V_196 , V_234 ) ;
V_197 -= V_234 ;
}
V_78 -> V_235 = ( T_14 ) V_197 ;
return V_16 ;
}
static T_1 F_42 ( T_7 V_203 , struct V_62 * * V_196 ,
T_7 * V_200 )
{
T_1 V_8 ;
unsigned long V_26 ;
...
void * V_3 , bool V_25 )
{
struct V_167 * V_168 = & V_77 -> V_167 ;
unsigned long V_236 , V_237 , V_238 ;
T_20 * V_239 ;
struct V_62 * V_196 ;
const char * V_178 ;
T_21 V_200 ;
...
V_200 = 0 ;
V_243:
V_8 = F_44 ( V_17 , & V_239 , & V_236 , & V_238 ,
& V_241 , & V_237 ) ;
if ( V_8 != V_16 )
return V_8 ;
V_240 = V_203 ;
V_203 = V_236 / V_238 ;
if ( V_203 > V_240 &&
V_203 > F_41 ( V_77 -> V_201 ) ) {
T_7 V_234 = V_203 - F_41 ( V_77 -> V_201 ) ;
V_8 = F_42 ( V_234 , & V_196 , & V_200 ) ;
if ( V_8 != V_16 )
goto V_244;
F_4 ( V_23 , V_239 ) ;
goto V_243;
}
V_178 = V_25 ? V_245 : V_246 ;
memcpy ( & V_168 -> V_247 , V_178 , sizeof( T_21 ) ) ;
V_168 -> V_248 = ( unsigned long ) V_17 ;
V_168 -> V_205 = V_238 ;
V_168 -> V_249 = V_241 ;
V_168 -> V_208 = ( unsigned long ) V_239 ;
V_168 -> V_204 = V_236 ;
#ifdef F_40
V_168 -> V_250 = ( unsigned long ) V_17 >> 32 ;
V_168 -> V_209 = ( unsigned long ) V_239 >> 32 ;
#endif
V_8 = F_4 ( V_251 , V_3 , V_237 ) ;
if ( V_8 != V_16 ) {
if ( V_242 )
goto V_244;
V_242 = true ;
...
struct V_77 * F_45 ( struct V_162 * V_163 ,
struct V_77 * V_77 )
{
struct V_253 * V_254 = NULL ;
T_19 * V_33 ;
struct V_166 * V_85 = & V_77 -> V_85 ;
T_1 V_8 ;
struct V_255 * V_256 ;
void * V_3 ;
T_9 * V_257 ;
bool V_25 ;
V_12 = V_163 ;
V_257 = ( T_9 * ) ( unsigned long ) V_12 -> V_39 ;
V_3 = ( void * ) ( unsigned long ) V_12 -> V_177 ;
V_25 = V_12 -> V_25 ;
V_17 = V_257 ;
if ( V_17 -> V_85 . V_178 != V_179 )
...
F_19 ( V_77 ) ;
V_8 = F_4 ( V_21 , V_22 ,
sizeof( * V_254 ) , ( void * * ) & V_254 ) ;
if ( V_8 != V_16 ) {
F_2 ( V_17 , L_16 ) ;
goto V_186;
}
V_254 -> V_26 = 0x800 ;
V_8 = F_33 ( V_17 , V_254 -> V_26 , 8 ,
( unsigned long * ) & V_254 -> V_258 ) ;
if ( V_8 != V_16 ) {
F_2 ( V_17 , L_17 ) ;
goto V_186;
}
if ( V_85 -> V_259 != V_85 -> V_260 ) {
unsigned long V_261 = V_85 -> V_260 ;
V_8 = F_46 ( V_17 , & V_261 ,
V_85 -> V_262 , V_85 -> V_262 ,
V_85 -> V_259 ,
V_85 -> V_263 ) ;
if ( V_8 != V_16 ) {
F_2 ( V_17 , L_18 ) ;
...
memset ( ( char * ) V_254 -> V_258 , 0x0 , V_254 -> V_26 ) ;
V_256 = (struct V_255 * ) V_254 -> V_258 ;
V_256 += 2 ;
V_256 -> V_264 = 0xffff ;
V_256 -> V_265 = 0x0000 ;
V_256 -> V_266 = 0x0000 ;
V_256 -> type = V_267 | V_268 ;
V_256 -> V_269 = V_270 ;
V_256 -> V_271 = 0 ;
V_256 -> V_272 = 1 ;
V_256 -> V_273 = 0xf ;
