...
int F_67 ( struct V_66 * V_66 , int V_108 )
{
struct V_2 * V_3 = V_66 -> V_3 ;
struct V_1 * V_20 = F_1 ( V_3 ) ;
T_1 V_109 = 0 , V_110 = 0 ;
...
F_11 ( & V_3 -> V_7 ) ;
F_68 ( V_3 -> V_4 -> V_5 ) ;
F_16 ( V_20 , V_22 , V_109 ) ;
F_29 ( V_3 , V_110 , V_110 ) ;
F_31 ( V_3 , L_13 , V_23 ,
F_46 ( V_3 -> V_4 -> V_5 ) + V_40 , V_110 ) ;
if ( V_16 )
F_2 ( V_3 -> V_7 . V_6 ) ;
return 0 ;
}
...
{
struct V_66 * V_66 ;
V_66 = F_72 ( sizeof( * V_66 ) , V_112 ) ;
if ( ! V_66 )
return - V_113 ;
V_66 -> V_114 = F_73 ( L_25 , 0 , 0 , F_74 ( V_3 ) ) ;
if ( ! V_66 -> V_114 )
goto abort;
V_66 -> V_3 = V_3 ;
F_75 ( & V_66 -> V_115 ) ;
F_75 ( & V_66 -> V_116 ) ;
F_76 ( & V_66 -> V_117 , V_118 ) ;
V_3 -> V_66 = V_66 ;
return 0 ;
abort:
F_77 ( V_66 ) ;
...
if ( ! V_55 )
return;
F_15 ( V_3 , L_26 , V_3 -> V_120 ) ;
F_14 ( V_20 , V_22 , & V_119 ) ;
F_15 ( V_3 , L_27 , V_119 ) ;
F_14 ( V_20 , V_40 , & V_119 ) ;
F_15 ( V_3 , L_28 , V_119 ) ;
}
struct V_2 * F_82 ( struct V_121 * V_86 )
{
struct V_2 * V_3 ;
T_2 V_120 , V_122 ;
struct V_1 * V_20 = V_86 -> V_5 ;
V_3 = F_72 ( sizeof( * V_3 ) , V_112 ) ;
if ( ! V_3 ) {
F_83 ( & V_86 -> V_123 , L_29 , V_23 ) ;
goto abort;
}
V_3 -> V_4 = V_86 ;
F_84 ( V_20 , V_124 , & V_120 ) ;
V_3 -> V_120 = V_120 ;
F_75 ( & V_3 -> V_39 ) ;
F_85 ( & V_3 -> V_35 ) ;
F_81 ( V_3 ) ;
F_84 ( V_20 , V_125 , & V_122 ) ;
if ( V_122 & V_126 )
V_3 -> V_58 = 1 ;
F_16 ( V_20 , V_22 ,
V_92 | V_77 |
