...
for ( V_30 = 0 ; V_30 < V_28 ; V_30 ++ )
V_85 += V_27 [ V_30 ] . V_43 ;
ASSERT ( ! ( F_38 ( V_85 ) < V_76 -> V_86 ) ) ;
ASSERT ( ! ( F_38 ( V_83 ) & ( T_6 ) V_76 -> V_87 ) ) ;
V_84 = F_52 ( V_76 -> V_88 , V_76 -> V_88 -> V_89 . V_90 ) ;
if ( V_83 < 0 || V_83 >= V_84 ) {
F_53 ( V_76 -> V_88 ,
L_2 ,
V_68 , V_83 , V_84 ) ;
...
if ( V_77 ) {
F_59 ( & V_77 -> V_38 , V_82 , V_81 ) ;
F_60 ( & V_77 -> V_38 , & V_79 -> V_92 ) ;
V_77 -> V_96 = V_79 ;
F_10 ( & V_79 -> V_91 ) ;
} else {
F_26 ( V_97 ) ;
...
T_4 V_119 ;
int V_49 ;
V_118 = ( unsigned long ) V_115 & V_63 ;
V_58 = ( unsigned long ) V_115 - V_118 ;
V_119 = F_86 ( V_116 + V_58 ) ;
V_49 = V_119 >> V_64 ;
if ( V_2 -> V_50 )
F_30 ( V_2 ) ;
V_2 -> V_50 = NULL ;
...
int error , V_30 ;
struct V_1 * V_2 ;
F_88 ( V_27 , V_105 , V_85 ) ;
V_2 = F_15 ( V_26 , & V_27 , 1 , 0 ) ;
if ( F_17 ( V_2 == NULL ) )
goto V_120;
V_49 = F_86 ( V_85 << V_121 ) >> V_64 ;
error = F_28 ( V_2 , V_49 ) ;
if ( error )
goto V_122;
...
struct V_1 * V_2 )
{
bool V_129 = V_2 -> V_7 & V_106 ;
F_115 ( V_2 , V_48 ) ;
V_2 -> V_7 &= ~ ( V_106 | V_104 | V_35 ) ;
if ( ! V_2 -> V_113 && V_2 -> V_130 )
F_116 ( V_2 , V_2 -> V_130 ) ;
if ( V_129 && ! V_2 -> V_113 && V_2 -> V_101 ) {
ASSERT ( ! V_2 -> V_100 ) ;
V_2 -> V_101 -> V_131 ( V_2 ) ;
}
if ( ! V_2 -> V_113 )
...
struct V_1 * V_2 )
{
F_121 ( & V_2 -> V_135 , F_118 ) ;
F_122 ( V_2 -> V_136 , & V_2 -> V_135 ) ;
}
void
F_116 (
T_2 * V_2 ,
...
F_53 ( V_2 -> V_14 -> V_88 ,
L_5 ,
( V_138 ) F_125 ( V_2 ) , V_137 , - V_2 -> V_113 , V_2 -> V_42 ) ;
}
int
F_126 (
struct V_1 * V_2 )
...
struct V_141 * V_141 )
{
T_2 * V_2 = ( T_2 * ) V_141 -> V_142 ;
if ( V_141 -> V_143 ) {
F_5 ( & V_2 -> V_10 ) ;
if ( ! V_2 -> V_130 )
V_2 -> V_130 = V_141 -> V_143 ;
F_10 ( & V_2 -> V_10 ) ;
}
if ( ! V_2 -> V_113 && F_1 ( V_2 ) && ( V_2 -> V_7 & V_106 ) )
...
V_152:
F_58 ( & V_2 -> V_144 ) ;
V_150 = V_153 >> ( V_64 - V_121 ) ;
if ( V_150 > V_149 )
V_150 = V_149 ;
V_141 = F_132 ( V_154 , V_150 ) ;
V_141 -> V_155 = V_2 -> V_14 -> V_156 ;
V_141 -> V_157 . V_158 = V_151 ;
V_141 -> V_159 = F_128 ;
V_141 -> V_142 = V_2 ;
...
if ( V_57 > V_56 )
V_57 = V_56 ;
V_160 = F_133 ( V_141 , V_2 -> V_50 [ V_148 ] , V_57 ,
V_58 ) ;
if ( V_160 < V_57 )
break;
V_58 = 0 ;
...
} else if ( V_2 -> V_40 != V_105 ) {
struct V_175 * V_176 = V_2 -> V_14 -> V_88 ;
if ( F_137 ( & V_176 -> V_89 ) ) {
F_68 ( V_176 ,
L_6 ,
