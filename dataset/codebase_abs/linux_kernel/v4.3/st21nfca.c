...
return V_5 ;
V_5 = F_3 ( V_2 , V_17 ,
V_19 , V_11 , sizeof( V_11 ) ,
& V_7 ) ;
if ( V_5 < 0 )
return V_5 ;
for ( V_3 = 0 ; V_3 < V_7 -> V_20 ; V_3 ++ ) {
V_14 [ 2 ] = V_7 -> V_21 [ V_3 ] ;
V_5 = F_3 ( V_2 , V_17 ,
V_19 , V_14 ,
sizeof( V_14 ) , & V_8 ) ;
...
for ( V_4 = 0 ; ( V_4 < F_6 ( V_26 ) ) &&
( V_26 [ V_4 ] . V_27 != V_10 -> V_22 ) ; V_4 ++ )
;
if ( V_4 < F_6 ( V_26 ) &&
V_26 [ V_4 ] . V_27 == V_10 -> V_22 &&
F_7 ( V_10 -> V_28 ) ) {
V_26 [ V_4 ] . V_29 = V_14 [ 2 ] ;
V_2 -> V_30 [ V_26 [ V_4 ] . V_27 ] =
V_26 [ V_4 ] . V_29 ;
V_2 -> V_31 [ V_26 [ V_4 ] . V_29 ] . V_27 =
V_26 [ V_4 ] . V_27 ;
V_2 -> V_31 [ V_26 [ V_4 ] . V_29 ] . V_32 =
V_10 -> V_24 ;
}
F_5 ( V_8 ) ;
}
if ( V_7 -> V_20 + 3 < F_6 ( V_26 ) ) {
for ( V_3 = V_7 -> V_20 + 3 ;
V_3 < F_6 ( V_26 ) - 2 ; V_3 ++ ) {
V_5 = F_2 ( V_2 ,
V_16 ,
...
memcpy ( V_2 -> V_34 . V_35 , V_26 , sizeof( V_26 ) ) ;
V_33:
F_5 ( V_7 ) ;
return V_5 ;
}
...
if ( V_5 < 0 )
goto exit;
if ( V_108 -> V_20 == 0 || V_108 -> V_20 > V_110 ) {
V_5 = - V_102 ;
goto exit;
}
memcpy ( V_107 , V_108 -> V_21 , V_108 -> V_20 ) ;
* V_20 = V_108 -> V_20 ;
exit:
F_5 ( V_108 ) ;
return V_5 ;
...
memcpy ( V_112 -> V_116 , V_113 -> V_21 , V_113 -> V_20 ) ;
V_112 -> V_117 = V_113 -> V_21 [ 1 ] ;
V_112 -> V_118 = 1 ;
exit:
F_5 ( V_113 ) ;
return V_5 ;
...
static int F_34 ( struct V_1 * V_2 , T_1 V_27 ,
struct V_111 * V_112 )
{
int V_5 , V_20 ;
T_3 V_99 ;
...
if ( V_130 -> V_20 > 0 ) {
memcpy ( V_112 -> V_133 , V_130 -> V_21 ,
V_130 -> V_20 ) ;
V_112 -> V_134 = V_130 -> V_20 ;
...
static void F_46 ( struct V_1 * V_2 , T_1 V_29 , T_1 V_149 ,
struct V_6 * V_47 )
{
struct V_36 * V_10 = F_9 ( V_2 ) ;
T_1 V_27 = V_2 -> V_31 [ V_29 ] . V_27 ;
F_47 ( L_5 , V_149 ) ;
switch ( V_149 ) {
case V_150 :
if ( V_27 != V_23 &&
V_2 -> V_31 [ V_29 ] . V_32 != V_54 )
V_10 -> V_151 . V_152 ++ ;
...
static int F_54 ( struct V_1 * V_2 , T_1 V_29 ,
T_1 V_157 , struct V_6 * V_47 )
{
T_1 V_27 = V_2 -> V_31 [ V_29 ] . V_27 ;
T_1 V_161 = V_2 -> V_31 [ V_29 ] . V_32 ;
F_47 ( L_7 , V_157 , V_27 ) ;
switch ( V_27 ) {
case V_55 :
...
F_60 ( & V_10 -> V_37 ) ;
V_34 . V_176 = F_6 ( V_26 ) ;
memcpy ( V_34 . V_35 , V_26 , sizeof( V_26 ) ) ;
