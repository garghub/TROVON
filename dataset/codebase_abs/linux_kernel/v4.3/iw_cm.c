...
& V_14 -> V_37 , & V_14 -> V_38 ,
F_13 ( V_3 ) , F_14 ( V_3 ) ) ;
V_2 = F_51 ( & V_113 , V_14 -> V_38 , V_14 -> V_37 ,
& V_114 , V_96 ) ;
if ( F_35 ( V_2 ) ) {
F_25 ( L_23 , F_36 ( V_2 ) ) ;
V_2 = NULL ;
...
V_125 . V_129 = V_130 ;
V_125 . V_131 . V_132 = ( V_133 T_1 ) V_2 -> V_30 ;
V_125 . V_134 = ( V_133 T_2 ) F_65 ( 0 ) ;
V_60 = F_66 ( V_7 -> V_24 , (struct V_135 * ) & V_125 ) ;
if ( V_60 ) {
F_25 ( L_30 ,
& V_2 -> V_30 , V_60 ) ;
F_67 ( V_7 -> V_24 ) ;
...
V_7 -> V_121 = V_16 -> V_122 ;
V_126 . V_129 = V_130 ;
V_126 . V_131 . V_132 = ( V_133 T_1 ) V_2 -> V_31 ;
V_126 . V_134 = ( V_133 T_2 ) F_65 ( V_136 ) ;
V_60 = F_68 ( V_7 -> V_24 , (struct V_135 * ) & V_125 ,
(struct V_135 * ) & V_126 ,
V_137 ) ;
if ( V_60 ) {
F_25 ( L_31 , V_7 -> V_24 ,
...
if ( V_7 -> V_24 -> V_140 ) {
V_139 . V_141 = V_142 ;
F_71 ( V_7 -> V_24 -> V_140 , & V_139 , V_143 ) ;
}
F_72 ( V_144 ,
F_73 ( & V_7 -> V_86 ) &&
F_73 ( & V_7 -> V_88 ) ) ;
...
int F_87 ( struct V_1 * V_2 , T_3 V_154 )
{
struct V_6 * V_7 ;
unsigned long V_155 ;
V_7 = F_88 ( sizeof( struct V_6 ) , V_154 ) ;
if ( ! V_7 )
return - V_97 ;
F_89 ( & V_7 -> V_156 ) ;
F_90 ( & V_7 -> V_157 , V_158 ,
( unsigned long ) V_7 ) ;
F_91 ( & V_7 -> V_159 ) ;
#ifndef F_81
F_92 ( & V_7 -> V_160 ) ;
...
V_2 -> V_8 = V_7 ;
F_93 ( & V_161 , V_155 ) ;
F_94 ( & V_7 -> V_156 , & V_162 ) ;
F_95 ( & V_161 , V_155 ) ;
F_25 ( L_36 , V_2 , V_2 -> V_8 ) ;
return 0 ;
}
void F_96 ( void * V_163 )
{
struct V_6 * V_7 = V_163 ;
T_4 * V_164 ;
F_25 ( L_37 , V_7 ) ;
V_164 = V_7 -> V_16 ? & V_7 -> V_16 -> V_165 : & V_161 ;
F_97 ( V_164 ) ;
F_98 ( & V_7 -> V_156 ) ;
F_99 ( V_164 ) ;
F_100 ( V_7 ) ;
...
void
F_101 ( struct V_1 * V_2 , const char * V_166 , ... )
{
T_5 V_167 ;
F_28 ( V_2 ) ;
va_start ( V_167 , V_166 ) ;
F_102 ( V_166 , V_167 ) ;
va_end ( V_167 ) ;
}
