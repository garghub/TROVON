...
struct V_24 * V_11 , int V_25 , T_2 V_26 ,
bool V_27 , struct V_1 * V_3 )
{
F_17 ( & V_23 , V_11 , V_25 ,
V_26 , & V_3 -> V_4 ) ;
V_3 -> V_12 = V_12 ;
if ( ! F_18 ( V_11 -> V_28 , V_29 [ V_25 ] , V_27 ) ) {
F_19 ( & V_3 -> V_4 , L_5 ) ;
return - V_30 ;
}
F_20 ( & V_3 -> V_31 ) ;
...
struct V_24 * V_11 , int V_25 , T_2 V_26 ,
bool V_27 , struct V_1 * * V_2 )
{
if ( ! ( * V_2 = F_22 ( sizeof( * * V_2 ) , V_32 ) ) )
return - V_33 ;
return F_16 ( V_12 , V_11 , V_25 , V_26 ,
V_27 , * V_2 ) ;
}
