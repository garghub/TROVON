...
V_9 -> V_57 = V_3 -> V_43 -> V_58 ;
if ( F_44 ( V_9 ) )
V_9 -> V_59 . V_60 = V_3 -> V_46 +
F_45 ( V_29 , V_9 -> V_59 . V_60 ) ;
return F_35 ( V_3 , V_3 -> V_47 , V_9 ) ;
}
V_9 -> V_57 = V_3 -> V_42 -> V_58 ;
V_9 -> V_59 . V_60 = V_3 -> V_39 +
F_45 ( V_29 , V_9 -> V_59 . V_60 ) ;
...
struct V_2 * V_3 = V_29 -> V_55 ;
int V_34 = 0 ;
V_34 = V_68 ( V_29 , V_3 -> V_42 , V_3 -> V_39 , V_29 -> V_69 , V_1 ) ;
if ( V_34 )
goto V_44;
if ( V_3 -> V_43 )
V_34 = V_68 ( V_29 , V_3 -> V_43 , V_3 -> V_46 , V_29 -> V_69 , V_1 ) ;
V_44:
return V_34 ;
}
