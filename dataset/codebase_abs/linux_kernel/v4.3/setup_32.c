...
int T_2 F_23 ( char * V_27 )
{
if ( F_21 ( V_28 ) ) {
unsigned long V_29 = F_24 ( V_27 , NULL , 0 ) ;
F_25 ( V_30 L_2 , V_29 ) ;
F_26 ( 0 ) ;
F_26 ( V_29 ) ;
}
...
unsigned char F_29 ( int V_32 )
{
if ( V_22 . V_33 )
return V_22 . V_33 ( V_32 ) ;
return 0xff ;
}
void F_30 ( unsigned char V_29 , int V_32 )
{
if ( V_22 . V_34 )
V_22 . V_34 ( V_32 , V_29 ) ;
}
