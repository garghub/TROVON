...
if ( F_10 ( & V_6 -> V_33 ) )
return - V_34 ;
V_27 = F_11 ( & V_6 -> V_14 , V_24 , V_25 , & V_10 ) ;
F_12 ( & V_6 -> V_33 ) ;
if ( V_27 )
return V_27 ;
...
if ( V_27 < 0 )
return V_27 ;
V_27 = V_2 -> V_22 -> V_56 ( V_2 ,
V_54 -> V_44 , F_22 ( V_54 ) ,
F_21 ( V_54 ) , V_55 ) ;
return ( V_27 < 0 ) ? V_27 : V_53 ;
}
...
if ( ! V_2 -> V_22 -> V_61 )
return - V_29 ;
V_27 = F_32 ( V_24 , 100000 , & V_55 , & V_58 ) ;
if ( V_27 )
return V_27 ;
V_27 = V_2 -> V_22 -> V_61 ( V_2 ,
V_54 -> V_44 , F_22 ( V_54 ) ,
F_21 ( V_54 ) , F_23 ( V_54 ) ,
V_55 , V_58 ) ;
if ( V_27 < 0 )
...
V_27 = F_39 ( V_70 , V_63 , F_34 , F_35 ,
( V_69 << 16 ) | V_64 , V_66 , & V_2 -> V_51 ,
& V_2 -> V_7 -> V_78 ) ;
F_40 ( V_70 ) ;
if ( ( V_27 == - V_37 ) && ( V_66 != V_79 ) )
continue;
if ( V_27 )
return V_27 ;
V_68 ++ ;
