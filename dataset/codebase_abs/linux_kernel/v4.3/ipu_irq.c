...
int T_3 F_26 ( struct V_1 * V_1 , struct V_34 * V_35 )
{
unsigned int V_19 , V_7 ;
int V_36 = F_27 ( - 1 , 0 , V_8 ,
F_28 () ) ;
if ( V_36 < 0 )
return V_36 ;
...
F_33 ( V_1 -> V_41 , F_20 , V_1 ) ;
F_33 ( V_1 -> V_42 , F_20 , V_1 ) ;
V_1 -> V_36 = V_36 ;
return 0 ;
}
void F_34 ( struct V_1 * V_1 , struct V_34 * V_35 )
{
unsigned int V_19 , V_36 ;
V_36 = V_1 -> V_36 ;
F_33 ( V_1 -> V_41 , NULL , NULL ) ;
F_33 ( V_1 -> V_42 , NULL , NULL ) ;
for ( V_19 = V_36 ; V_19 < V_36 + V_8 ; V_19 ++ ) {
F_35 ( V_19 , V_39 ) ;
F_29 ( V_19 , NULL ) ;
F_30 ( V_19 , NULL ) ;
}
