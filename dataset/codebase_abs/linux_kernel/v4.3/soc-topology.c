...
if ( V_2 -> V_65 != V_208 )
return 0 ;
V_207 = (struct V_206 * ) V_2 -> V_8 ;
V_2 -> V_8 += sizeof( struct V_206 ) ;
if ( V_2 -> V_62 && V_2 -> V_31 && V_2 -> V_31 -> V_207 )
return V_2 -> V_31 -> V_207 ( V_2 -> V_62 , V_207 ) ;
F_2 ( V_2 -> V_12 , L_44 ) ;
return 0 ;
}
...
F_38 ( V_2 -> V_12 ,
L_49 ,
V_45 -> V_180 , V_45 -> type , V_45 -> V_213 ,
V_45 -> V_64 , V_2 -> V_65 ) ;
return 1 ;
}
...
struct V_220 * V_31 , const struct V_221 * V_9 , V_173 V_20 )
{
struct V_1 V_2 ;
...
return;
F_30 ( V_68 -> V_184 -> V_222 , & V_68 -> V_90 , V_106 ) ;
}
void F_73 ( struct V_183 * V_184 ,
V_173 V_57 )
{
struct V_67 * V_68 , * V_223 ;
F_74 (w, next_w, &dapm->card->widgets, list) {
if ( V_68 -> V_90 . type != V_50 || V_68 -> V_184 != V_184 )
continue;
if ( V_68 -> V_90 . V_57 != V_57 &&
V_68 -> V_90 . V_57 != V_215 )
continue;
F_72 ( V_68 ) ;
F_75 ( V_68 ) ;
}
}
int F_76 ( struct V_88 * V_62 , V_173 V_57 )
{
struct V_89 * V_90 , * V_224 ;
int V_65 = V_219 ;
while ( V_65 >= V_218 ) {
