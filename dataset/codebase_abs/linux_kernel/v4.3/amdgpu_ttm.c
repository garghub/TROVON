...
F_85 ( V_6 , V_6 -> V_39 . V_106 ) ;
V_11 = F_86 ( V_6 , 256 * 1024 , V_89 , true ,
V_178 ,
V_179 ,
NULL , NULL , & V_6 -> V_180 ) ;
if ( V_11 ) {
...
if ( V_11 )
return V_11 ;
V_11 = F_88 ( V_6 -> V_180 , V_178 , NULL ) ;
F_89 ( V_6 -> V_180 ) ;
if ( V_11 ) {
F_90 ( & V_6 -> V_180 ) ;
return V_11 ;
...
F_91 ( L_11 ,
( unsigned ) ( V_6 -> V_39 . V_177 / ( 1024 * 1024 ) ) ) ;
...
V_6 -> V_182 . V_66 . V_183 >> V_88 ) ;
if ( V_11 ) {
F_9 ( L_14 ) ;
return V_11 ;
}
V_11 = F_84 ( & V_6 -> V_5 . V_3 , V_48 ,
V_6 -> V_182 . V_187 . V_183 >> V_88 ) ;
if ( V_11 ) {
F_9 ( L_15 ) ;
return V_11 ;
}
V_11 = F_84 ( & V_6 -> V_5 . V_3 , V_49 ,
V_6 -> V_182 . V_189 . V_183 >> V_88 ) ;
if ( V_11 ) {
F_9 ( L_16 ) ;
return V_11 ;
}
...
void F_85 ( struct V_1 * V_6 , V_99 V_16 )
{
struct V_27 * V_28 ;
if ( ! V_6 -> V_5 . V_176 )
return;
...
int F_99 ( struct V_72 * V_73 , struct V_130 * V_131 )
{
struct V_191 * V_192 ;
struct V_1 * V_6 ;
if ( F_28 ( V_131 -> V_193 < V_174 ) )
return - V_50 ;
V_192 = V_73 -> V_194 ;
V_6 = V_192 -> V_195 -> V_141 -> V_196 ;
if ( V_6 == NULL )
return - V_50 ;
return F_100 ( V_73 , V_131 , & V_6 -> V_5 . V_3 ) ;
}
...
T_1 V_201 ;
unsigned V_202 , V_203 ;
struct V_204 * V_205 ;
unsigned V_151 ;
int V_11 ;
V_201 = V_6 -> V_5 . V_98 -> V_206 ;
V_202 = F_101 ( V_199 , V_201 ) ;
V_203 = V_202 * V_6 -> V_5 . V_98 -> V_207 ;
while ( V_203 & 0x7 )
V_203 ++ ;
V_205 = F_66 ( sizeof( struct V_204 ) , V_138 ) ;
if ( ! V_205 )
return - V_140 ;
V_11 = F_102 ( V_83 , NULL , V_203 * 4 , V_205 ) ;
if ( V_11 ) {
F_48 ( V_205 ) ;
return V_11 ;
}
V_205 -> V_208 = 0 ;
if ( V_92 ) {
V_11 = F_103 ( V_6 , & V_205 -> V_209 , V_92 ,
V_210 ) ;
if ( V_11 ) {
F_9 ( L_19 , V_11 ) ;
goto V_211;
...
for ( V_151 = 0 ; V_151 < V_202 ; V_151 ++ ) {
T_1 V_212 = F_104 ( V_199 , V_201 ) ;
F_105 ( V_6 , V_205 , V_197 , V_198 ,
V_212 ) ;
V_197 += V_212 ;
V_198 += V_212 ;
V_199 -= V_212 ;
...
F_106 ( V_6 , V_205 ) ;
F_107 ( V_205 -> V_208 > V_203 ) ;
V_11 = F_108 ( V_6 , V_83 , V_205 , 1 ,
& V_213 ,
V_214 ,
V_86 ) ;
if ( V_11 )
...
static int F_110 ( struct V_216 * V_217 , void * V_218 )
{
struct V_219 * V_220 = (struct V_219 * ) V_217 -> V_221 ;
unsigned V_222 = * ( int * ) V_220 -> V_223 -> V_218 ;
struct V_224 * V_141 = V_220 -> V_195 -> V_141 ;
struct V_1 * V_6 = V_141 -> V_196 ;
struct V_225 * V_124 = (struct V_225 * ) V_6 -> V_5 . V_3 . V_28 [ V_222 ] . V_226 ;
int V_227 ;
struct V_23 * V_228 = V_6 -> V_5 . V_3 . V_228 ;
F_111 ( & V_228 -> V_229 ) ;
V_227 = F_112 ( V_217 , V_124 ) ;
F_113 ( & V_228 -> V_229 ) ;
return V_227 ;
}
static T_3 F_114 ( struct V_72 * V_230 , char T_4 * V_231 ,
T_5 V_16 , T_6 * V_232 )
{
struct V_1 * V_6 = V_230 -> V_233 -> V_234 ;
T_3 V_235 = 0 ;
int V_11 ;
if ( V_16 & 0x3 || * V_232 & 0x3 )
return - V_50 ;
while ( V_16 ) {
unsigned long V_26 ;
T_1 V_236 ;
if ( * V_232 >= V_6 -> V_39 . V_237 )
return V_235 ;
F_115 ( & V_6 -> V_238 , V_26 ) ;
F_116 ( V_239 , ( ( T_1 ) * V_232 ) | 0x80000000 ) ;
F_116 ( V_240 , * V_232 >> 31 ) ;
V_236 = F_117 ( V_241 ) ;
F_118 ( & V_6 -> V_238 , V_26 ) ;
V_11 = F_119 ( V_236 , ( T_1 * ) V_231 ) ;
if ( V_11 )
return V_11 ;
V_235 += 4 ;
V_231 += 4 ;
...
static T_3 F_120 ( struct V_72 * V_230 , char T_4 * V_231 ,
T_5 V_16 , T_6 * V_232 )
{
struct V_1 * V_6 = V_230 -> V_233 -> V_234 ;
T_3 V_235 = 0 ;
int V_11 ;
while ( V_16 ) {
T_6 V_242 = * V_232 / V_89 ;
unsigned V_243 = * V_232 & ~ V_244 ;
T_5 V_245 = F_121 ( T_5 , V_16 , V_89 - V_243 ) ;
struct V_134 * V_134 ;
void * V_246 ;
if ( V_242 >= V_6 -> V_147 . V_247 )
return V_235 ;
V_134 = V_6 -> V_147 . V_135 [ V_242 ] ;
if ( V_134 ) {
V_246 = F_122 ( V_134 ) ;
V_246 += V_243 ;
V_11 = F_123 ( V_231 , V_246 , V_245 ) ;
F_124 ( V_6 -> V_147 . V_135 [ V_242 ] ) ;
} else
V_11 = F_125 ( V_231 , V_245 ) ;
if ( V_11 )
return - V_160 ;
V_235 += V_245 ;
V_231 += V_245 ;
...
#if F_126 ( V_248 )
unsigned V_249 ;
struct V_250 * V_195 = V_6 -> V_108 -> V_251 ;
struct V_252 * V_253 , * V_254 = V_195 -> V_255 ;
V_253 = F_127 ( L_20 , V_256 | V_257 , V_254 ,
V_6 , & V_258 ) ;
if ( F_128 ( V_253 ) )
return F_129 ( V_253 ) ;
F_130 ( V_253 -> V_259 , V_6 -> V_39 . V_237 ) ;
V_6 -> V_5 . V_260 = V_253 ;
V_253 = F_127 ( L_21 , V_256 | V_257 , V_254 ,
V_6 , & V_261 ) ;
if ( F_128 ( V_253 ) )
return F_129 ( V_253 ) ;
F_130 ( V_253 -> V_259 , V_6 -> V_39 . V_181 ) ;
V_6 -> V_5 . V_113 = V_253 ;
V_249 = F_131 ( V_262 ) ;
#ifdef F_69
if ( ! F_70 () )
