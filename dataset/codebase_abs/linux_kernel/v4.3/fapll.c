...
static T_2 F_15 ( struct V_12 * V_13 )
{
struct V_1 * V_2 = F_10 ( V_13 ) ;
if ( F_1 ( V_2 ) )
return 1 ;
...
static struct V_48 * T_3 F_31 ( struct V_1 * V_2 ,
void T_4 * V_31 ,
void T_4 * div ,
int V_29 ,
const char * V_10 ,
...
static void T_3 F_36 ( struct V_60 * V_61 )
{
struct V_1 * V_2 ;
...
struct V_48 * V_50 ;
int V_63 ;
V_2 = F_32 ( sizeof( * V_2 ) , V_53 ) ;
if ( ! V_2 )
return;
V_2 -> V_64 . V_65 = F_32 ( sizeof( struct V_48 * ) *
V_66 + 1 ,
V_53 ) ;
if ( ! V_2 -> V_64 . V_65 )
goto free;
...
F_38 ( V_61 , V_62 , 2 ) ;
V_52 -> V_57 = V_62 ;
V_2 -> V_68 = F_39 ( V_61 , 0 ) ;
if ( F_40 ( V_2 -> V_68 ) ) {
F_8 ( L_4 , V_61 -> V_10 ) ;
goto free;
}
V_2 -> V_69 = F_39 ( V_61 , 1 ) ;
if ( F_40 ( V_2 -> V_69 ) ) {
F_8 ( L_5 , V_61 -> V_10 ) ;
goto free;
}
...
V_2 -> V_10 = V_61 -> V_10 ;
V_2 -> V_13 . V_52 = V_52 ;
V_50 = F_34 ( NULL , & V_2 -> V_13 ) ;
if ( F_40 ( V_50 ) )
goto V_70;
V_2 -> V_64 . V_65 [ 0 ] = V_50 ;
V_2 -> V_64 . V_71 ++ ;
...
V_73 = F_31 ( V_2 , V_31 , div , V_74 ,
V_72 , V_61 -> V_10 ,
V_50 ) ;
if ( F_40 ( V_73 ) )
continue;
V_2 -> V_64 . V_65 [ V_74 ] = V_73 ;
V_2 -> V_64 . V_71 ++ ;
F_46 ( V_73 , V_72 , NULL ) ;
}
F_47 ( V_61 , V_75 , & V_2 -> V_64 ) ;
F_35 ( V_52 ) ;
return;
V_70:
F_48 ( V_2 -> V_4 ) ;
