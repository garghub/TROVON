...
struct V_158 * V_18 ;
int V_23 , V_22 ;
V_17 = F_183 ( sizeof( * V_18 ) , V_299 , 1 ) ;
if ( ! V_17 )
return F_48 ( - V_95 ) ;
V_17 -> V_300 = V_64 + 8 ;
V_17 -> V_301 = 8 ;
...
V_17 -> V_305 = & V_306 ;
V_17 -> V_307 = V_308 ;
V_17 -> V_309 = V_231 | V_310 | V_311 |
V_312 | V_313 ;
V_17 -> V_230 = V_17 -> V_309 ;
F_187 ( V_17 , & V_178 -> V_17 ) ;
V_23 = F_188 ( V_17 ) ;
if ( V_23 ) {
F_4 ( L_27 ) ;
goto V_314;
...
F_189 ( & V_18 -> V_296 , & V_315 ) ;
return V_18 ;
V_314:
F_190 ( V_17 ) ;
return F_48 ( V_23 ) ;
}
static struct V_158 * F_191 ( const V_35 * V_297 ,
struct V_298 * V_178 )
{
struct V_158 * V_316 , * V_18 ;
F_192 ( & V_317 ) ;
V_18 = NULL ;
F_193 (iter, &vnet_list, list) {
if ( V_316 -> V_297 == * V_297 ) {
V_18 = V_316 ;
break;
}
}
if ( ! V_18 )
V_18 = F_182 ( V_297 , V_178 ) ;
F_194 ( & V_317 ) ;
return V_18 ;
}
...
F_192 ( & V_317 ) ;
while ( ! F_179 ( & V_315 ) ) {
V_18 = F_196 ( & V_315 , struct V_158 , V_296 ) ;
F_197 ( & V_18 -> V_296 ) ;
V_17 = V_18 -> V_17 ;
...
static struct V_158 * F_199 ( struct V_318 * V_184 ,
V_35 V_319 ,
struct V_298 * V_178 )
{
const V_35 * V_297 = NULL ;
V_35 V_320 ;
F_200 (a, hp, port_node, MDESC_ARC_TYPE_BACK) {
V_35 V_321 = F_201 ( V_184 , V_320 ) ;
const char * V_164 ;
V_164 = F_202 ( V_184 , V_321 , L_29 , NULL ) ;
if ( ! V_164 || strcmp ( V_164 , L_30 ) )
continue;
V_297 = F_202 ( V_184 , V_321 ,
V_322 , NULL ) ;
if ( V_297 )
break;
}
if ( ! V_297 )
return F_48 ( - V_323 ) ;
return F_191 ( V_297 , V_178 ) ;
}
static void F_203 ( void )
{
F_204 ( V_324 L_31 , V_284 ) ;
}
static void
...
static void
F_206 ( struct V_4 * V_5 )
{
V_5 -> V_18 -> V_326 -- ;
F_131 ( F_66 ( V_5 -> V_18 -> V_17 , V_5 -> V_162 ) ) ;
}
static int F_207 ( struct V_298 * V_178 , const struct V_327 * V_328 )
{
struct V_318 * V_184 ;
struct V_4 * V_5 ;
unsigned long V_104 ;
...
F_203 () ;
V_184 = F_208 () ;
V_18 = F_199 ( V_184 , V_178 -> V_330 , V_178 ) ;
if ( F_53 ( V_18 ) ) {
F_4 ( L_32 ) ;
V_23 = F_54 ( V_18 ) ;
goto V_331;
}
V_329 = F_202 ( V_184 , V_178 -> V_330 , V_332 , & V_62 ) ;
V_23 = - V_323 ;
if ( ! V_329 ) {
F_4 ( L_33 , V_332 ) ;
goto V_331;
...
V_5 -> V_18 = V_18 ;
V_23 = F_209 ( & V_5 -> V_12 , V_178 , V_334 ,
V_335 , F_210 ( V_335 ) ,
& V_336 , V_18 -> V_17 -> V_164 ) ;
if ( V_23 )
goto V_337;
V_23 = F_211 ( & V_5 -> V_12 , & V_338 , V_5 ) ;
if ( V_23 )
goto V_337;
F_212 ( V_5 -> V_18 -> V_17 , & V_5 -> V_113 , F_86 , V_339 ) ;
F_213 ( & V_5 -> V_182 ) ;
F_185 ( & V_5 -> V_296 ) ;
V_110 = 0 ;
if ( F_202 ( V_184 , V_178 -> V_330 , L_34 , NULL ) != NULL )
V_110 = 1 ;
V_5 -> V_110 = V_110 ;
V_5 -> V_44 = true ;
V_5 -> V_46 = 0 ;
...
F_215 ( & V_5 -> V_296 , & V_18 -> V_295 ) ;
F_216 ( & V_5 -> V_182 ,
& V_18 -> V_185 [ F_93 ( V_5 -> V_130 ) ] ) ;
F_205 ( V_5 ) ;
F_181 ( & V_18 -> V_294 , V_104 ) ;
F_217 ( & V_178 -> V_17 , V_5 ) ;
F_45 ( L_35 ,
V_18 -> V_17 -> V_164 , V_5 -> V_130 , V_110 ? L_36 : L_37 ) ;
F_218 ( & V_5 -> V_194 , F_102 ,
( unsigned long ) V_5 ) ;
F_219 ( & V_5 -> V_113 ) ;
F_81 ( & V_5 -> V_12 ) ;
F_220 ( V_184 ) ;
...
static int F_221 ( struct V_298 * V_178 )
{
struct V_4 * V_5 = F_222 ( & V_178 -> V_17 ) ;
if ( V_5 ) {
F_223 ( & V_5 -> V_12 . V_340 ) ;
F_224 ( & V_5 -> V_113 ) ;
F_225 ( & V_5 -> V_296 ) ;
F_226 ( & V_5 -> V_182 ) ;
F_227 () ;
