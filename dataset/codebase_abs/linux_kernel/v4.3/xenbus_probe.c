...
if ( ! V_94 )
goto V_97;
V_98 = V_99 -> V_100 = F_78 ( ( void * ) V_94 ) ;
V_96 . V_101 = V_102 ;
V_96 . V_103 = V_102 ;
V_24 = F_79 ( V_104 ,
& V_96 ) ;
...
static int F_82 ( struct V_87 * V_88 ,
unsigned long V_109 , void * V_55 )
{
int V_24 = 0 ;
if ( F_75 () ) {
T_4 V_110 = 0 ;
V_24 = F_83 ( V_111 , & V_110 ) ;
if ( ! V_24 && V_110 )
V_106 = V_110 ;
else
F_62 ( L_25 ,
...
goto V_117;
V_106 = ( int ) V_110 ;
V_24 = F_83 ( V_119 , & V_110 ) ;
if ( V_24 )
goto V_117;
V_98 = ( unsigned long ) V_110 ;
V_118 =
F_88 ( V_98 << V_120 , V_121 ) ;
break;
default:
F_62 ( L_26 ) ;
break;
