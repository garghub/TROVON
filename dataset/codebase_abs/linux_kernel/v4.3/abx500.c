...
struct V_1 * V_2 ;
int V_48 ;
V_2 = F_35 ( & V_10 -> V_11 , sizeof( * V_2 ) , V_49 ) ;
if ( ! V_2 )
return - V_50 ;
V_2 -> V_10 = V_10 ;
F_36 ( & V_2 -> V_18 ) ;
V_48 = F_37 ( V_2 ) ;
if ( V_48 < 0 || ! V_2 -> V_19 . V_20 || ! V_2 -> V_19 . F_12 ||
! V_2 -> V_19 . F_14 )
return V_48 ;
F_38 ( & V_2 -> V_4 , F_6 ) ;
F_39 ( V_10 , V_2 ) ;
V_48 = F_40 ( & V_10 -> V_11 . V_25 , & V_51 ) ;
if ( V_48 < 0 ) {
F_9 ( & V_10 -> V_11 , L_11 , V_48 ) ;
return V_48 ;
}
V_2 -> V_52 = F_41 ( & V_10 -> V_11 ) ;
if ( F_42 ( V_2 -> V_52 ) ) {
V_48 = F_43 ( V_2 -> V_52 ) ;
F_9 ( & V_10 -> V_11 , L_12 , V_48 ) ;
goto V_53;
}
if ( V_2 -> V_19 . V_45 ) {
V_48 = F_31 ( V_10 ) ;
