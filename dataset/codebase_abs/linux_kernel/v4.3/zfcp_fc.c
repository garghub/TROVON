...
static struct V_33 * F_127 ( struct V_226 * V_227 )
{
T_1 V_241 ;
T_4 V_242 ;
struct V_2 * V_3 ;
V_241 = V_227 -> V_243 -> V_244 . V_245 . V_241 ;
V_242 = ( V_241 & 0xff000000 ) >> 24 ;
V_3 = (struct V_2 * ) V_227 -> V_156 -> V_246 [ 0 ] ;
switch ( V_242 ) {
case V_247 :
...
static int F_129 ( struct V_226 * V_227 ,
struct V_2 * V_3 )
{
struct V_95 * V_250 = V_227 -> V_229 ;
struct V_251 * V_252 = V_227 -> V_252 ;
struct V_63 * V_64 ;
T_1 V_49 ;
if ( V_252 ) {
V_64 = F_130 ( V_3 , V_252 -> V_253 ) ;
if ( ! V_64 )
return - V_254 ;
V_49 = V_64 -> V_49 ;
F_80 ( & V_64 -> V_132 ) ;
} else
V_49 = F_54 ( V_227 -> V_243 -> V_244 . V_255 . V_256 ) ;
V_250 -> V_120 = F_126 ;
return F_95 ( V_3 , V_49 , V_250 , V_227 -> V_81 -> V_257 / V_48 ) ;
}
static int F_131 ( struct V_226 * V_227 ,
struct V_2 * V_3 )
{
int V_119 ;
struct V_95 * V_258 = V_227 -> V_229 ;
struct V_33 * V_34 ;
V_34 = F_127 ( V_227 ) ;
if ( ! V_34 )
return - V_254 ;
...
return V_119 ;
V_258 -> V_120 = F_128 ;
V_119 = F_72 ( V_34 , V_258 , NULL , V_227 -> V_81 -> V_257 / V_48 ) ;
if ( V_119 )
F_40 ( V_34 ) ;
return V_119 ;
}
int F_132 ( struct V_226 * V_227 )
{
struct V_155 * V_156 ;
struct V_2 * V_3 ;
struct V_95 * V_96 = V_227 -> V_229 ;
V_156 = V_227 -> V_252 ? F_133 ( V_227 -> V_252 ) : V_227 -> V_156 ;
V_3 = (struct V_2 * ) V_156 -> V_246 [ 0 ] ;
if ( ! ( F_37 ( & V_3 -> V_37 ) & V_152 ) )
return - V_254 ;
V_96 -> V_81 = V_227 -> V_259 . V_260 ;
V_96 -> V_123 = V_227 -> V_234 . V_260 ;
V_96 -> V_121 = V_227 ;
switch ( V_227 -> V_243 -> V_261 ) {
case V_262 :
case V_263 :
return F_129 ( V_227 , V_3 ) ;
case V_264 :
case V_265 :
return F_131 ( V_227 , V_3 ) ;
default:
return - V_254 ;
}
}
int F_134 ( struct V_226 * V_227 )
{
return - V_188 ;
}
...
{
struct V_51 * V_266 ;
V_266 = F_136 ( sizeof( struct V_51 ) , V_166 ) ;
if ( ! V_266 )
return - V_130 ;
V_3 -> V_52 = V_266 ;
F_43 ( & V_266 -> V_53 , V_267 , V_3 ) ;
F_43 ( & V_266 -> V_54 , V_268 , V_3 ) ;
F_43 ( & V_266 -> V_55 , V_269 , V_3 ) ;
F_43 ( & V_266 -> V_56 , V_270 , V_3 ) ;
return 0 ;
}
