...
if ( V_112 < 0 )
goto V_118;
V_112 = V_22 -> V_115 -> V_116 ( V_22 , V_24 , V_27 ) ;
if ( V_112 < 0 )
goto V_119;
if ( F_10 ( V_22 -> V_28 ) ) {
V_112 = V_22 -> V_115 -> V_116 ( V_22 , V_25 ,
V_31 ) ;
}
V_119:
F_14 ( V_24 ) ;
...
int F_12 ( int V_121 )
{
return sizeof( struct V_20 ) + V_121 * sizeof( struct V_57 ) ;
}
int
F_48 ( char * V_122 , T_1 V_123 )
{
int V_83 ;
for ( V_83 = 0 ; V_83 < F_49 ( V_124 ) ; V_83 ++ ) {
if ( V_124 [ V_83 ] . V_125 == V_123 &&
0 == memcmp ( V_124 [ V_83 ] . string , V_122 , V_123 ) )
return V_124 [ V_83 ] . type ;
}
return V_70 ;
}
T_4 F_50 ( struct V_126 * V_127 , int V_128 )
{
T_4 * V_122 ;
int V_83 ;
for ( V_83 = 0 ; V_83 < F_49 ( V_124 ) ; V_83 ++ ) {
if ( V_124 [ V_83 ] . type != V_128 )
continue;
V_122 = F_51 ( V_127 , V_124 [ V_83 ] . V_125 + 4 ) ;
if ( ! V_122 )
return V_129 ;
V_122 = F_52 ( V_122 , V_124 [ V_83 ] . string ,
V_124 [ V_83 ] . V_125 ) ;
return 0 ;
}
F_53 ( 1 ) ;
