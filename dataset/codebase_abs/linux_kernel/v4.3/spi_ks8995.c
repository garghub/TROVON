...
static T_3 F_19 ( struct V_27 * V_28 , struct V_29 * V_30 ,
struct V_31 * V_32 , char * V_8 , T_4 V_33 , T_2 V_10 )
{
struct V_34 * V_35 ;
struct V_6 * V_36 ;
...
static int F_20 ( struct V_37 * V_22 )
{
struct V_6 * V_7 ;
struct V_38 * V_39 ;
T_1 V_40 [ 2 ] ;
int V_16 ;
V_39 = V_22 -> V_35 . V_41 ;
V_7 = F_21 ( & V_22 -> V_35 , sizeof( * V_7 ) , V_42 ) ;
if ( ! V_7 )
return - V_43 ;
F_22 ( & V_7 -> V_21 ) ;
V_7 -> V_39 = V_39 ;
...
V_16 = F_25 ( V_22 ) ;
if ( V_16 ) {
F_26 ( & V_22 -> V_35 , L_1 , V_16 ) ;
return V_16 ;
}
V_16 = F_3 ( V_7 , V_40 , V_47 , sizeof( V_40 ) ) ;
if ( V_16 < 0 ) {
F_26 ( & V_22 -> V_35 , L_2 ,
V_16 ) ;
return V_16 ;
...
break;
default:
F_26 ( & V_22 -> V_35 , L_3 , V_40 [ 0 ] ) ;
return - V_49 ;
}
memcpy ( & V_7 -> V_50 , & V_51 , sizeof( V_7 -> V_50 ) ) ;
if ( F_1 ( V_40 [ 1 ] ) != V_52 ) {
T_1 V_1 ;
V_16 = F_3 ( V_7 , & V_1 , V_53 , sizeof( V_1 ) ) ;
if ( V_16 < 0 ) {
F_26 ( & V_22 -> V_35 ,
L_4 ,
V_16 ) ;
...
if ( V_16 )
return V_16 ;
V_16 = F_27 ( & V_22 -> V_35 . V_30 , & V_7 -> V_50 ) ;
if ( V_16 ) {
F_26 ( & V_22 -> V_35 , L_6 ,
V_16 ) ;
return V_16 ;
...
static int F_29 ( struct V_37 * V_22 )
{
struct V_6 * V_7 = F_30 ( V_22 ) ;
F_31 ( & V_22 -> V_35 . V_30 , & V_7 -> V_50 ) ;
return 0 ;
}
