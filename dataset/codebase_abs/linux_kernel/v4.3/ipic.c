...
enum V_43 V_44 )
{
return V_40 -> V_45 == NULL || V_40 -> V_45 == V_42 ;
}
...
struct V_48 V_49 ;
T_1 V_12 = 0 , V_50 ;
V_50 = F_24 ( V_42 , 0 , & V_49 ) ;
if ( V_50 )
return NULL ;
V_4 = F_25 ( sizeof( * V_4 ) , V_51 ) ;
if ( V_4 == NULL )
return NULL ;
V_4 -> V_52 = F_26 ( V_42 , V_53 ,
& V_54 , V_4 ) ;
if ( V_4 -> V_52 == NULL ) {
F_27 ( V_4 ) ;
return NULL ;
}
V_4 -> V_14 = F_28 ( V_49 . V_55 , F_29 ( & V_49 ) ) ;
...
int F_31 ( unsigned int V_5 , unsigned int V_78 )
{
...
F_40 ( V_6 == NULL ) ;
#define F_41 0x7f
V_9 = F_1 ( V_6 -> V_14 , V_91 ) & F_41 ;
if ( V_9 == 0 )
return V_92 ;
return F_42 ( V_6 -> V_52 , V_9 ) ;
}
