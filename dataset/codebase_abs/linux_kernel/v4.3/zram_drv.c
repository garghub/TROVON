...
static void F_100 ( struct V_120 * V_121 , struct V_99 * V_99 )
{
...
V_5 = V_4 -> V_5 ;
F_61 ( V_4 ) ;
F_106 ( V_4 -> V_131 , F_107 ( & V_4 -> V_75 ) == 0 ) ;
...
V_4 -> V_106 -> V_145 = V_146 ;
V_4 -> V_106 -> V_147 = V_140 ;
V_4 -> V_106 -> V_148 = & V_149 ;
V_4 -> V_106 -> V_121 = V_121 ;
V_4 -> V_106 -> V_121 -> V_122 = V_4 ;
V_4 -> V_106 -> V_8 = V_4 ;
snprintf ( V_4 -> V_106 -> V_132 , 16 , L_24 , V_140 ) ;
F_108 ( V_4 -> V_106 , 0 ) ;
F_135 ( V_150 , V_4 -> V_106 -> V_121 ) ;
F_136 ( V_151 , V_4 -> V_106 -> V_121 ) ;
F_137 ( V_4 -> V_106 -> V_121 , V_22 ) ;
F_138 ( V_4 -> V_106 -> V_121 ,
V_27 ) ;
F_139 ( V_4 -> V_106 -> V_121 , V_22 ) ;
F_140 ( V_4 -> V_106 -> V_121 , V_22 ) ;
V_4 -> V_106 -> V_121 -> V_152 . V_153 = V_22 ;
F_141 ( V_4 -> V_106 -> V_121 , V_154 ) ;
if ( V_27 == V_22 )
V_4 -> V_106 -> V_121 -> V_152 . V_155 = 1 ;
else
V_4 -> V_106 -> V_121 -> V_152 . V_155 = 0 ;
F_135 ( V_156 , V_4 -> V_106 -> V_121 ) ;
F_142 ( V_4 -> V_106 ) ;
V_57 = F_143 ( & F_144 ( V_4 -> V_106 ) -> V_157 ,
& V_158 ) ;
if ( V_57 < 0 ) {
F_71 ( L_25 ,
V_140 ) ;
...
F_53 ( V_4 -> V_61 , V_160 , sizeof( V_4 -> V_61 ) ) ;
V_4 -> V_10 = NULL ;
V_4 -> V_55 = 1 ;
F_49 ( L_26 , V_4 -> V_106 -> V_132 ) ;
return V_140 ;
V_159:
F_145 ( V_4 -> V_106 ) ;
F_146 ( V_4 -> V_106 ) ;
...
V_4 -> V_138 = true ;
F_122 ( & V_126 -> V_136 ) ;
F_150 ( & F_144 ( V_4 -> V_106 ) -> V_157 ,
& V_158 ) ;
F_124 ( V_126 ) ;
F_105 ( V_4 ) ;
F_123 ( V_126 ) ;
F_49 ( L_27 , V_4 -> V_106 -> V_132 ) ;
F_148 ( & V_141 , V_4 -> V_106 -> V_147 ) ;
...
static T_5 F_151 ( struct V_161 * V_161 ,
struct V_162 * V_42 ,
char * V_43 )
{
int V_57 ;
...
struct V_4 * V_4 ;
int V_57 , V_165 ;
V_57 = F_47 ( V_43 , 10 , & V_165 ) ;
if ( V_57 )
return V_57 ;
if ( V_165 < 0 )
return - V_53 ;
F_121 ( & V_163 ) ;
V_4 = F_153 ( & V_141 , V_165 ) ;
if ( V_4 )
V_57 = F_149 ( V_4 ) ;
else
V_57 = - V_166 ;
...
static int F_154 ( int V_167 , void * V_35 , void * V_168 )
{
F_149 ( V_35 ) ;
return 0 ;
}
