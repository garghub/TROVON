...
static int F_34 ( struct V_44 * V_45 , int V_66 )
{
F_7 ( L_6 ) ;
return 0 ;
}
...
F_41 ( & V_45 -> V_18 , V_17 -> V_83 . V_85 , 0 ) ;
F_42 ( V_45 , V_78 ) ;
return V_45 ;
}
static void F_43 ( struct V_44 * V_45 )
{
struct V_16 * V_17 = V_45 -> V_17 ;
struct V_19 * V_20 = V_17 -> V_21 ;
F_44 ( V_17 ) ;
F_45 ( V_20 , V_45 ) ;
F_46 ( V_17 ) ;
...
if ( ! V_92 -> V_144 )
continue;
F_94 ( V_154 , & V_38 -> V_52 ) ;
for ( V_42 = 0 ; V_42 < V_38 -> V_55 ; V_42 ++ )
F_95 ( V_154 , L_24 , V_42 ,
V_38 -> V_54 [ V_42 ] . V_28 ,
V_38 -> V_54 [ V_42 ] . V_32 ) ;
}
F_46 ( V_17 ) ;
...
int F_96 ( struct V_19 * V_20 )
{
#if F_97 ( V_161 )
return F_98 ( V_20 , V_162 , 1 ) ;
#endif
return 0 ;
}
