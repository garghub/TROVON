...
int F_27 ( struct V_1 * V_2 , const char * V_62 )
{
int V_55 , V_63 ;
const struct V_64 * V_65 ;
T_2 V_66 ;
const void * V_22 ;
V_55 = F_28 ( & V_65 , V_62 , F_29 ( V_2 ) ) ;
if ( V_55 ) {
F_2 ( V_2 , L_48 , V_62 ) ;
return V_55 ;
}
F_10 ( V_2 , L_49 , V_62 , V_65 -> V_4 ) ;
for ( V_66 = V_65 -> V_4 , V_22 = V_65 -> V_3 ; V_66 ; V_66 -= V_63 , V_22 += V_63 ) {
V_63 = F_1 ( V_2 , V_22 , V_66 ) ;
if ( V_63 < 0 ) {
V_55 = V_63 ;
goto V_67;
}
V_55 = F_26 ( V_2 , V_22 , V_63 ) ;
if ( V_55 < 0 )
goto V_67;
}
V_67:
