...
F_16 ( 1 , V_42 , V_3 , L_2 , ( unsigned long long ) V_37 ) ;
if ( V_3 -> V_43 == NULL || V_3 -> V_43 -> V_44 == NULL )
F_20 ( V_3 , L_3 ) ;
if ( V_37 & V_41 ) {
F_21 ( V_3 , V_45 , NULL ) ;
F_7 ( V_8 , 0x01 , 0 , 1 ) ;
...
static int F_23 ( struct V_2 * V_3 , int V_51 )
{
struct V_1 * V_8 = F_1 ( V_3 ) ;
F_16 ( 1 , V_42 , V_3 , L_6 , V_51 ) ;
if ( V_8 -> V_51 != V_51 ) {
V_8 -> V_51 = V_51 ;
F_7 ( V_8 , 0x16 , 7 , ! V_51 ) ;
}
...
switch ( V_5 -> V_53 ) {
case V_54 :
F_4 ( V_8 , 0x0a , V_5 -> V_55 ) ;
break;
case V_56 :
F_4 ( V_8 , 0x0c , V_5 -> V_55 & 0xff ) ;
F_7 ( V_8 , 0x0b , 2 , ( ( V_5 -> V_55 >> 8 ) & 0x01 ) ) ;
break;
case V_57 :
F_4 ( V_8 , 0x0d , ( V_5 -> V_55 >> 7 ) & 0xff ) ;
F_7 ( V_8 , 0x0b , 1 , ( ( V_5 -> V_55 >> 15 ) & 0x01 ) ) ;
V_52 = ( V_5 -> V_55 * 180 ) / 254 ;
F_4 ( V_8 , 0x0e , ( V_52 >> 7 ) & 0xff ) ;
F_7 ( V_8 , 0x0b , 0 , ( V_52 >> 15 ) & 0x01 ) ;
break;
case V_58 :
F_4 ( V_8 , 0x0f , V_5 -> V_55 ) ;
break;
default:
return - V_46 ;
}
...
const struct V_59 * V_53 )
{
int V_60 , V_61 ;
struct V_1 * V_8 ;
struct V_2 * V_3 ;
const char * V_62 ;
if ( ! F_9 ( V_12 -> V_17 , V_63 ) )
return - V_64 ;
V_8 = F_26 ( & V_12 -> V_65 , sizeof( * V_8 ) , V_66 ) ;
if ( V_8 == NULL )
return - V_67 ;
V_3 = & V_8 -> V_3 ;
F_27 ( V_3 , V_12 , & V_68 ) ;
...
F_28 ( V_12 , L_11 , V_62 ,
V_12 -> V_69 << 1 , V_12 -> V_17 -> V_62 ) ;
V_8 -> V_24 = V_41 ;
V_8 -> V_48 = 0 ;
V_8 -> V_51 = 1 ;
V_60 = F_13 ( V_3 ) ;
if ( V_60 < 0 )
F_16 ( 1 , V_42 , V_3 , L_12 , V_60 ) ;
F_29 ( & V_8 -> V_7 , 4 ) ;
F_30 ( & V_8 -> V_7 , & V_70 ,
V_54 , - 128 , 127 , 1 , 0 ) ;
F_30 ( & V_8 -> V_7 , & V_70 ,
