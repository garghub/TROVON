...
V_18 = 0 ;
return & ( (struct V_19 * ) ( V_14 -> V_20 ) + V_18 ) -> V_2 ;
}
...
struct V_25 * V_26 ;
struct V_27 * V_28 ;
struct V_29 * V_30 = F_17 ( V_14 ) ;
struct V_31 * V_32 = & V_22 -> V_32 ;
int V_33 ;
if ( ! V_24 )
return;
V_26 = F_18 ( V_32 -> V_34 , L_1 ) ;
if ( ! V_26 )
return;
V_33 = F_19 ( V_26 ) ;
if ( ! V_33 )
...
if ( ! V_33 )
return 0 ;
V_20 = F_20 ( V_32 , sizeof( * V_20 ) * V_33 , V_36 ) ;
if ( ! V_20 )
return - V_44 ;
V_14 -> V_45 = V_33 ;
V_14 -> V_20 = V_20 ;
F_27 (mix, priv, i) {
snprintf ( V_39 , V_40 , L_4 ,
V_46 , V_41 ) ;
V_38 = F_28 ( V_32 , V_39 ) ;
if ( F_29 ( V_38 ) )
return F_30 ( V_38 ) ;
V_20 -> V_30 = & V_30 -> V_28 [ V_41 ] ;
V_42 = F_31 ( V_14 , & V_20 -> V_2 , & V_47 ,
V_38 , V_48 , V_41 ) ;
if ( V_42 )
return V_42 ;
}
