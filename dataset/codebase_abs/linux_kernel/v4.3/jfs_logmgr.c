...
F_105 ( V_214 , V_26 -> V_205 , V_61 , V_26 -> V_204 ) ;
F_106 ( V_214 -> V_217 . V_220 != V_61 ) ;
V_214 -> V_221 = V_222 ;
V_214 -> V_223 = V_26 ;
if ( log -> V_169 ) {
V_214 -> V_217 . V_220 = 0 ;
...
F_108 ( V_26 -> V_206 , ( V_26 -> V_116 != V_215 ) ) ;
return 0 ;
}
...
log -> V_184 = V_26 ;
V_26 -> V_86 = V_226 -> V_86 ;
V_226 -> V_86 = V_26 ;
}
V_226 = V_26 ;
}
if ( ( V_26 != V_226 -> V_86 ) || ! ( V_45 & V_89 ) ) {
F_99 ( V_19 ) ;
return;
}
F_99 ( V_19 ) ;
...
F_97 ( V_19 ) ;
F_98 ( V_26 -> V_206 , ( V_26 -> V_116 & V_230 ) , V_19 ) ;
...
static void V_222 ( struct V_214 * V_214 )
{
struct V_25 * V_26 = V_214 -> V_223 ;
struct V_25 * V_80 , * V_226 ;
struct V_1 * log ;
unsigned long V_19 ;
...
int F_118 ( struct V_1 * log , T_3 V_235 , int V_236 )
{
int V_93 = - V_96 ;
struct V_3 * V_4 ;
struct V_170 * V_170 ;
...
struct V_25 * V_26 ;
F_5 ( L_46 ,
( long long ) V_235 , V_236 ) ;
V_4 = F_29 ( log -> V_152 . V_66 , struct V_3 , V_161 ) ;
V_26 = F_32 ( log , 1 ) ;
V_238 = V_236 >> V_4 -> V_239 ;
V_170 = (struct V_170 * ) V_26 -> V_42 ;
V_170 -> V_174 = F_33 ( V_175 ) ;
V_170 -> V_240 = F_33 ( V_241 ) ;
V_170 -> V_177 = F_33 ( V_178 ) ;
V_170 -> V_45 = F_33 ( V_4 -> V_141 ) ;
V_170 -> V_92 = F_33 ( V_238 ) ;
V_170 -> V_242 = F_33 ( V_4 -> V_242 ) ;
V_170 -> V_167 = F_33 ( V_4 -> V_167 ) ;
V_170 -> V_179 = F_33 ( 2 * V_61 + V_63 + V_67 ) ;
V_26 -> V_116 = V_89 | V_180 | V_227 ;
V_26 -> V_208 = V_235 + V_4 -> V_243 ;
F_109 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
V_28 = (struct V_27 * ) V_26 -> V_42 ;
V_28 -> V_81 . V_70 = V_28 -> V_88 . V_70 = F_33 ( V_238 - 3 ) ;
V_28 -> V_81 . V_43 = V_28 -> V_88 . V_43 = F_21 ( V_63 + V_67 ) ;
V_237 = (struct V_11 * ) & V_28 -> V_47 ;
V_237 -> V_130 = 0 ;
V_237 -> V_131 = 0 ;
V_237 -> type = F_21 ( V_132 ) ;
V_237 -> V_60 = 0 ;
V_237 -> log . V_129 . V_128 = 0 ;
V_26 -> V_208 += V_4 -> V_243 ;
V_26 -> V_116 = V_89 | V_180 | V_227 ;
F_109 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
for ( V_79 = 0 ; V_79 < V_238 - 3 ; V_79 ++ ) {
...
static int F_119 ( struct V_244 * V_245 , void * V_246 )
{
F_120 ( V_245 ,
L_47
L_48
...
static int F_121 ( struct V_247 * V_247 , struct V_248 * V_248 )
{
return F_122 ( V_248 , F_119 , NULL ) ;
}
