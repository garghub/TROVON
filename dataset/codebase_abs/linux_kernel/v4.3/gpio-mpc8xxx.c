...
return F_23 ( V_7 -> V_25 , V_24 ) ;
else
return - V_26 ;
}
static void F_24 ( struct V_27 * V_28 )
{
struct V_3 * V_7 = F_25 ( V_28 ) ;
...
{
struct V_3 * V_7 = F_31 ( V_35 ) ;
struct V_4 * V_5 = & V_7 -> V_6 ;
unsigned long V_17 ;
F_10 ( & V_7 -> V_18 , V_17 ) ;
F_19 ( V_5 -> V_9 + V_32 , F_1 ( F_32 ( V_35 ) ) ) ;
F_12 ( & V_7 -> V_18 , V_17 ) ;
}
...
unsigned long V_17 ;
F_10 ( & V_7 -> V_18 , V_17 ) ;
F_17 ( V_5 -> V_9 + V_32 , F_1 ( F_32 ( V_35 ) ) ) ;
F_12 ( & V_7 -> V_18 , V_17 ) ;
}
...
struct V_3 * V_7 = F_31 ( V_35 ) ;
struct V_4 * V_5 = & V_7 -> V_6 ;
F_11 ( V_5 -> V_9 + V_31 , F_1 ( F_32 ( V_35 ) ) ) ;
}
...
F_42 ( & V_53 -> V_56 ) ;
int V_62 ;
V_7 = F_43 ( & V_53 -> V_56 , sizeof( * V_7 ) , V_63 ) ;
if ( ! V_7 )
return - V_64 ;
F_44 ( V_53 , V_7 ) ;
F_45 ( & V_7 -> V_18 ) ;
...
if ( V_62 )
return V_62 ;
V_7 -> V_76 = F_47 ( V_55 , 0 ) ;
if ( V_7 -> V_76 == V_77 )
return 0 ;
V_7 -> V_25 = F_48 ( V_55 , V_2 ,
& V_78 , V_7 ) ;
if ( ! V_7 -> V_25 )
return 0 ;
V_59 = F_49 ( V_79 , V_55 ) ;
...
{
struct V_3 * V_7 = F_52 ( V_53 ) ;
if ( V_7 -> V_25 ) {
F_50 ( V_7 -> V_76 , NULL , NULL ) ;
F_53 ( V_7 -> V_25 ) ;
}
F_54 ( & V_7 -> V_6 ) ;
return 0 ;
