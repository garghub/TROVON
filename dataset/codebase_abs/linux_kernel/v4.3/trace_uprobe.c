...
F_24 ( & V_16 -> V_33 . V_34 ) ) ;
F_55 ( V_73 , L_21 , V_16 -> V_45 ) ;
if ( V_16 -> V_17 ) {
F_55 ( V_73 , L_22 , ( void * ) V_16 -> V_17 ) ;
} else {
switch ( sizeof( void * ) ) {
case 4 :
F_55 ( V_73 , L_23 ) ;
...
for ( V_42 = 0 ; V_42 < V_16 -> V_33 . V_43 ; V_42 ++ )
F_55 ( V_73 , L_25 , V_16 -> V_33 . args [ V_42 ] . V_36 , V_16 -> V_33 . args [ V_42 ] . V_77 ) ;
F_56 ( V_73 , '\n' ) ;
return 0 ;
}
...
if ( F_127 ( V_69 > V_157 , L_29 ) )
return;
F_128 () ;
V_153 = F_129 ( V_34 -> V_22 ) ;
if ( F_130 ( V_153 ) )
goto V_124;
V_104 = F_131 ( V_69 , V_34 -> V_27 . type , NULL , & V_154 ) ;
if ( ! V_104 )
goto V_124;
if ( F_11 ( V_16 ) ) {
V_104 -> V_14 [ 0 ] = V_99 ;
...
F_132 ( V_104 , V_69 , V_154 , 0 , 1 , V_4 , V_153 , NULL ) ;
V_124:
F_133 () ;
}
...
if ( F_43 ( V_176 ) )
return 0 ;
F_147 ( L_31 , 0644 , V_176 ,
NULL , & V_177 ) ;
F_147 ( L_32 , 0444 , V_176 ,
NULL , & V_178 ) ;
return 0 ;
}
