...
struct V_253 * V_253 ;
T_5 V_254 ;
unsigned int V_255 , V_256 , V_257 ;
T_6 V_258 , V_259 , V_260 ;
struct V_261 * V_262 = V_55 -> V_263 ;
F_204 ( V_117 , V_248 ,
V_249 , V_250 ) ;
V_257 =
( F_187 ( V_6 ) <<
F_13 ( V_6 ) -> V_264 ) >> V_265 ;
V_258 = ( ( T_6 ) V_117 ) << F_13 ( V_6 ) -> V_264 ;
V_259 = V_258 + ( V_250 << F_13 ( V_6 ) -> V_264 ) ;
if ( V_259 > F_205 ( V_55 ) )
V_259 = F_205 ( V_55 ) ;
while ( V_258 < V_259 ) {
V_254 = V_258 >> V_265 ;
V_260 = ( ( T_6 ) V_254 + 1 ) << V_265 ;
if ( V_260 > V_259 )
V_260 = V_259 ;
V_255 = V_258 & ( V_266 - 1 ) ;
V_256 = V_266 ;
if ( V_260 & ( V_266 - 1 ) )
V_256 = V_260 & ( V_266 - 1 ) ;
V_253 = F_206 ( V_262 , V_254 , V_48 ) ;
if ( ! V_253 ) {
V_50 = - V_53 ;
F_56 ( V_50 ) ;
break;
}
if ( V_266 <= F_13 ( V_6 ) -> V_267 )
F_5 ( F_207 ( V_253 ) ) ;
if ( ! F_208 ( V_253 ) ) {
V_50 = F_209 ( V_253 , V_268 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_269;
}
...
int V_122 , V_270 = F_174 ( V_6 , V_250 ) ;
T_1 V_271 = F_174 ( V_6 , V_248 ) ;
T_1 V_252 = F_174 ( V_6 , V_249 ) ;
struct V_27 * V_28 = F_13 ( V_6 ) ;
struct V_7 * V_272 = NULL ;
struct V_7 * V_77 = NULL ;
F_204 ( V_117 , V_248 ,
V_249 , V_250 ) ;
for ( V_122 = 0 ; V_122 < V_270 ; V_122 ++ , V_271 ++ , V_252 ++ ) {
...
F_84 ( V_3 , V_77 ) ;
V_50 = F_15 ( V_3 , V_271 , & V_272 , NULL ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
break;
}
...
memcpy ( V_77 -> V_12 , V_272 -> V_12 , V_6 -> V_88 ) ;
F_90 ( V_71 , V_77 ) ;
F_58 ( V_77 ) ;
F_58 ( V_272 ) ;
V_77 = NULL ;
...
struct V_141 * V_205 = NULL ;
struct V_137 * V_138 ;
struct V_5 * V_6 = F_108 ( V_145 -> V_275 ) ;
T_1 V_276 = F_119 ( V_145 -> V_275 ) ;
F_221 ( ( unsigned long long ) V_276 ,
V_117 , V_118 , V_243 , V_273 ) ;
memset ( & V_274 , 0 , sizeof( V_274 ) ) ;
V_274 . V_149 = F_88 ( V_117 ) ;
V_274 . V_183 = F_86 ( V_118 ) ;
V_274 . V_154 = F_87 ( F_174 ( V_6 ,
V_243 ) ) ;
V_274 . V_242 = V_273 ;
V_274 . V_242 &= ~ V_220 ;
V_205 = F_110 ( V_145 ) ;
...
V_50 = F_111 ( V_145 -> V_275 , V_205 , V_117 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
}
...
V_50 = F_10 ( V_6 ,
L_11 ,
( unsigned long long ) V_276 , V_117 ) ;
goto V_17;
}
...
{
int V_50 ;
struct V_2 * V_3 = V_278 -> V_280 . V_275 ;
T_1 V_276 = F_119 ( V_3 ) ;
F_225 ( ( unsigned long long ) V_276 ,
V_117 , V_279 , V_37 , V_118 , V_273 ) ;
if ( ! ( V_273 & V_281 ) ) {
V_50 = V_278 -> V_282 ( V_71 , V_278 -> V_55 ,
V_117 , V_279 , V_37 , V_118 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
}
}
V_50 = F_220 ( V_71 , & V_278 -> V_280 ,
V_117 , V_37 , V_118 , V_273 ,
V_278 -> V_73 , & V_278 -> V_208 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
V_17:
return V_50 ;
...
return 0 ;
V_258 = ( ( T_6 ) V_117 ) << F_13 ( V_6 ) -> V_264 ;
V_259 = V_258 + ( V_244 << F_13 ( V_6 ) -> V_264 ) ;
V_50 = F_228 ( V_55 -> V_263 ,
V_258 , V_259 - 1 ) ;
if ( V_50 < 0 ) {
F_56 ( V_50 ) ;
return V_50 ;
...
static int F_231 ( struct V_277 * V_278 ,
T_2 V_284 , T_2 * V_243 ,
T_2 * V_244 ,
unsigned int * V_285 )
{
return F_232 ( V_278 -> V_55 , V_284 , V_243 ,
V_244 , V_285 ) ;
}
...
T_2 V_286 , V_250 , V_287 ;
unsigned int V_213 ;
struct V_27 * V_28 = F_13 ( V_6 ) ;
T_3 * V_71 ;
struct V_7 * V_116 = NULL ;
struct V_2 * V_245 = & V_278 -> V_101 -> V_4 ;
struct V_119 V_123 ;
F_234 ( V_117 , V_243 ,
V_244 , V_242 ) ;
...
if ( V_278 -> V_288 && V_278 -> V_288 -> V_290 ) {
V_50 = V_278 -> V_288 -> V_290 ( V_278 -> V_55 , V_71 ,
V_278 -> V_288 -> V_291 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_86;
...
if ( V_278 -> V_292 == F_231 ) {
V_50 = F_226 ( V_6 , V_278 -> V_55 , V_117 ,
V_287 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
}
...
static int F_236 ( struct V_277 * V_278 )
{
int V_50 = 0 ;
struct V_55 * V_55 = V_278 -> V_55 ;
T_2 V_235 = V_278 -> V_235 , V_236 = V_278 -> V_236 ;
T_2 V_243 , V_244 ;
unsigned int V_273 ;
struct V_27 * V_28 = F_13 ( V_55 -> V_76 ) ;
if ( ! V_1 ( F_13 ( V_55 -> V_76 ) ) ) {
...
F_237 ( & V_278 -> V_208 ) ;
while ( V_236 ) {
V_50 = V_278 -> V_292 ( V_278 , V_235 , & V_243 ,
& V_244 , & V_273 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
break;
...
if ( F_238 ( & V_278 -> V_208 ) ) {
F_239 ( V_28 , 1 ) ;
F_240 ( V_28 , & V_278 -> V_208 ) ;
}
return V_50 ;
}
...
F_5 ( ! ( V_75 -> V_60 & V_61 ) ) ;
V_50 = F_192 ( V_55 , & V_59 -> V_293 . V_294 ,
V_117 , V_233 , V_234 ,
& V_235 , & V_236 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
...
V_235 , V_236 ) ;
F_5 ( V_236 == 0 ) ;
V_278 = F_53 ( sizeof( struct V_277 ) , V_48 ) ;
if ( ! V_278 ) {
V_50 = - V_53 ;
F_56 ( V_50 ) ;
goto V_17;
...
static int F_246 ( struct V_277 * V_278 ,
T_2 V_284 , T_2 * V_243 ,
T_2 * V_244 ,
unsigned int * V_285 )
{
struct V_55 * V_55 = V_278 -> V_55 ;
struct V_295 * V_296 = V_278 -> V_297 ;
return F_247 ( V_55 , V_284 , V_243 ,
V_244 , & V_296 -> V_298 ,
V_285 ) ;
}
...
T_2 V_243 , V_244 ;
T_2 V_117 = 0 , V_222 = F_12 ( V_296 -> V_299 ) ;
struct V_10 * V_11 ;
struct V_119 V_123 ;
struct V_7 * V_116 = NULL ;
while ( V_117 < V_222 ) {
...
{
int V_50 ;
struct V_295 * V_296 = V_301 -> V_304 ;
struct V_74 * V_75 = F_61 ( V_55 ) ;
struct V_277 * V_278 = NULL ;
T_2 V_235 , V_236 ;
F_5 ( ! ( V_75 -> V_60 & V_61 ) ) ;
V_50 = F_192 ( V_55 , & V_296 -> V_298 ,
V_117 , V_233 , V_151 ,
& V_235 , & V_236 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
...
if ( V_303 && V_303 -> V_290 ) {
V_50 = V_303 -> V_290 ( V_55 , V_71 , V_303 -> V_291 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
}
V_86:
...
V_55 -> V_306 = V_307 ;
V_59 -> V_306 = F_87 ( V_55 -> V_306 . V_308 ) ;
V_59 -> V_309 = F_88 ( V_55 -> V_306 . V_310 ) ;
F_90 ( V_71 , V_57 ) ;
V_86:
...
if ( V_243 && ! ( V_273 & V_220 ) ) {
V_50 = F_251 ( V_55 , & V_312 ,
& V_101 -> V_4 ,
V_51 , V_117 ,
V_243 , V_244 ,
& V_208 , NULL ) ;
...
static int F_257 ( struct V_55 * V_315 ,
struct V_7 * V_316 ,
struct V_55 * V_317 ,
struct V_7 * V_318 )
{
int V_50 ;
T_3 * V_71 ;
struct V_27 * V_28 = F_13 ( V_315 -> V_76 ) ;
struct V_58 * V_319 = (struct V_58 * ) V_316 -> V_12 ;
struct V_58 * V_320 = (struct V_58 * ) V_318 -> V_12 ;
F_5 ( ! ( F_61 ( V_315 ) -> V_60 & V_313 ) ) ;
V_71 = F_77 ( V_28 , V_305 ) ;
if ( F_78 ( V_71 ) ) {
V_50 = F_79 ( V_71 ) ;
F_56 ( V_50 ) ;
goto V_17;
}
V_50 = F_80 ( V_71 , F_81 ( V_317 ) , V_318 ,
V_85 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_86;
}
V_320 -> V_293 . V_321 . V_322 = V_319 -> V_293 . V_321 . V_322 ;
memcpy ( V_320 -> V_293 . V_321 . V_323 , V_319 -> V_293 . V_321 . V_323 ,
F_97 ( V_319 -> V_293 . V_321 . V_322 ) ) ;
F_19 ( & F_61 ( V_317 ) -> V_98 ) ;
F_61 ( V_317 ) -> V_60 |= V_313 ;
V_320 -> V_99 = F_86 ( F_61 ( V_317 ) -> V_60 ) ;
F_21 ( & F_61 ( V_317 ) -> V_98 ) ;
F_90 ( V_71 , V_318 ) ;
V_86:
F_92 ( V_28 , V_71 ) ;
V_17:
...
static int F_258 ( struct V_55 * V_315 ,
struct V_55 * V_317 ,
struct V_7 * V_318 ,
struct V_2 * V_245 ,
struct V_7 * V_51 ,
...
unsigned int V_273 ;
struct V_144 V_145 ;
F_243 ( & V_145 , F_81 ( V_317 ) , V_318 ) ;
V_191 = F_205 ( V_315 ) ;
V_222 = F_188 ( V_315 -> V_76 , V_191 ) ;
V_117 = 0 ;
while ( V_117 < V_222 ) {
V_50 = F_232 ( V_315 , V_117 , & V_243 ,
& V_244 , & V_273 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
...
static int F_259 ( struct V_55 * V_315 ,
struct V_7 * V_316 ,
struct V_55 * V_317 ,
struct V_7 * V_318 ,
bool V_324 )
...
T_3 * V_71 ;
struct V_58 * V_319 = (struct V_58 * ) V_316 -> V_12 ;
struct V_58 * V_59 = (struct V_58 * ) V_318 -> V_12 ;
T_6 V_191 = F_205 ( V_315 ) ;
V_71 = F_77 ( F_13 ( V_317 -> V_76 ) ,
V_305 ) ;
if ( F_78 ( V_71 ) ) {
V_50 = F_79 ( V_71 ) ;
F_56 ( V_50 ) ;
...
F_19 ( & F_61 ( V_317 ) -> V_98 ) ;
F_61 ( V_317 ) -> V_131 = F_61 ( V_315 ) -> V_131 ;
F_61 ( V_317 ) -> V_325 = F_61 ( V_315 ) -> V_325 ;
F_61 ( V_317 ) -> V_60 = F_61 ( V_315 ) -> V_60 ;
F_21 ( & F_61 ( V_317 ) -> V_98 ) ;
F_260 ( V_317 , V_191 ) ;
V_317 -> V_326 = V_315 -> V_326 ;
V_59 -> V_327 = V_319 -> V_327 ;
V_59 -> V_328 = V_319 -> V_328 ;
V_59 -> V_329 = V_319 -> V_329 ;
V_59 -> V_99 = V_319 -> V_99 ;
V_59 -> V_330 = V_319 -> V_330 ;
if ( V_324 ) {
V_317 -> V_331 = V_315 -> V_331 ;
V_317 -> V_332 = V_315 -> V_332 ;
V_317 -> V_333 = V_315 -> V_333 ;
V_59 -> V_331 = V_319 -> V_331 ;
V_59 -> V_332 = V_319 -> V_332 ;
V_59 -> V_333 = V_319 -> V_333 ;
V_317 -> V_306 = V_307 ;
V_59 -> V_306 = F_87 ( V_317 -> V_306 . V_308 ) ;
V_59 -> V_309 = F_88 ( V_317 -> V_306 . V_310 ) ;
V_317 -> V_334 = V_315 -> V_334 ;
V_59 -> V_334 = V_319 -> V_334 ;
V_59 -> V_335 = V_319 -> V_335 ;
}
F_90 ( V_71 , V_318 ) ;
V_86:
F_92 ( F_13 ( V_317 -> V_76 ) , V_71 ) ;
return V_50 ;
}
static int F_261 ( struct V_55 * V_315 ,
struct V_7 * V_316 ,
struct V_55 * V_317 ,
struct V_7 * V_318 ,
bool V_324 )
...
struct V_1 * V_101 ;
F_237 ( & V_208 ) ;
V_50 = F_94 ( V_317 , V_318 ,
F_11 ( V_59 -> V_62 ) ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
}
if ( F_61 ( V_315 ) -> V_60 & V_313 ) {
V_50 = F_257 ( V_315 , V_316 ,
V_317 , V_318 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
goto V_17;
...
static int F_262 ( struct V_337 * V_338 ,
struct V_7 * V_272 ,
struct V_55 * V_339 ,
bool V_324 )
{
int V_50 ;
struct V_55 * V_55 = F_263 ( V_338 ) ;
struct V_7 * V_77 = NULL ;
if ( F_61 ( V_55 ) -> V_340 & V_341 ) {
V_50 = - V_342 ;
F_56 ( V_50 ) ;
goto V_17;
}
V_50 = F_264 ( V_55 -> V_263 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
}
V_50 = F_254 ( V_55 , V_272 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
}
F_265 ( & V_339 -> V_112 , V_343 ) ;
V_50 = F_266 ( V_339 , & V_77 , 1 ,
V_344 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_115;
}
V_50 = F_261 ( V_55 , V_272 ,
V_339 , V_77 , V_324 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_345;
...
V_17:
if ( ! V_50 ) {
V_50 = F_268 ( V_55 -> V_263 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
}
return V_50 ;
}
static int F_269 ( struct V_337 * V_338 , struct V_55 * V_346 ,
struct V_337 * V_347 , bool V_324 )
{
int error ;
struct V_55 * V_55 = F_263 ( V_338 ) ;
struct V_7 * V_272 = NULL ;
struct V_55 * V_348 = NULL ;
struct V_349 * V_350 , * V_351 ;
T_7 V_352 ;
if ( ! V_1 ( F_13 ( V_55 -> V_76 ) ) )
return - V_353 ;
V_352 = V_55 -> V_333 ;
error = F_270 ( V_346 , & V_352 , & V_350 , & V_351 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
error = F_271 ( V_346 , V_352 ,
& V_348 ) ;
if ( error ) {
F_56 ( error ) ;
goto V_17;
...
static inline int F_278 ( struct V_55 * V_346 , struct V_337 * V_355 )
{
if ( F_279 ( V_355 ) )
return - V_356 ;
if ( F_280 ( V_346 ) )
return - V_357 ;
return F_281 ( V_346 , V_358 | V_359 ) ;
}
static int F_282 ( struct V_337 * V_338 , struct V_55 * V_346 ,
struct V_337 * V_347 , bool V_324 )
{
struct V_55 * V_55 = F_263 ( V_338 ) ;
int error ;
if ( ! V_55 )
return - V_357 ;
error = F_278 ( V_346 , V_347 ) ;
if ( error )
return error ;
if ( V_346 -> V_76 != V_55 -> V_76 )
return - V_360 ;
...
return - V_361 ;
if ( V_324 ) {
if ( ! F_286 ( F_287 () , V_55 -> V_331 ) && ! F_288 ( V_362 ) )
return - V_361 ;
if ( ! F_289 ( V_55 -> V_332 ) && ! F_288 ( V_362 ) )
return - V_361 ;
}
if ( ! V_324 ) {
error = F_281 ( V_55 , V_363 ) ;
if ( error )
return error ;
}
F_23 ( & V_55 -> V_112 ) ;
error = F_290 ( V_346 ) ;
if ( ! error )
error = F_269 ( V_338 , V_346 , V_347 , V_324 ) ;
F_25 ( & V_55 -> V_112 ) ;
if ( ! error )
F_291 ( V_346 , V_347 ) ;
return error ;
...
{
struct V_337 * V_347 ;
struct V_205 V_366 , V_367 ;
int error ;
if ( ! V_1 ( F_13 ( V_55 -> V_76 ) ) )
return - V_353 ;
error = F_293 ( V_368 , V_364 , 0 , & V_366 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
V_347 = F_294 ( V_368 , V_365 , & V_367 , 0 ) ;
error = F_79 ( V_347 ) ;
if ( F_78 ( V_347 ) ) {
F_56 ( error ) ;
goto V_17;
...
error = - V_360 ;
if ( V_366 . V_369 != V_367 . V_369 ) {
F_56 ( error ) ;
goto V_370;
}
error = F_282 ( V_366 . V_337 ,
F_263 ( V_367 . V_337 ) ,
V_347 , V_324 ) ;
V_370:
F_295 ( & V_367 , V_347 ) ;
