...
static struct V_376 * F_282 ( struct V_376 * V_45 )
{
F_40 ( & V_45 -> V_61 ) ;
return V_45 ;
}
...
static struct V_376 * F_283 ( void )
{
struct V_376 * V_45 ;
...
V_22 -> V_45 = V_45 ;
V_22 -> V_296 = V_296 ;
V_22 -> V_256 . V_379 = F_288 ( 1 << V_380 ) ;
V_22 -> V_256 . V_381 = F_288 ( 1 ) ;
V_22 -> V_256 . V_382 = F_288 ( 1 << V_380 ) ;
V_22 -> V_256 . V_383 = F_288 ( ( T_5 ) V_45 -> V_372 ) ;
return V_22 ;
}
...
if ( V_39 < 0 )
return V_39 ;
if ( V_39 < sizeof ( V_387 ) )
return - V_388 ;
if ( V_102 ) {
* V_102 = V_387 . V_102 ;
F_25 ( L_74 , ( unsigned int ) * V_102 ) ;
}
* V_142 = F_60 ( V_387 . V_97 ) ;
F_25 ( L_75 ,
...
goto V_49;
V_390 = V_389 ;
V_22 -> V_110 . V_112 = F_293 ( & V_390 ,
V_390 + V_39 , NULL , V_149 ) ;
V_39 = 0 ;
...
return - V_388 ;
V_392 = F_60 ( V_393 . V_392 ) ;
if ( V_392 & ~ V_394 )
return - V_324 ;
* V_143 = F_60 ( V_393 . V_131 ) ;
F_25 ( L_79 ,
( unsigned long long ) V_46 ,
( unsigned long long ) * V_143 ,
( unsigned long long ) F_60 ( V_393 . V_392 ) ) ;
return 0 ;
}
...
sizeof ( V_106 ) +
sizeof ( V_106 ) ;
V_389 = F_26 ( V_97 , V_59 ) ;
if ( ! V_389 ) {
V_39 = - V_57 ;
goto V_118;
}
V_384 = F_290 ( V_22 -> V_45 -> V_46 ) ;
V_39 = F_221 ( V_22 , V_22 -> V_292 ,
L_39 , L_80 ,
& V_384 , sizeof ( V_384 ) ,
V_389 , V_97 ) ;
...
V_39 = - V_132 ;
if ( V_372 > ( V_107 ) V_397 ) {
F_103 ( NULL , L_82 ,
( unsigned long long ) V_372 , V_397 ) ;
goto V_118;
}
V_374 = F_293 ( & V_390 , V_170 , NULL , V_59 ) ;
if ( F_30 ( V_374 ) ) {
V_39 = F_202 ( V_374 ) ;
goto V_118;
}
F_295 ( & V_390 , V_170 , V_46 , V_118 ) ;
F_295 ( & V_390 , V_170 , V_395 , V_118 ) ;
if ( ! V_22 -> V_261 ) {
V_261 -> V_372 = V_372 ;
V_261 -> V_374 = V_374 ;
V_261 -> V_46 = V_46 ;
...
V_400 = sizeof ( V_287 ) + V_117 ;
V_374 = F_26 ( V_400 , V_59 ) ;
if ( ! V_374 )
return NULL ;
V_390 = V_374 ;
V_170 = V_374 + V_400 ;
F_300 ( & V_390 , V_170 , V_22 -> V_45 -> V_374 , ( T_5 ) V_117 ) ;
V_97 = sizeof ( V_287 ) + V_401 ;
V_389 = F_26 ( V_97 , V_59 ) ;
if ( ! V_389 )
goto V_49;
V_39 = F_221 ( V_22 , V_402 ,
L_39 , L_90 ,
V_374 , V_400 ,
V_389 , V_97 ) ;
if ( V_39 < 0 )
...
V_390 = V_389 ;
V_170 = V_389 + V_39 ;
V_373 = F_293 ( & V_390 , V_170 , & V_117 , V_59 ) ;
if ( F_30 ( V_373 ) )
V_373 = NULL ;
else
...
F_17 ( V_45 -> V_374 ) ;
F_17 ( V_45 -> V_46 != V_47 ) ;
V_371 = F_306 ( V_207 -> V_403 , V_45 -> V_372 ) ;
if ( ! V_371 ) {
...
V_170 = V_389 + V_39 ;
V_39 = - V_388 ;
F_295 ( & V_390 , V_170 , V_119 , V_49 ) ;
F_308 ( & V_390 , V_170 , V_98 , V_49 ) ;
if ( V_98 > ( V_104 - sizeof ( struct V_105 ) )
/ sizeof ( V_107 ) ) {
V_39 = - V_4 ;
goto V_49;
}
if ( ! F_309 ( & V_390 , V_170 , V_98 * sizeof ( V_106 ) ) )
goto V_49;
V_39 = 0 ;
V_113 = F_63 ( V_98 , V_59 ) ;
if ( ! V_113 ) {
...
V_390 = V_389 ;
V_170 = V_389 + V_39 ;
V_134 = F_293 ( & V_390 , V_170 , NULL , V_59 ) ;
if ( F_30 ( V_134 ) )
goto V_49;
F_25 ( L_97 ,
...
static inline char * F_323 ( const char * * V_163 , T_6 * V_418 )
{
char * V_419 ;
T_6 V_117 ;
V_117 = F_322 ( V_163 ) ;
V_419 = F_324 ( * V_163 , V_117 + 1 , V_59 ) ;
if ( ! V_419 )
return NULL ;
* ( V_419 + V_117 ) = '\0' ;
* V_163 += V_117 ;
...
static int F_327 ( struct V_53 * V_56 , const char * V_371 )
{
...
int V_39 ;
V_429:
V_39 = F_328 ( V_56 -> V_63 -> V_207 . V_403 , V_371 ) ;
if ( V_39 == - V_34 && V_428 ++ < 1 ) {
V_39 = F_329 ( & V_56 -> V_63 -> V_430 , L_105 ,
& V_427 ) ;
if ( V_39 < 0 )
return V_39 ;
if ( V_56 -> V_63 -> V_207 . V_403 -> V_431 < V_427 ) {
F_330 ( & V_56 -> V_63 -> V_430 ) ;
( void ) F_331 ( & V_56 -> V_63 -> V_430 ,
V_427 ,
V_296 -> V_299 ) ;
goto V_429;
} else {
...
F_25 ( L_107 , V_243 ) ;
V_97 = sizeof ( V_287 ) + V_396 ;
V_432 = F_284 ( V_97 , V_149 ) ;
if ( ! V_432 ) {
V_39 = - V_57 ;
goto V_49;
}
...
static int F_335 ( struct V_21 * V_22 , int V_435 )
{
...
V_270 = F_285 ( V_22 -> V_53 , V_22 -> V_261 ,
NULL ) ;
if ( ! V_270 ) {
V_39 = - V_57 ;
goto V_118;
...
static int F_336 ( struct V_21 * V_22 , int V_435 )
{
int V_39 ;
V_39 = F_332 ( V_22 ) ;
if ( V_39 )
...
static T_11 F_344 ( struct V_451 * V_406 ,
const char * V_163 ,
T_6 V_375 )
{
struct V_21 * V_22 = NULL ;
...
V_452 = F_327 ( V_56 , V_45 -> V_371 ) ;
if ( V_452 < 0 ) {
if ( V_452 == - V_34 )
F_296 ( L_117 , V_45 -> V_371 ) ;
goto V_457;
}
V_45 -> V_372 = ( V_107 ) V_452 ;
if ( V_45 -> V_372 > ( V_107 ) V_397 ) {
F_103 ( NULL , L_118 ,
( unsigned long long ) V_45 -> V_372 , V_397 ) ;
V_452 = - V_132 ;
goto V_457;
}
...
static T_11 F_347 ( struct V_451 * V_406 ,
const char * V_163 ,
T_6 V_375 )
{
if ( V_13 )
return - V_4 ;
return F_344 ( V_406 , V_163 , V_375 ) ;
}
static T_11 F_348 ( struct V_451 * V_406 ,
const char * V_163 ,
T_6 V_375 )
{
return F_344 ( V_406 , V_163 , V_375 ) ;
}
static void V_411 ( struct V_17 * V_18 )
{
struct V_21 * V_22 = F_267 ( V_18 ) ;
F_237 ( V_22 ) ;
F_142 ( V_323 , & V_22 -> V_32 ) ;
...
struct V_21 * V_460 = V_459 -> V_270 ;
struct V_21 * V_461 ;
while ( V_460 && ( V_461 = V_460 -> V_270 ) ) {
V_459 = V_460 ;
V_460 = V_461 ;
}
F_17 ( V_460 ) ;
...
static T_11 F_349 ( struct V_451 * V_406 ,
const char * V_163 ,
T_6 V_375 )
{
struct V_21 * V_22 = NULL ;
...
static T_11 F_354 ( struct V_451 * V_406 ,
const char * V_163 ,
T_6 V_375 )
{
if ( V_13 )
return - V_4 ;
return F_349 ( V_406 , V_163 , V_375 ) ;
}
static T_11 F_355 ( struct V_451 * V_406 ,
const char * V_163 ,
T_6 V_375 )
{
return F_349 ( V_406 , V_163 , V_375 ) ;
