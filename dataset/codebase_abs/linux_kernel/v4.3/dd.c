...
static int F_59 ( struct V_29 * V_30 , void * V_52 )
{
...
static void F_61 ( void * V_59 , T_1 V_60 )
{
struct V_3 * V_4 = V_59 ;
struct V_53 V_54 = {
. V_4 = V_4 ,
...
static int F_65 ( struct V_3 * V_4 , bool V_61 )
{
int V_27 = 0 ;
F_62 ( V_4 ) ;
if ( V_4 -> V_21 ) {
...
{
return F_65 ( V_4 , false ) ;
}
void F_68 ( struct V_3 * V_4 )
{
F_65 ( V_4 , true ) ;
}
static int F_69 ( struct V_3 * V_4 , void * V_54 )
{
...
int F_70 ( struct V_29 * V_30 )
{
return F_71 ( V_30 -> V_24 , NULL , V_30 , F_69 ) ;
}
...
void F_76 ( struct V_29 * V_30 )
{
struct V_5 * V_65 ;
struct V_3 * V_4 ;
for (; ; ) {
F_77 ( & V_30 -> V_9 -> V_23 . V_66 ) ;
if ( F_3 ( & V_30 -> V_9 -> V_23 . V_67 ) ) {
F_78 ( & V_30 -> V_9 -> V_23 . V_66 ) ;
break;
}
V_65 = F_79 ( V_30 -> V_9 -> V_23 . V_67 . V_68 ,
struct V_5 ,
V_17 . V_69 ) ;
V_4 = V_65 -> V_3 ;
F_7 ( V_4 ) ;
