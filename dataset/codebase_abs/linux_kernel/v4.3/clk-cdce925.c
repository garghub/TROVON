...
static int F_45 ( struct V_51 * V_71 ,
const struct V_72 * V_73 )
{
struct V_74 * V_7 ;
struct V_75 * V_76 = V_71 -> V_50 . V_77 ;
const char * V_78 ;
const char * V_79 [ V_80 ] = { NULL ,} ;
struct V_81 V_82 ;
struct V_18 * V_18 ;
T_4 V_83 ;
int V_26 ;
...
struct V_75 * V_85 ;
char V_86 [ 6 ] ;
F_40 ( & V_71 -> V_50 , L_8 , V_14 ) ;
V_7 = F_46 ( & V_71 -> V_50 , sizeof( * V_7 ) , V_87 ) ;
if ( ! V_7 )
return - V_88 ;
V_7 -> V_51 = V_71 ;
V_7 -> V_28 = F_47 ( & V_71 -> V_50 , & V_89 ,
& V_71 -> V_50 , & V_90 ) ;
if ( F_48 ( V_7 -> V_28 ) ) {
F_49 ( & V_71 -> V_50 , L_9 ) ;
return F_50 ( V_7 -> V_28 ) ;
}
F_51 ( V_71 , V_7 ) ;
V_78 = F_52 ( V_76 , 0 ) ;
if ( ! V_78 ) {
...
F_40 ( & V_71 -> V_50 , L_11 , V_78 ) ;
if ( F_53 ( V_76 , L_12 , & V_83 ) == 0 )
F_18 ( V_7 -> V_28 ,
V_92 , ( V_83 << 3 ) & 0xF8 ) ;
F_15 ( V_7 -> V_28 , V_93 , F_16 ( 4 ) , 0 ) ;
...
V_79 [ V_26 ] = F_54 ( V_87 , L_13 ,
V_71 -> V_50 . V_77 -> V_98 , V_26 ) ;
V_82 . V_98 = V_79 [ V_26 ] ;
V_7 -> V_22 [ V_26 ] . V_27 = V_7 ;
V_7 -> V_22 [ V_26 ] . V_5 . V_82 = & V_82 ;
V_7 -> V_22 [ V_26 ] . V_24 = V_26 ;
V_18 = F_55 ( & V_71 -> V_50 , & V_7 -> V_22 [ V_26 ] . V_5 ) ;
if ( F_48 ( V_18 ) ) {
F_49 ( & V_71 -> V_50 , L_14 , V_26 ) ;
V_84 = F_50 ( V_18 ) ;
goto error;
}
sprintf ( V_86 , L_15 , V_26 + 1 ) ;
V_85 = F_56 ( V_76 , V_86 ) ;
if ( ! V_85 )
continue;
if ( ! F_53 ( V_85 ,
...
V_82 . V_97 = 1 ;
V_82 . V_96 = & V_78 ;
V_82 . V_98 = F_54 ( V_87 , L_20 , V_71 -> V_50 . V_77 -> V_98 ) ;
V_7 -> V_18 [ 0 ] . V_27 = V_7 ;
V_7 -> V_18 [ 0 ] . V_5 . V_82 = & V_82 ;
V_7 -> V_18 [ 0 ] . V_24 = 0 ;
V_7 -> V_18 [ 0 ] . V_32 = 1 ;
V_18 = F_55 ( & V_71 -> V_50 , & V_7 -> V_18 [ 0 ] . V_5 ) ;
F_59 ( V_82 . V_98 ) ;
if ( F_48 ( V_18 ) ) {
F_49 ( & V_71 -> V_50 , L_21 ) ;
V_84 = F_50 ( V_18 ) ;
...
V_82 . V_65 = V_103 ;
V_82 . V_97 = 1 ;
for ( V_26 = 1 ; V_26 < V_104 ; ++ V_26 ) {
V_82 . V_98 = F_54 ( V_87 , L_22 ,
V_71 -> V_50 . V_77 -> V_98 , V_26 + 1 ) ;
V_7 -> V_18 [ V_26 ] . V_27 = V_7 ;
V_7 -> V_18 [ V_26 ] . V_5 . V_82 = & V_82 ;
...
V_18 = F_55 ( & V_71 -> V_50 , & V_7 -> V_18 [ V_26 ] . V_5 ) ;
F_59 ( V_82 . V_98 ) ;
if ( F_48 ( V_18 ) ) {
F_49 ( & V_71 -> V_50 , L_23 ) ;
V_84 = F_50 ( V_18 ) ;
...
V_7 -> V_105 . V_106 = V_104 ;
V_7 -> V_105 . V_107 = V_7 -> V_101 ;
V_84 = F_60 ( V_71 -> V_50 . V_77 , V_108 ,
& V_7 -> V_105 ) ;
if ( V_84 )
F_49 ( & V_71 -> V_50 , L_24 ) ;
V_84 = 0 ;
