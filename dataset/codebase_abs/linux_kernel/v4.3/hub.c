...
if ( V_2 -> V_90 )
return;
V_81 = F_44 ( V_2 -> V_129 , V_140 ) ;
if ( V_81 != 0 && V_81 != - V_114 && V_81 != - V_141 )
...
int F_236 ( struct V_1 * V_2 , int V_70 , bool V_477 )
{
int V_55 ;
T_1 V_178 , V_3 ;
unsigned V_478 = 0xffff ;
int V_177 , V_479 = 0 ;
struct V_78 * V_79 = V_2 -> V_80 [ V_70 - 1 ] ;
for ( V_177 = 0 ; ; V_177 += V_182 ) {
V_55 = F_28 ( V_2 , V_70 , & V_3 , & V_178 ) ;
...
int V_481 ;
struct V_191 * V_157 = F_60 ( V_11 -> V_171 ) ;
if ( ! V_157 -> V_158 -> V_482 && V_169 <= 1 )
return - V_67 ;
if ( V_11 -> V_88 == V_431 )
return 0 ;
if ( V_11 -> V_88 != V_409 )
return - V_67 ;
if ( V_157 -> V_158 -> V_482 )
V_481 = V_157 -> V_158 -> V_482 ( V_157 , V_11 ) ;
else
V_481 = F_14 ( V_11 , F_241 () ,
V_483 , 0 , V_169 , 0 ,
NULL , 0 , V_201 ) ;
if ( V_481 == 0 ) {
F_137 ( V_11 , V_169 ) ;
...
if ( ( V_11 -> V_15 -> V_16 -> V_18 & F_243 ( V_485 ) ) ||
V_369 == V_372 ) {
V_11 -> V_486 = 1 ;
F_209 ( V_11 , 1 ) ;
}
...
{
struct V_191 * V_157 = F_60 ( V_11 -> V_171 ) ;
if ( ! V_157 -> V_158 -> V_487 )
return 0 ;
if ( V_11 -> V_88 == V_431 )
return 0 ;
if ( V_11 -> V_88 != V_409 )
return - V_67 ;
return V_157 -> V_158 -> V_487 ( V_157 , V_11 ) ;
}
static int
...
int V_54 , V_489 , V_481 ;
unsigned V_193 = V_397 ;
enum V_490 V_491 = V_11 -> V_12 ;
const char * V_12 ;
...
V_481 = F_193 ( V_2 , V_70 , V_11 , V_193 , false ) ;
if ( V_481 < 0 )
goto V_244;
V_481 = - V_114 ;
if ( V_491 != V_493 && V_491 != V_11 -> V_12 ) {
...
case V_50 :
case V_400 :
V_11 -> V_343 . V_281 . V_494 = F_228 ( 512 ) ;
break;
case V_13 :
V_11 -> V_343 . V_281 . V_494 = F_228 ( 64 ) ;
break;
case V_14 :
V_11 -> V_343 . V_281 . V_494 = F_228 ( 64 ) ;
break;
case V_401 :
V_11 -> V_343 . V_281 . V_494 = F_228 ( 8 ) ;
break;
default:
goto V_244;
}
...
V_169 , V_11 -> V_171 -> V_495 -> V_158 -> V_496 ) ;
if ( V_4 -> V_143 ) {
...
for ( V_54 = 0 ; V_54 < V_497 ; ( ++ V_54 , F_66 ( 100 ) ) ) {
bool V_498 = false ;
if ( F_189 ( V_11 , V_488 ) ) {
struct V_499 * V_500 ;
int V_501 = 0 ;
...
#define F_247 64
V_500 = F_56 ( F_247 , V_207 ) ;
if ( ! V_500 ) {
V_481 = - V_166 ;
continue;
}
for ( V_489 = 0 ; V_489 < 3 ; ++ V_489 ) {
V_500 -> V_502 = 0 ;
V_501 = F_14 ( V_11 , F_248 () ,
V_62 , V_63 ,
V_503 << 8 , 0 ,
V_500 , F_247 ,
V_504 ) ;
...
if ( V_11 -> V_335 == 0 ) {
for ( V_489 = 0 ; V_489 < V_508 ; ++ V_489 ) {
V_481 = F_240 ( V_11 , V_169 ) ;
if ( V_481 >= 0 )
break;
F_66 ( 200 ) ;
}
...
if ( V_11 -> V_34 . V_502 == 0xff ||
V_11 -> V_12 == V_50 )
V_54 = 512 ;
else
V_54 = V_11 -> V_34 . V_502 ;
...
V_11 -> V_343 . V_281 . V_494 = F_228 ( V_54 ) ;
F_237 ( V_11 ) ;
}
V_481 = F_185 ( V_11 , V_511 ) ;
if ( V_481 < ( signed ) sizeof( V_11 -> V_34 ) ) {
if ( V_481 != - V_114 )
...
if ( V_11 -> V_335 == 0 && F_12 ( V_11 -> V_34 . V_509 ) >= 0x0201 ) {
V_481 = F_250 ( V_11 ) ;
if ( ! V_481 ) {
V_11 -> V_24 = F_5 ( V_11 ) ;
F_11 ( V_11 ) ;
...
V_481 = 0 ;
if ( V_157 -> V_158 -> V_513 )
V_157 -> V_158 -> V_513 ( V_157 , V_11 ) ;
F_242 ( V_11 ) ;
V_244:
if ( V_481 ) {
F_72 ( V_2 , V_70 , 0 ) ;
...
if ( V_11 -> V_330 & V_516 )
return;
V_515 = F_56 ( sizeof *V_515 , V_243 ) ;
if ( V_515 == NULL )
return;
V_81 = F_252 ( V_11 , V_517 , 0 ,
V_515 , sizeof *V_515 ) ;
if ( V_81 == sizeof *V_515 ) {
F_7 ( & V_11 -> V_20 , L_164
L_165 ) ;
if ( V_2 -> V_225 ) {
...
static int V_519 = - 1 ;
if ( V_11 ) {
if ( V_157 -> V_520 && ! V_4 -> V_23 )
F_256 ( V_157 -> V_520 , V_11 -> V_12 ) ;
F_84 ( & V_79 -> V_185 ) ;
}
if ( ! ( V_3 & V_208 ) ||
( V_178 & V_210 ) )
...
if ( F_12 ( V_11 -> V_34 . V_509 ) >= 0x0200
&& V_11 -> V_12 == V_14
&& V_290 != 0 )
F_251 ( V_2 , V_11 , V_70 ) ;
V_81 = 0 ;
...
V_406:
F_72 ( V_2 , V_70 , 1 ) ;
if ( V_157 -> V_158 -> V_530 && ! V_2 -> V_4 -> V_23 )
V_157 -> V_158 -> V_530 ( V_157 , V_70 ) ;
}
...
int V_549 ;
char * V_500 ;
if ( memcmp ( & V_11 -> V_34 , V_542 ,
sizeof( * V_542 ) ) != 0 )
return 1 ;
if ( ( V_544 && ! V_11 -> V_15 ) || ( ! V_544 && V_11 -> V_15 ) )
return 1 ;
if ( V_11 -> V_15 ) {
V_547 = F_12 ( V_11 -> V_15 -> V_281 -> V_357 ) ;
if ( V_547 != F_12 ( V_544 -> V_281 -> V_357 ) )
return 1 ;
if ( memcmp ( V_11 -> V_15 -> V_281 , V_544 -> V_281 , V_547 ) )
return 1 ;
}
if ( V_11 -> V_351 )
V_546 = strlen ( V_11 -> V_351 ) + 1 ;
V_547 = V_546 ;
for ( V_545 = 0 ; V_545 < V_11 -> V_34 . V_550 ; V_545 ++ ) {
V_548 = F_12 ( V_11 -> V_354 [ V_545 ] . V_281 . V_357 ) ;
V_547 = F_276 ( V_547 , V_548 ) ;
}
V_500 = F_56 ( V_547 , V_207 ) ;
if ( V_500 == NULL ) {
...
for ( V_545 = 0 ; V_545 < V_11 -> V_34 . V_550 ; V_545 ++ ) {
V_548 = F_12 ( V_11 -> V_354 [ V_545 ] . V_281 . V_357 ) ;
V_549 = F_252 ( V_11 , V_551 , V_545 , V_500 ,
V_548 ) ;
if ( V_549 != V_548 ) {
...
if ( memcmp ( V_500 , V_11 -> V_356 [ V_545 ] , V_548 )
!= 0 ) {
...
if ( ! V_86 && V_546 ) {
V_549 = F_277 ( V_11 , V_11 -> V_34 . V_348 ,
V_500 , V_546 ) ;
if ( V_549 + 1 != V_546 ) {
F_22 ( & V_11 -> V_20 , L_189 ,
V_549 ) ;
V_86 = 1 ;
} else if ( memcmp ( V_500 , V_11 -> V_351 , V_549 ) != 0 ) {
...
{
struct V_7 * V_554 = V_11 -> V_23 ;
struct V_1 * V_555 ;
struct V_191 * V_157 = F_60 ( V_11 -> V_171 ) ;
struct V_499 V_34 = V_11 -> V_34 ;
struct V_543 * V_15 ;
int V_54 , V_489 , V_55 = 0 ;
int V_70 = V_11 -> V_127 ;
if ( V_11 -> V_88 == V_186 ||
V_11 -> V_88 == V_324 ) {
...
for ( V_54 = 0 ; V_54 < V_521 ; ++ V_54 ) {
F_237 ( V_11 ) ;
V_55 = F_245 ( V_555 , V_11 , V_70 , V_54 ) ;
...
V_55 = F_14 ( V_11 , F_17 ( V_11 , 0 ) ,
V_558 , 0 ,
V_11 -> V_8 -> V_281 . V_553 , 0 ,
NULL , 0 , V_201 ) ;
if ( V_55 < 0 ) {
F_30 ( & V_11 -> V_20 ,
L_197 ,
V_11 -> V_8 -> V_281 . V_553 , V_55 ) ;
F_31 ( V_157 -> V_476 ) ;
goto V_557;
}
F_31 ( V_157 -> V_476 ) ;
F_73 ( V_11 , V_89 ) ;
for ( V_54 = 0 ; V_54 < V_11 -> V_8 -> V_281 . V_559 ; V_54 ++ ) {
struct V_560 * V_354 = V_11 -> V_8 ;
...
for ( V_489 = 0 ; V_489 < V_121 -> V_294 -> V_281 . V_303 ; V_489 ++ )
V_121 -> V_294 -> V_233 [ V_489 ] . V_565 = 0 ;
}
V_406:
F_209 ( V_11 , 1 ) ;
F_211 ( V_11 ) ;
...
F_184 ( V_11 ) ;
if ( V_354 ) {
for ( V_54 = 0 ; V_54 < V_354 -> V_281 . V_559 ; ++ V_54 ) {
struct V_120 * V_567 = V_354 -> V_10 [ V_54 ] ;
struct V_568 * V_156 ;
int V_569 = 0 ;
if ( V_567 -> V_20 . V_158 ) {
V_156 = F_283 ( V_567 -> V_20 . V_158 ) ;
if ( V_156 -> V_570 && V_156 -> V_571 )
V_569 = ( V_156 -> V_570 ) ( V_567 ) ;
else if ( V_567 -> V_572 ==
V_573 )
V_569 = 1 ;
if ( V_569 )
...
F_198 ( V_79 ) ;
if ( V_354 ) {
for ( V_54 = V_354 -> V_281 . V_559 - 1 ; V_54 >= 0 ; -- V_54 ) {
struct V_120 * V_567 = V_354 -> V_10 [ V_54 ] ;
struct V_568 * V_156 ;
int V_574 = V_567 -> V_575 ;
if ( ! V_574 && V_567 -> V_20 . V_158 ) {
V_156 = F_283 ( V_567 -> V_20 . V_158 ) ;
if ( V_156 -> V_571 )
V_574 = ( V_156 -> V_571 ) ( V_567 ) ;
else if ( V_567 -> V_572 ==
V_573 )
V_574 = 1 ;
if ( V_574 )
...
if ( V_369 == V_372 ) {
T_2 V_579 = 1 << ( V_54 % 8 ) ;
if ( ! ( V_281 -> V_35 . V_249 . V_250 [ V_54 / 8 ] & V_579 ) ) {
F_22 ( & V_79 -> V_20 , L_201 ) ;
V_281 -> V_35 . V_249 . V_250 [ V_54 / 8 ] |= V_579 ;
}
}
}
} else {
T_1 V_580 = F_12 ( V_281 -> V_35 . V_36 . V_250 ) ;
for ( V_54 = 1 ; V_54 <= V_4 -> V_9 ; V_54 ++ ) {
struct V_78 * V_79 = V_2 -> V_80 [ V_54 - 1 ] ;
V_369 = V_79 -> V_369 ;
if ( V_369 == V_372 ) {
...
V_281 -> V_35 . V_36 . V_250 = F_228 ( V_580 ) ;
}
}
