...
static int F_91 ( struct V_10 * V_10 , struct V_1 * V_100 )
{
...
int F_96 ( struct V_10 * V_10 , struct V_1 * V_2 )
{
int error ;
F_97 () ;
for (; ; ) {
...
int F_145 ( struct V_10 * V_10 , struct V_1 * V_2 )
{
int error ;
F_97 () ;
for (; ; ) {
