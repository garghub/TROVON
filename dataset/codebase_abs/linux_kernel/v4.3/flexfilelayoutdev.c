...
static bool F_37 ( struct V_64 * V_65 , T_4 V_66 ,
T_4 V_67 , int V_68 , enum V_69 V_70 ,
T_5 * V_71 ,
struct V_72 * V_4 )
{
return V_65 -> V_68 == V_68 && V_65 -> V_70 == V_70 &&
F_38 ( & V_65 -> V_71 , V_71 ) &&
! memcmp ( & V_65 -> V_4 , V_4 , sizeof( * V_4 ) ) &&
F_33 ( V_65 -> V_66 , V_65 -> V_67 ) >= V_66 &&
V_65 -> V_66 <= F_33 ( V_66 , V_67 ) ;
}
static bool F_39 ( struct V_64 * V_73 ,
struct V_64 * V_74 )
{
if ( ! F_37 ( V_73 , V_74 -> V_66 , V_74 -> V_67 , V_74 -> V_68 ,
V_74 -> V_70 , & V_74 -> V_71 , & V_74 -> V_4 ) )
return false ;
F_34 ( V_73 , V_74 -> V_66 , V_74 -> V_67 ) ;
return true ;
}
static bool
...
{
struct V_64 * V_65 ;
F_41 (err, &flo->error_list, list) {
if ( F_39 ( V_65 , V_77 ) ) {
return true ;
}
}
F_42 ( & V_77 -> V_78 , & V_76 -> V_79 ) ;
return false ;
}
static bool
F_43 ( struct V_75 * V_76 , T_4 V_66 ,
T_4 V_67 , int V_68 , enum V_69 V_70 ,
T_5 * V_71 , struct V_72 * V_4 )
{
bool V_80 = false ;
struct V_64 * V_65 ;
F_41 (err, &flo->error_list, list) {
if ( F_37 ( V_65 , V_66 , V_67 , V_68 , V_70 ,
V_71 , V_4 ) ) {
V_80 = true ;
F_34 ( V_65 , V_66 , V_67 ) ;
break;
...
if ( V_59 -> V_2 == NULL )
return - V_82 ;
F_45 ( & V_76 -> V_83 . V_57 -> V_84 ) ;
if ( F_43 ( V_76 , V_66 , V_67 , V_68 , V_70 ,
& V_59 -> V_71 ,
& V_59 -> V_2 -> V_3 . V_4 ) ) {
F_46 ( & V_76 -> V_83 . V_57 -> V_84 ) ;
return 0 ;
}
F_46 ( & V_76 -> V_83 . V_57 -> V_84 ) ;
V_77 = F_47 ( sizeof( * V_77 ) , V_11 ) ;
if ( ! V_77 )
return - V_30 ;
F_11 ( & V_77 -> V_78 ) ;
V_77 -> V_66 = V_66 ;
...
V_77 -> V_68 = V_68 ;
V_77 -> V_70 = V_70 ;
F_48 ( & V_77 -> V_71 , & V_59 -> V_71 ) ;
memcpy ( & V_77 -> V_4 , & V_59 -> V_2 -> V_3 . V_4 ,
V_85 ) ;
F_45 ( & V_76 -> V_83 . V_57 -> V_84 ) ;
V_81 = F_40 ( V_76 , V_77 ) ;
F_46 ( & V_76 -> V_83 . V_57 -> V_84 ) ;
...
struct V_96 * V_91 ;
struct V_97 V_98 = {
. V_86 = F_51 ( & V_99 , V_59 -> V_86 ) ,
. V_100 = F_52 ( & V_99 , V_59 -> V_100 ) ,
} ;
...
struct V_103 *
F_57 ( struct V_52 * V_53 , T_2 V_104 )
{
struct V_58 * V_59 = F_58 ( V_53 , V_104 ) ;
...
struct V_89 *
F_60 ( struct V_52 * V_53 , T_2 V_108 ,
bool V_109 )
{
struct V_58 * V_59 = F_58 ( V_53 , V_108 ) ;
struct V_89 * V_5 = NULL ;
struct V_54 * V_55 ;
struct V_110 * V_111 = V_53 -> V_56 -> V_57 ;
struct V_7 * V_112 = F_61 ( V_111 ) ;
unsigned int V_113 ;
T_6 V_114 ;
if ( ! F_32 ( V_53 , V_59 ) ) {
F_59 ( L_9 ,
...
struct V_96 *
F_70 ( struct V_52 * V_53 , T_2 V_108 ,
struct V_96 * V_124 )
{
struct V_58 * V_59 = F_58 ( V_53 , V_108 ) ;
struct V_96 * V_91 = F_71 ( - V_82 ) ;
if ( ! F_60 ( V_53 , V_108 , true ) )
goto V_106;
if ( V_59 && V_59 -> V_91 )
V_91 = V_59 -> V_91 ;
else
...
struct V_125 *
F_72 ( struct V_52 * V_53 , T_2 V_108 ,
...
return V_90 -> V_94 ;
case 4 :
return F_73 ( V_90 , V_110 ) ;
default:
F_74 () ;
}
}
static bool F_75 ( T_4 V_126 , T_4 V_127 ,
T_4 V_128 , T_4 V_129 )
{
...
int F_76 ( struct V_75 * V_76 ,
struct V_12 * V_132 , int * V_133 ,
const struct V_134 * V_135 )
{
struct V_64 * V_65 , * V_136 ;
T_3 * V_27 ;
F_77 (err, n, &flo->error_list, list) {
if ( ! F_75 ( V_65 -> V_66 , V_65 -> V_67 ,
...
if ( F_16 ( ! V_27 ) )
return - V_138 ;
V_27 = F_79 ( V_27 , V_65 -> V_66 ) ;
V_27 = F_79 ( V_27 , V_65 -> V_67 ) ;
V_27 = F_80 ( V_27 , & V_65 -> V_71 ,
V_137 ) ;
* V_27 ++ = F_81 ( 1 ) ;
V_27 = F_80 ( V_27 , & V_65 -> V_4 ,
V_85 ) ;
* V_27 ++ = F_81 ( V_65 -> V_68 ) ;
* V_27 ++ = F_81 ( V_65 -> V_70 ) ;
* V_133 += 1 ;
F_82 ( & V_65 -> V_78 ) ;
F_18 ( L_10 ,
V_38 , V_65 -> V_66 , V_65 -> V_67 , V_65 -> V_68 ,
V_65 -> V_70 , * V_133 ) ;
F_26 ( V_65 ) ;
}
return 0 ;
}
static bool F_83 ( struct V_52 * V_53 )
{
struct V_58 * V_59 ;
struct V_54 * V_55 ;
T_2 V_139 ;
for ( V_139 = 0 ; V_139 < F_84 ( V_53 ) ; V_139 ++ ) {
V_59 = F_58 ( V_53 , V_139 ) ;
if ( V_59 && V_59 -> V_2 ) {
V_55 = & V_59 -> V_2 -> V_3 ;
if ( ! F_62 ( V_55 ) )
return true ;
