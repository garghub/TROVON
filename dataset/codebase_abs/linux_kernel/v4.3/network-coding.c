...
{
struct V_42 * V_43 ;
V_43 = F_26 ( V_41 , struct V_42 , V_41 ) ;
F_27 ( V_43 -> V_35 ) ;
F_28 ( V_43 ) ;
}
...
if ( F_41 && ! F_41 ( V_5 , V_46 ) )
continue;
if ( ! F_54 ( F_55 ( & V_46 -> V_72 ) ) ) {
F_56 ( V_73 ,
V_74
L_2 ,
V_46 -> V_75 ,
...
static void F_58 ( struct V_45 * V_78 , const char * V_79 ,
const char * V_80 )
{
memcpy ( V_78 -> V_75 , V_79 , sizeof( V_78 -> V_75 ) ) ;
memcpy ( V_78 -> V_76 , V_80 , sizeof( V_78 -> V_76 ) ) ;
}
static T_5 F_59 ( const void * V_81 , T_5 V_67 )
{
const struct V_45 * V_46 = V_81 ;
T_5 V_62 = 0 ;
V_62 = F_60 ( & V_46 -> V_75 , sizeof( V_46 -> V_75 ) , V_62 ) ;
V_62 = F_60 ( & V_46 -> V_76 , sizeof( V_46 -> V_76 ) , V_62 ) ;
return V_62 % V_67 ;
}
static int F_61 ( const struct V_69 * V_82 ,
const void * V_83 )
{
const struct V_45 * V_84 , * V_85 ;
V_84 = F_26 ( V_82 , struct V_45 , V_77 ) ;
V_85 = V_83 ;
...
if ( ! V_62 )
return NULL ;
V_87 = F_59 ( V_81 , V_62 -> V_67 ) ;
V_65 = & V_62 -> V_68 [ V_87 ] ;
F_49 () ;
F_50 (nc_path, head, hash_entry) {
if ( ! F_61 ( & V_46 -> V_77 , V_81 ) )
continue;
if ( ! F_63 ( & V_46 -> V_44 ) )
continue;
V_86 = V_46 ;
...
F_72 ( struct V_4 * V_5 ,
struct V_61 * V_62 ,
bool (* F_73)( struct V_4 * ,
struct V_45 * ,
struct V_47 * ) )
{
struct V_64 * V_65 ;
struct V_47 * V_48 , * V_99 ;
struct V_45 * V_46 ;
bool V_1 ;
int V_66 ;
if ( ! V_62 )
...
struct V_4 * V_5 ;
unsigned long V_90 ;
V_101 = F_26 ( V_8 , struct V_101 , V_8 ) ;
...
F_72 ( V_5 , V_5 -> V_7 . V_25 ,
F_69 ) ;
V_5 -> V_7 . V_22 = V_23 ;
}
if ( F_37 ( V_5 -> V_7 . V_24 ,
V_5 -> V_7 . V_34 ) ) {
F_72 ( V_5 , V_5 -> V_7 . V_26 ,
F_66 ) ;
V_5 -> V_7 . V_24 = V_23 ;
}
F_3 ( V_5 ) ;
}
static bool F_74 ( struct V_4 * V_5 ,
struct V_14 * V_35 ,
struct V_104 * V_105 )
{
struct V_106 * V_107 ;
T_5 V_108 ;
T_2 V_109 ;
V_107 = F_75 ( V_35 , V_110 ) ;
if ( ! V_107 )
return false ;
V_109 = V_107 -> V_109 ;
V_108 = V_107 -> V_108 ;
F_76 ( V_107 ) ;
if ( V_108 != F_77 ( V_105 -> V_111 ) )
return false ;
if ( V_109 != V_105 -> V_112 + 1 )
return false ;
if ( ! F_78 ( V_105 -> V_15 , V_105 -> V_113 ) )
return false ;
...
V_56 = & V_115 -> V_37 ;
F_49 () ;
F_80 (nc_node, list, list) {
if ( ! F_78 ( V_43 -> V_60 , V_35 -> V_15 ) )
continue;
if ( ! F_63 ( & V_43 -> V_44 ) )
continue;
V_117 = V_43 ;
...
T_4 * V_57 ;
struct V_55 * V_56 ;
V_43 = F_79 ( V_35 , V_115 , V_116 ) ;
if ( V_43 )
return V_43 ;
V_43 = F_82 ( sizeof( * V_43 ) , V_118 ) ;
if ( ! V_43 )
return NULL ;
if ( ! F_63 ( & V_115 -> V_44 ) )
goto free;
F_23 ( & V_43 -> V_56 ) ;
F_83 ( V_43 -> V_60 , V_35 -> V_15 ) ;
V_43 -> V_35 = V_115 ;
F_21 ( & V_43 -> V_44 , 2 ) ;
if ( V_116 ) {
V_57 = & V_115 -> V_38 ;
...
if ( ! F_7 ( & V_5 -> V_10 ) )
goto V_94;
if ( ! F_86 ( V_20 , & V_35 -> V_21 ) )
goto V_94;
if ( ! F_74 ( V_5 , V_35 , V_105 ) &&
! V_119 )
goto V_94;
V_120 = F_81 ( V_5 , V_35 ,
V_115 , true ) ;
...
static struct V_45 * F_87 ( struct V_4 * V_5 ,
struct V_61 * V_62 ,
T_2 * V_79 ,
T_2 * V_80 )
{
...
F_58 ( & V_123 , V_79 , V_80 ) ;
V_46 = F_62 ( V_62 , ( void * ) & V_123 ) ;
if ( V_46 ) {
V_46 -> V_54 = V_23 ;
return V_46 ;
}
V_46 = F_82 ( sizeof( * V_46 ) , V_118 ) ;
if ( ! V_46 )
return NULL ;
F_23 ( & V_46 -> V_72 ) ;
F_24 ( & V_46 -> V_92 ) ;
...
static T_2 F_89 ( T_2 V_114 )
{
T_2 V_124 , V_125 ;
F_90 ( & V_124 , sizeof( V_124 ) ) ;
V_125 = V_124 * ( V_126 - V_114 ) ;
V_125 /= V_126 ;
return V_126 - V_125 ;
}
static void F_91 ( char * V_80 , const char * V_79 , unsigned int V_97 )
{
unsigned int V_66 ;
...
F_83 ( V_139 -> V_146 , V_146 ) ;
F_83 ( V_139 -> V_164 , V_136 -> V_165 ) ;
V_139 -> V_166 = V_150 ;
V_139 -> V_167 = V_136 -> V_168 ;
F_83 ( V_139 -> V_149 , V_149 ) ;
F_83 ( V_139 -> V_148 , V_148 ) ;
F_83 ( V_139 -> V_169 , V_137 -> V_165 ) ;
V_139 -> V_170 = V_151 ;
V_139 -> V_171 = V_137 -> V_112 ;
V_139 -> V_172 = V_137 -> V_168 ;
V_139 -> V_173 = F_99 ( V_153 ) ;
F_91 ( V_133 -> V_81 + V_155 ,
V_134 -> V_81 + V_154 , V_153 ) ;
if ( F_100 ( V_134 ) -> V_174 &&
F_100 ( V_133 ) -> V_174 ) {
V_152 = V_134 -> V_97 + V_98 ;
V_152 += V_133 -> V_97 + V_98 ;
F_71 ( V_5 , V_175 , 2 ) ;
F_71 ( V_5 , V_176 , V_152 ) ;
} else if ( ! F_100 ( V_134 ) -> V_174 &&
! F_100 ( V_133 ) -> V_174 ) {
V_152 = V_134 -> V_97 + V_98 ;
V_152 += V_133 -> V_97 + V_98 ;
F_71 ( V_5 , V_177 , 2 ) ;
F_71 ( V_5 , V_178 , V_152 ) ;
} else if ( F_100 ( V_134 ) -> V_174 &&
! F_100 ( V_133 ) -> V_174 ) {
F_70 ( V_5 , V_175 ) ;
F_71 ( V_5 , V_176 ,
...
static bool F_103 ( struct V_127 * V_49 , T_2 * V_80 , T_2 * V_79 )
{
if ( F_100 ( V_49 ) -> V_174 && ! F_78 ( V_80 , V_79 ) )
return false ;
return true ;
}
static struct V_47 *
...
if ( ! V_62 )
return NULL ;
F_58 ( & V_123 , V_120 -> V_60 ,
V_121 -> V_60 ) ;
V_181 = F_59 ( & V_123 , V_62 -> V_67 ) ;
F_49 () ;
F_50 (nc_path, &hash->table[idx], hash_entry) {
if ( ! F_78 ( V_46 -> V_75 , V_120 -> V_60 ) )
continue;
if ( ! F_78 ( V_46 -> V_76 , V_121 -> V_60 ) )
continue;
F_42 ( & V_46 -> V_92 ) ;
if ( F_55 ( & V_46 -> V_72 ) ) {
F_46 ( & V_46 -> V_92 ) ;
...
{
struct V_128 * V_128 ;
V_49 = F_108 ( V_49 , V_118 ) ;
if ( ! V_49 )
return;
V_128 = F_109 ( V_49 ) ;
F_83 ( V_128 -> V_159 , V_128 -> V_184 ) ;
F_83 ( V_128 -> V_184 , V_183 ) ;
F_97 ( V_49 , V_98 ) ;
F_110 ( V_5 , V_49 ) ;
F_35 ( V_49 ) ;
}
static bool F_111 ( struct V_127 * V_49 ,
struct V_129 * V_88 ,
struct V_128 * V_128 )
{
...
struct V_47 * V_48 = NULL ;
F_49 () ;
F_80 (nc_node, &orig_node->in_coding_list, list) {
V_48 = F_105 ( V_5 , V_49 ,
V_88 -> V_60 ,
V_128 -> V_159 , V_43 ) ;
if ( V_48 )
...
F_107 ( V_5 , V_48 -> V_49 ,
V_48 -> V_88 -> V_60 ) ;
if ( F_92 ( V_5 , V_49 , V_128 , V_48 ,
V_88 ) )
return true ;
F_64 ( V_48 ) ;
return false ;
}
static bool F_112 ( struct V_127 * V_49 ,
struct V_45 * V_46 ,
struct V_129 * V_88 ,
T_6 V_160 )
{
struct V_47 * V_48 ;
V_48 = F_82 ( sizeof( * V_48 ) , V_118 ) ;
if ( ! V_48 )
return false ;
V_48 -> V_93 = V_23 ;
V_48 -> V_160 = V_160 ;
...
V_48 -> V_46 = V_46 ;
F_42 ( & V_46 -> V_92 ) ;
F_113 ( & V_48 -> V_56 , & V_46 -> V_72 ) ;
F_46 ( & V_46 -> V_92 ) ;
return true ;
}
bool F_114 ( struct V_127 * V_49 ,
struct V_129 * V_88 )
{
...
if ( ! V_46 )
goto V_94;
V_160 = F_95 ( V_49 , V_188 + sizeof( * V_187 ) ) ;
if ( ! F_112 ( V_49 , V_46 , V_88 , V_160 ) )
goto V_190;
return true ;
V_190:
F_32 ( V_46 ) ;
...
if ( ! V_46 )
goto V_94;
V_49 = F_116 ( V_49 , V_118 ) ;
if ( F_54 ( ! V_49 ) )
goto V_190;
if ( F_54 ( ! F_117 ( V_49 , V_98 ) ) )
goto V_191;
if ( F_54 ( ! F_118 ( V_49 , V_98 ) ) )
goto V_191;
V_160 = F_95 ( V_49 , V_188 + sizeof( * V_187 ) ) ;
if ( ! F_112 ( V_49 , V_46 , NULL , V_160 ) )
goto V_191;
F_70 ( V_5 , V_192 ) ;
return;
V_191:
...
{
struct V_128 * V_128 = F_109 ( V_49 ) ;
if ( F_120 ( V_5 , V_128 -> V_184 ) )
return;
F_97 ( V_49 , V_98 ) ;
F_110 ( V_5 , V_49 ) ;
}
static struct V_135 *
F_121 ( struct V_4 * V_5 , struct V_127 * V_49 ,
struct V_47 * V_48 )
{
...
memcpy ( & V_197 , F_122 ( V_49 ) , sizeof( V_197 ) ) ;
if ( F_123 ( V_49 , 0 ) < 0 )
return NULL ;
if ( F_54 ( ! F_118 ( V_49 , V_194 ) ) )
return NULL ;
F_124 ( V_49 , - V_98 ) ;
F_125 ( V_49 ) ;
V_128 = F_109 ( V_49 ) ;
* V_128 = V_197 ;
if ( F_120 ( V_5 , V_196 . V_149 ) ) {
F_83 ( V_128 -> V_184 , V_196 . V_149 ) ;
V_49 -> V_199 = V_200 ;
V_198 = V_196 . V_169 ;
V_112 = V_196 . V_171 ;
V_168 = V_196 . V_172 ;
...
V_153 = F_126 ( V_196 . V_173 ) ;
if ( V_153 > V_49 -> V_97 )
return NULL ;
F_91 ( V_49 -> V_81 + V_193 ,
V_48 -> V_49 -> V_81 + V_193 ,
V_153 ) ;
if ( V_48 -> V_49 -> V_97 > V_153 + V_193 ) {
V_27 = F_127 ( V_49 , V_153 + V_193 ) ;
if ( V_27 )
return NULL ;
}
...
F_58 ( & V_123 , V_203 , V_165 ) ;
V_87 = F_59 ( & V_123 , V_62 -> V_67 ) ;
F_49 () ;
...
if ( ! F_7 ( & V_5 -> V_10 ) )
return V_207 ;
if ( F_54 ( ! F_117 ( V_49 , V_206 ) ) )
return V_207 ;
V_139 = (struct V_138 * ) V_49 -> V_81 ;
V_128 = F_109 ( V_49 ) ;
if ( ! F_120 ( V_5 , V_128 -> V_184 ) &&
! F_120 ( V_5 , V_139 -> V_149 ) )
return V_207 ;
if ( F_120 ( V_5 , V_139 -> V_149 ) )
F_70 ( V_5 , V_208 ) ;
V_48 = F_128 ( V_5 , V_128 ,
V_139 ) ;
if ( ! V_48 ) {
F_70 ( V_5 , V_209 ) ;
return V_207 ;
...
if ( F_96 ( V_48 -> V_49 ) < 0 )
goto V_210;
V_195 = F_121 ( V_5 , V_49 , V_48 ) ;
if ( ! V_195 ) {
F_70 ( V_5 , V_209 ) ;
goto V_210;
}
F_100 ( V_49 ) -> V_174 = true ;
F_70 ( V_5 , V_211 ) ;
F_71 ( V_5 , V_212 ,
V_49 -> V_97 + V_98 ) ;
return F_130 ( V_49 , V_205 ) ;
V_210:
F_34 ( V_48 ) ;
return V_207 ;
}
...
int F_135 ( struct V_213 * V_214 , void * V_215 )
{
...
V_219 = F_141 ( L_13 , V_5 -> V_221 ) ;
if ( ! V_219 )
goto V_94;
V_220 = F_142 ( L_14 , V_222 | V_223 , V_219 ,
& V_5 -> V_7 . V_32 ) ;
if ( ! V_220 )
goto V_94;
V_220 = F_143 ( L_15 , V_222 | V_223 , V_219 ,
& V_5 -> V_7 . V_33 ) ;
if ( ! V_220 )
goto V_94;
V_220 = F_143 ( L_16 , V_222 | V_223 , V_219 ,
& V_5 -> V_7 . V_34 ) ;
if ( ! V_220 )
goto V_94;
return 0 ;
