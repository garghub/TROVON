...
static int F_74 ( struct V_2 * V_12 , struct V_13 * V_14 )
{
F_75 ( V_69 , V_74 ) ;
int V_18 = 0 ;
int V_72 = V_179 ;
...
static int F_81 ( struct V_1 * V_2 , int V_186 )
{
struct V_2 * V_12 = V_2 -> V_12 ;
struct V_13 * V_14 ;
struct V_150 * V_118 ;
...
F_85 ( V_14 , 0 ) ;
F_12 ( V_12 ) ;
if ( F_69 ( V_12 , V_190 ) && V_12 -> V_191 &&
! ( V_74 -> V_42 & V_192 ) )
V_18 = F_22 ( V_12 , V_193 ,
V_12 -> V_191 ) ;
}
if ( ! V_18 && V_12 -> V_194 )
V_18 = - V_12 -> V_194 ;
...
static void F_90 ( struct V_2 * V_196 )
{
struct V_2 * V_12 ;
F_7 ( L_10 , V_196 ,
F_70 ( V_196 -> V_25 ) ) ;
while ( ( V_12 = F_32 ( V_196 , NULL ) ) ) {
struct V_13 * V_14 = F_6 ( V_12 ) -> V_14 ;
F_7 ( L_11 , V_14 ,
F_70 ( V_14 -> V_47 ) ) ;
F_57 ( V_14 ) ;
...
static struct V_13 * F_92 ( struct V_13 * V_14 )
{
struct V_2 * V_12 , * V_196 = V_14 -> V_198 ;
F_12 ( V_196 ) ;
if ( F_93 ( V_196 ) ) {
F_7 ( L_12 , V_196 -> V_64 ) ;
F_18 ( V_196 ) ;
...
V_12 = F_94 ( F_95 ( V_196 ) , NULL , V_199 ,
V_200 , 0 ) ;
if ( ! V_12 ) {
F_18 ( V_196 ) ;
return NULL ;
...
static int F_99 ( struct V_13 * V_14 , struct V_201 * V_202 )
{
struct V_2 * V_12 = V_14 -> V_198 ;
int V_18 ;
F_12 ( V_12 ) ;
if ( F_6 ( V_12 ) -> V_173 ) {
V_18 = - V_203 ;
...
V_18 = F_65 ( V_12 , V_202 ) ;
if ( V_18 < 0 && V_14 -> V_45 == V_59 ) {
F_6 ( V_12 ) -> V_173 = V_202 ;
F_67 ( V_14 , 1 ) ;
V_18 = 0 ;
}
V_28:
...
static void F_101 ( struct V_13 * V_14 , int V_18 )
{
struct V_2 * V_12 = V_14 -> V_198 ;
struct V_2 * V_196 ;
F_7 ( L_8 , V_14 , F_70 ( V_14 -> V_47 ) ) ;
F_28 ( V_12 , F_66 ( & V_14 -> V_65 ) ) ;
V_196 = F_43 ( V_12 ) -> V_196 ;
F_72 ( V_12 , V_176 ) ;
switch ( V_14 -> V_47 ) {
case V_26 :
case V_48 :
...
static void F_103 ( struct V_13 * V_14 , int V_47 ,
int V_18 )
{
struct V_2 * V_12 = V_14 -> V_198 ;
V_12 -> V_25 = V_47 ;
...
static struct V_201 * F_104 ( struct V_13 * V_14 ,
unsigned long V_205 ,
unsigned long V_17 , int V_206 )
{
struct V_2 * V_12 = V_14 -> V_198 ;
struct V_201 * V_202 ;
int V_18 ;
F_59 ( V_14 ) ;
V_202 = F_105 ( V_12 , V_205 + V_17 , V_206 , & V_18 ) ;
F_57 ( V_14 ) ;
if ( ! V_202 )
return F_106 ( V_18 ) ;
V_202 -> V_207 = V_12 -> V_208 ;
F_107 ( V_202 ) -> V_209 . V_14 = V_14 ;
return V_202 ;
}
...
{
struct V_2 * V_196 , * V_12 = V_14 -> V_198 ;
F_12 ( V_12 ) ;
V_196 = F_43 ( V_12 ) -> V_196 ;
if ( V_196 )
V_196 -> V_204 ( V_196 ) ;
...
static long F_113 ( struct V_13 * V_14 )
{
struct V_2 * V_12 = V_14 -> V_198 ;
return V_12 -> V_210 ;
}
...
static void F_115 ( struct V_2 * V_12 )
{
F_7 ( L_1 , V_12 ) ;
if ( F_6 ( V_12 ) -> V_14 )
F_71 ( F_6 ( V_12 ) -> V_14 ) ;
if ( F_6 ( V_12 ) -> V_173 ) {
F_116 ( F_6 ( V_12 ) -> V_173 ) ;
F_6 ( V_12 ) -> V_173 = NULL ;
}
F_117 ( & V_12 -> V_211 ) ;
F_117 ( & V_12 -> V_212 ) ;
}
static void F_118 ( struct V_201 * V_202 , void * V_213 ,
int * V_214 )
{
F_119 ( struct V_15 * , V_16 , V_213 ) ;
memset ( V_16 , 0 , sizeof( struct V_15 ) ) ;
V_16 -> V_215 = V_20 ;
V_16 -> V_22 = F_107 ( V_202 ) -> V_209 . V_5 ;
F_17 ( & V_16 -> V_30 , & F_107 ( V_202 ) -> V_209 . V_216 ) ;
* V_214 = sizeof( struct V_15 ) ;
}
static void F_97 ( struct V_2 * V_12 , struct V_2 * V_196 )
{
struct V_13 * V_14 = F_6 ( V_12 ) -> V_14 ;
F_7 ( L_1 , V_12 ) ;
if ( V_196 ) {
struct V_13 * V_217 = F_6 ( V_196 ) -> V_14 ;
V_12 -> V_55 = V_196 -> V_55 ;
F_43 ( V_12 ) -> V_42 = F_43 ( V_196 ) -> V_42 ;
V_14 -> V_31 = V_217 -> V_31 ;
V_14 -> V_95 = V_217 -> V_95 ;
V_14 -> V_96 = V_217 -> V_96 ;
V_14 -> V_149 = V_217 -> V_149 ;
V_14 -> V_45 = V_217 -> V_45 ;
V_14 -> V_98 = V_217 -> V_98 ;
V_14 -> V_99 = V_217 -> V_99 ;
V_14 -> V_101 = V_217 -> V_101 ;
V_14 -> V_218 = V_217 -> V_218 ;
V_14 -> V_34 = V_217 -> V_34 ;
V_14 -> V_42 = V_217 -> V_42 ;
V_14 -> V_219 = V_217 -> V_219 ;
V_14 -> V_220 = V_217 -> V_220 ;
if ( V_14 -> V_31 == V_40 ) {
V_14 -> V_50 = V_217 -> V_50 ;
V_14 -> V_83 = V_217 -> V_50 ;
}
F_120 ( V_196 , V_12 ) ;
} else {
switch ( V_12 -> V_55 ) {
...
static struct V_2 * F_94 ( struct V_226 * V_226 , struct V_1 * V_2 ,
int V_227 , T_6 V_228 , int V_229 )
{
struct V_2 * V_12 ;
struct V_13 * V_14 ;
V_12 = F_122 ( V_226 , V_230 , V_228 , & V_231 , V_229 ) ;
if ( ! V_12 )
return NULL ;
F_123 ( V_2 , V_12 ) ;
F_124 ( & F_43 ( V_12 ) -> V_232 ) ;
V_12 -> V_233 = F_115 ;
V_12 -> V_210 = V_234 ;
F_125 ( V_12 , V_176 ) ;
V_12 -> V_235 = V_227 ;
...
static int F_128 ( struct V_226 * V_226 , struct V_1 * V_2 , int V_236 ,
int V_229 )
{
struct V_2 * V_12 ;
F_7 ( L_14 , V_2 ) ;
...
V_2 -> type != V_221 && V_2 -> type != V_137 )
return - V_238 ;
if ( V_2 -> type == V_137 && ! V_229 && ! F_3 ( V_239 ) )
return - V_163 ;
V_2 -> V_3 = & V_4 ;
V_12 = F_94 ( V_226 , V_2 , V_236 , V_200 , V_229 ) ;
if ( ! V_12 )
return - V_203 ;
F_97 ( V_12 , NULL ) ;
F_129 ( & V_195 , V_12 ) ;
...
{
int V_18 ;
F_131 ( sizeof( struct V_15 ) > sizeof( struct V_9 ) ) ;
V_18 = F_132 ( & V_231 , 0 ) ;
if ( V_18 < 0 )
return V_18 ;
V_18 = F_133 ( V_199 , & V_240 ) ;
if ( V_18 < 0 ) {
F_134 ( L_15 ) ;
goto error;
}
V_18 = F_135 ( & V_241 , L_16 , & V_195 ,
NULL ) ;
if ( V_18 < 0 ) {
F_134 ( L_17 ) ;
F_136 ( V_199 ) ;
