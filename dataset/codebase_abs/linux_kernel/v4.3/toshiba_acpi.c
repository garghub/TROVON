...
static bool F_118 ( unsigned char V_215 , unsigned char V_216 ,
struct V_217 * V_218 )
{
if ( V_216 & V_219 )
return false ;
...
static void F_121 ( struct V_222 * V_223 )
{
T_10 V_224 = F_122 () ;
T_2 V_6 ;
if ( ! V_224 )
return;
V_6 = F_5 ( V_224 , L_77 , NULL , NULL ) ;
if ( F_9 ( V_6 ) )
F_11 ( L_78 ) ;
}
...
if ( V_225 & 0x80 )
return;
if ( ! F_126 ( V_10 -> V_149 , V_225 , 1 , true ) )
F_12 ( L_81 , V_225 ) ;
}
static void F_127 ( struct V_9 * V_10 )
{
if ( V_10 -> V_226 ) {
int V_225 = F_123 ( V_10 ) ;
if ( V_225 < 0 ) {
F_11 ( L_82 ) ;
} else if ( V_225 != 0 ) {
F_125 ( V_10 , V_225 ) ;
...
V_10 -> V_149 -> V_239 = L_87 ;
V_10 -> V_149 -> V_240 . V_241 = V_242 ;
if ( V_234 == V_243 ||
! V_10 -> V_194 )
V_232 = V_233 ;
else if ( V_234 == V_244 ||
...
F_12 ( L_88 , V_234 ) ;
error = F_132 ( V_10 -> V_149 , V_232 , NULL ) ;
if ( error )
goto V_246;
V_224 = F_122 () ;
if ( V_224 && F_133 ( V_224 , L_77 ) ) {
F_134 ( & V_10 -> V_221 , F_121 ) ;
error = F_135 ( F_118 ) ;
if ( error ) {
F_11 ( L_89 ) ;
goto V_247;
...
if ( F_133 ( V_10 -> V_26 -> V_27 , L_79 ) )
V_10 -> V_226 = 1 ;
else {
V_235 = F_6 ( V_10 , V_229 , 1 ) ;
if ( V_235 == V_49 )
V_10 -> V_227 = 1 ;
}
if ( ! V_10 -> V_226 && ! V_10 -> V_227 ) {
F_136 ( L_90 ) ;
goto V_249;
}
error = F_137 ( V_10 -> V_149 ) ;
if ( error ) {
F_12 ( L_91 ) ;
goto V_249;
}
...
if ( V_10 -> V_96 )
V_108 . V_109 ++ ;
V_10 -> V_107 = F_146 ( L_93 ,
& V_10 -> V_26 -> V_10 ,
V_10 ,
& V_255 ,
& V_108 ) ;
if ( F_147 ( V_10 -> V_107 ) ) {
V_97 = F_148 ( V_10 -> V_107 ) ;
F_11 ( L_94 ) ;
V_10 -> V_107 = NULL ;
return V_97 ;
}
...
static int F_151 ( struct V_256 * V_26 )
{
struct V_9 * V_10 = F_152 ( V_26 ) ;
F_153 ( & V_10 -> V_257 ) ;
F_82 ( V_10 ) ;
if ( V_10 -> V_258 )
F_154 ( & V_10 -> V_26 -> V_10 . V_176 ,
& V_259 ) ;
if ( V_10 -> V_248 ) {
F_138 ( F_118 ) ;
F_155 ( & V_10 -> V_221 ) ;
...
static const char * F_159 ( T_10 V_27 )
{
if ( F_133 ( V_27 , L_113 ) )
return L_113 ;
if ( F_133 ( V_27 , L_114 ) )
...
static int F_160 ( struct V_256 * V_26 )
{
struct V_9 * V_10 ;
const char * V_260 ;
T_1 V_261 ;
...
F_12 ( L_115 ,
V_139 ) ;
V_260 = F_159 ( V_26 -> V_27 ) ;
if ( ! V_260 ) {
F_11 ( L_116 ) ;
return - V_68 ;
}
V_10 = F_161 ( sizeof( * V_10 ) , V_131 ) ;
if ( ! V_10 )
return - V_132 ;
V_10 -> V_26 = V_26 ;
V_10 -> V_28 = V_260 ;
V_10 -> V_257 . V_264 = V_265 ;
V_10 -> V_257 . V_238 = L_117 ;
V_10 -> V_257 . V_266 = & V_267 ;
V_97 = F_162 ( & V_10 -> V_257 ) ;
if ( V_97 ) {
F_11 ( L_118 ) ;
F_69 ( V_10 ) ;
return V_97 ;
...
V_26 -> V_268 = V_10 ;
F_163 ( & V_26 -> V_10 , V_10 ) ;
V_97 = F_41 ( V_10 , & V_261 ) ;
V_10 -> V_194 = ! V_97 ;
if ( F_129 ( V_10 ) )
F_12 ( L_119 ) ;
V_97 = F_48 ( V_10 , & V_262 ) ;
V_10 -> V_96 = ! V_97 ;
V_97 = F_141 ( V_10 ) ;
if ( V_97 )
goto error;
F_16 ( V_10 ) ;
if ( V_10 -> V_47 ) {
V_10 -> V_54 . V_238 = L_120 ;
V_10 -> V_54 . V_109 = 1 ;
V_10 -> V_54 . V_269 = F_17 ;
V_10 -> V_54 . V_270 = F_19 ;
if ( ! F_164 ( & V_26 -> V_10 , & V_10 -> V_54 ) )
V_10 -> V_48 = true ;
}
F_27 ( V_10 ) ;
if ( V_10 -> V_73 ) {
V_10 -> V_76 . V_238 = L_121 ;
V_10 -> V_76 . V_109 = 1 ;
V_10 -> V_76 . V_269 = F_29 ;
V_10 -> V_76 . V_270 = F_28 ;
if ( ! F_164 ( & V_10 -> V_26 -> V_10 , & V_10 -> V_76 ) )
V_10 -> V_74 = true ;
}
F_20 ( V_10 ) ;
if ( V_10 -> V_60 && V_10 -> V_64 == V_156 ) {
V_10 -> V_69 . V_238 = L_122 ;
V_10 -> V_69 . V_109 = 1 ;
V_10 -> V_69 . V_269 = F_24 ;
V_10 -> V_69 . V_270 = F_23 ;
if ( ! F_164 ( & V_10 -> V_26 -> V_10 , & V_10 -> V_69 ) )
V_10 -> V_61 = true ;
}
V_97 = F_26 ( V_10 , & V_262 ) ;
V_10 -> V_185 = ! V_97 ;
F_30 ( V_10 ) ;
F_32 ( V_10 ) ;
V_97 = F_37 ( V_10 , & V_262 ) ;
V_10 -> V_190 = ! V_97 ;
V_97 = F_39 ( V_10 , & V_262 ) ;
V_10 -> V_192 = ! V_97 ;
V_97 = F_43 ( V_10 , & V_262 ) ;
V_10 -> V_196 = ! V_97 ;
V_97 = F_45 ( V_10 , & V_262 ) ;
V_10 -> V_198 = ! V_97 ;
V_97 = F_64 ( V_10 , & V_262 ) ;
V_10 -> V_145 = ! V_97 ;
V_97 = F_70 ( V_10 , & V_262 ) ;
V_10 -> V_147 = ! V_97 ;
F_149 ( V_10 ) ;
if ( V_10 -> V_194 && V_261 )
F_117 ( V_10 ) ;
V_97 = F_165 ( & V_10 -> V_26 -> V_10 . V_176 ,
& V_259 ) ;
if ( V_97 ) {
V_10 -> V_258 = 0 ;
goto error;
...
static void F_166 ( struct V_256 * V_26 , T_1 V_271 )
{
struct V_9 * V_10 = F_152 ( V_26 ) ;
int V_97 ;
switch ( V_271 ) {
...
F_168 ( V_26 -> V_272 . V_273 ,
F_169 ( & V_26 -> V_10 ) ,
V_271 , 0 ) ;
}
static int F_170 ( struct V_152 * V_152 )
{
struct V_9 * V_10 = F_152 ( F_171 ( V_152 ) ) ;
if ( V_10 -> V_149 ) {
T_1 V_55 ;
V_55 = F_6 ( V_10 , V_212 , V_274 ) ;
if ( V_55 != V_49 )
F_12 ( L_128 ) ;
}
return 0 ;
}
static int F_172 ( struct V_152 * V_152 )
{
struct V_9 * V_10 = F_152 ( F_171 ( V_152 ) ) ;
if ( V_10 -> V_149 ) {
...
{
int V_97 ;
V_143 = F_174 ( V_275 , V_276 ) ;
if ( ! V_143 ) {
F_11 ( L_130 V_275 L_112 ) ;
return - V_68 ;
}
V_97 = F_175 ( & V_277 ) ;
if ( V_97 ) {
