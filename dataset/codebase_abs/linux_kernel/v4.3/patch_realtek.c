...
{
static const T_1 V_133 [] = { 0x1d , 0 } ;
static const T_1 V_134 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
return F_65 ( V_2 , V_133 , V_134 ) ;
}
...
V_13 = V_2 -> V_13 ;
V_13 -> V_87 . V_135 = 1 ;
V_13 -> V_87 . V_136 = 0x01 ;
V_2 -> V_107 . V_137 = F_18 ;
F_74 ( V_2 , V_138 , V_139 ,
V_140 ) ;
F_50 ( V_2 , V_59 ) ;
V_95 = F_70 ( V_2 ) ;
if ( V_95 < 0 )
...
if ( V_95 < 0 )
goto error;
if ( ! V_13 -> V_87 . V_141 && V_13 -> V_87 . V_136 )
F_75 ( V_13 , 0x0b , 0x05 , V_142 ) ;
F_50 ( V_2 , V_64 ) ;
return 0 ;
error:
...
if ( V_95 < 0 )
goto error;
if ( V_95 > 0 && ! V_13 -> V_87 . V_141 &&
V_13 -> V_87 . V_88 . V_197 [ 0 ] != 0x1d ) {
F_9 ( V_13 , V_198 ) ;
F_79 ( V_2 , V_199 ) ;
if ( ! F_105 ( V_2 , 0x1d , V_142 ) )
F_106 ( V_2 , 0x1d , V_142 ,
( 0x0c << V_200 ) |
( 0x0c << V_201 ) |
( 0x07 << V_202 ) |
( 0 << V_203 ) ) ;
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_325 * V_326 = & V_13 -> V_87 . V_327 ;
int V_68 ;
switch ( V_58 ) {
case V_59 :
F_200 ( V_2 , 0x19 , V_316 ) ;
break;
case V_64 :
V_13 -> V_105 = F_198 ;
for ( V_68 = 0 ; V_68 < V_326 -> V_328 ; V_68 ++ ) {
...
F_202 ( V_2 , 0x1b , F_25 ( V_2 , 0x1b ) & ~ V_329 ) ;
} else
F_186 ( V_2 , V_57 , V_58 ) ;
}
...
int V_68 ;
for ( V_68 = 0 ; V_68 < V_126 -> V_317 ; V_68 ++ ) {
if ( V_126 -> V_318 [ V_68 ] . type != V_331 )
continue;
V_3 = V_126 -> V_318 [ V_68 ] . V_160 ;
V_330 = F_36 ( V_2 , V_3 ) ;
if ( F_204 ( V_330 ) == V_332 )
continue;
return V_3 ;
}
return 0 ;
...
F_139 ( V_2 ) ;
if ( F_115 ( V_2 , 0x1b ) )
V_13 -> V_87 . V_333 |= ( 1ULL << 0x14 ) ;
}
static void F_212 ( struct V_1 * V_2 ,
const struct V_56 * V_57 , int V_58 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
static const struct V_245 V_334 [] = {
{ 0x01 , V_169 , 0x04 } ,
{ 0x01 , V_170 , 0x04 } ,
{ 0x01 , V_145 , 0x04 } ,
{}
} ;
static const struct V_151 V_335 [] = {
{ 0x1b , 0x21114000 } ,
{}
} ;
struct V_28 * V_29 ;
...
V_29 = F_15 ( V_2 , L_30 ) ;
if ( V_29 )
strcpy ( V_29 -> V_336 . V_99 , L_31 ) ;
V_29 = F_15 ( V_2 , L_32 ) ;
if ( V_29 )
strcpy ( V_29 -> V_336 . V_99 , L_30 ) ;
break;
}
}
...
struct V_12 * V_13 = V_2 -> V_13 ;
V_150 ( V_2 , V_27 ) ;
F_151 ( V_2 , 0x10 , ! V_13 -> V_87 . V_146 ) ;
}
...
V_2 -> V_324 = 1 ;
#ifdef F_218
V_2 -> V_107 . V_337 = F_127 ;
V_2 -> V_107 . V_338 = F_129 ;
#endif
V_13 -> V_105 = F_112 ;
F_74 ( V_2 , V_339 ,
V_340 , V_341 ) ;
F_219 ( V_2 , V_342 , V_341 ) ;
F_74 ( V_2 , NULL , V_343 ,
V_341 ) ;
F_50 ( V_2 , V_59 ) ;
F_35 ( V_2 ) ;
...
if ( F_3 ( V_2 , 0x51 , 0 , V_344 , 0 ) == 0x10ec5505 ) {
V_13 -> V_241 = 1 ;
V_13 -> V_103 = F_125 ;
}
V_95 = F_107 ( V_2 ) ;
if ( V_95 < 0 )
goto error;
if ( ! V_13 -> V_87 . V_141 && V_13 -> V_87 . V_136 && V_13 -> V_87 . V_128 )
F_75 ( V_13 , V_13 -> V_87 . V_128 , 0x04 , V_142 ) ;
F_50 ( V_2 , V_64 ) ;
return 0 ;
error:
F_61 ( V_2 ) ;
...
static const T_1 V_346 [] = { 0x0e , 0x0f , 0x0b , 0 } ;
return F_65 ( V_2 , V_345 , V_346 ) ;
}
...
return V_95 ;
V_13 = V_2 -> V_13 ;
V_13 -> V_87 . V_136 = 0x23 ;
#ifdef F_218
V_13 -> V_106 = F_54 ;
#endif
F_74 ( V_2 , NULL , V_349 , V_350 ) ;
F_50 ( V_2 , V_59 ) ;
V_95 = F_220 ( V_2 ) ;
if ( V_95 < 0 )
goto error;
if ( ! V_13 -> V_87 . V_141 )
F_75 ( V_13 , 0x23 , 0 , V_351 ) ;
F_50 ( V_2 , V_64 ) ;
return 0 ;
error:
F_61 ( V_2 ) ;
...
return F_65 ( V_2 , V_352 , V_353 ) ;
}
static void F_225 ( struct V_1 * V_2 ,
const struct V_56 * V_57 , int V_58 )
{
if ( V_58 == V_59 ) {
F_226 ( V_2 , 0x18 , 0x00000734 ) ;
F_226 ( V_2 , 0x19 , 0x0000073c ) ;
}
}
...
if ( V_58 == V_102 ) {
struct V_12 * V_13 = V_2 -> V_13 ;
V_13 -> V_87 . V_359 [ 0 ] -> V_360 [ 0 ] . V_361 = V_362 ;
}
}
static unsigned int F_232 ( struct V_1 * V_2 ,
T_1 V_3 ,
unsigned int V_262 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
...
case 0x10ec0665 :
case 0x10ec0668 :
F_75 ( V_13 , 0x0b , 0x04 , V_142 ) ;
break;
case 0x10ec0273 :
F_75 ( V_13 , 0x0b , 0x03 , V_142 ) ;
break;
}
}
F_50 ( V_2 , V_64 ) ;
