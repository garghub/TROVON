...
if ( V_32 <= 0 )
return V_32 ;
V_31 -> V_42 = F_23 ( V_11 , sizeof( struct V_35 ) *
V_32 , V_43 ) ;
if ( ! V_31 -> V_42 )
return - V_44 ;
V_31 -> V_45 = V_32 ;
...
static int F_24 ( struct V_49 * V_10 ,
const struct V_50 * V_51 )
{
struct V_27 * V_11 = & V_10 -> V_11 ;
struct V_30 V_52 , * V_31 = F_25 ( V_11 ) ;
struct V_53 V_54 = { } ;
struct V_1 * V_1 ;
int V_55 , V_33 , V_46 , V_7 = - V_40 ;
struct V_28 * V_29 [ V_56 ] ;
unsigned long type ;
if ( V_11 -> V_29 && ! V_31 ) {
const struct V_57 * V_46 ;
V_46 = F_26 ( F_27 ( V_58 ) , V_11 ) ;
if ( ! V_46 )
return - V_59 ;
V_7 = F_18 ( V_11 , V_29 , & V_52 ) ;
if ( V_7 < 0 )
return V_7 ;
V_31 = & V_52 ;
...
V_1 = F_23 ( V_11 , sizeof( struct V_1 ) , V_43 ) ;
if ( ! V_1 )
return - V_44 ;
V_1 -> V_10 = V_10 ;
if ( V_31 -> V_62 ) {
...
V_55 = V_31 -> V_42 [ V_33 ] . V_47 -> V_69 . V_55 ;
