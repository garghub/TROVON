...
V_77:
F_32 ( V_39 -> V_70 , & V_5 -> V_71 ) ;
}
struct V_22 * F_33 ( struct V_80 * V_6 ,
struct V_81 * V_82 ,
...
V_5 -> V_25 = F_42 ( V_6 -> V_7 , V_83 ) ;
if ( type == V_54 ) {
if ( F_43 ( V_82 , 1 ) -> V_96 >= V_97 &&
F_43 ( V_82 , 1 ) -> V_98 >= 1 &&
F_43 ( V_82 , 1 ) -> V_98 <= 9 )
V_5 -> V_99 = F_43 ( V_82 , 1 ) -> V_98 ;
else if ( F_18 ( V_6 -> V_7 ) == V_100 )
V_5 -> V_99 = 1 ;
else if ( F_43 ( V_82 , 1 ) -> V_101 >= 1 &&
F_43 ( V_82 , 1 ) -> V_101 <= 16 )
V_5 -> V_99 = F_43 ( V_82 , 1 ) -> V_101 - 1 ;
else
V_5 -> V_99 = 3 ;
V_5 -> V_58 = F_44 ( F_43 ( V_82 , 1 ) -> V_102 ) ;
if ( V_6 -> V_103 == F_45 ( 0x0644 , 0x8038 ) &&
V_5 -> V_58 == 4 )
V_5 -> V_104 = 1 ;
}
F_30 ( & V_5 -> V_105 , & V_6 -> V_106 ) ;
V_93:
F_46 ( & V_6 -> V_87 ) ;
return V_5 ;
}
static int F_47 ( struct V_22 * V_5 )
{
unsigned long V_107 = V_108 + F_48 ( 1000 ) ;
int V_109 ;
do {
V_109 = F_49 ( & V_5 -> V_71 , V_5 -> V_110 ) ;
if ( ! V_109 )
break;
F_50 ( 1 ) ;
} while ( F_51 ( V_108 , V_107 ) );
if ( V_109 )
F_26 ( V_5 -> V_6 ,
L_17 ,
V_109 , V_5 -> V_83 ) ;
...
void F_52 ( struct V_22 * V_5 )
{
if ( V_5 && F_21 ( V_111 , & V_5 -> V_26 ) )
F_47 ( V_5 ) ;
}
static int F_53 ( struct V_22 * V_5 , bool V_112 )
{
unsigned int V_40 ;
if ( ! V_112 && F_29 ( & V_5 -> V_6 -> V_78 ) )
return - V_113 ;
F_32 ( V_59 , & V_5 -> V_26 ) ;
F_40 ( & V_5 -> V_67 ) ;
V_5 -> V_63 = 0 ;
...
static void F_56 ( struct V_22 * V_5 , int V_112 )
{
int V_40 ;
V_5 -> V_35 = NULL ;
V_5 -> V_42 = NULL ;
...
static int F_57 ( struct V_22 * V_5 ,
T_1 V_118 ,
unsigned int V_119 ,
unsigned int V_120 ,
unsigned int V_121 ,
...
V_127 -= V_127 >> 3 ;
V_127 = F_59 ( V_127 , 1u ) ;
V_130 = F_61 ( V_120 , V_127 ) ;
V_131 = F_61 ( V_130 ,
V_129 ) ;
V_132 = F_61 ( V_130 , V_131 ) ;
V_5 -> V_144 = F_61 ( V_121 ,
V_131 ) ;
...
V_3 -> V_44 ++ ;
V_3 -> V_8 = F_62 ( V_3 -> V_44 , V_94 ) ;
if ( ! V_3 -> V_8 )
goto V_148;
V_3 -> V_8 -> V_9 =
F_63 ( V_5 -> V_6 -> V_7 , V_3 -> V_4 ,
V_94 , & V_3 -> V_8 -> V_10 ) ;
if ( ! V_3 -> V_8 -> V_9 )
goto V_148;
...
static int F_64 ( struct V_22 * V_5 )
{
int V_40 ;
V_5 -> V_115 = F_63 ( V_5 -> V_6 -> V_7 , V_116 * 4 ,
V_94 , & V_5 -> V_117 ) ;
if ( ! V_5 -> V_115 )
return - V_152 ;
...
int F_67 ( struct V_22 * V_5 , bool V_161 )
{
int V_11 ;
unsigned int V_40 ;
if ( F_29 ( & V_5 -> V_6 -> V_78 ) )
return - V_113 ;
if ( ++ V_5 -> V_155 != 1 )
return 0 ;
F_53 ( V_5 , false ) ;
...
V_165 >>= - V_5 -> V_159 ;
if ( F_76 ( V_165 >= V_5 -> V_56 - V_5 -> V_56 / 8 && V_165 <= V_5 -> V_138 ) ) {
F_10 ( & V_5 -> V_30 , V_26 ) ;
V_5 -> V_32 = V_165 ;
F_12 ( & V_5 -> V_30 , V_26 ) ;
} else {
