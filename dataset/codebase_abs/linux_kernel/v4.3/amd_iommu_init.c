...
return;
V_167 = true ;
if ( ( 0 != F_85 ( 0 , 0 , 0 , 0 , & V_10 , true ) ) ||
( 0 != F_85 ( 0 , 0 , 0 , 0 , & V_165 , false ) ) ||
( V_10 != V_165 ) ) {
F_24 ( L_30 ) ;
V_167 = false ;
return;
...
static T_7 F_86 ( struct V_170 * V_11 ,
struct V_171 * V_172 ,
char * V_173 )
{
...
static T_7 F_88 ( struct V_170 * V_11 ,
struct V_171 * V_172 ,
char * V_173 )
{
struct V_6 * V_7 = F_87 ( V_11 ) ;
...
V_7 -> V_11 = F_90 ( F_36 ( V_7 -> V_1 ) ,
V_7 -> V_1 & 0xff ) ;
if ( ! V_7 -> V_11 )
return - V_57 ;
V_7 -> V_11 -> V_179 = false ;
F_6 ( V_7 -> V_11 , V_41 + V_180 ,
& V_7 -> V_42 ) ;
F_6 ( V_7 -> V_11 , V_41 + V_43 ,
& V_175 ) ;
F_6 ( V_7 -> V_11 , V_41 + V_181 ,
& V_176 ) ;
...
if ( ! ( V_7 -> V_42 & ( 1 << V_182 ) ) )
V_183 = false ;
V_177 = F_16 ( V_7 -> V_19 + V_184 ) ;
V_178 = F_16 ( V_7 -> V_19 + V_184 + 4 ) ;
V_7 -> V_174 = ( ( T_4 ) V_178 << 32 ) | V_177 ;
if ( F_54 ( V_7 , V_85 ) ) {
int V_185 ;
T_2 V_186 ;
T_4 V_187 ;
V_187 = V_7 -> V_174 & V_188 ;
V_187 >>= V_189 ;
V_186 = ( 1 << ( V_187 + 1 ) ) - 1 ;
V_190 = F_92 ( V_190 , V_186 ) ;
F_13 ( V_190 & ~ V_191 ) ;
V_185 = V_7 -> V_174 & V_192 ;
V_185 >>= V_193 ;
if ( V_194 == - 1 )
V_194 = V_185 ;
else
V_194 = F_92 ( V_194 , V_185 ) ;
}
if ( F_54 ( V_7 , V_85 ) &&
F_54 ( V_7 , V_195 ) ) {
V_7 -> V_196 = true ;
...
if ( V_7 -> V_42 & ( 1UL << V_198 ) )
V_199 = true ;
F_84 ( V_7 ) ;
if ( F_93 ( V_7 -> V_11 ) ) {
int V_55 , V_200 ;
V_7 -> V_201 = F_90 ( V_7 -> V_11 -> V_39 -> V_202 ,
F_94 ( 0 , 0 ) ) ;
...
for ( V_200 = 0 ; V_200 < 0x12 ; V_200 ++ )
V_7 -> V_205 [ V_55 ] [ V_200 ] = F_4 ( V_7 , V_55 , V_200 ) ;
for ( V_55 = 0 ; V_55 < 0x83 ; V_55 ++ )
V_7 -> V_206 [ V_55 ] = F_8 ( V_7 , V_55 ) ;
}
F_75 ( V_7 ) ;
V_7 -> V_207 = F_95 ( & V_7 -> V_11 -> V_11 , V_7 ,
V_208 , L_34 ,
V_7 -> V_154 ) ;
return F_96 ( V_7 -> V_11 ) ;
}
...
if ( V_7 -> V_42 & ( 1 << V_210 ) ) {
F_62 ( L_46 ) ;
for ( V_55 = 0 ; V_55 < F_99 ( V_209 ) ; ++ V_55 ) {
if ( F_54 ( V_7 , ( 1ULL << V_55 ) ) )
F_100 ( L_47 , V_209 [ V_55 ] ) ;
}
F_100 ( L_48 ) ;
}
}
...
{
int V_212 ;
V_212 = F_106 ( V_7 -> V_11 ) ;
if ( V_212 )
return V_212 ;
V_212 = F_107 ( V_7 -> V_11 -> V_213 ,
V_214 ,
V_215 ,
0 , L_50 ,
V_7 ) ;
...
{
struct V_219 * V_17 , * V_147 ;
F_111 (entry, next, &amd_iommu_unity_map, list) {
F_73 ( & V_17 -> V_112 ) ;
F_74 ( V_17 ) ;
}
}
static int T_6 F_112 ( struct V_124 * V_125 )
{
int V_55 ;
switch ( V_125 -> type ) {
case V_220 :
...
break;
case V_222 :
for ( V_55 = V_125 -> V_1 ; V_55 <= V_125 -> V_223 ; ++ V_55 )
F_66 ( V_55 , V_125 ) ;
break;
default:
break;
...
static int T_6 F_113 ( struct V_124 * V_125 )
{
struct V_219 * V_134 = NULL ;
char * V_224 ;
...
case V_220 :
V_224 = L_51 ;
V_134 -> V_130 = V_134 -> V_225 = V_125 -> V_1 ;
break;
case V_221 :
V_224 = L_52 ;
V_134 -> V_130 = 0 ;
...
V_134 -> V_225 = V_125 -> V_223 ;
break;
}
V_134 -> V_226 = F_114 ( V_125 -> V_128 ) ;
V_134 -> V_227 = V_134 -> V_226 + F_114 ( V_125 -> V_129 ) ;
V_134 -> V_228 = V_125 -> V_94 >> 1 ;
F_68 ( L_54
L_55 , V_224 ,
F_36 ( V_134 -> V_130 ) , F_37 ( V_134 -> V_130 ) ,
F_38 ( V_134 -> V_130 ) , F_36 ( V_134 -> V_225 ) ,
F_37 ( V_134 -> V_225 ) , F_38 ( V_134 -> V_225 ) ,
V_134 -> V_226 , V_134 -> V_227 , V_125 -> V_94 ) ;
F_64 ( & V_134 -> V_112 , & V_229 ) ;
return 0 ;
}
static int T_6 F_115 ( struct V_53 * V_54 )
{
T_3 * V_46 = ( T_3 * ) V_54 , * V_35 = ( T_3 * ) V_54 ;
struct V_124 * V_125 ;
V_35 += V_54 -> V_48 ;
...
int V_55 , V_200 ;
T_2 V_245 ;
struct V_246 * V_247 = V_7 -> V_201 ;
if ( ! F_93 ( V_7 -> V_11 ) || ! V_247 )
return;
F_5 ( V_247 , 0x60 , 0x75 | ( 1 << 7 ) ) ;
F_6 ( V_247 , 0x64 , & V_245 ) ;
if ( ! ( V_245 & 0x1 ) )
F_5 ( V_247 , 0x64 , V_245 | 1 ) ;
...
for ( V_55 = 0 ; V_55 < 6 ; V_55 ++ )
for ( V_200 = 0 ; V_200 < 0x12 ; V_200 ++ )
F_7 ( V_7 , V_55 , V_200 , V_7 -> V_205 [ V_55 ] [ V_200 ] ) ;
for ( V_55 = 0 ; V_55 < 0x83 ; V_55 ++ )
F_9 ( V_7 , V_55 , V_7 -> V_206 [ V_55 ] ) ;
F_5 ( V_7 -> V_11 , V_7 -> V_41 + 4 ,
V_7 -> V_203 | 1 ) ;
}
...
static bool T_6 F_131 ( void )
{
const char * V_252 = V_253 ;
bool V_119 , V_254 ;
int V_255 ;
V_254 = false ;
V_119 = false ;
...
if ( ! V_264 )
return - V_57 ;
V_263 = F_136 ( L_60 , 0 , & V_261 , & V_262 ) ;
if ( V_263 == V_265 )
return - V_57 ;
else if ( F_137 ( V_263 ) ) {
const char * V_266 = F_138 ( V_263 ) ;
F_24 ( L_61 , V_266 ) ;
return - V_117 ;
}
V_119 = F_40 ( V_261 ) ;
...
static int T_6 F_147 ( enum V_288 V_289 )
{
int V_119 = 0 ;
while ( V_274 != V_289 ) {
V_119 = F_143 () ;
...
V_264 = true ;
V_292 = 1 ;
V_295 . V_7 . V_296 = F_153 ;
return 0 ;
}
static int T_6 F_155 ( char * V_297 )
{
V_298 = true ;
return 1 ;
}
static int T_6 F_156 ( char * V_297 )
{
for (; * V_297 ; ++ V_297 ) {
...
static int T_6 F_157 ( char * V_297 )
{
...
static int T_6 F_158 ( char * V_297 )
{
unsigned int V_39 , V_11 , V_40 ;
int V_119 , V_108 , V_55 ;
T_1 V_1 ;
...
int F_85 ( T_1 V_1 , T_3 V_302 , T_3 V_303 , T_3 V_304 ,
