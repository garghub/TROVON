...
int V_45 , V_30 , V_46 ;
struct V_27 * V_47 ;
V_24 = F_23 ( V_4 -> V_41 -> V_48 , 0 ) ;
if ( V_24 )
return V_24 ;
V_44 = F_24 ( V_4 -> V_41 -> V_48 , L_1 , NULL ) ;
if ( V_44 == NULL )
return V_40 ;
V_30 = * V_44 ;
V_43 = F_24 ( V_4 -> V_41 -> V_48 , L_2 , & V_45 ) ;
...
static void T_4 F_29 ( struct V_27 * V_48 , int V_36 ,
unsigned long V_52 )
{
struct V_1 * V_4 = & V_53 [ V_36 ] ;
int V_54 , V_24 ;
V_4 -> V_6 = F_30 ( V_52 , 0x1000 ) ;
if ( V_4 -> V_6 == NULL )
F_31 ( L_5 ) ;
V_4 -> V_41 = F_32 ( V_48 , V_55 ,
& V_56 , V_4 ) ;
if ( V_4 -> V_41 == NULL )
F_31 ( L_6 ) ;
