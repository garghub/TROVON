...
static int F_9 ( struct V_25 * V_26 , int V_27 , int V_28 )
{
...
static void F_15 ( struct V_1 * V_2 , struct V_38 * V_38 )
{
int V_39 ;
unsigned char * V_9 ;
if ( V_38 -> V_40 < 16 )
...
static struct V_43 * F_19 ( struct V_1 * V_2 , struct V_43 * V_44 ,
T_1 V_45 )
{
int V_46 = 0 ;
int V_47 = 0 ;
...
static int F_29 ( struct V_1 * V_2 , struct V_61 * V_62 )
{
int V_63 = 0 ;
unsigned char V_6 [ 2 ] ;
V_63 = F_30 ( V_2 , V_62 ) ;
