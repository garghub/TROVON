...
{
struct V_205 * V_90 = F_128 ( V_204 ) ;
struct V_89 * V_93 = F_129 ( V_204 ) ;
struct V_7 * V_8 = F_46 ( V_93 ) ;
F_130 ( V_90 , V_204 ) ;
F_122 ( V_8 ) ;
F_131 ( V_90 , V_204 ) ;
}
static void F_132 ( struct V_203 * V_204 )
{
struct V_205 * V_90 = F_128 ( V_204 ) ;
struct V_50 * V_51 = F_129 ( V_204 ) ;
unsigned long V_206 ;
int V_195 ;
F_130 ( V_90 , V_204 ) ;
V_206 = F_47 ( V_51 -> V_207 ) ;
...
struct V_147 * V_117 = V_51 -> V_117 ;
int V_209 = F_134 ( V_109 , L_17 ) ;
struct V_210 V_211 , V_212 ;
int V_213 = 0 , V_214 ;
if ( F_135 ( V_109 , 0 , & V_211 ) )
return - V_215 ;
V_8 -> V_85 = F_136 ( V_117 , & V_211 ) ;
if ( F_100 ( V_8 -> V_85 ) )
return F_137 ( V_8 -> V_85 ) ;
V_8 -> V_89 = V_216 ;
...
F_138 ( & V_8 -> V_185 ) ;
F_139 ( V_109 , L_18 , & V_6 -> V_104 ) ;
V_8 -> V_89 . V_218 = V_6 -> V_104 ;
V_6 -> V_219 = V_209 ;
V_6 -> V_220 = V_6 -> V_85 = V_6 -> V_219 * V_11 ;
V_6 -> V_106 = V_8 -> V_89 . V_100 ;
V_6 -> V_93 = & V_8 -> V_89 ;
V_214 = F_140 ( & V_8 -> V_89 ) ;
if ( V_214 ) {
F_63 ( V_117 , L_19 , V_209 ) ;
return V_214 ;
}
F_69 ( V_117 , L_20 , V_6 -> V_104 ) ;
if ( F_141 ( V_109 , 0 , & V_212 ) ) {
V_213 = V_212 . V_221 ;
F_142 ( & V_8 -> V_89 , & V_222 ,
V_213 , F_127 ) ;
}
if ( V_51 -> V_207 || V_213 > 0 ) {
V_214 = F_143 ( & V_8 -> V_89 , & V_222 ,
0 , V_223 ,
V_182 ) ;
if ( V_214 ) {
F_144 ( & V_8 -> V_89 ) ;
...
F_69 ( V_117 , L_22 , V_109 -> V_224 ) ;
}
return 0 ;
}
static int F_145 ( struct V_225 * V_226 ,
...
F_87 ( V_51 , V_109 ) ;
if ( ! V_51 -> V_146 ) {
F_63 ( & V_226 -> V_117 , L_23 ) ;
return - V_98 ;
}
F_69 ( & V_226 -> V_117 , L_24 , V_51 -> V_146 ) ;
F_69 ( & V_226 -> V_117 , L_25 , V_51 -> V_128 ) ;
F_69 ( & V_226 -> V_117 , L_26 , V_51 -> V_101 ) ;
V_51 -> V_129 = F_64 ( & V_226 -> V_117 ,
V_51 -> V_128 * sizeof( * V_51 -> V_129 ) , V_118 ) ;
V_51 -> V_103 = F_64 ( & V_226 -> V_117 ,
V_51 -> V_101 * sizeof( * V_51 -> V_103 ) , V_118 ) ;
V_51 -> V_159 = F_64 ( & V_226 -> V_117 ,
V_51 -> V_146 * sizeof( * V_51 -> V_159 ) , V_118 ) ;
if ( ! V_51 -> V_129 || ! V_51 -> V_103 || ! V_51 -> V_159 )
return - V_119 ;
V_51 -> V_148 = F_146 ( V_109 , L_27 ) ;
if ( F_100 ( V_51 -> V_148 ) ) {
F_63 ( V_51 -> V_117 , L_28 ) ;
return F_137 ( V_51 -> V_148 ) ;
}
V_51 -> V_34 = F_147 ( V_233 , V_109 ) -> V_34 ;
V_232 = F_148 ( V_226 , 0 ) ;
if ( V_232 > 0 ) {
V_211 = F_149 ( V_226 ,
V_234 , L_29 ) ;
V_51 -> V_207 = F_136 ( & V_226 -> V_117 , V_211 ) ;
if ( F_100 ( V_51 -> V_207 ) )
return F_137 ( V_51 -> V_207 ) ;
F_150 ( V_232 , F_132 ,
V_51 ) ;
}
V_228 -> V_106 = V_51 -> V_146 * V_11 ;
V_231 = F_64 ( & V_226 -> V_117 ,
...
static int F_152 ( struct V_225 * V_226 )
{
struct V_50 * V_51 ;
struct V_227 * V_228 ;
int V_172 , V_37 ;
if ( ! V_226 -> V_117 . V_217 ) {
F_63 ( & V_226 -> V_117 , L_32 ) ;
return - V_98 ;
}
V_228 = F_64 ( & V_226 -> V_117 , sizeof( * V_228 ) , V_118 ) ;
if ( ! V_228 )
return - V_119 ;
V_51 = F_64 ( & V_226 -> V_117 , sizeof( * V_51 ) , V_118 ) ;
if ( ! V_51 )
return - V_119 ;
V_51 -> V_117 = & V_226 -> V_117 ;
F_153 ( V_226 , V_51 ) ;
V_172 = F_145 ( V_226 , V_228 , V_51 ) ;
if ( V_172 )
return V_172 ;
V_228 -> V_237 = V_238 ;
V_228 -> V_239 = & V_240 ;
V_228 -> V_241 = & V_242 ;
V_228 -> V_243 = & V_244 ;
V_228 -> V_104 = F_154 ( & V_226 -> V_117 ) ;
V_51 -> V_245 = F_155 ( V_228 , & V_226 -> V_117 , V_51 ) ;
if ( F_100 ( V_51 -> V_245 ) ) {
F_63 ( & V_226 -> V_117 , L_33 ) ;
return F_137 ( V_51 -> V_245 ) ;
}
for ( V_37 = 0 ; V_37 < V_51 -> V_146 ; V_37 ++ )
F_156 ( V_51 -> V_245 , & V_51 -> V_159 [ V_37 ] . V_6 ) ;
return 0 ;
}
