...
static int F_29 ( struct V_50 * V_51 , unsigned long V_52 ,
void * V_53 )
{
switch ( V_52 & ~ V_54 ) {
case V_55 :
...
static void T_6 F_31 ( struct V_59 * V_60 )
{
struct V_32 * V_61 ;
int V_62 = 0 ;
if ( F_32 () == V_63
&& ( F_33 () & 0xf0000f ) < 0x200000 ) {
F_34 ( L_2 ) ;
return;
}
V_45 = F_35 ( V_60 , 0 ) ;
