...
F_49 ( & V_9 -> V_37 ,
F_72 ( & V_9 -> V_243 -> V_44 , 0 ) ) ;
}
static inline void F_73 ( struct V_8 * V_9 )
{
unsigned long V_201 ;
V_201 = F_72 ( & V_9 -> V_243 -> V_44 , 0 ) +
V_9 -> V_247 ;
F_49 ( & V_9 -> V_37 , V_201 ) ;
}
static inline void F_74 ( struct V_8 * V_9 )
{
F_75 ( & V_9 -> V_248 -> V_44 . V_249 . V_250 ) ;
V_9 -> V_248 -> V_44 . V_249 . V_31 = V_9 -> V_3 . V_3 . V_13 . V_31 ;
V_9 -> V_248 -> V_44 . V_249 . V_251 = V_9 -> V_251 ++ ;
F_76 ( & V_9 -> V_248 -> V_44 , V_252 ) ;
V_9 -> V_248 = V_9 -> V_243 ;
}
...
return - V_89 ;
V_44 -> V_249 . V_31 = V_9 -> V_3 . V_3 . V_13 . V_31 ;
return 0 ;
}
static void F_111 ( struct V_43 * V_44 )
{
struct V_8 * V_9 = F_106 ( V_44 -> V_337 ) ;
struct V_42 * V_345 = F_20 ( V_44 ) ;
unsigned long V_346 = 0 ;
F_112 ( & V_9 -> V_258 , V_346 ) ;
F_113 ( & V_345 -> V_246 , & V_9 -> V_244 ) ;
F_114 ( & V_9 -> V_258 , V_346 ) ;
}
static int F_115 ( struct V_337 * V_338 , unsigned int V_347 )
{
struct V_8 * V_9 = F_106 ( V_338 ) ;
struct V_42 * V_345 , * V_348 ;
struct V_15 * V_16 ;
unsigned long V_346 ;
unsigned long V_201 ;
int V_225 ;
...
struct V_42 , V_246 ) ;
V_9 -> V_248 = V_9 -> V_243 ;
F_71 ( & V_9 -> V_248 -> V_246 ) ;
F_114 ( & V_9 -> V_258 , V_346 ) ;
V_201 = F_72 ( & V_9 -> V_248 -> V_44 , 0 ) ;
F_49 ( & V_9 -> V_37 , ( unsigned long ) ( V_201 ) ) ;
F_21 ( & V_9 -> V_37 , 1 ) ;
V_225 = F_85 ( V_16 -> V_235 , V_330 , V_349 , 1 ) ;
if ( V_225 < 0 ) {
F_54 ( V_9 , L_57 ) ;
goto V_350;
}
...
F_81 ( V_9 ) ;
V_16 = V_9 -> V_17 ;
V_225 = F_85 ( V_16 -> V_235 , V_330 , V_349 , 0 ) ;
if ( V_225 && V_225 != - V_284 && V_225 != - V_242 )
F_10 ( 1 , V_9 , L_58 ) ;
F_112 ( & V_9 -> V_258 , V_346 ) ;
if ( V_9 -> V_248 == V_9 -> V_243 ) {
F_76 ( & V_9 -> V_248 -> V_44 , V_352 ) ;
} else {
if ( V_9 -> V_248 != NULL )
F_76 ( & V_9 -> V_248 -> V_44 ,
V_352 ) ;
...
struct V_42 , V_246 ) ;
F_71 ( & V_9 -> V_243 -> V_246 ) ;
F_76 ( & V_9 -> V_243 -> V_44 , V_352 ) ;
}
F_114 ( & V_9 -> V_258 , V_346 ) ;
}
static int F_118 ( struct V_238 * V_238 , void * V_263 ,
struct V_353 * V_226 )
{
struct V_8 * V_9 = F_61 ( V_238 ) ;
F_10 ( 2 , V_9 , L_59 ) ;
...
return - V_89 ;
memset ( V_226 , 0 , sizeof( struct V_353 ) ) ;
V_226 -> type = V_220 ;
V_226 -> V_354 . V_23 = V_228 [ V_9 -> V_233 ] . V_23 ;
V_226 -> V_355 . V_23 = V_226 -> V_354 . V_23 ;
V_226 -> V_354 . V_25 = V_228 [ V_9 -> V_233 ] . V_25 ;
V_226 -> V_355 . V_25 = V_226 -> V_354 . V_25 ;
V_226 -> V_356 = V_228 [ V_9 -> V_233 ] . V_356 ;
return 0 ;
}
static int
F_119 ( struct V_238 * V_238 , void * V_357 , struct V_358 * V_21 )
{
struct V_8 * V_9 = F_61 ( V_238 ) ;
switch ( V_21 -> V_359 ) {
case V_360 :
...
static int F_120 ( struct V_51 * V_363 , struct V_51 * V_164 )
{
if ( V_363 -> V_60 < V_164 -> V_60 || V_363 -> V_63 < V_164 -> V_63 )
return 0 ;
if ( V_363 -> V_60 + V_363 -> V_23 > V_164 -> V_60 + V_164 -> V_23 )
return 0 ;
if ( V_363 -> V_63 + V_363 -> V_25 > V_164 -> V_63 + V_164 -> V_25 )
return 0 ;
return 1 ;
}
static int
F_121 ( struct V_238 * V_238 , void * V_357 , struct V_358 * V_21 )
{
struct V_8 * V_9 = F_61 ( V_238 ) ;
struct V_51 V_364 = V_9 -> V_226 ;
...
V_21 -> V_359 != V_362 )
return - V_89 ;
F_122 ( & V_170 . V_23 , 0 , V_364 . V_23 , 0 ,
& V_170 . V_25 , 0 , V_364 . V_25 , 0 , 0 ) ;
V_170 . V_60 = F_123 (unsigned int, r.left, 0 , cr.width - r.width) ;
V_170 . V_63 = F_123 (unsigned int, r.top, 0 , cr.height - r.height) ;
if ( V_21 -> V_346 & V_365 && ! F_120 ( & V_170 , & V_21 -> V_170 ) )
return - V_366 ;
if ( V_21 -> V_346 & V_367 && ! F_120 ( & V_21 -> V_170 , & V_170 ) )
return - V_366 ;
...
F_10 ( 1 , V_9 , L_60 ,
V_170 . V_60 , V_170 . V_63 , V_170 . V_23 , V_170 . V_25 , V_364 . V_23 , V_364 . V_25 ) ;
return 0 ;
}
static long F_124 ( struct V_238 * V_238 , void * V_263 ,
...
switch ( V_369 ) {
case V_371 :
V_225 = F_33 ( & V_9 -> V_37 , ( void T_3 * ) V_370 ) ;
if ( V_225 ) {
F_10 ( 2 , V_9 ,
L_62 ) ;
return V_225 ;
...
struct V_376 * V_311 )
{
struct V_8 * V_9 = F_19 ( V_374 -> V_270 ,
struct V_8 , V_270 ) ;
struct V_377 V_378 ;
struct V_15 * V_16 ;
bool V_379 = false ;
...
F_10 ( 1 , V_9 , L_64 ) ;
for ( V_93 = 0 ; V_93 < F_2 ( V_9 -> V_47 -> V_311 ) ; V_93 ++ ) {
if ( V_9 -> V_47 -> V_311 [ V_93 ] -> V_380 . V_381 . V_382 == V_311 [ V_93 ] . V_380 . V_381 . V_382 ) {
...
if ( ! V_379 ) {
F_126 ( V_9 , L_65 , V_320 -> V_271 ) ;
return - V_89 ;
}
V_9 -> V_383 . V_384 |= V_16 -> V_321 [ 0 ] . V_385 ;
...
V_390 -> V_397 = & V_398 ;
V_390 -> V_399 = & V_400 ;
V_390 -> V_401 = sizeof( struct V_42 ) ;
V_390 -> V_402 = V_403 ;
...
F_135 ( & V_9 -> V_244 ) ;
V_389 = & V_9 -> V_383 ;
F_84 ( V_389 -> V_271 , V_267 , sizeof( V_389 -> V_271 ) ) ;
V_389 -> V_405 = V_406 ;
V_389 -> V_407 = & V_408 ;
V_389 -> V_409 = & V_410 ;
V_389 -> V_270 = & V_9 -> V_270 ;
V_389 -> V_411 = V_412 ;
V_389 -> V_413 = V_390 ;
V_389 -> V_240 = & V_9 -> V_240 ;
F_136 ( V_389 , V_9 ) ;
...
if ( ! F_142 ( V_421 ) || ! V_237 -> V_98 . V_422 )
return V_237 -> V_98 . V_423 ;
V_420 = F_143 ( & V_237 -> V_98 , sizeof( * V_420 ) , V_424 ) ;
if ( ! V_420 )
return NULL ;
for ( V_93 = 0 ; ; V_93 ++ ) {
struct V_416 * V_425 ;
V_417 = F_144 ( V_237 -> V_98 . V_422 ,
V_417 ) ;
if ( ! V_417 )
break;
V_16 = & V_420 -> V_234 [ V_93 ] ;
V_16 -> V_285 = 0 ;
V_16 -> V_321 [ 0 ] . V_289 = V_93 ;
strcpy ( V_16 -> V_321 [ 0 ] . V_271 , L_70 ) ;
V_16 -> V_321 [ 0 ] . type = V_426 ;
V_16 -> V_321 [ 0 ] . V_385 = V_427 ;
...
V_420 -> V_311 [ V_93 ] = F_143 ( & V_237 -> V_98 ,
sizeof( struct V_376 ) ,
V_424 ) ;
if ( ! V_420 -> V_311 [ V_93 ] ) {
F_149 ( V_425 ) ;
...
V_420 -> V_311 [ V_93 ] -> V_434 = V_435 ;
V_420 -> V_311 [ V_93 ] -> V_380 . V_381 . V_382 = V_425 ;
F_149 ( V_425 ) ;
}
F_149 ( V_417 ) ;
return V_420 ;
...
static int F_150 ( struct V_415 * V_237 )
{
struct V_312 * V_436 = F_140 ( V_237 ) ;
struct V_8 * V_9 ;
struct V_36 * V_37 ;
struct V_437 * V_438 ;
int V_225 ;
...
V_9 = F_143 ( & V_237 -> V_98 , sizeof( * V_9 ) , V_424 ) ;
if ( ! V_9 )
return - V_439 ;
V_9 -> V_237 = & V_237 -> V_98 ;
V_9 -> V_47 = V_436 ;
V_37 = & V_9 -> V_37 ;
V_438 = F_151 ( V_237 , V_440 , 0 ) ;
V_37 -> V_39 . V_40 = F_152 ( & V_237 -> V_98 , V_438 ) ;
if ( F_131 ( V_37 -> V_39 . V_40 ) )
return F_132 ( V_37 -> V_39 . V_40 ) ;
V_9 -> V_253 = F_153 ( V_237 , 0 ) ;
if ( V_9 -> V_253 <= 0 ) {
...
F_52 ( V_37 ) ;
F_32 ( & V_237 -> V_98 ) ;
V_9 -> V_235 = F_143 ( & V_237 -> V_98 , sizeof( struct V_375 * ) *
F_2 ( V_9 -> V_47 -> V_311 ) , V_424 ) ;
if ( ! V_9 -> V_235 ) {
V_225 = - V_439 ;
goto V_441;
}
V_9 -> V_374 . V_442 = V_9 -> V_47 -> V_311 ;
V_9 -> V_374 . V_443 = F_2 ( V_9 -> V_47 -> V_311 ) ;
...
static int F_159 ( struct V_415 * V_237 )
{
...
{
V_37 -> V_446 [ V_46 >> 2 ] = F_14 ( V_37 , V_46 ) ;
V_37 -> V_446 [ V_77 >> 2 ] = F_14 ( V_37 , V_77 ) ;
V_37 -> V_446 [ V_76 >> 2 ] = F_14 ( V_37 , V_76 ) ;
V_37 -> V_446 [ V_202 >> 2 ] = F_14 ( V_37 , V_202 ) ;
V_37 -> V_446 [ V_72 >> 2 ] = F_14 ( V_37 , V_72 ) ;
V_37 -> V_446 [ V_73 >> 2 ] = F_14 ( V_37 , V_73 ) ;
V_37 -> V_446 [ V_75 >> 2 ] = F_14 ( V_37 , V_75 ) ;
V_37 -> V_446 [ V_74 >> 2 ] = F_14 ( V_37 , V_74 ) ;
V_37 -> V_446 [ V_67 >> 2 ] = F_14 ( V_37 , V_67 ) ;
V_37 -> V_446 [ V_71 >> 2 ] = F_14 ( V_37 , V_71 ) ;
V_37 -> V_446 [ V_120 >> 2 ] = F_14 ( V_37 , V_120 ) ;
V_37 -> V_446 [ V_140 >> 2 ] = F_14 ( V_37 , V_140 ) ;
V_37 -> V_446 [ V_95 >> 2 ] = F_14 ( V_37 , V_95 ) ;
V_37 -> V_446 [ V_447 >> 2 ] = F_14 ( V_37 ,
V_447 ) ;
V_37 -> V_446 [ V_448 >> 2 ] = F_14 ( V_37 ,
V_448 ) ;
V_37 -> V_446 [ V_62 >> 2 ] = F_14 ( V_37 ,
V_62 ) ;
V_37 -> V_446 [ V_69 >> 2 ] = F_14 ( V_37 ,
V_69 ) ;
V_37 -> V_446 [ V_70 >> 2 ] = F_14 ( V_37 ,
V_70 ) ;
V_37 -> V_446 [ V_78 >> 2 ] = F_14 ( V_37 ,
V_78 ) ;
}
static int F_165 ( struct V_97 * V_98 )
{
struct V_415 * V_237 = F_166 ( V_98 ) ;
struct V_8 * V_9 = F_160 ( V_237 ) ;
...
{
F_16 ( V_37 , V_37 -> V_446 [ V_77 >> 2 ] , V_77 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_95 >> 2 ] , V_95 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_76 >> 2 ] , V_76 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_202 >> 2 ] , V_202 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_72 >> 2 ] , V_72 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_73 >> 2 ] , V_73 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_75 >> 2 ] , V_75 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_74 >> 2 ] , V_74 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_67 >> 2 ] , V_67 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_71 >> 2 ] , V_71 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_120 >> 2 ] , V_120 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_140 >> 2 ] , V_140 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_46 >> 2 ] , V_46 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_447 >> 2 ] ,
V_447 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_448 >> 2 ] ,
V_448 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_62 >> 2 ] ,
V_62 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_69 >> 2 ] ,
V_69 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_70 >> 2 ] ,
V_70 ) ;
F_16 ( V_37 , V_37 -> V_446 [ V_78 >> 2 ] ,
V_78 ) ;
}
