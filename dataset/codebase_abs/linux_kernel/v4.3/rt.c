...
F_48 ( V_51 ) ;
F_94 ( V_51 ) ;
F_120 ( & V_51 -> V_66 -> V_107 , V_51 -> V_54 , V_153 ) ;
}
...
static void
F_204 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_154 )
{
if ( ! F_162 ( V_63 ) )
return;
if ( V_51 -> V_33 == V_63 ) {
...
V_155 = F_206 ( V_63 , V_157 ) ;
V_156 = F_207 ( V_63 , V_157 ) ;
if ( V_155 != V_158 ) {
unsigned long V_34 ;
if ( V_63 -> V_50 . V_159 != V_160 ) {
V_63 -> V_50 . V_114 ++ ;
V_63 -> V_50 . V_159 = V_160 ;
}
V_34 = F_208 ( F_103 ( V_155 , V_156 ) , V_161 / V_162 ) ;
if ( V_63 -> V_50 . V_114 > V_34 )
V_63 -> V_163 . V_164 = V_63 -> V_100 . V_104 ;
}
}
static void F_209 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_165 )
{
struct V_48 * V_49 = & V_63 -> V_50 ;
F_109 ( V_51 ) ;
F_205 ( V_51 , V_63 ) ;
...
static unsigned int F_211 ( struct V_51 * V_51 , struct V_47 * V_127 )
{
if ( V_127 -> V_166 == V_167 )
return V_169 ;
else
return 0 ;
}
void F_212 ( struct V_170 * V_171 , int V_54 )
{
T_3 V_87 ;
struct V_22 * V_22 ;
F_147 () ;
F_96 (rt_rq, iter, cpu_rq(cpu))
F_213 ( V_171 , V_54 , V_22 ) ;
F_151 () ;
}
