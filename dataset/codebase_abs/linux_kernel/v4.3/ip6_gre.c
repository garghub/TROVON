...
V_135 = F_64 ( V_91 ) ;
if ( ! V_135 ) {
V_135 = F_65 ( V_12 , NULL , V_129 ) ;
if ( V_135 -> error )
goto V_143;
V_135 = F_66 ( V_12 , V_135 , F_67 ( V_129 ) , NULL , 0 ) ;
if ( F_68 ( V_135 ) ) {
V_92 = F_69 ( V_135 ) ;
V_135 = NULL ;
goto V_143;
...
V_76 = V_84 ;
if ( F_72 ( V_57 ) )
F_72 ( V_57 ) -> V_123 -> V_146 ( F_72 ( V_57 ) , NULL , V_57 , V_76 ) ;
if ( V_57 -> V_117 > V_76 ) {
* V_130 = V_76 ;
V_92 = - V_147 ;
goto V_145;
...
F_74 ( V_57 , ! F_75 ( V_91 -> V_12 , F_5 ( V_7 ) ) ) ;
V_132 += F_76 ( V_131 ) + V_133 + V_135 -> V_148 ;
if ( F_77 ( V_57 ) < V_132 || F_78 ( V_57 ) ||
( F_79 ( V_57 ) && ! F_80 ( V_57 , 0 ) ) ) {
V_139 = F_81 ( V_57 , V_132 ) ;
if ( V_132 > V_7 -> V_149 )
V_7 -> V_149 = V_132 ;
if ( ! V_139 )
goto V_145;
if ( V_57 -> V_150 )
F_82 ( V_139 , V_57 -> V_150 ) ;
F_83 ( V_57 ) ;
V_57 = V_139 ;
}
if ( ! V_129 -> V_142 && V_136 )
F_84 ( V_91 , V_136 ) ;
F_85 ( V_57 , V_135 ) ;
V_138 = V_151 ;
if ( V_82 >= 0 ) {
F_61 ( & V_59 , V_82 ) ;
F_86 ( V_57 , & V_59 . V_123 , & V_138 , NULL ) ;
}
if ( F_87 ( ! V_57 -> V_152 ) ) {
F_88 ( V_57 ) ;
V_57 -> V_152 = 1 ;
...
F_89 ( V_57 , V_133 ) ;
F_50 ( V_57 ) ;
F_90 ( V_57 , sizeof( * V_64 ) ) ;
V_64 = F_39 ( V_57 ) ;
F_91 ( V_64 , F_92 ( 0 , V_127 ) ,
F_93 ( V_12 , V_57 , V_129 -> V_153 , true , V_129 ) ) ;
...
V_129 . V_153 |= F_94 ( ( T_6 ) V_161 -> V_169 << V_170 )
& V_171 ;
...
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_63 * V_64 = (struct V_63 * ) F_89 ( V_57 , V_17 -> V_141 ) ;
T_3 * V_36 = ( T_3 * ) ( V_64 + 1 ) ;
F_91 ( V_64 , 0 ,
F_93 ( F_5 ( V_7 ) , V_57 ,
V_17 -> V_163 . V_164 . V_165 . V_153 , true ,
...
static void F_135 ( struct V_12 * V_12 , struct V_231 * V_232 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
...
static int F_145 ( struct V_241 * V_242 [] , struct V_241 * V_65 [] )
{
T_3 V_32 ;
if ( ! V_65 )
return 0 ;
V_32 = 0 ;
if ( V_65 [ V_243 ] )
V_32 |= F_146 ( V_65 [ V_243 ] ) ;
if ( V_65 [ V_244 ] )
V_32 |= F_146 ( V_65 [ V_244 ] ) ;
if ( V_32 & ( V_70 | V_69 ) )
return - V_216 ;
return 0 ;
}
static int F_147 ( struct V_241 * V_242 [] , struct V_241 * V_65 [] )
{
struct V_1 V_71 ;
if ( V_242 [ V_245 ] ) {
if ( F_148 ( V_242 [ V_245 ] ) != V_246 )
return - V_216 ;
if ( ! F_149 ( F_150 ( V_242 [ V_245 ] ) ) )
return - V_247 ;
}
if ( ! V_65 )
goto V_248;
if ( V_65 [ V_249 ] ) {
V_71 = F_151 ( V_65 [ V_249 ] ) ;
if ( F_14 ( & V_71 ) )
return - V_216 ;
}
V_248:
return F_145 ( V_242 , V_65 ) ;
}
static void F_152 ( struct V_241 * V_65 [] ,
struct V_35 * V_28 )
{
...
return;
if ( V_65 [ V_250 ] )
V_28 -> V_13 = F_153 ( V_65 [ V_250 ] ) ;
if ( V_65 [ V_243 ] )
V_28 -> V_104 = F_146 ( V_65 [ V_243 ] ) ;
if ( V_65 [ V_244 ] )
V_28 -> V_52 = F_146 ( V_65 [ V_244 ] ) ;
if ( V_65 [ V_251 ] )
V_28 -> V_31 = F_154 ( V_65 [ V_251 ] ) ;
if ( V_65 [ V_252 ] )
V_28 -> V_158 = F_154 ( V_65 [ V_252 ] ) ;
if ( V_65 [ V_253 ] )
V_28 -> V_29 = F_151 ( V_65 [ V_253 ] ) ;
if ( V_65 [ V_249 ] )
V_28 -> V_30 = F_151 ( V_65 [ V_249 ] ) ;
if ( V_65 [ V_254 ] )
V_28 -> V_154 = F_155 ( V_65 [ V_254 ] ) ;
if ( V_65 [ V_255 ] )
V_28 -> V_82 = F_155 ( V_65 [ V_255 ] ) ;
if ( V_65 [ V_256 ] )
V_28 -> V_189 = F_153 ( V_65 [ V_256 ] ) ;
if ( V_65 [ V_257 ] )
V_28 -> V_32 = F_153 ( V_65 [ V_257 ] ) ;
}
...
static int F_159 ( struct V_12 * V_259 , struct V_6 * V_7 ,
...
static int F_161 ( struct V_6 * V_7 , struct V_241 * V_242 [] ,
struct V_241 * V_65 [] )
{
...
static void F_162 ( struct V_6 * V_7 , struct V_231 * V_232 )
{
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
if ( V_7 != V_20 -> V_34 )
...
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_166 ( V_57 , V_250 , V_36 -> V_13 ) ||
F_167 ( V_57 , V_243 , V_36 -> V_104 ) ||
F_167 ( V_57 , V_244 , V_36 -> V_52 ) ||
F_168 ( V_57 , V_251 , V_36 -> V_31 ) ||
F_168 ( V_57 , V_252 , V_36 -> V_158 ) ||
F_169 ( V_57 , V_253 , & V_36 -> V_29 ) ||
F_169 ( V_57 , V_249 , & V_36 -> V_30 ) ||
F_170 ( V_57 , V_254 , V_36 -> V_154 ) ||
F_170 ( V_57 , V_255 , V_36 -> V_82 ) ||
F_168 ( V_57 , V_256 , V_36 -> V_189 ) ||
F_166 ( V_57 , V_257 , V_36 -> V_32 ) )
goto V_261;
return 0 ;
V_261:
return - V_147 ;
