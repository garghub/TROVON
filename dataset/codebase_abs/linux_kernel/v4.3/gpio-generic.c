...
V_65 = V_64 -> V_65 ;
if ( ! F_66 ( V_31 , V_65 , V_50 , V_64 -> V_60 ) ) {
* V_62 = - V_67 ;
return NULL ;
}
V_51 = F_67 ( V_31 , V_65 , V_50 ) ;
if ( ! V_51 ) {
* V_62 = - V_68 ;
return NULL ;
}
...
void T_1 * V_43 ;
unsigned long V_50 ;
unsigned long V_18 = V_59 -> V_69 -> V_70 ;
int V_62 ;
struct V_3 * V_4 ;
struct V_71 * V_72 = F_69 ( V_31 ) ;
V_64 = F_64 ( V_59 , V_66 , L_3 ) ;
if ( ! V_64 )
return - V_25 ;
V_50 = F_65 ( V_64 ) ;
V_35 = F_63 ( V_59 , L_3 , V_50 , & V_62 ) ;
if ( ! V_35 )
return V_62 ? V_62 : - V_25 ;
V_26 = F_63 ( V_59 , L_4 , V_50 , & V_62 ) ;
if ( V_62 )
return V_62 ;
V_36 = F_63 ( V_59 , L_5 , V_50 , & V_62 ) ;
if ( V_62 )
return V_62 ;
V_42 = F_63 ( V_59 , L_6 , V_50 , & V_62 ) ;
if ( V_62 )
return V_62 ;
V_43 = F_63 ( V_59 , L_7 , V_50 , & V_62 ) ;
if ( V_62 )
return V_62 ;
V_4 = F_70 ( & V_59 -> V_31 , sizeof( * V_4 ) , V_73 ) ;
if ( ! V_4 )
return - V_68 ;
V_62 = F_59 ( V_4 , V_31 , V_50 , V_35 , V_26 , V_36 , V_42 , V_43 , V_18 ) ;
if ( V_62 )
return V_62 ;
if ( V_72 ) {
if ( V_72 -> V_52 )
V_4 -> V_8 . V_52 = V_72 -> V_52 ;
V_4 -> V_8 . V_53 = V_72 -> V_53 ;
if ( V_72 -> V_49 > 0 )
V_4 -> V_8 . V_49 = V_72 -> V_49 ;
}
F_71 ( V_59 , V_4 ) ;
return F_72 ( & V_4 -> V_8 ) ;
}
