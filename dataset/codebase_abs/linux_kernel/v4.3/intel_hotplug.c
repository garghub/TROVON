...
if ( V_15 -> V_17 . V_18 [ V_51 ] . V_26 == V_43 ) {
F_36 ( F_37 ( V_29 ) -> V_89 >= 5 && ! F_38 ( V_29 ) ,
L_13 , V_51 ) ;
continue;
}
...
F_39 ( & V_15 -> V_37 ) ;
if ( V_86 )
F_40 ( V_15 -> V_17 . V_90 , & V_15 -> V_17 . V_63 ) ;
if ( V_87 )
F_27 ( & V_15 -> V_17 . V_78 ) ;
}
...
struct V_32 * V_32 = F_9 ( V_35 ) ;
V_35 -> V_38 = V_32 -> V_38 ;
if ( V_35 -> V_40 && ! V_35 -> V_38 && F_42 ( V_29 ) && V_32 -> V_40 -> V_1 > V_41 )
V_35 -> V_38 = V_39 ;
if ( V_32 -> V_91 )
V_35 -> V_38 = V_39 ;
}
...
{
F_44 ( & V_15 -> V_17 . V_78 , F_28 ) ;
F_44 ( & V_15 -> V_17 . V_63 , F_26 ) ;
F_45 ( & V_15 -> V_17 . V_47 ,
F_13 ) ;
}
