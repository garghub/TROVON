...
static int F_24 ( struct V_34 * V_35 , struct V_28 * V_29 )
{
F_25 ( V_29 , V_35 -> V_36 ) ;
return 0 ;
}
...
static int T_1 F_27 ( struct V_34 * V_35 )
{
T_2 V_31 = V_37 << F_13 ( V_38 - 1 , V_39 ) ;
T_2 V_40 = V_31 - 1 ;
unsigned long V_41 = V_35 -> V_42 ;
struct V_24 * V_24 ;
int V_43 ;
if ( ! F_28 ( V_41 , L_4 , NULL ) ||
F_28 ( V_41 , L_5 , NULL ) )
return - V_44 ;
if ( ( V_35 -> V_23 & V_40 ) || ( V_35 -> V_22 & V_40 ) ) {
F_29 ( L_6 ) ;
return - V_44 ;
}
V_43 = F_30 ( V_35 -> V_23 , V_35 -> V_22 , 0 , & V_24 ) ;
if ( V_43 ) {
F_29 ( L_7 ) ;
return V_43 ;
}
F_16 ( V_35 -> V_23 , V_35 -> V_22 ) ;
if ( F_28 ( V_41 , L_8 , NULL ) )
F_31 ( V_24 ) ;
V_35 -> V_45 = & V_46 ;
V_35 -> V_36 = V_24 ;
F_32 ( L_9 ,
& V_35 -> V_23 , ( unsigned long ) V_35 -> V_22 / V_21 ) ;
return 0 ;
}
