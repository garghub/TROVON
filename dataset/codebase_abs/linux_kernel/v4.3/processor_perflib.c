...
int F_14 ( struct V_7 * V_8 , int V_32 )
{
int V_33 ;
if ( V_11 ) {
if ( V_32 )
...
T_1 V_22 = V_73 ;
struct V_40 V_41 = { V_42 , NULL } ;
struct V_40 V_74 = { sizeof( L_30 ) , L_30 } ;
struct V_40 V_75 = { 0 , NULL } ;
union V_43 * V_94 = NULL ;
struct V_95 * V_96 ;
V_22 = F_23 ( V_8 -> V_24 , L_31 , NULL , & V_41 ) ;
if ( F_8 ( V_22 ) ) {
return - V_29 ;
}
V_94 = V_41 . V_46 ;
...
if ( ! V_8 )
continue;
V_8 -> V_16 = F_43 ( V_16 , V_60 ) ;
F_44 ( V_60 , V_8 -> V_16 -> V_114 ) ;
if ( F_39 ( V_8 ) ) {
V_108 = - V_23 ;
continue;
}
