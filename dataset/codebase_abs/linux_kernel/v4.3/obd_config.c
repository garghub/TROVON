...
struct V_190 * V_191 ;
V_191 = F_109 ( V_30 , 1 ) ;
F_11 ( V_36 , L_62 , V_191 -> V_192 ,
V_191 -> V_193 , V_191 -> V_194 , V_191 -> V_195 ) ;
V_71 = 0 ;
goto V_37;
}
case V_196 : {
...
int F_117 ( char * V_211 , struct V_212 * V_213 ,
struct V_29 * V_30 , void * V_214 )
{
struct V_212 * V_215 ;
struct V_216 V_217 ;
struct V_218 V_219 ;
...
V_217 . V_227 = & V_219 ;
V_219 . V_228 = V_214 ;
for ( V_221 = 1 ; V_221 < V_30 -> V_101 ; V_221 ++ ) {
V_2 = F_109 ( V_30 , V_221 ) ;
F_5 ( V_2 , V_211 , & V_2 ) ;
V_220 = strchr ( V_2 , '=' ) ;
if ( ! V_220 || ( * ( V_220 + 1 ) == 0 ) ) {
F_4 ( L_68 , V_2 ) ;
...
V_224 = 0 ;
V_225 = 0 ;
while ( V_213 [ V_225 ] . V_34 ) {
V_215 = & V_213 [ V_225 ] ;
if ( F_5 ( V_2 , ( char * ) V_215 -> V_34 , NULL ) == 0
&& V_222 == strlen ( V_215 -> V_34 ) ) {
V_224 ++ ;
V_26 = - V_229 ;
if ( V_215 -> V_230 && V_215 -> V_230 -> V_231 ) {
T_3 V_232 ;
V_232 = F_118 () ;
F_119 ( V_233 ) ;
V_26 = ( V_215 -> V_230 -> V_231 ) ( & V_217 , V_220 ,
V_223 , NULL ) ;
F_119 ( V_232 ) ;
}
break;
...
F_11 ( V_114 , L_71 ,
F_22 ( V_30 , 0 ) ,
( int ) strlen ( V_211 ) - 1 , V_211 ,
( int ) ( V_220 - V_2 - 1 ) , V_2 , V_220 ) ;
}
}
if ( V_26 > 0 )
V_26 = 0 ;
...
int F_121 ( const struct V_235 * V_236 ,
struct V_237 * V_238 ,
struct V_239 * V_240 , void * V_214 )
{
struct V_241 * V_242 = V_214 ;
int V_243 = V_240 -> V_244 ;
char * V_245 = ( char * ) ( V_240 + 1 ) ;
int V_26 = 0 ;
switch ( V_240 -> V_246 ) {
case V_247 : {
struct V_29 * V_30 , * V_248 ;
struct V_162 V_163 ;
char * V_249 = NULL ;
int V_250 = 0 ;
int V_251 = 0 , V_252 = 0 ;
V_30 = (struct V_29 * ) V_245 ;
if ( V_30 -> V_253 == F_122 ( V_254 ) ) {
F_123 ( V_30 ) ;
V_252 = 1 ;
}
V_26 = F_124 ( V_245 , V_243 ) ;
if ( V_26 )
goto V_37;
if ( V_30 -> V_167 == V_189 ) {
struct V_190 * V_191 = F_109 ( V_30 , 1 ) ;
F_125 ( V_191 , V_252 ,
F_21 ( V_30 , 1 ) ) ;
F_11 ( V_114 , L_72 ,
V_242 -> V_255 , V_191 -> V_193 ) ;
if ( V_191 -> V_193 & V_256 ) {
V_242 -> V_255 = V_257 ;
if ( V_191 -> V_193 & V_258 ) {
V_242 -> V_255 |= V_259 ;
F_11 ( V_114 , L_73 ,
V_191 -> V_192 ) ;
} else if ( ( V_191 -> V_193 & V_260 ) ||
( V_242 -> V_261 &&
F_126 ( V_242 -> V_261 ,
V_191 -> V_194 ) ) ) {
V_242 -> V_255 |= V_262 ;
...
char * V_267 = F_22 ( V_30 , 2 ) ;
if ( ( V_30 -> V_167 == V_179 && V_33 &&
strcmp ( V_33 , L_77 ) == 0 ) ) {
F_110 ( L_78 ) ;
V_33 [ 2 ] = 't' ;
}
if ( ( V_30 -> V_167 == V_201 && V_267 &&
strcmp ( V_267 , L_79 ) == 0 ) ) {
F_11 ( V_21 , L_80 ) ;
V_267 [ 0 ] = '0' ;
V_267 [ 1 ] = 0 ;
...
F_95 ( & V_163 , V_30 ) ;
if ( V_242 && V_242 -> V_265 &&
F_21 ( V_30 , 0 ) > 0 ) {
V_251 = 1 ;
V_250 = F_21 ( V_30 , 0 ) +
sizeof( V_242 -> V_265 ) * 2 + 4 ;
V_249 = F_80 ( V_250 , V_136 ) ;
if ( ! V_249 ) {
V_26 = - V_88 ;
goto V_37;
}
...
if ( V_242 && V_242 -> V_265 == NULL &&
V_30 -> V_167 == V_270 ) {
F_127 ( & V_163 , 2 , V_163 . V_271 [ 1 ] ,
V_163 . V_272 [ 1 ] ) ;
F_127 ( & V_163 , 1 , V_163 . V_271 [ 0 ] ,
V_163 . V_272 [ 0 ] ) ;
F_96 ( & V_163 , 0 ,
V_242 -> V_273 ) ;
}
V_248 = F_97 ( V_30 -> V_167 , & V_163 ) ;
V_248 -> V_126 = V_30 -> V_126 ;
V_248 -> V_168 = V_30 -> V_168 ;
if ( V_30 -> V_170 != 0 &&
( V_30 -> V_169 >> 32 ) == 0 ) {
T_2 V_274 = ( T_2 ) ( V_30 -> V_169 & 0xffffffff ) ;
V_248 -> V_169 =
F_128 ( F_129 ( V_30 -> V_170 , 0 ) , V_274 ) ;
F_110 ( L_84 ,
V_30 -> V_170 , V_274 ,
F_105 ( V_248 -> V_169 ) ) ;
} else {
V_248 -> V_169 = V_30 -> V_169 ;
}
V_248 -> V_170 = 0 ;
V_26 = F_104 ( V_248 ) ;
F_130 ( V_248 ) ;
...
if ( V_26 ) {
F_4 ( L_86 ,
V_238 -> V_275 -> V_276 -> V_40 , V_26 ) ;
F_131 ( NULL , V_238 , V_240 , V_214 ) ;
}
return V_26 ;
}
int F_132 ( const struct V_235 * V_236 , struct V_277 * V_278 ,
char * V_34 , struct V_241 * V_160 )
{
struct V_279 V_280 = { 0 , 0 } ;
struct V_237 * V_281 ;
T_4 V_282 ;
int V_26 ;
F_11 ( V_21 , L_87 , V_34 ) ;
V_26 = F_133 ( V_236 , V_278 , & V_281 , NULL , V_34 , V_283 ) ;
if ( V_26 )
return V_26 ;
V_26 = F_134 ( V_236 , V_281 , V_284 , NULL ) ;
if ( V_26 )
goto V_285;
if ( V_160 ) {
V_280 . V_286 = V_160 -> V_287 ;
V_282 = V_160 -> V_288 ;
F_46 ( V_282 != NULL ) ;
} else {
V_282 = F_121 ;
...
V_280 . V_289 = 0 ;
V_26 = F_135 ( V_236 , V_281 , V_282 , V_160 , & V_280 ) ;
F_11 ( V_114 , L_88 , V_34 ,
V_280 . V_286 + 1 , V_280 . V_289 , V_26 ) ;
if ( V_160 )
V_160 -> V_287 = V_280 . V_289 ;
V_285:
F_136 ( V_236 , V_281 ) ;
return V_26 ;
}
int F_137 ( struct V_239 * V_240 , char * V_1 , int V_290 )
{
struct V_29 * V_30 = (struct V_29 * ) ( V_240 + 1 ) ;
char * V_4 = V_1 ;
char * V_175 = V_1 + V_290 ;
int V_26 = 0 ;
F_46 ( V_240 -> V_246 == V_247 ) ;
V_26 = F_124 ( V_30 , V_240 -> V_244 ) ;
if ( V_26 < 0 )
return V_26 ;
V_4 += snprintf ( V_4 , V_175 - V_4 , L_89 , V_30 -> V_167 ) ;
if ( V_30 -> V_168 )
V_4 += snprintf ( V_4 , V_175 - V_4 , L_90 ,
V_30 -> V_168 ) ;
if ( V_30 -> V_126 )
V_4 += snprintf ( V_4 , V_175 - V_4 , L_91 , V_30 -> V_126 ) ;
if ( V_30 -> V_169 )
V_4 += snprintf ( V_4 , V_175 - V_4 , L_92 ,
F_105 ( V_30 -> V_169 ) ,
V_30 -> V_169 ) ;
if ( V_30 -> V_167 == V_189 ) {
struct V_190 * V_191 = F_109 ( V_30 , 1 ) ;
...
int V_221 ;
for ( V_221 = 0 ; V_221 < V_30 -> V_101 ; V_221 ++ ) {
V_4 += snprintf ( V_4 , V_175 - V_4 , L_94 , V_221 ,
F_22 ( V_30 , V_221 ) ) ;
}
}
V_26 = V_4 - V_1 ;
...
int F_131 ( const struct V_235 * V_236 ,
struct V_237 * V_238 ,
struct V_239 * V_240 , void * V_214 )
{
char * V_291 ;
int V_26 = 0 ;
V_291 = F_80 ( 256 , V_136 ) ;
if ( ! V_291 )
return - V_88 ;
if ( V_240 -> V_246 == V_247 ) {
F_137 ( V_240 , V_291 , 256 ) ;
F_138 ( V_292 , L_95 , V_291 ) ;
} else {
F_138 ( V_292 , L_96 , V_240 -> V_246 ) ;
V_26 = - V_16 ;
}
F_83 ( V_291 ) ;
return V_26 ;
}
int F_139 ( const struct V_235 * V_236 , struct V_277 * V_278 ,
char * V_34 , struct V_241 * V_160 )
{
struct V_237 * V_281 ;
int V_26 ;
...
if ( V_26 )
goto V_285;
V_26 = F_135 ( V_236 , V_281 , F_131 , V_160 , NULL ) ;
V_285:
F_136 ( V_236 , V_281 ) ;
F_140 ( L_98 , V_34 ) ;
return V_26 ;
...
F_96 ( & V_163 , 1 , V_293 ) ;
V_30 = F_97 ( V_203 , & V_163 ) ;
if ( ! V_30 )
return - V_88 ;
V_26 = F_104 ( V_30 ) ;
if ( V_26 ) {
F_4 ( L_104 , V_26 , V_32 -> V_40 ) ;
goto V_37;
}
V_30 -> V_167 = V_202 ;
V_26 = F_104 ( V_30 ) ;
...
static unsigned
F_142 ( struct V_295 * V_296 , const void * V_2 , unsigned V_297 )
{
return F_143 ( ( (struct V_65 * ) V_2 ) -> V_35 ,
sizeof( ( (struct V_65 * ) V_2 ) -> V_35 ) , V_297 ) ;
}
static void *
F_144 ( struct V_298 * V_299 )
{
struct V_72 * exp ;
exp = F_145 ( V_299 , struct V_72 , V_300 ) ;
return & exp -> V_301 ;
}
static int
F_146 ( const void * V_2 , struct V_298 * V_299 )
{
struct V_72 * exp ;
F_46 ( V_2 ) ;
exp = F_145 ( V_299 , struct V_72 , V_300 ) ;
return F_147 ( V_2 , & exp -> V_301 ) &&
! exp -> V_302 ;
}
static void *
F_148 ( struct V_298 * V_299 )
{
return F_145 ( V_299 , struct V_72 , V_300 ) ;
}
static void
F_149 ( struct V_295 * V_296 , struct V_298 * V_299 )
{
struct V_72 * exp ;
exp = F_145 ( V_299 , struct V_72 , V_300 ) ;
F_150 ( exp ) ;
...
static void
F_151 ( struct V_295 * V_296 , struct V_298 * V_299 )
{
struct V_72 * exp ;
exp = F_145 ( V_299 , struct V_72 , V_300 ) ;
F_51 ( exp ) ;
...
static unsigned
F_152 ( struct V_295 * V_296 , const void * V_2 , unsigned V_297 )
{
return F_143 ( V_2 , sizeof( T_1 ) , V_297 ) ;
}
static void *
F_153 ( struct V_298 * V_299 )
{
struct V_72 * exp ;
exp = F_145 ( V_299 , struct V_72 , V_303 ) ;
return & exp -> V_304 -> V_305 . V_18 ;
}
static int
F_154 ( const void * V_2 , struct V_298 * V_299 )
{
struct V_72 * exp ;
F_46 ( V_2 ) ;
exp = F_145 ( V_299 , struct V_72 , V_303 ) ;
return exp -> V_304 -> V_305 . V_18 == * ( T_1 * ) V_2 &&
! exp -> V_302 ;
}
static void *
F_155 ( struct V_298 * V_299 )
{
return F_145 ( V_299 , struct V_72 , V_303 ) ;
}
static void
F_156 ( struct V_295 * V_296 , struct V_298 * V_299 )
{
struct V_72 * exp ;
exp = F_145 ( V_299 , struct V_72 , V_303 ) ;
F_150 ( exp ) ;
...
static void
F_157 ( struct V_295 * V_296 , struct V_298 * V_299 )
{
struct V_72 * exp ;
exp = F_145 ( V_299 , struct V_72 , V_303 ) ;
F_51 ( exp ) ;
