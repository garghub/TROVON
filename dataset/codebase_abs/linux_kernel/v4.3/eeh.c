...
int T_1 F_58 ( struct V_20 * V_122 )
{
if ( ! V_122 -> V_123 ) {
F_8 ( L_42 ,
V_61 , V_122 ) ;
...
goto V_64;
F_90 ( & V_5 -> V_34 -> V_165 ) ;
F_18 ( F_91 ( & V_5 -> V_34 -> V_165 ) < 0 ) ;
F_83 ( V_5 -> V_34 ) ;
V_64:
F_88 ( & V_164 ) ;
}
static int F_92 ( struct V_158 * V_71 , void * V_31 )
{
struct V_70 * V_104 = F_93 ( V_71 ) ;
...
struct V_33 * F_94 ( struct V_167 * V_168 )
{
...
int F_96 ( struct V_33 * V_34 , int V_169 )
{
int V_58 = 0 ;
if ( ! V_34 )
return - V_163 ;
...
int F_100 ( struct V_33 * V_34 , int V_169 )
{
int V_58 = 0 ;
if ( ! V_34 )
return - V_163 ;
...
int F_102 ( struct V_33 * V_34 , int type , int V_183 ,
...
static int F_103 ( struct V_190 * V_191 , void * V_192 )
{
if ( ! F_30 () ) {
F_104 ( V_191 , L_58 ) ;
F_104 ( V_191 , L_59 , V_75 . V_76 ) ;
} else {
F_104 ( V_191 , L_60 ) ;
F_104 ( V_191 ,
L_61
...
static int F_105 ( struct V_193 * V_193 , struct V_194 * V_194 )
{
return F_106 ( V_194 , F_103 , NULL ) ;
}
...
static int F_110 ( void * V_31 , T_7 * V_195 )
{
* V_195 = V_196 ;
return 0 ;
}
...
{
if ( F_63 ( V_197 ) || F_63 ( V_133 ) ) {
F_112 ( L_67 , 0 , NULL , & V_198 ) ;
#ifdef F_113
F_114 ( L_68 , 0600 ,
V_199 , NULL ,
& V_200 ) ;
