...
V_14 -> V_302 -> V_312 = F_153 ( 0xffff ) ;
V_219 = V_5 -> V_219 [ V_6 ] ;
V_114 = F_154 ( V_5 , V_219 , V_14 -> V_307 . V_220 ,
V_6 / V_5 -> V_10 ) ;
if ( V_114 ) {
F_18 ( V_5 , L_63 ) ;
F_148 ( V_5 , V_14 ) ;
...
V_219 -> V_313 = F_120 ( V_2 , V_6 ) ;
F_149 ( V_5 , V_14 ) ;
for ( V_291 = 0 ; V_291 < V_219 -> V_314 ; V_291 += V_315 )
* ( ( T_3 * ) ( V_219 -> V_302 + V_291 ) ) = 0xffffffff ;
++ V_290 ;
}
V_114 = F_155 ( V_82 -> V_2 , V_5 -> V_64 ,
V_5 -> V_297 + V_316 ,
V_5 -> V_317 -> V_318 ,
V_5 -> V_317 -> V_319 ,
V_5 -> V_317 -> V_320 ,
...
V_114 = F_156 ( V_82 -> V_2 , V_5 -> V_64 , V_322 , 1 ) ;
if ( V_114 ) {
F_18 ( V_5 , L_66 ,
V_114 ) ;
goto V_311;
...
for ( V_6 = 0 ; V_6 < V_5 -> V_216 ; V_6 ++ )
F_167 ( V_5 , V_5 -> V_16 [ V_6 ] ) ;
return V_114 ;
}
void F_168 ( struct V_1 * V_2 , int V_324 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_5 -> V_82 ;
struct V_176 * V_197 , * V_116 ;
...
F_165 ( V_5 ) ;
for ( V_6 = 0 ; V_6 < V_5 -> V_218 ; V_6 ++ ) {
F_164 ( V_5 , V_5 -> V_219 [ V_6 ] ) ;
F_148 ( V_5 , V_5 -> V_246 [ V_6 ] ) ;
}
F_177 ( 10 ) ;
for ( V_6 = 0 ; V_6 < V_5 -> V_218 ; V_6 ++ )
F_178 ( V_2 , V_5 -> V_219 [ V_6 ] ) ;
F_166 ( V_5 ) ;
F_74 ( V_5 ) ;
...
memset ( & V_5 -> V_331 , 0 , sizeof( V_5 -> V_331 ) ) ;
memset ( & V_5 -> V_332 , 0 ,
sizeof( V_5 -> V_332 ) ) ;
memset ( & V_5 -> V_333 , 0 ,
sizeof( V_5 -> V_333 ) ) ;
...
V_5 -> V_219 [ V_6 ] -> V_335 = 0 ;
}
for ( V_6 = 0 ; V_6 < V_5 -> V_216 ; V_6 ++ ) {
V_5 -> V_16 [ V_6 ] -> V_269 = 0 ;
V_5 -> V_16 [ V_6 ] -> V_262 = 0 ;
V_5 -> V_16 [ V_6 ] -> V_336 = 0 ;
V_5 -> V_16 [ V_6 ] -> V_337 = 0 ;
V_5 -> V_16 [ V_6 ] -> V_338 = 0 ;
}
}
...
F_191 ( V_5 , & V_5 -> V_219 [ V_6 ] ) ;
if ( V_5 -> V_246 && V_5 -> V_246 [ V_6 ] )
F_192 ( V_5 , & V_5 -> V_246 [ V_6 ] ) ;
}
for ( V_6 = 0 ; V_6 < V_5 -> V_216 ; V_6 ++ ) {
if ( V_5 -> V_16 [ V_6 ] )
F_193 ( V_5 , & V_5 -> V_16 [ V_6 ] ,
V_5 -> V_317 -> V_342 , V_5 -> V_343 ) ;
if ( V_5 -> V_217 [ V_6 ] )
F_192 ( V_5 , & V_5 -> V_217 [ V_6 ] ) ;
}
}
int F_194 ( struct V_4 * V_5 )
{
struct V_344 * V_317 = V_5 -> V_317 ;
int V_6 ;
int V_345 ;
for ( V_6 = 0 ; V_6 < V_5 -> V_218 ; V_6 ++ ) {
V_345 = F_195 ( V_6 % F_196 () ) ;
if ( F_197 ( V_5 , & V_5 -> V_246 [ V_6 ] ,
V_317 -> V_346 , V_6 , V_347 , V_345 ) )
goto V_114;
if ( F_198 ( V_5 , & V_5 -> V_219 [ V_6 ] ,
V_317 -> V_346 , V_348 ,
V_345 , V_6 ) )
goto V_114;
}
for ( V_6 = 0 ; V_6 < V_5 -> V_216 ; V_6 ++ ) {
V_345 = F_195 ( V_6 % F_196 () ) ;
if ( F_197 ( V_5 , & V_5 -> V_217 [ V_6 ] ,
V_317 -> V_342 , V_6 , V_349 , V_345 ) )
goto V_114;
if ( F_199 ( V_5 , & V_5 -> V_16 [ V_6 ] ,
V_317 -> V_342 , V_5 -> V_343 ,
V_345 ) )
goto V_114;
}
#ifdef F_190
V_5 -> V_2 -> V_341 = F_200 ( V_5 -> V_82 -> V_2 , V_5 -> V_64 ) ;
#endif
return 0 ;
V_114:
F_18 ( V_5 , L_78 ) ;
...
F_202 ( V_2 ) ;
if ( V_5 -> V_351 )
F_203 ( V_82 -> V_2 , & V_5 -> V_352 , V_353 ) ;
F_204 ( & V_5 -> V_274 ) ;
F_204 ( & V_5 -> V_278 ) ;
F_205 ( V_82 -> V_115 ) ;
F_50 ( & V_82 -> V_126 ) ;
...
static int F_207 ( struct V_1 * V_2 , int V_356 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_5 -> V_82 ;
int V_114 = 0 ;
...
static int F_209 ( struct V_1 * V_2 , struct V_359 * V_360 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_5 -> V_82 ;
struct V_361 V_362 ;
if ( F_210 ( & V_362 , V_360 -> V_363 , sizeof( V_362 ) ) )
return - V_364 ;
if ( V_362 . V_167 )
return - V_9 ;
if ( ! ( V_82 -> V_2 -> V_130 . V_279 & V_280 ) )
...
if ( F_211 ( V_2 , V_362 , V_2 -> V_385 ) ) {
V_362 . V_365 = V_366 ;
V_362 . V_369 = V_370 ;
}
return F_212 ( V_360 -> V_363 , & V_362 ,
sizeof( V_362 ) ) ? - V_364 : 0 ;
}
static int F_213 ( struct V_1 * V_2 , struct V_359 * V_360 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
return F_212 ( V_360 -> V_363 , & V_5 -> V_361 ,
sizeof( V_5 -> V_361 ) ) ? - V_364 : 0 ;
}
static int F_214 ( struct V_1 * V_2 , struct V_359 * V_360 , int V_386 )
{
switch ( V_386 ) {
case V_387 :
return F_209 ( V_2 , V_360 ) ;
case V_388 :
return F_213 ( V_2 , V_360 ) ;
default:
return - V_389 ;
}
}
static T_6 F_215 ( struct V_1 * V_390 ,
T_6 V_385 )
{
struct V_4 * V_391 = F_2 ( V_390 ) ;
struct V_122 * V_82 = V_391 -> V_82 ;
if ( V_385 & V_392 &&
! ( V_82 -> V_2 -> V_130 . V_279 & V_393 ) )
V_385 |= V_394 ;
else
V_385 &= ~ V_394 ;
return V_385 ;
}
static int F_216 ( struct V_1 * V_390 ,
T_6 V_385 )
{
struct V_4 * V_5 = F_2 ( V_390 ) ;
bool V_395 = false ;
int V_96 = 0 ;
if ( F_217 ( V_390 , V_385 , V_396 ) ) {
F_133 ( V_5 , L_84 ,
( V_385 & V_396 ) ? L_85 : L_86 ) ;
V_395 = true ;
}
if ( F_217 ( V_390 , V_385 , V_397 ) ) {
T_1 V_398 = ( V_385 & V_397 ) ? 1 : 0 ;
F_133 ( V_5 , L_87 ,
V_398 ? L_85 : L_86 ) ;
V_96 = F_218 ( V_5 -> V_82 -> V_2 ,
V_5 -> V_64 , V_398 ) ;
if ( V_96 )
return V_96 ;
}
if ( F_217 ( V_390 , V_385 , V_392 ) ) {
F_133 ( V_5 , L_88 ,
( V_385 & V_392 ) ? L_85 : L_86 ) ;
V_395 = true ;
}
if ( F_217 ( V_390 , V_385 , V_399 ) )
F_133 ( V_5 , L_89 ,
( V_385 & V_399 ) ? L_85 : L_86 ) ;
if ( F_217 ( V_390 , V_385 , V_400 ) )
F_133 ( V_5 , L_90 ,
( V_385 & V_400 ) ? L_85 : L_86 ) ;
if ( F_217 ( V_390 , V_385 , V_401 ) ) {
F_133 ( V_5 , L_91 ,
( V_385 & V_401 ) ? L_85 : L_86 ) ;
F_219 ( V_390 , V_385 ) ;
}
if ( V_395 ) {
V_96 = F_211 ( V_390 , V_5 -> V_361 ,
V_385 ) ;
if ( V_96 )
return V_96 ;
}
...
static int F_220 ( struct V_1 * V_2 , int V_402 , T_1 * V_137 )
{
struct V_4 * V_391 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_391 -> V_82 ;
T_5 V_403 = F_66 ( V_137 ) ;
if ( ! F_84 ( V_137 ) )
return - V_9 ;
return F_221 ( V_82 -> V_2 , V_391 -> V_64 , V_402 , V_403 ) ;
}
static int F_222 ( struct V_1 * V_2 , int V_404 , T_4 V_405 , T_1 V_406 )
{
struct V_4 * V_391 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_391 -> V_82 ;
return F_223 ( V_82 -> V_2 , V_391 -> V_64 , V_404 , V_405 , V_406 ) ;
}
static int F_224 ( struct V_1 * V_2 , int V_404 , int V_407 ,
int V_408 )
{
struct V_4 * V_391 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_391 -> V_82 ;
return F_225 ( V_82 -> V_2 , V_391 -> V_64 , V_404 , V_407 ,
V_408 ) ;
}
static int F_226 ( struct V_1 * V_2 , int V_404 , bool V_409 )
{
struct V_4 * V_391 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_391 -> V_82 ;
return F_227 ( V_82 -> V_2 , V_391 -> V_64 , V_404 , V_409 ) ;
}
static int F_228 ( struct V_1 * V_2 , int V_404 , struct V_410 * V_411 )
{
struct V_4 * V_391 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_391 -> V_82 ;
return F_229 ( V_82 -> V_2 , V_391 -> V_64 , V_404 , V_411 ) ;
}
static int F_230 ( struct V_1 * V_2 , int V_404 , int V_209 )
{
struct V_4 * V_391 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_391 -> V_82 ;
return F_231 ( V_82 -> V_2 , V_391 -> V_64 , V_404 , V_209 ) ;
}
static int F_232 ( struct V_1 * V_2 , int V_404 ,
struct V_412 * V_413 )
{
struct V_4 * V_391 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_391 -> V_82 ;
return F_233 ( V_82 -> V_2 , V_391 -> V_64 , V_404 , V_413 ) ;
}
...
int V_6 ;
T_5 V_416 = V_82 -> V_130 . V_416 [ V_5 -> V_64 ] ;
if ( ! V_416 )
return - V_389 ;
V_415 -> V_417 = sizeof( V_416 ) ;
for ( V_6 = V_418 - 1 ; V_6 >= 0 ; -- V_6 ) {
V_415 -> V_37 [ V_6 ] = V_416 & 0xff ;
V_416 >>= 8 ;
}
return 0 ;
}
static void F_235 ( struct V_31 * V_32 )
{
int V_96 ;
struct V_4 * V_5 = F_6 ( V_32 , struct V_4 ,
V_419 ) ;
V_96 = F_236 ( V_5 -> V_82 -> V_2 , V_5 -> V_420 ) ;
if ( V_96 )
goto V_112;
V_96 = F_156 ( V_5 -> V_82 -> V_2 , V_5 -> V_64 ,
V_322 , 1 ) ;
V_112:
if ( V_96 ) {
F_18 ( V_5 , L_92 , V_96 ) ;
...
V_5 -> V_2 -> V_421 |= V_422 | V_423 |
V_424 | V_425 ;
V_5 -> V_2 -> V_426 |= V_425 ;
V_5 -> V_2 -> V_385 |= V_425 ;
}
static void F_237 ( struct V_31 * V_32 )
{
int V_96 ;
struct V_4 * V_5 = F_6 ( V_32 , struct V_4 ,
V_427 ) ;
...
if ( V_429 && V_429 != V_64 ) {
F_15 ( V_5 , L_93 ,
F_239 ( V_429 ) , F_239 ( V_64 ) ) ;
return;
}
V_5 -> V_420 = V_64 ;
F_37 ( V_5 -> V_82 -> V_115 , & V_5 -> V_419 ) ;
}
...
V_429 = V_5 -> V_420 ;
if ( V_429 != V_64 ) {
F_48 ( V_136 , V_5 , L_94 , F_239 ( V_64 ) ) ;
return;
}
F_37 ( V_5 -> V_82 -> V_115 , & V_5 -> V_427 ) ;
}
static T_6 F_241 ( struct V_98 * V_99 ,
struct V_1 * V_2 ,
T_6 V_385 )
{
V_385 = F_242 ( V_99 , V_385 ) ;
return F_243 ( V_99 , V_385 ) ;
}
static int F_244 ( struct V_1 * V_2 , int V_431 , T_3 V_432 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_288 * V_219 = V_5 -> V_219 [ V_431 ] ;
struct V_433 V_434 ;
int V_114 ;
if ( ! ( V_5 -> V_82 -> V_2 -> V_130 . V_279 & V_435 ) )
return - V_389 ;
if ( V_432 >> 12 ) {
V_434 . V_436 = V_437 ;
V_434 . V_438 = V_432 / 1000 ;
} else if ( V_432 ) {
V_434 . V_436 = V_439 ;
V_434 . V_438 = V_432 ;
} else {
...
V_114 = F_245 ( V_5 -> V_82 -> V_2 , V_219 -> V_71 , V_440 ,
& V_434 ) ;
return V_114 ;
}
static void F_246 ( struct V_31 * V_32 )
{
struct V_441 * V_442 = F_6 ( V_32 ,
struct V_441 ,
V_32 ) ;
int V_114 = 0 ;
struct V_138 * V_2 = V_442 -> V_5 -> V_82 -> V_2 ;
if ( V_442 -> V_443 ) {
if ( ! F_247 ( V_2 ) ) {
V_114 = F_248 ( V_2 ) ;
if ( V_114 )
...
static int F_252 ( struct V_4 * V_5 , int V_443 ,
T_1 V_447 , T_1 V_448 )
{
struct V_441 * V_442 = NULL ;
V_442 = F_24 ( sizeof( * V_442 ) , V_90 ) ;
if ( ! V_442 )
return - V_113 ;
F_25 ( & V_442 -> V_32 , F_246 ) ;
V_442 -> V_5 = V_5 ;
V_442 -> V_443 = V_443 ;
V_442 -> V_444 . V_445 = V_447 ;
V_442 -> V_444 . V_446 = V_448 ;
F_253 ( V_5 -> V_2 ) ;
F_37 ( V_5 -> V_82 -> V_115 , & V_442 -> V_32 ) ;
return 0 ;
}
int F_254 ( struct V_449 * V_450 ,
unsigned long V_451 , void * V_452 )
{
struct V_1 * V_453 = F_255 ( V_452 ) ;
T_1 V_64 = 0 ;
struct V_122 * V_82 ;
struct V_138 * V_2 ;
int V_6 , V_454 = 0 ;
...
T_1 V_456 = 0 ;
T_1 V_457 = 0 ;
if ( ! F_256 ( F_257 ( V_453 ) , & V_458 ) )
return V_459 ;
V_82 = F_6 ( V_450 , struct V_122 , V_460 ) ;
V_2 = V_82 -> V_2 ;
F_258 (i, dev, MLX4_PORT_TYPE_ETH) {
++ V_454 ;
if ( ! V_64 && ( V_82 -> V_354 [ V_6 ] == V_453 ) )
V_64 = V_6 ;
V_82 -> V_355 [ V_6 ] = V_82 -> V_354 [ V_6 ] ?
F_259 ( V_82 -> V_354 [ V_6 ] ) : NULL ;
if ( ! V_82 -> V_355 [ V_6 ] )
V_455 = false ;
if ( V_454 < 2 )
continue;
...
V_455 = ( V_454 == 2 ) ? V_455 : false ;
if ( ( V_455 && ( V_451 != V_461 ) ) || ! V_64 )
return V_459 ;
V_5 = F_2 ( V_453 ) ;
if ( V_455 ) {
struct V_462 * V_463 = V_452 ;
struct V_464 * V_465 =
& V_463 -> V_465 ;
if ( ( V_465 -> V_466 . V_467 != V_468 ) &&
( V_465 -> V_466 . V_467 != V_469 ) &&
( V_465 -> V_466 . V_467 != V_470 ) )
V_455 = false ;
if ( V_465 -> V_466 . V_471 != 2 )
V_455 = false ;
if ( V_455 ) {
if ( V_465 -> V_466 . V_467 ==
V_468 ) {
if ( V_465 -> V_472 . V_473 ==
V_474 ) {
if ( V_64 == 1 ) {
V_456 = 2 ;
V_457 = 2 ;
...
if ( ! F_261 ( V_2 ) &&
( V_2 -> V_130 . V_279 & V_484 ) ) {
F_50 ( & V_479 -> V_485 ) ;
F_262 ( V_479 -> V_486 , V_480 , V_487 ) ;
if ( V_321 )
F_263 ( V_479 -> V_486 , V_480 ,
V_488 ) ;
V_480 += V_488 ;
if ( V_320 && ! ( V_321 ) )
F_263 ( V_479 -> V_486 , V_480 ,
...
F_263 ( V_479 -> V_486 , V_480 , V_481 ) ;
}
V_480 += V_481 ;
F_263 ( V_479 -> V_486 , V_480 , V_482 ) ;
V_480 += V_482 ;
if ( F_268 ( V_2 ) )
F_263 ( V_479 -> V_486 , V_480 ,
V_483 ) ;
...
V_480 += V_487 ;
if ( ! F_261 ( V_2 ) )
F_263 ( V_479 -> V_486 , V_480 , V_497 ) ;
}
int F_269 ( struct V_122 * V_82 , int V_64 ,
struct V_344 * V_317 )
{
struct V_1 * V_2 ;
struct V_4 * V_5 ;
...
int V_114 ;
T_5 V_403 ;
V_2 = F_270 ( sizeof( struct V_4 ) ,
V_498 , V_499 ) ;
if ( V_2 == NULL )
return - V_113 ;
F_271 ( V_2 , V_317 -> V_218 ) ;
F_272 ( V_2 , V_317 -> V_216 ) ;
F_273 ( V_2 , & V_82 -> V_2 -> V_500 -> V_501 -> V_2 ) ;
V_2 -> V_502 = V_64 - 1 ;
V_5 = F_2 ( V_2 ) ;
...
F_25 ( & V_5 -> V_225 , F_185 ) ;
F_25 ( & V_5 -> V_282 , F_132 ) ;
F_275 ( & V_5 -> V_274 , F_125 ) ;
F_275 ( & V_5 -> V_278 , F_129 ) ;
#ifdef F_160
F_25 ( & V_5 -> V_419 , F_235 ) ;
F_25 ( & V_5 -> V_427 , F_237 ) ;
#endif
#ifdef F_190
F_62 ( & V_5 -> V_94 ) ;
F_274 ( & V_5 -> V_111 ) ;
...
V_5 -> V_2 = V_2 ;
V_5 -> V_82 = V_82 ;
V_5 -> V_503 = & V_82 -> V_501 -> V_2 ;
V_5 -> V_317 = V_317 ;
V_5 -> V_64 = V_64 ;
V_5 -> V_19 = false ;
V_5 -> V_167 = V_317 -> V_167 ;
V_5 -> V_504 = V_505 ;
V_5 -> V_506 = F_276 ( V_507 |
V_508 ) ;
V_5 -> V_10 = V_82 -> V_509 . V_10 ;
V_5 -> V_218 = V_317 -> V_218 ;
V_5 -> V_510 = V_511 ;
F_277 ( V_5 -> V_512 , sizeof( V_5 -> V_512 ) ) ;
V_5 -> V_219 = F_24 ( sizeof( struct V_288 * ) * V_498 ,
V_157 ) ;
if ( ! V_5 -> V_219 ) {
V_114 = - V_113 ;
goto V_112;
}
V_5 -> V_246 = F_24 ( sizeof( struct V_13 * ) * V_498 ,
V_157 ) ;
if ( ! V_5 -> V_246 ) {
V_114 = - V_113 ;
goto V_112;
}
V_5 -> V_216 = V_317 -> V_216 ;
V_5 -> V_304 = ( V_82 -> V_2 -> V_130 . V_303 == 64 ) ? 1 : 0 ;
V_5 -> V_303 = V_82 -> V_2 -> V_130 . V_303 ;
V_5 -> V_513 = - 1 ;
V_5 -> V_514 = V_515 ;
#ifdef F_278
if ( ! F_261 ( V_5 -> V_82 -> V_2 ) ) {
if ( V_82 -> V_2 -> V_130 . V_279 & V_516 ) {
V_2 -> V_517 = & V_518 ;
} else {
F_133 ( V_5 , L_98 ) ;
V_2 -> V_517 = & V_519 ;
...
for ( V_6 = 0 ; V_6 < V_165 ; ++ V_6 )
F_279 ( & V_5 -> V_161 [ V_6 ] ) ;
V_5 -> V_296 = V_82 -> V_2 -> V_130 . V_520 [ V_5 -> V_64 ] ;
if ( V_82 -> V_2 -> V_130 . V_521 [ V_5 -> V_64 ] &
V_522 )
V_5 -> V_167 |= V_523 ;
V_2 -> V_524 = V_78 ;
F_57 ( V_2 -> V_77 , V_82 -> V_2 -> V_130 . V_525 [ V_5 -> V_64 ] ) ;
if ( ! F_84 ( V_2 -> V_77 ) ) {
if ( F_261 ( V_5 -> V_82 -> V_2 ) ) {
F_280 ( V_2 ) ;
F_15 ( V_5 , L_99 , V_2 -> V_77 ) ;
V_403 = F_66 ( V_2 -> V_77 ) ;
V_82 -> V_2 -> V_130 . V_525 [ V_5 -> V_64 ] = V_403 ;
} else {
F_18 ( V_5 , L_100 ,
V_5 -> V_64 , V_2 -> V_77 ) ;
V_114 = - V_9 ;
...
V_5 -> V_343 = F_281 ( sizeof( struct V_526 ) +
V_527 * V_528 ) ;
V_114 = F_194 ( V_5 ) ;
if ( V_114 )
goto V_112;
...
V_114 = F_282 ( V_82 -> V_2 , & V_5 -> V_352 ,
V_353 , V_353 ) ;
if ( V_114 ) {
F_18 ( V_5 , L_101 ) ;
goto V_112;
...
F_272 ( V_2 , V_5 -> V_216 ) ;
V_2 -> V_534 = & V_535 ;
V_2 -> V_426 = V_536 | V_422 | V_537 ;
if ( V_82 -> V_538 )
V_2 -> V_426 |= V_424 | V_539 ;
V_2 -> V_540 = V_2 -> V_426 ;
V_2 -> V_426 |= V_423 | V_541 ;
V_2 -> V_385 = V_2 -> V_426 | V_542 |
V_399 | V_392 |
V_543 ;
V_2 -> V_426 |= V_401 |
V_399 | V_392 ;
if ( ! ( V_82 -> V_2 -> V_130 . V_279 & V_393 ) ) {
V_2 -> V_385 |= V_394 |
V_544 ;
V_2 -> V_426 |= V_394 ;
}
if ( F_261 ( V_82 -> V_2 ) ) {
int V_545 ;
V_114 = F_283 ( V_82 -> V_2 , V_64 , & V_545 ) ;
if ( ! V_114 && V_545 ) {
V_2 -> V_426 |= V_400 ;
V_5 -> V_504 |= V_546 ;
}
} else {
if ( V_82 -> V_2 -> V_130 . V_279 & V_547 &&
! ( V_82 -> V_2 -> V_130 . V_279 &
V_393 ) )
V_2 -> V_426 |= V_400 ;
}
if ( V_82 -> V_2 -> V_130 . V_167 & V_548 )
V_2 -> V_426 |= V_396 ;
if ( V_82 -> V_2 -> V_130 . V_279 & V_549 )
V_2 -> V_426 |= V_397 ;
if ( V_82 -> V_2 -> V_130 . V_139 ==
V_145 &&
...
V_2 -> V_213 |= V_214 ;
if ( V_82 -> V_2 -> V_130 . V_279 & V_551 ) {
V_5 -> V_552 = V_553 ;
} else if ( V_82 -> V_2 -> V_130 . V_279 & V_554 ) {
V_5 -> V_552 = V_555 ;
} else {
F_15 ( V_5 ,
L_102 ) ;
...
F_134 ( V_2 ) ;
F_122 ( V_5 ) ;
F_15 ( V_5 , L_103 , V_317 -> V_218 ) ;
F_15 ( V_5 , L_104 , V_317 -> V_216 ) ;
F_219 ( V_5 -> V_2 , V_5 -> V_2 -> V_385 ) ;
F_143 ( V_2 ) ;
V_114 = F_155 ( V_82 -> V_2 , V_5 -> V_64 ,
V_5 -> V_297 + V_316 ,
...
F_128 ( V_82 -> V_115 , & V_5 -> V_278 ,
V_281 ) ;
F_264 ( V_82 -> V_2 , & V_5 -> V_479 ,
V_82 -> V_509 . V_317 [ V_5 -> V_64 ] . V_321 ,
V_82 -> V_509 . V_317 [ V_5 -> V_64 ] . V_320 ,
V_82 -> V_509 . V_317 [ V_5 -> V_64 ] . V_319 ,
V_82 -> V_509 . V_317 [ V_5 -> V_64 ] . V_318 ) ;
V_114 = F_284 ( V_2 ) ;
if ( V_114 ) {
F_18 ( V_5 , L_105 , V_64 ) ;
goto V_112;
...
int V_19 = 0 ;
int V_114 = 0 ;
if ( V_5 -> V_361 . V_365 == V_556 . V_365 &&
V_5 -> V_361 . V_369 == V_556 . V_369 &&
! F_217 ( V_2 , V_385 , V_392 ) &&
! F_217 ( V_2 , V_385 , V_396 ) )
return 0 ;
if ( F_217 ( V_2 , V_385 , V_392 ) &&
( V_385 & V_392 ) &&
( V_5 -> V_361 . V_369 != V_370 ) ) {
F_15 ( V_5 , L_106 ) ;
return - V_9 ;
...
F_189 ( V_5 ) ;
F_15 ( V_5 , L_107 ,
V_556 . V_369 , ! ! ( V_385 & V_392 ) ) ;
V_5 -> V_361 . V_365 = V_556 . V_365 ;
V_5 -> V_361 . V_369 = V_556 . V_369 ;
if ( F_217 ( V_2 , V_385 , V_392 ) ) {
if ( V_385 & V_392 )
V_2 -> V_385 |= V_392 ;
...
V_2 -> V_385 &= ~ V_392 ;
} else if ( V_556 . V_369 == V_370 ) {
if ( V_2 -> V_557 & V_392 )
V_2 -> V_385 |= V_392 ;
else
V_2 -> V_385 &= ~ V_392 ;
}
if ( F_217 ( V_2 , V_385 , V_396 ) ) {
if ( V_385 & V_396 )
V_2 -> V_385 |= V_396 ;
else
V_2 -> V_385 &= ~ V_396 ;
}
if ( V_556 . V_369 != V_370 ) {
if ( V_2 -> V_385 & V_392 )
F_15 ( V_5 , L_108 ) ;
V_2 -> V_385 &= ~ V_392 ;
}
