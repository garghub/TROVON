...
{
struct V_1 * V_2 = F_41 ( V_22 , struct V_1 , V_57 ) ;
...
V_2 -> V_5 = F_81 ( V_140 -> V_145 , F_92 ( V_140 ) ) ;
if ( ! V_2 -> V_5 ) {
F_14 ( V_2 -> V_40 , L_9 ) ;
return - V_149 ;
}
V_2 -> V_36 = V_138 -> V_36 ;
V_2 -> V_6 = 2 - ( F_92 ( V_140 ) >> 12 ) ;
V_64 = 0 ;
...
static void F_95 ( struct V_62 * V_63 )
{
}
static int T_3 F_96 ( void )
{
int V_174 = 0 ;
V_174 = F_97 ( & V_175 , F_86 ) ;
return V_174 ;
}
