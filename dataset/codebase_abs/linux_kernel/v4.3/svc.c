...
F_99 ( V_162 ) ;
F_100 ( V_162 ) ;
V_168 = F_101 ( V_84 , V_162 , V_165 ) ;
F_102 ( & V_160 -> V_169 -> V_181 ) ;
if ( ! V_168 ) {
F_103 ( V_160 ) ;
return 0 ;
}
...
F_21 ( F_105 ( & V_37 -> V_182 ) != 1 ) ;
error = V_37 -> V_183 ;
F_106 ( V_37 ) ;
V_12:
F_40 ( L_21 , V_153 , error ) ;
return error ;
}
T_1 F_107 ( const struct V_83 * V_84 )
{
T_1 V_184 = V_84 -> V_169 -> V_185 -> V_186 ;
if ( V_84 -> V_95 -> V_64 < V_184 )
V_184 = V_84 -> V_95 -> V_64 ;
return V_184 ;
}
