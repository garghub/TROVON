...
if ( ! V_21 )
return - V_24 ;
V_5 = F_9 ( & V_17 -> V_19 , sizeof( * V_5 ) , V_25 ) ;
if ( ! V_5 )
return - V_26 ;
V_5 -> V_19 = V_19 ;
V_5 -> V_7 = F_10 ( & V_17 -> V_19 , L_1 , V_27 ) ;
if ( F_11 ( V_5 -> V_7 ) ) {
F_12 ( V_19 , L_2 ) ;
return F_13 ( V_5 -> V_7 ) ;
}
V_5 -> V_8 = F_14 ( V_19 , V_28 ) ;
if ( F_11 ( V_5 -> V_8 ) ) {
F_12 ( V_19 , L_3 ) ;
return - V_26 ;
}
V_23 = F_15 ( V_19 , V_5 -> V_8 ) ;
if ( V_23 < 0 ) {
F_12 ( V_19 , L_4 ) ;
return V_23 ;
}
...
V_5 -> V_14 = F_17 ( V_29 ) ;
F_18 ( & V_5 -> V_6 , F_1 ) ;
V_5 -> V_30 = F_19 ( V_5 -> V_7 ) ;
if ( V_5 -> V_30 < 0 ) {
F_12 ( V_19 , L_5 ) ;
return V_5 -> V_30 ;
}
V_23 = F_20 ( V_19 , V_5 -> V_30 , NULL ,
F_6 ,
V_31 |
V_32 | V_33 ,
V_17 -> V_34 , V_5 ) ;
...
{
struct V_4 * V_5 = F_24 ( V_17 ) ;
F_25 ( & V_5 -> V_6 ) ;
return 0 ;
}
static int F_26 ( struct V_18 * V_19 )
{
struct V_4 * V_5 = F_27 ( V_19 ) ;
int V_23 = 0 ;
if ( F_28 ( V_19 ) ) {
V_23 = F_29 ( V_5 -> V_30 ) ;
if ( V_23 )
