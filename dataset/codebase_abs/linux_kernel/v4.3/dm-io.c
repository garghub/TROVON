...
V_26 -> V_38 = F_34 ;
V_26 -> V_39 = F_36 ;
V_26 -> V_32 = ( ( unsigned long ) V_48 ) & ( V_36 - 1 ) ;
V_26 -> V_35 = V_48 ;
}
static void F_38 ( struct V_25 * V_26 , struct V_27 * * V_28 , unsigned long * V_29 ,
unsigned * V_30 )
{
* V_28 = F_39 ( V_26 -> V_35 ) ;
* V_30 = V_26 -> V_32 ;
...
static void F_41 ( struct V_25 * V_26 , void * V_48 )
{
V_26 -> V_38 = F_38 ;
V_26 -> V_39 = F_40 ;
V_26 -> V_32 = ( ( unsigned long ) V_48 ) & ( V_36 - 1 ) ;
...
static void F_42 ( int V_49 , unsigned V_12 , struct V_50 * V_51 ,
...
unsigned V_52 ;
T_2 V_53 = V_51 -> V_22 ;
struct V_54 * V_55 = F_43 ( V_51 -> V_56 ) ;
unsigned short V_57 = F_44 ( V_55 ) ;
T_2 V_58 ;
...
V_26 -> V_38 ( V_26 , & V_27 , & V_29 , & V_30 ) ;
V_29 = F_49 ( V_29 , F_50 ( V_53 ) ) ;
if ( ! F_48 ( V_10 , V_27 , V_29 , V_30 ) )
break;
V_30 = 0 ;
V_53 -= F_51 ( V_29 ) ;
V_26 -> V_39 ( V_26 ) ;
...
static void F_54 ( int V_49 , unsigned int V_75 ,
...
F_42 ( V_49 , V_77 , V_51 + V_77 , V_26 , V_11 ) ;
}
F_20 ( V_11 , 0 , 0 ) ;
}
static void F_56 ( unsigned long error , void * V_19 )
{
...
V_11 -> V_21 = V_26 -> V_21 ;
V_11 -> V_20 = V_26 -> V_20 ;
F_54 ( V_49 , V_75 , V_51 , V_26 , V_11 , 1 ) ;
F_62 ( & V_82 . V_83 ) ;
if ( V_16 )
* V_16 = V_82 . V_16 ;
return V_82 . V_16 ? - V_86 : 0 ;
}
static int F_63 ( struct V_1 * V_2 , unsigned int V_75 ,
struct V_50 * V_51 , int V_49 , struct V_25 * V_26 ,
T_1 V_17 , void * V_19 )
{
struct V_11 * V_11 ;
...
V_11 -> V_21 = V_26 -> V_21 ;
V_11 -> V_20 = V_26 -> V_20 ;
F_54 ( V_49 , V_75 , V_51 , V_26 , V_11 , 0 ) ;
return 0 ;
}
static int F_64 ( struct V_87 * V_88 , struct V_25 * V_26 ,
unsigned long V_89 )
{
V_26 -> V_21 = NULL ;
V_26 -> V_20 = 0 ;
...
int F_66 ( struct V_87 * V_88 , unsigned V_75 ,
struct V_50 * V_51 , unsigned long * V_100 )
{
int V_101 ;
struct V_25 V_26 ;
V_101 = F_64 ( V_88 , & V_26 , ( unsigned long ) V_51 -> V_22 << V_68 ) ;
if ( V_101 )
return V_101 ;
if ( ! V_88 -> V_102 . V_17 )
return V_81 ( V_88 -> V_2 , V_75 , V_51 ,
V_88 -> V_96 , & V_26 , V_100 ) ;
return F_63 ( V_88 -> V_2 , V_75 , V_51 , V_88 -> V_96 ,
