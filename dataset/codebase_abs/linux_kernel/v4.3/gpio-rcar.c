...
struct V_1 * V_2 = F_25 ( V_48 ) ;
int error ;
error = F_28 ( & V_2 -> V_27 -> V_28 ) ;
if ( error < 0 )
return error ;
error = F_29 ( V_48 -> V_4 + V_42 ) ;
if ( error )
F_30 ( & V_2 -> V_27 -> V_28 ) ;
return error ;
}
static void F_31 ( struct V_10 * V_48 , unsigned V_42 )
{
struct V_1 * V_2 = F_25 ( V_48 ) ;
F_32 ( V_48 -> V_4 + V_42 ) ;
...
static int F_33 ( struct V_10 * V_48 , unsigned V_42 )
{
F_26 ( V_48 , V_42 , false ) ;
return 0 ;
}
...
static void F_35 ( struct V_10 * V_48 , unsigned V_42 , int V_5 )
{
struct V_1 * V_2 = F_25 ( V_48 ) ;
unsigned long V_18 ;
F_13 ( & V_2 -> V_19 , V_18 ) ;
...
static int F_36 ( struct V_10 * V_48 , unsigned V_42 ,
int V_5 )
{
F_35 ( V_48 , V_42 , V_5 ) ;
F_26 ( V_48 , V_42 , true ) ;
...
{
struct V_54 * V_55 = F_38 ( & V_2 -> V_27 -> V_28 ) ;
struct V_56 * V_57 = V_2 -> V_27 -> V_28 . V_58 ;
struct V_59 args ;
int V_60 ;
if ( V_55 ) {
V_2 -> V_22 = * V_55 ;
} else if ( F_39 ( V_61 ) && V_57 ) {
...
static int F_43 ( struct V_71 * V_27 )
{
struct V_1 * V_2 ;
...
const char * V_76 = F_44 ( V_28 ) ;
int V_60 ;
V_2 = F_45 ( V_28 , sizeof( * V_2 ) , V_77 ) ;
if ( ! V_2 )
return - V_78 ;
V_2 -> V_27 = V_27 ;
F_46 ( & V_2 -> V_19 ) ;
...
return V_60 ;
F_47 ( V_27 , V_2 ) ;
V_2 -> V_38 = F_48 ( V_28 , NULL ) ;
if ( F_49 ( V_2 -> V_38 ) ) {
F_42 ( V_28 , L_5 ) ;
V_2 -> V_38 = NULL ;
}
F_50 ( V_28 ) ;
V_73 = F_51 ( V_27 , V_79 , 0 ) ;
V_39 = F_51 ( V_27 , V_80 , 0 ) ;
if ( ! V_73 || ! V_39 ) {
F_52 ( V_28 , L_6 ) ;
V_60 = - V_35 ;
goto V_81;
}
V_2 -> V_4 = F_53 ( V_28 , V_73 -> V_82 , F_54 ( V_73 ) ) ;
if ( ! V_2 -> V_4 ) {
F_52 ( V_28 , L_7 ) ;
V_60 = - V_83 ;
goto V_81;
...
V_60 = F_56 ( V_10 , V_74 , V_2 -> V_22 . V_99 ,
V_100 , V_101 ) ;
if ( V_60 ) {
F_52 ( V_28 , L_9 ) ;
goto V_102;
...
V_2 -> V_37 = V_39 -> V_82 ;
if ( F_57 ( V_28 , V_39 -> V_82 , F_21 ,
V_103 , V_76 , V_2 ) ) {
F_52 ( V_28 , L_10 ) ;
V_60 = - V_104 ;
goto V_102;
}
F_58 ( V_28 , L_11 , V_2 -> V_22 . V_68 ) ;
if ( V_2 -> V_22 . V_99 ) {
...
if ( V_2 -> V_22 . V_105 ) {
V_60 = F_59 ( V_10 , V_2 -> V_22 . V_105 , 0 ,
V_10 -> V_4 , V_10 -> V_92 ) ;
if ( V_60 < 0 )
F_42 ( V_28 , L_13 ) ;
}
