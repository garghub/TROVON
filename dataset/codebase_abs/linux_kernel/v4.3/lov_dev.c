...
static struct V_23 * F_29 ( const struct V_1 * V_2 ,
struct V_23 * V_24 )
{
struct V_26 * V_27 = F_14 ( V_24 ) ;
...
static void F_32 ( const struct V_1 * V_2 , struct V_23 * V_48 ,
T_1 V_64 )
{
...
static struct V_54 * * F_33 ( int V_56 )
{
struct V_54 * * V_65 ;
int V_25 ;
int V_51 ;
V_65 = F_34 ( V_56 , sizeof( V_65 [ 0 ] ) , V_16 ) ;
if ( V_65 == NULL )
return F_7 ( - V_19 ) ;
for ( V_51 = V_25 = 0 ; V_25 < V_56 && V_51 == 0 ; V_25 ++ ) {
struct V_54 * V_57 ;
V_57 = F_35 ( sizeof( * V_57 ) , V_16 ) ;
if ( V_57 != NULL ) {
V_65 [ V_25 ] = V_57 ;
F_36 ( & V_57 -> V_58 ) ;
V_57 -> V_60 = F_37 ( & V_57 -> V_61 ,
V_66 | V_67 ) ;
if ( ! F_21 ( V_57 -> V_60 ) )
...
static int F_38 ( const struct V_1 * V_2 , struct V_26 * V_48 )
{
int V_51 ;
T_1 V_70 ;
T_1 V_71 ;
...
static int F_41 ( const struct V_1 * V_2 , struct V_23 * V_48 ,
T_1 V_64 )
{
...
F_42 ( V_77 ) ;
V_87 = V_86 -> V_89 ;
V_34 = F_47 ( V_24 -> V_78 , V_86 , & V_64 , & V_88 ) ;
if ( V_34 == 0 ) {
switch ( V_87 ) {
case V_90 :
case V_91 :
V_34 = F_41 ( V_2 , V_24 , V_64 ) ;
if ( V_34 != 0 )
F_48 ( V_24 -> V_78 , V_64 , NULL , 0 ) ;
break;
case V_92 :
F_32 ( V_2 , V_24 , V_64 ) ;
break;
...
static struct V_23 * F_49 ( const struct V_1 * V_2 ,
struct V_93 * V_94 ,
struct V_85 * V_86 )
{
struct V_23 * V_24 ;
...
V_27 -> V_95 . V_98 = & V_99 ;
F_52 ( & V_27 -> V_75 ) ;
F_53 ( & V_27 -> V_75 , & V_100 ) ;
V_77 = F_54 ( F_55 ( V_86 , 0 ) ) ;
F_15 ( V_77 != NULL ) ;
V_34 = F_56 ( V_77 , V_86 ) ;
if ( V_34 ) {
F_29 ( V_2 , V_24 ) ;
