...
static int
F_89 ( struct V_40 * V_41 , struct V_12 * V_12 ,
T_3 V_59 )
{
struct V_187 V_89 = {
. V_41 = V_41 ,
...
static T_1 * F_90 ( struct V_12 * V_12 , int V_218 )
{
T_1 * V_219 = NULL ;
int V_2 ;
...
static T_1 * F_91 ( struct V_12 * V_12 )
{
return F_90 ( V_12 , V_96 ) ;
}
static T_1 * F_92 ( struct V_12 * V_12 )
{
return F_90 ( V_12 , V_220 ) ;
}
static unsigned int
F_93 ( const struct V_60 * V_221 )
{
...
T_1 F_95 ( const struct V_60 * V_222 )
{
T_1 V_73 ;
if ( ! V_222 -> clock )
return 0 ;
for ( V_73 = 0 ; V_73 < F_28 ( V_223 ) ; V_73 ++ ) {
const struct V_60 * V_221 = & V_223 [ V_73 ] ;
unsigned int V_224 , V_225 ;
V_224 = V_221 -> clock ;
V_225 = F_93 ( V_221 ) ;
if ( ( F_96 ( V_222 -> clock ) == F_96 ( V_224 ) ||
F_96 ( V_222 -> clock ) == F_96 ( V_225 ) ) &&
F_97 ( V_222 , V_221 ) )
return V_73 + 1 ;
}
return 0 ;
}
enum V_226 F_98 ( const T_1 V_227 )
{
return V_223 [ V_227 - 1 ] . V_228 ;
}
static unsigned int
F_99 ( const struct V_60 * V_229 )
{
if ( V_229 -> V_79 == 4096 && V_229 -> V_75 == 2160 )
return V_229 -> clock ;
return F_93 ( V_229 ) ;
}
static T_1 F_100 ( const struct V_60 * V_222 )
{
T_1 V_73 ;
if ( ! V_222 -> clock )
return 0 ;
for ( V_73 = 0 ; V_73 < F_28 ( V_230 ) ; V_73 ++ ) {
const struct V_60 * V_229 = & V_230 [ V_73 ] ;
unsigned int V_224 , V_225 ;
V_224 = V_229 -> clock ;
V_225 = F_99 ( V_229 ) ;
if ( ( F_96 ( V_222 -> clock ) == F_96 ( V_224 ) ||
...
static int
F_101 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
struct V_80 * V_52 = V_41 -> V_52 ;
struct V_60 * V_73 , * V_231 ;
F_102 ( V_232 ) ;
int V_182 = 0 ;
if ( ! F_91 ( V_12 ) )
return 0 ;
...
if ( V_224 == V_225 )
continue;
if ( V_73 -> clock != V_224 && V_73 -> clock != V_225 )
continue;
V_183 = F_39 ( V_52 , V_221 ) ;
if ( ! V_183 )
continue;
V_183 -> V_35 |= V_73 -> V_35 & V_234 ;
if ( V_73 -> clock != V_224 )
V_183 -> clock = V_224 ;
else
V_183 -> clock = V_225 ;
F_103 ( & V_183 -> V_70 , & V_232 ) ;
}
...
const T_1 * V_235 , T_1 V_236 ,
T_1 V_237 )
{
struct V_80 * V_52 = V_41 -> V_52 ;
struct V_60 * V_183 ;
T_1 V_221 ;
if ( V_235 == NULL || V_237 >= V_236 )
return NULL ;
V_221 = ( V_235 [ V_237 ] & 127 ) - 1 ;
if ( V_221 >= F_28 ( V_223 ) )
return NULL ;
V_183 = F_39 ( V_52 , & V_223 [ V_221 ] ) ;
if ( ! V_183 )
return NULL ;
V_183 -> V_72 = 0 ;
return V_183 ;
...
static int
F_106 ( struct V_40 * V_41 , const T_1 * V_238 , T_1 V_23 )
{
int V_2 , V_182 = 0 ;
for ( V_2 = 0 ; V_2 < V_23 ; V_2 ++ ) {
struct V_60 * V_73 ;
V_73 = F_105 ( V_41 , V_238 , V_23 , V_2 ) ;
if ( V_73 ) {
F_73 ( V_41 , V_73 ) ;
V_182 ++ ;
}
...
static bool
F_107 ( const struct V_60 * V_73 ,
const struct V_239 * V_240 )
{
unsigned int V_241 = V_73 -> V_35 & V_130 ;
return V_73 -> V_75 == V_240 -> V_212 &&
V_73 -> V_79 == V_240 -> V_213 &&
V_241 == ( V_240 -> V_35 & V_130 ) &&
F_35 ( V_73 ) == V_240 -> V_72 ;
}
static int F_108 ( struct V_40 * V_41 )
{
struct V_80 * V_52 = V_41 -> V_52 ;
const struct V_60 * V_73 ;
struct V_242 V_243 ;
...
F_109 ( & V_243 ) ;
F_55 (mode, &connector->probed_modes, head) {
for ( V_2 = 0 ; V_2 < F_28 ( V_244 ) ; V_2 ++ ) {
const struct V_239 * V_245 ;
struct V_60 * V_246 ;
if ( ! F_107 ( V_73 ,
& V_244 [ V_2 ] ) )
continue;
V_245 = & V_244 [ V_2 ] ;
V_246 = F_39 ( V_52 , V_73 ) ;
if ( ! V_246 )
continue;
V_246 -> V_35 |= V_245 -> V_35 ;
F_103 ( & V_246 -> V_70 , & V_243 ) ;
V_182 ++ ;
}
}
F_110 ( & V_243 , & V_41 -> V_67 ) ;
return V_182 ;
}
static int F_111 ( struct V_40 * V_41 , T_1 V_247 )
{
struct V_80 * V_52 = V_41 -> V_52 ;
struct V_60 * V_183 ;
V_247 -- ;
...
V_183 = F_39 ( V_52 , & V_230 [ V_247 ] ) ;
if ( ! V_183 )
return 0 ;
F_73 ( V_41 , V_183 ) ;
return 1 ;
}
static int F_112 ( struct V_40 * V_41 , T_5 V_248 ,
const T_1 * V_235 , T_1 V_236 , T_1 V_237 )
{
struct V_60 * V_183 ;
int V_182 = 0 ;
if ( V_248 & ( 1 << 0 ) ) {
V_183 = F_105 ( V_41 , V_235 ,
V_236 ,
V_237 ) ;
if ( V_183 ) {
V_183 -> V_35 |= V_249 ;
...
static int
F_113 ( struct V_40 * V_41 , const T_1 * V_238 , T_1 V_23 ,
const T_1 * V_235 , T_1 V_236 )
{
...
goto V_49;
V_252 ++ ;
if ( V_238 [ 8 + V_252 ] & ( 1 << 7 ) ) {
V_182 += F_108 ( V_41 ) ;
V_253 = ( V_238 [ 8 + V_252 ] & 0x60 ) >> 5 ;
}
V_252 ++ ;
V_255 = V_238 [ 8 + V_252 ] >> 5 ;
V_256 = V_238 [ 8 + V_252 ] & 0x1f ;
for ( V_2 = 0 ; V_2 < V_255 && V_23 >= ( 9 + V_252 + V_2 ) ; V_2 ++ ) {
T_1 V_247 ;
V_247 = V_238 [ 9 + V_252 + V_2 ] ;
V_182 += F_111 ( V_41 , V_247 ) ;
}
V_252 += 1 + V_255 ;
if ( V_253 == 1 )
V_254 = 2 ;
...
goto V_49;
if ( V_253 == 1 || V_253 == 2 ) {
V_258 = ( V_238 [ 8 + V_252 ] << 8 ) | V_238 [ 9 + V_252 ] ;
if ( V_253 == 2 )
V_257 = ( V_238 [ 10 + V_252 ] << 8 ) | V_238 [ 11 + V_252 ] ;
else
V_257 = 0xffff ;
...
bool V_261 ;
V_261 = ( ( V_238 [ 8 + V_252 + V_2 ] & 0x0f ) > 7 ) ;
if ( V_261 && ( V_2 + 1 == V_256 - V_254 ) )
break;
V_259 = V_238 [ 8 + V_252 + V_2 ] >> 4 ;
switch ( V_238 [ 8 + V_252 + V_2 ] & 0x0f ) {
case 0 :
V_260 = V_249 ;
break;
case 6 :
...
static int
F_114 ( const T_1 * V_238 )
{
return V_238 [ 0 ] & 0x1f ;
}
static int
F_115 ( const T_1 * V_238 )
{
return V_238 [ 0 ] >> 5 ;
}
static int
F_116 ( const T_1 * V_262 )
{
return V_262 [ 1 ] ;
}
static int
F_117 ( const T_1 * V_262 , int * V_26 , int * V_263 )
{
* V_26 = 4 ;
* V_263 = V_262 [ 2 ] ;
if ( * V_263 == 0 )
...
static bool F_118 ( const T_1 * V_238 )
{
int V_265 ;
if ( F_115 ( V_238 ) != V_266 )
return false ;
if ( F_114 ( V_238 ) < 5 )
return false ;
V_265 = V_238 [ 1 ] | ( V_238 [ 2 ] << 8 ) | ( V_238 [ 3 ] << 16 ) ;
return V_265 == V_267 ;
}
static int
F_119 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
const T_1 * V_262 = F_91 ( V_12 ) ;
const T_1 * V_238 , * V_268 = NULL , * V_269 = NULL ;
T_1 V_270 , V_271 , V_236 = 0 ;
int V_182 = 0 ;
if ( V_262 && F_116 ( V_262 ) >= 3 ) {
int V_2 , V_26 , V_263 ;
if ( F_117 ( V_262 , & V_26 , & V_263 ) )
return 0 ;
F_120 (cea, i, start, end) {
V_238 = & V_262 [ V_2 ] ;
V_270 = F_114 ( V_238 ) ;
if ( F_115 ( V_238 ) == V_272 ) {
V_269 = V_238 + 1 ;
V_236 = V_270 ;
V_182 += F_106 ( V_41 , V_269 , V_270 ) ;
}
else if ( F_118 ( V_238 ) ) {
V_268 = V_238 ;
V_271 = V_270 ;
...
if ( V_268 )
V_182 += F_113 ( V_41 , V_268 , V_271 , V_269 ,
V_236 ) ;
return V_182 ;
}
static void
F_121 ( struct V_40 * V_41 , const T_1 * V_238 )
{
T_1 V_23 = F_114 ( V_238 ) ;
if ( V_23 >= 6 ) {
V_41 -> V_273 [ 5 ] |= ( V_238 [ 6 ] >> 7 ) << 1 ;
V_41 -> V_274 = V_238 [ 6 ] & 1 ;
}
if ( V_23 >= 7 )
V_41 -> V_275 = V_238 [ 7 ] * 5 ;
if ( V_23 >= 8 ) {
V_41 -> V_276 [ 0 ] = V_238 [ 8 ] >> 7 ;
V_41 -> V_276 [ 1 ] = ( V_238 [ 8 ] >> 6 ) & 1 ;
}
if ( V_23 >= 9 )
V_41 -> V_277 [ 0 ] = V_238 [ 9 ] ;
if ( V_23 >= 10 )
V_41 -> V_278 [ 0 ] = V_238 [ 10 ] ;
if ( V_23 >= 11 )
V_41 -> V_277 [ 1 ] = V_238 [ 11 ] ;
if ( V_23 >= 12 )
V_41 -> V_278 [ 1 ] = V_238 [ 12 ] ;
F_14 ( L_16
L_17
L_18
L_19
...
static void
F_122 ( struct V_93 * V_61 , void * V_21 )
{
if ( V_61 -> V_21 . V_189 . type == V_279 )
* ( T_1 * * ) V_21 = V_61 -> V_21 . V_189 . V_21 . V_280 . V_280 ;
}
void F_123 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
...
V_281 = V_270 / 3 ;
if ( V_270 >= 1 )
memcpy ( V_273 + 20 + V_282 , & V_238 [ 1 ] , V_270 ) ;
break;
case V_285 :
if ( V_270 >= 1 )
V_273 [ 7 ] = V_238 [ 1 ] ;
...
int F_126 ( struct V_12 * V_12 , struct V_287 * * V_288 )
{
int V_289 = 0 ;
...
F_120 (cea, i, start, end) {
T_1 * V_238 = & V_262 [ V_2 ] ;
if ( F_115 ( V_238 ) == V_284 ) {
int V_42 ;
V_270 = F_114 ( V_238 ) ;
V_289 = V_270 / 3 ;
* V_288 = F_127 ( V_289 , sizeof( * * V_288 ) , V_48 ) ;
if ( ! * V_288 )
return - V_293 ;
for ( V_42 = 0 ; V_42 < V_289 ; V_42 ++ ) {
T_1 * V_294 = & V_238 [ 1 + V_42 * 3 ] ;
...
int F_128 ( struct V_12 * V_12 , T_1 * * V_299 )
{
int V_289 = 0 ;
int V_2 , V_26 , V_263 , V_270 ;
const T_1 * V_262 ;
...
F_120 (cea, i, start, end) {
const T_1 * V_238 = & V_262 [ V_2 ] ;
if ( F_115 ( V_238 ) == V_285 ) {
V_270 = F_114 ( V_238 ) ;
if ( V_270 == 3 ) {
* V_299 = F_25 ( & V_238 [ 1 ] , V_270 , V_48 ) ;
if ( ! * V_299 )
return - V_293 ;
V_289 = V_270 ;
break;
...
return F_130 ( V_300 - V_108 , 0 ) ;
}
struct V_40 * F_131 ( struct V_301 * V_302 ,
struct V_60 * V_73 )
{
struct V_40 * V_41 ;
struct V_80 * V_52 = V_302 -> V_52 ;
F_6 ( ! F_132 ( & V_52 -> V_303 . V_304 ) ) ;
F_6 ( ! F_133 ( & V_52 -> V_303 . V_305 ) ) ;
F_134 (connector, dev)
if ( V_41 -> V_302 == V_302 && V_41 -> V_273 [ 0 ] )
return V_41 ;
return NULL ;
}
bool F_135 ( struct V_12 * V_12 )
{
T_1 * V_219 ;
int V_2 ;
int V_306 , V_307 ;
...
goto V_263;
F_120 (edid_ext, i, start_offset, end_offset) {
if ( F_115 ( & V_219 [ V_2 ] ) == V_284 ) {
V_308 = true ;
for ( V_42 = 1 ; V_42 < F_114 ( & V_219 [ V_2 ] ) + 1 ; V_42 += 3 )
F_14 ( L_28 ,
...
if ( ! V_219 )
return false ;
if ( F_117 ( V_219 , & V_26 , & V_263 ) )
return false ;
F_120 (edid_ext, i, start, end) {
if ( F_115 ( & V_219 [ V_2 ] ) == V_310 &&
F_114 ( & V_219 [ V_2 ] ) == 2 ) {
F_14 ( L_29 , V_219 [ V_2 + 2 ] ) ;
return V_219 [ V_2 + 2 ] & V_311 ;
}
}
return false ;
}
static bool F_138 ( struct V_12 * V_12 ,
struct V_312 * V_313 ,
struct V_40 * V_41 )
{
T_1 * V_219 , * V_268 ;
...
static void F_139 ( struct V_12 * V_12 ,
struct V_312 * V_313 ,
struct V_40 * V_41 )
{
T_1 * V_219 ;
...
int F_140 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
int V_338 = 0 ;
T_3 V_59 ;
if ( V_12 == NULL ) {
...
if ( ! F_11 ( V_12 ) ) {
F_19 ( V_41 -> V_52 -> V_52 , L_38 ,
V_41 -> V_39 ) ;
return 0 ;
}
V_59 = F_27 ( V_12 ) ;
V_338 += F_89 ( V_41 , V_12 , V_59 ) ;
V_338 += F_87 ( V_41 , V_12 ) ;
V_338 += F_84 ( V_41 , V_12 ) ;
V_338 += F_82 ( V_41 , V_12 ) ;
V_338 += F_119 ( V_41 , V_12 ) ;
V_338 += F_101 ( V_41 , V_12 ) ;
if ( V_12 -> V_102 & V_103 )
V_338 += F_79 ( V_41 , V_12 ) ;
if ( V_59 & ( V_68 | V_69 ) )
F_30 ( V_41 , V_59 ) ;
F_139 ( V_12 , & V_41 -> V_339 , V_41 ) ;
if ( V_59 & V_340 )
V_41 -> V_339 . V_315 = 8 ;
if ( V_59 & V_341 )
V_41 -> V_339 . V_315 = 12 ;
...
if ( V_73 -> V_35 & V_348 )
V_345 -> V_349 = 1 ;
V_345 -> V_227 = F_95 ( V_73 ) ;
V_345 -> V_350 = V_351 ;
if ( V_73 -> V_228 == V_352 ||
V_73 -> V_228 == V_353 )
V_345 -> V_350 = V_73 -> V_228 ;
else if ( V_345 -> V_227 > 0 )
V_345 -> V_350 = F_98 (
V_345 -> V_227 ) ;
V_345 -> V_354 = V_355 ;
V_345 -> V_356 = V_357 ;
...
static enum V_358
F_145 ( const struct V_60 * V_73 )
{
T_3 V_359 = V_73 -> V_35 & V_234 ;
switch ( V_359 ) {
case V_249 :
return V_360 ;
case V_361 :
...
V_345 -> V_376 = F_145 ( V_73 ) ;
return 0 ;
}
static int F_148 ( struct V_40 * V_41 ,
T_1 * V_377 , int V_8 ,
bool V_378 )
{
int V_379 = 0 ;
...
V_41 -> V_403 = V_123 + 1 ;
V_41 -> V_404 = V_124 + 1 ;
F_14 ( L_42 , V_391 -> V_401 ) ;
F_14 ( L_43 , V_123 + 1 , V_124 + 1 ) ;
F_14 ( L_44 ,
V_395 + 1 , V_394 + 1 , V_393 , V_392 ) ;
F_14 ( L_45 , V_391 -> V_405 [ 0 ] , V_391 -> V_405 [ 1 ] , V_391 -> V_405 [ 2 ] ) ;
V_397 = F_149 ( V_41 -> V_52 , V_391 -> V_405 ) ;
if ( ! V_397 ) {
V_397 = F_150 ( V_41 -> V_52 , V_391 -> V_405 ) ;
}
if ( ! V_397 )
return - V_293 ;
if ( V_41 -> V_406 != V_397 ) {
if ( V_41 -> V_406 ) {
F_151 ( V_41 -> V_52 , V_41 -> V_406 ) ;
}
V_41 -> V_406 = V_397 ;
} else
F_151 ( V_41 -> V_52 , V_397 ) ;
}
break;
default:
F_9 ( L_46 , V_9 -> V_387 ) ;
...
V_29 = F_148 ( V_41 , V_377 , V_6 , true ) ;
if ( V_29 < 0 )
goto V_407;
if ( ! V_41 -> V_400 )
goto V_407;
