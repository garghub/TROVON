...
if ( V_86 != V_15 )
continue;
V_70 = F_50 ( & V_72 [ V_15 ] -> V_2 . V_73 ,
& V_79 -> V_2 . V_73 ,
F_36 ( & V_79 -> V_2 . V_73 ) ) ;
if ( V_70 )
return V_70 ;
return F_50 ( & V_79 -> V_2 . V_73 ,
& V_72 [ V_15 ] -> V_2 . V_73 ,
F_36 ( & V_72 [ V_15 ] -> V_2 . V_73 ) ) ;
}
return 0 ;
}
int F_51 ( struct V_78 * V_79 ,
unsigned long V_87 )
{
F_52 ( V_88 , V_89 , V_90 ) ;
unsigned long V_74 , V_80 , V_81 ;
...
static int F_56 ( int V_15 )
{
unsigned long V_92 = F_57 ( V_15 ) -> V_93 ;
unsigned long V_94 = V_92 + F_57 ( V_15 ) -> V_95 ;
unsigned long V_74 ;
struct V_78 * V_79 = NULL ;
int V_96 = 0 ;
for ( V_74 = V_92 ; V_74 < V_94 ; V_74 += V_85 ) {
unsigned long V_97 = F_58 ( V_74 ) ;
struct V_98 * V_99 ;
int V_70 ;
if ( ! F_59 ( V_97 ) )
continue;
...
static void F_63 ( struct V_100 * V_101 )
{
struct V_5 * V_5 = F_64 ( V_101 , struct V_5 , V_61 ) ;
if ( ! F_19 ( V_5 ) )
F_21 ( V_5 ) ;
}
static void F_65 ( int V_15 )
{
F_66 ( & V_72 [ V_15 ] -> V_61 , F_63 ) ;
}
...
static int F_56 ( int V_15 ) { return 0 ; }
static inline int F_67 ( struct V_102 * V_103 ,
unsigned long V_104 , void * V_105 )
{
return V_116 ;
}
...
if ( V_117 != V_15 )
V_63 = V_72 [ V_117 ] ;
V_72 [ V_15 ] = F_71 ( sizeof( struct V_5 ) , V_90 ) ;
if ( ! V_72 [ V_15 ] )
return - V_91 ;
...
static T_1 F_75 ( enum V_118 V_119 , char * V_4 )
{
int V_14 ;
V_14 = F_76 ( V_4 , V_11 - 1 , L_42 ,
F_77 ( & V_118 [ V_119 ] ) ) ;
V_4 [ V_14 ++ ] = '\n' ;
V_4 [ V_14 ] = '\0' ;
return V_14 ;
...
struct V_12 * V_13 , char * V_4 )
{
struct V_120 * V_121 = F_64 ( V_13 , struct V_120 , V_13 ) ;
return F_75 ( V_121 -> V_119 , V_4 ) ;
}
static int T_4 F_79 ( void )
{
int V_70 ;
F_4 ( F_80 ( V_122 ) != V_123 ) ;
F_4 ( F_80 ( V_124 ) - 1 != V_123 ) ;
V_70 = F_81 ( & V_65 , V_125 ) ;
if ( ! V_70 ) {
