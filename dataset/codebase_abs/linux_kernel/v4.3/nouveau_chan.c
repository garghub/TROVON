...
T_1 V_11 , T_1 V_27 , struct V_1 * * V_14 )
{
...
T_1 V_11 , T_1 V_66 , struct V_1 * * V_14 )
{
static const T_2 V_67 [] = { V_68 ,
V_69 ,
V_70 ,
V_71 ,
V_72 ,
...
T_1 V_27 ;
int V_9 ;
V_9 = F_16 ( V_15 , V_26 , V_11 , 0x12000 , & V_2 ) ;
* V_14 = V_2 ;
if ( V_9 )
return V_9 ;
do {
...
args . V_79 . V_80 = 0 ;
args . V_79 . V_66 = V_66 ;
args . V_79 . V_81 = 0x02000 ;
args . V_79 . V_82 = 0x10000 + V_2 -> V_19 . V_22 . V_40 ;
args . V_79 . V_45 = 0 ;
V_27 = sizeof( args . V_79 ) ;
} else
if ( V_73 [ 0 ] >= V_70 ) {
args . V_77 . V_80 = 0 ;
args . V_77 . V_81 = 0x02000 ;
args . V_77 . V_82 = 0x10000 + V_2 -> V_19 . V_22 . V_40 ;
args . V_77 . V_45 = 0 ;
V_27 = sizeof( args . V_77 ) ;
} else {
args . V_75 . V_80 = 0 ;
args . V_75 . V_81 = 0x02000 ;
args . V_75 . V_82 = 0x10000 + V_2 -> V_19 . V_22 . V_40 ;
args . V_75 . V_83 = F_26 ( & V_2 -> V_19 . V_20 ) ;
args . V_75 . V_45 = 0 ;
V_27 = sizeof( args . V_75 ) ;
}
V_9 = F_24 ( & V_26 -> V_28 , V_11 , * V_73 ++ ,
& args , V_27 , & V_2 -> V_6 ) ;
if ( V_9 == 0 ) {
if ( V_2 -> V_6 . V_73 >= V_69 )
V_2 -> V_84 = args . V_79 . V_84 ;
else
if ( V_2 -> V_6 . V_73 >= V_70 )
V_2 -> V_84 = args . V_77 . V_84 ;
else
V_2 -> V_84 = args . V_75 . V_84 ;
return V_9 ;
}
} while ( * V_73 );
F_8 ( V_14 ) ;
...
T_1 V_11 , struct V_1 * * V_14 )
{
static const T_2 V_67 [] = { V_85 ,
V_86 ,
V_87 ,
V_88 ,
0 } ;
...
struct V_1 * V_2 ;
int V_9 ;
V_9 = F_16 ( V_15 , V_26 , V_11 , 0x10000 , & V_2 ) ;
* V_14 = V_2 ;
if ( V_9 )
return V_9 ;
args . V_80 = 0 ;
args . V_83 = F_26 ( & V_2 -> V_19 . V_20 ) ;
...
T_1 V_11 , T_1 V_108 , T_1 V_109 ,
struct V_1 * * V_14 )
{
struct V_4 * V_5 = ( void * ) V_26 -> V_28 . V_7 ;
bool V_110 ;
int V_9 ;
V_110 = V_5 -> V_12 . V_110 ;
V_5 -> V_12 . V_110 = true ;
V_9 = F_25 ( V_15 , V_26 , V_11 , V_108 , V_14 ) ;
if ( V_9 ) {
F_6 ( V_111 , V_5 , L_3 , V_9 ) ;
V_9 = F_27 ( V_15 , V_26 , V_11 , V_14 ) ;
if ( V_9 ) {
F_6 ( V_111 , V_5 , L_4 , V_9 ) ;
goto V_112;
}
}
V_9 = F_28 ( * V_14 , V_108 , V_109 ) ;
if ( V_9 ) {
F_6 ( V_10 , V_5 , L_5 , V_9 ) ;
F_8 ( V_14 ) ;
}
V_112:
V_5 -> V_12 . V_110 = V_110 ;
return V_9 ;
}
