...
struct V_10 * V_11 ;
unsigned long * V_42 ;
V_42 = F_53 ( F_54 ( V_43 ) , sizeof( unsigned long ) ,
V_44 ) ;
if ( ! V_42 )
return - V_45 ;
F_55 ( 0 , V_42 ) ;
...
static struct V_10 * F_57 ( struct V_12 * V_13 ,
struct V_1 * V_2 )
{
int V_41 ;
struct V_10 * V_11 ;
...
int F_65 ( struct V_52 * V_52 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_53 ;
V_2 = F_66 ( sizeof( struct V_12 ) , V_9 , V_54 ,
V_55 ) ;
if ( ! V_2 )
return - V_45 ;
F_67 ( V_2 , V_52 ) ;
...
int F_70 ( struct V_52 * V_52 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_58 = 0 ;
F_71 () ;
...
int F_74 ( const struct V_12 * V_13 )
{
...
int F_80 ( struct V_12 * V_13 , struct V_1 * V_2 )
{
struct V_10 * V_11 ;
int V_20 = 0 ;
bool V_70 ;
...
if ( V_20 )
goto V_84;
V_20 = F_87 ( & V_11 -> V_29 , & V_85 , & ( V_2 -> V_2 . V_29 ) ,
V_86 ) ;
if ( V_20 )
goto V_87;
V_20 = F_88 ( V_11 ) ;
...
if ( V_20 )
goto V_89;
V_20 = F_90 ( V_2 , V_90 , V_11 ) ;
if ( V_20 )
goto V_91;
V_2 -> V_22 |= V_36 ;
V_20 = F_91 ( V_2 , V_13 -> V_2 ) ;
if ( V_20 )
goto V_92;
F_92 ( V_2 ) ;
F_93 ( & V_11 -> V_35 , & V_13 -> V_65 ) ;
F_21 ( V_13 ) ;
F_94 ( V_13 -> V_2 ) ;
if ( V_13 -> V_2 -> V_93 < V_2 -> V_93 )
V_13 -> V_2 -> V_93 = V_2 -> V_93 ;
if ( F_95 ( V_13 , V_11 , V_2 -> V_75 , 0 ) )
F_96 ( V_2 , L_3 ) ;
if ( F_97 ( V_11 ) )
F_96 ( V_2 , L_4 ) ;
F_7 ( & V_13 -> V_17 ) ;
...
int F_100 ( struct V_12 * V_13 , struct V_1 * V_2 )
{
struct V_10 * V_11 ;
bool V_70 ;
V_11 = F_101 ( V_2 ) ;
...
void F_102 ( struct V_10 * V_11 , unsigned long V_68 )
{
struct V_12 * V_13 = V_11 -> V_13 ;
if ( V_68 & V_97 )
F_21 ( V_13 ) ;
