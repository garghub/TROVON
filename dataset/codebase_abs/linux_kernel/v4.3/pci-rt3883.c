...
static int F_29 ( struct V_2 * V_3 , unsigned int V_42 ,
...
static int F_32 ( struct V_2 * V_3 , unsigned int V_42 ,
int V_13 , int V_43 , T_1 V_10 )
{
struct V_1 * V_7 ;
unsigned long V_14 ;
...
static void F_33 ( struct V_1 * V_7 , unsigned V_49 )
{
T_1 V_50 ;
T_1 V_51 ;
T_1 V_52 ;
...
int V_78 ;
int V_49 ;
V_7 = F_39 ( V_36 , sizeof( * V_7 ) , V_79 ) ;
if ( ! V_7 )
return - V_80 ;
V_76 = F_40 ( V_71 , V_81 , 0 ) ;
V_7 -> V_9 = F_41 ( V_36 , V_76 ) ;
if ( F_42 ( V_7 -> V_9 ) )
return F_43 ( V_7 -> V_9 ) ;
F_44 (np, child) {
if ( F_45 ( V_77 , L_3 , NULL ) &&
F_46 ( V_77 ) ) {
V_7 -> V_37 = V_77 ;
break;
}
...
V_49 = V_83 ;
F_48 (rpc->pci_controller.of_node, child) {
int V_42 ;
if ( ! V_77 -> type ||
F_47 ( V_77 -> type , L_6 ) != 0 )
continue;
...
F_5 ( V_7 , 0x03ff0000 , F_52 ( 0 ) ) ;
F_5 ( V_7 , V_96 , F_53 ( 0 ) ) ;
F_5 ( V_7 , 0x08021814 , F_54 ( 0 ) ) ;
F_5 ( V_7 , 0x00800001 , F_55 ( 0 ) ) ;
F_5 ( V_7 , 0x28801814 , F_56 ( 0 ) ) ;
F_5 ( V_7 , 0x03ff0000 , F_52 ( 1 ) ) ;
F_5 ( V_7 , V_96 , F_53 ( 1 ) ) ;
F_5 ( V_7 , 0x08021814 , F_54 ( 1 ) ) ;
F_5 ( V_7 , 0x06040001 , F_55 ( 1 ) ) ;
F_5 ( V_7 , 0x28801814 , F_56 ( 1 ) ) ;
V_78 = F_23 ( V_36 , V_7 ) ;
if ( V_78 )
goto V_84;
...
if ( V_49 == V_56 ) {
F_5 ( V_7 , 0x03ff0001 , F_52 ( 0 ) ) ;
F_5 ( V_7 , 0x03ff0001 , F_52 ( 1 ) ) ;
F_9 ( V_7 , 0 , V_66 , 0 ,
V_101 ,
V_96 ) ;
F_8 ( V_7 , 0 , V_66 , 0 ,
...
int T_3 F_59 ( const struct V_103 * V_36 , T_4 V_11 , T_4 V_104 )
{
return F_60 ( V_36 , V_11 , V_104 ) ;
}
int F_61 ( struct V_103 * V_36 )
{
return 0 ;
}
