...
F_134 ( & V_6 -> V_6 , V_220 ) ;
if ( V_59 == 0 ) {
V_6 -> V_6 . V_221 . V_222 = true ;
} else {
V_6 -> V_6 . V_221 . V_223 = true ;
V_6 -> V_6 . V_221 . V_224 = true ;
V_6 -> V_6 . V_221 . V_225 = true ;
}
V_6 -> V_6 . V_221 . V_23 = true ;
V_6 -> V_6 . V_221 . V_226 = true ;
}
F_134 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_227 ) ;
V_1 -> V_6 [ 0 ] -> V_9 = 0 ;
