...
static void F_107 ( struct V_39 * V_5 , int V_247 )
{
struct V_6 * V_7 = F_56 ( V_5 , struct V_6 , V_5 ) ;
struct V_1 * V_2 = V_7 -> V_1 ;
if ( V_247 )
...
static void F_111 ( struct V_253 * V_254 , struct V_229 * V_230 , int V_255 )
{
...
static int F_117 ( struct V_253 * V_254 , void * V_261 )
{
...
F_111 ( V_254 , V_230 , V_255 ) ;
return 0 ;
}
static int F_118 ( struct V_266 * V_266 , struct V_227 * V_227 )
{
return F_119 ( V_227 , F_117 , F_120 ( V_266 ) ) ;
}
void F_121 ( struct V_1 * V_5 , const char * V_267 ,
unsigned int V_86 ,
...
struct V_1 * T_5
F_122 ( struct V_1 * V_268 , int V_265 , struct V_269 * V_270 )
{
...
int F_123 ( char * V_273 , unsigned char * V_111 , unsigned long * V_274 ,
char * * V_275 )
{
...
* V_111 = V_276 ;
V_273 += 7 ;
} else if ( strncmp ( V_273 , L_26 , 9 ) == 0 ) {
* V_111 = V_277 ;
V_273 += 9 ;
} else if ( strncmp ( V_273 , L_27 , 3 ) == 0 ) {
* V_111 = V_278 ;
V_273 += 3 ;
} else if ( strncmp ( V_273 , L_28 , 2 ) == 0 ) {
* V_111 = V_260 ;
} else {
return - V_132 ;
}
* V_274 = F_124 ( V_273 , NULL , 0 ) ;
V_273 = strchr ( V_273 , ',' ) ;
if ( V_273 )
V_273 ++ ;
* V_275 = V_273 ;
...
void
F_125 ( char * V_275 , int * V_45 , int * V_184 , int * V_46 , int * V_279 )
{
char * V_267 = V_275 ;
* V_45 = F_124 ( V_267 , NULL , 10 ) ;
...
int
F_126 ( struct V_1 * V_5 , struct V_269 * V_270 ,
int V_45 , int V_184 , int V_46 , int V_279 )
{
struct V_56 V_33 ;
static struct V_56 V_280 ;
int V_255 ;
if ( ! ( F_16 ( V_5 ) && ( V_5 -> V_31 -> V_11 & V_281 ) ) ) {
F_127 ( & V_5 -> V_12 ) ;
F_128 ( & V_5 -> V_12 , & V_282 ) ;
}
memset ( & V_33 , 0 , sizeof( struct V_56 ) ) ;
V_33 . V_34 = V_283 | V_43 | V_76 ;
for ( V_255 = 0 ; V_284 [ V_255 ] . V_285 ; V_255 ++ )
if ( V_284 [ V_255 ] . V_285 <= V_45 )
break;
V_33 . V_34 |= V_284 [ V_255 ] . V_32 ;
if ( V_46 == 7 )
V_33 . V_34 |= V_50 ;
else
V_33 . V_34 |= V_286 ;
...
if ( V_7 -> V_257 != V_257 ) {
if ( V_5 -> V_13 -> V_288 )
V_5 -> V_13 -> V_288 ( V_5 , V_257 , V_7 -> V_257 ) ;
V_7 -> V_257 = V_257 ;
}
}
static int F_129 ( struct V_289 * V_145 , void * V_290 )
{
struct V_291 * V_292 = V_290 ;
struct V_262 * V_293 = V_292 -> V_231 -> V_262 ;
T_6 V_294 = F_130 ( V_293 -> V_295 , V_293 -> V_296 ) +
V_292 -> V_5 -> line ;
return V_145 -> V_294 == V_294 ;
}
int F_131 ( struct V_229 * V_230 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_230 -> V_7 + V_2 -> line ;
struct V_39 * V_5 = & V_7 -> V_5 ;
struct V_289 * V_297 ;
struct V_291 V_292 = { V_2 , V_230 } ;
F_59 ( & V_5 -> V_116 ) ;
V_297 = F_132 ( V_2 -> V_145 , & V_292 , F_129 ) ;
if ( F_133 ( V_297 ) ) {
if ( ! F_134 ( V_2 -> V_103 ) )
V_2 -> V_298 = 1 ;
F_135 ( V_297 ) ;
...
V_2 -> V_301 = 1 ;
if ( V_5 -> V_11 & V_40 ) {
const struct V_302 * V_13 = V_2 -> V_13 ;
int V_303 ;
F_21 ( V_44 , & V_5 -> V_11 ) ;
F_22 ( V_42 , & V_5 -> V_11 ) ;
F_35 ( & V_2 -> V_12 ) ;
...
V_13 -> V_233 ( V_2 ) ;
F_37 ( & V_2 -> V_12 ) ;
for ( V_303 = 3 ; ! V_13 -> V_152 ( V_2 ) && V_303 ; V_303 -- )
F_136 ( 10 ) ;
if ( ! V_303 )
F_137 ( V_2 -> V_145 , L_29 ,
V_230 -> V_304 ,
V_230 -> V_262 -> V_305 + V_2 -> line ) ;
V_13 -> V_245 ( V_2 ) ;
}
if ( F_16 ( V_2 ) )
F_138 ( V_2 -> V_31 ) ;
...
int F_139 ( struct V_229 * V_230 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_230 -> V_7 + V_2 -> line ;
struct V_39 * V_5 = & V_7 -> V_5 ;
struct V_289 * V_297 ;
...
static inline void
F_142 ( struct V_229 * V_230 , struct V_1 * V_5 )
{
char V_307 [ 64 ] ;
switch ( V_5 -> V_111 ) {
case V_278 :
snprintf ( V_307 , sizeof( V_307 ) , L_30 , V_5 -> V_100 ) ;
break;
case V_308 :
snprintf ( V_307 , sizeof( V_307 ) ,
L_31 , V_5 -> V_100 , V_5 -> V_109 ) ;
break;
case V_260 :
case V_276 :
case V_277 :
...
case V_310 :
snprintf ( V_307 , sizeof( V_307 ) ,
L_32 , ( unsigned long long ) V_5 -> V_115 ) ;
break;
default:
F_143 ( V_307 , L_33 , sizeof( V_307 ) ) ;
break;
}
F_144 ( V_311 L_34 ,
V_5 -> V_145 ? V_304 ( V_5 -> V_145 ) : L_23 ,
V_5 -> V_145 ? L_35 : L_23 ,
V_230 -> V_304 ,
V_230 -> V_262 -> V_305 + V_5 -> line ,
V_307 , V_5 -> V_103 , V_5 -> V_70 / 16 , F_110 ( V_5 ) ) ;
}
static void
F_145 ( struct V_229 * V_230 , struct V_6 * V_7 ,
struct V_1 * V_5 )
{
unsigned int V_11 ;
...
F_7 ( & V_5 -> V_12 , V_11 ) ;
if ( V_5 -> V_31 && ! ( V_5 -> V_31 -> V_11 & V_281 ) )
F_146 ( V_5 -> V_31 ) ;
if ( ! F_16 ( V_5 ) )
F_13 ( V_7 , V_235 ) ;
}
}
static int F_147 ( struct V_262 * V_231 , int line , char * V_275 )
{
...
if ( V_275 ) {
F_125 ( V_275 , & V_45 , & V_184 , & V_46 , & V_279 ) ;
return F_126 ( V_5 , NULL , V_45 , V_184 , V_46 , V_279 ) ;
}
return 0 ;
}
static int F_148 ( struct V_262 * V_231 , int line )
{
struct V_229 * V_230 = V_231 -> V_232 ;
struct V_6 * V_7 = V_230 -> V_7 + line ;
struct V_1 * V_5 ;
...
static void F_149 ( struct V_262 * V_231 , int line , char V_85 )
{
struct V_229 * V_230 = V_231 -> V_232 ;
struct V_6 * V_7 = V_230 -> V_7 + line ;
struct V_1 * V_5 ;
...
int V_255 , V_23 ;
F_3 ( V_230 -> V_7 ) ;
V_230 -> V_7 = F_151 ( sizeof( struct V_6 ) * V_230 -> V_265 , V_28 ) ;
if ( ! V_230 -> V_7 )
goto V_201;
V_318 = F_152 ( V_230 -> V_265 ) ;
if ( ! V_318 )
goto V_319;
V_230 -> V_262 = V_318 ;
V_318 -> V_320 = V_230 -> V_320 ;
V_318 -> V_321 = V_230 -> V_304 ;
V_318 -> V_295 = V_230 -> V_295 ;
V_318 -> V_296 = V_230 -> V_322 ;
V_318 -> type = V_323 ;
V_318 -> V_324 = V_325 ;
V_318 -> V_326 = V_327 ;
V_318 -> V_326 . V_34 = V_328 | V_286 | V_283 | V_43 | V_76 ;
...
struct V_262 * F_161 ( struct V_269 * V_270 , int * V_89 )
{
struct V_229 * V_273 = V_270 -> V_290 ;
* V_89 = V_270 -> V_89 ;
return V_273 -> V_262 ;
}
static T_7 F_162 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . V_105 * 16 ) ;
}
static T_7 F_164 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . type ) ;
}
static T_7 F_165 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . line ) ;
}
static T_7 F_166 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
...
return snprintf ( V_27 , V_334 , L_37 , V_335 ) ;
}
static T_7 F_167 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . V_103 ) ;
}
static T_7 F_168 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_38 , V_117 . V_11 ) ;
}
static T_7 F_169 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . V_104 ) ;
}
static T_7 F_170 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . V_106 ) ;
}
static T_7 F_171 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . V_107 ) ;
}
static T_7 F_172 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . V_69 ) ;
}
static T_7 F_173 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . V_110 ) ;
}
static T_7 F_174 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , ( unsigned long ) V_117 . V_114 ) ;
}
static T_7 F_175 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_163 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_36 , V_117 . V_112 ) ;
}
int F_176 ( struct V_229 * V_230 , struct V_1 * V_2 )
{
struct V_6 * V_7 ;
struct V_39 * V_5 ;
int V_82 = 0 ;
...
V_7 -> V_257 = V_338 ;
V_2 -> V_31 = V_230 -> V_31 ;
V_2 -> V_322 = V_230 -> V_262 -> V_296 + V_2 -> line ;
if ( ! ( F_16 ( V_2 ) && ( V_2 -> V_31 -> V_11 & V_281 ) ) ) {
F_127 ( & V_2 -> V_12 ) ;
F_128 ( & V_2 -> V_12 , & V_282 ) ;
}
if ( V_2 -> V_31 && V_2 -> V_145 )
F_178 ( V_2 -> V_145 -> V_339 , V_2 -> V_31 -> V_321 , V_2 -> line ) ;
F_145 ( V_230 , V_7 , V_2 ) ;
V_336 = 2 ;
if ( V_2 -> V_340 )
V_336 ++ ;
V_2 -> V_341 = F_179 ( V_336 , sizeof( * V_2 -> V_341 ) ,
V_28 ) ;
if ( ! V_2 -> V_341 ) {
V_82 = - V_29 ;
goto V_201;
...
V_297 = F_180 ( V_5 , V_230 -> V_262 ,
V_2 -> line , V_2 -> V_145 , V_5 , V_2 -> V_341 ) ;
if ( F_181 ( ! F_182 ( V_297 ) ) ) {
F_183 ( V_297 , 1 ) ;
} else {
F_137 ( V_2 -> V_145 , L_39 ,
V_2 -> line ) ;
}
V_2 -> V_11 &= ~ V_249 ;
V_201:
...
int F_184 ( struct V_229 * V_230 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_230 -> V_7 + V_2 -> line ;
struct V_39 * V_5 = & V_7 -> V_5 ;
struct V_9 * V_8 ;
...
int F_191 ( struct V_1 * V_343 , struct V_1 * V_344 )
{
...
void F_197 ( struct V_1 * V_2 , unsigned int V_3 )
{
F_193 ( & V_2 -> V_12 ) ;
V_2 -> V_168 . V_177 ++ ;
if ( F_36 ( V_2 ) ) {
