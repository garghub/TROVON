...
static int F_24 ( struct V_1 * V_2 , unsigned V_8 ,
unsigned V_41 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
int V_36 = F_26 ( V_5 , V_61 -> V_11 [ V_54 ] ) ;
...
for ( V_54 = 0 ; V_54 < V_61 -> V_13 ; ++ V_54 ) {
V_43 = F_27 ( V_5 , V_61 -> V_51 [ V_54 ] , V_68 ) ;
if ( V_43 < 0 )
break;
}
V_49:
...
static bool F_32 ( struct V_59 * V_5 , unsigned int V_82 ,
enum V_83 V_84 )
{
int V_36 = F_26 ( V_5 , V_82 ) ;
const struct V_72 * V_42 = & V_5 -> V_6 -> V_11 [ V_36 ] ;
switch ( V_84 ) {
case V_85 :
return true ;
case V_86 :
return V_42 -> V_22 & V_87 ;
case V_88 :
return V_42 -> V_22 & V_89 ;
case V_90 :
return V_42 -> V_22 & V_91 ;
default:
return false ;
}
}
static int F_33 ( struct V_1 * V_2 , unsigned V_82 ,
unsigned long * V_92 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_59 * V_5 = V_4 -> V_5 ;
enum V_83 V_84 = F_34 ( * V_92 ) ;
unsigned long V_62 ;
if ( ! F_32 ( V_5 , V_82 , V_84 ) )
return - V_93 ;
switch ( V_84 ) {
case V_85 :
case V_86 :
case V_88 : {
unsigned int V_94 ;
if ( ! V_5 -> V_6 -> V_95 || ! V_5 -> V_6 -> V_95 -> V_96 )
return - V_93 ;
F_25 ( & V_5 -> V_63 , V_62 ) ;
V_94 = V_5 -> V_6 -> V_95 -> V_96 ( V_5 , V_82 ) ;
F_28 ( & V_5 -> V_63 , V_62 ) ;
if ( V_94 != V_84 )
return - V_47 ;
* V_92 = 0 ;
...
case V_90 : {
int V_43 ;
if ( ! V_5 -> V_6 -> V_95 || ! V_5 -> V_6 -> V_95 -> V_97 )
return - V_93 ;
F_25 ( & V_5 -> V_63 , V_62 ) ;
V_43 = V_5 -> V_6 -> V_95 -> V_97 ( V_5 , V_82 ) ;
F_28 ( & V_5 -> V_63 , V_62 ) ;
if ( V_43 < 0 )
return V_43 ;
* V_92 = V_43 ;
...
static int F_35 ( struct V_1 * V_2 , unsigned V_82 ,
...
case V_88 :
case V_85 :
if ( ! V_5 -> V_6 -> V_95 || ! V_5 -> V_6 -> V_95 -> V_98 )
return - V_93 ;
F_25 ( & V_5 -> V_63 , V_62 ) ;
V_5 -> V_6 -> V_95 -> V_98 ( V_5 , V_82 , V_84 ) ;
F_28 ( & V_5 -> V_63 , V_62 ) ;
break;
case V_90 : {
unsigned int V_99 =
F_36 ( V_22 [ V_54 ] ) ;
int V_43 ;
if ( ! V_5 -> V_6 -> V_95 || ! V_5 -> V_6 -> V_95 -> V_100 )
return - V_93 ;
F_25 ( & V_5 -> V_63 , V_62 ) ;
V_43 = V_5 -> V_6 -> V_95 -> V_100 ( V_5 , V_82 , V_99 ) ;
F_28 ( & V_5 -> V_63 , V_62 ) ;
if ( V_43 )
return V_43 ;
break;
...
static int F_37 ( struct V_1 * V_2 , unsigned V_41 ,
unsigned long * V_22 ,
unsigned V_23 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
F_35 ( V_2 , V_11 [ V_54 ] , V_22 , V_23 ) ;
return 0 ;
}
static int F_38 ( struct V_59 * V_5 , struct V_3 * V_4 )
{
unsigned int V_54 ;
V_4 -> V_11 = F_39 ( V_5 -> V_33 ,
sizeof( * V_4 -> V_11 ) * V_5 -> V_6 -> V_13 ,
V_25 ) ;
if ( F_40 ( ! V_4 -> V_11 ) )
return - V_26 ;
V_4 -> V_22 = F_39 ( V_5 -> V_33 ,
...
struct V_101 * V_42 = & V_4 -> V_11 [ V_54 ] ;
V_42 -> V_102 = V_6 -> V_42 != ( V_103 ) - 1 ? V_6 -> V_42 : V_54 ;
V_42 -> V_10 = V_6 -> V_10 ;
V_65 -> type = V_66 ;
}
return 0 ;
}
int F_41 ( struct V_59 * V_5 )
{
struct V_3 * V_4 ;
int V_43 ;
V_4 = F_39 ( V_5 -> V_33 , sizeof( * V_4 ) , V_25 ) ;
if ( F_40 ( ! V_4 ) )
return - V_26 ;
V_4 -> V_5 = V_5 ;
V_5 -> V_104 = V_4 ;
...
V_4 -> V_105 . V_108 = & V_109 ;
V_4 -> V_105 . V_110 = & V_111 ;
V_4 -> V_105 . V_112 = & V_113 ;
V_4 -> V_105 . V_11 = V_4 -> V_11 ;
V_4 -> V_105 . V_114 = V_5 -> V_6 -> V_13 ;
V_4 -> V_115 = F_42 ( & V_4 -> V_105 , V_5 -> V_33 , V_4 ) ;
if ( F_43 ( V_4 -> V_115 ) )
return F_44 ( V_4 -> V_115 ) ;
return 0 ;
}
int F_45 ( struct V_59 * V_5 )
{
struct V_3 * V_4 = V_5 -> V_104 ;
F_46 ( V_4 -> V_115 ) ;
V_5 -> V_104 = NULL ;
return 0 ;
}
