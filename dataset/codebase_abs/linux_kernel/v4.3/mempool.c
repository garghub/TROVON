...
T_4 * V_31 , void * V_20 )
{
return F_29 ( V_28 , V_30 , V_31 , V_20 ,
V_32 , V_33 ) ;
}
T_1 * F_29 ( int V_28 , T_3 * V_30 ,
T_4 * V_31 , void * V_20 ,
T_5 V_34 , int V_35 )
{
T_1 * V_1 ;
V_1 = F_30 ( sizeof( * V_1 ) , V_34 , V_35 ) ;
if ( ! V_1 )
return NULL ;
V_1 -> V_29 = F_31 ( V_28 * sizeof( void * ) ,
V_34 , V_35 ) ;
if ( ! V_1 -> V_29 ) {
F_27 ( V_1 ) ;
return NULL ;
