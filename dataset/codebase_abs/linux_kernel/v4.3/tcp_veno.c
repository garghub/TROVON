...
if ( V_3 -> V_26 < V_27 ) {
F_16 ( V_21 , V_21 -> V_24 , 1 ) ;
} else {
if ( V_21 -> V_28 >= V_21 -> V_24 ) {
if ( V_3 -> V_7 &&
V_21 -> V_24 < V_21 -> V_29 ) {
V_21 -> V_24 ++ ;
V_3 -> V_7 = 0 ;
...
struct V_3 * V_3 = F_2 ( V_2 ) ;
if ( V_3 -> V_26 < V_27 )
return F_18 ( V_21 -> V_24 * 4 / 5 , 2U ) ;
else
return F_18 ( V_21 -> V_24 >> 1U , 2U ) ;
}
static int T_5 F_19 ( void )
{
F_20 ( sizeof( struct V_3 ) > V_30 ) ;
F_21 ( & V_31 ) ;
return 0 ;
}
