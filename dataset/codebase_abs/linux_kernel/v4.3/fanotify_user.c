...
static long F_50 ( struct V_11 * V_11 , unsigned int V_75 , unsigned long V_76 )
{
struct V_2 * V_3 ;
struct V_1 * V_23 ;
void T_3 * V_77 ;
...
static int F_54 ( int V_84 , const char T_3 * V_85 ,
struct V_16 * V_16 , unsigned int V_86 )
{
int V_24 ;
F_4 ( L_9 , V_6 ,
V_84 , V_85 , V_86 ) ;
if ( V_85 == NULL ) {
struct V_36 V_51 = F_55 ( V_84 ) ;
V_24 = - V_87 ;
if ( ! V_51 . V_11 )
goto V_88;
V_24 = - V_89 ;
if ( ( V_86 & V_90 ) &&
! ( F_56 ( F_57 ( V_51 . V_11 ) -> V_91 ) ) ) {
F_58 ( V_51 ) ;
goto V_88;
}
* V_16 = V_51 . V_11 -> V_92 ;
...
if ( V_86 & V_90 )
V_93 |= V_96 ;
V_24 = F_60 ( V_84 , V_85 , V_93 , V_16 ) ;
if ( V_24 )
goto V_88;
}
V_24 = F_61 ( V_16 -> V_17 -> V_97 , V_98 ) ;
if ( V_24 )
F_62 ( V_16 ) ;
V_88:
return V_24 ;
}
static T_6 F_63 ( struct V_81 * V_82 ,
T_6 V_31 ,
unsigned int V_86 ,
int * V_99 )
{
...
F_20 ( & V_82 -> V_101 ) ;
if ( ! ( V_86 & V_102 ) ) {
T_6 V_103 = V_82 -> V_31 & ~ V_31 ;
if ( V_86 & V_104 )
V_103 &= ~ V_105 ;
V_100 = V_82 -> V_31 ;
F_64 ( V_82 , V_103 ) ;
} else {
T_6 V_103 = V_82 -> V_106 & ~ V_31 ;
if ( V_86 & V_104 )
V_103 &= ~ V_105 ;
F_65 ( V_82 , V_103 ) ;
}
* V_99 = ! ( V_82 -> V_31 | V_82 -> V_106 ) ;
F_23 ( & V_82 -> V_101 ) ;
return V_31 & V_100 ;
}
static int F_66 ( struct V_2 * V_3 ,
struct V_107 * V_18 , T_6 V_31 ,
unsigned int V_86 )
{
...
static T_6 F_76 ( struct V_81 * V_82 ,
T_6 V_31 ,
unsigned int V_86 )
{
T_6 V_100 = - 1 ;
...
static struct V_81 * F_77 ( struct V_2 * V_3 ,
struct V_71 * V_71 ,
struct V_107 * V_18 )
{
struct V_81 * V_115 ;
int V_24 ;
if ( F_78 ( & V_3 -> V_116 ) > V_3 -> V_14 . V_117 )
return F_6 ( - V_118 ) ;
V_115 = F_79 ( V_83 , V_119 ) ;
if ( ! V_115 )
return F_6 ( - V_120 ) ;
F_80 ( V_115 , F_52 ) ;
V_24 = F_81 ( V_115 , V_3 , V_71 , V_18 , 0 ) ;
if ( V_24 ) {
F_70 ( V_115 ) ;
return F_6 ( V_24 ) ;
}
...
V_82 = F_67 ( V_3 , V_18 ) ;
if ( ! V_82 ) {
V_82 = F_77 ( V_3 , NULL , V_18 ) ;
if ( F_12 ( V_82 ) ) {
F_35 ( & V_3 -> V_110 ) ;
return F_14 ( V_82 ) ;
}
}
V_121 = F_76 ( V_82 , V_31 , V_86 ) ;
F_35 ( & V_3 -> V_110 ) ;
if ( V_121 & ~ F_71 ( V_18 ) -> V_111 )
F_72 ( V_18 ) ;
F_70 ( V_82 ) ;
return 0 ;
}
...
{
V_83 = F_85 ( V_81 , V_123 ) ;
V_124 = F_85 ( V_9 , V_123 ) ;
#ifdef F_28
V_125 = F_85 ( V_38 ,
V_123 ) ;
#endif
