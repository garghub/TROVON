...
struct V_154 * V_155 = F_80 ( V_153 ) ;
const int V_156 [] = { 0 , 1 , 2 , 3 , 10 , 11 , 12 , 13 , 14 } ;
F_81 ( V_155 , V_153 ) ;
F_73 ( V_2 , V_156 , F_27 ( V_156 ) ) ;
F_82 ( V_155 , V_153 ) ;
}
...
F_3 ( V_2 , 0 , F_74 ( V_83 / 32 ) ) ;
for ( V_83 = 0 ; V_83 < V_180 ; V_83 += 32 ) {
V_177 = F_103 ( V_2 -> V_151 , V_83 ) ;
V_177 -> V_184 = V_2 -> V_4 ;
V_177 -> V_160 = V_160 [ V_83 / 32 ] ;
V_179 = V_177 -> V_185 ;
V_179 -> V_155 . V_186 = V_187 ;
V_179 -> V_155 . V_188 = V_189 ;
V_179 -> V_155 . V_190 = V_191 ;
V_179 -> V_147 . V_192 = F_49 ( V_83 / 32 ) ;
V_179 -> V_147 . V_87 = F_74 ( V_83 / 32 ) ;
}
F_104 ( V_2 -> V_193 , F_78 , V_2 ) ;
F_104 ( V_2 -> V_194 , F_83 ,
V_2 ) ;
return 0 ;
}
...
{
int V_83 , V_101 ;
F_104 ( V_2 -> V_194 , NULL , NULL ) ;
F_104 ( V_2 -> V_193 , NULL , NULL ) ;
...
static int F_110 ( struct V_112 * V_113 )
{
const struct V_200 * V_201 =
F_111 ( V_202 , & V_113 -> V_68 ) ;
struct V_1 * V_2 ;
struct V_166 * V_167 ;
unsigned long V_114 ;
int V_83 , V_118 , V_193 , V_194 ;
const struct V_120 * V_121 ;
V_121 = V_201 -> V_203 ;
V_193 = F_112 ( V_113 , 0 ) ;
V_194 = F_112 ( V_113 , 1 ) ;
V_167 = F_113 ( V_113 , V_169 , 0 ) ;
F_14 ( & V_113 -> V_68 , L_31 ,
V_193 , V_194 ) ;
if ( ! V_167 || V_193 < 0 || V_194 < 0 )
return - V_70 ;
V_114 = V_167 -> V_170 ;
V_2 = F_114 ( & V_113 -> V_68 , sizeof( * V_2 ) , V_204 ) ;
if ( ! V_2 )
return - V_70 ;
for ( V_83 = 0 ; V_83 < 64 ; V_83 ++ )
V_2 -> V_67 [ V_83 ] . V_2 = V_2 ;
V_2 -> V_121 = V_121 ;
V_2 -> V_205 = V_121 -> type ;
F_115 ( & V_2 -> V_79 ) ;
F_116 ( & V_2 -> V_71 ) ;
F_14 ( & V_113 -> V_68 , L_32 ,
V_114 + V_121 -> V_137 ) ;
F_14 ( & V_113 -> V_68 , L_33 ,
V_114 + V_121 -> V_137 + V_206 ) ;
...
V_114 + V_121 -> V_208 ) ;
V_2 -> V_4 = F_117 ( & V_113 -> V_68 ,
V_114 + V_121 -> V_137 , V_172 ) ;
V_2 -> V_209 = F_117 ( & V_113 -> V_68 ,
V_114 + V_121 -> V_137 + V_206 ,
V_172 ) ;
if ( ! V_2 -> V_4 || ! V_2 -> V_209 )
return - V_210 ;
V_2 -> V_115 = F_118 ( & V_113 -> V_68 , L_46 ) ;
if ( F_97 ( V_2 -> V_115 ) ) {
...
F_122 ( & V_113 -> V_68 , L_51 , V_121 -> V_173 ) ;
return 0 ;
V_215:
F_87 ( V_2 ) ;
V_214:
