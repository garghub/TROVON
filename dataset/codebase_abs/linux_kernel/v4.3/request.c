...
F_74 ( V_106 , V_61 -> V_106 ) )
goto V_107;
V_61 = F_75 ( & V_2 -> V_108 , struct V_89 , V_109 ) ;
F_65 ( V_87 ) ;
V_61 -> V_110 = 0 ;
V_107:
...
V_61 -> V_105 = F_76 ( V_3 ) ;
V_61 -> V_106 = V_106 + F_77 ( 5000 ) ;
V_87 -> V_81 = V_61 -> V_110 ;
F_78 ( & V_61 -> V_111 ) ;
F_79 ( & V_61 -> V_111 , F_67 ( V_2 , V_61 -> V_105 ) ) ;
F_80 ( & V_61 -> V_109 , & V_2 -> V_108 ) ;
F_81 ( & V_2 -> V_104 ) ;
V_43 = F_82 ( V_87 -> V_81 ,
V_87 -> V_80 ) >> 9 ;
if ( V_2 -> V_101 &&
...
else if ( ! F_88 ( & V_113 -> V_117 ) &&
F_89 ( V_115 -> V_116 . V_25 , & V_113 -> V_117 , 0 ) ) {
F_90 ( & V_115 -> V_116 . V_25 -> V_118 ) ;
V_115 -> V_116 . error = - V_119 ;
}
F_35 ( V_115 -> V_116 . V_25 , V_3 , V_3 -> V_54 , L_4 ) ;
}
static int F_91 ( struct V_120 * V_20 , struct V_121 * V_113 , struct V_5 * V_6 )
{
struct V_114 * V_115 = F_11 ( V_20 , struct V_114 , V_20 ) ;
struct V_3 * V_52 , * V_3 = & V_115 -> V_3 . V_3 ;
struct V_5 * V_122 ;
unsigned V_16 ;
if ( F_92 ( V_6 , & F_27 ( V_115 -> V_116 . V_47 , V_3 -> V_41 . V_42 , 0 ) ) <= 0 )
return V_123 ;
if ( F_93 ( V_6 ) != V_115 -> V_116 . V_47 ||
F_94 ( V_6 ) > V_3 -> V_41 . V_42 ) {
unsigned F_24 = F_24 ( V_3 ) ;
unsigned V_43 = F_93 ( V_6 ) == V_115 -> V_116 . V_47
? F_95 ( T_1 , V_124 ,
F_94 ( V_6 ) - V_3 -> V_41 . V_42 )
: V_124 ;
...
if ( F_88 ( V_6 ) )
V_115 -> V_128 = true ;
V_52 = F_43 ( V_3 , F_95 ( T_1 , V_124 ,
F_96 ( V_6 ) - V_3 -> V_41 . V_42 ) ,
V_68 , V_115 -> V_12 -> V_64 ) ;
V_122 = & F_11 ( V_52 , struct V_112 , V_3 ) -> V_117 ;
F_97 ( V_122 , V_6 , V_16 ) ;
F_98 ( & F_27 ( V_115 -> V_116 . V_47 , V_52 -> V_41 . V_42 , 0 ) , V_122 ) ;
F_99 ( & F_27 ( V_115 -> V_116 . V_47 , F_76 ( V_52 ) , 0 ) , V_122 ) ;
V_52 -> V_69 = F_87 ;
V_52 -> V_53 = & V_115 -> V_18 ;
F_100 ( V_52 , V_113 -> V_25 ) ;
...
int V_24 ;
F_102 ( & V_115 -> V_20 , - 1 ) ;
V_24 = F_103 ( & V_115 -> V_20 , V_115 -> V_116 . V_25 ,
& F_27 ( V_115 -> V_116 . V_47 , V_3 -> V_41 . V_42 , 0 ) ,
F_91 , V_130 ) ;
if ( V_24 == - V_131 ) {
F_15 ( V_18 , F_101 , V_132 ) ;
return;
}
F_17 ( V_18 ) ;
}
...
{
if ( V_115 -> V_134 ) {
F_107 ( F_108 ( V_115 -> V_134 ) ,
& V_115 -> V_12 -> V_85 -> V_135 , V_115 -> V_136 ) ;
F_109 ( V_115 -> V_12 , V_115 -> V_134 ) ;
V_115 -> V_134 -> V_54 = V_115 -> V_116 . error ;
F_110 ( V_115 -> V_134 ) ;
V_115 -> V_134 = NULL ;
}
}
static void F_111 ( struct V_114 * V_115 , struct V_3 * V_134 )
{
struct V_3 * V_3 = & V_115 -> V_3 . V_3 ;
F_112 ( V_3 ) ;
F_113 ( V_3 , V_134 ) ;
...
F_116 ( V_18 ) ;
F_117 ( V_115 , V_115 -> V_12 -> V_25 -> V_114 ) ;
}
static inline struct V_114 * F_118 ( struct V_3 * V_3 ,
struct V_137 * V_12 )
{
struct V_114 * V_115 ;
V_115 = F_119 ( V_12 -> V_25 -> V_114 , V_68 ) ;
F_120 ( & V_115 -> V_18 , NULL ) ;
F_111 ( V_115 , V_3 ) ;
V_115 -> V_134 = V_3 ;
V_115 -> V_125 = NULL ;
V_115 -> V_12 = V_12 ;
V_115 -> V_133 = 1 ;
V_115 -> V_138 = ( V_3 -> V_58 & V_71 ) != 0 ;
V_115 -> V_128 = 0 ;
V_115 -> V_136 = V_106 ;
V_115 -> V_116 . V_25 = V_12 -> V_25 ;
V_115 -> V_116 . V_3 = NULL ;
V_115 -> V_116 . V_47 = V_12 -> V_139 ;
V_115 -> V_116 . V_65 = F_121 ( ( unsigned long ) V_88 , 16 ) ;
V_115 -> V_116 . V_66 = 0 ;
V_115 -> V_116 . error = 0 ;
V_115 -> V_116 . V_91 = 0 ;
...
struct V_114 * V_115 = F_11 ( V_18 , struct V_114 , V_18 ) ;
if ( V_115 -> V_116 . V_29 )
F_125 ( V_115 -> V_116 . V_25 , V_115 -> V_12 ) ;
if ( V_115 -> V_116 . V_3 ) {
int V_61 ;
struct V_7 * V_8 ;
...
F_133 ( V_115 -> V_116 . V_3 , NULL ) ;
F_134 ( V_115 -> V_125 , V_115 -> V_116 . V_3 ) ;
F_28 ( V_115 -> V_125 ) ;
V_115 -> V_125 = NULL ;
}
if ( F_3 ( V_2 , & V_115 -> V_3 . V_3 ) && V_115 -> V_133 && ! V_115 -> V_128 )
F_135 ( V_2 , V_115 -> V_134 ) ;
F_106 ( V_115 ) ;
if ( V_115 -> V_116 . V_3 &&
! F_70 ( V_142 , & V_115 -> V_116 . V_25 -> V_91 ) ) {
F_53 ( ! V_115 -> V_116 . V_23 ) ;
F_136 ( & V_115 -> V_116 . V_18 , F_55 , NULL , V_18 ) ;
}
F_15 ( V_18 , F_124 , NULL ) ;
}
...
struct V_114 * V_115 = F_11 ( V_18 , struct V_114 , V_18 ) ;
struct V_1 * V_2 = F_11 ( V_115 -> V_12 , struct V_1 , V_85 ) ;
F_138 ( V_115 -> V_116 . V_25 , V_115 -> V_12 ,
! V_115 -> V_125 , V_115 -> V_116 . V_57 ) ;
F_139 ( V_115 -> V_134 , ! V_115 -> V_125 , V_115 -> V_116 . V_57 ) ;
if ( V_115 -> V_116 . error )
F_140 ( V_18 , F_128 , V_132 ) ;
else if ( V_115 -> V_116 . V_3 || F_3 ( V_2 , & V_115 -> V_3 . V_3 ) )
F_140 ( V_18 , F_131 , V_132 ) ;
else
F_140 ( V_18 , F_122 , NULL ) ;
}
static int F_141 ( struct V_121 * V_113 , struct V_114 * V_115 ,
...
F_133 ( V_145 , NULL ) ;
if ( F_146 ( V_145 , V_154 | V_68 ) )
goto V_155;
if ( V_143 )
F_147 ( V_115 -> V_116 . V_25 , V_115 -> V_12 ) ;
V_115 -> V_125 = V_144 ;
V_115 -> V_116 . V_3 = V_145 ;
F_58 ( V_145 ) ;
F_130 ( V_145 , & V_115 -> V_18 ) ;
return V_24 ;
V_155:
F_28 ( V_145 ) ;
V_146:
...
F_130 ( V_144 , & V_115 -> V_18 ) ;
return V_24 ;
}
static void F_148 ( struct V_1 * V_2 , struct V_114 * V_115 )
{
struct V_17 * V_18 = & V_115 -> V_18 ;
F_136 ( & V_115 -> V_116 . V_18 , F_101 , NULL , V_18 ) ;
...
struct V_5 V_158 = F_27 ( V_2 -> V_85 . V_139 , F_76 ( V_3 ) , 0 ) ;
F_152 ( & V_115 -> V_116 . V_25 -> V_159 , & V_157 , & V_158 ) ;
F_153 ( & V_2 -> V_156 ) ;
if ( F_152 ( & V_2 -> V_160 , & V_157 , & V_158 ) ) {
V_115 -> V_116 . V_57 = false ;
V_115 -> V_116 . V_55 = true ;
}
if ( V_3 -> V_58 & V_95 )
V_115 -> V_116 . V_57 = true ;
if ( F_154 ( V_2 , V_115 -> V_134 ,
F_1 ( V_2 , V_3 ) ,
V_115 -> V_116 . V_57 ) ) {
V_115 -> V_116 . V_57 = false ;
V_115 -> V_116 . V_55 = true ;
...
if ( ! ( V_3 -> V_58 & V_95 ) ||
F_155 ( F_156 ( V_2 -> V_161 ) ) )
F_130 ( V_3 , V_18 ) ;
} else if ( V_115 -> V_116 . V_55 ) {
F_157 ( V_2 ) ;
V_115 -> V_116 . V_3 = V_3 ;
if ( V_3 -> V_58 & V_59 ) {
struct V_3 * V_162 = F_144 ( V_68 , 0 ,
V_2 -> V_85 . V_64 ) ;
V_162 -> V_58 = V_163 ;
...
V_115 -> V_116 . V_3 = F_158 ( V_3 , V_68 , V_2 -> V_85 . V_64 ) ;
F_130 ( V_3 , V_18 ) ;
}
F_136 ( & V_115 -> V_116 . V_18 , F_55 , NULL , V_18 ) ;
...
struct V_3 * V_3 = & V_115 -> V_3 . V_3 ;
if ( V_115 -> V_116 . V_27 )
F_160 ( V_115 -> V_116 . V_25 , V_18 ) ;
F_130 ( V_3 , V_18 ) ;
F_15 ( V_18 , F_122 , NULL ) ;
}
static void F_161 ( struct V_164 * V_165 , struct V_3 * V_3 )
{
struct V_114 * V_115 ;
struct V_137 * V_12 = V_3 -> V_140 -> V_166 -> V_167 ;
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_85 ) ;
int V_168 = F_108 ( V_3 ) ;
F_162 ( V_168 , F_24 ( V_3 ) , & V_12 -> V_85 -> V_135 ) ;
V_3 -> V_140 = V_2 -> V_161 ;
V_3 -> V_41 . V_42 += V_2 -> V_4 . V_169 ;
if ( F_163 ( V_2 ) ) {
V_115 = F_118 ( V_3 , V_12 ) ;
F_164 ( V_115 -> V_12 , V_3 ) ;
if ( ! V_3 -> V_41 . V_46 ) {
F_140 ( & V_115 -> V_18 ,
F_159 ,
V_132 ) ;
} else {
V_115 -> V_116 . V_57 = F_69 ( V_2 , V_3 ) ;
if ( V_168 )
F_151 ( V_2 , V_115 ) ;
else
F_148 ( V_2 , V_115 ) ;
...
static int F_166 ( struct V_137 * V_12 , T_4 V_86 ,
unsigned int V_170 , unsigned long V_171 )
{
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_85 ) ;
return F_167 ( V_2 -> V_161 , V_86 , V_170 , V_171 ) ;
}
static int F_168 ( void * V_172 , int V_173 )
{
struct V_137 * V_12 = V_172 ;
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_85 ) ;
struct V_164 * V_165 = F_156 ( V_2 -> V_161 ) ;
int V_24 = 0 ;
if ( F_169 ( & V_165 -> V_174 , V_173 ) )
return 1 ;
if ( F_163 ( V_2 ) ) {
unsigned V_61 ;
struct V_175 * V_176 ;
F_170 (ca, d->c, i) {
V_165 = F_156 ( V_176 -> V_161 ) ;
V_24 |= F_169 ( & V_165 -> V_174 , V_173 ) ;
}
F_123 ( V_2 ) ;
}
return V_24 ;
...
{
struct V_177 * V_178 = V_2 -> V_85 . V_85 ;
V_178 -> V_179 -> V_180 = F_161 ;
V_178 -> V_179 -> V_174 . V_181 = F_168 ;
V_2 -> V_85 . V_125 = F_141 ;
V_2 -> V_85 . V_182 = F_166 ;
}
static int F_172 ( struct V_121 * V_113 , struct V_114 * V_115 ,
struct V_3 * V_3 , unsigned V_43 )
{
...
static void F_177 ( struct V_164 * V_165 , struct V_3 * V_3 )
{
struct V_114 * V_115 ;
struct V_17 * V_18 ;
struct V_137 * V_12 = V_3 -> V_140 -> V_166 -> V_167 ;
...
F_152 ( & V_115 -> V_116 . V_25 -> V_159 ,
& F_27 ( V_12 -> V_139 , V_3 -> V_41 . V_42 , 0 ) ,
& F_27 ( V_12 -> V_139 , F_76 ( V_3 ) , 0 ) ) ;
V_115 -> V_116 . V_57 = ( V_3 -> V_58 & V_95 ) != 0 ;
V_115 -> V_116 . V_55 = true ;
V_115 -> V_116 . V_3 = V_3 ;
F_136 ( & V_115 -> V_116 . V_18 , F_55 , NULL , V_18 ) ;
} else {
...
static int F_178 ( struct V_137 * V_12 , T_4 V_86 ,
unsigned int V_170 , unsigned long V_171 )
{
return - V_184 ;
}
...
void F_180 ( struct V_137 * V_12 )
{
struct V_177 * V_178 = V_12 -> V_85 ;
