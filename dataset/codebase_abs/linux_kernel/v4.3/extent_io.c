...
static void F_172 ( struct V_41 * V_41 )
{
struct V_246 * V_247 ;
T_1 V_15 ;
T_1 V_16 ;
...
if ( F_170 ( V_129 , V_41 -> V_251 , V_15 , V_16 ) )
continue;
F_129 ( V_129 ) ;
}
F_144 ( V_41 ) ;
...
static void F_177 ( struct V_41 * V_41 )
{
struct V_246 * V_247 ;
int V_244 = ! V_41 -> V_251 ;
struct V_40 * V_253 = V_40 ( V_41 ) ;
struct V_24 * V_25 ;
T_1 V_56 = 0 ;
T_1 V_15 ;
T_1 V_16 ;
...
struct V_26 * V_26 = V_129 -> V_28 -> V_29 ;
F_154 ( L_23
L_24 , ( T_1 ) V_41 -> V_188 . V_193 ,
V_41 -> V_251 , V_253 -> V_174 ) ;
...
V_25 -> V_46 -> V_257 ) ) {
V_74 = V_25 -> V_46 -> V_257 ( V_253 , V_56 ,
V_129 , V_15 , V_16 ,
V_256 ) ;
if ( V_74 )
V_244 = 0 ;
...
if ( F_178 ( V_244 ) )
goto V_258;
if ( V_25 -> V_46 && V_25 -> V_46 -> V_259 ) {
V_74 = V_25 -> V_46 -> V_259 ( V_129 , V_256 ) ;
if ( ! V_74 && ! V_41 -> V_251 )
V_244 = 1 ;
} else {
...
if ( F_178 ( V_244 ) ) {
T_8 V_260 = F_17 ( V_26 ) ;
T_9 V_128 = V_260 >> V_127 ;
unsigned V_261 ;
V_261 = V_260 & ( V_149 - 1 ) ;
if ( V_129 -> V_126 == V_128 && V_261 )
F_179 ( V_129 , V_261 , V_149 ) ;
F_137 ( V_129 ) ;
} else {
F_171 ( V_129 ) ;
F_128 ( V_129 ) ;
...
if ( V_255 )
F_176 ( V_25 , V_254 , V_255 ,
V_244 ) ;
if ( V_253 -> V_262 )
V_253 -> V_262 ( V_253 , V_41 -> V_251 ) ;
F_144 ( V_41 ) ;
}
struct V_41 *
F_181 ( struct V_263 * V_194 , T_1 V_264 , int V_265 ,
T_3 V_266 )
{
struct V_40 * V_180 ;
struct V_41 * V_41 ;
V_41 = F_182 ( V_266 , V_265 , V_38 ) ;
if ( V_41 == NULL && ( V_267 -> V_7 & V_268 ) ) {
while ( ! V_41 && ( V_265 /= 2 ) ) {
V_41 = F_182 ( V_266 ,
V_265 , V_38 ) ;
}
...
struct V_41 * F_183 ( struct V_41 * V_41 , T_3 V_270 )
{
struct V_40 * V_180 ;
struct V_41 * V_5 ;
V_5 = F_184 ( V_41 , V_270 , V_38 ) ;
if ( V_5 ) {
V_180 = V_40 ( V_5 ) ;
V_180 -> V_232 = NULL ;
V_180 -> V_269 = NULL ;
...
#ifdef F_185
if ( V_41 -> V_271 )
F_186 ( V_5 , V_41 -> V_271 ) ;
#endif
}
return V_5 ;
}
struct V_41 * F_142 ( T_3 V_270 , unsigned int V_272 )
{
struct V_40 * V_180 ;
struct V_41 * V_41 ;
V_41 = F_182 ( V_270 , V_272 , V_38 ) ;
if ( V_41 ) {
V_180 = V_40 ( V_41 ) ;
V_180 -> V_232 = NULL ;
V_180 -> V_269 = NULL ;
...
static int T_4 F_187 ( int V_273 , struct V_41 * V_41 ,
...
static int F_190 ( int V_273 , struct V_24 * V_25 , struct V_129 * V_129 ,
...
static int F_191 ( int V_273 , struct V_24 * V_25 ,
struct V_277 * V_278 ,
...
struct V_41 * V_41 ;
int V_161 = 0 ;
int V_284 = V_282 & V_220 ;
T_10 V_285 = F_117 ( T_10 , V_275 , V_149 ) ;
if ( V_279 && * V_279 ) {
V_41 = * V_279 ;
if ( V_284 )
V_161 = V_41 -> V_188 . V_193 == V_179 ;
else
V_161 = F_192 ( V_41 ) == V_179 ;
if ( V_282 != V_217 || ! V_161 ||
V_283 ||
F_190 ( V_273 , V_25 , V_129 , V_56 , V_285 , V_41 , V_217 ) ||
F_146 ( V_41 , V_129 , V_285 , V_56 ) < V_285 ) {
V_74 = F_187 ( V_273 , V_41 , V_174 ,
V_282 ) ;
if ( V_74 < 0 ) {
* V_279 = NULL ;
return V_74 ;
...
if ( V_278 )
F_193 ( V_278 , V_129 , V_285 ) ;
return 0 ;
}
}
V_41 = F_181 ( V_194 , V_179 , V_286 ,
V_125 | V_287 ) ;
if ( ! V_41 )
return - V_36 ;
F_146 ( V_41 , V_129 , V_285 , V_56 ) ;
V_41 -> V_228 = V_281 ;
V_41 -> V_231 = V_25 ;
if ( V_278 ) {
F_194 ( V_278 , V_41 ) ;
...
V_74 = F_187 ( V_273 , V_41 , V_174 , V_217 ) ;
return V_74 ;
}
...
V_213 = V_289 ( V_26 , V_129 , V_173 , V_15 , V_21 , 0 ) ;
if ( V_290 && ! F_204 ( V_213 ) ) {
F_72 ( * V_290 ) ;
F_82 ( & V_213 -> V_17 ) ;
* V_290 = V_213 ;
}
...
int V_74 ;
int V_297 = 0 ;
int V_298 = * V_217 & V_299 ;
T_10 V_173 = 0 ;
T_10 V_300 ;
T_10 V_301 ;
T_10 V_302 = V_26 -> V_33 -> V_303 ;
unsigned long V_304 = * V_217 & V_299 ;
F_200 ( V_129 ) ;
V_16 = V_292 ;
if ( ! F_206 ( V_129 ) ) {
if ( F_207 ( V_129 ) == 0 ) {
...
char * V_305 ;
T_10 V_306 = V_295 & ( V_149 - 1 ) ;
if ( V_306 ) {
V_300 = V_149 - V_306 ;
V_305 = F_208 ( V_129 ) ;
memset ( V_305 + V_306 , 0 , V_300 ) ;
F_209 ( V_129 ) ;
F_210 ( V_305 ) ;
}
}
while ( V_293 <= V_16 ) {
unsigned long V_307 = ( V_295 >> V_127 ) + 1 ;
bool V_283 = false ;
if ( V_293 >= V_295 ) {
char * V_305 ;
struct V_1 * V_98 = NULL ;
V_300 = V_149 - V_173 ;
V_305 = F_208 ( V_129 ) ;
memset ( V_305 + V_173 , 0 , V_300 ) ;
F_209 ( V_129 ) ;
F_210 ( V_305 ) ;
F_96 ( V_25 , V_293 , V_293 + V_300 - 1 ,
& V_98 , V_125 ) ;
if ( ! V_298 )
F_101 ( V_25 , V_293 ,
V_293 + V_300 - 1 ,
...
V_213 = F_201 ( V_26 , V_129 , V_173 , V_293 ,
V_16 - V_293 + 1 , V_289 , V_290 ) ;
if ( F_204 ( V_213 ) ) {
F_128 ( V_129 ) ;
if ( ! V_298 )
...
V_300 = F_131 ( F_203 ( V_213 ) - V_293 , V_16 - V_293 + 1 ) ;
V_296 = F_131 ( F_203 ( V_213 ) - 1 , V_16 ) ;
V_300 = F_211 ( V_300 , V_302 ) ;
if ( V_304 & V_220 ) {
V_301 = V_213 -> V_308 ;
V_179 = V_213 -> V_218 >> 9 ;
} else {
...
F_96 ( V_25 , V_293 , V_293 + V_300 - 1 ,
& V_98 , V_125 ) ;
F_101 ( V_25 , V_293 , V_293 + V_300 - 1 ,
& V_98 , V_125 ) ;
V_293 = V_293 + V_300 ;
V_173 += V_300 ;
continue;
...
F_135 ( V_25 , V_129 ) ;
if ( ! V_298 )
F_102 ( V_25 , V_293 , V_293 + V_300 - 1 ) ;
V_293 = V_293 + V_300 ;
V_173 += V_300 ;
continue;
}
...
V_307 -= V_129 -> V_126 ;
V_74 = F_191 ( V_273 , V_25 , NULL , V_129 ,
V_179 , V_301 , V_173 ,
V_194 , V_41 , V_307 ,
F_177 , V_174 ,
* V_217 ,
...
static inline void F_213 ( struct V_24 * V_25 ,
...
F_205 ( V_25 , V_138 [ V_126 ] , V_289 , V_290 , V_41 ,
V_174 , V_217 , V_273 , V_291 ) ;
F_106 ( V_138 [ V_126 ] ) ;
}
}
static void F_217 ( struct V_24 * V_25 ,
struct V_129 * V_138 [] ,
int V_139 , T_12 * V_289 ,
struct V_212 * * V_290 ,
struct V_41 * * V_41 , int V_174 ,
unsigned long * V_217 , int V_273 ,
T_1 * V_291 )
...
int V_316 = 0 ;
for ( V_126 = 0 ; V_126 < V_139 ; V_126 ++ ) {
V_315 = F_136 ( V_138 [ V_126 ] ) ;
if ( ! V_16 ) {
V_15 = V_315 ;
V_16 = V_15 + V_149 - 1 ;
V_316 = V_126 ;
} else if ( V_16 + 1 == V_315 ) {
V_16 += V_149 ;
} else {
F_213 ( V_25 , & V_138 [ V_316 ] ,
V_126 - V_316 , V_15 ,
V_16 , V_289 , V_290 ,
V_41 , V_174 , V_217 ,
V_273 , V_291 ) ;
...
V_74 = F_205 ( V_25 , V_129 , V_289 , NULL , V_41 , V_174 ,
V_217 , V_273 , NULL ) ;
return V_74 ;
}
int F_220 ( struct V_24 * V_25 , struct V_129 * V_129 ,
T_12 * V_289 , int V_174 )
{
struct V_41 * V_41 = NULL ;
unsigned long V_217 = 0 ;
int V_74 ;
V_74 = F_218 ( V_25 , V_129 , V_289 , & V_41 , V_174 ,
& V_217 , V_317 ) ;
if ( V_41 )
V_74 = F_187 ( V_317 , V_41 , V_174 , V_217 ) ;
return V_74 ;
}
...
static T_5 void F_222 ( struct V_129 * V_129 ,
struct V_277 * V_278 ,
unsigned long V_318 )
{
V_278 -> V_319 -= V_318 ;
if ( V_278 -> V_320 || ( V_278 -> V_319 > 0 &&
V_278 -> V_321 == 0 && V_278 -> V_322 == V_323 ) )
V_129 -> V_28 -> V_324 = V_129 -> V_126 + V_318 ;
}
static T_13 int F_223 ( struct V_26 * V_26 ,
struct V_129 * V_129 , struct V_277 * V_278 ,
struct V_325 * V_326 ,
T_1 V_141 ,
unsigned long * V_318 )
{
...
if ( V_278 -> V_319 < V_328 ) {
int V_333 = 8192 ;
if ( V_328 < V_333 * 2 )
V_333 = V_328 ;
V_278 -> V_319 = F_117 ( T_1 , V_328 ,
V_333 ) ;
}
if ( V_329 ) {
V_278 -> V_319 -= * V_318 ;
...
F_225 ( V_278 , V_129 ) ;
F_222 ( V_129 , V_278 , V_318 ) ;
F_118 ( V_129 ) ;
V_74 = 1 ;
goto V_340;
}
}
F_222 ( V_129 , V_278 , V_318 + 1 ) ;
V_16 = V_292 ;
if ( V_260 <= V_15 ) {
if ( V_25 -> V_46 && V_25 -> V_46 -> V_245 )
...
V_213 = V_326 -> V_289 ( V_26 , V_129 , V_173 , V_293 ,
V_16 - V_293 + 1 , 1 ) ;
if ( F_204 ( V_213 ) ) {
F_128 ( V_129 ) ;
V_74 = F_226 ( V_213 ) ;
...
F_72 ( V_341 <= V_293 ) ;
F_72 ( V_16 < V_293 ) ;
V_300 = F_131 ( V_341 - V_293 , V_16 - V_293 + 1 ) ;
V_300 = F_211 ( V_300 , V_302 ) ;
V_179 = ( V_213 -> V_218 + V_294 ) >> 9 ;
V_194 = V_213 -> V_194 ;
V_218 = V_213 -> V_218 ;
...
unsigned long V_343 = ( V_260 >> V_127 ) + 1 ;
F_110 ( V_25 , V_293 , V_293 + V_300 - 1 ) ;
if ( ! F_227 ( V_129 ) ) {
F_174 ( F_125 ( V_26 ) -> V_54 -> V_175 ,
L_27 ,
V_129 -> V_126 , V_293 , V_16 ) ;
}
V_74 = F_191 ( V_334 , V_25 , V_278 , V_129 ,
V_179 , V_300 , V_173 ,
...
static int F_228 ( struct V_129 * V_129 , struct V_277 * V_278 ,
void * V_226 )
{
struct V_26 * V_26 = V_129 -> V_28 -> V_29 ;
...
T_10 V_173 = 0 ;
T_8 V_260 = F_17 ( V_26 ) ;
unsigned long V_128 = V_260 >> V_127 ;
int V_334 ;
unsigned long V_318 = 0 ;
if ( V_278 -> V_344 == V_345 )
V_334 = V_197 ;
else
V_334 = V_190 ;
F_229 ( V_129 , V_26 , V_278 ) ;
F_41 ( ! F_230 ( V_129 ) ) ;
F_231 ( V_129 ) ;
V_173 = V_260 & ( V_149 - 1 ) ;
...
V_173 = 0 ;
F_200 ( V_129 ) ;
V_74 = F_223 ( V_26 , V_129 , V_278 , V_326 , V_15 , & V_318 ) ;
if ( V_74 == 1 )
goto V_340;
if ( V_74 )
goto V_147;
V_74 = F_224 ( V_26 , V_129 , V_278 , V_326 ,
V_260 , V_318 , V_334 , & V_297 ) ;
if ( V_74 == 1 )
goto V_340;
V_147:
if ( V_297 == 0 ) {
...
F_70 ( & V_11 -> V_352 ) ;
if ( F_239 ( V_353 , & V_11 -> V_348 ) ) {
F_240 ( V_349 , & V_11 -> V_348 ) ;
F_74 ( & V_11 -> V_352 ) ;
F_241 ( V_11 , V_354 ) ;
F_242 ( & V_175 -> V_355 ,
- V_11 -> V_21 ,
...
{
F_245 ( V_349 , & V_11 -> V_348 ) ;
F_246 () ;
F_247 ( & V_11 -> V_348 , V_349 ) ;
}
...
F_128 ( V_129 ) ;
if ( F_249 ( V_359 , & V_11 -> V_348 ) )
return;
switch ( V_11 -> V_360 ) {
case - 1 :
F_240 ( V_361 , & V_358 -> V_362 ) ;
break;
case 0 :
F_240 ( V_363 , & V_358 -> V_362 ) ;
break;
case 1 :
F_240 ( V_364 , & V_358 -> V_362 ) ;
break;
default:
F_250 () ;
}
}
static void F_251 ( struct V_41 * V_41 )
{
struct V_246 * V_247 ;
struct V_10 * V_11 ;
int V_140 , V_147 ;
...
struct V_325 * V_326 )
{
struct V_263 * V_194 = V_175 -> V_229 -> V_230 ;
...
F_105 ( V_60 ) ;
F_111 ( V_60 ) ;
V_74 = F_191 ( V_273 , V_25 , V_278 , V_60 , V_56 >> 9 ,
V_149 , 0 , V_194 , & V_326 -> V_41 ,
- 1 , F_251 ,
0 , V_326 -> V_217 , V_217 , false ) ;
V_326 -> V_217 = V_217 ;
if ( V_74 ) {
F_248 ( V_60 ) ;
F_129 ( V_60 ) ;
if ( F_254 ( V_202 - V_140 , & V_11 -> V_365 ) )
F_244 ( V_11 ) ;
V_74 = - V_154 ;
break;
}
...
V_126 = V_278 -> V_321 >> V_127 ;
V_16 = V_278 -> V_322 >> V_127 ;
V_373 = 1 ;
}
if ( V_278 -> V_344 == V_345 )
V_374 = V_375 ;
...
( V_139 = F_258 ( & V_372 , V_28 , & V_126 , V_374 ,
...
if ( ! F_196 ( V_129 ) )
continue;
if ( ! V_278 -> V_320 && V_129 -> V_126 > V_16 ) {
V_147 = 1 ;
break;
}
F_70 ( & V_28 -> V_379 ) ;
...
V_74 = F_259 ( & V_11 -> V_17 ) ;
F_74 ( & V_28 -> V_379 ) ;
if ( ! V_74 )
continue;
V_369 = V_11 ;
V_74 = F_234 ( V_11 , V_175 , & V_326 ) ;
if ( ! V_74 ) {
F_260 ( V_11 ) ;
continue;
}
V_74 = F_252 ( V_11 , V_175 , V_278 , & V_326 ) ;
if ( V_74 ) {
V_147 = 1 ;
F_260 ( V_11 ) ;
break;
...
static void F_267 ( struct V_325 * V_326 )
{
if ( V_326 -> V_41 ) {
int V_273 = V_190 ;
int V_74 ;
if ( V_326 -> V_351 )
V_273 = V_197 ;
V_74 = F_187 ( V_273 , V_326 -> V_41 , 0 , V_326 -> V_217 ) ;
F_72 ( V_74 < 0 ) ;
V_326 -> V_41 = NULL ;
}
}
...
V_74 = F_228 ( V_129 , V_278 , & V_326 ) ;
F_267 ( & V_326 ) ;
return V_74 ;
}
int F_269 ( struct V_24 * V_25 , struct V_26 * V_26 ,
T_1 V_15 , T_1 V_16 , T_12 * V_289 ,
int V_383 )
{
int V_74 = 0 ;
...
V_386 [ V_297 ++ ] = V_129 ;
if ( V_297 < F_274 ( V_386 ) )
continue;
F_217 ( V_25 , V_386 , V_297 , V_289 , & V_290 ,
& V_41 , 0 , & V_217 , V_317 , & V_291 ) ;
V_297 = 0 ;
}
if ( V_297 )
F_217 ( V_25 , V_386 , V_297 , V_289 , & V_290 ,
...
F_72 ( ! F_10 ( V_138 ) ) ;
if ( V_41 )
return F_187 ( V_317 , V_41 , 0 , V_217 ) ;
return 0 ;
}
...
T_1 V_15 = F_136 ( V_129 ) ;
T_1 V_16 = V_15 + V_149 - 1 ;
T_10 V_302 = V_129 -> V_28 -> V_29 -> V_33 -> V_303 ;
V_15 += F_211 ( V_56 , V_302 ) ;
if ( V_15 > V_16 )
return 0 ;
...
static int F_276 ( struct V_214 * V_388 ,
struct V_24 * V_25 ,
...
T_1 V_16 = V_15 + V_149 - 1 ;
if ( ( V_49 & V_105 ) &&
V_129 -> V_28 -> V_29 -> V_260 > 16 * 1024 * 1024 ) {
T_1 V_21 ;
while ( V_15 <= V_16 ) {
V_21 = V_16 - V_15 + 1 ;
F_278 ( & V_388 -> V_48 ) ;
...
return F_276 ( V_388 , V_25 , V_129 , V_49 ) ;
}
static struct V_212 * F_281 ( struct V_26 * V_26 ,
T_1 V_56 ,
T_1 V_162 ,
T_12 * V_289 )
{
...
if ( V_21 == 0 )
break;
V_21 = F_211 ( V_21 , V_392 ) ;
V_213 = V_289 ( V_26 , NULL , 0 , V_56 , V_21 , 0 ) ;
if ( F_204 ( V_213 ) )
return V_213 ;
...
int F_282 ( struct V_26 * V_26 , struct V_394 * V_395 ,
T_15 V_15 , T_15 V_21 , T_12 * V_289 )
{
int V_74 = 0 ;
T_1 V_261 = V_15 ;
T_1 F_132 = V_15 + V_21 ;
...
return - V_36 ;
V_402 -> V_406 = 1 ;
V_15 = F_284 ( V_15 , F_125 ( V_26 ) -> V_54 -> V_392 ) ;
V_21 = F_285 ( F_132 , F_125 ( V_26 ) -> V_54 -> V_392 ) - V_15 ;
V_74 = F_286 ( NULL , V_54 , V_402 , F_19 ( V_26 ) , - 1 ,
0 ) ;
if ( V_74 < 0 ) {
F_287 ( V_402 ) ;
return V_74 ;
...
F_41 ( ! V_74 ) ;
V_402 -> V_407 [ 0 ] -- ;
F_288 ( V_402 -> V_408 [ 0 ] , & V_400 , V_402 -> V_407 [ 0 ] ) ;
V_396 = V_400 . type ;
...
while ( ! V_16 ) {
T_1 V_411 = 0 ;
if ( V_213 -> V_15 >= F_132 || F_203 ( V_213 ) < V_261 )
break;
V_403 = F_132 ( V_213 -> V_15 , V_261 ) ;
if ( ! F_164 ( V_219 , & V_213 -> V_7 ) )
...
( V_213 -> V_15 - V_213 -> V_311 ) ;
V_398 = V_213 -> V_218 + V_411 ;
V_74 = F_292 ( NULL , V_54 -> V_175 ,
V_54 -> V_409 ,
F_19 ( V_26 ) , V_420 ) ;
if ( V_74 < 0 )
goto V_421;
...
static struct V_10 *
F_299 ( struct V_32 * V_175 , T_1 V_15 ,
unsigned long V_21 )
{
struct V_10 * V_11 = NULL ;
V_11 = F_300 ( V_22 , V_125 | V_427 ) ;
V_11 -> V_15 = V_15 ;
V_11 -> V_21 = V_21 ;
V_11 -> V_175 = V_175 ;
V_11 -> V_348 = 0 ;
...
struct V_10 * F_303 ( struct V_10 * V_439 )
{
unsigned long V_140 ;
struct V_129 * V_60 ;
struct V_10 * V_5 ;
unsigned long V_202 = F_152 ( V_439 -> V_15 , V_439 -> V_21 ) ;
V_5 = F_299 ( V_439 -> V_175 , V_439 -> V_15 , V_439 -> V_21 ) ;
if ( V_5 == NULL )
return NULL ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ ) {
V_60 = F_304 ( V_125 ) ;
...
F_305 ( V_5 , V_439 , 0 , 0 , V_439 -> V_21 ) ;
F_240 ( V_440 , & V_5 -> V_348 ) ;
F_240 ( V_426 , & V_5 -> V_348 ) ;
return V_5 ;
}
struct V_10 * F_306 ( struct V_32 * V_175 ,
T_1 V_15 )
{
struct V_10 * V_11 ;
unsigned long V_21 ;
...
V_21 = V_175 -> V_441 -> V_442 ;
}
V_202 = F_152 ( 0 , V_21 ) ;
V_11 = F_299 ( V_175 , V_15 , V_21 ) ;
if ( ! V_11 )
return NULL ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ ) {
V_11 -> V_138 [ V_140 ] = F_304 ( V_125 ) ;
if ( ! V_11 -> V_138 [ V_140 ] )
goto V_95;
}
F_307 ( V_11 ) ;
F_308 ( V_11 , 0 ) ;
F_240 ( V_426 , & V_11 -> V_348 ) ;
return V_11 ;
V_95:
for (; V_140 > 0 ; V_140 -- )
...
int V_17 ;
V_17 = F_13 ( & V_11 -> V_17 ) ;
if ( V_17 >= 2 && F_164 ( V_443 , & V_11 -> V_348 ) )
return;
F_70 ( & V_11 -> V_352 ) ;
if ( ! F_249 ( V_443 , & V_11 -> V_348 ) )
F_82 ( & V_11 -> V_17 ) ;
F_74 ( & V_11 -> V_352 ) ;
}
...
struct V_10 * F_313 ( struct V_32 * V_175 ,
T_1 V_15 )
{
struct V_10 * V_11 ;
F_314 () ;
V_11 = F_315 ( & V_175 -> V_445 ,
V_15 >> V_127 ) ;
if ( V_11 && F_259 ( & V_11 -> V_17 ) ) {
F_316 () ;
if ( F_164 ( V_446 , & V_11 -> V_348 ) ) {
F_70 ( & V_11 -> V_352 ) ;
F_74 ( & V_11 -> V_352 ) ;
}
F_311 ( V_11 , NULL ) ;
...
struct V_10 * F_317 ( struct V_32 * V_175 ,
T_1 V_15 )
{
struct V_10 * V_11 , * V_447 = NULL ;
int V_74 ;
V_11 = F_313 ( V_175 , V_15 ) ;
if ( V_11 )
return V_11 ;
V_11 = F_306 ( V_175 , V_15 ) ;
if ( ! V_11 )
return NULL ;
V_11 -> V_175 = V_175 ;
V_104:
V_74 = F_318 ( V_125 & ~ V_448 ) ;
if ( V_74 )
goto V_449;
F_70 ( & V_175 -> V_450 ) ;
V_74 = F_319 ( & V_175 -> V_445 ,
V_15 >> V_127 , V_11 ) ;
F_74 ( & V_175 -> V_450 ) ;
F_320 () ;
if ( V_74 == - V_84 ) {
V_447 = F_313 ( V_175 , V_15 ) ;
if ( V_447 )
goto V_449;
else
goto V_104;
...
struct V_10 * F_321 ( struct V_32 * V_175 ,
T_1 V_15 )
{
unsigned long V_21 = V_175 -> V_441 -> V_442 ;
...
V_60 = F_322 ( V_28 , V_126 , V_125 | V_427 ) ;
if ( ! V_60 )
goto V_449;
F_70 ( & V_28 -> V_379 ) ;
if ( F_196 ( V_60 ) ) {
V_447 = (struct V_10 * ) V_60 -> V_50 ;
if ( F_259 ( & V_447 -> V_17 ) ) {
F_74 ( & V_28 -> V_379 ) ;
F_118 ( V_60 ) ;
F_106 ( V_60 ) ;
...
static inline void F_325 ( struct V_452 * V_6 )
{
struct V_10 * V_11 =
F_326 ( V_6 , struct V_10 , V_452 ) ;
F_294 ( V_11 ) ;
}
...
if ( V_17 <= 3 )
break;
V_453 = F_331 ( & V_11 -> V_17 , V_17 , V_17 - 1 ) ;
if ( V_453 == V_17 )
return;
}
F_70 ( & V_11 -> V_352 ) ;
...
F_71 ( & V_11 -> V_17 ) ;
if ( F_13 ( & V_11 -> V_17 ) == 2 &&
F_164 ( V_446 , & V_11 -> V_348 ) &&
! F_295 ( V_11 ) &&
F_239 ( V_443 , & V_11 -> V_348 ) )
F_71 ( & V_11 -> V_17 ) ;
F_327 ( V_11 ) ;
}
...
F_41 ( ! F_196 ( V_129 ) ) ;
F_105 ( V_129 ) ;
F_334 ( & V_129 -> V_28 -> V_454 ) ;
if ( ! F_121 ( V_129 ) ) {
F_335 ( & V_129 -> V_28 -> V_455 ,
F_336 ( V_129 ) ,
V_376 ) ;
}
F_337 ( & V_129 -> V_28 -> V_454 ) ;
F_231 ( V_129 ) ;
F_118 ( V_129 ) ;
}
F_41 ( F_13 ( & V_11 -> V_17 ) == 0 ) ;
...
int V_456 = 0 ;
F_310 ( V_11 ) ;
V_456 = F_249 ( V_353 , & V_11 -> V_348 ) ;
V_202 = F_152 ( V_11 -> V_15 , V_11 -> V_21 ) ;
F_41 ( F_13 ( & V_11 -> V_17 ) == 0 ) ;
F_41 ( ! F_164 ( V_443 , & V_11 -> V_348 ) ) ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ )
...
V_202 = F_152 ( V_11 -> V_15 , V_11 -> V_21 ) ;
for ( V_140 = V_457 ; V_140 < V_202 ; V_140 ++ ) {
V_129 = V_11 -> V_138 [ V_140 ] ;
if ( V_109 == V_461 ) {
if ( ! F_243 ( V_129 ) )
goto V_462;
...
F_245 ( V_463 , & V_11 -> V_348 ) ;
V_11 -> V_464 = 0 ;
F_36 ( & V_11 -> V_365 , V_460 ) ;
for ( V_140 = V_457 ; V_140 < V_202 ; V_140 ++ ) {
V_129 = V_11 -> V_138 [ V_140 ] ;
if ( ! F_206 ( V_129 ) ) {
F_231 ( V_129 ) ;
V_95 = F_218 ( V_25 , V_129 ,
V_289 , & V_41 ,
V_174 , & V_217 ,
V_317 | V_366 ) ;
if ( V_95 )
...
if ( V_41 ) {
V_95 = F_187 ( V_317 | V_366 , V_41 , V_174 ,
V_217 ) ;
if ( V_95 )
return V_95 ;
}
...
void F_344 ( struct V_10 * V_11 , void * V_466 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_10 V_293 ;
...
struct V_129 * V_129 ;
char * V_467 ;
char * V_468 = ( char * ) V_466 ;
T_10 V_469 = V_11 -> V_15 & ( ( T_1 ) V_149 - 1 ) ;
unsigned long V_140 = ( V_469 + V_15 ) >> V_127 ;
F_41 ( V_15 > V_11 -> V_21 ) ;
F_41 ( V_15 + V_21 > V_11 -> V_15 + V_11 -> V_21 ) ;
V_56 = ( V_469 + V_15 ) & ( V_149 - 1 ) ;
while ( V_21 > 0 ) {
V_129 = V_11 -> V_138 [ V_140 ] ;
V_293 = F_131 ( V_21 , ( V_149 - V_56 ) ) ;
V_467 = F_345 ( V_129 ) ;
memcpy ( V_468 , V_467 + V_56 , V_293 ) ;
V_468 += V_293 ;
V_21 -= V_293 ;
V_56 = 0 ;
V_140 ++ ;
...
int F_346 ( struct V_10 * V_11 , void T_17 * V_466 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_10 V_293 ;
...
struct V_129 * V_129 ;
char * V_467 ;
char T_17 * V_468 = ( char T_17 * ) V_466 ;
T_10 V_469 = V_11 -> V_15 & ( ( T_1 ) V_149 - 1 ) ;
unsigned long V_140 = ( V_469 + V_15 ) >> V_127 ;
int V_74 = 0 ;
F_41 ( V_15 > V_11 -> V_21 ) ;
...
V_293 = F_131 ( V_21 , ( V_149 - V_56 ) ) ;
V_467 = F_345 ( V_129 ) ;
if ( F_347 ( V_468 , V_467 + V_56 , V_293 ) ) {
V_74 = - V_470 ;
break;
}
V_468 += V_293 ;
...
unsigned long V_471 , char * * V_388 ,
unsigned long * V_472 ,
unsigned long * V_473 )
{
...
T_10 V_469 = V_11 -> V_15 & ( ( T_1 ) V_149 - 1 ) ;
unsigned long V_140 = ( V_469 + V_15 ) >> V_127 ;
unsigned long V_474 = ( V_469 + V_15 + V_471 - 1 ) >>
V_127 ;
if ( V_140 != V_474 )
return - V_405 ;
if ( V_140 == 0 ) {
...
V_56 = 0 ;
* V_472 = ( ( T_1 ) V_140 << V_127 ) - V_469 ;
}
if ( V_15 + V_471 > V_11 -> V_21 ) {
F_58 ( 1 , V_20 L_28
L_29 ,
V_11 -> V_15 , V_11 -> V_21 , V_15 , V_471 ) ;
return - V_405 ;
}
V_60 = V_11 -> V_138 [ V_140 ] ;
V_467 = F_345 ( V_60 ) ;
...
int F_349 ( struct V_10 * V_11 , const void * V_475 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_10 V_293 ;
...
V_293 = F_131 ( V_21 , ( V_149 - V_56 ) ) ;
V_467 = F_345 ( V_129 ) ;
V_74 = memcmp ( V_476 , V_467 + V_56 , V_293 ) ;
if ( V_74 )
break;
V_476 += V_293 ;
V_21 -= V_293 ;
...
void F_350 ( struct V_10 * V_11 , const void * V_477 ,
...
void F_351 ( struct V_10 * V_11 , char V_478 ,
unsigned long V_15 , unsigned long V_21 )
{
T_10 V_293 ;
T_10 V_56 ;
...
V_293 = F_131 ( V_21 , V_149 - V_56 ) ;
V_467 = F_345 ( V_129 ) ;
memset ( V_467 + V_56 , V_478 , V_293 ) ;
V_21 -= V_293 ;
V_56 = 0 ;
V_140 ++ ;
}
}
void F_305 ( struct V_10 * V_468 , struct V_10 * V_439 ,
unsigned long V_479 , unsigned long V_480 ,
unsigned long V_21 )
{
T_1 V_481 = V_468 -> V_21 ;
T_10 V_293 ;
T_10 V_56 ;
struct V_129 * V_129 ;
char * V_467 ;
T_10 V_469 = V_468 -> V_15 & ( ( T_1 ) V_149 - 1 ) ;
unsigned long V_140 = ( V_469 + V_479 ) >> V_127 ;
F_41 ( V_439 -> V_21 != V_481 ) ;
V_56 = ( V_469 + V_479 ) &
( V_149 - 1 ) ;
while ( V_21 > 0 ) {
V_129 = V_468 -> V_138 [ V_140 ] ;
F_41 ( ! F_206 ( V_129 ) ) ;
V_293 = F_131 ( V_21 , ( unsigned long ) ( V_149 - V_56 ) ) ;
V_467 = F_345 ( V_129 ) ;
F_344 ( V_439 , V_467 + V_56 , V_480 , V_293 ) ;
V_480 += V_293 ;
V_21 -= V_293 ;
V_56 = 0 ;
V_140 ++ ;
...
static inline bool F_352 ( unsigned long V_439 , unsigned long V_468 , unsigned long V_21 )
{
unsigned long V_482 = ( V_439 > V_468 ) ? V_439 - V_468 : V_468 - V_439 ;
return V_482 < V_21 ;
}
static void F_353 ( struct V_129 * V_483 , struct V_129 * V_484 ,
unsigned long V_485 , unsigned long V_486 ,
unsigned long V_21 )
{
char * V_487 = F_345 ( V_483 ) ;
char * V_488 ;
int V_489 = 0 ;
if ( V_483 != V_484 ) {
V_488 = F_345 ( V_484 ) ;
...
V_488 = V_487 ;
if ( F_352 ( V_486 , V_485 , V_21 ) )
V_489 = 1 ;
}
if ( V_489 )
memmove ( V_487 + V_485 , V_488 + V_486 , V_21 ) ;
else
memcpy ( V_487 + V_485 , V_488 + V_486 , V_21 ) ;
}
void F_354 ( struct V_10 * V_468 , unsigned long V_479 ,
...
unsigned long V_492 ;
unsigned long V_493 ;
if ( V_480 + V_21 > V_468 -> V_21 ) {
F_15 ( V_20 L_30
L_31 , V_480 , V_21 , V_468 -> V_21 ) ;
F_72 ( 1 ) ;
}
if ( V_479 + V_21 > V_468 -> V_21 ) {
F_15 ( V_20 L_32
L_31 , V_479 , V_21 , V_468 -> V_21 ) ;
F_72 ( 1 ) ;
}
while ( V_21 > 0 ) {
V_490 = ( V_469 + V_479 ) &
...
V_491 = ( V_469 + V_480 ) &
( V_149 - 1 ) ;
V_492 = ( V_469 + V_479 ) >> V_127 ;
V_493 = ( V_469 + V_480 ) >> V_127 ;
V_293 = F_131 ( V_21 , ( unsigned long ) ( V_149 -
V_491 ) ) ;
V_293 = F_117 (unsigned long, cur,
(unsigned long)(PAGE_CACHE_SIZE - dst_off_in_page)) ;
F_353 ( V_468 -> V_138 [ V_492 ] , V_468 -> V_138 [ V_493 ] ,
V_490 , V_491 , V_293 ) ;
V_480 += V_293 ;
V_479 += V_293 ;
V_21 -= V_293 ;
...
void F_355 ( struct V_10 * V_468 , unsigned long V_479 ,
unsigned long V_480 , unsigned long V_21 )
{
T_10 V_293 ;
T_10 V_490 ;
...
unsigned long V_495 = V_480 + V_21 - 1 ;
T_10 V_469 = V_468 -> V_15 & ( ( T_1 ) V_149 - 1 ) ;
unsigned long V_492 ;
unsigned long V_493 ;
if ( V_480 + V_21 > V_468 -> V_21 ) {
F_15 ( V_20 L_30
L_33 , V_480 , V_21 , V_468 -> V_21 ) ;
F_72 ( 1 ) ;
}
if ( V_479 + V_21 > V_468 -> V_21 ) {
F_15 ( V_20 L_32
L_33 , V_479 , V_21 , V_468 -> V_21 ) ;
F_72 ( 1 ) ;
}
if ( V_479 < V_480 ) {
F_354 ( V_468 , V_479 , V_480 , V_21 ) ;
return;
}
while ( V_21 > 0 ) {
V_492 = ( V_469 + V_494 ) >> V_127 ;
V_493 = ( V_469 + V_495 ) >> V_127 ;
V_490 = ( V_469 + V_494 ) &
( V_149 - 1 ) ;
V_491 = ( V_469 + V_495 ) &
( V_149 - 1 ) ;
V_293 = F_117 (unsigned long, len, src_off_in_page + 1 ) ;
V_293 = F_131 ( V_293 , V_490 + 1 ) ;
F_353 ( V_468 -> V_138 [ V_492 ] , V_468 -> V_138 [ V_493 ] ,
V_490 - V_293 + 1 ,
V_491 - V_293 + 1 , V_293 ) ;
V_494 -= V_293 ;
