...
F_2 ( V_58 , ( T_2 * ) ( V_12 -> V_3 + V_59 ) ) ;
F_19 ( & V_16 -> V_12 ,
L_11 , V_17 , V_37 ) ;
return 0 ;
}
void F_20 ( struct V_1 * V_12 , int V_37 )
{
struct V_9 * V_10 ;
F_4 ( & V_12 -> V_16 -> V_12 , L_3 , V_17 ) ;
if ( V_37 < 0 || V_37 > 1 ) {
