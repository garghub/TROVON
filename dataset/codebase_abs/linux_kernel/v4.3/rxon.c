...
V_108 = true ;
if ( V_266 & V_269 ) {
V_4 -> V_52 . V_55 = V_95 -> V_270 ;
F_14 ( V_2 , V_4 ) ;
}
V_4 -> V_5 . V_177 = F_3 ( V_6 -> V_95 . V_271 ) ;
if ( V_6 -> V_95 . V_272 )
V_4 -> V_5 . V_17 |= V_18 ;
else
V_4 -> V_5 . V_17 &= ~ V_18 ;
...
if ( V_4 -> V_57 . V_58 ) {
V_4 -> V_57 . V_152 = V_95 -> V_276 &
V_277 ;
V_4 -> V_57 . V_278 = ! ! ( V_95 -> V_276 &
V_279 ) ;
F_86 ( V_2 , V_4 , V_95 ) ;
F_53 ( V_2 , & V_2 -> V_223 ) ;
}
F_52 ( V_2 , V_4 ) ;
if ( V_95 -> V_280 && ( V_2 -> V_28 != V_163 ) )
V_4 -> V_5 . V_17 |= V_178 ;
else
V_4 -> V_5 . V_17 &= ~ V_178 ;
if ( V_95 -> V_280 )
...
V_4 -> V_5 . V_17 &= ~ V_212 ;
memcpy ( V_4 -> V_5 . V_174 , V_95 -> V_237 , V_33 ) ;
if ( V_6 -> type == V_9 ||
V_6 -> type == V_15 ) {
if ( V_6 -> V_95 . V_281 ) {
V_4 -> V_5 . V_13 |= V_41 ;
...
F_69 ( V_2 , V_4 ) ;
if ( V_266 & V_273 && V_95 -> V_141 ) {
if ( V_2 -> V_250 . V_252 == V_283 )
F_73 ( V_2 , false ) ;
F_90 ( V_2 ) ;
V_2 -> V_122 = 1 ;
}
...
if ( V_40 )
F_2 ( V_2 , L_65 ,
V_95 -> V_285 ? L_66 : L_67 ,
V_95 -> V_237 ) ;
}
if ( V_266 & V_286 && V_2 -> V_282 == V_4 ) {
if ( F_16 ( V_2 , V_6 ) )
F_2 ( V_2 , L_68 ) ;
}
F_85 ( & V_2 -> V_63 ) ;
...
{
struct V_3 * V_4 ;
F_100 ( V_2 , & V_2 -> V_287 . V_288 , false ) ;
F_37 ( V_2 , V_2 -> V_119 , false ) ;
F_54 (priv, ctx)
if ( memcmp ( & V_4 -> V_5 , & V_4 -> V_70 , sizeof( V_4 -> V_5 ) ) )
F_69 ( V_2 , V_4 ) ;
