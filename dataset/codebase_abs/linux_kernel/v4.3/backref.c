...
V_48 -> V_68 = V_35 ;
if ( V_51 == ( T_1 ) - 1 )
V_25 = F_38 ( NULL , V_46 , & V_39 -> V_41 , V_48 ,
0 , 0 ) ;
else
V_25 = F_39 ( V_46 , & V_39 -> V_41 , V_48 ,
V_51 ) ;
F_34 ( & V_58 -> V_63 , V_61 ) ;
F_40 ( L_2
L_3 ,
...
if ( V_39 -> V_37 == 0 )
continue;
if ( V_69 && V_39 -> V_34 != V_69 ) {
V_25 = V_76 ;
goto V_64;
}
V_70 = F_30 ( V_58 , V_48 , V_51 , V_39 ,
V_50 , V_7 ,
V_52 ) ;
if ( V_70 == - V_77 ) {
continue;
...
F_46 ( & V_75 ) ;
V_67 = F_47 ( V_50 , & V_75 ) ;
V_39 -> V_36 = V_67 ? V_67 -> V_78 : 0 ;
V_39 -> V_43 = V_67 ?
(struct V_8 * ) ( V_79 ) V_67 -> V_80 : NULL ;
while ( ( V_67 = F_47 ( V_50 , & V_75 ) ) ) {
V_72 = F_21 ( V_28 ,
V_14 ) ;
if ( ! V_72 ) {
V_25 = - V_15 ;
...
memcpy ( V_72 , V_39 , sizeof( * V_39 ) ) ;
V_72 -> V_36 = V_67 -> V_78 ;
V_72 -> V_43 = (struct V_8 * )
( V_79 ) V_67 -> V_80 ;
F_48 ( & V_72 -> V_44 , & V_39 -> V_44 ) ;
}
F_49 ( V_50 ) ;
}
V_64:
...
static inline int F_51 ( struct V_29 * V_81 ,
struct V_29 * V_82 )
{
...
F_53 (pos, head) {
struct V_29 * V_39 ;
V_39 = F_54 ( V_83 , struct V_29 , V_44 ) ;
if ( V_39 -> V_36 )
continue;
if ( V_39 -> V_41 . type )
continue;
F_55 ( ! V_39 -> V_20 ) ;
V_4 = F_56 ( V_58 -> V_84 , V_39 -> V_20 ,
0 ) ;
if ( F_33 ( V_4 ) ) {
return F_35 ( V_4 ) ;
} else if ( ! F_57 ( V_4 ) ) {
...
static void F_62 ( struct V_32 * V_33 , int V_86 )
{
struct V_32 * V_87 ;
F_53 (pos1, head) {
struct V_32 * V_88 ;
...
static int F_65 ( struct V_91 * V_33 , T_1 V_92 ,
...
* V_52 += ( V_67 -> V_106 * V_98 ) ;
switch ( V_67 -> type ) {
case V_107 : {
struct V_108 * V_39 ;
V_39 = F_69 ( V_67 ) ;
V_25 = F_20 ( V_93 , V_39 -> V_46 , & V_97 ,
V_39 -> V_35 + 1 , 0 , V_67 -> V_109 ,
V_67 -> V_106 * V_98 , V_110 ) ;
break;
}
case V_111 : {
struct V_108 * V_39 ;
...
V_116 = V_48 -> V_54 [ 0 ] ;
V_22 = V_48 -> V_56 [ 0 ] ;
V_123 = F_73 ( V_116 , V_22 ) ;
F_55 ( V_123 < sizeof( * V_121 ) ) ;
V_121 = F_13 ( V_116 , V_22 , struct V_120 ) ;
V_122 = F_74 ( V_116 , V_121 ) ;
* V_52 += F_75 ( V_116 , V_121 ) ;
...
type = F_77 ( V_116 , V_131 ) ;
V_10 = F_78 ( V_116 , V_131 ) ;
switch ( type ) {
case V_111 :
V_25 = F_20 ( V_93 , 0 , NULL ,
* V_115 + 1 , V_10 ,
...
V_37 = F_80 ( V_116 , V_135 ) ;
V_2 . V_18 = F_81 ( V_116 ,
V_135 ) ;
V_2 . type = V_26 ;
V_2 . V_10 = F_82 ( V_116 , V_135 ) ;
if ( V_17 && V_2 . V_18 != V_17 ) {
V_25 = V_76 ;
break;
}
V_46 = F_83 ( V_116 , V_135 ) ;
...
static void F_86 ( struct V_49 * V_137 )
{
struct V_73 * V_67 = NULL ;
struct V_8 * V_9 ;
struct V_74 V_75 ;
F_46 ( & V_75 ) ;
while ( ( V_67 = F_47 ( V_137 , & V_75 ) ) ) {
if ( ! V_67 -> V_80 )
continue;
V_9 = (struct V_8 * ) ( V_79 ) V_67 -> V_80 ;
F_8 ( V_9 ) ;
V_67 -> V_80 = 0 ;
}
F_50 ( V_137 ) ;
...
if ( ! V_139 )
F_92 ( & V_58 -> V_143 ) ;
V_25 = F_89 ( V_139 , V_58 , V_109 , V_51 , V_141 ) ;
if ( ! V_139 )
F_93 ( & V_58 -> V_143 ) ;
return V_25 ;
}
int F_94 ( struct V_138 * V_139 ,
struct V_57 * V_58 , T_1 V_69 ,
T_1 V_17 , T_1 V_109 )
{
...
F_46 ( & V_75 ) ;
while ( 1 ) {
V_25 = F_88 ( V_139 , V_58 , V_109 , V_145 . V_92 , V_142 ,
V_141 , NULL , V_69 , V_17 ) ;
if ( V_25 == V_76 ) {
V_25 = 1 ;
break;
}
...
int F_98 ( struct V_45 * V_46 , T_1 V_146 ,
...
V_2 . type = V_152 ;
V_2 . V_10 = V_147 ;
V_25 = F_38 ( NULL , V_46 , & V_2 , V_48 , 0 , 0 ) ;
if ( V_25 < 0 )
return V_25 ;
while ( 1 ) {
V_116 = V_48 -> V_54 [ 0 ] ;
...
char * F_100 ( struct V_45 * V_153 , struct V_47 * V_48 ,
...
V_160 -= V_154 ;
if ( V_160 >= 0 )
F_101 ( V_4 , V_157 + V_160 ,
V_155 , V_154 ) ;
if ( V_4 != V_156 ) {
F_102 ( V_4 ) ;
F_58 ( V_4 ) ;
}
V_25 = F_103 ( V_153 , V_48 , V_36 , 0 ,
V_163 , & V_117 ) ;
if ( V_25 > 0 )
V_25 = - V_77 ;
if ( V_25 )
...
int F_108 ( struct V_57 * V_58 , T_1 V_166 ,
...
V_2 . V_18 = V_166 ;
V_2 . V_10 = ( T_1 ) - 1 ;
V_25 = F_38 ( NULL , V_58 -> V_136 , & V_2 , V_48 , 0 , 0 ) ;
if ( V_25 < 0 )
return V_25 ;
V_25 = F_110 ( V_58 -> V_136 , V_48 , 0 ) ;
if ( V_25 ) {
if ( V_25 > 0 )
V_25 = - V_77 ;
return V_25 ;
...
V_4 = V_48 -> V_54 [ 0 ] ;
V_123 = F_73 ( V_4 , V_48 -> V_56 [ 0 ] ) ;
F_55 ( V_123 < sizeof( * V_121 ) ) ;
V_121 = F_13 ( V_4 , V_48 -> V_56 [ 0 ] , struct V_120 ) ;
V_122 = F_74 ( V_4 , V_121 ) ;
F_40 ( L_5
L_6 ,
...
static int F_111 ( unsigned long * V_118 , struct V_3 * V_4 ,
struct V_1 * V_2 ,
...
int F_112 ( unsigned long * V_118 , struct V_3 * V_4 ,
...
return 1 ;
while ( 1 ) {
V_25 = F_111 ( V_118 , V_4 , V_2 , V_121 , V_123 ,
& V_174 , & type ) ;
if ( V_25 < 0 )
return V_25 ;
if ( type == V_107 ||
...
* V_172 = F_78 ( V_4 , V_174 ) ;
if ( V_2 -> type == V_124 ) {
struct V_126 * V_127 ;
V_127 = (struct V_126 * ) ( V_121 + 1 ) ;
* V_173 = F_76 ( V_4 , V_127 ) ;
} else {
...
struct V_49 * V_141 = NULL ;
struct V_73 * V_178 = NULL ;
struct V_73 * V_179 = NULL ;
struct V_144 V_180 = F_95 ( V_180 ) ;
struct V_74 V_181 ;
struct V_74 V_182 ;
F_40 ( L_10 ,
V_175 ) ;
if ( ! V_65 ) {
V_139 = F_115 ( V_58 -> V_136 ) ;
if ( F_33 ( V_139 ) )
return F_35 ( V_139 ) ;
F_96 ( V_58 , & V_180 ) ;
} else {
...
V_25 = F_87 ( V_139 , V_58 , V_175 ,
V_180 . V_92 , & V_164 ,
& V_7 ) ;
if ( V_25 )
goto V_64;
F_46 ( & V_181 ) ;
while ( ! V_25 && ( V_178 = F_47 ( V_164 , & V_181 ) ) ) {
V_25 = F_89 ( V_139 , V_58 , V_178 -> V_78 ,
V_180 . V_92 , & V_141 ) ;
if ( V_25 )
break;
F_46 ( & V_182 ) ;
while ( ! V_25 && ( V_179 = F_47 ( V_141 , & V_182 ) ) ) {
F_40 ( L_11
...
if ( ! V_65 ) {
F_97 ( V_58 , & V_180 ) ;
F_116 ( V_139 , V_58 -> V_136 ) ;
} else {
F_93 ( & V_58 -> V_143 ) ;
}
return V_25 ;
}
int F_117 ( T_1 V_166 , struct V_57 * V_58 ,
struct V_47 * V_48 ,
T_7 * V_176 , void * V_177 )
{
int V_25 ;
...
struct V_1 V_117 ;
int V_65 = V_48 -> V_65 ;
V_25 = F_108 ( V_58 , V_166 , V_48 , & V_117 , & V_122 ) ;
F_42 ( V_48 ) ;
if ( V_25 < 0 )
return V_25 ;
if ( V_122 & V_125 )
...
V_25 = F_114 ( V_58 , V_117 . V_18 ,
V_7 , V_65 ,
V_176 , V_177 ) ;
return V_25 ;
}
static int F_118 ( T_1 V_17 , struct V_45 * V_153 ,
struct V_47 * V_48 ,
...
V_188 = F_121 ( V_22 ) ;
V_131 = F_13 ( V_4 , V_22 , struct V_162 ) ;
for ( V_184 = 0 ; V_184 < F_122 ( V_4 , V_188 ) ; V_184 += V_185 ) {
V_154 = F_106 ( V_4 , V_131 ) ;
F_40 ( L_13
...
static int F_123 ( T_1 V_17 , struct V_45 * V_153 ,
struct V_47 * V_48 ,
T_8 * V_176 , void * V_177 )
{
int V_25 ;
...
unsigned long V_118 ;
while ( 1 ) {
V_25 = F_98 ( V_153 , V_17 , V_10 , V_48 , & V_151 ,
& V_10 ) ;
if ( V_25 < 0 )
break;
if ( V_25 ) {
...
V_36 = F_124 ( V_4 , V_151 ) ;
V_154 = F_125 ( V_4 , V_151 ) ;
V_25 = V_176 ( V_36 , V_154 ,
( unsigned long ) & V_151 -> V_190 , V_4 , V_177 ) ;
if ( V_25 )
break;
V_189 += F_125 ( V_4 , V_151 ) ;
V_189 += sizeof( * V_151 ) ;
}
F_102 ( V_4 ) ;
F_58 ( V_4 ) ;
...
static int F_126 ( T_1 V_17 , struct V_45 * V_153 ,
struct V_47 * V_48 , T_8 * V_176 ,
void * V_177 )
{
int V_25 ;
int V_191 = 0 ;
V_25 = F_118 ( V_17 , V_153 , V_48 , V_176 , V_177 ) ;
if ( ! V_25 )
++ V_191 ;
else if ( V_25 != - V_77 )
return V_25 ;
V_25 = F_123 ( V_17 , V_153 , V_48 , V_176 , V_177 ) ;
if ( V_25 == - V_77 && V_191 )
return 0 ;
return V_25 ;
}
static int F_127 ( T_1 V_17 , T_4 V_154 , unsigned long V_155 ,
...
V_194 = F_100 ( V_193 -> V_153 , V_193 -> V_47 , V_154 ,
...
int F_128 ( T_1 V_17 , struct V_192 * V_193 )
{
return F_126 ( V_17 , V_193 -> V_153 , V_193 -> V_47 ,
F_127 , V_193 ) ;
}
struct V_201 * F_129 ( T_4 V_202 )
{
struct V_201 * V_203 ;
T_9 V_204 ;
V_204 = F_130 ( T_9 , V_202 , sizeof( * V_203 ) ) ;
V_203 = F_131 ( V_204 ) ;
if ( ! V_203 )
return F_107 ( - V_15 ) ;
...
struct V_192 * F_132 ( T_10 V_202 , struct V_45 * V_153 ,
struct V_47 * V_48 )
{
struct V_192 * V_205 ;
struct V_201 * V_194 ;
