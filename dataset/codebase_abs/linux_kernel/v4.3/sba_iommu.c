...
{
struct V_88 * V_88 ;
V_88 = F_67 ( V_6 -> V_110 , V_39 , F_68 ( V_28 ) ) ;
if ( F_31 ( ! V_88 ) )
return NULL ;
V_85 = F_48 ( V_88 ) ;
}
...
#ifdef F_49
ASSERT ( V_35 -> V_111 ) ;
if ( F_19 ( ( * V_109 & ~ V_35 -> V_111 ) == 0 ) ) {
F_52 ( L_30 ,
V_35 -> V_111 , * V_109 ) ;
return V_85 ;
}
#endif
* V_109 = F_58 ( & V_6 -> V_112 -> V_35 , V_85 ,
V_28 , 0 , NULL ) ;
return V_85 ;
}
static void F_70 ( struct V_34 * V_35 , T_5 V_28 , void * V_113 ,
T_6 V_109 , struct V_99 * V_100 )
{
F_64 ( V_35 , V_109 , V_28 , 0 , NULL ) ;
F_71 ( ( unsigned long ) V_113 , F_68 ( V_28 ) ) ;
}
static T_4 int
F_72 (
struct V_6 * V_6 ,
...
#endif
if ( V_22 -> V_24 & V_119 ) {
T_3 V_8 = V_22 -> V_24 & ~ V_119 ;
V_117 = ( unsigned long ) V_8 & ~ V_46 ;
V_22 -> V_24 = 0 ;
if ( V_115 )
V_114 = F_9 ( V_114 ) ;
V_114 -> V_24 = V_8 | V_6 -> V_45 ;
V_116 = & ( V_6 -> V_10 [ V_8 >> V_31 ] ) ;
V_115 ++ ;
}
if ( V_67 ) {
unsigned long V_113 = ( unsigned long ) F_8 ( V_22 ) ;
ASSERT ( V_116 ) ;
V_114 -> V_25 += V_67 ;
V_67 += V_117 ;
V_117 = 0 ;
...
unsigned long V_122 ;
struct V_21 * V_114 ;
unsigned long V_117 , V_123 ;
int V_115 = 0 ;
unsigned int V_124 = F_76 ( V_35 ) ;
int V_125 ;
while ( V_23 > 0 ) {
unsigned long V_113 = ( unsigned long ) F_8 ( V_22 ) ;
V_114 = V_120 = V_22 ;
V_123 = V_121 = V_122 = V_22 -> V_126 ;
V_122 += V_113 ;
V_117 = V_113 & ~ V_46 ;
...
V_22 = F_9 ( V_22 ) ;
V_22 -> V_24 = V_22 -> V_25 = 0 ;
ASSERT ( V_22 -> V_126 <= V_105 ) ;
if ( ( ( V_123 + V_117 + V_22 -> V_126 + ~ V_46 ) & V_46 )
> V_105 )
break;
if ( V_123 + V_22 -> V_126 > V_124 )
break;
V_113 = ( unsigned long ) F_8 ( V_22 ) ;
if ( V_122 == V_113 )
{
V_121 += V_22 -> V_126 ;
V_122 += V_22 -> V_126 ;
...
V_120 -> V_25 = V_121 ;
V_123 = ( V_123 + V_117 + ~ V_46 ) & V_46 ;
ASSERT ( V_123 <= V_105 ) ;
V_125 = F_28 ( V_6 , V_35 , V_123 ) ;
if ( V_125 < 0 ) {
V_114 -> V_25 = 0 ;
return - 1 ;
}
V_114 -> V_24 = ( T_6 ) ( V_119 | ( V_125 << V_31 )
| V_117 ) ;
V_115 ++ ;
}
return V_115 ;
}
static int F_78 ( struct V_34 * V_35 , struct V_21 * V_127 ,
...
V_130 -> V_25 = V_130 -> V_126 ;
V_130 -> V_24 = F_50 ( F_8 ( V_130 ) ) ;
}
return V_129 ;
}
#endif
if ( V_23 == 1 ) {
V_127 -> V_25 = V_127 -> V_126 ;
V_127 -> V_24 = F_58 ( V_35 , F_8 ( V_127 ) , V_127 -> V_126 , V_98 , V_100 ) ;
return 1 ;
}
#ifdef F_37
F_18 ( & V_6 -> V_47 , V_39 ) ;
...
#endif
F_26 ( V_6 -> V_44 ) ;
V_128 = F_75 ( V_6 , V_35 , V_127 , V_23 ) ;
if ( V_128 < 0 ) {
F_81 ( V_35 , V_127 , V_23 , V_98 , V_100 ) ;
return 0 ;
}
V_129 = F_72 ( V_6 , V_127 , V_23 ) ;
#ifdef F_37
F_18 ( & V_6 -> V_47 , V_39 ) ;
if ( F_6 ( V_6 , L_35 ) )
{
...
#endif
ASSERT ( V_128 == V_129 ) ;
F_74 ( L_37 , V_55 , V_129 ) ;
return V_129 ;
}
static void F_81 ( struct V_34 * V_35 , struct V_21 * V_127 ,
int V_23 , enum V_97 V_98 ,
struct V_99 * V_100 )
{
#ifdef F_37
...
#endif
F_74 ( L_38 ,
V_55 , V_23 , F_8 ( V_127 ) , V_127 -> V_126 ) ;
#ifdef F_37
V_6 = F_53 ( V_35 ) ;
ASSERT ( V_6 ) ;
F_18 ( & V_6 -> V_47 , V_39 ) ;
...
F_27 ( & V_6 -> V_47 , V_39 ) ;
#endif
while ( V_23 && V_127 -> V_25 ) {
F_64 ( V_35 , V_127 -> V_24 ,
V_127 -> V_25 , V_98 , V_100 ) ;
V_127 = F_9 ( V_127 ) ;
V_23 -- ;
}
F_74 ( L_40 , V_55 , V_23 ) ;
...
V_6 -> V_135 = ~ V_6 -> V_107 + 1 ;
F_2 ( L_42 ,
V_55 , V_6 -> V_70 , V_6 -> V_45 , V_6 -> V_107 ,
V_6 -> V_135 >> 20 ) ;
switch ( V_92 ) {
case 4 * 1024 : V_131 = 0 ; break;
case 8 * 1024 : V_131 = 1 ; break;
case 16 * 1024 : V_131 = 2 ; break;
case 64 * 1024 : V_131 = 3 ; break;
default:
F_54 ( V_136 L_43 ,
V_92 >> 10 ) ;
break;
}
F_46 ( V_131 , V_6 -> V_70 + V_4 ) ;
V_6 -> V_93 = ( V_6 -> V_135 / V_92 ) * V_77 ;
V_6 -> V_10 = ( void * ) F_69 ( V_137 ,
F_68 ( V_6 -> V_93 ) ) ;
if ( ! V_6 -> V_10 )
F_54 ( V_136 L_44 ) ;
...
int V_142 = 16 ;
void * V_143 , * V_85 ;
V_85 = ( void * ) F_69 ( V_137 , F_68 ( V_92 ) ) ;
if ( ! V_85 )
F_54 ( V_136 L_48 ) ;
V_143 = V_85 ;
for ( ; ( T_2 ) V_143 < V_85 + V_92 ; V_143 += V_142 )
memcpy ( V_143 , V_141 , V_142 ) ;
V_94 = F_50 ( V_85 ) ;
F_2 ( L_49 , V_55 , V_94 ) ;
}
for ( V_134 = 0 ; V_134 < ( V_6 -> V_93 / V_77 ) ; V_134 ++ )
( ( T_2 * ) V_6 -> V_10 ) [ V_134 ] = ( 0x80000000000000FF | V_94 ) ;
#endif
F_46 ( V_6 -> V_45 | ( F_11 ( V_6 -> V_135 ) + V_31 ) , V_6 -> V_70 + V_71 ) ;
F_3 ( V_6 -> V_70 + V_71 ) ;
...
#ifdef F_37
V_6 -> V_13 [ 0 ] = 0x1 ;
V_6 -> V_10 [ 0 ] = 0x8000000000000000ULL | V_140 ;
#endif
#ifdef F_45
...
F_87 ( struct V_6 * V_6 )
{
struct V_133 * V_144 = NULL ;
struct V_145 * V_146 = NULL ;
V_144 = F_88 ( sizeof( * V_144 ) , V_137 ) ;
if ( ! V_144 )
F_54 ( V_136 L_53 ) ;
V_146 = F_88 ( sizeof( * V_146 ) , V_137 ) ;
if ( ! V_146 )
F_54 ( V_136 L_54 ) ;
V_146 -> V_147 = V_6 ;
V_144 -> V_148 = V_146 ;
V_144 -> V_104 = 0xFFFFFFFFUL ;
#ifdef F_89
V_144 -> V_35 . V_149 = & V_150 ;
#endif
V_6 -> V_112 = V_144 ;
}
static void T_8
...
V_151 = F_3 ( V_6 -> V_70 + V_153 + V_58 ) ;
V_151 &= ~ V_154 ;
F_46 ( V_151 , V_6 -> V_70 + V_153 + V_58 ) ;
}
}
...
V_6 -> V_159 = F_3 ( V_6 -> V_70 + V_160 ) ;
V_6 -> V_152 = F_3 ( V_6 -> V_70 + V_161 ) & 0xFFUL ;
V_6 -> V_104 = 0xFFFFFFFFFFFFFFFFUL ;
for ( V_156 = V_162 ; V_156 < V_162 + F_93 ( V_162 ) ; V_156 ++ ) {
if ( V_6 -> V_159 == V_156 -> V_159 ) {
V_6 -> V_163 = V_156 -> V_163 ;
if ( V_156 -> V_164 )
( V_156 -> V_164 ) ( V_6 ) ;
}
}
...
V_87 >> 10 , V_92 >> 10 ) ;
if ( ! V_6 -> V_163 ) {
V_6 -> V_163 = F_94 ( 24 , V_137 ) ;
if ( V_6 -> V_163 )
sprintf ( ( char * ) V_6 -> V_163 , L_57 ,
V_6 -> V_159 & 0xFFFF , ( V_6 -> V_159 >> 16 ) & 0xFFFF ) ;
else
V_6 -> V_163 = L_58 ;
}
F_82 ( V_6 ) ;
...
static void *
F_95 ( struct V_166 * V_167 , T_9 * V_168 )
{
struct V_6 * V_6 ;
T_9 V_169 = * V_168 ;
for ( V_6 = V_158 ; V_6 ; V_6 = V_6 -> V_157 )
if ( ! V_169 -- )
return V_6 ;
return NULL ;
}
static void *
F_96 ( struct V_166 * V_167 , void * V_170 , T_9 * V_168 )
{
struct V_6 * V_6 = V_170 ;
++ * V_168 ;
return V_6 -> V_157 ;
}
static void
F_97 ( struct V_166 * V_167 , void * V_170 )
{
}
static int
F_98 ( struct V_166 * V_167 , void * V_170 )
{
struct V_6 * V_6 = V_170 ;
unsigned long * V_32 = ( unsigned long * ) V_6 -> V_13 ;
int V_58 , V_171 = 0 ;
F_99 ( V_167 , L_60 ,
V_6 -> V_163 , ( ( V_6 -> V_152 >> 4 ) & 0xF ) , ( V_6 -> V_152 & 0xF ) ) ;
#ifdef F_66
if ( V_6 -> V_110 != V_172 )
F_99 ( V_167 , L_61 , V_6 -> V_110 ) ;
#endif
F_99 ( V_167 , L_62 , ( ( V_6 -> V_93 >> 3 ) * V_92 ) / ( 1024 * 1024 ) ) ;
F_99 ( V_167 , L_63 , V_92 / 1024 ) ;
for ( V_58 = 0 ; V_58 < ( V_6 -> V_17 / sizeof( unsigned long ) ) ; ++ V_58 , ++ V_32 )
V_171 += F_100 ( * V_32 ) ;
F_99 ( V_167 , L_64 , V_6 -> V_93 >> 3 ) ;
F_99 ( V_167 , L_65 , V_171 ) ;
#ifdef F_29
{
...
static int
F_101 ( struct V_175 * V_175 , struct V_176 * V_176 )
{
return F_102 ( V_176 , & V_177 ) ;
}
static void T_8
F_103 ( void )
{
...
if ( ! V_98 )
return;
F_105 ( V_158 -> V_163 , 0 , V_98 , & V_179 ) ;
}
static void
F_106 ( struct V_180 * V_149 )
{
T_10 V_181 , V_182 ;
T_11 V_183 ;
struct V_6 * V_6 ;
if ( ! F_107 ( V_149 ) )
F_54 ( V_136 L_69 , V_149 -> V_184 ) ;
if ( F_107 ( V_149 ) -> V_147 )
return;
V_181 = F_108 ( F_107 ( V_149 ) -> V_185 ) ;
if ( ! V_181 )
return;
do {
for ( V_6 = V_158 ; V_6 ; V_6 = V_6 -> V_157 )
if ( V_6 -> V_181 == V_181 ) {
F_107 ( V_149 ) -> V_147 = V_6 ;
return;
}
V_183 = F_109 ( V_181 , & V_182 ) ;
V_181 = V_182 ;
} while ( F_110 ( V_183 ) );
F_5 ( V_72 L_70 , F_111 ( V_149 ) , V_149 -> V_184 ) ;
}
static void T_8
F_112 ( struct V_6 * V_6 , T_10 V_181 )
{
#ifdef F_66
unsigned int V_110 ;
V_110 = F_113 ( V_181 ) ;
if ( V_110 != V_172 && ! F_114 ( V_110 ) )
V_110 = V_172 ;
V_6 -> V_110 = V_110 ;
#endif
}
...
struct V_186 * V_187 ;
V_188 = V_6 -> V_157 ;
V_183 = F_116 ( V_181 , & V_1 , & V_126 ) ;
if ( F_117 ( V_183 ) )
goto V_189;
V_183 = F_118 ( V_181 , & V_187 ) ;
if ( F_117 ( V_183 ) )
goto V_189;
...
static int F_120 ( struct V_193 * V_34 ,
const struct V_194 * V_195 )
{
struct V_6 * V_6 ;
V_6 = F_88 ( sizeof( * V_6 ) , V_137 ) ;
if ( ! V_6 )
return - V_196 ;
V_6 -> V_157 = V_188 ;
V_188 = V_6 ;
...
static int F_133 ( struct V_34 * V_35 , T_6 V_205 )
{
return 0 ;
}
static int T_8
