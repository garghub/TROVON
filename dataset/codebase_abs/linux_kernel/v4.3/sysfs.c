...
static T_5 F_82 ( struct V_77 * V_41 ,
struct V_78 * V_79 , int V_80 )
{
struct V_1 * V_2 = F_65 ( V_41 , struct V_1 , V_41 ) ;
...
V_107 -> string = F_84 ( V_7 , V_107 -> V_99 . V_124 ) ;
if ( V_107 -> string && F_85 ( & V_104 -> V_2 , & V_125 ) )
;
V_104 -> V_121 = 1 ;
}
