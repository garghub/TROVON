...
if ( V_2 )
return F_114 ( V_2 ) ;
V_3 = F_115 ( V_24 -> V_211 . V_30 , sizeof( * V_3 ) + sizeof( * V_239 ) ,
V_232 ) ;
if ( ! V_3 )
return NULL ;
V_239 = ( void * ) & V_3 [ 1 ] ;
V_239 -> V_229 = L_66 ;
V_239 -> V_189 = V_248 -> args [ 1 ] ;
V_3 -> V_16 = V_239 ;
V_3 -> V_12 = V_24 ;
V_3 -> V_211 = true ;
V_3 -> V_81 = V_239 -> V_229 ;
V_3 -> V_82 = V_89 ;
V_3 -> signal = V_248 -> args [ 0 ] ;
V_3 -> V_4 . V_234 = F_54 ;
F_101 ( & V_3 -> V_4 , & V_24 -> V_211 ) ;
return F_114 ( & V_3 -> V_4 . V_3 ) ;
}
static int F_116 ( struct V_254 * V_29 ,
struct V_23 * V_24 ,
struct V_235 * V_255 )
{
struct V_10 * V_11 ;
...
T_1 V_20 ;
int V_13 ;
V_11 = F_115 ( & V_29 -> V_30 , sizeof( * V_11 ) , V_232 ) ;
if ( ! V_11 )
return - V_201 ;
if ( F_117 ( V_255 , L_73 ) )
V_11 -> V_124 |= V_154 ;
...
V_11 -> V_178 |= V_125 ;
if ( ! V_11 -> V_178 ) {
F_102 ( & V_29 -> V_30 , L_78 ) ;
V_11 -> V_178 |= V_154 | V_125 ;
}
V_13 = F_118 ( V_255 , L_79 , & V_20 ) ;
if ( V_13 ) {
F_102 ( & V_29 -> V_30 , L_80 ) ;
V_20 = 1 ;
}
switch ( V_20 ) {
default:
...
V_13 = F_118 ( V_255 , L_82 , & V_20 ) ;
if ( V_13 ) {
F_102 ( & V_29 -> V_30 , L_83 ) ;
V_20 = 8 ;
}
switch ( V_20 ) {
default:
...
V_176 |= V_158 ;
V_11 -> V_175 . V_229 = L_56 ;
V_11 -> V_175 . V_176 = V_176 ;
V_11 -> V_175 . V_189 = V_11 -> V_178 ;
V_24 -> V_11 = V_11 ;
return F_119 ( V_29 -> V_30 . V_264 , F_113 ,
V_24 ) ;
}
static inline int F_116 ( struct V_254 * V_29 ,
struct V_23 * V_24 ,
struct V_235 * V_255 )
{
return - V_212 ;
}
static int F_120 ( struct V_254 * V_29 , const struct V_265 * V_31 )
{
struct V_23 * V_24 ;
const struct V_266 * V_8 = V_31 -> V_239 ;
struct V_235 * V_255 = V_29 -> V_30 . V_264 ;
T_1 V_267 ;
int V_13 = 0 ;
int V_75 ;
V_13 = F_121 ( V_29 , NULL ) ;
if ( V_13 )
return V_13 ;
V_13 = F_122 ( & V_29 -> V_30 , F_123 ( 32 ) ) ;
if ( V_13 )
goto V_268;
...
F_124 ( V_269 , V_24 -> memcpy . V_270 ) ;
V_24 -> memcpy . V_30 = & V_29 -> V_30 ;
V_24 -> memcpy . V_271 = F_60 ;
V_24 -> memcpy . V_272 = F_79 ;
V_24 -> memcpy . V_273 = F_63 ;
V_24 -> memcpy . V_274 = F_64 ;
V_24 -> memcpy . V_275 = F_74 ;
V_24 -> memcpy . V_276 = F_89 ;
V_24 -> memcpy . V_277 = F_91 ;
V_24 -> memcpy . V_278 = F_92 ;
V_24 -> memcpy . V_279 = F_90 ;
V_24 -> memcpy . V_280 = V_281 ;
V_24 -> memcpy . V_282 = V_281 ;
V_24 -> memcpy . V_283 = F_125 ( V_284 ) ;
V_24 -> memcpy . V_285 = V_286 ;
F_124 ( V_287 , V_24 -> V_211 . V_270 ) ;
F_124 ( V_288 , V_24 -> V_211 . V_270 ) ;
V_24 -> V_211 . V_30 = & V_29 -> V_30 ;
V_24 -> V_211 . V_271 = F_60 ;
V_24 -> V_211 . V_273 = F_63 ;
V_24 -> V_211 . V_274 = F_64 ;
V_24 -> V_211 . V_275 = F_74 ;
V_24 -> V_211 . V_289 = F_84 ;
V_24 -> V_211 . V_290 = F_88 ;
V_24 -> V_211 . V_276 = F_89 ;
V_24 -> V_211 . V_277 = F_91 ;
V_24 -> V_211 . V_278 = F_92 ;
V_24 -> V_211 . V_279 = F_90 ;
V_24 -> V_211 . V_280 = V_281 ;
V_24 -> V_211 . V_282 = V_281 ;
V_24 -> V_211 . V_283 = F_125 ( V_190 ) | F_125 ( V_185 ) ;
V_24 -> V_211 . V_285 = V_286 ;
V_24 -> V_11 = F_126 ( & V_29 -> V_30 ) ;
if ( ! V_24 -> V_11 ) {
if ( V_255 ) {
V_13 = F_116 ( V_29 , V_24 , V_255 ) ;
if ( V_13 )
goto V_291;
} else {
F_46 ( & V_29 -> V_30 , L_85 ) ;
...
V_24 -> V_71 = V_293 ;
V_267 = V_72 * V_24 -> V_71 * sizeof( T_1 ) ;
V_24 -> V_121 = F_127 ( V_294 , & V_24 -> V_29 -> V_30 ,
V_267 , V_295 , 0 ) ;
if ( ! V_24 -> V_121 ) {
V_13 = - V_201 ;
goto V_296;
}
V_24 -> V_37 = F_128 ( V_29 -> V_297 . V_298 , F_129 ( & V_29 -> V_297 ) ) ;
if ( ! V_24 -> V_37 ) {
V_13 = - V_201 ;
goto V_299;
}
...
V_13 = F_130 ( V_29 -> V_221 [ 0 ] , F_95 , 0 , V_294 , V_24 ) ;
if ( V_13 ) {
F_46 ( & V_29 -> V_30 , L_86 ,
V_123 , V_29 -> V_221 [ 0 ] ) ;
goto V_300;
...
V_19 -> V_31 = V_75 ;
V_19 -> V_37 = V_24 -> V_37 + F_131 ( V_75 ) ;
V_19 -> V_21 = V_19 -> V_37 + V_8 -> V_302 ;
F_132 ( & V_19 -> V_78 ) ;
if ( V_8 -> V_219 ) {
T_1 V_20 ;
V_20 = F_8 ( V_19 -> V_21 ) ;
...
V_24 -> V_8 -> V_76 , false ) ;
if ( V_13 <= 0 ) {
F_133 ( & V_24 -> V_29 -> V_30 ,
L_93 ,
V_123 , V_13 ) ;
goto V_305;
}
V_13 = F_99 ( V_24 , & V_24 -> V_211 ,
V_24 -> V_11 -> V_306 , true ) ;
if ( V_13 < 0 ) {
F_133 ( & V_24 -> V_29 -> V_30 ,
L_94 ,
V_123 , V_13 ) ;
...
F_136 ( V_29 ) , V_24 -> V_8 -> V_28 ? L_98 : L_10 , F_137 ( V_29 ) ,
( unsigned long long ) V_29 -> V_297 . V_298 , V_29 -> V_221 [ 0 ] ) ;
return 0 ;
V_309:
F_138 ( & V_24 -> memcpy ) ;
V_308:
...
V_143 = F_144 ( & V_217 ) ;
if ( V_143 )
F_145 (KERN_WARNING DRIVER_NAME
L_99 ,
retval) ;
return V_143 ;
}
