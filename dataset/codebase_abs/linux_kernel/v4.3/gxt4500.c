...
F_25 ( V_138 , V_48 ) ;
F_26 ( V_138 , V_161 , 0x333300 ) ;
V_48 -> V_162 = & V_163 ;
V_48 -> V_164 = V_165 ;
V_49 = F_27 ( & V_48 -> V_166 , 256 , 0 ) ;
if ( V_49 ) {
F_17 ( & V_138 -> V_145 , L_9 ) ;
goto V_167;
}
F_14 ( V_133 , V_48 ) ;
if ( ! F_28 ( & V_19 , V_48 , V_168 , NULL , 0 , & V_169 , 8 ) ) {
...
F_33 ( V_48 ) ;
V_148:
F_34 ( V_142 , F_20 ( V_138 , 1 ) ) ;
V_147:
F_34 ( V_141 , F_20 ( V_138 , 0 ) ) ;
V_146:
return - V_172 ;
}
static void F_35 ( struct V_137 * V_138 )
{
struct V_47 * V_48 = F_36 ( V_138 ) ;
struct V_2 * V_3 ;
if ( ! V_48 )
return;
V_3 = V_48 -> V_3 ;
