...
F_40 ( V_2 , V_75 ) ;
V_40 = F_38 ( V_2 ) ;
if ( F_35 ( V_79 , & V_2 -> V_28 ) &&
V_75 != V_20 && V_2 -> V_73 == V_20 )
V_2 -> V_67 = V_20 ;
if ( F_45 ( V_75 != V_2 -> V_67 ) ) {
if ( V_40 && ! F_35 ( V_79 , & V_2 -> V_28 ) ) {
if ( V_53 & V_80 ) {
if ( ( V_40 -> V_46 & V_81 ) == 0 )
...
if ( F_49 ( V_79 , & V_2 -> V_28 ) )
F_42 ( V_2 ) ;
if ( V_75 != V_20 ) {
if ( V_18 -> V_84 ) {
F_18 ( & V_2 -> V_78 ) ;
V_77 = V_18 -> V_84 ( V_2 , V_40 ) ;
F_13 ( & V_2 -> V_78 ) ;
if ( V_77 ) {
F_33 ( V_2 , V_77 ) ;
goto V_83;
...
static void F_47 ( struct V_1 * V_2 , struct V_39 * V_40 , unsigned int V_87 )
__releases( &gl->gl_spin
...
static void F_51 ( struct V_1 * V_2 , const int V_88 )
__releases( &gl->gl_spin
static void F_52 ( struct V_89 * V_90 )
{
struct V_1 * V_2 = F_53 ( V_90 , struct V_1 , V_91 ) ;
struct V_3 * V_4 = V_2 -> V_5 . V_6 ;
struct V_92 * V_93 ;
struct V_94 * V_94 ;
T_1 V_95 = V_2 -> V_5 . V_96 ;
V_93 = V_2 -> V_97 ;
if ( V_93 )
V_94 = F_54 ( V_4 -> V_98 , V_95 , 1 ) ;
else
V_94 = F_55 ( V_4 , V_95 , NULL , V_99 ) ;
if ( V_94 && ! F_56 ( V_94 ) ) {
F_57 ( V_94 ) ;
F_58 ( V_94 ) ;
}
...
struct V_1 * V_2 = F_53 ( V_90 , struct V_1 , V_101 . V_90 ) ;
int V_102 = 0 ;
...
void F_77 ( struct V_1 * V_2 , unsigned int V_75 , unsigned V_141 ,
struct V_39 * V_40 )
{
F_78 ( & V_40 -> V_43 ) ;
V_40 -> V_146 = V_2 ;
...
void F_81 ( unsigned int V_75 , unsigned V_141 , struct V_39 * V_40 )
{
V_40 -> V_44 = V_75 ;
V_40 -> V_46 = V_141 ;
V_40 -> V_52 = 0 ;
...
unsigned int V_75 , int V_141 , struct V_39 * V_40 )
{
struct V_1 * V_2 ;
int error ;
...
if ( V_194 -> V_5 . V_96 > V_195 -> V_5 . V_96 )
return 1 ;
if ( V_194 -> V_5 . V_96 < V_195 -> V_5 . V_96 )
return - 1 ;
return 0 ;
...
static void F_123 ( T_3 V_209 , const struct V_3 * V_4 )
{
struct V_1 * V_2 ;
struct V_210 * V_211 , * V_42 ;
...
static const char * F_141 ( char * V_218 , unsigned V_141 , unsigned long V_219 )
{
char * V_185 = V_218 ;
if ( V_141 & V_59 )
* V_185 ++ = 't' ;
...
F_140 ( V_2 -> V_19 ) ,
V_2 -> V_5 . V_108 ,
( unsigned long long ) V_2 -> V_5 . V_96 ,
F_145 ( V_232 , V_2 ) ,
F_140 ( V_2 -> V_67 ) ,
...
static void * F_163 ( struct V_160 * V_161 , T_4 * V_211 )
{
...
static void * F_169 ( struct V_160 * V_161 , T_4 * V_211 )
{
F_68 () ;
if ( * V_211 >= V_260 )
return NULL ;
...
static int F_172 ( struct V_94 * V_94 , struct V_261 * V_261 )
{
...
static int F_175 ( struct V_94 * V_94 , struct V_261 * V_261 )
{
struct V_160 * V_161 = V_261 -> V_142 ;
struct V_254 * V_255 = V_161 -> V_243 ;
V_255 -> V_2 = NULL ;
F_176 ( & V_255 -> V_256 ) ;
return F_177 ( V_94 , V_261 ) ;
}
static int F_178 ( struct V_94 * V_94 , struct V_261 * V_261 )
{
...
static int F_179 ( struct V_94 * V_94 , struct V_261 * V_261 )
{
int V_53 = F_180 ( V_261 , & V_268 ) ;
if ( V_53 == 0 ) {
struct V_160 * V_161 = V_261 -> V_142 ;
V_161 -> V_243 = V_94 -> V_263 ;
}
return V_53 ;
}
