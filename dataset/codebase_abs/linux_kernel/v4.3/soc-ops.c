...
V_60 = F_32 ( V_13 -> V_22 . V_59 . V_60 , V_63 , V_64 | V_65 ) ;
if ( ! V_60 )
return - V_66 ;
if ( V_53 -> V_21 ) {
V_19 = F_33 ( V_15 -> V_57 , V_53 -> V_58 , & V_16 ) ;
if ( V_19 != 0 )
goto V_67;
V_16 &= V_53 -> V_21 ;
switch ( V_15 -> V_56 ) {
...
int F_38 ( struct V_1 * V_2 , int V_70 ,
