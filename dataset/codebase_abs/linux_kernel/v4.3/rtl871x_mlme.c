...
int F_33 ( struct V_1 * V_65 , struct V_5 * V_6 )
{
int V_66 = true ;
...
static int F_34 ( struct V_59 * V_73 ,
struct V_59 * V_74 )
{
T_5 V_75 , V_76 ;
...
break;
V_84 = F_12 ( V_39 , struct V_5 , V_28 ) ;
if ( V_84 -> V_46 != true ) {
if ( V_85 == NULL ||
F_36 ( ( unsigned long ) V_85 -> V_41 ,
( unsigned long ) V_84 -> V_41 ) )
V_85 = V_84 ;
}
V_39 = V_39 -> V_40 ;
}
...
static void F_37 ( struct V_59 * V_74 ,
struct V_59 * V_73 ,
struct V_1 * V_2 )
{
T_3 V_86 = 0 , V_87 ;
if ( F_22 ( & V_2 -> V_9 , V_56 ) &&
F_34 ( & ( V_2 -> V_9 . V_13 . V_14 ) , V_73 ) ) {
...
static void F_38 ( struct V_1 * V_65 ,
struct V_59 * V_6 )
{
...
static void F_40 ( struct V_1 * V_65 ,
struct V_59 * V_97 )
{
struct V_38 * V_39 , * V_50 ;
T_3 V_98 ;
...
struct V_7 * V_8 = & V_65 -> V_9 ;
F_11 ( & V_8 -> V_18 , V_35 ) ;
if ( F_22 ( V_8 , V_117 ) == true ) {
F_49 ( & V_8 -> V_118 ) ;
F_50 ( V_8 , V_117 ) ;
}
if ( V_8 -> V_119 == true ) {
if ( F_22 ( V_8 , V_104 ) == true ) {
...
V_128 -> V_14 . V_51 ) ;
F_11 ( & V_126 -> V_133 , V_35 ) ;
F_58 ( V_65 , V_132 ) ;
F_14 ( & V_126 -> V_133 , V_35 ) ;
}
if ( F_22 ( V_8 ,
V_104 | V_114 | V_130 ) )
F_59 ( V_65 ) ;
...
void F_68 ( struct V_1 * V_65 , T_2 * V_4 )
{
unsigned long V_35 ;
struct V_131 * V_132 ;
struct V_7 * V_8 = & ( V_65 -> V_9 ) ;
struct V_173 * V_174 = (struct V_173 * ) V_4 ;
if ( F_69 ( & V_65 -> V_175 , V_174 -> V_176 ) == false )
return;
V_132 = F_57 ( & V_65 -> V_127 , V_174 -> V_176 ) ;
if ( V_132 != NULL ) {
return;
}
V_132 = F_66 ( & V_65 -> V_127 , V_174 -> V_176 ) ;
if ( V_132 == NULL )
return;
V_132 -> V_155 = 0 ;
...
void F_70 ( struct V_1 * V_65 , T_2 * V_4 )
{
...
void F_73 ( struct V_1 * V_65 , T_2 * V_4 )
{
struct V_184 * V_185 =
(struct V_184 * ) V_4 ;
struct V_131 * V_132 ;
...
{
if ( V_65 -> V_69 . V_191 == false )
V_65 -> V_69 . V_191 = true ;
}
void F_75 ( struct V_1 * V_65 )
{
struct V_7 * V_8 = & V_65 -> V_9 ;
...
return V_26 ;
V_206:
return F_82 ( V_65 , V_6 ) ;
}
T_1 F_83 ( struct V_1 * V_65 ,
struct V_67 * V_68 )
{
struct V_209 * V_210 = & V_65 -> V_211 ;
struct V_212 * V_213 ;
struct V_214 * V_215 ;
V_213 = F_5 ( sizeof( * V_213 ) , V_25 ) ;
if ( V_213 == NULL )
return V_26 ;
V_215 = F_84 ( sizeof( * V_215 ) , V_25 ) ;
if ( V_215 == NULL ) {
F_28 ( V_213 ) ;
return V_26 ;
}
...
int F_87 ( struct V_1 * V_65 , T_2 * V_241 , T_2 * V_242 ,
T_4 V_243 , T_4 V_244 )
{
...
static int F_88 ( struct V_1 * V_247 , T_2 * V_248 )
{
...
T_1 F_89 ( struct V_1 * V_65 , T_2 * V_241 ,
T_2 * V_242 , T_4 V_243 )
{
T_2 V_253 = 0 , V_254 ;
...
V_122 -> V_72 = F_93 ( V_68 -> V_70
> 0 ? 1 : 0 ) ;
V_122 -> V_95 = 0 ;
switch ( V_195 -> V_287 ) {
case V_288 :
V_122 -> V_107 = F_93 ( V_289 ) ;
break;
case V_290 :
case V_291 :
V_122 -> V_107 = F_93 ( V_292 ) ;
break;
case V_293 :
V_122 -> V_107 = F_93 ( V_294 ) ;
break;
default:
break;
}
V_122 -> V_80 . V_81 = F_93 (
V_195 -> V_295 ) ;
if ( V_13 -> V_14 . V_15 == V_171 )
V_122 -> V_80 . V_108 = F_93 ( 3 ) ;
V_122 -> V_15 = F_93 (
V_13 -> V_14 . V_15 ) ;
V_286 = F_94 ( V_195 ) ;
V_122 -> V_61 = V_286 ;
...
unsigned int F_97 ( struct V_1 * V_2 , T_2 * V_241 ,
...
struct V_296 * V_297 = & V_8 -> V_298 ;
V_297 -> V_301 = 0 ;
V_305 = F_98 ( V_241 + 12 , V_312 , & V_303 , V_243 - 12 ) ;
if ( V_305 && ( V_303 > 0 ) ) {
if ( V_310 -> V_155 == 0 ) {
V_304 = * V_302 ;
F_99 ( V_242 + V_304 , V_313 ,
V_314 , V_308 , V_302 ) ;
V_310 -> V_155 = 1 ;
}
V_304 = * V_302 ;
...
static void F_67 ( struct V_1 * V_2 , T_2 * V_325 , T_4 V_326 )
{
T_2 * V_305 , V_327 ;
int V_3 , V_106 ;
...
if ( ! V_297 -> V_301 )
return;
if ( ( V_297 -> V_299 == false ) &&
( V_195 -> V_299 == 1 ) )
V_297 -> V_299 = true ;
V_106 = 0 ;
V_305 = F_98 ( V_325 + sizeof( struct V_96 ) ,
V_312 ,
& V_106 , V_326 -
sizeof( struct V_96 ) ) ;
if ( V_305 && V_106 > 0 ) {
...
void F_101 ( struct V_1 * V_2 , int V_335 )
{
struct V_7 * V_8 = & V_2 -> V_9 ;
struct V_296 * V_297 = & V_8 -> V_298 ;
if ( ( V_297 -> V_301 == 1 ) && ( V_297 -> V_299 == true ) ) {
if ( V_297 -> V_300 [ V_335 ] == false ) {
F_102 ( V_2 , ( T_2 ) V_335 ) ;
