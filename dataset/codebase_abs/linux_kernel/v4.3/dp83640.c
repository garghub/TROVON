...
void * V_173 , int V_174 , T_2 V_175 )
{
struct V_55 * V_55 ;
struct V_176 V_177 ;
int V_3 , V_178 ;
int V_179 = ( V_175 >> V_180 ) & V_181 ;
T_2 V_182 = 0 ;
if ( V_175 & V_183 )
V_178 = ( V_179 + 2 ) * sizeof( T_2 ) ;
else
V_178 = ( V_179 + 1 ) * sizeof( T_2 ) ;
if ( V_174 < V_178 )
return V_174 ;
if ( V_175 & V_183 ) {
V_182 = * ( T_2 * ) V_173 ;
...
switch ( V_179 ) {
case 3 :
V_26 -> V_184 . V_45 = V_55 -> V_45 ;
case 2 :
V_26 -> V_184 . V_44 = V_55 -> V_44 ;
case 1 :
V_26 -> V_184 . V_48 = V_55 -> V_48 ;
case 0 :
V_26 -> V_184 . V_47 = V_55 -> V_47 ;
}
if ( ! V_182 ) {
V_3 = ( ( V_175 >> V_185 ) & V_186 ) - V_111 ;
V_182 = F_43 ( V_3 ) ;
}
V_177 . type = V_187 ;
V_177 . V_188 = F_11 ( & V_26 -> V_184 ) ;
V_177 . V_188 -= 35 ;
for ( V_3 = 0 ; V_3 < V_110 ; V_3 ++ ) {
if ( V_182 & F_43 ( V_3 ) ) {
V_177 . V_4 = V_3 ;
V_176 ( V_26 -> clock -> V_66 , & V_177 ) ;
}
}
return V_178 ;
}
...
switch ( type & V_192 ) {
case V_193 :
V_189 += V_194 + F_47 ( V_173 + V_189 ) + V_195 ;
break;
case V_196 :
V_189 += V_194 + V_197 + V_195 ;
break;
case V_198 :
V_189 += V_194 ;
break;
...
if ( V_144 -> V_174 + V_194 < V_189 + V_199 + sizeof( * V_50 ) )
return 0 ;
if ( F_48 ( type & V_200 ) )
V_51 = V_173 + V_189 + V_201 ;
else
V_51 = V_173 + V_189 ;
V_50 = ( T_2 * ) ( V_173 + V_189 + V_199 ) ;
...
F_37 ( & V_42 -> V_153 ) ;
F_10 ( V_40 , V_42 ) ;
F_54 ( & V_26 -> V_206 . V_207 ) ;
F_55 (&dp83640->rx_queue, skb) {
struct V_208 * V_209 ;
V_209 = (struct V_208 * ) V_144 -> V_210 ;
if ( F_45 ( V_144 , V_209 -> V_211 , V_42 ) ) {
F_56 ( V_144 , & V_26 -> V_206 ) ;
V_203 = F_57 ( V_144 ) ;
memset ( V_203 , 0 , sizeof( * V_203 ) ) ;
V_203 -> V_212 = F_58 ( V_42 -> V_46 ) ;
F_59 ( V_144 ) ;
F_38 ( & V_42 -> V_153 , & V_26 -> V_154 ) ;
break;
}
}
F_60 ( & V_26 -> V_206 . V_207 ) ;
if ( ! V_203 )
F_61 ( & V_42 -> V_153 , & V_26 -> V_42 ) ;
V_205:
F_62 ( & V_26 -> V_204 , V_117 ) ;
}
...
T_2 V_175 , type ;
V_214 = V_144 -> V_173 + 2 ;
for ( V_174 = F_67 ( V_144 ) - 2 ; V_174 > sizeof( type ) ; V_174 -= V_215 ) {
type = * ( T_2 * ) V_214 ;
V_175 = type & 0x0fff ;
type = type & 0xf000 ;
V_174 -= sizeof( type ) ;
V_214 += sizeof( type ) ;
if ( V_216 == type && V_174 >= sizeof( * V_40 ) ) {
V_40 = (struct V_40 * ) V_214 ;
F_50 ( V_26 , V_40 ) ;
V_215 = sizeof( * V_40 ) ;
} else if ( V_217 == type && V_174 >= sizeof( * V_55 ) ) {
V_55 = (struct V_55 * ) V_214 ;
F_63 ( V_26 , V_55 ) ;
V_215 = sizeof( * V_55 ) ;
} else if ( V_218 == type ) {
V_215 = F_44 ( V_26 , V_214 , V_174 , V_175 ) ;
} else {
V_215 = 0 ;
break;
}
...
static int F_68 ( struct V_143 * V_144 , int type )
{
...
F_72 ( & clock -> V_78 ) ;
F_72 ( & clock -> V_220 ) ;
F_73 ( & clock -> V_18 -> V_31 ) ;
F_74 ( clock -> V_89 . V_127 ) ;
F_74 ( clock ) ;
}
F_15 ( & V_219 ) ;
}
static void F_75 ( struct V_56 * clock , struct V_17 * V_18 )
{
F_76 ( & clock -> V_153 ) ;
clock -> V_18 = V_18 ;
F_77 ( & clock -> V_78 ) ;
...
static int F_79 ( struct V_56 * clock ,
struct V_22 * V_23 )
{
...
static struct V_56 * F_80 ( struct V_56 * clock )
{
if ( clock )
F_14 ( & clock -> V_220 ) ;
return clock ;
}
static struct V_56 * F_81 ( struct V_17 * V_18 )
{
...
if ( clock )
goto V_205;
clock = F_82 ( sizeof( struct V_56 ) , V_237 ) ;
if ( ! clock )
goto V_205;
clock -> V_89 . V_127 = F_82 ( sizeof( struct V_1 ) *
V_5 , V_237 ) ;
if ( ! clock -> V_89 . V_127 ) {
F_74 ( clock ) ;
clock = NULL ;
...
F_75 ( clock , V_18 ) ;
F_61 ( & V_238 , & clock -> V_153 ) ;
V_205:
F_15 ( & V_219 ) ;
return F_80 ( clock ) ;
}
static void F_83 ( struct V_56 * clock )
{
F_15 ( & clock -> V_220 ) ;
}
...
if ( V_23 -> V_236 == V_21 )
return 0 ;
clock = F_81 ( V_23 -> V_18 ) ;
if ( ! clock )
goto V_240;
V_26 = F_82 ( sizeof( struct V_25 ) , V_237 ) ;
if ( ! V_26 )
goto V_241;
V_26 -> V_23 = V_23 ;
F_85 ( & V_26 -> V_242 , V_243 ) ;
F_76 ( & V_26 -> V_42 ) ;
F_76 ( & V_26 -> V_154 ) ;
...
if ( F_79 ( clock , V_23 ) ) {
clock -> V_61 = V_26 ;
clock -> V_66 = F_88 ( & clock -> V_89 , & V_23 -> V_31 ) ;
if ( F_89 ( clock -> V_66 ) ) {
V_99 = F_90 ( clock -> V_66 ) ;
goto V_246;
}
} else
F_61 ( & V_26 -> V_153 , & clock -> V_128 ) ;
F_83 ( clock ) ;
return 0 ;
V_246:
clock -> V_61 = NULL ;
...
static int F_98 ( struct V_22 * V_23 , struct V_259 * V_260 )
{
struct V_25 * V_26 = V_23 -> V_27 ;
struct V_261 V_262 ;
T_2 V_263 , V_264 ;
if ( F_99 ( & V_262 , V_260 -> V_265 , sizeof( V_262 ) ) )
return - V_266 ;
if ( V_262 . V_117 )
return - V_67 ;
...
return F_100 ( V_260 -> V_265 , & V_262 , sizeof( V_262 ) ) ? - V_266 : 0 ;
}
...
struct V_143 * V_144 ;
while ( ( V_144 = F_64 ( & V_26 -> V_206 ) ) ) {
struct V_208 * V_209 ;
V_209 = (struct V_208 * ) V_144 -> V_210 ;
if ( ! F_33 ( V_54 , V_209 -> V_53 ) ) {
F_101 ( & V_26 -> V_206 , V_144 ) ;
break;
}
F_59 ( V_144 ) ;
}
...
static bool F_104 ( struct V_22 * V_23 ,
...
case V_306 :
F_108 ( V_144 ) -> V_307 |= V_308 ;
F_106 ( & V_26 -> V_213 , V_144 ) ;
break;
case V_309 :
default:
F_105 ( V_144 ) ;
...
static int F_109 ( struct V_22 * V_31 , struct V_310 * V_311 )
{
...
V_314 |
V_315 ;
V_311 -> V_316 = F_110 ( V_26 -> clock -> V_66 ) ;
V_311 -> V_317 =
( 1 << V_309 ) |
( 1 << V_306 ) |
( 1 << V_268 ) ;
