...
struct V_79 * V_80 = V_77 -> V_80 + V_77 -> V_81 ;
unsigned int V_60 ;
int V_61 , V_63 ;
T_3 V_82 , V_83 ;
T_3 V_84 = V_77 -> V_84 ;
...
return 0 ;
for ( V_61 = 0 ; V_61 < V_57 ; V_61 ++ ) {
if ( V_80 -> V_91 == V_77 -> V_91 ) {
V_77 -> V_81 ++ ;
if ( V_77 -> V_81 == V_77 -> V_92 ) {
V_77 -> V_81 = 0 ;
V_77 -> V_91 = V_77 -> V_91 ? 0 : 1 ;
}
if ( V_80 -> error ) {
V_63 = V_80 -> error ;
if ( V_63 != V_73 ||
...
static int F_53 ( struct V_1 * V_2 , int V_133 )
{
V_103 V_108 = ( T_3 ) V_133 , V_109 = 0 ;
int V_57 = 1000 ;
return F_41 ( V_2 , V_137 , & V_108 , & V_109 , V_57 ) ;
}
static int F_54 ( struct V_1 * V_2 , int * V_135 )
{
V_103 V_108 = 0 , V_109 = 0 ;
int V_57 = 1000 ;
int V_63 ;
