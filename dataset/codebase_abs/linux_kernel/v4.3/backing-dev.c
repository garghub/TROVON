...
F_73 ( & V_93 ) ;
F_111 (slot, &bdi->cgwb_tree, &iter, 0 )
F_83 ( * V_142 ) ;
while ( ( V_141 = F_112 ( & V_6 -> V_94 ) ) ) {
struct V_86 * V_80 =
F_113 ( V_141 , struct V_86 , V_88 ) ;
F_71 ( V_141 , & V_6 -> V_94 ) ;
V_80 -> V_6 = NULL ;
}
F_75 ( & V_93 ) ;
F_114 ( & V_6 -> V_107 ) ;
F_115 ( V_108 , ! F_116 ( & V_6 -> V_107 ) ) ;
}
void F_117 ( struct V_115 * V_116 )
{
F_118 ( V_143 ) ;
...
{
int V_51 ;
V_6 -> V_144 = F_64 ( sizeof( * V_6 -> V_144 ) , V_136 ) ;
if ( ! V_6 -> V_144 )
return - V_57 ;
...
int F_122 ( struct V_5 * V_6 , struct V_34 * V_90 ,
const char * V_150 , ... )
{
T_6 args ;
struct V_34 * V_35 ;
...
return 0 ;
va_start ( args , V_150 ) ;
V_35 = F_123 ( V_47 , V_90 , F_124 ( 0 , 0 ) , V_6 , V_150 , args ) ;
va_end ( args ) ;
if ( F_31 ( V_35 ) )
return F_32 ( V_35 ) ;
V_6 -> V_35 = V_35 ;
...
int F_127 ( struct V_5 * V_6 , T_7 V_35 )
{
return F_122 ( V_6 , NULL , L_19 , F_128 ( V_35 ) , F_129 ( V_35 ) ) ;
}
...
void F_134 ( struct V_5 * V_6 )
{
F_135 ( V_6 -> V_35 ) ;
F_57 ( & V_6 -> V_9 ) ;
}
void F_136 ( struct V_5 * V_6 )
{
F_132 ( V_6 ) ;
F_134 ( V_6 ) ;
}
int F_137 ( struct V_5 * V_6 , char * V_30 )
{
int V_51 ;
V_6 -> V_30 = V_30 ;
V_6 -> V_152 = 0 ;
...
void F_139 ( struct V_86 * V_80 , int V_154 )
{
...
void F_143 ( struct V_86 * V_80 , int V_154 )
{
enum V_157 V_158 ;
V_158 = V_154 ? V_159 : V_160 ;
if ( ! F_144 ( V_158 , & V_80 -> V_27 ) )
F_66 ( & V_161 [ V_154 ] ) ;
}
long F_145 ( int V_154 , long V_59 )
{
long V_41 ;
unsigned long V_162 = V_68 ;
F_146 ( V_163 ) ;
T_8 * V_155 = & V_156 [ V_154 ] ;
F_147 ( V_155 , & V_163 , V_164 ) ;
V_41 = F_148 ( V_59 ) ;
F_149 ( V_155 , & V_163 ) ;
F_150 ( F_151 ( V_59 ) ,
F_151 ( V_68 - V_162 ) ) ;
...
long F_152 ( struct V_165 * V_165 , int V_154 , long V_59 )
{
long V_41 ;
unsigned long V_162 = V_68 ;
F_146 ( V_163 ) ;
T_8 * V_155 = & V_156 [ V_154 ] ;
if ( F_116 ( & V_161 [ V_154 ] ) == 0 ||
...
int F_155 ( struct V_168 * V_169 , int V_170 ,
...
if ( F_156 ( V_171 , V_174 , sizeof( V_174 ) ) )
return - V_175 ;
F_157 ( V_176 L_22 ,
V_169 -> V_177 ) ;
* V_172 = 2 ;
