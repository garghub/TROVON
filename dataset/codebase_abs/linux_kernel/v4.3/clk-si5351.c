...
V_151 -> V_160 [ V_12 ] . V_35 = V_4 ;
V_151 -> V_160 [ V_12 ] . V_164 =
F_62 ( V_147 , L_26 ) ;
}
V_7 -> V_8 . V_165 = V_151 ;
return 0 ;
...
static int F_63 ( struct V_144 * V_7 ,
const struct V_166 * V_167 )
{
enum V_145 V_52 = (enum V_145 ) V_167 -> V_168 ;
struct V_150 * V_151 ;
struct V_1 * V_2 ;
struct V_169 V_170 ;
struct V_171 * V_171 ;
...
V_5 = F_29 ( V_2 , V_175 , V_151 -> V_157 [ V_175 ] ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_32 ,
V_175 , V_151 -> V_157 [ V_175 ] ) ;
return V_5 ;
}
}
for ( V_175 = 0 ; V_175 < 8 ; V_175 ++ ) {
V_5 = F_38 ( V_2 , V_175 ,
V_151 -> V_160 [ V_175 ] . V_161 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_33 ,
V_175 , V_151 -> V_160 [ V_175 ] . V_161 ) ;
return V_5 ;
}
V_5 = F_46 ( V_2 , V_175 ,
V_151 -> V_160 [ V_175 ] . V_162 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_34 ,
V_175 , V_151 -> V_160 [ V_175 ] . V_162 ) ;
return V_5 ;
}
V_5 = F_47 ( V_2 , V_175 ,
V_151 -> V_160 [ V_175 ] . V_104 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_35 ,
V_175 , V_151 -> V_160 [ V_175 ] . V_104 ) ;
return V_5 ;
}
V_5 = F_48 ( V_2 , V_175 ,
V_151 -> V_160 [ V_175 ] . V_163 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_36 ,
V_175 , V_151 -> V_160 [ V_175 ] . V_163 ) ;
return V_5 ;
}
}
if ( ! F_67 ( V_2 -> V_176 ) )
...
V_170 . V_184 = 0 ;
if ( ! F_67 ( V_2 -> V_176 ) ) {
V_2 -> V_185 = F_70 ( V_2 -> V_176 ) ;
V_170 . V_172 = & V_2 -> V_185 ;
V_170 . V_173 = 1 ;
}
V_2 -> V_29 . V_170 = & V_170 ;
V_171 = F_71 ( & V_7 -> V_8 , & V_2 -> V_29 ) ;
if ( F_67 ( V_171 ) ) {
F_3 ( & V_7 -> V_8 , L_37 , V_170 . V_158 ) ;
V_5 = F_66 ( V_171 ) ;
goto V_186;
}
if ( V_2 -> V_52 == V_53 ) {
...
V_170 . V_182 = & V_187 ;
if ( ! F_67 ( V_2 -> V_177 ) ) {
V_2 -> V_188 = F_70 ( V_2 -> V_177 ) ;
V_170 . V_172 = & V_2 -> V_188 ;
V_170 . V_173 = 1 ;
}
V_2 -> V_32 . V_170 = & V_170 ;
V_171 = F_71 ( & V_7 -> V_8 , & V_2 -> V_32 ) ;
if ( F_67 ( V_171 ) ) {
F_3 ( & V_7 -> V_8 , L_37 ,
V_170 . V_158 ) ;
V_5 = F_66 ( V_171 ) ;
...
V_170 . V_172 = V_172 ;
V_170 . V_173 = V_173 ;
V_171 = F_71 ( & V_7 -> V_8 , & V_2 -> V_189 [ 0 ] . V_28 ) ;
if ( F_67 ( V_171 ) ) {
F_3 ( & V_7 -> V_8 , L_37 , V_170 . V_158 ) ;
V_5 = F_66 ( V_171 ) ;
goto V_186;
...
V_171 = F_71 ( & V_7 -> V_8 , & V_2 -> V_189 [ 1 ] . V_28 ) ;
if ( F_67 ( V_171 ) ) {
F_3 ( & V_7 -> V_8 , L_37 , V_170 . V_158 ) ;
V_5 = F_66 ( V_171 ) ;
goto V_186;
}
V_174 = ( V_2 -> V_52 == V_159 ) ? 3 : 8 ;
V_172 [ 0 ] = V_190 [ 0 ] ;
if ( V_2 -> V_52 == V_192 )
V_172 [ 1 ] = V_190 [ 2 ] ;
else
...
sizeof( * V_2 -> V_195 ) , V_155 ) ;
V_2 -> V_160 = F_57 ( & V_7 -> V_8 , V_174 *
sizeof( * V_2 -> V_160 ) , V_155 ) ;
V_2 -> V_196 . V_197 = V_174 ;
V_2 -> V_196 . V_198 = F_57 ( & V_7 -> V_8 ,
V_174 * sizeof( * V_2 -> V_196 . V_198 ) , V_155 ) ;
if ( F_72 ( ! V_2 -> V_195 || ! V_2 -> V_160 ||
! V_2 -> V_196 . V_198 ) ) {
V_5 = - V_156 ;
goto V_186;
}
...
V_2 -> V_195 [ V_175 ] . V_28 . V_170 = & V_170 ;
memset ( & V_170 , 0 , sizeof( V_170 ) ) ;
V_170 . V_158 = V_199 [ V_175 ] ;
V_170 . V_182 = & V_200 ;
V_170 . V_184 = 0 ;
if ( V_151 -> V_160 [ V_175 ] . V_164 )
V_170 . V_184 |= V_87 ;
V_170 . V_172 = V_172 ;
V_170 . V_173 = 2 ;
V_171 = F_71 ( & V_7 -> V_8 , & V_2 -> V_195 [ V_175 ] . V_28 ) ;
if ( F_67 ( V_171 ) ) {
F_3 ( & V_7 -> V_8 , L_37 ,
V_170 . V_158 ) ;
V_5 = F_66 ( V_171 ) ;
...
V_199 [ 4 ] ;
V_2 -> V_160 [ V_175 ] . V_12 = V_175 ;
V_2 -> V_160 [ V_175 ] . V_2 = V_2 ;
V_2 -> V_160 [ V_175 ] . V_28 . V_170 = & V_170 ;
memset ( & V_170 , 0 , sizeof( V_170 ) ) ;
V_170 . V_158 = V_201 [ V_175 ] ;
V_170 . V_182 = & V_202 ;
V_170 . V_184 = 0 ;
if ( V_151 -> V_160 [ V_175 ] . V_162 == V_94 )
V_170 . V_184 |= V_87 ;
V_170 . V_172 = V_172 ;
V_170 . V_173 = V_173 ;
V_171 = F_71 ( & V_7 -> V_8 , & V_2 -> V_160 [ V_175 ] . V_28 ) ;
if ( F_67 ( V_171 ) ) {
F_3 ( & V_7 -> V_8 , L_37 ,
V_170 . V_158 ) ;
V_5 = F_66 ( V_171 ) ;
...
V_2 -> V_196 . V_198 [ V_175 ] = V_171 ;
if ( V_151 -> V_160 [ V_175 ] . V_35 != 0 ) {
int V_5 ;
V_5 = F_73 ( V_171 , V_151 -> V_160 [ V_175 ] . V_35 ) ;
if ( V_5 != 0 ) {
F_3 ( & V_7 -> V_8 , L_38 ,
V_5 ) ;
}
