...
{
struct V_1 * V_2 = F_58 ( V_112 ) ;
F_53 ( V_2 ) ;
}
static void F_59 ( struct V_1 * V_2 ,
struct V_79 * V_72 ,
T_3 V_113 ,
void * V_114 , T_4 V_115 )
{
if ( V_113 & V_116 )
F_60 ( V_84 , & V_72 -> V_85 ) ;
else
...
int F_70 ( struct V_118 * V_119 , void * V_120 )
{
...
if ( ! V_123 )
goto V_51;
F_72 ( V_119 , L_17 , V_112 -> V_128 ) ;
F_72 ( V_119 , L_18 , L_19 ,
L_20 , L_21 , L_22 ) ;
for ( V_18 = 0 ; V_18 < V_19 -> V_20 ; V_18 ++ ) {
V_17 = & V_19 -> V_21 [ V_18 ] ;
F_24 () ;
...
static T_4 F_75 ( struct V_1 * V_2 ,
...
T_3 * V_130 , * V_131 ;
T_4 type = 0 ;
if ( F_36 ( ! F_76 ( V_33 , V_34 + V_37 ) ) )
goto V_51;
V_129 = (struct V_129 * ) ( V_33 -> V_36 + V_34 ) ;
if ( V_129 -> V_132 != F_77 ( V_133 ) )
goto V_51;
if ( F_36 ( ! F_76 ( V_33 , V_34 + V_37 +
F_78 ( V_33 -> V_134 ) ) ) )
goto V_51;
V_38 = (struct V_38 * ) ( V_33 -> V_36 + V_34 + V_37 ) ;
if ( V_38 -> V_135 != F_77 ( V_136 ) )
goto V_51;
if ( V_38 -> V_137 != F_77 ( V_138 ) )
goto V_51;
if ( V_38 -> V_139 != V_39 )
goto V_51;
if ( V_38 -> V_140 != 4 )
...
V_59 = F_19 ( V_33 , V_34 ) ;
V_60 = F_21 ( V_33 , V_34 ) ;
if ( F_79 ( V_59 ) || F_80 ( V_59 ) ||
F_79 ( V_60 ) || F_80 ( V_60 ) ||
F_81 ( V_59 ) || F_82 ( V_59 ) ||
F_81 ( V_60 ) || F_82 ( V_60 ) )
goto V_51;
V_130 = F_18 ( V_33 , V_34 ) ;
if ( F_83 ( V_130 ) || F_84 ( V_130 ) )
goto V_51;
if ( V_38 -> V_141 != F_77 ( V_142 ) ) {
V_131 = F_20 ( V_33 , V_34 ) ;
if ( F_83 ( V_131 ) ||
F_84 ( V_131 ) )
goto V_51;
}
type = F_85 ( V_38 -> V_141 ) ;
V_51:
return type ;
}
static unsigned short F_86 ( struct V_32 * V_33 , int * V_34 )
{
unsigned short V_42 ;
V_42 = F_87 ( V_33 , * V_34 ) ;
if ( V_42 & V_143 )
...
if ( V_8 ) {
if ( F_89 ( V_2 , V_8 -> V_47 , V_42 ) ) {
V_82 = true ;
goto V_51;
}
V_145 = F_90 ( V_146 , V_133 , V_59 ,
V_2 -> V_147 , V_60 , V_130 ,
V_8 -> V_47 , V_130 ) ;
if ( ! V_145 )
goto V_51;
if ( V_42 & V_143 )
V_145 = F_91 ( V_145 , F_77 ( V_148 ) ,
V_42 & V_149 ) ;
F_92 ( V_145 ) ;
V_145 -> V_150 = F_93 ( V_145 ,
V_2 -> V_147 ) ;
V_2 -> V_151 . V_152 ++ ;
...
V_156 = F_96 ( V_2 , V_145 ,
V_69 ,
NULL , V_42 ) ;
else
V_156 = F_97 ( V_2 , V_145 , NULL , V_42 ) ;
if ( V_156 != V_157 ) {
F_50 ( V_2 , V_158 ) ;
V_82 = true ;
}
...
F_44 ( V_2 , V_33 , V_59 , V_67 ) ;
F_44 ( V_2 , V_33 , V_60 , V_67 ) ;
}
...
F_28 ( V_2 , V_59 , V_130 , V_42 ) ;
F_28 ( V_2 , V_60 , V_131 , V_42 ) ;
V_159 = ! F_89 ( V_2 , V_131 , V_42 ) ;
V_159 |= F_89 ( V_2 , V_130 , V_42 ) ;
V_51:
if ( V_159 )
F_48 ( V_33 ) ;
return V_159 ;
...
if ( V_161 -> V_162 )
goto V_51;
V_42 = F_86 ( V_161 -> V_33 , & V_34 ) ;
type = F_75 ( V_2 , V_161 -> V_33 , V_34 ) ;
if ( type != V_142 )
goto V_51;
