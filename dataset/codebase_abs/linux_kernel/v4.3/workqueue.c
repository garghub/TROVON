...
bool F_115 ( int V_55 , struct V_23 * V_24 ,
struct V_12 * V_83 , unsigned long V_100 )
{
struct V_2 * V_6 = & V_83 -> V_6 ;
bool V_16 = false ;
...
V_15 -> V_44 ++ ;
V_50 -> V_109 = V_104 ;
F_118 ( & V_50 -> V_52 , & V_15 -> V_51 ) ;
if ( F_54 ( V_15 ) && ! F_112 ( & V_15 -> V_110 ) )
F_119 ( & V_15 -> V_110 , V_104 + V_111 ) ;
F_9 ( ! ( V_15 -> V_32 & V_112 ) &&
V_15 -> V_48 == V_15 -> V_44 &&
F_48 ( & V_15 -> V_42 ) ) ;
}
...
static struct V_50 * F_121 ( int V_25 )
{
struct V_50 * V_50 ;
V_50 = F_122 ( sizeof( * V_50 ) , V_20 , V_25 ) ;
if ( V_50 ) {
F_123 ( & V_50 -> V_52 ) ;
F_123 ( & V_50 -> V_113 ) ;
F_123 ( & V_50 -> V_25 ) ;
...
static void F_124 ( struct V_50 * V_50 ,
struct V_14 * V_15 )
{
F_125 ( & V_15 -> V_115 ) ;
F_126 ( V_50 -> V_53 , V_15 -> V_116 -> V_117 ) ;
if ( V_15 -> V_32 & V_112 )
V_50 -> V_32 |= V_118 ;
F_99 ( & V_50 -> V_25 , & V_15 -> V_119 ) ;
F_127 ( & V_15 -> V_115 ) ;
}
static void F_128 ( struct V_50 * V_50 ,
struct V_14 * V_15 )
{
...
static struct V_50 * F_130 ( struct V_14 * V_15 )
{
struct V_50 * V_50 = NULL ;
int V_21 = - 1 ;
char V_123 [ 16 ] ;
V_21 = F_131 ( & V_15 -> V_124 , 0 , 0 , V_20 ) ;
if ( V_21 < 0 )
goto V_85;
V_50 = F_121 ( V_15 -> V_25 ) ;
if ( ! V_50 )
goto V_85;
V_50 -> V_15 = V_15 ;
V_50 -> V_21 = V_21 ;
...
V_50 -> V_53 = F_132 ( V_126 , V_50 , V_15 -> V_25 ,
L_6 , V_123 ) ;
if ( F_133 ( V_50 -> V_53 ) )
goto V_85;
F_134 ( V_50 -> V_53 , V_15 -> V_116 -> V_125 ) ;
F_135 ( V_50 -> V_53 , V_15 -> V_116 -> V_117 ) ;
F_124 ( V_50 , V_15 ) ;
F_80 ( & V_15 -> V_67 ) ;
V_50 -> V_15 -> V_48 ++ ;
F_117 ( V_50 ) ;
...
static void F_139 ( unsigned long V_128 )
{
struct V_14 * V_15 = ( void * ) V_128 ;
F_80 ( & V_15 -> V_67 ) ;
while ( F_54 ( V_15 ) ) {
struct V_50 * V_50 ;
unsigned long V_103 ;
V_50 = F_140 ( V_15 -> V_51 . V_129 , struct V_50 , V_52 ) ;
V_103 = V_50 -> V_109 + V_111 ;
if ( F_141 ( V_104 , V_103 ) ) {
F_119 ( & V_15 -> V_110 , V_103 ) ;
break;
}
F_138 ( V_50 ) ;
}
...
if ( F_50 ( & V_33 -> V_132 ) ) {
F_76 ( V_33 ) ;
F_99 ( & V_33 -> V_132 , & V_24 -> V_133 ) ;
F_61 ( V_24 -> V_131 -> V_53 ) ;
}
}
static void F_143 ( unsigned long V_128 )
{
struct V_14 * V_15 = ( void * ) V_128 ;
struct V_2 * V_6 ;
F_80 ( & V_15 -> V_67 ) ;
...
{
struct V_50 * V_131 = V_143 ;
struct V_23 * V_24 = V_131 -> V_144 ;
struct V_62 * V_113 = & V_131 -> V_113 ;
bool V_145 ;
F_134 ( V_58 , V_146 ) ;
V_131 -> V_53 -> V_32 |= V_138 ;
V_147:
F_154 ( V_142 ) ;
V_145 = F_155 () ;
F_80 ( & V_130 ) ;
while ( ! F_50 ( & V_24 -> V_133 ) ) {
struct V_22 * V_33 = F_58 ( & V_24 -> V_133 ,
struct V_22 , V_132 ) ;
struct V_14 * V_15 = V_33 -> V_15 ;
struct V_2 * V_6 , * V_65 ;
F_151 ( V_148 ) ;
...
F_81 ( & V_15 -> V_67 ) ;
if ( V_33 -> V_24 -> V_171 == 1 || V_33 -> V_24 -> V_131 )
...
int F_202 ( T_2 V_182 , struct V_183 * V_184 )
{
if ( ! F_203 () ) {
V_182 ( & V_184 -> V_6 ) ;
return 0 ;
}
F_198 ( & V_184 -> V_6 , V_182 ) ;
F_78 ( & V_184 -> V_6 ) ;
return 1 ;
}
void F_204 ( struct V_185 * V_116 )
{
if ( V_116 ) {
F_205 ( V_116 -> V_117 ) ;
F_137 ( V_116 ) ;
...
struct V_185 * F_206 ( T_4 V_186 )
{
struct V_185 * V_116 ;
V_116 = F_207 ( sizeof( * V_116 ) , V_186 ) ;
if ( ! V_116 )
goto V_85;
if ( ! F_208 ( & V_116 -> V_117 , V_186 ) )
goto V_85;
F_209 ( V_116 -> V_117 , V_187 ) ;
return V_116 ;
V_85:
F_204 ( V_116 ) ;
return NULL ;
}
static void F_210 ( struct V_185 * V_188 ,
const struct V_185 * V_189 )
{
V_188 -> V_125 = V_189 -> V_125 ;
F_209 ( V_188 -> V_117 , V_189 -> V_117 ) ;
V_188 -> V_190 = V_189 -> V_190 ;
}
static T_5 F_211 ( const struct V_185 * V_116 )
{
T_5 V_191 = 0 ;
V_191 = F_212 ( V_116 -> V_125 , V_191 ) ;
V_191 = F_213 ( F_214 ( V_116 -> V_117 ) ,
F_215 ( V_192 ) * sizeof( long ) , V_191 ) ;
return V_191 ;
}
static bool F_216 ( const struct V_185 * V_193 ,
const struct V_185 * V_194 )
{
if ( V_193 -> V_125 != V_194 -> V_125 )
return false ;
if ( ! F_217 ( V_193 -> V_117 , V_194 -> V_117 ) )
return false ;
return true ;
}
...
static void F_226 ( struct V_198 * V_199 )
{
struct V_23 * V_24 =
F_158 ( V_199 , struct V_23 , V_199 ) ;
if ( ! ( V_24 -> V_32 & V_69 ) )
F_201 ( V_24 -> V_96 ) ;
else
F_204 ( V_24 -> V_200 ) ;
...
static void F_227 ( struct V_198 * V_199 )
{
struct V_14 * V_15 = F_158 ( V_199 , struct V_14 , V_199 ) ;
F_228 ( & V_15 -> V_124 ) ;
F_204 ( V_15 -> V_116 ) ;
F_137 ( V_15 ) ;
}
...
F_191 ( & V_15 -> V_110 ) ;
F_191 ( & V_15 -> V_134 ) ;
F_233 ( & V_15 -> V_199 , F_227 ) ;
}
static struct V_14 * F_234 ( const struct V_185 * V_116 )
{
T_5 V_191 = F_211 ( V_116 ) ;
struct V_14 * V_15 ;
int V_25 ;
F_22 ( & V_17 ) ;
...
static void F_239 ( struct V_198 * V_199 )
{
F_240 ( V_204 ,
F_158 ( V_199 , struct V_22 , V_199 ) ) ;
}
...
F_125 ( & V_24 -> V_161 ) ;
F_242 ( & V_33 -> V_206 ) ;
V_205 = F_50 ( & V_24 -> V_207 ) ;
F_127 ( & V_24 -> V_161 ) ;
F_125 ( & V_17 ) ;
F_229 ( V_15 ) ;
F_127 ( & V_17 ) ;
F_233 ( & V_33 -> V_199 , F_239 ) ;
if ( V_205 )
F_233 ( & V_24 -> V_199 , F_226 ) ;
}
static void F_243 ( struct V_22 * V_33 )
{
struct V_23 * V_24 = V_33 -> V_24 ;
bool V_208 = V_24 -> V_32 & V_209 ;
F_22 ( & V_24 -> V_161 ) ;
if ( ! V_208 && V_33 -> V_77 == V_24 -> V_171 )
return;
F_80 ( & V_33 -> V_15 -> V_67 ) ;
if ( ! V_208 || ! V_210 ) {
...
struct V_14 * V_15 )
{
F_245 ( ( unsigned long ) V_33 & V_211 ) ;
...
V_33 -> V_98 = V_24 -> V_98 ;
F_243 ( V_33 ) ;
F_247 ( & V_33 -> V_206 , & V_24 -> V_207 ) ;
}
static struct V_22 * F_248 ( struct V_23 * V_24 ,
const struct V_185 * V_116 )
{
struct V_14 * V_15 ;
struct V_22 * V_33 ;
F_22 ( & V_17 ) ;
...
if ( ! V_15 )
return NULL ;
V_33 = F_249 ( V_204 , V_20 , V_15 -> V_25 ) ;
if ( ! V_33 ) {
F_229 ( V_15 ) ;
return NULL ;
}
...
static bool F_250 ( const struct V_185 * V_116 , int V_25 ,
int V_212 , T_6 * V_117 )
{
if ( ! V_201 || V_116 -> V_190 )
goto V_213;
...
if ( F_254 ( V_117 ) )
goto V_213;
F_251 ( V_117 , V_116 -> V_117 , V_202 [ V_25 ] ) ;
...
F_22 ( & V_24 -> V_161 ) ;
F_246 ( V_33 ) ;
V_214 = F_256 ( V_24 -> V_26 [ V_25 ] ) ;
F_257 ( V_24 -> V_26 [ V_25 ] , V_33 ) ;
return V_214 ;
}
static void F_258 ( struct V_215 * V_216 )
{
if ( V_216 ) {
int V_25 ;
F_236 (node)
F_79 ( V_216 -> V_217 [ V_25 ] ) ;
F_79 ( V_216 -> V_218 ) ;
F_204 ( V_216 -> V_116 ) ;
F_137 ( V_216 ) ;
}
...
{
struct V_215 * V_216 ;
struct V_185 * V_219 , * V_220 ;
int V_25 ;
F_22 ( & V_17 ) ;
V_216 = F_207 ( sizeof( * V_216 ) + V_221 * sizeof( V_216 -> V_217 [ 0 ] ) ,
V_20 ) ;
V_219 = F_206 ( V_20 ) ;
V_220 = F_206 ( V_20 ) ;
...
goto V_222;
F_210 ( V_219 , V_116 ) ;
F_251 ( V_219 -> V_117 , V_219 -> V_117 , V_223 ) ;
if ( F_57 ( F_254 ( V_219 -> V_117 ) ) )
F_209 ( V_219 -> V_117 , V_223 ) ;
F_210 ( V_220 , V_219 ) ;
V_216 -> V_218 = F_248 ( V_24 , V_219 ) ;
if ( ! V_216 -> V_218 )
goto V_222;
F_236 (node) {
if ( F_250 ( V_219 , V_25 , - 1 , V_220 -> V_117 ) ) {
V_216 -> V_217 [ V_25 ] = F_248 ( V_24 , V_220 ) ;
if ( ! V_216 -> V_217 [ V_25 ] )
goto V_222;
} else {
V_216 -> V_218 -> V_68 ++ ;
V_216 -> V_217 [ V_25 ] = V_216 -> V_218 ;
}
}
F_210 ( V_219 , V_116 ) ;
F_251 ( V_219 -> V_117 , V_219 -> V_117 , V_187 ) ;
V_216 -> V_116 = V_219 ;
V_216 -> V_24 = V_24 ;
F_204 ( V_220 ) ;
return V_216 ;
...
static void F_260 ( struct V_215 * V_216 )
{
int V_25 ;
F_125 ( & V_216 -> V_24 -> V_161 ) ;
F_210 ( V_216 -> V_24 -> V_200 , V_216 -> V_116 ) ;
F_236 (node)
V_216 -> V_217 [ V_25 ] = F_255 ( V_216 -> V_24 , V_25 ,
V_216 -> V_217 [ V_25 ] ) ;
F_246 ( V_216 -> V_218 ) ;
F_261 ( V_216 -> V_24 -> V_218 , V_216 -> V_218 ) ;
F_127 ( & V_216 -> V_24 -> V_161 ) ;
}
...
return - V_224 ;
if ( F_10 ( ( V_24 -> V_32 & V_225 ) && ! F_50 ( & V_24 -> V_207 ) ) )
return - V_224 ;
V_216 = F_259 ( V_24 , V_116 ) ;
if ( V_216 ) {
F_260 ( V_216 ) ;
V_16 = 0 ;
}
...
{
int V_25 = F_106 ( V_55 ) ;
int V_227 = V_226 ? - 1 : V_55 ;
struct V_22 * V_214 = NULL , * V_33 ;
struct V_185 * V_228 ;
T_6 * V_117 ;
F_22 ( & V_17 ) ;
if ( ! V_201 || ! ( V_24 -> V_32 & V_69 ) ||
V_24 -> V_200 -> V_190 )
return;
V_228 = V_229 ;
V_117 = V_228 -> V_117 ;
F_210 ( V_228 , V_24 -> V_200 ) ;
V_33 = F_24 ( V_24 , V_25 ) ;
if ( F_250 ( V_24 -> V_218 -> V_15 -> V_116 , V_25 , V_227 , V_117 ) ) {
if ( F_217 ( V_117 , V_33 -> V_15 -> V_116 -> V_117 ) )
return;
} else {
goto V_230;
}
V_33 = F_248 ( V_24 , V_228 ) ;
if ( ! V_33 ) {
F_174 ( L_9 ,
V_24 -> V_97 ) ;
goto V_230;
...
F_125 ( & V_24 -> V_161 ) ;
V_214 = F_255 ( V_24 , V_25 , V_33 ) ;
goto V_163;
V_230:
F_125 ( & V_24 -> V_161 ) ;
F_80 ( & V_24 -> V_218 -> V_15 -> V_67 ) ;
F_76 ( V_24 -> V_218 ) ;
F_81 ( & V_24 -> V_218 -> V_15 -> V_67 ) ;
V_214 = F_255 ( V_24 , V_25 , V_24 -> V_218 ) ;
V_163:
F_127 ( & V_24 -> V_161 ) ;
F_79 ( V_214 ) ;
}
...
struct V_14 * V_233 =
F_269 ( V_234 , V_55 ) ;
F_244 ( V_33 , V_24 , & V_233 [ V_231 ] ) ;
F_125 ( & V_24 -> V_161 ) ;
F_246 ( V_33 ) ;
F_127 ( & V_24 -> V_161 ) ;
}
return 0 ;
} else if ( V_24 -> V_32 & V_225 ) {
V_16 = F_265 ( V_24 , V_235 [ V_231 ] ) ;
F_270 ( ! V_16 && ( V_24 -> V_207 . V_107 != & V_24 -> V_218 -> V_206 ||
V_24 -> V_207 . V_129 != & V_24 -> V_218 -> V_206 ) ,
L_10 , V_24 -> V_97 ) ;
return V_16 ;
} else {
return F_265 ( V_24 , V_236 [ V_231 ] ) ;
}
}
static int F_271 ( int V_77 , unsigned int V_32 ,
const char * V_97 )
{
int V_237 = V_32 & V_69 ? V_238 : V_239 ;
if ( V_77 < 1 || V_77 > V_237 )
F_174 ( L_11 ,
V_77 , V_97 , 1 , V_237 ) ;
return F_272 ( V_77 , 1 , V_237 ) ;
}
struct V_23 * F_273 ( const char * V_240 ,
unsigned int V_32 ,
int V_77 ,
struct V_241 * V_174 ,
const char * V_242 , ... )
...
V_32 |= V_69 ;
if ( V_32 & V_69 )
V_243 = V_221 * sizeof( V_24 -> V_26 [ 0 ] ) ;
V_24 = F_207 ( sizeof( * V_24 ) + V_243 , V_20 ) ;
if ( ! V_24 )
return NULL ;
if ( V_32 & V_69 ) {
V_24 -> V_200 = F_206 ( V_20 ) ;
if ( ! V_24 -> V_200 )
goto V_246;
}
va_start ( args , V_242 ) ;
vsnprintf ( V_24 -> V_97 , sizeof( V_24 -> V_97 ) , V_240 , args ) ;
va_end ( args ) ;
V_77 = V_77 ? : V_247 ;
...
F_123 ( & V_24 -> V_162 ) ;
F_123 ( & V_24 -> V_133 ) ;
F_274 ( & V_24 -> V_160 , V_242 , V_174 , 0 ) ;
F_123 ( & V_24 -> V_158 ) ;
if ( F_267 ( V_24 ) < 0 )
goto V_246;
if ( V_32 & V_248 ) {
...
goto V_249;
V_131 -> V_144 = V_24 ;
V_131 -> V_53 = F_275 ( F_153 , V_131 , L_12 ,
V_24 -> V_97 ) ;
if ( F_133 ( V_131 -> V_53 ) ) {
F_137 ( V_131 ) ;
goto V_249;
...
V_24 -> V_131 = V_131 ;
F_135 ( V_131 -> V_53 , V_187 ) ;
F_61 ( V_131 -> V_53 ) ;
}
if ( ( V_24 -> V_32 & V_250 ) && F_276 ( V_24 ) )
goto V_249;
F_125 ( & V_17 ) ;
F_125 ( & V_24 -> V_161 ) ;
F_165 (pwq, wq)
...
F_165 (pwq, wq) {
int V_252 ;
for ( V_252 = 0 ; V_252 < V_30 ; V_252 ++ ) {
if ( F_10 ( V_33 -> V_76 [ V_252 ] ) ) {
F_127 ( & V_24 -> V_161 ) ;
return;
}
}
if ( F_10 ( ( V_33 != V_24 -> V_218 ) && ( V_33 -> V_68 > 1 ) ) ||
F_10 ( V_33 -> V_72 ) ||
F_10 ( ! F_50 ( & V_33 -> V_73 ) ) ) {
F_127 ( & V_24 -> V_161 ) ;
return;
...
void F_289 ( const char * V_240 , ... )
{
struct V_50 * V_50 = F_102 () ;
T_8 args ;
if ( V_50 ) {
va_start ( args , V_240 ) ;
vsnprintf ( V_50 -> V_255 , sizeof( V_50 -> V_255 ) , V_240 , args ) ;
va_end ( args ) ;
V_50 -> V_256 = true ;
}
}
void F_290 ( const char * V_257 , struct V_54 * V_53 )
{
T_2 * V_182 = NULL ;
char V_97 [ V_258 ] = { } ;
char V_255 [ V_259 ] = { } ;
...
return;
V_50 = F_291 ( V_53 ) ;
F_292 ( & V_182 , & V_50 -> V_61 , sizeof( V_182 ) ) ;
F_292 ( & V_33 , & V_50 -> V_89 , sizeof( V_33 ) ) ;
F_292 ( & V_24 , & V_33 -> V_24 , sizeof( V_24 ) ) ;
F_292 ( V_97 , V_24 -> V_97 , sizeof( V_97 ) - 1 ) ;
F_292 ( & V_256 , & V_50 -> V_256 , sizeof( V_256 ) ) ;
if ( V_256 )
F_292 ( V_255 , V_50 -> V_255 , sizeof( V_255 ) - 1 ) ;
if ( V_182 || V_97 [ 0 ] || V_255 [ 0 ] ) {
F_293 ( L_13 , V_257 , V_97 , V_182 ) ;
if ( V_255 [ 0 ] )
F_294 ( L_14 , V_255 ) ;
F_294 ( L_15 ) ;
}
...
{
F_294 ( L_16 , V_192 , V_15 -> V_116 -> V_117 ) ;
if ( V_15 -> V_25 != V_195 )
F_294 ( L_17 , V_15 -> V_25 ) ;
F_294 ( L_18 , V_15 -> V_32 , V_15 -> V_116 -> V_125 ) ;
}
static void F_296 ( bool V_260 , struct V_2 * V_6 )
{
if ( V_6 -> V_3 == F_157 ) {
struct V_149 * V_150 ;
V_150 = F_158 ( V_6 , struct V_149 , V_6 ) ;
F_294 ( L_19 , V_260 ? L_20 : L_4 ,
F_297 ( V_150 -> V_53 ) ) ;
} else {
F_294 ( L_21 , V_260 ? L_20 : L_4 , V_6 -> V_3 ) ;
}
}
...
struct V_2 * V_6 ;
struct V_50 * V_50 ;
bool V_261 = false , V_262 = false ;
int V_263 ;
F_299 ( L_22 , V_15 -> V_21 ) ;
F_295 ( V_15 ) ;
F_294 ( L_23 , V_33 -> V_72 , V_33 -> V_77 ,
! F_50 ( & V_33 -> V_132 ) ? L_24 : L_4 ) ;
...
if ( V_50 -> V_89 != V_33 )
continue;
F_294 ( L_26 , V_260 ? L_20 : L_4 ,
F_297 ( V_50 -> V_53 ) ,
V_50 == V_33 -> V_24 -> V_131 ? L_27 : L_4 ,
V_50 -> V_61 ) ;
...
if ( V_15 -> V_136 )
F_294 ( L_34 ,
F_297 ( V_15 -> V_136 -> V_53 ) ) ;
F_144 (worker, &pool->idle_list, entry) {
F_294 ( L_35 , V_266 ? L_36 : L_4 ,
F_297 ( V_50 -> V_53 ) ) ;
V_266 = false ;
}
F_294 ( L_15 ) ;
...
V_15 -> V_32 &= ~ V_112 ;
F_308 (worker, pool) {
unsigned int V_268 = V_50 -> V_32 ;
if ( V_268 & V_105 )
F_61 ( V_50 -> V_53 ) ;
F_9 ( ! ( V_268 & V_118 ) ) ;
V_268 |= V_122 ;
V_268 &= ~ V_118 ;
F_310 ( V_50 -> V_32 ) = V_268 ;
}
F_81 ( & V_15 -> V_67 ) ;
}
...
return;
F_251 ( & V_117 , V_15 -> V_116 -> V_117 , V_269 ) ;
if ( F_313 ( & V_117 ) != 1 )
return;
F_308 (worker, pool)
F_9 ( F_126 ( V_50 -> V_53 ,
...
static int F_314 ( struct V_270 * V_271 ,
unsigned long V_272 ,
void * V_273 )
{
int V_55 = ( unsigned long ) V_273 ;
struct V_14 * V_15 ;
struct V_23 * V_24 ;
int V_264 ;
switch ( V_272 & ~ V_274 ) {
...
static int F_315 ( struct V_270 * V_271 ,
unsigned long V_272 ,
void * V_273 )
{
int V_55 = ( unsigned long ) V_273 ;
...
{
struct V_283 * V_284 = F_158 ( V_6 , struct V_283 , V_6 ) ;
V_284 -> V_16 = V_284 -> V_182 ( V_284 -> V_285 ) ;
}
long F_317 ( int V_55 , long (* V_182)( void * ) , void * V_285 )
{
struct V_283 V_284 = { . V_182 = V_182 , . V_285 = V_285 } ;
F_160 ( & V_284 . V_6 , F_316 ) ;
F_199 ( V_55 , & V_284 . V_6 ) ;
F_180 ( & V_284 . V_6 ) ;
F_18 ( & V_284 . V_6 ) ;
return V_284 . V_16 ;
}
...
if ( V_24 -> V_32 & V_225 )
continue;
V_216 = F_259 ( V_24 , V_24 -> V_200 ) ;
if ( ! V_216 ) {
V_16 = - V_181 ;
break;
}
F_99 ( & V_216 -> V_158 , & V_287 ) ;
}
...
static struct V_23 * F_325 ( struct V_289 * V_290 )
{
struct V_291 * V_292 = F_158 ( V_290 , struct V_291 , V_290 ) ;
return V_292 -> V_24 ;
}
static T_10 F_326 ( struct V_289 * V_290 , struct V_293 * V_294 ,
char * V_295 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
return F_327 ( V_295 , V_296 , L_37 , ( bool ) ! ( V_24 -> V_32 & V_69 ) ) ;
}
static T_10 F_328 ( struct V_289 * V_290 ,
struct V_293 * V_294 , char * V_295 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
return F_327 ( V_295 , V_296 , L_37 , V_24 -> V_171 ) ;
}
static T_10 F_329 ( struct V_289 * V_290 ,
struct V_293 * V_294 , const char * V_295 ,
T_7 V_297 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
int V_298 ;
if ( sscanf ( V_295 , L_38 , & V_298 ) != 1 || V_298 <= 0 )
return - V_224 ;
F_282 ( V_24 , V_298 ) ;
return V_297 ;
}
static T_10 F_330 ( struct V_289 * V_290 ,
struct V_293 * V_294 , char * V_295 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
const char * V_299 = L_4 ;
int V_25 , V_300 = 0 ;
F_285 () ;
F_236 (node) {
V_300 += F_327 ( V_295 + V_300 , V_296 - V_300 ,
L_39 , V_299 , V_25 ,
F_24 ( V_24 , V_25 ) -> V_15 -> V_21 ) ;
V_299 = L_40 ;
}
V_300 += F_327 ( V_295 + V_300 , V_296 - V_300 , L_15 ) ;
F_287 () ;
return V_300 ;
}
static T_10 F_331 ( struct V_289 * V_290 , struct V_293 * V_294 ,
char * V_295 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
int V_300 ;
F_125 ( & V_24 -> V_161 ) ;
V_300 = F_327 ( V_295 , V_296 , L_37 , V_24 -> V_200 -> V_125 ) ;
F_127 ( & V_24 -> V_161 ) ;
return V_300 ;
}
static struct V_185 * F_332 ( struct V_23 * V_24 )
{
struct V_185 * V_116 ;
F_22 ( & V_17 ) ;
V_116 = F_206 ( V_20 ) ;
if ( ! V_116 )
return NULL ;
F_210 ( V_116 , V_24 -> V_200 ) ;
return V_116 ;
}
static T_10 F_333 ( struct V_289 * V_290 , struct V_293 * V_294 ,
const char * V_295 , T_7 V_297 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
struct V_185 * V_116 ;
int V_16 = - V_181 ;
...
if ( ! V_116 )
goto V_163;
if ( sscanf ( V_295 , L_38 , & V_116 -> V_125 ) == 1 &&
V_116 -> V_125 >= V_301 && V_116 -> V_125 <= V_302 )
V_16 = F_264 ( V_24 , V_116 ) ;
else
V_16 = - V_224 ;
V_163:
...
static T_10 F_334 ( struct V_289 * V_290 ,
struct V_293 * V_294 , char * V_295 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
int V_300 ;
F_125 ( & V_24 -> V_161 ) ;
V_300 = F_327 ( V_295 , V_296 , L_41 ,
F_335 ( V_24 -> V_200 -> V_117 ) ) ;
F_127 ( & V_24 -> V_161 ) ;
return V_300 ;
}
static T_10 F_336 ( struct V_289 * V_290 ,
struct V_293 * V_294 ,
const char * V_295 , T_7 V_297 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
...
static T_10 F_338 ( struct V_289 * V_290 , struct V_293 * V_294 ,
char * V_295 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
int V_300 ;
F_125 ( & V_24 -> V_161 ) ;
V_300 = F_327 ( V_295 , V_296 , L_37 ,
! V_24 -> V_200 -> V_190 ) ;
F_127 ( & V_24 -> V_161 ) ;
return V_300 ;
}
static T_10 F_339 ( struct V_289 * V_290 , struct V_293 * V_294 ,
const char * V_295 , T_7 V_297 )
{
struct V_23 * V_24 = F_325 ( V_290 ) ;
struct V_185 * V_116 ;
int V_303 , V_16 = - V_181 ;
F_262 () ;
V_116 = F_332 ( V_24 ) ;
if ( ! V_116 )
goto V_163;
V_16 = - V_224 ;
if ( sscanf ( V_295 , L_38 , & V_303 ) == 1 ) {
V_116 -> V_190 = ! V_303 ;
V_16 = F_264 ( V_24 , V_116 ) ;
}
V_163:
...
static T_10 F_340 ( struct V_289 * V_290 ,
struct V_293 * V_294 , char * V_295 )
{
int V_300 ;
F_125 ( & V_17 ) ;
...
static T_10 F_341 ( struct V_289 * V_290 ,
struct V_293 * V_294 , const char * V_295 , T_7 V_297 )
{
T_9 V_117 ;
int V_16 ;
if ( ! F_324 ( & V_117 , V_20 ) )
return - V_181 ;
V_16 = F_337 ( V_295 , V_117 ) ;
if ( ! V_16 )
V_16 = F_323 ( V_117 ) ;
F_205 ( V_117 ) ;
return V_16 ? V_16 : V_297 ;
}
static int T_11 F_342 ( void )
{
int V_304 ;
V_304 = F_343 ( & V_305 , NULL ) ;
if ( V_304 )
return V_304 ;
return F_344 ( V_305 . V_306 , & V_307 ) ;
}
static void F_345 ( struct V_289 * V_290 )
{
struct V_291 * V_292 = F_158 ( V_290 , struct V_291 , V_290 ) ;
F_137 ( V_292 ) ;
}
...
if ( F_10 ( V_24 -> V_32 & V_225 ) )
return - V_224 ;
V_24 -> V_292 = V_292 = F_207 ( sizeof( * V_292 ) , V_20 ) ;
if ( ! V_292 )
return - V_181 ;
V_292 -> V_24 = V_24 ;
V_292 -> V_290 . V_308 = & V_305 ;
V_292 -> V_290 . V_309 = V_24 -> V_97 ;
V_292 -> V_290 . V_310 = F_345 ;
F_346 ( & V_292 -> V_290 , true ) ;
V_16 = F_347 ( & V_292 -> V_290 ) ;
if ( V_16 ) {
F_137 ( V_292 ) ;
V_24 -> V_292 = NULL ;
return V_16 ;
...
if ( V_24 -> V_32 & V_69 ) {
struct V_293 * V_294 ;
for ( V_294 = V_311 ; V_294 -> V_294 . V_97 ; V_294 ++ ) {
V_16 = F_344 ( & V_292 -> V_290 , V_294 ) ;
if ( V_16 ) {
F_348 ( & V_292 -> V_290 ) ;
V_24 -> V_292 = NULL ;
return V_16 ;
...
F_346 ( & V_292 -> V_290 , false ) ;
F_349 ( & V_292 -> V_290 . V_312 , V_313 ) ;
return 0 ;
}
static void F_279 ( struct V_23 * V_24 )
{
struct V_291 * V_292 = V_24 -> V_292 ;
if ( ! V_24 -> V_292 )
return;
V_24 -> V_292 = NULL ;
F_348 ( & V_292 -> V_290 ) ;
...
V_229 = F_206 ( V_20 ) ;
F_245 ( ! V_229 ) ;
V_314 = F_207 ( V_221 * sizeof( V_314 [ 0 ] ) , V_20 ) ;
F_245 ( ! V_314 ) ;
F_236 (node)
F_245 ( ! F_352 ( & V_314 [ V_25 ] , V_20 ,
F_353 ( V_25 ) ? V_25 : V_195 ) ) ;
F_268 (cpu) {
V_25 = F_106 ( V_55 ) ;
if ( F_10 ( V_25 == V_195 ) ) {
F_174 ( L_43 , V_55 ) ;
...
{
int V_316 [ V_317 ] = { 0 , V_318 } ;
int V_252 , V_55 ;
F_10 ( F_356 ( struct V_22 ) < F_356 (long long) ) ;
F_245 ( ! F_208 ( & V_223 , V_20 ) ) ;
F_209 ( V_223 , V_187 ) ;
V_204 = F_357 ( V_22 , V_319 ) ;
F_358 ( F_314 , V_320 ) ;
F_359 ( F_315 , V_321 ) ;
F_350 () ;
F_268 (cpu) {
...
for ( V_252 = 0 ; V_252 < V_317 ; V_252 ++ ) {
struct V_185 * V_116 ;
F_245 ( ! ( V_116 = F_206 ( V_20 ) ) ) ;
V_116 -> V_125 = V_316 [ V_252 ] ;
V_236 [ V_252 ] = V_116 ;
F_245 ( ! ( V_116 = F_206 ( V_20 ) ) ) ;
V_116 -> V_125 = V_316 [ V_252 ] ;
V_116 -> V_190 = true ;
...
V_322 = F_361 ( L_44 , 0 , 0 ) ;
V_282 = F_361 ( L_45 , V_232 , 0 ) ;
V_323 = F_361 ( L_46 , 0 , 0 ) ;
V_324 = F_361 ( L_47 , V_69 ,
V_238 ) ;
V_325 = F_361 ( L_48 ,
V_209 , 0 ) ;
V_326 = F_361 ( L_49 ,
