...
if ( ! V_3 )
return - V_9 ;
F_12 ( V_8 , V_3 + V_26 , & V_22 ) ;
F_12 ( V_8 , V_3 + V_27 , & V_23 ) ;
if ( ( V_22 & V_28 ) ||
! ( V_23 & V_29 ) )
return - V_11 ;
F_17 ( V_8 , V_3 + V_30 , & V_24 ) ;
V_21 = F_18 ( V_24 , V_21 ) ;
F_19 ( V_8 , V_3 + V_31 , V_21 ) ;
V_22 |= V_28 ;
F_8 ( V_8 , V_3 + V_26 , V_22 ) ;
return 0 ;
}
...
int F_22 ( struct V_1 * V_8 , int V_33 )
{
T_1 V_22 , V_34 ;
int V_3 ;
V_3 = F_2 ( V_8 , V_35 ) ;
if ( ! V_3 )
return - V_9 ;
F_12 ( V_8 , V_3 + V_36 , & V_22 ) ;
F_12 ( V_8 , V_3 + V_37 , & V_34 ) ;
if ( V_22 & V_38 )
return - V_9 ;
V_34 &= V_39 | V_40 ;
if ( ( V_34 & V_33 ) != V_33 )
