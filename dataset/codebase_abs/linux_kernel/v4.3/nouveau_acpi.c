...
if ( ! V_39 )
return false ;
V_73 = F_37 ( V_39 , L_13 , & V_69 ) ;
if ( F_33 ( V_73 ) )
return false ;
V_1 . V_69 = V_69 ;
return true ;
}
int F_38 ( T_4 * V_70 , int V_71 , int V_72 )
{
return F_31 ( V_1 . V_69 , V_70 , V_71 , V_72 ) ;
}
void *
F_39 ( struct V_80 * V_49 , struct V_81 * V_82 )
{
struct V_83 * V_84 ;
T_1 V_4 ;
int type , V_20 ;
...
if ( V_20 )
return NULL ;
V_20 = F_41 ( V_84 , type , - 1 , & V_85 ) ;
if ( V_20 < 0 )
return NULL ;
return F_42 ( V_85 , V_90 , V_91 ) ;
}
