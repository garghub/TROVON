...
static int F_28 ( struct V_55 * V_47 )
{
struct V_56 * V_57 = & V_47 -> V_57 ;
struct V_58 * V_59 = F_29 ( V_57 ) ;
struct V_26 * V_27 ;
int V_29 = F_30 ( V_47 , 0 ) ;
int V_60 ;
int V_48 ;
if ( V_29 < 0 ) {
F_31 ( V_57 , L_1 ) ;
...
V_27 = F_32 ( sizeof( * V_27 ) , V_62 ) ;
if ( ! V_27 )
return - V_63 ;
F_33 ( V_57 , V_27 ) ;
V_27 -> V_47 = V_47 ;
V_27 -> V_29 = V_29 ;
V_27 -> V_30 = V_59 -> V_61 + V_64 ;
V_27 -> V_13 . V_65 = L_3 ;
V_27 -> V_13 . V_66 = F_3 ;
V_27 -> V_13 . V_67 = F_5 ;
V_27 -> V_13 . V_68 = F_6 ;
...
F_36 ( V_48 + V_27 -> V_30 , V_27 ) ;
F_37 ( V_48 + V_27 -> V_30 ,
& V_74 ,
V_75 ) ;
}
F_38 ( V_27 -> V_29 , F_20 , V_27 ) ;
return 0 ;
V_73:
F_39 ( V_27 ) ;
return V_60 ;
