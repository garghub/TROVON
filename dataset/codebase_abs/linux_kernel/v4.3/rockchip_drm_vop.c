...
for ( V_233 = 0 ; V_233 < V_232 -> V_270 ; V_233 ++ )
F_1 ( V_1 , V_264 [ V_233 ] . V_2 , V_264 [ V_233 ] . V_271 ) ;
for ( V_233 = 0 ; V_233 < V_232 -> V_235 ; V_233 ++ ) {
const struct V_45 * V_46 = & V_232 -> V_46 [ V_233 ] ;
F_70 ( V_1 , V_46 , V_180 , 0 ) ;
}
F_6 ( V_1 ) ;
V_1 -> V_224 = F_135 ( V_1 -> V_89 , L_34 ) ;
if ( F_132 ( V_1 -> V_224 ) ) {
F_36 ( V_1 -> V_89 , L_35 ) ;
...
static int F_139 ( struct V_245 * V_89 , struct V_245 * V_272 , void * V_125 )
{
struct V_273 * V_274 = F_140 ( V_89 ) ;
...
T_6 V_279 ;
int V_88 , V_100 ;
V_276 = F_141 ( V_280 , V_89 ) ;
V_232 = V_276 -> V_125 ;
if ( ! V_232 )
return - V_281 ;
V_279 = sizeof( * V_1 ) + sizeof( * V_1 -> V_46 ) * V_232 -> V_235 ;
V_1 = F_142 ( V_89 , V_279 , V_115 ) ;
if ( ! V_1 )
return - V_116 ;
V_1 -> V_89 = V_89 ;
V_1 -> V_125 = V_232 ;
...
F_143 ( V_89 , V_1 ) ;
F_137 ( V_1 ) ;
V_278 = F_144 ( V_274 , V_282 , 0 ) ;
V_1 -> V_97 = F_145 ( V_278 ) ;
V_1 -> V_4 = F_146 ( V_89 , V_278 ) ;
if ( F_132 ( V_1 -> V_4 ) )
return F_133 ( V_1 -> V_4 ) ;
V_1 -> V_5 = F_142 ( V_89 , V_1 -> V_97 , V_115 ) ;
if ( ! V_1 -> V_5 )
return - V_116 ;
V_88 = F_130 ( V_1 ) ;
if ( V_88 < 0 ) {
F_36 ( & V_274 -> V_89 , L_36 , V_88 ) ;
return V_88 ;
}
V_100 = F_147 ( V_274 , 0 ) ;
if ( V_100 < 0 ) {
...
F_148 ( & V_1 -> V_83 ) ;
F_149 ( & V_1 -> V_165 ) ;
V_88 = F_150 ( V_89 , V_1 -> V_100 , F_116 , F_115 ,
V_283 , F_151 ( V_89 ) , V_1 ) ;
if ( V_88 )
return V_88 ;
F_49 ( V_1 -> V_100 ) ;
V_88 = F_119 ( V_1 ) ;
...
static void F_153 ( struct V_245 * V_89 , struct V_245 * V_272 , void * V_125 )
{
struct V_1 * V_1 = F_154 ( V_89 ) ;
F_155 ( V_89 ) ;
F_127 ( V_1 ) ;
}
static int F_156 ( struct V_273 * V_274 )
{
struct V_245 * V_89 = & V_274 -> V_89 ;
if ( ! V_89 -> V_260 ) {
F_36 ( V_89 , L_38 ) ;
return - V_281 ;
}
return F_157 ( V_89 , & V_284 ) ;
}
static int F_158 ( struct V_273 * V_274 )
{
F_159 ( & V_274 -> V_89 , & V_284 ) ;
return 0 ;
}
