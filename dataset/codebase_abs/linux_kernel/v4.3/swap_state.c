...
* V_35 = false ;
do {
V_36 = F_50 ( V_38 , V_14 . V_16 ) ;
if ( V_36 )
break;
if ( ! V_37 ) {
V_37 = F_54 ( V_21 , V_33 , V_34 ) ;
if ( ! V_37 )
break;
}
V_24 = F_25 ( V_21 & V_39 ) ;
...
struct V_13 * F_62 ( T_1 V_14 , T_2 V_21 ,
struct V_32 * V_33 , unsigned long V_34 )
{
bool V_41 ;
struct V_13 * V_42 = F_53 ( V_14 , V_21 ,
V_33 , V_34 , & V_41 ) ;
if ( V_41 )
F_63 ( V_42 ) ;
return V_42 ;
}
static unsigned long F_64 ( unsigned long V_43 )
{
...
F_47 () ;
V_56:
return F_62 ( V_14 , V_21 , V_33 , V_34 ) ;
}
