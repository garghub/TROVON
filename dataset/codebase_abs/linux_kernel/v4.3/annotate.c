...
V_59 -> V_64 ++ ;
V_59 -> V_12 [ V_17 ] ++ ;
F_40 ( L_11 V_14 L_12 V_14 L_13 V_14
L_14 V_65 L_10 , V_36 -> V_50 , V_36 -> V_5 ,
V_12 , V_12 - V_36 -> V_50 , V_58 , V_59 -> V_12 [ V_17 ] ) ;
return 0 ;
}
static struct V_37 * F_42 ( struct V_35 * V_36 , bool V_51 )
{
struct V_37 * V_38 = F_29 ( V_36 ) ;
if ( V_38 -> V_43 == NULL ) {
if ( F_31 ( V_36 ) < 0 )
...
static int F_43 ( struct V_35 * V_36 , struct V_34 * V_34 ,
int V_58 , T_2 V_12 )
{
struct V_37 * V_38 ;
if ( V_36 == NULL )
return 0 ;
V_38 = F_42 ( V_36 , false ) ;
if ( V_38 == NULL )
return - V_66 ;
return F_39 ( V_36 , V_34 , V_38 , V_58 , V_12 ) ;
}
static int F_44 ( T_2 V_12 , T_2 V_50 ,
...
V_69 = V_50 -> V_71 ;
if ( V_69 == 0 )
F_46 ( L_15 V_14 L_16 V_14 L_17 V_14 L_18 V_14 L_10 ,
V_68 -> V_12 ,
V_50 ? V_50 -> V_12 : 0 ,
V_68 -> V_36 ? V_68 -> V_36 -> V_50 + V_68 -> V_34 -> V_50 : 0 ,
V_69 ) ;
V_70 = F_44 ( V_68 -> V_71 , V_69 , V_68 -> V_36 , V_51 ) ;
if ( V_70 )
F_46 ( L_19 , V_70 ) ;
return V_70 ;
}
int F_47 ( struct V_67 * V_68 , int V_58 )
{
return F_43 ( V_68 -> V_36 , V_68 -> V_34 , V_58 , V_68 -> V_71 ) ;
}
int F_48 ( struct V_72 * V_73 , int V_58 , T_2 V_74 )
{
return F_43 ( V_73 -> V_75 . V_36 , V_73 -> V_75 . V_34 , V_58 , V_74 ) ;
}
...
static struct V_76 * F_50 ( T_3 V_17 , char * line ,
T_1 V_81 , int V_82 )
{
...
int F_52 ( struct V_76 * V_77 , char * V_8 , T_1 V_9 , bool V_4 )
{
if ( V_4 || ! V_77 -> V_7 )
return F_4 ( V_8 , V_9 , L_1 , V_77 -> V_5 , V_77 -> V_2 . V_4 ) ;
return F_5 ( V_77 -> V_7 , V_8 , V_9 , & V_77 -> V_2 ) ;
}
static void F_53 ( struct V_85 * V_86 , struct V_76 * line )
{
F_54 ( & line -> V_87 , V_86 ) ;
}
struct V_76 * F_55 ( struct V_85 * V_86 , struct V_76 * V_88 )
{
F_56 (pos, head, node)
if ( V_88 -> V_17 >= 0 )
return V_88 ;
...
double F_57 ( struct V_37 * V_38 , int V_58 , T_3 V_17 ,
...
struct V_42 * V_59 = F_41 ( V_38 , V_58 ) ;
unsigned int V_99 = 0 ;
while ( V_17 < V_62 )
V_99 += V_59 -> V_12 [ V_17 ++ ] ;
if ( V_59 -> V_64 ) {
...
static int F_58 ( struct V_76 * V_77 , struct V_35 * V_36 , T_2 V_50 ,
...
return 1 ;
if ( V_105 != NULL ) {
F_60 (queue, &notes->src->source, node) {
if ( V_105 == V_77 )
break;
F_58 ( V_105 , V_36 , V_50 , V_101 , V_102 ,
0 , 0 , 1 , NULL ) ;
}
}
V_113 = F_61 ( V_108 ) ;
...
V_113 = F_61 ( V_94 ) ;
if ( V_44 . V_117 )
F_62 ( stdout , V_113 , L_21 V_65 ,
V_90 ) ;
else
F_62 ( stdout , V_113 , L_22 , V_94 ) ;
}
printf ( L_23 ) ;
F_62 ( stdout , V_118 , L_24 V_14 L_25 , V_12 ) ;
F_62 ( stdout , V_119 , L_26 , V_77 -> line ) ;
if ( V_109 != & V_94 )
free ( V_109 ) ;
if ( V_110 != & V_90 )
free ( V_110 ) ;
...
V_120 *= V_101 -> V_115 ;
if ( ! * V_77 -> line )
printf ( L_27 , V_120 , L_28 ) ;
else
printf ( L_29 , V_120 , L_28 , V_77 -> line ) ;
}
return 0 ;
}
static int F_63 ( struct V_35 * V_36 , struct V_34 * V_34 ,
T_4 * V_121 , T_1 V_81 ,
int * V_82 )
{
struct V_37 * V_38 = F_29 ( V_36 ) ;
...
if ( V_126 != - 1 ) {
T_2 V_50 = F_65 ( V_34 , V_36 -> V_50 ) ,
V_62 = F_65 ( V_34 , V_36 -> V_62 ) ;
V_17 = V_126 - V_50 ;
...
V_77 = F_50 ( V_17 , V_122 , V_81 , * V_82 ) ;
free ( line ) ;
( * V_82 ) ++ ;
if ( V_77 == NULL )
return - 1 ;
...
F_53 ( & V_38 -> V_43 -> V_3 , V_77 ) ;
return 0 ;
}
int F_67 ( struct V_35 * V_36 , struct V_34 * V_34 , T_1 V_81 )
{
struct V_130 * V_130 = V_34 -> V_130 ;
char * V_131 = F_68 ( V_130 , NULL , 0 ) ;
bool V_132 = true ;
char V_133 [ V_134 * 2 ] ;
T_4 * V_121 ;
int V_70 = 0 ;
...
goto V_141;
} else if ( F_72 ( V_135 , V_133 , sizeof( V_133 ) ) < 0 ||
strstr ( V_133 , L_31 ) ||
F_73 ( V_135 , V_142 ) ) {
free ( V_131 ) ;
V_141:
V_131 = ( char * ) V_130 -> V_143 ;
F_69 ( V_135 , V_131 ) ;
V_132 = false ;
}
if ( V_130 -> V_144 == V_145 &&
! F_71 ( V_130 ) ) {
char V_8 [ V_146 * 2 + 16 ] = L_32 ;
char * V_147 = NULL ;
if ( V_130 -> V_148 )
goto V_149;
if ( V_130 -> V_140 ) {
F_74 ( V_130 -> V_150 ,
sizeof( V_130 -> V_150 ) , V_8 + 15 ) ;
V_147 = V_8 ;
}
V_70 = - V_151 ;
V_130 -> V_148 = 1 ;
...
F_75 ( L_41 V_14 L_42 V_14 L_10 , V_60 ,
V_131 , V_36 -> V_5 , V_34 -> V_61 ( V_34 , V_36 -> V_50 ) ,
V_34 -> V_61 ( V_34 , V_36 -> V_62 ) ) ;
F_75 ( L_43 ,
V_130 , V_130 -> V_143 , V_36 , V_36 -> V_5 ) ;
if ( F_71 ( V_130 ) ) {
V_137 . V_152 = V_135 ;
V_137 . V_12 = F_65 ( V_34 , V_36 -> V_50 ) ;
V_137 . V_153 = V_36 -> V_50 ;
V_137 . V_102 = V_36 -> V_62 - V_36 -> V_50 ;
if ( ! F_76 ( & V_137 ) ) {
V_138 = true ;
F_77 ( V_135 , V_137 . V_154 ,
sizeof( V_135 ) ) ;
if ( V_132 ) {
free ( V_131 ) ;
V_132 = false ;
...
if ( F_79 ( & V_156 , V_135 ) )
goto V_149;
snprintf ( V_79 , V_134 , L_44 ) ;
V_157 = F_80 ( V_79 ) ;
if ( V_157 < 0 ) {
free ( V_156 . V_159 ) ;
goto V_149;
}
V_158 = F_81 ( V_156 . V_159 , V_135 , V_157 ) ;
free ( V_156 . V_159 ) ;
F_82 ( V_157 ) ;
if ( ! V_158 )
goto V_149;
...
F_65 ( V_34 , V_36 -> V_50 ) ,
F_65 ( V_34 , V_36 -> V_62 ) ,
V_44 . V_162 ? L_40 : L_50 ,
V_44 . V_163 ? L_51 : L_40 ,
V_135 , V_131 ) ;
F_75 ( L_52 , V_133 ) ;
V_121 = F_83 ( V_133 , L_53 ) ;
if ( ! V_121 )
goto V_164;
while ( ! feof ( V_121 ) )
if ( F_63 ( V_36 , V_34 , V_121 , V_81 ,
& V_139 ) < 0 )
break;
if ( F_71 ( V_130 ) )
F_84 ( V_36 ) ;
...
static void F_88 ( struct V_165 * V_166 , struct V_91 * V_92 )
{
struct V_91 * V_167 ;
struct V_168 * * V_169 = & V_166 -> V_168 ;
struct V_168 * V_170 = NULL ;
int V_111 , V_158 ;
while ( * V_169 != NULL ) {
V_170 = * V_169 ;
V_167 = F_89 ( V_170 , struct V_91 , V_87 ) ;
V_158 = strcmp ( V_167 -> V_89 , V_92 -> V_89 ) ;
if ( V_158 == 0 ) {
for ( V_111 = 0 ; V_111 < V_92 -> V_97 ; V_111 ++ )
V_167 -> V_96 [ V_111 ] . V_171 += V_92 -> V_96 [ V_111 ] . V_94 ;
return;
}
if ( V_158 < 0 )
V_169 = & ( * V_169 ) -> V_172 ;
...
for ( V_111 = 0 ; V_111 < V_92 -> V_97 ; V_111 ++ )
V_92 -> V_96 [ V_111 ] . V_171 = V_92 -> V_96 [ V_111 ] . V_94 ;
F_90 ( & V_92 -> V_87 , V_170 , V_169 ) ;
F_91 ( & V_92 -> V_87 , V_166 ) ;
}
static int F_92 ( struct V_91 * V_174 , struct V_91 * V_175 )
{
int V_111 ;
for ( V_111 = 0 ; V_111 < V_174 -> V_97 ; V_111 ++ ) {
if ( V_174 -> V_96 [ V_111 ] . V_171 == V_175 -> V_96 [ V_111 ] . V_171 )
continue;
return V_174 -> V_96 [ V_111 ] . V_171 > V_175 -> V_96 [ V_111 ] . V_171 ;
}
return 0 ;
}
static void F_93 ( struct V_165 * V_166 , struct V_91 * V_92 )
{
struct V_91 * V_167 ;
struct V_168 * * V_169 = & V_166 -> V_168 ;
struct V_168 * V_170 = NULL ;
...
static void F_94 ( struct V_165 * V_176 , struct V_165 * V_177 )
{
struct V_91 * V_92 ;
struct V_168 * V_87 ;
V_87 = F_95 ( V_177 ) ;
...
if ( ! V_38 -> V_43 -> V_93 )
return - 1 ;
V_50 = F_65 ( V_34 , V_36 -> V_50 ) ;
for ( V_111 = 0 ; V_111 < V_102 ; V_111 ++ ) {
T_2 V_17 ;
double V_182 = 0.0 ;
V_92 -> V_97 = V_97 ;
for ( V_178 = 0 ; V_178 < V_97 ; V_178 ++ ) {
V_59 = F_41 ( V_38 , V_58 + V_178 ) ;
V_92 -> V_96 [ V_178 ] . V_94 = 100.0 * V_59 -> V_12 [ V_111 ] / V_59 -> V_64 ;
if ( V_92 -> V_96 [ V_178 ] . V_94 > V_182 )
V_182 = V_92 -> V_96 [ V_178 ] . V_94 ;
}
if ( V_182 <= 0.5 )
goto V_114;
V_17 = V_50 + V_111 ;
...
static void F_102 ( struct V_165 * V_166 , const char * V_131 )
{
struct V_91 * V_92 ;
struct V_168 * V_87 ;
printf ( L_54 , V_131 ) ;
...
V_87 = F_95 ( V_166 ) ;
while ( V_87 ) {
double V_94 , V_182 = 0.0 ;
const char * V_113 ;
char * V_89 ;
int V_111 ;
V_92 = F_89 ( V_87 , struct V_91 , V_87 ) ;
for ( V_111 = 0 ; V_111 < V_92 -> V_97 ; V_111 ++ ) {
V_94 = V_92 -> V_96 [ V_111 ] . V_171 ;
V_113 = F_61 ( V_94 ) ;
F_62 ( stdout , V_113 , L_22 , V_94 ) ;
if ( V_94 > V_182 )
V_182 = V_94 ;
...
{
struct V_37 * V_38 = F_29 ( V_36 ) ;
struct V_42 * V_59 = F_41 ( V_38 , V_101 -> V_116 ) ;
T_2 V_102 = F_32 ( V_36 ) , V_17 ;
for ( V_17 = 0 ; V_17 < V_102 ; ++ V_17 )
if ( V_59 -> V_12 [ V_17 ] != 0 )
printf ( L_58 V_14 L_59 V_65 L_10 , V_184 / 2 ,
V_36 -> V_50 + V_17 , V_59 -> V_12 [ V_17 ] ) ;
printf ( L_60 V_65 L_10 , V_184 / 2 , L_61 , V_59 -> V_64 ) ;
}
int F_105 ( struct V_35 * V_36 , struct V_34 * V_34 ,
struct V_100 * V_101 , bool V_185 ,
int V_103 , int V_104 , int V_186 )
{
struct V_130 * V_130 = V_34 -> V_130 ;
char * V_131 ;
const char * V_187 ;
const char * V_188 = F_106 ( V_101 ) ;
struct V_37 * V_38 = F_29 ( V_36 ) ;
...
V_120 *= V_101 -> V_115 ;
printf ( L_62 ,
V_120 , V_120 , L_63 , V_187 , V_188 ) ;
V_193 = V_120 + V_191 + V_192 ;
printf ( L_64 ,
V_193 , V_193 , V_194 ) ;
if ( V_195 )
F_104 ( V_36 , V_101 ) ;
...
switch ( F_58 ( V_88 , V_36 , V_50 , V_101 , V_102 ,
V_103 , V_27 , V_104 ,
V_105 ) ) {
case 0 :
++ V_27 ;
...
{
struct V_76 * V_88 , * V_196 ;
F_114 (pos, n, head, node) {
F_115 ( & V_88 -> V_87 ) ;
F_51 ( V_88 ) ;
}
}
static T_1 F_116 ( struct V_76 * V_77 , T_4 * V_197 )
{
T_1 V_27 ;
if ( V_77 -> V_17 == - 1 )
return fprintf ( V_197 , L_26 , V_77 -> line ) ;
V_27 = fprintf ( V_197 , L_11 V_14 L_20 , V_77 -> V_17 , V_77 -> V_5 ) ;
if ( V_77 -> V_2 . V_4 [ 0 ] != '\0' ) {
V_27 += fprintf ( V_197 , L_65 , 6 - ( int ) V_27 , L_28 ,
V_77 -> V_2 . V_4 ) ;
}
return V_27 + fprintf ( V_197 , L_10 ) ;
}
T_1 F_117 ( struct V_85 * V_86 , T_4 * V_197 )
{
struct V_76 * V_88 ;
T_1 V_27 = 0 ;
F_108 (pos, head, node)
V_27 += F_116 ( V_88 , V_197 ) ;
return V_27 ;
}
int F_118 ( struct V_35 * V_36 , struct V_34 * V_34 ,
struct V_100 * V_101 , bool V_198 ,
bool V_185 , int V_103 , int V_104 )
{
struct V_130 * V_130 = V_34 -> V_130 ;
struct V_165 V_91 = V_180 ;
T_2 V_102 ;
if ( F_67 ( V_36 , V_34 , 0 ) < 0 )
return - 1 ;
V_102 = F_32 ( V_36 ) ;
if ( V_198 ) {
F_100 ( V_36 , V_34 , V_101 , & V_91 , V_102 ) ;
F_102 ( & V_91 , V_130 -> V_143 ) ;
}
F_105 ( V_36 , V_34 , V_101 , V_185 ,
V_103 , V_104 , 0 ) ;
if ( V_198 )
F_98 ( V_36 , V_102 ) ;
...
{
return F_67 ( V_73 -> V_75 . V_36 , V_73 -> V_75 . V_34 , V_81 ) ;
}
bool F_120 ( void )
{
return V_199 == 1 && V_200 ;
}
