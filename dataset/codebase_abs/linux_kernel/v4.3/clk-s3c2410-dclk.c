...
static struct V_13 * F_7 ( struct V_14 * V_15 , const char * V_16 ,
...
V_12 = F_36 ( V_49 [ V_59 ] , L_10 , NULL ) ;
if ( ! V_12 )
V_12 = F_36 ( V_49 [ V_62 ] , L_11 , NULL ) ;
if ( ! V_12 )
V_12 = F_36 ( V_49 [ V_68 ] ,
L_7 , NULL ) ;
if ( ! V_12 )
...
{
struct V_26 * V_26 = F_21 ( V_45 ) ;
struct V_13 * * V_49 = V_26 -> V_54 . V_55 ;
int V_52 ;
F_38 ( V_49 [ V_64 ] ,
& V_26 -> V_77 ) ;
F_38 ( V_49 [ V_63 ] ,
