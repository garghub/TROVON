...
char * V_35 ;
int V_43 ;
V_28 -> V_37 . V_93 = V_28 -> V_93 + V_162 ;
F_99 ( & V_28 -> V_37 . V_106 ) ;
F_42 ( V_163 , V_28 -> V_37 . V_93 + V_146 ) ;
F_42 ( V_164 , V_28 -> V_37 . V_93 + V_165 ) ;
F_42 ( V_166 | V_167 ,
V_28 -> V_37 . V_93 + V_168 ) ;
F_42 ( 0x1 , V_28 -> V_37 . V_93 + V_97 ) ;
...
F_100 ( 1 ) ) |
V_170 ,
V_28 -> V_70 [ V_36 ] . V_93 + V_171 ) ;
}
V_28 -> V_37 . V_38 [ V_172 ] . V_39 = ~ 0 ;
V_28 -> V_37 . V_38 [ V_172 ] . V_40 = ~ 0 ;
V_28 -> V_37 . V_38 [ V_173 ] . V_39 = 0 ;
V_28 -> V_37 . V_38 [ V_173 ] . V_40 = 0 ;
V_28 -> V_37 . V_38 [ V_174 ] . V_39 = ~ 0 ;
V_28 -> V_37 . V_38 [ V_174 ] . V_40 = ~ ( 0x1 << 15 ) ;
V_28 -> V_37 . V_38 [ V_175 ] . V_39 = ~ 0 ;
V_28 -> V_37 . V_38 [ V_175 ] . V_40 = ~ ( 0x1f << 9 ) ;
V_28 -> V_37 . V_128 = F_101 ( & V_176 , 0 , 0 , V_177 ) ;
if ( V_28 -> V_37 . V_128 == 0 ) {
V_35 = L_22 ;
} else {
int V_178 = snprintf ( NULL , 0 , L_23 , V_28 -> V_37 . V_128 ) ;
V_35 = F_102 ( V_28 -> V_7 , V_178 + 1 , V_177 ) ;
snprintf ( V_35 , V_178 + 1 , L_23 , V_28 -> V_37 . V_128 ) ;
}
...
if ( ! V_28 -> V_111 ) {
F_103 ( V_28 -> V_7 , L_24 ) ;
F_104 ( & V_28 -> V_37 . V_112 , V_189 ,
V_190 ) ;
V_28 -> V_37 . V_112 . V_191 = F_88 ;
}
F_96 ( F_105 () , & V_28 -> V_37 . V_44 ) ;
V_28 -> V_37 . V_155 . V_192 = F_92 ;
V_28 -> V_37 . V_155 . V_193 = V_194 + 1 ,
...
V_195:
F_110 ( & V_176 , V_28 -> V_37 . V_128 ) ;
for ( V_36 = 0 ; V_36 < V_28 -> V_85 ; V_36 ++ )
F_42 ( 0 , V_28 -> V_70 [ V_36 ] . V_93 + V_171 ) ;
F_42 ( 0 , V_28 -> V_37 . V_93 + V_168 ) ;
return V_43 ;
}
static void F_111 ( struct V_27 * V_28 )
{
int V_36 ;
F_97 ( V_28 -> V_111 , V_198 ) ;
F_109 ( & V_28 -> V_37 . V_155 ) ;
for ( V_36 = 0 ; V_36 < V_28 -> V_85 ; V_36 ++ )
F_42 ( 0 , V_28 -> V_70 [ V_36 ] . V_93 + V_171 ) ;
F_42 ( 0 , V_28 -> V_37 . V_93 + V_168 ) ;
...
int (* F_114)( struct V_27 * V_28 , int V_199 ,
...
void T_8 * V_93 ;
int V_43 ;
V_102 = F_43 ( V_28 -> V_93 + V_201 +
4 * ( V_199 / 32 ) ) ;
if ( ! ( V_102 & ( 1 << ( V_199 % 32 ) ) ) )
continue;
V_93 = V_28 -> V_93 + V_199 * V_162 ;
V_102 = F_43 ( V_93 + V_202 ) ;
type = ( V_102 >> V_203 ) &
V_204 ;
V_128 = ( V_102 >> V_205 ) &
V_206 ;
V_43 = F_114 ( V_28 , V_199 , V_93 , type , V_128 ) ;
if ( V_43 )
return V_43 ;
}
return 0 ;
}
static int F_115 ( struct V_27 * V_28 , int V_199 ,
void T_8 * V_93 , T_2 type , T_2 V_128 )
{
...
static int F_116 ( struct V_27 * V_28 , int V_199 ,
void T_8 * V_93 , T_2 type , T_2 V_128 )
{
struct V_63 * V_207 ;
F_28 ( V_28 -> V_7 , L_26 , V_199 , V_128 , type ) ;
switch ( type ) {
case V_208 :
case V_209 :
return 0 ;
case V_21 :
V_207 = & V_28 -> V_70 [ V_128 ] ;
break;
case V_32 :
V_28 -> V_33 = 1 ;
V_207 = & V_28 -> V_1 [ V_128 ] ;
break;
case V_30 :
V_28 -> V_31 = 1 ;
default:
...
{
F_107 ( V_28 -> V_7 , L_27 ,
V_210 [ 5 ] , V_210 [ 4 ] , V_210 [ 3 ] ,
V_210 [ 2 ] , V_210 [ 1 ] , V_210 [ 0 ] ) ;
F_107 ( V_28 -> V_7 , L_28 ) ;
F_42 ( V_211 ,
V_28 -> V_93 + V_212 ) ;
return V_148 ;
}
static T_7 F_118 ( int V_111 , void * V_213 )
{
T_7 V_17 = V_145 ;
struct V_27 * V_28 = V_213 ;
T_2 V_210 [ 6 ] ;
T_2 V_214 ;
int V_36 ;
V_214 = V_210 [ 0 ] = F_43 ( V_28 -> V_93 + V_215 ) ;
if ( V_214 & V_216 ) {
V_214 &= ~ V_216 ;
V_17 = F_85 ( & V_28 -> V_37 ) ;
}
for ( V_36 = 1 ; V_36 < F_35 ( V_210 ) ; V_36 ++ ) {
V_210 [ V_36 ] = F_43 ( V_28 -> V_93 +
V_215 + V_36 * 4 ) ;
V_214 |= V_210 [ V_36 ] ;
}
if ( V_214 )
V_17 |= F_117 ( V_28 , V_210 ) ;
if ( V_17 != V_145 )
F_42 ( V_217 ,
V_28 -> V_93 + V_212 ) ;
return V_17 ;
...
unsigned int V_111 ;
int V_43 ;
V_28 = F_102 ( & V_219 -> V_7 , sizeof( * V_28 ) , V_177 ) ;
if ( ! V_28 )
return - V_221 ;
V_28 -> V_7 = & V_219 -> V_7 ;
F_120 ( V_219 , V_28 ) ;
V_17 = F_121 ( V_219 , V_222 , 0 ) ;
if ( ! V_17 )
return - V_41 ;
if ( ! F_122 ( V_28 -> V_7 , V_17 -> V_186 ,
F_123 ( V_17 ) , V_219 -> V_35 ) )
return - V_223 ;
V_28 -> V_93 = F_124 ( V_28 -> V_7 , V_17 -> V_186 ,
F_123 ( V_17 ) ) ;
if ( ! V_28 -> V_93 )
return - V_224 ;
V_17 = F_121 ( V_219 , V_225 , 0 ) ;
if ( ! V_17 )
return - V_41 ;
V_111 = V_17 -> V_186 ;
F_42 ( V_226 ,
V_28 -> V_93 + V_212 ) ;
if ( F_43 ( V_28 -> V_93 + V_212 ) &
V_227 ) {
F_42 ( V_228 ,
V_28 -> V_93 + V_212 ) ;
...
static int F_127 ( struct V_218 * V_219 )
{
struct V_27 * V_28 = F_128 ( V_219 ) ;
F_111 ( V_28 ) ;
return 0 ;
}
