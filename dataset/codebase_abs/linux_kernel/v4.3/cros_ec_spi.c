...
V_47 += V_4 [ V_6 ] ;
memcpy ( V_43 -> V_63 , V_4 + sizeof( * V_29 ) , V_5 ) ;
for ( V_6 = 0 ; V_6 < V_5 ; V_6 ++ )
V_47 += V_43 -> V_63 [ V_6 ] ;
if ( V_47 ) {
F_10 ( V_8 -> V_2 ,
...
static void F_27 ( struct V_9 * V_10 , struct V_1 * V_2 )
{
struct V_69 * V_70 = V_2 -> V_71 ;
T_2 V_72 ;
int V_16 ;
V_16 = F_28 ( V_70 , L_18 , & V_72 ) ;
if ( ! V_16 )
V_10 -> V_54 = V_72 ;
V_16 = F_28 ( V_70 , L_19 , & V_72 ) ;
if ( ! V_16 )
V_10 -> V_18 = V_72 ;
}
static int F_29 ( struct V_73 * V_19 )
{
...
if ( V_74 < 0 )
return V_74 ;
V_10 = F_31 ( V_2 , sizeof( * V_10 ) , V_52 ) ;
if ( V_10 == NULL )
return - V_53 ;
V_10 -> V_19 = V_19 ;
V_8 = F_31 ( V_2 , sizeof( * V_8 ) , V_52 ) ;
if ( ! V_8 )
return - V_53 ;
F_27 ( V_10 , V_2 ) ;
F_32 ( V_19 , V_8 ) ;
...
V_8 -> V_79 = F_26 ;
V_8 -> V_80 = F_19 ;
V_8 -> V_81 = F_33 ( & V_10 -> V_19 -> V_2 ) ;
V_8 -> V_24 = V_33 +
sizeof( struct V_28 ) +
sizeof( struct V_82 ) ;
V_8 -> V_83 = sizeof( struct V_44 ) ;
V_74 = F_34 ( V_8 ) ;
if ( V_74 ) {
F_10 ( V_2 , L_20 ) ;
return V_74 ;
...
static int F_36 ( struct V_73 * V_19 )
{
struct V_7 * V_8 ;
V_8 = F_37 ( V_19 ) ;
F_38 ( V_8 ) ;
