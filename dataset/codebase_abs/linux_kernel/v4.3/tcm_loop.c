...
V_25 -> V_35 = V_36 ;
if ( V_25 -> V_21 ) {
struct V_66 * V_168 = V_25 -> V_21 -> V_50 ;
F_115 ( V_168 -> V_123 ) ;
}
return V_149 ;
}
...
static struct V_67 * F_116 (
struct V_169 * V_170 ,
struct V_171 * V_172 ,
const char * V_152 )
{
struct V_22 * V_23 = F_4 ( V_170 ,
struct V_22 , V_173 ) ;
struct V_24 * V_25 ;
int V_71 ;
unsigned long V_174 ;
...
V_25 = & V_23 -> V_31 [ V_174 ] ;
V_25 -> V_23 = V_23 ;
V_25 -> V_121 = V_174 ;
V_71 = F_118 ( V_170 , & V_25 -> V_76 , V_23 -> V_141 ) ;
if ( V_71 < 0 )
return F_117 ( - V_153 ) ;
F_24 ( L_66
L_67 , F_92 ( V_23 ) ,
F_119 ( & V_170 -> V_176 . V_177 ) , V_174 ) ;
return & V_25 -> V_76 ;
}
static void F_120 (
struct V_67 * V_68 )
{
struct V_169 * V_170 = V_68 -> V_178 ;
struct V_24 * V_25 = F_4 ( V_68 ,
struct V_24 , V_76 ) ;
struct V_22 * V_23 ;
...
snprintf ( & V_23 -> V_120 [ 0 ] , V_163 , L_49 , & V_152 [ V_181 ] ) ;
V_71 = F_54 ( V_23 , V_183 ) ;
if ( V_71 )
goto V_157;
V_57 = V_23 -> V_57 ;
V_183 ++ ;
...
char * V_148 )
{
return sprintf ( V_148 , L_77 , V_184 ) ;
}
