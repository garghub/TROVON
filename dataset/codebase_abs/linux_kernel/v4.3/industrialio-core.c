...
F_63 ( V_3 ) ;
F_67 ( V_3 -> V_141 ) ;
F_68 ( & V_142 , V_3 -> V_143 ) ;
F_47 ( V_3 ) ;
}
struct V_2 * F_69 ( int V_144 )
{
struct V_2 * V_10 ;
T_5 V_145 ;
V_145 = sizeof( struct V_2 ) ;
if ( V_144 ) {
V_145 = F_70 ( V_145 , V_146 ) ;
V_145 += V_144 ;
}
V_145 += V_146 - 1 ;
...
F_73 ( & V_10 -> V_150 ) ;
F_74 ( & V_10 -> V_122 ) ;
V_10 -> V_143 = F_75 ( & V_142 , 0 , 0 , V_92 ) ;
if ( V_10 -> V_143 < 0 ) {
F_6 ( L_29 ) ;
F_47 ( V_10 ) ;
return NULL ;
}
F_76 ( & V_10 -> V_10 , L_30 , V_10 -> V_143 ) ;
F_74 ( & V_10 -> V_151 ) ;
}
return V_10 ;
}
...
static void F_79 ( struct V_9 * V_10 , void * V_152 )
{
F_77 ( * (struct V_2 * * ) V_152 ) ;
}
static int F_80 ( struct V_9 * V_10 , void * V_152 , void * V_153 )
{
...
struct V_2 * F_81 ( struct V_9 * V_10 , int V_144 )
{
struct V_2 * * V_155 , * V_2 ;
V_155 = F_82 ( F_79 , sizeof( * V_155 ) ,
V_92 ) ;
if ( ! V_155 )
return NULL ;
V_2 = F_69 ( V_144 ) ;
...
void F_85 ( struct V_9 * V_10 , struct V_2 * V_2 )
{
int V_156 ;
V_156 = F_86 ( V_10 , F_79 ,
F_80 , V_2 ) ;
F_46 ( V_156 ) ;
}
static int F_87 ( struct V_157 * V_157 , struct V_21 * V_158 )
{
struct V_2 * V_3 = F_88 ( V_157 -> V_159 ,
struct V_2 , V_160 ) ;
if ( F_89 ( V_161 , & V_3 -> V_162 ) )
return - V_116 ;
F_90 ( V_3 ) ;
V_158 -> V_25 = V_3 ;
return 0 ;
}
static int F_91 ( struct V_157 * V_157 , struct V_21 * V_158 )
{
struct V_2 * V_3 = F_88 ( V_157 -> V_159 ,
struct V_2 , V_160 ) ;
F_92 ( V_161 , & V_3 -> V_162 ) ;
F_93 ( V_3 ) ;
return 0 ;
}
static long F_94 ( struct V_21 * V_158 , unsigned int V_163 , unsigned long V_164 )
{
...
if ( V_163 == V_168 ) {
V_166 = F_95 ( V_3 ) ;
if ( F_96 ( V_165 , & V_166 , sizeof( V_166 ) ) )
return - V_34 ;
return 0 ;
}
return - V_35 ;
...
if ( V_7 [ V_5 ] . V_8 < 0 )
continue;
for ( V_169 = V_5 + 1 ; V_169 < V_3 -> V_6 ; V_169 ++ )
if ( V_7 [ V_5 ] . V_8 == V_7 [ V_169 ] . V_8 ) {
F_14 ( & V_3 -> V_10 ,
L_31 ,
V_7 [ V_5 ] . V_8 ) ;
return - V_35 ;
...
{
int V_14 ;
if ( ! V_3 -> V_10 . V_171 && V_3 -> V_10 . V_31 )
V_3 -> V_10 . V_171 = V_3 -> V_10 . V_31 -> V_171 ;
V_14 = F_97 ( V_3 ) ;
if ( V_14 < 0 )
return V_14 ;
V_3 -> V_10 . V_172 = F_99 ( F_100 ( V_17 ) , V_3 -> V_143 ) ;
V_14 = F_21 ( V_3 ) ;
if ( V_14 ) {
F_14 ( V_3 -> V_10 . V_31 ,
L_32 ) ;
...
V_3 -> V_176 == NULL )
V_3 -> V_176 = & V_177 ;
F_104 ( & V_3 -> V_160 , & V_178 ) ;
V_3 -> V_160 . V_179 = V_3 -> V_28 -> V_180 ;
V_3 -> V_160 . V_181 . V_31 = & V_3 -> V_10 . V_181 ;
V_14 = F_105 ( & V_3 -> V_160 , V_3 -> V_10 . V_172 , 1 ) ;
if ( V_14 < 0 )
goto V_182;
V_14 = F_106 ( & V_3 -> V_10 ) ;
if ( V_14 < 0 )
...
static void F_116 ( struct V_9 * V_10 , void * V_152 )
{
F_109 ( * (struct V_2 * * ) V_152 ) ;
}
int F_117 ( struct V_9 * V_10 , struct V_2 * V_3 )
{
struct V_2 * * V_155 ;
int V_14 ;
V_155 = F_82 ( F_116 , sizeof( * V_155 ) , V_92 ) ;
if ( ! V_155 )
return - V_40 ;
* V_155 = V_3 ;
V_14 = F_98 ( V_3 ) ;
...
void F_118 ( struct V_9 * V_10 , struct V_2 * V_3 )
{
int V_156 ;
V_156 = F_86 ( V_10 , F_116 ,
F_80 , V_3 ) ;
F_46 ( V_156 ) ;
}
