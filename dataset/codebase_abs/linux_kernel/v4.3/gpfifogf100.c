...
int V_24 , V_53 ;
F_30 ( V_49 , L_2 , V_45 ) ;
if ( F_31 ( args -> V_48 , 0 , 0 , false ) ) {
F_30 ( V_49 , L_3
L_4 ,
args -> V_48 . V_54 , args -> V_48 . V_34 , args -> V_48 . V_51 ,
args -> V_48 . V_52 ) ;
} else
return V_24 ;
if ( ! ( V_17 = F_32 ( sizeof( * V_17 ) , V_55 ) ) )
return - V_56 ;
* V_46 = & V_17 -> V_13 . V_26 ;
V_17 -> V_19 = V_19 ;
F_33 ( & V_17 -> V_38 ) ;
V_24 = F_34 ( & V_57 , & V_19 -> V_13 ,
...
F_7 ( V_19 -> V_58 . V_60 ) ;
for ( V_53 = 0 ; V_53 < 0x1000 ; V_53 += 4 )
F_8 ( V_19 -> V_58 . V_60 , V_50 + V_53 , 0x00000000 ) ;
F_9 ( V_19 -> V_58 . V_60 ) ;
V_50 = F_37 ( V_19 -> V_58 . V_60 ) + V_50 ;
F_7 ( V_17 -> V_13 . V_23 ) ;
