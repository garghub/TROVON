...
{
struct V_54 * V_20 = & V_19 -> V_21 ;
struct V_32 * V_33 = F_13 ( V_20 -> V_33 ) ;
struct V_1 * V_2 = & V_33 -> V_5 -> V_21 . V_55 ;
struct V_6 * V_7 ;
struct V_56 * V_15 = V_20 -> V_15 ;
struct V_13 * V_14 = V_15 -> V_16 ;
struct V_57 * V_58 = V_14 -> V_59 ;
struct V_43 * V_44 = F_23 ( V_20 ) ;
enum V_45 V_45 = V_44 -> V_45 ;
V_7 = F_40 ( V_20 , V_2 ) ;
if ( ! V_7 )
return;
...
if ( V_14 -> V_62 . V_63 )
V_14 -> V_62 . V_63 ( V_7 , V_19 , V_2 ) ;
if ( V_58 && V_58 -> V_64 && V_58 -> V_64 -> V_65 )
V_58 -> V_64 -> V_65 ( V_58 -> V_64 -> V_66 , ( int ) V_45 ) ;
}
...
V_14 -> V_62 . V_63 = F_32 ;
V_14 -> V_62 . V_67 = F_22 ;
} else if ( F_45 ( V_15 ) || F_46 ( V_15 ) -> V_68 >= 8 ) {
V_14 -> V_62 . V_63 = F_19 ;
V_14 -> V_62 . V_67 = F_12 ;
} else if ( F_47 ( V_15 ) ) {
V_14 -> V_62 . V_63 = F_32 ;
...
static void F_48 ( struct V_69 * V_15 )
{
F_49 ( F_50 ( V_15 ) , V_70 ) ;
}
static void F_51 ( struct V_69 * V_15 )
{
F_52 ( F_50 ( V_15 ) , V_70 ) ;
}
static void F_53 ( struct V_69 * V_15 ,
bool V_71 )
{
...
static int F_56 ( struct V_69 * V_15 )
{
struct V_13 * V_14 = F_50 ( V_15 ) ;
int V_74 ;
if ( F_57 ( ! F_58 ( V_14 ) ) )
return - V_75 ;
F_49 ( V_14 , V_70 ) ;
V_74 = V_14 -> V_62 . V_76 ( V_14 -> V_15 ) ;
F_52 ( V_14 , V_70 ) ;
return V_74 ;
}
static int F_59 ( struct V_69 * V_77 ,
struct V_69 * V_78 , void * V_79 )
{
struct V_57 * V_58 = V_79 ;
struct V_13 * V_14 = F_50 ( V_77 ) ;
if ( F_25 ( V_58 -> V_80 || V_58 -> V_15 ) )
return - V_81 ;
F_60 ( V_14 -> V_15 ) ;
V_58 -> V_80 = & V_82 ;
V_58 -> V_15 = V_77 ;
...
static void F_62 ( struct V_69 * V_77 ,
struct V_69 * V_78 , void * V_79 )
{
struct V_57 * V_58 = V_79 ;
struct V_13 * V_14 = F_50 ( V_77 ) ;
