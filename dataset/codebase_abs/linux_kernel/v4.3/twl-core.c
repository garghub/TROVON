...
V_97 . V_113 = V_113 ( V_72 ) ;
}
}
if ( F_37 ( V_114 ) && F_3 () ) {
V_72 = F_33 ( V_115 , L_24 , NULL ,
0 , false , 0 , 0 ) ;
if ( F_38 ( V_72 ) )
return F_39 ( V_72 ) ;
}
...
if ( V_180 ) {
if ( V_40 )
V_209 [ 0 ] . V_210 = V_40 -> V_74 ;
V_47 = F_61 ( V_180 , NULL , V_209 ,
& V_48 -> V_2 ) ;
} else {
