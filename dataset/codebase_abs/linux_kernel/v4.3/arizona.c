...
static const char * F_56 ( int V_102 )
{
switch ( V_102 ) {
case V_109 :
return L_18 ;
...
static int F_57 ( struct V_121 * V_122 ,
...
V_221 [ 0 ] . V_103 = F_56 ( V_162 -> V_86 ) ;
V_221 [ 1 ] . V_103 = F_56 ( V_162 -> V_86 ) ;
F_58 ( V_8 , V_221 , F_23 ( V_221 ) ) ;
V_221 [ 0 ] . V_103 = F_56 ( V_102 ) ;
V_221 [ 1 ] . V_103 = F_56 ( V_102 ) ;
F_20 ( V_8 , V_221 , F_23 ( V_221 ) ) ;
V_162 -> V_86 = V_102 ;
return F_59 ( V_8 ) ;
}
static int F_60 ( struct V_121 * V_122 , int V_227 )
{
struct V_6 * V_7 = V_122 -> V_7 ;
int V_127 = V_122 -> V_128 -> V_127 ;
unsigned int V_58 ;
...
static void F_61 ( struct V_121 * V_122 ,
unsigned int V_127 ,
...
if ( V_229 < 0 )
return;
F_63 ( V_9 -> V_20 , V_127 + V_43 , V_229 ) ;
V_73 &= ~ ( 1 << V_229 ) ;
}
if ( V_73 )
F_64 ( V_122 , L_36 ) ;
}
static int F_65 ( struct V_121 * V_122 , unsigned int V_230 ,
...
F_61 ( V_122 , V_127 + V_239 ,
V_236 , V_230 ) ;
F_61 ( V_122 , V_127 + V_240 ,
V_234 , V_231 ) ;
V_9 -> V_202 [ V_122 -> V_163 - 1 ] = V_233 ;
V_9 -> V_203 [ V_122 -> V_163 - 1 ] = V_232 ;
return 0 ;
}
int F_66 ( struct V_12 * V_13 , int V_163 )
{
struct V_161 * V_162 = & V_13 -> V_122 [ V_163 ] ;
V_162 -> V_86 = V_109 ;
return 0 ;
}
static int F_67 ( struct V_241 * V_242 ,
unsigned int V_243 ,
unsigned int V_244 )
{
unsigned int V_245 ;
if ( V_242 -> V_246 && V_244 != V_242 -> V_246 ) {
F_68 ( V_242 ,
L_37 ) ;
return - V_74 ;
}
...
V_245 = V_249 * V_242 -> V_250 ;
if ( V_244 * V_251 < V_245 ) {
F_68 ( V_242 , L_39 ,
V_244 ) ;
return - V_74 ;
}
...
static int F_69 ( unsigned int V_243 , int * V_252 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < F_23 ( V_253 ) ; V_43 ++ ) {
if ( V_253 [ V_43 ] . V_254 <= V_243 && V_243 <= V_253 [ V_43 ] . V_255 ) {
if ( V_252 )
* V_252 = V_253 [ V_43 ] . V_252 ;
return V_253 [ V_43 ] . V_256 ;
}
}
return - V_74 ;
}
static int F_70 ( struct V_241 * V_242 ,
struct V_257 * V_258 ,
unsigned int V_259 ,
unsigned int V_243 , bool V_260 )
{
int V_261 , V_256 ;
int V_262 , div ;
div = 1 ;
...
V_262 = V_258 -> V_262 ;
while ( div <= V_247 ) {
for ( V_256 = V_261 ; V_256 <= V_263 ;
V_256 ++ ) {
if ( ( V_264 / 2 ) /
( V_242 -> V_250 * V_256 ) < V_243 )
break;
if ( V_259 % ( V_256 * V_243 ) ) {
V_258 -> V_262 = V_262 ;
V_258 -> V_252 = V_256 - 1 ;
return V_256 ;
}
}
for ( V_256 = V_261 - 1 ; V_256 > 0 ; V_256 -- ) {
if ( V_259 % ( V_256 * V_243 ) ) {
V_258 -> V_262 = V_262 ;
V_258 -> V_252 = V_256 - 1 ;
return V_256 ;
...
V_243 /= 2 ;
V_262 ++ ;
V_261 = F_69 ( V_243 , NULL ) ;
}
F_71 ( V_242 , L_41 ) ;
return V_258 -> V_252 + 1 ;
}
static int F_72 ( struct V_241 * V_242 ,
struct V_257 * V_258 ,
unsigned int V_243 , bool V_260 )
{
unsigned int V_259 , div , V_265 ;
int V_43 , V_256 ;
F_73 ( V_242 , L_42 , V_243 , V_242 -> V_246 ) ;
div = V_266 ;
while ( V_242 -> V_246 * div < V_249 * V_242 -> V_250 ) {
div ++ ;
if ( div > V_251 )
return - V_74 ;
}
V_259 = V_242 -> V_246 * div / V_242 -> V_250 ;
V_258 -> V_267 = div ;
F_73 ( V_242 , L_43 , V_259 ) ;
V_256 = F_70 ( V_242 , V_258 , V_259 , V_243 , V_260 ) ;
if ( V_256 < 0 )
return V_256 ;
V_243 = V_243 / ( 1 << V_258 -> V_262 ) ;
V_258 -> V_268 = V_259 / ( V_256 * V_243 ) ;
if ( V_259 % ( V_256 * V_243 ) ) {
V_265 = F_74 ( V_259 , V_256 * V_243 ) ;
F_73 ( V_242 , L_44 , V_265 ) ;
V_258 -> V_269 = ( V_259 - ( V_258 -> V_268 * V_256 * V_243 ) )
/ V_265 ;
V_258 -> V_270 = ( V_256 * V_243 ) / V_265 ;
} else {
V_258 -> V_269 = 0 ;
V_258 -> V_270 = 0 ;
}
while ( V_258 -> V_270 >= ( 1 << 16 ) ) {
V_258 -> V_269 >>= 1 ;
V_258 -> V_270 >>= 1 ;
}
for ( V_43 = 0 ; V_43 < F_23 ( V_271 ) ; V_43 ++ ) {
if ( V_271 [ V_43 ] . V_254 <= V_243 && V_243 <= V_271 [ V_43 ] . V_255 ) {
V_258 -> V_272 = V_271 [ V_43 ] . V_272 ;
break;
}
}
if ( V_43 == F_23 ( V_271 ) ) {
...
F_73 ( V_242 , L_46 ,
V_258 -> V_268 , V_258 -> V_269 , V_258 -> V_270 ) ;
F_73 ( V_242 , L_47 ,
V_258 -> V_252 , V_258 -> V_252 , V_258 -> V_267 , V_258 -> V_262 ) ;
F_73 ( V_242 , L_48 , V_258 -> V_272 ) ;
return 0 ;
}
static void F_75 ( struct V_9 * V_9 , unsigned int V_127 ,
struct V_257 * V_258 , int V_103 ,
bool V_260 )
{
...
static int F_77 ( struct V_241 * V_242 )
{
struct V_9 * V_9 = V_242 -> V_9 ;
bool V_288 = false ;
int V_289 = F_76 ( V_242 ) ;
struct V_257 V_258 ;
int V_43 ;
unsigned int V_15 ;
if ( V_289 < 0 )
return V_289 ;
if ( V_289 ) {
F_8 ( V_242 -> V_9 -> V_20 , V_242 -> V_127 + 0x9 ,
V_281 , 0 ) ;
F_8 ( V_242 -> V_9 -> V_20 , V_242 -> V_127 + 1 ,
V_290 ,
V_290 ) ;
}
if ( V_242 -> V_291 >= 0 && V_242 -> V_292 &&
V_242 -> V_291 != V_242 -> V_293 ) {
F_72 ( V_242 , & V_258 , V_242 -> V_292 , false ) ;
F_75 ( V_9 , V_242 -> V_127 , & V_258 , V_242 -> V_291 ,
false ) ;
if ( V_242 -> V_293 >= 0 ) {
F_72 ( V_242 , & V_258 , V_242 -> V_294 , true ) ;
F_75 ( V_9 , V_242 -> V_127 + 0x10 , & V_258 ,
V_242 -> V_293 , true ) ;
V_288 = true ;
}
} else if ( V_242 -> V_293 >= 0 ) {
F_72 ( V_242 , & V_258 , V_242 -> V_294 , false ) ;
F_75 ( V_9 , V_242 -> V_127 , & V_258 ,
V_242 -> V_293 , false ) ;
...
V_297 ,
& V_15 ) ;
if ( V_15 & ( V_298 << ( V_242 -> V_163 - 1 ) ) )
break;
}
if ( V_43 == 15 )
F_71 ( V_242 , L_52 ) ;
else
F_73 ( V_242 , L_53 , V_43 ) ;
return 0 ;
}
static void F_80 ( struct V_241 * V_242 )
{
struct V_9 * V_9 = V_242 -> V_9 ;
bool V_299 ;
F_8 ( V_9 -> V_20 , V_242 -> V_127 + 1 ,
V_290 , V_290 ) ;
F_81 ( V_9 -> V_20 , V_242 -> V_127 + 1 ,
V_287 , 0 , & V_299 ) ;
...
int F_83 ( struct V_241 * V_242 , int V_103 ,
unsigned int V_243 , unsigned int V_244 )
{
int V_32 = 0 ;
if ( V_242 -> V_291 == V_103 && V_242 -> V_292 == V_243 )
return 0 ;
if ( V_242 -> V_246 && V_243 > 0 ) {
V_32 = F_67 ( V_242 , V_243 , V_242 -> V_246 ) ;
if ( V_32 != 0 )
return V_32 ;
}
V_242 -> V_291 = V_103 ;
...
int F_84 ( struct V_241 * V_242 , int V_103 ,
unsigned int V_243 , unsigned int V_244 )
{
int V_32 = 0 ;
if ( V_242 -> V_293 == V_103 &&
V_242 -> V_294 == V_243 && V_242 -> V_246 == V_244 )
return 0 ;
if ( V_244 ) {
if ( V_242 -> V_291 >= 0 ) {
V_32 = F_67 ( V_242 , V_242 -> V_292 , V_244 ) ;
if ( V_32 != 0 )
return V_32 ;
}
V_32 = F_67 ( V_242 , V_243 , V_244 ) ;
if ( V_32 != 0 )
return V_32 ;
}
V_242 -> V_293 = V_103 ;
...
int F_85 ( struct V_9 * V_9 , int V_163 , int V_127 , int V_300 ,
...
case V_305 :
case V_306 :
V_242 -> V_291 = V_15 & V_304 ;
break;
default:
V_242 -> V_291 = V_302 ;
}
V_242 -> V_292 = 32768 ;
snprintf ( V_242 -> V_307 , sizeof( V_242 -> V_307 ) , L_54 , V_163 ) ;
...
int F_86 ( struct V_6 * V_7 , int V_309 , bool V_310 )
{
...
static bool F_87 ( bool V_126 , T_2 V_313 , T_2 V_314 )
{
T_3 V_315 = F_88 ( V_313 ) ;
T_3 V_316 = F_88 ( V_314 ) ;
if ( ! V_126 ) {
return abs ( V_315 ) >= 4096 ;
} else {
if ( abs ( V_316 ) >= 4096 )
return true ;
return ( abs ( ( V_315 << 16 ) / ( 4096 - V_316 ) ) >= 4096 << 4 ) ;
}
}
int F_89 ( struct V_3 * V_4 ,
struct V_317 * V_318 )
{
struct V_6 * V_7 = F_90 ( V_4 ) ;
struct V_9 * V_9 = F_3 ( V_7 -> V_10 -> V_11 ) ;
struct V_319 * V_181 = ( void * ) V_4 -> V_320 ;
unsigned int V_15 ;
T_2 * V_31 ;
int V_321 ;
int V_32 ;
V_321 = V_181 -> V_322 * F_91 ( V_9 -> V_20 ) ;
V_31 = F_92 ( V_318 -> V_323 . V_324 . V_31 , V_321 , V_325 | V_326 ) ;
if ( ! V_31 )
return - V_327 ;
V_31 [ 0 ] &= F_93 ( V_328 ) ;
if ( F_87 ( ! ! V_31 [ 0 ] , V_31 [ 1 ] , V_31 [ 2 ] ) ||
F_87 ( true , V_31 [ 4 ] , V_31 [ 5 ] ) ||
F_87 ( true , V_31 [ 8 ] , V_31 [ 9 ] ) ||
F_87 ( true , V_31 [ 12 ] , V_31 [ 13 ] ) ||
F_87 ( false , V_31 [ 16 ] , V_31 [ 17 ] ) ) {
F_12 ( V_9 -> V_10 , L_56 ) ;
V_32 = - V_74 ;
goto V_329;
}
V_32 = F_11 ( V_9 -> V_20 , V_181 -> V_127 , & V_15 ) ;
if ( V_32 != 0 )
goto V_329;
V_15 &= ~ V_328 ;
V_31 [ 0 ] |= F_93 ( V_15 ) ;
V_32 = F_94 ( V_9 -> V_20 , V_181 -> V_127 , V_31 , V_321 ) ;
V_329:
F_95 ( V_31 ) ;
return V_32 ;
}
...
struct V_6 * V_7 = F_90 ( V_4 ) ;
struct V_9 * V_9 = F_3 ( V_7 -> V_10 -> V_11 ) ;
T_2 * V_31 = ( T_2 * ) V_318 -> V_323 . V_324 . V_31 ;
T_3 V_15 = F_88 ( * V_31 ) ;
if ( abs ( V_15 ) >= 4096 ) {
F_12 ( V_9 -> V_10 , L_57 ) ;
return - V_74 ;
}
return F_97 ( V_4 , V_318 ) ;
}
