...
static const struct V_78 * F_115 ( T_1 V_83 )
{
...
V_130 > 127 ? V_135 : V_134 ;
#ifdef F_92
if ( F_124 ( V_130 , V_131 ) )
V_133 . V_80 = V_136 ;
else if ( F_50 ( F_125 ( V_130 ) ) )
V_133 . V_80 = V_107 ;
else
V_133 . V_80 = V_138 ;
#endif
...
V_130 > 127 ? V_135 : V_134 ;
#ifdef F_92
if ( F_127 ( V_130 , V_131 ) )
V_133 . V_80 = V_136 ;
else if ( F_50 ( F_128 ( V_130 ) ) )
V_133 . V_80 = V_107 ;
else
V_133 . V_80 = V_138 ;
#endif
...
static const struct V_78 * F_131 ( T_1 V_83 )
{
unsigned int V_130 = V_83 & 0xff ;
...
F_134 ( L_23
L_24 , V_12 . V_154 , V_1 , V_150 , V_55 ,
V_55 < 0 ? L_25 : L_26 ) ;
F_136 ( & V_49 , L_27 , V_72 ) ;
return 0 ;
}
