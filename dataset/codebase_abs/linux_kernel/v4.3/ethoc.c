...
V_43 -> V_214 = V_215 ;
if ( ! V_201 ) {
struct V_216 * V_216 = F_102 ( & V_193 -> V_2 , NULL ) ;
if ( ! F_103 ( V_216 ) ) {
V_60 -> V_216 = V_216 ;
F_104 ( V_216 ) ;
V_201 = F_105 ( V_216 ) ;
...
if ( V_201 ) {
T_1 V_217 = F_106 ( V_201 / 2500000 + 1 ) ;
if ( ! V_217 )
V_217 = 2 ;
...
V_60 -> V_119 -> V_87 = F_108 ( sizeof( int ) * V_139 , V_210 ) ;
if ( ! V_60 -> V_119 -> V_87 ) {
V_44 = - V_202 ;
goto V_224;
}
...
static int F_119 ( struct V_192 * V_193 )
{
struct V_42 * V_43 = F_120 ( V_193 ) ;
...
static int F_123 ( struct V_192 * V_193 , T_8 V_234 )
{
return - V_164 ;
}
static int F_124 ( struct V_192 * V_193 )
{
return - V_164 ;
}
