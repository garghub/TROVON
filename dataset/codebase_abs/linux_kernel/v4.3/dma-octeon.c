...
{
struct V_31 * V_32 = F_30 ( F_31 ( V_7 ) ,
struct V_31 ,
V_33 ) ;
return V_32 -> F_29 ( V_7 , V_1 ) ;
}
...
V_35 = 0 ;
V_36 = 0 ;
for ( V_34 = 0 ; V_34 < V_39 . V_40 ; V_34 ++ ) {
struct V_41 * V_42 = & V_39 . V_43 [ V_34 ] ;
if ( V_42 -> type != V_44 && V_42 -> type != V_45 )
continue;
if ( V_42 -> V_46 > 0x410000000ull && ! F_34 () )
continue;
V_36 += V_42 -> V_12 ;
if ( V_35 < V_42 -> V_46 + V_42 -> V_12 )
V_35 = V_42 -> V_46 + V_42 -> V_12 ;
}
V_37 = V_47 ;
#ifdef F_35
if ( F_36 ( V_48 )
...
if ( V_37 > 64 * ( 1 << 20 ) )
V_37 = 64 * ( 1 << 20 ) ;
} else if ( V_35 > 0xf0000000ul ) {
V_37 = 64 * ( 1 << 20 ) ;
}
#endif
#ifdef F_37
if ( F_34 () && V_35 >= 0x100000000ul )
V_37 = 64 * ( 1 << 20 ) ;
#endif
V_38 = V_37 >> V_50 ;
V_38 = F_38 ( V_38 , V_51 ) ;
