...
static int F_50 ( struct V_92 * V_93 , T_5 V_110 )
{
T_4 V_76 ;
struct V_6 * V_7 = F_48 ( V_93 ) ;
unsigned long V_8 ;
...
V_76 = F_51 ( V_93 ) ;
if ( V_76 ) {
F_32 ( & V_93 -> V_34 , L_11 , V_76 ) ;
return V_76 ;
}
F_45 ( V_93 ) ;
F_52 ( V_93 , V_111 ) ;
V_76 = F_53 ( V_93 , V_111 , 1 ) ;
if ( V_76 )
F_32 ( & V_93 -> V_34 , L_12 , V_76 ) ;
return 0 ;
}
...
F_55 ( V_93 ) ;
F_3 ( & V_7 -> V_9 , V_8 ) ;
F_5 ( 0x01 , & V_7 -> V_10 -> V_112 ) ;
F_5 ( 0x00 , & V_7 -> V_10 -> V_112 ) ;
F_11 ( V_7 ) ;
F_6 ( & V_7 -> V_9 , V_8 ) ;
return 0 ;
}
