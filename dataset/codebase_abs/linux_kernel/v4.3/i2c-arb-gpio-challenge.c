...
V_6 = F_12 ( V_18 , sizeof( * V_6 ) , V_33 ) ;
if ( ! V_6 ) {
F_8 ( V_18 , L_4 ) ;
return - V_34 ;
}
F_13 ( V_21 , V_6 ) ;
V_30 = F_14 ( V_24 , L_5 , 0 , & V_28 ) ;
if ( ! F_15 ( V_30 ) ) {
if ( V_30 != - V_35 )
F_8 ( V_18 , L_6 ) ;
return V_30 ;
...
if ( F_15 ( F_17 ( V_24 , L_8 , 1 ) ) ) {
F_8 ( V_18 , L_12 ) ;
return - V_32 ;
}
if ( F_18 ( V_24 , L_13 , & V_6 -> V_13 ) )
V_6 -> V_13 = 10 ;
if ( F_18 ( V_24 , L_14 , & V_6 -> V_14 ) )
V_6 -> V_14 = 3000 ;
if ( F_18 ( V_24 , L_15 , & V_6 -> V_10 ) )
V_6 -> V_10 = 50000 ;
V_26 = F_19 ( V_24 , L_16 , 0 ) ;
if ( ! V_26 ) {
F_8 ( V_18 , L_17 ) ;
return - V_32 ;
}
...
V_6 -> V_41 = F_22 ( V_6 -> V_40 , V_18 , V_6 , 0 , 0 , 0 ,
F_1 ,
F_9 ) ;
if ( ! V_6 -> V_41 ) {
F_8 ( V_18 , L_19 ) ;
