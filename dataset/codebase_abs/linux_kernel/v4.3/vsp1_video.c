...
struct V_128 , V_131 ) ;
F_36 ( & V_15 -> V_119 , V_117 ) ;
V_112 -> V_132 . V_133 . V_134 = V_15 -> V_134 ++ ;
F_48 ( & V_112 -> V_132 . V_133 . V_135 ) ;
for ( V_3 = 0 ; V_3 < V_112 -> V_132 . V_61 ; ++ V_3 )
F_49 ( & V_112 -> V_132 , V_3 , V_112 -> V_136 [ V_3 ] ) ;
F_50 ( & V_112 -> V_132 , V_137 ) ;
return V_129 ;
}
...
static int
F_60 ( struct V_146 * V_147 , const struct V_148 * V_17 ,
...
unsigned int V_3 ;
if ( V_17 ) {
if ( ! F_15 ( V_15 , & V_17 -> V_17 . V_153 , & V_153 ) )
return - V_20 ;
V_27 = & V_153 ;
} else {
V_27 = & V_15 -> V_27 ;
...
V_152 [ V_3 ] = V_15 -> V_154 ;
}
return 0 ;
}
static int F_62 ( struct V_155 * V_156 )
{
struct V_14 * V_15 = F_61 ( V_156 -> V_146 ) ;
struct V_128 * V_132 = F_63 ( V_156 ) ;
const struct V_31 * V_27 = & V_15 -> V_27 ;
unsigned int V_3 ;
if ( V_156 -> V_61 < V_27 -> V_61 )
return - V_20 ;
for ( V_3 = 0 ; V_3 < V_156 -> V_61 ; ++ V_3 ) {
V_132 -> V_157 [ V_3 ] = F_64 ( V_156 , V_3 ) ;
V_132 -> V_136 [ V_3 ] = F_65 ( V_156 , V_3 ) ;
...
static void F_68 ( struct V_68 * V_159 )
{
struct V_68 * V_160 ;
if ( V_159 -> V_123 -> V_124 == 0 )
return;
V_160 = F_69 ( V_159 -> V_160 , struct V_68 , V_18 . V_11 ) ;
F_32 ( V_159 -> V_114 , V_159 -> V_123 -> V_124 ,
V_160 -> V_123 -> V_82 [ V_159 -> V_161 ] ) ;
}
static int F_70 ( struct V_146 * V_147 , unsigned int V_162 )
{
struct V_14 * V_15 = F_61 ( V_147 ) ;
struct V_63 * V_64 = F_43 ( & V_15 -> V_15 . V_11 ) ;
struct V_68 * V_11 ;
...
struct V_65 * V_84 =
F_27 ( & V_64 -> V_89 -> V_18 ) ;
V_88 -> V_164 = V_84 -> V_15 . V_25 -> V_140 ;
}
}
F_40 (entity, &pipe->entities, list_pipe) {
F_68 ( V_11 ) ;
...
F_50 ( & V_165 -> V_132 , V_166 ) ;
F_21 ( & V_15 -> V_130 ) ;
F_36 ( & V_15 -> V_119 , V_117 ) ;
}
static int
F_74 ( struct V_167 * V_167 , void * V_168 , struct V_169 * V_170 )
{
struct V_171 * V_172 = V_167 -> V_173 ;
struct V_14 * V_15 = F_75 ( V_172 -> V_174 ) ;
V_170 -> V_175 = V_176 | V_177
| V_178
| V_179 ;
if ( V_15 -> type == V_180 )
V_170 -> V_181 = V_178
...
V_170 -> V_181 = V_179
| V_177 ;
F_76 ( V_170 -> V_182 , L_3 , sizeof( V_170 -> V_182 ) ) ;
F_76 ( V_170 -> V_183 , V_15 -> V_15 . V_184 , sizeof( V_170 -> V_183 ) ) ;
snprintf ( V_170 -> V_185 , sizeof( V_170 -> V_185 ) , L_4 ,
F_77 ( V_15 -> V_114 -> V_145 ) ) ;
return 0 ;
}
static int
F_78 ( struct V_167 * V_167 , void * V_168 , struct V_148 * V_27 )
{
struct V_171 * V_172 = V_167 -> V_173 ;
struct V_14 * V_15 = F_75 ( V_172 -> V_174 ) ;
...
return - V_20 ;
F_23 ( & V_15 -> V_110 ) ;
V_27 -> V_17 . V_153 = V_15 -> V_27 ;
F_28 ( & V_15 -> V_110 ) ;
return 0 ;
}
static int
F_79 ( struct V_167 * V_167 , void * V_168 , struct V_148 * V_27 )
{
struct V_171 * V_172 = V_167 -> V_173 ;
struct V_14 * V_15 = F_75 ( V_172 -> V_174 ) ;
if ( V_27 -> type != V_15 -> V_131 . type )
return - V_20 ;
return F_9 ( V_15 , & V_27 -> V_17 . V_153 , NULL ) ;
}
static int
F_80 ( struct V_167 * V_167 , void * V_168 , struct V_148 * V_27 )
{
struct V_171 * V_172 = V_167 -> V_173 ;
struct V_14 * V_15 = F_75 ( V_172 -> V_174 ) ;
const struct V_1 * V_5 ;
...
if ( V_27 -> type != V_15 -> V_131 . type )
return - V_20 ;
V_19 = F_9 ( V_15 , & V_27 -> V_17 . V_153 , & V_5 ) ;
if ( V_19 < 0 )
return V_19 ;
F_23 ( & V_15 -> V_110 ) ;
if ( F_81 ( & V_15 -> V_131 ) ) {
...
static int
F_82 ( struct V_167 * V_167 , void * V_168 , enum V_187 type )
{
struct V_171 * V_172 = V_167 -> V_173 ;
struct V_14 * V_15 = F_75 ( V_172 -> V_174 ) ;
struct V_63 * V_64 ;
int V_19 ;
if ( V_15 -> V_131 . V_188 && V_15 -> V_131 . V_188 != V_167 -> V_173 )
return - V_186 ;
V_15 -> V_134 = 0 ;
V_64 = V_15 -> V_15 . V_11 . V_64
? F_43 ( & V_15 -> V_15 . V_11 ) : & V_15 -> V_64 ;
V_19 = F_83 ( & V_15 -> V_15 . V_11 , & V_64 -> V_64 ) ;
if ( V_19 < 0 )
return V_19 ;
V_19 = F_7 ( V_15 ) ;
if ( V_19 < 0 )
...
static int F_85 ( struct V_167 * V_167 )
{
struct V_14 * V_15 = F_86 ( V_167 ) ;
struct V_171 * V_172 ;
int V_19 = 0 ;
V_172 = F_87 ( sizeof( * V_172 ) , V_191 ) ;
if ( V_172 == NULL )
return - V_192 ;
F_88 ( V_172 , & V_15 -> V_15 ) ;
F_89 ( V_172 ) ;
V_167 -> V_173 = V_172 ;
V_19 = F_90 ( V_15 -> V_114 ) ;
if ( V_19 < 0 ) {
F_91 ( V_172 ) ;
F_92 ( V_172 ) ;
}
...
static int F_93 ( struct V_167 * V_167 )
{
struct V_14 * V_15 = F_86 ( V_167 ) ;
struct V_171 * V_172 = V_167 -> V_173 ;
F_23 ( & V_15 -> V_110 ) ;
if ( V_15 -> V_131 . V_188 == V_172 ) {
F_94 ( & V_15 -> V_131 ) ;
V_15 -> V_131 . V_188 = NULL ;
}
F_28 ( & V_15 -> V_110 ) ;
F_95 ( V_15 -> V_114 ) ;
F_96 ( V_167 ) ;
...
int F_97 ( struct V_14 * V_15 , struct V_68 * V_104 )
{
const char * V_193 ;
int V_19 ;
switch ( V_15 -> type ) {
case V_180 :
V_193 = L_5 ;
V_15 -> V_9 . V_117 = V_194 ;
break;
case V_195 :
V_193 = L_6 ;
V_15 -> V_9 . V_117 = V_196 ;
V_15 -> V_15 . V_197 = V_198 ;
break;
default:
return - V_20 ;
}
...
F_99 ( & V_15 -> V_119 ) ;
F_21 ( & V_15 -> V_130 ) ;
F_98 ( & V_15 -> V_64 . V_110 ) ;
F_99 ( & V_15 -> V_64 . V_119 ) ;
F_21 ( & V_15 -> V_64 . V_69 ) ;
F_100 ( & V_15 -> V_64 . V_121 ) ;
V_15 -> V_64 . V_91 = V_92 ;
V_19 = F_101 ( & V_15 -> V_15 . V_11 , 1 , & V_15 -> V_9 , 0 ) ;
if ( V_19 < 0 )
return V_19 ;
V_15 -> V_25 = F_1 ( V_43 ) ;
...
V_15 -> V_27 . V_44 = V_45 ;
V_15 -> V_27 . V_46 = V_47 ;
V_15 -> V_27 . V_30 = V_199 ;
V_15 -> V_27 . V_29 = V_200 ;
V_15 -> V_27 . V_61 = 1 ;
V_15 -> V_27 . V_58 [ 0 ] . V_59 =
V_15 -> V_27 . V_30 * V_15 -> V_25 -> V_201 [ 0 ] / 8 ;
V_15 -> V_27 . V_58 [ 0 ] . V_60 =
V_15 -> V_27 . V_58 [ 0 ] . V_59 * V_15 -> V_27 . V_29 ;
V_15 -> V_15 . V_202 = & V_15 -> V_114 -> V_202 ;
V_15 -> V_15 . V_203 = & V_204 ;
snprintf ( V_15 -> V_15 . V_184 , sizeof( V_15 -> V_15 . V_184 ) , L_7 ,
V_104 -> V_18 . V_184 , V_193 ) ;
V_15 -> V_15 . V_205 = V_206 ;
V_15 -> V_15 . V_207 = V_208 ;
V_15 -> V_15 . V_209 = & V_210 ;
F_102 ( & V_15 -> V_15 , V_15 ) ;
V_15 -> V_154 = F_103 ( V_15 -> V_114 -> V_145 ) ;
if ( F_104 ( V_15 -> V_154 ) ) {
V_19 = F_105 ( V_15 -> V_154 ) ;
goto error;
}
V_15 -> V_131 . type = V_15 -> type ;
V_15 -> V_131 . V_211 = V_212 | V_213 | V_214 ;
V_15 -> V_131 . V_110 = & V_15 -> V_110 ;
V_15 -> V_131 . V_215 = V_15 ;
V_15 -> V_131 . V_216 = sizeof( struct V_128 ) ;
V_15 -> V_131 . V_138 = & V_217 ;
V_15 -> V_131 . V_218 = & V_219 ;
V_15 -> V_131 . V_220 = V_221 ;
V_19 = F_106 ( & V_15 -> V_131 ) ;
if ( V_19 < 0 ) {
F_72 ( V_15 -> V_114 -> V_145 , L_8 ) ;
goto error;
}
V_15 -> V_15 . V_131 = & V_15 -> V_131 ;
V_19 = F_107 ( & V_15 -> V_15 , V_206 , - 1 ) ;
if ( V_19 < 0 ) {
F_72 ( V_15 -> V_114 -> V_145 , L_9 ) ;
goto error;
}
return 0 ;
error:
