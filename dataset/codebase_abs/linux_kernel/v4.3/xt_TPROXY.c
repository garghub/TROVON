...
static struct V_1 *
F_28 ( struct V_9 * V_10 , T_1 V_15 , T_3 V_40 ,
struct V_1 * V_2 )
{
...
struct V_1 * V_50 ;
V_50 = F_13 ( F_33 ( V_10 -> V_16 ) , V_42 -> V_20 ,
...
static unsigned int
F_37 ( struct V_9 * V_10 , T_1 V_15 , T_3 V_40 ,
T_4 V_55 , T_4 V_56 )
{
const struct V_41 * V_42 = F_29 ( V_10 ) ;
...
if ( V_45 == NULL )
return V_58 ;
V_2 = F_13 ( F_33 ( V_10 -> V_16 ) , V_42 -> V_20 ,
V_42 -> V_21 , V_42 -> V_12 ,
V_45 -> V_51 , V_45 -> V_52 ,
V_10 -> V_16 , V_32 ) ;
...
return F_37 ( V_10 , V_64 -> V_15 , V_64 -> V_40 , V_64 -> V_55 , V_64 -> V_56 ) ;
}
static unsigned int
F_39 ( struct V_9 * V_10 , const struct V_61 * V_62 )
{
const struct V_66 * V_64 = V_62 -> V_65 ;
return F_37 ( V_10 , V_64 -> V_15 . V_67 , V_64 -> V_40 , V_64 -> V_55 , V_64 -> V_56 ) ;
}
static inline const struct V_38 *
F_40 ( struct V_9 * V_10 , const struct V_38 * V_11 ,
...
static struct V_1 *
F_43 ( struct V_9 * V_10 , int V_74 , int V_75 ,
const struct V_61 * V_62 ,
struct V_1 * V_2 )
{
const struct V_76 * V_42 = F_44 ( V_10 ) ;
struct V_43 V_44 , * V_45 ;
const struct V_66 * V_64 = V_62 -> V_65 ;
...
if ( V_45 -> V_46 && ! V_45 -> V_47 && ! V_45 -> V_48 && ! V_45 -> V_49 ) {
struct V_1 * V_50 ;
V_50 = F_23 ( F_33 ( V_10 -> V_16 ) , V_74 ,
& V_42 -> V_21 ,
F_40 ( V_10 , & V_64 -> V_15 . V_77 , & V_42 -> V_12 ) ,
V_45 -> V_51 ,
...
static unsigned int
F_45 ( struct V_9 * V_10 , const struct V_61 * V_62 )
{
const struct V_76 * V_42 = F_44 ( V_10 ) ;
const struct V_66 * V_64 = V_62 -> V_65 ;
struct V_57 V_44 , * V_45 ;
...
int V_75 = 0 ;
int V_74 ;
V_74 = F_46 ( V_10 , & V_75 , - 1 , NULL , NULL ) ;
if ( V_74 < 0 ) {
F_20 ( L_5 ) ;
return V_58 ;
}
...
V_2 = F_23 ( F_33 ( V_10 -> V_16 ) , V_74 ,
& V_42 -> V_21 , & V_42 -> V_12 ,
V_45 -> V_51 , V_45 -> V_52 ,
V_62 -> V_25 , V_32 ) ;
V_15 = F_40 ( V_10 , & V_64 -> V_15 . V_77 , & V_42 -> V_12 ) ;
V_40 = V_64 -> V_40 ? V_64 -> V_40 : V_45 -> V_52 ;
if ( V_2 && V_2 -> V_3 == V_4 )
V_2 = F_43 ( V_10 , V_74 , V_75 , V_62 , V_2 ) ;
else if ( ! V_2 )
V_2 = F_23 ( F_33 ( V_10 -> V_16 ) , V_74 ,
& V_42 -> V_21 , V_15 ,
V_45 -> V_51 , V_40 ,
...
static int F_47 ( const struct V_78 * V_62 )
{
...
static int F_49 ( const struct V_78 * V_62 )
{
