...
static int F_126 ( struct V_59 * V_33 ,
struct V_119 * V_120 )
{
struct V_121 * V_122 ;
struct V_123 * V_124 ;
...
static void F_131 ( struct V_59 * V_126 )
{
int V_9 ;
F_56 ( & V_62 ) ;
for ( V_9 = 0 ; V_9 < V_10 ; V_9 ++ ) {
