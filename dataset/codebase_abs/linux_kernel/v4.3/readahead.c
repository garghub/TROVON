...
static unsigned long F_38 ( unsigned long V_43 , unsigned long V_44 )
{
unsigned long V_45 = F_39 ( V_43 ) ;
if ( V_45 <= V_44 / 32 )
V_45 = V_45 * 4 ;
else if ( V_45 <= V_44 / 4 )
V_45 = V_45 * 2 ;
...
{
T_1 V_43 ;
V_43 = F_41 ( V_4 , V_28 , V_44 ) ;
if ( V_43 <= V_48 )
return 0 ;
if ( V_43 >= V_28 )
V_43 *= 2 ;
V_2 -> V_49 = V_28 ;
V_2 -> V_43 = F_37 ( V_43 + V_48 , V_44 ) ;
V_2 -> V_50 = 1 ;
return 1 ;
}
...
unsigned long V_48 )
{
unsigned long V_44 = F_36 ( V_2 -> V_5 ) ;
T_1 V_52 ;
if ( ! V_28 )
goto V_53;
...
if ( V_28 - V_52 <= 1UL )
goto V_53;
if ( F_43 ( V_4 , V_2 , V_28 , V_48 , V_44 ) )
goto V_54;
return F_24 ( V_4 , V_19 , V_28 , V_48 , 0 ) ;
V_53:
V_2 -> V_49 = V_28 ;
V_2 -> V_43 = F_38 ( V_48 , V_44 ) ;
V_2 -> V_50 = V_2 -> V_43 > V_48 ? V_2 -> V_43 - V_48 : V_2 -> V_43 ;
V_54:
if ( V_28 == V_2 -> V_49 && V_2 -> V_43 == V_2 -> V_50 ) {
V_2 -> V_50 = F_40 ( V_2 , V_44 ) ;
V_2 -> V_43 += V_2 -> V_50 ;
}
return F_46 ( V_2 , V_4 , V_19 ) ;
}
...
F_35 ( V_4 , V_19 , V_28 , V_48 ) ;
return;
}
F_44 ( V_4 , V_2 , V_19 , false , V_28 , V_48 ) ;
}
void
F_48 ( struct V_3 * V_4 ,
struct V_1 * V_2 , struct V_18 * V_19 ,
...
if ( F_51 ( V_4 -> V_6 ) )
return;
F_44 ( V_4 , V_2 , V_19 , true , V_28 , V_48 ) ;
}
static T_3
F_52 ( struct V_3 * V_4 , struct V_18 * V_19 ,
T_1 V_16 , unsigned long V_41 )
{
if ( ! V_4 || ! V_4 -> V_24 )
return - V_38 ;
return F_35 ( V_4 , V_19 , V_16 , V_41 ) ;
}
