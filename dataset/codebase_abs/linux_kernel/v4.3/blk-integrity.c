...
V_2 -> V_39 . V_40 )
return false ;
if ( F_17 ( V_35 , V_36 -> V_3 ) )
return false ;
return true ;
}
bool F_18 ( struct V_1 * V_2 , struct V_34 * V_35 ,
struct V_3 * V_3 )
{
int V_41 ;
...
static T_1 F_19 ( struct V_43 * V_44 , struct V_45 * V_46 ,
char * V_47 )
{
struct V_23 * V_48 =
F_20 ( V_44 , struct V_23 , V_44 ) ;
struct V_49 * V_50 =
F_20 ( V_46 , struct V_49 , V_46 ) ;
...
static T_1 F_23 ( struct V_23 * V_48 , char * V_47 )
{
if ( V_48 != NULL )
...
static T_1 F_24 ( struct V_23 * V_48 ,
const char * V_47 , T_2 V_52 )
{
char * V_55 = ( char * ) V_47 ;
unsigned long V_56 = F_25 ( V_55 , & V_55 , 10 ) ;
if ( V_56 )
V_48 -> V_57 |= V_58 ;
else
V_48 -> V_57 &= ~ V_58 ;
...
static T_1 F_26 ( struct V_23 * V_48 , char * V_47 )
{
return sprintf ( V_47 , L_9 , ( V_48 -> V_57 & V_58 ) != 0 ) ;
}
static T_1 F_27 ( struct V_23 * V_48 ,
const char * V_47 , T_2 V_52 )
{
char * V_55 = ( char * ) V_47 ;
unsigned long V_56 = F_25 ( V_55 , & V_55 , 10 ) ;
...
static T_1 F_29 ( struct V_23 * V_48 , char * V_47 )
{
...
bool F_34 ( struct V_20 * V_63 )
{
struct V_23 * V_48 = F_35 ( V_63 ) ;
return ( V_48 && V_48 -> V_33 && strcmp ( V_48 -> V_33 , V_64 ) != 0 ) ;
}
int F_36 ( struct V_20 * V_63 , struct V_23 * V_65 )
{
struct V_23 * V_48 ;
F_37 ( V_63 == NULL ) ;
if ( V_63 -> V_25 == NULL ) {
