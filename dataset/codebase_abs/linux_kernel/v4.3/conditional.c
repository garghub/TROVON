...
void F_42 ( struct V_59 * V_86 , struct V_61 * V_27 ,
struct V_87 * V_88 )
{
struct V_69 * V_21 ;
if ( ! V_86 || ! V_27 || ! V_88 )
...
if ( V_21 -> V_27 . V_28 & V_29 )
F_43 ( V_88 , V_21 ) ;
}
return;
}
void F_44 ( struct V_59 * V_86 , struct V_61 * V_27 ,
struct V_89 * V_90 , struct V_91 * V_92 )
{
struct V_69 * V_21 ;
if ( ! V_86 || ! V_27 || ! V_90 || ! V_92 )
return;
for ( V_21 = F_26 ( V_86 , V_27 ) ; V_21 ;
V_21 = F_27 ( V_21 , V_27 -> V_28 ) ) {
if ( ( V_93 ) ( V_94 | V_29 ) ==
( V_21 -> V_27 . V_28 & ( V_94 | V_29 ) ) )
V_90 -> V_95 |= V_21 -> V_42 . V_96 . V_67 ;
if ( ( V_93 ) ( V_97 | V_29 ) ==
( V_21 -> V_27 . V_28 & ( V_97 | V_29 ) ) )
V_90 -> V_98 &= V_21 -> V_42 . V_96 . V_67 ;
if ( ( V_93 ) ( V_99 | V_29 ) ==
( V_21 -> V_27 . V_28 & ( V_99 | V_29 ) ) )
V_90 -> V_100 |= V_21 -> V_42 . V_96 . V_67 ;
if ( ( V_21 -> V_27 . V_28 & V_29 ) &&
( V_21 -> V_27 . V_28 & V_101 ) )
F_45 ( V_92 , V_21 ) ;
}
return;
}
