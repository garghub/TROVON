...
static bool F_24 ( struct V_106 * V_107 , unsigned int V_108 )
{
return false ;
}
static int F_25 ( struct V_109 * V_110 ,
const struct V_111 * V_112 )
{
struct V_113 * V_114 = V_110 -> V_107 . V_115 ;
struct V_1 * V_1 ;
int V_19 ;
V_1 = F_26 ( & V_110 -> V_107 , sizeof( * V_1 ) , V_116 ) ;
if ( V_1 == NULL )
return - V_117 ;
if ( V_114 ) {
V_1 -> V_63 = V_114 -> V_63 ;
} else if ( V_110 -> V_107 . V_118 ) {
V_1 -> V_63 = F_27 ( V_110 -> V_107 . V_118 , 0 ) ;
if ( V_1 -> V_63 < 0 && V_1 -> V_63 != - V_119 )
return V_1 -> V_63 ;
} else {
V_1 -> V_63 = - 1 ;
}
if ( F_13 ( V_1 -> V_63 ) ) {
V_19 = F_28 ( & V_110 -> V_107 , V_1 -> V_63 ,
V_120 , L_1 ) ;
if ( V_19 )
return V_19 ;
}
F_29 ( V_110 , V_1 ) ;
V_1 -> V_29 = F_30 ( V_110 , & V_121 ) ;
if ( F_31 ( V_1 -> V_29 ) )
return F_32 ( V_1 -> V_29 ) ;
F_33 ( V_1 -> V_29 , true ) ;
...
if ( V_19 )
return V_19 ;
return F_34 ( & V_110 -> V_107 , & V_124 ,
& V_125 , 1 ) ;
}
static int F_35 ( struct V_109 * V_126 )
{
F_36 ( & V_126 -> V_107 ) ;
return 0 ;
}
