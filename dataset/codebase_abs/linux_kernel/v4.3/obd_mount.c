...
V_44 = F_28 ( V_16 ,
L_8 , V_57 , F_27 ( V_24 ) ) ;
V_45 = F_28 ( V_16 , L_9 , V_44 , V_48 ) ;
if ( ! V_44 || ! V_45 ) {
V_15 = - V_17 ;
goto V_58;
}
V_46 = V_11 -> V_51 -> V_59 ? V_11 -> V_51 -> V_59 : L_10 ;
...
V_39 -> V_83 &= ~ V_87 ;
V_39 -> V_91 = V_89 ;
V_15 = F_42 ( NULL , & exp , V_40 , & ( V_40 -> V_42 ) , V_39 , NULL ) ;
if ( V_15 ) {
F_18 ( L_19 , V_15 ) ;
goto V_75;
}
...
V_11 -> V_14 = NULL ;
F_26 ( & V_56 ) ;
F_3 ( F_45 ( & V_40 -> V_64 . V_65 . V_66 ) > 0 ) ;
if ( ! F_46 ( & V_40 -> V_64 . V_65 . V_66 ) ) {
F_15 ( V_34 , L_20 ,
F_45 ( & V_40 -> V_64 . V_65 . V_66 ) ) ;
V_15 = - V_93 ;
goto V_75;
}
V_40 -> V_94 = 1 ;
if ( V_40 -> V_64 . V_65 . V_92 ) {
V_15 = F_47 ( V_40 -> V_64 . V_65 . V_92 ) ;
if ( V_15 )
F_15 ( V_34 , L_21 , V_15 ) ;
}
...
struct V_10 * F_49 ( struct V_1 * V_2 )
{
struct V_10 * V_11 ;
...
struct V_10 * V_11 = F_2 ( V_2 ) ;
F_3 ( V_11 != NULL ) ;
F_15 ( V_34 , L_25 , V_2 , F_45 ( & V_11 -> V_99 ) ) ;
if ( F_46 ( & V_11 -> V_99 ) ) {
if ( F_20 ( V_11 ) && V_11 -> V_108 ) {
F_53 ( & V_11 -> V_109 -> V_110 ) ;
...
int F_55 ( const char * V_114 , char * V_115 , const char * * V_116 )
{
const char * V_117 ;
V_117 = V_114 + F_56 ( V_114 , 8 ) ;
...
int F_57 ( const char * V_118 , char * V_114 , const char * * V_116 ,
T_5 V_119 )
{
int V_15 ;
const char * V_117 ;
V_15 = F_55 ( V_118 , NULL , & V_117 ) ;
if ( V_15 != 0 )
return V_15 ;
if ( V_116 != NULL )
* V_116 = V_117 ;
if ( F_58 ( V_114 , V_117 + 1 , V_119 ) >= V_119 )
return - V_120 ;
return 0 ;
}
int F_59 ( const char * V_114 , T_4 * V_121 , const char * * V_116 )
{
unsigned long V_122 ;
int V_15 ;
const char * V_117 ;
V_15 = F_55 ( V_114 , NULL , & V_117 ) ;
if ( V_15 != 0 )
return V_15 ;
V_117 ++ ;
...
V_122 = F_60 ( V_117 , ( char * * ) V_116 , 16 ) ;
if ( V_121 != NULL )
* V_121 = V_122 ;
...
F_64 ( V_34 , L_32 ) ;
if ( F_32 ( V_128 ) )
F_64 ( V_34 , L_33 , V_128 -> V_102 ) ;
F_64 ( V_34 , L_34 , V_128 -> V_55 ) ;
F_64 ( V_34 , L_35 , V_128 -> V_70 ) ;
if ( V_128 -> V_103 )
F_64 ( V_34 , L_36 , V_128 -> V_103 ) ;
if ( V_128 -> V_97 )
F_64 ( V_34 , L_37 ,
V_128 -> V_97 ) ;
if ( V_128 -> V_98 )
...
int F_65 ( struct V_1 * V_2 , char * V_114 )
{
struct V_10 * V_11 = F_2 ( V_2 ) ;
struct V_127 * V_128 = V_11 -> V_51 ;
T_4 V_122 ;
int V_48 , V_15 ;
V_15 = F_59 ( V_114 , & V_122 , NULL ) ;
if ( V_15 != V_124 )
return 0 ;
...
static int F_67 ( struct V_127 * V_128 , const char * V_47 )
{
const char * V_26 = V_47 , * V_27 ;
T_4 V_122 , * V_129 ;
int V_15 = 0 , V_130 ;
V_130 = strlen ( V_47 ) / 8 + 1 ;
V_129 = F_68 ( V_130 , sizeof( V_122 ) , V_16 ) ;
if ( ! V_129 )
return - V_17 ;
while ( * V_26 && * V_26 != ' ' && * V_26 != ',' ) {
V_26 ++ ;
V_15 = F_59 ( V_26 , & V_122 , & V_27 ) ;
if ( V_15 < 0 ) {
F_18 ( L_42 ,
V_26 , V_15 ) ;
break;
...
static int F_69 ( struct V_127 * V_128 , char * V_47 )
{
char * V_132 ;
int V_133 ;
F_11 ( V_128 -> V_59 ) ;
...
static int F_70 ( char * * V_134 , char * V_47 )
{
char * V_132 ;
int V_133 ;
...
static int F_71 ( struct V_127 * V_128 , char * * V_47 )
{
T_1 V_24 ;
char * V_132 = * V_47 ;
char * V_135 ;
...
static int F_72 ( char * V_137 , struct V_127 * V_128 )
{
...
V_15 = F_69 ( V_128 , V_26 + 7 ) ;
if ( V_15 )
goto V_150;
V_143 ++ ;
} else if ( strncmp ( V_26 , L_59 , 8 ) == 0 ) {
V_15 = F_67 ( V_128 , V_26 + 7 ) ;
if ( V_15 )
goto V_150;
V_143 ++ ;
...
V_128 -> V_70 |= V_156 ;
while ( * ++ V_26 == '/' ) ;
V_128 -> V_102 = F_28 ( V_16 , L_68 , V_26 ) ;
if ( ! V_128 -> V_102 )
return - V_17 ;
}
...
int F_74 ( struct V_1 * V_2 , void * V_39 , int V_157 )
{
struct V_127 * V_128 ;
...
F_75 () ;
F_54 () ;
if ( F_72 ( ( char * ) ( V_159 -> V_161 ) , V_128 ) ) {
F_52 ( V_2 ) ;
V_15 = - V_20 ;
goto V_75;
}
...
struct V_169 * F_81 ( struct V_170 * V_171 , int V_69 ,
...
return F_82 ( V_171 , V_69 , & V_159 , F_74 ) ;
}
