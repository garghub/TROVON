...
struct V_1 * F_56 ( const char * V_76 , T_2 type , T_2 V_50 )
{
return F_57 ( V_76 , & V_75 , type , V_50 ) ;
}
static int F_58 ( struct V_18 * V_19 )
{
struct V_25 * V_21 = & V_19 -> V_21 ;
if ( F_59 ( V_19 -> V_20 , V_19 -> V_31 ) > V_77 / 8 )
return - V_14 ;
V_21 -> V_78 = & V_75 ;
V_21 -> V_38 &= ~ V_79 ;
V_21 -> V_38 |= V_56 ;
...
int F_64 ( struct V_18 * V_80 , int V_81 )
{
int V_82 , V_6 ;
...
void F_65 ( struct V_18 * V_80 , int V_81 )
{
int V_82 ;
for ( V_82 = V_81 - 1 ; V_82 >= 0 ; -- V_82 )
F_62 ( & V_80 [ V_82 ] ) ;
}
