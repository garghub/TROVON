...
static void F_44 ( struct V_115 * V_14 , struct V_5 * V_6 )
{
F_26 ( V_6 ) ;
if ( ! V_6 -> V_48 ) {
T_5 V_116 ;
...
F_45 ( V_14 , L_23 , V_6 -> V_48 ) ;
}
}
int F_46 ( struct V_115 * V_14 , struct V_5 * V_6 )
{
struct V_70 * V_13 ;
int V_10 ;
F_47 ( V_6 == NULL ) ;
...
V_10 = F_49 ( V_14 , V_6 -> V_68 , F_32 , V_124 ,
V_6 -> V_122 , V_13 ) ;
if ( V_10 < 0 ) {
F_27 ( & V_13 -> V_14 , L_25 ) ;
goto V_125;
