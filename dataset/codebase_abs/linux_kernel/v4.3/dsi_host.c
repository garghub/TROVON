...
for ( V_46 = 0 ; V_46 < V_45 ; V_46 ++ ) {
if ( ( V_42 [ V_46 ] . V_53 >= 0 ) && ( V_42 [ V_46 ] . V_54 >= 0 ) ) {
V_28 = F_28 ( V_39 [ V_46 ] . V_48 ,
...
V_28 = F_35 ( V_20 -> V_59 , V_20 -> V_70 ) ;
if ( V_28 ) {
F_11 ( L_35 , V_31 , V_28 ) ;
goto error;
}
V_28 = F_35 ( V_20 -> V_60 , V_20 -> V_69 -> clock * 1000 ) ;
if ( V_28 ) {
F_11 ( L_36 , V_31 , V_28 ) ;
goto error;
}
...
static int F_37 ( struct V_19 * V_20 , bool V_73 )
{
int V_28 = 0 ;
F_38 ( & V_20 -> V_74 ) ;
if ( V_73 ) {
...
static void F_44 ( struct V_19 * V_20 , T_2 V_83 , int V_73 )
{
T_2 V_84 ;
unsigned long V_85 ;
F_45 ( & V_20 -> V_86 , V_85 ) ;
...
static inline enum V_88 F_47 ( const T_2 V_89 )
{
if ( V_89 & V_90 )
return V_91 ;
else if ( V_89 & V_92 )
...
static void F_50 ( struct V_19 * V_20 , bool V_73 ,
T_2 V_104 , T_2 V_105 )
{
T_2 V_85 = V_20 -> V_89 ;
...
static void F_83 ( int V_69 , struct V_19 * V_20 )
{
T_2 V_23 ;
V_23 = F_5 ( V_20 , V_127 ) ;
if ( V_69 == 0 )
...
static int F_90 ( struct V_19 * V_20 , int V_191 )
{
struct V_192 * V_30 = V_20 -> V_30 ;
int V_28 ;
T_2 V_193 ;
F_38 ( & V_30 -> V_194 ) ;
V_20 -> V_195 = F_91 ( V_30 , V_191 , V_196 ) ;
if ( F_10 ( V_20 -> V_195 ) ) {
V_28 = F_31 ( V_20 -> V_195 ) ;
F_11 ( L_47 , V_31 , V_28 ) ;
V_20 -> V_195 = NULL ;
F_39 ( & V_30 -> V_194 ) ;
return V_28 ;
}
V_28 = F_92 ( V_20 -> V_195 , 0 , & V_193 ) ;
if ( V_28 ) {
F_11 ( L_48 , V_31 , V_28 ) ;
return V_28 ;
}
...
static int F_101 ( T_3 * V_209 , const struct V_199 * V_200 )
{
...
static int F_104 ( struct V_19 * V_20 , int V_203 )
{
int V_28 ;
T_2 V_193 ;
bool V_210 ;
V_28 = F_105 ( V_20 -> V_195 , 0 , & V_193 ) ;
if ( V_28 ) {
F_11 ( L_54 , V_31 , V_28 ) ;
return V_28 ;
}
...
V_23 = F_5 ( V_20 , F_108 ( V_46 ) ) ;
* V_216 ++ = F_109 ( V_23 ) ;
F_15 ( L_56 , V_23 , F_109 ( V_23 ) ) ;
}
...
static void F_112 ( struct V_228 * V_229 )
{
struct V_19 * V_20 =
F_20 ( V_229 , struct V_19 , V_230 ) ;
T_2 V_231 = V_20 -> V_232 ;
F_113 ( L_60 , V_31 , V_231 ) ;
if ( V_231 & V_233 )
F_111 ( V_20 ) ;
V_20 -> V_232 = 0 ;
F_44 ( V_20 , V_141 , 1 ) ;
...
F_118 ( V_20 ) ;
F_116 ( V_20 ) ;
F_121 ( V_20 -> V_254 , & V_20 -> V_230 ) ;
}
static T_4 F_122 ( int V_255 , void * V_256 )
{
...
struct V_55 * V_262 )
{
V_20 -> V_263 = F_125 ( V_262 ,
L_62 ,
V_264 ) ;
if ( F_10 ( V_20 -> V_263 ) ) {
F_15 ( L_63 ,
F_31 ( V_20 -> V_263 ) ) ;
return F_31 ( V_20 -> V_263 ) ;
}
V_20 -> V_265 = F_125 ( V_262 , L_64 ,
V_266 ) ;
if ( F_10 ( V_20 -> V_265 ) ) {
F_15 ( L_65 , F_31 ( V_20 -> V_265 ) ) ;
return F_31 ( V_20 -> V_265 ) ;
}
return 0 ;
}
...
F_127 ( V_268 -> V_30 . V_269 != V_20 -> V_270 ) ;
V_28 = F_124 ( V_20 , & V_268 -> V_30 ) ;
if ( V_28 )
return V_28 ;
F_15 ( L_30 , V_20 -> V_64 ) ;
if ( V_20 -> V_30 )
...
static T_5 F_130 ( struct V_36 * V_37 ,
const struct V_199 * V_200 )
{
struct V_19 * V_20 = F_19 ( V_37 ) ;
int V_28 ;
...
int V_28 ;
V_28 = F_133 ( V_272 , L_66 , & V_20 -> V_64 ) ;
if ( V_28 ) {
F_134 ( V_30 , L_67 ,
V_31 , V_28 ) ;
return V_28 ;
}
V_273 = F_135 ( V_272 , NULL ) ;
if ( ! V_273 ) {
F_136 ( V_30 , L_68 , V_31 ) ;
return 0 ;
}
V_270 = F_137 ( V_273 ) ;
if ( ! V_270 ) {
F_134 ( V_30 , L_69 , V_31 ) ;
F_138 ( V_273 ) ;
return - V_274 ;
}
F_138 ( V_273 ) ;
...
int F_139 ( struct V_275 * V_275 )
{
struct V_19 * V_20 = NULL ;
struct V_276 * V_29 = V_275 -> V_29 ;
int V_28 ;
V_20 = F_140 ( & V_29 -> V_30 , sizeof( * V_20 ) , V_277 ) ;
if ( ! V_20 ) {
F_11 ( L_70 ,
V_31 ) ;
V_28 = - V_278 ;
...
V_20 -> V_22 = F_141 ( V_29 , L_73 , L_74 ) ;
if ( F_10 ( V_20 -> V_22 ) ) {
F_11 ( L_75 , V_31 ) ;
V_28 = F_31 ( V_20 -> V_22 ) ;
goto V_50;
...
V_20 -> V_205 = F_140 ( & V_29 -> V_30 , V_280 , V_277 ) ;
if ( ! V_20 -> V_205 ) {
F_11 ( L_78 , V_31 ) ;
goto V_50;
}
...
F_143 ( & V_20 -> V_74 ) ;
F_144 ( & V_20 -> V_86 ) ;
V_20 -> V_254 = F_145 ( L_79 , 0 ) ;
F_146 ( & V_20 -> V_230 , F_112 ) ;
V_275 -> V_37 = & V_20 -> V_1 ;
...
int F_151 ( struct V_36 * V_37 ,
struct V_192 * V_30 )
{
struct V_19 * V_20 = F_19 ( V_37 ) ;
struct V_276 * V_29 = V_20 -> V_29 ;
int V_28 ;
V_20 -> V_255 = F_152 ( V_29 -> V_30 . V_269 , 0 ) ;
if ( V_20 -> V_255 < 0 ) {
V_28 = V_20 -> V_255 ;
F_134 ( V_30 -> V_30 , L_81 , V_28 ) ;
return V_28 ;
}
V_28 = F_153 ( & V_29 -> V_30 , V_20 -> V_255 ,
F_122 , V_282 | V_283 ,
L_82 , V_20 ) ;
if ( V_28 < 0 ) {
F_134 ( & V_29 -> V_30 , L_83 ,
V_20 -> V_255 , V_28 ) ;
return V_28 ;
}
V_20 -> V_30 = V_30 ;
V_28 = F_90 ( V_20 , V_280 ) ;
if ( V_28 ) {
F_11 ( L_84 , V_31 , V_28 ) ;
return V_28 ;
}
...
int F_154 ( struct V_36 * V_37 , bool V_284 )
{
struct V_19 * V_20 = F_19 ( V_37 ) ;
int V_28 ;
if ( ! V_20 -> V_285 ) {
...
int F_162 ( struct V_36 * V_37 ,
const struct V_199 * V_200 )
{
struct V_19 * V_20 = F_19 ( V_37 ) ;
return F_110 ( V_20 , V_200 ) ;
}
...
V_28 = F_110 ( V_20 , V_200 ) ;
if ( V_28 < V_200 -> V_302 ) {
F_11 ( L_87 , V_31 , V_28 ) ;
return V_28 ;
}
V_293 = F_107 ( V_20 , V_209 , V_213 , V_214 ) ;
if ( V_293 <= 0 )
return 0 ;
if ( V_295 )
break;
...
void F_165 ( struct V_36 * V_37 , T_2 V_193 , T_2 V_203 )
{
struct V_19 * V_20 = F_19 ( V_37 ) ;
...
V_28 = F_169 ( V_20 -> V_62 , V_319 ) ;
if ( V_28 ) {
F_11 ( L_92 ,
V_31 , V_28 ) ;
goto exit;
}
V_28 = F_169 ( V_20 -> V_63 , V_320 ) ;
if ( V_28 ) {
F_11 ( L_93 ,
V_31 , V_28 ) ;
goto exit;
...
struct V_19 * V_20 = F_19 ( V_37 ) ;
if ( V_20 -> V_69 ) {
F_181 ( V_20 -> V_30 , V_20 -> V_69 ) ;
V_20 -> V_69 = NULL ;
}
V_20 -> V_69 = F_182 ( V_20 -> V_30 , V_69 ) ;
if ( F_10 ( V_20 -> V_69 ) ) {
F_11 ( L_103 , V_31 ) ;
return F_31 ( V_20 -> V_69 ) ;
}
return 0 ;
}
struct V_323 * F_183 ( struct V_36 * V_37 ,
unsigned long * V_324 )
{
struct V_19 * V_20 = F_19 ( V_37 ) ;
struct V_323 * V_325 ;
V_325 = F_156 ( V_20 -> V_270 ) ;
if ( V_324 )
* V_324 = V_20 -> V_89 ;
return V_325 ;
}
struct V_326 * F_184 ( struct V_36 * V_37 )
{
struct V_19 * V_20 = F_19 ( V_37 ) ;
return F_157 ( V_20 -> V_270 ) ;
}
