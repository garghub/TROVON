...
V_12 -> V_15 . V_22 = V_22 ;
V_12 -> V_15 . V_36 = V_37 ;
return V_34 -> V_35 ( V_27 , V_29 , V_12 ) ;
}
bool F_17 ( const struct V_26 * V_27 , unsigned int V_28 ,
T_3 V_30 , struct V_11 * V_12 )
{
struct V_31 * V_32 ;
struct V_33 * V_34 ;
unsigned int V_38 ;
...
V_34 = F_21 ( V_30 , V_22 ) ;
V_39 = F_16 ( V_27 , V_28 , V_38 , V_30 , V_22 , V_12 ,
V_32 , V_34 ) ;
F_20 () ;
return V_39 ;
}
...
if ( V_132 )
F_127 ( V_8 , V_132 -> V_68 , V_126 ) ;
F_128 ( V_8 , V_126 ) ;
F_129 ( V_8 , V_126 ) ;
F_130 ( V_8 ) ;
V_129 = V_59 ? F_131 ( V_59 ) : NULL ;
F_132 ( V_8 , V_129 ? V_129 -> V_136 : 0 ,
V_129 ? V_129 -> V_137 : 0 ,
V_126 ) ;
F_53 () ;
if ( V_5 -> V_8 . V_138 ) {
F_4 ( & V_139 ) ;
exp = F_133 ( V_5 , V_57 , V_12 ) ;
if ( exp ) {
F_24 ( L_8 ,
V_8 , exp ) ;
F_134 ( V_140 , & V_8 -> V_60 ) ;
V_8 -> V_71 = exp -> V_71 ;
if ( exp -> V_104 ) {
V_95 = F_135 ( V_8 , exp -> V_104 ,
V_126 ) ;
if ( V_95 )
F_136 ( V_95 -> V_104 , exp -> V_104 ) ;
}
#ifdef F_137
...
F_142 ( struct V_5 * V_5 , struct V_45 * V_59 ,
struct V_26 * V_27 ,
unsigned int V_29 ,
T_3 V_30 ,
T_4 V_22 ,
...
struct V_45 * V_8 ;
T_1 V_23 ;
if ( ! F_16 ( V_27 , F_143 ( V_27 ) ,
V_29 , V_30 , V_22 , & V_12 , V_32 ,
V_34 ) ) {
F_24 ( L_9 ) ;
return NULL ;
}
...
unsigned int
F_144 ( struct V_5 * V_5 , T_4 V_152 , unsigned int V_153 ,
struct V_26 * V_27 )
{
...
V_32 = F_19 ( V_152 ) ;
V_39 = V_32 -> V_40 ( V_27 , F_143 ( V_27 ) ,
& V_29 , & V_22 ) ;
if ( V_39 <= 0 ) {
F_24 ( L_13 ) ;
F_104 ( V_5 , error ) ;
...
V_8 = F_142 ( V_5 , V_59 , V_27 , V_29 , V_152 , V_22 ,
...
if ( V_8 -> V_71 || ( V_95 && ! F_151 ( & V_95 -> V_161 ) ) )
return;
F_18 () ;
F_139 ( V_8 , NULL , V_126 ) ;
F_20 () ;
}
void F_152 ( struct V_45 * V_8 ,
enum V_96 V_97 ,
...
F_155 ( & V_171 [ F_91 ( V_97 ) ] . V_172 ) ;
F_156 ( V_27 -> V_173 , & V_171 [ F_91 ( V_97 ) ] . V_174 ) ;
}
}
}
bool F_157 ( struct V_45 * V_8 ,
enum V_96 V_97 ,
const struct V_26 * V_27 ,
int V_163 )
{
...
const struct V_11 * V_12 )
{
if ( F_159 ( V_27 , V_176 , V_12 -> V_14 . V_20 . V_177 . V_178 ) ||
F_159 ( V_27 , V_179 , V_12 -> V_15 . V_20 . V_177 . V_178 ) )
goto V_180;
return 0 ;
V_180:
return - 1 ;
}
int F_160 ( struct V_181 * V_182 [] ,
struct V_11 * V_183 )
{
if ( ! V_182 [ V_176 ] || ! V_182 [ V_179 ] )
return - V_184 ;
V_183 -> V_14 . V_20 . V_177 . V_178 = F_161 ( V_182 [ V_176 ] ) ;
V_183 -> V_15 . V_20 . V_177 . V_178 = F_161 ( V_182 [ V_179 ] ) ;
return 0 ;
}
int F_162 ( void )
{
return F_163 ( V_185 , V_186 + 1 ) ;
}
static void F_164 ( struct V_26 * V_187 , const struct V_26 * V_27 )
{
struct V_45 * V_8 ;
enum V_96 V_97 ;
V_8 = F_90 ( V_27 , & V_97 ) ;
...
static struct V_45 *
F_165 ( struct V_5 * V_5 , int (* F_166)( struct V_45 * V_10 , void * V_164 ) ,
...
int (* F_166)( struct V_45 * V_10 , void * V_164 ) ,
void * V_164 , T_1 V_74 , int V_75 )
{
struct V_45 * V_8 ;
unsigned int V_85 = 0 ;
while ( ( V_8 = F_165 ( V_5 , F_166 , V_164 , & V_85 ) ) != NULL ) {
if ( F_103 ( & V_8 -> V_68 ) )
F_61 ( V_8 , V_74 , V_75 ) ;
F_56 ( V_8 ) ;
}
}
static int F_171 ( struct V_45 * V_10 , void * V_164 )
{
return 1 ;
}
void F_172 ( void * V_23 , unsigned int V_24 )
{
if ( F_173 ( V_23 ) )
F_174 ( V_23 ) ;
else
F_175 ( ( unsigned long ) V_23 ,
F_176 ( sizeof( struct V_189 ) * V_24 ) ) ;
}
static int F_177 ( void )
{
int V_112 = 0 , V_51 ;
F_167 (cpu) {
struct V_45 * V_8 = & F_178 ( V_190 , V_51 ) ;
...
void F_194 ( struct V_5 * V_5 )
{
F_195 ( V_194 ) ;
F_196 ( & V_5 -> V_195 , & V_194 ) ;
F_197 ( & V_194 ) ;
}
void F_197 ( struct V_196 * V_197 )
{
int V_198 ;
struct V_5 * V_5 ;
F_198 () ;
...
F_199 (net, net_exit_list, exit_list) {
F_172 ( V_5 -> V_8 . V_23 , V_5 -> V_8 . V_25 ) ;
F_200 ( V_5 ) ;
F_201 ( V_5 ) ;
F_202 ( V_5 ) ;
F_203 ( V_5 ) ;
...
void * F_208 ( unsigned int * V_202 , int V_203 )
{
struct V_204 * V_23 ;
unsigned int V_205 , V_10 ;
T_8 V_206 ;
F_209 ( sizeof( struct V_204 ) != sizeof( struct V_189 ) ) ;
V_205 = * V_202 = F_210 ( * V_202 , V_207 / sizeof( struct V_204 ) ) ;
V_206 = V_205 * sizeof( struct V_204 ) ;
V_23 = ( void * ) F_211 ( V_208 | V_209 | V_210 ,
F_176 ( V_206 ) ) ;
if ( ! V_23 )
V_23 = F_212 ( V_206 ) ;
if ( V_23 && V_203 )
for ( V_10 = 0 ; V_10 < V_205 ; V_10 ++ )
F_213 ( & V_23 [ V_10 ] , V_10 ) ;
return V_23 ;
}
int F_214 ( const char * V_211 , struct V_212 * V_213 )
{
int V_10 , V_85 , V_214 ;
...
return - V_222 ;
if ( ! V_223 )
return F_215 ( V_211 , V_213 ) ;
V_214 = F_216 ( V_211 , 0 , & V_215 ) ;
if ( V_214 )
return V_214 ;
if ( ! V_215 )
return - V_184 ;
...
while ( ! F_218 ( & V_221 . V_8 . V_23 [ V_10 ] ) ) {
V_83 = F_219 ( V_221 . V_8 . V_23 [ V_10 ] . V_224 ,
struct V_82 , V_47 ) ;
V_8 = F_71 ( V_83 ) ;
F_25 ( & V_83 -> V_47 ) ;
...
void F_221 ( unsigned long V_225 )
{
int V_51 ;
F_167 (cpu)
F_178 ( V_190 , V_51 ) . V_60 |= V_225 ;
}
int F_222 ( void )
{
int V_226 = 8 ;
...
F_236 ( & V_5 -> V_8 . V_9 ) ;
V_5 -> V_8 . V_52 = F_237 ( struct V_49 ) ;
if ( ! V_5 -> V_8 . V_52 )
goto V_242;
F_167 (cpu) {
struct V_49 * V_50 = F_29 ( V_5 -> V_8 . V_52 , V_51 ) ;
F_113 ( & V_50 -> V_53 ) ;
F_213 ( & V_50 -> V_55 , V_243 ) ;
F_213 ( & V_50 -> V_54 , V_244 ) ;
}
V_5 -> V_8 . V_201 = F_237 ( struct V_245 ) ;
if ( ! V_5 -> V_8 . V_201 )
goto V_246;
V_5 -> V_8 . V_200 = F_238 ( V_208 , L_17 , V_5 ) ;
if ( ! V_5 -> V_8 . V_200 )
goto V_247;
V_5 -> V_8 . V_123 = F_239 ( V_5 -> V_8 . V_200 ,
...
V_5 -> V_8 . V_25 = V_223 ;
V_5 -> V_8 . V_23 = F_208 ( & V_5 -> V_8 . V_25 , 1 ) ;
if ( ! V_5 -> V_8 . V_23 ) {
F_223 ( V_249 L_19 ) ;
goto V_251;
}
