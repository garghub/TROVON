...
int V_145 ;
V_22 = & V_141 -> V_22 ;
V_144 = F_44 ( & V_141 -> V_22 , sizeof( * V_144 ) , V_146 ) ;
if ( V_144 == NULL )
return - V_147 ;
V_144 -> V_124 = F_45 ( V_22 , L_12 ,
V_148 ) ;
if ( F_46 ( V_144 -> V_124 ) )
return F_47 ( V_144 -> V_124 ) ;
V_144 -> V_149 = V_141 ;
V_144 -> V_123 = F_48 ( V_141 , & V_150 ) ;
if ( F_46 ( V_144 -> V_123 ) ) {
V_125 = F_47 ( V_144 -> V_123 ) ;
F_15 ( & V_141 -> V_22 , L_13 ,
V_125 ) ;
return V_125 ;
}
for ( V_145 = 0 ; V_145 < F_35 ( V_144 -> V_126 ) ; V_145 ++ )
V_144 -> V_126 [ V_145 ] . V_151 = V_152 [ V_145 ] ;
V_125 = F_49 ( V_22 , F_35 ( V_144 -> V_126 ) ,
V_144 -> V_126 ) ;
if ( V_125 != 0 ) {
...
F_50 ( & V_141 -> V_22 ) ;
F_51 ( & V_141 -> V_22 , 1000 ) ;
F_52 ( & V_141 -> V_22 ) ;
F_53 ( & V_141 -> V_22 ) ;
F_54 ( & V_141 -> V_22 ) ;
F_55 ( & V_141 -> V_22 ) ;
F_56 ( & V_141 -> V_22 , V_144 ) ;
V_125 = F_57 ( & V_141 -> V_22 ,
& V_153 ,
V_154 , F_35 ( V_154 ) ) ;
if ( V_125 < 0 )
F_15 ( & V_141 -> V_22 , L_15 , V_125 ) ;
return V_125 ;
}
