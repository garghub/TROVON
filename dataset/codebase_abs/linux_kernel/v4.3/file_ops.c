...
( V_18 -> V_58 -> V_115 * ( 1 << 16 ) ) ) +
( type == V_112 ?
( V_116 / 2 ) : 0 ) ;
V_106 = F_41 ( V_18 -> V_58 -> V_117 * V_118 ,
V_119 ) ;
V_67 &= ~ V_120 ;
V_67 |= V_121 | V_122 ;
V_98 -> V_123 = F_42 ( V_98 -> V_123 ) ;
V_104 = 1 ;
break;
case V_124 :
if ( V_67 & V_125 ) {
...
V_106 = F_41 ( sizeof( * V_84 -> V_166 ) * V_84 -> V_167 , V_119 ) ;
V_67 |= V_152 | V_122 ;
V_105 = 1 ;
break;
}
...
V_26 = F_48 ( V_98 , V_98 -> V_141 , V_99 , V_106 ,
V_98 -> V_123 ) ;
} else {
V_26 = F_44 ( V_98 , V_98 -> V_141 , V_99 , V_106 ,
V_98 -> V_123 ) ;
}
V_85:
return V_26 ;
}
static int F_49 ( struct V_97 * V_98 , struct V_171 * V_105 )
{
struct V_172 * V_172 ;
V_172 = F_50 ( ( void * ) ( V_105 -> V_173 << V_101 ) ) ;
if ( ! V_172 )
return V_174 ;
F_51 ( V_172 ) ;
V_105 -> V_172 = V_172 ;
...
static unsigned int F_52 ( struct V_5 * V_6 , struct V_175 * V_176 )
{
struct V_17 * V_18 ;
unsigned V_177 ;
V_18 = F_6 ( V_6 ) ;
...
V_193 , V_18 -> V_77 ) ;
F_61 ( V_65 , V_18 -> V_77 ) ;
F_62 ( V_65 , V_18 -> V_58 -> V_115 , V_194 ,
F_63 ( V_65 , V_18 -> V_58 -> type ) ) ;
F_28 ( V_18 -> V_58 ) ;
V_18 -> V_195 = 0 ;
F_64 ( & V_65 -> V_187 , V_67 ) ;
...
static T_1 F_46 ( void * V_46 )
{
struct V_172 * V_172 ;
T_1 V_206 = 0 ;
V_172 = F_50 ( V_46 ) ;
if ( V_172 )
V_206 = F_70 ( V_172 ) << V_101 ;
return V_206 ;
}
...
V_26 = F_71 ( V_6 , V_21 ) ;
if ( ! V_26 ) {
V_207 = F_72 ( F_73 ( V_6 ) ) - V_216 ;
V_26 = F_74 ( V_6 , V_21 , V_207 - 1 , V_210 ) ;
}
F_59 ( & V_183 ) ;
V_85:
return V_26 ;
}
static int F_74 ( struct V_5 * V_6 , struct V_20 * V_21 ,
int V_217 , unsigned V_210 )
{
struct V_64 * V_65 = NULL ;
int V_26 = 0 , V_218 , V_219 , V_220 , V_221 ;
V_218 = F_75 ( & V_219 , & V_220 ) ;
if ( ! V_219 ) {
V_26 = - V_222 ;
goto V_85;
}
...
V_85:
return V_26 ? V_26 : F_77 ( V_6 , V_65 , V_21 ) ;
}
...
int V_26 = 0 ;
V_218 = F_75 ( NULL , NULL ) ;
for ( V_226 = 0 ; V_226 < V_218 ; V_226 ++ ) {
struct V_64 * V_65 = F_76 ( V_226 ) ;
...
F_6 ( V_6 ) = V_18 ;
F_20 ( V_6 ) = V_18 -> V_184 ++ ;
V_18 -> V_186 [ F_20 ( V_6 ) ] = V_232 -> V_195 ;
...
static int F_77 ( struct V_5 * V_6 , struct V_64 * V_65 ,
struct V_20 * V_21 )
{
struct V_17 * V_18 ;
unsigned V_77 ;
...
if ( V_77 == V_65 -> V_229 )
return - V_224 ;
V_18 = F_78 ( V_65 -> V_233 , V_77 ) ;
if ( ! V_18 ) {
F_43 ( V_65 ,
L_6 ) ;
return - V_11 ;
}
V_18 -> V_58 = F_79 ( V_65 , V_234 , V_18 -> V_235 ,
V_18 -> V_127 ) ;
if ( ! V_18 -> V_58 )
return - V_11 ;
F_80 ( L_7 , V_18 -> V_58 -> V_236 ,
V_18 -> V_58 -> V_115 ) ;
V_26 = F_29 ( V_18 -> V_58 ) ;
if ( V_26 )
return V_26 ;
...
V_18 -> V_195 = V_232 -> V_195 ;
V_18 -> V_67 = F_82 ( V_237 ) ;
F_83 ( & V_18 -> V_238 ) ;
F_84 ( V_18 -> V_239 , V_232 -> V_239 , sizeof( V_18 -> V_239 ) ) ;
memcpy ( V_18 -> V_230 , V_21 -> V_230 , sizeof( V_18 -> V_230 ) ) ;
V_18 -> V_240 = F_85 ( F_86 () ) ;
F_87 ( & V_18 -> V_241 ) ;
F_88 ( & V_18 -> V_242 ) ;
V_203 . V_204 ++ ;
V_65 -> V_205 -- ;
...
V_18 -> V_159 = F_91 ( V_119 ) ;
if ( ! V_18 -> V_159 ) {
V_26 = - V_11 ;
goto V_32;
}
V_18 -> V_161 = F_91 ( V_18 -> V_135 *
V_243 ) ;
if ( ! V_18 -> V_161 ) {
V_26 = - V_11 ;
goto V_246;
}
V_18 -> V_164 = F_91 ( V_18 -> V_138 . V_139 *
V_243 ) ;
if ( ! V_18 -> V_164 ) {
V_26 = - V_11 ;
goto V_247;
...
struct V_17 * V_18 = F_6 ( V_6 ) ;
if ( ! F_93 ( V_249 , & V_18 -> V_201 ) ) {
V_26 = - V_33 ;
goto V_85;
}
if ( F_20 ( V_6 ) ) {
V_26 = F_94 ( V_18 -> V_238 ,
! F_93 ( V_245 ,
& V_18 -> V_201 ) ) ;
goto V_85;
}
...
if ( V_18 -> V_252 )
F_95 ( V_18 ) ;
F_96 ( V_18 -> V_65 , V_18 -> V_77 , V_18 -> V_240 ) ;
V_248 = V_76 ;
if ( F_97 ( V_18 -> V_67 , V_253 ) )
V_248 |= V_254 ;
if ( ! F_97 ( V_18 -> V_67 , V_255 ) )
V_248 |= V_256 ;
if ( F_97 ( V_18 -> V_67 , V_257 ) )
V_248 |= V_258 ;
if ( F_97 ( V_18 -> V_67 , V_259 ) )
V_248 |= V_260 ;
if ( F_97 ( V_18 -> V_67 , V_156 ) )
V_248 |= V_261 ;
F_30 ( V_18 -> V_65 , V_248 , V_18 -> V_77 ) ;
if ( V_18 -> V_162 ) {
F_98 ( V_245 , & V_18 -> V_201 ) ;
F_99 ( & V_18 -> V_238 ) ;
}
V_26 = 0 ;
V_85:
...
V_264 . V_268 = F_102 ( V_18 -> V_138 . V_269 ,
...
V_264 . V_278 = V_18 -> V_235 << 2 ;
V_264 . V_279 = F_34 ( V_6 ) -> V_167 ;
V_264 . V_280 = V_18 -> V_138 . V_281 ;
F_103 ( V_18 -> V_65 , V_18 -> V_77 , F_20 ( V_6 ) , V_264 ) ;
...
V_26 = F_104 ( V_18 -> V_58 ) ;
if ( V_26 )
goto V_85;
V_26 = F_105 ( V_65 , V_18 ) ;
if ( V_26 )
goto V_85;
V_26 = F_106 ( V_18 ) ;
if ( V_26 )
...
V_18 -> V_202 = F_107 ( V_18 -> V_272 *
sizeof( struct V_172 * * ) ) ;
if ( ! V_18 -> V_202 ) {
V_26 = - V_11 ;
goto V_85;
}
V_18 -> V_282 = F_107 ( V_18 -> V_272 *
sizeof( * V_18 -> V_282 ) ) ;
if ( ! V_18 -> V_282 ) {
V_26 = - V_11 ;
goto V_85;
...
~ ( ( 1ULL << ( V_18 -> V_284 %
V_286 ) ) - 1 ) ;
F_110 ( V_18 -> V_77 , F_20 ( V_6 ) , 0 ,
V_18 -> V_287 , V_18 -> V_285 ) ;
}
V_26 = F_111 ( V_18 , V_6 ) ;
if ( V_26 )
goto V_85;
F_89 ( V_249 , & V_18 -> V_201 ) ;
V_85:
return V_26 ;
}
...
unsigned V_14 ;
int V_26 = 0 ;
F_112 ( V_18 -> V_65 , V_18 ) ;
memset ( & V_289 , 0 , sizeof( V_289 ) ) ;
V_289 . V_291 = V_65 -> V_292 ;
V_289 . V_293 = V_294 ;
V_289 . V_295 = V_296 ;
V_289 . V_240 = V_18 -> V_240 ;
V_14 = ( ( T_1 ) V_18 -> V_58 -> V_129 -
( T_1 ) V_65 -> V_126 [ V_18 -> V_127 ] . V_130 ) % V_119 ;
V_289 . V_297 = F_113 ( V_124 , V_18 -> V_77 ,
F_20 ( V_6 ) , V_14 ) ;
V_289 . V_298 = F_113 ( V_111 , V_18 -> V_77 ,
F_20 ( V_6 ) ,
V_18 -> V_58 -> V_299 ) ;
V_289 . V_300 = F_113 ( V_112 ,
V_18 -> V_77 ,
F_20 ( V_6 ) ,
V_18 -> V_58 -> V_299 ) ;
V_289 . V_301 = F_113 ( V_133 , V_18 -> V_77 ,
F_20 ( V_6 ) ,
V_18 -> V_302 ) ;
V_289 . V_303 = F_113 ( V_136 , V_18 -> V_77 ,
F_20 ( V_6 ) ,
V_18 -> V_138 . V_268 [ 0 ] . V_144 ) ;
V_289 . V_304 = F_113 ( V_165 , V_18 -> V_77 ,
F_20 ( V_6 ) , 0 ) ;
V_289 . V_305 = F_113 ( V_145 , V_18 -> V_77 ,
F_20 ( V_6 ) , 0 ) ;
V_14 = ( ( ( ( V_18 -> V_77 - V_65 -> V_150 ) *
V_151 ) + F_20 ( V_6 ) ) *
sizeof( * V_65 -> V_149 ) ) & ~ V_131 ;
V_289 . V_306 = F_113 ( V_148 , V_18 -> V_77 ,
F_20 ( V_6 ) ,
V_14 ) ;
V_289 . V_307 = F_113 ( V_153 , V_18 -> V_77 ,
F_20 ( V_6 ) ,
V_65 -> V_154 ) ;
if ( F_23 ( V_156 ) )
V_289 . V_308 = F_113 ( V_155 , V_18 -> V_77 ,
F_20 ( V_6 ) , 0 ) ;
if ( V_18 -> V_162 ) {
V_289 . V_159 = F_113 ( V_158 ,
V_18 -> V_77 ,
F_20 ( V_6 ) , 0 ) ;
V_289 . V_309 = F_113 ( V_160 ,
V_18 -> V_77 ,
F_20 ( V_6 ) , 0 ) ;
V_289 . V_164 = F_113 ( V_163 ,
V_18 -> V_77 ,
F_20 ( V_6 ) , 0 ) ;
}
...
int F_118 ( struct V_315 * V_316 , const int V_317 )
{
struct V_17 * V_18 ;
...
static inline T_7 F_119 ( T_1 V_322 )
{
return V_322 ? F_120 ( V_322 ) : sizeof( V_322 ) * 8 ;
}
static inline unsigned F_121 ( unsigned long V_323 , T_8 * V_324 )
{
unsigned free ;
T_8 V_325 = * V_324 ;
if ( V_325 >= V_286 )
...
V_328 = F_122 ( V_333 , V_23 -> V_60 ) ;
if ( ! V_328 ) {
V_26 = - V_31 ;
goto V_32;
}
if ( ! F_123 ( V_339 , ( void T_3 * ) V_333 ,
V_328 * V_119 ) ) {
F_43 ( V_65 , L_8 ,
( void * ) V_333 , V_328 ) ;
V_26 = - V_33 ;
...
free = F_121 ( V_18 -> V_287 [ V_337 ] , & V_325 ) ;
if ( ! free ) {
F_125 ( & V_18 -> V_344 ) ;
continue;
}
V_342 = F_126 ( free , V_329 ) ;
...
V_340 = F_126 ( ( V_342 * V_65 -> V_270 . V_271 ) ,
( V_328 - V_327 ) ) ;
V_26 = F_127 ( V_333 + ( V_327 * V_119 ) ,
V_340 , V_332 ) ;
if ( V_26 ) {
F_47 ( V_65 ,
L_9 ,
...
V_144 [ V_341 ] ,
V_332 [ V_341 ] ) ;
F_130 ( V_65 , V_326 , V_351 ,
V_144 [ V_341 ] ,
F_131 ( V_348 >> V_101 ) + 1 ) ;
V_347 += V_348 >> V_101 ;
F_132 ( V_335 [ V_336 ] , V_352 , V_347 ) ;
if ( ! ( V_326 % 2 ) ) {
V_335 [ V_336 ] |=
F_133 ( V_353 ,
( V_326 - V_18 -> V_345 )
...
F_110 ( V_18 -> V_77 , F_20 ( V_6 ) , 0 , V_18 -> V_287 ,
V_18 -> V_285 ) ;
V_85:
if ( V_327 ) {
...
V_137 ++ , V_326 ++ ) {
if ( V_332 [ V_137 ] ) {
F_130 ( V_65 , V_326 , V_357 ,
0 , 0 ) ;
F_134 ( V_18 -> V_77 ,
F_20 ( V_6 ) ,
V_326 , V_144 [ V_137 ] ,
V_332 [ V_137 ] ) ;
F_135 ( V_65 -> V_349 , V_144 [ V_137 ] ,
V_119 , V_350 ) ;
...
F_57 () ;
F_136 ( V_356 , V_355 ) ;
F_98 ( V_325 , & V_18 -> V_287 [ V_338 ] ) ;
V_323 &= ~ ( 1ULL << V_325 ) ;
}
}
F_110 ( V_18 -> V_77 , F_20 ( V_6 ) , 1 , V_18 -> V_287 ,
V_18 -> V_285 ) ;
V_85:
return V_26 ;
}
...
F_135 ( V_65 -> V_349 , V_144 , V_119 , V_350 ) ;
F_136 ( & V_358 , 1 ) ;
}
}
...
for ( V_137 = 0 ; V_137 < F_137 ( V_316 -> V_364 ) ; V_137 ++ )
if ( V_359 == V_316 -> V_364 [ V_137 ] ) {
V_361 = 1 ;
break;
}
if ( V_361 )
V_26 = F_138 ( V_65 , V_18 -> V_77 , V_359 ) ;
V_85:
return V_26 ;
}
static int F_139 ( struct V_4 * V_4 , struct V_5 * V_365 )
{
struct V_64 * V_65 ;
V_65 = F_140 ( V_4 -> V_366 , struct V_64 , V_367 ) ;
V_365 -> V_7 = V_65 ;
return 0 ;
}
...
static T_5 F_142 ( struct V_5 * V_365 , T_5 V_14 , int V_368 )
{
...
static T_2 F_143 ( struct V_5 * V_365 , char T_3 * V_375 , T_4 V_13 ,
T_5 * V_371 )
{
struct V_64 * V_65 = V_365 -> V_7 ;
...
V_12 = F_147 ( V_376 + V_377 ) ;
if ( F_148 ( V_12 , ( unsigned long T_3 * ) ( V_375 + V_377 ) ) )
break;
}
* V_371 += V_377 ;
return V_377 ;
}
static T_2 F_149 ( struct V_5 * V_365 , const char T_3 * V_375 ,
T_4 V_13 , T_5 * V_371 )
{
struct V_64 * V_65 = V_365 -> V_7 ;
void T_12 * V_376 ;
...
static void F_154 ( struct V_64 * V_65 )
{
if ( F_155 ( & V_387 ) == 0 )
F_156 ( & V_388 , & V_389 ) ;
F_156 ( & V_65 -> V_390 , & V_65 -> V_391 ) ;
F_156 ( & V_65 -> V_367 , & V_65 -> V_392 ) ;
}
static int F_157 ( struct V_64 * V_65 )
{
char V_393 [ 10 ] ;
int V_26 ;
if ( F_158 ( & V_387 ) == 1 ) {
V_26 = F_159 ( 0 , F_160 () , & V_394 ,
& V_388 , & V_389 ,
true ) ;
if ( V_26 )
goto V_85;
}
snprintf ( V_393 , sizeof( V_393 ) , L_11 , F_160 () , V_65 -> V_267 ) ;
V_26 = F_159 ( V_65 -> V_267 + 1 , V_393 , & V_394 ,
...
L_12 , F_160 () , V_65 -> V_267 ) ;
V_26 = F_159 ( V_65 -> V_267 + V_396 , V_393 , & V_397 ,
