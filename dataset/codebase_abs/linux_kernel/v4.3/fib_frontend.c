...
T_2 V_25 = F_91 ( V_144 -> V_222 -> V_32 ) ;
struct V_2 * V_15 ;
struct V_110 V_111 = {
. V_127 = V_223 ,
. V_133 = type ,
...
void F_96 ( struct V_143 * V_144 , struct V_143 * V_238 )
{
struct V_50 * V_51 = V_144 -> V_222 ;
struct V_31 * V_32 = V_51 -> V_32 ;
struct V_143 * V_239 ;
struct V_143 * V_226 = V_144 , * V_240 = NULL ;
T_3 V_241 = V_144 -> V_229 | ~ V_144 -> V_227 ;
...
int V_246 = 0 ;
if ( V_144 -> V_230 & V_231 ) {
V_226 = F_93 ( V_51 , V_242 , V_144 -> V_227 ) ;
if ( ! V_226 ) {
F_94 ( L_1 , V_232 ) ;
return;
}
if ( V_238 && V_238 != V_226 ) {
F_94 ( L_2 , V_232 ) ;
return;
}
} else if ( ! F_22 ( V_242 ) &&
( V_242 != V_144 -> V_148 || V_144 -> V_236 < 32 ) ) {
F_90 ( V_247 ,
V_32 -> V_233 & V_237 ? V_83 : V_43 ,
V_242 , V_144 -> V_236 , V_226 ) ;
V_244 = 1 ;
}
for ( V_239 = V_51 -> V_81 ; V_239 ; V_239 = V_239 -> V_145 ) {
if ( V_239 == V_144 ) {
V_245 = 0 ;
continue;
}
if ( V_238 && V_239 -> V_227 == V_238 -> V_227 &&
F_101 ( V_239 -> V_229 , V_238 ) )
continue;
if ( V_239 -> V_230 & V_231 ) {
if ( V_239 -> V_227 == V_226 -> V_227 &&
F_101 ( V_239 -> V_229 , V_226 ) )
V_240 = V_226 ;
else {
if ( ! V_246 )
continue;
if ( ! V_240 ||
V_239 -> V_227 != V_240 -> V_227 ||
! F_101 ( V_239 -> V_229 , V_240 ) )
V_240 = F_93 ( V_51 ,
V_239 -> V_229 ,
V_239 -> V_227 ) ;
if ( ! V_240 )
continue;
if ( V_240 -> V_148 != V_226 -> V_148 )
continue;
}
} else {
if ( V_226 -> V_148 != V_239 -> V_148 )
continue;
V_240 = V_239 ;
if ( V_226 != V_240 )
V_246 = 1 ;
...
V_243 |= F_97 ;
if ( V_144 -> V_235 == V_239 -> V_235 )
V_243 |= F_98 ;
if ( V_241 == V_239 -> V_235 )
V_243 |= F_100 ;
if ( V_242 == V_239 -> V_235 )
V_243 |= F_99 ;
if ( V_240 == V_239 && V_239 -> V_236 < 31 ) {
T_3 V_248 = V_239 -> V_229 | ~ V_239 -> V_227 ;
T_3 V_249 = V_239 -> V_229 & V_239 -> V_227 ;
if ( ! F_22 ( V_249 ) ) {
if ( V_144 -> V_235 == V_248 ||
V_144 -> V_235 == V_249 )
V_243 |= F_98 ;
if ( V_241 == V_248 || V_241 == V_249 )
V_243 |= F_100 ;
if ( V_242 == V_248 || V_242 == V_249 )
V_243 |= F_99 ;
}
}
}
if ( ! ( V_243 & F_98 ) )
F_90 ( V_247 , V_40 , V_144 -> V_235 , 32 , V_226 ) ;
if ( V_244 && V_144 -> V_236 < 31 ) {
if ( ! ( V_243 & F_100 ) )
F_90 ( V_247 , V_40 , V_241 , 32 , V_226 ) ;
if ( ! ( V_243 & F_99 ) )
F_90 ( V_247 , V_40 , V_242 , 32 , V_226 ) ;
}
if ( ! ( V_243 & F_97 ) ) {
unsigned int V_150 ;
F_90 ( V_247 , V_83 , V_144 -> V_148 , 32 , V_226 ) ;
V_150 = F_32 ( F_38 ( V_32 ) , V_32 ,
V_144 -> V_148 ) ;
if ( V_245 && V_150 != V_83 ) {
if ( F_102 ( F_38 ( V_32 ) , V_144 -> V_148 ) )
F_14 ( F_38 ( V_32 ) ) ;
}
}
#undef F_97
...
static void F_103 ( struct V_1 * V_1 , struct V_250 * V_251 )
{
struct V_37 V_38 ;
struct V_34 V_35 = {
. V_67 = V_251 -> V_252 ,
...
struct V_2 * V_15 ;
F_25 () ;
V_15 = F_6 ( V_1 , V_251 -> V_256 ) ;
V_251 -> V_167 = - V_257 ;
if ( V_15 ) {
F_104 () ;
V_251 -> V_25 = V_15 -> V_25 ;
V_251 -> V_167 = F_26 ( V_15 , & V_35 , & V_38 , V_44 ) ;
if ( ! V_251 -> V_167 ) {
V_251 -> V_258 = V_38 . V_258 ;
V_251 -> V_259 = V_38 . V_259 ;
V_251 -> type = V_38 . type ;
V_251 -> V_54 = V_38 . V_54 ;
}
F_105 () ;
}
F_27 () ;
...
V_1 = F_85 ( V_49 -> V_211 ) ;
V_175 = F_107 ( V_49 ) ;
if ( V_49 -> V_103 < V_260 || V_49 -> V_103 < V_175 -> F_88 ||
F_88 ( V_175 ) < sizeof( * V_251 ) )
return;
V_49 = F_108 ( V_49 , V_157 ) ;
if ( ! V_49 )
return;
V_175 = F_107 ( V_49 ) ;
V_251 = (struct V_250 * ) F_78 ( V_175 ) ;
F_103 ( V_1 , V_251 ) ;
V_193 = F_79 ( V_49 ) . V_193 ;
F_79 ( V_49 ) . V_193 = 0 ;
F_79 ( V_49 ) . V_261 = 0 ;
F_109 ( V_1 -> V_10 . V_262 , V_49 , V_193 , V_263 ) ;
}
...
V_211 = F_111 ( V_1 , V_267 , & V_111 ) ;
if ( ! V_211 )
return - V_118 ;
V_1 -> V_10 . V_262 = V_211 ;
return 0 ;
}
static void F_112 ( struct V_1 * V_1 )
{
F_113 ( V_1 -> V_10 . V_262 ) ;
V_1 -> V_10 . V_262 = NULL ;
}
static void F_114 ( struct V_31 * V_32 , unsigned long V_268 )
{
if ( F_115 ( V_32 , V_268 ) )
F_14 ( F_38 ( V_32 ) ) ;
F_17 ( F_38 ( V_32 ) ) ;
...
static int F_117 ( struct V_269 * V_270 , unsigned long V_268 , void * V_271 )
{
struct V_143 * V_144 = (struct V_143 * ) V_271 ;
...
static int F_120 ( struct V_269 * V_270 , unsigned long V_268 , void * V_271 )
{
struct V_31 * V_32 = F_121 ( V_271 ) ;
struct V_50 * V_51 ;
struct V_1 * V_1 = F_38 ( V_32 ) ;
unsigned int V_233 ;
if ( V_268 == V_277 ) {
...
{
int V_167 ;
T_6 V_283 = sizeof( struct V_23 ) * V_22 ;
V_283 = F_127 ( T_6 , V_283 , V_284 ) ;
V_1 -> V_10 . V_11 = F_68 ( V_283 , V_157 ) ;
if ( ! V_1 -> V_10 . V_11 )
return - V_6 ;
V_167 = F_1 ( V_1 ) ;
if ( V_167 < 0 )
...
#endif
for ( V_285 = 0 ; V_285 < V_22 ; V_285 ++ ) {
struct V_23 * V_24 = & V_1 -> V_10 . V_11 [ V_285 ] ;
struct V_29 * V_30 ;
struct V_2 * V_15 ;
F_15 (tb, tmp, head, tb_hlist) {
F_130 ( & V_15 -> V_9 ) ;
...
void T_8 F_137 ( void )
{
F_138 ( V_288 , V_225 , F_86 , NULL , NULL ) ;
F_138 ( V_288 , V_247 , F_84 , NULL , NULL ) ;
F_138 ( V_288 , V_289 , NULL , F_87 , NULL ) ;
F_139 ( & V_290 ) ;
F_140 ( & V_291 ) ;
F_141 ( & V_292 ) ;
F_142 () ;
