...
if ( V_13 )
goto V_58;
sscanf ( V_25 -> V_59 , L_6 , & V_54 ) ;
if ( V_20 != V_54 )
F_23 ( & V_25 -> V_52 , L_7 ,
V_54 , V_20 ) ;
F_24 ( & V_25 -> V_52 , L_8 ,
V_25 -> V_59 , V_20 ,
V_6 -> V_14 . V_42 -> V_60 , V_6 -> V_14 . V_42 -> V_61 ) ;
}
if ( V_6 -> V_26 -> V_27 & V_55 ) {
...
struct V_62 const * V_63 , int V_19 , int V_64 , long V_65 )
{
struct V_5 * V_6 = F_7 ( V_25 ) ;
int V_13 , V_39 ;
switch ( V_65 ) {
...
const struct V_62 * V_95 = & V_93 -> V_96 [ V_47 ] ;
if ( V_95 -> V_69 >= 0 &&
V_95 -> V_69 != V_97 )
V_6 -> V_98 [ 0 ] |= F_32 ( V_95 -> V_69 ) ;
}
}
