...
{
struct V_1 * V_4 = F_2 ( V_3 ) ;
unsigned long V_224 = V_4 -> V_225 -> V_20 & V_226 ;
if ( F_117 ( V_4 ) )
F_8 ( V_4 -> V_3 , L_29 , V_3 -> V_61 ) ;
if ( V_224 == V_227 )
V_224 = F_118 ( V_3 -> V_213 ) ;
if ( V_224 == V_227 )
F_100 ( V_4 -> V_3 , L_30 ) ;
V_224 |= V_228 ;
F_6 ( V_4 , V_145 , 0 ) ;
F_29 ( 1 ) ;
F_90 ( V_3 ) ;
if ( F_119 ( V_3 -> V_213 , F_110 , V_224 , V_3 -> V_61 , V_3 ) )
return - V_229 ;
F_89 ( V_4 ) ;
V_4 -> V_230 = 0 ;
...
static struct V_231 * F_126 ( struct V_232 * V_3 )
{
struct V_231 * V_233 ;
struct V_234 * V_235 = V_3 -> V_236 ;
const void * V_237 ;
if ( ! F_127 ( V_238 ) || ! V_235 )
return F_128 ( - V_239 ) ;
V_233 = F_129 ( V_3 , sizeof( * V_233 ) , V_240 ) ;
if ( ! V_233 )
return F_128 ( - V_241 ) ;
...
{
struct V_231 * V_233 = F_133 ( & V_111 -> V_3 ) ;
struct V_1 * V_4 ;
struct V_2 * V_96 ;
struct V_232 * V_3 = & V_111 -> V_3 ;
...
enum V_246 V_20 ;
struct V_247 * V_248 ;
V_248 = F_134 ( V_3 , L_34 ) ;
if ( F_135 ( V_248 ) ) {
if ( F_136 ( V_248 ) == - V_249 )
return - V_249 ;
F_8 ( V_3 , L_35 ) ;
} else {
V_22 = F_137 ( V_248 ) ;
...
V_245 = F_138 ( V_3 -> V_236 , L_38 , 0 ,
& V_20 ) ;
if ( F_139 ( V_245 ) ) {
V_22 = F_140 ( V_3 , V_245 , V_20 ,
L_39 ) ;
if ( V_22 ) {
F_10 ( V_3 , L_40 ,
V_245 , V_22 ) ;
...
F_145 ( & V_4 -> V_23 ) ;
F_146 ( & V_4 -> V_39 , F_71 ) ;
V_4 -> V_251 = F_147 ( V_111 , V_252 , 0 ) ;
V_4 -> V_253 = F_147 ( V_111 , V_252 , 1 ) ;
V_4 -> V_225 = F_147 ( V_111 , V_254 , 0 ) ;
if ( V_4 -> V_251 == NULL || V_4 -> V_253 == NULL ||
V_4 -> V_225 == NULL ) {
F_10 ( V_4 -> V_3 , L_42 ) ;
V_22 = - V_75 ;
goto V_255;
...
if ( V_4 -> V_92 >= 0 ) {
F_8 ( V_4 -> V_3 , L_43 , V_4 -> V_92 ) ;
V_22 = F_119 ( V_4 -> V_92 , F_112 ,
V_228 , F_149 ( V_4 -> V_3 ) , V_96 ) ;
if ( V_22 ) {
F_10 ( V_4 -> V_3 , L_44 , V_22 ) ;
} else {
...
V_243 = F_150 ( V_4 -> V_251 ) ;
V_4 -> V_113 = F_151 ( V_4 -> V_251 -> V_256 , V_243 ,
V_111 -> V_61 ) ;
if ( V_4 -> V_113 == NULL ) {
F_10 ( V_4 -> V_3 , L_46 ) ;
V_22 = - V_257 ;
...
V_4 -> V_6 = F_152 ( V_4 -> V_251 -> V_256 , V_243 ) ;
if ( V_4 -> V_6 == NULL ) {
F_10 ( V_4 -> V_3 , L_47 ) ;
V_22 = - V_45 ;
goto V_255;
}
V_243 = F_150 ( V_4 -> V_253 ) ;
V_4 -> V_112 = F_151 ( V_4 -> V_253 -> V_256 , V_243 ,
V_111 -> V_61 ) ;
if ( V_4 -> V_112 == NULL ) {
F_10 ( V_4 -> V_3 , L_48 ) ;
V_22 = - V_257 ;
...
V_4 -> V_7 = F_152 ( V_4 -> V_253 -> V_256 , V_243 ) ;
if ( V_4 -> V_7 == NULL ) {
F_10 ( V_4 -> V_3 , L_49 ) ;
V_22 = - V_45 ;
goto V_255;
}
V_96 -> V_258 = ( unsigned long ) V_4 -> V_6 ;
V_96 -> V_213 = V_4 -> V_225 -> V_256 ;
F_38 ( V_4 , V_243 ) ;
if ( V_233 != NULL ) {
if ( V_233 -> V_20 & V_259 )
F_38 ( V_4 , 1 ) ;
...
V_244 = F_3 ( V_4 , V_262 ) ;
V_244 |= ( T_3 ) F_3 ( V_4 , V_263 ) << 8 ;
V_244 |= ( T_3 ) F_3 ( V_4 , V_264 ) << 16 ;
V_244 |= ( T_3 ) F_3 ( V_4 , V_265 ) << 24 ;
if ( V_244 == V_266 )
break;
F_10 ( V_4 -> V_3 , L_50 , V_244 ) ;
}
if ( V_244 != V_266 ) {
F_10 ( V_4 -> V_3 , L_51 , V_244 ) ;
V_22 = - V_250 ;
goto V_255;
}
V_244 = F_3 ( V_4 , V_267 ) ;
F_8 ( V_4 -> V_3 , L_52 , V_244 ) ;
switch ( V_244 ) {
case V_268 :
V_4 -> type = V_115 ;
break;
...
break;
default:
F_8 ( V_4 -> V_3 , L_53 , V_244 ) ;
V_4 -> type = V_38 ;
}
if ( V_4 -> type == V_115 || V_4 -> type == V_116 ) {
V_96 -> V_142 = V_66 | V_270 ;
V_96 -> V_64 |= V_96 -> V_142 ;
}
V_96 -> V_271 = & V_272 ;
V_96 -> V_273 = F_154 ( V_274 ) ;
V_96 -> V_275 = & V_276 ;
V_4 -> V_62 = V_277 ;
V_4 -> V_46 . V_278 = 0x1f ;
V_4 -> V_46 . V_279 = 0x1f ;
...
if ( ! F_155 ( V_96 -> V_128 ) && V_233 != NULL ) {
V_242 = L_55 ;
memcpy ( V_96 -> V_128 , V_233 -> V_128 , V_283 ) ;
}
if ( ! F_155 ( V_96 -> V_128 ) ) {
V_242 = L_56 ;
