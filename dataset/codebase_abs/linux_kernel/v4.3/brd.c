...
F_39 ( V_1 , V_31 & V_59 , V_33 ) ;
return V_33 ;
}
static long F_40 ( struct V_39 * V_40 , T_1 V_4 ,
void T_5 * * V_60 , unsigned long * V_61 )
{
struct V_2 * V_3 = V_40 -> V_42 -> V_43 ;
struct V_1 * V_1 ;
if ( ! V_3 )
...
if ( ! V_1 )
return - V_26 ;
* V_60 = ( void T_5 * ) F_41 ( V_1 ) ;
* V_61 = F_42 ( V_1 ) ;
return V_25 ;
}
static int F_43 ( struct V_39 * V_40 , T_6 V_63 ,
...
static int T_7 F_47 ( char * V_72 )
{
V_73 = F_48 ( V_72 , NULL , 0 ) ;
return 1 ;
}
...
F_58 ( V_3 -> V_79 , V_84 ) ;
V_3 -> V_79 -> V_82 . V_85 = 1 ;
F_59 ( V_86 , V_3 -> V_79 ) ;
V_75 = V_3 -> V_87 = F_60 ( V_88 ) ;
if ( ! V_75 )
goto V_89;
V_75 -> V_90 = V_91 ;
V_75 -> V_92 = V_18 * V_88 ;
...
static struct V_2 * F_66 ( int V_18 , bool * V_99 )
{
struct V_2 * V_3 ;
* V_99 = false ;
...
static struct V_102 * F_73 ( T_8 V_103 , int * V_104 , void * V_105 )
{
struct V_2 * V_3 ;
struct V_102 * V_106 ;
bool V_99 ;
F_44 ( & V_107 ) ;
V_3 = F_66 ( F_74 ( V_103 ) / V_88 , & V_99 ) ;
V_106 = V_3 ? F_75 ( V_3 -> V_87 ) : NULL ;
F_46 ( & V_107 ) ;
if ( V_99 )
* V_104 = 0 ;
return V_106 ;
...
F_67 (brd, &brd_devices, brd_list)
F_68 ( V_3 -> V_87 ) ;
F_78 ( F_79 ( V_91 , 0 ) , 1UL << V_112 ,
V_113 , F_73 , NULL , NULL ) ;
F_80 ( L_3 ) ;
return 0 ;
V_111:
