...
int F_90 ( struct V_54 * V_55 )
{
struct V_1 * V_91 = V_55 -> V_3 , * V_3 ;
struct V_76 V_76 ;
struct V_70 * V_71 ;
int V_78 ;
V_55 -> V_3 = NULL ;
...
int F_92 ( char * V_52 , char * V_39 )
{
struct V_32 V_74 , V_93 ;
int V_94 = 0 ;
struct V_76 V_95 , V_96 ;
struct V_70 * V_97 ;
int V_78 ;
V_78 = F_73 ( V_39 , 0 , & V_96 ) ;
if ( V_78 )
return V_78 ;
V_97 = F_74 ( & V_96 ) ;
F_75 ( & V_96 ) ;
...
static int F_97 ( struct V_102 * V_47 ,
struct V_33 * V_103 ,
struct V_22 * V_104 ,
struct V_22 * V_105 ,
T_2 V_30 , void * V_106 , int V_107 ,
const unsigned char * V_108 , T_2 V_109 )
{
return 0 ;
}
static void F_98 ( struct V_22 * V_23 , struct V_102 * V_47 )
{
struct V_14 * V_15 = F_16 ( V_23 , struct V_14 , V_24 ) ;
F_95 ( V_15 ) ;
F_99 ( F_100 ( & V_23 -> V_110 ) < 1 ) ;
}
