...
static const struct V_228 * F_124 ( unsigned char * V_242 ,
unsigned char * V_243 )
{
const struct V_244 * V_245 ;
int V_57 ;
for ( V_57 = 0 ; V_57 < F_125 ( V_246 ) ; V_57 ++ ) {
V_245 = & V_246 [ V_57 ] ;
if ( ! memcmp ( V_242 , V_245 -> V_247 , sizeof( V_245 -> V_247 ) ) &&
( ! V_245 -> V_248 ||
V_245 -> V_248 == V_243 [ 2 ] ) ) {
return & V_245 -> V_249 ;
}
...
{
const struct V_228 * V_229 ;
unsigned char V_250 [ 4 ] , V_242 [ 4 ] , V_243 [ 4 ] ;
int error ;
if ( F_88 ( V_17 , V_194 ,
V_186 , V_250 ) )
return - V_180 ;
if ( ( V_250 [ 0 ] & 0xf8 ) != 0 || V_250 [ 1 ] != 0 || ( V_250 [ 2 ] != 10 && V_250 [ 2 ] != 100 ) )
return - V_251 ;
if ( F_88 ( V_17 , V_194 ,
V_185 , V_242 ) ||
F_88 ( V_17 , V_194 ,
...
F_91 ( V_17 ) )
return - V_180 ;
V_229 = F_124 ( V_242 , V_243 ) ;
if ( ! V_229 ) {
if ( V_242 [ 0 ] == 0x73 && V_242 [ 1 ] == 0x03 && V_242 [ 2 ] == 0x50 &&
V_243 [ 0 ] == 0x73 && ( V_243 [ 1 ] == 0x01 || V_243 [ 1 ] == 0x02 ) ) {
V_229 = & V_252 ;
} else if ( V_243 [ 0 ] == 0x88 &&
( ( V_243 [ 1 ] & 0xf0 ) == 0xb0 || ( V_243 [ 1 ] & 0xf0 ) == 0xc0 ) ) {
V_229 = & V_253 ;
} else if ( V_243 [ 0 ] == 0x88 && V_243 [ 1 ] == 0x08 ) {
V_229 = & V_254 ;
} else if ( V_243 [ 0 ] == 0x88 && V_243 [ 1 ] == 0x07 &&
V_243 [ 2 ] >= 0x90 && V_243 [ 2 ] <= 0x9d ) {
V_229 = & V_255 ;
} else if ( V_242 [ 0 ] == 0x73 && V_242 [ 1 ] == 0x03 &&
V_242 [ 2 ] == 0x14 && V_243 [ 1 ] == 0x02 ) {
V_229 = & V_256 ;
} else {
F_22 ( V_17 ,
L_25 , V_242 , V_243 ) ;
...
F_136 ( V_257 , V_7 -> V_258 ) ;
F_136 ( V_259 , V_7 -> V_258 ) ;
}
...
if ( error )
goto V_265;
F_139 ( V_151 , V_7 -> V_266 ) ;
F_139 ( V_33 , V_7 -> V_267 ) ;
F_139 ( V_34 , V_7 -> V_267 ) ;
V_7 -> V_266 [ F_140 ( V_152 ) ] |= F_141 ( V_152 ) ;
V_7 -> V_258 [ F_140 ( V_41 ) ] |= F_141 ( V_41 ) ;
V_7 -> V_258 [ F_140 ( V_40 ) ] |= F_141 ( V_40 ) ;
V_7 -> V_258 [ F_140 ( V_13 ) ] |=
F_141 ( V_13 ) | F_141 ( V_15 ) ;
V_7 -> V_266 [ F_140 ( V_268 ) ] |= F_141 ( V_268 ) ;
V_2 -> V_231 ( V_2 , V_7 ) ;
if ( V_2 -> V_29 & V_42 ) {
V_7 -> V_266 [ F_140 ( V_151 ) ] |= F_141 ( V_151 ) ;
V_7 -> V_267 [ F_140 ( V_43 ) ] |= F_141 ( V_43 ) ;
}
if ( V_2 -> V_29 & ( V_30 | V_31 ) ) {
V_7 -> V_258 [ F_140 ( V_44 ) ] |= F_141 ( V_44 ) ;
V_7 -> V_258 [ F_140 ( V_45 ) ] |= F_141 ( V_45 ) ;
}
if ( V_2 -> V_29 & V_46 ) {
V_7 -> V_258 [ F_140 ( V_47 ) ] |= F_141 ( V_47 ) ;
V_7 -> V_258 [ F_140 ( V_48 ) ] |= F_141 ( V_48 ) ;
V_7 -> V_258 [ F_140 ( V_49 ) ] |= F_141 ( V_49 ) ;
V_7 -> V_258 [ F_140 ( V_50 ) ] |= F_141 ( V_50 ) ;
} else if ( V_2 -> V_29 & V_120 ) {
F_136 ( V_269 , V_7 -> V_154 ) ;
F_142 ( V_15 , V_7 -> V_258 ) ;
} else {
V_7 -> V_258 [ F_140 ( V_16 ) ] |= F_141 ( V_16 ) ;
}
if ( V_2 -> V_29 & V_32 ) {
struct V_6 * V_8 ;
V_8 = F_59 () ;
...
snprintf ( V_2 -> V_270 , sizeof( V_2 -> V_270 ) , L_27 ,
V_17 -> V_139 . V_140 -> V_141 ) ;
V_8 -> V_141 = V_2 -> V_270 ;
V_8 -> V_142 = L_28 ;
V_8 -> V_143 . V_144 = V_145 ;
V_8 -> V_143 . V_146 = 0x0002 ;
V_8 -> V_143 . V_147 = V_271 ;
...
int F_144 ( struct V_17 * V_17 , bool V_279 )
{
struct V_1 * V_2 ;
int error ;
...
return error ;
F_128 ( V_17 ) ;
V_2 = F_145 ( sizeof( struct V_1 ) , V_280 ) ;
if ( ! V_2 )
return - V_137 ;
