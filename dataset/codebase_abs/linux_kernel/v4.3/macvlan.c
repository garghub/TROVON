...
static int F_96 ( struct V_5 * V_6 , void * V_118 )
{
struct V_8 * V_10 = F_70 ( V_6 ) ;
...
return F_95 ( V_6 , V_1 -> V_120 ) ;
}
static void F_99 ( struct V_5 * V_6 , int V_122 )
{
struct V_8 * V_10 = F_70 ( V_6 ) ;
struct V_5 * V_88 = V_10 -> V_88 ;
if ( V_6 -> V_72 & V_73 ) {
...
F_101 ( V_10 -> V_49 , V_123 ) ;
} else {
struct V_124 * V_125 ;
F_102 ( V_126 , V_123 ) ;
F_103 ( V_126 , V_123 ) ;
F_104 (ha, dev) {
F_105 ( F_28 ( V_10 , V_125 -> V_1 ) , V_126 ) ;
}
F_105 ( F_28 ( V_10 , V_6 -> V_32 ) , V_126 ) ;
F_106 ( V_10 -> V_49 , V_126 , V_123 ) ;
}
F_107 ( V_10 -> V_88 , V_6 ) ;
F_108 ( V_10 -> V_88 , V_6 ) ;
}
static int F_109 ( struct V_5 * V_6 , int V_127 )
{
struct V_8 * V_10 = F_70 ( V_6 ) ;
...
{
return ( (struct V_8 * ) F_70 ( V_6 ) ) -> V_130 ;
}
...
static struct V_148 * F_121 ( struct V_5 * V_6 ,
struct V_148 * V_149 )
{
struct V_8 * V_10 = F_70 ( V_6 ) ;
if ( V_10 -> V_95 ) {
...
int V_43 ;
F_122 (i) {
V_118 = F_123 ( V_10 -> V_95 , V_43 ) ;
do {
V_154 = F_124 ( & V_118 -> V_96 ) ;
V_150 = V_118 -> V_150 ;
V_151 = V_118 -> V_151 ;
V_152 = V_118 -> V_152 ;
V_97 = V_118 -> V_97 ;
V_98 = V_118 -> V_98 ;
} while ( F_125 ( & V_118 -> V_96 , V_154 ) );
V_149 -> V_150 += V_150 ;
V_149 -> V_151 += V_151 ;
V_149 -> V_155 += V_152 ;
V_149 -> V_97 += V_97 ;
...
struct V_8 * V_10 = F_70 ( V_6 ) ;
struct V_5 * V_88 = V_10 -> V_88 ;
F_129 ( V_88 , V_156 , V_157 ) ;
return 0 ;
}
static int F_130 ( struct V_158 * V_159 , struct V_160 * V_161 [] ,
struct V_5 * V_6 ,
...
static int F_134 ( struct V_158 * V_159 , struct V_160 * V_161 [] ,
struct V_5 * V_6 ,
const unsigned char * V_1 , T_6 V_157 )
{
struct V_8 * V_10 = F_70 ( V_6 ) ;
...
struct V_164 * V_165 )
{
F_137 ( V_165 -> V_166 , L_1 , sizeof( V_165 -> V_166 ) ) ;
F_137 ( V_165 -> V_167 , L_2 , sizeof( V_165 -> V_167 ) ) ;
}
static int F_138 ( struct V_5 * V_6 ,
struct V_168 * V_169 )
{
const struct V_8 * V_10 = F_70 ( V_6 ) ;
return F_139 ( V_10 -> V_88 , V_169 ) ;
}
...
static int F_143 ( struct V_5 * V_6 , struct V_175 * V_176 )
{
struct V_8 * V_10 = F_70 ( V_6 ) ;
...
static int F_149 ( const struct V_5 * V_6 )
{
struct V_8 * V_10 = F_70 ( V_6 ) ;
...
static int F_164 ( struct V_160 * V_161 [] , struct V_160 * V_86 [] )
{
if ( V_161 [ V_193 ] ) {
if ( F_165 ( V_161 [ V_193 ] ) != V_25 )
return - V_129 ;
if ( ! F_97 ( F_166 ( V_161 [ V_193 ] ) ) )
return - V_121 ;
}
if ( V_86 && V_86 [ V_194 ] &&
F_167 ( V_86 [ V_194 ] ) & ~ V_102 )
return - V_129 ;
if ( V_86 && V_86 [ V_195 ] ) {
switch ( F_168 ( V_86 [ V_195 ] ) ) {
case V_63 :
case V_64 :
case V_52 :
case V_65 :
...
if ( V_86 && V_86 [ V_202 ] ) {
if ( F_165 ( V_86 [ V_202 ] ) != V_25 )
return - V_129 ;
if ( ! F_97 ( F_166 ( V_86 [ V_202 ] ) ) )
return - V_121 ;
}
if ( V_86 && V_86 [ V_203 ] )
return - V_129 ;
...
static int F_169 ( struct V_8 * V_10 , T_1 V_41 ,
struct V_160 * V_86 [] )
{
char * V_1 = NULL ;
int V_71 , V_204 , V_53 ;
...
if ( ! V_86 || ! V_86 [ V_207 ] )
return 0 ;
V_206 = F_166 ( V_86 [ V_207 ] ) ;
V_53 = F_165 ( V_86 [ V_207 ] ) ;
F_170 (nla, head, len, rem) {
if ( F_171 ( V_205 ) != V_202 ||
F_165 ( V_205 ) != V_25 )
continue;
V_1 = F_166 ( V_205 ) ;
V_71 = F_13 ( V_10 , V_1 ) ;
...
int F_172 ( struct V_208 * V_209 , struct V_5 * V_6 ,
...
if ( ! V_161 [ V_211 ] )
return - V_129 ;
V_88 = F_173 ( V_209 , F_168 ( V_161 [ V_211 ] ) ) ;
if ( V_88 == NULL )
return - V_212 ;
if ( F_174 ( V_88 ) )
V_88 = F_175 ( V_88 ) ;
...
V_10 -> V_9 = V_9 ;
V_10 -> V_173 = V_140 ;
V_10 -> V_130 = F_178 ( V_88 , F_174 ) + 1 ;
V_10 -> V_41 = V_64 ;
if ( V_86 && V_86 [ V_195 ] )
V_10 -> V_41 = F_168 ( V_86 [ V_195 ] ) ;
if ( V_86 && V_86 [ V_194 ] )
V_10 -> V_72 = F_167 ( V_86 [ V_194 ] ) ;
if ( V_10 -> V_41 == V_65 ) {
if ( V_9 -> V_147 )
return - V_129 ;
V_9 -> V_82 = true ;
...
if ( V_10 -> V_41 != V_196 )
return - V_129 ;
V_210 = F_168 ( V_86 [ V_197 ] ) ;
V_44 = F_169 ( V_10 , V_210 , V_86 ) ;
if ( V_44 )
return V_44 ;
}
V_9 -> V_147 += 1 ;
...
static int F_185 ( struct V_208 * V_209 , struct V_5 * V_6 ,
struct V_160 * V_161 [] , struct V_160 * V_86 [] )
{
return F_172 ( V_209 , V_6 , V_161 , V_86 ) ;
}
void F_186 ( struct V_5 * V_6 , struct V_217 * V_206 )
{
struct V_8 * V_10 = F_70 ( V_6 ) ;
if ( V_10 -> V_41 == V_196 )
F_57 ( V_10 -> V_9 , V_10 ) ;
...
return - V_129 ;
V_210 = F_168 ( V_86 [ V_197 ] ) ;
V_71 = F_169 ( V_10 , V_210 , V_86 ) ;
if ( V_71 )
return V_71 ;
}
return 0 ;
}
static T_9 F_191 ( const struct V_8 * V_10 )
{
if ( V_10 -> V_21 == 0 )
return 0 ;
return F_192 ( 0 )
+ V_10 -> V_21 * F_192 ( sizeof( V_221 ) * V_25 ) ;
}
static T_9 F_193 ( const struct V_5 * V_6 )
{
struct V_8 * V_10 = F_70 ( V_6 ) ;
return ( 0
+ F_192 ( 4 )
...
if ( V_14 -> V_10 != V_10 )
continue;
if ( F_195 ( V_27 , V_202 , V_25 , V_14 -> V_1 ) )
return 1 ;
}
return 0 ;
}
...
int V_43 ;
struct V_160 * V_222 ;
if ( F_197 ( V_27 , V_195 , V_10 -> V_41 ) )
goto V_223;
if ( F_198 ( V_27 , V_194 , V_10 -> V_72 ) )
goto V_223;
if ( F_197 ( V_27 , V_203 , V_10 -> V_21 ) )
goto V_223;
if ( V_10 -> V_21 > 0 ) {
V_222 = F_199 ( V_27 , V_207 ) ;
if ( V_222 == NULL )
goto V_223;
for ( V_43 = 0 ; V_43 < V_48 ; V_43 ++ ) {
if ( F_194 ( V_27 , V_10 , V_43 ) )
goto V_223;
}
F_200 ( V_27 , V_222 ) ;
}
...
static struct V_208 * F_203 ( const struct V_5 * V_6 )
{
return F_204 ( F_175 ( V_6 ) ) ;
}
