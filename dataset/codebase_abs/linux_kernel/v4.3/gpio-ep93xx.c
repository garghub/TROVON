...
int V_61 ;
V_61 = F_33 ( V_53 , V_55 , 1 , V_59 , NULL , NULL , V_60 , NULL , 0 ) ;
if ( V_61 )
return V_61 ;
...
struct V_70 * V_71 ;
int V_17 ;
struct V_54 * V_55 = & V_68 -> V_55 ;
V_69 = F_36 ( V_55 , sizeof( struct V_69 ) , V_72 ) ;
if ( ! V_69 )
return - V_73 ;
V_71 = F_37 ( V_68 , V_74 , 0 ) ;
V_69 -> V_56 = F_38 ( V_55 , V_71 ) ;
if ( F_39 ( V_69 -> V_56 ) )
return F_40 ( V_69 -> V_56 ) ;
for ( V_17 = 0 ; V_17 < F_41 ( V_75 ) ; V_17 ++ ) {
struct V_52 * V_53 = & V_69 -> V_53 [ V_17 ] ;
struct V_57 * V_58 = & V_75 [ V_17 ] ;
if ( F_32 ( V_53 , & V_68 -> V_55 ,
V_69 -> V_56 , V_58 ) )
F_42 ( & V_68 -> V_55 , L_1 ,
V_58 -> V_63 ) ;
}
