...
F_55 ( & V_132 ,
V_8 -> V_160 ) ) ;
F_46 ( V_92 , L_60 , V_8 -> V_161 ) ;
F_46 ( V_92 , L_61 , V_8 -> V_162 ) ;
F_46 ( V_92 , L_62 , V_8 -> V_163 / V_164 ) ;
return 0 ;
}
...
F_15 ( V_41 , L_63 ) ;
F_59 ( & V_10 -> V_16 -> V_4 -> V_169 ) ;
F_59 ( & V_10 -> V_16 -> V_4 -> V_170 ) ;
F_60 ( 1 ) ;
F_59 ( & V_10 -> V_16 -> V_4 -> V_170 ) ;
F_60 ( 1 ) ;
}
...
static int F_62 ( struct V_1 * V_2 , int * V_74 , char * V_171 )
{
F_63 ( V_2 ) ;
* V_74 |= V_172 ;
return 0 ;
...
static struct V_46 *
F_66 ( struct V_173 * V_174 , struct V_1 * V_2 )
{
struct V_46 * V_46 ;
struct V_3 * V_8 = F_2 ( V_2 ) ;
char * V_175 = NULL ;
char * V_92 , * V_176 ;
char V_177 ;
V_175 = F_67 ( V_174 , V_8 ,
F_9 ( V_8 ) ) ;
if ( V_175 == NULL )
return F_68 ( - V_39 ) ;
F_15 ( V_41 , L_64 , V_175 ) ;
V_177 = F_69 ( V_8 ) ;
V_46 = F_70 ( V_2 -> V_38 ) ;
V_176 = V_92 = V_175 ;
do {
struct V_7 * V_178 = F_71 ( V_46 ) ;
struct V_46 * V_179 ;
if ( ! V_178 ) {
F_72 ( V_46 ) ;
V_46 = F_68 ( - V_180 ) ;
...
V_92 ++ ;
F_74 ( & V_178 -> V_183 ) ;
V_179 = F_75 ( V_176 , V_46 , V_92 - V_176 ) ;
F_76 ( & V_178 -> V_183 ) ;
F_72 ( V_46 ) ;
V_46 = V_179 ;
} while ( ! F_11 ( V_46 ) );
...
static int F_78 ( struct V_1 * V_2 , void * V_171 )
{
...
struct V_184 V_185 ;
struct V_46 * V_122 ;
F_15 ( V_41 , L_65 , V_189 , V_74 ) ;
V_190 = F_81 ( ( char * ) V_171 , V_189 ) ;
if ( F_11 ( V_190 ) )
return F_82 ( V_190 ) ;
...
V_8 -> V_192 = F_84 ( V_171 , V_193 , V_72 ) ;
if ( V_8 -> V_192 == NULL ) {
V_122 = F_68 ( - V_39 ) ;
goto V_194;
}
...
V_185 . V_74 = V_74 ;
V_74 |= V_172 | V_197 ;
V_2 = F_87 ( V_188 , V_198 , F_78 , V_74 , & V_185 ) ;
if ( F_11 ( V_2 ) ) {
V_122 = F_82 ( V_2 ) ;
F_18 ( V_8 ) ;
goto V_199;
...
V_122 = F_66 ( V_190 , V_2 ) ;
if ( F_11 ( V_122 ) )
goto V_200;
F_15 ( V_41 , L_68 , V_122 ) ;
goto V_199;
V_200:
F_88 ( V_2 ) ;
V_199:
...
static T_2
F_90 ( struct V_202 * V_203 , struct V_204 * V_205 )
{
T_2 V_11 ;
struct V_7 * V_7 = F_91 ( V_203 -> V_206 ) ;
V_11 = F_92 ( V_7 ) ;
if ( V_11 )
return V_11 ;
return F_93 ( V_203 , V_205 ) ;
}
static T_2 F_94 ( struct V_202 * V_203 , struct V_204 * V_207 )
{
struct V_7 * V_7 = F_91 ( V_203 -> V_206 ) ;
...
static T_1 F_100 ( struct V_58 * V_58 , T_1 V_211 , int V_212 )
{
if ( V_212 != V_213 && V_212 != V_214 ) {
int V_11 ;
struct V_7 * V_7 = F_91 ( V_58 ) ;
if ( ! F_101 ( F_37 ( V_7 ) ) && V_7 -> V_210 &&
V_7 -> V_210 -> V_215 != 0 ) {
V_11 = F_102 ( V_7 -> V_210 ) ;
if ( V_11 ) {
F_103 ( V_7 -> V_210 , V_11 ) ;
return V_11 ;
}
}
F_37 ( V_7 ) -> time = 0 ;
...
return F_105 ( V_58 , V_211 , V_212 ) ;
}
static int
F_106 ( struct V_58 * V_58 , long V_216 , struct V_217 * * V_218 , void * * V_219 )
{
struct V_7 * V_7 = F_91 ( V_58 ) ;
...
return - V_223 ;
if ( V_216 == V_224 ||
( ( V_216 == V_225 ) && F_101 ( F_37 ( V_7 ) ) ) ||
( ( V_216 == V_226 ) && F_97 ( F_37 ( V_7 ) ) ) )
return F_108 ( V_58 , V_216 , V_218 , V_219 ) ;
else if ( F_109 ( V_221 -> V_227 ) -> V_228 &&
! F_101 ( F_37 ( V_7 ) ) )
return F_108 ( V_58 , V_216 , V_218 , V_219 ) ;
else
return - V_229 ;
...
V_269 = F_129 ( L_78 , V_270 | V_271 , 0 ) ;
if ( ! V_269 ) {
V_11 = - V_39 ;
goto V_272;
}
