...
static void F_87 ( struct V_169 * V_170 , struct V_171 * V_171 )
{
...
static int F_97 ( struct V_181 * V_182 , T_7 V_137 ,
struct V_140 * V_140 , int V_147 )
{
struct V_60 * V_60 = V_182 -> V_183 -> V_184 ;
F_85 ( V_60 , NULL , V_140 , V_185 , 0 , V_147 , V_137 ) ;
F_98 ( V_140 , V_147 & V_167 , 0 ) ;
return 0 ;
}
static int F_99 ( struct V_181 * V_186 , struct V_187 * V_188 )
{
V_188 -> V_189 = 1 << 6 ;
V_188 -> V_190 = 1 << 5 ;
V_188 -> V_191 = F_100 ( V_186 -> V_183 ) >> 11 ;
return 0 ;
}
...
V_60 -> V_193 -> V_196 = V_197 ;
V_60 -> V_193 -> V_198 = 0 ;
V_60 -> V_193 -> V_199 = & V_200 ;
V_60 -> V_193 -> V_184 = V_60 ;
V_60 -> V_193 -> V_201 = V_60 -> V_192 ;
V_60 -> V_193 -> V_59 = V_202 ;
F_106 ( V_60 -> V_192 , F_87 ) ;
F_107 ( V_60 -> V_192 , V_60 -> V_136 ) ;
F_108 ( V_60 -> V_192 , V_203 ) ;
F_109 ( V_60 -> V_192 , V_204 ) ;
F_110 ( V_205 , V_60 -> V_192 ) ;
V_60 -> V_192 -> V_172 = V_60 ;
F_111 ( V_60 -> V_193 , 0 ) ;
F_112 ( V_60 -> V_193 ) ;
if ( F_66 ( V_60 ) ) {
int V_206 = F_113 ( V_60 -> V_193 , F_66 ( V_60 ) ) ;
if ( V_206 ) {
F_114 ( V_60 -> V_193 ) ;
F_115 ( V_60 -> V_193 ) ;
F_104 ( V_60 -> V_192 ) ;
...
static struct V_60 * F_119 ( struct V_6 * V_6 , unsigned long long V_109 ,
...
V_12 = F_53 ( V_60 ) ;
if ( V_12 ) {
F_122 ( V_62 , L_25 , V_12 ) ;
goto V_207;
}
if ( V_60 -> V_115 != V_120 && V_158 -> V_208 ) {
F_28 ( V_62 , L_26 ,
F_23 ( & V_158 -> V_62 ) ) ;
goto V_207;
...
V_12 = F_63 ( V_60 ) ;
if ( V_12 ) {
F_122 ( V_62 , L_29 , V_12 ) ;
goto V_207;
}
}
V_12 = F_101 ( V_60 ) ;
if ( V_12 ) {
F_122 ( V_62 , L_30 , V_12 ) ;
goto V_207;
}
F_22 ( V_60 ) ;
return V_60 ;
...
static void F_124 ( struct V_60 * V_60 )
{
if ( V_60 ) {
F_117 ( V_60 ) ;
F_46 ( V_60 ) ;
...
{
struct V_6 * V_6 = F_126 ( V_8 -> V_209 ) ;
struct V_158 * V_158 ;
struct V_60 * V_60 ;
T_2 V_109 ;
...
V_158 = F_128 ( V_6 -> V_62 . V_43 ) ;
V_60 = F_119 ( V_6 , V_109 , V_6 -> V_102 , V_6 -> V_130 ,
V_158 ) ;
if ( ! V_60 )
return - V_82 ;
V_6 -> V_60 = V_60 ;
