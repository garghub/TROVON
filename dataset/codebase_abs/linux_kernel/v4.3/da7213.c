...
V_230 |
V_231 , V_204 ) ;
V_33 -> V_169 = V_187 -> V_232 ;
}
return 0 ;
}
static int F_28 ( struct V_233 * V_234 ,
const struct V_235 * V_236 )
{
struct V_32 * V_33 ;
struct V_186 * V_187 = F_29 ( & V_234 -> V_31 ) ;
int V_57 ;
V_33 = F_30 ( & V_234 -> V_31 , sizeof( struct V_32 ) ,
V_237 ) ;
if ( ! V_33 )
return - V_238 ;
if ( V_187 )
V_33 -> V_187 = V_187 ;
F_31 ( V_234 , V_33 ) ;
V_33 -> V_239 = F_32 ( V_234 , & V_240 ) ;
if ( F_33 ( V_33 -> V_239 ) ) {
V_57 = F_34 ( V_33 -> V_239 ) ;
F_22 ( & V_234 -> V_31 , L_5 , V_57 ) ;
return V_57 ;
}
V_57 = F_35 ( & V_234 -> V_31 ,
& V_241 , & V_242 , 1 ) ;
if ( V_57 < 0 ) {
F_22 ( & V_234 -> V_31 , L_6 ,
V_57 ) ;
...
static int F_36 ( struct V_233 * V_243 )
{
F_37 ( & V_243 -> V_31 ) ;
return 0 ;
}
