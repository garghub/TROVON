...
V_41 = L_12 ;
F_70 ( V_100 , L_13 , V_41 , F_18 ( & type ) ) ;
return 0 ;
}
V_7 = F_69 ( & type , V_100 ) ;
if ( V_7 == 0 )
F_70 ( V_100 , L_14 , V_41 ) ;
return V_7 ;
}
int F_71 ( T_1 * V_24 , struct V_99 * V_100 )
{
int V_7 ;
V_7 = F_69 ( V_24 , V_100 ) ;
if ( V_7 < 0 ) {
...
if ( ! V_20 )
return - V_13 ;
V_108 = F_73 ( V_24 , & V_107 ) ;
if ( V_108 <= 1 ) {
V_7 = - V_88 ;
goto V_115;
}
while ( ( V_109 = F_74 ( & V_107 [ 1 ] , V_109 , & V_110 ,
& V_111 , & V_112 ) ) > 0 ) {
V_111 -= V_113 ;
V_112 -= V_113 ;
if ( V_114 ) {
F_70 ( V_100 , L_18 V_116 L_19 V_116 ,
V_20 , V_111 , V_112 ) ;
V_114 = false ;
} else {
F_70 ( V_100 , L_20 V_116 L_19 V_116 ,
V_111 , V_112 ) ;
}
}
if ( ! V_114 )
...
int F_75 ( T_1 * V_67 , T_1 * V_24 , struct V_99 * V_100 )
{
int V_7 = 0 ;
T_6 V_110 ;
T_6 V_111 , V_112 ;
