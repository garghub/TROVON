...
snprintf ( V_248 , 512 , L_106 , & V_242 -> V_249 [ 0 ] ) ;
...
{
unsigned char * V_3 ;
int V_41 , V_238 = V_251 ;
if ( ! V_123 ) {
char * V_252 = L_109 ;
V_41 = F_79 ( V_14 , V_252 ) ;
V_14 -> V_32 . V_180 = 0 ;
F_12 ( L_110 ) ;
if ( V_41 )
return V_226 ;
...
static T_2
F_88 ( struct V_11 * V_12 , T_3 V_255 , T_3 V_121 ,
bool V_123 , bool V_122 , bool V_256 , enum V_181 V_181 )
{
struct V_16 * V_18 = V_12 -> V_18 ;
struct V_13 * V_14 = V_12 -> V_15 ;
...
if ( ( V_181 == REGISTER ) && ( V_255 != V_2 -> V_111 ) ) {
F_10 ( L_118
L_119
L_120
L_121 , V_255 ,
...
static T_2
F_90 ( struct V_11 * V_12 , int type , int V_263 , T_3 V_255 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_16 * V_18 = V_12 -> V_18 ;
struct V_49 * V_49 = V_12 -> V_49 ;
...
static T_2
F_91 ( struct V_11 * V_12 , int type , int V_263 ,
T_3 V_255 )
{
switch ( type ) {
case V_70 :
...
case V_9 :
case V_10 :
return F_90 ( V_12 , type , V_263 , V_255 ) ;
default:
F_10 ( L_149
L_150 , type ) ;
return V_260 ;
...
static T_2
F_94 ( struct V_11 * V_12 , int type , int V_263 ,
T_3 V_255 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_16 * V_18 = V_12 -> V_18 ;
...
static T_2
F_95 ( struct V_11 * V_12 , T_3 V_255 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_24 * V_112 ;
struct V_16 * V_18 = V_12 -> V_18 ;
...
F_12 ( L_162
L_148 ,
V_150 -> V_48 () , ( V_273 == V_274 ) ? L_163 : L_30 ,
F_20 ( type ) ,
( V_2 -> V_138 ) ? 1 : 0 ) ;
F_12 ( L_164 ,
V_150 -> V_48 () , ( V_273 == V_274 ) ? L_163 : L_30 ,
...
static T_2
F_98 ( struct V_11 * V_12 , int type , int V_263 , T_3 V_255 ,
...
static T_2
F_100 ( struct V_11 * V_12 , int type , int V_263 ,
...
case V_9 :
case V_10 :
return F_98 ( V_12 , type , V_263 , V_255 ,
V_121 , V_273 ) ;
default:
F_10 ( L_167
L_168 , ( V_273 == V_274 ) ? L_163 : L_30 , type ) ;
return V_260 ;
}
}
static T_2
F_101 ( struct V_11 * V_12 , T_3 V_255 ,
...
V_3 = NULL ;
F_12 ( L_186
L_187 , V_281 -> V_48 () , ( V_222 != NULL ) ?
L_188 : L_189 , V_283 , ( V_222 != NULL ) ?
V_222 : L_30 ) ;
V_112 = V_2 -> V_112 ;
V_286 = ( ! strcmp ( V_283 ,
V_112 -> V_52 ) ) ? 1 : 0 ;
...
L_199 , V_281 -> V_48 () ,
V_209 -> V_52 ) ;
V_210 = F_76 ( V_209 , V_287 ) ;
if ( ! V_210 ) {
F_10 ( L_200
L_181 , V_281 -> V_48 () , V_287 ) ;
V_54 = V_229 ;
goto V_43;
}
if ( F_37 ( V_210 ) ) {
...
V_289 = ( V_58 [ 0 ] << 24 ) | ( V_58 [ 1 ] << 16 ) | ( V_58 [ 2 ] << 8 ) | V_58 [ 3 ] ;
V_290 = ( V_58 [ 4 ] << 24 ) | ( V_58 [ 5 ] << 16 ) | ( V_58 [ 6 ] << 8 ) | V_58 [ 7 ] ;
return ( ( unsigned long long ) V_290 ) | ( unsigned long long ) V_289 << 32 ;
}
T_2
...
F_77 ( V_12 ) ;
V_3 = NULL ;
if ( V_256 && ( ( V_58 [ 1 ] & 0x1f ) != V_83 ) )
return V_229 ;
if ( ! V_256 && ( ( V_58 [ 1 ] & 0x1f ) != V_85 ) &&
( V_12 -> V_228 != 24 ) ) {
F_70 ( L_218
L_219 , V_12 -> V_228 ) ;
return V_229 ;
...
break;
case V_86 :
V_54 = F_91 ( V_12 , type , V_263 , V_255 ) ;
break;
case V_87 :
V_54 = F_94 ( V_12 , type , V_263 , V_255 ) ;
break;
case V_80 :
V_54 = F_95 ( V_12 , V_255 ) ;
break;
case V_81 :
V_54 = F_100 ( V_12 , type , V_263 ,
V_255 , V_121 , V_293 ) ;
break;
case V_82 :
V_54 = F_100 ( V_12 , type , V_263 ,
...
case V_84 :
V_54 = F_88 ( V_12 ,
0 , V_121 , V_123 , V_122 , V_256 , V_183 ) ;
break;
case V_85 :
V_54 = F_101 ( V_12 , V_255 ,
V_121 , V_123 , V_268 ) ;
break;
default:
F_10 ( L_15
...
F_34 (pr_reg, &dev->t10_pr.registration_list,
pr_reg_list) {
if ( ( V_294 + 8 ) > ( V_12 -> V_228 - 8 ) )
break;
V_3 [ V_295 ++ ] = ( ( V_2 -> V_111 >> 56 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( ( V_2 -> V_111 >> 48 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( ( V_2 -> V_111 >> 40 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( ( V_2 -> V_111 >> 32 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( ( V_2 -> V_111 >> 24 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( ( V_2 -> V_111 >> 16 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( ( V_2 -> V_111 >> 8 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( V_2 -> V_111 & 0xff ) ;
V_294 += 8 ;
}
F_9 ( & V_14 -> V_32 . V_36 ) ;
V_3 [ 4 ] = ( ( V_294 >> 24 ) & 0xff ) ;
...
F_53 ( & V_2 -> V_131 ) ;
F_9 ( & V_31 -> V_36 ) ;
V_299 = F_108 ( V_266 , V_2 ,
& V_298 ) ;
if ( V_299 < 0 ||
V_299 + V_294 > V_12 -> V_228 ) {
F_70 ( L_226
L_227 , V_12 -> V_228 ) ;
F_7 ( & V_31 -> V_36 ) ;
F_54 ( & V_2 -> V_131 ) ;
...
if ( V_2 -> V_7 ) {
V_3 [ V_295 ++ ] |= 0x01 ;
V_3 [ V_295 ++ ] = ( V_2 -> V_167 & 0xf0 ) |
( V_2 -> V_8 & 0x0f ) ;
} else if ( V_62 ) {
V_3 [ V_295 ++ ] |= 0x01 ;
V_3 [ V_295 ++ ] = ( V_167 & 0xf0 ) |
( V_8 & 0x0f ) ;
} else {
V_295 += 2 ;
}
...
if ( ! V_2 -> V_138 ) {
T_4 V_301 = V_2 -> V_136 ;
V_3 [ V_295 ++ ] = ( ( V_301 >> 8 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( V_301 & 0xff ) ;
} else
V_295 += 2 ;
V_3 [ V_295 + 4 ] = V_42 -> V_233 ;
V_300 = F_109 ( V_266 , V_2 ,
& V_298 , & V_3 [ V_295 + 4 ] ) ;
F_7 ( & V_31 -> V_36 ) ;
F_54 ( & V_2 -> V_131 ) ;
if ( V_300 < 0 )
break;
V_3 [ V_295 ++ ] = ( ( V_300 >> 24 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( ( V_300 >> 16 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( ( V_300 >> 8 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( V_300 & 0xff ) ;
V_297 = ( 24 + V_300 ) ;
V_295 += V_300 ;
V_294 += V_297 ;
}
...
if ( ! V_12 -> V_18 )
return 0 ;
if ( V_14 -> V_306 -> V_307 & V_308 )
return 0 ;
if ( V_14 -> V_184 -> V_309 & V_310 )
return 0 ;
F_7 ( & V_14 -> V_44 ) ;
if ( V_14 -> V_26 & V_46 )
V_54 = F_3 ( V_12 ) ;
