...
struct V_116 * V_117 )
{
struct V_118 * V_119 = F_28 ( V_117 ) ;
struct V_120 * V_87 = ( void * ) V_119 -> V_76 ;
...
return;
F_17 ( V_3 , L_12 , V_5 -> V_92 . V_125 ,
V_123 == V_126 ? L_13 : L_14 ) ;
if ( V_123 == V_127 || V_3 -> V_18 -> V_19 ||
F_1 ( V_3 , V_5 ) == V_100 )
...
struct V_128 * V_129 )
{
struct V_56 * V_57 = F_33 ( V_129 ) ;
struct V_65 * V_66 = F_19 ( V_57 -> V_5 ) ;
struct V_130 * V_94 = V_66 -> V_94 ;
enum V_1 V_131 ;
if ( ! F_7 ( & V_3 -> V_28 -> V_29 , V_30 ) )
return F_34 ( V_3 , V_129 ) ;
if ( F_35 ( V_3 -> V_22 . V_95 , V_94 -> V_96 ) )
return V_132 ;
if ( F_5 ( V_3 -> V_22 . V_80 ) <
V_88 )
return V_132 ;
V_131 = F_1 ( V_3 , V_57 -> V_5 ) ;
if ( V_131 == V_100 || V_131 == V_16 )
return V_132 ;
return V_133 ;
}
...
bool F_38 ( struct V_2 * V_3 , T_3 V_134 )
{
if ( V_3 -> V_18 -> V_19 )
return true ;
if ( V_134 & V_3 -> V_18 -> V_135 )
return true ;
if ( ! F_7 ( & V_3 -> V_28 -> V_29 , V_30 ) )
return F_39 ( V_3 ) ;
...
T_3 F_43 ( struct V_2 * V_3 , struct V_138 * V_139 ,
struct V_140 * V_141 , T_3 V_142 )
{
T_4 V_143 = V_139 -> V_144 ;
if ( V_141 -> V_14 != V_15 )
return 0 ;
if ( F_10 ( V_3 -> V_145 ) )
return V_3 -> V_145 - 1 ;
if ( V_141 -> V_146 . V_147 & V_148 ||
F_44 ( V_139 -> V_149 ) ||
F_45 ( V_143 ) || F_46 ( V_143 ) ||
F_47 ( V_143 ) || F_48 ( V_143 ) )
return 3 ;
switch ( V_142 ) {
case V_150 :
return 1 ;
...
{
struct V_118 * V_119 = F_28 ( V_117 ) ;
T_2 V_153 = F_52 ( ( void * ) V_119 -> V_76 ) ;
struct V_154 V_55 = {} ;
T_3 T_5 V_155 , V_156 ;
T_3 V_157 ;
if ( ! F_7 ( & V_3 -> V_28 -> V_29 ,
...
if ( V_153 == V_3 -> V_158 )
return;
for ( V_157 = 0 ; V_157 < F_54 ( V_159 ) - 1 ; V_157 ++ )
if ( V_153 < V_159 [ V_157 + 1 ] . V_160 )
break;
V_155 = V_159 [ V_157 ] . V_160 ;
if ( V_157 < F_54 ( V_159 ) - 1 )
V_156 = V_159 [ V_157 + 1 ] . V_160 ;
else
V_156 = V_159 [ V_157 ] . V_160 ;
F_17 ( V_3 , L_16 ,
...
return;
V_3 -> V_161 = V_157 ;
memcpy ( & V_55 . V_162 , V_159 [ V_157 ] . V_163 ,
sizeof( V_55 . V_162 ) ) ;
memcpy ( & V_55 . V_164 , V_159 [ V_157 ] . V_163 ,
sizeof( V_55 . V_164 ) ) ;
if ( F_14 ( V_3 , V_165 , 0 ,
sizeof( V_55 ) , & V_55 ) )
F_24 ( V_3 ,
