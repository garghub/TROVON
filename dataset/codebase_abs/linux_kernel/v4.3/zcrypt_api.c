...
{
F_88 ( V_194 , L_9 , V_200 ) ;
F_93 ( V_194 , L_10 , V_204 , 32 , 4 , V_203 , V_83 , false ) ;
F_89 ( V_194 , '\n' ) ;
}
static int F_94 ( struct V_193 * V_194 , void * V_205 )
{
char V_206 [ sizeof( int ) * V_112 ] ;
F_88 ( V_194 , L_11 ,
V_207 , V_208 , V_209 ) ;
...
F_88 ( V_194 , L_20 , F_77 ( V_210 ) ) ;
F_88 ( V_194 , L_21 , F_77 ( V_211 ) ) ;
...
V_194 , V_206 , V_112 ) ;
F_71 ( V_206 ) ;
F_91 ( L_27 , V_194 , V_206 , V_112 ) ;
F_74 ( ( int * ) V_206 ) ;
F_92 ( L_28 ,
V_194 , ( unsigned int * ) V_206 , V_112 ) ;
return 0 ;
}
static int F_95 ( struct V_62 * V_62 , struct V_58 * V_58 )
{
return F_96 ( V_58 , F_94 , NULL ) ;
}
static void F_97 ( int V_212 )
{
struct V_6 * V_7 ;
F_36 ( & V_45 ) ;
F_48 (zdev, &zcrypt_device_list, list)
if ( F_64 ( V_7 -> V_15 -> V_16 ) == V_212 ) {
V_7 -> V_11 = 0 ;
F_6 ( V_7 -> V_15 ) ;
break;
}
...
static T_1 F_99 ( struct V_58 * V_58 , const char T_3 * V_110 ,
T_2 V_12 , T_4 * V_213 )
{
unsigned char * V_214 , * V_215 ;
T_2 V_216 ;
int V_217 ;
if ( V_12 <= 0 )
return 0 ;
#define F_100 1200UL
V_214 = F_28 ( F_100 , V_31 ) ;
if ( ! V_214 )
return 0 ;
V_216 = F_101 ( F_100 - 1 , V_12 ) ;
if ( F_62 ( V_214 , V_110 , V_216 ) != 0 ) {
F_31 ( V_214 ) ;
return - V_84 ;
}
V_214 [ V_216 ] = '\0' ;
V_215 = strstr ( V_214 , L_29 ) ;
if ( ! V_215 )
goto V_44;
V_215 = strstr ( V_215 , L_30 ) ;
if ( ! V_215 )
goto V_44;
V_215 ++ ;
if ( strstr ( V_215 , L_27 ) == NULL )
goto V_44;
for ( V_217 = 0 ; V_217 < 64 && * V_215 ; V_215 ++ ) {
if ( * V_215 >= '0' && * V_215 <= '8' )
V_217 ++ ;
else if ( * V_215 == 'd' || * V_215 == 'D' )
F_97 ( V_217 ++ ) ;
else if ( * V_215 == 'e' || * V_215 == 'E' )
F_98 ( V_217 ++ ) ;
else if ( * V_215 != ' ' && * V_215 != '\t' )
break;
}
...
static int F_102 ( struct V_218 * V_47 , T_5 * V_219 )
{
int V_39 ;
if ( V_220 == 0 ) {
V_39 = F_69 ( ( char * ) V_221 ) ;
if ( ( V_39 == - V_41 ) && ( F_7 () ) )
V_39 = F_69 ( ( char * ) V_221 ) ;
if ( V_39 < 0 )
return - V_222 ;
V_220 = V_39 / sizeof *V_219 ;
}
* V_219 = V_221 [ -- V_220 ] ;
return sizeof *V_219 ;
}
...
int T_6 F_109 ( void )
{
V_228 = F_110 ( L_31 , NULL ) ;
V_229 = F_111 ( L_32 , 1 , 1 , 16 ) ;
F_112 ( V_229 , & V_230 ) ;
F_113 ( V_229 , V_231 ) ;
...
if ( V_39 < 0 )
goto V_44;
V_233 = F_119 ( L_34 , 0644 , NULL , & V_234 ) ;
if ( ! V_233 ) {
V_39 = - V_107 ;
goto V_235;
}
