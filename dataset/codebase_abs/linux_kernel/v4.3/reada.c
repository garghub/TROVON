...
struct V_46 * V_82 ;
V_82 = F_4 ( & V_51 -> V_61 [ V_9 ] -> V_55 , V_18 ) ;
if ( V_82 && V_82 -> V_59 != V_51 -> V_59 )
V_82 -> V_58 = V_25 ;
}
}
...
V_47 -> V_88 >> V_19 , 1 ) ;
if ( V_45 == 0 || V_13 -> V_48 >= V_47 -> V_87 -> V_54 ) {
V_45 = F_51 ( V_47 ) ;
if ( ! V_45 ) {
F_5 ( & V_15 -> V_22 ) ;
return 0 ;
...
V_47 -> V_88 = V_13 -> V_48 + V_15 -> V_91 -> V_72 ;
V_13 -> V_24 ++ ;
F_5 ( & V_15 -> V_22 ) ;
for ( V_9 = 0 ; V_9 < V_13 -> V_70 ; ++ V_9 ) {
...
return 0 ;
F_48 ( & V_47 -> V_44 ) ;
V_45 = F_53 ( V_15 -> V_92 , V_48 ,
V_89 , & V_4 ) ;
if ( V_45 )
F_1 ( V_15 -> V_92 , NULL , V_48 , V_45 ) ;
else if ( V_4 )
F_1 ( V_15 -> V_92 , V_4 , V_4 -> V_5 , V_45 ) ;
if ( V_4 )
F_54 ( V_4 ) ;
return 1 ;
}
...
struct V_14 * V_15 ;
int V_97 ;
V_96 = F_47 ( V_94 , struct V_95 , V_94 ) ;
V_15 = V_96 -> V_15 ;
F_20 ( V_96 ) ;
V_97 = F_56 ( F_57 ( V_98 ) ,
F_58 ( V_98 ) ) ;
...
{
struct V_95 * V_96 ;
V_96 = F_33 ( sizeof( * V_96 ) , V_57 ) ;
if ( ! V_96 ) {
F_62 () ;
}
F_63 ( & V_96 -> V_94 , V_105 ,
F_55 , NULL , NULL ) ;
V_96 -> V_15 = V_15 ;
F_64 ( V_15 -> V_106 , & V_96 -> V_94 ) ;
}
static void F_65 ( struct V_14 * V_15 , int V_107 )
{
struct V_20 * V_59 ;
struct V_100 * V_101 = V_15 -> V_101 ;
unsigned long V_18 ;
...
V_51 -> V_58 ) ;
for ( V_108 = 0 ; V_108 < V_51 -> V_63 ; ++ V_108 ) {
F_66 ( V_112 L_6 ,
V_51 -> V_61 [ V_108 ] -> V_111 ) ;
}
if ( V_59 -> V_87 == V_51 )
F_66 ( V_112 L_7 ,
V_59 -> V_88 - V_51 -> V_5 ) ;
...
V_13 -> V_76 [ V_9 ] -> V_5 ,
V_13 -> V_76 [ V_9 ] -> V_54 ) ;
for ( V_108 = 0 ; V_108 < V_13 -> V_76 [ V_9 ] -> V_63 ; ++ V_108 ) {
F_66 ( V_112 L_6 ,
V_13 -> V_76 [ V_9 ] -> V_61 [ V_108 ] -> V_111 ) ;
}
}
F_66 ( V_112 L_8 ) ;
...
V_11 = F_8 ( V_113 ) ;
F_54 ( V_113 ) ;
if ( F_16 ( V_36 , V_5 , & V_114 , V_7 , V_11 ) ) {
F_20 ( V_36 ) ;
return F_68 ( - V_116 ) ;
}
F_28 ( V_2 -> V_15 ) ;
