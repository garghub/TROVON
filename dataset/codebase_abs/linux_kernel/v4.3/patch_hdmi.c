...
return;
F_40 ( V_2 , L_30 , V_146 ) ;
F_160 ( V_2 , V_146 , V_5 -> V_14 , V_5 -> V_243 ) ;
}
...
return;
V_304 |= V_309 ;
F_164 ( & V_2 -> V_245 , V_308 ) ;
F_86 ( V_2 , V_305 , 0 ,
V_308 , V_304 ) ;
}
static void F_165 ( struct V_1 * V_2 , T_1 V_310 ,
unsigned int V_311 )
{
if ( V_311 == V_169 ) {
F_161 ( V_2 , false ) ;
...
F_166 ( V_2 , V_310 , V_311 ) ;
}
static void F_167 ( void * V_312 , int V_313 )
{
...
if ( F_92 ( V_2 ) || F_170 ( V_2 ) )
V_2 -> V_245 . V_316 = 1 ;
if ( F_66 ( V_2 ) || F_92 ( V_2 ) ) {
V_2 -> V_317 = 0 ;
V_5 -> V_318 . V_312 = V_2 ;
V_5 -> V_318 . V_319 = F_167 ;
F_155 ( & V_5 -> V_318 ) ;
}
if ( F_119 ( V_2 ) < 0 ) {
V_2 -> V_5 = NULL ;
...
V_347 = 0x2 ;
if ( V_2 -> V_349 && ( V_250 -> V_350 & V_351 ) )
F_21 ( V_2 ,
V_343 ,
0 ,
V_352 ,
V_250 -> V_350 & ~ V_351 & 0xff ) ;
F_21 ( V_2 , V_343 , 0 ,
V_344 , ( V_182 << 4 ) | 0x0 ) ;
F_21 ( V_2 , V_343 , 0 ,
V_346 , V_183 ) ;
...
{
struct V_4 * V_5 ;
int V_38 = F_188 ( V_2 , V_343 ,
V_354 ) ;
if ( V_38 < 0 )
return V_38 ;
V_2 -> V_298 . V_299 = F_179 ;
V_5 = V_2 -> V_5 ;
V_5 -> V_324 . V_206 = V_355 ;
V_5 -> V_324 . V_208 = V_356 ;
V_5 -> V_324 . V_207 = V_357 ;
return 0 ;
}
...
V_5 -> V_333 . V_335 = 8 ;
V_5 -> V_324 = V_360 ;
V_2 -> V_298 . V_299 = F_181 ;
V_2 -> V_298 . V_361 = F_193 ;
V_2 -> V_298 . V_362 = F_194 ;
F_189 ( V_2 , 8 ) ;
return 0 ;
}
static int F_196 ( struct V_78 * V_260 ,
int V_81 )
{
...
static int F_197 ( int V_84 , int V_57 , unsigned char * V_105 )
{
...
V_5 -> V_92 . V_268 =
F_196 ;
V_5 -> V_92 . V_278 = F_197 ;
return 0 ;
}
static void F_199 ( struct V_1 * V_2 , unsigned int V_183 )
{
unsigned int V_32 ;
V_32 = F_19 ( V_2 , V_366 , 0 ,
V_367 , 0 ) ;
V_32 = ( V_32 >> 24 ) & 0xff ;
F_21 ( V_2 , V_366 , 0 ,
V_368 ,
...
static struct V_279 * F_202 ( struct V_1 * V_2 , int type )
{
struct V_4 * V_5 = V_2 -> V_5 ;
unsigned int V_76 ;
...
if ( V_38 < 0 )
return V_38 ;
V_290 = F_202 ( V_2 , V_283 ) ;
if ( ! V_290 )
return - V_193 ;
V_11 = & V_290 -> V_11 [ V_285 ] ;
V_11 -> V_92 . V_374 = F_200 ;
V_11 -> V_92 . V_375 = F_201 ;
return 0 ;
}
...
if ( V_38 )
return V_38 ;
V_2 -> V_298 . V_361 = F_203 ;
return 0 ;
}
static int F_205 ( struct V_1 * V_2 , T_1 V_146 ,
unsigned char * V_86 , int * V_29 )
{
return F_206 ( V_2 , V_146 , V_86 , V_29 ,
F_207 ( V_2 ) ) ;
}
static void F_208 ( struct V_1 * V_2 , T_1 V_3 , int V_84 ,
int V_132 , int V_133 )
{
F_21 ( V_2 , V_3 , 0 , V_376 , V_84 ) ;
}
static int F_209 ( int V_107 )
{
switch ( V_107 ) {
case 2 : return 3 ;
case 3 : return 2 ;
...
static int F_210 ( int V_84 , int V_57 , unsigned char * V_105 )
{
struct V_78 * V_260 ;
int V_76 , V_77 ;
...
int V_379 = 7 - F_209 ( V_77 ) ;
if ( V_260 -> V_83 [ V_379 ] == V_108 ) {
V_377 = true ;
if ( V_76 % 2 == 0 && V_76 + 1 < V_57 ) {
int V_380 = 7 - F_209 ( V_77 + 1 ) ;
int V_381 = F_45 ( V_105 [ V_76 + 1 ] ) ;
int V_382 = V_260 -> V_83 [ V_380 ] ;
if ( V_381 == V_382 )
V_378 = true ;
else
return - V_8 ;
...
if ( ! F_212 ( V_2 ) ) {
V_99 = F_209 ( V_99 ) ;
if ( V_99 % 2 != 0 && V_383 == 0xf )
return 0 ;
V_99 -= V_99 % 2 ;
if ( V_383 != 0xf )
V_383 -= V_383 % 2 ;
}
V_384 = V_386 + V_99 / 2 + ( V_99 % 2 ) * 0x00e ;
if ( V_383 != 0xf )
V_385 = ( V_383 << 4 ) | V_387 ;
return F_21 ( V_2 , V_3 , 0 , V_384 , V_385 ) ;
}
static int F_213 ( struct V_1 * V_2 , T_1 V_3 ,
int V_115 )
{
bool V_388 = false ;
int V_389 = V_115 ;
...
V_384 = V_390 + V_389 / 2 + ( V_389 % 2 ) * 0x00e ;
V_385 = F_19 ( V_2 , V_3 , 0 , V_384 , 0 ) ;
if ( ! ( V_385 & V_387 ) )
return 0xf ;
return ( ( V_385 & 0xf0 ) >> 4 ) + ! ! V_388 ;
}
static int F_214 ( struct V_78 * V_260 ,
int V_81 )
{
int V_68 ;
int V_391 = 0 ;
...
static void F_215 ( struct V_78 * V_260 ,
unsigned int * V_144 , int V_81 )
{
int V_27 = 0 ;
int V_68 ;
for ( V_68 = 7 ; V_68 >= 0 ; V_68 -- ) {
int V_340 = 7 - F_209 ( 7 - V_68 ) ;
int V_109 = V_260 -> V_83 [ V_340 ] ;
if ( ! V_109 ) {
if ( V_260 -> V_83 [ V_340 + ( V_340 % 2 ? - 1 : 1 ) ] )
V_144 [ V_27 ++ ] = V_393 ;
continue;
}
V_144 [ V_27 ++ ] = F_47 ( V_109 ) ;
...
static int F_216 ( struct V_1 * V_2 , T_1 V_3 ,
bool V_174 )
{
int V_394 , V_395 ;
V_394 = F_19 ( V_2 , V_3 , 0 , V_396 , 0 ) ;
if ( V_394 >= 0 && ( V_394 & V_397 ) ) {
if ( V_174 )
V_395 = V_394 | V_398 ;
else
V_395 = V_394 & ~ V_398 ;
...
static int F_217 ( struct V_1 * V_2 , T_1 V_12 ,
T_1 V_3 , T_3 V_182 , int V_183 )
{
if ( F_207 ( V_2 ) ) {
int V_400 = 180 ;
...
if ( V_38 )
return V_38 ;
V_2 -> V_298 . V_299 = F_218 ;
V_5 = V_2 -> V_5 ;
V_5 -> V_92 . V_224 = F_205 ;
V_5 -> V_92 . V_93 = F_213 ;
V_5 -> V_92 . V_101 = F_211 ;
V_5 -> V_92 . V_145 = F_208 ;
V_5 -> V_92 . V_184 = F_216 ;
V_5 -> V_92 . V_254 = F_217 ;
if ( ! F_212 ( V_2 ) ) {
V_5 -> V_92 . V_268 =
F_214 ;
V_5 -> V_92 . V_270 = F_215 ;
V_5 -> V_92 . V_278 = F_210 ;
}
for ( V_13 = 0 ; V_13 < V_5 -> V_14 ; V_13 ++ ) {
V_188 = F_7 ( V_5 , V_13 ) ;
