...
case V_115 :
V_2 = F_60 ( V_15 -> V_12 [ V_32 ] , F_55 ( V_20 -> V_28 ) ,
F_55 ( V_20 -> V_29 ) ) ;
if ( ! V_2 ) {
if ( F_58 () )
...
break;
F_31 ( & V_15 -> V_60 ) ;
if ( F_63 ( & V_15 -> V_61 [ V_32 ] ) > 10 ) {
if ( F_58 () )
F_6 ( & V_15 -> V_7 -> V_7 , L_38 ,
V_32 ) ;
F_2 ( V_4 ) ;
} else
F_64 ( & V_15 -> V_61 [ V_32 ] , V_4 ) ;
F_33 ( & V_15 -> V_60 ) ;
break;
}
}
...
static struct V_1 * F_60 ( struct V_11 * V_7 , short V_28 , int V_29 )
{
struct V_122 * V_123 ;
struct V_1 * V_2 = NULL ;
struct V_124 * V_125 ;
...
struct V_19 * V_20 ;
F_31 ( & V_15 -> V_140 ) ;
F_76 (&card->tx_queue[port], skb, tmpskb) {
if ( F_54 ( V_4 ) -> V_2 == V_2 ) {
F_77 ( V_4 , & V_15 -> V_141 [ V_32 ] ) ;
F_1 ( V_2 , V_4 ) ;
}
}
F_33 ( & V_15 -> V_140 ) ;
...
if ( ! F_14 ( V_15 -> V_36 , ! F_79 ( V_4 ) , 5 * V_37 ) )
F_6 ( & V_15 -> V_7 -> V_7 ,
L_43 , V_32 ) ;
F_80 ( V_4 ) ;
F_81 ( & V_15 -> V_102 ) ;
...
static int F_59 ( struct V_3 * V_10 )
{
int V_39 , V_43 ;
char V_143 [ 500 ] ;
char V_144 [ 10 ] ;
...
V_146 = F_63 ( & V_15 -> V_141 [ V_32 ] ) ;
F_64 ( & V_15 -> V_141 [ V_32 ] , V_4 ) ;
if ( ! V_146 )
V_15 -> V_147 |= ( 1 << V_32 ) ;
...
F_33 ( & V_15 -> V_140 ) ;
if ( V_4 && ! V_15 -> V_108 ) {
F_84 ( F_85 ( V_15 , V_32 ) , V_4 -> V_40 , V_4 -> V_39 ) ;
V_149 |= 1 << V_32 ;
V_151 = V_4 ;
...
F_54 ( V_4 ) -> V_110 = F_66 ( & V_15 -> V_7 -> V_7 , V_40 ,
V_4 -> V_39 , V_153 ) ;
V_15 -> V_152 [ V_32 ] = V_4 ;
F_39 ( F_54 ( V_4 ) -> V_110 ,
V_15 -> V_71 + F_86 ( V_32 ) ) ;
...
if ( ! F_89 ( V_4 , sizeof( * V_20 ) ) ) {
int V_158 = 0 ;
int V_42 ;
if ( F_90 ( V_4 ) < sizeof( * V_20 ) )
V_158 = sizeof( * V_20 ) - F_90 ( V_4 ) ;
V_42 = F_91 ( V_4 , V_158 , 0 , V_63 ) ;
if ( V_42 ) {
...
V_20 = ( void * ) F_92 ( V_4 , sizeof( * V_20 ) ) ;
V_20 -> V_27 = F_8 ( V_157 ) ;
V_20 -> V_28 = F_8 ( V_2 -> V_28 ) ;
V_20 -> V_29 = F_8 ( V_2 -> V_29 ) ;
V_20 -> type = F_8 ( V_115 ) ;
...
static int F_93 ( struct V_65 * V_7 , const struct V_159 * V_160 )
{
int V_64 ;
T_5 V_161 ;
T_6 V_162 , V_163 ;
...
V_15 -> V_71 = F_100 ( V_7 , 0 , V_164 ) ;
if ( ! V_15 -> V_71 ) {
F_6 ( & V_7 -> V_7 , L_55 ) ;
V_64 = - V_24 ;
goto V_165;
}
V_15 -> V_166 = F_100 ( V_7 , 1 , V_167 ) ;
if ( ! V_15 -> V_166 ) {
F_6 ( & V_7 -> V_7 , L_56 ) ;
V_64 = - V_24 ;
goto V_168;
...
if ( 1 ) {
V_15 -> V_154 = 3 ;
V_15 -> V_155 = F_103 ( V_15 -> V_106 * V_62 , V_23 ) ;
if ( ! V_15 -> V_155 ) {
...
F_104 ( V_7 , V_15 ) ;
F_105 ( & V_15 -> V_102 , F_51 , ( unsigned long ) V_15 ) ;
F_106 ( & V_15 -> V_150 ) ;
F_106 ( & V_15 -> V_140 ) ;
F_106 ( & V_15 -> V_60 ) ;
F_106 ( & V_15 -> V_33 ) ;
F_107 ( & V_15 -> V_35 ) ;
V_64 = F_108 ( V_7 -> V_98 , F_48 , V_179 ,
L_60 , V_15 ) ;
if ( V_64 ) {
...
if ( V_175 )
F_42 ( V_15 , 3 ) ;
V_64 = F_109 ( V_15 , & V_7 -> V_7 ) ;
if ( V_64 )
goto V_181;
if ( V_15 -> V_84 >= V_177 &&
F_110 ( & V_15 -> V_7 -> V_7 . V_182 , & V_183 ) )
F_111 ( & V_15 -> V_7 -> V_7 , L_62 ) ;
return 0 ;
V_181:
...
static int F_109 ( struct V_14 * V_15 , struct V_6 * V_184 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < V_15 -> V_106 ; V_43 ++ ) {
struct V_3 * V_4 ;
struct V_19 * V_20 ;
F_117 ( & V_15 -> V_141 [ V_43 ] ) ;
F_117 ( & V_15 -> V_61 [ V_43 ] ) ;
V_15 -> V_12 [ V_43 ] = F_118 ( L_60 , V_184 , & V_185 , - 1 , NULL ) ;
if ( ! V_15 -> V_12 [ V_43 ] ) {
F_111 ( & V_15 -> V_7 -> V_7 , L_63 , V_43 ) ;
F_119 ( V_15 ) ;
return - V_53 ;
}
if ( F_120 ( & V_15 -> V_12 [ V_43 ] -> V_13 , & V_186 ) )
F_111 ( & V_15 -> V_7 -> V_7 , L_64 , V_43 ) ;
if ( F_110 ( & V_15 -> V_12 [ V_43 ] -> V_13 . V_182 , & V_187 ) )
F_111 ( & V_15 -> V_7 -> V_7 , L_65 , V_43 ) ;
...
F_121 ( & V_15 -> V_12 [ V_43 ] -> V_13 . V_182 , & V_187 ) ;
F_122 ( V_15 -> V_12 [ V_43 ] ) ;
V_4 = V_15 -> V_109 [ V_43 ] ;
if ( V_4 ) {
F_53 ( & V_15 -> V_7 -> V_7 , F_54 ( V_4 ) -> V_110 ,
V_111 , V_112 ) ;
...
static void F_123 ( struct V_65 * V_7 )
{
...
( void ) F_38 ( V_15 -> V_71 + V_90 ) ;
if ( V_15 -> V_84 >= V_177 )
F_121 ( & V_15 -> V_7 -> V_7 . V_182 , & V_183 ) ;
F_119 ( V_15 ) ;
F_112 ( V_7 -> V_98 , V_15 ) ;
F_113 ( & V_15 -> V_102 ) ;
F_114 ( V_15 -> V_155 ) ;
...
{
F_126 ( sizeof( struct V_193 ) > sizeof( ( (struct V_3 * ) 0 ) -> V_194 ) ) ;
F_83 ( V_195 L_69 , V_196 ) ;
return F_127 ( & V_197 ) ;
}
static void T_8 F_128 ( void )
{
F_129 ( & V_197 ) ;
F_83 ( V_195 L_70 , V_196 ) ;
}
