...
F_3 ( L_10 ,
V_16 , V_43 , V_11 -> V_16 ,
F_31 ( & V_39 -> V_53 -> V_54 -> V_55 ) ) ;
return V_16 - V_43 ;
}
static int F_32 ( struct V_19 * V_20 , T_3 V_44 )
{
struct V_38 * V_39 = V_20 -> V_40 ;
...
struct V_56 * V_57 = V_39 -> V_53 ;
int V_12 = 0 ;
F_3 ( L_12 , V_20 , V_39 , V_57 ) ;
F_35 ( V_57 -> V_54 ) ;
V_12 = F_32 ( V_20 , V_59 ) ;
F_36 ( V_57 -> V_54 ) ;
return V_12 ;
}
void F_37 ( struct V_57 * V_54 )
{
void (* F_38)( struct V_57 * V_54 );
struct V_19 * V_20 ;
struct V_38 * V_39 ;
F_3 ( L_13 , V_54 ) ;
F_39 ( & V_54 -> V_60 ) ;
...
F_38 = V_39 -> V_63 ;
F_40 ( V_64 ) ;
if ( F_32 ( V_20 , V_65 ) == - V_45 )
F_41 ( V_66 , & V_20 -> V_67 , 0 ) ;
V_13:
F_42 ( & V_54 -> V_60 ) ;
F_38 ( V_54 ) ;
}
