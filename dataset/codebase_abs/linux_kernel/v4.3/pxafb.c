...
F_69 ( & V_2 -> V_244 ) ;
F_69 ( & V_2 -> V_272 ) ;
V_2 -> V_274 = F_115 ( F_105 , V_2 ,
L_12 ) ;
if ( F_116 ( V_2 -> V_274 ) ) {
F_106 ( L_13 , V_136 ) ;
return F_117 ( V_2 -> V_274 ) ;
}
return 0 ;
}
static inline int F_114 ( struct V_1 * V_2 ) { return 0 ; }
...
static inline void F_124 ( struct V_1 * V_2 , int V_288 )
{
...
F_44 ( & V_2 -> V_293 , F_113 ( 200 ) ) ;
F_128 ( V_2 -> V_196 ) ;
}
static T_5 F_129 ( int V_294 , void * V_295 )
{
...
static void F_131 ( struct V_1 * V_2 , T_1 V_6 )
{
T_1 V_301 ;
F_76 ( & V_2 -> V_271 ) ;
V_301 = V_2 -> V_6 ;
...
static void F_132 ( struct V_307 * V_308 )
{
struct V_1 * V_2 =
F_11 ( V_308 , struct V_1 , V_12 ) ;
T_1 V_6 = F_133 ( & V_2 -> V_8 , - 1 ) ;
F_131 ( V_2 , V_6 ) ;
}
static int
F_134 ( struct V_309 * V_310 , unsigned long V_5 , void * V_311 )
{
struct V_1 * V_2 = F_135 ( V_310 , V_312 ) ;
T_1 V_195 ;
switch ( V_5 ) {
case V_313 :
#ifdef F_130
...
static int
F_136 ( struct V_309 * V_310 , unsigned long V_5 , void * V_311 )
{
struct V_1 * V_2 = F_135 ( V_310 , V_315 ) ;
...
static int F_138 ( struct V_199 * V_91 )
{
struct V_1 * V_2 = F_90 ( V_91 ) ;
F_131 ( V_2 , V_306 ) ;
return 0 ;
...
V_2 -> V_51 = F_141 ( ( V_90 -> V_319 >> 10 ) & 0xff ) ;
...
static struct V_1 * F_142 ( struct V_199 * V_91 )
{
struct V_1 * V_2 ;
void * V_339 ;
struct V_58 * V_90 = F_28 ( V_91 ) ;
V_2 = F_143 ( sizeof( struct V_1 ) + sizeof( V_34 ) * 16 , V_187 ) ;
if ( ! V_2 )
return NULL ;
memset ( V_2 , 0 , sizeof( struct V_1 ) ) ;
V_2 -> V_91 = V_91 ;
V_2 -> V_196 = F_144 ( V_91 , NULL ) ;
if ( F_116 ( V_2 -> V_196 ) ) {
F_145 ( V_2 ) ;
return NULL ;
}
strcpy ( V_2 -> V_25 . V_39 . V_168 , V_340 ) ;
...
#endif
F_146 ( & V_2 -> V_349 ) ;
F_147 ( & V_2 -> V_12 , F_132 ) ;
F_148 ( & V_2 -> V_271 ) ;
F_69 ( & V_2 -> V_293 ) ;
return V_2 ;
}
static int F_149 ( struct V_199 * V_91 , const char * V_350 )
{
struct V_58 * V_90 = F_28 ( V_91 ) ;
...
V_352 = V_65 ;
if ( ! V_354 && ! V_355 ) {
V_48 = F_150 ( & V_351 [ V_65 + 1 ] , NULL , 0 ) ;
V_354 = 1 ;
} else
goto V_356;
break;
case 'x' :
if ( ! V_355 ) {
V_68 = F_150 ( & V_351 [ V_65 + 1 ] , NULL , 0 ) ;
V_355 = 1 ;
} else
goto V_356;
break;
...
if ( V_65 < 0 && V_355 ) {
V_67 = F_150 ( V_351 , NULL , 0 ) ;
V_353 = 1 ;
}
V_356:
if ( V_353 ) {
F_151 ( V_91 , L_27 , V_67 , V_68 ) ;
...
static int F_152 ( struct V_199 * V_91 , char * V_350 )
{
struct V_58 * V_90 = F_28 ( V_91 ) ;
struct V_57 * V_60 = & V_90 -> V_62 [ 0 ] ;
char V_357 [ 64 ] ;
...
V_90 -> V_81 = ( V_90 -> V_81 & ~ V_107 ) | V_367 ;
...
F_80 ( V_91 , L_69 , V_350 ) ;
return - V_49 ;
}
if ( V_357 [ 0 ] != '\0' )
F_151 ( V_91 , L_70 , V_357 ) ;
return 0 ;
}
static int F_154 ( struct V_199 * V_91 , char * V_370 )
{
char * V_350 ;
int V_37 ;
if ( ! V_370 || ! * V_370 )
return 0 ;
F_155 ( V_91 , L_71 , V_370 ? V_370 : L_72 ) ;
while ( ( V_350 = F_156 ( & V_370 , L_73 ) ) != NULL ) {
V_37 = F_152 ( V_91 , V_350 ) ;
if ( V_37 )
return V_37 ;
}
return 0 ;
...
return - V_159 ;
if ( V_370 )
F_159 ( V_371 , V_370 , sizeof( V_371 ) ) ;
return 0 ;
}
static void F_160 ( struct V_199 * V_91 , struct V_58 * V_90 )
{
if ( V_90 -> V_319 )
return;
if ( V_90 -> V_81 & V_372 )
...
static int F_162 ( struct V_374 * V_91 )
{
struct V_1 * V_2 ;
struct V_58 * V_90 ;
struct V_375 * V_376 ;
int V_294 , V_37 ;
F_155 ( & V_91 -> V_91 , L_84 ) ;
V_90 = F_28 ( & V_91 -> V_91 ) ;
V_37 = - V_189 ;
V_2 = NULL ;
if ( ! V_90 )
goto V_377;
V_37 = F_154 ( & V_91 -> V_91 , V_371 ) ;
if ( V_37 < 0 )
goto V_377;
F_160 ( & V_91 -> V_91 , V_90 ) ;
F_155 ( & V_91 -> V_91 , L_85 ,
V_90 -> V_62 -> V_67 ,
V_90 -> V_62 -> V_68 ,
V_90 -> V_62 -> V_48 ) ;
if ( V_90 -> V_62 -> V_67 == 0 ||
...
if ( F_72 () && V_90 -> V_378 )
V_2 -> V_25 . V_39 . V_343 = V_379 ;
V_2 -> V_289 = V_90 -> V_380 ;
V_2 -> V_290 = V_90 -> V_381 ;
V_376 = F_163 ( V_91 , V_382 , 0 ) ;
if ( V_376 == NULL ) {
F_80 ( & V_91 -> V_91 , L_88 ) ;
V_37 = - V_159 ;
goto V_383;
}
V_376 = F_164 ( V_376 -> V_120 , F_165 ( V_376 ) , V_91 -> V_351 ) ;
if ( V_376 == NULL ) {
F_80 ( & V_91 -> V_91 , L_89 ) ;
V_37 = - V_384 ;
goto V_383;
}
V_2 -> V_4 = F_166 ( V_376 -> V_120 , F_165 ( V_376 ) ) ;
if ( V_2 -> V_4 == NULL ) {
F_80 ( & V_91 -> V_91 , L_90 ) ;
V_37 = - V_384 ;
goto V_385;
}
V_2 -> V_386 = F_60 ( sizeof( struct V_205 ) ) ;
V_2 -> V_96 = F_167 ( V_2 -> V_91 , V_2 -> V_386 ,
& V_2 -> V_210 , V_187 ) ;
if ( V_2 -> V_96 == NULL ) {
F_80 ( & V_91 -> V_91 , L_91 ) ;
V_37 = - V_189 ;
...
V_37 = F_169 ( V_294 , F_129 , 0 , L_94 , V_2 ) ;
if ( V_37 ) {
...
F_78 ( V_2 ) ;
#ifdef F_29
V_2 -> V_312 . V_392 = F_134 ;
V_2 -> V_315 . V_392 = F_136 ;
F_171 ( & V_2 -> V_312 ,
V_393 ) ;
F_171 ( & V_2 -> V_315 ,
V_394 ) ;
...
V_388:
F_173 ( & V_91 -> V_91 , V_2 -> V_386 ,
V_2 -> V_96 , V_2 -> V_210 ) ;
V_387:
F_174 ( V_2 -> V_4 ) ;
V_385:
F_175 ( V_376 -> V_120 , F_165 ( V_376 ) ) ;
V_383:
F_176 ( V_2 -> V_196 ) ;
F_145 ( V_2 ) ;
V_377:
...
static int F_177 ( struct V_374 * V_91 )
{
struct V_1 * V_2 = F_178 ( V_91 ) ;
struct V_375 * V_376 ;
int V_294 ;
struct V_23 * V_24 ;
if ( ! V_2 )
