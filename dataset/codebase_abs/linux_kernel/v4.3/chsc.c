...
memset ( V_18 , 0 , V_19 ) ;
V_198 = V_18 ;
V_198 -> V_20 . V_21 = 0x0400 ;
V_198 -> V_20 . V_22 = 0x0031 ;
V_198 -> V_46 = V_46 ;
V_14 = F_4 ( V_198 ) ;
if ( V_14 > 0 ) {
...
switch ( V_198 -> V_1 . V_22 ) {
case 0x0101 :
V_14 = - V_3 ;
break;
default:
V_14 = F_1 ( V_198 -> V_1 . V_22 ) ;
}
if ( V_14 != 0 )
F_24 ( 2 , L_40 ,
V_46 , V_198 -> V_1 . V_22 ) ;
...
memset ( V_18 , 0 , V_19 ) ;
V_202 = V_18 ;
V_202 -> V_20 . V_21 = 0x0010 ;
V_202 -> V_20 . V_22 = 0x0010 ;
V_199 = F_4 ( V_202 ) ;
if ( V_199 ) {
V_199 = ( V_199 == 3 ) ? - V_27 : - V_4 ;
goto exit;
}
V_199 = F_1 ( V_202 -> V_1 . V_22 ) ;
if ( V_199 == 0 ) {
memcpy ( & V_52 , V_202 -> V_200 ,
sizeof( V_52 ) ) ;
memcpy ( & V_203 , V_202 -> V_201 ,
sizeof( V_203 ) ) ;
} else
F_24 ( 2 , L_41 ,
V_202 -> V_1 . V_22 ) ;
...
int F_78 ( void * V_164 , unsigned int V_114 , T_5 V_204 )
{
struct {
struct V_147 V_20 ;
unsigned int V_205 ;
unsigned int V_114 : 8 ;
unsigned int V_206 : 8 ;
unsigned int V_204 : 16 ;
unsigned int V_207 [ 5 ] ;
struct V_147 V_1 ;
unsigned int V_208 [ 7 ] ;
} V_155 ( ( V_156 ) ) * V_209 ;
int V_210 ;
memset ( V_164 , 0 , V_19 ) ;
V_209 = V_164 ;
V_209 -> V_20 . V_21 = 0x0020 ;
V_209 -> V_20 . V_22 = 0x0033 ;
V_209 -> V_114 = V_114 ;
V_209 -> V_204 = V_204 ;
V_210 = F_4 ( V_209 ) ;
if ( V_210 )
return - V_6 ;
V_210 = ( V_209 -> V_1 . V_22 == 0x0001 ) ? 0 : - V_6 ;
return V_210 ;
}
int F_79 ( void * V_164 , void * V_199 , T_6 V_211 )
{
struct {
struct V_147 V_20 ;
...
memset ( V_164 , 0 , V_19 ) ;
V_209 = V_164 ;
V_209 -> V_20 . V_21 = 0x0010 ;
V_209 -> V_20 . V_22 = 0x0038 ;
V_210 = F_4 ( V_209 ) ;
if ( V_210 )
return - V_6 ;
memcpy ( V_199 , & V_209 -> V_57 , V_211 ) ;
return ( V_209 -> V_1 . V_22 == 0x0001 ) ? 0 : - V_6 ;
}
...
memset ( V_18 , 0 , V_19 ) ;
V_216 = V_18 ;
V_216 -> V_20 . V_21 = 0x0010 ;
V_216 -> V_20 . V_22 = 0x0046 ;
V_216 -> V_212 = 0x80000000 ;
V_216 -> V_213 = V_8 ;
V_13 = F_4 ( V_216 ) ;
if ( V_13 > 0 ) {
if ( V_13 == 3 )
...
int F_81 ( struct F_81 * V_217 , T_1 V_218 )
{
int V_13 , V_14 ;
memset ( V_217 , 0 , sizeof( * V_217 ) ) ;
V_217 -> V_20 . V_21 = 0x0020 ;
V_217 -> V_20 . V_22 = 0x004C ;
V_217 -> V_219 = V_218 ;
V_13 = F_4 ( V_217 ) ;
if ( V_13 > 0 ) {
V_14 = ( V_13 == 3 ) ? - V_27 : - V_4 ;
...
V_221 -> V_20 . V_21 = 0x0030 ;
V_221 -> V_20 . V_22 = 0x003d ;
V_221 -> V_163 = V_8 . V_163 ;
V_221 -> V_23 = V_8 . V_23 ;
V_221 -> V_56 = V_8 . V_25 ;
V_221 -> V_68 = V_8 . V_68 ;
V_221 -> V_225 = 0 ;
