...
static int F_31 ( struct V_2 * V_3 , struct V_1 * V_11 , T_1 V_26 ,
T_1 V_25 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_23 * V_44 = F_14 ( V_6 , V_25 , V_26 ) ;
if ( V_44 == NULL ) {
V_44 = F_32 ( sizeof( * V_44 ) , V_45 ) ;
if ( V_44 == NULL )
return - V_46 ;
...
static int F_33 ( struct V_2 * V_3 , T_1 V_4 , T_1 V_47 ,
...
V_54 = F_35 ( V_52 , V_53 , V_49 [ V_56 ] , V_58 ) ;
if ( V_54 < 0 )
return V_54 ;
if ( V_52 [ V_59 ] ) {
V_26 = F_36 ( V_52 [ V_59 ] ) ;
...
V_11 = F_32 ( sizeof( struct V_1 ) , V_69 ) ;
if ( V_11 == NULL )
return - V_46 ;
V_11 -> V_70 = 1 ;
V_11 -> V_10 . V_4 = V_4 ;
V_11 -> V_71 = V_25 ;
V_11 -> V_13 = F_41 ( V_3 -> V_72 ,
& V_73 , V_4 ) ;
if ( V_11 -> V_13 == NULL )
V_11 -> V_13 = & V_74 ;
if ( V_49 [ V_65 ] ) {
V_54 = F_42 ( & V_11 -> V_66 , NULL ,
& V_11 -> V_67 ,
F_40 ( V_3 ) ,
V_49 [ V_65 ] ) ;
if ( V_54 )
...
if ( V_44 == NULL ) {
F_45 ( V_3 ) ;
V_44 = F_32 ( sizeof( * V_44 ) , V_69 ) ;
if ( V_44 == NULL ) {
V_54 = - V_46 ;
F_47 ( & V_11 -> V_66 , & V_11 -> V_67 ) ;
goto V_75;
}
F_43 ( V_3 ) ;
F_11 ( V_6 , V_44 , V_25 , V_26 ) ;
...
static int F_50 ( struct V_2 * V_3 , unsigned long V_50 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_1 * V_11 = (struct V_1 * ) V_50 ;
if ( V_11 -> V_76 > 0 )
...
static void F_54 ( struct V_2 * V_3 , unsigned long V_50 )
{
struct V_1 * V_11 = (struct V_1 * ) V_50 ;
if ( -- V_11 -> V_70 == 0 )
F_49 ( V_3 , V_11 ) ;
}
static struct V_78 T_3 * * F_55 ( struct V_2 * V_3 ,
unsigned long V_11 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
if ( V_11 )
...
static unsigned long F_56 ( struct V_2 * V_3 , unsigned long V_80 ,
T_1 V_4 )
{
struct V_1 * V_11 = F_1 ( V_3 , V_4 ) ;
if ( V_11 != NULL )
...
static void F_57 ( struct V_2 * V_3 , unsigned long V_50 )
{
struct V_1 * V_11 = (struct V_1 * ) V_50 ;
V_11 -> V_76 -- ;
}
static int F_58 ( struct V_2 * V_3 , unsigned long V_50 ,
...
static struct V_2 * F_59 ( struct V_2 * V_3 , unsigned long V_50 )
{
struct V_1 * V_11 = (struct V_1 * ) V_50 ;
return V_11 -> V_13 ;
}
static int F_60 ( struct V_2 * V_3 , unsigned long V_50 ,
...
if ( V_87 == NULL )
goto V_93;
if ( F_62 ( V_84 , V_59 , V_11 -> V_24 -> V_30 ) ||
F_62 ( V_84 , V_61 , V_11 -> V_24 -> V_25 ) )
goto V_93;
return F_63 ( V_84 , V_87 ) ;
V_93:
F_64 ( V_84 , V_87 ) ;
return - V_94 ;
}
static int F_65 ( struct V_2 * V_3 , unsigned long V_50 ,
struct V_95 * V_96 )
{
struct V_1 * V_11 = (struct V_1 * ) V_50 ;
struct V_97 V_98 ;
...
if ( F_66 ( V_96 , NULL , & V_11 -> V_66 ) < 0 ||
F_67 ( V_96 , & V_11 -> V_66 , & V_11 -> V_67 ) < 0 ||
F_68 ( V_96 , NULL ,
& V_11 -> V_13 -> V_99 , V_11 -> V_13 -> V_6 . V_14 ) < 0 )
return - 1 ;
return F_69 ( V_96 , & V_98 , sizeof( V_98 ) ) ;
}
static void F_70 ( struct V_2 * V_3 , struct V_100 * V_50 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_1 * V_11 ;
unsigned int V_37 ;
...
static struct V_1 * F_71 ( struct V_83 * V_84 , struct V_2 * V_3 ,
int * V_106 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_1 * V_11 ;
...
* V_106 = V_112 | V_113 ;
V_109 = F_73 ( V_6 -> V_79 ) ;
V_110 = F_74 ( V_84 , V_109 , & V_108 , false ) ;
if ( V_110 >= 0 ) {
#ifdef F_75
switch ( V_110 ) {
case V_114 :
...
static int F_81 ( struct V_5 * V_6 , const struct V_124 * V_36 )
{
unsigned int V_127 = F_76 ( V_36 -> V_128 , V_6 -> V_129 ) ;
unsigned long V_130 = F_80 ( V_6 -> V_131 [ V_132 ] , V_36 -> V_20 ) ;
struct V_124 * V_133 ;
if ( V_130 ) {
V_133 = F_78 ( V_6 , V_130 ) ;
if ( F_76 ( V_36 -> V_134 , V_133 -> V_134 ) )
V_127 |= V_135 ;
}
return V_127 ;
}
...
static void F_86 ( struct V_124 * V_36 , struct V_23 * V_24 ,
T_2 V_145 )
{
T_2 V_146 = ( V_145 - V_36 -> V_128 ) >> V_36 -> V_147 ;
unsigned int V_37 ;
if ( F_87 ( V_146 > V_148 - 2 ) ) {
...
F_88 ( V_146 , & V_36 -> V_152 ) ;
}
static struct V_23 * F_89 ( struct V_124 * V_36 )
{
return F_90 ( V_36 -> V_151 [ V_36 -> V_150 ] . V_153 ,
struct V_23 , V_133 ) ;
}
static void F_91 ( struct V_124 * V_36 )
{
struct V_23 * V_24 = F_89 ( V_36 ) ;
F_52 ( ! V_24 ) ;
F_92 ( & V_24 -> V_133 ) ;
if ( F_93 ( & V_36 -> V_151 [ V_36 -> V_150 ] ) )
F_94 ( 0 , & V_36 -> V_152 ) ;
}
static struct V_23 * F_95 ( struct V_124 * V_36 )
{
unsigned int V_37 ;
F_10 ( L_7 ,
...
static void F_96 ( struct V_124 * V_36 , T_2 V_145 )
{
...
if ( V_11 -> V_13 -> V_6 . V_14 == 0 )
F_26 ( & V_11 -> V_41 ) ;
else if ( V_11 -> V_71 < F_100 ( V_11 -> V_13 -> V_155 -> V_156 ( V_11 -> V_13 ) ) ) {
V_11 -> V_71 += V_24 -> V_25 ;
...
V_161 = F_77 ( V_24 -> V_134 , V_147 ) ;
V_160 = F_77 ( V_6 -> V_129 , V_147 ) + ( 1ULL << V_147 ) ;
if ( ! F_76 ( V_24 -> V_134 , V_6 -> V_129 ) || F_76 ( V_161 , V_160 ) ) {
V_130 = F_80 ( V_6 -> V_131 [ V_132 ] , V_24 -> V_36 -> V_20 ) ;
if ( V_130 ) {
struct V_124 * V_133 = F_78 ( V_6 , V_130 ) ;
if ( F_76 ( V_161 , V_133 -> V_134 ) ) {
if ( F_76 ( V_160 , V_133 -> V_134 ) )
...
V_42 -> V_35 ;
if ( ! F_27 ( & V_42 -> V_27 ) ) {
F_107 ( V_6 , V_42 , V_164 ) ;
F_109 ( V_6 , V_42 ) ;
} else if ( V_3 -> V_6 . V_14 == 0 ) {
V_6 -> V_42 = NULL ;
return NULL ;
}
V_42 = V_6 -> V_42 = F_23 ( V_6 ) ;
V_84 = F_102 ( V_42 , & V_11 , & V_12 ) ;
}
if ( ! V_84 )
return NULL ;
...
static struct V_23 * F_23 ( struct V_5 * V_6 )
{
struct V_124 * V_36 ;
...
if ( ! V_6 -> V_131 [ V_132 ] )
return NULL ;
V_36 = F_78 ( V_6 , V_6 -> V_131 [ V_132 ] ) ;
V_138 = V_36 -> V_134 ;
V_24 = F_89 ( V_36 ) ;
F_91 ( V_36 ) ;
V_165 = F_95 ( V_36 ) ;
if ( V_165 == NULL )
F_94 ( V_36 -> V_20 , & V_6 -> V_131 [ V_132 ] ) ;
else {
T_2 V_145 = F_77 ( V_165 -> V_128 ,
V_36 -> V_147 ) ;
unsigned int V_166 ;
if ( V_36 -> V_128 == V_145 )
return V_24 ;
...
F_94 ( V_36 -> V_20 , & V_6 -> V_131 [ V_132 ] ) ;
V_166 = F_81 ( V_6 , V_36 ) ;
F_88 ( V_36 -> V_20 , & V_6 -> V_131 [ V_166 ] ) ;
}
F_83 ( V_6 , V_36 -> V_20 , V_138 ) ;
return V_24 ;
}
...
V_54 = F_31 ( V_3 , V_11 , V_11 -> V_24 -> V_30 ,
F_100 ( V_84 ) ) ;
if ( V_54 )
return V_54 ;
}
V_54 = F_114 ( V_84 , V_11 -> V_13 ) ;
if ( F_87 ( V_54 != V_112 ) ) {
F_10 ( L_12 , V_54 ) ;
if ( F_115 ( V_54 ) ) {
V_11 -> V_99 . V_167 ++ ;
...
F_116 ( & V_11 -> V_66 , V_84 ) ;
++ V_3 -> V_6 . V_14 ;
V_24 = V_11 -> V_24 ;
if ( V_11 -> V_13 -> V_6 . V_14 != 1 ) {
if ( F_87 ( V_84 == V_11 -> V_13 -> V_155 -> V_156 ( V_11 -> V_13 ) ) &&
...
T_2 V_145 ;
int V_166 ;
V_145 = F_77 ( V_24 -> V_128 , V_36 -> V_147 ) ;
if ( V_36 -> V_152 ) {
if ( ! F_76 ( V_36 -> V_128 , V_24 -> V_128 ) )
goto V_168;
F_96 ( V_36 , V_145 ) ;
F_94 ( V_36 -> V_20 , & V_6 -> V_131 [ V_140 ] ) ;
F_94 ( V_36 -> V_20 , & V_6 -> V_131 [ V_139 ] ) ;
} else if ( ! V_6 -> V_131 [ V_132 ] && F_76 ( V_145 , V_6 -> V_129 ) &&
V_6 -> V_42 == NULL )
V_6 -> V_129 = V_145 ;
V_36 -> V_128 = V_145 ;
V_36 -> V_134 = V_145 + ( 2ULL << V_36 -> V_147 ) ;
...
static void F_117 ( struct V_5 * V_6 , struct V_124 * V_36 ,
struct V_23 * V_24 )
{
...
F_92 ( & V_24 -> V_133 ) ;
if ( F_93 ( & V_36 -> V_151 [ V_37 ] ) )
F_94 ( V_169 , & V_36 -> V_152 ) ;
}
static void F_28 ( struct V_5 * V_6 , struct V_23 * V_24 )
{
struct V_124 * V_36 = V_24 -> V_36 ;
unsigned long V_130 ;
T_2 V_145 ;
...
if ( ! V_36 -> V_152 ) {
F_94 ( V_36 -> V_20 , & V_6 -> V_131 [ V_140 ] ) ;
F_94 ( V_36 -> V_20 , & V_6 -> V_131 [ V_135 ] ) ;
F_94 ( V_36 -> V_20 , & V_6 -> V_131 [ V_139 ] ) ;
if ( F_118 ( V_36 -> V_20 , & V_6 -> V_131 [ V_132 ] ) &&
...
F_94 ( V_36 -> V_20 , & V_6 -> V_131 [ V_132 ] ) ;
} else if ( F_93 ( & V_36 -> V_151 [ V_36 -> V_150 ] ) ) {
V_24 = F_95 ( V_36 ) ;
V_145 = F_77 ( V_24 -> V_128 , V_36 -> V_147 ) ;
if ( V_36 -> V_128 != V_145 ) {
F_94 ( V_36 -> V_20 , & V_6 -> V_131 [ V_132 ] ) ;
...
static void F_119 ( struct V_2 * V_3 , unsigned long V_50 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_1 * V_11 = (struct V_1 * ) V_50 ;
if ( V_11 -> V_13 -> V_6 . V_14 == 0 )
...
static unsigned int F_120 ( struct V_5 * V_6 ,
struct V_170 * V_146 )
{
struct V_23 * V_24 ;
struct V_1 * V_11 ;
...
static unsigned int F_122 ( struct V_2 * V_3 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_124 * V_36 ;
...
V_12 = F_120 ( V_6 , & V_36 -> V_151 [ V_172 ] ) ;
if ( V_12 > 0 ) {
V_3 -> V_6 . V_14 -- ;
return V_12 ;
}
...
static int F_123 ( struct V_2 * V_3 , struct V_48 * V_174 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_124 * V_36 ;
int V_37 , V_172 , V_54 ;
...
if ( V_54 < 0 )
return V_54 ;
if ( F_38 ( V_3 ) -> V_178 + 1 > V_179 )
V_177 = V_179 ;
else
V_177 = F_38 ( V_3 ) -> V_178 + 1 ;
V_175 = F_9 ( V_177 ) ;
V_6 -> V_33 = 1 << V_175 ;
V_176 = V_63 + V_175 ;
