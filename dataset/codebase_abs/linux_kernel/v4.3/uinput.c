...
return 0 ;
F_43 (cnt, dev->absbit, ABS_CNT) {
int V_73 , V_74 ;
V_73 = F_44 ( V_2 , V_70 ) ;
V_74 = F_45 ( V_2 , V_70 ) ;
if ( ( V_73 != 0 || V_74 != 0 ) && V_74 <= V_73 ) {
F_32 ( V_54
L_2 ,
V_55 , V_70 ,
F_44 ( V_2 , V_70 ) ,
...
if ( F_26 ( V_75 , V_2 -> V_76 ) ) {
V_71 = F_45 ( V_2 , V_75 ) + 1 ;
F_47 ( V_2 , V_71 , 0 ) ;
} else if ( F_26 ( V_77 , V_2 -> V_76 ) ) {
F_48 ( V_2 , 60 ) ;
}
return 0 ;
}
...
V_2 = V_6 -> V_2 ;
V_82 = F_53 ( V_79 , sizeof( struct V_81 ) ) ;
if ( F_54 ( V_82 ) )
return F_55 ( V_82 ) ;
V_6 -> V_56 = V_82 -> V_56 ;
if ( ! V_82 -> V_48 [ 0 ] ) {
...
F_30 ( V_2 -> V_48 ) ;
V_2 -> V_48 = F_56 ( V_82 -> V_48 , V_83 ,
V_67 ) ;
if ( ! V_2 -> V_48 ) {
V_20 = - V_68 ;
goto exit;
}
V_2 -> V_13 . V_84 = V_82 -> V_13 . V_84 ;
V_2 -> V_13 . V_85 = V_82 -> V_13 . V_85 ;
V_2 -> V_13 . V_86 = V_82 -> V_13 . V_86 ;
V_2 -> V_13 . V_87 = V_82 -> V_13 . V_87 ;
for ( V_27 = 0 ; V_27 < V_88 ; V_27 ++ ) {
F_57 ( V_2 , V_27 , V_82 -> V_89 [ V_27 ] ) ;
F_58 ( V_2 , V_27 , V_82 -> V_90 [ V_27 ] ) ;
F_59 ( V_2 , V_27 , V_82 -> V_91 [ V_27 ] ) ;
F_60 ( V_2 , V_27 , V_82 -> V_92 [ V_27 ] ) ;
}
V_20 = F_42 ( V_2 ) ;
if ( V_20 < 0 )
goto exit;
...
static T_4 F_61 ( struct V_5 * V_6 ,
const char T_2 * V_79 , T_3 V_80 )
{
struct V_93 V_94 ;
T_3 V_95 = 0 ;
if ( V_80 != 0 && V_80 < F_62 () )
return - V_42 ;
while ( V_95 + F_62 () <= V_80 ) {
if ( F_63 ( V_79 + V_95 , & V_94 ) )
return - V_96 ;
...
static T_4 F_64 ( struct V_65 * V_65 , const char T_2 * V_79 ,
T_3 V_80 , T_5 * V_97 )
{
...
if ( V_98 ) {
* V_78 = V_6 -> V_7 [ V_6 -> V_100 ] ;
V_6 -> V_100 = ( V_6 -> V_100 + 1 ) % V_9 ;
}
F_67 ( & V_6 -> V_2 -> V_99 ) ;
return V_98 ;
}
static T_4 F_68 ( struct V_5 * V_6 ,
char T_2 * V_79 , T_3 V_80 )
{
struct V_93 V_78 ;
T_3 V_101 = 0 ;
while ( V_101 + F_62 () <= V_80 &&
F_65 ( V_6 , & V_78 ) ) {
if ( F_69 ( V_79 + V_101 , & V_78 ) )
return - V_96 ;
V_101 += F_62 () ;
}
return V_101 ;
}
static T_4 F_70 ( struct V_65 * V_65 , char T_2 * V_79 ,
T_3 V_80 , T_5 * V_97 )
{
struct V_5 * V_6 = V_65 -> V_69 ;
T_4 V_20 ;
...
static unsigned int F_71 ( struct V_65 * V_65 , T_6 * V_105 )
{
struct V_5 * V_6 = V_65 -> V_69 ;
F_72 ( V_65 , & V_6 -> V_10 , V_105 ) ;
if ( V_6 -> V_8 != V_6 -> V_100 )
return V_106 | V_107 ;
return 0 ;
}
static int F_73 ( struct V_64 * V_64 , struct V_65 * V_65 )
{
struct V_5 * V_6 = V_65 -> V_69 ;
F_27 ( V_6 ) ;
F_30 ( V_6 ) ;
...
static int F_76 ( const char T_2 * V_79 ,
struct V_108 * V_109 )
{
if ( V_110 ) {
struct V_111 V_112 ;
...
const struct V_108 * V_109 )
{
if ( F_75 ( V_79 , V_109 , sizeof( struct V_108 ) ) )
return - V_96 ;
return 0 ;
}
static int F_76 ( const char T_2 * V_79 ,
struct V_108 * V_109 )
{
if ( F_77 ( V_109 , V_79 , sizeof( struct V_108 ) ) )
return - V_96 ;
return 0 ;
}
static int F_78 ( void T_2 * V_115 , const char * V_116 ,
unsigned int V_117 )
{
...
if ( V_119 > V_117 )
V_119 = V_117 ;
V_120 = F_75 ( V_118 , V_116 , V_119 ) ;
if ( V_120 )
return - V_96 ;
V_120 = F_79 ( 0 , V_118 + V_119 - 1 ) ;
return V_120 ? - V_96 : V_119 ;
}
static long F_80 ( struct V_65 * V_65 , unsigned int V_122 ,
...
goto V_25;
case V_132 :
V_20 = F_81 ( V_123 , V_45 , V_133 ) ;
goto V_25;
case V_134 :
V_20 = F_81 ( V_123 , V_135 , V_136 ) ;
goto V_25;
case V_137 :
V_20 = F_81 ( V_123 , V_138 , V_139 ) ;
goto V_25;
case V_140 :
V_20 = F_81 ( V_123 , V_76 , V_141 ) ;
goto V_25;
case V_142 :
V_20 = F_81 ( V_123 , V_143 , V_144 ) ;
goto V_25;
case V_145 :
V_20 = F_81 ( V_123 , V_146 , V_147 ) ;
goto V_25;
case V_148 :
V_20 = F_81 ( V_123 , V_149 , V_150 ) ;
goto V_25;
case V_151 :
V_20 = F_81 ( V_123 , V_152 , V_153 ) ;
goto V_25;
case V_154 :
V_20 = F_81 ( V_123 , V_155 , V_156 ) ;
goto V_25;
case V_157 :
V_20 = F_81 ( V_123 , V_158 , V_159 ) ;
goto V_25;
case V_160 :
if ( V_6 -> V_22 == V_23 ) {
V_20 = - V_42 ;
...
V_20 = F_74 ( V_118 , & V_109 ) ;
goto V_25;
case V_162 :
if ( F_77 ( & V_125 , V_118 , sizeof( V_125 ) ) ) {
V_20 = - V_96 ;
goto V_25;
}
...
if ( F_75 ( V_118 , & V_125 , sizeof( V_125 ) ) ) {
V_20 = - V_96 ;
goto V_25;
}
goto V_25;
...
V_48 = F_85 ( & V_6 -> V_2 -> V_2 ) ;
V_20 = F_78 ( V_118 , V_48 , V_127 ) ;
goto V_25;
}
V_20 = - V_42 ;
V_25:
...
static long F_86 ( struct V_65 * V_65 , unsigned int V_122 , unsigned long V_123 )
{
return F_80 ( V_65 , V_122 , V_123 , ( void T_2 * ) V_123 ) ;
}
static long F_87 ( struct V_65 * V_65 ,
unsigned int V_122 , unsigned long V_123 )
{
return F_80 ( V_65 , V_122 , V_123 , F_88 ( V_123 ) ) ;
}
