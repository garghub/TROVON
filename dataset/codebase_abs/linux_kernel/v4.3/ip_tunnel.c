...
bool V_165 ;
int V_166 ;
V_164 = F_90 ( F_77 ( V_90 ) ,
& F_91 ( V_90 ) -> V_39 ) ;
if ( ! V_164 )
goto V_160;
V_162 = ( const struct V_161 * ) & V_164 -> V_167 ;
V_166 = F_92 ( V_162 ) ;
if ( V_166 == V_168 ) {
V_162 = & F_91 ( V_90 ) -> V_39 ;
V_166 = F_92 ( V_162 ) ;
}
if ( ( V_166 & V_169 ) == 0 )
V_165 = true ;
...
V_68 = F_94 ( ( const struct V_172 * ) V_136 ) ;
V_158 = false ;
}
}
...
V_156 = ( ( const struct V_172 * ) V_136 ) -> V_179 ;
#endif
else
V_156 = F_98 ( & V_81 -> V_9 ) ;
}
...
+ V_81 -> V_9 . V_180 + F_68 ( & V_54 -> V_130 ) ;
if ( V_157 > V_40 -> V_87 )
V_40 -> V_87 = V_157 ;
...
V_53 = F_101 ( NULL , V_81 , V_90 , V_66 . V_10 , V_66 . V_39 , V_82 ,
V_68 , V_156 , V_135 , ! F_60 ( V_54 -> V_51 , F_61 ( V_40 ) ) ) ;
F_102 ( V_53 , & V_40 -> V_98 , V_40 -> V_97 ) ;
return;
#if F_83 ( V_144 )
V_171:
F_96 ( V_90 ) ;
...
if ( V_40 -> type != V_84 ) {
memcpy ( V_40 -> V_184 , & V_23 -> V_38 . V_10 , 4 ) ;
memcpy ( V_40 -> V_185 , & V_23 -> V_38 . V_39 , 4 ) ;
}
F_24 ( V_29 , V_13 ) ;
...
int F_105 ( struct V_50 * V_40 , struct V_22 * V_23 , int V_186 )
{
int V_53 = 0 ;
struct V_12 * V_13 = F_22 ( V_40 ) ;
struct V_51 * V_51 = V_13 -> V_51 ;
struct V_28 * V_29 = F_106 ( V_51 , V_13 -> V_187 ) ;
F_46 ( ! V_29 -> V_45 ) ;
switch ( V_186 ) {
case V_188 :
if ( V_40 == V_29 -> V_45 ) {
...
if ( V_13 ) {
V_53 = 0 ;
F_103 ( V_29 , V_13 , V_40 , V_23 , true ) ;
} else {
V_53 = - V_199 ;
}
break;
...
int F_110 ( struct V_50 * V_40 , int V_201 )
{
struct V_12 * V_54 = F_22 ( V_40 ) ;
int V_80 = V_54 -> V_76 + sizeof( struct V_75 ) ;
if ( V_201 < 68 ||
V_201 > 0xFFF8 - V_40 -> V_86 - V_80 )
return - V_121 ;
V_40 -> V_78 = V_201 ;
return 0 ;
}
...
void F_114 ( struct V_50 * V_40 , struct V_202 * V_35 )
{
struct V_12 * V_54 = F_22 ( V_40 ) ;
struct V_28 * V_29 ;
V_29 = F_106 ( V_54 -> V_51 , V_54 -> V_187 ) ;
if ( V_29 -> V_45 != V_40 ) {
F_27 ( V_29 , F_22 ( V_40 ) ) ;
F_115 ( V_40 , V_35 ) ;
}
...
int F_118 ( struct V_51 * V_51 , int V_187 ,
struct V_52 * V_20 , char * V_203 )
{
struct V_28 * V_29 = F_106 ( V_51 , V_187 ) ;
struct V_22 V_37 ;
unsigned int V_15 ;
...
if ( V_203 )
F_31 ( V_37 . V_55 , V_203 , V_56 ) ;
F_120 () ;
V_29 -> V_45 = F_30 ( V_51 , V_20 , & V_37 ) ;
if ( ! F_42 ( V_29 -> V_45 ) ) {
V_29 -> V_45 -> V_205 |= V_206 ;
V_29 -> V_45 -> V_78 = F_39 ( V_29 -> V_45 ) ;
F_24 ( V_29 , F_22 ( V_29 -> V_45 ) ) ;
}
F_121 () ;
return F_108 ( V_29 -> V_45 ) ;
}
static void F_122 ( struct V_28 * V_29 , struct V_202 * V_35 ,
struct V_52 * V_20 )
{
struct V_51 * V_51 = F_61 ( V_29 -> V_45 ) ;
struct V_50 * V_40 , * V_207 ;
int V_46 ;
F_123 (net, dev, aux)
if ( V_40 -> V_52 == V_20 )
F_115 ( V_40 , V_35 ) ;
for ( V_46 = 0 ; V_46 < V_204 ; V_46 ++ ) {
struct V_12 * V_13 ;
struct V_208 * V_209 ;
struct V_34 * V_210 = & V_29 -> V_36 [ V_46 ] ;
...
F_126 ( V_211 ) ;
F_120 () ;
F_122 ( V_29 , & V_211 , V_20 ) ;
F_127 ( & V_211 ) ;
F_121 () ;
}
int F_128 ( struct V_50 * V_40 , struct V_212 * V_213 [] ,
struct V_22 * V_23 )
{
struct V_12 * V_88 ;
...
int F_131 ( struct V_50 * V_40 , struct V_212 * V_213 [] ,
struct V_22 * V_23 )
{
struct V_12 * V_13 ;
struct V_12 * V_54 = F_22 ( V_40 ) ;
struct V_51 * V_51 = V_54 -> V_51 ;
struct V_28 * V_29 = F_106 ( V_51 , V_54 -> V_187 ) ;
if ( V_40 == V_29 -> V_45 )
return - V_121 ;
...
F_103 ( V_29 , V_13 , V_40 , V_23 , ! V_213 [ V_216 ] ) ;
return 0 ;
}
...
struct V_51 * V_51 = V_54 -> V_51 ;
struct V_28 * V_29 ;
V_29 = F_106 ( V_51 , V_54 -> V_187 ) ;
if ( V_29 -> V_45 != V_40 )
F_27 ( V_29 , F_22 ( V_40 ) ) ;
F_10 ( V_54 ) ;
}
void F_138 ( struct V_50 * V_40 , int V_220 )
{
struct V_12 * V_54 = F_22 ( V_40 ) ;
V_54 -> V_187 = V_220 ;
}
