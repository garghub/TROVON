...
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
unsigned char * V_49 = F_33 ( V_3 ) ;
struct V_38 V_37 ;
V_37 . V_27 = V_7 -> V_27 ;
memcpy ( & V_37 . V_43 , V_7 -> V_24 , V_25 + 1 ) ;
if ( F_34 ( V_3 , V_50 , sizeof( V_37 ) , & V_37 ) )
goto V_51;
return V_3 -> V_34 ;
V_51:
F_35 ( V_3 , V_49 ) ;
...
static int F_36 ( struct V_1 * V_4 , unsigned long V_52 , struct V_1 * V_53 ,
struct V_1 * * V_46 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
...
* V_46 = V_7 -> V_23 [ V_8 ] ;
V_7 -> V_23 [ V_8 ] = V_53 ;
F_27 ( * V_46 , ( * V_46 ) -> V_7 . V_30 ) ;
F_19 ( * V_46 ) ;
F_28 ( V_4 ) ;
return 0 ;
}
static struct V_1 *
F_37 ( struct V_1 * V_4 , unsigned long V_52 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
unsigned long V_8 = V_52 - 1 ;
return V_7 -> V_23 [ V_8 ] ;
}
static unsigned long F_38 ( struct V_1 * V_4 , T_1 V_26 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
...
static unsigned long F_39 ( struct V_1 * V_4 , unsigned long V_54 , T_1 V_26 )
{
return F_38 ( V_4 , V_26 ) ;
}
static void F_40 ( struct V_1 * V_7 , unsigned long V_55 )
{
}
static int F_41 ( struct V_1 * V_4 , unsigned long V_55 , struct V_2 * V_3 ,
struct V_56 * V_57 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
V_57 -> V_58 |= F_7 ( V_55 ) ;
V_57 -> V_59 = V_7 -> V_23 [ V_55 - 1 ] -> V_17 ;
return 0 ;
}
static int F_42 ( struct V_1 * V_4 , unsigned long V_55 ,
struct V_60 * V_61 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
struct V_1 * V_62 ;
V_62 = V_7 -> V_23 [ V_55 - 1 ] ;
if ( F_43 ( V_61 , NULL , & V_62 -> V_63 ) < 0 ||
F_44 ( V_61 , NULL , & V_62 -> V_64 , V_62 -> V_7 . V_30 ) < 0 )
return - 1 ;
return 0 ;
}
static void F_45 ( struct V_1 * V_4 , struct V_65 * V_52 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
int V_31 ;
if ( V_52 -> V_66 )
return;
for ( V_31 = 0 ; V_31 < V_7 -> V_27 ; V_31 ++ ) {
if ( V_52 -> V_67 < V_52 -> V_68 ) {
V_52 -> V_67 ++ ;
continue;
}
if ( V_52 -> V_69 ( V_4 , V_31 + 1 , V_52 ) < 0 ) {
V_52 -> V_66 = 1 ;
break;
}
V_52 -> V_67 ++ ;
...
static struct V_12 T_2 * * F_46 ( struct V_1 * V_4 ,
unsigned long V_55 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
if ( V_55 )
