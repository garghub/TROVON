...
static int F_120 ( struct V_189 * V_190 , unsigned V_208 )
{
struct V_117 * V_175 = F_112 ( V_190 ) ;
...
static void F_128 ( struct V_216 * V_217 )
{
struct V_218 * V_120 = F_129 ( V_217 ) ;
struct V_119 * V_119 = F_130 ( V_217 ) ;
...
struct V_189 * V_190 = F_137 ( V_175 -> V_212 ) ;
int V_101 , V_6 ;
V_175 -> V_226 = F_138 ( V_190 ) ;
...
int V_101 = 0 ;
int V_206 , V_6 ;
int V_233 = F_143 ( V_20 , L_55 ) ;
T_3 V_174 ;
char * * V_234 ;
F_144 ( V_233 >= F_145 ( V_41 ) ) ;
if ( V_41 [ V_233 ] ) {
V_101 = - V_235 ;
goto V_236;
}
...
V_232 = F_147 ( V_160 , V_237 , 0 ) ;
V_118 -> V_42 = F_148 ( & V_160 -> V_9 , V_232 ) ;
if ( F_90 ( V_118 -> V_42 ) ) {
...
V_118 -> V_212 = V_206 ;
V_118 -> V_209 = V_233 ;
V_118 -> clock = F_149 ( & V_160 -> V_9 , NULL ) ;
if ( F_90 ( V_118 -> clock ) ) {
F_11 ( & V_160 -> V_9 , L_56 ) ;
...
goto V_245;
V_41 [ V_233 ] = V_118 ;
V_92 = F_155 ( V_92 , V_233 + 1 ) ;
V_101 = F_136 ( V_160 , V_118 ) ;
if ( V_101 )
goto V_246;
F_93 ( & V_160 -> V_9 , L_60 , V_118 -> V_42 ) ;
return 0 ;
V_246:
F_156 ( V_120 ) ;
V_245:
...
V_239:
V_236:
F_11 ( & V_160 -> V_9 , L_61 , V_101 , V_233 ) ;
return V_101 ;
}
