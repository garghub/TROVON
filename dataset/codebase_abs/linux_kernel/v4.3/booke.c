...
void F_177 ( struct V_1 * V_2 , T_1 V_364 )
{
V_2 -> V_4 . V_110 = V_364 ;
F_69 ( V_2 ) ;
F_78 ( V_2 ) ;
...
static int F_208 ( struct V_151 * V_157 , T_6 V_366 ,
int type , int V_367 )
{
switch ( V_367 ) {
case 0 :
...
void F_209 ( struct V_1 * V_2 , T_2 V_376 , bool V_377 )
{
#ifdef V_21
F_61 ( V_376 & ~ ( V_378 | V_379 | V_380 ) ) ;
if ( V_377 ) {
if ( V_376 & V_381 )
V_2 -> V_4 . V_382 |= V_378 ;
if ( V_376 & V_26 )
...
int F_210 ( struct V_1 * V_2 , T_2 V_259 , enum V_384 V_385 ,
...
return - V_155 ;
if ( type & V_191 ) {
if ( F_207 ( V_157 , V_366 , V_402 ++ ) )
return - V_155 ;
} else {
if ( F_208 ( V_157 , V_366 ,
type , V_403 ++ ) )
return - V_155 ;
}
}
...
void F_212 ( struct V_1 * V_2 , int V_421 )
{
V_2 -> V_421 = F_213 () ;
V_15 -> V_16 . V_1 = V_2 ;
}
...
void F_220 ( struct V_1 * V_2 , int V_421 )
{
