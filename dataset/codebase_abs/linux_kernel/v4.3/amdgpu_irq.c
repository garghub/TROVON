...
V_19 = V_24 -> V_26 -> V_51 ( V_4 , V_24 , V_50 ) ;
if ( V_19 )
F_13 ( L_6 , V_19 ) ;
}
...
int V_19 ;
F_11 ( & V_4 -> V_20 . V_21 , V_16 ) ;
if ( F_41 ( V_4 , V_24 , type ) )
V_53 = V_54 ;
else
V_53 = V_30 ;
V_19 = V_24 -> V_26 -> V_27 ( V_4 , V_24 , type , V_53 ) ;
F_14 ( & V_4 -> V_20 . V_21 , V_16 ) ;
return V_19 ;
}
int F_42 ( struct V_3 * V_4 , struct V_23 * V_24 ,
unsigned type )
{
if ( ! V_4 -> V_8 -> V_55 )
return - V_56 ;
...
return - V_45 ;
if ( F_43 ( & V_24 -> V_29 [ type ] ) == 1 )
return F_40 ( V_4 , V_24 , type ) ;
return 0 ;
}
...
return false ;
return F_43 ( & V_24 -> V_29 [ type ] ) == 1 ;
}
int F_45 ( struct V_3 * V_4 , struct V_23 * V_24 ,
unsigned type )
{
if ( ! V_4 -> V_8 -> V_55 )
return - V_56 ;
...
if ( ! V_24 -> V_29 || ! V_24 -> V_26 -> V_27 )
return - V_45 ;
if ( F_46 ( & V_24 -> V_29 [ type ] ) )
return F_40 ( V_4 , V_24 , type ) ;
return 0 ;
}
bool F_41 ( struct V_3 * V_4 , struct V_23 * V_24 ,
unsigned type )
{
if ( ! V_4 -> V_8 -> V_55 )
return false ;
