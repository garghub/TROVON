...
V_10 = 0 ;
return & ( (struct V_11 * ) ( V_8 -> V_12 ) + V_10 ) -> V_2 ;
}
...
struct V_17 * V_18 ;
struct V_19 * V_20 ;
struct V_21 * V_22 = F_14 ( V_8 ) ;
struct V_23 * V_24 = & V_14 -> V_24 ;
int V_25 ;
if ( ! V_16 )
return;
V_18 = F_15 ( V_24 -> V_26 , L_1 ) ;
if ( ! V_18 )
return;
V_25 = F_16 ( V_18 ) ;
if ( ! V_25 )
...
if ( ! V_25 )
return 0 ;
V_12 = F_17 ( V_24 , sizeof( * V_12 ) * V_25 , V_28 ) ;
if ( ! V_12 )
return - V_36 ;
V_8 -> V_37 = V_25 ;
V_8 -> V_12 = V_12 ;
F_24 (ctu, priv, i) {
snprintf ( V_31 , V_32 , L_4 ,
V_38 , V_33 / 4 ) ;
V_30 = F_25 ( V_24 , V_31 ) ;
if ( F_26 ( V_30 ) )
return F_27 ( V_30 ) ;
V_12 -> V_22 = & V_22 -> V_20 [ V_33 ] ;
V_34 = F_28 ( V_8 , & V_12 -> V_2 , & V_39 ,
V_30 , V_40 , V_33 ) ;
if ( V_34 )
return V_34 ;
}
