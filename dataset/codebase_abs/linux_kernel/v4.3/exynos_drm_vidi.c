...
type = ( V_73 == V_7 -> V_74 ) ? V_75 :
V_76 ;
V_38 = F_47 ( V_19 , & V_7 -> V_28 [ V_73 ] ,
1 << V_7 -> V_23 , type , V_77 ,
F_48 ( V_77 ) , V_73 ) ;
if ( V_38 )
return V_38 ;
}
V_71 = & V_7 -> V_28 [ V_7 -> V_74 ] ;
V_7 -> V_6 = F_49 ( V_19 , & V_71 -> V_26 ,
V_7 -> V_23 , V_78 ,
& V_79 , V_7 ) ;
if ( F_50 ( V_7 -> V_6 ) ) {
F_38 ( L_13 ) ;
...
static void F_56 ( struct V_30 * V_31 , struct V_30 * V_70 , void * V_43 )
{
}
...
struct V_1 * V_7 ;
int V_38 ;
V_7 = F_58 ( & V_85 -> V_31 , sizeof( * V_7 ) , V_61 ) ;
if ( ! V_7 )
return - V_50 ;
V_7 -> V_74 = 0 ;
V_7 -> V_85 = V_85 ;
...
F_60 ( & V_7 -> V_17 ) ;
F_61 ( V_85 , V_7 ) ;
V_38 = F_62 ( & V_85 -> V_31 , & V_86 ) ;
if ( V_38 < 0 ) {
F_38 ( L_16 ) ;
return V_38 ;
}
V_38 = F_63 ( & V_85 -> V_31 , & V_87 ) ;
if ( V_38 )
goto V_88;
return V_38 ;
V_88:
