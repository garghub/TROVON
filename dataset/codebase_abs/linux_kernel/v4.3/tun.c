...
goto V_109;
if ( V_48 -> V_63 ) {
F_108 ( V_48 -> V_63 , & F_109 ( V_48 ) -> V_114 ) ;
F_110 ( V_48 ) ;
}
F_111 ( V_48 ) ;
F_112 ( V_48 ) ;
F_113 ( & V_38 -> V_74 . V_63 -> V_64 , V_48 ) ;
if ( V_38 -> V_3 & V_115 )
F_114 ( & V_38 -> V_116 , V_117 , V_118 ) ;
V_38 -> V_74 . V_63 -> V_75 ( V_38 -> V_74 . V_63 ) ;
F_37 () ;
return V_119 ;
V_109:
...
static void F_117 ( struct V_45 * V_46 )
{
}
static int
F_118 ( struct V_45 * V_46 , int V_123 )
{
...
static T_9 F_119 ( struct V_45 * V_46 ,
T_9 V_128 )
{
struct V_1 * V_2 = F_41 ( V_46 ) ;
...
F_122 ( & V_2 -> V_39 [ V_25 ] ) ;
V_2 -> V_32 = V_131 ;
F_123 ( & V_2 -> V_36 , F_27 , ( unsigned long ) V_2 ) ;
F_30 ( & V_2 -> V_36 ,
F_31 ( V_20 + V_2 -> V_32 ) ) ;
}
...
static unsigned int F_129 ( struct V_77 * V_77 , T_10 * V_147 )
{
struct V_37 * V_38 = V_77 -> V_79 ;
...
V_63 = V_38 -> V_74 . V_63 ;
F_17 ( V_18 , V_2 , L_5 ) ;
F_130 ( V_77 , F_131 ( V_63 ) , V_147 ) ;
if ( ! F_132 ( & V_63 -> V_64 ) )
V_89 |= V_150 | V_151 ;
if ( F_133 ( V_63 ) ||
( ! F_134 ( V_152 , & V_63 -> V_153 -> V_3 ) &&
F_133 ( V_63 ) ) )
V_89 |= V_154 | V_155 ;
...
static struct V_47 * F_135 ( struct V_37 * V_38 ,
...
V_157 = V_110 ;
V_48 = F_136 ( V_63 , V_156 + V_157 , V_110 - V_157 , V_158 ,
& V_80 , 0 ) ;
if ( ! V_48 )
return F_137 ( V_80 ) ;
F_138 ( V_48 , V_156 ) ;
...
static T_12 F_140 ( struct V_1 * V_2 , struct V_37 * V_38 ,
void * V_161 , struct V_162 * V_163 ,
int V_158 )
{
struct V_164 V_165 = { 0 , F_141 (ETH_P_IP) } ;
struct V_47 * V_48 ;
T_11 V_166 = F_142 ( V_163 ) ;
...
return - V_8 ;
V_110 -= sizeof( V_165 ) ;
V_29 = F_143 ( & V_165 , sizeof( V_165 ) , V_163 ) ;
...
return - V_8 ;
V_110 -= V_2 -> V_176 ;
V_29 = F_143 ( & V_170 , sizeof( V_170 ) , V_163 ) ;
...
return - V_8 ;
F_144 ( V_163 , V_2 -> V_176 - sizeof( V_170 ) ) ;
}
...
V_48 = F_135 ( V_38 , V_167 , V_172 , V_157 , V_158 ) ;
if ( F_147 ( V_48 ) ) {
if ( F_148 ( V_48 ) != - V_186 )
...
if ( V_173 )
V_80 = F_149 ( V_48 , V_163 ) ;
else {
V_80 = F_150 ( V_48 , 0 , V_163 , V_110 ) ;
if ( ! V_80 && V_161 ) {
...
if ( V_170 . V_3 & V_177 ) {
if ( ! F_151 ( V_48 , F_8 ( V_2 , V_170 . V_178 ) ,
F_8 ( V_2 , V_170 . V_179 ) ) ) {
...
case 0x40 :
V_165 . V_192 = F_152 ( V_193 ) ;
break;
case 0x60 :
V_165 . V_192 = F_152 ( V_194 ) ;
break;
default:
V_2 -> V_46 -> V_120 . V_187 ++ ;
F_116 ( V_48 ) ;
...
break;
case V_142 :
V_48 -> V_195 = F_154 ( V_48 , V_2 -> V_46 ) ;
break;
}
...
case V_199 :
F_109 ( V_48 ) -> V_196 = V_200 ;
break;
case V_201 :
F_109 ( V_48 ) -> V_196 = V_202 ;
break;
case V_203 :
F_109 ( V_48 ) -> V_196 = V_204 ;
break;
default:
V_2 -> V_46 -> V_120 . V_191 ++ ;
F_116 ( V_48 ) ;
...
F_109 ( V_48 ) -> V_196 |= V_205 ;
F_109 ( V_48 ) -> V_206 = F_8 ( V_2 , V_170 . V_206 ) ;
if ( F_109 ( V_48 ) -> V_206 == 0 ) {
V_2 -> V_46 -> V_120 . V_191 ++ ;
F_116 ( V_48 ) ;
return - V_8 ;
}
F_109 ( V_48 ) -> V_196 |= V_207 ;
F_109 ( V_48 ) -> V_208 = 0 ;
}
if ( V_173 ) {
F_109 ( V_48 ) -> V_209 = V_161 ;
F_109 ( V_48 ) -> V_114 |= V_210 ;
F_109 ( V_48 ) -> V_114 |= V_211 ;
}
F_156 ( V_48 ) ;
F_157 ( V_48 , 0 ) ;
V_11 = F_43 ( V_48 ) ;
...
static T_12 F_159 ( struct V_214 * V_215 , struct V_162 * V_163 )
{
...
if ( ! V_2 )
return - V_218 ;
V_217 = F_140 ( V_2 , V_38 , NULL , V_163 , V_77 -> V_219 & V_220 ) ;
F_87 ( V_2 ) ;
return V_217 ;
}
static T_12 F_160 ( struct V_1 * V_2 ,
struct V_37 * V_38 ,
struct V_47 * V_48 ,
struct V_162 * V_221 )
{
...
if ( ! ( V_2 -> V_3 & V_174 ) ) {
if ( F_142 ( V_221 ) < sizeof( V_165 ) )
return - V_8 ;
V_222 += sizeof( V_165 ) ;
if ( F_142 ( V_221 ) < V_222 ) {
V_165 . V_3 |= V_226 ;
}
if ( F_162 ( & V_165 , sizeof( V_165 ) , V_221 ) != sizeof( V_165 ) )
return - V_7 ;
}
if ( V_176 ) {
struct V_169 V_170 = { 0 } ;
if ( F_142 ( V_221 ) < V_176 )
return - V_8 ;
if ( F_163 ( V_48 ) ) {
struct V_227 * V_228 = F_109 ( V_48 ) ;
V_170 . V_180 = F_10 ( V_2 , F_164 ( V_48 ) ) ;
...
V_230 ,
16 , 1 , V_48 -> V_14 ,
F_167 ( ( int ) F_8 ( V_2 , V_170 . V_180 ) , 64 ) , true ) ;
F_168 ( 1 ) ;
return - V_8 ;
}
...
if ( V_48 -> V_231 == V_232 ) {
V_170 . V_3 = V_177 ;
V_170 . V_178 = F_10 ( V_2 , F_169 ( V_48 ) +
V_224 ) ;
V_170 . V_179 = F_10 ( V_2 , V_48 -> V_179 ) ;
} else if ( V_48 -> V_231 == V_233 ) {
V_170 . V_3 = V_234 ;
}
if ( F_162 ( & V_170 , sizeof( V_170 ) , V_221 ) != sizeof( V_170 ) )
return - V_7 ;
F_144 ( V_221 , V_176 - sizeof( V_170 ) ) ;
}
if ( V_224 ) {
int V_235 ;
struct {
...
V_238 . V_237 = F_152 ( F_170 ( V_48 ) ) ;
V_223 = F_171 ( struct V_240 , V_236 ) ;
V_235 = F_172 ( V_48 , 0 , V_221 , V_223 ) ;
if ( V_235 || ! F_142 ( V_221 ) )
goto V_102;
V_235 = F_162 ( & V_238 , sizeof( V_238 ) , V_221 ) ;
if ( V_235 != sizeof( V_238 ) || ! F_142 ( V_221 ) )
goto V_102;
}
F_172 ( V_48 , V_223 , V_221 , V_48 -> V_110 - V_223 ) ;
V_102:
V_2 -> V_46 -> V_120 . V_241 ++ ;
V_2 -> V_46 -> V_120 . V_242 += V_48 -> V_110 + V_224 ;
return V_222 ;
}
static T_12 F_173 ( struct V_1 * V_2 , struct V_37 * V_38 ,
struct V_162 * V_243 ,
int V_158 )
{
struct V_47 * V_48 ;
...
if ( V_2 -> V_46 -> V_71 != V_72 )
return - V_246 ;
V_48 = F_174 ( V_38 -> V_74 . V_63 , V_158 ? V_247 : 0 ,
& V_244 , & V_245 , & V_80 ) ;
if ( ! V_48 )
return V_80 ;
V_235 = F_160 ( V_2 , V_38 , V_48 , V_243 ) ;
if ( F_39 ( V_235 < 0 ) )
F_116 ( V_48 ) ;
else
F_175 ( V_48 ) ;
...
static T_12 F_176 ( struct V_214 * V_215 , struct V_162 * V_243 )
{
struct V_77 * V_77 = V_215 -> V_216 ;
struct V_37 * V_38 = V_77 -> V_79 ;
struct V_1 * V_2 = F_83 ( V_38 ) ;
T_12 V_110 = F_142 ( V_243 ) , V_235 ;
if ( ! V_2 )
return - V_218 ;
V_235 = F_173 ( V_2 , V_38 , V_243 , V_77 -> V_219 & V_220 ) ;
V_235 = F_177 ( T_12 , V_235 , V_110 ) ;
if ( V_235 > 0 )
V_215 -> V_248 = V_235 ;
F_87 ( V_2 ) ;
return V_235 ;
}
static void F_178 ( struct V_45 * V_46 )
{
struct V_1 * V_2 = F_41 ( V_46 ) ;
F_65 ( ! ( F_179 ( & V_2 -> V_61 ) ) ) ;
F_124 ( V_2 ) ;
...
static void F_182 ( struct V_45 * V_46 )
{
struct V_1 * V_2 = F_41 ( V_46 ) ;
V_2 -> V_55 = V_249 ;
V_2 -> V_57 = V_250 ;
...
static int F_183 ( struct V_254 * V_255 [] , struct V_254 * V_30 [] )
{
return - V_8 ;
}
static void F_184 ( struct V_148 * V_63 )
{
struct V_37 * V_38 ;
T_14 * V_256 ;
if ( ! F_133 ( V_63 ) )
return;
if ( ! F_185 ( V_152 , & V_63 -> V_153 -> V_3 ) )
return;
V_256 = F_131 ( V_63 ) ;
if ( V_256 && F_186 ( V_256 ) )
F_187 ( V_256 , V_154 |
V_155 | V_257 ) ;
V_38 = F_188 ( V_63 , struct V_37 , V_63 ) ;
F_114 ( & V_38 -> V_116 , V_117 , V_258 ) ;
}
static int F_189 ( struct V_74 * V_148 , struct V_259 * V_260 , T_11 V_166 )
{
int V_235 ;
struct V_37 * V_38 = F_188 ( V_148 , struct V_37 , V_74 ) ;
struct V_1 * V_2 = F_83 ( V_38 ) ;
if ( ! V_2 )
return - V_218 ;
V_235 = F_140 ( V_2 , V_38 , V_260 -> V_161 , & V_260 -> V_261 ,
V_260 -> V_262 & V_247 ) ;
F_87 ( V_2 ) ;
return V_235 ;
}
...
if ( V_3 & V_264 ) {
V_235 = F_191 ( V_148 -> V_63 , V_260 , V_166 ,
V_265 , V_266 ) ;
goto V_82;
}
V_235 = F_173 ( V_2 , V_38 , & V_260 -> V_261 , V_3 & V_247 ) ;
if ( V_235 > ( T_12 ) V_166 ) {
V_260 -> V_262 |= V_263 ;
...
static T_12 F_193 ( struct V_268 * V_46 , struct V_269 * V_270 ,
char * V_271 )
{
struct V_1 * V_2 = F_41 ( F_194 ( V_46 ) ) ;
return sprintf ( V_271 , L_11 , F_192 ( V_2 ) ) ;
}
static T_12 F_195 ( struct V_268 * V_46 , struct V_269 * V_270 ,
char * V_271 )
{
struct V_1 * V_2 = F_41 ( F_194 ( V_46 ) ) ;
return F_49 ( V_2 -> V_55 ) ?
sprintf ( V_271 , L_12 ,
F_196 ( F_197 () , V_2 -> V_55 ) ) :
sprintf ( V_271 , L_13 ) ;
}
static T_12 F_198 ( struct V_268 * V_46 , struct V_269 * V_270 ,
char * V_271 )
{
struct V_1 * V_2 = F_41 ( F_194 ( V_46 ) ) ;
return F_51 ( V_2 -> V_57 ) ?
sprintf ( V_271 , L_12 ,
F_199 ( F_197 () , V_2 -> V_57 ) ) :
sprintf ( V_271 , L_13 ) ;
}
static int F_200 ( struct V_54 * V_54 , struct V_77 * V_77 , struct V_272 * V_273 )
{
struct V_1 * V_2 ;
struct V_37 * V_38 = V_77 -> V_79 ;
struct V_45 * V_46 ;
...
if ( * V_273 -> V_274 )
V_279 = V_273 -> V_274 ;
V_46 = F_204 ( sizeof( struct V_1 ) , V_279 ,
V_281 , F_182 , V_280 ,
V_280 ) ;
if ( ! V_46 )
return - V_101 ;
...
static void F_213 ( struct V_54 * V_54 , struct V_1 * V_2 ,
struct V_272 * V_273 )
{
F_17 ( V_18 , V_2 , L_17 ) ;
strcpy ( V_273 -> V_274 , V_2 -> V_46 -> V_279 ) ;
V_273 -> V_275 = F_192 ( V_2 ) ;
}
static int F_214 ( struct V_1 * V_2 , unsigned long V_94 )
{
T_9 V_128 = 0 ;
if ( V_94 & V_298 ) {
V_128 |= V_299 ;
...
static void F_216 ( struct V_1 * V_2 , int V_29 )
{
int V_25 ;
struct V_37 * V_38 ;
for ( V_25 = 0 ; V_25 < V_29 ; V_25 ++ ) {
V_38 = F_64 ( V_2 -> V_69 [ V_25 ] ) ;
F_217 ( V_38 -> V_74 . V_63 ) ;
}
V_2 -> V_87 = false ;
}
...
static int F_220 ( struct V_77 * V_77 , struct V_272 * V_273 )
{
struct V_37 * V_38 = V_77 -> V_79 ;
struct V_1 * V_2 ;
int V_235 = 0 ;
...
static long F_222 ( struct V_77 * V_77 , unsigned int V_310 ,
...
int V_312 ;
int V_235 ;
if ( V_310 == V_313 || V_310 == V_314 || F_223 ( V_310 ) == 0x89 ) {
...
return F_220 ( V_77 , & V_273 ) ;
V_235 = 0 ;
F_73 () ;
V_2 = F_83 ( V_38 ) ;
if ( V_310 == V_313 && ! V_2 ) {
V_273 . V_274 [ V_316 - 1 ] = '\0' ;
V_235 = F_200 ( F_224 ( & V_38 -> V_63 ) , V_77 , & V_273 ) ;
if ( V_235 )
goto V_42;
if ( F_225 ( V_5 , & V_273 , V_311 ) )
V_235 = - V_7 ;
goto V_42;
}
if ( V_310 == V_317 ) {
...
switch ( V_310 ) {
case V_318 :
F_213 ( V_319 -> V_320 -> V_321 , V_2 , & V_273 ) ;
if ( V_38 -> V_41 )
V_273 . V_275 |= V_309 ;
if ( ! V_38 -> V_74 . V_63 -> V_112 )
V_273 . V_275 |= V_278 ;
...
V_2 -> V_55 = V_55 ;
F_17 ( V_18 , V_2 , L_23 ,
F_228 ( & V_325 , V_2 -> V_55 ) ) ;
break;
case V_326 :
V_57 = F_229 ( F_197 () , V_94 ) ;
if ( ! F_51 ( V_57 ) ) {
V_235 = - V_8 ;
break;
}
...
F_17 ( V_339 , V_2 , L_27 ,
V_273 . V_334 . V_335 ) ;
V_235 = F_232 ( V_2 -> V_46 , & V_273 . V_334 ) ;
break;
case V_340 :
V_287 = V_38 -> V_74 . V_63 -> V_288 ;
if ( F_225 ( V_5 , & V_287 , sizeof( V_287 ) ) )
V_235 = - V_7 ;
break;
case V_341 :
...
case V_342 :
V_176 = V_2 -> V_176 ;
if ( F_225 ( V_5 , & V_176 , sizeof( V_176 ) ) )
V_235 = - V_7 ;
break;
case V_343 :
...
break;
V_235 = - V_7 ;
if ( F_225 ( V_5 , & V_2 -> V_88 , sizeof( V_2 -> V_88 ) ) )
break;
V_235 = 0 ;
break;
default:
...
static long F_233 ( struct V_77 * V_77 ,
unsigned int V_310 , unsigned long V_94 )
{
return F_222 ( V_77 , V_310 , V_94 , sizeof ( struct V_272 ) ) ;
}
...
case V_333 :
case V_338 :
V_94 = ( unsigned long ) F_235 ( V_94 ) ;
break;
default:
V_94 = ( V_351 ) V_94 ;
break;
}
return F_222 ( V_77 , V_310 , V_94 , sizeof( struct V_352 ) ) ;
}
static int F_236 ( int V_353 , struct V_77 * V_77 , int V_354 )
{
struct V_37 * V_38 = V_77 -> V_79 ;
int V_235 ;
if ( ( V_235 = F_237 ( V_353 , V_77 , V_354 , & V_38 -> V_116 ) ) < 0 )
goto V_82;
if ( V_354 ) {
F_238 ( V_77 , F_239 ( V_319 ) , V_355 , 0 ) ;
V_38 -> V_3 |= V_115 ;
} else
V_38 -> V_3 &= ~ V_115 ;
V_235 = 0 ;
...
static int F_240 ( struct V_356 * V_356 , struct V_77 * V_77 )
{
struct V_54 * V_54 = V_319 -> V_320 -> V_321 ;
struct V_37 * V_38 ;
F_241 ( V_18 , L_28 ) ;
V_38 = (struct V_37 * ) F_242 ( V_54 , V_357 , V_100 ,
& V_358 , 0 ) ;
if ( ! V_38 )
return - V_101 ;
F_67 ( V_38 -> V_2 , NULL ) ;
V_38 -> V_3 = 0 ;
V_38 -> V_284 = 0 ;
F_243 ( & V_38 -> V_359 . V_147 ) ;
F_67 ( V_38 -> V_74 . V_359 , & V_38 -> V_359 ) ;
V_38 -> V_74 . V_77 = V_77 ;
V_38 -> V_74 . V_360 = & V_361 ;
F_244 ( & V_38 -> V_74 , & V_38 -> V_63 ) ;
V_38 -> V_63 . V_362 = F_184 ;
V_38 -> V_63 . V_288 = V_184 ;
V_77 -> V_79 = V_38 ;
F_208 ( & V_38 -> V_60 ) ;
F_245 ( & V_38 -> V_63 , V_363 ) ;
return 0 ;
}
static int F_246 ( struct V_356 * V_356 , struct V_77 * V_77 )
{
struct V_37 * V_38 = V_77 -> V_79 ;
F_72 ( V_38 , true ) ;
return 0 ;
}
static void F_247 ( struct V_364 * V_260 , struct V_77 * V_365 )
{
struct V_1 * V_2 ;
struct V_272 V_273 ;
memset ( & V_273 , 0 , sizeof( V_273 ) ) ;
...
if ( V_2 )
F_87 ( V_2 ) ;
F_248 ( V_260 , L_29 , V_273 . V_274 ) ;
}
static int F_249 ( struct V_45 * V_46 , struct V_366 * V_310 )
{
V_310 -> V_367 = 0 ;
V_310 -> V_368 = 0 ;
F_250 ( V_310 , V_369 ) ;
...
static void F_251 ( struct V_45 * V_46 , struct V_381 * V_382 )
{
struct V_1 * V_2 = F_41 ( V_46 ) ;
F_252 ( V_382 -> V_383 , V_384 , sizeof( V_382 -> V_383 ) ) ;
F_252 ( V_382 -> V_385 , V_386 , sizeof( V_382 -> V_385 ) ) ;
switch ( V_2 -> V_3 & V_132 ) {
case V_133 :
F_252 ( V_382 -> V_387 , L_30 , sizeof( V_382 -> V_387 ) ) ;
break;
case V_142 :
F_252 ( V_382 -> V_387 , L_31 , sizeof( V_382 -> V_387 ) ) ;
break;
}
}
static T_4 F_253 ( struct V_45 * V_46 )
{
#ifdef F_231
struct V_1 * V_2 = F_41 ( V_46 ) ;
return V_2 -> V_330 ;
...
static void F_254 ( struct V_45 * V_46 , T_4 V_389 )
{
#ifdef F_231
struct V_1 * V_2 = F_41 ( V_46 ) ;
V_2 -> V_330 = V_389 ;
...
static int T_17 F_255 ( void )
{
int V_235 = 0 ;
F_256 ( L_32 , V_390 , V_386 ) ;
F_256 ( L_33 , V_391 ) ;
V_235 = F_257 ( & V_283 ) ;
if ( V_235 ) {
F_165 ( L_34 ) ;
...
struct V_74 * F_262 ( struct V_77 * V_77 )
{
struct V_37 * V_38 ;
if ( V_77 -> V_396 != & V_397 )
return F_137 ( - V_8 ) ;
