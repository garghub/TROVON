...
unsigned long V_99 , V_47 V_85 ,
struct V_100 * V_101 , bool V_56 ,
unsigned long V_102 )
{
unsigned long V_103 = V_99 & V_104 ;
...
if ( ! V_56 ) {
F_57 ( V_25 , V_36 , V_14 ) ;
F_65 ( & V_36 -> V_37 [ V_103 ] ) ;
} else {
unsigned long long V_106 ;
F_57 ( V_25 , V_36 , V_14 ) ;
F_66 ( & V_36 -> V_37 [ V_103 ] ) ;
V_14 -> V_107 [ V_103 ] += V_85 ;
V_14 -> V_108 [ V_103 ] += 1 ;
V_14 -> V_109 [ V_103 ] += V_101 -> V_110 ;
if ( ! ( V_25 -> V_58 & V_87 ) ) {
V_14 -> V_111 [ V_103 ] += V_102 ;
V_106 = F_67 ( V_102 ) ;
} else {
V_14 -> V_111 [ V_103 ] += V_101 -> V_112 ;
V_106 = V_101 -> V_112 ;
}
if ( V_25 -> V_59 ) {
unsigned V_113 = 0 , V_74 = V_25 -> V_59 + 1 ;
while ( V_113 + 1 < V_74 ) {
unsigned V_114 = ( V_113 + V_74 ) / 2 ;
if ( V_25 -> V_60 [ V_114 - 1 ] > V_106 ) {
V_74 = V_114 ;
} else {
V_113 = V_114 ;
}
...
static void F_70 ( struct V_24 * V_25 , unsigned long V_99 ,
V_47 V_115 , V_47 V_116 ,
bool V_56 , unsigned long V_102 ,
struct V_100 * V_101 )
{
V_47 V_117 , V_118 , V_119 , V_120 ;
T_1 V_98 ;
if ( V_116 <= V_25 -> V_55 || V_115 >= V_25 -> V_56 )
return;
if ( F_44 ( V_115 < V_25 -> V_55 ) ) {
V_117 = 0 ;
V_119 = V_116 - V_25 -> V_55 ;
} else {
V_117 = V_115 - V_25 -> V_55 ;
V_119 = V_116 - V_115 ;
}
if ( F_44 ( V_116 > V_25 -> V_56 ) )
V_119 -= ( V_116 - V_25 -> V_56 ) ;
V_118 = F_36 ( V_117 , V_25 -> V_57 ) ;
V_98 = V_117 ;
do {
...
V_120 = V_119 ;
if ( V_120 > V_25 -> V_57 - V_118 )
V_120 = V_25 -> V_57 - V_118 ;
F_61 ( V_25 , V_98 , V_99 , V_120 ,
V_101 , V_56 , V_102 ) ;
V_119 -= V_120 ;
V_98 ++ ;
V_118 = 0 ;
...
void F_71 ( struct V_40 * V_41 , unsigned long V_99 ,
V_47 V_115 , unsigned V_121 , bool V_56 ,
unsigned long V_102 ,
struct V_100 * V_101 )
{
struct V_24 * V_25 ;
...
V_43 = F_72 ( V_41 -> V_43 ) ;
V_101 -> V_110 =
( V_115 == ( F_53 ( V_43 -> V_46 ) &&
( ( V_99 & ( V_104 | V_123 ) ) ==
( F_53 ( V_43 -> V_49 ) & ( V_104 | V_123 ) ) )
) ) ;
F_53 ( V_43 -> V_46 ) = V_116 ;
F_53 ( V_43 -> V_49 ) = V_99 ;
}
F_73 () ;
V_122 = false ;
F_74 (s, &stats->list, list_entry) {
if ( V_25 -> V_58 & V_87 && ! V_122 ) {
if ( ! V_56 )
V_101 -> V_112 = F_59 ( F_60 () ) ;
else
V_101 -> V_112 = F_59 ( F_60 () ) - V_101 -> V_112 ;
V_122 = true ;
}
F_70 ( V_25 , V_99 , V_115 , V_116 , V_56 , V_102 , V_101 ) ;
}
F_75 () ;
}
static void F_76 ( struct V_35 * V_36 ,
struct V_24 * V_25 , T_1 V_124 )
{
int V_23 ;
struct V_66 * V_14 ;
F_77 () ;
V_14 = & V_25 -> V_28 [ F_64 () ] [ V_124 ] ;
F_57 ( V_25 , V_36 , V_14 ) ;
F_78 () ;
...
V_36 -> V_33 . V_111 [ V_38 ] = 0 ;
V_36 -> V_33 . V_111 [ V_39 ] = 0 ;
...
V_36 -> V_33 . V_111 [ V_38 ] += F_53 ( V_14 -> V_111 [ V_38 ] ) ;
V_36 -> V_33 . V_111 [ V_39 ] += F_53 ( V_14 -> V_111 [ V_39 ] ) ;
...
V_36 = & V_25 -> V_32 [ V_124 ] ;
if ( V_127 )
F_76 ( V_36 , V_25 , V_124 ) ;
F_77 () ;
V_14 = & V_25 -> V_28 [ F_64 () ] [ V_124 ] ;
...
V_14 -> V_111 [ V_38 ] -= V_36 -> V_33 . V_111 [ V_38 ] ;
V_14 -> V_111 [ V_39 ] -= V_36 -> V_33 . V_111 [ V_39 ] ;
...
for ( V_124 = V_125 ; V_124 < V_126 ; V_124 ++ , V_55 = V_56 ) {
V_36 = & V_25 -> V_32 [ V_124 ] ;
V_56 = V_55 + V_57 ;
...
V_36 -> V_33 . V_109 [ V_38 ] ,
V_36 -> V_33 . V_107 [ V_38 ] ,
F_81 ( V_25 , V_36 -> V_33 . V_111 [ V_38 ] ) ,
V_36 -> V_33 . V_108 [ V_39 ] ,
V_36 -> V_33 . V_109 [ V_39 ] ,
V_36 -> V_33 . V_107 [ V_39 ] ,
F_81 ( V_25 , V_36 -> V_33 . V_111 [ V_39 ] ) ,
F_21 ( V_36 ) ,
...
int V_25 ;
char V_137 ;
V_25 = sscanf ( V_134 , L_15 , & V_74 , & V_137 ) ;
...
if ( ! V_85 )
V_85 = 1 ;
} else if ( sscanf ( V_2 , L_17 , & V_55 , & V_85 , & V_140 ) != 2 ||
...
goto V_146;
V_2 = F_88 ( & V_143 ) ;
if ( sscanf ( V_2 , L_18 , & V_141 , & V_140 ) == 1 ) {
if ( ! V_141 )
return - V_69 ;
V_57 = V_56 - V_55 ;
if ( F_90 ( V_57 , V_141 ) )
...
if ( ! V_57 )
V_57 = 1 ;
} else if ( sscanf ( V_2 , L_15 , & V_57 , & V_140 ) != 1 ||
V_57 != ( V_47 ) V_57 || ! V_57 )
goto V_146;
V_144 = V_143 ;
V_2 = F_88 ( & V_143 ) ;
if ( V_2 && sscanf ( V_2 , L_19 , & V_145 , & V_140 ) == 1 ) {
while ( V_145 -- ) {
V_2 = F_88 ( & V_143 ) ;
if ( ! V_2 )
goto V_146;
...
if ( V_138 != 2 )
return - V_69 ;
if ( sscanf ( V_139 [ 1 ] , L_23 , & V_75 , & V_140 ) != 1 || V_75 < 0 )
return - V_69 ;
...
return - V_69 ;
if ( V_138 > 3 ) {
if ( strcmp ( V_139 [ 2 ] , L_16 ) &&
sscanf ( V_139 [ 2 ] , L_24 , & V_125 , & V_140 ) != 1 )
return - V_69 ;
if ( strcmp ( V_139 [ 3 ] , L_16 ) &&
sscanf ( V_139 [ 3 ] , L_24 , & V_130 , & V_140 ) != 1 )
return - V_69 ;
}
...
else if ( ! strcasecmp ( V_139 [ 0 ] , L_28 ) )
V_68 = F_95 ( V_62 , V_138 , V_139 , V_83 , V_84 ) ;
else if ( ! strcasecmp ( V_139 [ 0 ] , L_29 ) )
V_68 = F_96 ( V_62 , V_138 , V_139 , false , V_83 , V_84 ) ;
else if ( ! strcasecmp ( V_139 [ 0 ] , L_30 ) )
V_68 = F_96 ( V_62 , V_138 , V_139 , true , V_83 , V_84 ) ;
else if ( ! strcasecmp ( V_139 [ 0 ] , L_31 ) )
