...
STATIC int T_3 F_3 ( unsigned char * V_13 , long V_14 ,
long (* F_4)( void * V_9 , unsigned long V_3 ) ,
long (* F_5)( void * V_10 , unsigned long V_3 ) ,
unsigned char * V_15 , long * V_16 ,
void (* error)( char * V_4 ) )
{
struct V_17 V_2 ;
struct V_18 * V_12 ;
...
if ( F_5 ( V_2 . V_15 , V_2 . V_32 ) != ( long ) V_2 . V_32 )
V_20 = V_33 ;
V_2 . V_32 = 0 ;
}
} while ( V_20 == V_34 );
...
STATIC int T_3 F_10 ( unsigned char * V_7 , long V_40 ,
long (* F_4)( void * , unsigned long ) ,
long (* F_5)( void * , unsigned long ) ,
unsigned char * V_41 , long V_42 ,
long * V_43 ,
void (* error)( char * V_4 ) )
{
return F_3 ( V_7 , V_40 , F_4 , F_5 , V_41 , V_43 , error ) ;
}
