...
static void
F_126 ( struct V_8 * V_9 , struct V_46 * V_47 ,
struct V_46 * V_48 )
{
unsigned long V_115 ;
...
F_129 ( V_9 , V_47 -> V_129 , V_49 ) ;
if ( F_130 ( V_9 , V_47 -> V_129 ) )
F_118 ( V_9 ) ;
V_99 -> V_13 ( V_9 , V_124 ) ;
V_99 -> V_13 ( V_9 , V_125 ) ;
F_121 ( & V_9 -> V_116 , V_115 ) ;
...
F_133 ( V_9 -> V_88 , sizeof( struct V_1 ) ) ;
}
static int
...
int V_74 ;
if ( V_9 -> V_115 & V_158 )
V_9 -> V_159 = F_135 ( V_9 -> V_88 ,
sizeof( struct V_1 ) ) ;
if ( ! V_9 -> V_159 )
return - V_160 ;
V_74 = F_136 ( V_9 -> V_88 , sizeof( struct V_1 ) ,
L_17 ) != NULL ? 0 : - V_161 ;
if ( V_74 )
goto V_162;
if ( V_99 -> V_163 ) {
...
static void
F_137 ( struct V_8 * V_9 , int V_115 )
{
if ( ( V_115 & V_165 )
&& ( F_134 ( V_9 ) == 0 ) )
V_9 -> type = V_156 ;
...
static int
F_138 ( struct V_8 * V_9 , struct V_166 * V_167 )
{
...
if ( V_104 & V_215 )
F_152 ( V_9 , ! ( V_104 & V_108 ) ) ;
if ( V_104 & V_216 )
F_153 ( V_9 , ! ( V_104 & V_106 ) ) ;
if ( ! ( -- V_208 ) )
V_210 = 0 ;
} while ( V_210 );
return V_217 ;
...
static void
F_156 ( struct V_225 * V_226 , const char * V_227 , unsigned int V_228 )
{
...
static int T_6
F_157 ( struct V_225 * V_226 , char * V_233 )
{
struct V_8 * V_9 = & V_229 [ V_226 -> V_230 ] ;
...
F_155 ( L_24 , V_226 -> V_230 ) ;
return - V_160 ;
}
if ( ! V_52 ) {
F_155 ( L_25 , V_226 -> V_230 ) ;
return - V_160 ;
}
F_155 ( L_26 ,
V_226 -> V_230 , V_234 [ V_226 -> V_230 ] -> V_238 ) ;
V_95 = F_158 ( V_52 , 0 , & V_236 ) ;
if ( V_95 ) {
F_155 ( L_27 , V_226 -> V_230 ) ;
return V_95 ;
}
V_50 = F_159 ( V_52 ) ;
if ( V_50 == 0 ) {
...
V_9 -> V_159 = F_135 ( V_236 . V_241 , sizeof( struct V_1 ) ) ;
V_9 -> V_54 = F_37 ( V_52 , 0 ) ;
if ( V_9 -> V_159 == NULL )
return - V_160 ;
F_155 ( L_29 ,
...
V_9 -> V_54 , V_9 -> V_50 ) ;
if ( V_233 )
F_161 ( V_233 , & V_49 , & V_191 , & V_220 , & V_221 ) ;
else
F_154 ( V_9 , & V_49 , & V_191 , & V_220 , & V_221 ) ;
F_155 ( L_30 ,
V_49 , V_220 , V_191 , V_221 ) ;
return F_162 ( V_9 , V_226 , V_49 , V_191 , V_220 , V_221 ) ;
}
static int T_6
F_163 ( void )
{
...
V_9 -> V_239 = & V_240 ;
V_9 -> V_90 = & V_244 -> V_90 ;
V_95 = F_158 ( V_244 -> V_90 . V_246 , 0 , & V_236 ) ;
if ( V_95 )
return V_95 ;
V_9 -> V_88 = V_236 . V_241 ;
if ( ! V_9 -> V_88 ) {
...
V_95 = F_167 ( & V_251 , V_9 ) ;
if ( V_95 )
return V_95 ;
F_168 ( V_244 , ( void * ) V_9 ) ;
return 0 ;
}
static int
F_169 ( struct V_243 * V_244 )
{
struct V_8 * V_9 = F_170 ( V_244 ) ;
if ( V_9 )
F_171 ( & V_251 , V_9 ) ;
return 0 ;
}
static int
F_172 ( struct V_243 * V_244 , T_8 V_18 )
{
struct V_8 * V_9 = F_170 ( V_244 ) ;
if ( V_9 )
F_173 ( & V_251 , V_9 ) ;
...
if ( V_252 )
return;
F_178 (np, mpc52xx_uart_of_match) {
V_254 = F_179 ( V_255 , V_52 ) ;
V_99 = V_254 -> V_256 ;
F_176 ( V_52 ) ;
}
V_252 = 1 ;
