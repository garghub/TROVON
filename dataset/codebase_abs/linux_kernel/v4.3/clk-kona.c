...
long V_17 ;
T_1 V_98 ;
F_70 ( V_88 -> V_90 . V_22 & V_99 ) ;
V_79 = ( T_1 ) V_88 -> V_90 . V_100 ;
if ( V_79 < 2 ) {
V_17 = F_67 ( V_86 , V_94 -> V_17 ,
& V_94 -> V_101 ) ;
if ( V_17 < 0 )
return V_17 ;
V_94 -> V_17 = V_17 ;
...
V_95 = F_71 ( V_86 ) ;
V_67 = F_68 ( V_95 ) ;
V_97 = F_67 ( V_86 , V_94 -> V_17 , & V_67 ) ;
V_96 = abs ( V_97 - V_94 -> V_17 ) ;
for ( V_98 = 0 ; V_98 < V_79 ; V_98 ++ ) {
struct V_85 * V_102 = F_72 ( V_86 , V_98 ) ;
unsigned long V_103 ;
unsigned long V_104 ;
F_6 ( ! V_102 ) ;
if ( V_102 == V_95 )
continue;
V_67 = F_68 ( V_102 ) ;
V_104 = F_67 ( V_86 , V_94 -> V_17 ,
& V_67 ) ;
V_103 = abs ( V_104 - V_94 -> V_17 ) ;
if ( V_103 < V_96 ) {
V_96 = V_103 ;
V_97 = V_104 ;
V_94 -> V_105 = V_102 ;
...
static int F_73 ( struct V_85 * V_86 , T_3 V_82 )
{
struct V_87 * V_88 = F_63 ( V_86 ) ;
struct V_91 * V_92 = V_88 -> V_8 . V_89 ;
...
if ( ! F_58 ( V_77 ) )
return 0 ;
V_61 = F_74 ( & V_92 -> V_106 ) ? & V_92 -> V_106
: & V_92 -> V_61 ;
...
F_22 ( L_18 , V_25 ,
V_61 == & V_92 -> V_106 ? L_19 : L_20 ,
V_88 -> V_90 . V_26 ) ;
}
return V_40 ;
}
static T_3 F_75 ( struct V_85 * V_86 )
{
struct V_87 * V_88 = F_63 ( V_86 ) ;
struct V_91 * V_92 = V_88 -> V_8 . V_89 ;
T_3 V_82 ;
...
static int F_76 ( struct V_85 * V_86 , unsigned long V_17 ,
unsigned long V_67 )
{
struct V_87 * V_88 = F_63 ( V_86 ) ;
struct V_91 * V_92 = V_88 -> V_8 . V_89 ;
...
static bool F_77 ( struct V_87 * V_88 )
{
...
V_61 = F_74 ( & V_89 -> V_106 ) ? & V_89 -> V_106
: & V_89 -> V_61 ;
...
bool T_4 F_80 ( struct V_18 * V_19 )
{
unsigned long V_22 ;
unsigned int V_98 ;
struct V_108 * * V_109 = V_19 -> V_110 . V_109 ;
struct V_87 * V_111 = V_19 -> V_111 ;
bool V_55 = true ;
V_22 = F_17 ( V_19 ) ;
F_21 ( V_19 ) ;
for ( V_98 = 0 ; V_98 < V_19 -> V_110 . V_112 ; V_98 ++ ) {
struct V_87 * V_88 ;
if ( ! V_109 [ V_98 ] )
continue;
V_88 = & V_111 [ V_98 ] ;
