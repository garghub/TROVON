...
void T_1 * V_84 ;
int V_6 ;
V_4 = F_26 ( & V_81 -> V_2 , sizeof( struct V_3 ) , V_85 ) ;
if ( ! V_4 ) {
F_6 ( & V_81 -> V_2 , L_3 ) ;
V_6 = - V_86 ;
goto V_87;
...
V_83 = F_32 ( V_81 , V_90 , 0 ) ;
V_84 = F_33 ( & V_81 -> V_2 , V_83 ) ;
if ( F_30 ( V_84 ) ) {
V_6 = F_31 ( V_84 ) ;
goto V_91;
}
V_4 -> V_33 = F_34 ( & V_81 -> V_2 , V_84 ,
& V_92 ) ;
if ( F_30 ( V_4 -> V_33 ) ) {
F_6 ( & V_81 -> V_2 , L_5 ) ;
V_6 = F_31 ( V_4 -> V_33 ) ;
...
V_4 -> V_70 . V_93 = V_83 -> V_94 + V_79 ;
V_4 -> V_70 . V_95 = V_96 ;
V_4 -> V_70 . V_97 = 4 ;
V_4 -> V_71 . V_93 = V_83 -> V_94 + V_78 ;
V_4 -> V_71 . V_95 = V_96 ;
V_4 -> V_71 . V_97 = 4 ;
F_35 ( & V_81 -> V_2 ) ;
if ( ! F_36 ( & V_81 -> V_2 ) ) {
...
V_6 = F_37 ( & V_81 -> V_2 , & V_99 ,
& V_4 -> V_8 , 1 ) ;
if ( V_6 ) {
F_6 ( & V_81 -> V_2 , L_6 , V_6 ) ;
V_6 = - V_86 ;
goto V_100;
}
V_6 = F_38 ( & V_81 -> V_2 ) ;
if ( V_6 ) {
F_6 ( & V_81 -> V_2 , L_7 , V_6 ) ;
goto V_101;
}
return 0 ;
V_101:
