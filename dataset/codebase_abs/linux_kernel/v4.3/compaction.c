...
static int F_94 ( struct V_16 * V_16 , struct V_26 * V_27 ,
const int V_12 )
{
unsigned int V_19 ;
unsigned long V_105 ;
...
return V_108 ;
V_105 = F_96 ( V_16 ) ;
if ( ! F_97 ( V_16 , V_27 -> V_19 , V_105 , V_27 -> V_109 ,
V_27 -> V_110 ) )
return V_108 ;
...
#ifdef F_98
if ( V_12 == V_13 &&
! F_63 ( & V_112 -> V_114 [ V_115 ] ) )
return V_106 ;
#endif
if ( F_99 ( V_112 , V_19 , V_12 ,
true , & V_113 ) != - 1 )
return V_106 ;
}
return V_116 ;
}
static int F_100 ( struct V_16 * V_16 , struct V_26 * V_27 ,
const int V_12 )
{
int V_117 ;
V_117 = F_94 ( V_16 , V_27 , V_12 ) ;
F_101 ( V_16 , V_27 -> V_19 , V_117 ) ;
if ( V_117 == V_116 )
V_117 = V_108 ;
return V_117 ;
}
static unsigned long F_102 ( struct V_16 * V_16 , int V_19 ,
int V_110 , int V_109 )
{
int V_118 ;
unsigned long V_105 ;
...
return V_108 ;
V_105 = F_96 ( V_16 ) ;
if ( F_97 ( V_16 , V_19 , V_105 , V_109 ,
V_110 ) )
return V_106 ;
V_105 += ( 2UL << V_19 ) ;
if ( ! F_97 ( V_16 , 0 , V_105 , V_109 , V_110 ) )
return V_119 ;
V_118 = F_103 ( V_16 , V_19 ) ;
if ( V_118 >= 0 && V_118 <= V_120 )
return V_121 ;
return V_108 ;
}
unsigned long F_104 ( struct V_16 * V_16 , int V_19 ,
int V_110 , int V_109 )
{
unsigned long V_117 ;
V_117 = F_102 ( V_16 , V_19 , V_110 , V_109 ) ;
F_105 ( V_16 , V_19 , V_117 ) ;
if ( V_117 == V_121 )
V_117 = V_119 ;
return V_117 ;
}
static int F_106 ( struct V_16 * V_16 , struct V_26 * V_27 )
{
int V_117 ;
unsigned long V_14 = V_16 -> V_30 ;
unsigned long V_15 = F_32 ( V_16 ) ;
const int V_12 = F_107 ( V_27 -> V_122 ) ;
const bool V_123 = V_27 -> V_40 != V_41 ;
V_117 = F_104 ( V_16 , V_27 -> V_19 , V_27 -> V_110 ,
V_27 -> V_109 ) ;
switch ( V_117 ) {
case V_106 :
case V_119 :
...
if ( F_28 ( V_16 , V_27 -> V_19 ) && ! F_95 () )
F_33 ( V_16 ) ;
V_27 -> V_92 = V_16 -> V_29 [ V_123 ] ;
V_27 -> V_91 = V_16 -> V_31 ;
...
V_27 -> V_102 = 0 ;
F_108 ( V_14 , V_27 -> V_92 ,
V_27 -> V_91 , V_15 , V_123 ) ;
F_109 () ;
while ( ( V_117 = F_100 ( V_16 , V_27 , V_12 ) ) ==
V_108 ) {
int V_124 ;
...
V_124 = F_110 ( & V_27 -> V_68 , F_90 ,
F_92 , ( unsigned long ) V_27 , V_27 -> V_40 ,
V_127 ) ;
F_111 ( V_27 -> V_62 , V_124 ,
& V_27 -> V_68 ) ;
V_27 -> V_62 = 0 ;
if ( V_124 ) {
F_84 ( & V_27 -> V_68 ) ;
if ( V_124 == - V_128 && ! F_87 ( V_27 ) ) {
V_117 = V_106 ;
goto V_125;
}
}
...
F_116 ( V_14 , V_27 -> V_92 ,
V_27 -> V_91 , V_15 , V_123 , V_117 ) ;
return V_117 ;
}
static unsigned long F_117 ( struct V_16 * V_16 , int V_19 ,
T_5 V_122 , enum V_131 V_40 , int * V_44 ,
int V_110 , int V_109 )
{
unsigned long V_117 ;
struct V_26 V_27 = {
...
F_118 ( & V_27 . V_94 ) ;
F_118 ( & V_27 . V_68 ) ;
V_117 = F_106 ( V_16 , & V_27 ) ;
F_89 ( ! F_63 ( & V_27 . V_94 ) ) ;
F_89 ( ! F_63 ( & V_27 . V_68 ) ) ;
* V_44 = V_27 . V_44 ;
return V_117 ;
}
unsigned long F_119 ( T_5 V_122 , unsigned int V_19 ,
int V_110 , const struct V_132 * V_133 ,
enum V_131 V_40 , int * V_44 )
{
...
if ( F_24 ( V_16 , V_19 ) )
continue;
V_144 = F_117 ( V_16 , V_19 , V_122 , V_40 ,
& V_145 , V_110 ,
V_133 -> V_109 ) ;
V_140 = F_122 ( V_144 , V_140 ) ;
V_142 &= V_145 ;
if ( F_97 ( V_16 , V_19 , F_96 ( V_16 ) ,
V_133 -> V_109 , V_110 ) ) {
...
static void F_123 ( T_1 * V_34 , struct V_26 * V_27 )
{
int V_35 ;
struct V_16 * V_16 ;
for ( V_35 = 0 ; V_35 < V_36 ; V_35 ++ ) {
