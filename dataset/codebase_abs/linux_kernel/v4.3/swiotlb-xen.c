...
T_2 V_57 ;
V_52 &= ~ ( V_58 | V_59 ) ;
V_55 = F_41 ( V_51 , V_22 , V_30 , V_52 , V_54 ) ;
if ( ! V_55 )
return V_55 ;
if ( V_51 && V_51 -> V_5 )
V_4 = F_1 ( V_51 , V_52 ) ;
...
if ( F_19 ( V_56 , V_44 ,
F_42 ( V_4 ) , V_30 ) != 0 ) {
F_43 ( V_51 , V_22 , V_55 , ( T_2 ) V_56 , V_54 ) ;
return NULL ;
}
}
memset ( V_55 , 0 , V_22 ) ;
...
void
F_44 ( struct V_1 * V_51 , T_4 V_22 , void * V_60 ,
...
F_11 ( V_56 , V_22 ) )
F_45 ( V_56 , V_44 ) ;
F_43 ( V_51 , V_22 , V_60 , ( T_2 ) V_56 , V_54 ) ;
}
T_2 F_46 ( struct V_1 * V_2 , struct V_61 * V_61 ,
unsigned long V_15 , T_4 V_22 ,
enum V_62 V_63 ,
struct V_53 * V_54 )
{
T_3 V_64 , V_56 = F_47 ( V_61 ) + V_15 ;
T_2 V_57 = F_3 ( V_56 ) ;
F_48 ( V_63 == V_65 ) ;
if ( F_49 ( V_2 , V_57 , V_22 ) &&
! F_11 ( V_56 , V_22 ) &&
! F_50 ( V_2 , F_5 ( V_56 ) , F_5 ( V_57 ) ) &&
! V_66 ) {
F_51 ( V_2 , V_61 , V_57 , V_15 , V_22 , V_63 , V_54 ) ;
return V_57 ;
}
F_52 ( V_2 , V_57 , V_22 , V_66 ) ;
V_64 = F_53 ( V_2 , V_50 , V_56 , V_22 , V_63 ) ;
if ( V_64 == V_67 )
return V_68 ;
F_51 ( V_2 , F_54 ( V_64 >> V_10 ) ,
V_57 , V_64 & ~ V_11 , V_22 , V_63 , V_54 ) ;
V_57 = F_3 ( V_64 ) ;
if ( ! F_49 ( V_2 , V_57 , V_22 ) ) {
F_55 ( V_2 , V_64 , V_22 , V_63 ) ;
V_57 = 0 ;
}
return V_57 ;
}
static void F_56 ( struct V_1 * V_51 , T_2 V_57 ,
T_4 V_22 , enum V_62 V_63 ,
struct V_53 * V_54 )
{
T_3 V_7 = F_6 ( V_57 ) ;
F_48 ( V_63 == V_65 ) ;
F_57 ( V_51 , V_57 , V_22 , V_63 , V_54 ) ;
if ( F_12 ( V_57 ) ) {
F_55 ( V_51 , V_7 , V_22 , V_63 ) ;
return;
}
if ( V_63 != V_69 )
return;
...
void F_60 ( struct V_1 * V_51 , T_2 V_57 ,
T_4 V_22 , enum V_62 V_63 ,
struct V_53 * V_54 )
{
F_56 ( V_51 , V_57 , V_22 , V_63 , V_54 ) ;
}
static void
F_61 ( struct V_1 * V_51 , T_2 V_57 ,
T_4 V_22 , enum V_62 V_63 ,
enum V_70 V_71 )
{
T_3 V_7 = F_6 ( V_57 ) ;
F_48 ( V_63 == V_65 ) ;
if ( V_71 == V_72 )
F_62 ( V_51 , V_57 , V_22 , V_63 ) ;
if ( F_12 ( V_57 ) )
F_63 ( V_51 , V_7 , V_22 , V_63 , V_71 ) ;
if ( V_71 == V_73 )
...
void
F_65 ( struct V_1 * V_51 , T_2 V_57 ,
T_4 V_22 , enum V_62 V_63 )
{
F_61 ( V_51 , V_57 , V_22 , V_63 , V_72 ) ;
}
void
F_66 ( struct V_1 * V_51 , T_2 V_57 ,
T_4 V_22 , enum V_62 V_63 )
{
F_61 ( V_51 , V_57 , V_22 , V_63 , V_73 ) ;
}
int
F_67 ( struct V_1 * V_51 , struct V_74 * V_75 ,
...
T_2 V_57 = F_3 ( V_7 ) ;
if ( V_66 ||
F_50 ( V_51 , F_5 ( V_7 ) , F_5 ( V_57 ) ) ||
! F_49 ( V_51 , V_57 , V_77 -> V_16 ) ||
F_11 ( V_7 , V_77 -> V_16 ) ) {
T_3 V_64 = F_53 ( V_51 ,
V_50 ,
F_69 ( V_77 ) ,
...
if ( V_64 == V_67 ) {
F_70 ( V_51 , L_12 ) ;
F_71 ( V_51 , V_75 , V_18 , V_63 ,
V_54 ) ;
F_72 ( V_75 ) = 0 ;
return 0 ;
}
F_51 ( V_51 , F_54 ( V_64 >> V_10 ) ,
V_57 ,
V_64 & ~ V_11 ,
V_77 -> V_16 ,
V_63 ,
...
void
F_71 ( struct V_1 * V_51 , struct V_74 * V_75 ,
int V_76 , enum V_62 V_63 ,
struct V_53 * V_54 )
{
struct V_74 * V_77 ;
...
F_48 ( V_63 == V_65 ) ;
F_68 (sgl, sg, nelems, i)
F_56 ( V_51 , V_77 -> V_78 , F_72 ( V_77 ) , V_63 , V_54 ) ;
}
static void
...
void
F_74 ( struct V_1 * V_51 , struct V_74 * V_77 ,
int V_76 , enum V_62 V_63 )
{
F_73 ( V_51 , V_77 , V_76 , V_63 , V_72 ) ;
}
void
F_75 ( struct V_1 * V_51 , struct V_74 * V_77 ,
int V_76 , enum V_62 V_63 )
{
F_73 ( V_51 , V_77 , V_76 , V_63 , V_73 ) ;
}
int
F_76 ( struct V_1 * V_51 , T_2 V_23 )
{
return ! V_23 ;
}
int
F_77 ( struct V_1 * V_51 , T_6 V_79 )
{
