...
static int T_7 F_61 ( struct V_1 * V_2 )
{
...
V_21 = F_68 ( V_250 , V_257 , V_60 , & V_258 ) ;
if ( V_21 ) {
F_12 ( V_2 -> V_24 , L_25 ,
V_257 , V_60 ) ;
goto V_168;
}
V_21 = F_68 ( V_250 , V_257 , V_60 + 1 , & V_259 ) ;
if ( V_21 ) {
F_12 ( V_2 -> V_24 , L_25 ,
V_257 , V_60 + 1 ) ;
goto V_168;
}
V_21 = F_68 ( V_250 , V_257 , V_60 + 2 , & V_51 ) ;
if ( V_21 ) {
F_12 ( V_2 -> V_24 , L_25 ,
V_257 , V_60 + 2 ) ;
goto V_168;
}
F_69 ( V_256 , V_258 , F_9 ( V_259 ) , V_51 << V_259 ) ;
}
V_168:
if ( ! F_63 ( V_252 ) )
F_70 ( V_252 ) ;
...
static bool F_74 ( struct V_142 * V_143 , void * V_272 )
{
struct V_6 * V_7 = F_32 ( V_143 ) ;
...
static struct V_142 * F_76 ( struct V_273 * V_274 ,
struct V_275 * V_276 )
{
struct V_1 * V_2 = V_276 -> V_277 ;
T_8 V_278 = V_2 -> V_279 . V_280 ;
struct V_177 V_64 ;
if ( V_274 -> V_281 != 3 )
return NULL ;
...
V_64 . V_184 = 0 ;
return F_77 ( V_278 , F_74 , & V_64 ) ;
}
static int F_78 ( struct V_282 * V_283 )
{
const struct V_284 * V_285 =
F_79 ( V_286 , & V_283 -> V_24 ) ;
...
struct V_288 * V_289 ;
struct V_288 V_290 ;
struct V_291 * V_292 = F_80 ( & V_283 -> V_24 ) ;
int V_60 ;
struct V_1 * V_2 ;
T_6 * V_230 ;
...
V_21 = F_81 ( & V_283 -> V_24 , F_82 ( 32 ) ) ;
if ( V_21 )
return V_21 ;
V_2 = F_83 ( & V_283 -> V_24 , sizeof( * V_2 ) , V_37 ) ;
if ( ! V_2 )
return - V_38 ;
F_84 ( & V_2 -> V_39 ) ;
V_2 -> V_24 = & V_283 -> V_24 ;
...
if ( V_66 < 0 )
return V_66 ;
V_289 = F_86 ( V_283 , V_296 , 0 ) ;
V_2 -> V_16 = F_87 ( & V_283 -> V_24 , V_289 ) ;
if ( F_63 ( V_2 -> V_16 ) )
return F_67 ( V_2 -> V_16 ) ;
V_2 -> V_185 = F_88 ( & V_283 -> V_24 , L_28 ) ;
if ( F_63 ( V_2 -> V_185 ) )
return F_67 ( V_2 -> V_185 ) ;
V_2 -> V_186 = F_88 ( & V_283 -> V_24 , L_29 ) ;
if ( F_63 ( V_2 -> V_186 ) )
return F_67 ( V_2 -> V_186 ) ;
F_89 ( V_2 -> V_185 ) ;
F_89 ( V_2 -> V_186 ) ;
V_21 = F_90 ( & V_283 -> V_24 , V_66 , F_26 , 0 , L_30 ,
V_2 ) ;
if ( V_21 )
return V_21 ;
V_2 -> V_81 = F_91 ( sizeof( * V_2 -> V_81 ) , V_37 ) ;
if ( ! V_2 -> V_81 )
return - V_38 ;
V_230 = ( T_6 * ) V_2 -> V_81 ;
for ( V_60 = 0 ; V_60 < V_232 ; V_60 ++ )
V_230 [ V_60 ] = - V_15 ;
F_92 ( V_297 , V_2 -> V_279 . V_280 ) ;
F_92 ( V_298 , V_2 -> V_279 . V_280 ) ;
F_93 ( & V_2 -> V_279 . V_299 ) ;
for ( V_60 = 0 ; V_60 < V_268 ; V_60 ++ ) {
...
F_57 ( V_2 , V_292 -> V_81 ) ;
if ( V_292 ) {
V_21 = F_71 ( V_2 , V_292 -> V_263 ) ;
if ( V_21 )
F_65 ( & V_283 -> V_24 , L_31 ) ;
} else {
V_21 = F_97 ( V_250 , L_32 ,
& V_263 ) ;
if ( V_21 )
F_65 ( & V_283 -> V_24 , L_33 ) ;
else {
V_21 = F_71 ( V_2 , V_263 ) ;
if ( V_21 )
F_65 ( & V_283 -> V_24 , L_34 ) ;
}
}
