...
return false ;
if ( V_170 . V_75 != V_414 -> V_384 . V_417 )
return false ;
V_415 = true ;
break;
case V_316 :
if ( V_20 != sizeof( V_418 ) )
return false ;
if ( V_170 . V_75 != V_414 -> V_384 . V_417 )
return false ;
V_415 = true ;
...
V_420 = ( T_29 * ) V_378 -> V_2 -> V_162 ;
V_383 = F_102 ( V_420 -> V_383 ) ;
V_20 = sizeof( T_29 ) ;
...
static T_1 F_159 ( struct V_3 * V_421 ,
V_373 * V_397 ,
int V_428 )
{
V_373 * V_429 ;
...
V_396 = V_431 ;
V_430 = F_20 ( V_421 -> V_150 -> V_20 ) -
sizeof( T_19 ) ;
V_20 = sizeof( T_29 ) ;
V_429 = ( V_373 * ) ( V_421 -> V_2 -> V_162 +
V_20 ) ;
V_430 -= V_20 ;
while ( V_430 > 0 ) {
if ( V_429 -> V_395 == V_397 -> V_395 ) {
switch ( V_429 -> V_74 . type ) {
case V_404 :
return V_403 ;
case V_405 :
V_20 = sizeof( V_373 ) ;
V_399 = ( void * ) V_429 + V_20 ;
V_430 -= V_20 ;
if ( V_430 > 0 )
return V_399 -> V_19 ;
else
...
V_20 = F_20 ( V_429 -> V_74 . V_20 ) ;
V_429 = ( void * ) V_429 + V_20 ;
V_430 -= V_20 ;
}
return V_396 ;
}
...
struct V_3 * V_421 )
{
struct V_3 * V_378 = V_6 -> V_432 ;
union V_354 * V_355 ;
V_373 * V_397 ;
int V_20 = 0 ;
int V_433 = V_378 -> V_2 -> V_18 ;
int V_419 = 0 ;
int V_428 = 1 ;
int V_35 = 0 ;
T_1 V_396 = V_403 ;
...
for ( V_297 = 0 ; V_297 < V_437 ; V_297 ++ ) {
V_442 . V_112 = V_439 [ V_297 ] . V_112 ;
V_442 . V_107 = V_439 [ V_297 ] . V_107 ;
F_9 ( V_35 , sizeof( V_442 ) , & V_442 ) ;
}
return V_35 ;
}
