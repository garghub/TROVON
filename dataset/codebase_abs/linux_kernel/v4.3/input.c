...
int F_173 ( struct V_23 * V_24 , void * V_15 ,
int (* F_174)( struct V_18 * , void * ) )
{
struct V_18 * V_19 ;
int V_97 = 0 ;
F_11 () ;
F_13 (handle, &handler->h_list, h_node) {
V_97 = F_174 ( V_19 , V_15 ) ;
if ( V_97 )
break;
}
F_14 () ;
...
return error ;
if ( V_24 -> V_27 )
F_176 ( & V_19 -> V_237 , & V_8 -> V_210 ) ;
else
F_177 ( & V_19 -> V_237 , & V_8 -> V_210 ) ;
F_38 ( & V_8 -> V_98 ) ;
F_177 ( & V_19 -> V_238 , & V_24 -> V_210 ) ;
if ( V_24 -> V_102 )
V_24 -> V_102 ( V_19 ) ;
return 0 ;
}
...
int F_180 ( int V_239 , unsigned int V_240 ,
bool V_241 )
{
if ( V_239 >= 0 ) {
int V_179 = F_181 ( & V_242 ,
V_239 ,
V_239 + V_240 ,
V_90 ) ;
if ( V_179 >= 0 || ! V_241 )
...
void F_182 ( unsigned int V_179 )
{
F_183 ( & V_242 , V_179 ) ;
}
static int T_3 F_184 ( void )
{
int V_245 ;
V_245 = F_185 ( & V_209 ) ;
if ( V_245 ) {
