...
if ( V_268 -> V_274 [ 0 ] != '\0' )
V_269 = V_268 -> V_274 ;
V_90 = F_166 ( sizeof( struct V_232 ) , V_269 ,
V_275 , F_163 ) ;
if ( ! V_90 ) {
F_167 ( L_36 ) ;
return - V_80 ;
...
static void F_171 ( struct V_110 * V_107 , int V_279 )
{
struct V_7 * V_8 = F_76 ( V_107 , struct V_7 , V_107 ) ;
...
static int F_172 ( struct V_280 * V_281 , struct V_94 * V_95 )
{
struct V_47 * V_48 ;
struct V_7 * V_8 ;
...
V_195 = F_173 ( & V_8 -> V_107 , V_281 , V_95 ) ;
if ( V_195 ) {
if ( V_284 )
F_83 ( V_8 ) ;
F_88 ( & V_48 -> V_151 ) ;
...
static int F_174 ( struct V_94 * V_95 , struct V_205 * V_291 )
{
...
F_64 ( V_8 ) ;
return F_175 ( V_107 , V_95 , V_291 ) ;
}
static void F_176 ( struct V_94 * V_95 , struct V_205 * V_291 )
{
struct V_7 * V_8 = V_95 -> V_290 ;
struct V_47 * V_48 ;
if ( V_8 == NULL )
...
F_88 ( & V_8 -> V_151 ) ;
V_48 = V_8 -> V_48 ;
if ( F_177 ( & V_8 -> V_107 , V_95 , V_291 ) == 0 )
return;
F_48 ( V_8 ) ;
if ( F_178 ( V_292 , & V_8 -> V_107 . V_71 ) ) {
if ( F_179 ( V_95 ) )
F_180 ( & V_8 -> V_107 ) ;
}
...
if ( V_8 -> V_145 == V_146 )
return - V_203 ;
V_293 = F_185 ( V_8 -> V_77 , V_117 , V_4 , & V_8 -> V_81 ) ;
F_36 ( V_8 ) ;
return V_293 ;
}
...
static void F_189 ( struct V_94 * V_95 , int V_295 )
{
}
...
static void F_193 ( struct V_94 * V_95 , struct V_301 * V_302 )
{
struct V_7 * V_8 = V_95 -> V_290 ;
if ( V_8 -> V_145 == V_146 )
return;
F_194 ( & V_95 -> V_104 , V_302 ) ;
}
