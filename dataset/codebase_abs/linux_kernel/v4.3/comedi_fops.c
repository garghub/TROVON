...
V_22 = F_36 ( V_32 ) ;
if ( V_22 && V_22 -> V_43 ) {
F_134 ( V_32 , & V_22 -> V_43 -> V_79 , V_273 ) ;
if ( ! V_22 -> V_47 || ! F_61 ( V_22 ) ||
...
V_22 = F_37 ( V_32 ) ;
if ( V_22 && V_22 -> V_43 ) {
unsigned int V_276 = F_136 ( V_22 ) ;
F_134 ( V_32 , & V_22 -> V_43 -> V_79 , V_273 ) ;
F_93 ( V_22 , V_22 -> V_43 -> V_53 ) ;
if ( ! V_22 -> V_47 || ! F_61 ( V_22 ) ||
! ( V_22 -> V_43 -> V_77 . V_68 & V_151 ) ||
F_137 ( V_22 ) >= V_276 )
V_67 |= V_277 | V_278 ;
...
if ( ! ( V_43 -> V_77 . V_68 & V_151 ) ) {
V_44 = - V_64 ;
goto V_196;
}
F_141 ( & V_43 -> V_79 , & V_273 ) ;
V_283 = true ;
while ( V_279 > 0 && ! V_44 ) {
unsigned V_66 ;
F_142 ( V_286 ) ;
...
V_155 = V_279 ;
V_281 = V_155 ;
if ( V_43 -> V_143 + V_281 > V_43 -> V_53 )
V_281 = V_43 -> V_53 - V_43 -> V_143 ;
F_93 ( V_22 , V_43 -> V_53 ) ;
if ( V_281 > F_137 ( V_22 ) )
V_281 = F_137 ( V_22 ) ;
if ( V_281 < V_155 )
...
V_281 = F_77 ( V_43 -> V_292 + V_43 -> V_143 ,
V_57 , V_155 ) ;
if ( V_281 ) {
V_155 -= V_281 ;
V_44 = - V_88 ;
...
static T_1 F_145 ( struct V_32 * V_32 , char T_3 * V_57 , T_2 V_279 ,
T_5 * V_280 )
{
struct V_21 * V_22 ;
struct V_42 * V_43 ;
...
V_155 = V_279 ;
V_281 = F_135 ( V_22 ) ;
if ( V_43 -> V_144 + V_281 > V_43 -> V_53 )
V_281 = V_43 -> V_53 - V_43 -> V_144 ;
if ( V_281 < V_155 )
V_155 = V_281 ;
if ( V_155 == 0 ) {
unsigned V_66 = F_58 ( V_22 ) ;
...
F_16 ( & V_2 -> V_5 ) ;
V_287 = F_36 ( V_32 ) ;
if ( V_2 -> V_12 && V_285 == V_2 -> V_40 &&
V_22 == V_287 && V_287 -> V_43 == V_43 ) {
if ( V_294 || F_92 ( V_22 ) == 0 )
F_68 ( V_2 , V_22 ) ;
}
F_19 ( & V_2 -> V_5 ) ;
}
...
static int F_146 ( struct V_295 * V_295 , struct V_32 * V_32 )
{
const unsigned V_7 = F_32 ( V_295 ) ;
struct V_33 * V_34 ;
...
static int F_149 ( int V_297 , struct V_32 * V_32 , int V_298 )
{
struct V_33 * V_34 = V_32 -> V_35 ;
struct V_1 * V_2 = V_34 -> V_2 ;
return F_150 ( V_297 , V_32 , V_298 , & V_2 -> V_299 ) ;
}
static int F_151 ( struct V_295 * V_295 , struct V_32 * V_32 )
{
struct V_33 * V_34 = V_32 -> V_35 ;
struct V_1 * V_2 = V_34 -> V_2 ;
...
void F_152 ( struct V_1 * V_2 , struct V_21 * V_22 )
{
struct V_42 * V_43 = V_22 -> V_43 ;
unsigned int V_301 ;
int V_302 = 0 ;
...
if ( V_43 -> V_224 & V_301 ) {
F_153 ( & V_43 -> V_79 ) ;
V_302 = V_43 -> V_77 . V_68 & V_151 ? V_304 : V_305 ;
}
F_56 ( & V_22 -> V_69 , V_68 ) ;
if ( V_302 )
F_154 ( & V_2 -> V_299 , V_306 , V_302 ) ;
}
struct V_1 * F_155 ( struct V_26 * V_307 )
{
struct V_1 * V_2 ;
struct V_26 * V_54 ;
unsigned V_15 ;
...
V_2 -> V_7 = V_15 ;
V_54 = F_158 ( V_19 , V_307 ,
F_24 ( V_20 , V_15 ) , NULL , L_40 , V_15 ) ;
if ( ! F_110 ( V_54 ) )
V_2 -> V_9 = F_159 ( V_54 ) ;
return V_2 ;
}
void F_160 ( struct V_26 * V_307 )
{
int V_7 ;
struct V_1 * V_2 ;
...
V_44 = F_167 ( F_24 ( V_20 , 0 ) ,
V_310 , L_46 ) ;
if ( V_44 )
return - V_198 ;
F_168 ( & V_312 , & V_313 ) ;
V_312 . V_314 = V_315 ;
V_44 = F_169 ( & V_312 . V_316 , L_46 ) ;
if ( V_44 ) {
F_170 ( F_24 ( V_20 , 0 ) ,
V_310 ) ;
return V_44 ;
}
if ( F_171 ( & V_312 , F_24 ( V_20 , 0 ) , V_310 ) ) {
F_170 ( F_24 ( V_20 , 0 ) ,
V_310 ) ;
return - V_198 ;
}
V_19 = F_172 ( V_315 , L_46 ) ;
if ( F_110 ( V_19 ) ) {
F_166 ( L_47 ) ;
F_173 ( & V_312 ) ;
F_170 ( F_24 ( V_20 , 0 ) ,
