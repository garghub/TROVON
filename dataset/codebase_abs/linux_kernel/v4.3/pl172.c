...
static int F_19 ( struct V_1 * V_2 , const struct V_38 * V_39 )
{
...
F_23 ( V_15 , L_24 , F_20 ( V_2 ) , V_43 ) ;
V_10 = F_24 ( V_15 , sizeof( * V_10 ) , V_45 ) ;
if ( ! V_10 )
return - V_46 ;
V_10 -> V_47 = F_25 ( V_15 , L_25 ) ;
if ( F_26 ( V_10 -> V_47 ) ) {
F_5 ( V_15 , L_26 ) ;
...
V_10 -> V_17 = F_31 ( V_15 , V_2 -> V_50 . V_8 ,
F_32 ( & V_2 -> V_50 ) ) ;
if ( ! V_10 -> V_17 ) {
F_5 ( V_15 , L_30 ) ;
V_20 = - V_46 ;
