...
F_5 ( V_2 ) ;
F_6 ( V_2 -> V_12 , V_8 + V_13 , 4 , & V_3 ) ;
V_3 &= ~ V_14 ;
F_7 ( V_2 -> V_12 , V_8 + V_13 , 4 , V_3 ) ;
F_7 ( V_2 -> V_12 , V_15 , 2 , 0x104A ) ;
F_7 ( V_2 -> V_12 , V_16 , 2 , 0xCD80 ) ;
if ( V_4 -> V_17 ) {
F_6 ( V_2 -> V_12 , V_8 + V_18 , 4 ,
& V_3 ) ;
if ( ( V_3 & V_19 ) != V_20 ) {
V_3 &= ~ ( ( T_1 ) V_19 ) ;
V_3 |= V_20 ;
...
struct V_51 * V_12 ;
int V_42 ;
V_4 = F_25 ( V_11 , sizeof( * V_4 ) , V_52 ) ;
if ( ! V_4 )
return - V_53 ;
V_4 -> V_54 = F_26 ( V_11 , L_8 ) ;
if ( F_27 ( V_4 -> V_54 ) ) {
V_42 = F_28 ( V_4 -> V_54 ) ;
if ( V_42 == - V_55 )
F_9 ( V_11 , L_9 ) ;
