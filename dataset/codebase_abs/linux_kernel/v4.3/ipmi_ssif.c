...
F_87 ( & V_1 -> V_181 [ V_75 ] , 0 ) ;
if ( V_1 -> V_166 )
V_1 -> V_40 -> V_2 |= V_182 ;
V_1 -> V_183 . V_184 = V_185 ;
V_1 -> V_183 . V_186 = F_52 ;
V_1 -> V_183 . F_43 = F_43 ;
V_1 -> V_183 . F_40 = F_40 ;
V_1 -> V_183 . F_45 = F_45 ;
V_1 -> V_183 . F_46 = F_46 ;
...
static int F_94 ( struct V_150 * V_191 , void * V_192 )
{
struct V_144 * V_115 = V_192 ;
if ( V_191 -> type != & V_193 )
return 0 ;
F_95 ( F_96 ( V_191 ) , & V_115 -> V_149 ) ;
if ( ! V_115 -> V_146 )
return 1 ;
return 0 ;
}
...
V_115 -> V_149 . V_198 = V_115 ;
V_115 -> V_158 = V_158 ;
V_115 -> V_155 = V_155 ;
V_115 -> V_112 = V_112 ;
F_100 ( & V_115 -> V_199 , & V_200 ) ;
if ( V_201 )
F_101 ( V_115 , F_94 ) ;
V_197:
F_102 ( & V_195 ) ;
...
{
struct V_144 * V_129 ;
unsigned int V_203 = 0 , V_75 ;
unsigned short * V_204 ;
F_75 (info, &ssif_infos, link)
V_203 ++ ;
V_204 = F_80 ( sizeof( * V_204 ) * ( V_203 + 1 ) , V_130 ) ;
if ( ! V_204 )
return NULL ;
V_75 = 0 ;
F_75 (info, &ssif_infos, link) {
...
int V_205 ;
for ( V_205 = 0 ; V_205 < V_75 ; V_205 ++ ) {
if ( V_204 [ V_205 ] == V_145 )
goto V_206;
}
V_204 [ V_75 ] = V_145 ;
V_206:
...
static int F_107 ( struct V_208 * V_209 )
{
unsigned short V_210 ;
if ( V_211 >= V_212 )
return - 1 ;
if ( V_209 -> V_213 != 1 ) {
F_35 ( L_48 , V_209 -> V_213 ) ;
return - V_119 ;
}
if ( V_209 -> V_214 != 4 )
return - V_119 ;
if ( V_209 -> V_145 . V_215 != V_216 ) {
F_35 ( V_8 L_49 ,
V_209 -> V_145 . V_215 ) ;
return - V_59 ;
}
V_210 = V_209 -> V_145 . V_217 >> 1 ;
return F_97 ( V_210 , NULL , 0 , 0 , V_218 ) ;
}
...
static void F_108 ( void ) { }
static int F_110 ( const struct V_225 * V_226 )
{
struct V_227 * V_228 = V_226 -> V_229 ;
T_4 * V_11 = ( T_4 * ) V_228 ;
T_4 V_67 = V_228 -> V_230 ;
unsigned short V_210 ;
int V_155 ;
if ( V_211 >= V_212 )
return - 1 ;
...
return F_97 ( V_210 , NULL , 0 , 0 , V_231 ) ;
}
static void F_111 ( void )
{
const struct V_225 * V_114 = NULL ;
while ( ( V_114 = F_112 ( V_232 , NULL , V_114 ) ) )
F_110 ( V_114 ) ;
}
static void F_111 ( void ) { }
...
return 0 ;
F_29 ( L_50 ) ;
for ( V_75 = 0 ; V_75 < V_211 ; V_75 ++ ) {
V_49 = F_97 ( V_145 [ V_75 ] , V_146 [ V_75 ] ,
V_233 [ V_75 ] , V_234 [ V_75 ] ,
V_235 ) ;
if ( V_49 )
F_8 ( V_8
L_51 ,
