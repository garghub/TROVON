...
struct V_1 * F_55 ( struct V_92 * V_93 )
{
struct V_1 * V_6 ;
F_44 ( & V_90 ) ;
...
int F_57 ( struct V_1 * V_6 , struct V_95 * V_58 )
{
unsigned long V_17 ;
int V_72 ;
V_58 -> V_59 . V_96 = V_97 ;
...
int F_70 ( struct V_1 * V_6 , T_2 V_105 )
{
int V_72 ;
V_72 = F_71 ( & V_6 -> V_3 , V_106 ,
V_105 ) ;
if ( V_72 < 0 )
return V_72 ;
return 0 ;
}
int F_72 ( struct V_1 * V_6 , struct V_107 * V_108 ,
T_2 V_109 )
{
...
V_119 |
V_120 ;
V_72 = F_73 ( & V_6 -> V_3 , V_121 , V_113 ,
V_108 -> V_116 ) ;
if ( V_72 < 0 )
return V_72 ;
F_62 ( 500 , 1000 ) ;
V_72 = F_74 ( & V_6 -> V_3 , V_18 ) ;
if ( V_72 < 0 )
return V_72 ;
switch ( V_110 ) {
case V_122 :
...
break;
default:
F_33 ( V_6 -> V_60 , L_13 , V_110 ) ;
return - V_20 ;
}
V_72 = F_71 ( & V_6 -> V_3 , V_125 , 0 ) ;
if ( V_72 < 0 )
return V_72 ;
return 0 ;
}
