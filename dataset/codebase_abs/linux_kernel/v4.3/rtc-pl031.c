...
static int F_30 ( struct V_60 * V_61 , const struct V_62 * V_63 )
{
int V_41 ;
struct V_4 * V_5 ;
...
if ( V_41 )
goto V_69;
V_5 = F_32 ( sizeof( struct V_4 ) , V_70 ) ;
if ( ! V_5 ) {
V_41 = - V_71 ;
goto V_72;
}
V_5 -> V_65 = V_65 ;
V_5 -> V_8 = F_33 ( V_61 -> V_73 . V_74 , F_34 ( & V_61 -> V_73 ) ) ;
if ( ! V_5 -> V_8 ) {
V_41 = - V_71 ;
goto V_75;
}
...
F_39 ( & V_61 -> V_2 , 1 ) ;
V_5 -> V_57 = F_40 ( L_4 , & V_61 -> V_2 , V_68 ,
V_81 ) ;
if ( F_41 ( V_5 -> V_57 ) ) {
V_41 = F_42 ( V_5 -> V_57 ) ;
goto V_82;
}
if ( F_43 ( V_61 -> V_50 [ 0 ] , F_18 ,
V_65 -> V_83 , L_5 , V_5 ) ) {
V_41 = - V_84 ;
goto V_85;
}
