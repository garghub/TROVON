...
return NULL ;
V_15 -> V_39 = V_37 ;
V_24 = F_29 ( V_20 , V_15 , F_28 , V_38 ) ;
F_30 ( & V_15 -> V_20 ) ;
return V_24 ? NULL : V_15 ;
}
struct V_14 * F_31 ( struct V_36 * V_20 ,
...
if ( ! V_15 )
return NULL ;
V_24 = F_32 ( V_20 , V_15 , V_37 , V_38 ) ;
F_30 ( & V_15 -> V_20 ) ;
return V_24 ? NULL : V_15 ;
}
bool F_33 ( struct V_1 * V_23 )
{
struct V_1 * V_40 ;
int V_41 , V_42 ;
const char * V_43 ;
...
V_42 = F_35 ( V_23 , L_11 , & V_43 ) ;
if ( V_42 == 0 && strcmp ( V_43 , L_12 ) != 0 )
return true ;
...
V_42 = F_35 ( V_23 , L_11 , & V_43 ) ;
if ( V_42 == 0 ) {
if ( strcmp ( V_43 , L_13 ) == 0 ) {
V_15 = F_37 ( V_31 , & V_45 , - 1 , V_23 ) ;
return F_7 ( V_15 ) ? F_38 ( V_15 ) : 0 ;
}
}
V_46 = F_34 ( V_23 , L_10 ) ;
if ( V_46 ) {
...
V_45 . V_50 = F_9 ( V_46 ,
L_14 ) ;
if ( F_16 ( V_46 , L_15 , & V_45 . V_51 ) )
return - V_9 ;
V_45 . V_52 = F_9 ( V_46 , L_16 ) ;
V_45 . V_53 = F_9 ( V_46 ,
L_17 ) ;
V_48 = F_39 ( V_46 ,
L_18 , 0 , NULL ) ;
...
if ( V_48 == - V_54 )
return - V_54 ;
V_15 = F_37 ( V_31 , & V_45 , V_48 , V_23 ) ;
return F_7 ( V_15 ) ? F_38 ( V_15 ) : 0 ;
}
V_47 = F_21 ( V_23 , L_10 , & V_41 ) ;
if ( V_47 && V_41 == ( 5 * sizeof( T_2 ) ) ) {
V_45 . V_49 = 1 ;
V_45 . V_50 = F_40 ( V_47 [ 1 ] ) ;
V_45 . V_51 = F_40 ( V_47 [ 2 ] ) ;
V_45 . V_52 = F_40 ( V_47 [ 3 ] ) ;
V_45 . V_53 = F_40 ( V_47 [ 4 ] ) ;
V_15 = F_37 ( V_31 , & V_45 , - 1 , V_23 ) ;
return F_7 ( V_15 ) ? F_38 ( V_15 ) : 0 ;
}
return - V_55 ;
