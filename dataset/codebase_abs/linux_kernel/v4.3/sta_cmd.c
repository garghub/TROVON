...
struct V_378 * V_379 =
& V_4 -> V_11 . V_379 ;
struct V_380 * V_381 = V_79 ;
struct V_382 * V_228 ;
T_1 V_383 , V_384 , V_60 ;
struct V_385 * V_386 ;
V_4 -> V_6 = F_2 ( V_387 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
V_379 -> V_13 = F_2 ( V_5 ) ;
V_379 -> V_388 = F_2 ( V_381 -> V_388 ) ;
V_386 = V_379 -> V_386 ;
for ( V_383 = 0 ; V_383 < V_381 -> V_388 ; V_383 ++ ) {
V_386 -> V_231 . type = F_2 ( V_389 ) ;
V_386 -> V_390 =
F_2 ( V_381 -> V_386 [ V_383 ] . V_390 ) ;
V_386 -> V_391 = V_381 -> V_386 [ V_383 ] . V_391 ;
V_386 -> V_392 = V_381 -> V_386 [ V_383 ] . V_392 ;
V_60 = 0 ;
V_228 = V_386 -> V_11 ;
for ( V_384 = 0 ; V_384 < V_381 -> V_386 [ V_383 ] . V_392 ; V_384 ++ ) {
V_228 -> V_393 = V_381 -> V_386 [ V_383 ] . V_11 [ V_384 ] . V_393 ;
V_228 -> V_394 =
V_381 -> V_386 [ V_383 ] . V_11 [ V_384 ] . V_394 ;
V_228 -> V_264 =
F_2 ( V_381 -> V_386 [ V_383 ] . V_11 [ V_384 ] . V_264 ) ;
memcpy ( V_228 -> V_395 ,
V_381 -> V_386 [ V_383 ] . V_11 [ V_384 ] . V_395 ,
V_228 -> V_394 ) ;
V_60 += sizeof( struct V_382 ) ;
V_228 ++ ;
}
V_386 -> V_231 . V_168 = F_2 ( V_60 + sizeof( T_1 ) +
sizeof( V_58 ) + sizeof( V_58 ) ) ;
F_6 ( & V_4 -> V_8 , F_7 ( V_386 -> V_231 . V_168 ) +
sizeof( struct V_61 ) ) ;
V_386 = ( void * ) ( ( V_58 * ) V_386 -> V_11 + V_60 ) ;
}
...
T_1 V_5 , void * V_79 )
{
struct V_396 * V_397 = & V_4 -> V_11 . V_397 ;
struct V_398 * V_399 ;
struct V_400 * V_401 ;
T_1 V_168 ;
V_4 -> V_6 = F_2 ( V_402 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
V_397 -> V_403 = F_2 ( V_5 ) ;
F_6 ( & V_4 -> V_8 , sizeof( V_397 -> V_403 ) ) ;
switch ( V_5 ) {
case V_404 :
V_401 = V_79 ;
V_168 = sizeof( * V_401 ) ;
memcpy ( V_397 -> V_405 , V_401 , V_168 ) ;
break;
case V_406 :
V_399 = V_79 ;
V_168 = sizeof( * V_399 ) ;
memcpy ( V_397 -> V_405 , V_399 , V_168 ) ;
break;
case V_407 :
V_168 = sizeof( struct V_408 ) ;
memcpy ( V_397 -> V_405 , V_79 , V_168 ) ;
break;
case V_409 :
V_168 = sizeof( struct V_410 ) ;
memcpy ( V_397 -> V_405 , V_79 , V_168 ) ;
break;
default:
F_4 ( V_2 -> V_29 , ERROR ,
...
void * V_79 )
{
struct V_412 * V_413 = & V_4 -> V_11 . V_413 ;
struct V_414 * V_415 = V_79 ;
struct V_416 * V_417 ;
struct V_418 * V_419 ;
struct V_420 * V_421 ;
struct V_422 * V_423 ;
...
V_58 * V_315 , V_432 ;
T_1 V_433 = 0 ;
struct V_434 * V_11 = V_2 -> V_435 ;
V_4 -> V_6 = F_2 ( V_436 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
F_6 ( & V_4 -> V_8 , sizeof( struct V_412 ) ) ;
V_413 -> V_437 = 0 ;
memcpy ( V_413 -> V_438 , V_415 -> V_438 , V_126 ) ;
V_417 = F_49 ( V_2 , V_415 -> V_438 ) ;
V_315 = ( V_58 * ) V_413 + sizeof( struct V_412 ) ;
switch ( V_415 -> V_403 ) {
case V_439 :
V_413 -> V_403 = F_2 ( V_440 ) ;
break;
case V_441 :
V_413 -> V_403 = F_2 ( V_442 ) ;
break;
case V_443 :
V_413 -> V_403 = F_2 ( V_444 ) ;
if ( ! V_11 ) {
F_4 ( V_2 -> V_29 , ERROR ,
L_32 ,
V_415 -> V_438 ) ;
...
* ( V_43 * ) V_315 = F_2 ( V_11 -> V_446 ) ;
V_433 += sizeof( V_11 -> V_446 ) ;
V_432 = V_11 -> V_447 | ( V_11 -> V_448 << 5 ) ;
V_423 = (struct V_422 * ) ( V_315 +
V_433 ) ;
V_423 -> V_231 . type = F_2 ( V_449 ) ;
V_423 -> V_231 . V_168 = F_2 ( sizeof( V_432 ) ) ;
V_423 -> V_432 = V_432 ;
V_433 += sizeof( struct V_422 ) ;
if ( V_11 -> V_450 ) {
V_421 = (struct V_420 * ) ( V_315 +
V_433 ) ;
V_421 -> V_231 . type =
F_2 ( V_451 ) ;
V_421 -> V_231 . V_168 =
F_2 ( sizeof( struct V_452 ) ) ;
memcpy ( & V_421 -> V_453 , V_11 -> V_450 ,
sizeof( struct V_452 ) ) ;
V_433 += sizeof( struct V_420 ) ;
}
if ( V_11 -> V_454 && V_11 -> V_455 ) {
V_419 = (struct V_418 * ) ( V_315 +
V_433 ) ;
V_419 -> V_231 . type =
F_2 ( V_456 ) ;
V_419 -> V_231 . V_168 =
F_2 ( V_11 -> V_455 ) ;
memcpy ( V_419 -> V_457 , V_11 -> V_454 ,
V_11 -> V_455 ) ;
V_433 += sizeof( struct V_418 ) +
V_11 -> V_455 ;
}
if ( V_11 -> V_458 && V_11 -> V_459 ) {
V_425 = (struct V_424 * ) ( V_315 +
V_433 ) ;
V_425 -> V_231 . type =
F_2 ( V_460 ) ;
V_425 -> V_231 . V_168 = F_2 ( V_11 -> V_459 ) ;
memcpy ( V_425 -> V_458 , V_11 -> V_458 ,
V_11 -> V_459 ) ;
V_433 += sizeof( struct V_424 ) +
V_11 -> V_459 ;
}
if ( V_11 -> V_461 ) {
V_427 = (struct V_426 * ) ( V_315 +
V_433 ) ;
V_427 -> V_231 . type =
F_2 ( V_462 ) ;
V_427 -> V_231 . V_168 =
F_2 ( sizeof( struct V_463 ) ) ;
memcpy ( & V_427 -> V_464 , V_11 -> V_461 ,
sizeof( struct V_463 ) ) ;
V_433 += sizeof( struct V_426 ) ;
}
if ( V_11 -> V_429 ) {
V_429 = (struct V_428 * ) ( V_315 + V_433 ) ;
V_429 -> V_231 . type = F_2 ( V_465 ) ;
V_429 -> V_231 . V_168 = F_2 ( sizeof( V_11 -> V_429 ) ) ;
V_429 -> V_429 = F_2 ( V_11 -> V_429 ) ;
V_433 += sizeof( struct V_428 ) ;
}
V_431 = ( void * ) ( V_315 + V_433 ) ;
V_431 -> V_231 . type = F_2 ( V_466 ) ;
V_431 -> V_231 . V_168 = F_2 ( sizeof( V_431 -> V_44 ) ) ;
V_431 -> V_44 = F_2 ( V_467 ) ;
V_433 += sizeof( struct V_430 ) ;
break;
default:
...
V_4 -> V_6 = F_2 ( V_470 ) ;
V_4 -> V_8 =
F_2 ( sizeof( struct V_468 ) +
V_10 ) ;
V_381 -> V_13 = V_5 ;
if ( V_5 == V_28 )
V_381 -> V_246 = * ( V_58 * ) V_79 ;
return 0 ;
}
int F_51 ( struct V_1 * V_2 , T_4 V_471 ,
T_1 V_5 , T_2 V_31 ,
void * V_79 , void * V_472 )
{
struct V_3 * V_473 = V_472 ;
int V_223 = 0 ;
switch ( V_471 ) {
case V_474 :
V_223 = F_52 ( V_2 , V_473 ) ;
break;
case V_368 :
V_223 = F_43 ( V_2 , V_473 , V_79 ) ;
break;
case V_30 :
V_223 = F_3 ( V_2 , V_473 , V_5 ,
V_79 ) ;
break;
case V_121 :
V_223 = F_16 ( V_2 , V_473 ,
V_5 ) ;
break;
case V_132 :
V_223 = F_17 ( V_473 , V_5 ,
V_79 ) ;
break;
case V_56 :
V_223 = F_9 ( V_2 , V_473 , V_5 ,
V_79 ) ;
break;
case V_77 :
V_223 = F_11 ( V_473 , V_5 ,
V_79 ) ;
break;
case V_81 :
V_223 = F_12 ( V_2 , V_473 , V_5 ,
V_79 ) ;
break;
case V_88 :
V_223 = F_13 ( V_2 , V_473 , V_5 ,
V_79 ) ;
break;
case V_475 :
V_223 = F_53 ( V_2 , V_473 , V_5 ,
( T_4 ) V_31 , V_79 ) ;
break;
case V_108 :
V_223 = F_14 ( V_2 , V_473 , V_5 ,
(struct V_101 * ) V_79 ) ;
break;
case V_476 :
V_223 = F_54 ( V_473 , V_79 ) ;
break;
case V_477 :
V_223 = F_55 ( V_473 ) ;
break;
case V_478 :
V_223 = F_56 ( V_2 , V_473 , V_79 ) ;
break;
case V_139 :
V_223 = F_18 ( V_2 , V_473 ,
V_79 ) ;
break;
case V_479 :
V_223 = F_57 ( V_2 , V_473 ,
V_79 ) ;
break;
case V_45 :
V_223 = F_8 ( V_473 ) ;
...
break;
case V_7 :
V_223 = F_1 ( V_2 , V_473 , V_5 ) ;
break;
case V_37 :
V_223 = F_5 ( V_2 , V_473 , V_5 ,
V_31 , V_79 ) ;
break;
case V_481 :
V_473 -> V_6 =
...
case V_484 :
V_473 -> V_6 = F_2 ( V_471 ) ;
V_473 -> V_11 . V_485 . V_486 =
( V_58 ) ( * ( ( T_2 * ) V_79 ) ) ;
memcpy ( & V_473 -> V_11 , V_79 ,
sizeof( struct V_487 ) ) ;
V_473 -> V_8 =
...
case V_488 :
V_473 -> V_6 = F_2 ( V_471 ) ;
V_473 -> V_11 . V_489 . V_13 = F_2 ( V_5 ) ;
V_473 -> V_11 . V_489 . V_490 = F_15 ( * ( T_2 * ) V_79 ) ;
V_473 -> V_8 =
F_2 ( sizeof( struct V_491 ) +
V_10 ) ;
V_223 = 0 ;
break;
case V_492 :
...
break;
case V_494 :
V_223 = F_59 ( V_2 , V_473 , V_5 , V_79 ) ;
break;
case V_495 :
V_473 -> V_6 = F_2 ( V_471 ) ;
V_473 -> V_11 . V_496 . V_13 = F_2 ( V_5 ) ;
V_473 -> V_11 . V_496 . V_78 = F_2 ( * ( T_1 * ) V_79 ) ;
V_473 -> V_8 =
F_2 ( sizeof( struct V_497 ) +
V_10 ) ;
break;
case V_498 :
if ( V_2 -> V_29 -> V_499 == V_500 )
V_2 -> V_29 -> V_499 = V_501 ;
V_473 -> V_6 = F_2 ( V_471 ) ;
V_473 -> V_8 = F_2 ( V_10 ) ;
break;
case V_502 :
V_2 -> V_29 -> V_499 = V_500 ;
V_473 -> V_6 = F_2 ( V_471 ) ;
V_473 -> V_8 = F_2 ( V_10 ) ;
break;
case V_503 :
V_223 = F_60 ( V_473 , V_79 ) ;
break;
case V_504 :
V_223 = F_61 ( V_473 , V_79 ) ;
break;
case V_505 :
V_223 = F_62 ( V_2 , V_473 , V_79 ) ;
break;
case V_187 :
V_223 = F_27 ( V_2 , V_473 ,
V_5 , V_31 ,
V_79 ) ;
break;
case V_241 :
V_223 = F_28 ( V_2 , V_473 ,
V_5 ) ;
break;
case V_506 :
V_223 = F_63 ( V_2 , V_473 , V_5 ,
V_79 ) ;
break;
case V_507 :
V_223 = F_64 ( V_473 , V_5 ,
V_79 ) ;
break;
case V_508 :
V_223 = F_65 ( V_2 , V_473 , V_5 , V_79 ) ;
break;
case V_509 :
F_4 ( V_2 -> V_29 , V_36 ,
L_34 ) ;
...
break;
case V_250 :
V_223 = F_29 ( V_473 , V_5 ,
V_79 ) ;
break;
case V_511 :
V_223 = F_66 ( V_2 , V_473 , V_79 ) ;
break;
case V_257 :
V_223 = F_30 ( V_473 , V_5 , V_79 ) ;
break;
case V_261 :
case V_265 :
case V_268 :
...
case V_274 :
case V_276 :
V_223 = F_31 ( V_473 , V_5 , V_79 ) ;
break;
case V_512 :
V_473 -> V_6 = F_2 ( V_471 ) ;
if ( V_2 -> V_210 == V_211 )
V_473 -> V_11 . V_210 . V_513 =
V_514 ;
else if ( V_2 -> V_210 == V_515 ||
V_2 -> V_210 == V_516 )
V_473 -> V_11 . V_210 . V_513 =
V_517 ;
else if ( V_2 -> V_210 == V_518 ||
V_2 -> V_210 == V_519 )
V_473 -> V_11 . V_210 . V_513 = V_520 ;
V_473 -> V_8 = F_2 ( sizeof( struct
V_521 ) + V_10 ) ;
V_223 = 0 ;
break;
case V_288 :
V_223 = F_33 ( V_2 , V_473 , V_5 ) ;
break;
case V_316 :
V_223 = F_34 ( V_2 , V_473 , V_79 ) ;
break;
case V_352 :
V_223 = F_36 ( V_2 , V_473 , V_79 ) ;
break;
case V_387 :
V_223 = F_46 ( V_2 , V_473 , V_5 ,
V_79 ) ;
break;
case V_436 :
V_223 = F_48 ( V_2 , V_473 , V_79 ) ;
break;
case V_402 :
V_223 = F_47 ( V_2 , V_473 , V_5 ,
V_79 ) ;
break;
case V_522 :
V_223 = F_67 ( V_2 , V_473 ,
V_79 ) ;
break;
case V_470 :
V_223 = F_50 ( V_473 , V_5 ,
V_79 ) ;
break;
case V_377 :
V_223 = F_45 ( V_2 , V_473 , V_5 ,
V_79 ) ;
break;
default:
F_4 ( V_2 -> V_29 , ERROR ,
...
int F_68 ( struct V_1 * V_2 , V_58 V_523 , bool V_524 )
{
struct V_103 * V_29 = V_2 -> V_29 ;
int V_223 ;
T_1 V_246 = true ;
...
V_223 = F_42 ( V_2 , V_474 ,
V_39 , 0 , NULL , true ) ;
if ( V_223 )
return - 1 ;
if ( V_2 -> V_29 -> V_534 == V_536 &&
F_70 ( V_2 -> V_29 -> V_537 ) ) {
V_533 = true ;
V_223 = F_42 ( V_2 ,
V_470 ,
...
return - 1 ;
if ( ! V_551 &&
V_523 && V_2 -> V_29 -> V_534 != V_552 &&
V_2 -> V_540 != V_541 ) {
V_528 . V_528 = V_553 ;
V_528 . V_554 = V_555 ;
V_223 = F_42 ( V_2 , V_475 ,
V_544 , V_556 ,
& V_528 , true ) ;
if ( V_223 )
return - 1 ;
...
V_532 . V_559 = V_560 ;
V_223 = F_42 ( V_2 , V_508 ,
V_28 , 0 , & V_532 , true ) ;
if ( V_524 ) {
V_2 -> V_29 -> V_561 = V_508 ;
V_223 = - V_562 ;
}
return V_223 ;
}
