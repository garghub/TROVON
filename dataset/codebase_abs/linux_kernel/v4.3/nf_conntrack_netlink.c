...
static int
F_180 ( struct V_1 * V_2 , struct V_28 * V_29 )
{
const struct V_23 * V_24 ;
struct V_8 * V_9 ;
F_8 () ;
...
static int
F_181 ( const struct V_8 * V_167 [] , struct V_28 * V_29 )
{
int V_142 ;
if ( V_167 [ V_36 ] ) {
V_142 = F_148 ( V_29 , V_167 ) ;
...
static int
F_182 ( const struct V_8 * V_53 , struct V_28 * V_29 )
{
struct V_8 * V_167 [ V_300 + 1 ] ;
int V_7 ;
V_7 = F_101 ( V_167 , V_300 , V_53 , V_301 ) ;
if ( V_7 < 0 )
return V_7 ;
F_129 ( & V_244 ) ;
V_7 = F_181 ( ( const struct V_8 * * ) V_167 , V_29 ) ;
F_131 ( & V_244 ) ;
return V_7 ;
}
static int F_183 ( const struct V_8 * const * V_167 ,
const struct V_28 * V_29 ,
struct V_3 * V_4 ,
struct V_3 * V_172 )
{
int V_142 ;
V_142 = F_110 ( V_167 , V_4 , V_302 ,
F_20 ( V_29 ) , NULL ) ;
if ( V_142 < 0 )
return V_142 ;
return F_110 ( V_167 , V_172 , V_303 ,
F_20 ( V_29 ) , NULL ) ;
}
static int
F_184 ( const struct V_8 * V_53 , struct V_28 * V_29 ,
T_2 V_107 , T_2 V_152 )
{
...
struct V_305 * exp ;
int V_142 ;
V_142 = F_101 ( V_167 , V_304 , V_53 , V_306 ) ;
if ( V_142 < 0 )
return V_142 ;
V_142 = F_183 ( ( const struct V_8 * const * ) V_167 ,
V_29 , & V_4 , & V_172 ) ;
if ( V_142 < 0 )
return V_142 ;
if ( V_167 [ V_307 ] ) {
const char * V_242 = F_112 ( V_167 [ V_307 ] ) ;
V_44 = F_147 ( V_242 , F_20 ( V_29 ) ,
F_21 ( V_29 ) ) ;
if ( V_44 == NULL )
return - V_174 ;
}
exp = F_185 ( ( const struct V_8 * const * ) V_167 , V_29 ,
V_44 , & V_4 , & V_172 ) ;
if ( F_114 ( exp ) )
return F_115 ( exp ) ;
V_142 = F_186 ( exp , V_107 , V_152 ) ;
if ( V_142 < 0 ) {
F_187 ( exp ) ;
return V_142 ;
}
...
struct V_3 V_310 ;
struct V_8 * V_9 ;
memset ( & V_310 , 0xFF , sizeof( V_310 ) ) ;
memcpy ( & V_310 . V_20 . V_205 , & V_172 -> V_20 . V_205 , sizeof( V_310 . V_20 . V_205 ) ) ;
V_310 . V_20 . V_311 . V_312 = V_172 -> V_20 . V_311 . V_312 ;
V_310 . V_14 . V_15 = V_4 -> V_14 . V_15 ;
V_9 = F_2 ( V_2 , V_303 | V_11 ) ;
if ( ! V_9 )
goto V_12;
F_8 () ;
V_18 = F_9 ( V_4 -> V_20 . V_21 ) ;
V_7 = F_6 ( V_2 , & V_310 , V_18 ) ;
if ( V_7 >= 0 ) {
V_6 = F_10 ( V_4 -> V_20 . V_21 ,
V_4 -> V_14 . V_15 ) ;
V_7 = F_1 ( V_2 , & V_310 , V_6 ) ;
}
F_11 () ;
if ( F_190 ( V_7 < 0 ) )
goto V_12;
...
if ( V_32 < 0 )
V_32 = 0 ;
if ( F_188 ( V_2 , & exp -> V_4 , V_302 ) < 0 )
goto V_12;
if ( F_189 ( V_2 , & exp -> V_4 , & exp -> V_172 ) < 0 )
goto V_12;
if ( F_188 ( V_2 ,
& V_243 -> V_316 [ V_65 ] . V_4 ,
V_317 ) < 0 )
goto V_12;
#ifdef F_68
if ( ! F_192 ( & exp -> V_318 , & V_319 ) ||
exp -> V_320 . V_312 ) {
V_9 = F_2 ( V_2 , V_321 | V_11 ) ;
if ( ! V_9 )
goto V_12;
if ( F_16 ( V_2 , V_322 , F_17 ( exp -> V_25 ) ) )
goto V_12;
V_313 . V_20 . V_21 = F_20 ( V_243 ) ;
V_313 . V_20 . V_205 = exp -> V_318 ;
V_313 . V_14 . V_15 = F_21 ( V_243 ) ;
V_313 . V_20 . V_311 = exp -> V_320 ;
if ( F_188 ( V_2 , & V_313 ,
V_323 ) < 0 )
goto V_12;
F_5 ( V_2 , V_9 ) ;
...
#endif
if ( F_16 ( V_2 , V_324 , F_17 ( V_32 ) ) ||
F_16 ( V_2 , V_325 , F_17 ( ( unsigned long ) exp ) ) ||
F_16 ( V_2 , V_326 , F_17 ( exp -> V_112 ) ) ||
F_16 ( V_2 , V_327 , F_17 ( exp -> V_328 ) ) )
goto V_12;
V_42 = F_23 ( V_243 ) ;
if ( V_42 ) {
struct V_43 * V_44 ;
V_44 = F_24 ( V_42 -> V_44 ) ;
if ( V_44 &&
F_25 ( V_2 , V_307 , V_44 -> V_48 ) )
goto V_12;
}
V_315 = F_193 ( exp -> V_329 ) ;
if ( V_315 != NULL &&
F_25 ( V_2 , V_330 , V_315 -> V_48 ) )
goto V_12;
return 0 ;
V_12:
return - 1 ;
...
static int
F_194 ( struct V_1 * V_2 , T_2 V_107 , T_2 V_91 ,
int V_114 , const struct V_305 * exp )
{
struct V_108 * V_109 ;
struct V_110 * V_111 ;
...
static int
F_195 ( unsigned int V_137 , struct V_332 * V_139 )
{
struct V_305 * exp = V_139 -> exp ;
struct V_140 * V_140 = F_196 ( exp ) ;
struct V_108 * V_109 ;
struct V_110 * V_111 ;
struct V_1 * V_2 ;
...
static int F_197 ( struct V_163 * V_164 )
{
if ( V_164 -> args [ 1 ] )
F_187 ( (struct V_305 * ) V_164 -> args [ 1 ] ) ;
return 0 ;
}
static int
F_198 ( struct V_1 * V_2 , struct V_163 * V_164 )
{
struct V_140 * V_140 = F_89 ( V_2 -> V_175 ) ;
struct V_305 * exp , * V_176 ;
struct V_110 * V_111 = F_54 ( V_164 -> V_109 ) ;
V_133 V_18 = V_111 -> V_118 ;
F_8 () ;
V_176 = (struct V_305 * ) V_164 -> args [ 1 ] ;
for (; V_164 -> args [ 0 ] < V_339 ; V_164 -> args [ 0 ] ++ ) {
V_184:
F_199 (exp, &net->ct.expect_hash[cb->args[0]],
hnode) {
...
static int
F_200 ( struct V_1 * V_2 , struct V_163 * V_164 )
{
struct V_305 * exp , * V_176 ;
struct V_110 * V_111 = F_54 ( V_164 -> V_109 ) ;
...
V_176 = (struct V_305 * ) V_164 -> args [ 1 ] ;
V_184:
F_199 (exp, &help->expectations, lnode) {
if ( V_18 && exp -> V_4 . V_20 . V_21 != V_18 )
continue;
if ( V_164 -> args [ 1 ] ) {
if ( exp != V_176 )
...
if ( F_194 ( V_2 , F_96 ( V_164 -> V_2 ) . V_107 ,
V_164 -> V_109 -> V_187 ,
V_337 ,
exp ) < 0 ) {
if ( ! F_130 ( & exp -> V_106 ) )
...
static int F_201 ( struct V_203 * V_204 , struct V_1 * V_2 ,
const struct V_108 * V_109 ,
const struct V_8 * const V_167 [] )
{
int V_142 ;
...
V_142 = F_110 ( V_167 , & V_4 , V_317 ,
V_205 , NULL ) ;
if ( V_142 < 0 )
return V_142 ;
V_142 = F_105 ( V_167 [ V_340 ] , & V_24 ) ;
if ( V_142 < 0 )
return V_142 ;
V_178 = F_119 ( V_140 , & V_24 , & V_4 ) ;
if ( ! V_178 )
...
static int
F_202 ( struct V_203 * V_204 , struct V_1 * V_2 ,
const struct V_108 * V_109 ,
const struct V_8 * const V_167 [] )
{
struct V_140 * V_140 = F_89 ( V_204 ) ;
...
if ( V_109 -> V_208 & V_209 ) {
if ( V_167 [ V_317 ] )
return F_201 ( V_204 , V_2 , V_109 , V_167 ) ;
else {
struct V_210 V_211 = {
. V_212 = F_198 ,
. V_213 = F_197 ,
...
if ( V_142 < 0 )
return V_142 ;
exp = F_203 ( V_140 , & V_24 , & V_4 ) ;
if ( ! exp )
return - V_206 ;
if ( V_167 [ V_325 ] ) {
T_7 V_26 = F_86 ( V_167 [ V_325 ] ) ;
...
F_8 () ;
V_142 = F_194 ( V_207 , F_96 ( V_2 ) . V_107 ,
V_109 -> V_187 , V_337 , exp ) ;
F_11 () ;
F_187 ( exp ) ;
if ( V_142 <= 0 )
goto free;
...
static int
F_204 ( struct V_203 * V_204 , struct V_1 * V_2 ,
const struct V_108 * V_109 ,
const struct V_8 * const V_167 [] )
{
struct V_140 * V_140 = F_89 ( V_204 ) ;
...
char * V_48 = F_112 ( V_167 [ V_307 ] ) ;
struct V_41 * V_343 ;
F_129 ( & V_244 ) ;
for ( V_85 = 0 ; V_85 < V_339 ; V_85 ++ ) {
F_206 (exp, next,
&net->ct.expect_hash[i],
hnode) {
V_343 = F_23 ( exp -> V_243 ) ;
if ( ! strcmp ( V_343 -> V_44 -> V_48 , V_48 ) &&
F_120 ( & exp -> V_32 ) ) {
F_205 ( exp ,
F_96 ( V_2 ) . V_107 ,
F_118 ( V_109 ) ) ;
...
static int
F_207 ( struct V_305 * V_344 ,
const struct V_8 * const V_167 [] )
{
if ( V_167 [ V_324 ] ) {
if ( ! F_120 ( & V_344 -> V_32 ) )
return - V_246 ;
V_344 -> V_32 . V_33 = V_34 +
F_85 ( F_86 ( V_167 [ V_324 ] ) ) * V_35 ;
F_149 ( & V_344 -> V_32 ) ;
}
return 0 ;
}
static int
F_208 ( const struct V_8 * V_53 ,
struct V_305 * exp ,
V_133 V_205 )
{
#ifdef F_68
struct V_8 * V_189 [ V_345 + 1 ] ;
struct V_3 V_313 = {} ;
int V_142 ;
V_142 = F_101 ( V_189 , V_345 , V_53 , V_346 ) ;
if ( V_142 < 0 )
return V_142 ;
...
if ( V_142 < 0 )
return V_142 ;
exp -> V_318 = V_313 . V_20 . V_205 ;
exp -> V_320 = V_313 . V_20 . V_311 ;
exp -> V_25 = F_85 ( F_86 ( V_189 [ V_322 ] ) ) ;
return 0 ;
#else
return - V_174 ;
#endif
...
static struct V_305 *
F_185 ( const struct V_8 * const V_167 [] , struct V_28 * V_29 ,
struct V_43 * V_44 ,
struct V_3 * V_4 ,
struct V_3 * V_172 )
{
...
exp -> V_32 . V_33 =
V_34 + F_85 ( F_86 ( V_167 [ V_324 ] ) ) * V_35 ;
exp -> V_112 = V_349 ;
if ( V_167 [ V_326 ] ) {
exp -> V_112 |=
F_85 ( F_86 ( V_167 [ V_326 ] ) ) ;
}
} else {
if ( V_167 [ V_326 ] ) {
exp -> V_112 = F_85 ( F_86 ( V_167 [ V_326 ] ) ) ;
exp -> V_112 &= ~ V_349 ;
} else
exp -> V_112 = 0 ;
}
if ( V_167 [ V_330 ] ) {
const char * V_48 = F_112 ( V_167 [ V_330 ] ) ;
struct V_314 * V_315 ;
V_315 = F_210 ( V_48 ) ;
if ( V_315 == NULL ) {
V_142 = - V_195 ;
...
exp -> V_172 . V_20 . V_311 . V_312 = V_172 -> V_20 . V_311 . V_312 ;
if ( V_167 [ V_321 ] ) {
V_142 = F_208 ( V_167 [ V_321 ] ,
exp , F_20 ( V_29 ) ) ;
if ( V_142 < 0 )
goto V_348;
}
...
if ( V_142 < 0 )
return V_142 ;
V_142 = F_110 ( V_167 , & V_172 , V_303 ,
V_205 , NULL ) ;
if ( V_142 < 0 )
return V_142 ;
V_142 = F_110 ( V_167 , & F_45 , V_317 ,
V_205 , NULL ) ;
if ( V_142 < 0 )
return V_142 ;
...
exp = F_185 ( V_167 , V_29 , V_44 , & V_4 , & V_172 ) ;
if ( F_114 ( exp ) ) {
V_142 = F_115 ( exp ) ;
goto V_350;
}
...
static int
F_212 ( struct V_203 * V_204 , struct V_1 * V_2 ,
const struct V_108 * V_109 ,
const struct V_8 * const V_167 [] )
{
struct V_140 * V_140 = F_89 ( V_204 ) ;
...
return V_142 ;
F_129 ( & V_244 ) ;
exp = F_213 ( V_140 , & V_24 , & V_4 ) ;
if ( ! exp ) {
F_131 ( & V_244 ) ;
V_142 = - V_206 ;
if ( V_109 -> V_208 & V_148 ) {
V_142 = F_211 ( V_140 , & V_24 , V_167 , V_205 ,
F_96 ( V_2 ) . V_107 ,
F_118 ( V_109 ) ) ;
}
return V_142 ;
...
V_142 = - V_263 ;
if ( ! ( V_109 -> V_208 & V_149 ) )
V_142 = F_207 ( exp , V_167 ) ;
F_131 ( & V_244 ) ;
return V_142 ;
}
static int
F_214 ( struct V_1 * V_2 , T_2 V_107 , T_2 V_91 , int V_217 ,
const struct V_264 * V_265 )
{
struct V_108 * V_109 ;
struct V_110 * V_111 ;
...
V_111 -> V_119 = V_120 ;
V_111 -> V_121 = F_14 ( V_217 ) ;
if ( F_16 ( V_2 , V_352 , F_17 ( V_265 -> V_353 ) ) ||
F_16 ( V_2 , V_354 , F_17 ( V_265 -> V_355 ) ) ||
F_16 ( V_2 , V_356 , F_17 ( V_265 -> V_357 ) ) )
goto V_12;
F_57 ( V_2 , V_109 ) ;
return V_2 -> V_77 ;
V_12:
...
static int
F_215 ( struct V_1 * V_2 , struct V_163 * V_164 )
{
int V_217 ;
struct V_140 * V_140 = F_89 ( V_2 -> V_175 ) ;
if ( V_164 -> args [ 0 ] == V_220 )
...
continue;
V_265 = F_128 ( V_140 -> V_29 . V_293 , V_217 ) ;
if ( F_214 ( V_2 , F_96 ( V_164 -> V_2 ) . V_107 ,
V_164 -> V_109 -> V_187 ,
V_217 , V_265 ) < 0 )
break;
}
...
static int
F_216 ( struct V_203 * V_204 , struct V_1 * V_2 ,
const struct V_108 * V_109 ,
const struct V_8 * const V_167 [] )
{
if ( V_109 -> V_208 & V_209 ) {
...
static int T_8 F_217 ( struct V_140 * V_140 )
{
#ifdef F_218
int V_7 ;
V_7 = F_219 ( V_140 , & V_358 ) ;
if ( V_7 < 0 ) {
F_220 ( L_5 ) ;
goto V_348;
}
V_7 = F_221 ( V_140 , & V_359 ) ;
if ( V_7 < 0 ) {
F_220 ( L_6 ) ;
goto V_360;
}
...
static void F_223 ( struct V_140 * V_140 )
{
#ifdef F_218
F_224 ( V_140 , & V_359 ) ;
F_222 ( V_140 , & V_358 ) ;
...
static void T_9 F_225 ( struct V_361 * V_362 )
{
struct V_140 * V_140 ;
F_226 (net, net_exit_list, exit_list)
F_223 ( V_140 ) ;
}
