...
F_38 ( ! ( V_64 & V_130 ) ) ;
V_103 = F_175 ( V_40 , F_122 ( V_114 ) ) ;
}
V_124 = F_166 ( V_103 ) ;
if ( F_176 ( V_114 ) )
V_124 = F_177 ( V_124 ) ;
F_127 ( V_18 , V_51 , V_77 , V_124 ) ;
} else if ( F_174 ( V_129 ) &&
( V_64 & V_130 ) ) {
T_9 V_103 ;
V_103 = F_175 ( V_40 , F_122 ( V_114 ) ) ;
F_127 ( V_18 , V_51 , V_77 , F_166 ( V_103 ) ) ;
} else
F_165 ( V_18 , V_122 ) ;
F_159 ( V_40 ) ;
F_178 ( V_40 ) ;
V_118:
F_101 ( V_77 , V_78 ) ;
if ( V_95 != V_88 && ! ( V_64 & V_117 ) )
F_128 ( V_18 , V_51 ) ;
V_45:
return V_95 ;
V_116:
F_101 ( V_77 , V_78 ) ;
if ( F_51 ( & V_13 -> V_19 -> V_131 ) ) {
if ( V_13 -> V_86 & V_87 ) {
F_179 ( V_40 ) ;
V_95 = V_132 ;
}
F_52 ( & V_13 -> V_19 -> V_131 ) ;
}
return V_95 ;
}
bool F_180 ( struct V_12 * V_13 )
{
int V_133 = V_13 -> V_86 & ( V_134 | V_135 ) ;
if ( ! V_133 )
return false ;
if ( ( V_13 -> V_86 & V_136 ) ==
V_136 )
...
static bool F_181 ( struct V_12 * V_13 , void * V_80 )
{
return F_180 ( V_13 ) ;
}
static int F_182 ( struct V_40 * V_40 )
{
return ! F_47 ( V_40 ) ;
}
int F_183 ( struct V_40 * V_40 , enum V_63 V_64 )
{
int V_95 ;
struct V_97 V_98 = {
. V_99 = F_160 ,
...
if ( ( V_64 & V_130 ) && ! F_116 ( V_40 ) && F_79 ( V_40 ) )
V_98 . V_101 = F_181 ;
V_95 = F_118 ( V_40 , & V_98 ) ;
if ( V_95 != V_132 && ! F_47 ( V_40 ) )
V_95 = V_91 ;
return V_95 ;
}
int F_184 ( struct V_40 * V_40 )
{
int V_95 ;
struct V_97 V_98 = {
. V_99 = F_160 ,
...
F_134 ( ! F_131 ( V_40 ) || F_185 ( V_40 ) , V_40 ) ;
V_95 = F_118 ( V_40 , & V_98 ) ;
return V_95 ;
}
...
static struct V_1 * F_186 ( struct V_40 * V_40 ,
struct V_97 * V_98 )
{
struct V_1 * V_1 ;
if ( V_98 -> V_100 )
...
static int F_187 ( struct V_40 * V_40 , struct V_97 * V_98 )
{
struct V_1 * V_1 ;
T_3 V_47 ;
struct V_9 * V_14 ;
...
return V_95 ;
V_47 = F_59 ( V_40 ) ;
F_188 (avc, &anon_vma->rb_root, pgoff, pgoff) {
...
V_47 = F_59 ( V_40 ) ;
F_190 ( V_42 ) ;
F_191 (vma, &mapping->i_mmap, pgoff, pgoff) {
unsigned long V_51 = F_60 ( V_40 , V_13 ) ;
if ( V_98 -> V_101 && V_98 -> V_101 ( V_13 , V_98 -> V_80 ) )
continue;
V_95 = V_98 -> V_99 ( V_40 , V_13 , V_51 , V_98 -> V_80 ) ;
...
{
if ( F_18 ( F_116 ( V_40 ) ) )
return F_193 ( V_40 , V_98 ) ;
else if ( F_79 ( V_40 ) )
return F_187 ( V_40 , V_98 ) ;
else
return F_189 ( V_40 , V_98 ) ;
}
static void F_194 ( struct V_40 * V_40 ,
struct V_12 * V_13 , unsigned long V_51 , int V_107 )
{
struct V_1 * V_1 = V_13 -> V_1 ;
F_38 ( ! V_1 ) ;
...
if ( V_108 )
F_194 ( V_40 , V_13 , V_51 , 0 ) ;
}
void F_196 ( struct V_40 * V_40 ,
struct V_12 * V_13 , unsigned long V_51 )
{
F_38 ( V_51 < V_13 -> V_48 || V_51 >= V_13 -> V_52 ) ;
F_3 ( & V_40 -> V_109 , 0 ) ;
F_194 ( V_40 , V_13 , V_51 , 1 ) ;
}
