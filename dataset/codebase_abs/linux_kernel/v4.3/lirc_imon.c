...
F_5 ( V_4 , L_24 ,
V_9 , V_90 , V_91 , V_84 ) ;
for ( V_45 = 0 ; V_45 < V_86 && ! ( V_89 && V_88 ) ; ++ V_45 ) {
struct V_80 * V_101 ;
int V_102 ;
int V_103 ;
...
if ( ! V_5 )
goto V_109;
V_8 = F_45 ( sizeof( struct V_83 ) , V_40 ) ;
if ( ! V_8 )
goto V_111;
if ( F_46 ( V_8 , V_112 , V_113 ) ) {
F_8 ( V_4 , L_30 , V_9 ) ;
goto V_114;
}
V_7 = F_47 ( 0 , V_40 ) ;
...
F_9 ( V_4 , L_38 ,
V_90 , V_91 , V_84 , V_12 -> V_131 -> V_132 , V_12 -> V_133 ) ;
goto V_92;
V_129:
F_7 ( V_5 -> V_11 ) ;
V_127:
...
static int F_58 ( struct V_15 * V_64 , T_6 V_134 )
{
struct V_1 * V_2 = F_15 ( V_64 ) ;
F_55 ( V_2 -> V_7 ) ;
return 0 ;
}
static int F_59 ( struct V_15 * V_64 )
{
struct V_1 * V_2 = F_15 ( V_64 ) ;
F_20 ( V_2 -> V_7 , V_2 -> V_12 ,
F_50 ( V_2 -> V_12 ,
