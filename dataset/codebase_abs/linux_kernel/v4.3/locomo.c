...
static inline struct V_3 * F_48 ( struct V_23 * V_104 )
{
return (struct V_3 * ) F_49 ( V_104 -> V_24 . V_34 ) ;
}
void F_50 ( struct V_21 * V_24 , unsigned int V_105 , unsigned int V_106 )
{
struct V_3 * V_4 = F_49 ( V_24 ) ;
unsigned long V_47 ;
unsigned int V_15 ;
if ( ! V_4 )
return;
