...
F_26 ( & V_3 -> V_101 , V_78 ) ;
F_30 ( V_3 , V_100 -> V_45 , V_100 -> V_64 ) ;
F_11 ( V_100 ) ;
}
}
...
int V_28 ;
int V_158 ;
F_59 ( V_3 -> V_36 , V_3 -> V_159 , sizeof( V_3 -> V_159 ) ) ;
F_60 ( V_3 -> V_159 , L_38 , sizeof( V_3 -> V_159 ) ) ;
V_157 = F_61 () ;
if ( ! V_157 )
return - V_32 ;
V_157 -> V_160 = L_39 ;
V_157 -> V_161 = V_3 -> V_159 ;
V_157 -> V_162 [ 0 ] = F_62 ( V_163 ) ;
V_157 -> V_164 = sizeof( T_1 ) ;
V_157 -> V_165 = 0x1a ;
V_157 -> V_166 = V_15 ;
for ( V_28 = 0 ; V_28 < F_63 ( V_15 ) ; V_28 ++ )
F_64 ( V_15 [ V_28 ] , V_157 -> V_167 ) ;
V_158 = F_65 ( V_157 ) ;
if ( V_158 ) {
F_66 ( V_157 ) ;
return V_158 ;
...
F_69 ( & V_3 -> V_33 ) ;
F_69 ( & V_3 -> V_128 ) ;
V_3 -> V_37 = F_70 ( V_3 -> V_36 , V_169 ) ;
V_3 -> V_38 = F_71 ( V_3 -> V_36 , V_170 ) ;
V_3 -> V_120 = F_72 ( V_3 -> V_36 , V_171 ) ;
V_3 -> V_172 = F_73 ( V_3 -> V_36 , V_173 ) ;
V_3 -> V_174 = F_74 ( V_3 -> V_36 , V_175 ) ;
if( V_176 ) {
V_3 -> V_168 = F_53 ( 0 , V_31 ) ;
if( ! V_3 -> V_168 ) {
return - V_32 ;
}
V_3 -> V_6 = F_75 ( V_3 -> V_36 , V_177 ,
V_31 , & V_3 -> V_178 ) ;
if( ! V_3 -> V_6 ) {
F_49 ( V_3 -> V_168 ) ;
return - V_32 ;
}
F_76 ( V_3 -> V_168 , V_3 -> V_36 , V_3 -> V_174 ,
V_3 -> V_6 , V_177 ,
F_1 , V_3 , 1 ) ;
...
F_2 ( L_5 , V_13 ) ;
V_26 = F_79 ( & V_191 , V_3 -> V_192 , & V_3 -> V_36 -> V_117 ) ;
if ( V_26 ) {
F_6 ( V_193 L_41 ,
V_13 , V_3 -> V_192 ) ;
return V_26 ;
...
V_3 -> V_139 . V_207 = 31 ;
V_3 -> V_139 . V_208 = 31 ;
V_3 -> V_139 . V_209 = F_44 ;
V_3 -> V_139 . V_210 = F_47 ;
V_3 -> V_139 . V_211 = NULL ;
if ( ( V_26 = F_87 ( & V_3 -> V_139 ) ) < 0 ) {
F_6 ( L_53 , V_13 ,
V_26 ) ;
F_88 ( & V_3 -> V_200 ) ;
return V_26 ;
...
V_3 -> V_212 . V_204 = 0 ;
if ( ( V_26 = F_89 ( & V_3 -> V_212 , & V_3 -> V_200 ) ) < 0 ) {
F_6 ( L_54 ,
V_13 , V_26 ) ;
F_90 ( & V_3 -> V_139 ) ;
F_88 ( & V_3 -> V_200 ) ;
...
F_92 ( & V_3 -> V_200 , & V_3 -> V_218 , & V_3 -> V_139 . V_152 ) ;
return 0 ;
}
...
static int F_103 ( struct V_223 * V_220 , const T_2 V_21 ,
int V_22 , const T_2 V_23 [] ,
int * V_24 , T_2 V_25 [] )
{
...
case 0x1008 :
case 0x1009 :
V_3 -> V_220 = F_109 ( & V_233 ) ;
break;
}
if ( V_3 -> V_220 == NULL ) {
F_6 ( L_56 ,
F_110 ( V_3 -> V_36 -> V_234 . V_235 ) ,
F_110 ( V_3 -> V_36 -> V_234 . V_230 ) ) ;
} else {
if ( F_111 ( & V_3 -> V_200 , V_3 -> V_220 ) ) {
F_6 ( L_57 ) ;
if ( V_3 -> V_220 -> V_221 . V_222 )
V_3 -> V_220 -> V_221 . V_222 ( V_3 -> V_220 ) ;
V_3 -> V_220 = NULL ;
