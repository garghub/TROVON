...
F_2 ( V_14 , L_2
L_3 ,
args -> V_10 . V_16 , args -> V_10 . V_17 ,
args -> V_10 . V_18 , args -> V_10 . V_19 ) ;
if ( args -> V_10 . V_18 > 0x1f || args -> V_10 . V_19 > 0x7f )
return - V_20 ;
V_12 = 0x40000000 * ! ! args -> V_10 . V_17 ;
V_12 |= args -> V_10 . V_18 << 16 ;
V_12 |= args -> V_10 . V_19 ;
V_12 |= 0x1f000000 ;
} else
return V_13 ;
