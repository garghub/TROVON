...
F_45 ( & V_1 -> V_11 , V_94 ) ;
F_46 ( V_9 -> V_95 ) ;
for ( V_90 = 0 ; V_90 < F_47 ( V_9 -> V_96 ) ; V_90 ++ ) {
V_91 = F_48 ( V_9 -> V_96 [ V_90 ] ) ;
if ( V_91 )
...
V_101 |
V_102 ) ;
F_55 ( V_3 -> V_98 , V_103 , 0 ) ;
F_11 ( V_9 , 1 ) ;
for ( V_90 = 0 ; V_90 < F_47 ( V_9 -> V_96 ) ; V_90 ++ ) {
V_91 = F_56 ( V_9 -> V_96 [ V_90 ] ) ;
if ( V_91 )
F_6 ( V_6 -> V_6 , L_10 , V_91 ) ;
}
F_8 ( L_11 , V_97 ) ;
V_91 = F_57 ( V_9 -> V_95 , V_97 ) ;
if ( V_91 )
...
long F_61 ( struct V_2 * V_3 , unsigned long V_104 )
{
struct V_9 * V_9 =
F_14 ( V_3 ) ;
return F_62 ( V_9 -> V_95 , V_104 ) ;
}
