...
static void F_35 ( void T_3 * V_52 )
{
T_1 V_53 ;
...
static void F_36 ( void T_3 * V_52 )
{
T_1 V_53 ;
F_14 ( ~ V_54 & F_6 ( V_52 + V_55 ) ,
V_52 + V_55 ) ;
...
static void T_3 * F_40 ( struct V_9 * V_10 , T_4 V_67 ,
unsigned int V_68 )
{
T_4 V_69 = F_41 ( V_68 ) , V_70 = F_42 ( V_68 ) ;
struct V_1 * V_8 = & V_10 -> V_8 ;
T_1 V_71 ;
if ( V_67 == 0 )
return V_8 -> V_59 ;
...
return F_44 ( V_79 + ( V_75 & ~ 0x3 ) , V_75 , V_76 , V_53 ) ;
}
...
void T_3 * V_79 ;
V_79 = F_40 ( V_10 , V_77 , V_68 ) ;
return F_46 ( V_79 + ( V_75 & ~ 0x3 ) , V_75 , V_76 , V_53 ) ;
}
