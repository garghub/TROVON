...
V_15 -> V_22 = 0 ;
if ( V_239 == 0 ) {
V_15 -> V_15 . V_370 . V_371 = true ;
} else {
V_15 -> V_15 . V_370 . V_372 = true ;
V_15 -> V_15 . V_370 . V_373 = true ;
V_15 -> V_15 . V_370 . V_374 = true ;
}
if ( V_239 & 1 )
V_15 -> V_15 . V_370 . V_375 = true ;
else
V_15 -> V_15 . V_370 . V_376 = true ;
F_130 ( & V_15 -> V_15 , ( unsigned short ) ~ 0 ) ;
F_58 ( & V_15 -> V_27 ) ;
if ( V_367 )
F_74 ( & V_15 -> V_15 . V_377 , & V_19 -> V_34 . V_377 ) ;
V_15 -> V_34 = & V_19 -> V_34 ;
...
#endif
V_379 = F_135 ( V_362 , V_384 , 0 ) ;
if ( ! V_379 ) {
V_197 = - V_385 ;
goto V_383;
}
if ( V_4 -> V_380 == V_386 ) {
if ( ! F_136 ( V_379 -> V_387 , F_137 ( V_379 ) ,
V_351 ) ) {
...
V_46 = F_138 ( V_379 -> V_387 , F_137 ( V_379 ) ) ;
if ( ! V_46 ) {
V_197 = - V_195 ;
goto V_389;
}
V_4 -> V_390 = ( void T_2 * ) V_46 ;
if ( V_4 -> V_391 && V_4 -> V_391 ( V_362 ) ) {
V_197 = - V_212 ;
goto V_392;
}
F_9 ( V_4 ) ;
...
V_9 -> V_269 = ( V_83 & V_396 ) * 2 ;
V_9 -> V_329 = F_140 ( V_362 , 0 ) ;
if ( ! V_9 -> V_329 ) {
V_197 = - V_212 ;
goto V_395;
}
V_197 = F_141 ( V_9 -> V_329 , F_113 , V_397 ,
V_351 , V_9 ) ;
if ( V_197 != 0 ) {
F_37 ( L_115 ,
V_9 -> V_329 , V_197 ) ;
...
if ( V_197 )
goto V_398;
V_9 -> V_34 . V_368 = & V_399 ;
V_9 -> V_34 . V_400 = V_313 ;
V_9 -> V_34 . V_280 = & V_9 -> V_234 [ 0 ] . V_15 ;
F_58 ( & V_9 -> V_34 . V_377 ) ;
V_9 -> V_34 . V_148 = V_149 ;
V_9 -> V_34 . V_36 = V_351 ;
F_143 ( & V_9 -> V_34 . V_358 , L_117 ) ;
V_9 -> V_34 . V_358 . V_401 = V_362 -> V_358 . V_401 ;
if ( ! F_85 ( V_9 -> V_228 ) )
V_9 -> V_34 . V_105 = 1 ;
F_48 ( V_9 ) ;
F_129 ( V_9 , 0 , L_118 , 0 ) ;
V_9 -> V_234 [ 0 ] . V_15 . V_141 = & V_402 ;
...
V_389:
if ( V_4 -> V_380 == V_386 )
F_151 ( V_379 -> V_387 , F_137 ( V_379 ) ) ;
V_383:
F_60 ( V_9 ) ;
V_9 = NULL ;
return V_197 ;
}
static int F_152 ( struct V_361 * V_362 )
{
struct V_378 * V_379 = F_135 ( V_362 , V_384 , 0 ) ;
...
static int F_157 ( struct V_361 * V_362 , T_9 V_406 )
{
F_42 ( V_9 ) ;
return 0 ;
}
...
static int F_159 ( struct V_357 * V_358 , T_9 V_406 )
{
struct V_21 * V_19 = V_9 ;
T_1 V_407 , V_67 ;
V_407 = F_31 ( & V_46 -> V_72 ) & V_73 ;
F_43 ( L_122 , V_104 , V_407 , V_19 -> V_22 ) ;
if ( V_19 -> V_22 ) {
F_43 ( L_123 ) ;
V_19 -> V_408 = 1 ;
return 0 ;
