...
F_15 ( V_114 , & V_13 , 1 ) ;
if ( ! F_25 ( V_4 ) || F_66 ( V_4 ) != - V_106 )
return V_4 ;
V_4 = F_23 ( V_2 , V_37 , V_38 , V_40 ) ;
if ( F_25 ( V_4 ) )
return V_4 ;
F_4 ( F_67 ( F_2 ( V_4 ) , V_38 ) ) ;
F_37 ( V_114 , & V_13 , 1 ) ;
V_115 = F_53 ( V_61 , & V_13 , V_38 , V_101 , & V_102 ) ;
if ( F_56 ( F_66 ( V_115 ) == - V_106 ) ) {
struct V_5 * V_6 ;
V_6 = F_10 ( V_114 , & V_13 ) ;
F_64 ( V_114 , & V_13 , & V_4 -> V_16 -> V_19 ) ;
V_6 -> V_29 ++ ;
...
T_3 V_120 ;
while ( 1 ) {
V_119 = F_65 ( V_2 , V_37 , V_38 , V_40 , & V_120 ) ;
if ( V_119 != F_24 ( - V_112 ) )
return V_119 ;
F_68 () ;
...
if ( V_47 == 0 )
F_73 ( & V_122 -> V_123 , & V_126 ) ;
return V_47 ;
}
void F_74 ( struct V_121 * V_122 )
{
F_22 ( & V_122 -> V_123 ) ;
...
static int
F_76 ( struct V_34 * V_114 , struct V_12 * V_13 ,
struct V_103 * V_104 , void * V_130 )
{
struct V_131 * V_132 = (struct V_131 * ) V_130 ;
struct V_7 * V_63 ;
V_63 = F_77 ( V_104 , struct V_7 , V_19 ) ;
if ( ! F_5 ( & V_63 -> V_51 ) ) {
...
void F_78 ( const struct V_1 * V_2 , struct V_9 * V_61 , void * V_77 ,
T_2 V_90 )
{
struct V_131 V_132 = {
...
static unsigned F_82 ( struct V_34 * V_114 ,
...
V_146 = F_84 ( V_146 , V_114 -> V_147 ) ;
V_146 -= F_84 ( ( unsigned long ) V_114 , F_85 ( V_15 ) % 11 + 3 ) ;
V_146 <<= V_114 -> V_148 - V_114 -> V_147 ;
V_146 |= ( F_86 ( V_15 ) + F_85 ( V_15 ) ) & ( F_35 ( V_114 ) - 1 ) ;
return V_146 & V_145 ;
}
static void * F_87 ( struct V_103 * V_104 )
{
return F_77 ( V_104 , struct V_7 , V_19 ) ;
}
...
static int F_89 ( const void * V_82 , struct V_103 * V_104 )
{
struct V_7 * V_63 ;
V_63 = F_77 ( V_104 , struct V_7 , V_19 ) ;
return F_67 ( & V_63 -> V_27 , (struct V_14 * ) V_82 ) ;
}
static void F_90 ( struct V_34 * V_114 , struct V_103 * V_104 )
{
struct V_7 * V_63 ;
V_63 = F_77 ( V_104 , struct V_7 , V_19 ) ;
if ( F_91 ( 1 , & V_63 -> V_23 ) == 1 ) {
struct V_5 * V_6 ;
struct V_12 V_13 ;
...
static void F_92 ( struct V_34 * V_114 , struct V_103 * V_104 )
{
F_93 () ;
}
void F_94 ( struct V_9 * V_61 , struct V_36 * V_149 )
{
F_95 ( & V_61 -> V_150 ) ;
if ( F_5 ( & V_149 -> V_151 ) )
F_73 ( & V_149 -> V_151 , & V_61 -> V_152 ) ;
F_96 ( & V_61 -> V_150 ) ;
}
void F_97 ( struct V_9 * V_61 , struct V_36 * V_149 )
{
F_95 ( & V_61 -> V_150 ) ;
F_22 ( & V_149 -> V_151 ) ;
F_96 ( & V_61 -> V_150 ) ;
}
int F_98 ( struct V_9 * V_61 , struct V_36 * V_8 )
{
struct V_5 * V_6 ;
struct V_12 V_13 ;
char V_153 [ 16 ] ;
...
for ( V_137 = F_99 ( F_100 ( V_154 , V_137 ) , V_155 ) ;
V_137 >= V_154 ; V_137 -- ) {
V_61 -> V_26 = F_101 ( V_153 , V_137 , V_137 ,
V_137 - V_156 ,
sizeof( * V_6 ) , 0 , 0 ,
& V_157 ,
V_158 |
...
V_61 -> V_54 = F_104 ( V_162 , 0 ) ;
if ( V_61 -> V_54 == NULL ) {
F_105 ( V_61 -> V_26 ) ;
V_61 -> V_26 = NULL ;
return - V_50 ;
}
F_106 ( V_61 -> V_54 , V_55 ,
0 , L_16 , L_16 ) ;
F_106 ( V_61 -> V_54 , V_108 ,
0 , L_17 , L_17 ) ;
F_106 ( V_61 -> V_54 , V_107 ,
0 , L_18 , L_18 ) ;
F_106 ( V_61 -> V_54 , V_118 ,
0 , L_19 , L_19 ) ;
F_106 ( V_61 -> V_54 , V_111 ,
0 , L_20 , L_20 ) ;
F_106 ( V_61 -> V_54 , V_76 ,
0 , L_21 , L_21 ) ;
F_29 ( & V_61 -> V_163 ) ;
V_61 -> V_113 = V_8 ;
V_8 -> V_18 = V_61 ;
F_107 ( V_8 ) ;
F_108 ( & V_8 -> V_164 , L_22 , V_61 ) ;
F_29 ( & V_61 -> V_152 ) ;
F_109 ( & V_61 -> V_150 ) ;
F_94 ( V_61 , V_8 ) ;
return 0 ;
}
void F_110 ( struct V_9 * V_61 )
{
F_111 ( & V_165 ) ;
F_22 ( & V_61 -> V_163 ) ;
F_112 ( & V_165 ) ;
...
F_113 ( & V_61 -> V_113 -> V_164 , L_22 , V_61 ) ;
F_114 ( V_61 -> V_113 ) ;
V_61 -> V_113 = NULL ;
}
if ( V_61 -> V_54 != NULL )
...
int F_116 ( struct V_9 * V_61 )
{
int V_47 ;
F_111 ( & V_165 ) ;
V_47 = F_117 ( & V_166 . V_85 ) ;
if ( V_47 == 0 )
F_73 ( & V_61 -> V_163 , & V_167 ) ;
F_112 ( & V_165 ) ;
return V_47 ;
}
void F_107 ( struct V_36 * V_149 )
{
F_118 ( & V_149 -> V_168 ) ;
}
void F_114 ( struct V_36 * V_149 )
{
F_4 ( F_39 ( & V_149 -> V_168 ) > 0 ) ;
F_119 ( & V_149 -> V_168 ) ;
}
int F_120 ( struct V_36 * V_149 , struct V_121 * V_169 )
{
...
V_4 -> V_17 = V_149 ;
F_107 ( V_149 ) ;
F_127 ( & V_149 -> V_164 , & V_4 -> V_173 , L_24 , V_4 ) ;
F_29 ( & V_4 -> V_59 ) ;
return 0 ;
}
...
F_4 ( F_5 ( & V_4 -> V_59 ) ) ;
if ( V_37 != NULL ) {
F_129 ( & V_37 -> V_164 , & V_4 -> V_173 ,
L_24 , V_4 ) ;
F_114 ( V_37 ) ;
V_4 -> V_17 = NULL ;
}
}
void F_130 ( struct V_7 * V_63 , struct V_3 * V_4 )
{
F_40 ( & V_4 -> V_59 , & V_63 -> V_51 ) ;
}
void F_131 ( struct V_3 * V_174 , struct V_3 * V_4 )
{
F_40 ( & V_4 -> V_59 , & V_174 -> V_59 ) ;
}
int F_132 ( struct V_7 * V_63 )
{
...
struct V_3 * F_71 ( struct V_7 * V_63 ,
...
void F_135 ( const struct V_1 * V_2 , struct V_36 * V_8 )
{
...
static void F_138 ( struct V_193 * V_194 , int V_195 )
{
...
F_113 ( & V_82 -> V_191 , L_26 , V_194 ) ;
F_119 ( & V_82 -> V_190 ) ;
if ( ( V_194 -> V_197 & V_198 ) == 0 ) {
#ifdef F_139
F_140 ( F_141 ( V_82 -> V_199 ) > 0 ) ;
#endif
F_142 ( V_82 -> V_199 ) ;
}
...
void F_143 ( struct V_182 * V_82 )
{
F_4 ( F_39 ( & V_82 -> V_190 ) >= 1 ) ;
F_140 ( 0 <= V_82 -> V_189 && V_82 -> V_189 < F_45 ( V_188 ) ) ;
F_144 ( V_82 ) ;
++ V_192 ;
F_95 ( & V_187 ) ;
F_138 ( & V_166 . V_85 , V_82 -> V_189 ) ;
if ( V_188 [ V_82 -> V_189 ] ) {
V_188 [ V_82 -> V_189 ] = NULL ;
F_124 ( & V_82 -> V_191 ) ;
}
F_96 ( & V_187 ) ;
F_125 ( F_39 ( & V_82 -> V_190 ) == 1 ,
L_27 ,
F_39 ( & V_82 -> V_190 ) ) ;
}
int F_145 ( struct V_182 * V_200 , ... )
{
...
lc_remember)
F_138 ( V_194 , V_82 -> V_189 ) ;
F_96 ( & V_187 ) ;
++ V_192 ;
}
}
void F_148 ( struct V_182 * V_82 )
{
V_82 -> V_185 &= ~ V_203 ;
++ V_192 ;
}
...
! ( V_82 -> V_185 & V_203 ) ) {
void * V_204 ;
F_140 ( V_82 -> V_183 != NULL ) ;
F_140 ( V_82 -> V_189 == V_71 ) ;
V_204 = V_82 -> V_183 ( V_194 , V_82 ) ;
if ( F_25 ( V_204 ) )
return F_66 ( V_204 ) ;
if ( ! ( V_194 -> V_197 & V_198 ) )
F_153 ( V_82 -> V_199 ) ;
F_154 ( & V_82 -> V_191 , L_26 , V_194 ) ;
F_118 ( & V_82 -> V_190 ) ;
...
static int F_155 ( struct V_193 * V_194 )
{
V_194 -> V_196 = F_156 ( F_45 ( V_188 ) , sizeof( V_194 -> V_196 [ 0 ] ) ,
V_208 ) ;
if ( F_56 ( V_194 -> V_196 != NULL ) )
return F_152 ( V_194 ) ;
return - V_50 ;
}
int F_157 ( struct V_193 * V_194 , T_5 V_209 )
{
int V_210 ;
...
void F_158 ( struct V_193 * V_194 )
{
F_140 ( V_194 -> V_201 == V_211 || V_194 -> V_201 == V_215 ) ;
V_194 -> V_201 = V_216 ;
if ( ( V_194 -> V_197 & V_212 ) == 0 ) {
F_4 ( F_5 ( & V_194 -> V_213 ) ) ;
F_150 ( V_194 ) ;
} else {
F_95 ( & V_187 ) ;
...
int F_117 ( struct V_193 * V_194 )
{
return F_56 ( V_194 -> V_207 == V_192 ) ? 0 : F_152 ( V_194 ) ;
}
void F_161 ( T_5 V_209 )
{
F_95 ( & V_187 ) ;
V_217 |= V_209 ;
V_192 ++ ;
...
int F_165 ( struct V_1 * V_2 , T_5 V_209 )
{
int V_47 ;
V_2 -> V_219 = NULL ;
V_47 = F_157 ( & V_2 -> V_85 , V_209 ) ;
if ( F_56 ( V_47 == 0 ) )
F_159 ( & V_2 -> V_85 ) ;
return V_47 ;
}
...
int V_47 ;
V_47 = F_117 ( & V_2 -> V_85 ) ;
if ( V_47 == 0 && V_2 -> V_219 != NULL )
V_47 = F_117 ( V_2 -> V_219 ) ;
return V_47 ;
}
int F_168 ( struct V_1 * V_2 , T_5 V_220 ,
T_5 V_221 )
{
if ( ( V_2 -> V_85 . V_197 & V_220 ) != V_220 ) {
V_2 -> V_85 . V_207 = 0 ;
V_2 -> V_85 . V_197 |= V_220 ;
}
if ( V_2 -> V_219 && ( V_2 -> V_219 -> V_197 & V_221 ) != V_221 ) {
V_2 -> V_219 -> V_207 = 0 ;
V_2 -> V_219 -> V_197 |= V_221 ;
}
return F_167 ( V_2 ) ;
}
static void F_169 ( struct V_34 * V_114 ,
T_6 * V_222 , int V_223 )
{
struct V_12 V_13 ;
int V_71 ;
...
struct V_224 * V_225 ;
F_37 ( V_114 , & V_13 , 1 ) ;
V_222 -> V_226 += V_6 -> V_29 ;
V_222 -> V_227 += F_170 ( & V_13 ) ;
V_222 -> V_228 = F_100 ( ( int ) V_222 -> V_228 ,
F_171 ( & V_13 ) ) ;
if ( ! V_223 ) {
F_15 ( V_114 , & V_13 , 1 ) ;
continue;
...
static unsigned long F_174 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
T_6 V_222 ;
struct V_9 * V_61 ;
...
F_169 ( V_61 -> V_26 , & V_222 , 0 ) ;
V_235 += V_222 . V_227 - V_222 . V_226 ;
}
F_112 ( & V_165 ) ;
V_235 = ( V_235 / 100 ) * V_238 ;
F_175 ( V_239 , L_28 , V_235 ) ;
return V_235 ;
}
static unsigned long F_176 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
struct V_9 * V_61 ;
struct V_9 * V_234 ;
unsigned long V_240 = V_233 -> V_241 , V_242 = 0 ;
F_177 ( V_56 ) ;
if ( ! ( V_233 -> V_236 & V_237 ) )
return V_243 ;
F_111 ( & V_165 ) ;
F_38 (s, tmp, &lu_sites, ls_linkage) {
V_242 = F_33 ( & V_166 , V_61 , V_240 ) ;
V_240 -= V_242 ;
F_178 ( & V_61 -> V_163 , & V_56 ) ;
}
F_179 ( & V_56 , V_167 . V_58 ) ;
F_112 ( & V_165 ) ;
return V_233 -> V_241 - V_240 ;
}
int F_180 ( const struct V_1 * V_2 ,
void * V_244 , const char * V_78 , ... )
{
T_1 args ;
va_start ( args , V_78 ) ;
F_181 ( V_78 , args ) ;
...
static T_5 F_189 ( struct V_248 * V_222 , int V_249 )
{
struct V_250 V_251 ;
F_190 ( V_222 , V_249 , & V_251 ) ;
return ( T_5 ) V_251 . V_252 ;
}
int F_191 ( const struct V_9 * V_61 , struct V_253 * V_254 )
{
T_6 V_222 ;
memset ( & V_222 , 0 , sizeof( V_222 ) ) ;
F_169 ( V_61 -> V_26 , & V_222 , 1 ) ;
F_192 ( V_254 , L_30 ,
V_222 . V_226 ,
V_222 . V_227 ,
V_222 . V_229 ,
F_193 ( V_61 -> V_26 ) ,
V_222 . V_228 ,
F_189 ( V_61 -> V_54 , V_55 ) ,
F_189 ( V_61 -> V_54 , V_108 ) ,
F_189 ( V_61 -> V_54 , V_107 ) ,
F_189 ( V_61 -> V_54 , V_118 ) ,
F_189 ( V_61 -> V_54 , V_111 ) ,
F_189 ( V_61 -> V_54 , V_76 ) ) ;
return 0 ;
}
int F_194 ( struct V_255 * V_256 )
{
int V_47 ;
struct V_255 * V_257 = V_256 ;
for ( V_47 = 0 ; V_257 -> V_258 != NULL ; ++ V_257 ) {
* V_257 -> V_258 = F_195 ( V_257 -> V_259 ,
V_257 -> V_260 ,
0 , 0 , NULL ) ;
if ( * V_257 -> V_258 == NULL ) {
V_47 = - V_50 ;
...
void F_198 ( const struct V_1 * V_2 , struct V_3 * V_4 ,
const struct V_14 * V_15 )
{
...
F_4 ( F_25 ( V_115 ) && F_66 ( V_115 ) == - V_106 ) ;
* V_261 = * V_15 ;
V_6 = F_10 ( V_114 , & V_13 ) ;
F_64 ( V_114 , & V_13 , & V_4 -> V_16 -> V_19 ) ;
V_6 -> V_29 ++ ;
...
struct V_3 * F_199 ( const struct V_1 * V_2 ,
struct V_36 * V_37 ,
const struct V_39 * V_40 )
{
struct V_14 V_15 ;
...
void F_203 ( struct V_262 * V_263 , int V_266 )
{
F_4 ( V_263 ) ;
F_4 ( V_263 -> V_264 == NULL ) ;
F_4 ( V_263 -> V_265 == 0 ) ;
V_263 -> V_264 = F_204 ( V_266 , V_208 ) ;
if ( F_56 ( V_263 -> V_264 ) )
V_263 -> V_265 = V_266 ;
}
...
struct V_262 * F_206 ( struct V_262 * V_263 , int V_267 )
{
...
int F_207 ( struct V_262 * V_263 , int V_267 )
{
char * V_268 ;
if ( V_267 <= V_263 -> V_265 )
return 0 ;
V_268 = F_204 ( V_267 , V_208 ) ;
if ( V_268 == NULL )
return - V_50 ;
if ( V_263 -> V_264 != NULL ) {
