...
int T_2 F_21 ( const struct V_35 * V_36 ,
unsigned long V_54 ,
const char * V_26 )
{
int V_37 ;
...
V_14 -> V_25 = V_29 ;
V_14 -> V_39 = V_40 * 16 ;
V_14 -> V_41 = F_1 ( V_14 -> V_25 , V_59 ) ;
V_55 = F_24 ( V_54 , L_10 , NULL ) ;
if ( V_55 )
V_14 -> V_25 += F_25 ( * V_55 ) ;
V_55 = F_24 ( V_54 , L_11 , NULL ) ;
if ( V_55 )
V_14 -> V_31 = F_25 ( * V_55 ) ;
V_56 = F_24 ( V_54 , L_12 , NULL ) != NULL ||
( F_19 ( V_60 ) &&
F_24 ( V_54 , L_13 , NULL ) != NULL ) ;
V_55 = F_24 ( V_54 , L_14 , NULL ) ;
if ( V_55 ) {
switch ( F_25 ( * V_55 ) ) {
case 1 :
V_14 -> V_20 = V_21 ;
...
V_55 = F_24 ( V_54 , L_16 , NULL ) ;
if ( V_55 )
V_19 . V_33 = F_25 ( * V_55 ) ;
if ( V_26 ) {
V_19 . V_33 = F_8 ( V_26 , NULL , 0 ) ;
F_9 ( V_19 . V_26 , V_26 ,
sizeof( V_19 . V_26 ) ) ;
}
F_7 ( & V_19 , V_36 -> V_9 ) ;
