...
F_110 ( V_11 , 1 ) ;
F_63 ( V_18 , L_16 ) ;
V_20 = F_111 ( V_11 , V_110 ) ;
if ( V_20 )
return V_20 ;
}
F_63 ( V_18 , L_17 ) ;
F_112 ( & V_18 -> V_32 . V_111 , V_112 ) ;
F_63 ( V_18 , L_18 ) ;
if ( V_18 -> V_31 ) {
V_20 = F_22 ( V_18 -> V_31 ) ;
if ( V_20 )
...
static int
F_115 ( struct V_10 * V_11 , bool V_110 )
{
struct V_17 * V_18 = V_17 ( V_11 ) ;
F_63 ( V_18 , L_22 ) ;
F_116 ( & V_18 -> V_22 . V_14 ) ;
F_63 ( V_18 , L_23 ) ;
if ( V_18 -> V_34 && F_27 ( V_18 ) -> V_116 )
F_27 ( V_18 ) -> V_116 ( V_18 ) ;
F_117 ( V_11 ) ;
...
return V_20 ;
F_60 ( V_2 ) ;
V_20 = F_115 ( V_117 , false ) ;
F_128 ( & V_17 ( V_117 ) -> V_123 ) ;
return V_20 ;
}
static int
...
F_141 (crtc, &drm->dev->mode_config.crtc_list, head) {
if ( V_131 -> V_133 ) {
F_140 ( L_26 ) ;
return - V_125 ;
}
...
static int
F_143 ( struct V_10 * V_11 , struct V_134 * V_135 )
{
struct V_17 * V_18 = V_17 ( V_11 ) ;
struct V_12 * V_13 ;
...
return V_20 ;
F_144 ( V_136 , V_139 ) ;
snprintf ( V_3 , sizeof( V_3 ) , L_27 , V_136 , F_145 ( V_135 -> V_140 ) ) ;
...
V_135 -> V_142 = V_13 ;
F_146 ( & V_18 -> V_22 . V_21 ) ;
F_147 ( & V_13 -> V_143 , & V_18 -> V_97 ) ;
F_148 ( & V_18 -> V_22 . V_21 ) ;
V_25:
if ( V_20 && V_13 ) {
F_8 ( V_13 ) ;
F_59 ( V_13 ) ;
...
long
F_153 ( struct V_145 * V_145 , unsigned int V_146 , unsigned long V_147 )
{
...
if ( V_20 < 0 && V_20 != - V_138 )
return V_20 ;
switch ( F_154 ( V_146 ) - V_151 ) {
case V_152 :
V_20 = F_155 ( V_148 , ( void V_153 * ) V_147 , F_156 ( V_146 ) ) ;
break;
default:
V_20 = F_157 ( V_145 , V_146 , V_147 ) ;
break;
}
F_88 ( V_11 -> V_11 ) ;
F_149 ( V_11 -> V_11 ) ;
...
struct V_10 *
F_159 ( const struct V_160 * V_161 ,
struct V_7 * V_2 ,
struct V_75 * * V_162 )
{
struct V_10 * V_18 ;
int V_163 ;
V_163 = F_160 ( V_161 , V_2 , V_23 , V_24 ,
true , true , ~ 0ULL , V_162 ) ;
if ( V_163 )
goto V_164;
V_18 = F_161 ( & V_165 , & V_2 -> V_11 ) ;
if ( F_162 ( V_18 ) ) {
V_163 = F_163 ( V_18 ) ;
goto V_164;
}
