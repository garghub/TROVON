...
{
int V_70 = - V_71 ;
struct V_72 * V_73 = F_21 ( V_20 ) ;
if ( V_20 -> V_74 == - V_75 )
return 0 ;
if ( ! V_73 ) {
V_73 = F_22 ( sizeof( * V_73 ) , V_76 ) ;
if ( ! V_73 )
return - V_77 ;
V_73 -> V_78 = false ;
F_23 ( V_20 , V_73 ) ;
}
if ( ! V_73 -> V_78 && F_24 ( V_20 -> V_74 ) ) {
V_70 = F_25 ( V_20 -> V_74 ,
( V_20 -> V_30 & V_79 ) ?
V_80 : V_81 ,
F_26 ( & V_20 -> V_43 ) ) ;
...
if ( F_24 ( V_20 -> V_74 ) ) {
int V_30 = ( ( V_20 -> V_30 & V_79 ) ?
V_80 : V_81 ) ;
V_70 = F_28 ( V_20 -> V_74 , V_30 ) ;
if ( V_70 )
F_27 ( & V_20 -> V_43 , L_3 ,
V_20 -> V_74 , V_70 ) ;
}
...
struct V_84 * V_85 ;
T_1 V_86 ;
V_22 = F_33 ( & V_83 -> V_43 , sizeof( * V_2 ) ) ;
if ( ! V_22 )
return - V_77 ;
V_2 = F_7 ( V_22 ) ;
V_22 -> V_43 . V_87 = V_83 -> V_43 . V_87 ;
F_34 ( V_83 , V_22 ) ;
V_85 = F_35 ( V_83 , V_88 , 0 ) ;
V_2 -> V_4 = F_36 ( & V_83 -> V_43 , V_85 ) ;
if ( F_37 ( V_2 -> V_4 ) ) {
V_70 = F_38 ( V_2 -> V_4 ) ;
goto V_89;
}
V_2 -> V_90 = F_39 ( & V_83 -> V_43 , L_4 ) ;
if ( F_37 ( V_2 -> V_90 ) ) {
F_27 ( & V_83 -> V_43 , L_5 ) ;
V_70 = F_38 ( V_2 -> V_90 ) ;
goto V_89;
}
V_2 -> V_37 = F_39 ( & V_83 -> V_43 , L_6 ) ;
if ( F_37 ( V_2 -> V_37 ) ) {
F_27 ( & V_83 -> V_43 , L_7 ) ;
V_70 = F_38 ( V_2 -> V_37 ) ;
goto V_89;
...
F_43 ( & V_83 -> V_43 ) ;
F_44 ( & V_83 -> V_43 ) ;
V_70 = F_45 ( V_83 -> V_43 . V_87 , L_10 , & V_86 ) ;
if ( V_70 < 0 )
V_22 -> V_93 = V_94 ;
else
V_22 -> V_93 = V_86 ;
V_70 = F_45 ( V_83 -> V_43 . V_87 , L_11 ,
& V_2 -> V_8 ) ;
if ( V_70 < 0 )
V_2 -> V_8 = 0 ;
F_5 ( V_2 ) ;
...
V_22 -> V_104 = F_29 ;
V_22 -> V_105 = true ;
V_22 -> V_106 = V_32 | V_31 ;
V_22 -> V_107 = F_10 ( V_2 -> V_37 ) / 4 ;
V_2 -> V_38 = V_22 -> V_107 ;
V_22 -> V_108 = F_50 ( 8 ) ;
V_70 = F_51 ( V_22 ) ;
if ( V_70 ) {
...
static int T_4 F_59 ( struct V_109 * V_43 )
{
struct V_82 * V_83 = F_60 ( V_43 ) ;
struct V_53 * V_22 = F_57 ( V_83 ) ;
return F_61 ( V_22 ) ;
}
static int T_4 F_62 ( struct V_109 * V_43 )
{
struct V_82 * V_83 = F_60 ( V_43 ) ;
struct V_53 * V_22 = F_57 ( V_83 ) ;
struct V_1 * V_2 = F_7 ( V_22 ) ;
...
static int T_4 F_64 ( struct V_109 * V_43 )
{
struct V_53 * V_22 = F_65 ( V_43 ) ;
struct V_1 * V_2 = F_7 ( V_22 ) ;
int V_70 ;
V_70 = F_40 ( V_2 -> V_90 ) ;
if ( V_70 ) {
...
static int T_4 F_67 ( struct V_109 * V_43 )
{
struct V_53 * V_22 = F_65 ( V_43 ) ;
struct V_1 * V_2 = F_7 ( V_22 ) ;
F_54 ( V_2 -> V_37 ) ;
