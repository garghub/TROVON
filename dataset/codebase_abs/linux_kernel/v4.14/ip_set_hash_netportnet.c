...
V_59 = F_41 ( V_15 , V_58 , & V_31 . V_16 [ 0 ] ) ;
...
static inline void
F_53 ( struct V_79 * V_29 ,
const struct V_79 * V_30 )
{
V_29 -> V_7 = V_30 -> V_7 ;
}
static void
F_54 ( struct V_79 * V_31 )
{
V_31 -> V_16 [ 0 ] = V_32 ;
V_31 -> V_16 [ 1 ] = V_32 ;
}
static int
F_55 ( struct V_33 * V_34 , const struct V_18 * V_19 ,
const struct V_35 * V_36 ,
enum V_37 V_38 , struct V_39 * V_40 )
{
...
if ( ! F_56 ( V_19 , V_40 -> V_12 & V_49 ,
& V_31 . V_7 , & V_31 . V_8 ) )
return - V_50 ;
F_57 ( V_19 , V_40 -> V_12 & V_51 , & V_31 . V_15 [ 0 ] . V_80 ) ;
F_57 ( V_19 , V_40 -> V_12 & V_52 , & V_31 . V_15 [ 1 ] . V_80 ) ;
F_50 ( & V_31 . V_15 [ 0 ] , V_31 . V_16 [ 0 ] ) ;
F_50 ( & V_31 . V_15 [ 1 ] , V_31 . V_16 [ 1 ] ) ;
return V_43 ( V_34 , & V_31 , & V_46 , & V_40 -> V_46 , V_40 -> V_53 ) ;
}
static int
F_58 ( struct V_33 * V_34 , struct V_54 * V_55 [] ,
enum V_37 V_38 , T_1 * V_56 , T_1 V_12 , bool V_57 )
{
const struct V_81 * V_42 = V_34 -> V_20 ;
T_3 V_43 = V_34 -> V_44 -> V_38 [ V_38 ] ;
...
return - V_82 ;
V_66 = F_59 ( V_55 [ V_21 ] , & V_31 . V_15 [ 0 ] ) ;
if ( V_66 )
return V_66 ;
V_66 = F_59 ( V_55 [ V_22 ] , & V_31 . V_15 [ 1 ] ) ;
if ( V_66 )
return V_66 ;
V_66 = F_29 ( V_34 , V_55 , & V_46 ) ;
if ( V_66 )
