...
if ( V_70 . V_71 && V_40 -> V_68 ) {
struct V_72 * V_73 ;
V_63 = F_15 ( V_40 -> V_68 , V_40 -> V_67 ) ,
V_73 = F_16 ( V_40 -> V_68 -> V_74 , V_63 ) ;
if ( V_73 ) {
struct V_75 * V_76 ;
F_17 (ilist, &inode->val, list) {
if ( V_55 )
V_12 += fprintf ( V_1 , L_17 ) ;
if ( V_41 )
V_12 += fprintf ( V_1 , L_23 ,
V_59 , L_5 ) ;
if ( V_43 )
V_12 += fprintf ( V_1 , L_24 ,
V_76 -> V_77 ) ;
if ( V_51 )
V_12 += fprintf ( V_1 , L_25 ,
V_76 -> V_78 ,
V_76 -> V_79 ) ;
if ( ! V_49 )
V_12 += fprintf ( V_1 , L_22 ) ;
...
int F_21 ( struct V_33 * V_34 , struct V_61 * V_81 ,
...
V_12 += fprintf ( V_1 , L_15 , V_35 , V_35 , L_16 ) ;
if ( V_41 )
V_12 += fprintf ( V_1 , L_26 V_66 , V_34 -> V_67 ) ;
if ( V_43 ) {
V_12 += fprintf ( V_1 , L_16 ) ;
if ( V_47 ) {
V_12 += F_11 ( V_81 -> V_64 , V_81 ,
V_53 ,
true , V_1 ) ;
} else {
V_12 += F_12 ( V_81 -> V_64 , V_81 ,
V_53 , V_1 ) ;
}
}
if ( V_45 ) {
V_12 += fprintf ( V_1 , L_19 ) ;
V_12 += F_13 ( V_81 -> V_68 , V_1 ) ;
V_12 += fprintf ( V_1 , L_20 ) ;
}
if ( V_51 )
V_12 += F_14 ( V_81 -> V_68 , V_81 -> V_63 , L_21 , V_1 ) ;
}
return V_12 ;
}
