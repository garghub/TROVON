...
V_151 = F_50 ( V_196 , & V_5 -> V_4 , & V_198 ,
V_199 , NULL ) ;
if ( V_151 ) {
...
F_51 ( & V_5 -> V_4 , & V_201 ) ;
V_5 -> V_4 . V_202 = F_52 ( 1 ) ;
V_151 = F_53 ( & V_5 -> V_4 , V_5 -> V_203 , NULL ) ;
if ( V_151 ) {
...
static int F_56 ( struct V_206 * V_207 )
{
struct V_192 * V_152 = & V_207 -> V_152 ;
struct V_1 * V_5 ;
struct V_208 * V_209 ;
struct V_210 * V_211 ;
int V_212 ;
int V_151 ;
V_5 = F_57 ( V_152 , sizeof( * V_5 ) , V_213 ) ;
if ( ! V_5 )
return - V_214 ;
V_5 -> V_152 = V_152 ;
V_209 = F_58 ( V_207 , V_215 , 0 ) ;
V_5 -> V_10 = F_59 ( V_152 , V_209 ) ;
if ( F_60 ( V_5 -> V_10 ) ) {
V_151 = F_61 ( V_5 -> V_10 ) ;
...
V_5 -> V_216 = F_63 ( V_207 , 0 ) ;
if ( V_5 -> V_216 <= 0 ) {
F_32 ( V_152 , L_15 , V_5 -> V_216 ) ;
return - V_217 ;
}
V_211 = F_64 ( V_152 -> V_197 , 0 , 0 ) ;
if ( ! V_211 )
return - V_218 ;
F_65 ( V_152 , L_16 , V_211 ) ;
V_5 -> V_203 = F_66 ( V_211 ) ;
F_67 ( V_211 ) ;
if ( ! V_5 -> V_203 )
return - V_219 ;
V_212 = F_68 ( V_152 -> V_197 , V_220 ) ;
if ( V_212 < 0 ) {
F_32 ( V_152 , L_17 , V_212 ) ;
return V_212 ;
}
V_151 = F_69 ( V_152 , V_152 -> V_197 , & V_5 -> V_191 , V_212 ,
& V_221 ) ;
if ( V_151 ) {
F_32 ( V_152 , L_18 , V_151 ) ;
return V_151 ;
}
F_70 ( V_207 , V_5 ) ;
V_151 = F_71 ( V_152 , & V_222 ) ;
if ( V_151 ) {
...
static int F_72 ( struct V_206 * V_207 )
{
F_73 ( & V_207 -> V_152 , & V_222 ) ;
return 0 ;
}
