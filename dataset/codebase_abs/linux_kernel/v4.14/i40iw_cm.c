...
static bool F_68 ( struct V_258 * V_170 , T_2 V_328 , bool V_329 )
{
struct V_318 * V_323 ;
struct V_18 * V_19 ;
unsigned long V_89 ;
...
if ( V_329 ) {
F_25 ( & V_170 -> V_273 , V_89 ) ;
F_64 (cm_node, &cm_core->connected_nodes, list) {
if ( V_19 -> V_38 == V_328 ) {
V_260 = true ;
break;
}
...
static enum V_331 F_70 (
struct V_83 * V_84 ,
struct V_53 * V_54 ,
struct V_318 * V_332 )
{
struct V_318 * V_333 ;
enum V_331 V_260 = V_334 ;
struct V_293 * V_335 , * V_336 ;
unsigned long V_89 ;
F_25 ( & V_84 -> V_170 . V_327 , V_89 ) ;
F_55 (pos, tpos, &cm_parent_listen_node->child_listen_list) {
V_333 = F_71 ( V_335 , struct V_318 , V_337 ) ;
if ( V_333 -> V_55 )
F_19 ( & V_84 -> V_338 ,
V_82 ,
L_24 ,
...
F_19 ( & V_84 -> V_338 , V_82 ,
L_25 ,
V_333 -> V_42 ,
V_333 -> V_38 ,
V_333 -> V_56 ) ;
F_72 ( V_335 ) ;
memcpy ( V_54 -> V_42 , V_333 -> V_42 ,
sizeof( V_54 -> V_42 ) ) ;
V_54 -> V_56 = V_333 -> V_56 ;
if ( V_333 -> V_339 ) {
V_260 = F_73 ( V_84 , V_54 ,
V_340 ,
V_341 ,
NULL , false ) ;
V_333 -> V_339 = false ;
...
static struct V_344 * F_74 ( T_3 * V_167 , T_2 * V_56 )
{
...
static enum V_331 F_84 ( struct V_83 * V_84 ,
struct V_53 * V_54 ,
struct V_318 * V_332 )
{
struct V_344 * V_345 ;
...
F_77 (&init_net, ip_dev) {
if ( ( ( ( F_79 ( V_345 ) < V_348 ) &&
( F_86 ( V_345 ) == V_84 -> V_350 ) ) ||
( V_345 == V_84 -> V_350 ) ) && ( V_345 -> V_89 & V_355 ) ) {
V_352 = F_87 ( V_345 ) ;
if ( ! V_352 ) {
F_16 ( L_27 ) ;
break;
...
V_19 = F_56 ( V_367 , struct V_18 , V_299 ) ;
...
F_26 ( & V_170 -> V_327 , V_89 ) ;
if ( V_363 -> V_84 ) {
if ( V_365 && ! F_68 ( V_170 , V_363 -> V_38 , false ) )
F_97 ( V_363 -> V_84 ,
V_363 -> V_38 ,
V_378 ) ;
...
if ( F_104 ( V_350 ) )
V_350 = F_105 ( V_350 ) ;
V_388 = F_106 ( V_26 , & V_319 ) ;
F_76 () ;
if ( V_388 ) {
F_19 ( & V_84 -> V_338 , V_82 , L_35 , V_388 -> V_396 ) ;
if ( V_388 -> V_392 & V_393 ) {
if ( V_384 >= 0 ) {
if ( F_107
( V_84 -> V_394 [ V_384 ] . V_395 ,
...
V_19 -> V_363 = V_363 ;
V_19 -> V_59 = V_54 -> V_59 ;
F_29 ( V_19 -> V_119 , V_350 -> V_356 ) ;
F_125 ( & V_19 -> V_90 ) ;
F_30 ( & V_19 -> V_88 , 1 ) ;
V_19 -> V_170 = V_170 ;
V_19 -> V_134 . V_135 = V_415 ;
V_19 -> V_134 . V_313 = V_416 ;
V_19 -> V_134 . V_165 =
V_417 >> V_416 ;
V_410 = F_126 () ;
...
if ( ! F_68 ( V_170 , V_19 -> V_38 , true ) && V_19 -> V_421 ) {
F_97 ( V_19 -> V_84 ,
V_19 -> V_38 ,
V_378 ) ;
V_19 -> V_421 = 0 ;
...
T_3 V_438 ;
V_260 = F_46 ( V_19 , V_435 , & V_438 , V_433 ) ;
if ( V_260 ) {
if ( V_19 -> V_173 == V_249 )
F_33 ( V_19 , true ) ;
else
...
V_19 -> V_134 . V_198 = V_461 -> V_134 . V_313 ;
V_461 -> V_134 . V_198 = V_19 -> V_134 . V_313 ;
V_461 -> V_173 = V_377 ;
F_17 ( V_461 , V_439 ) ;
}
return V_19 ;
...
F_125 ( & V_170 -> V_273 ) ;
F_125 ( & V_170 -> V_327 ) ;
V_170 -> V_476 = F_150 ( L_56 ,
V_477 ) ;
V_170 -> V_478 = F_150 ( L_57 ,
V_477 ) ;
}
...
V_480 -> V_485 = false ;
V_480 -> V_137 = V_486 ;
V_480 -> V_487 = F_155 ( V_488 ) ;
V_480 -> V_489 = F_155 ( V_490 ) ;
V_480 -> V_491 = V_492 ;
V_480 -> V_493 = V_494 ;
V_480 -> V_198 = V_19 -> V_134 . V_198 ;
V_480 -> V_313 = V_19 -> V_134 . V_313 ;
V_480 -> V_495 = F_155 ( V_19 -> V_134 . V_151 ) ;
V_480 -> V_203 = F_155 ( V_19 -> V_134 . V_203 ) ;
V_480 -> V_154 = F_155 ( V_19 -> V_134 . V_154 ) ;
V_480 -> V_496 = F_155 ( V_19 -> V_134 . V_151 ) ;
V_480 -> V_497 = F_155 ( V_19 -> V_134 . V_151 ) ;
V_480 -> V_498 = F_155 ( 2 * V_19 -> V_134 . V_196 ) ;
V_480 -> V_499 = F_155 ( V_19 -> V_134 . V_154 ) ;
V_480 -> V_500 = F_155 ( V_19 -> V_134 . V_151 ) ;
V_480 -> V_501 = F_155 ( V_19 -> V_134 . V_204 ) ;
V_480 -> V_165 = F_155 ( V_19 -> V_134 . V_165 <<
V_19 -> V_134 . V_313 ) ;
V_480 -> V_502 = 0 ;
V_480 -> V_503 = F_155 ( ( ( T_3 ) V_19 -> V_134 . V_196 ) ) ;
if ( V_19 -> V_56 < V_111 ) {
V_480 -> V_504 = true ;
V_480 -> V_505 = F_156 ( ( ( T_2 ) V_19 -> V_57 << V_506 ) |
V_19 -> V_56 ) ;
}
if ( V_19 -> V_55 ) {
V_480 -> V_507 = F_156 ( V_19 -> V_38 ) ;
V_480 -> V_320 = F_156 ( V_19 -> V_39 ) ;
V_480 -> V_508 = F_155 ( V_19 -> V_43 [ 0 ] ) ;
V_480 -> V_509 = F_155 ( V_19 -> V_42 [ 0 ] ) ;
V_480 -> V_510 =
F_156 ( ( T_2 ) F_109 (
V_178 -> V_84 ,
& V_480 -> V_508 ,
...
V_480 -> V_507 = F_156 ( V_19 -> V_38 ) ;
V_480 -> V_320 = F_156 ( V_19 -> V_39 ) ;
V_480 -> V_511 = F_155 ( V_19 -> V_43 [ 0 ] ) ;
V_480 -> V_512 = F_155 ( V_19 -> V_43 [ 1 ] ) ;
V_480 -> V_513 = F_155 ( V_19 -> V_43 [ 2 ] ) ;
V_480 -> V_508 = F_155 ( V_19 -> V_43 [ 3 ] ) ;
V_480 -> V_514 = F_155 ( V_19 -> V_42 [ 0 ] ) ;
V_480 -> V_515 = F_155 ( V_19 -> V_42 [ 1 ] ) ;
V_480 -> V_516 = F_155 ( V_19 -> V_42 [ 2 ] ) ;
V_480 -> V_509 = F_155 ( V_19 -> V_42 [ 3 ] ) ;
V_480 -> V_510 =
F_156 ( ( T_2 ) F_109 (
V_178 -> V_84 ,
& V_480 -> V_511 ,
...
struct V_297 * V_81 = & V_178 -> V_84 -> V_338 ;
memset ( & V_480 , 0x00 , sizeof( struct V_479 ) ) ;
V_518 = & V_178 -> V_518 ;
V_520 = & V_178 -> V_520 ;
V_520 -> V_480 = & V_480 ;
...
F_154 ( V_19 , & V_480 , V_178 ) ;
if ( V_19 -> V_254 ) {
V_518 -> V_254 = true ;
V_518 -> V_537 = ( V_480 . V_495 &
V_538 ) + V_19 -> V_539 ;
}
V_19 -> V_173 = V_302 ;
V_480 . V_493 = V_494 ;
V_480 . V_540 = V_84 -> V_541 ;
V_480 . V_131 = V_19 -> V_131 ;
...
F_163 ( V_84 -> V_338 . V_561 , & V_178 -> V_557 ) ;
}
}
if ( V_178 -> V_19 ) {
F_19 ( & V_84 -> V_338 , V_82 , L_60 , V_172 ) ;
F_145 ( V_178 -> V_19 ) ;
}
}
...
return - V_271 ;
V_19 -> V_170 -> V_616 ++ ;
if ( V_615 + sizeof( struct V_219 ) > V_250 )
return - V_271 ;
if ( V_371 ) {
...
F_74 ( V_54 . V_42 , & V_54 . V_56 ) ;
}
V_54 . V_59 = V_59 ;
V_54 . V_131 = V_59 -> V_131 ;
V_54 . V_57 = F_124 ( V_59 -> V_131 ) ;
F_19 ( & V_84 -> V_338 , V_413 , L_65 ,
...
F_25 ( & V_84 -> V_170 . V_273 , V_89 ) ;
if ( ! F_178 ( V_54 . V_38 , V_84 -> V_170 . V_330 ) ) {
F_26 ( & V_84 -> V_170 . V_273 , V_89 ) ;
if ( F_97 ( V_84 , V_54 . V_38 , V_618 ) ) {
V_260 = - V_271 ;
goto V_366;
}
} else {
...
int F_179 ( struct V_58 * V_59 , int V_444 )
{
struct V_83 * V_84 ;
struct V_318 * V_619 ;
struct V_53 V_54 ;
...
V_54 . V_444 = V_444 ;
V_54 . V_59 = V_59 ;
V_619 = F_141 ( & V_84 -> V_170 , V_84 , & V_54 ) ;
if ( ! V_619 ) {
F_16 ( L_69 ) ;
return - V_241 ;
}
V_59 -> V_72 = V_619 ;
V_619 -> V_131 = V_59 -> V_131 ;
V_619 -> V_57 = F_124 ( V_59 -> V_131 ) ;
V_54 . V_57 = V_619 -> V_57 ;
if ( ! V_619 -> V_458 ) {
if ( V_620 ) {
if ( V_54 . V_55 )
V_260 = F_90 ( V_84 ,
...
return 0 ;
error:
F_100 ( & V_84 -> V_170 , ( void * ) V_619 , false ) ;
return - V_271 ;
}
...
F_157 ( V_178 , V_19 ) ;
V_624 = ( V_19 -> V_231 == V_233 ) ;
if ( V_178 -> V_608 )
V_178 -> V_544 . V_609 . V_610 = F_172 ( V_178 -> V_608 ) ;
V_81 -> V_542 -> V_626 ( & V_178 -> V_544 , V_624 ) ;
if ( V_178 -> V_608 )
F_173 ( V_178 -> V_608 ) ;
...
static void F_182 ( struct V_78 * V_29 )
{
...
static void F_183 ( struct V_587 * V_548 )
{
...
F_159 ( & V_29 -> V_627 , F_183 ) ;
F_160 ( V_29 -> V_19 -> V_170 -> V_476 , & V_29 -> V_627 ) ;
}
static void F_184 ( struct V_83 * V_84 ,
struct V_318 * V_629 ,
struct V_53 * V_370 ,
T_3 * V_630 , bool V_55 , bool V_631 )
{
struct V_293 * V_337 = & V_629 -> V_337 ;
struct V_318 * V_333 ;
struct V_293 * V_335 , * V_336 ;
enum V_331 V_260 ;
bool V_632 = false ;
...
struct V_318 ,
V_337 ) ;
if ( ! memcmp ( V_333 -> V_42 , V_630 , V_55 ? 4 : 16 ) )
goto V_635;
}
if ( ! V_631 )
return;
...
return;
V_632 = true ;
memcpy ( V_333 , V_629 , sizeof( * V_333 ) ) ;
memcpy ( V_333 -> V_42 , V_630 , V_55 ? 4 : 16 ) ;
V_635:
memcpy ( V_370 -> V_42 ,
V_333 -> V_42 ,
sizeof( V_370 -> V_42 ) ) ;
V_370 -> V_56 = V_333 -> V_56 ;
V_260 = F_73 ( V_84 , V_370 ,
V_340 ,
V_634 ,
NULL , false ) ;
if ( ! V_260 ) {
...
V_19 = F_56 ( V_295 , struct V_18 , V_299 ) ;
F_34 ( & V_19 -> V_88 ) ;
F_57 ( & V_19 -> V_637 , & V_636 ) ;
}
F_26 ( & V_170 -> V_273 , V_89 ) ;
F_55 (list_node, list_core_temp, &connected_list) {
V_19 = F_56 ( V_295 , struct V_18 , V_637 ) ;
V_593 . V_613 = V_289 ;
...
void F_186 ( struct V_83 * V_84 , struct V_344 * V_350 ,
T_3 * V_630 , bool V_55 , bool V_631 )
{
struct V_258 * V_170 = & V_84 -> V_170 ;
unsigned long V_89 ;
...
F_64 (listen_node, &cm_core->listen_nodes, list) {
if ( V_56 == V_323 -> V_56 &&
( ! memcmp ( V_323 -> V_42 , V_630 , V_55 ? 4 : 16 ) ||
! memcmp ( V_323 -> V_42 , V_324 , V_55 ? 4 : 16 ) ) ) {
memcpy ( V_370 . V_42 , V_323 -> V_42 ,
sizeof( V_370 . V_42 ) ) ;
V_370 . V_38 = V_323 -> V_38 ;
V_370 . V_55 = V_323 -> V_55 ;
V_370 . V_56 = V_323 -> V_56 ;
V_370 . V_57 = V_323 -> V_57 ;
if ( ! F_98 ( & V_323 -> V_337 ) ) {
F_184 ( V_84 ,
V_323 ,
& V_370 ,
