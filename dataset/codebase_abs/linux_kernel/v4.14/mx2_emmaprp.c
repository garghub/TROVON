...
struct V_11 * V_16 ;
unsigned int V_129 , V_130 = * V_124 ;
V_16 = F_2 ( V_13 , V_101 -> type ) ;
if ( V_16 -> V_4 -> V_8 == V_104 )
V_129 = V_16 -> V_49 * V_16 -> V_50 * 3 / 2 ;
else
V_129 = V_16 -> V_49 * V_16 -> V_50 * 2 ;
while ( V_129 * V_130 > V_131 )
( V_130 ) -- ;
* V_125 = 1 ;
* V_124 = V_130 ;
V_126 [ 0 ] = V_129 ;
F_5 ( V_13 -> V_23 , L_17 , V_130 , V_129 ) ;
return 0 ;
}
...
V_134 -> V_144 = & V_145 ;
V_134 -> V_146 = V_147 ;
V_134 -> V_23 = V_13 -> V_23 -> V_51 . V_23 ;
V_117 = F_67 ( V_134 ) ;
if ( V_117 )
return V_117 ;
V_135 -> type = V_18 ;
...
V_135 -> V_144 = & V_145 ;
V_135 -> V_146 = V_147 ;
V_135 -> V_23 = V_13 -> V_23 -> V_51 . V_23 ;
return F_67 ( V_135 ) ;
}
...
return - V_149 ;
F_86 ( & V_22 -> V_77 ) ;
V_22 -> V_152 = F_87 ( & V_160 -> V_23 , L_22 ) ;
if ( F_74 ( V_22 -> V_152 ) ) {
return F_75 ( V_22 -> V_152 ) ;
}
V_22 -> V_153 = F_87 ( & V_160 -> V_23 , L_23 ) ;
if ( F_74 ( V_22 -> V_153 ) )
...
F_93 ( V_162 , V_22 ) ;
snprintf ( V_162 -> V_96 , sizeof( V_162 -> V_96 ) , L_25 , V_167 . V_96 ) ;
V_22 -> V_162 = V_162 ;
...
if ( V_117 )
goto V_170;
V_22 -> V_25 = F_99 ( & V_171 ) ;
if ( F_74 ( V_22 -> V_25 ) ) {
F_17 ( & V_22 -> V_51 , L_27 ) ;
V_117 = F_75 ( V_22 -> V_25 ) ;
goto V_170;
}
V_117 = F_100 ( V_162 , V_172 , 0 ) ;
if ( V_117 ) {
F_17 ( & V_22 -> V_51 , L_28 ) ;
goto V_173;
}
...
static int F_105 ( struct V_159 * V_160 )
{
struct V_21 * V_22 = F_106 ( V_160 ) ;
F_94 ( & V_22 -> V_51 , L_29 V_169 ) ;
F_107 ( V_22 -> V_162 ) ;
F_101 ( V_22 -> V_25 ) ;
F_103 ( & V_22 -> V_51 ) ;
F_104 ( & V_22 -> V_27 ) ;
