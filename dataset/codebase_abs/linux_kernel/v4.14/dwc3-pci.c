...
static int F_36 ( struct V_1 * V_2 , int V_48 )
{
union V_49 * V_50 ;
union V_49 V_51 ;
union V_49 V_52 = F_37 ( 1 , & V_51 ) ;
if ( ! V_2 -> V_20 )
return 0 ;
V_51 . type = V_53 ;
V_51 . integer . V_54 = V_48 ;
V_50 = F_38 ( F_39 ( & V_2 -> V_7 -> V_24 ) , & V_2 -> V_19 ,
1 , V_55 , & V_52 ) ;
if ( ! V_50 ) {
...
static int F_41 ( struct V_10 * V_24 )
{
struct V_1 * V_2 = F_42 ( V_24 ) ;
if ( F_43 ( V_24 ) )
return F_36 ( V_2 , V_57 ) ;
return - V_58 ;
}
static int F_44 ( struct V_10 * V_24 )
{
struct V_1 * V_2 = F_42 ( V_24 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
int V_15 ;
