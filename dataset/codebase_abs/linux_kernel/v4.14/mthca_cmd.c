...
V_2 -> V_13 . V_80 = F_41 ( L_3 , & V_2 -> V_77 -> V_2 ,
V_81 ,
V_81 , 0 ) ;
if ( ! V_2 -> V_13 . V_80 ) {
F_42 ( V_2 -> V_3 ) ;
...
F_223 ( V_221 , F_285 ( V_341 -> V_356 ) , F_282 ) ;
F_223 ( V_221 , V_341 -> V_357 , F_283 ) ;
if ( V_343 )
memcpy ( V_221 + F_284 , V_343 , 40 ) ;
V_9 |= 0x4 ;
V_8 |= F_285 ( V_341 -> V_356 ) << 16 ;
}
...
int F_287 ( struct V_1 * V_2 , int V_359 ,
struct V_85 * V_87 )
{
return F_33 ( V_2 , V_87 -> V_89 , V_359 , 0 , V_361 ,
V_113 ) ;
}
int F_288 ( struct V_1 * V_2 , struct V_85 * V_87 ,
T_4 * V_362 )
{
T_1 V_363 ;
int V_26 ;
...
{
return F_33 ( V_2 , 0 , 0x1f , 0 , V_365 , F_290 ( 100 ) ) ;
}
