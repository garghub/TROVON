...
int F_95 ( struct V_1 * V_2 , struct V_1 * V_135 ,
T_2 V_136 , T_2 V_137 , struct V_19 * V_24 )
{
...
if ( ! V_32 )
return 0 ;
if ( V_135 -> V_138 != F_29 ( V_32 ) ) {
V_135 -> V_138 = F_29 ( V_32 ) ;
V_135 -> V_120 = 1 ;
} else if ( ++ V_135 -> V_120 > 100 ) {
F_88 ( V_2 , V_32 ) ;
V_135 -> V_120 = 0 ;
if ( F_9 ( V_2 ) )
return V_68 ;
...
F_96 (&l->transmq, skb) {
if ( ! F_97 ( F_29 ( V_32 ) , V_136 ) )
break;
}
F_98 (&l->transmq, skb) {
if ( F_28 ( F_29 ( V_32 ) , V_137 ) )
break;
V_98 = F_49 ( V_32 ) ;
V_125 = F_99 ( V_32 , V_139 , V_46 ) ;
if ( ! V_125 )
return 0 ;
V_98 = F_49 ( V_125 ) ;
F_77 ( V_98 , V_29 ) ;
...
if ( ! F_102 ( V_32 , & V_149 , & V_153 ) )
return V_58 ;
F_70 ( V_32 ) ;
V_32 = V_149 ;
V_98 = F_49 ( V_32 ) ;
if ( F_97 ( F_92 ( V_98 ) , V_2 -> V_156 ) )
goto V_155;
...
F_42 ( & V_150 ) ;
V_2 -> V_72 . V_157 ++ ;
V_2 -> V_72 . V_158 += F_103 ( V_98 ) ;
while ( F_102 ( V_32 , & V_149 , & V_152 ) )
F_100 ( V_2 , V_149 , & V_150 ) ;
F_104 ( & V_150 , V_20 ) ;
return 0 ;
} else if ( V_151 == V_75 ) {
V_2 -> V_72 . V_159 ++ ;
...
struct V_19 * V_24 )
{
T_1 V_164 = ++ V_2 -> V_72 . V_165 ;
int V_166 , V_167 ;
if ( F_10 ( V_2 ) ) {
V_166 = V_164 & 0xf ;
V_167 = F_59 ( V_2 -> V_38 ) & 0xf ;
if ( V_166 == V_167 )
return V_162 ;
return 0 ;
}
if ( ( F_48 ( & V_2 -> V_33 ) == 1 ) || ! ( V_164 % V_168 ) )
F_57 ( V_2 , V_88 , 0 , 0 , 0 , 0 , V_24 ) ;
return 0 ;
}
...
struct V_19 * V_24 )
{
struct V_19 * V_169 = & V_2 -> V_33 ;
struct V_69 * V_98 ;
T_2 V_123 , V_35 , V_170 ;
int V_58 = 0 ;
do {
V_98 = F_49 ( V_32 ) ;
V_123 = F_92 ( V_98 ) ;
...
V_2 -> V_90 = 0 ;
if ( F_73 ( F_97 ( V_123 , V_35 ) || F_28 ( V_123 , V_170 ) ) ) {
V_2 -> V_72 . V_174 ++ ;
goto V_155;
}
...
if ( F_73 ( ++ V_2 -> V_92 >= V_176 ) )
V_58 |= F_112 ( V_2 , V_24 ) ;
if ( F_73 ( V_58 & ~ V_162 ) )
break;
} while ( ( V_32 = F_81 ( V_169 ) ) );
return V_58 ;
V_155:
F_70 ( V_32 ) ;
return V_58 ;
...
T_2 V_177 , int V_18 , int V_17 ,
struct V_19 * V_24 )
{
struct V_1 * V_178 = V_2 -> V_12 ;
struct V_31 * V_32 ;
struct V_69 * V_98 ;
struct V_19 * V_179 = & V_2 -> V_33 ;
bool V_180 = F_1 ( V_178 ) ;
struct V_85 * V_86 = & V_2 -> V_87 ;
int V_181 = 0 ;
void * V_182 ;
if ( F_8 ( V_2 ) )
...
return;
if ( ! F_56 ( V_179 ) )
V_177 = F_29 ( F_27 ( V_179 ) ) - V_2 -> V_35 ;
V_32 = F_61 ( V_172 , V_80 , V_102 ,
V_183 , V_2 -> V_47 ,
F_59 ( V_2 -> V_38 ) , 0 , 0 , 0 ) ;
if ( ! V_32 )
return;
...
F_129 ( V_98 , V_180 ) ;
F_130 ( V_98 , 0 ) ;
F_76 ( V_98 , V_2 -> V_28 + V_184 / 2 ) ;
if ( V_80 == V_88 ) {
F_130 ( V_98 , V_177 ) ;
F_131 ( V_98 , F_26 ( V_178 ) ) ;
F_132 ( V_98 , V_81 ) ;
F_133 ( V_2 -> V_38 , V_182 , & V_181 , V_86 , V_2 -> V_15 ) ;
F_134 ( V_98 , V_102 + V_181 ) ;
F_135 ( V_32 , V_102 + V_181 ) ;
V_2 -> V_72 . V_185 ++ ;
V_2 -> V_92 = 0 ;
} else {
F_136 ( V_98 , V_2 -> V_50 ) ;
strcpy ( V_182 , V_2 -> V_39 ) ;
F_134 ( V_98 , V_102 + V_186 ) ;
F_135 ( V_32 , V_102 + V_186 ) ;
}
if ( V_81 )
V_2 -> V_72 . V_187 ++ ;
if ( V_177 )
...
void F_137 ( struct V_1 * V_2 , struct V_1 * V_189 ,
int V_80 , struct V_19 * V_24 )
{
struct V_31 * V_32 , * V_190 ;
struct V_69 * V_98 , V_191 ;
struct V_19 * V_192 = & V_2 -> V_51 ;
struct V_19 V_193 , V_194 ;
T_2 V_195 , V_196 , V_123 = V_2 -> V_28 ;
if ( ! V_189 )
return;
F_42 ( & V_194 ) ;
F_42 ( & V_193 ) ;
V_32 = F_61 ( V_113 , V_197 ,
V_198 , 0 , V_2 -> V_47 , F_59 ( V_2 -> V_38 ) ,
0 , 0 , V_199 ) ;
if ( ! V_32 ) {
F_75 ( L_12 , V_200 ) ;
return;
...
F_65 ( & V_194 , V_32 ) ;
F_72 ( V_2 , & V_194 , & V_193 ) ;
F_24 ( & V_193 ) ;
F_138 ( F_59 ( V_2 -> V_38 ) , & V_191 , V_146 ,
V_80 , V_102 , V_2 -> V_47 ) ;
V_196 = F_48 ( & V_2 -> V_51 ) + F_48 ( & V_2 -> V_52 ) ;
F_139 ( & V_191 , V_196 ) ;
F_122 ( & V_191 , V_2 -> V_14 ) ;
V_189:
F_96 (queue, skb) {
V_98 = F_49 ( V_32 ) ;
if ( V_192 == & V_2 -> V_52 )
F_76 ( V_98 , V_123 ++ ) ;
V_195 = F_50 ( V_98 ) ;
F_134 ( & V_191 , V_195 + V_102 ) ;
V_190 = F_140 ( V_195 + V_102 , V_46 ) ;
if ( ! V_190 ) {
F_75 ( L_13 , V_200 ) ;
return;
}
F_141 ( V_190 , & V_191 , V_102 ) ;
F_142 ( V_190 , V_102 , V_98 , V_195 ) ;
F_82 ( & V_194 , V_190 ) ;
}
if ( V_192 != & V_2 -> V_52 ) {
V_192 = & V_2 -> V_52 ;
...
F_72 ( V_189 , & V_194 , V_24 ) ;
if ( V_80 == V_201 ) {
V_189 -> V_156 = V_2 -> V_35 ;
V_189 -> V_119 = V_2 -> V_118 ;
V_2 -> V_118 = NULL ;
}
}
...
T_2 V_29 = F_118 ( V_98 ) ;
T_2 V_34 = F_143 ( V_98 ) ;
T_2 V_202 = F_144 ( V_98 ) ;
T_2 V_203 = F_145 ( V_98 ) ;
T_2 V_204 = F_146 ( V_98 ) ;
T_2 V_35 = V_2 -> V_35 ;
T_2 V_181 = F_147 ( V_98 ) ;
int V_80 = F_52 ( V_98 ) ;
void * V_182 ;
char * V_39 ;
int V_58 = 0 ;
...
if ( sizeof( V_2 -> V_37 ) - ( V_39 - V_2 -> V_37 ) <= V_186 )
break;
if ( F_147 ( V_98 ) < V_186 )
break;
strncpy ( V_39 , V_182 , V_186 ) ;
if ( F_152 ( V_203 , V_205 , V_206 ) )
V_2 -> V_18 = V_203 ;
if ( F_152 ( V_204 , V_2 -> V_17 + 1 , V_207 ) )
V_2 -> V_17 = V_204 ;
if ( F_153 ( V_98 ) )
V_58 = F_45 ( V_2 , V_61 ) ;
...
F_157 ( V_2 -> V_38 , V_182 , V_181 , V_2 -> V_47 ,
& V_2 -> V_87 , V_2 -> V_15 ) ;
if ( F_28 ( V_202 , V_35 ) && ! F_6 ( V_2 ) )
V_177 = V_202 - V_2 -> V_35 ;
if ( V_177 || ( F_156 ( V_98 ) ) )
F_57 ( V_2 , V_88 , 0 , V_177 ,
0 , 0 , V_24 ) ;
F_110 ( V_2 , V_29 ) ;
if ( V_34 ) {
V_58 = F_95 ( V_2 , V_2 , V_29 + 1 , V_29 + V_34 , V_24 ) ;
V_2 -> V_72 . V_210 ++ ;
}
F_87 ( V_2 , V_24 ) ;
if ( F_73 ( ! F_56 ( & V_2 -> V_53 ) ) )
...
static bool F_158 ( struct V_1 * V_2 , bool V_211 ,
T_2 V_202 ,
struct V_19 * V_24 )
{
struct V_31 * V_32 ;
struct V_69 * V_98 ;
struct V_31 * V_212 = F_27 ( & V_2 -> V_33 ) ;
T_2 V_29 = V_2 -> V_35 - 1 ;
T_2 V_213 = V_202 - 1 ;
V_32 = F_61 ( V_147 , V_88 , V_102 ,
...
static bool F_164 ( struct V_1 * V_2 , T_2 * V_136 , T_2 * V_137 )
{
unsigned long V_215 = F_165 ( V_216 - V_2 -> V_217 ) ;
if ( F_97 ( * V_137 , * V_136 ) )
return false ;
if ( ( V_215 > V_218 ) ||
F_97 ( * V_137 , V_2 -> V_219 ) || F_28 ( * V_136 , V_2 -> V_220 ) ) {
V_2 -> V_219 = * V_136 ;
V_2 -> V_220 = * V_137 ;
V_2 -> V_217 = V_216 ;
return true ;
}
if ( ! F_97 ( * V_136 , V_2 -> V_219 ) && ! F_28 ( * V_137 , V_2 -> V_220 ) )
return false ;
if ( F_97 ( * V_136 , V_2 -> V_219 ) ) {
* V_137 = V_2 -> V_219 - 1 ;
V_2 -> V_219 = * V_136 ;
}
if ( F_28 ( * V_137 , V_2 -> V_220 ) ) {
* V_136 = V_2 -> V_220 + 1 ;
V_2 -> V_220 = * V_137 ;
}
V_2 -> V_217 = V_216 ;
...
T_2 V_202 = F_162 ( V_98 ) ;
T_2 V_136 = F_167 ( V_98 ) + 1 ;
T_2 V_137 = V_136 + F_168 ( V_98 ) - 1 ;
int V_58 = 0 ;
if ( ! F_1 ( V_2 ) )
return V_58 ;
if ( ! F_163 ( V_98 ) )
...
return V_58 ;
V_2 -> V_72 . V_210 ++ ;
if ( F_28 ( V_202 , V_2 -> V_35 + V_2 -> V_16 ) )
return V_58 ;
if ( F_164 ( V_22 , & V_136 , & V_137 ) )
V_58 = F_95 ( V_22 , V_2 , V_136 , V_137 , V_24 ) ;
V_2 -> V_28 = V_202 ;
if ( F_26 ( V_2 ) )
V_58 |= V_162 ;
if ( V_2 -> V_43 & V_221 )
return V_58 ;
if ( ! F_28 ( V_202 , V_2 -> V_35 ) ) {
V_2 -> V_222 = V_223 ;
return 0 ;
}
if ( V_2 -> V_222 == V_224 ) {
...
if ( V_2 -> V_222 == V_223 ) {
V_2 -> V_222 = V_225 ;
if ( ( V_202 - V_2 -> V_35 ) < V_176 )
return 0 ;
}
F_158 ( V_2 , true , V_202 , V_24 ) ;
V_2 -> V_222 = V_224 ;
return 0 ;
}
...
F_22 ( V_2 , V_27 , V_24 ) ;
V_58 = F_95 ( V_2 -> V_11 , V_2 , V_136 , V_137 , V_24 ) ;
V_2 -> V_72 . V_210 ++ ;
return V_58 ;
}
if ( F_28 ( V_202 , V_2 -> V_35 ) && ! F_97 ( V_2 -> V_35 , V_136 ) )
V_2 -> V_222 = V_224 ;
return 0 ;
}
void F_40 ( struct V_1 * V_2 , T_1 V_226 )
{
int V_227 = V_228 / ( V_2 -> V_36 / V_229 ) ;
V_2 -> V_16 = V_226 ;
V_2 -> V_110 [ V_113 ] . V_112 = F_173 ( T_2 , 50 , V_226 ) ;
V_2 -> V_110 [ V_114 ] . V_112 = F_173 ( T_2 , 100 , V_226 * 2 ) ;
V_2 -> V_110 [ V_115 ] . V_112 = F_173 ( T_2 , 150 , V_226 * 3 ) ;
V_2 -> V_110 [ V_116 ] . V_112 = F_173 ( T_2 , 200 , V_226 * 4 ) ;
V_2 -> V_110 [ V_117 ] . V_112 = V_227 ;
}
void F_71 ( struct V_1 * V_2 )
{
memset ( & V_2 -> V_72 , 0 , sizeof( V_2 -> V_72 ) ) ;
}
static void F_89 ( struct V_1 * V_2 , const char * V_230 )
{
struct V_31 * V_231 = F_27 ( & V_2 -> V_51 ) ;
T_2 V_232 = V_231 ? F_92 ( F_49 ( V_231 ) ) : V_2 -> V_28 - 1 ;
T_2 V_233 = V_2 -> V_28 - 1 ;
F_90 ( L_14 , V_230 , V_2 -> V_37 , V_2 -> V_3 ) ;
F_90 ( L_15 ,
F_48 ( & V_2 -> V_51 ) , V_232 , V_233 ,
F_48 ( & V_2 -> V_52 ) , V_2 -> V_28 , V_2 -> V_35 ) ;
}
int F_174 ( struct V_234 * V_235 , struct V_234 * V_236 [] )
{
int V_237 ;
V_237 = F_175 ( V_236 , V_238 , V_235 ,
V_239 , NULL ) ;
if ( V_237 )
return V_237 ;
if ( V_236 [ V_240 ] ) {
T_1 V_241 ;
V_241 = F_176 ( V_236 [ V_240 ] ) ;
if ( V_241 > V_207 )
return - V_242 ;
}
if ( V_236 [ V_243 ] ) {
T_1 V_244 ;
V_244 = F_176 ( V_236 [ V_243 ] ) ;
if ( ( V_244 < V_205 ) || ( V_244 > V_206 ) )
return - V_242 ;
}
if ( V_236 [ V_245 ] ) {
T_1 V_226 ;
V_226 = F_176 ( V_236 [ V_245 ] ) ;
if ( ( V_226 < V_176 ) || ( V_226 > V_171 ) )
return - V_242 ;
}
return 0 ;
}
static int F_177 ( struct V_31 * V_32 , struct V_246 * V_247 )
{
int V_109 ;
struct V_234 * V_72 ;
struct V_248 {
...
{ V_283 , V_247 -> V_284 } ,
{ V_285 , V_247 -> V_74 ?
( V_247 -> V_73 / V_247 -> V_74 ) : 0 }
} ;
V_72 = F_178 ( V_32 , V_286 ) ;
if ( ! V_72 )
return - V_128 ;
for ( V_109 = 0 ; V_109 < F_179 ( V_251 ) ; V_109 ++ )
if ( F_180 ( V_32 , V_251 [ V_109 ] . V_249 , V_251 [ V_109 ] . V_250 ) )
goto V_287;
F_181 ( V_32 , V_72 ) ;
return 0 ;
V_287:
...
int F_183 ( struct V_38 * V_38 , struct V_288 * V_70 ,
struct V_1 * V_45 , int V_289 )
{
int V_237 ;
void * V_98 ;
struct V_234 * V_290 ;
struct V_234 * V_235 ;
struct V_291 * V_292 = F_184 ( V_38 , V_293 ) ;
V_98 = F_185 ( V_70 -> V_32 , V_70 -> V_294 , V_70 -> V_295 , & V_296 ,
V_289 , V_297 ) ;
if ( ! V_98 )
return - V_128 ;
V_290 = F_178 ( V_70 -> V_32 , V_298 ) ;
if ( ! V_290 )
goto V_287;
if ( F_186 ( V_70 -> V_32 , V_299 , V_45 -> V_37 ) )
goto V_300;
if ( F_180 ( V_70 -> V_32 , V_301 ,
F_187 ( V_292 -> V_302 ) ) )
goto V_300;
if ( F_180 ( V_70 -> V_32 , V_303 , V_45 -> V_36 ) )
goto V_300;
if ( F_180 ( V_70 -> V_32 , V_304 , V_45 -> V_72 . V_175 ) )
goto V_300;
if ( F_180 ( V_70 -> V_32 , V_305 , V_45 -> V_72 . V_132 ) )
goto V_300;
if ( F_2 ( V_45 ) )
if ( F_188 ( V_70 -> V_32 , V_306 ) )
goto V_300;
if ( V_45 -> V_13 )
if ( F_188 ( V_70 -> V_32 , V_307 ) )
goto V_300;
V_235 = F_178 ( V_70 -> V_32 , V_308 ) ;
if ( ! V_235 )
goto V_300;
if ( F_180 ( V_70 -> V_32 , V_240 , V_45 -> V_17 ) )
goto V_309;
if ( F_180 ( V_70 -> V_32 , V_243 , V_45 -> V_18 ) )
goto V_309;
if ( F_180 ( V_70 -> V_32 , V_245 ,
V_45 -> V_16 ) )
goto V_309;
if ( F_180 ( V_70 -> V_32 , V_240 , V_45 -> V_17 ) )
goto V_309;
F_181 ( V_70 -> V_32 , V_235 ) ;
V_237 = F_177 ( V_70 -> V_32 , & V_45 -> V_72 ) ;
if ( V_237 )
goto V_300;
F_181 ( V_70 -> V_32 , V_290 ) ;
F_189 ( V_70 -> V_32 , V_98 ) ;
return 0 ;
V_309:
F_182 ( V_70 -> V_32 , V_235 ) ;
V_300:
F_182 ( V_70 -> V_32 , V_290 ) ;
V_287:
...
int F_192 ( struct V_38 * V_38 , struct V_288 * V_70 )
{
int V_237 ;
void * V_98 ;
struct V_234 * V_290 ;
...
if ( F_188 ( V_70 -> V_32 , V_306 ) )
goto V_300;
if ( F_188 ( V_70 -> V_32 , V_312 ) )
goto V_300;
if ( F_186 ( V_70 -> V_32 , V_299 , V_178 -> V_37 ) )
goto V_300;
if ( F_180 ( V_70 -> V_32 , V_304 , 0 ) )
goto V_300;
if ( F_180 ( V_70 -> V_32 , V_305 , 0 ) )
goto V_300;
V_235 = F_178 ( V_70 -> V_32 , V_308 ) ;
if ( ! V_235 )
goto V_300;
if ( F_180 ( V_70 -> V_32 , V_245 , V_178 -> V_16 ) )
goto V_309;
F_181 ( V_70 -> V_32 , V_235 ) ;
V_237 = F_191 ( V_70 -> V_32 , & V_178 -> V_72 ) ;
if ( V_237 )
goto V_300;
F_109 ( V_38 ) ;
F_181 ( V_70 -> V_32 , V_290 ) ;
...
void F_193 ( struct V_1 * V_2 , T_1 V_244 ,
struct V_19 * V_24 )
{
V_2 -> V_18 = V_244 ;
F_57 ( V_2 , V_88 , 0 , 0 , V_244 , 0 , V_24 ) ;
}
void F_194 ( struct V_1 * V_2 , T_1 V_241 ,
struct V_19 * V_24 )
{
V_2 -> V_17 = V_241 ;
F_57 ( V_2 , V_88 , 0 , 0 , 0 , V_241 , V_24 ) ;
}
