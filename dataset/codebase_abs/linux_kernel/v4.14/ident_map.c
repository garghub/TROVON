...
return - V_20 ;
F_1 ( V_2 , V_8 , V_4 , V_12 ) ;
F_10 ( V_13 , F_9 ( F_12 ( V_8 ) | V_2 -> V_21 ) ) ;
}
return 0 ;
}
...
return - V_20 ;
F_6 ( V_2 , V_13 , V_4 , V_12 ) ;
F_17 ( V_23 , F_18 ( F_12 ( V_13 ) | V_2 -> V_21 ) ) ;
}
return 0 ;
}
...
return V_29 ;
if ( F_23 ( V_34 ) ) {
F_24 ( V_31 , F_25 ( F_12 ( V_23 ) | V_2 -> V_21 ) ) ;
} else {
T_2 * V_13 = F_16 ( V_23 , 0 ) ;
F_24 ( V_31 , F_25 ( F_12 ( V_13 ) | V_2 -> V_21 ) ) ;
}
}
return 0 ;
}
