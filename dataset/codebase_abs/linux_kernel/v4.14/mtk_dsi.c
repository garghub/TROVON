...
{
struct V_1 * V_11 ;
struct V_125 * V_126 = & V_218 -> V_126 ;
struct V_219 * V_16 ;
int V_220 ;
int V_221 ;
int V_110 ;
V_11 = F_97 ( V_126 , sizeof( * V_11 ) , V_222 ) ;
if ( ! V_11 )
return - V_223 ;
V_11 -> V_10 . V_224 = & V_225 ;
...
V_221 = F_105 ( V_126 -> V_214 , V_227 ) ;
if ( V_221 < 0 ) {
F_42 ( V_126 , L_33 , V_221 ) ;
return V_221 ;
}
V_110 = F_106 ( V_126 , V_126 -> V_214 , & V_11 -> V_175 , V_221 ,
& V_228 ) ;
if ( V_110 ) {
...
V_220 = F_107 ( V_218 , 0 ) ;
if ( V_220 < 0 ) {
F_42 ( & V_218 -> V_126 , L_35 ) ;
return - V_229 ;
}
F_108 ( V_220 , V_230 ) ;
V_110 = F_109 ( & V_218 -> V_126 , V_220 , F_35 ,
V_231 , F_110 ( & V_218 -> V_126 ) , V_11 ) ;
if ( V_110 ) {
F_42 ( & V_218 -> V_126 , L_36 ) ;
return - V_229 ;
}
F_111 ( & V_11 -> V_112 ) ;
F_112 ( V_218 , V_11 ) ;
return F_113 ( & V_218 -> V_126 , & V_232 ) ;
}
static int F_114 ( struct V_217 * V_218 )
{
struct V_1 * V_11 = F_115 ( V_218 ) ;
F_53 ( V_11 ) ;
F_116 ( & V_218 -> V_126 , & V_232 ) ;
return 0 ;
}
