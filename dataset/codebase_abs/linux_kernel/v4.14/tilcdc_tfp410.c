...
static int F_32 ( struct V_44 * V_7 , struct V_12 * V_13 )
{
struct V_14 * V_45 = F_33 ( V_7 ) ;
...
F_43 ( V_57 ) ;
V_45 -> V_8 = F_44 ( V_55 , L_11 ,
0 , NULL ) ;
if ( V_45 -> V_8 < 0 ) {
F_39 ( & V_53 -> V_13 , L_12 ) ;
} else {
V_15 = F_45 ( V_45 -> V_8 , L_13 ) ;
if ( V_15 ) {
F_10 ( & V_53 -> V_13 , L_14 ) ;
goto V_64;
}
...
{
struct V_44 * V_7 = F_49 ( & V_53 -> V_13 ) ;
struct V_14 * V_45 = F_33 ( V_7 ) ;
F_46 ( V_45 -> V_28 ) ;
F_50 ( V_45 -> V_8 ) ;
F_47 ( V_7 ) ;
