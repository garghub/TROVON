...
int V_77 ;
V_21 = F_21 ( V_1 , V_2 , V_3 , V_22 ) ;
for ( V_77 = 0 ; V_77 < F_46 ( V_78 ) ; V_77 ++ ) {
T_7 V_79 = V_78 [ V_77 ] . V_79 ;
if ( V_78 [ V_77 ] . V_21 != V_21 )
continue;
V_70 = ( F_47 ( V_70 ) ) V_79 ;
...
static void T_1 F_51 ( int V_81 , int V_2 , int V_3 )
{
void T_8 * V_82 ;
T_4 V_83 ;
T_9 V_84 ;
...
if ( ! V_85 )
return;
V_83 = F_21 ( V_81 , V_2 , V_3 , V_86 + V_87 ) ;
if ( ( V_83 & V_88 ) != V_89 ) {
V_83 &= ~ V_88 ;
F_52 ( V_81 , V_2 , V_3 , V_86 + V_87 , V_83 ) ;
F_53 ( 10 ) ;
V_83 = F_21 ( V_81 , V_2 , V_3 , V_86 + V_87 ) ;
if ( ( V_83 & V_88 ) != V_89 ) {
F_54 ( L_21 ) ;
...
V_84 = F_2 ( V_81 , V_2 , V_3 , V_90 ) ;
V_84 |= ( T_9 ) F_2 ( V_81 , V_2 , V_3 , V_91 ) << 32 ;
V_84 &= V_92 ;
V_82 = F_55 ( V_84 , V_93 ) ;
if ( ! V_82 ) {
F_54 ( L_22 ) ;
...
F_50 ( L_23 ) ;
for ( V_77 = 0 ; F_56 ( V_94 ) && V_77 < 30 ; V_77 ++ )
F_57 ( 10 ) ;
F_58 ( V_95 , V_96 ) ;
F_56 ( V_95 ) ;
F_57 ( 1 ) ;
...
static int T_1 F_60 ( int V_1 , int V_2 , int V_3 )
{
T_4 V_97 ;
T_4 V_98 ;
T_4 V_21 ;
...
T_3 V_99 ;
int V_77 ;
V_97 = F_21 ( V_1 , V_2 , V_3 , V_100 ) ;
if ( V_97 == 0xffff )
return - 1 ;
V_98 = F_21 ( V_1 , V_2 , V_3 , V_101 ) ;
V_21 = F_21 ( V_1 , V_2 , V_3 , V_22 ) ;
for ( V_77 = 0 ; V_102 [ V_77 ] . V_103 != NULL ; V_77 ++ ) {
if ( ( ( V_102 [ V_77 ] . V_98 == V_104 ) ||
( V_102 [ V_77 ] . V_98 == V_98 ) ) &&
( ( V_102 [ V_77 ] . V_21 == V_104 ) ||
( V_102 [ V_77 ] . V_21 == V_21 ) ) &&
( ! ( ( V_102 [ V_77 ] . V_97 ^ V_97 ) &
V_102 [ V_77 ] . V_105 ) ) ) {
if ( ( V_102 [ V_77 ] . V_106 &
V_107 ) != V_107 )
V_102 [ V_77 ] . V_103 ( V_1 , V_2 , V_3 ) ;
V_102 [ V_77 ] . V_106 |= V_108 ;
}
}
type = F_13 ( V_1 , V_2 , V_3 ,
V_109 ) ;
if ( ( type & 0x7f ) == V_110 ) {
V_99 = F_13 ( V_1 , V_2 , V_3 , V_111 ) ;
if ( V_99 > V_1 )
F_61 ( V_99 ) ;
}
if ( ! ( type & 0x80 ) )
...
static void T_1 F_61 ( int V_81 )
{
int V_2 , V_3 ;
for ( V_2 = 0 ; V_2 < 32 ; V_2 ++ )
for ( V_3 = 0 ; V_3 < 8 ; V_3 ++ ) {
if ( F_60 ( V_81 , V_2 , V_3 ) )
break;
}
}
void T_1 F_62 ( void )
