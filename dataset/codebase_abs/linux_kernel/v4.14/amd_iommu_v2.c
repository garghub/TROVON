...
int F_67 ( struct V_1 * V_2 , int V_18 ,
struct V_95 * V_96 )
{
struct V_17 * V_17 ;
struct V_7 * V_8 ;
...
if ( V_27 )
goto V_102;
V_27 = F_74 ( V_8 -> V_15 , V_18 ,
F_75 ( V_17 -> V_38 -> V_103 ) ) ;
if ( V_27 )
goto V_104;
V_17 -> V_32 = false ;
F_76 ( V_38 ) ;
...
void F_77 ( struct V_1 * V_2 , int V_18 )
{
struct V_17 * V_17 ;
struct V_7 * V_8 ;
T_1 V_3 ;
...
int F_78 ( struct V_1 * V_2 , int V_105 )
{
struct V_7 * V_8 ;
struct V_12 * V_13 ;
unsigned long V_9 ;
...
if ( ! F_68 () )
return - V_89 ;
if ( V_105 <= 0 || V_105 > ( V_107 + 1 ) )
return - V_97 ;
V_3 = F_1 ( V_2 ) ;
V_8 = F_64 ( sizeof( * V_8 ) , V_98 ) ;
if ( V_8 == NULL )
return - V_29 ;
F_71 ( & V_8 -> V_28 ) ;
F_70 ( & V_8 -> V_16 ) ;
...
V_8 -> V_3 = V_3 ;
V_106 = V_105 ;
for ( V_8 -> V_24 = 0 ; ( V_106 - 1 ) & ~ 0x1ff ; V_106 >>= 9 )
V_8 -> V_24 += 1 ;
F_69 ( & V_8 -> V_11 , 1 ) ;
V_8 -> V_36 = V_105 ;
V_27 = - V_29 ;
V_8 -> V_25 = ( void * ) F_19 ( V_98 ) ;
if ( V_8 -> V_25 == NULL )
goto V_108;
V_8 -> V_15 = F_79 ( & V_109 ) ;
if ( V_8 -> V_15 == NULL )
