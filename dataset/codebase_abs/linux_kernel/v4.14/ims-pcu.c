...
while ( V_194 >= sizeof( * V_196 ) ) {
V_196 = (struct V_191 * ) V_139 ;
if ( V_196 -> V_197 > V_194 ) {
F_6 ( & V_141 -> V_13 , L_49 ) ;
return NULL ;
}
if ( V_196 -> V_198 == V_199 &&
V_196 -> V_200 == V_201 ) {
F_35 ( & V_141 -> V_13 , L_50 ) ;
if ( V_196 -> V_197 >= sizeof( * V_196 ) )
return V_196 ;
F_6 ( & V_141 -> V_13 ,
L_51 ,
V_196 -> V_197 , sizeof( * V_196 ) ) ;
return NULL ;
}
V_194 -= V_196 -> V_197 ;
V_139 += V_196 -> V_197 ;
...
if ( V_203 -> V_206 . V_207 < 1 )
return - V_124 ;
V_2 -> V_189 = & V_203 -> V_208 [ 0 ] . V_206 ;
V_2 -> V_184 = F_116 ( V_2 -> V_189 ) ;
V_2 -> V_209 = F_115 ( V_2 -> V_17 ,
V_196 -> V_210 ) ;
if ( ! V_2 -> V_209 )
return - V_79 ;
V_203 = V_2 -> V_209 -> V_205 ;
if ( V_203 -> V_206 . V_207 != 2 ) {
F_6 ( V_2 -> V_13 ,
L_53 ,
V_203 -> V_206 . V_207 ) ;
return - V_79 ;
}
V_2 -> V_67 = & V_203 -> V_208 [ 0 ] . V_206 ;
if ( ! F_117 ( V_2 -> V_67 ) ) {
F_6 ( V_2 -> V_13 ,
L_54 ) ;
return - V_79 ;
...
* V_226 = V_2 -> V_49 [ V_88 ] ;
F_35 ( V_2 -> V_13 , L_69 , * V_226 ) ;
return 0 ;
}
static int F_127 ( struct V_1 * V_2 )
{
static T_8 V_16 = F_128 ( - 1 ) ;
