...
V_119 = F_56 ( V_119 ) ;
F_57 ( & V_2 -> V_122 , V_119 ) ;
}
F_58 ( & V_2 -> V_114 , V_112 ) ;
}
static void F_59 ( unsigned long V_123 )
{
struct V_1 * V_2 = (struct V_1 * ) V_123 ;
F_49 ( V_2 ) ;
}
int F_60 ( struct V_1 * V_2 , struct V_124 * V_52 ,
T_1 V_24 , struct V_76 * V_28 ,
int V_125 , struct V_126 * V_75 ,
char * V_111 )
{
switch ( V_24 ) {
case V_39 :
...
V_2 -> V_78 = V_125 ;
V_2 -> V_75 = V_75 ;
F_62 ( & V_2 -> V_122 , F_59 , ( unsigned long ) V_2 ) ;
return 0 ;
}
