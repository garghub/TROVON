...
if ( F_61 ( F_52 ( V_44 -> type ) ) )
goto V_67;
F_63 ( & V_44 -> V_123 , V_123 ) ;
...
if ( V_44 -> V_130 -> V_133 == NULL )
V_44 -> V_130 -> V_133 = V_134 ;
if ( V_44 -> V_130 -> V_135 == NULL )
V_44 -> V_130 -> V_135 = V_134 ;
if ( V_44 -> V_130 -> V_136 == NULL )
V_44 -> V_130 -> V_136 = V_134 ;
if ( V_44 -> V_130 -> V_137 == NULL )
V_44 -> V_130 -> V_137 = V_134 ;
V_120 = V_44 -> type & ( V_121 - 1 ) ;
F_65 ( & V_44 -> V_138 , & V_139 [ V_120 ] ) ;
V_23 = V_44 -> type ;
V_67:
F_66 ( & V_129 ) ;
return V_23 ;
}
int F_67 ( struct V_42 * V_44 )
{
F_68 ( & V_44 -> V_138 ) ;
F_69 ( & V_44 -> V_123 ) ;
return 0 ;
}
int F_70 ( struct V_42 * V_44 )
{
F_60 ( & V_129 ) ;
F_67 ( V_44 ) ;
F_66 ( & V_129 ) ;
...
int V_144 , V_145 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
V_145 = F_78 ( V_11 -> V_146 ) ;
V_144 = F_78 ( V_11 -> V_147 ) ;
F_42 ( V_11 -> V_148 , V_84 ) ;
F_10 ( & V_3 -> V_6 ,
L_35 ,
V_11 -> V_149 ,
V_11 -> V_150 ,
...
struct V_42 * V_44 )
{
return F_77 ( V_3 , L_36 ) ;
}
static enum V_1 F_80 ( struct V_2 * V_3 ,
int V_19 , struct V_42 * V_44 )
{
return F_77 ( V_3 , L_37 ) ;
}
static int F_81 ( struct V_2 * V_3 , char V_144 )
{
struct V_143 * V_11 ;
int V_145 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
...
static int F_84 ( struct V_2 * V_3 , char V_144 )
{
struct V_143 * V_11 ;
struct V_4 * V_5 = & V_3 -> V_6 ;
int V_145 ;
...
unsigned long * V_154 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
V_154 = ( unsigned long * ) ( ( long ) V_3 -> V_9 + V_3 -> V_117 ) ;
F_3 ( V_5 , L_39 ) ;
...
struct V_159 * V_160 ;
F_90 () ;
V_160 = F_91 ( V_11 -> V_114 ) ;
if ( V_160 )
V_53 = F_92 ( V_160 ) ;
F_93 () ;
}
for ( V_24 = 0 ; V_24 < V_161 ; V_24 ++ ) {
unsigned long V_54 = V_11 -> V_155 [ V_24 ] ;
if ( V_54 == V_156 || F_38 ( V_5 ) )
break;
F_3 ( V_5 , L_40 ) ;
if ( ! V_54 ) {
F_3 ( V_5 , L_42 ) ;
...
int V_24 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
F_10 ( & V_3 -> V_6 , L_51 , V_11 -> V_173 ) ;
for ( V_24 = 0 ; V_24 < V_3 -> V_117 - F_105 ( struct V_172 , V_15 ) ; V_24 ++ )
F_10 ( & V_3 -> V_6 , L_52 ,
