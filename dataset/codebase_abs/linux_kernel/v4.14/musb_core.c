...
static void F_136 ( struct V_235 * V_39 )
{
struct V_1 * V_1 = F_137 ( V_39 , struct V_1 , V_129 . V_236 ) ;
int error ;
error = F_6 ( V_1 -> V_45 ) ;
if ( error < 0 ) {
F_78 ( V_1 -> V_45 , L_75 , error ) ;
return;
}
F_133 ( V_1 ) ;
if ( V_1 -> V_60 -> V_61 -> V_62 != V_1 -> V_237 ) {
V_1 -> V_237 = V_1 -> V_60 -> V_61 -> V_62 ;
F_138 ( & V_1 -> V_45 -> V_238 , NULL , L_77 ) ;
}
F_134 ( V_1 -> V_45 ) ;
F_135 ( V_1 -> V_45 ) ;
}
...
const struct V_239 * V_136 , void T_2 * V_36 )
{
struct V_1 * V_1 ;
struct V_40 * V_240 ;
int V_35 ;
int V_22 ;
V_1 = F_142 ( V_3 , sizeof( * V_1 ) , V_241 ) ;
if ( ! V_1 )
return NULL ;
F_143 ( & V_1 -> V_242 ) ;
F_143 ( & V_1 -> V_243 ) ;
...
V_1 -> V_248 = - V_221 ;
V_1 -> V_136 = V_136 ;
F_144 ( V_1 -> V_136 -> V_178 > V_249 ) ;
for ( V_35 = 0 , V_240 = V_1 -> V_52 ;
...
if ( V_254 -> V_257 ) {
error = V_254 -> V_257 ( V_1 , V_254 -> V_39 ) ;
if ( error < 0 ) {
F_78 ( V_1 -> V_45 ,
L_78 ,
V_254 -> V_257 , error ) ;
...
F_155 ( & V_254 -> V_258 ) ;
F_156 ( V_1 -> V_45 , V_254 ) ;
}
F_59 ( & V_1 -> V_256 , V_58 ) ;
return error ;
}
int F_157 ( struct V_1 * V_1 ,
int (* V_257)( struct V_1 * V_1 , void * V_39 ) ,
void * V_39 )
{
struct V_253 * V_254 ;
unsigned long V_58 ;
...
return - V_179 ;
if ( F_159 ( V_1 -> V_45 ) )
return V_257 ( V_1 , V_39 ) ;
V_254 = F_142 ( V_1 -> V_45 , sizeof( * V_254 ) , V_259 ) ;
if ( ! V_254 )
return - V_260 ;
V_254 -> V_257 = V_257 ;
V_254 -> V_39 = V_39 ;
...
static void F_161 ( struct V_235 * V_236 )
{
struct V_1 * V_1 ;
unsigned long V_58 ;
V_1 = F_137 ( V_236 , struct V_1 , V_263 . V_236 ) ;
F_54 ( & V_1 -> V_59 , V_58 ) ;
if ( V_1 -> V_75 & V_264 )
F_162 ( V_1 , false ) ;
F_59 ( & V_1 -> V_59 , V_58 ) ;
...
static int
F_163 ( struct V_2 * V_3 , int V_248 , void T_2 * V_265 )
{
int V_183 ;
struct V_1 * V_1 ;
struct V_266 * V_267 = F_164 ( V_3 ) ;
if ( ! V_267 ) {
F_78 ( V_3 , L_80 ) ;
V_183 = - V_221 ;
goto V_268;
}
V_1 = F_141 ( V_3 , V_267 -> V_136 , V_265 ) ;
if ( ! V_1 ) {
V_183 = - V_260 ;
goto V_268;
}
F_165 ( & V_1 -> V_59 ) ;
F_165 ( & V_1 -> V_256 ) ;
V_1 -> V_269 = V_267 -> V_270 ;
V_1 -> V_271 = V_267 -> V_271 ;
V_1 -> V_272 = V_267 -> V_273 ;
V_1 -> V_141 = V_267 -> V_6 ;
F_7 = F_17 ;
F_8 = F_21 ;
F_83 = F_24 ;
...
if ( V_1 -> V_272 -> V_202 )
V_1 -> V_48 . V_202 = V_1 -> V_272 -> V_202 ;
if ( V_1 -> V_48 . V_202 & V_279 ) {
V_1 -> V_48 . V_212 = F_15 ;
V_1 -> V_48 . V_280 = F_14 ;
} else {
V_1 -> V_48 . V_212 = F_13 ;
...
if ( V_1 -> V_48 . V_202 & V_281 )
V_1 -> V_111 . V_282 = 1 ;
if ( V_1 -> V_272 -> V_212 )
V_1 -> V_48 . V_212 = V_1 -> V_272 -> V_212 ;
if ( V_1 -> V_272 -> V_280 )
V_1 -> V_48 . V_280 = V_1 -> V_272 -> V_280 ;
if ( V_1 -> V_272 -> V_167 )
V_167 = V_1 -> V_272 -> V_167 ;
else
V_167 = 4 ;
if ( V_1 -> V_272 -> V_200 )
V_1 -> V_48 . V_200 = V_1 -> V_272 -> V_200 ;
else
V_1 -> V_48 . V_200 = F_11 ;
if ( V_1 -> V_272 -> V_283 )
V_1 -> V_48 . V_283 = V_1 -> V_272 -> V_283 ;
else
V_1 -> V_48 . V_283 = F_16 ;
if ( V_1 -> V_272 -> V_284 )
F_7 = V_1 -> V_272 -> V_284 ;
...
F_8 = V_1 -> V_272 -> V_285 ;
if ( V_1 -> V_272 -> V_286 )
F_83 = V_1 -> V_272 -> V_286 ;
if ( V_1 -> V_272 -> V_287 )
F_52 = V_1 -> V_272 -> V_287 ;
if ( V_1 -> V_272 -> V_288 )
V_274 = V_1 -> V_272 -> V_288 ;
if ( V_1 -> V_272 -> V_289 )
V_275 = V_1 -> V_272 -> V_289 ;
#ifndef F_167
if ( ! V_1 -> V_272 -> V_290 || ! V_1 -> V_272 -> V_291 ) {
F_78 ( V_3 , L_81 ) ;
V_183 = - V_221 ;
goto V_278;
}
V_292 = V_1 -> V_272 -> V_290 ;
V_293 = V_1 -> V_272 -> V_291 ;
#endif
if ( V_1 -> V_272 -> V_49 )
V_1 -> V_48 . V_49 = V_1 -> V_272 -> V_49 ;
else
V_1 -> V_48 . V_49 = F_44 ;
if ( V_1 -> V_272 -> V_50 )
V_1 -> V_48 . V_50 = V_1 -> V_272 -> V_50 ;
else
V_1 -> V_48 . V_50 = F_36 ;
if ( ! V_1 -> V_60 -> V_294 ) {
V_1 -> V_60 -> V_23 = V_1 -> V_45 ;
V_1 -> V_60 -> V_18 = V_1 -> V_53 ;
V_1 -> V_60 -> V_294 = & V_295 ;
}
if ( V_1 -> V_272 -> V_296 )
V_220 = V_1 -> V_272 -> V_296 ;
F_168 ( V_1 -> V_45 ) ;
F_169 ( V_1 -> V_45 , 500 ) ;
F_170 ( V_1 -> V_45 ) ;
F_6 ( V_1 -> V_45 ) ;
...
F_174 ( & V_1 -> V_263 , F_161 ) ;
F_174 ( & V_1 -> V_90 , V_302 ) ;
V_183 = F_101 ( V_267 -> V_136 -> V_303
? V_196
: V_304 , V_1 ) ;
if ( V_183 < 0 )
goto V_305;
F_175 ( & V_1 -> V_113 , F_53 , ( unsigned long ) V_1 ) ;
if ( F_176 ( V_248 , V_1 -> V_277 , V_306 , F_177 ( V_3 ) , V_1 ) ) {
F_78 ( V_3 , L_82 , V_248 ) ;
V_183 = - V_221 ;
goto V_305;
}
...
if ( V_267 -> V_307 ) {
T_3 V_308 = F_180 ( V_1 -> V_53 ) ;
V_308 |= V_309 ;
F_181 ( V_1 -> V_53 , V_308 ) ;
}
if ( V_1 -> V_60 -> V_61 -> V_310 ) {
F_68 ( V_1 ) ;
V_1 -> V_60 -> V_61 -> V_62 = V_102 ;
} else {
F_61 ( V_1 ) ;
...
if ( V_183 < 0 )
goto V_313;
V_183 = F_186 ( & V_1 -> V_45 -> V_238 , & V_251 ) ;
if ( V_183 )
goto V_314;
V_1 -> V_315 = 1 ;
F_134 ( V_1 -> V_45 ) ;
...
static int F_195 ( struct V_318 * V_319 )
{
struct V_2 * V_3 = & V_319 -> V_3 ;
int V_320 = F_196 ( V_319 , L_85 ) ;
struct V_321 * V_322 ;
void T_2 * V_323 ;
if ( V_320 <= 0 )
return - V_221 ;
V_322 = F_197 ( V_319 , V_324 , 0 ) ;
V_323 = F_198 ( V_3 , V_322 ) ;
if ( F_172 ( V_323 ) )
return F_173 ( V_323 ) ;
return F_163 ( V_3 , V_320 , V_323 ) ;
}
static int F_199 ( struct V_318 * V_319 )
{
struct V_2 * V_3 = & V_319 -> V_3 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_58 ;
...
{
int V_19 ;
void T_2 * V_325 = V_1 -> V_53 ;
void T_2 * V_326 ;
V_1 -> V_327 . V_328 = F_83 ( V_325 , V_329 ) ;
V_1 -> V_327 . V_330 = F_7 ( V_325 , V_134 ) ;
V_1 -> V_327 . V_308 = F_180 ( V_1 -> V_53 ) ;
V_1 -> V_327 . V_21 = F_7 ( V_325 , V_24 ) ;
V_1 -> V_327 . V_331 = F_7 ( V_325 , V_121 ) ;
V_1 -> V_327 . V_46 = F_7 ( V_325 , V_38 ) ;
V_1 -> V_327 . V_78 = F_7 ( V_325 , V_98 ) ;
...
continue;
F_8 ( V_325 , V_38 , V_19 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_333 =
F_83 ( V_326 , V_334 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_335 =
F_83 ( V_326 , V_336 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_337 =
F_83 ( V_326 , V_338 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_339 =
F_83 ( V_326 , V_340 ) ;
if ( V_1 -> V_186 ) {
V_1 -> V_327 . V_332 [ V_19 ] . V_341 =
F_201 ( V_325 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_342 =
F_202 ( V_325 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_343 =
F_203 ( V_325 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_344 =
F_204 ( V_325 ) ;
}
V_1 -> V_327 . V_332 [ V_19 ] . V_345 =
F_7 ( V_326 , V_346 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_347 =
F_7 ( V_326 , V_348 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_349 =
F_7 ( V_326 , V_350 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_351 =
F_7 ( V_326 , V_352 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_353 =
F_205 ( V_1 , V_19 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_354 =
F_206 ( V_1 , V_19 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_355 =
F_207 ( V_1 , V_19 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_356 =
F_208 ( V_1 , V_19 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_357 =
F_209 ( V_1 , V_19 ) ;
V_1 -> V_327 . V_332 [ V_19 ] . V_358 =
F_210 ( V_1 , V_19 ) ;
}
}
...
void T_2 * V_326 ;
T_3 V_21 ;
F_52 ( V_325 , V_329 , V_1 -> V_327 . V_328 ) ;
F_8 ( V_325 , V_134 , V_1 -> V_327 . V_330 ) ;
F_181 ( V_1 -> V_53 , V_1 -> V_327 . V_308 ) ;
V_21 = F_7 ( V_325 , V_24 ) ;
V_21 &= V_25 | V_359 ;
V_1 -> V_327 . V_21 &= ~ ( V_25 | V_359 ) ;
V_21 |= V_1 -> V_327 . V_21 ;
F_8 ( V_325 , V_24 , V_21 ) ;
F_52 ( V_325 , V_118 , V_1 -> V_116 ) ;
F_52 ( V_325 , V_120 , V_1 -> V_119 ) ;
F_8 ( V_325 , V_121 , V_1 -> V_327 . V_331 ) ;
if ( V_1 -> V_327 . V_78 & V_99 )
F_8 ( V_325 , V_98 , V_1 -> V_327 . V_78 ) ;
for ( V_19 = 0 ; V_19 < V_1 -> V_136 -> V_178 ; ++ V_19 ) {
struct V_40 * V_41 ;
V_41 = & V_1 -> V_52 [ V_19 ] ;
if ( ! V_41 )
...
F_82 ( V_1 ) ;
V_1 -> V_232 = true ;
while ( F_220 ( & V_1 -> V_129 ) )
;
V_1 -> V_232 = false ;
if ( ! ( V_1 -> V_48 . V_202 & V_360 ) )
F_8 ( V_1 -> V_53 , V_98 , 0 ) ;
F_158 ( ! F_221 ( & V_1 -> V_245 ) ) ;
F_54 ( & V_1 -> V_59 , V_58 ) ;
if ( F_222 ( V_1 ) ) {
} else if ( F_77 ( V_1 ) ) {
}
...
F_211 ( V_1 ) ;
V_78 = F_7 ( V_1 -> V_53 , V_98 ) ;
V_361 = V_97 | V_228 | V_126 ;
if ( ( V_78 & V_361 ) != ( V_1 -> V_327 . V_78 & V_361 ) )
V_1 -> V_75 = 0 ;
F_85 ( V_1 ) ;
F_54 ( & V_1 -> V_59 , V_58 ) ;
error = F_153 ( V_1 ) ;
