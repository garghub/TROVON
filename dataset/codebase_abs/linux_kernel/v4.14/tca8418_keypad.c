...
V_3 = ~ ( ~ 0 << V_30 ) ;
V_3 += ( ~ ( ~ 0 << V_31 ) ) << 8 ;
error |= F_1 ( V_2 , V_32 , V_3 ) ;
error |= F_1 ( V_2 , V_33 , V_3 >> 8 ) ;
error |= F_1 ( V_2 , V_34 , V_3 >> 16 ) ;
...
static int F_14 ( struct V_42 * V_5 ,
const struct V_43 * V_44 )
{
struct V_45 * V_6 = & V_5 -> V_6 ;
struct V_1 * V_2 ;
struct V_8 * V_9 ;
T_3 V_30 = 0 , V_31 = 0 ;
int error , V_20 , V_46 ;
T_1 V_3 ;
if ( ! F_15 ( V_5 -> V_47 , V_48 ) ) {
F_3 ( V_6 , L_7 ,
F_16 ( & V_5 -> V_47 -> V_6 ) ) ;
return - V_49 ;
}
...
V_9 -> V_55 = V_5 -> V_55 ;
V_9 -> V_44 . V_56 = V_57 ;
V_9 -> V_44 . V_58 = 0x0001 ;
V_9 -> V_44 . V_59 = 0x001 ;
V_9 -> V_44 . V_60 = 0x0001 ;
