...
static T_4 F_40 ( struct V_83 * V_84 )
{
return V_90 | V_91 | V_92 |
V_93 ;
}
static int F_41 ( unsigned long V_94 , unsigned int V_95 ,
...
static int F_42 ( struct V_10 * V_11 , unsigned int * V_100 )
{
struct V_101 * V_102 = V_11 -> V_102 ;
unsigned long V_94 = F_43 ( V_11 -> V_87 ) ;
...
V_103 /= 1000 ;
V_104 = F_41 ( V_94 , V_103 , & V_96 , & V_97 ) ;
if ( V_104 > V_103 ) {
F_15 ( V_11 -> V_3 ,
L_21 \
L_22 , V_103 , V_104 ) ;
...
{
struct V_10 * V_11 = F_47 ( V_114 ) ;
unsigned int V_100 ;
int V_116 ;
int V_12 ;
V_116 = F_43 ( V_11 -> V_87 ) - V_11 -> V_105 ;
if ( ( V_115 == V_117 && V_116 < 0 ) ||
( V_115 == V_118 && V_116 > 0 ) ) {
F_48 ( & V_11 -> V_84 ) ;
V_12 = F_42 ( V_11 , & V_100 ) ;
F_49 ( & V_11 -> V_84 ) ;
if ( V_12 < 0 )
F_15 ( V_11 -> V_3 , L_24 , V_12 ) ;
else
F_50 ( V_11 -> V_3 , L_25 , V_100 ) ;
}
return 0 ;
}
static inline int F_51 ( struct V_10 * V_11 )
{
V_11 -> V_119 . V_120 = F_46 ;
return F_52 ( & V_11 -> V_119 ,
V_121 ) ;
}
static inline void F_53 ( struct V_10 * V_11 )
{
F_54 ( & V_11 -> V_119 ,
V_121 ) ;
}
...
F_50 ( V_11 -> V_3 , L_29 , V_102 -> V_127 ) ;
F_9 ( 0 , V_11 -> V_21 + V_22 ) ;
F_9 ( 0 , V_11 -> V_21 + V_27 ) ;
if ( F_42 ( V_11 , & V_104 ) != 0 ) {
F_15 ( V_11 -> V_3 , L_30 ) ;
return - V_64 ;
}
F_50 ( V_11 -> V_3 , L_31 , V_104 ) ;
F_5 ( V_11 -> V_3 , L_32 ,
F_8 ( V_11 -> V_21 + V_22 ) ) ;
return 0 ;
}
static void
F_62 ( struct V_129 * V_130 , struct V_10 * V_11 )
{
struct V_101 * V_102 = V_11 -> V_102 ;
int V_131 ;
if ( ! V_130 )
return;
V_102 -> V_132 = - 1 ;
F_63 ( V_130 , L_33 , & V_102 -> V_110 ) ;
F_63 ( V_130 , L_34 , & V_102 -> V_127 ) ;
F_63 ( V_130 , L_35 ,
( T_4 * ) & V_102 -> V_106 ) ;
V_131 = F_64 ( V_130 , L_36 ) ;
V_11 -> V_133 = F_65 ( V_130 ,
L_37 ) ;
if ( F_66 ( V_11 -> V_133 ) )
return;
F_67 ( V_11 -> V_133 , V_134 , F_68 ( V_131 ) , 0 ) ;
}
static void
F_62 ( struct V_129 * V_130 , struct V_10 * V_11 ) { }
...
V_11 = F_71 ( & V_2 -> V_3 , sizeof( struct V_10 ) , V_137 ) ;
if ( ! V_11 )
return - V_138 ;
V_11 -> V_102 = F_71 ( & V_2 -> V_3 , sizeof( * V_102 ) , V_137 ) ;
if ( ! V_11 -> V_102 )
return - V_138 ;
V_11 -> V_17 = F_1 ( V_2 ) ;
V_11 -> V_133 = F_72 ( - V_139 ) ;
if ( V_102 )
memcpy ( V_11 -> V_102 , V_102 , sizeof( * V_102 ) ) ;
else
F_62 ( V_2 -> V_3 . V_4 , V_11 ) ;
F_73 ( V_11 -> V_84 . V_140 , L_39 , sizeof( V_11 -> V_84 . V_140 ) ) ;
...
F_74 ( & V_11 -> V_19 ) ;
V_11 -> V_3 = & V_2 -> V_3 ;
V_11 -> V_87 = F_75 ( & V_2 -> V_3 , L_36 ) ;
if ( F_66 ( V_11 -> V_87 ) ) {
F_15 ( & V_2 -> V_3 , L_40 ) ;
return - V_139 ;
}
F_5 ( & V_2 -> V_3 , L_41 , V_11 -> V_87 ) ;
V_136 = F_76 ( V_2 , V_147 , 0 ) ;
V_11 -> V_21 = F_77 ( & V_2 -> V_3 , V_136 ) ;
if ( F_66 ( V_11 -> V_21 ) )
return F_78 ( V_11 -> V_21 ) ;
F_5 ( & V_2 -> V_3 , L_42 ,
V_11 -> V_21 , V_136 ) ;
V_11 -> V_84 . V_85 = V_11 ;
V_11 -> V_84 . V_3 . V_148 = & V_2 -> V_3 ;
V_11 -> V_149 = F_79 ( V_11 -> V_3 ) ;
if ( V_11 -> V_102 -> V_150 )
V_11 -> V_102 -> V_150 ( F_80 ( V_11 -> V_3 ) ) ;
else if ( F_66 ( V_11 -> V_149 ) && F_55 ( V_11 ) )
return - V_64 ;
V_12 = F_81 ( V_11 -> V_87 ) ;
if ( V_12 ) {
F_15 ( & V_2 -> V_3 , L_43 ) ;
...
if ( ! ( V_11 -> V_17 & V_18 ) ) {
V_11 -> V_151 = V_12 = F_83 ( V_2 , 0 ) ;
if ( V_12 <= 0 ) {
F_15 ( & V_2 -> V_3 , L_45 ) ;
F_82 ( V_11 -> V_87 ) ;
return V_12 ;
}
V_12 = F_84 ( & V_2 -> V_3 , V_11 -> V_151 , F_25 ,
0 , F_85 ( & V_2 -> V_3 ) , V_11 ) ;
if ( V_12 != 0 ) {
F_15 ( & V_2 -> V_3 , L_46 , V_11 -> V_151 ) ;
F_82 ( V_11 -> V_87 ) ;
return V_12 ;
}
}
...
F_50 ( & V_2 -> V_3 , L_48 , F_85 ( & V_11 -> V_84 . V_3 ) ) ;
return 0 ;
}
static int F_90 ( struct V_1 * V_2 )
{
struct V_10 * V_11 = F_91 ( V_2 ) ;
F_82 ( V_11 -> V_87 ) ;
F_89 ( & V_2 -> V_3 ) ;
F_53 ( V_11 ) ;
F_92 ( & V_11 -> V_84 ) ;
if ( V_2 -> V_3 . V_4 && F_66 ( V_11 -> V_149 ) )
F_60 ( V_11 ) ;
return 0 ;
}
static int F_93 ( struct V_153 * V_3 )
{
struct V_10 * V_11 = F_94 ( V_3 ) ;
V_11 -> V_79 = 1 ;
if ( ! F_66 ( V_11 -> V_133 ) )
F_95 ( V_11 -> V_133 , V_134 , & V_11 -> V_154 ) ;
return 0 ;
}
static int F_96 ( struct V_153 * V_3 )
{
struct V_10 * V_11 = F_94 ( V_3 ) ;
int V_12 ;
if ( ! F_66 ( V_11 -> V_133 ) )
F_97 ( V_11 -> V_133 , V_134 , V_11 -> V_154 ) ;
V_12 = F_37 ( V_11 -> V_87 ) ;
if ( V_12 )
return V_12 ;
F_61 ( V_11 ) ;
