...
struct V_23 * V_24 = V_20 -> V_25 ;
if ( V_24 -> V_26 > 0 && V_24 -> V_27 & V_28 )
F_17 ( & V_24 -> V_29 , V_21 , V_22 ) ;
}
int F_18 ( struct V_23 * V_24 )
{
int V_30 , V_9 = 0 ;
for ( V_30 = 0 ; V_30 < V_24 -> V_12 . V_31 ; V_30 ++ ) {
V_24 -> V_32 [ V_30 ] . V_20 . V_15 = V_24 -> V_33 -> V_15 ;
if ( V_24 -> V_12 . V_34 [ V_30 ] . V_35 & V_36 )
V_24 -> V_32 [ V_30 ] . V_20 . V_37 =
F_14 ;
else
if ( V_24 -> V_12 . V_34 [ V_30 ] . V_35 & V_38 )
V_24 -> V_32 [ V_30 ] . V_20 . V_37 =
F_16 ;
else
V_24 -> V_32 [ V_30 ] . V_20 . V_37 = F_12 ;
V_24 -> V_32 [ V_30 ] . V_20 . V_25 = V_24 ;
V_9 = F_19 ( & V_24 -> V_32 [ V_30 ] . V_20 ,
& V_24 -> V_12 . V_34 [ V_30 ] . V_20 ) ;
if ( V_9 < 0 )
break;
}
return V_9 ;
