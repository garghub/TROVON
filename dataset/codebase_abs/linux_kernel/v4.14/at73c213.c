...
int V_50 = F_18 ( V_49 ) ;
int V_4 ;
V_4 = F_19 ( V_2 -> V_19 -> V_34 , V_51 ) ;
V_4 = F_20 ( V_52 , V_50 - 1 , V_4 ) ;
...
switch ( V_61 ) {
case V_63 :
F_9 ( V_2 -> V_19 -> V_34 , V_64 , F_29 ( V_65 ) ) ;
F_9 ( V_2 -> V_19 -> V_34 , V_66 , F_29 ( V_67 ) ) ;
break;
case V_68 :
F_9 ( V_2 -> V_19 -> V_34 , V_66 , F_29 ( V_69 ) ) ;
F_9 ( V_2 -> V_19 -> V_34 , V_70 , F_29 ( V_71 ) ) ;
break;
default:
F_30 ( & V_2 -> V_16 -> V_37 , L_2 , V_61 ) ;
V_11 = - V_72 ;
break;
}
F_31 ( & V_2 -> V_62 ) ;
...
static int F_34 ( struct V_1 * V_2 , int V_76 )
{
struct V_77 * V_78 ;
int V_11 ;
V_11 = F_35 ( V_2 -> V_79 , V_2 -> V_79 -> V_80 ,
V_76 , 1 , 0 , & V_78 ) ;
if ( V_11 < 0 )
goto V_81;
V_78 -> V_82 = V_2 ;
...
static T_3 F_38 ( int V_90 , void * V_91 )
{
struct V_1 * V_2 = V_91 ;
...
for ( V_125 = 0 ; V_125 < F_54 ( V_127 ) ; V_125 ++ ) {
V_124 = F_55 ( V_79 ,
F_56 ( & V_127 [ V_125 ] ,
V_2 ) ) ;
if ( V_124 < 0 )
...
return 0 ;
V_128:
for ( V_125 = 1 ; V_125 < F_54 ( V_127 ) + 1 ; V_125 ++ ) {
struct V_99 * V_129 ;
V_129 = F_57 ( V_79 , V_125 ) ;
if ( V_129 )
F_58 ( V_79 , V_129 ) ;
}
return V_124 ;
...
if ( V_11 )
goto V_141;
F_9 ( V_2 -> V_19 -> V_34 , V_159 , F_29 ( V_160 ) ) ;
goto V_81;
V_141:
F_16 ( V_2 -> V_31 -> V_32 ) ;
V_81:
...
F_9 ( V_2 -> V_19 -> V_34 , V_159 , F_29 ( V_163 ) ) ;
if ( V_2 -> V_90 >= 0 ) {
F_64 ( V_2 -> V_90 , V_2 ) ;
V_2 -> V_90 = - 1 ;
}
...
V_2 -> V_90 = - 1 ;
F_14 ( V_2 -> V_19 -> V_20 ) ;
V_11 = F_69 ( V_90 , F_38 , 0 , L_3 , V_2 ) ;
if ( V_11 ) {
F_30 ( & V_2 -> V_16 -> V_37 , L_4 , V_90 ) ;
goto V_81;
}
V_2 -> V_90 = V_90 ;
...
static int F_72 ( struct V_164 * V_16 )
{
struct V_123 * V_79 ;
struct V_1 * V_2 ;
struct V_172 * V_31 ;
...
if ( F_73 ( V_31 -> V_32 ) ) {
F_30 ( & V_16 -> V_37 , L_6 ) ;
return F_74 ( V_31 -> V_32 ) ;
}
snprintf ( V_173 , sizeof V_173 , L_7 , V_31 -> V_175 ) ;
V_11 = F_75 ( & V_16 -> V_37 , - 1 , V_173 , V_176 ,
...
static int F_81 ( struct V_164 * V_16 )
{
struct V_123 * V_79 = F_82 ( & V_16 -> V_37 ) ;
...
static int F_83 ( struct V_76 * V_37 )
{
struct V_123 * V_79 = F_82 ( V_37 ) ;
struct V_1 * V_2 = V_79 -> V_82 ;
F_9 ( V_2 -> V_19 -> V_34 , V_159 , F_29 ( V_163 ) ) ;
F_16 ( V_2 -> V_19 -> V_20 ) ;
F_16 ( V_2 -> V_31 -> V_32 ) ;
