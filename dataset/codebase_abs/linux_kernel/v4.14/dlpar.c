...
int F_20 ( struct V_12 * V_14 , struct V_12 * V_22 )
{
int V_29 ;
V_14 -> V_22 = V_22 ;
V_29 = F_21 ( V_14 ) ;
...
if ( V_29 || V_45 != V_47 )
return - 1 ;
V_29 = F_26 ( V_48 , V_21 , V_49 ) ;
if ( V_29 )
return V_29 ;
V_29 = F_26 ( V_50 , V_21 , V_51 ) ;
if ( V_29 ) {
F_26 ( V_48 , V_21 , V_52 ) ;
return V_29 ;
}
...
if ( V_29 || V_45 != V_53 )
return - 1 ;
V_29 = F_26 ( V_50 , V_21 , V_54 ) ;
if ( V_29 )
return V_29 ;
V_29 = F_26 ( V_48 , V_21 , V_52 ) ;
if ( V_29 ) {
F_26 ( V_50 , V_21 , V_51 ) ;
return V_29 ;
}
...
{
struct V_72 * V_73 =
F_33 ( V_71 , struct V_72 , V_71 ) ;
if ( V_73 -> V_29 )
* ( V_73 -> V_29 ) = F_28 ( V_73 -> V_74 ) ;
else
F_28 ( V_73 -> V_74 ) ;
if ( V_73 -> V_75 )
F_34 ( V_73 -> V_75 ) ;
...
void F_35 ( struct V_55 * V_76 ,
struct V_77 * V_78 , int * V_29 )
{
struct V_72 * V_71 ;
struct V_55 * V_79 ;
V_79 = F_36 ( sizeof( struct V_55 ) ,
V_7 ) ;
memcpy ( V_79 , V_76 , sizeof( struct V_55 ) ) ;
V_71 = F_36 ( sizeof( struct V_72 ) , V_7 ) ;
if ( V_71 ) {
F_37 ( (struct V_70 * ) V_71 , F_32 ) ;
V_71 -> V_74 = V_79 ;
V_71 -> V_75 = V_78 ;
V_71 -> V_29 = V_29 ;
F_38 ( V_80 , (struct V_70 * ) V_71 ) ;
} else {
* V_29 = - V_81 ;
F_2 ( V_79 ) ;
F_34 ( V_78 ) ;
...
static int F_39 ( char * * V_82 , struct V_55 * V_56 )
{
char * V_83 ;
V_83 = F_40 ( V_82 , L_8 ) ;
if ( ! V_83 )
...
static int F_44 ( char * * V_82 , struct V_55 * V_56 )
{
char * V_83 ;
T_2 V_64 , V_65 ;
V_83 = F_40 ( V_82 , L_8 ) ;
...
V_56 -> V_59 . V_63 . V_64 = F_46 ( V_64 ) ;
V_56 -> V_59 . V_63 . V_65 = F_46 ( V_65 ) ;
} else if ( F_41 ( V_83 , L_20 ) ) {
V_56 -> V_57 = V_61 ;
V_83 = F_40 ( V_82 , L_8 ) ;
if ( ! V_83 ) {
F_42 ( L_18 ) ;
...
V_56 -> V_59 . V_21 = F_46 ( V_65 ) ;
} else if ( F_41 ( V_83 , L_21 ) ) {
V_56 -> V_57 = V_58 ;
V_83 = F_40 ( V_82 , L_8 ) ;
if ( ! V_83 ) {
F_42 ( L_16 ) ;
...
static T_3 F_47 ( struct V_87 * V_87 , struct V_88 * V_89 ,
