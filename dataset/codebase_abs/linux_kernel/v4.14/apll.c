...
V_8 -> V_29 = F_15 ( V_4 ) ;
V_4 = F_16 ( NULL , & V_1 -> V_2 , V_25 -> V_26 ) ;
if ( ! F_13 ( V_4 ) ) {
F_17 ( V_25 , V_30 , V_4 ) ;
...
int V_34 ;
V_8 = F_20 ( sizeof( * V_8 ) , V_35 ) ;
V_1 = F_20 ( sizeof( * V_1 ) , V_35 ) ;
V_31 = F_20 ( sizeof( * V_31 ) , V_35 ) ;
if ( ! V_8 || ! V_1 || ! V_31 )
goto V_27;
V_1 -> V_7 = V_8 ;
V_1 -> V_2 . V_31 = V_31 ;
...
V_32 = F_20 ( sizeof( char * ) * V_31 -> V_38 , V_35 ) ;
if ( ! V_32 )
goto V_27;
F_23 ( V_25 , V_32 , V_31 -> V_38 ) ;
V_31 -> V_32 = V_32 ;
V_34 = F_24 ( V_25 , 0 , & V_8 -> V_17 ) ;
V_34 |= F_24 ( V_25 , 1 , & V_8 -> V_16 ) ;
if ( V_34 )
goto V_27;
V_8 -> V_13 = 0x1 ;
V_8 -> V_18 = 0x3 ;
...
V_11 = V_14 -> V_15 ( & V_8 -> V_17 ) ;
V_11 &= ~ V_8 -> V_18 ;
V_11 |= V_42 << F_4 ( V_8 -> V_18 ) ;
V_14 -> V_20 ( V_11 , & V_8 -> V_17 ) ;
}
static void F_29 ( struct V_3 * V_4 , T_2 V_43 )
{
struct V_7 * V_8 = V_4 -> V_7 ;
T_2 V_11 ;
V_11 = V_14 -> V_15 ( & V_8 -> V_44 ) ;
V_11 &= ~ V_8 -> V_45 ;
V_11 |= V_43 << F_4 ( V_8 -> V_45 ) ;
V_14 -> V_20 ( V_11 , & V_8 -> V_17 ) ;
}
...
V_48 = F_33 ( V_25 , 0 ) ;
V_31 -> V_32 = & V_48 ;
if ( F_34 ( V_25 , L_10 , & V_43 ) ) {
F_22 ( L_11 , V_25 -> V_26 ) ;
goto V_27;
}
V_1 -> V_41 = V_43 ;
if ( F_34 ( V_25 , L_12 , & V_43 ) ) {
F_22 ( L_13 , V_25 -> V_26 ) ;
goto V_27;
}
V_1 -> V_51 = V_43 ;
V_8 -> V_18 = 0x3 << V_43 ;
V_8 -> V_45 = 0x3 << V_43 ;
if ( F_34 ( V_25 , L_14 , & V_43 ) ) {
F_22 ( L_15 , V_25 -> V_26 ) ;
goto V_27;
}
V_8 -> V_13 = 1 << V_43 ;
V_34 = F_24 ( V_25 , 0 , & V_8 -> V_17 ) ;
V_34 |= F_24 ( V_25 , 1 , & V_8 -> V_44 ) ;
V_34 |= F_24 ( V_25 , 2 , & V_8 -> V_16 ) ;
if ( V_34 )
goto V_27;
V_4 = F_35 ( NULL , & V_1 -> V_2 ) ;
if ( ! F_13 ( V_4 ) ) {
F_17 ( V_25 , V_30 , V_4 ) ;
F_18 ( V_31 ) ;
return;
