...
if ( ( V_55 = F_58 ( V_18 ) ) < 0 )
return V_55 ;
if ( F_59 ( & V_18 -> V_115 , F_60 ( 28 ) ) < 0 ||
F_61 ( & V_18 -> V_115 , F_60 ( 28 ) ) < 0 ) {
...
static int F_74 ( struct V_20 * V_115 )
{
struct V_110 * V_60 = F_70 ( V_115 ) ;
struct V_6 * V_7 = V_60 -> V_32 ;
F_54 ( V_7 ) ;
...
static int F_76 ( struct V_43 * V_18 ,
...
V_55 = F_77 ( & V_18 -> V_115 , V_129 [ V_115 ] , V_130 [ V_115 ] , V_131 ,
0 , & V_60 ) ;
if ( V_55 < 0 )
return V_55 ;
V_12 = V_124 -> V_132 ;
...
V_60 -> V_32 = V_7 ;
strcpy ( V_60 -> V_133 , L_10 ) ;
if ( V_7 -> V_12 == V_13 )
sprintf ( V_60 -> V_134 , L_15 , V_7 -> V_11 ) ;
else
sprintf ( V_60 -> V_134 , L_16 , 'A' +
V_7 -> V_11 - 1 ) ;
sprintf ( V_60 -> V_135 , L_17 ,
V_60 -> V_134 , V_7 -> V_1 , V_7 -> V_17 ) ;
if ( ( V_55 = F_78 ( V_60 ) ) < 0 ) {
F_19 ( V_60 ) ;
return V_55 ;
}
