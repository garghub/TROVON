...
} else if ( V_41 -> V_261 == V_262 ) {
V_4 -> V_204 |= V_259 ;
} else if ( V_4 -> V_204 == 0 ) {
V_84 = F_101 ( V_2 , V_263 ,
0 , V_4 -> V_37 ) ;
return V_4 -> V_66 ;
}
V_4 -> V_115 = V_107 ;
...
V_189 = NULL ;
V_268 = NULL ;
V_269 = F_4 ( V_41 , V_43 , V_44 ) ;
if ( V_43 -> V_270 & V_271 )
V_189 = ( T_7 * ) V_269 ;
else if ( V_43 -> V_270 & V_272 )
V_268 = (struct V_267 * ) V_269 ;
V_50 = & V_44 -> V_51 ;
if ( V_50 -> V_56 ) {
if ( ( V_2 -> V_149 == V_150 ) &&
V_2 -> V_151 ) {
...
( F_111 ( V_280 , V_268 ) ==
V_197 ) ) {
if ( F_111 ( V_281 , V_268 ) )
V_4 -> V_111 |= V_199 ;
if ( F_111 ( V_282 , V_268 ) ) {
V_4 -> V_111 |= V_201 ;
if ( F_111 ( V_283 , V_268 ) )
V_4 -> V_111 |= V_284 ;
if ( ( F_111 ( V_285 , V_268 ) == 1 ) &&
( F_111 ( V_286 , V_268 ) > 0 ) &&
( V_41 -> V_287 ) &&
( ! V_41 -> V_113 ) ) {
V_4 -> V_8 |= V_194 ;
V_4 -> V_276 = F_111 ( V_286 ,
V_268 ) ;
}
}
if ( F_111 ( V_288 , V_268 ) )
V_4 -> V_97 |= V_193 ;
F_3 ( V_2 , V_65 , V_250 ,
L_32
L_33
...
struct V_40 * V_41 = V_2 -> V_41 ;
struct V_42 * V_43 = (struct V_42 * ) V_217 ;
F_133 ( V_2 , & V_41 -> V_134 . V_294 [ V_295 ] ,
V_4 -> V_296 , 0 , V_297 ) ;
F_45 ( V_2 , V_4 , V_43 , V_177 ) ;
return V_4 -> V_66 ;
}
...
L_38
L_39 ,
V_218 , V_4 -> V_37 , V_301 , V_4 -> V_8 ) ;
F_51 ( V_2 , V_303 ,
L_40 ,
V_218 , V_301 , V_4 -> V_37 ) ;
F_149 = V_304 [ ( V_301 * V_305 ) + V_218 ] ;
