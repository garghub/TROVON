...
T_1 V_30 [ 1 ] ;
if ( V_15 -> V_31 )
F_6 ( V_9 , V_26 , sizeof( V_26 ) ,
V_30 , sizeof( V_30 ) ) ;
return F_6 ( V_9 , V_28 , sizeof( V_28 ) ,
V_30 , sizeof( V_30 ) ) ;
}
...
struct V_8 * V_9 = F_19 ( V_40 ) ;
struct V_14 * V_15 = F_15 ( V_40 ) ;
static const char * const V_194 [] = { L_26 , L_36 , L_37 , L_38 , L_39 } ;
int V_18 = 0 ;
switch ( V_15 -> V_58 ) {
case V_59 :
...
int V_18 = 0 , V_4 = 3 , V_13 = 1 ;
F_33 ( & V_9 -> V_102 ) ;
V_18 = F_6 ( V_9 , V_100 ? V_200 : V_202 , V_4 , V_12 , V_13 ) ;
V_15 -> V_55 = 1 ;
F_10 ( & V_9 -> V_102 ) ;
return V_18 ;
}
