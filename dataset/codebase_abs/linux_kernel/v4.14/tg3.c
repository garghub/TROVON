...
! ( V_5 -> V_349 & V_1198 ) )
F_314 ( V_1103 , F_312 ( V_1195 ) ,
V_1128 -> V_1167 & V_1199 ) ;
F_315 ( & V_131 -> V_123 , V_1103 ) ;
V_1157 ++ ;
V_1152 -- ;
V_1172:
( * V_1161 ) ++ ;
...
static int F_324 ( struct V_130 * V_131 , int V_1213 , int V_1152 )
{
struct V_4 * V_5 = V_131 -> V_5 ;
...
{
if ( ! F_326 ( V_1215 , V_5 -> V_1216 ) )
F_327 ( & V_5 -> V_1217 ) ;
}
static inline void F_328 ( struct V_4 * V_5 )
{
F_329 ( & V_5 -> V_1217 ) ;
F_86 ( V_5 , V_1218 ) ;
F_86 ( V_5 , V_1090 ) ;
}
static int F_330 ( struct V_1219 * V_123 , int V_1152 )
{
...
struct V_139 * V_140 = V_131 -> V_134 ;
while ( 1 ) {
V_1213 = F_324 ( V_131 , V_1213 , V_1152 ) ;
if ( F_269 ( F_23 ( V_5 , V_1090 ) ) )
goto V_1220;
...
F_300 () ;
if ( F_331 ( V_140 -> V_145 [ 0 ] . V_146 == V_131 -> V_147 &&
* ( V_131 -> V_148 ) == V_131 -> V_149 ) ) {
...
static int F_335 ( struct V_1219 * V_123 , int V_1152 )
{
struct V_130 * V_131 = F_241 ( V_123 , struct V_130 , V_123 ) ;
struct V_4 * V_5 = V_131 -> V_5 ;
int V_1213 = 0 ;
...
{
int V_42 ;
F_341 ( V_5 -> V_111 , & V_5 -> V_123 [ 0 ] . V_123 , F_335 , 64 ) ;
for ( V_42 = 1 ; V_42 < V_5 -> V_129 ; V_42 ++ )
F_341 ( V_5 -> V_111 , & V_5 -> V_123 [ V_42 ] . V_123 , F_330 , 64 ) ;
}
static void F_342 ( struct V_4 * V_5 )
{
int V_42 ;
for ( V_42 = 0 ; V_42 < V_5 -> V_129 ; V_42 ++ )
F_343 ( & V_5 -> V_123 [ V_42 ] . V_123 ) ;
}
...
static T_10 F_352 ( int V_1231 , void * V_1232 )
{
struct V_130 * V_131 = V_1232 ;
struct V_4 * V_5 = V_131 -> V_5 ;
F_301 ( V_131 -> V_134 ) ;
...
static T_10 F_356 ( int V_1231 , void * V_1232 )
{
struct V_130 * V_131 = V_1232 ;
struct V_4 * V_5 = V_131 -> V_5 ;
struct V_139 * V_140 = V_131 -> V_134 ;
...
return;
for ( V_42 = 0 ; V_42 < V_5 -> V_129 ; V_42 ++ )
F_354 ( V_5 -> V_123 [ V_42 ] . V_1230 , & V_5 -> V_123 [ V_42 ] ) ;
}
static void F_358 ( struct V_359 * V_111 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( F_359 ( V_5 ) ) {
F_187 ( V_111 , L_40 ) ;
...
static inline int F_360 ( T_9 V_1110 , int V_74 )
{
...
static inline int F_362 ( struct V_4 * V_5 , T_9 V_1110 ,
int V_74 )
{
#if F_363 ( V_1240 ) && ( V_1241 == 64 )
if ( F_23 ( V_5 , 40BIT_DMA_BUG ) )
return ( ( T_6 ) V_1110 + V_74 ) > F_364 ( 40 ) ;
return 0 ;
#else
return 0 ;
#endif
}
static inline void F_365 ( struct V_1242 * V_1243 ,
...
static bool F_366 ( struct V_130 * V_131 , T_1 * V_1249 , T_1 * V_1152 ,
...
V_1250 = true ;
if ( F_360 ( V_1129 , V_74 ) )
V_1250 = true ;
if ( F_361 ( V_5 , V_1129 , V_74 , V_1239 ) )
V_1250 = true ;
if ( F_362 ( V_5 , V_1129 , V_74 ) )
V_1250 = true ;
if ( V_5 -> V_1252 ) {
T_1 V_1253 = * V_1249 ;
...
F_365 ( & V_131 -> V_1105 [ * V_1249 ] , V_1129 ,
...
static void F_367 ( struct V_130 * V_131 , T_1 V_1249 , int V_1257 )
{
int V_42 ;
struct V_1102 * V_1103 ;
...
static int F_368 ( struct V_130 * V_131 ,
...
V_1110 , V_1263 ) ;
if ( F_366 ( V_131 , V_1249 , V_1152 , V_1263 ,
V_1262 -> V_74 , V_1261 ,
V_1239 , V_1244 ) ) {
F_367 ( V_131 , V_1265 , - 1 ) ;
F_313 ( V_1262 ) ;
V_56 = - 1 ;
}
}
...
static bool F_373 ( struct V_130 * V_131 , struct V_1102 * V_1103 )
{
return F_275 ( V_1103 ) -> V_1266 < V_131 -> V_1083 / 3 ;
}
static int F_374 ( struct V_4 * V_5 , struct V_130 * V_131 ,
...
V_1267 = F_376 ( V_1103 , V_5 -> V_111 -> V_1184 &
~ ( V_1271 | V_1272 ) ) ;
...
V_1268 -> V_1274 = NULL ;
F_377 ( V_1268 , V_5 -> V_111 ) ;
} while ( V_1267 );
V_1273:
F_278 ( V_1103 ) ;
return V_1275 ;
}
static T_12 F_377 ( struct V_1102 * V_1103 , struct V_359 * V_111 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
T_14 V_1283 = 0 ;
V_1095 = F_268 ( V_111 , F_378 ( V_1103 ) ) ;
V_131 = & V_5 -> V_123 [ F_378 ( V_1103 ) ] ;
if ( F_23 ( V_5 , V_1098 ) )
V_131 ++ ;
V_1152 = F_265 ( V_131 ) ;
...
V_1278 = F_380 ( V_1103 ) ;
V_1285 = F_381 ( V_1103 ) ;
V_1286 = F_382 ( V_1103 ) + F_383 ( V_1103 ) - V_1194 ;
if ( V_1103 -> V_1192 == F_312 ( V_1195 ) ||
V_1103 -> V_1192 == F_312 ( V_1196 ) ) {
if ( F_373 ( V_131 , V_1103 ) )
return F_374 ( V_5 , V_131 , V_1095 , V_1103 ) ;
goto V_1287;
}
if ( ! F_384 ( V_1103 ) ) {
...
V_1280 -> V_1289 = ~ F_386 ( V_1278 -> V_1297 , V_1278 -> V_1298 ,
0 , V_1299 , 0 ) ;
}
if ( F_23 ( V_5 , V_1295 ) ) {
...
V_1276 = 1 ;
if ( F_366 ( V_131 , & V_1249 , & V_1152 , V_1110 , V_74 , V_1261 |
...
V_74 = F_277 ( V_1259 ) ;
V_1110 = F_390 ( & V_5 -> V_12 -> V_111 , V_1259 , 0 ,
V_74 , V_1312 ) ;
V_131 -> V_1101 [ V_1249 ] . V_1103 = NULL ;
F_296 ( & V_131 -> V_1101 [ V_1249 ] , V_1110 ,
V_1110 ) ;
if ( F_391 ( & V_5 -> V_12 -> V_111 , V_1110 ) )
goto V_1313;
if ( ! V_1152 ||
F_366 ( V_131 , & V_1249 , & V_1152 , V_1110 ,
V_74 , V_1261 |
...
if ( V_1276 ) {
F_367 ( V_131 , V_131 -> V_1082 , V_42 ) ;
if ( V_1239 && F_373 ( V_131 , V_1103 ) ) {
if ( V_1283 ) {
...
V_1249 = V_131 -> V_1082 ;
V_1152 = F_265 ( V_131 ) ;
if ( F_368 ( V_131 , & V_1103 , & V_1249 , & V_1152 ,
V_1261 , V_1239 , V_1244 ) )
goto V_1314;
}
F_392 ( V_1103 ) ;
F_393 ( V_1095 , V_1103 -> V_74 ) ;
F_49 () ;
V_131 -> V_1082 = V_1249 ;
...
if ( ! V_1103 -> V_1316 || F_394 ( V_1095 ) ) {
F_395 ( V_131 -> V_1317 , V_1249 ) ;
F_53 () ;
}
return V_1275 ;
V_1313:
...
static void F_396 ( struct V_4 * V_5 , bool V_195 )
{
if ( V_195 ) {
V_5 -> V_362 &= ~ ( V_366 |
V_365 ) ;
...
static int F_397 ( struct V_4 * V_5 , T_1 V_367 , bool V_1319 )
{
...
static void F_398 ( struct V_359 * V_111 , T_15 V_1184 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( V_1184 & V_1327 ) {
if ( V_5 -> V_362 & V_829 )
...
static T_15 F_399 ( struct V_359 * V_111 ,
T_15 V_1184 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
static int F_400 ( struct V_359 * V_111 , T_15 V_1184 )
{
...
memset ( V_1123 -> V_1134 , 0 , F_405 ( V_5 ) ) ;
V_1331 = V_1332 ;
if ( F_23 ( V_5 , 5780_CLASS ) &&
V_5 -> V_111 -> V_1193 > V_1328 )
V_1331 = V_1333 ;
V_5 -> V_1136 = F_406 ( V_1331 ) ;
for ( V_42 = 0 ; V_42 <= V_5 -> V_1133 ; V_42 ++ ) {
...
if ( ! F_23 ( V_5 , V_516 ) || F_23 ( V_5 , 5780_CLASS ) )
goto V_186;
memset ( V_1123 -> V_1139 , 0 , F_407 ( V_5 ) ) ;
if ( ! F_23 ( V_5 , V_1340 ) )
goto V_186;
for ( V_42 = 0 ; V_42 <= V_5 -> V_1138 ; V_42 ++ ) {
struct V_1127 * V_1334 ;
...
V_1123 -> V_1141 = NULL ;
if ( V_1123 -> V_1134 ) {
F_409 ( & V_5 -> V_12 -> V_111 , F_405 ( V_5 ) ,
V_1123 -> V_1134 , V_1123 -> V_1343 ) ;
V_1123 -> V_1134 = NULL ;
}
if ( V_1123 -> V_1139 ) {
F_409 ( & V_5 -> V_12 -> V_111 , F_407 ( V_5 ) ,
...
struct V_1122 * V_1123 )
{
V_1123 -> V_1135 = F_263 ( F_403 ( V_5 ) ,
V_627 ) ;
if ( ! V_1123 -> V_1135 )
return - V_267 ;
V_1123 -> V_1134 = F_411 ( & V_5 -> V_12 -> V_111 ,
F_405 ( V_5 ) ,
& V_1123 -> V_1343 ,
V_627 ) ;
if ( ! V_1123 -> V_1134 )
goto V_1026;
if ( F_23 ( V_5 , V_516 ) && ! F_23 ( V_5 , 5780_CLASS ) ) {
V_1123 -> V_1141 = F_263 ( F_404 ( V_5 ) ,
V_627 ) ;
if ( ! V_1123 -> V_1141 )
goto V_1026;
V_1123 -> V_1139 = F_411 ( & V_5 -> V_12 -> V_111 ,
F_407 ( V_5 ) ,
& V_1123 -> V_1344 ,
V_627 ) ;
if ( ! V_1123 -> V_1139 )
...
V_131 -> V_149 = 0 ;
if ( V_131 -> V_1158 )
memset ( V_131 -> V_1158 , 0 , F_415 ( V_5 ) ) ;
if ( V_131 -> V_1084 . V_1134 &&
F_402 ( V_5 , & V_131 -> V_1084 ) ) {
F_412 ( V_5 ) ;
return - V_267 ;
}
}
...
if ( ! V_131 -> V_1101 )
goto V_1026;
V_131 -> V_1105 = F_411 ( & V_5 -> V_12 -> V_111 ,
V_1346 ,
& V_131 -> V_1347 ,
V_627 ) ;
if ( ! V_131 -> V_1105 )
...
for ( V_42 = 0 ; V_42 < V_5 -> V_122 ; V_42 ++ ) {
struct V_130 * V_131 = & V_5 -> V_123 [ V_42 ] ;
F_408 ( V_5 , & V_131 -> V_1084 ) ;
if ( ! V_131 -> V_1158 )
continue;
F_409 ( & V_5 -> V_12 -> V_111 ,
F_415 ( V_5 ) ,
V_131 -> V_1158 ,
V_131 -> V_1349 ) ;
V_131 -> V_1158 = NULL ;
...
struct V_130 * V_131 = & V_5 -> V_123 [ V_42 ] ;
if ( F_410 ( V_5 , & V_131 -> V_1084 ) )
goto V_1026;
if ( ! V_42 && F_23 ( V_5 , V_1203 ) )
continue;
V_131 -> V_1158 = F_420 ( & V_5 -> V_12 -> V_111 ,
F_415 ( V_5 ) ,
& V_131 -> V_1349 ,
V_627 ) ;
if ( ! V_131 -> V_1158 )
...
F_243 ( V_5 , 0 ) ;
if ( V_5 -> V_1351 ) {
F_409 ( & V_5 -> V_12 -> V_111 , sizeof( struct V_1352 ) ,
...
{
int V_42 ;
V_5 -> V_1351 = F_420 ( & V_5 -> V_12 -> V_111 ,
...
struct V_130 * V_131 = & V_5 -> V_123 [ V_42 ] ;
struct V_139 * V_140 ;
V_131 -> V_134 = F_420 ( & V_5 -> V_12 -> V_111 ,
V_1345 ,
& V_131 -> V_1350 ,
V_627 ) ;
if ( ! V_131 -> V_134 )
...
static int F_423 ( struct V_4 * V_5 , unsigned long V_1356 , T_1 V_1357 , bool V_1358 )
{
unsigned int V_42 ;
T_1 V_7 ;
if ( F_23 ( V_5 , 5705_PLUS ) ) {
...
static int F_424 ( struct V_4 * V_5 , bool V_1358 )
{
int V_42 , V_75 ;
F_45 ( V_5 ) ;
if ( F_36 ( V_5 -> V_12 ) ) {
...
F_31 ( V_356 , V_5 -> V_349 ) ;
F_24 ( 10 ) ;
V_75 = F_423 ( V_5 , V_1052 , V_1362 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1046 , V_1363 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1054 , V_1364 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1048 , V_1365 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1051 , V_1366 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1053 , V_1367 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1043 , V_1368 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1044 , V_1369 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1041 , V_1370 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1060 , V_1371 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1042 , V_1372 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1071 , V_1373 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1045 , V_1374 , V_1358 ) ;
V_5 -> V_362 &= ~ V_727 ;
F_31 ( V_377 , V_5 -> V_362 ) ;
F_24 ( 40 ) ;
V_5 -> V_351 &= ~ V_1360 ;
...
V_75 |= F_423 ( V_5 , V_138 , V_128 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1061 , V_1375 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1055 , V_1376 , V_1358 ) ;
F_46 ( V_1069 , 0xffffffff ) ;
F_46 ( V_1069 , 0x00000000 ) ;
V_75 |= F_423 ( V_5 , V_1059 , V_1377 , V_1358 ) ;
V_75 |= F_423 ( V_5 , V_1058 , V_1378 , V_1358 ) ;
V_1361:
for ( V_42 = 0 ; V_42 < V_5 -> V_129 ; V_42 ++ ) {
struct V_130 * V_131 = & V_5 -> V_123 [ V_42 ] ;
if ( V_131 -> V_134 )
...
{
F_426 ( V_5 -> V_12 , V_1379 , & V_5 -> V_1380 ) ;
}
...
F_428 ( V_5 -> V_12 , V_1379 , V_5 -> V_1380 ) ;
if ( ! F_23 ( V_5 , V_1074 ) ) {
F_429 ( V_5 -> V_12 , V_1387 ,
V_5 -> V_1388 ) ;
F_429 ( V_5 -> V_12 , V_1389 ,
V_5 -> V_1390 ) ;
}
if ( F_23 ( V_5 , V_836 ) ) {
T_3 V_1391 ;
F_426 ( V_5 -> V_12 , V_5 -> V_1392 + V_1393 ,
& V_1391 ) ;
V_1391 &= ~ V_1394 ;
F_428 ( V_5 -> V_12 , V_5 -> V_1392 + V_1393 ,
V_1391 ) ;
}
if ( F_23 ( V_5 , 5780_CLASS ) ) {
if ( F_23 ( V_5 , V_1395 ) ) {
...
F_24 ( 120 ) ;
if ( F_23 ( V_5 , V_1074 ) && F_434 ( V_5 -> V_12 ) ) {
T_3 V_1417 ;
if ( F_77 ( V_5 ) == V_1414 ) {
int V_622 ;
T_1 V_1418 ;
...
static int F_436 ( struct V_4 * V_5 , int V_95 , bool V_1358 )
{
int V_75 ;
F_93 ( V_5 ) ;
F_94 ( V_5 , V_95 ) ;
...
F_95 ( V_5 , V_95 ) ;
if ( V_5 -> V_1351 ) {
F_437 ( V_5 , & V_5 -> V_1439 ) ;
F_438 ( V_5 , & V_5 -> V_1440 ) ;
memset ( V_5 -> V_1351 , 0 , sizeof( struct V_1352 ) ) ;
}
return V_75 ;
}
static int F_439 ( struct V_359 * V_111 , void * V_1441 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
struct V_1442 * V_184 = V_1441 ;
int V_75 = 0 ;
bool V_688 = false ;
if ( ! F_440 ( V_184 -> V_1443 ) )
return - V_1444 ;
...
static void F_442 ( struct V_4 * V_5 , T_1 V_1452 ,
...
static void F_445 ( struct V_4 * V_5 , struct V_1459 * V_1460 )
{
F_443 ( V_5 , V_1460 ) ;
F_444 ( V_5 , V_1460 ) ;
if ( ! F_23 ( V_5 , 5705_PLUS ) ) {
...
V_1497 = V_1504 ;
V_1499 = F_323 ( V_1497 / 2 , V_5 -> V_1200 ) ;
V_1498 = F_452 ( T_1 , V_5 -> V_1338 / 8 , 1 ) ;
V_7 = F_323 ( V_1499 , V_1498 ) ;
F_46 ( V_1505 , V_7 ) ;
...
return;
V_1497 = V_1507 ;
V_1498 = F_452 ( T_1 , V_5 -> V_1342 / 8 , 1 ) ;
V_7 = F_323 ( V_1497 / 2 , V_1498 ) ;
F_46 ( V_1508 , V_7 ) ;
if ( F_23 ( V_5 , 57765_PLUS ) )
F_46 ( V_1509 , V_1497 ) ;
}
static inline T_1 F_453 ( unsigned char * V_621 , int V_74 )
{
T_1 V_161 ;
T_1 V_591 ;
int V_622 , V_1510 ;
...
static void F_454 ( struct V_4 * V_5 , unsigned int V_1511 )
{
...
static void F_441 ( struct V_359 * V_111 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
T_1 V_349 ;
V_349 = V_5 -> V_349 & ~ ( V_1516 |
V_1198 ) ;
#if ! F_363 ( V_1517 ) && ! F_363 ( V_1518 )
if ( ! F_23 ( V_5 , V_303 ) )
V_349 |= V_1198 ;
#endif
...
T_1 V_1525 ;
F_456 (ha, dev) {
V_1525 = F_453 ( V_1522 -> V_184 , V_1526 ) ;
V_44 = ~ V_1525 & 0x7f ;
V_1524 = ( V_44 & 0x60 ) >> 5 ;
V_44 &= 0x1f ;
...
static void F_461 ( struct V_4 * V_5 , T_1 V_1527 )
{
int V_42 ;
for ( V_42 = 0 ; V_42 < V_1528 ; V_42 ++ )
V_5 -> V_1529 [ V_42 ] = F_462 ( V_42 , V_1527 ) ;
}
...
static inline T_1 F_465 ( struct V_4 * V_5 )
{
if ( F_30 ( V_5 ) == V_472 )
return V_1531 ;
else
...
static int F_466 ( struct V_4 * V_5 , bool V_1533 )
{
T_1 V_7 , V_1534 ;
int V_42 , V_75 , V_202 ;
...
F_316 ( V_18 , V_1123 -> V_1085 ) ;
V_1123 -> V_1087 =
F_23 ( V_5 , V_1340 ) ? V_5 -> V_1342 : 0 ;
F_316 ( V_1204 , V_1123 -> V_1087 ) ;
F_450 ( V_5 ) ;
F_197 ( V_5 , false ) ;
F_46 ( V_1624 ,
...
if ( F_33 ( V_1708 + ( V_42 << 2 ) ) > F_469 ( V_5 ) )
break;
}
if ( V_42 < V_1707 ) {
V_7 = F_33 ( V_1661 ) ;
...
static int F_471 ( struct V_4 * V_5 , bool V_1533 )
{
F_198 ( V_5 ) ;
F_97 ( V_5 ) ;
F_54 ( V_5 ) ;
F_46 ( V_40 , 0 ) ;
return F_466 ( V_5 , V_1533 ) ;
}
static void F_472 ( struct V_4 * V_5 , struct V_1772 * V_1773 )
{
int V_42 ;
...
static T_16 F_473 ( struct V_538 * V_111 ,
struct V_1780 * V_1781 , char * V_621 )
{
struct V_1782 * V_1783 = F_474 ( V_1781 ) ;
struct V_4 * V_5 = F_475 ( V_111 ) ;
T_1 V_1784 ;
F_70 ( & V_5 -> V_209 ) ;
...
if ( ! V_629 )
return;
V_5 -> V_1785 = F_479 ( & V_12 -> V_111 , L_56 ,
V_5 , V_1790 ) ;
if ( F_116 ( V_5 -> V_1785 ) ) {
V_5 -> V_1785 = NULL ;
...
static inline void F_476 ( struct V_4 * V_5 ) { }
static inline void F_478 ( struct V_4 * V_5 ) { }
static void F_480 ( struct V_4 * V_5 )
{
struct V_1352 * V_1791 = V_5 -> V_1351 ;
if ( ! V_5 -> V_335 )
return;
F_481 ( & V_1791 -> V_1792 , V_1793 ) ;
F_481 ( & V_1791 -> V_1794 , V_1795 ) ;
F_481 ( & V_1791 -> V_1796 , V_1797 ) ;
F_481 ( & V_1791 -> V_1798 , V_1799 ) ;
F_481 ( & V_1791 -> V_1800 , V_1801 ) ;
F_481 ( & V_1791 -> V_1802 , V_1803 ) ;
F_481 ( & V_1791 -> V_1804 , V_1805 ) ;
F_481 ( & V_1791 -> V_1806 , V_1807 ) ;
F_481 ( & V_1791 -> V_1808 , V_1809 ) ;
F_481 ( & V_1791 -> V_1810 , V_1811 ) ;
F_481 ( & V_1791 -> V_1812 , V_1813 ) ;
F_481 ( & V_1791 -> V_1814 , V_1815 ) ;
F_481 ( & V_1791 -> V_1816 , V_1817 ) ;
...
F_481 ( & V_1791 -> V_1818 , V_1819 ) ;
F_481 ( & V_1791 -> V_1820 , V_1821 ) ;
F_481 ( & V_1791 -> V_1822 , V_1823 ) ;
F_481 ( & V_1791 -> V_1824 , V_1825 ) ;
F_481 ( & V_1791 -> V_1826 , V_1827 ) ;
F_481 ( & V_1791 -> V_1828 , V_1829 ) ;
F_481 ( & V_1791 -> V_1830 , V_1831 ) ;
F_481 ( & V_1791 -> V_1832 , V_1833 ) ;
F_481 ( & V_1791 -> V_1834 , V_1835 ) ;
F_481 ( & V_1791 -> V_1836 , V_1837 ) ;
F_481 ( & V_1791 -> V_1838 , V_1839 ) ;
F_481 ( & V_1791 -> V_1840 , V_1841 ) ;
F_481 ( & V_1791 -> V_1842 , V_1843 ) ;
F_481 ( & V_1791 -> V_1844 , V_1845 ) ;
F_481 ( & V_1791 -> V_1846 , V_1847 ) ;
if ( F_30 ( V_5 ) != V_471 &&
F_30 ( V_5 ) != V_762 &&
F_77 ( V_5 ) != V_1613 &&
F_77 ( V_5 ) != V_1614 ) {
F_481 ( & V_1791 -> V_1848 , V_1849 ) ;
} else {
T_1 V_7 = F_33 ( V_1223 ) ;
V_7 = ( V_7 & V_1224 ) ? 1 : 0 ;
if ( V_7 ) {
...
static void F_483 ( unsigned long V_1853 )
{
...
static void F_488 ( struct V_4 * V_5 )
{
F_489 ( & V_5 -> V_1870 ) ;
}
static int F_490 ( struct V_4 * V_5 , bool V_1533 )
__releases( V_5 -> V_209 )
__acquires( V_5 -> V_209 )
{
int V_75 ;
V_75 = F_471 ( V_5 , V_1533 ) ;
if ( V_75 ) {
F_187 ( V_5 -> V_111 ,
L_58 ) ;
F_436 ( V_5 , V_110 , 1 ) ;
...
static void F_492 ( struct V_1876 * V_1877 )
{
...
static int F_495 ( struct V_4 * V_5 , int V_1879 )
{
T_17 V_1880 ;
unsigned long V_10 ;
char * V_268 ;
...
return F_496 ( V_131 -> V_1230 , V_1880 , V_10 , V_268 , V_131 ) ;
}
...
return - V_82 ;
F_45 ( V_5 ) ;
F_498 ( V_131 -> V_1230 , V_131 ) ;
if ( F_23 ( V_5 , 57765_PLUS ) ) {
V_7 = F_33 ( V_1070 ) | V_1690 ;
F_46 ( V_1070 , V_7 ) ;
}
V_75 = F_496 ( V_131 -> V_1230 , F_356 ,
...
if ( ! F_23 ( V_5 , V_1395 ) )
return 0 ;
F_426 ( V_5 -> V_12 , V_1379 , & V_1380 ) ;
F_428 ( V_5 -> V_12 , V_1379 ,
V_1380 & ~ V_1885 ) ;
V_75 = F_497 ( V_5 ) ;
F_428 ( V_5 -> V_12 , V_1379 , V_1380 ) ;
if ( ! V_75 )
return 0 ;
if ( V_75 != - V_210 )
return V_75 ;
...
L_64
L_65 ) ;
F_498 ( V_5 -> V_123 [ 0 ] . V_1230 , & V_5 -> V_123 [ 0 ] ) ;
F_501 ( V_5 -> V_12 ) ;
F_86 ( V_5 , V_1395 ) ;
...
static int F_502 ( struct V_4 * V_5 )
{
const struct V_654 * V_655 ;
if ( F_503 ( & V_5 -> V_657 , V_5 -> V_1886 , & V_5 -> V_12 -> V_111 ) ) {
...
static T_1 F_505 ( struct V_4 * V_5 )
{
T_1 V_129 = F_506 ( V_5 -> V_1214 , V_5 -> V_1348 ) ;
if ( V_129 > 1 ) {
V_129 = F_507 ( unsigned , V_129 + 1 , V_5 -> V_122 ) ;
}
return V_129 ;
}
static bool F_508 ( struct V_4 * V_5 )
{
int V_42 , V_623 ;
...
V_623 = F_510 ( V_5 -> V_12 , V_1889 , 1 , V_5 -> V_129 ) ;
if ( V_623 < 0 ) {
return false ;
} else if ( V_623 < V_5 -> V_129 ) {
F_511 ( V_5 -> V_111 , L_68 ,
V_5 -> V_129 , V_623 ) ;
V_5 -> V_129 = V_623 ;
V_5 -> V_1214 = F_506 ( V_623 - 1 , 1 ) ;
if ( V_5 -> V_1348 )
V_5 -> V_1348 = F_323 ( V_5 -> V_1214 , V_5 -> V_1895 ) ;
}
for ( V_42 = 0 ; V_42 < V_5 -> V_122 ; V_42 ++ )
V_5 -> V_123 [ V_42 ] . V_1230 = V_1889 [ V_42 ] . V_1894 ;
if ( F_512 ( V_5 -> V_111 , V_5 -> V_1214 ) ) {
F_513 ( V_5 -> V_12 ) ;
return false ;
}
if ( V_5 -> V_129 == 1 )
...
if ( F_23 ( V_5 , V_1056 ) && F_508 ( V_5 ) )
F_84 ( V_5 , V_1688 ) ;
else if ( F_23 ( V_5 , V_1896 ) && F_516 ( V_5 -> V_12 ) == 0 )
F_84 ( V_5 , V_1395 ) ;
if ( F_23 ( V_5 , V_1395 ) || F_23 ( V_5 , V_1688 ) ) {
...
static void F_517 ( struct V_4 * V_5 )
{
if ( F_23 ( V_5 , V_1688 ) )
F_513 ( V_5 -> V_12 ) ;
...
static int F_518 ( struct V_4 * V_5 , bool V_1533 , bool V_1899 ,
bool V_1900 )
{
struct V_359 * V_111 = V_5 -> V_111 ;
int V_42 , V_75 ;
...
static void F_520 ( struct V_4 * V_5 )
{
int V_42 ;
F_328 ( V_5 ) ;
F_344 ( V_5 ) ;
...
static int F_522 ( struct V_359 * V_111 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( V_5 -> V_1906 ) {
F_187 ( V_111 , L_76
...
static inline T_6 F_523 ( T_18 * V_7 )
{
return ( ( T_6 ) V_7 -> V_481 << 32 ) | ( ( T_6 ) V_7 -> V_480 ) ;
}
static T_6 F_524 ( struct V_4 * V_5 )
{
...
return F_523 ( & V_1351 -> V_1828 ) ;
}
static void F_438 ( struct V_4 * V_5 , struct V_1908 * V_1909 )
{
...
static void F_437 ( struct V_4 * V_5 , struct V_1952 * V_1953 )
{
...
static void F_527 ( struct V_359 * V_111 ,
...
static int F_528 ( struct V_359 * V_111 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
return V_5 -> V_1970 ;
}
static int F_529 ( struct V_359 * V_111 , struct V_1971 * V_1972 , T_4 * V_72 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_56 , V_1973 = 0 ;
T_4 * V_1974 ;
...
static int F_533 ( struct V_359 * V_111 , struct V_1971 * V_1972 , T_4 * V_72 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_56 ;
...
static int F_534 ( struct V_359 * V_111 ,
struct V_1985 * V_637 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
T_1 V_388 , V_393 ;
...
static int F_537 ( struct V_359 * V_111 ,
...
static void F_540 ( struct V_359 * V_111 , struct V_2007 * V_982 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
F_541 ( V_982 -> V_2008 , V_2009 , sizeof( V_982 -> V_2008 ) ) ;
F_541 ( V_982 -> V_1969 , V_2010 , sizeof( V_982 -> V_1969 ) ) ;
F_541 ( V_982 -> V_2011 , V_5 -> V_2012 , sizeof( V_982 -> V_2011 ) ) ;
F_541 ( V_982 -> V_2013 , F_542 ( V_5 -> V_12 ) , sizeof( V_982 -> V_2013 ) ) ;
}
static void F_543 ( struct V_359 * V_111 , struct V_2014 * V_2015 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( F_23 ( V_5 , V_712 ) && F_544 ( & V_5 -> V_12 -> V_111 ) )
V_2015 -> V_388 = V_2016 ;
else
V_2015 -> V_388 = 0 ;
V_2015 -> V_2017 = 0 ;
if ( F_23 ( V_5 , V_112 ) && F_544 ( & V_5 -> V_12 -> V_111 ) )
V_2015 -> V_2017 = V_2016 ;
memset ( & V_2015 -> V_2018 , 0 , sizeof( V_2015 -> V_2018 ) ) ;
}
static int F_545 ( struct V_359 * V_111 , struct V_2014 * V_2015 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
return - V_64 ;
if ( ( V_2015 -> V_2017 & V_2016 ) &&
! ( F_23 ( V_5 , V_712 ) && F_544 ( V_2019 ) ) )
return - V_64 ;
F_546 ( V_2019 , V_2015 -> V_2017 & V_2016 ) ;
if ( F_44 ( V_2019 ) )
F_84 ( V_5 , V_112 ) ;
else
F_86 ( V_5 , V_112 ) ;
...
static T_1 F_547 ( struct V_359 * V_111 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
return V_5 -> V_2020 ;
}
static void F_548 ( struct V_359 * V_111 , T_1 V_2021 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
V_5 -> V_2020 = V_2021 ;
}
static int F_549 ( struct V_359 * V_111 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_2022 ;
if ( ! F_146 ( V_111 ) )
...
static void F_550 ( struct V_359 * V_111 , struct V_2023 * V_2024 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
static int F_551 ( struct V_359 * V_111 , struct V_2023 * V_2024 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
static void F_552 ( struct V_359 * V_111 , struct V_2029 * V_2030 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
static int F_553 ( struct V_359 * V_111 , struct V_2029 * V_2030 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_75 = 0 ;
if ( V_5 -> V_324 . V_347 == V_352 )
...
static int F_554 ( struct V_359 * V_111 , int V_2034 )
{
switch ( V_2034 ) {
case V_2035 :
return V_2036 ;
...
static int F_555 ( struct V_359 * V_111 , struct V_2039 * V_982 ,
T_1 * T_19 V_2040 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( ! F_23 ( V_5 , V_1056 ) )
...
static T_1 F_557 ( struct V_359 * V_111 )
{
T_1 V_629 = 0 ;
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( F_23 ( V_5 , V_1056 ) )
...
static int F_558 ( struct V_359 * V_111 , T_1 * V_2043 , T_4 * V_2044 , T_4 * V_2045 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_42 ;
if ( V_2045 )
...
static int F_559 ( struct V_359 * V_111 , const T_1 * V_2043 , const T_4 * V_2044 ,
const T_4 V_2045 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
T_20 V_42 ;
...
static void F_560 ( struct V_359 * V_111 ,
...
V_2049 -> V_2053 = F_323 ( V_2050 , V_5 -> V_1893 ) ;
if ( V_5 -> V_1891 )
V_2049 -> V_2054 = V_5 -> V_1891 ;
else
V_2049 -> V_2054 = F_323 ( V_2050 , V_5 -> V_1895 ) ;
}
}
static int F_561 ( struct V_359 * V_111 ,
struct V_2048 * V_2049 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( ! F_23 ( V_5 , V_1056 ) )
...
F_520 ( V_5 ) ;
F_141 ( V_5 ) ;
F_518 ( V_5 , true , false , false ) ;
return 0 ;
}
static void F_562 ( struct V_359 * V_111 , T_1 V_2055 , T_4 * V_621 )
{
switch ( V_2055 ) {
case V_2037 :
...
static int F_564 ( struct V_359 * V_111 ,
enum V_2058 V_843 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( ! F_146 ( V_5 -> V_111 ) )
...
static void F_565 ( struct V_359 * V_111 ,
struct V_2066 * V_1909 , T_6 * V_2067 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( V_5 -> V_1351 )
F_438 ( V_5 , (struct V_1908 * ) V_2067 ) ;
else
memset ( V_2067 , 0 , sizeof( struct V_1908 ) ) ;
}
static T_5 * F_566 ( struct V_4 * V_5 , T_1 * V_2068 )
{
int V_42 ;
T_5 * V_621 ;
T_1 V_590 = 0 , V_74 = 0 ;
...
V_75 = - V_210 ;
V_2081 = F_453 ( ( unsigned char * ) V_621 , 0x10 ) ;
if ( V_2081 != F_570 ( V_621 [ 0x10 / 4 ] ) )
goto V_497;
V_2081 = F_453 ( ( unsigned char * ) & V_621 [ 0x74 / 4 ] , 0x88 ) ;
if ( V_2081 != F_570 ( V_621 [ 0xfc / 4 ] ) )
goto V_497;
F_177 ( V_621 ) ;
V_621 = F_566 ( V_5 , & V_74 ) ;
if ( ! V_621 )
return - V_267 ;
V_42 = F_571 ( ( T_4 * ) V_621 , 0 , V_74 , V_2111 ) ;
if ( V_42 > 0 ) {
V_622 = F_572 ( & ( ( T_4 * ) V_621 ) [ V_42 ] ) ;
if ( V_622 < 0 )
goto V_497;
if ( V_42 + V_2112 + V_622 > V_74 )
goto V_497;
V_42 += V_2112 ;
V_622 = F_573 ( ( T_4 * ) V_621 , V_42 , V_622 ,
V_2113 ) ;
if ( V_622 > 0 ) {
T_4 V_2104 = 0 ;
V_622 += V_2114 ;
...
if ( V_2117 && ( V_2123 [ V_42 ] . V_10 & F_578 ) )
continue;
if ( ! V_2117 && ( V_2123 [ V_42 ] . V_10 & F_577 ) )
continue;
if ( F_23 ( V_5 , V_1643 ) &&
( V_2123 [ V_42 ] . V_10 & F_579 ) )
continue;
if ( V_2118 && ( V_2123 [ V_42 ] . V_10 & F_580 ) )
continue;
...
static int F_582 ( struct V_4 * V_5 , T_1 V_590 , T_1 V_74 )
{
static const T_1 V_2128 [] = { 0x00000000 , 0xffffffff , 0xaa55a55a } ;
int V_42 ;
T_1 V_622 ;
for ( V_42 = 0 ; V_42 < F_583 ( V_2128 ) ; V_42 ++ ) {
...
static int F_584 ( struct V_4 * V_5 )
{
...
V_75 = F_582 ( V_5 , V_2136 [ V_42 ] . V_590 , V_2136 [ V_42 ] . V_74 ) ;
if ( V_75 )
break;
}
return V_75 ;
}
static int F_585 ( struct V_4 * V_5 , T_1 V_2137 , bool V_2138 )
{
...
V_1152 = F_265 ( V_131 ) ;
if ( F_366 ( V_131 , & V_7 , & V_1152 , V_1129 , V_2146 ,
...
V_131 -> V_1082 ++ ;
F_49 () ;
F_395 ( V_131 -> V_1317 , V_131 -> V_1082 ) ;
F_499 ( V_131 -> V_1317 ) ;
F_24 ( 10 ) ;
...
static int F_588 ( struct V_4 * V_5 , T_6 * V_72 , bool V_2156 )
{
int V_75 = - V_210 ;
T_1 V_2157 ;
T_1 V_2158 = 9000 ;
...
! F_23 ( V_5 , V_152 ) ) {
F_396 ( V_5 , true ) ;
if ( F_585 ( V_5 , V_2163 , false ) )
V_72 [ V_2159 ] |= V_2164 ;
if ( F_23 ( V_5 , V_1340 ) &&
F_585 ( V_5 , V_2158 + V_1194 , false ) )
V_72 [ V_2159 ] |= V_2165 ;
F_396 ( V_5 , false ) ;
}
if ( ! ( V_5 -> V_178 & V_562 ) &&
...
static void F_589 ( struct V_359 * V_111 , struct V_2167 * V_2168 ,
T_6 * V_72 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
static int F_590 ( struct V_359 * V_111 , struct V_2179 * V_2180 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
struct V_2181 V_2182 ;
if ( ! F_23 ( V_5 , V_987 ) )
return - V_1032 ;
if ( F_591 ( & V_2182 , V_2180 -> V_2183 , sizeof( V_2182 ) ) )
return - V_2184 ;
if ( V_2182 . V_10 )
return - V_64 ;
...
F_86 ( V_5 , V_1309 ) ;
return F_592 ( V_2180 -> V_2183 , & V_2182 , sizeof( V_2182 ) ) ?
- V_2184 : 0 ;
}
static int F_593 ( struct V_359 * V_111 , struct V_2179 * V_2180 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
struct V_2181 V_2182 ;
if ( ! F_23 ( V_5 , V_987 ) )
...
static int F_595 ( struct V_359 * V_111 , struct V_2179 * V_2180 , int V_637 )
{
struct V_2205 * V_72 = F_596 ( V_2180 ) ;
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_75 ;
if ( F_23 ( V_5 , V_266 ) ) {
struct V_211 * V_212 ;
...
return - V_85 ;
V_212 = F_74 ( V_5 -> V_213 , V_5 -> V_160 ) ;
return F_597 ( V_212 , V_2180 , V_637 ) ;
}
switch ( V_637 ) {
case V_2206 :
...
return V_75 ;
case V_2213 :
return F_590 ( V_111 , V_2180 ) ;
case V_2214 :
return F_593 ( V_111 , V_2180 ) ;
default:
break;
}
return - V_1032 ;
...
static int F_599 ( struct V_359 * V_111 , struct V_1459 * V_1460 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
static int F_601 ( struct V_359 * V_111 , struct V_446 * V_2229 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( ! ( V_5 -> V_178 & V_333 ) ) {
F_144 ( V_5 -> V_111 ,
...
static void F_603 ( struct V_359 * V_111 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( ! F_146 ( V_111 ) )
return;
...
static inline void F_604 ( struct V_359 * V_111 , struct V_4 * V_5 ,
int V_2231 )
{
V_111 -> V_1193 = V_2231 ;
if ( V_2231 > V_1328 ) {
...
static int F_606 ( struct V_359 * V_111 , int V_2231 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_75 ;
bool V_1533 = false ;
if ( ! F_146 ( V_111 ) ) {
F_604 ( V_111 , V_5 , V_2231 ) ;
return 0 ;
}
F_124 ( V_5 ) ;
F_344 ( V_5 ) ;
...
if ( V_7 != 0 ) {
V_5 -> V_1970 = F_609 ( ( T_3 ) ( V_7 & 0x0000ffff ) ) * 1024 ;
return;
}
}
V_5 -> V_1970 = V_2234 ;
...
static void F_611 ( struct V_4 * V_5 , T_1 V_2255 )
{
...
static struct V_2368 * F_621 ( struct V_4 * V_5 )
{
int V_42 ;
for ( V_42 = 0 ; V_42 < F_583 ( V_2369 ) ; V_42 ++ ) {
...
V_186:
if ( F_23 ( V_5 , V_712 ) )
F_546 ( & V_5 -> V_12 -> V_111 ,
F_23 ( V_5 , V_112 ) ) ;
else
F_623 ( & V_5 -> V_12 -> V_111 , false ) ;
}
static int F_624 ( struct V_4 * V_5 , T_1 V_590 , T_1 * V_7 )
{
int V_42 , V_75 ;
...
static int F_625 ( struct V_4 * V_5 , T_1 V_637 )
{
int V_42 ;
T_1 V_7 ;
...
static T_1 F_626 ( struct V_4 * V_5 )
{
T_1 V_2442 , V_2443 ;
F_46 ( V_2444 , V_2445 ) ;
if ( F_625 ( V_5 , V_2446 ) )
...
static int F_628 ( struct V_4 * V_5 )
{
T_1 V_2452 , V_2453 ;
T_1 V_2454 , V_2455 ;
int V_75 ;
...
T_1 V_2068 ;
int V_622 , V_42 = 0 ;
V_2461 = ( T_4 * ) F_566 ( V_5 , & V_2068 ) ;
if ( ! V_2461 )
goto V_2464;
V_42 = F_571 ( V_2461 , 0 , V_2068 , V_2111 ) ;
if ( V_42 < 0 )
goto V_2465;
V_2463 = F_572 ( & V_2461 [ V_42 ] ) ;
V_2462 = V_42 + V_2112 + V_2463 ;
V_42 += V_2112 ;
if ( V_2462 > V_2068 )
goto V_2465;
V_622 = F_573 ( V_2461 , V_42 , V_2463 ,
V_2466 ) ;
if ( V_622 > 0 ) {
V_74 = F_631 ( & V_2461 [ V_622 ] ) ;
V_622 += V_2114 ;
...
V_2467:
V_42 = F_573 ( V_2461 , V_42 , V_2463 ,
V_2469 ) ;
if ( V_42 < 0 )
goto V_2465;
V_74 = F_631 ( & V_2461 [ V_42 ] ) ;
V_42 += V_2114 ;
if ( V_74 > V_2470 ||
( V_74 + V_42 ) > V_2068 )
goto V_2465;
...
static int F_632 ( struct V_4 * V_5 , T_1 V_590 )
{
T_1 V_7 ;
if ( F_170 ( V_5 , V_590 , & V_7 ) ||
...
static void F_635 ( struct V_4 * V_5 , T_1 V_7 )
{
...
if ( F_30 ( V_5 ) != V_762 )
return;
if ( ! F_624 ( V_5 , V_2531 , & V_7 ) &&
! F_624 ( V_5 , V_2531 + 4 , & V_2428 ) &&
F_640 ( V_7 ) ) {
...
static void F_641 ( struct V_4 * V_5 )
{
T_1 V_7 ;
bool V_2533 = false ;
if ( V_5 -> V_2012 [ 0 ] != 0 )
...
static inline T_1 F_642 ( struct V_4 * V_5 )
{
if ( F_23 ( V_5 , V_1714 ) )
return V_2534 ;
...
static void F_646 ( struct V_4 * V_5 , T_1 V_2540 )
{
...
static bool F_647 ( struct V_4 * V_5 ,
...
static int F_648 ( struct V_4 * V_5 , const struct V_2557 * V_2558 )
{
T_1 V_2540 ;
T_1 V_2564 , V_2559 ;
T_1 V_7 ;
...
V_2579 = F_649 ( V_2578 -> V_2569 , V_2578 -> V_538 ,
V_2579 ) ;
if ( ! V_2579 ) {
V_2578 ++ ;
continue;
...
F_23 ( V_5 , 5780_CLASS ) ) {
V_5 -> V_1392 = F_651 ( V_5 -> V_12 , V_2598 ) ;
if ( ! V_5 -> V_1392 ) {
F_117 ( & V_5 -> V_12 -> V_111 ,
L_111 ) ;
return - V_210 ;
...
! F_23 ( V_5 , V_1074 ) )
F_84 ( V_5 , V_31 ) ;
F_653 ( V_5 -> V_12 , V_1387 ,
& V_5 -> V_1388 ) ;
F_653 ( V_5 -> V_12 , V_1389 ,
& V_5 -> V_1390 ) ;
if ( F_30 ( V_5 ) == V_494 &&
V_5 -> V_1390 < 64 ) {
V_5 -> V_1390 = 64 ;
...
V_7 = F_33 ( V_1058 ) ;
F_46 ( V_1058 , V_7 | V_1378 ) ;
V_5 -> V_54 = F_655 ( V_5 -> V_12 -> V_273 ) & 3 ;
if ( F_30 ( V_5 ) == V_495 ||
F_23 ( V_5 , 5780_CLASS ) ) {
if ( F_23 ( V_5 , V_836 ) ) {
F_19 ( V_5 -> V_12 ,
...
V_5 -> V_1133 = F_468 ( V_5 ) - 1 ;
V_5 -> V_1138 = F_467 ( V_5 ) - 1 ;
V_5 -> V_1201 = F_642 ( V_5 ) - 1 ;
...
struct V_359 * V_111 = V_5 -> V_111 ;
struct V_1786 * V_12 = V_5 -> V_12 ;
struct V_2649 * V_2019 = F_658 ( V_12 ) ;
const unsigned char * V_184 ;
int V_74 ;
V_184 = F_659 ( V_2019 , L_113 , & V_74 ) ;
...
#endif
if ( F_23 ( V_5 , V_263 ) ) {
V_75 = F_663 ( V_5 -> V_12 , & V_111 -> V_689 [ 0 ] ) ;
if ( ! V_75 && F_440 ( & V_111 -> V_689 [ 0 ] ) )
return 0 ;
}
V_2654 = 0x7c ;
if ( F_30 ( V_5 ) == V_495 ||
...
static T_1 F_664 ( struct V_4 * V_5 , T_1 V_7 )
{
int V_2659 ;
T_4 V_2660 ;
int V_2661 ;
F_653 ( V_5 -> V_12 , V_1387 , & V_2660 ) ;
if ( V_2660 == 0 )
V_2659 = 1024 ;
else
V_2659 = ( int ) V_2660 * 4 ;
...
! F_23 ( V_5 , V_1074 ) )
goto V_497;
#if F_363 ( V_2662 ) || F_363 ( V_2663 ) || F_363 ( V_2664 )
V_2661 = V_2665 ;
#else
#if F_363 ( V_2666 ) || F_363 ( V_2667 )
V_2661 = V_2668 ;
#else
V_2661 = 0 ;
#endif
...
static int F_665 ( struct V_4 * V_5 , T_1 * V_621 , T_9 V_2692 ,
...
static int F_666 ( struct V_4 * V_5 )
{
T_9 V_2692 ;
T_1 * V_621 , V_2703 ;
int V_56 = 0 ;
V_621 = F_411 ( & V_5 -> V_12 -> V_111 , V_2704 ,
& V_2692 , V_627 ) ;
if ( ! V_621 ) {
V_56 = - V_267 ;
goto V_2705;
...
( 0x6 << V_2707 ) ) ;
V_5 -> V_1575 = F_664 ( V_5 , V_5 -> V_1575 ) ;
if ( F_23 ( V_5 , 57765_PLUS ) )
goto V_497;
if ( F_23 ( V_5 , V_1074 ) ) {
...
V_1441 [ V_42 ] = V_42 ;
V_56 = F_665 ( V_5 , V_621 , V_2692 , V_2704 , true ) ;
if ( V_56 ) {
F_117 ( & V_5 -> V_12 -> V_111 ,
L_114 ,
V_652 , V_56 ) ;
...
V_56 = F_665 ( V_5 , V_621 , V_2692 , V_2704 , false ) ;
if ( V_56 ) {
...
V_497:
F_409 ( & V_5 -> V_12 -> V_111 , V_2704 , V_621 , V_2692 ) ;
V_2705:
return V_56 ;
}
static void F_667 ( struct V_4 * V_5 )
{
if ( F_23 ( V_5 , 57765_PLUS ) ) {
V_5 -> V_1598 . V_1599 =
V_2718 ;
...
static char * F_668 ( struct V_4 * V_5 )
{
...
static char * F_669 ( struct V_4 * V_5 , char * V_2759 )
{
if ( F_23 ( V_5 , V_1074 ) ) {
strcpy ( V_2759 , L_145 ) ;
return V_2759 ;
...
static void F_670 ( struct V_4 * V_5 )
{
...
static int F_671 ( struct V_1786 * V_12 ,
const struct V_2557 * V_2558 )
{
struct V_359 * V_111 ;
struct V_4 * V_5 ;
...
T_6 V_2778 , V_2779 ;
T_15 V_1184 = 0 ;
F_672 ( V_2780 L_155 , V_1969 ) ;
V_75 = F_673 ( V_12 ) ;
if ( V_75 ) {
F_117 ( & V_12 -> V_111 , L_156 ) ;
return V_75 ;
}
V_75 = F_674 ( V_12 , V_2009 ) ;
if ( V_75 ) {
F_117 ( & V_12 -> V_111 , L_157 ) ;
goto V_2781;
}
F_675 ( V_12 ) ;
V_111 = F_676 ( sizeof( * V_5 ) , V_1890 ) ;
if ( ! V_111 ) {
V_75 = - V_267 ;
goto V_2782;
}
F_677 ( V_111 , & V_12 -> V_111 ) ;
V_5 = F_111 ( V_111 ) ;
V_5 -> V_12 = V_12 ;
V_5 -> V_111 = V_111 ;
V_5 -> V_349 = V_2783 ;
...
F_684 ( & V_5 -> V_209 ) ;
F_684 ( & V_5 -> V_11 ) ;
F_685 ( & V_5 -> V_1217 , F_492 ) ;
V_5 -> V_8 = F_686 ( V_12 , V_2794 ) ;
if ( ! V_5 -> V_8 ) {
...
if ( F_23 ( V_5 , V_1643 ) )
V_2779 = V_2778 = F_364 ( 32 ) ;
else if ( F_23 ( V_5 , 40BIT_DMA_BUG ) ) {
V_2779 = V_2778 = F_364 ( 40 ) ;
#ifdef V_1240
V_2778 = F_364 ( 64 ) ;
#endif
} else
V_2779 = V_2778 = F_364 ( 64 ) ;
if ( V_2778 > F_364 ( 32 ) ) {
V_75 = F_687 ( V_12 , V_2778 ) ;
if ( ! V_75 ) {
V_1184 |= V_2809 ;
V_75 = F_688 ( V_12 ,
V_2779 ) ;
...
if ( V_75 || V_2778 == F_364 ( 32 ) ) {
V_75 = F_687 ( V_12 , F_364 ( 32 ) ) ;
if ( V_75 ) {
F_117 ( & V_12 -> V_111 ,
L_163 ) ;
goto V_2808;
...
F_98 ( V_111 , L_174 ,
V_5 -> V_1575 ,
V_12 -> V_2778 == F_364 ( 32 ) ? 32 :
( ( T_6 ) V_12 -> V_2778 ) == F_364 ( 40 ) ? 40 : 64 ) ;
F_692 ( V_12 ) ;
return 0 ;
V_2808:
if ( V_5 -> V_9 ) {
...
static void F_697 ( struct V_1786 * V_12 )
{
...
static int F_699 ( struct V_538 * V_538 )
{
struct V_1786 * V_12 = F_700 ( V_538 ) ;
struct V_359 * V_111 = F_154 ( V_12 ) ;
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_75 = 0 ;
F_493 () ;
...
static int F_703 ( struct V_538 * V_538 )
{
struct V_1786 * V_12 = F_700 ( V_538 ) ;
struct V_359 * V_111 = F_154 ( V_12 ) ;
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
static void F_704 ( struct V_1786 * V_12 )
{
struct V_359 * V_111 = F_154 ( V_12 ) ;
struct V_4 * V_5 = F_111 ( V_111 ) ;
F_493 () ;
...
static T_21 F_706 ( struct V_1786 * V_12 )
{
struct V_359 * V_2831 = F_154 ( V_12 ) ;
struct V_4 * V_5 = F_111 ( V_2831 ) ;
T_21 V_623 = V_2835 ;
...
static void F_708 ( struct V_1786 * V_12 )
{
struct V_359 * V_2831 = F_154 ( V_12 ) ;
struct V_4 * V_5 = F_111 ( V_2831 ) ;
int V_75 ;
