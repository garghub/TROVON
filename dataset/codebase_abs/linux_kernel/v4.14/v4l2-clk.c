...
static int F_19 ( struct V_1 * V_3 )
{
struct V_1 * V_17 ;
int V_18 = - V_4 ;
F_10 ( & V_14 ) ;
...
unsigned long F_28 ( struct V_1 * V_3 )
{
int V_18 ;
if ( V_3 -> V_3 )
return F_29 ( V_3 -> V_3 ) ;
...
int F_30 ( struct V_1 * V_3 , unsigned long V_28 )
{
int V_18 ;
if ( V_3 -> V_3 ) {
long V_29 = F_31 ( V_3 -> V_3 , V_28 ) ;
if ( V_29 < 0 )
return V_29 ;
return F_32 ( V_3 -> V_3 , V_29 ) ;
}
V_18 = F_19 ( V_3 ) ;
if ( V_18 < 0 )
return V_18 ;
...
struct V_1 * F_33 ( const struct V_31 * V_19 ,
const char * V_2 ,
void * V_32 )
{
struct V_1 * V_3 ;
...
static unsigned long F_41 ( struct V_1 * V_3 )
{
struct V_39 * V_32 = V_3 -> V_32 ;
return V_32 -> V_28 ;
}
struct V_1 * F_42 ( const char * V_2 ,
...
V_32 -> V_19 . V_26 = F_41 ;
V_32 -> V_19 . V_20 = V_20 ;
V_3 = F_33 ( & V_32 -> V_19 , V_2 , V_32 ) ;
if ( F_13 ( V_3 ) )
F_17 ( V_32 ) ;
return V_3 ;
}
void F_43 ( struct V_1 * V_3 )
{
F_17 ( V_3 -> V_32 ) ;
F_38 ( V_3 ) ;
}
