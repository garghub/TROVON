...
V_42 = F_21 ( 0 , V_39 ) | F_21 ( 1 , V_33 ) | F_21 ( 2 , V_41 ) | F_21 ( 3 , V_31 ) |
F_21 ( 4 , V_39 ) | F_21 ( 5 , V_37 ) | F_21 ( 6 , V_41 ) | F_21 ( 7 , V_35 ) ;
}
if ( ! V_3 ) {
F_14 ( V_42 ) ;
V_3 = true ;
...
{
if ( ! F_54 ( V_77 << V_72 , V_97 ) )
V_101 = F_55 ( V_101 ) ;
return V_101 ;
}
static inline int F_56 ( unsigned long V_77 , unsigned long V_97 )
{
return 1 ;
}
static inline int F_56 ( unsigned long V_77 , unsigned long V_97 )
...
int F_58 ( struct V_100 * V_100 , unsigned long V_77 ,
unsigned long V_97 , T_5 * V_101 )
{
enum V_7 V_105 = V_14 ;
if ( ! F_56 ( V_77 , V_97 ) )
...
{
unsigned long V_110 ;
if ( V_109 > F_62 ( V_111 - 1 ) )
return 0 ;
if ( ! F_63 ( V_109 >> V_72 ) )
return 0 ;
V_110 = ( F_62 ( V_111 - 1 ) <= V_109 + V_97 ) ?
F_62 ( V_111 ) - V_109 :
V_97 ;
if ( F_64 ( ( unsigned long ) F_65 ( V_109 ) , V_110 , V_105 ) < 0 ) {
F_3 ( L_20 ,
V_92 -> V_93 , V_92 -> V_94 ,
F_37 ( V_105 ) ,
...
static int F_66 ( T_2 V_95 , unsigned long V_97 , T_5 * V_101 ,
int V_112 )
{
int V_113 = 0 ;
int V_70 ;
enum V_7 V_114 = F_67 ( * V_101 ) ;
...
static void F_70 ( T_2 V_95 , unsigned long V_97 )
{
int V_113 ;
V_113 = F_26 ( V_95 , V_95 + V_97 ) ;
if ( V_113 == 0 )
...
if ( F_72 ( V_116 , V_116 -> V_120 , 0 , & V_117 , & V_95 ) ) {
F_29 ( 1 ) ;
return - V_79 ;
}
V_121 = F_59 ( V_117 ) ;
return F_66 ( V_95 , V_118 , & V_121 , 1 ) ;
}
return 0 ;
}
int F_73 ( struct V_115 * V_116 , T_5 * V_117 ,
...
* V_117 = F_59 ( ( F_60 ( * V_117 ) & ( ~ V_108 ) ) |
F_61 ( V_105 ) ) ;
return 0 ;
}
void F_74 ( struct V_115 * V_116 , T_5 * V_117 , T_6 V_77 )
{
enum V_7 V_105 ;
if ( ! F_5 () )
return;
V_105 = F_44 ( F_75 ( V_77 ) ) ;
* V_117 = F_59 ( ( F_60 ( * V_117 ) & ( ~ V_108 ) ) |
F_61 ( V_105 ) ) ;
}
void F_76 ( struct V_115 * V_116 , unsigned long V_77 ,
unsigned long V_97 )
{
T_4 V_95 ;
unsigned long V_117 ;
...
void F_77 ( struct V_115 * V_116 )
{
V_116 -> V_122 &= ~ V_123 ;
}
T_5 F_78 ( T_5 V_117 )
{
return F_59 ( F_60 ( V_117 ) |
F_61 ( V_16 ) ) ;
}
T_5 F_79 ( T_5 V_117 )
{
...
static struct V_20 * F_80 ( T_7 V_125 )
{
struct V_20 * V_126 ;
int V_70 ;
...
static void * F_82 ( struct V_127 * V_128 , T_7 * V_125 )
{
if ( * V_125 == 0 ) {
++ * V_125 ;
F_83 ( V_128 , L_23 ) ;
...
static void * F_84 ( struct V_127 * V_128 , void * V_129 , T_7 * V_125 )
{
++ * V_125 ;
return F_80 ( * V_125 ) ;
}
static void F_85 ( struct V_127 * V_128 , void * V_129 )
{
}
static int F_86 ( struct V_127 * V_128 , void * V_129 )
{
struct V_20 * V_126 = (struct V_20 * ) V_129 ;
F_87 ( V_128 , L_24 , F_37 ( V_126 -> type ) ,
V_126 -> V_56 , V_126 -> V_57 ) ;
F_38 ( V_126 ) ;
return 0 ;
}
static int F_88 ( struct V_130 * V_130 , struct V_100 * V_100 )
{
return F_89 ( V_100 , & V_131 ) ;
}
