...
F_70 () ;
#ifdef F_10
F_135 ( V_1 -> V_10 . V_19 , NULL ) ;
F_135 ( V_1 -> V_10 . V_21 , NULL ) ;
#endif
for ( V_298 = 0 ; V_298 < V_22 ; V_298 ++ ) {
struct V_23 * V_24 = & V_1 -> V_10 . V_11 [ V_298 ] ;
struct V_29 * V_30 ;
struct V_2 * V_15 ;
F_16 (tb, tmp, head, tb_hlist) {
F_136 ( & V_15 -> V_9 ) ;
...
static int T_1 F_138 ( struct V_1 * V_1 )
{
int error ;
#ifdef F_139
V_1 -> V_10 . F_47 = 0 ;
...
static void T_7 F_141 ( struct V_1 * V_1 )
{
F_142 ( V_1 ) ;
F_115 ( V_1 ) ;
F_134 ( V_1 ) ;
...
F_146 ( & V_302 ) ;
F_147 ( & V_303 ) ;
F_148 ( V_304 , V_229 , F_88 , NULL , 0 ) ;
F_148 ( V_304 , V_253 , F_86 , NULL , 0 ) ;
F_148 ( V_304 , V_305 , NULL , F_89 , 0 ) ;
}
