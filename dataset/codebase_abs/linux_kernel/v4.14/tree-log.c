...
if ( V_294 -> V_253 <= V_332 )
continue;
if ( V_294 -> V_36 < V_330 )
V_330 = V_294 -> V_36 ;
if ( ( V_294 -> V_36 + V_294 -> V_37 - 1 ) > V_331 )
V_331 = V_294 -> V_36 + V_294 -> V_37 - 1 ;
F_259 ( & V_294 -> V_340 ) ;
F_5 ( V_341 , & V_294 -> V_263 ) ;
F_10 ( & V_294 -> V_25 , & V_326 ) ;
V_333 ++ ;
}
F_260 ( NULL , & V_326 , F_237 ) ;
F_261 ( V_84 , V_295 , V_330 , V_331 ) ;
...
return 0 ;
V_344 = V_44 . V_82 + V_37 ;
V_345 = V_165 - V_344 ;
}
F_31 ( V_41 ) ;
if ( V_345 == 0 )
return 0 ;
V_345 = F_58 ( V_345 , V_8 -> V_89 ) ;
V_9 = F_236 ( V_2 , log , V_147 , V_344 , 0 , 0 ,
V_345 , 0 , V_345 , 0 , 0 , 0 ) ;
return V_9 ;
}
...
if ( V_44 -> type == V_136 ) {
struct V_119 * V_351 ;
V_351 = (struct V_119 * ) ( V_121 + V_139 ) ;
V_200 = V_44 -> V_82 ;
V_350 = F_94 ( V_30 , V_351 ) ;
V_123 = ( unsigned long ) ( V_351 + 1 ) ;
V_184 = sizeof( * V_351 ) + V_350 ;
} else {
struct V_133 * V_134 ;
V_134 = (struct V_133 * ) ( V_121 +
V_139 ) ;
V_200 = F_102 ( V_30 , V_134 ) ;
V_350 = F_101 ( V_30 , V_134 ) ;
V_123 = ( unsigned long ) & V_134 -> V_112 ;
V_184 = sizeof( * V_134 ) + V_350 ;
}
...
F_34 ( V_30 , V_112 , V_123 , V_350 ) ;
V_111 = F_90 ( NULL , V_84 -> V_4 , V_347 ,
V_200 , V_112 , V_350 , 0 ) ;
if ( V_111 && ! F_89 ( V_111 ) ) {
struct V_43 V_168 ;
F_82 ( V_347 -> V_59 [ 0 ] ,
...
V_243 = V_41 -> V_59 [ 0 ] ;
if ( V_343 && V_353 + V_343 == V_41 -> V_60 [ 0 ] ) {
V_343 ++ ;
goto V_369;
} else if ( ! V_343 ) {
V_353 = V_41 -> V_60 [ 0 ] ;
...
list) {
const T_1 V_370 = V_294 -> V_299 + V_294 -> V_300 - 1 ;
if ( V_294 -> V_299 >= V_36 && V_370 <= V_230 )
F_170 ( & V_294 -> V_25 ) ;
}
F_264 ( & V_355 -> V_335 ) ;
}
if ( V_267 == V_362 && F_39 ( V_84 -> V_138 . V_152 ) ) {
...
{
int V_9 = 0 ;
struct V_373 * V_376 = NULL ;
struct V_108 * V_377 = V_84 ;
if ( F_46 ( V_84 -> V_138 . V_152 ) &&
V_84 -> V_253 <= V_375 &&
V_84 -> V_372 <= V_375 )
goto V_13;
if ( ! F_39 ( V_84 -> V_138 . V_152 ) ) {
if ( ! V_200 || F_286 ( V_200 ) || V_366 != V_200 -> V_378 )
goto V_13;
...
if ( ! V_41 )
return - V_63 ;
V_382 = F_32 ( sizeof( * V_382 ) , V_62 ) ;
if ( ! V_382 ) {
F_96 ( V_41 ) ;
return - V_63 ;
}
V_382 -> V_147 = F_61 ( V_379 ) ;
F_10 ( & V_382 -> V_25 , & V_380 ) ;
while ( ! F_73 ( & V_380 ) ) {
struct V_29 * V_94 ;
struct V_43 V_242 ;
int V_174 ;
int V_178 ;
V_382 = F_292 ( & V_380 , struct V_381 ,
V_25 ) ;
if ( V_9 )
goto V_383;
V_242 . V_54 = V_382 -> V_147 ;
V_242 . type = V_163 ;
V_242 . V_82 = 0 ;
V_135:
F_31 ( V_41 ) ;
...
continue;
F_31 ( V_41 ) ;
V_384 = F_278 ( V_8 -> V_366 , & V_168 , V_4 , NULL ) ;
if ( F_89 ( V_384 ) ) {
V_9 = F_136 ( V_384 ) ;
goto V_383;
}
if ( F_293 ( F_62 ( V_384 ) , V_2 -> V_79 ) ) {
F_80 ( V_384 ) ;
break;
}
V_6 -> V_247 = false ;
if ( type == V_167 || type == V_387 )
V_386 = V_362 ;
V_9 = F_272 ( V_2 , V_4 , F_62 ( V_384 ) ,
V_386 , 0 , V_368 , V_6 ) ;
if ( ! V_9 &&
F_284 ( V_2 , F_62 ( V_384 ) ) )
V_9 = 1 ;
F_80 ( V_384 ) ;
if ( V_9 )
goto V_383;
if ( V_6 -> V_247 ) {
V_385 = F_32 ( sizeof( * V_385 ) ,
V_62 ) ;
if ( ! V_385 ) {
V_9 = - V_63 ;
goto V_383;
}
V_385 -> V_147 = V_168 . V_54 ;
F_10 ( & V_385 -> V_25 , & V_380 ) ;
}
break;
}
if ( V_178 == V_174 ) {
...
V_364 . V_54 = V_44 . V_82 ;
V_139 = V_45 ;
}
V_388 = F_278 ( V_8 -> V_366 , & V_364 ,
V_4 , NULL ) ;
if ( F_89 ( V_388 ) )
continue;
if ( V_6 )
V_6 -> V_247 = false ;
V_9 = F_272 ( V_2 , V_4 , F_62 ( V_388 ) ,
V_362 , 0 , V_368 , V_6 ) ;
if ( ! V_9 &&
F_284 ( V_2 , F_62 ( V_388 ) ) )
V_9 = 1 ;
...
V_9 = F_285 ( V_2 , V_84 , V_200 , V_366 ,
V_375 ) ;
if ( V_9 )
goto V_392;
...
struct V_3 * V_4 , struct V_373 * V_373 ,
const T_6 V_36 ,
const T_6 V_230 ,
struct V_5 * V_6 )
{
struct V_373 * V_200 = F_289 ( V_373 ) ;
int V_9 ;
V_9 = F_295 ( V_2 , V_4 , F_62 ( F_287 ( V_373 ) ) ,
...
V_396 . V_54 = V_156 . V_82 ;
V_396 . type = V_246 ;
V_396 . V_82 = ( T_1 ) - 1 ;
V_32 . V_191 = F_302 ( V_8 , & V_396 ) ;
if ( F_89 ( V_32 . V_191 ) ) {
...
struct V_108 * V_84 , struct V_108 * V_402 ,
struct V_373 * V_200 )
{
struct V_7 * V_8 = F_231 ( V_84 -> V_138 . V_268 ) ;
struct V_3 * V_4 = V_84 -> V_4 ;
if ( F_46 ( V_84 -> V_138 . V_152 ) )
V_84 -> V_372 = V_2 -> V_79 ;
if ( V_84 -> V_234 <= V_8 -> V_336 &&
( ! V_402 || V_402 -> V_234 <= V_8 -> V_336 ) )
return 0 ;
