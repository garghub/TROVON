...
void
F_46 ( struct V_5 * V_6 , const char * V_78 , const char * V_79 , ... )
{
struct V_80 V_81 ;
T_6 args ;
va_start ( args , V_79 ) ;
V_81 . V_79 = V_79 ;
V_81 . V_82 = & args ;
F_45 ( L_6 , V_6 -> V_83 , V_78 , & V_81 ) ;
va_end ( args ) ;
}
bool
F_47 ( const struct V_28 * V_28 )
{
return F_48 ( F_31 ( V_28 -> V_86 ) -> V_84 , V_87 ) ;
}
int
F_49 ( const unsigned char * V_13 , int V_88 , bool V_89 )
{
int V_90 ;
if ( V_88 > V_91 ) {
if ( V_89 )
...
int
F_50 ( unsigned char * V_94 , struct V_28 * V_28 )
{
T_1 V_88 = F_51 ( V_28 -> V_95 . V_88 , V_91 ) ;
* V_94 ++ = V_88 ;
