...
switch ( V_30 -> V_128 ) {
case V_129 :
V_30 -> V_132 = V_306 . V_308 . V_309 . V_310 ;
break;
case V_311 :
break;
default:
...
V_25 -> V_315 = & V_316 ;
V_25 -> V_39 |= V_317 ;
V_30 -> V_318 . V_39 = V_319 ;
V_25 -> V_26 . V_27 = V_28 ;
V_11 = F_139 ( & V_25 -> V_26 , V_320 , & V_30 -> V_318 ) ;
if ( V_11 < 0 )
goto V_133;
V_25 = & V_30 -> V_25 ;
F_140 ( V_25 , V_33 , & V_321 ) ;
snprintf ( V_25 -> V_246 , sizeof( V_25 -> V_246 ) , L_42 ,
F_138 ( V_33 -> V_44 ) , V_33 -> V_31 ) ;
V_25 -> V_315 = & V_322 ;
V_25 -> V_39 |= V_317 ;
V_30 -> V_323 [ V_201 ] . V_39 = V_324 ;
V_30 -> V_323 [ V_282 ] . V_39 = V_319 ;
V_25 -> V_26 . V_27 = V_325 ;
V_11 = F_139 ( & V_25 -> V_26 , V_326 , V_30 -> V_323 ) ;
if ( ! V_11 )
return 0 ;
...
V_30 -> V_170 [ V_9 ] . V_327 = V_328 [ V_9 ] ;
...
if ( V_11 < 0 )
goto V_330;
V_30 -> clock = F_146 ( V_30 -> V_25 . V_2 , V_331 ) ;
if ( F_70 ( V_30 -> clock ) ) {
V_11 = - V_332 ;
goto V_330;
}
