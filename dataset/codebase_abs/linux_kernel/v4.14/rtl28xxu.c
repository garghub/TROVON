...
F_65 ( V_2 -> V_236 , V_232 , V_226 , 0 ) ;
V_8 = F_12 ( V_2 , V_237 , 1 ) ;
if ( V_8 )
goto V_62;
V_8 = F_12 ( V_2 , V_237 , 1 ) ;
if ( V_8 )
...
if ( ! V_6 -> V_229 ) {
static const struct V_250 V_255 [] = {
{ V_221 , 0x00 , 0x04 } ,
{ V_221 , 0x00 , 0x08 } ,
{ V_256 , 0x20 , 0x20 } ,
{ V_61 , 0x00 , 0x08 } ,
...
for ( V_225 = 0 ; V_225 < F_61 ( V_255 ) ; V_225 ++ ) {
V_8 = F_14 ( V_2 , V_255 [ V_225 ] . V_25 ,
V_255 [ V_225 ] . V_26 , V_255 [ V_225 ] . V_34 ) ;
if ( V_8 )
goto V_62;
}
V_6 -> V_229 = true ;
}
V_8 = F_13 ( V_2 , V_252 , & V_13 [ 0 ] ) ;
if ( V_8 )
goto V_62;
if ( V_13 [ 0 ] != 0x83 )
goto exit;
V_8 = F_13 ( V_2 , V_266 , & V_13 [ 0 ] ) ;
if ( V_8 )
goto V_62;
V_27 = V_13 [ 0 ] ;
V_8 = F_11 ( V_2 , V_267 , V_13 , V_27 ) ;
if ( V_8 )
goto V_62;
for ( V_225 = 0 ; V_225 < F_61 ( V_251 ) ; V_225 ++ ) {
V_8 = F_14 ( V_2 , V_251 [ V_225 ] . V_25 ,
V_251 [ V_225 ] . V_26 , V_251 [ V_225 ] . V_34 ) ;
if ( V_8 )
goto V_62;
}
F_68 ( & V_249 ) ;
for ( V_225 = 0 ; V_225 < V_27 ; V_225 ++ ) {
V_249 . V_268 = V_13 [ V_225 ] >> 7 ;
V_249 . V_269 = 50800 * ( V_13 [ V_225 ] & 0x7f ) ;
F_69 ( V_2 -> V_236 , & V_249 ) ;
}
F_70 ( V_2 -> V_236 , true ) ;
F_71 ( V_2 -> V_236 ) ;
exit:
...
struct V_5 * V_6 = F_20 ( V_2 ) ;
if ( V_6 -> V_107 == V_108 )
return F_66 ( V_2 , V_239 ) ;
else
return F_72 ( V_2 , V_239 ) ;
}
...
if ( V_6 -> V_107 == V_108 ) {
struct V_117 * V_118 = & V_6 -> V_117 ;
return V_118 -> V_275 ( V_37 -> V_131 [ 0 ] , V_215 ) ;
} else {
struct V_148 * V_118 = & V_6 -> V_148 ;
return V_118 -> V_275 ( V_37 -> V_131 [ 0 ] , V_215 ) ;
}
...
if ( V_6 -> V_107 == V_108 ) {
struct V_117 * V_118 = & V_6 -> V_117 ;
return V_118 -> V_277 ( V_37 -> V_131 [ 0 ] , V_17 , V_276 , V_215 ) ;
} else {
struct V_148 * V_118 = & V_6 -> V_148 ;
return V_118 -> V_277 ( V_37 -> V_131 [ 0 ] , V_17 , V_276 , V_215 ) ;
}
