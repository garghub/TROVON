...
for ( V_7 = 0 ; V_7 < V_44 && V_13 < 0 ; V_7 ++ )
if ( ! V_6 [ V_7 ] )
V_13 = V_7 ;
F_14 ( L_12 , V_13 ) ;
if ( V_13 < 0 )
return - V_45 ;
V_5 = F_31 ( sizeof( struct V_4 ) , V_46 ) ;
if ( ! V_5 )
return - V_47 ;
V_5 -> V_13 = V_31 -> V_43 ;
V_5 -> V_25 = V_25 ;
...
V_16 = F_34 ( V_13 , V_31 -> V_48 , V_35 , V_49 ) ;
if ( F_35 ( V_16 ) )
return F_36 ( V_16 ) ;
F_37 ( & V_31 -> V_37 , V_16 ) ;
if ( V_16 -> V_50 == 0 && ! V_51 ) {
...
if ( ! V_56 )
return;
V_55 = F_41 ( V_56 , L_13 , NULL ) ;
if ( ! V_55 ) {
F_42 ( V_57 L_14 ) ;
return;
}
if ( strncmp ( V_55 , L_15 , 3 ) != 0 )
return;
V_13 = F_41 ( V_56 , L_16 , NULL ) ;
if ( V_13 == NULL )
return;
V_42 . V_13 = F_43 ( V_13 , 1 ) ;
F_32 ( & V_42 . V_10 ) ;
V_6 [ 0 ] = & V_42 ;
if ( F_29 ( V_56 , L_5 ) ) {
V_42 . V_25 = V_26 ;
...
else if ( F_29 ( V_56 , L_6 ) ) {
V_42 . V_25 = V_27 ;
V_35 = & V_40 ;
F_33 ( & V_42 . V_14 , F_4 , F_8 ,
V_42 . V_13 , 1 ) ;
F_44 ( & V_42 . V_14 ) ;
} else
return;
