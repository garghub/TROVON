...
V_144 -> V_86 = * V_86 ;
V_144 -> V_86 . V_157 = V_144 -> V_157 ;
V_102 = - V_131 ;
V_4 = F_109 ( V_37 , V_120 ) ;
if ( ! V_4 )
goto V_162;
V_102 = 0 ;
if ( V_151 ) {
...
struct V_4 * F_110 ( struct V_91 * V_92 ,
const struct V_119 * V_86 ,
T_2 V_37 )
{
int V_170 ;
...
return F_108 ( - V_131 ) ;
V_102 = - V_131 ;
V_121 = F_113 ( V_120 , sizeof( struct V_110 * ) , V_37 ) ;
if ( ! V_121 )
goto V_26;
F_111 (iov, i, *iter) {
unsigned long V_154 = ( unsigned long ) V_157 . V_158 ;
...
unsigned short V_175 = V_4 -> V_109 ;
if ( V_111 <= 0 )
break;
if ( V_130 > V_111 )
V_130 = V_111 ;
...
struct V_4 * F_121 ( struct V_91 * V_92 , void * V_87 , unsigned int V_111 ,
T_2 V_37 )
{
unsigned long V_177 = ( unsigned long ) V_87 ;
unsigned long V_155 = ( V_177 + V_111 + V_126 - 1 ) >> V_160 ;
unsigned long V_156 = V_177 >> V_160 ;
...
if ( V_130 > V_111 )
V_130 = V_111 ;
if ( F_68 ( V_92 , V_4 , F_122 ( V_87 ) , V_130 ,
V_112 ) < V_130 ) {
F_28 ( V_4 ) ;
return F_108 ( - V_161 ) ;
}
...
int V_10 ;
F_89 (bvec, bio, i) {
memcpy ( V_49 , F_125 ( V_114 -> V_89 ) , V_114 -> V_88 ) ;
V_49 += V_114 -> V_88 ;
}
F_123 ( V_4 ) ;
}
struct V_4 * F_126 ( struct V_91 * V_92 , void * V_87 , unsigned int V_111 ,
T_2 V_37 , int V_178 )
{
unsigned long V_177 = ( unsigned long ) V_87 ;
unsigned long V_155 = ( V_177 + V_111 + V_126 - 1 ) >> V_160 ;
...
void F_127 ( struct V_4 * V_4 )
{
struct V_31 * V_114 ;
int V_10 ;
F_89 (bvec, bio, i) {
struct V_110 * V_110 = V_114 -> V_89 ;
if ( V_110 && ! F_128 ( V_110 ) )
F_118 ( V_110 ) ;
}
}
static void F_129 ( struct V_4 * V_4 )
{
struct V_31 * V_114 ;
int V_10 ;
F_89 (bvec, bio, i) {
...
static void F_130 ( struct V_67 * V_68 )
{
unsigned long V_59 ;
struct V_4 * V_4 ;
F_131 ( & V_179 , V_59 ) ;
...
void F_136 ( struct V_91 * V_92 , int V_184 ,
unsigned long V_185 , struct V_186 * V_187 )
{
int V_188 = F_137 () ;
F_138 ( V_92 , V_188 , V_187 ) ;
F_139 ( V_188 , V_187 , V_189 [ V_184 ] ) ;
F_140 ( V_188 , V_187 , V_185 [ V_184 ] , V_185 ) ;
F_141 ( V_92 , V_187 , V_184 ) ;
F_142 () ;
}
void F_143 ( struct V_91 * V_92 , int V_184 ,
struct V_186 * V_187 , unsigned long V_190 )
{
unsigned long V_191 = V_192 - V_190 ;
int V_188 = F_137 () ;
F_140 ( V_188 , V_187 , V_193 [ V_184 ] , V_191 ) ;
F_138 ( V_92 , V_188 , V_187 ) ;
F_144 ( V_92 , V_187 , V_184 ) ;
F_142 () ;
}
void F_145 ( struct V_4 * V_194 )
{
struct V_31 V_114 ;
struct V_85 V_86 ;
F_50 (bvec, bi, iter)
...
static inline bool F_146 ( struct V_4 * V_4 )
{
if ( ! F_54 ( V_4 , V_195 ) )
return true ;
...
if ( V_4 -> V_96 && F_54 ( V_4 , V_197 ) ) {
F_148 ( V_4 -> V_96 -> V_198 , V_4 ,
F_79 ( V_4 -> V_65 ) ) ;
F_73 ( V_4 , V_197 ) ;
}
F_149 ( V_4 ) ;
...
struct V_4 * F_150 ( struct V_4 * V_4 , int V_185 ,
T_2 V_199 , struct V_23 * V_24 )
{
struct V_4 * V_200 = NULL ;
F_32 ( V_185 <= 0 ) ;
F_32 ( V_185 >= F_151 ( V_4 ) ) ;
V_200 = F_62 ( V_4 , V_199 , V_24 ) ;
if ( ! V_200 )
return NULL ;
V_200 -> V_100 . V_104 = V_185 << 9 ;
if ( F_63 ( V_200 ) )
F_152 ( V_200 ) ;
F_85 ( V_4 , V_200 -> V_100 . V_104 ) ;
if ( F_54 ( V_4 , V_197 ) )
F_60 ( V_4 , V_197 ) ;
return V_200 ;
}
void F_153 ( struct V_4 * V_4 , int V_112 , int V_123 )
{
V_123 <<= 9 ;
...
struct V_23 * F_160 ( unsigned int V_203 ,
unsigned int V_52 ,
int V_59 )
{
unsigned int V_204 = V_81 * sizeof( struct V_31 ) ;
struct V_23 * V_24 ;
V_24 = F_161 ( sizeof( * V_24 ) , V_19 ) ;
if ( ! V_24 )
return NULL ;
V_24 -> V_52 = V_52 ;
F_162 ( & V_24 -> V_70 ) ;
F_42 ( & V_24 -> V_71 ) ;
F_163 ( & V_24 -> V_69 , F_34 ) ;
V_24 -> V_6 = F_1 ( V_52 + V_204 ) ;
if ( ! V_24 -> V_6 ) {
F_23 ( V_24 ) ;
return NULL ;
}
V_24 -> V_53 = F_155 ( V_203 , V_24 -> V_6 ) ;
if ( ! V_24 -> V_53 )
goto V_205;
if ( V_59 & V_206 ) {
V_24 -> V_50 = F_154 ( V_203 ) ;
if ( ! V_24 -> V_50 )
goto V_205;
}
if ( ! ( V_59 & V_207 ) )
return V_24 ;
V_24 -> V_75 = F_164 ( L_3 , V_208 , 0 ) ;
if ( ! V_24 -> V_75 )
goto V_205;
return V_24 ;
V_205:
...
int F_165 ( struct V_4 * V_4 , struct V_209 * V_210 )
{
if ( F_18 ( V_4 -> V_211 ) )
return - V_212 ;
F_166 ( V_210 ) ;
...
static int T_5 F_173 ( void )
{
V_18 = 2 ;
V_13 = 0 ;
V_14 = F_161 ( V_18 * sizeof( struct V_6 ) , V_19 ) ;
if ( ! V_14 )
F_174 ( L_4 ) ;
F_175 () ;
F_172 () ;
V_219 = F_160 ( V_220 , 0 , V_206 ) ;
if ( ! V_219 )
F_174 ( L_4 ) ;
if ( F_176 ( V_219 , V_220 ) )
F_174 ( L_5 ) ;
return 0 ;
}
