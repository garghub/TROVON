...
struct V_159 * V_159 ;
struct V_160 * V_161 ;
int V_162 , V_78 = - V_102 ;
V_157 = ( T_4 * ) V_58 -> V_163 ;
if ( F_106 ( & V_101 -> V_164 ) ) {
F_104 ( V_101 -> V_27 , L_10 ) ;
return - V_102 ;
}
F_28 (module, &ctx->uuid_list, list) {
if ( F_107 ( * V_157 , V_161 -> V_165 ) == 0 ) {
V_58 -> V_166 . V_167 = V_161 -> V_166 ;
if ( V_58 -> V_161 )
V_58 -> V_161 -> V_168 = V_161 -> V_169 ;
V_78 = 0 ;
break;
}
}
...
V_157 = & V_161 -> V_165 ;
V_78 = - V_102 ;
for ( V_162 = 0 ; V_162 < V_30 -> V_170 ; V_162 ++ ) {
V_159 = V_30 -> V_171 [ V_162 ] ;
V_158 = & V_159 -> V_165 ;
if ( ! F_107 ( * V_157 , * V_158 ) ) {
V_58 -> V_161 = V_159 ;
V_78 = 0 ;
break;
}
...
V_156 = & V_58 -> V_173 [ V_162 ] . V_166 ;
if ( ! F_107 ( V_156 -> V_174 , V_161 -> V_165 ) )
V_156 -> V_167 = V_161 -> V_166 ;
}
for ( V_162 = 0 ; V_162 < V_175 ; V_162 ++ ) {
V_156 = & V_58 -> V_176 [ V_162 ] . V_166 ;
if ( ! F_107 ( V_156 -> V_174 , V_161 -> V_165 ) )
V_156 -> V_167 = V_161 -> V_166 ;
}
}
...
{
struct V_6 * V_12 = F_14 ( V_183 -> V_27 ) ;
struct V_30 * V_30 = F_15 ( V_12 ) ;
const struct V_184 * V_130 ;
int V_78 ;
F_110 ( V_183 -> V_27 ) ;
if ( ( F_12 ( V_12 ) ) -> V_21 ) {
V_30 -> V_183 = V_183 ;
V_30 -> V_185 = F_111 ( V_30 ) ;
V_78 = F_112 ( V_183 , V_12 ) ;
if ( V_78 < 0 ) {
F_104 ( V_183 -> V_27 , L_12 ) ;
return V_78 ;
}
V_130 = F_113 ( V_30 -> V_154 -> V_36 ) ;
if ( ! V_130 )
return - V_102 ;
if ( V_30 -> V_73 -> V_186 == false ) {
F_104 ( V_183 -> V_27 , L_13 ) ;
return - V_102 ;
}
V_78 = V_130 -> V_187 ( V_183 -> V_27 , V_30 -> V_73 ) ;
if ( V_78 < 0 ) {
F_104 ( V_183 -> V_27 , L_14 , V_78 ) ;
return V_78 ;
}
F_108 ( V_30 ) ;
V_30 -> V_73 -> V_188 = V_189 ;
...
F_118 ( & V_30 -> V_190 ) ;
F_118 ( & V_30 -> V_191 ) ;
V_78 = F_119 ( V_27 , & V_192 ) ;
if ( V_78 ) {
F_104 ( V_27 , L_15 , V_78 ) ;
return V_78 ;
}
V_78 = F_120 ( V_27 , & V_193 ,
V_194 ,
F_121 ( V_194 ) ) ;
if ( V_78 ) {
