...
static int F_43 ( T_1 * V_69 , unsigned long V_1 , unsigned long V_4 ,
unsigned long V_35 )
{
unsigned long V_57 ;
V_24 * V_56 ;
...
static int F_48 ( T_2 * V_72 , unsigned long V_1 , unsigned long V_4 ,
unsigned long V_35 )
{
unsigned long V_57 ;
T_1 * V_73 ;
...
break;
V_57 = F_56 ( V_1 , V_4 ) ;
V_58 = F_48 ( V_74 , V_1 , V_57 , V_35 ) ;
if ( V_58 )
break;
F_18 () ;
} while ( V_74 ++ , V_1 = V_57 , V_1 < V_4 && ! V_58 );
F_57 ( & V_76 ) ;
return V_58 ;
}
int F_58 ( unsigned long V_1 , int V_77 , unsigned long V_35 )
{
if ( ! V_78 )
V_35 &= ~ ( V_40 | V_42 ) ;
if ( ! V_35 )
return 0 ;
V_1 &= V_79 ;
return F_52 ( V_1 , V_1 + V_77 * V_9 , V_35 ) ;
}
static void F_59 ( V_30 * V_80 , unsigned long V_81 , int V_82 )
{
int V_46 ;
if ( F_60 ( 13 ) ) {
F_61 ( V_81 , V_82 - 1 , V_80 , V_83 ) ;
return;
}
for ( V_46 = 0 ; V_46 < V_82 ; V_46 ++ ) {
F_62 ( V_81 , V_80 , 0 , 0 , V_83 ) ;
V_81 += V_9 ;
V_80 ++ ;
}
}
void F_63 ( struct V_84 * V_84 , int V_77 , int V_85 )
{
unsigned long V_81 ;
int V_82 , V_46 , V_86 ;
T_2 * V_72 ;
...
V_88 = F_31 ( V_87 , V_81 ) ;
V_80 = F_65 ( V_88 , V_81 ) ;
V_82 = ( unsigned long ) V_80 >> F_66 ( sizeof( long ) ) ;
V_82 = V_29 - ( V_82 & ( V_29 - 1 ) ) ;
V_82 = F_67 ( V_77 - V_46 , V_82 ) ;
if ( V_85 ) {
