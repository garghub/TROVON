...
{
struct V_1 * V_2 = F_48 ( V_92 ) ;
return V_2 -> V_131 ( V_92 ) ;
}
static int F_80 ( struct V_91 * V_92 )
{
struct V_1 * V_2 = F_48 ( V_92 ) ;
return V_2 -> V_132 ( V_92 ) ;
}
...
static int F_82 ( struct V_91 * V_92 , void * V_134 )
{
struct V_1 * V_2 = F_48 ( V_92 ) ;
...
memcpy ( V_136 -> V_120 , V_120 , V_137 ) ;
memcpy ( V_136 -> V_13 , V_2 -> V_13 , sizeof( V_136 -> V_13 ) ) ;
V_136 -> V_21 = V_137 ;
V_136 -> V_131 = V_2 -> V_131 ;
V_136 -> V_133 = V_2 -> V_133 ;
V_136 -> V_132 = V_2 -> V_132 ;
return 0 ;
}
static int F_83 ( struct V_91 * V_92 , const void * V_138 )
{
struct V_1 * V_2 = F_48 ( V_92 ) ;
const struct V_135 * V_136 = V_138 ;
memset ( V_2 , 0 , sizeof( * V_2 ) ) ;
memcpy ( V_2 -> V_5 , V_136 -> V_120 , V_136 -> V_21 ) ;
memcpy ( V_2 -> V_13 , V_136 -> V_13 , sizeof( V_2 -> V_13 ) ) ;
V_2 -> V_7 = V_136 -> V_21 ;
V_2 -> V_131 = V_136 -> V_131 ;
V_2 -> V_133 = V_136 -> V_133 ;
V_2 -> V_132 = V_136 -> V_132 ;
return 0 ;
}
static int F_84 ( struct V_139 * V_140 )
{
struct V_55 * V_56 = F_85 ( V_140 ) ;
struct V_141 * V_82 = V_140 -> V_142 ;
struct V_143 * V_144 =
F_53 ( V_82 , struct V_143 , V_82 ) ;
struct V_145 * V_146 =
F_53 ( V_144 , struct V_145 , V_144 ) ;
struct V_147 * V_148 =
F_53 ( V_146 , struct V_147 , V_145 ) ;
struct V_25 * V_26 = F_86 ( V_140 ) ;
static const T_1 V_149 [] = { V_150 + V_151 ,
V_150 + V_152 ,
V_150 + 32 ,
V_150 + V_153 ,
V_150 + 64 ,
...
V_155 = F_91 ( V_26 -> V_10 , V_26 -> V_57 ,
F_92 ( struct V_25 ,
V_58 ) ,
V_23 , V_156 ) ;
if ( F_7 ( V_26 -> V_10 , V_155 ) ) {
F_8 ( V_26 -> V_10 , L_29 ) ;
F_93 ( V_26 -> V_10 ) ;
return - V_15 ;
}
...
F_92 ( struct V_25 ,
V_61 ) ;
V_26 -> V_66 = V_155 + F_92 ( struct V_25 ,
V_64 ) ;
V_26 -> V_69 = V_155 + F_92 ( struct V_25 ,
V_67 ) ;
V_26 -> V_29 . V_30 = V_157 | V_148 -> V_158 ;
V_26 -> V_11 = V_149 [ ( V_26 -> V_29 . V_30 &
V_159 ) >>
V_160 ] ;
F_94 ( F_85 ( V_140 ) ,
sizeof( struct V_1 ) ) ;
...
static struct V_147 *
F_101 ( struct V_166 * V_167 ,
bool V_168 )
{
struct V_147 * V_161 ;
struct V_145 * V_144 ;
struct V_141 * V_146 ;
V_161 = F_59 ( sizeof( * V_161 ) , V_76 ) ;
if ( ! V_161 ) {
F_89 ( L_30 ) ;
return F_102 ( - V_15 ) ;
}
V_161 -> V_145 = V_167 -> V_169 ;
V_144 = & V_161 -> V_145 ;
V_146 = & V_144 -> V_144 . V_82 ;
if ( V_168 ) {
snprintf ( V_146 -> V_170 , V_171 , L_31 ,
V_167 -> V_172 ) ;
snprintf ( V_146 -> V_173 , V_171 , L_31 ,
V_167 -> V_174 ) ;
} else {
snprintf ( V_146 -> V_170 , V_171 , L_31 ,
V_167 -> V_175 ) ;
snprintf ( V_146 -> V_173 , V_171 , L_31 ,
V_167 -> V_176 ) ;
V_161 -> V_145 . V_177 = NULL ;
}
V_146 -> V_178 = V_179 ;
V_146 -> V_180 = F_84 ;
V_146 -> V_181 = F_95 ;
V_146 -> V_182 = sizeof( struct V_25 ) ;
V_146 -> V_183 = V_184 ;
V_146 -> V_185 = V_167 -> V_81 ;
V_146 -> V_186 = 0 ;
V_146 -> V_187 = V_188 | V_189 ;
V_146 -> V_190 = & V_191 ;
V_161 -> V_158 = V_167 -> V_158 ;
return V_161 ;
}
...
int V_197 = 0 , V_78 = 0 ;
struct V_198 * V_199 ;
unsigned int V_200 = V_154 ;
T_2 V_201 , V_202 ;
V_193 = F_104 ( NULL , NULL , L_32 ) ;
if ( ! V_193 ) {
V_193 = F_104 ( NULL , NULL , L_33 ) ;
if ( ! V_193 )
return - V_203 ;
}
V_195 = F_105 ( V_193 ) ;
...
if ( ! V_199 )
return - V_203 ;
V_202 = F_108 ( & V_199 -> V_204 -> V_205 . V_206 ) ;
V_201 = F_108 ( & V_199 -> V_204 -> V_205 . V_207 ) ;
if ( ! ( ( V_201 & V_208 ) >> V_209 ) )
return - V_203 ;
if ( ( V_202 & V_208 ) == V_210 )
V_200 = V_153 ;
F_109 ( & V_163 ) ;
for ( V_197 = 0 ; V_197 < F_110 ( V_211 ) ; V_197 ++ ) {
struct V_147 * V_161 ;
struct V_166 * V_146 = V_211 + V_197 ;
if ( V_146 -> V_169 . V_144 . V_17 > V_200 )
continue;
V_161 = F_101 ( V_146 , true ) ;
if ( F_88 ( V_161 ) ) {
V_78 = F_90 ( V_161 ) ;
F_111 ( L_34 , V_146 -> V_176 ) ;
continue;
}
V_78 = F_112 ( & V_161 -> V_145 ) ;
if ( V_78 ) {
F_111 ( L_35 ,
V_161 -> V_145 . V_144 . V_82 . V_173 ,
V_78 ) ;
F_35 ( V_161 ) ;
} else
F_113 ( & V_161 -> V_165 , & V_163 ) ;
V_161 = F_101 ( V_146 , false ) ;
if ( F_88 ( V_161 ) ) {
V_78 = F_90 ( V_161 ) ;
F_111 ( L_34 , V_146 -> V_176 ) ;
continue;
