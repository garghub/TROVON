...
int F_28 ( struct V_1 * V_2 , unsigned int V_8 , bool V_26 )
{
unsigned long V_56 ;
int V_25 , V_30 = 0 ;
if ( ! V_2 )
...
goto V_64;
if ( F_1 ( V_2 ,
( V_2 -> V_26 & ~ F_6 ( V_25 ) ) | ( V_26 & F_6 ( V_25 ) ) ) ) {
V_30 = - V_65 ;
goto V_64;
}
if ( ! V_26 )
...
int F_29 ( struct V_1 * V_2 , unsigned int V_8 , bool V_26 )
{
int V_30 , V_25 ;
unsigned long V_56 ;
V_25 = F_3 ( V_2 , V_8 ) ;
...
return V_25 ;
F_20 ( & V_2 -> V_57 , V_56 ) ;
V_30 = F_7 ( V_2 , V_25 , V_26 ) ;
F_23 ( & V_2 -> V_57 , V_56 ) ;
if ( ! V_30 )
return 0 ;
V_30 = F_28 ( V_2 , V_8 , V_26 ) ;
if ( V_30 < 0 )
return V_30 ;
return F_19 ( V_2 , V_8 ) ;
}
...
V_85 = F_54 ( sizeof( char ) * ( strlen ( V_44 ) + 1 ) ,
V_78 ) ;
if ( ! V_85 ) {
...
V_29 -> V_2 = V_2 ;
V_29 -> V_48 = V_25 ;
V_29 -> V_89 [ 0 ] = & V_29 -> V_47 . V_43 ;
V_29 -> V_89 [ 1 ] = & V_29 -> V_49 . V_43 ;
V_29 -> V_89 [ 2 ] = NULL ;
V_29 -> V_87 . V_46 = V_85 ;
V_29 -> V_87 . V_89 = V_29 -> V_89 ;
F_63 ( & V_29 -> V_47 . V_43 ) ;
V_29 -> V_47 . V_43 . V_46 = L_13 ;
V_29 -> V_47 . V_43 . V_90 = 0444 ;
V_29 -> V_47 . V_91 = F_15 ;
F_63 ( & V_29 -> V_49 . V_43 ) ;
V_29 -> V_49 . V_43 . V_46 = L_14 ;
V_29 -> V_49 . V_43 . V_90 = 0444 ;
V_29 -> V_49 . V_91 = F_17 ;
}
}
if ( V_2 -> V_9 && V_2 -> V_5 ) {
...
;
V_2 -> V_92 = F_54 ( sizeof( struct V_93 * ) *
( V_25 + 1 ) , V_78 ) ;
if ( ! V_2 -> V_92 ) {
V_30 = - V_63 ;
goto V_94;
}
V_2 -> V_95 = F_54 ( sizeof( struct V_42 ) *
V_25 , V_78 ) ;
if ( ! V_2 -> V_95 ) {
V_30 = - V_63 ;
F_56 ( V_2 -> V_92 ) ;
...
strcpy ( V_46 , V_44 ) ;
F_63 ( & V_2 -> V_95 [ V_25 ] . V_43 ) ;
V_2 -> V_95 [ V_25 ] . V_43 . V_46 = V_46 ;
V_2 -> V_95 [ V_25 ] . V_43 . V_90 = 0000 ;
V_2 -> V_92 [ V_25 ] = & V_2 -> V_95 [ V_25 ]
. V_43 ;
}
V_2 -> V_96 . V_46 = V_97 ;
V_2 -> V_96 . V_89 = V_2 -> V_92 ;
}
if ( V_2 -> V_9 ) {
V_2 -> V_98 . V_99 =
F_54 ( sizeof( struct V_100 * ) *
( V_2 -> V_9 + 2 ) , V_78 ) ;
if ( ! V_2 -> V_98 . V_99 ) {
V_30 = - V_63 ;
goto V_101;
}
V_2 -> V_98 . V_46 = F_59 ( & V_2 -> V_41 ) ;
V_2 -> V_98 . V_83 = F_52 ;
for ( V_25 = 0 ; V_25 < V_2 -> V_9 ; V_25 ++ )
V_2 -> V_98 . V_99 [ V_25 ] =
& V_2 -> V_31 [ V_25 ] . V_87 ;
...
F_66 ( & V_2 -> V_57 ) ;
V_2 -> V_58 = F_67 ( & V_2 -> V_41 , V_2 -> V_9 ,
sizeof( * V_2 -> V_58 ) , V_78 ) ;
if ( ! V_2 -> V_58 ) {
V_30 = - V_63 ;
goto V_102;
}
...
if ( V_2 -> V_9 && V_2 -> V_5 ) {
for ( V_25 = 0 ; V_2 -> V_5 [ V_25 ] ; V_25 ++ )
F_56 ( V_2 -> V_95 [ V_25 ] . V_43 . V_46 ) ;
F_56 ( V_2 -> V_95 ) ;
F_56 ( V_2 -> V_92 ) ;
}
V_94:
for ( V_25 = 0 ; V_25 < V_2 -> V_9 ; V_25 ++ )
F_56 ( V_2 -> V_31 [ V_25 ] . V_87 . V_46 ) ;
V_88:
if ( V_2 -> V_9 )
F_56 ( V_2 -> V_31 ) ;
V_86:
...
V_106 = F_77 ( V_41 -> V_107 , L_8 , V_25 ) ;
if ( ! V_106 ) {
F_76 ( V_41 , L_18 ,
V_41 -> V_107 ) ;
return F_37 ( - V_108 ) ;
...
if ( V_2 -> V_41 . V_84 && V_2 -> V_41 . V_84 -> V_107 == V_106 ) {
F_40 ( & V_70 ) ;
F_78 ( V_106 ) ;
return V_2 ;
}
