...
F_9 ( V_5 -> V_28 ) ;
F_9 ( V_5 -> V_58 ) ;
if ( V_5 -> V_2 -> V_20 -> V_59 )
V_5 -> V_2 -> V_20 -> V_59 ( V_5 -> V_2 , V_51 ) ;
}
static int F_20 ( struct V_60 * V_61 ,
enum V_62 V_63 ,
union V_64 * V_65 )
{
struct V_4 * V_5 = F_21 ( V_61 ) ;
int V_7 = 0 ;
switch ( V_63 ) {
case V_66 :
V_65 -> V_67 = V_5 -> V_37 ;
...
int V_73 ;
T_1 V_74 ;
V_5 = F_25 ( & V_70 -> V_19 , sizeof( * V_5 ) , V_75 ) ;
if ( ! V_5 )
return - V_76 ;
F_26 ( V_70 , V_5 ) ;
V_5 -> V_2 = F_27 ( V_70 -> V_19 . V_77 ) ;
for ( V_73 = 0 ; V_73 < F_28 ( V_78 ) ; V_73 ++ )
F_29 ( V_5 -> V_2 , V_78 [ V_73 ] ,
F_19 , V_5 ) ;
V_72 . V_79 = V_5 -> V_2 -> V_20 -> V_80 ;
V_72 . V_81 = V_5 -> V_2 -> V_20 -> V_82 ;
V_72 . V_83 = V_5 ;
V_5 -> V_58 = F_30 ( & V_70 -> V_19 ,
& V_84 ,
& V_72 ) ;
if ( F_31 ( V_5 -> V_58 ) ) {
F_4 ( V_5 -> V_2 -> V_19 , L_5 ) ;
return F_32 ( V_5 -> V_58 ) ;
}
V_5 -> V_28 = F_30 ( & V_70 -> V_19 , & V_85 ,
& V_72 ) ;
if ( F_31 ( V_5 -> V_28 ) ) {
F_4 ( V_5 -> V_2 -> V_19 , L_6 ) ;
F_33 ( V_5 -> V_58 ) ;
return F_32 ( V_5 -> V_28 ) ;
}
V_5 -> V_57 = F_30 ( & V_70 -> V_19 , & V_86 ,
& V_72 ) ;
if ( F_31 ( V_5 -> V_57 ) ) {
F_4 ( V_5 -> V_2 -> V_19 , L_7 ) ;
F_33 ( V_5 -> V_58 ) ;
F_33 ( V_5 -> V_28 ) ;
return F_32 ( V_5 -> V_57 ) ;
}
if ( F_34 ( & V_70 -> V_19 . V_87 , & V_88 ) )
F_4 ( V_5 -> V_2 -> V_19 , L_8 ) ;
V_74 = F_7 ( V_5 -> V_2 , V_89 ) ;
if ( V_74 & V_90 )
F_19 ( V_53 , V_5 ) ;
if ( V_74 & V_91 )
F_19 ( V_55 , V_5 ) ;
...
int V_73 ;
for ( V_73 = 0 ; V_73 < F_28 ( V_78 ) ; V_73 ++ )
F_36 ( V_5 -> V_2 , V_78 [ V_73 ] ) ;
F_37 ( & V_70 -> V_19 . V_87 , & V_88 ) ;
F_33 ( V_5 -> V_28 ) ;
F_33 ( V_5 -> V_58 ) ;
F_33 ( V_5 -> V_57 ) ;
return 0 ;
