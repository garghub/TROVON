...
F_6 ( V_12 , L_54 ,
V_67 -> V_83 . V_166 ) ;
V_67 -> V_34 = F_107 ( V_67 -> V_83 . V_166 ) ;
if ( ! V_67 -> V_34 ) {
F_99 ( V_12 , L_55
L_56 ,
V_67 -> V_83 . V_166 ) ;
...
static int
F_109 ( struct V_11 * V_12 , int * V_27 , char * V_108 )
{
F_110 ( V_12 ) ;
if ( ! ( * V_27 & V_187 ) )
return - V_144 ;
...
static int
F_111 ( struct V_25 * V_25 , struct V_200 * V_201 )
{
struct V_11 * V_12 = V_25 -> V_157 ;
T_18 V_202 = F_112 ( V_12 -> V_203 -> V_204 ) ;
F_6 ( V_12 , L_28 , V_23 ) ;
V_201 -> V_205 = V_193 ;
...
static struct V_25 *
F_113 ( struct V_218 * V_219 , int V_27 , const char * V_220 ,
void * V_108 )
{
return F_114 ( V_219 , V_27 , V_220 , V_108 , F_96 ) ;
}
static int T_8
F_115 ( void )
{
