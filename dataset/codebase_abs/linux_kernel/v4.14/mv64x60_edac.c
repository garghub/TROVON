...
F_3 (KERN_INFO EDAC_MOD_STR L_17 ,
pdata->irq) ;
}
F_23 ( & V_23 -> V_33 , F_13 ) ;
F_20 ( 3 , L_18 ) ;
...
F_3 (KERN_INFO EDAC_MOD_STR L_32 ,
pdata->irq) ;
}
F_23 ( & V_23 -> V_33 , F_32 ) ;
F_20 ( 3 , L_18 ) ;
...
F_4 ( 0 , V_4 -> V_64 [ 1 ] + V_65 ) ;
F_4 ( 0 , V_4 -> V_64 [ 1 ] + V_72 ) ;
F_4 ( 0x000000ff , V_4 -> V_64 [ 1 ] + V_72 ) ;
V_53 -> V_38 = V_39 ;
V_53 -> V_16 = V_4 -> V_36 ;
if ( V_40 == V_41 )
V_53 -> V_42 = F_38 ;
...
F_48 ( V_74 , V_4 ) ;
F_4 ( 0 , V_4 -> V_81 + V_82 ) ;
V_97 = F_2 ( V_4 -> V_81 + V_134 ) ;
V_97 = ( V_97 & 0xff00ffff ) | 0x10000 ;
F_4 ( V_97 , V_4 -> V_81 + V_134 ) ;
V_32 = F_52 ( V_74 ) ;
if ( V_32 ) {
F_20 ( 3 , L_51 ) ;
goto V_45;
...
return F_57 ( V_137 , F_51 ( V_137 ) ) ;
}
static void T_5 F_58 ( void )
{
F_59 ( V_137 , F_51 ( V_137 ) ) ;
}
