...
struct V_305 * V_306 ;
struct V_319 * V_77 = V_75 ;
if ( V_77 -> V_320 != V_321 )
return V_322 ;
V_306 = F_5 ( sizeof( * V_306 ) , V_323 ) ;
if ( F_212 ( ! V_306 ) )
return V_324 ;
...
struct V_326 * V_327 )
{
F_220 ( V_327 -> V_328 , V_47 , sizeof( V_327 -> V_328 ) ) ;
F_220 ( V_327 -> V_329 , V_330 , sizeof( V_327 -> V_329 ) ) ;
}
static void F_221 ( struct V_116 * V_331 , T_1 V_332 ,
T_10 * V_91 )
{
T_10 * V_277 = V_91 ;
int V_26 ;
switch ( V_332 ) {
case V_333 :
for ( V_26 = 0 ; V_26 < F_222 ( V_334 ) ; V_26 ++ ) {
memcpy ( V_277 , V_334 [ V_26 ] . V_197 , V_335 ) ;
V_277 += V_335 ;
}
break;
}
...
{
const struct V_117 * V_118 [ V_169 + 1 ] ;
const struct V_117 * V_339 [ V_340 + 1 ] ;
const struct V_117 * V_341 ;
T_1 V_135 ;
T_2 * V_91 = V_161 ;
int V_26 ;
F_83 ( V_118 , V_169 , V_53 ) ;
...
if ( ! V_339 [ V_338 ] )
return - V_19 ;
V_135 = F_102 ( V_339 [ V_338 ] ) ;
if ( V_135 != V_11 -> V_135 )
return - V_19 ;
for ( V_26 = 0 ; V_26 < F_222 ( V_334 ) ; V_26 ++ ) {
V_341 = V_339 [ V_334 [ V_26 ] . type ] ;
if ( ! V_341 )
continue;
V_91 [ V_26 ] = F_80 ( V_341 ) ;
}
return 0 ;
}
...
static int F_227 ( struct V_116 * V_331 , int V_343 )
{
switch ( V_343 ) {
case V_333 :
return V_344 ;
...
static struct V_11 * F_228 ( struct V_345 * V_346 )
{
return F_205 ( V_346 , struct V_11 , V_153 ) ;
}
static int F_229 ( struct V_345 * V_346 , int V_347 )
{
struct V_11 * V_11 = F_228 ( V_346 ) ;
const struct V_8 * V_8 = V_11 -> V_8 ;
const struct V_52 * V_53 ;
T_1 V_83 = 0 ;
int V_30 ;
...
V_107 = F_38 ( V_53 ) ;
if ( V_30 == 0 ) {
V_11 -> V_18 -> V_275 . V_348 ++ ;
V_11 -> V_18 -> V_275 . V_349 += V_107 -> V_119 ;
} else {
V_11 -> V_18 -> V_275 . V_350 ++ ;
}
F_78 ( V_107 ) ;
V_83 ++ ;
}
...
return - V_66 ;
if ( V_118 [ V_354 ] )
V_352 = F_81 ( V_118 [ V_354 ] ) ;
F_79 ( V_8 , V_118 ) ;
V_351 = F_81 ( V_118 [ V_353 ] ) ;
F_234 ( V_107 , V_351 ) ;
V_107 -> V_355 = F_235 ( V_107 , V_11 -> V_18 ) ;
if ( V_352 & V_356 )
V_107 -> V_357 = 1 ;
V_11 -> V_18 -> V_275 . V_358 ++ ;
V_11 -> V_18 -> V_275 . V_359 += V_107 -> V_119 ;
F_236 ( V_107 ) ;
return F_76 ( V_11 , V_53 ) ;
}
static struct V_11 * F_237 ( struct V_345 * V_346 )
{
return F_205 ( V_346 , struct V_11 , V_154 ) ;
}
static int F_238 ( struct V_345 * V_346 , int V_347 )
{
struct V_11 * V_11 = F_237 ( V_346 ) ;
const struct V_8 * V_8 = V_11 -> V_8 ;
struct V_52 * V_53 ;
T_1 V_83 = 0 ;
int V_30 ;
...
{
const struct V_8 * V_8 = V_11 -> V_8 ;
T_2 V_361 = F_23 ( V_8 , V_362 ) ;
bool V_137 ;
V_137 = V_361 & ( 1 << V_11 -> V_135 ) ;
if ( V_137 )
F_96 ( V_11 -> V_18 ) ;
else
F_99 ( V_11 -> V_18 ) ;
...
T_4 V_381 ;
int V_30 ;
V_381 = sizeof( struct V_11 * ) * V_8 -> V_140 ;
V_8 -> V_141 = F_5 ( V_381 , V_5 ) ;
if ( ! V_8 -> V_141 )
return - V_33 ;
for ( V_26 = 0 ; V_26 < V_8 -> V_140 ; V_26 ++ ) {
V_30 = F_247 ( V_8 , V_26 ) ;
...
{
struct V_235 V_77 ;
V_77 . V_143 = V_386 -> V_143 ;
V_77 . V_237 = V_386 -> V_237 ;
F_263 ( V_387 ,
V_11 -> V_18 , & V_77 . V_77 ) ;
}
...
case V_391 :
V_389 = & V_388 -> V_389 ;
V_30 = F_162 ( V_11 , V_389 ) ;
if ( V_30 )
F_265 ( V_11 -> V_18 , L_40 , V_30 ) ;
break;
}
F_210 () ;
F_7 ( V_388 -> V_389 . V_143 ) ;
F_7 ( V_388 ) ;
F_266 ( V_11 -> V_18 ) ;
}
static int F_267 ( struct V_316 * V_392 ,
unsigned long V_309 , void * V_75 )
{
struct V_116 * V_18 = F_268 ( V_75 ) ;
struct F_264 * V_388 ;
struct V_235 * V_389 = V_75 ;
struct V_11 * V_11 ;
if ( ! F_261 ( V_18 ) )
return V_322 ;
V_11 = F_171 ( V_18 ) ;
V_388 = F_5 ( sizeof( * V_388 ) , V_323 ) ;
if ( F_212 ( ! V_388 ) )
return V_324 ;
F_213 ( & V_388 -> V_304 , F_264 ) ;
V_388 -> V_11 = V_11 ;
V_388 -> V_309 = V_309 ;
switch ( V_309 ) {
case V_390 :
case V_391 :
memcpy ( & V_388 -> V_389 , V_75 ,
sizeof( V_388 -> V_389 ) ) ;
V_388 -> V_389 . V_143 = F_5 ( V_191 , V_323 ) ;
F_126 ( ( T_10 * ) V_388 -> V_389 . V_143 ,
V_389 -> V_143 ) ;
F_269 ( V_18 ) ;
break;
default:
...
F_216 ( V_11 -> V_8 -> V_325 ,
& V_388 -> V_304 ) ;
return V_322 ;
}
static int F_270 ( struct V_13 * V_14 , const struct V_393 * V_288 )
{
struct V_8 * V_8 ;
int V_30 ;
...
if ( F_276 ( V_14 , 0 ) < V_397 ) {
F_21 ( & V_14 -> V_18 , L_45 ) ;
V_30 = - V_66 ;
goto V_398;
}
V_8 -> V_399 = F_277 ( F_278 ( V_14 , 0 ) ,
F_276 ( V_14 , 0 ) ) ;
if ( ! V_8 -> V_399 ) {
F_21 ( & V_14 -> V_18 , L_46 ) ;
V_30 = - V_19 ;
...
F_19 ( V_8 , V_404 , V_405 ) ;
V_30 = F_69 ( V_8 ) ;
if ( V_30 )
goto V_406;
V_30 = F_33 ( F_12 ( V_8 , V_407 ) ,
F_92 , 0 ,
V_47 , V_8 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_49 ) ;
...
V_8 -> V_325 = F_281 ( V_47 ,
V_411 ) ;
if ( ! V_8 -> V_325 ) {
V_30 = - V_33 ;
goto V_412;
}
V_8 -> V_318 . V_413 = F_211 ;
...
V_8 -> V_293 . V_288 = F_23 ( V_8 , V_417 ) ;
V_30 = F_253 ( V_8 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_52 ) ;
goto V_418;
...
F_287 ( V_8 -> V_325 ) ;
V_412:
V_49 ( F_12 ( V_8 , V_409 ) , V_8 ) ;
V_410:
V_49 ( F_12 ( V_8 , V_407 ) , V_8 ) ;
V_408:
F_71 ( V_8 ) ;
V_406:
V_403:
...
static int F_294 ( struct V_116 * V_419 , void * V_420 )
{
struct V_421 * V_91 = V_420 ;
int V_422 = 0 ;
if ( F_293 ( V_419 , V_91 -> V_8 ) ) {
V_91 -> V_182 = F_171 ( V_419 ) ;
V_422 = 1 ;
}
return V_422 ;
}
...
static int F_297 ( struct V_316 * V_392 ,
unsigned long V_309 , void * V_75 )
{
...
static int F_299 ( struct V_316 * V_392 ,
unsigned long V_309 , void * V_75 )
{
struct V_11 * V_11 ;
struct V_116 * V_18 ;
