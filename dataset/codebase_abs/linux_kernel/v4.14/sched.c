...
if ( V_4 -> V_60 < 0 || V_4 -> V_60 >= V_2 -> V_61 )
return - V_62 ;
V_41 = F_17 ( sizeof( struct V_40 ) , V_71 ) ;
if ( ! V_41 )
return - V_72 ;
V_59 = & V_8 -> V_63 . V_64 [ V_2 -> V_65 + V_4 -> V_60 ] ;
V_49 = V_59 -> V_66 . V_46 ;
...
int F_22 ( struct V_75 * V_76 , void * V_31 ,
enum V_32 type )
{
...
int F_28 ( struct V_75 * V_76 , void * V_31 ,
enum V_32 type )
{
struct V_1 * V_2 = F_23 ( V_76 ) ;
struct V_9 * V_10 ;
...
V_80 . V_16 . V_17 . V_18 = V_78 ;
V_51 = & V_10 -> V_15 [ V_10 -> V_54 ] ;
for ( V_13 = & V_10 -> V_15 [ 0 ] ; V_13 != V_51 ; ++ V_13 ) {
if ( V_13 -> V_55 == V_56 )
continue;
memcpy ( & V_70 , & V_13 -> V_70 , sizeof( V_70 ) ) ;
V_70 . V_16 . V_17 . V_18 = V_78 ;
if ( ( V_70 . type == V_80 . type ) &&
( ! memcmp ( & V_70 . V_16 . V_17 , & V_80 . V_16 . V_17 ,
...
if ( ! V_13 )
goto V_47;
memcpy ( & V_81 , V_4 , sizeof( V_81 ) ) ;
V_81 . V_16 . V_17 . V_18 = V_13 -> V_25 ;
F_11 ( & V_13 -> V_67 ) ;
V_14 = F_1 ( V_2 , & V_81 , V_19 ) ;
if ( V_14 ) {
F_12 ( & V_13 -> V_67 ) ;
V_13 = NULL ;
goto V_47;
}
memcpy ( & V_13 -> V_70 , & V_81 , sizeof( V_13 -> V_70 ) ) ;
F_31 ( & V_13 -> V_69 , 0 ) ;
V_13 -> V_55 = V_82 ;
F_12 ( & V_13 -> V_67 ) ;
}
...
struct V_12 * F_32 ( struct V_75 * V_76 ,
struct V_3 * V_4 )
{
struct V_1 * V_2 = F_23 ( V_76 ) ;
T_2 V_77 ;
...
struct V_9 * V_10 ;
unsigned int V_53 ;
V_10 = F_17 ( sizeof( * V_10 ) + V_54 * sizeof( struct V_12 ) , V_71 ) ;
if ( ! V_10 )
return NULL ;
V_10 -> V_54 = V_54 ;
F_35 ( & V_10 -> V_79 ) ;
...
{
struct V_9 * V_10 ;
unsigned int V_83 , V_53 ;
F_39 (adap, j) {
struct V_1 * V_2 = F_23 ( V_8 -> V_84 [ V_83 ] ) ;
V_10 = V_2 -> V_11 ;
for ( V_53 = 0 ; V_53 < V_10 -> V_54 ; V_53 ++ ) {
struct V_12 * V_13 ;
F_26 ( & V_10 -> V_79 ) ;
