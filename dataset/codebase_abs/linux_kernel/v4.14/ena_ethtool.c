...
static int F_45 ( struct V_31 * V_32 , T_2 * V_165 , T_3 * V_166 ,
T_3 * V_167 )
{
struct V_6 * V_7 = F_7 ( V_32 ) ;
enum V_168 V_169 ;
T_3 V_170 ;
int V_49 ;
V_49 = F_46 ( V_7 -> V_28 , V_165 ) ;
if ( V_49 )
return V_49 ;
V_49 = F_47 ( V_7 -> V_28 , & V_169 , V_166 ) ;
if ( V_49 )
return V_49 ;
switch ( V_169 ) {
case V_171 :
...
static int F_48 ( struct V_31 * V_32 , const T_2 * V_165 ,
const T_3 * V_166 , const T_3 V_167 )
{
struct V_6 * V_7 = F_7 ( V_32 ) ;
struct V_44 * V_28 = V_7 -> V_28 ;
enum V_168 V_170 ;
...
break;
default:
F_41 ( V_7 , V_156 , V_32 , L_8 ,
V_167 ) ;
return - V_39 ;
}
if ( V_166 ) {
V_49 = F_53 ( V_28 , V_170 , V_166 ,
V_164 ,
0xFFFFFFFF ) ;
if ( F_51 ( V_49 ) ) {
F_41 ( V_7 , V_156 , V_32 , L_9 ) ;
return V_49 == - V_175 ? - V_39 : V_49 ;
}
}
return 0 ;
...
{
struct V_6 * V_7 = F_7 ( V_32 ) ;
V_177 -> V_178 = V_7 -> V_15 ;
V_177 -> V_179 = V_7 -> V_15 ;
V_177 -> V_180 = 0 ;
V_177 -> V_181 = 0 ;
V_177 -> V_182 = V_7 -> V_15 ;
V_177 -> V_183 = V_7 -> V_15 ;
V_177 -> V_184 = 0 ;
V_177 -> V_185 = 0 ;
}
static int F_55 ( struct V_31 * V_32 ,
const struct V_186 * V_187 , void * V_8 )
{
struct V_6 * V_7 = F_7 ( V_32 ) ;
int V_188 = 0 ;
switch ( V_187 -> V_189 ) {
...
static void F_58 ( struct V_6 * V_7 , T_3 * V_196 )
{
...
V_199 = F_8 ( V_32 , V_38 ) ;
if ( V_199 <= 0 ) {
F_41 ( V_7 , V_156 , V_32 , L_10 ) ;
return;
}
V_197 = F_59 ( & V_7 -> V_110 -> V_102 ,
V_199 * V_40 ,
V_200 ) ;
if ( ! V_197 ) {
F_41 ( V_7 , V_156 , V_32 ,
...
F_41 ( V_7 , V_156 , V_32 ,
L_12 ) ;
F_60 ( & V_7 -> V_110 -> V_102 , V_197 ) ;
return;
}
F_11 ( V_32 , V_38 , V_197 ) ;
F_6 ( V_32 , NULL , V_198 ) ;
if ( V_196 )
for ( V_13 = 0 ; V_13 < V_199 ; V_13 ++ ) {
V_49 = snprintf ( V_196 , V_40 + sizeof( T_1 ) ,
L_13 ,
V_197 + V_13 * V_40 ,
V_198 [ V_13 ] ) ;
V_196 += V_49 ;
...
for ( V_13 = 0 ; V_13 < V_199 ; V_13 ++ )
F_41 ( V_7 , V_156 , V_32 , L_14 ,
V_197 + V_13 * V_40 ,
V_198 [ V_13 ] ) ;
F_60 ( & V_7 -> V_110 -> V_102 , V_197 ) ;
F_60 ( & V_7 -> V_110 -> V_102 , V_198 ) ;
}
void F_61 ( struct V_6 * V_7 , T_3 * V_196 )
{
if ( ! V_196 )
return;
F_58 ( V_7 , V_196 ) ;
