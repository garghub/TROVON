...
static int F_25 ( struct V_58 * V_11 )
{
...
struct V_16 * V_17 ;
struct V_58 * V_11 =
(struct V_58 * ) V_67 -> V_68 -> V_69 ;
int V_60 ;
for ( V_60 = 0 ; V_60 < F_6 ( V_70 ) ; V_60 ++ ) {
if ( ! strncmp ( V_11 -> V_71 [ V_60 ] . V_72 , L_6 ,
V_73 ) ) {
if ( ! strncmp ( V_11 -> V_74 , L_7 ,
V_75 ) ) {
V_11 -> V_71 [ V_60 ] . V_74 = L_8 ;
V_11 -> V_71 [ V_60 ] . V_76 = L_9 ;
} else if ( ! strncmp ( V_11 -> V_74 , L_10 ,
V_75 ) ) {
V_11 -> V_71 [ V_60 ] . V_74 = L_11 ;
V_11 -> V_71 [ V_60 ] . V_76 = L_12 ;
}
}
}
V_17 = F_10 ( & V_67 -> V_23 , sizeof( * V_17 ) , V_77 ) ;
if ( ! V_17 )
return - V_25 ;
F_30 ( & V_17 -> V_30 ) ;
V_11 -> V_23 = & V_67 -> V_23 ;
F_31 ( V_11 , V_17 ) ;
return F_32 ( & V_67 -> V_23 , V_11 ) ;
}
