...
V_71 = - V_73 ;
V_32 -> V_131 = 0 ;
while ( * V_130 ++ != V_132 && F_21 ( V_130 ++ ) == V_32 -> V_133 ) {
T_2 V_134 , V_135 ;
T_3 V_136 ;
V_134 = F_21 ( V_130 ++ ) ;
V_135 = F_21 ( V_130 ++ ) ;
V_130 = F_53 ( V_130 , & V_136 ) ;
...
F_56 ( L_9 ,
V_32 -> V_133 ) ;
V_32 -> V_124 = V_114 -> V_137 ;
V_32 -> V_122 = 0 ;
V_71 = F_63 ( V_117 , V_32 , V_130 ) ;
if ( V_71 < 0 )
goto V_14;
V_114 -> V_123 . V_115 [ 0 ] . V_106 =
V_114 -> V_123 . V_114 [ 0 ] . V_106 + V_32 -> V_133 ;
V_114 -> V_123 . V_115 [ 0 ] . V_107 =
V_114 -> V_123 . V_114 [ 0 ] . V_107 - V_32 -> V_133 ;
V_114 -> V_123 . V_114 [ 0 ] . V_107 = V_32 -> V_133 ;
V_114 -> V_123 . V_115 [ 0 ] . V_107 += 4 - ( V_32 -> V_131 & 3 ) ;
V_114 -> V_123 . V_108 = V_32 -> V_131 ;
V_114 -> V_123 . V_76 += V_32 -> V_131 ;
V_114 -> V_123 . V_138 += V_32 -> V_131 ;
V_14:
return V_71 ;
}
...
int V_71 ;
F_56 ( L_10 ) ;
V_32 -> V_124 = V_114 -> V_137 - 1 ;
V_32 -> V_122 = F_47 ( V_114 -> V_139 ) ;
V_71 = F_63 ( V_117 , V_32 , V_130 ) ;
if ( V_71 < 0 )
goto V_14;
V_114 -> V_123 . V_76 += V_32 -> V_131 ;
V_114 -> V_123 . V_138 += V_32 -> V_131 ;
if ( V_114 -> V_123 . V_138 <= V_114 -> V_140 [ 0 ] . V_141 ) {
V_114 -> V_123 . V_114 [ 0 ] . V_107 = V_32 -> V_131 ;
} else {
V_114 -> V_123 . V_114 [ 0 ] . V_107 =
V_114 -> V_140 [ 0 ] . V_141 - V_114 -> V_139 ;
V_114 -> V_123 . V_108 =
...
int F_66 ( struct V_5 * V_6 , struct V_116 * V_117 ,
struct V_120 * V_114 , T_1 * V_130 )
{
struct V_57 * V_32 ;
struct V_87 * * V_87 ;
int V_71 ;
V_114 -> V_137 = V_114 -> V_126 ;
V_114 -> V_123 . V_114 [ 0 ] = V_117 -> V_142 . V_114 [ 0 ] ;
V_114 -> V_123 . V_115 [ 0 ] = V_117 -> V_142 . V_115 [ 0 ] ;
V_114 -> V_123 . V_91 = V_114 -> V_91 ;
V_114 -> V_123 . V_89 = 0 ;
V_114 -> V_123 . V_108 = 0 ;
V_114 -> V_123 . V_76 = V_117 -> V_142 . V_76 ;
V_114 -> V_123 . V_138 = V_117 -> V_142 . V_138 ;
V_32 = F_30 ( V_6 ) ;
if ( ! V_32 )
return - V_102 ;
V_32 -> V_61 = V_114 ;
V_32 -> V_133 = F_21 ( V_130 + 1 ) ;
if ( V_32 -> V_133 )
V_71 = F_64 ( V_117 , V_32 , V_130 ) ;
else
V_71 = F_65 ( V_117 , V_32 , V_130 ) ;
if ( V_32 -> V_122 > 0 )
V_32 -> V_124 ++ ;
V_117 -> V_143 = & V_117 -> V_125 [ V_32 -> V_124 ] ;
V_117 -> V_144 = V_117 -> V_143 + 1 ;
if ( V_71 < 0 )
goto V_14;
V_71 = F_35 ( & V_32 -> V_58 ) ;
V_14:
for ( V_87 = V_117 -> V_125 ; V_87 < V_117 -> V_143 ; V_87 ++ )
* V_87 = NULL ;
if ( V_71 < 0 )
F_31 ( V_32 ) ;
return V_71 ;
