...
F_28 ( & V_2 -> V_10 ) ;
F_28 ( & V_2 -> V_31 ) ;
if ( ( V_39 = F_29 ( V_44 , V_70 , V_2 , & V_66 ) ) < 0 ) {
F_21 ( V_2 ) ;
return V_39 ;
}
* V_64 = V_2 ;
...
return V_39 ;
if ( ! V_83 ) {
if ( ( V_2 -> V_59 = F_33 ( V_9 , 2 , L_6 ) ) == NULL ) {
F_34 ( V_71 L_7 , V_9 ) ;
F_35 ( V_44 , V_2 ) ;
return - V_84 ;
}
if ( V_8 != 0 &&
( V_2 -> V_60 = F_33 ( V_8 , 2 , L_8 ) ) == NULL ) {
F_34 ( V_71 L_9 , V_8 ) ;
F_35 ( V_44 , V_2 ) ;
return - V_84 ;
}
...
if ( V_91 )
* V_91 = NULL ;
if ( ( V_39 = F_38 ( V_44 , L_11 , V_46 , & V_50 ) ) < 0 ) {
F_35 ( V_44 , V_2 ) ;
return V_39 ;
}
V_50 -> V_49 = V_2 ;
...
V_2 -> V_109 = V_90 ;
#if F_40 ( V_110 )
if ( F_41 ( V_44 , V_90 , V_111 ,
sizeof( struct V_1 * ) , & V_2 -> V_112 ) >= 0 ) {
strcpy ( V_2 -> V_112 -> V_48 , V_50 -> V_48 ) ;
* (struct V_1 * * ) F_42 ( V_2 -> V_112 ) = V_2 ;
}
#endif
if ( V_91 )
* V_91 = V_50 ;
