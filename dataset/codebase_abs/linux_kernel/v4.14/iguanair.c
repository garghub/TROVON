...
V_2 -> V_4 = F_36 ( V_80 , V_88 , V_43 ,
& V_2 -> V_89 ) ;
V_2 -> V_36 = F_36 ( V_80 , V_90 , V_43 ,
& V_2 -> V_91 ) ;
V_2 -> V_92 = F_37 ( 0 , V_43 ) ;
V_2 -> V_41 = F_37 ( 0 , V_43 ) ;
if ( ! V_2 -> V_4 || ! V_2 -> V_36 || ! V_2 -> V_92 || ! V_2 -> V_41 ) {
V_81 = - V_87 ;
goto V_49;
}
V_85 = V_76 -> V_93 ;
...
F_39 ( & V_2 -> V_7 ) ;
V_83 = F_40 ( V_80 ,
V_85 -> V_96 [ 1 ] . V_94 . V_97 ) ;
F_41 ( V_2 -> V_41 , V_80 , V_83 , V_2 -> V_36 , V_90 ,
F_14 , V_2 , 1 ) ;
V_2 -> V_41 -> V_98 = V_2 -> V_91 ;
V_2 -> V_41 -> V_99 |= V_100 ;
V_82 = F_42 ( V_80 , V_85 -> V_96 [ 0 ] . V_94 . V_97 ) ;
F_41 ( V_2 -> V_92 , V_80 , V_82 , V_2 -> V_4 , V_88 ,
F_10 , V_2 , 1 ) ;
V_2 -> V_92 -> V_98 = V_2 -> V_89 ;
V_2 -> V_92 -> V_99 |= V_100 ;
V_81 = F_13 ( V_2 -> V_92 , V_43 ) ;
if ( V_81 ) {
...
if ( V_81 )
goto V_101;
snprintf ( V_2 -> V_102 , sizeof( V_2 -> V_102 ) ,
L_13 , V_2 -> V_6 ) ;
F_43 ( V_2 -> V_80 , V_2 -> V_103 , sizeof( V_2 -> V_103 ) ) ;
V_19 -> V_104 = V_2 -> V_102 ;
V_19 -> V_105 = V_2 -> V_103 ;
F_44 ( V_2 -> V_80 , & V_19 -> V_106 ) ;
V_19 -> V_18 . V_107 = & V_76 -> V_18 ;
V_19 -> V_108 = V_109 ;
V_19 -> V_54 = V_2 ;
V_19 -> V_110 = F_30 ;
V_19 -> V_111 = F_31 ;
...
F_48 ( V_2 -> V_92 ) ;
F_48 ( V_2 -> V_41 ) ;
F_49 ( V_80 , V_88 , V_2 -> V_4 , V_2 -> V_89 ) ;
F_49 ( V_80 , V_90 , V_2 -> V_36 ,
V_2 -> V_91 ) ;
}
F_50 ( V_19 ) ;
F_51 ( V_2 ) ;
...
F_48 ( V_2 -> V_92 ) ;
F_48 ( V_2 -> V_41 ) ;
F_49 ( V_2 -> V_80 , V_88 , V_2 -> V_4 , V_2 -> V_89 ) ;
F_49 ( V_2 -> V_80 , V_90 , V_2 -> V_36 , V_2 -> V_91 ) ;
F_51 ( V_2 ) ;
}
static int F_55 ( struct V_75 * V_76 , T_3 V_124 )
{
struct V_1 * V_2 = F_53 ( V_76 ) ;
int V_19 = 0 ;
F_23 ( & V_2 -> V_56 ) ;
