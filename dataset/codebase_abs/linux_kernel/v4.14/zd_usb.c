...
static int F_137 ( struct V_161 * V_151 , const struct V_177 * V_82 )
{
int V_5 ;
struct V_6 * V_7 = F_115 ( V_151 ) ;
struct V_29 * V_30 ;
...
F_2 ( & V_151 -> V_19 , L_55 ) ;
F_20 ( & V_151 -> V_19 , L_46 , F_142 ( V_160 -> V_181 ) ) ;
return 0 ;
error:
F_138 ( F_115 ( V_151 ) ) ;
if ( V_160 ) {
...
struct V_62 * V_63 ;
struct V_29 * V_30 ;
if ( ! V_160 || V_151 -> V_184 != V_185 )
return 0 ;
V_63 = F_32 ( V_160 ) ;
V_30 = & V_63 -> V_137 . V_30 ;
V_30 -> V_182 = F_106 ( V_154 , & V_63 -> V_13 ) ;
F_153 ( V_30 ) ;
F_70 ( & V_63 -> V_137 . V_186 ) ;
return 0 ;
}
...
{
int V_5 ;
F_159 ( L_60 , V_187 . V_3 ) ;
V_152 = F_160 ( V_187 . V_3 ) ;
if ( V_152 == NULL ) {
F_161 ( V_188 L_61 , V_187 . V_3 ) ;
return - V_17 ;
}
V_5 = F_162 ( & V_187 ) ;
if ( V_5 ) {
...
F_159 ( L_63 , V_187 . V_3 ) ;
return 0 ;
}
static void T_8 F_164 ( void )
{
F_159 ( L_64 , V_187 . V_3 ) ;
F_165 ( & V_187 ) ;
F_163 ( V_152 ) ;
}
...
struct V_190 * V_191 ;
unsigned int V_192 ;
V_192 = F_167 ( V_7 , V_193 ) ;
V_191 = F_168 ( V_7 , V_192 ) ;
if ( ! V_191 )
return - V_76 ;
if ( F_169 ( & V_191 -> V_173 ) ) {
return F_170 ( V_7 , V_192 , V_10 , V_46 ,
V_67 , V_189 ) ;
} else {
V_192 = F_93 ( V_7 , V_193 ) ;
return F_133 ( V_7 , V_192 , V_10 , V_46 , V_67 ,
V_189 ) ;
}
}
static int F_171 ( unsigned int V_120 )
{
return sizeof( struct V_194 ) + V_120 * sizeof( struct V_195 ) ;
}
...
static bool F_35 ( struct V_29 * V_30 , struct V_196 * V_69 ,
unsigned int V_120 )
{
int V_98 ;
struct V_52 * V_53 = & V_30 -> V_53 ;
struct V_197 * V_198 = & V_53 -> V_57 ;
struct V_194 * V_199 = (struct V_194 * ) V_198 -> V_31 ;
if ( V_198 -> V_68 < F_171 ( V_120 ) ) {
F_2 ( F_45 ( V_30 ) ,
L_65 ,
V_198 -> V_68 , F_171 ( V_120 ) ) ;
return false ;
}
if ( V_198 -> V_68 > sizeof( V_198 -> V_31 ) ) {
F_2 ( F_45 ( V_30 ) ,
L_66 ,
V_198 -> V_68 , sizeof( V_198 -> V_31 ) ) ;
return false ;
}
for ( V_98 = 0 ; V_98 < V_120 ; V_98 ++ ) {
struct V_195 * V_200 = & V_199 -> V_199 [ V_98 ] ;
if ( V_200 -> V_45 != V_69 -> V_45 [ V_98 ] ) {
F_2 ( F_45 ( V_30 ) ,
L_67 , V_98 ,
F_6 ( V_200 -> V_45 ) ,
F_6 ( V_69 -> V_45 [ V_98 ] ) ) ;
...
static int F_175 ( struct V_29 * V_30 , T_1 * V_201 ,
struct V_196 * V_69 , unsigned int V_120 ,
bool * V_202 )
{
int V_5 ;
int V_98 ;
...
int F_176 ( struct V_29 * V_30 , T_1 * V_201 ,
const T_5 * V_205 , unsigned int V_120 )
{
int V_5 , V_98 , V_206 , V_207 , V_208 = 0 ;
struct V_6 * V_7 ;
struct V_196 * V_69 = NULL ;
unsigned long V_189 ;
bool V_202 = false ;
if ( V_120 < 1 ) {
F_2 ( F_45 ( V_30 ) , L_69 ) ;
...
F_30 ( F_178 ( & F_179 ( V_30 ) -> V_186 ) ) ;
F_180 ( sizeof( struct V_196 ) + V_209 *
sizeof( T_4 ) > sizeof( V_30 -> V_211 ) ) ;
F_181 ( sizeof( struct V_196 ) + V_120 * sizeof( T_4 ) >
sizeof( V_30 -> V_211 ) ) ;
V_206 = sizeof( struct V_196 ) + V_120 * sizeof( T_4 ) ;
V_69 = ( void * ) V_30 -> V_211 ;
V_69 -> V_82 = F_112 ( V_212 ) ;
for ( V_98 = 0 ; V_98 < V_120 ; V_98 ++ )
V_69 -> V_45 [ V_98 ] = F_112 ( ( T_1 ) V_205 [ V_98 ] ) ;
V_213:
V_208 ++ ;
V_7 = F_17 ( V_30 ) ;
F_172 ( V_30 , V_69 , V_120 ) ;
V_5 = F_166 ( V_7 , V_69 , V_206 , & V_207 , 50 ) ;
if ( V_5 ) {
F_2 ( F_45 ( V_30 ) ,
L_73 , V_5 ) ;
goto error;
...
V_189 = F_182 ( & V_30 -> V_53 . V_57 . V_58 ,
F_183 ( 50 ) ) ;
if ( ! V_189 ) {
F_174 ( V_30 ) ;
F_2 ( F_45 ( V_30 ) , L_76 ) ;
...
V_5 = F_175 ( V_30 , V_201 , V_69 , V_120 , & V_202 ) ;
if ( V_202 && V_208 < 20 ) {
F_2 ( F_45 ( V_30 ) , L_77 ,
V_208 ) ;
goto V_213;
...
{
struct V_29 * V_30 = V_50 -> V_51 ;
if ( V_50 -> V_74 && ! V_30 -> V_215 )
V_30 -> V_215 = V_50 -> V_74 ;
if ( ! V_30 -> V_215 &&
V_50 -> V_67 != V_50 -> V_114 )
V_30 -> V_215 = - V_49 ;
}
static int F_185 ( struct V_29 * V_30 , bool V_216 )
{
int V_5 = 0 ;
struct V_50 * V_50 = V_30 -> V_217 ;
if ( ! V_50 )
return 0 ;
V_30 -> V_217 = NULL ;
if ( ! V_216 )
...
int F_188 ( struct V_29 * V_30 , unsigned int V_189 )
{
int V_5 ;
F_30 ( F_178 ( & F_179 ( V_30 ) -> V_186 ) ) ;
F_30 ( V_30 -> V_219 ) ;
...
int F_190 ( struct V_29 * V_30 , const struct V_220 * V_221 ,
unsigned int V_120 )
{
int V_5 ;
struct V_6 * V_7 ;
...
V_7 = F_17 ( V_30 ) ;
V_191 = F_168 ( V_7 , F_167 ( V_7 , V_193 ) ) ;
if ( ! V_191 )
return - V_77 ;
V_50 = F_46 ( 0 , V_16 ) ;
if ( ! V_50 )
return - V_17 ;
V_206 = sizeof( struct V_222 ) +
V_120 * sizeof( struct V_195 ) ;
V_69 = F_8 ( V_206 , V_16 ) ;
if ( ! V_69 ) {
V_5 = - V_17 ;
goto error;
}
V_69 -> V_82 = F_112 ( V_224 ) ;
for ( V_98 = 0 ; V_98 < V_120 ; V_98 ++ ) {
struct V_195 * V_225 = & V_69 -> V_226 [ V_98 ] ;
V_225 -> V_45 = F_112 ( ( T_1 ) V_221 [ V_98 ] . V_45 ) ;
V_225 -> V_204 = F_112 ( V_221 [ V_98 ] . V_204 ) ;
}
if ( F_169 ( & V_191 -> V_173 ) )
F_51 ( V_50 , V_7 , F_167 ( V_7 , V_193 ) ,
V_69 , V_206 , F_184 , V_30 ,
V_191 -> V_173 . V_227 ) ;
else
F_64 ( V_50 , V_7 , F_93 ( V_7 , V_193 ) ,
V_69 , V_206 , F_184 , V_30 ) ;
V_50 -> V_96 |= V_228 ;
...
int F_191 ( struct V_29 * V_30 , const struct V_220 * V_221 ,
unsigned int V_120 )
{
int V_5 ;
F_186 ( V_30 ) ;
V_5 = F_190 ( V_30 , V_221 , V_120 ) ;
if ( V_5 ) {
F_188 ( V_30 , 0 ) ;
return V_5 ;
}
...
int F_192 ( struct V_29 * V_30 , T_9 V_204 , T_2 V_229 )
{
int V_5 ;
struct V_6 * V_7 ;
struct V_230 * V_69 = NULL ;
int V_98 , V_206 , V_207 ;
T_1 V_231 ;
if ( F_177 () ) {
F_2 ( F_45 ( V_30 ) ,
L_71 ) ;
...
#endif
F_2 ( F_45 ( V_30 ) , L_86 , V_204 , V_229 ) ;
V_5 = F_194 ( V_30 , & V_231 , V_234 ) ;
if ( V_5 ) {
F_2 ( F_45 ( V_30 ) ,
L_87 , V_5 ) ;
return V_5 ;
}
V_231 &= ~ ( V_235 | V_236 | V_237 ) ;
F_30 ( F_178 ( & F_179 ( V_30 ) -> V_186 ) ) ;
F_180 ( sizeof( struct V_230 ) +
V_233 * sizeof( T_4 ) >
sizeof( V_30 -> V_211 ) ) ;
F_181 ( sizeof( struct V_230 ) + V_229 * sizeof( T_4 ) >
sizeof( V_30 -> V_211 ) ) ;
V_206 = sizeof( struct V_230 ) + V_229 * sizeof( T_4 ) ;
V_69 = ( void * ) V_30 -> V_211 ;
V_69 -> V_82 = F_112 ( V_238 ) ;
V_69 -> V_204 = F_112 ( 2 ) ;
V_69 -> V_229 = F_112 ( V_229 ) ;
for ( V_98 = 0 ; V_98 < V_229 ; V_98 ++ ) {
T_1 V_239 = V_231 ;
if ( V_204 & ( 1 << ( V_229 - 1 - V_98 ) ) )
V_239 |= V_237 ;
V_69 -> V_240 [ V_98 ] = F_112 ( V_239 ) ;
}
V_7 = F_17 ( V_30 ) ;
V_5 = F_166 ( V_7 , V_69 , V_206 , & V_207 , 50 ) ;
if ( V_5 ) {
