...
{
F_58 ( V_14 , V_27 -> V_38 -> V_61 ) ;
V_14 -> V_89 . V_90 = F_55 ( V_27 , V_14 ) ;
}
static void F_59 ( struct V_46 * V_47 , struct V_25 * V_27 ,
struct V_14 * V_14 )
{
...
static void F_61 ( struct V_2 * V_3 , struct V_14 * V_14 )
{
F_62 ( & V_3 -> V_23 ) ;
if ( F_19 ( & V_3 -> V_92 ) ) {
F_63 ( & V_3 -> V_23 ) ;
...
static void F_66 ( unsigned long error , void * V_1 )
{
...
static void F_70 ( struct V_25 * V_27 , struct V_14 * V_14 )
{
struct V_46 V_47 ;
struct V_48 V_49 = {
. V_50 = V_98 ,
...
F_59 ( & V_47 , V_27 , V_14 ) ;
F_17 ( V_14 , V_27 ) ;
F_71 ( F_31 ( & V_49 , 1 , & V_47 , NULL ) ) ;
}
static inline int F_72 ( struct V_2 * V_3 , T_1 V_88 ,
int V_102 )
{
int V_103 = F_73 ( V_3 -> V_79 , V_88 , V_102 ) ;
return V_103 == V_104 || V_103 == V_105 ;
}
static void F_74 ( struct V_2 * V_3 , struct V_18 * V_22 )
{
T_1 V_88 ;
struct V_14 * V_14 ;
struct V_25 * V_27 ;
...
static void F_75 ( unsigned long error , void * V_1 )
{
unsigned V_45 ;
...
static void F_77 ( struct V_2 * V_3 , struct V_14 * V_14 )
{
unsigned int V_45 ;
...
F_59 ( V_76 ++ , V_27 , V_14 ) ;
F_17 ( V_14 , F_18 ( V_3 ) ) ;
F_71 ( F_31 ( & V_49 , V_3 -> V_30 , V_47 , NULL ) ) ;
}
static void F_78 ( struct V_2 * V_3 , struct V_18 * V_21 )
{
int V_103 ;
struct V_14 * V_14 ;
...
F_81 ( V_3 -> V_79 , & V_112 ) ;
F_81 ( V_3 -> V_79 , & V_113 ) ;
V_3 -> V_119 = F_82 ( V_3 -> V_79 ) ? 1 : V_3 -> V_119 ;
if ( F_32 ( V_3 -> V_119 ) && F_25 ( V_3 ) ) {
F_62 ( & V_3 -> V_23 ) ;
F_80 ( & V_3 -> V_109 , & V_112 ) ;
F_63 ( & V_3 -> V_23 ) ;
F_1 ( V_3 ) ;
} else
...
static void F_85 ( struct V_2 * V_3 , struct V_18 * V_109 )
{
struct V_14 * V_14 ;
if ( F_51 ( ! V_109 -> V_24 ) )
return;
...
{
struct V_2 * V_3 =
F_87 ( V_121 , struct V_2 , V_40 ) ;
F_49 ( V_3 -> V_42 -> V_87 ) ;
}
static void F_88 ( struct V_120 * V_121 )
{
struct V_2 * V_3 = F_87 ( V_121 , struct V_2 ,
V_5 ) ;
...
F_79 ( & V_3 -> V_109 ) ;
F_13 ( & V_3 -> V_23 , V_16 ) ;
F_89 ( V_3 -> V_79 , F_25 ( V_3 ) ) ;
F_45 ( V_3 ) ;
F_74 ( V_3 , & V_22 ) ;
F_78 ( V_3 , & V_21 ) ;
F_85 ( V_3 , & V_109 ) ;
}
static struct V_2 * F_90 ( unsigned int V_30 ,
T_3 V_78 ,
struct V_41 * V_42 ,
struct V_85 * V_122 )
{
...
static void F_99 ( struct V_2 * V_3 , struct V_41 * V_42 ,
unsigned int V_27 )
{
while ( V_27 -- )
F_100 ( V_42 , V_3 -> V_25 [ V_27 ] . V_38 ) ;
F_98 ( V_3 -> V_60 ) ;
F_101 ( V_3 -> V_79 ) ;
F_96 ( V_3 ) ;
}
static int F_102 ( struct V_2 * V_3 , struct V_41 * V_42 ,
...
V_129 = F_103 ( V_42 , V_127 [ 0 ] , F_104 ( V_42 -> V_87 ) ,
& V_3 -> V_25 [ V_25 ] . V_38 ) ;
if ( V_129 ) {
V_42 -> error = L_14 ;
return V_129 ;
...
static struct V_85 * F_105 ( struct V_41 * V_42 ,
...
V_122 = F_106 ( V_127 [ 0 ] , V_42 , F_30 , V_133 ,
V_127 + 2 ) ;
if ( ! V_122 ) {
V_42 -> error = L_18 ;
return NULL ;
...
static int F_107 ( struct V_2 * V_3 , unsigned V_131 , char * * V_127 ,
unsigned * V_132 )
{
unsigned V_134 ;
...
static int F_108 ( struct V_41 * V_42 , unsigned int V_131 , char * * V_127 )
{
int V_72 ;
...
struct V_85 * V_122 ;
char V_128 ;
V_122 = F_105 ( V_42 , V_131 , V_127 , & V_132 ) ;
if ( ! V_122 )
return - V_130 ;
V_127 += V_132 ;
V_131 -= V_132 ;
...
V_3 = F_90 ( V_30 , V_122 -> type -> V_138 ( V_122 ) , V_42 , V_122 ) ;
if ( ! V_3 ) {
F_109 ( V_122 ) ;
return - V_139 ;
}
for ( V_27 = 0 ; V_27 < V_30 ; V_27 ++ ) {
V_72 = F_102 ( V_3 , V_42 , V_27 , V_127 ) ;
if ( V_72 ) {
F_99 ( V_3 , V_42 , V_27 ) ;
return V_72 ;
}
...
V_42 -> V_43 = V_3 ;
V_72 = F_110 ( V_42 , F_40 ( V_3 -> V_79 ) ) ;
if ( V_72 )
goto V_140;
V_42 -> V_141 = 1 ;
V_42 -> V_142 = 1 ;
V_42 -> V_143 = sizeof( struct V_144 ) ;
V_3 -> V_4 = F_111 ( L_27 , V_145 , 0 ) ;
if ( ! V_3 -> V_4 ) {
F_27 ( L_28 ) ;
V_72 = - V_139 ;
goto V_140;
...
V_3 -> V_7 = 0 ;
F_112 ( & V_3 -> V_40 , V_40 ) ;
V_72 = F_107 ( V_3 , V_131 , V_127 , & V_132 ) ;
if ( V_72 )
goto V_146;
V_127 += V_132 ;
V_131 -= V_132 ;
...
static int F_122 ( struct V_41 * V_42 , struct V_14 * V_14 )
{
int V_72 , V_15 = F_68 ( V_14 ) ;
struct V_25 * V_27 ;
struct V_2 * V_3 = V_42 -> V_43 ;
struct V_85 * log = F_46 ( V_3 -> V_79 ) ;
struct V_144 * V_148 =
F_123 ( V_14 , sizeof( struct V_144 ) ) ;
V_148 -> V_149 . V_150 = NULL ;
if ( V_15 == V_20 ) {
V_148 -> V_151 = F_54 ( V_3 -> V_79 , V_14 ) ;
F_10 ( V_3 , V_14 , V_15 ) ;
return V_152 ;
}
...
if ( F_32 ( ! V_27 ) )
return V_154 ;
F_124 ( & V_148 -> V_149 , V_14 ) ;
V_148 -> V_27 = V_27 ;
F_57 ( V_27 , V_14 ) ;
return V_156 ;
}
static int F_125 ( struct V_41 * V_42 , struct V_14 * V_14 ,
T_5 * error )
{
int V_15 = F_68 ( V_14 ) ;
struct V_2 * V_3 = (struct V_2 * ) V_42 -> V_43 ;
...
static char F_135 ( struct V_25 * V_27 )
{
if ( ! F_19 ( & ( V_27 -> V_31 ) ) )
return 'A' ;
...
static void F_136 ( struct V_41 * V_42 , T_6 type ,
...
F_137 ( L_36 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ ) {
F_137 ( L_37 , V_3 -> V_25 [ V_27 ] . V_38 -> V_39 ) ;
V_169 [ V_27 ] = F_135 ( & ( V_3 -> V_25 [ V_27 ] ) ) ;
}
V_169 [ V_27 ] = '\0' ;
F_137 ( L_38 ,
...
F_137 ( L_39 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ )
F_137 ( L_40 , V_3 -> V_25 [ V_27 ] . V_38 -> V_39 ,
...
static int F_138 ( struct V_41 * V_42 ,
T_7 V_101 , void * V_6 )
{
struct V_2 * V_3 = V_42 -> V_43 ;
int V_129 = 0 ;
