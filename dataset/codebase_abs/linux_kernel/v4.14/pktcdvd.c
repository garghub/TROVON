...
static struct V_83 * F_123 ( struct V_2 * V_3 , int V_183 )
{
struct V_83 * V_86 ;
...
static inline void F_129 ( struct V_83 * V_86 , enum V_184 V_185 )
{
#if V_186 > 1
...
V_86 -> V_194 += V_95 -> V_111 . V_161 / V_164 ;
F_13 ( & V_86 -> V_28 ) ;
}
V_190 = ( V_3 -> V_31 > 0
&& V_3 -> V_29 <= V_3 -> V_30 ) ;
...
F_119 ( V_86 -> V_88 , V_3 -> V_52 ) ;
V_86 -> V_88 -> V_181 = F_114 ;
V_86 -> V_88 -> V_168 = V_86 ;
for ( V_174 = 0 ; V_174 < V_86 -> V_84 ; V_174 ++ ) {
struct V_203 * V_203 = V_86 -> V_91 [ ( V_174 * V_164 ) / V_167 ] ;
unsigned V_4 = ( V_174 * V_164 ) % V_167 ;
if ( ! F_120 ( V_86 -> V_88 , V_203 , V_164 , V_4 ) )
F_121 () ;
}
F_56 ( 2 , V_3 , L_52 , V_86 -> V_88 -> V_204 ) ;
F_12 ( & V_86 -> V_28 ) ;
F_134 ( V_86 -> V_88 , V_86 -> V_94 . V_205 ) ;
F_129 ( V_86 , V_206 ) ;
F_13 ( & V_86 -> V_28 ) ;
F_56 ( 2 , V_3 , L_53 ,
V_86 -> V_194 , ( unsigned long long ) V_86 -> V_1 ) ;
if ( F_135 ( V_165 , & V_3 -> V_166 ) || ( V_86 -> V_194 < V_86 -> V_84 ) )
V_86 -> V_179 = 1 ;
else
V_86 -> V_179 = 0 ;
F_57 ( & V_86 -> V_171 , 1 ) ;
F_122 ( V_86 -> V_88 , V_207 , 0 ) ;
F_99 ( V_3 , V_86 -> V_88 ) ;
}
static void F_136 ( struct V_83 * V_86 , T_6 V_208 )
{
struct V_95 * V_95 ;
if ( V_208 )
V_86 -> V_179 = 0 ;
...
V_216 = V_223 ;
F_124 (pkt, &pd->cdrw.pkt_active_list, list) {
if ( V_86 -> V_199 && V_86 -> V_199 < V_216 )
V_216 = V_86 -> V_199 ;
}
F_56 ( 2 , V_3 , L_57 ) ;
V_217 = F_148 ( V_216 ) ;
...
static int F_156 ( struct V_2 * V_3 , T_7 * V_232 )
{
struct V_115 V_116 ;
int V_61 ;
F_97 ( & V_116 , V_232 , sizeof( * V_232 ) , V_230 ) ;
V_116 . V_130 [ 0 ] = V_233 ;
...
static int F_158 ( struct V_2 * V_3 , T_8 V_235 , T_4 type , T_9 * V_236 )
{
struct V_115 V_116 ;
int V_61 ;
F_97 ( & V_116 , V_236 , 8 , V_230 ) ;
V_116 . V_130 [ 0 ] = V_237 ;
...
F_97 ( & V_116 , V_127 , sizeof( * V_249 ) , V_230 ) ;
V_116 . V_143 = & V_143 ;
...
if ( V_6 > sizeof( V_127 ) )
V_6 = sizeof( V_127 ) ;
F_97 ( & V_116 , V_127 , V_6 , V_230 ) ;
V_116 . V_143 = & V_143 ;
if ( ( V_61 = F_154 ( V_3 , & V_116 , V_251 , 0 ) ) ) {
F_94 ( V_3 , & V_116 ) ;
return V_61 ;
}
V_249 = ( T_11 * ) & V_127 [ sizeof( struct V_253 ) + V_3 -> V_252 ] ;
...
static int F_164 ( struct V_2 * V_3 , T_9 * V_236 )
{
switch ( V_3 -> V_250 ) {
case 0x1a :
case 0x12 :
...
return 1 ;
F_95 ( V_3 , L_63 , V_236 -> V_266 , V_236 -> V_243 , V_236 -> V_265 ) ;
return 0 ;
}
static int F_165 ( struct V_2 * V_3 , T_7 * V_232 )
{
switch ( V_3 -> V_250 ) {
case 0x0a :
case 0xffff :
...
T_9 V_236 ;
int V_61 , V_235 ;
F_97 ( & V_116 , V_54 , sizeof( V_54 ) , V_230 ) ;
V_116 . V_130 [ 0 ] = V_271 ;
V_116 . V_130 [ 8 ] = 8 ;
V_61 = F_83 ( V_3 , & V_116 ) ;
V_3 -> V_250 = V_61 ? 0xffff : V_54 [ 6 ] << 8 | V_54 [ 7 ] ;
memset ( & V_232 , 0 , sizeof( T_7 ) ) ;
memset ( & V_236 , 0 , sizeof( T_9 ) ) ;
if ( ( V_61 = F_156 ( V_3 , & V_232 ) ) ) {
F_95 ( V_3 , L_69 ) ;
return V_61 ;
}
...
F_112 ( V_281 , & V_3 -> V_166 ) ;
}
if ( V_236 . V_244 ) {
V_3 -> V_282 = F_160 ( V_236 . V_245 ) ;
F_112 ( V_283 , & V_3 -> V_166 ) ;
} else {
...
F_97 ( & V_116 , V_54 , sizeof( V_54 ) , V_293 ) ;
V_116 . V_143 = & V_143 ;
...
static int F_174 ( struct V_2 * V_3 , T_12 V_306 )
{
int V_61 ;
long V_307 ;
struct V_117 * V_118 ;
...
static int F_185 ( struct V_317 * V_52 , T_12 V_318 )
{
struct V_2 * V_3 = NULL ;
int V_61 ;
F_186 ( & V_319 ) ;
...
static void F_188 ( struct V_324 * V_195 , T_12 V_318 )
{
struct V_2 * V_3 = V_195 -> V_325 ;
F_186 ( & V_319 ) ;
F_186 ( & V_47 ) ;
V_3 -> V_320 -- ;
F_53 ( V_3 -> V_320 < 0 ) ;
...
{
struct V_95 * V_329 = F_191 ( V_95 , V_330 , V_331 ) ;
struct V_326 * V_327 = F_192 ( V_328 , V_330 ) ;
V_327 -> V_3 = V_3 ;
V_327 -> V_95 = V_95 ;
F_119 ( V_329 , V_3 -> V_52 ) ;
V_329 -> V_168 = V_327 ;
V_329 -> V_181 = F_189 ;
...
if ( V_333 ) {
F_58 ( & V_3 -> V_82 ) ;
} else if ( ! F_68 ( & V_3 -> V_78 . V_100 ) && ! V_334 ) {
F_58 ( & V_3 -> V_82 ) ;
}
}
static T_13 F_197 ( struct V_117 * V_118 , struct V_95 * V_95 )
{
struct V_2 * V_3 ;
char V_335 [ V_336 ] ;
struct V_95 * V_337 ;
...
T_1 V_340 = F_1 ( F_106 ( V_95 ) - 1 , V_3 ) ;
if ( V_340 != V_183 ) {
F_53 ( V_340 != V_183 + V_3 -> V_5 . V_6 ) ;
V_337 = F_200 ( V_95 , V_340 -
V_95 -> V_111 . V_112 ,
V_330 , V_331 ) ;
F_201 ( V_337 , V_95 ) ;
} else {
...
F_206 ( V_69 , L_125 , ( unsigned long long ) V_3 -> V_192 ) ;
F_141 ( V_3 , V_213 ) ;
F_206 ( V_69 , L_126 ,
...
static int F_208 ( struct V_70 * V_70 , struct V_71 * V_71 )
{
return F_44 ( V_71 , F_42 , F_209 ( V_70 ) ) ;
}
static int F_210 ( struct V_2 * V_3 , T_14 V_37 )
{
int V_85 ;
int V_61 = 0 ;
char V_335 [ V_336 ] ;
...
V_61 = F_176 ( V_52 , V_308 | V_345 , NULL ) ;
if ( V_61 )
return V_61 ;
F_214 ( V_58 ) ;
V_3 -> V_52 = V_52 ;
...
V_3 -> V_78 . V_346 = F_215 ( F_142 , V_3 , L_1 , V_3 -> V_8 ) ;
if ( F_21 ( V_3 -> V_78 . V_346 ) ) {
F_95 ( V_3 , L_132 ) ;
V_61 = - V_62 ;
goto V_347;
}
F_216 ( V_3 -> V_8 , 0 , V_348 , & V_349 , V_3 ) ;
F_56 ( 1 , V_3 , L_133 , F_207 ( V_52 , V_335 ) ) ;
return 0 ;
V_347:
F_182 ( V_52 , V_308 | V_345 ) ;
F_33 ( V_58 ) ;
return V_61 ;
}
static int F_217 ( struct V_317 * V_52 , T_12 V_318 , unsigned int V_130 , unsigned long V_350 )
{
...
case V_355 :
case V_356 :
V_61 = F_218 ( V_3 -> V_52 , V_318 , V_130 , V_350 ) ;
break;
default:
...
static unsigned int F_219 ( struct V_324 * V_195 ,
unsigned int V_358 )
{
struct V_2 * V_3 = V_195 -> V_325 ;
struct V_324 * V_359 ;
...
static char * F_220 ( struct V_324 * V_362 , T_15 * V_318 )
{
return F_221 ( V_14 , L_136 , V_362 -> V_363 ) ;
}
...
if ( ! F_21 ( V_3 -> V_78 . V_346 ) )
F_231 ( V_3 -> V_78 . V_346 ) ;
V_50 [ V_46 ] = NULL ;
F_48 ( V_3 ) ;
F_22 ( V_3 ) ;
F_182 ( V_3 -> V_52 , V_308 | V_345 ) ;
F_232 ( V_3 -> V_8 , V_348 ) ;
F_56 ( 1 , V_3 , L_140 ) ;
F_233 ( V_3 -> V_195 ) ;
F_227 ( V_3 -> V_195 -> V_196 ) ;
F_228 ( V_3 -> V_195 ) ;
F_229 ( V_3 -> V_108 ) ;
F_9 ( V_3 ) ;
F_33 ( V_58 ) ;
...
static void F_234 ( struct V_376 * V_377 )
{
struct V_2 * V_3 ;
F_26 ( & V_47 , V_48 ) ;
V_3 = F_184 ( V_377 -> V_378 ) ;
if ( V_3 ) {
V_377 -> V_37 = F_235 ( V_3 -> V_52 -> V_53 ) ;
V_377 -> V_51 = F_235 ( V_3 -> V_51 ) ;
} else {
V_377 -> V_37 = 0 ;
V_377 -> V_51 = 0 ;
}
...
{
void T_16 * V_380 = ( void T_16 * ) V_350 ;
struct V_376 V_377 ;
int V_61 = 0 ;
T_14 V_51 = 0 ;
if ( V_130 != V_381 )
return - V_357 ;
if ( F_237 ( & V_377 , V_380 , sizeof( struct V_376 ) ) )
return - V_382 ;
switch ( V_377 . V_383 ) {
case V_384 :
if ( ! F_238 ( V_385 ) )
return - V_386 ;
V_61 = F_32 ( F_239 ( V_377 . V_37 ) , & V_51 ) ;
V_377 . V_51 = F_235 ( V_51 ) ;
break;
case V_387 :
if ( ! F_238 ( V_385 ) )
return - V_386 ;
V_61 = F_35 ( F_239 ( V_377 . V_51 ) ) ;
break;
case V_388 :
F_234 ( & V_377 ) ;
break;
...
if ( F_240 ( V_380 , & V_377 , sizeof( struct V_376 ) ) )
return - V_382 ;
return V_61 ;
}
static long F_241 ( struct V_71 * V_71 , unsigned int V_130 , unsigned long V_350 )
{
return F_236 ( V_71 , V_130 , ( unsigned long ) F_242 ( V_350 ) ) ;
}
static int T_17 F_243 ( void )
{
int V_61 ;
F_244 ( & V_47 ) ;
V_328 = F_222 ( V_389 ,
...
if ( ! V_328 )
return - V_62 ;
V_331 = F_245 ( V_390 , 0 , 0 ) ;
if ( ! V_331 ) {
F_229 ( V_328 ) ;
return - V_62 ;
}
V_61 = F_246 ( V_367 , V_63 ) ;
if ( V_61 < 0 ) {
F_38 ( L_141 ) ;
goto V_391;
}
...
static void T_18 F_251 ( void )
{
F_232 ( L_143 V_63 , NULL ) ;
F_252 ( & V_392 ) ;
F_51 () ;
F_39 () ;
F_249 ( V_367 , V_63 ) ;
