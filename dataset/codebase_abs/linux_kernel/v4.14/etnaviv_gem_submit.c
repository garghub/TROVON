...
V_9 = F_35 ( args -> V_13 , sizeof( * V_9 ) , V_10 ) ;
V_59 = F_35 ( args -> V_60 , sizeof( * V_59 ) , V_10 ) ;
V_56 = F_35 ( 1 , args -> V_83 , V_10 ) ;
V_75 = F_36 ( V_5 -> V_89 ,
F_37 ( args -> V_83 , 8 ) + 8 ,
args -> V_13 ) ;
...
if ( V_23 )
goto V_100;
memcpy ( V_75 -> V_101 , V_56 , args -> V_83 ) ;
V_75 -> V_102 = F_37 ( args -> V_83 , 8 ) ;
