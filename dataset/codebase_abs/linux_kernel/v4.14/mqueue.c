...
struct V_37 * V_27 )
{
const struct V_179 * V_179 = F_101 () ;
int V_40 ;
if ( V_27 ) {
V_40 = F_99 ( V_35 , V_27 ) ;
if ( V_40 )
...
V_35 -> V_68 ) ;
V_40 = F_99 ( V_35 , & V_180 ) ;
if ( V_40 )
return F_41 ( V_40 ) ;
}
V_36 &= ~ F_102 () ;
V_40 = F_103 ( V_110 , V_177 -> V_93 , V_36 , true ) ;
V_177 -> V_93 -> V_112 = NULL ;
if ( V_40 )
return F_41 ( V_40 ) ;
return F_104 ( V_177 , V_178 , V_179 ) ;
}
static struct V_118 * F_105 ( struct V_177 * V_177 , int V_178 )
{
...
if ( F_106 ( F_66 ( V_177 -> V_93 ) , V_185 ) )
return F_41 ( - V_113 ) ;
return F_104 ( V_177 , V_178 , F_101 () ) ;
}
static int F_107 ( const char T_3 * V_188 , int V_178 , T_1 V_36 ,
struct V_37 * V_27 )
{
struct V_177 V_177 ;
struct V_118 * V_119 ;
...
struct V_192 * V_193 = V_35 -> V_194 ;
struct V_93 * V_195 = V_193 -> V_196 ;
int V_197 ;
F_108 ( V_178 , V_36 , V_27 ) ;
if ( F_43 ( V_190 = F_109 ( V_188 ) ) )
return F_44 ( V_190 ) ;
V_191 = F_110 ( V_198 ) ;
if ( V_191 < 0 )
goto V_199;
...
error = 0 ;
F_112 ( F_66 ( V_195 ) ) ;
V_177 . V_93 = F_113 ( V_190 -> V_190 , V_195 , strlen ( V_190 -> V_190 ) ) ;
if ( F_43 ( V_177 . V_93 ) ) {
error = F_44 ( V_177 . V_93 ) ;
goto V_200;
}
V_177 . V_193 = F_114 ( V_193 ) ;
if ( V_178 & V_201 ) {
if ( F_115 ( V_177 . V_93 ) ) {
F_116 ( V_190 , V_177 . V_93 , 0 ) ;
if ( V_178 & V_202 ) {
error = - V_203 ;
goto V_204;
}
V_119 = F_105 ( & V_177 , V_178 ) ;
} else {
if ( V_197 ) {
error = V_197 ;
goto V_204;
...
F_117 ( V_190 , V_195 ) ;
V_119 = F_100 ( V_35 , F_66 ( V_195 ) , & V_177 ,
V_178 , V_36 , V_27 ) ;
}
} else {
if ( F_118 ( V_177 . V_93 ) ) {
...
static inline void F_125 ( struct V_206 * V_207 ,
struct V_1 * V_11 ,
struct V_9 * V_208 ,
struct V_137 * V_209 )
{
V_209 -> V_10 = V_208 ;
F_23 ( & V_209 -> V_58 ) ;
F_126 ( V_207 , V_209 -> V_140 ) ;
V_209 -> V_210 = V_211 ;
}
static inline void F_127 ( struct V_206 * V_207 ,
struct V_1 * V_11 )
{
struct V_137 * V_212 = F_81 ( V_11 , V_213 ) ;
if ( ! V_212 ) {
F_128 ( & V_11 -> V_56 ) ;
return;
}
if ( F_8 ( V_212 -> V_10 , V_11 ) )
return;
F_23 ( & V_212 -> V_58 ) ;
F_126 ( V_207 , V_212 -> V_140 ) ;
V_212 -> V_210 = V_211 ;
}
static int F_129 ( T_8 V_214 , const char T_3 * V_215 ,
T_4 V_216 , unsigned int V_217 ,
struct V_167 * V_168 )
{
struct V_191 V_218 ;
struct V_2 * V_2 ;
...
struct V_9 * V_220 ;
struct V_1 * V_11 ;
T_7 V_221 , * V_142 = NULL ;
struct V_15 * V_222 = NULL ;
int V_40 = 0 ;
F_130 ( V_207 ) ;
if ( F_18 ( V_217 >= ( unsigned long ) V_223 ) )
return - V_170 ;
if ( V_168 ) {
V_221 = F_131 ( * V_168 ) ;
V_142 = & V_221 ;
}
F_132 ( V_214 , V_216 , V_217 , V_168 ) ;
V_218 = F_133 ( V_214 ) ;
if ( F_18 ( ! V_218 . V_118 ) ) {
V_40 = - V_224 ;
goto V_204;
}
V_2 = F_70 ( V_218 . V_118 ) ;
if ( F_18 ( V_218 . V_118 -> V_225 != & V_52 ) ) {
V_40 = - V_224 ;
goto V_226;
}
V_11 = F_1 ( V_2 ) ;
F_134 ( V_218 . V_118 ) ;
if ( F_18 ( ! ( V_218 . V_118 -> V_227 & V_228 ) ) ) {
V_40 = - V_224 ;
goto V_226;
}
if ( F_18 ( V_216 > V_11 -> V_27 . V_66 ) ) {
V_40 = - V_229 ;
goto V_226;
}
V_220 = F_135 ( V_215 , V_216 ) ;
if ( F_43 ( V_220 ) ) {
V_40 = F_44 ( V_220 ) ;
goto V_226;
}
...
if ( V_11 -> V_27 . V_28 == V_11 -> V_27 . V_63 ) {
if ( V_218 . V_118 -> V_230 & V_231 ) {
V_40 = - V_232 ;
} else {
V_219 . V_140 = V_99 ;
V_219 . V_10 = ( void * ) V_220 ;
V_219 . V_210 = V_233 ;
V_40 = F_80 ( V_11 , V_213 , V_142 , & V_219 ) ;
goto V_234;
}
} else {
V_209 = F_81 ( V_11 , V_235 ) ;
if ( V_209 ) {
F_125 ( & V_207 , V_11 , V_220 , V_209 ) ;
} else {
V_40 = F_8 ( V_220 , V_11 ) ;
if ( V_40 )
goto V_114;
...
static int F_138 ( T_8 V_214 , char T_3 * V_215 ,
T_4 V_216 , unsigned int T_3 * V_236 ,
struct V_167 * V_168 )
{
T_2 V_40 ;
struct V_9 * V_220 ;
...
V_11 = F_1 ( V_2 ) ;
F_134 ( V_218 . V_118 ) ;
if ( F_18 ( ! ( V_218 . V_118 -> V_227 & V_237 ) ) ) {
V_40 = - V_224 ;
goto V_226;
}
if ( F_18 ( V_216 < V_11 -> V_27 . V_66 ) ) {
...
V_219 . V_140 = V_99 ;
V_219 . V_210 = V_233 ;
V_40 = F_80 ( V_11 , V_235 , V_142 , & V_219 ) ;
V_220 = V_219 . V_10 ;
}
} else {
F_130 ( V_207 ) ;
...
if ( V_40 == 0 ) {
V_40 = V_220 -> V_30 ;
if ( ( V_236 && F_139 ( V_220 -> V_19 , V_236 ) ) ||
F_140 ( V_215 , V_220 , V_220 -> V_30 ) ) {
V_40 = - V_169 ;
}
F_58 ( V_220 ) ;
}
...
static int F_141 ( T_8 V_214 , const struct V_238 * V_239 )
{
int V_40 ;
struct V_191 V_218 ;
struct V_240 * V_240 ;
...
V_240 = NULL ;
if ( V_239 != NULL ) {
if ( F_18 ( V_239 -> V_125 != V_152 &&
V_239 -> V_125 != V_126 &&
V_239 -> V_125 != V_161 ) )
return - V_170 ;
if ( V_239 -> V_125 == V_126 &&
! F_143 ( V_239 -> V_127 ) ) {
return - V_170 ;
}
if ( V_239 -> V_125 == V_161 ) {
long V_242 ;
V_241 = F_144 ( V_149 , V_105 ) ;
if ( ! V_241 ) {
V_40 = - V_25 ;
goto V_204;
}
...
F_146 ( V_241 , V_149 ) ;
V_244:
V_218 = F_133 ( V_239 -> V_127 ) ;
if ( ! V_218 . V_118 ) {
V_40 = - V_224 ;
goto V_204;
}
V_240 = F_147 ( V_218 . V_118 ) ;
F_137 ( V_218 ) ;
if ( F_43 ( V_240 ) ) {
V_40 = F_44 ( V_240 ) ;
V_240 = NULL ;
...
V_242 = V_245 ;
V_40 = F_148 ( V_240 , V_241 , & V_242 , NULL ) ;
if ( V_40 == 1 ) {
V_240 = NULL ;
goto V_244;
}
...
break;
case V_126 :
V_11 -> V_124 . V_127 = V_239 -> V_127 ;
V_11 -> V_124 . V_158 = V_239 -> V_158 ;
V_11 -> V_124 . V_125 = V_126 ;
break;
}
V_11 -> V_59 = F_149 ( F_74 ( V_99 ) ) ;
V_11 -> V_60 = F_150 ( F_151 () ) ;
V_2 -> V_48 = V_2 -> V_47 = F_30 ( V_2 ) ;
}
F_7 ( & V_11 -> V_55 ) ;
V_226:
...
static int F_154 ( int V_214 , struct V_37 * V_247 , struct V_37 * V_248 )
{
struct V_191 V_218 ;
struct V_2 * V_2 ;
struct V_1 * V_11 ;
if ( V_247 && ( V_247 -> V_249 & ( ~ V_231 ) ) )
return - V_170 ;
V_218 = F_133 ( V_214 ) ;
if ( ! V_218 . V_118 )
return - V_224 ;
...
if ( V_248 ) {
* V_248 = V_11 -> V_27 ;
V_248 -> V_249 = V_218 . V_118 -> V_230 & V_231 ;
}
if ( V_247 ) {
F_155 ( V_214 , V_247 ) ;
F_6 ( & V_218 . V_118 -> V_250 ) ;
if ( V_247 -> V_249 & V_231 )
V_218 . V_118 -> V_230 |= V_231 ;
else
V_218 . V_118 -> V_230 &= ~ V_231 ;
F_7 ( & V_218 . V_118 -> V_250 ) ;
V_2 -> V_48 = V_2 -> V_47 = F_30 ( V_2 ) ;
}
F_7 ( & V_11 -> V_55 ) ;
F_137 ( V_218 ) ;
...
static inline int F_156 ( struct V_37 * V_27 ,
const struct V_251 T_3 * V_252 )
{
struct V_251 V_253 ;
if ( F_145 ( & V_253 , V_252 , sizeof( * V_252 ) ) )
return - V_169 ;
memset ( V_27 , 0 , sizeof( * V_27 ) ) ;
V_27 -> V_249 = V_253 . V_249 ;
V_27 -> V_63 = V_253 . V_63 ;
V_27 -> V_66 = V_253 . V_66 ;
V_27 -> V_28 = V_253 . V_28 ;
return 0 ;
}
static inline int F_157 ( const struct V_37 * V_27 ,
struct V_251 T_3 * V_252 )
{
struct V_251 V_253 ;
memset ( & V_253 , 0 , sizeof( V_253 ) ) ;
V_253 . V_249 = V_27 -> V_249 ;
V_253 . V_63 = V_27 -> V_63 ;
V_253 . V_66 = V_27 -> V_66 ;
V_253 . V_28 = V_27 -> V_28 ;
if ( F_158 ( V_252 , & V_253 , sizeof( * V_252 ) ) )
return - V_169 ;
return 0 ;
}
static int F_159 ( const struct V_254 T_3 * V_13 ,
struct V_167 * V_168 )
{
if ( F_160 ( V_168 , V_13 ) )
return - V_169 ;
...
V_7 -> V_65 = V_258 ;
V_7 -> V_68 = V_259 ;
V_7 -> V_194 = F_162 ( & V_260 , V_7 ) ;
if ( F_43 ( V_7 -> V_194 ) ) {
int V_41 = F_44 ( V_7 -> V_194 ) ;
V_7 -> V_194 = NULL ;
return V_41 ;
}
return 0 ;
...
{
V_7 -> V_194 -> V_261 -> V_6 = NULL ;
}
void F_164 ( struct V_4 * V_7 )
{
F_165 ( V_7 -> V_194 ) ;
}
