...
if ( V_82 -> V_43 == 0 || ! V_82 -> V_87 )
return false ;
V_89 = ( V_82 -> V_87 << 1 ) * V_91 ;
V_88 = V_82 -> V_42 / V_89 ;
V_90 = F_41 ( V_92 - V_82 -> V_93 ) ;
if ( V_90 > V_89 ) {
V_84 = V_94 ;
goto V_95;
}
...
bool V_210 = false ;
while ( F_25 ( V_209 < ( unsigned int ) V_44 ) ) {
struct V_107 * V_194 ;
union V_130 * V_131 ;
unsigned int V_3 ;
T_3 V_122 ;
...
F_27 ( & V_105 -> V_53 ) ;
V_105 -> V_57 -> V_220 . V_43 += V_209 ;
V_105 -> V_57 -> V_220 . V_42 += V_208 ;
return V_210 ? V_44 : ( int ) V_209 ;
}
static T_2 F_119 ( const int type , const T_3 V_87 )
{
T_2 V_70 ;
V_70 = V_78 |
( type << V_221 ) |
...
static inline int F_120 ( struct V_36 * V_37 , int V_223 )
{
struct V_224 * V_225 = V_37 -> V_74 ;
return V_225 -> V_226 [ V_223 ] . V_227 ;
}
static inline int F_121 ( struct V_36 * V_37 , int V_223 )
{
struct V_224 * V_225 = V_37 -> V_74 ;
...
struct V_69 * V_57 )
{
struct V_230 * V_75 = & V_37 -> V_74 -> V_75 ;
bool V_220 = false , V_58 = false ;
T_2 V_231 , V_232 ;
int V_233 ;
int V_223 = V_57 -> V_76 ;
int V_227 , V_229 ;
V_233 = ( V_57 -> V_76 + V_37 -> V_77 ) ;
V_231 = V_232 = F_119 ( V_234 , 0 ) ;
V_227 = F_120 ( V_37 , V_223 ) ;
V_229 = F_121 ( V_37 , V_223 ) ;
if ( V_57 -> V_235 > 0 ||
( ! F_123 ( V_227 ) &&
! F_123 ( V_229 ) ) ) {
goto V_236;
...
if ( F_123 ( V_227 ) ) {
V_220 = F_40 ( & V_57 -> V_220 ) ;
V_231 = F_119 ( V_237 , V_57 -> V_220 . V_87 ) ;
}
if ( F_123 ( V_229 ) ) {
V_58 = F_40 ( & V_57 -> V_58 ) ;
V_232 = F_119 ( V_238 , V_57 -> V_58 . V_87 ) ;
}
if ( V_220 || V_58 ) {
T_3 V_87 = F_124 ( V_57 -> V_58 . V_87 , V_57 -> V_220 . V_87 ) ;
V_57 -> V_58 . V_87 = V_57 -> V_220 . V_87 = V_87 ;
V_232 = F_119 ( V_238 , V_87 ) ;
V_58 = true ;
V_231 = F_119 ( V_237 , V_87 ) ;
V_220 = true ;
}
if ( V_220 ) {
V_231 |= F_79 ( 31 ) ;
F_37 ( V_75 , F_125 ( V_233 - 1 ) , V_231 ) ;
}
V_236:
if ( ! F_28 ( V_63 , V_37 -> V_64 ) )
F_37 ( V_75 , F_125 ( V_233 - 1 ) , V_232 ) ;
if ( V_57 -> V_235 )
V_57 -> V_235 -- ;
else
V_57 -> V_235 = V_91 ;
}
int F_126 ( struct V_239 * V_127 , int V_44 )
{
struct V_69 * V_57 =
...
if ( V_44 <= 0 )
goto V_243;
V_241 = F_124 ( V_44 / V_57 -> V_244 , 1 ) ;
F_129 (ring, q_vector->rx) {
int V_245 = F_116 ( V_12 , V_241 ) ;
V_242 += V_245 ;
if ( V_245 >= V_241 )
V_240 = false ;
}
...
F_132 ( V_127 , V_242 ) ;
F_122 ( V_37 , V_57 ) ;
return F_133 ( V_242 , V_44 - 1 ) ;
}
static inline int F_134 ( struct V_121 * V_15 ,
struct V_11 * V_24 ,
T_2 * V_59 )
{
T_6 V_190 = V_15 -> V_190 ;
T_2 V_16 = 0 ;
if ( V_190 == F_70 ( V_126 ) &&
...
static T_7 F_170 ( struct V_121 * V_15 ,
struct V_11 * V_24 )
{
V_6 V_263 = V_342 ;
T_2 V_302 = 0 , V_339 = 0 ;
...
T_7 F_176 ( struct V_121 * V_15 , struct V_377 * V_32 )
{
struct V_224 * V_225 = F_177 ( V_32 ) ;
struct V_11 * V_24 = & V_225 -> V_228 [ V_15 -> V_378 ] ;
