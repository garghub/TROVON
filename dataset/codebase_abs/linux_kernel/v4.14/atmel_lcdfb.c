...
F_29 ( V_11 -> V_79 , V_11 -> V_73 . V_80 , V_11 -> V_81 ,
V_11 -> V_73 . V_75 ) ;
}
...
static int F_65 ( struct V_187 * V_188 )
{
const char * V_189 ;
int V_190 , V_191 ;
...
V_11 -> V_81 = F_100 ( V_11 -> V_73 . V_75 ,
V_11 -> V_73 . V_80 ) ;
if ( ! V_11 -> V_81 ) {
V_49 = - V_85 ;
goto V_242;
...
V_7 -> V_246 = F_101 ( V_11 -> V_73 . V_243 , V_11 -> V_73 . V_244 ) ;
if ( ! V_7 -> V_246 ) {
F_12 ( V_38 , L_58 ) ;
V_49 = - V_85 ;
goto V_247;
...
F_17 ( V_7 ) ;
V_49 = F_102 ( V_7 -> V_239 , F_54 , 0 , V_3 -> V_234 , V_11 ) ;
if ( V_49 ) {
F_12 ( V_38 , L_59 , V_49 ) ;
goto V_248;
}
F_103 ( & V_7 -> V_177 , F_56 ) ;
V_49 = F_58 ( V_7 ) ;
if ( V_49 < 0 ) {
F_12 ( V_38 , L_60 , V_49 ) ;
goto V_249;
...
V_249:
F_107 ( & V_7 -> V_177 ) ;
F_108 ( V_7 -> V_239 , V_11 ) ;
V_248:
F_14 ( V_7 ) ;
F_109 ( V_7 -> V_246 ) ;
V_247:
F_110 ( V_11 -> V_73 . V_243 , V_11 -> V_73 . V_244 ) ;
V_245:
if ( V_219 )
F_109 ( V_11 -> V_81 ) ;
else
...
V_242:
if ( V_219 )
F_110 ( V_11 -> V_73 . V_75 , V_11 -> V_73 . V_80 ) ;
V_238:
F_63 ( V_7 ) ;
F_111 ( V_7 -> V_91 ) ;
V_235:
...
static int T_4 F_113 ( struct V_2 * V_3 )
{
struct V_79 * V_38 = & V_3 -> V_38 ;
struct V_10 * V_11 = F_114 ( V_38 ) ;
struct V_6 * V_7 ;
struct V_43 * V_44 ;
if ( ! V_11 || ! V_11 -> V_71 )
return 0 ;
...
static int F_116 ( struct V_2 * V_3 , T_5 V_252 )
{
struct V_10 * V_11 = F_117 ( V_3 ) ;
struct V_6 * V_7 = V_11 -> V_71 ;
F_4 ( V_7 , V_156 , ~ 0UL ) ;
