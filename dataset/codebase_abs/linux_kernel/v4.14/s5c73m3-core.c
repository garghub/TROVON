...
if ( V_223 . V_230 . V_231 . V_232 != V_233 )
F_99 ( V_66 , L_47 ) ;
return 0 ;
}
static int F_105 ( struct V_12 * V_13 ,
const struct V_234 * V_185 )
{
...
struct V_30 * V_31 ;
int V_17 , V_100 ;
V_31 = F_106 ( V_66 , sizeof( * V_31 ) , V_235 ) ;
if ( ! V_31 )
return - V_236 ;
V_31 -> V_12 = V_13 ;
V_17 = F_94 ( V_31 ) ;
...
V_193 = & V_31 -> V_193 ;
F_108 ( V_61 , & V_237 ) ;
V_61 -> V_238 = V_13 -> V_66 . V_239 -> V_238 ;
F_109 ( V_61 , V_31 ) ;
F_110 ( V_61 -> V_178 , L_48 , sizeof( V_61 -> V_178 ) ) ;
V_61 -> V_240 = & V_241 ;
V_61 -> V_25 |= V_242 ;
V_31 -> V_243 [ V_155 ] . V_25 = V_244 ;
V_31 -> V_243 [ V_139 ] . V_25 = V_244 ;
V_61 -> V_200 . V_245 = V_246 ;
V_17 = F_111 ( & V_61 -> V_200 , V_168 ,
V_31 -> V_243 ) ;
if ( V_17 < 0 )
return V_17 ;
F_112 ( V_193 , V_13 , & V_247 ) ;
strcpy ( V_193 -> V_178 , L_49 ) ;
V_193 -> V_240 = & V_248 ;
V_193 -> V_25 |= V_242 ;
V_31 -> V_249 [ V_131 ] . V_25 = V_250 ;
V_31 -> V_249 [ V_134 ] . V_25 = V_250 ;
V_31 -> V_249 [ V_135 ] . V_25 = V_244 ;
V_193 -> V_200 . V_245 = V_251 ;
V_17 = F_111 ( & V_193 -> V_200 , V_252 ,
V_31 -> V_249 ) ;
if ( V_17 < 0 )
return V_17 ;
V_17 = F_89 ( V_31 ) ;
...
goto V_253;
for ( V_100 = 0 ; V_100 < V_188 ; V_100 ++ )
V_31 -> V_189 [ V_100 ] . V_198 = V_254 [ V_100 ] ;
