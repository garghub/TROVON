...
const char * V_10 , T_2 V_41 )
{
struct V_64 * V_65 = F_38 ( V_7 ) ;
struct V_66 * V_67 = F_4 ( V_9 , struct V_66 , V_9 ) ;
struct V_14 * V_15 = F_39 ( V_65 ) ;
T_3 V_68 ;
if ( V_41 != 1 && ( V_41 != 2 || V_10 [ 1 ] != '\n' ) )
return - V_69 ;
F_10 ( & V_15 -> V_33 ) ;
V_68 = F_40 ( V_15 -> V_70 + V_71 ) ;
if ( V_10 [ 0 ] == '1' ) {
V_68 |= 1 << V_67 -> V_72 ;
F_41 ( V_68 , V_15 -> V_70 + V_71 ) ;
} else if ( V_10 [ 0 ] == '0' ) {
V_68 &= ~ ( 1 << V_67 -> V_72 ) ;
F_41 ( V_68 , V_15 -> V_70 + V_71 ) ;
} else {
...
static int F_44 ( struct V_14 * V_15 , int V_73 )
{
...
if ( F_45 ( & V_75 , V_76 , & V_15 -> V_7 -> V_7 ) )
return - V_86 ;
F_24 ( & V_15 -> V_7 -> V_7 , L_26 ) ;
F_41 ( V_87 , V_15 -> V_70 + V_88 ) ;
V_78 = V_75 -> V_27 / V_77 ;
F_24 ( & V_15 -> V_7 -> V_7 , L_27 , V_75 -> V_27 ) ;
F_24 ( & V_15 -> V_7 -> V_7 , L_28 , V_78 ) ;
F_24 ( & V_15 -> V_7 -> V_7 , L_29 ) ;
F_41 ( 1 , V_15 -> V_70 + V_89 ) ;
( void ) F_40 ( V_15 -> V_70 + V_89 ) ;
if( V_73 == 0 || V_73 == 2 )
F_24 ( & V_15 -> V_7 -> V_7 , L_30 ) ;
if( V_73 == 1 || V_73 == 3 )
F_24 ( & V_15 -> V_7 -> V_7 , L_31 ) ;
F_41 ( ( V_73 * 2 ) , V_15 -> V_70 + V_90 ) ;
F_41 ( 1 , V_15 -> V_70 + V_91 ) ;
F_46 ( V_15 -> V_92 , ! F_40 ( V_15 -> V_70 + V_93 ) ) ;
for ( V_72 = 0 ; V_72 < V_75 -> V_27 ; V_72 += V_77 ) {
int V_43 ;
F_41 ( 0 , V_15 -> V_70 + V_91 ) ;
F_41 ( ( ( V_73 * 2 ) + 1 ) , V_15 -> V_70 + V_90 ) ;
for( V_43 = 0 ; V_43 < V_77 ; V_43 += 4 ) {
T_3 V_94 ;
if ( V_15 -> V_79 )
V_94 = F_47 ( ( T_3 * ) ( V_75 -> V_40 + V_72 + V_43 ) ) ;
else
V_94 = * ( T_3 * ) ( V_75 -> V_40 + V_72 + V_43 ) ;
if( V_15 -> V_83 > V_84 )
F_41 ( V_94 , V_95 + V_43 ) ;
else
F_41 ( V_94 , F_48 ( V_15 , 3 ) + V_43 ) ;
}
F_41 ( V_72 / V_77 , V_15 -> V_70 + V_96 ) ;
F_41 ( 1 , V_15 -> V_70 + V_91 ) ;
F_46 ( V_15 -> V_92 , ! F_40 ( V_15 -> V_70 + V_93 ) ) ;
}
F_49 ( V_75 ) ;
F_41 ( 0 , V_15 -> V_70 + V_91 ) ;
F_41 ( 0 , V_15 -> V_70 + V_89 ) ;
F_41 ( 0 , V_15 -> V_70 + V_90 ) ;
F_24 ( & V_15 -> V_7 -> V_7 , L_32 ) ;
return 0 ;
}
static T_4 F_50 ( int V_97 , void * V_98 )
{
struct V_14 * V_15 = V_98 ;
int V_99 = 1 ;
F_41 ( 0 , V_15 -> V_70 + V_100 ) ;
if ( V_15 -> V_12 [ 0 ] )
F_51 ( & V_15 -> V_101 ) ;
else
F_28 ( & V_15 -> V_92 ) ;
...
F_55 ( & V_15 -> V_7 -> V_7 , F_56 ( V_4 ) -> V_109 ,
V_110 , V_111 ) ;
V_20 = ( void * ) V_4 -> V_40 ;
V_27 = F_57 ( V_20 -> V_27 ) ;
...
V_20 = & V_106 ;
V_104 |= 0x10 << V_32 ;
F_58 ( V_20 , F_48 ( V_15 , V_32 ) , sizeof( * V_20 ) ) ;
V_27 = F_57 ( V_20 -> V_27 ) ;
if ( V_27 > ( V_15 -> V_112 - sizeof( * V_20 ) ) ) {
F_6 ( & V_15 -> V_7 -> V_7 , L_33 ) ;
continue;
}
V_4 = F_59 ( NULL , V_27 + 1 ) ;
if ( ! V_4 ) {
if ( F_60 () )
...
switch ( F_57 ( V_20 -> type ) ) {
case V_114 :
V_2 = F_62 ( V_15 -> V_12 [ V_32 ] , F_57 ( V_20 -> V_28 ) ,
F_57 ( V_20 -> V_29 ) ) ;
if ( ! V_2 ) {
if ( F_60 () )
F_6 ( & V_15 -> V_7 -> V_7 , L_37 ,
F_57 ( V_20 -> V_28 ) , F_57 ( V_20 -> V_29 ) ,
V_32 ) ;
F_2 ( V_4 ) ;
break;
}
...
break;
F_31 ( & V_15 -> V_60 ) ;
if ( F_65 ( & V_15 -> V_61 [ V_32 ] ) > 10 ) {
if ( F_60 () )
F_6 ( & V_15 -> V_7 -> V_7 , L_39 ,
V_32 ) ;
F_2 ( V_4 ) ;
} else
F_66 ( & V_15 -> V_61 [ V_32 ] , V_4 ) ;
F_33 ( & V_15 -> V_60 ) ;
break;
}
}
...
! V_15 -> V_108 [ V_32 ] ) {
struct V_3 * V_4 = F_67 ( V_110 ) ;
if ( V_4 ) {
F_56 ( V_4 ) -> V_109 =
F_68 ( & V_15 -> V_7 -> V_7 , V_4 -> V_40 ,
V_110 , V_111 ) ;
F_41 ( F_56 ( V_4 ) -> V_109 ,
V_15 -> V_70 + F_69 ( V_32 ) ) ;
V_15 -> V_108 [ V_32 ] = V_4 ;
...
if ( V_104 )
F_41 ( V_104 , V_15 -> V_70 + V_120 ) ;
return;
}
static struct V_1 * F_62 ( struct V_11 * V_7 , short V_28 , int V_29 )
{
struct V_121 * V_122 ;
struct V_1 * V_2 = NULL ;
struct V_123 * V_124 ;
...
struct V_19 * V_20 ;
F_31 ( & V_15 -> V_139 ) ;
F_78 (&card->tx_queue[port], skb, tmpskb) {
if ( F_56 ( V_4 ) -> V_2 == V_2 ) {
F_79 ( V_4 , & V_15 -> V_140 [ V_32 ] ) ;
F_1 ( V_2 , V_4 ) ;
}
}
F_33 ( & V_15 -> V_139 ) ;
...
if ( ! F_14 ( V_15 -> V_36 , ! F_81 ( V_4 ) , 5 * V_37 ) )
F_6 ( & V_15 -> V_7 -> V_7 ,
L_44 , V_32 ) ;
F_82 ( V_4 ) ;
F_83 ( & V_15 -> V_101 ) ;
...
static int F_61 ( struct V_3 * V_10 )
{
int V_39 , V_43 ;
char V_142 [ 500 ] ;
char V_143 [ 10 ] ;
...
V_145 = F_65 ( & V_15 -> V_140 [ V_32 ] ) ;
F_66 ( & V_15 -> V_140 [ V_32 ] , V_4 ) ;
if ( ! V_145 )
V_15 -> V_146 |= ( 1 << V_32 ) ;
...
static T_3 F_54 ( struct V_14 * V_15 )
{
T_3 V_147 , V_103 ;
T_3 V_148 = 0 ;
struct V_3 * V_4 ;
...
F_33 ( & V_15 -> V_139 ) ;
if ( V_4 && ! V_15 -> V_107 ) {
F_86 ( F_87 ( V_15 , V_32 ) , V_4 -> V_40 , V_4 -> V_39 ) ;
V_148 |= 1 << V_32 ;
V_150 = V_4 ;
...
F_56 ( V_4 ) -> V_109 = F_68 ( & V_15 -> V_7 -> V_7 , V_40 ,
V_4 -> V_39 , V_152 ) ;
V_15 -> V_151 [ V_32 ] = V_4 ;
F_41 ( F_56 ( V_4 ) -> V_109 ,
V_15 -> V_70 + F_88 ( V_32 ) ) ;
...
int V_157 = 0 ;
int V_42 ;
if ( F_92 ( V_4 ) < sizeof( * V_20 ) )
V_157 = sizeof( * V_20 ) - F_92 ( V_4 ) ;
V_42 = F_93 ( V_4 , V_157 , 0 , V_63 ) ;
if ( V_42 ) {
...
static int F_95 ( struct V_64 * V_7 , const struct V_158 * V_159 )
{
int V_52 ;
T_5 V_160 ;
T_6 V_161 , V_162 ;
...
V_15 -> V_70 = F_102 ( V_7 , 0 , V_163 ) ;
if ( ! V_15 -> V_70 ) {
F_6 ( & V_7 -> V_7 , L_56 ) ;
V_52 = - V_24 ;
goto V_164;
}
V_15 -> V_165 = F_102 ( V_7 , 1 , V_166 ) ;
if ( ! V_15 -> V_165 ) {
F_6 ( & V_7 -> V_7 , L_57 ) ;
V_52 = - V_24 ;
goto V_167;
...
if ( 1 ) {
V_15 -> V_153 = 3 ;
V_15 -> V_154 = F_105 ( V_15 -> V_105 * V_62 , V_23 ) ;
if ( ! V_15 -> V_154 ) {
...
V_15 -> V_107 = 0 ;
F_41 ( 0xF0 , V_15 -> V_70 + V_120 ) ;
}
F_106 ( V_7 , V_15 ) ;
F_107 ( & V_15 -> V_101 , F_53 , ( unsigned long ) V_15 ) ;
F_108 ( & V_15 -> V_149 ) ;
F_108 ( & V_15 -> V_139 ) ;
F_108 ( & V_15 -> V_60 ) ;
F_108 ( & V_15 -> V_33 ) ;
F_109 ( & V_15 -> V_35 ) ;
V_52 = F_110 ( V_7 -> V_97 , F_50 , V_178 ,
L_61 , V_15 ) ;
if ( V_52 ) {
F_22 ( & V_15 -> V_7 -> V_7 , L_62 , V_7 -> V_97 ) ;
goto V_177;
}
F_41 ( 1 , V_15 -> V_70 + V_179 ) ;
if ( V_171 )
F_44 ( V_15 , 0 ) ;
if ( V_172 )
F_44 ( V_15 , 1 ) ;
...
if ( V_174 )
F_44 ( V_15 , 3 ) ;
V_52 = F_111 ( V_15 , & V_7 -> V_7 ) ;
if ( V_52 )
goto V_180;
if ( V_15 -> V_83 >= V_176 &&
F_112 ( & V_15 -> V_7 -> V_7 . V_181 , & V_182 ) )
F_113 ( & V_15 -> V_7 -> V_7 , L_63 ) ;
return 0 ;
V_180:
F_41 ( 0 , V_15 -> V_70 + V_179 ) ;
F_114 ( V_7 -> V_97 , V_15 ) ;
F_115 ( & V_15 -> V_101 ) ;
V_177:
F_116 ( V_15 -> V_154 ) ;
F_117 ( V_7 , V_15 -> V_165 ) ;
V_167:
F_117 ( V_7 , V_15 -> V_70 ) ;
V_164:
F_118 ( V_7 ) ;
...
static int F_111 ( struct V_14 * V_15 , struct V_6 * V_183 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < V_15 -> V_105 ; V_43 ++ ) {
struct V_3 * V_4 ;
struct V_19 * V_20 ;
F_119 ( & V_15 -> V_140 [ V_43 ] ) ;
F_119 ( & V_15 -> V_61 [ V_43 ] ) ;
V_15 -> V_12 [ V_43 ] = F_120 ( L_61 , V_183 , & V_184 , - 1 , NULL ) ;
if ( ! V_15 -> V_12 [ V_43 ] ) {
F_113 ( & V_15 -> V_7 -> V_7 , L_64 , V_43 ) ;
F_121 ( V_15 ) ;
return - V_53 ;
}
if ( F_122 ( & V_15 -> V_12 [ V_43 ] -> V_13 , & V_185 ) )
F_113 ( & V_15 -> V_7 -> V_7 , L_65 , V_43 ) ;
if ( F_112 ( & V_15 -> V_12 [ V_43 ] -> V_13 . V_181 , & V_186 ) )
F_113 ( & V_15 -> V_7 -> V_7 , L_66 , V_43 ) ;
...
F_123 ( & V_15 -> V_12 [ V_43 ] -> V_13 . V_181 , & V_186 ) ;
F_124 ( V_15 -> V_12 [ V_43 ] ) ;
V_4 = V_15 -> V_108 [ V_43 ] ;
if ( V_4 ) {
F_55 ( & V_15 -> V_7 -> V_7 , F_56 ( V_4 ) -> V_109 ,
V_110 , V_111 ) ;
...
static void F_125 ( struct V_64 * V_7 )
{
struct V_14 * V_15 = F_39 ( V_7 ) ;
F_41 ( 0 , V_15 -> V_70 + V_179 ) ;
F_41 ( 1 , V_15 -> V_70 + V_89 ) ;
( void ) F_40 ( V_15 -> V_70 + V_89 ) ;
if ( V_15 -> V_83 >= V_176 )
F_123 ( & V_15 -> V_7 -> V_7 . V_181 , & V_182 ) ;
F_121 ( V_15 ) ;
F_114 ( V_7 -> V_97 , V_15 ) ;
F_115 ( & V_15 -> V_101 ) ;
F_116 ( V_15 -> V_154 ) ;
...
{
F_128 ( sizeof( struct V_192 ) > sizeof( ( (struct V_3 * ) 0 ) -> V_193 ) ) ;
F_85 ( V_194 L_70 , V_195 ) ;
return F_129 ( & V_196 ) ;
}
static void T_8 F_130 ( void )
{
F_131 ( & V_196 ) ;
F_85 ( V_194 L_71 , V_195 ) ;
}
