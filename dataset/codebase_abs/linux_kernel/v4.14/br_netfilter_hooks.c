...
static int F_70 ( struct V_22 * V_22 , struct V_39 * V_40 , struct V_1 * V_2 )
{
struct V_14 * V_8 = F_34 ( V_2 ) ;
struct V_9 * V_82 ;
...
static unsigned int F_74 ( void * V_76 ,
struct V_1 * V_2 ,
const struct V_77 * V_78 )
{
struct V_14 * V_8 ;
...
if ( V_97 == V_99 ) {
if ( F_75 ( V_78 -> V_22 , V_2 ) )
return V_81 ;
F_73 ( V_2 ) -> V_59 = V_8 -> V_59 ;
}
V_8 -> V_100 = V_2 -> V_10 ;
if ( V_97 == V_89 )
V_2 -> V_3 = F_3 ( V_88 ) ;
...
V_78 -> V_82 , V_78 -> V_98 , F_70 ) ;
return V_91 ;
}
static int F_78 ( struct V_22 * V_22 , struct V_39 * V_40 , struct V_1 * V_2 )
{
struct V_108 * V_109 ;
int V_58 ;
V_109 = F_79 ( & V_110 ) ;
V_58 = F_80 ( V_2 , V_109 -> V_111 ) ;
if ( V_58 ) {
F_39 ( V_2 ) ;
return 0 ;
}
...
F_81 ( V_2 , - V_109 -> V_111 , V_109 -> V_113 , V_109 -> V_111 ) ;
F_82 ( V_2 , V_109 -> V_114 ) ;
F_7 ( V_2 ) ;
return F_83 ( V_22 , V_40 , V_2 ) ;
}
static int
F_84 ( struct V_22 * V_22 , struct V_39 * V_40 , struct V_1 * V_2 ,
int (* V_53)( struct V_22 * , struct V_39 * , struct V_1 * ) )
{
unsigned int V_115 = F_85 ( V_40 , V_2 ) ;
struct V_23 * V_24 = F_23 ( V_2 ) ;
...
return F_87 ( V_22 , V_40 , V_2 , V_53 ) ;
}
...
static int F_89 ( struct V_22 * V_22 , struct V_39 * V_40 , struct V_1 * V_2 )
{
struct V_14 * V_8 = F_34 ( V_2 ) ;
unsigned int V_115 , V_121 ;
V_121 = F_88 ( V_2 ) ;
V_115 = V_2 -> V_10 -> V_115 ;
if ( V_8 -> V_59 && V_8 -> V_59 < V_115 )
V_115 = V_8 -> V_59 ;
if ( F_90 ( V_2 ) || V_2 -> V_20 + V_121 <= V_115 ) {
F_7 ( V_2 ) ;
return F_83 ( V_22 , V_40 , V_2 ) ;
}
if ( F_91 ( V_122 ) &&
...
V_109 -> V_111 ) ;
return F_84 ( V_22 , V_40 , V_2 , F_78 ) ;
}
if ( F_91 ( V_123 ) &&
V_2 -> V_3 == F_3 ( V_92 ) ) {
const struct V_124 * V_125 = F_92 () ;
struct V_108 * V_109 ;
if ( F_75 ( V_22 , V_2 ) )
goto V_31;
F_73 ( V_2 ) -> V_59 = V_8 -> V_59 ;
...
V_109 -> V_111 ) ;
if ( V_125 )
return V_125 -> V_126 ( V_22 , V_40 , V_2 , F_78 ) ;
F_39 ( V_2 ) ;
return - V_120 ;
}
F_7 ( V_2 ) ;
...
static unsigned int F_93 ( void * V_76 ,
struct V_1 * V_2 ,
const struct V_77 * V_78 )
{
struct V_14 * V_8 = F_34 ( V_2 ) ;
...
static unsigned int F_94 ( void * V_76 ,
struct V_1 * V_2 ,
const struct V_77 * V_78 )
{
...
F_18 ( V_2 , V_6 ) ;
V_8 -> V_52 = 0 ;
F_96 ( sizeof( V_8 -> V_51 ) != ( V_6 - V_50 ) ) ;
F_81 ( V_2 , - ( V_6 - V_50 ) ,
V_8 -> V_51 ,
V_6 - V_50 ) ;
V_2 -> V_10 = V_8 -> V_49 ;
V_8 -> V_100 = NULL ;
F_36 ( F_97 ( V_2 -> V_10 ) , NULL , V_2 ) ;
}
...
static int F_100 ( struct V_130 * V_131 , unsigned long V_132 ,
void * V_133 )
{
struct V_9 * V_10 = F_101 ( V_133 ) ;
struct V_134 * V_135 ;
struct V_22 * V_22 ;
int V_46 ;
...
F_102 () ;
V_22 = F_97 ( V_10 ) ;
V_135 = F_103 ( V_22 , V_140 ) ;
if ( V_135 -> V_141 )
return V_142 ;
V_46 = F_104 ( V_22 , V_143 , F_105 ( V_143 ) ) ;
if ( V_46 )
return V_144 ;
V_135 -> V_141 = true ;
return V_142 ;
}
static void T_5 F_106 ( struct V_22 * V_22 )
{
struct V_134 * V_135 = F_103 ( V_22 , V_140 ) ;
if ( ! V_135 -> V_141 )
return;
F_107 ( V_22 , V_143 , F_105 ( V_143 ) ) ;
V_135 -> V_141 = false ;
}
...
unsigned int V_152 ;
int V_46 ;
V_149 = F_108 ( V_22 -> V_153 . V_154 [ V_155 ] [ V_145 ] ) ;
if ( ! V_149 )
return V_129 ( V_22 , V_40 , V_2 ) ;
V_151 = F_109 ( V_149 ) ;
for ( V_152 = 0 ; V_152 < V_149 -> V_156 &&
V_151 [ V_152 ] -> V_157 <= V_158 ; V_152 ++ )
;
F_110 ( & V_78 , V_145 , V_155 , V_146 , V_147 ,
V_40 , V_22 , V_129 ) ;
V_46 = F_111 ( V_2 , & V_78 , V_149 , V_152 ) ;
if ( V_46 == 1 )
V_46 = V_129 ( V_22 , V_40 , V_2 ) ;
return V_46 ;
}
static
int F_112 ( struct V_159 * V_160 , int V_161 ,
void T_6 * V_162 , T_7 * V_163 , T_8 * V_164 )
{
int V_46 ;
V_46 = F_113 ( V_160 , V_161 , V_162 , V_163 , V_164 ) ;
if ( V_161 && * ( int * ) ( V_160 -> V_109 ) )
* ( int * ) ( V_160 -> V_109 ) = 1 ;
return V_46 ;
}
