...
T_1 V_11 , V_12 ;
F_1 ( V_10 , & V_4 ) ;
V_12 = ( V_4 . V_13 - V_10 -> V_14 ) << ( 10 - V_10 -> V_15 - V_10 -> V_16 ) ;
V_12 -= ( V_10 -> V_17 >> V_10 -> V_15 ) ;
V_11 = ( T_1 ) ( V_4 . V_18 - V_10 -> V_19 ) << ( 10 - V_10 -> V_15 - V_10 -> V_16 ) ;
V_11 -= ( V_10 -> V_20 >> V_10 -> V_15 ) ;
F_6 ( & V_10 -> V_21 ) ;
V_10 -> V_17 += V_12 ;
V_10 -> V_20 += V_11 ;
F_7 ( & V_10 -> V_21 ) ;
V_10 -> V_14 = V_4 . V_13 ;
V_10 -> V_19 = V_4 . V_18 ;
V_10 -> V_22 += ( ( V_23 / 4 ) << V_10 -> V_16 ) ;
if ( F_8 ( F_9 ( V_24 , V_10 -> V_22 ) ) ) {
V_10 -> V_22 = V_24 + 1 ;
}
F_10 ( & V_10 -> V_25 , V_10 -> V_22 ) ;
}
...
do {
V_21 = F_30 ( & V_10 -> V_21 ) ;
V_40 -> V_41 = V_10 -> V_17 >> 8 ;
V_40 -> V_42 = V_10 -> V_20 >> 8 ;
} while ( F_31 ( & V_10 -> V_21 , V_21 ) );
F_29 () ;
return true ;
}
