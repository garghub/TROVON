...
{
F_16 ( & V_2 -> V_34 -> V_2 , L_3 , V_2 -> V_47 ) ;
F_20 ( V_2 -> V_48 ) ;
F_21 ( V_2 -> V_49 ) ;
F_20 ( V_2 -> V_36 ) ;
F_20 ( V_2 ) ;
...
break;
case V_72 :
if ( F_9 ( & V_2 -> V_45 ) == V_73 ) {
if ( V_50 -> V_58 & V_59 ) {
V_28 = - V_60 ;
goto exit;
} else {
V_28 = F_24 ( V_2 -> V_46 ,
( ! V_2 -> V_55 || ( F_9 ( & V_2 -> V_45 ) < V_73 ) ) ) ;
if ( V_28 ) {
V_28 = - V_62 ;
goto exit;
}
...
static long F_38 ( struct V_50 * V_50 , unsigned int V_85 ,
unsigned long V_86 )
{
...
V_94 . V_98 = F_40 ( V_2 -> V_78 -> V_99 . V_100 ) ;
V_94 . V_101 = V_2 -> V_67 ;
V_94 . V_102 = F_40 ( V_2 -> V_78 -> V_99 . V_103 ) ;
V_94 . V_104 = V_2 -> V_78 -> V_104 ;
...
static int F_41 ( struct V_111 * V_111 , struct V_50 * V_50 )
{
struct V_21 * V_2 = NULL ;
struct V_16 * V_34 ;
int V_112 ;
...
if ( ( V_28 = F_13 ( V_2 -> V_49 , V_75 ) ) < 0 ) {
F_14 ( & V_34 -> V_2 , L_11 , V_28 ) ;
V_28 = - V_63 ;
goto V_117;
}
++ V_2 -> V_74 ;
...
static int F_46 ( struct V_111 * V_111 , struct V_50 * V_50 )
{
struct V_21 * V_2 ;
int V_28 = 0 ;
V_2 = V_50 -> V_54 ;
...
static unsigned F_48 ( struct V_50 * V_50 , T_6 * V_118 )
{
struct V_21 * V_2 = V_50 -> V_54 ;
unsigned int V_119 = 0 ;
if ( ! V_2 -> V_55 )
return V_120 | V_121 ;
F_49 ( V_50 , & V_2 -> V_40 , V_118 ) ;
F_49 ( V_50 , & V_2 -> V_46 , V_118 ) ;
if ( ! V_2 -> V_55 )
return V_120 | V_121 ;
if ( F_22 ( V_2 ) != - 1 )
V_119 |= V_122 | V_123 ;
...
static char * F_50 ( struct V_126 * V_2 , T_7 * V_127 )
{
return F_51 ( V_75 , L_12 , F_52 ( V_2 ) ) ;
}
static int F_53 ( struct V_16 * V_34 ,
...
int V_28 = - V_76 ;
int V_130 ;
V_2 = F_39 ( sizeof( struct V_21 ) , V_75 ) ;
if ( ! V_2 )
return V_28 ;
F_54 ( & V_2 -> V_66 ) ;
F_11 ( & V_2 -> V_23 , 0 ) ;
...
V_2 -> V_34 = V_34 ;
V_129 = V_34 -> V_19 ;
V_2 -> V_67 = F_40 ( V_78 -> V_99 . V_131 ) ;
V_130 = F_57 ( V_129 , & V_2 -> V_132 ) ;
if ( V_130 ) {
F_14 ( & V_34 -> V_2 , L_13 ) ;
V_28 = V_130 ;
goto error;
...
V_2 -> V_35 = F_59 ( V_2 -> V_132 ) ;
if ( ( V_2 -> V_34 -> V_19 -> V_12 . V_13 == 0 ) &&
( V_2 -> V_67 == V_72 ) )
V_2 -> V_35 = 7 ;
V_2 -> V_49 = F_32 ( 0 , V_75 ) ;
if ( ! V_2 -> V_49 )
goto error;
V_2 -> V_48 = F_60 ( V_2 -> V_35 , V_75 ) ;
if ( ! V_2 -> V_48 )
goto error;
F_34 ( V_2 -> V_49 , V_2 -> V_78 ,
F_61 ( V_2 -> V_78 ,
V_2 -> V_132 -> V_81 ) ,
V_2 -> V_48 , V_2 -> V_35 ,
F_7 , V_2 ,
V_2 -> V_132 -> V_82 ) ;
V_2 -> V_36 =
F_60 ( ( ( V_2 -> V_35 + 1 ) * V_33 ) ,
V_75 ) ;
if ( ! V_2 -> V_36 )
goto error;
memset ( V_2 -> V_107 , 0x00 , sizeof( V_2 -> V_107 ) ) ;
F_62 ( V_78 , V_78 -> V_99 . V_133 , V_2 -> V_107 ,
sizeof( V_2 -> V_107 ) ) ;
...
V_2 -> V_47 = V_34 -> V_47 ;
F_65 ( & V_34 -> V_2 , L_16
L_17 , V_2 -> V_67 , V_2 -> V_107 ,
V_129 -> V_12 . V_13 , V_2 -> V_47 - V_136 ) ;
return V_28 ;
error:
F_19 ( V_2 ) ;
return V_28 ;
}
static void F_66 ( struct V_16 * V_34 )
{
struct V_21 * V_2 ;
int V_47 ;
V_2 = F_45 ( V_34 ) ;
