...
if ( V_116 ) {
for ( V_38 = 0 ; V_38 < V_116 -> V_149 . V_2 ; V_38 ++ ) {
int V_273 = V_116 -> V_149 . V_183 [ V_38 ] [ 0 ] ;
int V_274 = V_116 -> V_149 . V_183 [ V_38 ] [ 1 ] ;
int V_275 = - 1 ;
bool V_276 = false ;
for ( V_23 = 0 ; V_23 < V_270 -> V_18 ; V_23 ++ ) {
int V_180 = V_270 -> V_179 [ V_23 ] ;
if ( V_180 == V_274 ) {
V_276 = true ;
break;
}
if ( V_180 == V_273 && V_275 < 0 &&
! ( V_274 != V_214 &&
V_274 < V_260 -> V_160 &&
V_260 -> V_153 [ V_274 ] == 0 ) ) {
V_275 = V_23 ;
...
if ( ! V_260 -> V_155 )
return;
for ( V_38 = 0 ; V_38 < V_277 -> V_18 ; V_38 ++ ) {
int V_180 = V_277 -> V_179 [ V_38 ] ;
if ( V_180 != V_214 &&
V_260 -> V_155 [ V_180 ] !=
V_163 ) {
break;
...
if ( V_275 < 0 )
return;
V_277 -> V_212 = V_277 -> V_179 [ V_275 ] ;
if ( F_144 ( V_9 ) && V_275 > 0 ) {
for ( V_38 = V_275 ; V_38 > 0 ; V_38 -- )
V_277 -> V_179 [ V_38 ] = V_277 -> V_179 [ V_38 - 1 ] ;
V_277 -> V_179 [ 0 ] = V_277 -> V_212 ;
}
}
...
if ( F_144 ( V_9 ) )
continue;
V_279 -> V_179 [ V_279 -> V_18 ++ ] = V_214 ;
} else {
V_279 -> V_179 [ V_279 -> V_18 ++ ] = V_116 -> V_146 . V_179 [ V_38 ] ;
}
}
for ( V_38 = 0 ; V_38 < V_279 -> V_18 ; V_38 ++ ) {
if ( V_279 -> V_179 [ V_38 ] != V_214 ) {
V_279 -> V_212 = V_279 -> V_179 [ V_38 ] ;
break;
}
}
}
...
F_146 ( V_260 , V_9 , V_255 , V_277 , & V_272 ) ;
F_151 ( V_260 , & V_112 , V_277 ) ;
F_152 ( V_260 , V_9 , V_277 ) ;
F_154 ( V_260 , V_9 , V_272 , V_277 ) ;
F_155 ( V_260 , V_9 , & V_112 , V_233 ) ;
if ( ! V_233 -> V_18 ) {
memcpy ( V_233 -> V_179 , V_277 -> V_179 , V_277 -> V_18 * sizeof( V_277 -> V_179 [ 0 ] ) ) ;
V_233 -> V_18 = V_277 -> V_18 ;
if ( V_233 -> V_212 == - 1 )
V_233 -> V_212 = V_277 -> V_212 ;
}
F_18 ( ! F_121 ( V_277 ) || ! F_121 ( V_233 ) ) ;
}
...
F_156 ( V_260 , V_9 , & V_112 , & V_277 , & V_233 ) ;
for ( V_38 = 0 ; V_38 < V_233 . V_18 ; V_38 ++ ) {
...
if ( ! V_9 )
return - 1 ;
F_156 ( V_260 , V_9 , V_255 , & V_277 , & V_233 ) ;
return V_233 . V_212 ;
}
