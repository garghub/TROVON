...
static void V_41 ( struct V_98 * V_32 )
{
struct V_1 * V_2 ;
...
void F_121 ( struct V_1 * V_2 , char * V_108 , char * V_109 )
{
int V_4 ;
int V_51 ;
unsigned long V_110 = 0 , V_111 = 0 ;
V_51 = V_2 -> V_37 & 0x1 ;
F_122 ( L_4 , V_108 , V_109 , V_51 ) ;
F_8 (cpu) {
unsigned long V_112 , V_113 ;
unsigned long V_114 , V_115 ;
long V_116 , V_117 ;
struct V_9 * V_118 ;
V_118 = F_9 ( V_2 -> V_26 , V_4 ) ;
V_114 = V_118 -> V_25 [ ! V_51 ] ;
V_115 = V_118 -> V_25 [ V_51 ] ;
F_123 () ;
V_112 = V_118 -> V_24 [ ! V_51 ] ;
V_113 = V_118 -> V_24 [ V_51 ] ;
V_116 = V_112 - V_114 ;
V_117 = V_113 - V_115 ;
F_124 ( L_5 , V_4 , V_116 , V_117 ) ;
V_110 += V_116 ;
V_111 += V_117 ;
}
F_124 ( L_6 , V_110 , V_111 ) ;
}
