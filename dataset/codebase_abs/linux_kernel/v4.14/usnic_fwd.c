...
void F_17 ( struct V_1 * V_2 , T_2 V_20 )
{
F_7 ( & V_2 -> V_11 ) ;
if ( ! V_2 -> V_20 )
V_2 -> V_20 = V_20 ;
...
void F_21 ( struct V_1 * V_2 , unsigned int V_22 )
{
F_7 ( & V_2 -> V_11 ) ;
V_2 -> V_22 = V_22 ;
F_8 ( & V_2 -> V_11 ) ;
...
F_2 ( & V_2 -> V_11 ) ;
if ( V_24 -> type == V_25 ) {
if ( ! ( V_24 -> V_26 . V_27 . V_28 & V_29 ) )
return - V_30 ;
if ( ! ( V_24 -> V_26 . V_27 . V_28 & V_31 ) )
return - V_32 ;
else if ( V_2 -> V_20 == 0 )
return - V_33 ;
else if ( V_24 -> V_26 . V_27 . V_34 == 0 )
return - V_35 ;
else if ( F_24 ( V_2 -> V_20 ) != V_24 -> V_26 . V_27 . V_36 )
return - V_37 ;
else
return 0 ;
}
...
static void F_25 ( struct V_38 * V_39 , struct V_24 * V_24 ,
struct V_40 * V_41 )
{
V_39 -> type = V_42 ;
V_39 -> V_43 = sizeof( struct V_24 ) ;
* ( (struct V_24 * ) & V_39 -> V_44 ) = * V_24 ;
...
struct V_46 *
F_26 ( struct V_1 * V_2 , struct V_24 * V_24 ,
struct V_47 * V_48 )
{
struct V_38 * V_39 ;
struct V_15 * V_16 ;
...
int V_8 ;
V_16 = V_2 -> V_16 ;
V_50 = ( 2 * sizeof( struct V_38 ) + sizeof( struct V_24 ) +
sizeof( struct V_40 ) ) ;
