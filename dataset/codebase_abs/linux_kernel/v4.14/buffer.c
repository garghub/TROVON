...
F_186 ( & V_133 , 0 ) ;
while ( F_187 ( & V_133 , V_28 , & V_31 , V_134 ) ) {
V_135 = F_188 ( & V_133 ) ;
...
static inline int F_193 ( unsigned int V_75 )
{
return F_194 ( V_75 ) ;
}
static struct V_1 * F_195 ( struct V_11 * V_11 , struct V_25 * V_25 , unsigned int V_8 )
{
F_12 ( ! F_13 ( V_11 ) ) ;
if ( ! F_14 ( V_11 ) )
F_183 ( V_11 , 1 << F_196 ( V_25 -> V_34 ) , V_8 ) ;
return F_16 ( V_11 ) ;
}
int F_197 ( struct V_25 * V_25 , struct V_11 * V_11 ,
...
int V_142 = 0 ;
int V_143 = F_198 ( V_139 ) ;
V_14 = F_195 ( V_11 , V_25 ,
( 1 << V_144 ) | ( 1 << V_145 ) ) ;
V_2 = V_14 ;
V_75 = V_2 -> V_39 ;
V_141 = F_193 ( V_75 ) ;
...
void F_209 ( struct V_11 * V_11 , unsigned V_150 , unsigned V_151 )
{
...
if ( ! F_101 ( V_11 ) ) {
unsigned V_154 , V_90 ;
V_154 = F_210 ( V_150 , V_152 ) ;
V_90 = F_211 ( V_151 , V_153 ) - V_154 ;
...
if ( ! F_101 ( V_11 ) )
V_169 = 0 ;
F_209 ( V_11 , V_154 + V_169 , V_154 + V_131 ) ;
}
F_225 ( V_11 ) ;
...
V_14 = F_16 ( V_11 ) ;
V_75 = V_14 -> V_39 ;
V_151 = F_231 ( unsigned , V_94 - V_150 , V_135 ) ;
V_151 = V_150 + V_151 ;
...
struct V_25 * V_25 = V_11 -> V_71 -> V_82 ;
T_2 V_174 , V_175 ;
struct V_1 * V_2 , * V_14 , * V_176 [ V_177 ] ;
unsigned int V_75 , V_141 ;
int V_178 , V_115 ;
int V_179 = 1 ;
V_14 = F_195 ( V_11 , V_25 , 0 ) ;
V_75 = V_14 -> V_39 ;
V_141 = F_193 ( V_75 ) ;
V_174 = ( T_2 ) V_11 -> V_31 << ( V_33 - V_141 ) ;
V_175 = ( F_129 ( V_25 ) + V_75 - 1 ) >> V_141 ;
V_2 = V_14 ;
V_178 = 0 ;
V_115 = 0 ;
do {
...
V_176 [ V_178 ++ ] = V_2 ;
} while ( V_115 ++ , V_174 ++ , ( V_2 = V_2 -> V_15 ) != V_14 );
if ( V_179 )
F_233 ( V_11 ) ;
if ( ! V_178 ) {
if ( ! F_59 ( V_11 ) )
...
T_3 V_31 , V_182 ;
T_5 V_183 ;
unsigned V_184 , V_92 , V_131 ;
int V_60 = 0 ;
V_31 = V_161 >> V_33 ;
V_92 = V_161 & ~ V_185 ;
while ( V_31 > ( V_182 = ( V_183 = * V_181 ) >> V_33 ) ) {
V_184 = V_183 & ~ V_185 ;
if ( V_184 & ( V_75 - 1 ) ) {
* V_181 |= ( V_75 - 1 ) ;
( * V_181 ) ++ ;
...
V_131 = V_94 - V_184 ;
V_60 = F_236 ( V_168 , V_71 , V_183 , V_131 , 0 ,
& V_11 , & V_170 ) ;
if ( V_60 )
goto V_36;
F_212 ( V_11 , V_184 , V_131 ) ;
V_60 = F_237 ( V_168 , V_71 , V_183 , V_131 , V_131 ,
V_11 , V_170 ) ;
if ( V_60 < 0 )
goto V_36;
F_12 ( V_60 != V_131 ) ;
...
unsigned int V_184 ;
int V_60 ;
V_60 = F_238 ( V_168 , V_71 , V_161 , V_181 ) ;
if ( V_60 )
return V_60 ;
V_184 = * V_181 & ~ V_185 ;
if ( V_161 + V_131 > * V_181 && V_184 & ( V_75 - 1 ) ) {
* V_181 |= ( V_75 - 1 ) ;
( * V_181 ) ++ ;
}
...
int F_244 ( struct V_188 * V_189 , struct V_190 * V_191 ,
T_7 V_137 )
{
struct V_11 * V_11 = V_191 -> V_11 ;
struct V_25 * V_25 = F_245 ( V_189 -> V_192 ) ;
unsigned long V_134 ;
T_5 V_90 ;
int V_30 ;
F_189 ( V_11 ) ;
...
{
struct V_25 * V_25 = V_71 -> V_82 ;
const unsigned V_194 = V_25 -> V_34 ;
const unsigned V_75 = 1 << V_194 ;
struct V_1 * V_14 , * V_2 ;
struct V_11 * V_11 ;
T_3 V_31 ;
...
V_196 = ( T_2 ) V_11 -> V_31 << ( V_33 - V_194 ) ;
for ( V_152 = 0 , V_195 = 0 , V_2 = V_14 ;
V_152 < V_94 ;
V_195 ++ , V_152 += V_75 , V_2 = V_2 -> V_15 ) {
int V_200 ;
V_153 = V_152 + V_75 ;
V_2 -> V_8 = 0 ;
V_200 = 1 ;
...
const T_3 V_201 = V_172 >> V_33 ;
unsigned V_92 ;
int V_30 ;
if ( V_11 -> V_31 < V_201 )
goto V_36;
V_92 = V_172 & ( V_94 - 1 ) ;
if ( V_11 -> V_31 >= V_201 + 1 || ! V_92 ) {
#if 0
...
if ( V_30 == - V_202 )
V_30 = F_197 ( V_25 , V_11 , V_137 , V_139 ,
F_62 ) ;
return V_30 ;
}
...
V_203 . V_39 = V_75 ;
V_203 . V_8 = 0 ;
V_60 = V_137 ( V_25 , V_174 , & V_203 , 0 ) ;
if ( V_60 )
goto V_205;
if ( ! F_38 ( & V_203 ) )
goto V_205;
if ( ! F_101 ( V_11 ) ) {
V_60 = V_71 -> V_206 -> V_207 ( NULL , V_11 ) ;
if ( V_60 ) {
F_24 ( V_11 ) ;
goto V_36;
}
...
if ( F_101 ( V_11 ) )
F_29 ( V_2 ) ;
if ( ! F_56 ( V_2 ) && ! F_199 ( V_2 ) && ! F_219 ( V_2 ) ) {
V_60 = - V_62 ;
F_94 ( V_111 , 0 , 1 , & V_2 ) ;
F_79 ( V_2 ) ;
if ( ! F_56 ( V_2 ) )
...
unsigned V_92 ;
if ( V_11 -> V_31 < V_201 )
return F_197 ( V_25 , V_11 , V_137 , V_139 ,
F_62 ) ;
V_92 = V_172 & ( V_94 - 1 ) ;
if ( V_11 -> V_31 >= V_201 + 1 || ! V_92 ) {
F_261 ( V_11 , 0 , V_94 ) ;
...
static void F_263 ( struct V_208 * V_208 )
{
struct V_1 * V_2 = V_208 -> V_209 ;
if ( F_108 ( F_264 ( V_208 , V_210 ) ) )
F_265 ( V_17 , & V_2 -> V_8 ) ;
V_2 -> V_5 ( V_2 , ! V_208 -> V_211 ) ;
F_266 ( V_208 ) ;
}
void F_267 ( int V_212 , struct V_208 * V_208 )
{
T_2 V_213 ;
struct V_214 * V_215 = & V_208 -> V_216 [ V_208 -> V_217 - 1 ] ;
unsigned V_218 ;
V_213 = F_268 ( V_208 -> V_219 ) ;
if ( ! V_213 )
return;
if ( F_108 ( V_208 -> V_220 . V_221 >= V_213 ) )
return;
V_213 -= V_208 -> V_220 . V_221 ;
if ( F_168 ( ( V_208 -> V_220 . V_222 >> 9 ) <= V_213 ) )
return;
V_218 = V_208 -> V_220 . V_222 - ( V_213 << 9 ) ;
V_208 -> V_220 . V_222 -= V_218 ;
V_215 -> V_223 -= V_218 ;
if ( V_212 == V_111 ) {
F_212 ( V_215 -> V_224 , V_215 -> V_225 + V_215 -> V_223 ,
V_218 ) ;
}
}
static int F_208 ( int V_212 , int V_226 , struct V_1 * V_2 ,
enum V_227 V_228 , struct V_138 * V_139 )
{
struct V_208 * V_208 ;
F_12 ( ! F_17 ( V_2 ) ) ;
F_12 ( ! F_38 ( V_2 ) ) ;
...
F_12 ( F_199 ( V_2 ) ) ;
F_12 ( F_219 ( V_2 ) ) ;
if ( F_269 ( V_2 ) && ( V_212 == V_76 ) )
F_270 ( V_2 ) ;
V_208 = F_271 ( V_229 , 1 ) ;
if ( V_139 ) {
F_272 ( V_139 , V_208 ) ;
F_273 ( V_139 , V_2 -> V_7 , V_2 -> V_39 ) ;
}
V_208 -> V_220 . V_221 = V_2 -> V_20 * ( V_2 -> V_39 >> 9 ) ;
F_274 ( V_208 , V_2 -> V_19 ) ;
V_208 -> V_230 = V_228 ;
F_275 ( V_208 , V_2 -> V_7 , V_2 -> V_39 , F_276 ( V_2 ) ) ;
F_12 ( V_208 -> V_220 . V_222 != V_2 -> V_39 ) ;
V_208 -> V_231 = F_263 ;
V_208 -> V_209 = V_2 ;
F_267 ( V_212 , V_208 ) ;
if ( F_277 ( V_2 ) )
...
if ( F_278 ( V_2 ) )
V_226 |= V_233 ;
F_279 ( V_208 , V_212 , V_226 ) ;
F_280 ( V_208 ) ;
return 0 ;
}
int F_153 ( int V_212 , int V_226 , struct V_1 * V_2 )
{
return F_208 ( V_212 , V_226 , V_2 , 0 , NULL ) ;
}
void F_94 ( int V_212 , int V_226 , int V_178 , struct V_1 * V_118 [] )
{
int V_115 ;
for ( V_115 = 0 ; V_115 < V_178 ; V_115 ++ ) {
...
void F_118 ( struct V_1 * V_2 , int V_226 )
{
F_152 ( V_2 ) ;
if ( ! F_206 ( V_2 ) ) {
F_7 ( V_2 ) ;
...
V_2 -> V_5 = F_33 ;
F_39 ( V_2 ) ;
F_153 ( V_76 , V_226 , V_2 ) ;
}
int F_281 ( struct V_1 * V_2 , int V_226 )
{
int V_30 = 0 ;
...
static int
F_284 ( struct V_11 * V_11 , struct V_1 * * V_235 )
{
struct V_1 * V_14 = F_16 ( V_11 ) ;
struct V_1 * V_2 ;
V_2 = V_14 ;
...
struct V_1 * V_235 = NULL ;
int V_30 = 0 ;
F_12 ( ! F_13 ( V_11 ) ) ;
if ( F_15 ( V_11 ) )
return 0 ;
if ( V_71 == NULL ) {
V_30 = F_284 ( V_11 , & V_235 ) ;
goto V_36;
}
F_37 ( & V_71 -> V_37 ) ;
V_30 = F_284 ( V_11 , & V_235 ) ;
...
int V_115 ;
int V_236 = 0 ;
if ( F_287 ( V_237 . V_238 ) - 1 < 4096 )
return;
F_163 ( V_237 . V_238 , 0 ) ;
F_288 (i)
V_236 += F_289 ( V_237 , V_115 ) . V_178 ;
V_239 = ( V_236 > V_240 ) ;
}
struct V_1 * F_123 ( T_6 V_241 )
{
struct V_1 * V_30 = F_290 ( V_242 , V_241 ) ;
if ( V_30 ) {
F_114 ( & V_30 -> V_52 ) ;
F_291 () ;
F_292 ( V_237 . V_178 ) ;
...
static int F_296 ( unsigned int V_121 )
{
int V_115 ;
struct V_113 * V_114 = & F_289 ( V_116 , V_121 ) ;
for ( V_115 = 0 ; V_115 < V_117 ; V_115 ++ ) {
F_80 ( V_114 -> V_118 [ V_115 ] ) ;
V_114 -> V_118 [ V_115 ] = NULL ;
}
F_297 ( V_237 . V_178 , F_289 ( V_237 , V_121 ) . V_178 ) ;
F_289 ( V_237 , V_121 ) . V_178 = 0 ;
return 0 ;
}
...
static T_5
F_300 ( struct V_11 * V_11 , T_5 V_243 , int V_244 )
{
T_5 V_92 = F_246 ( V_11 ) ;
struct V_1 * V_2 , * V_14 ;
bool V_245 = V_244 == V_246 ;
if ( V_243 < V_92 )
V_243 = V_92 ;
V_2 = V_14 = F_16 ( V_11 ) ;
do {
...
T_5
F_301 ( struct V_25 * V_25 , T_5 V_92 , T_5 V_127 ,
int V_244 )
{
T_3 V_31 = V_92 >> V_33 ;
T_3 V_134 = F_302 ( V_92 + V_127 , V_94 ) ;
T_5 V_243 = V_92 ;
struct V_132 V_133 ;
if ( V_127 <= 0 )
return - V_247 ;
F_186 ( & V_133 , 0 ) ;
do {
unsigned V_248 , V_115 ;
V_248 = F_187 ( & V_133 , V_25 -> V_29 , & V_31 ,
V_134 - 1 ) ;
if ( V_248 == 0 )
break;
for ( V_115 = 0 ; V_115 < V_248 ; V_115 ++ ) {
struct V_11 * V_11 = V_133 . V_136 [ V_115 ] ;
if ( V_244 == V_249 &&
V_243 < F_246 ( V_11 ) )
goto V_250;
...
NULL ) ;
V_252 = ( F_305 () * 10 ) / 100 ;
V_240 = V_252 * ( V_94 / sizeof( struct V_1 ) ) ;
V_30 = F_306 ( V_256 , L_17 ,
NULL , F_296 ) ;
F_73 ( V_30 < 0 ) ;
}
