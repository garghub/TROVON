...
V_66 -> V_129 = V_14 ;
F_97 ( V_131 , V_66 -> V_129 * V_133 ) ;
F_47 ( V_66 ) ;
return V_87 ;
}
static T_2
F_98 ( struct V_66 * V_75 , struct V_83 * V_84 ,
const char * V_85 , T_3 V_87 )
{
struct V_72 * V_66 ;
unsigned int V_14 ;
...
V_14 = 0 ;
if ( V_66 -> V_99 && V_66 -> V_99 -> V_134 )
V_66 -> V_99 -> V_134 ( V_66 , ( V_135 ) V_14 ) ;
F_47 ( V_66 ) ;
return V_87 ;
}
static T_2 F_99 ( struct V_66 * V_75 , struct V_83 * V_84 ,
char * V_85 )
{
struct V_72 * V_66 ;
int V_136 ;
...
if ( F_17 ( V_66 ) )
return - V_69 ;
if ( ! V_66 -> V_99 || ! V_66 -> V_99 -> V_137 ) {
F_47 ( V_66 ) ;
return snprintf ( V_85 , V_41 , L_34 , V_39 ) ;
}
V_136 = V_66 -> V_99 -> V_137 ( V_66 ) ;
F_47 ( V_66 ) ;
return snprintf ( V_85 , V_41 , L_34 , V_136 ) ;
}
static T_2 F_100 ( struct V_66 * V_75 ,
struct V_83 * V_84 ,
char * V_85 )
{
struct V_49 * V_50 ;
...
int V_26 ;
if ( F_102 ( L_53 , V_85 ) )
V_26 = F_62 ( V_74 , V_138 , 0 ) ;
else if ( F_102 ( L_54 , V_85 ) )
V_26 = F_62 ( V_74 , V_138 , 1 ) ;
else
V_26 = - V_19 ;
return V_26 ? : V_87 ;
}
static T_2 F_103 ( struct V_66 * V_75 ,
struct V_83 * V_84 ,
char * V_85 )
{
struct V_72 * V_66 ;
...
if ( F_65 ( V_139 , & V_66 -> V_76 ) )
V_26 = snprintf ( V_85 , V_41 , L_55 ) ;
else if ( F_65 ( V_140 , & V_66 -> V_76 ) )
...
static T_2 F_106 ( struct V_66 * V_75 ,
struct V_83 * V_84 , char * V_85 )
{
struct V_72 * V_66 ;
T_4 V_141 , V_142 , V_143 , V_144 , V_145 , V_146 ;
V_66 = F_57 ( F_63 ( V_75 ) ) ;
if ( F_17 ( V_66 ) )
return sprintf ( V_85 , L_33 ) ;
V_141 = F_107 ( V_66 ) ;
...
V_146 = F_112 ( V_66 ) ;
F_47 ( V_66 ) ;
return sprintf ( V_85 , L_58 , V_141 , V_142 ,
V_143 , V_144 , V_145 , V_146 ) ;
}
static T_2
F_113 ( struct V_66 * V_75 ,
struct V_83 * V_84 , char * V_85 )
{
struct V_72 * V_66 ;
int V_25 ;
...
if ( F_17 ( V_66 ) )
return - V_69 ;
V_25 = snprintf ( V_85 , V_41 , L_50 , V_66 -> V_147 ) ;
F_47 ( V_66 ) ;
return V_25 ;
}
static T_2
F_114 ( struct V_66 * V_75 , struct V_83 * V_84 ,
const char * V_85 , T_3 V_87 )
{
struct V_72 * V_66 ;
unsigned long V_76 ;
...
if ( F_17 ( V_66 ) )
return - V_69 ;
if ( F_76 ( V_85 , 10 , & V_14 ) != 0 || V_14 > V_148 ) {
F_47 ( V_66 ) ;
return - V_19 ;
}
...
static T_2
F_116 ( struct V_66 * V_75 , struct V_83 * V_84 ,
const char * V_85 , T_3 V_87 )
{
struct V_72 * V_66 ;
unsigned long V_76 ;
...
int
F_117 ( struct V_73 * V_74 , int V_151 )
{
struct V_49 * V_50 ;
V_50 = F_27 ( F_36 ( & V_74 -> V_75 ) ) ;
if ( F_17 ( V_50 ) )
return F_18 ( V_50 ) ;
return ( ( V_50 -> V_24 & V_151 ) != 0 ) ;
}
int
F_62 ( struct V_73 * V_74 , int V_151 , int V_152 )
{
struct V_49 * V_50 ;
V_50 = F_35 ( V_74 ) ;
if ( F_17 ( V_50 ) )
...
int
F_118 ( struct V_73 * V_74 )
{
return F_119 ( & V_74 -> V_75 . V_153 , & V_154 ) ;
}
void
F_120 ( struct V_73 * V_74 )
{
F_121 ( & V_74 -> V_75 . V_153 , & V_154 ) ;
}
int
F_122 ( void )
{
