...
static int F_36 ( struct V_26 * V_27 , const void * V_69 )
{
...
F_95 ( & V_2 -> V_157 ) ;
F_96 ( & V_2 -> V_65 ) ;
V_2 -> V_4 = F_97 ( V_19 -> V_25 . V_198 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_48 ( & V_19 -> V_25 , L_18 ) ;
V_174 = - V_64 ;
goto V_199;
...
V_2 -> V_159 = 0 ;
V_71 = ( T_6 * ) F_98 ( V_19 -> V_25 . V_198 , L_19 , NULL ) ;
if ( V_71 && F_99 ( * V_71 ) ) {
V_2 -> V_159 |= V_200 ;
V_27 -> V_191 |= V_201 ;
}
V_71 = ( T_6 * ) F_98 ( V_19 -> V_25 . V_198 , L_20 , NULL ) ;
if ( V_71 && F_99 ( * V_71 ) )
V_2 -> V_159 |= V_160 ;
V_21 = F_100 ( V_19 -> V_25 . V_198 , L_21 , 0 ) ;
if ( ! V_21 ) {
F_48 ( & V_19 -> V_25 , L_22 ) ;
V_174 = - V_176 ;
goto V_202;
...
V_2 -> V_180 = F_102 ( V_21 , 0 ) ;
V_2 -> V_177 = F_102 ( V_21 , 1 ) ;
F_101 ( V_21 ) ;
...
F_36 ( V_27 , V_73 ) ;
V_174 = F_104 ( V_2 , V_19 -> V_25 . V_198 ) ;
if ( V_174 )
F_105 ( & V_19 -> V_25 , L_27 ) ;
V_2 -> V_175 = F_100 ( V_19 -> V_25 . V_198 , L_28 , 0 ) ;
if ( V_2 -> V_175 )
F_21 ( V_2 -> V_25 , L_29 , V_21 , V_21 ) ;
V_174 = F_106 ( & V_2 -> V_25 -> V_204 , & V_205 ) ;
if ( V_174 ) {
F_48 ( V_2 -> V_25 , L_30 ) ;
goto V_203;
}
V_174 = F_107 ( V_2 -> V_27 ) ;
if ( V_174 ) {
F_48 ( V_2 -> V_25 , L_31 , V_174 ) ;
goto V_206;
}
return 0 ;
V_206:
F_108 ( & V_2 -> V_25 -> V_204 , & V_205 ) ;
V_203:
if ( V_2 -> V_16 )
F_109 ( V_2 -> V_16 ) ;
V_202:
