...
static void T_8 F_40 ( unsigned long V_48 , unsigned long V_49 )
{
...
static int F_59 ( struct V_8 * V_8 , int V_73 , T_11 V_69 )
{
int V_24 , V_26 = 0 ;
unsigned long V_10 ;
struct V_8 * V_74 = V_8 ;
...
F_61 () ;
F_62 ( V_10 ) ;
F_63 ( ( unsigned long ) F_55 ( V_74 ) ,
( unsigned long ) F_55 ( V_8 ) ) ;
return V_26 ;
}
void F_64 ( void )
{
struct V_8 * V_8 = F_65 ( V_57 ) ;
unsigned long V_73 = F_66 ( ( unsigned long ) V_58 ) -
F_67 ( ( unsigned long ) V_57 ) ;
F_59 ( V_8 , V_73 , V_28 ) ;
}
void F_68 ( void )
{
...
unsigned long V_73 ;
V_8 = F_65 ( V_55 ) ;
V_73 = F_66 ( ( unsigned long ) V_75 ) -
F_67 ( ( unsigned long ) V_55 ) ;
F_59 ( V_8 , V_73 , V_76 ) ;
V_8 = F_65 ( V_77 ) ;
V_73 = F_66 ( ( unsigned long ) V_78 ) -
F_67 ( ( unsigned long ) V_77 ) ;
F_59 ( V_8 , V_73 , V_79 ) ;
}
void F_69 ( struct V_8 * V_8 , int V_73 , int V_80 )
{
if ( F_54 ( V_8 ) )
return;
F_59 ( V_8 , V_73 , V_80 ? V_28 : F_38 ( 0 ) ) ;
}
