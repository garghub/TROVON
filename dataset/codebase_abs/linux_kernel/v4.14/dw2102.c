...
F_60 ( L_36 ,
V_62 , V_180 [ 0 ] , V_180 [ 1 ] ) ;
F_61 ( V_26 -> V_182 , V_183 , V_180 [ 0 ] ^ 0xff ,
0 ) ;
}
}
return 0 ;
...
V_212 -> V_185 = V_215 ;
V_212 -> V_216 [ 0 ] = V_217 ;
V_212 -> V_198 . V_199 . V_218 = F_62 ;
V_212 -> V_198 . V_199 . V_200 = V_219 ;
V_212 -> V_52 -> V_70 [ 0 ] . V_220 = F_43 ;
V_221 = F_69 ( & V_213 ,
sizeof( struct V_64 ) , V_16 ) ;
if ( ! V_221 )
goto V_222;
...
V_228 -> V_185 = V_230 ;
V_228 -> V_216 [ 0 ] = V_231 ;
V_228 -> V_198 . V_199 . V_218 = F_62 ;
V_228 -> V_198 . V_199 . V_200 = V_219 ;
V_228 -> V_52 -> V_70 [ 0 ] . V_220 = F_45 ;
V_232 = F_69 ( & V_233 ,
sizeof( struct V_64 ) , V_16 ) ;
if ( ! V_232 )
goto V_234;
