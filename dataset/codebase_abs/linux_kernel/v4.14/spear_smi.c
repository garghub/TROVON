...
void T_6 * V_79 , const void * V_75 , T_5 V_65 )
{
int V_7 ;
T_1 V_8 ;
V_7 = F_9 ( V_5 , V_6 , V_57 ) ;
...
static int F_32 ( struct V_90 * V_27 ,
struct V_91 * V_92 )
{
...
struct V_99 * V_100 ;
V_100 = & V_94 -> V_96 [ V_83 ] ;
V_94 -> V_92 [ V_83 ] = V_95 ;
V_64 = F_37 ( V_95 , L_7 , & V_65 ) ;
V_94 -> V_96 -> V_101 = F_38 ( & V_64 [ 0 ] ) ;
V_94 -> V_96 -> V_102 = F_38 ( & V_64 [ 1 ] ) ;
...
if ( ! V_100 )
return - V_46 ;
V_50 = F_35 ( & V_27 -> V_5 , sizeof( * V_50 ) , V_108 ) ;
if ( ! V_50 )
return - V_98 ;
V_50 -> V_6 = V_6 ;
V_50 -> V_77 = V_100 -> V_77 ? 1 : 0 ;
F_41 ( & V_50 -> V_9 ) ;
V_107 = F_31 ( V_5 , V_6 ) ;
if ( V_107 < 0 ) {
...
V_50 -> V_76 = F_43 ( & V_27 -> V_5 , V_100 -> V_101 ,
V_100 -> V_102 ) ;
if ( ! V_50 -> V_76 )
return - V_48 ;
V_5 -> V_50 [ V_6 ] = V_50 ;
V_50 -> V_3 . V_63 = V_5 ;
if ( V_100 -> V_109 )
V_50 -> V_3 . V_109 = V_100 -> V_109 ;
else
V_50 -> V_3 . V_109 = V_44 [ V_107 ] . V_109 ;
V_50 -> V_3 . V_5 . V_110 = & V_27 -> V_5 ;
F_44 ( & V_50 -> V_3 , V_92 ) ;
V_50 -> V_3 . type = V_111 ;
V_50 -> V_3 . V_112 = 1 ;
V_50 -> V_3 . V_113 = V_114 ;
V_50 -> V_3 . V_102 = V_100 -> V_102 ;
V_50 -> V_3 . V_70 = V_44 [ V_107 ] . V_115 ;
V_50 -> V_82 = V_44 [ V_107 ] . V_116 ;
V_50 -> V_3 . V_117 = V_50 -> V_82 ;
V_50 -> V_54 = V_44 [ V_107 ] . V_54 ;
V_50 -> V_3 . V_118 = F_24 ;
V_50 -> V_3 . V_119 = F_26 ;
V_50 -> V_3 . V_120 = F_30 ;
V_50 -> V_30 = V_44 [ V_107 ] . V_45 ;
F_42 ( & V_5 -> V_27 -> V_5 , L_10 ,
V_50 -> V_3 . V_109 , V_50 -> V_3 . V_102 ,
V_50 -> V_3 . V_102 / ( 1024 * 1024 ) ) ;
...
static int F_47 ( struct V_90 * V_27 )
{
struct V_91 * V_92 = V_27 -> V_5 . V_123 ;
...
V_5 = F_35 ( & V_27 -> V_5 , sizeof( * V_5 ) , V_108 ) ;
if ( ! V_5 ) {
V_7 = - V_98 ;
goto V_126;
}
V_125 = F_49 ( V_27 , V_128 , 0 ) ;
V_5 -> V_11 = F_50 ( & V_27 -> V_5 , V_125 ) ;
if ( F_51 ( V_5 -> V_11 ) ) {
V_7 = F_52 ( V_5 -> V_11 ) ;
goto V_126;
}
...
static int F_59 ( struct V_90 * V_27 )
{
struct V_4 * V_5 ;
struct V_1 * V_50 ;
int V_7 , V_83 ;
...
static int F_61 ( struct V_132 * V_5 )
{
struct V_4 * V_133 = F_62 ( V_5 ) ;
if ( V_133 && V_133 -> V_37 )
F_58 ( V_133 -> V_37 ) ;
return 0 ;
}
static int F_63 ( struct V_132 * V_5 )
{
struct V_4 * V_133 = F_62 ( V_5 ) ;
int V_7 = - V_134 ;
if ( V_133 && V_133 -> V_37 )
