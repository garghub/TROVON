...
V_106 -> V_110 = ( ( V_104 - 1 ) * 16 ) + V_112 + 6 ;
if ( V_104 < V_52 -> V_107 . V_108 )
...
{
struct V_52 * V_52 = F_39 ( V_50 ) ;
int V_113 = V_52 -> V_107 . V_114 == 9 ? 16 : 26 ;
if ( V_104 >= V_52 -> V_107 . V_108 )
return - V_109 ;
V_106 -> V_110 = ( V_104 * V_113 ) + 7 ;
V_106 -> V_111 = V_52 -> V_107 . V_114 ;
return 0 ;
}
...
struct V_7 * V_8 = F_40 ( V_52 ) ;
T_6 V_116 = 0 ;
if ( V_52 -> V_107 . V_64 == V_117 && V_50 -> V_57 )
V_116 |= V_118 ;
if ( ! V_8 -> V_14 -> V_15 )
V_116 |= V_18 ;
V_8 -> V_75 = 1 ;
...
static int F_70 ( struct V_49 * V_50 , int V_123 ,
const struct V_124 * V_125 )
{
struct V_52 * V_52 = F_39 ( V_50 ) ;
struct V_7 * V_8 = F_40 ( V_52 ) ;
int V_126 , V_127 , V_30 ;
...
return - V_132 ;
V_116 = F_15 ( V_17 ) ;
V_126 = V_131 -> V_133 / 1000 ;
V_128 = 1000000000 / V_126 ;
if ( V_126 < 30 ) {
V_129 = F_73 ( V_8 -> V_91 , V_128 ) ;
V_116 |= V_134 ;
V_127 = 1000000000 / ( V_129 / 1000 ) ;
} else {
V_128 *= 2 ;
V_129 = F_73 ( V_8 -> V_91 , V_128 ) ;
V_116 &= ~ V_134 ;
V_127 = 1000000000 / ( V_129 / 1000 / 2 ) ;
}
if ( V_131 -> V_135 > V_127 - 1000 ||
V_131 -> V_136 > V_127 - 2000 ||
V_131 -> V_137 > V_127 - 1000 ||
V_131 -> V_138 > V_127 - 2000 ||
V_131 -> V_139 > V_127 - 1500 ||
V_131 -> V_140 > V_127 ||
V_131 -> V_141 > V_127 - 3000 ||
V_131 -> V_142 > V_127 ||
V_131 -> V_143 > V_127 - 5000 ||
V_131 -> V_144 > 2 * V_127 ||
V_131 -> V_145 > V_127 - 2500 ||
V_131 -> V_146 > 6 * V_127 ||
V_131 -> V_147 > 3 * V_127 / 2 ||
V_131 -> V_133 > 2 * V_127 ||
V_131 -> V_148 > ( V_127 / 2 ) - 2500 ) {
F_30 ( V_8 -> V_33 , L_11 ) ;
return - V_149 ;
}
if ( V_123 == V_150 )
return 0 ;
V_30 = F_74 ( V_8 -> V_91 , V_128 ) ;
if ( V_30 )
return V_30 ;
F_16 ( V_116 , V_17 ) ;
F_30 ( V_8 -> V_33 , L_12 , V_129 ,
V_116 & V_134 ? L_13 :
L_14 ) ;
return 0 ;
}
...
V_116 |= V_18 ;
if ( V_50 -> V_57 ) {
T_6 V_152 = V_50 -> V_153 / V_50 -> V_57 ;
if ( V_52 -> V_107 . V_64 == V_117 )
V_116 |= V_118 ;
V_8 -> V_75 = F_68 ( V_50 ) ;
if ( V_8 -> V_75 == 4 )
V_116 |= V_154 ;
V_116 |= F_76 ( F_77 ( V_152 ) - 6 ) ;
} else {
V_8 -> V_75 = 1 ;
}
F_16 ( V_116 , V_17 ) ;
...
F_13 ( V_167 | V_168 ,
V_169 ) ;
for ( V_4 = 0 ; V_4 < V_170 ; V_4 ++ )
F_13 ( 0xffff << 16 , V_171 + ( V_4 << 2 ) ) ;
F_13 ( 0 , V_10 ) ;
V_163 = V_172 |
V_173 |
F_80 ( V_50 -> V_88 >> 1 ) |
...
if ( V_50 -> V_57 ) {
if ( V_89 -> V_107 . V_64 == V_117 )
V_163 |= V_179 ;
V_163 |= F_84 (
F_77 ( V_50 -> V_153 / V_50 -> V_57 ) - 6 ,
V_8 -> V_14 -> V_180 ) ;
V_8 -> V_75 = F_68 ( V_50 ) ;
if ( V_8 -> V_75 == 8 )
V_163 |= V_181 ;
...
static void F_88 ( struct V_49 * V_50 , unsigned V_187 ,
int V_101 , int V_102 )
{
struct V_52 * V_52 = F_39 ( V_50 ) ;
struct V_7 * V_8 = F_40 ( V_52 ) ;
...
case V_42 :
V_8 -> V_14 -> V_188 ( V_50 ) ;
V_8 -> V_14 -> V_189 ( V_8 , V_187 , false ) ;
break;
case V_190 :
V_8 -> V_83 = 0 ;
V_8 -> V_79 = true ;
V_8 -> V_14 -> V_189 ( V_8 , V_187 , true ) ;
...
int V_4 ;
if ( ! V_89 -> V_205 ||
! ( F_90 ( V_89 -> V_206 . V_207 )
& V_208 ) )
return - V_149 ;
V_8 -> V_83 = 0 ;
for ( V_4 = 0 ; V_4 < V_209 ; ++ V_4 )
V_89 -> V_210 ( V_50 , V_204 [ V_4 ] ) ;
F_7 ( V_8 -> V_60 , V_8 -> V_59 , V_50 -> V_57 ) ;
V_8 -> V_14 -> V_189 ( V_8 , V_211 , false ) ;
F_63 ( V_50 , V_44 , - 1 ) ;
V_8 -> V_14 -> V_194 ( V_50 , V_198 ) ;
return 0 ;
}
...
& V_208 ) )
return - V_149 ;
V_8 -> V_14 -> V_189 ( V_8 , V_212 , false ) ;
F_63 ( V_50 , V_44 , - 1 ) ;
V_8 -> V_14 -> V_194 ( V_50 , V_195 ) ;
F_1 ( V_8 -> V_59 , V_8 -> V_60 , 512 ) ;
V_8 -> V_83 = 0 ;
for ( V_4 = 0 ; V_4 < V_209 ; ++ V_4 )
* V_204 ++ = V_89 -> V_213 ( V_50 ) ;
return 0 ;
}
...
static int F_99 ( struct V_226 * V_227 )
{
struct V_52 * V_93 ;
struct V_49 * V_50 ;
struct V_7 * V_8 ;
struct V_228 * V_229 ;
int V_71 = 0 ;
V_8 = F_100 ( & V_227 -> V_33 , sizeof( struct V_7 ) ,
V_230 ) ;
if ( ! V_8 )
return - V_231 ;
V_8 -> V_59 = F_100 ( & V_227 -> V_33 , V_232 , V_230 ) ;
if ( ! V_8 -> V_59 )
return - V_231 ;
V_8 -> V_33 = & V_227 -> V_33 ;
V_93 = & V_8 -> V_233 ;
V_50 = F_101 ( V_93 ) ;
V_50 -> V_33 . V_234 = & V_227 -> V_33 ;
V_50 -> V_235 = V_236 ;
V_93 -> V_237 = 5 ;
F_102 ( V_93 , V_8 ) ;
F_103 ( V_93 , V_227 -> V_33 . V_221 ) ,
V_93 -> V_238 = F_47 ;
V_93 -> V_239 = F_88 ;
V_93 -> V_213 = F_53 ;
V_93 -> V_240 = F_54 ;
...
V_93 -> V_243 = F_89 ;
V_93 -> V_244 = F_91 ;
V_8 -> V_91 = F_104 ( & V_227 -> V_33 , NULL ) ;
if ( F_72 ( V_8 -> V_91 ) )
...
if ( V_71 < 0 )
return V_71 ;
V_93 -> V_251 = V_8 -> V_14 -> V_251 ;
if ( V_8 -> V_14 -> V_252 ) {
V_229 = F_107 ( V_227 , V_253 , 0 ) ;
V_8 -> V_254 = F_108 ( & V_227 -> V_33 , V_229 ) ;
if ( F_72 ( V_8 -> V_254 ) )
return F_105 ( V_8 -> V_254 ) ;
V_229 = F_107 ( V_227 , V_253 , 1 ) ;
} else {
V_229 = F_107 ( V_227 , V_253 , 0 ) ;
}
V_8 -> V_255 = F_108 ( & V_227 -> V_33 , V_229 ) ;
if ( F_72 ( V_8 -> V_255 ) )
return F_105 ( V_8 -> V_255 ) ;
V_8 -> V_60 = V_8 -> V_255 ;
if ( V_8 -> V_14 -> V_256 )
V_8 -> V_257 = V_8 -> V_255 + V_8 -> V_14 -> V_256 ;
V_8 -> V_97 = V_8 -> V_255 + V_8 -> V_14 -> V_258 ;
if ( V_8 -> V_14 -> V_259 )
V_8 -> V_260 = V_8 -> V_255 + V_8 -> V_14 -> V_259 ;
V_93 -> V_107 . V_114 = V_8 -> V_14 -> V_261 ;
V_8 -> V_75 = V_8 -> V_14 -> V_75 ;
V_93 -> V_262 = V_8 -> V_14 -> V_262 ;
V_93 -> V_107 . V_3 = 512 ;
F_109 ( V_50 , V_8 -> V_14 -> V_263 ) ;
if ( V_8 -> V_246 . V_264 ) {
V_93 -> V_107 . V_64 = V_117 ;
} else {
V_93 -> V_107 . V_64 = V_265 ;
V_93 -> V_107 . V_266 = V_267 ;
}
if ( V_8 -> V_246 . V_268 == 2 )
V_93 -> V_81 |= V_82 ;
if ( V_8 -> V_246 . V_269 )
V_93 -> V_270 |= V_271 ;
F_110 ( & V_8 -> V_27 ) ;
V_8 -> V_21 = F_111 ( V_227 , 0 ) ;
if ( V_8 -> V_21 < 0 )
return V_8 -> V_21 ;
V_8 -> V_14 -> F_19 ( V_8 , 0 ) ;
V_71 = F_112 ( & V_227 -> V_33 , V_8 -> V_21 , F_25 ,
0 , V_236 , V_8 ) ;
if ( V_71 )
return V_71 ;
V_71 = F_60 ( V_8 -> V_91 ) ;
...
case V_117 :
V_93 -> V_107 . V_273 = F_52 ;
V_93 -> V_107 . V_274 = F_48 ;
V_93 -> V_107 . V_275 = V_8 -> V_14 -> V_276 ;
break;
case V_265 :
break;
default:
...
F_114 ( & V_227 -> V_33 , ( void * ) V_8 -> V_59 ) ;
V_8 -> V_59 = F_100 ( & V_227 -> V_33 , V_50 -> V_57 + V_50 -> V_88 ,
V_230 ) ;
if ( ! V_8 -> V_59 ) {
V_71 = - V_231 ;
goto V_272;
...
if ( V_93 -> V_107 . V_64 == V_117 ) {
if ( F_92 ( V_8 ) || F_93 ( V_8 ) )
V_93 -> V_107 . V_281 = 1 ;
else
V_93 -> V_107 . V_281 = ( V_8 -> V_75 == 4 ) ? 4 : 8 ;
}
V_71 = F_115 ( V_50 ) ;
if ( V_71 )
goto V_272;
...
{
struct V_7 * V_8 = F_119 ( V_227 ) ;
F_120 ( F_101 ( & V_8 -> V_233 ) ) ;
if ( V_8 -> V_90 )
F_59 ( V_8 -> V_91 ) ;
return 0 ;
}
