...
V_473 = F_226 ( L_176 , & V_23 -> V_477 -> V_166 , V_433 , 0 ,
0 ) ;
if ( ! V_473 ) {
F_46 ( L_177 ) ;
F_87 ( V_475 ) ;
...
static int F_472 ( struct V_165 * V_166 , int V_1288 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
#ifdef F_292
int V_1291 = F_363 ( V_23 , V_1288 ) ;
...
static void F_473 ( struct V_17 * V_23 ,
struct V_1287 * V_532 )
{
struct V_673 V_1313 ;
struct V_1053 * V_1054 ;
...
if ( ! V_1315 )
continue;
V_1078 = F_384 ( V_1315 , sizeof( * V_1078 ) ) ;
...
F_474 ( V_803 , F_384 ( V_1315 , V_4 ) , V_4 ) ;
if ( ! F_386 ( V_23 -> V_159 -> V_163 , V_1315 , & V_1313 ) )
F_395 ( V_1315 ) ;
}
}
static T_12 F_475 ( struct V_1287 * V_532 ,
...
static int F_477 ( struct V_165 * V_166 , void * V_134 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
...
static void F_479 ( struct V_165 * V_166 ,
struct V_1320 * V_902 )
{
...
char V_1322 [ 32 ] ;
T_3 V_4 ;
F_480 ( V_902 -> V_1323 , V_1324 , sizeof( V_902 -> V_1323 ) ) ;
F_480 ( V_902 -> V_983 , V_1325 , sizeof( V_902 -> V_983 ) ) ;
V_4 = sizeof( V_1321 ) ;
...
V_1321 , V_1322 ) ;
F_480 ( V_902 -> V_1329 , F_481 ( V_134 -> V_477 ) ,
sizeof( V_902 -> V_1329 ) ) ;
}
static T_3 F_482 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
...
static int F_485 ( struct V_165 * V_166 ,
struct V_1330 * V_123 , T_2 * V_1331 )
{
struct V_17 * V_134 = F_341 ( V_166 ) ;
int V_7 ;
...
static T_13 F_486 ( int V_1332 , void * V_3 )
{
struct V_17 * V_23 = V_3 ;
T_3 V_219 , V_220 ;
if ( ! V_23 )
...
static void F_495 ( struct V_17 * V_23 )
{
F_72 ( V_23 ) ;
F_268 ( V_23 -> V_167 ) ;
F_138 ( V_23 ) ;
...
static void F_496 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
F_498 ( & V_23 -> V_228 ) ;
F_498 ( & V_23 -> V_486 ) ;
F_499 ( & V_23 -> V_669 , F_323 ) ;
F_500 ( & V_23 -> V_333 , F_375 ) ;
F_500 ( & V_23 -> V_558 , F_269 ) ;
F_500 ( & V_23 -> V_564 , F_270 ) ;
F_500 ( & V_23 -> V_780 , F_301 ) ;
F_500 ( & V_23 -> V_246 , F_165 ) ;
F_499 ( & V_23 -> V_191 , F_491 ) ;
F_500 ( & V_23 -> V_193 , V_1338 ) ;
F_500 ( & V_23 -> V_190 , V_1339 ) ;
F_499 ( & V_23 -> V_186 , F_333 ) ;
F_499 ( & V_23 -> V_187 , F_334 ) ;
F_499 ( & V_23 -> V_188 , F_332 ) ;
F_499 ( & V_23 -> V_189 , F_287 ) ;
F_499 ( & V_23 -> V_644 , F_283 ) ;
F_500 ( & V_23 -> V_653 , F_335 ) ;
F_500 ( & V_23 -> V_706 , F_374 ) ;
F_499 ( & V_23 -> V_322 , F_170 ) ;
F_500 ( & V_23 -> V_676 , F_494 ) ;
F_500 ( & V_23 -> V_241 , F_496 ) ;
F_499 ( & V_23 -> V_108 , F_57 ) ;
F_499 ( & V_23 -> V_104 , F_62 ) ;
F_499 ( & V_23 -> V_114 , F_66 ) ;
F_500 ( & V_23 -> V_815 , F_312 ) ;
#ifdef F_292
F_500 ( & V_23 -> V_961 , F_367 ) ;
#endif
F_501 ( & V_23 -> V_1335 , ( void (*) ( unsigned long ) )
F_141 , ( unsigned long ) V_23 ) ;
return V_432 ;
}
static void F_502 ( struct V_165 * V_166 ,
struct V_886 * V_244 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
int V_7 ;
...
static int F_503 ( struct V_17 * V_23 )
{
if ( F_182 ( V_23 ) )
goto error;
...
F_505 ( V_23 -> V_163 , & V_1352 [ V_8 ] ) ;
}
static int F_164 ( struct V_17 * V_23 )
{
int V_155 , V_7 ;
if ( V_23 -> V_1354 ) {
F_506 ( V_23 -> V_163 , V_23 -> V_1354 ) ;
V_23 -> V_1354 = 0 ;
}
if ( V_23 -> V_37 & V_701 )
return - V_306 ;
if ( V_149 && ! V_23 -> V_149 ) {
V_23 -> V_149 = F_507 ( V_149 , sizeof( * V_23 -> V_149 ) ,
V_148 ) ;
if ( V_23 -> V_149 == NULL ) {
F_46 ( L_498 ,
V_149 ) ;
...
static void F_508 ( struct V_17 * V_23 )
{
int V_7 ;
if ( V_23 -> V_37 & V_321 ) {
F_74 ( L_507 ) ;
...
V_1360 -> V_869 = F_507 ( V_202 -> V_203 ,
...
V_1373 -> V_869 = F_507 ( V_202 -> V_209 ,
sizeof( struct V_1363 ) ,
V_148 ) ;
if ( ! V_1373 -> V_869 ) {
V_155 = - V_476 ;
...
F_510 ( V_182 -> V_183 , & V_23 -> V_477 -> V_166 ) ;
if ( F_511 ( V_182 -> V_183 ) )
V_155 = - V_306 ;
V_6:
return V_155 ;
}
...
static int F_513 ( struct V_165 * V_166 )
{
struct V_1380 * V_159 = F_341 ( V_166 ) ;
struct V_17 * V_23 = V_159 -> V_23 ;
F_74 ( L_512 ) ;
...
static T_12 F_514 ( struct V_1005 * V_501 ,
struct V_165 * V_166 )
{
F_74 ( L_513 ) ;
F_241 ( V_501 ) ;
...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_515 ( sizeof( struct V_1380 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_476 ;
V_23 -> V_159 = F_341 ( V_23 -> V_157 ) ;
V_23 -> V_159 -> V_163 = F_516 ( V_23 -> V_157 ) ;
...
F_517 ( V_23 -> V_157 , & V_23 -> V_477 -> V_166 ) ;
V_155 = F_518 ( V_23 -> V_157 ) ;
if ( V_155 ) {
F_519 ( V_23 -> V_157 , 1 ) ;
V_23 -> V_157 = NULL ;
return V_155 ;
...
static int F_521 ( struct V_477 * V_1386 ,
...
struct V_17 * V_23 ;
int V_7 ;
V_167 = F_515 ( sizeof( struct V_17 ) , 0 ) ;
if ( V_167 == NULL ) {
V_557 = - V_476 ;
goto V_6;
}
V_23 = F_341 ( V_167 ) ;
V_23 -> V_163 = F_516 ( V_167 ) ;
V_23 -> V_167 = V_167 ;
V_23 -> V_477 = V_1386 ;
V_12 = V_1389 ;
F_302 ( & V_23 -> V_42 ) ;
...
F_524 ( V_1386 ) ;
V_557 = F_525 ( V_1386 , F_526 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_527 ( V_1386 , F_526 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_515 ) ;
goto V_1392;
}
F_528 ( V_1386 , V_23 ) ;
V_557 = F_529 ( V_1386 , V_1324 ) ;
if ( V_557 )
goto V_1392;
F_530 ( V_1386 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_531 ( V_1386 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_532 ( V_1386 , 0 ) ;
V_23 -> V_1393 = V_415 ;
V_137 = F_533 ( V_1386 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1390 ;
goto V_1394;
}
...
F_412 ( V_23 , 1 ) ;
V_557 = F_534 ( V_1386 -> V_1332 , F_486 , V_1396 , V_1324 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_519 , V_1386 -> V_1332 ) ;
goto V_1395;
}
F_517 ( V_167 , & V_1386 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1397 = F_475 ;
V_23 -> V_163 -> V_896 = F_502 ;
...
V_167 -> V_1383 = 68 ;
V_167 -> V_1384 = V_1385 ;
V_557 = F_535 ( & V_1386 -> V_166 . V_1410 , & V_1411 ) ;
if ( V_557 ) {
F_46 ( L_520 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1412;
...
return 0 ;
V_1414:
F_536 ( V_23 -> V_163 -> V_182 . V_183 ) ;
F_87 ( V_23 -> V_163 -> V_1373 . V_869 ) ;
F_87 ( V_23 -> V_163 -> V_1360 . V_869 ) ;
V_1413:
F_537 ( & V_1386 -> V_166 . V_1410 , & V_1411 ) ;
V_1412:
F_538 ( V_1386 -> V_1332 , V_23 ) ;
V_1395:
F_539 ( V_23 -> V_22 ) ;
V_1394:
F_540 ( V_1386 ) ;
...
static void F_542 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_543 ( V_1386 ) ;
...
static int F_546 ( struct V_477 * V_1386 , T_15 V_665 )
{
struct V_17 * V_23 = F_543 ( V_1386 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
...
F_548 ( V_1386 ) ;
F_541 ( V_1386 ) ;
F_549 ( V_1386 , F_550 ( V_1386 , V_665 ) ) ;
V_23 -> V_1415 = F_551 () ;
return 0 ;
}
static int F_552 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_543 ( V_1386 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
...
F_531 ( V_1386 , 0x40 , V_21 & 0xffff00ff ) ;
F_554 ( V_166 ) ;
V_23 -> V_1354 = F_551 () - V_23 -> V_1415 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_555 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_543 ( V_1386 ) ;
F_162 ( V_23 ) ;
F_541 ( V_1386 ) ;
}
static int T_16 F_556 ( void )
{
int V_432 ;
...
V_432 = F_558 ( & V_1417 . V_1323 , & V_1418 ) ;
if ( V_432 ) {
F_46 ( L_531 ) ;
F_559 ( & V_1417 ) ;
return V_432 ;
...
static void T_17 F_560 ( void )
{
F_561 ( & V_1417 . V_1323 , & V_1418 ) ;
F_559 ( & V_1417 ) ;
}
