...
static void F_26 ( struct V_54 * V_55 , struct V_22 * V_23 )
{
F_27 ( V_55 , L_9 ,
...
static bool F_33 ( struct V_22 * V_23 , const struct V_38 * V_39 ,
unsigned int V_40 , unsigned int * V_64 )
{
F_14 ( L_10 ) ;
F_15 ( & V_23 -> V_70 [ V_35 ] . V_12 ) ;
V_23 -> V_56 . V_21 . V_59 = V_64 [ V_71 ] ;
V_23 -> V_56 . V_21 . V_57 = V_64 [ V_72 ] ;
return true ;
}
...
struct V_1 * V_4 = F_1 ( V_2 ) ;
V_64 [ V_72 ] = V_4 -> V_60 [ V_72 ] ;
V_64 [ V_71 ] = V_4 -> V_60 [ V_71 ] ;
if ( V_75 [ V_77 ] ) {
V_64 [ V_72 ] =
F_36 ( F_37 ( V_75 [ V_77 ] ) ) * V_58 ;
}
if ( V_75 [ V_78 ] ) {
V_64 [ V_71 ] =
F_36 ( F_37 ( V_75 [ V_78 ] ) ) * V_58 ;
}
return 0 ;
}
static int
F_38 ( struct V_38 * V_39 , const void * V_76 )
{
...
static int F_41 ( struct V_2 * V_2 , T_3 V_56 )
{
struct V_1 * V_4 = F_1 ( V_2 ) ;
int V_81 ;
F_42 ( & V_4 -> V_8 ) ;
