...
if ( V_2 -> V_42 != V_144 )
return 0 ;
V_196 = F_112 ( NULL , L_50 ) ;
if ( ! V_196 )
return - V_188 ;
V_164 = F_106 ( V_196 , V_2 , & V_189 , & V_74 ) ;
if ( V_164 )
F_16 ( L_51 , V_2 -> V_5 ) ;
else if ( V_74 && V_189 )
F_15 ( L_52 ,
...
if ( V_2 -> V_204 ) {
int V_164 ;
V_164 = F_99 ( V_2 -> V_204 ) ;
F_2 ( V_164 , L_60 ,
V_2 -> V_5 , V_2 -> V_204 -> V_5 ) ;
}
F_114 ( V_2 ) ;
if ( ! F_115 ( V_2 ) )
F_116 ( V_2 ) ;
...
if ( F_75 ( V_2 -> V_5 ) )
return - V_205 ;
F_119 ( & V_2 -> V_71 , & V_206 ) ;
F_120 ( & V_2 -> V_207 ) ;
F_121 ( & V_2 -> V_208 ) ;
F_122 ( & V_2 -> V_208 , & V_2 -> V_209 ) ;
V_2 -> V_42 = V_144 ;
if ( ! strcmp ( V_2 -> V_5 , V_210 ) )
V_177 = V_2 ;
return 0 ;
}
static int T_4 F_123 ( struct V_92 * V_211 )
{
F_16 ( L_62 , V_211 -> V_212 -> V_5 ,
V_211 -> V_213 -> V_5 ) ;
F_38 ( & V_211 -> V_71 , & V_211 -> V_213 -> V_207 ) ;
V_211 -> V_213 -> V_126 ++ ;
return 0 ;
}
static int T_4 F_124 ( struct V_92 * V_211 )
{
if ( ! V_211 || ! V_211 -> V_212 || ! V_211 -> V_213 || ! V_211 -> V_66 )
return - V_6 ;
if ( V_211 -> V_11 & V_214 )
return - V_205 ;
F_16 ( L_63 ,
V_211 -> V_212 -> V_5 , V_211 -> V_213 -> V_5 ) ;
if ( V_211 -> V_212 -> V_42 != V_144 )
F_118 ( V_211 -> V_212 ) ;
if ( V_211 -> V_213 -> V_42 != V_144 )
F_118 ( V_211 -> V_213 ) ;
F_123 ( V_211 ) ;
V_211 -> V_11 |= V_214 ;
return 0 ;
...
if ( ! F_70 ( V_2 ) )
return 0 ;
return F_126 ( 0 , V_2 -> V_81 . V_215 . V_216 ,
V_2 -> V_81 . V_215 . V_217 ,
V_2 -> V_81 . V_215 . V_218 ) ;
}
...
V_2 -> V_81 . V_215 . V_216 , 0 ) ;
}
static int F_130 ( struct V_1 * V_2 ,
struct V_146 * V_147 )
{
return F_131 ( V_147 -> V_151 , V_147 -> V_152 , 0 ,
V_2 -> V_81 . V_215 . V_216 , 0 , 0 ) ;
}
...
T_1 F_3 ( struct V_1 * V_2 , T_6 V_222 )
{
if ( V_2 -> V_64 & V_223 )
return F_139 ( V_2 -> V_195 + V_222 ) ;
else
return F_140 ( V_2 -> V_195 + V_222 ) ;
}
void F_5 ( T_1 V_13 , struct V_1 * V_2 , T_6 V_222 )
{
if ( V_2 -> V_64 & V_223 )
F_141 ( V_13 , V_2 -> V_195 + V_222 ) ;
else
F_142 ( V_13 , V_2 -> V_195 + V_222 ) ;
}
...
int T_4 F_147 ( struct V_92 * * V_224 )
{
int V_164 , V_96 ;
if ( ! V_225 )
return - V_6 ;
...
V_96 = 0 ;
do {
V_164 = F_124 ( V_224 [ V_96 ] ) ;
F_2 ( V_164 && V_164 != - V_205 ,
L_65 ,
V_224 [ V_96 ] -> V_212 -> V_5 , V_224 [ V_96 ] -> V_213 -> V_5 , V_164 ) ;
} while ( V_224 [ ++ V_96 ] );
return 0 ;
}
static void T_4 F_148 ( struct V_1 * V_2 )
{
if ( ! V_177 || V_177 -> V_42 == V_203 )
F_35 ( L_66 ,
V_70 , V_210 ) ;
else if ( V_177 -> V_42 == V_144 && V_2 != V_177 )
F_149 ( V_210 ) ;
}
int T_4 F_149 ( const char * V_226 )
{
struct V_1 * V_2 ;
F_16 ( L_29 , V_226 , V_70 ) ;
V_2 = F_75 ( V_226 ) ;
if ( ! V_2 ) {
F_2 ( 1 , L_67 , V_226 ) ;
return - V_6 ;
...
V_74 = F_151 ( L_68 ) ;
if ( V_74 ) {
V_227 = F_152 ( V_74 , L_69 , NULL ) ;
if ( V_227 ) {
V_74 = F_151 ( V_227 ) ;
if ( V_74 ) {
V_227 = F_152 ( V_74 , L_43 , NULL ) ;
V_2 = F_144 ( V_227 ) ;
if ( V_2 )
V_2 -> V_64 |= V_228 ;
}
...
if ( ! V_2 )
return - V_6 ;
F_156 ( & V_2 -> V_208 , V_64 ) ;
V_164 = F_99 ( V_2 ) ;
F_157 ( & V_2 -> V_208 , V_64 ) ;
return V_164 ;
}
...
int F_161 ( struct V_1 * V_2 , struct V_232 * V_186 )
{
struct V_92 * V_93 ;
int V_96 , V_123 , V_233 , V_234 , V_235 ;
int V_164 = 0 ;
V_233 = F_63 ( V_2 ) ;
for ( V_96 = 0 ; V_96 < V_233 ; V_96 ++ ) {
unsigned int V_111 ;
if ( V_2 -> V_236 )
V_111 = V_2 -> V_236 ( ( V_2 -> V_110 + V_96 ) -> V_111 ) ;
else
V_111 = ( V_2 -> V_110 + V_96 ) -> V_111 ;
( V_186 + V_164 ) -> V_5 = ( V_2 -> V_110 + V_96 ) -> V_5 ;
( V_186 + V_164 ) -> V_237 = V_111 ;
( V_186 + V_164 ) -> V_238 = V_111 ;
( V_186 + V_164 ) -> V_64 = V_229 ;
V_164 ++ ;
}
V_234 = F_64 ( V_2 ) ;
for ( V_96 = 0 ; V_96 < V_234 ; V_96 ++ ) {
( V_186 + V_164 ) -> V_5 = ( V_2 -> V_114 + V_96 ) -> V_5 ;
( V_186 + V_164 ) -> V_237 = ( V_2 -> V_114 + V_96 ) -> V_115 ;
...
( V_186 + V_164 ) -> V_237 = ( V_93 -> V_69 + V_123 ) -> V_118 ;
( V_186 + V_164 ) -> V_238 = ( V_93 -> V_69 + V_123 ) -> V_119 ;
...
int F_162 ( struct V_1 * V_2 , struct V_232 * V_186 )
{
int V_96 , V_234 ;
int V_164 = 0 ;
V_234 = F_64 ( V_2 ) ;
...
const char * V_5 , struct V_232 * V_239 )
{
int V_164 ;
...
struct V_240 * F_164 ( struct V_1 * V_2 )
{
struct V_58 * V_34 ;
struct V_92 * V_211 ;
struct V_56 * V_59 ;
...
int F_171 ( struct V_1 * V_2 , T_2 V_242 )
{
int V_80 ;
unsigned long V_64 ;
if ( ! V_2 )
