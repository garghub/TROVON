...
int F_26 ( struct V_7 * V_34 , struct V_67 * V_68 ,
struct V_23 * V_36 ,
unsigned int V_69 , int V_14 )
{
int V_70 ;
struct V_22 * V_59 = V_34 -> V_59 ;
if ( V_68 -> V_24 == NULL ) {
V_70 = F_27 ( & V_68 -> V_24 , V_68 -> V_71 ,
V_34 -> V_39 ) ;
if ( V_70 < 0 ) {
F_12 ( V_34 -> V_39 , L_7 ,
V_68 -> V_71 , V_70 ) ;
...
if ( V_34 -> V_66 ) {
V_70 = F_10 ( V_59 , V_68 -> V_24 , V_69 , V_14 ) ;
if ( V_70 < 0 )
return V_70 ;
}
V_36 -> V_38 = V_68 -> V_24 -> V_38 ;
V_36 -> V_31 = V_68 -> V_24 -> V_31 ;
F_11 ( V_36 ) ;
return 0 ;
}
void F_28 ( struct V_67 * V_68 , int V_72 )
{
int V_18 ;
