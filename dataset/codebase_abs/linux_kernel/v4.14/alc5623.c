...
struct V_42 * V_43 = F_10 ( V_2 ) ;
int V_111 ;
F_22 ( V_43 -> V_110 , false ) ;
V_111 = F_24 ( V_43 -> V_110 ) ;
if ( V_111 != 0 ) {
F_25 ( V_2 -> V_84 , L_2 ,
V_111 ) ;
F_22 ( V_43 -> V_110 , true ) ;
...
static int F_31 ( struct V_126 * V_127 ,
const struct V_128 * V_99 )
{
struct V_129 * V_130 ;
struct V_42 * V_43 ;
struct V_131 * V_132 ;
...
int V_111 ;
T_2 V_135 ;
V_43 = F_32 ( & V_127 -> V_84 , sizeof( struct V_42 ) ,
V_136 ) ;
if ( V_43 == NULL )
return - V_137 ;
V_43 -> V_110 = F_33 ( V_127 , & V_138 ) ;
if ( F_34 ( V_43 -> V_110 ) ) {
V_111 = F_35 ( V_43 -> V_110 ) ;
F_25 ( & V_127 -> V_84 , L_3 , V_111 ) ;
return V_111 ;
}
V_111 = F_36 ( V_43 -> V_110 , V_139 , & V_133 ) ;
if ( V_111 < 0 ) {
F_25 ( & V_127 -> V_84 , L_4 , V_111 ) ;
return V_111 ;
}
V_111 = F_36 ( V_43 -> V_110 , V_140 , & V_134 ) ;
if ( V_111 < 0 ) {
F_25 ( & V_127 -> V_84 , L_5 , V_111 ) ;
return V_111 ;
}
V_134 >>= 8 ;
if ( ( V_133 != 0x10ec ) || ( V_134 != V_99 -> V_141 ) ) {
F_25 ( & V_127 -> V_84 , L_6 ) ;
F_25 ( & V_127 -> V_84 , L_7 ,
0x10ec , V_99 -> V_141 ,
V_133 , V_134 ) ;
...
F_16 ( & V_127 -> V_84 , L_8 , V_134 ) ;
V_130 = V_127 -> V_84 . V_142 ;
if ( V_130 ) {
V_43 -> V_113 = V_130 -> V_113 ;
V_43 -> V_115 = V_130 -> V_115 ;
} else {
if ( V_127 -> V_84 . V_143 ) {
V_132 = V_127 -> V_84 . V_143 ;
V_111 = F_37 ( V_132 , L_9 , & V_135 ) ;
if ( ! V_111 )
V_43 -> V_113 = V_135 ;
V_111 = F_37 ( V_132 , L_10 , & V_135 ) ;
if ( ! V_111 )
V_43 -> V_115 = V_135 ;
}
}
...
F_38 ( V_127 , V_43 ) ;
V_111 = F_39 ( & V_127 -> V_84 ,
& V_146 , & V_144 , 1 ) ;
if ( V_111 != 0 )
F_25 ( & V_127 -> V_84 , L_14 , V_111 ) ;
return V_111 ;
}
static int F_40 ( struct V_126 * V_127 )
{
F_41 ( & V_127 -> V_84 ) ;
return 0 ;
}
