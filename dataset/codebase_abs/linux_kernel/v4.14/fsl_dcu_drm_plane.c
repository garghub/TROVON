...
void F_30 ( struct V_48 * V_5 )
{
struct V_3 * V_4 = V_5 -> V_6 ;
int V_49 , V_50 ;
for ( V_49 = 0 ; V_49 < V_4 -> V_8 -> V_7 ; V_49 ++ ) {
for ( V_50 = 1 ; V_50 <= V_4 -> V_8 -> V_51 ; V_50 ++ )
F_8 ( V_4 -> V_28 , F_7 ( V_49 , V_50 ) , 0 ) ;
}
}
struct V_1 * F_31 ( struct V_48 * V_5 )
{
struct V_1 * V_52 ;
int V_53 ;
V_52 = F_32 ( sizeof( * V_52 ) , V_54 ) ;
if ( ! V_52 ) {
F_33 ( L_3 ) ;
return NULL ;
}
V_53 = F_34 ( V_5 , V_52 , 0 ,
& V_55 ,
V_56 ,
F_35 ( V_56 ) ,
NULL , V_57 , NULL ) ;
