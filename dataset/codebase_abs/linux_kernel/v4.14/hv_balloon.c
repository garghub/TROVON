...
static void F_15 ( unsigned long V_35 , unsigned long V_33 ,
unsigned long V_36 ,
struct V_21 * V_22 )
{
int V_37 = 0 ;
...
static int F_24 ( unsigned long V_31 , unsigned long V_48 )
{
struct V_21 * V_22 ;
struct V_27 * V_28 ;
...
continue;
if ( V_22 -> V_30 != V_31 ) {
V_28 = F_25 ( sizeof( struct V_27 ) , V_51 ) ;
if ( ! V_28 ) {
V_37 = - V_52 ;
break;
}
...
static unsigned long F_30 ( unsigned long V_55 ,
unsigned long V_48 ,
unsigned long V_60 ,
unsigned long V_61 )
{
...
if ( V_61 != 0 ) {
V_62 = F_25 ( sizeof( struct V_21 ) , V_66 ) ;
if ( ! V_62 )
return 0 ;
F_26 ( & V_62 -> V_53 ) ;
F_26 ( & V_62 -> V_54 ) ;
...
V_62 -> V_32 = V_60 + V_61 ;
F_3 ( & V_10 . V_14 , V_7 ) ;
F_27 ( & V_62 -> V_53 , & V_10 . V_67 ) ;
F_4 ( & V_10 . V_14 , V_7 ) ;
}
V_65:
return F_28 ( V_55 , V_48 ) ;
}
...
F_33 ( L_4 ) ;
V_74 -> V_88 = V_89 ;
V_71 . V_75 . V_90 = F_34 ( & V_90 ) ;
F_35 ( V_74 -> V_91 -> V_92 , & V_71 ,
sizeof( struct V_70 ) ,
( unsigned long ) NULL ,
V_93 , 0 ) ;
}
static void F_36 ( struct V_73 * V_74 , struct V_94 * V_95 )
{
struct V_96 * V_97 ;
...
{
unsigned long V_103 ;
#define F_38 ( T_1 ) ((mb) << (20 - PAGE_SHIFT))
if ( V_104 < F_38 ( 128 ) )
V_103 = F_38 ( 8 ) + ( V_104 >> 1 ) ;
else if ( V_104 < F_38 ( 512 ) )
V_103 = F_38 ( 40 ) + ( V_104 >> 2 ) ;
else if ( V_104 < F_38 ( 2048 ) )
V_103 = F_38 ( 104 ) + ( V_104 >> 3 ) ;
else if ( V_104 < F_38 ( 8192 ) )
V_103 = F_38 ( 232 ) + ( V_104 >> 4 ) ;
else
V_103 = F_38 ( 488 ) + ( V_104 >> 5 ) ;
#undef F_38
return V_103 ;
}
...
if ( ! F_39 ( V_107 , ( V_110 + V_47 ) ) )
return;
memset ( & V_106 , 0 , sizeof( struct V_105 ) ) ;
V_106 . V_75 . type = V_112 ;
V_106 . V_75 . V_33 = sizeof( struct V_105 ) ;
V_106 . V_75 . V_90 = F_34 ( & V_90 ) ;
V_106 . V_113 = F_40 () ;
V_106 . V_114 = F_41 () +
V_74 -> V_115 +
( V_74 -> V_86 > V_74 -> V_15 ?
V_74 -> V_86 - V_74 -> V_15 : 0 ) +
F_37 () ;
if ( V_106 . V_75 . V_90 != F_42 ( & V_90 ) )
return;
if ( V_109 != V_110 )
return;
V_110 = V_108 ;
F_35 ( V_74 -> V_91 -> V_92 , & V_106 ,
sizeof( struct V_105 ) ,
( unsigned long ) NULL ,
V_93 , 0 ) ;
}
...
static unsigned int F_45 ( struct V_73 * V_74 ,
unsigned int V_118 ,
struct V_120 * V_121 ,
int V_122 )
{
...
{
unsigned int V_118 = V_10 . V_129 . V_118 ;
...
F_14 ( L_10 ,
V_118 , V_10 . V_129 . V_118 ) ;
V_121 -> V_136 = 0 ;
V_131 = true ;
V_10 . V_88 = V_89 ;
}
do {
V_121 -> V_75 . V_90 = F_34 ( & V_90 ) ;
V_37 = F_35 ( V_10 . V_91 -> V_92 ,
V_121 ,
V_121 -> V_75 . V_33 ,
( unsigned long ) NULL ,
V_93 , 0 ) ;
...
V_37 = F_35 ( V_74 -> V_91 -> V_92 , & V_148 ,
sizeof( struct V_147 ) ,
( unsigned long ) NULL ,
V_93 , 0 ) ;
if ( V_37 )
...
static void F_58 ( struct V_73 * V_74 ,
struct V_159 * F_58 )
{
if ( ! F_58 -> V_149 ) {
F_33 ( L_13 ) ;
...
struct V_164 * V_165 ;
struct V_166 * V_167 ;
struct V_73 * V_74 = F_60 ( V_91 ) ;
struct V_168 * V_169 ;
struct V_170 * V_171 ;
union V_116 * V_172 ;
union V_116 * V_62 ;
memset ( V_173 , 0 , sizeof( V_173 ) ) ;
F_61 ( V_91 -> V_92 , V_173 ,
V_123 , & V_162 , & V_163 ) ;
if ( V_162 > 0 ) {
...
V_74 -> V_88 = V_177 ;
V_10 . V_129 . V_118 = V_169 -> V_118 ;
F_62 ( & V_10 . V_129 . V_178 ) ;
break;
case V_179 :
V_74 -> V_88 = V_180 ;
F_52 ( V_74 ,
...
F_62 ( & V_10 . V_77 . V_178 ) ;
break;
case V_185 :
F_36 ( V_74 , (struct V_94 * ) V_165 ) ;
break;
default:
F_63 ( L_16 , V_167 -> type ) ;
}
}
}
static int F_64 ( struct V_161 * V_91 ,
...
V_46 = false ;
#endif
V_134 = F_65 ( V_123 , V_66 ) ;
if ( ! V_134 )
return - V_52 ;
V_37 = F_66 ( V_91 -> V_92 , V_192 , V_192 , NULL , 0 ,
F_59 , V_91 ) ;
if ( V_37 )
goto V_193;
V_10 . V_91 = V_91 ;
...
F_26 ( & V_10 . V_67 ) ;
F_67 ( & V_10 . V_14 ) ;
F_68 ( & V_10 . V_129 . V_178 , F_50 ) ;
F_68 ( & V_10 . V_77 . V_178 , F_31 ) ;
V_10 . V_64 = false ;
V_10 . V_195 =
F_69 ( F_53 , & V_10 , L_17 ) ;
if ( F_70 ( V_10 . V_195 ) ) {
V_37 = F_71 ( V_10 . V_195 ) ;
goto V_196;
}
#ifdef F_32
F_72 ( & F_23 ) ;
...
V_148 . V_157 = 0 ;
V_10 . V_154 = V_148 . V_154 . V_154 ;
V_37 = F_35 ( V_91 -> V_92 , & V_148 ,
sizeof( struct V_147 ) ,
( unsigned long ) NULL ,
V_93 , 0 ) ;
if ( V_37 )
goto V_199;
V_188 = F_21 ( & V_10 . V_150 , 5 * V_47 ) ;
if ( V_188 == 0 ) {
V_37 = - V_200 ;
goto V_199;
}
...
static int F_81 ( struct V_161 * V_91 )
{
struct V_73 * V_74 = F_60 ( V_91 ) ;
...
unsigned long V_7 ;
if ( V_74 -> V_115 != 0 )
F_20 ( L_19 , V_74 -> V_115 ) ;
F_82 ( & V_74 -> V_129 . V_178 ) ;
F_82 ( & V_74 -> V_77 . V_178 ) ;
F_79 ( V_91 -> V_92 ) ;
F_78 ( V_74 -> V_195 ) ;
F_80 ( V_134 ) ;
#ifdef F_32
...
#endif
F_3 ( & V_10 . V_14 , V_7 ) ;
F_84 (has, tmp, &dm->ha_region_list, list) {
F_84 (gap, tmp_gap, &has->gap_list, list) {
F_85 ( & V_28 -> V_53 ) ;
F_80 ( V_28 ) ;
}
F_85 ( & V_22 -> V_53 ) ;
