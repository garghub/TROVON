...
{
struct V_127 * V_128 = F_55 ( V_126 ) ;
F_56 ( & V_128 -> V_129 ) ;
V_128 -> V_129 . V_130 = V_128 -> V_130 ;
}
...
int V_133 = 256 ;
int V_134 = V_135 ;
V_132 = F_58 ( V_136 , F_59 ( V_42 ) ) ;
if ( ! V_132 )
return 1 ;
V_132 -> V_137 = V_138 ;
V_132 -> V_139 = F_54 ;
V_132 -> V_140 = sizeof( struct V_127 ) ;
F_60 ( V_141 , V_132 ) ;
if ( F_61 ( V_132 ) < 0 ) {
F_62 ( V_132 ) ;
return 1 ;
...
static int F_73 ( T_4 * V_42 )
{
struct V_57 * V_58 = & V_42 -> V_58 ;
struct V_148 * V_149 = V_42 -> V_149 ;
T_5 V_150 = V_149 -> V_150 ;
int V_151 = V_149 -> V_152 ;
if ( V_150 == NULL )
V_150 = V_153 ;
if ( ! V_149 -> V_154 )
if ( F_74 ( V_42 -> V_118 , V_150 , V_151 , V_42 -> V_31 , V_42 ) )
goto V_155;
#if ! F_75 ( V_156 )
...
static int F_76 ( T_6 V_102 , void * V_160 )
{
return 0 ;
}
static struct V_161 * F_77 ( T_6 V_102 , int * V_162 , void * V_160 )
{
T_4 * V_42 = V_160 ;
...
static struct V_161 * F_79 ( T_6 V_102 , int * V_162 , void * V_160 )
{
struct V_165 * V_166 = V_160 ;
* V_162 &= ( 1 << V_164 ) - 1 ;
return & F_80 ( V_166 ) -> V_167 ;
}
static int F_81 ( T_6 V_102 , void * V_160 )
{
struct V_165 * V_166 = V_160 ;
if ( ! F_82 ( V_166 ) )
return - 1 ;
...
V_168 -> V_171 , NULL , F_79 , F_81 , V_168 ) ;
}
void F_85 ( struct V_165 * V_168 )
{
F_86 ( F_37 ( V_168 -> V_169 , V_168 -> V_170 ) ,
V_168 -> V_171 ) ;
}
void F_87 ( struct V_165 * V_168 , T_1 * V_1 )
{
T_4 * V_42 = V_1 -> V_42 ;
...
static void F_88 ( struct V_92 * V_102 )
{
...
static int F_90 ( T_4 * V_42 )
{
if ( ! V_42 -> V_118 ) {
F_8 ( V_88 L_46 , V_42 -> V_31 ) ;
return 0 ;
}
if ( F_91 ( V_42 -> V_169 , V_42 -> V_31 ) )
return 0 ;
if ( ! V_42 -> V_175 )
V_42 -> V_175 = V_135 ;
V_42 -> V_176 = F_92 ( sizeof( struct V_177 ) * V_42 -> V_175 ,
V_136 ) ;
if ( ! V_42 -> V_176 ) {
F_8 ( V_88 L_47 , V_42 -> V_31 ) ;
goto V_108;
}
F_93 ( V_42 -> V_176 , V_42 -> V_175 ) ;
if ( F_73 ( V_42 ) ) {
F_8 ( V_88 L_48 ,
...
V_178 , F_77 , F_76 , V_42 ) ;
return 1 ;
V_108:
F_94 ( V_42 -> V_169 , V_42 -> V_31 ) ;
return 0 ;
}
...
static void F_97 ( T_4 * V_42 , unsigned int V_193 ,
...
static void F_103 ( T_4 * V_42 , unsigned int V_173 )
{
V_42 -> V_173 = V_173 ;
...
V_42 -> V_31 [ 3 ] = '0' + V_173 ;
F_104 ( & V_42 -> V_227 ) ;
F_105 ( & V_42 -> V_228 , & V_229 , ( unsigned long ) V_42 ) ;
F_102 ( & V_42 -> V_104 ) ;
V_42 -> V_45 = & V_230 ;
F_100 ( V_42 ) ;
}
static void F_106 ( T_4 * V_42 , struct V_231 * V_232 )
{
...
static int F_107 ( const struct V_194 * V_195 )
{
int V_235 = - V_236 ;
...
static void F_109 ( int V_235 )
{
F_69 ( & V_147 ) ;
V_240 &= ~ ( 1 << V_235 ) ;
F_70 ( & V_147 ) ;
}
static void F_110 ( T_4 * V_42 )
{
T_1 * V_1 ;
int V_111 ;
F_43 (i, drive, hwif) {
...
static int F_112 ( T_4 * V_42 , int V_242 )
{
T_1 * V_1 ;
int V_111 ;
for ( V_111 = 0 ; V_111 < V_174 ; V_111 ++ ) {
V_1 = F_113 ( sizeof( * V_1 ) , V_136 , V_242 ) ;
if ( V_1 == NULL )
goto V_243;
V_1 -> V_2 = F_113 ( V_47 , V_136 , V_242 ) ;
if ( V_1 -> V_2 == NULL )
goto V_244;
V_1 -> V_217 = F_92 ( sizeof( struct V_125 ) +
sizeof( struct V_127 ) , V_136 ) ;
if ( ! V_1 -> V_217 )
goto V_245;
V_42 -> V_97 [ V_111 ] = V_1 ;
}
...
struct V_148 * F_114 ( const struct V_194 * V_195 ,
struct V_231 * * V_247 , unsigned int V_248 )
{
struct V_148 * V_149 ;
struct V_92 * V_102 = V_247 [ 0 ] ? V_247 [ 0 ] -> V_102 : NULL ;
int V_242 = V_102 ? F_115 ( V_102 ) : - 1 ;
int V_111 ;
V_149 = F_113 ( sizeof( * V_149 ) , V_136 , V_242 ) ;
if ( V_149 == NULL )
return NULL ;
...
if ( V_247 [ V_111 ] == NULL )
continue;
V_42 = F_113 ( sizeof( * V_42 ) , V_136 , V_242 ) ;
if ( V_42 == NULL )
continue;
if ( F_112 ( V_42 , V_242 ) < 0 ) {
F_111 ( V_42 ) ;
continue;
}
V_235 = F_107 ( V_195 ) ;
...
static void F_116 ( T_4 * V_42 )
{
F_110 ( V_42 ) ;
F_109 ( V_42 -> V_173 ) ;
F_111 ( V_42 ) ;
}
static void F_117 ( T_4 * V_42 )
{
struct V_148 * V_149 = V_42 -> V_149 ;
int V_111 ;
...
int F_118 ( struct V_148 * V_149 , const struct V_194 * V_195 ,
struct V_231 * * V_247 )
{
T_4 * V_42 , * V_253 = NULL ;
int V_111 , V_146 = 0 ;
...
int F_125 ( const struct V_194 * V_195 , struct V_231 * * V_247 ,
unsigned int V_248 , struct V_148 * * V_257 )
{
struct V_148 * V_149 ;
int V_61 ;
V_149 = F_114 ( V_195 , V_247 , V_248 ) ;
if ( V_149 == NULL )
return - V_246 ;
V_61 = F_118 ( V_149 , V_195 , V_247 ) ;
if ( V_61 ) {
F_126 ( V_149 ) ;
return V_61 ;
}
...
F_133 ( V_42 ) ;
if ( ! V_42 -> V_149 -> V_154 )
F_134 ( V_42 -> V_118 , V_42 ) ;
F_40 ( V_42 -> V_109 ) ;
F_40 ( & V_42 -> V_103 ) ;
F_128 ( & V_42 -> V_104 ) ;
F_86 ( F_37 ( V_42 -> V_169 , 0 ) , V_174 << V_164 ) ;
F_111 ( V_42 -> V_176 ) ;
F_94 ( V_42 -> V_169 , V_42 -> V_31 ) ;
F_135 ( V_42 ) ;
F_70 ( & V_147 ) ;
}
void F_126 ( struct V_148 * V_149 )
{
T_4 * V_42 ;
int V_111 ;
F_72 (i, hwif, host) {
