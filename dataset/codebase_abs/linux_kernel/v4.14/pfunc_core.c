...
static struct V_59 * F_69 ( struct V_56 * V_93 ,
const char * V_68 , T_1 V_78 )
{
struct V_56 * V_94 = F_56 ( V_93 ) ;
struct V_53 * V_54 ;
struct V_59 * V_60 , * V_95 = NULL ;
char V_96 [ 64 ] ;
const T_1 * V_97 ;
T_1 V_98 ;
snprintf ( V_96 , 63 , L_54 , V_68 ) ;
V_97 = F_70 ( V_93 , V_96 , NULL ) ;
if ( V_97 == NULL )
goto V_99;
V_98 = * V_97 ;
if ( V_98 == 0 )
...
continue;
if ( V_60 -> V_77 && V_93 -> V_77 != V_60 -> V_77 )
continue;
if ( ( V_60 -> V_78 & V_78 ) == 0 )
continue;
V_95 = V_60 ;
...
F_73 ( & V_104 ) ;
if ( F_66 ( & V_60 -> V_75 ) )
V_60 -> V_54 -> V_61 -> V_105 ( V_60 ) ;
F_54 ( & V_87 , V_78 ) ;
F_50 ( & V_102 -> V_79 , & V_60 -> V_75 ) ;
F_55 ( & V_87 , V_78 ) ;
V_102 -> V_60 = V_60 ;
F_74 ( & V_104 ) ;
return 0 ;
}
void F_75 ( struct V_101 * V_102 )
{
struct V_59 * V_60 = V_102 -> V_60 ;
unsigned long V_78 ;
F_76 ( V_60 == NULL ) ;
F_73 ( & V_104 ) ;
V_102 -> V_60 = NULL ;
...
void * V_62 = NULL ;
int V_65 = 0 ;
F_46 ( L_55 , V_54 -> V_58 , V_60 -> V_68 ) ;
if ( V_54 -> V_61 -> V_108 )
V_62 = V_54 -> V_61 -> V_108 ( V_60 , args ) ;
V_65 = F_43 ( V_60 , V_54 -> V_61 , V_62 , args ) ;
if ( V_54 -> V_61 -> V_109 )
V_54 -> V_61 -> V_109 ( V_60 , V_62 ) ;
return V_65 ;
}
int F_79 ( struct V_56 * V_57 , const char * V_68 ,
T_1 V_77 , T_1 V_110 , struct V_63 * args )
{
struct V_53 * V_54 ;
struct V_59 * V_60 , * V_111 ;
unsigned long V_78 ;
int V_65 = - V_90 ;
F_54 ( & V_87 , V_78 ) ;
V_54 = F_41 ( V_57 ) ;
...
struct V_59 * F_81 ( struct V_56 * V_93 ,
const char * V_68 )
{
struct V_59 * V_60 ;
unsigned long V_78 ;
F_54 ( & V_87 , V_78 ) ;
V_60 = F_69 ( V_93 , V_68 , V_112 ) ;
if ( V_60 )
V_60 = F_58 ( V_60 ) ;
F_55 ( & V_87 , V_78 ) ;
return V_60 ;
}
int F_82 ( struct V_56 * V_93 , const char * V_68 ,
struct V_63 * args )
{
struct V_59 * V_60 = F_81 ( V_93 , V_68 ) ;
int V_65 ;
if ( V_60 == NULL )
return - V_90 ;
V_65 = F_78 ( V_60 , args ) ;
