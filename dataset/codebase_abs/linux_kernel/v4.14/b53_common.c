...
T_1 V_112 ;
do {
F_3 ( V_2 , V_5 , V_219 , & V_112 ) ;
if ( ! ( V_112 & V_220 ) )
return 0 ;
F_4 ( 1000 , 2000 ) ;
} while ( V_133 -- );
F_71 ( V_2 -> V_2 , L_8 , V_112 ) ;
return - V_98 ;
}
...
V_112 &= ~ V_221 ;
F_2 ( V_2 , V_5 , V_219 , V_112 ) ;
return F_70 ( V_2 ) ;
}
static int F_73 ( struct V_1 * V_2 , T_6 V_222 ,
T_2 V_10 , struct V_223 * V_224 , T_1 * V_225 ,
bool V_226 )
{
unsigned int V_4 ;
int V_143 ;
...
F_12 ( V_2 , V_5 ,
F_75 ( V_4 ) , & V_229 ) ;
F_76 ( V_224 , V_228 , V_229 ) ;
if ( ! ( V_229 & V_230 ) )
continue;
if ( ( V_228 & V_231 ) != V_222 )
continue;
* V_225 = V_4 ;
}
return - V_232 ;
}
static int F_77 ( struct V_1 * V_2 , int V_3 , int V_99 ,
const unsigned char * V_141 , T_2 V_10 , bool V_226 )
{
struct V_223 V_224 ;
T_3 V_229 ;
T_6 V_222 , V_228 = 0 ;
...
int V_143 ;
V_222 = F_78 ( V_141 ) ;
F_79 ( V_2 , V_5 , V_233 , V_222 ) ;
F_8 ( V_2 , V_5 , V_234 , V_10 ) ;
V_143 = F_72 ( V_2 , 1 ) ;
if ( V_143 )
return V_143 ;
V_143 = F_73 ( V_2 , V_222 , V_10 , & V_224 , & V_225 , V_226 ) ;
if ( V_3 )
return V_143 ;
if ( V_143 ) {
V_229 = 0 ;
...
V_224 . V_10 = V_10 ;
V_224 . V_235 = true ;
memcpy ( V_224 . V_222 , V_141 , V_236 ) ;
F_80 ( & V_228 , & V_229 , & V_224 ) ;
F_81 ( V_2 , V_5 ,
F_74 ( V_225 ) , V_228 ) ;
F_7 ( V_2 , V_5 ,
F_75 ( V_225 ) , V_229 ) ;
...
int F_82 ( struct V_41 * V_34 , int V_99 ,
const unsigned char * V_141 , T_2 V_10 )
{
struct V_1 * V_105 = V_34 -> V_105 ;
if ( F_6 ( V_105 ) || F_9 ( V_105 ) )
return - V_211 ;
return F_77 ( V_105 , 0 , V_99 , V_141 , V_10 , true ) ;
}
int F_83 ( struct V_41 * V_34 , int V_99 ,
const unsigned char * V_141 , T_2 V_10 )
{
struct V_1 * V_105 = V_34 -> V_105 ;
return F_77 ( V_105 , 0 , V_99 , V_141 , V_10 , false ) ;
}
...
static void F_85 ( struct V_1 * V_2 , T_1 V_225 ,
struct V_223 * V_224 )
{
T_6 V_228 ;
T_3 V_229 ;
...
static int F_88 ( int V_99 , const struct V_223 * V_224 ,
T_7 * V_240 , void * V_158 )
{
if ( ! V_224 -> V_226 )
return 0 ;
if ( V_99 != V_224 -> V_99 )
return 0 ;
return V_240 ( V_224 -> V_222 , V_224 -> V_10 , V_224 -> V_235 , V_158 ) ;
}
int F_89 ( struct V_41 * V_34 , int V_99 ,
T_7 * V_240 , void * V_158 )
{
struct V_1 * V_105 = V_34 -> V_105 ;
struct V_223 V_241 [ 2 ] ;
unsigned int V_242 = 0 ;
int V_143 ;
T_1 V_112 ;
V_112 = V_238 ;
F_2 ( V_105 , V_5 , V_237 , V_112 ) ;
do {
V_143 = F_84 ( V_105 ) ;
if ( V_143 )
return V_143 ;
F_85 ( V_105 , 0 , & V_241 [ 0 ] ) ;
V_143 = F_88 ( V_99 , & V_241 [ 0 ] , V_240 , V_158 ) ;
if ( V_143 )
return V_143 ;
if ( V_105 -> V_227 > 2 ) {
F_85 ( V_105 , 1 , & V_241 [ 1 ] ) ;
V_143 = F_88 ( V_99 , & V_241 [ 1 ] , V_240 , V_158 ) ;
if ( V_143 )
return V_143 ;
if ( ! V_241 [ 0 ] . V_226 && ! V_241 [ 1 ] . V_226 )
break;
}
} while ( V_242 ++ < 1024 );
return 0 ;
}
int F_90 ( struct V_41 * V_34 , int V_99 , struct V_243 * V_244 )
{
struct V_1 * V_2 = V_34 -> V_105 ;
T_8 V_104 = V_34 -> V_245 -> V_246 -> V_247 ;
T_2 V_106 , V_112 ;
unsigned int V_4 ;
if ( F_46 ( V_2 ) ) {
F_13 ( V_2 , V_22 , V_248 , & V_112 ) ;
V_112 &= ~ F_25 ( V_99 ) ;
if ( ( V_112 & F_25 ( V_104 ) ) == F_25 ( V_104 ) )
V_112 &= ~ F_25 ( V_104 ) ;
F_8 ( V_2 , V_22 , V_248 , V_112 ) ;
}
F_13 ( V_2 , V_107 , F_24 ( V_99 ) , & V_106 ) ;
F_23 (dev, i) {
if ( V_34 -> V_110 [ V_4 ] . V_249 != V_244 )
continue;
...
void F_91 ( struct V_41 * V_34 , int V_99 , struct V_243 * V_244 )
{
struct V_1 * V_2 = V_34 -> V_105 ;
...
void F_92 ( struct V_41 * V_34 , int V_99 , T_1 V_250 )
{
struct V_1 * V_2 = V_34 -> V_105 ;
T_1 V_251 ;
T_1 V_112 ;
...
void F_93 ( struct V_41 * V_34 , int V_99 )
{
struct V_1 * V_2 = V_34 -> V_105 ;
if ( F_20 ( V_2 , V_99 ) )
F_38 ( V_34 -> V_2 , L_10 ) ;
}
static enum V_263 F_94 ( struct V_41 * V_34 )
{
return V_48 ;
}
int F_95 ( struct V_41 * V_34 , int V_99 ,
struct V_264 * V_265 , bool V_266 )
{
struct V_1 * V_2 = V_34 -> V_105 ;
T_2 V_112 , V_267 ;
if ( V_266 )
...
V_267 = V_269 ;
F_13 ( V_2 , V_122 , V_267 , & V_112 ) ;
V_112 &= ~ V_270 ;
V_112 |= F_25 ( V_99 ) ;
F_8 ( V_2 , V_122 , V_267 , V_112 ) ;
F_13 ( V_2 , V_122 , V_271 , & V_112 ) ;
V_112 &= ~ V_272 ;
V_112 |= V_265 -> V_273 ;
V_112 |= V_274 ;
F_8 ( V_2 , V_122 , V_271 , V_112 ) ;
return 0 ;
}
void F_96 ( struct V_41 * V_34 , int V_99 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = V_34 -> V_105 ;
bool V_275 = false , V_276 = false ;
T_2 V_112 , V_267 ;
if ( V_265 -> V_266 )
V_267 = V_268 ;
else
...
F_8 ( V_2 , V_122 , V_267 , V_112 ) ;
if ( V_265 -> V_266 )
F_13 ( V_2 , V_122 , V_269 , & V_112 ) ;
else
F_13 ( V_2 , V_122 , V_268 , & V_112 ) ;
if ( ! ( V_112 & V_270 ) )
V_276 = true ;
F_13 ( V_2 , V_122 , V_271 , & V_112 ) ;
if ( V_275 && V_276 ) {
...
unsigned int V_4 ;
int V_143 ;
for ( V_4 = 0 ; V_4 < F_98 ( V_277 ) ; V_4 ++ ) {
const struct V_278 * V_279 = & V_277 [ V_4 ] ;
if ( V_279 -> V_135 == V_2 -> V_135 ) {
if ( ! V_2 -> V_86 )
V_2 -> V_86 = V_279 -> V_86 ;
V_2 -> V_162 = V_279 -> V_280 ;
V_2 -> V_281 = V_279 -> V_281 ;
V_2 -> V_6 [ 0 ] = V_279 -> V_6 [ 0 ] ;
V_2 -> V_6 [ 1 ] = V_279 -> V_6 [ 1 ] ;
V_2 -> V_6 [ 2 ] = V_279 -> V_6 [ 2 ] ;
V_2 -> V_90 = V_279 -> V_90 ;
V_2 -> V_104 = V_279 -> V_104 ;
V_2 -> V_127 = V_279 -> V_147 ;
V_2 -> V_227 = V_279 -> V_282 ;
break;
}
}
if ( F_6 ( V_2 ) ) {
...
} else if ( V_2 -> V_135 == V_283 ) {
T_6 V_284 ;
F_100 ( V_2 , V_285 , V_286 , & V_284 ) ;
if ( V_284 & V_287 )
V_2 -> V_104 = 5 ;
}
V_2 -> V_148 = V_2 -> V_104 + 1 ;
V_2 -> V_86 |= F_25 ( V_2 -> V_104 ) ;
V_2 -> V_110 = F_101 ( V_2 -> V_2 ,
sizeof( struct V_288 ) * V_2 -> V_148 ,
V_289 ) ;
if ( ! V_2 -> V_110 )
return - V_290 ;
V_2 -> V_147 = F_101 ( V_2 -> V_2 ,
...
struct V_1 * F_104 ( struct V_292 * V_293 ,
const struct V_294 * V_46 ,
void * V_105 )
{
struct V_41 * V_34 ;
struct V_1 * V_2 ;
V_34 = F_105 ( V_293 , V_295 ) ;
if ( ! V_34 )
return NULL ;
V_2 = F_101 ( V_293 , sizeof( * V_2 ) , V_289 ) ;
if ( ! V_2 )
return NULL ;
V_34 -> V_105 = V_2 ;
V_2 -> V_2 = V_293 ;
...
T_1 V_300 ;
int V_143 ;
V_143 = F_3 ( V_2 , V_122 , V_301 , & V_300 ) ;
if ( V_143 )
return V_143 ;
switch ( V_300 ) {
case 0 :
F_8 ( V_2 , V_22 , V_24 , 0xf ) ;
F_13 ( V_2 , V_22 , V_24 , & V_299 ) ;
if ( V_299 == 0xf )
V_2 -> V_135 = V_302 ;
else
V_2 -> V_135 = V_303 ;
...
break;
default:
V_143 = F_12 ( V_2 , V_122 , V_301 , & V_298 ) ;
if ( V_143 )
return V_143 ;
switch ( V_298 ) {
case V_283 :
...
if ( V_2 -> V_135 == V_302 )
return F_3 ( V_2 , V_285 , V_315 ,
& V_2 -> V_18 ) ;
else
return F_3 ( V_2 , V_122 , V_316 ,
& V_2 -> V_18 ) ;
}
...
int V_143 ;
if ( V_2 -> V_317 ) {
V_2 -> V_135 = V_2 -> V_317 -> V_135 ;
V_2 -> V_86 = V_2 -> V_317 -> V_86 ;
}
if ( ! V_2 -> V_135 && F_107 ( V_2 ) )
return - V_85 ;
V_143 = F_97 ( V_2 ) ;
if ( V_143 )
return V_143 ;
F_110 ( L_13 , V_2 -> V_162 , V_2 -> V_18 ) ;
return F_111 ( V_2 -> V_34 ) ;
}
