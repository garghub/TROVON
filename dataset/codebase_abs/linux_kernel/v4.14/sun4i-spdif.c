...
int V_29 ;
void T_2 * V_64 ;
F_24 ( & V_36 -> V_45 , L_2 , V_65 ) ;
V_2 = F_25 ( & V_36 -> V_45 , sizeof( * V_2 ) , V_66 ) ;
if ( ! V_2 )
return - V_67 ;
V_2 -> V_36 = V_36 ;
memcpy ( & V_2 -> V_68 , & V_69 , sizeof( V_69 ) ) ;
V_2 -> V_68 . V_70 = F_26 ( & V_36 -> V_45 ) ;
V_61 = F_27 ( V_36 , V_71 , 0 ) ;
V_64 = F_28 ( & V_36 -> V_45 , V_61 ) ;
if ( F_29 ( V_64 ) )
return F_30 ( V_64 ) ;
V_63 = F_31 ( & V_36 -> V_45 ) ;
if ( V_63 == NULL ) {
...
V_2 -> V_3 = F_32 ( & V_36 -> V_45 , V_64 ,
& V_73 ) ;
V_2 -> V_59 = F_33 ( & V_36 -> V_45 , L_4 ) ;
if ( F_29 ( V_2 -> V_59 ) ) {
F_13 ( & V_36 -> V_45 , L_5 ) ;
return F_30 ( V_2 -> V_59 ) ;
}
V_2 -> V_44 = F_33 ( & V_36 -> V_45 , L_6 ) ;
if ( F_29 ( V_2 -> V_44 ) ) {
F_13 ( & V_36 -> V_45 , L_7 ) ;
return F_30 ( V_2 -> V_44 ) ;
}
V_2 -> V_57 . V_74 = V_61 -> V_75 + V_63 -> V_76 ;
V_2 -> V_57 . V_77 = 8 ;
V_2 -> V_57 . V_78 = V_79 ;
F_34 ( V_36 , V_2 ) ;
if ( V_63 -> V_80 ) {
V_2 -> V_81 = F_35 ( & V_36 -> V_45 ,
NULL ) ;
if ( F_29 ( V_2 -> V_81 ) && F_30 ( V_2 -> V_81 ) == - V_82 ) {
V_29 = - V_82 ;
F_13 ( & V_36 -> V_45 , L_8 , V_29 ) ;
return V_29 ;
}
if ( ! F_29 ( V_2 -> V_81 ) )
F_36 ( V_2 -> V_81 ) ;
