...
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 = F_3 ( V_2 ) ;
return F_18 ( V_4 -> V_35 - ( ( V_4 -> V_35 * V_6 -> V_13 ) >> V_45 ) , 2U ) ;
}
static T_5 F_19 ( struct V_1 * V_2 , T_2 V_46 , int * V_47 ,
union V_48 * V_49 )
{
const struct V_5 * V_6 = F_3 ( V_2 ) ;
if ( V_46 & ( 1 << ( V_50 - 1 ) ) ) {
V_49 -> V_51 . V_52 = 1 ;
V_49 -> V_51 . V_53 = V_6 -> V_9 ;
V_49 -> V_51 . V_54 = V_6 -> V_15 ;
V_49 -> V_51 . V_55 = 0 ;
if ( V_49 -> V_51 . V_53 > 0 ) {
T_3 V_25 = V_6 -> V_10 ;
F_8 ( V_25 , V_49 -> V_51 . V_53 ) ;
V_49 -> V_51 . V_55 = V_25 ;
}
* V_47 = V_50 ;
