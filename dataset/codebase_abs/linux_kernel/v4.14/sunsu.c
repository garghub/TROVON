...
( unsigned long long ) V_2 -> V_4 . V_224 ,
V_2 -> V_4 . V_92 ) ;
#ifdef F_45
V_106 = & V_2 -> V_106 ;
V_106 -> V_196 = V_2 ;
V_106 -> V_225 . type = V_226 ;
if ( V_2 -> V_104 == V_105 ) {
V_106 -> V_225 . V_227 = V_228 ;
F_79 ( V_106 -> V_195 , L_6 , sizeof( V_106 -> V_195 ) ) ;
} else {
V_106 -> V_225 . V_227 = V_229 ;
V_106 -> V_225 . V_230 = 1 ;
...
V_106 -> V_233 = F_74 ;
V_106 -> V_234 = F_75 ;
V_106 -> V_222 . V_235 = V_2 -> V_4 . V_222 ;
F_80 ( V_106 ) ;
#endif
F_43 ( & V_2 -> V_4 , V_2 -> V_99 , 0 , V_100 ) ;
F_53 ( & V_2 -> V_4 ) ;
...
break;
F_82 ( 1 ) ;
} while ( ( V_41 & V_237 ) != V_237 );
if ( V_2 -> V_4 . V_39 & V_238 ) {
V_236 = 1000000 ;
while ( -- V_236 &&
( ( F_1 ( V_2 , V_81 ) & V_90 ) == 0 ) )
F_82 ( 1 ) ;
...
static void F_84 ( struct V_239 * V_240 , const char * V_241 ,
unsigned int V_72 )
{
struct V_1 * V_2 = & V_242 [ V_240 -> V_58 ] ;
unsigned long V_39 ;
unsigned int V_28 ;
int V_243 = 1 ;
if ( V_2 -> V_4 . V_244 || V_245 )
V_243 = F_85 ( & V_2 -> V_4 . V_24 , V_39 ) ;
else
F_22 ( & V_2 -> V_4 . V_24 , V_39 ) ;
V_28 = F_1 ( V_2 , V_30 ) ;
F_5 ( V_2 , V_30 , 0 ) ;
F_86 ( & V_2 -> V_4 , V_241 , V_72 , F_83 ) ;
F_81 ( V_2 ) ;
F_5 ( V_2 , V_30 , V_28 ) ;
if ( V_243 )
F_23 ( & V_2 -> V_4 . V_24 , V_39 ) ;
}
static int T_2 F_87 ( struct V_239 * V_240 , char * V_246 )
{
static struct V_184 V_247 ;
struct V_184 V_185 ;
struct V_31 * V_4 ;
F_55 ( L_10 ,
( V_248 . V_249 - 64 ) + V_240 -> V_58 ) ;
if ( V_240 -> V_58 > V_250 )
return - V_143 ;
V_4 = & V_242 [ V_240 -> V_58 ] . V_4 ;
F_88 ( & V_4 -> V_24 ) ;
F_89 ( V_240 , V_4 -> V_222 -> V_223 ) ;
memset ( & V_185 , 0 , sizeof( struct V_184 ) ) ;
V_185 . V_188 = V_240 -> V_99 ;
V_4 -> V_117 |= V_121 ;
V_4 -> V_251 -> V_252 ( V_4 , & V_185 , & V_247 ) ;
return 0 ;
}
static inline struct V_239 * F_90 ( void )
{
return & V_253 ;
}
static enum V_104 F_91 ( struct V_254 * V_255 )
{
struct V_254 * V_256 = F_92 ( L_11 ) ;
if ( V_256 ) {
const char * V_257 = F_93 ( V_256 , L_12 , NULL ) ;
const char * V_258 = F_93 ( V_256 , L_13 , NULL ) ;
if ( V_257 ) {
if ( V_255 == F_92 ( V_257 ) )
return V_105 ;
}
...
static int F_94 ( struct V_259 * V_260 )
{
struct V_254 * V_255 = V_260 -> V_222 . V_223 ;
struct V_1 * V_2 ;
struct V_261 * V_262 ;
enum V_104 type ;
bool V_263 ;
...
V_2 -> V_104 = type ;
V_262 = & V_260 -> V_261 [ 0 ] ;
V_2 -> V_4 . V_224 = V_262 -> V_268 ;
V_2 -> V_269 = F_96 ( V_262 ) ;
V_2 -> V_4 . V_11 = F_97 ( V_262 , 0 , V_2 -> V_269 , L_14 ) ;
if ( ! V_2 -> V_4 . V_11 ) {
if ( type != V_144 )
F_98 ( V_2 ) ;
return - V_267 ;
}
V_2 -> V_4 . V_92 = V_260 -> V_270 . V_271 [ 0 ] ;
V_2 -> V_4 . V_222 = & V_260 -> V_222 ;
V_2 -> V_4 . type = V_209 ;
V_2 -> V_4 . V_21 = ( V_272 * 16 ) ;
V_264 = 0 ;
if ( V_2 -> V_104 == V_105 || V_2 -> V_104 == V_107 ) {
V_264 = F_78 ( V_2 ) ;
if ( V_264 ) {
F_99 ( & V_260 -> V_261 [ 0 ] ,
V_2 -> V_4 . V_11 , V_2 -> V_269 ) ;
F_98 ( V_2 ) ;
return V_264 ;
}
F_100 ( V_260 , V_2 ) ;
...
V_2 -> V_4 . V_251 = & V_275 ;
V_263 = false ;
if ( ! strcmp ( V_255 -> V_195 , L_15 ) ||
! strcmp ( V_255 -> V_195 , L_16 ) )
V_263 = true ;
F_101 ( F_90 () , V_255 ,
& V_248 , V_2 -> V_4 . line ,
V_263 ) ;
V_264 = F_102 ( & V_248 , & V_2 -> V_4 ) ;
if ( V_264 )
goto V_274;
F_100 ( V_260 , V_2 ) ;
V_250 ++ ;
return 0 ;
V_274:
F_99 ( & V_260 -> V_261 [ 0 ] , V_2 -> V_4 . V_11 , V_2 -> V_269 ) ;
F_98 ( V_2 ) ;
return V_264 ;
}
static int F_103 ( struct V_259 * V_260 )
{
struct V_1 * V_2 = F_104 ( V_260 ) ;
bool V_276 = false ;
if ( V_2 -> V_104 == V_107 ||
V_2 -> V_104 == V_105 )
V_276 = true ;
