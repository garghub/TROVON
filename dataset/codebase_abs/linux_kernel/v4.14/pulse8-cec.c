...
struct V_60 V_61 = {} ;
T_3 V_62 = V_67 ;
V_3 = F_38 ( sizeof( * V_3 ) , V_147 ) ;
if ( ! V_3 )
return - V_146 ;
V_3 -> V_16 = V_16 ;
V_3 -> V_6 = F_39 ( & V_148 , V_3 ,
F_40 ( & V_16 -> V_28 ) , V_142 , 1 ) ;
V_46 = F_41 ( V_3 -> V_6 ) ;
if ( V_46 < 0 )
goto V_149;
V_3 -> V_28 = & V_16 -> V_28 ;
...
F_43 ( & V_3 -> V_112 ) ;
V_3 -> V_131 = false ;
V_46 = F_44 ( V_16 , V_141 ) ;
if ( V_46 )
goto V_150;
V_46 = F_25 ( V_3 , V_16 , & V_61 , & V_62 ) ;
if ( V_46 )
goto V_151;
V_46 = F_45 ( V_3 -> V_6 , & V_16 -> V_28 ) ;
if ( V_46 < 0 )
goto V_151;
V_3 -> V_28 = & V_3 -> V_6 -> V_152 . V_28 ;
if ( V_153 && V_3 -> V_75 ) {
...
static void V_154 ( struct V_1 * V_2 )
{
struct V_3 * V_3 =
