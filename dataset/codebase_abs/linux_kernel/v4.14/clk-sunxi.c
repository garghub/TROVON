...
V_37 = F_28 ( V_19 , V_35 , V_36 ) ;
if ( F_29 ( V_19 , L_3 , & V_34 ) ) {
F_17 ( L_4 ,
V_38 , V_19 ) ;
goto V_39;
}
V_17 = F_30 ( NULL , V_34 , V_35 , V_37 ,
V_40 , V_22 ,
V_21 -> V_41 , V_42 ,
0 , & V_24 ) ;
if ( F_31 ( V_17 ) ) {
...
static void T_3 F_36 ( struct V_18 * V_19 )
{
struct V_17 * V_17 ;
V_17 = F_27 ( V_19 , & V_44 ) ;
if ( ! V_17 )
...
static void T_3 F_39 ( struct V_18 * V_19 )
{
F_27 ( V_19 , & V_45 ) ;
}
...
static void T_3 F_46 ( struct V_18 * V_19 )
{
F_41 ( V_19 , & V_53 ) ;
}
...
static struct V_17 * * T_3 F_50 ( struct V_18 * V_19 ,
...
struct V_70 * V_71 ;
struct V_72 * V_73 ;
struct V_20 V_74 = * V_21 -> V_74 ;
char * V_75 = NULL ;
void T_4 * V_22 ;
int V_76 = V_77 , V_37 = 0 ;
int V_78 , V_79 ;
if ( V_21 -> V_76 )
V_76 = V_21 -> V_76 ;
for ( V_37 = 0 ; V_37 < V_76 ; V_37 ++ ) {
if ( V_21 -> div [ V_37 ] . V_80 ) {
F_51 ( V_19 , L_3 ,
V_37 , & V_74 . V_23 ) ;
break;
}
...
V_59 = F_55 ( sizeof( struct V_58 ) , V_82 ) ;
if ( ! V_59 )
goto V_39;
V_61 = F_56 ( V_76 , sizeof( * V_61 ) , V_82 ) ;
if ( ! V_61 )
goto V_83;
V_59 -> V_61 = V_61 ;
V_79 = ! strcmp ( L_9 , V_60 ) ? 0 : V_40 ;
for ( V_37 = 0 ; V_37 < V_76 ; V_37 ++ ) {
if ( F_51 ( V_19 , L_3 ,
V_37 , & V_34 ) != 0 )
break;
...
V_69 = F_57 ( sizeof( * V_69 ) , V_82 ) ;
if ( ! V_69 )
goto V_84;
V_69 -> V_22 = V_22 ;
V_69 -> V_85 = V_21 -> div [ V_37 ] . V_69 ;
V_69 -> V_86 = & V_24 ;
V_64 = & V_69 -> V_87 ;
}
if ( V_21 -> div [ V_37 ] . V_88 ) {
V_71 = F_57 ( sizeof( * V_71 ) , V_82 ) ;
if ( ! V_71 )
goto V_89;
V_71 -> V_90 = 1 ;
V_71 -> div = V_21 -> div [ V_37 ] . V_88 ;
V_65 = & V_71 -> V_87 ;
V_67 = & V_91 ;
} else {
V_73 = F_57 ( sizeof( * V_73 ) , V_82 ) ;
if ( ! V_73 )
goto V_89;
V_78 = V_21 -> div [ V_37 ] . pow ? V_50 : 0 ;
V_73 -> V_22 = V_22 ;
...
V_61 [ V_37 ] = F_58 ( NULL , V_34 , & V_60 , 1 ,
NULL , NULL ,
V_65 , V_67 ,
V_64 , & V_94 ,
V_79 ) ;
F_59 ( F_31 ( V_59 -> V_61 [ V_37 ] ) ) ;
}
V_59 -> V_95 = V_37 ;
if ( F_33 ( V_19 , V_96 , V_59 ) ) {
F_17 ( L_6 ,
V_38 , V_34 ) ;
goto V_89;
}
...
if ( V_2 -> V_3 > V_2 -> V_10 )
V_2 -> V_3 = V_2 -> V_10 ;
V_4 = F_6 ( V_2 -> V_10 , V_2 -> V_3 ) ;
V_2 -> V_3 = V_2 -> V_10 / V_4 ;
V_2 -> V_4 = V_4 - 1 ;
}
static void T_3 F_64 ( struct V_18 * V_19 )
{
F_15 ( V_19 , & V_100 ) ;
}
