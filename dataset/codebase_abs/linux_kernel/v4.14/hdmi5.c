...
static int F_97 ( struct V_102 * V_4 , struct V_102 * V_114 , void * V_7 )
{
struct V_87 * V_3 = F_98 ( V_4 ) ;
int V_1 ;
int V_6 ;
V_2 . V_3 = V_3 ;
F_99 ( & V_3 -> V_4 , & V_2 ) ;
...
if ( V_1 )
return V_1 ;
V_1 = F_103 ( V_3 , & V_2 . V_41 , & V_2 . V_9 ) ;
if ( V_1 )
return V_1 ;
V_1 = F_104 ( V_3 , & V_2 . V_15 ) ;
if ( V_1 )
goto V_101;
V_1 = F_105 ( V_3 , & V_2 . V_49 ) ;
if ( V_1 )
goto V_101;
V_6 = F_106 ( V_3 , 0 ) ;
if ( V_6 < 0 ) {
...
static void F_112 ( struct V_102 * V_4 , struct V_102 * V_114 , void * V_7 )
{
struct V_87 * V_3 = F_98 ( V_4 ) ;
if ( V_2 . V_112 )
F_113 ( V_2 . V_112 ) ;
...
static int F_114 ( struct V_87 * V_3 )
{
return F_115 ( & V_3 -> V_4 , & V_116 ) ;
}
static int F_116 ( struct V_87 * V_3 )
{
F_117 ( & V_3 -> V_4 , & V_116 ) ;
return 0 ;
}
static int F_118 ( struct V_102 * V_4 )
{
F_119 () ;
return 0 ;
}
static int F_120 ( struct V_102 * V_4 )
{
int V_1 ;
V_1 = F_121 () ;
if ( V_1 < 0 )
