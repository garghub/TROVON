...
switch ( V_4 ) {
case V_83 :
if ( F_44 ( V_10 ) -> V_84 . V_85 )
V_56 = F_45 ( F_44 ( V_10 ) -> V_84 . V_85 -> V_86 . V_87 ) ;
break;
case V_88 :
if ( F_44 ( V_10 ) -> V_84 . V_89 )
V_56 = F_45 ( F_44 ( V_10 ) -> V_84 . V_89 -> V_86 . V_87 ) ;
break;
}
V_3 = F_25 ( V_10 ) ;
if ( V_3 ) {
...
V_82:
F_49 ( & V_42 -> V_82 ) ;
if ( F_5 ( V_42 -> V_94 . V_95 != V_96 ) ) {
if ( V_42 -> V_94 . V_95 == V_97 )
F_43 ( V_52 , V_98 ) ;
else
F_43 ( V_52 ,
V_99 ) ;
...
if ( ( V_42 -> V_101 ? V_42 -> V_101 -> V_51 : 0 ) != V_51 ) {
F_43 ( V_52 , V_102 ) ;
goto V_100;
}
if ( V_42 -> V_103 -> V_104 ( V_42 , V_10 , V_29 ) ) {
F_43 ( V_52 , V_105 ) ;
goto V_100;
}
if ( F_50 ( V_42 ) ) {
...
F_40 ( V_10 ) -> V_29 . V_63 . V_108 = V_54 ;
F_54 ( V_10 ) ;
F_55 ( V_10 -> V_53 ) ;
if ( V_60 )
V_27 = V_42 -> V_109 -> V_110 ( V_42 , V_10 ) ;
else
...
V_51 = 0 ;
if ( V_58 && V_42 -> V_103 -> V_113 ( V_42 , V_10 , V_29 ) ) {
F_43 ( V_52 , V_105 ) ;
goto V_100;
}
V_42 -> V_103 -> V_114 ( V_42 , V_29 ) ;
V_42 -> V_115 . V_116 += V_10 -> V_17 ;
V_42 -> V_115 . V_117 ++ ;
F_51 ( & V_42 -> V_82 ) ;
F_36 ( V_10 ) -> V_11 = V_27 ;
V_44 = V_42 -> V_44 ;
...
if ( V_42 -> V_45 -> V_66 & V_118 ) {
V_57 = 1 ;
break;
}
V_55 = & V_42 -> V_119 . V_55 ;
V_4 = V_42 -> V_45 -> V_2 -> V_4 ;
...
V_62 = V_61 ( V_10 ) ;
if ( V_62 )
V_59 = V_62 -> V_66 & V_121 ;
V_3 = V_42 -> V_44 -> V_2 -> V_122 ( V_10 , V_59 || V_58 ) ;
if ( V_59 ) {
if ( V_10 -> V_15 )
V_10 -> V_15 -> V_22 = 0 ;
F_58 ( V_10 ) ;
