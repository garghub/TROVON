...
static int F_69 ( struct V_1 * V_2 , T_3 V_138 )
{
...
if ( V_141 == F_71 ( 0xffff ) ) {
V_24 -> V_147 = V_148 ;
V_24 -> V_136 = 0 ;
V_143 = 1 ;
} else {
V_24 -> V_147 = F_72 ( V_141 ) & 0x7F ;
V_24 -> V_136 = F_72 ( V_141 ) >> 8 ;
V_143 = ( F_72 ( V_141 ) & 0x80 ) ? 0 : 1 ;
}
...
static int F_76 ( struct V_19 * V_9 , int V_168 )
{
struct V_1 * V_2 = F_13 ( V_9 ) ;
...
static int F_78 ( struct V_1 * V_2 , struct V_49 * V_50 )
{
int V_51 ;
T_1 V_52 [ V_12 ] ;
F_34 ( V_2 , V_50 ) ;
