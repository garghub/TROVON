...
F_15 ( & V_75 , V_69 ) ;
if ( V_74 ) {
while ( F_17 ( F_18 ( & V_73 ) , sizeof( V_73 ) ) == V_79 ) {
T_2 type ;
type = F_3 ( V_73 . V_80 ) ;
if ( type != V_81 )
continue;
V_3 = (struct V_2 * ) & V_73 . V_82 [ 0 ] ;
F_7 ( V_3 ) ;
}
F_19 ( NULL , L_65 ) ;
}
...
unsigned long V_80 , void * V_73 )
{
unsigned long V_69 ;
struct V_2 * V_3 ;
struct V_72 * V_85 = V_73 ;
struct V_70 * V_71 ;
if ( V_80 != V_81 )
return 0 ;
V_3 = (struct V_2 * ) & V_85 -> V_82 [ 0 ] ;
V_71 = F_21 ( sizeof( * V_71 ) , V_86 ) ;
if ( ! V_71 ) {
F_8 ( L_66 ) ;
return - V_87 ;
}
