...
{
return F_27 ( & V_5 -> V_72 ) && F_187 ( V_5 ) ;
}
...
struct V_1 * V_5 = NULL ;
if ( ! F_120 ( & V_12 -> V_260 ) ) {
V_65 = F_201 ( & V_12 -> V_260 , struct V_20 ,
V_149 ) ;
F_104 ( & V_65 -> V_149 ) ;
V_5 = F_87 ( V_65 ) ;
if ( V_5 ) {
...
{
struct V_266 * V_267 = V_154 ;
int V_181 ;
struct V_6 * V_12 = V_5 -> V_12 ;
if ( ! V_12 )
return;
V_181 = F_210 ( V_3 -> V_268 ) ;
switch ( V_181 ) {
default:
F_211 ( V_5 -> V_12 -> V_19 -> V_269 -> V_270 ,
L_34 , V_181 ) ;
case V_271 :
V_5 -> V_272 = F_212 ( V_267 ) ;
V_5 -> V_273 = F_213 ( V_267 ) ;
break;
case V_274 :
V_5 -> V_272 = F_214 ( V_3 -> V_268 ) ;
V_5 -> V_273 = V_274 ;
break;
case V_275 :
V_5 -> V_272 = F_214 ( V_3 -> V_268 ) ;
...
V_5 -> V_54 . V_277 = F_216 ( V_5 -> V_272 ) ;
V_5 -> V_54 . V_93 = 1 ;
}
...
struct V_1 * V_5 ;
int V_268 = V_3 -> V_7 . V_14 -> V_268 ;
if ( F_32 ( ! V_12 ) || F_60 ( V_3 -> V_268 == V_268 ) )
return;
V_3 -> V_268 = V_268 ;
V_5 = F_1 ( V_3 , false ) ;
if ( V_5 ) {
F_141 ( V_5 ) ;
V_5 = F_218 ( V_12 , V_145 , V_278 , V_3 ) ;
F_2 ( V_3 , V_5 , false ) ;
}
V_5 = F_1 ( V_3 , true ) ;
if ( V_5 )
...
switch ( V_181 ) {
case V_274 :
return & V_166 -> V_170 [ 0 ] [ V_268 ] ;
case V_271 :
V_268 = V_280 ;
case V_275 :
return & V_166 -> V_170 [ 1 ] [ V_268 ] ;
case V_276 :
return & V_166 -> V_171 ;
default:
return NULL ;
...
struct V_2 * V_3 )
{
const int V_268 = F_214 ( V_3 -> V_268 ) ;
const int V_181 = F_210 ( V_3 -> V_268 ) ;
...
struct V_1 * V_5 )
{
struct V_285 * V_84 = & V_5 -> V_84 ;
T_2 V_286 = F_39 () - V_5 -> V_84 . V_133 ;
V_286 = F_78 ( T_2 , V_286 , 2ULL * V_12 -> V_134 ) ;
V_84 -> V_287 = ( 7 * V_5 -> V_84 . V_287 + 256 ) / 8 ;
V_84 -> V_288 = F_163 ( 7 * V_84 -> V_288 + 256 * V_286 , 8 ) ;
V_84 -> V_289 = F_162 ( V_84 -> V_288 + 128 ,
V_84 -> V_287 ) ;
}
static void
...
V_12 -> V_130 ) )
return;
if ( F_236 ( & V_3 -> V_7 . V_14 -> V_293 ) == 0 ||
( F_237 ( V_5 -> V_84 . V_287 ) &&
V_5 -> V_84 . V_289 > V_12 -> V_134 ) )
V_292 = false ;
F_40 ( V_12 , V_5 , L_40 ,
V_292 ) ;
if ( V_292 )
...
L_41 ,
F_138 ( V_5 ) , F_134 ( V_5 ) ) ;
V_5 -> V_290 = F_17 ( V_65 ) + F_48 ( V_65 ) ;
if ( V_5 == V_12 -> V_77 && F_186 ( V_5 ) ) {
bool V_294 = V_5 -> V_18 [ F_16 ( V_65 ) ] == 1 &&
F_48 ( V_65 ) < 32 ;
...
V_5 , V_178 ) ;
F_141 ( V_5 ) ;
V_65 -> V_295 . V_296 [ 1 ] = V_178 ;
V_5 = V_178 ;
}
F_97 ( V_65 ) ;
V_65 -> V_68 = F_39 () + V_12 -> V_297 [ F_16 ( V_65 ) ] ;
...
if ( V_298 || F_245 ( V_65 ) ) {
if ( V_298 )
F_246 ( & V_65 -> V_149 , & V_12 -> V_260 ) ;
else
F_241 ( & V_65 -> V_149 , & V_12 -> V_260 ) ;
} else {
F_240 ( V_12 , V_65 ) ;
if ( F_247 ( V_65 ) ) {
F_248 ( V_8 , V_65 ) ;
...
struct V_299 * V_300 , bool V_298 )
{
while ( ! F_120 ( V_300 ) ) {
struct V_20 * V_65 ;
V_65 = F_201 ( V_300 , struct V_20 , V_149 ) ;
F_104 ( & V_65 -> V_149 ) ;
F_242 ( V_153 , V_65 , V_298 ) ;
}
}
static void F_250 ( struct V_6 * V_12 )
{
V_12 -> V_301 = F_50 ( int , V_12 -> V_301 ,
V_12 -> V_228 ) ;
if ( V_12 -> V_248 == 1 )
return;
if ( V_12 -> V_228 + V_12 -> V_18 < V_302 )
return;
if ( V_12 -> V_303 ++ < V_304 )
return;
V_12 -> V_248 = V_12 -> V_301 > V_302 ;
V_12 -> V_301 = 0 ;
V_12 -> V_303 = 0 ;
}
...
V_305 = F_163 ( V_225 - V_12 -> V_222 , V_223 ) ;
if ( V_305 > V_193 / V_223 &&
( V_12 -> V_215 << V_198 ) / V_305 <
1UL << ( V_198 - 10 ) )
F_161 ( V_12 , NULL ) ;
V_12 -> V_222 = V_225 ;
...
V_65 -> V_295 . V_296 [ 0 ] = NULL ;
V_65 -> V_295 . V_296 [ 1 ] = NULL ;
}
static struct V_1 *
...
struct V_1 * V_5 ;
bool V_255 = false ;
bool V_307 = false , V_306 = false ;
if ( ! V_65 -> V_295 . V_7 )
return;
V_3 = F_4 ( V_65 -> V_295 . V_7 ) ;
F_110 ( & V_12 -> V_156 ) ;
F_217 ( V_3 , V_145 ) ;
F_263 ( V_3 , V_145 ) ;
...
F_40 ( V_12 , V_5 , L_44 ,
V_65 , V_5 , V_5 -> V_94 ) ;
V_65 -> V_295 . V_296 [ 0 ] = V_3 ;
V_65 -> V_295 . V_296 [ 1 ] = V_5 ;
...
static enum V_309 F_266 ( struct V_310 * V_311 )
{
struct V_6 * V_12 = F_5 ( V_311 , struct V_6 ,
V_195 ) ;
struct V_1 * V_5 = V_12 -> V_77 ;
if ( V_5 )
F_265 ( V_5 ) ;
...
struct V_1 * * V_313 )
{
struct V_1 * V_5 = * V_313 ;
F_11 ( V_12 , L_45 , V_5 ) ;
if ( V_5 ) {
F_268 ( V_12 , V_5 , V_12 -> V_314 ) ;
F_40 ( V_12 , V_5 , L_46 ,
V_5 , V_5 -> V_94 ) ;
F_141 ( V_5 ) ;
* V_313 = NULL ;
...
static void F_270 ( struct V_315 * V_316 )
{
struct V_6 * V_12 = V_316 -> V_10 ;
struct V_1 * V_5 , * V_42 ;
F_271 ( & V_12 -> V_195 ) ;
F_110 ( & V_12 -> V_156 ) ;
...
F_271 ( & V_12 -> V_195 ) ;
#ifdef F_28
F_274 ( V_12 -> V_19 , & V_317 ) ;
#else
F_110 ( & V_12 -> V_156 ) ;
F_269 ( V_12 , V_12 -> V_314 ) ;
F_34 ( V_12 -> V_314 ) ;
F_114 ( & V_12 -> V_156 ) ;
#endif
F_34 ( V_12 ) ;
}
static void F_275 ( struct V_165 * V_314 ,
struct V_6 * V_12 )
{
int V_167 ;
#ifdef F_28
V_314 -> V_54 . V_41 = NULL ;
V_314 -> V_318 = NULL ;
V_314 -> V_12 = V_12 ;
#endif
V_314 -> V_50 = V_319 ;
for ( V_167 = 0 ; V_167 < V_320 ; V_167 ++ )
V_314 -> V_321 . V_322 [ V_167 ] = V_323 ;
V_314 -> V_321 . V_324 = V_111 ;
}
static int F_276 ( struct V_15 * V_8 , struct V_325 * V_316 )
{
struct V_6 * V_12 ;
struct V_315 * V_326 ;
V_326 = F_277 ( V_8 , V_316 ) ;
if ( ! V_326 )
return - V_327 ;
V_12 = F_278 ( sizeof( * V_12 ) , V_328 , V_8 -> V_176 ) ;
if ( ! V_12 ) {
F_279 ( & V_326 -> V_329 ) ;
return - V_327 ;
}
...
V_12 -> V_183 . V_94 ++ ;
V_12 -> V_183 . V_272 = V_330 ;
V_12 -> V_183 . V_273 = V_275 ;
V_12 -> V_183 . V_54 . V_277 =
F_216 ( V_12 -> V_183 . V_272 ) ;
F_90 ( & V_12 -> V_183 ) ;
V_12 -> V_183 . V_54 . V_93 = 1 ;
V_12 -> V_19 = V_8 ;
F_221 ( & V_12 -> V_260 ) ;
F_280 ( & V_12 -> V_195 , V_331 ,
V_196 ) ;
V_12 -> V_195 . V_332 = F_266 ;
V_12 -> V_51 = V_319 ;
V_12 -> V_52 = V_319 ;
F_221 ( & V_12 -> V_333 ) ;
F_221 ( & V_12 -> V_334 ) ;
...
V_12 -> V_248 = - 1 ;
V_12 -> F_74 = V_115 ;
V_12 -> V_297 [ 0 ] = V_297 [ 0 ] ;
V_12 -> V_297 [ 1 ] = V_297 [ 1 ] ;
V_12 -> V_32 = V_32 ;
V_12 -> V_33 = V_33 ;
V_12 -> V_134 = V_134 ;
V_12 -> V_191 = V_191 ;
...
V_12 -> V_201 = V_202 ;
F_282 ( & V_12 -> V_156 ) ;
V_12 -> V_314 = F_283 ( V_12 , V_8 -> V_176 ) ;
if ( ! V_12 -> V_314 )
goto V_335;
F_275 ( V_12 -> V_314 , V_12 ) ;
F_231 ( & V_12 -> V_183 . V_54 , V_12 -> V_314 ) ;
return 0 ;
V_335:
F_34 ( V_12 ) ;
F_279 ( & V_326 -> V_329 ) ;
...
static T_7 F_288 ( unsigned int V_336 , char * V_337 )
{
return sprintf ( V_337 , L_47 , V_336 ) ;
}
static int F_289 ( unsigned long * V_336 , const char * V_337 )
{
unsigned long V_338 ;
int V_155 = F_290 ( V_337 , 10 , & V_338 ) ;
if ( V_155 )
return V_155 ;
* V_336 = V_338 ;
return 0 ;
}
static T_7 F_291 ( struct V_315 * V_316 ,
const char * V_337 , T_8 V_339 )
{
struct V_6 * V_12 = V_316 -> V_10 ;
unsigned long V_340 ;
int V_155 ;
V_155 = F_289 ( & V_340 , ( V_337 ) ) ;
if ( V_155 )
return V_155 ;
if ( V_340 == 0 )
...
static T_7 F_292 ( struct V_315 * V_316 ,
const char * V_337 , T_8 V_339 )
{
struct V_6 * V_12 = V_316 -> V_10 ;
unsigned long V_340 ;
...
V_340 = V_341 ;
V_12 -> V_191 = F_72 ( V_340 ) ;
if ( V_12 -> V_200 == 0 )
V_12 -> F_74 = F_156 ( V_12 ) ;
return V_339 ;
}
static T_7 F_293 ( struct V_315 * V_316 ,
const char * V_337 , T_8 V_339 )
{
struct V_6 * V_12 = V_316 -> V_10 ;
unsigned long V_340 ;
...
if ( V_340 > 1 )
V_340 = 1 ;
if ( ! V_12 -> V_254 && V_340 == 1
&& V_12 -> V_134 < 8 * V_227 )
V_12 -> V_134 = 8 * V_227 ;
V_12 -> V_254 = V_340 ;
return V_339 ;
}
static T_7 F_294 ( struct V_315 * V_316 ,
const char * V_337 , T_8 V_339 )
{
struct V_6 * V_12 = V_316 -> V_10 ;
unsigned long V_340 ;
