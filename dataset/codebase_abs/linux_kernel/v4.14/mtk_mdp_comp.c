...
if ( F_7 ( V_14 -> V_17 [ V_9 ] ) )
continue;
V_15 = F_8 ( V_14 -> V_17 [ V_9 ] ) ;
if ( V_15 )
F_4 ( V_2 ,
L_3 ,
...
void F_9 ( struct V_1 * V_2 , struct V_13 * V_14 )
{
int V_9 ;
for ( V_9 = 0 ; V_9 < F_3 ( V_14 -> V_17 ) ; V_9 ++ ) {
if ( F_7 ( V_14 -> V_17 [ V_9 ] ) )
...
V_14 -> V_25 = F_14 ( V_4 , 0 ) ;
for ( V_9 = 0 ; V_9 < F_3 ( V_14 -> V_17 ) ; V_9 ++ ) {
V_14 -> V_17 [ V_9 ] = F_15 ( V_4 , V_9 ) ;
if ( V_14 -> type != V_26 )
break;
}
V_14 -> V_16 = NULL ;
...
void F_20 ( struct V_1 * V_2 , struct V_13 * V_14 )
{
F_19 ( V_14 -> V_24 ) ;
}
