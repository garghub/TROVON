...
return F_37 ( V_2 , V_92 ) ;
}
static int F_38 ( struct V_1 * V_2 , T_3 V_111 ,
union V_112 * V_22 )
{
int V_75 = 0 ;
switch ( V_111 ) {
case V_113 :
* V_22 = F_39 ( V_111 , V_2 -> V_31 . V_114 ) ;
break;
default:
V_75 = F_40 ( V_2 , V_111 , V_22 ) ;
}
return V_75 ;
}
static int F_41 ( struct V_1 * V_2 , T_3 V_111 ,
union V_112 * V_22 )
{
int V_75 = 0 ;
switch ( V_111 ) {
case V_113 :
V_2 -> V_31 . V_114 = F_42 ( V_111 , * V_22 ) ;
break;
default:
V_75 = F_43 ( V_2 , V_111 , V_22 ) ;
}
return V_75 ;
}
static struct V_1 * F_44 ( struct V_115 * V_115 ,
unsigned int V_111 )
{
struct V_15 * V_16 ;
struct V_1 * V_2 ;
int V_116 ;
V_16 = F_45 ( V_117 , V_118 ) ;
if ( ! V_16 ) {
V_116 = - V_119 ;
goto V_120;
}
...
V_116 = F_46 ( V_2 , V_115 , V_111 ) ;
if ( V_116 )
goto V_121;
V_116 = F_47 ( V_16 ) ;
if ( V_116 )
goto V_122;
V_2 -> V_31 . V_54 = ( void * ) F_48 ( V_118 | V_123 ) ;
if ( ! V_2 -> V_31 . V_54 ) {
V_116 = - V_119 ;
goto V_124;
}
...
{
struct V_15 * V_16 = F_22 ( V_2 ) ;
F_54 ( ( unsigned long ) V_2 -> V_31 . V_54 ) ;
F_49 ( V_16 ) ;
F_50 ( V_2 ) ;
F_51 ( V_117 , V_16 ) ;
}
static int F_55 ( struct V_115 * V_115 )
{
int V_125 ;
V_125 = F_56 () ;
if ( V_125 < 0 )
...
static void F_57 ( struct V_115 * V_115 )
{
...
F_61 ( V_128 / V_126 ) ;
F_62 ( 0 ) ;
V_75 = F_63 ( NULL , sizeof( struct V_15 ) , 0 , V_129 ) ;
if ( V_75 )
goto V_127;
V_130 . V_131 = V_129 ;
V_132 = & V_130 ;
