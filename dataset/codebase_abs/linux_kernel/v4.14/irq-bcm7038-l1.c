...
F_44 ( V_28 , & V_39 , false ) ;
}
static int T_4 F_45 ( struct V_40 * V_41 ,
unsigned int V_16 ,
struct V_1 * V_2 )
{
struct V_42 V_43 ;
...
return - V_47 ;
V_13 = V_2 -> V_17 [ V_16 ] = F_48 ( sizeof( * V_13 ) + V_4 * sizeof( V_5 ) ,
V_50 ) ;
if ( ! V_13 )
return - V_51 ;
V_13 -> V_24 = F_49 ( V_43 . V_52 , V_44 ) ;
if ( ! V_13 -> V_24 )
return - V_51 ;
...
static int F_53 ( struct V_53 * V_28 , unsigned int V_54 ,
T_2 V_55 )
{
F_54 ( V_54 , & V_56 , V_57 ) ;
F_55 ( V_54 , V_28 -> V_58 ) ;
...
int T_4 F_59 ( struct V_40 * V_41 ,
struct V_40 * V_59 )
{
struct V_1 * V_2 ;
int V_16 , V_60 ;
V_2 = F_48 ( sizeof( * V_2 ) , V_50 ) ;
if ( ! V_2 )
return - V_51 ;
F_60 ( & V_2 -> V_23 ) ;
F_61 (idx) {
V_60 = F_45 ( V_41 , V_16 , V_2 ) ;
if ( V_60 < 0 ) {
if ( V_16 )
break;
F_51 ( L_2 ) ;
...
V_2 -> V_26 = F_62 ( V_41 , V_19 * V_2 -> V_4 ,
& V_62 ,
V_2 ) ;
if ( ! V_2 -> V_26 ) {
V_60 = - V_51 ;
