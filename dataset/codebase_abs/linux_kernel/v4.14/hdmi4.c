...
static int F_92 ( struct V_98 * V_4 , struct V_98 * V_110 , void * V_7 )
{
struct V_83 * V_3 = F_93 ( V_4 ) ;
int V_1 ;
int V_6 ;
V_2 . V_3 = V_3 ;
F_94 ( & V_3 -> V_4 , & V_2 ) ;
...
if ( V_1 )
return V_1 ;
V_1 = F_97 ( V_3 , & V_2 . V_9 , 4 ) ;
if ( V_1 )
return V_1 ;
V_1 = F_98 ( V_3 , & V_2 . V_40 , & V_2 . V_9 ) ;
if ( V_1 )
return V_1 ;
V_1 = F_99 ( V_3 , & V_2 . V_44 , 4 ) ;
if ( V_1 )
goto V_97;
V_1 = F_100 ( V_3 , & V_2 . V_49 ) ;
if ( V_1 )
goto V_97;
V_6 = F_101 ( V_3 , 0 ) ;
if ( V_6 < 0 ) {
...
static void F_107 ( struct V_98 * V_4 , struct V_98 * V_110 , void * V_7 )
{
struct V_83 * V_3 = F_93 ( V_4 ) ;
if ( V_2 . V_108 )
F_108 ( V_2 . V_108 ) ;
...
static int F_109 ( struct V_83 * V_3 )
{
return F_110 ( & V_3 -> V_4 , & V_112 ) ;
}
static int F_111 ( struct V_83 * V_3 )
{
F_112 ( & V_3 -> V_4 , & V_112 ) ;
return 0 ;
}
static int F_113 ( struct V_98 * V_4 )
{
F_114 () ;
return 0 ;
}
static int F_115 ( struct V_98 * V_4 )
{
int V_1 ;
V_1 = F_116 () ;
if ( V_1 < 0 )
