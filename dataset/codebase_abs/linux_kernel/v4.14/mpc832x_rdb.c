...
static void F_18 ( struct V_6 * V_28 , bool V_8 )
{
F_19 ( L_10 , V_30 , V_28 -> V_31 , V_8 ) ;
F_20 ( 3 , 13 , V_8 ) ;
}
...
F_26 () ;
#ifdef V_33
if ( ( V_10 = F_27 ( NULL , L_12 ) ) != NULL ) {
F_28 ( V_10 ) ;
F_29 ( V_10 ) ;
for ( V_10 = NULL ; ( V_10 = F_27 ( V_10 , L_13 ) ) != NULL ; )
F_30 ( V_10 ) ;
}
#endif
}
