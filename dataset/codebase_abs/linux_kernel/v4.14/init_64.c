...
int F_98 ( int V_94 , unsigned long V_95 ,
unsigned long V_96 , bool V_97 )
{
int V_98 ;
V_98 = F_99 ( V_94 , V_95 , V_96 , V_97 ) ;
F_100 ( V_98 ) ;
F_96 ( V_95 << V_50 ,
V_96 << V_50 ) ;
return V_98 ;
}
int F_101 ( int V_94 , T_11 V_4 , T_11 V_33 , bool V_97 )
{
unsigned long V_95 = V_4 >> V_50 ;
unsigned long V_96 = V_33 >> V_50 ;
F_102 ( V_4 , V_4 + V_33 ) ;
return F_98 ( V_94 , V_95 , V_96 , V_97 ) ;
}
static void T_10 F_103 ( struct V_9 * V_9 , int V_99 )
{
unsigned long V_100 ;
unsigned int V_96 = 1 << V_99 ;
struct V_101 * V_102 = F_104 ( ( unsigned long ) V_9 ) ;
if ( V_102 ) {
F_105 ( V_102 , V_96 ) ;
return;
}
...
F_110 ( ( unsigned long ) F_8 ( V_9 ) , V_99 ) ;
}
static void T_10 F_111 ( T_8 * V_106 , T_7 * V_26 )
{
T_8 * V_27 ;
int V_58 ;
...
static void T_10 F_113 ( T_7 * V_107 , T_6 * V_25 )
{
T_7 * V_26 ;
int V_58 ;
...
static void T_10 F_115 ( T_6 * V_108 , T_4 * V_15 )
{
T_6 * V_25 ;
int V_58 ;
...
static void T_10
F_117 ( T_8 * V_106 , unsigned long V_6 , unsigned long V_5 ,
bool V_109 )
{
...
if ( ! F_118 ( * V_27 ) )
continue;
V_112 = F_119 ( * V_27 ) + ( V_6 & V_21 ) ;
if ( V_112 < ( V_83 ) 0x40000000 )
return;
if ( F_120 ( V_6 ) && F_120 ( V_110 ) ) {
if ( ! V_109 )
F_103 ( V_52 ( * V_27 ) , 0 ) ;
F_6 ( & V_23 . V_13 ) ;
F_121 ( & V_23 , V_6 , V_27 ) ;
...
static void T_10
F_124 ( T_7 * V_107 , unsigned long V_6 , unsigned long V_5 ,
bool V_109 )
{
unsigned long V_110 , V_55 = 0 ;
T_8 * V_114 ;
...
static void T_10
F_129 ( T_6 * V_108 , unsigned long V_6 , unsigned long V_5 ,
bool V_109 )
{
unsigned long V_110 , V_55 = 0 ;
T_7 * V_115 ;
...
static void T_10
F_132 ( T_4 * V_116 , unsigned long V_6 , unsigned long V_5 ,
bool V_109 )
{
unsigned long V_110 , V_55 = 0 ;
T_6 * V_117 ;
...
static void T_10
F_136 ( unsigned long V_4 , unsigned long V_5 , bool V_109 )
{
unsigned long V_110 ;
unsigned long V_6 ;
T_2 * V_11 ;
...
continue;
V_15 = F_16 ( V_11 , 0 ) ;
F_132 ( V_15 , V_6 , V_110 , V_109 ) ;
}
F_123 () ;
}
void T_5 F_139 ( unsigned long V_4 , unsigned long V_5 )
{
F_136 ( V_4 , V_5 , false ) ;
}
static void T_10
F_140 ( unsigned long V_4 , unsigned long V_5 )
{
V_4 = ( unsigned long ) F_54 ( V_4 ) ;
V_5 = ( unsigned long ) F_54 ( V_5 ) ;
F_136 ( V_4 , V_5 , true ) ;
}
int T_5 F_141 ( T_11 V_4 , T_11 V_33 )
{
unsigned long V_95 = V_4 >> V_50 ;
unsigned long V_96 = V_33 >> V_50 ;
struct V_9 * V_9 = F_142 ( V_95 ) ;
struct V_101 * V_102 ;
struct V_120 * V_120 ;
int V_98 ;
V_102 = F_104 ( ( unsigned long ) V_9 ) ;
if ( V_102 )
V_9 += F_143 ( V_102 ) ;
V_120 = F_144 ( V_9 ) ;
V_98 = F_145 ( V_120 , V_95 , V_96 ) ;
F_100 ( V_98 ) ;
F_140 ( V_4 , V_4 + V_33 ) ;
return V_98 ;
}
...
F_153 () ;
V_17 = 1 ;
F_154 ( & V_121 , ( void * ) V_122 ,
V_20 , V_123 ) ;
F_155 ( NULL ) ;
}
void F_156 ( void )
{
unsigned long V_4 = F_157 ( V_51 ) ;
unsigned long V_5 = F_157 ( V_124 ) ;
if ( ! V_125 )
return;
F_24 ( L_14 ,
V_4 , V_5 ) ;
F_158 ( V_4 , ( V_5 - V_4 ) >> V_50 ) ;
}
void F_159 ( void )
{
unsigned long V_4 = F_157 ( V_51 ) ;
...
F_24 ( L_15 ,
V_4 , V_5 ) ;
F_160 ( V_4 , ( V_5 - V_4 ) >> V_50 ) ;
}
void F_161 ( void )
{
unsigned long V_4 = F_157 ( V_51 ) ;
unsigned long V_126 = F_157 ( V_127 ) ;
unsigned long V_5 = ( unsigned long ) & V_128 ;
unsigned long V_129 = F_157 ( & V_124 ) ;
unsigned long V_130 = F_157 ( & V_131 ) ;
unsigned long V_132 ;
F_27 ( V_133 L_16 ,
( V_5 - V_4 ) >> 10 ) ;
F_160 ( V_4 , ( V_5 - V_4 ) >> V_50 ) ;
...
#endif
F_164 ( L_19 ,
( unsigned long ) F_54 ( F_165 ( V_129 ) ) ,
( unsigned long ) F_54 ( F_165 ( V_126 ) ) ) ;
F_164 ( L_19 ,
( unsigned long ) F_54 ( F_165 ( V_130 ) ) ,
( unsigned long ) F_54 ( F_165 ( V_134 ) ) ) ;
F_166 () ;
}
int F_167 ( unsigned long V_6 )
{
...
return 0 ;
if ( F_83 ( * V_25 ) )
return F_168 ( F_169 ( * V_25 ) ) ;
V_26 = F_34 ( V_25 , V_6 ) ;
if ( F_36 ( * V_26 ) )
return 0 ;
if ( F_76 ( * V_26 ) )
return F_168 ( F_170 ( * V_26 ) ) ;
V_27 = F_38 ( V_26 , V_6 ) ;
if ( F_70 ( * V_27 ) )
return 0 ;
return F_168 ( F_171 ( * V_27 ) ) ;
}
static unsigned long F_172 ( void )
{
unsigned long V_137 = V_138 ;
if ( F_173 () || ( ( V_91 << V_50 ) >= ( 64UL << 30 ) ) )
V_137 = 2UL << 30 ;
F_71 ( L_20 , V_137 >> 20 ) ;
return V_137 ;
}
unsigned long F_174 ( void )
{
if ( ! V_139 )
V_139 = F_172 () ;
return V_139 ;
}
static int T_10 F_175 ( unsigned long V_4 ,
...
for ( V_6 = V_4 ; V_6 < V_5 ; V_6 = V_110 ) {
V_110 = F_125 ( V_6 , V_5 ) ;
V_11 = F_176 ( V_6 , V_140 ) ;
if ( ! V_11 )
return - V_141 ;
V_15 = F_177 ( V_11 , V_6 , V_140 ) ;
if ( ! V_15 )
return - V_141 ;
V_25 = F_178 ( V_15 , V_6 , V_140 ) ;
if ( ! V_25 )
return - V_141 ;
V_26 = F_34 ( V_25 , V_6 ) ;
if ( F_36 ( * V_26 ) ) {
void * V_142 ;
V_142 = F_179 ( V_39 , V_140 , V_102 ) ;
if ( V_142 ) {
T_8 V_143 ;
V_143 = F_72 ( F_56 ( V_142 ) >> V_50 ,
V_37 ) ;
F_60 ( V_26 , F_61 ( F_119 ( V_143 ) ) ) ;
...
F_180 ( ( T_8 * ) V_26 , V_140 , V_6 , V_110 ) ;
continue;
}
F_181 ( L_22 ) ;
if ( F_182 ( V_6 , V_110 , V_140 ) )
return - V_141 ;
}
return 0 ;
}
int T_10 F_183 ( unsigned long V_4 , unsigned long V_5 , int V_140 )
{
struct V_101 * V_102 = F_104 ( V_4 ) ;
int V_149 ;
if ( F_184 ( V_150 ) )
V_149 = F_175 ( V_4 , V_5 , V_140 , V_102 ) ;
else if ( V_102 ) {
F_185 ( L_23 ,
V_151 ) ;
V_149 = - V_141 ;
} else
V_149 = F_182 ( V_4 , V_5 , V_140 ) ;
if ( ! V_149 )
F_2 ( V_4 , V_5 - 1 ) ;
return V_149 ;
}
void F_186 ( unsigned long V_152 ,
...
F_187 ( V_152 , F_188 ( * V_11 ) , V_105 ) ;
V_15 = F_16 ( V_11 , V_6 ) ;
if ( F_17 ( * V_15 ) ) {
V_110 = ( V_6 + V_20 ) & V_21 ;
continue;
}
F_187 ( V_152 , V_29 ( * V_15 ) , V_105 ) ;
V_25 = F_30 ( V_15 , V_6 ) ;
if ( F_32 ( * V_25 ) ) {
V_110 = ( V_6 + V_20 ) & V_21 ;
continue;
}
F_187 ( V_152 , V_30 ( * V_25 ) , V_105 ) ;
if ( ! F_184 ( V_150 ) ) {
V_110 = ( V_6 + V_20 ) & V_21 ;
V_26 = F_34 ( V_25 , V_6 ) ;
if ( F_36 ( * V_26 ) )
continue;
F_187 ( V_152 , V_64 ( * V_26 ) ,
V_105 ) ;
V_27 = F_38 ( V_26 , V_6 ) ;
if ( F_70 ( * V_27 ) )
continue;
F_187 ( V_152 , V_52 ( * V_27 ) ,
V_104 ) ;
} else {
V_110 = F_125 ( V_6 , V_5 ) ;
V_26 = F_34 ( V_25 , V_6 ) ;
