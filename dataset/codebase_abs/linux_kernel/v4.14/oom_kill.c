...
F_64 ( V_74 , & V_9 -> V_17 ) ;
F_65 ( & V_67 , V_9 , 0 , - 1 ) ;
for ( V_69 = V_9 -> V_75 ; V_69 ; V_69 = V_69 -> V_76 ) {
if ( ! F_66 ( V_69 ) )
continue;
if ( F_67 ( V_69 ) || ! ( V_69 -> V_77 & V_78 ) )
F_68 ( & V_67 , V_69 , V_69 -> V_79 , V_69 -> V_80 ,
NULL ) ;
}
F_69 ( & V_67 , 0 , - 1 ) ;
F_43 ( L_8 ,
...
static inline void F_80 ( struct V_1 * V_4 )
{
}
...
if ( F_90 ( V_4 , V_93 ) )
return;
if ( ! F_91 ( & V_4 -> signal -> V_51 , NULL , V_9 ) )
F_92 ( V_4 -> signal -> V_51 ) ;
F_93 ( V_4 ) ;
F_94 ( & V_94 ) ;
F_95 ( V_4 -> V_56 ) ;
}
...
static inline bool F_105 ( struct V_1 * V_48 )
{
...
if ( V_98 -> V_17 & V_100 )
return true ;
if ( F_106 ( V_48 ) && ( V_48 -> V_17 & V_101 ) )
return true ;
return false ;
}
static bool F_107 ( struct V_1 * V_48 )
{
...
static void F_109 ( struct V_11 * V_12 , const char * V_103 )
{
...
F_46 ( V_12 , V_7 ) ;
F_86 ( L_14 ,
V_103 , F_70 ( V_7 ) , V_7 -> V_60 , V_20 ) ;
F_112 ( & V_111 ) ;
F_3 (p, t) {
F_113 (child, &t->children, sibling) {
unsigned int V_112 ;
...
F_115 ( V_113 ) ;
F_116 ( V_9 , V_113 ) ;
F_117 ( V_114 , V_115 , V_104 , true ) ;
F_88 ( V_104 ) ;
F_86 ( L_15 ,
F_70 ( V_104 ) , V_104 -> V_60 , F_71 ( V_104 -> V_9 -> V_59 ) ,
F_71 ( F_20 ( V_104 -> V_9 , V_81 ) ) ,
F_71 ( F_20 ( V_104 -> V_9 , V_82 ) ) ,
F_71 ( F_20 ( V_104 -> V_9 , V_83 ) ) ) ;
F_10 ( V_104 ) ;
F_2 () ;
F_41 (p) {
if ( ! F_54 ( V_7 , V_9 ) )
...
F_64 ( V_24 , & V_9 -> V_17 ) ;
F_43 ( L_16 ,
F_70 ( V_104 ) , V_104 -> V_60 ,
F_70 ( V_7 ) , V_7 -> V_60 ) ;
continue;
}
if ( F_118 ( V_7 -> V_17 & V_18 ) )
continue;
F_117 ( V_114 , V_115 , V_7 , true ) ;
}
F_6 () ;
if ( V_110 )
F_80 ( V_104 ) ;
...
{
return F_123 ( & V_120 , V_119 ) ;
}
int F_124 ( struct V_118 * V_119 )
{
return F_125 ( & V_120 , V_119 ) ;
}
bool F_126 ( struct V_11 * V_12 )
{
