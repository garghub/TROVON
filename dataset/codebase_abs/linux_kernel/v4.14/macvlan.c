...
V_10 -> V_141 |= V_142 ;
V_10 -> V_143 |= V_10 -> V_105 ;
V_10 -> V_144 = V_89 -> V_144 ;
V_10 -> V_145 = V_89 -> V_145 ;
V_10 -> V_146 = V_89 -> V_146 ;
F_121 ( V_10 ) ;
...
if ( V_13 -> V_96 ) {
struct V_95 * V_120 ;
T_2 V_150 , V_151 , V_152 , V_98 , V_99 ;
T_1 V_153 = 0 , V_100 = 0 ;
unsigned int V_154 ;
int V_46 ;
F_130 (i) {
...
do {
V_154 = F_132 ( & V_120 -> V_97 ) ;
V_150 = V_120 -> V_150 ;
V_151 = V_120 -> V_151 ;
V_152 = V_120 -> V_152 ;
V_98 = V_120 -> V_98 ;
V_99 = V_120 -> V_99 ;
} while ( F_133 ( & V_120 -> V_97 , V_154 ) );
V_149 -> V_150 += V_150 ;
V_149 -> V_151 += V_151 ;
V_149 -> V_155 += V_152 ;
V_149 -> V_98 += V_98 ;
...
struct V_12 * V_13 = F_78 ( V_10 ) ;
struct V_9 * V_89 = V_13 -> V_89 ;
F_137 ( V_89 , V_156 , V_157 ) ;
return 0 ;
}
static int F_138 ( struct V_158 * V_159 , struct V_160 * V_161 [] ,
struct V_9 * V_10 ,
const unsigned char * V_6 , T_6 V_157 ,
T_6 V_3 )
{
struct V_12 * V_13 = F_78 ( V_10 ) ;
int V_47 = - V_131 ;
...
static int F_142 ( struct V_158 * V_159 , struct V_160 * V_161 [] ,
struct V_9 * V_10 ,
const unsigned char * V_6 , T_6 V_157 )
{
struct V_12 * V_13 = F_78 ( V_10 ) ;
...
struct V_164 * V_165 )
{
F_145 ( V_165 -> V_166 , L_1 , sizeof( V_165 -> V_166 ) ) ;
F_145 ( V_165 -> V_167 , L_2 , sizeof( V_165 -> V_167 ) ) ;
}
static int F_146 ( struct V_9 * V_10 ,
struct V_168 * V_169 )
{
const struct V_12 * V_13 = F_78 ( V_10 ) ;
return F_147 ( V_13 -> V_89 , V_169 ) ;
}
static T_7 F_148 ( struct V_9 * V_10 ,
T_7 V_105 )
{
struct V_12 * V_13 = F_78 ( V_10 ) ;
T_7 V_170 = V_13 -> V_89 -> V_105 ;
T_7 V_171 ;
V_105 |= V_172 ;
V_105 &= ( V_13 -> V_173 | ~ V_137 ) ;
V_171 = V_105 ;
V_170 &= ( V_105 | ~ V_140 ) ;
V_105 = F_149 ( V_170 , V_105 , V_171 ) ;
V_105 |= V_138 ;
V_105 &= ~ V_174 ;
return V_105 ;
}
...
static int F_151 ( struct V_9 * V_10 , struct V_175 * V_176 )
{
struct V_12 * V_13 = F_78 ( V_10 ) ;
struct V_9 * V_177 = V_13 -> V_89 ;
struct V_91 * V_91 ;
int V_47 = 0 ;
...
unsigned int V_46 ;
int V_47 ;
if ( V_10 -> type != V_192 || V_10 -> V_3 & V_193 )
return - V_131 ;
if ( F_163 ( V_10 ) )
return - V_111 ;
...
struct V_121 V_195 ;
V_195 . V_196 = V_2 -> V_10 -> type ;
memcpy ( & V_195 . V_122 , V_2 -> V_119 , V_2 -> V_10 -> V_197 ) ;
F_107 ( V_2 -> V_10 , & V_195 ) ;
}
F_154 ( V_2 ) ;
}
static int F_171 ( struct V_160 * V_161 [] , struct V_160 * V_87 [] ,
struct V_198 * V_199 )
{
if ( V_161 [ V_200 ] ) {
if ( F_172 ( V_161 [ V_200 ] ) != V_28 )
return - V_131 ;
if ( ! F_105 ( F_173 ( V_161 [ V_200 ] ) ) )
return - V_123 ;
}
if ( V_87 && V_87 [ V_201 ] &&
F_174 ( V_87 [ V_201 ] ) & ~ V_103 )
return - V_131 ;
if ( V_87 && V_87 [ V_202 ] ) {
switch ( F_175 ( V_87 [ V_202 ] ) ) {
case V_66 :
case V_67 :
case V_55 :
case V_68 :
...
if ( V_87 && V_87 [ V_209 ] ) {
if ( F_172 ( V_87 [ V_209 ] ) != V_28 )
return - V_131 ;
if ( ! F_105 ( F_173 ( V_87 [ V_209 ] ) ) )
return - V_123 ;
}
if ( V_87 && V_87 [ V_210 ] )
return - V_131 ;
...
char * V_6 = NULL ;
int V_74 , V_211 , V_56 ;
struct V_160 * V_212 , * V_213 ;
struct V_16 * V_17 ;
if ( V_87 [ V_209 ] )
V_6 = F_173 ( V_87 [ V_209 ] ) ;
if ( V_44 == V_205 ) {
if ( ! V_6 )
return - V_131 ;
...
if ( ! V_87 || ! V_87 [ V_214 ] )
return 0 ;
V_213 = F_173 ( V_87 [ V_214 ] ) ;
V_56 = F_172 ( V_87 [ V_214 ] ) ;
F_177 (nla, head, len, rem) {
if ( F_178 ( V_212 ) != V_209 ||
F_172 ( V_212 ) != V_28 )
continue;
V_6 = F_173 ( V_212 ) ;
V_74 = F_18 ( V_13 , V_6 ) ;
...
int F_179 ( struct V_215 * V_216 , struct V_9 * V_10 ,
struct V_160 * V_161 [] , struct V_160 * V_87 [] )
{
struct V_12 * V_13 = F_78 ( V_10 ) ;
struct V_1 * V_2 ;
struct V_9 * V_89 ;
...
if ( ! V_161 [ V_219 ] )
return - V_131 ;
V_89 = F_180 ( V_216 , F_175 ( V_161 [ V_219 ] ) ) ;
if ( V_89 == NULL )
return - V_220 ;
if ( F_181 ( V_89 ) )
V_89 = F_182 ( V_89 ) ;
...
V_13 -> V_44 = V_67 ;
if ( V_87 && V_87 [ V_202 ] )
V_13 -> V_44 = F_175 ( V_87 [ V_202 ] ) ;
if ( V_87 && V_87 [ V_201 ] )
V_13 -> V_3 = F_174 ( V_87 [ V_201 ] ) ;
if ( V_13 -> V_44 == V_68 ) {
if ( V_2 -> V_147 ) {
V_47 = - V_131 ;
goto V_223;
...
V_217 = F_175 ( V_87 [ V_204 ] ) ;
V_47 = F_176 ( V_13 , V_217 , V_87 ) ;
if ( V_47 )
goto V_223;
}
V_47 = F_187 ( V_10 ) ;
...
static int F_193 ( struct V_215 * V_216 , struct V_9 * V_10 ,
struct V_160 * V_161 [] , struct V_160 * V_87 [] ,
struct V_198 * V_199 )
{
return F_179 ( V_216 , V_10 , V_161 , V_87 ) ;
}
void F_194 ( struct V_9 * V_10 , struct V_226 * V_213 )
{
struct V_12 * V_13 = F_78 ( V_10 ) ;
if ( V_13 -> V_44 == V_203 )
F_64 ( V_13 -> V_2 , V_13 ) ;
...
if ( V_87 && V_87 [ V_201 ] ) {
T_8 V_3 = F_174 ( V_87 [ V_201 ] ) ;
bool V_229 = ( V_3 ^ V_13 -> V_3 ) & V_103 ;
if ( F_1 ( V_13 -> V_2 ) && V_229 ) {
int V_47 ;
if ( V_3 & V_103 )
...
return 0 ;
return F_200 ( 0 )
+ V_13 -> V_24 * F_200 ( sizeof( V_230 ) * V_28 ) ;
}
...
if ( V_17 -> V_13 != V_13 )
continue;
if ( F_203 ( V_30 , V_209 , V_28 , V_17 -> V_6 ) )
return 1 ;
}
return 0 ;
}
...
int V_46 ;
struct V_160 * V_231 ;
if ( F_205 ( V_30 , V_202 , V_13 -> V_44 ) )
goto V_232;
if ( F_206 ( V_30 , V_201 , V_13 -> V_3 ) )
goto V_232;
if ( F_205 ( V_30 , V_210 , V_13 -> V_24 ) )
goto V_232;
if ( V_13 -> V_24 > 0 ) {
V_231 = F_207 ( V_30 , V_214 ) ;
if ( V_231 == NULL )
goto V_232;
for ( V_46 = 0 ; V_46 < V_51 ; V_46 ++ ) {
...
static struct V_215 * F_211 ( const struct V_9 * V_10 )
{
return F_74 ( F_182 ( V_10 ) ) ;
}
static int F_212 ( struct V_243 * V_244 ,
unsigned long V_245 , void * V_246 )
{
struct V_9 * V_10 = F_213 ( V_246 ) ;
struct V_12 * V_13 , * V_247 ;
struct V_1 * V_2 ;
F_214 ( V_248 ) ;
if ( ! F_184 ( V_10 ) )
return V_249 ;
...
V_13 -> V_10 -> V_107 -> V_259 ( V_13 -> V_10 , & V_248 ) ;
F_220 ( & V_248 ) ;
break;
case V_260 :
return V_255 ;
