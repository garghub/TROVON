...
int V_58 , unsigned long V_59 ,
void * V_39 , unsigned long V_60 )
{
struct V_7 * V_8 = V_4 -> V_9 ;
struct V_15 * V_16 = V_4 -> V_16 ;
...
memcpy ( V_65 , V_64 , V_60 ) ;
}
return 0 ;
}
static int F_34 ( struct V_2 * V_4 ,
int V_58 , unsigned long V_59 ,
void T_3 * V_39 , unsigned long V_60 )
{
return F_33 ( V_4 , V_58 , V_59 , ( void * ) V_39 , V_60 ) ;
}
...
V_12 = F_5 ( V_8 -> V_13 , V_4 ) ;
if ( V_12 -> V_14 ) {
V_67 = F_26 ( V_16 , V_59 ) * 8 * V_61 ;
V_68 = F_26 ( V_16 , V_60 ) * 8 ;
} else {
V_67 = V_59 ;
V_68 = F_36 ( V_16 , V_60 ) ;
}
F_37 ( V_16 -> V_69 , V_39 + V_67 , V_68 ) ;
return 0 ;
}
