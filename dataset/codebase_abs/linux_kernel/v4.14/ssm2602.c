...
struct V_15 * V_16 = F_4 ( V_14 ) ;
int V_68 ;
V_68 = F_6 ( V_16 -> V_19 , V_78 , 0 ) ;
if ( V_68 < 0 ) {
F_24 ( V_14 -> V_79 , L_1 , V_68 ) ;
return V_68 ;
}
F_8 ( V_16 -> V_19 , V_80 ,
V_81 , V_81 ) ;
...
static bool F_25 ( struct V_89 * V_79 , unsigned int V_90 )
{
return V_90 == V_78 ;
}
int F_26 ( struct V_89 * V_79 , enum V_91 type ,
struct V_19 * V_19 )
{
struct V_15 * V_16 ;
if ( F_27 ( V_19 ) )
return F_28 ( V_19 ) ;
V_16 = F_29 ( V_79 , sizeof( * V_16 ) , V_92 ) ;
if ( V_16 == NULL )
return - V_93 ;
F_30 ( V_79 , V_16 ) ;
V_16 -> type = type ;
V_16 -> V_19 = V_19 ;
return F_31 ( V_79 , & V_94 ,
& V_95 , 1 ) ;
}
