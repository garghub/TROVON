...
static int F_69 ( struct V_10 * V_11 , struct V_49 * V_49 )
{
struct V_19 * V_20 = V_11 -> V_35 ;
...
{
if ( V_20 -> V_33 == V_37 )
F_71 ( F_23 ( V_20 -> V_11 -> V_36 ) ) ;
else if ( V_20 -> V_33 == V_39 )
F_67 ( V_98 , & V_20 -> V_40 ) ;
}
static void V_40 ( struct V_102 * V_103 )
{
int V_104 ;
unsigned long V_24 ;
struct V_49 * V_49 ;
...
F_75 ( & V_106 , & V_20 -> V_97 ) ;
F_73 ( & V_20 -> V_97 ) ;
F_44 ( & V_20 -> V_22 , V_24 ) ;
F_76 ( & V_108 ) ;
while ( ( V_49 = F_77 ( & V_106 ) ) ) {
V_104 = F_65 ( V_20 , V_49 , F_28 ( V_49 ) ) ;
switch ( V_104 ) {
case V_82 :
V_49 -> V_100 = V_109 ;
F_78 ( V_49 ) ;
...
static void F_82 ( bool V_111 , long V_112 , unsigned long * V_113 )
{
if ( V_111 )
F_16 ( V_112 , V_113 ) ;
else
...
static int F_83 ( struct V_19 * V_20 , bool F_83 ,
bool V_114 )
{
unsigned long V_24 ;
F_43 ( & V_20 -> V_22 , V_24 ) ;
F_82 ( ( V_114 && F_36 ( V_80 , & V_20 -> V_24 ) ) ||
( ! V_114 && F_83 ) ,
V_115 , & V_20 -> V_24 ) ;
F_82 ( F_83 || F_84 ( V_20 -> V_11 ) ,
V_80 , & V_20 -> V_24 ) ;
F_44 ( & V_20 -> V_22 , V_24 ) ;
if ( ! F_83 ) {
F_85 ( V_20 -> V_11 -> V_36 ) ;
...
static void V_30 ( struct V_102 * V_103 )
{
struct V_19 * V_20 =
F_72 ( V_103 , struct V_19 , V_30 ) ;
F_86 ( V_20 -> V_11 -> V_36 ) ;
}
static int F_87 ( struct V_116 * V_117 , struct V_6 * V_7 ,
struct V_10 * V_11 )
{
int V_104 ;
struct V_118 * V_119 ;
...
V_119 = F_88 ( F_89 ( V_117 ) ) ;
if ( ! V_119 ) {
V_11 -> error = L_6 ;
return - V_123 ;
}
V_104 = F_90 ( V_122 , V_117 , & V_120 , & V_11 -> error ) ;
if ( V_104 ) {
F_13 ( V_119 ) ;
return - V_123 ;
}
V_104 = V_119 -> V_124 ( & V_7 -> V_17 , V_120 , V_117 -> V_125 ) ;
if ( V_104 ) {
F_13 ( V_119 ) ;
V_11 -> error = L_7 ;
return V_104 ;
...
static struct V_1 * F_92 ( struct V_116 * V_117 , struct V_16 * V_17 ,
struct V_10 * V_11 )
{
int V_104 ;
struct V_1 * V_126 ;
...
if ( ! V_126 )
return F_47 ( - V_129 ) ;
V_104 = F_93 ( V_11 , F_89 ( V_117 ) , F_94 ( V_11 -> V_36 ) ,
& V_126 -> V_14 . V_15 ) ;
if ( V_104 ) {
V_11 -> error = L_9 ;
goto V_130;
...
if ( V_20 -> V_42 ) {
V_104 = F_96 ( V_78 , V_20 -> V_42 ) ;
if ( V_104 == - V_132 ) {
char V_133 [ V_134 ] ;
F_97 ( V_135 L_10 ,
F_98 ( V_126 -> V_14 . V_15 -> V_76 , V_133 ) ) ;
goto V_131;
}
if ( V_104 < 0 ) {
V_11 -> error = L_11 ;
...
V_104 = V_17 -> type -> V_136 ( V_17 , & V_126 -> V_14 , V_117 -> V_128 , V_117 -> V_125 , & V_11 -> error ) ;
if ( V_104 ) {
F_11 ( V_11 , V_126 -> V_14 . V_15 ) ;
goto V_130;
}
...
static struct V_6 * F_100 ( struct V_116 * V_117 ,
struct V_19 * V_20 )
{
static const struct V_121 V_122 [] = {
{ 1 , 1024 , L_14 } ,
...
V_7 -> V_20 = V_20 ;
V_104 = F_87 ( V_117 , V_7 , V_11 ) ;
if ( V_104 )
goto V_130;
V_104 = F_101 ( V_122 , V_117 , & V_7 -> V_140 , & V_11 -> error ) ;
if ( V_104 )
goto V_130;
V_104 = F_101 ( V_122 + 1 , V_117 , & V_138 , & V_11 -> error ) ;
if ( V_104 )
goto V_130;
V_139 = 1 + V_138 ;
...
V_1 = F_92 ( & V_141 , & V_7 -> V_17 , V_11 ) ;
if ( F_58 ( V_1 ) ) {
V_104 = F_61 ( V_1 ) ;
goto V_130;
}
V_1 -> V_7 = V_7 ;
F_102 ( & V_1 -> V_13 , & V_7 -> V_8 ) ;
F_91 ( V_117 , V_139 ) ;
}
return V_7 ;
V_130:
...
static int F_103 ( struct V_116 * V_117 , struct V_19 * V_20 )
{
unsigned V_142 ;
int V_61 ;
struct V_10 * V_11 = V_20 -> V_11 ;
...
if ( F_90 ( V_122 , V_117 , & V_142 , & V_11 -> error ) )
return - V_123 ;
if ( ! V_142 )
return 0 ;
if ( V_20 -> V_33 == V_39 ) {
...
V_20 -> V_42 = F_105 ( F_89 ( V_117 ) , V_2 ) ;
if ( ! V_20 -> V_42 )
return - V_123 ;
if ( V_142 > 1 ) {
char * V_126 ;
...
V_143 = sprintf ( V_126 , L_22 , V_142 - 1 ) ;
for ( V_137 = 0 , V_126 += V_143 + 1 ; V_137 <= V_142 - 2 ; V_137 ++ , V_126 += V_143 + 1 )
V_143 = sprintf ( V_126 , L_23 , V_117 -> V_125 [ V_137 ] ) ;
}
F_91 ( V_117 , V_142 - 1 ) ;
return 0 ;
V_145:
...
static int F_106 ( struct V_116 * V_117 , struct V_19 * V_20 )
{
int V_104 ;
unsigned V_128 ;
struct V_10 * V_11 = V_20 -> V_11 ;
...
V_104 = F_90 ( V_122 , V_117 , & V_128 , & V_11 -> error ) ;
if ( V_104 )
return - V_123 ;
if ( ! V_128 )
return 0 ;
...
( V_128 >= 1 ) ) {
V_104 = F_101 ( V_122 + 1 , V_117 , & V_20 -> V_147 , & V_11 -> error ) ;
V_128 -- ;
continue;
}
if ( ! strcasecmp ( V_146 , L_30 ) &&
( V_128 >= 1 ) ) {
V_104 = F_101 ( V_122 + 2 , V_117 , & V_20 -> V_28 , & V_11 -> error ) ;
V_128 -- ;
continue;
}
if ( ! strcasecmp ( V_146 , L_31 ) &&
( V_128 >= 1 ) ) {
const char * V_148 = F_89 ( V_117 ) ;
if ( ! strcasecmp ( V_148 , L_32 ) )
V_20 -> V_33 = V_39 ;
else if ( ! strcasecmp ( V_148 , L_33 ) )
V_20 -> V_33 = V_38 ;
else if ( ! strcasecmp ( V_148 , L_34 ) )
V_20 -> V_33 = V_37 ;
else {
V_11 -> error = L_35 ;
V_104 = - V_123 ;
...
static int F_107 ( struct V_10 * V_11 , unsigned V_128 , char * * V_125 )
{
static const struct V_121 V_122 [] = {
{ 0 , 1024 , L_37 } ,
{ 0 , 1024 , L_38 } ,
...
V_104 = F_106 ( & V_117 , V_20 ) ;
if ( V_104 )
goto V_130;
V_104 = F_21 ( V_11 , V_20 ) ;
if ( V_104 )
goto V_130;
V_104 = F_103 ( & V_117 , V_20 ) ;
if ( V_104 )
goto V_130;
V_104 = F_101 ( V_122 , & V_117 , & V_20 -> V_151 , & V_11 -> error ) ;
if ( V_104 )
goto V_130;
V_104 = F_101 ( V_122 + 1 , & V_117 , & V_150 , & V_11 -> error ) ;
if ( V_104 )
goto V_130;
if ( ( ! V_20 -> V_151 && V_150 ) ||
( V_20 -> V_151 && ! V_150 ) ) {
...
F_109 ( V_158 ) ;
while ( 1 ) {
F_110 ( & V_20 -> V_31 , & V_158 , V_159 ) ;
if ( ! F_35 ( & V_20 -> V_26 ) )
break;
F_111 () ;
}
F_112 ( & V_20 -> V_31 , & V_158 ) ;
}
...
if ( ! V_1 -> V_3 )
goto V_160;
F_119 ( L_42 , V_1 -> V_14 . V_15 -> V_161 ) ;
V_1 -> V_7 -> V_17 . type -> F_118 ( & V_1 -> V_7 -> V_17 , & V_1 -> V_14 ) ;
V_1 -> V_3 = false ;
V_1 -> V_162 ++ ;
F_120 ( & V_20 -> V_25 ) ;
if ( V_1 == V_20 -> V_66 )
V_20 -> V_66 = NULL ;
F_121 ( V_163 , V_20 -> V_11 ,
...
if ( V_1 -> V_3 )
goto V_160;
F_119 ( L_43 , V_1 -> V_14 . V_15 -> V_161 ) ;
V_104 = V_1 -> V_7 -> V_17 . type -> F_123 ( & V_1 -> V_7 -> V_17 , & V_1 -> V_14 ) ;
if ( V_104 )
goto V_160;
V_1 -> V_3 = true ;
V_25 = F_124 ( & V_20 -> V_25 ) ;
if ( V_25 == 1 ) {
V_20 -> V_66 = NULL ;
V_164 = 1 ;
} else if ( V_20 -> V_42 && ( V_20 -> V_57 == V_1 -> V_7 ) ) {
if ( F_67 ( V_60 , & V_1 -> V_4 . V_103 ) )
F_37 ( & V_20 -> V_26 ) ;
}
F_121 ( V_165 , V_20 -> V_11 ,
...
static int F_125 ( struct V_19 * V_20 , struct V_166 * V_15 ,
T_2 V_167 )
{
int V_104 = - V_123 ;
struct V_1 * V_1 ;
...
static void F_126 ( struct V_19 * V_20 , struct V_6 * V_7 ,
bool V_67 )
{
unsigned long V_24 ;
F_43 ( & V_20 -> V_22 , V_24 ) ;
...
static int F_127 ( struct V_19 * V_20 , const char * V_168 )
{
struct V_6 * V_7 ;
unsigned V_169 ;
unsigned long V_24 ;
char V_170 ;
if ( ! V_168 || ( sscanf ( V_168 , L_44 , & V_169 , & V_170 ) != 1 ) || ! V_169 ||
...
static int F_128 ( struct V_19 * V_20 , const char * V_168 , bool V_67 )
{
struct V_6 * V_7 ;
unsigned V_169 ;
char V_170 ;
...
static bool F_129 ( struct V_19 * V_20 , struct V_1 * V_1 )
{
unsigned long V_24 ;
bool V_171 = false ;
F_43 ( & V_20 -> V_22 , V_24 ) ;
...
static void F_130 ( void * V_172 , int V_173 )
{
...
F_133 ( V_78 , F_130 , V_1 ) ;
else
F_130 ( V_1 , V_181 ) ;
}
static void V_5 ( struct V_102 * V_103 )
{
struct V_1 * V_1 =
F_72 ( V_103 , struct V_1 , V_4 . V_103 ) ;
F_62 ( V_1 ) ;
}
static int F_134 ( T_3 error )
{
switch ( error ) {
case V_182 :
case V_183 :
...
static int F_135 ( struct V_10 * V_11 , struct V_71 * V_79 ,
T_3 error , union V_45 * V_73 )
{
struct V_44 * V_50 = F_26 ( V_73 ) ;
struct V_1 * V_1 = V_50 -> V_1 ;
int V_104 = V_187 ;
if ( error && ! F_134 ( error ) ) {
struct V_19 * V_20 = V_11 -> V_35 ;
V_104 = V_188 ;
if ( V_1 )
F_118 ( V_1 ) ;
...
if ( V_17 -> type -> V_189 )
V_17 -> type -> V_189 ( V_17 , & V_1 -> V_14 , V_50 -> V_62 ) ;
}
return V_104 ;
}
static int F_136 ( struct V_10 * V_11 , struct V_49 * V_79 ,
T_3 * error )
{
struct V_19 * V_20 = V_11 -> V_35 ;
...
unsigned long V_24 ;
F_43 ( & V_20 -> V_22 , V_24 ) ;
F_82 ( F_36 ( V_115 , & V_20 -> V_24 ) ,
V_80 , & V_20 -> V_24 ) ;
F_44 ( & V_20 -> V_22 , V_24 ) ;
}
static void F_143 ( struct V_10 * V_11 , T_4 type ,
...
F_43 ( & V_20 -> V_22 , V_24 ) ;
if ( type == V_197 )
F_144 ( L_50 , F_36 ( V_23 , & V_20 -> V_24 ) ,
F_35 ( & V_20 -> V_27 ) ) ;
else {
F_144 ( L_51 , F_36 ( V_80 , & V_20 -> V_24 ) +
( V_20 -> V_147 > 0 ) * 2 +
( V_20 -> V_28 != V_29 ) * 2 +
F_36 ( V_41 , & V_20 -> V_24 ) +
( V_20 -> V_33 != V_38 ) * 2 ) ;
...
F_144 ( L_52 ) ;
if ( V_20 -> V_147 )
F_144 ( L_53 , V_20 -> V_147 ) ;
if ( V_20 -> V_28 != V_29 )
F_144 ( L_54 , V_20 -> V_28 ) ;
if ( F_36 ( V_41 , & V_20 -> V_24 ) )
F_144 ( L_55 ) ;
if ( V_20 -> V_33 != V_38 ) {
switch( V_20 -> V_33 ) {
...
F_144 ( L_59 , V_20 -> V_42 ) ;
F_144 ( L_51 , V_20 -> V_151 ) ;
if ( V_20 -> V_69 )
...
F_144 ( L_58 ) ;
F_144 ( L_61 , V_7 -> V_140 ,
V_7 -> V_17 . type -> V_199 ) ;
F_40 (p, &pg->pgpaths, list) {
F_144 ( L_62 , V_126 -> V_14 . V_15 -> V_161 ,
V_126 -> V_3 ? L_63 : L_64 ,
V_126 -> V_162 ) ;
if ( V_7 -> V_17 . type -> V_198 )
...
case V_200 :
F_40 (pg, &m->priority_groups, list) {
F_144 ( L_65 , V_7 -> V_17 . type -> V_161 ) ;
if ( V_7 -> V_17 . type -> V_198 )
V_195 += V_7 -> V_17 . type -> V_198 ( & V_7 -> V_17 , NULL , type ,
V_193 + V_195 ,
V_194 - V_195 ) ;
...
V_7 -> V_17 . type -> V_201 ) ;
F_40 (p, &pg->pgpaths, list) {
F_144 ( L_65 , V_126 -> V_14 . V_15 -> V_161 ) ;
if ( V_7 -> V_17 . type -> V_198 )
V_195 += V_7 -> V_17 . type -> V_198 ( & V_7 -> V_17 ,
& V_126 -> V_14 , type , V_193 + V_195 ,
V_194 - V_195 ) ;
...
if ( V_128 == 1 ) {
if ( ! strcasecmp ( V_125 [ 0 ] , L_27 ) ) {
V_104 = F_83 ( V_20 , true , false ) ;
goto V_160;
} else if ( ! strcasecmp ( V_125 [ 0 ] , L_66 ) ) {
V_104 = F_83 ( V_20 , false , false ) ;
goto V_160;
}
}
if ( V_128 != 2 ) {
...
if ( ! strcasecmp ( V_125 [ 0 ] , L_68 ) ) {
V_104 = F_128 ( V_20 , V_125 [ 1 ] , true ) ;
goto V_160;
} else if ( ! strcasecmp ( V_125 [ 0 ] , L_69 ) ) {
V_104 = F_128 ( V_20 , V_125 [ 1 ] , false ) ;
goto V_160;
} else if ( ! strcasecmp ( V_125 [ 0 ] , L_70 ) ) {
V_104 = F_127 ( V_20 , V_125 [ 1 ] ) ;
goto V_160;
} else if ( ! strcasecmp ( V_125 [ 0 ] , L_71 ) )
V_167 = F_123 ;
else if ( ! strcasecmp ( V_125 [ 0 ] , L_72 ) )
V_167 = F_118 ;
else {
F_119 ( L_73 , V_125 [ 0 ] ) ;
goto V_160;
}
V_104 = F_93 ( V_11 , V_125 [ 1 ] , F_94 ( V_11 -> V_36 ) , & V_15 ) ;
if ( V_104 ) {
F_119 ( L_74 ,
V_125 [ 1 ] ) ;
goto V_160;
}
V_104 = F_125 ( V_20 , V_15 , V_167 ) ;
F_11 ( V_11 , V_15 ) ;
V_160:
F_141 ( & V_20 -> V_32 ) ;
return V_104 ;
...
if ( ! V_104 && V_11 -> V_144 != F_149 ( ( * V_76 ) -> V_205 ) >> V_206 )
return 1 ;
return V_104 ;
}
static int F_150 ( struct V_10 * V_11 ,
T_6 V_207 , void * V_172 )
{
struct V_19 * V_20 = V_11 -> V_35 ;
struct V_6 * V_7 ;
struct V_1 * V_126 ;
...
F_40 (pg, &m->priority_groups, list) {
F_40 (p, &pg->pgpaths, list) {
V_61 = V_207 ( V_11 , V_126 -> V_14 . V_15 , V_11 -> V_208 , V_11 -> V_144 , V_172 ) ;
if ( V_61 )
goto V_160;
}
}
