...
( ( V_54 * ) V_17 -> V_22 ) [ V_46 ] = F_29 ( ( ( V_54 * ) V_17 -> V_22 ) [ V_46 ] ) ;
...
{
union V_59 V_60 = { 0 } ;
V_60 . V_61 = F_2 ( V_2 -> V_13 , F_39 ( 0 ) ) ;
V_2 -> V_12 = V_60 . V_62 . V_63 ;
V_2 -> V_33 = V_60 . V_62 . V_64 ;
}
static T_3 F_40 ( struct V_1 * V_2 )
{
union V_65 V_66 = { 0 } ;
V_66 . V_61 = F_2 ( V_2 -> V_13 ,
F_41 ( 0 ) ) ;
return V_66 . V_61 ;
}
...
static int F_57 ( struct V_1 * V_2 , int V_73 )
{
int V_74 = 0 ;
int V_75 ;
V_54 V_76 ;
struct V_77 * V_10 = V_2 -> V_10 ;
V_74 = F_58 ( V_10 , V_78 ) ;
if ( ! V_74 ) {
F_7 ( & V_10 -> V_9 , L_26 ) ;
return - V_69 ;
...
V_2 -> V_79 = V_73 ;
F_59 ( V_10 , ( V_74 + V_80 ) , & V_76 ) ;
if ( V_76 < V_2 -> V_79 )
V_2 -> V_79 = V_76 ;
if ( ! V_76 )
return 0 ;
V_75 = F_60 ( V_10 , V_2 -> V_79 ) ;
if ( V_75 ) {
F_7 ( & V_10 -> V_9 , L_27 ,
V_2 -> V_79 ) ;
V_2 -> V_79 = 0 ;
...
static int F_61 ( struct V_77 * V_10 , const struct V_82 * V_83 )
{
...
V_75 = F_67 ( V_10 , F_68 ( 48 ) ) ;
if ( V_75 ) {
F_7 ( V_9 , L_32 ) ;
goto V_86;
}
V_75 = F_69 ( V_10 , F_68 ( 48 ) ) ;
if ( V_75 ) {
F_7 ( V_9 , L_33 ) ;
goto V_86;
}
...
static void F_73 ( struct V_77 * V_10 )
{
...
static void F_76 ( struct V_77 * V_10 )
{
struct V_1 * V_2 = F_74 ( V_10 ) ;
if ( ! V_2 )
return;
F_31 ( & V_10 -> V_9 , L_35 ,
( T_3 ) V_10 -> V_88 , ( T_3 ) V_10 -> V_8 ) ;
F_55 ( V_2 ) ;
F_71 ( V_10 ) ;
F_72 ( V_10 ) ;
F_64 ( V_10 , NULL ) ;
