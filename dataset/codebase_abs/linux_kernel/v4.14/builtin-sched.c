...
printf ( L_82 , L_83 ) ;
printf ( L_15 ) ;
printf ( L_84 , L_85 , L_85 ) ;
if ( V_8 -> V_280 )
printf ( L_86 , V_279 , L_85 ) ;
printf ( L_77 , V_278 ,
L_87 , L_88 , L_88 , L_88 ) ;
if ( V_8 -> V_281 )
printf ( L_89 , L_85 ) ;
printf ( L_15 ) ;
printf ( L_90 , V_282 , V_282 ) ;
if ( V_8 -> V_280 )
printf ( L_91 , V_279 , V_282 ) ;
printf ( L_92 , V_278 ,
V_282 , V_282 , V_282 ,
V_282 ) ;
if ( V_8 -> V_281 )
...
static char F_123 ( struct V_106 * V_106 , int V_173 )
{
static const char V_283 [] = V_169 ;
unsigned V_284 = V_173 ? F_124 ( V_173 ) : 0 ;
if ( V_106 -> V_126 == 0 )
return 'I' ;
return V_284 < sizeof( V_283 ) - 1 ? V_283 [ V_284 ] : '?' ;
}
...
T_1 V_287 , int V_173 )
{
struct V_288 * V_289 = F_93 ( V_106 ) ;
const char * V_128 = F_49 ( V_121 , V_123 , L_25 ) ;
const T_5 V_130 = F_50 ( V_121 , V_123 , L_27 ) ;
T_5 V_290 = V_8 -> V_226 + 1 ;
char V_291 [ 64 ] ;
char V_292 [ 30 ] ;
T_1 V_293 ;
F_79 ( V_287 , V_291 , sizeof( V_291 ) ) ;
printf ( L_94 , V_291 , V_123 -> V_135 ) ;
if ( V_8 -> V_280 ) {
T_5 V_15 ;
char V_294 ;
printf ( L_48 ) ;
...
printf ( L_96 , V_278 , F_120 ( V_106 ) ) ;
V_293 = V_289 -> V_295 + V_289 -> V_296 + V_289 -> V_297 ;
F_115 ( V_293 , 6 ) ;
F_115 ( V_289 -> V_298 , 6 ) ;
F_115 ( V_289 -> V_299 , 6 ) ;
if ( V_8 -> V_281 )
printf ( L_97 , F_123 ( V_106 , V_173 ) ) ;
if ( V_8 -> V_300 ) {
snprintf ( V_292 , sizeof( V_292 ) , L_98 , V_128 , V_130 ) ;
printf ( L_99 , V_278 , V_292 ) ;
}
if ( V_8 -> V_301 && ! V_8 -> V_300 )
printf ( L_100 , V_278 , L_85 ) ;
if ( V_106 -> V_126 == 0 )
goto V_240;
if ( V_8 -> V_302 )
printf ( L_54 ) ;
...
static void F_127 ( struct V_288 * V_149 ,
T_1 V_287 , T_1 V_308 )
{
V_149 -> V_298 = 0 ;
V_149 -> V_295 = 0 ;
...
V_149 -> V_299 = 0 ;
if ( V_308 ) {
V_149 -> V_299 = V_287 - V_308 ;
if ( V_149 -> V_309 ) {
if ( V_149 -> V_309 > V_308 )
F_52 ( L_101 ) ;
else
V_149 -> V_298 = V_308 - V_149 -> V_309 ;
}
if ( V_149 -> V_274 > V_308 )
F_52 ( L_102 ) ;
else if ( V_149 -> V_274 ) {
T_1 V_310 = V_308 - V_149 -> V_274 ;
if ( V_149 -> V_311 == V_312 )
V_149 -> V_297 = V_310 ;
else if ( V_149 -> V_311 == V_313 )
V_149 -> V_296 = V_310 ;
else
V_149 -> V_295 = V_310 ;
}
}
F_128 ( & V_149 -> V_314 , V_149 -> V_299 ) ;
V_149 -> V_315 += V_149 -> V_299 ;
V_149 -> V_316 += V_149 -> V_298 ;
V_149 -> V_317 += V_149 -> V_295 ;
V_149 -> V_318 += V_149 -> V_296 ;
V_149 -> V_319 += V_149 -> V_297 ;
}
static bool F_129 ( struct V_122 * V_123 ,
struct V_120 * V_121 )
{
if ( strcmp ( F_130 ( V_121 ) , L_61 ) == 0 )
...
struct V_124 * V_124 )
{
struct V_307 * V_320 = & V_307 ;
struct V_106 * V_106 ;
V_106 = F_54 ( V_124 , V_123 -> V_44 , V_123 -> V_44 ) ;
if ( V_106 == NULL ) {
F_52 ( L_103 , V_123 -> V_44 ) ;
return;
}
if ( ! V_321 . V_322 || V_123 -> V_323 == NULL )
return;
if ( F_132 ( V_106 , V_320 , V_121 , V_123 ,
NULL , NULL , V_8 -> V_324 + 2 ) != 0 ) {
if ( V_51 > 0 )
F_31 ( L_104 ) ;
return;
}
...
V_327 = V_157 -> V_327 ;
if ( V_327 ) {
if ( ! strcmp ( V_327 -> V_202 , L_105 ) ||
! strcmp ( V_327 -> V_202 , L_106 ) ||
! strcmp ( V_327 -> V_202 , L_107 ) )
V_327 -> V_328 = 1 ;
}
F_135 ( V_320 ) ;
}
}
static int F_136 ( struct V_106 * V_106 )
{
struct V_329 * V_330 ;
F_137 ( V_106 , V_331 , 0 ) ;
V_330 = F_10 ( sizeof( * V_330 ) ) ;
if ( V_330 == NULL )
return - V_332 ;
F_138 ( & V_330 -> V_289 . V_314 ) ;
F_139 ( & V_330 -> V_323 ) ;
F_140 ( & V_330 -> V_320 ) ;
F_96 ( V_106 , V_330 ) ;
return 0 ;
}
static int F_141 ( int V_273 )
{
int V_15 , V_56 ;
V_333 = F_10 ( V_273 * sizeof( struct V_106 * ) ) ;
if ( ! V_333 )
return - V_332 ;
V_334 = V_273 ;
for ( V_15 = 0 ; V_15 < V_273 ; ++ V_15 ) {
V_333 [ V_15 ] = F_142 ( 0 , 0 ) ;
if ( V_333 [ V_15 ] == NULL )
return - V_332 ;
V_56 = F_136 ( V_333 [ V_15 ] ) ;
if ( V_56 < 0 )
return V_56 ;
}
return 0 ;
...
if ( V_333 == NULL )
return;
for ( V_15 = 0 ; V_15 < V_334 ; ++ V_15 ) {
if ( ( V_333 [ V_15 ] ) )
F_144 ( V_333 [ V_15 ] ) ;
}
free ( V_333 ) ;
}
static struct V_106 * F_145 ( int V_135 )
{
if ( ( V_135 >= V_334 ) || ( V_333 == NULL ) ) {
int V_15 , V_54 = F_118 ( V_135 + 1 ) ;
void * V_276 ;
V_276 = realloc ( V_333 , V_54 * sizeof( struct V_106 * ) ) ;
if ( ! V_276 )
return NULL ;
V_333 = (struct V_106 * * ) V_276 ;
for ( V_15 = V_334 ; V_15 < V_54 ; ++ V_15 )
V_333 [ V_15 ] = NULL ;
V_334 = V_54 ;
}
if ( V_333 [ V_135 ] == NULL ) {
V_333 [ V_135 ] = F_142 ( 0 , 0 ) ;
if ( V_333 [ V_135 ] ) {
if ( F_136 ( V_333 [ V_135 ] ) < 0 )
return NULL ;
}
}
return V_333 [ V_135 ] ;
}
static void F_146 ( struct V_329 * V_330 ,
struct V_122 * V_123 )
{
if ( ! V_321 . V_322 || V_123 -> V_323 == NULL )
return;
F_147 ( & V_330 -> V_320 , & V_307 ) ;
}
static struct V_288 * F_148 ( struct V_106 * V_106 )
{
struct V_288 * V_149 ;
V_149 = F_10 ( sizeof( struct V_288 ) ) ;
if ( ! V_149 )
return NULL ;
F_138 ( & V_149 -> V_314 ) ;
F_96 ( V_106 , V_149 ) ;
...
static struct V_288 * F_149 ( struct V_106 * V_106 )
{
struct V_288 * V_289 ;
V_289 = F_93 ( V_106 ) ;
if ( V_289 == NULL ) {
...
static struct V_106 * F_150 ( struct V_7 * V_8 ,
struct V_122 * V_123 ,
struct V_124 * V_124 ,
struct V_120 * V_121 )
{
struct V_106 * V_106 ;
if ( F_129 ( V_123 , V_121 ) ) {
V_106 = F_145 ( V_123 -> V_135 ) ;
if ( V_106 == NULL )
F_31 ( L_109 , V_123 -> V_135 ) ;
} else {
...
F_131 ( V_8 , V_123 , V_121 , V_124 ) ;
if ( V_8 -> V_335 ) {
struct V_106 * V_336 ;
struct V_329 * V_330 ;
V_336 = F_145 ( V_123 -> V_135 ) ;
if ( V_336 == NULL ) {
F_31 ( L_109 , V_123 -> V_135 ) ;
return NULL ;
}
...
static bool F_151 ( struct V_7 * V_8 ,
struct V_106 * V_106 ,
struct V_120 * V_121 ,
struct V_122 * V_123 )
{
...
if ( V_106 == NULL )
return;
if ( F_151 ( V_8 , V_106 , V_121 , V_123 ) &&
F_151 ( V_8 , V_339 , V_121 , V_123 ) ) {
return;
}
F_79 ( V_123 -> time , V_291 , sizeof( V_291 ) ) ;
printf ( L_94 , V_291 , V_123 -> V_135 ) ;
if ( V_8 -> V_280 )
printf ( L_86 , V_8 -> V_226 + 1 , L_85 ) ;
printf ( L_96 , V_278 , F_120 ( V_106 ) ) ;
printf ( L_111 , L_85 , L_85 , L_85 ) ;
printf ( L_112 , F_120 ( V_339 ) ) ;
printf ( L_15 ) ;
}
...
return - 1 ;
if ( V_289 -> V_309 == 0 )
V_289 -> V_309 = V_123 -> time ;
if ( V_8 -> V_301 &&
! F_155 ( & V_8 -> V_340 , V_123 -> time ) )
F_153 ( V_8 , V_121 , V_123 , V_124 , V_106 ) ;
return 0 ;
}
...
return;
V_290 = V_8 -> V_226 + 1 ;
V_342 = F_50 ( V_121 , V_123 , L_113 ) ;
V_343 = F_50 ( V_121 , V_123 , L_114 ) ;
V_106 = F_54 ( V_124 , V_123 -> V_44 , V_123 -> V_126 ) ;
if ( V_106 == NULL )
return;
if ( F_151 ( V_8 , V_106 , V_121 , V_123 ) &&
F_151 ( V_8 , V_341 , V_121 , V_123 ) ) {
return;
}
F_79 ( V_123 -> time , V_291 , sizeof( V_291 ) ) ;
printf ( L_94 , V_291 , V_123 -> V_135 ) ;
...
printf ( L_96 , V_278 , F_120 ( V_106 ) ) ;
printf ( L_111 , L_85 , L_85 , L_85 ) ;
printf ( L_115 , F_120 ( V_341 ) ) ;
printf ( L_116 , V_342 , V_343 ) ;
printf ( L_15 ) ;
}
static int F_157 ( struct V_210 * V_211 ,
union V_138 * V_22 V_42 ,
struct V_120 * V_121 ,
struct V_122 * V_123 ,
struct V_124 * V_124 )
...
return - 1 ;
V_289 -> V_345 ++ ;
F_156 ( V_8 , V_121 , V_123 , V_124 , V_106 ) ;
return 0 ;
}
...
{
struct V_7 * V_8 = F_61 ( V_211 , struct V_7 , V_211 ) ;
struct V_346 * V_340 = & V_8 -> V_340 ;
struct V_285 V_286 ;
struct V_106 * V_106 ;
struct V_288 * V_289 = NULL ;
T_1 V_308 , V_287 = V_123 -> time ;
int V_259 = 0 ;
int V_173 = F_50 ( V_121 , V_123 , L_28 ) ;
if ( F_159 ( V_124 , & V_286 , V_123 ) < 0 ) {
F_31 ( L_117 ,
V_22 -> V_260 . type ) ;
V_259 = - 1 ;
goto V_240;
}
V_106 = F_150 ( V_8 , V_123 , V_124 , V_121 ) ;
if ( V_106 == NULL ) {
V_259 = - 1 ;
goto V_240;
}
...
V_308 = F_119 ( V_121 , V_123 -> V_135 ) ;
if ( V_340 -> V_347 && V_340 -> V_347 > V_287 )
goto V_240;
if ( V_308 && V_340 -> V_347 > V_308 )
V_308 = V_340 -> V_347 ;
if ( V_340 -> V_348 ) {
if ( V_308 > V_340 -> V_348 )
goto V_240;
if ( V_287 > V_340 -> V_348 )
V_287 = V_340 -> V_348 ;
}
if ( ! V_8 -> V_335 || V_106 -> V_126 == 0 ) {
F_127 ( V_289 , V_287 , V_308 ) ;
if ( V_8 -> V_335 ) {
struct V_329 * V_330 = ( void * ) V_289 ;
struct V_288 * V_349 ;
F_11 ( V_106 -> V_126 != 0 ) ;
if ( V_330 -> V_337 == NULL )
goto V_240;
V_349 = F_149 ( V_330 -> V_337 ) ;
if ( V_349 == NULL )
goto V_240;
F_127 ( V_349 , V_287 , V_308 ) ;
V_349 -> V_299 = 0 ;
V_349 -> V_298 = 0 ;
V_349 -> V_295 = 0 ;
V_349 -> V_296 = 0 ;
V_349 -> V_297 = 0 ;
if ( V_330 -> V_320 . V_26 )
F_160 ( & V_330 -> V_323 , & V_330 -> V_320 , V_287 - V_308 ) ;
V_330 -> V_337 = NULL ;
}
}
if ( ! V_8 -> V_344 )
F_125 ( V_8 , V_121 , V_123 , & V_286 , V_106 , V_287 , V_173 ) ;
V_240:
if ( V_8 -> V_350 . V_347 == 0 && V_287 >= V_340 -> V_347 )
V_8 -> V_350 . V_347 = V_287 ;
if ( V_340 -> V_348 == 0 || V_287 <= V_340 -> V_348 )
V_8 -> V_350 . V_348 = V_287 ;
if ( V_289 ) {
V_289 -> V_274 = V_123 -> time ;
V_289 -> V_311 = V_173 ;
V_289 -> V_309 = 0 ;
}
...
static int F_161 ( struct V_210 * V_211 ,
union V_138 * V_22 ,
struct V_120 * V_121 ,
struct V_122 * V_123 ,
struct V_124 * V_124 V_42 )
{
return F_158 ( V_211 , V_22 , V_121 , V_123 , V_124 ) ;
}
static int F_162 ( struct V_210 * V_211 V_42 ,
union V_138 * V_22 ,
struct V_122 * V_123 ,
struct V_124 * V_124 V_42 )
{
...
F_79 ( V_123 -> time , V_291 , sizeof( V_291 ) ) ;
printf ( L_118 , V_291 ) ;
printf ( L_119 V_16 L_120 , V_22 -> V_351 . V_351 , V_123 -> V_135 ) ;
return 0 ;
}
static void F_163 ( struct V_106 * V_287 ,
struct V_288 * V_149 )
{
double V_352 = F_164 ( & V_149 -> V_314 ) ;
float V_353 ;
printf ( L_121 V_16 L_48 ,
V_278 , F_120 ( V_287 ) , V_287 -> V_142 ,
( T_1 ) V_149 -> V_314 . V_275 ) ;
F_115 ( V_149 -> V_315 , 8 ) ;
V_353 = F_165 ( F_166 ( & V_149 -> V_314 ) , V_352 ) ;
F_115 ( V_149 -> V_314 . F_7 , 6 ) ;
printf ( L_48 ) ;
F_115 ( ( T_1 ) V_352 , 6 ) ;
printf ( L_48 ) ;
F_115 ( V_149 -> V_314 . F_43 , 6 ) ;
printf ( L_54 ) ;
printf ( L_122 , V_353 ) ;
printf ( L_123 V_16 , V_149 -> V_345 ) ;
printf ( L_15 ) ;
}
static void F_167 ( struct V_106 * V_287 ,
struct V_288 * V_149 )
{
printf ( L_121 V_16 L_48 ,
V_278 , F_120 ( V_287 ) , V_287 -> V_142 ,
...
static int F_168 ( struct V_106 * V_287 , void * V_215 )
{
struct V_354 * V_264 = V_215 ;
struct V_288 * V_149 ;
if ( F_152 ( V_287 ) )
return 0 ;
V_149 = F_93 ( V_287 ) ;
if ( V_149 && V_149 -> V_314 . V_275 ) {
V_264 -> V_355 ++ ;
V_264 -> V_356 += V_149 -> V_314 . V_275 ;
V_264 -> V_315 += V_149 -> V_315 ;
if ( V_264 -> V_8 -> V_281 )
F_167 ( V_287 , V_149 ) ;
else
F_163 ( V_287 , V_149 ) ;
...
static int F_169 ( struct V_106 * V_287 , void * V_215 )
{
if ( V_287 -> V_357 )
return 0 ;
return F_168 ( V_287 , V_215 ) ;
}
static int F_170 ( struct V_106 * V_287 , void * V_215 )
{
if ( ! V_287 -> V_357 )
return 0 ;
return F_168 ( V_287 , V_215 ) ;
}
static T_2 F_171 ( T_9 * V_358 , struct V_359 * V_157 )
{
const char * V_360 = L_124 ;
struct V_361 * V_362 ;
T_2 V_56 = 0 ;
char V_363 [ 1024 ] ;
bool V_364 ;
if ( V_157 == NULL )
return 0 ;
V_56 = F_171 ( V_358 , V_157 -> V_140 ) ;
V_364 = ( V_56 == 0 ) ;
F_59 (chain, &node->val, list) {
if ( V_362 -> V_365 >= V_366 )
continue;
if ( V_362 -> V_367 . V_327 && V_362 -> V_367 . V_327 -> V_328 )
continue;
V_56 += fprintf ( V_358 , L_125 , V_364 ? L_85 : V_360 ,
F_172 ( V_362 , V_363 , sizeof( V_363 ) ,
false ) ) ;
V_364 = false ;
}
return V_56 ;
}
static T_2 F_173 ( struct V_153 * V_154 )
{
T_2 V_56 = 0 ;
T_9 * V_358 = stdout ;
struct V_359 * V_362 ;
struct V_156 * V_156 = F_88 ( V_154 ) ;
printf ( L_126 , L_127 , L_128 , L_129 ) ;
printf ( L_130 , V_282 , V_282 ,
V_282 ) ;
while ( V_156 ) {
V_362 = F_90 ( V_156 , struct V_359 , V_156 ) ;
V_156 = F_174 ( V_156 ) ;
V_56 += fprintf ( V_358 , L_54 ) ;
F_115 ( V_362 -> V_368 , 12 ) ;
V_56 += 16 ;
V_56 += fprintf ( V_358 , L_131 , V_362 -> V_369 ) ;
V_56 += F_171 ( V_358 , V_362 ) ;
V_56 += fprintf ( V_358 , L_15 ) ;
}
return V_56 ;
}
...
struct V_251 * V_252 )
{
struct V_124 * V_370 = & V_252 -> V_371 . V_372 ;
struct V_354 V_373 ;
T_1 V_355 ;
struct V_106 * V_287 ;
struct V_288 * V_149 ;
int V_15 ;
T_1 V_350 = V_8 -> V_350 . V_348 - V_8 -> V_350 . V_347 ;
memset ( & V_373 , 0 , sizeof( V_373 ) ) ;
V_373 . V_8 = V_8 ;
if ( V_8 -> V_335 ) {
printf ( L_132 ) ;
printf ( L_133 , V_278 , L_19 ) ;
printf ( L_134 ) ;
} else if ( V_8 -> V_281 ) {
printf ( L_135 ) ;
printf ( L_136 , V_278 , L_19 ) ;
printf ( L_137 ) ;
} else {
printf ( L_138 ) ;
printf ( L_136 , V_278 , L_19 ) ;
...
printf ( L_140 , V_278 , L_85 ) ;
printf ( L_141 ,
V_8 -> V_281 ? L_88 : L_142 ) ;
printf ( L_143 , V_282 ) ;
F_176 ( V_370 , F_169 , & V_373 ) ;
V_355 = V_373 . V_355 ;
if ( ! V_355 )
printf ( L_144 ) ;
printf ( L_145 ) ;
F_176 ( V_370 , F_170 , & V_373 ) ;
if ( V_355 == V_373 . V_355 )
printf ( L_146 ) ;
if ( V_8 -> V_338 && ! V_8 -> V_335 )
return;
printf ( L_147 ) ;
for ( V_15 = 0 ; V_15 < V_334 ; ++ V_15 ) {
V_287 = V_333 [ V_15 ] ;
...
V_149 = F_93 ( V_287 ) ;
if ( V_149 && V_149 -> V_314 . V_275 ) {
V_373 . V_356 += V_149 -> V_314 . V_275 ;
printf ( L_148 , V_15 ) ;
F_115 ( V_149 -> V_315 , 6 ) ;
printf ( L_149 , 100.0 * V_149 -> V_315 / V_350 ) ;
} else
printf ( L_150 , V_15 ) ;
}
if ( V_8 -> V_335 && V_321 . V_322 ) {
V_374 . V_257 = V_375 ;
V_374 . V_376 = V_377 ;
F_177 ( & V_374 ) ;
printf ( L_151 ) ;
...
if ( V_330 == NULL )
continue;
V_374 . V_151 ( & V_330 -> V_378 , & V_330 -> V_323 ,
0 , & V_374 ) ;
printf ( L_152 , V_15 ) ;
F_115 ( V_330 -> V_289 . V_315 , 6 ) ;
printf ( L_153 ) ;
F_173 ( & V_330 -> V_378 ) ;
printf ( L_15 ) ;
}
...
L_154 V_16 L_15
L_155 V_16 L_15 ,
V_373 . V_355 , V_373 . V_356 ) ;
printf ( L_156 ) ;
F_115 ( V_373 . V_315 , 2 ) ;
printf ( L_15 ) ;
printf ( L_157 ) ;
F_115 ( V_350 , 2 ) ;
printf ( L_158 , V_8 -> V_226 ) ;
}
static int F_178 ( struct V_210 * V_211 ,
union V_138 * V_22 ,
struct V_122 * V_123 ,
struct V_120 * V_121 ,
struct V_124 * V_124 )
...
struct V_379 * V_263 ;
int V_61 = - 1 ;
V_8 -> V_211 . V_123 = F_178 ;
V_8 -> V_211 . V_384 = V_385 ;
V_8 -> V_211 . V_45 = V_386 ;
V_8 -> V_211 . exit = V_387 ;
V_8 -> V_211 . V_141 = F_105 ;
V_8 -> V_211 . V_351 = F_162 ;
V_8 -> V_211 . V_69 = V_388 ;
V_8 -> V_211 . V_389 = V_390 ;
V_8 -> V_211 . V_391 = V_392 ;
V_8 -> V_211 . V_393 = true ;
V_8 -> V_211 . V_394 = true ;
V_321 . V_322 = V_8 -> V_302 ;
V_252 = F_109 ( & V_254 , false , & V_8 -> V_211 ) ;
if ( V_252 == NULL )
return - V_332 ;
V_263 = V_252 -> V_263 ;
F_110 ( & V_252 -> V_260 . V_261 ) ;
if ( F_182 ( & V_8 -> V_340 , V_8 -> V_395 ) != 0 ) {
F_31 ( L_161 ) ;
return - V_396 ;
}
if ( F_179 ( V_8 , V_263 ) != 0 )
goto V_240;
F_183 () ;
if ( F_111 ( V_252 , V_250 ) )
goto V_240;
if ( ! F_184 ( V_252 -> V_263 ,
L_61 ) ) {
F_31 ( L_162 ) ;
goto V_240;
}
...
F_111 ( V_252 , V_383 ) )
goto V_240;
V_8 -> V_226 = V_252 -> V_260 . V_261 . V_398 ;
if ( V_8 -> V_226 == 0 )
V_8 -> V_226 = 4 ;
if ( F_141 ( V_8 -> V_226 ) )
goto V_240;
...
static void F_186 ( struct V_153 * V_154 , struct V_147 * V_161 )
{
struct V_156 * * V_162 = & ( V_154 -> V_156 ) , * V_140 = NULL ;
struct V_147 * V_163 ;
const char * V_45 = F_55 ( V_161 -> V_106 ) , * V_400 ;
while ( * V_162 ) {
int V_152 ;
V_163 = F_61 ( * V_162 , struct V_147 , V_157 ) ;
V_140 = * V_162 ;
V_400 = F_55 ( V_163 -> V_106 ) ;
V_152 = strcmp ( V_45 , V_400 ) ;
if ( V_152 > 0 ) {
V_162 = & ( ( * V_162 ) -> V_159 ) ;
} else if ( V_152 < 0 ) {
V_162 = & ( ( * V_162 ) -> V_160 ) ;
...
if ( ! V_8 -> V_218 . V_404 )
return 0 ;
V_218 = F_193 ( V_8 -> V_218 . V_404 ) ;
if ( ! V_218 ) {
F_31 ( L_173 , V_8 -> V_218 . V_404 ) ;
return - 1 ;
}
...
if ( ! V_8 -> V_218 . V_406 )
return 0 ;
V_218 = F_195 ( V_8 -> V_218 . V_406 ) ;
if ( ! V_218 ) {
F_31 ( L_174 , V_8 -> V_218 . V_406 ) ;
return - 1 ;
}
...
if ( ! V_8 -> V_218 . V_407 )
return 0 ;
V_218 = F_193 ( V_8 -> V_218 . V_407 ) ;
if ( ! V_218 ) {
F_31 ( L_174 , V_8 -> V_218 . V_407 ) ;
return - 1 ;
}
...
if ( F_108 ( V_8 ) )
return - 1 ;
printf ( L_175 , V_8 -> V_32 ) ;
printf ( L_176 , V_8 -> V_43 ) ;
printf ( L_177 , V_8 -> V_41 ) ;
if ( V_8 -> V_37 )
printf ( L_178 , V_8 -> V_37 ) ;
if ( V_8 -> V_39 )
printf ( L_179 , V_8 -> V_39 ) ;
if ( V_8 -> V_31 )
printf ( L_180 ,
V_8 -> V_31 ) ;
F_19 ( V_8 ) ;
...
static void F_199 ( struct V_7 * V_8 , const struct V_408 * V_409 ,
const char * const V_410 [] )
{
char * V_411 , * V_200 , * V_168 = F_200 ( V_8 -> V_412 ) ;
for ( V_200 = strtok_r ( V_168 , L_182 , & V_411 ) ;
V_200 ; V_200 = strtok_r ( NULL , L_182 , & V_411 ) ) {
...
static int F_202 ( int V_413 , const char * * V_414 )
{
unsigned int V_415 , V_15 , V_54 ;
const char * * V_416 ;
...
V_415 = F_86 ( V_417 ) + V_413 - 1 ;
V_416 = calloc ( V_415 + 1 , sizeof( char * ) ) ;
if ( V_416 == NULL )
return - V_332 ;
for ( V_15 = 0 ; V_15 < F_86 ( V_417 ) ; V_15 ++ )
V_416 [ V_15 ] = F_200 ( V_417 [ V_15 ] ) ;
for ( V_54 = 1 ; V_54 < ( unsigned int ) V_413 ; V_54 ++ , V_15 ++ )
V_416 [ V_15 ] = V_414 [ V_54 ] ;
F_11 ( V_15 != V_415 ) ;
return F_203 ( V_15 , V_416 ) ;
}
int F_204 ( int V_413 , const char * * V_414 )
{
const char V_418 [] = L_196 ;
struct V_7 V_8 = {
. V_211 = {
. V_123 = F_107 ,
. V_45 = V_386 ,
...
. V_167 = F_205 ( V_8 . V_167 ) ,
. V_155 = F_205 ( V_8 . V_155 ) ,
. V_100 = V_422 ,
. V_103 = V_422 ,
. V_412 = V_418 ,
. V_109 = 10 ,
...
const struct V_408 V_423 [] = {
F_206 ( 'i' , L_197 , & V_256 , L_198 ,
L_199 ) ,
F_207 ( 'v' , L_200 , & V_51 ,
L_201 ) ,
F_208 ( 'D' , L_202 , & V_424 ,
L_203 ) ,
F_208 ( 'f' , L_204 , & V_8 . V_83 , L_205 ) ,
F_209 ()
} ;
const struct V_408 V_425 [] = {
F_206 ( 's' , L_206 , & V_8 . V_412 , L_207 ,
L_208 ) ,
F_210 ( 'C' , L_209 , & V_8 . V_188 ,
L_210 ) ,
F_208 ( 'p' , L_211 , & V_8 . V_401 ,
L_212 ) ,
F_211 (sched_options)
} ;
const struct V_408 V_426 [] = {
F_212 ( 'r' , L_213 , & V_8 . V_109 ,
L_214 ) ,
F_211 (sched_options)
} ;
const struct V_408 V_427 [] = {
F_208 ( 0 , L_215 , & V_8 . V_218 . V_227 ,
L_216 ) ,
F_206 ( 0 , L_217 , & V_8 . V_218 . V_406 , L_211 ,
L_218 ) ,
F_206 ( 0 , L_219 , & V_8 . V_218 . V_407 , L_220 ,
L_221 ) ,
F_206 ( 0 , L_220 , & V_8 . V_218 . V_404 , L_220 ,
L_222 ) ,
F_211 (sched_options)
} ;
const struct V_408 V_428 [] = {
F_206 ( 'k' , L_223 , & V_321 . V_429 ,
L_198 , L_224 ) ,
F_206 ( 0 , L_225 , & V_321 . V_430 ,
L_198 , L_226 ) ,
F_208 ( 'g' , L_227 , & V_8 . V_302 ,
L_228 ) ,
F_212 ( 0 , L_229 , & V_8 . V_324 ,
L_230 ) ,
F_206 ( 0 , L_231 , & V_321 . V_431 , L_232 ,
L_233 ) ,
F_208 ( 's' , L_234 , & V_8 . V_344 ,
L_235 ) ,
F_208 ( 'S' , L_236 , & V_8 . V_399 ,
L_237 ) ,
F_208 ( 'w' , L_238 , & V_8 . V_301 , L_239 ) ,
F_208 ( 'n' , L_240 , & V_8 . V_300 , L_241 ) ,
F_208 ( 'M' , L_242 , & V_8 . V_397 , L_243 ) ,
F_208 ( 'V' , L_244 , & V_8 . V_280 , L_245 ) ,
F_208 ( 'I' , L_246 , & V_8 . V_335 , L_247 ) ,
F_206 ( 0 , L_74 , & V_8 . V_395 , L_248 ,
L_249 ) ,
F_208 ( 0 , L_83 , & V_8 . V_281 , L_250 ) ,
F_211 (sched_options)
} ;
...
const char * const V_433 [] = {
L_252 ,
NULL
} ;
const char * const V_434 [] = {
L_253 ,
NULL
} ;
const char * const V_435 [] = {
L_254 ,
NULL
} ;
const char * const V_436 [] = { L_184 , L_255 , L_256 ,
L_257 , L_258 ,
L_259 , NULL } ;
const char * V_437 [] = {
NULL ,
...
V_8 . V_241 [ V_15 ] = - 1 ;
V_413 = F_213 ( V_413 , V_414 , V_423 , V_436 ,
V_437 , V_442 ) ;
if ( ! V_413 )
F_214 ( V_437 , V_423 ) ;
if ( ! strcmp ( V_414 [ 0 ] , L_258 ) )
return F_215 ( V_413 , V_414 ) ;
if ( ! strncmp ( V_414 [ 0 ] , L_260 , 3 ) ) {
return F_202 ( V_413 , V_414 ) ;
} else if ( ! strncmp ( V_414 [ 0 ] , L_261 , 3 ) ) {
V_8 . V_212 = & V_439 ;
if ( V_413 > 1 ) {
V_413 = F_216 ( V_413 , V_414 , V_425 , V_432 , 0 ) ;
if ( V_413 )
F_214 ( V_432 , V_425 ) ;
}
F_199 ( & V_8 , V_425 , V_432 ) ;
return F_189 ( & V_8 ) ;
} else if ( ! strcmp ( V_414 [ 0 ] , L_256 ) ) {
if ( V_413 ) {
V_413 = F_216 ( V_413 , V_414 , V_427 , V_434 , 0 ) ;
if ( V_413 )
F_214 ( V_434 , V_427 ) ;
}
V_8 . V_212 = & V_440 ;
F_199 ( & V_8 , V_425 , V_432 ) ;
return F_197 ( & V_8 ) ;
} else if ( ! strncmp ( V_414 [ 0 ] , L_262 , 3 ) ) {
V_8 . V_212 = & V_441 ;
if ( V_413 ) {
V_413 = F_216 ( V_413 , V_414 , V_426 , V_433 , 0 ) ;
if ( V_413 )
F_214 ( V_433 , V_426 ) ;
}
return F_198 ( & V_8 ) ;
} else if ( ! strcmp ( V_414 [ 0 ] , L_259 ) ) {
if ( V_413 ) {
V_413 = F_216 ( V_413 , V_414 , V_428 ,
V_435 , 0 ) ;
if ( V_413 )
F_214 ( V_435 , V_428 ) ;
}
...
V_8 . V_344 ) {
F_31 ( L_263 ) ;
F_217 ( V_435 , V_428 , L_264 , true ) ;
if ( V_8 . V_301 )
F_217 ( NULL , V_428 , L_265 , true ) ;
if ( V_8 . V_300 )
F_217 ( NULL , V_428 , L_266 , true ) ;
return - V_396 ;
}
return F_181 ( & V_8 ) ;
} else {
