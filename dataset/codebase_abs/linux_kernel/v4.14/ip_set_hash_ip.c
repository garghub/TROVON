...
static inline bool
F_22 ( const struct V_48 * V_49 ,
const struct V_48 * V_50 ,
T_1 * V_4 )
{
return F_23 ( & V_49 -> V_5 . V_51 , & V_50 -> V_5 . V_51 ) ;
}
static inline void
F_24 ( union V_52 * V_5 , T_4 V_53 )
{
F_25 ( V_5 , V_53 ) ;
}
static bool
F_26 ( struct V_6 * V_7 , const struct V_48 * V_8 )
{
if ( F_27 ( V_7 , V_9 , & V_8 -> V_5 . V_51 ) )
goto V_10;
return false ;
V_10:
return true ;
...
static inline void
F_28 ( struct V_48 * V_11 , const struct V_48 * V_8 )
{
}
static int
F_29 ( struct V_12 * V_13 , const struct V_6 * V_7 ,
const struct V_14 * V_15 ,
enum V_16 V_17 , struct V_18 * V_19 )
{
const struct V_54 * V_21 = V_13 -> V_22 ;
T_2 V_23 = V_13 -> V_24 -> V_17 [ V_17 ] ;
struct V_48 V_8 = { { . V_55 = { 0 } } } ;
struct V_25 V_26 = F_6 ( V_7 , V_19 , V_13 ) ;
F_30 ( V_7 , V_19 -> V_27 & V_28 , & V_8 . V_5 . V_51 ) ;
F_24 ( & V_8 . V_5 , V_21 -> V_29 ) ;
if ( F_31 ( & V_8 . V_5 . V_51 ) )
return - V_30 ;
return V_23 ( V_13 , & V_8 , & V_26 , & V_19 -> V_26 , V_19 -> V_31 ) ;
}
static int
