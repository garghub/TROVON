...
int F_151 ( struct V_75 * V_76 , void * V_257 ,
struct V_162 * V_163 )
{
...
{
if ( F_49 -> V_237 & V_265 )
F_154 ( F_49 , V_266 , V_73 ) ;
else if ( F_155 ( F_49 ) )
F_20 ( V_73 , F_49 -> V_39 +
V_267 ) ;
F_154 ( F_49 , V_268 , V_11 ) ;
F_154 ( F_49 , V_269 , V_12 ) ;
F_154 ( F_49 , V_270 , V_264 ) ;
if ( F_156 ( F_49 , V_271 ) != V_194 ) {
F_10 ( L_35 ,
V_194 , V_264 , F_156 ( F_49 , V_271 ) ) ;
return - V_18 ;
}
return 0 ;
}
...
struct V_272 * V_273 ;
T_3 V_57 ;
F_49 -> V_274 = F_156 ( F_49 , V_268 ) ;
F_49 -> V_275 = F_156 ( F_49 , V_269 ) ;
F_49 -> V_276 = F_156 ( F_49 , V_270 ) ;
if ( F_49 -> V_237 & V_265 )
F_49 -> V_277 =
F_156 ( F_49 , V_266 ) ;
else if ( F_155 ( F_49 ) )
...
if ( ! ( F_49 -> V_237 & V_278 ) )
return 0 ;
F_49 -> V_279 = F_156 ( F_49 ,
V_280 ) ;
if ( F_49 -> V_279 == 0 )
F_49 -> V_279 = 1 ;
for ( V_57 = 0 ; V_57 < F_49 -> V_279 ; ++ V_57 ) {
V_273 = & F_49 -> V_281 [ V_57 ] ;
F_154 ( F_49 , V_282 , V_57 ) ;
V_273 -> V_3 = F_156 ( F_49 , V_283 ) ;
V_273 -> V_284 = F_156 ( F_49 , V_285 ) ;
V_273 -> V_286 = F_156 ( F_49 , V_287 ) ;
V_273 -> V_11 = F_156 ( F_49 , V_288 ) ;
V_273 -> V_12 = F_156 ( F_49 , V_289 ) ;
F_154 ( F_49 , V_282 , V_290 ) ;
...
struct V_272 * V_273 ;
T_3 V_57 ;
F_154 ( F_49 , V_268 , F_49 -> V_274 ) ;
F_154 ( F_49 , V_269 , F_49 -> V_275 ) ;
F_154 ( F_49 , V_270 , F_49 -> V_276 ) ;
if ( F_49 -> V_237 & V_265 )
F_154 ( F_49 , V_266 ,
F_49 -> V_277 ) ;
else if ( F_155 ( F_49 ) )
...
V_273 = & F_49 -> V_281 [ V_57 ] ;
F_154 ( F_49 , V_282 , V_57 ) ;
F_154 ( F_49 , V_283 , V_273 -> V_3 ) ;
F_154 ( F_49 , V_285 , V_273 -> V_284 ) ;
F_154 ( F_49 , V_287 , V_273 -> V_286 ) ;
F_154 ( F_49 , V_288 , V_273 -> V_11 ) ;
F_154 ( F_49 , V_289 , V_273 -> V_12 ) ;
F_154 ( F_49 , V_282 , V_290 ) ;
}
return 0 ;
}
...
T_1 F_159 ( struct V_75 * V_76 , unsigned int V_293 )
{
return 0 ;
}
int F_160 ( struct V_75 * V_76 , unsigned int V_293 )
{
return - V_181 ;
}
void F_161 ( struct V_75 * V_76 , unsigned int V_293 )
{
}
static int F_162 ( struct V_8 * V_9 , unsigned V_294 ,
struct V_178 * V_295 )
{
struct V_75 * V_76 = V_9 -> V_76 ;
struct V_1 * V_2 ;
...
F_154 ( V_9 , V_311 + V_57 * 3 + 0 , V_306 [ V_57 ] >> 8 ) ;
F_154 ( V_9 , V_311 + V_57 * 3 + 1 , V_307 [ V_57 ] >> 8 ) ;
F_154 ( V_9 , V_311 + V_57 * 3 + 2 , V_308 [ V_57 ] >> 8 ) ;
}
return 0 ;
}
int F_169 ( struct V_157 * V_5 , int V_143 )
{
return 0 ;
}
enum V_312
F_165 ( struct V_157 * V_5 , bool V_313 )
{
T_3 V_279 ;
struct V_75 * V_76 = V_5 -> V_76 ;
struct V_8 * V_9 = F_49 ( V_76 ) ;
struct V_1 * V_2 = F_163 ( V_5 ) ;
V_279 = F_156 ( V_9 , V_314 ) ;
return ( ( F_163 ( V_5 ) -> V_297 < V_279 &&
V_2 -> V_300 ) ?
V_315 : V_316 ) ;
}
void F_170 ( struct V_317 * V_143 )
{
...
V_143 -> V_324 = F_171 ( V_143 ) ;
}
int F_172 ( struct V_157 * V_5 ,
T_3 V_255 , T_3 V_256 )
{
struct V_1 * V_2 = F_163 ( V_5 ) ;
struct V_75 * V_76 = V_5 -> V_76 ;
...
V_327 = 2 ;
if ( V_9 -> V_171 == V_180 ) {
V_255 = F_174 ( V_255 , V_9 -> V_329 ) ;
V_255 = F_174 ( V_255 , V_9 -> V_229 ) ;
V_256 = F_174 ( V_256 , V_9 -> V_330 ) ;
V_256 = F_174 ( V_256 , V_9 -> V_230 ) ;
}
V_143 = F_175 ( V_76 , & V_326 ) ;
if ( ! V_143 )
return 0 ;
...
if ( V_2 -> V_331 ) {
F_178 ( & V_2 -> V_331 -> V_332 ) ;
F_177 ( V_76 , V_2 -> V_331 ) ;
}
V_2 -> V_331 = V_143 ;
...
int F_184 ( struct V_75 * V_76 , void * V_257 ,
struct V_162 * V_163 )
{
struct V_8 * V_9 = F_49 ( V_76 ) ;
struct V_340 * V_259 =
...
V_295 = F_185 ( V_259 -> V_346 , sizeof( struct V_178 ) ,
V_151 ) ;
if ( F_9 ( ! V_295 ) )
return - V_19 ;
V_341 = ( void T_8 * ) ( unsigned long ) V_259 -> V_295 ;
V_30 = F_186 ( V_295 , V_341 , V_342 ) ;
if ( F_9 ( V_30 != 0 ) ) {
F_10 ( L_39 ) ;
V_30 = - V_348 ;
goto V_349;
...
continue;
V_355 -> V_370 = F_188 ( T_7 , V_355 -> V_370 ,
V_360 ) ;
V_355 -> V_371 = F_188 ( T_7 , V_355 -> V_371 ,
V_361 ) ;
V_366 = F_188 ( T_7 , V_355 -> V_372 , 0 ) ;
V_367 = F_188 ( T_7 , V_355 -> V_373 , 0 ) ;
V_355 -> V_372 -= V_366 ;
V_355 -> V_373 -= V_367 ;
V_355 -> V_368 -= V_366 ;
V_355 -> V_369 -= V_367 ;
...
V_30 = F_190 ( V_9 , V_51 , V_375 ,
V_376 ) ;
if ( V_30 )
F_17 ( V_51 ) ;
return V_30 ;
}
void F_191 ( struct V_22 * V_213 )
{
if ( V_213 )
F_17 ( & V_213 -> V_33 ) ;
}
...
T_3 V_380 ;
int V_30 ;
V_30 = F_193 ( V_163 , V_9 , & V_379 ,
V_163 ? & V_380 : NULL ) ;
if ( V_213 )
F_194 ( & V_213 -> V_33 , V_379 ) ;
if ( V_163 )
F_195 ( V_9 , F_127 ( V_163 ) ,
V_30 , V_177 , V_379 ,
V_380 , - 1 , NULL ) ;
if ( V_378 )
* V_378 = V_379 ;
...
void F_197 ( struct V_220 * V_94 )
{
F_191 ( V_94 -> V_214 ) ;
F_120 ( V_94 , false , NULL , 0 ) ;
F_33 ( & V_94 -> V_9 -> V_224 ) ;
}
int F_198 ( struct V_220 * V_94 ,
bool V_375 )
{
int V_30 = 0 ;
if ( V_375 )
V_30 = F_199 ( & V_94 -> V_9 -> V_224 ) ;
else
F_31 ( & V_94 -> V_9 -> V_224 ) ;
if ( F_9 ( V_30 != 0 ) )
return - V_381 ;
...
goto V_382;
if ( V_94 -> V_214 ) {
V_30 = F_189 ( V_94 -> V_9 , V_94 -> V_214 ,
V_375 ,
V_94 -> V_9 -> V_383 ) ;
if ( V_30 )
goto V_384;
...
void F_201 ( struct V_220 * V_94 ,
struct V_377 * * V_378 )
{
if ( V_94 -> V_214 || V_378 )
F_192 ( V_94 -> V_9 , NULL , V_94 -> V_214 ,
V_378 , NULL ) ;
F_120 ( V_94 , false , NULL , 0 ) ;
F_33 ( & V_94 -> V_9 -> V_224 ) ;
}
int F_202 ( struct V_220 * V_94 ,
const struct V_166 * V_167 ,
unsigned V_168 ,
int V_212 )
{
struct V_8 * V_9 = V_94 -> V_9 ;
struct V_218 * V_62 = & F_203 ( V_94 ) -> V_193 ;
struct {
T_4 V_52 ;
T_12 V_386 ;
} * V_15 ;
...
if ( F_206 ( & V_296 -> V_334 ) )
( void ) F_172 ( V_296 , V_255 , V_256 ) ;
if ( F_206 ( & V_296 -> V_334 ) ) {
F_10 ( L_49 ) ;
return - V_18 ;
}
...
int F_214 ( struct V_394 * V_395 ,
struct V_309 * V_310 )
{
if ( V_395 && V_395 -> V_143 )
V_395 -> V_143 -> type = 0 ;
return F_215 ( V_395 , V_310 ) ;
}
