...
static int F_43 ( struct V_150 * V_151 , int V_300 ,
int V_199 , unsigned int V_301 , int V_302 )
{
struct V_156 * V_157 = F_6 ( V_151 ) ;
unsigned int V_279 = 0 ;
switch ( V_300 ) {
...
if ( V_300 != V_306 )
V_157 -> V_201 = V_300 ;
F_40 ( V_151 -> V_2 , L_12 , V_301 , V_300 ) ;
return 0 ;
}
...
V_182 = F_68 ( V_157 -> V_195 , V_377 ,
F_2 ( V_377 ) ) ;
if ( V_182 != 0 )
F_69 ( & V_361 -> V_2 , L_20 , V_182 ) ;
F_30 ( V_157 -> V_195 , V_147 ,
V_378 , V_378 ) ;
if ( V_157 -> V_176 . V_379 )
