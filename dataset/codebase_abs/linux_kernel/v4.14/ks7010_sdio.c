...
int F_28 ( struct V_1 * V_2 , void * V_40 , unsigned long V_41 ,
void (* F_21)( struct V_1 * V_2 ,
struct V_42 * V_43 ) ,
struct V_42 * V_43 )
{
...
V_2 -> V_65 . V_66 [ V_2 -> V_65 . V_53 ] = F_25 ( V_56 -> V_57 ) ;
...
static void F_31 ( unsigned long V_69 )
{
struct V_1 * V_2 = (struct V_1 * ) V_69 ;
struct V_70 * V_71 ;
F_10 ( 4 , L_1 ) ;
if ( F_32 ( V_2 ) > 0 && V_2 -> V_33 >= V_46 ) {
V_71 = & V_2 -> V_72 . V_73 [ V_2 -> V_72 . V_63 ] ;
F_33 ( V_2 , V_71 -> V_74 , V_71 -> V_41 ) ;
F_34 ( V_2 ) ;
if ( F_32 ( V_2 ) > 0 )
F_35 ( & V_2 -> V_75 ) ;
}
}
static void F_36 ( struct V_1 * V_2 , T_1 V_41 )
{
int V_8 ;
struct V_70 * V_76 ;
struct V_55 * V_56 ;
...
V_76 -> V_41 = F_25 ( V_56 -> V_41 ) + sizeof( V_56 -> V_41 ) ;
V_57 = F_25 ( V_56 -> V_57 ) ;
F_40 ( V_2 ) ;
V_8 = F_5 ( V_2 , V_79 , V_80 ) ;
if ( V_8 )
...
F_54 ( & V_2 -> V_51 . V_68 ) ;
F_54 ( & V_2 -> V_72 . V_94 ) ;
F_55 ( & V_2 -> V_75 , F_31 , ( unsigned long ) V_2 ) ;
return 0 ;
}
...
if ( ! V_168 ) {
F_76 ( & V_88 -> V_6 -> V_69 , L_46 ) ;
goto V_178;
}
if ( F_77 ( V_168 , L_47 ) < 0 ) {
F_76 ( & V_88 -> V_6 -> V_69 ,
L_48 ) ;
goto V_179;
}
...
T_3 V_41 ;
V_88 = F_51 ( V_6 ) ;
V_189 = F_70 ( F_37 ( sizeof( * V_189 ) ) , V_97 ) ;
if ( ! V_189 ) {
F_10 ( 3 , L_54 ) ;
return - V_98 ;
}
