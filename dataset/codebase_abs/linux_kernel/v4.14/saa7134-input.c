...
static int F_14 ( struct V_21 * V_4 ,
enum V_22 * V_23 ,
T_1 * V_24 , T_2 * V_25 )
{
unsigned char V_27 ;
...
V_4 -> V_14 = V_14 ;
V_4 -> V_44 = V_44 ;
snprintf ( V_4 -> V_169 , sizeof( V_4 -> V_169 ) , L_11 ,
V_170 [ V_2 -> V_8 ] . V_169 ) ;
snprintf ( V_4 -> V_171 , sizeof( V_4 -> V_171 ) , L_12 ,
F_43 ( V_2 -> V_172 ) ) ;
V_71 -> V_47 = V_2 ;
V_71 -> V_173 = F_37 ;
V_71 -> V_174 = F_38 ;
...
V_71 -> V_179 = V_4 -> V_169 ;
V_71 -> V_180 = V_4 -> V_171 ;
V_71 -> V_181 . V_182 = V_183 ;
V_71 -> V_181 . V_184 = 1 ;
if ( V_2 -> V_172 -> V_185 ) {
V_71 -> V_181 . V_186 = V_2 -> V_172 -> V_185 ;
V_71 -> V_181 . V_187 = V_2 -> V_172 -> V_188 ;
} else {
V_71 -> V_181 . V_186 = V_2 -> V_172 -> V_186 ;
V_71 -> V_181 . V_187 = V_2 -> V_172 -> V_189 ;
}
V_71 -> V_2 . V_190 = & V_2 -> V_172 -> V_2 ;
V_71 -> V_191 = V_72 ;
V_71 -> V_192 = V_193 ;
V_71 -> V_194 = 1 ;
V_71 -> V_195 = V_196 ;
...
F_50 ( V_199 . type , L_14 , V_206 ) ;
switch ( V_2 -> V_8 ) {
case V_207 :
case V_208 :
V_2 -> V_205 . V_169 = L_15 ;
if ( V_209 == 0 ) {
V_2 -> V_205 . V_210 = F_24 ;
V_2 -> V_205 . V_72 = V_211 ;
V_199 . V_34 = 0x47 ;
} else {
V_2 -> V_205 . V_210 = F_23 ;
V_2 -> V_205 . V_72 = V_212 ;
V_199 . V_34 = 0x47 ;
}
break;
case V_213 :
V_2 -> V_205 . V_169 = L_16 ;
V_2 -> V_205 . V_210 = F_16 ;
V_2 -> V_205 . V_72 = V_214 ;
V_199 . V_34 = 0x7a ;
break;
case V_215 :
V_2 -> V_205 . V_169 = L_17 ;
V_2 -> V_205 . V_210 = F_14 ;
V_2 -> V_205 . V_72 = V_216 ;
V_2 -> V_205 . V_217 = 50 ;
V_199 . V_34 = 0x30 ;
V_71 = F_51 ( & V_2 -> V_218 , & V_201 , 1 ) ;
F_6 ( L_18 ,
V_201 . V_34 , V_2 -> V_218 . V_169 ,
( 1 == V_71 ) ? L_19 : L_20 ) ;
break;
case V_219 :
V_2 -> V_205 . V_169 = L_21 ;
V_2 -> V_205 . V_210 = F_14 ;
V_2 -> V_205 . V_72 = V_216 ;
V_2 -> V_205 . V_217 = 50 ;
V_199 . V_34 = 0x30 ;
...
break;
case V_220 :
V_2 -> V_205 . V_169 = L_22 ;
V_2 -> V_205 . V_210 = F_15 ;
V_2 -> V_205 . V_72 = V_221 ;
V_199 . V_34 = 0x30 ;
V_71 = F_51 ( & V_2 -> V_218 , & V_201 , 1 ) ;
F_6 ( L_18 ,
V_201 . V_34 , V_2 -> V_218 . V_169 ,
...
break;
case V_222 :
V_2 -> V_205 . V_169 = L_23 ;
V_2 -> V_205 . V_210 = F_17 ;
V_2 -> V_205 . V_72 = V_162 ;
V_199 . V_34 = 0x71 ;
break;
case V_223 :
case V_224 :
...
case V_236 :
case V_237 :
V_2 -> V_205 . V_169 = L_24 ;
V_2 -> V_205 . V_210 = F_19 ;
V_2 -> V_205 . V_72 = V_238 ;
V_2 -> V_205 . type = V_239 ;
V_199 . V_34 = 0x2d ;
break;
case V_240 :
case V_241 :
...
break;
case V_243 :
V_2 -> V_205 . V_169 = L_25 ;
V_2 -> V_205 . V_210 = F_9 ;
V_2 -> V_205 . V_72 = V_135 ;
V_199 . V_34 = 0x0b ;
break;
default:
F_6 ( L_26 , V_2 -> V_8 ) ;
...
if ( V_2 -> V_205 . V_169 )
V_199 . V_244 = & V_2 -> V_205 ;
F_52 ( & V_2 -> V_218 , & V_199 ) ;
}
...
F_3 ( V_11 , V_12 ) ;
F_2 ( V_11 , V_12 ) ;
V_245 = F_4 ( V_13 >> 2 ) & V_4 -> V_19 ;
F_53 ( V_2 -> V_5 -> V_2 , ! V_245 ) ;
return 1 ;
}
