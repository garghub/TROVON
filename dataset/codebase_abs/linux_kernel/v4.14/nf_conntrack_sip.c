...
V_97 = F_52 ( V_66 . V_67 . V_70 . V_71 . V_27 ) & ~ 1 ;
V_98 = F_17 ( V_97 ) ;
V_99 = F_17 ( V_97 + 1 ) ;
if ( V_94 ) {
V_101 = F_53 ( V_100 ) ;
...
if ( V_85 == NULL )
goto V_114;
F_55 ( V_85 , V_64 , F_8 ( V_2 ) , V_92 , V_81 ,
V_47 , NULL , & V_98 ) ;
V_86 = F_54 ( V_2 ) ;
if ( V_86 == NULL )
goto V_115;
F_55 ( V_86 , V_64 , F_8 ( V_2 ) , V_92 , V_81 ,
V_47 , NULL , & V_99 ) ;
V_101 = F_53 ( V_100 ) ;
...
unsigned int V_119 ;
for ( V_119 = 0 ; V_119 < F_59 ( V_120 ) ; V_119 ++ ) {
V_118 = & V_120 [ V_119 ] ;
if ( V_26 < V_118 -> V_6 ||
...
static int F_60 ( struct V_78 * V_79 , unsigned int V_80 ,
unsigned int V_32 ,
const char * * V_3 , unsigned int * V_24 ,
unsigned int V_121 )
{
...
enum V_87 V_88 ;
struct V_1 * V_2 = F_46 ( V_79 , & V_88 ) ;
struct V_134 * V_135 = F_63 ( V_2 ) ;
if ( ( V_133 >= 100 && V_133 <= 199 ) ||
( V_133 >= 200 && V_133 <= 299 ) )
return F_60 ( V_79 , V_80 , V_32 , V_3 , V_24 , V_121 ) ;
...
unsigned int V_15 ;
F_43 ( V_2 , true ) ;
V_15 = F_60 ( V_79 , V_80 , V_32 , V_3 , V_24 , V_121 ) ;
if ( V_15 == V_105 )
V_135 -> V_136 = V_121 ;
return V_15 ;
}
...
V_150 = V_25 + V_26 + 1 ;
for ( V_119 = 0 ; V_119 < F_59 ( V_152 ) ; V_119 ++ ) {
...
static int F_72 ( struct V_78 * V_79 , struct V_1 * V_2 ,
...
V_15 = F_71 ( V_79 , V_80 , V_32 , V_3 , V_24 ) ;
else
V_15 = F_70 ( V_79 , V_80 , V_32 , V_3 , V_24 ) ;
...
V_88 != V_169 )
return V_105 ;
V_162 = F_74 ( V_79 , V_80 , sizeof( V_163 ) , & V_163 ) ;
if ( V_162 == NULL )
return V_105 ;
V_32 = V_80 + V_162 -> V_170 * 4 ;
if ( V_32 >= V_79 -> V_6 )
return V_105 ;
F_75 ( V_2 , V_79 , V_142 * V_74 ) ;
if ( F_76 ( F_77 ( V_79 ) ) )
return V_96 ;
V_3 = V_79 -> V_171 + V_32 ;
V_24 = V_79 -> V_6 - V_32 ;
...
if ( V_24 < strlen ( L_17 ) )
return V_105 ;
return F_72 ( V_79 , V_2 , V_80 , V_32 , & V_3 , & V_24 ) ;
}
...
{
int V_119 , V_15 ;
F_82 ( sizeof( struct V_134 ) ) ;
if ( V_176 == 0 )
V_177 [ V_176 ++ ] = V_30 ;
for ( V_119 = 0 ; V_119 < V_176 ; V_119 ++ ) {
F_83 ( & V_175 [ 4 * V_119 ] , V_16 , V_47 , L_24 ,
V_30 , V_177 [ V_119 ] , V_119 , V_178 ,
V_179 , F_78 ,
NULL , V_180 ) ;
F_83 ( & V_175 [ 4 * V_119 + 1 ] , V_16 , V_46 , L_24 ,
V_30 , V_177 [ V_119 ] , V_119 , V_178 ,
V_179 , F_73 ,
NULL , V_180 ) ;
F_83 ( & V_175 [ 4 * V_119 + 2 ] , V_19 , V_47 , L_24 ,
V_30 , V_177 [ V_119 ] , V_119 , V_178 ,
V_179 , F_78 ,
NULL , V_180 ) ;
F_83 ( & V_175 [ 4 * V_119 + 3 ] , V_19 , V_46 , L_24 ,
V_30 , V_177 [ V_119 ] , V_119 , V_178 ,
V_179 , F_73 ,
NULL , V_180 ) ;
}
V_15 = F_84 ( V_175 , V_176 * 4 ) ;
if ( V_15 < 0 ) {
F_85 ( L_25 ) ;
return V_15 ;
}
