...
if ( ! V_2 -> V_12 )
return V_80 ;
V_79 = ( V_75 -> V_81 - V_77 -> V_82 ) >> V_45 ;
V_17 = V_2 -> V_12 [ V_79 ] ;
V_24 = F_69 ( V_77 , V_75 -> V_81 , V_17 ) ;
switch ( V_24 ) {
case - V_83 :
case 0 :
case - V_84 :
...
static int F_70 ( struct V_66 * V_5 ,
struct V_76 * V_77 )
{
struct V_3 * V_2 = F_64 ( V_5 ) ;
if ( ! V_2 -> V_12 ) {
unsigned long V_88 = V_77 -> V_88 ;
int V_24 ;
V_77 -> V_89 &= ~ V_90 ;
V_77 -> V_88 = 0 ;
V_24 = F_71 ( V_5 -> V_32 -> V_32 , V_77 , V_2 -> V_9 , V_2 -> V_8 ,
V_5 -> V_30 ) ;
if ( V_24 < 0 ) {
F_72 ( V_77 ) ;
return V_24 ;
...
int F_74 ( struct V_58 * V_58 , struct V_76 * V_77 )
{
struct V_66 * V_5 ;
int V_24 ;
V_24 = F_75 ( V_58 , V_77 ) ;
...
return V_24 ;
V_5 = V_77 -> V_78 ;
return F_70 ( V_5 , V_77 ) ;
}
static struct V_6 *
F_76 ( struct V_62 * V_63 ,
enum V_93 V_94 )
{
struct V_66 * V_5 = V_63 -> V_11 -> V_95 ;
struct V_3 * V_2 = F_64 ( V_5 ) ;
struct V_6 * V_7 ;
V_7 = F_77 ( sizeof( * V_7 ) , V_27 ) ;
if ( ! V_7 )
return NULL ;
if ( V_2 -> V_12 ) {
struct V_42 * V_96 ;
unsigned int V_44 ;
if ( F_78 ( V_7 , V_2 -> V_13 , V_27 ) )
goto free;
F_46 (sgt->sgl, sg, bo->num_pages, i)
F_79 ( V_96 , V_2 -> V_12 [ V_44 ] , V_18 , 0 ) ;
if ( F_80 ( V_63 -> V_32 , V_7 -> V_36 , V_7 -> V_37 , V_94 ) == 0 )
goto free;
} else {
if ( F_78 ( V_7 , 1 , V_27 ) )
goto free;
F_47 ( V_7 -> V_36 ) = V_2 -> V_8 ;
F_81 ( V_7 -> V_36 ) = V_5 -> V_30 ;
}
return V_7 ;
free:
F_39 ( V_7 ) ;
...
struct V_3 * V_2 = F_64 ( V_5 ) ;
if ( V_2 -> V_12 )
F_83 ( V_63 -> V_32 , V_7 -> V_36 , V_7 -> V_37 , V_94 ) ;
F_39 ( V_7 ) ;
F_27 ( V_7 ) ;
}
...
static void * F_88 ( struct V_60 * V_61 , unsigned long V_17 )
{
return NULL ;
}
static void F_89 ( struct V_60 * V_61 , unsigned long V_17 ,
void * V_16 )
{
}
static int F_90 ( struct V_60 * V_61 , struct V_76 * V_77 )
{
struct V_66 * V_5 = V_61 -> V_95 ;
int V_24 ;
V_24 = F_91 ( V_5 , V_5 -> V_30 , V_77 ) ;
if ( V_24 < 0 )
return V_24 ;
return F_70 ( V_5 , V_77 ) ;
}
...
static void F_93 ( struct V_60 * V_61 , void * V_9 )
{
}
struct V_60 * F_94 ( struct V_38 * V_31 ,
struct V_66 * V_5 ,
int V_50 )
{
F_95 ( V_97 ) ;
...
V_97 . V_50 = V_50 ;
V_97 . V_95 = V_5 ;
return F_96 ( V_31 , & V_97 ) ;
}
struct V_66 * F_97 ( struct V_38 * V_31 ,
struct V_60 * V_61 )
{
struct V_3 * V_2 ;
if ( V_61 -> V_98 == & V_99 ) {
