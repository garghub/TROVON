...
V_79 = V_74 -> V_26 - V_57 -> V_81 -> V_2 . V_88
- V_57 -> V_81 -> V_2 . V_26 ;
else if ( V_18 & F_10 ( V_34 ) && V_2 -> V_18 . V_16 )
V_79 = V_74 -> V_27 - V_57 -> V_81 -> V_2 . V_88
- V_57 -> V_81 -> V_2 . V_26 ;
else
V_79 = V_57 -> V_81 -> V_2 . V_88 ;
...
{
struct V_1 * V_2 = F_20 ( & V_7 -> V_51 ) ;
return V_2 -> V_18 . V_16 ? 256 : V_2 -> V_128 ;
}
static void F_36 ( struct V_54 * V_7 ,
struct V_56 * V_57 ,
struct V_129 * V_81 ,
unsigned int V_130 ,
struct V_131 * V_132 )
...
struct V_1 * F_37 ( struct V_38 * V_39 , unsigned int V_8 )
{
struct V_1 * V_2 ;
char V_133 [ 6 ] ;
int V_17 ;
V_2 = F_38 ( V_39 -> V_49 , sizeof( * V_2 ) , V_134 ) ;
if ( V_2 == NULL )
return F_39 ( - V_135 ) ;
if ( V_39 -> V_41 -> V_97 == 2 ) {
V_2 -> V_128 = V_136 ;
...
V_2 -> V_7 . type = V_143 ;
V_2 -> V_7 . V_8 = V_8 ;
sprintf ( V_133 , L_2 , V_8 ) ;
V_17 = F_40 ( V_39 , & V_2 -> V_7 , V_133 , 2 , & V_144 ,
V_145 ) ;
if ( V_17 < 0 )
return F_39 ( V_17 ) ;
V_2 -> V_55 = F_41 ( V_39 , V_8 , 64 ) ;
if ( ! V_2 -> V_55 ) {
V_17 = - V_135 ;
goto error;
}
