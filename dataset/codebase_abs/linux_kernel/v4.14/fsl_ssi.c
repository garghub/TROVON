...
static int F_60 ( struct V_195 * V_196 ,
struct V_18 * V_19 , void T_6 * V_197 )
{
struct V_198 * V_199 = V_196 -> V_2 . V_200 ;
T_3 V_201 [ 4 ] ;
int V_90 ;
if ( V_19 -> V_202 )
V_19 -> V_91 = F_61 ( & V_196 -> V_2 , L_9 ) ;
else
V_19 -> V_91 = F_61 ( & V_196 -> V_2 , NULL ) ;
if ( F_35 ( V_19 -> V_91 ) ) {
V_90 = F_62 ( V_19 -> V_91 ) ;
F_18 ( & V_196 -> V_2 , L_10 , V_90 ) ;
return V_90 ;
}
if ( ! V_19 -> V_202 ) {
V_90 = F_28 ( V_19 -> V_91 ) ;
if ( V_90 ) {
F_18 ( & V_196 -> V_2 , L_11 , V_90 ) ;
return V_90 ;
}
}
V_19 -> V_115 = F_61 ( & V_196 -> V_2 , L_12 ) ;
if ( F_35 ( V_19 -> V_115 ) )
F_63 ( & V_196 -> V_2 , L_13 ,
F_62 ( V_19 -> V_115 ) ) ;
V_19 -> V_182 . V_203 = V_19 -> V_204 ;
V_19 -> V_184 . V_203 = V_19 -> V_204 ;
V_19 -> V_182 . V_205 = V_19 -> V_206 + V_6 ;
V_19 -> V_184 . V_205 = V_19 -> V_206 + V_8 ;
V_90 = F_64 ( V_199 , L_14 , V_201 , 4 ) ;
if ( V_19 -> V_62 && ! V_90 && V_201 [ 2 ] == V_207 ) {
V_19 -> V_92 = true ;
V_19 -> V_182 . V_203 &= ~ 0x1 ;
V_19 -> V_184 . V_203 &= ~ 0x1 ;
}
if ( ! V_19 -> V_62 ) {
V_19 -> V_208 . V_26 = V_19 -> V_26 ;
V_19 -> V_208 . V_209 = V_197 ;
V_19 -> V_208 . V_184 =
& V_19 -> V_184 ;
V_19 -> V_208 . V_182 =
& V_19 -> V_182 ;
V_90 = F_65 ( V_196 , & V_19 -> V_208 ) ;
if ( V_90 )
goto V_210;
} else {
V_90 = F_66 ( V_196 , V_211 ) ;
if ( V_90 )
goto V_210;
}
return 0 ;
...
static void F_67 ( struct V_195 * V_196 ,
struct V_18 * V_19 )
{
if ( ! V_19 -> V_62 )
F_68 ( V_196 ) ;
...
static int F_69 ( struct V_195 * V_196 )
{
struct V_18 * V_19 ;
int V_90 = 0 ;
struct V_198 * V_199 = V_196 -> V_2 . V_200 ;
const struct V_212 * V_213 ;
const char * V_214 , * V_215 ;
const T_7 * V_216 ;
struct V_217 * V_218 ;
void T_6 * V_197 ;
char V_219 [ 64 ] ;
struct V_220 V_221 = V_222 ;
V_213 = F_70 ( V_223 , & V_196 -> V_2 ) ;
if ( ! V_213 || ! V_213 -> V_224 )
return - V_116 ;
V_19 = F_71 ( & V_196 -> V_2 , sizeof( * V_19 ) ,
V_225 ) ;
if ( ! V_19 )
return - V_226 ;
V_19 -> V_32 = V_213 -> V_224 ;
V_19 -> V_2 = & V_196 -> V_2 ;
V_215 = F_72 ( V_199 , L_15 , NULL ) ;
if ( V_215 ) {
if ( ! strcmp ( V_215 , L_16 ) )
V_19 -> V_20 = V_22 ;
}
V_19 -> V_62 = ! F_73 ( V_199 ,
L_17 ) ;
if ( F_5 ( V_19 ) ) {
memcpy ( & V_19 -> V_98 , & V_227 ,
sizeof( V_227 ) ) ;
V_187 = V_19 ;
V_90 = F_74 ( & V_228 , V_196 ) ;
if ( V_90 ) {
F_18 ( & V_196 -> V_2 , L_18 ) ;
return V_90 ;
}
...
V_19 -> V_98 . V_219 = F_75 ( & V_196 -> V_2 ) ;
V_218 = F_76 ( V_196 , V_230 , 0 ) ;
V_197 = F_77 ( & V_196 -> V_2 , V_218 ) ;
if ( F_35 ( V_197 ) )
return F_62 ( V_197 ) ;
V_19 -> V_206 = V_218 -> V_231 ;
if ( V_19 -> V_32 -> V_81 ) {
V_221 . V_232 = V_172 ;
V_221 . V_233 =
V_172 / sizeof( T_7 ) + 1 ;
}
V_90 = F_78 ( V_199 , L_19 , L_9 ) ;
if ( V_90 < 0 ) {
V_19 -> V_202 = false ;
V_19 -> V_29 = F_79 ( & V_196 -> V_2 , V_197 ,
& V_221 ) ;
} else {
V_19 -> V_202 = true ;
V_19 -> V_29 = F_80 ( & V_196 -> V_2 ,
L_9 , V_197 , & V_221 ) ;
}
if ( F_35 ( V_19 -> V_29 ) ) {
F_18 ( & V_196 -> V_2 , L_20 ) ;
...
V_19 -> V_26 = F_81 ( V_196 , 0 ) ;
if ( V_19 -> V_26 < 0 ) {
F_18 ( & V_196 -> V_2 , L_21 , V_196 -> V_219 ) ;
return V_19 -> V_26 ;
}
if ( ! F_82 ( V_199 , L_22 , NULL ) ) {
if ( ! F_5 ( V_19 ) )
V_19 -> V_98 . V_99 = 1 ;
V_19 -> V_98 . V_234 = 1 ;
V_19 -> V_98 . V_235 = 1 ;
}
V_216 = F_72 ( V_199 , L_23 , NULL ) ;
if ( V_216 )
V_19 -> V_236 = F_83 ( V_216 ) ;
else
V_19 -> V_236 = 8 ;
switch ( V_19 -> V_236 ) {
case 15 :
...
case 8 :
default:
V_19 -> V_162 = V_19 -> V_236 - 2 ;
V_19 -> V_204 = V_19 -> V_236 - 2 ;
break;
}
F_84 ( & V_196 -> V_2 , V_19 ) ;
if ( V_19 -> V_32 -> V_180 ) {
V_90 = F_60 ( V_196 , V_19 , V_197 ) ;
if ( V_90 )
return V_90 ;
}
V_90 = F_85 ( & V_196 -> V_2 , & V_237 ,
& V_19 -> V_98 , 1 ) ;
if ( V_90 ) {
F_18 ( & V_196 -> V_2 , L_24 , V_90 ) ;
goto V_238;
}
if ( V_19 -> V_62 ) {
V_90 = F_86 ( & V_196 -> V_2 , V_19 -> V_26 ,
F_8 , 0 , F_75 ( & V_196 -> V_2 ) ,
V_19 ) ;
if ( V_90 < 0 ) {
F_18 ( & V_196 -> V_2 , L_25 ,
V_19 -> V_26 ) ;
...
V_90 = F_87 ( & V_19 -> V_34 , & V_196 -> V_2 ) ;
if ( V_90 )
goto V_238;
if ( ! F_72 ( V_199 , L_26 , NULL ) )
goto V_239;
V_215 = F_72 ( F_88 ( L_27 ) , L_28 , NULL ) ;
V_214 = strrchr ( V_215 , ',' ) ;
if ( V_214 )
V_215 = V_214 + 1 ;
snprintf ( V_219 , sizeof( V_219 ) , L_29 , V_215 ) ;
F_59 ( V_219 ) ;
V_19 -> V_196 =
F_89 ( & V_196 -> V_2 , V_219 , 0 , NULL , 0 ) ;
if ( F_35 ( V_19 -> V_196 ) ) {
V_90 = F_62 ( V_19 -> V_196 ) ;
F_18 ( & V_196 -> V_2 , L_30 , V_90 ) ;
goto V_240;
}
V_239:
if ( V_19 -> V_20 )
...
{
struct V_18 * V_19 = F_93 ( & V_196 -> V_2 ) ;
F_91 ( & V_19 -> V_34 ) ;
if ( V_19 -> V_196 )
F_94 ( V_19 -> V_196 ) ;
if ( V_19 -> V_32 -> V_180 )
