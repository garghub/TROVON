...
{
unsigned int V_56 = V_4 -> V_57 ;
F_21 ( V_4 , true ) ;
F_7 ( ( V_56 / 2 << 16 ) | V_56 , V_4 -> V_15 + V_58 ) ;
F_21 ( V_4 , false ) ;
}
...
unsigned long V_65 ;
int V_1 , V_20 ;
V_4 = F_28 ( V_14 , sizeof( * V_4 ) , V_66 ) ;
if ( ! V_4 )
return - V_67 ;
V_63 = F_29 ( V_60 , V_68 , 0 ) ;
...
if ( F_34 ( V_14 -> V_69 , L_12 , & V_64 ) )
V_64 = V_70 ;
if ( ! V_64 || V_64 > V_71 ) {
F_10 ( V_14 , L_13 , V_64 ) ;
return - V_72 ;
}
V_4 -> V_73 = F_35 ( V_14 , NULL ) ;
if ( F_31 ( V_4 -> V_73 ) ) {
F_10 ( V_14 , L_14 ) ;
return F_32 ( V_4 -> V_73 ) ;
}
V_20 = F_36 ( V_4 -> V_73 ) ;
if ( V_20 )
return V_20 ;
...
V_4 -> V_8 . V_75 = V_76 ;
V_4 -> V_8 . V_77 = & V_78 ;
V_4 -> V_8 . V_14 . V_79 = V_14 ;
V_4 -> V_8 . V_14 . V_69 = V_14 -> V_69 ;
F_39 ( V_4 -> V_8 . V_80 , L_16 , sizeof( V_4 -> V_8 . V_80 ) ) ;
V_4 -> V_8 . V_81 = & V_82 ;
F_40 ( & V_4 -> V_8 , V_4 ) ;
F_41 ( V_60 , V_4 ) ;
F_26 ( V_4 ) ;
V_20 = F_42 ( V_14 , V_1 , F_1 , 0 , V_60 -> V_80 ,
V_4 ) ;
if ( V_20 ) {
F_10 ( V_14 , L_17 , V_1 ) ;
goto V_74;
...
static int T_5 F_48 ( struct V_61 * V_14 )
{
struct V_3 * V_4 = F_49 ( V_14 ) ;
F_44 ( V_4 -> V_73 ) ;
return 0 ;
}
static int T_5 F_50 ( struct V_61 * V_14 )
{
struct V_3 * V_4 = F_49 ( V_14 ) ;
int V_20 ;
V_20 = F_36 ( V_4 -> V_73 ) ;
