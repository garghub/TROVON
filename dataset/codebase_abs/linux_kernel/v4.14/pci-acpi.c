...
{
if ( F_57 ( & V_6 -> V_6 ) )
return F_60 ( & V_6 -> V_6 , V_122 ) ;
return F_56 ( V_6 -> V_88 , V_122 ) ;
}
static bool F_61 ( struct V_83 * V_6 )
{
struct V_1 * V_2 = F_46 ( & V_6 -> V_6 ) ;
if ( ! V_2 || ! F_47 ( V_2 ) )
return false ;
if ( F_62 ( & V_6 -> V_6 ) != ! ! V_2 -> V_96 . V_125 )
return true ;
if ( F_63 () == V_126 )
return false ;
return ! ! V_2 -> V_127 . V_11 . V_128 ;
}
void F_64 ( struct V_85 * V_88 )
{
union V_31 * V_129 ;
struct V_130 * V_124 ;
if ( V_87 || ! V_88 -> V_124 )
...
if ( ! F_67 ( V_88 ) )
return;
V_129 = F_68 ( F_69 ( V_88 -> V_124 ) , & V_131 , 3 ,
V_132 , NULL ) ;
if ( ! V_129 )
return;
...
static struct V_1 * F_75 ( struct V_5 * V_6 )
{
struct V_83 * V_83 = F_36 ( V_6 ) ;
bool V_134 ;
T_8 V_135 ;
V_134 = F_76 ( V_83 ) ;
V_135 = ( F_77 ( V_83 -> V_136 ) << 16 ) | F_78 ( V_83 -> V_136 ) ;
return F_79 ( F_46 ( V_6 -> V_89 ) , V_135 ,
V_134 ) ;
}
static void F_80 ( struct V_83 * V_90 ,
T_2 V_17 )
{
struct V_130 * V_124 = F_70 ( V_90 -> V_88 ) ;
int V_40 ;
union V_31 * V_129 , * V_38 ;
if ( V_124 -> V_133 )
V_90 -> V_137 = 0 ;
V_129 = F_68 ( V_17 , & V_131 , 3 ,
V_138 , NULL ) ;
if ( ! V_129 )
return;
...
struct V_143 * F_87 ( struct V_85 * V_88 )
{
struct V_144 * V_145 ;
if ( ! V_146 )
return NULL ;
