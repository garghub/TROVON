...
V_46 = F_27 ( V_43 -> V_48 , L_2 ) ;
if ( ! V_46 )
return - V_49 ;
for ( V_47 = 0 ; V_47 < F_28 ( V_4 -> V_8 ) ; V_47 ++ ) {
V_4 -> V_8 [ V_47 ] =
F_29 ( V_43 , L_3 , V_47 ,
V_50 ) ;
if ( F_30 ( V_4 -> V_8 [ V_47 ] ) ) {
V_10 = F_31 ( V_4 -> V_8 [ V_47 ] ) ;
F_32 ( V_42 , L_4 , V_47 , V_10 ) ;
goto V_51;
}
if ( ! V_4 -> V_8 [ V_47 ] ) {
F_33 ( V_42 , L_5 , V_47 ) ;
...
{
struct V_57 * V_57 = F_37 ( V_56 -> V_42 . V_58 ) ;
...
int V_10 , V_47 , V_67 ;
V_4 = F_38 ( & V_56 -> V_42 , sizeof( * V_4 ) , V_68 ) ;
if ( ! V_4 )
return - V_69 ;
V_10 = F_26 ( & V_56 -> V_42 , & V_60 -> V_42 ,
V_57 -> V_11 , V_4 ) ;
if ( V_10 < 0 )
return V_10 ;
F_39 ( V_56 , V_4 ) ;
