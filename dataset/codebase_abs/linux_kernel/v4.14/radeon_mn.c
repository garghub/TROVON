...
return F_27 ( - V_36 ) ;
F_3 ( & V_6 -> V_13 ) ;
F_28 (rdev->mn_hash, rmn, node, (unsigned long)mm)
if ( V_4 -> V_19 == V_19 )
goto V_37;
V_4 = F_29 ( sizeof( * V_4 ) , V_38 ) ;
if ( ! V_4 ) {
V_4 = F_27 ( - V_39 ) ;
goto V_37;
}
...
if ( V_25 )
goto V_43;
F_32 ( V_6 -> V_44 , & V_4 -> V_8 , ( unsigned long ) V_19 ) ;
V_37:
F_10 ( & V_6 -> V_13 ) ;
F_33 ( & V_19 -> V_35 ) ;
return V_4 ;
...
int F_34 ( struct V_10 * V_11 , unsigned long V_45 )
{
unsigned long V_23 = V_45 + F_35 ( V_11 ) - 1 ;
...
F_38 ( & V_47 ) ;
F_3 ( & V_4 -> V_14 ) ;
while ( ( V_15 = F_16 ( & V_4 -> V_16 , V_45 , V_23 ) ) ) {
F_9 ( V_8 ) ;
V_8 = F_2 ( V_15 , struct V_7 , V_15 ) ;
F_6 ( & V_8 -> V_15 , & V_4 -> V_16 ) ;
V_45 = F_39 ( V_15 -> V_22 , V_45 ) ;
V_23 = F_40 ( V_15 -> V_48 , V_23 ) ;
F_41 ( & V_8 -> V_47 , & V_47 ) ;
}
if ( ! V_8 ) {
V_8 = F_42 ( sizeof( struct V_7 ) , V_38 ) ;
if ( ! V_8 ) {
F_10 ( & V_4 -> V_14 ) ;
return - V_39 ;
}
