...
{
struct V_108 * V_105 = V_37 -> V_106 ;
* V_1 ++ = F_15 ( V_105 -> V_69 ) ;
F_43 ( V_37 , V_1 ) ;
V_37 -> V_109 . V_87 = V_105 -> V_69 ;
if ( V_105 -> V_69 & 3 ) {
V_37 -> V_109 . V_110 [ 0 ] . V_77 = V_1 ;
* V_1 = 0 ;
V_37 -> V_109 . V_110 [ 0 ] . V_78 = 4 - ( V_105 -> V_69 & 3 ) ;
}
return 1 ;
}
int
...
{
struct V_111 * V_105 = V_37 -> V_106 ;
V_1 = F_14 ( V_37 , V_1 , & V_105 -> V_65 , & V_105 -> V_39 ) ;
* V_1 ++ = F_15 ( V_105 -> V_73 ) ;
F_43 ( V_37 , V_1 ) ;
V_37 -> V_109 . V_87 = V_105 -> V_73 ;
if ( V_105 -> V_73 & 3 ) {
V_37 -> V_109 . V_110 [ 0 ] . V_77 = V_1 ;
* V_1 = 0 ;
V_37 -> V_109 . V_110 [ 0 ] . V_78 = 4 - ( V_105 -> V_73 & 3 ) ;
}
return 1 ;
}
int
...
{
struct V_112 * V_105 = V_37 -> V_106 ;
F_43 ( V_37 , V_1 ) ;
V_1 = V_105 -> V_99 ;
* V_1 ++ = 0 ;
* V_1 ++ = F_15 ( ( V_105 -> V_113 . V_114 == V_115 ) ) ;
V_37 -> V_109 . V_87 = ( ( ( unsigned long ) V_1 - 1 ) & ~ V_116 ) + 1 ;
return 1 ;
}
int
F_49 ( struct V_36 * V_37 , T_1 * V_1 )
{
struct V_117 * V_105 = V_37 -> V_106 ;
struct V_118 * V_39 = & V_105 -> V_119 ;
* V_1 ++ = F_15 ( V_86 ) ;
* V_1 ++ = F_15 ( V_39 -> V_120 ) ;
* V_1 ++ = F_15 ( V_39 -> V_121 ) ;
* V_1 ++ = F_15 ( V_39 -> V_122 ) ;
...
int
F_50 ( void * V_124 , const char * V_10 ,
int V_125 , T_3 V_72 , T_4 V_61 , unsigned int V_126 )
{
struct V_127 * V_128 = V_124 ;
struct V_112 * V_129 = F_51 ( V_128 , struct V_112 , V_113 ) ;
T_1 * V_1 = V_129 -> V_99 ;
int V_130 , V_131 ;
if ( V_72 > ~ ( ( T_2 ) 0 ) ) {
...
if ( V_129 -> V_72 )
* V_129 -> V_72 = F_15 ( V_72 ) ;
V_125 = F_52 ( V_125 , V_134 ) ;
V_131 = F_35 ( V_125 ) ;
