...
F_19 ( ! V_2 -> V_43 ) ;
V_8 -> V_19 = V_63 ;
V_8 -> V_19 . V_2 . V_64 = V_2 -> V_2 ;
snprintf ( V_8 -> V_19 . V_65 , sizeof( V_8 -> V_19 . V_65 ) , L_17 , V_8 -> V_2 -> V_65 , V_8 -> V_13 ) ;
V_8 -> V_19 . V_20 = V_8 ;
F_20 ( & V_8 -> V_19 , & V_2 -> V_66 ) ;
V_8 -> V_67 = F_21 ( & V_8 -> V_19 ) ;
if ( 0 != V_8 -> V_67 )
F_22 ( V_2 -> V_2 ,
L_18 , V_8 -> V_13 ) ;
return V_8 -> V_67 ;
...
return F_27 ( V_2 , V_70 ) ;
}
int F_28 ( struct V_1 * V_2 )
{
V_2 -> V_69 = F_29 ( & V_2 -> V_71 [ 1 ] . V_19 , V_2 -> V_2 , 2 , 0 , 0 ,
F_25 , NULL ) ;
if ( ! V_2 -> V_69 )
return - V_72 ;
V_2 -> V_69 -> V_73 = V_2 ;
...
int F_30 ( struct V_1 * V_2 , int V_74 )
{
return F_31 ( V_2 -> V_69 ,
0 ,
V_74 ,
0 ) ;
}
...
switch ( V_12 ) {
case V_75 :
return & V_2 -> V_71 [ 0 ] . V_19 ;
case V_76 :
return & V_2 -> V_71 [ 1 ] . V_19 ;
case V_77 :
return & V_2 -> V_71 [ 2 ] . V_19 ;
case V_6 :
return V_2 -> V_69 -> V_78 [ 0 ] ;
case V_5 :
return V_2 -> V_69 -> V_78 [ 1 ] ;
default:
F_34 () ;
}
}
