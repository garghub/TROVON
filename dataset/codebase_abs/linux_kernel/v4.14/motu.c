...
static int F_25 ( struct V_38 * V_5 ,
const struct V_39 * V_40 )
{
struct V_1 * V_2 ;
V_2 = F_26 ( sizeof( struct V_1 ) , V_41 ) ;
if ( V_2 == NULL )
return - V_42 ;
V_2 -> V_16 = ( const struct V_43 * ) V_40 -> V_44 ;
V_2 -> V_5 = F_27 ( V_5 ) ;
F_28 ( & V_5 -> V_21 , V_2 ) ;
F_29 ( & V_2 -> V_23 ) ;
F_30 ( & V_2 -> V_45 ) ;
...
static void F_34 ( struct V_38 * V_5 )
{
...
static void F_38 ( struct V_38 * V_5 )
{
struct V_1 * V_2 = F_35 ( & V_5 -> V_21 ) ;
if ( ! V_2 -> V_30 )
F_33 ( V_5 , & V_2 -> V_28 ) ;
