...
static void F_40 ( unsigned long V_76 ,
unsigned int V_77 ,
unsigned int V_34 ,
void * V_78 )
{
struct V_79 * V_80 = V_78 ;
unsigned long V_39 = ( unsigned long ) F_41 ( V_76 ) ;
V_80 -> V_81 [ V_80 -> V_82 ] = V_39 ;
V_80 -> V_62 [ V_80 -> V_82 ] = V_39 ;
V_80 -> V_82 ++ ;
}
...
unsigned int V_40 = F_43 ( V_58 ) ;
if ( V_58 > V_66 )
return - V_70 ;
* V_39 = NULL ;
V_19 = F_44 ( sizeof( * V_19 ) , V_37 ) ;
if ( ! V_19 )
return - V_24 ;
V_18 = F_45 ( V_40 , V_19 -> V_86 . V_87 ) ;
if ( V_18 )
goto V_88;
F_46 ( V_19 -> V_86 . V_87 , V_58 ,
F_40 ,
& V_80 ) ;
V_18 = F_34 ( V_14 , V_83 , V_58 , V_19 -> V_61 ,
V_80 . V_81 , V_74 , & V_64 ) ;
V_19 -> V_89 = V_58 ;
if ( V_18 )
goto V_90;
V_85 = F_47 ( V_19 -> V_86 . V_87 , V_40 , V_91 | V_92 ,
V_93 ) ;
if ( ! V_85 ) {
V_18 = - V_24 ;
goto V_94;
...
V_94:
if ( ! V_64 )
F_51 ( V_14 , V_19 -> V_61 , V_58 , V_80 . V_62 ) ;
else
F_52 ( L_27 ,
V_85 , V_40 ) ;
V_90:
if ( ! V_64 )
F_53 ( V_40 , V_19 -> V_86 . V_87 ) ;
V_88:
F_9 ( V_19 ) ;
return V_18 ;
}
int F_54 ( struct V_13 * V_14 , T_2 * V_57 ,
unsigned int V_58 , T_3 * V_61 ,
unsigned long * V_98 , bool * V_64 )
{
T_4 V_81 [ V_66 ] ;
int V_42 ;
if ( V_58 > V_66 )
return - V_70 ;
for ( V_42 = 0 ; V_42 < V_58 ; V_42 ++ )
V_81 [ V_42 ] = ( unsigned long ) V_98 [ V_42 ] ;
return F_34 ( V_14 , V_57 , V_58 , V_61 ,
V_81 , V_74 , V_64 ) ;
}
int F_55 ( struct V_13 * V_14 , void * V_39 )
{
...
if ( ! V_19 )
return - V_24 ;
V_100 = F_57 ( V_46 * V_58 , V_101 ) ;
if ( ! V_100 ) {
F_9 ( V_19 ) ;
return - V_24 ;
}
for ( V_42 = 0 ; V_42 < V_58 ; V_42 ++ )
V_81 [ V_42 ] = F_58 ( V_101 [ V_42 ] ) . V_102 ;
...
for ( V_42 = 0 ; V_42 < V_19 -> V_89 ; V_42 ++ ) {
unsigned long V_85 ;
memset ( & V_68 [ V_42 ] , 0 , sizeof( V_68 [ V_42 ] ) ) ;
V_85 = ( unsigned long ) V_39 + ( V_46 * V_42 ) ;
V_68 [ V_42 ] . V_110 = F_58 (
F_63 ( V_85 , & V_106 ) ) . V_102 ;
V_68 [ V_42 ] . V_111 = 0 ;
...
if ( ! V_64 )
F_59 ( V_19 -> V_105 . V_100 ) ;
else
F_52 ( L_28 ,
V_19 -> V_105 . V_100 , V_19 -> V_89 ) ;
F_9 ( V_19 ) ;
return V_18 ;
}
static void F_64 ( unsigned long V_76 ,
unsigned int V_77 ,
unsigned int V_34 ,
void * V_78 )
{
struct V_112 * V_80 = V_78 ;
V_80 -> V_62 [ V_80 -> V_82 ] = ( unsigned long ) F_41 ( V_76 ) ;
V_80 -> V_82 ++ ;
}
...
V_40 = F_43 ( V_19 -> V_89 ) ;
F_46 ( V_19 -> V_86 . V_87 , V_19 -> V_89 ,
F_64 ,
& V_80 ) ;
V_113 = F_51 ( V_14 , V_19 -> V_61 , V_19 -> V_89 ,
V_80 . V_62 ) ;
if ( ! V_113 ) {
F_66 ( V_39 ) ;
F_53 ( V_40 , V_19 -> V_86 . V_87 ) ;
...
if ( V_89 > V_66 )
return - V_70 ;
for ( V_42 = 0 ; V_42 < V_89 ; V_42 ++ )
F_37 ( & V_68 [ V_42 ] , V_98 [ V_42 ] ,
V_74 , V_61 [ V_42 ] ) ;
if ( F_38 ( V_75 , V_68 , V_42 ) )
F_39 () ;
V_18 = V_69 ;
