...
int V_15 ;
V_1 [ 0 ] = 0 ;
for ( V_15 = 0 ; V_15 < F_19 ( V_30 ) ; V_15 ++ ) {
if ( V_4 -> V_21 == V_15 ) {
strcat ( V_1 , L_6 ) ;
...
static T_4 F_20 ( struct V_22 * V_11 ,
struct V_23 * V_24 , const char * V_1 , T_1 V_2 )
{
struct V_25 * V_8 = F_13 ( V_11 ) ;
struct V_3 * V_4 = F_14 ( V_8 ) ;
...
static int F_22 ( struct V_25 * V_31 ,
const struct V_32 * V_33 )
{
struct V_34 * V_10 = F_23 ( V_31 ) ;
struct V_3 * V_4 = NULL ;
int V_5 = - V_35 ;
...
static void F_29 ( struct V_25 * V_31 )
{
struct V_3 * V_4 ;
V_4 = F_14 ( V_31 ) ;
F_30 ( & V_31 -> V_11 . V_37 , & V_38 ) ;
F_25 ( V_31 , NULL ) ;
F_28 ( V_4 -> V_10 ) ;
F_11 ( V_4 ) ;
F_27 ( & V_31 -> V_11 , L_11 ) ;
}
static int F_31 ( struct V_25 * V_8 , T_5 V_39 )
{
struct V_3 * V_4 ;
V_4 = F_14 ( V_8 ) ;
V_4 -> V_9 = 0 ;
...
static int F_33 ( struct V_25 * V_8 )
{
struct V_3 * V_4 ;
V_4 = F_14 ( V_8 ) ;
V_4 -> V_9 = 1 ;
