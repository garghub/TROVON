...
struct V_114 * V_115 )
{
static const char * const V_133 [ 2 ] = { L_7 , L_8 } ;
return F_63 ( V_115 , 1 , 2 , V_133 ) ;
}
static int
...
int V_122 ;
F_59 ( & V_2 -> V_13 ) ;
V_122 = ( V_2 -> V_16 . V_17 >> V_134 ) & 1 ;
V_126 -> V_122 . V_135 . V_136 [ 0 ] = V_122 ;
F_60 ( & V_2 -> V_13 ) ;
return 0 ;
}
static int
F_65 ( struct V_112 * V_113 ,
struct V_125 * V_126 )
{
struct V_1 * V_2 = F_58 ( V_113 ) ;
int V_122 ;
int V_132 = V_2 -> V_16 . V_17 ;
F_59 ( & V_2 -> V_13 ) ;
V_122 = V_126 -> V_122 . V_135 . V_136 [ 0 ] & 1 ;
V_2 -> V_16 . V_17 &= ~ V_137 ;
V_2 -> V_16 . V_17 |= V_122 << V_134 ;
F_55 ( V_2 ) ;
F_60 ( & V_2 -> V_13 ) ;
return V_2 -> V_16 . V_17 != V_132 ;
}
...
return - V_60 ;
V_99 = V_2 -> V_99 ;
strcpy ( V_99 -> V_141 , L_9 ) ;
for ( V_140 = 0 ; V_140 < V_142 ; V_140 ++ ) {
V_86 = F_68 ( V_99 ,
F_69 ( & V_143 [ V_140 ] , V_2 ) ) ;
if ( V_86 < 0 )
return V_86 ;
}
F_66 ( V_2 ) ;
...
static int
F_75 ( struct V_144 * V_24 )
{
struct V_1 * V_2 = V_24 -> V_145 ;
return F_70 ( V_2 ) ;
}
static int
F_76 ( struct V_139 * V_99 ,
struct V_146 * V_147 ,
struct V_1 * * V_148 )
{
int V_86 ;
...
* V_148 = NULL ;
V_2 = F_77 ( sizeof( * V_2 ) , V_152 ) ;
if ( V_2 == NULL )
return - V_153 ;
V_2 -> V_154 = V_147 -> V_154 . V_155 ;
V_2 -> V_99 = V_99 ;
V_2 -> V_24 = V_147 ;
V_2 -> V_23 = - 1 ;
V_2 -> V_4 = F_78 ( V_147 -> V_154 . V_155 , V_156 ) ;
if ( V_2 -> V_4 == NULL ) {
...
struct V_139 * V_99 ;
struct V_1 * V_2 ;
V_86 = F_83 ( & V_147 -> V_24 , V_159 , V_160 , V_161 , 0 , & V_99 ) ;
if ( V_86 < 0 )
return V_86 ;
V_86 = F_76 ( V_99 , V_147 , & V_2 ) ;
if ( V_86 < 0 )
goto V_157;
V_86 = F_49 ( V_2 ) ;
if ( V_86 < 0 )
...
if ( V_86 < 0 )
goto V_157;
strcpy ( V_99 -> V_162 , L_3 ) ;
strcpy ( V_99 -> V_163 , L_12 ) ;
sprintf ( V_99 -> V_164 , L_13 ,
V_99 -> V_163 , V_2 -> V_154 , V_2 -> V_23 ) ;
V_86 = F_84 ( V_99 ) ;
if ( V_86 < 0 )
goto V_157;
F_85 ( V_147 , V_99 ) ;
