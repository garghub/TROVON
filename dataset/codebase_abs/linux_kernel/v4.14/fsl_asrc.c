...
if ( ( V_33 > 8000 && V_33 < 30000 ) &&
( V_33 / V_32 > 24 || V_32 / V_33 > 8 ) ) {
F_14 ( L_9 , V_32 , V_33 ) ;
return - V_21 ;
}
...
enum V_4 V_5 = V_3 -> V_5 ;
char V_75 [ 4 ] ;
sprintf ( V_75 , L_12 , V_74 == V_52 ? 'r' : 't' , V_5 + 'a' ) ;
...
unsigned int V_1 = F_59 ( V_79 ) ;
unsigned int V_86 = F_60 ( V_79 ) ;
struct V_36 V_37 ;
int V_87 , V_14 ;
V_14 = F_1 ( V_1 , V_3 ) ;
if ( V_14 ) {
...
static int F_62 ( struct V_76 * V_77 , int V_95 ,
struct V_80 * V_81 )
{
struct V_83 * V_84 = V_77 -> V_84 ;
struct V_2 * V_3 = V_84 -> V_85 ;
...
static bool F_65 ( struct V_9 * V_10 , unsigned int V_69 )
{
switch ( V_69 ) {
case V_23 :
case V_71 :
...
static T_2 F_70 ( int V_139 , void * V_140 )
{
...
static int F_77 ( struct V_150 * V_11 )
{
...
int V_139 , V_14 , V_13 ;
char V_157 [ 16 ] ;
V_8 = F_78 ( & V_11 -> V_10 , sizeof( * V_8 ) , V_158 ) ;
if ( ! V_8 )
return - V_159 ;
V_8 -> V_11 = V_11 ;
V_155 = F_79 ( V_11 , V_160 , 0 ) ;
V_156 = F_80 ( & V_11 -> V_10 , V_155 ) ;
if ( F_81 ( V_156 ) )
return F_82 ( V_156 ) ;
V_8 -> V_161 = V_155 -> V_162 ;
V_8 -> V_22 = F_83 ( & V_11 -> V_10 , L_20 , V_156 ,
& V_163 ) ;
if ( F_81 ( V_8 -> V_22 ) ) {
F_3 ( & V_11 -> V_10 , L_21 ) ;
return F_82 ( V_8 -> V_22 ) ;
}
V_139 = F_84 ( V_11 , 0 ) ;
if ( V_139 < 0 ) {
F_3 ( & V_11 -> V_10 , L_22 , V_11 -> V_75 ) ;
return V_139 ;
}
V_14 = F_85 ( & V_11 -> V_10 , V_139 , F_70 , 0 ,
F_86 ( & V_11 -> V_10 ) , V_8 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_23 , V_139 , V_14 ) ;
return V_14 ;
}
V_8 -> V_164 = F_87 ( & V_11 -> V_10 , L_20 ) ;
if ( F_81 ( V_8 -> V_164 ) ) {
F_3 ( & V_11 -> V_10 , L_24 ) ;
return F_82 ( V_8 -> V_164 ) ;
}
V_8 -> V_165 = F_87 ( & V_11 -> V_10 , L_25 ) ;
if ( F_81 ( V_8 -> V_165 ) ) {
F_3 ( & V_11 -> V_10 , L_26 ) ;
return F_82 ( V_8 -> V_165 ) ;
}
V_8 -> V_166 = F_87 ( & V_11 -> V_10 , L_27 ) ;
if ( F_81 ( V_8 -> V_166 ) )
F_88 ( & V_11 -> V_10 , L_28 ) ;
for ( V_13 = 0 ; V_13 < V_167 ; V_13 ++ ) {
sprintf ( V_157 , L_29 , V_13 ) ;
V_8 -> V_56 [ V_13 ] = F_87 ( & V_11 -> V_10 , V_157 ) ;
if ( F_81 ( V_8 -> V_56 [ V_13 ] ) ) {
F_3 ( & V_11 -> V_10 , L_30 , V_157 ) ;
return F_82 ( V_8 -> V_56 [ V_13 ] ) ;
}
}
if ( F_89 ( V_152 , L_31 ) ) {
V_8 -> V_58 = 3 ;
...
V_14 = F_68 ( V_8 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_32 , V_14 ) ;
return V_14 ;
}
V_8 -> V_20 = 10 ;
V_14 = F_90 ( V_152 , L_33 ,
& V_8 -> V_94 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_34 ) ;
return V_14 ;
}
V_14 = F_90 ( V_152 , L_35 ,
& V_8 -> V_90 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_36 ) ;
return V_14 ;
...
struct V_7 * V_8 = F_97 ( V_10 ) ;
T_1 V_179 ;
F_50 ( V_8 -> V_22 , V_23 , & V_179 ) ;
F_6 ( V_8 -> V_22 , V_23 ,
V_180 , 0 ) ;
F_102 ( V_8 -> V_22 , false ) ;
F_105 ( V_8 -> V_22 ) ;
F_6 ( V_8 -> V_22 , V_67 ,
V_181 | V_182 |
V_183 , V_8 -> V_178 ) ;
