...
{
struct V_81 * V_82 = V_7 -> V_31 -> V_83 ;
struct V_84 * V_85 ;
struct V_86 * V_87 ;
unsigned long V_88 ;
bool V_89 ;
int V_4 , V_18 ;
V_88 = F_31 ( F_32 ( V_7 -> V_74 ) ) ;
switch ( V_88 ) {
case V_90 :
case V_91 :
V_89 = false ;
...
if ( V_18 < 0 )
return V_18 ;
V_85 = (struct V_84 * ) V_7 -> V_31 -> V_96 ;
if ( ( V_82 && F_34 ( V_82 , L_2 ) ) ||
( V_85 && V_85 -> V_97 ) ) {
V_18 = F_9 ( V_7 , V_98 ,
V_99 , 1 ) ;
if ( V_18 < 0 )
...
if ( ! V_87 )
return - V_102 ;
F_38 ( V_7 -> V_13 [ V_4 ] , V_87 ) ;
V_7 -> V_13 [ V_4 ] -> V_103 |= V_104 ;
V_7 -> V_13 [ V_4 ] -> V_105 = & V_106 ;
}
return 0 ;
}
