...
F_60 (intr_line, &pending, pctrl->community->nirqs) {
unsigned V_125 , V_3 ;
V_3 = V_2 -> V_55 [ V_100 ] ;
...
bool V_128 = ! F_65 ( V_129 ) ;
int V_87 , V_41 , V_3 ;
int V_130 ;
* V_92 = V_131 ;
V_92 -> V_132 = V_2 -> V_17 -> V_133 ;
V_92 -> V_134 = F_66 ( V_2 -> V_42 ) ;
V_92 -> V_135 = V_2 -> V_42 ;
V_92 -> V_96 = - 1 ;
V_92 -> V_136 = V_128 ;
V_87 = F_67 ( V_2 -> V_42 , V_92 , V_2 ) ;
if ( V_87 ) {
F_68 ( V_2 -> V_42 , L_10 ) ;
return V_87 ;
}
for ( V_41 = 0 , V_3 = 0 ; V_41 < V_2 -> V_17 -> V_137 ; V_41 ++ ) {
V_54 = & V_2 -> V_17 -> V_138 [ V_41 ] ;
V_87 = F_69 ( V_92 , F_66 ( V_2 -> V_42 ) , V_3 ,
V_54 -> V_96 , V_54 -> V_23 ) ;
if ( V_87 ) {
F_68 ( V_2 -> V_42 , L_11 ) ;
return V_87 ;
...
const struct V_139 * V_122 ;
T_2 V_108 ;
V_122 = & V_2 -> V_17 -> V_22 [ V_41 ] ;
V_108 = F_4 ( F_1 ( V_2 , V_122 -> V_90 , V_31 ) ) ;
V_108 &= V_101 ;
V_108 >>= V_102 ;
if ( V_128 && V_108 >= V_2 -> V_17 -> V_140 )
F_70 ( V_41 , V_92 -> V_141 ) ;
}
F_2 ( 0xffff , V_2 -> V_11 + V_103 ) ;
if ( ! V_128 ) {
V_130 = F_71 ( V_2 -> V_42 , - 1 , 0 ,
V_92 -> V_132 , V_142 ) ;
if ( V_130 < 0 ) {
F_68 ( V_2 -> V_42 , L_12 ) ;
return V_130 ;
...
V_87 = F_72 ( V_92 , & V_143 , V_130 ,
V_144 , V_106 ) ;
if ( V_87 ) {
F_68 ( V_2 -> V_42 , L_13 ) ;
return V_87 ;
}
F_73 ( V_92 , & V_143 , V_125 ,
F_56 ) ;
return 0 ;
}
static T_5 F_74 ( T_2 V_37 ,
T_6 V_145 , T_2 V_146 , T_7 * V_12 ,
void * V_147 , void * V_148 )
{
...
F_11 ( & V_30 , V_26 ) ;
if ( V_37 == V_150 )
F_2 ( ( T_2 ) ( * V_12 ) , V_2 -> V_11 + ( T_2 ) V_145 ) ;
else if ( V_37 == V_151 )
* V_12 = F_4 ( V_2 -> V_11 + ( T_2 ) V_145 ) ;
else
V_87 = V_152 ;
F_12 ( & V_30 , V_26 ) ;
return V_87 ;
}
static int F_75 ( struct V_153 * V_154 )
{
struct V_1 * V_2 ;
struct V_155 * V_156 ;
struct V_157 * V_158 ;
T_5 V_159 ;
int V_87 , V_125 , V_41 ;
V_156 = F_76 ( & V_154 -> V_42 ) ;
if ( ! V_156 )
return - V_160 ;
V_2 = F_77 ( & V_154 -> V_42 , sizeof( * V_2 ) , V_161 ) ;
if ( ! V_2 )
return - V_162 ;
for ( V_41 = 0 ; V_41 < F_22 ( V_163 ) ; V_41 ++ )
if ( ! strcmp ( V_156 -> V_164 . V_165 , V_163 [ V_41 ] -> V_166 ) ) {
V_2 -> V_17 = V_163 [ V_41 ] ;
break;
}
if ( V_41 == F_22 ( V_163 ) )
...
V_2 -> V_42 = & V_154 -> V_42 ;
#ifdef F_78
V_2 -> V_167 = F_79 ( V_2 -> V_42 ,
V_2 -> V_17 -> V_23 , sizeof( * V_2 -> V_167 ) ,
V_161 ) ;
if ( ! V_2 -> V_167 )
return - V_162 ;
#endif
V_158 = F_80 ( V_154 , V_168 , 0 ) ;
V_2 -> V_11 = F_81 ( & V_154 -> V_42 , V_158 ) ;
if ( F_82 ( V_2 -> V_11 ) )
return F_83 ( V_2 -> V_11 ) ;
V_125 = F_84 ( V_154 , 0 ) ;
if ( V_125 < 0 ) {
F_68 ( & V_154 -> V_42 , L_14 ) ;
return V_125 ;
}
V_2 -> V_169 = V_170 ;
V_2 -> V_169 . V_21 = F_66 ( & V_154 -> V_42 ) ;
V_2 -> V_169 . V_22 = V_2 -> V_17 -> V_22 ;
V_2 -> V_169 . V_23 = V_2 -> V_17 -> V_23 ;
V_2 -> V_16 = F_85 ( & V_154 -> V_42 , & V_2 -> V_169 ,
V_2 ) ;
if ( F_82 ( V_2 -> V_16 ) ) {
F_68 ( & V_154 -> V_42 , L_15 ) ;
return F_83 ( V_2 -> V_16 ) ;
}
V_87 = F_64 ( V_2 , V_125 ) ;
if ( V_87 )
return V_87 ;
V_159 = F_86 ( V_156 -> V_171 ,
V_2 -> V_17 -> V_172 ,
F_74 ,
NULL , V_2 ) ;
if ( F_87 ( V_159 ) )
F_68 ( & V_154 -> V_42 , L_16 ) ;
F_88 ( V_154 , V_2 ) ;
return 0 ;
}
...
F_91 ( F_76 ( & V_154 -> V_42 ) ,
V_2 -> V_17 -> V_172 ,
F_74 ) ;
return 0 ;
}
static int F_92 ( struct V_173 * V_42 )
{
struct V_153 * V_154 = F_93 ( V_42 ) ;
struct V_1 * V_2 = F_90 ( V_154 ) ;
unsigned long V_26 ;
int V_41 ;
F_11 ( & V_30 , V_26 ) ;
V_2 -> V_174 = F_4 ( V_2 -> V_11 + V_105 ) ;
for ( V_41 = 0 ; V_41 < V_2 -> V_17 -> V_23 ; V_41 ++ ) {
const struct V_139 * V_122 ;
struct V_175 * V_176 ;
void T_1 * V_4 ;
...
continue;
V_176 = & V_2 -> V_167 [ V_41 ] ;
V_4 = F_1 ( V_2 , V_122 -> V_90 , V_31 ) ;
V_176 -> V_177 = F_4 ( V_4 ) & ~ V_94 ;
...
static int F_94 ( struct V_173 * V_42 )
{
struct V_153 * V_154 = F_93 ( V_42 ) ;
struct V_1 * V_2 = F_90 ( V_154 ) ;
unsigned long V_26 ;
