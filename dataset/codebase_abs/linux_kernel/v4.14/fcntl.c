...
V_121 . V_123 = 0 ;
V_121 . V_124 = V_119 ;
if ( ( V_91 != V_125 ) && F_66 ( V_91 ) )
V_121 . V_124 = V_126 ;
F_67 ( ( V_119 < V_127 ) || ( ( V_119 - V_127 ) >= V_128 ) ) ;
if ( V_119 - V_127 >= V_128 )
V_121 . V_129 = ~ 0L ;
else
V_121 . V_129 = V_130 [ V_119 - V_127 ] ;
V_121 . V_131 = V_1 ;
if ( ! F_68 ( V_91 , & V_121 , V_113 , V_120 ) )
break;
case 0 :
F_68 ( V_132 , V_133 , V_113 , V_120 ) ;
}
}
void F_69 ( struct V_114 * V_115 , int V_1 , int V_134 )
{
struct V_112 * V_113 ;
enum V_26 type ;
struct V_25 * V_25 ;
...
F_68 ( V_137 , V_133 , V_113 , V_120 ) ;
}
int F_73 ( struct V_114 * V_115 )
{
struct V_112 * V_113 ;
enum V_26 type ;
struct V_25 * V_25 ;
...
{
F_75 ( V_140 ,
F_76 ( V_139 , struct V_141 , V_142 ) ) ;
}
int F_77 ( struct V_2 * V_3 , struct V_141 * * V_143 )
{
...
struct V_141 * F_81 ( void )
{
return F_82 ( V_140 , V_151 ) ;
}
void F_83 ( struct V_141 * V_152 )
{
F_75 ( V_140 , V_152 ) ;
}
struct V_141 * F_84 ( int V_1 , struct V_2 * V_3 , struct V_141 * * V_143 , struct V_141 * V_152 )
{
struct V_141 * V_144 , * * V_145 ;
F_6 ( & V_3 -> V_23 ) ;
F_6 ( & V_147 ) ;
...
static int F_87 ( int V_1 , struct V_2 * V_3 , struct V_141 * * V_143 )
{
struct V_141 * V_152 ;
V_152 = F_81 () ;
if ( ! V_152 )
return - V_156 ;
if ( F_84 ( V_1 , V_3 , V_143 , V_152 ) ) {
F_83 ( V_152 ) ;
return 0 ;
}
return 1 ;
}
int F_88 ( int V_1 , struct V_2 * V_3 , int V_157 , struct V_141 * * V_143 )
{
if ( ! V_157 )
return F_77 ( V_3 , V_143 ) ;
return F_87 ( V_1 , V_3 , V_143 ) ;
}
static void F_89 ( struct V_141 * V_144 , int V_116 , int V_134 )
{
while ( V_144 ) {
struct V_114 * V_115 ;
unsigned long V_158 ;
...
F_69 ( V_115 , V_144 -> V_153 , V_134 ) ;
}
F_92 ( & V_144 -> V_150 , V_158 ) ;
V_144 = F_93 ( V_144 -> V_148 ) ;
}
}
void F_94 ( struct V_141 * * V_145 , int V_116 , int V_134 )
{
if ( * V_145 ) {
F_17 () ;
F_89 ( F_93 ( * V_145 ) , V_116 , V_134 ) ;
F_19 () ;
}
}
