...
T_2 V_91 = V_10 -> V_84 . V_92 ;
if ( V_88 ) {
F_73 ( V_88 ) ;
F_74 ( V_88 , V_8 -> V_34 , & V_91 ) ;
F_14 ( V_1 , F_75 ( V_62 ) ,
F_76 ( V_10 -> V_84 . V_93 ) |
F_77 ( V_10 -> V_84 . V_94 ) ) ;
F_14 ( V_1 , F_78 ( V_62 ) , V_91 ) ;
F_14 ( V_1 , F_79 ( V_62 ) ,
F_80 ( V_95 ) |
V_96 ) ;
} else {
...
struct V_33 * V_8 = & V_1 -> V_11 . V_11 ;
struct V_24 * V_6 = V_3 -> V_6 ;
struct V_87 * V_102 , * V_103 ;
unsigned long V_27 ;
T_2 V_91 ;
int V_104 ;
if ( ( V_93 > V_105 ) || ( V_94 > V_106 ) ) {
F_86 ( V_6 -> V_6 , L_8 , V_93 , V_94 ) ;
return - V_107 ;
}
if ( V_101 ) {
V_102 = F_87 ( V_100 , V_101 ) ;
if ( ! V_102 )
return - V_108 ;
} else {
V_102 = NULL ;
...
if ( V_102 ) {
V_104 = F_74 ( V_102 , V_8 -> V_34 , & V_91 ) ;
if ( V_104 )
goto V_109;
} else {
V_91 = 0 ;
...
F_16 ( & V_10 -> V_84 . V_85 , V_27 ) ;
V_103 = V_10 -> V_84 . V_88 ;
V_10 -> V_84 . V_88 = V_102 ;
V_10 -> V_84 . V_92 = V_91 ;
V_10 -> V_84 . V_93 = V_93 ;
V_10 -> V_84 . V_94 = V_94 ;
V_10 -> V_84 . V_86 = true ;
...
static int F_88 ( struct V_2 * V_3 , int V_98 , int V_99 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
unsigned long V_27 ;
F_16 ( & V_10 -> V_84 . V_85 , V_27 ) ;
...
static void F_89 ( struct V_111 * V_112 , T_1 V_113 )
{
struct V_10 * V_10 = F_20 ( V_112 , struct V_10 , V_12 ) ;
...
if ( V_9 & V_110 ) {
F_72 ( V_3 ) ;
F_91 ( & V_10 -> V_32 , V_5 -> V_114 ) ;
}
}
static void F_92 ( struct V_111 * V_112 , T_1 V_113 )
{
struct V_10 * V_10 = F_20 ( V_112 , struct V_10 , V_81 ) ;
struct V_2 * V_3 = & V_10 -> V_11 ;
F_13 ( L_9 , V_10 -> V_19 , V_113 ) ;
F_8 ( V_3 ) ;
}
...
if ( V_104 )
return;
V_104 = F_95 ( V_6 -> V_12 [ F_96 ( V_3 ) ] . V_115 ,
! ( F_97 ( V_1 , V_21 ) &
V_10 -> V_20 ) ,
F_98 ( 50 ) ) ;
if ( V_104 <= 0 )
...
void F_104 ( struct V_2 * V_3 , enum V_117 V_118 , int V_48 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_1 V_119 ;
V_119 = F_97 ( V_1 , V_120 ) ;
switch ( V_10 -> V_62 ) {
case V_121 :
V_119 &= ~ V_122 ;
V_119 |= F_105 ( V_118 ) ;
...
V_10 -> V_48 = V_48 ;
F_30 ( V_3 ) ;
F_13 ( L_11 , V_10 -> V_19 , V_119 ) ;
F_14 ( V_1 , V_120 , V_119 ) ;
}
...
struct V_13 * V_14 , int V_67 , int V_130 ,
enum V_61 V_131 )
{
struct V_2 * V_3 = NULL ;
struct V_10 * V_10 ;
V_10 = F_110 ( sizeof( * V_10 ) , V_132 ) ;
if ( ! V_10 )
return F_111 ( - V_133 ) ;
V_3 = & V_10 -> V_11 ;
V_10 -> V_67 = V_67 ;
V_10 -> V_18 = V_130 ;
V_10 -> V_62 = V_131 ;
V_10 -> V_12 . V_116 = F_112 ( V_10 -> V_62 ) ;
V_10 -> V_12 . V_112 = F_89 ;
V_10 -> V_81 . V_116 = F_113 ( V_10 -> V_62 ) ;
V_10 -> V_81 . V_112 = F_92 ;
snprintf ( V_10 -> V_19 , sizeof( V_10 -> V_19 ) , L_12 ,
V_134 [ V_131 ] , V_130 ) ;
F_114 ( & V_10 -> V_84 . V_85 ) ;
F_115 ( & V_10 -> V_32 ,
L_13 , F_19 ) ;
F_116 ( V_6 , V_3 , V_14 , NULL , & V_135 ,
NULL ) ;
F_117 ( V_3 , & V_136 ) ;
V_14 -> V_3 = V_3 ;
return V_3 ;
