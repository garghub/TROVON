...
static
enum V_378 F_57 ( T_3 V_379 )
{
enum V_378 V_380 = V_381 ;
switch ( V_379 ) {
case 1 :
V_380 = V_381 ;
break;
...
if ( V_2 -> V_317 -> V_2 > V_390 )
* V_295 |= V_296 ;
if ( V_2 -> V_317 -> V_2 > V_384 )
* V_295 |= V_297 ;
if ( V_2 -> V_317 -> V_2 >= V_389 )
* V_295 |= V_298 ;
if ( V_2 -> V_317 -> V_2 >= V_391 )
* V_295 |= V_299 ;
}
return 0 ;
}
static int F_59 ( struct V_50 * V_45 , T_2 V_162 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
F_14 ( L_7 , V_20 ) ;
if ( V_162 ) {
...
{
struct V_1 * V_2 = V_45 -> V_52 ;
struct V_399 * V_317 = V_2 -> V_317 ;
F_14 ( L_7 , V_20 ) ;
F_12 ( V_2 ,
V_169 [ V_2 -> V_170 ] [ V_400 ] ) ;
...
F_9 ( V_2 , V_410 , 0x00 ) ;
F_6 ( V_2 , V_411 , 0x00 ) ;
V_317 -> V_412 = F_48 ( V_45 , V_2 -> V_11 -> V_37 ) ;
V_317 -> V_413 = F_49 ( V_45 , V_2 -> V_11 -> V_37 ) ;
return 0 ;
}
static
enum V_378 F_62 ( struct V_1 * V_2 ,
struct V_179 * V_67 )
{
struct V_399 * V_317 = V_2 -> V_317 ;
enum V_378 V_414 = V_381 ;
T_3 V_415 , V_416 , V_363 , V_43 ,
V_417 , V_418 , V_419 , V_420 ,
V_421 , V_422 , V_423 , V_424 ;
T_2 V_425 ;
T_4 V_53 ;
F_14 ( L_7 , V_20 ) ;
F_15 ( V_2 , & V_43 ) ;
V_419 = 25 ;
V_418 = 100000000 / V_67 -> V_426 ;
switch ( V_67 -> V_269 ) {
case V_271 :
V_420 = 150000 ;
V_422 = 100 ;
...
#endif
V_421 = ( 25 * V_420 * ( V_317 -> V_430 / 1000 ) ) /
( V_67 -> V_426 / 1000 ) ;
V_421 = ( 1000 * V_421 ) / V_67 -> V_426 ;
if ( V_421 < 50 )
V_421 = 50 ;
V_424 = 20 ;
V_423 = V_419 + V_418 + V_421 + V_422 ;
F_14 ( L_37 , V_20 , V_423 ) ;
F_6 ( V_2 , V_431 , 0x04 ) ;
V_425 = F_11 ( V_2 , V_432 ) ;
F_9 ( V_2 , V_432 , 0x0 ) ;
F_9 ( V_2 , V_433 , 0 ) ;
F_9 ( V_2 , V_434 , 0 ) ;
F_51 ( V_2 , V_317 -> V_413 ,
( 1000 * ( T_4 ) V_43 + V_317 -> V_435 ) ) ;
if ( ( V_67 -> V_426 > 10800000 ) | ( V_67 -> V_426 < 1800000 ) ) {
F_9 ( V_2 , V_436 , 0 ) ;
F_9 ( V_2 , V_367 , 0 ) ;
}
#if 0
...
do {
V_416 = F_55 ( V_2 ) ;
if ( ( V_417 >= ( V_423 - V_422 ) ) &&
( V_416 == 0x04 ) )
V_417 = V_423 ;
else if ( ( V_417 >= ( V_419 + V_418 ) ) &&
( V_416 == 0x02 ) )
{
V_417 = V_423 ;
V_363 = F_11 ( V_2 ,
...
F_14 ( L_38 , V_416 , V_417 ) ;
V_53 = F_7 ( V_2 , V_443 ) ;
F_14 ( L_39 , V_53 ) ;
} while ( ( ( V_416 != 0x0c ) && ( V_416 != 0x0b ) ) &&
( V_417 < V_423 ) );
F_14 ( L_40 , V_416 ) ;
V_53 = F_7 ( V_2 , V_443 ) ;
F_14 ( L_39 , V_53 ) ;
V_53 = F_7 ( V_2 , V_444 ) ;
F_14 ( L_41 , V_53 ) ;
V_53 = F_52 ( V_2 , V_317 -> V_413 ) ;
F_14 ( L_42 , V_53 ) ;
if ( ( V_416 == 0x0c ) || ( V_416 == 0x0b ) ) {
V_417 = 0 ;
do {
F_25 ( 5000 , 7000 ) ;
V_417 += 5 ;
V_415 = F_56 ( V_2 ) ;
} while ( ! V_415 && ( V_417 < V_424 ) );
} else
V_415 = 0 ;
if ( V_415 ) {
V_414 = V_391 ;
V_317 -> V_445 = F_11 ( V_2 ,
V_446 ) ;
#if 0
if (ifkhz != 0) {
...
static int F_63 ( struct V_50 * V_45 )
{
struct V_179 * V_67 = & V_45 -> V_180 ;
struct V_1 * V_2 = V_45 -> V_52 ;
struct V_399 * V_317 = V_2 -> V_317 ;
...
F_14 ( L_7 , V_20 ) ;
F_15 ( V_2 , & V_43 ) ;
V_67 -> V_426 = F_54 ( V_2 , V_317 -> V_412 ) ;
...
if ( V_43 == 0 ) {
V_67 -> V_189 +=
( F_52 ( V_2 , V_317 -> V_413 ) -
V_317 -> V_413 / 4000 ) ;
return 0 ;
}
if ( V_43 > V_317 -> V_413 / 1000 )
V_67 -> V_189 += ( V_43
- F_52 ( V_2 , V_317 -> V_413 )
- V_317 -> V_413 / 1000 ) ;
else
...
V_450 += 2048 ;
V_450 = 100 * V_450 / 4095 ;
if ( V_449 < 90 && V_450 < 28 ) {
for ( V_31 = 0 ; V_31 < V_456 ; V_31 ++ ) {
if ( V_449 <= V_457 [ 0 ] [ V_31 ] ) {
V_448 = ( - 1 ) * V_457 [ 1 ] [ V_31 ] ;
break;
}
}
if ( V_31 == V_456 )
...
for ( V_31 = 0 ; V_31 < V_458 ; V_31 ++ ) {
if ( V_450 <= V_459 [ 0 ] [ V_31 ] ) {
V_448 = ( - 1 ) * V_459 [ 1 ] [ V_31 ] ;
break;
}
}
if ( V_31 == V_458 )
...
static int F_66 ( struct V_50 * V_45 , T_1 * V_460 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
T_4 signal = F_65 ( V_2 ) ;
...
* V_460 = ( 22 + signal ) * ( - 1311 ) ;
F_14 ( L_46 , V_20 , ( * V_460 ) ) ;
return 0 ;
}
static int F_67 ( struct V_50 * V_45 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
enum V_332 V_334 ;
V_334 = F_11 ( V_2 , V_335 ) ;
...
static int F_68 ( struct V_50 * V_45 , int V_461 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
T_3 V_462 = 0 ;
int V_31 ;
for ( V_31 = 0 ; V_31 < 10 ; V_31 ++ ) {
V_462 += ( F_11 ( V_2 , V_463 )
+ 256 * F_11 ( V_2 , V_464 ) ) ;
}
if ( V_461 )
V_462 /= 10 ;
...
static int F_69 ( struct V_50 * V_45 , T_1 * V_292 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
T_3 V_465 ;
T_3 V_462 = 0 , V_188 = 0 ;
...
V_465 = 0 ;
F_14 ( L_47 , V_20 , V_465 ) ;
* V_292 = ( V_465 * 65535 ) / 100 ;
return 0 ;
}
static int F_70 ( struct V_50 * V_45 , T_3 * V_222 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
int V_468 , V_469 ;
* V_222 = ( F_7 ( V_2 , V_470 ) << 8 )
| F_7 ( V_2 , V_471 ) ;
V_468 = ( F_7 ( V_2 , V_472 ) << 8 )
| F_7 ( V_2 , V_473 ) ;
V_469 = ( F_7 ( V_2 , V_473 ) << 8 )
| F_7 ( V_2 , V_474 ) ;
F_14 ( L_48 ,
V_20 , * V_222 , V_468 , V_469 ) ;
return 0 ;
}
struct V_50 * F_71 ( const struct V_318 * V_11 ,
struct V_319 * V_21 )
{
struct V_1 * V_2 = NULL ;
struct V_399 * V_317 = NULL ;
V_2 = F_46 ( sizeof( struct V_1 ) , V_320 ) ;
if ( V_2 == NULL )
goto error;
V_317 = F_46 ( sizeof( struct V_399 ) , V_320 ) ;
if ( V_317 == NULL )
goto error;
V_2 -> V_21 = V_21 ;
V_2 -> V_11 = V_11 ;
...
F_34 ( 50 ) ;
F_6 ( V_2 , V_172 , 0x00 ) ;
V_2 -> V_317 -> V_412 = F_48 ( & V_2 -> V_45 ,
V_2 -> V_11 -> V_37 ) ;
V_2 -> V_317 -> V_413 = F_49 ( & V_2 -> V_45 ,
V_2 -> V_11 -> V_37 ) ;
V_2 -> V_485 = V_487 ;
}
static int F_74 ( struct V_50 * V_45 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
switch ( V_45 -> V_180 . V_488 ) {
case V_489 :
if ( V_2 -> V_485 != V_486 )
F_72 ( V_2 ) ;
return F_35 ( V_45 ) ;
...
break;
default:
V_67 -> V_460 . V_492 [ 0 ] . V_493 = V_494 ;
return;
}
V_67 -> V_460 . V_492 [ 0 ] . V_493 = V_495 ;
V_67 -> V_460 . V_492 [ 0 ] . V_496 = V_491 ;
}
static void F_76 ( struct V_50 * V_45 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
struct V_179 * V_67 = & V_45 -> V_180 ;
int V_497 ;
T_3 V_462 , V_498 , V_293 = 0 ;
switch ( V_2 -> V_485 ) {
case V_486 :
V_293 = F_38 ( V_45 ) ;
break;
...
V_498 = ( V_497 * 320 ) / V_462 ;
V_293 = ( ( V_498 != 0 ) ? ( F_77 ( V_498 ) / 5581 ) : 0 ) ;
break;
default:
V_67 -> V_499 . V_492 [ 0 ] . V_493 = V_494 ;
return;
}
V_67 -> V_499 . V_492 [ 0 ] . V_493 = V_495 ;
V_67 -> V_499 . V_492 [ 0 ] . V_496 = V_293 ;
}
static void F_78 ( struct V_50 * V_45 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
struct V_179 * V_67 = & V_45 -> V_180 ;
T_3 V_222 = 0 ;
...
break;
default:
V_67 -> V_500 . V_492 [ 0 ] . V_493 = V_494 ;
return;
}
V_67 -> V_500 . V_492 [ 0 ] . V_493 = V_501 ;
V_67 -> V_500 . V_492 [ 0 ] . V_496 = V_222 ;
}
static int F_79 ( struct V_50 * V_45 ,
enum V_294 * V_295 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
struct V_179 * V_67 = & V_45 -> V_180 ;
...
static int F_80 ( struct V_50 * V_45 ,
struct V_179 * V_67 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
switch ( V_2 -> V_485 ) {
...
case V_487 :
return F_64 ( V_45 , V_67 ) ;
default:
break;
}
return 0 ;
}
static int F_81 ( struct V_50 * V_45 )
{
struct V_1 * V_2 = V_45 -> V_52 ;
switch ( V_2 -> V_485 ) {
case V_486 :
...
F_6 ( V_2 , V_484 , 0x10 ) ;
if ( V_169 [ V_2 -> V_170 ] [ V_503 ] )
F_12 ( V_2 ,
V_169 [ V_2 -> V_170 ] [ V_503 ] ) ;
F_12 ( V_2 ,
V_169 [ V_2 -> V_170 ] [ V_400 ] ) ;
F_6 ( V_2 , V_484 , 0x00 ) ;
F_12 ( V_2 ,
...
struct V_50 * F_83 ( const struct V_318 * V_11 ,
struct V_319 * V_21 )
{
struct V_1 * V_2 = NULL ;
struct V_166 * V_167 = NULL ;
...
if ( ( V_2 -> V_175 != 0x50 ) && ( V_2 -> V_175 != 0x60 ) )
goto error;
F_84 ( & V_21 -> V_525 , L_50 ,
V_2 -> V_45 . V_46 . V_526 . V_527 , V_2 -> V_175 ,
V_11 -> V_12 ) ;
F_82 ( V_2 ) ;
return & V_2 -> V_45 ;
error:
