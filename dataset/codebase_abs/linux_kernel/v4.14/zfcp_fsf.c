...
F_55 ( V_136 ) = F_56 ( V_139 -> V_144 ) ;
F_57 ( V_136 ) = F_56 ( V_139 -> V_145 ) ;
F_58 ( V_136 ) = V_146 | V_147 ;
V_3 -> V_148 = V_102 -> V_149 & V_150 ;
V_3 -> V_151 = F_59 ( V_102 -> V_152 ,
( V_153 ) V_154 ) ;
if ( F_60 ( V_136 ) == - 1 )
F_60 ( V_136 ) = F_55 ( V_136 ) ;
F_61 ( V_3 ) ;
if ( V_15 -> V_21 -> V_74 . V_82 == V_155 )
return 0 ;
F_62 ( V_136 ) = F_17 ( V_102 -> V_156 ) ;
F_63 ( V_136 ) =
F_53 ( V_102 -> V_157 ) ;
...
V_3 -> V_163 = F_56 ( V_140 -> V_144 ) ;
V_3 -> V_164 = F_56 ( V_140 -> V_145 ) ;
F_64 ( V_136 ) = V_165 ;
break;
case V_166 :
if ( V_102 -> V_167 & V_168 )
F_64 ( V_136 ) = V_169 ;
else
F_64 ( V_136 ) = V_170 ;
break;
...
if ( V_15 -> V_18 & V_19 )
return;
V_3 -> V_174 = V_102 -> V_175 ;
V_3 -> V_69 = V_102 -> V_69 ;
V_3 -> V_167 = V_102 -> V_167 ;
V_3 -> V_163 = 0 ;
V_3 -> V_164 = 0 ;
V_3 -> V_162 = 0 ;
...
if ( F_54 ( V_15 ) )
return;
if ( V_102 -> V_177 < sizeof( struct V_86 ) ) {
F_9 ( & V_3 -> V_16 -> V_17 ,
L_56
L_57 ,
V_102 -> V_177 ) ;
...
if ( V_3 -> V_69 & V_181 ) {
V_3 -> V_182 = V_102 -> V_182 ;
memcpy ( F_66 ( V_136 ) , V_102 -> V_183 ,
F_67 ( V_184 , 17 ) ) ;
F_68 ( F_66 ( V_136 ) ,
F_67 ( V_184 , 17 ) ) ;
}
...
{
struct V_2 * V_3 = V_15 -> V_3 ;
struct V_187 * V_102 = & V_15 -> V_21 -> V_102 . V_28 ;
struct V_135 * V_136 = V_3 -> V_137 ;
if ( V_15 -> V_1 )
memcpy ( V_15 -> V_1 , V_102 , sizeof( * V_102 ) ) ;
if ( V_3 -> V_167 & V_168 ) {
F_60 ( V_136 ) = V_102 -> V_188 ;
} else
F_60 ( V_136 ) = F_55 ( V_136 ) ;
F_70 ( V_136 ) = V_102 -> V_189 ;
F_71 ( V_136 ) =
F_53 ( V_102 -> V_190 ) ;
memcpy ( F_72 ( V_136 ) , V_102 -> V_191 ,
V_192 ) ;
memcpy ( F_73 ( V_136 ) , V_102 -> V_193 ,
V_192 ) ;
}
...
struct V_5 * V_15 ;
if ( F_12 ( V_20 ) )
V_15 = F_76 ( V_20 , V_194 ) ;
else
V_15 = F_77 ( sizeof( * V_15 ) , V_194 ) ;
if ( F_41 ( ! V_15 ) )
return NULL ;
...
static struct V_86 * F_78 ( T_2 * V_20 )
{
struct V_86 * V_21 ;
if ( F_12 ( V_20 ) )
V_21 = F_76 ( V_20 , V_194 ) ;
else
V_21 = F_79 ( V_23 , V_194 ) ;
if ( F_41 ( ! V_21 ) )
return NULL ;
memset ( V_21 , 0 , sizeof( * V_21 ) ) ;
return V_21 ;
}
static struct V_5 * F_80 ( struct V_195 * V_196 ,
...
F_85 ( V_3 -> V_196 , & V_15 -> V_209 , V_15 -> V_201 , V_198 ,
...
V_15 -> V_213 = F_88 () ;
if ( F_89 ( V_196 , & V_15 -> V_209 ) ) {
F_45 ( & V_15 -> V_8 ) ;
F_90 ( V_3 -> V_115 , V_201 ) ;
F_3 ( V_3 , 0 , L_65 ) ;
return - V_173 ;
}
if ( V_210 )
...
V_214 = F_76 ( V_3 -> V_20 . V_55 , V_194 ) ;
if ( ! V_214 ) {
V_215 = - V_199 ;
goto V_219;
}
...
V_15 -> V_1 = V_26 ;
F_97 ( V_196 , & V_15 -> V_209 , V_26 , sizeof( * V_26 ) ) ;
F_98 ( V_196 , & V_15 -> V_209 ) ;
V_215 = F_86 ( V_15 ) ;
if ( V_215 )
goto V_220;
goto V_34;
...
struct V_263 * V_265 )
{
F_97 ( V_196 , V_262 , F_110 ( V_264 ) , V_264 -> V_266 ) ;
F_97 ( V_196 , V_262 , F_110 ( V_265 ) , V_265 -> V_266 ) ;
F_98 ( V_196 , V_262 ) ;
}
...
T_1 V_267 = V_3 -> V_69 ;
if ( F_112 ( V_3 ) ) {
if ( F_113 ( V_196 , & V_15 -> V_209 , V_264 ) )
return - V_173 ;
V_21 -> V_102 . V_103 . V_268 =
F_114 ( V_264 ) ;
if ( F_113 ( V_196 , & V_15 -> V_209 , V_265 ) )
return - V_173 ;
V_21 -> V_102 . V_103 . V_269 =
F_114 ( V_265 ) ;
F_115 ( V_196 , & V_15 -> V_209 , F_116 ( V_264 ) ) ;
F_98 ( V_196 , & V_15 -> V_209 ) ;
F_117 ( V_196 , & V_15 -> V_209 ) ;
return 0 ;
}
if ( F_118 ( V_264 ) && F_118 ( V_265 ) ) {
F_109 ( V_196 , & V_15 -> V_209 ,
V_264 , V_265 ) ;
return 0 ;
}
if ( ! ( V_267 & V_270 ) )
...
if ( F_113 ( V_196 , & V_15 -> V_209 , V_264 ) )
return - V_173 ;
V_21 -> V_102 . V_103 . V_268 = F_114 ( V_264 ) ;
F_98 ( V_196 , & V_15 -> V_209 ) ;
F_119 ( V_196 , & V_15 -> V_209 ) ;
if ( F_113 ( V_196 , & V_15 -> V_209 , V_265 ) )
return - V_173 ;
V_21 -> V_102 . V_103 . V_269 = F_114 ( V_265 ) ;
F_98 ( V_196 , & V_15 -> V_209 ) ;
return 0 ;
}
...
V_15 -> V_18 |= V_110 ;
V_272 = F_120 ( V_15 , V_250 -> V_15 , V_250 -> V_279 , V_7 ) ;
if ( V_272 )
goto V_280;
V_15 -> V_109 = F_107 ;
V_15 -> V_21 -> V_74 . V_245 = V_276 -> V_246 ;
V_250 -> V_29 = V_276 -> V_29 ;
V_15 -> V_1 = V_250 ;
F_122 ( L_73 , V_15 , V_276 -> V_29 ) ;
V_272 = F_86 ( V_15 ) ;
if ( V_272 )
goto V_280;
goto V_34;
...
int F_124 ( struct V_2 * V_3 , T_1 V_29 ,
...
V_15 -> V_18 |= V_110 ;
if ( ! F_112 ( V_3 ) )
F_125 ( V_196 , & V_15 -> V_209 , 2 ) ;
V_272 = F_120 ( V_15 , V_284 -> V_15 , V_284 -> V_279 , V_7 ) ;
if ( V_272 )
goto V_280;
F_126 ( V_15 -> V_21 -> V_102 . V_103 . V_29 , V_29 ) ;
V_15 -> V_109 = F_123 ;
V_284 -> V_29 = V_29 ;
V_15 -> V_1 = V_284 ;
...
int F_130 ( struct V_286 * V_12 )
{
struct V_195 * V_196 = V_12 -> V_3 -> V_196 ;
struct V_5 * V_15 ;
int V_215 = - V_173 ;
if ( ! ( V_196 -> V_3 -> V_69 & V_181 ) )
return - V_271 ;
F_92 ( & V_196 -> V_216 ) ;
if ( F_93 ( V_196 ) )
goto V_34;
V_15 = F_80 ( V_196 , V_295 ,
V_240 ,
V_196 -> V_3 -> V_20 . V_288 ) ;
if ( F_94 ( V_15 ) ) {
V_215 = F_95 ( V_15 ) ;
...
F_98 ( V_196 , & V_15 -> V_209 ) ;
V_15 -> V_109 = F_132 ;
F_126 ( V_15 -> V_21 -> V_102 . V_103 . V_29 , V_28 -> V_29 ) ;
V_15 -> V_1 = V_28 ;
V_15 -> V_12 = V_12 ;
V_12 -> V_292 = V_15 -> V_201 ;
F_137 ( & V_28 -> V_17 ) ;
...
static void F_141 ( struct V_5 * V_15 )
{
...
F_98 ( V_196 , & V_15 -> V_209 ) ;
V_15 -> V_109 = F_141 ;
F_126 ( V_15 -> V_21 -> V_102 . V_103 . V_29 , V_276 -> V_29 ) ;
V_15 -> V_1 = V_276 ;
F_4 ( V_15 , V_294 ) ;
V_215 = F_86 ( V_15 ) ;
if ( V_215 )
...
V_15 -> V_18 |= V_19 ;
F_3 ( V_276 -> V_3 , 0 , L_81 ) ;
}
V_276 -> V_18 = V_305 ;
F_142 ( & V_276 -> V_307 ) ;
}
int F_146 ( struct V_275 * V_276 )
{
struct V_195 * V_196 = V_276 -> V_3 -> V_196 ;
struct V_5 * V_15 ;
int V_215 = - V_173 ;
...
break;
case V_230 :
F_133 ( V_299 , & V_28 -> V_18 ) ;
F_148 (sdev, port->adapter->scsi_host)
if ( F_101 ( V_222 ) -> V_28 == V_28 )
F_133 ( V_298 ,
& F_101 ( V_222 ) -> V_18 ) ;
F_102 ( V_28 , V_231 ) ;
F_20 ( V_28 , V_4 ,
...
L_88 ,
F_151 ( V_222 ) ,
( unsigned long long ) V_224 -> V_28 -> V_188 ,
V_309 -> V_313 . V_314 ,
V_309 -> V_313 . V_315 ) ;
F_103 ( V_222 ,
V_4 |
...
L_89
L_90 ,
( unsigned long long ) F_151 ( V_222 ) ,
( unsigned long long ) V_224 -> V_28 -> V_188 ) ;
F_103 ( V_222 , V_4 ) ;
case V_317 :
V_15 -> V_18 |= V_19 ;
...
F_98 ( V_196 , & V_15 -> V_209 ) ;
V_15 -> V_21 -> V_74 . V_245 = V_12 -> V_28 -> V_246 ;
V_15 -> V_21 -> V_102 . V_103 . V_319 = F_151 ( V_12 -> V_222 ) ;
V_15 -> V_109 = F_150 ;
V_15 -> V_1 = V_12 -> V_222 ;
V_15 -> V_12 = V_12 ;
V_12 -> V_292 = V_15 -> V_201 ;
...
static void F_153 ( struct V_5 * V_15 )
{
struct V_221 * V_222 = V_15 -> V_1 ;
struct V_223 * V_224 ;
if ( V_15 -> V_18 & V_19 )
...
switch ( V_15 -> V_21 -> V_74 . V_82 ) {
case V_226 :
F_3 ( V_224 -> V_28 -> V_3 , 0 , L_91 ) ;
V_15 -> V_18 |= V_19 ;
break;
case V_227 :
F_20 ( V_224 -> V_28 , 0 , L_92 ) ;
V_15 -> V_18 |= V_19 ;
break;
case V_230 :
F_102 ( V_224 -> V_28 ,
...
break;
case V_176 :
F_133 ( V_298 , & V_224 -> V_18 ) ;
break;
}
}
int F_154 ( struct V_286 * V_12 )
{
struct V_195 * V_196 = V_12 -> V_3 -> V_196 ;
struct V_223 * V_224 = F_101 ( V_12 -> V_222 ) ;
struct V_5 * V_15 ;
int V_215 = - V_173 ;
F_92 ( & V_196 -> V_216 ) ;
if ( F_93 ( V_196 ) )
goto V_34;
V_15 = F_80 ( V_196 , V_322 ,
V_240 ,
V_196 -> V_3 -> V_20 . V_288 ) ;
if ( F_94 ( V_15 ) ) {
V_215 = F_95 ( V_15 ) ;
...
static void F_155 ( struct V_323 * V_324 , T_1 V_325 )
{
V_324 -> V_326 += V_325 ;
V_324 -> F_67 = F_67 ( V_324 -> F_67 , V_325 ) ;
V_324 -> F_59 = F_59 ( V_324 -> F_59 , V_325 ) ;
}
static void F_156 ( struct V_5 * V_15 , struct V_234 * V_327 )
{
struct V_328 * V_329 ;
...
if ( V_325 ) {
F_157 ( & V_224 -> V_349 . V_357 ) ;
F_155 ( & V_325 -> V_358 , V_329 -> V_342 ) ;
F_155 ( & V_325 -> V_359 , V_329 -> V_343 ) ;
V_325 -> V_360 ++ ;
F_158 ( & V_224 -> V_349 . V_357 ) ;
}
}
F_159 ( V_327 -> V_361 -> V_362 , V_327 -> V_361 , & V_332 ,
sizeof( V_332 ) ) ;
}
static void F_160 ( struct V_5 * V_15 )
{
...
case V_363 :
case V_226 :
F_3 ( V_224 -> V_28 -> V_3 , 0 , L_94 ) ;
V_15 -> V_18 |= V_19 ;
break;
case V_364 :
case V_227 :
F_20 ( V_224 -> V_28 , 0 , L_95 ) ;
V_15 -> V_18 |= V_19 ;
break;
case V_254 :
F_8 ( V_15 ) ;
...
static void F_161 ( struct V_5 * V_15 )
{
struct V_234 * V_368 ;
struct V_369 * V_370 ;
unsigned long V_24 ;
...
F_164 ( sizeof( struct V_369 ) > V_379 ) ;
V_370 = & V_15 -> V_21 -> V_102 . V_344 . V_370 . V_380 ;
F_165 ( V_370 , V_368 ) ;
V_253:
F_156 ( V_15 , V_368 ) ;
F_166 ( V_368 , V_15 ) ;
...
static int F_167 ( struct V_234 * V_234 , T_1 * V_382 )
{
switch ( F_168 ( V_234 ) ) {
case V_383 :
switch ( V_234 -> V_384 ) {
...
V_242 ) ) )
return - V_395 ;
F_170 ( & V_196 -> V_216 , V_24 ) ;
if ( F_23 ( & V_196 -> V_212 ) <= 0 ) {
F_37 ( & V_196 -> V_396 ) ;
goto V_34;
}
if ( V_234 -> V_384 == V_387 )
V_198 = V_397 ;
V_15 = F_80 ( V_196 , V_398 ,
V_198 , V_3 -> V_20 . V_399 ) ;
if ( F_94 ( V_15 ) ) {
V_215 = F_95 ( V_15 ) ;
goto V_34;
}
...
V_344 -> V_273 = V_274 ;
V_344 -> V_367 = V_400 ;
if ( F_168 ( V_234 ) != V_383 ) {
V_344 -> V_401 = V_234 -> V_236 -> V_402 ;
V_344 -> V_403 = F_171 ( V_234 ) & 0xFFFFFFFF ;
}
if ( F_167 ( V_234 , & V_344 -> V_345 ) )
goto V_404;
F_164 ( sizeof( struct V_393 ) > V_405 ) ;
V_393 = & V_15 -> V_21 -> V_102 . V_344 . V_393 . V_380 ;
F_172 ( V_393 , V_234 , 0 ) ;
if ( ( F_168 ( V_234 ) != V_383 ) &&
F_173 ( V_234 ) ) {
F_115 ( V_196 , & V_15 -> V_209 ,
F_173 ( V_234 ) ) ;
V_215 = F_113 ( V_196 , & V_15 -> V_209 ,
F_174 ( V_234 ) ) ;
if ( V_215 )
goto V_404;
V_344 -> V_406 = F_114 (
...
V_234 -> V_238 = NULL ;
V_34:
F_176 ( & V_196 -> V_216 , V_24 ) ;
return V_215 ;
}
static void F_177 ( struct V_5 * V_15 )
{
struct V_369 * V_370 ;
struct V_407 * V_408 ;
F_160 ( V_15 ) ;
V_370 = & V_15 -> V_21 -> V_102 . V_344 . V_370 . V_380 ;
V_408 = (struct V_407 * ) & V_370 [ 1 ] ;
if ( ( V_408 -> V_409 != V_410 ) ||
( V_15 -> V_18 & V_19 ) )
V_15 -> V_18 |= V_411 ;
}
struct V_5 * F_178 ( struct V_234 * V_235 ,
V_141 V_412 )
{
struct V_5 * V_15 = NULL ;
struct V_393 * V_393 ;
struct V_223 * V_224 = F_101 ( V_235 -> V_236 ) ;
struct V_195 * V_196 = V_224 -> V_28 -> V_3 -> V_196 ;
if ( F_41 ( ! ( F_23 ( & V_224 -> V_18 ) &
V_242 ) ) )
return NULL ;
...
V_15 -> V_21 -> V_102 . V_344 . V_367 = V_400 ;
F_98 ( V_196 , & V_15 -> V_209 ) ;
V_393 = & V_15 -> V_21 -> V_102 . V_344 . V_393 . V_380 ;
F_172 ( V_393 , V_235 , V_412 ) ;
F_4 ( V_15 , V_248 ) ;
if ( ! F_86 ( V_15 ) )
goto V_34;
F_11 ( V_15 ) ;
...
void F_179 ( struct V_195 * V_196 , int V_413 )
{
struct V_2 * V_3 = V_196 -> V_3 ;
struct V_414 * V_415 = V_196 -> V_416 [ V_413 ] ;
struct V_417 * V_418 ;
struct V_5 * V_6 ;
unsigned long V_201 ;
int V_419 ;
...
V_201 = ( unsigned long ) V_418 -> V_422 ;
V_6 = F_90 ( V_3 -> V_115 , V_201 ) ;
if ( ! V_6 ) {
F_2 ( V_3 ) ;
F_180 ( L_104 ,
V_201 , F_181 ( & V_3 -> V_16 -> V_17 ) ) ;
}
F_44 ( V_6 ) ;
if ( F_12 ( V_418 -> V_423 & V_424 ) )
break;
}
}
