...
{
struct V_1 * V_2 = F_46 ( V_129 ) ;
return F_48 ( V_129 , & V_2 -> V_143 . V_142 ,
F_45 ) ;
}
...
static void F_112 ( struct V_252 * V_253 )
{
struct V_1 * V_2 = V_253 -> V_32 ;
V_2 -> V_254 = NULL ;
}
...
static int F_114 ( struct V_256 * V_257 ,
struct V_258 * V_259 )
{
V_259 -> type = V_260 ;
V_259 -> V_5 = 2 ;
V_259 -> V_261 . integer . V_262 = 0 ;
V_259 -> V_261 . integer . V_263 = 0x7fff ;
return 0 ;
}
static int F_115 ( struct V_256 * V_257 , struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
int V_3 = V_257 -> V_266 ;
unsigned int V_33 = F_36 ( V_2 , V_3 ) ;
V_265 -> V_261 . integer . V_261 [ 0 ] = 0xffff - ( V_33 >> 16 ) ;
V_265 -> V_261 . integer . V_261 [ 1 ] = 0xffff - ( V_33 & 0xffff ) ;
return 0 ;
}
static int F_117 ( struct V_256 * V_257 , struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
int V_3 = V_257 -> V_266 ;
unsigned int V_33 = ( ( 0xffff - V_265 -> V_261 . integer . V_261 [ 0 ] ) << 16 |
( 0xffff - V_265 -> V_261 . integer . V_261 [ 1 ] ) ) ;
unsigned int V_267 = F_36 ( V_2 , V_3 ) ;
int V_268 = ( V_267 != V_33 ) ;
if ( V_268 ) {
F_30 ( V_2 , V_3 , V_33 ) ;
}
return V_268 ;
}
static int F_118 ( struct V_256 * V_257 , struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
V_265 -> V_261 . integer . V_261 [ 0 ] = V_2 -> V_199 -> V_269 ;
V_265 -> V_261 . integer . V_261 [ 1 ] = V_2 -> V_199 -> V_270 ;
return 0 ;
}
static int F_119 ( struct V_256 * V_257 , struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
int V_268 = 0 ;
if ( V_2 -> V_199 -> V_270 != V_265 -> V_261 . integer . V_261 [ 0 ] ||
V_2 -> V_199 -> V_269 != V_265 -> V_261 . integer . V_261 [ 1 ] ) {
F_120 ( V_2 ,
V_265 -> V_261 . integer . V_261 [ 0 ] ,
V_265 -> V_261 . integer . V_261 [ 1 ] ) ;
V_268 = 1 ;
}
return V_268 ;
}
static int F_121 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
int V_3 = V_257 -> V_266 ;
if ( V_3 == V_271 )
V_265 -> V_261 . integer . V_261 [ 0 ] = ( V_2 -> V_199 -> V_272 & V_273 ) ;
else
V_265 -> V_261 . integer . V_261 [ 0 ] = V_2 -> V_199 -> V_274 ;
return 0 ;
}
static int F_122 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
int V_268 , V_275 ;
...
case V_271 :
F_68 ( & V_2 -> V_170 ) ;
V_268 = ( V_2 -> V_199 -> V_272 & V_273 ) ;
if ( V_265 -> V_261 . integer . V_261 [ 0 ] && ! V_268 )
F_123 ( V_2 ) ;
else if ( V_268 && ! V_265 -> V_261 . integer . V_261 [ 0 ] )
F_124 ( V_2 ) ;
V_275 = ( V_268 != ( V_2 -> V_199 -> V_272 & V_273 ) ) ;
F_69 ( & V_2 -> V_170 ) ;
break;
case V_276 :
V_268 = V_2 -> V_199 -> V_274 ;
if ( V_265 -> V_261 . integer . V_261 [ 0 ] && ! V_268 ) {
F_125 ( V_2 ) ;
}
else if ( V_268 && ! V_265 -> V_261 . integer . V_261 [ 0 ] )
F_126 ( V_2 ) ;
V_275 = ( V_268 != V_2 -> V_199 -> V_274 ) ;
break;
default:
V_275 = - V_39 ;
F_74 () ;
...
struct V_199 * V_200 = V_2 -> V_199 ;
if ( V_200 -> V_277 != NULL )
V_265 -> V_261 . integer . V_261 [ 0 ] = 1 ;
else
V_265 -> V_261 . integer . V_261 [ 0 ] = 0 ;
return 0 ;
}
...
struct V_199 * V_200 = V_2 -> V_199 ;
int V_268 = 0 ;
if ( V_265 -> V_261 . integer . V_261 [ 0 ] && ! V_200 -> V_277 ) {
F_129 ( V_2 ) ;
V_268 = 1 ;
} else if ( ! V_265 -> V_261 . integer . V_261 [ 0 ] && V_200 -> V_277 ) {
F_130 ( V_2 ) ;
V_268 = 1 ;
}
return V_268 ;
...
static int F_132 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
struct V_199 * V_200 = V_2 -> V_199 ;
int V_268 = 0 ;
if ( V_265 -> V_261 . integer . V_261 [ 0 ] && ! V_200 -> V_278 ) {
F_133 ( V_2 ) ;
V_268 = 1 ;
} else if ( ! V_265 -> V_261 . integer . V_261 [ 0 ] && V_200 -> V_278 ) {
F_134 ( V_2 ) ;
V_268 = 1 ;
}
return V_268 ;
}
static int F_135 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
int V_279 = F_3 ( V_2 , V_280 ) ;
if ( V_279 & V_281 )
V_265 -> V_261 . integer . V_261 [ 0 ] = 1 ;
else
V_265 -> V_261 . integer . V_261 [ 0 ] = 0 ;
...
static int F_136 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
int V_279 = F_3 ( V_2 , V_280 ) ;
int V_282 = F_3 ( V_2 , V_283 ) ;
if ( V_265 -> V_261 . integer . V_261 [ 0 ] ) {
F_5 ( V_2 , V_280 ,
V_281 | V_279 ) ;
F_5 ( V_2 , V_283 ,
V_284 | V_282 ) ;
} else {
F_5 ( V_2 , V_280 , V_279 & ~ V_281 ) ;
F_5 ( V_2 , V_283 , V_282 & ~ V_284 ) ;
}
return ( V_279 != ( int ) F_3 ( V_2 , V_280 ) ) ;
}
static int F_137 ( struct V_256 * V_257 , struct V_258 * V_259 )
{
V_259 -> type = V_285 ;
V_259 -> V_5 = 1 ;
return 0 ;
}
static int F_138 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
struct V_199 * V_200 = V_2 -> V_199 ;
F_68 ( & V_2 -> V_170 ) ;
V_265 -> V_261 . V_286 . V_92 [ 0 ] = F_139 ( ( V_200 -> V_287 >> 24 ) & 0xff ) ;
V_265 -> V_261 . V_286 . V_92 [ 1 ] = F_139 ( ( V_200 -> V_287 >> 16 ) & 0xff ) ;
V_265 -> V_261 . V_286 . V_92 [ 2 ] = 0 ;
V_265 -> V_261 . V_286 . V_92 [ 3 ] = F_139 ( ( V_200 -> V_287 ) & 0xff ) ;
F_69 ( & V_2 -> V_170 ) ;
return 0 ;
}
static int F_140 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
struct V_199 * V_200 = V_2 -> V_199 ;
...
int V_268 ;
F_68 ( & V_2 -> V_170 ) ;
V_33 = ( ( unsigned int ) F_139 ( V_265 -> V_261 . V_286 . V_92 [ 0 ] ) << 24 ) |
( ( unsigned int ) F_139 ( V_265 -> V_261 . V_286 . V_92 [ 2 ] ) << 16 ) |
( ( unsigned int ) F_139 ( V_265 -> V_261 . V_286 . V_92 [ 3 ] ) ) |
( 1 << 13 ) | ( 1 << 12 ) ;
V_268 = ( unsigned int ) V_200 -> V_287 != V_33 ;
V_200 -> V_287 = V_33 ;
if ( ! ( V_200 -> V_272 & V_288 ) )
F_141 ( V_2 , V_289 , V_33 ) ;
F_69 ( & V_2 -> V_170 ) ;
return V_268 ;
}
static int F_142 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
V_265 -> V_261 . V_286 . V_92 [ 0 ] = 0xff ;
V_265 -> V_261 . V_286 . V_92 [ 1 ] = 0xff ;
V_265 -> V_261 . V_286 . V_92 [ 2 ] = 0x00 ;
V_265 -> V_261 . V_286 . V_92 [ 3 ] = 0xff ;
return 0 ;
}
...
struct V_199 * V_200 = V_2 -> V_199 ;
F_68 ( & V_2 -> V_170 ) ;
V_265 -> V_261 . V_286 . V_92 [ 0 ] = F_139 ( ( V_200 -> V_290 >> 24 ) & 0xff ) ;
V_265 -> V_261 . V_286 . V_92 [ 1 ] = F_139 ( ( V_200 -> V_290 >> 16 ) & 0xff ) ;
V_265 -> V_261 . V_286 . V_92 [ 2 ] = 0 ;
V_265 -> V_261 . V_286 . V_92 [ 3 ] = F_139 ( ( V_200 -> V_290 ) & 0xff ) ;
F_69 ( & V_2 -> V_170 ) ;
return 0 ;
}
static int F_144 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
struct V_199 * V_200 = V_2 -> V_199 ;
...
F_68 ( & V_2 -> V_170 ) ;
V_33 = ( ( unsigned int ) F_139 ( V_265 -> V_261 . V_286 . V_92 [ 0 ] ) << 24 ) |
( ( unsigned int ) F_139 ( V_265 -> V_261 . V_286 . V_92 [ 1 ] ) << 16 ) |
( ( unsigned int ) F_139 ( V_265 -> V_261 . V_286 . V_92 [ 3 ] ) ) |
( 1 << 13 ) | ( 1 << 12 ) ;
V_268 = V_200 -> V_290 != V_33 ;
V_200 -> V_290 = V_33 ;
if ( V_200 -> V_272 & V_288 )
F_141 ( V_2 , V_289 , V_33 ) ;
F_69 ( & V_2 -> V_170 ) ;
...
static int F_145 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
unsigned short V_33 ;
V_33 = F_146 ( V_2 -> V_31 [ V_9 ] , V_291 ) ;
V_265 -> V_261 . integer . V_261 [ 0 ] = ( V_33 & 0x200 ) ? 0 : 1 ;
return 0 ;
}
static int F_147 ( struct V_256 * V_257 ,
struct V_264 * V_265 )
{
struct V_1 * V_2 = F_116 ( V_257 ) ;
return F_148 ( V_2 -> V_31 [ V_9 ] ,
V_291 , 0x200 ,
V_265 -> V_261 . integer . V_261 [ 0 ] ? 0 : 0x200 ) ;
}
...
F_150 ( V_31 , V_293 , 0 ) ;
if ( V_31 -> V_34 == V_9 ) {
F_34 ( V_31 -> V_253 -> V_16 -> V_17 , L_22 , 0x0 ) ;
F_11 ( V_31 , V_291 , 0x0 ) ;
} else if ( V_31 -> V_34 == V_10 ) {
F_34 ( V_31 -> V_253 -> V_16 -> V_17 , L_23 , 0x3 ) ;
F_11 ( V_31 , V_291 , 0x3 ) ;
} else {
F_74 () ;
}
...
F_146 ( V_31 , V_297 ) ;
F_146 ( V_31 , V_298 ) ;
V_296 = F_146 ( V_31 , V_299 ) ;
if ( V_296 != 0xffff && ( V_296 & 1 ) != 0 )
return;
F_150 ( V_31 , V_300 , 0x8a05 ) ;
if ( ( V_56 = F_146 ( V_31 , V_300 ) ) == 0x8a05 )
return;
F_6 ( 10 ) ;
} while ( F_151 ( V_292 , V_294 ) );
F_8 ( V_31 -> V_253 -> V_16 -> V_17 ,
L_24 ) ;
}
static int F_152 ( struct V_1 * V_2 , int V_301 )
{
int V_41 , V_56 ;
struct V_302 V_31 ;
...
V_31 . V_305 = V_306 ;
if ( V_301 == V_10 ) {
F_10 ( V_2 , V_293 , 0 , V_301 ) ;
F_7 ( 10 ) ;
if ( F_1 ( V_2 , V_293 , V_301 ) & 0x8000 ) {
F_34 ( V_2 -> V_16 -> V_17 ,
L_25 ) ;
return - V_146 ;
}
}
F_10 ( V_2 , V_307 , 0x8000 , V_301 ) ;
for ( V_41 = 0 ; V_41 < 100 ; ++ V_41 ) {
if ( F_1 ( V_2 , V_307 , V_301 ) == 0x8000 ) {
V_56 = F_153 ( V_2 -> V_254 , & V_31 , & V_2 -> V_31 [ V_301 ] ) ;
return V_56 ;
}
F_6 ( 10 ) ;
}
F_34 ( V_2 -> V_16 -> V_17 , L_26 , V_301 ) ;
return - V_146 ;
}
int F_154 ( struct V_1 * V_2 , int V_308 )
{
struct V_309 * V_16 = V_2 -> V_16 ;
struct V_310 V_311 ;
int V_56 ;
unsigned int V_41 ;
static struct V_312 V_174 = {
#ifdef F_50
. V_313 = F_149 ,
#endif
. V_314 = F_11 ,
...
if ( ( V_56 = V_252 ( V_16 , 0 , & V_174 , V_2 , & V_2 -> V_254 ) ) < 0 )
return V_56 ;
V_2 -> V_254 -> V_235 = F_112 ;
if ( F_152 ( V_2 , V_9 ) < 0 )
return - V_146 ;
V_2 -> V_316 = 1 ;
#ifdef F_50
...
V_2 -> V_316 = 2 ;
#endif
for ( V_41 = 0 ; V_41 < F_155 ( V_317 ) ; V_41 ++ ) {
struct V_256 * V_318 ;
V_318 = F_156 ( & V_317 [ V_41 ] , V_2 ) ;
if ( V_318 && V_318 -> V_311 . V_319 == V_320 )
V_318 -> V_311 . V_242 = V_308 ;
if ( ( V_56 = F_157 ( V_16 , V_318 ) ) < 0 )
return V_56 ;
}
memset ( & V_311 , 0 , sizeof( V_311 ) ) ;
V_311 . V_319 = V_321 ;
strcpy ( V_311 . V_248 , L_29 ) ;
V_2 -> V_255 = F_158 ( V_2 -> V_16 , & V_311 ) ;
#ifdef F_50
if ( V_2 -> V_316 == 1 ) {
unsigned int V_322 = V_2 -> V_31 [ V_9 ] -> V_311 & 0xffff ;
if ( ( V_322 & 0xfff0 ) == 0x5920 ) {
V_56 = F_157 ( V_16 , F_156 ( & V_323 , V_2 ) ) ;
if ( V_56 < 0 )
return V_56 ;
F_159 ( V_2 -> V_31 [ V_9 ] ,
V_291 , 0x200 ) ;
...
static int F_161 ( struct V_326 * V_129 )
{
...
static int F_164 ( struct V_326 * V_129 )
{
struct V_1 * V_2 = V_129 -> V_217 -> V_32 ;
F_162 ( & V_2 -> V_113 ) ;
V_2 -> V_222 &= ~ ( V_329 | V_223 ) ;
V_2 -> V_224 = NULL ;
if ( ! ( V_2 -> V_327 & V_330 ) ) {
F_160 ( V_2 ) ;
} else {
...
static int F_165 ( struct V_326 * V_129 )
{
struct V_1 * V_2 = V_129 -> V_217 -> V_32 ;
V_2 -> V_11 ( V_2 , 1 ) ;
F_162 ( & V_2 -> V_113 ) ;
...
static int F_166 ( struct V_326 * V_129 )
{
struct V_1 * V_2 = V_129 -> V_217 -> V_32 ;
F_162 ( & V_2 -> V_113 ) ;
V_2 -> V_222 &= ~ ( V_331 | V_226 ) ;
V_2 -> V_227 = NULL ;
if ( ! ( V_2 -> V_327 & V_328 ) ) {
F_160 ( V_2 ) ;
} else {
...
static void F_167 ( struct V_326 * V_129 , int V_332 )
{
unsigned long V_106 ;
struct V_1 * V_2 = V_129 -> V_217 -> V_32 ;
F_39 ( & V_2 -> V_113 , V_106 ) ;
...
static void F_168 ( struct V_326 * V_129 , int V_332 )
{
unsigned long V_106 ;
struct V_1 * V_2 = V_129 -> V_217 -> V_32 ;
unsigned char V_333 ;
...
F_171 ( V_217 , V_335 , & V_336 ) ;
F_171 ( V_217 , V_337 , & V_338 ) ;
V_217 -> V_247 |= V_339 | V_340 | V_341 ;
V_217 -> V_32 = V_2 ;
V_2 -> V_217 = V_217 ;
return 0 ;
}
static void F_172 ( struct V_342 * V_342 )
{
struct V_1 * V_2 = F_173 ( V_342 ) ;
if ( F_2 ( ! V_2 ) )
return;
F_5 ( V_2 , V_343 , 0xFF ) ;
}
static unsigned char F_174 ( struct V_342 * V_342 )
{
struct V_1 * V_2 = F_173 ( V_342 ) ;
if ( F_2 ( ! V_2 ) )
return 0 ;
return F_3 ( V_2 , V_343 ) ;
}
static int F_175 ( struct V_342 * V_342 , int * V_344 , int * V_345 )
{
struct V_1 * V_2 = F_173 ( V_342 ) ;
unsigned V_346 , V_347 , V_348 ;
if ( F_2 ( ! V_2 ) )
return 0 ;
V_346 = F_3 ( V_2 , V_349 ) ;
V_347 = F_3 ( V_2 , V_350 ) ;
V_348 = F_3 ( V_2 , V_343 ) ;
* V_345 = ( ~ V_348 >> 4 ) & 0x0F ;
V_344 [ 0 ] = ( ( V_346 & V_351 ) >> V_352 ) & 0xFFFF ;
V_344 [ 1 ] = ( ( V_346 & V_353 ) >> V_354 ) & 0xFFFF ;
V_344 [ 2 ] = ( ( V_347 & V_355 ) >> V_356 ) & 0xFFFF ;
V_344 [ 3 ] = ( ( V_347 & V_357 ) >> V_358 ) & 0xFFFF ;
for( V_348 = 0 ; V_348 < 4 ; ++ V_348 )
if( V_344 [ V_348 ] == 0xFFFF ) V_344 [ V_348 ] = - 1 ;
return 0 ;
}
static int F_176 ( struct V_342 * V_342 , int V_359 )
{
switch ( V_359 ) {
case V_360 :
return 0 ;
...
F_179 ( V_362 , L_33 ) ;
F_180 ( V_362 , L_34 , F_181 ( V_2 -> V_64 ) ) ;
F_182 ( V_362 , & V_2 -> V_64 -> V_17 ) ;
F_183 ( V_362 , V_2 ) ;
V_362 -> V_363 = F_176 ;
V_362 -> V_315 = F_174 ;
V_362 -> V_364 = F_172 ;
...
int F_177 ( struct V_1 * V_2 ) { return - V_369 ; }
static inline void F_185 ( struct V_1 * V_2 ) { }
static T_7 F_187 ( struct V_370 * V_71 ,
void * V_371 ,
struct V_372 * V_372 , char T_8 * V_373 ,
T_4 V_5 , T_9 V_374 )
{
struct V_375 * V_40 = V_71 -> V_32 ;
if ( F_188 ( V_373 , V_40 -> V_42 + V_374 , V_5 ) )
return - V_376 ;
return V_5 ;
}
static int F_189 ( struct V_309 * V_16 , struct V_1 * V_2 )
{
struct V_370 * V_71 ;
int V_41 ;
for ( V_41 = 0 ; V_41 < 5 ; V_41 ++ ) {
struct V_375 * V_40 = & V_2 -> V_40 . V_41 [ V_41 ] ;
if ( ! F_190 ( V_16 , V_40 -> V_248 , & V_71 ) ) {
V_71 -> V_377 = V_378 ;
V_71 -> V_32 = V_2 ;
V_71 -> V_218 . V_174 = & V_379 ;
V_71 -> V_65 = V_40 -> V_65 ;
V_71 -> V_359 = V_380 | V_381 ;
}
}
#ifdef F_50
F_191 ( V_16 , V_2 ) ;
...
F_185 ( V_2 ) ;
if ( V_2 -> V_303 )
V_2 -> V_303 ( V_2 , - V_2 -> V_383 ) ;
F_192 ( V_2 ) ;
if ( V_2 -> V_40 . V_41 [ 0 ] . V_384 )
F_194 ( V_2 ) ;
if ( V_2 -> V_196 >= 0 )
F_196 ( V_2 -> V_196 , V_2 ) ;
if ( V_2 -> V_11 )
V_2 -> V_11 ( V_2 , - V_2 -> V_383 ) ;
for ( V_41 = 0 ; V_41 < 5 ; V_41 ++ ) {
struct V_375 * V_40 = & V_2 -> V_40 . V_41 [ V_41 ] ;
F_197 ( V_40 -> V_42 ) ;
F_198 ( V_40 -> V_384 ) ;
...
static int F_203 ( struct V_388 * V_242 )
{
struct V_1 * V_2 = V_242 -> V_389 ;
return F_195 ( V_2 ) ;
}
...
F_5 ( V_2 , V_391 , 0 ) ;
#ifdef F_50
F_5 ( V_2 , V_392 , V_393 | V_394 |
V_395 ) ;
#else
F_5 ( V_2 , V_392 , V_393 | V_396 ) ;
#endif
F_5 ( V_2 , V_14 , 0 ) ;
#ifdef F_50
F_5 ( V_2 , V_397 , 0 ) ;
...
#ifdef F_50
F_5 ( V_2 , V_397 , V_18 | V_22 ) ;
#endif
F_32 ( 10 ) ;
F_5 ( V_2 , V_391 , V_398 ) ;
F_5 ( V_2 , V_399 , V_400 | V_401 ) ;
F_5 ( V_2 , V_402 , 0x3a ) ;
F_5 ( V_2 , V_403 , V_404 ) ;
F_5 ( V_2 , V_96 , V_405 ) ;
F_6 ( 100 ) ;
F_5 ( V_2 , V_96 , V_405 | V_97 ) ;
F_5 ( V_2 , V_406 , V_407 ) ;
F_33 ( V_2 ) ;
F_5 ( V_2 , V_408 , V_409 | V_410 ) ;
F_5 ( V_2 , V_411 , V_412 | V_410 ) ;
F_5 ( V_2 , V_391 , V_398 | V_413 ) ;
#ifdef F_50
F_5 ( V_2 , V_414 , V_415 ) ;
F_5 ( V_2 , V_416 , 0 ) ;
F_5 ( V_2 , V_417 , 0 ) ;
...
#ifdef F_50
F_5 ( V_2 , V_397 , V_15 | V_18 | V_22 ) ;
#endif
V_390 = 150 ;
while ( V_390 -- > 0 ) {
if ( ( F_3 ( V_2 , V_423 ) & ( V_424 | V_425 ) ) == ( V_424 | V_425 ) )
goto V_29;
F_6 ( 10 ) ;
}
#ifndef F_50
...
F_29 ( V_2 ) ;
#ifdef F_50
for ( V_51 = 0 ; V_51 < V_385 ; V_51 ++ ) {
V_56 = F_19 ( V_2 , & V_2 -> V_386 [ V_51 ] , V_429 [ V_51 ] ) ;
if ( V_56 < 0 ) {
F_8 ( V_2 -> V_16 -> V_17 , L_43 ,
V_429 [ V_51 ] ) ;
return V_56 ;
}
V_56 = F_207 ( V_2 , V_2 -> V_386 [ V_51 ] ) ;
if ( V_56 < 0 ) {
...
F_30 ( V_2 , V_431 , 0x80008000 ) ;
#endif
return 0 ;
}
static void F_209 ( struct V_1 * V_2 , int V_268 )
{
}
static int F_210 ( struct V_1 * V_2 )
{
T_1 V_41 , V_432 , V_7 , V_95 = 0 ;
T_10 V_433 , V_434 , V_435 ;
...
static void V_304 ( struct V_1 * V_2 , int V_268 )
{
#ifdef F_50
int V_267 = V_2 -> V_383 ;
#endif
...
static void F_213 ( struct V_1 * V_2 , int V_268 )
{
int V_267 = V_2 -> V_383 ;
int V_279 = F_3 ( V_2 , V_280 ) ;
int V_282 = F_3 ( V_2 , V_283 ) ;
...
F_5 ( V_2 , V_283 ,
V_443 | V_282 ) ;
} else if ( V_267 && ! V_2 -> V_383 ) {
F_34 ( V_2 -> V_16 -> V_17 , L_50 ) ;
F_5 ( V_2 , V_280 , V_279 & ~ V_442 ) ;
F_5 ( V_2 , V_283 , V_282 & ~ V_443 ) ;
}
}
...
if ( V_2 -> V_444 )
return;
for ( V_41 = 0 ; V_41 < F_155 ( V_445 ) ; V_41 ++ ) {
struct V_256 * V_318 ;
V_318 = F_156 ( & V_445 [ V_41 ] , V_2 ) ;
if ( ( V_56 = F_157 ( V_16 , V_318 ) ) < 0 ) {
F_8 ( V_16 -> V_17 ,
L_53 ,
V_56 ) ;
...
static void F_216 ( struct V_1 * V_2 , int V_268 )
{
T_10 V_446 , V_447 ;
if ( ! V_2 -> V_448 )
return;
V_2 -> V_383 += V_268 ;
V_447 = V_446 = F_217 ( V_2 -> V_448 + 0x10 ) ;
if ( ! V_2 -> V_383 )
V_447 |= 0x2000 ;
else
V_447 &= ~ 0x2000 ;
if ( V_447 != V_446 )
F_218 ( V_447 , V_2 -> V_448 + 0x10 ) ;
}
...
if ( V_450 == NULL )
return;
F_221 ( V_450 , 0x41 , & V_451 ) ;
V_2 -> V_448 = V_451 << 8 ;
F_222 ( V_450 ) ;
}
static int F_223 ( struct V_242 * V_17 )
{
struct V_309 * V_16 = F_224 ( V_17 ) ;
...
F_227 ( V_2 -> V_31 [ V_9 ] ) ;
F_227 ( V_2 -> V_31 [ V_10 ] ) ;
for ( V_51 = 0 ; V_51 < F_155 ( V_387 ) ; V_51 ++ )
V_2 -> V_387 [ V_51 ] = F_3 ( V_2 , V_387 [ V_51 ] ) ;
V_454 = V_2 -> V_383 ;
V_2 -> V_303 ( V_2 , - V_2 -> V_383 ) ;
F_194 ( V_2 ) ;
V_2 -> V_11 ( V_2 , - V_2 -> V_383 ) ;
...
F_229 ( V_2 ) ;
for ( V_51 = 0 ; V_51 < F_155 ( V_387 ) ; V_51 ++ )
F_5 ( V_2 , V_387 [ V_51 ] , V_2 -> V_387 [ V_51 ] ) ;
#else
F_28 ( V_2 ) ;
#endif
#if 0
...
V_2 -> V_64 = V_64 ;
V_2 -> V_196 = - 1 ;
V_2 -> V_466 = F_235 ( V_64 , 0 ) ;
V_2 -> V_467 = F_235 ( V_64 , 1 ) ;
if ( V_2 -> V_466 == 0 || V_2 -> V_466 == ( unsigned long ) ~ 0 ||
V_2 -> V_467 == 0 || V_2 -> V_467 == ( unsigned long ) ~ 0 ) {
F_8 ( V_2 -> V_16 -> V_17 ,
L_54 ,
V_2 -> V_466 , V_2 -> V_467 ) ;
F_195 ( V_2 ) ;
...
V_40 = & V_2 -> V_40 . V_248 . V_468 ;
strcpy ( V_40 -> V_248 , L_55 ) ;
V_40 -> V_469 = V_2 -> V_466 ;
V_40 -> V_65 = V_470 ;
V_40 = & V_2 -> V_40 . V_248 . V_471 ;
strcpy ( V_40 -> V_248 , L_56 ) ;
V_40 -> V_469 = V_2 -> V_467 + V_472 ;
V_40 -> V_65 = V_473 ;
V_40 = & V_2 -> V_40 . V_248 . V_474 ;
strcpy ( V_40 -> V_248 , L_57 ) ;
V_40 -> V_469 = V_2 -> V_467 + V_475 ;
V_40 -> V_65 = V_476 ;
V_40 = & V_2 -> V_40 . V_248 . V_477 ;
strcpy ( V_40 -> V_248 , L_58 ) ;
V_40 -> V_469 = V_2 -> V_467 + V_478 ;
V_40 -> V_65 = V_479 ;
V_40 = & V_2 -> V_40 . V_248 . V_3 ;
strcpy ( V_40 -> V_248 , L_59 ) ;
V_40 -> V_469 = V_2 -> V_467 + V_480 ;
V_40 -> V_65 = V_481 ;
F_236 ( V_64 , V_482 , & V_463 ) ;
F_236 ( V_64 , V_483 , & V_462 ) ;
for ( V_461 = & V_484 [ 0 ] ; V_461 -> V_248 ; V_461 ++ ) {
if ( V_461 -> V_485 == V_463 && V_461 -> V_311 == V_462 ) {
F_34 ( V_2 -> V_16 -> V_17 , L_60 ,
V_461 -> V_248 ) ;
V_2 -> V_303 = V_461 -> V_486 ;
V_2 -> V_11 = V_461 -> V_211 ;
V_2 -> V_324 = V_461 -> V_324 ;
if ( V_461 -> V_487 )
V_461 -> V_487 ( V_2 ) ;
break;
}
...
if ( ( V_40 -> V_384 = F_239 ( V_40 -> V_469 , V_40 -> V_65 ,
V_40 -> V_248 ) ) == NULL ) {
F_8 ( V_2 -> V_16 -> V_17 ,
L_63 ,
V_40 -> V_469 , V_40 -> V_469 + V_40 -> V_65 - 1 ) ;
F_195 ( V_2 ) ;
return - V_488 ;
}
V_40 -> V_42 = F_240 ( V_40 -> V_469 , V_40 -> V_65 ) ;
if ( V_40 -> V_42 == NULL ) {
F_8 ( V_2 -> V_16 -> V_17 ,
L_64 , V_40 -> V_248 ) ;
F_195 ( V_2 ) ;
...
if ( F_241 ( V_64 -> V_196 , F_86 , V_489 ,
V_490 , V_2 ) ) {
...
if ( ( V_56 = F_243 ( V_16 , V_491 , V_2 , & V_174 ) ) < 0 ) {
F_195 ( V_2 ) ;
return V_56 ;
}
F_189 ( V_16 , V_2 ) ;
#ifdef F_201
V_2 -> V_387 = F_24 ( sizeof( * V_2 -> V_387 ) *
F_155 ( V_387 ) , V_67 ) ;
if ( ! V_2 -> V_387 ) {
F_195 ( V_2 ) ;
return - V_66 ;
