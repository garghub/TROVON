...
static unsigned long F_156 ( int V_45 )
{
unsigned long V_58 ;
F_131 ( V_221 , V_45 ) = true ;
V_58 = F_157 ( V_45 ) ;
if ( V_58 != V_135 ) {
F_131 ( V_221 , V_45 ) = false ;
F_158 ( L_29 ,
V_223 , V_58 ) ;
}
return V_58 ;
...
void T_5 F_166 ( int V_152 , struct V_153 * V_154 )
{
F_70 ( 1 << V_152 ) ;
F_167 () ;
}
static void F_168 ( void * V_227 )
{
F_18 ( F_24 () , false ) ;
F_169 () ;
}
...
static void * T_6 F_175 ( unsigned int V_45 , T_8 V_228 ,
T_8 V_229 )
{
const unsigned long V_230 = F_40 ( V_231 ) ;
#ifdef F_176
int V_232 = F_177 ( V_45 ) ;
void * V_233 ;
if ( ! F_178 ( V_232 ) || ! F_179 ( V_232 ) ) {
V_233 = F_180 ( V_228 , V_229 , V_230 ) ;
F_181 ( L_34 ,
V_45 , V_232 ) ;
F_165 ( L_35 ,
V_45 , V_228 , F_40 ( V_233 ) ) ;
} else {
V_233 = F_182 ( F_179 ( V_232 ) ,
V_228 , V_229 , V_230 ) ;
F_165 ( L_36
L_37 , V_45 , V_228 , V_232 , F_40 ( V_233 ) ) ;
}
return V_233 ;
#else
return F_180 ( V_228 , V_229 , V_230 ) ;
#endif
}
static void T_6 F_183 ( void * V_233 , T_8 V_228 )
{
F_184 ( F_40 ( V_233 ) , V_228 ) ;
}
static int T_6 F_185 ( unsigned int V_234 , unsigned int V_235 )
{
...
static void T_6 F_186 ( unsigned long V_238 )
{
T_9 * V_160 = F_187 ( V_238 ) ;
T_10 * V_239 ;
T_11 * V_240 ;
if ( F_188 ( * V_160 ) ) {
T_10 * V_241 ;
V_241 = F_180 ( V_242 , V_242 , V_242 ) ;
F_189 ( & V_12 , V_160 , V_241 ) ;
}
V_239 = F_190 ( V_160 , V_238 ) ;
if ( F_191 ( * V_239 ) ) {
T_11 * V_241 ;
V_241 = F_180 ( V_242 , V_242 , V_242 ) ;
F_192 ( & V_12 , V_239 , V_241 ) ;
}
V_240 = F_193 ( V_239 , V_238 ) ;
if ( ! F_194 ( * V_240 ) ) {
T_12 * V_241 ;
V_241 = F_180 ( V_242 , V_242 , V_242 ) ;
F_195 ( & V_12 , V_240 , V_241 ) ;
}
}
void T_6 F_196 ( void )
{
...
if ( V_243 < 0 )
F_25 ( L_40 , V_243 ) ;
V_32 = ( unsigned long ) V_249 - ( unsigned long ) V_250 ;
F_200 (cpu)
F_8 ( V_45 ) = V_32 + V_251 [ V_45 ] ;
V_6 = F_8 ( F_24 () ) ;
F_201 () ;
if ( V_7 == V_8 )
F_202 ( V_252 ) ;
