...
static struct V_92 *
F_89 ( struct V_1 * V_2 , struct V_86 * V_39 ,
T_3 va_start , T_3 va_end )
{
struct V_93 * V_94 ;
struct V_92 * V_75 ;
int V_8 ;
...
if ( ! V_94 )
return NULL ;
V_94 -> V_96 . V_97 = va_start ;
V_94 -> V_96 . V_98 = va_end ;
F_91 ( V_2 -> V_7 -> V_7 , L_16 , V_2 -> V_19 ) ;
V_75 = F_92 ( & V_39 -> V_7 , V_94 , L_17 ) ;
if ( F_84 ( V_75 ) ) {
F_10 ( V_2 -> V_7 -> V_7 , L_18 ,
F_93 ( V_75 ) ) ;
F_94 ( V_94 ) ;
return F_95 ( V_75 ) ;
}
V_8 = V_75 -> V_99 -> V_23 -> V_100 ( V_75 -> V_99 , NULL , 0 ) ;
if ( V_8 ) {
F_96 ( V_75 ) ;
return F_97 ( V_8 ) ;
}
...
int F_98 ( struct V_6 * V_101 , struct V_86 * V_39 ,
struct V_1 * V_2 , const struct V_102 * V_23 ,
const char * V_19 , struct V_103 * V_104 )
{
int V_8 ;
...
( unsigned long ) V_2 ) ;
F_103 ( & V_2 -> V_61 ) ;
V_2 -> V_107 = F_104 ( V_39 , V_104 -> V_108 , V_19 ) ;
if ( F_84 ( V_2 -> V_107 ) ) {
V_8 = F_93 ( V_2 -> V_107 ) ;
goto V_105;
}
V_2 -> V_22 = F_105 ( V_39 , V_104 -> V_109 ) ;
if ( V_2 -> V_22 < 0 ) {
V_8 = V_2 -> V_22 ;
F_10 ( V_101 -> V_7 , L_19 , V_8 ) ;
goto V_105;
}
V_8 = F_106 ( & V_39 -> V_7 , V_2 -> V_22 , F_81 ,
V_110 , V_2 -> V_19 , V_2 ) ;
if ( V_8 ) {
F_10 ( V_101 -> V_7 , L_20 , V_2 -> V_22 , V_8 ) ;
goto V_105;
}
V_8 = F_85 ( V_39 , V_2 ) ;
if ( V_8 )
goto V_105;
V_2 -> V_17 = F_107 ( V_39 , L_21 ) ;
F_3 ( L_22 , V_2 -> V_17 ) ;
if ( F_84 ( V_2 -> V_17 ) )
V_2 -> V_17 = NULL ;
V_2 -> V_9 = F_108 ( & V_39 -> V_7 , L_23 ) ;
F_3 ( L_24 , V_2 -> V_9 ) ;
if ( F_84 ( V_2 -> V_9 ) )
V_2 -> V_9 = NULL ;
V_2 -> V_10 = F_108 ( & V_39 -> V_7 , L_25 ) ;
F_3 ( L_26 , V_2 -> V_10 ) ;
if ( F_84 ( V_2 -> V_10 ) )
V_2 -> V_10 = NULL ;
V_2 -> V_39 = V_39 ;
F_109 ( V_39 , V_2 ) ;
F_1 ( V_2 ) ;
V_2 -> V_75 = F_89 ( V_2 , V_39 ,
V_104 -> va_start , V_104 -> va_end ) ;
if ( V_2 -> V_75 == NULL )
F_91 ( V_101 -> V_7 , L_27 , V_19 ) ;
else if ( F_84 ( V_2 -> V_75 ) ) {
V_8 = F_93 ( V_2 -> V_75 ) ;
goto V_105;
}
V_2 -> V_111 = F_110 ( V_2 , V_104 -> V_112 ) ;
if ( F_84 ( V_2 -> V_111 ) ) {
V_8 = F_93 ( V_2 -> V_111 ) ;
V_2 -> V_111 = NULL ;
F_10 ( V_101 -> V_7 , L_28 , V_8 ) ;
goto V_105;
}
return 0 ;
V_105:
...
if ( V_2 -> V_111 ) {
if ( V_2 -> V_113 )
F_65 ( V_2 -> V_111 -> V_114 , V_2 -> V_75 ) ;
F_112 ( V_2 -> V_111 ) ;
}
if ( ! F_113 ( V_2 -> V_75 ) ) {
V_2 -> V_75 -> V_99 -> V_23 -> V_115 ( V_2 -> V_75 -> V_99 ,
NULL , 0 ) ;
F_96 ( V_2 -> V_75 ) ;
}
}
