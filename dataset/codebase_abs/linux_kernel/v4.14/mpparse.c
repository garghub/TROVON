...
F_4 ( L_35 , V_111 -> V_120 ) ;
F_32 ( V_111 -> V_120 ) ;
} else if ( V_111 -> V_108 ) {
if ( F_36 ( V_111 , V_70 ) ) {
F_35 ( V_111 , sizeof( * V_111 ) ) ;
return;
}
} else
F_41 () ;
...
F_7 ( V_20 , L_37 ,
V_121 , V_121 + V_60 - 1 ) ;
F_45 ( sizeof( * V_111 ) != 16 ) ;
while ( V_60 > 0 ) {
V_122 = F_34 ( V_121 , V_60 ) ;
...
V_114 = V_121 ;
F_4 ( L_38 ,
V_121 , V_121 + sizeof( * V_111 ) - 1 , V_111 ) ;
F_43 ( V_121 , sizeof( * V_111 ) ) ;
if ( V_111 -> V_108 )
F_42 ( V_111 ) ;
V_123 = 1 ;
}
...
static int T_1 F_48 ( struct V_43 * V_5 )
{
int V_85 ;
if ( V_5 -> V_45 != V_87 )
return 0 ;
...
static void T_1 F_49 ( struct V_43 * V_5 , int * V_128 )
{
int V_85 ;
F_7 ( V_20 , L_39 ) ;
F_15 ( V_5 ) ;
...
static int T_1
F_50 ( unsigned long V_131 , unsigned long V_132 , int V_65 )
{
if ( ! V_131 || V_65 <= V_132 ) {
F_51 ( 1 , L_41 , V_65 ) ;
return - 1 ;
...
static
inline void T_1 F_49 ( struct V_43 * V_5 , int * V_128 ) {}
static int T_1 F_52 ( struct V_55 * V_56 ,
unsigned long V_131 ,
unsigned long V_132 )
{
#ifdef F_38
...
if ( ! F_17 ( V_56 , V_57 , V_18 ) )
goto V_141;
F_4 ( L_46 , ( V_142 ) V_114 ) ;
F_4 ( L_47 , V_111 -> V_108 ) ;
...
V_56 -> V_134 = 0 ;
V_143 = F_1 ( ( unsigned char * ) V_56 , V_56 -> V_60 ) ;
V_56 -> V_134 = 0xff ;
V_144 = F_1 ( ( unsigned char * ) V_56 , V_56 -> V_60 ) ;
if ( V_143 == V_144 ) {
F_4 ( L_49 ) ;
goto V_141;
}
...
struct V_110 * V_145 ;
V_145 = F_34 ( 0x400 - 16 , sizeof( * V_145 ) ) ;
if ( ! V_145 ) {
F_18 ( L_52 ) ;
goto V_141;
}
F_4 ( L_53 , 0x400 - 16 ) ;
memcpy ( V_145 , V_111 , 16 ) ;
F_35 ( V_111 , sizeof( * V_111 ) ) ;
V_111 = V_145 ;
V_111 -> V_108 = V_131 ;
}
...
F_4 ( L_54 , V_111 -> V_108 ) ;
}
F_52 ( V_56 , V_131 , V_132 ) ;
V_141:
F_35 ( V_56 , V_66 ) ;
V_140:
F_35 ( V_111 , sizeof( * V_111 ) ) ;
