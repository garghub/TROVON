...
V_5 -> V_90 -> V_165 = V_5 ;
V_5 -> V_90 -> V_128 = F_74 ;
return F_70 ( & V_54 -> V_73 , V_5 -> V_90 , V_63 ) ;
}
...
if ( V_5 -> V_210 -> V_133 & V_272 )
V_5 -> V_138 . V_273 = 1 ;
if ( V_5 -> V_274 && ( V_268 -> V_275 || V_268 -> V_276 ||
V_268 -> V_277 ) )
V_5 -> V_138 . V_274 = 1 ;
...
if ( V_132 )
goto V_281;
V_5 -> V_138 . V_282 = & V_5 -> V_144 -> V_73 ;
...
struct V_287 * V_288 ;
int V_86 ;
if ( ! F_7 ( V_5 , V_289 , V_290 ) )
return - V_291 ;
V_288 = F_137 ( V_5 -> V_92 , sizeof( * V_288 ) , V_237 ) ;
if ( ! V_288 )
return - V_64 ;
V_288 -> V_292 = F_133 ;
V_288 -> V_293 = F_135 ;
