...
static void T_9 F_90 ( struct V_1 * floor )
{
struct V_242 * V_243 = floor -> V_244 . V_245 ;
struct V_9 * V_9 = floor -> V_119 ;
if ( F_91 ( V_243 ) )
return;
F_92 ( L_64 , V_246 , V_243 , V_9 ,
& V_247 ) ;
F_92 ( L_65 , V_246 , V_243 , V_9 ,
& V_248 ) ;
F_92 ( L_66 , V_246 , V_243 , V_9 ,
& V_249 ) ;
F_92 ( L_67 , V_246 , V_243 , V_9 ,
& V_250 ) ;
}
static int T_9 F_93 ( int V_251 , struct V_1 * V_2 )
{
struct V_9 * V_9 = V_2 -> V_119 ;
int V_252 ;
V_252 = F_15 ( V_9 , V_253 ) ;
V_9 -> V_254 = ( V_252 & V_255 ? 1 : 0 ) ;
V_9 -> V_48 = V_256 ;
switch ( V_251 ) {
case V_257 :
V_2 -> V_195 = F_94 ( V_258 , L_68 ,
V_9 -> V_106 ) ;
if ( ! V_2 -> V_195 )
return - V_259 ;
V_9 -> V_150 = 2047 ;
...
F_96 ( struct V_206 * V_12 , int floor , struct V_188 * V_189 )
{
int V_31 , V_274 ;
T_2 V_251 , V_275 ;
struct V_9 * V_9 ;
struct V_1 * V_2 ;
V_31 = - V_259 ;
V_9 = F_97 ( sizeof( struct V_9 ) , V_258 ) ;
if ( ! V_9 )
goto V_276;
V_2 = F_97 ( sizeof( struct V_1 ) , V_258 ) ;
if ( ! V_2 )
goto V_277;
V_2 -> V_119 = V_9 ;
...
8 * V_71 ) ;
V_9 -> V_149 = F_97 ( V_274 * V_71 , V_258 ) ;
if ( ! V_9 -> V_149 )
goto V_279;
V_9 -> V_189 = V_189 ;
V_9 -> V_106 = floor ;
...
static int F_104 ( struct V_192 * V_193 , T_10 V_162 )
{
int floor , V_22 ;
struct V_206 * V_12 ;
struct V_1 * * V_194 , * V_2 ;
...
static int T_9 F_106 ( struct V_192 * V_193 )
{
struct V_188 * V_189 = & V_193 -> V_189 ;
struct V_1 * V_2 ;
struct V_286 * V_287 ;
...
struct V_206 * V_12 ;
V_31 = - V_288 ;
V_287 = F_107 ( V_193 , V_289 , 0 ) ;
if ( ! V_287 ) {
F_108 ( V_189 , L_74 ) ;
return V_31 ;
}
V_13 = F_109 ( V_189 , V_287 -> V_290 , V_291 ) ;
V_31 = - V_259 ;
V_12 = F_110 ( V_189 , sizeof( * V_12 ) * V_196 ,
V_258 ) ;
if ( ! V_12 )
return V_31 ;
V_12 -> V_13 = V_13 ;
F_111 ( & V_12 -> V_134 ) ;
V_12 -> V_100 = F_112 ( V_292 , V_98 ,
V_293 ) ;
if ( ! V_12 -> V_100 )
return V_31 ;
for ( floor = 0 ; floor < V_196 ; floor ++ ) {
V_2 = F_96 ( V_12 , floor , V_189 ) ;
if ( F_113 ( V_2 ) ) {
V_31 = F_114 ( V_2 ) ;
goto V_294;
}
...
V_31 = F_115 ( V_2 , V_296 , NULL , NULL ,
0 ) ;
if ( V_31 )
goto V_294;
F_90 ( V_12 -> V_207 [ floor ] ) ;
}
