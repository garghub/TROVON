...
struct V_82 * V_83 )
{
struct V_81 * V_78 = F_23 ( V_89 -> V_70 . V_90 ) ;
struct V_84 * V_85 , * V_91 , * V_92 ;
struct V_64 * V_65 ;
struct V_68 * V_93 ;
...
V_83 -> V_25 = F_25 ( V_91 ) ;
V_65 = F_26 ( & V_89 -> V_70 , sizeof( * V_65 ) *
V_83 -> V_25 , V_97 ) ;
if ( ! V_65 )
return - V_98 ;
V_93 = F_26 ( & V_89 -> V_70 , sizeof( * V_93 ) *
V_83 -> V_25 , V_97 ) ;
if ( ! V_93 )
return - V_98 ;
V_83 -> V_99 = V_65 ;
V_83 -> V_26 = V_93 ;
F_27 (regulators_np, reg_np) {
for ( V_6 = 0 ; V_6 < F_28 ( V_99 ) ; V_6 ++ )
if ( ! F_29 ( V_92 -> V_72 , V_99 [ V_6 ] . V_72 ) )
break;
if ( V_6 == F_28 ( V_99 ) ) {
F_14 ( V_78 -> V_70 ,
L_9 ,
...
if ( V_77 )
return - V_24 ;
if ( F_33 ( V_85 , L_24 , NULL ) )
V_83 -> V_106 = true ;
if ( F_33 ( V_85 , L_25 , NULL ) )
V_83 -> V_107 = true ;
if ( F_33 ( V_85 , L_26 , NULL ) )
V_83 -> V_108 = true ;
if ( V_83 -> V_106 || V_83 -> V_107
|| V_83 -> V_108 ) {
if ( F_31 ( V_85 , L_27 ,
& V_83 -> V_109 ) )
V_83 -> V_109 = 0 ;
...
V_2 = F_26 ( & V_89 -> V_70 , sizeof( struct V_1 ) ,
V_97 ) ;
if ( ! V_2 )
return - V_98 ;
V_2 -> V_70 = & V_89 -> V_70 ;
...
V_2 -> V_63 = V_83 -> V_109 ;
V_2 -> V_111 = V_83 -> V_106 ;
V_2 -> V_112 = V_83 -> V_107 ;
V_2 -> V_113 = V_83 -> V_108 ;
V_2 -> V_26 = V_83 -> V_26 ;
V_110 = F_3 ( & V_114 ,
V_83 -> V_115 ) ;
F_38 ( V_2 -> V_78 -> V_79 , V_116 ,
V_110 ) ;
V_110 = F_3 ( & V_114 ,
V_83 -> V_117 ) ;
F_38 ( V_2 -> V_78 -> V_79 , V_118 ,
V_110 ) ;
V_110 = F_3 ( & V_114 ,
V_83 -> V_119 ) ;
F_38 ( V_2 -> V_78 -> V_79 , V_120 ,
V_110 ) ;
for ( V_6 = 0 ; V_6 < 8 ; V_6 ++ ) {
if ( V_2 -> V_32 ) {
V_2 -> V_55 [ V_6 ] =
...
V_77 = F_39 ( & V_89 -> V_70 , V_83 -> V_49 [ 0 ] ,
L_31 ) ;
if ( V_77 )
return V_77 ;
V_77 = F_39 ( & V_89 -> V_70 , V_83 -> V_49 [ 1 ] ,
L_32 ) ;
if ( V_77 )
return V_77 ;
V_77 = F_39 ( & V_89 -> V_70 , V_83 -> V_49 [ 2 ] ,
L_33 ) ;
if ( V_77 )
return V_77 ;
F_40 ( V_83 -> V_49 [ 0 ] ,
...
V_77 = F_39 ( & V_89 -> V_70 , V_83 -> V_87 [ 0 ] , L_34 ) ;
if ( V_77 )
return V_77 ;
V_77 = F_39 ( & V_89 -> V_70 , V_83 -> V_87 [ 1 ] , L_35 ) ;
if ( V_77 )
return V_77 ;
V_77 = F_39 ( & V_89 -> V_70 , V_83 -> V_87 [ 2 ] , L_36 ) ;
if ( V_77 )
return V_77 ;
F_40 ( V_83 -> V_87 [ 0 ] , 0x0 ) ;
F_40 ( V_83 -> V_87 [ 1 ] , 0x0 ) ;
F_40 ( V_83 -> V_87 [ 2 ] , 0x0 ) ;
if ( V_83 -> V_32 || V_83 -> V_36 ||
V_83 -> V_38 ) {
F_17 ( V_2 -> V_78 -> V_79 ,
V_18 , 1 << 1 ,
...
V_99 [ V_27 ] . V_135 = V_42 -> V_46 ;
V_99 [ V_27 ] . V_136 = V_42 -> V_47 ;
V_99 [ V_27 ] . V_137 =
F_2 ( V_27 , V_2 ) ;
if ( V_27 < V_14 )
V_99 [ V_27 ] . V_138 = 0x3f ;
else
V_99 [ V_27 ] . V_138 = 0xff ;
V_77 = F_1 ( V_2 , V_27 , & V_132 ,
& V_133 ) ;
if ( V_77 ) {
F_20 ( V_2 -> V_70 , L_37 ) ;
return V_77 ;
}
V_99 [ V_27 ] . V_132 = V_132 ;
V_99 [ V_27 ] . V_139 = V_80 ;
V_99 [ V_27 ] . V_133 = V_133 ;
}
V_67 . V_70 = V_2 -> V_70 ;
V_67 . V_140 = V_83 -> V_99 [ V_6 ] . V_100 ;
V_67 . V_141 = V_2 ;
V_67 . V_142 = V_78 -> V_79 ;
V_67 . V_95 = V_83 -> V_99 [ V_6 ] . V_71 ;
V_67 . V_74 = - V_24 ;
V_67 . V_75 = 0 ;
V_67 . V_143 = true ;
if ( F_15 ( V_83 -> V_99 [ V_6 ] . V_73 ) )
F_13 ( V_2 ,
& V_83 -> V_99 [ V_6 ] , & V_67 ) ;
V_51 = F_41 ( & V_89 -> V_70 , & V_99 [ V_27 ] ,
& V_67 ) ;
if ( F_42 ( V_51 ) ) {
V_77 = F_43 ( V_51 ) ;
F_20 ( V_2 -> V_70 , L_38 ,
