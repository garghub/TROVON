...
unsigned int V_43 = 0 ;
* V_37 = true ;
F_14 (conn, n, head, node) {
V_39 = F_15 ( V_34 , V_36 , & V_13 -> V_29 ) ;
if ( V_39 == NULL ) {
F_16 ( & V_13 -> V_33 ) ;
F_17 ( V_31 , V_13 ) ;
continue;
...
static unsigned int
F_23 ( struct V_34 * V_34 , struct V_44 * V_45 ,
const struct V_28 * V_29 ,
...
int V_57 ;
bool V_37 ;
V_49 = F_24 ( * V_53 , struct V_46 , V_33 ) ;
V_54 = * V_53 ;
...
V_45 = & V_63 -> V_66 [ V_64 ] ;
F_30 ( & V_67 [ V_64 % V_68 ] ) ;
V_60 = F_23 ( V_34 , V_45 , V_29 , V_1 , V_7 , V_21 , V_36 ) ;
F_31 ( & V_67 [ V_64 % V_68 ] ) ;
return V_60 ;
}
static bool
F_32 ( const struct V_69 * V_70 , struct V_71 * V_72 )
{
struct V_34 * V_34 = F_33 ( V_72 ) ;
const struct V_73 * V_74 = V_72 -> V_75 ;
union V_6 V_1 ;
struct V_28 V_29 ;
const struct V_28 * V_76 = & V_29 ;
const struct V_35 * V_36 = & V_77 ;
enum V_78 V_79 ;
const struct V_12 * V_80 ;
unsigned int V_81 ;
V_80 = F_34 ( V_70 , & V_79 ) ;
if ( V_80 != NULL ) {
V_76 = & V_80 -> V_82 [ V_83 ] . V_29 ;
V_36 = F_35 ( V_80 ) ;
} else if ( ! F_36 ( V_70 , F_37 ( V_70 ) ,
F_38 ( V_72 ) , V_34 , & V_29 ) ) {
goto V_84;
}
if ( F_38 ( V_72 ) == V_65 ) {
const struct V_85 * V_86 = F_39 ( V_70 ) ;
memcpy ( & V_1 . V_10 , ( V_74 -> V_87 & V_88 ) ?
& V_86 -> V_89 : & V_86 -> V_90 , sizeof( V_1 . V_10 ) ) ;
} else {
const struct V_91 * V_86 = F_40 ( V_70 ) ;
V_1 . V_23 = ( V_74 -> V_87 & V_88 ) ?
V_86 -> V_89 : V_86 -> V_90 ;
}
V_81 = F_29 ( V_34 , V_74 -> V_63 , V_76 , & V_1 ,
& V_74 -> V_7 , F_38 ( V_72 ) , V_36 ) ;
if ( V_81 == 0 )
goto V_84;
return ( V_81 > V_74 -> V_92 ) ^
! ! ( V_74 -> V_87 & V_93 ) ;
V_84:
V_72 -> V_84 = true ;
return false ;
}
static int F_41 ( const struct V_94 * V_72 )
{
struct V_73 * V_74 = V_72 -> V_75 ;
unsigned int V_9 ;
int V_95 ;
F_42 ( & V_4 , sizeof( V_4 ) ) ;
V_95 = F_43 ( V_72 -> V_34 , V_72 -> V_21 ) ;
if ( V_95 < 0 ) {
F_44 ( L_1
L_2 , V_72 -> V_21 ) ;
return V_95 ;
}
V_74 -> V_63 = F_45 ( sizeof( struct V_62 ) , V_96 ) ;
if ( V_74 -> V_63 == NULL ) {
F_46 ( V_72 -> V_34 , V_72 -> V_21 ) ;
return - V_97 ;
}
for ( V_9 = 0 ; V_9 < F_4 ( V_74 -> V_63 -> V_66 ) ; ++ V_9 )
V_74 -> V_63 -> V_66 [ V_9 ] = V_98 ;
return 0 ;
}
static void F_47 ( struct V_44 * V_99 )
{
struct V_30 * V_13 ;
struct V_46 * V_49 ;
struct V_40 * V_41 ;
struct V_52 * V_33 ;
while ( ( V_33 = F_48 ( V_99 ) ) != NULL ) {
V_49 = F_24 ( V_33 , struct V_46 , V_33 ) ;
F_22 ( V_33 , V_99 ) ;
F_14 (conn, n, &rbconn->hhead, node)
F_17 ( V_31 , V_13 ) ;
F_17 ( V_50 , V_49 ) ;
}
}
static void F_49 ( const struct V_100 * V_72 )
{
const struct V_73 * V_74 = V_72 -> V_75 ;
unsigned int V_9 ;
F_46 ( V_72 -> V_34 , V_72 -> V_21 ) ;
for ( V_9 = 0 ; V_9 < F_4 ( V_74 -> V_63 -> V_66 ) ; ++ V_9 )
F_47 ( & V_74 -> V_63 -> V_66 [ V_9 ] ) ;
F_50 ( V_74 -> V_63 ) ;
}
