...
goto V_28;
V_19 = V_7 -> V_19 [ V_2 ] ;
if ( ! ( V_7 -> V_38 && F_3 ( V_2 , V_7 -> V_45 ) ) )
if ( V_19 != V_46 )
F_17 ( V_14 , V_34 , V_47 , V_2 ) ;
switch ( V_19 ) {
case V_46 :
break;
case V_48 :
...
V_18 = 0 ;
V_7 -> V_56 = 0 ;
} else if ( ! V_7 -> V_57 && F_3 ( V_19 , V_14 -> V_58 ) ) {
V_18 = F_21 ( V_59 , V_7 -> time ) && V_7 -> V_56 == V_2 ? 1 : 2 ;
} else {
V_18 = 1 ;
V_7 -> V_56 = V_2 ;
V_7 -> time = V_59 + F_22 ( V_14 -> V_60 [ V_61 ] ) / 2 ;
}
F_17 ( V_14 , V_62 , V_19 , V_18 ) ;
F_20 ( V_14 ) ;
if ( V_18 && F_3 ( V_2 , V_7 -> V_45 ) ) {
F_17 ( V_14 , V_34 , V_47 , V_2 ) ;
F_23 ( V_14 , V_19 , 0 ) ;
F_20 ( V_14 ) ;
}
...
unsigned char V_69 ;
int V_3 = 0 , V_70 = 0 ;
while ( V_3 < F_2 ( V_67 ) - 1 && V_67 [ V_3 ] < V_14 -> V_60 [ V_71 ] )
V_3 ++ ;
V_14 -> V_60 [ V_71 ] = V_67 [ V_3 ] ;
while ( V_70 < F_2 ( V_68 ) - 1 && V_68 [ V_70 ] < V_14 -> V_60 [ V_61 ] )
V_70 ++ ;
V_14 -> V_60 [ V_61 ] = V_68 [ V_70 ] ;
V_69 = V_3 | ( V_70 << 5 ) ;
...
F_64 ( V_13 , V_7 ) ;
V_13 -> V_137 [ 0 ] = F_65 ( V_62 ) | F_65 ( V_95 ) |
F_65 ( V_34 ) ;
if ( V_7 -> V_26 ) {
...
V_13 -> V_139 [ 0 ] = V_7 -> V_140 ? F_65 ( V_47 ) :
F_65 ( V_35 ) | F_65 ( V_47 ) ;
if ( V_7 -> V_15 ) {
...
{
T_3 V_175 = F_86 ( V_167 , V_176 - 1 , L_28 ,
V_117 , V_7 -> V_45 ) ;
V_167 [ V_175 ++ ] = '\n' ;
V_167 [ V_175 ] = '\0' ;
return V_175 ;
...
if ( V_150 )
return V_150 ;
memcpy ( V_7 -> V_45 , V_177 , sizeof( V_7 -> V_45 ) ) ;
return V_168 ;
}
...
{
return sprintf ( V_167 , L_27 , V_7 -> V_57 ? 1 : 0 ) ;
}
...
{
return sprintf ( V_167 , L_29 , V_7 -> V_44 ) ;
}
