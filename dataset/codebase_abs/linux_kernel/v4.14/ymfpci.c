...
V_2 -> V_32 = V_32 ;
V_15 -> V_56 = V_2 ;
strcpy ( V_15 -> V_57 , V_35 ) ;
sprintf ( V_15 -> V_58 , L_21 , V_36 , V_35 ) ;
sprintf ( V_15 -> V_59 , L_22 ,
V_15 -> V_58 ,
V_2 -> V_60 ,
V_2 -> V_61 ) ;
V_37 = F_21 ( V_2 , 0 ) ;
...
V_4 &= ~ V_46 ;
F_12 ( V_13 , V_21 , V_4 ) ;
} else if ( ( V_37 = F_30 ( V_34 , 0 , 1 , NULL ) ) < 0 ) {
F_4 ( V_15 -> V_3 , L_25 ) ;
goto V_55;
}
}
