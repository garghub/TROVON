...
bool F_25 ( struct V_15 * V_16 , struct V_90 * V_91 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_5 * V_6 = & V_22 -> V_28 ;
...
int F_27 ( struct V_15 * V_16 , int V_8 , bool * V_20 , bool * V_51 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_5 * V_6 = & V_22 -> V_28 ;
...
int F_28 ( struct V_15 * V_16 , struct V_17 * V_18 , int V_19 , int V_8 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_55 * V_41 = & V_22 -> V_56 . V_41 . V_57 ;
struct V_5 * V_6 = & V_22 -> V_28 ;
...
static void F_30 ( struct V_5 * V_6 , T_2 V_123 )
{
V_6 -> V_14 = F_3 ( V_6 -> V_1 [ V_123 ] ) ;
}
static int F_31 ( struct V_15 * V_16 , struct V_5 * V_6 , struct V_124 * V_125 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
T_2 V_126 ;
...
if ( V_177 -> V_127 < 0x40 ) {
V_145 -> V_214 =
( ( 1 << ( F_29 ( V_145 -> V_33 ) - 1 ) ) * 3 == V_145 -> V_33 ) ;
} else {
