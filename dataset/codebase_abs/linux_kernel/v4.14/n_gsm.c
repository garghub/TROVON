...
static long F_140 ( struct V_94 * V_95 , struct V_204 * V_204 ,
unsigned int V_93 , unsigned long V_221 )
{
return F_136 ( V_95 , V_204 , V_93 , V_221 ) ;
}
...
static int F_143 ( struct V_226 * V_90 )
{
F_144 ( V_90 ) ;
return 0 ;
}
...
static void F_147 ( struct V_185 * V_186 )
{
struct V_230 * V_231 ;
struct V_7 * V_8 ;
...
static inline void F_150 ( struct V_230 * V_231 )
{
F_110 ( & V_231 -> V_186 , F_147 ) ;
}
static int F_151 ( struct V_232 * V_85 ,
struct V_226 * V_90 )
{
struct V_230 * V_231 = F_152 ( V_90 ) ;
...
F_159 ( V_85 , V_239 ) ;
F_160 ( V_85 , V_238 , V_74 ) ;
V_85 -> V_236 = V_90 ;
V_85 -> V_241 = F_161 ( V_242 ) ;
F_162 ( V_85 ) ;
V_90 -> V_233 . V_243 ++ ;
...
if ( ! V_8 -> V_90 )
return;
V_231 = F_152 ( V_8 -> V_90 ) ;
F_150 ( V_231 ) ;
}
static int F_164 ( struct V_7 * V_8 , struct V_259 * V_260 )
{
char * V_261 ;
int V_262 = 0 ;
struct V_226 * V_90 ;
...
if ( V_260 -> V_266 [ 0 ] != '\0' )
V_261 = V_260 -> V_266 ;
V_90 = F_166 ( sizeof( struct V_230 ) , V_261 ,
V_267 , F_163 ) ;
if ( ! V_90 ) {
F_167 ( L_36 ) ;
return - V_80 ;
...
static void F_171 ( struct V_107 * V_104 , int V_273 )
{
struct V_7 * V_8 = F_77 ( V_104 , struct V_7 , V_104 ) ;
...
static int F_172 ( struct V_274 * V_275 , struct V_94 * V_95 )
{
struct V_47 * V_48 ;
struct V_7 * V_8 ;
...
V_194 = F_173 ( & V_8 -> V_104 , V_275 , V_95 ) ;
if ( V_194 ) {
if ( V_278 )
F_84 ( V_8 ) ;
F_89 ( & V_48 -> V_148 ) ;
...
static int F_174 ( struct V_94 * V_95 , struct V_204 * V_285 )
{
...
F_175 ( V_104 , 1 ) ;
F_65 ( V_8 ) ;
return F_176 ( V_104 , V_95 , V_285 ) ;
}
static void F_177 ( struct V_94 * V_95 , struct V_204 * V_285 )
{
struct V_7 * V_8 = V_95 -> V_284 ;
struct V_47 * V_48 ;
if ( V_8 == NULL )
...
F_89 ( & V_8 -> V_148 ) ;
V_48 = V_8 -> V_48 ;
if ( F_178 ( & V_8 -> V_104 , V_95 , V_285 ) == 0 )
return;
F_49 ( V_8 ) ;
...
if ( V_8 -> V_142 == V_143 )
return - V_202 ;
V_286 = F_186 ( V_8 -> V_77 , V_114 , V_4 , & V_8 -> V_81 ) ;
F_36 ( V_8 ) ;
return V_286 ;
}
...
static void F_190 ( struct V_94 * V_95 , int V_288 )
{
}
...
static void F_194 ( struct V_94 * V_95 , struct V_294 * V_295 )
{
struct V_7 * V_8 = V_95 -> V_284 ;
if ( V_8 -> V_142 == V_143 )
return;
F_195 ( & V_95 -> V_296 , V_295 ) ;
}
