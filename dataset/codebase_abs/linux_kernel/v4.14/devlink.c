...
struct V_4 * V_195 ;
T_4 V_196 ;
V_196 = V_181 -> V_184 -> V_197 ( V_181 -> V_186 ) ;
V_195 = F_95 ( V_47 , V_198 ) ;
if ( ! V_195 )
return - V_57 ;
if ( F_40 ( V_47 , V_199 , V_181 -> V_13 ) ||
F_102 ( V_47 , V_200 , V_196 ,
V_201 ) )
goto V_65;
if ( F_71 ( V_47 , V_202 ,
V_181 -> V_203 ) )
...
static int F_103 ( struct V_46 * * V_204 ,
struct V_15 * V_16 )
{
int V_66 ;
if ( * V_204 ) {
V_66 = F_55 ( * V_204 , V_16 ) ;
if ( V_66 )
return V_66 ;
}
* V_204 = F_104 ( V_205 , V_70 ) ;
if ( ! * V_204 )
return - V_93 ;
return 0 ;
}
...
if ( V_16 -> V_5 [ V_199 ] )
V_208 = F_7 ( V_16 -> V_5 [ V_199 ] ) ;
return F_105 ( V_16 , V_220 , 0 ,
& V_2 -> V_221 ,
V_208 ) ;
}
...
int V_212 ;
int V_66 ;
for ( V_212 = 0 ; V_212 < V_232 ; V_212 ++ ) {
V_189 = F_95 ( V_47 ,
V_233 ) ;
if ( ! V_189 )
return - V_57 ;
V_66 = F_112 ( V_47 , & V_231 [ V_212 ] ) ;
if ( V_66 )
goto V_234;
F_96 ( V_47 , V_189 ) ;
}
...
struct V_237 * V_238 )
{
struct V_4 * V_239 , * V_182 , * V_192 ;
int V_66 ;
V_239 = F_95 ( V_47 , V_240 ) ;
if ( ! V_239 )
return - V_57 ;
if ( F_102 ( V_47 , V_241 , V_238 -> V_19 ,
V_201 ) )
goto V_65;
if ( V_238 -> V_242 )
if ( F_102 ( V_47 , V_243 ,
...
int F_119 ( struct V_253 * V_254 )
{
struct V_2 * V_2 ;
int V_66 ;
V_66 = F_103 ( & V_254 -> V_47 ,
V_254 -> V_16 ) ;
if ( V_66 )
return V_66 ;
V_254 -> V_63 = F_42 ( V_254 -> V_47 ,
V_254 -> V_16 -> V_94 ,
V_254 -> V_16 -> V_95 ,
& V_64 , V_103 ,
V_254 -> V_59 ) ;
if ( ! V_254 -> V_63 )
goto V_65;
V_2 = V_254 -> V_16 -> V_51 [ 0 ] ;
if ( F_39 ( V_254 -> V_47 , V_2 ) )
goto V_65;
V_254 -> V_255 = F_95 ( V_254 -> V_47 ,
V_256 ) ;
if ( ! V_254 -> V_255 )
goto V_65;
return 0 ;
V_65:
F_44 ( V_254 -> V_47 , V_254 -> V_63 ) ;
F_48 ( V_254 -> V_47 ) ;
return - V_57 ;
}
int F_120 ( struct V_253 * V_254 ,
struct V_237 * V_238 )
{
return F_116 ( V_254 -> V_47 , V_238 ) ;
}
int F_121 ( struct V_253 * V_254 )
{
F_96 ( V_254 -> V_47 , V_254 -> V_255 ) ;
F_43 ( V_254 -> V_47 , V_254 -> V_63 ) ;
return 0 ;
}
void F_122 ( struct V_237 * V_238 )
{
...
F_123 ( V_223 [ V_258 ] . V_223 ) ;
F_123 ( V_223 [ V_258 ] . V_226 ) ;
}
V_223 = V_238 -> V_246 ;
V_257 = V_238 -> V_247 ;
for ( V_258 = 0 ; V_258 < V_257 ; V_258 ++ ) {
...
V_254 . V_59 = V_59 ;
V_254 . V_16 = V_16 ;
V_66 = V_181 -> V_184 -> V_259 ( V_181 -> V_186 ,
V_181 -> V_203 ,
& V_254 ) ;
if ( V_66 )
goto V_260;
V_217:
V_101 = F_108 ( V_254 . V_47 , V_16 -> V_94 , V_16 -> V_95 ,
V_218 , 0 , V_62 | V_103 ) ;
if ( ! V_101 ) {
V_66 = F_103 ( & V_254 . V_47 , V_16 ) ;
if ( V_66 )
goto V_219;
goto V_217;
}
return F_55 ( V_254 . V_47 , V_16 ) ;
V_260:
V_219:
F_44 ( V_254 . V_47 , V_254 . V_63 ) ;
F_48 ( V_254 . V_47 ) ;
...
return - V_10 ;
V_208 = F_7 ( V_16 -> V_5 [ V_199 ] ) ;
V_181 = F_117 ( & V_2 -> V_221 ,
V_208 ) ;
if ( ! V_181 )
return - V_10 ;
if ( ! V_181 -> V_184 -> V_259 )
return - V_10 ;
return F_124 ( V_16 , V_261 ,
0 , V_181 ) ;
}
static int F_126 ( struct V_46 * V_47 ,
const struct V_164 * V_165 )
{
struct V_166 * V_167 ;
struct V_4 * V_262 ;
int V_212 ;
for ( V_212 = 0 ; V_212 < V_165 -> V_263 ; V_212 ++ ) {
V_167 = & V_165 -> V_168 [ V_212 ] ;
V_262 = F_95 ( V_47 , V_264 ) ;
if ( ! V_262 )
return - V_57 ;
if ( F_40 ( V_47 , V_265 , V_167 -> V_13 ) ||
F_51 ( V_47 , V_177 , V_167 -> V_176 ) ||
F_51 ( V_47 , V_266 , V_167 -> V_267 ) ||
F_51 ( V_47 , V_268 , V_167 -> V_269 ) )
goto V_65;
F_96 ( V_47 , V_262 ) ;
}
return 0 ;
...
int V_66 ;
V_271 = F_95 ( V_47 , V_272 ) ;
if ( ! V_271 )
return - V_57 ;
if ( F_40 ( V_47 , V_273 , V_165 -> V_13 ) ||
F_51 ( V_47 , V_175 , V_165 -> V_176 ) ||
F_71 ( V_47 , V_178 , V_165 -> V_179 ) )
goto V_65;
V_270 = F_95 ( V_47 , V_274 ) ;
if ( ! V_270 )
goto V_65;
V_66 = F_126 ( V_47 , V_165 ) ;
if ( V_66 ) {
F_97 ( V_47 , V_270 ) ;
goto V_65;
}
...
if ( F_39 ( V_47 , V_2 ) )
goto V_65;
V_277 = F_95 ( V_47 , V_279 ) ;
if ( ! V_277 )
goto V_65;
V_278 = 0 ;
for (; V_212 < V_276 -> V_280 ; V_212 ++ ) {
V_66 = F_127 ( V_47 , V_276 -> V_281 [ V_212 ] ) ;
if ( V_66 ) {
if ( ! V_278 )
goto V_216;
break;
...
if ( V_181 -> V_284 )
return - V_109 ;
if ( ! ( V_181 -> V_203 ^ V_283 ) )
return 0 ;
V_181 -> V_203 = V_283 ;
if ( V_181 -> V_184 -> V_285 )
V_181 -> V_184 -> V_285 ( V_181 -> V_186 , V_283 ) ;
return 0 ;
}
static int F_131 ( struct V_46 * V_47 ,
struct V_15 * V_16 )
{
struct V_2 * V_2 = V_16 -> V_51 [ 0 ] ;
const char * V_208 ;
...
return - V_10 ;
V_208 = F_7 ( V_16 -> V_5 [ V_199 ] ) ;
V_286 = ! ! F_27 ( V_16 -> V_5 [ V_202 ] ) ;
return F_130 ( V_2 , V_208 ,
V_286 ) ;
}
struct V_2 * F_132 ( const struct V_130 * V_45 , T_5 V_287 )
{
struct V_2 * V_2 ;
V_2 = F_133 ( sizeof( * V_2 ) + V_287 , V_70 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_45 = V_45 ;
F_3 ( V_2 , & V_288 ) ;
...
int F_136 ( struct V_2 * V_2 , struct V_291 * V_11 )
{
F_34 ( & V_48 ) ;
V_2 -> V_11 = V_11 ;
F_137 ( & V_2 -> V_213 , & V_292 ) ;
F_45 ( V_2 , V_67 ) ;
F_36 ( & V_48 ) ;
return 0 ;
}
...
void F_140 ( struct V_2 * V_2 )
{
F_123 ( V_2 ) ;
}
int F_141 ( struct V_2 * V_2 ,
struct V_17 * V_17 ,
unsigned int V_18 )
{
F_34 ( & V_53 ) ;
...
V_17 -> V_19 = V_18 ;
V_17 -> V_90 = true ;
F_137 ( & V_17 -> V_213 , & V_2 -> V_289 ) ;
F_36 ( & V_53 ) ;
F_53 ( V_17 , V_91 ) ;
return 0 ;
}
void F_142 ( struct V_17 * V_17 )
{
F_53 ( V_17 , V_92 ) ;
F_34 ( & V_53 ) ;
F_139 ( & V_17 -> V_213 ) ;
...
int F_148 ( struct V_2 * V_2 , unsigned int V_24 ,
T_1 V_115 , T_2 V_22 ,
T_2 V_23 , T_2 V_42 ,
T_2 V_43 )
{
...
V_21 -> V_42 = V_42 ;
V_21 -> V_43 = V_43 ;
F_137 ( & V_21 -> V_213 , & V_2 -> V_290 ) ;
V_294:
F_36 ( & V_48 ) ;
return V_66 ;
}
void F_149 ( struct V_2 * V_2 , unsigned int V_24 )
{
struct V_21 * V_21 ;
F_34 ( & V_48 ) ;
V_21 = F_19 ( V_2 , V_24 ) ;
...
void F_151 ( struct V_2 * V_2 )
{
F_34 ( & V_48 ) ;
V_2 -> V_276 = NULL ;
F_36 ( & V_48 ) ;
}
bool F_152 ( struct V_2 * V_2 ,
const char * V_208 )
{
struct V_180 * V_181 ;
bool V_295 ;
...
int F_155 ( struct V_2 * V_2 ,
const char * V_208 ,
struct V_296 * V_184 ,
void * V_186 , bool V_284 )
{
struct V_180 * V_181 ;
if ( F_117 ( & V_2 -> V_221 , V_208 ) )
return - V_293 ;
if ( F_46 ( ! V_184 -> V_197 ) )
return - V_10 ;
V_181 = F_133 ( sizeof( * V_181 ) , V_70 ) ;
if ( ! V_181 )
return - V_93 ;
V_181 -> V_13 = V_208 ;
V_181 -> V_184 = V_184 ;
...
V_181 -> V_284 = V_284 ;
F_34 ( & V_48 ) ;
F_156 ( & V_181 -> V_213 , & V_2 -> V_221 ) ;
F_36 ( & V_48 ) ;
return 0 ;
}
void F_157 ( struct V_2 * V_2 ,
const char * V_208 )
{
struct V_180 * V_181 ;
F_34 ( & V_48 ) ;
