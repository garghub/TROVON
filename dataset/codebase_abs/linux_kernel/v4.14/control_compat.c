...
goto error;
V_8 = - V_10 ;
if ( F_11 ( & V_4 -> V_18 , & V_6 -> V_18 , sizeof( V_6 -> V_18 ) ) ||
F_11 ( & V_4 -> type , & V_6 -> type , 3 * sizeof( V_9 ) ) )
goto error;
...
break;
case V_29 :
if ( F_11 ( & V_4 -> V_19 . V_30 ,
& V_6 -> V_19 . V_30 ,
sizeof( V_6 -> V_19 . V_30 ) ) )
goto error;
break;
case V_31 :
if ( F_11 ( & V_4 -> V_19 . V_20 ,
& V_6 -> V_19 . V_20 ,
...
static int F_13 ( struct V_1 * V_2 , struct V_32 * V_18 ,
int * V_33 )
{
struct V_34 * V_35 ;
struct V_15 * V_36 ;
...
static int F_17 ( int type , int V_39 )
{
switch ( type ) {
case V_29 :
...
V_50 = F_17 ( type , V_39 ) ;
if ( F_11 ( V_46 , V_6 -> V_19 . V_57 . V_6 , V_50 ) )
return - V_10 ;
}
return 0 ;
}
...
if ( V_8 < 0 )
goto error;
V_8 = F_20 ( V_45 , V_46 , V_6 , type , V_39 ) ;
error:
F_12 ( V_6 ) ;
return V_8 ;
}
static int F_23 ( struct V_12 * V_58 ,
void T_1 * V_45 , void T_1 * V_46 )
{
struct V_44 * V_6 ;
...
struct V_48 T_1 * V_4 )
{
return F_21 ( V_2 , V_4 , & V_4 -> V_19 ) ;
}
static int F_26 ( struct V_12 * V_58 ,
struct V_48 T_1 * V_4 )
{
return F_23 ( V_58 , V_4 , & V_4 -> V_19 ) ;
}
...
static int F_29 ( struct V_12 * V_58 ,
struct V_14 T_1 * V_4 ,
int V_60 )
{
struct V_15 * V_6 ;
...
V_8 = F_30 ( V_58 , V_6 , V_60 ) ;
error:
F_12 ( V_6 ) ;
return V_8 ;
}
static inline long F_31 ( struct V_58 * V_58 , unsigned int V_63 , unsigned long V_64 )
{
struct V_12 * V_13 ;
struct V_65 * V_66 ;
...
case V_79 :
case V_80 :
return F_33 ( V_58 , V_63 , ( unsigned long ) V_67 ) ;
case V_81 :
return F_1 ( V_13 -> V_2 , V_67 ) ;
case V_82 :
return F_7 ( V_13 , V_67 ) ;
case V_83 :
return F_25 ( V_13 -> V_2 , V_67 ) ;
case V_84 :
return F_26 ( V_13 , V_67 ) ;
case V_85 :
return F_29 ( V_13 , V_67 , 0 ) ;
case V_86 :
return F_29 ( V_13 , V_67 , 1 ) ;
#ifdef F_34
case V_87 :
...
F_14 ( & V_89 ) ;
F_35 (p, &snd_control_compat_ioctls, list) {
if ( V_66 -> V_90 ) {
