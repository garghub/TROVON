...
if ( V_12 -> V_23 & V_46 ) {
V_33 |= V_47 ;
} else if ( V_12 -> V_23 & V_48 ) {
V_33 |= V_49 ;
if ( V_12 -> V_23 & V_50 )
V_33 |= V_51 ;
else if ( V_12 -> V_23 & V_52 )
V_33 |= V_53 ;
else if ( V_12 -> V_23 & V_54 )
V_33 |= V_55 ;
else if ( V_12 -> V_23 & V_56 )
V_33 |= V_57 ;
} else if ( V_12 -> V_23 & V_58 ) {
V_33 |= V_59 ;
}
if ( ( V_12 -> V_23 & V_60 ) || ( V_12 -> V_23 & V_58 ) )
V_33 |= V_61 ;
F_7 ( V_12 , V_25 , V_32 ) ;
F_7 ( V_12 , V_62 , V_33 ) ;
F_9 ( V_12 , V_63 , V_12 -> V_16 -> V_64 ,
V_12 -> V_16 -> V_40 >> 2 ) ;
if ( ( ( V_12 -> V_23 & V_46 ) || ( V_12 -> V_23 & V_48 ) ||
( V_12 -> V_23 & V_58 ) ) && V_12 -> V_65 -> V_66 ) {
...
if ( ( V_12 -> V_23 & V_48 ) && ( V_12 -> V_23 & V_50 ) )
V_89 = F_37 ( V_10 , sizeof( V_90 ) ) ;
else if ( ( V_12 -> V_23 & V_48 ) && ( V_12 -> V_23 & V_52 ) )
...
if ( V_119 ) {
V_8 = F_50 ( T_1 , V_12 -> V_6 , F_42 ( V_12 -> V_71 ) ) ;
V_8 = F_50 ( T_1 , V_8 , F_42 ( V_12 -> V_69 ) ) ;
V_21 = F_51 ( V_12 -> V_29 , V_12 -> V_71 , 1 , V_72 ) ;
if ( ! V_21 ) {
F_29 ( V_12 -> V_29 , L_6 ) ;
return - V_77 ;
}
V_21 = F_51 ( V_12 -> V_29 , V_12 -> V_69 , 1 ,
V_70 ) ;
if ( ! V_21 ) {
F_29 ( V_12 -> V_29 , L_6 ) ;
...
V_12 -> V_6 -= V_8 ;
if ( V_12 -> V_35 . V_36 )
V_21 = F_38 ( V_88 , V_121 , V_122 , V_8 ) ;
else
V_21 = F_35 ( V_88 , V_121 , V_122 , V_8 ) ;
if ( V_21 && ( V_12 -> V_23 & V_68 ) ) {
F_24 ( V_12 -> V_29 , V_12 -> V_71 , 1 , V_72 ) ;
F_24 ( V_12 -> V_29 , V_12 -> V_69 , 1 , V_72 ) ;
}
return V_21 ;
}
static void F_52 ( struct V_11 * V_12 , int V_21 )
{
struct V_125 * V_65 = V_12 -> V_65 ;
F_19 ( V_12 -> V_22 ) ;
V_12 -> V_23 &= ~ V_126 ;
V_65 -> V_127 . V_128 ( & V_65 -> V_127 , V_21 ) ;
}
...
F_54 ( & V_12 -> V_20 , V_23 ) ;
if ( V_65 )
V_134 = F_55 ( & V_12 -> V_135 , V_65 ) ;
if ( V_12 -> V_23 & V_126 ) {
F_56 ( & V_12 -> V_20 , V_23 ) ;
return V_134 ;
}
V_131 = F_57 ( & V_12 -> V_135 ) ;
V_130 = F_58 ( & V_12 -> V_135 ) ;
if ( V_130 )
V_12 -> V_23 |= V_126 ;
F_56 ( & V_12 -> V_20 , V_23 ) ;
if ( ! V_130 )
...
V_16 = F_61 ( F_48 ( V_65 ) ) ;
V_133 -> V_140 &= V_141 ;
V_12 -> V_23 = ( V_12 -> V_23 & ~ V_141 ) | V_133 -> V_140 ;
V_12 -> V_16 = V_16 ;
V_16 -> V_12 = V_12 ;
V_21 = F_22 ( V_12 ) ;
if ( ! V_21 )
...
static int F_63 ( struct V_125 * V_65 , unsigned long V_140 )
{
struct V_15 * V_16 = F_61 (
F_48 ( V_65 ) ) ;
struct V_132 * V_133 = F_60 ( V_65 ) ;
if ( V_140 & V_50 ) {
...
V_133 -> V_140 = V_140 ;
return F_53 ( V_16 -> V_12 , V_65 ) ;
}
static bool F_64 ( struct V_146 * V_111 , void * V_147 )
{
...
F_66 ( V_155 ) ;
F_67 ( V_156 , V_155 ) ;
V_12 -> V_103 . V_111 = F_68 ( V_155 ,
F_64 , & V_154 -> V_157 -> V_158 , V_12 -> V_29 , L_11 ) ;
if ( ! V_12 -> V_103 . V_111 )
goto V_159;
...
V_12 -> V_107 . V_111 = F_68 ( V_155 ,
F_64 , & V_154 -> V_157 -> V_167 , V_12 -> V_29 , L_12 ) ;
if ( ! V_12 -> V_107 . V_111 )
goto V_168;
...
{
F_69 ( V_12 -> V_103 . V_111 ) ;
F_69 ( V_12 -> V_107 . V_111 ) ;
}
static int F_72 ( struct V_171 * V_88 , const V_90 * V_64 ,
unsigned int V_40 )
{
T_2 V_18 [ V_172 ] ;
int V_21 ;
struct V_87 * V_173 = F_47 ( V_88 ) ;
struct V_15 * V_16 = F_61 ( V_88 ) ;
if ( V_40 != V_41 ) {
F_73 ( V_88 , V_174 ) ;
return - V_77 ;
}
V_21 = F_74 ( V_18 , V_64 ) ;
if ( V_21 == 0 && ( V_173 -> V_175 & V_176 ) ) {
V_173 -> V_175 |= V_177 ;
return - V_77 ;
}
...
static int F_75 ( struct V_171 * V_88 , const V_90 * V_64 ,
unsigned int V_40 )
{
struct V_15 * V_16 = F_61 ( V_88 ) ;
const char * V_178 ;
V_178 = F_76 ( F_47 ( V_88 ) ) ;
...
{
return F_63 ( V_65 , V_48 | V_54 ) ;
}
static int F_89 ( struct V_125 * V_65 )
{
return F_63 ( V_65 , V_60 | V_58 ) ;
}
static int F_90 ( struct V_125 * V_65 )
{
return F_63 ( V_65 , V_58 ) ;
}
...
static void F_94 ( unsigned long V_30 )
{
struct V_11 * V_12 = (struct V_11 * ) V_30 ;
int V_21 ;
if ( ! ( V_12 -> V_23 & V_112 ) )
...
static T_5 F_95 ( int V_183 , void * V_184 )
{
...
{
int V_191 ;
for ( V_191 = 0 ; V_191 < F_97 ( V_192 ) ; V_191 ++ )
F_98 ( & V_192 [ V_191 ] ) ;
}
static int F_99 ( struct V_11 * V_12 )
{
int V_21 , V_191 , V_193 ;
for ( V_191 = 0 ; V_191 < F_97 ( V_192 ) ; V_191 ++ ) {
V_21 = F_100 ( & V_192 [ V_191 ] ) ;
if ( V_21 )
goto V_194;
}
return 0 ;
...
static struct V_153 * F_102 ( struct V_195 * V_196 )
{
...
V_154 = F_104 ( & V_196 -> V_29 , sizeof( * V_154 ) , V_80 ) ;
if ( ! V_154 ) {
F_29 ( & V_196 -> V_29 , L_18 ) ;
return F_103 ( - V_78 ) ;
}
V_154 -> V_157 = F_104 ( & V_196 -> V_29 ,
sizeof( * ( V_154 -> V_157 ) ) ,
V_80 ) ;
if ( ! V_154 -> V_157 ) {
...
static inline struct V_153 * F_102 ( struct V_195 * V_196 )
{
return F_103 ( - V_77 ) ;
}
static int F_105 ( struct V_195 * V_196 )
{
struct V_11 * V_17 ;
struct V_153 * V_154 ;
...
struct V_200 * V_201 ;
int V_21 ;
V_17 = F_106 ( & V_196 -> V_29 , sizeof( * V_17 ) , V_80 ) ;
if ( V_17 == NULL ) {
F_29 ( V_29 , L_20 ) ;
V_21 = - V_78 ;
goto V_202;
...
F_108 ( & V_17 -> V_203 ) ;
F_109 ( & V_17 -> V_20 ) ;
F_110 ( & V_17 -> V_31 , F_94 ,
( unsigned long ) V_17 ) ;
F_110 ( & V_17 -> V_142 , F_93 ,
( unsigned long ) V_17 ) ;
F_111 ( & V_17 -> V_135 , V_204 ) ;
V_17 -> V_183 = - 1 ;
V_201 = F_112 ( V_196 , V_205 , 0 ) ;
if ( ! V_201 ) {
F_29 ( V_29 , L_21 ) ;
V_21 = - V_182 ;
goto V_206;
}
V_17 -> V_162 = V_201 -> V_207 ;
V_17 -> V_183 = F_113 ( V_196 , 0 ) ;
if ( V_17 -> V_183 < 0 ) {
F_29 ( V_29 , L_22 ) ;
V_21 = V_17 -> V_183 ;
goto V_206;
}
V_21 = F_114 ( & V_196 -> V_29 , V_17 -> V_183 , F_95 ,
V_208 , L_23 , V_17 ) ;
if ( V_21 ) {
F_29 ( V_29 , L_24 ) ;
goto V_206;
}
V_17 -> V_22 = F_115 ( & V_196 -> V_29 , L_25 ) ;
if ( F_116 ( V_17 -> V_22 ) ) {
F_29 ( V_29 , L_26 ) ;
V_21 = F_117 ( V_17 -> V_22 ) ;
goto V_206;
}
V_17 -> V_13 = F_118 ( & V_196 -> V_29 , V_201 ) ;
if ( F_116 ( V_17 -> V_13 ) ) {
F_29 ( V_29 , L_27 ) ;
V_21 = F_117 ( V_17 -> V_13 ) ;
goto V_206;
}
F_17 ( V_17 ) ;
F_101 ( V_17 ) ;
...
V_21 = F_65 ( V_17 , V_154 ) ;
if ( V_21 )
goto V_213;
F_18 ( V_29 , L_29 ,
F_119 ( V_17 -> V_103 . V_111 ) ,
F_119 ( V_17 -> V_107 . V_111 ) ) ;
}
F_120 ( & V_19 . V_20 ) ;
F_121 ( & V_17 -> V_203 , & V_19 . V_214 ) ;
F_122 ( & V_19 . V_20 ) ;
V_21 = F_99 ( V_17 ) ;
if ( V_21 )
goto V_215;
...
static int F_125 ( struct V_195 * V_196 )
{
struct V_11 * V_17 ;
V_17 = F_126 ( V_196 ) ;
if ( ! V_17 )
