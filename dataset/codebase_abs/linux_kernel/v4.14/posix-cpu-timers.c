...
V_102 -> V_73 = V_23 ;
V_102 -> V_74 = F_70 ( ++ V_98 , V_61 ,
V_47 -> V_104 . V_29 ) ;
V_103 = F_74 ( V_47 , V_105 ) ;
if ( V_103 != V_106 ) {
unsigned long V_107 = F_75 ( V_47 , V_105 ) ;
if ( V_107 != V_106 &&
V_47 -> V_108 . V_109 > F_76 ( V_107 , V_110 / V_34 ) ) {
if ( V_111 ) {
F_77 ( L_1 ,
V_47 -> V_112 , F_78 ( V_47 ) ) ;
}
F_79 ( V_113 , V_114 , V_47 ) ;
return;
}
if ( V_47 -> V_108 . V_109 > F_76 ( V_103 , V_110 / V_34 ) ) {
if ( V_103 < V_107 ) {
V_103 += V_110 ;
V_47 -> signal -> V_115 [ V_105 ] . V_116 =
V_103 ;
}
if ( V_111 ) {
F_77 ( L_2 ,
...
F_79 ( V_117 , V_114 , V_47 ) ;
}
}
if ( F_15 ( V_102 ) )
F_80 ( V_47 , V_75 ) ;
}
static inline void F_81 ( struct V_118 * V_119 )
{
struct F_27 * V_48 = & V_119 -> V_48 ;
F_30 ( V_48 -> V_49 , false ) ;
F_82 ( V_119 , V_75 ) ;
}
static void F_83 ( struct V_1 * V_47 , struct V_120 * V_21 ,
T_1 * V_23 , T_1 V_121 , int V_122 )
{
if ( ! V_21 -> V_23 )
return;
if ( V_121 >= V_21 -> V_23 ) {
...
F_84 ( V_122 == V_123 ?
V_124 : V_125 ,
V_47 -> signal -> V_126 , V_121 ) ;
F_79 ( V_122 , V_114 , V_47 ) ;
}
if ( V_21 -> V_23 && ( ! * V_23 || V_21 -> V_23 < * V_23 ) )
* V_23 = V_21 -> V_23 ;
}
static void F_85 ( struct V_1 * V_47 ,
struct V_63 * V_61 )
{
struct V_118 * const V_119 = V_47 -> signal ;
T_1 V_27 , V_127 , V_128 , V_129 ;
T_1 V_130 , V_131 ;
struct V_63 * V_98 = V_119 -> V_67 ;
struct V_25 V_26 ;
unsigned long V_103 ;
if ( ! F_28 ( V_47 -> signal -> V_48 . V_49 ) )
return;
V_119 -> V_48 . V_132 = true ;
F_27 ( V_47 , & V_26 ) ;
V_27 = V_26 . V_27 ;
V_127 = V_27 + V_26 . V_28 ;
V_130 = V_26 . V_29 ;
V_129 = F_70 ( V_98 , V_61 , V_127 ) ;
V_128 = F_70 ( ++ V_98 , V_61 , V_27 ) ;
V_131 = F_70 ( ++ V_98 , V_61 , V_130 ) ;
F_83 ( V_47 , & V_119 -> V_21 [ V_8 ] , & V_129 , V_127 ,
V_123 ) ;
F_83 ( V_47 , & V_119 -> V_21 [ V_38 ] , & V_128 , V_27 ,
V_133 ) ;
V_103 = F_74 ( V_47 , V_134 ) ;
if ( V_103 != V_106 ) {
unsigned long V_135 = F_86 ( V_127 , V_5 ) ;
unsigned long V_107 = F_75 ( V_47 , V_134 ) ;
T_1 V_136 ;
if ( V_135 >= V_107 ) {
if ( V_111 ) {
F_77 ( L_3 ,
...
if ( V_103 < V_107 ) {
V_103 ++ ;
V_119 -> V_115 [ V_134 ] . V_116 = V_103 ;
}
}
V_136 = V_103 * V_5 ;
if ( ! V_129 || V_136 < V_129 )
V_129 = V_136 ;
}
V_119 -> V_70 . V_72 = V_129 ;
V_119 -> V_70 . V_73 = V_128 ;
V_119 -> V_70 . V_74 = V_131 ;
if ( F_15 ( & V_119 -> V_70 ) )
F_81 ( V_119 ) ;
V_119 -> V_48 . V_132 = false ;
}
...
V_16 -> V_21 . V_22 . V_23 = 0 ;
return;
} else if ( F_42 ( V_10 -> V_137 ) && F_87 ( V_10 ) ) {
goto V_138;
}
F_63 ( V_16 -> V_54 , V_10 , & V_17 ) ;
F_14 ( V_16 , V_17 ) ;
...
static inline int F_88 ( const struct V_25 * V_37 ,
...
static inline int F_89 ( struct V_1 * V_47 )
{
struct V_118 * V_119 ;
if ( ! F_15 ( & V_47 -> V_70 ) ) {
struct V_25 V_139 ;
V_25 ( V_47 , & V_139 . V_27 , & V_139 . V_28 ) ;
V_139 . V_29 = V_47 -> V_104 . V_29 ;
if ( F_88 ( & V_139 , & V_47 -> V_70 ) )
return 1 ;
}
V_119 = V_47 -> signal ;
if ( F_28 ( V_119 -> V_48 . V_49 ) &&
! F_28 ( V_119 -> V_48 . V_132 ) ) {
struct V_25 V_140 ;
F_26 ( & V_140 , & V_119 -> V_48 . V_43 ) ;
if ( F_88 ( & V_140 , & V_119 -> V_70 ) )
return 1 ;
}
return 0 ;
}
void F_90 ( struct V_1 * V_47 )
{
F_91 ( V_61 ) ;
...
void F_3 ( struct V_1 * V_47 , unsigned int V_143 ,
T_1 * V_144 , T_1 * V_145 )
{
T_1 V_17 ;
F_40 ( V_143 == V_35 ) ;
F_63 ( V_143 , V_47 , & V_17 ) ;
if ( V_145 ) {
if ( * V_145 ) {
if ( * V_145 <= V_17 ) {
* V_145 = V_146 ;
...
switch ( V_143 ) {
case V_8 :
if ( F_53 ( V_47 -> signal -> V_70 . V_72 , * V_144 ) )
V_47 -> signal -> V_70 . V_72 = * V_144 ;
break;
case V_38 :
if ( F_53 ( V_47 -> signal -> V_70 . V_73 , * V_144 ) )
V_47 -> signal -> V_70 . V_73 = * V_144 ;
break;
}
F_58 ( V_47 -> signal , V_75 ) ;
}
static int F_95 ( const T_2 V_9 , int V_59 ,
const struct V_30 * V_147 )
{
struct V_83 V_21 ;
struct V_15 V_16 ;
T_1 V_23 ;
...
error = - V_152 ;
V_150 = & V_14 -> V_149 ;
V_150 -> V_153 . V_23 = V_23 ;
if ( V_150 -> V_153 . type != V_154 )
error = F_100 ( V_150 , & V_21 . V_90 ) ;
}
return error ;
}
static int F_101 ( const T_2 V_9 , int V_59 ,
const struct V_30 * V_147 )
{
struct V_149 * V_149 = & V_14 -> V_149 ;
int error ;
if ( F_10 ( V_9 ) &&
( F_6 ( V_9 ) == 0 ||
F_6 ( V_9 ) == F_102 ( V_14 ) ) )
return - V_13 ;
error = F_95 ( V_9 , V_59 , V_147 ) ;
if ( error == - V_152 ) {
if ( V_59 & V_93 )
return - V_155 ;
V_149 -> V_156 = V_157 ;
V_149 -> V_153 . V_158 = V_9 ;
}
return error ;
}
static long V_157 ( struct V_149 * V_149 )
{
T_2 V_9 = V_149 -> V_153 . V_158 ;
struct V_30 V_101 ;
V_101 = F_34 ( V_149 -> V_153 . V_23 ) ;
return F_95 ( V_9 , V_93 , & V_101 ) ;
}
static int F_103 ( const T_2 V_9 ,
struct V_30 * V_31 )
{
return F_18 ( V_159 , V_31 ) ;
}
static int F_104 ( const T_2 V_9 ,
struct V_30 * V_31 )
{
return F_35 ( V_159 , V_31 ) ;
}
...
static int F_106 ( const T_2 V_9 , int V_59 ,
const struct V_30 * V_147 )
{
return F_101 ( V_159 , V_59 , V_147 ) ;
}
static int F_107 ( const T_2 V_9 ,
struct V_30 * V_31 )
{
return F_18 ( V_160 , V_31 ) ;
}
static int F_108 ( const T_2 V_9 ,
struct V_30 * V_31 )
{
