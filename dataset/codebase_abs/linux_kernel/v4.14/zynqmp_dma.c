...
if ( ! V_2 )
return;
F_61 ( V_2 -> V_123 -> V_75 , V_2 -> V_100 , V_2 ) ;
F_62 ( & V_2 -> V_108 ) ;
F_21 ( & V_2 -> V_73 . V_124 ) ;
F_63 ( V_2 -> V_125 ) ;
F_63 ( V_2 -> V_126 ) ;
}
static int F_64 ( struct V_127 * V_123 ,
struct V_128 * V_129 )
{
struct V_1 * V_2 ;
struct V_130 * V_131 ;
struct V_124 * V_55 = V_129 -> V_75 . V_132 ;
int V_112 ;
V_2 = F_65 ( V_123 -> V_75 , sizeof( * V_2 ) , V_70 ) ;
if ( ! V_2 )
return - V_71 ;
V_2 -> V_75 = V_123 -> V_75 ;
V_2 -> V_123 = V_123 ;
V_131 = F_66 ( V_129 , V_133 , 0 ) ;
V_2 -> V_5 = F_67 ( & V_129 -> V_75 , V_131 ) ;
if ( F_68 ( V_2 -> V_5 ) )
return F_69 ( V_2 -> V_5 ) ;
V_2 -> V_134 = V_135 ;
V_2 -> V_90 = V_136 ;
V_2 -> V_87 = V_137 ;
V_112 = F_70 ( V_55 , L_4 , & V_2 -> V_134 ) ;
if ( V_112 < 0 ) {
F_51 ( & V_129 -> V_75 , L_5 ) ;
return V_112 ;
}
...
V_2 -> V_26 = F_71 ( V_55 , L_7 ) ;
V_123 -> V_2 = V_2 ;
F_72 ( & V_2 -> V_108 , F_53 , ( T_8 ) V_2 ) ;
F_73 ( & V_2 -> V_53 ) ;
F_22 ( & V_2 -> V_96 ) ;
F_22 ( & V_2 -> V_54 ) ;
F_22 ( & V_2 -> V_99 ) ;
F_22 ( & V_2 -> V_59 ) ;
F_74 ( & V_2 -> V_73 ) ;
V_2 -> V_73 . V_140 = & V_123 -> V_73 ;
F_17 ( & V_2 -> V_73 . V_124 , & V_123 -> V_73 . V_141 ) ;
F_7 ( V_2 ) ;
V_2 -> V_100 = F_75 ( V_129 , 0 ) ;
if ( V_2 -> V_100 < 0 )
return - V_142 ;
V_112 = F_76 ( & V_129 -> V_75 , V_2 -> V_100 , F_49 , 0 ,
L_8 , V_2 ) ;
if ( V_112 )
return V_112 ;
V_2 -> V_126 = F_77 ( & V_129 -> V_75 , L_9 ) ;
if ( F_68 ( V_2 -> V_126 ) ) {
F_51 ( & V_129 -> V_75 , L_10 ) ;
return F_69 ( V_2 -> V_126 ) ;
}
V_2 -> V_125 = F_77 ( & V_129 -> V_75 , L_11 ) ;
if ( F_68 ( V_2 -> V_125 ) ) {
F_51 ( & V_129 -> V_75 , L_12 ) ;
return F_69 ( V_2 -> V_125 ) ;
}
V_112 = F_78 ( V_2 -> V_126 ) ;
if ( V_112 ) {
F_51 ( & V_129 -> V_75 , L_13 ) ;
return V_112 ;
}
V_112 = F_78 ( V_2 -> V_125 ) ;
if ( V_112 ) {
F_63 ( V_2 -> V_126 ) ;
F_51 ( & V_129 -> V_75 , L_14 ) ;
return V_112 ;
}
...
static struct V_65 * F_79 ( struct V_143 * V_144 ,
struct V_145 * V_146 )
{
struct V_127 * V_123 = V_146 -> V_147 ;
return F_80 ( & V_123 -> V_2 -> V_73 ) ;
}
...
struct V_148 * V_149 ;
int V_104 ;
V_123 = F_65 ( & V_129 -> V_75 , sizeof( * V_123 ) , V_70 ) ;
if ( ! V_123 )
return - V_71 ;
V_123 -> V_75 = & V_129 -> V_75 ;
F_22 ( & V_123 -> V_73 . V_141 ) ;
F_82 ( & V_129 -> V_75 , F_83 ( 44 ) ) ;
F_84 ( V_150 , V_123 -> V_73 . V_151 ) ;
V_149 = & V_123 -> V_73 ;
V_149 -> V_152 = F_55 ;
V_149 -> V_153 = F_54 ;
V_149 -> V_154 = F_43 ;
...
V_149 -> V_157 = V_158 ;
V_149 -> V_159 = F_34 ;
V_149 -> V_75 = & V_129 -> V_75 ;
F_85 ( V_129 , V_123 ) ;
V_104 = F_64 ( V_123 , V_129 ) ;
if ( V_104 ) {
F_51 ( & V_129 -> V_75 , L_15 ) ;
goto V_160;
}
V_149 -> V_161 = F_86 ( V_123 -> V_2 -> V_134 / 8 ) ;
V_149 -> V_162 = F_86 ( V_123 -> V_2 -> V_134 / 8 ) ;
F_87 ( & V_123 -> V_73 ) ;
V_104 = F_88 ( V_129 -> V_75 . V_132 ,
F_79 , V_123 ) ;
if ( V_104 ) {
F_51 ( & V_129 -> V_75 , L_16 ) ;
F_89 ( & V_123 -> V_73 ) ;
goto V_160;
}
F_52 ( & V_129 -> V_75 , L_17 ) ;
return 0 ;
V_160:
F_60 ( V_123 -> V_2 ) ;
return V_104 ;
...
{
struct V_127 * V_123 = F_91 ( V_129 ) ;
F_92 ( V_129 -> V_75 . V_132 ) ;
F_89 ( & V_123 -> V_73 ) ;
F_60 ( V_123 -> V_2 ) ;
return 0 ;
}
