...
static int F_60 ( struct V_135 * V_24 )
{
struct V_131 * V_132 = F_61 ( V_24 ) ;
return V_132 ? F_56 ( V_132 ) : 0 ;
}
static int F_62 ( struct V_135 * V_24 )
{
struct V_131 * V_132 = F_61 ( V_24 ) ;
...
F_4 ( 0 , V_1 -> V_7 + V_139 ) ;
F_5 ( 2 ) ;
F_4 ( V_140 , V_1 -> V_7 + V_139 ) ;
F_5 ( V_21 * 2 ) ;
V_83 = V_138 ( V_1 -> V_132 , 0 , & V_141 , V_1 , & V_74 ) ;
if ( V_83 )
goto V_26;
V_74 -> clock = 48000 ;
V_1 -> V_74 = V_74 ;
...
V_137 . V_6 = 0 ;
V_137 . V_142 = V_143 ;
V_83 = F_64 ( V_74 , & V_137 , & V_3 ) ;
if ( V_83 )
goto V_26;
V_1 -> V_3 = V_3 ;
if ( F_65 ( V_3 ) )
F_66 ( V_3 , V_144 , 0x801e ) ;
V_83 = F_67 ( V_74 , F_23 ( V_145 ) , V_145 ) ;
if ( V_83 )
goto V_26;
...
static struct V_1 * F_70 ( struct V_146 * V_24 )
{
struct V_1 * V_1 ;
struct V_131 * V_132 ;
int V_103 ;
V_103 = F_71 ( & V_24 -> V_24 , V_147 , V_148 ,
...
static unsigned int F_80 ( struct V_1 * V_1 )
{
struct V_27 * V_28 = & V_1 -> V_57 ;
int V_62 ;
...
static int F_81 ( struct V_146 * V_24 ,
...
void T_5 * V_7 = V_1 -> V_7 + V_62 * 0x14 ;
F_4 ( 0 , V_7 + V_43 ) ;
F_4 ( 0 , V_7 + V_114 ) ;
F_4 ( 0 , V_7 + V_126 ) ;
}
...
V_83 = F_87 ( V_1 -> V_132 ) ;
if ( V_83 == 0 ) {
F_88 ( & V_24 -> V_24 , L_15 , V_1 -> V_132 -> V_153 ) ;
F_88 ( & V_24 -> V_24 , L_16 , V_1 -> V_93 ) ;
F_89 ( V_24 , V_1 -> V_132 ) ;
return V_83 ;
}
V_26:
...
static int F_92 ( struct V_146 * V_24 )
{
struct V_131 * V_132 = F_93 ( V_24 ) ;
if ( V_132 ) {
struct V_1 * V_1 = V_132 -> V_16 ;
F_4 ( 0 , V_1 -> V_7 + V_13 ) ;
F_90 ( V_132 ) ;
