...
V_4 -> V_23 = * ( int * ) V_127 ;
V_126 = F_42 ( ( V_8 -> V_137 + 2 ) *
sizeof( struct V_105 ) , V_138 ) ;
if ( V_126 == 0 ) {
F_17 ( V_70 L_24
L_25 , V_123 ) ;
V_129 = - V_133 ;
...
V_129 = F_45 ( V_8 , & V_119 -> V_140 . V_56 ) ;
if ( V_129 != 0 )
goto V_141;
F_46 ( V_8 ) ;
return 0 ;
...
{
struct V_3 * V_142 = (struct V_3 * ) F_53 ( V_119 ) ;
struct V_55 * V_8 = V_142 -> V_8 ;
F_54 ( V_8 ) ;
F_47 ( V_142 -> V_62 , V_142 ) ;
if ( V_142 -> V_15 )
F_49 ( V_142 -> V_15 ) ;
if ( V_142 -> V_17 )
F_49 ( V_142 -> V_17 ) ;
