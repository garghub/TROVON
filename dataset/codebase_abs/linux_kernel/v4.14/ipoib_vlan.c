...
V_9 = F_27 ( V_12 -> V_21 , V_12 -> V_27 , V_38 ) ;
if ( ! V_9 ) {
V_14 = - V_36 ;
goto V_46;
}
...
F_28 (tpriv, &ppriv->child_intfs, list) {
if ( V_40 -> V_13 == V_13 &&
V_40 -> V_33 == V_30 ) {
V_14 = - V_47 ;
goto V_46;
...
int F_32 ( struct V_6 * V_37 , unsigned short V_13 )
{
...
F_33 (priv, tpriv, &ppriv->child_intfs, list) {
if ( V_9 -> V_13 == V_13 &&
V_9 -> V_33 == V_30 ) {
F_34 ( & V_9 -> V_34 ) ;
V_7 = V_9 -> V_7 ;
