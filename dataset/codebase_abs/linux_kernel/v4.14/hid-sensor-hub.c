...
struct V_32 * V_106 = NULL ;
V_102 = F_45 ( & V_4 -> V_107 , sizeof( * V_102 ) , V_108 ) ;
if ( ! V_102 ) {
F_41 ( V_4 , L_10 ) ;
return - V_47 ;
}
F_46 ( V_4 , V_102 ) ;
V_102 -> V_109 = V_2 -> V_110 ;
F_47 ( & V_102 -> V_78 ) ;
F_47 ( & V_102 -> V_40 ) ;
F_48 ( & V_102 -> V_58 ) ;
V_57 = F_49 ( V_4 ) ;
...
V_102 -> V_115 = F_45 ( & V_4 -> V_107 , V_104 *
sizeof( struct V_116 ) ,
V_108 ) ;
if ( V_102 -> V_115 == NULL ) {
F_41 ( V_4 , L_14 ) ;
...
if ( V_11 -> type == V_12 ||
V_11 -> type == V_13 ) {
V_33 = F_45 ( & V_4 -> V_107 , sizeof( * V_33 ) ,
V_108 ) ;
if ( ! V_33 ) {
F_41 ( V_4 , L_15 ) ;
V_57 = - V_47 ;
...
V_33 -> V_4 = V_4 ;
V_33 -> V_117 = V_4 -> V_118 ;
V_33 -> V_119 = V_4 -> V_120 ;
V_33 -> V_84 = V_11 -> V_84 ;
V_33 -> V_73 = F_45 ( & V_4 -> V_107 ,
sizeof( struct V_58 ) ,
V_108 ) ;
if ( ! V_33 -> V_73 ) {
V_57 = - V_47 ;
...
F_54 ( V_4 ) ;
F_8 ( & V_53 -> V_78 , V_39 ) ;
for ( V_7 = 0 ; V_7 < V_53 -> V_112 ; ++ V_7 ) {
struct V_32 * V_33 =
V_53 -> V_115 [ V_7 ] . V_121 ;
if ( V_33 -> V_75 . V_79 )
F_38 ( & V_33 -> V_75 . V_76 ) ;
}
F_9 ( & V_53 -> V_78 , V_39 ) ;
