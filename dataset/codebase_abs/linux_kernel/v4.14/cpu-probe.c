...
static inline unsigned int F_83 ( struct V_10 * V_11 )
{
unsigned int V_123 ;
F_84 ( V_106 , V_123 , V_133 ) ;
if ( V_123 & V_133 )
V_11 -> V_249 . V_250 |= F_85 ( 1 ) ;
return V_123 & V_133 ;
}
static inline unsigned int F_86 ( struct V_10 * V_11 )
{
unsigned int V_135 , V_251 ;
F_87 ( V_135 , V_135 , V_251 ,
V_133 | V_138 | V_140 |
V_146 ) ;
if ( V_135 & V_146 )
...
>> V_214 ;
if ( V_72 & V_133 )
V_11 -> V_249 . V_250 |= F_85 ( 5 ) ;
return V_72 & V_133 ;
}
static inline unsigned int F_91 ( struct V_10 * V_11 )
{
unsigned int V_218 , V_255 ;
F_87 ( V_218 , V_218 , V_255 ,
V_133 | V_227 | V_223 ) ;
if ( V_218 & V_223 )
...
static inline void F_93 ( struct V_10 * V_11 )
{
...
static inline void F_98 ( struct V_10 * V_11 )
{
if ( V_268 ) {
F_95 ( V_269 ) ;
F_43 () ;
V_11 -> V_270 = ( F_99 () & V_269 )
>> V_271 ;
F_95 ( 0 ) ;
}
}
...
static inline void F_104 ( struct V_10 * V_11 , unsigned int V_93 )
{
...
static inline void F_107 ( struct V_10 * V_11 , unsigned int V_93 )
{
V_11 -> V_360 = V_361 ;
switch ( V_11 -> V_83 & V_274 ) {
case V_365 :
...
static inline void F_117 ( struct V_10 * V_11 , unsigned int V_93 )
{
F_70 ( V_11 ) ;
V_11 -> V_35 &= ~ V_236 ;
F_71 ( ! F_118 ( V_466 ) || V_466 ) ;
switch ( V_11 -> V_83 & V_274 ) {
case V_467 :
V_11 -> V_107 = V_468 ;
V_11 -> V_360 = V_361 ;
...
static inline void F_119 ( struct V_10 * V_11 , int V_93 )
{
F_70 ( V_11 ) ;
if ( ( V_11 -> V_83 & V_274 ) == V_469 ) {
V_11 -> V_107 = V_415 ;
V_277 [ V_93 ] = L_111 ;
return;
}
...
V_11 -> V_360 = V_366 ;
V_11 -> V_17 = V_499 ;
V_11 -> V_23 = V_500 | V_33 | V_34 ;
V_11 -> V_83 = F_122 () ;
switch ( V_11 -> V_83 & V_501 ) {
case V_502 :
F_104 ( V_11 , V_93 ) ;
break;
case V_503 :
...
struct V_10 * V_11 = & V_81 ;
F_29 ( L_119 ,
F_121 () , V_11 -> V_83 , F_131 () ) ;
if ( V_11 -> V_35 & V_49 )
F_105 ( V_315 L_120 , V_11 -> V_2 ) ;
if ( V_524 )
F_29 ( L_121 , V_11 -> V_8 ) ;
}
void F_132 ( struct V_10 * V_530 , unsigned int V_531 )
{
F_65 ( V_531 > ( V_532 >>
V_533 ) ) ;
V_530 -> V_534 &= ~ V_532 ;
V_530 -> V_534 |= V_531 << V_533 ;
}
void F_82 ( struct V_10 * V_530 , unsigned int V_247 )
{
F_65 ( V_247 > ( V_535 >> V_536 ) ) ;
V_530 -> V_534 &= ~ V_535 ;
V_530 -> V_534 |= V_247 << V_536 ;
}
void F_133 ( struct V_10 * V_530 , unsigned int V_537 )
{
F_65 ( V_537 > ( V_538 >> V_539 ) ) ;
F_65 ( V_537 && ! F_134 ( V_540 ) &&
! F_134 ( V_541 ) ) ;
V_530 -> V_534 &= ~ V_538 ;
V_530 -> V_534 |= V_537 << V_539 ;
}
