...
static struct V_26 * F_25 ( T_5 V_16 , T_6 V_65 ,
T_6 V_52 )
{
struct V_26 * V_27 ;
unsigned int V_17 ;
...
if ( ! V_27 )
return - V_83 ;
if ( V_27 -> V_35 != V_84 && V_27 -> V_35 != V_41 ) {
F_23 ( L_12 ,
V_27 -> V_35 , V_84 , V_41 ) ;
V_63 = - V_85 ;
goto V_86;
...
V_16 = 0 ;
V_82 = sizeof( struct V_87 ) ;
if ( F_41 ( & V_79 , V_77 , V_82 ) ) {
V_63 = - V_88 ;
goto V_86;
}
if ( V_79 . V_9 != V_89 &&
