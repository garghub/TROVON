...
static int F_55 ( struct V_69 * V_23 )
{
...
static int F_58 ( struct V_69 * V_23 )
{
struct V_55 * V_55 = F_47 ( V_23 ) ;
int V_20 ;
F_3 ( V_23 , L_21 ) ;
...
{
struct V_55 * V_55 = F_47 ( & V_71 -> V_23 ) ;
int V_20 ;
V_20 = F_62 ( & V_71 -> V_23 , V_55 ) ;
if ( V_20 < 0 )
return - V_64 ;
V_20 = F_63 ( & V_71 -> V_23 , & V_72 ) ;
if ( V_20 < 0 )
goto V_73;
V_20 = F_64 ( & V_71 -> V_23 , & V_74 ,
V_75 , F_65 ( V_75 ) ) ;
if ( V_20 < 0 )
goto V_76;
return 0 ;
