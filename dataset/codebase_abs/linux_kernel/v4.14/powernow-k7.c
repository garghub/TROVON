...
static void F_10 ( unsigned int V_18 )
{
V_19 [ V_18 ] . V_20 = V_21 ;
}
static int F_11 ( unsigned char * V_22 )
{
unsigned int V_23 ;
unsigned int V_24 ;
T_1 V_25 , V_26 ;
...
static int F_19 ( struct V_47 * V_48 , unsigned int V_49 )
{
T_1 V_25 , V_26 ;
struct V_50 V_51 ;
union V_52 V_53 ;
...
static void F_30 ( struct V_88 * V_22 , unsigned int V_23 )
{
F_14 ( L_14 , V_23 , V_22 ) ;
F_14 ( L_15 ,
V_22 -> F_8 , V_22 -> V_1 , V_22 -> V_89 , V_22 -> V_90 ) ;
}
static int F_31 ( int V_89 , int V_90 )
{
struct V_91 * V_92 ;
struct V_88 * V_22 ;
...
static unsigned int F_34 ( unsigned int V_103 )
{
union V_52 V_53 ;
unsigned int V_54 ;
if ( V_103 )
...
static int F_35 ( const struct V_104 * V_105 )
{
F_29 ( L_30 ,
V_105 -> V_106 ) ;
F_29 ( L_31 ) ;
...
F_16 ( V_55 , V_53 . V_39 ) ;
F_37 () ;
V_4 = ( 10 * V_108 ) / V_30 [ V_53 . V_40 . V_56 ] ;
if ( ! V_4 ) {
F_29 ( L_33 ) ;
return - V_64 ;
}
...
V_32 / 1000 , V_33 / 1000 ) ;
V_48 -> V_113 . V_85 =
F_39 ( 2000000UL , V_4 , V_43 ) ;
return F_40 ( V_48 , V_19 ) ;
}
