...
V_193 -> V_205 = false ;
if ( V_8 -> V_77 -> V_208 )
V_8 -> V_77 -> V_208 ( V_193 ) ;
}
F_37 ( L_25 ,
V_193 , V_8 -> V_125 , F_126 ( V_193 -> V_206 . type ) ,
F_127 ( V_193 -> V_206 . V_209 ) , F_127 ( V_193 -> V_206 . V_210 ) ,
V_193 -> V_184 ) ;
F_35 ( V_193 -> V_211 . V_153 != F_127 ( V_193 -> V_206 . V_209 ) ) ;
F_35 ( V_193 -> V_184 != F_127 ( V_193 -> V_206 . V_192 ) ) ;
F_95 ( V_8 , sizeof ( V_212 ) , & V_212 ) ;
F_95 ( V_8 , sizeof( V_8 -> V_213 ) , & V_8 -> V_213 ) ;
F_95 ( V_8 , V_193 -> V_211 . V_153 , V_193 -> V_211 . V_154 ) ;
if ( V_193 -> V_214 )
F_95 ( V_8 , V_193 -> V_214 -> V_215 . V_153 ,
V_193 -> V_214 -> V_215 . V_154 ) ;
V_202 = F_128 ( 0 , & V_193 -> V_206 , F_129 ( struct V_216 , V_202 ) ) ;
V_8 -> V_126 -> V_206 . V_202 = F_130 ( V_202 ) ;
memcpy ( & V_8 -> V_213 , & V_8 -> V_126 -> V_206 , sizeof( V_8 -> V_213 ) ) ;
V_202 = F_128 ( 0 , V_193 -> V_211 . V_154 , V_193 -> V_211 . V_153 ) ;
V_8 -> V_126 -> V_194 . V_217 = F_130 ( V_202 ) ;
if ( V_193 -> V_214 ) {
V_202 = F_128 ( 0 , V_193 -> V_214 -> V_215 . V_154 ,
V_193 -> V_214 -> V_215 . V_153 ) ;
V_8 -> V_126 -> V_194 . V_218 = F_130 ( V_202 ) ;
} else
V_8 -> V_126 -> V_194 . V_218 = 0 ;
F_37 ( L_26 , V_46 ,
F_127 ( V_8 -> V_126 -> V_194 . V_217 ) ,
F_127 ( V_8 -> V_126 -> V_194 . V_218 ) ) ;
V_8 -> V_126 -> V_194 . V_9 = 0 ;
V_8 -> V_126 -> V_194 . V_219 = 0 ;
if ( V_193 -> V_184 ) {
...
struct V_221 V_222 ;
F_134 ( & V_222 ) ;
F_95 ( V_8 , sizeof( V_223 ) , & V_223 ) ;
F_135 ( & V_8 -> V_224 , & V_222 ) ;
F_95 ( V_8 , sizeof( V_8 -> V_224 ) ,
& V_8 -> V_224 ) ;
} else {
F_95 ( V_8 , sizeof( V_225 ) , & V_225 ) ;
}
F_5 ( V_8 , V_4 ) ;
}
static struct V_226 * F_136 ( struct V_7 * V_8 ,
int * V_227 )
{
struct V_226 * V_228 ;
if ( ! V_8 -> V_77 -> V_229 ) {
V_8 -> V_230 . V_231 = V_232 ;
V_8 -> V_230 . V_233 = 0 ;
return NULL ;
}
V_228 = V_8 -> V_77 -> V_229 ( V_8 , V_227 , V_8 -> V_234 ) ;
if ( F_137 ( V_228 ) )
return V_228 ;
V_8 -> V_235 = V_228 -> V_236 ;
V_8 -> V_237 = V_228 -> V_238 ;
return V_228 ;
}
static void F_138 ( struct V_7 * V_8 )
{
F_95 ( V_8 , strlen ( V_239 ) , V_239 ) ;
...
F_37 ( L_30 , V_8 ,
V_8 -> V_124 , V_146 , V_240 ) ;
V_8 -> V_230 . V_247 =
F_85 ( F_58 ( V_8 -> V_30 ) -> V_248 ) ;
V_8 -> V_230 . V_249 = F_130 ( V_250 ) ;
V_8 -> V_230 . V_124 = F_130 ( V_8 -> V_124 ) ;
V_8 -> V_230 . V_146 = F_130 ( V_146 ) ;
V_8 -> V_230 . V_251 = F_130 ( V_240 ) ;
V_8 -> V_230 . V_9 = 0 ;
V_227 = V_232 ;
V_228 = F_136 ( V_8 , & V_227 ) ;
if ( F_137 ( V_228 ) )
return F_140 ( V_228 ) ;
V_8 -> V_230 . V_231 = F_130 ( V_227 ) ;
V_8 -> V_230 . V_233 = V_228 ?
F_130 ( V_228 -> V_252 ) : 0 ;
F_95 ( V_8 , sizeof ( V_8 -> V_230 ) ,
& V_8 -> V_230 ) ;
if ( V_228 && V_228 -> V_252 )
F_95 ( V_8 , V_228 -> V_252 ,
V_228 -> V_253 ) ;
V_8 -> V_199 = 0 ;
F_5 ( V_8 , V_4 ) ;
return 0 ;
...
V_255 = F_143 ( V_99 ) ;
F_3 ( V_255 == NULL ) ;
V_202 = F_128 ( V_202 , V_255 + V_100 , V_101 ) ;
F_144 ( V_99 ) ;
return V_202 ;
}
...
struct V_157 * V_158 = & V_90 -> V_158 ;
bool V_256 = ! F_57 ( F_58 ( V_8 -> V_30 ) , V_257 ) ;
T_4 V_202 ;
F_37 ( L_33 , V_46 , V_8 , V_90 ) ;
if ( F_77 ( & V_90 -> V_151 ) )
return - V_258 ;
V_202 = V_256 ? F_127 ( V_90 -> V_194 . V_219 ) : 0 ;
while ( V_158 -> V_161 ) {
struct V_99 * V_99 ;
T_1 V_100 ;
T_1 V_101 ;
...
if ( V_69 <= 0 ) {
if ( V_256 )
V_90 -> V_194 . V_219 = F_130 ( V_202 ) ;
return V_69 ;
}
if ( V_256 && V_158 -> V_183 )
...
F_3 ( V_8 -> V_123 != NULL ) ;
V_8 -> V_260 = 0 ;
V_8 -> V_264 = V_8 -> V_265 = V_8 -> V_266 = 0 ;
return 0 ;
}
static int F_154 ( struct V_7 * V_8 ,
int V_267 , int V_114 , void * V_268 )
{
while ( V_8 -> V_260 < V_267 ) {
int V_269 = V_267 - V_8 -> V_260 ;
int V_270 = V_114 - V_269 ;
int V_69 = F_60 ( V_8 -> V_50 , V_268 + V_270 , V_269 ) ;
if ( V_69 <= 0 )
return V_69 ;
V_8 -> V_260 += V_69 ;
}
...
int V_267 ;
int V_69 ;
F_37 ( L_43 , V_8 , V_8 -> V_260 ) ;
V_114 = strlen ( V_239 ) ;
V_267 = V_114 ;
V_69 = F_154 ( V_8 , V_267 , V_114 , V_8 -> V_271 ) ;
if ( V_69 <= 0 )
goto V_254;
V_114 = sizeof ( V_8 -> V_272 ) ;
V_267 += V_114 ;
V_69 = F_154 ( V_8 , V_267 , V_114 , & V_8 -> V_272 ) ;
if ( V_69 <= 0 )
goto V_254;
V_114 = sizeof ( V_8 -> V_273 ) ;
V_267 += V_114 ;
V_69 = F_154 ( V_8 , V_267 , V_114 , & V_8 -> V_273 ) ;
if ( V_69 <= 0 )
goto V_254;
V_254:
return V_69 ;
...
int V_267 ;
int V_69 ;
F_37 ( L_44 , V_8 , V_8 -> V_260 ) ;
V_114 = sizeof ( V_8 -> V_274 ) ;
V_267 = V_114 ;
V_69 = F_154 ( V_8 , V_267 , V_114 , & V_8 -> V_274 ) ;
if ( V_69 <= 0 )
goto V_254;
V_114 = F_127 ( V_8 -> V_274 . V_233 ) ;
V_267 += V_114 ;
V_69 = F_154 ( V_8 , V_267 , V_114 , V_8 -> V_235 ) ;
if ( V_69 <= 0 )
goto V_254;
F_37 ( L_45 ,
V_8 , ( int ) V_8 -> V_274 . V_275 ,
F_127 ( V_8 -> V_274 . V_124 ) ,
F_127 ( V_8 -> V_274 . V_146 ) ) ;
V_254:
return V_69 ;
}
static int F_157 ( struct V_7 * V_8 )
{
if ( memcmp ( V_8 -> V_271 , V_239 , strlen ( V_239 ) ) ) {
F_29 ( L_46 ,
F_13 ( & V_8 -> V_66 . V_67 ) ) ;
V_8 -> V_276 = L_47 ;
return - 1 ;
...
struct V_277 * V_278 = & ( (struct V_16 * ) V_11 ) -> V_27 ;
switch ( V_11 -> V_21 ) {
case V_22 :
return V_33 -> V_279 == F_159 ( V_280 ) ;
case V_26 :
return F_160 ( V_278 ) ;
default:
return true ;
...
static void F_162 ( struct V_10 * V_11 , int V_281 )
{
switch ( V_11 -> V_21 ) {
case V_22 :
( (struct V_14 * ) V_11 ) -> V_25 = F_163 ( V_281 ) ;
break;
case V_26 :
( (struct V_16 * ) V_11 ) -> V_28 = F_163 ( V_281 ) ;
break;
}
}
static int F_164 ( const char * V_282 , T_1 V_86 , struct V_10 * V_11 ,
char V_283 , const char * * V_284 )
{
struct V_14 * V_15 = (struct V_14 * ) V_11 ;
struct V_16 * V_17 = (struct V_16 * ) V_11 ;
memset ( V_11 , 0 , sizeof( * V_11 ) ) ;
if ( F_165 ( V_282 , V_86 , ( V_285 * ) & V_15 -> V_24 . V_279 , V_283 , V_284 ) ) {
V_11 -> V_21 = V_22 ;
return 0 ;
}
if ( F_166 ( V_282 , V_86 , ( V_285 * ) & V_17 -> V_27 . V_286 , V_283 , V_284 ) ) {
V_11 -> V_21 = V_26 ;
return 0 ;
}
return - V_258 ;
}
static int F_167 ( const char * V_287 , T_1 V_288 ,
struct V_10 * V_11 , char V_283 , const char * * V_284 )
{
const char * V_267 , * V_289 ;
char * V_290 , * V_291 = NULL ;
int V_292 , V_69 ;
V_289 = memchr ( V_287 , V_283 , V_288 ) ;
V_290 = memchr ( V_287 , ':' , V_288 ) ;
if ( V_289 && V_290 )
V_267 = V_289 < V_290 ? V_289 : V_290 ;
else if ( ! V_289 && V_290 )
V_267 = V_290 ;
else {
V_267 = V_289 ;
...
if ( V_267 <= V_287 )
return - V_258 ;
V_292 = F_168 ( NULL , V_287 , V_267 - V_287 , NULL , & V_291 , NULL ) ;
if ( V_292 > 0 )
V_69 = F_164 ( V_291 , V_292 , V_11 , - 1 , NULL ) ;
else
V_69 = - V_293 ;
F_169 ( V_291 ) ;
* V_284 = V_267 ;
F_170 ( L_48 , ( int ) ( V_267 - V_287 ) , V_287 ,
V_69 , V_69 ? L_49 : F_13 ( V_11 ) ) ;
return V_69 ;
}
static inline int F_167 ( const char * V_287 , T_1 V_288 ,
struct V_10 * V_11 , char V_283 , const char * * V_284 )
{
return - V_258 ;
}
static int F_171 ( const char * V_287 , T_1 V_288 ,
struct V_10 * V_11 , char V_283 , const char * * V_284 )
{
int V_69 ;
V_69 = F_164 ( V_287 , V_288 , V_11 , V_283 , V_284 ) ;
if ( V_69 )
V_69 = F_167 ( V_287 , V_288 , V_11 , V_283 , V_284 ) ;
return V_69 ;
}
int F_172 ( const char * V_294 , const char * V_267 ,
struct V_135 * V_33 ,
int V_295 , int * V_296 )
{
int V_12 , V_69 = - V_258 ;
const char * V_281 = V_294 ;
F_37 ( L_50 , ( int ) ( V_267 - V_294 ) , V_294 ) ;
for ( V_12 = 0 ; V_12 < V_295 ; V_12 ++ ) {
const char * V_284 ;
...
V_69 = F_171 ( V_281 , V_267 - V_281 , V_11 , V_283 , & V_284 ) ;
if ( V_69 )
goto V_298;
V_69 = - V_258 ;
V_281 = V_284 ;
...
if ( V_281 < V_267 && * V_281 == ':' ) {
V_297 = 0 ;
V_281 ++ ;
while ( V_281 < V_267 && * V_281 >= '0' && * V_281 <= '9' ) {
V_297 = ( V_297 * 10 ) + ( * V_281 - '0' ) ;
V_281 ++ ;
}
if ( V_297 == 0 )
V_297 = V_299 ;
...
return 0 ;
V_298:
F_29 ( L_53 , ( int ) ( V_267 - V_294 ) , V_294 ) ;
return V_69 ;
}
...
F_174 ( & V_8 -> V_272 ) ;
F_174 ( & V_8 -> V_273 ) ;
if ( memcmp ( & V_8 -> V_66 , & V_8 -> V_272 ,
sizeof( V_8 -> V_66 ) ) != 0 &&
! ( F_158 ( & V_8 -> V_272 . V_67 ) &&
V_8 -> V_272 . V_300 == V_8 -> V_66 . V_300 ) ) {
F_175 ( L_55 ,
F_13 ( & V_8 -> V_66 . V_67 ) ,
( int ) F_127 ( V_8 -> V_66 . V_300 ) ,
F_13 ( & V_8 -> V_272 . V_67 ) ,
( int ) F_127 ( V_8 -> V_272 . V_300 ) ) ;
V_8 -> V_276 = L_56 ;
return - 1 ;
}
if ( F_158 ( & V_8 -> V_30 -> V_32 . V_33 . V_67 ) ) {
int V_297 = F_161 ( & V_8 -> V_30 -> V_32 . V_33 . V_67 ) ;
memcpy ( & V_8 -> V_30 -> V_32 . V_33 . V_67 ,
& V_8 -> V_273 . V_67 ,
sizeof( V_8 -> V_273 . V_67 ) ) ;
F_162 ( & V_8 -> V_30 -> V_32 . V_33 . V_67 , V_297 ) ;
F_16 ( V_8 -> V_30 ) ;
F_37 ( L_57 ,
...
{
V_172 V_301 = F_58 ( V_8 -> V_30 ) -> V_248 ;
V_172 V_302 = F_58 ( V_8 -> V_30 ) -> V_303 ;
V_172 V_304 = F_177 ( V_8 -> V_274 . V_247 ) ;
int V_69 ;
F_37 ( L_58 , V_8 , ( int ) V_8 -> V_261 ) ;
if ( V_8 -> V_235 ) {
V_69 = V_8 -> V_77 -> V_305 ( V_8 ) ;
if ( V_69 < 0 ) {
V_8 -> V_276 = L_59 ;
return V_69 ;
}
}
switch ( V_8 -> V_274 . V_275 ) {
case V_306 :
F_29 ( L_60
L_61 ,
F_178 ( V_8 -> V_137 ) ,
F_13 ( & V_8 -> V_66 . V_67 ) ,
V_301 , V_304 , V_304 & ~ V_301 ) ;
V_8 -> V_276 = L_62 ;
F_79 ( V_8 ) ;
return - 1 ;
case V_307 :
...
F_178 ( V_8 -> V_137 ) ,
F_13 ( & V_8 -> V_66 . V_67 ) ,
F_127 ( V_8 -> V_230 . V_251 ) ,
F_127 ( V_8 -> V_274 . V_251 ) ) ;
V_8 -> V_276 = L_65 ;
F_79 ( V_8 ) ;
return - 1 ;
case V_308 :
...
case V_312 :
F_37 ( L_71 ,
F_127 ( V_8 -> V_230 . V_124 ) ,
F_127 ( V_8 -> V_274 . V_124 ) ) ;
V_8 -> V_124 = F_127 ( V_8 -> V_274 . V_124 ) ;
F_94 ( V_8 ) ;
V_69 = F_139 ( V_8 ) ;
if ( V_69 < 0 )
return V_69 ;
...
V_8 -> V_56 = V_314 ;
V_8 -> V_234 = 0 ;
V_8 -> V_132 = F_127 ( V_8 -> V_274 . V_146 ) ;
V_8 -> V_124 ++ ;
V_8 -> V_188 = V_304 ;
F_37 ( L_75 ,
V_8 -> V_132 ,
...
F_35 ( V_8 -> V_124 !=
F_127 ( V_8 -> V_274 . V_124 ) ) ;
if ( V_8 -> V_274 . V_9 & V_315 )
F_5 ( V_8 , V_2 ) ;
V_8 -> V_139 = 0 ;
if ( V_8 -> V_274 . V_275 == V_262 ) {
F_132 ( V_8 ) ;
F_150 ( V_8 ) ;
} else {
F_151 ( V_8 ) ;
...
{
int V_114 = sizeof ( V_8 -> V_317 ) ;
int V_267 = V_114 ;
return F_154 ( V_8 , V_267 , V_114 , & V_8 -> V_317 ) ;
}
static void F_180 ( struct V_7 * V_8 )
{
struct V_35 * V_193 ;
V_172 V_318 = F_177 ( V_8 -> V_317 ) ;
V_172 V_207 ;
bool V_319 = ( V_8 -> V_261 == V_262 ) ;
struct V_119 * V_320 = V_319 ? & V_8 -> V_121 : & V_8 -> V_122 ;
while ( ! F_77 ( V_320 ) ) {
V_193 = F_78 ( V_320 , struct V_35 , V_119 ) ;
if ( V_319 && V_193 -> V_205 )
break;
V_207 = F_177 ( V_193 -> V_206 . V_207 ) ;
if ( V_207 > V_318 )
break;
F_37 ( L_78 , V_207 ,
F_126 ( V_193 -> V_206 . type ) , V_193 ) ;
V_193 -> V_321 = V_322 ;
F_73 ( V_193 ) ;
}
F_151 ( V_8 ) ;
...
struct V_87 * V_323 ,
unsigned int V_324 , T_4 * V_202 )
{
int V_69 , V_269 ;
F_3 ( ! V_323 ) ;
while ( V_323 -> V_153 < V_324 ) {
F_3 ( V_323 -> V_154 == NULL ) ;
V_269 = V_324 - V_323 -> V_153 ;
V_69 = F_60 ( V_8 -> V_50 , ( char * ) V_323 -> V_154 +
V_323 -> V_153 , V_269 ) ;
if ( V_69 <= 0 )
return V_69 ;
V_323 -> V_153 += V_69 ;
}
if ( V_323 -> V_153 == V_324 )
* V_202 = F_128 ( 0 , V_323 -> V_154 , V_323 -> V_153 ) ;
return 1 ;
}
...
int V_267 ;
int V_69 ;
unsigned int V_209 , V_210 , V_192 ;
bool V_256 = ! F_57 ( F_58 ( V_8 -> V_30 ) , V_257 ) ;
bool V_326 = ( V_8 -> V_188 & V_189 ) ;
V_172 V_207 ;
T_4 V_202 ;
F_37 ( L_79 , V_8 , V_193 ) ;
V_114 = sizeof ( V_8 -> V_327 ) ;
V_267 = V_114 ;
V_69 = F_154 ( V_8 , V_267 , V_114 , & V_8 -> V_327 ) ;
if ( V_69 <= 0 )
return V_69 ;
V_202 = F_128 ( 0 , & V_8 -> V_327 , F_129 ( struct V_216 , V_202 ) ) ;
if ( F_130 ( V_202 ) != V_8 -> V_327 . V_202 ) {
F_29 ( L_80 ,
V_202 , V_8 -> V_327 . V_202 ) ;
return - V_328 ;
}
V_209 = F_127 ( V_8 -> V_327 . V_209 ) ;
if ( V_209 > V_329 )
return - V_325 ;
V_210 = F_127 ( V_8 -> V_327 . V_210 ) ;
if ( V_210 > V_330 )
return - V_325 ;
V_192 = F_127 ( V_8 -> V_327 . V_192 ) ;
if ( V_192 > V_331 )
return - V_325 ;
V_207 = F_177 ( V_8 -> V_327 . V_207 ) ;
if ( ( V_332 ) V_207 - ( V_332 ) V_8 -> V_127 < 1 ) {
F_170 ( L_81 ,
F_178 ( V_8 -> V_137 ) ,
F_13 ( & V_8 -> V_66 . V_67 ) ,
V_207 , V_8 -> V_127 + 1 ) ;
V_8 -> V_260 = - V_209 - V_210 - V_192 -
F_120 ( V_8 ) ;
V_8 -> V_261 = V_263 ;
return 1 ;
} else if ( ( V_332 ) V_207 - ( V_332 ) V_8 -> V_127 > 1 ) {
F_29 ( L_82 ,
V_207 , V_8 -> V_127 + 1 ) ;
V_8 -> V_276 = L_83 ;
return - V_333 ;
...
if ( ! V_8 -> V_123 ) {
int V_156 = 0 ;
F_37 ( L_84 , V_8 -> V_327 . type ,
V_209 , V_192 ) ;
V_69 = F_184 ( V_8 , & V_156 ) ;
if ( V_69 < 0 )
return V_69 ;
F_3 ( ! V_8 -> V_123 ^ V_156 ) ;
if ( V_156 ) {
...
V_193 -> V_211 . V_153 = 0 ;
if ( V_193 -> V_214 )
V_193 -> V_214 -> V_215 . V_153 = 0 ;
if ( V_192 )
F_121 ( V_8 -> V_123 , V_192 ) ;
}
V_69 = F_181 ( V_8 , & V_193 -> V_211 , V_209 ,
& V_8 -> V_264 ) ;
if ( V_69 <= 0 )
return V_69 ;
if ( V_193 -> V_214 ) {
V_69 = F_181 ( V_8 , & V_193 -> V_214 -> V_215 ,
V_210 ,
& V_8 -> V_265 ) ;
if ( V_69 <= 0 )
return V_69 ;
...
V_114 = F_120 ( V_8 ) ;
V_267 += V_114 ;
V_69 = F_154 ( V_8 , V_267 , V_114 , & V_193 -> V_194 ) ;
if ( V_69 <= 0 )
return V_69 ;
if ( ! V_326 ) {
...
F_37 ( L_86 ,
V_193 , V_209 , V_193 -> V_194 . V_217 , V_210 ,
V_193 -> V_194 . V_218 , V_192 , V_193 -> V_194 . V_219 ) ;
if ( V_8 -> V_264 != F_127 ( V_193 -> V_194 . V_217 ) ) {
F_29 ( L_87 ,
V_193 , V_8 -> V_264 , V_193 -> V_194 . V_217 ) ;
return - V_328 ;
}
if ( V_8 -> V_265 != F_127 ( V_193 -> V_194 . V_218 ) ) {
F_29 ( L_88 ,
V_193 , V_8 -> V_265 , V_193 -> V_194 . V_218 ) ;
return - V_328 ;
}
if ( V_256 &&
( V_193 -> V_194 . V_9 & V_259 ) == 0 &&
V_8 -> V_266 != F_127 ( V_193 -> V_194 . V_219 ) ) {
F_29 ( L_89 , V_193 ,
V_8 -> V_266 , F_127 ( V_193 -> V_194 . V_219 ) ) ;
return - V_328 ;
}
if ( V_326 && V_8 -> V_77 -> V_334 &&
V_8 -> V_77 -> V_334 ( V_193 ) ) {
F_29 ( L_90 , V_193 ) ;
return - V_328 ;
}
return 1 ;
...
V_8 -> V_123 = NULL ;
if ( V_8 -> V_137 . type == 0 )
V_8 -> V_137 = V_90 -> V_206 . V_335 ;
V_8 -> V_127 ++ ;
F_83 ( & V_8 -> V_130 ) ;
F_37 ( L_91 ,
V_90 , F_177 ( V_90 -> V_206 . V_207 ) ,
F_178 ( V_90 -> V_206 . V_335 ) ,
F_126 ( V_90 -> V_206 . type ) ,
F_186 ( F_126 ( V_90 -> V_206 . type ) ) ,
F_127 ( V_90 -> V_206 . V_209 ) ,
F_127 ( V_90 -> V_206 . V_192 ) ,
V_8 -> V_264 , V_8 -> V_265 , V_8 -> V_266 ) ;
V_8 -> V_77 -> V_336 ( V_8 , V_90 ) ;
F_81 ( & V_8 -> V_130 ) ;
}
static int F_187 ( struct V_7 * V_8 )
{
struct V_337 V_338 ;
T_1 V_114 = sizeof( V_338 ) ;
int V_69 = F_154 ( V_8 , V_114 , V_114 , & V_338 ) ;
if ( V_69 <= 0 )
return V_69 ;
F_188 ( & V_8 -> V_339 , & V_338 ) ;
F_151 ( V_8 ) ;
return 1 ;
}
...
F_35 ( V_8 -> V_56 != V_314 ) ;
if ( V_8 -> V_260 < 0 ) {
static char V_85 [ V_343 ] ;
int V_156 = F_99 ( ( int ) sizeof ( V_85 ) , - V_8 -> V_260 ) ;
F_37 ( L_103 , V_156 , - V_8 -> V_260 ) ;
...
if ( V_8 -> V_261 == V_263 ) {
V_69 = F_60 ( V_8 -> V_50 , & V_8 -> V_261 , 1 ) ;
if ( V_69 <= 0 )
goto V_254;
F_37 ( L_104 , ( int ) V_8 -> V_261 ) ;
switch ( V_8 -> V_261 ) {
case V_344 :
F_153 ( V_8 ) ;
break;
...
return V_69 ;
V_348:
F_29 ( L_108 , ( int ) V_8 -> V_261 ) ;
V_8 -> V_276 = L_109 ;
V_69 = - 1 ;
goto V_254;
}
static int F_191 ( struct V_7 * V_8 , unsigned long V_139 )
{
if ( ! V_8 -> V_77 -> V_349 ( V_8 ) ) {
F_37 ( L_110 , V_46 , V_8 ) ;
return - V_350 ;
}
if ( ! F_192 ( V_39 , & V_8 -> V_142 , V_139 ) ) {
F_37 ( L_111 , V_46 , V_8 ) ;
V_8 -> V_77 -> V_351 ( V_8 ) ;
return - V_352 ;
}
...
static bool F_194 ( struct V_7 * V_8 )
{
if ( ! F_9 ( V_8 , V_5 ) )
return false ;
#define CASE ( T_5 ) \
...
if ( ! F_9 ( V_8 , V_6 ) )
return false ;
V_69 = F_191 ( V_8 , F_196 ( V_8 -> V_139 ) ) ;
if ( V_69 ) {
F_37 ( L_116 , V_46 ,
V_8 , V_8 -> V_139 ) ;
F_3 ( V_69 == - V_350 ) ;
...
static void V_143 ( struct V_361 * V_142 )
{
struct V_7 * V_8 = F_198 ( V_142 , struct V_7 ,
V_142 . V_142 ) ;
bool V_360 ;
F_81 ( & V_8 -> V_130 ) ;
while ( true ) {
...
F_175 ( L_126 , F_178 ( V_8 -> V_137 ) ,
F_13 ( & V_8 -> V_66 . V_67 ) , V_8 -> V_276 ) ;
V_8 -> V_276 = NULL ;
F_35 ( V_8 -> V_56 != V_340 &&
V_8 -> V_56 != V_311 &&
V_8 -> V_56 != V_314 ) ;
...
if ( V_8 -> V_139 == 0 )
V_8 -> V_139 = V_363 ;
else if ( V_8 -> V_139 < V_364 )
V_8 -> V_139 *= 2 ;
F_5 ( V_8 , V_6 ) ;
F_44 ( V_8 ) ;
}
}
void F_201 ( struct V_29 * V_30 ,
struct V_135 * V_365 )
{
F_202 ( & V_30 -> V_145 ) ;
if ( V_365 )
V_30 -> V_32 . V_33 = * V_365 ;
V_30 -> V_32 . V_33 . type = 0 ;
F_203 ( & V_30 -> V_32 . V_33 . V_300 , sizeof( V_30 -> V_32 . V_33 . V_300 ) ) ;
F_16 ( V_30 ) ;
F_204 ( & V_30 -> V_53 , 0 ) ;
F_205 ( & V_30 -> V_70 , F_206 ( V_366 -> V_367 -> V_368 ) ) ;
F_37 ( L_113 , V_46 , V_30 ) ;
}
void F_207 ( struct V_29 * V_30 )
{
F_208 ( F_52 ( & V_30 -> V_70 ) ) ;
}
static void F_209 ( struct V_35 * V_90 , struct V_7 * V_8 )
{
if ( V_90 -> V_8 )
V_90 -> V_8 -> V_77 -> V_351 ( V_90 -> V_8 ) ;
V_90 -> V_8 = V_8 ? V_8 -> V_77 -> V_349 ( V_8 ) : NULL ;
F_3 ( V_90 -> V_8 != V_8 ) ;
}
...
void F_211 ( struct V_7 * V_8 , struct V_35 * V_90 )
{
V_90 -> V_206 . V_335 = V_8 -> V_30 -> V_32 . V_287 ;
F_3 ( V_90 -> V_211 . V_153 != F_127 ( V_90 -> V_206 . V_209 ) ) ;
V_90 -> V_205 = true ;
F_81 ( & V_8 -> V_130 ) ;
if ( V_8 -> V_56 == V_131 ) {
F_37 ( L_130 , V_8 , V_90 ) ;
...
F_209 ( V_90 , V_8 ) ;
F_3 ( ! F_77 ( & V_90 -> V_119 ) ) ;
F_212 ( & V_90 -> V_119 , & V_8 -> V_121 ) ;
F_37 ( L_131 , V_90 ,
F_178 ( V_8 -> V_137 ) , F_126 ( V_90 -> V_206 . type ) ,
F_186 ( F_126 ( V_90 -> V_206 . type ) ) ,
F_127 ( V_90 -> V_206 . V_209 ) ,
F_127 ( V_90 -> V_206 . V_210 ) ,
F_127 ( V_90 -> V_206 . V_192 ) ) ;
F_210 ( V_8 ) ;
F_83 ( & V_8 -> V_130 ) ;
if ( F_11 ( V_8 , V_4 ) == 0 )
...
F_81 ( & V_8 -> V_130 ) ;
if ( V_8 -> V_123 == V_90 ) {
unsigned int V_209 = F_127 ( V_8 -> V_327 . V_209 ) ;
unsigned int V_210 = F_127 ( V_8 -> V_327 . V_210 ) ;
unsigned int V_192 = F_127 ( V_8 -> V_327 . V_192 ) ;
...
F_134 ( & V_222 ) ;
F_217 ( V_369 , & V_370 ) ;
V_370 = F_218 ( V_8 -> V_339 , V_370 ) ;
return F_219 ( & V_222 , & V_370 ) >= 0 ;
}
return false ;
}
static struct V_38 * F_220 ( enum V_371 type )
{
struct V_38 * V_151 ;
if ( F_35 ( ! F_221 ( type ) ) )
return NULL ;
V_151 = F_222 ( V_37 , V_74 ) ;
if ( ! V_151 )
return NULL ;
V_151 -> type = type ;
F_89 ( & V_151 -> V_186 ) ;
...
static void F_223 ( struct V_38 * V_151 )
{
if ( ! V_151 )
return;
...
void F_226 ( struct V_35 * V_90 , struct V_99 * * V_170 ,
T_1 V_101 , T_1 V_171 )
{
struct V_38 * V_151 ;
F_3 ( ! V_170 ) ;
...
F_212 ( & V_151 -> V_186 , & V_90 -> V_151 ) ;
V_90 -> V_184 += V_101 ;
}
void F_227 ( struct V_35 * V_90 ,
struct V_177 * V_178 )
{
struct V_38 * V_151 ;
F_3 ( ! V_178 ) ;
...
void F_228 ( struct V_35 * V_90 , struct V_159 * V_159 ,
T_1 V_101 )
{
struct V_38 * V_151 ;
F_3 ( ! V_159 ) ;
...
struct V_35 * F_229 ( int type , int V_209 , T_6 V_9 ,
bool V_372 )
{
struct V_35 * V_193 ;
V_193 = F_222 ( V_34 , V_9 ) ;
if ( V_193 == NULL )
goto V_254;
V_193 -> V_206 . type = F_230 ( type ) ;
V_193 -> V_206 . V_373 = F_230 ( V_374 ) ;
V_193 -> V_206 . V_209 = F_130 ( V_209 ) ;
F_89 ( & V_193 -> V_119 ) ;
F_231 ( & V_193 -> V_375 ) ;
F_89 ( & V_193 -> V_151 ) ;
if ( V_209 ) {
V_193 -> V_211 . V_154 = F_232 ( V_209 , V_9 ) ;
if ( V_193 -> V_211 . V_154 == NULL ) {
F_37 ( L_138 ,
V_209 ) ;
goto V_376;
}
} else {
V_193 -> V_211 . V_154 = NULL ;
}
V_193 -> V_377 = V_193 -> V_211 . V_153 = V_209 ;
F_37 ( L_139 , V_193 , V_209 ) ;
return V_193 ;
V_376:
F_75 ( V_193 ) ;
V_254:
...
static int F_233 ( struct V_7 * V_8 , struct V_35 * V_90 )
{
int type = F_126 ( V_90 -> V_206 . type ) ;
int V_210 = F_127 ( V_90 -> V_206 . V_210 ) ;
F_37 ( L_141 , V_90 , type ,
F_186 ( type ) , V_210 ) ;
F_3 ( ! V_210 ) ;
F_3 ( V_90 -> V_214 ) ;
V_90 -> V_214 = F_234 ( V_210 , V_74 ) ;
if ( ! V_90 -> V_214 )
return - V_36 ;
return 0 ;
}
static int F_184 ( struct V_7 * V_8 , int * V_156 )
{
struct V_216 * V_206 = & V_8 -> V_327 ;
int V_210 = F_127 ( V_206 -> V_210 ) ;
struct V_35 * V_90 ;
int V_69 = 0 ;
F_3 ( V_8 -> V_123 != NULL ) ;
F_3 ( ! V_8 -> V_77 -> V_378 ) ;
F_83 ( & V_8 -> V_130 ) ;
V_90 = V_8 -> V_77 -> V_378 ( V_8 , V_206 , V_156 ) ;
F_81 ( & V_8 -> V_130 ) ;
if ( V_8 -> V_56 != V_314 ) {
if ( V_90 )
F_75 ( V_90 ) ;
...
memcpy ( & V_8 -> V_123 -> V_206 , & V_8 -> V_327 , sizeof( V_8 -> V_327 ) ) ;
if ( V_210 && ! V_8 -> V_123 -> V_214 ) {
V_69 = F_233 ( V_8 , V_8 -> V_123 ) ;
if ( V_69 < 0 ) {
F_75 ( V_8 -> V_123 ) ;
V_8 -> V_123 = NULL ;
}
...
static void F_235 ( struct V_35 * V_193 )
{
F_37 ( L_113 , V_46 , V_193 ) ;
F_236 ( V_193 -> V_211 . V_154 ) ;
F_225 ( V_34 , V_193 ) ;
}
static void F_237 ( struct V_375 * V_375 )
{
struct V_35 * V_193 = F_198 ( V_375 , struct V_35 , V_375 ) ;
struct V_38 * V_151 , * V_379 ;
F_37 ( L_113 , V_46 , V_193 ) ;
...
F_239 (data, next, &m->data, links) {
F_74 ( & V_151 -> V_186 ) ;
F_223 ( V_151 ) ;
}
V_193 -> V_184 = 0 ;
if ( V_193 -> V_380 )
F_240 ( V_193 -> V_380 , V_193 ) ;
else
F_235 ( V_193 ) ;
}
...
F_37 ( L_143 , V_46 , V_90 ,
F_241 ( & V_90 -> V_375 ) ) ;
F_243 ( & V_90 -> V_375 , F_237 ) ;
}
void F_244 ( struct V_35 * V_90 )
{
F_245 ( L_144 , V_90 ,
V_90 -> V_377 , V_90 -> V_184 ) ;
F_246 ( V_381 , L_145 ,
V_382 , 16 , 1 ,
& V_90 -> V_206 , sizeof( V_90 -> V_206 ) , true ) ;
F_246 ( V_381 , L_146 ,
V_382 , 16 , 1 ,
V_90 -> V_211 . V_154 , V_90 -> V_211 . V_153 , true ) ;
if ( V_90 -> V_214 )
F_246 ( V_381 , L_147 ,
V_382 , 16 , 1 ,
V_90 -> V_214 -> V_215 . V_154 ,
V_90 -> V_214 -> V_215 . V_153 , true ) ;
F_246 ( V_381 , L_148 ,
V_382 , 16 , 1 ,
