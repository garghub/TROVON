...
return F_47 ( V_121 , 1 , 2 , V_122 ) ;
}
static int F_48 ( struct V_118 * V_119 , struct V_62 * V_63 )
{
struct V_5 * V_6 = F_49 ( V_119 ) ;
unsigned char V_16 = V_119 -> V_46 & 0xff ;
F_8 ( V_6 ) ;
V_63 -> V_64 . V_123 . V_124 [ 0 ] = F_5 ( V_6 , V_11 ) & V_16 ? 1 : 0 ;
F_11 ( V_6 ) ;
return 0 ;
}
...
if ( V_119 -> V_46 & ( 1 << 31 ) )
return - V_126 ;
V_125 = V_63 -> V_64 . V_123 . V_124 [ 0 ] ? V_16 : 0 ;
F_8 ( V_6 ) ;
V_68 = F_5 ( V_6 , V_11 ) ;
V_125 |= V_68 & ~ V_16 ;
F_2 ( V_6 , V_11 , V_125 ) ;
...
F_18 ( V_6 -> V_31 ) ;
V_63 -> V_64 . V_123 . V_124 [ 0 ] = V_4 & V_127 ? 1 : 0 ;
return 0 ;
}
...
V_29 = ( V_4 & ~ V_127 ) | ( V_63 -> V_64 . V_123 . V_124 [ 0 ] ? V_127 : 0 ) ;
...
static int F_53 ( struct V_118 * V_119 , struct V_62 * V_63 )
{
struct V_5 * V_6 = F_49 ( V_119 ) ;
struct V_27 * V_28 = V_6 -> V_28 ;
int V_128 = F_54 ( V_119 , & V_63 -> V_79 ) ;
unsigned char V_4 ;
if ( F_14 ( V_128 < 0 || V_128 > 7 ) )
return 0 ;
F_15 ( V_6 -> V_31 ) ;
...
V_63 -> V_64 . V_123 . V_124 [ 0 ] = V_4 & ( 1 << V_128 ) ? 0 : 1 ;
F_18 ( V_6 -> V_31 ) ;
return 0 ;
}
...
V_29 = ( V_4 & ~ ( 1 << V_128 ) ) | ( V_63 -> V_64 . V_123 . V_124 [ 0 ] ? 0 : ( 1 << V_128 ) ) ;
...
struct V_5 * V_6 = F_49 ( V_119 ) ;
struct V_27 * V_28 = V_6 -> V_28 ;
int V_129 = V_119 -> V_46 & 0xff ;
int V_130 = ( V_119 -> V_46 >> 8 ) & 1 ;
unsigned char V_4 [ 2 ] ;
F_15 ( V_6 -> V_31 ) ;
...
F_18 ( V_6 -> V_31 ) ;
V_4 [ 0 ] = ( V_4 [ V_129 >> 3 ] >> ( V_129 & 7 ) ) & 0x01 ;
if ( V_130 )
V_4 [ 0 ] ^= 0x01 ;
V_63 -> V_64 . integer . V_64 [ 0 ] = V_4 [ 0 ] ;
return 0 ;
}
static int F_57 ( struct V_118 * V_119 , struct V_62 * V_63 )
{
struct V_5 * V_6 = F_49 ( V_119 ) ;
struct V_27 * V_28 = V_6 -> V_28 ;
int V_129 = V_119 -> V_46 & 0xff ;
...
V_29 [ V_129 >> 3 ] = V_4 [ V_129 >> 3 ] & ~ ( 1 << ( V_129 & 7 ) ) ;
if ( V_130 ) {
if ( ! V_63 -> V_64 . integer . V_64 [ 0 ] )
V_29 [ V_129 >> 3 ] |= ( 1 << ( V_129 & 7 ) ) ;
} else {
if ( V_63 -> V_64 . integer . V_64 [ 0 ] )
V_29 [ V_129 >> 3 ] |= ( 1 << ( V_129 & 7 ) ) ;
}
V_69 = ( V_4 [ V_129 >> 3 ] != V_29 [ V_129 >> 3 ] ) ;
if ( V_69 &&
...
static int F_58 ( struct V_5 * V_6 , unsigned char V_131 )
{
unsigned char V_132 ;
struct V_27 * V_28 = V_6 -> V_28 ;
F_15 ( V_6 -> V_31 ) ;
V_132 = V_131 ;
F_17 ( V_28 -> V_32 [ V_88 ] , & V_132 , 1 ) ;
V_132 = 0 ;
if ( F_16 ( V_28 -> V_32 [ V_88 ] , & V_132 , 1 ) != 1 ) {
F_18 ( V_6 -> V_31 ) ;
...
static int F_42 ( struct V_5 * V_6 , unsigned char V_131 , unsigned char V_4 )
{
unsigned char V_53 [ 2 ] ;
struct V_27 * V_28 = V_6 -> V_28 ;
F_15 ( V_6 -> V_31 ) ;
...
static int F_60 ( struct V_118 * V_119 , struct V_62 * V_63 )
{
struct V_5 * V_6 = F_49 ( V_119 ) ;
int V_129 = V_119 -> V_46 & 0xff ;
int V_130 = ( V_119 -> V_46 >> 8 ) & 1 ;
...
V_29 ^= ( 1 << V_129 ) ;
if ( V_4 != V_29 ) {
F_42 ( V_6 , V_133 , ( unsigned char ) V_29 ) ;
return 1 ;
}
return 0 ;
}
...
static int F_63 ( struct V_118 * V_119 , struct V_62 * V_63 )
{
struct V_5 * V_6 = F_49 ( V_119 ) ;
int V_4 , V_29 ;
if ( ( V_4 = F_58 ( V_6 , V_133 ) ) < 0 )
...
switch ( V_6 -> V_17 . V_18 ) {
case V_19 :
for ( V_134 = 0 ; V_134 < F_67 ( V_135 ) ; V_134 ++ ) {
V_80 = F_68 ( V_6 -> V_35 , F_69 ( & V_135 [ V_134 ] , V_6 ) ) ;
if ( V_80 < 0 )
return V_80 ;
}
break;
...
case V_56 :
case V_57 :
V_80 = F_68 ( V_6 -> V_35 , F_69 ( & V_136 , V_6 ) ) ;
if ( V_80 < 0 )
return V_80 ;
V_80 = F_68 ( V_6 -> V_35 , F_69 ( & V_137 , V_6 ) ) ;
if ( V_80 < 0 )
return V_80 ;
break;
case V_60 :
for ( V_134 = 0 ; V_134 < F_67 ( V_138 ) ; V_134 ++ ) {
V_80 = F_68 ( V_6 -> V_35 , F_69 ( & V_138 [ V_134 ] , V_6 ) ) ;
if ( V_80 < 0 )
return V_80 ;
}
break;
case V_21 :
for ( V_134 = 0 ; V_134 < F_67 ( V_139 ) ; V_134 ++ ) {
V_80 = F_68 ( V_6 -> V_35 , F_69 ( & V_139 [ V_134 ] , V_6 ) ) ;
if ( V_80 < 0 )
return V_80 ;
}
break;
