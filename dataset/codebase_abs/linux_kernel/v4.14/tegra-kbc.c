...
F_18 ( V_15 ) ;
F_17 ( V_15 , false ) ;
F_10 ( V_15 -> V_80 , V_15 -> V_22 + V_81 ) ;
V_76 = F_24 ( V_15 -> V_76 , V_82 ) ;
V_17 = F_25 ( V_76 ) ;
V_17 |= F_26 ( 1 ) ;
V_17 |= V_39 ;
V_17 |= V_83 ;
...
static int F_33 ( struct V_1 * V_86 )
{
struct V_14 * V_15 = F_34 ( V_86 ) ;
return F_19 ( V_15 ) ;
}
static void F_35 ( struct V_1 * V_86 )
{
struct V_14 * V_15 = F_34 ( V_86 ) ;
return F_29 ( V_15 ) ;
}
...
* V_87 = 0 ;
for ( V_7 = 0 ; V_7 < V_60 ; V_7 ++ ) {
const struct V_88 * V_71 = & V_15 -> V_71 [ V_7 ] ;
switch ( V_71 -> type ) {
case V_72 :
...
{
struct V_90 * V_91 = V_15 -> V_86 -> V_92 ;
T_1 V_93 ;
int V_7 ;
T_1 V_87 = 0 ;
T_1 V_94 = 0 ;
...
int V_97 ;
int V_77 ;
if ( ! F_39 ( V_91 , L_4 , & V_93 ) )
V_15 -> V_76 = V_93 ;
if ( ! F_39 ( V_91 , L_5 , & V_93 ) )
V_15 -> V_80 = V_93 ;
if ( F_40 ( V_91 , L_6 , NULL ) )
V_15 -> V_31 = true ;
if ( F_41 ( V_91 , L_7 ) ||
F_41 ( V_91 , L_8 ) )
V_15 -> V_56 = true ;
if ( ! F_42 ( V_91 , L_9 , & V_97 ) ) {
F_37 ( V_15 -> V_86 , L_10 ) ;
return - V_98 ;
}
V_87 = V_97 / sizeof( T_1 ) ;
if ( ! F_42 ( V_91 , L_11 , & V_97 ) ) {
F_37 ( V_15 -> V_86 , L_12 ) ;
return - V_98 ;
}
V_94 = V_97 / sizeof( T_1 ) ;
if ( V_87 > V_15 -> V_57 -> V_58 ) {
F_37 ( V_15 -> V_86 ,
L_13 ) ;
return - V_99 ;
}
if ( V_94 > V_15 -> V_57 -> V_89 ) {
F_37 ( V_15 -> V_86 ,
L_14 ) ;
return - V_99 ;
}
if ( ! F_42 ( V_91 , L_15 , & V_97 ) ) {
F_37 ( V_15 -> V_86 , L_16 ) ;
return - V_98 ;
}
if ( ! V_87 || ! V_94 || ( ( V_87 + V_94 ) > V_60 ) ) {
F_37 ( V_15 -> V_86 ,
L_17 ) ;
return - V_99 ;
}
...
V_15 -> V_71 [ V_96 [ V_7 ] ] . type = V_72 ;
V_15 -> V_71 [ V_96 [ V_7 ] ] . V_73 = V_7 ;
}
for ( V_7 = 0 ; V_7 < V_94 ; V_7 ++ ) {
V_15 -> V_71 [ V_95 [ V_7 ] ] . type = V_74 ;
...
V_109 = F_45 ( V_110 , & V_102 -> V_86 ) ;
V_15 = F_46 ( & V_102 -> V_86 , sizeof( * V_15 ) , V_111 ) ;
if ( ! V_15 ) {
F_37 ( & V_102 -> V_86 , L_20 ) ;
return - V_112 ;
}
V_15 -> V_86 = & V_102 -> V_86 ;
...
if ( ! F_36 ( V_15 , & V_87 ) )
return - V_99 ;
V_15 -> V_48 = F_48 ( V_102 , 0 ) ;
if ( V_15 -> V_48 < 0 ) {
F_37 ( & V_102 -> V_86 , L_21 ) ;
return - V_113 ;
}
V_15 -> V_35 = F_49 ( & V_102 -> V_86 ) ;
if ( ! V_15 -> V_35 ) {
F_37 ( & V_102 -> V_86 , L_22 ) ;
return - V_112 ;
}
F_50 ( & V_15 -> V_46 , F_11 , ( unsigned long ) V_15 ) ;
V_104 = F_51 ( V_102 , V_114 , 0 ) ;
V_15 -> V_22 = F_52 ( & V_102 -> V_86 , V_104 ) ;
if ( F_53 ( V_15 -> V_22 ) )
return F_54 ( V_15 -> V_22 ) ;
V_15 -> V_78 = F_55 ( & V_102 -> V_86 , NULL ) ;
if ( F_53 ( V_15 -> V_78 ) ) {
F_37 ( & V_102 -> V_86 , L_23 ) ;
return F_54 ( V_15 -> V_78 ) ;
}
V_15 -> V_79 = F_56 ( & V_102 -> V_86 , L_24 ) ;
if ( F_53 ( V_15 -> V_79 ) ) {
F_37 ( & V_102 -> V_86 , L_25 ) ;
return F_54 ( V_15 -> V_79 ) ;
}
V_76 = F_24 ( V_15 -> V_76 , V_82 ) ;
V_106 = ( V_115 + V_76 ) * V_87 ;
V_15 -> V_45 = V_116 + V_106 + V_15 -> V_80 ;
V_15 -> V_45 = F_57 ( V_15 -> V_45 , V_117 ) ;
V_15 -> V_35 -> V_118 = V_102 -> V_118 ;
V_15 -> V_35 -> V_119 . V_120 = V_121 ;
V_15 -> V_35 -> V_86 . V_122 = & V_102 -> V_86 ;
V_15 -> V_35 -> V_123 = F_33 ;
V_15 -> V_35 -> V_124 = F_35 ;
if ( V_15 -> V_125 && V_15 -> V_30 )
V_107 *= 2 ;
V_105 = F_58 ( V_15 -> V_125 , NULL ,
V_107 ,
V_15 -> V_57 -> V_89 ,
V_15 -> V_28 , V_15 -> V_35 ) ;
if ( V_105 ) {
F_37 ( & V_102 -> V_86 , L_26 ) ;
return V_105 ;
}
F_59 ( V_126 , V_15 -> V_35 -> V_127 ) ;
F_60 ( V_15 -> V_35 , V_12 , V_13 ) ;
F_61 ( V_15 -> V_35 , V_15 ) ;
V_105 = F_62 ( & V_102 -> V_86 , V_15 -> V_48 , F_16 ,
V_128 , V_102 -> V_118 , V_15 ) ;
if ( V_105 ) {
F_37 ( & V_102 -> V_86 , L_27 ) ;
return V_105 ;
}
F_30 ( V_15 -> V_48 ) ;
V_105 = F_63 ( V_15 -> V_35 ) ;
if ( V_105 ) {
F_37 ( & V_102 -> V_86 , L_28 ) ;
return V_105 ;
}
F_64 ( V_102 , V_15 ) ;
F_65 ( & V_102 -> V_86 , V_15 -> V_56 ) ;
return 0 ;
}
static void F_66 ( struct V_14 * V_15 , bool V_37 )
{
T_1 V_17 ;
V_17 = F_6 ( V_15 -> V_22 + V_38 ) ;
if ( V_37 )
...
static int F_67 ( struct V_130 * V_86 )
{
struct V_101 * V_102 = F_68 ( V_86 ) ;
struct V_14 * V_15 = F_69 ( V_102 ) ;
F_70 ( & V_15 -> V_35 -> V_131 ) ;
if ( F_71 ( & V_102 -> V_86 ) ) {
F_30 ( V_15 -> V_48 ) ;
F_31 ( & V_15 -> V_46 ) ;
F_9 ( V_15 , false ) ;
...
F_74 ( & V_15 -> V_35 -> V_131 ) ;
return 0 ;
}
static int F_75 ( struct V_130 * V_86 )
{
struct V_101 * V_102 = F_68 ( V_86 ) ;
struct V_14 * V_15 = F_69 ( V_102 ) ;
int V_105 = 0 ;
