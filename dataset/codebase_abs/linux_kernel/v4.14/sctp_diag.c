...
static int F_44 ( struct V_65 * V_121 , void * V_122 )
{
...
static int F_45 ( struct V_65 * V_121 , void * V_122 )
{
struct V_79 * V_80 = V_121 -> V_6 -> V_80 ;
struct V_124 * V_125 = V_122 ;
struct V_3 * V_4 = V_80 -> V_17 . V_4 ;
...
static int F_46 ( struct V_79 * V_80 , void * V_122 )
{
struct V_124 * V_125 = V_122 ;
struct V_3 * V_4 = V_80 -> V_17 . V_4 ;
struct V_54 * V_55 = V_125 -> V_55 ;
...
struct V_143 * V_144 = F_47 ( V_4 ) ;
int V_129 = 0 ;
if ( ! F_48 ( F_34 ( V_4 ) , V_127 ) )
goto V_130;
if ( V_137 -> args [ 4 ] < V_137 -> args [ 1 ] )
goto V_20;
if ( ! ( V_2 -> V_145 & V_146 ) && ! F_49 ( & V_80 -> V_140 ) )
goto V_20;
if ( V_2 -> V_141 != V_142 &&
V_4 -> V_26 != V_2 -> V_141 )
goto V_20;
...
if ( V_86 -> V_118 )
F_50 ( V_4 , V_86 -> V_6 , V_86 -> V_118 ) ;
}
static int F_51 ( struct V_54 * V_126 ,
...
static void F_54 ( struct V_54 * V_55 , struct V_136 * V_137 ,
...
. V_137 = V_137 ,
. V_2 = V_2 ,
. V_78 = F_52 ( V_137 -> V_55 , V_153 ) ,
} ;
int V_160 = V_137 -> args [ 2 ] ;
if ( V_137 -> args [ 0 ] == 0 ) {
if ( ! ( V_145 & V_146 ) )
goto V_161;
if ( F_55 ( F_46 , & V_125 ) )
