...
F_29 ( V_10 ) ;
V_10 -> V_62 [ 0 ] -> V_65 = 0 ;
V_10 -> V_62 [ 0 ] -> V_66 = 0xffff ;
V_42 = V_10 -> V_62 [ 1 ] -> V_65 ;
V_43 = V_10 -> V_62 [ 1 ] -> V_66 + 1 - V_42 ;
if ( V_42 < 0x1000000UL )
V_42 = 0x1000000UL ;
V_44 = ( 0x100000000UL - V_43 ) & - V_42 ;
V_10 -> V_62 [ 1 ] -> V_65 = V_44 ;
V_10 -> V_62 [ 1 ] -> V_66 = 0xffffffffUL ;
if ( F_30 ( & V_51 , V_10 -> V_62 [ 1 ] ) < 0 )
F_13 ( V_67 L_6 ) ;
if ( V_44 < V_45 )
V_45 = V_44 ;
if ( V_45 > V_2 . V_68 ) {
