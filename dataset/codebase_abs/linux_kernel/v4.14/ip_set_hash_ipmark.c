...
static inline bool
F_24 ( const struct V_48 * V_2 ,
const struct V_48 * V_3 ,
T_1 * V_4 )
{
return F_25 ( & V_2 -> V_5 . V_49 , & V_3 -> V_5 . V_49 ) &&
V_2 -> V_6 == V_3 -> V_6 ;
}
static bool
F_26 ( struct V_7 * V_8 ,
...
static inline void
F_28 ( struct V_48 * V_13 ,
const struct V_48 * V_14 )
{
}
static int
F_29 ( struct V_15 * V_16 , const struct V_7 * V_8 ,
const struct V_17 * V_18 ,
enum V_19 V_20 , struct V_21 * V_22 )
{
...
V_27 . V_6 = V_8 -> V_6 ;
V_27 . V_6 &= V_24 -> V_30 ;
F_30 ( V_8 , V_22 -> V_31 & V_32 , & V_27 . V_5 . V_49 ) ;
return V_25 ( V_16 , & V_27 , & V_29 , & V_22 -> V_29 , V_22 -> V_33 ) ;
}
static int
F_31 ( struct V_15 * V_16 , struct V_34 * V_35 [] ,
enum V_19 V_20 , T_1 * V_36 , T_1 V_31 , bool V_37 )
{
const struct V_50 * V_24 = V_16 -> V_9 ;
T_2 V_25 = V_16 -> V_26 -> V_20 [ V_20 ] ;
