...
int V_150 ;
F_11 ( & V_18 -> V_59 ) ;
( void ) F_85 ( V_20 , V_27 -> V_33 , V_151 ) ;
V_150 = F_88 ( V_2 ) ;
F_13 ( & V_18 -> V_59 ) ;
return V_150 ;
}
static int F_89 ( struct V_1 * V_2 ,
char * V_152 , T_6 V_153 )
{
struct V_17 * V_18 = F_10 ( V_2 ) ;
struct V_23 * V_24 = V_18 -> V_25 ;
struct V_26 * V_27 = V_24 -> V_27 ;
int V_150 ;
V_150 = snprintf ( V_152 , V_153 , L_3 , V_27 -> V_33 - 1 ) ;
if ( V_150 >= V_153 )
return - V_63 ;
return 0 ;
}
...
{
struct V_17 * V_18 = F_10 ( V_2 ) ;
if ( ! F_91 ( V_155 -> V_156 . V_157 ) ||
V_155 -> V_156 . V_158 )
return - V_63 ;
if ( V_155 -> V_159 ) {
struct V_19 * V_20 = V_18 -> V_21 -> V_18 . V_22 ;
V_2 = F_92 ( V_20 ) ;
return V_2 -> V_160 -> V_161 ( V_2 , V_162 ,
V_155 ) ;
}
switch ( V_155 -> V_163 ) {
case V_164 :
return F_93 ( V_18 , V_155 ) ;
case V_165 :
return F_94 ( V_18 , V_155 ) ;
case V_166 :
return F_95 ( V_18 , V_155 ) ;
default:
return - V_63 ;
}
}
static int F_96 ( struct V_1 * V_2 , enum V_167 type ,
void * V_168 )
{
switch ( type ) {
case V_162 :
return F_90 ( V_2 , V_168 ) ;
default:
return - V_63 ;
}
}
bool F_97 ( struct V_17 * V_18 )
{
struct V_19 * V_20 = V_18 -> V_21 -> V_18 . V_22 ;
struct V_23 * V_24 = V_18 -> V_25 ;
struct V_26 * V_27 ;
if ( ! F_98 ( V_18 -> V_21 , V_169 ) )
return false ;
V_27 = V_24 -> V_27 ;
if ( V_20 -> V_66 == V_170 &&
V_27 && V_27 -> V_33 == V_171 )
return true ;
return false ;
}
static bool F_99 ( struct V_17 * V_18 )
{
struct V_23 * V_24 = V_18 -> V_25 ;
struct V_26 * V_27 = V_24 -> V_27 ;
if ( V_27 && V_27 -> V_33 != V_171 )
return true ;
return false ;
}
bool F_100 ( const struct V_1 * V_2 , int V_172 )
{
struct V_17 * V_18 = F_10 ( V_2 ) ;
switch ( V_172 ) {
case V_173 :
if ( F_99 ( V_18 ) || F_97 ( V_18 ) )
return true ;
}
return false ;
}
...
{
struct V_17 * V_18 = F_10 ( V_2 ) ;
struct V_40 * V_174 = & V_18 -> V_34 . V_42 ;
V_34 -> V_36 = V_174 -> V_36 ;
V_34 -> V_38 = V_174 -> V_38 ;
V_34 -> V_37 = V_174 -> V_37 ;
V_34 -> V_39 = V_174 -> V_39 ;
V_34 -> V_175 = V_174 -> V_176 ;
return 0 ;
}
int F_102 ( int V_172 , const struct V_1 * V_2 ,
void * V_177 )
{
switch ( V_172 ) {
case V_173 :
...
static void
F_103 ( struct V_1 * V_2 , struct V_28 * V_34 )
{
struct V_17 * V_18 = F_10 ( V_2 ) ;
memcpy ( V_34 , & V_18 -> V_34 . V_35 , sizeof( * V_34 ) ) ;
}
static void F_104 ( struct V_179 * V_21 ,
struct V_180 * V_55 )
{
T_5 V_181 = F_98 ( V_21 , V_182 ) ?
V_183 :
V_184 ;
V_55 -> V_185 = V_186 ;
V_55 -> V_187 = V_188 ;
V_55 -> V_189 = V_190 ;
V_55 -> V_191 = F_98 ( V_21 , V_192 ) ;
F_105 ( V_55 , V_181 ) ;
V_55 -> V_193 = F_106 ( V_21 ) ;
V_55 -> V_56 = 1 ;
V_55 -> V_194 = V_195 ;
F_107 ( V_21 , & V_55 -> V_196 ) ;
}
static void F_108 ( struct V_1 * V_83 )
{
V_83 -> V_160 = & V_197 ;
V_83 -> V_198 = 15 * V_199 ;
V_83 -> V_200 = & V_201 ;
...
V_83 -> V_202 = & V_203 ;
#endif
V_83 -> V_204 |= V_205 | V_206 | V_207 ;
V_83 -> V_208 |= V_206 ;
F_110 ( V_83 ) ;
}
static void F_111 ( struct V_179 * V_21 ,
struct V_1 * V_83 ,
...
V_18 -> V_25 = V_25 ;
F_112 ( & V_18 -> V_59 ) ;
F_62 ( & V_18 -> V_211 , V_212 ) ;
V_18 -> V_48 . V_55 . V_213 = V_210 -> V_214 ( V_21 ) ;
V_18 -> V_215 = V_216 ;
F_104 ( V_21 , & V_18 -> V_48 . V_55 ) ;
F_108 ( V_83 ) ;
}
...
V_32 = F_127 ( V_18 ) ;
if ( V_32 ) {
F_128 ( V_18 -> V_21 , L_4 , V_32 ) ;
return V_32 ;
}
return 0 ;
}
static int F_129 ( struct V_179 * V_21 )
{
#define F_130 1
return F_130 ;
}
...
static int
F_133 ( struct V_19 * V_20 , struct V_26 * V_27 )
{
struct V_23 * V_24 ;
struct V_1 * V_83 ;
int V_32 ;
...
if ( ! V_24 )
return - V_78 ;
V_83 = F_134 ( V_20 -> V_2 , & V_226 , V_24 ) ;
if ( ! V_83 ) {
F_6 ( L_5 ,
V_27 -> V_33 ) ;
F_21 ( V_24 ) ;
...
static void
F_139 ( struct V_19 * V_20 , struct V_26 * V_27 )
{
...
int V_230 = F_142 ( V_21 ) ;
int V_33 ;
T_5 V_231 [ V_73 ] ;
F_143 ( V_21 , 0 , V_231 ) ;
for ( V_33 = 1 ; V_33 < V_230 ; V_33 ++ ) {
struct V_26 V_27 ;
V_27 . V_232 = F_133 ;
V_27 . V_233 = F_139 ;
V_27 . V_33 = V_33 ;
F_17 ( V_27 . V_74 , V_231 ) ;
F_144 ( V_20 , V_33 , & V_27 ) ;
}
}
