...
V_12 ) ;
V_2 -> V_3 = F_8 ( V_2 -> V_3 ) ;
V_2 -> V_15 = F_8 ( V_2 -> V_15 ) ;
return V_7 ;
}
static void F_9 ( const struct V_16 * V_8 , struct V_1 * V_2 )
{
F_3 ( V_8 , L_4 , V_2 -> V_17 ) ;
F_3 ( V_8 , L_5 , V_2 -> V_3 ) ;
F_3 ( V_8 , L_6 , V_2 -> V_15 ) ;
}
static T_2 F_10 ( struct V_16 * V_8 , struct V_18 * V_19 ,
char * V_20 )
{
struct V_1 * V_2 ;
