...
T_1 V_226 ;
F_66 ( V_225 , L_36 , V_51 -> V_74 ) ;
if ( V_51 -> V_2 -> V_214 & ( 1 << V_227 ) ) {
F_66 ( V_225 , L_37 ) ;
switch ( V_51 -> V_2 -> V_210 ) {
case V_228 : F_66 ( V_225 , L_38 ) ; break;
case V_211 : F_66 ( V_225 , L_39 ) ; break;
case V_229 : F_66 ( V_225 , L_40 ) ; break;
default: F_66 ( V_225 , L_41 ) ; break;
}
F_66 ( V_225 , L_42 ) ;
...
F_66 ( V_225 , L_43 , V_233 ) ;
F_66 ( V_225 , L_44 , V_231 ) ;
F_66 ( V_225 , L_45 , V_235 ) ;
}
}
}
...
V_204 = V_267 [ V_19 ] + V_67 ;
snprintf ( V_266 , sizeof( V_266 ) , L_52 , V_268 [ V_19 ] ? V_268 [ V_19 ] : L_53 , V_67 ) ;
V_12 = F_82 ( & V_18 -> V_19 , V_204 , V_266 , V_269 ,
0 , & V_73 ) ;
if ( V_12 < 0 ) {
F_2 ( & V_18 -> V_19 , L_54 , V_67 ) ;
F_51 ( V_2 ) ;
return V_12 ;
}
strcpy ( V_73 -> V_270 , V_254 ) ;
snprintf ( V_73 -> V_271 , sizeof( V_73 -> V_271 ) ,
L_55 , V_67 ) ;
snprintf ( V_73 -> V_272 , sizeof( V_73 -> V_272 ) ,
L_56 ,
V_2 -> V_215 [ 0 ] . V_255 , V_2 -> V_215 [ 1 ] . V_255 , V_2 -> V_213 , V_67 ) ;
