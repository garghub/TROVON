...
( const struct V_1 * ) & V_60 -> V_96 . V_49 ) )
goto V_94;
V_91 = V_81 -> V_18 ;
if ( V_91 == V_18 ) {
V_54 -> V_97 ++ ;
...
V_93 = F_65 ( V_81 ) ;
if ( ! V_45 -> V_99 && V_45 -> V_79 > V_93 ) {
F_57 ( V_45 ) -> V_100 -> V_101 ( V_81 , NULL , V_45 , V_93 ) ;
if ( V_45 -> V_71 == F_66 ( V_102 ) ) {
if ( V_93 < V_103 )
V_93 = V_103 ;
F_67 ( V_45 , V_104 , 0 , V_93 ) ;
} else {
F_68 ( V_45 , V_105 , V_106 ,
F_69 ( V_93 ) ) ;
}
return - V_107 ;
}
V_32 = F_70 ( V_10 -> V_7 , V_45 -> V_108 , V_45 ) ;
if ( F_71 ( V_32 ) == 0 ) {
...
break;
case F_66 ( V_115 ) :
F_75 ( V_45 , & V_88 , V_116 ) ;
memset ( F_77 ( V_45 ) , 0 , sizeof( * F_77 ( V_45 ) ) ) ;
break;
default:
goto V_114;
}
V_88 . V_117 = F_45 ( V_10 -> V_15 . V_118 ) ;
...
static int F_78 ( struct V_44 * V_45 , struct V_121 * V_122 ,
T_5 type , T_5 V_123 , int V_124 , T_6 V_125 )
{
T_6 V_126 ;
T_7 V_66 ;
struct V_59 * V_60 ;
...
const struct V_46 * V_133 = ( const struct V_46 * ) V_45 -> V_134 ;
int V_71 = V_133 -> V_135 ;
V_10 = F_4 ( F_19 ( V_45 -> V_18 ) , & V_133 -> V_49 , & V_133 -> V_48 ) ;
if ( ! V_10 )
return - 1 ;
V_66 = F_45 ( V_10 -> V_15 . V_118 ) ;
switch ( V_71 ) {
case V_136 :
V_128 = (struct V_127 * ) ( V_45 -> V_134 + V_124 ) ;
V_126 = V_128 -> V_126 ;
break;
case V_137 :
V_130 = (struct V_129 * ) ( V_45 -> V_134 + V_124 ) ;
V_126 = V_130 -> V_126 ;
break;
case V_138 :
V_132 = (struct V_131 * ) ( V_45 -> V_134 + V_124 ) ;
V_126 = F_69 ( F_79 ( V_132 -> V_139 ) ) ;
break;
default:
return 0 ;
}
...
type != V_140 )
return 0 ;
V_60 = F_80 ( V_7 , V_66 , ( const T_3 * ) & V_133 -> V_49 ,
V_126 , V_71 , V_86 ) ;
if ( ! V_60 )
return 0 ;
if ( type == V_140 )
F_81 ( V_45 , V_7 , V_45 -> V_18 -> V_141 , 0 ,
F_82 ( V_7 , NULL ) ) ;
else
F_83 ( V_45 , V_7 , V_125 , 0 , 0 , F_82 ( V_7 , NULL ) ) ;
F_84 ( V_60 ) ;
return 0 ;
}
...
memcpy ( V_18 -> V_142 , & V_23 -> V_16 , sizeof( struct V_1 ) ) ;
memcpy ( V_18 -> V_143 , & V_23 -> V_17 , sizeof( struct V_1 ) ) ;
V_23 -> V_19 &= ~ ( V_144 | V_145 |
V_146 ) ;
V_23 -> V_19 |= F_86 ( V_10 , & V_23 -> V_16 , & V_23 -> V_17 ) ;
if ( V_23 -> V_19 & V_144 && V_23 -> V_19 & V_145 )
V_18 -> V_19 |= V_147 ;
else
V_18 -> V_19 &= ~ V_147 ;
}
...
V_10 -> V_15 . V_118 = V_23 -> V_118 ;
V_10 -> V_15 . V_50 = V_23 -> V_50 ;
V_10 -> V_15 . V_149 = V_23 -> V_149 ;
F_88 ( & V_10 -> V_150 ) ;
F_85 ( V_10 ) ;
return 0 ;
}
...
static void
F_92 ( struct V_22 * V_23 , const struct V_151 * V_152 )
{
V_23 -> V_16 = V_152 -> V_16 ;
V_23 -> V_17 = V_152 -> V_17 ;
V_23 -> V_148 = V_152 -> V_148 ;
V_23 -> V_74 = V_152 -> V_74 ;
V_23 -> V_118 = V_152 -> V_118 ;
V_23 -> V_50 = V_152 -> V_50 ;
memcpy ( V_23 -> V_36 , V_152 -> V_36 , sizeof( V_152 -> V_36 ) ) ;
}
static void
F_93 ( struct V_151 * V_152 , const struct V_22 * V_23 )
{
V_152 -> V_16 = V_23 -> V_16 ;
V_152 -> V_17 = V_23 -> V_17 ;
V_152 -> V_148 = V_23 -> V_148 ;
V_152 -> V_74 = V_23 -> V_74 ;
V_152 -> V_118 = V_23 -> V_118 ;
if ( V_152 -> V_74 )
V_152 -> V_153 |= V_154 ;
if ( V_152 -> V_118 )
V_152 -> V_155 |= V_154 ;
V_152 -> V_50 = V_23 -> V_50 ;
memcpy ( V_152 -> V_36 , V_23 -> V_36 , sizeof( V_152 -> V_36 ) ) ;
}
static int
F_94 ( struct V_30 * V_18 , struct V_156 * V_157 , int V_158 )
{
int V_32 = 0 ;
struct V_151 V_23 ;
struct V_22 V_159 ;
...
case V_160 :
if ( V_18 == V_12 -> V_43 ) {
if ( F_95 ( & V_23 , V_157 -> V_161 . V_162 , sizeof( V_23 ) ) ) {
V_32 = - V_163 ;
break;
}
F_92 ( & V_159 , & V_23 ) ;
V_10 = F_27 ( V_7 , & V_159 , 0 ) ;
} else {
...
V_10 = F_18 ( V_18 ) ;
F_93 ( & V_23 , & V_10 -> V_15 ) ;
if ( F_96 ( V_157 -> V_161 . V_162 , & V_23 , sizeof( V_23 ) ) )
V_32 = - V_163 ;
break;
case V_164 :
case V_165 :
V_32 = - V_75 ;
if ( ! F_97 ( V_7 -> V_166 , V_167 ) )
break;
V_32 = - V_163 ;
if ( F_95 ( & V_23 , V_157 -> V_161 . V_162 , sizeof( V_23 ) ) )
break;
...
break;
F_92 ( & V_159 , & V_23 ) ;
V_10 = F_27 ( V_7 , & V_159 , V_158 == V_164 ) ;
if ( V_18 != V_12 -> V_43 && V_158 == V_165 ) {
if ( V_10 ) {
if ( V_10 -> V_18 != V_18 ) {
V_32 = - V_168 ;
break;
...
V_18 -> V_175 = F_15 ;
V_18 -> type = V_176 ;
V_18 -> V_177 = V_178 + sizeof( struct V_46 ) ;
V_18 -> V_93 = V_179 ;
V_18 -> V_180 = V_103 ;
V_18 -> V_181 = V_182 ;
V_18 -> V_19 |= V_183 ;
V_18 -> V_184 = sizeof( struct V_1 ) ;
F_99 ( V_18 ) ;
V_18 -> V_185 = V_186 ;
F_100 ( V_18 -> V_187 ) ;
}
...
static int F_105 ( struct V_189 * V_190 [] , struct V_189 * V_134 [] ,
struct V_191 * V_192 )
{
return 0 ;
}
static void F_106 ( struct V_189 * V_134 [] ,
struct V_22 * V_15 )
{
...
return;
if ( V_134 [ V_193 ] )
V_15 -> V_148 = F_107 ( V_134 [ V_193 ] ) ;
if ( V_134 [ V_194 ] )
V_15 -> V_16 = F_108 ( V_134 [ V_194 ] ) ;
if ( V_134 [ V_195 ] )
V_15 -> V_17 = F_108 ( V_134 [ V_195 ] ) ;
if ( V_134 [ V_196 ] )
V_15 -> V_74 = F_109 ( V_134 [ V_196 ] ) ;
if ( V_134 [ V_197 ] )
V_15 -> V_118 = F_109 ( V_134 [ V_197 ] ) ;
if ( V_134 [ V_198 ] )
V_15 -> V_149 = F_107 ( V_134 [ V_198 ] ) ;
}
static int F_110 ( struct V_7 * V_199 , struct V_30 * V_18 ,
struct V_189 * V_190 [] , struct V_189 * V_134 [] ,
struct V_191 * V_192 )
{
struct V_7 * V_7 = F_19 ( V_18 ) ;
struct V_6 * V_200 ;
V_200 = F_18 ( V_18 ) ;
F_106 ( V_134 , & V_200 -> V_15 ) ;
V_200 -> V_15 . V_50 = V_51 ;
if ( F_27 ( V_7 , & V_200 -> V_15 , 0 ) )
return - V_168 ;
return F_17 ( V_18 ) ;
}
static void F_111 ( struct V_30 * V_18 , struct V_201 * V_202 )
{
struct V_7 * V_7 = F_19 ( V_18 ) ;
struct V_11 * V_12 = F_5 ( V_7 , V_13 ) ;
if ( V_18 != V_12 -> V_43 )
...
static int F_113 ( struct V_30 * V_18 , struct V_189 * V_190 [] ,
struct V_189 * V_134 [] ,
struct V_191 * V_192 )
{
struct V_6 * V_10 ;
...
struct V_22 * V_203 = & V_63 -> V_15 ;
if ( F_117 ( V_45 , V_193 , V_203 -> V_148 ) ||
F_118 ( V_45 , V_194 , & V_203 -> V_16 ) ||
F_118 ( V_45 , V_195 , & V_203 -> V_17 ) ||
F_119 ( V_45 , V_196 , V_203 -> V_74 ) ||
F_119 ( V_45 , V_197 , V_203 -> V_118 ) ||
F_117 ( V_45 , V_198 , V_203 -> V_149 ) )
goto V_204;
return 0 ;
V_204:
return - V_107 ;
...
struct V_6 * V_10 ;
F_121 ( V_205 ) ;
for ( V_24 = 0 ; V_24 < V_206 ; V_24 ++ ) {
V_10 = F_13 ( V_12 -> V_207 [ V_24 ] ) ;
while ( V_10 ) {
F_112 ( V_10 -> V_18 , & V_205 ) ;
V_10 = F_13 ( V_10 -> V_28 ) ;
}
}
...
goto V_212;
V_210 = L_5 ;
V_32 = F_130 ( & V_213 , V_136 ) ;
if ( V_32 < 0 )
goto V_214;
V_32 = F_130 ( & V_215 , V_137 ) ;
if ( V_32 < 0 )
goto V_216;
V_32 = F_130 ( & V_217 , V_138 ) ;
if ( V_32 < 0 )
goto V_218;
V_210 = L_6 ;
V_32 = F_131 ( & V_34 ) ;
