...
V_69 -> V_3 . V_77 = F_18 ;
V_69 -> V_3 . V_78 = F_20 ;
V_70 = F_28 ( V_3 -> V_20 , V_50 ,
0 ,
0 , V_79 | V_80 , 0 ) ;
if ( V_70 )
return V_70 ;
{
struct V_68 * V_69 = V_50 -> V_75 ;
int V_62 , V_81 ;
for ( V_81 = 0 ; V_81 < V_30 ; V_81 ++ ) {
V_62 = V_3 -> V_17 + V_81 ;
F_29 ( V_62 , & V_69 -> V_3 , V_69 -> V_82 ) ;
F_30 ( V_62 , V_50 ) ;
F_31 ( V_62 , V_79 | V_80 ) ;
}
V_50 -> V_83 = V_62 - V_50 -> V_17 ;
}
return 0 ;
}
static int F_32 ( struct V_84 * V_20 )
{
int V_62 , V_35 ;
struct V_85 * V_86 ;
struct V_87 * V_88 ;
struct V_2 * V_3 ;
struct V_89 * V_90 ;
V_86 = * (struct V_85 * * ) F_33 ( & V_20 -> V_20 ) ;
V_88 = F_33 ( & V_86 -> V_20 ) ;
if ( V_88 == NULL )
F_34 ( & V_20 -> V_20 , L_4 ) ;
F_22 ( L_5 , V_88 ) ;
V_90 = F_35 ( V_20 , V_91 , 0 ) ;
V_3 = F_36 ( & V_20 -> V_20 , sizeof( * V_3 ) , V_92 ) ;
if ( ! V_3 )
return - V_74 ;
V_3 -> V_20 = & V_20 -> V_20 ;
V_3 -> V_72 = F_37 ( & V_20 -> V_20 , V_90 ) ;
if ( F_38 ( V_3 -> V_72 ) )
return F_39 ( V_3 -> V_72 ) ;
for ( V_62 = 0 ; V_62 < V_65 ; V_62 ++ ) {
V_3 -> V_5 [ V_62 ] = V_3 -> V_72 + V_62 * 4096 ;
...
F_13 ( V_3 , V_62 , V_88 -> V_93 [ V_62 ] ) ;
V_35 = F_41 ( & V_20 -> V_20 , - 1 , 384 ,
V_30 , V_94 ) ;
if ( V_35 < 0 ) {
F_42 ( & V_20 -> V_20 , L_6 ,
- V_35 ) ;
...
if ( V_35 )
return V_35 ;
V_35 = F_43 ( & V_20 -> V_20 , V_86 -> V_52 , F_23 ,
V_95 , V_71 , V_3 ) ;
if ( V_35 < 0 ) {
F_34 ( & V_20 -> V_20 , L_7 ,
- V_35 ) ;
...
V_35 = F_44 ( & V_20 -> V_20 , & V_3 -> V_8 , V_3 ) ;
if ( V_35 < 0 ) {
F_34 ( & V_20 -> V_20 , L_8 ,
- V_35 ) ;
return V_35 ;
