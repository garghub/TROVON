...
T_1 F_17 ( struct V_1 * V_2 , T_1 V_34 , T_1 * V_8 )
{
T_1 V_35 = 0 , V_32 = 0 , V_23 = 0 ;
T_2 V_31 = 0 ;
T_1 V_33 ;
T_1 V_9 = 0 ;
T_1 V_36 [ V_37 ] ;
...
T_1 F_21 ( struct V_1 * V_2 , const T_1 V_34 ,
...
if ( ( V_7 + V_49 ) > V_54 )
return false ;
if ( F_10 ( V_2 , & V_34 ) && V_34 ) {
for ( V_18 = 0 ; V_18 < V_49 ; V_18 ++ )
V_8 [ V_18 ] = 0xFF ;
return V_16 ;
}
V_34 = ( V_7 >> 3 ) & 0xF ;
V_16 = F_17 ( V_2 , V_34 , V_52 ) ;
V_18 = V_7 & 0x7 ;
V_53 = 0 ;
do {
for (; V_18 < V_37 ; V_18 ++ ) {
