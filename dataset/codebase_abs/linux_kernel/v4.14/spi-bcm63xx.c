...
static T_4 F_28 ( struct V_7 * V_8 )
{
struct V_1 * V_2 = F_13 ( V_8 -> V_11 ) ;
return V_2 -> V_61 ;
}
...
V_86 = F_30 ( V_87 , V_20 -> V_84 ) ;
if ( ! V_86 )
return - V_62 ;
V_77 = V_86 -> V_88 ;
F_31 ( V_20 -> V_84 , L_6 , & V_82 ) ;
if ( V_82 > V_83 ) {
F_32 ( V_20 , L_7 ,
V_82 ) ;
V_82 = V_83 ;
...
V_79 = - 1 ;
} else if ( V_74 -> V_89 -> V_90 ) {
const struct V_91 * V_86 = V_74 -> V_89 ;
V_77 = ( const unsigned long * ) V_86 -> V_90 ;
V_79 = V_92 ;
} else {
return - V_62 ;
}
...
F_39 ( V_74 , V_11 ) ;
V_2 -> V_74 = V_74 ;
V_76 = F_40 ( V_74 , V_94 , 0 ) ;
V_2 -> V_4 = F_41 ( & V_74 -> V_20 , V_76 ) ;
if ( F_35 ( V_2 -> V_4 ) ) {
V_81 = F_36 ( V_2 -> V_4 ) ;
goto V_95;
}
...
V_2 -> V_80 = V_80 ;
V_2 -> V_5 = V_77 ;
V_2 -> V_61 = V_2 -> V_5 [ V_96 ] ;
V_81 = F_42 ( & V_74 -> V_20 , V_67 , F_26 , 0 ,
V_74 -> V_97 , V_11 ) ;
if ( V_81 ) {
F_23 ( V_20 , L_12 ) ;
goto V_95;
}
V_11 -> V_20 . V_84 = V_20 -> V_84 ;
V_11 -> V_79 = V_79 ;
V_11 -> V_98 = V_82 ;
V_11 -> V_99 = F_21 ;
V_11 -> V_100 = V_101 ;
...
V_11 -> V_104 = F_28 ;
V_11 -> V_105 = true ;
V_2 -> V_40 = V_2 -> V_5 [ V_106 ] ;
V_2 -> V_43 = V_2 -> V_5 [ V_107 ] ;
V_2 -> V_34 = ( T_1 * ) ( V_2 -> V_4 + V_2 -> V_5 [ V_108 ] ) ;
V_2 -> V_53 = ( const T_1 * ) ( V_2 -> V_4 + V_2 -> V_5 [ V_109 ] ) ;
V_81 = F_44 ( V_2 -> V_80 ) ;
if ( V_81 )
goto V_95;
F_7 ( V_2 , V_71 , V_70 ) ;
...
{
struct V_54 * V_11 = F_50 ( V_74 ) ;
struct V_1 * V_2 = F_13 ( V_11 ) ;
F_7 ( V_2 , 0 , V_30 ) ;
F_47 ( V_2 -> V_80 ) ;
return 0 ;
}
static int F_51 ( struct V_78 * V_20 )
{
struct V_54 * V_11 = F_52 ( V_20 ) ;
struct V_1 * V_2 = F_13 ( V_11 ) ;
F_53 ( V_11 ) ;
F_47 ( V_2 -> V_80 ) ;
return 0 ;
}
static int F_54 ( struct V_78 * V_20 )
{
struct V_54 * V_11 = F_52 ( V_20 ) ;
struct V_1 * V_2 = F_13 ( V_11 ) ;
int V_81 ;
