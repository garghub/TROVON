...
if ( V_24 )
goto V_152;
V_142 = F_91 ( V_131 , & V_144 ) ;
F_92 ( & V_87 -> V_147 ) ;
F_100 ( & V_133 -> V_90 , & V_87 -> V_147 ) ;
V_143 = F_104 () ||
F_105 ( V_124 , V_153 ) ;
if ( ! V_154 && ! V_143 ) {
F_45 ( L_4 ,
...
if ( F_105 ( V_124 , V_156 ) )
V_87 -> V_25 |= V_157 ;
F_66 (d, &iommu->domain_list, next) {
if ( V_88 -> V_87 -> V_158 == V_87 -> V_87 -> V_158 &&
V_88 -> V_25 == V_87 -> V_25 ) {
F_106 ( V_87 -> V_87 , V_131 ) ;
if ( ! F_103 ( V_88 -> V_87 , V_131 ) ) {
F_100 ( & V_133 -> V_90 , & V_88 -> V_147 ) ;
F_107 ( V_87 -> V_87 ) ;
F_15 ( V_87 ) ;
F_54 ( & V_3 -> V_78 ) ;
return 0 ;
...
static void * F_116 ( unsigned long V_160 )
{
struct V_2 * V_3 ;
...
static void F_120 ( struct V_86 * V_87 , bool V_164 )
{
struct V_130 * V_133 , * V_165 ;
...
unsigned int V_167 , unsigned long V_160 )
{
struct V_2 * V_3 = V_70 ;
unsigned long V_168 ;
if ( V_167 == V_169 ) {
...
struct V_172 V_173 ;
V_168 = F_124 ( struct V_172 , V_174 ) ;
if ( F_125 ( & V_173 , ( void V_175 * ) V_160 , V_168 ) )
return - V_176 ;
if ( V_173 . V_177 < V_168 )
return - V_75 ;
V_173 . V_49 = V_178 ;
V_173 . V_174 = F_65 ( V_3 ) ;
return F_126 ( ( void V_175 * ) V_160 , & V_173 , V_168 ) ?
- V_176 : 0 ;
} else if ( V_167 == V_179 ) {
struct V_112 V_113 ;
T_5 V_102 = V_115 |
V_114 ;
V_168 = F_124 ( struct V_112 , V_5 ) ;
if ( F_125 ( & V_113 , ( void V_175 * ) V_160 , V_168 ) )
return - V_176 ;
if ( V_113 . V_177 < V_168 || V_113 . V_49 & ~ V_102 )
return - V_75 ;
return F_79 ( V_3 , & V_113 ) ;
} else if ( V_167 == V_180 ) {
struct V_100 V_101 ;
long V_24 ;
V_168 = F_124 ( struct V_100 , V_5 ) ;
if ( F_125 ( & V_101 , ( void V_175 * ) V_160 , V_168 ) )
return - V_176 ;
if ( V_101 . V_177 < V_168 || V_101 . V_49 )
return - V_75 ;
V_24 = F_67 ( V_3 , & V_101 ) ;
if ( V_24 )
return V_24 ;
return F_126 ( ( void V_175 * ) V_160 , & V_101 , V_168 ) ?
- V_176 : 0 ;
}
return - V_181 ;
}
...
if ( * V_182 )
return - V_75 ;
return F_128 ( & V_3 -> V_80 , V_184 ) ;
}
static int F_129 ( void * V_70 ,
struct V_183 * V_184 )
{
struct V_2 * V_3 = V_70 ;
return F_130 ( & V_3 -> V_80 , V_184 ) ;
}
