...
if ( V_30 < 0 )
return V_30 ;
V_30 = F_26 ( V_8 , V_44 , 0 ) ;
if ( V_30 < 0 )
return V_30 ;
F_27 ( V_28 , V_44 , & V_7 -> V_21 ) ;
V_23 = F_28 ( V_51 , V_44 L_6 ) ;
if ( ! V_23 )
return - V_55 ;
V_30 = F_29 ( V_28 , V_51 , V_23 , V_44 , & V_24 ) ;
if ( V_30 < 0 )
return V_30 ;
V_53 = 0 ;
F_30 (node, np) {
...
int V_11 , V_30 ;
V_7 = F_33 ( V_28 , sizeof( * V_7 ) , V_59 ) ;
if ( ! V_7 )
return - V_60 ;
V_11 = F_34 ( V_23 ) ;
V_10 = F_33 ( V_28 , sizeof( * V_10 ) * V_11 , V_59 ) ;
V_15 = F_33 ( V_28 , sizeof( * V_15 ) * V_11 , V_59 ) ;
if ( ! V_10 || ! V_15 )
return - V_60 ;
V_7 -> V_10 = V_10 ;
V_7 -> V_15 = V_15 ;
