...
if ( V_151 & V_163 ) {
int V_104 ;
V_104 = F_62 ( & V_154 -> V_106 , F_63 ( & V_46 -> V_51 ) ) ;
if ( V_104 ) {
F_64 ( L_5 V_50 L_6 ,
( unsigned long long ) F_63 ( & V_46 -> V_51 ) ,
F_22 ( & V_154 -> V_106 ) , V_104 ) ;
}
V_154 -> V_124 |= V_163 ;
}
if ( V_151 & V_164 ) {
struct V_78 * V_79 ;
struct V_34 * V_165 ;
V_165 = F_65 ( V_62 -> V_166 , F_24 ( V_6 ) ) ;
V_79 = F_66 ( V_8 , F_24 ( V_6 ) , F_67 ( V_165 ) ,
V_167 | V_168 ) ;
if ( ! V_79 && ! V_165 -> V_169 ) {
struct V_170 * V_171 ;
struct V_83 * V_84 ;
F_68 ( V_172 , V_8 , V_62 -> V_166 ,
L_7 ) ;
V_84 = & F_32 ( V_8 ) -> V_85 ;
F_33 ( & V_46 -> V_51 , V_84 ) ;
V_171 = F_69 (
...
struct V_1 * F_73 ( const struct V_7 * V_8 ,
...
int F_76 ( const struct V_7 * V_8 , struct V_2 * V_3 )
{
struct V_183 V_184 = { 0 } ;
F_27 ( V_185 , L_8 ,
V_3 , F_17 ( & V_3 -> V_20 ) ) ;
F_77 ( V_3 -> V_21 , ! F_17 ( & V_3 -> V_20 ) , & V_184 ) ;
F_78 ( V_8 , V_3 , 0 , NULL ) ;
F_79 ( V_8 , V_3 , 0 , V_186 , V_187 ) ;
F_31 ( V_8 , F_80 ( V_3 ) ) ;
return 0 ;
}
