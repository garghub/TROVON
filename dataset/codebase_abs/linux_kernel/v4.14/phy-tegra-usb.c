...
V_23 -> V_75 = F_84 (
V_133 -> V_18 . V_137 , L_30 ) ;
if ( ! V_23 -> V_75 ) {
V_123 = F_77 ( V_133 , L_31 ,
& V_23 -> V_76 ) ;
if ( V_123 < 0 )
return V_123 ;
}
...
break;
default:
F_51 ( & V_133 -> V_18 , L_38 ) ;
return - V_32 ;
}
if ( F_90 ( V_148 , L_39 , NULL ) )
V_138 -> V_64 = F_91 ( & V_133 -> V_18 ) ;
else
V_138 -> V_64 = V_94 ;
if ( V_138 -> V_64 == V_156 ) {
...
V_138 -> V_117 = F_92 ( & V_133 -> V_18 , L_42 ) ;
if ( F_9 ( V_138 -> V_117 ) )
return F_11 ( V_138 -> V_117 ) ;
} else {
F_93 ( & V_133 -> V_18 , L_43 ) ;
