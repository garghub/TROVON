...
unsigned int V_5 , V_29 , V_82 = 0 ;
struct V_23 T_2 * V_24 ;
const T_4 * V_83 ;
for ( V_78 = NULL ;
( V_78 = F_38 ( V_78 , L_5 ) ) != NULL ; ) {
if ( ! F_29 ( V_78 ,
L_2 ) )
continue;
V_83 = F_33 ( V_78 , L_6 , NULL ) ;
if ( V_83 == NULL ) {
F_24 ( V_84 L_7 ) ;
F_39 ( V_78 ) ;
return - V_68 ;
...
V_82 ++ ;
F_34 ( V_83 [ 0 ] , V_80 . V_85 , V_78 ) ;
F_34 ( V_83 [ 1 ] , V_81 . V_85 , V_78 ) ;
V_5 = V_83 [ 0 ] >> 1 ;
V_24 = F_41 ( V_83 [ 0 ] ) ;
V_29 = V_5 << V_11 ;
V_29 |= 1 << V_72 ;
...
void F_48 ( int V_40 , int V_93 , int V_94 )
{
struct V_23 T_2 * V_95 = F_41 ( V_40 ) ;
V_37 V_87 = 0 ;
int V_5 = V_40 >> 1 ;
V_87 |= F_49 ( V_94 ) |
F_50 ( V_5 ) ;
