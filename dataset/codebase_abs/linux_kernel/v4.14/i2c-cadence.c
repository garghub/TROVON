...
{
struct V_1 * V_123 = F_27 ( V_67 ) ;
F_28 ( V_123 -> V_124 ) ;
return 0 ;
}
static int T_3 F_29 ( struct V_122 * V_67 )
{
struct V_1 * V_123 = F_27 ( V_67 ) ;
int V_73 ;
V_73 = F_30 ( V_123 -> V_124 ) ;
if ( V_73 ) {
F_13 ( V_67 , L_4 ) ;
return V_73 ;
}
...
static int F_31 ( struct V_125 * V_126 )
{
struct V_127 * V_128 ;
struct V_1 * V_2 ;
int V_73 ;
const struct V_129 * V_130 ;
V_2 = F_32 ( & V_126 -> V_67 , sizeof( * V_2 ) , V_131 ) ;
if ( ! V_2 )
return - V_132 ;
V_2 -> V_67 = & V_126 -> V_67 ;
F_33 ( V_126 , V_2 ) ;
V_130 = F_34 ( V_133 , V_126 -> V_67 . V_134 ) ;
if ( V_130 && V_130 -> V_111 ) {
const struct V_135 * V_111 = V_130 -> V_111 ;
V_2 -> V_24 = V_111 -> V_24 ;
}
V_128 = F_35 ( V_126 , V_136 , 0 ) ;
V_2 -> V_137 = F_36 ( & V_126 -> V_67 , V_128 ) ;
if ( F_37 ( V_2 -> V_137 ) )
return F_38 ( V_2 -> V_137 ) ;
V_2 -> V_9 = F_39 ( V_126 , 0 ) ;
V_2 -> V_55 . V_138 = V_139 ;
V_2 -> V_55 . V_67 . V_134 = V_126 -> V_67 . V_134 ;
V_2 -> V_55 . V_140 = & V_141 ;
V_2 -> V_55 . V_66 = V_142 ;
V_2 -> V_55 . V_143 = 3 ;
V_2 -> V_55 . V_56 = V_2 ;
V_2 -> V_55 . V_67 . V_68 = & V_126 -> V_67 ;
F_40 ( & V_2 -> V_43 ) ;
snprintf ( V_2 -> V_55 . V_144 , sizeof( V_2 -> V_55 . V_144 ) ,
L_5 , ( unsigned long ) V_128 -> V_145 ) ;
V_2 -> V_124 = F_41 ( & V_126 -> V_67 , NULL ) ;
if ( F_37 ( V_2 -> V_124 ) ) {
F_13 ( & V_126 -> V_67 , L_6 ) ;
return F_38 ( V_2 -> V_124 ) ;
}
V_73 = F_42 ( V_2 -> V_124 ) ;
if ( V_73 )
F_13 ( & V_126 -> V_67 , L_7 ) ;
...
if ( F_47 ( V_2 -> V_124 , & V_2 -> V_147 ) )
F_16 ( & V_126 -> V_67 , L_8 ) ;
V_2 -> V_86 = F_48 ( V_2 -> V_124 ) ;
V_73 = F_49 ( V_126 -> V_67 . V_134 , L_9 ,
& V_2 -> V_103 ) ;
...
if ( V_73 ) {
F_13 ( & V_126 -> V_67 , L_10 , V_2 -> V_103 ) ;
V_73 = - V_101 ;
goto V_153;
}
V_73 = F_50 ( & V_126 -> V_67 , V_2 -> V_9 , F_5 , 0 ,
V_154 , V_2 ) ;
if ( V_73 ) {
F_13 ( & V_126 -> V_67 , L_11 , V_2 -> V_9 ) ;
goto V_153;
}
F_3 ( V_155 , V_156 ) ;
V_73 = F_51 ( & V_2 -> V_55 ) ;
...
{
struct V_1 * V_2 = F_57 ( V_126 ) ;
F_58 ( & V_2 -> V_55 ) ;
F_59 ( V_2 -> V_124 , & V_2 -> V_147 ) ;
F_53 ( V_2 -> V_124 ) ;
F_55 ( & V_126 -> V_67 ) ;
return 0 ;
}
