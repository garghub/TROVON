...
if ( V_20 -> V_53 -> V_69 ) {
F_11 ( V_4 , ' ' ) ;
V_52 = V_20 -> V_53 -> V_69 ( V_4 , V_48 . V_49 ) ;
}
F_11 ( V_4 , '\n' ) ;
V_55:
return V_52 ;
}
static int F_27 ( struct V_70 * V_70 , struct V_1 * V_1 ,
int (* F_28)( struct V_3 * , struct V_31 * ) )
{
struct V_71 * V_72 = F_29 ( V_70 ) ;
struct V_73 * V_74 ;
...
F_31 ( V_72 ) ;
F_32 ( V_72 ) ;
V_75 = F_35 ( V_1 , & V_81 , sizeof( struct V_6 ) ) ;
if ( V_75 )
goto V_82;
V_4 = V_1 -> V_5 ;
V_4 -> V_16 = V_10 -> V_14 ;
...
static int F_38 ( struct V_70 * V_70 , struct V_1 * V_1 )
{
struct V_3 * V_4 = V_1 -> V_5 ;
struct V_6 * V_7 = V_4 -> V_8 ;
F_36 ( & V_7 -> V_57 ) ;
F_37 ( V_7 -> V_10 ) ;
return F_39 ( V_70 , V_1 ) ;
}
static int F_40 ( struct V_70 * V_70 , struct V_1 * V_1 )
{
return F_27 ( V_70 , V_1 , F_12 ) ;
}
static int F_41 ( struct V_70 * V_70 , struct V_1 * V_1 )
{
return F_27 ( V_70 , V_1 , F_16 ) ;
}
static int F_42 ( struct V_70 * V_70 , struct V_1 * V_1 )
{
return F_27 ( V_70 , V_1 , F_26 ) ;
}
