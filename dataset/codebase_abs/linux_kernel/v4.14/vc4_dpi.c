...
static enum V_58 F_16 ( struct V_2 * V_3 ,
...
{
struct V_62 * V_12 = & V_17 -> V_63 -> V_12 ;
struct V_64 * V_65 ;
int V_30 ;
V_30 = F_18 ( V_12 -> V_66 , 0 , 0 ,
& V_65 , & V_17 -> V_67 ) ;
if ( V_30 ) {
if ( V_30 == - V_68 )
return 0 ;
...
return F_20 ( V_17 -> V_3 , V_17 -> V_67 , NULL ) ;
}
static int F_21 ( struct V_62 * V_12 , struct V_62 * V_71 , void * V_72 )
{
struct V_73 * V_63 = F_22 ( V_12 ) ;
struct V_11 * V_74 = F_23 ( V_71 ) ;
struct V_14 * V_15 = F_4 ( V_74 ) ;
struct V_16 * V_17 ;
struct V_1 * V_1 ;
int V_30 ;
V_17 = F_24 ( V_12 , sizeof( * V_17 ) , V_75 ) ;
if ( ! V_17 )
return - V_76 ;
...
V_17 -> V_63 = V_63 ;
V_17 -> V_78 = F_25 ( V_63 , 0 ) ;
if ( F_26 ( V_17 -> V_78 ) )
return F_27 ( V_17 -> V_78 ) ;
if ( F_7 ( V_79 ) != V_80 ) {
F_28 ( V_12 , L_4 ,
F_7 ( V_79 ) , V_80 ) ;
return - V_68 ;
}
V_17 -> V_81 = F_29 ( V_12 , L_5 ) ;
if ( F_26 ( V_17 -> V_81 ) ) {
V_30 = F_27 ( V_17 -> V_81 ) ;
if ( V_30 != - V_82 )
F_12 ( L_6 , V_30 ) ;
...
static void F_34 ( struct V_62 * V_12 , struct V_62 * V_71 ,
void * V_72 )
{
struct V_11 * V_74 = F_23 ( V_71 ) ;
struct V_14 * V_15 = F_4 ( V_74 ) ;
...
static int F_36 ( struct V_73 * V_63 )
{
return F_37 ( & V_63 -> V_12 , & V_87 ) ;
}
static int F_38 ( struct V_73 * V_63 )
{
F_39 ( & V_63 -> V_12 , & V_87 ) ;
return 0 ;
}
