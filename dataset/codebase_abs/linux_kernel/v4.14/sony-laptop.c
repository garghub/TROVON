...
V_169 -> V_65 = V_65 ;
V_169 -> V_170 = V_173 ;
V_169 -> V_177 = V_65 != 0x0153 ;
F_53 ( & V_169 -> V_178 . V_89 ) ;
V_169 -> V_178 . V_89 . V_39 = L_64 ;
V_169 -> V_178 . V_89 . V_100 = V_101 | V_179 ;
V_169 -> V_178 . V_102 = F_124 ;
V_169 -> V_178 . V_180 = F_122 ;
V_57 = F_54 ( & V_94 -> V_8 , & V_169 -> V_178 ) ;
if ( V_57 )
goto V_181;
F_121 ( V_169 -> V_100 ) ;
if ( V_169 -> V_177 ) {
F_53 ( & V_169 -> V_182 . V_89 ) ;
V_169 -> V_182 . V_89 . V_39 = L_65 ;
V_169 -> V_182 . V_89 . V_100 = V_101 | V_179 ;
V_169 -> V_182 . V_102 =
F_127 ;
V_169 -> V_182 . V_180 =
F_126 ;
V_57 = F_54 ( & V_94 -> V_8 , & V_169 -> V_182 ) ;
if ( V_57 )
goto V_183;
F_125 ( V_169 -> V_171 ) ;
}
...
return - V_81 ;
if ( V_185 -> V_65 != 0x013f )
V_184 = V_184 | ( V_184 << 2 ) ;
V_184 = ( V_184 | 0x1 ) << 0x10 ;
}
if ( F_58 ( V_185 -> V_65 , V_184 | 0x0100 , & V_68 ) )
return - V_112 ;
return V_77 ;
}
...
if ( F_58 ( V_185 -> V_65 , 0x0000 , & V_68 ) )
return - V_112 ;
...
T_6 V_77 = 0 ;
unsigned int V_186 ;
if ( F_58 ( V_185 -> V_65 , 0x0200 , & V_186 ) )
return - V_112 ;
V_77 = snprintf ( V_82 , V_92 , L_21 , V_186 & 0xff ) ;
return V_77 ;
}
...
{
int V_57 = 0 ;
V_185 = F_52 ( sizeof( struct V_187 ) , V_35 ) ;
if ( ! V_185 )
return - V_37 ;
V_185 -> V_65 = V_65 ;
F_53 ( & V_185 -> V_188 [ 0 ] . V_89 ) ;
V_185 -> V_188 [ 0 ] . V_89 . V_39 = L_66 ;
V_185 -> V_188 [ 0 ] . V_89 . V_100 = V_101 | V_179 ;
V_185 -> V_188 [ 0 ] . V_102 = F_129 ;
V_185 -> V_188 [ 0 ] . V_180 = F_128 ;
V_57 = F_54 ( & V_94 -> V_8 , & V_185 -> V_188 [ 0 ] ) ;
if ( V_57 )
goto V_181;
if ( V_65 == 0x0115 )
return 0 ;
F_53 ( & V_185 -> V_188 [ 1 ] . V_89 ) ;
V_185 -> V_188 [ 1 ] . V_89 . V_39 = L_67 ;
V_185 -> V_188 [ 1 ] . V_89 . V_100 = V_101 ;
V_185 -> V_188 [ 1 ] . V_102 = F_130 ;
V_57 = F_54 ( & V_94 -> V_8 , & V_185 -> V_188 [ 1 ] ) ;
if ( V_57 )
goto V_189;
return 0 ;
V_189:
F_56 ( & V_94 -> V_8 , & V_185 -> V_188 [ 0 ] ) ;
V_181:
F_47 ( V_185 ) ;
V_185 = NULL ;
return V_57 ;
...
if ( V_185 ) {
F_56 ( & V_94 -> V_8 , & V_185 -> V_188 [ 0 ] ) ;
if ( V_185 -> V_65 != 0x0115 )
F_56 ( & V_94 -> V_8 , & V_185 -> V_188 [ 1 ] ) ;
F_47 ( V_185 ) ;
V_185 = NULL ;
}
}
...
{
unsigned int V_68 ;
if ( ( V_100 && ! ( V_190 -> V_191 & V_100 ) ) || V_100 >= V_192 )
return - V_81 ;
...
if ( ! V_193 || ( V_190 -> V_191 & V_193 ) )
V_194 += snprintf ( V_82 + V_194 , V_92 - V_194 , L_68 ,
V_195 [ V_193 ] ) ;
}
V_194 += snprintf ( V_82 + V_194 , V_92 - V_194 , L_13 ) ;
return V_194 ;
}
...
if ( V_82 [ V_84 - 1 ] == '\n' )
V_84 -- ;
for ( V_184 = 0 ; V_184 < V_192 ; V_184 ++ )
if ( strncmp ( V_82 , V_195 [ V_184 ] , V_84 ) == 0 )
break;
if ( F_131 ( V_184 ) )
return - V_112 ;
return V_77 ;
...
if ( V_100 < 0 )
return V_100 ;
V_77 = snprintf ( V_82 , V_92 , L_69 , V_195 [ V_100 ] ) ;
return V_77 ;
}
static int F_84 ( struct V_93 * V_94 )
{
int V_57 = 0 ;
V_190 = F_52 ( sizeof( struct V_196 ) , V_35 ) ;
if ( ! V_190 )
return - V_37 ;
V_57 = F_58 ( 0x0122 , 0x0000 , & V_190 -> V_191 ) ;
if ( V_57 ) {
F_46 ( L_70 ) ;
goto V_181;
}
...
V_190 -> V_100 = V_57 ;
F_53 ( & V_190 -> V_197 . V_89 ) ;
V_190 -> V_197 . V_89 . V_39 = L_72 ;
V_190 -> V_197 . V_89 . V_100 = V_101 ;
V_190 -> V_197 . V_102 = F_133 ;
F_53 ( & V_190 -> V_178 . V_89 ) ;
V_190 -> V_178 . V_89 . V_39 = L_73 ;
V_190 -> V_178 . V_89 . V_100 = V_101 | V_179 ;
V_190 -> V_178 . V_102 = F_135 ;
V_190 -> V_178 . V_180 = F_134 ;
V_57 = F_54 ( & V_94 -> V_8 , & V_190 -> V_197 ) ;
if ( V_57 )
goto V_181;
V_57 = F_54 ( & V_94 -> V_8 , & V_190 -> V_178 ) ;
if ( V_57 )
goto V_198;
return 0 ;
V_198:
F_56 ( & V_94 -> V_8 , & V_190 -> V_197 ) ;
V_181:
F_47 ( V_190 ) ;
V_190 = NULL ;
return V_57 ;
...
return - V_81 ;
while ( V_199 < V_201 ) {
if ( & V_202 -> V_188 [ V_199 ] . V_89 == & V_89 -> V_89 )
break;
V_199 ++ ;
}
if ( V_199 == V_201 )
return - V_81 ;
if ( V_67 )
V_67 = V_202 -> V_72 | ( 1 << V_199 ) ;
else
V_67 = V_202 -> V_72 & ~ ( 1 << V_199 ) ;
if ( F_58 ( V_202 -> V_65 , V_67 << 0x10 | 0x0100 ,
& V_68 ) )
return - V_112 ;
V_202 -> V_72 = V_67 ;
return V_77 ;
...
return - V_112 ;
V_202 = F_52 ( sizeof( struct V_203 ) , V_35 ) ;
if ( ! V_202 )
return - V_37 ;
V_202 -> V_72 = V_68 & 0x7 ;
V_202 -> V_65 = V_65 ;
F_53 ( & V_202 -> V_188 [ 0 ] . V_89 ) ;
V_202 -> V_188 [ V_200 ] . V_89 . V_39 = L_74 ;
V_202 -> V_188 [ V_200 ] . V_89 . V_100 = V_101 | V_179 ;
V_202 -> V_188 [ V_200 ] . V_102 = F_137 ;
V_202 -> V_188 [ V_200 ] . V_180 = F_136 ;
if ( V_65 == 0x0119 ) {
F_53 ( & V_202 -> V_188 [ 1 ] . V_89 ) ;
V_202 -> V_188 [ V_204 ] . V_89 . V_39 = L_75 ;
V_202 -> V_188 [ V_204 ] . V_89 . V_100 = V_101 | V_179 ;
V_202 -> V_188 [ V_204 ] . V_102 = F_137 ;
V_202 -> V_188 [ V_204 ] . V_180 = F_136 ;
F_53 ( & V_202 -> V_188 [ 2 ] . V_89 ) ;
V_202 -> V_188 [ V_205 ] . V_89 . V_39 = L_76 ;
V_202 -> V_188 [ V_205 ] . V_89 . V_100 = V_101 | V_179 ;
V_202 -> V_188 [ V_205 ] . V_102 = F_137 ;
V_202 -> V_188 [ V_205 ] . V_180 = F_136 ;
}
for ( V_32 = 0 ; V_32 < V_201 &&
V_202 -> V_188 [ V_32 ] . V_89 . V_39 ; V_32 ++ ) {
V_68 = F_54 ( & V_94 -> V_8 , & V_202 -> V_188 [ V_32 ] ) ;
if ( V_68 )
goto V_206;
}
return 0 ;
...
F_56 ( & V_94 -> V_8 , & V_202 -> V_188 [ V_32 ] ) ;
F_47 ( V_202 ) ;
V_202 = NULL ;
return V_68 ;
}
...
int V_32 ;
if ( V_202 ) {
for ( V_32 = 0 ; V_32 < V_201 ; V_32 ++ ) {
if ( ! V_202 -> V_188 [ V_32 ] . V_89 . V_39 )
break;
F_56 ( & V_94 -> V_8 , & V_202 -> V_188 [ V_32 ] ) ;
}
F_47 ( V_202 ) ;
...
unsigned int V_68 ;
if ( F_58 ( V_207 -> V_65 ,
V_207 -> V_65 == 0x015B ? 0x0000 : 0x0100 ,
& V_68 ) )
return - V_112 ;
switch ( V_207 -> V_65 ) {
case 0x0146 :
return V_68 & 0x1 ? V_208 : V_209 ;
break;
case 0x015B :
return V_68 & 0x1 ? V_209 : V_208 ;
break;
case 0x0128 :
F_13 ( L_77 , V_68 ) ;
return V_68 & 0x80 ? AUTO :
V_68 & 0x02 ? V_209 : V_208 ;
break;
}
return - V_81 ;
}
...
V_199 == V_208 ? L_78 :
V_199 == V_209 ? L_79 :
V_199 == AUTO ? L_80 : L_81 ) ;
}
static int F_85 ( struct V_93 * V_94 ,
unsigned int V_65 )
{
unsigned int V_68 ;
V_207 = F_52 ( sizeof( struct V_210 ) , V_35 ) ;
if ( ! V_207 )
return - V_37 ;
V_207 -> V_65 = V_65 ;
F_53 ( & V_207 -> V_89 . V_89 ) ;
V_207 -> V_89 . V_89 . V_39 = L_82 ;
V_207 -> V_89 . V_89 . V_100 = V_101 ;
V_207 -> V_89 . V_102 = F_138 ;
V_68 = F_54 ( & V_94 -> V_8 , & V_207 -> V_89 ) ;
if ( V_68 )
goto V_211;
return 0 ;
V_211:
...
return - V_37 ;
F_53 ( & V_212 -> V_89 ) ;
V_212 -> V_89 . V_39 = L_84 ;
V_212 -> V_89 . V_100 = V_101 | V_179 ;
V_212 -> V_102 = F_140 ;
V_212 -> V_180 = F_139 ;
...
{
unsigned int V_68 ;
V_213 = F_52 ( sizeof( struct V_88 ) , V_35 ) ;
if ( ! V_213 )
return - V_37 ;
F_53 ( & V_213 -> V_89 ) ;
V_213 -> V_89 . V_39 = L_85 ;
V_213 -> V_89 . V_100 = V_101 | V_179 ;
V_213 -> V_102 = F_142 ;
V_213 -> V_180 = F_141 ;
V_68 = F_54 ( & V_94 -> V_8 , V_213 ) ;
if ( V_68 ) {
F_47 ( V_213 ) ;
V_213 = NULL ;
return V_68 ;
...
{
unsigned int V_68 ;
V_214 = F_52 ( sizeof( struct V_88 ) , V_35 ) ;
if ( ! V_214 )
return - V_37 ;
V_215 = F_52 ( sizeof( struct V_88 ) , V_35 ) ;
if ( ! V_215 ) {
V_68 = - V_37 ;
goto V_216;
}
F_53 ( & V_214 -> V_89 ) ;
V_214 -> V_89 . V_39 = L_86 ;
V_214 -> V_89 . V_100 = V_101 ;
V_214 -> V_102 = F_145 ;
V_214 -> V_180 = NULL ;
F_53 ( & V_215 -> V_89 ) ;
V_215 -> V_89 . V_39 = L_87 ;
V_215 -> V_89 . V_100 = V_101 | V_179 ;
V_215 -> V_102 = F_144 ;
V_215 -> V_180 = F_143 ;
V_68 = F_54 ( & V_94 -> V_8 , V_214 ) ;
if ( V_68 )
goto V_217;
V_68 = F_54 ( & V_94 -> V_8 , V_215 ) ;
if ( V_68 )
goto V_218;
return 0 ;
V_218:
...
V_219 = F_52 ( sizeof( struct V_88 ) , V_35 ) ;
if ( ! V_219 )
return - V_37 ;
F_53 ( & V_219 -> V_89 ) ;
V_219 -> V_89 . V_39 = L_89 ;
V_219 -> V_89 . V_100 = V_101 | V_179 ;
V_219 -> V_102 = F_147 ;
V_219 -> V_180 = F_146 ;
V_68 = F_54 ( & V_94 -> V_8 , V_219 ) ;
if ( V_68 ) {
F_47 ( V_219 ) ;
V_219 = NULL ;
return V_68 ;
...
{
unsigned int V_68 ;
V_220 = F_52 ( sizeof( struct V_88 ) , V_35 ) ;
if ( ! V_220 )
return - V_37 ;
F_53 ( & V_220 -> V_89 ) ;
V_220 -> V_89 . V_39 = L_90 ;
V_220 -> V_89 . V_100 = V_101 ;
V_220 -> V_102 = F_148 ;
V_220 -> V_180 = NULL ;
V_68 = F_54 ( & V_94 -> V_8 , V_220 ) ;
if ( V_68 ) {
F_47 ( V_220 ) ;
V_220 = NULL ;
return V_68 ;
...
{
unsigned int V_68 ;
V_221 = F_52 ( sizeof( struct V_88 ) , V_35 ) ;
if ( ! V_221 )
return - V_37 ;
F_53 ( & V_221 -> V_89 ) ;
V_221 -> V_89 . V_39 = L_91 ;
V_221 -> V_89 . V_100 = V_179 ;
V_221 -> V_102 = NULL ;
V_221 -> V_180 = F_149 ;
V_68 = F_54 ( & V_94 -> V_8 , V_221 ) ;
if ( V_68 ) {
F_47 ( V_221 ) ;
V_221 = NULL ;
return V_68 ;
...
{
int V_57 = 0 ;
V_222 = F_52 ( sizeof( struct V_223 ) , V_35 ) ;
if ( ! V_222 )
return - V_37 ;
V_222 -> V_65 = V_65 ;
F_53 ( & V_222 -> V_89 . V_89 ) ;
V_222 -> V_89 . V_89 . V_39 = L_92 ;
V_222 -> V_89 . V_89 . V_100 = V_101 | V_179 ;
V_222 -> V_89 . V_102 = F_151 ;
V_222 -> V_89 . V_180 = F_150 ;
V_57 = F_54 ( & V_94 -> V_8 , & V_222 -> V_89 ) ;
if ( V_57 ) {
F_47 ( V_222 ) ;
V_222 = NULL ;
}
...
for ( V_32 = 0 ; V_32 < V_224 && V_32 < F_12 ( V_82 ) ; V_32 ++ ) {
F_13 ( L_93 , V_82 [ V_32 ] ) ;
if ( ! V_82 [ V_32 ] )
break;
if ( V_82 [ V_32 ] > V_226 )
...
return;
memset ( & V_118 , 0 , sizeof( struct V_231 ) ) ;
V_118 . type = V_235 ;
V_118 . V_228 = V_228 ;
V_233 . V_8 = F_154 ( L_95 , NULL ,
& V_233 ,
V_230 , & V_118 ) ;
if ( F_155 ( V_233 . V_8 ) ) {
F_46 ( L_96 ) ;
...
V_233 . V_8 -> V_118 . V_119 =
V_230 -> V_236 ( V_233 . V_8 ) ;
}
...
{
T_1 V_246 , V_247 ;
F_165 ( F_166 ( V_248 . V_249 -> V_250 . V_251 + 4 ) & 2 ,
V_252 ) ;
F_167 ( V_8 , V_248 . V_249 -> V_250 . V_251 + 4 ) ;
V_246 = F_166 ( V_248 . V_249 -> V_250 . V_251 + 4 ) ;
V_247 = F_166 ( V_248 . V_249 -> V_250 . V_251 ) ;
F_13 ( L_106 , V_8 , ( V_247 << 8 ) | V_246 ) ;
return V_247 ;
}
static T_1 F_168 ( T_1 V_8 , T_1 V_253 )
{
T_1 V_246 ;
F_165 ( F_166 ( V_248 . V_249 -> V_250 . V_251 + 4 ) & 2 ,
V_252 ) ;
...
F_165 ( F_166 ( V_248 . V_249 -> V_250 . V_251 + 4 ) & 2 ,
V_252 ) ;
F_167 ( V_253 , V_248 . V_249 -> V_250 . V_251 ) ;
V_246 = F_166 ( V_248 . V_249 -> V_250 . V_251 ) ;
F_13 ( L_107 , V_8 , V_253 , V_246 ) ;
return V_246 ;
}
static T_1 F_169 ( T_1 V_8 , T_1 V_253 , T_1 V_80 )
{
T_1 V_246 ;
F_165 ( F_166 ( V_248 . V_249 -> V_250 . V_251 + 4 ) & 2 , V_252 ) ;
F_167 ( V_8 , V_248 . V_249 -> V_250 . V_251 + 4 ) ;
F_165 ( F_166 ( V_248 . V_249 -> V_250 . V_251 + 4 ) & 2 , V_252 ) ;
F_167 ( V_253 , V_248 . V_249 -> V_250 . V_251 ) ;
F_165 ( F_166 ( V_248 . V_249 -> V_250 . V_251 + 4 ) & 2 , V_252 ) ;
F_167 ( V_80 , V_248 . V_249 -> V_250 . V_251 ) ;
V_246 = F_166 ( V_248 . V_249 -> V_250 . V_251 ) ;
F_13 ( L_108 ,
V_8 , V_253 , V_80 , V_246 ) ;
return V_246 ;
}
static int F_170 ( const T_1 V_254 , const T_1 V_255 )
{
if ( V_254 == 0x31 ) {
if ( V_255 == 0x5c || V_255 == 0x5f )
F_164 ( 0xA0 ) ;
else if ( V_255 == 0x61 )
F_164 ( 0xB3 ) ;
return 0 ;
...
static void F_171 ( struct V_256 * V_8 )
{
struct V_257 * V_258 ;
V_258 = F_172 ( V_259 ,
V_260 , NULL ) ;
...
{
T_1 V_80 ;
V_80 = F_168 ( 0x8f , V_278 ) ;
return ( V_80 != 0xff && ( V_80 & V_279 ) ) ;
}
...
if ( V_248 . V_284 )
return 0 ;
for ( V_285 = 5 ; V_285 > 0 ; V_285 -- ) {
for ( V_286 = 0 ; V_286 < 100 && F_168 ( 0x91 , 0x1 ) ; V_286 ++ )
F_177 ( 10 ) ;
F_164 ( 0x93 ) ;
...
F_165 ( F_169 ( 0x90 , V_287 ,
0x5a ) ,
V_283 ) ;
V_248 . V_284 = 1 ;
return 0 ;
}
int F_178 ( int V_288 , T_1 V_67 )
{
if ( ! V_280 )
return - V_112 ;
F_179 ( & V_248 . V_289 ) ;
...
break;
case V_297 :
F_165 ( F_169 ( 0x90 , V_298 , V_67 ) ,
V_283 ) ;
break;
case V_299 :
F_165 ( F_169 ( 0x90 , V_300 , V_67 ) ,
V_283 ) ;
break;
case V_301 :
F_165 ( F_169 ( 0x90 , V_281 , V_67 ) ,
V_283 ) ;
break;
case V_302 :
F_165 ( F_169 ( 0x90 , V_303 , V_67 ) ,
V_283 ) ;
break;
default:
F_20 ( L_112 , V_288 ) ;
...
static void F_181 ( T_1 V_304 )
{
V_304 = ! ! V_304 ;
if ( V_248 . V_305 == V_304 )
return;
F_168 ( 0xB0 , V_304 ) ;
F_164 ( 0x82 ) ;
V_248 . V_305 = V_304 ;
...
T_6 V_77 ;
F_179 ( & V_248 . V_289 ) ;
V_77 = snprintf ( V_82 , V_92 , L_21 , V_248 . V_305 ) ;
F_180 ( & V_248 . V_289 ) ;
return V_77 ;
}
static void F_184 ( T_1 V_304 )
{
V_304 = ! ! V_304 ;
if ( V_248 . V_306 == V_304 )
return;
F_168 ( 0x96 , V_304 ) ;
F_164 ( 0x82 ) ;
V_248 . V_306 = V_304 ;
...
T_6 V_77 = 0 ;
F_179 ( & V_248 . V_289 ) ;
V_77 = snprintf ( V_82 , V_92 , L_21 , V_248 . V_306 ) ;
F_180 ( & V_248 . V_289 ) ;
return V_77 ;
}
static int F_187 ( unsigned long V_67 )
{
return F_188 ( V_307 , V_67 ) ;
}
static int F_189 ( T_1 * V_67 )
{
return F_190 ( V_307 , V_67 ) ;
}
...
static int F_193 ( int V_308 , struct V_309 * V_310 , int V_311 )
{
return F_194 ( V_308 , V_310 , V_311 , & V_312 . V_313 ) ;
}
static int F_195 ( struct V_314 * V_314 , struct V_309 * V_309 )
{
F_30 ( & V_312 . V_315 ) ;
return 0 ;
}
static int F_196 ( struct V_314 * V_314 , struct V_309 * V_309 )
{
unsigned long V_4 ;
F_2 ( & V_312 . V_6 , V_4 ) ;
if ( F_197 ( & V_312 . V_315 ) == 1 )
F_198 ( & V_312 . V_7 ) ;
F_9 ( & V_312 . V_6 , V_4 ) ;
return 0 ;
}
static T_6 F_199 ( struct V_309 * V_309 , char T_8 * V_316 ,
T_5 V_77 , T_9 * V_199 )
{
T_6 V_57 ;
unsigned char V_317 ;
...
( V_309 -> V_318 & V_319 ) )
return - V_320 ;
V_57 = F_200 ( V_312 . V_321 ,
F_6 ( & V_312 . V_7 ) != 0 ) ;
if ( V_57 )
return V_57 ;
while ( V_57 < V_77 &&
( F_201 ( & V_312 . V_7 , & V_317 , sizeof( V_317 ) ,
& V_312 . V_6 ) == sizeof( V_317 ) ) ) {
if ( F_202 ( V_317 , V_316 ++ ) )
return - V_322 ;
V_57 ++ ;
}
if ( V_57 > 0 ) {
struct V_314 * V_314 = F_203 ( V_309 ) ;
V_314 -> V_323 = F_204 ( V_314 ) ;
}
return V_57 ;
}
static unsigned int F_205 ( struct V_309 * V_309 , T_10 * V_324 )
{
F_206 ( V_309 , & V_312 . V_321 , V_324 ) ;
if ( F_6 ( & V_312 . V_7 ) )
return V_325 | V_326 ;
return 0 ;
}
static int F_207 ( T_1 V_327 , T_11 * V_67 )
{
T_1 V_328 , V_329 ;
if ( F_190 ( V_327 , & V_328 ) )
return - 1 ;
if ( F_190 ( V_327 + 1 , & V_329 ) )
return - 1 ;
* V_67 = V_328 | ( V_329 << 8 ) ;
return 0 ;
}
static long F_208 ( struct V_309 * V_330 , unsigned int V_184 ,
unsigned long V_96 )
{
int V_57 = 0 ;
void T_8 * V_331 = ( void T_8 * ) V_96 ;
T_1 V_332 ;
T_11 V_333 ;
int V_67 ;
F_179 ( & V_248 . V_289 ) ;
...
V_332 = ( ( V_67 & 0xff ) - 1 ) << 5 ;
if ( F_209 ( V_331 , & V_332 , sizeof( V_332 ) ) )
V_57 = - V_322 ;
break;
case V_335 :
if ( V_233 . V_8 == NULL ) {
...
if ( F_210 ( & V_332 , V_331 , sizeof( V_332 ) ) ) {
V_57 = - V_322 ;
break;
}
V_67 = ( V_332 >> 5 ) + 1 ;
...
break;
case V_336 :
if ( F_207 ( V_337 , & V_333 ) ) {
V_57 = - V_112 ;
break;
}
if ( F_209 ( V_331 , & V_333 , sizeof( V_333 ) ) )
V_57 = - V_322 ;
break;
case V_338 :
if ( F_207 ( V_339 , & V_333 ) ) {
V_57 = - V_112 ;
break;
}
if ( F_209 ( V_331 , & V_333 , sizeof( V_333 ) ) )
...
{
F_15 ( & V_312 . V_7 , ( unsigned char * ) & V_12 ,
sizeof( V_12 ) , & V_312 . V_6 ) ;
F_212 ( & V_312 . V_313 , V_352 , V_353 ) ;
F_213 ( & V_312 . V_321 ) ;
}
...
static void F_211 ( T_1 V_12 ) { }
static T_4
F_219 ( struct V_356 * V_357 , void * V_137 )
{
T_7 V_32 ;
struct V_256 * V_8 = (struct V_256 * ) V_137 ;
switch ( V_357 -> type ) {
case V_358 :
{
struct V_359 * V_360 = F_52 ( sizeof( * V_360 ) , V_35 ) ;
if ( ! V_360 )
return V_361 ;
F_220 ( & V_360 -> V_362 , & V_8 -> V_363 ) ;
return V_142 ;
}
case V_364 :
return V_142 ;
case V_365 :
{
struct V_366 * V_367 = & V_357 -> V_127 . V_368 ;
struct V_369 * V_370 = NULL ;
if ( ! V_367 || ! V_367 -> V_371 ) {
F_13 ( L_115 ) ;
return V_142 ;
}
for ( V_32 = 0 ; V_32 < V_367 -> V_371 ; V_32 ++ ) {
if ( ! V_367 -> V_372 [ V_32 ] ) {
F_46 ( L_116 ,
V_367 -> V_372 [ V_32 ] ) ;
continue;
}
V_370 = F_52 ( sizeof( * V_370 ) ,
V_35 ) ;
if ( ! V_370 )
return V_361 ;
F_220 ( & V_370 -> V_362 , & V_8 -> V_372 ) ;
V_370 -> V_368 . V_373 = V_367 -> V_373 ;
V_370 -> V_368 . V_374 = V_367 -> V_374 ;
V_370 -> V_368 . V_375 = V_367 -> V_375 ;
V_370 -> V_368 . V_371 = 1 ;
V_370 -> V_368 . V_372 [ 0 ] = V_367 -> V_372 [ V_32 ] ;
}
return V_142 ;
}
case V_376 :
{
struct V_377 * V_378 = & V_357 -> V_127 . V_378 ;
struct V_359 * V_360 =
F_221 ( & V_8 -> V_363 , struct V_359 , V_362 ) ;
if ( ! V_378 ) {
F_13 ( L_117 ) ;
return V_142 ;
}
if ( ! V_360 -> V_250 . V_251 ) {
memcpy ( & V_360 -> V_250 , V_378 , sizeof( * V_378 ) ) ;
F_13 ( L_118 , V_360 -> V_250 . V_251 ,
V_360 -> V_250 . V_379 ) ;
}
else if ( ! V_360 -> V_380 . V_251 ) {
memcpy ( & V_360 -> V_380 , V_378 , sizeof( * V_378 ) ) ;
F_13 ( L_119 , V_360 -> V_380 . V_251 ,
V_360 -> V_380 . V_379 ) ;
}
else {
F_20 ( L_120 ) ;
...
{
T_4 V_57 = F_43 ( V_87 -> V_65 , L_128 , NULL ,
NULL ) ;
if ( F_44 ( V_57 ) && V_57 != V_386 )
return - V_387 ;
F_13 ( L_124 ) ;
return 0 ;
}
static int F_225 ( struct V_31 * V_87 ,
struct V_359 * V_360 , struct V_369 * V_368 )
{
T_4 V_72 ;
int V_68 = 0 ;
struct {
...
if ( ! V_360 || ! V_368 )
return - V_81 ;
V_357 = F_52 ( sizeof( * V_357 ) + 1 , V_35 ) ;
if ( ! V_357 )
return - V_37 ;
V_82 . V_86 = sizeof( * V_357 ) + 1 ;
V_82 . V_78 = V_357 ;
if ( V_248 . V_261 == V_262 ) {
V_357 -> V_388 . type = V_376 ;
V_357 -> V_388 . V_86 = sizeof( struct V_356 ) ;
memcpy ( & V_357 -> V_388 . V_127 . V_378 , & V_360 -> V_250 ,
sizeof( struct V_377 ) ) ;
V_357 -> V_389 . type = V_376 ;
V_357 -> V_389 . V_86 = sizeof( struct V_356 ) ;
memcpy ( & V_357 -> V_389 . V_127 . V_378 , & V_360 -> V_380 ,
sizeof( struct V_377 ) ) ;
V_357 -> V_390 . type = V_365 ;
V_357 -> V_390 . V_86 = sizeof( struct V_356 ) ;
memcpy ( & V_357 -> V_390 . V_127 . V_368 , & V_368 -> V_368 ,
sizeof( struct V_366 ) ) ;
V_357 -> V_390 . V_127 . V_368 . V_375 = V_392 ;
V_357 -> V_391 . type = V_381 ;
V_357 -> V_391 . V_86 = sizeof( struct V_356 ) ;
}
else {
V_357 -> V_388 . type = V_376 ;
V_357 -> V_388 . V_86 = sizeof( struct V_356 ) ;
memcpy ( & V_357 -> V_388 . V_127 . V_378 , & V_360 -> V_250 ,
sizeof( struct V_377 ) ) ;
V_357 -> V_389 . type = V_365 ;
V_357 -> V_389 . V_86 = sizeof( struct V_356 ) ;
memcpy ( & V_357 -> V_389 . V_127 . V_368 , & V_368 -> V_368 ,
sizeof( struct V_366 ) ) ;
V_357 -> V_389 . V_127 . V_368 . V_375 = V_392 ;
V_357 -> V_390 . type = V_381 ;
V_357 -> V_390 . V_86 = sizeof( struct V_356 ) ;
}
F_13 ( L_129 ) ;
...
F_164 ( 0x82 ) ;
F_168 ( 0x81 , 0xff ) ;
F_164 ( V_393 ? 0x92 : 0x82 ) ;
V_383:
F_47 ( V_357 ) ;
return V_68 ;
}
static T_12 V_369 ( int V_368 , void * V_394 )
{
int V_32 , V_285 ;
T_1 V_255 = 0 ;
T_1 V_254 = 0 ;
T_1 V_395 = 0 ;
struct V_256 * V_8 = (struct V_256 * ) V_394 ;
V_255 = F_166 ( V_8 -> V_249 -> V_250 . V_251 ) ;
if ( V_8 -> V_249 -> V_380 . V_251 )
V_254 = F_166 ( V_8 -> V_249 -> V_380 . V_251 ) ;
else
V_254 = F_166 ( V_8 -> V_249 -> V_250 . V_251 +
V_8 -> V_263 ) ;
F_13 ( L_131 ,
V_255 , V_254 , V_8 -> V_249 -> V_250 . V_251 ,
V_8 -> V_263 ) ;
if ( V_255 == 0x00 || V_255 == 0xff )
return V_396 ;
for ( V_32 = 0 ; V_8 -> V_265 [ V_32 ] . V_397 ; V_32 ++ ) {
if ( ( V_254 & V_8 -> V_265 [ V_32 ] . V_127 ) !=
V_8 -> V_265 [ V_32 ] . V_127 )
continue;
if ( ! ( V_397 & V_8 -> V_265 [ V_32 ] . V_397 ) )
continue;
for ( V_285 = 0 ; V_8 -> V_265 [ V_32 ] . V_398 [ V_285 ] . V_12 ; V_285 ++ ) {
if ( V_255 == V_8 -> V_265 [ V_32 ] . V_398 [ V_285 ] . V_127 ) {
V_395 =
V_8 -> V_265 [ V_32 ] . V_398 [ V_285 ] . V_12 ;
if ( ! V_395 )
return V_396 ;
goto V_399;
}
...
if ( V_8 -> V_273 && V_8 -> V_273 ( V_254 , V_255 ) == 0 )
return V_396 ;
F_13 ( L_132 ,
V_255 , V_254 , V_8 -> V_249 -> V_250 . V_251 ,
V_8 -> V_263 ) ;
...
{
struct V_359 * V_378 , * V_400 ;
struct V_369 * V_368 , * V_401 ;
if ( F_224 ( V_87 ) ) {
F_20 ( L_133 ) ;
return - V_387 ;
}
F_228 ( V_248 . V_402 -> V_368 . V_372 [ 0 ] , & V_248 ) ;
F_229 ( V_248 . V_249 -> V_250 . V_251 ,
V_248 . V_249 -> V_250 . V_379 ) ;
if ( V_248 . V_249 -> V_380 . V_251 )
F_229 ( V_248 . V_249 -> V_380 . V_251 ,
V_248 . V_249 -> V_380 . V_379 ) ;
F_217 () ;
F_31 () ;
F_230 ( & V_61 -> V_8 . V_403 , & V_404 ) ;
F_40 () ;
...
if ( F_236 ( V_378 -> V_250 . V_251 , V_378 -> V_250 . V_379 ,
L_135 ) ) {
F_13 ( L_136 ,
V_378 -> V_250 . V_251 , V_378 -> V_250 . V_409 ,
V_378 -> V_250 . V_379 ) ;
if ( V_378 -> V_380 . V_251 ) {
if ( F_236 ( V_378 -> V_380 . V_251 ,
V_378 -> V_380 . V_379 ,
L_135 ) ) {
F_13 ( L_137 ,
V_378 -> V_380 . V_251 , V_378 -> V_380 . V_409 ,
V_378 -> V_380 . V_379 ) ;
V_248 . V_249 = V_378 ;
break;
}
...
if ( ! F_237 ( V_368 -> V_368 . V_372 [ 0 ] , V_369 ,
0 , L_6 , & V_248 ) ) {
F_13 ( L_141
L_142 ,
V_368 -> V_368 . V_372 [ 0 ] ,
...
V_68 = F_225 ( V_87 , V_248 . V_249 , V_248 . V_402 ) ;
if ( V_68 ) {
F_20 ( L_144 ) ;
goto V_412;
}
...
if ( V_68 )
goto V_413;
V_68 = F_238 ( & V_61 -> V_8 . V_403 , & V_404 ) ;
if ( V_68 )
goto V_414;
F_71 ( L_145 ) ;
return 0 ;
...
{
F_225 ( F_240 ( V_8 ) ,
V_248 . V_249 , V_248 . V_402 ) ;
return 0 ;
}
static int T_13 F_242 ( void )
{
int V_68 ;
if ( ! V_415 && F_243 ( V_416 ) ) {
V_68 = F_244 ( & V_417 ) ;
if ( V_68 ) {
F_20 ( L_146 ) ;
goto V_60;
