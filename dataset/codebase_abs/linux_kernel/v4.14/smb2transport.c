...
#ifdef F_26
F_4 ( V_8 , L_19 , V_17 ) ;
F_4 ( V_8 , L_20 , ( int ) sizeof( V_20 -> V_21 ) ,
& V_20 -> V_21 ) ;
F_4 ( V_8 , L_21 ,
V_43 , V_20 -> V_41 . V_42 ) ;
F_4 ( V_8 , L_22 ,
...
return V_3 ;
if ( ! V_2 -> V_74 ) {
strncpy ( V_36 -> V_39 , L_35 , 8 ) ;
return V_3 ;
}
V_3 = V_2 -> V_75 -> V_76 ( V_28 , V_2 ) ;
return V_3 ;
}
int
F_31 ( struct V_27 * V_28 , struct V_1 * V_2 )
{
unsigned int V_3 ;
char V_77 [ 16 ] ;
struct V_35 * V_36 =
...
( ! V_2 -> V_74 ) )
return 0 ;
if ( memcmp ( V_36 -> V_39 , L_36 , 8 ) == 0 )
F_4 ( V_82 , L_37 ,
V_36 -> V_78 ) ;
memcpy ( V_77 , V_36 -> V_39 , V_40 ) ;
...
struct V_35 * V_36 )
{
unsigned int V_49 , V_85 = F_35 ( V_36 -> V_86 ) ;
V_36 -> V_87 = F_36 ( V_2 ) ;
for ( V_49 = 1 ; V_49 < V_85 ; V_49 ++ )
F_37 ( V_2 ) ;
}
static struct V_88 *
F_38 ( const struct V_35 * V_36 ,
struct V_1 * V_2 )
{
struct V_88 * V_89 ;
if ( V_2 == NULL ) {
...
static int
F_42 ( struct V_18 * V_20 , struct V_35 * V_36 ,
struct V_88 * * V_92 )
{
if ( V_20 -> V_2 -> V_72 == V_104 )
return - V_105 ;
if ( V_20 -> V_2 -> V_72 == V_106 ) {
F_4 ( V_82 , L_39 ) ;
return - V_107 ;
}
if ( V_20 -> V_108 == V_109 ) {
...
* V_92 = F_38 ( V_36 , V_20 -> V_2 ) ;
if ( * V_92 == NULL )
return - V_11 ;
F_14 ( & V_111 ) ;
F_43 ( & ( * V_92 ) -> V_112 , & V_20 -> V_2 -> V_113 ) ;
F_15 ( & V_111 ) ;
return 0 ;
}
int
F_44 ( struct V_88 * V_92 , struct V_1 * V_2 ,
bool V_114 )
{
unsigned int V_115 = F_45 ( V_92 -> V_116 ) ;
struct V_32 V_33 [ 2 ] ;
struct V_27 V_28 = { . V_34 = V_33 ,
. V_117 = 2 } ;
V_33 [ 0 ] . V_37 = ( char * ) V_92 -> V_116 ;
V_33 [ 0 ] . V_54 = 4 ;
V_33 [ 1 ] . V_37 = ( char * ) V_92 -> V_116 + 4 ;
V_33 [ 1 ] . V_54 = V_115 ;
F_46 ( V_92 -> V_116 , F_47 ( V_118 , 80 , V_115 ) ) ;
if ( V_115 > 24 && V_2 -> V_119 && ! V_92 -> V_120 ) {
int V_3 ;
V_3 = F_31 ( & V_28 , V_2 ) ;
if ( V_3 )
F_4 ( V_8 , L_40 ,
...
return F_48 ( V_92 -> V_116 , V_114 ) ;
}
struct V_88 *
F_49 ( struct V_18 * V_20 , struct V_27 * V_28 )
{
int V_3 ;
struct V_35 * V_36 =
(struct V_35 * ) V_28 -> V_34 [ 1 ] . V_37 ;
struct V_88 * V_92 ;
F_34 ( V_20 -> V_2 , V_36 ) ;
V_3 = F_42 ( V_20 , V_36 , & V_92 ) ;
if ( V_3 )
return F_50 ( V_3 ) ;
V_3 = F_30 ( V_28 , V_20 -> V_2 ) ;
if ( V_3 ) {
F_51 ( V_92 ) ;
return F_50 ( V_3 ) ;
}
