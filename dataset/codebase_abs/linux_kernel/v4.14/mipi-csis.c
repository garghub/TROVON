...
if ( V_46 )
goto V_48;
V_11 -> V_69 = V_107 . V_111 . V_112 - V_113 ;
if ( V_11 -> V_69 >= V_114 ) {
V_46 = - V_115 ;
goto V_48;
}
...
L_20 ) ;
V_11 -> V_22 = V_107 . V_116 . V_117 . V_118 ;
V_48:
F_58 ( V_104 ) ;
return V_46 ;
}
...
int V_46 = - V_125 ;
int V_8 ;
V_11 = F_60 ( V_44 , sizeof( * V_11 ) , V_126 ) ;
if ( ! V_11 )
return - V_125 ;
F_61 ( & V_11 -> V_62 ) ;
F_62 ( & V_11 -> V_55 ) ;
V_11 -> V_45 = V_45 ;
V_120 = F_63 ( V_127 , V_44 -> V_105 ) ;
if ( F_64 ( V_120 == NULL ) )
return - V_42 ;
V_122 = V_120 -> V_84 ;
V_11 -> V_15 = V_122 -> V_15 ;
V_46 = F_52 ( V_45 , V_11 ) ;
if ( V_46 < 0 )
return V_46 ;
...
V_11 -> V_128 = F_65 ( V_44 , L_22 ) ;
if ( F_16 ( V_11 -> V_128 ) )
return F_22 ( V_11 -> V_128 ) ;
V_124 = F_66 ( V_45 , V_129 , 0 ) ;
V_11 -> V_99 = F_67 ( V_44 , V_124 ) ;
if ( F_16 ( V_11 -> V_99 ) )
...
V_11 -> V_131 [ V_8 ] . V_132 = V_133 [ V_8 ] ;
V_46 = F_69 ( V_44 , V_130 ,
V_11 -> V_131 ) ;
if ( V_46 )
return V_46 ;
V_46 = F_20 ( V_11 ) ;
...
return V_46 ;
if ( V_11 -> V_108 )
V_46 = F_70 ( V_11 -> clock [ V_134 ] ,
V_11 -> V_108 ) ;
else
F_71 ( V_44 , L_24 ) ;
if ( V_46 < 0 )
goto V_135;
V_46 = F_72 ( V_11 -> clock [ V_134 ] ) ;
if ( V_46 < 0 )
goto V_135;
...
F_75 ( & V_11 -> V_4 , & V_137 ) ;
V_11 -> V_4 . V_138 = V_139 ;
snprintf ( V_11 -> V_4 . V_51 , sizeof( V_11 -> V_4 . V_51 ) , L_26 ,
V_140 , V_11 -> V_69 ) ;
V_11 -> V_4 . V_54 |= V_141 ;
V_11 -> V_29 = & V_9 [ 0 ] ;
V_11 -> V_23 . V_10 = V_9 [ 0 ] . V_10 ;
V_11 -> V_23 . V_25 = V_142 ;
V_11 -> V_23 . V_26 = V_143 ;
V_11 -> V_4 . V_144 . V_145 = V_146 ;
V_11 -> V_147 [ V_148 ] . V_54 = V_149 ;
V_11 -> V_147 [ V_79 ] . V_54 = V_150 ;
V_46 = F_76 ( & V_11 -> V_4 . V_144 ,
V_151 , V_11 -> V_147 ) ;
if ( V_46 < 0 )
goto V_136;
F_77 ( & V_11 -> V_4 , V_45 ) ;
F_78 ( V_45 , & V_11 -> V_4 ) ;
memcpy ( V_11 -> V_57 , V_152 , sizeof( V_11 -> V_57 ) ) ;
F_79 ( V_44 ) ;
if ( ! F_80 ( V_44 ) ) {
V_46 = F_81 ( V_44 , true ) ;
if ( V_46 < 0 )
...
F_83 ( & V_11 -> V_4 . V_144 ) ;
V_136:
F_84 ( V_11 -> clock [ V_134 ] ) ;
V_135:
F_15 ( V_11 ) ;
return V_46 ;
}
static int F_85 ( struct V_43 * V_44 , bool V_154 )
{
...
static int F_81 ( struct V_43 * V_44 , bool V_154 )
{
struct V_102 * V_45 = F_86 ( V_44 ) ;
struct V_2 * V_4 = F_87 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
