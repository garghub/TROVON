...
struct V_48 * V_49 ;
F_66 ( ! V_129 || ! V_129 -> V_160 || ! V_129 -> V_160 -> V_85 ) ;
V_49 = (struct V_48 * ) V_129 -> V_160 -> V_85 ;
if ( V_49 -> V_103 )
F_79 (
( unsigned long ) V_49 -> V_103 ) ;
}
static void F_86 ( struct V_159 * V_129 )
{
struct V_48 * V_49 ;
F_66 ( ! V_129 || ! V_129 -> V_160 || ! V_129 -> V_160 -> V_85 ) ;
V_49 = (struct V_48 * ) V_129 -> V_160 -> V_85 ;
...
char V_40 [ 16 ] ;
F_28 ( V_37 , V_40 , sizeof( V_40 ) ) ;
V_163 = F_92 ( V_82 , V_84 -> V_135 % V_84 -> V_95 ) ;
...
if ( V_84 == NULL )
return - V_94 ;
V_33 = F_98 ( V_86 -> V_104 -> V_105 -> V_106 ,
V_37 -> V_116 , & V_84 -> V_1 ) ;
F_53 ( V_33 ) ;
if ( V_33 )
F_60 ( V_84 ) ;
...
return F_92 ( V_82 , V_84 -> V_135 % V_84 -> V_95 ) ;
}
...
static int F_115 ( struct V_48 * V_49 , int V_199 )
{
struct V_200 * V_201 ;
int V_33 ;
T_1 V_202 , V_203 , V_204 ;
T_2 V_205 ;
V_33 = F_116 ( V_49 -> V_104 -> V_105 -> V_106 ,
& V_203 , & V_202 ,
& V_204 , & V_205 , & V_204 ) ;
V_33 = F_117 ( V_49 -> V_86 , L_33 , V_199 ,
V_203 , V_202 , & V_201 ) ;
if ( V_33 < 0 )
return V_33 ;
F_118 ( V_201 , V_114 ,
...
static inline int F_121 ( struct V_160 * V_86 , struct V_210 * V_211 ,
struct V_48 * V_49 )
{
int V_33 ;
V_33 = F_122 ( V_86 , F_123 ( V_211 , V_49 ) ) ;
if ( V_33 < 0 )
return V_33 ;
else if ( V_212 )
F_124 ( & V_49 -> V_64 -> V_65 , L_34 , V_211 -> V_40 , V_211 -> V_106 ) ;
return 0 ;
}
static void F_125 ( struct V_210 * V_213 ,
struct V_214 * V_215 ,
char * V_40 )
{
char * V_216 ;
...
static int F_126 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
...
static int F_129 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
T_2 V_52 = V_231 -> V_217 ;
short V_245 [ V_239 ] ;
F_53 ( F_130 ( V_52 , V_245 ) ) ;
V_244 -> V_241 . integer . V_241 [ 0 ] = V_245 [ 0 ] / V_238 ;
V_244 -> V_241 . integer . V_241 [ 1 ] = V_245 [ 1 ] / V_238 ;
return 0 ;
}
static int F_131 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
int V_246 ;
T_2 V_52 = V_231 -> V_217 ;
...
V_33 = F_121 ( V_86 , & V_213 , V_49 ) ;
if ( V_33 )
return V_33 ;
if ( F_134 ( V_215 -> V_52 , & V_247 ) == 0 ) {
F_125 ( & V_213 , V_215 , L_42 ) ;
V_213 . V_249 = V_250 ;
V_213 . V_184 = V_256 ;
V_213 . V_252 = F_133 ;
V_213 . V_253 = F_135 ;
...
static int F_138 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
T_2 V_52 = V_231 -> V_217 ;
T_1 V_33 ;
...
return F_121 ( V_86 , & V_213 , V_49 ) ;
}
static int F_145 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
return F_146 ( V_233 , 1 , 3 , V_259 ) ;
}
static int F_147 ( struct V_230 * V_231 ,
struct V_243 * V_244 ,
T_1 (* F_148)( T_2 , T_1 * ) )
{
T_2 V_52 = V_231 -> V_217 ;
T_1 V_260 , V_33 ;
V_33 = F_148 ( V_52 , & V_260 ) ;
...
struct V_160 * V_86 = V_49 -> V_86 ;
struct V_210 V_213 ;
F_125 ( & V_213 , V_215 , L_44 ) ;
V_213 . V_249 = V_250 ;
V_213 . V_184 = F_145 ;
V_213 . V_252 = F_150 ;
V_213 . V_253 = F_151 ;
if ( F_121 ( V_86 , & V_213 , V_49 ) < 0 )
return - V_47 ;
F_125 ( & V_213 , V_215 , L_45 ) ;
V_213 . V_249 =
V_267 | V_268 ;
V_213 . V_184 = F_152 ;
V_213 . V_252 = F_153 ;
...
static int F_159 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
T_2 V_52 = V_231 -> V_217 ;
T_1 V_33 ;
...
static int F_161 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
T_2 V_52 = V_231 -> V_217 ;
short V_272 ;
F_53 ( F_162 ( V_52 , & V_272 ) ) ;
...
F_53 ( F_164 ( V_52 , V_272 ) ) ;
return 1 ;
}
static int F_165 ( struct V_230 * V_231 ,
T_1 * V_273 , T_2 V_274 ) {
T_2 V_52 = V_231 -> V_217 ;
T_1 V_33 = 0 ;
T_2 V_275 ;
...
static int F_167 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
T_1 V_277 [ V_278 ] ;
int V_279 = 0 ;
V_279 = F_165 ( V_231 , V_277 ,
V_278 ) ;
if ( V_279 < 0 )
return V_279 ;
return F_146 ( V_233 , 1 , V_279 , V_280 ) ;
}
...
static int F_170 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
T_2 V_52 = V_231 -> V_217 ;
unsigned int V_54 ;
...
V_54 = F_171 ( V_277 ) - 1 ;
V_281 = V_277 [ V_54 ] ;
F_53 ( F_172 ( V_52 , V_281 ) ) ;
return 1 ;
}
static int F_173 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
T_2 V_52 = V_231 -> V_217 ;
T_1 V_33 ;
...
static int F_175 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
T_2 V_52 = V_231 -> V_217 ;
T_2 V_286 ;
F_53 ( F_176 ( V_52 , & V_286 ) ) ;
...
V_213 . V_217 = V_215 -> V_52 ;
V_213 . V_249 = V_250 ;
if ( ! F_162 ( V_215 -> V_52 , NULL ) ) {
F_125 ( & V_213 , V_215 , L_46 ) ;
V_213 . V_184 = F_159 ;
V_213 . V_252 = F_161 ;
V_213 . V_253 = F_163 ;
if ( F_121 ( V_86 , & V_213 , V_49 ) < 0 )
...
F_125 ( & V_213 , V_215 , L_47 ) ;
V_213 . V_184 = F_167 ;
V_213 . V_252 = F_168 ;
V_213 . V_253 = F_170 ;
if ( F_121 ( V_86 , & V_213 , V_49 ) < 0 )
return - V_47 ;
F_125 ( & V_213 , V_215 , L_48 ) ;
V_213 . V_184 = F_173 ;
V_213 . V_252 = F_175 ;
V_213 . V_253 = F_177 ;
return F_121 ( V_86 , & V_213 , V_49 ) ;
}
static int F_180 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
T_2 V_52 = V_231 -> V_217 ;
T_2 V_234 ;
...
static int F_184 ( struct V_230 * V_213 )
{
T_2 V_52 = V_213 -> V_217 ;
struct V_214 V_215 ;
int V_110 , V_33 ;
for ( V_110 = 0 ; V_110 < 32 ; V_110 ++ ) {
V_33 = F_185 ( V_52 , V_110 ,
& V_215 .
V_220 ,
& V_215 .
V_227 ) ;
...
static int F_186 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
int V_33 ;
T_1 V_220 , V_227 ;
...
static int F_189 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
int V_246 ;
T_2 V_52 = V_231 -> V_217 ;
...
if ( ! V_297 )
return - V_47 ;
return F_146 ( V_233 , 1 , V_297 , V_296 ) ;
}
static int F_194 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
T_2 V_52 = V_231 -> V_217 ;
T_1 V_295 ;
...
static int F_196 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
int V_246 ;
T_2 V_52 = V_231 -> V_217 ;
...
static int F_199 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
struct V_48 * V_49 =
...
static int F_203 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
struct V_48 * V_49 =
(struct V_48 * ) ( V_231 -> V_85 ) ;
...
static int F_206 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
V_233 -> type = V_240 ;
V_233 -> V_234 = 1 ;
...
static int F_209 ( struct V_230 * V_231 ,
struct V_243 * V_244 )
{
int V_246 ;
T_2 V_52 = V_231 -> V_217 ;
...
static int F_211 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
V_233 -> type = V_240 ;
V_233 -> V_234 = 1 ;
...
switch ( V_215 . V_314 ) {
case V_316 :
V_33 = F_137 ( V_49 , & V_215 ) ;
break;
case V_317 :
V_33 = F_144 ( V_49 , & V_215 ) ;
break;
case V_318 :
V_33 = F_191 ( V_49 , & V_215 ) ;
break;
case V_319 :
V_33 = F_198 ( V_49 , & V_215 ) ;
break;
case V_320 :
V_33 = F_183 ( V_49 , & V_215 , V_311 ) ;
break;
case V_63 :
V_33 = F_213 (
V_49 , & V_215 ) ;
...
continue;
case V_322 :
V_33 = F_179 ( V_49 , & V_215 ) ;
break;
case V_323 :
V_33 = F_158 ( V_49 , & V_215 ) ;
break;
case V_324 :
V_33 = F_155 ( V_49 , & V_215 ) ;
break;
case V_325 :
case V_326 :
case V_327 :
...
int V_33 ;
F_221 ( V_17 , L_68 ) ;
F_53 ( F_116 ( V_49 -> V_104 -> V_105 -> V_106 ,
& V_203 , & V_202 ,
& V_333 , & V_334 , & type ) ) ;
F_221 ( V_17 ,
L_69
...
{
struct V_330 * V_331 ;
if ( ! F_223 ( V_49 -> V_86 , L_73 , & V_331 ) )
F_224 ( V_331 , V_49 , F_220 ) ;
}
static int F_225 ( struct V_335 * V_193 , struct V_336 * V_336 )
{
if ( V_337 )
return 0 ;
else
...
static int F_228 ( struct V_335 * V_193 , struct V_336 * V_336 ,
unsigned int V_109 , unsigned long V_161 )
{
if ( V_337 )
return F_229 ( V_336 , V_109 , V_161 ) ;
else
return - V_338 ;
}
static int F_230 ( struct V_48 * V_49 , int V_199 )
{
struct V_335 * V_193 ;
int V_33 ;
V_33 = F_231 ( V_49 -> V_86 , L_74 , V_199 , & V_193 ) ;
if ( V_33 < 0 )
return V_33 ;
strcpy ( V_193 -> V_40 , L_75 ) ;
V_193 -> V_218 = V_339 ;
V_193 -> V_340 . V_341 = F_225 ;
V_193 -> V_340 . V_342 = F_228 ;
V_193 -> V_340 . V_343 = F_226 ;
V_193 -> V_85 = V_49 ;
return 0 ;
}
static int F_232 ( struct V_344 * V_344 ,
...
V_33 = F_233 ( V_344 , V_346 ) ;
if ( V_33 < 0 )
return V_33 ;
V_104 = F_234 ( V_344 ) ;
V_13 = V_104 -> V_105 -> V_106 ;
V_33 = F_235 ( & V_344 -> V_65 , V_13 , V_350 [ V_13 ] ,
V_351 , sizeof( struct V_48 ) , & V_86 ) ;
if ( V_33 < 0 ) {
V_33 = F_235 ( & V_344 -> V_65 , V_106 [ V_65 ] , V_350 [ V_65 ] ,
V_351 , sizeof( struct V_48 ) ,
& V_86 ) ;
if ( V_33 < 0 )
return V_33 ;
F_236 ( & V_344 -> V_65 , L_76 ,
V_13 , V_86 -> V_116 ) ;
}
V_49 = V_86 -> V_85 ;
V_49 -> V_86 = V_86 ;
...
static void F_242 ( struct V_344 * V_344 )
{
struct V_159 * V_104 = F_234 ( V_344 ) ;
