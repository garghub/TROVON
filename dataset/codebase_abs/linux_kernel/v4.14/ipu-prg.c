...
T_3 V_36 ;
int V_31 , V_21 ;
V_9 = F_40 ( V_3 , sizeof( * V_9 ) , V_65 ) ;
if ( ! V_9 )
return - V_66 ;
V_64 = F_41 ( V_62 , V_67 , 0 ) ;
V_9 -> V_45 = F_42 ( & V_62 -> V_3 , V_64 ) ;
if ( F_43 ( V_9 -> V_45 ) )
return F_44 ( V_9 -> V_45 ) ;
V_9 -> V_24 = F_45 ( V_3 , L_2 ) ;
if ( F_43 ( V_9 -> V_24 ) )
return F_44 ( V_9 -> V_24 ) ;
V_9 -> V_22 = F_45 ( V_3 , L_3 ) ;
if ( F_43 ( V_9 -> V_22 ) )
return F_44 ( V_9 -> V_22 ) ;
V_9 -> V_39 =
F_46 ( L_4 ) ;
if ( F_43 ( V_9 -> V_39 ) )
return F_44 ( V_9 -> V_39 ) ;
for ( V_31 = 0 ; V_31 < 3 ; V_31 ++ ) {
V_9 -> V_32 [ V_31 ] = F_47 ( V_3 , L_5 , V_31 ) ;
if ( ! V_9 -> V_32 [ V_31 ] )
return - V_68 ;
}
V_21 = F_12 ( V_9 -> V_24 ) ;
