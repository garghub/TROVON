...
F_19 ( V_2 , V_20 ) ;
if ( V_105 -> V_14 & V_113 )
F_99 ( V_109 -> V_111 [ 0 ] . V_112 , V_115 ) ;
F_100 ( V_109 ) ;
if ( F_101 ( & V_105 -> V_116 ) ) {
V_105 -> V_117 = 1 ;
F_21 ( & V_2 -> V_118 ) ;
F_102 ( & V_105 -> V_103 , & F_93 ) ;
}
}
static void F_103 ( struct V_104 * V_105 , int V_22 ) __must_hold( T_4 )
{
struct V_109 * V_109 = F_104 ( V_48 ) ;
struct V_1 * V_2 = V_105 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_19 * V_19 ;
unsigned int V_70 ;
...
F_22 ( V_5 -> V_24 [ V_22 ] ) ;
if ( V_105 -> V_14 & V_113 ) {
V_19 = F_105 ( V_115 , V_52 | V_125 ) ;
F_106 ( V_19 , V_5 -> V_24 [ V_22 ] ) ;
F_11 ( V_19 , V_22 ) ;
} else
V_19 = V_5 -> V_24 [ V_22 ] ;
F_107 ( V_109 , V_2 -> V_76 -> V_126 ) ;
V_109 -> V_127 . V_128 = V_123 ;
F_108 ( V_109 , V_19 , V_70 , 0 ) ;
V_109 -> V_110 = V_105 ;
V_109 -> V_129 = F_96 ;
F_109 ( V_109 , V_119 , 0 ) ;
if ( F_81 ( V_2 , ( V_119 == V_122 ) ? V_130 : V_131 ) ) {
F_110 ( V_109 ) ;
} else {
F_111 ( V_109 ) ;
F_112 ( V_70 >> 9 , & V_2 -> V_132 ) ;
}
}
static int F_113 ( struct V_1 * V_2 , const unsigned int V_14 , unsigned V_133 ) __must_hold( T_4 )
{
struct V_104 * V_105 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned int V_134 , V_41 , V_135 = 0 ;
unsigned long V_136 ;
char V_137 [ 10 ] ;
int V_90 = 0 ;
V_105 = F_114 ( sizeof( struct V_104 ) , V_48 ) ;
if ( ! V_105 )
return - V_54 ;
* V_105 = (struct V_104 ) {
. V_2 = V_2 ,
...
F_117 ( & V_105 -> V_108 , & V_2 -> V_142 ) ;
F_76 ( & V_2 -> V_106 -> V_107 ) ;
V_134 = V_5 -> V_30 ;
V_136 = V_139 ;
if ( V_14 & V_120 ) {
for ( V_41 = 0 ; V_41 < V_134 ; V_41 ++ ) {
F_118 ( & V_105 -> V_116 ) ;
F_103 ( V_105 , V_41 ) ;
++ V_135 ;
F_67 () ;
...
unsigned int V_144 ;
for ( V_144 = 0 ; V_144 < V_5 -> V_29 ; V_144 ++ ) {
V_41 = V_5 -> V_31 [ V_144 ] ;
if ( V_41 >= V_134 )
continue;
if ( ! F_119 ( V_32 ,
...
if ( ! F_101 ( & V_105 -> V_116 ) )
F_120 ( V_2 , V_2 -> V_76 , & V_105 -> V_117 ) ;
else
F_102 ( & V_105 -> V_103 , & F_93 ) ;
if ( V_14 == 0 ) {
unsigned int V_146 = F_121 ( V_139 - V_136 ) ;
if ( V_146 > 5 ) {
F_74 ( V_2 , L_24 ,
...
if ( ( V_14 & ~ V_120 ) == 0 )
F_74 ( V_2 , L_29 ,
F_125 ( V_137 , V_136 << ( V_149 - 10 ) ) , V_136 ) ;
F_102 ( & V_105 -> V_103 , & F_93 ) ;
return V_90 ;
}
int F_126 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_113 ( V_2 , V_120 , 0 ) ;
}
int F_127 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_113 ( V_2 , 0 , 0 ) ;
}
int F_128 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_113 ( V_2 , V_145 , 0 ) ;
}
int F_129 ( struct V_1 * V_2 , unsigned V_150 ) __must_hold( T_4 )
{
return F_113 ( V_2 , V_113 , V_150 ) ;
}
int F_130 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_113 ( V_2 , V_113 , 0 ) ;
}
int F_131 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_113 ( V_2 , V_143 | V_113 , 0 ) ;
}
static unsigned long F_132 ( struct V_1 * V_2 , unsigned long V_151 ,
const int V_152 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_38 ;
...
unsigned V_41 ;
if ( V_151 > V_5 -> V_61 ) {
F_3 ( V_2 , L_30 , V_151 , V_5 -> V_61 ) ;
V_151 = V_154 ;
} else {
while ( V_151 < V_5 -> V_61 ) {
V_153 = V_151 & ~ V_62 ;
V_38 = F_37 ( V_5 , F_36 ( V_5 , V_151 ) ) ;
if ( V_152 )
V_41 = F_133 ( V_38 ,
V_97 * 8 , V_151 & V_62 ) ;
else
...
if ( V_156 & V_5 -> V_18 )
F_136 ( V_2 ) ;
V_41 = F_132 ( V_2 , V_151 , V_152 ) ;
F_76 ( & V_5 -> V_55 ) ;
return V_41 ;
}
unsigned long F_137 ( struct V_1 * V_2 , unsigned long V_151 )
{
return F_135 ( V_2 , V_151 , 0 ) ;
}
unsigned long F_138 ( struct V_1 * V_2 , unsigned long V_151 )
{
return F_132 ( V_2 , V_151 , 0 ) ;
}
unsigned long F_139 ( struct V_1 * V_2 , unsigned long V_151 )
{
return F_132 ( V_2 , V_151 , 1 ) ;
}
static int F_140 ( struct V_1 * V_2 , const unsigned long V_99 ,
...
F_3 ( V_2 , L_31 ,
V_99 , V_157 , V_5 -> V_61 ) ;
V_157 = V_5 -> V_61 ? V_5 -> V_61 - 1 : 0 ;
}
for ( V_37 = V_99 ; V_37 <= V_157 ; V_37 ++ ) {
...
if ( V_158 )
V_69 += ( 0 == F_141 ( V_37 & V_62 , V_38 ) ) ;
else
V_69 -= ( 0 != F_142 ( V_37 & V_62 , V_38 ) ) ;
}
if ( V_38 )
F_40 ( V_38 ) ;
if ( V_69 < 0 )
...
static int F_143 ( struct V_1 * V_2 , const unsigned long V_99 ,
...
return 0 ;
F_83 ( & V_5 -> V_55 , V_14 ) ;
if ( ( V_158 ? V_161 : V_162 ) & V_5 -> V_18 )
F_136 ( V_2 ) ;
V_69 = F_140 ( V_2 , V_99 , V_157 , V_158 ) ;
F_84 ( & V_5 -> V_55 , V_14 ) ;
return V_69 ;
}
int F_144 ( struct V_1 * V_2 , const unsigned long V_99 , const unsigned long V_157 )
{
return F_143 ( V_2 , V_99 , V_157 , 1 ) ;
}
int F_145 ( struct V_1 * V_2 , const unsigned long V_99 , const unsigned long V_157 )
{
return - F_143 ( V_2 , V_99 , V_157 , 0 ) ;
}
static inline void F_146 ( struct V_4 * V_5 ,
int V_22 , int V_163 , int V_66 )
{
int V_41 ;
int V_65 ;
int V_164 = 0 ;
unsigned long * V_165 = F_38 ( V_5 -> V_24 [ V_22 ] ) ;
for ( V_41 = V_163 ; V_41 < V_66 ; V_41 ++ ) {
V_65 = F_63 ( V_165 [ V_41 ] ) ;
V_165 [ V_41 ] = ~ 0UL ;
V_164 += V_64 - V_65 ;
}
F_41 ( V_165 ) ;
...
void F_147 ( struct V_1 * V_2 , const unsigned long V_99 , const unsigned long V_157 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long V_166 = F_70 ( V_99 , V_64 ) ;
unsigned long V_167 = ( V_157 + 1 ) & ~ ( ( unsigned long ) V_64 - 1 ) ;
int V_168 ;
int V_169 ;
int V_22 ;
int V_163 ;
int V_66 ;
if ( V_157 - V_99 <= 3 * V_64 ) {
F_75 ( & V_5 -> V_55 ) ;
F_140 ( V_2 , V_99 , V_157 , 1 ) ;
F_76 ( & V_5 -> V_55 ) ;
return;
}
F_75 ( & V_5 -> V_55 ) ;
if ( V_166 )
F_140 ( V_2 , V_99 , V_166 - 1 , 1 ) ;
V_168 = V_166 >> ( 3 + V_35 ) ;
V_169 = V_167 >> ( 3 + V_35 ) ;
V_163 = F_71 ( V_166 >> V_36 ) ;
V_66 = V_74 ;
for ( V_22 = V_168 ; V_22 < V_169 ; V_22 ++ ) {
F_146 ( V_2 -> V_6 , V_22 , V_163 , V_66 ) ;
F_76 ( & V_5 -> V_55 ) ;
F_67 () ;
V_163 = 0 ;
F_75 ( & V_5 -> V_55 ) ;
}
V_66 = F_71 ( V_167 >> V_36 ) ;
if ( V_66 )
F_146 ( V_2 -> V_6 , V_169 , V_163 , V_66 ) ;
if ( V_167 <= V_157 )
F_140 ( V_2 , V_167 , V_157 , 1 ) ;
F_76 ( & V_5 -> V_55 ) ;
}
int F_148 ( struct V_1 * V_2 , const unsigned long V_37 )
{
unsigned long V_14 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_38 ;
...
int F_150 ( struct V_1 * V_2 , const unsigned long V_99 , const unsigned long V_157 )
{
unsigned long V_14 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_38 = NULL ;
...
V_69 += ( 0 != F_149 ( V_37 - ( V_22 << ( V_35 + 3 ) ) , V_38 ) ) ;
else
...
int F_151 ( struct V_1 * V_2 , unsigned long V_170 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
int V_135 , V_99 , V_157 ;
unsigned long V_14 ;
unsigned long * V_38 , * V_58 ;
if ( ! F_58 ( V_5 ) )
return 0 ;
...
F_136 ( V_2 ) ;
V_99 = F_152 ( V_170 ) ;
V_157 = F_153 ( ( T_3 ) F_152 ( V_170 + 1 ) , V_5 -> V_73 ) ;
V_135 = 0 ;
if ( V_99 < V_5 -> V_73 ) {
int V_171 = V_157 - V_99 ;
V_38 = F_39 ( V_5 , F_35 ( V_5 , V_99 ) ) ;
V_58 = V_38 + F_71 ( V_99 ) ;
V_135 += F_66 ( V_58 , V_171 * V_64 ) ;
F_42 ( V_38 ) ;
} else {
F_3 ( V_2 , L_34 , V_99 ) ;
}
