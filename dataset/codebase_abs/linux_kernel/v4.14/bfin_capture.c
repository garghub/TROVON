...
V_5 = F_63 ( sizeof( * V_5 ) , V_20 ) ;
if ( ! V_5 )
return - V_21 ;
V_5 -> V_65 = V_121 ;
V_5 -> V_50 = F_64 ( V_167 , V_121 -> V_176 ) ;
if ( ! V_5 -> V_50 ) {
...
V_55 = F_65 ( & V_167 -> V_173 , & V_5 -> V_41 ) ;
if ( V_55 ) {
...
static int F_82 ( struct V_166 * V_167 )
{
struct V_210 * V_41 = F_83 ( V_167 ) ;
