...
struct V_15 * V_16 = V_31 -> V_16 ;
struct V_34 * V_35 = & V_16 -> V_36 ;
struct V_78 * V_111 = V_77 -> V_80 ;
struct V_95 * V_96 = (struct V_95 * )
( V_77 -> V_80 + V_83 ) ;
T_4 V_112 = ( T_4 ) ( V_111 -> V_81 & 0xffff ) ;
F_27 ( V_31 , V_77 ) ;
V_96 -> V_97 = F_15 ( ( ( V_112 - V_82 ) &
0x0000ffff ) | ( V_96 -> V_97 &
0xffff0000 ) ) ;
...
if ( ( V_35 -> V_116 && ( ( V_112 + V_83 ) % 0x200 ) ==
0 ) || ( ( ! V_35 -> V_116 && ( ( V_112 + V_83 ) %
0x40 ) == 0 ) ) ) {
V_111 -> V_81 |= F_15
( ( ( V_83 + V_84 + 8 ) << V_85 ) &
0x00ff0000 ) ;
...
struct V_78 * V_164 ;
V_164 = & V_134 ;
V_111 -> V_139 = V_164 -> V_139 ;
if ( V_129 )
V_111 -> V_139 |= F_15 ( V_155 ) ;
V_111 -> V_139 |= F_15 ( V_160 ) ;
V_111 -> V_161 = V_164 -> V_161 ;
V_111 -> V_162 = V_164 -> V_162 ;
V_18 -> V_163 = 0 ;
}
} else if ( V_31 -> V_37 == V_40 ) {
V_111 -> V_89 |= F_15 ( ( 0x05 ) & 0x1f ) ;
V_43 = ( V_106 ) ( V_18 -> V_43 & 0x0000001f ) ;
V_111 -> V_89 |= F_15 ( ( V_43 << V_90 ) & 0x00001f00 ) ;
V_111 -> V_89 |= F_15 ( F_31 ( 16 ) ) ;
if ( V_129 )
