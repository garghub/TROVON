...
static struct V_1 * F_10 ( void * V_4 ,
unsigned char * V_12 )
{
int V_13 ;
struct V_1 * V_2 = F_11 () ;
...
static struct V_1 * F_15 ( void * V_4 )
{
int V_37 , V_38 ;
struct V_39 * V_40 ;
struct V_1 * V_2 = F_11 () ;
...
static int F_25 ( struct V_55 * V_5 )
{
const T_1 * V_68 ;
enum V_56 V_57 ;
V_68 = F_26 ( V_5 -> V_69 ) ;
...
static void F_30 ( struct V_55 * V_5 )
{
...
static void F_32 ( struct V_1 * V_2 , int V_30 ,
int V_74 )
{
int V_75 ;
switch ( V_30 ) {
...
static int F_37 ( int V_79 )
{
if ( V_79 > 0xff )
return V_63 [ ( V_79 >> 8 ) & 0xff ] ;
return V_62 [ V_79 ] ;
}
static int F_38 ( int V_80 )
{
switch ( V_80 ) {
case 1 :
return V_42 ;
...
static void F_39 ( struct V_55 * V_5 )
{
struct V_81 V_82 ;
int V_79 , V_30 ;
struct V_1 * V_2 ;
...
static int F_43 ( struct V_55 * V_5 ,
T_2 V_101 )
{
int V_102 ;
struct V_3 * V_4 = F_31 ( & V_5 -> V_66 ) ;
...
static int F_44 ( struct V_55 * V_5 ,
T_2 V_101 )
{
int V_102 ;
struct V_3 * V_4 = F_31 ( & V_5 -> V_66 ) ;
