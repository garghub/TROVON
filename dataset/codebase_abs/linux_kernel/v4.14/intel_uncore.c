...
F_103 ;
if ( F_106 ( V_25 , 2 , 4 ) || F_96 ( V_25 ) ) {
F_107 ( V_25 , V_126 ) ;
F_108 ( V_25 , V_126 ) ;
} else if ( F_109 ( V_25 ) ) {
F_107 ( V_25 , V_127 ) ;
F_108 ( V_25 , V_127 ) ;
} else if ( F_106 ( V_25 , 6 , 7 ) ) {
F_107 ( V_25 , V_128 ) ;
if ( F_26 ( V_25 ) ) {
F_110 ( V_129 ) ;
F_108 ( V_25 , V_130 ) ;
...
int F_113 ( struct V_134 * V_135 ,
void * V_119 , struct V_136 * V_137 )
{
struct V_5 * V_25 = F_114 ( V_135 ) ;
...
switch ( V_141 ) {
case 8 | 1 :
V_82 -> V_148 = F_117 ( V_142 , V_143 ) ;
break;
case 8 :
V_82 -> V_148 = F_118 ( V_142 ) ;
break;
case 4 :
...
static void F_123 ( struct V_5 * V_25 )
{
struct V_150 * V_151 ;
enum V_152 V_2 ;
F_124 (engine, dev_priv, id) {
const T_1 V_153 = V_151 -> V_154 ;
const T_3 V_155 = F_125 ( V_153 ) ;
F_126 ( V_155 , F_98 ( V_156 ) ) ;
if ( F_127 ( V_25 ,
V_155 ,
V_157 ,
V_157 ,
...
F_126 ( F_129 ( V_153 ) , 0 ) ;
F_126 ( F_130 ( V_153 ) , 0 ) ;
if ( F_131 ( F_129 ( V_153 ) ) != 0 )
F_59 ( L_17 ,
V_151 -> V_158 ) ;
}
}
static bool F_132 ( struct V_159 * V_160 )
{
T_5 V_161 ;
F_133 ( V_160 , V_162 , & V_161 ) ;
return ( V_161 & V_163 ) == 0 ;
}
static int F_134 ( struct V_5 * V_25 , unsigned V_164 )
{
struct V_159 * V_160 = V_25 -> V_165 . V_160 ;
F_135 ( V_160 , V_162 , V_166 ) ;
F_136 ( 50 , 200 ) ;
F_135 ( V_160 , V_162 , 0 ) ;
return F_137 ( F_132 ( V_160 ) , 500 ) ;
}
static bool F_138 ( struct V_159 * V_160 )
{
T_5 V_161 ;
F_133 ( V_160 , V_162 , & V_161 ) ;
return ( V_161 & V_166 ) == 0 ;
}
static int F_139 ( struct V_5 * V_25 , unsigned V_164 )
{
struct V_159 * V_160 = V_25 -> V_165 . V_160 ;
F_123 ( V_25 ) ;
F_135 ( V_160 , V_162 , V_166 ) ;
return F_137 ( F_138 ( V_160 ) , 500 ) ;
}
...
static int F_143 ( struct V_5 * V_25 ,
unsigned V_164 )
{
int V_67 ;
F_141 ( V_171 , V_172 | V_173 ) ;
V_67 = F_144 ( V_25 ,
V_171 , V_173 , 0 ,
500 ) ;
if ( V_67 ) {
...
static int F_145 ( struct V_5 * V_25 ,
T_1 V_175 )
{
int V_176 ;
...
unsigned int V_23 ;
V_190 = 0 ;
F_147 (engine, dev_priv, engine_mask, tmp)
V_190 |= V_178 [ V_151 -> V_2 ] ;
}
return F_145 ( V_25 , V_190 ) ;
}
int F_148 ( struct V_5 * V_25 ,
T_3 V_82 ,
T_1 V_45 ,
T_1 V_193 ,
unsigned int V_194 ,
...
{
T_1 V_197 ( V_198 ) ;
#define F_149 (((reg_value = I915_READ_FW(reg)) & mask) == value)
int V_67 ;
F_150 ( V_195 ) ;
F_17 ( V_194 > 20000 ) ;
V_67 = - V_199 ;
if ( V_194 && V_194 <= 20000 )
V_67 = F_151 ( F_149 , V_194 , 0 ) ;
if ( V_67 && V_195 )
V_67 = F_137 ( F_149 , V_195 ) ;
if ( V_196 )
* V_196 = V_198 ;
return V_67 ;
#undef F_149
}
int F_144 ( struct V_5 * V_25 ,
T_3 V_82 ,
T_1 V_45 ,
T_1 V_193 ,
unsigned int V_200 )
...
F_102 ( & V_25 -> V_10 . V_42 ) ;
if ( V_67 )
V_67 = F_137 ( ( F_154 ( V_82 ) & V_45 ) == V_193 ,
V_200 ) ;
return V_67 ;
}
static int F_155 ( struct V_150 * V_151 )
{
struct V_5 * V_25 = V_151 -> V_6 ;
int V_67 ;
F_126 ( F_156 ( V_151 -> V_154 ) ,
F_98 ( V_202 ) ) ;
V_67 = F_127 ( V_25 ,
F_156 ( V_151 -> V_154 ) ,
V_203 ,
...
static void F_157 ( struct V_150 * V_151 )
{
struct V_5 * V_25 = V_151 -> V_6 ;
F_126 ( F_156 ( V_151 -> V_154 ) ,
F_97 ( V_202 ) ) ;
}
static int F_158 ( struct V_5 * V_25 ,
unsigned V_164 )
{
struct V_150 * V_151 ;
unsigned int V_23 ;
...
if ( F_155 ( V_151 ) )
goto V_204;
return F_146 ( V_25 , V_164 ) ;
V_204:
F_147 (engine, dev_priv, engine_mask, tmp)
F_157 ( V_151 ) ;
return - V_205 ;
}
static T_6 F_159 ( struct V_5 * V_25 )
{
if ( ! V_6 . V_206 )
return NULL ;
if ( F_115 ( V_25 ) -> V_207 >= 8 )
return F_158 ;
else if ( F_115 ( V_25 ) -> V_207 >= 6 )
return F_146 ;
else if ( F_109 ( V_25 ) )
return F_143 ;
else if ( F_160 ( V_25 ) )
return F_140 ;
else if ( F_161 ( V_25 ) || F_162 ( V_25 ) )
return F_139 ;
else if ( F_115 ( V_25 ) -> V_207 >= 3 )
return F_134 ;
else
return NULL ;
}
int F_163 ( struct V_5 * V_25 , unsigned V_164 )
{
T_6 V_206 ;
int V_208 ;
int V_67 ;
...
bool F_164 ( struct V_5 * V_25 )
{
return F_159 ( V_25 ) != NULL ;
}
bool F_165 ( struct V_5 * V_25 )
{
return ( V_25 -> V_210 . V_211 &&
! V_25 -> V_212 . V_213 &&
V_6 . V_206 >= 2 ) ;
}
...
enum V_21
F_152 ( struct V_5 * V_25 ,
T_3 V_82 , unsigned int V_215 )
{
enum V_21 V_22 = 0 ;
F_4 ( ! V_215 ) ;
if ( F_96 ( V_25 ) )
