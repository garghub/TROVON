...
struct V_12 * V_12 )
{
int V_80 = F_45 ( V_12 ) -> F_46 ( V_79 , V_51 ) ;
if ( V_80 != 0 )
return V_80 ;
F_47 ( V_12 , V_81 , V_51 -> V_82 . V_83 ) ;
F_48 ( V_12 , V_79 -> V_84 ,
V_51 -> args . V_85 , V_51 -> V_82 . V_86 ) ;
if ( V_79 -> V_84 == - V_87 ) {
F_49 ( V_88 , & F_33 ( V_12 ) -> V_54 ) ;
F_50 ( V_12 ) ;
}
return 0 ;
}
...
struct V_1 * V_51 )
{
struct V_89 * V_90 = & V_51 -> args ;
struct V_91 * V_92 = & V_51 -> V_82 ;
F_52 ( V_51 -> V_12 , V_93 ) ;
if ( V_92 -> V_83 == 0 ) {
F_53 ( V_51 , - V_94 , V_90 -> V_85 ) ;
return;
}
if ( ! V_79 -> V_95 ) {
V_51 -> V_96 = - V_97 ;
...
if ( V_51 -> V_82 . V_86 ) {
T_1 V_100 ;
V_100 = V_51 -> args . V_85 + V_51 -> V_82 . V_83 ;
F_56 ( & V_51 -> V_101 ) ;
if ( V_100 < V_51 -> V_75 + V_51 -> V_62 ) {
F_49 ( V_61 , & V_51 -> V_54 ) ;
F_57 ( V_63 , & V_51 -> V_54 ) ;
V_51 -> V_62 = V_100 - V_51 -> V_75 ;
}
F_58 ( & V_51 -> V_101 ) ;
} else if ( V_51 -> V_82 . V_83 < V_51 -> args . V_83 )
F_51 ( V_79 , V_51 ) ;
}
int F_59 ( struct V_102 * V_102 , struct V_8 * V_8 )
{
struct V_41 * V_42 ;
struct V_12 * V_12 = F_60 ( V_8 ) -> V_103 ;
int error ;
F_17 ( L_2 ,
V_8 , V_9 , F_61 ( V_8 ) ) ;
F_52 ( V_12 , V_104 ) ;
...
if ( V_102 == NULL ) {
error = - V_107 ;
V_42 = F_64 ( V_12 , NULL , V_6 ) ;
if ( V_42 == NULL )
goto V_106;
} else
V_42 = F_65 ( F_66 ( V_102 ) ) ;
if ( ! F_67 ( V_12 ) ) {
error = F_68 ( V_42 , V_12 , V_8 ) ;
if ( error == 0 )
goto V_55;
}
...
static int
F_70 ( void * V_108 , struct V_8 * V_8 )
{
...
int F_71 ( struct V_102 * V_112 , struct V_113 * V_114 ,
struct V_76 * V_56 , unsigned V_115 )
{
struct V_10 V_11 ;
struct V_25 * V_45 ;
struct V_109 V_110 = {
...
goto V_55;
if ( V_112 == NULL ) {
V_110 . V_42 = F_64 ( V_12 , NULL , V_6 ) ;
if ( V_110 . V_42 == NULL )
return - V_107 ;
} else
V_110 . V_42 = F_65 ( F_66 ( V_112 ) ) ;
V_117 = F_72 ( V_110 . V_42 , V_12 , V_114 ,
V_56 , & V_115 ) ;
if ( V_117 == 0 )
goto V_119;
F_9 ( & V_11 , V_12 , false ,
& V_46 ) ;
V_117 = F_73 ( V_114 , V_56 , F_70 , & V_110 ) ;
F_32 ( & V_11 ) ;
F_14 ( V_11 . V_28 != 1 ) ;
V_45 = & V_11 . V_29 [ 0 ] ;
F_33 ( V_12 ) -> V_47 += V_45 -> V_48 ;
