...
static int
F_34 ( struct V_10 * V_10 , const struct V_44 * V_4 )
{
struct V_1 * V_2 ;
int V_45 = - V_46 ;
void * V_39 = NULL ;
...
static void F_50 ( struct V_5 * V_6 , void * V_7 )
{
struct V_54 * V_2 = V_7 ;
F_7 ( V_2 -> V_55 ) -> F_51 ( V_6 , V_2 ) ;
}
struct V_5 *
F_52 ( struct V_8 * V_55 , struct V_8 * V_56 ,
...
V_2 -> args . V_65 = & V_57 -> V_66 ;
V_2 -> args . V_56 = F_20 ( V_56 ) ;
V_2 -> args . V_67 = & V_58 -> V_66 ;
V_2 -> V_21 . V_63 = & V_2 -> V_63 ;
V_2 -> V_21 . V_64 = & V_2 -> V_64 ;
F_19 ( V_55 -> V_32 ) ;
F_7 ( V_2 -> V_55 ) -> F_57 ( & V_18 , V_55 ) ;
return F_24 ( & V_24 ) ;
}
static void
F_58 ( struct V_5 * V_6 , struct V_54 * V_2 )
{
...
int
F_60 ( struct V_8 * V_9 , struct V_10 * V_10 )
{
static unsigned int V_68 ;
unsigned char V_69 [ V_70 + 1 ] ;
...
goto V_48;
V_71 = F_64 ( F_5 ( V_10 ) ) ;
F_7 ( F_5 ( V_10 ) ) -> F_65 ( F_5 ( V_10 ) ) ;
V_72 = NULL ;
do {
int V_75 ;
F_14 ( V_72 ) ;
V_68 ++ ;
V_75 = F_66 ( V_69 , sizeof( V_69 ) ,
V_76 L_2 ,
V_77 , V_71 ,
V_78 , V_68 ) ;
F_61 ( V_73 , L_3 ,
V_10 , V_69 ) ;
V_72 = F_67 ( V_69 , V_10 -> V_11 , V_75 ) ;
if ( F_25 ( V_72 ) )
goto V_48;
} while ( F_5 ( V_72 ) != NULL );
error = F_34 ( V_10 , & V_72 -> V_66 ) ;
if ( error )
goto V_79;
V_6 = F_52 ( V_9 , V_9 , V_10 , V_72 ,
F_58 ) ;
if ( F_25 ( V_6 ) ) {
error = - V_52 ;
F_42 ( V_10 ) ;
