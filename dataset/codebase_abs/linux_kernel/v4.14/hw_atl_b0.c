...
F_93 ( V_2 , 0U ) ;
F_167 ( V_2 , 1U ) ;
if ( V_2 -> V_24 -> V_173 == V_174 ) {
int V_176 = V_2 -> V_24 -> V_177 / 2 ;
int V_178 = V_176 / 2 ;
int V_179 = V_2 -> V_24 -> V_180 / 2 ;
int V_181 = V_179 / 2 ;
V_176 = F_168 ( V_182 , V_176 ) ;
V_178 = F_168 ( V_183 , V_178 ) ;
V_179 = F_168 ( V_182 , V_179 ) ;
V_181 = F_168 ( V_183 , V_181 ) ;
V_171 |= V_178 << 0x8U ;
V_171 |= V_176 << 0x10U ;
V_172 |= V_181 << 0x8U ;
V_172 |= V_179 << 0x10U ;
} else {
static unsigned int V_184 [] [ 2 ] = {
{ 0xfU , 0xffU } ,
{ 0xfU , 0x1ffU } ,
{ 0xfU , 0x1ffU } ,
{ 0xfU , 0x1ffU } ,
...
F_169 (
V_2 -> V_187 . V_188 ) ;
V_2 -> V_24 -> V_177 = V_184
[ V_186 ] [ 1 ] * 2 ;
V_2 -> V_24 -> V_180 = V_185
[ V_186 ] [ 1 ] * 2 ;
V_171 |= V_184
[ V_186 ] [ 0 ] << 0x8U ;
V_171 |= V_184
...
for ( V_31 = V_43 ; V_31 -- ; ) {
F_170 ( V_2 , V_171 , V_31 ) ;
F_171 ( V_2 , V_172 , V_31 ) ;
}
return F_19 ( V_2 ) ;
}
...
static int F_175 ( struct V_1 * V_2 , T_1 V_191 )
{
int V_16 = 0 ;
V_16 = F_176 ( V_2 , V_191 , V_57 ) ;
if ( V_16 < 0 )
goto V_13;
V_13:
return V_16 ;
}
struct V_9 * F_177 ( struct V_192 * V_193 )
{
bool V_194 = ( V_193 -> V_195 == V_196 ) ;
bool V_197 = ( ( V_193 -> V_133 == V_198 ) ||
( V_193 -> V_133 == V_199 ) ||
( V_193 -> V_133 == V_200 ) ||
( V_193 -> V_133 == V_201 ) ||
( V_193 -> V_133 == V_202 ) ) ;
bool V_203 = ( V_193 -> V_204 == 2U ) ;
return ( V_194 && V_197 && V_203 ) ? & V_205 : NULL ;
}
