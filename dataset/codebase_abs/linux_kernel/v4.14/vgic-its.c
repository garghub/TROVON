...
struct V_4 * V_5 = NULL ;
struct V_34 * V_36 ;
struct V_40 * V_42 , * V_149 = NULL ;
struct V_1 * V_10 ;
int V_150 ;
V_36 = F_18 ( V_28 , V_35 ) ;
if ( ! V_36 )
return V_151 ;
if ( V_38 >= F_57 ( V_36 -> V_152 ) )
return V_153 ;
if ( F_74 ( V_122 ) == V_154 )
V_150 = F_75 ( V_122 ) ;
else
...
{
T_1 V_35 = F_59 ( V_122 ) ;
bool V_160 = F_82 ( V_122 ) ;
T_3 V_152 = F_83 ( V_122 ) ;
T_4 V_158 = F_84 ( V_122 ) ;
struct V_34 * V_36 ;
if ( ! F_63 ( V_28 , V_28 -> V_161 , V_35 , NULL ) )
return V_162 ;
if ( V_160 && V_152 > V_75 )
return V_163 ;
V_36 = F_18 ( V_28 , V_35 ) ;
...
{
struct V_6 * V_7 = & V_2 -> V_8 . V_9 ;
T_1 V_169 = F_86 ( V_122 ) ;
T_1 V_170 = F_55 ( V_122 , 3 , 16 , 32 ) ;
struct V_4 * V_171 , * V_172 ;
struct V_1 * V_10 ;
if ( V_169 >= F_87 ( & V_2 -> V_164 ) ||
V_170 >= F_87 ( & V_2 -> V_164 ) )
return V_173 ;
if ( V_169 == V_170 )
return 0 ;
V_171 = F_30 ( V_2 , V_169 ) ;
V_172 = F_30 ( V_2 , V_170 ) ;
F_8 ( & V_7 -> V_22 ) ;
F_9 (irq, &dist->lpi_list_head, lpi_list) {
F_8 ( & V_10 -> V_17 ) ;
if ( V_10 -> V_21 == V_171 )
...
T_2 * V_122 )
{
T_1 V_174 = F_60 ( V_122 ) ;
T_2 V_175 = F_59 ( V_122 ) ;
return F_45 ( V_2 , V_28 , V_175 , V_174 ) ;
}
...
{
V_71 = F_95 ( V_71 , V_187 ,
V_188 ,
V_189 ) ;
V_71 = F_95 ( V_71 , V_190 ,
V_191 ,
V_192 ) ;
V_71 = F_95 ( V_71 , V_193 ,
V_194 ,
V_195 ) ;
V_71 &= ~ F_69 ( 15 , 12 ) ;
V_71 = ( V_71 & ~ V_196 ) | V_197 ;
return V_71 ;
}
static T_2 F_96 ( T_2 V_71 )
{
V_71 = F_95 ( V_71 , V_198 ,
V_199 ,
V_189 ) ;
...
T_4 V_69 , unsigned int V_70 )
{
return F_40 ( V_28 -> V_204 , V_69 & 7 , V_70 ) ;
}
...
return;
F_51 ( & V_28 -> V_205 ) ;
V_28 -> V_204 = F_99 ( V_28 -> V_204 , V_69 & 7 , V_70 , V_79 ) ;
V_28 -> V_204 = F_96 ( V_28 -> V_204 ) ;
V_28 -> V_206 = 0 ;
V_28 -> V_207 = V_28 -> V_206 ;
F_52 ( & V_28 -> V_205 ) ;
}
...
if ( ! V_28 -> V_50 )
return;
V_204 = F_101 ( V_28 -> V_204 ) ;
while ( V_28 -> V_207 != V_28 -> V_206 ) {
int V_12 = F_22 ( V_2 , V_204 + V_28 -> V_206 ,
V_208 , V_209 ) ;
if ( ! V_12 )
F_93 ( V_2 , V_28 , V_208 ) ;
V_28 -> V_206 += V_209 ;
if ( V_28 -> V_206 == F_102 ( V_28 -> V_204 ) )
V_28 -> V_206 = 0 ;
}
}
...
return;
F_51 ( & V_28 -> V_205 ) ;
V_71 = F_99 ( V_28 -> V_207 , V_69 & 7 , V_70 , V_79 ) ;
V_71 = F_104 ( V_71 ) ;
if ( V_71 >= F_102 ( V_28 -> V_204 ) ) {
F_52 ( & V_28 -> V_205 ) ;
return;
}
V_28 -> V_207 = V_71 ;
...
T_4 V_69 , unsigned int V_70 )
{
return F_40 ( V_28 -> V_207 , V_69 & 0x7 , V_70 ) ;
}
static unsigned long F_106 ( struct V_2 * V_2 ,
struct V_27 * V_28 ,
T_4 V_69 , unsigned int V_70 )
{
return F_40 ( V_28 -> V_206 , V_69 & 0x7 , V_70 ) ;
}
...
V_71 = F_99 ( * V_214 , V_69 & 7 , V_70 , V_79 ) ;
V_71 &= ~ V_218 ;
V_71 &= ~ V_215 ;
V_71 |= ( V_212 - 1 ) << V_219 ;
V_71 |= V_213 << V_220 ;
...
{
F_51 ( & V_28 -> V_205 ) ;
if ( ! V_28 -> V_50 && ( V_79 & V_222 ) &&
( ! ( V_28 -> V_161 & V_223 ) ||
! ( V_28 -> V_143 & V_223 ) ||
! ( V_28 -> V_204 & V_224 ) ) )
goto V_211;
V_28 -> V_50 = ! ! ( V_79 & V_222 ) ;
F_100 ( V_2 , V_28 ) ;
V_211:
F_52 ( & V_28 -> V_205 ) ;
}
...
struct V_243 * V_244 , * V_156 ;
if ( ! V_28 -> V_159 . V_245 )
return;
F_51 ( & V_28 -> V_119 ) ;
F_124 (cur, temp, &its->device_list) {
struct V_34 * V_103 ;
V_103 = F_125 ( V_244 , struct V_34 , V_157 ) ;
F_122 ( V_2 , V_103 ) ;
}
...
struct V_34 * V_245 ;
T_1 V_262 ;
if ( F_132 ( & V_103 -> V_157 , V_261 ) )
return 0 ;
V_245 = F_133 ( V_103 , V_157 ) ;
...
char V_270 [ V_135 ] ;
int V_12 ;
memset ( V_270 , 0 , V_135 ) ;
while ( V_70 > 0 ) {
int V_262 ;
T_9 V_64 ;
V_12 = F_22 ( V_2 , V_269 , V_270 , V_135 ) ;
if ( V_12 )
return V_12 ;
V_262 = V_267 ( V_28 , V_130 , V_270 , V_268 ) ;
if ( V_262 <= 0 )
return V_262 ;
V_64 = V_262 * V_135 ;
V_130 += V_262 ;
...
struct V_37 * V_39 , T_4 V_269 , int V_77 )
{
struct V_2 * V_2 = V_28 -> V_103 -> V_2 ;
T_1 V_262 ;
T_2 V_79 ;
V_262 = F_135 ( & V_103 -> V_148 , V_39 ) ;
V_79 = ( ( T_2 ) V_262 << V_271 ) |
( ( T_2 ) V_39 -> V_10 -> V_3 << V_272 ) |
V_39 -> V_42 -> V_43 ;
V_79 = F_138 ( V_79 ) ;
return F_139 ( V_2 , V_269 , & V_79 , V_77 ) ;
}
...
V_79 = F_56 ( V_79 ) ;
V_41 = V_79 & V_276 ;
V_275 = ( V_79 & V_277 ) >> V_272 ;
if ( ! V_275 )
return 1 ;
if ( V_275 < V_278 )
return - V_86 ;
V_250 = V_79 >> V_271 ;
if ( V_38 + V_250 >= F_57 ( V_103 -> V_152 ) )
return - V_86 ;
V_42 = F_20 ( V_28 , V_41 ) ;
if ( ! V_42 )
return - V_86 ;
V_39 = F_72 ( V_103 , V_42 , V_38 ) ;
if ( F_76 ( V_39 ) )
return F_77 ( V_39 ) ;
if ( F_29 ( V_42 ) )
V_5 = F_30 ( V_2 , V_42 -> V_55 ) ;
V_10 = F_1 ( V_2 , V_275 , V_5 ) ;
if ( F_76 ( V_10 ) )
return F_77 ( V_10 ) ;
V_39 -> V_10 = V_10 ;
return V_250 ;
}
static int F_141 ( void * V_279 , struct V_243 * V_280 ,
struct V_243 * V_281 )
{
struct V_37 * V_282 = F_47 ( V_280 , struct V_37 , V_121 ) ;
struct V_37 * V_283 = F_47 ( V_281 , struct V_37 , V_121 ) ;
if ( V_282 -> V_38 < V_283 -> V_38 )
return - 1 ;
else
return 1 ;
}
...
{
const struct V_26 * V_32 = F_16 ( V_28 ) ;
T_4 V_265 = V_36 -> V_158 ;
struct V_37 * V_39 ;
int V_12 ;
int V_77 = V_32 -> V_77 ;
F_143 ( NULL , & V_36 -> V_148 , F_141 ) ;
F_9 (ite, &device->itt_head, ite_list) {
T_4 V_269 = V_265 + V_39 -> V_38 * V_77 ;
V_12 = F_137 ( V_28 , V_36 , V_39 , V_269 , V_77 ) ;
if ( V_12 )
return V_12 ;
}
return 0 ;
...
{
const struct V_26 * V_32 = F_16 ( V_28 ) ;
T_4 V_265 = V_103 -> V_158 ;
int V_12 ;
int V_77 = V_32 -> V_77 ;
T_9 V_284 = F_57 ( V_103 -> V_152 ) * V_77 ;
V_12 = F_136 ( V_28 , V_265 , V_284 , V_77 , 0 ,
F_140 , V_103 ) ;
if ( V_12 > 0 )
V_12 = 0 ;
return V_12 ;
...
T_1 V_262 ;
V_285 = V_103 -> V_158 >> 8 ;
V_262 = F_131 ( & V_28 -> V_159 , V_103 ) ;
V_79 = ( 1ULL << V_286 |
( ( T_2 ) V_262 << V_287 ) |
( V_285 << V_288 ) |
( V_103 -> V_152 - 1 ) ) ;
V_79 = F_138 ( V_79 ) ;
return F_139 ( V_2 , V_273 , & V_79 , V_216 ) ;
}
...
if ( ! V_160 )
return 1 ;
V_250 = ( V_270 & V_291 ) >> V_287 ;
V_103 = F_80 ( V_28 , V_130 , V_158 , V_152 ) ;
if ( F_76 ( V_103 ) )
return F_77 ( V_103 ) ;
...
static int F_147 ( void * V_279 , struct V_243 * V_280 ,
struct V_243 * V_281 )
{
struct V_34 * V_292 = F_47 ( V_280 , struct V_34 , V_157 ) ;
struct V_34 * V_293 = F_47 ( V_281 , struct V_34 , V_157 ) ;
if ( V_292 -> V_35 < V_293 -> V_35 )
return - 1 ;
else
return 1 ;
}
...
{
const struct V_26 * V_32 = F_16 ( V_28 ) ;
T_2 V_129 = V_28 -> V_161 ;
struct V_34 * V_103 ;
int V_216 = V_32 -> V_216 ;
if ( ! ( V_129 & V_223 ) )
return 0 ;
F_143 ( NULL , & V_28 -> V_159 , F_147 ) ;
...
if ( V_12 )
return V_12 ;
V_12 = F_145 ( V_28 , V_103 , V_131 , V_216 ) ;
if ( V_12 )
return V_12 ;
}
return 0 ;
...
{
const struct V_26 * V_32 = F_16 ( V_28 ) ;
int V_294 = V_130 * ( V_133 / V_32 -> V_216 ) ;
T_2 V_270 = * ( T_2 * ) V_69 ;
int V_216 = V_32 -> V_216 ;
T_4 V_269 ;
int V_12 ;
...
return 1 ;
V_269 = V_270 & V_296 ;
V_12 = F_136 ( V_28 , V_269 , V_133 , V_216 ,
V_294 , F_146 , NULL ) ;
return V_12 ;
}
...
if ( V_129 & V_140 ) {
V_297 = V_299 ;
V_12 = F_136 ( V_28 , V_298 , V_132 , V_297 , 0 ,
F_149 , NULL ) ;
} else {
V_297 = V_32 -> V_216 ;
V_12 = F_136 ( V_28 , V_298 , V_132 , V_297 , 0 ,
...
V_42 -> V_43 ) ;
V_79 = F_138 ( V_79 ) ;
return F_139 ( V_28 -> V_103 -> V_2 , V_269 , & V_79 , V_135 ) ;
}
static int F_152 ( struct V_27 * V_28 , T_4 V_269 , int V_135 )
{
struct V_40 * V_42 ;
struct V_2 * V_2 = V_28 -> V_103 -> V_2 ;
T_1 V_55 , V_41 ;
...
V_12 = F_22 ( V_2 , V_269 , & V_79 , V_135 ) ;
if ( V_12 )
return V_12 ;
V_79 = F_56 ( V_79 ) ;
if ( ! ( V_79 & V_302 ) )
...
{
const struct V_26 * V_32 = F_16 ( V_28 ) ;
T_2 V_129 = V_28 -> V_143 ;
T_4 V_269 = F_67 ( V_129 ) ;
struct V_40 * V_42 ;
T_2 V_79 ;
T_9 V_284 , V_305 = 0 ;
int V_12 , V_217 = V_32 -> V_217 ;
if ( ! ( V_129 & V_223 ) )
return 0 ;
V_284 = F_64 ( V_129 ) * V_133 ;
F_9 (collection, &its->collection_list, coll_list) {
V_12 = F_151 ( V_28 , V_42 , V_269 , V_217 ) ;
if ( V_12 )
return V_12 ;
V_269 += V_217 ;
V_305 += V_217 ;
...
return 0 ;
V_79 = 0 ;
F_153 ( V_217 > sizeof( V_79 ) ) ;
V_12 = F_139 ( V_28 -> V_103 -> V_2 , V_269 , & V_79 , V_217 ) ;
return V_12 ;
}
...
V_28 -> V_143 &= ~ V_307 ;
V_28 -> V_161 &= ~ V_307 ;
V_28 -> V_143 |= ( F_39 ( V_32 -> V_217 , 5 )
<< V_219 ) ;
V_28 -> V_161 |= ( F_39 ( V_32 -> V_216 , 5 )
<< V_219 ) ;
return 0 ;
}
