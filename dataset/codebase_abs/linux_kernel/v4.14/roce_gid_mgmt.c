...
F_20 ( V_18 , V_2 , V_3 , V_34 ,
(struct V_35 * ) & V_47 -> V_46 ) ;
F_33 ( & V_47 -> V_44 ) ;
F_34 ( V_47 ) ;
}
}
...
union V_12 V_13 ;
F_21 ( (struct V_35 * ) & V_66 -> V_65 , & V_13 ) ;
...
F_48 (net)
F_49 (net, ndev)
if ( F_11 ( V_2 , V_3 , V_28 , V_34 ) )
F_43 ( V_2 , V_3 , V_28 , V_34 ) ;
F_50 () ;
}
...
if ( ! V_91 -> V_86 [ V_4 ] . V_34 )
V_91 -> V_86 [ V_4 ] . V_34 = V_34 ;
if ( ! V_91 -> V_86 [ V_4 ] . V_89 )
V_91 -> V_86 [ V_4 ] . V_89 = V_34 ;
F_56 ( V_91 -> V_86 [ V_4 ] . V_34 ) ;
...
if ( V_96 -> V_99 == false ) {
V_86 [ 0 ] = V_97 ;
V_86 [ 0 ] . V_34 = V_96 -> V_100 ;
V_86 [ 1 ] = V_101 ;
} else {
V_86 [ 0 ] = V_98 ;
V_86 [ 0 ] . V_34 = V_96 -> V_100 ;
V_86 [ 1 ] = V_102 ;
V_86 [ 1 ] . V_34 = V_96 -> V_100 ;
...
V_34 = V_57 -> V_125 -> V_22 ;
return F_77 ( V_104 , V_105 , (struct V_35 * ) & V_123 , V_34 ) ;
}
...
V_126 . V_69 = V_70 ;
V_126 . V_71 = V_127 -> V_36 ;
V_34 = V_127 -> V_128 -> V_22 ;
return F_77 ( V_104 , V_105 , (struct V_35 * ) & V_126 , V_34 ) ;
}
int T_2 F_80 ( void )
{
V_94 = F_81 ( L_1 , 0 ) ;
