...
V_90 = F_36 ( V_69 -> V_99 . V_77 , V_69 -> V_99 . V_78 ,
0 , V_88 ,
V_92 ,
V_87 , V_89 ,
V_100 ) ;
...
V_103 = F_7 ( V_9 , V_104 ) ;
if ( V_15 <= 8 )
( ( V_105 * ) V_69 -> V_47 ) [ V_93 ++ ] = V_103 ;
else if ( V_15 <= 16 )
( ( V_106 * ) V_69 -> V_47 ) [ V_93 ++ ] = V_103 ;
else
( ( T_1 * ) V_69 -> V_47 ) [ V_93 ++ ] = V_103 ;
} else {
int V_42 = F_10 ( V_15 ) ;
F_15 ( & V_9 -> V_28 , L_3 ) ;
V_72 -= ( V_42 << 1 ) ;
...
static unsigned
F_39 ( struct V_8 * V_9 , struct V_37 * V_69 )
{
struct V_5 * V_6 ;
struct V_10 * V_11 = V_9 -> V_12 ;
struct V_63 * V_64 ;
...
V_11 -> V_22 = 0 ;
V_9 -> V_12 = V_11 ;
F_54 ( & V_11 -> V_159 , & V_31 -> V_11 ) ;
if ( F_55 ( V_9 -> V_160 ) ) {
V_90 = F_56 ( V_9 -> V_160 , F_57 ( & V_9 -> V_28 ) ) ;
if ( V_90 ) {
F_15 ( & V_9 -> V_28 , L_21 ) ;
return V_90 ;
}
...
static int F_67 ( struct V_179 * V_28 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
V_2 = F_68 ( V_28 ) ;
...
int V_165 = 0 , V_186 ;
T_1 V_187 = 0 ;
struct V_188 * V_159 = V_181 -> V_28 . V_189 ;
const struct V_190 * V_191 ;
V_2 = F_70 ( & V_181 -> V_28 , sizeof *V_6 ) ;
if ( V_2 == NULL ) {
F_45 ( & V_181 -> V_28 , L_23 ) ;
return - V_158 ;
}
V_2 -> V_192 = V_151 | V_153 | V_26 ;
V_2 -> V_193 = F_71 ( 4 , 32 ) ;
V_2 -> V_194 = F_52 ;
V_2 -> V_195 = true ;
V_2 -> V_196 = F_64 ;
...
V_2 -> V_198 = F_13 ;
V_2 -> V_199 = F_60 ;
V_2 -> V_28 . V_189 = V_159 ;
V_2 -> V_139 = V_134 ;
V_2 -> V_200 = V_134 >> 15 ;
F_72 ( V_181 , V_2 ) ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_2 = V_2 ;
V_191 = F_73 ( V_201 , & V_181 -> V_28 ) ;
if ( V_191 ) {
T_1 V_202 = 1 ;
V_183 = V_191 -> V_62 ;
F_74 ( V_159 , L_24 , & V_202 ) ;
V_2 -> V_161 = V_202 ;
if ( F_75 ( V_159 , L_25 , NULL ) )
V_6 -> V_142 = V_203 ;
} else {
V_183 = F_76 ( & V_181 -> V_28 ) ;
V_2 -> V_161 = V_183 -> V_202 ;
V_6 -> V_142 = V_183 -> V_142 ;
}
V_187 = V_183 -> V_187 ;
V_185 = F_77 ( V_181 , V_204 , 0 ) ;
V_6 -> V_7 = F_78 ( & V_181 -> V_28 , V_185 ) ;
if ( F_49 ( V_6 -> V_7 ) ) {
V_165 = F_50 ( V_6 -> V_7 ) ;
goto V_205;
}
V_6 -> V_117 = V_185 -> V_206 + V_187 ;
V_6 -> V_7 += V_187 ;
V_6 -> V_28 = & V_181 -> V_28 ;
F_79 ( & V_6 -> V_31 . V_11 ) ;
V_6 -> V_65 = F_80 ( & V_181 -> V_28 , V_2 -> V_161 ,
sizeof( struct V_63 ) ,
V_100 ) ;
if ( V_6 -> V_65 == NULL ) {
V_165 = - V_158 ;
...
F_81 ( & V_181 -> V_28 ) ;
F_82 ( & V_181 -> V_28 , V_207 ) ;
F_83 ( & V_181 -> V_28 ) ;
V_165 = F_66 ( V_6 ) ;
if ( V_165 < 0 )
goto V_208;
V_165 = F_84 ( & V_181 -> V_28 , V_2 ) ;
if ( V_165 < 0 )
goto V_208;
return V_165 ;
V_208:
...
static int F_89 ( struct V_180 * V_181 )
{
struct V_1 * V_2 = F_90 ( V_181 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_85 ( V_6 -> V_28 ) ;
F_86 ( V_6 -> V_28 ) ;
F_87 ( & V_181 -> V_28 ) ;
...
static int F_91 ( struct V_179 * V_28 )
{
struct V_1 * V_2 = F_68 ( V_28 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_30 * V_31 = & V_6 -> V_31 ;
struct V_10 * V_11 ;
F_14 ( V_6 -> V_28 ) ;
...
static int F_93 ( struct V_179 * V_28 )
{
return F_94 ( V_28 ) ;
}
