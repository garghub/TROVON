...
const
char * F_99 ( struct V_304 * V_1 )
{
static char string [ 100 ] , * V_305 ;
V_305 = string ;
V_305 += sprintf ( string , L_102
#ifdef F_71
L_103
#endif
#ifdef F_39
...
#endif
, V_1 -> V_306 -> V_307 , V_1 -> V_308 , V_1 -> V_100 ,
V_309 , V_310 , V_311 ) ;
return string ;
}
static int F_101 ( struct V_312 * V_313 , struct V_304 * V_314 )
{
int V_303 ;
struct V_315 * V_316 ;
T_1 * V_1 ;
...
F_102 ( V_313 , L_117 , V_303 == 8 ? 'H' : ( '0' + V_303 ) ) ;
V_318 = V_1 -> V_94 [ V_303 ] - 10 ;
if ( ( signed int ) V_318 < 0 )
V_318 += V_96 ;
V_93 = V_1 -> V_97 [ V_303 ] [ V_318 ] . V_98 ;
for (; V_318 != V_1 -> V_94 [ V_303 ] ; V_318 = ( V_318 + 1 ) & ( V_96 - 1 ) ) {
if ( V_1 -> V_97 [ V_303 ] [ V_318 ] . V_98 ) {
F_102 ( V_313 , L_118 ,
V_1 -> V_97 [ V_303 ] [ V_318 ] . V_100 ? '-' : ' ' ,
V_1 -> V_97 [ V_303 ] [ V_318 ] . V_101 ,
V_1 -> V_97 [ V_303 ] [ V_318 ] . V_82 ,
( V_1 -> V_97 [ V_303 ] [ V_318 ] . V_98 - V_93 ) < 100 ?
( V_1 -> V_97 [ V_303 ] [ V_318 ] . V_98 - V_93 ) : 99 ) ;
V_93 = V_1 -> V_97 [ V_303 ] [ V_318 ] . V_98 ;
}
}
}
...
F_103 (scd, instance) {
F_102 ( V_313 , L_120 ) ;
F_102 ( V_313 , L_121 , V_316 -> V_102 , V_316 -> V_170 ) ;
if ( V_316 -> V_319 )
F_102 ( V_313 , L_122 ,
