...
void F_87 ( unsigned int V_14 )
{
F_66 ( V_14 ) ;
}
int F_88 ( unsigned int V_14 )
{
struct V_4 * V_5 = F_46 ( V_14 ) ;
if ( ! V_5 )
return - V_67 ;
...
int F_90 ( struct V_79 * V_45 , unsigned int V_46 ,
bool V_80 , struct V_81 * V_82 )
{
struct V_81 * V_83 = F_91 ( V_82 ) ;
...
void F_98 ( unsigned int V_84 , unsigned int V_64 )
{
int V_66 ;
...
V_40 = F_71 ( V_63 , V_64 , V_6 , V_8 , V_16 ) ;
V_86:
F_52 ( & V_53 ) ;
return V_40 ;
}
...
{
int V_66 , V_89 ;
for ( V_66 = V_84 , V_89 = V_64 ; V_89 > 0 ; V_66 ++ , V_89 -- ) {
F_106 ( V_66 , V_87 | V_88 ) ;
F_107 ( V_66 ) ;
}
F_98 ( V_84 , V_64 ) ;
}
unsigned int F_109 ( unsigned int V_90 )
{
return F_110 ( V_70 , V_73 , V_90 ) ;
}
struct V_4 *
F_111 ( unsigned int V_14 , unsigned long * V_54 , bool V_91 ,
unsigned int V_92 )
{
struct V_4 * V_5 = F_46 ( V_14 ) ;
if ( V_5 ) {
...
void F_114 ( struct V_4 * V_5 , unsigned long V_54 , bool V_91 )
{
F_85 ( & V_5 -> V_44 , V_54 ) ;
if ( V_91 )
F_115 ( V_5 ) ;
...
if ( V_5 -> V_95 )
return - V_67 ;
V_5 -> V_95 = F_117 ( sizeof( * V_5 -> V_95 ) , V_9 ) ;
if ( ! V_5 -> V_95 )
return - V_10 ;
if ( V_8 )
V_5 -> V_96 = V_8 ;
