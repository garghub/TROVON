...
int F_9 ( struct V_11 * V_12 , const char * V_23 , int * V_24 )
{
int V_14 ;
struct V_4 * V_19 = V_12 -> V_19 . V_16 ;
for ( V_14 = * V_24 + 1 ; V_14 < V_12 -> V_19 . V_13 ; ++ V_14 ) {
if ( F_10 ( V_19 [ V_14 ] . V_6 , V_23 ) ) {
* V_24 = V_14 ;
return V_19 [ V_14 ] . V_20 ;
}
}
return - 1 ;
}
int F_11 ( struct V_11 * V_12 , const char * V_23 , int * V_24 )
{
* V_24 = - 1 ;
return F_9 ( V_12 , V_23 , V_24 ) ;
}
struct V_11 * F_4 ( void )
{
struct V_11 * V_12 = malloc ( sizeof( * V_12 ) ) ;
...
{
return F_13 ( V_20 , V_12 -> V_25 ) ;
}
int F_8 ( struct V_11 * V_12 , const char * V_6 )
{
return F_14 ( V_6 , V_12 -> V_25 ) ;
}
int F_9 ( struct V_11 * V_12 V_21 ,
const char * V_23 V_21 , int * V_24 V_21 )
{
return - 1 ;
}
int F_11 ( struct V_11 * V_12 , const char * V_23 , int * V_24 )
