...
if ( V_38 < 0 )
return V_38 ;
V_2 = F_50 ( & V_68 -> V_49 , sizeof( * V_2 ) , V_89 ) ;
if ( ! V_2 )
return - V_90 ;
V_87 = F_51 ( V_68 , V_91 , 0 ) ;
V_2 -> V_5 = F_52 ( & V_68 -> V_49 , V_87 ) ;
if ( F_42 ( V_2 -> V_5 ) )
return F_53 ( V_2 -> V_5 ) ;
V_85 = F_54 ( & V_68 -> V_49 ) ;
if ( V_85 ) {
...
goto V_95;
F_56 ( & V_2 -> V_18 ) ;
V_78 = F_57 ( & V_68 -> V_49 , V_38 , F_26 , 0 ,
V_68 -> V_96 , V_2 ) ;
if ( V_78 ) {
F_32 ( & V_68 -> V_49 , L_14 ) ;
goto V_95;
...
V_2 -> V_42 = V_97 ;
F_59 ( & V_2 -> V_42 , V_2 ) ;
V_2 -> V_42 . V_49 . V_98 = & V_68 -> V_49 ;
V_2 -> V_42 . V_49 . V_71 = V_68 -> V_49 . V_71 ;
V_78 = F_60 ( & V_2 -> V_42 ) ;
if ( V_78 )
goto V_95;
if ( V_85 ) {
for ( V_88 = 0 ; V_88 < V_85 -> V_99 ; V_88 ++ )
F_61 ( & V_2 -> V_42 , V_85 -> V_100 + V_88 ) ;
}
return 0 ;
V_95:
F_45 ( V_2 -> V_77 ) ;
