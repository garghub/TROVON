...
V_161 = F_162 ( V_68 , V_232 , V_69 , & V_2 ) ;
if ( V_161 < 0 )
goto V_387;
V_68 -> V_185 = V_2 ;
V_161 = F_178 ( V_68 ) ;
...
V_2 -> V_389 [ V_10 ] = F_3 ( V_2 , V_389 [ V_10 ] ) ;
for ( V_10 = 0 ; V_10 < F_18 ( V_390 ) ; V_10 ++ )
V_2 -> V_390 [ V_10 ] = F_102 ( V_2 , V_390 [ V_10 ] ) ;
F_1 ( V_2 , V_105 , 0 ) ;
return 0 ;
}
...
F_101 ( V_2 , 0 , 0 ) ;
for ( V_10 = 0 ; V_10 < F_18 ( V_389 ) ; V_10 ++ )
F_1 ( V_2 , V_389 [ V_10 ] , V_2 -> V_389 [ V_10 ] ) ;
for ( V_10 = 0 ; V_10 < F_18 ( V_390 ) ; V_10 ++ )
F_101 ( V_2 , V_390 [ V_10 ] , V_2 -> V_390 [ V_10 ] ) ;
F_185 ( V_68 , V_391 ) ;
return 0 ;
}
