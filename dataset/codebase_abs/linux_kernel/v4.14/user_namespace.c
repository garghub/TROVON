...
const struct V_2 * V_121 )
{
const struct V_2 * V_3 ;
for ( V_3 = V_121 ; V_3 -> V_27 > V_120 -> V_27 ; V_3 = V_3 -> V_38 )
;
return ( V_3 == V_120 ) ;
}
bool F_85 ( const struct V_2 * V_122 )
{
return F_84 ( V_122 , F_86 () ) ;
}
static inline struct V_2 * F_87 ( struct V_123 * V_3 )
{
return F_26 ( V_3 , struct V_2 , V_3 ) ;
}
static struct V_123 * F_88 ( struct V_124 * V_125 )
{
struct V_2 * V_7 ;
F_89 () ;
V_7 = F_90 ( F_91 ( V_125 ) -> V_7 ) ;
F_92 () ;
return V_7 ? & V_7 -> V_3 : NULL ;
}
static void F_93 ( struct V_123 * V_3 )
{
F_94 ( F_87 ( V_3 ) ) ;
}
static int F_95 ( struct V_126 * V_126 , struct V_123 * V_3 )
{
struct V_2 * V_7 = F_87 ( V_3 ) ;
struct V_6 * V_6 ;
if ( V_7 == F_86 () )
return - V_104 ;
if ( ! F_96 ( V_127 ) )
return - V_104 ;
if ( V_127 -> V_128 -> V_129 != 1 )
return - V_104 ;
if ( ! F_78 ( V_7 , V_106 ) )
return - V_29 ;
V_6 = F_24 () ;
...
struct V_123 * F_98 ( struct V_123 * V_3 )
{
struct V_2 * V_130 = F_86 () ;
struct V_2 * V_20 , * V_131 ;
V_20 = V_131 = V_3 -> V_35 -> V_20 ( V_3 ) ;
for (; ; ) {
if ( ! V_131 )
return F_99 ( - V_29 ) ;
if ( V_131 == V_130 )
...
return & F_90 ( V_20 ) -> V_3 ;
}
static struct V_2 * F_100 ( struct V_123 * V_3 )
{
return F_87 ( V_3 ) -> V_38 ;
}
static T_12 int F_101 ( void )
{
V_32 = F_102 ( V_2 , V_132 ) ;
return 0 ;
}
