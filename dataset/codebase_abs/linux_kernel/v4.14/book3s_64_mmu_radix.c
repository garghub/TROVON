...
V_103 |= V_83 ;
F_48 ( V_102 ) ;
V_63 = F_49 ( V_115 -> V_67 -> V_71 , V_91 , NULL , NULL ) ;
if ( V_63 ) {
V_17 = F_50 ( * V_63 ) ;
if ( F_9 ( V_17 ) &&
...
V_103 = V_47 | V_51 ;
V_11 = 0 ;
V_97 = F_54 ( V_91 , 1 , V_99 , V_96 ) ;
if ( V_97 < 1 ) {
F_55 ( & V_115 -> V_67 -> V_117 ) ;
V_101 = F_56 ( V_115 -> V_67 , V_91 ) ;
if ( V_101 && V_101 -> V_118 <= V_91 && V_91 < V_101 -> V_119 &&
( V_101 -> V_120 & V_121 ) ) {
V_92 = V_101 -> V_122 +
( ( V_91 - V_101 -> V_118 ) >> V_84 ) ;
V_103 = F_57 ( V_101 -> V_123 ) ;
}
F_58 ( & V_115 -> V_67 -> V_117 ) ;
if ( ! V_92 )
return - V_105 ;
} else {
V_95 = V_96 [ 0 ] ;
...
static void F_68 ( struct V_8 * V_8 , struct V_93 * V_94 ,
...
unsigned int V_43 ;
unsigned long V_66 ;
V_63 = F_53 ( V_8 -> V_24 . V_77 , V_22 , NULL , & V_43 ) ;
if ( V_63 && F_9 ( * V_63 ) ) {
...
int F_70 ( struct V_8 * V_8 , struct V_93 * V_94 ,
unsigned long V_90 )
{
T_4 * V_63 ;
unsigned long V_22 = V_90 << V_84 ;
...
int F_72 ( struct V_8 * V_8 , struct V_93 * V_94 ,
unsigned long V_90 )
{
T_4 * V_63 ;
unsigned long V_22 = V_90 << V_84 ;
...
static int F_73 ( struct V_8 * V_8 ,
...
static void F_78 ( struct V_140 * V_141 ,
int V_58 , int * V_142 )
{
if ( ! V_42 [ V_58 ] . V_43 )
return;
...
int F_79 ( struct V_8 * V_8 , struct V_140 * V_141 )
{
int V_128 ;
if ( ! F_80 () )
return - V_25 ;
...
V_128 = 0 ;
F_78 ( V_141 , V_40 , & V_128 ) ;
F_78 ( V_141 , V_147 , & V_128 ) ;
F_78 ( V_141 , V_61 , & V_128 ) ;
F_78 ( V_141 , V_148 , & V_128 ) ;
return 0 ;
}
int F_81 ( struct V_8 * V_8 )
{
V_8 -> V_24 . V_77 = F_82 ( V_8 -> V_67 ) ;
if ( ! V_8 -> V_24 . V_77 )
return - V_81 ;
return 0 ;
}
void F_83 ( struct V_8 * V_8 )
{
...
F_89 ( V_8 -> V_67 , V_8 -> V_24 . V_77 ) ;
}
static void F_90 ( void * V_56 )
{
memset ( V_56 , 0 , V_156 ) ;
}
int F_91 ( void )
...
V_68 = F_92 ( L_3 , V_157 , V_157 , 0 , F_90 ) ;
if ( ! V_68 )
return - V_81 ;
return 0 ;
}
