...
static unsigned long F_41 ( unsigned long V_52 )
{
if ( V_52 < V_53 )
return V_53 * V_54 ;
if ( V_52 > V_31 && ! F_42 ( V_55 ) )
return 0 ;
return V_52 * V_54 ;
}
...
static struct V_1 *
F_44 ( struct V_2 * V_2 , struct V_34 * V_35 , struct V_57 * V_58 ,
char T_4 * V_59 , int V_60 , int * V_61 )
{
struct V_1 * V_4 = NULL ;
int V_62 ;
int V_63 ;
int V_64 ;
V_62 = V_60 - F_45 ( sizeof( * V_58 ) ) ;
V_64 = - V_65 ;
if ( V_62 > 64 * 1024 )
goto V_66;
V_64 = - V_67 ;
V_4 = F_46 ( sizeof( * V_4 ) , V_68 ) ;
if ( ! V_4 )
goto V_66;
if ( V_62 > 0 ) {
struct V_69 V_70 ;
...
struct V_74 V_75 ;
V_64 = - V_67 ;
V_4 -> V_11 = F_47 ( sizeof( * V_4 -> V_11 ) + V_62 , V_68 ) ;
if ( ! V_4 -> V_11 )
goto V_66;
memset ( V_4 -> V_11 , 0 , sizeof( * V_4 -> V_11 ) ) ;
V_4 -> V_11 -> V_51 = sizeof( * V_4 -> V_11 ) + V_62 ;
V_64 = - V_76 ;
if ( F_48 ( V_4 -> V_11 + 1 , V_59 + F_45 ( sizeof( * V_58 ) ) , V_62 ) )
goto V_66;
V_70 . V_77 = V_62 ;
V_70 . V_78 = ( void * ) ( V_4 -> V_11 + 1 ) ;
memset ( & V_71 , 0 , sizeof( V_71 ) ) ;
V_75 . V_11 = V_4 -> V_11 ;
V_64 = F_49 ( V_2 , V_35 , & V_70 , & V_71 , & V_75 , & V_73 ) ;
if ( V_64 )
goto V_66;
V_64 = - V_65 ;
if ( V_4 -> V_11 -> V_45 )
...
V_4 -> V_5 = V_2 ;
V_4 -> V_18 = V_15 ;
V_64 = F_43 ( V_4 , V_58 -> V_79 , V_58 -> V_80 ) ;
if ( V_64 )
goto V_66;
V_4 -> V_7 = V_58 -> V_81 ;
V_63 = F_50 ( & V_58 -> V_82 ) ;
...
int F_56 ( struct V_34 * V_35 , struct V_57 * V_58 ,
int V_96 )
{
struct V_38 * V_39 = F_36 ( V_35 ) ;
struct V_36 * V_37 ;
if ( V_96 & V_97 ) {
V_58 -> V_98 = V_39 -> V_99 & V_33 ;
return 0 ;
}
if ( V_39 -> V_100 ) {
V_58 -> V_98 = V_39 -> V_101 ;
return 0 ;
}
F_5 () ;
F_37 (np, sfl) {
...
F_13 ( & V_13 ) ;
V_58 -> V_98 = V_37 -> V_4 -> V_3 ;
V_58 -> V_82 = V_37 -> V_4 -> V_85 ;
V_58 -> V_81 = V_37 -> V_4 -> V_7 ;
V_58 -> V_80 = ( V_37 -> V_4 -> V_18 - V_15 ) / V_54 ;
V_58 -> V_79 = V_37 -> V_4 -> V_17 / V_54 ;
F_18 ( & V_13 ) ;
F_7 () ;
return 0 ;
}
...
int F_57 ( struct V_34 * V_35 , char T_4 * V_59 , int V_60 )
{
int V_103 ( V_64 ) ;
...
F_22 ( & V_41 ) ) ) != NULL ;
V_105 = & V_37 -> V_29 ) {
if ( V_37 -> V_4 -> V_3 == V_58 . V_98 ) {
if ( V_58 . V_98 == ( V_39 -> V_101 & V_33 ) )
V_39 -> V_101 &= ~ V_33 ;
* V_105 = V_37 -> V_29 ;
F_18 ( & V_41 ) ;
F_12 ( V_37 -> V_4 ) ;
...
F_37 (np, sfl) {
if ( V_37 -> V_4 -> V_3 == V_58 . V_98 ) {
V_64 = F_43 ( V_37 -> V_4 , V_58 . V_79 , V_58 . V_80 ) ;
F_7 () ;
return V_64 ;
}
}
...
( V_58 . V_98 & V_123 ) )
return - V_124 ;
V_4 = F_44 ( V_2 , V_35 , & V_58 , V_59 , V_60 , & V_64 ) ;
if ( ! V_4 )
return V_64 ;
V_104 = F_47 ( sizeof( * V_104 ) , V_68 ) ;
if ( V_58 . V_98 ) {
V_64 = - V_125 ;
F_5 () ;
F_37 (np, sfl) {
...
if ( V_64 != 0 )
goto V_66;
V_106 = F_29 ( V_2 , V_4 , V_58 . V_98 ) ;
if ( V_106 )
goto V_127;
if ( ! V_58 . V_98 ) {
if ( F_62 ( & ( (struct V_57 T_4 * ) V_59 ) -> V_98 ,
