...
V_39 , & V_42 ) ;
if ( V_41 < V_42 ) {
F_26 ( V_40 , V_4 -> V_9 [ V_39 ] . V_17 -> V_45 ) ;
V_40 -> V_43 . V_44 = V_41 +
V_4 -> V_9 [ V_39 ] . V_18 ;
V_40 -> V_43 . V_46 = F_27 ( V_42 - V_41 ) ;
return V_47 ;
} else {
F_28 ( V_40 ) ;
return V_48 ;
...
static int F_29 ( struct V_11 * V_5 , struct V_40 * V_40 )
{
...
V_49 = F_30 ( V_40 ) ;
F_31 ( V_49 >= V_4 -> V_7 ) ;
F_26 ( V_40 , V_4 -> V_9 [ V_49 ] . V_17 -> V_45 ) ;
return V_47 ;
}
if ( F_32 ( F_33 ( V_40 ) == V_52 ) ||
F_32 ( F_33 ( V_40 ) == V_53 ) ||
F_32 ( F_33 ( V_40 ) == V_54 ) ) {
V_49 = F_30 ( V_40 ) ;
F_31 ( V_49 >= V_4 -> V_7 ) ;
return F_24 ( V_4 , V_40 , V_49 ) ;
}
F_21 ( V_4 , V_40 -> V_43 . V_44 ,
& V_9 , & V_40 -> V_43 . V_44 ) ;
V_40 -> V_43 . V_44 += V_4 -> V_9 [ V_9 ] . V_18 ;
F_26 ( V_40 , V_4 -> V_9 [ V_9 ] . V_17 -> V_45 ) ;
return V_47 ;
}
static long F_34 ( struct V_11 * V_5 , T_4 V_55 ,
long V_56 , void * * V_57 , T_5 * V_58 )
{
T_2 V_59 , V_35 = V_55 * V_60 ;
struct V_3 * V_4 = V_5 -> V_34 ;
struct V_61 * V_62 ;
struct V_63 * V_45 ;
T_3 V_9 ;
long V_15 ;
F_21 ( V_4 , V_35 , & V_9 , & V_59 ) ;
V_59 += V_4 -> V_9 [ V_9 ] . V_18 ;
V_62 = V_4 -> V_9 [ V_9 ] . V_17 -> V_62 ;
V_45 = V_4 -> V_9 [ V_9 ] . V_17 -> V_45 ;
V_15 = F_35 ( V_45 , V_59 , V_56 * V_64 , & V_55 ) ;
if ( V_15 )
return V_15 ;
return F_36 ( V_62 , V_55 , V_56 , V_57 , V_58 ) ;
}
static T_1 F_37 ( struct V_11 * V_5 , T_4 V_55 ,
void * V_65 , T_1 V_66 , struct V_67 * V_24 )
{
T_2 V_59 , V_35 = V_55 * V_60 ;
struct V_3 * V_4 = V_5 -> V_34 ;
struct V_61 * V_62 ;
...
V_62 = V_4 -> V_9 [ V_9 ] . V_17 -> V_62 ;
V_45 = V_4 -> V_9 [ V_9 ] . V_17 -> V_45 ;
if ( F_35 ( V_45 , V_59 , F_38 ( V_66 , V_64 ) , & V_55 ) )
return 0 ;
return F_39 ( V_62 , V_55 , V_65 , V_66 , V_24 ) ;
}
static void F_40 ( struct V_11 * V_5 , T_6 type ,
unsigned V_68 , char * V_36 , unsigned V_69 )
{
struct V_3 * V_4 = (struct V_3 * ) V_5 -> V_34 ;
char V_70 [ V_4 -> V_7 + 1 ] ;
unsigned int V_71 = 0 ;
...
F_41 ( L_13 , V_4 -> V_7 ) ;
for ( V_24 = 0 ; V_24 < V_4 -> V_7 ; V_24 ++ ) {
F_41 ( L_14 , V_4 -> V_9 [ V_24 ] . V_17 -> V_73 ) ;
V_70 [ V_24 ] = F_42 ( & ( V_4 -> V_9 [ V_24 ] . V_33 ) ) ?
'D' : 'A' ;
}
V_70 [ V_24 ] = '\0' ;
F_41 ( L_15 , V_70 ) ;
...
for ( V_24 = 0 ; V_24 < V_4 -> V_7 ; V_24 ++ )
F_41 ( L_17 , V_4 -> V_9 [ V_24 ] . V_17 -> V_73 ,
( unsigned long long ) V_4 -> V_9 [ V_24 ] . V_18 ) ;
break;
}
}
static int F_43 ( struct V_11 * V_5 , struct V_40 * V_40 ,
T_7 * error )
{
unsigned V_24 ;
char V_75 [ 16 ] ;
...
sprintf ( V_75 , L_18 , F_44 ( F_45 ( V_40 ) ) , F_46 ( F_45 ( V_40 ) ) ) ;
for ( V_24 = 0 ; V_24 < V_4 -> V_7 ; V_24 ++ )
if ( ! strcmp ( V_4 -> V_9 [ V_24 ] . V_17 -> V_73 , V_75 ) ) {
F_47 ( & ( V_4 -> V_9 [ V_24 ] . V_33 ) ) ;
if ( F_42 ( & ( V_4 -> V_9 [ V_24 ] . V_33 ) ) <
V_79 )
F_48 ( & V_4 -> F_1 ) ;
}
return V_76 ;
}
static int F_49 ( struct V_11 * V_5 ,
T_8 V_80 , void * V_81 )
{
struct V_3 * V_4 = V_5 -> V_34 ;
int V_15 = 0 ;
unsigned V_24 = 0 ;
do {
V_15 = V_80 ( V_5 , V_4 -> V_9 [ V_24 ] . V_17 ,
V_4 -> V_9 [ V_24 ] . V_18 ,
V_4 -> V_26 , V_81 ) ;
} while ( ! V_15 && ++ V_24 < V_4 -> V_7 );
return V_15 ;
}
static void F_50 ( struct V_11 * V_5 ,
struct V_82 * V_83 )
{
struct V_3 * V_4 = V_5 -> V_34 ;
unsigned V_22 = V_4 -> V_22 << V_84 ;
F_51 ( V_83 , V_22 ) ;
F_52 ( V_83 , V_22 * V_4 -> V_7 ) ;
}
int T_9 F_53 ( void )
{
int V_23 ;
