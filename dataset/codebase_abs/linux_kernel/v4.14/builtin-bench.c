...
int V_17 , const char * * V_18 )
{
int V_19 ;
char * V_4 ;
int V_20 ;
V_19 = strlen ( V_14 ) + 1 + strlen ( V_15 ) + 1 ;
V_4 = F_7 ( V_19 ) ;
F_8 ( ! V_4 ) ;
F_9 ( V_4 , V_19 , L_7 , V_14 , V_15 ) ;
F_10 ( V_21 , V_4 ) ;
V_18 [ 0 ] = V_4 ;
V_20 = V_16 ( V_17 , V_18 ) ;
free ( V_4 ) ;
...
fflush ( stdout ) ;
V_18 [ 1 ] = V_3 -> V_4 ;
F_6 ( V_2 -> V_4 , V_3 -> V_4 , V_3 -> V_16 , 1 , V_18 ) ;
printf ( L_3 ) ;
}
}
...
int F_13 ( int V_17 , const char * * V_18 )
{
struct V_1 * V_2 ;
int V_20 = 0 ;
if ( V_17 < 2 ) {
...
fflush ( stdout ) ;
V_20 = F_6 ( V_2 -> V_4 , V_3 -> V_4 , V_3 -> V_16 , V_17 - 1 , V_18 + 1 ) ;
goto V_22;
}
