...
V_10 = F_67 ( V_57 , V_110 , * V_56 , V_28 , NULL ) ;
if ( F_68 ( ! V_10 ) )
return - V_126 ;
F_69 ( * V_56 , V_10 ) ;
if ( V_28 == V_113 )
...
return - V_119 ;
V_133 = F_75 ( V_10 ) ;
if ( F_76 ( V_8 -> V_6 ) && V_133 && V_32 -> V_35 == 0 ) {
F_77 (v, &vg->vlan_list, vlist) {
V_32 -> V_35 = V_135 -> V_35 ;
...
F_79 ( & V_10 -> V_137 ) ;
F_80 ( & V_10 -> V_67 ) ;
F_81 ( & V_10 -> V_138 , V_139 ) ;
V_47 = 0 ;
if ( ! V_54 -> V_61 && ! V_54 -> V_137 &&
F_72 ( V_8 -> V_6 ) )
...
void F_83 ( void )
{
F_84 ( V_140 , V_81 , NULL , F_18 , 0 ) ;
F_84 ( V_140 , V_102 , F_74 , NULL , 0 ) ;
F_84 ( V_140 , V_106 , F_82 , NULL , 0 ) ;
}
void F_85 ( void )
{
F_86 ( V_140 , V_81 ) ;
