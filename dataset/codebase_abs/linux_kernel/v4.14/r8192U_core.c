...
( strcmp ( V_475 -> V_480 -> V_106 , L_59 ) == 0 ) ) ;
if ( V_476 && ( V_61 == 0 ) ) {
return false ;
} else if ( ( V_61 != 0 ) ) {
...
if ( strcmp ( V_832 -> V_830 . V_475 . V_840 , L_119 ) == 0 ) {
V_11 -> V_391 = V_395 ;
} else if ( strcmp ( V_832 -> V_830 . V_475 . V_840 , L_120 ) == 0 ) {
V_11 -> V_391 = V_394 ;
} else if ( strcmp ( V_832 -> V_830 . V_475 . V_840 , L_59 ) == 0 ) {
...
V_7 -> V_67 . V_942 ++ ;
if ( ! V_7 -> V_943 ) {
V_941 = V_921 -> V_944 & 0xc0 ;
V_941 >>= 6 ;
switch ( V_941 ) {
case 0x3 :
V_930 = - 35 - ( V_921 -> V_944 & 0x3e ) ;
break;
case 0x2 :
V_930 = - 23 - ( V_921 -> V_944 & 0x3e ) ;
break;
case 0x1 :
V_930 = - 11 - ( V_921 -> V_944 & 0x3e ) ;
break;
case 0x0 :
V_930 = 6 - ( V_921 -> V_944 & 0x3e ) ;
break;
}
} else {
V_941 = V_921 -> V_944 & 0x60 ;
V_941 >>= 5 ;
switch ( V_941 ) {
case 0x3 :
V_930 = - 35 - ( ( V_921 -> V_944 & 0x1f ) << 1 ) ;
break;
case 0x2 :
V_930 = - 23 - ( ( V_921 -> V_944 & 0x1f ) << 1 ) ;
break;
case 0x1 :
V_930 = - 11 - ( ( V_921 -> V_944 & 0x1f ) << 1 ) ;
break;
case 0x0 :
V_930 = 6 - ( ( V_921 -> V_944 & 0x1f ) << 1 ) ;
break;
}
}
V_934 = F_236 ( V_930 ) ;
V_134 -> V_896 = V_917 -> V_896 = V_934 ;
V_134 -> V_945 = V_934 ;
if ( V_134 -> V_896 > 40 ) {
V_939 = 100 ;
} else {
...
if ( V_921 -> V_946 > 64 )
V_939 = 0 ;
else if ( V_921 -> V_946 < 20 )
V_939 = 100 ;
else
V_939 = ( ( 64 - V_939 ) * 100 ) / 44 ;
}
V_134 -> V_901 = V_917 -> V_901 = V_939 ;
V_134 -> V_906 [ 0 ] =
V_917 -> V_906 [ 0 ] = V_939 ;
V_134 -> V_906 [ 1 ] =
V_917 -> V_906 [ 1 ] = - 1 ;
...
continue;
V_929 [ V_1 ] =
( ( V_920 -> V_949 [ V_1 ] & 0x3F ) * 2 ) - 106 ;
V_926 = V_920 -> V_950 [ V_1 ] ;
V_931 = ( T_9 ) ( V_926 ) ;
V_931 /= 2 ;
V_7 -> V_67 . V_951 [ V_1 ] = ( long ) V_931 ;
V_935 = F_236 ( V_929 [ V_1 ] ) ;
V_936 += V_935 ;
V_134 -> V_892 [ V_1 ] = ( T_1 ) V_935 ;
V_917 -> V_892 [ V_1 ] = ( T_1 ) V_935 ;
}
V_930 = ( ( ( V_920 -> V_934 ) >> 1 ) & 0x7f ) - 106 ;
V_934 = F_236 ( V_930 ) ;
V_134 -> V_896 = V_917 -> V_896 = V_934 ;
V_134 -> V_952 = V_917 -> V_952 = V_930 ;
...
V_134 -> V_882 =
V_917 -> V_882 =
( T_1 ) ( F_238 ( ( long ) V_934 ) ) ;
} else {
if ( V_938 != 0 ) {
V_134 -> V_882 =
V_917 -> V_882 =
( T_1 ) ( F_238 ( ( long ) ( V_936 /= V_938 ) ) ) ;
}
}
}
static void F_241 (
...
struct V_133 * V_958 )
{
V_958 -> V_849 = V_957 -> V_849 ;
V_958 -> V_850 = V_957 -> V_850 ;
V_958 -> V_878 = V_957 -> V_878 ;
}
...
V_873 = (struct V_872 * ) V_961 ;
V_960 = F_131 ( V_873 -> V_963 ) ;
type = F_243 ( V_960 ) ;
V_962 = V_873 -> V_964 ;
V_918 = ( type != V_965 ) &&
( F_244 ( V_7 -> V_12 -> V_211 . V_260 , ( V_960 & V_966 ) ? V_873 -> V_964 : ( V_960 & V_967 ) ? V_873 -> V_968 : V_873 -> V_969 ) )
&& ( ! V_134 -> V_970 ) && ( ! V_134 -> V_971 ) && ( ! V_134 -> V_972 ) ;
V_919 = V_918 &
( F_244 ( V_962 , V_7 -> V_12 -> V_36 -> V_617 ) ) ;
if ( F_245 ( V_960 ) == V_973 )
V_897 = true ;
if ( F_245 ( V_960 ) == V_974 ) {
if ( ( F_244 ( V_962 , V_36 -> V_617 ) ) )
V_886 = true ;
}
if ( V_918 )
V_7 -> V_67 . V_975 ++ ;
if ( V_919 )
V_7 -> V_67 . V_976 ++ ;
F_232 ( V_7 , V_961 , & V_959 , V_134 ) ;
F_240 ( V_7 , V_134 , V_914 , & V_959 ,
V_918 , V_919 ,
V_897 , V_886 ) ;
F_241 ( V_134 , & V_959 ) ;
}
...
V_1005 = false ;
if ( F_251 ( V_1004 -> V_964 ) ) {
} else if ( F_252 ( V_1004 -> V_964 ) ) {
} else {
V_1005 = true ;
}
...
static int F_262 ( struct V_1021 * V_1022 ,
const struct V_1023 * V_1024 )
{
struct V_35 * V_36 = NULL ;
struct V_6 * V_7 = NULL ;
struct V_44 * V_45 = F_263 ( V_1022 ) ;
int V_188 ;
F_9 ( V_95 , L_130 ) ;
...
static void F_271 ( struct V_1021 * V_1022 )
{
struct V_35 * V_36 = F_272 ( V_1022 ) ;
struct V_6 * V_7 = F_19 ( V_36 ) ;
if ( V_36 ) {
F_273 ( V_36 ) ;
F_9 ( V_817 ,
...
struct V_10 * V_11 = V_7 -> V_12 ;
V_679 = V_715 | V_716 ;
if ( ( ( V_11 -> V_391 == V_392 ) || ( V_11 -> V_391 == V_393 ) ) && ( V_7 -> V_12 -> V_844 != 2 ) ) {
V_679 |= V_1037 ;
V_679 |= V_1038 ;
...
void F_188 ( struct V_35 * V_36 , T_1 V_1043 , T_1 V_1044 , T_3 V_1045 ,
