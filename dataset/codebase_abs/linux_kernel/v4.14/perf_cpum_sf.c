...
if ( V_64 -> V_77 >= 0 ) {
if ( ( unsigned int ) V_64 -> V_77 >= V_101 )
return - V_62 ;
if ( ! F_70 ( V_64 -> V_77 ) )
return - V_62 ;
}
...
break;
default:
if ( V_38 -> V_73 . V_143 || V_38 -> V_73 . V_144 != 0xffff )
V_117 -> V_121 = 1 ;
break;
}
V_123 = 0 ;
...
V_123 = 1 ;
V_64 -> V_104 -> V_145 ( V_64 , 0 ) ;
}
F_81 ( V_64 ) ;
V_80:
return V_123 ;
}
static void F_82 ( struct V_63 * V_64 , V_46 V_146 )
{
F_83 ( V_146 , & V_64 -> V_146 ) ;
}
static int F_84 ( struct V_147 * V_148 ,
unsigned int V_54 )
{
if ( F_85 ( V_54 & V_83 ) )
if ( V_148 -> V_73 . V_149 != 0x0001 )
return 0 ;
if ( V_54 & V_88 )
if ( V_148 -> V_44 . V_149 < 0x8001 )
return 0 ;
return 1 ;
}
...
if ( F_71 ( ! ( V_54 & V_83 ) ) )
return 0 ;
if ( V_148 -> V_73 . V_150 || V_148 -> V_73 . V_138 )
return 0 ;
return 1 ;
}
...
struct V_147 * V_148 )
{
if ( F_85 ( V_38 -> V_151 & V_83 ) )
V_38 -> V_73 = V_148 -> V_73 ;
if ( V_38 -> V_151 & V_88 )
memcpy ( & V_38 -> V_44 , & V_148 -> V_44 , V_38 -> V_32 ) ;
}
...
L_29
L_30 , V_153 -> V_154 ,
V_148 -> V_73 . V_149 , & V_148 -> V_73 ,
( V_54 & V_88 )
? V_148 -> V_44 . V_149 : 0xFFFF ,
( V_54 & V_88 )
? & V_148 -> V_44 : NULL ) ;
}
...
V_38 -> V_151 = V_54 & V_155 ;
V_39 = F_26 ( & V_64 -> V_65 ) ;
V_153 = (struct V_152 * ) F_12 ( * V_1 ) ;
V_148 = (struct V_147 * ) * V_1 ;
while ( ( unsigned long * ) V_148 < ( unsigned long * ) V_153 ) {
if ( ! V_148 -> V_73 . V_149 )
break;
...
static void F_91 ( struct V_63 * V_64 , int V_156 )
{
struct V_34 * V_35 = & V_64 -> V_65 ;
struct V_152 * V_153 ;
unsigned long * V_1 ;
unsigned long long V_157 , V_158 , V_17 , V_159 ;
int V_160 ;
if ( V_156 && F_92 ( V_35 ) )
V_156 = 0 ;
V_1 = ( unsigned long * ) F_56 ( V_35 ) ;
V_160 = V_157 = V_158 = V_17 = 0 ;
while ( ! V_160 ) {
V_153 = (struct V_152 * ) F_12 ( * V_1 ) ;
if ( ! V_153 -> V_154 ) {
V_160 = 1 ;
...
L_32 ,
V_1 , V_153 -> V_123 ,
( V_153 -> V_154 ) ? F_93 ( V_153 ) : 0ULL ) ;
F_90 ( V_64 , V_1 , & V_157 ) ;
V_17 ++ ;
do {
V_159 = V_153 -> V_54 & ~ V_161 ;
V_159 |= V_16 ;
} while ( ! F_94 ( & V_153 -> V_54 , & V_153 -> V_123 ,
V_153 -> V_54 , V_153 -> V_123 ,
V_159 , 0ULL ) );
V_1 ++ ;
if ( F_6 ( V_1 ) )
V_1 = F_7 ( V_1 ) ;
...
{
struct V_6 * V_7 = F_40 ( & V_6 ) ;
if ( F_97 ( ! ( V_64 -> V_65 . V_162 & V_163 ) ) )
return;
if ( V_54 & V_164 )
F_97 ( ! ( V_64 -> V_65 . V_162 & V_165 ) ) ;
F_98 ( V_64 -> V_104 ) ;
V_64 -> V_65 . V_162 = 0 ;
V_7 -> F_3 . V_108 = 1 ;
if ( F_19 ( & V_64 -> V_65 ) )
...
{
struct V_6 * V_7 = F_40 ( & V_6 ) ;
if ( V_64 -> V_65 . V_162 & V_163 )
return;
F_98 ( V_64 -> V_104 ) ;
V_7 -> F_3 . V_108 = 0 ;
V_7 -> F_3 . V_110 = 0 ;
V_64 -> V_65 . V_162 |= V_163 ;
if ( ( V_54 & V_166 ) && ! ( V_64 -> V_65 . V_162 & V_165 ) ) {
F_91 ( V_64 , 1 ) ;
V_64 -> V_65 . V_162 |= V_165 ;
}
F_99 ( V_64 -> V_104 ) ;
}
...
static void F_103 ( struct V_173 V_173 ,
...
static int F_110 ( char * V_184 , const struct V_185 * V_186 )
{
if ( ! F_111 () )
return - V_62 ;
return sprintf ( V_184 , L_38 , V_29 , V_30 ) ;
}
static int F_112 ( const char * V_187 , const struct V_185 * V_186 )
{
int V_19 ;
unsigned long V_25 , V_26 ;
if ( ! F_111 () )
return - V_62 ;
if ( ! V_187 || ! strlen ( V_187 ) )
return - V_22 ;
V_25 = V_29 ;
V_26 = V_30 ;
if ( strchr ( V_187 , ',' ) )
V_19 = ( sscanf ( V_187 , L_38 , & V_25 , & V_26 ) == 2 ) ? 0 : - V_22 ;
else
V_19 = F_113 ( V_187 , 10 , & V_26 ) ;
...
static void T_3 F_116 ( unsigned int V_188 )
{
F_41 ( L_41
L_42 , V_188 ) ;
}
...
if ( V_28 . V_33 != sizeof( struct V_190 ) ) {
F_116 ( V_191 ) ;
return - V_22 ;
}
if ( V_28 . V_86 ) {
