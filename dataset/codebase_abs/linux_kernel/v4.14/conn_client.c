...
F_88 ( & V_52 -> V_2 -> V_6 . V_40 -> V_134 ) ;
F_89 ( & V_52 -> V_135 ,
& V_52 -> V_2 -> V_6 . V_40 -> V_136 ) ;
F_90 ( & V_52 -> V_2 -> V_6 . V_40 -> V_134 ) ;
V_94:
F_9 ( L_3 , V_21 ) ;
return V_21 ;
}
...
unsigned int V_108 )
{
if ( ! F_56 ( V_137 , & V_2 -> V_17 ) ) {
F_33 ( V_2 , V_108 , V_138 ) ;
F_92 ( V_2 ) ;
}
}
void F_93 ( struct V_51 * V_52 )
{
unsigned int V_108 = V_52 -> V_14 & V_139 ;
struct V_1 * V_2 = V_52 -> V_2 ;
struct V_109 * V_110 = & V_2 -> V_111 [ V_108 ] ;
if ( ! F_56 ( V_140 , & V_52 -> V_17 ) ) {
V_110 -> V_115 ++ ;
if ( V_110 -> V_115 >= V_141 )
F_8 ( V_24 , & V_2 -> V_17 ) ;
F_91 ( V_2 , V_108 ) ;
}
}
...
struct V_1 * V_2 = V_52 -> V_2 ;
struct V_109 * V_110 = & V_2 -> V_111 [ V_108 ] ;
struct V_4 * V_5 = V_4 ( F_94 ( & V_52 -> V_142 -> V_143 ) ) ;
F_33 ( V_2 , V_108 , V_144 ) ;
V_52 -> V_2 = NULL ;
F_4 ( & V_2 -> V_84 ) ;
if ( ! F_71 ( & V_52 -> V_77 ) ) {
F_40 ( L_22 ) ;
F_95 ( V_52 -> V_114 , == , 0 ) ;
ASSERT ( ! F_11 ( V_140 , & V_52 -> V_17 ) ) ;
F_64 ( & V_52 -> V_77 ) ;
...
F_95 ( F_96 ( V_110 -> V_52 ) , == , V_52 ) ;
if ( F_11 ( V_140 , & V_52 -> V_17 ) ) {
F_40 ( L_23 , V_52 -> V_114 , V_52 -> V_147 ) ;
F_97 ( V_2 , V_52 ) ;
}
if ( V_2 -> V_86 == V_89 &&
! F_71 ( & V_2 -> V_78 ) ) {
F_33 ( V_2 , V_108 , V_148 ) ;
F_59 ( V_2 , V_108 ) ;
goto V_149;
}
F_4 ( & V_5 -> V_95 ) ;
...
V_146:
if ( F_11 ( V_137 , & V_2 -> V_17 ) ) {
F_33 ( V_2 , V_108 , V_150 ) ;
V_2 -> V_151 = V_152 ;
V_2 -> V_86 = V_102 ;
F_54 ( & V_2 -> V_91 , & V_5 -> V_153 ) ;
if ( V_5 -> V_153 . V_113 == & V_2 -> V_91 &&
! V_5 -> V_154 )
F_98 ( V_155 ,
& V_5 -> V_132 ,
V_156 ) ;
} else {
F_33 ( V_2 , V_108 , V_157 ) ;
V_2 -> V_86 = V_100 ;
F_64 ( & V_2 -> V_91 ) ;
}
goto V_94;
...
{
const void * V_160 = F_32 ( 0 ) ;
int V_161 ;
do {
V_161 = F_104 ( & V_2 -> V_18 ) ;
F_31 ( V_2 , V_162 , V_161 , V_160 ) ;
if ( V_161 > 0 )
return;
F_95 ( V_161 , >= , 0 ) ;
V_2 = F_99 ( V_2 ) ;
...
if ( F_71 ( & V_5 -> V_153 ) )
goto V_94;
V_2 = F_60 ( V_5 -> V_153 . V_113 ,
struct V_1 , V_91 ) ;
ASSERT ( F_11 ( V_137 , & V_2 -> V_17 ) ) ;
if ( ! V_5 -> V_154 ) {
V_167 = V_156 ;
if ( V_93 > V_164 )
V_167 = V_172 ;
V_168 = V_2 -> V_151 + V_167 ;
V_169 = F_109 ( V_152 ) ;
if ( F_110 ( V_168 , V_169 ) )
goto V_173;
}
F_33 ( V_2 , - 1 , V_174 ) ;
if ( ! F_100 ( V_137 , & V_2 -> V_17 ) )
F_18 () ;
V_2 -> V_86 = V_100 ;
F_64 ( & V_2 -> V_91 ) ;
F_6 ( & V_5 -> V_95 ) ;
