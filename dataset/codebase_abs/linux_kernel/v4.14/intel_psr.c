...
& V_18 -> V_22 -> V_17 . V_102 ;
int V_103 ;
F_39 ( & V_8 -> V_36 . V_104 ) ;
F_40 ( ! F_41 ( & V_5 -> V_105 . V_106 ) ) ;
F_40 ( ! F_41 ( & V_19 -> V_107 ) ) ;
V_8 -> V_36 . V_108 = false ;
if ( F_42 ( V_8 ) && V_16 -> V_45 != V_109 ) {
F_43 ( L_1 ) ;
return false ;
}
if ( ! V_110 . V_111 ) {
...
if ( F_49 ( V_102 , V_103 ) >
V_102 -> V_115 - V_102 -> V_116 - 1 ) {
F_43 ( L_7 ,
V_103 ) ;
return false ;
}
if ( V_8 -> V_36 . V_60 &&
( V_18 -> V_22 -> V_117 > 3200 ||
V_18 -> V_22 -> V_118 > 2000 ) ) {
V_8 -> V_36 . V_60 = false ;
return false ;
}
...
static void F_65 ( struct V_141 * V_132 )
{
struct V_7 * V_8 =
F_66 ( V_132 , F_67 ( * V_8 ) , V_36 . V_132 . V_132 ) ;
struct V_1 * V_1 = V_8 -> V_36 . V_121 ;
...
V_19 = F_7 ( V_8 -> V_36 . V_121 ) -> V_17 . V_17 . V_19 ;
V_6 = F_8 ( V_19 ) -> V_6 ;
if ( V_143 & F_70 ( V_6 ) ) {
V_9 = F_4 ( F_29 ( V_6 ) ) ;
F_10 ( F_29 ( V_6 ) , V_9 | V_144 ) ;
}
F_58 ( & V_8 -> V_36 . V_104 ) ;
}
...
V_6 = F_8 ( V_19 ) -> V_6 ;
V_143 &= F_70 ( V_6 ) ;
V_8 -> V_36 . V_123 |= V_143 ;
if ( V_143 )
F_68 ( V_8 ) ;
F_58 ( & V_8 -> V_36 . V_104 ) ;
}
void F_72 ( struct V_7 * V_8 ,
unsigned V_143 , enum V_145 V_146 )
{
struct V_29 * V_19 ;
enum V_6 V_6 ;
F_53 ( & V_8 -> V_36 . V_104 ) ;
...
if ( V_143 )
F_68 ( V_8 ) ;
if ( ! V_8 -> V_36 . V_119 && ! V_8 -> V_36 . V_123 )
if ( ! F_73 ( & V_8 -> V_36 . V_132 . V_132 ) )
F_56 ( & V_8 -> V_36 . V_132 ,
F_57 ( 100 ) ) ;
F_58 ( & V_8 -> V_36 . V_104 ) ;
}
...
V_8 -> V_36 . V_64 = V_8 -> V_72 . V_36 . V_150 ;
if ( V_110 . V_111 == 2 && ! V_8 -> V_36 . V_64 ) {
F_43 ( L_16 ) ;
V_8 -> V_36 . V_64 = true ;
}
if ( V_110 . V_111 == 3 && V_8 -> V_36 . V_64 ) {
F_43 ( L_17 ) ;
V_8 -> V_36 . V_64 = false ;
}
F_76 ( & V_8 -> V_36 . V_132 , F_65 ) ;
F_77 ( & V_8 -> V_36 . V_104 ) ;
}
