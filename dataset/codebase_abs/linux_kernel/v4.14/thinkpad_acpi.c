...
{
static char V_753 [] V_754 = L_401 ;
return ( V_1 ) ? & V_753 [ 4 ] : & V_753 [ 0 ] ;
}
static void F_415 ( struct V_67 * V_68 )
{
F_20 ( V_310 , L_402 , V_68 -> V_51 ) ;
F_416 ( & V_68 -> V_755 ) ;
if ( V_68 -> V_79 . V_80 ) {
F_20 ( V_310 ,
L_403 , V_68 -> V_51 ) ;
F_25 ( ! V_68 -> V_71 ) ;
F_417 ( * V_68 -> V_71 -> V_16 ,
V_68 -> V_71 -> type ,
F_27 ) ;
V_68 -> V_79 . V_80 = 0 ;
}
...
F_20 ( V_55 , L_406 , V_68 -> V_51 ) ;
}
static int T_1 F_420 ( struct V_315 * V_316 )
{
int V_100 ;
...
if ( V_68 -> V_101 )
V_374 |= V_766 ;
V_760 = F_422 ( V_68 -> V_51 , V_374 , V_757 ,
& V_767 , V_68 ) ;
if ( ! V_760 ) {
F_8 ( L_410 , V_68 -> V_51 ) ;
V_100 = - V_75 ;
...
static bool T_2 T_1 F_424 ( const char V_37 )
{
return ( V_37 >= '0' && V_37 <= '9' ) || ( V_37 >= 'A' && V_37 <= 'Z' ) ;
}
static bool T_2 T_1 F_425 ( const char * const V_118 ,
const char V_157 )
{
...
return 0 ;
V_118 = F_428 ( V_773 ) ;
V_770 -> V_774 = F_429 ( V_118 , V_83 ) ;
if ( V_118 && ! V_770 -> V_774 )
return - V_84 ;
if ( ! ( F_425 ( V_770 -> V_774 , 'E' ) ||
F_425 ( V_770 -> V_774 , 'C' ) ) )
return 0 ;
...
| V_770 -> V_774 [ 5 ] ;
while ( ( V_60 = F_430 ( V_775 , NULL , V_60 ) ) ) {
if ( sscanf ( V_60 -> V_51 ,
L_414 ,
V_772 ) == 1 ) {
V_772 [ sizeof( V_772 ) - 1 ] = 0 ;
V_772 [ strcspn ( V_772 , L_415 ) ] = 0 ;
V_770 -> V_654 = F_429 ( V_772 , V_83 ) ;
if ( ! V_770 -> V_654 )
return - V_84 ;
if ( F_425 ( V_772 , 'H' ) ) {
V_770 -> V_12 = V_772 [ 0 ]
...
V_118 = F_428 ( V_776 ) ;
if ( V_118 && ! ( strncasecmp ( V_118 , L_417 , 8 ) && strncasecmp ( V_118 , L_418 , 6 ) ) ) {
V_770 -> V_777 = F_429 ( V_118 , V_83 ) ;
if ( ! V_770 -> V_777 )
return - V_84 ;
} else {
V_118 = F_428 ( V_778 ) ;
if ( V_118 && ! ( strncasecmp ( V_118 , L_418 , 6 ) ) ) {
V_770 -> V_777 = F_429 ( V_118 , V_83 ) ;
if ( ! V_770 -> V_777 )
return - V_84 ;
}
...
V_118 = F_428 ( V_779 ) ;
V_770 -> V_780 = F_429 ( V_118 , V_83 ) ;
if ( V_118 && ! V_770 -> V_780 )
return - V_84 ;
return 0 ;
}
static int T_1 F_431 ( void )
{
int V_781 ;
if ( V_782 )
return - V_75 ;
...
static int T_1 F_433 ( const char * V_687 , struct V_786 * V_787 )
{
unsigned int V_42 ;
struct V_67 * V_68 ;
...
V_757 = F_445 ( V_798 , V_799 ) ;
if ( ! V_757 ) {
F_8 ( L_427 V_798 L_269 ) ;
F_435 () ;
return - V_75 ;
}
V_100 = F_446 ( & V_795 ) ;
...
V_212 -> V_51 = L_434 ;
V_212 -> V_806 = V_803 L_435 ;
V_212 -> V_144 . V_807 = V_808 ;
V_212 -> V_144 . V_6 = V_7 . V_6 ;
V_212 -> V_144 . V_809 = V_810 ;
V_212 -> V_144 . V_811 = V_812 ;
V_212 -> V_60 . V_52 = & V_154 -> V_60 ;
}
F_323 () ;
for ( V_42 = 0 ; V_42 < F_100 ( V_788 ) ; V_42 ++ ) {
V_100 = F_420 ( & V_788 [ V_42 ] ) ;
