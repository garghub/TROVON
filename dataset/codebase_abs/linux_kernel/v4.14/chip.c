...
struct V_12 * V_128 ;
struct V_3 * V_129 ;
V_129 = F_35 ( & V_2 -> V_15 , V_62 ) ;
if ( V_129 ) {
V_128 = F_36 ( V_129 , struct V_12 , V_15 ) ;
V_2 -> V_15 . V_76 = F_32 ( V_128 ) ;
V_2 -> V_15 . V_130 = F_33 ( V_2 ) ;
if ( ! V_2 -> V_15 . V_130 ) {
F_9 ( L_8 ) ;
return - V_131 ;
}
} else {
V_129 = F_35 ( & V_2 -> V_15 , V_132 ) ;
if ( V_129 ) {
V_128 = F_36 ( V_129 , struct V_12 ,
V_15 ) ;
V_2 -> V_15 . V_76 = F_30 ( V_128 ) ;
V_2 -> V_15 . V_130 = F_33 ( V_2 ) ;
if ( ! V_2 -> V_15 . V_130 ) {
F_9 ( L_9 ) ;
return - V_131 ;
...
V_128 = F_36 ( V_129 , struct V_12 ,
V_15 ) ;
F_26 ( V_128 , & V_2 -> V_15 . V_76 ,
& V_2 -> V_15 . V_77 ) ;
}
}
F_21 ( V_59 , L_11 ,
V_2 -> V_15 . V_130 , V_2 -> V_15 . V_76 , V_2 -> V_15 . V_76 ,
V_2 -> V_15 . V_77 , V_2 -> V_15 . V_77 ) ;
if ( ! V_2 -> V_15 . V_76 ) {
F_9 ( L_12 ) ;
return - V_51 ;
}
if ( V_2 -> V_15 . V_76 > V_133 ) {
F_9 ( L_13 ) ;
return - V_51 ;
}
return 0 ;
}
static T_1 F_37 ( struct V_1 * V_2 , T_1 * V_134 ,
T_4 * type )
{
T_1 V_30 ;
V_30 = V_2 -> V_6 -> V_7 ( V_2 -> V_8 , * V_134 ) ;
* V_134 += 4 ;
if ( ! type )
return V_30 ;
* type = ( V_30 & V_135 ) ;
...
static int F_38 ( struct V_1 * V_2 , T_1 * V_134 ,
T_1 * V_138 , T_1 * V_22 )
{
T_4 V_139 ;
T_1 V_30 ;
...
* V_138 = 0 ;
* V_22 = 0 ;
V_30 = F_37 ( V_2 , V_134 , & V_139 ) ;
if ( V_139 == V_144 ) {
V_140 = ( V_30 & V_145 ) >> V_146 ;
V_143 = V_147 ;
} else if ( V_139 == V_137 ) {
* V_134 -= 4 ;
V_143 = V_148 ;
...
if ( V_30 & V_136 )
F_37 ( V_2 , V_134 , NULL ) ;
V_142 = ( V_30 & V_153 ) >> V_154 ;
if ( V_142 == V_155 ) {
V_30 = F_37 ( V_2 , V_134 , NULL ) ;
if ( V_30 & V_136 )
F_37 ( V_2 , V_134 , NULL ) ;
}
if ( V_142 != V_156 )
continue;
V_141 = ( V_30 & V_157 ) >> V_158 ;
if ( * V_138 == 0 && V_141 == V_159 )
* V_138 = V_30 & V_160 ;
if ( * V_22 == 0 && V_141 == V_143 )
* V_22 = V_30 & V_160 ;
} while ( * V_138 == 0 || * V_22 == 0 );
return 0 ;
}
static
...
T_1 V_30 ;
T_3 V_52 ;
T_4 V_162 , V_163 , V_164 , V_165 , V_11 ;
T_1 V_9 , V_166 ;
int V_167 ;
V_134 = V_2 -> V_6 -> V_7 ( V_2 -> V_8 , F_40 ( V_168 , V_169 ) ) ;
while ( V_161 != V_150 ) {
V_30 = F_37 ( V_2 , & V_134 , & V_161 ) ;
if ( ! ( V_30 & V_170 ) )
continue;
if ( V_161 == V_171 )
continue;
if ( V_161 != V_152 )
continue;
V_52 = ( V_30 & V_172 ) >> V_173 ;
V_30 = F_37 ( V_2 , & V_134 , & V_161 ) ;
if ( F_27 ( ( V_30 & V_135 ) != V_152 ) )
return - V_151 ;
V_162 = ( V_30 & V_174 ) >> V_175 ;
V_163 = ( V_30 & V_176 ) >> V_177 ;
V_164 = ( V_30 & V_178 ) >> V_179 ;
V_165 = ( V_30 & V_180 ) >> V_181 ;
V_11 = ( V_30 & V_182 ) >> V_183 ;
if ( V_164 + V_165 == 0 &&
V_52 != V_184 )
continue;
V_167 = F_38 ( V_2 , & V_134 , & V_9 , & V_166 ) ;
if ( V_167 )
continue;
V_4 = F_15 ( V_2 , V_52 , V_9 , V_166 ) ;
if ( F_41 ( V_4 ) )
return F_42 ( V_4 ) ;
V_4 -> V_11 = V_11 ;
}
...
T_1 V_185 ;
int V_21 ;
V_5 = V_2 -> V_6 -> V_7 ( V_2 -> V_8 , F_40 ( V_168 , V_45 ) ) ;
V_2 -> V_15 . V_14 = V_5 & V_186 ;
V_2 -> V_15 . V_90 = ( V_5 & V_187 ) >> V_188 ;
V_185 = ( V_5 & V_189 ) >> V_190 ;
F_14 ( V_2 -> V_15 . V_14 , V_2 -> V_15 . V_127 , sizeof( V_2 -> V_15 . V_127 ) ) ;
F_21 ( V_59 , L_14 ,
V_185 == V_191 ? L_15 : L_16 , V_2 -> V_15 . V_127 ,
V_2 -> V_15 . V_90 ) ;
if ( V_185 == V_191 ) {
if ( V_2 -> V_15 . V_14 != V_192 ) {
F_9 ( L_17 ) ;
return - V_65 ;
}
V_2 -> V_193 = F_4 ;
...
V_200 , 0 ) ;
F_1 ( V_2 , V_4 ) ;
V_4 = F_15 ( V_2 , V_201 , 0x18001000 , 0 ) ;
F_1 ( V_2 , V_4 ) ;
} else if ( V_185 == V_202 ) {
V_2 -> V_193 = F_5 ;
V_2 -> V_194 = F_10 ;
...
case V_62 :
case V_63 :
V_203 = F_36 ( V_4 , struct V_12 , V_15 ) ;
V_30 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_203 -> V_22 + V_23 ) ;
V_30 &= V_204 ;
F_29 ( V_4 , V_30 , V_204 ,
V_204 ) ;
break;
...
int V_21 = 0 ;
V_15 = & V_14 -> V_15 ;
V_206 = F_48 ( & V_14 -> V_54 , struct V_12 , V_53 ) ;
V_9 = V_206 -> V_15 . V_9 ;
V_15 -> V_208 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 ,
F_40 ( V_9 , V_209 ) ) ;
V_15 -> V_210 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 ,
F_40 ( V_9 ,
V_211 ) ) ;
V_207 = F_49 ( V_15 ) ;
if ( V_15 -> V_208 & V_212 ) {
V_30 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 ,
F_40 ( V_207 -> V_9 , V_213 ) ) ;
V_15 -> V_214 = V_30 & V_215 ;
V_15 -> V_216 = V_30 ;
}
F_21 ( V_59 , L_20 ,
V_206 -> V_15 . V_11 , V_15 -> V_214 , V_15 -> V_216 ) ;
if ( V_14 -> V_6 -> V_217 )
V_21 = V_14 -> V_6 -> V_217 ( V_14 -> V_8 , V_15 ) ;
return V_21 ;
}
struct V_205 * F_50 ( void * V_8 ,
const struct V_218 * V_6 )
{
struct V_1 * V_14 ;
int V_167 = 0 ;
if ( F_27 ( ! V_6 -> V_7 ) )
...
struct V_3 * F_35 ( struct V_205 * V_15 , T_3 V_49 )
{
struct V_1 * V_14 ;
struct V_12 * V_4 ;
V_14 = F_36 ( V_15 , struct V_1 , V_15 ) ;
...
struct V_3 * F_56 ( struct V_205 * V_15 )
{
struct V_1 * V_14 ;
struct V_12 * V_206 ;
V_14 = F_36 ( V_15 , struct V_1 , V_15 ) ;
V_206 = F_48 ( & V_14 -> V_54 , struct V_12 , V_53 ) ;
if ( F_27 ( ! V_206 || V_206 -> V_15 . V_52 != V_196 ) )
return F_35 ( V_15 , V_196 ) ;
return & V_206 -> V_15 ;
}
struct V_3 * F_49 ( struct V_205 * V_15 )
{
struct V_3 * V_206 = F_56 ( V_15 ) ;
struct V_3 * V_207 ;
if ( V_206 -> V_11 >= 35 &&
V_15 -> V_210 & V_224 ) {
V_207 = F_35 ( V_15 , V_184 ) ;
if ( V_207 )
return V_207 ;
}
return V_206 ;
...
return V_4 -> V_14 -> V_193 ( V_4 ) ;
}
void F_46 ( struct V_3 * V_15 , T_1 V_28 , T_1 V_29 )
{
struct V_12 * V_4 ;
V_4 = F_36 ( V_15 , struct V_12 , V_15 ) ;
V_4 -> V_14 -> V_194 ( V_4 , V_28 , V_29 ) ;
}
...
struct V_12 * V_4 ;
V_4 = F_36 ( V_15 , struct V_12 , V_15 ) ;
V_4 -> V_14 -> V_195 ( V_4 , V_28 , V_29 , V_40 ) ;
}
static void
...
V_14 -> V_6 -> V_220 ( V_14 -> V_8 , & V_14 -> V_15 , 0 ) ;
...
static bool F_60 ( struct V_1 * V_14 , T_1 V_228 )
{
struct V_3 * V_4 ;
V_14 -> V_6 -> V_220 ( V_14 -> V_8 , & V_14 -> V_15 , V_228 ) ;
...
static bool F_62 ( struct V_1 * V_14 , T_1 V_228 )
{
struct V_3 * V_4 ;
V_14 -> V_6 -> V_220 ( V_14 -> V_8 , & V_14 -> V_15 , V_228 ) ;
...
void F_44 ( struct V_205 * V_15 )
{
struct V_1 * V_14 ;
struct V_3 * V_229 ;
F_21 ( V_230 , L_22 ) ;
V_14 = F_36 ( V_15 , struct V_1 , V_15 ) ;
V_229 = F_35 ( V_15 , V_62 ) ;
if ( V_229 ) {
F_59 ( V_14 ) ;
return;
}
V_229 = F_35 ( V_15 , V_63 ) ;
if ( V_229 ) {
F_61 ( V_14 ) ;
return;
}
V_229 = F_35 ( V_15 , V_60 ) ;
if ( V_229 ) {
F_57 ( V_14 ) ;
return;
}
}
bool F_63 ( struct V_205 * V_15 , T_1 V_228 )
{
struct V_1 * V_14 ;
struct V_3 * V_229 ;
F_21 ( V_230 , L_22 ) ;
...
V_229 = F_35 ( V_15 , V_62 ) ;
if ( V_229 )
return F_60 ( V_14 , V_228 ) ;
V_229 = F_35 ( V_15 , V_63 ) ;
if ( V_229 )
return F_62 ( V_14 , V_228 ) ;
V_229 = F_35 ( V_15 , V_60 ) ;
if ( V_229 )
return F_58 ( V_14 ) ;
return false ;
}
bool F_64 ( struct V_205 * V_15 )
{
T_1 V_9 , V_231 , V_66 , V_232 = ~ 0 ;
struct V_1 * V_14 ;
struct V_3 * V_207 = F_49 ( V_15 ) ;
F_21 ( V_230 , L_22 ) ;
if ( V_15 -> V_214 < 17 )
return false ;
V_9 = F_56 ( V_15 ) -> V_9 ;
...
case V_110 :
case V_111 :
V_231 = F_40 ( V_207 -> V_9 , V_234 ) ;
V_14 -> V_6 -> V_31 ( V_14 -> V_8 , V_231 , 3 ) ;
V_231 = F_40 ( V_207 -> V_9 , V_235 ) ;
V_66 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_231 ) ;
return ( V_66 & V_232 ) != 0 ;
case V_91 :
V_231 = F_40 ( V_9 , V_236 ) ;
V_66 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_231 ) ;
return V_66 != 0 ;
default:
V_231 = F_40 ( V_207 -> V_9 , V_237 ) ;
V_66 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_231 ) ;
if ( ( V_66 & V_238 ) == 0 )
return false ;
V_231 = F_40 ( V_207 -> V_9 , V_239 ) ;
V_66 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_231 ) ;
return ( V_66 & ( V_240 |
V_241 ) ) == 0 ;
}
