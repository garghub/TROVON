...
static int F_102 ( struct V_118 * V_119 , struct V_12 * V_13 )
{
if ( ! F_15 ( V_13 ) )
...
static int F_104 ( struct V_242 * V_243 , void * V_244 )
{
T_1 * V_6 = V_243 -> V_245 ;
F_105 ( V_243 , L_56 , ( long long ) F_103 ( V_6 ) ) ;
return 0 ;
}
static int F_106 ( struct V_246 * V_246 , struct V_247 * V_247 )
{
return F_107 ( V_247 , F_104 , F_108 ( V_246 ) ) ;
}
static T_12 * F_109 ( T_1 * V_6 )
{
return V_248 ;
}
static const struct V_249 * F_110 ( T_1 * V_6 )
{
return NULL ;
}
static unsigned int F_111 ( T_7 * V_250 )
{
...
static void F_121 ( struct V_265 * V_7 )
{
...
static int F_126 ( struct V_268 * V_269 , T_13 V_270 )
{
struct V_1 * V_30 ;
int V_100 = - V_271 ;
F_2 ( & V_272 ) ;
...
if ( ! V_30 )
goto V_274;
V_100 = F_127 ( & V_30 -> V_125 , V_269 , V_270 ) ;
if ( V_100 < 0 )
F_7 ( V_30 ) ;
V_274:
F_6 ( & V_272 ) ;
...
static void F_128 ( struct V_2 * V_3 , T_13 V_270 )
{
struct V_1 * V_30 = F_3 ( V_3 , V_1 ) ;
F_2 ( & V_272 ) ;
F_129 ( & V_30 -> V_125 , V_270 ) ;
F_7 ( V_30 ) ;
F_6 ( & V_272 ) ;
}
static int F_130 ( struct V_141 * V_142 , unsigned long V_275 )
{
struct V_179 V_180 ;
char V_72 [ 16 ] ;
int V_52 ;
char V_276 ;
if ( F_131 ( & V_276 , ( void V_277 * ) V_275 , sizeof( char ) ) )
return - V_278 ;
...
return F_132 ( V_142 , & V_180 ) ;
}
static int F_133 ( struct V_141 * V_142 , unsigned long V_275 )
{
struct V_179 V_180 ;
char V_72 [ 16 ] ;
int V_52 ;
...
return V_52 ;
V_276 = V_72 [ 11 ] & 0x0f ;
if ( F_134 ( ( void V_277 * ) V_275 , & V_276 , sizeof( char ) ) )
return - V_278 ;
return 0 ;
}
static int F_135 ( struct V_268 * V_269 , T_13 V_270 ,
...
switch ( V_26 ) {
case V_280 :
return F_130 ( & V_30 -> V_125 , V_275 ) ;
case V_281 :
return F_133 ( & V_30 -> V_125 , V_275 ) ;
default:
break;
}
V_54 = F_136 ( V_30 -> V_6 , V_269 , V_26 , V_275 ) ;
if ( V_54 == - V_282 )
V_54 = F_137 ( & V_30 -> V_125 , V_269 , V_270 , V_26 , V_275 ) ;
return V_54 ;
}
static int F_138 ( struct V_268 * V_269 , T_13 V_270 ,
unsigned int V_26 , unsigned long V_275 )
{
int V_283 ;
F_2 ( & V_272 ) ;
V_283 = F_135 ( V_269 , V_270 , V_26 , V_275 ) ;
F_6 ( & V_272 ) ;
return V_283 ;
}
...
V_6 -> V_132 = V_132 ;
V_6 -> V_287 = F_49 ;
V_30 = F_143 ( sizeof( struct V_1 ) , V_166 ) ;
if ( V_30 == NULL ) {
...
V_30 -> V_7 . V_292 = F_121 ;
F_146 ( & V_30 -> V_7 , L_62 , F_147 ( & V_6 -> V_291 ) ) ;
if ( F_148 ( & V_30 -> V_7 ) )
goto V_293;
V_30 -> V_6 = V_6 ;
V_30 -> V_264 = & V_294 ;
