...
if ( V_32 )
break;
F_13 ( & V_19 -> F_9 . V_36 , V_31 ) ;
if ( ! F_11 ( & V_19 -> F_9 . V_34 ) ) {
V_2 = F_14 ( & V_19 -> F_9 . V_34 , struct V_1 , V_37 ) ;
F_15 ( & V_2 -> V_37 ) ;
} else
V_2 = NULL ;
F_16 ( & V_19 -> F_9 . V_36 , V_31 ) ;
if ( V_2 ) {
F_6 ( V_2 ) ;
F_7 ( V_2 ) ;
}
...
void F_18 ( struct V_22 * V_19 )
{
struct V_38 * V_39 = F_19 ( F_9 , V_19 , L_5 ) ;
if ( F_20 ( V_39 ) ) {
V_19 -> F_9 . V_39 = NULL ;
F_21 ( V_40 L_6
L_7 ) ;
...
V_19 -> F_9 . V_39 = V_39 ;
V_19 -> F_9 . V_41 = V_19 -> F_9 . V_39 -> V_41 ;
}
}
