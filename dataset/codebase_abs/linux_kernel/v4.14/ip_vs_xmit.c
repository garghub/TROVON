...
int
F_86 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , struct V_61 * V_62 )
{
...
int
F_87 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , struct V_61 * V_62 )
{
struct V_22 * V_29 ;
...
T_3 V_125 , * V_126 ;
V_126 = F_88 ( V_18 , V_62 -> V_21 , sizeof( V_125 ) , & V_125 ) ;
if ( V_126 == NULL )
goto V_119;
F_89 ( V_101 , * V_126 ) ;
F_37 ( 10 , L_12 , F_90 ( * V_126 ) ) ;
}
V_123 = F_91 ( F_30 ( V_18 ) ) ;
...
enum V_129 V_130 ;
struct V_131 * V_132 = F_93 ( V_18 , & V_130 ) ;
if ( V_132 ) {
F_94 ( 10 , V_133 , V_115 , V_18 , V_62 -> V_134 ,
L_13
L_14 ) ;
goto V_119;
}
...
F_94 ( 1 , V_133 , V_115 , V_18 , V_62 -> V_134 ,
L_15
L_16 ) ;
goto V_119;
}
...
int
F_97 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , struct V_61 * V_62 )
{
struct V_37 * V_29 ;
int V_81 , V_122 ;
...
struct V_131 * V_132 = F_93 ( V_18 , & V_130 ) ;
if ( V_132 ) {
F_94 ( 10 , V_50 , V_115 , V_18 , V_62 -> V_134 ,
L_18
L_14 ) ;
goto V_119;
}
...
F_94 ( 1 , V_50 , V_115 , V_18 , V_62 -> V_134 ,
L_18
L_19 ) ;
goto V_119;
}
...
F_96 ( 10 , V_50 , V_115 , V_18 , V_62 -> V_134 , L_17 ) ;
V_18 -> V_120 = 1 ;
...
T_4 V_144 ;
#ifdef F_24
struct V_75 * V_145 = NULL ;
#endif
F_72 ( V_18 ) ;
if ( F_99 ( V_18 ) < V_137 || F_100 ( V_18 ) ) {
V_142 = F_101 ( V_18 , V_137 ) ;
if ( ! V_142 )
goto error;
if ( V_18 -> V_56 )
F_102 ( V_142 , V_18 -> V_56 ) ;
F_103 ( V_18 ) ;
V_18 = V_142 ;
}
#ifdef F_24
...
* V_76 = V_143 -> V_76 ;
if ( V_139 )
* V_139 = F_90 ( V_143 -> V_148 ) ;
}
* V_140 = F_106 ( V_144 , V_144 ) ;
return V_18 ;
error:
F_85 ( V_18 ) ;
return F_107 ( - V_149 ) ;
}
static inline int F_108 ( int V_150 , int V_151 )
{
switch ( V_150 ) {
case V_133 :
return V_152 ;
...
int
F_109 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , struct V_61 * V_62 )
{
...
V_29 = F_30 ( V_18 ) ;
V_155 = V_29 -> V_7 . V_38 ;
V_137 = F_110 ( V_155 ) + sizeof( struct V_79 ) ;
V_156 = F_38 ( V_60 ) ? & V_141 : NULL ;
V_18 = F_98 ( V_18 , V_101 -> V_110 , V_137 ,
& V_138 , NULL , & V_140 ,
& V_76 , V_156 ) ;
if ( F_17 ( V_18 ) )
goto V_119;
if ( F_111 ( V_18 , F_108 ( V_133 , V_101 -> V_110 ) ) )
goto V_119;
V_18 -> V_157 = V_18 -> V_158 ;
F_112 ( V_18 , sizeof( struct V_79 ) ) ;
F_113 ( V_18 ) ;
memset ( & ( F_114 ( V_18 ) -> V_159 ) , 0 , sizeof( F_114 ( V_18 ) -> V_159 ) ) ;
V_117 = F_29 ( V_18 ) ;
V_117 -> V_160 = 4 ;
V_117 -> V_161 = sizeof( struct V_79 ) >> 2 ;
V_117 -> V_67 = V_141 ;
V_117 -> V_162 = V_138 ;
V_117 -> V_163 = V_140 ;
...
V_117 -> V_26 = V_26 ;
V_117 -> V_76 = V_76 ;
F_115 ( V_23 , V_18 , NULL ) ;
V_18 -> V_120 = 1 ;
V_102 = F_68 ( V_18 , V_101 ) ;
if ( V_102 == V_103 )
F_116 ( V_23 , V_18 -> V_56 , V_18 ) ;
else if ( V_102 == V_164 )
F_85 ( V_18 ) ;
F_84 ( 10 ) ;
return V_107 ;
...
int
F_117 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , struct V_61 * V_62 )
{
struct V_37 * V_29 ;
struct V_91 V_26 ;
...
V_29 = (struct V_37 * ) F_27 ( V_18 ) ;
V_155 = V_29 -> V_7 . V_38 ;
V_137 = F_110 ( V_155 ) + sizeof( struct V_75 ) ;
V_18 = F_98 ( V_18 , V_101 -> V_110 , V_137 ,
& V_138 , & V_139 ,
& V_140 , & V_76 , NULL ) ;
if ( F_17 ( V_18 ) )
goto V_119;
if ( F_111 ( V_18 , F_108 ( V_50 , V_101 -> V_110 ) ) )
goto V_119;
V_18 -> V_157 = V_18 -> V_158 ;
F_112 ( V_18 , sizeof( struct V_75 ) ) ;
F_113 ( V_18 ) ;
memset ( & ( F_114 ( V_18 ) -> V_159 ) , 0 , sizeof( F_114 ( V_18 ) -> V_159 ) ) ;
V_117 = F_26 ( V_18 ) ;
V_117 -> V_160 = 6 ;
...
memset ( & V_117 -> V_166 , 0 , sizeof( V_117 -> V_166 ) ) ;
F_118 ( V_117 , 0 , V_140 ) ;
...
V_102 = F_68 ( V_18 , V_101 ) ;
if ( V_102 == V_103 )
F_119 ( V_101 -> V_60 -> V_23 , V_18 -> V_56 , V_18 ) ;
else if ( V_102 == V_164 )
F_85 ( V_18 ) ;
F_84 ( 10 ) ;
return V_107 ;
...
int
F_120 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , struct V_61 * V_62 )
{
int V_81 ;
F_82 ( 10 ) ;
...
struct V_114 * V_115 , int V_167 , unsigned int V_168 ,
struct V_61 * V_117 )
{
struct V_22 * V_29 ;
int V_122 ;
...
int V_25 , V_123 ;
F_82 ( 10 ) ;
if ( F_123 ( V_101 ) != V_169 ) {
if ( V_101 -> V_170 )
V_122 = V_101 -> V_170 ( V_18 , V_101 , V_115 , V_117 ) ;
else
V_122 = V_103 ;
F_124 ( & V_101 -> V_171 ) ;
goto V_172;
...
int
F_126 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , int V_167 , unsigned int V_168 ,
struct V_61 * V_62 )
{
struct V_37 * V_29 ;
...
if ( F_123 ( V_101 ) != V_169 ) {
if ( V_101 -> V_170 )
V_122 = V_101 -> V_170 ( V_18 , V_101 , V_115 , V_62 ) ;
else
V_122 = V_103 ;
F_124 ( & V_101 -> V_171 ) ;
goto V_172;
