...
static bool F_87 ( V_90 V_107 )
{
int V_108 = 64 - ( V_109 + 1 ) ;
long V_110 = ( long ) V_107 ;
return ( ( ( V_110 << V_108 ) >> V_108 ) == V_110 ) ;
}
static T_2 V_28 ( int V_17 , void * V_111 )
{
struct V_1 * V_2 = V_111 ;
struct V_34 * V_35 = NULL ;
int V_112 , V_113 , V_114 = 0 ;
F_88 ( V_115 , V_2 -> V_30 + V_116 ) ;
V_113 = F_89 ( V_2 -> V_30 + V_32 ) & V_117 ;
V_112 = F_89 ( V_2 -> V_30 + V_31 ) & V_117 ;
while ( V_112 != V_113 ) {
struct V_36 * V_37 ;
struct V_95 * V_96 ;
struct V_97 * V_98 ;
...
V_90 V_38 ;
V_114 = 1 ;
V_98 = & V_2 -> V_20 [ V_112 / sizeof( * V_98 ) ] ;
V_119 = V_120 ;
V_38 = ( V_90 ) V_98 -> V_107 << V_58 ;
if ( ! V_98 -> V_121 ) {
F_16 ( L_9 ,
...
if ( ! F_87 ( V_38 ) )
goto V_122;
F_91 ( & V_35 -> V_63 -> V_125 ) ;
V_96 = F_92 ( V_35 -> V_63 , V_38 ) ;
if ( ! V_96 || V_38 < V_96 -> V_126 )
goto V_127;
if ( F_86 ( V_96 , V_98 ) )
goto V_127;
V_18 = F_93 ( V_96 , V_38 ,
...
V_119 = V_130 ;
V_127:
F_94 ( & V_35 -> V_63 -> V_125 ) ;
F_77 ( V_35 -> V_63 ) ;
V_122:
F_41 () ;
F_42 (sdev, &svm->devs, list) {
if ( V_37 -> V_53 == F_95 ( V_98 -> V_131 , V_98 -> V_132 ) )
break;
}
F_43 () ;
if ( F_54 ( & V_37 -> V_93 == & V_35 -> V_89 ) )
V_37 = NULL ;
if ( V_37 && V_37 -> V_75 && V_37 -> V_75 -> V_133 ) {
int V_134 = ( V_98 -> V_102 << 3 ) | ( V_98 -> V_104 << 2 ) |
( V_98 -> V_100 << 1 ) | ( V_98 -> V_135 ) ;
V_37 -> V_75 -> V_133 ( V_37 -> V_72 , V_98 -> V_44 , V_98 -> V_107 , V_98 -> V_136 , V_134 , V_119 ) ;
}
V_37 = NULL ;
V_35 = NULL ;
V_123:
if ( V_98 -> V_137 ) {
V_118 . V_43 = F_96 ( V_98 -> V_44 ) |
F_97 ( ( V_98 -> V_131 << 8 ) | V_98 -> V_132 ) |
F_98 ( V_98 -> V_121 ) |
V_138 ;
V_118 . V_49 = F_99 ( V_98 -> V_139 ) |
F_100 ( V_98 -> V_136 ) | F_101 ( V_119 ) ;
F_33 ( & V_118 , V_2 ) ;
} else if ( V_98 -> V_140 ) {
V_118 . V_43 = F_102 ( V_98 -> V_139 ) |
F_103 ( V_98 -> V_136 ) | F_104 ( V_98 -> V_131 ) |
F_105 ( V_98 -> V_44 ) | V_141 ;
V_118 . V_49 = F_106 ( V_38 ) | F_107 ( V_98 -> V_132 ) |
F_108 ( V_119 ) ;
F_33 ( & V_118 , V_2 ) ;
}
V_112 = ( V_112 + sizeof( * V_98 ) ) & V_117 ;
}
F_19 ( V_2 -> V_30 + V_31 , V_113 ) ;
return F_109 ( V_114 ) ;
}
