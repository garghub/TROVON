...
static int F_59 ( struct V_78 * V_79 , struct V_12 * V_13 ,
struct V_4 * V_58 ,
struct V_31 * V_80 ) {
struct V_81 {
unsigned long long V_13 ;
unsigned long V_64 ;
unsigned long args [ V_82 ] ;
} V_83 ;
int V_33 ;
* (struct V_12 * * ) & V_83 = V_13 ;
V_83 . V_64 = V_80 -> V_14 ;
for ( V_33 = 0 ; V_33 < V_58 -> V_36 ; V_33 ++ )
V_83 . args [ V_33 ] = V_80 -> args [ V_33 ] ;
return F_60 ( V_79 , & V_83 ) ;
}
static void F_61 ( void * V_84 , struct V_12 * V_13 , long V_55 )
{
struct V_4 * V_58 ;
struct V_31 * V_80 ;
struct V_85 * V_86 ;
...
if ( ! V_58 )
return;
V_79 = F_63 ( V_58 -> V_35 -> V_79 ) ;
V_86 = F_64 ( V_58 -> V_35 -> V_89 ) ;
if ( ! V_79 && F_65 ( V_86 ) )
return;
V_65 = sizeof( unsigned long ) * V_58 -> V_36 + sizeof( * V_80 ) ;
V_65 = F_66 ( V_65 + sizeof( V_90 ) , sizeof( V_91 ) ) ;
V_65 -= sizeof( V_90 ) ;
V_80 = F_67 ( V_65 , NULL , & V_87 ) ;
if ( ! V_80 )
return;
V_80 -> V_14 = V_64 ;
F_35 ( V_66 , V_13 , 0 , V_58 -> V_36 ,
( unsigned long * ) & V_80 -> args ) ;
if ( ( V_79 && ! F_59 ( V_79 , V_13 , V_58 , V_80 ) ) ||
F_65 ( V_86 ) ) {
F_68 ( V_87 ) ;
return;
}
F_69 ( V_80 , V_65 , V_87 ,
V_58 -> V_35 -> V_23 . type , 1 , V_13 ,
V_86 , NULL , NULL ) ;
}
...
static int F_75 ( struct V_78 * V_79 , struct V_12 * V_13 ,
struct V_40 * V_80 ) {
struct V_81 {
unsigned long long V_13 ;
unsigned long V_64 ;
...
static void F_76 ( void * V_84 , struct V_12 * V_13 , long V_44 )
{
struct V_4 * V_58 ;
struct V_40 * V_80 ;
struct V_85 * V_86 ;
...
if ( ! V_58 )
return;
V_79 = F_63 ( V_58 -> V_42 -> V_79 ) ;
V_86 = F_64 ( V_58 -> V_42 -> V_89 ) ;
if ( ! V_79 && F_65 ( V_86 ) )
return;
V_65 = F_66 ( sizeof( * V_80 ) + sizeof( V_90 ) , sizeof( V_91 ) ) ;
V_65 -= sizeof( V_90 ) ;
V_80 = F_67 ( V_65 , NULL , & V_87 ) ;
if ( ! V_80 )
return;
V_80 -> V_14 = V_64 ;
V_80 -> V_44 = F_38 ( V_66 , V_13 ) ;
if ( ( V_79 && ! F_75 ( V_79 , V_13 , V_80 ) ) ||
F_65 ( V_86 ) ) {
F_68 ( V_87 ) ;
return;
}
F_69 ( V_80 , V_65 , V_87 , V_58 -> V_42 -> V_23 . type ,
1 , V_13 , V_86 , NULL , NULL ) ;
}
...
static int F_79 ( struct V_2 * V_23 ,
enum V_95 type , void * V_6 )
{
...
static int F_81 ( struct V_2 * V_23 ,
enum V_95 type , void * V_6 )
{
struct V_56 * V_70 = V_6 ;
switch ( type ) {
