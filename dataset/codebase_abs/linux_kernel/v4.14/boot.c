void T_1 T_2 * F_1 ( unsigned long V_1 , unsigned long V_2 )
{
if ( ! V_1 || ! V_2 )
return NULL ;
return F_2 ( V_1 , V_2 ) ;
}
void T_1 F_3 ( void T_2 * V_3 , unsigned long V_2 )
{
if ( ! V_3 || ! V_2 )
return;
F_4 ( V_3 , V_2 ) ;
...
static int F_9 ( int V_17 , T_3 V_18 , T_4 V_19 )
{
unsigned int V_20 = 0 ;
int V_21 ;
if ( V_17 >= V_22 ) {
...
static void T_1 F_21 ( T_4 V_49 , T_4 V_50 , T_4 V_51 ,
T_3 V_52 )
{
int V_53 ;
int V_54 ;
...
static int F_28 ( struct V_69 * V_70 , T_3 V_52 , int V_51 ,
int V_50 )
{
#ifdef F_29
struct V_55 V_56 ;
...
static void T_1 F_34 ( T_4 V_49 , T_5 V_50 , T_5 V_51 , T_3 V_52 )
{
if ( V_51 == 0 )
V_51 = 3 ;
if ( V_50 == 0 )
...
void T_1 F_38 ( unsigned int V_103 , T_5 V_51 )
{
...
int F_41 ( T_3 V_52 , unsigned int * V_108 )
{
...
int F_44 ( unsigned V_114 , T_3 * V_52 )
{
if ( V_114 < F_27 () &&
V_67 [ V_114 ] != V_68 ) {
* V_52 = V_67 [ V_114 ] ;
...
static int F_45 ( struct V_69 * V_70 , T_3 V_52 ,
int V_51 , int V_50 )
{
#ifdef F_46
if ( V_51 == V_112 )
...
static int F_48 ( struct V_69 * V_70 , T_3 V_52 ,
int V_51 , int V_50 )
{
int V_103 = V_52 ;
#ifdef F_49
...
int F_43 ( struct V_69 * V_70 , T_3 V_52 , int V_51 , int V_50 )
{
...
static int F_60 ( T_6 V_124 , int V_21 , int V_125 )
{
#ifdef F_61
int V_126 ;
V_126 = F_62 ( V_124 ) ;
...
int F_65 ( T_6 V_124 , T_7 V_125 , T_3 V_127 ,
int * V_128 )
{
int V_21 ;
...
int F_71 ( T_6 V_124 , V_13 V_131 , T_3 V_132 )
{
int V_133 = - V_134 ;
#ifdef F_72
int V_135 ;
...
void T_1 F_132 ( T_9 V_136 , T_10 V_2 )
{
