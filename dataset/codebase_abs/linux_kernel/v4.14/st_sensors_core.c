...
void F_27 ( struct V_67 * V_15 ,
const struct V_74 * V_75 ,
char * V_76 , int V_77 )
{
const struct V_74 * V_78 ;
V_78 = F_28 ( V_75 , V_15 ) ;
if ( ! V_78 || ! V_78 -> V_7 )
return;
strncpy ( V_76 , V_78 -> V_7 , V_77 ) ;
V_76 [ V_77 - 1 ] = '\0' ;
}
static struct V_59 * F_23 ( struct V_67 * V_15 ,
struct V_59 * V_68 )
...
if ( V_8 < 0 )
return V_8 ;
if ( V_11 -> V_23 -> V_80 . V_35 ) {
V_8 = F_2 ( V_4 ,
V_11 -> V_23 -> V_80 . V_35 ,
V_11 -> V_23 -> V_80 . V_6 , true ) ;
if ( V_8 < 0 )
return V_8 ;
}
if ( V_11 -> V_23 -> V_81 . V_35 ) {
V_8 = F_2 ( V_4 ,
V_11 -> V_23 -> V_81 . V_35 ,
V_11 -> V_23 -> V_81 . V_6 , 1 ) ;
if ( V_8 < 0 )
return V_8 ;
}
if ( V_11 -> V_66 ) {
...
int F_30 ( struct V_3 * V_4 , bool V_46 )
{
int V_8 ;
T_2 V_84 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
if ( ! V_11 -> V_23 -> V_60 . V_35 ) {
if ( V_11 -> V_23 -> V_60 . V_85 )
V_11 -> V_86 = V_46 ;
return 0 ;
}
if ( V_11 -> V_23 -> V_60 . V_87 . V_88 > 0 ) {
V_8 = F_2 ( V_4 ,
V_11 -> V_23 -> V_60 . V_87 . V_88 ,
V_11 -> V_23 -> V_60 . V_87 . V_89 ,
( int ) V_46 ) ;
if ( V_8 < 0 )
goto V_90;
}
if ( V_11 -> V_61 == 1 )
V_84 = V_11 -> V_23 -> V_60 . V_62 ;
else
V_84 = V_11 -> V_23 -> V_60 . V_63 ;
V_11 -> V_86 = V_46 ;
V_8 = F_2 ( V_4 ,
V_11 -> V_23 -> V_60 . V_35 ,
V_84 , ( int ) V_46 ) ;
...
int F_31 ( struct V_3 * V_4 , int V_91 )
{
int V_8 = - V_29 , V_27 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
for ( V_27 = 0 ; V_27 < V_40 ; V_27 ++ ) {
if ( ( V_11 -> V_23 -> V_38 . V_41 [ V_27 ] . V_92 == V_91 ) &&
( V_11 -> V_23 -> V_38 . V_41 [ V_27 ] . V_92 != 0 ) ) {
V_8 = 0 ;
break;
}
}
...
struct V_94 const * V_95 , int * V_7 )
{
int V_8 ;
T_2 * V_96 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
unsigned int V_97 ;
V_97 = F_33 ( V_95 -> V_98 . V_99 +
V_95 -> V_98 . V_100 , 8 ) ;
V_96 = F_34 ( V_97 , V_73 ) ;
if ( ! V_96 )
return - V_101 ;
V_8 = V_11 -> V_12 -> V_102 ( & V_11 -> V_14 , V_11 -> V_15 ,
V_95 -> V_103 , V_97 ,
V_96 , V_11 -> V_104 ) ;
if ( V_8 < 0 )
goto V_105;
...
struct V_94 const * V_95 , int * V_72 )
{
int V_8 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
F_38 ( & V_4 -> V_108 ) ;
...
if ( V_8 < 0 )
goto V_112;
F_39 ( ( V_11 -> V_23 -> V_113 * 1000 ) / V_11 -> V_24 ) ;
V_8 = F_32 ( V_4 , V_95 , V_72 ) ;
if ( V_8 < 0 )
goto V_112;
* V_72 = * V_72 >> V_95 -> V_98 . V_100 ;
V_8 = F_11 ( V_4 , false ) ;
}
V_112:
F_40 ( & V_4 -> V_108 ) ;
...
struct V_59 * V_54 ;
V_54 = (struct V_59 * ) V_11 -> V_15 -> V_114 ;
if ( ( ( V_70 && F_26 ( V_70 , L_18 ) ) ||
( V_54 && V_54 -> V_115 ) ) && V_23 -> V_116 . V_35 ) {
int V_8 ;
...
const struct V_22 * V_23 )
{
int V_27 , V_118 , V_8 = 0 ;
T_2 V_119 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
for ( V_27 = 0 ; V_27 < V_117 ; V_27 ++ ) {
for ( V_118 = 0 ; V_118 < V_120 ; V_118 ++ ) {
if ( strcmp ( V_4 -> V_76 ,
V_23 [ V_27 ] . V_121 [ V_118 ] ) == 0 ) {
break;
}
}
if ( V_118 < V_120 )
...
V_8 = F_41 ( V_4 , & V_23 [ V_27 ] ) ;
if ( V_8 < 0 )
return V_8 ;
if ( V_23 [ V_27 ] . V_123 ) {
V_8 = V_11 -> V_12 -> V_13 ( & V_11 -> V_14 , V_11 -> V_15 ,
V_23 [ V_27 ] . V_123 , & V_119 ) ;
if ( V_8 < 0 ) {
F_10 ( & V_4 -> V_15 ,
L_21 ) ;
return V_8 ;
}
if ( V_23 [ V_27 ] . V_119 != V_119 ) {
F_10 ( & V_4 -> V_15 ,
L_22 ,
V_4 -> V_76 , V_119 ) ;
return - V_29 ;
...
{
int V_27 , V_77 = 0 ;
struct V_3 * V_4 = F_44 ( V_15 ) ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
F_38 ( & V_4 -> V_108 ) ;
for ( V_27 = 0 ; V_27 < V_30 ; V_27 ++ ) {
if ( V_11 -> V_23 -> V_24 . V_31 [ V_27 ] . V_32 == 0 )
break;
V_77 += F_45 ( V_126 + V_77 , V_127 - V_77 , L_23 ,
...
T_3 F_46 ( struct V_67 * V_15 ,
struct V_124 * V_125 , char * V_126 )
{
int V_27 , V_77 = 0 , V_128 , V_129 ;
struct V_3 * V_4 = F_44 ( V_15 ) ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
F_38 ( & V_4 -> V_108 ) ;
for ( V_27 = 0 ; V_27 < V_40 ; V_27 ++ ) {
...
break;
V_128 = V_11 -> V_23 -> V_38 . V_41 [ V_27 ] . V_92 / 1000000 ;
V_129 = V_11 -> V_23 -> V_38 . V_41 [ V_27 ] . V_92 % 1000000 ;
V_77 += F_45 ( V_126 + V_77 , V_127 - V_77 , L_24 , V_128 , V_129 ) ;
}
F_40 ( & V_4 -> V_108 ) ;
V_126 [ V_77 - 1 ] = '\n' ;
return V_77 ;
