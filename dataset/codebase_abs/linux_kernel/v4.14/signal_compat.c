...
& V_26 -> V_3 . V_38 [ 0 ] ) ;
switch ( F_15 ( V_27 -> V_32 , V_27 -> V_34 ) ) {
case V_39 :
if ( V_27 -> V_32 == V_40 &&
( V_27 -> V_34 == V_41 ||
V_27 -> V_34 == V_42 ) )
...
int F_17 ( V_2 T_3 * V_26 , const T_4 * V_27 )
{
return F_10 ( V_26 , V_27 , F_9 () ) ;
}
int F_18 ( T_4 * V_26 , V_2 T_3 * V_27 )
{
int V_29 = 0 ;
T_6 V_68 ;
if ( ! F_11 ( V_69 , V_27 , sizeof( V_2 ) ) )
return - V_31 ;
F_19 {
F_20 ( V_26 -> V_32 , & V_27 -> V_32 ) ;
F_20 ( V_26 -> V_33 , & V_27 -> V_33 ) ;
F_20 ( V_26 -> V_34 , & V_27 -> V_34 ) ;
F_20 ( V_26 -> V_35 , & V_27 -> V_35 ) ;
F_20 ( V_26 -> V_36 , & V_27 -> V_36 ) ;
F_20 ( V_68 , & V_27 -> V_37 ) ;
V_26 -> V_37 = F_21 ( V_68 ) ;
} F_22 ( V_29 ) ;
return V_29 ;
