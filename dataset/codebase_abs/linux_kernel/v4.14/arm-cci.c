...
{
if ( V_202 >= V_211 || V_212 [ V_202 ] . type == V_221 )
return - V_99 ;
...
static int F_157 ( struct V_207 * V_223 )
{
struct V_224 const * V_225 ;
int V_126 , V_69 , V_226 = 0 , V_227 = 0 ;
struct V_207 * V_228 ;
struct V_195 V_196 ;
const char * V_229 ;
bool V_230 ;
V_225 = F_113 ( V_231 , V_223 ) -> V_191 ;
if ( ! V_225 )
return - V_99 ;
V_211 = V_225 -> V_226 + V_225 -> V_227 ;
V_212 = F_158 ( V_211 , sizeof( * V_212 ) , V_193 ) ;
if ( ! V_212 )
return - V_194 ;
F_159 (np, cp) {
if ( ! F_113 ( V_232 , V_228 ) )
continue;
if ( ! F_160 ( V_228 ) )
continue;
V_69 = V_226 + V_227 ;
...
V_230 = strcmp ( V_229 , L_25 ) == 0 ;
if ( ! V_230 && strcmp ( V_229 , L_26 ) ) {
F_147 ( 1 , L_27 ,
V_228 ) ;
continue;
}
V_126 = F_162 ( V_228 , 0 , & V_196 ) ;
if ( ! V_126 ) {
V_212 [ V_69 ] . V_84 = F_163 ( V_196 . V_176 , F_164 ( & V_196 ) ) ;
V_212 [ V_69 ] . V_233 = V_196 . V_176 ;
}
...
if ( V_230 ) {
if ( F_22 ( V_226 >= V_225 -> V_226 ) )
continue;
V_212 [ V_69 ] . type = V_215 ;
++ V_226 ;
} else {
if ( F_22 ( V_227 >= V_225 -> V_227 ) )
continue;
V_212 [ V_69 ] . type = V_213 ;
++ V_227 ;
}
V_212 [ V_69 ] . V_208 = V_228 ;
}
if ( ! V_226 && ! V_227 )
return - V_99 ;
F_144 () ;
...
F_165 ( & V_212 ) ;
F_165 ( & V_201 ) ;
F_166 ( V_212 , sizeof( * V_212 ) * V_211 ) ;
F_131 ( L_29 ) ;
return 0 ;
}
static inline int F_157 ( struct V_207 * V_223 )
{
return 0 ;
}
...
struct V_207 * V_223 ;
struct V_195 V_196 ;
V_223 = F_168 ( NULL , V_231 ) ;
if( ! V_223 || ! F_160 ( V_223 ) )
return - V_99 ;
V_126 = F_162 ( V_223 , 0 , & V_196 ) ;
if ( ! V_126 ) {
V_41 = F_163 ( V_196 . V_176 , F_164 ( & V_196 ) ) ;
V_234 = V_196 . V_176 ;
}
if ( V_126 || ! V_41 ) {
F_147 ( 1 , L_30 ) ;
