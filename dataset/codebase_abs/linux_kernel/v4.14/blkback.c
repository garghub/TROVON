...
goto V_233;
V_217 [ V_218 ++ ] = V_195 ;
F_126 ( V_195 , V_159 . V_86 ) ;
V_195 -> V_196 = V_66 ;
V_195 -> V_234 = F_108 ;
V_195 -> V_235 . V_236 = V_159 . V_83 ;
F_127 ( V_195 , V_75 , V_219 ) ;
}
...
unsigned short V_240 , int V_241 )
{
struct V_242 * V_243 ;
unsigned long V_4 ;
union V_198 * V_199 ;
...
switch ( V_2 -> V_19 -> V_207 ) {
case V_208 :
V_243 = F_132 ( & V_199 -> V_209 ,
V_199 -> V_209 . V_206 ) ;
break;
case V_210 :
V_243 = F_132 ( & V_199 -> V_211 ,
V_199 -> V_211 . V_206 ) ;
break;
case V_212 :
V_243 = F_132 ( & V_199 -> V_213 ,
V_199 -> V_213 . V_206 ) ;
break;
default:
F_117 () ;
