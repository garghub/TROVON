...
static void F_27 ( struct V_32 * V_83 , void T_3 * V_84 )
{
V_83 -> V_85 = V_84 + V_86 ;
V_83 -> V_87 = V_84 + V_88 ;
V_83 -> V_42 =
...
V_83 -> V_37 = V_84 + V_98 ;
V_83 -> V_26 = V_84 + V_99 ;
V_83 -> V_21 = V_84 + V_100 ;
}
static int F_28 ( struct V_101 * V_102 , const struct V_103 * V_104 )
{
const struct V_105 * V_106 [] =
{ & V_107 [ V_104 -> V_108 ] , NULL } ;
struct V_109 * V_77 ;
void T_3 * V_110 ;
int V_111 , V_112 , V_113 , V_114 ;
F_29 ( & V_102 -> V_78 , V_115 ) ;
V_111 = 4 ;
if ( V_106 [ 0 ] -> V_6 & V_116 )
V_111 = 8 ;
V_77 = F_30 ( & V_102 -> V_78 , V_106 , V_111 ) ;
if ( ! V_77 )
return - V_117 ;
V_114 = 5 ;
if ( V_106 [ 0 ] -> V_6 & V_118 )
V_114 = 3 ;
V_113 = F_31 ( V_102 ) ;
if ( V_113 )
return V_113 ;
if ( F_32 ( V_102 , V_114 ) == 0 ) {
F_33 ( V_102 ) ;
return - V_119 ;
}
V_113 = F_34 ( V_102 , 1 << V_114 , V_120 ) ;
if ( V_113 == - V_121 )
F_33 ( V_102 ) ;
if ( V_113 )
return V_113 ;
V_77 -> V_122 = F_35 ( V_102 ) ;
V_110 = V_77 -> V_122 [ V_114 ] ;
for ( V_112 = 0 ; V_112 < V_77 -> V_111 ; V_112 ++ ) {
struct V_29 * V_5 = V_77 -> V_79 [ V_112 ] ;
unsigned int V_123 = V_112 * V_124 ;
F_27 ( & V_5 -> V_20 , V_110 + V_123 ) ;
F_36 ( V_5 , 5 , - 1 , L_3 ) ;
F_36 ( V_5 , 5 , V_123 , L_4 ) ;
}
V_113 = F_37 ( & V_102 -> V_78 , V_125 ) ;
if ( V_113 )
return V_113 ;
V_113 = F_38 ( & V_102 -> V_78 , V_125 ) ;
if ( V_113 )
return V_113 ;
F_5 ( F_3 ( V_110 + V_126 ) & ~ 0x00040000 ,
V_110 + V_126 ) ;
F_5 ( 0xffffffff , V_110 + V_127 ) ;
F_5 ( 0x0 , V_110 + V_128 ) ;
F_39 ( V_102 ) ;
return F_40 ( V_77 , V_102 -> V_129 , V_130 ,
V_131 , & V_132 ) ;
}
