...
if ( V_13 && ( abs ( V_16 -> V_30 - V_13 -> V_30 ) != 1 ||
V_20 != V_14 ) ) {
if ( V_18 == V_17 )
...
V_19 += sprintf ( V_5 + V_19 , L_12 , V_14 ,
V_17 , V_18 ) ;
}
return V_19 ;
}
...
V_19 += snprintf ( V_5 + V_19 , V_32 - V_19 , L_13 ,
V_7 -> V_33 [ V_21 ] -> V_34 ) ;
return V_19 ;
}
...
{
int V_21 ;
for ( V_21 = 0 ; V_21 < F_8 ( V_35 ) ; V_21 ++ )
if ( F_9 ( V_2 , & V_35 [ V_21 ] ) ) {
F_10 ( V_2 , L_14 ) ;
while ( V_21 > 0 )
F_11 ( V_2 , & V_35 [ -- V_21 ] ) ;
return;
