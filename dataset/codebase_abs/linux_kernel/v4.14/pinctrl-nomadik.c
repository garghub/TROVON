...
return F_76 ( V_46 ) ;
V_2 -> V_7 = V_46 ;
V_80 = F_77 ( & V_138 -> V_67 , NULL ) ;
if ( F_75 ( V_80 ) )
return ( void * ) V_80 ;
F_78 ( V_80 ) ;
V_2 -> V_80 = V_80 ;
F_79 ( V_2 -> V_118 >= F_80 ( V_78 ) ) ;
V_78 [ V_141 ] = V_2 ;
return V_2 ;
}
static int F_81 ( struct V_136 * V_67 )
{
...
V_149 -> V_173 = F_44 ;
V_149 -> V_101 = V_174 ;
V_149 -> V_142 = F_86 ( V_144 , L_37 ,
V_67 -> V_141 ,
V_45 -> V_46 ,
V_45 -> V_46 + V_45 -> V_133 - 1 ) ;
F_23 ( V_2 -> V_80 ) ;
V_2 -> V_27 = F_87 ( V_2 -> V_7 + V_29 ) ;
F_25 ( V_2 -> V_80 ) ;
V_45 -> V_148 = V_135 ;
V_152 = F_88 ( V_45 , V_2 ) ;
if ( V_152 )
...
V_2 -> V_154 ,
F_53 ) ;
F_93 ( & V_67 -> V_67 , L_39 , V_2 -> V_7 ) ;
return 0 ;
}
static int F_94 ( struct V_81 * V_82 )
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
return V_58 -> V_68 -> V_177 ;
}
static const char * F_95 ( struct V_81 * V_82 ,
unsigned V_178 )
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
return V_58 -> V_68 -> V_179 [ V_178 ] . V_142 ;
}
static int F_96 ( struct V_81 * V_82 , unsigned V_178 ,
...
static struct V_1 * F_97 ( unsigned V_71 )
{
int V_60 ;
struct V_1 * V_183 ;
...
static struct V_84 * F_98 ( unsigned V_71 )
{
struct V_1 * V_183 = F_97 ( V_71 ) ;
if ( V_183 )
return & V_183 -> V_45 ;
return NULL ;
}
static void F_99 ( struct V_81 * V_82 , struct V_122 * V_123 ,
unsigned V_3 )
{
struct V_84 * V_45 = F_98 ( V_3 ) ;
if ( ! V_45 ) {
F_62 ( V_123 , L_40 ) ;
return;
}
...
static int F_100 ( struct V_185 * * V_186 , unsigned * V_187 ,
...
static int F_101 ( struct V_185 * * V_186 ,
unsigned * V_187 ,
unsigned * V_188 , const char * V_189 ,
...
if ( * V_188 == * V_187 )
return - V_191 ;
V_197 = F_102 ( V_195 , V_196 * sizeof( * V_197 ) ,
V_144 ) ;
if ( ! V_197 )
return - V_145 ;
...
static int F_103 ( int V_200 , int V_31 , unsigned long * V_201 )
{
int V_152 = 0 ;
...
static const char * F_104 ( struct V_81 * V_82 , const char * V_205 )
{
int V_60 , V_206 ;
struct V_57 * V_58 = F_27 ( V_82 ) ;
...
static bool F_105 ( struct V_134 * V_135 ,
unsigned long * V_195 )
{
bool V_208 = 0 ;
unsigned long V_209 = 0 ;
int V_60 , V_31 , V_152 ;
for ( V_60 = 0 ; V_60 < F_80 ( V_202 ) ; V_60 ++ ) {
V_152 = F_70 ( V_135 ,
V_202 [ V_60 ] . V_210 , & V_31 ) ;
if ( V_152 != - V_102 ) {
if ( F_103 ( V_60 , V_31 , & V_209 ) == 0 ) {
* V_195 |= V_209 ;
V_208 = 1 ;
}
}
...
static int F_106 ( struct V_81 * V_82 ,
struct V_134 * V_135 ,
struct V_185 * * V_186 ,
unsigned * V_187 ,
unsigned * V_188 )
...
struct V_210 * V_211 ;
struct V_134 * V_212 ;
V_152 = F_107 ( V_135 , L_42 , & V_190 ) ;
if ( V_152 >= 0 ) {
const char * V_189 ;
V_152 = F_108 ( V_135 , L_43 ) ;
if ( V_152 < 0 )
goto exit;
V_152 = F_109 ( V_82 , V_186 ,
V_187 ,
V_188 , V_152 ) ;
if ( V_152 < 0 )
goto exit;
F_110 (np, L_43 , prop, group) {
V_152 = F_100 ( V_186 , V_187 , V_188 ,
V_189 , V_190 ) ;
if ( V_152 < 0 )
goto exit;
}
}
V_208 = F_105 ( V_135 , & V_195 ) ;
V_212 = F_111 ( V_135 , L_44 , 0 ) ;
if ( V_212 )
V_208 |= F_105 ( V_212 , & V_195 ) ;
if ( V_208 ) {
const char * V_213 ;
const char * V_71 ;
V_152 = F_108 ( V_135 , L_45 ) ;
if ( V_152 < 0 )
goto exit;
V_152 = F_109 ( V_82 , V_186 ,
V_187 ,
...
if ( V_152 < 0 )
goto exit;
F_110 (np, L_45 , prop, pin) {
V_213 = F_104 ( V_82 , V_71 ) ;
V_152 = F_101 ( V_186 , V_187 ,
V_188 ,
V_213 , & V_195 , 1 ) ;
if ( V_152 < 0 )
goto exit;
...
* V_188 = 0 ;
F_113 (np_config, np) {
V_152 = F_106 ( V_82 , V_135 , V_186 ,
& V_187 , V_188 ) ;
if ( V_152 < 0 ) {
F_114 ( V_82 , * V_186 , * V_188 ) ;
return V_152 ;
}
}
return 0 ;
...
static const char * F_116 ( struct V_81 * V_82 ,
unsigned V_190 )
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
return V_58 -> V_68 -> V_215 [ V_190 ] . V_142 ;
}
static int F_117 ( struct V_81 * V_82 ,
unsigned V_190 ,
...
static int F_118 ( struct V_81 * V_82 , unsigned V_190 ,
unsigned V_189 )
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
...
static void F_120 ( struct V_81 * V_82 ,
struct V_222 * V_223 ,
unsigned V_3 )
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
...
static int F_122 ( struct V_81 * V_82 , unsigned V_71 ,
unsigned long * V_195 , unsigned V_196 )
{
...
V_230 = F_129 ( V_209 ) ;
if ( V_230 ) {
int V_231 = F_130 ( V_209 ) ;
int V_232 = F_131 ( V_209 ) ;
int V_233 = F_132 ( V_209 ) ;
V_229 = true ;
if ( V_231 )
V_18 = V_231 - 1 ;
if ( V_232 )
...
static int F_133 ( struct V_234 * V_67 )
{
struct V_57 * V_58 ;
V_58 = F_134 ( V_67 ) ;
if ( ! V_58 )
return - V_102 ;
return F_135 ( V_58 -> V_235 ) ;
}
static int F_136 ( struct V_234 * V_67 )
{
struct V_57 * V_58 ;
V_58 = F_134 ( V_67 ) ;
if ( ! V_58 )
return - V_102 ;
return F_137 ( V_58 -> V_235 ) ;
}
static int F_138 ( struct V_136 * V_137 )
{
...
V_238 = F_111 ( V_135 , L_74 , 0 ) ;
if ( V_238 )
V_58 -> V_65 = F_144 ( V_238 , 0 ) ;
if ( ! V_58 -> V_65 ) {
if ( V_239 == V_241 ) {
F_93 ( & V_137 -> V_67 ,
L_75
...
V_58 -> V_235 = F_145 ( & V_137 -> V_67 , & V_245 , V_58 ) ;
if ( F_75 ( V_58 -> V_235 ) ) {
F_20 ( & V_137 -> V_67 , L_78 ) ;
return F_82 ( V_58 -> V_235 ) ;
}
F_89 ( V_137 , V_58 ) ;
F_93 ( & V_137 -> V_67 , L_79 ) ;
return 0 ;
}
