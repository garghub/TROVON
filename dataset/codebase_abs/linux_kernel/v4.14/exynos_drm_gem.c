...
int F_44 ( struct V_65 * V_66 )
{
struct V_49 * V_50 = V_66 -> V_50 ;
struct V_34 * V_35 = V_50 -> V_67 ;
struct V_1 * V_2 = F_22 ( V_35 ) ;
unsigned long V_68 ;
T_1 V_69 ;
int V_10 ;
V_69 = ( V_66 -> V_70 - V_50 -> V_57 ) >> V_23 ;
if ( V_69 >= ( V_2 -> V_22 >> V_23 ) ) {
F_4 ( L_17 ) ;
V_10 = - V_31 ;
goto V_71;
}
V_68 = F_45 ( V_2 -> V_24 [ V_69 ] ) ;
V_10 = F_46 ( V_50 , V_66 -> V_70 , F_47 ( V_68 , V_72 ) ) ;
V_71:
switch ( V_10 ) {
case 0 :
case - V_73 :
...
int F_53 ( struct V_80 * V_42 , struct V_49 * V_50 )
{
struct V_34 * V_35 ;
int V_10 ;
V_10 = F_54 ( V_42 , V_50 ) ;
...
V_35 = V_50 -> V_67 ;
if ( V_35 -> V_40 )
return F_55 ( V_35 -> V_81 , V_50 , 0 ) ;
return F_48 ( V_35 , V_50 ) ;
}
struct V_8 * F_56 ( struct V_34 * V_35 )
{
struct V_1 * V_2 = F_22 ( V_35 ) ;
int V_82 ;
V_82 = V_2 -> V_22 >> V_23 ;
return F_57 ( V_2 -> V_24 , V_82 ) ;
}
struct V_34 *
F_58 ( struct V_3 * V_4 ,
struct V_83 * V_84 ,
...
V_2 -> V_12 = F_59 ( V_9 -> V_86 ) ;
V_82 = V_2 -> V_22 >> V_23 ;
V_2 -> V_24 = F_3 ( V_82 , sizeof( struct V_25 * ) , V_26 ) ;
if ( ! V_2 -> V_24 ) {
V_10 = - V_11 ;
goto V_87;
}
...
void F_61 ( struct V_34 * V_35 , void * V_90 )
{
}
