...
struct V_167 * V_12 ;
V_12 = V_4 -> V_9 -> V_11 -> V_12 ;
V_186 -> V_187 = V_4 -> V_9 -> V_188 ;
V_186 -> V_189 = V_4 -> V_9 -> V_188 ;
if ( ( ! V_12 -> V_190 ) ||
( ! V_12 -> V_191 ) )
return - V_45 ;
V_12 -> V_190 ( V_4 -> V_9 ,
...
int V_205 , V_206 ;
V_12 = V_4 -> V_9 -> V_11 -> V_12 ;
if ( V_186 -> V_192 != V_186 -> V_193 )
return - V_48 ;
if ( ( ! V_12 -> V_207 ) ||
( ! V_12 -> V_208 ) )
return - V_45 ;
if ( V_186 -> V_187 != V_4 -> V_9 -> V_188 )
V_4 -> V_9 -> V_188 = V_186 -> V_187 ;
V_205 = V_12 -> V_207 ( V_4 -> V_9 ,
V_186 -> V_193 ) ;
V_206 = V_12 -> V_208 ( V_4 -> V_9 ,
V_186 -> V_194 ,
V_186 -> V_195 ) ;
if ( V_205 || V_206 )
return - V_48 ;
...
void F_64 ( struct V_1 * V_2 , struct V_209 * V_210 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
V_210 -> V_211 = V_4 -> V_9 -> V_142 ;
V_210 -> V_212 = V_4 -> V_9 -> V_142 ;
V_210 -> V_213 = V_4 -> V_9 -> V_142 ;
V_210 -> V_214 = V_4 -> V_9 -> V_142 ;
}
void F_65 ( struct V_1 * V_130 ,
struct V_215 * V_123 , T_5 * V_117 )
{
T_5 * V_216 = V_117 ;
...
struct V_217 V_219 ;
if ( ! V_8 -> V_11 -> V_12 -> V_220 || ! V_8 -> V_11 -> V_12 -> V_221 ) {
F_10 ( V_130 , L_9 ) ;
return;
}
V_8 -> V_11 -> V_12 -> V_221 ( V_8 , & V_130 -> V_123 ) ;
V_218 = F_66 ( V_130 , & V_219 ) ;
V_216 [ 0 ] = V_218 -> V_124 ;
V_216 [ 1 ] = V_218 -> V_222 ;
V_216 [ 2 ] = V_218 -> V_125 ;
V_216 [ 3 ] = V_218 -> V_223 ;
...
V_216 [ 8 ] = V_218 -> V_228 ;
V_216 [ 9 ] = V_218 -> V_229 ;
V_216 [ 10 ] = V_218 -> V_230 ;
V_216 [ 11 ] = V_218 -> V_231 ;
V_216 [ 12 ] = V_218 -> V_126 ;
V_216 [ 13 ] = V_218 -> V_232 ;
V_216 [ 14 ] = V_218 -> V_233 ;
V_216 [ 15 ] = V_218 -> V_234 ;
V_216 [ 16 ] = V_218 -> V_235 ;
V_216 [ 17 ] = V_218 -> V_236 ;
V_216 [ 18 ] = V_218 -> V_237 ;
V_216 [ 19 ] = V_218 -> V_238 ;
V_216 [ 20 ] = V_218 -> V_239 ;
V_216 [ 21 ] = V_218 -> V_240 ;
V_216 [ 22 ] = V_218 -> V_241 ;
V_216 [ 23 ] = V_130 -> V_226 . V_242 ;
V_216 [ 24 ] = V_130 -> V_227 . V_242 ;
V_216 [ 25 ] = V_4 -> V_243 ;
V_8 -> V_11 -> V_12 -> V_220 ( V_8 , & V_216 [ 26 ] ) ;
}
void F_67 ( struct V_1 * V_130 , T_1 V_244 , T_2 * V_117 )
{
struct V_3 * V_4 = F_2 ( V_130 ) ;
struct V_7 * V_8 = V_4 -> V_9 ;
char * V_115 = ( char * ) V_117 ;
if ( ! V_8 -> V_11 -> V_12 -> V_245 ) {
F_10 ( V_130 , L_10 ) ;
return;
}
if ( V_244 == V_246 ) {
...
V_247 ) ;
V_115 += V_247 ;
if ( ( V_130 -> V_10 ) && ( ! V_130 -> V_10 -> V_248 ) )
memcpy ( V_115 , V_141 [ V_92 ] ,
V_247 ) ;
} else {
snprintf ( V_115 , V_247 , L_11 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_12 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_13 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_14 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_15 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_16 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_17 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_18 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_19 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_20 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_21 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_22 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_23 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_24 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_25 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_26 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_27 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_28 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_29 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_30 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_31 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_32 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_33 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_34 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_35 ) ;
V_115 = V_115 + V_247 ;
snprintf ( V_115 , V_247 , L_36 ) ;
V_115 = V_115 + V_247 ;
V_8 -> V_11 -> V_12 -> V_245 ( V_8 , V_244 , ( T_2 * ) V_115 ) ;
}
}
int F_68 ( struct V_1 * V_130 , int V_244 )
{
struct V_3 * V_4 = F_2 ( V_130 ) ;
struct V_7 * V_8 = V_4 -> V_9 ;
...
return ( V_252 + V_12 -> V_249 ( V_8 , V_244 ) ) ;
}
}
int F_69 ( struct V_1 * V_130 , int V_253 )
{
int V_18 ;
struct V_20 * V_21 = V_130 -> V_10 ;
V_18 = F_5 ( V_21 , V_28 , V_254 ) ;
V_18 |= F_5 ( V_21 , V_255 , V_253 ) ;
...
int F_70 ( struct V_1 * V_130 , enum V_256 V_151 )
{
struct V_3 * V_4 = F_2 ( V_130 ) ;
struct V_7 * V_8 = V_4 -> V_9 ;
struct V_20 * V_21 = V_130 -> V_10 ;
...
return 2 ;
case V_259 :
V_40 = F_69 ( V_130 , V_260 ) ;
if ( V_40 )
return V_40 ;
break;
case V_261 :
V_40 = F_69 ( V_130 , V_262 ) ;
if ( V_40 )
return V_40 ;
break;
case V_263 :
...
switch ( V_151 ) {
case V_257 :
return V_8 -> V_11 -> V_12 -> V_264 ( V_8 , V_265 ) ;
case V_259 :
return V_8 -> V_11 -> V_12 -> V_264 ( V_8 , V_266 ) ;
case V_261 :
return V_8 -> V_11 -> V_12 -> V_264 ( V_8 , V_267 ) ;
case V_263 :
return V_8 -> V_11 -> V_12 -> V_264 ( V_8 , V_268 ) ;
default:
return - V_48 ;
}
return 0 ;
}
void F_71 ( struct V_1 * V_2 , struct V_269 * V_15 ,
void * V_117 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_167 * V_12 ;
...
V_272 = V_12 -> V_273 ( V_4 -> V_9 ) ;
if ( V_272 > 0 )
return V_272 * sizeof( T_1 ) ;
else
return V_272 ;
}
...
{
int V_40 = 0 ;
struct V_20 * V_274 = V_130 -> V_10 ;
if ( F_16 ( V_130 ) ) {
if ( V_274 && V_274 -> V_50 == V_77 )
V_40 = F_74 ( V_274 ) ;
}
return V_40 ;
}
...
V_12 = V_4 -> V_9 -> V_11 -> V_12 ;
return V_12 -> V_276 ( V_4 -> V_9 ) ;
}
static int
F_77 ( struct V_1 * V_130 , T_1 * V_277 , T_2 * V_278 , T_2 * V_279 )
{
struct V_3 * V_4 = F_2 ( V_130 ) ;
struct V_167 * V_12 ;
if ( F_13 ( V_4 -> V_69 ) ) {
...
if ( ! V_277 )
return 0 ;
return V_12 -> V_280 ( V_4 -> V_9 , V_277 , V_278 , V_279 ) ;
}
static int
F_78 ( struct V_1 * V_130 , const T_1 * V_277 , const T_2 * V_278 ,
const T_2 V_279 )
{
struct V_3 * V_4 = F_2 ( V_130 ) ;
struct V_167 * V_12 ;
...
V_12 = V_4 -> V_9 -> V_11 -> V_12 ;
if ( V_279 != V_281 && V_279 != V_282 ) {
F_10 ( V_130 , L_42 ) ;
return - V_250 ;
}
return V_12 -> V_283 ( V_4 -> V_9 , V_277 , V_278 , V_279 ) ;
}
