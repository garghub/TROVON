...
F_5 ( L_16 ,
log , ( unsigned long long ) log -> V_164 , log -> V_92 ) ;
} else {
...
if ( ! memcmp ( V_170 -> V_134 [ V_36 ] . V_146 , V_196 , 16 ) ) {
...
memcpy ( V_170 -> V_134 [ V_36 ] . V_146 , V_196 , 16 ) ;
break;
}
if ( V_36 == V_195 ) {
F_47 ( L_33 ) ;
...
char * V_202 ;
T_2 V_65 ;
struct V_70 * V_70 = F_91 ( V_150 | V_203 ) ;
if ( ! V_70 )
goto error;
V_202 = F_92 ( V_70 ) ;
for ( V_65 = 0 ; V_65 < V_204 ; V_65 += V_61 ) {
V_25 = F_93 ( sizeof( struct V_25 ) , V_150 ) ;
if ( V_25 == NULL ) {
if ( V_65 == 0 )
F_94 ( V_70 ) ;
goto error;
...
unsigned long V_19 ;
F_96 ( V_19 ) ;
F_97 ( log -> V_199 , ( V_26 = log -> V_200 ) , V_19 ) ;
log -> V_200 = V_26 -> V_208 ;
F_98 ( V_19 ) ;
V_26 -> V_116 = 0 ;
V_26 -> V_86 = NULL ;
V_26 -> V_208 = NULL ;
...
V_26 -> V_208 = log -> V_200 ;
log -> V_200 = V_26 ;
F_100 ( & log -> V_199 ) ;
return;
}
static inline void F_101 ( struct V_25 * V_26 )
{
unsigned long V_19 ;
F_38 ( & V_210 , V_19 ) ;
V_26 -> V_211 = V_212 ;
...
V_26 -> V_116 |= V_216 ;
V_215 = F_103 ( V_217 , 1 ) ;
V_215 -> V_218 . V_219 = V_26 -> V_209 << ( log -> V_167 - 9 ) ;
F_104 ( V_215 , log -> V_139 ) ;
F_105 ( V_215 , V_26 -> V_206 , V_61 , V_26 -> V_205 ) ;
F_106 ( V_215 -> V_218 . V_220 != V_61 ) ;
V_215 -> V_221 = V_222 ;
V_215 -> V_223 = V_26 ;
V_215 -> V_224 = V_225 ;
if ( log -> V_169 ) {
...
F_108 ( V_26 -> V_207 , ( V_26 -> V_116 != V_216 ) ) ;
return 0 ;
}
...
log -> V_184 = V_26 ;
V_26 -> V_86 = V_227 -> V_86 ;
V_227 -> V_86 = V_26 ;
}
V_227 = V_26 ;
}
if ( ( V_26 != V_227 -> V_86 ) || ! ( V_45 & V_89 ) ) {
F_98 ( V_19 ) ;
return;
}
F_98 ( V_19 ) ;
...
unsigned long V_19 ;
int V_93 = 0 ;
F_5 ( L_40 , V_26 , V_26 -> V_116 , V_45 ) ;
F_96 ( V_19 ) ;
F_97 ( V_26 -> V_207 , ( V_26 -> V_116 & V_232 ) , V_19 ) ;
...
static void V_222 ( struct V_215 * V_215 )
{
struct V_25 * V_26 = V_215 -> V_223 ;
struct V_25 * V_80 , * V_227 ;
struct V_1 * log ;
unsigned long V_19 ;
F_5 ( L_42 , V_26 , V_26 -> V_116 ) ;
F_96 ( V_19 ) ;
V_26 -> V_116 |= V_232 ;
if ( V_215 -> V_233 ) {
V_26 -> V_116 |= V_117 ;
...
int F_118 ( struct V_1 * log , T_3 V_237 , int V_238 )
{
int V_93 = - V_96 ;
struct V_3 * V_4 ;
struct V_170 * V_170 ;
...
struct V_25 * V_26 ;
F_5 ( L_45 ,
( long long ) V_237 , V_238 ) ;
V_4 = F_29 ( log -> V_152 . V_66 , struct V_3 , V_161 ) ;
V_26 = F_32 ( log , 1 ) ;
V_240 = V_238 >> V_4 -> V_241 ;
V_170 = (struct V_170 * ) V_26 -> V_42 ;
V_170 -> V_174 = F_33 ( V_175 ) ;
V_170 -> V_242 = F_33 ( V_243 ) ;
V_170 -> V_177 = F_33 ( V_178 ) ;
V_170 -> V_45 = F_33 ( V_4 -> V_141 ) ;
V_170 -> V_92 = F_33 ( V_240 ) ;
V_170 -> V_244 = F_33 ( V_4 -> V_244 ) ;
V_170 -> V_167 = F_33 ( V_4 -> V_167 ) ;
V_170 -> V_179 = F_33 ( 2 * V_61 + V_63 + V_67 ) ;
V_26 -> V_116 = V_89 | V_180 | V_228 ;
V_26 -> V_209 = V_237 + V_4 -> V_245 ;
F_109 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
V_28 = (struct V_27 * ) V_26 -> V_42 ;
V_28 -> V_81 . V_70 = V_28 -> V_88 . V_70 = F_33 ( V_240 - 3 ) ;
V_28 -> V_81 . V_43 = V_28 -> V_88 . V_43 = F_21 ( V_63 + V_67 ) ;
V_239 = (struct V_11 * ) & V_28 -> V_47 ;
V_239 -> V_130 = 0 ;
V_239 -> V_131 = 0 ;
V_239 -> type = F_21 ( V_132 ) ;
V_239 -> V_60 = 0 ;
V_239 -> log . V_129 . V_128 = 0 ;
V_26 -> V_209 += V_4 -> V_245 ;
V_26 -> V_116 = V_89 | V_180 | V_228 ;
F_109 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
for ( V_79 = 0 ; V_79 < V_240 - 3 ; V_79 ++ ) {
...
static int F_119 ( struct V_246 * V_247 , void * V_248 )
{
F_120 ( V_247 ,
L_46
L_47
...
static int F_121 ( struct V_249 * V_249 , struct V_250 * V_250 )
{
return F_122 ( V_250 , F_119 , NULL ) ;
}
