...
static const unsigned short V_39 [] = {
...
F_6 ( V_29 , L_6 ) ;
V_30 -> V_41 = ( ( V_33 & 0x0100 ) != 0 ) ;
V_30 -> V_42 = ( ( V_34 & 0x0001 ) != 0 ) ;
V_30 -> V_43 = V_37 & 0x00FF ;
V_30 -> V_44 = ( V_37 & 0xFF00 ) >> 8 ;
if ( ( V_36 & 0x00FF ) < F_8 ( V_38 ) ) {
V_30 -> V_45 = V_38 [ V_36 & 0x00FF ] ;
} else {
V_30 -> V_45 = 0 ;
}
F_9 ( V_29 ,
...
F_6 ( V_29 , L_6 ) ;
V_30 -> V_46 = ( ( V_34 & 0x0001 ) != 0 ) ;
V_30 -> V_47 = V_37 & 0x000F ;
if ( ( ( V_37 & 0xFF00 ) >> 8 ) < F_8 ( V_39 ) ) {
V_30 -> V_48 = V_39 [ ( V_37 & 0xFF00 ) >> 8 ] ;
} else {
V_30 -> V_48 = 0 ;
}
F_10 ( V_29 ,
...
static const unsigned short V_39 [] = {
0x03F8 , 0x02F8 , 0x03E8 , 0x02E8 } ;
static const unsigned short V_50 [] = {
5 , 7 , 10 , 11 , 15 } ;
static const unsigned short V_51 [] = {
3 , 4 } ;
unsigned short V_52 = 0 , V_53 = 0 ;
F_2 ( V_29 ,
L_15 ,
V_54 , V_55 , V_56 , V_57 ) ;
if ( V_55 ) {
for ( V_49 = 0 ; V_49 < F_8 ( V_38 ) ; V_49 ++ ) {
if ( V_55 == V_38 [ V_49 ] )
break;
}
if ( V_49 == F_8 ( V_38 ) ) {
...
if ( V_31 ) goto V_58;
if ( V_57 ) {
V_37 = ( V_37 & 0x00ff ) | ( V_53 << 8 ) ;
}
if ( V_56 ) {
V_37 = ( V_37 & 0xff00 ) | V_56 ;
}
