...
struct V_83 * V_84 = F_27 ( V_14 -> V_61 , V_14 -> V_85 ,
V_14 -> V_86 , V_46 , V_59 , 0 ) ;
V_82 = F_22 ( V_44 , V_53 , V_59 , V_46 ) ;
if ( V_82 == 0 )
continue;
F_3 ( 0 , L_15 , V_46 , V_59 ,
V_53 ? L_16 : L_6 , F_28 ( V_82 ) ) ;
V_84 -> V_82 = V_82 ;
V_84 -> V_87 = V_82 << V_56 ;
V_84 -> V_88 = V_89 ;
V_84 -> V_90 = V_91 ;
...
static int F_32 ( struct V_1 * V_2 , const struct V_95 * V_96 )
{
int V_58 ;
F_3 ( 0 , L_13 ) ;
if ( F_33 ( V_2 ) < 0 )
return - V_97 ;
V_58 = F_23 ( V_2 , V_96 -> V_98 ) ;
if ( ! V_99 )
V_99 = F_34 ( V_2 ) ;
return V_58 ;
}
