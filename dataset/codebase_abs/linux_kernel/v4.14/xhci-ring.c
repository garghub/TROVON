...
return;
V_80 -> V_83 |= V_86 ;
F_161 ( V_29 , V_179 , V_75 , V_76 , V_269 ) ;
if ( V_269 == V_270 )
F_162 ( V_29 , V_76 , V_77 , V_19 ) ;
F_23 ( V_29 ) ;
}
...
int F_164 ( struct V_28 * V_29 , unsigned int V_271 )
{
...
static int F_167 ( struct V_28 * V_29 , struct V_18 * V_19 ,
...
V_76 = F_168 ( F_9 ( V_145 -> V_67 ) ) - 1 ;
V_107 = F_169 ( V_80 , F_53 ( V_145 -> V_283 ) ) ;
...
return F_165 ( V_29 , V_19 , V_107 , V_57 ) ;
}
static int F_170 ( struct V_28 * V_29 , struct V_13 * V_14 ,
union V_3 * V_289 )
{
T_2 V_290 ;
...
if ( ! F_2 ( V_4 ) && ! F_4 ( V_4 ) )
V_290 += F_171 ( F_9 ( V_4 -> V_9 . V_10 [ 2 ] ) ) ;
}
return V_290 ;
}
...
V_19 -> V_21 -> V_276 = V_292 ;
F_167:
return F_167 ( V_29 , V_19 , V_267 , V_145 , V_80 , V_57 ) ;
}
...
V_292 = V_301 -> V_306 ;
V_291 = F_173 ( F_9 ( V_145 -> V_284 ) ) ;
V_303 = F_171 ( F_9 ( V_267 -> V_9 . V_10 [ 2 ] ) ) ;
...
if ( V_302 )
V_301 -> V_276 = F_170 ( V_29 , V_107 , V_267 ) +
V_303 - V_291 ;
else
V_301 -> V_276 = V_292 ;
...
static int F_176 ( struct V_28 * V_29 , struct V_18 * V_19 ,
union V_3 * V_267 , struct V_281 * V_145 ,
struct V_79 * V_80 , int * V_57 )
{
struct V_13 * V_107 ;
...
F_175 ( V_29 , V_19 , V_145 , V_80 , & V_57 ) ;
goto V_166;
}
if ( V_271 == V_295 )
V_107 -> V_338 = true ;
...
if ( F_181 ( & V_19 -> V_21 -> V_80 -> V_280 ) )
F_172 ( V_29 , V_19 , V_267 , V_145 , V_80 , & V_57 ) ;
else if ( F_166 ( & V_19 -> V_21 -> V_80 -> V_280 ) )
F_174 ( V_29 , V_19 , V_267 , V_145 , V_80 , & V_57 ) ;
else
F_176 ( V_29 , V_19 , V_267 , V_145 , V_80 ,
& V_57 ) ;
V_166:
V_322 = V_80 -> V_330 &&
V_271 != V_335 &&
...
T_7 F_187 ( struct V_124 * V_125 )
{
struct V_28 * V_29 = F_188 ( V_125 ) ;
union V_3 * V_349 ;
T_7 V_69 = V_350 ;
unsigned long V_67 ;
T_1 V_102 ;
...
T_7 F_189 ( int V_363 , void * V_125 )
{
return F_187 ( V_125 ) ;
}
static void F_190 ( struct V_28 * V_29 , struct V_13 * V_14 ,
bool V_35 ,
...
static int F_192 ( struct V_28 * V_29 , struct V_13 * V_107 ,
...
V_69 = F_192 ( V_29 , V_107 , F_100 ( V_96 ) ,
V_42 , V_368 ) ;
if ( V_69 )
return V_69 ;
V_20 = V_21 -> V_22 ;
...
F_195 ( & V_19 -> V_149 ) ;
if ( V_376 == 0 ) {
V_69 = F_196 ( F_61 ( V_21 -> V_106 -> V_126 ) , V_21 ) ;
if ( F_76 ( V_69 ) )
return V_69 ;
}
V_19 -> V_21 = V_21 ;
F_197 ( & V_19 -> V_88 , & V_107 -> V_88 ) ;
V_19 -> V_120 = V_107 -> V_41 ;
V_19 -> V_121 = V_107 -> V_37 ;
return 0 ;
}
static unsigned int F_198 ( T_3 V_110 , T_3 V_377 )
{
unsigned int V_42 ;
V_42 = F_199 ( V_377 + ( V_110 & ( V_378 - 1 ) ) ,
V_378 ) ;
if ( V_42 == 0 )
V_42 ++ ;
return V_42 ;
}
static inline unsigned int F_200 ( struct V_21 * V_21 )
{
return F_198 ( V_21 -> V_379 , V_21 -> V_277 ) ;
}
static unsigned int F_201 ( struct V_21 * V_21 )
{
struct V_380 * V_138 ;
unsigned int V_154 , V_377 , V_381 , V_42 = 0 ;
V_381 = V_21 -> V_277 ;
F_202 (urb->sg, sg, urb->num_mapped_sgs, i) {
V_377 = F_203 ( V_138 ) ;
V_42 += F_198 ( F_204 ( V_138 ) , V_377 ) ;
V_377 = F_205 (unsigned int, len, full_len) ;
V_381 -= V_377 ;
if ( V_381 == 0 )
break;
}
...
static unsigned int F_206 ( struct V_21 * V_21 , int V_154 )
{
T_3 V_110 , V_377 ;
V_110 = ( T_3 ) ( V_21 -> V_379 + V_21 -> V_305 [ V_154 ] . V_382 ) ;
V_377 = V_21 -> V_305 [ V_154 ] . V_306 ;
return F_198 ( V_110 , V_377 ) ;
}
static void F_207 ( struct V_21 * V_21 , int V_383 )
{
if ( F_76 ( V_383 != V_21 -> V_277 ) )
F_208 ( & V_21 -> V_106 -> V_106 , L_135
L_136 ,
V_257 ,
...
static void F_209 ( struct V_28 * V_29 , int V_75 ,
...
static void F_210 ( struct V_28 * V_29 , struct V_21 * V_21 ,
struct V_95 * V_96 )
{
int V_385 ;
int V_386 ;
V_385 = F_211 ( F_9 ( V_96 -> V_387 ) ) ;
V_386 = V_21 -> V_388 ;
if ( V_21 -> V_106 -> V_223 == V_389 ||
V_21 -> V_106 -> V_223 == V_390 )
V_386 *= 8 ;
if ( V_385 != V_386 ) {
F_212 ( & V_21 -> V_106 -> V_106 ,
L_137 ,
V_386 , V_386 == 1 ? L_138 : L_139 ,
V_385 , V_385 == 1 ? L_138 : L_139 ) ;
V_21 -> V_388 = V_385 ;
if ( V_21 -> V_106 -> V_223 == V_389 ||
V_21 -> V_106 -> V_223 == V_390 )
V_21 -> V_388 /= 8 ;
...
F_210 ( V_29 , V_21 , V_96 ) ;
return F_214 ( V_29 , V_368 , V_21 , V_75 , V_76 ) ;
}
static T_2 F_215 ( struct V_28 * V_29 , int V_391 ,
...
if ( V_29 -> V_39 & V_397 )
V_392 = 0 ;
V_394 = F_216 ( & V_21 -> V_80 -> V_280 ) ;
V_395 = F_199 ( V_393 , V_394 ) ;
return ( V_395 - ( ( V_391 + V_392 ) / V_394 ) ) ;
}
static int F_217 ( struct V_28 * V_29 , struct V_21 * V_21 , T_2 V_398 ,
...
if ( F_72 ( V_21 ) ) {
F_218 ( V_21 -> V_138 , V_21 -> V_139 ,
V_2 -> V_140 , V_401 , V_398 ) ;
V_2 -> V_135 = F_219 ( V_106 , V_2 -> V_140 ,
V_400 , V_137 ) ;
} else {
V_2 -> V_135 = F_219 ( V_106 , V_2 -> V_140 ,
V_400 , V_143 ) ;
}
if ( F_220 ( V_106 , V_2 -> V_135 ) ) {
F_51 ( V_29 , L_142 ) ;
return 0 ;
}
* V_392 = V_401 ;
V_2 -> V_141 = V_401 ;
V_2 -> V_142 = V_398 ;
F_24 ( V_29 , L_143 , * V_392 ) ;
return 1 ;
}
int F_214 ( struct V_28 * V_29 , T_8 V_368 ,
struct V_21 * V_21 , int V_75 , unsigned int V_76 )
{
struct V_13 * V_14 ;
struct V_20 * V_20 ;
...
V_69 = F_194 ( V_29 , V_29 -> V_81 [ V_75 ] ,
V_76 , V_21 -> V_77 ,
V_42 , V_21 , 0 , V_368 ) ;
if ( F_76 ( V_69 < 0 ) )
return V_69 ;
...
V_10 = F_14 ( V_296 ) ;
V_392 = F_221 ( V_110 ) ;
V_392 = F_205 (unsigned int, trb_buff_len, block_len) ;
...
if ( F_222 ( V_21 ) )
V_10 |= V_411 ;
V_407 = F_215 ( V_29 , V_398 , V_392 ,
V_381 , V_21 , V_35 ) ;
V_406 = F_171 ( V_392 ) |
F_223 ( V_407 ) |
F_224 ( 0 ) ;
F_190 ( V_29 , V_14 , V_35 | V_402 ,
F_182 ( V_408 ) ,
F_183 ( V_408 ) ,
V_406 ,
V_10 ) ;
...
F_190 ( V_29 , V_14 , 0 , 0 , 0 , F_224 ( 0 ) , V_10 ) ;
}
F_207 ( V_21 , V_398 ) ;
F_209 ( V_29 , V_75 , V_76 , V_21 -> V_77 ,
V_384 , V_259 ) ;
return 0 ;
}
int F_226 ( struct V_28 * V_29 , T_8 V_368 ,
struct V_21 * V_21 , int V_75 , unsigned int V_76 )
{
struct V_13 * V_107 ;
int V_42 ;
...
F_190 ( V_29 , V_107 , true ,
V_413 -> V_416 | V_413 -> V_420 << 8 | F_228 ( V_413 -> V_421 ) << 16 ,
F_228 ( V_413 -> V_422 ) | F_228 ( V_413 -> V_423 ) << 16 ,
F_171 ( 8 ) | F_224 ( 0 ) ,
V_10 ) ;
if ( F_222 ( V_21 ) )
...
V_10 = V_424 ;
F_190 ( V_29 , V_107 , false ,
0 ,
0 ,
F_224 ( 0 ) ,
V_10 | V_410 | F_14 ( V_293 ) | V_107 -> V_33 ) ;
F_209 ( V_29 , V_75 , V_76 , 0 ,
V_384 , V_259 ) ;
return 0 ;
}
...
return F_199 ( V_395 , V_425 + 1 ) - 1 ;
}
static unsigned int F_230 ( struct V_28 * V_29 ,
struct V_21 * V_21 , unsigned int V_395 )
{
unsigned int V_425 ;
unsigned int V_429 ;
...
static int F_231 ( struct V_28 * V_29 ,
...
V_432 = F_232 ( V_29 -> V_436 ) & 0x7 ;
if ( F_232 ( V_29 -> V_436 ) & ( 1 << 3 ) )
V_432 <<= 3 ;
V_435 = F_26 ( & V_29 -> V_437 -> V_438 ) ;
V_433 = F_233 ( V_435 + V_432 + 1 , 8 ) ;
V_434 = F_234 ( V_435 + 895 * 8 , 8 ) ;
V_431 &= 0x7ff ;
V_433 = ( V_433 >> 3 ) & 0x7ff ;
V_434 = ( V_434 >> 3 ) & 0x7ff ;
F_24 ( V_29 , L_144 ,
...
static int F_235 ( struct V_28 * V_29 , T_8 V_368 ,
struct V_21 * V_21 , int V_75 , unsigned int V_76 )
{
struct V_13 * V_107 ;
struct V_20 * V_20 ;
...
V_441 = V_440 ;
V_400 = F_216 ( & V_21 -> V_80 -> V_280 ) ;
V_446 = F_199 ( V_440 , V_400 ) ;
if ( V_446 == 0 )
V_446 ++ ;
V_447 = F_229 ( V_29 , V_21 , V_446 ) ;
V_448 = F_230 ( V_29 ,
V_21 , V_446 ) ;
V_439 = F_206 ( V_21 , V_154 ) ;
V_69 = F_194 ( V_29 , V_29 -> V_81 [ V_75 ] , V_76 ,
...
int F_242 ( struct V_28 * V_29 , T_8 V_368 ,
struct V_21 * V_21 , int V_75 , unsigned int V_76 )
{
struct V_93 * V_282 ;
struct V_13 * V_107 ;
...
V_24 = V_21 -> V_445 ;
for ( V_154 = 0 ; V_154 < V_24 ; V_154 ++ )
V_42 += F_206 ( V_21 , V_154 ) ;
V_69 = F_192 ( V_29 , V_107 , F_100 ( V_96 ) ,
V_42 , V_368 ) ;
if ( V_69 )
return V_69 ;
F_210 ( V_29 , V_21 , V_96 ) ;
if ( F_236 ( V_29 -> V_452 ) && ! F_49 ( & V_107 -> V_88 ) ) {
if ( F_100 ( V_96 ) == V_374 ) {
...
if ( V_21 -> V_106 -> V_223 == V_389 ||
V_21 -> V_106 -> V_223 == V_390 ) {
V_431 = F_233 ( V_431 , V_21 -> V_388 << 3 ) ;
V_21 -> V_431 = V_431 >> 3 ;
} else {
V_431 = F_233 ( V_431 , V_21 -> V_388 ) ;
V_21 -> V_431 = V_431 ;
}
V_458:
V_107 -> V_160 = V_107 -> V_34 ;
return F_235 ( V_29 , V_368 , V_21 , V_75 , V_76 ) ;
}
static int F_243 ( struct V_28 * V_29 , struct V_53 * V_191 ,
T_2 V_364 , T_2 V_365 ,
...
if ( ! V_460 )
V_461 ++ ;
V_69 = F_192 ( V_29 , V_29 -> V_62 , V_374 ,
V_461 , V_180 ) ;
if ( V_69 < 0 ) {
F_38 ( V_29 , L_150 ) ;
if ( V_460 )
...
F_197 ( & V_191 -> V_54 , & V_29 -> V_54 ) ;
F_190 ( V_29 , V_29 -> V_62 , false , V_364 , V_365 , V_366 ,
V_367 | V_29 -> V_62 -> V_33 ) ;
return 0 ;
}
int F_244 ( struct V_28 * V_29 , struct V_53 * V_191 ,
T_2 V_215 , T_2 V_75 )
{
return F_243 ( V_29 , V_191 , 0 , 0 , 0 ,
F_14 ( V_215 ) | F_245 ( V_75 ) , false ) ;
}
int F_246 ( struct V_28 * V_29 , struct V_53 * V_191 ,
T_1 V_463 , T_2 V_75 , enum V_464 V_413 )
{
return F_243 ( V_29 , V_191 , F_182 ( V_463 ) ,
F_183 ( V_463 ) , 0 ,
F_14 ( V_209 ) | F_245 ( V_75 )
| ( V_413 == V_465 ? V_466 : 0 ) , false ) ;
}
int F_247 ( struct V_28 * V_29 , struct V_53 * V_191 ,
T_2 V_364 , T_2 V_365 , T_2 V_366 , T_2 V_367 )
{
return F_243 ( V_29 , V_191 , V_364 , V_365 , V_366 , V_367 , false ) ;
}
int F_248 ( struct V_28 * V_29 , struct V_53 * V_191 ,
T_2 V_75 )
{
return F_243 ( V_29 , V_191 , 0 , 0 , 0 ,
F_14 ( V_213 ) | F_245 ( V_75 ) ,
false ) ;
}
...
return F_243 ( V_29 , V_191 , F_182 ( V_463 ) ,
F_183 ( V_463 ) , 0 ,
F_14 ( V_208 ) | F_245 ( V_75 ) ,
V_460 ) ;
}
int F_250 ( struct V_28 * V_29 , struct V_53 * V_191 ,
int V_75 , unsigned int V_76 , int V_467 )
{
T_2 V_468 = F_245 ( V_75 ) ;
T_2 V_469 = F_251 ( V_76 ) ;
T_2 type = F_14 ( V_210 ) ;
T_2 V_470 = F_252 ( V_467 ) ;
return F_243 ( V_29 , V_191 , 0 , 0 , 0 ,
...
if ( V_148 -> V_77 )
V_472 = F_254 ( V_473 ) ;
V_69 = F_243 ( V_29 , V_191 ,
F_182 ( V_110 ) | V_472 | V_148 -> V_115 ,
F_183 ( V_110 ) , V_471 ,
...
int F_161 ( struct V_28 * V_29 , struct V_53 * V_191 ,
