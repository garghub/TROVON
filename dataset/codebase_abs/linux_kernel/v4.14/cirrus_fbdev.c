...
V_35 -> V_71 = & V_72 ;
F_31 ( V_35 , V_63 -> V_32 [ 0 ] , V_63 -> V_17 -> V_73 ) ;
F_32 ( V_35 , & V_61 -> V_50 , V_60 -> V_74 ,
V_60 -> V_75 ) ;
V_35 -> V_76 -> V_77 [ 0 ] . V_16 = V_52 -> V_49 -> V_78 . V_79 ;
V_35 -> V_76 -> V_77 [ 0 ] . V_54 = V_52 -> V_80 . V_81 ;
V_35 -> V_69 . V_82 = V_52 -> V_49 -> V_78 . V_79 ;
V_35 -> V_69 . V_83 = V_52 -> V_80 . V_81 ;
V_35 -> V_84 = V_33 ;
V_35 -> V_85 = V_54 ;
V_35 -> V_69 . V_86 = 0 ;
V_35 -> V_69 . V_87 = 0 ;
F_30 ( L_5 , V_35 -> V_69 . V_82 ) ;
F_30 ( L_6 , ( unsigned long ) V_35 -> V_69 . V_82 ) ;
F_30 ( L_7 , ( unsigned long ) V_35 -> V_69 . V_83 ) ;
F_30 ( L_8 , V_63 -> V_17 -> V_73 ) ;
...
int V_19 ;
int V_89 = 24 ;
V_61 = F_41 ( sizeof( struct V_1 ) , V_90 ) ;
if ( ! V_61 )
return - V_68 ;
V_52 -> V_91 . V_61 = V_61 ;
F_42 ( & V_61 -> V_26 ) ;
...
return V_19 ;
F_46 ( V_52 -> V_49 ) ;
return F_47 ( & V_61 -> V_50 , V_89 ) ;
}
void F_48 ( struct V_51 * V_52 )
{
if ( ! V_52 -> V_91 . V_61 )
return;
F_33 ( V_52 -> V_49 , V_52 -> V_91 . V_61 ) ;
F_49 ( V_52 -> V_91 . V_61 ) ;
V_52 -> V_91 . V_61 = NULL ;
}
