...
snprintf ( V_91 , sizeof( V_91 ) , L_5 ,
V_106 -> V_205 ) ;
} else if ( ( V_156 == 2 ) && ( V_53 == V_3 -> V_5 ) ) {
snprintf ( V_91 , sizeof( V_91 ) , L_5 ,
V_106 -> V_205 ) ;
} else {
snprintf ( V_91 , sizeof( V_91 ) , L_6 ,
V_106 -> V_205 , V_156 + 1 ) ;
}
...
if ( V_180 < 0 )
return V_180 ;
snprintf ( V_3 -> V_157 [ V_156 ] . V_174 -> V_206 ,
sizeof( V_3 -> V_157 [ V_156 ] . V_174 -> V_206 ) ,
L_6 , V_106 -> V_156 , V_156 + 1 ) ;
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
int V_28 = V_229 -> V_224 . integer . V_224 [ 0 ] ;
if ( V_28 < 27000 || V_28 > 207000 )
return - V_123 ;
F_42 ( V_3 , V_229 -> V_224 . integer . V_224 [ 0 ] ) ;
return 0 ;
}
...
static int F_23 ( struct V_3 * V_3 , int V_234 )
{
int V_235 ;
switch ( V_3 -> V_5 ) {
case V_36 :
V_235 = F_5 ( V_3 , V_236 ) ;
return ( V_235 >> ( 4 * V_234 ) ) & 0xF ;
break;
default:
break;
}
...
static int F_80 ( struct V_3 * V_3 , unsigned int V_237 )
{
int V_32 = F_5 ( V_3 , V_233 ) ;
return ( V_32 >> ( V_237 * 4 ) ) & 0xF ;
}
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = F_74 ( V_3 ) ;
return 0 ;
}
...
struct V_220 * V_221 )
{
return F_93 ( V_221 , 1 , 9 , V_239 + 1 ) ;
}
static int F_94 ( struct V_218 * V_219 ,
struct V_228 * V_229 )
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = F_90 ( V_3 ) ;
return 0 ;
}
...
int V_260 = F_96 ( V_3 ) ;
if ( V_260 >= 0 ) {
V_229 -> V_224 . V_241 . V_242 [ 0 ] = V_260 ;
return 0 ;
}
return - 1 ;
}
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = F_19 ( V_3 ) ;
return 0 ;
}
...
V_229 -> V_224 . V_241 . V_242 [ 0 ] = V_24 ;
return 0 ;
}
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = F_106 ( V_3 ) ;
return 0 ;
}
...
struct V_3 * V_3 = F_77 ( V_219 ) ;
F_36 ( & V_3 -> V_25 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = F_111 ( V_3 ) ;
F_38 ( & V_3 -> V_25 ) ;
return 0 ;
}
...
struct V_3 * V_3 = F_77 ( V_219 ) ;
F_36 ( & V_3 -> V_25 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = F_116 ( V_3 ) ;
F_38 ( & V_3 -> V_25 ) ;
return 0 ;
}
...
struct V_3 * V_3 = F_77 ( V_219 ) ;
F_36 ( & V_3 -> V_25 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = F_121 ( V_3 ) ;
F_38 ( & V_3 -> V_25 ) ;
return 0 ;
}
...
V_18 V_280 = V_219 -> V_240 ;
F_36 ( & V_3 -> V_25 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = F_126 ( V_3 , V_280 ) ;
F_38 ( & V_3 -> V_25 ) ;
return 0 ;
}
...
struct V_3 * V_3 = F_77 ( V_219 ) ;
F_36 ( & V_3 -> V_25 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = F_131 ( V_3 ) ;
F_38 ( & V_3 -> V_25 ) ;
return 0 ;
}
...
static int F_145 ( struct V_3 * V_3 , int V_237 )
{
int V_32 , V_25 , V_298 ;
V_32 = F_5 ( V_3 , V_230 ) ;
V_25 = ( V_32 & ( 0x1 << V_237 ) ) ? 1 : 0 ;
V_298 = ( V_32 & ( 0x100 << V_237 ) ) ? 1 : 0 ;
if ( V_25 && V_298 )
return 2 ;
else if ( V_25 )
return 1 ;
...
static int F_22 ( struct V_3 * V_3 , int V_237 )
{
int V_33 , V_25 , V_298 ;
V_33 = F_5 ( V_3 , V_37 ) ;
V_25 = ( V_33 & ( 0x0080 >> V_237 ) ) ? 1 : 0 ;
V_298 = ( V_33 & ( 0x8000 >> V_237 ) ) ? 1 : 0 ;
if ( V_298 )
return 2 ;
else if ( V_25 )
return 1 ;
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = V_3 -> V_232 -> V_315 ;
return 0 ;
}
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
if ( V_3 -> V_232 -> V_315 != V_229 -> V_224 . V_241 . V_242 [ 0 ] ) {
V_3 -> V_232 -> V_315 = V_229 -> V_224 . V_241 . V_242 [ 0 ] ;
F_148 ( V_3 ) ;
return 1 ;
}
return 0 ;
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = V_3 -> V_232 -> V_318 ;
return 0 ;
}
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
if ( V_3 -> V_232 -> V_318 != V_229 -> V_224 . V_241 . V_242 [ 0 ] ) {
V_3 -> V_232 -> V_318 = V_229 -> V_224 . V_241 . V_242 [ 0 ] ;
F_148 ( V_3 ) ;
return 1 ;
}
return 0 ;
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = V_3 -> V_232 -> V_312 ;
return 0 ;
}
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
if ( V_3 -> V_232 -> V_312 != V_229 -> V_224 . V_241 . V_242 [ 0 ] ) {
V_3 -> V_232 -> V_312 = V_229 -> V_224 . V_241 . V_242 [ 0 ] ;
F_148 ( V_3 ) ;
return 1 ;
}
return 0 ;
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = V_3 -> V_232 -> V_310 ;
return 0 ;
}
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
if ( V_3 -> V_232 -> V_310 != V_229 -> V_224 . V_241 . V_242 [ 0 ] ) {
V_3 -> V_232 -> V_310 = V_229 -> V_224 . V_241 . V_242 [ 0 ] ;
F_148 ( V_3 ) ;
return 1 ;
}
return 0 ;
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . V_241 . V_242 [ 0 ] = V_3 -> V_232 -> V_168 ;
return 0 ;
}
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
if ( V_3 -> V_232 -> V_168 != V_229 -> V_224 . V_241 . V_242 [ 0 ] ) {
V_3 -> V_232 -> V_168 = V_229 -> V_224 . V_241 . V_242 [ 0 ] ;
F_148 ( V_3 ) ;
return 1 ;
}
return 0 ;
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
V_229 -> V_224 . integer . V_224 [ 0 ] = V_3 -> V_232 -> V_322 ;
return 0 ;
}
...
{
struct V_3 * V_3 = F_77 ( V_219 ) ;
if ( V_3 -> V_232 -> V_322 != V_229 -> V_224 . integer . V_224 [ 0 ] ) {
V_3 -> V_232 -> V_322 = V_229 -> V_224 . integer . V_224 [ 0 ] ;
F_148 ( V_3 ) ;
return 1 ;
}
return 0 ;
...
if ( V_338 ) {
for ( V_237 = 0 ; V_237 < V_335 ; V_237 ++ ) {
V_180 = F_171 ( V_106 ,
F_172 ( & V_338 [ V_237 ] , V_3 ) ) ;
if ( V_180 < 0 )
return V_180 ;
}
}
...
static int F_231 ( struct V_403 * V_172 )
{
struct V_3 * V_3 = F_191 ( V_172 ) ;
bool V_446 = ( V_172 -> V_407 == V_408 ) ;
F_36 ( & V_3 -> V_25 ) ;
...
static int F_232 ( struct V_457 * V_447 , struct V_458 * V_458 )
{
return 0 ;
}
static inline int F_233 ( void T_5 * V_459 , void T_6 * V_460 )
{
V_18 V_8 = F_6 ( V_460 ) ;
return F_234 ( V_459 , & V_8 , 4 ) ;
}
static int F_235 ( struct V_457 * V_447 , struct V_458 * V_458 ,
...
V_87 = F_234 ( V_461 , V_467 , sizeof( * V_467 ) ) ;
if ( 0 != V_87 ) {
return - V_491 ;
}
break;
...
V_87 = F_234 ( V_461 , & V_352 , sizeof( V_352 ) ) ;
if ( 0 != V_87 ) {
return - V_491 ;
}
break;
...
V_428 . V_508 = 0 ;
F_38 ( & V_3 -> V_25 ) ;
if ( F_234 ( V_461 , & V_428 , sizeof( V_428 ) ) )
return - V_491 ;
break;
case V_509 :
...
if ( F_234 ( V_461 , & V_32 , sizeof( V_32 ) ) )
return - V_491 ;
break;
case V_523 :
memset ( & V_465 , 0 , sizeof( V_465 ) ) ;
V_465 . V_510 = V_3 -> V_5 ;
F_236 ( V_465 . V_524 , V_3 -> V_362 ,
sizeof( V_465 . V_524 ) ) ;
...
if ( V_3 -> V_232 )
V_465 . V_525 |= V_526 ;
if ( F_234 ( V_461 , & V_465 ,
sizeof( V_465 ) ) )
return - V_491 ;
break;
case V_527 :
if ( F_237 ( & V_13 , V_461 , sizeof( V_13 ) ) )
return - V_491 ;
if ( F_234 ( ( void T_5 * ) V_13 . V_13 , V_3 -> V_13 ,
sizeof( * V_13 . V_13 ) ) )
return - V_491 ;
break;
default:
...
static int F_238 ( struct V_179 * V_106 ,
struct V_3 * V_3 )
{
struct V_457 * V_447 ;
int V_180 ;
V_180 = F_239 ( V_106 , L_166 , 0 , & V_447 ) ;
if ( V_180 < 0 )
return V_180 ;
V_3 -> V_528 = V_447 ;
V_447 -> V_175 = V_3 ;
strcpy ( V_447 -> V_206 , L_167 ) ;
V_447 -> V_529 . V_530 = F_232 ;
V_447 -> V_529 . V_531 = F_235 ;
V_447 -> V_529 . V_532 = F_235 ;
V_447 -> V_529 . V_533 = F_232 ;
return 0 ;
}
static int F_240 ( struct V_3 * V_3 )
{
int V_180 ;
struct V_534 * V_535 ;
T_7 V_536 ;
...
struct V_403 * V_172 ,
unsigned int V_7 , int V_539 )
{
int V_19 ;
for ( V_19 = 0 ; V_19 < ( V_539 * 16 ) ; V_19 ++ )
F_3 ( V_3 , V_7 + 4 * V_19 ,
F_243 ( V_172 , 4096 * V_19 ) ) ;
}
static int F_244 ( struct V_179 * V_106 ,
struct V_3 * V_3 )
{
struct V_534 * V_535 ;
int V_180 ;
V_180 = F_245 ( V_106 , V_3 -> V_362 , 0 , 1 , 1 , & V_535 ) ;
if ( V_180 < 0 )
return V_180 ;
V_3 -> V_535 = V_535 ;
V_535 -> V_175 = V_3 ;
strcpy ( V_535 -> V_206 , V_3 -> V_362 ) ;
F_246 ( V_535 , V_408 ,
& V_540 ) ;
F_246 ( V_535 , V_437 ,
& V_540 ) ;
...
static int F_248 ( struct V_179 * V_106 ,
struct V_3 * V_3 )
{
int V_180 , V_19 ;
F_202 ( V_106 -> V_107 , L_170 ) ;
V_180 = F_244 ( V_106 , V_3 ) ;
if ( V_180 < 0 )
return V_180 ;
V_19 = 0 ;
while ( V_19 < V_3 -> V_216 ) {
...
static int F_250 ( struct V_179 * V_106 ,
struct V_3 * V_3 )
{
struct V_544 * V_538 = V_3 -> V_538 ;
int V_180 ;
unsigned long V_545 ;
V_3 -> V_186 = - 1 ;
V_3 -> V_106 = V_106 ;
...
F_251 ( V_3 -> V_538 ,
V_546 , & V_3 -> V_364 ) ;
strcpy ( V_106 -> V_547 , L_177 ) ;
strcpy ( V_106 -> V_548 , L_178 ) ;
switch ( V_3 -> V_364 ) {
case V_549 :
V_3 -> V_5 = V_6 ;
V_3 -> V_362 = L_179 ;
...
return V_180 ;
F_253 ( V_3 -> V_538 ) ;
V_180 = F_254 ( V_538 , L_151 ) ;
if ( V_180 < 0 )
return V_180 ;
V_3 -> V_369 = F_255 ( V_538 , 0 ) ;
V_545 = F_256 ( V_538 , 0 ) ;
F_202 ( V_106 -> V_107 , L_185 ,
V_3 -> V_369 , V_3 -> V_369 + V_545 - 1 ) ;
V_3 -> V_9 = F_257 ( V_3 -> V_369 , V_545 ) ;
if ( ! V_3 -> V_9 ) {
...
V_3 -> V_369 + V_545 - 1 ) ;
if ( F_258 ( V_538 -> V_186 , F_187 ,
V_553 , V_554 , V_3 ) ) {
F_46 ( V_106 -> V_107 , L_188 , V_538 -> V_186 ) ;
return - V_125 ;
}
F_202 ( V_106 -> V_107 , L_189 , V_538 -> V_186 ) ;
V_3 -> V_186 = V_538 -> V_186 ;
F_202 ( V_106 -> V_107 , L_190 ,
sizeof( * V_3 -> V_13 ) ) ;
V_3 -> V_13 = F_259 ( sizeof( * V_3 -> V_13 ) , V_555 ) ;
if ( ! V_3 -> V_13 )
return - V_556 ;
V_3 -> V_136 = NULL ;
V_3 -> V_138 = NULL ;
switch ( V_3 -> V_5 ) {
case V_36 :
V_3 -> V_133 = V_3 -> V_135 = V_557 ;
V_3 -> V_142 = V_3 -> V_143 = V_557 ;
V_3 -> V_148 = V_3 -> V_149 = V_557 ;
V_3 -> V_129 = V_3 -> V_131 =
V_558 ;
V_3 -> V_140 = V_3 -> V_141 =
V_558 ;
...
V_3 -> V_143 = V_569 ;
V_3 -> V_149 = V_570 ;
if ( 0 == ( F_5 ( V_3 , V_37 ) & V_571 ) ) {
F_198 ( V_106 -> V_107 , L_191 ) ;
V_3 -> V_133 += 4 ;
V_3 -> V_142 += 4 ;
V_3 -> V_148 += 4 ;
}
...
V_594 ) {
V_3 -> V_216 ++ ;
V_3 -> V_232 = F_259 ( sizeof( * V_3 -> V_232 ) , V_555 ) ;
if ( V_3 -> V_232 )
F_148 ( V_3 ) ;
...
V_3 -> V_368 = ( F_5 ( V_3 ,
V_189 ) >> 8 ) & 0xFFFFFF ;
if ( ! V_156 [ V_3 -> V_107 ] && V_3 -> V_368 != 0xFFFFFF ) {
snprintf ( V_106 -> V_156 , sizeof( V_106 -> V_156 ) ,
L_195 , V_3 -> V_368 ) ;
F_261 ( V_106 , V_106 -> V_156 ) ;
}
}
F_202 ( V_106 -> V_107 , L_196 ) ;
V_180 = F_248 ( V_106 , V_3 ) ;
if ( V_180 < 0 )
return V_180 ;
F_247 ( V_3 ) ;
return 0 ;
}
static int F_262 ( struct V_3 * V_3 )
{
if ( V_3 -> V_369 ) {
V_3 -> V_29 &=
~ ( V_89 | V_88 |
...
static void F_268 ( struct V_179 * V_106 )
{
struct V_3 * V_3 = V_106 -> V_175 ;
if ( V_3 )
F_262 ( V_3 ) ;
}
static int F_269 ( struct V_544 * V_538 ,
const struct V_603 * V_604 )
{
static int V_107 ;
struct V_3 * V_3 ;
struct V_179 * V_106 ;
...
V_180 = F_270 ( & V_538 -> V_107 , V_234 [ V_107 ] , V_156 [ V_107 ] ,
V_608 , sizeof( * V_3 ) , & V_106 ) ;
if ( V_180 < 0 )
return V_180 ;
V_3 = V_106 -> V_175 ;
V_106 -> V_609 = F_268 ;
V_3 -> V_107 = V_107 ;
V_3 -> V_538 = V_538 ;
V_180 = F_250 ( V_106 , V_3 ) ;
if ( V_180 < 0 )
goto V_610;
if ( V_3 -> V_5 != V_49 ) {
snprintf ( V_106 -> V_205 , sizeof( V_106 -> V_205 ) , L_197 ,
V_3 -> V_362 , V_3 -> V_368 ) ;
snprintf ( V_106 -> V_611 , sizeof( V_106 -> V_611 ) ,
L_198 ,
V_3 -> V_362 , V_3 -> V_368 ,
V_3 -> V_369 , V_3 -> V_186 ) ;
} else {
snprintf ( V_106 -> V_205 , sizeof( V_106 -> V_205 ) , L_199 ,
V_3 -> V_362 ) ;
snprintf ( V_106 -> V_611 , sizeof( V_106 -> V_611 ) ,
L_200 ,
...
static void F_273 ( struct V_544 * V_538 )
{
F_272 ( F_274 ( V_538 ) ) ;
}
