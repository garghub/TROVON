...
V_149 -> V_157 = V_12 -> V_76 -> V_157 ;
V_147 = V_12 -> V_76 -> V_157 -> V_158 ( V_12 -> V_76 , V_149 , V_159 , true ) ;
if ( V_147 < 0 )
goto V_156;
memset ( & V_148 , 0 , sizeof( V_148 ) ) ;
if ( V_149 -> V_157 -> V_160 ( V_149 , (struct V_50 * ) & V_148 ,
& V_4 , 2 ) ) {
V_147 = - V_161 ;
goto V_156;
}
F_57 ( & V_148 , 0 , & V_4 ) ;
if ( F_29 ( & V_148 , & V_8 ) ) {
unsigned char * V_162 = ( unsigned char * ) & V_148 ;
F_61 ( L_10 ) ;
F_72 ( L_11 , V_163 ,
...
F_21 ( & V_31 ) ;
F_71 ( & V_12 -> V_17 , 0 ) ;
V_129 = F_76 ( V_12 -> V_76 , & V_149 , V_159 ) ;
if ( V_129 < 0 )
goto V_156;
memset ( & V_165 , 0 , sizeof( struct V_164 ) ) ;
V_166 = sizeof( struct V_164 ) ;
V_129 = F_77 ( V_149 , V_167 , V_168 ,
( char * ) & V_165 , & V_166 ) ;
if ( V_129 < 0 ) {
F_61 ( L_16 , V_129 ) ;
goto V_156;
}
F_57 ( & V_165 . V_169 , 0 , & V_118 ) ;
V_129 = F_29 ( & V_165 . V_169 , & V_8 ) ;
if ( V_129 ) {
...
static void F_79 ( struct V_170 * V_171 , int V_173 )
{
V_171 -> V_174 += V_173 ;
V_171 -> V_4 -= V_173 ;
...
F_57 ( & V_176 , V_117 , & V_118 ) ;
if ( ! V_28 )
V_147 = F_82 ( V_12 -> V_76 ,
(struct V_50 * ) & V_176 ,
V_118 ) ;
else
V_147 = F_83 ( V_12 -> V_76 , V_177 ,
V_178 ,
( char * ) & V_176 , V_118 ) ;
if ( V_147 < 0 ) {
F_61 ( L_19 ,
...
V_147 = F_26 ( V_12 -> V_8 , & V_179 , NULL , true ) ;
if ( V_147 < 0 ) {
F_61 ( L_22 , V_12 -> V_8 ) ;
goto V_96;
}
V_147 = F_85 ( & V_182 , V_61 [ 0 ] -> V_37 ,
V_153 , V_167 , & V_76 ) ;
if ( V_147 < 0 )
goto V_183;
...
if ( F_81 ( V_12 , 0 ) )
goto V_184;
F_57 ( & V_179 , V_99 . V_100 , & V_118 ) ;
F_61 ( L_23 , V_12 -> V_8 ) ;
F_83 ( V_76 , V_185 , V_186 , ( char * ) & V_180 ,
sizeof( V_180 ) ) ;
V_147 = V_76 -> V_157 -> V_187 ( V_76 , (struct V_50 * ) & V_179 , V_118 ,
V_159 ) ;
if ( V_147 == - V_188 )
V_147 = 0 ;
if ( V_147 == 0 )
...
static void F_87 ( struct V_10 * V_12 )
{
...
F_57 ( & V_193 , 0 , & V_118 ) ;
V_147 = V_76 -> V_157 -> V_195 ( V_76 , (struct V_50 * ) & V_193 ,
V_118 ) ;
if ( V_147 < 0 ) {
F_61 ( L_25 , V_147 ) ;
}
...
F_83 ( V_76 , V_185 , V_186 , ( char * ) & V_180 ,
sizeof( V_180 ) ) ;
V_147 = V_76 -> V_157 -> V_187 ( V_76 , (struct V_50 * ) & V_93 , V_118 ,
V_159 ) ;
if ( V_147 == - V_188 )
V_147 = 0 ;
if ( V_147 == 0 )
...
static struct V_114 * F_88 ( struct V_10 * V_12 ,
struct V_34 * V_93 )
{
struct V_114 * V_76 = NULL ;
int V_147 = 0 ;
...
V_12 -> V_25 = F_87 ;
F_57 ( V_93 , V_99 . V_100 , & V_118 ) ;
V_147 = V_76 -> V_157 -> V_195 ( V_76 , (struct V_50 * ) V_93 , V_118 ) ;
if ( V_147 < 0 ) {
...
if ( F_90 ( & V_53 , V_28 ) )
break;
V_57 = F_91 ( & V_53 , sizeof( * V_57 ) , V_71 ) ;
if ( ! V_57 )
break;
V_61 [ V_54 ++ ] = V_57 ;
}
...
if ( V_147 )
F_61 ( L_33 , V_147 ) ;
V_147 = F_83 ( V_76 , V_177 , V_204 , ( char * ) & V_180 ,
sizeof( V_180 ) ) ;
if ( V_147 < 0 )
F_61 ( L_34 , V_147 ) ;
F_54 ( & V_76 -> V_77 -> V_95 ) ;
...
static struct V_170 * F_94 ( struct V_10 * V_12 ,
T_1 V_30 )
{
struct V_170 * V_207 ;
V_207 = F_95 ( sizeof( struct V_170 ) , V_30 ) ;
if ( ! V_207 )
return NULL ;
V_207 -> V_172 = F_65 ( V_30 ) ;
if ( ! V_207 -> V_172 ) {
F_32 ( V_207 ) ;
return NULL ;
}
...
void * F_96 ( int V_8 , int V_4 , T_1 V_30 , char * * V_209 )
{
struct V_10 * V_12 ;
struct V_170 * V_171 ;
int V_174 = 0 ;
...
return NULL ;
F_27 ( & V_12 -> V_19 ) ;
V_171 = F_97 ( V_12 -> V_18 . V_210 , struct V_170 , V_15 ) ;
if ( ( & V_171 -> V_15 == & V_12 -> V_18 ) ||
( V_141 - V_171 -> V_208 < V_4 ) ) {
V_171 = NULL ;
} else {
V_174 = V_171 -> V_208 ;
V_171 -> V_208 += V_4 ;
...
if ( V_171 ) {
V_211:
* V_209 = F_66 ( V_171 -> V_172 ) + V_174 ;
return V_171 ;
}
V_171 = F_94 ( V_12 , V_30 ) ;
if ( V_171 ) {
F_27 ( & V_12 -> V_19 ) ;
V_174 = V_171 -> V_208 ;
V_171 -> V_208 += V_4 ;
...
void F_99 ( void * V_212 )
{
struct V_170 * V_171 = (struct V_170 * ) V_212 ;
...
if ( V_175 )
goto V_96;
V_171 -> V_4 = V_171 -> V_208 - V_171 -> V_174 ;
F_28 ( & V_12 -> V_19 ) ;
if ( ! F_36 ( V_85 , & V_12 -> V_79 ) ) {
F_37 ( V_86 , & V_12 -> V_20 ) ;
}
...
F_27 ( & V_12 -> V_19 ) ;
for (; ; ) {
V_171 = F_97 ( V_12 -> V_18 . V_216 , struct V_170 ,
V_15 ) ;
if ( (struct V_217 * ) V_171 == & V_12 -> V_18 )
break;
V_4 = V_171 -> V_4 ;
V_174 = V_171 -> V_174 ;
...
V_129 = 0 ;
if ( V_4 ) {
V_129 = F_102 ( V_12 -> V_76 , V_171 -> V_172 , V_174 , V_4 ,
V_213 ) ;
...
{
struct V_10 * V_12 = F_107 ( V_222 , struct V_10 , V_22 ) ;
int V_223 ;
F_39 ( V_78 , & V_12 -> V_79 ) ;
do {
...
{
struct V_10 * V_12 = F_107 ( V_222 , struct V_10 , V_20 ) ;
