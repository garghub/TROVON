...
{
int V_44 = V_45 ;
V_10 -> V_7 = F_43 ( V_44 * sizeof( void * ) , V_41 ) ;
if ( ! V_10 -> V_7 )
return - V_43 ;
...
F_47 ( V_46 > V_47 ) ;
V_48 = V_10 -> V_7 ;
V_49 = F_43 ( V_47 * sizeof( void * ) , V_41 ) ;
if ( ! V_49 )
return - V_43 ;
...
static int F_51 ( struct V_1 * V_2 , bool V_50 )
{
int V_40 ;
if ( ! V_50 )
return 0 ;
...
int V_46 = V_45 ;
F_2 ( & V_3 ) ;
F_57 (lru, &list_lrus, list) {
V_31 = F_54 ( V_2 , V_46 , V_47 ) ;
if ( V_31 )
goto V_42;
}
V_51:
...
return;
F_52 (i)
F_59 ( & V_2 -> V_6 [ V_40 ] , V_52 , V_53 ) ;
}
void F_62 ( int V_52 , int V_53 )
{
struct V_1 * V_2 ;
F_2 ( & V_3 ) ;
F_57 (lru, &list_lrus, list)
...
int F_63 ( struct V_1 * V_2 , bool V_50 ,
struct V_56 * V_57 )
{
int V_40 ;
...
int V_59 = - V_43 ;
F_64 () ;
V_2 -> V_6 = F_65 ( V_44 , V_41 ) ;
if ( ! V_2 -> V_6 )
goto V_51;
F_52 (i) {
F_66 ( & V_2 -> V_6 [ V_40 ] . V_12 ) ;
if ( V_57 )
F_67 ( & V_2 -> V_6 [ V_40 ] . V_12 , V_57 ) ;
