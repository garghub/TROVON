...
static void T_3 F_19 ( struct V_33 * V_34 )
{
T_2 V_35 , V_36 ;
...
V_35 = F_16 ( V_6 + V_37 ) ;
V_36 = V_35 & V_38 ;
if ( F_20 ( V_36 > 15 && V_36 <= V_39 ) ) {
F_21 ( V_4 . V_40 , V_36 , V_34 ) ;
continue;
}
if ( V_36 < 16 ) {
F_7 ( V_35 , V_6 + V_12 ) ;
...
static T_4 F_24 ( struct V_3 * V_41 )
{
...
static void T_5 F_26 ( struct V_3 * V_41 )
{
unsigned int V_42 ;
T_2 V_19 ;
...
static void F_28 ( struct V_3 * V_41 )
{
void T_1 * V_5 = V_41 -> V_5 ;
void T_1 * V_13 = V_41 -> V_6 ;
unsigned int V_45 , V_23 = F_29 () ;
int V_42 ;
F_30 ( V_23 >= V_28 ) ;
V_45 = F_24 ( V_41 ) ;
V_31 [ V_23 ] = V_45 ;
...
static void F_32 ( const struct V_19 * V_8 , unsigned int V_14 )
{
int V_23 ;
...
static int F_37 ( struct V_52 * V_2 , unsigned int V_14 ,
T_6 V_53 )
{
if ( V_53 < 32 ) {
F_38 ( V_14 ) ;
...
static int F_46 ( struct V_52 * V_2 ,
struct V_59 * V_60 ,
...
static int F_48 ( unsigned int V_23 )
{
F_28 ( & V_4 ) ;
return 0 ;
}
static int T_5
F_49 ( struct V_59 * V_66 , struct V_59 * V_67 )
{
T_6 V_68 = 16 ;
int V_43 , V_69 , V_42 ;
if ( F_50 ( ! V_66 ) )
...
for ( V_42 = 0 ; V_42 < V_28 ; V_42 ++ )
V_31 [ V_42 ] = 0xffff ;
V_43 = F_16 ( V_4 . V_5 + V_71 ) & 0x1f ;
V_43 = ( V_43 + 1 ) * 32 ;
if ( V_43 > V_39 )
V_43 = V_39 ;
V_4 . V_43 = V_43 ;
V_43 -= V_68 ;
V_69 = F_53 ( - 1 , V_68 , V_43 , F_54 () ) ;
if ( V_69 < 0 ) {
F_55 ( L_4 ) ;
return - V_16 ;
}
V_4 . V_40 = F_56 ( V_66 , V_43 , V_69 ,
V_68 ,
& V_72 ,
& V_4 ) ;
if ( F_50 ( ! V_4 . V_40 ) )
