...
V_81 -> V_7 . V_89 = F_22 ;
V_81 -> V_7 . V_90 = F_23 ;
V_82 = F_28 ( V_7 -> V_35 , V_54 , F_29 ( V_79 ) ,
V_91 ,
V_92 | V_93 , 0 ) ;
return V_82 ;
}
...
V_74 = F_31 ( V_95 ) ;
if ( V_74 ) {
F_32 ( & V_95 -> V_35 , L_5 , V_56 ) ;
goto V_99;
}
V_74 = F_33 ( V_95 , V_100 ) ;
if ( V_74 ) {
F_32 ( & V_95 -> V_35 , L_6 , V_74 ) ;
goto V_101;
}
V_43 = F_34 ( V_95 , 1 , 0 ) ;
if ( ! V_43 ) {
F_32 ( & V_95 -> V_35 , L_7 , V_56 ) ;
V_74 = - V_84 ;
goto V_102;
}
V_98 = F_35 ( sizeof( * V_7 ) * 8 , V_103 ) ;
if ( V_98 == NULL ) {
F_32 ( & V_95 -> V_35 , L_8 , V_56 ) ;
V_74 = - V_84 ;
goto V_104;
}
V_7 = V_98 ;
...
V_7 = V_98 ;
V_74 = F_39 ( & V_95 -> V_35 , V_95 -> V_52 , F_24 ,
V_108 , V_100 , V_7 ) ;
if ( V_74 != 0 ) {
F_32 ( & V_95 -> V_35 ,
L_11 , V_56 ) ;
...
F_45 ( V_95 ) ;
V_99:
F_32 ( & V_95 -> V_35 , L_12 , V_56 , V_74 ) ;
return V_74 ;
}
static void F_46 ( struct V_94 * V_95 )
{
int V_17 ;
struct V_6 * V_7 = F_47 ( V_95 ) ;
void * V_98 ;
V_98 = V_7 ;
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ , V_7 ++ )
F_41 ( & V_7 -> V_2 ) ;
...
static int F_48 ( struct V_94 * V_95 , T_4 V_109 )
{
T_5 V_74 ;
struct V_6 * V_7 = F_47 ( V_95 ) ;
unsigned long V_8 ;
...
V_74 = F_49 ( V_95 ) ;
if ( V_74 ) {
F_32 ( & V_95 -> V_35 , L_13 , V_74 ) ;
return V_74 ;
}
F_45 ( V_95 ) ;
F_50 ( V_95 , V_110 ) ;
V_74 = F_51 ( V_95 , V_110 , 1 ) ;
if ( V_74 )
F_32 ( & V_95 -> V_35 , L_14 , V_74 ) ;
return 0 ;
}
...
struct V_6 * V_7 = F_47 ( V_95 ) ;
unsigned long V_8 ;
V_74 = F_51 ( V_95 , V_110 , 0 ) ;
F_50 ( V_95 , V_110 ) ;
V_74 = F_31 ( V_95 ) ;
if ( V_74 ) {
F_32 ( & V_95 -> V_35 , L_15 , V_74 ) ;
return V_74 ;
}
F_53 ( V_95 ) ;
F_3 ( & V_7 -> V_9 , V_8 ) ;
F_5 ( 0x01 , & V_7 -> V_10 -> V_111 ) ;
F_5 ( 0x00 , & V_7 -> V_10 -> V_111 ) ;
F_11 ( V_7 ) ;
F_6 ( & V_7 -> V_9 , V_8 ) ;
return 0 ;
}
