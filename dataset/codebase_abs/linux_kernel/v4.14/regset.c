...
if ( F_12 () ) {
if ( V_13 )
V_18 = F_13 ( V_13 , V_22 , V_11 , V_12 ) ;
else
V_18 = F_14 ( V_14 , V_22 , V_11 , V_12 ) ;
} else {
F_6 ( V_5 ) ;
...
int F_15 ( struct V_1 * V_2 , const struct V_3 * V_4 ,
unsigned int V_11 , unsigned int V_12 ,
const void * V_13 , const void T_1 * V_14 )
{
struct V_5 * V_5 = & V_2 -> V_7 . V_5 ;
...
static inline unsigned short F_20 ( unsigned short V_32 )
{
unsigned int V_33 ;
V_33 = ~ V_32 ;
...
static inline T_2 F_21 ( struct V_34 * V_17 )
{
struct V_35 * V_36 ;
...
void
F_23 ( struct V_47 * V_48 , struct V_1 * V_49 )
{
...
int F_28 ( struct V_1 * V_2 , const struct V_3 * V_4 ,
unsigned int V_11 , unsigned int V_12 ,
void * V_13 , void T_1 * V_14 )
{
struct V_5 * V_5 = & V_2 -> V_7 . V_5 ;
...
F_5 ( V_5 ) ;
if ( ! F_3 ( V_66 ) )
return F_29 ( V_2 , V_4 , V_11 , V_12 , V_13 , V_14 ) ;
if ( ! F_3 ( V_10 ) )
return F_7 ( & V_11 , & V_12 , & V_13 , & V_14 ,
& V_5 -> V_16 . V_67 , 0 ,
- 1 ) ;
...
int F_30 ( struct V_1 * V_2 , const struct V_3 * V_4 ,
unsigned int V_11 , unsigned int V_12 ,
const void * V_13 , const void T_1 * V_14 )
{
struct V_5 * V_5 = & V_2 -> V_7 . V_5 ;
...
F_6 ( V_5 ) ;
if ( ! F_3 ( V_66 ) )
return F_31 ( V_2 , V_4 , V_11 , V_12 , V_13 , V_14 ) ;
if ( ! F_3 ( V_10 ) )
...
int F_32 ( struct V_69 * V_70 , struct V_71 * V_72 )
{
