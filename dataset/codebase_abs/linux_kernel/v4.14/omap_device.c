...
static int F_65 ( struct V_76 * V_9 )
{
struct V_22 * V_8 = F_25 ( V_9 ) ;
struct V_1 * V_2 = F_27 ( V_8 ) ;
if ( V_2 -> V_35 & V_78 ) {
...
int F_68 ( struct V_22 * V_8 , const char * V_39 )
{
struct V_1 * V_2 = F_27 ( V_8 ) ;
int V_29 = 0 ;
int V_17 ;
for ( V_17 = 0 ; V_17 < V_2 -> V_55 ; V_17 ++ ) {
V_29 = F_69 ( V_2 -> V_23 [ V_17 ] , V_39 ) ;
if ( V_29 )
break;
}
return V_29 ;
}
int F_70 ( struct V_22 * V_8 ,
const char * V_39 )
{
struct V_1 * V_2 = F_27 ( V_8 ) ;
int V_29 = 0 ;
...
struct V_76 * F_72 ( const char * V_27 )
{
struct V_15 * V_16 ;
if ( ! V_27 ) {
F_73 ( 1 , L_23 , V_67 ) ;
...
static int T_2 F_76 ( struct V_76 * V_9 , void * V_82 )
{
struct V_22 * V_8 = F_25 ( V_9 ) ;
struct V_1 * V_2 = F_27 ( V_8 ) ;
int V_17 ;
