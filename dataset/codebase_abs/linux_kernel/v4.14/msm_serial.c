...
F_1 ( V_2 , V_203 , V_165 ) ;
if ( V_11 -> V_12 ) {
F_15 ( V_11 , V_11 -> V_25 . V_209 ) ;
F_20 ( V_11 , V_11 -> V_25 . V_209 ) ;
}
V_32 = F_81 ( V_2 -> V_148 , F_65 , V_210 ,
V_11 -> V_205 , V_2 ) ;
if ( F_82 ( V_32 ) )
goto V_211;
return 0 ;
...
static void F_86 ( struct V_1 * V_2 , struct V_212 * V_213 ,
struct V_212 * V_177 )
{
struct V_11 * V_11 = F_8 ( V_2 ) ;
struct V_13 * V_14 = & V_11 -> V_26 ;
...
if ( V_14 -> V_19 )
F_9 ( V_2 , V_14 ) ;
V_172 = F_87 ( V_2 , V_213 , V_177 , 300 , 4000000 ) ;
V_172 = F_75 ( V_2 , V_172 , & V_76 ) ;
if ( F_88 ( V_213 ) )
F_89 ( V_213 , V_172 , V_172 ) ;
V_164 = F_3 ( V_2 , V_214 ) ;
V_164 &= ~ V_215 ;
if ( V_213 -> V_216 & V_217 ) {
if ( V_213 -> V_216 & V_218 )
V_164 |= V_219 ;
else if ( V_213 -> V_216 & V_220 )
V_164 |= V_221 ;
else
V_164 |= V_222 ;
}
V_164 &= ~ V_223 ;
switch ( V_213 -> V_216 & V_224 ) {
case V_225 :
V_164 |= V_226 ;
break;
case V_227 :
...
V_164 = F_3 ( V_2 , V_165 ) ;
V_164 &= ~ ( V_236 | V_166 ) ;
if ( V_213 -> V_216 & V_237 ) {
V_164 |= V_236 ;
V_164 |= V_166 ;
}
F_1 ( V_2 , V_164 , V_165 ) ;
V_2 -> V_113 = 0 ;
if ( V_213 -> V_238 & V_239 )
V_2 -> V_113 |= V_129 ;
if ( V_213 -> V_238 & ( V_240 | V_241 | V_242 ) )
V_2 -> V_113 |= V_114 ;
F_90 ( V_2 , V_213 -> V_216 , V_172 ) ;
F_45 ( V_11 ) ;
F_33 ( & V_2 -> V_77 , V_76 ) ;
}
...
{
struct V_243 * V_244 = F_93 ( V_2 -> V_16 ) ;
struct V_245 * V_246 ;
T_2 V_247 ;
V_246 = F_94 ( V_244 , V_248 , 0 ) ;
if ( F_82 ( ! V_246 ) )
return;
V_247 = F_95 ( V_246 ) ;
F_96 ( V_2 -> V_209 , V_247 ) ;
F_97 ( V_2 -> V_5 ) ;
V_2 -> V_5 = NULL ;
}
...
return - V_249 ;
V_247 = F_95 ( V_246 ) ;
if ( ! F_99 ( V_2 -> V_209 , V_247 , L_7 ) )
return - V_250 ;
V_2 -> V_5 = F_100 ( V_2 -> V_209 , V_247 ) ;
if ( ! V_2 -> V_5 ) {
V_32 = - V_250 ;
goto V_251;
}
...
static int F_102 ( struct V_1 * V_2 , struct V_254 * V_255 )
{
if ( F_82 ( V_255 -> type != V_256 && V_255 -> type != V_253 ) )
return - V_257 ;
if ( F_82 ( V_2 -> V_148 != V_255 -> V_148 ) )
return - V_257 ;
return 0 ;
}
...
{
struct V_11 * V_11 = F_8 ( V_2 ) ;
unsigned int V_259 = V_11 -> V_12 ? V_54 : V_128 ;
if ( ! ( F_3 ( V_2 , V_60 ) & V_126 ) )
return V_260 ;
return F_3 ( V_2 , V_259 ) & 0xff ;
}
...
static T_1 V_261 ;
static int V_18 ;
unsigned char * V_262 = ( unsigned char * ) & V_261 ;
if ( V_18 ) {
V_127 = V_262 [ sizeof( V_261 ) - V_18 ] ;
V_18 -- ;
} else if ( ! ( F_3 ( V_2 , V_60 ) & V_126 ) ) {
V_18 = F_3 ( V_2 , V_263 ) ;
V_18 = ( V_18 >> V_264 ) & V_265 ;
if ( V_18 ) {
F_1 ( V_2 , V_266 , V_65 ) ;
V_261 = F_3 ( V_2 , V_54 ) ;
V_127 = V_262 [ 0 ] ;
...
{
return & V_267 [ line ] . V_25 ;
}
static void F_111 ( struct V_1 * V_2 , const char * V_268 ,
...
static void F_112 ( struct V_272 * V_273 , const char * V_268 ,
unsigned int V_18 )
{
struct V_1 * V_2 ;
struct V_11 * V_11 ;
F_113 ( V_273 -> V_274 < 0 || V_273 -> V_274 >= V_275 ) ;
V_2 = F_110 ( V_273 -> V_274 ) ;
V_11 = F_8 ( V_2 ) ;
F_111 ( V_2 , V_268 , V_18 , V_11 -> V_12 ) ;
}
static int T_5 F_114 ( struct V_272 * V_273 , char * V_276 )
{
struct V_1 * V_2 ;
int V_172 = 115200 ;
int V_277 = 8 ;
int V_278 = 'n' ;
int V_279 = 'n' ;
if ( F_82 ( V_273 -> V_274 >= V_275 || V_273 -> V_274 < 0 ) )
return - V_249 ;
V_2 = F_110 ( V_273 -> V_274 ) ;
if ( F_82 ( ! V_2 -> V_5 ) )
return - V_249 ;
F_77 ( V_2 ) ;
if ( V_276 )
F_115 ( V_276 , & V_172 , & V_278 , & V_277 , & V_279 ) ;
F_116 ( L_9 , V_2 -> line ) ;
return F_117 ( V_2 , V_273 , V_172 , V_278 , V_277 , V_279 ) ;
}
static void
F_118 ( struct V_272 * V_280 , const char * V_268 , unsigned V_281 )
{
struct V_282 * V_16 = V_280 -> V_203 ;
F_111 ( & V_16 -> V_2 , V_268 , V_281 , false ) ;
}
static int T_5
F_119 ( struct V_282 * V_15 , const char * V_283 )
{
if ( ! V_15 -> V_2 . V_5 )
return - V_284 ;
V_15 -> V_280 -> V_285 = F_118 ;
return 0 ;
}
static void
F_120 ( struct V_272 * V_280 , const char * V_268 , unsigned V_281 )
{
struct V_282 * V_16 = V_280 -> V_203 ;
F_111 ( & V_16 -> V_2 , V_268 , V_281 , true ) ;
}
static int T_5
F_121 ( struct V_282 * V_15 ,
const char * V_283 )
{
if ( ! V_15 -> V_2 . V_5 )
return - V_284 ;
V_15 -> V_280 -> V_285 = F_120 ;
return 0 ;
}
static int F_122 ( struct V_243 * V_244 )
{
struct V_11 * V_11 ;
struct V_245 * V_245 ;
struct V_1 * V_2 ;
...
int V_148 , line ;
if ( V_244 -> V_16 . V_34 )
line = F_123 ( V_244 -> V_16 . V_34 , L_10 ) ;
else
line = V_244 -> V_287 ;
if ( line < 0 )
line = F_124 ( & V_288 ) - 1 ;
if ( F_82 ( line < 0 || line >= V_275 ) )
return - V_249 ;
F_125 ( & V_244 -> V_16 , L_11 , line ) ;
V_2 = F_110 ( line ) ;
V_2 -> V_16 = & V_244 -> V_16 ;
V_11 = F_8 ( V_2 ) ;
V_287 = F_126 ( V_289 , & V_244 -> V_16 ) ;
if ( V_287 )
V_11 -> V_12 = ( unsigned long ) V_287 -> V_203 ;
else
V_11 -> V_12 = 0 ;
V_11 -> V_186 = F_127 ( & V_244 -> V_16 , L_12 ) ;
if ( F_17 ( V_11 -> V_186 ) )
return F_128 ( V_11 -> V_186 ) ;
if ( V_11 -> V_12 ) {
V_11 -> V_202 = F_127 ( & V_244 -> V_16 , L_13 ) ;
if ( F_17 ( V_11 -> V_202 ) )
return F_128 ( V_11 -> V_202 ) ;
}
V_2 -> V_10 = F_129 ( V_11 -> V_186 ) ;
F_125 ( & V_244 -> V_16 , L_14 , V_2 -> V_10 ) ;
V_245 = F_94 ( V_244 , V_248 , 0 ) ;
if ( F_82 ( ! V_245 ) )
return - V_249 ;
V_2 -> V_209 = V_245 -> V_290 ;
V_148 = F_130 ( V_244 , 0 ) ;
if ( F_82 ( V_148 < 0 ) )
return - V_249 ;
V_2 -> V_148 = V_148 ;
F_131 ( V_244 , V_2 ) ;
return F_132 ( & V_291 , V_2 ) ;
}
static int F_133 ( struct V_243 * V_244 )
{
struct V_1 * V_2 = F_134 ( V_244 ) ;
F_135 ( & V_291 , V_2 ) ;
return 0 ;
}
