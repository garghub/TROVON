...
static void F_20 ( struct V_1 * V_2 , char * V_56 ,
struct V_57 * V_58 )
{
int V_59 ;
...
V_9 = F_22 ( V_70 -> V_35 . V_9 ) ;
if ( ( F_23 ( V_9 ) == 0 ) && ( F_24 ( V_9 ) == 0 ) ) {
F_25 ( V_37 , V_70 -> V_35 . V_36 ) ;
F_25 ( V_45 , V_70 -> V_35 . V_39 ) ;
} else if ( ( F_23 ( V_9 ) == 0 ) &&
( F_24 ( V_9 ) == 1 ) ) {
F_25 ( V_37 , V_70 -> V_35 . V_36 ) ;
F_25 ( V_45 , V_70 -> V_35 . V_35 ) ;
} else if ( ( F_23 ( V_9 ) == 1 ) &&
( F_24 ( V_9 ) == 0 ) ) {
F_25 ( V_37 , V_70 -> V_35 . V_35 ) ;
F_25 ( V_45 , V_70 -> V_35 . V_39 ) ;
} else {
V_69 = V_73 ;
if ( V_68 < V_73 - V_71 ) {
...
V_68 -= ( V_73 - V_71 ) ;
F_25 ( V_37 , V_70 -> V_74 . V_35 ) ;
F_25 ( V_45 , V_70 -> V_74 . V_74 ) ;
}
if ( ( V_2 -> V_46 & V_47 ) &&
F_26 ( V_9 ) &&
( V_2 -> V_46 & V_75 ) ) {
...
V_5 -> V_80 = F_30 ( V_5 , V_40 ) ;
if ( V_2 -> V_60 )
F_20 ( V_2 , F_31 ( V_5 ) -> V_81 ,
F_32 ( V_5 ) ) ;
F_33 ( V_5 ) ;
return 0 ;
}
