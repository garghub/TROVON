...
if ( ! strcmp ( V_24 -> V_56 . V_15 -> V_57 . V_58 ,
V_21 ) ) {
F_3 ( V_45 , & V_4 , 0 ) ;
F_2 ( & V_4 , 0 ) ;
V_50 = V_5 ;
...
V_52 -> V_60 . V_61 . V_62 . V_63 =
V_64 ;
V_52 -> V_60 . V_61 . V_62 . type = V_65 ;
memset ( V_52 -> V_60 . V_61 . V_62 . V_66 ,
0 ,
V_19 ) ;
sprintf ( V_52 -> V_60 . V_61 . V_62 . V_66 ,
L_29 ,
V_54 . V_67 ,
V_54 . V_68 ) ;
V_2 = F_31 ( V_52 ,
...
V_78 = F_35 ( V_77 , sizeof( * V_78 ) , V_20 ) ;
if ( ! V_78 ) {
V_2 = - V_3 ;
goto V_9;
}
...
( unsigned long long * ) & ( V_78 [ V_71 ] . V_68 ) ) ;
...
F_37 ( V_90 , L_39 , V_87 ) ;
F_37 ( V_90 , V_94 [ V_71 ] . V_79 , V_87 ) ;
V_89 = F_37 ( V_90 , L_6 , V_87 ) ;
}
if ( V_89 >= V_87 ) {
F_26 ( V_90 ) ;
goto V_9;
...
strcpy ( V_5 , L_40 ) ;
V_9:
F_8 ( V_76 , L_41 , V_7 , V_50 ) ;
return;
}
static void F_40 ( void * V_98 , int V_99 )
{
T_5 * V_95 = ( T_5 * ) V_98 ;
if ( F_41 ( ( char * ) V_94 [ V_99 ] . V_79 ) )
goto V_9;
...
static void F_39 ( void * V_54 , int V_99 )
{
struct V_53 * V_95 = (struct V_53 * ) V_54 ;
if ( F_41 ( V_78 [ V_99 ] . V_79 ) )
goto V_9;
if ( ( V_95 -> V_67 & V_78 [ V_99 ] . V_67 ) ||
( V_95 -> V_68 & V_78 [ V_99 ] . V_68 ) ) {
if ( ( strlen ( V_38 ) +
...
static int F_38 ( void * V_95 , int type )
{
T_5 * V_98 ;
struct V_53 * V_54 ;
int V_101 = V_93 - 1 ;
...
if ( ( V_54 -> V_67 == V_78 [ V_83 ] . V_67 ) &&
( V_54 -> V_68 == V_78 [ V_83 ] . V_68 ) ) {
strcpy ( V_38 , V_82 ) ;
V_2 = 1 ;
goto V_9;
}
if ( ( V_54 -> V_67 == V_78 [ V_81 ] . V_67 ) &&
( V_54 -> V_68 == V_78 [ V_81 ] . V_68 ) ) {
strcpy ( V_38 , V_80 ) ;
V_2 = 1 ;
goto V_9;
}
...
static void F_45 ( int V_71 , char * V_102 ,
struct V_53 * * V_105 )
{
if ( ! strcmp ( V_78 [ V_71 ] . V_79 , V_102 ) ) {
( * * V_105 ) . V_67 = ( * * V_105 ) . V_67 | V_78 [ V_71 ] . V_67 ;
( * * V_105 ) . V_68 = ( * * V_105 ) . V_68 | V_78 [ V_71 ] . V_68 ;
}
}
static void F_46 ( int V_71 , char * V_102 , T_5 * * V_105 )
{
if ( ! strcmp ( V_94 [ V_71 ] . V_79 , V_102 ) )
* * V_105 = ( * * V_105 ) |
V_94 [ V_71 ] . V_100 ;
}
int F_47 ( void T_3 * V_106 )
{
...
if ( V_16 != 0 )
return - V_109 ;
V_53 . V_67 = V_108 . V_110 ;
V_53 . V_68 = V_108 . V_111 ;
F_4 ( L_44
L_45 ,
V_7 ,
( unsigned long long ) V_53 . V_67 ,
( unsigned long long ) V_53 . V_68 ) ;
return V_16 ;
}
