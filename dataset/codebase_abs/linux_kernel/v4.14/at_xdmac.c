...
if ( ! V_2 ) {
F_44 ( & V_233 -> V_11 , L_61 ) ;
return - V_250 ;
}
V_2 -> V_4 = V_245 ;
V_2 -> V_211 = V_211 ;
V_2 -> V_241 = F_121 ( & V_233 -> V_11 , L_62 ) ;
if ( F_116 ( V_2 -> V_241 ) ) {
F_44 ( & V_233 -> V_11 , L_63 ) ;
return F_117 ( V_2 -> V_241 ) ;
}
V_120 = F_122 ( V_2 -> V_211 , F_92 , 0 , L_64 , V_2 ) ;
if ( V_120 ) {
...
F_43 , V_2 ) ;
if ( V_120 ) {
F_44 ( & V_233 -> V_11 , L_69 ) ;
goto V_285;
}
F_132 ( & V_233 -> V_11 , L_70 ,
V_244 , V_2 -> V_4 ) ;
return 0 ;
V_285:
F_133 ( & V_2 -> V_14 ) ;
