...
if ( V_87 )
return 0 ;
V_124 = F_56 ( V_5 -> V_57 , V_125 ) ;
V_123 = V_124 ;
V_124 = F_56 ( V_5 -> V_57 , V_126 ) ;
V_123 |= ( ( T_4 ) V_124 << 32 ) ;
...
V_43 * V_2 -> V_4 . V_29 ) ;
V_119 = F_57 ( & V_2 -> V_99 , struct V_32 ,
V_99 ) ;
if ( V_33 == V_119 )
V_118 = true ;
if ( V_116 && ! V_118 ) {
...
static int F_59 ( struct V_1 * V_2 , T_1 V_129 )
{
struct V_5 * V_5 ;
int V_87 ;
V_5 = V_2 -> V_5 ;
...
F_2 ( V_5 -> V_8 , L_43 , V_134 ) ;
F_22 ( V_5 -> V_57 , V_135 , V_134 ) ;
return 0 ;
}
static void F_64 ( struct V_5 * V_5 , struct V_1 * V_2 ,
struct V_143 * V_144 )
{
...
V_99 ) ;
V_85 = & V_33 -> V_85 ;
V_151 = F_66 ( F_67 ( V_144 -> V_18 [ 3 ] ) ) ;
if ( V_151 == V_153 && V_85 -> V_79 > 1 ) {
V_124 = F_67 ( V_144 -> V_18 [ 0 ] ) ;
V_123 = V_124 ;
V_124 = F_67 ( V_144 -> V_18 [ 1 ] ) ;
V_123 |= ( ( T_4 ) V_124 << 32 ) ;
V_145 = F_14 ( V_2 , V_123 ) ;
if ( F_15 ( V_145 < 0 ) )
F_46 ( V_5 -> V_8 , L_46 ) ;
V_89 = V_85 -> V_89 ;
if ( V_89 <= V_145 ) {
...
V_149 = F_67 ( V_150 -> V_18 [ 2 ] ) & 0x1FFFFF ;
V_149 -= F_68 ( F_67 ( V_144 -> V_18 [ 2 ] ) ) ;
V_148 += V_149 ;
V_33 -> V_36 . V_111 = V_148 ;
} else {
V_33 -> V_36 . V_111 = V_33 -> V_36 . V_37 -
F_68 ( F_67 ( V_144 -> V_18 [ 2 ] ) ) ;
F_2 ( V_5 -> V_8 ,
L_47 ,
...
void F_69 ( struct V_5 * V_5 , struct V_143 * V_144 )
{
struct V_156 * V_67 ;
T_1 V_157 ;
F_2 ( V_5 -> V_8 ,
...
static int F_71 ( struct V_5 * V_5 , struct V_156 * V_158 )
{
...
static int F_74 ( struct V_5 * V_5 , T_3 V_61 ,
...
case V_189 :
return F_74 ( V_5 , V_61 , V_165 , V_166 ) ;
case V_190 :
F_2 ( V_5 -> V_8 , L_61 ) ;
if ( V_61 != V_191 )
return - V_45 ;
...
F_2 ( V_5 -> V_8 , L_71 , V_197 ) ;
* ( V_198 * ) V_5 -> V_199 = F_78 ( V_197 ) ;
V_5 -> V_114 . V_36 . V_37 = 2 ;
V_5 -> V_114 . V_36 . V_200 = & V_5 -> V_199 ;
F_53 ( V_5 ) ;
return 0 ;
}
static void F_79 ( struct V_103 * V_201 , struct V_202 * V_203 )
{
}
...
case V_213 :
F_2 ( V_5 -> V_8 , L_76 ) ;
V_87 = F_76 ( V_5 , V_67 , 1 ) ;
break;
case V_214 :
F_2 ( V_5 -> V_8 , L_77 ) ;
V_87 = F_76 ( V_5 , V_67 , 0 ) ;
break;
case V_215 :
F_2 ( V_5 -> V_8 , L_78 ) ;
V_87 = F_77 ( V_5 , V_67 ) ;
...
if ( V_205 ) {
F_38 ( & V_5 -> V_102 ) ;
V_87 = V_5 -> V_218 -> V_219 ( & V_5 -> V_71 , V_67 ) ;
F_40 ( & V_5 -> V_102 ) ;
}
return V_87 ;
}
void F_83 ( struct V_5 * V_5 , struct V_143 * V_144 )
{
struct V_1 * V_2 ;
int V_87 = 0 ;
F_2 ( V_5 -> V_8 , L_31 , V_9 ) ;
...
static void F_85 ( struct V_5 * V_5 , struct V_143 * V_144 )
{
F_2 ( V_5 -> V_8 , L_31 , V_9 ) ;
switch ( V_5 -> V_64 ) {
case V_204 :
...
void F_86 ( struct V_5 * V_5 , struct V_143 * V_144 )
{
struct V_1 * V_2 ;
T_1 V_151 ;
T_5 V_94 ;
V_94 = ( F_67 ( V_144 -> V_18 [ 3 ] ) >> 4 ) & 0x1f ;
V_2 = V_5 -> V_54 [ V_94 ] ;
...
V_5 -> V_228 [ V_151 - V_225 ] ( V_5 , V_144 ) ;
break;
case V_229 :
if ( V_94 == 1 ) {
F_2 ( V_5 -> V_8 , L_93 ,
...
break;
default:
F_46 ( V_5 -> V_8 , L_95 , V_151 ) ;
break;
}
}
static int F_88 ( struct V_103 * V_201 ,
struct V_202 * V_203 , T_6 V_230 )
{
struct V_32 * V_33 ;
unsigned long V_55 ;
struct V_1 * V_2 ;
...
if ( ! V_201 || ! V_201 -> V_20 )
return - V_105 ;
if ( ! V_203 || ! V_203 -> V_101 || ! V_203 -> V_200 )
return - V_45 ;
V_2 = F_89 ( V_201 ) ;
V_33 = F_90 ( V_203 ) ;
V_5 = V_2 -> V_5 ;
...
F_2 ( V_5 -> V_8 , L_97 ,
V_203 , V_2 -> V_10 , V_203 -> V_37 , V_203 -> V_231 ) ;
if ( ! V_2 -> V_103 . V_20 ) {
F_46 ( V_5 -> V_8 ,
L_98 ,
V_203 , V_2 -> V_10 ) ;
...
static int F_93 ( struct V_103 * V_201 ,
struct V_202 * V_203 )
{
struct V_32 * V_33 ;
unsigned long V_55 ;
...
static int F_95 ( struct V_103 * V_201 , int V_129 )
{
unsigned long V_55 ;
struct V_1 * V_2 ;
struct V_5 * V_5 ;
...
static struct V_202 * F_96 ( struct V_103 * V_201 ,
T_6 V_230 )
{
struct V_32 * V_33 ;
struct V_1 * V_2 ;
V_33 = F_11 ( sizeof( * V_33 ) , V_230 ) ;
if ( ! V_33 )
return NULL ;
V_2 = F_89 ( V_201 ) ;
V_33 -> V_2 = V_2 ;
V_33 -> V_53 = V_2 -> V_94 ;
V_33 -> V_36 . V_13 = V_235 ;
F_2 ( V_2 -> V_5 -> V_8 , L_100 , V_9 , V_2 -> V_10 , V_33 ) ;
return & V_33 -> V_36 ;
}
static void F_97 ( struct V_103 * V_201 ,
struct V_202 * V_203 )
{
struct V_32 * V_33 ;
V_33 = F_90 ( V_203 ) ;
...
static int F_98 ( struct V_103 * V_201 ,
const struct V_236 * V_20 )
{
unsigned long V_55 ;
struct V_1 * V_2 ;
struct V_5 * V_5 ;
int V_87 ;
if ( ! V_201 || ! V_20 || V_20 -> V_237 != V_238 ) {
F_99 ( L_102 ) ;
return - V_45 ;
}
if ( ! V_20 -> V_239 ) {
...
static int F_100 ( struct V_103 * V_201 )
{
unsigned long V_55 ;
struct V_1 * V_2 ;
struct V_5 * V_5 ;
...
static int F_101 ( struct V_5 * V_5 , T_1 V_53 , T_1 V_63 )
{
struct V_1 * V_2 ;
F_2 ( V_5 -> V_8 , L_109 , V_9 , V_53 , V_63 ) ;
V_2 = F_11 ( sizeof( * V_2 ) , V_240 ) ;
if ( ! V_2 )
return - V_25 ;
V_2 -> V_5 = V_5 ;
V_2 -> V_63 = V_63 ;
if ( V_63 )
V_2 -> V_103 . V_241 . V_242 = true ;
else
V_2 -> V_103 . V_241 . V_243 = true ;
if ( V_53 == 1 ) {
V_2 -> V_94 = 1 ;
V_5 -> V_54 [ V_2 -> V_94 ] = V_2 ;
snprintf ( V_2 -> V_10 , sizeof( V_2 -> V_10 ) , L_110 , V_53 - 1 ) ;
F_102 ( & V_2 -> V_103 , V_244 ) ;
V_2 -> V_103 . V_241 . V_245 = true ;
V_2 -> V_106 = NULL ;
...
V_63 & 1 ? L_112 : L_113 ) ;
F_102 ( & V_2 -> V_103 , 1024 ) ;
V_2 -> V_103 . V_241 . V_246 = true ;
V_2 -> V_103 . V_241 . V_247 = true ;
V_2 -> V_103 . V_241 . V_248 = true ;
V_2 -> V_103 . V_249 = 0 ;
F_33 ( & V_2 -> V_103 . V_133 , & V_5 -> V_71 . V_133 ) ;
}
V_2 -> V_103 . V_250 = & V_251 ;
...
int F_104 ( struct V_5 * V_5 )
{
T_5 V_53 ;
int V_87 ;
F_2 ( V_5 -> V_8 , L_29 , V_9 ) ;
F_103 ( & V_5 -> V_71 . V_133 ) ;
V_87 = F_101 ( V_5 , 1 , 0 ) ;
if ( V_87 ) {
