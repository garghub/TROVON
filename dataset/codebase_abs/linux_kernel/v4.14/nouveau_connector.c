...
V_11 -> V_23 != V_165 -> V_23 ) ) {
V_167 = F_68 ( V_9 , V_11 -> V_22 , V_11 -> V_23 ,
F_3 ( V_165 ) , false ,
false , false ) ;
if ( ! V_167 )
continue;
...
static unsigned
F_75 ( struct V_2 * V_3 , bool V_182 )
{
struct V_86 * V_88 = V_86 ( V_3 ) ;
struct V_7 * V_8 = V_7 ( V_3 -> V_9 ) ;
...
break;
case V_112 :
V_182 = F_77 ( V_88 -> V_90 ) ;
V_191 = F_75 ( V_3 , V_182 ) ;
if ( ! V_182 && V_193 &&
V_77 -> V_85 -> V_194 )
V_191 *= 2 ;
break;
...
break;
case V_143 :
return F_64 ( V_87 ) -> V_17 ( V_87 , V_11 ) ;
case V_101 :
...
static int
F_80 ( struct V_205 * V_206 )
{
struct V_86 * V_88 =
F_81 ( V_206 , F_82 ( * V_88 ) , V_89 ) ;
...
static T_3
F_86 ( struct V_215 * V_216 , struct V_217 * V_218 )
{
struct V_86 * V_88 =
F_81 ( V_216 , F_82 ( * V_88 ) , V_91 ) ;
struct V_76 * V_77 ;
struct V_219 * V_91 ;
...
if ( V_102 )
return V_102 ;
V_102 = F_88 ( V_91 , false , V_218 -> V_222 , V_218 -> V_223 ,
V_218 -> V_224 , & V_220 ) ;
F_89 ( V_91 ) ;
if ( V_102 >= 0 ) {
V_218 -> V_225 = V_102 ;
...
struct V_2 *
F_91 ( struct V_10 * V_9 , int V_243 )
{
const struct V_244 * V_159 = & V_245 ;
struct V_7 * V_8 = V_7 ( V_9 ) ;
struct V_31 * V_32 = V_31 ( V_9 ) ;
...
V_3 = & V_88 -> V_69 ;
V_88 -> V_243 = V_243 ;
V_88 -> V_85 = F_93 ( V_9 , V_243 ) ;
if ( V_88 -> V_85 ) {
T_4 V_248 = F_94 ( V_88 -> V_85 [ 0 ] ) ;
if ( F_95 ( V_9 ) [ 3 ] >= 4 )
V_248 |= ( T_4 ) F_94 ( V_88 -> V_85 [ 2 ] ) << 16 ;
...
if ( F_97 ( V_9 , 0x0421 , 0x1458 , 0x344c ) ) {
if ( V_88 -> type == V_238 )
V_88 -> type = V_126 ;
}
if ( F_97 ( V_9 , 0x0402 , 0x1458 , 0x3455 ) ) {
if ( V_88 -> type == V_238 )
V_88 -> type = V_126 ;
}
} else {
...
if ( V_88 -> type == V_249 ) {
struct V_7 * V_8 = V_7 ( V_9 ) ;
struct V_250 * V_251 = & V_8 -> V_147 . V_85 ;
T_4 V_252 = 0 ;
int V_80 ;
for ( V_80 = 0 ; V_80 < V_251 -> V_253 ; V_80 ++ ) {
if ( V_251 -> V_248 [ V_80 ] . V_3 == V_88 -> V_243 )
V_252 |= ( 1 << V_251 -> V_248 [ V_80 ] . type ) ;
}
if ( V_252 & ( 1 << V_101 ) ) {
if ( V_252 & ( 1 << V_112 ) )
V_88 -> type = V_236 ;
...
switch ( ( type = F_90 ( V_88 -> type ) ) ) {
case V_54 :
V_102 = F_98 ( V_9 , 0 , & V_246 , & V_246 ) ;
if ( V_102 ) {
F_53 ( V_8 , L_12 ) ;
F_10 ( V_88 ) ;
return F_92 ( V_102 ) ;
...
V_102 = F_102 (&disp->disp, nouveau_connector_hotplug, true,
NV04_DISP_NTFY_CONN,
