...
static void F_9 ( struct V_1 * V_2 , unsigned long V_17 ,
unsigned long * V_3 ,
...
static long F_13 ( struct V_1 * V_2 , unsigned long V_17 ,
unsigned long * V_3 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
unsigned long V_7 , V_8 ;
...
return * V_3 ;
if ( V_5 -> V_21 )
V_5 -> V_21 ( V_2 , V_17 , V_3 , & V_7 , & V_8 ) ;
else
F_9 ( V_2 , V_17 , V_3 , & V_7 , & V_8 ) ;
V_10 = ( T_2 ) * V_3 * V_7 ;
F_8 ( V_10 , V_8 ) ;
return V_10 ;
}
static int F_14 ( struct V_1 * V_2 , unsigned long V_17 ,
unsigned long V_3 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
unsigned long V_6 = 0 ;
...
struct V_1 * F_16 ( struct V_22 * V_23 ,
...
struct V_36 * F_21 ( struct V_22 * V_23 ,
const char * V_24 , const char * V_25 , unsigned long V_6 ,
void T_3 * V_12 , T_4 V_14 , T_4 V_20 , T_4 V_16 , T_4 V_19 ,
T_4 V_26 , T_5 * V_11 )
{
struct V_1 * V_2 ;
V_2 = F_16 ( V_23 , V_24 , V_25 , V_6 ,
V_12 , V_14 , V_20 , V_16 , V_19 , V_26 ,
V_11 ) ;
if ( F_22 ( V_2 ) )
return F_23 ( V_2 ) ;
return V_2 -> V_36 ;
