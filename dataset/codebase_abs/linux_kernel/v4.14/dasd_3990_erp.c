...
static struct V_1 *
F_37 ( struct V_1 * V_59 , char * V_48 )
{
struct V_9 * V_10 = V_59 -> V_11 ;
F_12 ( & V_10 -> V_15 -> V_21 ,
L_211 ) ;
return F_1 ( V_59 , V_30 ) ;
}
static struct V_1 *
...
static struct V_1 *
F_39 ( struct V_1 * V_59 , char * V_48 )
{
struct V_9 * V_10 = V_59 -> V_11 ;
if ( ! F_22 ( V_60 , & V_59 -> V_12 ) )
F_12 ( & V_10 -> V_15 -> V_21 ,
L_213 ) ;
return F_1 ( V_59 , V_30 ) ;
}
...
if ( ! F_22 ( V_63 , & V_4 -> V_11 -> V_12 ) && V_48
...
if ( ( V_67 == NULL ) && ( V_48 [ 0 ] & V_68 ) ) {
V_67 = F_28 ( V_2 , V_48 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 0 ] & V_69 ) ) {
V_67 = F_11 ( V_2 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 0 ] & V_70 ) ) {
V_67 = F_29 ( V_2 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 0 ] & V_71 ) ) {
V_67 = F_30 ( V_2 , V_48 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 0 ] & V_72 ) ) {
V_67 = F_32 ( V_2 , V_48 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 0 ] & V_73 ) ) {
V_67 = F_35 ( V_2 , V_48 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 1 ] & V_74 ) ) {
V_67 = F_36 ( V_2 , V_48 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 1 ] & V_75 ) ) {
V_67 = F_37 ( V_2 , V_48 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 2 ] & V_54 ) ) {
V_67 = F_38 ( V_2 , V_48 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 1 ] & V_76 ) ) {
V_67 = F_39 ( V_2 , V_48 ) ;
}
if ( ( V_67 == NULL ) && ( V_48 [ 1 ] & V_77 ) ) {
V_67 = F_40 ( V_2 ) ;
}
if ( V_67 == NULL ) {
V_67 = V_2 ;
...
static struct V_1 *
F_49 ( struct V_1 * V_59 , char * V_48 )
{
struct V_9 * V_10 = V_59 -> V_11 ;
V_44 V_78 = 0 ;
struct V_1 * V_4 ;
...
V_78 = V_59 -> V_5 -> V_24 . V_85 . V_86 . V_78 ;
if ( V_78 == 0 ) {
F_4 ( V_29 , V_10 , L_8 ,
L_222
L_223 ) ;
...
memcpy ( V_80 , V_4 -> V_37 , sizeof( struct V_79 ) ) ;
V_83 = V_2 -> V_37 + sizeof( struct V_79 ) ;
if ( ( V_48 [ 3 ] == 0x01 ) && ( V_83 [ 1 ] & 0x01 ) ) {
return F_1 ( V_59 , V_30 ) ;
}
if ( ( V_48 [ 7 ] & 0x3F ) == 0x01 ) {
V_83 [ 0 ] = 0x81 ;
...
V_83 [ 5 ] = V_48 [ 30 ] ;
V_83 [ 7 ] = V_48 [ 31 ] ;
memcpy ( & ( V_83 [ 8 ] ) , & ( V_48 [ 11 ] ) , 8 ) ;
V_34 = V_2 -> V_39 ;
memset ( V_34 , 0 , sizeof( struct V_33 ) ) ;
V_34 -> V_40 = V_90 ;
V_34 -> V_12 = V_91 ;
V_34 -> V_42 = 16 ;
V_34 -> V_43 = ( V_44 ) ( V_45 ) V_80 ;
V_34 ++ ;
memset ( V_34 , 0 , sizeof( struct V_33 ) ) ;
V_34 -> V_40 = V_92 ;
V_34 -> V_12 = V_91 ;
V_34 -> V_42 = 16 ;
V_34 -> V_43 = ( V_44 ) ( V_45 ) V_83 ;
V_34 ++ ;
V_34 -> V_40 = V_93 ;
V_34 -> V_43 = V_78 ;
V_2 -> V_12 = V_59 -> V_12 ;
...
static struct V_1 *
F_51 ( struct V_1 * V_94 , char * V_48 )
{
...
{
if ( ( V_48 [ 24 ] & V_99 ) || ( V_48 [ 1 ] & 0x10 ) ) {
F_12 ( & V_10 -> V_15 -> V_21 , L_229
L_230 , V_48 [ 22 ] ,
V_48 [ 23 ] , V_48 [ 11 ] , V_48 [ 12 ] ) ;
} else if ( V_48 [ 24 ] & V_100 ) {
...
F_12 ( & V_10 -> V_15 -> V_21 ,
L_244 ,
V_10 -> V_105 [ V_104 ] . V_106 , V_10 -> V_105 [ V_104 ] . V_107 , V_28 ) ;
F_62 ( V_10 , V_28 ) ;
F_63 ( V_10 , V_28 ) ;
V_10 -> V_105 [ V_104 ] . V_108 = 0 ;
F_64 ( & V_10 -> V_105 [ V_104 ] . V_109 , 0 ) ;
}
static void F_65 ( struct V_1 * V_2 )
{
struct V_9 * V_10 = V_2 -> V_11 ;
T_1 V_28 = V_2 -> V_5 -> V_24 . V_25 . V_110 . V_28 ;
int V_104 = F_61 ( V_28 ) ;
unsigned long V_111 ;
if ( ! V_10 -> V_112 )
return;
V_111 = F_19 () ;
if ( ( F_66 ( V_111 - V_10 -> V_105 [ V_104 ] . V_108 ) / V_113 )
>= V_10 -> V_114 ) {
F_64 ( & V_10 -> V_105 [ V_104 ] . V_109 , 0 ) ;
V_10 -> V_105 [ V_104 ] . V_108 = 0 ;
}
F_67 ( & V_10 -> V_105 [ V_104 ] . V_109 ) ;
V_10 -> V_105 [ V_104 ] . V_108 = V_111 ;
if ( F_68 ( & V_10 -> V_105 [ V_104 ] . V_109 ) >=
V_10 -> V_112 )
F_60 ( V_10 , V_28 ) ;
}
static struct V_1 *
...
{
struct V_9 * V_10 = V_2 -> V_11 ;
if ( F_70 ( & V_2 -> V_5 -> V_24 . V_85 ) & ( V_115
| V_116 ) ) {
F_4 ( V_29 , V_10 , L_8 ,
L_245 ) ;
F_65 ( V_2 ) ;
...
if ( V_4 -> V_122 == 1 ) {
V_118 = 0 ;
V_119 = 64 + sizeof( struct V_120 ) + sizeof( struct V_121 ) ;
} else {
V_118 = 2 ;
V_119 = 0 ;
}
...
V_120 = V_2 -> V_39 ;
V_121 = (struct V_121 * ) & V_120 [ 1 ] ;
* V_120 = * ( (struct V_120 * ) V_4 -> V_39 ) ;
V_120 -> V_121 = ( long ) V_121 ;
} else if ( V_34 -> V_40 == V_124 ) {
V_2 -> V_39 = V_4 -> V_39 ;
} else {
V_34 = V_2 -> V_39 ;
V_34 -> V_40 = V_125 ;
...
static int F_75 ( struct V_1 * V_126 ,
struct V_1 * V_127 )
{
char * V_128 , * V_129 ;
...
V_129 = F_42 ( & V_127 -> V_24 ) ;
if ( ! V_128 != ! V_129 )
return 0 ;
if ( ! V_128 && ! V_129 ) {
if ( ( F_70 ( & V_126 -> V_24 . V_85 ) & ( V_115 |
V_116 ) ) ==
( F_70 ( & V_127 -> V_24 . V_85 ) & ( V_115 |
V_116 ) ) )
return 1 ;
}
if ( ! ( V_128 && V_129 &&
( memcmp ( V_128 , V_129 , 3 ) == 0 ) &&
( V_128 [ 27 ] == V_129 [ 27 ] ) &&
( V_128 [ 25 ] == V_129 [ 25 ] ) ) ) {
return 0 ;
}
...
do {
V_132 = F_75 ( V_130 , V_4 -> V_5 ) ;
V_131 = V_4 ;
V_4 = V_4 -> V_5 ;
} while ( ( V_4 -> V_5 != NULL ) && ( ! V_132 ) );
if ( ! V_132 ) {
return NULL ;
}
return V_131 ;
...
static struct V_1 *
F_78 ( struct V_1 * V_130 ,
struct V_1 * V_2 )
{
struct V_9 * V_10 = V_130 -> V_11 ;
struct V_1 * V_133 = V_130 ;
