...
V_83 -> V_7 . V_90 = F_19 ;
V_83 -> V_7 . V_91 = F_15 ;
V_84 = F_27 ( V_7 -> V_34 , V_50 , F_28 ( V_81 ) ,
V_92 ,
V_93 | V_94 , 0 ) ;
return V_84 ;
}
...
int V_32 ;
T_1 V_99 ;
V_7 = F_30 ( sizeof( * V_7 ) , V_100 ) ;
if ( V_7 == NULL )
return - V_86 ;
V_7 -> V_34 = & V_96 -> V_34 ;
V_77 = F_31 ( V_96 ) ;
if ( V_77 ) {
F_32 ( & V_96 -> V_34 , L_4 , V_57 ) ;
goto V_101;
}
V_77 = F_33 ( V_96 , V_102 ) ;
if ( V_77 ) {
F_32 ( & V_96 -> V_34 , L_5 , V_77 ) ;
goto V_103;
}
V_7 -> V_43 = F_34 ( V_96 , 1 , 0 ) ;
if ( ! V_7 -> V_43 ) {
F_32 ( & V_96 -> V_34 , L_6 , V_57 ) ;
V_77 = - V_86 ;
goto V_104;
}
if ( V_96 -> V_105 == 0x8803 )
V_7 -> V_15 = V_25 ;
else if ( V_96 -> V_105 == 0x8014 )
V_7 -> V_15 = V_106 ;
else if ( V_96 -> V_105 == 0x8043 )
V_7 -> V_15 = V_28 ;
V_7 -> V_10 = V_7 -> V_43 ;
F_35 ( V_96 , V_7 ) ;
F_36 ( & V_7 -> V_9 ) ;
...
V_7 -> V_32 = V_32 ;
V_99 = ( 1 << V_14 [ V_7 -> V_15 ] ) - 1 ;
F_5 ( V_99 , & V_7 -> V_10 -> V_20 ) ;
F_5 ( V_99 , & V_7 -> V_10 -> V_18 ) ;
V_77 = F_41 ( & V_96 -> V_34 , V_96 -> V_56 , F_22 ,
V_111 , V_102 , V_7 ) ;
if ( V_77 != 0 ) {
F_32 ( & V_96 -> V_34 ,
L_9 , V_57 ) ;
...
V_101:
F_46 ( V_7 ) ;
F_32 ( & V_96 -> V_34 , L_10 , V_57 , V_77 ) ;
return V_77 ;
}
static void F_47 ( struct V_95 * V_96 )
{
struct V_6 * V_7 = F_48 ( V_96 ) ;
F_42 ( & V_7 -> V_2 ) ;
F_43 ( V_96 , V_7 -> V_43 ) ;
F_44 ( V_96 ) ;
F_45 ( V_96 ) ;
...
static int F_49 ( struct V_95 * V_96 , T_5 V_113 )
{
T_4 V_77 ;
struct V_6 * V_7 = F_48 ( V_96 ) ;
unsigned long V_8 ;
...
V_77 = F_50 ( V_96 ) ;
if ( V_77 ) {
F_32 ( & V_96 -> V_34 , L_11 , V_77 ) ;
return V_77 ;
}
F_45 ( V_96 ) ;
F_51 ( V_96 , V_114 ) ;
V_77 = F_52 ( V_96 , V_114 , 1 ) ;
if ( V_77 )
F_32 ( & V_96 -> V_34 , L_12 , V_77 ) ;
return 0 ;
}
...
struct V_6 * V_7 = F_48 ( V_96 ) ;
unsigned long V_8 ;
V_77 = F_52 ( V_96 , V_114 , 0 ) ;
F_51 ( V_96 , V_114 ) ;
V_77 = F_31 ( V_96 ) ;
if ( V_77 ) {
F_32 ( & V_96 -> V_34 , L_13 , V_77 ) ;
return V_77 ;
}
F_54 ( V_96 ) ;
F_3 ( & V_7 -> V_9 , V_8 ) ;
F_5 ( 0x01 , & V_7 -> V_10 -> V_115 ) ;
F_5 ( 0x00 , & V_7 -> V_10 -> V_115 ) ;
F_11 ( V_7 ) ;
F_6 ( & V_7 -> V_9 , V_8 ) ;
return 0 ;
}
