...
static int F_33 ( struct V_23 * V_53 ,
...
{
unsigned long V_63 = F_27 ( F_44 () ) ;
F_4 ( F_45 ( V_63 ) ,
V_8 + V_64 ) ;
}
static void F_46 ( const struct V_19 * V_20 ,
unsigned int V_1 )
{
int V_48 ;
...
static int F_52 ( unsigned int V_48 )
{
F_43 () ;
F_42 () ;
F_49 () ;
...
static int F_53 ( unsigned int V_48 )
{
F_43 () ;
F_49 () ;
F_54 ( V_67 , V_68 ) ;
...
static void F_55 ( struct V_69 * V_70 , bool V_71 )
{
T_3 V_72 , V_73 ;
V_72 = F_56 ( V_8 +
V_61 )
...
static void F_55 ( struct V_69 * V_75 , bool V_76 ) {}
...
V_81 = F_56 ( V_8 + V_85 ) ;
V_63 = F_27 ( F_44 () ) ;
F_64 (irqn, &irqmap, BITS_PER_LONG) {
V_83 = F_56 ( V_6 +
F_29 ( V_82 ) ) ;
if ( ! ( V_83 & F_65 ( V_63 ) ) )
continue;
...
static int T_5 F_73 ( struct V_35 * V_36 ,
struct V_35 * V_95 )
{
struct V_96 V_97 , V_98 ;
int V_26 , V_27 ;
T_3 V_59 ;
F_74 ( F_75 ( V_36 , 0 , & V_97 ) ) ;
F_74 ( F_75 ( V_36 , 1 , & V_98 ) ) ;
F_74 ( ! F_76 ( V_97 . V_99 ,
F_77 ( & V_97 ) ,
V_36 -> V_100 ) ) ;
F_74 ( ! F_76 ( V_98 . V_99 ,
