...
struct V_133 * V_48 ;
struct V_134 * V_135 ;
if ( ( V_18 -> V_3 -> V_15 == V_3 -> V_15 ) || ! V_3 -> V_15 )
return 0 ;
V_48 = F_47 ( & F_24 ( V_3 -> V_15 , 0 ) -> V_22 ) ;
V_135 = F_48 ( V_48 -> V_136 ) ;
F_49 ( V_3 , V_135 ) ;
return 0 ;
}
...
struct V_17 * F_56 ( struct V_143 * V_28 ,
enum V_144 type )
{
...
int V_87 = 0 ;
unsigned V_6 ;
V_145 = F_57 ( V_28 -> V_28 , sizeof( * V_145 ) ,
V_20 ) ;
if ( ! V_145 )
return F_58 ( - V_148 ) ;
for ( V_6 = 0 ; V_6 < F_3 ( V_7 ) ; V_6 ++ ) {
if ( type != V_67 ||
V_7 [ V_6 ] . V_31 < V_149 ) {
V_146 [ V_147 ++ ] = V_7 [ V_6 ] . V_8 ;
}
}
V_18 = & V_145 -> V_22 ;
V_87 = F_59 ( V_28 , V_18 , 0 ,
& V_150 ,
V_146 , V_147 ,
NULL , type , NULL ) ;
F_60 ( V_18 , & V_151 ) ;
