...
static void F_41 ( struct V_18 * V_2 )
{
F_42 () ;
F_43 ( & V_2 -> V_43 , 1 ) ;
}
void F_44 ( struct V_18 * V_2 )
{
F_40 ( V_2 ) ;
F_45 ( & V_44 ) ;
F_41 ( V_2 ) ;
...
V_38 = F_64 ( V_2 , V_60 ? V_49 ( V_60 ) : V_59 -> V_80 ) ;
if ( V_38 )
goto V_81;
return 0 ;
V_81:
...
struct V_18 * F_71 ( struct V_58 * V_59 ,
struct V_1 * V_60 )
{
struct V_18 * V_2 ;
int V_38 ;
...
static void F_72 ( struct V_83 * V_62 )
{
struct V_18 * V_2 = F_73 ( V_62 , struct V_18 , V_62 ) ;
if ( V_2 -> V_59 -> V_84 ) {
V_2 -> V_59 -> V_84 ( V_2 ) ;
} else {
F_69 ( V_2 ) ;
...
static int F_76 ( struct V_18 * V_2 )
{
struct V_17 * V_25 ;
char * V_80 ;
int V_38 ;
...
if ( ! V_25 )
return 0 ;
V_80 = F_77 ( V_28 , L_15 , V_25 -> V_34 + 64 ) ;
if ( ! V_80 )
return - V_29 ;
V_38 = F_78 ( V_25 -> V_35 -> V_86 . V_60 ,
& V_25 -> V_35 -> V_86 ,
V_80 ) ;
F_18 ( V_80 ) ;
return V_38 ;
}
static void F_79 ( struct V_18 * V_2 )
{
struct V_17 * V_25 ;
char * V_80 ;
if ( ! F_60 ( V_2 , V_85 ) )
...
if ( ! V_25 )
return;
V_80 = F_77 ( V_28 , L_15 , V_25 -> V_34 ) ;
if ( ! V_80 )
return;
F_80 ( V_25 -> V_35 -> V_86 . V_60 , V_80 ) ;
F_18 ( V_80 ) ;
}
int F_81 ( struct V_18 * V_2 , unsigned long V_26 )
{
...
V_38 = 0 ;
F_83 ( L_16 ,
V_59 -> V_80 , V_59 -> V_89 , V_59 -> V_25 ,
V_59 -> V_90 , V_59 -> V_91 ,
V_2 -> V_2 ? V_49 ( V_2 -> V_2 ) : L_17 ,
V_2 -> V_20 -> V_34 ) ;
goto V_92;
V_76:
F_79 ( V_2 ) ;
...
int F_64 ( struct V_18 * V_2 , const char * V_80 )
{
F_18 ( V_2 -> V_82 ) ;
V_2 -> V_82 = F_89 ( V_80 , V_28 ) ;
return V_2 -> V_82 ? 0 : - V_29 ;
}
static int F_90 ( struct V_53 * V_53 , struct V_100 * V_101 )
{
...
V_103 = F_92 ( V_25 -> V_2 -> V_59 -> V_105 ) ;
if ( ! V_103 ) {
V_104 = - V_42 ;
goto V_106;
}
...
V_104 = V_101 -> V_107 -> V_108 ( V_53 , V_101 ) ;
else
V_104 = 0 ;
V_106:
F_38 ( V_25 ) ;
...
V_39 = F_106 ( L_20 , NULL ) ;
if ( ! V_39 ) {
V_38 = - V_29 ;
F_24 ( L_21 , V_38 ) ;
goto error;
}
V_38 = F_107 ( V_109 , L_18 , & V_110 ) ;
if ( V_38 < 0 )
goto error;
V_61 = true ;
F_22 ( L_22 ) ;
