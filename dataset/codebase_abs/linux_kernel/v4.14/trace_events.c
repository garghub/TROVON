...
static int
F_206 ( struct V_4 * V_13 , struct V_195 * V_196 )
{
int V_25 ;
V_25 = F_205 ( V_13 ) ;
if ( V_25 < 0 )
return V_25 ;
F_11 ( & V_13 -> V_108 , & V_197 ) ;
V_13 -> V_196 = V_196 ;
return 0 ;
}
static char * F_207 ( char * V_198 , struct V_199 * V_200 , int V_53 )
{
int V_201 ;
int V_202 ;
V_202 = snprintf ( V_198 , 0 , L_29 , V_200 -> V_203 ) ;
if ( V_53 < V_202 )
return NULL ;
snprintf ( V_198 , V_202 + 1 , L_29 , V_200 -> V_203 ) ;
...
for ( V_198 = V_13 -> V_155 ; * V_198 ; V_198 ++ ) {
if ( * V_198 == '\\' ) {
V_198 ++ ;
if ( ! * V_198 )
break;
...
void F_209 ( struct V_199 * * V_200 , int V_53 )
{
...
static void F_222 ( struct V_195 * V_196 )
{
...
static int F_228 ( struct V_220 * V_99 ,
...
static void F_231 ( struct V_223 * V_45 )
{
if ( V_45 -> V_74 )
...
static void
F_232 ( unsigned long V_224 , unsigned long V_225 ,
struct V_42 * V_43 , struct V_226 * V_227 ,
void * V_45 )
{
struct V_228 * V_229 = V_45 ;
struct V_223 * V_230 ;
void * * V_231 ;
V_231 = F_233 ( V_229 , V_224 ) ;
if ( ! V_231 || ! * V_231 )
return;
V_230 = * V_231 ;
F_231 ( V_230 ) ;
...
static void
F_234 ( unsigned long V_224 , unsigned long V_225 ,
struct V_42 * V_43 , struct V_226 * V_227 ,
void * V_45 )
{
struct V_228 * V_229 = V_45 ;
...
if ( ! V_230 -> V_232 )
return;
if ( V_230 -> V_74 == ! ( V_230 -> V_61 -> V_54 & V_83 ) )
return;
if ( V_230 -> V_232 != - 1 )
( V_230 -> V_232 ) -- ;
F_231 ( V_230 ) ;
...
static int
F_235 ( struct V_131 * V_132 , unsigned long V_224 ,
struct V_226 * V_227 , void * V_45 )
{
struct V_228 * V_229 = V_45 ;
struct V_223 * V_230 ;
void * * V_231 ;
...
return 0 ;
V_230 = * V_231 ;
F_124 ( V_132 , L_32 , ( void * ) V_224 ) ;
F_124 ( V_132 , L_33 ,
V_230 -> V_74 ? V_233 : V_234 ,
V_230 -> V_61 -> V_5 -> V_6 -> system ,
F_55 ( V_230 -> V_61 -> V_5 ) ) ;
if ( V_230 -> V_232 == - 1 )
F_143 ( V_132 , L_34 ) ;
else
F_124 ( V_132 , L_35 , V_230 -> V_232 ) ;
return 0 ;
}
static int
F_236 ( struct V_226 * V_227 , struct V_42 * V_43 ,
unsigned long V_224 , void * V_235 , void * * V_45 )
{
struct V_228 * V_229 = * V_45 ;
struct V_223 * V_230 = V_235 ;
int V_25 ;
if ( ! V_229 ) {
V_229 = F_237 () ;
if ( ! V_229 )
...
{
struct V_223 * V_230 = V_45 ;
V_230 -> V_236 -- ;
if ( ! V_230 -> V_236 ) {
F_51 ( V_230 -> V_61 , 0 , 1 ) ;
F_240 ( V_230 -> V_61 -> V_5 -> V_196 ) ;
F_91 ( V_230 ) ;
}
return 0 ;
}
static void
F_241 ( struct V_226 * V_227 , struct V_42 * V_43 ,
unsigned long V_224 , void * V_45 )
{
struct V_228 * V_229 = V_45 ;
struct V_223 * V_230 ;
if ( ! V_224 ) {
...
V_230 = F_243 ( V_229 , V_224 ) ;
if ( F_90 ( ! V_230 ) )
return;
if ( F_90 ( V_230 -> V_236 <= 0 ) )
return;
F_239 ( V_230 ) ;
}
static int
F_244 ( struct V_42 * V_43 , struct V_237 * V_238 ,
char * V_239 , char * V_91 , char * V_240 , int V_241 )
{
struct V_40 * V_61 ;
struct V_226 * V_227 ;
struct V_223 * V_45 ;
...
if ( ! V_241 || ! V_240 )
return - V_122 ;
system = F_108 ( & V_240 , L_3 ) ;
if ( ! V_240 )
return - V_122 ;
V_38 = F_108 ( & V_240 , L_3 ) ;
F_40 ( & V_75 ) ;
V_25 = - V_122 ;
V_61 = F_230 ( V_43 , system , V_38 ) ;
if ( ! V_61 )
goto V_148;
V_74 = strcmp ( V_91 , V_233 ) == 0 ;
if ( V_74 )
V_227 = V_240 ? & V_243 : & V_244 ;
else
V_227 = V_240 ? & V_245 : & V_246 ;
if ( V_239 [ 0 ] == '!' ) {
V_25 = F_245 ( V_239 + 1 , V_43 , V_227 ) ;
goto V_148;
}
V_25 = - V_22 ;
...
if ( ! V_240 )
goto V_247;
V_242 = F_108 ( & V_240 , L_3 ) ;
V_25 = - V_122 ;
if ( ! strlen ( V_242 ) )
goto V_175;
V_25 = F_246 ( V_242 , 0 , & V_45 -> V_232 ) ;
if ( V_25 )
goto V_175;
V_247:
V_25 = F_247 ( V_61 -> V_5 -> V_196 ) ;
if ( ! V_25 ) {
V_25 = - V_215 ;
goto V_175;
}
...
if ( V_25 < 0 )
goto V_138;
V_25 = F_248 ( V_239 , V_43 , V_227 , V_45 ) ;
if ( ! V_25 ) {
V_25 = - V_248 ;
goto V_249;
} else if ( V_25 < 0 )
...
static T_6 int F_255 ( char * V_252 )
{
F_256 ( V_253 , V_252 , V_254 ) ;
V_255 = true ;
V_256 = true ;
return 1 ;
}
...
{
V_20 = F_263 ( V_9 , V_264 ) ;
V_118 = F_263 ( V_40 , V_264 ) ;
return 0 ;
}
static T_6 void
F_264 ( struct V_42 * V_43 , bool V_265 )
{
char * V_125 = V_253 ;
char * V_266 ;
int V_25 ;
while ( true ) {
V_266 = F_108 ( & V_125 , L_48 ) ;
if ( ! V_266 )
break;
if ( * V_266 ) {
if ( V_265 )
F_107 ( V_43 , V_266 , 0 ) ;
V_25 = F_107 ( V_43 , V_266 , 1 ) ;
if ( V_25 )
F_195 ( L_49 , V_266 ) ;
}
if ( V_125 )
...
static T_6 void F_275 ( struct V_271 * V_272 )
{
F_100 ( & V_273 ) ;
F_276 ( & V_274 ) ;
F_277 ( 1 ) ;
...
static T_6 int F_280 ( void * V_276 )
{
void * V_277 ;
V_277 = F_153 ( 1234 , V_161 ) ;
if ( ! V_277 )
F_54 ( L_55 ) ;
F_281 ( F_275 ) ;
F_91 ( V_277 ) ;
...
static void T_6
F_292 ( unsigned long V_224 , unsigned long V_225 ,
...
F_293 () ;
V_28 = F_294 () ;
V_287 = F_53 ( & F_295 ( V_288 , V_28 ) ) ;
if ( V_287 != 1 )
goto V_148;
F_30 ( V_54 ) ;
V_38 = F_33 ( & V_58 , & V_289 ,
V_290 , sizeof( * V_59 ) ,
V_54 , V_56 ) ;
if ( ! V_38 )
goto V_148;
...
V_59 -> V_224 = V_224 ;
V_59 -> V_225 = V_225 ;
F_296 ( & V_289 , V_58 , V_38 ,
V_59 , V_54 , V_56 ) ;
V_148:
F_297 ( & F_295 ( V_288 , V_28 ) ) ;
F_298 () ;
}
