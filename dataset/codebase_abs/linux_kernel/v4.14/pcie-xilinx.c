...
const char * type ;
int V_108 ;
type = F_45 ( V_93 , L_26 , NULL ) ;
if ( ! type || strcmp ( type , L_27 ) ) {
F_16 ( V_9 , L_28 , type ) ;
return - V_43 ;
}
V_108 = F_46 ( V_93 , 0 , & V_107 ) ;
if ( V_108 ) {
F_16 ( V_9 , L_29 ) ;
return V_108 ;
}
V_2 -> V_4 = F_47 ( V_9 , & V_107 ) ;
if ( F_48 ( V_2 -> V_4 ) )
return F_49 ( V_2 -> V_4 ) ;
V_2 -> V_24 = F_50 ( V_93 , 0 ) ;
V_108 = F_51 ( V_9 , V_2 -> V_24 , F_34 ,
V_109 | V_110 ,
L_30 , V_2 ) ;
if ( V_108 ) {
...
static int F_52 ( struct V_111 * V_37 )
{
struct V_8 * V_9 = & V_37 -> V_9 ;
struct V_1 * V_2 ;
struct V_14 * V_15 , * V_112 ;
struct V_113 * V_114 ;
int V_108 ;
T_6 V_115 = 0 ;
F_53 ( V_116 ) ;
...
V_108 = F_56 ( V_9 -> V_94 , 0 , 0xff , & V_116 ,
& V_115 ) ;
if ( V_108 ) {
F_16 ( V_9 , L_34 ) ;
return V_108 ;
}
V_108 = F_57 ( V_9 , & V_116 ) ;
if ( V_108 )
goto error;
F_58 ( & V_116 , & V_114 -> V_117 ) ;
V_114 -> V_9 . V_118 = V_9 ;
V_114 -> V_17 = V_2 ;
V_114 -> V_119 = 0 ;
V_114 -> V_120 = & V_121 ;
