...
static bool F_52 ( struct V_1 * V_1 , int V_13 )
{
struct V_45 * V_46 ;
F_18 () ;
V_46 = F_53 ( V_1 , V_13 ) ;
...
static int F_54 ( struct V_47 * V_48 , struct V_49 * V_50 ,
struct V_51 * V_52 )
{
struct V_1 * V_1 = F_55 ( V_48 -> V_53 ) ;
struct V_54 * V_55 ;
struct V_56 * V_57 [ V_58 + 1 ] ;
struct V_10 * V_59 ;
T_1 V_16 ;
int V_41 = 0 ;
V_41 = F_56 ( V_50 , sizeof( * V_55 ) , V_57 , V_58 , V_60 ,
V_52 ) ;
if ( V_41 < 0 )
return V_41 ;
V_55 = F_57 ( V_50 ) ;
...
! F_52 ( V_1 , V_55 -> V_68 ) )
return - V_24 ;
V_41 = F_36 ( V_1 , V_59 , V_55 -> V_63 ,
V_55 -> V_68 , V_16 ,
V_50 -> V_69 & V_70 ) ;
break;
case V_71 :
V_41 = F_43 ( V_1 , V_59 , V_55 -> V_63 ,
V_55 -> V_68 ) ;
break;
default:
V_41 = - V_72 ;
...
int V_15 , int V_13 , T_1 V_73 )
{
struct V_54 * V_55 = F_57 ( V_50 ) ;
V_55 -> V_61 = V_62 ;
V_55 -> V_63 = V_15 ;
V_55 -> V_74 = 0 ;
V_55 -> V_68 = V_13 ;
...
struct V_2 * V_5 ,
T_1 V_73 ,
T_1 V_76 , T_1 V_37 , int V_77 ,
unsigned int V_78 )
{
struct V_49 * V_50 = F_62 ( V_48 , V_76 , V_37 , V_77 ,
sizeof( struct V_54 ) , V_78 ) ;
if ( ! V_50 )
return - V_79 ;
F_60 ( V_50 , V_5 -> V_15 , V_5 -> V_13 , V_73 ) ;
if ( F_63 ( V_48 , V_64 , & V_5 -> V_14 ) < 0 ||
F_64 ( V_48 , V_65 , V_5 -> V_16 ) < 0 ) {
F_65 ( V_48 , V_50 ) ;
return - V_79 ;
}
F_66 ( V_48 , V_50 ) ;
...
static int F_67 ( struct V_47 * V_48 , struct V_80 * V_81 )
{
struct V_1 * V_1 = F_55 ( V_48 -> V_53 ) ;
struct V_2 * V_5 ;
int V_82 = 0 , V_83 = V_81 -> args [ 0 ] ;
int V_41 ;
F_18 () ;
F_16 (p, &ip6addrlbl_table.head, list) {
if ( V_82 >= V_83 &&
...
{
return F_70 ( sizeof( struct V_54 ) )
+ F_71 ( 16 )
+ F_71 ( 4 ) ;
}
static int F_72 ( struct V_47 * V_87 , struct V_49 * V_50 ,
struct V_51 * V_52 )
{
struct V_1 * V_1 = F_55 ( V_87 -> V_53 ) ;
struct V_54 * V_55 ;
struct V_56 * V_57 [ V_58 + 1 ] ;
struct V_10 * V_11 ;
T_1 V_73 ;
...
V_11 = F_58 ( V_57 [ V_64 ] ) ;
F_18 () ;
V_5 = F_15 ( V_1 , V_11 , F_22 ( V_11 ) , V_55 -> V_68 ) ;
if ( V_5 && ! F_7 ( V_5 ) )
V_5 = NULL ;
V_73 = V_35 . V_37 ;
F_19 () ;
...
V_41 = F_61 ( V_48 , V_5 , V_73 ,
F_68 ( V_87 ) . V_76 , V_50 -> V_84 ,
V_67 , 0 ) ;
F_9 ( V_5 ) ;
if ( V_41 < 0 ) {
F_74 ( V_41 == - V_79 ) ;
...
V_41 = F_76 ( V_48 , V_1 , F_68 ( V_87 ) . V_76 ) ;
V_34:
return V_41 ;
}
void T_4 F_77 ( void )
