...
V_104 -> V_168 = ( V_72 -> V_97 % V_2 -> V_169 ) ;
V_104 -> V_170 = V_171 ;
V_104 -> V_172 = 3 ;
V_104 -> V_173 = 65535 ;
V_104 -> V_174 = V_175 ;
...
V_104 -> V_186 = V_187 ;
V_104 -> V_188 = V_189 ;
V_104 -> V_190 = V_72 -> V_157 ;
V_104 -> V_191 = V_72 -> V_156 ;
...
switch ( V_204 ) {
case V_208 :
V_206 = sprintf ( V_205 , L_20 , V_72 -> V_157 ) ;
break;
case V_209 :
if ( V_72 -> V_151 == V_152 )
V_206 = sprintf ( V_205 , L_21 , V_72 -> V_150 ) ;
else
V_206 = sprintf ( V_205 , L_22 , V_72 -> V_150 ) ;
break;
default:
return - V_207 ;
}
...
V_72 -> V_87 = ( T_3 ) - 1 ;
V_72 -> V_2 = V_2 ;
if ( V_150 -> V_289 == V_290 ) {
V_272 = (struct V_271 * ) V_150 ;
memcpy ( V_72 -> V_150 , & V_272 -> V_291 . V_292 ,
sizeof( struct V_293 ) ) ;
V_72 -> V_157 = F_68 ( V_272 -> V_294 ) ;
V_72 -> V_151 = V_152 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_28 ,
V_72 -> V_150 , V_72 -> V_157 ) ;
} else if ( V_150 -> V_289 == V_295 ) {
V_274 = (struct V_273 * ) V_150 ;
memcpy ( V_72 -> V_150 , & V_274 -> V_296 ,
sizeof( struct V_297 ) ) ;
V_72 -> V_157 = F_68 ( V_274 -> V_298 ) ;
V_72 -> V_151 = V_192 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_29 ,
V_72 -> V_150 , V_72 -> V_157 ) ;
...
if ( V_283 )
goto V_301;
V_283 = V_125 -> V_302 ( V_2 -> V_127 , & V_72 -> V_128 ,
...
V_205 = ( char * ) & V_279 ;
V_206 = sizeof( V_279 ) ;
memset ( & V_279 , 0 , V_206 ) ;
V_280 = V_309 ;
V_279 . V_128 = ( T_4 ) V_72 -> V_87 ;
V_279 . V_130 = V_2 -> V_310 ;
V_72 -> V_130 = V_2 -> V_310 ;
if ( V_72 -> V_151 == V_152 ) {
memcpy ( & V_279 . V_146 . V_311 , & V_72 -> V_150 ,
sizeof( struct V_293 ) ) ;
V_279 . V_312 = 4 ;
} else {
memcpy ( & V_279 . V_146 . V_313 , & V_72 -> V_150 ,
sizeof( struct V_297 ) ) ;
V_279 . V_312 = 16 ;
}
V_283 = F_72 ( V_10 , & V_75 , V_280 , V_205 ,
V_206 ) ;
if ( V_283 ) {
F_18 ( & V_2 -> V_35 ,
L_33 ,
...
V_72 -> V_94 = V_327 ;
V_283 = V_125 -> V_328 ( V_2 -> V_127 , V_72 -> V_128 , V_202 ) ;
if ( V_283 ) {
F_70 ( & V_2 -> V_35 ,
L_38 , V_283 ) ;
} else {
...
V_327 ) ,
V_321 ) ;
if ( ( V_283 <= 0 ) || ( V_72 -> V_94 == V_327 ) ) {
F_70 ( & V_2 -> V_35 ,
L_39 ,
V_283 , V_321 , V_72 -> V_87 ) ;
}
}
V_326:
V_283 = V_125 -> V_316 ( V_2 -> V_127 , V_72 -> V_128 ) ;
if ( V_283 )
F_70 ( & V_2 -> V_35 ,
L_40 ,
V_283 , V_72 -> V_87 ) ;
...
V_332 = (struct V_331 * ) V_277 -> V_332 ;
if ( ! V_332 ) {
F_18 ( & V_2 -> V_35 , L_42 ) ;
return - V_93 ;
}
...
F_93 ( V_334 , V_206 ) ;
memcpy ( V_334 -> V_263 , V_277 -> V_337 , V_206 ) ;
V_334 -> V_338 = V_339 ;
if ( V_330 )
F_94 ( V_334 , F_95 ( V_340 ) , V_330 ) ;
V_254 = V_125 -> V_341 -> V_342 ( V_127 , V_334 ) ;
if ( V_254 ) {
F_18 ( & V_2 -> V_35 , L_45 ,
V_254 ) ;
F_96 ( V_334 ) ;
...
V_283 = F_77 ( V_72 -> V_306 ,
( V_72 -> V_94 ==
V_319 ) ,
V_321 ) ;
if ( ( V_283 <= 0 ) || ( V_72 -> V_94 != V_319 ) ) {
V_72 -> V_94 = V_318 ;
F_18 ( & V_2 -> V_35 ,
L_47 ,
V_72 -> V_87 , V_72 ) ;
...
static int F_99 ( struct V_9 * V_10 , struct V_278 * V_346 )
{
struct V_1 * V_2 ;
struct V_71 * V_72 ;
int V_283 = 0 ;
...
F_42 ( & V_72 -> V_147 [ 0 ] , & V_346 -> V_352 [ 0 ] ) ;
V_72 -> V_162 = V_346 -> V_162 ;
if ( V_346 -> V_130 < V_354 ) {
V_72 -> V_130 = V_2 -> V_310 ;
F_10 ( & V_2 -> V_35 , V_197 ,
L_52 ,
V_346 -> V_130 , V_72 -> V_130 ) ;
}
if ( V_346 -> V_130 != V_2 -> V_310 ) {
if ( V_346 -> V_130 > V_355 ) {
V_283 = - V_93 ;
F_18 ( NULL , L_53 , V_346 -> V_130 ) ;
goto V_351;
}
F_102 ( V_2 , V_346 -> V_130 ) ;
V_72 -> V_130 = V_2 -> V_310 ;
}
V_347 = V_72 -> V_156 ;
if ( V_347 >= V_356 &&
...
V_72 -> V_156 = V_347 ;
if ( V_72 -> V_151 == V_152 ) {
memcpy ( & V_72 -> V_149 [ 0 ] , & V_346 -> V_143 . V_311 ,
sizeof( struct V_293 ) ) ;
memcpy ( & V_2 -> V_215 [ 0 ] , & V_346 -> V_143 . V_311 ,
sizeof( struct V_293 ) ) ;
V_2 -> V_151 = V_152 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_55 ,
...
memcpy ( & V_72 -> V_149 [ 0 ] , & V_346 -> V_143 . V_313 ,
sizeof( struct V_297 ) ) ;
memcpy ( & V_2 -> V_215 [ 0 ] , & V_346 -> V_143 . V_313 ,
sizeof( struct V_297 ) ) ;
V_2 -> V_151 = V_192 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_56 ,
...
char * F_113 ( enum V_400 V_401 )
{
int V_4 ;
char * V_402 = NULL ;
for ( V_4 = 0 ; V_4 < F_114 ( V_403 ) ; V_4 ++ ) {
...
void F_115 ( struct V_71 * V_67 , struct V_406 * V_263 )
{
struct V_3 * V_3 ;
struct V_1 * V_2 ;
char V_407 [] = L_59 ;
...
void F_116 ( struct V_71 * V_67 , struct V_406 * V_263 )
{
struct V_3 * V_3 ;
if ( ! V_67 )
return;
