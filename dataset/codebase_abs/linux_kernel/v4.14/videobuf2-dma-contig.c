...
struct V_70 * * V_71 ;
if ( V_2 ) {
F_58 ( V_11 -> V_18 , V_2 -> V_6 , V_2 -> V_19 ,
V_11 -> V_20 , V_72 ) ;
V_71 = F_59 ( V_11 -> V_73 ) ;
F_60 ( F_55 ( V_71 ) ) ;
for ( V_7 = 0 ; V_7 < F_61 ( V_11 -> V_73 ) ; V_7 ++ )
F_62 ( V_71 [ V_7 ] ) ;
F_16 ( V_2 ) ;
F_17 ( V_2 ) ;
}
...
static inline T_1 F_64 ( struct V_24 * V_18 , unsigned long V_74 )
{
return ( T_1 ) F_65 ( V_18 , V_74 ) ;
}
static inline T_1 F_64 ( struct V_24 * V_18 , unsigned long V_74 )
{
...
static inline T_1 F_64 ( struct V_24 * V_18 , unsigned long V_74 )
{
return ( T_1 ) F_67 ( V_74 ) ;
}
static inline T_1 F_64 ( struct V_24 * V_18 , unsigned long V_74 )
{
return ( T_1 ) ( V_74 ) << V_75 ;
}
static void * F_68 ( struct V_24 * V_18 , unsigned long V_13 ,
unsigned long V_8 , enum V_25 V_20 )
{
struct V_10 * V_11 ;
struct V_76 * V_73 ;
...
struct V_1 * V_2 ;
unsigned long V_78 ;
unsigned long V_79 = F_69 () ;
if ( ! F_70 ( V_13 | V_8 , V_79 ) ) {
F_32 ( L_8 , V_79 ) ;
return F_22 ( - V_27 ) ;
}
if ( ! V_8 ) {
...
V_36 = F_73 ( V_73 ) ;
if ( V_36 < 0 ) {
unsigned long * V_84 = F_74 ( V_73 ) ;
for ( V_7 = 1 ; V_7 < V_77 ; V_7 ++ )
if ( V_84 [ V_7 - 1 ] + 1 != V_84 [ V_7 ] )
goto V_85;
V_11 -> V_12 = F_64 ( V_11 -> V_18 , V_84 [ 0 ] ) ;
goto V_86;
}
...
V_36 = F_75 ( V_2 , F_59 ( V_73 ) , V_77 ,
V_58 , V_8 , V_28 ) ;
if ( V_36 ) {
F_31 ( L_11 ) ;
goto V_87;
}
V_2 -> V_62 = F_76 ( V_11 -> V_18 , V_2 -> V_6 , V_2 -> V_19 ,
V_11 -> V_20 , V_72 ) ;
if ( V_2 -> V_62 <= 0 ) {
F_31 ( L_5 ) ;
V_36 = - V_63 ;
...
if ( F_21 ( V_11 -> V_12 ) )
F_80 ( V_11 ) ;
F_83 ( V_11 -> V_14 -> V_15 , V_11 -> V_14 ) ;
F_17 ( V_11 ) ;
}
static void * F_84 ( struct V_24 * V_18 , struct V_48 * V_49 ,
unsigned long V_8 , enum V_25 V_20 )
{
struct V_10 * V_11 ;
struct V_50 * V_92 ;
...
int F_86 ( struct V_24 * V_18 , unsigned int V_8 )
{
if ( ! V_18 -> V_93 ) {
V_18 -> V_93 = F_23 ( sizeof( * V_18 -> V_93 ) , V_28 ) ;
if ( ! V_18 -> V_93 )
return - V_29 ;
}
if ( F_87 ( V_18 ) < V_8 )
return F_88 ( V_18 , V_8 ) ;
return 0 ;
}
void F_89 ( struct V_24 * V_18 )
{
F_17 ( V_18 -> V_93 ) ;
V_18 -> V_93 = NULL ;
}
