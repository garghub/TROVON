...
static int F_39 ( struct V_121 * V_88 )
{
struct V_12 * V_13 ;
int V_62 = 0 ;
int V_82 ;
V_13 = F_40 ( sizeof( struct V_12 ) , V_122 ) ;
if ( ! V_13 ) {
V_62 = - V_123 ;
goto V_78;
}
F_41 ( & V_13 -> V_124 ) ;
V_13 -> V_64 = F_42 ( V_88 -> V_125 ) ;
V_13 -> V_88 = V_88 ;
strcpy ( F_43 ( V_88 ) , V_126 ) ;
strcpy ( F_44 ( V_88 ) , V_127 ) ;
V_88 -> V_128 = V_13 ;
V_62 = F_35 ( V_13 ) ;
if ( V_62 && V_62 != - V_26 )
goto V_78;
