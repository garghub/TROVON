...
strcmp ( V_2 -> V_4 . type , V_4 -> type ) == 0 ;
}
...
error = F_55 ( V_2 -> V_26 , 0 , V_2 -> V_4 . V_5 ,
& V_2 -> V_27 ) ;
if ( error < 0 ) {
F_14 ( & V_2 -> V_7 , L_20 , error ) ;
goto V_73;
}
error = F_56 ( V_2 -> V_26 , 0 , V_2 -> V_27 ,
& V_34 -> V_74 ) ;
if ( error < 0 ) {
F_14 ( & V_2 -> V_7 , L_21 ,
error ) ;
...
struct V_55 * V_47 = V_2 -> V_44 [ 0 ] ;
( void ) F_39 ( V_2 ) ;
F_63 ( & V_2 -> V_7 , V_47 -> V_43 -> V_47 , & V_2 -> V_7 ) ;
F_48 ( V_2 ) ;
}
...
F_33 ( V_2 ) ;
error = F_60 ( V_2 -> V_26 , 0 , V_2 -> V_27 ) ;
if ( error < 0 )
