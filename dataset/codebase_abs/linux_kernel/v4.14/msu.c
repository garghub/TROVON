...
V_6 -> V_14 [ V_78 ] . V_2 =
F_56 ( F_39 ( V_5 ) -> V_80 -> V_80 , V_69 ,
& V_6 -> V_14 [ V_78 ] . V_15 , V_23 ) ;
...
if ( F_11 ( V_6 ) ) {
V_83 |= V_84 ;
V_82 = F_7 ( V_5 -> V_13 . V_16 ,
struct V_4 , V_17 ) ;
} else {
V_82 = F_7 ( V_6 -> V_17 . V_16 ,
struct V_4 , V_17 ) ;
}
for ( V_18 = 0 ; V_18 < V_6 -> V_19 ; V_18 ++ ) {
struct V_1 * V_2 = V_6 -> V_14 [ V_18 ] . V_2 ;
memset ( V_2 , 0 , sizeof( * V_2 ) ) ;
V_2 -> V_82 = V_82 -> V_14 [ 0 ] . V_15 >> V_11 ;
if ( V_18 == V_6 -> V_19 - 1 ) {
V_83 |= V_85 ;
V_2 -> V_86 =
...
static unsigned long F_76 ( void * V_89 , void * V_90 , T_2 V_91 )
{
struct V_92 * V_93 = V_89 ;
unsigned long V_66 ;
V_66 = F_77 ( V_93 -> V_94 + V_93 -> V_95 , V_90 , V_91 ) ;
V_93 -> V_95 += V_91 - V_66 ;
return V_66 ;
}
static int F_78 ( struct V_96 * V_96 , struct V_97 * V_97 )
{
struct V_64 * V_53 = V_97 -> V_98 ;
struct V_5 * V_5 = F_41 ( & V_53 -> V_65 ) ;
struct V_20 * V_21 ;
if ( ! F_79 ( V_99 ) )
return - V_100 ;
...
return F_81 ( V_21 ) ;
V_97 -> V_98 = V_21 ;
return F_82 ( V_96 , V_97 ) ;
}
static int F_83 ( struct V_96 * V_96 , struct V_97 * V_97 )
{
struct V_20 * V_21 = V_97 -> V_98 ;
struct V_5 * V_5 = V_21 -> V_5 ;
F_22 ( V_21 , V_5 ) ;
return 0 ;
}
static T_3
F_84 ( struct V_5 * V_5 , char T_4 * V_94 , T_5 V_74 , T_2 V_91 )
{
unsigned long V_69 = V_5 -> V_43 << V_11 , V_101 = V_91 ;
unsigned long V_102 = V_74 , V_103 = 0 ;
if ( V_5 -> V_60 ) {
V_102 += V_5 -> V_63 ;
if ( V_102 < V_69 ) {
V_103 = F_85 ( V_101 , V_69 - V_102 ) ;
if ( F_77 ( V_94 , V_5 -> V_73 + V_102 , V_103 ) )
return - V_104 ;
V_94 += V_103 ;
V_101 -= V_103 ;
V_102 += V_103 ;
...
V_102 &= V_69 - 1 ;
if ( V_101 ) {
V_103 = F_85 ( V_101 , V_5 -> V_63 - V_102 ) ;
if ( F_77 ( V_94 , V_5 -> V_73 + V_102 , V_103 ) )
return - V_104 ;
V_101 -= V_103 ;
}
...
if ( F_77 ( V_94 , V_5 -> V_73 + V_102 , V_101 ) )
return - V_104 ;
return V_91 ;
}
static T_3 F_86 ( struct V_97 * V_97 , char T_4 * V_94 ,
T_2 V_91 , T_5 * V_105 )
{
struct V_20 * V_21 = V_97 -> V_98 ;
struct V_5 * V_5 = V_21 -> V_5 ;
...
static void F_88 ( struct V_107 * V_108 )
{
struct V_20 * V_21 = V_108 -> V_109 -> V_98 ;
struct V_5 * V_5 = V_21 -> V_5 ;
F_89 ( & V_5 -> V_110 ) ;
}
...
struct V_5 * V_5 = V_21 -> V_5 ;
unsigned long V_111 ;
if ( ! F_91 ( & V_5 -> V_110 , & V_5 -> V_25 ) )
return;
for ( V_111 = 0 ; V_111 < V_5 -> V_43 ; V_111 ++ ) {
struct V_71 * V_71 = F_75 ( V_5 , V_111 ) ;
if ( F_71 ( ! V_71 ) )
continue;
if ( V_71 -> V_76 )
V_71 -> V_76 = NULL ;
...
{
struct V_20 * V_21 = V_113 -> V_108 -> V_109 -> V_98 ;
struct V_5 * V_5 = V_21 -> V_5 ;
V_113 -> V_71 = F_75 ( V_5 , V_113 -> V_77 ) ;
if ( ! V_113 -> V_71 )
return V_114 ;
F_93 ( V_113 -> V_71 ) ;
V_113 -> V_71 -> V_76 = V_113 -> V_108 -> V_109 -> V_115 ;
V_113 -> V_71 -> V_116 = V_113 -> V_77 ;
return 0 ;
}
static int F_94 ( struct V_97 * V_97 , struct V_107 * V_108 )
{
unsigned long V_69 = V_108 -> V_117 - V_108 -> V_118 ;
struct V_20 * V_21 = V_108 -> V_109 -> V_98 ;
struct V_5 * V_5 = V_21 -> V_5 ;
int V_66 = - V_32 ;
if ( ! V_69 || F_95 ( V_69 ) )
...
static T_3
F_101 ( struct V_127 * V_65 , struct V_128 * V_129 , char * V_94 )
{
struct V_5 * V_5 = F_41 ( V_65 ) ;
return F_102 ( V_94 , V_75 , L_5 , V_5 -> V_52 ) ;
}
static T_3
F_103 ( struct V_127 * V_65 , struct V_128 * V_129 , const char * V_94 ,
T_2 V_69 )
{
struct V_5 * V_5 = F_41 ( V_65 ) ;
unsigned long V_130 ;
int V_66 ;
V_66 = F_104 ( V_94 , 10 , & V_130 ) ;
if ( V_66 )
return V_66 ;
V_5 -> V_52 = ! ! V_130 ;
return V_69 ;
...
static T_3
F_105 ( struct V_127 * V_65 , struct V_128 * V_129 , char * V_94 )
{
struct V_5 * V_5 = F_41 ( V_65 ) ;
return F_102 ( V_94 , V_75 , L_6 , V_131 [ V_5 -> V_37 ] ) ;
}
static T_3
F_106 ( struct V_127 * V_65 , struct V_128 * V_129 , const char * V_94 ,
T_2 V_69 )
{
struct V_5 * V_5 = F_41 ( V_65 ) ;
T_2 V_91 = V_69 ;
...
if ( V_132 )
V_91 = V_132 - V_94 ;
for ( V_78 = 0 ; V_78 < F_107 ( V_131 ) ; V_78 ++ )
if ( ! strncmp ( V_131 [ V_78 ] , V_94 , V_91 ) )
goto V_12;
return - V_32 ;
V_12:
F_18 ( & V_5 -> V_25 ) ;
...
static T_3
F_108 ( struct V_127 * V_65 , struct V_128 * V_129 , char * V_94 )
{
struct V_5 * V_5 = F_41 ( V_65 ) ;
struct V_4 * V_6 ;
T_2 V_56 = 0 ;
F_18 ( & V_5 -> V_25 ) ;
if ( V_5 -> V_37 == V_42 )
V_56 = F_102 ( V_94 , V_75 , L_7 , V_5 -> V_43 ) ;
else if ( V_5 -> V_37 == V_38 ) {
F_6 (win, &msc->win_list, entry) {
V_56 += F_102 ( V_94 + V_56 , V_75 - V_56 ,
L_8 , V_6 -> V_19 ,
F_11 ( V_6 ) ? '\n' : ',' ) ;
}
} else {
V_56 = F_102 ( V_94 , V_75 , L_9 ) ;
}
F_21 ( & V_5 -> V_25 ) ;
return V_56 ;
}
static T_3
F_109 ( struct V_127 * V_65 , struct V_128 * V_129 ,
const char * V_94 , T_2 V_69 )
{
struct V_5 * V_5 = F_41 ( V_65 ) ;
unsigned long V_130 , * V_6 = NULL , * V_133 ;
T_2 V_91 = V_69 ;
const char * V_134 = V_94 ;
char * V_135 , * V_136 ;
int V_66 , V_88 = 0 ;
if ( ! F_79 ( V_99 ) )
return - V_100 ;
...
V_91 = V_135 - V_94 ;
do {
V_135 = memchr ( V_134 , ',' , V_91 ) ;
V_136 = F_110 ( V_134 , V_135 ? V_135 - V_134 : V_91 , V_23 ) ;
if ( ! V_136 ) {
V_66 = - V_24 ;
goto V_137;
}
V_66 = F_104 ( V_136 , 10 , & V_130 ) ;
F_19 ( V_136 ) ;
if ( V_66 || ! V_130 )
goto V_137;
if ( V_88 && V_5 -> V_37 == V_42 ) {
V_66 = - V_32 ;
goto V_137;
}
V_88 ++ ;
V_133 = F_111 ( V_6 , sizeof( * V_6 ) * V_88 , V_23 ) ;
if ( ! V_133 ) {
F_19 ( V_6 ) ;
return - V_24 ;
}
...
{
struct V_127 * V_65 = & V_53 -> V_65 ;
struct V_138 * V_139 ;
struct V_5 * V_5 ;
void T_6 * V_73 ;
int V_140 ;
V_139 = F_113 ( V_53 , V_141 , 0 ) ;
if ( ! V_139 )
return - V_68 ;
V_73 = F_114 ( V_65 , V_139 -> V_102 , F_115 ( V_139 ) ) ;
if ( ! V_73 )
return - V_24 ;
V_5 = F_116 ( V_65 , sizeof( * V_5 ) , V_23 ) ;
if ( ! V_5 )
return - V_24 ;
V_5 -> V_116 = V_53 -> V_142 ;
V_5 -> V_53 = V_53 ;
V_5 -> V_8 = V_73 + V_5 -> V_116 * 0x100 ;
V_140 = F_98 ( V_5 ) ;
if ( V_140 )
return V_140 ;
F_117 ( V_65 , V_5 ) ;
