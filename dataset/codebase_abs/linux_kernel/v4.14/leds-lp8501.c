...
struct V_7 * V_4 ;
struct V_1 * V_2 ;
struct V_75 * V_13 = F_22 ( & V_72 -> V_65 ) ;
struct V_76 * V_77 = V_72 -> V_65 . V_78 ;
if ( ! V_13 ) {
if ( V_77 ) {
V_13 = F_23 ( & V_72 -> V_65 , V_77 ) ;
if ( F_24 ( V_13 ) )
return F_25 ( V_13 ) ;
} else {
F_16 ( & V_72 -> V_65 , L_5 ) ;
...
V_4 = F_26 ( & V_72 -> V_65 , sizeof( * V_4 ) , V_79 ) ;
if ( ! V_4 )
return - V_80 ;
V_2 = F_26 ( & V_72 -> V_65 ,
sizeof( * V_2 ) * V_13 -> V_81 , V_79 ) ;
if ( ! V_2 )
return - V_80 ;
V_4 -> V_64 = V_72 ;
V_4 -> V_13 = V_13 ;
