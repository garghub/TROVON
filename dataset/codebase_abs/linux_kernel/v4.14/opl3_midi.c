...
F_4 ( V_35 L_3 , * ( V_31 + V_27 -> V_36 [ V_30 ] . V_37 + 1 ) ) ;
F_4 ( V_35 L_4 ) ;
}
static int F_5 ( struct V_26 * V_27 , int V_38 ,
struct V_3 * V_4 ) {
int V_39 ;
int V_40 ;
...
int V_30 ;
#ifdef F_6
char * V_45 [ 3 ] = { L_5 , L_6 , L_7 } ;
#endif
enum {
FREE = 0 , V_46 , V_47 , V_48
};
struct V_49 {
unsigned int time ;
int V_29 ;
...
V_44 = V_42 -> time ;
V_50 = V_49 ;
V_39 = ( ( V_30 < 3 ) || ( V_30 > 8 && V_30 < 12 ) ) ;
V_40 = ( ( V_30 > 2 && V_30 < 6 ) || ( V_30 > 11 && V_30 < 15 ) ) ;
if ( V_38 ) {
if ( ! V_39 )
continue;
if ( V_42 -> V_37 )
V_50 ++ ;
V_43 = & V_27 -> V_36 [ V_30 + 3 ] ;
if ( V_43 -> V_37 == V_52 ) {
V_50 ++ ;
V_44 = ( V_44 > V_42 -> time ) ?
V_44 : V_42 -> time ;
...
V_49 [ V_30 ] . V_29 ) ;
#endif
return V_49 [ V_30 ] . V_29 ;
}
}
return - 1 ;
}
void F_7 ( unsigned long V_53 )
{
struct V_26 * V_27 = (struct V_26 * ) V_53 ;
unsigned long V_54 ;
int V_55 = 0 ;
int V_30 ;
F_8 ( & V_27 -> V_56 , V_54 ) ;
for ( V_30 = 0 ; V_30 < V_27 -> V_34 ; V_30 ++ ) {
struct V_41 * V_42 = & V_27 -> V_36 [ V_30 ] ;
if ( V_42 -> V_37 > 0 && V_42 -> V_57 ) {
if ( V_42 -> V_58 == V_59 )
F_9 ( V_27 , V_42 -> V_16 , 0 ,
V_42 -> V_4 ) ;
else
V_55 ++ ;
}
...
V_72 = V_42 -> V_102 & ~ V_103 ;
V_27 -> V_104 ( V_27 , V_71 , V_72 ) ;
}
if ( V_38 ) {
V_43 = & V_27 -> V_36 [ V_29 + 3 ] ;
if ( V_42 -> V_37 > 0 ) {
V_71 = V_68 | ( V_101 +
V_70 + 3 ) ;
V_72 = V_42 -> V_102 & ~ V_103 ;
...
if ( V_79 -> V_129 ) {
V_27 -> V_36 [ V_29 ] . V_58 = V_59 +
( V_79 -> V_129 * V_130 ) / 100 ;
F_12 ( V_27 ) ;
V_27 -> V_36 [ V_29 ] . V_57 = 1 ;
} else
V_27 -> V_36 [ V_29 ] . V_57 = 0 ;
...
#endif
V_71 = V_68 | ( V_101 + V_70 ) ;
V_27 -> V_104 ( V_27 , V_71 , V_42 -> V_102 ) ;
V_42 -> time = V_27 -> V_33 ++ ;
if ( V_42 -> V_37 == V_132 ) {
V_43 = & V_27 -> V_36 [ V_29 + 3 ] ;
V_43 -> time = V_27 -> V_33 ++ ;
...
V_42 = & V_27 -> V_36 [ V_29 ] ;
if ( V_42 -> V_37 > 0 && V_42 -> V_4 == V_4 && V_42 -> V_16 == V_16 ) {
F_18 ( V_27 , V_29 ) ;
}
}
} else {
...
F_2 ( & V_14 , & V_15 , V_42 -> V_16 , V_42 -> V_4 ) ;
V_71 = V_68 | ( V_128 + V_70 ) ;
V_27 -> V_104 ( V_27 , V_71 , V_14 ) ;
V_42 -> V_102 = V_15 ;
V_15 |= V_103 ;
