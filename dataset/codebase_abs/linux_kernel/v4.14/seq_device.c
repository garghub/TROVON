...
static int F_24 ( struct V_22 * V_1 )
{
struct V_5 * V_2 = V_1 -> V_23 ;
int V_24 ;
V_24 = F_25 ( & V_2 -> V_2 ) ;
...
static int F_26 ( struct V_22 * V_1 )
{
struct V_5 * V_2 = V_1 -> V_23 ;
F_27 ( & V_2 -> V_2 ) ;
return 0 ;
...
int F_30 ( struct V_26 * V_27 , int V_1 , const char * V_9 ,
...
V_2 -> V_2 . V_39 = & V_17 ;
V_2 -> V_2 . V_40 = F_28 ;
F_34 ( & V_2 -> V_2 , L_5 , V_2 -> V_9 , V_27 -> V_41 , V_1 ) ;
V_24 = F_35 ( V_27 , V_42 , V_2 , & V_30 ) ;
if ( V_24 < 0 ) {
F_23 ( & V_2 -> V_2 ) ;
return V_24 ;
}
...
int F_36 ( struct V_7 * V_4 , struct V_43 * V_44 )
{
if ( F_37 ( ! V_4 -> V_14 . V_45 || ! V_4 -> V_9 ) )
return - V_34 ;
V_4 -> V_14 . V_39 = & V_17 ;
V_4 -> V_14 . V_46 = V_44 ;
return F_38 ( & V_4 -> V_14 ) ;
}
void F_39 ( struct V_7 * V_4 )
{
F_40 ( & V_4 -> V_14 ) ;
}
