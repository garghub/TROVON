...
static
int F_82 ( unsigned long V_67 , T_13 T_7 * V_68 ,
unsigned long * V_69 )
{
if ( ! V_68 )
return 0 ;
return F_83 ( V_68 , V_69 , V_67 ) ;
}
static int F_84 ( int V_71 , T_13 T_7 * V_99 ,
...
if ( F_82 ( V_71 , V_99 , V_72 . V_103 ) ||
F_82 ( V_71 , V_100 , V_72 . V_104 ) ||
F_82 ( V_71 , exp , V_72 . V_105 ) )
V_10 = - V_70 ;
V_83:
if ( V_116 != V_120 )
F_75 ( V_116 ) ;
...
static long F_85 ( int V_71 , T_13 T_7 * V_99 ,
T_13 T_7 * V_100 , T_13 T_7 * exp ,
...
return - V_54 ;
if ( F_39 ( & V_167 , V_125 , sizeof( V_167 ) ) )
return - V_70 ;
F_86 ( & V_127 , & V_167 ) ;
F_64 ( & V_127 , V_125 ( V_130 ) | V_125 ( V_131 ) ) ;
F_65 ( V_132 , & V_127 , & V_128 ) ;
}
V_10 = F_84 ( V_71 , V_99 , V_100 , exp , V_50 ) ;
