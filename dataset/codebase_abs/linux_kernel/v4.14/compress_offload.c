...
static void F_67 ( struct V_147 * V_148 ,
struct V_149 * V_45 )
{
struct V_4 * V_5 = (struct V_4 * ) V_148 -> V_33 ;
F_68 ( V_45 , L_20 , V_5 -> V_26 -> V_150 ) ;
...
struct V_147 * V_148 ;
char V_144 [ 16 ] ;
sprintf ( V_144 , L_26 , V_5 -> V_34 ) ;
V_148 = F_70 ( V_5 -> V_26 , V_144 ,
V_5 -> V_26 -> V_151 ) ;
if ( ! V_148 )
return - V_28 ;
V_148 -> V_152 = V_153 | V_154 | V_155 ;
if ( F_71 ( V_148 ) < 0 ) {
F_72 ( V_148 ) ;
return - V_28 ;
}
V_5 -> V_151 = V_148 ;
V_148 = F_70 ( V_5 -> V_26 , L_27 ,
V_5 -> V_151 ) ;
if ( V_148 ) {
F_73 ( V_148 , V_5 ,
F_67 ) ;
...
int F_79 ( struct V_157 * V_26 , int V_34 ,
int V_11 , const char * V_99 , struct V_4 * V_5 )
{
static struct V_158 V_32 = {
. V_159 = F_77 ,
. V_160 = F_63 ,
. V_161 = F_65 ,
} ;
...
F_75 ( V_5 , V_99 ) ;
F_80 ( & V_5 -> V_146 , V_26 ) ;
F_81 ( & V_5 -> V_146 , L_28 , V_26 -> V_150 , V_34 ) ;
V_13 = F_82 ( V_26 , V_162 , V_5 , & V_32 ) ;
if ( V_13 == 0 )
F_69 ( V_5 ) ;
return V_13 ;
}
...
{
int V_73 ;
if ( V_34 -> V_144 == NULL || V_34 -> V_32 == NULL )
return - V_20 ;
F_16 ( L_30 , V_34 -> V_144 ) ;
