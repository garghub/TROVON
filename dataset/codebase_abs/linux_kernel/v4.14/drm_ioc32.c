...
V_7 = F_4 ( V_1 , V_138 , & V_88 , V_16 ) ;
if ( V_7 )
return V_7 ;
V_77 . V_139 . type = V_88 . V_139 . type ;
V_77 . V_139 . V_137 = V_88 . V_139 . V_137 ;
V_77 . V_139 . V_140 = V_88 . V_139 . V_140 ;
V_77 . V_139 . V_141 = V_88 . V_139 . V_141 ;
if ( F_5 ( V_29 , & V_77 , sizeof( V_77 ) ) )
return - V_9 ;
return 0 ;
}
...
unsigned long V_3 )
{
struct V_142 V_8 * V_29 = ( void V_8 * ) V_3 ;
struct V_143 V_144 ;
int V_7 ;
if ( F_2 ( & V_144 , V_29 ,
F_20 ( V_145 , V_146 ) ) )
return - V_9 ;
if ( F_2 ( & V_144 . V_146 , & V_29 -> V_146 ,
sizeof( V_144 . V_146 ) ) )
return - V_9 ;
V_7 = F_4 ( V_1 , V_147 , & V_144 ,
V_18 | V_16 ) ;
if ( V_7 )
return V_7 ;
if ( F_24 ( V_144 . V_148 , & V_29 -> V_148 ) )
return - V_9 ;
return 0 ;
}
long F_45 ( struct V_1 * V_149 , unsigned int V_2 , unsigned long V_3 )
{
unsigned int V_150 = F_46 ( V_2 ) ;
struct V_75 * V_76 = V_149 -> V_151 ;
T_22 * V_152 ;
int V_153 ;
if ( V_150 >= F_47 ( V_154 ) )
return F_48 ( V_149 , V_2 , V_3 ) ;
V_152 = V_154 [ V_150 ] . V_152 ;
if ( ! V_152 )
return F_48 ( V_149 , V_2 , V_3 ) ;
F_49 ( L_2 ,
F_50 ( V_155 ) ,
( long ) F_51 ( V_76 -> V_156 -> V_157 -> V_158 ) ,
V_76 -> V_159 ,
V_154 [ V_150 ] . V_11 ) ;
V_153 = (* V_152)( V_149 , V_2 , V_3 ) ;
if ( V_153 )
F_49 ( L_3 , V_153 ) ;
return V_153 ;
}
