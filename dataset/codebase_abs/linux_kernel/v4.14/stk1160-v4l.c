...
static int F_42 ( struct V_102 * V_118 ,
...
* V_119 = F_28 (unsigned int, *nbuffers,
STK1160_MIN_VIDEO_BUFFERS, STK1160_MAX_VIDEO_BUFFERS) ;
if ( * V_120 )
return V_121 [ 0 ] < V_117 ? - V_81 : 0 ;
* V_120 = 1 ;
V_121 [ 0 ] = V_117 ;
F_3 ( L_14 ,
V_124 , * V_119 , V_117 ) ;
...
struct V_128 * V_129 = F_45 ( V_126 ) ;
struct V_130 * V_131 =
F_46 ( V_129 , struct V_130 , V_126 ) ;
F_47 ( & V_4 -> V_132 , V_127 ) ;
if ( ! V_4 -> V_47 ) {
F_48 ( & V_131 -> V_126 . V_133 , V_134 ) ;
} else {
V_131 -> V_135 = F_49 ( V_126 , 0 ) ;
V_131 -> V_136 = F_50 ( V_126 , 0 ) ;
V_131 -> V_137 = 0 ;
V_131 -> V_138 = 0 ;
if ( V_131 -> V_136 < V_4 -> V_90 * V_4 -> V_91 * 2 )
F_48 ( & V_131 -> V_126 . V_133 , V_134 ) ;
else
F_51 ( & V_131 -> V_139 , & V_4 -> V_140 ) ;
}
F_52 ( & V_4 -> V_132 , V_127 ) ;
}
static int F_53 ( struct V_102 * V_118 , unsigned int V_141 )
{
struct V_3 * V_4 = F_43 ( V_118 ) ;
return F_8 ( V_4 ) ;
}
static void F_54 ( struct V_102 * V_118 )
{
struct V_3 * V_4 = F_43 ( V_118 ) ;
F_18 ( V_4 ) ;
}
...
unsigned long V_127 ;
F_47 ( & V_4 -> V_132 , V_127 ) ;
while ( ! F_55 ( & V_4 -> V_140 ) ) {
V_131 = F_56 ( & V_4 -> V_140 ,
struct V_130 , V_139 ) ;
F_57 ( & V_131 -> V_139 ) ;
F_48 ( & V_131 -> V_126 . V_133 , V_134 ) ;
F_3 ( L_15 ,
V_131 , V_131 -> V_126 . V_133 . V_80 ) ;
}
if ( V_4 -> V_53 . V_131 ) {
V_131 = V_4 -> V_53 . V_131 ;
V_4 -> V_53 . V_131 = NULL ;
F_48 ( & V_131 -> V_126 . V_133 , V_134 ) ;
F_3 ( L_15 ,
V_131 , V_131 -> V_126 . V_133 . V_80 ) ;
...
V_103 = & V_4 -> V_104 ;
V_103 -> type = V_142 ;
V_103 -> V_143 = V_144 | V_145 | V_146 | V_147 ;
V_103 -> V_148 = V_4 ;
V_103 -> V_149 = sizeof( struct V_130 ) ;
V_103 -> V_150 = & V_151 ;
V_103 -> V_152 = & V_153 ;
V_103 -> V_154 = V_155 ;
V_49 = F_59 ( V_103 ) ;
...
int V_49 ;
V_4 -> V_113 = V_156 ;
V_4 -> V_113 . V_157 = & V_4 -> V_104 ;
V_4 -> V_113 . V_158 = & V_4 -> V_51 ;
V_4 -> V_113 . V_157 -> V_158 = & V_4 -> V_159 ;
