...
{
const struct V_63 * V_64 = V_18 -> V_65 ;
return F_35 ( V_42 , V_43 , L_13 , V_64 -> string ) ;
}
static T_3 F_50 ( struct V_67 * V_68 ,
struct V_69 * V_70 , char * V_71 )
{
int V_72 ;
struct V_73 * V_74 = F_51 ( V_68 ) ;
...
static T_3 F_52 ( struct V_67 * V_68 ,
struct V_69 * V_70 ,
...
static T_4 int F_55 ( struct V_69 * V_70 ,
...
F_2 ( ! V_18 -> V_79 ) ;
if ( ! V_70 -> V_80 ) {
V_70 -> V_80 = F_56 ( sizeof( * V_70 -> V_80 ) , V_6 ) ;
if ( ! V_70 -> V_80 )
return - V_41 ;
V_70 -> V_80 -> V_81 . V_21 = L_20 ;
V_70 -> V_80 -> V_81 . V_82 = F_56 ( sizeof( V_70 -> V_80 -> V_81 . V_82 [ 0 ] ) ,
V_6 ) ;
...
F_58 ( & V_70 -> V_80 -> V_82 [ V_70 -> V_80 -> V_37 ] . V_68 . V_83 ) ;
V_70 -> V_80 -> V_82 [ V_70 -> V_80 -> V_37 ] . V_11 = V_18 ;
V_70 -> V_80 -> V_82 [ V_70 -> V_80 -> V_37 ] . V_68 . V_84 = F_50 ;
if ( ( V_18 -> V_79 & ( V_85 | V_86 | V_87 ) ) != 0 )
V_70 -> V_80 -> V_82 [ V_70 -> V_80 -> V_37 ] . V_68 . V_88 = F_52 ;
else
...
if ( V_90 [ V_16 ] . V_79 == 0 )
continue;
V_30 = F_55 ( & V_2 -> V_91 , & V_90 [ V_16 ] , V_90 [ V_16 ] . V_21 ) ;
if ( V_30 ) {
F_59 ( & V_2 -> V_91 ) ;
return V_30 ;
}
...
if ( ! V_25 )
return 0 ;
V_30 = F_61 ( & V_2 -> V_91 . V_92 , & V_2 -> V_91 . V_80 -> V_81 ) ;
if ( V_30 )
F_59 ( & V_2 -> V_91 ) ;
return V_30 ;
}
...
{
if ( V_2 -> V_91 . V_80 ) {
F_63 ( & V_2 -> V_91 . V_92 , & V_2 -> V_91 . V_80 -> V_81 ) ;
F_59 ( & V_2 -> V_91 ) ;
}
}
void F_64 ( const struct V_17 * V_25 , unsigned V_37 )
{
unsigned int V_16 ;
...
static struct V_69 * T_5 F_65 ( const char * V_21 )
{
struct V_69 * V_70 ;
struct V_93 * V_92 ;
int V_30 ;
...
V_70 = F_56 ( sizeof( struct V_69 ) , V_6 ) ;
F_2 ( ! V_70 ) ;
V_70 -> V_2 = V_95 ;
V_70 -> V_92 . V_96 = V_94 ;
V_30 = F_68 ( & V_70 -> V_92 , & V_97 , NULL ,
L_21 , V_21 ) ;
#ifdef F_69
if ( ! V_30 )
V_30 = F_70 ( & V_70 -> V_92 , & V_98 . V_83 ) ;
#endif
if ( V_30 ) {
F_71 ( & V_70 -> V_92 ) ;
F_72 ( L_22 ,
...
static void T_5 F_74 ( const char * V_21 ,
const struct V_17 * V_90 ,
unsigned int V_99 )
{
struct V_69 * V_70 ;
...
return;
if ( V_70 -> V_80 )
F_63 ( & V_70 -> V_92 , & V_70 -> V_80 -> V_81 ) ;
V_30 = F_55 ( V_70 , V_90 , V_90 -> V_21 + V_99 ) ;
F_2 ( V_30 ) ;
V_30 = F_61 ( & V_70 -> V_92 , & V_70 -> V_80 -> V_81 ) ;
F_2 ( V_30 ) ;
F_75 ( & V_70 -> V_92 , V_100 ) ;
F_71 ( & V_70 -> V_92 ) ;
}
...
F_77 ( V_102 , V_18 -> V_21 , V_101 ) ;
}
F_74 ( V_102 , V_18 , V_101 ) ;
}
}
...
return F_35 ( V_71 , V_43 , L_13 , V_108 -> V_109 ) ;
}
...
V_70 = F_65 ( V_108 -> V_112 ) ;
if ( V_70 ) {
V_30 = F_70 ( & V_70 -> V_92 , & V_108 -> V_68 . V_83 ) ;
F_81 ( V_30 ) ;
F_75 ( & V_70 -> V_92 , V_100 ) ;
F_71 ( & V_70 -> V_92 ) ;
}
...
{
struct V_69 * V_70 = F_67 ( V_92 ) ;
F_88 ( V_70 -> V_116 ) ;
}
static int T_5 F_89 ( void )
{
V_94 = F_90 ( L_24 , & V_117 , NULL ) ;
if ( ! V_94 ) {
F_91 ( V_118 L_25 ,
__FILE__ , __LINE__ ) ;
return - V_41 ;
