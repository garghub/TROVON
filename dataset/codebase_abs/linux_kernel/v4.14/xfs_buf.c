...
if ( V_150 -> V_152 ) {
int error = F_139 ( V_150 -> V_152 ) ;
F_140 ( & V_2 -> V_140 , 0 , error ) ;
}
if ( ! V_2 -> V_121 && F_1 ( V_2 ) && ( V_2 -> V_7 & V_108 ) )
F_141 ( V_2 -> V_3 , F_2 ( V_2 ) ) ;
...
V_162:
F_70 ( & V_2 -> V_153 ) ;
V_160 = F_144 ( V_159 , V_163 ) ;
V_150 = F_145 ( V_164 , V_160 ) ;
F_146 ( V_150 , V_2 -> V_13 -> V_116 ) ;
V_150 -> V_165 . V_166 = V_161 ;
V_150 -> V_167 = F_138 ;
V_150 -> V_151 = V_2 ;
F_147 ( V_150 , V_156 , V_157 ) ;
for (; V_59 && V_160 ; V_160 -- , V_158 ++ ) {
int V_168 , V_60 = V_5 - V_61 ;
if ( V_60 > V_59 )
V_60 = V_59 ;
V_168 = F_148 ( V_150 , V_2 -> V_53 [ V_158 ] , V_60 ,
V_61 ) ;
if ( V_168 < V_60 )
break;
V_61 = 0 ;
...
struct V_183 * V_184 = V_2 -> V_13 -> V_49 ;
if ( F_152 ( & V_184 -> V_97 ) ) {
F_79 ( V_184 ,
L_6 ,
...
F_143 ( V_2 , V_34 , & V_61 , & V_59 , V_156 , V_157 ) ;
if ( V_2 -> V_121 )
break;
if ( V_59 <= 0 )
break;
...
while ( V_188 < V_192 ) {
struct V_56 * V_56 ;
int V_158 , V_193 , V_194 ;
V_158 = ( V_188 + V_2 -> V_6 ) >> V_67 ;
V_193 = ( V_188 + V_2 -> V_6 ) & ~ V_66 ;
V_56 = V_2 -> V_53 [ V_158 ] ;
V_194 = F_49 ( T_4 , V_5 - V_193 ,
F_43 ( V_2 -> V_46 ) - V_188 ) ;
ASSERT ( ( V_194 + V_193 ) <= V_5 ) ;
switch ( V_191 ) {
case V_195 :
memset ( F_51 ( V_56 ) + V_193 , 0 , V_194 ) ;
break;
case V_196 :
memcpy ( V_190 , F_51 ( V_56 ) + V_193 , V_194 ) ;
break;
case V_197 :
memcpy ( F_51 ( V_56 ) + V_193 , V_190 , V_194 ) ;
}
V_188 += V_194 ;
V_190 += V_194 ;
}
...
void * V_83 )
{
struct V_1 * V_2 = F_129 ( V_200 , struct V_1 , V_20 ) ;
struct V_199 * V_204 = V_83 ;
if ( F_16 ( & V_2 -> V_21 ) > 1 ) {
F_166 ( V_2 , V_51 ) ;
return V_205 ;
}
...
F_170 ( V_204 ) ;
int V_207 = 0 ;
while ( F_171 ( & V_91 -> V_14 ) )
F_172 ( 100 ) ;
F_173 ( V_91 -> V_49 -> V_173 ) ;
while ( F_174 ( & V_91 -> V_19 ) ) {
F_175 ( & V_91 -> V_19 , F_165 ,
& V_204 , V_208 ) ;
while ( ! F_38 ( & V_204 ) ) {
struct V_1 * V_2 ;
V_2 = F_176 ( & V_204 , struct V_1 , V_20 ) ;
F_177 ( & V_2 -> V_20 ) ;
if ( V_2 -> V_7 & V_148 ) {
F_65 ( V_91 -> V_49 ,
L_7 ,
...
struct V_212 * V_213 )
{
struct V_29 * V_91 = F_129 ( V_211 ,
struct V_29 , V_214 ) ;
F_170 ( V_204 ) ;
unsigned long V_215 ;
V_215 = F_181 ( & V_91 -> V_19 , V_213 ,
F_178 , & V_204 ) ;
while ( ! F_38 ( & V_204 ) ) {
struct V_1 * V_2 ;
V_2 = F_176 ( & V_204 , struct V_1 , V_20 ) ;
...
V_91 -> V_95 = V_216 ;
V_91 -> V_96 = V_216 - 1 ;
if ( F_190 ( V_91 -> V_116 , V_216 ) ) {
F_79 ( V_91 -> V_49 ,
L_9 ,
V_216 , V_91 -> V_116 ) ;
return - V_217 ;
}
V_91 -> V_218 = F_191 ( V_91 -> V_116 ) ;
V_91 -> V_219 = F_191 ( V_91 -> V_116 ) - 1 ;
return 0 ;
}
STATIC int
F_192 (
...
{
T_11 * V_91 ;
V_91 = F_18 ( sizeof( * V_91 ) , V_224 | V_27 ) ;
V_91 -> V_49 = V_184 ;
V_91 -> V_225 = V_221 -> V_226 ;
V_91 -> V_116 = V_221 ;
V_91 -> V_227 = V_223 ;
if ( F_192 ( V_91 , V_221 ) )
goto error;
if ( F_194 ( & V_91 -> V_19 ) )
goto error;
if ( F_195 ( & V_91 -> V_14 , 0 , V_228 ) )
goto error;
V_91 -> V_214 . V_229 = F_182 ;
V_91 -> V_214 . V_230 = F_180 ;
V_91 -> V_214 . V_231 = V_232 ;
V_91 -> V_214 . V_33 = V_233 ;
F_196 ( & V_91 -> V_214 ) ;
return V_91 ;
error:
F_20 ( V_91 ) ;
...
struct V_1 * V_2 ;
while ( ! F_38 ( V_234 ) ) {
V_2 = F_176 ( V_234 , struct V_1 , V_40 ) ;
F_75 ( V_2 ) ;
V_2 -> V_7 &= ~ V_16 ;
F_177 ( & V_2 -> V_40 ) ;
F_80 ( V_2 ) ;
...
struct V_199 * V_237 )
{
struct V_1 * V_238 = F_129 ( V_236 , struct V_1 , V_40 ) ;
struct V_1 * V_2 = F_129 ( V_237 , struct V_1 , V_40 ) ;
T_7 V_239 ;
V_239 = V_238 -> V_23 [ 0 ] . V_43 - V_2 -> V_23 [ 0 ] . V_43 ;
if ( V_239 < 0 )
return - 1 ;
if ( V_239 > 0 )
return 1 ;
...
int V_244 = 0 ;
struct V_171 V_172 ;
F_204 ( NULL , V_240 , F_202 ) ;
F_155 ( & V_172 ) ;
F_205 (bp, n, buffer_list, b_list) {
if ( ! V_241 ) {
if ( F_206 ( V_2 ) ) {
V_244 ++ ;
continue;
...
F_203 ( V_240 , & V_241 ) ;
while ( ! F_38 ( & V_241 ) ) {
V_2 = F_176 ( & V_241 , struct V_1 , V_40 ) ;
F_177 ( & V_2 -> V_40 ) ;
F_75 ( V_2 ) ;
V_245 = V_2 -> V_121 ;
F_80 ( V_2 ) ;
