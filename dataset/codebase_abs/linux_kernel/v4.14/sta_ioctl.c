...
T_1 V_342 = V_232 , V_343 ;
if ( ! V_232 ) {
V_22 -> V_344 = 0 ;
V_22 -> V_345 . V_346 = false ;
return 0 ;
} else if ( ! V_231 ||
V_232 <= sizeof( struct V_347 ) ) {
return - 1 ;
}
V_339 = (struct V_338 * ) V_231 ;
while ( V_339 ) {
V_343 = V_339 -> V_48 + sizeof( struct V_347 ) ;
if ( V_339 -> V_348 == V_237 ) {
F_52 ( V_22 , ( T_2 * ) V_339 , V_343 ) ;
V_22 -> V_345 . V_346 = false ;
goto V_349;
}
if ( V_339 -> V_348 == V_241 ) {
F_53 ( V_22 , ( T_2 * ) V_339 ,
V_343 ) ;
goto V_349;
}
if ( V_339 -> V_348 == V_235 ) {
if ( ! memcmp ( V_339 -> V_350 , V_340 ,
sizeof( V_340 ) ) ) {
F_52 ( V_22 , ( T_2 * ) V_339 ,
V_343 ) ;
V_22 -> V_345 . V_346 = false ;
...
if ( V_343 <
( sizeof( V_22 -> V_351 ) - V_22 -> V_344 ) ) {
memcpy ( V_22 -> V_351 + V_22 -> V_344 ,
( T_2 * ) V_339 , V_343 ) ;
V_22 -> V_344 += V_343 ;
}
V_349:
V_342 -= V_343 ;
if ( V_342 <= sizeof( struct V_347 ) )
V_339 = NULL ;
else
V_339 = (struct V_338 * )
( ( ( T_2 * ) V_339 ) + V_343 ) ;
...
int
F_73 ( struct V_21 * V_22 , const T_2 * V_360 , int V_232 )
{
struct V_352 V_353 ;
if ( V_232 > V_361 )
return - V_362 ;
