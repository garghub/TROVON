...
V_2 -> V_212 = 0 ;
V_2 -> V_159 = F_75 ( V_53 , V_213 , L_9 , V_2 -> V_2 ,
V_2 -> V_212 ) ;
if ( ! V_2 -> V_159 ) {
V_49 = - V_214 ;
goto V_145;
...
if ( F_78 ( V_210 ) ) {
unsigned long V_217 ;
V_2 -> V_218 = F_75 ( V_53 , V_213 , L_12 ,
V_2 -> V_159 ) ;
if ( ! V_2 -> V_218 ) {
V_49 = - V_214 ;
goto V_145;
...
V_2 -> V_210 = F_81 ( V_210 ) ;
}
V_2 -> V_207 = F_82 ( V_208 , NULL ) ;
if ( F_83 ( V_2 -> V_207 ) ) {
F_31 ( V_53 , L_14 , V_2 -> V_159 ) ;
goto V_211;
}
V_49 = F_84 ( V_53 , F_70 , V_2 ) ;
if ( V_49 < 0 ) {
F_71 ( V_2 -> V_207 ) ;
goto V_145;
}
...
static int F_93 ( struct V_185 * V_52 )
{
...
struct V_186 * V_208 ;
int V_226 , V_17 , V_49 ;
V_51 = F_94 ( V_53 , sizeof( * V_51 ) , V_213 ) ;
if ( ! V_51 )
return - V_214 ;
V_51 -> V_52 = V_52 ;
F_95 ( V_52 , V_51 ) ;
...
V_51 -> V_160 . V_50 = F_98 ( T_5 ,
V_228 ,
F_44 ( & V_51 -> V_65 ) ) ;
} else
V_51 -> V_160 = V_51 -> V_65 ;
V_49 = F_99 ( V_187 , & V_51 -> V_164 ) ;
if ( V_49 ) {
F_31 ( V_53 , L_17 , V_49 ) ;
return V_49 ;
}
V_226 = F_100 ( V_187 ) ;
V_51 -> V_155 = F_101 ( V_53 , V_226 , sizeof( * V_51 -> V_155 ) , V_213 ) ;
if ( ! V_51 -> V_155 )
return - V_214 ;
V_17 = 0 ;
F_102 (np, child) {
...
F_104 ( V_17 , V_51 -> V_65 . V_66 + V_17 ) ;
F_52 ( V_51 ) ;
F_95 ( V_52 , V_51 ) ;
return 0 ;
}
