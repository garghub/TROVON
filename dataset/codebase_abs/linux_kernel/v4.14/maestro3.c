...
F_88 ( V_2 , 1 ) ;
F_89 ( V_2 ) ;
if ( F_136 ( V_169 -> V_134 , F_56 , V_327 ,
V_328 , V_2 ) ) {
...
#ifdef F_100
V_2 -> V_287 = F_137 ( sizeof( T_1 ) * ( V_329 + V_330 ) ) ;
if ( V_2 -> V_287 == NULL )
F_138 ( V_107 -> V_108 , L_14 ) ;
#endif
V_45 = F_139 ( V_107 , V_331 , V_2 , & V_206 ) ;
if ( V_45 < 0 )
goto V_326;
if ( ( V_45 = F_80 ( V_2 ) ) < 0 )
return V_45 ;
...
static int
F_140 ( struct V_249 * V_169 , const struct V_332 * V_333 )
{
static int V_108 ;
struct V_288 * V_107 ;
struct V_1 * V_2 ;
...
V_45 = F_141 ( & V_169 -> V_108 , V_7 [ V_108 ] , V_129 [ V_108 ] , V_339 ,
0 , & V_107 ) ;
if ( V_45 < 0 )
return V_45 ;
switch ( V_169 -> V_159 ) {
...
V_45 = F_120 ( V_107 , V_169 , V_243 [ V_108 ] , V_244 [ V_108 ] , & V_2 ) ;
if ( V_45 < 0 )
goto V_340;
V_107 -> V_44 = V_2 ;
sprintf ( V_107 -> V_341 , L_19 , V_107 -> V_161 ) ;
sprintf ( V_107 -> V_342 , L_20 ,
V_107 -> V_341 , V_2 -> V_5 , V_2 -> V_134 ) ;
V_45 = F_142 ( V_107 ) ;
if ( V_45 < 0 )
goto V_340;
#if 0
