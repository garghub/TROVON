...
static bool F_52 ( struct V_1 * V_1 , struct V_69 * V_69 )
{
struct V_9 * V_37 ;
struct V_6 * V_87 ;
T_1 V_88 ;
...
unsigned V_56 ;
unsigned V_31 ;
if ( F_53 ( V_69 -> V_89 & V_90 ) ) {
F_54 ( V_1 , V_69 ) ;
return true ;
}
if ( F_53 ( ( F_55 ( V_69 ) == V_91 ) ) ) {
F_42 ( V_1 , V_69 ) ;
return true ;
}
V_88 = V_69 -> V_70 . V_71 ;
...
static void F_59 ( struct V_93 * V_94 , struct V_1 * V_1 )
{
F_60 ( V_94 , L_33 , V_1 -> V_43 / 2 ) ;
return;
}
...
static void F_67 ( struct V_1 * V_1 , int V_110 )
{
}
