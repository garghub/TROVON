...
struct V_16 *
F_37 ( struct V_24 * V_31 , const char * V_6 , const char * V_32 , ... )
{
struct V_16 * V_18 ;
T_3 V_33 ;
va_start ( V_33 , V_32 ) ;
...
struct V_16 * F_38 ( struct V_1 * V_1 , const char * V_6 ,
const char * V_32 , ... )
{
struct V_16 * V_18 ;
T_3 V_33 ;
...
struct V_16 * F_39 ( struct V_24 * V_31 , const char * V_6 ,
const char * V_32 , ... )
{
struct V_16 * V_18 ;
T_3 V_33 ;
va_start ( V_33 , V_32 ) ;
V_18 = F_35 ( V_31 , V_6 , V_32 , V_33 ) ;
va_end ( V_33 ) ;
return V_18 ;
}
int F_40 ( const char * V_36 , const char * V_37 ,
...
if ( F_9 ( V_38 ) )
return F_10 ( V_38 ) ;
V_39 = F_38 ( V_38 , V_36 , V_37 ? L_7 : NULL ,
V_37 ) ;
F_24 ( V_38 ) ;
return V_39 ? 0 : - V_40 ;
}
void F_41 ( struct V_16 * V_18 )
{
F_17 ( & V_22 ) ;
F_42 ( & V_18 -> V_28 ) ;
F_21 ( & V_22 ) ;
...
static struct V_16 * F_44 ( struct V_24 * V_31 ,
const char * V_6 ,
const char * V_5 , ... )
{
struct V_16 * V_18 ;
...
int F_45 ( struct V_1 * V_1 , const char * V_6 ,
const char * V_5 )
{
struct V_16 * V_18 ;
if ( F_9 ( V_1 ) )
return F_10 ( V_1 ) ;
if ( V_5 )
V_18 = F_44 ( F_29 ( V_1 ) , V_6 , L_7 ,
V_5 ) ;
else
V_18 = F_44 ( F_29 ( V_1 ) , V_6 , NULL ) ;
return V_18 ? 0 : - V_41 ;
}
int F_46 ( struct V_24 * V_31 , const char * V_6 ,
const char * V_5 )
{
struct V_16 * V_18 ;
if ( F_9 ( V_31 ) )
return F_10 ( V_31 ) ;
if ( V_5 )
V_18 = F_44 ( V_31 , V_6 , L_7 , V_5 ) ;
else
V_18 = F_44 ( V_31 , V_6 , NULL ) ;
return V_18 ? 0 : - V_41 ;
}
