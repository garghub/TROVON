...
static void F_90 ( struct V_27 * V_28 , bool V_172 )
{
struct V_173 V_174 = { 0 } ;
int V_164 ;
if ( V_172 )
V_174 . V_175 = V_176 ;
else
V_174 . V_177 = V_176 ;
for ( V_164 = 1 ; V_164 <= V_28 -> V_101 ; V_164 ++ )
F_91 ( V_28 -> V_30 , V_164 , V_178 , & V_174 ) ;
}
static void F_92 ( struct V_104 * V_160 )
{
struct V_27 * V_28 ;
int V_32 , V_179 = sizeof( * V_28 ) ;
if ( ! F_93 ( V_160 ) )
return;
V_179 += V_160 -> V_180 * sizeof( struct V_6 ) ;
V_28 = F_94 ( V_179 , V_94 ) ;
if ( ! V_28 )
return;
V_28 -> V_101 = V_160 -> V_180 ;
V_28 -> V_30 = V_160 ;
V_32 = F_83 ( V_28 ) ;
if ( ! V_32 )
F_95 ( L_10 ) ;
F_96 ( V_160 , & V_181 , V_28 ) ;
F_90 ( V_28 , true ) ;
}
static void F_97 ( struct V_104 * V_160 ,
void * V_182 )
{
struct V_27 * V_28 = V_182 ;
if ( ! V_28 )
return;
F_95 ( L_11 ) ;
F_90 ( V_28 , false ) ;
