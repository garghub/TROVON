...
V_14 -> V_2 = F_12 ( V_36 + V_35 , sizeof( * V_14 -> V_2 ) , V_19 ) ;
if ( ! V_14 -> V_2 )
return - V_20 ;
V_14 -> V_28 = F_12 ( V_29 , sizeof( * V_14 -> V_28 ) , V_19 ) ;
if ( ! V_14 -> V_28 )
return - V_20 ;
...
V_31 -> V_45 . V_45 = 0 ;
V_31 -> V_45 . V_46 =
F_15 ( ( V_47 ) F_16 ( V_11 , V_48 ) ) ;
V_31 -> V_45 . V_21 = F_15 ( sizeof( * V_31 ) / 4 ) ;
F_17 ( F_18 ( V_49 ) > 0xF ) ;
V_43 = V_50 |
V_51 |
F_18 ( V_49 ) <<
V_52 ;
V_31 -> V_53 . V_43 = F_19 ( V_43 ) ;
V_42 = & V_31 -> V_54 ;
V_42 -> V_55 = F_13 ( V_24 -> V_56 -> V_57 ) ;
V_42 -> V_58 = F_13 ( V_24 -> V_56 -> V_59 ) ;
V_42 -> V_60 = F_13 ( V_24 -> V_56 -> V_61 ) ;
V_31 -> V_62 . V_63 =
F_13 ( V_24 -> V_64 [ V_24 -> V_65 ] -> V_66 ) ;
V_31 -> V_62 . V_67 =
F_20 ( V_68 ) ;
