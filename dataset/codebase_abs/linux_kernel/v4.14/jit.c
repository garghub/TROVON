...
{
return F_63 ( V_1 , V_3 , V_212 , false ) ;
}
static int F_113 ( struct V_1 * V_1 , struct V_2 * V_3 )
{
return F_63 ( V_1 , V_3 , V_177 , true ) ;
}
...
{
return F_64 ( V_1 , V_3 , V_212 , false ) ;
}
static int F_120 ( struct V_1 * V_1 , struct V_2 * V_3 )
{
return F_64 ( V_1 , V_3 , V_177 , true ) ;
}
static int F_121 ( struct V_1 * V_1 , struct V_2 * V_3 )
{
return F_62 ( V_1 , V_3 , V_187 , V_213 ) ;
}
static int F_122 ( struct V_1 * V_1 , struct V_2 * V_3 )
{
return F_62 ( V_1 , V_3 , V_188 , V_213 ) ;
}
static int F_123 ( struct V_1 * V_1 , struct V_2 * V_3 )
{
F_43 ( V_1 , V_89 , V_214 ) ;
return 0 ;
}
static void F_124 ( T_1 * V_215 , T_2 V_15 )
{
T_2 V_80 , V_81 ;
...
T_3 V_194 , V_216 ;
T_3 V_217 ;
F_126 (nfp_prog, meta, next) {
if ( V_3 -> V_190 )
continue;
if ( F_127 ( V_3 -> V_9 . V_218 ) != V_219 )
continue;
V_216 = F_9 ( V_1 , V_5 -> V_194 ) - 1 ;
if ( ! F_128 ( V_1 -> V_13 [ V_216 ] ) ) {
F_12 ( L_6 ,
...
V_217 <= V_216 ; V_217 ++ ) {
if ( ! F_128 ( V_1 -> V_13 [ V_217 ] ) )
continue;
F_124 ( & V_1 -> V_13 [ V_217 ] , V_5 -> V_194 ) ;
}
}
...
static int
F_137 ( struct V_1 * V_1 , const struct V_191 * V_13 ,
unsigned int V_236 )
{
unsigned int V_172 ;
for ( V_172 = 0 ; V_172 < V_236 ; V_172 ++ ) {
struct V_2 * V_3 ;
V_3 = F_138 ( sizeof( * V_3 ) , V_237 ) ;
if ( ! V_3 )
return - V_238 ;
V_3 -> V_9 = V_13 [ V_172 ] ;
V_3 -> V_239 = V_172 ;
F_139 ( & V_3 -> V_4 , & V_1 -> V_6 ) ;
}
return 0 ;
}
...
for ( V_172 = 0 , V_247 = 0 ; V_172 < F_142 ( V_246 ) ; V_172 ++ ) {
if ( ! V_244 [ V_172 ] )
continue;
V_246 [ V_172 ] = V_247 ++ ;
}
...
F_126 (nfp_prog, meta1, meta2) {
struct V_191 V_9 , V_5 ;
V_9 = V_249 -> V_9 ;
V_5 = V_250 -> V_9 ;
if ( F_127 ( V_9 . V_218 ) != V_255 )
continue;
if ( F_144 ( V_9 . V_218 ) != V_256 &&
F_144 ( V_9 . V_218 ) != V_257 )
continue;
if ( V_5 . V_218 != ( V_240 | V_258 | V_259 ) )
continue;
if ( ! V_251 [ F_145 ( V_9 . V_218 ) ] )
continue;
if ( V_251 [ F_145 ( V_9 . V_218 ) ] != V_5 . V_105 )
continue;
...
F_147 (nfp_prog, meta1, meta2, meta3) {
...
int
F_149 ( struct V_265 * V_266 , void * V_267 ,
enum V_268 V_206 ,
...
V_1 -> V_14 = V_269 ;
V_1 -> V_228 = V_270 ;
V_205 = F_137 ( V_1 , V_266 -> V_274 , V_266 -> V_200 ) ;
if ( V_205 )
goto V_275;
V_205 = F_151 ( V_1 , V_266 ) ;
if ( V_205 )
goto V_275;
V_205 = F_148 ( V_1 ) ;
if ( V_205 )
