...
int V_36 ;
T_1 V_18 ;
V_2 = F_65 ( & V_21 -> V_21 , sizeof( struct V_1 ) , V_147 ) ;
if ( ! V_2 )
return - V_148 ;
...
V_2 -> V_107 = V_107 ;
V_2 -> V_7 = F_68 ( & V_21 -> V_21 , V_107 ) ;
if ( F_37 ( V_2 -> V_7 ) )
return F_38 ( V_2 -> V_7 ) ;
V_36 = F_69 ( V_21 -> V_21 . V_150 , L_22 , & V_18 ) ;
V_2 -> V_18 = V_36 ? V_19 : V_18 ;
V_2 -> V_17 = 1 ;
V_146 = F_70 ( V_151 , & V_21 -> V_21 ) ;
if ( V_146 ) {
const struct V_152 * V_153 = V_146 -> V_4 ;
V_2 -> V_17 = V_153 -> V_17 ;
if ( V_153 -> V_154 )
V_153 -> V_154 ( V_2 ) ;
}
...
V_144 -> V_155 = V_156 ;
V_144 -> V_157 = & V_158 ;
V_144 -> V_21 . V_159 = & V_21 -> V_21 ;
V_144 -> V_160 = 5 ;
V_144 -> V_161 = V_21 -> V_162 ;
V_144 -> V_21 . V_150 = V_21 -> V_21 . V_150 ;
F_76 ( V_144 -> V_163 , V_21 -> V_163 , sizeof( V_144 -> V_163 ) ) ;
F_77 ( & V_2 -> V_37 ) ;
F_78 ( & V_2 -> V_77 ) ;
V_36 = F_79 ( V_144 ) ;
if ( V_36 < 0 ) {
...
F_80 ( & V_21 -> V_21 , L_23 , V_144 -> V_161 , V_2 -> V_18 ) ;
return 0 ;
}
static int F_81 ( struct V_137 * V_21 )
{
...
static int F_85 ( struct V_83 * V_21 )
{
return 0 ;
}
