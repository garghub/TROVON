...
if ( ! V_76 )
return NULL ;
V_74 = F_4 ( V_76 -> V_87 , V_71 , sizeof( V_76 -> V_87 ) ) ;
if ( V_74 >= sizeof( V_76 -> V_87 ) ) {
F_15 ( V_76 ) ;
return NULL ;
}
F_16 ( & V_76 -> V_80 ) ;
...
F_56 ( & V_3 -> V_113 . V_114 . V_116 , V_117 ) ;
V_110 = V_3 -> V_113 . V_114 . V_118 ;
if ( V_110 ) {
F_57 ( & V_110 -> V_119 ) ;
if ( V_110 -> V_120 )
V_110 -> V_121 = F_58 () +
