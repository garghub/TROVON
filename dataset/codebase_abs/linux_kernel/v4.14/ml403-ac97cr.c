...
int V_40 ;
int V_123 = V_69 -> V_148 ;
if ( V_123 >= V_149 )
return - V_150 ;
if ( ! V_151 [ V_123 ] )
return - V_152 ;
V_40 = F_77 ( & V_69 -> V_123 , V_153 [ V_123 ] , V_148 [ V_123 ] , V_154 ,
0 , & V_110 ) ;
if ( V_40 < 0 )
return V_40 ;
...
F_3 ( V_74 , L_77 ) ;
strcpy ( V_110 -> V_155 , V_156 ) ;
strcpy ( V_110 -> V_157 , L_78 ) ;
sprintf ( V_110 -> V_158 , L_79 ,
V_110 -> V_157 , V_110 -> V_155 ,
