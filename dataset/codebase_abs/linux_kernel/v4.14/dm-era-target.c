...
{
F_123 ( V_121 , V_95 -> V_126 -> V_89 ) ;
}
static void F_124 ( struct V_95 * V_95 )
{
if ( ! F_125 ( & V_95 -> V_127 ) )
F_126 ( V_95 -> V_128 , & V_95 -> V_129 ) ;
}
...
static void F_128 ( struct V_95 * V_95 )
{
int V_8 ;
...
F_129 ( & V_132 ) ;
F_130 ( & V_95 -> V_135 ) ;
F_131 ( & V_131 , & V_95 -> V_131 ) ;
F_129 ( & V_95 -> V_131 ) ;
F_132 ( & V_95 -> V_135 ) ;
while ( ( V_121 = F_133 ( & V_131 ) ) ) {
...
if ( V_134 )
while ( ( V_121 = F_133 ( & V_132 ) ) )
F_135 ( V_121 ) ;
else
while ( ( V_121 = F_133 ( & V_132 ) ) )
F_136 ( V_121 ) ;
}
static void F_137 ( struct V_95 * V_95 )
{
int V_8 ;
bool V_136 = false ;
struct V_137 V_138 ;
struct V_139 * V_139 , * V_140 ;
F_138 ( & V_138 ) ;
F_130 ( & V_95 -> V_141 ) ;
F_139 ( & V_95 -> V_142 , & V_138 ) ;
F_132 ( & V_95 -> V_141 ) ;
F_140 (rpc, tmp, &calls, list) {
V_139 -> V_18 = V_139 -> V_143 ? V_139 -> V_143 ( V_95 -> V_11 ) : V_139 -> V_144 ( V_95 -> V_11 , V_139 -> V_107 ) ;
V_136 = true ;
}
if ( V_136 ) {
V_8 = F_104 ( V_95 -> V_11 ) ;
...
static void F_142 ( struct V_95 * V_95 )
{
if ( V_95 -> V_11 -> V_85 ) {
...
static void F_143 ( struct V_145 * V_2 )
{
struct V_95 * V_95 = F_144 ( V_2 , struct V_95 , V_129 ) ;
F_142 ( V_95 ) ;
F_127 ( V_95 ) ;
F_128 ( V_95 ) ;
F_137 ( V_95 ) ;
}
static void F_145 ( struct V_95 * V_95 , struct V_121 * V_121 )
{
F_130 ( & V_95 -> V_135 ) ;
F_134 ( & V_95 -> V_131 , V_121 ) ;
F_132 ( & V_95 -> V_135 ) ;
F_124 ( V_95 ) ;
}
static int F_146 ( struct V_95 * V_95 , struct V_139 * V_139 )
{
V_139 -> V_18 = 0 ;
F_147 ( & V_139 -> F_141 ) ;
F_130 ( & V_95 -> V_141 ) ;
F_148 ( & V_139 -> V_146 , & V_95 -> V_142 ) ;
F_132 ( & V_95 -> V_141 ) ;
F_124 ( V_95 ) ;
F_149 ( & V_139 -> F_141 ) ;
return V_139 -> V_18 ;
}
static int F_150 ( struct V_95 * V_95 , int (* F_151)( struct V_42 * ) )
{
struct V_139 V_139 ;
V_139 . V_143 = F_151 ;
V_139 . V_144 = NULL ;
return F_146 ( V_95 , & V_139 ) ;
}
static int F_152 ( struct V_95 * V_95 ,
int (* F_151)( struct V_42 * , void * ) , void * V_107 )
{
struct V_139 V_139 ;
V_139 . V_143 = NULL ;
V_139 . V_144 = F_151 ;
...
static void F_153 ( struct V_95 * V_95 )
{
F_154 ( & V_95 -> V_127 , 0 ) ;
}
static void F_155 ( struct V_95 * V_95 )
{
F_154 ( & V_95 -> V_127 , 1 ) ;
F_156 ( V_95 -> V_128 ) ;
}
static int F_157 ( struct V_147 * V_148 , int V_149 )
{
struct V_150 * V_151 = F_158 ( V_148 -> V_89 ) ;
return F_159 ( V_151 -> V_152 , V_149 ) ;
}
static int F_160 ( struct V_153 * V_154 , int V_149 )
{
struct V_95 * V_95 = F_144 ( V_154 , struct V_95 , V_155 ) ;
return F_157 ( V_95 -> V_126 , V_149 ) ;
}
static void F_161 ( struct V_95 * V_95 )
{
if ( V_95 -> V_11 )
F_90 ( V_95 -> V_11 ) ;
if ( V_95 -> V_128 )
F_162 ( V_95 -> V_128 ) ;
if ( V_95 -> V_126 )
F_163 ( V_95 -> V_156 , V_95 -> V_126 ) ;
if ( V_95 -> V_157 )
F_163 ( V_95 -> V_156 , V_95 -> V_157 ) ;
F_88 ( V_95 ) ;
}
static T_1 F_164 ( struct V_95 * V_95 )
{
return F_165 ( V_95 -> V_156 -> V_158 , V_95 -> V_125 ) ;
}
static bool F_166 ( T_1 V_78 )
{
bool V_159 = V_78 > 0 ;
bool V_160 = ( V_78 & ( V_161 - 1 ) ) == 0 ;
return V_159 && V_160 ;
}
static int F_167 ( struct V_162 * V_156 , unsigned V_163 , char * * V_164 )
{
int V_8 ;
char V_165 ;
struct V_95 * V_95 ;
...
V_95 -> V_156 = V_156 ;
V_8 = F_168 ( V_156 , V_164 [ 0 ] , V_166 | V_167 , & V_95 -> V_157 ) ;
if ( V_8 ) {
V_156 -> error = L_46 ;
F_161 ( V_95 ) ;
return - V_36 ;
}
V_8 = F_168 ( V_156 , V_164 [ 1 ] , V_166 | V_167 , & V_95 -> V_126 ) ;
if ( V_8 ) {
V_156 -> error = L_47 ;
F_161 ( V_95 ) ;
return - V_36 ;
}
V_8 = sscanf ( V_164 [ 2 ] , L_48 , & V_95 -> V_125 , & V_165 ) ;
if ( V_8 != 1 ) {
V_156 -> error = L_49 ;
F_161 ( V_95 ) ;
return - V_36 ;
}
V_8 = F_169 ( V_156 , V_95 -> V_125 ) ;
if ( V_8 ) {
V_156 -> error = L_50 ;
F_161 ( V_95 ) ;
return - V_36 ;
...
V_95 -> V_120 = F_170 ( V_95 -> V_125 ) ;
V_11 = F_86 ( V_95 -> V_157 -> V_89 , V_95 -> V_125 , true ) ;
if ( F_70 ( V_11 ) ) {
V_156 -> error = L_52 ;
F_161 ( V_95 ) ;
return F_71 ( V_11 ) ;
...
V_95 -> V_128 = F_171 ( L_54 V_168 , V_169 ) ;
if ( ! V_95 -> V_128 ) {
V_156 -> error = L_55 ;
F_161 ( V_95 ) ;
return - V_14 ;
}
F_172 ( & V_95 -> V_129 , F_143 ) ;
F_173 ( & V_95 -> V_135 ) ;
F_129 ( & V_95 -> V_131 ) ;
F_173 ( & V_95 -> V_141 ) ;
F_138 ( & V_95 -> V_142 ) ;
...
V_156 -> V_173 = 1 ;
V_156 -> V_174 = true ;
V_95 -> V_155 . V_175 = F_160 ;
F_174 ( V_156 -> V_176 , & V_95 -> V_155 ) ;
return 0 ;
}
static void F_175 ( struct V_162 * V_156 )
{
F_161 ( V_156 -> V_170 ) ;
}
static int F_176 ( struct V_162 * V_156 , struct V_121 * V_121 )
{
struct V_95 * V_95 = V_156 -> V_170 ;
T_1 V_15 = F_120 ( V_95 , V_121 ) ;
F_122 ( V_95 , V_121 ) ;
if ( ! ( V_121 -> V_177 & V_178 ) &&
( F_177 ( V_121 ) == V_179 ) &&
...
static void F_178 ( struct V_162 * V_156 )
{
int V_8 ;
struct V_95 * V_95 = V_156 -> V_170 ;
V_8 = F_150 ( V_95 , F_94 ) ;
...
static int F_179 ( struct V_162 * V_156 )
{
int V_8 ;
struct V_95 * V_95 = V_156 -> V_170 ;
T_1 V_108 = F_164 ( V_95 ) ;
if ( V_95 -> V_10 != V_108 ) {
V_8 = F_152 ( V_95 , F_92 , & V_108 ) ;
if ( V_8 )
return V_8 ;
V_95 -> V_10 = V_108 ;
}
...
static void F_180 ( struct V_162 * V_156 , T_7 type ,
unsigned V_182 , char * V_18 , unsigned V_183 )
{
int V_8 ;
struct V_95 * V_95 = V_156 -> V_170 ;
T_8 V_184 = 0 ;
...
switch ( type ) {
case V_188 :
V_8 = F_152 ( V_95 , F_116 , & V_185 ) ;
if ( V_8 )
goto V_189;
F_181 ( L_58 ,
( unsigned ) ( V_80 >> V_81 ) ,
( unsigned long long ) V_185 . V_117 ,
( unsigned long long ) V_185 . V_118 ,
( unsigned ) V_185 . V_95 ) ;
if ( V_185 . V_119 != V_45 )
F_181 ( L_59 , V_185 . V_119 ) ;
else
F_181 ( L_60 ) ;
break;
case V_190 :
F_182 ( V_186 , V_95 -> V_157 -> V_89 -> V_191 ) ;
F_181 ( L_61 , V_186 ) ;
F_182 ( V_186 , V_95 -> V_126 -> V_89 -> V_191 ) ;
F_181 ( L_62 , V_186 , V_95 -> V_125 ) ;
break;
}
return;
V_189:
...
static int F_183 ( struct V_162 * V_156 , unsigned V_163 , char * * V_164 )
{
struct V_95 * V_95 = V_156 -> V_170 ;
if ( V_163 != 1 ) {
F_10 ( L_64 ) ;
...
if ( ! strcasecmp ( V_164 [ 0 ] , L_65 ) )
return F_150 ( V_95 , F_106 ) ;
if ( ! strcasecmp ( V_164 [ 0 ] , L_66 ) )
return F_150 ( V_95 , F_107 ) ;
if ( ! strcasecmp ( V_164 [ 0 ] , L_67 ) )
return F_150 ( V_95 , F_112 ) ;
F_10 ( L_68 , V_164 [ 0 ] ) ;
return - V_36 ;
}
static T_6 F_184 ( struct V_147 * V_148 )
{
return F_185 ( V_148 -> V_89 -> V_192 ) >> V_81 ;
}
static int F_186 ( struct V_162 * V_156 ,
T_9 F_151 , void * V_193 )
{
struct V_95 * V_95 = V_156 -> V_170 ;
return F_151 ( V_156 , V_95 -> V_126 , 0 , F_184 ( V_95 -> V_126 ) , V_193 ) ;
}
static void F_187 ( struct V_162 * V_156 , struct V_194 * V_195 )
{
struct V_95 * V_95 = V_156 -> V_170 ;
T_5 V_196 = V_195 -> V_197 >> V_81 ;
if ( V_196 < V_95 -> V_125 ||
F_188 ( V_196 , V_95 -> V_125 ) ) {
F_189 ( V_195 , 0 ) ;
F_190 ( V_195 , V_95 -> V_125 << V_81 ) ;
}
}
