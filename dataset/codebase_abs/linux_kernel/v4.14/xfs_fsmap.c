...
struct V_12 V_96 ;
T_3 V_63 ;
V_63 = F_23 ( V_49 , V_52 -> V_92 . V_93 . V_56 ,
V_46 -> V_97 ) ;
V_96 . V_59 = V_46 -> V_97 ;
V_96 . V_60 = V_46 -> V_98 ;
V_96 . V_14 = V_16 ;
...
struct V_12 V_100 ;
int error ;
V_45 -> V_68 . V_59 = F_26 ( V_49 , V_99 [ 0 ] . V_7 ) ;
V_45 -> V_68 . V_80 = F_26 ( V_49 , V_99 [ 0 ] . V_9 ) ;
error = F_5 ( & V_45 -> V_68 , V_99 ) ;
if ( error )
return error ;
V_45 -> V_68 . V_60 = 0 ;
F_24 ( & V_45 -> V_68 , & V_99 [ 0 ] ) ;
error = F_5 ( & V_45 -> V_101 , V_99 + 1 ) ;
if ( error )
return error ;
V_45 -> V_101 . V_59 = - 1U ;
V_45 -> V_101 . V_14 = V_102 ;
V_45 -> V_101 . V_80 = V_102 ;
V_45 -> V_101 . V_60 = 0 ;
V_45 -> V_101 . V_81 = V_103 | V_104 ;
V_45 -> V_76 = V_15 ;
F_27 ( V_49 , V_45 -> V_41 , V_45 -> V_56 , & V_45 -> V_68 ) ;
F_28 ( V_49 , V_45 -> V_41 , V_45 -> V_56 , & V_45 -> V_101 ) ;
if ( V_99 [ 0 ] . V_7 > 0 )
return 0 ;
V_100 . V_59 = 0 ;
V_100 . V_60 = V_49 -> V_55 . V_105 ;
V_100 . V_14 = V_22 ;
V_100 . V_80 = 0 ;
V_100 . V_81 = 0 ;
return F_14 ( V_43 , V_45 , & V_100 , 0 ) ;
}
STATIC int
F_29 (
struct V_42 * V_43 ,
...
if ( V_99 [ 1 ] . V_7 >= V_109 )
V_99 [ 1 ] . V_7 = V_109 - 1 ;
V_107 = F_26 ( V_49 , V_99 [ 0 ] . V_7 ) ;
V_108 = F_32 ( V_49 , V_99 [ 1 ] . V_7 ) ;
V_45 -> V_68 . V_59 = V_107 ;
error = F_5 ( & V_45 -> V_68 , & V_99 [ 0 ] ) ;
if ( error )
return error ;
V_45 -> V_68 . V_80 = F_26 ( V_49 , V_99 [ 0 ] . V_9 ) ;
V_45 -> V_68 . V_60 = 0 ;
F_24 ( & V_45 -> V_68 , & V_99 [ 0 ] ) ;
V_45 -> V_101 . V_59 = V_108 ;
error = F_5 ( & V_45 -> V_101 , & V_99 [ 1 ] ) ;
if ( error )
return error ;
V_45 -> V_101 . V_80 = F_26 ( V_49 , V_99 [ 1 ] . V_9 ) ;
V_45 -> V_101 . V_60 = 0 ;
F_24 ( & V_45 -> V_101 , & V_99 [ 1 ] ) ;
F_27 ( V_49 , V_45 -> V_41 , V_45 -> V_56 , & V_45 -> V_68 ) ;
F_28 ( V_49 , V_45 -> V_41 , V_45 -> V_56 , & V_45 -> V_101 ) ;
...
V_112 . V_97 = V_45 -> V_101 . V_59 ;
error = F_35 ( V_43 , & V_111 , & V_112 ,
F_29 , V_45 ) ;
if ( error )
goto V_115;
V_45 -> V_74 = true ;
error = F_29 ( V_43 , & V_112 , V_45 ) ;
if ( error )
goto V_115;
V_115:
...
if ( V_99 [ 1 ] . V_7 >= V_109 )
V_99 [ 1 ] . V_7 = V_109 - 1 ;
V_107 = F_39 ( V_49 , V_99 [ 0 ] . V_7 ) ;
V_108 = F_39 ( V_49 , V_99 [ 1 ] . V_7 ) ;
...
if ( V_45 -> V_56 == V_118 ) {
V_45 -> V_101 . V_59 = F_40 ( V_49 ,
V_108 ) ;
V_45 -> V_101 . V_80 = F_26 ( V_49 ,
V_99 [ 1 ] . V_9 ) ;
error = F_5 ( & V_45 -> V_101 , & V_99 [ 1 ] ) ;
if ( error )
goto V_115;
...
{
if ( V_45 -> V_74 )
return F_19 ( * V_120 , & V_45 -> V_101 , V_45 ) ;
* V_120 = F_45 ( V_43 -> V_50 , V_43 , V_45 -> V_58 ,
V_45 -> V_56 ) ;
return F_46 ( * V_120 , & V_45 -> V_68 , & V_45 -> V_101 ,
F_19 , V_45 ) ;
}
STATIC int
F_47 (
...
void * V_89 )
{
struct V_95 * V_121 = V_89 ;
if ( V_45 -> V_74 )
return F_22 ( * V_120 , & V_121 [ 1 ] , V_45 ) ;
* V_120 = F_49 ( V_43 -> V_50 , V_43 , V_45 -> V_58 ,
V_45 -> V_56 , V_122 ) ;
V_121 -> V_97 = V_45 -> V_68 . V_59 ;
V_121 [ 1 ] . V_97 = V_45 -> V_101 . V_59 ;
...
#endif
F_59 ( V_135 , V_136 , sizeof( struct V_38 ) ,
F_8 ) ;
