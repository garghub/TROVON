...
int V_100 ;
V_372 = F_270 ( sizeof( * V_372 ) , V_197 ) ;
if ( ! V_372 )
return;
F_113 ( & V_30 -> V_195 ) ;
...
if ( V_102 & V_243 ) {
V_417 -> V_288 . V_295 = F_294 ( V_418 , V_157 ) ;
...
int F_297 ( struct V_29 * V_30 , struct V_416 * V_423 ,
...
F_38 ( & V_417 -> V_420 -> V_421 ) ;
if ( ! F_6 ( & V_5 -> V_150 ) )
F_298 ( & V_5 -> V_150 , & V_417 -> V_420 -> V_435 ) ;
F_40 ( & V_417 -> V_420 -> V_421 ) ;
V_314:
F_100 ( V_5 ) ;
V_111:
...
int F_299 ( struct V_29 * V_30 , struct V_416 * V_423 ,
T_1 V_102 , T_1 V_161 )
{
struct V_4 * V_5 ;
struct V_292 args ;
...
void F_304 ( struct V_29 * V_30 , struct V_438 * V_420 )
{
struct V_4 * V_5 , * V_285 ;
F_8 ( V_30 ) ;
while ( 1 ) {
V_5 = F_303 ( V_30 , V_420 ) ;
if ( ! V_5 )
break;
F_29 ( V_5 ) ;
if ( V_5 -> V_10 & V_440 )
...
static void F_305 ( struct V_29 * V_30 , struct V_438 * V_420 )
{
struct V_4 * V_5 , * V_285 ;
while ( 1 ) {
V_5 = NULL ;
...
static int F_306 ( struct V_29 * V_30 , int V_187 , int V_308 )
{
struct V_203 * V_204 ;
struct V_317 * V_319 ;
int error ;
...
int F_307 ( struct V_29 * V_30 , struct V_438 * V_420 ,
int V_187 , int V_308 )
{
int error = 0 ;
if ( V_187 && ( V_187 != F_59 () ) ) {
error = F_306 ( V_30 , V_187 , V_308 ) ;
} else {
F_8 ( V_30 ) ;
