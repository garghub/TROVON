...
F_20 ( & V_95 -> V_80 ) ;
V_99 = 0 ;
F_38 (policy, &nrs->nrs_policy_list, pol_list) {
F_5 ( V_99 < V_98 ) ;
F_32 ( V_76 , & V_97 ) ;
if ( V_16 == 0 ) {
...
struct V_128 * V_129 ;
struct V_130 * V_131 ;
if ( V_126 -> V_132 && V_126 -> V_133 > V_39 -> V_134 &&
V_126 -> V_133 <= V_127 ) {
...
char V_154 [ V_155 ] ;
V_131 = V_126 -> V_132 ;
F_59 ( V_131 -> V_156 , V_154 , sizeof( V_154 ) ) ;
V_151 . V_157 = V_131 -> V_158 . V_157 ;
V_151 . V_159 = V_131 -> V_158 . V_159 ;
V_152 . V_157 = V_131 -> V_160 ;
V_152 . V_159 = 0 ;
V_153 = F_60 ( V_152 , V_151 ) ;
F_16 ( V_143 , L_35 ,
V_131 -> V_135 , V_154 ,
F_61 ( V_131 -> V_161 ) , V_131 -> V_162 ,
V_131 -> V_163 , F_62 ( V_131 ) ,
( V_164 ) V_131 -> V_158 . V_157 ,
( V_164 ) V_131 -> V_158 . V_159 / V_165 ,
( V_164 ) V_153 . V_157 ,
( V_164 ) ( V_153 . V_159 / V_165 ) ,
( V_164 ) ( V_131 -> V_160 - V_131 -> V_166 ) ) ;
if ( ! V_36 -> V_167 . V_168 )
F_63 ( V_143 , '\n' ) ;
else
V_36 -> V_167 . V_168 ( V_143 , V_126 -> V_132 ) ;
}
F_22 ( & V_39 -> V_146 ) ;
return V_17 ;
}
static int
F_64 ( struct V_169 * V_169 , struct V_44 * V_44 )
{
...
struct V_32 * V_175 ;
int V_17 ;
V_17 = F_65 ( V_44 , & V_171 ) ;
if ( V_17 )
return V_17 ;
V_175 = V_44 -> V_48 ;
V_175 -> V_37 = V_169 -> V_176 ;
return 0 ;
}
static int F_66 ( struct V_32 * V_33 , void * V_42 )
{
struct V_35 * V_36 = V_33 -> V_37 ;
struct V_38 * V_39 ;
struct V_177 V_178 ;
...
F_15 (svcpt, i, svc) {
V_180 = F_67 ( & V_39 -> V_184 ) ;
V_181 = V_39 -> V_184 . V_185 ;
V_179 = V_39 -> V_184 . V_186 ;
F_68 ( & V_178 , F_69 () - V_179 ) ;
F_16 ( V_33 , L_37
V_187 L_38 , L_39 ,
V_180 , V_181 , ( V_164 ) V_179 , F_70 ( & V_178 ) ) ;
F_71 ( V_33 , & V_39 -> V_184 ) ;
}
return 0 ;
}
...
struct V_35 * V_36 = F_24 ( V_59 , struct V_35 ,
V_63 ) ;
return sprintf ( V_62 , L_13 , V_36 -> V_188 ) ;
}
...
int F_80 ( struct V_190 * V_191 ,
struct V_35 * V_36 )
{
int V_17 ;
V_36 -> V_63 . V_190 = V_191 ;
F_81 ( & V_36 -> V_189 ) ;
V_17 = F_82 ( & V_36 -> V_63 , & V_192 , NULL ,
L_40 , V_36 -> V_137 ) ;
return V_17 ;
}
void F_83 ( struct V_7 * V_193 ,
struct V_35 * V_36 )
{
struct V_194 V_195 [] = {
{ . V_10 = L_41 ,
...
static const struct V_202 V_203 = {
. V_204 = V_205 ,
. V_206 = F_64 ,
. V_207 = V_208 ,
. V_209 = V_210 ,
...
int V_17 ;
F_6 ( V_193 , V_36 -> V_137 ,
L_45 , & V_36 -> V_213 ,
& V_36 -> V_214 ) ;
if ( F_84 ( V_36 -> V_213 ) )
return;
F_85 ( V_36 -> V_213 , V_195 , NULL ) ;
V_17 = F_86 ( V_36 -> V_213 , L_46 ,
0400 , & V_203 , V_36 ) ;
if ( V_17 )
F_51 ( L_47 ) ;
}
void F_87 ( struct V_215 * V_216 )
{
F_6 ( V_216 -> V_217 , NULL , L_45 ,
& V_216 -> V_218 ,
& V_216 -> V_219 ) ;
}
void F_88 ( struct V_130 * V_131 , long V_220 )
{
struct V_12 * V_15 ;
T_1 V_221 = F_89 ( V_131 -> V_222 ) ;
int V_223 = F_2 ( V_221 ) ;
V_15 = V_131 -> V_224 -> V_225 -> V_219 ;
if ( ! V_15 || V_223 <= 0 )
return;
F_5 ( V_223 < V_3 ) ;
if ( ! ( V_221 == V_226 || V_221 == V_227 ) )
F_90 ( V_15 , V_223 + V_21 , V_220 ) ;
}
void F_91 ( struct V_130 * V_131 , int V_228 )
{
struct V_12 * V_15 ;
int V_229 ;
if ( ! V_131 -> V_224 )
...
F_90 ( V_15 , V_229 , V_228 ) ;
}
void F_92 ( struct V_35 * V_36 )
{
if ( ! F_84 ( V_36 -> V_213 ) )
F_13 ( & V_36 -> V_213 ) ;
if ( V_36 -> V_214 )
...
T_4 V_46 , T_5 * V_47 )
{
struct V_215 * V_232 = ( (struct V_32 * ) V_44 -> V_48 ) -> V_37 ;
struct V_130 * V_131 ;
int V_17 ;
V_17 = F_95 ( V_232 ) ;
if ( V_17 )
return V_17 ;
V_131 = F_96 ( V_232 -> V_233 . V_234 . V_235 ) ;
F_97 ( & V_232 -> V_233 . V_234 . V_236 ) ;
if ( ! V_131 )
return - V_107 ;
V_131 -> V_237 = V_238 ;
V_17 = F_98 ( V_131 ) ;
...
int F_100 ( struct V_44 * V_44 , const char T_3 * V_45 ,
T_4 V_46 , T_5 * V_47 )
{
struct V_215 * V_232 = ( (struct V_32 * ) V_44 -> V_48 ) -> V_37 ;
struct V_239 * V_240 = V_232 -> V_233 . V_234 . V_235 ;
char * V_241 = NULL ;
char * V_242 ;
char * V_243 ;
int V_244 = 1 ;
const char V_245 [] = L_49 ;
const int V_246 = sizeof( V_245 ) - 1 ;
if ( V_46 > V_53 - 1 || V_46 <= V_246 )
return - V_117 ;
V_241 = F_43 ( V_46 + 1 , V_106 ) ;
if ( ! V_241 )
return - V_107 ;
if ( F_44 ( V_241 , V_45 , V_46 ) ) {
V_46 = - V_118 ;
goto V_119;
}
V_241 [ V_46 ] = 0 ;
if ( strncmp ( V_245 , V_241 , V_246 ) != 0 ) {
V_46 = - V_117 ;
goto V_119;
}
V_242 = V_241 + V_246 ;
V_243 = strstr ( V_242 , L_50 ) ;
if ( V_243 ) {
T_1 V_247 ;
char * V_248 ;
* V_243 = 0 ;
V_244 = 0 ;
V_243 += strlen ( L_50 ) ;
V_247 = F_101 ( V_243 , & V_248 , 10 ) ;
if ( * V_248 ) {
F_102 ( L_51 , V_243 ) ;
} else if ( V_247 != V_240 -> V_249 . V_250 ) {
F_103 ( V_251 , L_52 ,
V_240 -> V_225 -> V_252 ,
V_240 -> V_249 . V_250 , V_247 ) ;
V_244 = 1 ;
} else {
F_103 ( V_251 , L_53 ,
V_240 -> V_225 -> V_252 , V_247 ) ;
}
}
if ( V_244 )
F_104 ( V_240 , V_242 , 1 ) ;
...
int F_105 ( struct V_32 * V_33 , void * V_42 )
{
struct V_215 * V_232 = V_33 -> V_37 ;
struct V_239 * V_240 = V_232 -> V_233 . V_234 . V_235 ;
int V_17 ;
V_17 = F_95 ( V_232 ) ;
if ( V_17 )
return V_17 ;
F_16 ( V_33 , L_13 , ! V_240 -> V_253 ) ;
F_97 ( & V_232 -> V_233 . V_234 . V_236 ) ;
return 0 ;
}
int F_106 ( struct V_44 * V_44 , const char T_3 * V_45 ,
T_4 V_46 , T_5 * V_47 )
{
struct V_215 * V_232 = ( (struct V_32 * ) V_44 -> V_48 ) -> V_37 ;
struct V_254 * V_234 = & V_232 -> V_233 . V_234 ;
struct V_239 * V_240 = V_234 -> V_235 ;
int V_17 , V_50 ;
V_17 = F_19 ( V_45 , V_46 , & V_50 ) ;
if ( V_17 < 0 )
return V_17 ;
