...
void F_116 ( T_2 * V_125 , const T_2 * V_126 , const T_2 * V_127 , unsigned int V_6 )
{
int V_128 = 0 ;
if ( ! F_110 ( V_124 ) ) {
int V_121 = sizeof( unsigned long ) ;
int V_129 = ( ( ( unsigned long ) V_125 ^ ( unsigned long ) V_126 ) |
( ( unsigned long ) V_125 ^ ( unsigned long ) V_127 ) ) &
( V_121 - 1 ) ;
V_128 = V_129 ? 1 << F_117 ( V_129 ) : V_121 ;
while ( ( ( unsigned long ) V_125 & ( V_128 - 1 ) ) && V_6 > 0 ) {
* V_125 ++ = * V_126 ++ ^ * V_127 ++ ;
V_6 -- ;
}
}
while ( F_110 ( V_130 ) && V_6 >= 8 && ! ( V_128 & 7 ) ) {
* ( V_131 * ) V_125 = * ( V_131 * ) V_126 ^ * ( V_131 * ) V_127 ;
V_125 += 8 ;
V_126 += 8 ;
V_127 += 8 ;
V_6 -= 8 ;
...
while ( V_6 >= 2 && ! ( V_128 & 1 ) ) {
* ( V_132 * ) V_125 = * ( V_132 * ) V_126 ^ * ( V_132 * ) V_127 ;
V_125 += 2 ;
V_126 += 2 ;
V_127 += 2 ;
V_6 -= 2 ;
