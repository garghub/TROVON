...
int
F_19 ( struct V_45 * V_46 , T_4 * V_4 )
{
struct V_47 * V_48 = V_46 -> V_49 ;
T_6 V_50 ;
if ( ! ( V_4 = F_3 ( V_4 , & V_48 -> V_40 ) ) )
return 0 ;
V_50 = F_4 ( * V_4 ++ ) ;
if ( ! ( V_4 = F_12 ( V_4 , & V_48 -> V_17 ) ) )
return 0 ;
if ( V_50 )
V_48 -> V_17 . V_19 . V_33 = V_51 ;
return F_20 ( V_46 , V_4 ) ;
}
int
F_21 ( struct V_45 * V_46 , T_4 * V_4 )
{
struct V_38 * V_39 = V_46 -> V_52 ;
if ( ! ( V_4 = F_16 ( V_4 , V_39 ) ) )
return 0 ;
return F_22 ( V_46 , V_4 ) ;
}
int
F_23 ( struct V_45 * V_46 , T_4 * V_4 )
{
struct V_47 * V_48 = V_46 -> V_49 ;
T_6 V_50 ;
if ( ! ( V_4 = F_3 ( V_4 , & V_48 -> V_40 ) ) )
...
int
F_25 ( struct V_45 * V_46 , T_4 * V_4 )
{
struct V_47 * V_48 = V_46 -> V_49 ;
if ( ! ( V_4 = F_3 ( V_4 , & V_48 -> V_40 ) )
|| ! ( V_4 = F_12 ( V_4 , & V_48 -> V_17 ) ) )
return 0 ;
V_48 -> V_17 . V_19 . V_33 = V_57 ;
return F_20 ( V_46 , V_4 ) ;
}
int
F_26 ( struct V_45 * V_46 , T_4 * V_4 )
{
struct V_47 * V_48 = V_46 -> V_49 ;
...
int
F_30 ( struct V_45 * V_46 , T_4 * V_4 )
{
struct V_60 * V_48 = V_46 -> V_49 ;
if ( ! ( V_4 = F_13 ( V_4 , & V_48 -> V_61 , & V_48 -> V_7 , V_62 ) ) )
return 0 ;
V_48 -> V_55 = F_4 ( * V_4 ++ ) ;
memcpy ( & V_48 -> V_63 . V_8 , V_4 , sizeof( V_48 -> V_63 . V_8 ) ) ;
V_4 += F_5 ( V_64 ) ;
return F_20 ( V_46 , V_4 ) ;
}
int
F_31 ( struct V_45 * V_46 , T_4 * V_4 )
{
struct V_38 * V_39 = V_46 -> V_49 ;
...
int
F_32 ( struct V_45 * V_46 , T_4 * V_4 )
{
return F_20 ( V_46 , V_4 ) ;
}
int
F_33 ( struct V_45 * V_46 , T_4 * V_4 )
{
return F_22 ( V_46 , V_4 ) ;
}
