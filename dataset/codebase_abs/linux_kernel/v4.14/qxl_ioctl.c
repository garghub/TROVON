...
V_50 = F_22
( V_47 + sizeof( union V_57 ) + ( V_38 -> V_64 & ~ V_56 ) ,
F_19 ( V_43 -> V_59 ) , V_43 -> V_55 ) ;
{
...
struct V_71 V_72 ;
struct V_71 T_3 * V_73 = F_19 ( V_43 -> V_74 ) ;
if ( F_23 ( & V_72 , V_73 + V_48 , sizeof( V_72 ) ) ) {
V_11 = - V_60 ;
goto V_75;
}
...
V_11 = F_25 ( V_7 , V_38 , V_43 -> type , true ) ;
if ( V_11 )
F_26 ( V_38 ) ;
else
F_27 ( V_38 ) ;
...
struct V_42 T_3 * V_86 =
F_19 ( V_82 -> V_86 ) ;
if ( F_23 ( & V_83 , V_86 + V_84 ,
sizeof( V_83 ) ) )
return - V_60 ;
...
return - V_96 ;
V_13 = F_13 ( V_41 ) ;
V_11 = F_32 ( V_13 , false ) ;
if ( V_11 )
goto V_97;
if ( ! V_13 -> V_98 ) {
F_33 ( V_13 , V_13 -> type , false ) ;
V_11 = F_34 ( & V_13 -> V_99 , & V_13 -> V_100 ,
true , false ) ;
if ( F_35 ( V_11 ) )
goto V_97;
}
