...
struct V_216 * V_113 = & V_112 -> V_113 ;
struct V_1 * V_2 ;
int V_4 ;
int V_106 ;
T_1 V_23 ;
...
V_2 -> V_112 = V_112 ;
if ( V_208 ) {
V_2 -> V_60 = V_208 -> V_244 ;
} else {
V_242 = F_50 ( V_113 -> V_245 -> V_246 , V_113 ) ;
if ( ! V_242 )
return - V_247 ;
V_2 -> V_60 = V_242 -> V_244 ;
}
V_2 -> V_6 = F_51 ( V_112 , & V_248 ) ;
if ( F_52 ( V_2 -> V_6 ) ) {
...
V_2 -> V_12 = F_54 ( & V_112 -> V_113 , V_237 ,
& V_240 ) ;
if ( F_52 ( V_2 -> V_12 ) ) {
...
if ( V_112 -> V_252 ) {
unsigned int V_253 = V_254 | V_255 ;
if ( V_242 )
V_253 |= V_256 | V_257 ;
V_4 = F_56 ( & V_112 -> V_113 , V_112 -> V_252 ,
NULL ,
F_40 , V_253 ,
V_2 -> V_12 -> V_258 -> V_259 ,
V_2 ) ;
if ( ! V_4 ) {
F_38 ( V_2 -> V_6 , V_121 ,
V_260 ,
...
static int F_59 ( struct V_216 * V_113 )
{
struct V_1 * V_2 = F_60 ( V_113 ) ;
if ( V_2 -> V_112 -> V_252 ) {
F_61 ( V_2 -> V_112 -> V_252 ) ;
F_62 ( V_2 -> V_112 -> V_252 ) ;
}
return 0 ;
}
static int F_63 ( struct V_216 * V_113 )
{
struct V_1 * V_2 = F_60 ( V_113 ) ;
if ( V_2 -> V_112 -> V_252 ) {
F_64 ( V_2 -> V_112 -> V_252 ) ;
F_65 ( V_2 -> V_112 -> V_252 ) ;
F_39 ( V_2 , 1 ) ;
}
return 0 ;
}
