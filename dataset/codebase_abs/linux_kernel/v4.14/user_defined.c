...
void F_16 ( const struct V_15 * V_15 , struct V_19 * V_20 )
{
F_17 ( V_20 , V_15 -> V_21 ) ;
if ( F_9 ( V_15 ) )
F_18 ( V_20 , L_1 , V_15 -> V_5 ) ;
}
long F_19 ( const struct V_15 * V_15 , char T_2 * V_22 , T_1 V_23 )
{
...
if ( V_23 > V_4 -> V_5 )
V_23 = V_4 -> V_5 ;
if ( F_20 ( V_22 , V_4 -> V_6 , V_23 ) != 0 )
V_17 = - V_24 ;
}
return V_17 ;
}
static int F_21 ( const char * V_25 )
{
char * V_26 ;
V_26 = strchr ( V_25 , ':' ) ;
if ( ! V_26 )
