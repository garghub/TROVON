...
V_53 -> V_263 [ V_264 ] =
F_22 ( V_112 -> V_236 [ V_264 ] ) ;
V_53 -> V_263 [ V_265 ] =
F_22 ( V_112 -> V_236 [ V_265 ] ) ;
V_53 -> V_263 [ V_266 ] =
F_22 ( V_112 -> V_236 [ V_266 ] ) ;
V_53 -> V_267 = F_22 ( V_112 -> V_243 ) ;
F_145 ( & V_53 -> V_268 ) ;
V_53 -> V_269 = 0 ;
V_53 -> V_270 = V_271 ;
V_53 -> V_211 = 1 ;
...
ASSERT ( V_53 -> V_263 [ V_264 ] ==
F_22 ( V_112 -> V_236 [ V_264 ] ) ) ;
ASSERT ( V_53 -> V_263 [ V_265 ] ==
F_22 ( V_112 -> V_236 [ V_265 ] ) ) ;
}
#endif
F_108 ( V_53 ) ;
...
if ( args -> V_31 == 0 )
args -> V_31 = 1 ;
ASSERT ( F_148 ( V_2 , args -> V_278 ) < V_2 -> V_3 . V_4 ) ;
ASSERT ( F_149 ( V_2 , args -> V_278 ) < V_272 ) ;
ASSERT ( args -> V_32 <= args -> V_52 ) ;
ASSERT ( args -> V_32 <= V_272 ) ;
ASSERT ( args -> V_50 < args -> V_51 ) ;
if ( F_148 ( V_2 , args -> V_278 ) >= V_2 -> V_3 . V_4 ||
F_149 ( V_2 , args -> V_278 ) >= V_272 ||
args -> V_32 > args -> V_52 || args -> V_32 > V_272 ||
args -> V_50 >= args -> V_51 ) {
args -> V_278 = V_279 ;
F_150 ( args ) ;
return 0 ;
...
case V_118 :
case V_119 :
args -> V_102 = F_148 ( V_2 , args -> V_278 ) ;
...
args -> V_120 = F_149 ( V_2 , args -> V_278 ) ;
if ( ( error = F_62 ( args ) ) )
goto V_132;
break;
case V_280 :
...
args -> V_102 = V_273 = F_148 ( V_2 , args -> V_278 ) ;
V_62 = V_213 ;
}
for (; ; ) {
args -> V_53 = F_106 ( V_2 , args -> V_102 ) ;
...
if ( V_274 ) {
if ( args -> V_102 == V_273 )
V_2 -> V_284 = ( V_2 -> V_284 + 1 ) %
( V_2 -> V_3 . V_4 * V_275 ) ;
else
V_2 -> V_284 = ( args -> V_102 * V_275 + 1 ) %
( V_2 -> V_3 . V_4 * V_275 ) ;
}
break;
default:
...
args -> V_278 = F_153 ( V_2 , args -> V_102 , args -> V_120 ) ;
#ifdef F_32
ASSERT ( args -> V_11 >= args -> V_32 ) ;
ASSERT ( args -> V_11 <= args -> V_52 ) ;
ASSERT ( args -> V_120 % args -> V_31 == 0 ) ;
F_156 ( V_2 , F_157 ( V_2 , args -> V_278 ) ,
args -> V_11 ) ;
#endif
if ( args -> V_36 & V_287 ) {
error = F_158 ( args -> V_288 , args -> V_278 , args -> V_11 ) ;
if ( error )
goto V_132;
}
}
...
if ( error )
return error ;
F_72 ( V_2 , V_120 < V_2 -> V_3 . V_7 , V_292 ) ;
F_72 ( V_2 ,
...
struct V_296 V_297 ;
V_297 . V_15 = F_22 ( V_21 -> V_22 . V_15 ) ;
V_297 . V_16 = F_22 ( V_21 -> V_22 . V_16 ) ;
return V_295 -> V_298 ( V_9 , & V_297 , V_295 -> V_293 ) ;
}
int
F_163 (
struct V_8 * V_9 ,
...
union V_301 V_303 ;
struct V_294 V_295 ;
ASSERT ( V_9 -> V_304 == V_131 ) ;
V_302 . V_14 = * V_299 ;
V_303 . V_14 = * V_300 ;
V_295 . V_293 = V_293 ;
V_295 . V_298 = V_298 ;
return F_164 ( V_9 , & V_302 , & V_303 ,
F_162 , & V_295 ) ;
}
int
F_165 (
