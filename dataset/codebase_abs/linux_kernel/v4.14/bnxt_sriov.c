...
int V_162 , V_163 ;
V_155 = * V_81 ;
V_162 = V_2 -> V_28 . V_120 - V_2 -> V_121 ;
V_163 = V_2 -> V_28 . V_122 - V_2 -> V_123 ;
V_162 = F_35 ( int , V_162 , V_163 ) ;
while ( V_155 ) {
V_156 = V_155 ;
V_157 = V_155 ;
V_158 = V_155 ;
...
V_162 >= V_157 )
V_159 = 1 ;
if ( V_2 -> V_28 . V_154 - V_2 -> V_164 >= V_158 )
V_161 = 1 ;
...
int F_50 ( struct V_87 * V_88 , int V_81 )
{
struct V_31 * V_21 = F_51 ( V_88 ) ;
struct V_1 * V_2 = F_11 ( V_21 ) ;
if ( ! ( V_2 -> V_38 & V_169 ) ) {
F_45 ( V_21 , L_13 ) ;
return 0 ;
...
V_10 . V_180 = F_3 ( V_4 -> V_16 ) ;
V_10 . V_181 = F_3 ( V_4 -> V_16 ) ;
V_10 . V_182 = F_3 ( V_176 ) ;
V_10 . V_174 = V_174 ;
V_10 . V_183 = V_175 ;
memcpy ( V_10 . V_173 , V_173 , V_176 ) ;
F_4 ( & V_2 -> V_19 ) ;
V_13 = F_5 ( V_2 , & V_10 , sizeof( V_10 ) , V_20 ) ;
if ( V_13 ) {
...
V_10 . V_180 = F_3 ( V_4 -> V_16 ) ;
V_10 . V_181 = F_3 ( V_4 -> V_16 ) ;
memcpy ( V_10 . V_188 , V_4 -> V_90 , V_176 ) ;
F_4 ( & V_2 -> V_19 ) ;
V_13 = F_5 ( V_2 , & V_10 , sizeof( V_10 ) , V_20 ) ;
if ( V_13 ) {
...
int V_13 = 0 ;
struct V_190 V_10 = { 0 } ;
struct V_191 * V_7 = V_2 -> V_8 ;
F_2 ( V_2 , & V_10 , V_192 , - 1 , - 1 ) ;
V_10 . V_180 = F_3 ( V_4 -> V_16 ) ;
V_10 . V_181 = F_3 ( V_4 -> V_16 ) ;
memcpy ( V_10 . V_188 , V_4 -> V_90 , V_176 ) ;
F_4 ( & V_2 -> V_19 ) ;
...
{
T_2 V_176 = sizeof( struct V_194 ) ;
struct V_194 * V_10 =
(struct V_194 * ) V_4 -> V_90 ;
if ( ! F_58 ( V_4 -> V_47 ) ||
F_59 ( ( const T_3 * ) V_10 -> V_195 , V_4 -> V_47 ) )
return F_56 ( V_2 , V_4 , V_176 ) ;
else
return F_55 ( V_2 , V_4 , V_176 ) ;
}
...
if ( ! ( V_4 -> V_38 & V_56 ) ) {
V_13 = F_56 (
V_2 , V_4 , sizeof( struct V_196 ) ) ;
} else {
struct V_197 V_198 ;
struct V_196 * V_199 ;
V_199 =
(struct V_196 * ) V_4 -> V_90 ;
F_4 ( & V_2 -> V_19 ) ;
memcpy ( & V_198 , & V_2 -> V_73 . V_198 ,
sizeof( V_198 ) ) ;
F_7 ( & V_2 -> V_19 ) ;
...
{
int V_13 = 0 ;
struct V_214 * V_215 = V_4 -> V_90 ;
T_2 V_216 = F_36 ( V_215 -> V_216 ) ;
switch ( V_216 ) {
case V_217 :
V_13 = F_57 ( V_2 , V_4 ) ;
break;
...
while ( 1 ) {
V_24 = F_63 ( V_2 -> V_28 . V_89 , V_29 , V_82 ) ;
if ( V_24 >= V_29 )
break;
F_64 ( V_24 , V_2 -> V_28 . V_89 ) ;
F_61 ( V_2 , & V_2 -> V_28 . V_4 [ V_24 ] ) ;
V_82 = V_24 + 1 ;
}
}
...
{
struct V_219 V_10 = { 0 } ;
struct V_220 * V_7 = V_2 -> V_8 ;
F_2 ( V_2 , & V_10 , V_221 , - 1 , - 1 ) ;
V_10 . V_43 = F_3 ( 0xffff ) ;
F_4 ( & V_2 -> V_19 ) ;
if ( F_5 ( V_2 , & V_10 , sizeof( V_10 ) , V_20 ) )
goto V_222;
if ( ! F_59 ( V_7 -> V_223 , V_2 -> V_4 . V_47 ) )
memcpy ( V_2 -> V_4 . V_47 , V_7 -> V_223 , V_48 ) ;
if ( F_58 ( V_2 -> V_4 . V_47 ) )
memcpy ( V_2 -> V_21 -> V_224 , V_2 -> V_4 . V_47 , V_48 ) ;
V_222:
F_7 ( & V_2 -> V_19 ) ;
}
int F_66 ( struct V_1 * V_2 , T_3 * V_46 )
{
struct V_225 V_10 = { 0 } ;
int V_13 = 0 ;
if ( ! F_67 ( V_2 ) )
...
F_2 ( V_2 , & V_10 , V_228 , - 1 , - 1 ) ;
V_10 . V_62 = F_12 ( V_229 ) ;
memcpy ( V_10 . V_64 , V_46 , V_48 ) ;
V_13 = F_13 ( V_2 , & V_10 , sizeof( V_10 ) , V_20 ) ;
V_227:
if ( V_13 ) {
