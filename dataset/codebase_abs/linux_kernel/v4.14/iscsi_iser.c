...
V_26 = & V_23 -> V_26 ;
if ( V_26 -> V_117 ) {
T_8 V_118 = V_26 -> V_25 -> V_36 -> V_119 . V_120 ;
F_55 ( V_87 , F_52 ( V_118 ) ) ;
F_56 ( V_87 , V_121 |
V_122 ) ;
}
if ( F_57 ( V_87 ,
V_26 -> V_25 -> V_36 -> V_123 . V_124 ) ) {
F_14 ( & V_23 -> V_31 ) ;
goto V_116;
}
F_14 ( & V_23 -> V_31 ) ;
...
V_103 = ( ( V_87 -> V_114 - 1 ) * V_126 ) >> 9 ;
V_87 -> V_127 = F_58 ( V_128 , V_103 ) ;
F_4 ( L_14 ,
V_23 , V_87 -> V_114 ,
V_87 -> V_127 ) ;
if ( V_99 > V_104 ) {
...
enum V_133 V_134 , char * V_135 , int V_136 )
{
int V_137 ;
switch ( V_134 ) {
case V_138 :
...
break;
default:
return F_61 ( V_74 , V_134 , V_135 , V_136 ) ;
}
return 0 ;
}
static void
F_62 ( struct V_70 * V_74 , struct V_144 * V_145 )
{
struct V_1 * V_2 = V_74 -> V_17 ;
V_145 -> V_146 = V_2 -> V_146 ;
V_145 -> V_147 = V_2 -> V_147 ;
V_145 -> V_148 = V_2 -> V_149 ;
V_145 -> V_150 = V_2 -> V_151 ;
V_145 -> V_152 = V_2 -> V_153 ;
V_145 -> V_154 = V_2 -> V_155 ;
V_145 -> V_156 = V_2 -> V_157 ;
V_145 -> V_158 = V_2 -> V_159 ;
V_145 -> V_160 = V_2 -> V_161 ;
V_145 -> V_162 = 0 ;
}
static int F_63 ( struct V_79 * V_80 ,
enum V_133 V_134 , char * V_135 )
{
...
case V_164 :
case V_165 :
if ( ! V_23 || ! V_23 -> V_26 . V_166 )
return - V_167 ;
return F_64 ( (struct V_168 * )
& V_23 -> V_26 . V_166 -> V_169 . V_43 . V_170 ,
V_134 , V_135 ) ;
break;
default:
return - V_171 ;
...
static struct V_79 *
F_65 ( struct V_86 * V_87 , struct V_172 * V_170 ,
int V_173 )
{
int V_174 ;
struct V_23 * V_23 ;
...
V_23 -> V_80 = V_80 ;
F_69 ( V_23 ) ;
V_174 = F_70 ( V_23 , NULL , V_170 , V_173 ) ;
if ( V_174 )
goto V_176;
return V_80 ;
V_176:
...
static int
F_72 ( struct V_79 * V_80 , int V_177 )
{
struct V_23 * V_23 = V_80 -> V_17 ;
int V_7 ;
V_7 = F_73 ( & V_23 -> V_178 ,
...
F_44 ( V_23 ) ;
if ( V_23 -> V_1 ) {
F_76 ( & V_23 -> V_181 , V_182 ) ;
F_77 ( V_183 , & V_23 -> V_181 ) ;
F_14 ( & V_23 -> V_31 ) ;
} else {
V_23 -> V_32 = V_180 ;
F_14 ( & V_23 -> V_31 ) ;
...
static T_10 F_79 ( int V_184 , int V_134 )
{
switch ( V_184 ) {
case V_185 :
switch ( V_134 ) {
...
struct V_36 * V_219 ;
F_11 ( & V_85 ) ;
V_82 = F_81 ( F_82 ( V_218 ) ) -> V_17 ;
V_23 = V_82 -> V_220 -> V_17 ;
if ( ! V_23 ) {
F_14 ( & V_85 ) ;
return - V_167 ;
}
V_219 = V_23 -> V_26 . V_25 -> V_36 ;
if ( ! ( V_219 -> V_119 . V_221 & V_222 ) )
F_83 ( V_218 -> V_223 , ~ V_224 ) ;
F_14 ( & V_85 ) ;
return 0 ;
}
static int T_11 F_84 ( void )
{
int V_174 ;
F_4 ( L_22 ) ;
if ( V_110 < 1 ) {
...
{
struct V_23 * V_23 , * V_235 ;
int V_236 ;
F_4 ( L_28 ) ;
F_90 ( V_183 ) ;
F_11 ( & V_225 . V_231 ) ;
V_236 = F_93 ( & V_225 . V_232 ) ;
F_14 ( & V_225 . V_231 ) ;
if ( ! V_236 ) {
F_3 ( L_29
L_30 ) ;
F_94 (iser_conn, n, &ig.connlist,
conn_list) {
F_78 ( V_23 ) ;
}
}
