...
V_101 = F_91 ( V_4 -> V_102 ) ;
if ( V_101 && ( V_101 -> V_104 != V_96 -> V_104 ) ) {
V_17 = F_92 ( V_101 , true ) ;
if ( V_17 )
return V_17 ;
}
}
...
int F_100 ( struct V_1 * V_2 , T_4 V_111 , T_5 * V_112 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
bool V_113 = ! ! ( V_111 & V_114 ) ;
unsigned long V_115 =
V_111 & V_116 ? 0 : F_101 ( V_112 ) ;
long V_17 ;
V_17 = F_102 ( V_4 -> V_102 , V_113 ,
true , V_115 ) ;
if ( V_17 == 0 )
...
static void F_104 ( struct V_100 * V_101 , const char * type ,
struct V_118 * V_119 )
{
if ( ! F_105 ( V_101 ) )
F_106 ( V_119 , L_6 , type ,
V_101 -> V_120 -> V_121 ( V_101 ) ,
V_101 -> V_120 -> V_122 ( V_101 ) ,
V_101 -> V_123 ) ;
}
void F_107 ( struct V_1 * V_2 , struct V_118 * V_119 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
F_106 ( V_119 , L_10 ,
V_4 -> V_28 , F_109 ( V_4 ) ? 'A' : 'I' ,
V_2 -> V_128 , F_110 ( & V_2 -> V_129 ) ,
V_126 , V_4 -> V_84 ) ;
F_56 (vma, &msm_obj->vmas, list)
F_106 ( V_119 , L_11 , V_38 -> V_71 ) ;
F_106 ( V_119 , L_12 , V_2 -> V_26 , V_34 ) ;
F_111 () ;
V_99 = F_112 ( V_125 -> V_101 ) ;
if ( V_99 ) {
unsigned int V_18 , V_103 = V_99 -> V_103 ;
for ( V_18 = 0 ; V_18 < V_103 ; V_18 ++ ) {
V_101 = F_112 ( V_99 -> V_105 [ V_18 ] ) ;
F_104 ( V_101 , L_13 , V_119 ) ;
}
}
V_101 = F_112 ( V_125 -> V_130 ) ;
if ( V_101 )
F_104 ( V_101 , L_14 , V_119 ) ;
F_113 () ;
F_30 ( & V_4 -> V_21 ) ;
}
void F_114 ( struct V_131 * V_68 , struct V_118 * V_119 )
{
struct V_3 * V_4 ;
int V_132 = 0 ;
T_6 V_26 = 0 ;
...
struct V_1 * V_2 ;
int V_17 ;
V_2 = F_120 ( V_7 , V_26 , V_28 ) ;
if ( F_14 ( V_2 ) )
return F_16 ( V_2 ) ;
V_17 = F_121 ( V_46 , V_2 , V_81 ) ;
F_72 ( V_2 ) ;
return V_17 ;
}
static int F_122 ( struct V_25 * V_7 ,
T_4 V_26 , T_4 V_28 ,
struct V_124 * V_102 ,
struct V_1 * * V_2 ,
bool V_136 )
...
static struct V_1 * F_126 ( struct V_25 * V_7 ,
...
if ( V_26 == 0 )
return F_6 ( - V_139 ) ;
V_17 = F_122 ( V_7 , V_26 , V_28 , NULL , & V_2 , V_136 ) ;
if ( V_17 )
goto V_73;
if ( V_141 ) {
struct V_65 * V_38 ;
...
struct V_1 * F_130 ( struct V_25 * V_7 ,
T_4 V_26 , T_4 V_28 )
{
return F_126 ( V_7 , V_26 , V_28 , true ) ;
}
struct V_1 * F_120 ( struct V_25 * V_7 ,
T_4 V_26 , T_4 V_28 )
{
return F_126 ( V_7 , V_26 , V_28 , false ) ;
}
...
V_17 = F_122 ( V_7 , V_26 , V_29 , V_134 -> V_102 , & V_2 , false ) ;
if ( V_17 )
goto V_73;
F_128 ( V_7 , V_2 , V_26 ) ;
V_15 = V_26 / V_23 ;
...
V_17 = F_132 ( V_27 , V_4 -> V_24 , NULL , V_15 ) ;
if ( V_17 ) {
F_30 ( & V_4 -> V_21 ) ;
goto V_73;
}
...
static void * F_133 ( struct V_25 * V_7 , T_4 V_26 ,
T_4 V_28 , struct V_66 * V_67 ,
struct V_1 * * V_147 , T_3 * V_71 , bool V_148 )
{
void * V_84 ;
struct V_1 * V_2 = F_126 ( V_7 , V_26 , V_28 , V_148 ) ;
int V_17 ;
if ( F_14 ( V_2 ) )
return F_18 ( V_2 ) ;
if ( V_71 ) {
V_17 = F_62 ( V_2 , V_67 , V_71 ) ;
if ( V_17 ) {
F_134 ( V_2 ) ;
return F_6 ( V_17 ) ;
}
...
void * F_135 ( struct V_25 * V_7 , T_4 V_26 ,
T_4 V_28 , struct V_66 * V_67 ,
struct V_1 * * V_147 , T_3 * V_71 )
{
return F_133 ( V_7 , V_26 , V_28 , V_67 , V_147 , V_71 , false ) ;
}
void * F_136 ( struct V_25 * V_7 , T_4 V_26 ,
T_4 V_28 , struct V_66 * V_67 ,
struct V_1 * * V_147 , T_3 * V_71 )
{
return F_133 ( V_7 , V_26 , V_28 , V_67 , V_147 , V_71 , true ) ;
}
