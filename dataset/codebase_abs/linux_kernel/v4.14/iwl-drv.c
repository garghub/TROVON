...
static void F_28 ( struct V_1 * V_2 , const T_3 * V_5 ,
struct V_91 * V_67 )
{
...
if ( V_95 & F_31 ( V_9 ) )
F_32 ( V_9 + 32 * V_94 , V_67 -> V_97 ) ;
}
}
static void F_33 ( struct V_1 * V_2 , const T_3 * V_5 ,
struct V_91 * V_67 )
{
...
if ( V_132 != sizeof( T_2 ) )
goto V_150;
V_2 -> V_12 . V_185 = F_42 ( ( V_152 * ) V_136 ) ;
...
int V_9 ;
struct V_3 * V_11 ;
V_11 = F_51 ( V_49 -> V_8 [ type ] . V_54 , sizeof( * V_11 ) , V_46 ) ;
if ( ! V_11 )
return - V_21 ;
...
if ( V_106 -> V_113 )
V_258 = F_34 ( V_2 , V_104 , V_49 ) ;
else
V_258 = F_39 ( V_2 , V_104 , V_49 ,
& V_12 -> V_99 , & V_128 ) ;
if ( V_258 )
goto V_268;
if ( F_60 ( & V_2 -> V_12 . V_99 , V_269 ) )
...
if ( V_12 -> type == V_270 && F_52 ( V_2 , V_49 ,
V_2 -> V_26 -> V_25 ) )
goto V_268;
for ( V_9 = 0 ; V_9 < V_17 ; V_9 ++ )
if ( F_50 ( V_2 , V_49 , V_9 ) )
goto V_267;
if ( V_49 -> V_13 ) {
V_2 -> V_12 . V_13 =
F_61 ( V_49 -> V_13 ,
...
V_12 -> V_160 = V_49 -> V_160 ;
if ( V_49 -> V_162 )
V_12 -> V_162 = ( V_49 -> V_162 - 16 ) / 12 ;
else
V_12 -> V_162 =
V_2 -> V_26 -> V_25 -> V_290 -> V_291 ;
V_12 -> V_164 = V_49 -> V_164 ;
V_12 -> V_166 = V_49 -> V_166 ;
if ( V_49 -> V_168 )
V_12 -> V_168 = ( V_49 -> V_168 - 16 ) / 12 ;
else
V_12 -> V_168 =
V_2 -> V_26 -> V_25 -> V_290 -> V_291 ;
V_12 -> V_170 = V_49 -> V_170 ;
if ( V_12 -> V_99 . V_177 >
V_292 )
V_12 -> V_99 . V_177 =
V_293 ;
...
F_65 ( & V_2 -> V_297 , & V_247 -> V_2 ) ;
if ( V_247 -> V_249 ) {
V_2 -> V_252 = F_53 ( V_2 , V_247 ) ;
if ( ! V_2 -> V_252 ) {
F_66 ( & V_294 ) ;
goto V_298;
}
...
struct V_1 * F_71 ( struct V_300 * V_26 )
{
struct V_1 * V_2 ;
int V_301 ;
V_2 = F_59 ( sizeof( * V_2 ) , V_46 ) ;
if ( ! V_2 ) {
V_301 = - V_21 ;
goto V_258;
}
...
V_2 -> V_26 -> V_251 = F_55 ( L_59 , V_2 -> V_255 ) ;
if ( ! V_2 -> V_26 -> V_251 ) {
F_12 ( V_2 , L_60 ) ;
V_301 = - V_21 ;
goto V_304;
...
int F_80 ( const char * V_254 , const struct V_248 * V_249 )
{
int V_9 ;
struct V_1 * V_2 ;
struct V_246 * V_247 ;
...
F_81 (drv, &iwlwifi_opmode_table[i].drv, list)
F_57 ( V_2 ) ;
F_66 ( & V_294 ) ;
return;
}
