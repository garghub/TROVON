...
static void F_43 ( struct V_56 * V_57 , int V_4 )
{
struct V_58 * V_59 ;
F_13 ( & V_57 -> V_60 . V_61 ) ;
F_13 ( & V_57 -> V_62 ) ;
V_59 = F_44 ( V_57 , V_4 ) ;
F_45 ( V_57 -> V_2 , V_59 , V_4 ) ;
F_12 ( V_57 , V_4 , NULL ) ;
F_46 ( V_57 -> V_2 , V_4 ) ;
F_29 ( V_57 , V_4 , false ) ;
F_47 ( V_59 , V_77 ) ;
}
int F_48 ( struct V_56 * V_57 , T_2 V_4 ,
enum V_78 V_79 )
{
...
if ( F_50 ( V_93 , & V_59 -> V_94 ) ) {
F_28 ( & V_57 -> V_62 ) ;
if ( V_79 != V_89 )
return - V_95 ;
V_81 . V_34 = V_96 ;
V_84 = F_51 ( V_10 , V_57 -> V_2 , & V_81 ) ;
F_49 ( V_84 ) ;
return 0 ;
}
if ( F_50 ( V_97 , & V_59 -> V_94 ) ) {
F_12 ( V_57 , V_4 , NULL ) ;
F_28 ( & V_57 -> V_62 ) ;
F_47 ( V_59 , V_77 ) ;
return 0 ;
...
static void F_56 ( unsigned long V_105 )
{
T_2 V_4 = * ( T_1 * ) V_105 ;
struct V_56 * V_57 = F_57 ( ( void * ) V_105 ,
struct V_56 , V_106 [ V_4 ] ) ;
struct V_58 * V_59 ;
F_32 () ;
V_59 = F_58 ( V_57 -> V_60 . V_59 [ V_4 ] ) ;
if ( ! V_59 ||
F_50 ( V_107 , & V_59 -> V_94 ) ) {
F_34 () ;
F_52 ( V_57 -> V_2 ,
L_3 ,
V_57 -> V_57 . V_21 , V_4 ) ;
...
void F_60 ( struct V_56 * V_57 , int V_4 )
{
struct V_58 * V_59 ;
struct V_9 * V_10 = V_57 -> V_10 ;
...
static void F_62 ( unsigned long V_105 )
{
T_1 * V_115 = ( T_1 * ) V_105 ;
T_1 * V_116 = V_115 - * V_115 ;
struct V_56 * V_57 = F_57 ( V_116 , struct V_56 ,
V_106 [ 0 ] ) ;
struct V_58 * V_59 ;
unsigned long V_8 ;
F_32 () ;
V_59 = F_58 ( V_57 -> V_60 . V_59 [ * V_115 ] ) ;
if ( ! V_59 || F_50 ( V_93 , & V_59 -> V_94 ) ) {
F_34 () ;
return;
}
V_8 = V_59 -> V_117 + F_63 ( V_59 -> V_8 ) ;
if ( F_64 ( V_8 ) ) {
F_61 ( & V_59 -> V_99 , V_8 ) ;
F_34 () ;
return;
...
F_59 ( & V_57 -> V_57 , * V_115 ) ;
}
int F_65 ( struct V_118 * V_119 , T_2 V_4 ,
T_2 V_8 )
{
struct V_56 * V_57 = F_57 ( V_119 , struct V_56 , V_57 ) ;
struct V_1 * V_2 = V_57 -> V_2 ;
struct V_9 * V_10 = V_2 -> V_10 ;
struct V_58 * V_59 ;
int V_84 = 0 ;
F_66 ( V_119 , V_4 ) ;
if ( F_37 ( V_57 -> V_120 == V_4 ,
L_8 , V_4 ) )
return - V_91 ;
if ( ! V_119 -> V_121 . V_122 )
return - V_91 ;
if ( F_49 ( ! V_10 -> V_123 -> V_124 ) )
return - V_91 ;
if ( ( V_4 >= V_125 ) ||
! F_67 ( & V_10 -> V_16 , V_126 ) ||
F_67 ( & V_10 -> V_16 , V_127 ) )
return - V_91 ;
if ( F_55 ( V_4 >= V_128 ) )
return - V_91 ;
F_52 ( V_2 , L_9 ,
...
F_69 ( V_110 , V_57 -> V_60 . V_112 [ V_4 ] +
V_134 ) ) {
F_52 ( V_2 ,
L_12 ,
...
V_59 = F_70 ( sizeof( struct V_58 ) , V_137 ) ;
if ( ! V_59 ) {
V_84 = - V_138 ;
goto V_132;
}
...
F_75 ( & V_10 -> V_16 , & V_57 -> V_60 . V_140 ) ;
V_132:
F_28 ( & V_57 -> V_62 ) ;
return V_84 ;
}
...
void F_77 ( struct V_56 * V_57 , int V_4 ,
struct V_58 * V_59 )
{
struct V_1 * V_2 = V_57 -> V_2 ;
struct V_9 * V_10 = V_2 -> V_10 ;
if ( F_55 ( F_78 ( V_142 , & V_59 -> V_94 ) ) )
return;
if ( F_50 ( V_107 , & V_59 -> V_94 ) )
F_76 ( V_10 , V_57 , V_4 ) ;
}
static struct V_58 *
F_79 ( struct V_1 * V_2 ,
...
int V_84 ;
F_84 ( & V_57 -> V_60 . V_61 ) ;
V_84 = F_48 ( V_57 , V_4 , V_79 ) ;
F_85 ( & V_57 -> V_60 . V_61 ) ;
return V_84 ;
}
int F_59 ( struct V_118 * V_119 , T_2 V_4 )
{
struct V_56 * V_57 = F_57 ( V_119 , struct V_56 , V_57 ) ;
struct V_1 * V_2 = V_57 -> V_2 ;
struct V_9 * V_10 = V_2 -> V_10 ;
...
void F_87 ( struct V_56 * V_57 , int V_4 ,
struct V_58 * V_59 )
{
struct V_1 * V_2 = V_57 -> V_2 ;
bool V_147 = false ;
...
F_28 ( & V_57 -> V_62 ) ;
if ( V_147 )
F_88 ( V_2 , V_57 -> V_57 . V_21 , V_4 ,
V_103 , V_149 ) ;
}
void F_89 ( struct V_40 * V_20 ,
const T_1 * V_41 , T_2 V_4 )
{
struct V_1 * V_2 = F_9 ( V_20 ) ;
struct V_9 * V_10 = V_2 -> V_10 ;
...
T_1 V_82 ;
bool V_83 ;
V_15 = F_92 ( V_14 -> V_27 . V_34 . V_27 . V_152 . V_15 ) ;
V_83 = V_15 & V_153 ;
V_4 = ( V_15 & V_154 ) >> 2 ;
V_82 = ( V_15 & V_155 ) >> 6 ;
V_82 = F_93 ( V_82 , V_10 -> V_16 . V_156 ) ;
...
if ( F_92 ( V_14 -> V_27 . V_34 . V_27 . V_152 . V_158 )
== V_159 && V_82 ) {
if ( F_78 ( V_107 ,
& V_59 -> V_94 ) ) {
goto V_143;
