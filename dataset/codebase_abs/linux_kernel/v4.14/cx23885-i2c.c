...
goto V_31;
if ( V_32 ) {
F_9 ( V_33 L_4 , V_13 -> V_16 << 1 , V_13 -> V_27 [ 0 ] ) ;
if ( ! ( V_17 & V_28 ) )
F_10 ( L_5 ) ;
}
...
static T_1 F_14 ( struct V_1 * V_42 )
{
return V_43 | V_44 ;
}
static void F_15 ( char * V_45 , struct V_46 * V_47 )
{
unsigned char V_27 ;
int V_38 , V_48 ;
for ( V_38 = 0 ; V_38 < 128 ; V_38 ++ ) {
V_47 -> V_16 = V_38 ;
V_48 = F_16 ( V_47 , & V_27 , 0 ) ;
if ( V_48 < 0 )
continue;
F_17 ( L_12 ,
V_45 , V_38 , V_49 [ V_38 ] ? V_49 [ V_38 ] : L_13 ) ;
}
}
int F_18 ( struct V_3 * V_4 )
{
struct V_6 * V_7 = V_4 -> V_7 ;
F_7 ( 1 , L_14 , V_20 , V_4 -> V_50 ) ;
V_4 -> V_2 = V_51 ;
V_4 -> V_46 = V_52 ;
V_4 -> V_2 . V_7 . V_53 = & V_7 -> V_54 -> V_7 ;
F_19 ( V_4 -> V_2 . V_45 , V_4 -> V_7 -> V_45 ,
sizeof( V_4 -> V_2 . V_45 ) ) ;
V_4 -> V_2 . V_5 = V_4 ;
F_20 ( & V_4 -> V_2 , & V_7 -> V_55 ) ;
F_21 ( & V_4 -> V_2 ) ;
V_4 -> V_46 . V_56 = & V_4 -> V_2 ;
if ( 0 == V_4 -> V_57 ) {
F_7 ( 1 , L_15 , V_7 -> V_45 , V_4 -> V_50 ) ;
if ( V_58 ) {
F_17 ( L_16 ,
V_7 -> V_45 , V_4 -> V_50 ) ;
F_15 ( V_7 -> V_45 , & V_4 -> V_46 ) ;
}
} else
F_22 ( L_17 ,
V_7 -> V_45 , V_4 -> V_50 ) ;
...
F_19 ( V_60 . type , L_18 , V_63 ) ;
F_23 ( & V_4 -> V_2 , & V_60 , V_61 ,
V_64 ) ;
}
return V_4 -> V_57 ;
}
...
void F_26 ( struct V_6 * V_7 , int V_65 )
{
char V_66 [ 3 ] ;
struct V_12 V_13 ;
F_7 ( 1 , L_19 , V_20 , V_65 ) ;
V_66 [ 0 ] = 0x01 ;
V_66 [ 1 ] = 0x44 ;
if ( V_65 == 1 )
V_66 [ 2 ] = 0x05 ;
