...
if ( ! V_100 -> V_50 ) {
if ( ! V_101 || F_40 ( V_101 -> V_51 , V_100 -> V_51 ) )
V_101 = V_100 ;
}
}
return V_101 ;
...
V_125 = V_6 -> V_16 . V_87 ;
if ( F_22 ( V_8 , V_129 ) ) {
if ( F_51 ( V_6 -> V_16 . V_80 + V_130 , V_6 -> V_16 . V_116 - V_130 , NULL , & V_126 ) )
return true ;
else
return false ;
}
...
if ( V_8 -> V_145 != 0 ) {
if ( -- V_8 -> V_145 == 0 ||
F_67 ( V_1 , & V_8 -> V_24 , 1 , NULL , 0 ) != V_11 ) {
V_8 -> V_145 = 0 ;
F_68 ( V_1 ) ;
F_69 ( V_1 ) ;
} else {
...
F_52 ( L_52 ,
( V_243 -> V_16 . V_106 . V_120 == 2 ) ? L_53 : L_54 ,
( V_254 == 2 ) ? L_53 : L_54
) ;
}
...
int V_3 ;
for ( V_3 = 0 ; V_3 < 16 ; V_3 ++ )
( ( T_1 * ) & V_210 -> V_387 . V_390 ) [ V_3 ] &= V_391 [ V_3 ] ;
V_166 -> V_392 = V_393 ;
...
V_210 -> V_400 = ( F_32 ( V_210 -> V_387 . V_370 ) & 0x0C ) >> 2 ;
if ( V_210 -> V_400 == V_401 )
F_52 ( L_64 , V_174 ) ;
V_210 -> V_402 = V_210 -> V_388 . V_389 [ 1 ] & 0x3 ;
}
void F_146 ( struct V_1 * V_2 , struct V_403 * V_404 )
{
T_1 V_405 ;
int V_406 ;
struct V_155 * V_156 = NULL ;
struct V_345 * V_346 ;
struct V_407 * V_408 = & V_404 -> V_409 ;
T_6 V_410 = F_147 ( V_408 -> V_411 ) ;
if ( V_410 || ( V_2 -> V_9 . V_412 . V_413 < 100 ) )
return;
V_406 = V_408 -> V_406 ;
if ( V_408 -> V_156 )
V_156 = V_408 -> V_156 ;
else
V_156 = F_76 ( & V_2 -> V_151 , V_408 -> V_411 ) ;
if ( ! V_156 )
return;
V_346 = & V_156 -> V_347 ;
if ( ( V_346 -> V_351 ) && ( V_346 -> V_350 ) ) {
V_405 = ( V_346 -> V_414 >> V_406 ) & 0x1 ;
V_405 |= ( V_346 -> V_415 >> V_406 ) & 0x1 ;
if ( V_405 == 0 ) {
F_52 ( L_65 , V_406 ) ;
V_156 -> V_347 . V_415 |= F_132 ( ( T_1 ) V_406 ) ;
F_148 ( V_2 , ( T_1 ) V_406 , V_408 -> V_411 ) ;
}
}
}
void F_149 ( struct V_1 * V_2 , struct V_5 * V_152 )
{
struct V_7 * V_8 = & V_2 -> V_9 ;
F_16 ( & V_8 -> V_21 ) ;
F_115 ( V_2 , V_152 ) ;
