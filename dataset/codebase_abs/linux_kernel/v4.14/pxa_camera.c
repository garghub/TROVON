...
static struct V_48 * F_9 (
struct V_52 * V_53 , struct V_54 * V_55 ,
int (* F_10)( struct V_52 * , unsigned int ,
struct V_48 * V_56 ) )
{
...
struct V_48 * V_49 ;
while ( ! F_11 ( V_55 , V_63 , V_64 , NULL , & V_14 ) ) {
V_58 ++ ;
V_14 . V_65 ++ ;
}
for ( V_18 = 0 ; V_18 < V_58 ; V_18 ++ ) {
V_59 = F_10 ( V_53 , V_18 , NULL ) ;
if ( V_59 < 0 )
return F_12 ( V_59 ) ;
V_57 += V_59 ;
}
if ( ! V_57 )
return F_12 ( - V_66 ) ;
V_49 = F_13 ( V_57 + 1 , sizeof( * V_49 ) , V_67 ) ;
if ( ! V_49 )
return F_12 ( - V_68 ) ;
V_57 = 0 ;
for ( V_18 = 0 ; V_18 < V_58 ; V_18 ++ ) {
V_59 = F_10 ( V_53 , V_18 , V_49 + V_57 ) ;
if ( V_59 < 0 )
goto V_69;
V_57 += V_59 ;
}
...
static struct V_70 * F_15 ( struct V_71 * V_72 )
{
struct V_73 * V_74 = F_16 ( V_72 ) ;
return F_17 ( V_74 , struct V_70 , V_74 ) ;
}
static struct V_75 * F_18 ( struct V_76 * V_77 )
{
return V_77 -> V_53 . V_78 ;
}
static struct V_76 * F_19 ( struct V_52 * V_53 )
{
return F_17 ( V_53 , struct V_76 , V_53 ) ;
}
...
int V_18 ;
for ( V_18 = 0 ; V_18 < V_77 -> V_101 ; V_18 ++ ) {
V_82 -> V_102 [ V_18 ] = F_34 ( V_82 -> V_97 [ V_18 ] ) ;
F_27 ( F_18 ( V_77 ) ,
L_4 ,
...
{
unsigned long V_103 ;
F_27 ( F_18 ( V_77 ) , L_5 , V_98 ) ;
F_36 ( F_37 ( V_77 -> V_104 + V_105 ) , V_77 -> V_104 + V_105 ) ;
V_103 = F_37 ( V_77 -> V_104 + V_106 ) | V_107 ;
V_103 &= ~ V_108 ;
F_36 ( V_103 , V_77 -> V_104 + V_106 ) ;
}
...
V_77 -> V_109 = F_44 ( V_77 -> V_120 . V_121 ,
struct V_70 , V_113 ) ;
}
...
enum V_131 V_132 ;
T_3 V_123 ;
F_46 ( & V_77 -> V_133 , V_23 ) ;
V_128 = F_37 ( V_77 -> V_104 + V_105 ) ;
F_27 ( F_18 ( V_77 ) , L_8 ,
V_128 , V_126 ) ;
V_129 = V_134 ;
if ( V_77 -> V_101 == 3 )
...
goto V_137;
V_82 = V_77 -> V_109 ;
F_7 ( V_82 -> V_138 || F_43 ( & V_82 -> V_113 ) ) ;
switch ( V_126 ) {
case V_80 :
V_130 = 1 ;
break;
...
V_82 -> V_99 &= ~ V_126 ;
if ( ! V_82 -> V_99 ) {
F_39 ( V_77 , V_82 , V_119 ) ;
F_45 ( V_77 , V_127 -> V_102 [ V_130 ] ,
V_123 ) ;
}
V_137:
...
F_36 ( V_149 , V_77 -> V_104 + V_150 ) ;
}
static void F_54 ( struct V_76 * V_77 )
{
T_2 V_151 = 0 ;
F_36 ( 0x3ff , V_77 -> V_104 + V_106 ) ;
if ( V_77 -> V_147 & V_152 )
V_151 |= V_153 ;
if ( V_77 -> V_147 & V_148 )
V_151 |= V_154 ;
...
if ( V_77 -> V_147 & V_159 )
V_151 |= V_160 ;
F_36 ( V_77 -> V_161 | V_151 , V_77 -> V_104 + V_162 ) ;
if ( V_77 -> V_147 & V_148 )
...
F_27 ( F_18 ( V_77 ) ,
L_12 ,
F_37 ( V_77 -> V_104 + V_105 ) ) ;
V_164 = F_37 ( V_77 -> V_104 + V_165 ) | V_166 ;
F_36 ( V_164 , V_77 -> V_104 + V_165 ) ;
...
V_168 = F_37 ( V_77 -> V_104 + V_105 ) ;
F_27 ( F_18 ( V_77 ) ,
L_13 , V_168 ) ;
if ( ! V_168 )
return V_169 ;
F_36 ( V_168 , V_77 -> V_104 + V_105 ) ;
if ( V_168 & V_170 ) {
V_103 = F_37 ( V_77 -> V_104 + V_106 ) | V_108 ;
F_36 ( V_103 , V_77 -> V_104 + V_106 ) ;
F_61 ( & V_77 -> V_171 ) ;
}
return V_172 ;
...
if ( V_23 & V_36 )
V_151 |= V_160 ;
V_103 = F_37 ( V_77 -> V_104 + V_106 ) ;
if ( V_103 & V_107 )
F_36 ( V_103 & ~ V_107 , V_77 -> V_104 + V_106 ) ;
...
V_151 |= V_77 -> V_161 ;
F_36 ( V_179 , V_77 -> V_104 + V_196 ) ;
F_36 ( V_180 , V_77 -> V_104 + V_197 ) ;
F_36 ( V_181 , V_77 -> V_104 + V_198 ) ;
F_36 ( V_151 , V_77 -> V_104 + V_162 ) ;
...
return - V_257 ;
V_255 -> V_258 = F_37 ( V_77 -> V_104 + V_255 -> V_255 ) ;
...
return - V_11 ;
F_36 ( V_255 -> V_258 , V_77 -> V_104 + V_255 -> V_255 ) ;
return 0 ;
}
...
int V_59 ;
V_56 = F_8 ( V_77 -> V_49 , V_176 ) ;
if ( ! V_56 ) {
F_52 ( F_18 ( V_77 ) , L_30 , V_176 ) ;
return - V_11 ;
}
...
if ( V_298 )
goto V_305;
V_298 = F_131 ( & V_77 -> V_300 , V_306 , - 1 ) ;
if ( V_298 ) {
...
struct V_296 * V_297 )
{
struct V_76 * V_77 = F_19 ( V_295 -> V_53 ) ;
F_121 ( & V_77 -> V_236 ) ;
F_128 ( F_18 ( V_77 ) ,
L_42 ,
V_55 -> V_246 ) ;
...
static int F_136 ( struct V_75 * V_78 )
{
struct V_76 * V_77 = F_137 ( V_78 ) ;
int V_18 = 0 , V_59 = 0 ;
V_77 -> V_308 [ V_18 ++ ] = F_37 ( V_77 -> V_104 + V_106 ) ;
V_77 -> V_308 [ V_18 ++ ] = F_37 ( V_77 -> V_104 + V_196 ) ;
V_77 -> V_308 [ V_18 ++ ] = F_37 ( V_77 -> V_104 + V_197 ) ;
V_77 -> V_308 [ V_18 ++ ] = F_37 ( V_77 -> V_104 + V_198 ) ;
V_77 -> V_308 [ V_18 ++ ] = F_37 ( V_77 -> V_104 + V_162 ) ;
if ( V_77 -> V_183 ) {
V_59 = F_64 ( V_77 , V_292 , V_293 , 0 ) ;
if ( V_59 == - V_240 )
V_59 = 0 ;
...
struct V_76 * V_77 = F_137 ( V_78 ) ;
int V_18 = 0 , V_59 = 0 ;
F_36 ( V_77 -> V_308 [ V_18 ++ ] & ~ V_107 , V_77 -> V_104 + V_106 ) ;
F_36 ( V_77 -> V_308 [ V_18 ++ ] , V_77 -> V_104 + V_196 ) ;
F_36 ( V_77 -> V_308 [ V_18 ++ ] , V_77 -> V_104 + V_197 ) ;
F_36 ( V_77 -> V_308 [ V_18 ++ ] , V_77 -> V_104 + V_198 ) ;
F_36 ( V_77 -> V_308 [ V_18 ++ ] , V_77 -> V_104 + V_162 ) ;
if ( V_77 -> V_183 ) {
V_59 = F_64 ( V_77 , V_292 , V_293 , 1 ) ;
if ( V_59 == - V_240 )
V_59 = 0 ;
...
static int F_139 ( struct V_75 * V_78 ,
struct V_76 * V_77 ,
struct V_296 * V_297 )
{
T_2 V_309 ;
struct V_310 * V_311 , * V_312 = V_78 -> V_313 ;
struct V_314 V_315 ;
int V_298 = F_140 ( V_312 , L_43 ,
& V_309 ) ;
if ( ! V_298 ) {
V_77 -> V_147 |= V_148 ;
V_77 -> V_143 = V_309 ;
}
V_312 = F_141 ( V_312 , NULL ) ;
if ( ! V_312 ) {
F_26 ( V_78 , L_44 ) ;
return - V_11 ;
}
V_298 = F_142 ( F_143 ( V_312 ) , & V_315 ) ;
if ( V_298 ) {
F_26 ( V_78 , L_45 ) ;
goto V_137;
}
switch ( V_315 . V_316 . V_317 . V_318 ) {
case 4 :
V_77 -> V_147 |= V_319 ;
break;
case 5 :
...
if ( V_315 . V_316 . V_317 . V_23 & V_42 )
V_77 -> V_147 |= V_174 ;
if ( V_315 . V_316 . V_317 . V_23 & V_33 )
V_77 -> V_147 |= V_157 ;
if ( V_315 . V_316 . V_317 . V_23 & V_35 )
V_77 -> V_147 |= V_159 ;
if ( V_315 . V_316 . V_317 . V_23 & V_38 )
V_77 -> V_147 |= V_152 | V_155 ;
if ( V_315 . V_316 . V_317 . V_23 & V_39 )
V_77 -> V_147 |= V_152 ;
V_297 -> V_324 = V_325 ;
V_311 = F_144 ( V_312 ) ;
if ( V_311 ) {
V_297 -> V_326 . V_327 . V_327 = F_143 ( V_311 ) ;
F_145 ( V_311 ) ;
} else {
F_146 ( V_78 , L_46 , V_312 ) ;
}
V_137:
F_145 ( V_312 ) ;
return V_298 ;
}
static int F_147 ( struct V_141 * V_142 )
{
struct V_76 * V_77 ;
struct V_328 * V_329 ;
void T_6 * V_104 ;
...
int V_167 ;
int V_298 = 0 , V_18 ;
V_329 = F_148 ( V_142 , V_340 , 0 ) ;
V_167 = F_149 ( V_142 , 0 ) ;
if ( ! V_329 || V_167 < 0 )
return - V_341 ;
V_77 = F_150 ( & V_142 -> V_78 , sizeof( * V_77 ) , V_67 ) ;
if ( ! V_77 ) {
F_26 ( & V_142 -> V_78 , L_47 ) ;
return - V_68 ;
}
V_77 -> V_145 = F_151 ( & V_142 -> V_78 , NULL ) ;
if ( F_100 ( V_77 -> V_145 ) )
return F_101 ( V_77 -> V_145 ) ;
V_77 -> V_329 = V_329 ;
V_77 -> V_342 = V_142 -> V_78 . V_343 ;
if ( & V_142 -> V_78 . V_313 && ! V_77 -> V_342 ) {
V_298 = F_139 ( & V_142 -> V_78 , V_77 , & V_77 -> V_297 ) ;
} else {
V_77 -> V_147 = V_77 -> V_342 -> V_23 ;
V_77 -> V_143 = V_77 -> V_342 -> V_344 * 10000 ;
V_77 -> V_297 . V_324 = V_345 ;
V_77 -> V_297 . V_326 . V_346 . V_347 =
V_77 -> V_342 -> V_348 ;
V_77 -> V_297 . V_326 . V_346 . V_349 = V_77 -> V_342 -> V_350 ;
}
if ( V_298 < 0 )
return V_298 ;
if ( ! ( V_77 -> V_147 & ( V_321 |
...
V_77 -> V_88 [ 0 ] =
F_157 ( V_335 , V_355 ,
& V_337 , & V_142 -> V_78 , L_50 ) ;
if ( ! V_77 -> V_88 [ 0 ] ) {
F_26 ( & V_142 -> V_78 , L_51 ) ;
return - V_341 ;
}
V_337 . V_354 = 69 ;
V_77 -> V_88 [ 1 ] =
F_157 ( V_335 , V_355 ,
& V_337 , & V_142 -> V_78 , L_52 ) ;
if ( ! V_77 -> V_88 [ 1 ] ) {
F_26 ( & V_142 -> V_78 , L_51 ) ;
V_298 = - V_341 ;
goto V_356;
...
V_77 -> V_88 [ 2 ] =
F_157 ( V_335 , V_355 ,
& V_337 , & V_142 -> V_78 , L_53 ) ;
if ( ! V_77 -> V_88 [ 2 ] ) {
F_26 ( & V_142 -> V_78 , L_54 ) ;
V_298 = - V_341 ;
goto V_357;
}
for ( V_18 = 0 ; V_18 < 3 ; V_18 ++ ) {
V_331 . V_358 = V_77 -> V_329 -> V_359 + V_360 + V_18 * 8 ;
V_298 = F_158 ( V_77 -> V_88 [ V_18 ] , & V_331 ) ;
if ( V_298 < 0 ) {
F_26 ( & V_142 -> V_78 , L_55 ,
V_298 ) ;
goto V_361;
}
}
V_298 = F_159 ( & V_142 -> V_78 , V_77 -> V_167 , F_60 , 0 ,
V_282 , V_77 ) ;
if ( V_298 ) {
F_26 ( & V_142 -> V_78 , L_56 ) ;
goto V_361;
}
F_160 ( & V_77 -> V_171 , F_58 , ( unsigned long ) V_77 ) ;
F_54 ( V_77 ) ;
F_161 ( & V_142 -> V_78 , V_77 ) ;
V_298 = F_162 ( & V_142 -> V_78 , & V_77 -> V_53 ) ;
if ( V_298 )
goto V_361;
V_77 -> V_362 [ 0 ] = & V_77 -> V_297 ;
V_77 -> V_295 . V_363 = V_77 -> V_362 ;
V_77 -> V_295 . V_364 = 1 ;
V_77 -> V_295 . V_365 = F_127 ;
V_77 -> V_295 . V_366 = F_133 ;
if ( ! F_163 () )
V_77 -> V_297 . V_324 = V_345 ;
V_298 = F_93 ( V_77 ) ;
if ( V_298 )
goto V_367;
if ( V_77 -> V_143 ) {
F_164 ( V_338 , sizeof( V_338 ) ,
V_77 -> V_297 . V_326 . V_346 . V_347 ,
V_77 -> V_297 . V_326 . V_346 . V_349 ) ;
V_77 -> V_307 = F_165 ( & V_368 ,
V_338 , NULL ) ;
if ( F_100 ( V_77 -> V_307 ) ) {
V_298 = F_101 ( V_77 -> V_307 ) ;
goto V_367;
}
}
V_298 = F_166 ( & V_77 -> V_53 , & V_77 -> V_295 ) ;
if ( V_298 )
goto V_369;
return 0 ;
V_369:
...
{
struct V_76 * V_77 = F_137 ( & V_142 -> V_78 ) ;
F_56 ( V_77 ) ;
F_168 ( V_77 -> V_88 [ 0 ] ) ;
F_168 ( V_77 -> V_88 [ 1 ] ) ;
F_168 ( V_77 -> V_88 [ 2 ] ) ;
