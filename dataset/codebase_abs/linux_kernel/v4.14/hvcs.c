...
{
struct V_1 * V_9 = F_47 ( V_58 , struct V_1 , V_19 ) ;
struct V_2 * V_21 ;
unsigned long V_10 ;
F_26 ( & V_53 ) ;
F_5 ( & V_9 -> V_12 , V_10 ) ;
...
static void F_65 ( struct V_74 * V_75 , struct V_1 * V_9 )
{
V_9 -> V_13 = V_75 -> V_22 ;
V_9 -> V_24 = V_75 -> V_76 ;
F_66 ( & V_9 -> V_14 [ 0 ] ,
& V_75 -> V_77 [ 0 ] , sizeof( V_9 -> V_14 ) ) ;
}
...
unsigned long V_10 ;
int V_68 ;
V_68 = F_74 ( V_37 , & F_25 , 0 , L_26 , V_9 ) ;
if ( ! V_68 ) {
if ( F_37 ( V_21 ) == V_84 )
return 0 ;
else {
...
static int F_78 ( struct V_85 * V_86 , struct V_32 * V_33 )
{
struct V_1 * V_9 ;
struct V_2 * V_21 ;
...
static int F_80 ( struct V_32 * V_33 , struct V_90 * V_91 )
{
struct V_1 * V_9 = V_33 -> V_34 ;
unsigned long V_10 ;
F_5 ( & V_9 -> V_12 , V_10 ) ;
...
static void F_81 ( struct V_32 * V_33 , struct V_90 * V_91 )
{
struct V_1 * V_9 ;
unsigned long V_10 ;
int V_37 ;
...
static int F_90 ( int V_100 )
{
int V_63 ;
V_55 = F_91 ( V_100 * sizeof( V_56 ) , V_69 ) ;
if ( ! V_55 )
return - V_82 ;
V_56 = V_100 ;
for ( V_63 = 0 ; V_63 < V_56 ; V_63 ++ )
...
V_81 = ( unsigned long * ) F_98 ( V_69 ) ;
if ( ! V_81 ) {
V_68 = - V_82 ;
goto V_120;
}
V_31 = F_99 ( F_38 , NULL , L_39 ) ;
if ( F_100 ( V_31 ) ) {
F_9 ( V_64 L_40 ) ;
V_68 = - V_99 ;
goto V_121;
...
{
int V_68 = F_105 ( & V_122 ) ;
if ( V_68 ) {
F_9 ( V_64 L_41 ) ;
return V_68 ;
}
F_106 ( L_42 ) ;
V_68 = F_107 ( & ( V_122 . V_86 ) , & V_123 ) ;
if ( V_68 )
F_108 ( L_43 , V_68 ) ;
return 0 ;
}
