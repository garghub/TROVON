...
static int F_55 ( struct V_18 * V_19 , int V_20 )
{
struct V_17 * V_1 = F_10 ( V_19 , V_20 ) ;
int V_48 ;
if ( F_11 ( V_1 ) )
return F_56 ( V_1 ) ;
V_19 -> V_35 = V_1 ;
F_46 ( V_19 , V_20 ) ;
if ( ( V_48 = F_49 ( V_19 , V_1 ) ) < 0 )
F_15 ( V_1 ) ;
return V_48 ;
}
static void F_57 ( struct V_18 * V_19 , struct V_17 * V_49 )
{
V_49 = F_10 ( V_19 , V_49 -> V_23 -> V_11 ) ;
F_50 ( F_11 ( V_49 ) ) ;
V_19 -> V_35 = V_49 ;
F_46 ( V_19 , V_49 -> V_23 -> V_11 ) ;
if ( F_49 ( V_19 , V_49 ) < 0 ) {
F_15 ( V_49 ) ;
if ( F_55 ( V_19 , V_6 ) < 0 &&
F_55 ( V_19 , V_50 ) < 0 )
...
int F_60 ( struct V_18 * V_19 , int V_1 )
{
int V_51 ;
struct V_17 * V_52 , * V_3 ;
V_3 = F_10 ( V_19 , V_1 ) ;
if ( F_11 ( V_3 ) )
return F_56 ( V_3 ) ;
F_61 ( V_19 ) ;
V_51 = F_37 ( V_19 , 5 * V_53 ) ;
if ( V_51 )
goto V_54;
if ( ! V_19 -> V_35 ) {
V_51 = - V_55 ;
...
if ( V_19 -> V_35 -> V_23 -> V_11 != V_52 -> V_23 -> V_11 && V_19 -> V_23 -> V_58 ) {
F_62 ( & V_19 -> V_40 ) ;
V_19 -> V_23 -> V_58 ( V_19 ) ;
F_63 ( & V_19 -> V_40 ) ;
}
...
{
F_47 ( & V_19 -> V_40 ) ;
V_19 -> V_41 = V_19 -> V_60 -> V_61 ;
V_19 -> V_41 . V_62 = F_68 ( & V_19 -> V_41 ) ;
V_19 -> V_41 . V_63 = F_69 ( & V_19 -> V_41 ) ;
F_48 ( & V_19 -> V_40 ) ;
}
int F_70 ( struct V_18 * V_19 , int V_1 )
{
struct V_17 * V_20 ;
int V_51 ;
V_20 = F_10 ( V_19 , V_1 ) ;
...
void F_72 ( struct V_18 * V_19 , bool V_64 )
{
struct V_17 * V_20 ;
F_52 ( V_19 , L_7 , V_19 -> V_35 ) ;
V_20 = F_28 ( V_19 ) ;
if ( V_20 != NULL ) {
if ( V_20 -> V_23 -> V_65 )
V_20 -> V_23 -> V_65 ( V_19 ) ;
F_73 ( V_19 ) ;
if ( ( F_54 ( V_66 , & V_19 -> V_4 ) ) &&
V_20 -> V_23 -> V_67 )
V_20 -> V_23 -> V_67 ( V_19 ) ;
if ( V_20 -> V_23 -> V_68 )
V_20 -> V_23 -> V_68 ( V_19 ) ;
...
F_74 ( & V_19 -> V_71 , V_72 ) ;
F_37 ( V_19 , V_34 ) ;
if ( V_19 -> V_60 -> V_4 & V_73 )
F_67 ( V_19 ) ;
if ( V_19 -> V_35 ) {
if ( V_64 ) {
if ( F_70 ( V_19 , V_19 -> V_41 . V_42 ) < 0 &&
F_70 ( V_19 , V_6 ) < 0 )
F_50 ( F_70 ( V_19 , V_50 ) < 0 ) ;
} else
F_66 ( V_19 ) ;
}
F_39 ( V_19 ) ;
}
int F_75 ( struct V_18 * V_19 , struct V_18 * V_74 )
{
int V_51 = F_49 ( V_19 , V_19 -> V_35 ) ;
if ( V_51 )
return V_51 ;
if ( V_74 ) {
V_51 = F_49 ( V_74 , V_74 -> V_35 ) ;
if ( V_51 ) {
F_53 ( V_19 , V_19 -> V_35 ) ;
return V_51 ;
}
