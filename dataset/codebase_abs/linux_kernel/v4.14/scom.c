...
V_22 -> V_41 . V_42 = ( void * ) F_21 ( V_38 , L_8 , V_32 ) ;
V_22 -> V_41 . V_10 = strlen ( ( char * ) V_22 -> V_41 . V_42 ) ;
V_37 = F_22 ( V_22 -> V_40 , V_35 ) ;
if ( ! V_37 ) {
F_6 ( V_32 ) ;
F_23 ( V_22 -> V_41 . V_42 ) ;
F_23 ( V_22 ) ;
...
F_24 ( L_9 , 0400 , V_37 , & V_22 -> V_41 ) ;
F_25 ( L_10 , 0600 , V_37 , V_22 , & V_43 ) ;
return 0 ;
}
