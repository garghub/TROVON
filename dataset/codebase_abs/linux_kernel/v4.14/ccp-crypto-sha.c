...
V_19 -> V_44 . V_45 . V_66 [ V_76 ] = V_19 -> V_44 . V_45 . V_71 [ V_76 ] ^ V_78 ;
V_19 -> V_44 . V_45 . V_58 [ V_76 ] = V_19 -> V_44 . V_45 . V_71 [ V_76 ] ^ V_79 ;
}
...
static int F_34 ( struct V_80 * V_7 )
{
struct V_22 * V_19 = F_27 ( V_7 ) ;
struct V_6 * V_81 = F_35 ( V_7 ) ;
V_19 -> V_82 = F_1 ;
V_19 -> V_44 . V_45 . V_59 = 0 ;
F_36 ( V_81 , sizeof( struct V_8 ) ) ;
return 0 ;
}
static void F_37 ( struct V_80 * V_7 )
{
}
static int F_38 ( struct V_80 * V_7 )
{
struct V_22 * V_19 = F_27 ( V_7 ) ;
struct V_64 * V_65 = V_64 ( V_7 ) ;
struct V_72 * V_74 ;
V_74 = F_39 ( V_65 -> V_83 , 0 , 0 ) ;
if ( F_40 ( V_74 ) ) {
F_41 ( L_1 ,
V_65 -> V_83 ) ;
return F_42 ( V_74 ) ;
...
static void F_43 ( struct V_80 * V_7 )
{
struct V_22 * V_19 = F_27 ( V_7 ) ;
...
struct V_93 * V_31 ;
int V_3 ;
V_89 = F_46 ( sizeof( * V_89 ) , V_34 ) ;
if ( ! V_89 )
return - V_94 ;
* V_89 = * V_88 ;
F_17 ( & V_89 -> V_41 ) ;
strncpy ( V_89 -> V_83 , V_87 -> V_95 , V_96 ) ;
V_65 = & V_89 -> V_65 ;
V_65 -> V_97 = F_26 ;
V_92 = & V_65 -> V_92 ;
V_31 = & V_92 -> V_31 ;
snprintf ( V_31 -> V_98 , V_96 , L_2 , V_87 -> V_95 ) ;
snprintf ( V_31 -> V_99 , V_96 , L_3 ,
V_87 -> V_100 ) ;
V_31 -> V_101 = F_38 ;
V_31 -> V_102 = F_43 ;
V_3 = F_47 ( V_65 ) ;
...
V_65 -> V_108 = F_25 ;
V_92 = & V_65 -> V_92 ;
V_92 -> V_109 = V_87 -> V_10 ;
V_92 -> V_110 = sizeof( struct V_68 ) ;
V_31 = & V_92 -> V_31 ;
snprintf ( V_31 -> V_98 , V_96 , L_5 , V_87 -> V_95 ) ;
snprintf ( V_31 -> V_99 , V_96 , L_5 ,
V_87 -> V_100 ) ;
V_31 -> V_111 = V_112 | V_113 |
V_114 |
V_115 ;
V_31 -> V_116 = V_87 -> V_25 ;
V_31 -> V_117 = sizeof( struct V_22 ) ;
V_31 -> V_118 = V_119 ;
V_31 -> V_120 = & V_121 ;
V_31 -> V_101 = F_34 ;
V_31 -> V_102 = F_37 ;
...
F_50 ( & V_89 -> V_41 , V_85 ) ;
V_3 = F_45 ( V_85 , V_87 , V_89 ) ;
return V_3 ;
}
int F_52 ( struct V_84 * V_85 )
{
int V_76 , V_3 ;
unsigned int V_124 = F_53 () ;
for ( V_76 = 0 ; V_76 < F_54 ( V_125 ) ; V_76 ++ ) {
if ( V_125 [ V_76 ] . V_126 > V_124 )
continue;
V_3 = F_51 ( V_85 , & V_125 [ V_76 ] ) ;
if ( V_3 )
return V_3 ;
}
return 0 ;
