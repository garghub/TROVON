...
0 , type -> V_91 , 0 , 0 ) ;
if ( type -> V_172 ) {
for ( V_13 = 0 ; type -> V_172 [ V_13 ] . V_21 . V_21 . V_159 ; V_13 ++ ) ;
...
V_169 [ V_170 ] = & type -> V_172 [ V_170 ] . V_21 . V_21 ;
type -> V_163 = V_167 ;
}
type -> V_173 = & V_174 ;
return 0 ;
...
static int F_100 ( struct V_175 * V_176 , const struct V_177 * V_178 )
{
struct V_79 * type ;
...
if ( V_161 < 0 )
return - V_94 ;
if ( F_102 ( V_178 -> V_179 ) == V_180 ) {
int V_48 = F_103 ( V_178 -> V_179 ) ;
V_181 [ V_161 ] . V_144 [ V_48 ] = V_176 ;
F_104 ( V_176 , NULL ) ;
return 0 ;
}
type = V_182 [ F_102 ( V_178 -> V_179 ) ] ;
if ( V_178 -> V_179 & ~ 0xffff ) {
struct V_183 * V_184 = V_176 -> V_185 ;
const struct V_177 * V_186 = V_184 -> V_187 ;
unsigned int V_188 ;
while ( V_186 && V_186 -> V_189 ) {
if ( ( V_186 -> V_189 == V_176 -> V_189 ) &&
( V_186 -> V_143 == V_176 -> V_143 ) ) {
V_188 = F_105 ( F_106 ( V_186 -> V_179 ) ,
F_107 ( V_186 -> V_179 ) ) ;
if ( V_188 == V_176 -> V_188 ) {
V_28 = & type -> V_162 [ F_103 ( V_186 -> V_179 ) ] ;
break;
}
}
V_186 ++ ;
...
V_28 = & type -> V_162 [ F_103 ( V_178 -> V_179 ) ] ;
}
...
return - V_126 ;
if ( V_28 -> V_129 < 0 )
V_28 -> V_129 = V_176 -> V_188 ;
else
F_73 ( V_28 -> V_129 != V_176 -> V_188 ) ;
F_24 ( & V_33 -> V_190 ) ;
V_33 -> V_84 = V_5 ;
V_33 -> V_30 = V_161 ;
V_33 -> V_175 = V_176 ;
...
static void F_111 ( struct V_175 * V_176 )
{
struct V_26 * V_33 ;
struct V_27 * V_28 ;
int V_13 , V_5 , V_161 ;
...
if ( V_181 [ V_161 ] . V_144 [ V_13 ] == V_176 ) {
V_181 [ V_161 ] . V_144 [ V_13 ] = NULL ;
break;
}
}
F_73 ( V_13 >= V_192 ) ;
...
T_4 V_81 ;
int V_113 ;
V_81 = V_31 * sizeof( struct V_193 ) ;
V_181 = F_97 ( V_81 , V_16 ) ;
if ( ! V_181 ) {
V_113 = - V_126 ;
goto V_171;
}
V_113 = F_99 ( V_182 , false ) ;
if ( V_113 )
goto V_194;
V_195 -> V_196 = F_100 ;
V_195 -> remove = F_111 ;
...
return - V_120 ;
V_31 = F_139 () ;
V_210 = (struct V_209 * ) V_178 -> V_179 ;
if ( V_210 -> V_215 ) {
V_211 = V_210 -> V_215 () ;
if ( ! V_211 )
V_211 = F_114 () ;
