...
static struct V_15 T_3 * F_43 ( const char * V_49 , struct V_15 * V_15 )
{
const char * V_74 ;
V_74 = F_44 ( V_15 ) ;
V_15 = F_45 ( NULL , V_49 , V_74 ,
0 , 1 , 1 ) ;
if ( F_23 ( V_15 ) )
F_18 ( L_2 , V_36 , V_49 ,
F_24 ( V_15 ) ) ;
...
static struct V_15 T_3 * F_46 ( const char * V_49 ,
const char * V_75 )
{
struct V_15 * V_15 ;
V_15 = F_47 ( V_1 . V_67 , V_75 ) ;
if ( F_23 ( V_15 ) )
return V_15 ;
return F_43 ( V_49 , V_15 ) ;
}
static struct V_15 T_3 * F_48 ( const char * V_49 , int V_25 )
{
struct V_15 * V_15 ;
V_15 = F_49 ( V_1 . V_67 , 0 ) ;
if ( F_23 ( V_15 ) )
return V_15 ;
return F_43 ( V_49 , V_15 ) ;
}
static struct V_15 * T_3 F_50 ( const char * V_49 )
{
struct V_65 * V_76 ;
struct V_15 * V_15 ;
...
static struct V_15 * T_3 F_52 ( const char * V_49 )
{
struct V_15 * V_15 ;
V_15 = F_46 ( V_49 , L_9 ) ;
if ( ! F_23 ( V_15 ) )
return V_15 ;
if ( F_53 ( F_24 ( V_15 ) == - V_77 ) )
return V_15 ;
return NULL ;
}
static void T_3 F_54 ( struct V_65 * V_67 )
{
struct V_15 * V_15 ;
F_33 ( V_67 ) ;
V_15 = V_1 . V_76 ;
...
static void T_3 F_55 ( struct V_1 * V_2 , int V_25 )
{
T_1 T_2 * V_4 ;
T_1 V_78 ;
struct V_79 * V_12 = & V_2 -> V_12 [ V_25 ] ;
const char * V_80 = L_10 ;
int V_50 ;
if ( ! ( V_2 -> V_5 . V_81 & ( 1 << V_25 ) ) )
return;
if ( V_2 -> V_82 && V_25 != V_16 ) {
if ( F_23 ( V_2 -> V_82 ) )
return;
V_80 = L_11 ;
}
...
if ( ( V_2 -> V_5 . V_6 & V_56 ) ||
( ( V_2 -> V_5 . V_6 & V_87 ) && V_25 != V_16 ) )
V_78 = ( V_78 & F_58 ( 8 , 1 ) ) >> 1 ;
else
V_78 = ( V_78 & F_58 ( 6 , 1 ) ) >> 1 ;
...
L_14 , V_25 , V_50 + 1 ) ;
V_15 = F_45 ( NULL ,
V_12 -> div [ V_50 ] . V_49 , V_80 , 0 , V_78 , V_50 + 1 ) ;
if ( F_23 ( V_15 ) ) {
F_18 ( L_15 ,
...
V_34 = F_59 ( V_15 , V_12 -> div [ V_50 ] . V_49 , NULL ) ;
if ( V_34 != 0 )
F_18 ( L_16 ,
V_36 , V_12 -> div [ V_50 ] . V_49 , F_24 ( V_15 ) ) ;
}
}
static void T_3 F_60 ( struct V_1 * V_2 )
{
int V_50 ;
for ( V_50 = 0 ; V_50 < F_31 ( V_2 -> V_12 ) ; V_50 ++ )
F_55 ( V_2 , V_50 ) ;
}
static void T_3 F_61 ( struct V_65 * V_66 , int V_25 )
{
struct V_79 * V_12 ;
struct V_88 * V_89 ;
struct V_15 * * V_90 ;
...
V_12 = & V_1 . V_12 [ V_25 ] ;
V_91 = F_62 ( V_66 , L_17 ) ;
F_63 ( F_31 ( V_12 -> div ) < 4 ) ;
V_90 = F_64 ( 4 , sizeof( struct V_15 * ) , V_55 ) ;
if ( ! V_90 )
return;
V_89 = F_65 ( sizeof( * V_89 ) , V_55 ) ;
if ( ! V_89 )
goto V_92;
if ( V_91 <= 3 ) {
V_90 [ 0 ] = V_12 -> div [ 0 ] . V_15 ;
V_90 [ 1 ] = V_12 -> div [ 1 ] . V_15 ;
V_90 [ 2 ] = V_12 -> div [ 3 ] . V_15 ;
} else {
V_90 [ 0 ] = V_12 -> div [ 0 ] . V_15 ;
V_90 [ 1 ] = V_12 -> div [ 1 ] . V_15 ;
V_90 [ 2 ] = V_12 -> div [ 2 ] . V_15 ;
V_90 [ 3 ] = V_12 -> div [ 3 ] . V_15 ;
}
V_89 -> V_93 = V_90 ;
V_89 -> V_94 = V_91 ;
V_70 = F_38 ( V_66 , V_95 , V_89 ) ;
if ( V_70 ) {
F_18 ( L_5 ,
V_36 , V_66 -> V_49 , V_70 ) ;
goto V_96;
...
static void T_3 F_66 ( struct V_65 * V_66 )
{
F_61 ( V_66 , V_16 ) ;
}
static void T_3 F_67 ( struct V_65 * V_66 )
{
struct V_68 V_69 ;
int V_25 ;
if ( F_37 ( V_66 , 0 , & V_69 ) )
...
static struct V_15 * F_68 ( struct V_97 * V_98 , void * V_99 )
{
struct V_1 * V_2 = V_99 ;
struct V_15 * V_15 ;
struct V_79 * V_12 ;
...
return V_15 ;
V_101:
F_18 ( L_19 , V_36 , type , V_25 ) ;
return F_41 ( - V_30 ) ;
}
static bool T_3 F_69 ( void )
{
T_1 V_103 = F_70 ( V_104 ) ;
int V_50 ;
V_103 &= ~ V_105 ;
for ( V_50 = 0 ; V_50 < F_31 ( V_106 ) ; V_50 ++ ) {
if ( V_103 == V_106 [ V_50 ] )
return true ;
}
return false ;
...
return;
V_1 . V_67 = V_66 ;
V_1 . V_57 = F_71 ( V_66 , 0 ) ;
if ( ! V_1 . V_57 &&
F_72 ( V_108 , L_20 ) ) {
V_1 . V_57 = F_73 ( 0x1ee1000 , 0x1000 ) ;
V_107 = true ;
}
if ( ! V_1 . V_57 ) {
F_18 ( L_21 , V_36 , V_66 -> V_49 ) ;
return;
}
for ( V_50 = 0 ; V_50 < F_31 ( V_109 ) ; V_50 ++ ) {
if ( F_72 ( V_66 , V_109 [ V_50 ] . V_110 ) )
break;
if ( V_107 &&
! strcmp ( V_109 [ V_50 ] . V_110 , L_22 ) )
break;
}
if ( V_50 == F_31 ( V_109 ) ) {
F_18 ( L_23 , V_36 , V_66 ) ;
