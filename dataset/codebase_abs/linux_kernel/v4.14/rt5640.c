...
static int F_25 ( struct V_127 * V_128 ,
struct V_129 * V_130 , int V_131 )
{
struct V_1 * V_2 = F_7 ( V_128 -> V_132 ) ;
struct V_133 * V_134 = F_8 ( V_2 ) ;
...
static int F_26 ( struct V_1 * V_2 , int V_184 )
{
int V_185 = 0 , V_144 ;
if ( V_2 == NULL )
return - V_186 ;
...
static int F_27 ( struct V_201 * V_202 ,
...
V_134 -> V_214 [ V_206 -> V_215 ] = F_28 ( V_204 ) ;
V_211 = F_29 ( V_134 -> V_137 , V_134 -> V_214 [ V_206 -> V_215 ] ) ;
if ( V_211 < 0 ) {
F_11 ( V_2 -> V_5 , L_2 ,
...
static int F_33 ( struct V_205 * V_206 , unsigned int V_228 )
{
struct V_1 * V_2 = V_206 -> V_2 ;
struct V_133 * V_134 = F_8 ( V_2 ) ;
...
static int F_34 ( struct V_205 * V_206 ,
...
V_134 -> V_137 = V_251 ;
V_134 -> V_253 = V_250 ;
F_31 ( V_206 -> V_5 , L_8 , V_251 , V_250 ) ;
return 0 ;
}
static int F_35 ( struct V_205 * V_206 , int V_259 , int V_142 ,
...
{
struct V_328 * V_132 = F_45 ( V_2 ) ;
struct V_133 * V_134 = F_8 ( V_2 ) ;
V_134 -> V_285 = F_46 ( V_2 -> V_5 , L_13 ) ;
if ( F_47 ( V_134 -> V_285 ) == - V_329 )
return - V_329 ;
V_134 -> V_2 = V_2 ;
F_48 ( V_2 , V_287 ) ;
...
F_48 ( V_2 , V_287 ) ;
F_1 ( V_2 ) ;
F_54 ( V_134 -> V_138 , true ) ;
F_55 ( V_134 -> V_138 ) ;
if ( F_56 ( V_134 -> V_340 . V_342 ) )
F_57 ( V_134 -> V_340 . V_342 , 0 ) ;
return 0 ;
}
...
struct V_133 * V_134 = F_8 ( V_2 ) ;
if ( F_56 ( V_134 -> V_340 . V_342 ) ) {
F_57 ( V_134 -> V_340 . V_342 , 1 ) ;
F_22 ( 400 ) ;
}
F_54 ( V_134 -> V_138 , false ) ;
F_59 ( V_134 -> V_138 ) ;
return 0 ;
}
