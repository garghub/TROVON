...
F_23 ( V_56 -> V_60 , & V_59 ) ;
F_24 (a, &actions, list) {
V_47 = F_15 ( V_41 , V_27 , & V_57 , V_44 ) ;
if ( V_47 )
return V_47 ;
V_58 ++ ;
}
if ( V_58 > 1 )
V_27 -> V_39 . V_40 = F_13 ( V_54 ) ;
V_27 -> V_39 . V_57 = V_57 ;
return 0 ;
}
