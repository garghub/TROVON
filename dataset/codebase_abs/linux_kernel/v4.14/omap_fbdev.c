...
V_6 -> V_56 = V_17 ;
V_6 -> V_57 = & V_58 ;
strcpy ( V_6 -> V_9 . V_59 , V_60 ) ;
F_24 ( V_6 , V_29 -> V_45 [ 0 ] , V_29 -> V_61 -> V_62 ) ;
F_25 ( V_6 , V_17 , V_26 -> V_40 , V_26 -> V_41 ) ;
V_22 -> V_63 . V_64 = V_34 ;
V_6 -> V_65 = F_26 ( V_4 -> V_12 ) ;
V_6 -> V_66 = V_4 -> V_12 -> V_67 ;
V_6 -> V_9 . V_68 = V_34 ;
V_6 -> V_9 . V_69 = V_4 -> V_12 -> V_67 ;
if ( V_4 -> V_19 ) {
F_27 ( L_8 ) ;
V_6 -> V_70 |= V_71 | V_72 ;
V_6 -> V_9 . V_73 = 1 ;
...
{
if ( ! V_6 || strcmp ( V_6 -> V_9 . V_59 , V_60 ) ) {
return NULL ;
}
return V_6 -> V_56 ;
}
