...
static struct V_15 * F_104 ( struct V_15 * * V_20 , T_3 V_22 )
{
...
struct V_96 * F_109 ( struct V_96 * V_193 )
{
...
return V_193 ;
V_195 = F_110 ( V_198 , NULL ) ;
if ( ! V_195 )
return NULL ;
V_196 = (struct V_56 * ) V_195 -> V_102 ;
while ( ( V_41 = F_104 ( & V_18 , V_22 ) ) != NULL ) {
...
int F_112 ( struct V_3 * V_3 , struct V_96 * V_97 )
{
struct V_56 * V_57 = (struct V_56 * ) V_97 -> V_102 ;
struct V_15 * V_82 = V_57 -> V_16 ;
unsigned long V_77 = 1 ;
...
static void F_113 ( struct V_3 * V_3 , struct V_15 * V_41 ,
...
static void F_114 ( struct V_3 * V_3 , struct V_96 * V_97 ,
struct V_1 * V_2 )
{
struct V_56 * V_57 = (struct V_56 * ) V_97 -> V_102 ;
...
T_3 V_22 = 0 ;
while ( ( V_41 = F_104 ( & V_18 , V_22 ) ) != NULL ) {
F_113 ( V_3 , V_41 , V_97 , V_2 ) ;
V_22 = V_41 -> V_22 + 1 ;
if ( V_22 < V_41 -> V_22 )
break;
}
}
void F_115 ( struct V_3 * V_3 , struct V_1 * V_2 )
{
unsigned int V_201 ;
...
void F_117 ( struct V_96 * V_97 )
{
F_14 ( & V_97 -> V_31 , F_116 ) ;
}
static int F_118 ( struct V_15 * V_41 , struct V_96 * V_97 ,
...
V_108 = F_119 ( V_206 , F_120 ( V_208 -> V_206 ) . V_211 ,
...
int F_121 ( struct V_96 * V_97 , struct V_205 * V_206 ,
struct V_207 * V_208 )
{
struct V_56 * V_57 = (struct V_56 * ) V_97 -> V_102 ;
struct V_15 * V_41 , * V_18 = V_57 -> V_16 ;
...
while ( ( V_41 = F_104 ( & V_18 , V_22 ) ) != NULL ) {
int V_108 ;
V_108 = F_118 ( V_41 , V_97 , V_206 , V_208 ) ;
if ( V_108 < 0 ) {
V_208 -> args [ 3 ] = V_22 ;
V_208 -> args [ 2 ] = V_216 ;
return V_108 ;
...
struct V_96 * F_110 ( T_1 V_219 , struct V_96 * V_220 )
{
struct V_96 * V_97 ;
struct V_56 * V_57 ;
...
static struct V_15 * F_126 ( struct V_222 * V_223 ,
struct V_56 * V_57 )
{
struct V_15 * V_17 , * V_82 ;
if ( ! V_57 )
...
static void F_127 ( struct V_56 * V_57 , struct V_225 * V_226 )
{
struct V_15 * V_17 ;
struct V_222 V_223 ;
memset ( V_226 , 0 , sizeof( * V_226 ) ) ;
F_128 () ;
for ( V_17 = F_126 ( & V_223 , V_57 ) ; V_17 ; V_17 = F_125 ( & V_223 ) ) {
if ( F_86 ( V_17 ) ) {
struct V_29 * V_30 ;
V_226 -> V_227 ++ ;
...
static void F_130 ( struct V_235 * V_236 , struct V_225 * V_237 )
{
...
F_131 ( V_236 , L_13 ,
V_241 / 100 , V_241 % 100 ) ;
F_131 ( V_236 , L_14 , V_237 -> V_229 ) ;
F_131 ( V_236 , L_15 , V_237 -> V_227 ) ;
V_240 = V_218 * V_237 -> V_227 ;
F_131 ( V_236 , L_16 , V_237 -> V_230 ) ;
V_240 += sizeof( struct V_29 ) * V_237 -> V_230 ;
F_131 ( V_236 , L_17 , V_237 -> V_231 ) ;
...
F_131 ( V_236 , L_18 , V_47 , V_237 -> V_233 [ V_47 ] ) ;
V_239 += ( 1 << V_47 ) * V_237 -> V_233 [ V_47 ] ;
}
F_132 ( V_236 , '\n' ) ;
F_131 ( V_236 , L_19 , V_239 ) ;
V_240 += sizeof( struct V_15 * ) * V_239 ;
F_131 ( V_236 , L_20 , V_237 -> V_234 ) ;
F_131 ( V_236 , L_21 , ( V_240 + 1023 ) / 1024 ) ;
}
static void F_133 ( struct V_235 * V_236 ,
const struct V_75 T_5 * V_76 )
{
struct V_75 V_226 = { 0 } ;
int V_242 ;
F_134 (cpu) {
const struct V_75 * V_243 = F_135 ( V_76 , V_242 ) ;
...
F_131 ( V_236 , L_22 ) ;
F_131 ( V_236 , L_23 , V_226 . gets ) ;
F_131 ( V_236 , L_24 , V_226 . V_149 ) ;
F_131 ( V_236 , L_25 ,
V_226 . V_156 ) ;
F_131 ( V_236 , L_26 , V_226 . V_178 ) ;
F_131 ( V_236 , L_27 , V_226 . V_147 ) ;
F_131 ( V_236 , L_28 , V_226 . V_80 ) ;
}
static void F_136 ( struct V_235 * V_236 , struct V_96 * V_97 )
{
if ( V_97 -> V_11 == V_198 )
F_137 ( V_236 , L_29 ) ;
...
F_131 ( V_236 , L_31 , V_97 -> V_11 ) ;
}
static int F_138 ( struct V_235 * V_236 , void * V_245 )
{
...
F_130 ( V_236 , & V_237 ) ;
#ifdef F_54
F_133 ( V_236 , V_57 -> V_76 ) ;
#endif
}
}
return 0 ;
}
static int F_139 ( struct V_51 * V_51 , struct V_247 * V_247 )
{
return F_140 ( V_51 , V_247 , F_138 ) ;
}
static struct V_15 * F_141 ( struct V_235 * V_236 , T_10 V_26 )
{
struct V_222 * V_223 = V_236 -> V_246 ;
struct V_3 * V_3 = F_142 ( V_236 ) ;
T_10 V_248 = 0 ;
unsigned int V_201 ;
for ( V_201 = 0 ; V_201 < V_202 ; V_201 ++ ) {
struct V_83 * V_28 = & V_3 -> V_203 . V_204 [ V_201 ] ;
...
F_90 (tb, head, tb_hlist) {
struct V_15 * V_17 ;
for ( V_17 = F_126 ( V_223 ,
(struct V_56 * ) V_97 -> V_102 ) ;
V_17 ; V_17 = F_125 ( V_223 ) )
if ( V_26 == V_248 ++ ) {
V_223 -> V_97 = V_97 ;
return V_17 ;
}
...
static void * F_143 ( struct V_235 * V_236 , T_10 * V_26 )
__acquires( T_11 )
{
F_128 () ;
return F_141 ( V_236 , * V_26 ) ;
}
static void * F_144 ( struct V_235 * V_236 , void * V_245 , T_10 * V_26 )
{
struct V_222 * V_223 = V_236 -> V_246 ;
struct V_3 * V_3 = F_142 ( V_236 ) ;
...
while ( ( V_249 = F_88 ( F_145 ( & V_97 -> V_250 ) ) ) ) {
V_97 = F_97 ( V_249 , struct V_96 , V_250 ) ;
V_17 = F_126 ( V_223 , (struct V_56 * ) V_97 -> V_102 ) ;
if ( V_17 )
goto V_144;
}
while ( ++ V_201 < V_202 ) {
...
static void F_146 ( struct V_235 * V_236 , void * V_245 )
__releases( T_11 )
{
F_129 () ;
}
static void F_147 ( struct V_235 * V_236 , int V_17 )
{
while ( V_17 -- > 0 )
F_137 ( V_236 , L_34 ) ;
}
static inline const char * F_148 ( char * V_251 , T_4 V_215 , enum V_252 V_226 )
{
switch ( V_226 ) {
...
static inline const char * F_149 ( char * V_251 , T_4 V_215 , unsigned int V_57 )
{
...
static int F_150 ( struct V_235 * V_236 , void * V_245 )
{
const struct V_222 * V_223 = V_236 -> V_246 ;
struct V_15 * V_17 = V_245 ;
if ( F_37 ( F_89 ( V_17 ) ) )
F_136 ( V_236 , V_223 -> V_97 ) ;
if ( F_31 ( V_17 ) ) {
T_8 V_259 = F_79 ( V_17 -> V_22 ) ;
F_147 ( V_236 , V_223 -> V_224 - 1 ) ;
F_131 ( V_236 , L_42 ,
...
struct V_29 * V_30 ;
F_147 ( V_236 , V_223 -> V_224 ) ;
F_131 ( V_236 , L_43 , & V_260 ) ;
F_90 (fa, &n->leaf, fa_list) {
char V_261 [ 32 ] , V_262 [ 32 ] ;
F_147 ( V_236 , V_223 -> V_224 + 1 ) ;
F_131 ( V_236 , L_44 ,
V_25 - V_30 -> V_43 ,
F_148 ( V_261 , sizeof( V_261 ) ,
V_30 -> V_87 -> V_153 ) ,
F_149 ( V_262 , sizeof( V_262 ) ,
V_30 -> V_116 ) ) ;
if ( V_30 -> V_86 )
F_131 ( V_236 , L_45 , V_30 -> V_86 ) ;
F_132 ( V_236 , '\n' ) ;
}
}
return 0 ;
}
static int F_151 ( struct V_51 * V_51 , struct V_247 * V_247 )
{
return F_152 ( V_51 , V_247 , & V_263 ,
sizeof( struct V_222 ) ) ;
}
static struct V_15 * F_153 ( struct V_264 * V_223 ,
T_10 V_26 )
{
...
V_26 -= V_223 -> V_26 ;
while ( ( V_41 = F_104 ( V_18 , V_22 ) ) && ( V_26 -- > 0 ) ) {
V_22 = V_41 -> V_22 + 1 ;
V_223 -> V_26 ++ ;
V_41 = NULL ;
if ( ! V_22 )
...
static void * F_154 ( struct V_235 * V_236 , T_10 * V_26 )
__acquires( T_11 )
{
...
if ( * V_26 != 0 )
return F_153 ( V_223 , * V_26 ) ;
V_223 -> V_26 = 0 ;
V_223 -> V_22 = V_74 ;
return V_266 ;
}
static void * F_156 ( struct V_235 * V_236 , void * V_245 , T_10 * V_26 )
{
struct V_264 * V_223 = V_236 -> V_246 ;
...
static void F_157 ( struct V_235 * V_236 , void * V_245 )
__releases( T_11 )
{
F_129 () ;
}
static unsigned int F_158 ( int type , T_8 V_267 , const struct V_8 * V_9 )
{
...
static int F_159 ( struct V_235 * V_236 , void * V_245 )
{
struct V_264 * V_223 = V_236 -> V_246 ;
...
T_8 V_267 = F_160 ( V_25 - V_30 -> V_43 ) ;
unsigned int V_268 = F_158 ( V_30 -> V_116 , V_267 , V_9 ) ;
if ( ( V_30 -> V_116 == V_276 ) ||
( V_30 -> V_116 == V_277 ) )
continue;
...
static int F_163 ( struct V_51 * V_51 , struct V_247 * V_247 )
{
return F_152 ( V_51 , V_247 , & V_283 ,
sizeof( struct V_264 ) ) ;
}
int T_12 F_164 ( struct V_3 * V_3 )
{
if ( ! F_165 ( L_54 , V_284 , V_3 -> V_285 , & V_286 ) )
goto V_287;
if ( ! F_165 ( L_55 , V_284 , V_3 -> V_285 ,
& V_288 ) )
goto V_289;
if ( ! F_165 ( L_56 , V_284 , V_3 -> V_285 , & V_290 ) )
goto V_291;
return 0 ;
V_291:
F_166 ( L_55 , V_3 -> V_285 ) ;
V_289:
F_166 ( L_54 , V_3 -> V_285 ) ;
V_287:
return - V_91 ;
}
void T_13 F_167 ( struct V_3 * V_3 )
{
F_166 ( L_54 , V_3 -> V_285 ) ;
F_166 ( L_55 , V_3 -> V_285 ) ;
F_166 ( L_56 , V_3 -> V_285 ) ;
}
