...
V_294 = F_163 ( V_2 ) ;
F_47 ( V_293 -> V_297 != 0 ||
V_294 <= V_293 -> V_298 , V_2 ,
L_44 ,
V_294 , V_293 -> V_298 ) ;
if ( V_294 > V_293 -> V_298 )
return 0 ;
V_293 -> V_299 = F_63 ( V_2 -> V_52 , V_293 -> V_299 ) ;
F_47 ( V_293 -> V_297 != 0 ||
V_2 -> V_34 <= V_293 -> V_299 , V_2 ,
L_45 ,
V_2 -> V_34 , V_293 -> V_299 ) ;
if ( V_293 -> V_297 + V_2 -> V_34 > V_293 -> V_299 )
return 0 ;
F_19 (tmp, data->erd_rpc_list, oe_link) {
struct V_24 * V_300 ;
V_300 = F_165 ( & V_56 -> V_35 , struct V_24 ,
V_132 ) ;
F_78 ( V_56 -> V_166 == V_159 , V_56 ) ;
if ( F_99 ( V_25 ) -> V_301 != F_99 ( V_300 ) -> V_301 ) {
F_115 ( V_71 , L_46 ) ;
return 0 ;
}
if ( V_56 -> V_8 != V_2 -> V_8 ||
! V_56 -> V_38 != ! V_2 -> V_38 ||
V_56 -> V_302 || V_2 -> V_302 )
return 0 ;
break;
}
V_293 -> V_296 -- ;
V_293 -> V_298 -= V_294 ;
V_293 -> V_297 += V_2 -> V_34 ;
F_68 ( & V_2 -> V_61 , V_293 -> V_303 ) ;
V_2 -> V_166 = V_159 ;
return 1 ;
}
static inline unsigned int F_166 ( const struct V_88 * V_89 )
{
return V_304 >> V_89 -> V_80 ;
}
...
return V_293 . V_297 ;
F_78 ( V_2 -> V_34 <= V_293 . V_299 , V_2 ) ;
}
if ( V_293 . V_297 == V_293 . V_299 )
return V_293 . V_297 ;
while ( ! F_3 ( & V_20 -> V_84 ) ) {
...
struct V_1 * V_2 ;
struct V_1 * V_56 ;
struct V_1 * V_307 = NULL ;
T_6 V_26 = 0 ;
int V_200 = 0 ;
int V_27 = 0 ;
F_7 ( F_14 ( V_180 ) ) ;
V_26 = F_167 ( V_180 , & V_305 ) ;
F_7 ( F_124 ( V_26 == 0 , F_3 ( & V_305 ) ) ) ;
if ( F_3 ( & V_305 ) )
return 0 ;
...
if ( ! F_3 ( & V_305 ) ) {
F_7 ( V_26 > 0 ) ;
V_27 = F_171 ( V_63 , V_89 , & V_305 , V_70 ) ;
F_7 ( F_3 ( & V_305 ) ) ;
}
F_58 ( V_180 ) ;
return V_27 ;
...
F_7 ( V_293 . V_297 <= V_293 . V_299 ) ;
F_54 ( V_180 , V_194 , - V_293 . V_297 ) ;
if ( ! F_3 ( & V_305 ) ) {
F_59 ( V_180 ) ;
V_27 = F_171 ( V_63 , V_89 , & V_305 , V_194 ) ;
F_7 ( F_3 ( & V_305 ) ) ;
F_58 ( V_180 ) ;
}
return V_27 ;
...
{
if ( ! F_3 ( & V_89 -> V_278 ) )
return F_174 ( & V_89 -> V_278 , V_309 ) ;
if ( ! F_3 ( & V_89 -> V_277 ) )
return F_174 ( & V_89 -> V_277 , V_310 ) ;
if ( ! F_3 ( & V_89 -> V_258 ) &&
! F_3 ( & V_89 -> V_280 ) )
return F_174 ( & V_89 -> V_280 , V_311 ) ;
if ( ! V_89 -> V_123 || V_89 -> V_123 -> V_268 ) {
if ( ! F_3 ( & V_89 -> V_280 ) )
return F_174 ( & V_89 -> V_280 , V_311 ) ;
if ( ! F_3 ( & V_89 -> V_282 ) )
return F_174 ( & V_89 -> V_282 , V_312 ) ;
}
return NULL ;
}
...
F_115 ( V_71 , L_47 , V_89 ) ;
F_7 ( V_89 -> V_314 ) ;
V_27 = F_177 ( V_89 -> V_314 ) ;
}
return V_27 ;
}
...
int F_179 ( struct V_19 * V_180 , struct V_184 * V_315 ,
struct V_157 * V_157 , T_5 V_136 )
{
struct V_316 * exp = F_180 ( V_180 ) ;
struct V_24 * V_25 = & V_315 -> V_317 ;
if ( ! V_157 )
return F_181 ( sizeof( * V_25 ) ) ;
V_25 -> V_318 = V_319 ;
V_25 -> V_320 = & exp -> V_321 -> V_322 . V_89 ;
V_25 -> V_243 = V_180 ;
V_25 -> V_323 = V_157 ;
V_25 -> V_133 = V_136 ;
F_7 ( ! ( V_136 & ~ V_137 ) ) ;
...
struct V_184 * V_315 )
{
struct V_326 * V_327 = F_73 ( V_63 ) ;
struct V_1 * V_2 = NULL ;
struct V_24 * V_25 = & V_315 -> V_317 ;
struct V_88 * V_89 = V_25 -> V_320 ;
struct V_19 * V_180 = V_25 -> V_243 ;
T_2 V_54 ;
...
V_20 = F_97 ( & V_180 -> V_335 ) ;
V_191 = & F_96 ( V_63 ) -> V_192 ;
F_120 ( V_20 ) ;
V_27 = F_121 ( V_63 , V_20 , V_191 ) ;
F_122 ( V_20 ) ;
V_333 [ V_336 ] = V_191 -> V_337 ;
V_333 [ V_338 ] = V_191 -> V_339 ;
if ( V_27 == 0 && F_185 ( V_89 , V_333 ) == V_340 )
V_27 = - V_229 ;
if ( V_27 )
return V_27 ;
}
V_25 -> V_291 = V_183 ;
V_25 -> V_173 = V_315 -> V_341 ;
V_25 -> V_134 = V_315 -> V_342 - V_315 -> V_341 ;
V_25 -> V_167 = 0 ;
V_25 -> V_206 = V_328 ;
F_153 ( V_180 , L_49 ,
V_25 , V_25 -> V_323 , V_25 -> V_291 & V_343 ) ;
V_54 = F_20 ( F_21 ( V_25 ) ) ;
V_2 = V_327 -> V_344 ;
...
struct V_19 * V_20 , struct V_184 * V_315 )
{
struct V_24 * V_25 = & V_315 -> V_317 ;
int V_27 = 0 ;
F_7 ( V_25 -> V_318 == V_319 ) ;
F_115 ( V_325 , L_52 ,
V_25 , V_315 , F_20 ( F_21 ( V_25 ) ) ) ;
if ( ! F_3 ( & V_25 -> V_131 ) ) {
F_115 ( V_71 , L_53 , V_25 ) ;
V_27 = - V_78 ;
...
{
struct V_1 * V_2 = NULL ;
struct V_19 * V_20 = F_189 ( V_315 -> V_195 . V_196 ) ;
struct V_156 * V_345 = V_315 -> V_195 . V_346 ;
T_2 V_54 = F_20 ( V_315 ) ;
struct V_24 * V_25 = & V_315 -> V_317 ;
bool V_347 = false ;
int V_27 = 0 ;
...
V_27 = F_191 ( V_63 , V_148 , V_345 , V_187 ) ;
if ( V_27 )
goto V_28;
F_110 ( & V_25 -> V_169 ) ;
V_25 -> V_167 |= V_168 | V_348 ;
F_111 ( & V_25 -> V_169 ) ;
if ( F_192 () )
V_2 -> V_11 = 1 ;
V_2 -> V_10 = 1 ;
...
int F_193 ( const struct V_62 * V_63 , struct V_184 * V_315 )
{
struct V_24 * V_25 = & V_315 -> V_317 ;
...
struct V_14 * V_15 , int V_183 , int V_328 )
{
struct V_88 * V_89 = F_61 ( V_20 ) ;
struct V_1 * V_2 ;
struct V_24 * V_25 , * V_56 ;
int V_26 = 0 ;
int V_350 = V_89 -> V_110 ;
bool V_351 = true ;
T_2 V_47 = V_352 ;
T_2 V_48 = 0 ;
...
++ V_26 ;
V_350 <<= ( V_26 > V_350 ) ;
if ( F_170 ( V_185 -> V_341 > 0 || V_185 -> V_342 < V_135 ) )
V_351 = false ;
}
V_2 = F_26 ( V_20 ) ;
if ( ! V_2 ) {
...
int V_186 = 0 ;
bool V_146 ;
V_54 = F_198 ( F_18 ( V_20 ) , V_353 ) ;
V_146 = V_353 > F_17 ( F_18 ( V_20 ) , V_54 ) ;
V_356:
F_58 ( V_20 ) ;
V_2 = F_44 ( V_20 , V_54 ) ;
if ( ! V_2 )
...
if ( V_355 ) {
int V_27 ;
V_27 = F_81 ( V_63 , V_355 , V_33 ) ;
if ( V_27 < 0 )
F_22 ( V_71 , V_355 , L_63 , V_27 ) ;
F_37 ( V_63 , V_355 ) ;
V_355 = NULL ;
goto V_356;
}
...
T_2 V_47 , T_2 V_48 , int V_357 , int V_358 )
{
struct V_1 * V_2 ;
F_169 ( V_359 ) ;
bool V_347 = false ;
...
bool V_369 = true ;
V_363 = V_47 ;
V_362 = F_96 ( V_63 ) -> V_370 ;
F_110 ( & V_180 -> V_371 ) ;
while ( ( V_364 = F_203 ( & V_180 -> V_372 , V_362 ,
V_363 , V_373 ) ) > 0 ) {
struct V_156 * V_157 ;
bool V_374 = false ;
for ( V_365 = 0 , V_366 = 0 ; V_365 < V_364 ; ++ V_365 ) {
V_315 = V_362 [ V_365 ] ;
V_362 [ V_365 ] = NULL ;
V_363 = F_20 ( V_315 ) ;
if ( V_363 > V_48 ) {
...
V_157 = V_315 -> V_195 . V_346 ;
F_7 ( V_157 -> V_301 == V_375 ) ;
...
V_315 = V_362 [ V_365 ] ;
if ( V_367 == V_368 )
V_367 = (* V_360)( V_63 , V_148 , V_315 , V_361 ) ;
V_157 = V_315 -> V_195 . V_346 ;
F_104 ( & V_157 -> V_158 , L_68 , V_159 ) ;
F_105 ( V_63 , V_157 ) ;
}
if ( V_364 < V_373 || V_374 )
break;
if ( V_367 == V_368 && F_205 () )
V_367 = V_376 ;
if ( V_367 != V_368 )
break;
F_110 ( & V_180 -> V_371 ) ;
...
struct V_184 * V_315 , void * V_361 )
{
struct V_377 * V_378 = F_96 ( V_63 ) ;
struct V_19 * V_180 = V_361 ;
T_2 V_54 ;
V_54 = F_20 ( V_315 ) ;
if ( V_54 >= V_378 -> V_379 ) {
struct V_380 * V_56 ;
struct V_156 * V_157 = V_315 -> V_195 . V_346 ;
V_56 = F_207 ( V_63 , V_180 , V_54 ,
V_381 ) ;
if ( V_56 ) {
T_3 V_48 = V_56 -> V_45 . V_46 . V_48 ;
V_378 -> V_379 = F_198 ( F_18 ( V_180 ) , V_48 + 1 ) ;
if ( V_48 == V_382 )
V_378 -> V_379 = V_352 ;
F_40 ( V_56 ) ;
...
struct V_377 * V_378 = F_96 ( V_63 ) ;
struct V_156 * V_157 = V_315 -> V_195 . V_346 ;
V_378 -> V_383 = F_20 ( V_315 ) + 1 ;
if ( F_101 ( V_63 , V_148 , V_157 ) == 0 ) {
if ( V_157 -> V_301 == V_375 &&
F_209 ( F_210 ( V_157 ) ) )
...
T_2 V_47 , T_2 V_48 , enum V_384 V_385 )
{
struct V_377 * V_378 = F_96 ( V_63 ) ;
struct V_147 * V_148 = & V_378 -> V_152 ;
T_8 V_360 ;
int V_367 ;
int V_186 ;
...
if ( V_186 != 0 )
goto V_28;
V_360 = V_385 == V_386 ? F_206 : F_208 ;
V_378 -> V_379 = V_47 ;
V_378 -> V_383 = V_47 ;
do {
V_367 = F_202 ( V_63 , V_148 , V_180 ,
V_378 -> V_383 , V_48 , V_360 , V_180 ) ;
if ( V_378 -> V_383 > V_48 )
break;
if ( V_367 == V_376 )
F_212 () ;
