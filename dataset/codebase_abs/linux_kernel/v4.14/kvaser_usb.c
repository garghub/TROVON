...
F_111 ( & V_248 -> V_9 , L_29 ,
( ( V_9 -> V_45 >> 24 ) & 0xff ) ,
( ( V_9 -> V_45 >> 16 ) & 0xff ) ,
( V_9 -> V_45 & 0xffff ) ) ;
F_111 ( & V_248 -> V_9 , L_30 , V_9 -> V_48 ) ;
V_20 = F_19 ( V_9 ) ;
if ( V_20 ) {
F_12 ( & V_248 -> V_9 ,
L_31 , V_20 ) ;
