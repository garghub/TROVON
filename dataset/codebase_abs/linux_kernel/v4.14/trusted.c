...
F_61 ( V_17 , V_172 ) ;
F_66 ( & V_119 -> V_171 , F_62 ) ;
V_23:
F_10 ( V_156 ) ;
F_10 ( V_173 ) ;
return V_14 ;
}
static long F_67 ( const struct V_17 * V_17 , char T_7 * V_32 ,
T_5 V_64 )
{
...
if ( ! V_119 )
return - V_24 ;
if ( V_32 && V_64 >= 2 * V_119 -> V_124 ) {
V_175 = F_3 ( 2 * V_119 -> V_124 , V_6 ) ;
if ( ! V_175 )
return - V_7 ;
V_176 = V_175 ;
for ( V_102 = 0 ; V_102 < V_119 -> V_124 ; V_102 ++ )
V_176 = F_69 ( V_176 , V_119 -> V_88 [ V_102 ] ) ;
if ( F_70 ( V_32 , V_175 , 2 * V_119 -> V_124 ) != 0 ) {
F_10 ( V_175 ) ;
return - V_177 ;
}
F_10 ( V_175 ) ;
...
{
int V_14 ;
V_21 = F_75 ( V_22 , 0 , V_178 ) ;
if ( F_6 ( V_21 ) ) {
F_7 ( L_14 ,
V_22 ) ;
return F_8 ( V_21 ) ;
}
V_15 = F_75 ( V_16 , 0 , V_178 ) ;
if ( F_6 ( V_15 ) ) {
F_7 ( L_14 ,
V_16 ) ;
V_14 = F_8 ( V_15 ) ;
