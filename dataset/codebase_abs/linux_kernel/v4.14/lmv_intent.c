...
V_60 -> V_68 = V_24 -> V_69 ;
F_18 ( V_60 , V_24 -> V_70 ) ;
F_19 ( V_60 -> V_71 ) = V_24 -> V_72 ;
F_19 ( V_60 -> V_73 ) = V_24 -> V_74 ;
F_19 ( V_60 -> V_75 ) = V_24 -> V_76 ;
}
F_20 ( V_22 -> V_51 , V_59 , V_60 , NULL ) ;
if ( V_3 . V_35 && V_59 ) {
F_13 ( V_59 , V_3 . V_35 ) ;
V_3 . V_35 = 0 ;
}
...
static int F_21 ( struct V_1 * exp , struct V_19 * V_20 ,
struct V_2 * V_3 ,
struct V_6 * * V_7 ,
T_1 V_8 ,
T_2 V_9 )
...
if ( ( V_3 -> V_32 & V_82 ) && ! ( V_3 -> V_77 & V_78 ) ) {
V_26 = F_23 ( NULL , exp , & V_20 -> V_45 , V_20 ) ;
if ( V_26 != 0 )
return V_26 ;
}
F_9 ( V_48 , L_6 V_49 L_7 V_49 L_8 ,
F_10 ( & V_20 -> V_43 ) ,
F_10 ( & V_20 -> V_45 ) , V_20 -> V_81 , V_22 -> V_50 ) ;
...
int V_26 = 0 ;
V_22 = F_16 ( V_14 , V_20 , & V_20 -> V_43 ) ;
if ( F_6 ( V_22 ) && ( F_7 ( V_22 ) != - V_87 ) )
return F_7 ( V_22 ) ;
if ( V_56 && ! F_26 ( V_56 -> V_88 ) ) {
struct V_89 * V_90 = & V_56 -> V_62 [ 0 ] ;
V_20 -> V_43 = V_90 -> V_63 ;
V_20 -> V_80 = V_90 -> V_91 ;
V_22 = F_27 ( V_14 , V_90 -> V_91 , NULL ) ;
if ( F_6 ( V_22 ) )
return F_7 ( V_22 ) ;
}
if ( ! F_4 ( & V_20 -> V_45 ) )
F_28 ( & V_20 -> V_45 ) ;
F_9 ( V_48 , L_9 V_49 L_7 V_49 L_10 ,
F_10 ( & V_20 -> V_43 ) , F_10 ( & V_20 -> V_45 ) ,
V_20 -> V_81 ? V_20 -> V_81 : L_11 ,
V_22 -> V_50 , V_56 , ! V_56 ? - 1 : V_56 -> V_92 ) ;
V_20 -> V_46 &= ~ V_47 ;
V_26 = F_11 ( V_22 -> V_51 , V_20 , V_3 , V_7 , V_8 ,
V_9 ) ;
if ( V_26 < 0 )
...
* V_7 = NULL ;
V_90 = & V_56 -> V_62 [ V_94 ] ;
V_22 = F_5 ( V_14 , & V_90 -> V_63 ) ;
if ( F_6 ( V_22 ) )
return F_7 ( V_22 ) ;
F_9 ( V_48 , L_12 V_49 L_13 ,
F_10 ( & V_90 -> V_63 ) ) ;
V_20 -> V_43 = V_90 -> V_63 ;
V_3 -> V_83 &= ~ V_95 ;
...
int V_26 ;
F_3 ( F_4 ( & V_20 -> V_43 ) ) ;
F_9 ( V_48 , L_14 V_49 L_15 V_49 L_13 ,
F_31 ( V_3 ) , F_10 ( & V_20 -> V_45 ) ,
( int ) V_20 -> V_96 , V_20 -> V_81 ,
F_10 ( & V_20 -> V_43 ) ) ;
if ( V_3 -> V_32 & ( V_33 | V_34 | V_97 ) )
V_26 = F_25 ( exp , V_20 , V_3 , V_7 , V_8 ,
V_9 ) ;
else if ( V_3 -> V_32 & V_44 )
V_26 = F_21 ( exp , V_20 , V_3 , V_7 , V_8 ,
V_9 ) ;
else
F_32 () ;
if ( V_26 < 0 ) {
