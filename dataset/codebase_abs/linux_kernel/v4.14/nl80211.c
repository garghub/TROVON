...
T_4 V_775 = V_749 -> V_759 ;
const T_2 * V_776 = V_749 -> V_758 ;
const T_2 * V_705 ;
const T_2 * V_253 ;
...
struct V_6 * V_7 )
{
struct V_4 * V_1694 , * V_1695 , * V_1774 , * V_1775 ;
int V_160 , V_162 , V_1696 ;
struct V_1776 * V_236 ;
if ( ! V_7 -> V_237 -> V_239 )
return 0 ;
V_1775 = F_45 ( V_51 , V_241 ) ;
if ( ! V_1775 )
return - V_89 ;
for ( V_160 = 0 ; V_160 < V_7 -> V_237 -> V_239 ; V_160 ++ ) {
V_1774 = F_45 ( V_51 , V_160 + 1 ) ;
if ( ! V_1774 )
return - V_89 ;
V_236 = & V_7 -> V_237 -> V_1777 [ V_160 ] ;
if ( F_26 ( V_51 , V_1778 ,
V_236 -> V_1357 ) )
return - V_89 ;
if ( F_26 ( V_51 , V_1779 ,
...
{
struct V_1783 * V_237 = V_7 -> V_237 ;
int V_160 , V_162 ;
struct V_1776 * V_236 ;
if ( ! V_237 )
return;
for ( V_160 = 0 ; V_160 < V_237 -> V_239 ; V_160 ++ ) {
V_236 = & V_237 -> V_1777 [ V_160 ] ;
for ( V_162 = 0 ; V_162 < V_236 -> V_222 ; V_162 ++ )
...
struct V_4 * V_236 ,
struct V_1776 * V_1784 )
{
int V_35 , V_160 ;
const struct V_1785 * V_237 = V_7 -> V_18 . V_237 ;
struct V_4 * V_93 [ V_1786 ] , * V_224 ;
int V_133 , V_1696 , V_1768 , V_1703 , V_222 = 0 ;
struct V_4 * V_1769 [ V_1770 ] ;
V_35 = F_31 ( V_93 , V_1787 , V_236 ,
V_1788 , NULL ) ;
if ( V_35 )
return V_35 ;
if ( V_93 [ V_1778 ] )
V_1784 -> V_1357 =
F_4 ( V_93 [ V_1778 ] ) ;
if ( V_1784 -> V_1357 > V_237 -> V_240 )
return - V_16 ;
if ( V_93 [ V_1779 ] )
V_1784 -> V_1780 =
F_4 ( V_93 [ V_1779 ] ) ;
if ( V_1784 -> V_1780 != V_1789 &&
V_1784 -> V_1780 != V_1790 )
return - V_16 ;
if ( ! V_93 [ V_1781 ] )
return - V_16 ;
...
return - V_16 ;
V_1784 -> V_1697 = F_405 ( V_222 , sizeof( V_1784 -> V_1697 [ 0 ] ) ,
V_135 ) ;
if ( ! V_1784 -> V_1697 )
return - V_136 ;
V_1784 -> V_222 = V_222 ;
...
return - V_16 ;
V_1784 -> V_1697 [ V_160 ] . V_1703 = V_1703 ;
V_1771 = F_406 ( V_1768 + V_1696 , V_135 ) ;
if ( ! V_1771 )
return - V_136 ;
V_1784 -> V_1697 [ V_160 ] . V_707 = V_1771 ;
memcpy ( V_1771 , F_21 ( V_1769 [ V_1699 ] ) ,
V_1768 ) ;
V_1771 += V_1768 ;
V_1784 -> V_1697 [ V_160 ] . V_1701 = V_1771 ;
V_1784 -> V_1697 [ V_160 ] . V_1698 = V_1696 ;
...
struct V_6 * V_7 = V_30 -> V_523 [ 0 ] ;
const struct V_1785 * V_237 = V_7 -> V_18 . V_237 ;
struct V_1783 V_1791 = {} ;
struct V_1783 * V_1792 ;
int V_35 , V_1793 , V_239 = 0 , V_160 , V_162 ;
struct V_4 * V_236 ;
struct V_1776 * V_1794 ;
if ( ! V_7 -> V_18 . V_237 || ! V_7 -> V_328 -> V_1795 )
return - V_560 ;
if ( ! V_30 -> V_5 [ V_241 ] ) {
F_411 ( V_7 ) ;
F_414 ( V_7 , NULL ) ;
...
return - V_16 ;
V_1791 . V_1777 = F_405 ( V_239 , sizeof( V_1791 . V_1777 [ 0 ] ) ,
V_135 ) ;
if ( ! V_1791 . V_1777 )
return - V_136 ;
V_1791 . V_239 = V_239 ;
...
V_35 = F_414 ( V_7 , & V_1791 ) ;
if ( V_35 )
goto error;
V_1792 = F_407 ( & V_1791 , sizeof( V_1791 ) , V_135 ) ;
if ( ! V_1792 ) {
V_35 = - V_136 ;
goto error;
}
...
return 0 ;
error:
for ( V_160 = 0 ; V_160 < V_1791 . V_239 ; V_160 ++ ) {
V_1794 = & V_1791 . V_1777 [ V_160 ] ;
for ( V_162 = 0 ; V_162 < V_1794 -> V_222 ; V_162 ++ )
F_39 ( V_1794 -> V_1697 [ V_162 ] . V_707 ) ;
F_39 ( V_1794 -> V_1697 ) ;
}
F_39 ( V_1791 . V_1777 ) ;
return V_35 ;
...
struct V_25 * V_559 = V_30 -> V_523 [ 1 ] ;
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_4 * V_93 [ V_1796 ] ;
struct V_1797 V_1798 ;
int V_35 ;
if ( ! V_30 -> V_5 [ V_1799 ] )
return - V_16 ;
V_35 = F_31 ( V_93 , V_1800 ,
V_30 -> V_5 [ V_1799 ] ,
V_1801 , V_30 -> V_127 ) ;
if ( V_35 )
return V_35 ;
if ( ! V_93 [ V_1802 ] || ! V_93 [ V_1803 ] ||
! V_93 [ V_1804 ] )
return - V_16 ;
if ( F_22 ( V_93 [ V_1802 ] ) != V_1805 )
return - V_1806 ;
if ( F_22 ( V_93 [ V_1803 ] ) != V_1807 )
return - V_1806 ;
if ( F_22 ( V_93 [ V_1804 ] ) != V_1808 )
return - V_1806 ;
V_1798 . V_1809 = F_21 ( V_93 [ V_1803 ] ) ;
V_1798 . V_1810 = F_21 ( V_93 [ V_1804 ] ) ;
V_1798 . V_1811 = F_21 ( V_93 [ V_1802 ] ) ;
F_116 ( V_17 ) ;
if ( ! V_17 -> V_149 ) {
V_35 = - V_1382 ;
goto V_620;
...
{
struct V_6 * V_7 = V_30 -> V_523 [ 0 ] ;
struct V_1815 * V_1816 , * V_1817 ;
int V_1818 ;
if ( ! ( V_7 -> V_18 . V_49 & V_345 ) )
return - V_560 ;
V_1817 = F_37 ( sizeof( * V_1817 ) , V_135 ) ;
if ( ! V_1817 )
return - V_136 ;
F_302 ( & V_7 -> V_1819 ) ;
F_6 (reg, &rdev->beacon_registrations, list) {
if ( V_1816 -> V_1820 == V_30 -> V_524 ) {
V_1818 = - V_793 ;
goto V_967;
}
}
V_1817 -> V_1820 = V_30 -> V_524 ;
F_421 ( & V_1817 -> V_666 , & V_7 -> V_1821 ) ;
F_304 ( & V_7 -> V_1819 ) ;
return 0 ;
V_967:
F_304 ( & V_7 -> V_1819 ) ;
...
return - V_560 ;
if ( V_438 && ! ( V_438 & F_113 ( V_1832 ) ) )
return - V_16 ;
V_1828 . V_438 = V_438 ;
}
V_35 = F_429 ( V_7 , V_17 , & V_1828 ) ;
if ( V_35 )
return V_35 ;
V_17 -> V_1824 = true ;
V_7 -> V_1825 ++ ;
...
static int F_432 ( struct V_4 * V_1833 )
{
struct V_4 * V_43 ;
...
static int F_433 ( struct V_4 * V_1835 ,
struct V_1836 * V_1837 ,
bool V_278 )
{
struct V_4 * V_43 ;
int V_691 , V_133 , V_160 ;
struct V_1838 * V_1839 ;
V_691 = F_432 ( V_1835 ) ;
if ( V_691 < 0 )
return V_691 ;
F_117 ( sizeof( * V_1837 -> V_1840 ) != sizeof( * V_1837 -> V_1841 ) ) ;
V_1839 = F_405 ( V_691 , sizeof( * V_1837 -> V_1840 ) , V_135 ) ;
if ( ! V_1839 )
return - V_136 ;
V_160 = 0 ;
F_36 (attr, attr_filter, rem) {
V_1839 [ V_160 ] . V_1839 = F_434 ( V_43 , V_135 ) ;
V_1839 [ V_160 ] . V_45 = F_22 ( V_43 ) ;
V_160 ++ ;
}
if ( V_278 ) {
V_1837 -> V_1842 = V_691 ;
V_1837 -> V_1841 = V_1839 ;
} else {
V_1837 -> V_1843 = V_691 ;
V_1837 -> V_1840 = V_1839 ;
}
return 0 ;
}
...
if ( ! V_30 -> V_5 [ V_1846 ] )
return - V_16 ;
V_35 = F_31 ( V_93 , V_1847 ,
V_30 -> V_5 [ V_1846 ] ,
V_1848 , V_30 -> V_127 ) ;
if ( V_35 )
return V_35 ;
V_1837 = F_37 ( sizeof( * V_1837 ) , V_135 ) ;
if ( ! V_1837 )
return - V_136 ;
V_1837 -> V_673 = V_17 -> V_18 -> V_1365 ++ ;
if ( ! V_93 [ V_1849 ] ||
F_32 ( V_93 [ V_1849 ] ) > V_1850 ) {
V_35 = - V_16 ;
goto V_620;
}
V_1837 -> type = F_32 ( V_93 [ V_1849 ] ) ;
if ( ! V_93 [ V_1851 ] ) {
V_35 = - V_16 ;
goto V_620;
}
memcpy ( V_1837 -> V_1852 , F_21 ( V_93 [ V_1851 ] ) ,
sizeof( V_1837 -> V_1852 ) ) ;
V_1837 -> V_1853 =
F_170 ( V_93 [ V_1854 ] ) ;
if ( V_93 [ V_1855 ] ) {
V_1837 -> V_1856 =
...
V_1837 -> V_1873 =
F_32 ( V_93 [ V_1871 ] ) ;
memcpy ( V_1837 -> V_1874 . V_703 ,
F_21 ( V_93 [ V_1875 ] ) ,
sizeof( V_1837 -> V_1874 . V_703 ) ) ;
if ( V_1837 -> V_1859 ) {
V_35 = - V_16 ;
goto V_620;
}
...
if ( V_93 [ V_1876 ] ) {
struct V_4 * V_1877 [ V_1878 ] ;
V_35 = F_31 ( V_1877 , V_1879 ,
V_93 [ V_1876 ] ,
V_1880 , V_30 -> V_127 ) ;
if ( V_35 )
goto V_620;
...
V_1837 -> V_1890 = V_691 ;
V_1837 -> V_1891 =
F_37 ( sizeof( * V_1837 -> V_1891 ) * V_691 ,
V_135 ) ;
if ( ! V_1837 -> V_1891 ) {
V_35 = - V_136 ;
goto V_620;
...
memcpy ( V_1837 -> V_1891 [ V_160 ++ ] . V_703 , F_21 ( V_43 ) ,
sizeof( * V_1837 -> V_1891 ) ) ;
}
}
if ( V_93 [ V_1892 ] ) {
...
if ( F_104 ( V_51 , V_1369 , V_1837 -> V_673 ,
V_606 ) )
goto V_59;
V_1845 = F_45 ( V_51 , V_1846 ) ;
if ( ! V_1845 )
goto V_59;
if ( F_54 ( V_51 , V_1895 ,
V_1837 -> V_1896 ) )
...
V_1828 . V_1831 =
F_32 ( V_30 -> V_5 [ V_1830 ] ) ;
if ( V_1828 . V_1831 <= 1 || V_1828 . V_1831 == 255 )
return - V_16 ;
V_570 |= V_1897 ;
}
if ( V_30 -> V_5 [ V_513 ] ) {
...
if ( ! V_570 )
return - V_16 ;
return F_441 ( V_7 , V_17 , & V_1828 , V_570 ) ;
}
void F_442 ( struct V_1 * V_17 ,
struct V_1899 * V_1726 , T_10 V_1557 )
{
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
struct V_4 * V_1900 , * V_1901 , * V_1902 ;
struct V_31 * V_51 ;
void * V_360 ;
if ( F_60 ( ! V_1726 -> V_1903 || ! V_1726 -> V_1904 || ! V_1726 -> V_703 ) )
return;
V_51 = F_75 ( V_621 , V_1557 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_1905 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
if ( ! V_1901 )
goto V_59;
if ( F_54 ( V_51 , V_1895 , V_1726 -> V_1903 ) )
goto V_59;
F_46 ( V_51 , V_1901 ) ;
V_1902 = F_45 ( V_51 , V_1908 ) ;
if ( ! V_1902 )
goto V_59;
if ( F_54 ( V_51 , V_1849 , V_1726 -> type ) ||
F_54 ( V_51 , V_1895 , V_1726 -> V_1904 ) )
goto V_59;
if ( V_1726 -> V_30 && V_1726 -> V_1909 &&
F_49 ( V_51 , V_1855 , V_1726 -> V_1909 ,
V_1726 -> V_30 ) )
goto V_59;
F_46 ( V_51 , V_1902 ) ;
F_46 ( V_51 , V_1900 ) ;
...
if ( ! V_1845 )
goto V_59;
if ( F_54 ( V_51 , V_1895 , V_1903 ) ||
F_54 ( V_51 , V_1913 , V_1597 ) )
goto V_59;
F_46 ( V_51 , V_1845 ) ;
F_65 ( V_51 , V_360 ) ;
if ( ! V_17 -> V_660 )
...
! F_20 ( V_30 -> V_5 [ V_752 ] ) )
return - V_16 ;
memset ( & V_1918 , 0 , sizeof( V_1918 ) ) ;
V_1918 . V_1921 = F_79 ( V_30 -> V_5 [ V_1920 ] ) ;
V_1918 . V_1214 = F_21 ( V_30 -> V_5 [ V_752 ] ) ;
V_1918 . V_1215 = F_22 ( V_30 -> V_5 [ V_752 ] ) ;
return F_447 ( V_7 , V_559 , & V_1918 ) ;
}
...
return - V_564 ;
if ( V_30 -> V_5 [ V_1925 ] )
V_1491 = F_79 ( V_30 -> V_5 [ V_1925 ] ) ;
if ( V_1491 >= V_1926 )
return - V_16 ;
if ( ! V_30 -> V_5 [ V_1927 ] )
return - V_16 ;
V_1308 =
F_79 ( V_30 -> V_5 [ V_1927 ] ) ;
if ( V_1308 > V_1928 )
return - V_1806 ;
V_516 = F_449 ( V_7 , V_17 , V_1491 , V_1308 ) ;
if ( ! V_516 )
V_7 -> V_1924 = V_30 -> V_524 ;
return V_516 ;
}
...
! V_30 -> V_5 [ V_1560 ] )
return - V_16 ;
V_1929 = F_4 ( V_30 -> V_5 [ V_1558 ] ) ;
V_1561 = F_4 ( V_30 -> V_5 [ V_1560 ] ) ;
for ( V_160 = 0 ; V_160 < V_7 -> V_18 . V_487 ; V_160 ++ ) {
const struct V_1930 * V_1931 ;
void * V_140 = NULL ;
int V_45 = 0 ;
V_1931 = & V_7 -> V_18 . V_491 [ V_160 ] ;
if ( V_1931 -> V_30 . V_1559 != V_1929 || V_1931 -> V_30 . V_1561 != V_1561 )
continue;
if ( V_1931 -> V_49 & ( V_1932 |
V_1933 ) ) {
if ( ! V_17 )
return - V_16 ;
if ( V_1931 -> V_49 & V_1933 &&
! V_17 -> V_19 )
return - V_16 ;
if ( V_1931 -> V_49 & V_1934 ) {
if ( ! F_423 ( V_17 ) )
return - V_574 ;
}
if ( ! V_1931 -> V_1935 )
...
V_7 -> V_1570 = V_30 ;
V_35 = V_7 -> V_18 . V_491 [ V_160 ] . V_1935 ( & V_7 -> V_18 , V_17 ,
V_140 , V_45 ) ;
V_7 -> V_1570 = NULL ;
return V_35 ;
}
...
V_1938 = F_45 ( V_32 , V_490 ) ;
if ( ! V_1938 ) {
F_66 ( V_32 , V_360 ) ;
break;
}
V_35 = V_1931 -> V_1937 ( & V_7 -> V_18 , V_17 , V_32 , V_140 , V_1572 ,
...
{
struct V_6 * V_7 = V_30 -> V_523 [ 0 ] ;
struct V_1939 * V_1940 = NULL ;
struct V_25 * V_559 = V_30 -> V_523 [ 1 ] ;
T_2 * V_44 , V_45 , V_1941 , V_1942 , V_1943 ;
int V_516 ;
if ( ! V_7 -> V_328 -> V_451 )
return - V_560 ;
if ( V_30 -> V_5 [ V_1944 ] ) {
V_44 = F_21 ( V_30 -> V_5 [ V_1944 ] ) ;
V_45 = F_22 ( V_30 -> V_5 [ V_1944 ] ) ;
if ( V_45 % 2 || V_45 < V_1945 ||
V_45 > V_1946 )
return - V_16 ;
V_1940 = F_37 ( sizeof( struct V_1939 ) , V_135 ) ;
if ( ! V_1940 )
return - V_136 ;
V_1941 = ( V_45 - V_1945 ) >> 1 ;
if ( V_1941 ) {
V_1942 = V_1941 *
sizeof( struct V_1947 ) ;
memcpy ( V_1940 -> V_1948 , V_44 , V_1942 ) ;
V_1940 -> V_1941 = V_1941 ;
for ( V_1943 = 0 ; V_1943 < V_1941 ; V_1943 ++ ) {
if ( V_1940 -> V_1948 [ V_1943 ] . V_1949 > 7 ) {
F_39 ( V_1940 ) ;
return - V_16 ;
}
}
...
memcpy ( V_1940 -> V_1949 , V_44 , V_1945 ) ;
}
F_116 ( V_559 -> V_28 ) ;
V_516 = F_40 ( V_559 -> V_28 ) ;
if ( ! V_516 )
V_516 = F_458 ( V_7 , V_559 , V_1940 ) ;
F_118 ( V_559 -> V_28 ) ;
F_39 ( V_1940 ) ;
return V_516 ;
}
...
return - V_560 ;
if ( ! V_30 -> V_5 [ V_1952 ] || ! V_30 -> V_5 [ V_567 ] ||
! V_30 -> V_5 [ V_1953 ] )
return - V_16 ;
V_1950 = F_32 ( V_30 -> V_5 [ V_1952 ] ) ;
if ( V_1950 >= V_951 )
return - V_16 ;
V_1949 = F_32 ( V_30 -> V_5 [ V_1953 ] ) ;
if ( V_1949 >= V_1954 )
return - V_16 ;
if ( V_1950 >= V_1955 ) {
return - V_16 ;
...
V_35 = F_460 ( V_7 , V_559 , V_1950 , V_1618 , V_1949 , V_1951 ) ;
V_620:
F_118 ( V_17 ) ;
return V_35 ;
}
...
V_1618 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
F_116 ( V_17 ) ;
V_35 = F_462 ( V_7 , V_559 , V_1950 , V_1618 ) ;
F_118 ( V_17 ) ;
return V_35 ;
}
...
return - V_16 ;
V_703 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
V_1957 = F_32 ( V_30 -> V_5 [ V_1960 ] ) ;
F_116 ( V_17 ) ;
V_35 = F_464 ( V_7 , V_559 , V_703 , V_1957 , & V_540 ) ;
F_118 ( V_17 ) ;
return V_35 ;
}
...
V_17 -> V_141 != V_144 )
return - V_560 ;
V_622 = V_30 -> V_5 [ V_1963 ] ;
V_1962 = F_170 ( V_622 ) ;
return F_468 ( V_7 , V_559 , V_1962 ) ;
}
...
V_1965 . V_1966 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
if ( memcmp ( V_1965 . V_1966 , V_17 -> V_149 -> V_1403 . V_566 , V_607 ) ) {
V_516 = - V_16 ;
goto V_620;
}
V_1965 . V_1611 = F_21 ( V_30 -> V_5 [ V_1506 ] ) ;
V_1965 . V_1612 = F_22 ( V_30 -> V_5 [ V_1506 ] ) ;
if ( V_1965 . V_1612 != V_1507 &&
V_1965 . V_1612 != V_1967 ) {
V_516 = - V_16 ;
goto V_620;
}
if ( V_30 -> V_5 [ V_1968 ] ) {
int V_1969 = F_22 ( V_30 -> V_5 [ V_1968 ] ) ;
if ( V_1969 != V_1970 ) {
V_516 = - V_16 ;
goto V_620;
}
V_1965 . V_1971 =
F_21 ( V_30 -> V_5 [ V_1968 ] ) ;
}
V_516 = F_470 ( V_7 , V_559 , & V_1965 ) ;
V_620:
F_118 ( V_17 ) ;
return V_516 ;
}
...
return - V_16 ;
F_116 ( V_17 ) ;
V_1966 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
V_516 = F_472 ( V_7 , V_559 , V_1966 ) ;
F_118 ( V_17 ) ;
return V_516 ;
}
static int F_473 ( const struct V_1972 * V_328 , struct V_31 * V_32 ,
struct V_29 * V_30 )
{
struct V_6 * V_7 ;
struct V_1 * V_17 ;
struct V_25 * V_559 ;
bool V_1973 = V_328 -> V_1974 & V_1975 ;
if ( V_1973 )
F_69 () ;
if ( V_328 -> V_1974 & V_1976 ) {
V_7 = F_12 ( F_95 ( V_30 ) , V_30 ) ;
if ( F_17 ( V_7 ) ) {
if ( V_1973 )
F_70 () ;
...
static void F_474 ( const struct V_1972 * V_328 , struct V_31 * V_32 ,
struct V_29 * V_30 )
{
if ( V_30 -> V_523 [ 1 ] ) {
if ( V_328 -> V_1974 & V_1978 ) {
struct V_1 * V_17 = V_30 -> V_523 [ 1 ] ;
if ( V_17 -> V_19 )
F_191 ( V_17 -> V_19 ) ;
} else {
...
if ( V_328 -> V_1974 & V_1975 )
F_70 () ;
if ( V_328 -> V_1974 & V_1980 ) {
struct V_1981 * V_36 = F_475 ( V_32 ) ;
...
goto V_59;
if ( V_1367 -> V_30 . V_1984 &&
( F_104 ( V_51 , V_1985 ,
V_1367 -> V_30 . V_1984 , V_1414 ) ||
F_49 ( V_51 , V_1986 , V_607 ,
V_1367 -> V_30 . V_1987 ) ) )
goto V_59;
return 0 ;
V_59:
...
struct V_1992 * V_1295 )
{
if ( F_54 ( V_51 , V_1993 , V_1295 -> V_1619 ) )
goto V_59;
...
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
const struct V_2009 * V_2010 = ( void * ) V_1642 ;
V_22 V_50 ;
if ( F_60 ( V_45 < 2 ) )
return;
if ( F_493 ( V_2010 -> V_2011 ) )
V_50 = V_2012 ;
else
V_50 = V_2013 ;
F_494 ( V_559 , V_1642 , V_45 ) ;
F_487 ( V_7 , V_559 , V_1642 , V_45 , V_50 , V_2003 , - 1 ) ;
}
...
T_10 V_1557 )
{
F_495 ( V_7 , V_19 , V_2006 ,
V_703 , V_1557 ) ;
}
void F_498 ( struct V_6 * V_7 ,
struct V_25 * V_19 ,
struct V_2015 * V_2016 ,
T_10 V_1557 )
{
struct V_31 * V_51 ;
void * V_360 ;
V_51 = F_75 ( 100 + V_2016 -> V_2017 + V_2016 -> V_2018 +
V_2016 -> V_1532 + V_2016 -> V_1612 +
( V_2016 -> V_1606 ? V_2019 : 0 ) , V_1557 ) ;
if ( ! V_51 )
return;
...
F_26 ( V_51 , V_10 , V_19 -> V_20 ) ||
( V_2016 -> V_566 &&
F_49 ( V_51 , V_567 , V_607 , V_2016 -> V_566 ) ) ||
F_53 ( V_51 , V_1621 ,
V_2016 -> V_2020 < 0 ? V_2021 :
V_2016 -> V_2020 ) ||
( V_2016 -> V_2020 < 0 &&
( F_27 ( V_51 , V_2014 ) ||
F_26 ( V_51 , V_2022 ,
V_2016 -> V_2023 ) ) ) ||
( V_2016 -> V_2024 &&
F_49 ( V_51 , V_2025 , V_2016 -> V_2017 , V_2016 -> V_2024 ) ) ||
( V_2016 -> V_2026 &&
F_49 ( V_51 , V_2027 , V_2016 -> V_2018 ,
V_2016 -> V_2026 ) ) ||
( V_2016 -> V_2028 &&
F_53 ( V_51 , V_1587 ,
V_2016 -> V_1593 ) ) ||
( V_2016 -> V_2020 == V_2029 &&
( ( V_2016 -> V_1531 &&
F_49 ( V_51 , V_1530 , V_2016 -> V_1532 ,
V_2016 -> V_1531 ) ) ||
( V_2016 -> V_1611 &&
F_49 ( V_51 , V_1506 , V_2016 -> V_1612 , V_2016 -> V_1611 ) ) ||
( V_2016 -> V_1606 &&
F_49 ( V_51 , V_1605 , V_2019 , V_2016 -> V_1606 ) ) ) ) )
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_332 ( & V_38 , F_7 ( & V_7 -> V_18 ) , V_51 , 0 ,
V_2005 , V_1557 ) ;
...
struct V_25 * V_19 ,
struct V_2030 * V_30 , T_10 V_1557 )
{
struct V_31 * V_51 ;
void * V_360 ;
const T_2 * V_566 = V_30 -> V_1405 ? V_30 -> V_1405 -> V_566 : V_30 -> V_566 ;
V_51 = F_75 ( 100 + V_30 -> V_2017 + V_30 -> V_2018 , V_1557 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2031 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
( V_30 -> V_2024 &&
F_49 ( V_51 , V_2025 , V_30 -> V_2017 ,
V_30 -> V_2024 ) ) ||
( V_30 -> V_2026 &&
F_49 ( V_51 , V_2027 , V_30 -> V_2018 ,
V_30 -> V_2026 ) ) ||
( V_30 -> V_2032 &&
F_27 ( V_51 , V_2033 ) ) )
goto V_59;
...
const T_2 * V_1214 , T_4 V_1215 , bool V_2034 )
{
struct V_31 * V_51 ;
void * V_360 ;
...
struct V_25 * V_19 , const T_2 * V_703 ,
enum V_2038 V_2039 , int V_2040 ,
const T_2 * V_2041 , T_10 V_1557 )
{
struct V_31 * V_51 ;
void * V_360 ;
V_51 = F_75 ( V_621 , V_1557 ) ;
...
F_26 ( V_51 , V_125 , V_2039 ) ||
( V_2040 != - 1 &&
F_54 ( V_51 , V_121 , V_2040 ) ) ||
( V_2041 && F_49 ( V_51 , V_120 , 6 , V_2041 ) ) )
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_332 ( & V_38 , F_7 ( & V_7 -> V_18 ) , V_51 , 0 ,
V_2005 , V_1557 ) ;
...
void * V_360 ;
struct V_4 * V_364 ;
V_51 = F_75 ( V_621 , V_2003 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2045 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
goto V_59;
F_46 ( V_51 , V_364 ) ;
V_364 = F_45 ( V_51 , V_2047 ) ;
if ( ! V_364 )
goto V_59;
if ( F_25 ( V_51 , V_2044 , false ) )
goto V_59;
F_46 ( V_51 , V_364 ) ;
F_65 ( V_51 , V_360 ) ;
F_245 () ;
...
struct V_31 * V_51 ;
void * V_360 ;
V_51 = F_75 ( V_2052 , V_1557 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2053 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_443 ( F_7 ( & V_7 -> V_18 ) , V_51 , V_1820 ) ;
return true ;
V_59:
F_66 ( V_51 , V_360 ) ;
F_76 ( V_51 ) ;
...
struct V_1 * V_17 , V_22 V_1820 ,
int V_2057 , int V_2058 ,
...
F_104 ( V_51 , V_12 , V_13 ( V_17 ) ,
V_606 ) ||
F_26 ( V_51 , V_542 , V_2057 ) ||
( V_2058 &&
F_26 ( V_51 , V_2059 , V_2058 ) ) ||
F_49 ( V_51 , V_1639 , V_45 , V_1642 ) ||
( V_49 &&
F_26 ( V_51 , V_2060 , V_49 ) ) )
goto V_59;
F_65 ( V_51 , V_360 ) ;
return F_443 ( F_7 ( & V_7 -> V_18 ) , V_51 , V_1820 ) ;
V_59:
F_66 ( V_51 , V_360 ) ;
F_76 ( V_51 ) ;
return - V_89 ;
...
const T_2 * V_1642 , T_4 V_45 , bool V_2061 , T_10 V_1557 )
{
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
struct V_25 * V_19 = V_17 -> V_19 ;
struct V_31 * V_51 ;
void * V_360 ;
F_525 ( V_17 , V_673 , V_2061 ) ;
V_51 = F_75 ( 100 + V_45 , V_1557 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2062 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
enum V_2065 V_2066 ,
T_7 V_2067 , T_10 V_1557 )
{
struct V_31 * V_51 ;
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_6 * V_7 = F_11 ( V_17 -> V_18 ) ;
F_529 ( V_559 , V_2066 , V_2067 ) ;
if ( F_60 ( V_2066 != V_2068 &&
V_2066 != V_2069 ) )
return;
if ( V_17 -> V_1665 ) {
V_17 -> V_1665 -> V_1666 = V_2067 ;
F_375 ( V_7 , V_559 ) ;
if ( V_2067 == 0 )
V_2067 = V_17 -> V_1665 -> V_1666 ;
}
...
const T_2 * V_1618 , V_22 V_2072 , T_10 V_1557 )
{
struct V_31 * V_51 ;
F_532 ( V_559 , V_1618 , V_2072 ) ;
V_51 = F_526 ( V_559 , V_1618 , V_1557 ) ;
if ( ! V_51 )
return;
if ( F_26 ( V_51 , V_2073 , V_2072 ) )
goto V_59;
F_527 ( V_51 , V_1557 ) ;
return;
V_59:
...
struct V_6 * V_7 = F_11 ( V_18 ) ;
F_536 ( V_559 , V_566 ) ;
F_534 ( V_7 , V_559 , V_566 , V_1811 , V_1557 ) ;
}
static void
F_537 ( struct V_6 * V_7 ,
struct V_25 * V_19 , int V_2077 ,
const T_2 * V_566 , bool V_2078 , T_10 V_1557 )
{
struct V_31 * V_51 ;
struct V_4 * V_43 ;
void * V_360 ;
...
F_26 ( V_51 , V_10 , V_19 -> V_20 ) )
goto V_59;
V_43 = F_45 ( V_51 , V_2080 ) ;
if ( ! V_43 )
goto V_59;
if ( F_26 ( V_51 , V_2081 , V_2077 ) ||
F_49 ( V_51 , V_2082 , V_607 , V_566 ) ||
( V_2078 &&
F_27 ( V_51 , V_2083 ) ) )
goto V_59;
F_46 ( V_51 , V_43 ) ;
...
void F_538 ( struct V_25 * V_559 , int V_2077 ,
const T_2 * V_566 , bool V_2078 , T_10 V_1557 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
F_539 ( V_559 , V_2077 , V_566 , V_2078 ) ;
F_537 ( V_7 , V_559 , V_2077 , V_566 , V_2078 , V_1557 ) ;
}
...
T_1 V_673 , bool V_2091 , T_10 V_1557 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_6 * V_7 = F_11 ( V_17 -> V_18 ) ;
struct V_31 * V_51 ;
void * V_360 ;
F_547 ( V_559 , V_703 , V_673 , V_2091 ) ;
V_51 = F_75 ( V_621 , V_1557 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_1814 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
F_549 ( V_18 , V_2092 , V_45 , V_2057 , V_2058 ) ;
F_302 ( & V_7 -> V_1819 ) ;
F_6 (reg, &rdev->beacon_registrations, list) {
V_51 = F_75 ( V_45 + 100 , V_2003 ) ;
if ( ! V_51 ) {
F_304 ( & V_7 -> V_1819 ) ;
return;
}
...
( V_2058 &&
F_26 ( V_51 , V_2059 , V_2058 ) ) ||
F_49 ( V_51 , V_1639 , V_45 , V_2092 ) )
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_443 ( F_7 ( & V_7 -> V_18 ) , V_51 , V_1816 -> V_1820 ) ;
}
F_304 ( & V_7 -> V_1819 ) ;
return;
V_59:
...
struct V_2093 * V_2094 )
{
struct V_2095 * V_1724 = V_2094 -> V_2096 ;
struct V_4 * V_2097 , * V_2098 , * V_363 ;
int V_160 , V_162 ;
V_2097 = F_45 (
V_51 , V_2099 ) ;
if ( ! V_2097 )
return - V_515 ;
for ( V_160 = 0 ; V_160 < V_1724 -> V_2100 ; V_160 ++ ) {
struct V_2101 * V_1726 = V_1724 -> V_1725 [ V_160 ] ;
V_2098 = F_45 ( V_51 , V_160 ) ;
if ( ! V_2098 )
break;
...
void * V_360 ;
int V_1728 = 200 ;
F_553 ( V_17 -> V_18 , V_17 , V_2094 ) ;
if ( V_2094 )
V_1728 += V_2094 -> V_2102 ;
V_51 = F_75 ( V_1728 , V_1557 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2103 ) ;
if ( ! V_360 )
goto V_683;
if ( F_26 ( V_51 , V_26 , V_7 -> V_14 ) ||
F_104 ( V_51 , V_12 , V_13 ( V_17 ) ,
...
if ( V_2094 -> V_2120 &&
F_26 ( V_51 , V_2115 , V_2094 -> V_2120 ) )
goto V_683;
if ( F_49 ( V_51 , V_2113 , V_2094 -> V_2102 ,
V_2094 -> V_2112 ) )
goto V_683;
}
if ( V_2094 -> V_2096 &&
...
struct V_31 * V_51 ;
void * V_360 ;
F_555 ( V_17 -> V_18 , V_559 , V_1618 , V_2121 ,
V_1056 ) ;
V_51 = F_75 ( V_621 , V_1557 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2122 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
static int F_556 ( struct V_2123 * V_2124 ,
unsigned long V_359 ,
void * V_2125 )
{
struct V_2126 * V_2127 = V_2125 ;
struct V_6 * V_7 ;
struct V_1 * V_17 ;
struct V_1815 * V_1816 , * V_24 ;
if ( V_359 != V_2128 || V_2127 -> V_2129 != V_2130 )
return V_2131 ;
F_245 () ;
...
list) {
if ( V_1361 -> V_660 == V_2127 -> V_47 ) {
V_1361 -> V_2132 = true ;
F_558 ( & V_7 -> V_2133 ) ;
}
}
F_557 (wdev, &rdev->wiphy.wdev_list, list) {
F_559 ( V_17 , V_2127 -> V_47 ) ;
if ( V_17 -> V_660 == V_2127 -> V_47 ) {
V_17 -> V_2132 = true ;
F_558 ( & V_7 -> V_2134 ) ;
} else if ( V_17 -> V_1535 == V_2127 -> V_47 ) {
F_558 ( & V_17 -> V_2135 ) ;
}
}
F_302 ( & V_7 -> V_1819 ) ;
...
struct V_2137 * V_2138 )
{
struct V_18 * V_18 = V_19 -> V_28 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
struct V_31 * V_51 ;
void * V_360 ;
F_564 ( V_18 , V_19 , V_2138 ) ;
if ( ! V_2138 -> V_2139 )
return;
V_51 = F_75 ( 100 + V_2138 -> V_2140 , V_135 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2141 ) ;
if ( ! V_360 )
goto V_620;
if ( F_26 ( V_51 , V_26 , V_7 -> V_14 ) ||
F_26 ( V_51 , V_10 , V_19 -> V_20 ) ||
F_49 ( V_51 , V_567 , V_607 , V_2138 -> V_2139 ) )
goto V_620;
if ( V_2138 -> V_776 &&
F_49 ( V_51 , V_752 , V_2138 -> V_775 , V_2138 -> V_776 ) )
goto V_620;
if ( V_2138 -> V_2142 &&
F_49 ( V_51 , V_2143 , V_2138 -> V_2140 ,
V_2138 -> V_2142 ) )
goto V_620;
F_65 ( V_51 , V_360 ) ;
F_332 ( & V_38 , F_7 ( & V_7 -> V_18 ) , V_51 , 0 ,
