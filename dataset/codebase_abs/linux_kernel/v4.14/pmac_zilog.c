...
struct V_217 * V_218 ;
int V_93 ;
V_218 = F_116 ( V_2 -> V_268 , V_269 , 0 ) ;
V_93 = F_117 ( V_2 -> V_268 , 0 ) ;
if ( ! V_218 || V_93 <= 0 )
return - V_221 ;
V_2 -> V_36 . V_222 = V_218 -> V_223 ;
V_2 -> V_36 . V_224 = ( unsigned char V_270 * ) V_218 -> V_223 ;
V_2 -> V_36 . V_241 = V_242 ;
V_2 -> V_36 . V_93 = V_93 ;
V_2 -> V_36 . V_243 = V_166 ;
V_2 -> V_36 . V_244 = 1 ;
...
static int T_3 F_100 ( struct V_274 * V_268 )
{
struct V_1 * V_2 ;
int V_4 ;
for ( V_4 = 0 ; V_4 < V_267 ; V_4 ++ )
if ( V_254 [ V_4 ] . V_268 == V_268 )
break;
if ( V_4 >= V_267 )
return - V_221 ;
V_2 = & V_254 [ V_4 ] ;
V_2 -> V_36 . V_256 = & V_268 -> V_256 ;
F_118 ( V_268 , V_2 ) ;
return F_103 ( & V_260 , & V_2 -> V_36 ) ;
}
static int T_5 F_104 ( struct V_274 * V_268 )
{
struct V_1 * V_2 = F_119 ( V_268 ) ;
if ( ! V_2 )
return - V_221 ;
F_106 ( & V_260 , & V_2 -> V_36 ) ;
V_2 -> V_36 . V_256 = NULL ;
...
static void F_131 ( struct V_280 * V_281 , const char * V_282 , unsigned int V_213 )
{
struct V_1 * V_2 = & V_254 [ V_281 -> V_283 ] ;
unsigned long V_30 ;
F_44 ( & V_2 -> V_36 . V_56 , V_30 ) ;
F_7 ( V_2 , V_6 , V_2 -> V_32 [ 1 ] & ~ V_9 ) ;
F_7 ( V_2 , V_15 , V_2 -> V_32 [ 5 ] | V_16 | V_119 | V_121 ) ;
F_132 ( & V_2 -> V_36 , V_282 , V_213 , F_130 ) ;
F_7 ( V_2 , V_6 , V_2 -> V_32 [ 1 ] ) ;
F_45 ( & V_2 -> V_36 . V_56 , V_30 ) ;
}
static int T_3 F_133 ( struct V_280 * V_284 , char * V_285 )
{
struct V_1 * V_2 ;
struct V_113 * V_36 ;
int V_161 = 38400 ;
...
F_71 ( V_150 ) ;
if ( V_285 )
F_136 ( V_285 , & V_161 , & V_62 , & V_286 , & V_287 ) ;
return F_137 ( V_36 , V_284 , V_161 , V_62 , V_286 , V_287 ) ;
}
