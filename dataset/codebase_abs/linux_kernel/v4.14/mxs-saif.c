...
V_27 = F_7 ( V_7 -> V_20 + V_28 ) ;
if ( ! V_7 -> V_25 && ( V_27 & V_29 ) ) {
F_6 ( V_2 -> V_16 , L_4 ) ;
return - V_30 ;
}
V_14 = F_4 ( V_7 , V_7 -> V_9 , F_21 ( V_58 ) ) ;
if ( V_14 ) {
F_6 ( V_2 -> V_16 , L_7 ) ;
return V_14 ;
}
...
static int F_27 ( struct V_53 * V_54 , int V_68 ,
struct V_1 * V_2 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_6 * V_15 ;
...
static int F_29 ( struct V_1 * V_81 )
{
struct V_6 * V_7 = F_30 ( V_81 -> V_16 ) ;
F_31 ( V_81 , V_7 ) ;
return 0 ;
}
...
{
struct V_6 * V_7 = F_34 ( V_89 ) ;
struct V_90 * V_91 = V_89 -> V_16 . V_92 ;
struct V_24 * V_24 ;
int V_14 ;
V_24 = F_35 ( & V_89 -> V_16 , L_15 ,
F_36 ( V_7 -> V_24 ) , 0 ,
V_7 -> V_20 + V_21 ,
V_93 , 3 ,
0 , NULL ) ;
...
if ( ! V_91 )
return - V_10 ;
V_7 = F_41 ( & V_89 -> V_16 , sizeof( * V_7 ) , V_99 ) ;
if ( ! V_7 )
return - V_100 ;
V_14 = F_42 ( V_91 , L_17 ) ;
if ( V_14 < 0 )
...
V_7 -> V_17 = V_14 ;
if ( V_7 -> V_17 >= F_43 ( V_6 ) ) {
F_6 ( & V_89 -> V_16 , L_18 ) ;
return - V_10 ;
}
V_98 = F_44 ( V_91 , L_19 , 0 ) ;
if ( ! V_98 ) {
V_7 -> V_11 = V_7 -> V_17 ;
} else {
V_14 = F_42 ( V_98 , L_17 ) ;
...
V_7 -> V_11 = V_14 ;
if ( V_7 -> V_11 >= F_43 ( V_6 ) ) {
F_6 ( & V_89 -> V_16 , L_20 ) ;
return - V_10 ;
}
}
V_6 [ V_7 -> V_17 ] = V_7 ;
V_7 -> V_24 = F_45 ( & V_89 -> V_16 , NULL ) ;
if ( F_37 ( V_7 -> V_24 ) ) {
V_14 = F_38 ( V_7 -> V_24 ) ;
F_6 ( & V_89 -> V_16 , L_21 ,
V_14 ) ;
...
V_97 = F_46 ( V_89 , V_101 , 0 ) ;
V_7 -> V_20 = F_47 ( & V_89 -> V_16 , V_97 ) ;
if ( F_37 ( V_7 -> V_20 ) )
...
V_7 -> V_16 = & V_89 -> V_16 ;
V_14 = F_49 ( & V_89 -> V_16 , V_82 , F_32 , 0 ,
F_50 ( & V_89 -> V_16 ) , V_7 ) ;
if ( V_14 ) {
F_6 ( & V_89 -> V_16 , L_23 ) ;
return V_14 ;
