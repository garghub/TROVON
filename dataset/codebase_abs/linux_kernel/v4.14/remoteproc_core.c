...
{
struct V_50 * V_51 ;
F_49 (subdev, &rproc->subdevs, node)
V_51 -> remove ( V_51 ) ;
}
...
struct V_5 * V_6 = & V_10 -> V_6 ;
F_51 (entry, tmp, &rproc->traces, node) {
F_52 ( V_87 -> V_69 ) ;
V_10 -> V_68 -- ;
F_38 ( & V_87 -> V_61 ) ;
F_35 ( V_87 ) ;
}
F_51 (entry, tmp, &rproc->mappings, node) {
T_4 V_90 ;
V_90 = F_53 ( V_10 -> V_4 , V_87 -> V_19 , V_87 -> V_20 ) ;
if ( V_90 != V_87 -> V_20 ) {
...
F_51 (entry, tmp, &rproc->carveouts, node) {
F_21 ( V_6 -> V_13 , V_87 -> V_20 , V_87 -> V_28 ,
V_87 -> V_37 ) ;
F_38 ( & V_87 -> V_61 ) ;
F_35 ( V_87 ) ;
}
F_51 (rvdev, rvtmp, &rproc->rvdevs, node)
F_54 ( & V_30 -> V_58 , F_36 ) ;
}
static int F_55 ( struct V_10 * V_10 , const struct V_91 * V_92 )
{
struct V_93 * V_94 , * V_95 ;
struct V_5 * V_6 = & V_10 -> V_6 ;
int V_14 , V_96 ;
V_94 = F_56 ( V_10 , V_92 , & V_96 ) ;
if ( ! V_94 ) {
F_4 ( V_6 , L_35 ) ;
return - V_42 ;
}
...
V_10 -> V_100 = V_101 ;
F_59 ( V_6 , L_39 , V_10 -> V_67 ) ;
return 0 ;
}
static int F_60 ( struct V_10 * V_10 , const struct V_91 * V_92 )
{
struct V_5 * V_6 = & V_10 -> V_6 ;
...
if ( V_14 )
return V_14 ;
F_59 ( V_6 , L_40 , V_67 , V_92 -> V_38 ) ;
V_14 = F_6 ( V_10 ) ;
if ( V_14 ) {
F_4 ( V_6 , L_41 , V_14 ) ;
return V_14 ;
}
V_10 -> V_102 = F_62 ( V_10 , V_92 ) ;
V_14 = - V_42 ;
V_94 = F_56 ( V_10 , V_92 , & V_96 ) ;
if ( ! V_94 ) {
F_4 ( V_6 , L_42 ) ;
...
static void F_64 ( const struct V_91 * V_92 , void * V_106 )
{
...
static int F_69 ( struct V_10 * V_10 )
{
struct V_5 * V_6 = & V_10 -> V_6 ;
int V_14 ;
F_48 ( V_10 ) ;
...
F_70 ( & V_10 -> V_110 ) ;
V_10 -> V_100 = V_111 ;
F_59 ( V_6 , L_46 , V_10 -> V_67 ) ;
return 0 ;
}
int F_71 ( struct V_10 * V_10 )
{
...
goto V_114;
F_74 ( & V_10 -> V_110 ) ;
V_14 = F_75 ( & V_112 , V_10 -> V_91 , V_6 ) ;
if ( V_14 < 0 ) {
F_4 ( V_6 , L_48 , V_14 ) ;
goto V_114;
}
V_14 = F_55 ( V_10 , V_112 ) ;
F_66 ( V_112 ) ;
V_114:
F_76 ( & V_10 -> V_113 ) ;
return V_14 ;
...
F_59 ( V_6 , L_54 , V_10 -> V_67 ) ;
V_14 = F_75 ( & V_112 , V_10 -> V_91 , V_6 ) ;
if ( V_14 < 0 ) {
F_4 ( V_6 , L_48 , V_14 ) ;
goto V_124;
}
V_14 = F_60 ( V_10 , V_112 ) ;
F_66 ( V_112 ) ;
V_124:
if ( V_14 )
F_81 ( & V_10 -> V_123 ) ;
...
struct V_10 * F_115 ( struct V_5 * V_6 )
{
for ( V_6 = V_6 -> V_13 ; V_6 ; V_6 = V_6 -> V_13 ) {
if ( V_6 -> type == & V_140 )
return V_6 -> V_143 ;
}
return NULL ;
