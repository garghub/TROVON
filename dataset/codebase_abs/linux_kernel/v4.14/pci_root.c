...
F_57 () ;
F_58 ( V_5 ) ;
F_59 ( V_24 -> V_75 -> V_123 , V_5 -> V_124 . V_60 . V_125 ) ;
if ( V_105 ) {
F_60 ( V_24 -> V_75 ) ;
F_61 ( V_24 -> V_75 ) ;
F_62 ( V_24 -> V_5 -> V_3 ) ;
...
static void F_98 ( struct V_153 * V_123 )
{
struct V_8 * V_10 ;
struct V_131 * V_33 ;
...
V_145 -> V_151 = V_151 ;
F_29 ( & V_145 -> V_127 ) ;
snprintf ( V_145 -> V_148 , sizeof( V_145 -> V_148 ) , L_31 ,
V_24 -> V_104 , V_157 ) ;
...
goto V_159;
F_104 ( V_75 ) ;
F_105 ( F_106 ( V_75 -> V_123 ) ,
F_98 , V_145 ) ;
if ( V_70 != V_162 )
F_107 ( V_163 , & V_75 -> V_36 , L_32 , V_70 ) ;
return V_75 ;
V_159:
F_96 ( V_145 ) ;
return NULL ;
