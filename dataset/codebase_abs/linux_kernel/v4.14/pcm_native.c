...
V_257 = F_163 ( V_262 , V_257 ) ;
}
V_257 = F_164 ( V_257 * 1000 ) ;
}
V_257 = F_165 ( V_257 ) ;
F_115 ( & V_7 ) ;
F_14 ( V_4 ) ;
F_166 ( & V_258 -> V_213 , & V_251 ) ;
if ( V_19 -> V_263 ) {
V_151 = - V_264 ;
break;
}
...
static bool F_169 ( struct V_246 * V_246 )
{
struct V_267 * V_267 = F_170 ( V_246 ) ;
unsigned int V_268 ;
if ( ! F_171 ( V_267 -> V_269 ) || F_172 ( V_267 ) != V_270 )
return false ;
V_268 = F_173 ( V_267 ) ;
return F_174 ( V_268 , V_271 ) ||
F_174 ( V_268 , V_272 ) ;
}
static int F_175 ( struct V_3 * V_4 , int V_273 )
{
int V_185 = 0 ;
struct V_274 * V_275 ;
struct V_3 * V_276 ;
struct V_277 * V_201 ;
struct V_273 V_278 = F_176 ( V_273 ) ;
if ( ! V_278 . V_246 )
return - V_118 ;
if ( ! F_169 ( V_278 . V_246 ) ) {
V_185 = - V_118 ;
goto V_279;
}
...
V_201 = NULL ;
F_178 ( & V_4 -> V_201 -> V_2 ) ;
F_179 ( & V_4 -> V_201 -> V_10 ) ;
F_180 ( & V_4 -> V_201 -> V_283 ) ;
F_181 ( & V_4 -> V_284 , & V_4 -> V_201 -> V_283 ) ;
V_4 -> V_201 -> V_285 = 1 ;
}
F_181 ( & V_276 -> V_284 , & V_4 -> V_201 -> V_283 ) ;
V_4 -> V_201 -> V_285 ++ ;
...
static int F_189 ( struct V_47 * V_48 ,
struct V_71 * V_286 )
{
struct V_62 V_262 ;
F_190 ( F_48 ( V_48 , V_286 -> V_78 [ 0 ] ) ,
...
if ( V_112 <= 0 )
continue;
if ( ( unsigned ) V_112 < V_63 -> V_290 || ( unsigned ) V_112 > V_63 -> F_163 )
F_200 ( & V_53 , V_54 ) ;
}
...
V_262 . V_290 = V_112 ;
if ( V_262 . F_163 < ( unsigned ) V_112 )
V_262 . F_163 = V_112 ;
}
V_262 . integer = 1 ;
return F_41 ( F_38 ( V_48 , V_286 -> V_79 ) , & V_262 ) ;
}
static int F_202 ( struct V_47 * V_48 ,
struct V_71 * V_286 )
{
struct V_294 * V_38 = V_286 -> V_287 ;
return F_203 ( F_38 ( V_48 , V_286 -> V_79 ) ,
V_295 . V_285 ,
...
int V_54 , V_34 ;
for ( V_54 = V_57 ; V_54 <= V_58 ; V_54 ++ ) {
F_198 ( F_35 ( V_50 , V_54 ) ) ;
}
for ( V_54 = V_65 ; V_54 <= V_66 ; V_54 ++ ) {
F_206 ( F_42 ( V_50 , V_54 ) ) ;
}
F_207 ( F_42 ( V_50 , V_88 ) ) ;
F_207 ( F_42 ( V_50 , V_109 ) ) ;
F_207 ( F_42 ( V_50 , V_299 ) ) ;
F_207 ( F_42 ( V_50 , V_82 ) ) ;
F_207 ( F_42 ( V_50 , V_300 ) ) ;
V_34 = F_208 ( V_15 , 0 , V_87 ,
F_197 , NULL ,
V_82 , - 1 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_208 ( V_15 , 0 , V_82 ,
F_201 , NULL ,
V_87 ,
V_82 , - 1 ) ;
if ( V_34 < 0 )
...
if ( V_34 < 0 )
return V_34 ;
V_34 = F_208 ( V_15 , 0 , V_88 ,
F_191 , NULL ,
V_300 , V_82 , - 1 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_208 ( V_15 , 0 , V_84 ,
F_195 , ( void * ) 1000000 ,
V_302 , V_108 , - 1 ) ;
if ( V_34 < 0 )
return V_34 ;
...
if ( V_34 < 0 )
return V_34 ;
V_34 = F_208 ( V_15 , 0 , V_304 ,
F_191 , NULL ,
V_109 , V_302 , - 1 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_208 ( V_15 , 0 , V_302 ,
F_191 , NULL ,
V_109 , V_304 , - 1 ) ;
if ( V_34 < 0 )
return V_34 ;
...
if ( V_34 < 0 )
return V_34 ;
V_34 = F_208 ( V_15 , 0 , V_301 ,
F_193 , ( void * ) 8 ,
V_302 , V_300 , - 1 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_208 ( V_15 , 0 , V_299 ,
F_193 , ( void * ) 8 ,
V_109 , V_300 , - 1 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_208 ( V_15 , 0 , V_108 ,
F_195 , ( void * ) 1000000 ,
V_302 , V_84 , - 1 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_208 ( V_15 , 0 , V_303 ,
F_195 , ( void * ) 1000000 ,
V_109 , V_84 , - 1 ) ;
if ( V_34 < 0 )
return V_34 ;
...
V_34 = F_210 ( V_15 , V_106 , V_288 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_211 ( V_15 , V_87 , V_38 -> V_313 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_210 ( V_15 , V_107 , 1 << V_314 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_212 ( V_15 , V_88 ,
V_38 -> V_315 , V_38 -> V_316 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_212 ( V_15 , V_84 ,
V_38 -> V_317 , V_38 -> V_318 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_212 ( V_15 , V_301 ,
V_38 -> V_319 , V_38 -> V_320 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_212 ( V_15 , V_304 ,
V_38 -> V_321 , V_38 -> V_322 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_212 ( V_15 , V_299 ,
...
return V_34 ;
if ( V_15 -> V_323 ) {
V_34 = F_212 ( V_15 , V_299 , 0 , V_15 -> V_323 ) ;
if ( V_34 < 0 )
return V_34 ;
}
...
int F_217 ( struct V_16 * V_5 , int V_22 ,
struct V_246 * V_246 ,
struct V_3 * * V_330 )
{
struct V_3 * V_4 ;
int V_34 ;
V_34 = F_218 ( V_5 , V_22 , V_246 , & V_4 ) ;
if ( V_34 < 0 )
return V_34 ;
if ( V_4 -> V_326 > 1 ) {
* V_330 = V_4 ;
...
static int F_220 ( struct V_246 * V_246 ,
struct V_16 * V_5 ,
int V_22 )
{
struct V_274 * V_275 ;
struct V_3 * V_4 ;
int V_34 ;
V_34 = F_217 ( V_5 , V_22 , V_246 , & V_4 ) ;
if ( V_34 < 0 )
return V_34 ;
V_275 = F_221 ( sizeof( * V_275 ) , V_35 ) ;
if ( V_275 == NULL ) {
F_215 ( V_4 ) ;
return - V_36 ;
}
...
static int F_222 ( struct V_267 * V_267 , struct V_246 * V_246 )
{
struct V_16 * V_5 ;
int V_34 = F_223 ( V_267 , V_246 ) ;
if ( V_34 < 0 )
return V_34 ;
V_5 = F_174 ( F_173 ( V_267 ) ,
V_271 ) ;
V_34 = F_224 ( V_246 , V_5 , V_156 ) ;
if ( V_5 )
F_184 ( V_5 -> V_19 ) ;
return V_34 ;
}
static int F_225 ( struct V_267 * V_267 , struct V_246 * V_246 )
{
struct V_16 * V_5 ;
int V_34 = F_223 ( V_267 , V_246 ) ;
if ( V_34 < 0 )
...
V_5 = F_174 ( F_173 ( V_267 ) ,
V_272 ) ;
V_34 = F_224 ( V_246 , V_5 , V_332 ) ;
if ( V_5 )
F_184 ( V_5 -> V_19 ) ;
return V_34 ;
}
static int F_224 ( struct V_246 * V_246 , struct V_16 * V_5 , int V_22 )
{
int V_34 ;
T_4 V_251 ;
if ( V_5 == NULL ) {
...
V_34 = F_226 ( V_5 -> V_19 , V_246 ) ;
if ( V_34 < 0 )
goto V_333;
if ( ! F_227 ( V_5 -> V_19 -> V_334 ) ) {
V_34 = - V_37 ;
goto V_335;
}
F_161 ( & V_251 , V_259 ) ;
...
F_166 ( & V_5 -> V_336 , & V_251 ) ;
F_10 ( & V_5 -> V_337 ) ;
if ( V_34 < 0 )
goto V_339;
return V_34 ;
V_339:
F_230 ( V_5 -> V_19 -> V_334 ) ;
V_335:
F_231 ( V_5 -> V_19 , V_246 ) ;
V_333:
return V_34 ;
}
static int F_232 ( struct V_267 * V_267 , struct V_246 * V_246 )
{
struct V_16 * V_5 ;
struct V_3 * V_4 ;
struct V_274 * V_275 ;
...
static T_5 F_234 ( struct V_3 * V_4 ,
T_2 V_113 ,
T_5 V_177 )
{
struct V_14 * V_15 = V_4 -> V_15 ;
...
static T_5 F_237 ( struct V_3 * V_4 ,
T_2 V_113 )
{
struct V_14 * V_15 = V_4 -> V_15 ;
T_5 V_216 ;
...
V_216 = F_233 ( V_4 ) ;
if ( ! V_216 )
V_216 = F_234 ( V_4 , V_113 ,
F_97 ( V_15 ) ) ;
F_16 ( V_4 ) ;
return V_216 ;
}
static T_5 F_242 ( struct V_3 * V_4 ,
T_2 V_113 )
{
struct V_14 * V_15 = V_4 -> V_15 ;
T_5 V_216 ;
...
static int F_246 ( struct V_3 * V_4 , int T_1 * V_349 )
{
struct V_14 * V_15 = V_4 -> V_15 ;
int V_350 ;
...
if ( V_15 -> V_100 -> V_99 == V_115 )
return - V_118 ;
if ( F_248 ( 0 , & V_352 -> V_151 ) )
return - V_37 ;
if ( F_91 ( & V_353 , V_352 , sizeof( V_353 ) ) )
return - V_37 ;
if ( V_4 -> V_22 == V_156 )
V_151 = F_249 ( V_4 , V_353 . V_354 , V_353 . V_113 ) ;
else
V_151 = F_250 ( V_4 , V_353 . V_354 , V_353 . V_113 ) ;
F_251 ( V_151 , & V_352 -> V_151 ) ;
return V_151 < 0 ? V_151 : 0 ;
}
static int F_252 ( struct V_3 * V_4 ,
struct V_355 T_1 * V_356 )
{
struct V_355 V_357 ;
struct V_14 * V_15 = V_4 -> V_15 ;
void * V_358 ;
...
if ( V_15 -> V_127 > 128 )
return - V_59 ;
if ( F_248 ( 0 , & V_356 -> V_151 ) )
return - V_37 ;
if ( F_91 ( & V_357 , V_356 , sizeof( V_357 ) ) )
return - V_37 ;
V_358 = F_55 ( V_357 . V_358 , sizeof( void * ) * V_15 -> V_127 ) ;
if ( F_56 ( V_358 ) )
return F_57 ( V_358 ) ;
if ( V_4 -> V_22 == V_156 )
V_151 = F_253 ( V_4 , V_358 , V_357 . V_113 ) ;
else
V_151 = F_254 ( V_4 , V_358 , V_357 . V_113 ) ;
F_27 ( V_358 ) ;
F_251 ( V_151 , & V_356 -> V_151 ) ;
return V_151 < 0 ? V_151 : 0 ;
}
...
T_2 V_113 ;
T_5 V_151 ;
if ( F_100 ( V_113 , V_359 ) )
return - V_37 ;
if ( F_248 ( 0 , V_359 ) )
return - V_37 ;
if ( V_4 -> V_22 == V_156 )
V_151 = F_237 ( V_4 , V_113 ) ;
else
...
V_151 = F_242 ( V_4 , V_113 ) ;
F_251 ( V_151 , V_359 ) ;
return V_151 < 0 ? V_151 : 0 ;
}
static int F_257 ( struct V_246 * V_246 ,
struct V_3 * V_4 ,
unsigned int V_360 , void T_1 * V_350 )
{
struct V_274 * V_275 = V_246 -> V_280 ;
int V_185 ;
if ( F_67 ( V_4 ) )
return - V_114 ;
V_185 = F_258 ( V_4 -> V_5 -> V_19 , V_361 ) ;
if ( V_185 < 0 )
return V_185 ;
switch ( V_360 ) {
case V_362 :
return F_248 ( V_363 , ( int T_1 * ) V_350 ) ? - V_37 : 0 ;
case V_364 :
return F_24 ( V_4 , V_350 ) ;
case V_365 :
return 0 ;
case V_366 :
return F_246 ( V_4 , V_350 ) ;
case V_367 :
if ( F_100 ( V_275 -> V_368 ,
...
return F_122 ( V_4 ) ;
case V_379 :
return F_175 ( V_4 , ( int ) ( unsigned long ) V_350 ) ;
case V_380 :
return F_187 ( V_4 ) ;
case V_381 :
return F_145 ( V_4 ) ;
...
if ( V_180 < 0 )
return V_180 ;
if ( F_248 ( V_180 , V_185 ) )
return - V_37 ;
return 0 ;
}
case V_385 :
return F_245 ( V_4 , V_350 ) ;
#ifdef F_259
case V_386 :
return F_260 ( V_4 , V_350 ) ;
case V_387 :
return F_261 ( V_4 , V_350 ) ;
#endif
case V_388 :
...
case V_395 :
return F_255 ( V_4 , V_350 ) ;
case V_396 :
return F_256 ( V_4 , V_350 ) ;
}
F_219 ( V_4 -> V_5 , L_4 , V_360 ) ;
return - V_397 ;
}
static long F_262 ( struct V_246 * V_246 , unsigned int V_360 ,
unsigned long V_350 )
{
struct V_274 * V_275 ;
V_275 = V_246 -> V_280 ;
if ( ( ( V_360 >> 8 ) & 0xff ) != 'A' )
return - V_397 ;
return F_257 ( V_246 , V_275 -> V_4 , V_360 ,
( void T_1 * ) V_350 ) ;
}
int F_263 ( struct V_3 * V_4 ,
unsigned int V_360 , void * V_350 )
{
T_2 * V_113 = V_350 ;
T_5 V_151 ;
switch ( V_360 ) {
...
static T_6 F_264 ( struct V_246 * V_246 , char T_1 * V_354 , T_7 V_285 ,
T_8 * V_398 )
{
struct V_274 * V_275 ;
struct V_3 * V_4 ;
...
if ( ! F_265 ( V_15 , V_285 ) )
return - V_59 ;
V_285 = F_266 ( V_15 , V_285 ) ;
V_151 = F_250 ( V_4 , V_354 , V_285 ) ;
if ( V_151 > 0 )
V_151 = F_267 ( V_15 , V_151 ) ;
return V_151 ;
}
static T_6 F_268 ( struct V_246 * V_246 , const char T_1 * V_354 ,
T_7 V_285 , T_8 * V_398 )
{
struct V_274 * V_275 ;
struct V_3 * V_4 ;
...
return - V_59 ;
V_285 = F_266 ( V_15 , V_285 ) ;
V_151 = F_249 ( V_4 , V_354 , V_285 ) ;
if ( V_151 > 0 )
V_151 = F_267 ( V_15 , V_151 ) ;
return V_151 ;
}
static T_6 F_269 ( struct V_399 * V_400 , struct V_401 * V_402 )
{
struct V_274 * V_275 ;
struct V_3 * V_4 ;
struct V_14 * V_15 ;
...
return - V_59 ;
if ( ! F_265 ( V_15 , V_402 -> V_405 -> V_406 ) )
return - V_59 ;
V_113 = F_271 ( V_15 , V_402 -> V_405 -> V_406 ) ;
V_358 = F_25 ( sizeof( void * ) * V_402 -> V_404 , V_35 ) ;
if ( V_358 == NULL )
return - V_36 ;
for ( V_63 = 0 ; V_63 < V_402 -> V_404 ; ++ V_63 )
V_358 [ V_63 ] = V_402 -> V_405 [ V_63 ] . V_407 ;
V_151 = F_254 ( V_4 , V_358 , V_113 ) ;
if ( V_151 > 0 )
V_151 = F_267 ( V_15 , V_151 ) ;
F_27 ( V_358 ) ;
return V_151 ;
}
static T_6 F_272 ( struct V_399 * V_400 , struct V_401 * V_408 )
{
struct V_274 * V_275 ;
struct V_3 * V_4 ;
struct V_14 * V_15 ;
...
! F_265 ( V_15 , V_408 -> V_405 -> V_406 ) )
return - V_59 ;
V_113 = F_271 ( V_15 , V_408 -> V_405 -> V_406 ) ;
V_358 = F_25 ( sizeof( void * ) * V_408 -> V_404 , V_35 ) ;
if ( V_358 == NULL )
return - V_36 ;
for ( V_63 = 0 ; V_63 < V_408 -> V_404 ; ++ V_63 )
V_358 [ V_63 ] = V_408 -> V_405 [ V_63 ] . V_407 ;
V_151 = F_253 ( V_4 , V_358 , V_113 ) ;
if ( V_151 > 0 )
V_151 = F_267 ( V_15 , V_151 ) ;
F_27 ( V_358 ) ;
return V_151 ;
}
static unsigned int F_273 ( struct V_246 * V_246 , T_9 * V_251 )
{
struct V_274 * V_275 ;
struct V_3 * V_4 ;
struct V_14 * V_15 ;
...
static int F_276 ( struct V_414 * V_415 )
{
...
if ( V_422 != F_279 ( sizeof( struct V_343 ) ) )
return - V_59 ;
V_421 -> V_427 = & V_428 ;
V_421 -> V_417 = V_4 ;
...
static int F_280 ( struct V_414 * V_415 )
{
struct V_3 * V_4 = V_415 -> V_416 -> V_417 ;
struct V_14 * V_15 ;
if ( V_4 == NULL )
...
return - V_59 ;
V_422 = V_421 -> V_425 - V_421 -> V_426 ;
if ( V_422 != F_279 ( sizeof( struct V_344 ) ) )
return - V_59 ;
V_421 -> V_427 = & V_431 ;
V_421 -> V_417 = V_4 ;
V_421 -> V_423 |= V_429 | V_430 ;
...
static bool F_281 ( struct V_274 * V_275 )
{
if ( V_275 -> V_432 )
return false ;
if ( V_275 -> V_368 < F_86 ( 2 , 0 , 14 ) &&
( V_275 -> V_4 -> V_15 -> V_38 . V_13 & V_433 ) )
return false ;
return true ;
}
static bool F_282 ( struct V_274 * V_275 )
{
if ( V_275 -> V_432 )
return false ;
...
F_283 ( struct V_3 * V_4 , unsigned long V_434 )
{
...
int F_285 ( struct V_3 * V_4 ,
struct V_420 * V_421 )
{
V_421 -> V_423 |= V_429 | V_430 ;
#ifdef F_286
if ( V_4 -> V_44 . V_45 . type == V_440 ) {
V_421 -> V_441 = F_287 ( V_421 -> V_441 ) ;
return F_288 ( V_421 , V_421 -> V_426 ,
...
V_4 -> V_44 . V_45 . type == V_46 )
return F_290 ( V_4 -> V_44 . V_45 . V_45 ,
V_421 ,
V_4 -> V_15 -> V_436 ,
V_4 -> V_15 -> V_443 ,
...
int F_291 ( struct V_3 * V_4 ,
struct V_420 * V_421 )
{
struct V_14 * V_15 = V_4 -> V_15 ; ;
V_421 -> V_441 = F_292 ( V_421 -> V_441 ) ;
return F_293 ( V_421 , V_15 -> V_443 , V_15 -> V_323 ) ;
}
int F_294 ( struct V_3 * V_4 , struct V_246 * V_246 ,
struct V_420 * V_421 )
{
struct V_14 * V_15 ;
long V_422 ;
...
V_34 = F_285 ( V_4 , V_421 ) ;
if ( ! V_34 )
F_295 ( & V_4 -> V_121 ) ;
return V_34 ;
}
static int F_296 ( struct V_246 * V_246 , struct V_420 * V_421 )
{
struct V_274 * V_275 ;
struct V_3 * V_4 ;
unsigned long V_398 ;
...
default:
return F_294 ( V_4 , V_246 , V_421 ) ;
}
return 0 ;
}
static int F_297 ( int V_273 , struct V_246 * V_246 , int V_450 )
{
struct V_274 * V_275 ;
struct V_3 * V_4 ;
struct V_14 * V_15 ;
...
return - V_114 ;
V_15 = V_4 -> V_15 ;
return F_298 ( V_273 , V_246 , V_450 , & V_15 -> V_451 ) ;
}
...
for ( V_63 = 0 ; V_63 < F_300 ( V_453 -> V_454 ) ; V_63 ++ )
V_48 -> V_454 [ V_63 ] . V_112 [ 0 ] = V_453 -> V_454 [ V_63 ] ;
memcpy ( V_48 -> V_455 , V_453 -> V_455 , sizeof( V_453 -> V_455 ) ) ;
V_48 -> V_60 = F_301 ( V_453 -> V_60 ) ;
V_48 -> V_61 = F_301 ( V_453 -> V_61 ) ;
...
static void F_302 ( struct V_452 * V_453 ,
struct V_47 * V_48 )
{
unsigned int V_63 ;
...
V_453 -> V_60 = F_303 ( V_48 -> V_60 ) ;
V_453 -> V_61 = F_303 ( V_48 -> V_61 ) ;
...
static int F_260 ( struct V_3 * V_4 ,
...
static unsigned long F_304 ( struct V_246 * V_246 ,
unsigned long V_442 ,
unsigned long V_459 ,
unsigned long V_437 ,
unsigned long V_12 )
