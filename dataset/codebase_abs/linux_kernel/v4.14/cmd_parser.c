...
V_173 == V_174 )
return 0 ;
if ( ! F_72 ( V_23 . V_27 , V_23 . V_29 , V_23 . V_30 ) ) {
V_48 = - V_50 ;
goto V_184;
}
...
static int F_121 ( struct V_180 * V_72 )
{
...
V_193 = F_122 ( V_72 -> V_194 , V_72 -> V_178 / sizeof( T_1 ) ) ;
if ( F_100 ( V_193 ) )
return F_101 ( V_193 ) ;
V_72 -> V_182 = V_193 ;
if ( V_173 > V_174 ) {
...
V_193 += V_48 / sizeof( T_1 ) ;
F_123 ( V_72 -> V_194 , V_193 ) ;
return 0 ;
}
int F_124 ( struct V_180 * V_72 )
{
int V_48 ;
struct V_51 * V_27 = V_72 -> V_27 ;
V_48 = F_121 ( V_72 ) ;
...
static int F_125 ( struct V_185 * V_186 )
{
...
static struct V_8 * F_128 ( struct V_9 * V_10 ,
unsigned int V_11 , int V_15 )
{
struct V_8 * V_14 = NULL ;
unsigned int V_203 ;
F_129 (ring, (unsigned long *)&rings, I915_NUM_ENGINES) {
V_14 = F_3 ( V_10 , V_11 , V_203 ) ;
if ( V_14 )
break;
}
return V_14 ;
...
if ( ! ( V_8 [ V_18 ] . V_205 & V_204 ) )
continue;
V_13 = F_132 ( sizeof( * V_13 ) , V_157 ) ;
if ( ! V_13 )
return - V_158 ;
V_13 -> V_14 = & V_8 [ V_18 ] ;
V_14 = F_128 ( V_10 ,
...
V_13 -> V_14 -> V_205 , V_13 -> V_14 -> V_15 ) ;
}
return 0 ;
}
...
struct V_12 * V_13 ;
int V_18 ;
F_135 (gvt->cmd_table, i, tmp, e, hlist)
F_108 ( V_13 ) ;
F_136 ( V_10 -> V_169 ) ;
}
