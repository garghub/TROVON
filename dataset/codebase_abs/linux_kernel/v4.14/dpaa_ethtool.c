...
static int F_29 ( struct V_1 * V_16 ,
struct V_102 * V_4 )
{
struct V_18 * V_25 = F_12 ( V_16 ) ;
V_4 -> V_55 = 0 ;
switch ( V_4 -> V_103 ) {
case V_104 :
case V_105 :
...
static int F_30 ( struct V_1 * V_16 , struct V_102 * V_4 ,
T_1 * V_123 )
{
int V_124 = - V_49 ;
switch ( V_4 -> V_4 ) {
...
static void F_31 ( struct V_1 * V_2 , bool V_126 )
{
struct V_23 * V_24 ;
struct V_127 * V_128 ;
struct V_18 * V_25 ;
...
static int F_33 ( struct V_1 * V_16 ,
struct V_102 * V_130 )
{
int V_124 = - V_37 ;
if ( V_130 -> V_55 &
~ ( V_121 | V_122 | V_109 | V_110 ) )
return - V_37 ;
switch ( V_130 -> V_103 ) {
case V_104 :
case V_105 :
...
static int F_34 ( struct V_1 * V_16 , struct V_102 * V_4 )
{
int V_124 = - V_49 ;
switch ( V_4 -> V_4 ) {
case V_131 :
