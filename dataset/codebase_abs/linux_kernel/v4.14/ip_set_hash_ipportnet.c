...
static inline bool
F_41 ( const struct V_74 * V_2 ,
const struct V_74 * V_3 ,
T_1 * V_4 )
{
return F_42 ( & V_2 -> V_5 . V_75 , & V_3 -> V_5 . V_75 ) &&
F_42 ( & V_2 -> V_3 . V_75 , & V_3 -> V_3 . V_75 ) &&
V_2 -> V_6 == V_3 -> V_6 &&
V_2 -> V_7 == V_3 -> V_7 &&
V_2 -> V_8 == V_3 -> V_8 ;
}
static inline int
F_43 ( const struct V_74 * V_9 )
{
return V_9 -> V_10 ? - V_11 : 1 ;
}
static inline void
F_44 ( struct V_74 * V_9 , T_1 V_12 )
{
V_9 -> V_10 = ! ! ( ( V_12 >> 16 ) & V_13 ) ;
}
static inline void
F_45 ( struct V_74 * V_9 , T_2 * V_12 )
{
F_5 ( * V_12 , V_9 -> V_10 ) ;
}
static inline void
F_46 ( struct V_74 * V_9 , T_2 V_6 )
{
F_47 ( & V_9 -> V_3 , V_6 ) ;
V_9 -> V_6 = V_6 - 1 ;
}
...
{
T_1 V_12 = V_16 -> V_10 ? V_13 : 0 ;
if ( F_49 ( V_15 , V_17 , & V_16 -> V_5 . V_75 ) ||
F_49 ( V_15 , V_18 , & V_16 -> V_3 . V_75 ) ||
F_10 ( V_15 , V_19 , V_16 -> V_7 ) ||
F_11 ( V_15 , V_20 , V_16 -> V_6 + 1 ) ||
F_11 ( V_15 , V_21 , V_16 -> V_8 ) ||
( V_12 &&
...
static inline void
F_50 ( struct V_74 * V_24 ,
const struct V_74 * V_25 )
{
V_24 -> V_7 = V_25 -> V_7 ;
}
static int
F_51 ( struct V_26 * V_27 , const struct V_14 * V_15 ,
const struct V_28 * V_29 ,
enum V_30 V_31 , struct V_32 * V_33 )
{
...
if ( V_31 == V_43 )
V_38 . V_6 = V_40 - 1 ;
if ( ! F_52 ( V_15 , V_33 -> V_12 & V_44 ,
& V_38 . V_7 , & V_38 . V_8 ) )
return - V_45 ;
F_53 ( V_15 , V_33 -> V_12 & V_46 , & V_38 . V_5 . V_75 ) ;
F_53 ( V_15 , V_33 -> V_12 & V_47 , & V_38 . V_3 . V_75 ) ;
F_47 ( & V_38 . V_3 , V_38 . V_6 + 1 ) ;
return V_36 ( V_27 , & V_38 , & V_42 , & V_33 -> V_42 , V_33 -> V_48 ) ;
}
static int
F_54 ( struct V_26 * V_27 , struct V_49 * V_50 [] ,
enum V_30 V_31 , T_1 * V_51 , T_1 V_12 , bool V_52 )
{
const struct V_76 * V_35 = V_27 -> V_16 ;
T_3 V_36 = V_27 -> V_37 -> V_31 [ V_31 ] ;
...
V_60 = F_55 ( V_50 [ V_17 ] , & V_38 . V_5 ) ;
if ( V_60 )
return V_60 ;
V_60 = F_27 ( V_27 , V_50 , & V_42 ) ;
if ( V_60 )
return V_60 ;
V_60 = F_55 ( V_50 [ V_18 ] , & V_38 . V_3 ) ;
if ( V_60 )
return V_60 ;
if ( V_50 [ V_20 ] ) {
V_6 = F_28 ( V_50 [ V_20 ] ) ;
