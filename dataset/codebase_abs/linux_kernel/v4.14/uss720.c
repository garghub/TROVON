...
static void F_77 ( struct V_73 * V_74 )
{
struct V_14 * V_15 = F_78 ( V_74 ) ;
struct V_2 * V_3 ;
struct V_26 * V_5 ;
F_3 ( & V_74 -> V_6 , L_16 ) ;
F_76 ( V_74 , NULL ) ;
...
if ( V_104 )
goto V_106;
F_36 (KERN_INFO KBUILD_MODNAME L_19 DRIVER_DESC L_20 ) ;
F_36 (KERN_INFO KBUILD_MODNAME L_21
L_22 ) ;
