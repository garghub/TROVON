...
V_96 . V_97 = V_86 -> V_98 ;
V_96 . V_99 = V_86 -> V_100 ;
V_96 . V_101 = V_86 -> V_102 ;
if ( ! V_86 -> V_103 ) {
...
V_84 = F_48 ( V_22 , V_104 ,
F_49 ( V_105 ) ) ;
if ( F_33 ( V_84 ) ) {
V_26 = F_34 ( V_84 ) ;
goto V_68;
}
V_106 . V_107 = V_84 [ 0 ] . V_108 ;
V_109 . V_107 = V_84 [ 1 ] . V_108 ;
V_96 . V_110 = V_84 [ 2 ] . V_108 ;
V_26 = F_50 ( V_82 , V_3 ) ;
if ( V_26 < 0 )
goto V_68;
V_17 -> V_56 = V_26 ;
...
V_113 . V_116 = V_26 ;
V_26 = - V_117 ;
V_31 = F_51 ( V_22 -> V_63 , & V_118 ) ;
if ( ! V_31 )
goto V_68;
V_17 -> V_4 . V_72 = V_31 ;
V_31 = F_51 ( V_22 -> V_63 , & V_119 ) ;
if ( ! V_31 )
goto V_68;
V_17 -> V_4 . V_74 = V_31 ;
V_31 = F_51 ( V_22 -> V_63 , & V_120 ) ;
if ( ! V_31 )
goto V_68;
V_17 -> V_28 = V_31 ;
V_26 = - V_92 ;
...
if ( ! V_17 -> V_20 )
goto V_68;
V_17 -> V_20 -> V_25 = F_53 ( V_121 , V_91 ) ;
if ( ! V_17 -> V_20 -> V_25 )
goto V_68;
V_17 -> V_20 -> V_37 = V_121 ;
V_17 -> V_20 -> V_32 = V_17 ;
V_17 -> V_20 -> V_58 = F_16 ;
V_122 . V_123 = V_118 . V_123 ;
V_124 . V_123 = V_119 . V_123 ;
V_125 . V_123 = V_120 . V_123 ;
V_126 . V_123 = V_118 . V_123 ;
V_127 . V_123 = V_119 . V_123 ;
V_128 . V_123 = V_120 . V_123 ;
V_26 = F_54 ( V_3 , V_129 , V_130 ,
V_131 , NULL ) ;
if ( V_26 )
goto V_68;
V_17 -> V_4 . V_132 = F_38 ;
V_17 -> V_4 . V_133 = F_41 ;
F_39 ( V_17 -> V_38 , V_80 , 0 ) ;
F_55 ( V_17 -> V_38 , V_17 -> V_134 ) ;
if ( V_17 -> V_135 && V_17 -> V_136 &&
F_56 ( V_17 -> V_38 , V_17 -> V_136 ,
V_17 -> V_135 ) ) {
V_26 = - V_77 ;
goto V_137;
}
...
void F_60 ( struct V_138 * V_3 , struct V_70 * V_71 )
{
struct V_85 * V_139 ;
V_139 = F_2 ( V_3 , struct V_85 , V_88 ) ;
if ( V_139 -> V_103 )
F_61 ( F_62 ( V_139 -> V_71 ) ) ;
else
F_63 ( V_139 -> V_71 ) ;
V_139 -> V_140 = V_139 -> V_103 = true ;
V_139 -> V_71 = V_71 ;
}
static inline struct V_85 * F_64 ( struct V_141 * V_142 )
{
return F_2 ( F_65 ( V_142 ) , struct V_85 ,
V_88 . V_143 ) ;
}
static void F_66 ( struct V_138 * V_3 )
{
struct V_85 * V_139 ;
V_139 = F_2 ( V_3 , struct V_85 , V_88 ) ;
if ( ! V_139 -> V_140 ) {
...
static struct V_138 * F_67 ( void )
{
struct V_85 * V_139 ;
struct V_145 * V_146 [ 1 ] ;
char * V_147 [ 1 ] ;
struct V_148 * V_144 ;
V_139 = F_45 ( sizeof( * V_139 ) , V_91 ) ;
if ( ! V_139 )
return F_68 ( - V_92 ) ;
V_139 -> V_95 . V_149 = V_139 -> V_150 ;
F_69 ( & V_139 -> V_151 ) ;
V_139 -> V_88 . V_152 = F_66 ;
V_139 -> V_71 = F_70 () ;
if ( F_33 ( V_139 -> V_71 ) ) {
struct V_70 * V_71 = V_139 -> V_71 ;
F_58 ( V_139 ) ;
return F_71 ( V_71 ) ;
}
F_72 ( & V_139 -> V_95 . V_153 ) ;
V_139 -> V_98 = V_96 . V_97 ;
V_139 -> V_100 = V_96 . V_99 ;
V_139 -> V_102 = V_96 . V_101 ;
V_146 [ 0 ] = & V_139 -> V_95 ;
V_147 [ 0 ] = L_20 ;
F_73 ( & V_139 -> V_88 . V_143 , L_21 ,
& V_154 ) ;
V_144 =
F_74 ( & V_139 -> V_88 . V_143 , 1 , V_146 ,
V_147 , V_155 ) ;
if ( F_33 ( V_144 ) ) {
F_66 ( & V_139 -> V_88 ) ;
return F_71 ( V_144 ) ;
...
V_17 = F_1 ( V_3 ) ;
F_76 ( V_17 -> V_38 ) ;
V_139 = F_2 ( V_3 -> V_87 , struct V_85 , V_88 ) ;
F_58 ( V_17 ) ;
F_77 ( & V_139 -> V_151 ) ;
V_139 -> V_156 -- ;
F_78 ( & V_139 -> V_151 ) ;
...
static struct V_2 * F_80 ( struct V_138 * V_87 )
{
struct V_1 * V_17 ;
struct V_85 * V_139 ;
struct V_157 * V_38 ;
...
if ( ! V_17 )
return F_68 ( - V_92 ) ;
V_139 = F_2 ( V_87 , struct V_85 , V_88 ) ;
F_77 ( & V_139 -> V_151 ) ;
V_139 -> V_156 ++ ;
F_81 ( V_139 -> V_71 , V_17 -> V_134 ) ;
V_17 -> V_136 = V_139 -> V_158 ;
V_17 -> V_135 = V_139 -> V_135 ;
V_17 -> V_4 . V_159 = F_62 ( V_139 -> V_71 ) ;
F_78 ( & V_139 -> V_151 ) ;
V_17 -> V_4 . V_76 = 0 ;
V_17 -> V_4 . V_160 = sizeof( struct V_15 ) ;
V_17 -> V_4 . V_161 = F_6 ;
V_17 -> V_4 . V_162 = V_163 ;
V_17 -> V_4 . V_5 . V_35 = L_20 ;
V_17 -> V_4 . V_5 . V_164 = F_44 ;
V_17 -> V_4 . V_5 . V_165 = F_79 ;
V_17 -> V_4 . V_5 . V_166 = F_27 ;
V_17 -> V_4 . V_5 . V_167 = F_22 ;
V_17 -> V_4 . V_5 . V_168 = F_36 ;
V_17 -> V_4 . V_5 . V_169 = F_75 ;
V_38 = F_82 ( F_10 , V_17 ) ;
if ( F_33 ( V_38 ) ) {
F_58 ( V_17 ) ;
return F_71 ( V_38 ) ;
