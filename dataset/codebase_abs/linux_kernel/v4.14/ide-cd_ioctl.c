...
F_21 ( V_81 ) -> type = V_85 ;
V_81 -> V_86 = V_87 ;
F_22 ( V_4 -> V_82 , V_35 -> V_88 , V_81 , 0 ) ;
V_69 = F_23 ( V_81 ) -> V_89 ? - V_90 : 0 ;
F_24 ( V_81 ) ;
if ( V_4 -> V_7 & V_43 )
( void ) F_9 ( V_4 , 1 , & V_13 ) ;
return V_69 ;
}
static int F_25 ( T_1 * V_4 , int V_91 ,
struct V_92 * * V_93 )
{
struct V_34 * V_68 = V_4 -> V_36 ;
...
static int F_26 ( T_1 * V_4 , void * V_99 )
{
...
struct V_12 V_13 ;
unsigned char V_39 [ V_40 ] ;
V_14 = F_25 ( V_4 , V_101 -> V_106 , & V_102 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_25 ( V_4 , V_101 -> V_107 , & V_103 ) ;
if ( V_14 )
return V_14 ;
if ( V_101 -> V_107 != V_98 )
++ V_103 ;
...
memset ( V_39 , 0 , V_40 ) ;
V_39 [ 0 ] = V_108 ;
F_27 ( V_104 , & V_39 [ 3 ] , & V_39 [ 4 ] , & V_39 [ 5 ] ) ;
F_27 ( V_105 - 1 , & V_39 [ 6 ] , & V_39 [ 7 ] , & V_39 [ 8 ] ) ;
return F_8 ( V_4 , V_39 , 0 , NULL , NULL , & V_13 , 0 , 0 ) ;
}
static int F_28 ( T_1 * V_4 , void * V_99 )
{
struct V_34 * V_35 = V_4 -> V_36 ;
...
switch ( V_39 ) {
case V_128 :
return F_26 ( V_4 , V_99 ) ;
case V_129 :
return F_28 ( V_4 , V_99 ) ;
case V_130 :
