...
F_9 ( F_10 ( V_3 -> V_38 [ V_36 ] ) , & V_35 -> V_38 [ V_36 ] ) ;
F_11 ( F_10 ( V_3 -> V_6 ) , & V_35 -> V_6 ) ;
}
static inline enum V_1 F_12 ( struct V_2 T_2 *
V_35 ,
struct V_2 * V_39 )
{
int V_36 ;
enum V_1 V_7 ;
V_39 -> V_6 = F_13 ( F_14 ( & V_35 -> V_6 ) ) ;
V_7 = F_1 ( V_39 ) ;
if ( V_7 != V_10 )
return V_7 ;
for ( V_36 = 0 ; V_36 < V_37 ; V_36 ++ )
V_39 -> V_38 [ V_36 ] =
F_13 ( F_14 ( & V_35 -> V_38 [ V_36 ] ) ) ;
return V_7 ;
}
...
int F_24 ( struct V_40 * V_41 , struct V_2 * V_3 )
{
int error ;
enum V_1 V_7 ;
...
F_8 ( V_41 -> V_46 , V_3 ) ;
if ( ! ( V_41 -> V_53 & V_54 ) )
error = F_15 ( V_41 , V_3 , & V_7 ) ;
else
error = F_21 ( V_41 , V_3 , & V_7 ) ;
if ( error < 0 )
goto V_57;
if ( V_7 != V_10 ) {
F_19 ( V_41 -> V_49 ,
