...
static const char * F_141 ( struct V_5 * V_5 )
{
if ( F_35 ( V_268 , & V_5 -> V_269 ) )
return L_141 ;
if ( F_35 ( V_280 , & V_5 -> V_269 ) ||
( ! V_5 -> V_266 && F_35 ( V_281 , & V_5 -> V_269 ) ) ) {
if ( F_35 ( V_282 , & V_5 -> V_269 ) )
return L_142 ;
...
if ( F_35 ( V_286 , & V_5 -> V_269 ) )
return L_146 ;
}
return L_147 ;
}
static const char * F_142 ( struct V_1 * V_2 , struct V_54 * V_55 , bool V_287 )
{
if ( ! V_55 -> V_88 )
return L_9 ;
...
else if ( ! V_287 || ! F_35 ( V_85 , & V_55 -> V_59 ) )
return L_150 ;
else
return L_149 ;
}
static T_2 F_143 ( struct V_1 * V_2 ,
T_2 V_288 , bool * V_287 )
{
T_2 V_48 , V_289 ;
struct V_5 * V_5 = & V_2 -> V_6 ;
V_289 = V_5 -> V_289 ? : V_5 -> V_25 ;
* V_287 = false ;
if ( F_10 ( V_2 ) ) {
V_48 = V_288 ;
* V_287 = true ;
...
} else if ( F_35 ( V_280 , & V_5 -> V_269 ) )
V_48 = V_289 ;
else
V_48 = V_5 -> V_25 ;
if ( ( V_48 == V_28 ) ||
( F_35 ( V_290 , & V_5 -> V_269 ) &&
( V_5 -> V_289 == V_288 ) ) ) {
* V_287 = true ;
V_48 = V_288 ;
} else if ( F_35 ( V_284 , & V_5 -> V_269 ) ) {
* V_287 = true ;
} else {
struct V_54 * V_55 ;
F_42 (rdev, mddev)
...
static const char * F_144 ( struct V_291 * V_69 )
{
return V_69 ? V_69 -> V_17 : L_9 ;
}
static void F_145 ( struct V_65 * V_37 , T_4 type ,
...
if ( ! V_30 )
return;
F_146 ( L_151 , V_30 -> V_17 , V_5 -> V_63 ) ;
F_87 () ;
V_288 = F_35 ( V_303 , & V_2 -> V_243 ) ?
V_5 -> V_288 : V_5 -> V_26 ;
V_299 = F_143 ( V_2 , V_288 , & V_287 ) ;
V_300 = ( V_5 -> V_304 && ! strcasecmp ( V_5 -> V_304 , L_144 ) ) ?
F_147 ( & V_5 -> V_300 ) : 0 ;
V_301 = F_141 ( & V_2 -> V_6 ) ;
for ( V_67 = 0 ; V_67 < V_2 -> V_63 ; V_67 ++ )
F_146 ( F_142 ( V_2 , & V_2 -> V_69 [ V_67 ] . V_55 , V_287 ) ) ;
F_146 ( L_152 , ( unsigned long long ) V_299 ,
( unsigned long long ) V_288 ) ;
F_146 ( L_153 , V_301 ) ;
F_146 ( L_154 , ( unsigned long long ) V_300 ) ;
F_146 ( L_154 , ( unsigned long long ) V_2 -> V_69 [ 0 ] . V_55 . V_82 ) ;
F_146 ( L_153 , F_35 ( V_122 , & V_2 -> V_36 ) ?
F_142 ( V_2 , & V_2 -> V_73 . V_55 , 0 ) : L_9 ) ;
break;
case V_305 :
for ( V_67 = 0 ; V_67 < V_2 -> V_63 ; V_67 ++ )
if ( F_35 ( V_134 , & V_2 -> V_69 [ V_67 ] . V_55 . V_59 ) )
V_298 += 2 ;
V_130 = F_148 ( V_2 -> V_130 , V_205 * sizeof( * V_2 -> V_130 ) ) ;
V_296 += V_130 * 2 +
V_298 +
F_5 ( V_2 -> V_36 & V_306 ) +
...
F_146 ( L_155 , V_2 -> V_29 -> V_17 , V_296 , V_5 -> V_9 ) ;
if ( F_35 ( V_116 , & V_2 -> V_36 ) )
F_146 ( L_153 , F_4 ( V_115 ) ) ;
if ( F_35 ( V_114 , & V_2 -> V_36 ) )
F_146 ( L_153 , F_4 ( V_113 ) ) ;
if ( V_130 )
for ( V_67 = 0 ; V_67 < V_2 -> V_63 ; V_67 ++ )
if ( F_35 ( V_2 -> V_69 [ V_67 ] . V_55 . V_81 , ( void * ) V_2 -> V_130 ) )
F_146 ( L_156 , F_4 ( V_129 ) ,
V_2 -> V_69 [ V_67 ] . V_55 . V_81 ) ;
if ( F_35 ( V_141 , & V_2 -> V_36 ) )
F_146 ( L_157 , F_4 ( V_140 ) ,
V_5 -> V_97 . V_143 ) ;
if ( F_35 ( V_155 , & V_2 -> V_36 ) )
F_146 ( L_158 , F_4 ( V_154 ) ,
V_5 -> V_157 ) ;
if ( F_35 ( V_159 , & V_2 -> V_36 ) )
F_146 ( L_158 , F_4 ( V_158 ) ,
V_5 -> V_160 ) ;
if ( V_298 )
for ( V_67 = 0 ; V_67 < V_2 -> V_63 ; V_67 ++ )
if ( F_35 ( V_134 , & V_2 -> V_69 [ V_67 ] . V_55 . V_59 ) )
F_146 ( L_158 , F_4 ( V_133 ) ,
V_2 -> V_69 [ V_67 ] . V_55 . V_81 ) ;
if ( F_35 ( V_137 , & V_2 -> V_36 ) )
F_146 ( L_157 , F_4 ( V_136 ) ,
V_5 -> V_97 . V_139 ) ;
if ( F_35 ( V_153 , & V_2 -> V_36 ) )
F_146 ( L_158 , F_4 ( V_152 ) ,
V_295 ) ;
if ( F_35 ( V_162 , & V_2 -> V_36 ) )
F_146 ( L_159 , F_4 ( V_161 ) ,
( unsigned long long ) F_72 ( V_5 -> V_97 . V_98 ) ) ;
if ( F_35 ( V_165 , & V_2 -> V_36 ) )
F_146 ( L_158 , F_4 ( V_164 ) ,
F_33 ( V_5 -> V_38 ) ) ;
if ( F_35 ( V_119 , & V_2 -> V_36 ) )
F_146 ( L_160 , F_4 ( V_118 ) ,
F_31 ( V_5 -> V_38 ) ) ;
if ( F_35 ( V_149 , & V_2 -> V_36 ) )
F_146 ( L_158 , F_4 ( V_148 ) ,
V_12 ( V_2 -> V_64 , V_5 -> V_64 ) ) ;
if ( F_35 ( V_145 , & V_2 -> V_36 ) )
F_146 ( L_159 , F_4 ( V_144 ) ,
( unsigned long long ) V_2 -> V_82 ) ;
if ( F_35 ( V_122 , & V_2 -> V_36 ) )
F_146 ( L_160 , F_4 ( V_120 ) ,
F_144 ( V_2 -> V_73 . V_69 ) ) ;
if ( F_35 ( V_128 , & V_2 -> V_36 ) )
F_146 ( L_160 , F_4 ( V_127 ) ,
F_9 ( V_2 -> V_73 . V_19 ) ) ;
F_146 ( L_161 , V_2 -> V_63 ) ;
for ( V_67 = 0 ; V_67 < V_2 -> V_63 ; V_67 ++ )
F_146 ( L_160 , F_144 ( V_2 -> V_69 [ V_67 ] . V_74 ) ,
F_144 ( V_2 -> V_69 [ V_67 ] . V_75 ) ) ;
}
}
static int F_149 ( struct V_65 * V_37 , unsigned int V_255 , char * * V_256 )
{
struct V_1 * V_2 = V_37 -> V_170 ;
struct V_5 * V_5 = & V_2 -> V_6 ;
...
F_70 ( V_281 , & V_5 -> V_269 ) ;
if ( ! V_5 -> V_312 && V_5 -> V_313 )
F_151 ( V_5 -> V_313 ) ;
return 0 ;
}
static int F_152 ( struct V_65 * V_37 ,
...
static void F_153 ( struct V_65 * V_37 , struct V_316 * V_317 )
{
struct V_1 * V_2 = V_37 -> V_170 ;
unsigned int V_318 = F_66 ( V_2 -> V_6 . V_62 ) ;
F_154 ( V_317 , V_318 ) ;
F_155 ( V_317 , V_318 * F_78 ( V_2 ) ) ;
}
static void F_156 ( struct V_65 * V_37 )
{
struct V_1 * V_2 = V_37 -> V_170 ;
F_157 ( & V_2 -> V_6 ) ;
}
static void F_158 ( struct V_65 * V_37 )
{
struct V_1 * V_2 = V_37 -> V_170 ;
...
static int F_166 ( struct V_65 * V_37 )
{
int V_48 ;
struct V_1 * V_2 = V_37 -> V_170 ;
struct V_5 * V_5 = & V_2 -> V_6 ;
...
static void F_169 ( struct V_65 * V_37 )
{
struct V_1 * V_2 = V_37 -> V_170 ;
struct V_5 * V_5 = & V_2 -> V_6 ;
