...
int F_62 ( struct V_9 * V_65 )
{
return F_51 ( F_14 ( V_65 ) ) ;
}
static void
F_63 ( struct V_3 * V_4 , struct V_9 * V_65 , struct V_7 * V_85 )
{
...
static struct V_9 *
F_68 ( struct V_3 * V_4 , int V_5 )
{
struct V_9 * V_65 ;
struct V_7 * V_86 ;
V_65 = F_69 ( sizeof( struct V_9 ) + F_70 () ,
V_55 , F_71 ( V_5 ) ) ;
if ( ! V_65 )
return NULL ;
V_86 = F_9 ( V_65 ) ;
if ( V_4 -> V_24 )
F_72 ( V_86 , F_7 ( V_4 -> V_24 ) ) ;
else
F_72 ( V_86 , F_7 ( V_4 ) ) ;
F_30 ( & V_65 -> V_69 ) ;
return V_65 ;
...
int V_5 ;
F_63 ( V_4 , V_65 , V_85 ) ;
V_5 = F_74 ( F_9 ( V_65 ) , V_85 ) ;
V_65 -> V_20 = * F_65 ( V_88 -> V_20 , V_5 ) ;
if ( F_75 ( & V_65 -> V_20 -> V_69 ) == 1 )
F_72 ( F_14 ( V_65 ) , V_85 ) ;
else
F_66 ( ! F_13 ( F_14 ( V_65 ) , V_85 ) ) ;
V_86 = F_9 ( V_65 ) ;
V_65 -> V_20 -> V_22 = V_23 * F_10 ( V_86 ) ;
V_65 -> V_20 -> V_93 = V_23 ;
}
static int
F_76 ( struct V_3 * V_4 , int V_5 )
{
...
static struct V_9 * F_78 ( int V_5 , struct V_87 * V_88 )
{
struct V_3 * V_4 = * F_65 ( V_88 -> V_4 , V_5 ) ;
struct V_3 * V_24 = V_4 -> V_24 ;
struct V_9 * V_65 ;
if ( V_24 )
V_5 = F_51 ( F_7 ( V_24 ) ) ;
V_65 = * F_65 ( V_88 -> V_65 , V_5 ) ;
V_65 -> V_20 = * F_65 ( V_88 -> V_20 , V_5 ) ;
F_30 ( & V_65 -> V_69 ) ;
F_30 ( & V_65 -> V_20 -> V_69 ) ;
if ( V_24 ) {
F_72 ( F_9 ( V_65 ) , F_7 ( V_24 ) ) ;
F_72 ( F_14 ( V_65 ) , F_9 ( V_65 ) ) ;
} else {
F_31 ( V_5 , F_9 ( V_65 ) ) ;
F_31 ( V_5 , F_14 ( V_65 ) ) ;
}
...
static void F_81 ( int V_5 , struct V_3 * V_4 )
{
...
if ( ! ( V_4 -> V_13 & V_80 ) )
goto V_25;
F_64 (cpu, sched_group_span(sg)) {
if ( V_98 < 0 )
V_98 = V_5 ;
else if ( F_83 ( V_5 , V_98 ) )
V_98 = V_5 ;
}
V_65 -> V_100 = V_98 ;
V_25:
...
static void F_89 ( struct V_107 * V_108 , enum V_109 V_110 ,
const struct V_7 * V_111 )
{
switch ( V_110 ) {
case V_112 :
if ( ! F_90 ( & V_108 -> V_43 -> V_53 ) )
...
static enum V_109
F_93 ( struct V_107 * V_108 , const struct V_7 * V_111 )
{
memset ( V_108 , 0 , sizeof( * V_108 ) ) ;
if ( F_94 ( V_111 ) )
return V_114 ;
V_108 -> V_4 = F_95 ( struct V_3 * ) ;
if ( ! V_108 -> V_4 )
return V_114 ;
V_108 -> V_43 = F_42 () ;
if ( ! V_108 -> V_43 )
...
static void F_96 ( int V_5 , struct V_3 * V_4 )
{
struct V_87 * V_88 = V_4 -> V_89 ;
F_66 ( * F_65 ( V_88 -> V_4 , V_5 ) != V_4 ) ;
* F_65 ( V_88 -> V_4 , V_5 ) = NULL ;
if ( F_90 ( & ( * F_65 ( V_88 -> V_72 , V_5 ) ) -> V_69 ) )
* F_65 ( V_88 -> V_72 , V_5 ) = NULL ;
if ( F_90 ( & ( * F_65 ( V_88 -> V_65 , V_5 ) ) -> V_69 ) )
* F_65 ( V_88 -> V_65 , V_5 ) = NULL ;
if ( F_90 ( & ( * F_65 ( V_88 -> V_20 , V_5 ) ) -> V_69 ) )
* F_65 ( V_88 -> V_20 , V_5 ) = NULL ;
}
static struct V_3 *
F_97 ( struct V_116 * V_117 ,
const struct V_7 * V_111 ,
...
F_101 ( F_7 ( V_4 ) , V_111 , V_117 -> V_85 ( V_5 ) ) ;
V_119 = F_51 ( F_7 ( V_4 ) ) ;
if ( V_4 -> V_13 & V_31 ) {
...
static const struct V_7 * F_104 ( int V_5 )
{
return V_147 [ V_122 ] [ F_71 ( V_5 ) ] ;
}
static void F_105 ( const char * V_1 )
{
...
F_5 ( V_17 L_32 , F_106 ( V_91 , V_149 ) ) ;
F_5 ( V_17 L_12 ) ;
}
F_5 ( V_150 L_12 ) ;
}
bool F_107 ( int V_151 )
{
int V_91 ;
if ( V_151 == F_106 ( 0 , 0 ) )
return true ;
...
F_109 (a) {
F_109 (b) {
if ( F_106 ( V_153 , V_154 ) < V_156 )
continue;
F_109 (c) {
if ( F_106 ( V_153 , V_155 ) < V_156 &&
F_106 ( V_154 , V_155 ) < V_156 ) {
V_158 =
V_160 ;
return;
}
...
void F_110 ( void )
{
int V_162 , V_163 = F_106 ( 0 , 0 ) ;
struct V_116 * V_117 ;
int V_6 = 0 ;
int V_91 , V_149 , V_164 ;
V_142 = F_43 ( sizeof( int ) * V_38 , V_55 ) ;
if ( ! V_142 )
return;
V_162 = V_163 ;
for ( V_91 = 0 ; V_91 < V_38 ; V_91 ++ ) {
...
int V_151 = F_106 ( V_91 , V_164 ) ;
if ( V_151 > V_163 &&
( V_151 < V_162 ||
V_162 == V_163 ) )
V_162 = V_151 ;
if ( F_2 () && F_106 ( V_164 , V_91 ) != V_151 )
F_105 ( L_33 ) ;
if ( F_2 () && V_91 && ! F_107 ( V_151 ) )
F_105 ( L_34 ) ;
}
if ( V_162 != V_163 ) {
V_142 [ V_6 ++ ] = V_162 ;
...
return;
V_152 = 0 ;
V_147 = F_43 ( sizeof( void * ) * V_6 , V_55 ) ;
if ( ! V_147 )
return;
for ( V_91 = 0 ; V_91 < V_6 ; V_91 ++ ) {
V_147 [ V_91 ] =
F_43 ( V_38 * sizeof( void * ) , V_55 ) ;
if ( ! V_147 [ V_91 ] )
return;
for ( V_149 = 0 ; V_149 < V_38 ; V_149 ++ ) {
struct V_7 * V_85 = F_43 ( F_70 () , V_55 ) ;
if ( ! V_85 )
return;
V_147 [ V_91 ] [ V_149 ] = V_85 ;
F_111 (k) {
if ( F_106 ( V_149 , V_164 ) > V_142 [ V_91 ] )
continue;
...
for ( V_91 = 0 ; V_91 < V_152 ; V_91 ++ ) {
for ( V_149 = 0 ; V_149 < V_38 ; V_149 ++ ) {
if ( F_106 ( V_149 , V_167 ) <= V_142 [ V_91 ] )
...
static int F_94 ( const struct V_7 * V_111 )
{
struct V_116 * V_117 ;
int V_149 ;
F_116 (tl) {
struct V_87 * V_88 = & V_117 -> V_118 ;
V_88 -> V_4 = F_95 ( struct V_3 * ) ;
if ( ! V_88 -> V_4 )
return - V_63 ;
V_88 -> V_72 = F_95 ( struct V_71 * ) ;
if ( ! V_88 -> V_72 )
return - V_63 ;
V_88 -> V_65 = F_95 ( struct V_9 * ) ;
if ( ! V_88 -> V_65 )
return - V_63 ;
V_88 -> V_20 = F_95 ( struct V_168 * ) ;
if ( ! V_88 -> V_20 )
return - V_63 ;
F_64 (j, cpu_map) {
struct V_3 * V_4 ;
...
struct V_9 * V_65 ;
struct V_168 * V_20 ;
V_4 = F_69 ( sizeof( struct V_3 ) + F_70 () ,
V_55 , F_71 ( V_149 ) ) ;
if ( ! V_4 )
return - V_63 ;
* F_65 ( V_88 -> V_4 , V_149 ) = V_4 ;
V_72 = F_69 ( sizeof( struct V_71 ) ,
V_55 , F_71 ( V_149 ) ) ;
if ( ! V_72 )
return - V_63 ;
* F_65 ( V_88 -> V_72 , V_149 ) = V_72 ;
V_65 = F_69 ( sizeof( struct V_9 ) + F_70 () ,
V_55 , F_71 ( V_149 ) ) ;
if ( ! V_65 )
return - V_63 ;
V_65 -> V_25 = V_65 ;
* F_65 ( V_88 -> V_65 , V_149 ) = V_65 ;
V_20 = F_69 ( sizeof( struct V_168 ) + F_70 () ,
V_55 , F_71 ( V_149 ) ) ;
if ( ! V_20 )
return - V_63 ;
#ifdef F_100
V_20 -> V_21 = V_149 ;
#endif
* F_65 ( V_88 -> V_20 , V_149 ) = V_20 ;
}
}
return 0 ;
}
static void F_92 ( const struct V_7 * V_111 )
{
struct V_116 * V_117 ;
int V_149 ;
F_116 (tl) {
...
struct V_3 * V_4 ;
if ( V_88 -> V_4 ) {
V_4 = * F_65 ( V_88 -> V_4 , V_149 ) ;
if ( V_4 && ( V_4 -> V_13 & V_19 ) )
F_44 ( V_4 -> V_11 , 0 ) ;
F_24 ( * F_65 ( V_88 -> V_4 , V_149 ) ) ;
}
if ( V_88 -> V_72 )
F_24 ( * F_65 ( V_88 -> V_72 , V_149 ) ) ;
if ( V_88 -> V_65 )
F_24 ( * F_65 ( V_88 -> V_65 , V_149 ) ) ;
if ( V_88 -> V_20 )
F_24 ( * F_65 ( V_88 -> V_20 , V_149 ) ) ;
}
F_91 ( V_88 -> V_4 ) ;
V_88 -> V_4 = NULL ;
F_91 ( V_88 -> V_72 ) ;
...
static struct V_3 * F_117 ( struct V_116 * V_117 ,
const struct V_7 * V_111 , struct V_102 * V_103 ,
struct V_3 * V_24 , int V_5 )
{
struct V_3 * V_4 = F_97 ( V_117 , V_111 , V_24 , V_5 ) ;
if ( V_24 ) {
V_4 -> V_6 = V_24 -> V_6 + 1 ;
...
F_64 (i, cpu_map) {
for ( V_4 = * F_65 ( V_108 . V_4 , V_91 ) ; V_4 ; V_4 = V_4 -> V_15 ) {
...
int V_91 ;
T_2 * V_176 ;
V_176 = F_127 ( sizeof( * V_176 ) * V_175 , V_55 ) ;
if ( ! V_176 )
return NULL ;
for ( V_91 = 0 ; V_91 < V_175 ; V_91 ++ ) {
if ( ! F_128 ( & V_176 [ V_91 ] , V_55 ) ) {
F_129 ( V_176 , V_91 ) ;
return NULL ;
}
}
...
void F_129 ( T_2 V_176 [] , unsigned int V_175 )
{
unsigned int V_91 ;
for ( V_91 = 0 ; V_91 < V_175 ; V_91 ++ )
F_23 ( V_176 [ V_91 ] ) ;
...
int F_130 ( const struct V_7 * V_111 )
{
int V_177 ;
F_36 ( & V_26 , V_55 ) ;
F_36 ( & V_92 , V_55 ) ;
...
if ( ! V_180 )
V_180 = & V_178 ;
F_131 ( V_180 [ 0 ] , V_111 , V_83 ) ;
V_177 = F_119 ( V_180 [ 0 ] , NULL ) ;
F_132 () ;
return V_177 ;
}
static void F_133 ( const struct V_7 * V_111 )
{
int V_91 ;
F_120 () ;
F_64 (i, cpu_map)
...
static int F_134 ( struct V_102 * V_181 , int V_182 ,
...
void F_135 ( int V_186 , T_2 V_187 [] ,
struct V_102 * V_188 )
{
