...
static int F_5 ( unsigned long V_59 , unsigned long V_60 )
{
V_59 = F_6 ( V_59 ) ;
V_60 = F_6 ( V_60 ) ;
if ( V_60 <= V_59 )
return 0 ;
return F_7 ( V_59 , V_60 - V_59 ) ;
}
...
error = F_7 ( F_34 ( V_91 ) , V_91 . V_99 + V_91 . V_100 ) ;
if ( error )
return error ;
...
V_132:
error = F_5 ( V_4 -> V_23 -> V_118 , V_4 -> V_23 -> V_27 ) ;
if ( error )
return error ;
F_44 ( & V_141 ) ;
V_4 -> V_23 -> V_19 =
...
T_4 V_147 = 0 ;
V_92 = - V_101 ;
error = F_48 ( V_98 , & V_91 , sizeof( V_91 ) , & V_147 ) ;
...
#endif
V_92 = F_7 ( V_145 , V_91 . V_99 + V_91 . V_100 + V_91 . V_104 ) ;
if ( V_92 )
goto V_148;
...
if ( V_144 > V_146 ) {
V_92 = F_7 ( V_145 + V_146 , V_144 - V_146 ) ;
if ( V_92 )
goto V_148;
}
V_92 = 0 ;
