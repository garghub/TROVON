...
V_5 = V_2 -> V_72 = F_41 ( 2 , sizeof( struct V_4 ) , V_32 ) ;
if ( ! V_5 )
return - V_33 ;
switch ( V_2 -> V_63 . V_64 ) {
case V_65 :
...
if ( V_31 < 0 )
return V_31 ;
V_31 = F_46 ( V_30 -> V_60 , NULL ,
V_2 -> V_86 -> V_87 [ V_88 ] . V_89 ) ;
if ( V_31 < 0 )
return V_31 ;
break;
}
