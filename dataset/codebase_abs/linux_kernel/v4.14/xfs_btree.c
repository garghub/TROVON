...
{
if ( V_9 == 0 ) {
V_6 -> V_28 -> V_190 ( V_189 ,
F_45 ( V_6 , V_188 , V_8 ) ) ;
return V_189 ;
}
return F_46 ( V_6 , V_188 , V_8 ) ;
}
int
F_114 (
struct V_5 * V_6 ,
...
V_8 = NULL ;
V_188 = 0 ;
V_6 -> V_28 -> V_193 ( V_6 , & V_55 ) ;
V_184 = & V_55 ;
for ( V_9 = V_6 -> V_70 - 1 , V_191 = 1 ; V_9 >= 0 ; V_9 -- ) {
...
V_189 = F_113 ( V_6 , V_9 ,
V_188 , V_8 , & V_163 ) ;
V_191 = V_6 -> V_28 -> V_198 ( V_6 , V_189 ) ;
if ( V_191 < 0 )
V_195 = V_188 + 1 ;
else if ( V_191 > 0 )
V_194 = V_188 - 1 ;
...
} else if ( V_164 == V_196 && V_191 > 0 )
V_188 -- ;
V_6 -> V_81 [ 0 ] = V_188 ;
if ( V_188 == 0 || V_188 > F_110 ( V_8 ) )
* V_176 = 0 ;
else if ( V_164 != V_200 || V_191 == 0 )
* V_176 = 1 ;
else
* V_176 = 0 ;
F_96 ( V_6 , V_168 ) ;
...
V_6 -> V_28 -> V_190 ( V_163 , V_165 ) ;
if ( V_6 -> V_49 & V_201 ) {
V_6 -> V_28 -> V_204 ( & V_202 , V_165 ) ;
for ( V_93 = 2 ; V_93 <= F_110 ( V_8 ) ; V_93 ++ ) {
V_165 = F_45 ( V_6 , V_93 , V_8 ) ;
V_6 -> V_28 -> V_204 ( & V_203 , V_165 ) ;
if ( V_6 -> V_28 -> V_205 ( V_6 , & V_203 , & V_202 )
> 0 )
V_202 = V_203 ;
}
V_194 = F_115 ( V_6 , V_163 ) ;
memcpy ( V_194 , & V_202 , V_6 -> V_28 -> V_95 / 2 ) ;
}
}
STATIC void
F_117 (
...
V_6 -> V_28 -> V_95 / 2 ) ;
V_202 = F_47 ( V_6 , 1 , V_8 ) ;
for ( V_93 = 2 ; V_93 <= F_110 ( V_8 ) ; V_93 ++ ) {
V_203 = F_47 ( V_6 , V_93 , V_8 ) ;
if ( V_6 -> V_28 -> V_205 ( V_6 , V_203 , V_202 ) > 0 )
V_202 = V_203 ;
}
V_194 = F_115 ( V_6 , V_163 ) ;
memcpy ( V_194 , V_202 , V_6 -> V_28 -> V_95 / 2 ) ;
...
#endif
V_55 = V_6 -> V_81 [ V_9 ] ;
V_209 = F_46 ( V_6 , V_55 , V_8 ) ;
V_210 = F_47 ( V_6 , V_55 , V_8 ) ;
if ( ! V_207 &&
! ( V_6 -> V_28 -> V_205 ( V_6 , V_209 , V_208 ) != 0 ||
V_6 -> V_28 -> V_205 ( V_6 , V_210 , V_203 ) != 0 ) )
break;
F_89 ( V_6 , V_209 , V_208 , 1 ) ;
...
#endif
V_55 = V_6 -> V_81 [ V_9 ] ;
V_189 = F_46 ( V_6 , V_55 , V_8 ) ;
F_89 ( V_6 , V_189 , & V_163 , 1 ) ;
F_95 ( V_6 , V_11 , V_55 , V_55 ) ;
}
F_96 ( V_6 , V_168 ) ;
return 0 ;
...
#endif
V_55 = V_6 -> V_81 [ 0 ] ;
V_212 = F_45 ( V_6 , V_55 , V_8 ) ;
F_90 ( V_6 , V_212 , V_165 , 1 ) ;
F_102 ( V_6 , V_11 , V_55 , V_55 ) ;
if ( F_82 ( V_6 , V_8 , 0 ) ) {
V_6 -> V_28 -> V_213 ( V_6 , V_8 , V_165 ,
V_55 , V_214 ) ;
}
if ( F_119 ( V_6 , V_55 ) ) {
error = F_123 ( V_6 , 0 ) ;
...
int V_219 ;
union V_54 V_220 ;
union V_97 * V_221 = NULL ;
union V_54 * V_222 = NULL ;
union V_96 * V_223 = NULL ;
int error ;
int V_69 ;
F_96 ( V_6 , V_166 ) ;
F_108 ( V_6 , V_9 ) ;
...
V_9 == V_6 -> V_70 - 1 )
goto V_179;
V_125 = F_52 ( V_6 , V_9 , & V_217 ) ;
#ifdef F_109
error = F_17 ( V_6 , V_125 , V_9 , V_217 ) ;
if ( error )
goto V_177;
#endif
F_75 ( V_6 , V_125 , & V_220 , V_129 ) ;
if ( F_73 ( V_6 , & V_220 ) )
goto V_179;
if ( V_6 -> V_81 [ V_9 ] <= 1 )
goto V_179;
error = F_88 ( V_6 , & V_220 , 0 , & V_124 , & V_215 ) ;
if ( error )
goto V_177;
V_216 = F_110 ( V_124 ) ;
if ( V_216 == V_6 -> V_28 -> V_29 ( V_6 , V_9 ) )
goto V_179;
V_219 = F_110 ( V_125 ) ;
V_216 ++ ;
V_219 -- ;
...
union V_97 * V_226 ;
union V_54 * V_227 ;
V_226 = F_46 ( V_6 , V_216 , V_124 ) ;
V_221 = F_46 ( V_6 , 1 , V_125 ) ;
V_227 = F_48 ( V_6 , V_216 , V_124 ) ;
V_222 = F_48 ( V_6 , 1 , V_125 ) ;
#ifdef F_109
error = F_21 ( V_6 , V_222 , 0 , V_9 ) ;
if ( error )
goto V_177;
#endif
F_89 ( V_6 , V_226 , V_221 , 1 ) ;
F_91 ( V_6 , V_227 , V_222 , 1 ) ;
F_95 ( V_6 , V_215 , V_216 , V_216 ) ;
F_103 ( V_6 , V_215 , V_216 , V_216 ) ;
ASSERT ( V_6 -> V_28 -> V_228 ( V_6 ,
F_46 ( V_6 , V_216 - 1 , V_124 ) , V_226 ) ) ;
} else {
union V_96 * V_229 ;
V_229 = F_45 ( V_6 , V_216 , V_124 ) ;
V_223 = F_45 ( V_6 , 1 , V_125 ) ;
F_90 ( V_6 , V_229 , V_223 , 1 ) ;
F_102 ( V_6 , V_215 , V_216 , V_216 ) ;
ASSERT ( V_6 -> V_28 -> V_230 ( V_6 ,
F_45 ( V_6 , V_216 - 1 , V_124 ) , V_229 ) ) ;
}
F_129 ( V_124 , V_216 ) ;
F_104 ( V_6 , V_215 , V_231 ) ;
F_129 ( V_125 , V_219 ) ;
F_104 ( V_6 , V_217 , V_231 ) ;
F_128 ( V_6 , V_225 , V_219 - 1 ) ;
if ( V_9 > 0 ) {
#ifdef F_109
int V_69 ;
for ( V_69 = 0 ; V_69 < V_219 ; V_69 ++ ) {
error = F_21 ( V_6 , V_222 , V_69 + 1 , V_9 ) ;
if ( error )
goto V_177;
}
#endif
...
F_48 ( V_6 , 2 , V_125 ) ,
- 1 , V_219 ) ;
F_95 ( V_6 , V_217 , 1 , V_219 ) ;
F_103 ( V_6 , V_217 , 1 , V_219 ) ;
} else {
F_93 ( V_6 ,
F_45 ( V_6 , 2 , V_125 ) ,
- 1 , V_219 ) ;
F_102 ( V_6 , V_217 , 1 , V_219 ) ;
}
if ( V_6 -> V_49 & V_201 ) {
error = F_36 ( V_6 , & V_218 ) ;
if ( error )
goto V_177;
V_69 = F_59 ( V_218 , V_9 ) ;
F_130 ( V_218 -> V_16 , V_69 == 1 , V_177 ) ;
error = F_111 ( V_218 , V_9 , & V_69 ) ;
if ( error )
goto V_232;
error = F_123 ( V_218 , V_9 ) ;
if ( error )
goto V_232;
F_33 ( V_218 , V_233 ) ;
}
...
( V_9 == V_6 -> V_70 - 1 ) )
goto V_179;
V_124 = F_52 ( V_6 , V_9 , & V_215 ) ;
#ifdef F_109
error = F_17 ( V_6 , V_124 , V_9 , V_215 ) ;
if ( error )
goto V_177;
#endif
F_75 ( V_6 , V_124 , & V_235 , V_130 ) ;
if ( F_73 ( V_6 , & V_235 ) )
goto V_179;
V_216 = F_110 ( V_124 ) ;
if ( V_6 -> V_81 [ V_9 ] >= V_216 )
goto V_179;
error = F_88 ( V_6 , & V_235 , 0 , & V_125 , & V_217 ) ;
if ( error )
goto V_177;
V_219 = F_110 ( V_125 ) ;
if ( V_219 == V_6 -> V_28 -> V_29 ( V_6 , V_9 ) )
goto V_179;
F_32 ( V_6 , V_236 ) ;
F_128 ( V_6 , V_225 , V_219 ) ;
if ( V_9 > 0 ) {
union V_97 * V_226 ;
union V_54 * V_227 ;
union V_54 * V_222 ;
...
V_222 = F_48 ( V_6 , 1 , V_125 ) ;
#ifdef F_109
for ( V_69 = V_219 - 1 ; V_69 >= 0 ; V_69 -- ) {
error = F_21 ( V_6 , V_222 , V_69 , V_9 ) ;
if ( error )
goto V_177;
}
#endif
F_92 ( V_6 , V_221 , 1 , V_219 ) ;
F_94 ( V_6 , V_222 , 1 , V_219 ) ;
#ifdef F_109
error = F_21 ( V_6 , V_227 , 0 , V_9 ) ;
if ( error )
goto V_177;
#endif
F_89 ( V_6 , V_221 , V_226 , 1 ) ;
F_91 ( V_6 , V_222 , V_227 , 1 ) ;
F_95 ( V_6 , V_217 , 1 , V_219 + 1 ) ;
F_103 ( V_6 , V_217 , 1 , V_219 + 1 ) ;
ASSERT ( V_6 -> V_28 -> V_228 ( V_6 , V_221 ,
F_46 ( V_6 , 2 , V_125 ) ) ) ;
} else {
union V_96 * V_229 ;
union V_96 * V_223 ;
V_229 = F_45 ( V_6 , V_216 , V_124 ) ;
V_223 = F_45 ( V_6 , 1 , V_125 ) ;
F_93 ( V_6 , V_223 , 1 , V_219 ) ;
F_90 ( V_6 , V_223 , V_229 , 1 ) ;
F_102 ( V_6 , V_217 , 1 , V_219 + 1 ) ;
}
F_129 ( V_124 , -- V_216 ) ;
F_104 ( V_6 , V_215 , V_231 ) ;
F_129 ( V_125 , ++ V_219 ) ;
...
goto V_177;
#endif
F_83 ( V_6 , V_215 , & V_220 ) ;
error = V_6 -> V_28 -> V_243 ( V_6 , & V_220 , & V_235 , V_176 ) ;
if ( error )
goto V_177;
if ( * V_176 == 0 )
goto V_179;
F_32 ( V_6 , V_244 ) ;
error = F_87 ( V_6 , & V_235 , 0 , & V_125 , & V_217 ) ;
if ( error )
goto V_177;
F_81 ( V_6 , V_217 , F_49 ( V_124 ) , 0 ) ;
V_216 = F_110 ( V_124 ) ;
V_219 = V_216 / 2 ;
if ( ( V_216 & 1 ) && V_6 -> V_81 [ V_9 ] <= V_219 + 1 )
V_219 ++ ;
V_241 = ( V_216 - V_219 + 1 ) ;
F_128 ( V_6 , V_225 , V_219 ) ;
V_216 -= V_219 ;
F_129 ( V_124 , V_216 ) ;
F_129 ( V_125 , F_110 ( V_125 ) + V_219 ) ;
if ( V_9 > 0 ) {
union V_97 * V_226 ;
union V_54 * V_227 ;
union V_97 * V_221 ;
union V_54 * V_222 ;
V_226 = F_46 ( V_6 , V_241 , V_124 ) ;
V_227 = F_48 ( V_6 , V_241 , V_124 ) ;
V_221 = F_46 ( V_6 , 1 , V_125 ) ;
V_222 = F_48 ( V_6 , 1 , V_125 ) ;
#ifdef F_109
for ( V_69 = V_241 ; V_69 < V_219 ; V_69 ++ ) {
error = F_21 ( V_6 , V_227 , V_69 , V_9 ) ;
if ( error )
goto V_177;
}
#endif
F_89 ( V_6 , V_221 , V_226 , V_219 ) ;
F_91 ( V_6 , V_222 , V_227 , V_219 ) ;
F_95 ( V_6 , V_217 , 1 , V_219 ) ;
F_103 ( V_6 , V_217 , 1 , V_219 ) ;
...
union V_96 * V_229 ;
union V_96 * V_223 ;
V_229 = F_45 ( V_6 , V_241 , V_124 ) ;
V_223 = F_45 ( V_6 , 1 , V_125 ) ;
F_90 ( V_6 , V_223 , V_229 , V_219 ) ;
F_102 ( V_6 , V_217 , 1 , V_219 ) ;
F_116 ( V_6 , V_125 , V_163 ) ;
}
F_75 ( V_6 , V_124 , & V_238 , V_130 ) ;
F_76 ( V_6 , V_125 , & V_238 , V_130 ) ;
F_76 ( V_6 , V_125 , & V_220 , V_129 ) ;
F_76 ( V_6 , V_124 , & V_235 , V_130 ) ;
F_104 ( V_6 , V_217 , V_172 ) ;
F_104 ( V_6 , V_215 , V_231 | V_130 ) ;
if ( ! F_73 ( V_6 , & V_238 ) ) {
error = F_88 ( V_6 , & V_238 ,
0 , & V_240 , & V_239 ) ;
if ( error )
goto V_177;
F_76 ( V_6 , V_240 , & V_235 , V_129 ) ;
F_104 ( V_6 , V_239 , V_129 ) ;
}
if ( V_6 -> V_49 & V_201 ) {
error = F_123 ( V_6 , V_9 ) ;
if ( error )
...
if ( V_6 -> V_81 [ V_9 ] > V_216 + 1 ) {
F_72 ( V_6 , V_9 , V_217 ) ;
V_6 -> V_81 [ V_9 ] -= V_216 ;
}
if ( V_9 + 1 < V_6 -> V_70 ) {
error = F_36 ( V_6 , V_237 ) ;
if ( error )
goto V_177;
( * V_237 ) -> V_81 [ V_9 + 1 ] ++ ;
}
...
F_136 ( & V_248 , V_249 ) ;
args -> V_255 = F_132 ( args -> V_6 , args -> V_9 , args -> V_181 ,
args -> V_163 , args -> V_237 , args -> V_176 ) ;
F_137 ( args -> V_256 ) ;
F_138 ( & V_248 , V_249 ) ;
}
STATIC int
...
F_140 ( V_256 ) ;
if ( V_6 -> V_15 != V_72 )
return F_132 ( V_6 , V_9 , V_181 , V_163 , V_237 , V_176 ) ;
args . V_6 = V_6 ;
args . V_9 = V_9 ;
args . V_181 = V_181 ;
args . V_163 = V_163 ;
...
args . V_256 = & V_256 ;
args . V_251 = F_141 () ;
F_142 ( & args . V_246 , F_134 ) ;
F_143 ( V_257 , & args . V_246 ) ;
F_144 ( & V_256 ) ;
F_145 ( & args . V_246 ) ;
return args . V_255 ;
}
...
error = V_6 -> V_28 -> V_243 ( V_6 , V_184 , & V_263 , V_176 ) ;
if ( error )
goto V_177;
if ( * V_176 == 0 ) {
F_96 ( V_6 , V_168 ) ;
...
F_32 ( V_6 , V_244 ) ;
error = F_87 ( V_6 , & V_263 , 0 , & V_260 , & V_259 ) ;
if ( error )
goto V_177;
memcpy ( V_260 , V_8 , F_39 ( V_6 ) ) ;
if ( V_6 -> V_49 & V_86 ) {
if ( V_6 -> V_49 & V_50 )
V_260 -> V_18 . V_19 . V_22 = F_5 ( V_259 -> V_23 ) ;
else
V_260 -> V_18 . V_46 . V_22 = F_5 ( V_259 -> V_23 ) ;
}
F_147 ( & V_8 -> V_26 , 1 ) ;
F_129 ( V_8 , 1 ) ;
V_6 -> V_70 ++ ;
V_6 -> V_81 [ V_9 + 1 ] = 1 ;
V_189 = F_46 ( V_6 , 1 , V_8 ) ;
V_261 = F_46 ( V_6 , 1 , V_260 ) ;
F_89 ( V_6 , V_261 , V_189 , F_110 ( V_260 ) ) ;
V_262 = F_48 ( V_6 , 1 , V_260 ) ;
#ifdef F_109
for ( V_69 = 0 ; V_69 < F_7 ( V_260 -> V_27 ) ; V_69 ++ ) {
error = F_21 ( V_6 , V_184 , V_69 , V_9 ) ;
if ( error )
goto V_177;
}
#endif
F_91 ( V_6 , V_262 , V_184 , F_110 ( V_260 ) ) ;
#ifdef F_109
error = F_21 ( V_6 , & V_263 , 0 , V_9 ) ;
if ( error )
goto V_177;
#endif
F_91 ( V_6 , V_184 , & V_263 , 1 ) ;
F_148 ( V_6 -> V_43 . V_73 . V_100 ,
1 - F_110 ( V_260 ) ,
V_6 -> V_43 . V_73 . V_101 ) ;
F_72 ( V_6 , V_9 , V_259 ) ;
F_104 ( V_6 , V_259 , V_172 ) ;
F_95 ( V_6 , V_259 , 1 , F_7 ( V_260 -> V_27 ) ) ;
F_103 ( V_6 , V_259 , 1 , F_7 ( V_260 -> V_27 ) ) ;
* V_258 |=
V_265 | F_101 ( V_6 -> V_43 . V_73 . V_101 ) ;
* V_176 = 1 ;
F_96 ( V_6 , V_168 ) ;
return 0 ;
V_177:
...
F_96 ( V_6 , V_166 ) ;
F_32 ( V_6 , V_264 ) ;
V_6 -> V_28 -> V_193 ( V_6 , & V_235 ) ;
error = V_6 -> V_28 -> V_243 ( V_6 , & V_235 , & V_220 , V_176 ) ;
if ( error )
goto V_177;
if ( * V_176 == 0 )
goto V_179;
F_32 ( V_6 , V_244 ) ;
error = F_87 ( V_6 , & V_220 , 0 , & V_77 , & V_266 ) ;
if ( error )
goto V_177;
V_6 -> V_28 -> V_267 ( V_6 , & V_220 , 1 ) ;
...
F_81 ( V_6 , V_266 , V_6 -> V_70 , 2 ) ;
F_104 ( V_6 , V_266 , V_172 ) ;
ASSERT ( ! F_73 ( V_6 , & V_220 ) &&
! F_73 ( V_6 , & V_235 ) ) ;
if ( F_49 ( V_124 ) > 0 ) {
F_117 ( V_6 , V_124 ,
F_46 ( V_6 , 1 , V_77 ) ) ;
...
F_95 ( V_6 , V_266 , 1 , 2 ) ;
F_91 ( V_6 ,
F_48 ( V_6 , 1 , V_77 ) , & V_220 , 1 ) ;
F_91 ( V_6 ,
F_48 ( V_6 , 2 , V_77 ) , & V_235 , 1 ) ;
F_103 ( V_6 , V_266 , 1 , 2 ) ;
F_72 ( V_6 , V_6 -> V_70 , V_266 ) ;
V_6 -> V_81 [ V_6 -> V_70 ] = V_263 ;
V_6 -> V_70 ++ ;
F_96 ( V_6 , V_168 ) ;
* V_176 = 1 ;
return 0 ;
...
if ( ( V_6 -> V_49 & V_104 ) &&
V_9 == V_6 -> V_70 - 1 ) {
struct V_269 * V_100 = V_6 -> V_43 . V_73 . V_100 ;
if ( V_133 < V_6 -> V_28 -> V_270 ( V_6 , V_9 ) ) {
F_148 ( V_100 , 1 , V_6 -> V_43 . V_73 . V_101 ) ;
* V_176 = 1 ;
} else {
int V_258 = 0 ;
error = F_146 ( V_6 , & V_258 , V_176 ) ;
if ( error || * V_176 == 0 )
return error ;
F_100 ( V_6 -> V_68 , V_100 , V_258 ) ;
}
return 0 ;
}
...
return error ;
if ( * V_176 ) {
* V_268 = * V_56 = V_6 -> V_81 [ V_9 ] ;
return 0 ;
}
error = F_139 ( V_6 , V_9 , V_263 , V_163 , V_76 , V_176 ) ;
if ( error || * V_176 == 0 )
return error ;
* V_56 = V_6 -> V_81 [ V_9 ] ;
return 0 ;
...
if ( V_55 <= V_133 ) {
if ( V_9 == 0 ) {
ASSERT ( V_6 -> V_28 -> V_230 ( V_6 , V_165 ,
F_45 ( V_6 , V_55 , V_8 ) ) ) ;
} else {
ASSERT ( V_6 -> V_28 -> V_228 ( V_6 , V_163 ,
F_46 ( V_6 , V_55 , V_8 ) ) ) ;
}
}
#endif
...
& V_272 , & V_55 , & V_263 , & V_76 , V_208 , V_176 ) ;
if ( error || * V_176 == 0 )
goto V_177;
}
V_8 = F_52 ( V_6 , V_9 , & V_11 ) ;
...
#ifdef F_109
if ( V_55 < V_133 ) {
ASSERT ( V_6 -> V_28 -> V_228 ( V_6 , V_189 ,
F_46 ( V_6 , V_55 + 1 , V_8 ) ) ) ;
}
#endif
} else {
union V_96 * V_212 ;
V_212 = F_45 ( V_6 , V_55 , V_8 ) ;
F_93 ( V_6 , V_212 , 1 , V_133 - V_55 + 1 ) ;
F_90 ( V_6 , V_212 , V_165 , 1 ) ;
F_129 ( V_8 , ++ V_133 ) ;
F_102 ( V_6 , V_11 , V_55 , V_133 ) ;
#ifdef F_109
if ( V_55 < V_133 ) {
ASSERT ( V_6 -> V_28 -> V_230 ( V_6 , V_212 ,
F_45 ( V_6 , V_55 + 1 , V_8 ) ) ) ;
}
#endif
}
F_104 ( V_6 , V_11 , V_231 ) ;
if ( V_11 && V_11 -> V_23 != V_273 ) {
F_118 ( V_6 , V_8 , V_208 ) ;
} else if ( F_119 ( V_6 , V_272 ) ) {
error = F_123 ( V_6 , V_9 ) ;
if ( error )
goto V_177;
}
...
V_163 = & V_277 ;
F_74 ( V_6 , & V_263 ) ;
V_6 -> V_28 -> V_278 ( V_6 , & V_165 ) ;
V_6 -> V_28 -> V_190 ( V_163 , & V_165 ) ;
do {
error = F_151 ( V_276 , V_9 , & V_263 , & V_165 , V_163 ,
& V_76 , & V_69 ) ;
if ( error ) {
if ( V_276 != V_6 )
F_33 ( V_276 , V_234 ) ;
...
F_147 ( & V_8 -> V_27 , V_56 ) ;
ASSERT ( V_8 -> V_27 == V_260 -> V_27 ) ;
V_189 = F_46 ( V_6 , 1 , V_8 ) ;
V_261 = F_46 ( V_6 , 1 , V_260 ) ;
F_89 ( V_6 , V_189 , V_261 , V_133 ) ;
V_184 = F_48 ( V_6 , 1 , V_8 ) ;
V_262 = F_48 ( V_6 , 1 , V_260 ) ;
#ifdef F_109
for ( V_69 = 0 ; V_69 < V_133 ; V_69 ++ ) {
error = F_21 ( V_6 , V_262 , V_69 , V_9 - 1 ) ;
if ( error ) {
F_96 ( V_6 , V_182 ) ;
return error ;
}
...
#endif
F_91 ( V_6 , V_184 , V_262 , V_133 ) ;
error = F_30 ( V_6 , V_259 ) ;
if ( error ) {
F_96 ( V_6 , V_182 ) ;
return error ;
}
...
F_32 ( V_6 , V_282 ) ;
F_128 ( V_6 , V_225 , V_133 - V_55 ) ;
if ( V_9 > 0 ) {
union V_97 * V_226 ;
union V_54 * V_227 ;
V_226 = F_46 ( V_6 , V_55 + 1 , V_8 ) ;
V_227 = F_48 ( V_6 , V_55 + 1 , V_8 ) ;
#ifdef F_109
...
#endif
if ( V_55 < V_133 ) {
F_92 ( V_6 , V_226 , - 1 , V_133 - V_55 ) ;
F_94 ( V_6 , V_227 , - 1 , V_133 - V_55 ) ;
...
if ( V_133 >= V_6 -> V_28 -> V_284 ( V_6 , V_9 ) ) {
error = F_156 ( V_6 , V_9 , V_176 ) ;
if ( error )
goto V_177;
return 0 ;
...
V_69 = F_60 ( V_218 , V_9 ) ;
F_130 ( V_6 -> V_16 , V_69 == 1 , V_177 ) ;
V_125 = F_52 ( V_218 , V_9 , & V_217 ) ;
#ifdef F_109
error = F_17 ( V_218 , V_125 , V_9 , V_217 ) ;
if ( error )
goto V_177;
#endif
F_75 ( V_218 , V_125 , & V_281 , V_129 ) ;
if ( F_110 ( V_125 ) - 1 >=
V_6 -> V_28 -> V_284 ( V_218 , V_9 ) ) {
error = F_127 ( V_218 , V_9 , & V_69 ) ;
if ( error )
goto V_177;
if ( V_69 ) {
ASSERT ( F_110 ( V_8 ) >=
...
V_69 = F_59 ( V_218 , V_9 ) ;
F_130 ( V_6 -> V_16 , V_69 == 1 , V_177 ) ;
V_124 = F_52 ( V_218 , V_9 , & V_215 ) ;
#ifdef F_109
error = F_17 ( V_6 , V_124 , V_9 , V_215 ) ;
if ( error )
goto V_177;
#endif
F_75 ( V_218 , V_124 , & V_281 , V_130 ) ;
if ( F_110 ( V_124 ) - 1 >=
V_6 -> V_28 -> V_284 ( V_218 , V_9 ) ) {
error = F_131 ( V_218 , V_9 , & V_69 ) ;
if ( error )
goto V_177;
if ( V_69 ) {
ASSERT ( F_110 ( V_8 ) >=
...
union V_97 * V_221 ;
union V_54 * V_222 ;
V_226 = F_46 ( V_6 , V_216 + 1 , V_124 ) ;
V_227 = F_48 ( V_6 , V_216 + 1 , V_124 ) ;
V_221 = F_46 ( V_6 , 1 , V_125 ) ;
V_222 = F_48 ( V_6 , 1 , V_125 ) ;
#ifdef F_109
for ( V_69 = 1 ; V_69 < V_219 ; V_69 ++ ) {
error = F_21 ( V_6 , V_222 , V_69 , V_9 ) ;
if ( error )
goto V_177;
}
#endif
F_89 ( V_6 , V_226 , V_221 , V_219 ) ;
F_91 ( V_6 , V_227 , V_222 , V_219 ) ;
F_95 ( V_6 , V_215 , V_216 + 1 , V_216 + V_219 ) ;
F_103 ( V_6 , V_215 , V_216 + 1 , V_216 + V_219 ) ;
} else {
union V_96 * V_229 ;
union V_96 * V_223 ;
V_229 = F_45 ( V_6 , V_216 + 1 , V_124 ) ;
V_223 = F_45 ( V_6 , 1 , V_125 ) ;
F_90 ( V_6 , V_229 , V_223 , V_219 ) ;
F_102 ( V_6 , V_215 , V_216 + 1 , V_216 + V_219 ) ;
}
F_32 ( V_6 , V_285 ) ;
F_129 ( V_124 , V_216 + V_219 ) ;
F_75 ( V_6 , V_125 , & V_281 , V_130 ) ,
F_76 ( V_6 , V_124 , & V_281 , V_130 ) ;
F_104 ( V_6 , V_215 , V_231 | V_130 ) ;
F_75 ( V_6 , V_124 , & V_281 , V_130 ) ;
if ( ! F_73 ( V_6 , & V_281 ) ) {
error = F_88 ( V_6 , & V_281 , 0 , & V_240 , & V_239 ) ;
if ( error )
goto V_177;
F_76 ( V_6 , V_240 , & V_220 , V_129 ) ;
F_104 ( V_6 , V_239 , V_129 ) ;
}
error = F_30 ( V_6 , V_217 ) ;
if ( error )
goto V_177;
if ( V_11 != V_215 ) {
V_6 -> V_71 [ V_9 ] = V_215 ;
...
F_69 ( V_6 , V_9 , V_127 ) ;
V_8 = F_52 ( V_6 , V_9 , & V_11 ) ;
error = V_288 ( V_6 , V_9 , V_289 ) ;
if ( error )
return error ;
F_75 ( V_6 , V_8 , & V_235 , V_130 ) ;
if ( F_73 ( V_6 , & V_235 ) )
return - V_290 ;
return F_112 ( V_6 , V_9 , & V_235 , & V_8 ) ;
}
int
F_161 (
struct V_5 * V_6 ,
...
struct V_7 * V_8 = NULL ;
int error = 0 ;
V_6 -> V_28 -> V_193 ( V_6 , & V_220 ) ;
for ( V_9 = V_6 -> V_70 - 1 ; V_9 >= 0 ; V_9 -- ) {
error = F_112 ( V_6 , V_9 , & V_220 , & V_8 ) ;
if ( error )
return error ;
if ( V_9 > 0 ) {
union V_54 * V_55 ;
V_55 = F_48 ( V_6 , 1 , V_8 ) ;
F_71 ( V_6 , V_55 , 1 ) ;
F_91 ( V_6 , & V_220 , V_55 , 1 ) ;
}
do {
error = F_160 ( V_6 , V_9 , V_288 , V_289 ) ;
} while ( ! error );
if ( error != - V_290 )
return error ;
}
...
void * V_289 )
{
struct V_291 * V_292 = V_289 ;
struct V_7 * V_8 ;
struct V_10 * V_11 ;
V_8 = F_52 ( V_6 , V_9 , & V_11 ) ;
if ( V_6 -> V_49 & V_50 ) {
if ( V_8 -> V_18 . V_19 . V_136 == F_5 ( V_292 -> V_293 ) )
return 0 ;
V_8 -> V_18 . V_19 . V_136 = F_5 ( V_292 -> V_293 ) ;
} else {
if ( V_8 -> V_18 . V_46 . V_136 == F_16 ( V_292 -> V_293 ) )
return 0 ;
V_8 -> V_18 . V_46 . V_136 = F_16 ( V_292 -> V_293 ) ;
}
if ( ! V_11 ) {
ASSERT ( V_6 -> V_49 & V_104 ) ;
...
if ( V_6 -> V_68 ) {
if ( ! F_163 ( V_6 -> V_68 , V_11 ) ) {
F_104 ( V_6 , V_11 , V_294 ) ;
return - V_295 ;
}
} else {
F_164 ( V_11 , V_292 -> V_296 ) ;
}
return 0 ;
}
int
...
return false ;
if ( V_299 && F_6 ( V_8 -> V_18 . V_46 . V_136 ) != V_299 -> V_301 )
return false ;
return true ;
}
bool
...
while ( V_176 ) {
error = F_159 ( V_6 , & V_287 , & V_176 ) ;
if ( error || ! V_176 )
break;
if ( V_310 ) {
V_6 -> V_28 -> V_204 ( & V_309 , V_287 ) ;
V_310 = false ;
V_191 = V_6 -> V_28 -> V_205 ( V_6 , V_306 ,
& V_309 ) ;
if ( V_191 > 0 )
goto V_312;
}
V_6 -> V_28 -> V_190 ( & V_309 , V_287 ) ;
V_191 = V_6 -> V_28 -> V_205 ( V_6 , & V_309 , V_307 ) ;
if ( V_191 > 0 )
break;
error = V_288 ( V_6 , V_287 , V_308 ) ;
...
if ( V_9 == 0 ) {
V_287 = F_45 ( V_6 , V_6 -> V_81 [ 0 ] , V_8 ) ;
V_6 -> V_28 -> V_204 ( & V_314 , V_287 ) ;
V_316 = V_6 -> V_28 -> V_205 ( V_6 , & V_314 ,
V_306 ) ;
V_6 -> V_28 -> V_190 ( & V_309 , V_287 ) ;
V_317 = V_6 -> V_28 -> V_205 ( V_6 , V_307 ,
& V_309 ) ;
if ( V_316 >= 0 && V_317 >= 0 ) {
error = V_288 ( V_6 , V_287 , V_308 ) ;
if ( error < 0 ||
...
V_226 = F_46 ( V_6 , V_6 -> V_81 [ V_9 ] , V_8 ) ;
V_315 = F_47 ( V_6 , V_6 -> V_81 [ V_9 ] , V_8 ) ;
V_184 = F_48 ( V_6 , V_6 -> V_81 [ V_9 ] , V_8 ) ;
V_316 = V_6 -> V_28 -> V_205 ( V_6 , V_315 , V_306 ) ;
V_317 = V_6 -> V_28 -> V_205 ( V_6 , V_307 , V_226 ) ;
if ( V_316 >= 0 && V_317 >= 0 ) {
V_9 -- ;
...
V_6 -> V_80 = * V_321 ;
V_6 -> V_28 -> V_278 ( V_6 , & V_165 ) ;
V_6 -> V_28 -> V_190 ( & V_307 , & V_165 ) ;
V_6 -> V_80 = * V_320 ;
V_6 -> V_28 -> V_278 ( V_6 , & V_165 ) ;
V_6 -> V_28 -> V_190 ( & V_306 , & V_165 ) ;
if ( V_6 -> V_28 -> V_205 ( V_6 , & V_306 , & V_307 ) > 0 )
return - V_322 ;
if ( ! ( V_6 -> V_49 & V_201 ) )
...
memset ( & V_307 , 0xFF , sizeof( V_307 ) ) ;
return F_169 ( V_6 , & V_306 , & V_307 , V_288 , V_308 ) ;
}
T_14
F_174 (
struct V_13 * V_14 ,
