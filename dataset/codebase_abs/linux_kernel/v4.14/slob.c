...
F_45 ( V_44 , V_7 , 1 , V_13 ) ;
return V_44 ;
}
void * F_46 ( T_4 V_7 , T_3 V_13 )
{
return F_38 ( V_7 , V_13 , V_16 , V_48 ) ;
}
void * F_47 ( T_4 V_7 , T_3 V_13 , unsigned long V_40 )
{
return F_38 ( V_7 , V_13 , V_16 , V_40 ) ;
}
void * F_48 ( T_4 V_7 , T_3 V_13 ,
int V_15 , unsigned long V_40 )
{
return F_38 ( V_7 , V_13 , V_15 , V_40 ) ;
}
void F_49 ( const void * V_38 )
{
struct V_1 * V_2 ;
F_50 ( V_48 , V_38 ) ;
if ( F_33 ( F_35 ( V_38 ) ) )
...
static void * F_57 ( struct V_50 * V_51 , T_3 V_29 , int V_15 )
{
void * V_17 ;
V_29 &= V_45 ;
F_40 ( V_29 ) ;
...
F_58 ( V_48 , V_17 , V_51 -> V_54 ,
F_21 ( V_51 -> V_7 ) * V_49 ,
V_29 , V_15 ) ;
} else {
V_17 = F_13 ( V_29 , F_43 ( V_51 -> V_7 ) , V_15 ) ;
F_58 ( V_48 , V_17 , V_51 -> V_54 ,
V_37 << F_43 ( V_51 -> V_7 ) ,
V_29 , V_15 ) ;
}
if ( V_17 && V_51 -> V_55 )
V_51 -> V_55 ( V_17 ) ;
F_59 ( V_17 , V_51 -> V_7 , 1 , V_51 -> V_29 , V_29 ) ;
return V_17 ;
}
void * F_60 ( struct V_50 * V_56 , T_3 V_29 )
{
return F_57 ( V_56 , V_29 , V_16 ) ;
}
void * F_61 ( T_4 V_7 , T_3 V_13 , int V_15 )
{
return F_38 ( V_7 , V_13 , V_15 , V_48 ) ;
}
void * F_62 ( struct V_50 * V_56 , T_3 V_13 , int V_15 )
{
return F_57 ( V_56 , V_13 , V_15 ) ;
}
static void F_63 ( void * V_17 , int V_7 )
{
if ( V_7 < V_37 )
F_34 ( V_17 , V_7 ) ;
else
...
void F_65 ( struct V_50 * V_51 , void * V_17 )
{
F_66 ( V_17 , V_51 -> V_29 ) ;
...
void F_69 ( struct V_50 * V_6 , T_4 V_7 , void * * V_59 )
{
F_70 ( V_6 , V_7 , V_59 ) ;
}
int F_71 ( struct V_50 * V_6 , T_3 V_29 , T_4 V_7 ,
void * * V_59 )
{
return F_72 ( V_6 , V_29 , V_7 , V_59 ) ;
}
int F_73 ( struct V_50 * V_51 )
{
return 0 ;
}
