...
static int F_68 ( struct V_6 * V_50 , struct V_138 * V_139 , int V_140 )
{
if ( ! F_66 ( V_50 ) )
return - V_141 ;
if ( ! V_50 -> V_10 )
return - V_142 ;
return F_69 ( V_50 -> V_10 , V_139 , V_140 ) ;
}
int F_70 ( struct V_6 * V_7 , int V_143 )
{
struct V_144 * V_50 = V_7 -> V_50 . V_145 ;
struct V_146 V_147 ;
struct V_148 * V_149 ;
struct V_8 * V_10 = NULL ;
struct V_1 * V_2 ;
const char * V_150 ;
unsigned int V_151 , V_152 , V_75 ;
int V_153 ;
V_149 = F_71 ( V_50 -> V_154 , L_4 , 0 ) ;
if ( ! V_149 ) {
F_72 ( V_50 , L_5 ) ;
return - V_142 ;
}
V_153 = F_73 ( V_50 -> V_154 , 0 , & V_147 ) ;
if ( V_153 ) {
F_72 ( V_50 , L_6 ) ;
V_153 = - V_142 ;
goto V_155;
}
V_75 = F_74 ( V_50 -> V_154 , 0 ) ;
if ( ! V_75 ) {
F_72 ( V_50 , L_7 ) ;
V_153 = - V_142 ;
goto V_155;
...
V_2 = F_3 ( V_7 ) ;
V_2 -> V_50 = V_50 ;
V_2 -> V_162 = F_75 ( V_50 , & V_147 ) ;
if ( F_76 ( V_2 -> V_162 ) ) {
V_153 = F_77 ( V_2 -> V_162 ) ;
goto V_155;
}
F_78 ( V_50 , L_8 , V_2 -> V_162 ) ;
if ( V_2 -> V_163 ) {
V_153 = F_79 ( V_2 -> V_163 ) ;
if ( V_153 ) {
F_72 ( V_50 , L_9 ) ;
goto V_155;
}
V_152 = F_80 ( V_2 -> V_163 ) ;
} else {
if ( F_81 ( V_50 -> V_154 , L_10 ,
& V_152 ) ) {
F_72 ( V_50 , L_11 ) ;
V_153 = - V_141 ;
goto V_155;
...
V_151 = F_4 ( V_2 , V_164 ) ;
if ( ! ( V_151 == 0x0005fd02 || V_151 == 0x0007fd02 ) ) {
F_72 ( V_50 , L_12 , V_151 ) ;
V_153 = - V_142 ;
goto V_165;
}
F_82 ( V_50 , L_13 , V_151 ) ;
F_5 ( V_2 , V_166 , V_152 / 1000000 ) ;
V_7 -> V_75 = V_75 ;
F_82 ( V_50 , L_14 , V_7 -> V_75 ) ;
V_153 = F_83 ( V_50 , V_7 -> V_75 , F_37 , 0 ,
V_7 -> V_167 , V_7 ) ;
if ( V_153 ) {
F_72 ( V_50 , L_15 ) ;
goto V_165;
}
V_150 = F_84 ( V_50 -> V_154 ) ;
if ( V_150 )
memcpy ( V_7 -> V_128 , V_150 , V_114 ) ;
else
F_85 ( V_7 ) ;
F_63 ( V_7 ) ;
F_82 ( V_50 , L_16 , V_7 -> V_128 ) ;
V_2 -> V_57 = F_86 ( V_50 , V_168 + V_95 ,
& V_2 -> V_99 , V_169 ) ;
if ( ! V_2 -> V_57 ) {
F_72 ( V_50 , L_17 ) ;
V_153 = - V_94 ;
...
F_82 ( V_50 , L_21 ,
V_10 -> V_171 -> V_167 , V_10 -> V_172 ) ;
F_89 ( V_7 , & V_2 -> V_71 , F_34 , V_173 ) ;
V_153 = F_90 ( V_7 ) ;
if ( V_153 ) {
F_72 ( V_50 , L_22 ) ;
goto V_174;
