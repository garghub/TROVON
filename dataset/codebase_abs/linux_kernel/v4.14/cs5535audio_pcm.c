...
struct V_18 * V_19 ;
V_19 = V_2 -> V_7 -> V_14 ;
V_74 = V_19 -> V_42 -> V_75 ( V_5 ) ;
if ( V_74 < V_19 -> V_56 ) {
F_42 ( V_5 -> V_71 -> V_72 , L_2 ,
V_74 , V_19 -> V_56 ) ;
return 0 ;
}
V_74 -= V_19 -> V_56 ;
if ( V_74 >= V_19 -> V_57 ) {
F_42 ( V_5 -> V_71 -> V_72 , L_3 ,
V_74 , V_19 -> V_57 ) ;
return 0 ;
}
return F_45 ( V_2 -> V_7 , V_74 ) ;
}
...
struct V_6 * V_7 = V_2 -> V_7 ;
V_7 -> V_8 = V_76 ;
V_7 -> V_8 . V_10 = V_5 -> V_11 -> V_10 [ V_77 ] ;
F_3 ( V_7 ) ;
V_5 -> V_78 = V_2 ;
V_7 -> V_14 = & ( V_5 -> V_15 [ V_79 ] ) ;
if ( ( V_3 = F_4 ( V_7 ,
V_17 ) ) < 0 )
return V_3 ;
F_47 ( V_5 -> V_11 ) ;
...
struct V_80 * V_81 ;
int V_3 ;
V_3 = F_52 ( V_5 -> V_71 , L_4 , 0 , 1 , 1 , & V_81 ) ;
if ( V_3 < 0 )
return V_3 ;
V_5 -> V_15 [ V_16 ] . V_42 =
& V_82 ;
