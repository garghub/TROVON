...
{
if ( V_3 -> V_20 . V_5 . V_19 )
return - V_21 ;
F_11 ( V_3 ) ;
V_3 -> V_22 . V_23 = 100 ;
V_3 -> V_22 . V_24 = NULL ;
V_3 -> V_20 . V_25 = V_3 -> V_26 ;
V_3 -> V_20 . V_27 = V_3 -> V_28 ;
V_3 -> V_20 . V_29 = F_30 ( V_3 -> V_28 ) ;
V_3 -> V_20 . V_5 . V_22 = & V_3 -> V_22 ;
V_3 -> V_20 . V_5 . V_19 = NULL ;
V_3 -> V_20 . V_5 . V_30 = F_28 ;
V_3 -> V_20 . V_5 . V_31 = NULL ;
snprintf ( V_3 -> V_32 , sizeof( V_3 -> V_32 ) , L_2 ) ;
V_3 -> V_20 . V_33 = V_3 -> V_32 ;
F_31 ( & V_3 -> V_4 -> V_5 , L_3 , L_2 ) ;
F_32 ( L_2 ) ;
F_31 ( & V_3 -> V_4 -> V_5 , L_4 ,
V_3 -> V_20 . V_33 ) ;
return F_33 ( & V_3 -> V_20 ) ;
}
static void F_34 ( struct V_2 * V_3 )
{
F_5 ( & V_3 -> V_34 ) ;
while ( V_3 -> V_35 > V_3 -> V_36 ) {
struct V_37 * V_38 = & V_3 -> V_38 [ V_39 &
V_3 -> V_36 ++ ] ;
* V_38 -> V_40 = - V_41 ;
* V_38 -> V_42 = 0 ;
F_35 ( & V_38 -> V_43 ) ;
...
int V_40 = - V_73 ;
V_38 -> V_40 = & V_40 ;
V_38 -> V_62 = V_60 -> V_62 = 0x00 | V_163 ;
V_60 -> V_63 = 0x04 ;
V_38 -> V_64 = V_60 -> V_64 = V_164 ;
V_60 -> V_65 = 0x00 ;
V_60 -> V_66 = 0 ;
V_60 -> V_42 = 0 ;
V_60 -> V_67 = NULL ;
...
int V_40 = - V_73 ;
V_38 -> V_40 = & V_40 ;
V_38 -> V_62 = V_60 -> V_62 = 0x00 | ( V_165 &
0x0F ) ;
V_60 -> V_63 = 0x04 ;
V_38 -> V_64 = V_60 -> V_64 = V_157 ;
V_60 -> V_65 = 0x00 | ( V_65 & 0x0F ) ;
V_60 -> V_66 = 0 ;
V_60 -> V_42 = 0 ;
V_60 -> V_67 = NULL ;
...
int V_40 = - V_73 ;
V_38 -> V_40 = & V_40 ;
V_38 -> V_62 = V_60 -> V_62 = 0x00 | ( V_166 &
0x0F ) ;
V_60 -> V_63 = 0x04 ;
V_38 -> V_64 = V_60 -> V_64 = V_157 ;
V_60 -> V_65 = 0x00 | ( V_65 & 0x0F ) ;
...
if ( V_189 == V_3 -> V_22 . V_192 && V_190 ==
V_3 -> V_22 . V_18 ) {
return 0 ;
} else {
F_45 ( & V_3 -> V_4 -> V_5 , L_37 ,
V_3 -> V_22 . V_192 , V_189 ,
V_3 -> V_22 . V_18 , V_190 ) ;
return - V_73 ;
}
}
...
V_269 = V_88 -> V_274 ;
V_72 = F_128 ( V_269 ,
& V_271 , & V_272 , NULL , NULL ) ;
if ( V_72 ) {
F_45 ( & V_3 -> V_4 -> V_5 , L_40 ) ;
goto error;
}
V_3 -> V_108 = F_129 ( V_271 ) ;
V_3 -> V_107 = V_271 -> V_275 ;
V_3 -> V_10 = F_130 ( V_3 -> V_108 , V_126 ) ;
if ( ! V_3 -> V_10 ) {
V_72 = - V_127 ;
goto error;
}
V_3 -> V_128 = V_272 -> V_275 ;
F_31 ( & V_3 -> V_4 -> V_5 , L_41 ,
V_269 -> V_276 . V_277 , V_3 -> V_107 ,
V_3 -> V_128 ) ;
F_131 ( V_88 , V_3 ) ;
if ( V_269 -> V_276 . V_277 == 0 &&
V_3 -> V_107 == 0x81 &&
V_3 -> V_128 == 0x02 ) {
V_72 = F_132 ( V_88 , & V_278 ) ;
if ( V_72 ) {
...
V_3 , V_269 -> V_276 . V_277 ,
V_88 -> V_280 ) ;
return 0 ;
}
} else if ( V_269 -> V_276 . V_277 == 1 &&
V_3 -> V_107 == 0x83 &&
V_3 -> V_128 == 0x04 ) {
V_3 -> V_279 = NULL ;
...
static void F_134 ( struct V_87 * V_88 )
{
struct V_2 * V_3 = F_63 ( V_88 ) ;
V_3 -> V_6 += 1 ;
if ( V_3 -> V_279 ) {
int V_280 = V_88 -> V_280 ;
struct V_281 * V_279 = V_3 -> V_279 ;
F_131 ( V_88 , NULL ) ;
F_135 ( V_88 , V_279 ) ;
...
F_141 ( & V_89 ) ;
F_137 ( L_50 ) ;
F_142 (ftdi, temp, &ftdi_static_list, ftdi_list) {
F_18 ( V_3 ) ;
F_22 ( V_3 ) ;
F_25 ( V_3 ) ;
}
