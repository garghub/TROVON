...
V_21 -> V_233 =
F_67 ( V_21 -> V_35 . V_232 , V_21 -> V_35 . V_113 ) ;
if ( ! V_21 -> V_233 ) {
F_8 ( L_18 ) ;
...
F_8 ( V_103 L_19 ,
V_21 -> V_233 ) ;
V_4 -> V_234 = F_68 ( V_21 -> V_35 . V_232 ,
F_69 ( V_225 , 0 ) ) ;
...
{
struct V_3 * V_4 = V_21 -> V_4 ;
unsigned char type , V_235 ;
int V_236 ;
V_21 -> V_237 . V_238 = F_74 ( sizeof( struct V_239 ) , V_240 ) ;
if ( ! V_21 -> V_237 . V_238 )
return - V_230 ;
V_21 -> V_237 . V_241 = 1 ;
F_15 ( NULL , 0x09 , 0x26 ) ;
type = F_40 ( NULL , 0x21 ) ;
V_235 = F_40 ( NULL , 0x20 ) ;
if ( ! V_4 -> V_100 && ! V_4 -> V_136 ) {
V_4 -> V_100 = V_235 & 2 || ! ( V_235 & 3 ) ? 1 : 0 ;
V_4 -> V_136 = V_235 & 1 ;
F_8 ( V_103 L_21 ,
...
V_4 -> V_101 = 640 ;
V_4 -> V_102 = 480 ;
memcpy ( V_21 -> V_237 . V_238 , & V_242 [ 3 ] , sizeof( struct V_239 ) ) ;
break;
case 0x01 :
V_4 -> V_101 = 800 ;
if ( V_4 -> V_104 ) {
V_4 -> V_102 = 480 ;
memcpy ( V_21 -> V_237 . V_238 , & V_243 , sizeof( struct V_239 ) ) ;
} else {
V_4 -> V_102 = 600 ;
memcpy ( V_21 -> V_237 . V_238 , & V_242 [ 8 ] , sizeof( struct V_239 ) ) ;
}
break;
case 0x02 :
V_4 -> V_101 = 1024 ;
V_4 -> V_102 = 768 ;
memcpy ( V_21 -> V_237 . V_238 , & V_242 [ 13 ] , sizeof( struct V_239 ) ) ;
break;
case 0x03 :
#ifdef F_75
V_4 -> V_101 = 1280 ;
V_4 -> V_102 = 1024 ;
memcpy ( V_21 -> V_237 . V_238 , & V_242 [ 20 ] , sizeof( struct V_239 ) ) ;
break;
#else
F_8 ( V_88
L_25 ) ;
...
return NULL ;
V_4 = V_21 -> V_4 ;
V_21 -> V_35 . V_36 = V_248 -> V_249 ;
V_4 -> V_131 = ! V_250 ;
V_4 -> V_124 = ! V_251 ;
V_4 -> V_104 = V_104 ;
V_4 -> V_100 = V_252 ;
V_4 -> V_136 = V_253 ;
V_21 -> V_91 = V_254 | V_255 ;
switch ( V_21 -> V_35 . V_36 ) {
case V_151 :
snprintf ( V_21 -> V_35 . V_248 , sizeof( V_21 -> V_35 . V_248 ) ,
L_32 ) ;
break;
case V_152 :
snprintf ( V_21 -> V_35 . V_248 , sizeof( V_21 -> V_35 . V_248 ) ,
...
static int F_82 ( struct V_224 * V_225 , const struct V_247 * V_248 )
{
struct V_20 * V_21 ;
T_6 V_267 , V_268 ;
int V_231 , V_269 ;
...
return V_269 ;
V_269 = - V_230 ;
V_21 = F_77 ( V_225 , V_248 ) ;
if ( ! V_21 )
return V_269 ;
V_269 = F_59 ( V_21 , V_225 ) ;
if ( V_269 )
goto V_270;
V_269 = F_73 ( V_21 ) ;
if ( V_269 )
...
V_269 = F_66 ( V_21 , V_225 , V_231 ) ;
if ( V_269 )
goto V_272;
if ( ! F_84 ( & V_21 -> V_46 , V_21 , V_273 , NULL , 0 ,
V_21 -> V_237 . V_238 , 16 ) ) {
F_8 ( V_88 L_42 ) ;
V_269 = - V_94 ;
goto V_274;
}
V_267 = 1953125000 / V_21 -> V_46 . V_98 ;
V_267 =
V_267 * 512 / ( V_21 -> V_46 . V_7 + V_21 -> V_46 . V_51 +
V_21 -> V_46 . V_48 + V_21 -> V_46 . V_49 ) ;
V_268 =
V_267 / ( V_21 -> V_46 . V_8 + V_21 -> V_46 . V_57 +
V_21 -> V_46 . V_53 + V_21 -> V_46 . V_55 ) ;
F_8 ( V_103 L_43 V_275
L_44 ,
V_21 -> V_35 . V_113 >> 10 , V_21 -> V_46 . V_7 ,
V_21 -> V_46 . V_8 , V_267 / 1000 , V_267 % 1000 , V_268 ) ;
V_269 = F_85 ( & V_21 -> V_164 , 256 , 0 ) ;
if ( V_269 < 0 )
goto V_274;
V_269 = F_86 ( V_21 ) ;
if ( V_269 < 0 )
goto V_276;
V_20 ( V_21 , L_45 , V_21 -> V_35 . V_248 ) ;
F_87 ( V_225 , V_21 ) ;
return 0 ;
V_276:
F_80 ( & V_21 -> V_164 ) ;
...
static int T_9 F_92 ( char * V_277 )
{
char * V_278 ;
F_37 ( L_48 ) ;
if ( ! V_277 || ! * V_277 )
return 0 ;
while ( ( V_278 = F_93 ( & V_277 , L_49 ) ) != NULL ) {
if ( ! * V_278 )
continue;
if ( ! strncmp ( V_278 , L_23 , 8 ) )
V_252 = 1 ;
else if ( ! strncmp ( V_278 , L_24 , 8 ) )
V_253 = 1 ;
else if ( ! strncmp ( V_278 , L_50 , 9 ) )
V_251 = 1 ;
else if ( ! strncmp ( V_278 , L_51 , 10 ) )
V_250 = 1 ;
else if ( ! strncmp ( V_278 , L_52 , 8 ) )
V_104 = 1 ;
else
V_273 = V_278 ;
}
