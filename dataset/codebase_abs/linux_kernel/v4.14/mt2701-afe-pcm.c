...
V_136 = F_51 ( V_134 , V_140 , 0 ) ;
V_2 -> V_141 = F_52 ( & V_134 -> V_7 , V_136 ) ;
if ( F_53 ( V_2 -> V_141 ) )
return F_54 ( V_2 -> V_141 ) ;
V_2 -> V_42 = F_55 ( & V_134 -> V_7 , V_2 -> V_141 ,
& V_142 ) ;
if ( F_53 ( V_2 -> V_42 ) )
return F_54 ( V_2 -> V_42 ) ;
F_56 ( & V_2 -> V_143 ) ;
V_2 -> V_144 = V_126 ;
V_2 -> V_95 = F_57 ( V_7 , V_2 -> V_144 , sizeof( * V_2 -> V_95 ) ,
V_137 ) ;
if ( ! V_2 -> V_95 )
return - V_138 ;
for ( V_11 = 0 ; V_11 < V_2 -> V_144 ; V_11 ++ ) {
V_2 -> V_95 [ V_11 ] . V_104 = & V_101 [ V_11 ] ;
V_2 -> V_95 [ V_11 ] . V_127 = - 1 ;
}
V_2 -> V_145 = V_146 ;
V_2 -> V_128 = F_57 ( V_7 , V_2 -> V_145 , sizeof( * V_2 -> V_128 ) ,
V_137 ) ;
if ( ! V_2 -> V_128 )
return - V_138 ;
for ( V_11 = 0 ; V_11 < V_2 -> V_145 ; V_11 ++ )
V_2 -> V_128 [ V_11 ] . V_129 = & V_129 [ V_11 ] ;
for ( V_11 = 0 ; V_11 < V_6 ; V_11 ++ ) {
V_24 -> V_34 [ V_11 ] . V_36 [ V_147 ]
= & V_35 [ V_11 ] [ V_147 ] ;
V_24 -> V_34 [ V_11 ] . V_36 [ V_148 ]
= & V_35 [ V_11 ] [ V_148 ] ;
}
V_2 -> V_149 = & V_150 ;
V_2 -> V_151 = F_37 ;
