...
if ( F_20 ( ( V_50 & F_14 ( V_54 ) ) || ( V_52 & F_14 ( V_54 ) ) ) )
F_21 ( V_13 -> V_62 . V_63 , L_1 ) ;
}
...
static int F_23 ( struct V_1 * V_43 )
{
struct V_12 * V_13 = F_24 ( V_43 -> V_4 . V_3 . V_67 ) ;
struct V_68 * V_60 = F_25 ( & V_43 -> V_4 ) ;
if ( ! V_43 -> V_6 )
return - V_69 ;
...
static void F_27 ( unsigned long V_74 )
{
struct V_12 * V_13 = (struct V_12 * ) V_74 ;
struct V_5 * V_42 ;
struct V_1 * V_43 , * V_75 ;
unsigned V_76 , V_77 = 0 ;
F_28 (c, cn, &d->slave.channels, vc.chan.device_node) {
F_29 ( & V_43 -> V_4 . V_58 ) ;
V_42 = V_43 -> V_6 ;
if ( V_42 && V_42 -> V_61 ) {
if ( F_23 ( V_43 ) ) {
F_30 ( V_13 -> V_62 . V_63 , L_2 , V_42 -> V_14 ) ;
V_43 -> V_6 = NULL ;
V_42 -> V_57 = NULL ;
}
}
...
V_42 = & V_13 -> V_6 [ V_76 ] ;
if ( V_42 -> V_57 == NULL && ! F_32 ( & V_13 -> V_79 ) ) {
V_43 = F_33 ( & V_13 -> V_79 ,
struct V_1 , V_72 ) ;
F_34 ( & V_43 -> V_72 ) ;
V_77 |= 1 << V_76 ;
V_42 -> V_57 = V_43 ;
V_43 -> V_6 = V_42 ;
F_30 ( V_13 -> V_62 . V_63 , L_3 , V_76 , & V_43 -> V_4 ) ;
}
}
F_31 ( & V_13 -> V_58 ) ;
for ( V_76 = 0 ; V_76 < V_13 -> V_78 ; V_76 ++ ) {
...
struct V_12 * V_13 = F_24 ( V_3 -> V_67 ) ;
unsigned long V_56 ;
F_16 ( & V_13 -> V_58 , V_56 ) ;
F_34 ( & V_43 -> V_72 ) ;
F_18 ( & V_13 -> V_58 , V_56 ) ;
...
static enum V_81 F_37 ( struct V_2 * V_3 ,
...
enum V_81 V_85 ;
T_4 V_86 = 0 ;
V_85 = F_38 ( & V_43 -> V_4 . V_3 , V_82 , V_84 ) ;
if ( V_85 == V_87 )
return V_85 ;
F_16 ( & V_43 -> V_4 . V_58 , V_56 ) ;
V_42 = V_43 -> V_6 ;
V_85 = V_43 -> V_88 ;
V_60 = F_39 ( & V_43 -> V_4 , V_82 ) ;
if ( V_60 && ! V_43 -> V_89 ) {
...
if ( ! V_43 -> V_6 ) {
if ( F_32 ( & V_43 -> V_72 ) ) {
F_44 ( & V_43 -> V_72 , & V_13 -> V_79 ) ;
F_22 ( & V_13 -> V_64 ) ;
F_30 ( V_13 -> V_62 . V_63 , L_4 , & V_43 -> V_4 ) ;
}
}
F_45 ( & V_13 -> V_58 ) ;
} else
F_30 ( V_13 -> V_62 . V_63 , L_5 , & V_43 -> V_4 ) ;
F_18 ( & V_43 -> V_4 . V_58 , V_56 ) ;
}
static void F_46 ( struct V_70 * V_71 , T_5 V_95 ,
...
static struct V_70 * F_47 ( int V_98 ,
struct V_2 * V_3 )
{
struct V_1 * V_43 = F_1 ( V_3 ) ;
struct V_70 * V_71 ;
...
if ( V_98 > V_100 ) {
F_30 ( V_3 -> V_67 -> V_63 , L_6 ,
& V_43 -> V_4 , V_98 , V_100 ) ;
return NULL ;
}
V_71 = F_48 ( sizeof( * V_71 ) , V_102 ) ;
if ( ! V_71 )
return NULL ;
V_71 -> V_73 = F_49 ( V_13 -> V_103 , V_102 , & V_71 -> V_93 ) ;
if ( ! V_71 -> V_73 ) {
F_30 ( V_3 -> V_67 -> V_63 , L_7 , & V_43 -> V_4 ) ;
F_50 ( V_71 ) ;
return NULL ;
}
V_71 -> V_94 = V_98 ;
...
do {
V_105 = F_53 ( T_4 , V_97 , V_106 ) ;
F_46 ( V_71 , V_95 , V_96 , V_105 , V_98 ++ , V_43 -> V_80 ) ;
if ( V_43 -> V_109 == V_110 ) {
V_96 += V_105 ;
...
return F_54 ( & V_43 -> V_4 , & V_71 -> V_60 , V_56 ) ;
}
static struct V_104 * F_55 (
...
F_46 ( V_71 , V_95 , V_96 , V_97 , V_98 ++ , V_43 -> V_80 ) ;
V_120 += V_97 ;
V_117 -= V_97 ;
} while ( V_117 );
}
...
V_128 = 0 ;
F_46 ( V_71 , V_95 , V_96 , V_97 , V_98 ++ , V_43 -> V_80 | V_128 ) ;
V_120 += V_97 ;
V_117 -= V_97 ;
} while ( V_117 );
...
static void F_61 ( struct V_68 * V_60 )
{
struct V_70 * V_71 =
F_2 ( V_60 , struct V_70 , V_60 ) ;
struct V_12 * V_13 = F_24 ( V_60 -> V_151 . V_3 -> V_67 ) ;
F_62 ( V_13 -> V_103 , V_71 -> V_73 , V_71 -> V_93 ) ;
F_50 ( V_71 ) ;
}
...
unsigned long V_56 ;
F_64 ( V_152 ) ;
F_30 ( V_13 -> V_62 . V_63 , L_9 , & V_43 -> V_4 ) ;
F_43 ( & V_13 -> V_58 ) ;
F_34 ( & V_43 -> V_72 ) ;
F_45 ( & V_13 -> V_58 ) ;
F_16 ( & V_43 -> V_4 . V_58 , V_56 ) ;
...
struct V_12 * V_13 = F_24 ( V_3 -> V_67 ) ;
struct V_5 * V_42 = V_43 -> V_6 ;
F_30 ( V_13 -> V_62 . V_63 , L_10 , & V_43 -> V_4 ) ;
if ( V_43 -> V_88 == V_153 ) {
V_43 -> V_88 = V_154 ;
if ( V_42 ) {
F_3 ( V_42 , false ) ;
...
struct V_5 * V_42 = V_43 -> V_6 ;
unsigned long V_56 ;
F_30 ( V_13 -> V_62 . V_63 , L_11 , & V_43 -> V_4 ) ;
F_16 ( & V_43 -> V_4 . V_58 , V_56 ) ;
if ( V_43 -> V_88 == V_154 ) {
V_43 -> V_88 = V_153 ;
if ( V_42 ) {
F_3 ( V_42 , true ) ;
} else if ( ! F_32 ( & V_43 -> V_4 . V_155 ) ) {
F_43 ( & V_13 -> V_58 ) ;
F_44 ( & V_43 -> V_72 , & V_13 -> V_79 ) ;
F_45 ( & V_13 -> V_58 ) ;
}
...
static struct V_2 * F_69 ( struct V_156 * V_157 ,
struct V_158 * V_159 )
{
...
if ( V_161 > V_13 -> V_162 )
return NULL ;
return F_70 ( & ( V_13 -> V_163 [ V_161 ] . V_4 . V_3 ) ) ;
}
static int F_71 ( struct V_164 * V_165 )
{
struct V_12 * V_13 ;
const struct V_166 * V_167 ;
struct V_168 * V_169 ;
int V_54 , V_85 , V_40 = 0 ;
V_169 = F_72 ( V_165 , V_170 , 0 ) ;
if ( ! V_169 )
return - V_137 ;
V_13 = F_73 ( & V_165 -> V_63 , sizeof( * V_13 ) , V_171 ) ;
if ( ! V_13 )
return - V_172 ;
V_13 -> V_9 = F_74 ( & V_165 -> V_63 , V_169 ) ;
if ( F_75 ( V_13 -> V_9 ) )
return F_76 ( V_13 -> V_9 ) ;
V_167 = F_77 ( V_173 , & V_165 -> V_63 ) ;
if ( V_167 ) {
F_78 ( ( & V_165 -> V_63 ) -> V_174 ,
L_12 , & V_13 -> V_78 ) ;
F_78 ( ( & V_165 -> V_63 ) -> V_174 ,
L_13 , & V_13 -> V_162 ) ;
}
V_13 -> V_175 = F_79 ( & V_165 -> V_63 , NULL ) ;
if ( F_75 ( V_13 -> V_175 ) ) {
F_80 ( & V_165 -> V_63 , L_14 ) ;
return F_76 ( V_13 -> V_175 ) ;
}
V_40 = F_81 ( V_165 , 0 ) ;
V_85 = F_82 ( & V_165 -> V_63 , V_40 ,
F_12 , 0 , V_176 , V_13 ) ;
if ( V_85 )
return V_85 ;
V_13 -> V_40 = V_40 ;
V_13 -> V_103 = F_83 ( V_176 , & V_165 -> V_63 ,
V_101 , 32 , 0 ) ;
if ( ! V_13 -> V_103 )
return - V_172 ;
V_13 -> V_6 = F_73 ( & V_165 -> V_63 ,
...
F_84 ( & V_13 -> V_62 . V_177 ) ;
F_85 ( V_178 , V_13 -> V_62 . V_179 ) ;
F_85 ( V_180 , V_13 -> V_62 . V_179 ) ;
F_85 ( V_181 , V_13 -> V_62 . V_179 ) ;
V_13 -> V_62 . V_63 = & V_165 -> V_63 ;
V_13 -> V_62 . V_182 = F_35 ;
V_13 -> V_62 . V_183 = F_37 ;
V_13 -> V_62 . V_184 = F_51 ;
V_13 -> V_62 . V_185 = F_55 ;
V_13 -> V_62 . V_186 = F_59 ;
V_13 -> V_62 . V_187 = F_41 ;
V_13 -> V_62 . V_188 = F_60 ;
V_13 -> V_62 . V_189 = F_67 ;
V_13 -> V_62 . V_190 = F_68 ;
V_13 -> V_62 . V_191 = F_63 ;
V_13 -> V_62 . V_192 = V_193 ;
V_13 -> V_163 = F_73 ( & V_165 -> V_63 ,
...
F_84 ( & V_43 -> V_72 ) ;
V_43 -> V_4 . V_194 = F_61 ;
F_86 ( & V_43 -> V_4 , & V_13 -> V_62 ) ;
}
V_85 = F_87 ( V_13 -> V_175 ) ;
if ( V_85 < 0 ) {
F_80 ( & V_165 -> V_63 , L_15 , V_85 ) ;
return V_85 ;
}
F_11 ( V_13 , true ) ;
V_85 = F_88 ( & V_13 -> V_62 ) ;
if ( V_85 )
goto V_195;
V_85 = F_89 ( ( & V_165 -> V_63 ) -> V_174 ,
F_69 , V_13 ) ;
if ( V_85 )
goto V_196;
F_90 ( & V_13 -> V_58 ) ;
F_84 ( & V_13 -> V_79 ) ;
F_91 ( & V_13 -> V_64 , F_27 , ( unsigned long ) V_13 ) ;
F_92 ( V_165 , V_13 ) ;
F_93 ( & V_165 -> V_63 , L_16 ) ;
return 0 ;
V_196:
F_94 ( & V_13 -> V_62 ) ;
V_195:
...
{
struct V_1 * V_43 , * V_75 ;
struct V_12 * V_13 = F_97 ( V_165 ) ;
F_94 ( & V_13 -> V_62 ) ;
F_98 ( ( & V_165 -> V_63 ) -> V_174 ) ;
F_99 ( & V_165 -> V_63 , V_13 -> V_40 , V_13 ) ;
F_28 (c, cn, &d->slave.channels, vc.chan.device_node) {
F_26 ( & V_43 -> V_4 . V_3 . V_197 ) ;
F_100 ( & V_43 -> V_4 . V_64 ) ;
}
F_100 ( & V_13 -> V_64 ) ;
F_95 ( V_13 -> V_175 ) ;
...
static int F_101 ( struct V_67 * V_63 )
{
struct V_12 * V_13 = F_102 ( V_63 ) ;
T_1 V_44 = 0 ;
V_44 = F_10 ( V_13 ) ;
if ( V_44 ) {
F_21 ( V_13 -> V_62 . V_63 ,
...
static int F_103 ( struct V_67 * V_63 )
{
struct V_12 * V_13 = F_102 ( V_63 ) ;
int V_85 = 0 ;
V_85 = F_87 ( V_13 -> V_175 ) ;
if ( V_85 < 0 ) {
F_80 ( V_13 -> V_62 . V_63 , L_15 , V_85 ) ;
return V_85 ;
}
F_11 ( V_13 , true ) ;
return 0 ;
