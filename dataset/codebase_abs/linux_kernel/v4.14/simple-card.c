...
if ( V_46 ) {
V_45 = F_13 ( V_43 ) * V_46 ;
V_39 = F_14 ( V_41 , 0 , V_45 ,
V_47 ) ;
if ( V_39 && V_39 != - V_48 )
goto V_49;
V_39 = F_14 ( V_40 , 0 , V_45 ,
V_50 ) ;
if ( V_39 && V_39 != - V_48 )
goto V_49;
}
...
F_8 ( V_35 , V_32 -> V_38 ) ;
int V_39 ;
V_39 = F_16 ( V_51 , & V_37 -> V_41 ) ;
if ( V_39 < 0 )
return V_39 ;
V_39 = F_16 ( V_52 , & V_37 -> V_40 ) ;
if ( V_39 < 0 )
return V_39 ;
V_39 = F_17 ( V_32 -> V_2 , & V_35 -> V_53 , V_54 ) ;
if ( V_39 < 0 )
return V_39 ;
V_39 = F_18 ( V_32 -> V_2 , & V_35 -> V_55 , V_54 ) ;
if ( V_39 < 0 )
return V_39 ;
return 0 ;
}
...
struct V_60 * V_61 = F_21 ( V_35 , V_58 ) ;
struct V_36 * V_37 = F_8 ( V_35 , V_58 ) ;
...
V_39 = F_24 ( V_8 , V_57 , V_51 ,
V_6 , & V_61 -> V_68 ) ;
if ( V_39 < 0 )
goto V_67;
F_25 ( V_57 , L_12 , & V_37 -> V_46 ) ;
V_39 = F_26 ( V_52 , V_61 ,
V_69 , V_70 , & V_64 ) ;
if ( V_39 < 0 )
goto V_67;
V_39 = F_27 ( V_51 , V_61 , V_69 , V_70 ) ;
if ( V_39 < 0 )
goto V_67;
V_39 = F_28 ( V_63 , V_61 , V_69 , V_70 ) ;
if ( V_39 < 0 )
goto V_67;
V_39 = F_29 ( V_52 , V_40 ) ;
if ( V_39 < 0 )
...
if ( V_39 < 0 )
goto V_67;
V_39 = F_30 ( V_8 , V_52 , V_61 , V_40 ) ;
if ( V_39 < 0 )
goto V_67;
V_39 = F_31 ( V_8 , V_51 , V_61 , V_41 ) ;
if ( V_39 < 0 )
goto V_67;
V_39 = F_32 ( V_61 ) ;
if ( V_39 < 0 )
...
if ( ! V_57 )
return - V_65 ;
V_61 = F_22 ( V_57 , V_54 L_15 ) ;
V_39 = F_42 ( V_2 , V_54 ) ;
if ( V_39 < 0 )
goto V_86;
V_39 = F_43 ( V_2 , V_54 , 1 ) ;
if ( V_39 < 0 )
goto V_86;
F_25 ( V_57 , V_54 L_12 , & V_35 -> V_46 ) ;
if ( V_61 ) {
...
struct V_1 * V_2 ;
int V_38 , V_39 ;
if ( V_87 && F_22 ( V_87 , V_54 L_15 ) )
V_38 = F_48 ( V_87 ) ;
else
V_38 = 1 ;
V_35 = F_39 ( V_8 , sizeof( * V_35 ) , V_82 ) ;
if ( ! V_35 )
return - V_83 ;
V_37 = F_39 ( V_8 , sizeof( * V_37 ) * V_38 , V_82 ) ;
V_61 = F_39 ( V_8 , sizeof( * V_61 ) * V_38 , V_82 ) ;
if ( ! V_37 || ! V_61 )
return - V_83 ;
V_35 -> V_37 = V_37 ;
V_35 -> V_61 = V_61 ;
