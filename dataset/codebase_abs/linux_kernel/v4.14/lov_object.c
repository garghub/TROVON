...
T_4 V_151 ;
int V_93 ;
F_11 ( V_11 -> V_94 < F_97 ( V_152 ) ) ;
V_10 = F_98 ( & V_151 ) ;
if ( F_13 ( V_10 ) )
return F_49 ( V_10 ) ;
F_11 ( V_147 < F_97 ( V_152 ) ) ;
F_20 ( V_41 , V_42 L_23 ,
F_21 ( F_94 ( F_32 ( V_11 ) ) ) ,
...
struct V_7 * V_8 ,
struct V_199 * V_199 , T_7 * V_218 ,
struct V_219 * V_220 , int V_221 ,
struct V_222 * V_223 )
{
struct V_17 * V_224 ;
struct V_225 * V_11 = F_2 ( V_3 -> V_5 . V_6 ) -> V_86 ;
struct V_200 * V_226 = & V_223 -> V_227 -> V_211 [ 0 ] ;
T_6 V_228 ;
T_6 V_229 ;
T_6 V_213 ;
T_6 V_214 ;
...
int V_93 = 0 ;
V_223 -> V_233 = false ;
if ( ( F_125 ( V_8 , V_221 , V_223 -> V_234 , V_223 -> V_235 ,
& V_213 , & V_230 ) ) == 0 )
return 0 ;
if ( F_44 ( V_8 -> V_40 [ V_221 ] ) )
return - V_38 ;
if ( V_223 -> V_236 != 0 && V_221 == V_223 -> V_237 )
V_213 = V_223 -> V_236 ;
V_214 = V_223 -> V_238 ;
if ( V_214 != ~ 0ULL ) {
if ( V_223 -> V_234 + V_223 -> V_238 < V_223 -> V_234 )
V_223 -> V_238 = ~ 0ULL - V_223 -> V_234 ;
V_214 = F_130 ( V_8 , V_223 -> V_234 + V_223 -> V_238 ,
V_221 ) ;
}
if ( V_213 == V_214 )
return 0 ;
...
V_223 -> V_227 -> V_239 = 0 ;
V_229 = 0 ;
V_224 = F_52 ( V_10 , F_28 ( V_3 ) , V_8 , V_221 ) ;
if ( F_13 ( V_224 ) )
return F_49 ( V_224 ) ;
do {
if ( V_199 -> V_217 > 0 ) {
if ( V_223 -> V_240 + V_223 -> V_241 >
V_199 -> V_217 )
V_223 -> V_241 = V_199 -> V_217 -
V_223 -> V_240 ;
}
V_213 += V_229 ;
V_223 -> V_227 -> V_239 = V_228 - V_229 ;
V_228 = V_223 -> V_227 -> V_239 ;
V_223 -> V_227 -> V_217 = V_223 -> V_242 ?
1 : V_223 -> V_241 ;
V_223 -> V_227 -> V_243 = 0 ;
V_223 -> V_227 -> V_244 = V_199 -> V_244 ;
V_202 = V_8 -> V_40 [ V_221 ] -> V_47 ;
if ( V_202 < 0 || V_202 >= V_11 -> V_245 . V_246 ) {
V_93 = - V_96 ;
goto V_247;
}
if ( ! V_11 -> V_248 [ V_202 ] -> V_249 ) {
V_223 -> V_227 -> V_244 |= V_250 ;
V_223 -> V_227 -> V_243 = 1 ;
V_226 [ 0 ] . V_212 = V_213 ;
V_226 [ 0 ] . V_251 = V_230 - V_213 ;
V_226 [ 0 ] . V_208 |= V_252 ;
goto V_253;
}
V_223 -> V_227 -> V_190 = V_213 ;
V_223 -> V_227 -> V_244 &= ~ V_254 ;
memcpy ( & V_220 -> V_255 , V_223 -> V_227 , sizeof( * V_223 -> V_227 ) ) ;
* V_218 = F_127 ( V_223 -> V_227 -> V_217 ) ;
V_93 = F_131 ( V_10 , V_224 , V_220 , V_223 -> V_227 , V_218 ) ;
if ( V_93 )
goto V_247;
V_253:
V_203 = V_223 -> V_227 -> V_243 ;
if ( V_203 == 0 ) {
V_232 = true ;
V_223 -> V_233 = true ;
if ( V_221 == V_223 -> V_256 ) {
V_199 -> V_243 = 0 ;
V_223 -> V_257 = true ;
goto V_247;
}
...
if ( V_226 [ V_203 - 1 ] . V_208 & V_250 )
V_226 [ V_203 - 1 ] . V_208 &= ~ V_250 ;
if ( F_132 ( V_8 , V_226 [ V_203 - 1 ] . V_212 +
V_226 [ V_203 - 1 ] . V_251 ,
V_221 ) >= V_220 -> V_258 . V_259 ) {
V_231 = true ;
V_223 -> V_233 = true ;
}
F_126 ( V_199 , V_226 , V_202 ,
V_203 , V_223 -> V_240 ) ;
V_223 -> V_240 += V_203 ;
if ( V_223 -> V_240 >= V_199 -> V_217 )
V_223 -> V_242 = true ;
} while ( ! V_232 && ! V_231 );
if ( V_221 == V_223 -> V_256 )
V_223 -> V_257 = true ;
...
static int F_133 ( const struct V_9 * V_10 , struct V_17 * V_3 ,
struct V_219 * V_220 ,
struct V_199 * V_199 , T_7 * V_218 )
{
unsigned int V_260 = V_261 ;
struct V_199 * V_262 = NULL ;
struct V_7 * V_8 ;
int V_93 = 0 ;
int V_263 ;
int V_193 ;
...
if ( F_51 ( V_8 ) ) {
if ( V_199 -> V_190 < V_220 -> V_258 . V_259 ) {
V_199 -> V_243 = 1 ;
V_199 -> V_211 [ 0 ] . V_212 = V_199 -> V_190 ;
if ( V_199 -> V_190 + V_199 -> V_239 <
V_220 -> V_258 . V_259 )
V_199 -> V_211 [ 0 ] . V_251 =
V_199 -> V_239 ;
else
...
if ( F_127 ( V_199 -> V_217 ) < V_260 )
V_260 = F_127 ( V_199 -> V_217 ) ;
V_262 = F_42 ( V_260 , V_78 ) ;
if ( ! V_262 ) {
V_93 = - V_91 ;
goto V_84;
}
V_223 . V_227 = V_262 ;
V_223 . V_241 = F_135 ( V_260 ) ;
V_223 . V_234 = V_199 -> V_190 ;
if ( V_223 . V_234 > V_220 -> V_258 . V_259 ) {
V_93 = - V_96 ;
goto V_84;
}
V_223 . V_237 = F_136 ( V_8 , V_223 . V_234 ) ;
V_223 . V_235 = ( V_223 . V_238 == ~ 0ULL ) ? V_220 -> V_258 . V_259 :
V_223 . V_234 + V_223 . V_238 - 1 ;
if ( V_223 . V_235 > V_220 -> V_258 . V_259 ) {
V_223 . V_235 = V_220 -> V_258 . V_259 ;
V_223 . V_238 = V_223 . V_235 - V_223 . V_234 ;
}
V_223 . V_256 = F_124 ( V_8 , V_223 . V_234 , V_223 . V_235 ,
V_223 . V_237 ,
& V_193 ) ;
V_223 . V_236 = F_128 ( V_199 , V_8 , V_223 . V_234 ,
V_223 . V_235 ,
& V_223 . V_237 ) ;
if ( V_223 . V_236 == - V_96 ) {
V_93 = - V_96 ;
...
if ( F_127 ( V_199 -> V_217 ) > * V_218 )
V_199 -> V_217 = F_135 ( * V_218 ) ;
if ( ! V_199 -> V_217 )
V_223 . V_241 = 0 ;
V_223 . V_257 = false ;
V_223 . V_242 = false ;
V_223 . V_240 = 0 ;
for ( V_263 = V_223 . V_237 ; V_193 > 0 ;
-- V_193 ,
V_263 = ( V_263 + 1 ) % V_8 -> V_77 ) {
V_93 = F_129 ( V_10 , V_3 , V_8 , V_199 , V_218 , V_220 ,
V_263 , & V_223 ) ;
if ( V_93 < 0 )
goto V_84;
if ( V_223 . V_257 )
...
if ( ! V_199 -> V_217 )
goto V_266;
if ( ( V_263 == V_223 . V_256 ) && V_223 . V_233 )
V_199 -> V_211 [ V_223 . V_240 - 1 ] . V_208 |=
V_250 ;
V_266:
V_199 -> V_243 = V_223 . V_240 ;
V_84:
F_69 ( V_262 ) ;
F_3 ( V_8 ) ;
return V_93 ;
}
static int F_137 ( const struct V_9 * V_10 , struct V_17 * V_3 ,
struct V_267 T_8 * V_268 )
{
struct V_2 * V_11 = F_28 ( V_3 ) ;
struct V_7 * V_8 ;
int V_93 = 0 ;
...
if ( ! V_8 )
return - V_264 ;
V_93 = F_138 ( F_28 ( V_3 ) , V_8 , V_268 ) ;
F_3 ( V_8 ) ;
return V_93 ;
}
static int F_139 ( const struct V_9 * V_10 ,
struct V_17 * V_3 ,
struct V_269 * V_270 )
{
struct V_2 * V_11 = F_28 ( V_3 ) ;
struct V_7 * V_8 = F_134 ( V_11 ) ;
...
V_270 -> V_274 = F_140 ( V_8 -> V_77 , V_8 -> V_73 ) ;
V_270 -> V_275 = V_8 -> V_118 ;
V_93 = F_141 ( V_8 , V_272 -> V_164 , V_272 -> V_165 ) ;
F_3 ( V_8 ) ;
return V_93 < 0 ? V_93 : 0 ;
}
static T_10 F_142 ( struct V_17 * V_3 )
{
struct V_2 * V_11 = F_28 ( V_3 ) ;
struct V_7 * V_8 = F_134 ( V_11 ) ;
T_10 V_277 ;
...
struct V_21 * F_143 ( const struct V_9 * V_10 ,
const struct V_280 * V_145 ,
struct V_281 * V_14 )
{
struct V_2 * V_11 ;
struct V_21 * V_3 ;
V_11 = F_144 ( V_172 , V_78 ) ;
if ( V_11 ) {
V_3 = F_32 ( V_11 ) ;
F_145 ( V_3 , NULL , V_14 ) ;
V_11 -> V_4 . V_282 = & V_283 ;
V_11 -> V_94 = - 1 ;
V_3 -> V_284 = & V_285 ;
} else {
V_3 = NULL ;
...
struct V_7 * F_134 ( struct V_2 * V_11 )
{
struct V_7 * V_8 = NULL ;
F_86 ( V_11 ) ;
if ( V_11 -> V_39 ) {
...
int F_146 ( struct V_17 * V_286 )
{
struct V_21 * V_287 ;
int V_93 = 0 ;
V_287 = F_27 ( & V_30 ( V_286 ) -> V_44 ,
& V_58 ) ;
if ( V_287 ) {
struct V_2 * V_11 = F_72 ( V_287 ) ;
F_86 ( V_11 ) ;
switch ( V_11 -> V_94 ) {
case V_95 : {
struct V_7 * V_8 ;
...
V_8 = V_11 -> V_39 ;
for ( V_65 = 0 ; V_65 < V_8 -> V_77 ; V_65 ++ ) {
struct V_34 * V_288 = V_8 -> V_40 [ V_65 ] ;
if ( F_44 ( V_288 ) )
continue;
if ( V_288 -> V_289 . V_290 && ! V_93 )
V_93 = V_288 -> V_289 . V_290 ;
V_288 -> V_289 . V_290 = 0 ;
}
}
case V_98 :
