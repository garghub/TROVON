...
static struct V_206 * F_209 ( struct V_23 * V_24 )
{
struct V_13 * V_14 = F_35 ( V_24 ) ;
struct V_206 * V_207 ;
F_197 ( & V_259 ) ;
...
if ( V_207 ) {
V_14 -> V_26 = NULL ;
if ( F_210 ( & V_207 -> V_265 ) )
F_205 ( & V_207 -> V_264 ) ;
else
V_207 = NULL ;
if ( V_14 -> V_204 ) {
F_207 ( V_14 -> V_204 , V_270 ) ;
V_14 -> V_204 = NULL ;
}
}
F_208 ( & V_259 ) ;
...
case V_515 :
F_20 () ;
V_204 = F_21 ( V_14 -> V_204 ) ;
if ( V_204 ) {
V_508 . V_516 = F_345 ( & V_204 -> V_208 ) ;
V_508 . V_517 = F_345 ( & V_204 -> V_217 ) ;
V_508 . V_518 = F_345 ( & V_204 -> V_218 ) ;
V_81 = & V_508 ;
V_504 = sizeof( V_508 ) ;
}
F_24 () ;
