...
& V_68 ) ;
V_59 = F_29 ( V_2 -> V_63 , V_58 , F_30 ( V_58 ) ) ;
F_2 ( 1 , L_12 , V_59 ) ;
V_5 -> V_53 -> V_43 = F_31 ( V_59 , V_47 ) ;
if ( V_5 -> V_53 -> V_43 == NULL ) {
F_32 ( V_5 -> V_53 ) ;
return V_60 ;
}
F_2 ( 1 , L_13 , V_2 -> V_64 . V_65 -> V_66 . V_69 ) ;
F_33 ( V_5 -> V_53 , V_2 -> V_63 , V_58 ,
V_5 -> V_53 -> V_43 , V_59 ,
F_12 , V_2 ,
V_2 -> V_64 . V_65 -> V_66 . V_69 ) ;
V_5 -> V_40 = 1 ;
F_14 ( & V_5 -> V_41 , F_15 ( V_42 ) ) ;
return 0 ;
}
...
V_2 -> V_81 ) ;
F_42 ( V_2 -> V_63 , V_5 -> V_82 , sizeof( V_5 -> V_82 ) ) ;
F_43 ( V_5 -> V_82 , L_15 , sizeof( V_5 -> V_82 ) ) ;
V_10 = V_83 ;
F_25 ( V_34 , & V_10 ) ;
V_34 -> V_84 = V_5 -> V_81 ;
V_34 -> V_85 = V_5 -> V_82 ;
V_34 -> V_86 . V_87 = V_88 ;
V_34 -> V_86 . V_89 = 1 ;
V_34 -> V_86 . V_90 = F_44 ( V_2 -> V_63 -> V_91 . V_92 ) ;
V_34 -> V_86 . V_93 = F_44 ( V_2 -> V_63 -> V_91 . V_94 ) ;
V_34 -> V_95 = V_2 -> V_73 ;
V_34 -> V_96 = L_16 ;
V_34 -> V_2 . V_97 = & V_2 -> V_63 -> V_2 ;
V_60 = F_45 ( V_34 ) ;
if ( V_60 )
goto V_75;
return 0 ;
