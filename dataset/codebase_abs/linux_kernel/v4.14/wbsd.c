...
static void F_47 ( struct V_127 * V_34 , struct V_129 * V_130 )
{
struct V_1 * V_2 = F_43 ( V_34 ) ;
T_1 V_20 , V_12 , V_131 ;
F_44 ( & V_2 -> V_40 ) ;
...
if ( V_12 & V_17 ) {
V_12 &= ~ V_17 ;
F_48 ( & V_2 -> V_140 , V_141 + V_142 / 100 ) ;
}
}
F_8 ( V_2 , V_14 , V_12 ) ;
...
static int F_49 ( struct V_127 * V_34 )
{
struct V_1 * V_2 = F_43 ( V_34 ) ;
T_1 V_143 ;
F_44 ( & V_2 -> V_40 ) ;
...
static void F_51 ( unsigned long V_42 )
{
...
static inline struct V_41 * F_53 ( struct V_1 * V_2 )
{
F_40 ( ! V_2 -> V_36 ) ;
if ( ! V_2 -> V_36 )
return NULL ;
...
static void F_54 ( unsigned long V_147 )
{
...
F_19 ( & V_2 -> V_40 ) ;
if ( V_148 != - 1 )
F_55 ( V_2 -> V_34 , F_56 ( V_148 ) ) ;
}
static void F_57 ( unsigned long V_147 )
{
struct V_1 * V_2 = (struct V_1 * ) V_147 ;
struct V_41 * V_42 ;
F_21 ( & V_2 -> V_40 ) ;
...
static void F_60 ( unsigned long V_147 )
{
struct V_1 * V_2 = (struct V_1 * ) V_147 ;
struct V_41 * V_42 ;
F_21 ( & V_2 -> V_40 ) ;
...
static T_3 F_62 ( int V_151 , void * V_152 )
{
...
static int F_64 ( struct V_159 * V_160 )
{
struct V_127 * V_34 ;
struct V_1 * V_2 ;
V_34 = F_65 ( sizeof( struct V_1 ) , V_160 ) ;
if ( ! V_34 )
return - V_161 ;
V_2 = F_43 ( V_34 ) ;
V_2 -> V_34 = V_34 ;
...
int V_179 ;
for ( V_51 = 0 ; V_51 < F_74 ( V_180 ) ; V_51 ++ ) {
if ( ! F_75 ( V_180 [ V_51 ] , 2 , V_181 ) )
continue;
for ( V_177 = 0 ; V_177 < F_74 ( V_182 ) ; V_177 ++ ) {
V_179 = 0xFFFF ;
V_2 -> V_3 = V_180 [ V_51 ] ;
V_2 -> V_4 = V_182 [ V_177 ] ;
F_1 ( V_2 ) ;
...
F_4 ( V_2 ) ;
for ( V_178 = 0 ; V_178 < F_74 ( V_185 ) ; V_178 ++ ) {
...
static int F_77 ( struct V_1 * V_2 , int V_9 )
{
if ( V_9 & 0x7 )
return - V_111 ;
if ( ! F_75 ( V_9 , 8 , V_181 ) )
...
static void F_79 ( struct V_1 * V_2 , int V_38 )
{
if ( V_38 < 0 )
return;
if ( F_80 ( V_38 , V_181 ) )
...
if ( ! V_2 -> V_54 )
goto free;
V_2 -> V_116 = F_82 ( F_83 ( V_2 -> V_34 ) , V_2 -> V_54 ,
V_189 , V_194 ) ;
if ( F_84 ( F_83 ( V_2 -> V_34 ) , V_2 -> V_116 ) )
goto V_195;
...
F_89 ( & V_2 -> V_149 , F_61 ,
( unsigned long ) V_2 ) ;
V_197 = F_90 ( V_151 , F_62 , V_198 , V_181 , V_2 ) ;
if ( V_197 )
return V_197 ;
V_2 -> V_151 = V_151 ;
return 0 ;
...
static int F_99 ( struct V_159 * V_160 , int V_9 , int V_151 , int V_38 ,
int V_210 )
{
struct V_1 * V_2 = NULL ;
...
F_10 ( V_2 ) ;
F_101 ( V_34 ) ;
F_102 ( L_15 , F_13 ( V_34 ) ) ;
if ( V_2 -> V_186 != 0 )
F_103 ( L_16 , ( int ) V_2 -> V_186 ) ;
F_103 ( L_17 , ( int ) V_2 -> V_9 , ( int ) V_2 -> V_151 ) ;
if ( V_2 -> V_38 >= 0 )
F_103 ( L_18 , ( int ) V_2 -> V_38 ) ;
else
F_103 ( L_19 ) ;
if ( V_210 )
F_103 ( L_20 ) ;
...
static void F_104 ( struct V_159 * V_160 , int V_210 )
{
struct V_127 * V_34 = F_70 ( V_160 ) ;
struct V_1 * V_2 ;
if ( ! V_34 )
return;
V_2 = F_43 ( V_34 ) ;
...
static int F_106 ( struct V_212 * V_160 )
{
return F_99 ( & V_160 -> V_160 , V_213 , V_214 , V_215 , 0 ) ;
}
...
static int
F_108 ( struct V_216 * V_217 , const struct V_218 * V_152 )
{
...
V_38 = - 1 ;
F_59 ( L_22 , V_219 , V_151 , V_38 ) ;
return F_99 ( & V_217 -> V_160 , V_219 , V_151 , V_38 , 1 ) ;
}
static void F_113 ( struct V_216 * V_160 )
{
F_104 ( & V_160 -> V_160 , 1 ) ;
}
static int F_114 ( struct V_212 * V_160 ,
T_4 V_220 )
{
struct V_127 * V_34 = F_115 ( V_160 ) ;
struct V_1 * V_2 ;
if ( V_34 == NULL )
return 0 ;
F_59 ( L_23 ) ;
...
static int F_116 ( struct V_212 * V_160 )
{
struct V_127 * V_34 = F_115 ( V_160 ) ;
struct V_1 * V_2 ;
if ( V_34 == NULL )
...
static int F_117 ( struct V_216 * V_216 , T_4 V_220 )
{
struct V_127 * V_34 = F_70 ( & V_216 -> V_160 ) ;
if ( V_34 == NULL )
return 0 ;
F_59 ( L_23 ) ;
return 0 ;
}
static int F_118 ( struct V_216 * V_216 )
{
struct V_127 * V_34 = F_70 ( & V_216 -> V_160 ) ;
struct V_1 * V_2 ;
if ( V_34 == NULL )
