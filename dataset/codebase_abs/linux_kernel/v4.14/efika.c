...
if ( ! V_19 )
return;
V_28 = F_11 ( V_19 , L_14 , NULL ) ;
V_29 = F_11 ( V_19 , L_15 , NULL ) ;
V_30 = F_11 ( V_19 , L_16 , NULL ) ;
if ( V_29 )
F_15 ( V_27 , L_17 , V_29 ) ;
else
F_15 ( V_27 , L_18 ) ;
...
static void F_16 ( void T_3 * V_31 )
{
T_4 V_32 = 4 ;
T_4 V_33 = 1 ;
F_17 ( V_32 , V_33 ) ;
...
#endif
if ( V_36 . V_37 )
V_36 . V_37 ( L_21 V_38 L_22 , 0x0 ) ;
}
static int T_2 F_23 ( void )
{
const char * V_39 = F_11 ( V_40 , L_23 , NULL ) ;
if ( V_39 == NULL )
return 0 ;
if ( strcmp ( V_39 , L_24 ) )
return 0 ;
