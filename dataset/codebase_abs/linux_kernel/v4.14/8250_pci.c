...
struct V_10 * V_11 , int V_27 )
{
V_11 -> V_11 . V_29 |= V_182 ;
V_11 -> V_11 . V_183 = F_103 ;
V_11 -> V_11 . V_184 = F_100 ;
return F_99 ( V_9 , V_26 , V_11 , V_27 ) ;
}
static int F_105 ( struct V_2 * V_3 )
{
#if F_106 ( V_185 ) || F_106 ( V_186 )
return - V_42 ;
#else
return 0 ;
#endif
...
{
V_11 -> V_11 . V_29 |= V_153 ;
V_11 -> V_11 . type = V_188 ;
return F_53 ( V_9 , V_26 , V_11 , V_27 ) ;
}
static inline int F_110 ( T_1 V_189 , T_1 V_190 )
{
return V_189 == V_191 || V_189 == V_190 ;
}
static struct V_192 * F_111 ( struct V_2 * V_3 )
{
struct V_192 * V_193 ;
for ( V_193 = V_194 ; ; V_193 ++ )
if ( F_110 ( V_193 -> V_4 , V_3 -> V_4 ) &&
F_110 ( V_193 -> V_5 , V_3 -> V_5 ) &&
F_110 ( V_193 -> V_195 , V_3 -> V_6 ) &&
F_110 ( V_193 -> V_196 , V_3 -> V_7 ) )
break;
return V_193 ;
}
...
for ( V_201 = V_202 ;
V_201 < V_202 + F_42 ( V_202 ) ;
V_201 ++ ) {
if ( V_3 -> V_4 == V_201 -> V_4 &&
V_3 -> V_5 == V_201 -> V_5 )
return - V_42 ;
}
return 0 ;
...
static int
F_115 ( struct V_2 * V_3 , struct V_25 * V_26 )
{
int V_203 , V_204 , V_205 = - 1 , V_60 ;
V_203 = V_204 = 0 ;
...
static inline int
F_116 ( const struct V_25 * V_26 ,
const struct V_25 * V_206 )
{
return
V_26 -> V_79 == V_206 -> V_79 &&
V_26 -> V_207 == V_206 -> V_207 &&
V_26 -> V_30 == V_206 -> V_30 &&
V_26 -> V_31 == V_206 -> V_31 &&
V_26 -> V_28 == V_206 -> V_28 ;
}
struct V_8 *
F_117 ( struct V_2 * V_3 , const struct V_25 * V_26 )
{
struct V_10 V_208 ;
struct V_8 * V_9 ;
struct V_192 * V_193 ;
...
V_208 . V_11 . V_29 = V_213 | V_214 | V_215 ;
V_208 . V_11 . V_146 = V_26 -> V_207 * 16 ;
V_208 . V_11 . V_176 = F_112 ( V_3 , V_26 ) ;
V_208 . V_11 . V_3 = & V_3 -> V_3 ;
for ( V_60 = 0 ; V_60 < V_209 ; V_60 ++ ) {
if ( V_193 -> V_216 ( V_9 , V_26 , & V_208 , V_60 ) )
break;
F_16 ( & V_3 -> V_3 , L_23 ,
V_208 . V_11 . V_21 , V_208 . V_11 . V_176 , V_208 . V_11 . V_19 ) ;
V_9 -> line [ V_60 ] = F_120 ( & V_208 ) ;
if ( V_9 -> line [ V_60 ] < 0 ) {
F_2 ( & V_3 -> V_3 ,
L_24 ,
V_208 . V_11 . V_21 , V_208 . V_11 . V_176 ,
V_208 . V_11 . V_19 , V_9 -> line [ V_60 ] ) ;
break;
}
}
V_9 -> V_217 = V_60 ;
...
struct V_192 * V_193 ;
int V_60 ;
for ( V_60 = 0 ; V_60 < V_9 -> V_217 ; V_60 ++ )
F_122 ( V_9 -> line [ V_60 ] ) ;
V_193 = F_111 ( V_9 -> V_3 ) ;
if ( V_193 -> exit )
V_193 -> exit ( V_9 -> V_3 ) ;
...
F_126 ( V_9 -> line [ V_60 ] ) ;
if ( V_9 -> V_193 -> exit )
V_9 -> V_193 -> exit ( V_9 -> V_3 ) ;
}
void F_127 ( struct V_8 * V_9 )
{
int V_60 ;
if ( V_9 -> V_193 -> V_210 )
V_9 -> V_193 -> V_210 ( V_9 -> V_3 ) ;
for ( V_60 = 0 ; V_60 < V_9 -> V_217 ; V_60 ++ )
if ( V_9 -> line [ V_60 ] >= 0 )
F_128 ( V_9 -> line [ V_60 ] ) ;
}
static int
F_129 ( struct V_2 * V_3 , const struct V_200 * V_218 )
{
struct V_192 * V_193 ;
struct V_8 * V_9 ;
const struct V_25 * V_26 ;
...
V_193 = F_111 ( V_3 ) ;
if ( V_193 -> V_219 ) {
V_32 = V_193 -> V_219 ( V_3 ) ;
if ( V_32 )
return V_32 ;
}
if ( V_218 -> V_220 >= F_42 ( V_221 ) ) {
F_2 ( & V_3 -> V_3 , L_25 ,
V_218 -> V_220 ) ;
return - V_16 ;
}
V_26 = & V_221 [ V_218 -> V_220 ] ;
V_32 = F_113 ( V_3 ) ;
if ( V_32 )
return V_32 ;
V_32 = F_114 ( V_3 ) ;
...
if ( V_32 )
return V_32 ;
if ( V_218 -> V_220 == V_222 ) {
memcpy ( & V_145 , V_26 , sizeof( struct V_25 ) ) ;
V_26 = & V_145 ;
V_32 = F_115 ( V_3 , & V_145 ) ;
if ( V_32 )
return V_32 ;
} else {
memcpy ( & V_145 , & V_221 [ V_222 ] ,
sizeof( struct V_25 ) ) ;
V_32 = F_115 ( V_3 , & V_145 ) ;
if ( V_32 == 0 && F_116 ( V_26 , & V_145 ) )
F_1 ( L_26 ,
V_3 ) ;
}
V_9 = F_117 ( V_3 , V_26 ) ;
...
static T_6 F_141 ( struct V_2 * V_3 )
{
int V_32 ;
V_32 = F_138 ( V_3 ) ;
if ( V_32 )
