...
F_46 ( V_10 ) ;
F_47 ( V_2 ) ;
F_48 ( V_10 -> V_14 , V_2 -> V_91 ) ;
F_48 ( V_10 -> V_14 , V_2 -> V_87 ) ;
F_19 ( V_2 ) ;
}
...
int V_8 ;
* V_70 = NULL ;
V_103 = F_50 ( V_103 , V_107 ) ;
if ( V_103 == 0 )
return - V_108 ;
V_8 = F_51 ( V_10 , V_103 , 0 , 0 , & V_106 ) ;
if ( V_8 ) {
if ( V_8 != - V_109 )
F_28 ( L_24 ) ;
return V_8 ;
...
V_8 = F_49 ( V_10 , args -> V_103 , false ,
& V_113 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_53 ( V_111 , V_113 , & V_114 ) ;
F_23 ( V_113 ) ;
if ( V_8 )
return V_8 ;
args -> V_114 = V_114 ;
...
static void F_54 ( struct V_105 * * V_119 )
{
struct V_120 * V_121 ;
if ( ( * V_119 ) == NULL )
return;
...
void F_56 ( struct V_73 * V_70 )
{
struct V_105 * V_105 = F_57 ( V_70 ) ;
F_54 ( & V_105 ) ;
}
static inline T_5 F_58 ( struct V_105 * V_119 )
{
return F_59 ( & V_119 -> V_119 . V_122 ) ;
}
int
F_60 ( struct V_75 * V_111 ,
struct V_9 * V_10 ,
T_1 V_114 ,
T_6 * V_123 )
{
