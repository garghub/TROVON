...
int F_24 ( unsigned long V_12 , unsigned long V_28 ,
...
int F_27 ( unsigned long V_12 , unsigned long V_28 ,
unsigned V_18 )
{
unsigned long V_5 ;
struct V_1 * V_1 ;
...
F_28 ( unsigned long V_5 , unsigned long V_28 ,
bool V_2 )
{
struct V_1 * V_1 ;
while ( V_5 < V_28 ) {
...
int * * V_32 )
{
return F_34 ( V_1 , F_35 () , & V_33 [ V_34 ] ) ;
}
