...
F_142 ( V_23 , V_327 , sizeof( V_327 ) ) , V_327 ) ;
V_23 -> V_335 ++ ;
}
F_48 ( V_23 ) ;
}
...
V_430 = F_113 ( V_56 , V_431 ) ;
V_430 -> V_192 = V_192 ;
V_430 -> V_19 = V_19 ;
V_430 -> V_193 = F_18 ( V_428 ) ;
if ( V_428 ) {
V_389 -= V_249 + V_431 ;
F_217 ( V_56 , V_194 , V_389 ) ;
V_194 += V_389 ;
}
V_193 -= V_56 -> V_193 ;
V_390 = & F_190 ( V_56 ) -> V_393 ;
...
static inline int F_218 ( void * * V_434 , int * type , int * V_435 ,
unsigned long * V_436 )
{
...
static void F_219 ( void * * V_434 , T_1 type , T_1 V_193 , unsigned long V_436 , T_6 V_61 )
{
struct V_437 * V_438 = * V_434 ;
...
static void F_220 ( void * * V_434 , struct V_11 * V_23 , T_6 V_61 )
{
struct V_440 V_441 ;
switch ( V_23 -> V_147 ) {
case V_150 :
...
V_441 . V_444 = F_221 ( V_23 -> V_133 ) ;
V_441 . V_445 = F_221 ( V_136 ) ;
V_441 . V_104 = F_221 ( V_138 ) ;
break;
case V_154 :
V_441 . V_189 = 1 ;
V_441 . V_442 = V_130 ;
...
F_219 ( V_434 , V_446 , sizeof( V_441 ) ,
( unsigned long ) & V_441 , V_61 ) ;
}
static void F_222 ( struct V_71 * V_72 )
{
struct V_11 * V_23 = F_46 ( V_72 , struct V_11 ,
V_447 . V_72 ) ;
T_2 V_384 ;
...
static inline T_7 F_224 ( T_7 V_147 , T_5 V_451 )
{
switch ( V_147 ) {
case V_154 :
case V_150 :
...
static inline bool F_226 ( struct V_12 * V_13 )
{
return ( ( V_13 -> V_269 & V_270 ) &&
( V_13 -> V_315 & V_453 ) ) ;
}
static void F_227 ( struct V_11 * V_23 ,
struct V_454 * V_455 )
{
if ( V_23 -> V_448 != V_449 && V_23 -> V_206 ) {
T_10 V_456 = V_23 -> V_206 -> V_195 -> V_457 ;
V_456 = F_228 ( V_456 , 1000 ) ;
V_456 = 3 * V_456 + 500 ;
if ( V_456 > 0xffff )
V_456 = 0xffff ;
...
static inline void F_229 ( struct V_11 * V_23 )
{
if ( V_23 -> V_97 > V_98 &&
F_225 ( V_23 -> V_13 ) ) {
...
static int F_142 ( struct V_11 * V_23 , void * V_194 , T_6 V_459 )
{
struct V_460 * V_279 = V_194 ;
struct V_454 V_455 = { . V_147 = V_23 -> V_147 } ;
void * V_434 = V_279 -> V_194 ;
void * V_461 = V_194 + V_459 ;
T_2 V_61 ;
F_23 ( L_3 , V_23 ) ;
if ( V_23 -> V_335 || V_23 -> V_462 )
goto V_27;
switch ( V_23 -> V_147 ) {
case V_154 :
case V_150 :
...
break;
if ( F_226 ( V_23 -> V_13 ) )
F_57 ( V_463 , & V_23 -> V_109 ) ;
default:
V_23 -> V_147 = F_224 ( V_455 . V_147 , V_23 -> V_13 -> V_315 ) ;
break;
}
V_27:
if ( V_23 -> V_117 != V_38 )
F_219 ( & V_434 , V_464 , 2 , V_23 -> V_117 , V_461 - V_434 ) ;
switch ( V_23 -> V_147 ) {
case V_148 :
if ( V_318 )
break;
...
V_455 . V_51 = 0 ;
V_455 . V_467 = 0 ;
F_219 ( & V_434 , V_468 , sizeof( V_455 ) ,
( unsigned long ) & V_455 , V_461 - V_434 ) ;
break;
case V_150 :
V_455 . V_147 = V_150 ;
V_455 . V_466 = V_23 -> V_95 ;
F_227 ( V_23 , & V_455 ) ;
V_61 = F_66 ( T_2 , V_469 , V_23 -> V_13 -> V_164 -
V_250 - V_401 -
V_255 ) ;
V_455 . V_467 = F_18 ( V_61 ) ;
F_229 ( V_23 ) ;
V_455 . V_465 = F_66 ( T_2 , V_23 -> V_97 ,
V_98 ) ;
F_219 ( & V_434 , V_468 , sizeof( V_455 ) ,
( unsigned long ) & V_455 , V_461 - V_434 ) ;
if ( F_70 ( V_463 , & V_23 -> V_109 ) )
F_220 ( & V_434 , V_23 , V_461 - V_434 ) ;
if ( F_70 ( V_245 , & V_23 -> V_109 ) )
F_219 ( & V_434 , V_470 , 2 ,
V_23 -> V_97 , V_461 - V_434 ) ;
if ( V_23 -> V_13 -> V_315 & V_471 )
if ( V_23 -> V_93 == V_472 ||
F_70 ( V_473 , & V_23 -> V_92 ) ) {
V_23 -> V_93 = V_472 ;
F_219 ( & V_434 , V_474 , 1 ,
V_23 -> V_93 , V_461 - V_434 ) ;
}
break;
case V_154 :
F_229 ( V_23 ) ;
...
static int F_230 ( struct V_11 * V_23 , void * V_194 , T_6 V_459 )
{
struct V_475 * V_158 = V_194 ;
void * V_434 = V_158 -> V_194 ;
void * V_461 = V_194 + V_459 ;
void * V_279 = V_23 -> V_476 ;
int V_193 = V_23 -> V_477 ;
int type , V_478 , V_435 ;
unsigned long V_436 ;
...
F_23 ( L_3 , V_23 ) ;
while ( V_193 >= V_439 ) {
V_193 -= F_218 ( & V_279 , & type , & V_435 , & V_436 ) ;
V_478 = type & V_481 ;
type &= V_482 ;
switch ( type ) {
case V_464 :
...
if ( V_23 -> V_462 || V_23 -> V_335 > 1 )
goto V_27;
switch ( V_23 -> V_147 ) {
case V_154 :
case V_150 :
if ( ! F_70 ( V_325 , & V_23 -> V_92 ) ) {
V_23 -> V_147 = F_224 ( V_455 . V_147 ,
V_23 -> V_13 -> V_315 ) ;
break;
}
if ( V_479 ) {
...
F_219 ( & V_434 , V_464 , 2 , V_23 -> V_37 , V_461 - V_434 ) ;
if ( V_479 ) {
if ( V_23 -> V_129 != V_490 &&
V_441 . V_442 != V_490 &&
V_441 . V_442 != V_23 -> V_129 ) {
...
F_219 ( & V_434 , V_446 ,
sizeof( V_441 ) ,
( unsigned long ) & V_441 , V_461 - V_434 ) ;
} else {
V_159 = V_491 ;
...
V_23 -> V_101 = V_455 . V_465 ;
else
V_455 . V_465 = V_98 ;
V_23 -> V_100 = V_455 . V_466 ;
V_61 = F_66 ( T_2 , F_231 ( V_455 . V_467 ) ,
...
F_57 ( V_493 , & V_23 -> V_92 ) ;
F_219 ( & V_434 , V_468 ,
sizeof( V_455 ) , ( unsigned long ) & V_455 , V_461 - V_434 ) ;
if ( F_70 ( V_463 , & V_23 -> V_109 ) ) {
V_23 -> V_494 = V_441 . V_189 ;
V_23 -> V_495 = V_441 . V_442 ;
V_23 -> V_496 = F_231 ( V_441 . V_443 ) ;
V_23 -> V_497 =
F_232 ( V_441 . V_104 ) ;
V_23 -> V_498 =
F_232 ( V_441 . V_445 ) ;
...
static int F_233 ( struct V_11 * V_23 , void * V_158 , int V_193 ,
void * V_194 , T_6 V_61 , T_2 * V_159 )
{
struct V_460 * V_279 = V_194 ;
void * V_434 = V_279 -> V_194 ;
void * V_461 = V_194 + V_61 ;
int type , V_435 ;
unsigned long V_436 ;
struct V_454 V_455 = { . V_147 = V_148 } ;
struct V_440 V_441 ;
...
while ( V_193 >= V_439 ) {
V_193 -= F_218 ( & V_158 , & type , & V_435 , & V_436 ) ;
switch ( type ) {
case V_464 :
if ( V_436 < V_488 ) {
* V_159 = V_487 ;
...
if ( * V_159 == V_480 || * V_159 == V_491 ) {
switch ( V_455 . V_147 ) {
case V_150 :
V_23 -> V_49 = F_231 ( V_455 . V_49 ) ;
V_23 -> V_51 = F_231 ( V_455 . V_51 ) ;
V_23 -> V_116 = F_231 ( V_455 . V_467 ) ;
if ( ! F_70 ( V_245 , & V_23 -> V_109 ) )
V_23 -> V_102 = F_66 ( T_2 , V_23 -> V_102 ,
V_455 . V_465 ) ;
if ( F_70 ( V_463 , & V_23 -> V_109 ) ) {
V_23 -> V_131 = F_231 ( V_441 . V_443 ) ;
V_23 -> V_133 =
F_232 ( V_441 . V_444 ) ;
V_23 -> V_135 = F_232 ( V_441 . V_445 ) ;
V_23 -> V_137 =
F_232 ( V_441 . V_104 ) ;
}
break;
...
static int F_234 ( struct V_11 * V_23 , void * V_194 ,
T_2 V_159 , T_2 V_109 )
{
struct V_475 * V_158 = V_194 ;
void * V_434 = V_158 -> V_194 ;
...
V_501 = V_171 ;
F_23 ( L_42 , V_23 , V_501 ) ;
F_83 ( V_13 , V_23 -> V_19 , V_501 , sizeof( V_158 ) , & V_158 ) ;
...
static void F_237 ( struct V_11 * V_23 , void * V_158 , int V_193 )
{
int type , V_435 ;
unsigned long V_436 ;
T_2 V_503 = V_23 -> V_102 ;
struct V_454 V_455 = {
. V_147 = V_23 -> V_147 ,
. V_49 = F_18 ( V_106 ) ,
. V_51 = F_18 ( V_107 ) ,
. V_467 = F_18 ( V_23 -> V_117 ) ,
. V_465 = F_66 ( T_2 , V_23 -> V_102 , V_98 ) ,
} ;
...
V_23 -> V_116 = F_231 ( V_455 . V_467 ) ;
if ( F_70 ( V_245 , & V_23 -> V_109 ) )
V_23 -> V_102 = F_66 ( T_2 , V_23 -> V_102 , V_503 ) ;
else
V_23 -> V_102 = F_66 ( T_2 , V_23 -> V_102 ,
V_455 . V_465 ) ;
break;
...
static inline int F_238 ( struct V_12 * V_13 ,
struct V_429 * V_430 , T_2 V_504 ,
T_1 * V_194 )
{
struct V_505 * V_506 = (struct V_505 * ) V_194 ;
...
static struct V_11 * F_240 ( struct V_12 * V_13 ,
struct V_429 * V_430 ,
T_1 * V_194 , T_1 V_501 , T_1 V_281 )
{
...
V_509 = F_165 ( V_172 , V_20 , & V_13 -> V_8 -> V_21 ,
...
F_83 ( V_13 , V_430 -> V_19 , V_501 , sizeof( V_158 ) , & V_158 ) ;
if ( V_159 == V_328 && V_169 == V_170 ) {
struct V_306 V_516 ;
V_516 . type = F_18 ( V_309 ) ;
V_13 -> V_307 |= V_308 ;
V_13 -> V_310 = F_91 ( V_13 ) ;
F_137 ( & V_13 -> V_311 , V_312 ) ;
F_83 ( V_13 , V_13 -> V_310 , V_313 ,
...
struct V_429 * V_430 , T_2 V_504 , T_1 * V_194 )
{
struct V_267 * V_195 = V_13 -> V_8 -> V_195 ;
struct V_7 * V_8 = V_13 -> V_8 ;
if ( V_504 < sizeof( struct V_278 ) )
return - V_507 ;
F_149 ( V_195 ) ;
if ( F_243 ( V_195 , V_517 ) &&
! F_132 ( V_518 , & V_8 -> V_109 ) )
F_244 ( V_195 , V_8 , 0 , NULL , 0 ) ;
F_151 ( V_195 ) ;
F_240 ( V_13 , V_430 , V_194 , V_171 , 0 ) ;
return 0 ;
}
...
break;
F_83 ( V_13 , F_91 ( V_13 ) , V_334 ,
F_142 ( V_23 , V_279 , sizeof( V_279 ) ) , V_279 ) ;
V_23 -> V_335 ++ ;
break;
case V_328 :
F_57 ( V_266 , & V_23 -> V_92 ) ;
...
static inline void F_246 ( struct V_11 * V_23 )
{
if ( V_23 -> V_147 != V_150 && V_23 -> V_147 != V_154 )
V_23 -> V_93 = V_472 ;
...
static void F_247 ( struct V_11 * V_23 , void * V_194 ,
T_1 V_19 , T_2 V_109 )
{
struct V_12 * V_13 = V_23 -> V_13 ;
...
static void F_248 ( struct V_12 * V_13 , T_1 V_19 ,
T_2 V_17 , T_2 V_16 )
{
struct V_522 V_506 ;
V_506 . V_74 = F_18 ( V_523 ) ;
V_506 . V_17 = F_249 ( V_17 ) ;
V_506 . V_16 = F_249 ( V_16 ) ;
...
V_23 = F_7 ( V_13 , V_16 ) ;
if ( ! V_23 ) {
F_248 ( V_13 , V_430 -> V_19 , V_16 , 0 ) ;
return 0 ;
}
if ( V_23 -> V_45 != V_76 && V_23 -> V_45 != V_174 ) {
F_248 ( V_13 , V_430 -> V_19 , V_23 -> V_17 ,
V_23 -> V_16 ) ;
goto V_520;
}
V_193 = V_504 - sizeof( * V_279 ) ;
if ( V_23 -> V_477 + V_193 > sizeof( V_23 -> V_476 ) ) {
F_83 ( V_13 , V_430 -> V_19 , V_521 ,
F_234 ( V_23 , V_158 ,
V_525 , V_109 ) , V_158 ) ;
goto V_520;
}
memcpy ( V_23 -> V_476 + V_23 -> V_477 , V_279 -> V_194 , V_193 ) ;
V_23 -> V_477 += V_193 ;
if ( V_109 & V_526 ) {
F_83 ( V_13 , V_430 -> V_19 , V_521 ,
F_234 ( V_23 , V_158 ,
...
V_193 = F_230 ( V_23 , V_158 , sizeof( V_158 ) ) ;
if ( V_193 < 0 ) {
F_86 ( V_23 , V_326 ) ;
goto V_520;
}
V_23 -> V_19 = V_430 -> V_19 ;
F_83 ( V_13 , V_430 -> V_19 , V_521 , V_193 , V_158 ) ;
V_23 -> V_462 ++ ;
V_23 -> V_477 = 0 ;
...
if ( ! V_23 -> V_206 )
F_247 ( V_23 , V_158 , V_430 -> V_19 , V_109 ) ;
else
V_23 -> V_19 = V_430 -> V_19 ;
}
V_520:
...
T_1 * V_194 )
{
struct V_475 * V_158 = (struct V_475 * ) V_194 ;
T_2 V_17 , V_109 , V_159 ;
struct V_11 * V_23 ;
int V_193 = V_504 - sizeof( * V_158 ) ;
int V_24 = 0 ;
if ( V_504 < sizeof( * V_158 ) )
return - V_507 ;
V_17 = F_69 ( V_158 -> V_17 ) ;
...
char V_327 [ 64 ] ;
V_193 = F_233 ( V_23 , V_158 -> V_194 , V_193 ,
V_327 , sizeof( V_327 ) , & V_159 ) ;
if ( V_193 < 0 ) {
F_86 ( V_23 , V_326 ) ;
goto V_27;
}
if ( ! V_23 -> V_206 ) {
F_247 ( V_23 , V_327 , V_430 -> V_19 ,
0 ) ;
} else {
if ( F_124 ( V_23 ) ) {
F_252 ( V_23 ) ;
...
if ( ! V_23 ) {
F_10 ( & V_13 -> V_18 ) ;
F_248 ( V_13 , V_430 -> V_19 , V_16 , V_17 ) ;
return 0 ;
}
F_9 ( V_23 ) ;
V_158 . V_16 = F_18 ( V_23 -> V_17 ) ;
V_158 . V_17 = F_18 ( V_23 -> V_16 ) ;
F_83 ( V_13 , V_430 -> V_19 , V_532 , sizeof( V_158 ) , & V_158 ) ;
...
T_1 * V_194 )
{
struct V_531 * V_158 = (struct V_531 * ) V_194 ;
T_2 V_16 , V_17 ;
struct V_11 * V_23 ;
if ( V_504 != sizeof( * V_158 ) )
return - V_507 ;
...
T_1 V_327 [ 8 ] ;
T_8 V_315 = V_317 ;
struct V_534 * V_158 = (struct V_534 * ) V_327 ;
V_158 -> type = F_18 ( V_309 ) ;
V_158 -> V_159 = F_18 ( V_535 ) ;
if ( ! V_318 )
V_315 |= V_319 | V_320
| V_471 ;
if ( V_13 -> V_269 & V_270 )
...
F_83 ( V_13 , V_430 -> V_19 , V_536 , sizeof( V_327 ) ,
V_327 ) ;
} else if ( type == V_537 ) {
T_1 V_327 [ 12 ] ;
struct V_534 * V_158 = (struct V_534 * ) V_327 ;
V_158 -> type = F_18 ( V_537 ) ;
V_158 -> V_159 = F_18 ( V_535 ) ;
...
V_158 . V_159 = F_18 ( V_538 ) ;
F_83 ( V_13 , V_430 -> V_19 , V_536 , sizeof( V_158 ) ,
& V_158 ) ;
}
return 0 ;
}
static inline int F_256 ( struct V_12 * V_13 ,
struct V_429 * V_430 , T_2 V_504 ,
T_1 * V_194 )
{
struct V_534 * V_158 = (struct V_534 * ) V_194 ;
T_2 type , V_159 ;
if ( V_504 < sizeof( * V_158 ) )
return - V_507 ;
...
if ( ! ( V_13 -> V_269 & V_270 ) )
return - V_36 ;
V_20 = F_231 ( V_279 -> V_20 ) ;
V_17 = F_231 ( V_279 -> V_17 ) ;
F_23 ( L_53 , V_20 , V_17 , V_279 -> V_281 ) ;
if ( V_279 -> V_281 == V_449 ) {
F_240 ( V_13 , V_430 , V_194 , V_502 ,
V_279 -> V_281 ) ;
return 0 ;
}
V_195 = F_258 ( V_279 -> V_281 ) ;
if ( ! V_195 )
goto error;
if ( V_195 -> V_541 != V_542 || ! F_70 ( V_275 , & V_195 -> V_109 ) ) {
F_259 ( V_195 ) ;
goto error;
}
V_23 = F_240 ( V_13 , V_430 , V_194 , V_502 ,
V_279 -> V_281 ) ;
if ( V_23 ) {
struct V_142 * V_143 = V_13 -> V_8 -> V_142 ;
struct V_7 * V_206 ;
V_206 = F_260 ( V_195 , V_543 ,
& V_13 -> V_8 -> V_156 ) ;
if ( ! V_206 ) {
F_259 ( V_195 ) ;
F_248 ( V_13 , V_430 -> V_19 , V_23 -> V_17 ,
...
V_158 . V_16 = 0 ;
V_158 . V_17 = F_18 ( V_17 ) ;
V_158 . V_159 = F_18 ( V_545 ) ;
V_158 . V_169 = F_18 ( V_170 ) ;
F_83 ( V_13 , V_430 -> V_19 , V_502 ,
sizeof( V_158 ) , & V_158 ) ;
return 0 ;
}
static void F_261 ( struct V_11 * V_23 , T_1 V_546 )
{
struct V_547 V_279 ;
T_1 V_19 ;
F_23 ( L_55 , V_23 , V_546 ) ;
V_19 = F_91 ( V_23 -> V_13 ) ;
V_23 -> V_19 = V_19 ;
V_279 . V_548 = F_18 ( V_23 -> V_17 ) ;
V_279 . V_546 = V_546 ;
F_83 ( V_23 -> V_13 , V_19 , V_549 , sizeof( V_279 ) ,
& V_279 ) ;
F_85 ( V_23 , V_550 ) ;
}
...
V_158 . V_548 = F_18 ( V_23 -> V_16 ) ;
V_158 . V_159 = F_18 ( V_159 ) ;
F_83 ( V_23 -> V_13 , V_23 -> V_19 , V_552 ,
sizeof( V_158 ) , & V_158 ) ;
}
static void F_263 ( struct V_11 * V_23 , T_2 V_159 )
{
struct V_553 V_554 ;
F_23 ( L_56 , V_23 , V_159 ) ;
V_23 -> V_19 = F_91 ( V_23 -> V_13 ) ;
V_554 . V_548 = F_18 ( V_23 -> V_17 ) ;
V_554 . V_159 = F_18 ( V_159 ) ;
F_83 ( V_23 -> V_13 , V_23 -> V_19 , V_555 ,
sizeof( V_554 ) , & V_554 ) ;
F_85 ( V_23 , V_550 ) ;
}
static void F_264 ( struct V_12 * V_13 , T_2 V_548 )
{
struct V_553 V_554 ;
F_23 ( L_57 , V_13 , V_548 ) ;
V_554 . V_548 = F_18 ( V_548 ) ;
V_554 . V_159 = F_18 ( V_556 ) ;
F_83 ( V_13 , F_91 ( V_13 ) , V_555 ,
sizeof( V_554 ) , & V_554 ) ;
}
static void F_265 ( struct V_12 * V_13 , T_1 V_19 ,
T_2 V_548 )
{
struct V_557 V_158 ;
F_23 ( L_58 , V_548 ) ;
V_158 . V_548 = F_18 ( V_548 ) ;
F_83 ( V_13 , V_19 , V_558 , sizeof( V_158 ) , & V_158 ) ;
}
...
static void F_269 ( struct V_11 * V_23 ,
struct V_146 * V_202 )
{
...
void F_270 ( struct V_11 * V_23 , struct V_146 * V_202 ,
T_1 V_169 )
{
...
static void F_273 ( struct V_11 * V_23 , T_1 V_448 ,
T_1 V_568 )
{
F_127 ( V_23 ) ;
V_23 -> V_450 = V_448 ;
...
static void F_275 ( struct V_11 * V_23 , int V_159 )
{
if ( V_23 -> V_294 == V_299 ) {
T_1 V_571 ;
if ( V_159 == - V_36 )
...
void F_276 ( struct V_11 * V_23 , int V_159 )
{
T_1 V_448 = V_23 -> V_448 ;
T_1 V_568 = V_23 -> V_568 ;
F_23 ( L_62 ,
V_23 , V_159 , V_448 , V_568 ) ;
if ( V_23 -> V_45 == V_163 || V_23 -> V_45 == V_573 ) {
F_48 ( V_23 ) ;
return;
}
if ( V_23 -> V_45 != V_75 ) {
F_272 ( V_23 , V_159 , V_448 , V_568 ) ;
} else if ( V_159 != V_567 ) {
F_275 ( V_23 , V_159 ) ;
} else {
switch ( V_23 -> V_294 ) {
...
static inline int F_277 ( struct V_12 * V_13 ,
struct V_429 * V_430 ,
T_2 V_504 , void * V_194 )
{
struct V_547 * V_279 = V_194 ;
struct V_551 V_158 ;
struct V_11 * V_23 ;
T_2 V_548 = 0 ;
T_2 V_159 = V_570 ;
if ( V_504 != sizeof( * V_279 ) )
return - V_507 ;
V_548 = F_231 ( V_279 -> V_548 ) ;
F_23 ( L_63 , V_548 , V_279 -> V_546 ) ;
if ( ! ( V_13 -> V_269 & V_270 ) )
return - V_36 ;
V_23 = F_11 ( V_13 , V_548 ) ;
if ( ! V_23 ) {
V_158 . V_548 = F_18 ( V_548 ) ;
V_158 . V_159 = F_18 ( V_570 ) ;
F_83 ( V_13 , V_430 -> V_19 , V_552 ,
sizeof( V_158 ) , & V_158 ) ;
return 0 ;
}
V_23 -> V_19 = V_430 -> V_19 ;
...
if ( V_23 -> V_448 == V_279 -> V_546 ) {
V_159 = V_576 ;
goto V_575;
}
if ( V_279 -> V_546 != V_449 ) {
struct V_267 * V_195 ;
V_195 = F_258 ( V_279 -> V_546 ) ;
if ( ! V_195 || V_195 -> V_541 != V_542 ||
! F_70 ( V_275 , & V_195 -> V_109 ) ) {
if ( V_195 )
F_259 ( V_195 ) ;
V_159 = V_572 ;
...
static void F_278 ( struct V_12 * V_13 , T_2 V_548 , T_2 V_159 )
{
struct V_11 * V_23 ;
struct V_146 * V_202 = NULL ;
V_23 = F_7 ( V_13 , V_548 ) ;
...
static void F_279 ( struct V_12 * V_13 , T_1 V_19 , T_2 V_548 ,
T_2 V_159 )
{
struct V_11 * V_23 ;
V_23 = F_13 ( V_13 , V_19 ) ;
...
T_2 V_504 , void * V_194 )
{
struct V_551 * V_158 = V_194 ;
T_2 V_548 , V_159 ;
if ( V_504 != sizeof( * V_158 ) )
return - V_507 ;
V_548 = F_231 ( V_158 -> V_548 ) ;
V_159 = F_231 ( V_158 -> V_159 ) ;
F_23 ( L_64 , V_548 , V_159 ) ;
if ( V_159 == V_567 || V_159 == V_578 )
F_278 ( V_13 , V_548 , V_159 ) ;
else
F_279 ( V_13 , V_430 -> V_19 , V_548 , V_159 ) ;
return 0 ;
}
static int F_281 ( struct V_12 * V_13 ,
struct V_429 * V_430 ,
T_2 V_504 , void * V_194 )
{
struct V_553 * V_554 = V_194 ;
struct V_11 * V_23 ;
T_2 V_548 , V_159 ;
if ( V_504 != sizeof( * V_554 ) )
return - V_507 ;
V_548 = F_231 ( V_554 -> V_548 ) ;
V_159 = F_231 ( V_554 -> V_159 ) ;
F_23 ( L_64 , V_548 , V_159 ) ;
V_23 = F_11 ( V_13 , V_548 ) ;
if ( ! V_23 ) {
F_265 ( V_13 , V_430 -> V_19 , V_548 ) ;
return 0 ;
}
if ( V_23 -> V_203 == V_566 ) {
if ( V_159 == V_565 ) {
...
static inline int F_282 ( struct V_12 * V_13 ,
struct V_429 * V_430 ,
T_2 V_504 , void * V_194 )
{
struct V_557 * V_158 = V_194 ;
struct V_11 * V_23 ;
T_2 V_548 ;
if ( V_504 != sizeof( * V_158 ) )
return - V_507 ;
...
V_24 = F_283 ( V_345 , V_346 , V_347 , V_349 ) ;
if ( V_24 )
V_158 . V_159 = F_18 ( V_582 ) ;
else
V_158 . V_159 = F_18 ( V_583 ) ;
F_83 ( V_13 , V_430 -> V_19 , V_584 ,
sizeof( V_158 ) , & V_158 ) ;
if ( ! V_24 ) {
T_1 V_585 ;
V_585 = F_284 ( V_8 , V_345 , V_346 , V_347 ,
V_349 ) ;
F_285 ( V_8 -> V_195 , & V_8 -> V_156 , V_8 -> V_10 ,
V_585 , V_345 , V_346 , V_347 ,
V_349 ) ;
}
return 0 ;
}
...
switch ( V_430 -> V_192 ) {
case V_524 :
F_238 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_280 :
V_24 = F_242 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_171 :
case V_502 :
F_245 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_334 :
V_24 = F_250 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_521 :
F_251 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_323 :
V_24 = F_253 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_532 :
F_254 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_588 :
F_83 ( V_13 , V_430 -> V_19 , V_589 , V_504 , V_194 ) ;
break;
case V_589 :
break;
case V_313 :
V_24 = F_255 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_536 :
F_256 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_283 :
V_24 = F_257 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_549 :
V_24 = F_277 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_552 :
F_280 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_555 :
V_24 = F_281 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_558 :
F_282 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
default:
F_288 ( L_67 , V_430 -> V_192 ) ;
V_24 = - V_36 ;
break;
}
return V_24 ;
}
static int F_289 ( struct V_12 * V_13 ,
struct V_429 * V_430 , T_2 V_504 ,
T_1 * V_194 )
{
...
struct F_291 * V_594 ;
struct V_11 * V_23 ;
T_2 V_14 , V_165 , V_595 ;
if ( V_504 != sizeof( * V_594 ) )
return - V_507 ;
V_594 = (struct F_291 * ) V_194 ;
V_14 = F_69 ( V_594 -> V_14 ) ;
V_165 = F_69 ( V_594 -> V_165 ) ;
F_23 ( L_69 , V_14 , V_165 ) ;
V_23 = F_11 ( V_13 , V_14 ) ;
if ( ! V_23 )
return - V_519 ;
V_595 = V_596 - V_23 -> V_113 ;
if ( V_165 > V_595 ) {
F_288 ( L_70 ) ;
F_86 ( V_23 , V_326 ) ;
F_48 ( V_23 ) ;
...
static inline int F_293 ( struct V_12 * V_13 ,
struct V_429 * V_430 , T_2 V_504 ,
T_1 * V_194 )
{
int V_24 = 0 ;
switch ( V_430 -> V_192 ) {
case V_524 :
F_292 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_351 :
V_24 = V_344 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_584 :
break;
case V_166 :
F_286 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_305 :
V_24 = F_289 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_598 :
V_24 = F_291 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
case V_323 :
V_24 = F_253 ( V_13 , V_430 , V_504 , V_194 ) ;
break;
...
F_102 ( V_56 , V_431 ) ;
V_193 = F_231 ( V_430 -> V_193 ) ;
F_23 ( L_72 , V_430 -> V_192 , V_193 , V_430 -> V_19 ) ;
if ( V_193 != V_56 -> V_193 || ! V_430 -> V_19 ) {
F_23 ( L_73 ) ;
goto V_599;
}
V_24 = F_293 ( V_13 , V_430 , V_193 , V_56 -> V_194 ) ;
if ( V_24 ) {
struct V_505 V_506 ;
F_288 ( L_74 , V_24 ) ;
V_506 . V_74 = F_18 ( V_508 ) ;
F_83 ( V_13 , V_430 -> V_19 , V_524 ,
sizeof( V_506 ) , & V_506 ) ;
}
V_599:
F_97 ( V_56 ) ;
}
static inline void F_295 ( struct V_12 * V_13 ,
struct V_52 * V_56 )
{
struct V_7 * V_8 = V_13 -> V_8 ;
...
V_194 += V_431 ;
V_193 -= V_431 ;
V_504 = F_231 ( V_430 . V_193 ) ;
F_23 ( L_72 , V_430 . V_192 , V_504 ,
V_430 . V_19 ) ;
if ( V_504 > V_193 || ! V_430 . V_19 ) {
F_23 ( L_73 ) ;
break;
}
V_24 = F_287 ( V_13 , & V_430 , V_504 , V_194 ) ;
if ( V_24 ) {
struct V_505 V_506 ;
F_288 ( L_74 , V_24 ) ;
V_506 . V_74 = F_18 ( V_508 ) ;
...
static int F_296 ( struct V_11 * V_23 , struct V_52 * V_56 )
{
T_2 V_600 , V_601 ;
int V_602 ;
if ( F_70 ( V_245 , & V_23 -> V_109 ) )
...
V_602 = V_251 ;
if ( V_23 -> V_93 == V_94 ) {
F_297 ( V_56 , V_56 -> V_193 - V_255 ) ;
V_601 = F_103 ( V_56 -> V_194 + V_56 -> V_193 ) ;
V_600 = F_114 ( 0 , V_56 -> V_194 - V_602 , V_56 -> V_193 + V_602 ) ;
if ( V_600 != V_601 )
return - V_603 ;
}
return 0 ;
}
static void F_298 ( struct V_11 * V_23 )
{
struct V_210 V_211 ;
F_23 ( L_3 , V_23 ) ;
memset ( & V_211 , 0 , sizeof( V_211 ) ) ;
...
static void F_299 ( struct V_52 * V_56 , struct V_52 * V_604 ,
struct V_52 * * V_605 )
{
if ( ! F_300 ( V_56 ) )
F_190 ( V_56 ) -> V_393 = V_604 ;
V_604 -> V_398 = NULL ;
( * V_605 ) -> V_398 = V_604 ;
* V_605 = V_604 ;
V_56 -> V_193 += V_604 -> V_193 ;
V_56 -> V_397 += V_604 -> V_193 ;
V_56 -> V_606 += V_604 -> V_606 ;
}
static int F_301 ( struct V_11 * V_23 , struct V_52 * V_56 ,
struct V_210 * V_211 )
{
int V_24 = - V_36 ;
switch ( V_211 -> V_226 ) {
...
void F_304 ( struct V_11 * V_23 , int V_607 )
{
T_1 V_417 ;
if ( V_23 -> V_147 != V_150 )
return;
V_417 = V_607 ? V_418 : V_420 ;
...
V_24 = F_301 ( V_23 , V_56 , & F_35 ( V_56 ) -> V_57 ) ;
if ( V_24 )
break;
}
if ( F_170 ( & V_23 -> V_151 ) ) {
...
V_23 -> V_608 = V_211 -> V_212 ;
}
} else {
F_215 ( V_23 , V_211 ) ;
if ( V_211 -> V_215 ) {
if ( V_23 -> V_608 != V_211 -> V_212 ||
! F_116 ( V_288 ,
& V_23 -> V_258 ) )
F_182 ( V_23 , V_211 ) ;
} else {
...
static void F_307 ( struct V_11 * V_23 ,
struct V_210 * V_211 )
{
struct V_52 * V_56 ;
F_23 ( L_10 , V_23 , V_211 ) ;
...
static T_1 F_308 ( struct V_11 * V_23 , T_2 V_58 )
{
F_23 ( L_78 , V_23 , V_58 ) ;
...
V_23 -> V_291 = V_386 ;
if ( V_23 -> V_206 )
V_23 -> V_13 -> V_164 = V_23 -> V_206 -> V_195 -> V_544 ;
else
V_23 -> V_13 -> V_164 = V_23 -> V_13 -> V_8 -> V_195 -> V_624 ;
return F_303 ( V_23 ) ;
}
...
if ( V_417 == V_618 )
return - V_507 ;
return F_309 ( V_23 , V_211 , NULL , V_417 ) ;
}
static int F_314 ( struct V_11 * V_23 ,
struct V_210 * V_211 ,
struct V_52 * V_56 , T_1 V_417 )
{
int V_24 ;
...
V_24 = F_303 ( V_23 ) ;
if ( ! V_24 )
V_24 = F_309 ( V_23 , V_211 , V_56 , V_417 ) ;
return V_24 ;
}
static bool F_315 ( struct V_11 * V_23 , T_2 V_212 )
{
T_2 V_625 ;
V_625 = F_186 ( V_23 , V_23 -> V_377 , V_23 -> V_416 ) ;
return F_186 ( V_23 , V_23 -> V_377 , V_212 ) <= V_625 ;
}
...
if ( F_315 ( V_23 , V_211 -> V_212 ) ) {
switch ( V_23 -> V_291 ) {
case V_386 :
V_24 = F_309 ( V_23 , V_211 , V_56 , V_417 ) ;
break;
case V_419 :
V_24 = F_311 ( V_23 , V_211 , V_56 ,
V_417 ) ;
break;
case V_300 :
...
break;
case V_298 :
V_24 = F_314 ( V_23 , V_211 , V_56 , V_417 ) ;
break;
default:
break;
}
...
static int F_317 ( struct V_11 * V_23 , struct V_210 * V_211 ,
struct V_52 * V_56 )
{
F_23 ( L_97 , V_23 , V_211 , V_56 ,
V_23 -> V_291 ) ;
if ( F_308 ( V_23 , V_211 -> V_58 ) ==
V_614 ) {
F_214 ( V_23 , V_211 ) ;
F_23 ( L_98 , V_23 -> V_265 ,
F_172 ( V_23 , V_23 -> V_265 ) ) ;
V_23 -> V_265 = F_172 ( V_23 , V_23 -> V_265 ) ;
F_301 ( V_23 , V_56 , V_211 ) ;
} else {
if ( V_23 -> V_110 ) {
F_97 ( V_23 -> V_110 ) ;
V_23 -> V_110 = NULL ;
...
static int F_318 ( struct V_11 * V_23 , struct V_52 * V_56 )
{
...
if ( ( V_23 -> V_147 == V_150 ||
V_23 -> V_147 == V_154 ) && F_319 ( V_23 -> V_194 , V_56 ) )
goto V_599;
if ( ! V_211 -> V_219 ) {
int V_24 ;
F_23 ( L_99 ,
...
if ( V_23 -> V_147 != V_154 ) {
V_417 = V_618 ;
V_24 = F_316 ( V_23 , V_211 , V_56 , V_417 ) ;
} else {
V_24 = F_317 ( V_23 , V_211 , V_56 ) ;
}
if ( V_24 )
F_86 ( V_23 , V_326 ) ;
} else {
...
V_23 -> V_289 != V_422 ) )
goto V_599;
V_417 = V_626 [ V_211 -> V_223 ] ;
if ( F_316 ( V_23 , V_211 , V_56 , V_417 ) )
F_86 ( V_23 , V_326 ) ;
}
return 0 ;
V_599:
...
static void F_320 ( struct V_11 * V_23 )
{
struct V_12 * V_13 = V_23 -> V_13 ;
struct F_291 V_594 ;
T_2 V_627 ;
...
return;
V_627 = V_115 - V_23 -> V_114 ;
F_23 ( L_102 , V_23 , V_627 ) ;
V_23 -> V_114 += V_627 ;
V_594 . V_14 = F_18 ( V_23 -> V_17 ) ;
V_594 . V_165 = F_18 ( V_627 ) ;
V_23 -> V_19 = F_91 ( V_13 ) ;
F_83 ( V_13 , V_23 -> V_19 , V_598 , sizeof( V_594 ) , & V_594 ) ;
}
static int F_321 ( struct V_11 * V_23 , struct V_52 * V_56 )
{
int V_24 ;
if ( ! V_23 -> V_114 ) {
F_288 ( L_103 ) ;
...
F_299 ( V_23 -> V_110 , V_56 , & V_23 -> V_111 ) ;
V_56 = NULL ;
if ( V_23 -> V_110 -> V_193 == V_23 -> V_112 ) {
V_24 = V_23 -> V_46 -> V_427 ( V_23 , V_23 -> V_110 ) ;
if ( ! V_24 ) {
...
static void F_322 ( struct V_12 * V_13 , T_2 V_14 ,
struct V_52 * V_56 )
{
struct V_11 * V_23 ;
V_23 = F_7 ( V_13 , V_14 ) ;
...
static void F_324 ( struct V_12 * V_13 , T_3 V_20 ,
struct V_52 * V_56 )
{
struct V_7 * V_8 = V_13 -> V_8 ;
struct V_11 * V_23 ;
...
if ( V_23 -> V_117 < V_56 -> V_193 )
goto V_599;
F_81 ( & F_35 ( V_56 ) -> V_57 . V_632 , & V_8 -> V_156 ) ;
...
static void F_325 ( struct V_12 * V_13 , struct V_52 * V_56 )
{
...
if ( V_8 -> type == V_2 &&
F_326 ( & V_8 -> V_195 -> V_633 , & V_8 -> V_156 ,
F_3 ( V_8 ) ) ) {
F_97 ( V_56 ) ;
return;
}
...
break;
case V_125 :
V_20 = F_327 ( ( T_3 * ) V_56 -> V_194 ) ;
F_102 ( V_56 , V_399 ) ;
F_324 ( V_13 , V_20 , V_56 ) ;
break;
case V_432 :
F_294 ( V_13 , V_56 ) ;
break;
default:
F_322 ( V_13 , V_14 , V_56 ) ;
break;
}
}
static void F_328 ( struct V_71 * V_72 )
{
struct V_12 * V_13 = F_46 ( V_72 , struct V_12 ,
V_353 ) ;
struct V_52 * V_56 ;
...
static struct V_12 * F_329 ( struct V_7 * V_8 )
{
struct V_12 * V_13 = V_8 -> V_362 ;
struct V_146 * V_202 ;
if ( V_13 )
...
case V_2 :
if ( V_8 -> V_195 -> V_634 ) {
V_13 -> V_164 = V_8 -> V_195 -> V_634 ;
break;
}
default:
V_13 -> V_164 = V_8 -> V_195 -> V_624 ;
break;
}
V_13 -> V_315 = 0 ;
V_13 -> V_269 = V_635 | V_636 ;
if ( V_8 -> type == V_123 &&
F_243 ( V_8 -> V_195 , V_637 ) )
V_13 -> V_269 |= V_270 ;
if ( F_243 ( V_8 -> V_195 , V_638 ) &&
( F_332 ( V_8 -> V_195 ) ||
F_243 ( V_8 -> V_195 , V_639 ) ) )
V_13 -> V_269 |= V_640 ;
F_52 ( & V_13 -> V_190 ) ;
F_52 ( & V_13 -> V_18 ) ;
F_333 ( & V_13 -> V_140 ) ;
...
F_67 ( & V_13 -> V_365 ) ;
F_334 ( & V_13 -> V_353 , F_328 ) ;
F_334 ( & V_13 -> V_155 , F_80 ) ;
V_13 -> V_120 = V_121 ;
return V_13 ;
}
static bool F_335 ( T_2 V_20 , T_1 V_10 ) {
if ( ! V_20 )
return false ;
if ( F_336 ( V_10 ) )
return ( V_20 <= 0x00ff ) ;
...
int F_337 ( struct V_11 * V_23 , T_3 V_20 , T_2 V_14 ,
T_4 * V_156 , T_1 V_10 )
{
struct V_12 * V_13 ;
struct V_7 * V_8 ;
...
V_10 , F_69 ( V_20 ) ) ;
V_195 = F_338 ( V_156 , & V_23 -> V_21 , V_23 -> V_9 ) ;
if ( ! V_195 )
return - V_641 ;
F_149 ( V_195 ) ;
if ( ! F_335 ( F_69 ( V_20 ) , V_10 ) && ! V_14 &&
V_23 -> V_39 != V_175 ) {
V_24 = - V_36 ;
goto V_27;
}
...
V_10 = V_644 ;
if ( F_243 ( V_195 , V_645 ) )
V_8 = F_339 ( V_195 , V_156 , V_10 ,
V_23 -> V_79 ,
V_646 ,
V_340 ) ;
else
V_8 = F_340 ( V_195 , V_156 , V_10 ,
V_23 -> V_79 ,
V_646 ) ;
} else {
T_1 V_188 = F_87 ( V_23 ) ;
V_8 = F_341 ( V_195 , V_156 , V_23 -> V_79 , V_188 ) ;
}
if ( F_118 ( V_8 ) ) {
V_24 = F_191 ( V_8 ) ;
goto V_27;
...
int F_342 ( struct V_267 * V_195 , T_4 * V_632 )
{
int V_649 = 0 , V_650 = 0 , V_651 = 0 ;
struct V_11 * V_15 ;
F_23 ( L_119 , V_195 -> V_336 , V_632 ) ;
F_122 ( & V_25 ) ;
F_5 (c, &chan_list, global_l) {
if ( V_15 -> V_45 != V_172 )
continue;
if ( ! F_15 ( & V_15 -> V_21 , & V_195 -> V_632 ) ) {
V_650 |= V_652 ;
if ( F_70 ( V_653 , & V_15 -> V_109 ) )
V_650 |= V_654 ;
V_649 ++ ;
...
static struct V_11 * F_343 ( struct V_11 * V_15 ,
struct V_7 * V_8 )
{
T_1 V_9 = F_2 ( V_8 ) ;
F_122 ( & V_25 ) ;
if ( V_15 )
V_15 = F_344 ( V_15 , V_87 ) ;
else
V_15 = F_345 ( V_88 . V_398 , F_346 ( * V_15 ) , V_87 ) ;
F_347 (c, &chan_list, global_l) {
if ( V_15 -> V_39 != V_40 )
continue;
if ( V_15 -> V_45 != V_172 )
continue;
...
static void F_348 ( struct V_7 * V_8 , T_1 V_169 )
{
struct V_267 * V_195 = V_8 -> V_195 ;
struct V_12 * V_13 ;
struct V_11 * V_509 ;
...
return;
V_10 = F_3 ( V_8 ) ;
if ( F_326 ( & V_195 -> V_633 , & V_8 -> V_156 , V_10 ) )
return;
V_509 = F_343 ( NULL , V_8 ) ;
while ( V_509 ) {
...
F_48 ( V_509 ) ;
V_398:
V_398 = F_343 ( V_509 , V_8 ) ;
F_49 ( V_509 ) ;
V_509 = V_398 ;
}
F_144 ( V_13 ) ;
}
int F_350 ( struct V_7 * V_8 )
{
struct V_12 * V_13 = V_8 -> V_362 ;
F_23 ( L_121 , V_8 ) ;
if ( ! V_13 )
...
static void F_351 ( struct V_7 * V_8 , T_1 V_74 )
{
if ( V_8 -> type != V_123 && V_8 -> type != V_2 )
return;
F_23 ( L_122 , V_8 , V_74 ) ;
F_156 ( V_8 , F_349 ( V_74 ) ) ;
}
static inline void F_352 ( struct V_11 * V_23 , T_1 V_655 )
{
if ( V_23 -> V_39 != V_122 )
return;
if ( V_655 == 0x00 ) {
...
static void F_353 ( struct V_7 * V_8 , T_1 V_169 , T_1 V_655 )
{
struct V_12 * V_13 = V_8 -> V_362 ;
struct V_11 * V_23 ;
if ( ! V_13 )
return;
F_23 ( L_123 , V_13 , V_169 , V_655 ) ;
F_8 ( & V_13 -> V_18 ) ;
F_5 (chan, &conn->chan_l, list) {
F_9 ( V_23 ) ;
...
V_158 . V_17 = F_18 ( V_23 -> V_16 ) ;
V_158 . V_16 = F_18 ( V_23 -> V_17 ) ;
V_158 . V_159 = F_18 ( V_658 ) ;
V_158 . V_169 = F_18 ( V_659 ) ;
F_83 ( V_13 , V_23 -> V_19 , V_171 ,
sizeof( V_158 ) , & V_158 ) ;
if ( ! F_70 ( V_333 , & V_23 -> V_92 ) &&
V_658 == V_331 ) {
...
void F_354 ( struct V_7 * V_8 , struct V_52 * V_56 , T_2 V_109 )
{
struct V_12 * V_13 = V_8 -> V_362 ;
struct V_252 * V_660 ;
int V_193 ;
if ( ! V_13 && V_8 -> V_195 -> V_541 != V_661 )
goto V_599;
if ( ! V_13 )
V_13 = F_329 ( V_8 ) ;
if ( ! V_13 )
...
if ( V_56 -> V_193 < V_249 ) {
F_288 ( L_127 , V_56 -> V_193 ) ;
F_146 ( V_13 , V_663 ) ;
goto V_599;
}
V_660 = (struct V_252 * ) V_56 -> V_194 ;
V_193 = F_69 ( V_660 -> V_193 ) + V_249 ;
if ( V_193 == V_56 -> V_193 ) {
F_325 ( V_13 , V_56 ) ;
return;
}
...
if ( ! V_13 -> V_364 )
goto V_599;
F_355 ( V_56 , F_113 ( V_13 -> V_364 , V_56 -> V_193 ) ,
V_56 -> V_193 ) ;
V_13 -> V_662 = V_193 - V_56 -> V_193 ;
break;
case V_664 :
F_23 ( L_130 , V_56 -> V_193 , V_13 -> V_662 ) ;
if ( ! V_13 -> V_662 ) {
F_288 ( L_131 , V_56 -> V_193 ) ;
F_146 ( V_13 , V_663 ) ;
goto V_599;
}
if ( V_56 -> V_193 > V_13 -> V_662 ) {
F_288 ( L_132 ,
V_56 -> V_193 , V_13 -> V_662 ) ;
F_97 ( V_13 -> V_364 ) ;
V_13 -> V_364 = NULL ;
V_13 -> V_662 = 0 ;
F_146 ( V_13 , V_663 ) ;
...
static int F_356 ( struct V_665 * V_666 , void * V_28 )
{
struct V_11 * V_15 ;
F_122 ( & V_25 ) ;
F_5 (c, &chan_list, global_l) {
...
static int F_358 ( struct V_667 * V_667 , struct V_668 * V_668 )
{
return F_359 ( V_668 , F_356 , V_667 -> V_669 ) ;
}
int T_11 F_360 ( void )
{
int V_24 ;
...
if ( F_363 ( V_671 ) )
return 0 ;
V_672 = F_364 ( L_134 , 0444 , V_671 ,
NULL , & V_673 ) ;
F_365 ( L_135 , 0644 , V_671 ,
& V_115 ) ;
F_365 ( L_136 , 0644 , V_671 ,
& V_118 ) ;
return 0 ;
}
void F_366 ( void )
