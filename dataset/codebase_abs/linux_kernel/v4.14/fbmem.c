...
for ( V_36 = 0 ; V_36 < V_50 -> V_72 ; V_27 ++ ) {
V_47 = * V_27 ^ V_70 ;
for ( V_68 = 7 ; V_68 >= 0 && V_36 < V_50 -> V_72 ; V_68 -- ) {
...
V_15 = V_10 -> V_15 ;
F_63 ( V_10 ) ;
return F_75 ( & V_15 , F_71 ( V_196 ) ) ;
}
static long F_77 ( struct V_123 * V_123 , unsigned int V_195 ,
unsigned long V_196 )
{
struct V_1 * V_10 = F_42 ( V_123 ) ;
struct V_197 * V_198 ;
...
default:
if ( V_198 -> F_77 )
V_162 = V_198 -> F_77 ( V_10 , V_195 , V_196 ) ;
break;
}
return V_162 ;
}
static int
F_78 ( struct V_123 * V_123 , struct V_233 * V_234 )
{
struct V_1 * V_10 = F_42 ( V_123 ) ;
struct V_197 * V_198 ;
unsigned long V_235 ;
...
V_237 = V_198 -> F_78 ( V_10 , V_234 ) ;
F_5 ( & V_10 -> V_236 ) ;
return V_237 ;
}
V_57 = V_10 -> V_15 . V_225 ;
V_58 = V_10 -> V_15 . V_137 ;
V_235 = F_80 ( ( V_57 & ~ V_239 ) + V_58 ) >> V_240 ;
...
F_5 ( & V_10 -> V_236 ) ;
V_234 -> V_238 = F_81 ( V_234 -> V_243 ) ;
V_234 -> V_238 = F_79 ( V_234 -> V_238 ) ;
F_82 ( V_123 , V_234 , V_57 ) ;
return F_83 ( V_234 , V_57 , V_58 ) ;
}
static int
...
__acquires( &info->lock
unsigned long F_86 ( struct V_123 * V_244 ,
unsigned long V_42 , unsigned long V_58 ,
unsigned long V_245 , unsigned long V_43 )
{
struct V_1 * const V_10 = V_244 -> V_126 ;
unsigned long V_246 = F_80 ( V_10 -> V_15 . V_137 ) ;
if ( V_245 > V_246 || V_58 > V_246 - V_245 )
return - V_147 ;
return ( unsigned long ) V_10 -> V_134 + V_245 ;
}
...
#endif
if ( V_119 -> V_43 & V_249 && ! F_89 ( V_119 ) ) {
F_90 ( L_6
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_250 ;
} else if ( ! ( V_119 -> V_43 & V_249 ) && F_89 ( V_119 ) ) {
F_90 ( L_8
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_250 ;
}
...
static bool F_91 ( struct V_251 * V_252 , struct V_251 * V_253 )
{
...
static bool F_92 ( struct V_255 * V_256 ,
struct V_255 * V_257 )
{
int V_35 , V_36 ;
if ( ! V_257 || ! V_256 )
...
static int F_93 ( struct V_255 * V_261 ,
...
F_98 ( & V_1 -> V_11 ) ;
F_98 ( & V_1 -> V_236 ) ;
V_1 -> V_271 = F_99 ( V_272 , V_1 -> V_273 ,
F_100 ( V_274 , V_35 ) , NULL , L_5 , V_35 ) ;
if ( F_101 ( V_1 -> V_271 ) ) {
F_58 ( V_181 L_11 , V_35 , F_102 ( V_1 -> V_271 ) ) ;
V_1 -> V_271 = NULL ;
} else
F_103 ( V_1 ) ;
...
F_104 ( & V_1 -> V_168 ) ;
if ( V_1 -> V_282 )
F_105 ( V_1 -> V_271 , false ) ;
else
F_105 ( V_1 -> V_271 , true ) ;
F_55 ( & V_179 , & V_1 -> V_13 ) ;
...
return - V_147 ;
if ( V_1 -> V_271 ) {
F_110 ( V_272 , F_100 ( V_274 , V_35 ) ) ;
V_1 -> V_271 = NULL ;
}
return 0 ;
}
int F_111 ( struct V_255 * V_261 ,
const char * V_262 , bool V_263 )
{
int V_162 ;
F_3 ( & V_5 ) ;
V_162 = F_93 ( V_261 , V_262 , V_263 ) ;
F_5 ( & V_5 ) ;
return V_162 ;
}
int
...
{
int V_162 ;
if ( ! F_116 ( L_12 , 0 , NULL , & V_290 ) )
return - V_139 ;
V_162 = F_117 ( V_274 , L_12 , & V_291 ) ;
if ( V_162 ) {
F_58 ( L_13 , V_274 ) ;
goto V_292;
}
V_272 = F_118 ( V_293 , L_14 ) ;
if ( F_101 ( V_272 ) ) {
V_162 = F_102 ( V_272 ) ;
F_119 ( L_15 , V_162 ) ;
V_272 = NULL ;
...
int V_132 = 1 ;
F_127 (pos, n, &info->modelist) {
V_168 = F_128 ( V_117 , struct V_296 , V_297 ) ;
V_116 = & V_168 -> V_179 ;
F_129 ( & V_13 , V_116 ) ;
V_13 . V_153 = V_298 ;
