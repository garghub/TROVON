...
static void F_60 ( struct V_57 * V_81 , T_3 V_82 )
{
unsigned long V_62 ;
...
F_60 ( V_81 , F_63 ( V_84 -> V_85 ) ) ;
}
static void F_64 ( struct V_57 * V_81 )
{
struct V_68 * V_69 =
(struct V_68 * ) V_81 -> V_28 ;
struct V_86 * V_87 =
(struct V_86 * ) V_69 -> V_75 . V_28 ;
F_60 ( V_81 , F_63 ( V_87 -> V_88 ) ) ;
}
...
if ( V_96 -> V_37 )
return;
if ( V_98 -> V_102 . V_103 != F_68 ( V_104 ) )
return;
V_96 -> V_64 -> V_49 = F_54 ( V_98 -> V_100 . V_105 ) ;
}
static void F_69 ( void * V_28 )
{
F_70 ( V_28 ) ;
}
static void F_71 ( struct V_106 * V_102 , T_2 V_107 , T_2 V_108 )
{
V_102 -> V_109 = V_110 ;
V_102 -> V_111 = V_112 ;
V_102 -> V_113 = V_114 ;
V_102 -> V_103 = F_68 ( V_107 ) ;
V_102 -> V_115 = F_68 ( V_108 / 4 ) ;
}
static int F_72 ( struct V_63 * V_64 ,
struct V_93 * V_94 )
{
...
int V_119 ;
V_94 -> V_96 . V_64 = V_64 ;
V_94 -> V_96 . V_120 = F_69 ;
V_94 -> V_96 . V_121 = & V_116 ;
V_94 -> V_96 . V_81 = & V_94 -> V_122 ;
V_94 -> V_96 . V_123 = & V_94 -> V_124 ;
F_74 ( & V_94 -> V_122 , V_118 , sizeof( * V_118 ) ) ;
F_74 ( & V_94 -> V_124 , V_98 , sizeof( * V_98 ) ) ;
F_71 ( & V_118 -> V_102 ,
V_125 , V_126 ) ;
V_118 -> V_100 . V_127 = F_75 ( V_64 -> V_82 ) ;
V_119 = F_76 ( & V_3 -> V_52 -> V_55 , & V_94 -> V_96 ,
V_3 -> V_128 . V_118 ,
V_129 ) ;
if ( ! V_119 ) {
F_77 ( & V_116 ) ;
...
struct V_93 * V_94 ;
struct V_2 * V_3 = V_64 -> V_3 ;
V_94 = F_79 ( V_3 -> V_128 . V_100 , V_32 ) ;
if ( ! V_94 )
return - V_130 ;
...
if ( V_119 )
goto V_47;
V_119 = F_72 ( V_64 , V_94 ) ;
F_40 ( & V_3 -> V_52 -> V_55 ) ;
V_47:
F_80 ( V_94 , V_3 -> V_128 . V_100 ) ;
return V_119 ;
}
...
void F_85 ( struct V_63 * V_64 )
{
F_86 ( & V_64 -> V_132 ) ;
if ( ! F_27 ( V_64 -> V_3 -> V_13 , & V_64 -> V_131 ) )
F_84 ( & V_64 -> V_132 ) ;
}
void F_87 ( struct V_63 * V_64 , struct V_83 * V_84 )
{
if ( F_63 ( V_84 -> V_85 ) != V_64 -> V_82 ) {
V_64 -> V_49 = 0 ;
F_88 ( & V_64 -> V_3 -> V_133 -> V_132 ,
L_6
L_7 ,
( unsigned long long ) V_64 -> V_82 ,
( unsigned long long ) F_63 ( V_84 -> V_85 ) ) ;
return;
}
V_64 -> V_134 = F_63 ( V_84 -> V_135 ) ;
V_64 -> V_136 = F_59 ( V_84 -> V_137 . V_138 ) ;
if ( V_84 -> V_139 [ 0 ] . V_140 & F_68 ( V_141 ) )
V_64 -> V_142 |= V_143 ;
if ( V_84 -> V_139 [ 1 ] . V_140 & F_68 ( V_141 ) )
V_64 -> V_142 |= V_144 ;
if ( V_84 -> V_139 [ 2 ] . V_140 & F_68 ( V_141 ) )
V_64 -> V_142 |= V_145 ;
if ( V_84 -> V_139 [ 3 ] . V_140 & F_68 ( V_141 ) )
V_64 -> V_142 |= V_146 ;
}
static void F_89 ( void * V_28 )
{
...
if ( ! V_64 -> V_134 )
V_64 -> V_134 = F_63 ( V_148 -> V_150 ) ;
if ( ( V_64 -> V_82 != F_63 ( V_148 -> V_151 ) ) ||
...
F_90 ( V_64 ) ;
V_47:
F_91 ( V_153 , & V_64 -> V_37 ) ;
F_84 ( & V_64 -> V_132 ) ;
F_92 ( V_154 , V_94 ) ;
}
static int F_93 ( struct V_63 * V_64 )
{
struct V_93 * V_94 ;
struct V_2 * V_3 = V_64 -> V_3 ;
struct V_155 * V_156 = V_3 -> V_26 ;
int V_119 ;
V_94 = F_94 ( V_154 , V_32 ) ;
if ( ! V_94 )
return - V_130 ;
V_94 -> V_96 . V_64 = V_64 ;
V_94 -> V_96 . V_81 = & V_94 -> V_122 ;
V_94 -> V_96 . V_123 = & V_94 -> V_124 ;
F_74 ( & V_94 -> V_122 , & V_94 -> V_99 . V_149 . V_81 ,
sizeof( struct V_147 ) ) ;
F_74 ( & V_94 -> V_124 , & V_94 -> V_99 . V_149 . V_101 ,
sizeof( struct V_147 ) ) ;
V_94 -> V_96 . V_120 = F_89 ;
V_94 -> V_96 . V_121 = V_94 ;
V_94 -> V_99 . V_149 . V_81 . V_151 = F_75 ( F_95 ( V_156 ) ) ;
V_94 -> V_99 . V_149 . V_81 . V_150 = F_75 ( F_96 ( V_156 ) ) ;
V_94 -> V_99 . V_149 . V_81 . V_157 = V_158 ;
F_97 ( V_94 -> V_99 . V_149 . V_81 . V_159 , F_98 ( V_156 ) ) ;
V_119 = F_99 ( V_3 , V_64 -> V_49 , & V_94 -> V_96 ,
V_129 ) ;
if ( V_119 )
F_92 ( V_154 , V_94 ) ;
return V_119 ;
}
void F_100 ( struct V_16 * V_17 )
{
struct V_63 * V_64 =
...
static struct V_93 * F_103 ( int V_165 )
{
struct V_93 * V_94 ;
V_94 = F_94 ( V_154 , V_166 ) ;
if ( ! V_94 )
return NULL ;
if ( F_104 ( & V_94 -> V_124 , V_165 ) ) {
F_92 ( V_154 , V_94 ) ;
return NULL ;
}
F_74 ( & V_94 -> V_122 , & V_94 -> V_99 . V_167 . V_81 ,
sizeof( struct V_168 ) ) ;
return V_94 ;
}
...
F_73 ( V_116 ) ;
int V_119 ;
F_71 ( & V_81 -> V_102 , V_170 , V_169 ) ;
V_81 -> V_167 . V_171 = V_172 ;
V_96 -> V_120 = F_69 ;
V_96 -> V_121 = & V_116 ;
V_96 -> V_81 = & V_94 -> V_122 ;
V_96 -> V_123 = & V_94 -> V_124 ;
V_119 = F_76 ( & V_3 -> V_52 -> V_55 , V_96 , NULL ,
V_129 ) ;
if ( ! V_119 )
F_77 ( & V_116 ) ;
return V_119 ;
}
static void F_106 ( struct V_63 * V_64 , struct V_173 * V_174 )
{
if ( ! ( F_37 ( & V_64 -> V_37 ) & V_175 ) )
return;
F_91 ( V_175 , & V_64 -> V_37 ) ;
if ( ( V_64 -> V_142 != 0 ) ||
! F_107 ( & V_64 -> V_176 ) )
return;
F_108 ( & V_64 -> V_25 , V_174 ) ;
}
...
struct V_106 * V_180 = F_110 ( V_179 ) ;
struct V_181 * V_182 = F_110 ( V_179 ) ;
...
if ( V_96 -> V_37 )
return - V_44 ;
if ( V_180 -> V_103 != F_68 ( V_104 ) ) {
if ( V_180 -> V_186 == V_187 )
return - V_188 ;
return - V_44 ;
}
if ( V_180 -> V_115 ) {
F_88 ( & V_3 -> V_133 -> V_132 ,
L_11 ,
V_180 -> V_115 ) ;
return - V_189 ;
}
...
F_95 ( V_3 -> V_26 ) )
continue;
V_64 = F_111 ( V_3 , F_63 ( V_182 -> V_194 ) ,
V_175 , V_49 ) ;
if ( ! F_112 ( V_64 ) )
F_56 ( V_64 , 0 , L_12 ) ;
else if ( F_113 ( V_64 ) != - V_195 )
V_119 = F_113 ( V_64 ) ;
}
F_114 ( V_3 ) ;
F_115 ( & V_3 -> V_65 , V_62 ) ;
...
if ( F_120 ( V_3 -> V_26 ) != V_202 &&
F_120 ( V_3 -> V_26 ) != V_203 )
return;
...
V_119 = F_105 ( V_94 , V_3 , V_169 ) ;
if ( ! V_119 ) {
V_119 = F_109 ( V_94 , V_3 , V_177 ) ;
if ( V_119 == - V_188 )
F_121 ( 1 ) ;
else
break;
...
int V_119 ;
F_71 ( & V_206 -> V_102 , V_210 ,
V_211 ) ;
F_97 ( V_206 -> V_207 . V_105 , F_98 ( V_3 -> V_26 ) ) ;
F_74 ( & V_94 -> V_122 , V_206 , sizeof( * V_206 ) ) ;
F_74 ( & V_94 -> V_124 , V_209 , sizeof( * V_209 ) ) ;
V_96 -> V_120 = F_69 ;
V_96 -> V_121 = & V_116 ;
V_96 -> V_81 = & V_94 -> V_122 ;
V_96 -> V_123 = & V_94 -> V_124 ;
...
if ( V_96 -> V_37 )
return V_96 -> V_37 ;
if ( F_120 ( V_3 -> V_26 ) == V_203 &&
! ( strstr ( V_209 -> V_207 . V_212 , V_204 ) ) )
snprintf ( F_124 ( V_3 -> V_26 ) ,
V_211 , L_15 ,
V_209 -> V_207 . V_212 , V_204 ,
F_125 ( & V_3 -> V_133 -> V_132 ) ,
F_126 () -> V_213 ) ;
else
F_127 ( F_124 ( V_3 -> V_26 ) ,
...
int V_119 , V_218 ;
F_71 ( & V_215 -> V_102 , V_219 ,
V_211 ) ;
F_97 ( V_215 -> V_216 . V_220 . V_105 , F_98 ( V_156 ) ) ;
V_218 = F_127 ( V_215 -> V_216 . V_221 , F_124 ( V_156 ) ,
V_211 ) ;
V_215 -> V_216 . V_222 = V_218 ;
F_74 ( & V_94 -> V_122 , V_215 , sizeof( * V_215 ) ) ;
F_74 ( & V_94 -> V_124 , V_217 , sizeof( * V_217 ) ) ;
V_96 -> V_120 = F_69 ;
V_96 -> V_121 = & V_116 ;
V_96 -> V_81 = & V_94 -> V_122 ;
V_96 -> V_123 = & V_94 -> V_124 ;
...
if ( V_119 )
goto V_224;
V_119 = F_123 ( V_3 , V_94 ) ;
if ( V_119 || F_120 ( V_3 -> V_26 ) != V_203 )
goto V_225;
memset ( V_94 , 0 , sizeof( * V_94 ) ) ;
F_128 ( V_3 , V_94 ) ;
V_225:
...
F_131 ( V_227 , V_231 -> V_239 , V_231 -> V_233 ) ;
}
static struct V_33 * F_132 ( struct V_226 * V_227 )
{
T_1 V_240 ;
T_4 V_241 ;
struct V_2 * V_3 ;
struct V_242 * V_243 = V_227 -> V_244 ;
struct V_245 * V_246 = F_133 ( V_227 ) ;
struct V_155 * V_156 ;
V_240 = V_243 -> V_247 . V_248 . V_240 ;
V_241 = ( V_240 & 0xff000000 ) >> 24 ;
V_156 = V_246 ? F_134 ( V_246 ) : F_135 ( V_227 ) ;
...
V_253 -> V_120 = F_130 ;
return F_99 ( V_3 , V_49 , V_253 , V_227 -> V_81 -> V_258 / V_48 ) ;
}
static int F_139 ( struct V_226 * V_227 ,
struct V_2 * V_3 )
{
int V_119 ;
...
return V_119 ;
V_259 -> V_120 = F_136 ;
V_119 = F_76 ( V_34 , V_259 , NULL , V_227 -> V_81 -> V_258 / V_48 ) ;
if ( V_119 )
F_40 ( V_34 ) ;
return V_119 ;
}
int F_140 ( struct V_226 * V_227 )
{
struct V_155 * V_156 ;
struct V_2 * V_3 ;
...
case V_263 :
case V_264 :
return F_137 ( V_227 , V_3 ) ;
case V_265 :
case V_266 :
return F_139 ( V_227 , V_3 ) ;
default:
return - V_255 ;
}
}
int F_141 ( struct V_226 * V_227 )
{
return - V_188 ;
}
...
{
struct V_51 * V_267 ;
V_267 = F_143 ( sizeof( struct V_51 ) , V_166 ) ;
if ( ! V_267 )
return - V_130 ;
V_3 -> V_52 = V_267 ;
