...
static int F_111 ( struct V_194 * V_190 ,
int V_60 , unsigned long V_197 ,
void T_8 * V_198 , unsigned long V_97 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
char * V_199 ;
if ( F_110 ( V_197 + V_97 > V_196 ) )
return - V_52 ;
V_199 = F_109 ( V_11 ,
V_190 -> V_200 -> V_195 ,
V_60 ) ;
if ( F_110 ( ! V_199 ) )
return - V_151 ;
if ( F_112 ( V_199 + V_197 , V_198 , V_97 ) )
return - V_201 ;
return 0 ;
}
static int F_113 ( struct V_194 * V_190 ,
int V_60 , unsigned long V_197 ,
void * V_198 , unsigned long V_97 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
char * V_199 ;
V_199 = F_109 ( V_11 ,
...
if ( F_110 ( ! V_199 ) )
return - V_151 ;
memcpy ( V_199 + V_197 , V_198 , V_97 ) ;
return 0 ;
}
static int F_114 ( struct V_194 * V_190 ,
int V_60 , unsigned long V_197 ,
void T_8 * V_202 , unsigned long V_97 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
char * V_199 ;
if ( F_110 ( V_197 + V_97 > V_196 ) )
...
if ( F_110 ( ! V_199 ) )
return - V_151 ;
if ( F_115 ( V_202 , V_199 + V_197 , V_97 ) )
return - V_201 ;
return 0 ;
}
static int F_116 ( struct V_194 * V_190 ,
int V_60 , unsigned long V_197 ,
void * V_202 , unsigned long V_97 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
char * V_199 ;
V_199 = F_109 ( V_11 ,
...
if ( F_110 ( ! V_199 ) )
return - V_151 ;
memcpy ( V_202 , V_199 + V_197 , V_97 ) ;
return 0 ;
}
static int F_117 ( struct V_194 * V_190 ,
int V_60 , unsigned long V_197 ,
unsigned long V_97 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
...
static int F_120 ( struct V_194 * V_190 ,
struct V_208 * V_209 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
int V_133 ;
...
if ( ( V_133 = F_27 ( V_11 , F_121 ( V_209 ) ) ) < 0 ) {
F_122 ( V_209 , V_212 ) ;
return V_133 ;
}
if ( ( V_133 = F_23 ( V_11 , F_123 ( V_209 ) ) ) < 0 ) {
F_122 ( V_209 , V_213 ) ;
return V_133 ;
}
return 0 ;
}
static int F_124 ( struct V_194 * V_190 ,
struct V_214 * V_215 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
int V_132 ;
...
static int F_125 ( struct V_194 * V_190 ,
...
return F_124 ( V_190 , V_215 ) ;
}
default:
break;
}
return F_126 ( V_190 , V_218 , V_219 ) ;
}
static void F_127 ( struct V_10 * V_11 )
{
memset ( V_11 -> V_167 , 0 , V_178 ) ;
}
static int F_128 ( struct V_194 * V_190 ,
int V_218 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
struct V_194 * V_205 ;
...
static int F_133 ( struct V_194 * V_190 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
unsigned long V_15 ;
int V_225 = 0 ;
...
struct V_229 * V_230 = F_135 ( V_209 , V_231 ) ;
unsigned int V_232 [ 2 ] = { V_11 -> V_233 , V_11 -> V_53 } ;
return F_136 ( V_230 , 2 , V_232 , 0 ) ;
}
...
struct V_10 * V_11 = V_227 -> V_228 ;
struct V_229 * V_230 = F_135 ( V_209 , V_231 ) ;
struct V_229 * V_234 = F_135 ( V_209 , V_212 ) ;
...
static int F_139 ( struct V_208 * V_209 ,
struct V_226 * V_227 )
{
struct V_10 * V_11 = V_227 -> V_228 ;
struct V_229 * V_230 = F_135 ( V_209 , V_231 ) ;
...
static int F_140 ( struct V_194 * V_190 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
struct V_203 * V_204 = V_190 -> V_204 ;
F_24 ( & V_11 -> V_17 ) ;
...
static int F_147 ( struct V_194 * V_190 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
struct V_203 * V_204 = V_190 -> V_204 ;
F_24 ( & V_11 -> V_17 ) ;
...
static int F_148 ( struct V_194 * V_190 )
{
struct V_10 * V_11 = F_108 ( V_190 ) ;
F_24 ( & V_11 -> V_17 ) ;
V_11 -> V_19 = - 1 ;
...
static int F_149 ( struct V_153 * V_37 ,
struct V_10 * V_11 )
{
struct V_250 * V_187 ;
int V_133 ;
...
F_151 ( V_187 , V_192 , & V_252 ) ;
F_151 ( V_187 , V_189 , & V_253 ) ;
V_187 -> V_254 = V_255 ;
return 0 ;
}
static int F_152 ( struct V_153 * V_37 ,
struct V_10 * V_11 ,
int V_34 )
{
...
if ( ( V_133 = F_154 ( V_2 ) ) < 0 )
return V_133 ;
F_155 ( & V_11 -> V_17 ) ;
if ( ( V_133 = F_156 ( V_2 , L_66 ) ) < 0 )
return V_133 ;
V_11 -> V_169 = F_157 ( V_2 , 0 ) ;
V_11 -> V_14 = F_158 ( V_11 -> V_169 , V_259 ) ;
if ( V_11 -> V_14 == NULL ) {
F_18 ( V_37 -> V_6 , L_68 ,
V_11 -> V_169 , V_11 -> V_169 + V_259 - 1 ) ;
return - V_49 ;
}
if ( F_159 ( V_2 -> V_168 , F_105 , V_260 ,
V_261 , V_11 ) ) {
...
static void F_161 ( struct V_153 * V_37 )
{
...
V_133 = F_163 ( & V_2 -> V_6 , V_270 [ V_6 ] , V_248 [ V_6 ] , V_271 ,
...
V_11 -> V_6 = V_6 ;
V_11 -> V_2 = V_2 ;
V_133 = F_152 ( V_37 , V_11 , V_34 [ V_6 ] ) ;
if ( V_133 )
goto V_273;
strcpy ( V_37 -> V_274 , V_11 -> V_82 ) ;
sprintf ( V_37 -> V_275 , L_78 ,
V_37 -> V_274 , V_11 -> V_169 , V_11 -> V_168 ) ;
V_133 = F_164 ( V_37 ) ;
if ( V_133 ) {
V_273:
F_165 ( V_37 ) ;
