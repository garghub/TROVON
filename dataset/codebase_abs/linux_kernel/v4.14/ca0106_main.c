...
int V_64 ;
V_64 = F_70 ( V_2 -> V_23 , L_5 , V_153 , 1 , 1 , & V_171 ) ;
if ( V_64 < 0 )
return V_64 ;
V_171 -> V_37 = V_2 ;
switch ( V_153 ) {
...
if ( V_64 < 0 )
return V_64 ;
if ( F_79 ( & V_151 -> V_24 , F_80 ( 32 ) ) < 0 ||
F_81 ( & V_151 -> V_24 , F_80 ( 32 ) ) < 0 ) {
F_10 ( V_23 -> V_24 , L_7 ) ;
F_66 ( V_151 ) ;
return - V_235 ;
}
...
V_38 -> V_149 = F_84 ( V_38 -> V_9 , 0x20 , L_8 ) ;
if ( ! V_38 -> V_149 ) {
F_61 ( V_38 ) ;
F_10 ( V_23 -> V_24 , L_9 ) ;
return - V_236 ;
...
strcpy ( V_23 -> V_244 , L_6 ) ;
strcpy ( V_23 -> V_245 , L_6 ) ;
...
{
struct V_229 * V_23 = F_111 ( V_24 ) ;
struct V_1 * V_38 = V_23 -> V_37 ;
int V_93 ;
F_112 ( V_23 , V_285 ) ;
for ( V_93 = 0 ; V_93 < 4 ; V_93 ++ )
F_113 ( V_38 -> V_171 [ V_93 ] ) ;
if ( V_38 -> V_44 -> V_136 )
F_114 ( V_38 -> V_136 ) ;
F_115 ( V_38 ) ;
F_62 ( V_38 ) ;
...
static int F_116 ( struct V_153 * V_24 )
{
struct V_229 * V_23 = F_111 ( V_24 ) ;
struct V_1 * V_38 = V_23 -> V_37 ;
int V_93 ;
