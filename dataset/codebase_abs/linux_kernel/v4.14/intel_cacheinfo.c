...
int V_62 , V_141 ;
if ( V_58 == 3 ) {
F_48 (i, cpu_llc_shared_mask(cpu)) {
V_140 = F_47 ( V_62 ) ;
if ( ! V_140 -> V_142 )
continue;
V_56 = V_140 -> V_142 + V_58 ;
F_48 (sibling, cpu_llc_shared_mask(cpu)) {
if ( ! F_49 ( V_141 ) )
continue;
F_50 ( V_141 ,
& V_56 -> V_70 ) ;
...
unsigned int V_120 , V_143 , V_144 , V_145 ;
V_143 = V_138 -> V_3 . V_28 . V_33 + 1 ;
V_120 = F_51 ( V_60 ) . V_120 ;
V_144 = V_120 - ( V_120 % V_143 ) ;
V_145 = V_144 + V_143 - 1 ;
F_52 (i) {
V_140 = F_47 ( V_62 ) ;
if ( ! V_140 -> V_142 )
continue;
V_120 = F_51 ( V_62 ) . V_120 ;
if ( ( V_120 < V_144 ) || ( V_120 > V_145 ) )
continue;
V_56 = V_140 -> V_142 + V_58 ;
F_52 (sibling) {
V_120 = F_51 ( V_141 ) . V_120 ;
if ( ( V_120 < V_144 ) || ( V_120 > V_145 ) )
continue;
F_50 ( V_141 ,
& V_56 -> V_70 ) ;
...
V_113 = F_43 ( V_33 ) ;
F_52 (i)
if ( F_51 ( V_62 ) . V_120 >> V_113 == V_101 -> V_120 >> V_113 ) {
struct V_139 * V_147 = F_47 ( V_62 ) ;
if ( V_62 == V_60 || ! V_147 -> V_142 )
continue;
V_146 = V_147 -> V_142 + V_58 ;
F_50 ( V_62 , & V_56 -> V_70 ) ;
