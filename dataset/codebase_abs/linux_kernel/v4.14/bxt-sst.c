...
V_96 -> V_100 . V_103 = V_104 ;
V_96 -> V_100 . V_105 = V_106 ;
V_96 -> V_100 . V_107 = V_108 ;
V_96 -> V_100 . V_109 = V_110 ;
F_45 ( V_96 , ( V_104 + V_108 ) ,
V_110 , V_106 , V_111 ) ;
V_14 = F_46 ( V_23 , V_10 ) ;
if ( V_14 ) {
F_47 ( V_96 ) ;
...
V_10 -> V_28 . V_112 . V_113 = V_114 ;
V_10 -> V_54 = false ;
F_48 ( & V_10 -> V_53 ) ;
F_49 ( & V_10 -> V_58 . V_70 , F_29 ) ;
V_10 -> V_58 . V_60 = V_63 ;
return 0 ;
}
int F_50 ( struct V_92 * V_23 , struct V_9 * V_2 )
{
int V_14 ;
struct V_1 * V_96 = V_2 -> V_73 ;
V_14 = V_96 -> V_98 . V_115 ( V_96 ) ;
if ( V_14 < 0 ) {
F_5 ( V_23 , L_33 , V_14 ) ;
return V_14 ;
}
F_51 ( V_96 ) ;
if ( V_2 -> V_6 > 1 ) {
V_14 = V_96 -> V_98 . V_116 ( V_96 , V_2 -> V_18 ,
V_2 -> V_6 ) ;
if ( V_14 < 0 ) {
F_5 ( V_23 , L_34 , V_14 ) ;
return V_14 ;
...
void F_52 ( struct V_92 * V_23 , struct V_9 * V_2 )
{
