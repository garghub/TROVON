...
void F_34 ( struct V_59 * V_60 , struct V_12 * V_13 ,
struct V_47 * V_48 , int V_61 , int V_62 )
{
V_60 -> V_63 = V_48 ;
V_60 -> V_61 = V_61 ;
V_60 -> V_13 = V_13 ;
V_60 -> V_19 = 0 ;
V_60 -> V_62 = V_62 ;
F_35 ( & V_13 -> V_30 , V_64 , V_60 , 1 ) ;
}
int F_36 ( struct V_52 * V_65 , void * V_66 )
{
struct V_43 * V_44 = V_65 -> V_67 ;
T_5 V_68 , V_61 , V_69 ;
struct V_47 * V_48 ;
struct V_3 * V_4 ;
union V_70 V_71 ;
...
int V_6 = 0 ;
V_48 = F_28 ( V_44 -> V_49 ) ;
V_71 . V_72 = V_44 -> V_49 -> V_72 ;
V_68 = V_71 . V_73 . V_74 ;
V_69 = V_71 . V_73 . V_69 ;
V_61 = V_71 . V_73 . V_61 ;
V_4 = & V_75 [ V_68 ] ;
V_13 = F_37 ( V_4 , V_69 , NULL ) ;
if ( ! V_13 ) {
V_6 = - V_50 ;
goto V_51;
}
F_34 ( & V_60 , V_13 , V_48 , V_61 , false ) ;
if ( V_60 . V_19 & V_76 )
F_32 ( V_65 , L_6 ) ;
else if ( V_60 . V_19 & V_77 )
F_32 ( V_65 , L_7 ) ;
else
F_31 ( V_65 , L_8 , V_60 . V_19 * V_4 -> V_78 ) ;
V_51:
F_29 ( V_44 -> V_49 ) ;
return V_6 ;
}
