...
static T_4 F_35 ( struct V_5 * V_6 , T_3 V_66 ,
T_5 V_39 , T_5 * V_67 , T_6 * V_68 )
{
struct V_7 * V_8 = F_3 ( V_6 ) ;
unsigned int V_69 , V_40 ;
F_21 ( & V_6 -> V_21 , L_14 , V_30 ,
...
static T_4 F_36 ( struct V_5 * V_6 , T_3 V_73 ,
T_5 V_39 , T_5 * V_67 , const T_6 * V_68 )
{
struct V_7 * V_8 = F_3 ( V_6 ) ;
unsigned int V_69 , V_40 ;
if ( V_73 >= V_8 -> V_27 )
...
F_38 ( V_75 , L_18 , V_8 -> V_46 . V_59 , V_8 -> V_46 . V_60 ) ;
return 0 ;
}
...
const char * V_87 = V_85 ? L_20 : L_21 ;
...
T_5 V_39 = V_91 . V_98 , V_67 ;
F_21 ( & V_6 -> V_21 , L_22 , V_87 ,
V_39 , V_57 ) ;
if ( V_85 )
...
static T_7 F_53 ( struct V_103 * V_104 , struct V_84 * V_84 )
{
struct V_5 * V_6 = V_104 -> V_105 ;
struct V_7 * V_8 = F_3 ( V_6 ) ;
int V_106 ;
F_21 ( & V_6 -> V_21 , L_26 , V_30 ) ;
F_54 ( V_104 , & V_84 ) ;
F_48 ( & V_8 -> V_100 ) ;
...
struct V_103 * V_108 ;
struct V_109 * V_109 ;
T_8 V_110 , V_111 , V_112 , V_113 , V_114 ,
V_115 , V_116 ;
char * V_117 ;
...
V_28 = - 1 ;
V_110 = F_64 ( F_65 ( V_27 , & V_117 ) , 1024 * 1024 ) ;
if ( ! V_110 ) {
F_18 ( & V_6 -> V_21 , L_29 ) ;
error = - V_123 ;
goto V_124;
...
V_8 -> V_18 = F_71 ( V_112 , 64 * 1024 ) ;
if ( ! V_8 -> V_18 ) {
F_18 ( & V_6 -> V_21 , L_33 ) ;
error = - V_65 ;
goto V_131;
}
V_8 -> V_1 = F_71 ( V_114 , V_115 ) ;
if ( ! V_8 -> V_1 ) {
F_18 ( & V_6 -> V_21 , L_34 ) ;
error = - V_65 ;
goto V_132;
...
V_109 -> V_108 = V_108 ;
V_109 -> V_144 = V_6 ;
F_78 ( V_109 -> V_145 , V_82 , sizeof( V_109 -> V_145 ) ) ;
F_79 ( V_109 , V_8 -> V_27 >> 9 ) ;
F_32 ( & V_6 -> V_21 , L_38 ,
V_109 -> V_145 , F_80 ( V_109 ) >> 11 ) ;
F_81 ( & V_6 -> V_21 , V_109 ) ;
return 0 ;
V_138:
F_82 ( V_108 ) ;
...
F_87 ( V_6 ) ;
V_122:
F_88 ( ( unsigned long ) V_8 -> V_72 , F_62 ( V_119 ) ) ;
V_120:
F_34 ( V_8 ) ;
F_60 ( V_6 , NULL ) ;
V_118:
