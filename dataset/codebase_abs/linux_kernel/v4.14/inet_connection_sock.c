...
void (* F_58)( unsigned long ) )
{
struct V_84 * V_85 = F_34 ( V_14 ) ;
F_59 ( & V_85 -> V_107 , F_56 ,
( unsigned long ) V_14 ) ;
F_59 ( & V_85 -> V_108 , F_57 ,
( unsigned long ) V_14 ) ;
F_59 ( & V_14 -> V_109 , F_58 , ( unsigned long ) V_14 ) ;
...
F_61 ( V_14 , & V_85 -> V_107 ) ;
F_61 ( V_14 , & V_85 -> V_108 ) ;
F_61 ( V_14 , & V_14 -> V_109 ) ;
}
void F_62 ( struct V_13 * V_14 )
{
F_61 ( V_14 , & V_14 -> V_109 ) ;
}
void F_63 ( struct V_13 * V_14 , unsigned long V_114 )
{
F_64 ( V_14 , & V_14 -> V_109 , V_115 + V_114 ) ;
}
struct V_116 * F_65 ( const struct V_13 * V_14 ,
struct V_117 * V_118 ,
const struct V_97 * V_98 )
{
const struct V_119 * V_120 = F_66 ( V_98 ) ;
struct V_21 * V_21 = F_67 ( & V_120 -> V_121 ) ;
struct V_122 * V_123 ;
struct V_124 * V_125 ;
V_123 = F_68 ( V_120 ) ;
F_69 ( V_118 , V_120 -> V_126 , V_120 -> V_127 ,
F_70 ( V_14 ) , V_128 ,
V_14 -> V_102 , F_71 ( V_14 ) ,
( V_123 && V_123 -> V_123 . V_129 ) ? V_123 -> V_123 . V_130 : V_120 -> V_131 ,
V_120 -> V_132 , V_120 -> V_133 ,
F_72 ( V_120 -> V_134 ) , V_14 -> V_135 ) ;
F_73 ( V_98 , F_74 ( V_118 ) ) ;
V_125 = F_75 ( V_21 , V_118 , V_14 ) ;
if ( F_76 ( V_125 ) )
goto V_136;
...
struct V_116 * F_79 ( const struct V_13 * V_14 ,
struct V_13 * V_99 ,
const struct V_97 * V_98 )
{
const struct V_119 * V_120 = F_66 ( V_98 ) ;
struct V_21 * V_21 = F_67 ( & V_120 -> V_121 ) ;
struct V_142 * V_143 = F_80 ( V_99 ) ;
struct V_122 * V_123 ;
struct V_117 * V_118 ;
struct V_124 * V_125 ;
V_123 = F_81 ( V_120 -> V_144 ) ;
V_118 = & V_143 -> V_145 . V_146 . V_147 . V_148 ;
F_69 ( V_118 , V_120 -> V_126 , V_120 -> V_127 ,
F_70 ( V_14 ) , V_128 ,
V_14 -> V_102 , F_71 ( V_14 ) ,
( V_123 && V_123 -> V_123 . V_129 ) ? V_123 -> V_123 . V_130 : V_120 -> V_131 ,
...
* V_152 = V_98 -> V_154 >= V_149 &&
( ! F_66 ( V_98 ) -> V_155 || V_98 -> V_154 >= V_150 ) ;
* V_153 = ! F_66 ( V_98 ) -> V_155 ||
V_98 -> V_154 >= V_151 - 1 ;
}
...
V_99 -> V_39 = V_180 ;
V_179 -> V_82 = NULL ;
F_80 ( V_99 ) -> V_181 = F_66 ( V_98 ) -> V_133 ;
F_80 ( V_99 ) -> V_182 = F_66 ( V_98 ) -> V_134 ;
F_80 ( V_99 ) -> V_183 = F_72 ( F_66 ( V_98 ) -> V_134 ) ;
F_114 ( V_99 , V_184 ) ;
F_80 ( V_99 ) -> V_185 = NULL ;
V_99 -> V_186 = F_66 ( V_98 ) -> V_127 ;
F_115 ( & V_99 -> V_187 ,
F_116 ( & F_66 ( V_98 ) -> V_188 ) ) ;
V_179 -> V_189 = 0 ;
V_179 -> V_190 = 0 ;
V_179 -> V_191 = 0 ;
...
{
F_36 ( V_14 -> V_39 != V_192 ) ;
F_36 ( ! F_119 ( V_14 , V_193 ) ) ;
F_36 ( ! F_120 ( V_14 ) ) ;
F_36 ( F_80 ( V_14 ) -> V_182 && ! F_34 ( V_14 ) -> V_82 ) ;
V_14 -> V_48 -> V_194 ( V_14 ) ;
F_121 ( V_14 ) ;
F_122 ( V_14 ) ;
F_123 ( V_14 ) ;
F_124 ( V_14 -> V_48 -> V_195 ) ;
F_125 ( V_14 ) ;
}
void F_126 ( struct V_13 * V_14 )
__releases( &sk->sk_lock.slock
int F_127 ( struct V_13 * V_14 , int V_196 )
{
struct V_84 * V_85 = F_34 ( V_14 ) ;
struct V_142 * V_197 = F_80 ( V_14 ) ;
int V_87 = - V_198 ;
F_128 ( & V_85 -> V_89 ) ;
V_14 -> V_171 = V_196 ;
V_14 -> V_199 = 0 ;
F_129 ( V_14 ) ;
F_130 ( V_14 , V_40 ) ;
if ( ! V_14 -> V_48 -> V_200 ( V_14 , V_197 -> V_182 ) ) {
V_197 -> V_183 = F_72 ( V_197 -> V_182 ) ;
F_131 ( V_14 ) ;
V_87 = V_14 -> V_48 -> V_201 ( V_14 ) ;
if ( F_19 ( ! V_87 ) )
return 0 ;
}
V_14 -> V_39 = V_192 ;
...
struct V_13 * V_202 )
{
V_14 -> V_48 -> V_203 ( V_202 , V_101 ) ;
F_133 ( V_202 ) ;
F_134 ( V_14 -> V_48 -> V_195 ) ;
if ( V_14 -> V_102 == V_103 && F_52 ( V_98 ) -> V_104 ) {
F_135 ( F_136 ( V_202 ) -> V_204 != V_98 ) ;
F_135 ( V_14 != V_98 -> V_165 ) ;
F_136 ( V_202 ) -> V_204 = NULL ;
}
F_118 ( V_202 ) ;
}
...
struct V_13 * F_139 ( struct V_13 * V_14 , struct V_13 * V_202 ,
struct V_97 * V_98 , bool V_209 )
{
if ( V_209 ) {
F_93 ( V_14 , V_98 ) ;
F_94 ( & F_34 ( V_14 ) -> V_89 , V_98 ) ;
if ( F_137 ( V_14 , V_98 , V_202 ) )
return V_202 ;
}
F_140 ( V_202 ) ;
F_125 ( V_202 ) ;
...
struct V_84 * V_85 = F_34 ( V_14 ) ;
struct V_95 * V_96 = & V_85 -> V_89 ;
struct V_97 * V_210 , * V_98 ;
while ( ( V_98 = F_51 ( V_96 , V_14 ) ) != NULL ) {
struct V_13 * V_202 = V_98 -> V_14 ;
F_142 () ;
F_143 ( V_202 ) ;
F_36 ( F_144 ( V_202 ) ) ;
F_145 ( V_202 ) ;
...
if ( V_96 -> V_105 . V_211 ) {
F_24 ( & V_96 -> V_105 . V_27 ) ;
V_98 = V_96 -> V_105 . V_211 ;
V_96 -> V_105 . V_211 = NULL ;
F_28 ( & V_96 -> V_105 . V_27 ) ;
while ( V_98 != NULL ) {
V_210 = V_98 -> V_206 ;
F_54 ( V_98 ) ;
...
void F_148 ( struct V_13 * V_14 , struct V_212 * V_213 )
{
struct V_214 * sin = (struct V_214 * ) V_213 ;
const struct V_142 * V_197 = F_80 ( V_14 ) ;
sin -> V_215 = V_216 ;
sin -> V_217 . V_218 = V_197 -> V_219 ;
sin -> V_220 = V_197 -> V_181 ;
}
int F_149 ( struct V_13 * V_14 , int V_221 , int V_222 ,
char T_7 * V_223 , int T_7 * V_224 )
{
const struct V_84 * V_85 = F_34 ( V_14 ) ;
if ( V_85 -> V_225 -> V_226 )
return V_85 -> V_225 -> V_226 ( V_14 , V_221 , V_222 ,
V_223 , V_224 ) ;
return V_85 -> V_225 -> V_227 ( V_14 , V_221 , V_222 ,
V_223 , V_224 ) ;
}
int F_150 ( struct V_13 * V_14 , int V_221 , int V_222 ,
char T_7 * V_223 , unsigned int V_224 )
{
const struct V_84 * V_85 = F_34 ( V_14 ) ;
if ( V_85 -> V_225 -> V_228 )
return V_85 -> V_225 -> V_228 ( V_14 , V_221 , V_222 ,
V_223 , V_224 ) ;
return V_85 -> V_225 -> V_229 ( V_14 , V_221 , V_222 ,
V_223 , V_224 ) ;
}
static struct V_116 * F_151 ( struct V_13 * V_14 , struct V_230 * V_146 )
{
const struct V_142 * V_197 = F_80 ( V_14 ) ;
const struct V_122 * V_231 ;
T_1 V_232 = V_197 -> V_219 ;
struct V_117 * V_118 ;
struct V_124 * V_125 ;
F_152 () ;
V_231 = F_81 ( V_197 -> V_231 ) ;
if ( V_231 && V_231 -> V_123 . V_129 )
V_232 = V_231 -> V_123 . V_130 ;
V_118 = & V_146 -> V_147 . V_148 ;
V_125 = F_153 ( F_18 ( V_14 ) , V_118 , V_14 , V_232 ,
V_197 -> V_233 , V_197 -> V_181 ,
V_197 -> V_183 , V_14 -> V_102 ,
F_70 ( V_14 ) , V_14 -> V_38 ) ;
if ( F_76 ( V_125 ) )
V_125 = NULL ;
if ( V_125 )
F_154 ( V_14 , & V_125 -> V_140 ) ;
F_155 () ;
return & V_125 -> V_140 ;
}
struct V_116 * F_156 ( struct V_13 * V_14 , T_3 V_234 )
{
struct V_116 * V_140 = F_157 ( V_14 , 0 ) ;
struct V_142 * V_197 = F_80 ( V_14 ) ;
if ( ! V_140 ) {
V_140 = F_151 ( V_14 , & V_197 -> V_145 . V_146 ) ;
if ( ! V_140 )
goto V_106;
}
V_140 -> V_235 -> V_236 ( V_140 , V_14 , NULL , V_234 ) ;
V_140 = F_157 ( V_14 , 0 ) ;
if ( ! V_140 )
V_140 = F_151 ( V_14 , & V_197 -> V_145 . V_146 ) ;
V_106:
