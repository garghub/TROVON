...
V_6 = snprintf ( V_8 , sizeof( V_8 ) , L_2 , V_1 , V_3 ) ;
if ( V_6 < 0 ) {
F_2 ( L_3 , V_6 ) ;
return;
}
...
void T_3 * V_13 = NULL ;
bool V_41 = false ;
struct V_11 * V_42 = F_18 ( sizeof( * V_42 ) ,
V_43 ) ;
...
if ( F_7 ( ! V_13 ) ) {
F_2 ( L_21 ,
( unsigned int ) V_42 -> V_55 -> V_58 ,
( unsigned int ) F_24 ( V_42 -> V_55 ) ) ;
V_50 = - V_51 ;
goto V_52;
}
...
F_3 ( L_44 ,
( V_81 >> 24 ) , ( V_81 >> 16 ) & 0xF , ( V_81 >> 4 ) & 0xFFF ,
( V_81 >> 20 ) & 0xF , V_81 & 0xF ) ;
#endif
V_50 = F_17 ( V_38 ) ;
if ( V_50 != 0 )
return V_50 ;
