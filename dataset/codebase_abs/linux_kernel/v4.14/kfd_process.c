...
struct V_2 * F_14 ( const struct V_3 * V_4 )
{
struct V_2 * V_5 ;
if ( ! V_4 -> V_6 )
return F_6 ( - V_7 ) ;
...
static struct V_2 * F_15 ( const struct V_11 * V_6 )
{
struct V_2 * V_5 ;
F_16 (kfd_processes_table, process,
kfd_processes, (uintptr_t)mm)
if ( V_5 -> V_6 == V_6 )
return V_5 ;
return NULL ;
}
static struct V_2 * F_9 ( const struct V_3 * V_4 )
{
struct V_2 * V_12 ;
int V_13 ;
V_13 = F_17 ( & V_14 ) ;
...
V_12 -> V_22 ) ;
F_8 ( & V_12 -> V_23 ) ;
F_20 (pdd, temp, &p->per_device_data,
per_device_list) {
F_10 ( L_4 ,
V_20 -> V_24 -> V_25 , V_12 -> V_22 ) ;
if ( V_20 -> V_26 )
F_21 ( V_20 -> V_24 , V_12 ) ;
F_22 ( V_20 -> V_24 -> V_27 , V_12 -> V_22 ) ;
F_23 ( & V_20 -> V_28 ) ;
F_24 ( V_20 ) ;
}
F_25 ( V_12 ) ;
...
struct V_17 * V_16 ;
struct V_2 * V_12 ;
V_12 = F_29 ( V_31 , struct V_2 , V_31 ) ;
F_30 ( F_31 ( & V_12 -> V_6 -> V_32 ) <= 0 ) ;
F_32 ( V_12 -> V_6 ) ;
V_16 = F_33 ( sizeof( struct V_17 ) , V_33 ) ;
if ( V_16 ) {
F_34 ( (struct V_15 * ) V_16 , F_19 ) ;
V_16 -> V_12 = V_12 ;
...
V_12 = F_29 ( V_35 , struct V_2 , V_34 ) ;
if ( F_30 ( V_12 -> V_6 != V_6 ) )
return;
F_8 ( & V_10 ) ;
F_37 ( & V_12 -> V_36 ) ;
F_12 ( & V_10 ) ;
