...
V_38 ) ;
if ( V_2 -> V_96 ) {
F_41 ( V_2 -> V_191 -> V_213 ,
L_26 ) ;
V_11 -> error = F_39 ( V_2 ) ;
} else if ( ! time ) {
F_41 ( V_2 -> V_191 -> V_213 , L_27 ) ;
V_11 -> error = - V_106 ;
} else if ( time < 0 ) {
F_41 ( V_2 -> V_191 -> V_213 ,
L_28 , time ) ;
...
static T_5 F_80 ( int V_215 , void * V_216 )
{
...
static T_5 F_85 ( int V_215 , void * V_216 )
{
struct V_1 * V_2 = V_216 ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
T_1 V_103 , V_41 ;
...
F_4 ( V_2 , V_115 , V_103 & V_222 ) ;
if ( V_103 & ~ V_222 )
F_7 ( V_10 , L_30 ,
V_103 ) ;
if ( V_103 & V_223 || V_103 & ~ V_224 ) {
V_2 -> V_96 = true ;
F_7 ( V_10 , L_31 , V_103 ) ;
}
if ( V_103 & ~ ( V_225 | V_226 ) ) {
if ( ! V_2 -> V_8 )
F_7 ( V_10 , L_32 , V_103 ) ;
if ( ! V_2 -> V_26 )
return V_227 ;
...
static void F_86 ( struct V_228 * V_229 )
{
struct V_230 * V_231 = F_87 ( V_229 ) ;
struct V_1 * V_2 = F_88 ( V_231 , struct V_1 , V_185 ) ;
struct V_7 * V_8 = V_2 -> V_8 ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
unsigned long V_127 ;
if ( V_2 -> V_232 )
...
return;
if ( ! V_191 -> V_234 )
V_191 -> V_234 = V_50 -> V_235 ;
else if ( V_50 -> V_235 )
F_17 ( F_91 ( V_191 ) , L_35 ) ;
}
static int F_92 ( struct V_236 * V_237 )
{
int V_23 = 0 , V_215 [ 2 ] ;
struct V_190 * V_191 ;
struct V_1 * V_2 ;
struct V_9 * V_10 = & V_237 -> V_10 ;
struct V_61 * V_50 = V_10 -> V_60 ;
struct V_46 * V_47 ;
void T_6 * V_3 ;
const char * V_238 ;
V_215 [ 0 ] = F_93 ( V_237 , 0 ) ;
V_215 [ 1 ] = F_93 ( V_237 , 1 ) ;
if ( V_215 [ 0 ] < 0 ) {
F_41 ( V_10 , L_36 ) ;
return - V_239 ;
}
V_47 = F_24 ( V_237 , V_51 , 0 ) ;
V_3 = F_94 ( V_10 , V_47 ) ;
if ( F_69 ( V_3 ) )
return F_95 ( V_3 ) ;
V_191 = F_96 ( sizeof( struct V_1 ) , V_10 ) ;
if ( ! V_191 )
return - V_240 ;
V_23 = F_97 ( V_191 ) ;
if ( V_23 < 0 )
...
V_191 -> V_242 = & V_243 ;
F_89 ( V_2 ) ;
V_191 -> V_244 |= V_245 | V_246 ;
V_191 -> V_247 |= V_248 | V_249 ;
V_191 -> V_250 = 10000 ;
if ( V_50 && V_50 -> V_244 )
V_191 -> V_244 |= V_50 -> V_244 ;
V_191 -> V_251 = 32 ;
V_191 -> V_252 = 512 ;
V_191 -> V_253 = V_254 * V_191 -> V_251 ;
V_191 -> V_255 = V_191 -> V_253 / V_191 -> V_252 ;
V_191 -> V_256 = V_191 -> V_253 ;
F_100 ( V_237 , V_2 ) ;
V_2 -> V_65 = F_101 ( V_10 , NULL ) ;
if ( F_69 ( V_2 -> V_65 ) ) {
V_23 = F_95 ( V_2 -> V_65 ) ;
F_41 ( V_10 , L_37 , V_23 ) ;
goto V_241;
...
if ( V_23 < 0 )
goto V_257;
F_103 ( & V_2 -> V_185 , F_86 ) ;
F_36 ( V_2 ) ;
F_38 ( V_2 -> V_5 , V_115 , V_258 ) ;
V_238 = V_215 [ 1 ] < 0 ? F_9 ( V_10 ) : L_38 ;
V_23 = F_104 ( V_10 , V_215 [ 0 ] , F_85 ,
F_80 , 0 , V_238 , V_2 ) ;
if ( V_23 ) {
F_41 ( V_10 , L_39 , V_238 ) ;
goto V_257;
}
if ( V_215 [ 1 ] >= 0 ) {
V_23 = F_104 ( V_10 , V_215 [ 1 ] ,
F_85 , F_80 ,
0 , L_40 , V_2 ) ;
if ( V_23 ) {
F_41 ( V_10 , L_41 ) ;
