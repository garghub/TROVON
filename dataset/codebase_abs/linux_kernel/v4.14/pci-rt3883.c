...
while ( V_21 ) {
unsigned V_24 , V_25 = F_13 ( V_21 ) ;
V_24 = F_14 ( V_7 -> V_26 , V_25 ) ;
F_15 ( V_24 ) ;
V_21 &= ~ F_16 ( V_25 ) ;
}
}
...
V_7 = F_18 ( V_28 ) ;
V_29 = F_3 ( V_7 , V_23 ) ;
F_5 ( V_7 , V_29 | F_16 ( V_28 -> V_30 ) , V_23 ) ;
F_3 ( V_7 , V_23 ) ;
}
...
static int F_20 ( struct V_26 * V_28 , unsigned int V_24 ,
T_2 V_31 )
{
F_21 ( V_24 , & V_32 , V_33 ) ;
F_22 ( V_24 , V_28 -> V_34 ) ;
...
{
int V_24 ;
V_24 = F_24 ( V_7 -> V_37 , 0 ) ;
if ( V_24 == 0 ) {
F_25 ( V_36 , L_1 , V_7 -> V_37 ) ;
return - V_38 ;
}
F_5 ( V_7 , 0 , V_23 ) ;
V_7 -> V_26 =
...
static int F_28 ( struct V_2 * V_3 , unsigned int V_42 ,
...
static int F_31 ( struct V_2 * V_3 , unsigned int V_42 ,
int V_13 , int V_43 , T_1 V_10 )
{
struct V_1 * V_7 ;
unsigned long V_14 ;
...
static void F_32 ( struct V_1 * V_7 , unsigned V_49 )
{
T_1 V_50 ;
T_1 V_51 ;
T_1 V_52 ;
...
int V_78 ;
int V_49 ;
V_7 = F_38 ( V_36 , sizeof( * V_7 ) , V_79 ) ;
if ( ! V_7 )
return - V_80 ;
V_76 = F_39 ( V_71 , V_81 , 0 ) ;
V_7 -> V_9 = F_40 ( V_36 , V_76 ) ;
if ( F_41 ( V_7 -> V_9 ) )
return F_42 ( V_7 -> V_9 ) ;
F_43 (np, child) {
if ( F_44 ( V_77 , L_3 , NULL ) ) {
V_7 -> V_37 = V_77 ;
break;
}
}
...
V_49 = V_83 ;
F_46 (rpc->pci_controller.of_node, child) {
int V_42 ;
if ( ! V_77 -> type ||
F_45 ( V_77 -> type , L_6 ) != 0 )
continue;
...
F_5 ( V_7 , 0x03ff0000 , F_50 ( 0 ) ) ;
F_5 ( V_7 , V_96 , F_51 ( 0 ) ) ;
F_5 ( V_7 , 0x08021814 , F_52 ( 0 ) ) ;
F_5 ( V_7 , 0x00800001 , F_53 ( 0 ) ) ;
F_5 ( V_7 , 0x28801814 , F_54 ( 0 ) ) ;
F_5 ( V_7 , 0x03ff0000 , F_50 ( 1 ) ) ;
F_5 ( V_7 , V_96 , F_51 ( 1 ) ) ;
F_5 ( V_7 , 0x08021814 , F_52 ( 1 ) ) ;
F_5 ( V_7 , 0x06040001 , F_53 ( 1 ) ) ;
F_5 ( V_7 , 0x28801814 , F_54 ( 1 ) ) ;
V_78 = F_23 ( V_36 , V_7 ) ;
if ( V_78 )
goto V_84;
...
if ( V_49 == V_56 ) {
F_5 ( V_7 , 0x03ff0001 , F_50 ( 0 ) ) ;
F_5 ( V_7 , 0x03ff0001 , F_50 ( 1 ) ) ;
F_9 ( V_7 , 0 , V_66 , 0 ,
V_101 ,
V_96 ) ;
F_8 ( V_7 , 0 , V_66 , 0 ,
...
int F_57 ( const struct V_103 * V_36 , T_3 V_11 , T_3 V_104 )
{
return F_58 ( V_36 , V_11 , V_104 ) ;
}
int F_59 ( struct V_103 * V_36 )
{
return 0 ;
}
