...
static void F_48 ( struct V_80 * V_81 ,
struct V_48 * V_49 )
{
struct V_42 * V_66 = F_38 ( V_81 , struct V_42 , V_56 ) ;
struct V_16 * V_17 = V_66 -> V_18 . V_17 ;
...
void F_54 ( struct V_92 * V_93 , struct V_70 * V_71 )
{
struct V_94 * V_94 = F_55 ( V_93 ) ;
struct V_16 * V_17 = V_93 -> V_17 ;
struct V_19 * V_20 = V_17 -> V_21 ;
struct V_9 * V_9 = F_56 ( V_94 -> V_91 ) ;
struct V_11 * V_12 = V_9 -> V_54 ;
struct V_42 * V_42 = F_53 ( & V_9 -> V_18 ) ;
int V_95 ;
...
V_95 = V_97 -> V_95 ;
V_94 -> V_102 =
F_57 ( V_20 , & V_94 -> V_103 ,
V_104 ,
V_95 ) ;
}
static void
F_58 ( struct V_77 * V_91 , int V_71 )
{
struct V_16 * V_17 = V_91 -> V_17 ;
struct V_19 * V_20 = V_17 -> V_21 ;
struct V_9 * V_9 , * V_10 ;
...
V_12 -> V_112 = true ;
F_60 ( V_91 , V_12 -> V_28 ) ;
F_61 ( & V_10 -> V_18 , V_113 , 0 ) ;
F_62 ( & V_10 -> V_18 , V_114 ,
0 , 0 , V_106 -> V_111 ) ;
if ( F_63 ( V_12 -> V_49 ) ||
V_106 -> V_109 == 1 ) {
F_64 ( & V_10 -> V_18 , & V_12 -> V_49 -> V_18 ) ;
}
} else {
V_12 -> V_28 = F_65 ( V_91 , V_94 -> V_115 ) ;
if ( V_12 -> V_28 == - 1 )
F_9 ( L_11 ) ;
V_12 -> V_112 = false ;
F_60 ( V_91 , V_12 -> V_28 ) ;
...
V_32 = F_66 ( & V_42 -> V_52 -> V_56 ,
V_12 -> V_117 ) ;
V_68 = F_67 ( & V_42 -> V_52 -> V_56 ,
V_42 -> V_57 ,
V_12 -> V_117 , V_32 ) ;
...
V_12 -> V_55 = true ;
F_14 ( V_42 -> V_52 , V_10 ) ;
V_107 = F_69 ( V_12 -> V_117 ) ;
V_108 = F_69 ( V_42 -> V_52 -> V_56 . V_118 ) ;
V_61 = F_70 ( V_107 , V_108 ) ;
F_18 ( V_9 , V_61 ) ;
F_71 ( & V_10 -> V_18 , V_119 , 0 ,
V_12 -> V_28 ) ;
V_68 = F_72 ( & V_42 -> V_52 -> V_56 ) ;
...
static bool F_77 ( struct V_77 * V_91 ,
const struct V_70 * V_71 ,
struct V_70 * V_124 )
{
struct V_11 * V_12 ;
struct V_9 * V_9 = F_56 ( V_91 ) ;
struct V_96 * V_97 ;
int V_125 = 24 ;
V_12 = V_9 -> V_54 ;
V_12 -> V_117 = F_78 ( V_124 -> clock , V_125 ) ;
...
F_79 ( V_124 , 0 ) ;
V_97 = V_12 -> V_49 -> V_98 ;
V_97 -> V_129 = F_80 ( V_97 -> V_130 ) ;
V_97 -> V_95 = F_81 ( V_97 -> V_130 ) ;
F_7 ( L_15 , V_97 ,
V_97 -> V_129 , V_97 -> V_95 ) ;
return true ;
}
static void F_82 ( struct V_77 * V_91 )
{
struct V_42 * V_42 ;
struct V_9 * V_9 , * V_10 ;
struct V_11 * V_12 ;
...
V_12 -> V_57 = V_42 -> V_57 ;
if ( V_106 -> V_111 == - 1 ) {
V_106 -> V_111 = F_65 ( & V_10 -> V_18 , - 1 ) ;
V_10 -> V_26 = F_1 ( V_106 -> V_111 ) ;
F_60 ( V_91 , V_106 -> V_111 ) ;
}
F_7 ( L_17 , V_106 -> V_111 , V_10 -> V_26 ) ;
}
static void
F_83 ( struct V_77 * V_91 ,
struct V_70 * V_71 ,
struct V_70 * V_124 )
{
F_7 ( L_6 ) ;
...
F_86 ( V_17 , & V_9 -> V_18 , & V_138 ,
V_139 , NULL ) ;
F_87 ( V_91 , & V_140 ) ;
V_12 = V_9 -> V_54 ;
V_12 -> V_49 = V_49 ;
V_12 -> V_10 = F_56 ( V_134 ) ;
V_9 -> V_141 = true ;
return V_9 ;
}
int
F_88 ( struct V_42 * V_42 )
{
struct V_16 * V_17 = V_42 -> V_18 . V_17 ;
if ( ! V_42 -> V_142 -> V_143 )
return 0 ;
V_42 -> V_56 . V_144 = & V_145 ;
return F_89 ( & V_42 -> V_56 , V_17 ,
...
return 0 ;
V_68 = F_91 ( & V_42 -> V_142 -> V_146 , V_150 , V_147 ,
1 ) ;
if ( V_68 ) {
if ( V_147 [ 0 ] & V_151 ) {
F_7 ( L_19 ) ;
...
int V_68 = 0 ;
bool V_156 ;
V_155 = F_91 ( & V_42 -> V_142 -> V_146 ,
V_157 , V_154 , 8 ) ;
V_158:
if ( V_155 == 8 ) {
F_7 ( L_21 , V_154 [ 0 ] , V_154 [ 1 ] , V_154 [ 2 ] ) ;
V_68 = F_94 ( & V_42 -> V_56 , V_154 , & V_156 ) ;
if ( V_156 ) {
for ( V_153 = 0 ; V_153 < 3 ; V_153 ++ ) {
int V_159 ;
V_159 = F_95 ( & V_42 -> V_142 -> V_146 ,
V_157 + 1 , & V_154 [ 1 ] , 3 ) ;
if ( V_159 == 3 )
break;
}
...
static int F_96 ( struct V_161 * V_162 , void * V_163 )
{
