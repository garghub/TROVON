...
return - V_115 ;
if ( ! F_45 ( & V_117 -> V_99 -> V_121 [ 0 ] . V_100 ) )
return - V_115 ;
V_64 = - V_20 ;
V_1 = F_46 () ;
if ( V_1 == NULL ) {
...
F_29 ( V_91 ) ;
V_91 -> V_93 = F_47 ( F_32 ( V_117 ) ) ;
V_91 -> V_98 = F_48 ( V_117 ) ;
V_91 -> V_1 = V_1 ;
V_1 -> V_151 = V_152 ;
V_1 -> V_153 = F_31 ;
V_1 -> V_154 = F_39 ;
...
static void F_55 ( struct V_104 * V_117 )
{
struct V_91 * V_91 = F_56 ( V_117 ) ;
...
static int F_58 ( struct V_104 * V_117 )
{
struct V_91 * V_91 = F_56 ( V_117 ) ;
struct V_1 * V_1 = V_91 -> V_1 ;
F_59 ( V_1 ) ;
...
static int F_60 ( struct V_104 * V_117 )
{
struct V_91 * V_91 = F_56 ( V_117 ) ;
struct V_1 * V_1 = V_91 -> V_1 ;
return F_61 ( V_1 ) ;
