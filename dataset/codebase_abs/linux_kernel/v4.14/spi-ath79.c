...
static inline void F_3 ( struct V_1 * V_2 , unsigned int V_3 , T_1 V_5 )
{
F_4 ( V_5 , V_2 -> V_4 + V_3 ) ;
}
...
static inline void F_7 ( struct V_1 * V_2 , unsigned int V_9 )
{
if ( V_9 > V_2 -> V_10 )
F_8 ( V_9 - V_2 -> V_10 ) ;
}
...
static T_1 F_24 ( struct V_6 * V_7 , unsigned int V_9 ,
T_1 V_33 , T_2 V_34 )
{
struct V_1 * V_2 = F_5 ( V_7 ) ;
T_1 V_35 = V_2 -> V_16 ;
