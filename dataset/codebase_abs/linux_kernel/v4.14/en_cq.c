...
V_35 = 1 ;
V_2 -> V_39 . V_54 = V_55 ;
V_16 = F_16 ( V_15 -> V_21 , V_2 -> V_19 , & V_2 -> V_28 . V_56 ,
& V_15 -> V_57 , V_2 -> V_28 . V_41 . V_58 , & V_2 -> V_39 ,
V_2 -> V_24 , 0 , V_35 ) ;
if ( V_16 )
goto V_46;
V_2 -> V_39 . V_4 = F_1 ;
...
case V_59 :
V_2 -> V_39 . V_60 = V_61 ;
F_17 ( V_2 -> V_21 , & V_2 -> V_62 , V_63 ,
V_64 ) ;
F_18 ( & V_2 -> V_62 ) ;
break;
case V_43 :
V_2 -> V_39 . V_60 = V_65 ;
F_19 ( V_2 -> V_21 , & V_2 -> V_62 , V_66 , 64 ) ;
F_18 ( & V_2 -> V_62 ) ;
break;
case V_67 :
V_2 -> V_68 = false ;
...
void F_29 ( struct V_5 * V_6 , struct V_7 * V_2 )
{
F_30 ( & V_2 -> V_39 , V_71 , V_6 -> V_15 -> V_72 ,
& V_6 -> V_15 -> V_73 ) ;
}
