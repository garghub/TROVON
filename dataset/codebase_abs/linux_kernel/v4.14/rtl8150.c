...
static int F_88 ( struct V_46 * V_32 ,
struct V_139 * V_140 )
{
T_1 * V_1 = F_23 ( V_32 ) ;
short V_141 , V_142 ;
...
V_140 -> V_151 . V_154 = V_1 -> V_33 ;
F_1 ( V_1 , V_155 , 2 , & V_142 ) ;
F_1 ( V_1 , V_156 , 2 , & V_141 ) ;
if ( V_142 & V_157 ) {
T_7 V_158 = ( ( V_141 & ( V_159 | V_160 ) ) ?
V_161 : V_162 ) ;
V_140 -> V_151 . V_158 = V_158 ;
V_140 -> V_151 . V_163 = V_164 ;
if ( V_158 == V_161 )
V_140 -> V_151 . V_165 = ( V_141 & V_160 ) ?
V_166 : V_167 ;
else
V_140 -> V_151 . V_165 = ( V_141 & V_168 ) ?
V_166 : V_167 ;
} else {
V_140 -> V_151 . V_163 = V_169 ;
V_140 -> V_151 . V_158 = ( ( V_142 & V_170 ) ?
V_161 : V_162 ) ;
V_140 -> V_151 . V_165 = ( V_142 & V_171 ) ?
V_166 : V_167 ;
}
F_89 ( V_140 -> V_172 . V_143 ,
V_143 ) ;
return 0 ;
}
