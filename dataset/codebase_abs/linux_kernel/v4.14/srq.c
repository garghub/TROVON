...
static int F_41 ( struct V_1 * V_2 , struct V_9 * V_10 ,
struct V_15 * V_16 )
{
T_1 V_43 [ F_20 ( V_107 ) ] = { 0 } ;
void * V_45 ;
void * V_108 ;
void * V_29 ;
int V_47 ;
...
int V_49 ;
V_47 = F_9 ( V_16 ) ;
V_48 = F_21 ( V_109 ) + V_47 ;
V_45 = F_22 ( V_48 , V_51 ) ;
if ( ! V_45 )
return - V_52 ;
V_108 = F_23 ( V_109 , V_45 , V_110 ) ;
V_29 = F_23 ( V_108 , V_108 , V_29 ) ;
F_10 ( V_29 , V_16 ) ;
memcpy ( F_23 ( V_108 , V_108 , V_29 . V_46 ) , V_16 -> V_46 , V_47 ) ;
if ( V_16 -> type == V_111 ) {
F_11 ( V_108 , V_108 , V_112 , V_113 ) ;
if ( V_16 -> V_31 & V_114 )
F_11 ( V_108 , V_108 , V_115 , V_116 ) ;
F_11 ( V_108 , V_108 ,
V_117 . V_118 ,
V_16 -> V_119 ) ;
}
F_11 ( V_108 , V_108 , V_79 , V_16 -> V_79 ) ;
F_11 ( V_108 , V_108 , V_42 , V_16 -> V_42 ) ;
F_11 ( V_109 , V_45 , V_54 , V_120 ) ;
V_49 = F_24 ( V_2 , V_45 , V_48 , V_43 ,
sizeof( V_43 ) ) ;
F_25 ( V_45 ) ;
if ( ! V_49 )
V_10 -> V_3 = F_15 ( V_107 , V_43 , V_121 ) ;
return V_49 ;
}
static int F_42 ( struct V_1 * V_2 , struct V_9 * V_10 )
{
T_1 V_16 [ F_20 ( V_122 ) ] = { 0 } ;
T_1 V_68 [ F_20 ( V_123 ) ] = { 0 } ;
F_11 ( V_122 , V_16 , V_54 , V_124 ) ;
F_11 ( V_122 , V_16 , V_121 , V_10 -> V_3 ) ;
return F_24 ( V_2 , V_16 , sizeof( V_16 ) , V_68 , sizeof( V_68 ) ) ;
}
static int F_43 ( struct V_1 * V_2 ,
struct V_9 * V_10 ,
T_2 V_36 )
{
T_1 V_68 [ F_20 ( V_63 ) ] = { 0 } ;
T_1 V_16 [ F_20 ( V_62 ) ] = { 0 } ;
F_11 ( V_62 , V_16 , V_54 , V_64 ) ;
F_11 ( V_62 , V_16 , V_65 , V_125 ) ;
F_11 ( V_62 , V_16 , V_67 , V_10 -> V_3 ) ;
F_11 ( V_62 , V_16 , V_36 , V_36 ) ;
return F_24 ( V_2 , V_16 , sizeof( V_16 ) , V_68 , sizeof( V_68 ) ) ;
}
static int F_44 ( struct V_1 * V_2 , struct V_9 * V_10 ,
struct V_15 * V_68 )
{
T_1 V_16 [ F_20 ( V_126 ) ] = { 0 } ;
T_1 * V_127 ;
int V_128 = F_21 ( V_129 ) ;
void * V_108 ;
int V_49 ;
V_127 = F_22 ( V_128 , V_51 ) ;
if ( ! V_127 )
return - V_52 ;
F_11 ( V_126 , V_16 , V_54 , V_130 ) ;
F_11 ( V_126 , V_16 , V_121 , V_10 -> V_3 ) ;
V_49 = F_24 ( V_2 , V_16 , sizeof( V_16 ) , V_127 , V_128 ) ;
if ( V_49 )
goto V_68;
V_108 = F_23 ( V_129 , V_127 , V_110 ) ;
F_14 ( F_23 ( V_108 , V_108 , V_29 ) , V_68 ) ;
if ( F_15 ( V_108 , V_108 , V_72 ) != V_131 )
V_68 -> V_31 |= V_74 ;
V_68 -> V_132 =
F_15 ( V_108 , V_108 ,
V_117 . V_133 ) ;
...
switch ( V_10 -> V_139 . V_140 ) {
case V_141 :
return F_29 ( V_2 , V_10 , V_16 ) ;
case V_142 :
return F_41 ( V_2 , V_10 , V_16 ) ;
default:
...
int F_47 ( struct V_1 * V_2 , struct V_9 * V_10 ,
struct V_15 * V_16 )
{
int V_49 ;
struct V_5 * V_6 = & V_2 -> V_7 . V_8 ;
switch ( V_16 -> type ) {
case V_143 :
V_10 -> V_139 . V_140 = V_141 ;
break;
case V_111 :
V_10 -> V_139 . V_140 = V_142 ;
break;
default:
V_10 -> V_139 . V_140 = V_144 ;
}
V_49 = F_45 ( V_2 , V_10 , V_16 ) ;
if ( V_49 )
return V_49 ;
F_48 ( & V_10 -> V_13 , 1 ) ;
F_49 ( & V_10 -> free ) ;
F_50 ( & V_6 -> V_11 ) ;
V_49 = F_51 ( & V_6 -> V_12 , V_10 -> V_3 , V_10 ) ;
F_52 ( & V_6 -> V_11 ) ;
if ( V_49 ) {
