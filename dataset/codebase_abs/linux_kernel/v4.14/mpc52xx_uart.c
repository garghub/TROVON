...
V_9 -> V_50 = V_50 ;
V_9 -> V_238 = & V_239 ;
V_9 -> V_88 = V_236 . V_240 ;
V_9 -> V_159 = F_136 ( V_236 . V_240 , sizeof( struct V_1 ) ) ;
V_9 -> V_54 = F_37 ( V_52 , 0 ) ;
if ( V_9 -> V_159 == NULL )
return - V_160 ;
F_156 ( L_29 ,
...
struct V_235 V_236 ;
int V_95 ;
for ( V_244 = 0 ; V_244 < V_237 ; V_244 ++ )
if ( V_234 [ V_244 ] == V_243 -> V_90 . V_245 )
break;
if ( V_244 >= V_237 )
return - V_160 ;
F_156 ( L_31 ,
V_234 [ V_244 ] , V_244 ) ;
V_50 = F_160 ( V_243 -> V_90 . V_245 ) ;
if ( V_50 == 0 ) {
F_80 ( & V_243 -> V_90 , L_28 ) ;
return - V_160 ;
}
V_9 = & V_229 [ V_244 ] ;
F_161 ( & V_9 -> V_116 ) ;
...
V_9 -> V_238 = & V_239 ;
V_9 -> V_90 = & V_243 -> V_90 ;
V_95 = F_159 ( V_243 -> V_90 . V_245 , 0 , & V_236 ) ;
if ( V_95 )
return V_95 ;
V_9 -> V_88 = V_236 . V_240 ;
if ( ! V_9 -> V_88 ) {
F_80 ( & V_243 -> V_90 , L_32 ) ;
return - V_160 ;
}
V_99 -> V_249 ( V_9 , V_243 -> V_90 . V_245 ) ;
if ( V_9 -> V_54 == 0 ) {
F_80 ( & V_243 -> V_90 , L_33 ) ;
return - V_160 ;
}
F_80 ( & V_243 -> V_90 , L_34 ,
( void * ) V_9 -> V_88 , V_9 -> V_54 , V_9 -> V_50 ) ;
V_95 = F_168 ( & V_250 , V_9 ) ;
if ( V_95 )
return V_95 ;
