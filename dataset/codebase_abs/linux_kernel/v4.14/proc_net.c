...
static int F_29 ( const struct V_36 * V_36 , struct V_37 * V_38 ,
T_1 V_39 , unsigned int V_40 )
{
struct V_6 * V_6 = F_30 ( V_36 -> V_31 ) ;
struct V_1 * V_1 ;
V_1 = F_18 ( V_6 ) ;
F_31 ( V_6 , V_38 ) ;
if ( V_1 != NULL ) {
V_38 -> V_41 = V_1 -> V_35 -> V_41 ;
F_8 ( V_1 ) ;
}
return 0 ;
}
...
V_1 = F_18 ( F_33 ( V_8 ) ) ;
if ( V_1 != NULL ) {
V_44 = F_34 ( V_1 -> V_35 , V_8 , V_43 ) ;
F_8 ( V_1 ) ;
}
return V_44 ;
}
static T_2 int F_35 ( struct V_1 * V_1 )
{
...
V_46 -> V_54 = 3 ;
V_46 -> V_4 = & V_55 ;
memcpy ( V_46 -> V_56 , L_1 , 4 ) ;
V_48 = F_37 ( V_1 -> V_57 , 0 ) ;
if ( ! F_38 ( V_48 ) )
V_48 = V_46 -> V_48 ;
V_49 = F_39 ( V_1 -> V_57 , 0 ) ;
if ( ! F_40 ( V_49 ) )
V_49 = V_46 -> V_49 ;
F_41 ( V_46 , V_48 , V_49 ) ;
V_18 = - V_58 ;
V_47 = F_42 ( V_1 , L_2 , V_46 ) ;
if ( ! V_47 )
goto V_59;
V_1 -> V_35 = V_46 ;
V_1 -> V_60 = V_47 ;
...
static T_5 void F_44 ( struct V_1 * V_1 )
{
F_45 ( L_2 , V_1 -> V_35 ) ;
F_43 ( V_1 -> V_35 ) ;
}
