...
if ( ! F_42 ( V_2 ) ) {
V_52 = F_43 ( V_2 , V_39 -> V_49 , V_39 -> V_48 ,
V_39 -> V_58 , V_9 ) ;
if ( F_31 ( V_52 ) )
goto V_57;
}
#ifdef F_44
if ( F_31 ( F_40 ( V_2 ) -> V_59 ) ) {
struct V_60 * V_61 = F_45 ( V_60 ) ;
T_2 V_62 = F_40 ( V_2 ) -> V_59 ;
V_61 [ V_62 & 0xFF ] . V_63 ++ ;
...
V_51 = F_46 ( V_2 ) ;
if ( V_51 -> V_68 == V_69 ) {
F_47 ( V_10 , V_70 , V_2 -> V_65 ) ;
} else if ( V_51 -> V_68 == V_71 ) {
F_47 ( V_10 , V_72 , V_2 -> V_65 ) ;
...
int F_51 ( struct V_1 * V_2 , struct V_8 * V_9 , struct V_80 * V_81 , struct V_8 * V_82 )
{
const struct V_38 * V_39 ;
struct V_10 * V_10 ;
T_2 V_65 ;
...
goto V_41;
V_10 = F_3 ( V_9 ) ;
F_47 ( V_10 , V_84 , V_2 -> V_65 ) ;
V_2 = F_52 ( V_2 , V_18 ) ;
if ( ! V_2 ) {
F_20 ( V_10 , V_40 ) ;
goto V_27;
}
if ( ! F_53 ( V_2 , sizeof( struct V_38 ) ) )
goto V_85;
V_39 = F_2 ( V_2 ) ;
if ( V_39 -> V_43 < 5 || V_39 -> V_86 != 4 )
goto V_85;
F_54 ( V_87 != V_88 + V_89 ) ;
F_54 ( V_90 != V_88 + V_91 ) ;
F_54 ( V_92 != V_88 + V_93 ) ;
F_55 ( V_10 ,
V_88 + ( V_39 -> V_58 & V_94 ) ,
F_56 (unsigned short, 1 , skb_shinfo(skb)->gso_segs) ) ;
if ( ! F_53 ( V_2 , V_39 -> V_43 * 4 ) )
goto V_85;
V_39 = F_2 ( V_2 ) ;
if ( F_31 ( F_57 ( ( T_1 * ) V_39 , V_39 -> V_43 ) ) )
goto V_95;
V_65 = F_58 ( V_39 -> V_96 ) ;
if ( V_2 -> V_65 < V_65 ) {
F_20 ( V_10 , V_97 ) ;
...
V_2 -> V_98 = V_2 -> V_99 + V_39 -> V_43 * 4 ;
memset ( F_29 ( V_2 ) , 0 , sizeof( struct V_100 ) ) ;
F_29 ( V_2 ) -> V_101 = V_2 -> V_102 ;
F_60 ( V_2 ) ;
return F_25 ( V_34 , V_103 ,
