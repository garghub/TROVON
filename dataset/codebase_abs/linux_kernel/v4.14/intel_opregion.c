...
V_7 -> V_25 = 1 ;
V_7 -> V_22 = 1 ;
if ( F_1 ( V_2 , V_176 , 0 , & V_175 ) == 0 ) {
V_175 <<= 1 ;
V_7 -> V_25 |= V_175 ;
}
if ( F_1 ( V_2 , V_177 , 0 , & V_175 ) == 0 ) {
V_7 -> V_22 |= V_175 ;
V_174 = true ;
}
if ( F_1 ( V_2 , V_178 , 0 , & V_175 ) == 0 ) {
T_1 V_179 = V_175 & 0x7ff ;
T_1 V_180 = V_175 & ~ 0xfff ;
V_175 = ( V_180 << 4 ) | ( V_179 << 1 ) | 1 ;
if ( V_174 ) {
T_1 V_181 = V_7 -> V_22 ;
if ( ( V_181 & V_175 ) != V_181 )
F_3 ( L_28 , V_181 , V_175 ) ;
} else {
V_7 -> V_22 |= V_175 ;
}
}
...
static int F_53 ( const struct V_182 * V_183 )
{
F_17 ( L_30
L_31 , V_183 -> V_184 ) ;
return 1 ;
...
const char * V_187 = V_188 . V_171 ;
int V_119 ;
if ( ! V_187 || ! * V_187 )
return - V_189 ;
V_119 = F_55 ( & V_186 , V_187 , & V_2 -> V_10 . V_9 -> V_40 ) ;
if ( V_119 ) {
F_43 ( L_32 ,
V_187 , V_119 ) ;
return V_119 ;
}
if ( F_56 ( V_186 -> V_114 , V_186 -> V_190 ) ) {
V_7 -> V_171 = F_57 ( V_186 -> V_114 , V_186 -> V_190 , V_191 ) ;
if ( V_7 -> V_171 ) {
F_17 ( L_33 , V_187 ) ;
V_7 -> V_172 = V_7 -> V_171 ;
V_7 -> V_192 = V_186 -> V_190 ;
V_119 = 0 ;
} else {
V_119 = - V_193 ;
}
...
struct V_8 * V_9 = V_2 -> V_10 . V_9 ;
T_1 V_194 , V_195 ;
char V_196 [ sizeof( V_197 ) ] ;
int V_198 = 0 ;
void * V_39 ;
const void * V_172 ;
T_1 V_192 ;
F_60 ( sizeof( struct V_199 ) != 0x100 ) ;
F_60 ( sizeof( struct V_117 ) != 0x100 ) ;
F_60 ( sizeof( struct V_6 ) != 0x100 ) ;
F_60 ( sizeof( struct V_64 ) != 0x100 ) ;
F_60 ( sizeof( struct V_200 ) != 0x400 ) ;
F_61 ( V_9 , V_201 , & V_194 ) ;
F_3 ( L_35 , V_194 ) ;
if ( V_194 == 0 ) {
F_3 ( L_36 ) ;
return - V_202 ;
...
F_62 ( & V_7 -> F_33 , F_33 ) ;
V_39 = F_63 ( V_194 , V_203 , V_204 ) ;
if ( ! V_39 )
return - V_193 ;
memcpy ( V_196 , V_39 , sizeof( V_196 ) ) ;
if ( memcmp ( V_196 , V_197 , 16 ) ) {
F_3 ( L_37 ) ;
V_198 = - V_23 ;
goto V_205;
}
V_7 -> V_162 = V_39 ;
V_7 -> V_173 = V_39 + V_206 ;
V_195 = V_7 -> V_162 -> V_195 ;
if ( V_195 & V_207 ) {
F_3 ( L_38 ) ;
V_7 -> V_118 = V_39 + V_208 ;
}
if ( V_195 & V_209 ) {
F_3 ( L_39 ) ;
V_7 -> F_1 = V_39 + V_210 ;
...
if ( F_64 ( V_215 ) )
goto V_214;
if ( V_7 -> V_162 -> V_216 >= 2 && V_7 -> V_65 &&
V_7 -> V_65 -> V_170 && V_7 -> V_65 -> V_217 ) {
V_7 -> V_170 = F_63 ( V_7 -> V_65 -> V_170 ,
V_7 -> V_65 -> V_217 ,
V_204 ) ;
V_172 = V_7 -> V_170 ;
V_192 = V_7 -> V_65 -> V_217 ;
if ( F_56 ( V_172 , V_192 ) ) {
F_17 ( L_42 ) ;
V_7 -> V_172 = V_172 ;
V_7 -> V_192 = V_192 ;
...
static int F_65 ( const struct V_182 * V_183 )
{
F_66 ( L_46 , V_183 -> V_184 ) ;
return 1 ;
}
int
F_67 ( struct V_1 * V_2 )
