...
F_18 ( & V_2 -> V_33 ) ;
F_19 (pos, &obj->pt_list) {
struct V_34 * V_35 = F_20 ( V_32 , struct V_34 , V_36 ) ;
...
int V_39 ;
F_13 ( V_13 , L_11 , V_7 ,
F_23 ( V_7 , V_38 , sizeof( V_38 ) ) ,
F_9 ( F_24 ( V_7 -> V_15 ) ) ) ;
if ( F_25 ( V_7 -> V_15 ) ) {
struct V_40 * V_41 = F_26 ( V_7 -> V_15 ) ;
...
static int F_27 ( struct V_12 * V_13 , void * V_44 )
{
struct V_31 * V_32 ;
F_28 ( V_13 , L_12 ) ;
F_18 ( & V_4 ) ;
F_19 (pos, &sync_timeline_list_head) {
struct V_1 * V_2 =
F_20 ( V_32 , struct V_1 ,
V_5 ) ;
F_17 ( V_13 , V_2 ) ;
F_16 ( V_13 , '\n' ) ;
}
...
F_28 ( V_13 , L_13 ) ;
F_18 ( & V_8 ) ;
F_19 (pos, &sync_file_list_head) {
struct V_7 * V_7 =
F_20 ( V_32 , struct V_7 , V_9 ) ;
F_22 ( V_13 , V_7 ) ;
F_16 ( V_13 , '\n' ) ;
}
F_21 ( & V_8 ) ;
...
{
return F_30 ( V_46 , F_27 , V_45 -> V_47 ) ;
}
static T_1 int F_31 ( void )
{
V_48 = F_32 ( L_14 , NULL ) ;
F_33 ( L_15 , 0444 , V_48 , NULL ,
& V_49 ) ;
F_33 ( L_16 , 0644 , V_48 , NULL ,
& V_50 ) ;
return 0 ;
}
void F_34 ( void )
