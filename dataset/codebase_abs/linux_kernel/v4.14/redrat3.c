...
L_51 ,
V_137 == V_142 ? L_52 : L_53 ) ;
F_64 ( V_2 -> V_39 , V_2 -> V_143 , sizeof( V_2 -> V_143 ) ) ;
V_31 -> V_144 = V_2 -> V_141 ;
V_31 -> V_145 = V_2 -> V_143 ;
F_65 ( V_2 -> V_39 , & V_31 -> V_146 ) ;
V_31 -> V_5 . V_147 = V_5 ;
V_31 -> V_68 = V_2 ;
V_31 -> V_148 = V_149 ;
V_31 -> V_150 = F_66 ( V_151 ) ;
V_31 -> V_152 = F_66 ( V_153 ) ;
...
static int F_69 ( struct V_163 * V_164 ,
const struct V_165 * V_166 )
{
struct V_38 * V_39 = F_70 ( V_164 ) ;
struct V_21 * V_5 = & V_164 -> V_5 ;
struct V_167 * V_168 ;
struct V_1 * V_2 ;
struct V_169 * V_170 ;
struct V_169 * V_57 = NULL ;
struct V_169 * V_171 = NULL ;
struct V_169 * V_126 = NULL ;
T_3 V_172 , V_173 ;
int V_63 , V_22 ;
int V_174 = - V_43 ;
V_168 = V_164 -> V_175 ;
for ( V_22 = 0 ; V_22 < V_168 -> V_176 . V_177 ; ++ V_22 ) {
V_170 = & V_168 -> V_178 [ V_22 ] . V_176 ;
V_172 = V_170 -> V_127 ;
V_173 = V_170 -> V_179 ;
if ( ( ( V_172 & V_180 ) == V_46 ) &&
( ( V_173 & V_181 ) ==
...
F_10 ( V_5 , L_55 ,
V_170 -> V_127 ) ;
if ( V_170 -> V_127 == V_183 )
V_57 = V_170 ;
if ( V_170 -> V_127 == V_184 )
V_171 = V_170 ;
}
if ( ( V_126 == NULL ) &&
( ( V_172 & V_180 ) == V_70 ) &&
...
F_28 ( V_57 -> V_58 ) ,
F_44 , V_2 ) ;
V_2 -> V_53 -> V_188 = V_2 -> V_60 ;
V_2 -> V_53 -> V_189 |= V_190 ;
V_63 = F_73 ( V_39 , V_171 -> V_127 ) ;
F_74 ( V_2 -> V_54 , V_39 , V_63 , V_2 -> V_59 ,
F_28 ( V_57 -> V_58 ) ,
F_44 , V_2 ) ;
V_2 -> V_54 -> V_188 = V_2 -> V_60 ;
V_2 -> V_54 -> V_189 |= V_190 ;
F_38 ( V_2 ) ;
F_39 ( V_2 ) ;
V_2 -> V_30 = 38000 ;
F_57 ( & V_2 -> V_135 , 0 ) ;
...
if ( ! V_2 -> V_56 )
goto V_187;
V_2 -> V_191 . V_192 = 0xc0 ;
V_2 -> V_191 . V_193 = V_194 ;
V_2 -> V_191 . V_195 = F_75 ( 1 ) ;
F_76 ( V_2 -> V_56 , V_39 , F_19 ( V_39 , 0 ) ,
( unsigned char * ) & V_2 -> V_191 ,
& V_2 -> V_196 , sizeof( V_2 -> V_196 ) ,
F_59 , V_2 ) ;
V_2 -> V_197 . V_192 = 0xc0 ;
V_2 -> V_197 . V_193 = V_198 ;
V_2 -> V_197 . V_195 = F_75 ( 1 ) ;
F_76 ( V_2 -> V_55 , V_39 , F_19 ( V_39 , 0 ) ,
( unsigned char * ) & V_2 -> V_197 ,
& V_2 -> V_199 , sizeof( V_2 -> V_199 ) ,
F_60 , V_2 ) ;
V_2 -> V_133 . V_141 = L_58 ;
V_2 -> V_133 . V_200 = L_59 ;
V_2 -> V_133 . V_201 = F_54 ;
V_174 = F_77 ( & V_164 -> V_5 , & V_2 -> V_133 ) ;
if ( V_174 )
goto V_187;
V_2 -> V_31 = F_62 ( V_2 ) ;
if ( ! V_2 -> V_31 ) {
...
{
struct V_38 * V_39 = F_70 ( V_164 ) ;
struct V_1 * V_2 = F_81 ( V_164 ) ;
F_78 ( V_164 , NULL ) ;
F_82 ( V_2 -> V_31 ) ;
F_79 ( & V_2 -> V_133 ) ;
F_24 ( V_2 , V_39 ) ;
}
static int F_83 ( struct V_163 * V_164 , T_6 V_203 )
{
struct V_1 * V_2 = F_81 ( V_164 ) ;
F_84 ( & V_2 -> V_133 ) ;
F_25 ( V_2 -> V_53 ) ;
