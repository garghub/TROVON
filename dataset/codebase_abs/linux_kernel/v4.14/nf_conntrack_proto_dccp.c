...
F_20 ( & V_3 -> V_62 ) ;
V_36 = V_3 -> V_35 . V_5 . V_36 [ V_54 ] ;
V_55 = V_3 -> V_35 . V_5 . V_26 ;
V_56 = V_27 [ V_36 ] [ type ] [ V_55 ] ;
switch ( V_56 ) {
case V_33 :
if ( V_55 == V_63 &&
V_36 == V_39 ) {
V_3 -> V_35 . V_5 . V_36 [ V_54 ] = V_28 ;
V_3 -> V_35 . V_5 . V_36 [ ! V_54 ] = V_39 ;
}
break;
case V_64 :
if ( V_55 == V_33 )
...
V_3 -> V_35 . V_5 . V_42 = V_54 ;
V_3 -> V_35 . V_5 . V_40 = type ;
V_3 -> V_35 . V_5 . V_26 = V_56 ;
F_23 ( & V_3 -> V_62 ) ;
if ( V_56 != V_55 )
F_24 ( V_70 , V_3 ) ;
F_25 ( V_3 , V_51 , V_7 , V_22 [ V_56 ] ) ;
return V_61 ;
}
static int F_26 ( struct V_2 * V_2 , struct V_21 * V_71 ,
struct V_6 * V_7 , unsigned int V_8 ,
T_1 V_52 , unsigned int V_72 )
{
struct V_11 V_24 , * V_13 ;
...
if ( V_2 -> V_3 . V_78 && V_72 == V_79 &&
F_27 ( V_7 , V_72 , V_8 , V_75 , V_44 ,
V_52 ) ) {
V_25 = L_8 ;
goto V_32;
}
...
static void F_29 ( struct V_83 * V_84 , struct V_21 * V_3 )
{
F_30 ( V_84 , L_10 , V_85 [ V_3 -> V_35 . V_5 . V_26 ] ) ;
}
static int F_31 ( struct V_6 * V_7 , struct V_86 * V_87 ,
struct V_21 * V_3 )
{
struct V_86 * V_88 ;
F_20 ( & V_3 -> V_62 ) ;
V_88 = F_32 ( V_7 , V_89 | V_90 ) ;
if ( ! V_88 )
goto V_91;
if ( F_33 ( V_7 , V_92 , V_3 -> V_35 . V_5 . V_26 ) ||
F_33 ( V_7 , V_93 ,
...
static int F_37 ( struct V_86 * V_96 [] , struct V_21 * V_3 )
{
...
if ( ! V_97 )
return 0 ;
V_100 = F_38 ( V_98 , V_99 , V_97 ,
V_101 , NULL ) ;
if ( V_100 < 0 )
return V_100 ;
if ( ! V_98 [ V_92 ] ||
! V_98 [ V_93 ] ||
F_39 ( V_98 [ V_93 ] ) > V_102 ||
F_39 ( V_98 [ V_92 ] ) >= V_68 ) {
return - V_103 ;
}
F_20 ( & V_3 -> V_62 ) ;
V_3 -> V_35 . V_5 . V_26 = F_39 ( V_98 [ V_92 ] ) ;
if ( F_39 ( V_98 [ V_93 ] ) == V_28 ) {
V_3 -> V_35 . V_5 . V_36 [ V_37 ] = V_28 ;
V_3 -> V_35 . V_5 . V_36 [ V_38 ] = V_39 ;
} else {
...
static int F_45 ( struct V_86 * V_98 [] ,
...
if ( V_98 [ V_105 ] ) {
V_22 [ V_105 ] = F_14 ( F_46 ( V_98 [ V_105 ] ) ) * V_109 ;
}
}
return 0 ;
}
static int
F_47 ( struct V_6 * V_7 , const void * V_104 )
{
const unsigned int * V_22 = V_104 ;
int V_105 ;
for ( V_105 = V_107 + 1 ; V_105 < V_108 + 1 ; V_105 ++ ) {
if ( F_48 ( V_7 , V_105 , F_49 ( V_22 [ V_105 ] / V_109 ) ) )
goto V_91;
}
return 0 ;
V_91:
...
static int F_50 ( struct V_2 * V_2 , struct V_111 * V_112 ,
struct V_1 * V_23 )
{
#ifdef F_51
if ( V_112 -> V_113 )
return 0 ;
V_112 -> V_113 = F_52 ( V_114 ,
sizeof( V_114 ) ,
V_115 ) ;
if ( ! V_112 -> V_113 )
return - V_116 ;
V_112 -> V_113 [ 0 ] . V_104 = & V_23 -> V_49 [ V_33 ] ;
V_112 -> V_113 [ 1 ] . V_104 = & V_23 -> V_49 [ V_64 ] ;
V_112 -> V_113 [ 2 ] . V_104 = & V_23 -> V_49 [ V_65 ] ;
V_112 -> V_113 [ 3 ] . V_104 = & V_23 -> V_49 [ V_117 ] ;
V_112 -> V_113 [ 4 ] . V_104 = & V_23 -> V_49 [ V_81 ] ;
V_112 -> V_113 [ 5 ] . V_104 = & V_23 -> V_49 [ V_82 ] ;
V_112 -> V_113 [ 6 ] . V_104 = & V_23 -> V_49 [ V_63 ] ;
...
V_23 -> V_49 [ V_64 ] = 4 * V_122 ;
V_23 -> V_49 [ V_65 ] = 4 * V_122 ;
V_23 -> V_49 [ V_117 ] = 12 * 3600 * V_109 ;
V_23 -> V_49 [ V_81 ] = 64 * V_109 ;
V_23 -> V_49 [ V_82 ] = 64 * V_109 ;
V_23 -> V_49 [ V_63 ] = 2 * V_122 ;
}
return F_50 ( V_2 , V_112 , V_23 ) ;
}
static struct V_111 * F_54 ( struct V_2 * V_2 )
{
