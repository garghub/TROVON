...
unsigned int V_34 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_47 * V_48 = F_23 ( & V_2 -> V_27 ) ;
if ( V_48 ) {
memcpy ( V_6 -> V_8 , V_48 -> V_8 ,
sizeof( V_6 -> V_8 ) ) ;
return;
}
#ifdef F_24
...
F_22 ( V_2 ) ;
for ( V_34 = 0 ; V_34 < V_36 ; ++ V_34 ) {
if ( ! V_6 -> V_8 [ V_34 ] . V_46 )
continue;
V_50 = F_30 ( & V_2 -> V_27 , & V_37 [ V_34 ] . V_38 ) ;
if ( V_50 )
goto V_55;
}
