...
void F_109 ( struct V_84 * exp , struct V_178 * V_179 )
{
F_10 ( & exp -> V_113 ) ;
F_20 ( V_179 -> V_180 >= 0 ) ;
if ( V_179 -> V_181 && V_179 -> V_181 != exp ) {
F_89 ( L_35 ,
exp , V_179 , V_179 -> V_181 ) ;
}
if ( ( V_179 -> V_180 ++ ) == 0 ) {
F_31 ( & V_179 -> V_182 , & exp -> V_112 ) ;
V_179 -> V_181 = exp ;
}
F_16 ( V_18 , L_36 ,
V_179 , exp , V_179 -> V_180 ) ;
F_13 ( & exp -> V_113 ) ;
}
void F_110 ( struct V_84 * exp , struct V_178 * V_179 )
{
F_10 ( & exp -> V_113 ) ;
F_20 ( V_179 -> V_180 > 0 ) ;
if ( V_179 -> V_181 != exp ) {
F_89 ( L_37 ,
V_179 , V_179 -> V_181 , exp ) ;
}
if ( -- V_179 -> V_180 == 0 ) {
F_97 ( & V_179 -> V_182 ) ;
V_179 -> V_181 = NULL ;
...
if ( V_201 == F_125 () )
return;
F_126 ( V_198 , F_123 () , & V_200 ) ;
}
static int F_127 ( void * V_202 )
{
F_128 () ;
F_129 ( & V_203 ) ;
V_201 = F_125 () ;
while ( ! F_120 ( V_196 , & V_197 ) ) {
struct V_199 V_200 = { 0 } ;
F_126 ( V_198 ,
! F_119 ( NULL ) , & V_200 ) ;
F_117 () ;
...
static bool F_137 ( struct V_207 * V_65 ,
struct V_208 * V_209 )
{
bool V_210 ;
F_10 ( & V_65 -> V_211 ) ;
V_210 = ! ! F_69 ( & V_209 -> V_212 ) ;
F_13 ( & V_65 -> V_211 ) ;
return V_210 ;
}
int F_138 ( struct V_207 * V_65 )
{
struct V_208 V_209 ;
struct V_199 V_200 ;
int V_28 ;
F_10 ( & V_65 -> V_211 ) ;
if ( V_65 -> V_213 < V_65 -> V_214 ) {
V_65 -> V_213 ++ ;
F_13 ( & V_65 -> V_211 ) ;
return 0 ;
}
F_107 ( & V_209 . V_215 ) ;
F_139 ( & V_209 . V_212 , & V_65 -> V_216 ) ;
V_209 . V_217 = false ;
F_13 ( & V_65 -> V_211 ) ;
V_200 = F_140 ( V_218 , NULL ) ;
V_28 = F_126 ( V_209 . V_215 ,
F_137 ( V_65 , & V_209 ) ||
V_209 . V_217 ,
& V_200 ) ;
F_10 ( & V_65 -> V_211 ) ;
...
if ( V_209 . V_217 ) {
F_20 ( F_69 ( & V_209 . V_212 ) ) ;
V_28 = - V_219 ;
}
F_13 ( & V_65 -> V_211 ) ;
return V_28 ;
}
void F_141 ( struct V_207 * V_65 )
{
struct V_208 * V_209 ;
F_10 ( & V_65 -> V_211 ) ;
V_65 -> V_213 -- ;
if ( ! F_69 ( & V_65 -> V_216 ) &&
F_142 ( V_65 -> V_213 < V_65 -> V_214 ) ) {
V_209 = F_12 ( V_65 -> V_216 . V_67 ,
struct V_208 , V_212 ) ;
F_97 ( & V_209 -> V_212 ) ;
V_65 -> V_213 ++ ;
F_130 ( & V_209 -> V_215 ) ;
...
T_1 F_143 ( struct V_207 * V_65 )
{
return V_65 -> V_214 ;
}
int F_144 ( struct V_207 * V_65 , T_1 V_220 )
{
struct V_208 * V_209 ;
const char * V_16 ;
T_1 V_221 ;
...
int V_28 ;
int V_46 ;
if ( V_220 > V_223 || V_220 < 1 )
return - V_224 ;
V_16 = V_65 -> V_91 -> V_136 -> V_10 -> V_16 ;
if ( ! strcmp ( V_16 , V_73 ) ) {
if ( V_220 < 2 ) {
F_5 ( L_46 ,
V_65 -> V_91 -> V_136 -> V_52 ) ;
return - V_224 ;
}
if ( V_220 <= V_65 -> V_225 ) {
V_28 = F_145 ( V_65 , V_220 - 1 ) ;
if ( V_28 )
return V_28 ;
}
}
...
int F_145 ( struct V_207 * V_65 , T_2 V_220 )
{
struct V_226 * V_227 ;
T_3 V_228 ;
T_3 V_229 ;
...
int F_146 ( struct V_207 * V_65 , struct V_236 * V_237 )
{
unsigned long V_238 = 0 , V_239 ;
struct V_240 V_241 ;
int V_46 ;
F_147 ( & V_241 ) ;
F_10 ( & V_65 -> V_234 ) ;
F_148 ( V_237 , L_49 ,
( V_242 ) V_241 . V_243 , ( unsigned long ) V_241 . V_244 ) ;
F_148 ( V_237 , L_50 ,
V_65 -> V_245 ) ;
F_149 ( V_237 , L_51 ) ;
F_149 ( V_237 , L_52 ) ;
V_238 = F_150 ( & V_65 -> V_246 ) ;
V_239 = 0 ;
for ( V_46 = 0 ; V_46 < V_247 ; V_46 ++ ) {
unsigned long V_248 = V_65 -> V_246 . V_249 [ V_46 ] ;
V_239 += V_248 ;
F_148 ( V_237 , L_53 ,
V_46 , V_248 , F_151 ( V_248 , V_238 ) ,
F_151 ( V_239 , V_238 ) ) ;
if ( V_239 == V_238 )
break;
}
...
static inline bool F_152 ( struct V_207 * V_65 ,
bool V_250 )
{
bool V_210 ;
V_210 = V_65 -> V_245 < V_65 -> V_225 ||
( V_250 && ! V_65 -> V_251 ) ;
return V_210 ;
}
static inline bool F_153 ( struct V_207 * V_65 ,
bool V_250 )
{
bool V_210 ;
F_10 ( & V_65 -> V_234 ) ;
V_210 = F_152 ( V_65 , V_250 ) ;
F_13 ( & V_65 -> V_234 ) ;
return V_210 ;
}
T_3 F_154 ( struct V_207 * V_65 , T_1 V_252 ,
struct V_253 * V_254 )
{
struct V_199 V_200 = F_140 ( NULL , NULL ) ;
bool V_250 = false ;
T_3 V_46 , V_220 ;
if ( V_254 && ( V_254 -> V_255 == V_256 || V_254 -> V_255 == V_257 ||
V_254 -> V_255 == V_258 || V_254 -> V_255 == V_259 ) )
return 0 ;
if ( V_252 == V_260 )
V_250 = true ;
do {
...
F_155 ( & V_65 -> V_246 ,
V_65 -> V_245 ) ;
V_46 = F_156 ( V_65 -> V_261 ,
V_220 + 1 ) ;
F_20 ( V_46 < V_223 ) ;
F_20 ( ! F_157 ( V_46 , V_65 -> V_261 ) ) ;
F_13 ( & V_65 -> V_234 ) ;
return V_46 + 1 ;
}
F_13 ( & V_65 -> V_234 ) ;
F_16 ( V_262 , L_54 ,
V_65 -> V_91 -> V_136 -> V_52 , V_252 , V_220 ) ;
F_126 ( V_65 -> V_235 ,
F_153 ( V_65 , V_250 ) , & V_200 ) ;
} while ( true );
}
void F_158 ( struct V_207 * V_65 , T_4 V_252 ,
struct V_253 * V_254 , T_3 V_263 )
{
bool V_250 = false ;
if ( V_254 && ( V_254 -> V_255 == V_256 || V_254 -> V_255 == V_257 ||
V_254 -> V_255 == V_258 || V_254 -> V_255 == V_259 ) )
...
V_65 -> V_251 -- ;
F_20 ( V_263 - 1 < V_223 ) ;
F_20 ( F_159 ( V_263 - 1 , V_65 -> V_261 ) != 0 ) ;
F_13 ( & V_65 -> V_234 ) ;
F_130 ( & V_65 -> V_235 ) ;
}
