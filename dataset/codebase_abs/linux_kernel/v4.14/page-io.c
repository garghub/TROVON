...
{
struct V_10 * V_10 = V_38 -> V_78 ;
if ( V_10 ) {
int V_79 = V_38 -> V_80 -> V_81 == V_82 ?
V_83 : 0 ;
V_38 -> V_78 -> V_84 = V_38 -> V_31 -> V_39 -> V_85 ;
F_69 ( V_38 -> V_78 , V_86 , V_79 ) ;
F_70 ( V_38 -> V_78 ) ;
}
V_38 -> V_78 = NULL ;
}
...
static int F_76 ( struct F_68 * V_38 ,
struct V_39 * V_39 ,
struct V_14 * V_14 ,
struct V_5 * V_6 )
{
int V_42 ;
if ( V_38 -> V_78 && V_6 -> V_9 != V_38 -> V_91 ) {
V_92:
F_68 ( V_38 ) ;
}
if ( V_38 -> V_78 == NULL ) {
...
if ( V_42 )
return V_42 ;
V_38 -> V_78 -> V_84 = V_39 -> V_85 ;
}
V_42 = F_77 ( V_38 -> V_78 , V_14 , V_6 -> V_29 , F_16 ( V_6 ) ) ;
if ( V_42 != V_6 -> V_29 )
goto V_92;
F_78 ( V_38 -> V_80 , V_14 , V_6 -> V_29 ) ;
V_38 -> V_91 ++ ;
return 0 ;
}
int F_79 ( struct F_68 * V_38 ,
struct V_14 * V_14 ,
int V_93 ,
struct V_87 * V_88 ,
bool V_94 )
{
struct V_14 * V_16 = NULL ;
struct V_39 * V_39 = V_14 -> V_24 -> V_95 ;
unsigned V_96 ;
struct V_5 * V_6 , * V_17 ;
int V_42 = 0 ;
int V_97 = 0 ;
...
V_6 = V_17 = F_13 ( V_14 ) ;
if ( F_96 ( V_39 ) && F_97 ( V_39 -> V_100 ) &&
V_98 ) {
T_6 V_101 = V_102 ;
V_103:
V_16 = F_98 ( V_39 , V_14 , V_99 , 0 ,
V_14 -> V_104 , V_101 ) ;
if ( F_99 ( V_16 ) ) {
V_42 = F_100 ( V_16 ) ;
if ( V_42 == - V_4 && V_88 -> V_81 == V_82 ) {
if ( V_38 -> V_78 ) {
F_68 ( V_38 ) ;
F_101 ( V_105 , V_106 / 50 ) ;
}
V_101 |= V_107 ;
goto V_103;
}
