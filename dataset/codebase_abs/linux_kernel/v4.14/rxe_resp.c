...
F_61 ( V_4 , V_22 ) ;
F_62 ( V_4 ) ;
memcpy ( F_2 ( V_6 ) , & V_161 , sizeof( V_161 ) ) ;
memset ( ( unsigned char * ) F_2 ( V_6 ) + sizeof( V_161 ) , 0 ,
sizeof( V_6 -> V_235 ) - sizeof( V_161 ) ) ;
V_22 -> type = V_68 ;
V_22 -> V_236 . V_6 = V_6 ;
...
{
int V_238 ;
for ( V_238 = 0 ; V_238 < V_4 -> V_63 . V_99 ; V_238 ++ ) {
...
{
enum V_15 V_129 ;
T_2 V_239 = ( V_4 -> V_13 . V_26 - 1 ) & V_170 ;
if ( V_9 -> V_38 & V_187 ||
V_9 -> V_38 & V_66 ) {
if ( F_86 ( V_9 ) )
F_79 ( V_4 , V_9 , V_178 , V_239 ) ;
V_129 = V_31 ;
goto V_130;
} else if ( V_9 -> V_38 & V_62 ) {
struct V_162 * V_22 ;
...
void F_92 ( struct V_3 * V_4 , bool V_246 )
{
struct V_5 * V_6 ;
...
break;
case V_33 :
F_79 ( V_4 , V_9 , V_254 , V_4 -> V_13 . V_26 ) ;
V_17 = V_31 ;
break;
case V_100 :
case V_52 :
