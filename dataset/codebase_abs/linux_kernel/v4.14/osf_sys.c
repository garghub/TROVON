...
{
struct V_87 V_89 ;
if ( F_13 ( & V_89 , V_88 , sizeof( struct V_87 ) ) )
return - V_24 ;
V_86 -> V_52 = V_89 . V_52 ;
V_86 -> V_90 = V_89 . V_90 ;
return 0 ;
...
static inline long
F_22 ( struct V_87 T_3 * V_86 , struct V_85 * V_88 )
{
return F_5 (o, &(struct timeval32){
.tv_sec = o->tv_sec,
.tv_usec = o->tv_usec},
sizeof(struct timeval32)) ;
}
static inline long
F_23 ( struct V_91 * V_86 , struct V_92 T_3 * V_88 )
{
struct V_92 V_93 ;
if ( F_13 ( & V_93 , V_88 , sizeof( struct V_92 ) ) )
return - V_24 ;
V_86 -> V_94 . V_52 = V_93 . V_94 . V_52 ;
V_86 -> V_94 . V_90 = V_93 . V_94 . V_90 ;
V_86 -> V_95 . V_52 = V_93 . V_95 . V_52 ;
V_86 -> V_95 . V_90 = V_93 . V_95 . V_90 ;
return 0 ;
}
static inline long
F_24 ( struct V_92 T_3 * V_86 , struct V_91 * V_88 )
{
return F_5 (o, &(struct itimerval32){
...
static inline void
F_25 ( unsigned long V_96 , struct V_87 * V_97 )
{
V_97 -> V_90 = ( V_96 % V_98 ) * ( 1000000L / V_98 ) ;
V_97 -> V_52 = V_96 / V_98 ;
}
static unsigned long
F_26 ( unsigned long V_99 , unsigned long V_100 ,
unsigned long V_101 )
{
struct V_102 V_103 ;
V_103 . V_78 = 0 ;
...
unsigned long
F_28 ( struct V_109 * V_110 , unsigned long V_99 ,
...
return V_99 ;
if ( V_99 ) {
V_99 = F_26 ( F_29 ( V_99 ) , V_100 , V_101 ) ;
if ( V_99 != ( unsigned long ) - V_116 )
return V_99 ;
}
V_99 = F_26 ( F_29 ( V_118 ) ,
V_100 , V_101 ) ;
if ( V_99 != ( unsigned long ) - V_116 )
return V_99 ;
V_99 = F_26 ( V_119 , V_100 , V_101 ) ;
return V_99 ;
}
static int
F_30 ( const struct V_120 T_3 * V_121 , unsigned long V_17 )
{
unsigned long V_88 ;
