...
V_39 -> V_117 = V_118 ;
V_39 -> V_119 = 0 ;
V_53 = F_54 ( V_39 , & V_120 , V_11 -> V_15 , V_11 ) ;
if ( V_53 ) {
...
F_51 ( V_61 , V_124 ) ;
F_51 ( V_61 , V_126 ) ;
V_11 -> V_39 = F_63 ( V_118 , 0 , V_127 ) ;
F_24 ( V_57 , 2 , L_14 ,
V_66 -> V_6 , F_9 ( V_11 ) ) ;
V_53 = F_64 ( V_11 -> V_39 , & V_120 , V_11 -> V_17 ,
NULL , V_11 -> V_15 , V_11 ) ;
switch ( V_53 ) {
case 0 :
V_66 -> V_121 = V_11 -> V_39 -> V_117 ;
F_65 ( & V_11 -> V_123 , V_128 ,
V_129 , V_11 ) ;
return;
case 11 :
F_66 ( V_67 -> V_2 ,
...
unsigned long V_143 = ( ( unsigned long ) ( F_80 ( V_74 ) +
V_69 ) ) >> 31 ;
int V_144 = 0 ;
if ( V_143 || ( F_34 ( V_74 ) < 2 ) ) {
V_142 = F_81 ( V_74 -> V_7 + V_69 +
V_69 , V_145 | V_146 ) ;
if ( ! V_142 ) {
F_37 ( V_45 , 2 , L_34 ) ;
V_53 = - V_33 ;
...
F_82 ( V_142 , V_69 ) ;
F_49 ( V_142 , V_74 -> V_45 , V_74 -> V_7 ) ;
}
V_144 = 1 ;
}
V_76 . V_77 = V_142 -> V_7 + V_69 ;
memcpy ( F_83 ( V_142 , V_69 ) , & V_76 , V_69 ) ;
V_76 . V_77 = 0 ;
F_49 ( V_142 , & V_76 , V_69 ) ;
F_51 ( V_11 -> V_46 , V_147 ) ;
V_11 -> V_97 . V_109 = V_110 ;
V_41 . V_92 = 1 ;
V_41 . V_111 = 0 ;
...
static void F_89 ( struct V_151 * V_2 )
{
F_37 ( V_83 , 3 , V_84 ) ;
return;
}
static int F_90 ( struct V_151 * V_2 )
{
...
goto V_153;
F_92 ( V_152 ) ;
V_4 -> V_154 = F_75 ( V_4 -> V_46 ) ;
V_53 = F_87 ( V_152 ) ;
V_153:
return V_53 ;
}
static int F_93 ( struct V_151 * V_2 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
struct V_1 * V_152 = NULL ;
int V_53 = 0 ;
...
static struct V_159 * F_98 ( struct V_1 * V_2 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return & V_4 -> V_78 ;
}
static T_5 F_99 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_38 , F_9 ( V_4 -> V_11 ) ) ;
}
static int F_100 ( const char * V_14 , T_6 V_162 , char * V_163 ,
char * V_15 )
{
const char * V_9 ;
int V_164 ;
...
for ( V_164 = 0 , V_9 = V_14 ; V_164 < 8 && * V_9 && * V_9 != '.' ; V_164 ++ , V_9 ++ ) {
if ( isalnum ( * V_9 ) || * V_9 == '$' ) {
V_163 [ V_164 ] = toupper ( * V_9 ) ;
continue;
}
if ( * V_9 == '\n' )
break;
...
if ( * V_9 == '.' ) {
V_9 ++ ;
for ( V_164 = 0 ; V_164 < 16 && * V_9 ; V_164 ++ , V_9 ++ ) {
if ( * V_9 == '\n' )
break;
V_15 [ V_164 ] = toupper ( * V_9 ) ;
}
while ( V_164 > 0 && V_164 < 16 )
V_15 [ V_164 ++ ] = ' ' ;
} else
memcpy ( V_15 , V_165 , 16 ) ;
V_15 [ 16 ] = '\0' ;
F_101 ( V_15 , 16 ) ;
return 0 ;
}
static T_5 F_102 ( struct V_151 * V_2 , struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
...
struct V_10 * V_166 ;
F_37 ( V_83 , 3 , V_84 ) ;
V_53 = F_100 ( V_14 , V_162 , V_163 , V_15 ) ;
if ( V_53 )
return V_53 ;
if ( memcmp ( V_163 , V_4 -> V_11 -> V_17 , 9 ) &&
( V_152 -> V_119 & ( V_167 | V_168 ) ) ) {
F_37 ( V_57 , 2 , L_41 ) ;
return - V_169 ;
}
F_22 ( & V_55 ) ;
F_23 (cp, &iucv_connection_list, list) {
if ( ! strncmp ( V_163 , V_166 -> V_17 , 9 ) &&
! strncmp ( V_15 , V_166 -> V_15 , 17 ) && V_166 -> V_66 != V_152 ) {
F_25 ( & V_55 ) ;
F_24 ( V_57 , 2 , L_42
L_43 , F_9 ( V_166 ) ) ;
return - V_170 ;
...
F_25 ( & V_55 ) ;
memcpy ( V_4 -> V_11 -> V_17 , V_163 , 9 ) ;
memcpy ( V_4 -> V_11 -> V_15 , V_15 , 17 ) ;
return V_162 ;
}
static T_5 F_103 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_44 , V_4 -> V_11 -> V_86 ) ;
}
static T_5 F_104 ( struct V_151 * V_2 , struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
struct V_1 * V_152 = V_4 -> V_11 -> V_66 ;
...
if ( V_162 >= 39 )
return - V_54 ;
V_53 = F_105 ( V_14 , 0 , & V_171 ) ;
if ( V_53 == - V_54 ) {
F_24 ( V_57 , 2 , L_45 ,
V_14 ) ;
return - V_54 ;
}
if ( ( V_53 == - V_172 ) || ( V_171 > V_173 ) ) {
F_24 ( V_57 , 2 ,
L_46 ,
V_171 ) ;
return - V_54 ;
}
if ( ( V_152 -> V_119 & V_168 ) &&
( V_171 < ( V_152 -> V_174 + V_69 + 2 ) ) ) {
F_24 ( V_57 , 2 ,
L_47 ,
V_171 ) ;
return - V_54 ;
}
if ( V_171 < ( 576 + V_69 + V_69 ) ) {
F_24 ( V_57 , 2 ,
L_47 ,
V_171 ) ;
return - V_54 ;
...
V_4 -> V_11 -> V_86 = V_171 ;
if ( ! ( V_152 -> V_119 & V_168 ) )
V_152 -> V_174 = V_171 - V_69 - V_69 ;
return V_162 ;
}
static T_5 F_106 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_38 , F_107 ( V_4 -> V_46 ) ) ;
}
static T_5 F_108 ( struct V_151 * V_2 ,
struct V_160 * V_161 , char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_38 , F_107 ( V_4 -> V_11 -> V_46 ) ) ;
}
...
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_48 , V_4 -> V_11 -> V_97 . V_107 ) ;
}
static T_5 F_110 ( struct V_151 * V_2 ,
struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
...
static T_5 F_111 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_48 , V_4 -> V_11 -> V_97 . V_116 ) ;
}
static T_5 F_112 ( struct V_151 * V_2 , struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
static T_5 F_113 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_48 , V_4 -> V_11 -> V_97 . V_148 ) ;
}
static T_5 F_114 ( struct V_151 * V_2 , struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
static T_5 F_115 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_48 , V_4 -> V_11 -> V_97 . V_112 ) ;
}
static T_5 F_116 ( struct V_151 * V_2 , struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_117 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_48 , V_4 -> V_11 -> V_97 . V_113 ) ;
}
static T_5 F_118 ( struct V_151 * V_2 , struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
static T_5 F_119 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_48 , V_4 -> V_11 -> V_97 . V_175 ) ;
}
static T_5 F_120 ( struct V_151 * V_2 , struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
V_4 -> V_11 -> V_97 . V_175 = 0 ;
return V_162 ;
}
static T_5 F_121 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_48 , V_4 -> V_11 -> V_97 . V_98 ) ;
}
static T_5 F_122 ( struct V_151 * V_2 , struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
static T_5 F_123 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_48 , V_4 -> V_11 -> V_97 . V_114 ) ;
}
static T_5 F_124 ( struct V_151 * V_2 , struct V_160 * V_161 ,
const char * V_14 , T_6 V_162 )
{
struct V_3 * V_4 = F_91 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
static int F_125 ( struct V_1 * V_152 )
{
struct V_3 * V_4 = F_2 ( V_152 ) ;
struct V_151 * V_2 = F_126 ( sizeof( struct V_151 ) , V_127 ) ;
int V_176 ;
F_37 ( V_83 , 3 , V_84 ) ;
if ( V_2 ) {
F_127 ( V_2 , L_49 , V_152 -> V_6 ) ;
V_2 -> V_177 = & V_178 ;
V_2 -> V_179 = V_180 ;
V_2 -> V_181 = V_182 ;
V_2 -> V_183 = ( void ( * ) ( struct V_151 * ) ) F_68 ;
V_2 -> V_184 = & V_185 ;
} else
return - V_33 ;
V_176 = F_128 ( V_2 ) ;
...
static void F_131 ( struct V_151 * V_2 )
{
F_37 ( V_83 , 3 , V_84 ) ;
F_132 ( V_2 ) ;
}
...
V_11 -> V_86 = V_186 ;
V_11 -> V_66 = V_2 ;
V_11 -> V_87 = F_81 ( V_11 -> V_86 , V_127 | V_146 ) ;
if ( ! V_11 -> V_87 )
goto V_187;
V_11 -> V_103 = F_81 ( V_11 -> V_86 , V_127 | V_146 ) ;
if ( ! V_11 -> V_103 )
goto V_188;
V_11 -> V_46 = F_136 ( L_50 , V_189 ,
V_190 , V_191 ,
V_192 , V_193 , V_194 ,
V_127 ) ;
if ( ! V_11 -> V_46 )
goto V_195;
F_137 ( V_11 -> V_46 , & V_11 -> V_123 ) ;
F_51 ( V_11 -> V_46 , V_196 ) ;
if ( V_15 )
memcpy ( V_11 -> V_15 , V_15 , 17 ) ;
if ( V_163 ) {
memcpy ( V_11 -> V_17 , V_163 , 9 ) ;
F_51 ( V_11 -> V_46 , V_133 ) ;
}
F_138 ( & V_55 ) ;
F_139 ( & V_11 -> V_197 , & V_198 ) ;
F_140 ( & V_55 ) ;
return V_11 ;
V_195:
F_141 ( V_11 -> V_103 ) ;
...
V_2 -> type = V_207 ;
V_2 -> V_121 = V_118 ;
V_2 -> V_119 = V_208 | V_209 ;
V_2 -> V_210 = & V_211 ;
}
static struct V_1 * F_147 ( char * V_163 , char * V_15 )
{
struct V_3 * V_67 ;
struct V_1 * V_2 ;
V_2 = F_148 ( sizeof( struct V_3 ) , L_51 ,
V_212 , F_146 ) ;
if ( ! V_2 )
return NULL ;
F_149 () ;
...
goto V_213;
V_67 = F_2 ( V_2 ) ;
V_67 -> V_46 = F_136 ( L_52 , V_214 ,
V_215 , V_216 , V_217 ,
V_218 , V_219 , V_127 ) ;
if ( ! V_67 -> V_46 )
goto V_213;
V_67 -> V_11 = F_133 ( V_2 , V_163 , V_15 ) ;
if ( ! V_67 -> V_11 ) {
F_37 ( V_57 , 2 , L_53 ) ;
goto V_220;
}
F_51 ( V_67 -> V_46 , V_139 ) ;
return V_2 ;
V_220:
F_144 ( V_67 -> V_46 ) ;
V_213:
...
static T_5 F_153 ( struct V_221 * V_222 , const char * V_14 ,
T_6 V_162 )
{
char V_163 [ 9 ] ;
char V_15 [ 17 ] ;
...
static T_5 F_156 ( struct V_221 * V_222 , const char * V_14 ,
T_6 V_162 )
{
struct V_10 * V_166 ;
struct V_1 * V_152 ;
...
if ( V_162 >= V_226 )
V_162 = V_226 - 1 ;
for ( V_164 = 0 , V_9 = V_14 ; V_164 < V_162 && * V_9 ; V_164 ++ , V_9 ++ ) {
if ( * V_9 == '\n' || * V_9 == ' ' )
break;
V_6 [ V_164 ] = * V_9 ;
}
...
V_4 = F_2 ( V_152 ) ;
V_2 = V_4 -> V_2 ;
if ( strncmp ( V_6 , V_152 -> V_6 , V_162 ) )
continue;
F_25 ( & V_55 ) ;
if ( V_152 -> V_119 & ( V_167 | V_168 ) ) {
F_66 ( V_2 , L_59
L_60 ,
V_4 -> V_11 -> V_17 ) ;
F_37 ( V_45 , 2 , L_61 ) ;
...
V_53 = F_167 ( & V_185 ) ;
if ( V_53 ) {
F_24 ( V_57 , 2 , L_65 , V_53 ) ;
goto V_230;
}
V_227 = F_126 ( sizeof( struct V_151 ) , V_127 ) ;
if ( ! V_227 ) {
V_53 = - V_33 ;
goto V_231;
}
...
V_227 -> V_177 = & V_178 ;
V_227 -> V_179 = V_180 ;
V_227 -> V_183 = ( void ( * ) ( struct V_151 * ) ) F_68 ;
V_227 -> V_184 = & V_185 ;
V_53 = F_128 ( V_227 ) ;
if ( V_53 ) {
F_129 ( V_227 ) ;
