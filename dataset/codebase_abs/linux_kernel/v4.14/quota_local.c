...
F_68 ( & F_29 ( V_2 ) -> V_118 ) ;
F_44 ( & V_106 -> V_119 ) ;
V_109 = F_66 ( V_105 -> V_120 ) ;
V_110 = F_66 ( V_105 -> V_121 ) ;
V_106 -> V_122 . V_123 += V_109 ;
V_106 -> V_122 . V_124 += V_110 ;
F_46 ( & V_106 -> V_119 ) ;
V_17 = F_69 ( V_106 ) ;
if ( V_17 < 0 ) {
F_16 ( V_17 ) ;
...
static int F_82 ( struct V_1 * V_2 , int type )
{
struct V_58 * V_59 ;
...
static int F_88 ( struct V_1 * V_2 , int type )
{
struct V_66 * V_67 = F_61 ( V_2 , type ) ;
struct V_68 * V_69 = V_67 -> V_70 ;
struct V_52 * V_76 ;
...
F_85 ( F_13 ( V_2 ) , & V_69 -> V_144 ) ;
F_86 ( & V_69 -> V_144 ) ;
F_89 (chunk, &oinfo->dqi_chunk, qc_chunk) {
V_75 = (struct V_6 * )
( V_76 -> V_56 -> V_46 ) ;
...
static void F_90 ( struct V_12 * V_13 , void * V_14 )
{
...
+ F_8 ( V_2 , V_148 -> V_151 ) ) ;
V_105 -> V_113 = F_91 ( F_92 ( & V_112 ,
V_148 -> V_149 . V_152 ) ) ;
F_44 ( & V_148 -> V_149 . V_119 ) ;
V_105 -> V_120 = F_91 ( V_148 -> V_149 . V_122 . V_123 -
V_148 -> V_153 ) ;
V_105 -> V_121 = F_91 ( V_148 -> V_149 . V_122 . V_124 -
V_148 -> V_154 ) ;
F_46 ( & V_148 -> V_149 . V_119 ) ;
F_93 (
( unsigned long long ) F_66 ( V_105 -> V_120 ) ,
( unsigned long long ) F_66 ( V_105 -> V_121 ) ,
F_92 ( & V_112 , V_148 -> V_149 . V_152 ) ) ;
}
int F_94 ( struct V_106 * V_106 )
{
struct V_1 * V_2 = V_106 -> V_150 ;
struct V_147 * V_148 = F_95 ( V_106 ) ;
struct V_12 * V_13 ;
struct V_11 * V_86 = F_29 ( V_2 ) -> V_39 [ V_106 -> V_152 . type ] ;
int V_17 ;
V_17 = F_96 ( V_86 , V_148 -> V_155 ,
& V_13 ) ;
if ( V_17 ) {
F_16 ( V_17 ) ;
goto V_101;
}
V_17 = F_10 ( V_86 , V_13 , F_90 , V_148 ) ;
if ( V_17 < 0 ) {
F_16 ( V_17 ) ;
goto V_101;
}
...
static struct V_52 * F_97 ( struct V_1 * V_2 ,
int type ,
int * V_156 )
{
struct V_66 * V_67 = F_61 ( V_2 , type ) ;
...
V_17 = F_102 ( V_86 , V_69 -> V_74 ,
& V_159 , NULL , NULL ) ;
if ( V_17 < 0 ) {
F_16 ( V_17 ) ;
goto V_133;
}
V_13 = F_103 ( V_2 , V_159 ) ;
if ( ! V_13 ) {
V_17 = - V_64 ;
F_16 ( V_17 ) ;
goto V_133;
...
F_21 ( V_13 ) ;
F_22 ( V_16 , V_13 ) ;
V_17 = F_102 ( V_86 , V_69 -> V_74 + 1 ,
& V_159 , NULL , NULL ) ;
if ( V_17 < 0 ) {
F_16 ( V_17 ) ;
goto V_133;
}
V_158 = F_103 ( V_2 , V_159 ) ;
if ( ! V_158 ) {
V_17 = - V_64 ;
F_16 ( V_17 ) ;
goto V_133;
}
F_104 ( F_18 ( V_86 ) , V_158 ) ;
V_17 = F_17 ( V_16 , F_18 ( V_86 ) , V_158 ,
V_160 ) ;
if ( V_17 < 0 ) {
F_16 ( V_17 ) ;
goto V_133;
...
F_42 ( & V_76 -> V_55 , & V_69 -> V_138 ) ;
V_76 -> V_65 = F_105 ( V_76 -> V_55 . V_161 ,
struct V_52 ,
V_55 ) -> V_65 + 1 ;
V_76 -> V_56 = V_13 ;
* V_156 = 0 ;
...
T_2 * V_16 ;
if ( F_79 ( & V_69 -> V_138 ) )
return F_99 ( V_2 , type , V_156 ) ;
V_76 = F_105 ( V_69 -> V_138 . V_161 ,
struct V_52 , V_55 ) ;
V_162 = V_69 -> V_74 -
F_4 ( V_2 , V_76 -> V_65 ) - 1 ;
if ( F_2 ( V_2 ) == V_162 )
...
static void F_107 ( struct V_12 * V_13 , void * V_14 )
{
int * V_156 = V_14 ;
struct V_6 * V_75 ;
V_75 = (struct V_6 * ) V_13 -> V_46 ;
F_108 ( * V_156 , V_75 -> V_80 ) ;
F_73 ( & V_75 -> V_89 , - 1 ) ;
}
int F_109 ( struct V_106 * V_106 )
{
struct V_1 * V_2 = V_106 -> V_150 ;
int type = V_106 -> V_152 . type ;
struct V_11 * V_86 = F_29 ( V_2 ) -> V_39 [ type ] ;
struct V_52 * V_76 ;
struct V_147 * V_148 = F_95 ( V_106 ) ;
int V_156 ;
int V_17 ;
T_3 V_163 ;
F_68 ( & F_26 ( V_86 ) -> V_164 ) ;
V_76 = F_97 ( V_2 , type , & V_156 ) ;
if ( ! V_76 ) {
V_76 = F_106 ( V_2 , type , & V_156 ) ;
if ( F_14 ( V_76 ) ) {
V_17 = F_15 ( V_76 ) ;
goto V_101;
}
...
V_148 -> V_151 = F_7 ( V_2 , V_76 -> V_65 , V_156 ) ;
V_148 -> V_165 = V_76 ;
V_17 = F_102 ( V_86 ,
F_5 ( V_2 , V_76 -> V_65 , V_156 ) ,
& V_148 -> V_155 ,
& V_163 ,
NULL ) ;
V_17 = F_94 ( V_106 ) ;
...
V_17 = F_10 ( V_86 , V_76 -> V_56 , F_107 ,
& V_156 ) ;
if ( V_17 < 0 ) {
F_16 ( V_17 ) ;
goto V_101;
...
V_156 = F_9 ( V_2 , V_148 -> V_165 -> V_65 ,
V_148 -> V_151 ) ;
V_75 = (struct V_6 * )
( V_148 -> V_165 -> V_56 -> V_46 ) ;
F_20 ( V_148 -> V_165 -> V_56 ) ;
F_72 ( V_156 , V_75 -> V_80 ) ;
F_73 ( & V_75 -> V_89 , 1 ) ;
F_21 ( V_148 -> V_165 -> V_56 ) ;
F_22 ( V_16 , V_148 -> V_165 -> V_56 ) ;
V_101:
return V_17 ;
}
