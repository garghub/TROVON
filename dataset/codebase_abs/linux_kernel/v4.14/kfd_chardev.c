...
V_76 -> V_104 . V_188 = args -> V_189 ;
F_30 ( & V_23 -> V_78 ) ;
if ( V_190 == V_191 && V_76 -> V_104 . V_192 != 0 )
V_73 -> V_150 -> V_193 (
V_73 -> V_152 , args -> V_189 , V_76 -> V_104 . V_192 ) ;
return 0 ;
V_187:
F_30 ( & V_23 -> V_78 ) ;
return V_1 ;
...
if ( ! V_73 )
return - V_35 ;
V_73 -> V_150 -> V_197 ( V_73 -> V_152 , & V_196 ) ;
args -> V_198 = V_196 . V_198 ;
args -> V_199 = V_196 . V_199 ;
args -> V_200 = V_196 . V_200 ;
if ( args -> V_201 > V_196 . V_201 )
args -> V_201 = V_196 . V_201 ;
V_1 = F_69 ( ( void V_40 * ) args -> V_202 ,
V_196 . V_202 ,
args -> V_201 * sizeof( V_45 ) ) ;
if ( V_1 ) {
args -> V_201 = 0 ;
return - V_42 ;
}
if ( args -> V_203 > V_196 . V_203 )
args -> V_203 =
V_196 . V_203 ;
V_1 = F_69 ( ( void V_40 * ) args -> V_204 ,
V_196 . V_204 ,
args -> V_203 * sizeof( V_45 ) ) ;
if ( V_1 ) {
args -> V_203 = 0 ;
return - V_42 ;
}
...
static long F_70 ( struct V_13 * V_14 , unsigned int V_205 , unsigned long V_206 )
{
struct V_15 * V_16 ;
T_1 * V_207 ;
const struct V_208 * V_209 = NULL ;
unsigned int V_210 = F_71 ( V_205 ) ;
char V_211 [ 128 ] ;
char * V_212 = NULL ;
...
T_2 V_220 ;
V_209 = & V_221 [ V_210 ] ;
V_220 = F_72 ( V_209 -> V_205 ) ;
V_213 = V_214 = F_72 ( V_205 ) ;
if ( V_220 > V_214 )
V_214 = V_220 ;
V_205 = V_209 -> V_205 ;
} else
goto V_217;
F_18 ( V_9 , L_46 , V_205 , V_210 , V_206 ) ;
V_16 = F_73 ( V_19 ) ;
if ( F_5 ( V_16 ) ) {
F_18 ( V_9 , L_47 ) ;
goto V_217;
...
if ( V_214 <= sizeof( V_211 ) ) {
V_212 = V_211 ;
} else {
V_212 = F_75 ( V_214 , V_224 ) ;
if ( ! V_212 ) {
V_215 = - V_225 ;
goto V_217;
}
...
if ( V_214 > V_213 )
memset ( V_212 + V_213 , 0 , V_214 - V_213 ) ;
}
if ( V_205 & V_222 ) {
if ( F_76 ( V_212 , ( void V_40 * ) V_206 , V_213 ) != 0 ) {
V_215 = - V_42 ;
goto V_217;
}
} else if ( V_205 & V_223 ) {
memset ( V_212 , 0 , V_213 ) ;
}
V_215 = V_207 ( V_14 , V_16 , V_212 ) ;
if ( V_205 & V_223 )
if ( F_69 ( ( void V_40 * ) V_206 , V_212 , V_213 ) != 0 )
V_215 = - V_42 ;
V_217:
if ( ! V_209 )
F_18 ( V_9 , L_49 ,
F_77 ( V_19 ) , V_205 , V_210 ) ;
if ( V_212 != V_211 )
F_46 ( V_212 ) ;
if ( V_215 )
F_18 ( V_9 , L_50 , V_215 ) ;
...
static int F_78 ( struct V_13 * V_87 , struct V_226 * V_227 )
{
struct V_15 * V_16 ;
V_16 = F_73 ( V_19 ) ;
if ( F_5 ( V_16 ) )
...
if ( ( V_227 -> V_228 & V_85 ) ==
V_85 ) {
V_227 -> V_228 = V_227 -> V_228 ^ V_85 ;
return F_79 ( V_16 , V_227 ) ;
} else if ( ( V_227 -> V_228 & V_229 ) ==
V_229 ) {
V_227 -> V_228 = V_227 -> V_228 ^ V_229 ;
return F_80 ( V_16 , V_227 ) ;
}
return - V_42 ;
}
