...
struct V_1 * F_7 ( const struct V_31 * V_32 )
{
struct V_1 * V_2 = F_8 ( sizeof( * V_2 ) , V_33 ) ;
T_1 V_34 ;
if ( ! V_2 )
return NULL ;
V_2 -> V_35 = V_32 ;
...
void F_14 ( struct V_1 * V_2 , T_1 V_60 )
{
F_3 ( V_2 , V_59 , V_60 ) ;
}
...
void F_16 ( struct V_1 * V_2 , T_1 V_60 )
{
F_3 ( V_2 , V_61 , V_60 ) ;
}
...
void F_18 ( struct V_1 * V_2 , int V_63 )
{
...
void F_20 ( struct V_1 * V_2 , void * V_65 , T_2 V_66 )
{
T_2 * V_67 = V_65 ;
F_21 () ;
...
{
T_1 * V_68 , V_69 ;
V_68 = F_5 ( V_2 , F_23 ( V_2 -> V_36 . V_37 ) ) ;
V_69 = V_68 [ 0 ] & ~ V_38 ;
if ( ! V_69 )
return NULL ;
V_2 -> V_36 . V_37 ^= V_38 ;
...
void F_24 ( struct V_70 * V_32 )
{
memset ( V_32 , 0 , sizeof( * V_32 ) ) ;
}
void F_25 ( struct V_70 * V_32 , int V_71 )
{
V_32 -> V_69 &= ~ ( 1 << V_72 ) ;
if ( V_71 )
V_32 -> V_69 |= V_73 ;
...
void F_26 ( struct V_70 * V_32 , T_1 V_75 )
{
V_32 -> V_69 &= ~ ( 1 << V_76 ) ;
V_32 -> V_77 = F_27 ( V_75 ) ;
}
