...
F_15 ( 3 , L_48 , V_5 -> V_77 , V_25 ) ;
V_112 = ( unsigned int * ) V_111 -> V_117 ;
F_15 ( 3 , L_49 , V_112 [ 0 ] , V_112 [ 1 ] ) ;
F_15 ( 3 , L_49 , V_112 [ 2 ] , V_112 [ 3 ] ) ;
F_15 ( 3 , L_49 , V_112 [ 4 ] , V_112 [ 5 ] ) ;
F_15 ( 3 , L_49 , V_112 [ 6 ] , V_112 [ 7 ] ) ;
}
static int
...
F_106 ( void )
{
V_156 = F_107 ( L_69 , 2 , 2 , 4 * sizeof( long ) ) ;
F_108 ( V_156 , & V_157 ) ;
#ifdef F_109
F_110 ( V_156 , 6 ) ;
#endif
