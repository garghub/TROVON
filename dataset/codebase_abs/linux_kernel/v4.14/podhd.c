...
if ( V_9 -> V_26 . V_40 -> V_41 & V_42 ) {
V_49 = F_28 ( V_26 -> V_7 , & V_53 ) ;
if ( V_49 < 0 )
return V_49 ;
}
if ( V_9 -> V_26 . V_40 -> V_41 & V_54 ) {
V_49 = F_29 ( V_26 ,
( V_48 -> V_55 == V_56 ||
V_48 -> V_55 == V_57 ) ? & V_58 :
& V_59 ) ;
...
static int F_30 ( struct V_43 * V_60 ,
const struct V_47 * V_48 )
{
return F_31 ( V_60 , V_48 , L_7 ,
& V_61 [ V_48 -> V_55 ] ,
