...
F_24 ( F_15 ( 0 ) , F_7 ( F_15 ( 0 ) ) | V_88 ) ;
F_35 ( V_14 -> V_18 ) ;
if ( F_36 ( V_13 , F_37 ( 0 ) , V_89 , V_89 , 1000 ) )
F_38 ( L_5 ) ;
F_39 ( V_22 , V_69 ) ;
}
...
struct V_12 * V_13 = F_5 ( V_3 -> V_4 . V_11 ) ;
F_24 ( F_15 ( 0 ) , F_7 ( F_15 ( 0 ) ) & ~ V_88 ) ;
if ( F_36 ( V_13 , F_37 ( 0 ) , V_89 , 0 , 1000 ) )
F_38 ( L_6 ) ;
F_24 ( V_14 -> V_18 , F_7 ( V_14 -> V_18 ) & ~ V_19 ) ;
F_35 ( V_14 -> V_18 ) ;
}
...
struct V_72 * V_93 )
{
struct V_94 * V_94 = F_46 ( V_7 ) ;
struct V_72 * V_95 = V_94 -> V_96 . V_95 ;
int V_97 = F_5 ( V_7 -> V_11 ) -> V_98 ;
if ( V_93 -> V_99 > V_95 -> V_99 )
return V_100 ;
if ( V_93 -> V_101 > V_95 -> V_101 )
return V_100 ;
if ( V_95 -> clock > V_97 )
return V_102 ;
return V_103 ;
...
V_93 = F_56 ( V_11 , V_117 -> V_4 . V_96 . V_95 ) ;
if ( V_93 == NULL )
return 0 ;
F_57 ( V_7 , V_93 ) ;
return 1 ;
...
static int F_71 ( const struct V_119 * V_113 )
{
F_59 ( L_11 , V_113 -> V_120 ) ;
return 1 ;
}
static int F_72 ( const struct V_119 * V_113 )
{
F_59 ( L_12 , V_113 -> V_120 ) ;
return 1 ;
}
struct V_8 * F_73 ( struct V_10 * V_11 )
{
struct V_8 * V_8 ;
F_74 (dev, intel_encoder)
if ( V_8 -> type == V_137 )
return V_8 ;
return NULL ;
}
bool F_75 ( struct V_10 * V_11 )
{
struct V_8 * V_3 = F_73 ( V_11 ) ;
return V_3 && F_1 ( & V_3 -> V_4 ) -> V_80 ;
}
static bool F_76 ( struct V_1 * V_14 )
{
struct V_10 * V_11 = V_14 -> V_4 . V_4 . V_11 ;
unsigned int V_41 ;
struct V_12 * V_13 = F_5 ( V_11 ) ;
if ( V_138 . V_139 > 0 )
return V_138 . V_139 == 2 ;
if ( V_14 -> V_104 -> V_4 . V_96 . V_95 -> clock
> 112999 )
return true ;
if ( F_62 ( V_140 ) )
return true ;
V_41 = F_7 ( V_14 -> V_18 ) ;
if ( ! ( V_41 & ~ ( V_141 | V_142 ) ) )
V_41 = V_13 -> V_143 . V_144 ;
return ( V_41 & V_145 ) == V_82 ;
}
static bool F_77 ( struct V_12 * V_13 )
{
if ( F_78 ( V_13 ) || F_8 ( V_13 ) )
return true ;
if ( F_13 ( V_13 ) <= 4 &&
F_79 ( V_13 ) && ! F_80 ( V_13 ) )
return true ;
...
struct V_2 * V_3 ;
struct V_72 * V_147 ;
struct V_72 * V_95 = NULL ;
struct V_72 * V_148 = NULL ;
struct V_118 * V_118 ;
struct V_70 * V_71 ;
T_2 V_149 ;
T_1 V_150 ;
...
V_14 = F_83 ( sizeof( * V_14 ) , V_159 ) ;
if ( ! V_14 )
return;
V_117 = F_83 ( sizeof( * V_117 ) , V_159 ) ;
if ( ! V_117 ) {
F_68 ( V_14 ) ;
return;
}
...
V_94 = & V_117 -> V_4 ;
V_7 = & V_94 -> V_4 ;
F_85 ( V_11 , & V_94 -> V_4 , & V_160 ,
V_161 ) ;
F_86 ( V_11 , & V_8 -> V_4 , & V_162 ,
V_163 , L_16 ) ;
V_8 -> V_164 = F_34 ;
V_8 -> V_165 = F_26 ;
V_8 -> V_166 = F_47 ;
...
V_8 -> V_174 = 0 ;
if ( F_28 ( V_13 ) )
V_8 -> V_175 = ( 1 << 0 ) | ( 1 << 1 ) | ( 1 << 2 ) ;
else if ( F_33 ( V_13 ) )
V_8 -> V_175 = ( 1 << 0 ) | ( 1 << 1 ) ;
else
V_8 -> V_175 = ( 1 << 1 ) ;
F_88 ( V_7 , & V_176 ) ;
V_7 -> V_177 . V_178 = V_179 ;
V_7 -> V_180 = false ;
V_7 -> V_181 = false ;
V_14 -> V_18 = V_149 ;
V_152 = F_89 ( V_182 ) ;
...
V_152 |= F_89 ( V_184 ) ;
F_90 ( V_7 , V_152 ) ;
V_7 -> V_185 -> V_109 = V_182 ;
F_14 ( V_13 , & V_14 -> V_75 ) ;
V_14 -> V_76 = V_150 ;
F_61 ( & V_11 -> V_186 . V_187 ) ;
if ( F_91 () & V_188 )
V_118 = F_92 ( V_7 ,
F_93 ( V_13 , V_151 ) ) ;
else
...
F_97 (scan, &connector->probed_modes, head) {
if ( V_147 -> type & V_191 ) {
F_20 ( L_17 ) ;
F_98 ( V_147 ) ;
V_95 = F_56 ( V_11 , V_147 ) ;
if ( V_95 )
goto V_20;
}
}
if ( V_13 -> V_143 . V_192 ) {
F_20 ( L_18 ) ;
F_98 ( V_13 -> V_143 . V_192 ) ;
V_95 = F_56 ( V_11 , V_13 -> V_143 . V_192 ) ;
if ( V_95 ) {
V_95 -> type |= V_191 ;
V_7 -> V_177 . V_193 = V_95 -> V_193 ;
V_7 -> V_177 . V_194 = V_95 -> V_194 ;
goto V_20;
}
}
if ( F_28 ( V_13 ) )
...
goto V_195;
V_20:
F_65 ( & V_11 -> V_186 . V_187 ) ;
F_101 ( & V_94 -> V_96 , V_95 , NULL ,
V_148 ) ;
F_102 ( V_7 , V_196 ) ;
V_14 -> V_80 = F_76 ( V_14 ) ;
F_20 ( L_20 ,
V_14 -> V_80 ? L_21 : L_22 ) ;
V_14 -> V_84 = V_150 & V_83 ;
V_117 -> V_124 . V_136 = F_60 ;
if ( F_103 ( & V_117 -> V_124 ) ) {
F_20 ( L_23 ) ;
