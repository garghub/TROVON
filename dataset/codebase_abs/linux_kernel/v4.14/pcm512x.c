...
static int F_54 ( struct V_105 * V_106 , unsigned int V_129 )
{
struct V_77 * V_78 = V_106 -> V_78 ;
struct V_79 * V_80 = F_5 ( V_78 ) ;
V_80 -> V_129 = V_129 ;
...
int F_55 ( struct V_1 * V_2 , struct V_124 * V_124 )
{
struct V_79 * V_80 ;
int V_214 , V_136 ;
...
V_136 = F_57 ( V_2 , F_22 ( V_80 -> V_215 ) ,
V_80 -> V_215 ) ;
if ( V_136 != 0 ) {
F_25 ( V_2 , L_68 , V_136 ) ;
return V_136 ;
...
for ( V_214 = 0 ; V_214 < F_22 ( V_80 -> V_215 ) ; V_214 ++ ) {
V_136 = F_58 ( V_80 -> V_215 [ V_214 ] . V_223 ,
& V_80 -> V_218 [ V_214 ] ) ;
if ( V_136 != 0 ) {
F_25 ( V_2 ,
L_69 ,
...
V_80 -> V_111 = F_60 ( V_2 , NULL ) ;
if ( F_26 ( V_80 -> V_111 ) == - V_227 )
return - V_227 ;
if ( ! F_24 ( V_80 -> V_111 ) ) {
V_136 = F_61 ( V_80 -> V_111 ) ;
if ( V_136 != 0 ) {
F_25 ( V_2 , L_72 , V_136 ) ;
return V_136 ;
}
...
F_75 ( V_80 -> V_124 , false ) ;
V_136 = F_76 ( V_80 -> V_124 ) ;
if ( V_136 != 0 ) {
F_25 ( V_2 , L_82 , V_136 ) ;
return V_136 ;
}
