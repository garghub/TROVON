...
struct V_66 * V_67 ;
F_74 ( V_82 , V_7 -> V_58 -> V_116 ) ;
V_82 -> V_117 . V_8 = F_3 ( V_7 , V_82 -> V_117 . V_8 ) ;
if ( ( ( unsigned ) V_82 -> V_117 . V_8 | F_75 ( V_82 ) ) &
( ( 1 << ( V_7 -> V_81 - V_118 ) ) - 1 ) ) {
F_76 ( L_13 ) ;
return V_119 ;
}
if ( F_77 ( V_82 ) >>
( V_7 -> V_81 - V_118 ) > V_7 -> V_120 ) {
F_76 ( L_14 ) ;
return V_119 ;
}
if ( F_78 ( V_82 ) == V_121 )
return V_119 ;
V_67 = F_79 ( V_82 , V_10 -> V_83 ) ;
V_67 -> V_7 = V_7 ;
V_67 -> V_95 = V_82 -> V_94 ;
V_67 -> V_11 = V_82 -> V_117 . V_8 >> ( V_7 -> V_81 - V_118 ) ;
V_67 -> V_92 = V_82 -> V_117 . V_122 >> V_7 -> V_81 ;
V_82 -> V_94 = F_62 ;
V_82 -> V_100 = V_67 ;
...
static void F_82 ( struct V_114 * V_10 , T_5 type ,
unsigned V_124 , char * V_125 , unsigned V_126 )
{
struct V_6 * V_7 = V_10 -> V_115 ;
unsigned args = 0 ;
unsigned V_127 = 0 ;
...
( unsigned long long ) V_7 -> V_132 ,
V_7 -> V_133
) ;
for ( V_128 = 0 ; V_128 < V_7 -> V_43 ; V_128 ++ )
F_83 ( L_17 , V_7 -> V_76 [ V_128 ] ) ;
F_83 ( L_18 ) ;
if ( ! V_7 -> V_33 )
F_83 ( L_19 ) ;
else
for ( V_128 = 0 ; V_128 < V_7 -> V_33 ; V_128 ++ )
F_83 ( L_17 , V_7 -> V_35 [ V_128 ] ) ;
if ( V_7 -> V_63 != V_134 )
args ++ ;
if ( F_63 ( V_7 ) )
args += V_135 ;
...
if ( V_7 -> V_77 )
F_83 ( L_18 V_138 ) ;
V_127 = F_84 ( V_7 , V_127 , V_125 , V_126 ) ;
break;
}
}
static int F_85 ( struct V_114 * V_10 ,
struct V_139 * * V_116 , T_6 * V_63 )
{
struct V_6 * V_7 = V_10 -> V_115 ;
* V_116 = V_7 -> V_58 -> V_116 ;
if ( V_7 -> V_9 ||
V_10 -> V_26 != F_86 ( V_7 -> V_58 -> V_116 -> V_140 ) >> V_118 )
return 1 ;
return 0 ;
}
static int F_87 ( struct V_114 * V_10 ,
T_7 V_141 , void * V_19 )
{
struct V_6 * V_7 = V_10 -> V_115 ;
return V_141 ( V_10 , V_7 -> V_58 , V_7 -> V_9 , V_10 -> V_26 , V_19 ) ;
}
static void F_88 ( struct V_114 * V_10 , struct V_142 * V_143 )
{
struct V_6 * V_7 = V_10 -> V_115 ;
if ( V_143 -> V_144 < 1 << V_7 -> V_81 )
V_143 -> V_144 = 1 << V_7 -> V_81 ;
if ( V_143 -> V_145 < 1 << V_7 -> V_81 )
V_143 -> V_145 = 1 << V_7 -> V_81 ;
F_89 ( V_143 , V_143 -> V_144 ) ;
}
static void F_90 ( struct V_114 * V_10 )
{
struct V_6 * V_7 = V_10 -> V_115 ;
if ( V_7 -> V_101 )
F_91 ( V_7 -> V_101 ) ;
...
struct V_24 * V_25 ;
T_2 * V_147 ;
V_7 -> V_77 = F_72 ( V_7 -> V_43 , V_148 ) ;
if ( ! V_7 -> V_77 )
return V_29 ;
V_25 = F_72 ( V_7 -> V_149 , V_148 ) ;
if ( ! V_25 )
return V_29 ;
V_147 = F_97 ( 1 << V_7 -> V_81 , V_148 ) ;
if ( ! V_147 )
goto V_37;
V_29 = F_25 ( V_7 , V_25 , V_147 , 1 << V_7 -> V_81 ,
V_7 -> V_77 ) ;
V_37:
F_70 ( V_25 ) ;
F_70 ( V_147 ) ;
...
static int F_98 ( struct V_150 * V_151 , struct V_6 * V_7 )
{
int V_29 ;
unsigned V_152 ;
...
V_29 = F_99 ( V_155 , V_151 , & V_152 , & V_10 -> error ) ;
if ( V_29 )
return - V_157 ;
if ( ! V_152 )
return 0 ;
...
V_153 = F_100 ( V_151 ) ;
V_152 -- ;
if ( ! strcasecmp ( V_153 , V_136 ) ) {
V_7 -> V_63 = V_64 ;
continue;
} else if ( ! strcasecmp ( V_153 , V_137 ) ) {
V_7 -> V_63 = V_65 ;
continue;
} else if ( ! strcasecmp ( V_153 , V_138 ) ) {
V_29 = F_96 ( V_7 ) ;
if ( V_29 ) {
V_10 -> error = L_22 ;
return V_29 ;
...
V_29 = F_102 ( V_151 , V_7 , & V_152 , V_153 ) ;
if ( V_29 )
return V_29 ;
continue;
}
...
static int F_103 ( struct V_114 * V_10 , unsigned V_152 , char * * V_158 )
{
struct V_6 * V_7 ;
struct V_150 V_151 ;
unsigned int V_159 ;
...
T_1 V_161 ;
char V_162 ;
V_7 = F_97 ( sizeof( struct V_6 ) , V_148 ) ;
if ( ! V_7 ) {
V_10 -> error = L_24 ;
return - V_146 ;
}
...
if ( sscanf ( V_158 [ 0 ] , L_27 , & V_159 , & V_162 ) != 1 ||
V_159 > 1 ) {
V_10 -> error = L_28 ;
V_29 = - V_157 ;
goto V_163;
...
V_7 -> V_34 = V_159 ;
V_29 = F_106 ( V_10 , V_158 [ 1 ] , V_164 , & V_7 -> V_58 ) ;
if ( V_29 ) {
V_10 -> error = L_29 ;
goto V_163;
}
V_29 = F_106 ( V_10 , V_158 [ 2 ] , V_164 , & V_7 -> V_131 ) ;
if ( V_29 ) {
V_10 -> error = L_30 ;
goto V_163;
}
if ( sscanf ( V_158 [ 3 ] , L_27 , & V_159 , & V_162 ) != 1 ||
! V_159 || ( V_159 & ( V_159 - 1 ) ) ||
V_159 < V_165 ( V_7 -> V_58 -> V_116 ) ||
V_159 > V_166 ) {
V_10 -> error = L_31 ;
V_29 = - V_157 ;
goto V_163;
}
V_7 -> V_81 = F_107 ( V_159 ) ;
if ( sscanf ( V_158 [ 4 ] , L_27 , & V_159 , & V_162 ) != 1 ||
! V_159 || ( V_159 & ( V_159 - 1 ) ) ||
V_159 < V_165 ( V_7 -> V_131 -> V_116 ) ||
V_159 > V_167 ) {
V_10 -> error = L_32 ;
V_29 = - V_157 ;
goto V_163;
}
V_7 -> V_44 = F_107 ( V_159 ) ;
if ( sscanf ( V_158 [ 5 ] , L_33 , & V_160 , & V_162 ) != 1 ||
( T_1 ) ( V_160 << ( V_7 -> V_81 - V_118 ) )
>> ( V_7 -> V_81 - V_118 ) != V_160 ) {
V_10 -> error = L_34 ;
V_29 = - V_157 ;
goto V_163;
}
V_7 -> V_120 = V_160 ;
if ( V_10 -> V_26 > ( V_7 -> V_120 << ( V_7 -> V_81 - V_118 ) ) ) {
V_10 -> error = L_35 ;
V_29 = - V_157 ;
goto V_163;
}
if ( sscanf ( V_158 [ 6 ] , L_33 , & V_160 , & V_162 ) != 1 ||
( T_1 ) ( V_160 << ( V_7 -> V_44 - V_118 ) )
>> ( V_7 -> V_44 - V_118 ) != V_160 ) {
V_10 -> error = L_36 ;
V_29 = - V_157 ;
goto V_163;
}
V_7 -> V_132 = V_160 ;
V_7 -> V_133 = F_108 ( V_158 [ 7 ] , V_148 ) ;
if ( ! V_7 -> V_133 ) {
V_10 -> error = L_37 ;
V_29 = - V_146 ;
goto V_163;
}
V_7 -> V_30 = F_109 ( V_7 -> V_133 , 0 , 0 ) ;
if ( F_36 ( V_7 -> V_30 ) ) {
V_10 -> error = L_38 ;
V_29 = F_37 ( V_7 -> V_30 ) ;
V_7 -> V_30 = NULL ;
...
V_7 -> V_43 = F_110 ( V_7 -> V_30 ) ;
if ( ( 1 << V_7 -> V_44 ) < V_7 -> V_43 * 2 ) {
V_10 -> error = L_39 ;
V_29 = - V_157 ;
goto V_163;
}
V_7 -> V_149 = sizeof( struct V_24 ) +
F_111 ( V_7 -> V_30 ) ;
V_7 -> V_76 = F_72 ( V_7 -> V_43 , V_148 ) ;
if ( ! V_7 -> V_76 ) {
V_10 -> error = L_40 ;
V_29 = - V_146 ;
goto V_163;
}
if ( strlen ( V_158 [ 8 ] ) != V_7 -> V_43 * 2 ||
F_112 ( V_7 -> V_76 , V_158 [ 8 ] , V_7 -> V_43 ) ) {
V_10 -> error = L_41 ;
V_29 = - V_157 ;
goto V_163;
}
if ( strcmp ( V_158 [ 9 ] , L_19 ) ) {
V_7 -> V_33 = strlen ( V_158 [ 9 ] ) / 2 ;
V_7 -> V_35 = F_72 ( V_7 -> V_33 , V_148 ) ;
if ( ! V_7 -> V_35 ) {
V_10 -> error = L_42 ;
V_29 = - V_146 ;
goto V_163;
}
if ( strlen ( V_158 [ 9 ] ) != V_7 -> V_33 * 2 ||
F_112 ( V_7 -> V_35 , V_158 [ 9 ] , V_7 -> V_33 ) ) {
V_10 -> error = L_43 ;
V_29 = - V_157 ;
goto V_163;
}
...
( unsigned long long ) ( V_7 -> V_120 - 1 ) >>
( V_7 -> V_13 * V_7 -> V_75 ) )
V_7 -> V_75 ++ ;
if ( V_7 -> V_75 > V_168 ) {
V_10 -> error = L_44 ;
...
T_1 V_170 ;
V_7 -> V_42 [ V_74 ] = V_161 ;
V_170 = ( V_7 -> V_120 + ( ( T_1 ) 1 << ( ( V_74 + 1 ) * V_7 -> V_13 ) ) - 1 )
>> ( ( V_74 + 1 ) * V_7 -> V_13 ) ;
if ( V_161 + V_170 < V_161 ) {
V_10 -> error = L_45 ;
V_29 = - V_169 ;
goto V_163;
}
...
V_7 -> V_109 = V_161 ;
V_7 -> V_70 = F_113 ( V_7 -> V_131 -> V_116 ,
...
if ( F_114 ( V_7 -> V_70 ) < V_7 -> V_109 ) {
V_10 -> error = L_47 ;
V_29 = - V_169 ;
goto V_163;
}
V_7 -> V_101 = F_115 ( L_48 , V_171 | V_172 | V_173 , F_116 () ) ;
if ( ! V_7 -> V_101 ) {
V_10 -> error = L_49 ;
V_29 = - V_146 ;
goto V_163;
...
V_7 -> V_149 + V_7 -> V_43 * 2 ;
V_29 = F_117 ( V_7 ) ;
if ( V_29 )
goto V_163;
V_10 -> V_83 = F_118 ( V_10 -> V_83 ,
F_119 ( struct V_66 ) ) ;
return 0 ;
V_163:
F_90 ( V_10 ) ;
