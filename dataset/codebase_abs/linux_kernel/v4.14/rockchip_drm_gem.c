...
{
struct V_1 * V_2 ;
int V_68 = F_58 ( args -> V_69 * args -> V_70 , 8 ) ;
args -> V_71 = F_59 ( V_68 , 64 ) ;
args -> V_16 = args -> V_71 * args -> V_72 ;
V_2 = F_53 ( V_64 , V_6 , args -> V_16 ,
& args -> V_65 ) ;
return F_60 ( V_2 ) ;
}
struct V_73 * F_61 ( struct V_40 * V_41 )
{
struct V_1 * V_2 = F_35 ( V_41 ) ;
struct V_3 * V_4 = V_41 -> V_6 ;
struct V_73 * V_21 ;
...
if ( ! V_21 )
return F_50 ( - V_24 ) ;
V_13 = F_62 ( V_4 -> V_6 , V_21 , V_2 -> V_36 ,
V_2 -> V_18 , V_41 -> V_16 ,
V_2 -> V_42 ) ;
if ( V_13 ) {
F_5 ( L_5 , V_13 ) ;
...
void F_64 ( struct V_40 * V_41 , void * V_74 )
{
struct V_1 * V_2 = F_35 ( V_41 ) ;
if ( V_2 -> V_29 ) {
F_30 ( V_74 ) ;
