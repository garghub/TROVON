...
static inline bool F_128 ( struct V_4 * V_5 )
{
if ( V_5 -> V_37 && V_5 -> V_150 && ( V_5 -> V_150 -> V_104 &
V_151 ) )
return false ;
return true ;
}
T_4 F_129 ( struct V_4 * V_5 , const char * V_16 ,
T_5 V_152 )
{
int V_70 ;
if ( ! ( V_5 -> V_37 || V_5 -> V_153 ) || ! F_128 ( V_5 ) )
return V_152 ;
V_70 = F_124 ( V_5 , V_16 ) ;
if ( ! V_70 )
return V_152 ;
...
T_4 F_130 ( struct V_4 * V_5 , char * V_16 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
...
if ( ! V_5 -> V_8 )
V_156 += sprintf ( V_16 + V_156 , L_20 ) ;
else
V_154 = V_7 -> type ;
F_9 ( & V_20 ) ;
F_5 (__e, &elv_list, list) {
if ( V_154 && ! strcmp ( V_154 -> V_17 , V_155 -> V_17 ) ) {
V_156 += sprintf ( V_16 + V_156 , L_21 , V_154 -> V_17 ) ;
continue;
}
if ( V_155 -> V_9 && V_5 -> V_37 && F_128 ( V_5 ) )
V_156 += sprintf ( V_16 + V_156 , L_22 , V_155 -> V_17 ) ;
else if ( ! V_155 -> V_9 && ! V_5 -> V_37 )
V_156 += sprintf ( V_16 + V_156 , L_22 , V_155 -> V_17 ) ;
}
F_10 ( & V_20 ) ;
if ( V_5 -> V_37 && V_5 -> V_8 )
V_156 += sprintf ( V_16 + V_156 , L_18 ) ;
V_156 += sprintf ( V_156 + V_16 , L_23 ) ;
return V_156 ;
}
struct V_1 * F_132 ( struct V_4 * V_5 ,
struct V_1 * V_2 )
{
struct V_51 * V_157 = F_133 ( & V_2 -> V_51 ) ;
if ( V_157 )
return F_134 ( V_157 ) ;
return NULL ;
}
...
struct V_1 * V_2 )
{
struct V_51 * V_158 = F_136 ( & V_2 -> V_51 ) ;
if ( V_158 )
return F_134 ( V_158 ) ;
return NULL ;
}
