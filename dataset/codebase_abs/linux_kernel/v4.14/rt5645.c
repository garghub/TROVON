...
V_160 -> V_387 = V_435 ;
if ( V_436 != - 1 ) {
V_160 -> V_387 . V_418 = F_92 ( V_436 ) ;
V_160 -> V_387 . V_388 = F_93 ( V_436 ) ;
V_160 -> V_387 . V_437 = F_94 ( V_436 ) ;
V_160 -> V_387 . V_391 = F_95 ( V_436 ) ;
V_160 -> V_387 . V_419 = F_96 ( V_436 ) ;
V_160 -> V_387 . V_420 = F_97 ( V_436 ) ;
}
...
for ( V_7 = 0 ; V_7 < F_4 ( V_160 -> V_440 ) ; V_7 ++ )
V_160 -> V_440 [ V_7 ] . V_441 = V_442 [ V_7 ] ;
...
V_166 = F_103 ( F_4 ( V_160 -> V_440 ) ,
V_160 -> V_440 ) ;
if ( V_166 ) {
F_24 ( & V_422 -> V_5 , L_30 , V_166 ) ;
return V_166 ;
}
V_167 = F_104 ( V_422 , & V_443 ) ;
if ( F_99 ( V_167 ) ) {
V_166 = F_101 ( V_167 ) ;
F_24 ( & V_422 -> V_5 , L_31 ,
V_166 ) ;
...
switch ( V_165 ) {
case V_444 :
V_160 -> V_167 = F_104 ( V_422 , & V_445 ) ;
V_160 -> V_218 = V_243 ;
break;
case V_446 :
V_160 -> V_167 = F_104 ( V_422 , & V_447 ) ;
V_160 -> V_218 = V_219 ;
break;
default:
F_24 ( & V_422 -> V_5 ,
...
V_166 = F_105 ( V_160 -> V_167 , V_450 ,
F_4 ( V_450 ) ) ;
if ( V_166 != 0 )
F_106 ( & V_422 -> V_5 , L_34 , V_166 ) ;
if ( V_160 -> V_218 == V_219 ) {
V_166 = F_105 ( V_160 -> V_167 , V_451 ,
F_4 ( V_451 ) ) ;
if ( V_166 != 0 )
...
V_449:
F_112 ( F_4 ( V_160 -> V_440 ) , V_160 -> V_440 ) ;
return V_166 ;
}
