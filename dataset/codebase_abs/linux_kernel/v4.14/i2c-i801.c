...
if ( ! ( V_2 -> V_9 & V_161 ) )
return;
F_72 ( V_5 , V_162 , & V_155 ) ;
F_72 ( V_5 , V_163 , & V_156 ) ;
if ( ! ( V_156 & V_164 ) )
return;
memset ( V_150 , 0 , sizeof( V_150 ) ) ;
V_151 = & V_150 [ V_165 ] ;
V_151 -> V_166 = V_155 & ~ 1 ;
V_151 -> V_167 = V_151 -> V_166 + 32 - 1 ;
V_151 -> V_73 = V_168 ;
V_154 = F_73 ( F_74 ( V_5 -> V_154 ) , 2 ) ;
F_75 ( V_5 -> V_169 , V_154 , V_170 , & V_157 ) ;
V_151 = & V_150 [ V_171 ] ;
V_151 -> V_166 = ( V_157 & ~ 1 ) + V_172 ;
V_151 -> V_167 = V_151 -> V_166 + 3 ;
V_151 -> V_73 = V_168 ;
F_75 ( V_5 -> V_169 , V_154 , V_173 , & V_158 ) ;
V_158 |= V_174 ;
F_76 ( V_5 -> V_169 , V_154 , V_173 , V_158 ) ;
F_77 ( & V_175 ) ;
V_154 = F_73 ( F_74 ( V_5 -> V_154 ) , 1 ) ;
F_78 ( V_5 -> V_169 , V_154 , 0xe1 , & V_160 ) ;
if ( V_160 )
F_79 ( V_5 -> V_169 , V_154 , 0xe1 , 0x0 ) ;
F_75 ( V_5 -> V_169 , V_154 , V_176 , & V_157 ) ;
V_159 = V_157 & 0xfffffff0 ;
F_75 ( V_5 -> V_169 , V_154 , V_176 + 0x4 , & V_157 ) ;
V_159 |= ( T_9 ) V_157 << 32 ;
if ( V_160 )
F_79 ( V_5 -> V_169 , V_154 , 0xe1 , V_160 ) ;
F_80 ( & V_175 ) ;
V_151 = & V_150 [ V_177 ] ;
V_151 -> V_166 = ( V_178 ) V_159 + V_179 ;
V_151 -> V_167 = V_151 -> V_166 + 3 ;
V_151 -> V_73 = V_180 ;
V_153 = F_81 ( & V_5 -> V_6 , L_26 , - 1 ,
V_150 , 3 , & V_181 ,
sizeof( V_181 ) ) ;
if ( F_65 ( V_153 ) ) {
F_16 ( & V_5 -> V_6 , L_27 ) ;
...
static T_10
F_82 ( T_5 V_183 , T_11 V_184 , T_5 V_185 ,
T_9 * V_186 , void * V_187 , void * V_188 )
{
...
V_3 = F_83 ( V_184 , ( T_5 * ) V_186 , V_185 ) ;
else
V_3 = F_84 ( V_184 , ( T_5 ) * V_186 , V_185 ) ;
F_38 ( & V_2 -> V_76 ) ;
return V_3 ;
}
...
struct V_191 * V_192 ;
T_10 V_3 ;
V_192 = F_86 ( & V_2 -> V_5 -> V_6 ) ;
if ( V_192 ) {
V_3 = F_87 ( V_192 -> V_193 ,
V_194 , F_82 ,
NULL , V_2 ) ;
if ( F_88 ( V_3 ) )
return 0 ;
}
return F_89 ( & V_2 -> V_5 -> V_149 [ V_195 ] ) ;
}
...
static inline int F_85 ( struct V_1 * V_2 ) { return 0 ; }
static inline void F_90 ( struct V_1 * V_2 ) { }
static int F_93 ( struct V_5 * V_6 , const struct V_196 * V_143 )
{
unsigned char V_197 ;
int V_128 , V_39 ;
struct V_1 * V_2 ;
V_2 = F_94 ( & V_6 -> V_6 , sizeof( * V_2 ) , V_198 ) ;
if ( ! V_2 )
return - V_199 ;
F_95 ( & V_2 -> V_30 , V_2 ) ;
...
F_96 ( & V_2 -> V_30 . V_6 , F_86 ( & V_6 -> V_6 ) ) ;
V_2 -> V_30 . V_204 = 3 ;
F_97 ( & V_2 -> V_76 ) ;
V_2 -> V_5 = V_6 ;
switch ( V_6 -> V_123 ) {
...
for ( V_39 = 0 ; V_39 < F_56 ( V_225 ) ; V_39 ++ ) {
if ( V_2 -> V_9 & V_226 & ( 1 << V_39 ) )
F_99 ( & V_6 -> V_6 , L_30 ,
V_225 [ V_39 ] ) ;
}
V_2 -> V_9 &= ~ V_226 ;
...
if ( F_85 ( V_2 ) )
return - V_228 ;
V_128 = F_103 ( V_6 , 1 << V_195 ,
F_104 ( & V_6 -> V_6 ) ) ;
if ( V_128 ) {
F_4 ( & V_6 -> V_6 ,
L_33 ,
V_2 -> V_227 ,
( unsigned long long ) F_105 ( V_6 , V_195 ) ) ;
F_90 ( V_2 ) ;
return V_128 ;
}
F_33 ( V_2 -> V_5 , V_68 , & V_197 ) ;
V_2 -> V_90 = V_197 ;
V_197 &= ~ V_69 ;
if ( ! ( V_197 & V_229 ) ) {
F_106 ( & V_6 -> V_6 , L_34 ) ;
...
F_6 ( F_2 ( F_31 ( V_2 ) ) &
~ ( V_93 | V_66 ) , F_31 ( V_2 ) ) ;
V_2 -> V_30 . V_22 = V_231 / 5 ;
if ( V_2 -> V_9 & V_31 ) {
T_2 V_232 , V_57 ;
F_27 ( V_2 -> V_5 , V_58 , & V_57 ) ;
if ( V_57 & V_59 )
F_16 ( & V_6 -> V_6 , L_37 ) ;
F_27 ( V_2 -> V_5 , V_233 , & V_232 ) ;
if ( V_232 & V_234 ) {
F_106 ( & V_6 -> V_6 , L_38 ) ;
V_2 -> V_9 &= ~ V_31 ;
}
...
if ( V_2 -> V_9 & V_31 ) {
F_107 ( & V_2 -> V_34 ) ;
V_128 = F_108 ( & V_6 -> V_6 , V_6 -> V_55 , F_26 ,
V_235 ,
F_104 ( & V_6 -> V_6 ) , V_2 ) ;
if ( V_128 ) {
F_4 ( & V_6 -> V_6 , L_39 ,
