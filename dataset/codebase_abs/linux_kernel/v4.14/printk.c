...
static int F_27 ( int type , int V_57 )
{
...
F_167 ( V_168 -> V_241 , 0 ) ) {
F_168 ( L_37 ,
V_168 -> V_195 , V_168 -> V_200 ) ;
F_161 ( V_168 ) ;
}
}
V_85 = F_169 ( V_242 , L_38 , NULL ,
F_134 ) ;
F_170 ( V_85 < 0 ) ;
V_85 = F_169 ( V_243 , L_39 ,
F_134 , NULL ) ;
F_170 ( V_85 < 0 ) ;
return 0 ;
}
static void F_171 ( struct V_244 * V_244 )
{
int V_245 = F_172 ( V_246 , 0 ) ;
if ( V_245 & V_247 ) {
if ( F_112 () )
F_113 () ;
}
...
int F_180 ( const char * V_182 , T_11 args )
{
int V_189 ;
...
int F_182 ( const char * V_182 , ... )
{
T_11 args ;
int V_189 ;
va_start ( args , V_182 ) ;
V_189 = F_180 ( V_182 , args ) ;
va_end ( args ) ;
return V_189 ;
}
int F_183 ( const char * V_250 )
{
return F_39 ( & V_251 , V_250 ) ;
}
bool F_184 ( unsigned long * V_252 ,
unsigned int V_253 )
{
unsigned long V_254 = V_136 - * V_252 ;
if ( * V_252 && V_254 <= F_88 ( V_253 ) )
return false ;
* V_252 = V_136 ;
return true ;
}
int F_185 ( struct V_255 * V_256 )
{
unsigned long V_21 ;
int V_18 = - V_257 ;
if ( ! V_256 -> V_258 )
...
if ( ! V_256 -> V_260 ) {
V_256 -> V_260 = 1 ;
F_187 ( & V_256 -> V_261 , & V_262 ) ;
V_18 = 0 ;
}
F_188 ( & V_259 , V_21 ) ;
return V_18 ;
}
int F_189 ( struct V_255 * V_256 )
{
unsigned long V_21 ;
int V_18 = - V_2 ;
F_186 ( & V_259 , V_21 ) ;
...
bool F_196 ( struct V_255 * V_256 , bool V_140 ,
...
if ( V_256 -> V_269 >= V_36 )
goto V_98;
V_27 = F_17 ( V_256 -> V_270 ) ;
V_272 = F_94 ( V_27 , V_140 , line , V_42 ) ;
V_256 -> V_270 = F_18 ( V_256 -> V_270 ) ;
V_256 -> V_269 ++ ;
V_85 = true ;
V_98:
if ( V_30 )
...
bool F_197 ( struct V_255 * V_256 , bool V_140 ,
char * line , T_3 V_42 , T_3 * V_30 )
{
unsigned long V_21 ;
bool V_85 ;
F_80 ( V_21 ) ;
V_85 = F_196 ( V_256 , V_140 , line , V_42 , V_30 ) ;
F_81 ( V_21 ) ;
return V_85 ;
}
bool F_198 ( struct V_255 * V_256 , bool V_140 ,
...
if ( V_256 -> V_269 >= V_256 -> V_151 ) {
F_81 ( V_21 ) ;
goto V_98;
}
V_70 = V_256 -> V_269 ;
V_29 = V_256 -> V_270 ;
while ( V_70 < V_256 -> V_151 ) {
struct V_26 * V_27 = F_17 ( V_29 ) ;
V_272 += F_94 ( V_27 , true , NULL , 0 ) ;
V_29 = F_18 ( V_29 ) ;
V_70 ++ ;
}
V_70 = V_256 -> V_269 ;
V_29 = V_256 -> V_270 ;
while ( V_272 > V_42 && V_70 < V_256 -> V_151 ) {
struct V_26 * V_27 = F_17 ( V_29 ) ;
V_272 -= F_94 ( V_27 , true , NULL , 0 ) ;
V_29 = F_18 ( V_29 ) ;
V_70 ++ ;
...
while ( V_70 < V_256 -> V_151 ) {
struct V_26 * V_27 = F_17 ( V_29 ) ;
V_272 += F_94 ( V_27 , V_140 , V_69 + V_272 , V_42 - V_272 ) ;
V_29 = F_18 ( V_29 ) ;
V_70 ++ ;
}
V_256 -> V_151 = V_151 ;
...
void T_1 F_201 ( const char * V_182 , ... )
{
T_11 args ;
va_start ( args , V_182 ) ;
...
void F_202 ( const char * V_274 )
{
F_119 ( L_40 ,
V_274 , F_142 () , V_63 -> V_275 , V_63 -> V_64 ,
F_203 () , F_204 () -> V_276 ,
( int ) strcspn ( F_204 () -> V_277 , L_41 ) ,
F_204 () -> V_277 ) ;
if ( V_273 [ 0 ] != '\0' )
F_119 ( L_42 ,
V_274 , V_273 ) ;
...
void F_206 ( const char * V_274 )
{
F_202 ( V_274 ) ;
F_119 ( L_43 ,
V_274 , V_63 , F_207 ( V_63 ) ) ;
}
