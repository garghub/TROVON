...
static int F_24 ( struct V_37 * V_5 , const struct V_38 * V_39 )
{
struct V_3 * V_3 ;
int V_2 ;
V_3 = F_25 ( sizeof( * V_3 ) , V_29 ) ;
if ( ! V_3 )
return - V_40 ;
F_26 ( & V_3 -> V_17 ) ;
V_3 -> V_5 = V_5 ;
...
static int F_32 ( struct V_37 * V_5 )
{
struct V_3 * V_3 = F_33 ( V_5 ) ;
int V_2 ;
F_34 ( V_45 ) ;
F_35 ( & V_5 -> V_43 , & V_44 ) ;
if ( V_4 == V_3 ) {
