...
{
int V_13 ;
V_49 V_95 = F_38 ( V_2 -> V_77 + 1 ) ;
V_13 = F_36 ( V_2 -> V_15 , V_104 ,
V_105 , V_95 ) ;
if ( V_13 < 0 )
return V_13 ;
return F_32 ( V_2 ) ;
}
static int F_39 ( struct V_1 * V_2 , V_49 V_106 )
{
int V_13 ;
...
static int F_45 ( struct V_1 * V_2 , int * V_46 )
{
int V_13 ;
T_6 V_8 = 0 ;
V_13 = F_39 ( V_2 , V_112 ) ;
...
if ( V_13 < 0 )
return V_13 ;
for ( V_80 = 0 ; V_80 < F_47 ( V_26 ) ; V_80 ++ ) {
if ( V_26 [ V_80 ] == F_48 ( 0 ) || V_26 [ V_80 ] == F_48 ( 0xffff ) )
return - V_51 ;
}
F_49 ( V_26 , sizeof( V_26 ) ) ;
...
static T_2 F_50 ( struct V_1 * V_2 , T_2 V_23 )
{
T_2 V_130 , V_131 ;
...
static int F_52 ( struct V_1 * V_2 , int * V_46 )
{
int V_13 ;
T_5 V_8 = 0 ;
V_49 V_132 = V_2 -> V_78 ;
V_13 = F_39 ( V_2 , F_53 ( V_132 ) ) ;
if ( V_13 )
return V_13 ;
...
static T_1 F_54 ( struct V_1 * V_2 , T_2 V_33 )
{
...
static T_9 F_57 ( int V_138 , void * V_139 )
{
...
V_2 -> V_164 = F_66 ( V_5 , L_22 ) ;
if ( F_67 ( V_2 -> V_164 ) ) {
F_3 ( V_5 , L_23 ) ;
return F_68 ( V_2 -> V_164 ) ;
}
V_13 = F_69 ( V_2 -> V_164 ) ;
if ( V_13 ) {
F_3 ( V_5 , L_24 ) ;
...
F_44 ( V_2 -> V_159 , V_2 -> V_159 + 100 ) ;
V_147 = F_70 ( V_5 , L_28 , V_167 ) ;
if ( ! F_67 ( V_147 ) ) {
F_71 ( V_5 , L_29 ) ;
F_72 ( V_147 , 0 ) ;
}
