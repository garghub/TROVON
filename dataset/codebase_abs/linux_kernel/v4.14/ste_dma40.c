...
static struct V_176 *
F_138 ( struct V_173 * V_4 , struct V_99 * V_100 ,
unsigned int V_101 , enum V_264 V_265 ,
unsigned long V_260 , void * V_295 )
{
if ( ! F_139 ( V_265 ) )
return NULL ;
...
static struct V_176 *
F_140 ( struct V_173 * V_4 , T_6 V_29 ,
T_7 V_296 , T_7 V_297 ,
...
struct V_99 * V_102 ;
int V_33 ;
V_102 = F_141 ( V_298 + 1 , sizeof( struct V_99 ) , V_24 ) ;
if ( ! V_102 )
return NULL ;
...
F_142 ( V_102 , V_298 + 1 , V_102 ) ;
V_47 = F_118 ( V_4 , V_102 , V_102 , V_298 , V_265 ,
V_186 ) ;
F_10 ( V_102 ) ;
return V_47 ;
}
static enum V_299 F_143 ( struct V_173 * V_4 ,
T_3 V_178 ,
struct V_300 * V_301 )
{
struct V_2 * V_3 = F_77 ( V_4 , struct V_2 , V_4 ) ;
...
V_34 = F_144 ( V_4 , V_178 , V_301 ) ;
if ( V_34 != V_302 && V_301 )
F_145 ( V_301 , F_109 ( V_4 ) ) ;
if ( F_108 ( V_3 ) )
V_34 = V_303 ;
return V_34 ;
}
...
! F_151 ( V_317 ) )
return - V_35 ;
V_257 -> V_209 . V_168 = V_316 ;
V_257 -> V_167 . V_168 = V_317 ;
...
V_3 -> V_266 = V_318 ;
V_3 -> V_325 = V_314 -> V_265 ;
F_64 ( V_3 -> V_8 -> V_5 ,
L_42
L_43 ,
F_153 ( V_4 ) ,
( V_314 -> V_265 == V_79 ) ? L_44 : L_45 ,
V_316 , V_317 ,
V_319 , V_320 ) ;
return 0 ;
}
static void T_8 F_154 ( struct V_189 * V_8 , struct V_326 * V_327 ,
struct V_2 * V_328 , int V_197 ,
int V_329 )
{
int V_33 = 0 ;
struct V_2 * V_3 ;
F_24 ( & V_327 -> V_330 ) ;
for ( V_33 = V_197 ; V_33 < V_197 + V_329 ; V_33 ++ ) {
V_3 = & V_328 [ V_33 ] ;
V_3 -> V_8 = V_8 ;
V_3 -> V_4 . V_1 = V_327 ;
F_155 ( & V_3 -> V_37 ) ;
...
static void F_157 ( struct V_189 * V_8 , struct V_326 * V_5 )
{
if ( F_105 ( V_240 , V_5 -> V_238 ) ) {
V_5 -> V_332 = F_138 ;
V_5 -> V_333 = F_94 ( V_79 ) | F_94 ( V_229 ) ;
}
if ( F_105 ( V_239 , V_5 -> V_238 ) ) {
V_5 -> V_334 = F_135 ;
V_5 -> V_333 = F_94 ( V_230 ) ;
V_5 -> V_335 = V_336 ;
}
if ( F_105 ( V_337 , V_5 -> V_238 ) )
V_5 -> V_338 = F_140 ;
V_5 -> V_339 = F_132 ;
V_5 -> V_340 = F_134 ;
V_5 -> V_341 = F_146 ;
...
{
int V_179 ;
F_154 ( V_8 , & V_8 -> V_350 , V_8 -> V_351 ,
0 , V_8 -> V_207 ) ;
F_124 ( V_8 -> V_350 . V_238 ) ;
F_125 ( V_240 , V_8 -> V_350 . V_238 ) ;
F_125 ( V_337 , V_8 -> V_350 . V_238 ) ;
F_157 ( V_8 , & V_8 -> V_350 ) ;
V_179 = F_159 ( & V_8 -> V_350 ) ;
if ( V_179 ) {
F_96 ( V_8 -> V_5 , L_46 ) ;
goto exit;
}
F_154 ( V_8 , & V_8 -> V_352 , V_8 -> V_351 ,
V_8 -> V_207 , V_8 -> V_353 ) ;
F_124 ( V_8 -> V_352 . V_238 ) ;
F_125 ( V_239 , V_8 -> V_352 . V_238 ) ;
F_157 ( V_8 , & V_8 -> V_352 ) ;
...
{
struct V_358 * V_359 = F_162 ( V_5 ) ;
struct V_189 * V_8 = F_163 ( V_359 ) ;
int V_34 ;
V_34 = F_164 ( V_5 ) ;
if ( V_34 )
return V_34 ;
...
int V_34 = 0 ;
if ( V_8 -> V_360 ) {
V_34 = F_167 ( V_8 -> V_360 ) ;
if ( V_34 )
return V_34 ;
}
return F_168 ( V_5 ) ;
}
static void F_169 ( void T_1 * V_361 , T_2 * V_362 ,
T_2 * V_363 , int V_12 , bool V_364 )
{
int V_33 ;
for ( V_33 = 0 ; V_33 < V_12 ; V_33 ++ ) {
void T_1 * V_124 = V_361 + V_363 [ V_33 ] ;
if ( V_364 )
V_362 [ V_33 ] = F_170 ( V_124 ) ;
else
F_171 ( V_362 [ V_33 ] , V_124 ) ;
}
}
static void F_172 ( struct V_189 * V_8 , bool V_364 )
{
int V_33 ;
for ( V_33 = 0 ; V_33 < V_8 -> V_208 ; V_33 ++ ) {
void T_1 * V_124 ;
int V_39 ;
if ( V_8 -> V_228 [ V_33 ] . V_365 )
continue;
V_124 = V_8 -> V_9 + V_10 + V_33 * V_13 ;
V_39 = V_33 * F_173 ( V_366 ) ;
F_169 ( V_124 , & V_8 -> V_367 [ V_39 ] ,
V_366 ,
F_173 ( V_366 ) ,
V_364 ) ;
}
F_169 ( V_8 -> V_9 , V_8 -> V_368 ,
V_369 , F_173 ( V_369 ) ,
V_364 ) ;
if ( V_8 -> V_191 . V_362 )
...
int V_376 = - 2 ;
int V_377 = V_378 ;
V_134 [ 0 ] = F_53 ( V_8 -> V_9 + V_379 ) ;
V_134 [ 1 ] = F_53 ( V_8 -> V_9 + V_380 ) ;
for ( V_33 = 0 ; V_33 < V_8 -> V_208 ; V_33 ++ ) {
V_8 -> V_228 [ V_33 ] . V_12 = V_33 ;
V_376 += 2 * ( ( V_33 % 2 ) == 0 ) ;
if ( ( ( V_134 [ V_33 % 2 ] >> V_376 ) & 3 ) == 1 ) {
V_8 -> V_228 [ V_33 ] . V_215 = V_218 ;
V_8 -> V_228 [ V_33 ] . V_216 = V_218 ;
V_8 -> V_228 [ V_33 ] . V_365 = true ;
V_377 |= F_177 ( F_178 ( V_33 ) ,
V_381 ) ;
V_377 |= F_177 ( F_178 ( V_33 ) ,
V_382 ) ;
} else {
...
V_8 -> V_228 [ V_4 ] . V_365 = true ;
V_377 |= F_177 ( F_178 ( V_4 ) ,
V_381 ) ;
V_377 |= F_177 ( F_178 ( V_4 ) ,
V_382 ) ;
V_375 -- ;
...
static struct V_189 * T_8 F_180 ( struct V_358 * V_359 )
{
struct V_387 * V_74 = F_181 ( & V_359 -> V_5 ) ;
struct V_388 * V_388 ;
void T_1 * V_9 ;
struct V_389 * V_174 ;
struct V_189 * V_8 ;
...
V_174 = F_185 ( V_359 , V_395 , L_53 ) ;
if ( ! V_174 )
goto V_394;
if ( F_186 ( V_174 -> V_396 , F_187 ( V_174 ) ,
V_397 L_54 ) == NULL )
goto V_398;
V_9 = F_188 ( V_174 -> V_396 , F_187 ( V_174 ) ) ;
if ( ! V_9 )
goto V_398;
for ( V_391 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_391 |= ( F_53 ( V_9 + F_187 ( V_174 ) - 0x20 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
for ( V_392 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_392 |= ( F_53 ( V_9 + F_187 ( V_174 ) - 0x10 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
if ( V_392 != V_399 ) {
F_96 ( & V_359 -> V_5 , L_55 ) ;
goto V_400;
}
if ( F_189 ( V_391 ) != V_401 ) {
F_96 ( & V_359 -> V_5 , L_56 ,
F_189 ( V_391 ) ,
V_401 ) ;
goto V_400;
...
V_281 = F_190 ( V_391 ) ;
if ( V_281 < 2 ) {
F_96 ( & V_359 -> V_5 , L_57 , V_281 ) ;
goto V_400;
}
if ( V_74 -> V_402 )
V_208 = V_74 -> V_402 ;
else
V_208 = 4 * ( F_53 ( V_9 + V_403 ) & 0x7 ) + 4 ;
if ( V_74 -> V_404 )
V_353 = V_74 -> V_404 ;
else
V_353 = F_173 ( V_242 ) ;
...
F_179 ( & V_359 -> V_5 ,
L_58 ,
V_281 , & V_174 -> V_396 , V_208 , V_207 ) ;
V_8 = F_191 ( F_47 ( sizeof( struct V_189 ) , 4 ) +
( V_208 + V_207 + V_353 ) *
sizeof( struct V_2 ) , V_406 ) ;
if ( V_8 == NULL )
goto V_400;
V_8 -> V_281 = V_281 ;
V_8 -> V_388 = V_388 ;
...
V_8 -> V_208 = V_208 ;
V_8 -> V_207 = V_207 ;
V_8 -> V_407 = V_174 -> V_396 ;
V_8 -> V_408 = F_187 ( V_174 ) ;
V_8 -> V_9 = V_9 ;
V_8 -> V_74 = V_74 ;
V_8 -> V_5 = & V_359 -> V_5 ;
V_8 -> V_356 = ( ( void * ) V_8 ) + F_47 ( sizeof( struct V_189 ) , 4 ) ;
V_8 -> V_351 = & V_8 -> V_356 [ V_208 ] ;
if ( V_8 -> V_74 -> V_402 == 14 ) {
V_8 -> V_191 . V_362 = V_409 ;
V_8 -> V_191 . V_371 = V_410 ;
V_8 -> V_191 . V_411 = V_412 ;
V_8 -> V_191 . V_413 = V_414 ;
V_8 -> V_191 . V_277 = V_415 ;
V_8 -> V_191 . V_278 = V_416 ;
V_8 -> V_191 . V_279 = V_417 ;
V_8 -> V_191 . V_280 = V_418 ;
V_8 -> V_191 . V_194 = V_419 ;
V_8 -> V_191 . V_192 = F_173 ( V_419 ) ;
V_8 -> V_191 . V_420 = V_421 ;
V_8 -> V_191 . V_422 = F_173 ( V_421 ) ;
} else {
if ( V_8 -> V_281 >= 3 ) {
V_8 -> V_191 . V_362 = V_423 ;
V_8 -> V_191 . V_371 = V_424 ;
}
V_8 -> V_191 . V_411 = V_425 ;
V_8 -> V_191 . V_413 = V_426 ;
V_8 -> V_191 . V_277 = V_427 ;
V_8 -> V_191 . V_278 = V_428 ;
V_8 -> V_191 . V_279 = V_429 ;
V_8 -> V_191 . V_280 = V_430 ;
V_8 -> V_191 . V_194 = V_431 ;
V_8 -> V_191 . V_192 = F_173 ( V_431 ) ;
V_8 -> V_191 . V_420 = V_432 ;
V_8 -> V_191 . V_422 = F_173 ( V_432 ) ;
}
V_8 -> V_228 = F_141 ( V_208 ,
sizeof( * V_8 -> V_228 ) ,
V_406 ) ;
if ( ! V_8 -> V_228 )
goto V_433;
V_8 -> V_198 = F_141 ( V_208 ,
sizeof( * V_8 -> V_198 ) ,
V_406 ) ;
if ( ! V_8 -> V_198 )
goto V_434;
V_8 -> V_199 = F_141 ( V_207 ,
sizeof( * V_8 -> V_199 ) ,
V_406 ) ;
if ( ! V_8 -> V_199 )
goto V_435;
V_8 -> V_367 = F_192 ( V_8 -> V_208 ,
sizeof( V_366 ) ,
V_406 ) ;
if ( ! V_8 -> V_367 )
goto V_436;
V_8 -> V_36 . V_40 = F_141 ( V_208
* V_38 ,
sizeof( * V_8 -> V_36 . V_40 ) ,
V_406 ) ;
if ( ! V_8 -> V_36 . V_40 )
goto V_437;
V_8 -> V_48 = F_193 ( V_397 , sizeof( struct V_14 ) ,
0 , V_438 ,
NULL ) ;
if ( V_8 -> V_48 == NULL )
goto V_439;
...
int V_33 ;
T_2 V_440 [ 2 ] = { 0 , 0 } ;
T_2 V_441 [ 2 ] = { 0xFFFFFFFF , 0xFFFFFFFF } ;
T_2 V_442 = 0 ;
T_2 V_443 = 0 ;
struct V_444 * V_445 = V_8 -> V_191 . V_420 ;
T_2 V_446 = V_8 -> V_191 . V_422 ;
for ( V_33 = 0 ; V_33 < V_446 ; V_33 ++ )
F_30 ( V_445 [ V_33 ] . V_134 ,
V_8 -> V_9 + V_445 [ V_33 ] . V_123 ) ;
for ( V_33 = 0 ; V_33 < V_8 -> V_208 ; V_33 ++ ) {
...
F_30 ( V_440 [ 1 ] , V_8 -> V_9 + V_154 ) ;
F_30 ( V_440 [ 0 ] , V_8 -> V_9 + V_447 ) ;
F_30 ( V_441 [ 1 ] , V_8 -> V_9 + V_112 ) ;
F_30 ( V_441 [ 0 ] , V_8 -> V_9 + V_113 ) ;
F_30 ( V_442 , V_8 -> V_9 + V_8 -> V_191 . V_411 ) ;
F_30 ( V_443 , V_8 -> V_9 + V_8 -> V_191 . V_413 ) ;
V_8 -> V_191 . V_420 = NULL ;
V_8 -> V_191 . V_422 = 0 ;
}
...
if ( ! V_448 )
return - V_25 ;
V_8 -> V_36 . V_450 = V_451 * V_8 -> V_208 / V_452 ;
for ( V_33 = 0 ; V_33 < V_449 ; V_33 ++ ) {
V_448 [ V_33 ] = F_200 ( V_406 ,
V_8 -> V_36 . V_450 ) ;
if ( ! V_448 [ V_33 ] ) {
F_96 ( V_8 -> V_5 , L_59 ,
V_8 -> V_36 . V_450 ) ;
...
F_201 ( V_448 [ V_227 ] , V_8 -> V_36 . V_450 ) ;
goto V_453;
}
if ( ( F_114 ( ( void * ) V_448 [ V_33 ] ) &
( V_454 - 1 ) ) == 0 )
break;
}
for ( V_227 = 0 ; V_227 < V_33 ; V_227 ++ )
F_201 ( V_448 [ V_227 ] , V_8 -> V_36 . V_450 ) ;
if ( V_33 < V_449 ) {
V_8 -> V_36 . V_8 = ( void * ) V_448 [ V_33 ] ;
} else {
F_202 ( V_8 -> V_5 ,
L_60 ,
V_129 , V_8 -> V_36 . V_450 ) ;
V_8 -> V_36 . V_455 = F_6 ( V_451 *
V_8 -> V_208 +
V_454 ,
V_406 ) ;
if ( ! V_8 -> V_36 . V_455 ) {
...
V_8 -> V_36 . V_8 = F_7 ( V_8 -> V_36 . V_455 ,
V_454 ) ;
}
...
static int T_8 F_203 ( struct V_358 * V_359 ,
struct V_331 * V_457 )
{
struct V_387 * V_458 ;
int V_459 = 0 , V_460 = 0 , V_461 = 0 ;
const T_10 * V_462 ;
V_458 = F_204 ( & V_359 -> V_5 , sizeof( * V_458 ) , V_406 ) ;
if ( ! V_458 )
return - V_25 ;
F_205 ( V_457 , L_61 , & V_459 ) ;
if ( V_459 > 0 )
V_458 -> V_402 = V_459 ;
V_462 = F_206 ( V_457 , L_62 , & V_460 ) ;
V_460 /= sizeof( * V_462 ) ;
if ( V_460 > V_463 || V_460 <= 0 ) {
F_96 ( & V_359 -> V_5 ,
L_63 ,
V_460 ) ;
return - V_35 ;
...
V_242 ,
V_460 ) ;
V_462 = F_206 ( V_457 , L_64 , & V_461 ) ;
V_461 /= sizeof( * V_462 ) ;
if ( V_461 >= V_464 || V_461 < 0 ) {
F_96 ( & V_359 -> V_5 ,
L_65 ,
V_461 ) ;
return - V_35 ;
...
V_461 ) ;
V_458 -> V_383 [ V_461 ] = - 1 ;
V_359 -> V_5 . V_465 = V_458 ;
return 0 ;
}
static int T_8 F_208 ( struct V_358 * V_359 )
{
struct V_387 * V_74 = F_181 ( & V_359 -> V_5 ) ;
struct V_331 * V_457 = V_359 -> V_5 . V_466 ;
int V_34 = - V_467 ;
struct V_189 * V_8 ;
struct V_389 * V_174 ;
int V_349 ;
...
F_155 ( & V_8 -> V_195 ) ;
F_155 ( & V_8 -> V_111 ) ;
V_174 = F_185 ( V_359 , V_395 , L_67 ) ;
if ( ! V_174 ) {
V_34 = - V_467 ;
F_96 ( & V_359 -> V_5 , L_68 ) ;
goto V_469;
}
V_8 -> V_470 = F_187 ( V_174 ) ;
V_8 -> V_471 = V_174 -> V_396 ;
if ( F_186 ( V_174 -> V_396 , F_187 ( V_174 ) ,
V_397 L_69 ) == NULL ) {
V_34 = - V_117 ;
F_96 ( & V_359 -> V_5 , L_70 , V_174 ) ;
goto V_469;
}
V_134 = F_53 ( V_8 -> V_9 + V_472 ) ;
if ( V_174 -> V_396 != V_134 && V_134 != 0 ) {
F_202 ( & V_359 -> V_5 ,
L_71 ,
V_129 , V_134 , & V_174 -> V_396 ) ;
} else
F_30 ( V_174 -> V_396 , V_8 -> V_9 + V_472 ) ;
V_8 -> V_289 = F_188 ( V_174 -> V_396 , F_187 ( V_174 ) ) ;
if ( ! V_8 -> V_289 ) {
V_34 = - V_25 ;
F_96 ( & V_359 -> V_5 , L_72 ) ;
goto V_469;
...
V_8 -> V_36 . V_8 = F_188 ( V_174 -> V_396 ,
F_187 ( V_174 ) ) ;
if ( ! V_8 -> V_36 . V_8 ) {
V_34 = - V_25 ;
F_96 ( & V_359 -> V_5 , L_75 ) ;
...
F_30 ( V_174 -> V_396 , V_8 -> V_9 + V_456 ) ;
} else {
V_34 = F_199 ( V_8 ) ;
if ( V_34 ) {
F_96 ( & V_359 -> V_5 , L_76 ) ;
...
F_155 ( & V_8 -> V_36 . V_37 ) ;
V_8 -> V_187 = F_210 ( V_359 , 0 ) ;
V_34 = F_211 ( V_8 -> V_187 , F_92 , 0 , V_397 , V_8 ) ;
if ( V_34 ) {
F_96 ( & V_359 -> V_5 , L_77 ) ;
goto V_469;
}
if ( V_8 -> V_74 -> V_73 ) {
V_8 -> V_360 = F_212 ( V_8 -> V_5 , L_73 ) ;
if ( F_183 ( V_8 -> V_360 ) ) {
F_96 ( & V_359 -> V_5 , L_78 ) ;
V_34 = F_213 ( V_8 -> V_360 ) ;
V_8 -> V_360 = NULL ;
goto V_469;
}
V_34 = F_167 ( V_8 -> V_360 ) ;
...
F_218 ( V_8 -> V_5 ) ;
F_219 ( V_8 -> V_5 ) ;
V_34 = F_158 ( V_8 , V_349 ) ;
if ( V_34 )
goto V_469;
V_8 -> V_5 -> V_474 = & V_8 -> V_474 ;
...
V_451 * V_8 -> V_208 ,
V_31 ) ;
if ( ! V_8 -> V_36 . V_455 && V_8 -> V_36 . V_8 )
