...
if ( ! V_21 )
goto V_28;
V_25 = F_13 ( V_23 , V_24 , V_21 , V_29 , NULL ) ;
if ( V_25 < 0 )
goto V_28;
if ( V_23 [ V_30 ] )
...
static struct V_43 * F_17 ( struct V_5 * V_6 , unsigned long V_18 )
{
struct V_1 * V_2 = F_3 ( V_6 ) ;
return V_2 -> V_44 ;
}
...
struct V_58 V_59 ;
struct V_60 * V_61 = F_29 ( V_2 -> V_62 ) ;
int V_63 = F_30 ( V_46 , V_61 , & V_59 , false ) ;
F_4 ( L_6 , V_63 , V_59 . V_16 ) ;
switch ( V_63 ) {
#ifdef F_31
case V_64 :
case V_65 :
...
struct V_1 * V_2 = F_3 ( V_6 ) ;
F_4 ( L_7 , V_10 , V_6 , V_2 ) ;
return V_2 -> V_15 -> V_75 -> V_76 ( V_2 -> V_15 ) ;
}
...
V_2 -> V_31 = F_51 ( V_4 , sizeof( * V_2 -> V_31 ) , V_81 ) ;
if ( ! V_2 -> V_31 ) {
V_25 = - V_82 ;
goto V_28;
}
...
F_57 ( V_2 -> V_44 ) ;
F_58 ( V_2 -> V_15 ) ;
if ( V_2 -> V_31 != V_2 -> V_80 )
F_59 ( V_2 -> V_31 ) ;
}
static int F_60 ( struct V_5 * V_6 , unsigned long V_18 ,
struct V_45 * V_46 , struct V_86 * V_87 )
{
struct V_1 * V_2 = F_3 ( V_6 ) ;
struct V_19 * V_88 = NULL ;
F_4 ( L_12 , V_10 , V_6 , V_2 , V_18 ) ;
if ( ! F_1 ( V_2 , V_18 ) )
return - V_26 ;
V_87 -> V_89 = F_61 ( F_28 ( V_6 -> V_13 ) , V_18 - 1 ) ;
V_87 -> V_90 = V_2 -> V_15 -> V_13 ;
V_88 = F_62 ( V_46 , V_22 ) ;
if ( V_88 == NULL )
goto V_91;
if ( F_63 ( V_46 , V_33 , V_2 -> V_31 [ V_18 - 1 ] . V_34 ) ||
F_63 ( V_46 , V_30 , V_2 -> V_31 [ V_18 - 1 ] . V_32 ) )
goto V_91;
return F_64 ( V_46 , V_88 ) ;
V_91:
F_65 ( V_46 , V_88 ) ;
return - V_92 ;
}
static int F_66 ( struct V_5 * V_6 , struct V_45 * V_46 )
{
struct V_1 * V_2 = F_3 ( V_6 ) ;
struct V_19 * V_88 = NULL ;
V_88 = F_62 ( V_46 , V_22 ) ;
if ( V_88 == NULL )
goto V_91;
if ( F_67 ( V_46 , V_77 , V_2 -> V_4 ) )
goto V_91;
if ( V_2 -> V_71 != V_72 &&
F_67 ( V_46 , V_78 , V_2 -> V_71 ) )
goto V_91;
if ( V_2 -> V_48 &&
F_68 ( V_46 , V_83 ) )
goto V_91;
