...
V_37 = V_17 -> V_44 ;
V_19 = F_19 ( V_36 , V_3 , ( V_3 & V_37 ) , 10 ,
V_45 ) ;
if ( V_19 ) {
F_10 ( V_16 -> V_20 ,
L_5 ) ;
...
int V_19 , V_9 ;
F_8 ( V_16 -> V_20 , L_6 ) ;
for ( V_9 = 0 ; V_9 < V_16 -> V_17 -> V_49 ; V_9 ++ ) {
V_19 = F_11 ( V_16 -> V_50 [ V_9 ] ) ;
if ( V_19 ) {
F_10 ( V_16 -> V_20 , L_7 ,
V_16 -> V_17 -> V_51 [ V_9 ] , V_19 ) ;
goto V_52;
}
}
V_19 = F_15 ( V_16 ) ;
...
F_5 ( V_46 , V_17 -> V_5 , V_17 -> V_57 , V_17 -> V_58 ) ;
F_5 ( V_47 , V_17 -> V_5 , V_17 -> V_59 , V_17 -> V_60 ) ;
F_5 ( V_48 , V_17 -> V_5 , V_17 -> V_61 , V_17 -> V_62 ) ;
F_1 ( V_48 , V_63 , V_17 -> V_64 ) ;
if ( V_17 -> V_65 )
F_23 ( V_17 -> V_66 , V_17 -> V_67 ) ;
F_1 ( V_48 , V_17 -> V_5 [ V_68 ] , V_17 -> V_69 ) ;
F_4 ( V_48 , V_17 -> V_5 [ V_70 ] , V_39 ) ;
V_36 = V_48 + V_17 -> V_5 [ V_71 ] ;
V_37 = V_17 -> V_72 ;
V_19 = F_19 ( V_36 , V_3 , ! ( V_3 & V_37 ) , 1 ,
V_45 ) ;
if ( V_19 ) {
F_10 ( V_16 -> V_20 , L_9 ) ;
goto V_73;
...
const struct V_23 * V_17 = V_16 -> V_17 ;
int V_9 = V_17 -> V_49 ;
F_1 ( V_14 -> V_48 , V_17 -> V_5 [ V_70 ] , V_39 ) ;
F_4 ( V_14 -> V_48 , V_17 -> V_5 [ V_68 ] , V_17 -> V_69 ) ;
F_4 ( V_14 -> V_48 , V_63 , V_17 -> V_64 ) ;
if ( V_17 -> V_53 )
F_20 ( V_14 -> V_54 ) ;
F_21 ( V_16 ) ;
while ( -- V_9 >= 0 )
...
struct V_15 * V_16 = F_26 ( V_20 ) ;
int V_19 , V_9 ;
V_16 -> V_50 = F_27 ( V_20 , V_16 -> V_17 -> V_49 ,
sizeof( * V_16 -> V_50 ) , V_75 ) ;
if ( ! V_16 -> V_50 )
return - V_76 ;
for ( V_9 = 0 ; V_9 < V_16 -> V_17 -> V_49 ; V_9 ++ ) {
struct V_82 * V_83 ;
const char * V_81 = V_16 -> V_17 -> V_51 [ V_9 ] ;
V_83 = F_34 ( V_20 , V_81 ) ;
if ( F_31 ( V_83 ) ) {
V_19 = F_32 ( V_83 ) ;
if ( V_19 != - V_84 )
...
static int F_35 ( struct V_15 * V_16 , struct V_85 * V_86 )
{
struct V_87 * V_88 ;
struct V_89 V_90 = { } ;
int V_19 ;
...
V_19 = F_36 ( V_86 , L_12 , & V_90 . V_81 ) ;
if ( V_19 ) {
F_10 ( V_16 -> V_20 , L_13 , V_86 -> V_81 ) ;
return V_19 ;
}
V_88 = F_37 ( V_16 -> V_20 , sizeof( * V_88 ) , V_75 ) ;
if ( ! V_88 )
return - V_76 ;
V_90 . V_93 = & V_94 ;
V_88 -> V_95 = 125000000 ;
V_88 -> V_96 . V_90 = & V_90 ;
return F_38 ( V_16 -> V_20 , & V_88 -> V_96 ) ;
}
static
int F_39 ( struct V_74 * V_20 , struct V_85 * V_86 , int V_97 )
{
struct V_15 * V_16 = F_26 ( V_20 ) ;
struct V_12 * V_98 ;
struct V_13 * V_14 ;
char V_99 [ V_100 ] ;
int V_19 ;
V_14 = F_37 ( V_20 , sizeof( * V_14 ) , V_75 ) ;
if ( ! V_14 )
return - V_76 ;
V_14 -> V_46 = F_40 ( V_86 , 0 ) ;
if ( ! V_14 -> V_46 )
return - V_76 ;
V_14 -> V_47 = F_40 ( V_86 , 1 ) ;
if ( ! V_14 -> V_47 )
return - V_76 ;
V_14 -> V_48 = F_40 ( V_86 , 2 ) ;
if ( ! V_14 -> V_48 )
return - V_76 ;
snprintf ( V_99 , sizeof( V_99 ) , L_14 , V_97 ) ;
V_14 -> V_22 = F_41 ( V_86 , V_99 ) ;
if ( F_31 ( V_14 -> V_22 ) ) {
if ( V_16 -> V_17 -> type == V_92 ||
V_16 -> V_17 -> type == V_91 ) {
V_19 = F_32 ( V_14 -> V_22 ) ;
if ( V_19 != - V_84 )
F_10 ( V_20 ,
...
if ( V_16 -> V_17 -> V_53 ) {
snprintf ( V_99 , sizeof( V_99 ) , L_16 , V_97 ) ;
V_14 -> V_54 = F_42 ( V_86 , V_99 ) ;
if ( F_31 ( V_14 -> V_54 ) ) {
F_10 ( V_20 , L_17 , V_97 ) ;
return F_32 ( V_14 -> V_54 ) ;
}
}
V_98 = F_43 ( V_20 , V_86 , & V_101 ) ;
if ( F_31 ( V_98 ) ) {
V_19 = F_32 ( V_98 ) ;
F_10 ( V_20 , L_18 , V_19 ) ;
return V_19 ;
...
int V_8 , V_97 ;
int V_19 ;
V_16 = F_37 ( V_20 , sizeof( * V_16 ) , V_75 ) ;
if ( ! V_16 )
return - V_76 ;
V_16 -> V_20 = V_20 ;
F_46 ( V_20 , V_16 ) ;
V_106 = F_47 ( V_104 , V_109 , 0 ) ;
V_1 = F_48 ( V_20 , V_106 ) ;
if ( F_31 ( V_1 ) )
return F_32 ( V_1 ) ;
V_16 -> V_24 = V_1 ;
...
return - V_76 ;
V_97 = 0 ;
F_52 (dev->of_node, child) {
V_19 = F_39 ( V_20 , V_107 , V_97 ) ;
if ( V_19 ) {
F_10 ( V_20 , L_20 ,
V_97 , V_19 ) ;
return V_19 ;
}
V_19 = F_35 ( V_16 , V_107 ) ;
if ( V_19 ) {
F_10 ( V_16 -> V_20 ,
L_21 ) ;
return V_19 ;
