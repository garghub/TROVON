...
static int F_37 ( struct V_94 * V_95 , const struct V_96 * V_97 )
{
static const char V_98 [] = L_4 ;
const struct V_99 * V_100 = NULL ;
const struct V_101 * V_102 ;
struct V_94 * V_59 ;
struct V_103 * V_104 = F_38 ( V_95 ) ;
struct V_3 * V_4 ;
struct V_5 * V_6 ;
T_3 * V_17 ;
int V_105 = 0 ;
int V_18 , V_10 ;
struct V_106 V_107 ;
V_17 = V_95 -> V_108 -> V_109 ;
V_18 = V_95 -> V_108 -> V_110 ;
F_39 ( & V_107 , V_95 , V_17 , V_18 ) ;
V_100 = V_107 . V_99 ;
V_105 = V_107 . V_111 ;
if ( ! V_100 || ! V_105 )
return - V_112 ;
V_59 = F_40 ( V_104 , V_100 -> V_113 ) ;
if ( V_59 == NULL )
return - V_114 ;
if ( V_59 -> V_115 != 2 )
return - V_112 ;
if ( V_59 -> V_108 [ 0 ] . V_61 . V_116 == 0 &&
V_59 -> V_108 [ 1 ] . V_61 . V_116 == 2 )
V_102 = V_59 -> V_108 + 1 ;
else
if ( V_59 -> V_108 [ 0 ] . V_61 . V_116 == 2 &&
V_59 -> V_108 [ 1 ] . V_61 . V_116 == 0 )
V_102 = V_59 -> V_108 ;
else
return - V_112 ;
...
F_43 ( & V_6 -> V_22 ) ;
F_43 ( & V_6 -> V_45 ) ;
if ( F_44 ( V_102 -> V_118 [ 0 ] . V_61 . V_119 ) ) {
V_6 -> V_41 = F_45 ( V_104 ,
V_102 -> V_118 [ 0 ] . V_61 . V_119 ) ;
V_6 -> V_16 = F_46 ( V_104 ,
V_102 -> V_118 [ 1 ] . V_61 . V_119 ) ;
} else {
V_6 -> V_41 = F_45 ( V_104 ,
V_102 -> V_118 [ 1 ] . V_61 . V_119 ) ;
V_6 -> V_16 = F_46 ( V_104 ,
...
V_6 -> V_63 = V_102 - V_59 -> V_108 ;
V_10 = F_47 ( & V_120 , V_59 , V_6 ) ;
if ( V_10 )
goto V_121;
F_32 ( V_104 , V_100 -> V_113 ,
! V_6 -> V_63 ) ;
F_48 ( V_95 , V_6 ) ;
V_10 = F_49 ( V_4 ) ;
if ( V_10 ) {
...
V_6 -> V_122 = 1 ;
F_50 ( & V_120 ,
( V_6 -> V_95 == V_95 ) ? V_6 -> V_59 : V_6 -> V_95 ) ;
F_54 ( V_6 -> V_4 ) ;
}
