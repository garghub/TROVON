...
return - V_56 ;
F_5 ( & V_13 ) ;
V_108 = F_93 ( & V_20 , & V_2 -> V_21 ) ;
F_8 ( & V_13 ) ;
} while ( V_108 == - V_110 );
return V_108 ;
}
int F_94 ( struct V_22 * V_2 )
{
int V_83 = 0 , V_108 ;
struct V_1 * V_6 ;
T_6 * V_19 ;
...
if ( F_23 ( V_101 , V_2 -> V_26 ) && ! V_2 -> V_112 ) {
F_32 ( V_2 -> V_3 ,
L_15 ,
L_16 ) ;
return - V_111 ;
}
if ( F_23 ( V_103 , V_2 -> V_26 ) && ! V_2 -> V_113 ) {
F_32 ( V_2 -> V_3 ,
L_15 ,
L_17 ) ;
return - V_111 ;
}
if ( F_23 ( V_104 , V_2 -> V_26 ) && ! V_2 -> V_114 ) {
F_32 ( V_2 -> V_3 ,
L_15 ,
L_18 ) ;
return - V_111 ;
}
if ( F_23 ( V_106 , V_2 -> V_26 ) && ! V_2 -> V_115 ) {
F_32 ( V_2 -> V_3 ,
L_15 ,
L_19 ) ;
return - V_111 ;
}
if ( F_23 ( V_107 , V_2 -> V_26 ) && ! V_2 -> V_116 ) {
F_32 ( V_2 -> V_3 ,
L_15 ,
L_20 ) ;
return - V_111 ;
}
if ( F_23 ( V_117 , V_2 -> V_26 ) && ! V_2 -> V_118 ) {
F_32 ( V_2 -> V_3 ,
L_15 ,
L_21 ) ;
return - V_111 ;
}
if ( F_23 ( V_52 , V_2 -> V_26 ) && ! V_2 -> V_119 ) {
F_32 ( V_2 -> V_3 ,
L_15 ,
L_22 ) ;
return - V_111 ;
}
if ( F_23 ( V_67 , V_2 -> V_26 ) && ! V_2 -> V_120 ) {
F_32 ( V_2 -> V_3 ,
L_15 ,
L_23 ) ;
return - V_111 ;
}
if ( F_23 ( V_121 , V_2 -> V_26 ) && ! V_2 -> V_122 ) {
F_32 ( V_2 -> V_3 ,
L_15 ,
L_24 ) ;
return - V_111 ;
...
if ( V_6 -> V_14 == NULL )
goto V_35;
V_6 -> V_3 = F_97 ( sizeof( * V_6 -> V_3 ) , V_109 ) ;
if ( V_6 -> V_3 == NULL ) {
F_40 ( V_6 -> V_14 ) ;
V_6 -> V_14 = NULL ;
goto V_35;
...
F_98 ( V_19 ) ;
F_99 ( & V_6 -> V_3 -> V_2 , L_27 ,
V_2 -> V_21 , V_6 -> V_125 ) ;
V_108 = F_100 ( & V_6 -> V_3 -> V_2 ) ;
if ( V_108 ) {
F_40 ( V_6 -> V_14 ) ;
V_6 -> V_14 = NULL ;
F_14 ( V_6 -> V_3 ) ;
...
static struct V_130 * F_106 ( int V_131 )
{
int V_132 = F_107 ( V_131 ) ;
switch ( V_132 ) {
case 0 ... 1 :
return & V_133 [ 0 ] ;
#if F_88 ( V_134 )
...
static void F_109 ( struct V_135 * V_135 )
{
struct V_136 * V_137 = F_2 ( V_135 , F_3 ( * V_137 ) , V_135 ) ;
struct V_2 * V_3 = V_137 -> V_3 ;
int V_138 , V_11 ;
V_138 = V_137 -> V_139 ;
for ( V_11 = 0 ; V_11 < V_138 ; V_11 ++ )
F_110 ( V_3 , V_137 -> V_140 [ V_11 ] , V_137 -> V_141 ,
V_142 ) ;
V_138 += V_137 -> V_143 ;
for (; V_11 < V_138 ; V_11 ++ )
F_110 ( V_3 , V_137 -> V_140 [ V_11 ] , V_137 -> V_141 ,
...
V_138 += V_137 -> V_145 ;
for (; V_11 < V_138 ; V_11 ++ ) {
if ( V_137 -> V_140 [ V_11 ] == 0 )
continue;
F_110 ( V_3 , V_137 -> V_140 [ V_11 ] , V_137 -> V_141 ,
V_146 ) ;
}
V_138 = V_137 -> V_147 ;
F_111 ( V_137 , F_106 ( V_138 ) -> V_148 ) ;
}
void F_112 ( struct V_136 * V_137 )
{
if ( V_137 )
F_113 ( & V_137 -> V_135 , F_109 ) ;
}
static void F_114 ( void )
{
int V_11 ;
for ( V_11 = 0 ; V_11 < F_115 ( V_133 ) ; V_11 ++ ) {
struct V_130 * V_149 = & V_133 [ V_11 ] ;
F_116 ( V_149 -> V_148 ) ;
V_149 -> V_148 = NULL ;
F_117 ( V_149 -> V_150 ) ;
V_149 -> V_150 = NULL ;
...
static int T_4 F_118 ( void )
{
int V_11 ;
for ( V_11 = 0 ; V_11 < F_115 ( V_133 ) ; V_11 ++ ) {
struct V_130 * V_149 = & V_133 [ V_11 ] ;
T_7 V_151 ;
V_151 = sizeof( struct V_136 ) +
sizeof( V_152 ) * V_149 -> V_151 ;
V_149 -> V_150 = F_119 ( V_149 -> V_90 , V_151 , 0 ,
V_153 , NULL ) ;
if ( ! V_149 -> V_150 )
break;
V_149 -> V_148 = F_120 ( 1 , V_149 -> V_150 ) ;
if ( ! V_149 -> V_148 )
break;
}
if ( V_11 == F_115 ( V_133 ) )
...
struct V_136 *
F_121 ( struct V_2 * V_3 , int V_131 , T_8 V_154 )
{
struct V_136 * V_137 ;
V_137 = F_122 ( F_106 ( V_131 ) -> V_148 , V_154 ) ;
if ( ! V_137 )
return NULL ;
...
enum V_41
F_127 ( struct V_155 * V_156 )
{
unsigned long V_44 = V_45 + F_28 ( 5000 ) ;
if ( ! V_156 )
return V_158 ;
while ( V_156 -> V_42 == - V_87 ) {
if ( F_31 ( V_45 , V_44 ) ) {
F_32 ( V_156 -> V_6 -> V_2 -> V_3 ,
L_30 ,
V_46 ) ;
return V_47 ;
}
...
return F_27 ( V_156 -> V_6 , V_156 -> V_42 ) ;
}
void F_128 ( struct V_155 * V_156 )
{
struct V_155 * V_159 = F_129 ( V_156 ) ;
struct V_155 * V_160 ;
struct V_1 * V_6 ;
if ( ! V_159 )
return;
F_130 ( V_156 ) ;
V_6 = V_159 -> V_6 ;
for (; V_159 ; V_159 = V_160 ) {
F_131 ( V_159 ) ;
F_132 ( V_159 ) ;
V_160 = F_129 ( V_159 ) ;
if ( V_160 && V_160 -> V_6 == V_6 )
F_130 ( V_159 ) ;
else
V_160 = NULL ;
F_133 ( V_159 ) ;
