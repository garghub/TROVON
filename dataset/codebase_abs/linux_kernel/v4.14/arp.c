...
int V_168 = - V_151 ;
struct V_177 * V_178 = & V_123 ;
if ( V_17 ) {
if ( V_17 -> V_25 & ~ V_26 )
V_168 = F_83 ( V_17 , NULL , V_179 ,
V_136 |
V_173 , 0 ) ;
F_107 ( & V_178 -> V_174 ) ;
F_75 ( V_17 ) ;
...
static int F_110 ( struct V_70 * V_70 , struct V_152 * V_153 ,
struct V_3 * V_4 )
{
T_1 V_154 = ( (struct V_155 * ) & V_153 -> V_156 ) -> V_157 . V_158 ;
T_1 V_159 = ( (struct V_155 * ) & V_153 -> V_160 ) -> V_157 . V_158 ;
if ( V_159 == F_95 ( 0xFFFFFFFF ) )
return F_111 ( & V_123 , V_70 , & V_154 , V_4 ) ;
if ( V_159 )
return - V_13 ;
return F_90 ( V_70 , V_4 , 0 ) ;
}
static int F_112 ( struct V_70 * V_70 , struct V_152 * V_153 ,
struct V_3 * V_4 )
{
T_1 V_154 ;
if ( V_153 -> V_161 & V_169 )
return F_110 ( V_70 , V_153 , V_4 ) ;
V_154 = ( (struct V_155 * ) & V_153 -> V_156 ) -> V_157 . V_158 ;
if ( ! V_4 ) {
struct V_73 * V_74 = F_41 ( V_70 , V_154 , 0 , V_171 , 0 ) ;
if ( F_42 ( V_74 ) )
...
int F_113 ( struct V_70 * V_70 , unsigned int V_180 , void T_7 * V_181 )
{
int V_168 ;
struct V_152 V_153 ;
struct V_3 * V_4 = NULL ;
...
case V_182 :
case V_183 :
if ( ! F_114 ( V_70 -> V_184 , V_185 ) )
return - V_186 ;
case V_187 :
V_168 = F_115 ( & V_153 , V_181 , sizeof( struct V_152 ) ) ;
if ( V_168 )
return - V_188 ;
break;
default:
...
if ( V_153 . V_156 . V_164 != V_189 )
return - V_190 ;
if ( ! ( V_153 . V_161 & V_169 ) &&
( V_153 . V_161 & ( V_191 | V_192 ) ) )
return - V_13 ;
if ( ! ( V_153 . V_161 & V_191 ) )
( (struct V_155 * ) & V_153 . V_160 ) -> V_157 . V_158 =
F_95 ( 0xFFFFFFFFUL ) ;
F_116 () ;
if ( V_153 . V_175 [ 0 ] ) {
V_168 = - V_166 ;
V_4 = F_117 ( V_70 , V_153 . V_175 ) ;
if ( ! V_4 )
goto V_89;
...
V_89:
F_118 () ;
if ( V_180 == V_187 && ! V_168 && F_119 ( V_181 , & V_153 , sizeof( V_153 ) ) )
V_168 = - V_188 ;
return V_168 ;
}
static int F_120 ( struct V_193 * V_194 , unsigned long V_195 ,
void * V_196 )
{
struct V_3 * V_4 = F_121 ( V_196 ) ;
struct V_197 * V_198 ;
switch ( V_195 ) {
case V_199 :
F_122 ( & V_123 , V_4 ) ;
...
F_129 () ;
#ifdef F_130
F_131 ( NULL , & V_123 . V_22 , NULL ) ;
#endif
F_132 ( & V_205 ) ;
}
static void F_133 ( T_9 * V_206 , char * V_207 )
{
char V_208 , * V_209 ;
int V_115 ;
for ( V_115 = 0 , V_209 = V_207 ; V_115 < 6 ; V_115 ++ ) {
V_208 = ( V_206 -> V_210 [ V_115 ] >> 1 ) & 0x7F ;
if ( V_208 != ' ' )
* V_209 ++ = V_208 ;
}
* V_209 ++ = '-' ;
V_115 = ( V_206 -> V_210 [ 6 ] >> 1 ) & 0x0F ;
if ( V_115 > 9 ) {
* V_209 ++ = '1' ;
V_115 -= 10 ;
}
...
static void F_134 ( struct V_211 * V_212 ,
struct V_16 * V_115 )
{
char V_213 [ V_214 ] ;
int V_215 , V_216 ;
...
F_135 ( & V_115 -> V_174 ) ;
#if F_58 ( V_93 )
if ( V_218 == V_94 || V_218 == V_97 )
F_133 ( ( T_9 * ) V_115 -> V_32 , V_213 ) ;
else {
#endif
for ( V_215 = 0 , V_216 = 0 ; V_215 < V_214 - 3 && V_216 < V_4 -> V_12 ; V_216 ++ ) {
V_213 [ V_215 ++ ] = F_136 ( V_115 -> V_32 [ V_216 ] ) ;
V_213 [ V_215 ++ ] = F_137 ( V_115 -> V_32 [ V_216 ] ) ;
V_213 [ V_215 ++ ] = ':' ;
}
if ( V_215 != 0 )
-- V_215 ;
...
#endif
sprintf ( V_217 , L_2 , V_115 -> V_18 ) ;
F_138 ( V_212 , L_3 ,
V_217 , V_218 , F_100 ( V_115 ) , V_213 , V_4 -> V_176 ) ;
F_139 ( & V_115 -> V_174 ) ;
}
static void F_140 ( struct V_211 * V_212 ,
struct V_219 * V_115 )
{
struct V_3 * V_4 = V_115 -> V_4 ;
int V_218 = V_4 ? V_4 -> type : 0 ;
char V_217 [ 16 ] ;
sprintf ( V_217 , L_2 , V_115 -> V_220 ) ;
F_138 ( V_212 , L_4 ,
V_217 , V_218 , V_169 | V_170 , L_5 ,
V_4 ? V_4 -> V_176 : L_6 ) ;
}
static int F_141 ( struct V_211 * V_212 , void * V_221 )
{
if ( V_221 == V_222 ) {
F_142 ( V_212 , L_7
L_8 ) ;
} else {
struct V_223 * V_129 = V_212 -> V_224 ;
if ( V_129 -> V_33 & V_225 )
F_140 ( V_212 , V_221 ) ;
else
F_134 ( V_212 , V_221 ) ;
...
static void * F_143 ( struct V_211 * V_212 , T_10 * V_226 )
{
return F_144 ( V_212 , V_226 , & V_123 , V_227 ) ;
}
static int F_145 ( struct V_228 * V_228 , struct V_229 * V_229 )
{
return F_146 ( V_228 , V_229 , & V_230 ,
sizeof( struct V_223 ) ) ;
}
static int T_11 F_147 ( struct V_70 * V_70 )
{
if ( ! F_148 ( L_9 , V_231 , V_70 -> V_232 , & V_233 ) )
return - V_234 ;
return 0 ;
}
static void T_12 F_149 ( struct V_70 * V_70 )
{
F_150 ( L_9 , V_70 -> V_232 ) ;
}
