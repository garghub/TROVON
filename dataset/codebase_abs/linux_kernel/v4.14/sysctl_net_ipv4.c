...
static int F_47 ( struct V_8 * V_38 ,
int V_10 ,
void T_1 * V_11 , T_2 * V_12 ,
T_3 * V_13 )
{
struct V_8 V_41 = { . V_17 = V_69 , } ;
int V_15 ;
V_41 . V_14 = F_27 ( V_41 . V_17 , V_43 ) ;
if ( ! V_41 . V_14 )
return - V_44 ;
...
static T_7 int F_49 ( struct V_1 * V_1 )
{
struct V_8 * V_9 ;
V_9 = V_70 ;
if ( ! F_50 ( V_1 , & V_64 ) ) {
int V_71 ;
V_9 = F_51 ( V_9 , sizeof( V_70 ) , V_49 ) ;
if ( ! V_9 )
goto V_72;
for ( V_71 = 0 ; V_71 < F_52 ( V_70 ) - 1 ; V_71 ++ )
V_9 [ V_71 ] . V_14 += ( void * ) V_1 - ( void * ) & V_64 ;
}
V_1 -> V_4 . V_73 = F_53 ( V_1 , L_5 , V_9 ) ;
if ( ! V_1 -> V_4 . V_73 )
goto V_74;
V_1 -> V_4 . V_75 = F_54 ( 65536 / 8 , V_49 ) ;
if ( ! V_1 -> V_4 . V_75 )
goto V_76;
return 0 ;
V_76:
...
static T_8 void F_56 ( struct V_1 * V_1 )
{
struct V_8 * V_9 ;
F_29 ( V_1 -> V_4 . V_75 ) ;
V_9 = V_1 -> V_4 . V_73 -> V_77 ;
F_55 ( V_1 -> V_4 . V_73 ) ;
F_29 ( V_9 ) ;
}
static T_9 int F_57 ( void )
{
struct V_78 * V_79 ;
V_79 = F_53 ( & V_64 , L_5 , V_80 ) ;
if ( ! V_79 )
return - V_44 ;
if ( F_58 ( & V_81 ) ) {
F_55 ( V_79 ) ;
