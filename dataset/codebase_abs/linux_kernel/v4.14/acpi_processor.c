...
return 0 ;
F_42 ( V_26 -> V_32 >= V_69 ) ;
if ( F_43 ( V_70 , V_26 -> V_32 ) != NULL &&
F_43 ( V_70 , V_26 -> V_32 ) != V_37 ) {
F_44 ( & V_37 -> V_2 ,
L_21 ,
V_26 -> V_32 ) ;
goto V_71;
...
V_77 [ 0 ] = 0x0000 ;
V_77 [ 1 ] = 0x1000 ;
if ( F_35 ( F_56 ( V_19 , & V_79 ) ) ) {
if ( V_79 . V_29 . V_84 && V_79 . V_29 . V_83 > 1 ) {
T_4 * V_87 = V_79 . V_29 . V_84 ;
if ( V_87 [ 1 ] & 0x1000 ) {
F_57 ( V_19 ,
L_24 ) ;
V_85 = true ;
...
static int F_62 ( struct V_36 * V_2 ,
const struct V_61 * V_32 )
{
return 1 ;
}
static void T_6 F_63 ( int V_52 )
{
int V_93 ;
if ( V_94 == V_95 || V_96 == V_95 )
return;
...
if ( F_15 ( V_28 ) )
goto V_71;
V_100 = V_39 . V_51 . V_52 ;
break;
case V_101 :
V_28 = F_14 ( V_19 , L_25 , NULL , & V_100 ) ;
if ( F_15 ( V_28 ) )
goto V_71;
break;
default:
