...
struct V_39 * V_40 = V_47 -> V_21 . V_52 ;
struct V_41 V_42 ;
struct V_39 * V_53 ;
struct V_6 * V_7 ;
struct V_1 * V_54 ;
...
V_51 = V_44 -> V_51 ;
F_6 ( & V_47 -> V_21 , L_11 , V_44 -> V_57 ) ;
V_54 = F_25 ( sizeof( * V_7 ) ) ;
if ( ! V_54 )
return - V_58 ;
V_7 = V_54 -> V_7 ;
V_54 -> V_59 = L_12 ,
...
V_54 -> V_61 = & F_1 ;
V_54 -> V_62 = & F_7 ;
V_55 = F_18 ( V_40 , 0 , & V_42 ) ;
if ( V_55 < 0 ) {
F_10 ( & V_47 -> V_21 , L_13 ) ;
goto error;
}
snprintf ( V_54 -> V_44 , V_63 , L_14 , V_40 -> V_59 ,
( unsigned long long ) V_42 . V_36 ) ;
V_7 -> V_64 = F_26 ( V_40 , 0 ) ;
if ( ! V_7 -> V_64 ) {
V_55 = - V_58 ;
goto error;
}
if ( V_51 -> V_65 > F_27 ( & V_42 ) ) {
F_10 ( & V_47 -> V_21 , L_15 ) ;
V_55 = - V_66 ;
goto error;
}
V_7 -> V_9 = V_7 -> V_64 + V_51 -> V_65 ;
V_54 -> V_67 = & V_47 -> V_21 ;
F_28 ( V_47 , V_54 ) ;
if ( V_51 -> V_68 ) {
F_29 (np, tbi) {
if ( strcmp ( V_53 -> type , L_16 ) == 0 ) {
F_6 ( & V_47 -> V_21 , L_17 ,
V_53 ) ;
break;
}
...
if ( V_53 ) {
const T_5 * V_69 = F_20 ( V_53 , L_18 , NULL ) ;
T_3 T_2 * V_30 ;
if ( ! V_69 ) {
F_10 ( & V_47 -> V_21 ,
L_19 ,
...
V_30 = V_51 -> V_68 ( V_7 -> V_64 ) ;
if ( ( void * ) V_30 > V_7 -> V_64 + F_27 ( & V_42 ) - 4 )
F_10 ( & V_47 -> V_21 , L_20 ,
( ( void * ) V_30 - V_7 -> V_64 ) + 4 ) ;
F_2 ( F_21 ( V_69 ) , V_30 ) ;
}
}
if ( V_51 -> F_16 )
V_51 -> F_16 ( V_42 . V_36 , V_42 . V_37 ) ;
V_55 = F_30 ( V_54 , V_40 ) ;
if ( V_55 ) {
F_10 ( & V_47 -> V_21 , L_21 ,
V_54 -> V_59 ) ;
...
{
struct V_70 * V_70 = & V_47 -> V_21 ;
struct V_1 * V_2 = F_34 ( V_70 ) ;
struct V_6 * V_7 = V_2 -> V_7 ;
F_35 ( V_2 ) ;
F_31 ( V_7 -> V_64 ) ;
F_36 ( V_2 ) ;
