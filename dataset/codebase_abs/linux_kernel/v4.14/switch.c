...
if ( ! V_2 -> V_16 -> V_28 )
return - V_29 ;
return V_2 -> V_16 -> V_28 ( V_2 , V_10 -> V_22 , V_10 -> V_30 ,
V_10 -> V_31 ) ;
}
...
if ( ! V_2 -> V_16 -> V_32 )
return - V_29 ;
return V_2 -> V_16 -> V_32 ( V_2 , V_10 -> V_22 , V_10 -> V_30 ,
V_10 -> V_31 ) ;
}
static int F_8 ( struct V_1 * V_2 ,
struct V_33 * V_10 )
{
const struct V_34 * V_35 = V_10 -> V_35 ;
struct V_11 * V_12 = V_10 -> V_12 ;
F_9 ( V_36 , V_2 -> V_5 ) ;
int V_22 , V_37 ;
F_10 ( V_36 , V_2 -> V_5 ) ;
...
F_11 ( V_22 , V_36 ) ;
if ( F_3 ( V_12 ) ) {
if ( ! V_2 -> V_16 -> V_38 || ! V_2 -> V_16 -> V_39 )
return - V_29 ;
F_14 (port, group, ds->num_ports) {
V_37 = V_2 -> V_16 -> V_38 ( V_2 , V_22 , V_35 , V_12 ) ;
if ( V_37 )
return V_37 ;
}
return 0 ;
...
F_14 (port, group, ds->num_ports)
V_2 -> V_16 -> V_39 ( V_2 , V_22 , V_35 , V_12 ) ;
return 0 ;
}
...
return - V_29 ;
if ( V_2 -> V_19 == V_10 -> V_20 )
return V_2 -> V_16 -> V_40 ( V_2 , V_10 -> V_22 , V_35 ) ;
return 0 ;
}
static int F_16 ( struct V_1 * V_2 ,
struct V_41 * V_10 )
{
const struct V_42 * V_43 = V_10 -> V_43 ;
struct V_11 * V_12 = V_10 -> V_12 ;
F_9 ( V_44 , V_2 -> V_5 ) ;
int V_22 , V_37 ;
F_10 ( V_44 , V_2 -> V_5 ) ;
...
F_11 ( V_22 , V_44 ) ;
if ( F_3 ( V_12 ) ) {
if ( ! V_2 -> V_16 -> V_45 || ! V_2 -> V_16 -> V_46 )
return - V_29 ;
F_14 (port, members, ds->num_ports) {
V_37 = V_2 -> V_16 -> V_45 ( V_2 , V_22 , V_43 , V_12 ) ;
if ( V_37 )
return V_37 ;
}
return 0 ;
...
F_14 (port, members, ds->num_ports)
V_2 -> V_16 -> V_46 ( V_2 , V_22 , V_43 , V_12 ) ;
return 0 ;
}
...
return - V_29 ;
if ( V_2 -> V_19 == V_10 -> V_20 )
return V_2 -> V_16 -> V_47 ( V_2 , V_10 -> V_22 , V_43 ) ;
return 0 ;
}
static int F_18 ( struct V_48 * V_49 ,
unsigned long V_50 , void * V_10 )
{
struct V_1 * V_2 = F_19 ( V_49 , struct V_1 , V_49 ) ;
int V_37 ;
switch ( V_50 ) {
case V_51 :
V_37 = F_2 ( V_2 , V_10 ) ;
...
{
V_2 -> V_49 . V_61 = F_18 ;
return F_23 ( & V_2 -> V_62 -> V_63 , & V_2 -> V_49 ) ;
}
void F_24 ( struct V_1 * V_2 )
{
int V_37 ;
V_37 = F_25 ( & V_2 -> V_62 -> V_63 , & V_2 -> V_49 ) ;
if ( V_37 )
F_26 ( V_2 -> V_60 , L_2 , V_37 ) ;
}
