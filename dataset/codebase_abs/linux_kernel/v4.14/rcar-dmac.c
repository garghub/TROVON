...
F_40 ( & V_71 -> V_23 ) ;
F_74 ( ( unsigned long ) V_71 ) ;
}
if ( V_138 -> V_143 . V_103 ) {
F_75 ( V_8 -> V_24 -> V_25 , V_138 -> V_144 ,
V_138 -> V_143 . V_103 , V_138 -> V_122 , 0 ) ;
V_138 -> V_143 . V_103 = 0 ;
}
F_76 ( V_8 -> V_24 -> V_25 ) ;
}
static struct V_63 *
F_77 ( struct V_134 * V_8 , T_6 V_145 ,
T_6 V_146 , T_5 V_133 , unsigned long V_65 )
{
struct V_7 * V_135 = F_21 ( V_8 ) ;
struct V_117 V_118 ;
if ( ! V_133 )
return NULL ;
F_78 ( & V_118 , 1 ) ;
F_79 ( & V_118 , F_80 ( F_81 ( V_146 ) ) , V_133 ,
F_82 ( V_146 ) ) ;
F_62 ( & V_118 ) = V_146 ;
F_63 ( & V_118 ) = V_133 ;
return F_60 ( V_135 , & V_118 , 1 , V_145 ,
V_114 , V_65 , false ) ;
}
static int F_83 ( struct V_134 * V_8 ,
enum V_121 V_122 )
{
struct V_7 * V_135 = F_21 ( V_8 ) ;
struct V_137 * V_138 = & V_135 -> V_138 ;
...
enum V_148 V_149 ;
if ( V_122 == V_105 ) {
V_120 = V_135 -> V_109 . V_150 ;
V_147 = V_135 -> V_109 . V_103 ;
V_149 = V_151 ;
} else {
V_120 = V_135 -> V_113 . V_150 ;
V_147 = V_135 -> V_113 . V_103 ;
V_149 = V_152 ;
}
if ( V_120 == V_138 -> V_143 . V_150 &&
V_147 == V_138 -> V_143 . V_103 &&
V_149 == V_138 -> V_122 )
return 0 ;
if ( V_138 -> V_143 . V_103 )
F_75 ( V_8 -> V_24 -> V_25 , V_138 -> V_144 ,
V_138 -> V_143 . V_103 , V_138 -> V_122 , 0 ) ;
V_138 -> V_143 . V_103 = 0 ;
V_138 -> V_144 = F_84 ( V_8 -> V_24 -> V_25 , V_120 , V_147 ,
V_149 , 0 ) ;
if ( F_85 ( V_8 -> V_24 -> V_25 , V_138 -> V_144 ) ) {
F_86 ( V_8 -> V_24 -> V_25 ,
L_6 , V_135 -> V_26 ,
V_147 , & V_120 ) ;
return - V_62 ;
...
V_135 -> V_26 , V_147 , & V_120 , & V_138 -> V_144 ,
V_149 == V_151 ? L_8 : L_9 ) ;
V_138 -> V_143 . V_150 = V_120 ;
V_138 -> V_143 . V_103 = V_147 ;
V_138 -> V_122 = V_149 ;
return 0 ;
}
static struct V_63 *
F_87 ( struct V_134 * V_8 , struct V_117 * V_118 ,
unsigned int V_119 , enum V_121 V_122 ,
unsigned long V_65 , void * V_153 )
{
struct V_7 * V_135 = F_21 ( V_8 ) ;
if ( V_135 -> V_17 < 0 || ! V_119 ) {
F_19 ( V_8 -> V_24 -> V_25 ,
L_10 ,
V_154 , V_119 , V_135 -> V_17 ) ;
return NULL ;
}
if ( F_83 ( V_8 , V_122 ) )
return NULL ;
return F_60 ( V_135 , V_118 , V_119 , V_135 -> V_138 . V_144 ,
V_122 , V_65 , false ) ;
}
static struct V_63 *
F_88 ( struct V_134 * V_8 , T_6 V_155 ,
T_5 V_156 , T_5 V_157 ,
...
unsigned int V_119 ;
unsigned int V_73 ;
if ( V_135 -> V_17 < 0 || V_156 < V_157 ) {
F_19 ( V_8 -> V_24 -> V_25 ,
L_11 ,
V_154 , V_156 , V_157 , V_135 -> V_17 ) ;
return NULL ;
}
if ( F_83 ( V_8 , V_122 ) )
return NULL ;
...
F_86 ( V_8 -> V_24 -> V_25 ,
L_12 ,
V_135 -> V_26 , V_119 , V_158 ) ;
return NULL ;
}
V_118 = F_89 ( V_119 , sizeof( * V_118 ) , V_83 ) ;
if ( ! V_118 )
return NULL ;
F_78 ( V_118 , V_119 ) ;
for ( V_73 = 0 ; V_73 < V_119 ; ++ V_73 ) {
T_6 V_109 = V_155 + ( V_157 * V_73 ) ;
F_79 ( & V_118 [ V_73 ] , F_80 ( F_81 ( V_109 ) ) , V_157 ,
F_82 ( V_109 ) ) ;
F_62 ( & V_118 [ V_73 ] ) = V_109 ;
F_63 ( & V_118 [ V_73 ] ) = V_157 ;
}
V_15 = F_60 ( V_135 , V_118 , V_119 , V_135 -> V_138 . V_144 ,
V_122 , V_65 , true ) ;
F_90 ( V_118 ) ;
return V_15 ;
}
...
{
struct V_7 * V_135 = F_21 ( V_8 ) ;
V_135 -> V_109 . V_150 = V_160 -> V_30 ;
V_135 -> V_113 . V_150 = V_160 -> V_32 ;
V_135 -> V_109 . V_103 = V_160 -> V_161 ;
V_135 -> V_113 . V_103 = V_160 -> V_162 ;
return 0 ;
}
static int F_92 ( struct V_134 * V_8 )
{
struct V_7 * V_135 = F_21 ( V_8 ) ;
unsigned long V_65 ;
...
static unsigned int F_93 ( struct V_7 * V_8 ,
T_3 V_66 )
{
struct V_14 * V_15 = V_8 -> V_15 . V_16 ;
...
V_166 = V_15 -> V_27 ;
V_166 -- ;
F_96 ( V_166 >= V_15 -> V_27 ) ;
} else {
V_16 = V_15 -> V_16 ;
}
F_97 (chunk, &desc->chunks, node) {
if ( V_21 == V_16 || ++ V_166 == V_15 -> V_27 )
break;
V_165 += V_21 -> V_51 ;
}
V_165 += F_7 ( V_8 , V_53 ) << V_15 -> V_54 ;
return V_165 ;
}
static enum V_163 F_98 ( struct V_134 * V_8 ,
T_3 V_66 ,
struct V_170 * V_171 )
{
struct V_7 * V_135 = F_21 ( V_8 ) ;
...
unsigned long V_65 ;
unsigned int V_165 ;
V_164 = F_94 ( V_8 , V_66 , V_171 ) ;
if ( V_164 == V_167 || ! V_171 )
return V_164 ;
F_23 ( & V_135 -> V_67 , V_65 ) ;
V_165 = F_93 ( V_135 , V_66 ) ;
F_26 ( & V_135 -> V_67 , V_65 ) ;
if ( ! V_165 )
return V_167 ;
F_99 ( V_171 , V_165 ) ;
...
static void F_100 ( struct V_134 * V_8 )
{
struct V_7 * V_135 = F_21 ( V_8 ) ;
unsigned long V_65 ;
F_23 ( & V_135 -> V_67 , V_65 ) ;
...
static void F_101 ( struct V_134 * V_8 )
{
struct V_7 * V_135 = F_21 ( V_8 ) ;
F_72 ( V_135 -> V_140 ) ;
}
static T_8 F_102 ( struct V_7 * V_8 )
{
struct V_14 * V_15 = V_8 -> V_15 . V_16 ;
unsigned int V_172 ;
if ( F_96 ( ! V_15 || ! V_15 -> V_44 ) ) {
return V_173 ;
}
V_172 = ( F_7 ( V_8 , V_36 ) &
V_168 ) >> V_169 ;
F_8 ( V_8 , V_39 , F_16 ( V_172 ) ) ;
return V_174 ;
}
static T_8 F_103 ( struct V_7 * V_8 )
{
struct V_14 * V_15 = V_8 -> V_15 . V_16 ;
T_8 V_82 = V_174 ;
if ( F_11 ( ! V_15 ) ) {
...
if ( ! V_15 -> V_18 . V_19 ) {
if ( ! F_104 ( & V_15 -> V_16 -> V_23 , & V_15 -> V_22 ) ) {
V_15 -> V_16 = F_105 ( V_15 -> V_16 , V_23 ) ;
if ( ! V_15 -> V_44 )
V_82 = V_175 ;
goto V_93;
}
...
static T_8 F_107 ( int V_140 , void * V_25 )
{
T_1 V_176 = V_91 | V_13 ;
struct V_7 * V_8 = V_25 ;
T_8 V_82 = V_173 ;
...
static T_8 F_108 ( int V_140 , void * V_25 )
{
struct V_7 * V_8 = V_25 ;
struct V_14 * V_15 ;
struct V_177 V_178 ;
...
static T_8 F_113 ( int V_140 , void * V_4 )
{
struct V_1 * V_2 = V_4 ;
if ( ! ( F_4 ( V_2 , V_5 ) & V_61 ) )
return V_173 ;
...
static bool F_114 ( struct V_134 * V_8 , void * V_179 )
{
struct V_1 * V_2 = F_69 ( V_8 -> V_24 ) ;
struct V_180 * V_181 = V_179 ;
if ( V_8 -> V_24 -> V_182 != F_91 ||
V_181 -> V_183 != V_8 -> V_24 -> V_25 -> V_184 )
return false ;
return ! F_115 ( V_181 -> args [ 0 ] , V_2 -> V_141 ) ;
}
static struct V_134 * F_116 ( struct V_180 * V_181 ,
struct V_185 * V_186 )
{
struct V_7 * V_135 ;
struct V_134 * V_8 ;
...
unsigned int V_26 )
{
struct V_189 * V_190 = F_126 ( V_2 -> V_25 ) ;
struct V_134 * V_8 = & V_135 -> V_8 ;
char V_191 [ 5 ] ;
char * V_192 ;
int V_82 ;
V_135 -> V_26 = V_26 ;
V_135 -> V_6 = V_2 -> V_6 + F_127 ( V_26 ) ;
V_135 -> V_17 = - V_142 ;
F_128 ( & V_135 -> V_67 ) ;
...
V_135 -> V_140 = F_129 ( V_190 , V_191 ) ;
if ( V_135 -> V_140 < 0 ) {
F_86 ( V_2 -> V_25 , L_15 , V_26 ) ;
return - V_193 ;
}
V_192 = F_130 ( V_2 -> V_25 , V_136 , L_16 ,
F_131 ( V_2 -> V_25 ) , V_26 ) ;
if ( ! V_192 )
return - V_74 ;
V_8 -> V_24 = & V_2 -> V_194 ;
...
V_82 = F_133 ( V_2 -> V_25 , V_135 -> V_140 ,
F_107 ,
F_108 , 0 ,
V_192 , V_135 ) ;
if ( V_82 ) {
...
static int F_134 ( struct V_24 * V_25 , struct V_1 * V_2 )
{
struct V_195 * V_183 = V_25 -> V_184 ;
int V_82 ;
V_82 = F_135 ( V_183 , L_18 , & V_2 -> V_58 ) ;
if ( V_82 < 0 ) {
F_86 ( V_25 , L_19 ) ;
return V_82 ;
}
...
static int F_136 ( struct V_189 * V_190 )
{
...
int V_140 ;
int V_82 ;
V_2 = F_137 ( & V_190 -> V_25 , sizeof( * V_2 ) , V_136 ) ;
if ( ! V_2 )
return - V_74 ;
V_2 -> V_25 = & V_190 -> V_25 ;
F_138 ( V_190 , V_2 ) ;
F_139 ( V_2 -> V_25 , F_140 ( 40 ) ) ;
V_82 = F_134 ( & V_190 -> V_25 , V_2 ) ;
if ( V_82 < 0 )
return V_82 ;
if ( V_190 -> V_25 . V_208 ) {
V_2 -> V_58 -- ;
...
V_2 -> V_94 = F_141 ( & V_190 -> V_25 , V_2 -> V_58 ,
sizeof( * V_2 -> V_94 ) , V_136 ) ;
if ( ! V_2 -> V_94 )
return - V_74 ;
V_85 = F_142 ( V_190 , V_209 , 0 ) ;
V_2 -> V_6 = F_143 ( & V_190 -> V_25 , V_85 ) ;
if ( F_144 ( V_2 -> V_6 ) )
return F_145 ( V_2 -> V_6 ) ;
V_140 = F_129 ( V_190 , L_21 ) ;
if ( V_140 < 0 ) {
F_86 ( & V_190 -> V_25 , L_22 ) ;
return - V_193 ;
}
V_192 = F_130 ( V_2 -> V_25 , V_136 , L_23 ,
F_131 ( V_2 -> V_25 ) ) ;
if ( ! V_192 )
return - V_74 ;
F_146 ( & V_190 -> V_25 ) ;
...
if ( V_82 < 0 ) {
F_86 ( & V_190 -> V_25 , L_24 , V_82 ) ;
return V_82 ;
}
V_82 = F_17 ( V_2 ) ;
F_76 ( & V_190 -> V_25 ) ;
if ( V_82 ) {
F_86 ( & V_190 -> V_25 , L_25 ) ;
goto error;
}
V_194 = & V_2 -> V_194 ;
F_118 ( V_210 , V_194 -> V_211 ) ;
F_118 ( V_188 , V_194 -> V_211 ) ;
...
F_31 ( & V_194 -> V_94 ) ;
for ( V_73 = 0 ; V_73 < V_2 -> V_58 ; ++ V_73 ) {
V_82 = F_125 ( V_2 , & V_2 -> V_94 [ V_73 ] ,
V_73 + V_205 ) ;
if ( V_82 < 0 )
goto error;
}
V_82 = F_148 ( & V_190 -> V_25 , V_140 , F_113 , 0 ,
V_192 , V_2 ) ;
if ( V_82 ) {
F_86 ( & V_190 -> V_25 , L_17 ,
V_140 , V_82 ) ;
return V_82 ;
}
V_82 = F_149 ( V_190 -> V_25 . V_184 , F_116 ,
NULL ) ;
if ( V_82 < 0 )
goto error;
V_82 = F_150 ( V_194 ) ;
...
return 0 ;
error:
F_151 ( V_190 -> V_25 . V_184 ) ;
F_152 ( & V_190 -> V_25 ) ;
return V_82 ;
}
static int F_153 ( struct V_189 * V_190 )
{
...
static void F_156 ( struct V_189 * V_190 )
{
struct V_1 * V_2 = F_154 ( V_190 ) ;
F_54 ( V_2 ) ;
}
