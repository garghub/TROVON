...
return F_16 ( - V_28 ) ;
memcpy ( V_114 -> V_13 , V_118 . V_13 , sizeof( V_114 -> V_13 ) - 1 ) ;
...
void F_70 ( struct V_123 * V_114 )
{
int V_127 ;
if ( V_114 -> V_128 != NULL ) {
F_71 (cpu)
F_72 ( V_114 -> V_128 [ V_127 ] ) ;
F_72 ( V_114 -> V_128 ) ;
}
F_72 ( V_114 ) ;
}
struct V_129 * F_73 ( struct V_130 * V_130 , T_1 V_3 ,
const char * V_13 )
{
struct V_129 * V_22 , * V_131 = NULL ;
F_2 ( & V_5 [ V_3 ] . V_6 ) ;
...
static int F_77 ( struct V_123 * V_9 )
{
unsigned int V_24 ;
int V_127 ;
V_24 = sizeof( void * * ) * V_136 ;
if ( V_24 > V_137 )
V_9 -> V_128 = F_78 ( V_24 , V_105 ) ;
else
V_9 -> V_128 = F_79 ( V_24 , V_105 ) ;
if ( V_9 -> V_128 == NULL )
return - V_75 ;
if ( V_9 -> V_138 == 0 )
return 0 ;
V_24 = sizeof( void * ) * V_9 -> V_138 * 2u ;
F_71 (cpu) {
V_9 -> V_128 [ V_127 ] = F_80 ( V_24 , V_105 ,
F_81 ( V_127 ) ) ;
if ( V_9 -> V_128 [ V_127 ] == NULL )
return - V_75 ;
}
return 0 ;
}
struct V_123 *
F_82 ( struct V_129 * V_57 ,
unsigned int V_119 ,
struct V_123 * V_139 ,
int * error )
{
...
V_139 -> V_142 = V_140 -> V_142 ;
F_86 () ;
V_57 -> V_140 = V_139 ;
F_85 () ;
#ifdef F_87
if ( V_143 ) {
F_88 ( V_144 -> V_145 , V_105 ,
V_146 ,
L_23 ,
V_57 -> V_13 , V_57 -> V_3 , V_140 -> V_73 ) ;
}
#endif
return V_140 ;
}
struct V_129 * F_89 ( struct V_130 * V_130 ,
const struct V_129 * V_147 ,
struct V_123 * V_148 ,
struct V_123 * V_139 )
{
int V_54 ;
struct V_123 * V_140 ;
struct V_129 * V_22 , * V_57 ;
V_57 = F_90 ( V_147 , sizeof( struct V_129 ) , V_105 ) ;
if ( ! V_57 ) {
V_54 = - V_75 ;
goto V_133;
}
...
V_57 -> V_140 = V_148 ;
if ( ! F_82 ( V_57 , 0 , V_139 , & V_54 ) )
goto V_150;
V_140 = V_57 -> V_140 ;
F_84 ( L_24 , V_140 -> V_73 ) ;
V_140 -> V_142 = V_140 -> V_73 ;
F_3 ( & V_57 -> V_7 , & V_130 -> V_5 . V_151 [ V_57 -> V_3 ] ) ;
F_4 ( & V_5 [ V_57 -> V_3 ] . V_6 ) ;
return V_57 ;
V_150:
F_4 ( & V_5 [ V_57 -> V_3 ] . V_6 ) ;
...
static void * F_93 ( struct V_152 * V_153 , T_9 * V_65 )
{
struct V_154 * V_155 = V_153 -> V_140 ;
struct V_130 * V_130 = F_94 ( V_153 ) ;
T_1 V_3 = V_155 -> V_3 ;
F_2 ( & V_5 [ V_3 ] . V_6 ) ;
return F_95 ( & V_130 -> V_5 . V_151 [ V_3 ] , * V_65 ) ;
}
static void * F_96 ( struct V_152 * V_153 , void * V_156 , T_9 * V_65 )
{
struct V_154 * V_155 = V_153 -> V_140 ;
struct V_130 * V_130 = F_94 ( V_153 ) ;
T_1 V_3 = V_155 -> V_3 ;
return F_97 ( V_156 , & V_130 -> V_5 . V_151 [ V_3 ] , V_65 ) ;
}
static void F_98 ( struct V_152 * V_153 , void * V_156 )
{
struct V_154 * V_155 = V_153 -> V_140 ;
T_1 V_3 = V_155 -> V_3 ;
F_4 ( & V_5 [ V_3 ] . V_6 ) ;
}
static int F_99 ( struct V_152 * V_153 , void * V_156 )
{
struct V_129 * V_57 = F_100 ( V_156 , struct V_129 , V_7 ) ;
if ( * V_57 -> V_13 )
F_101 ( V_153 , L_25 , V_57 -> V_13 ) ;
return 0 ;
}
static int F_102 ( struct V_157 * V_157 , struct V_158 * V_158 )
{
int V_54 ;
struct V_154 * V_155 ;
V_54 = F_103 ( V_157 , V_158 , & V_159 ,
sizeof( struct V_154 ) ) ;
if ( ! V_54 ) {
V_155 = ( (struct V_152 * ) V_158 -> V_160 ) -> V_140 ;
V_155 -> V_3 = ( unsigned long ) F_104 ( V_157 ) ;
}
return V_54 ;
}
static void * F_105 ( struct V_152 * V_153 , void * V_156 , T_9 * V_161 ,
bool V_162 )
{
static const T_3 V_163 [] = {
[ V_164 ] = V_165 ,
[ V_165 ] = V_166 ,
} ;
struct V_167 * V_168 = V_153 -> V_140 ;
switch ( V_168 -> V_169 ) {
case V_170 :
V_168 -> V_169 = V_164 ;
F_2 ( & V_5 [ V_19 ] . V_6 ) ;
V_168 -> V_171 = V_168 -> V_172 = V_162 ?
& V_5 [ V_19 ] . V_2 : & V_5 [ V_19 ] . V_12 ;
break;
case V_164 :
V_168 -> V_172 = V_168 -> V_172 -> V_173 ;
if ( V_168 -> V_172 != V_168 -> V_171 )
break;
F_4 ( & V_5 [ V_19 ] . V_6 ) ;
F_2 ( & V_5 [ V_168 -> V_20 ] . V_6 ) ;
V_168 -> V_171 = V_168 -> V_172 = V_162 ?
& V_5 [ V_168 -> V_20 ] . V_2 : & V_5 [ V_168 -> V_20 ] . V_12 ;
V_168 -> V_169 = V_163 [ V_168 -> V_169 ] ;
break;
case V_165 :
V_168 -> V_172 = V_168 -> V_172 -> V_173 ;
if ( V_168 -> V_172 != V_168 -> V_171 )
...
static void * F_106 ( struct V_152 * V_153 , T_9 * V_65 ,
bool V_162 )
{
struct V_167 * V_168 = V_153 -> V_140 ;
unsigned int V_174 ;
V_168 -> V_169 = V_170 ;
for ( V_174 = 0 ; V_174 < * V_65 ; ++ V_174 )
if ( F_105 ( V_153 , NULL , NULL , V_162 ) == NULL )
return NULL ;
return V_168 ;
}
static void F_107 ( struct V_152 * V_153 , void * V_156 )
{
struct V_167 * V_168 = V_153 -> V_140 ;
switch ( V_168 -> V_169 ) {
case V_164 :
...
break;
case V_165 :
F_4 ( & V_5 [ V_168 -> V_20 ] . V_6 ) ;
break;
}
}
static void * F_108 ( struct V_152 * V_153 , T_9 * V_65 )
{
return F_106 ( V_153 , V_65 , false ) ;
}
static void * F_109 ( struct V_152 * V_153 , void * V_156 , T_9 * V_161 )
{
return F_105 ( V_153 , V_156 , V_161 , false ) ;
}
static int F_110 ( struct V_152 * V_153 , void * V_156 )
{
const struct V_167 * V_168 = V_153 -> V_140 ;
...
if ( V_168 -> V_172 == V_168 -> V_171 )
return 0 ;
V_12 = F_100 ( V_168 -> V_172 , struct V_11 , V_7 ) ;
if ( * V_12 -> V_13 )
F_101 ( V_153 , L_25 , V_12 -> V_13 ) ;
}
return 0 ;
}
static int F_111 ( struct V_157 * V_157 , struct V_158 * V_158 )
{
struct V_167 * V_168 ;
V_168 = F_112 ( V_158 , & V_175 , sizeof( * V_168 ) ) ;
if ( ! V_168 )
return - V_75 ;
V_168 -> V_20 = ( unsigned long ) F_104 ( V_157 ) ;
return 0 ;
}
static void * F_113 ( struct V_152 * V_153 , T_9 * V_65 )
{
return F_106 ( V_153 , V_65 , true ) ;
}
static void * F_114 ( struct V_152 * V_153 , void * V_156 , T_9 * V_161 )
{
return F_105 ( V_153 , V_156 , V_161 , true ) ;
}
static int F_115 ( struct V_152 * V_153 , void * V_156 )
{
const struct V_167 * V_168 = V_153 -> V_140 ;
...
if ( V_168 -> V_172 == V_168 -> V_171 )
return 0 ;
V_2 = F_100 ( V_168 -> V_172 , struct V_1 , V_7 ) ;
if ( * V_2 -> V_13 )
F_101 ( V_153 , L_25 , V_2 -> V_13 ) ;
}
return 0 ;
}
static int F_116 ( struct V_157 * V_157 , struct V_158 * V_158 )
{
struct V_167 * V_168 ;
V_168 = F_112 ( V_158 , & V_176 , sizeof( * V_168 ) ) ;
if ( ! V_168 )
return - V_75 ;
V_168 -> V_20 = ( unsigned long ) F_104 ( V_157 ) ;
return 0 ;
...
struct V_177 *
F_117 ( const struct V_129 * V_57 , T_10 * V_178 )
{
unsigned int V_59 = V_57 -> V_179 ;
T_3 V_9 , V_180 = F_118 ( V_59 ) ;
T_3 V_181 ;
struct V_177 * V_182 ;
if ( ! V_180 )
return F_16 ( - V_56 ) ;
V_182 = F_119 ( V_180 , sizeof( * V_182 ) , V_105 ) ;
if ( V_182 == NULL )
return F_16 ( - V_75 ) ;
for ( V_9 = 0 , V_181 = 0 ; V_9 < V_180 && V_59 != 0 ;
V_59 >>= 1 , ++ V_181 ) {
if ( ! ( V_59 & 1 ) )
continue;
V_182 [ V_9 ] . V_183 = V_178 ;
V_182 [ V_9 ] . V_184 = V_57 -> V_3 ;
V_182 [ V_9 ] . V_181 = V_181 ;
V_182 [ V_9 ] . V_185 = V_57 -> V_185 ;
++ V_9 ;
}
return V_182 ;
}
int F_120 ( struct V_130 * V_130 , T_1 V_3 )
{
#ifdef F_121
char V_40 [ V_186 ] ;
struct V_187 * V_188 ;
...
return - V_56 ;
#ifdef F_121
V_189 = F_122 ( V_130 -> V_191 , 0 ) ;
V_190 = F_123 ( V_130 -> V_191 , 0 ) ;
F_49 ( V_40 , V_21 [ V_3 ] , sizeof( V_40 ) ) ;
F_124 ( V_40 , V_192 , sizeof( V_40 ) ) ;
V_188 = F_125 ( V_40 , 0440 , V_130 -> V_193 , & V_194 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_188 )
goto V_133;
if ( F_126 ( V_189 ) && F_127 ( V_190 ) )
F_128 ( V_188 , V_189 , V_190 ) ;
F_49 ( V_40 , V_21 [ V_3 ] , sizeof( V_40 ) ) ;
F_124 ( V_40 , V_195 , sizeof( V_40 ) ) ;
V_188 = F_125 ( V_40 , 0440 , V_130 -> V_193 , & V_196 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_188 )
goto V_197;
if ( F_126 ( V_189 ) && F_127 ( V_190 ) )
F_128 ( V_188 , V_189 , V_190 ) ;
F_49 ( V_40 , V_21 [ V_3 ] , sizeof( V_40 ) ) ;
F_124 ( V_40 , V_198 , sizeof( V_40 ) ) ;
V_188 = F_125 ( V_40 , 0440 , V_130 -> V_193 , & V_199 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_188 )
goto V_200;
if ( F_126 ( V_189 ) && F_127 ( V_190 ) )
...
void F_130 ( struct V_130 * V_130 , T_1 V_3 )
{
#ifdef F_121
char V_40 [ V_186 ] ;
F_49 ( V_40 , V_21 [ V_3 ] , sizeof( V_40 ) ) ;
...
bool F_131 ( struct V_201 * V_202 ,
struct V_120 * V_203 )
{
F_54 ( V_204 < ( sizeof( * V_203 ) * 2 ) ) ;
if ( V_136 <= 1 )
return true ;
if ( ! V_202 -> V_116 ) {
V_202 -> V_116 = F_132 ( V_204 ,
V_204 ) ;
if ( ! V_202 -> V_116 )
return false ;
}
V_203 -> V_205 = ( V_206 unsigned long ) ( V_202 -> V_116 + V_202 -> V_88 ) ;
V_202 -> V_88 += sizeof( * V_203 ) ;
if ( V_202 -> V_88 > ( V_204 - sizeof( * V_203 ) ) ) {
V_202 -> V_116 = NULL ;
V_202 -> V_88 = 0 ;
}
return true ;
}
void F_133 ( struct V_120 * V_207 )
{
unsigned long V_205 = V_207 -> V_205 ;
if ( V_136 > 1 && ( V_205 & ( V_204 - 1 ) ) == 0 )
F_134 ( ( void V_208 * ) V_205 ) ;
}
static int T_13 F_135 ( struct V_130 * V_130 )
{
int V_9 ;
for ( V_9 = 0 ; V_9 < V_209 ; V_9 ++ )
F_136 ( & V_130 -> V_5 . V_151 [ V_9 ] ) ;
return 0 ;
}
static int T_14 F_137 ( void )
{
unsigned int V_9 ;
int V_210 ;
F_71 (i) {
F_138 ( & F_139 ( V_211 , V_9 ) ) ;
}
V_5 = F_140 ( sizeof( struct V_70 ) * V_209 , V_105 ) ;
if ( ! V_5 )
return - V_75 ;
for ( V_9 = 0 ; V_9 < V_209 ; V_9 ++ ) {
F_141 ( & V_5 [ V_9 ] . V_6 ) ;
