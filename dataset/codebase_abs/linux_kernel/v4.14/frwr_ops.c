...
F_41 ( & V_32 -> V_23 [ V_91 ] , V_80 -> V_99 ,
V_80 -> V_98 ) ;
++ V_80 ;
++ V_91 ;
if ( V_84 )
continue;
if ( ( V_91 < V_81 && F_40 ( V_80 -> V_99 ) ) ||
F_40 ( ( V_80 - 1 ) -> V_99 + ( V_80 - 1 ) -> V_98 ) )
break;
}
V_32 -> V_41 = F_42 ( V_82 ) ;
V_32 -> V_40 = F_43 ( V_2 -> V_5 , V_32 -> V_23 , V_91 , V_32 -> V_41 ) ;
if ( ! V_32 -> V_40 )
goto V_100;
V_92 = F_44 ( V_86 , V_32 -> V_23 , V_32 -> V_40 , NULL , V_101 ) ;
if ( F_45 ( V_92 != V_32 -> V_40 ) )
goto V_102;
F_10 ( L_13 ,
...
V_112 | V_113 :
V_114 ;
F_47 ( & V_36 -> V_115 , & V_88 -> V_67 ) ;
V_18 = F_48 ( V_2 -> V_116 -> V_117 , & V_88 -> V_67 , & V_90 ) ;
if ( V_18 )
goto V_118;
...
static void
F_49 ( struct V_35 * V_36 , struct V_125 * V_126 )
{
...
F_51 ( & V_16 -> V_26 ) ;
F_52 ( & V_36 -> V_115 , V_130 ) ;
V_36 -> V_43 . V_139 ++ ;
V_90 = NULL ;
V_18 = F_48 ( V_2 -> V_116 -> V_117 , V_127 , & V_90 ) ;
if ( V_90 != V_127 )
F_53 ( & V_16 -> V_26 ) ;
if ( V_18 )
goto V_140;
...
static void
F_55 ( struct V_35 * V_36 , struct V_141 * V_142 ,
bool V_143 )
{
struct V_11 * V_32 ;
while ( ! F_13 ( & V_142 -> V_144 ) ) {
V_32 = F_54 ( & V_142 -> V_144 ) ;
if ( V_143 )
F_19 ( V_32 ) ;
else
F_36 ( V_32 ) ;
