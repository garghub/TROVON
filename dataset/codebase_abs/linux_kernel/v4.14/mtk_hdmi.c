...
struct V_289 * V_337 , * V_338 , * V_339 ;
struct V_334 * V_340 ;
struct V_341 * V_341 ;
struct V_342 * V_343 ;
int V_247 ;
...
V_8 -> V_296 = & V_340 -> V_57 ;
V_341 = F_127 ( V_290 , L_31 ) ;
...
V_8 -> V_25 = V_341 ;
V_343 = F_129 ( V_335 , V_346 , 0 ) ;
V_8 -> V_10 = F_130 ( V_57 , V_343 ) ;
if ( F_86 ( V_8 -> V_10 ) )
return F_87 ( V_8 -> V_10 ) ;
V_338 = F_131 ( V_290 , 1 , 0 ) ;
if ( ! V_338 )
return - V_263 ;
if ( ! F_132 ( V_338 , L_33 ) ) {
V_8 -> V_320 = F_133 ( V_338 ) ;
if ( ! V_8 -> V_320 ) {
F_55 ( V_57 , L_34 ) ;
F_134 ( V_338 ) ;
return - V_345 ;
...
static int F_137 ( struct V_312 * V_57 , void * V_347 ,
struct V_348 * V_349 ,
struct V_350 * V_351 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
struct V_281 V_352 ;
unsigned int V_353 = V_351 -> V_354 . V_279 ;
F_23 ( V_8 -> V_57 , L_38 , V_191 ,
V_351 -> V_190 , V_351 -> V_355 , V_353 ) ;
if ( ! V_8 -> V_4 . V_310 )
return - V_301 ;
switch ( V_353 ) {
case 2 :
...
break;
default:
F_55 ( V_8 -> V_57 , L_41 , V_191 ,
V_349 -> V_356 ) ;
return - V_263 ;
}
memcpy ( & V_352 . V_261 , V_351 ,
sizeof( V_352 . V_261 ) ) ;
F_80 ( V_8 , & V_352 ) ;
return 0 ;
}
static int F_138 ( struct V_312 * V_57 , void * V_347 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_42 , V_191 ) ;
F_78 ( V_8 ) ;
return 0 ;
}
static void F_139 ( struct V_312 * V_57 , void * V_347 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_42 , V_191 ) ;
F_79 ( V_8 ) ;
...
static int
F_140 ( struct V_312 * V_57 , void * V_347 , bool V_21 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_43 , V_191 , V_21 ) ;
if ( V_21 )
F_16 ( V_8 ) ;
else
F_17 ( V_8 ) ;
...
static int F_141 ( struct V_312 * V_57 , void * V_347 , T_5 * V_358 , T_6 V_46 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_42 , V_191 ) ;
memcpy ( V_358 , V_8 -> V_7 . V_359 , F_142 ( sizeof( V_8 -> V_7 . V_359 ) , V_46 ) ) ;
return 0 ;
}
static void F_143 ( struct V_312 * V_57 )
{
struct V_360 V_361 = {
. V_362 = & V_363 ,
. V_364 = 2 ,
...
static int F_146 ( struct V_334 * V_335 )
{
struct V_1 * V_8 ;
struct V_312 * V_57 = & V_335 -> V_57 ;
int V_247 ;
V_8 = F_147 ( V_57 , sizeof( * V_8 ) , V_368 ) ;
if ( ! V_8 )
return - V_369 ;
V_8 -> V_57 = V_57 ;
...
if ( V_247 )
return V_247 ;
V_8 -> V_288 = F_148 ( V_57 , L_45 ) ;
if ( F_86 ( V_8 -> V_288 ) ) {
V_247 = F_87 ( V_8 -> V_288 ) ;
F_55 ( V_57 , L_46 , V_247 ) ;
return V_247 ;
}
F_149 ( V_335 , V_8 ) ;
V_247 = F_77 ( V_8 ) ;
...
V_247 = F_150 ( & V_8 -> V_4 ) ;
if ( V_247 ) {
F_55 ( V_57 , L_48 , V_247 ) ;
return V_247 ;
}
V_247 = F_88 ( V_8 ) ;
if ( V_247 ) {
F_55 ( V_57 , L_49 , V_247 ) ;
goto V_372;
}
F_23 ( V_57 , L_50 ) ;
return 0 ;
...
static int F_152 ( struct V_334 * V_335 )
{
struct V_1 * V_8 = F_153 ( V_335 ) ;
F_151 ( & V_8 -> V_4 ) ;
F_91 ( V_8 ) ;
return 0 ;
}
static int F_154 ( struct V_312 * V_57 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_91 ( V_8 ) ;
F_23 ( V_57 , L_51 ) ;
...
static int F_155 ( struct V_312 * V_57 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
int V_247 = 0 ;
V_247 = F_88 ( V_8 ) ;
