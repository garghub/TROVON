...
if ( V_1405 != V_11 -> V_1528 ) {
F_10 ( V_11 , L_186 ,
V_1526 , V_1405 ) ;
}
memcpy ( V_11 -> V_1104 , V_1527 , V_11 -> V_1528 ) ;
if ( ! F_428 ( & V_11 -> V_1104 [ 0 ] ) ) {
F_10 ( V_11 , L_187 , V_1526 ) ;
F_10 ( V_11 , L_188 , V_1526 , V_11 -> V_1104 ) ;
return - V_21 ;
}
...
struct V_1532 * V_1533 , char * V_1534 )
{
struct V_1515 * V_1535 = F_552 ( V_11 ) ;
struct V_24 * V_498 = F_553 ( & V_1535 -> V_11 ) ;
...
V_1537 = L_192 ;
V_1534 += sprintf ( V_1534 ,
( V_26 == 0 ) ? L_193 : L_194 ,
V_1537 ) ;
}
V_1534 += sprintf ( V_1534 , L_195 ) ;
return V_1534 - V_1536 ;
}
...
return sprintf ( V_1534 , L_201 , V_1537 ) ;
}
...
T_5 * V_1540 ;
int V_26 ;
V_1540 = ( V_1539 ? V_498 -> V_809 : V_498 -> V_810 ) ;
for ( V_26 = 0 ; V_26 < V_498 -> V_481 ; V_26 ++ ) {
V_1534 += sprintf ( V_1534 ,
( V_26 == 0 ) ? L_202 : L_203 ,
V_1540 [ V_26 ] ) ;
...
struct V_1532 * V_1533 , char * V_1534 )
{
return F_555 ( V_11 , V_1533 , V_1534 , 1 ) ;
}
...
struct V_1515 * V_1535 = F_552 ( V_11 ) ;
struct V_24 * V_498 = F_553 ( & V_1535 -> V_11 ) ;
return sprintf ( V_1534 , L_204 , V_498 -> V_481 ) ;
}
static struct V_24 * F_559 ( struct V_3 * V_4 ,
union V_1541 * V_1459 , T_5 V_542 )
{
struct V_1515 * V_1535 ;
struct V_24 * V_498 ;
int V_26 ;
V_1535 = F_560 ( L_205 , V_1542 ,
NULL , 0 ) ;
if ( F_561 ( V_1535 ) )
return NULL ;
for ( V_26 = 0 ; V_1543 [ V_26 ] . V_1533 . V_1117 ; V_26 ++ ) {
int V_10 = F_562 ( & V_1535 -> V_11 ,
& V_1543 [ V_26 ] ) ;
if ( V_10 )
goto V_1544;
}
...
goto V_1544;
V_498 -> V_375 = V_1542 ++ ;
V_1535 -> V_11 . V_1545 = V_498 ;
V_498 -> V_1535 = V_1535 ;
memcpy ( & V_498 -> V_1459 , V_1459 , sizeof( * V_1459 ) ) ;
V_498 -> V_339 = V_542 ;
F_564 ( & V_498 -> V_1546 ) ;
F_565 ( & V_498 -> V_1547 , 0 ) ;
F_566 ( & V_498 -> V_1546 , & V_1548 ) ;
F_567 ( & V_498 -> V_155 ) ;
V_498 -> V_902 = 7500 ;
V_498 -> V_441 = V_1549 ;
...
char V_1554 [ 8 ] ;
int V_10 ;
sprintf ( V_1554 , L_206 , V_30 ) ;
V_10 = F_572 ( & V_498 -> V_1535 -> V_11 . V_1555 ,
& V_4 -> V_508 -> V_1555 ,
V_1554 ) ;
if ( ! V_10 ) {
...
sprintf ( V_1554 , L_206 , V_30 ) ;
F_570 ( & V_1553 ) ;
F_576 ( & V_498 -> V_1535 -> V_11 . V_1555 , V_1554 ) ;
V_498 -> V_1422 [ V_30 ] = NULL ;
V_4 -> V_25 = NULL ;
if ( F_577 ( & V_498 -> V_1547 ) ) {
F_578 ( & V_498 -> V_1546 ) ;
F_568 ( V_498 -> V_1535 ) ;
}
F_574 ( & V_1553 ) ;
...
T_1 * V_1556 , T_6 V_1557 )
{
T_14 V_1558 ;
void * V_860 ;
V_860 = F_580 ( V_11 , V_487 , & V_1558 , V_1557 ) ;
if ( V_860 )
* V_1556 = V_1558 ;
return V_860 ;
}
static void F_581 ( struct V_508 * V_11 , T_13 V_487 ,
void * V_1559 , T_1 V_1556 )
{
F_582 ( V_11 , V_487 , V_1559 , V_1556 ) ;
}
static T_1 F_583 ( struct V_508 * V_11 , struct V_485 * V_485 ,
unsigned long V_486 , T_13 V_487 ,
enum V_1560 V_1561 )
{
return F_584 ( V_11 , V_485 , V_486 , V_487 , V_1561 ) ;
}
static void F_585 ( struct V_508 * V_11 , T_1 V_1562 ,
T_13 V_487 , enum V_1560 V_1561 )
{
F_586 ( V_11 , V_1562 , V_487 , V_1561 ) ;
}
static T_1 F_587 ( struct V_508 * V_11 , void * V_1559 ,
T_13 V_487 ,
enum V_1560 V_1561 )
{
return F_588 ( V_11 , V_1559 , V_487 , V_1561 ) ;
}
static void F_589 ( struct V_508 * V_11 , T_1 V_1562 ,
T_13 V_487 ,
enum V_1560 V_1561 )
{
F_590 ( V_11 , V_1562 , V_487 , V_1561 ) ;
}
...
static struct V_308 * F_592 ( struct V_508 * V_1564 ,
struct V_1510 * V_1231 ,
struct V_1515 * V_1516 ,
const struct V_1565 * V_304 , T_5 V_30 )
{
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
{
V_11 -> V_1573 = V_1574 | V_1575 | V_552 ;
V_11 -> V_551 |= V_11 -> V_1573 | V_1576 ;
}
static int F_599 ( struct V_1510 * V_1231 ,
const struct V_1577 * V_468 )
{
union V_1541 V_1578 ;
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
if ( ! ( F_601 ( V_1231 , 0 ) & V_1580 ) ||
! ( F_601 ( V_1231 , 2 ) & V_1580 ) ) {
...
& V_1583 , F_604 ( V_1231 -> V_1584 ) ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1582;
}
V_4 = F_399 ( V_11 ) ;
memset ( & V_1578 , 0 , sizeof( V_1578 ) ) ;
V_1578 . V_1585 . V_1586 = F_605 ( V_1231 -> V_1587 ) ;
V_1578 . V_1585 . V_1587 = V_1231 -> V_1587 -> V_1588 ;
V_1578 . V_1585 . V_508 = F_606 ( V_1231 -> V_1584 ) ;
V_4 -> V_25 = F_569 ( V_4 , & V_1578 ,
V_1538 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
goto V_1589;
...
V_1596 ) ;
V_1579 = F_608 ( 44 ) ;
V_10 = F_609 ( V_1231 , V_1579 ) ;
if ( ! V_10 ) {
V_11 -> V_551 |= V_1597 ;
V_10 = F_610 ( V_1231 , V_1579 ) ;
if ( V_10 ) {
...
T_1 * V_1606 , T_6 V_1557 )
{
unsigned long V_1607 = F_630 ( V_487 ) ;
unsigned long V_485 = F_631 ( V_1557 , V_1607 ) ;
if ( V_485 == 0UL )
return NULL ;
memset ( ( char * ) V_485 , 0 , V_509 << V_1607 ) ;
* V_1606 = F_632 ( V_485 ) ;
return ( void * ) V_485 ;
}
...
{
unsigned long V_1607 = F_630 ( V_487 ) ;
F_634 ( ( unsigned long ) V_1559 , V_1607 ) ;
}
...
static void F_637 ( struct V_508 * V_11 , T_1 V_1562 ,
T_13 V_487 , enum V_1560 V_1561 )
{
}
static T_1 F_638 ( struct V_508 * V_11 , void * V_1559 ,
T_13 V_487 ,
enum V_1560 V_1561 )
{
return F_632 ( V_1559 ) ;
}
static void F_639 ( struct V_508 * V_11 , T_1 V_1562 ,
T_13 V_487 ,
enum V_1560 V_1561 )
{
}
...
V_4 = F_399 ( V_11 ) ;
memset ( & V_1578 , 0 , sizeof( V_1578 ) ) ;
V_1578 . V_1610 = F_641 ( V_1516 -> V_11 . V_1518 ) ;
V_4 -> V_25 = F_569 ( V_4 , & V_1578 ,
V_343 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
...
F_598 ( V_11 ) ;
V_4 -> V_1498 = F_642 ( & V_1516 -> V_1611 [ 1 ] , 0 ,
F_643 ( & V_1516 -> V_1611 [ 1 ] ) ,
L_228 ) ;
if ( ! V_4 -> V_1498 ) {
...
V_4 -> V_1612 = F_642 ( & V_1516 -> V_1611 [ 2 ] , 0 ,
F_643 ( & V_1516 -> V_1611 [ 2 ] ) ,
L_229 ) ;
if ( ! V_4 -> V_1612 ) {
...
V_4 -> V_1613 = F_642 ( & V_1516 -> V_1611 [ 3 ] , 0 ,
F_643 ( & V_1516 -> V_1611 [ 3 ] ) ,
L_231 ) ;
if ( ! V_4 -> V_1613 ) {
...
V_1605:
if ( V_4 -> V_1612 ) {
F_645 ( & V_1516 -> V_1611 [ 2 ] , V_4 -> V_1612 ,
F_643 ( & V_1516 -> V_1611 [ 2 ] ) ) ;
V_4 -> V_1612 = NULL ;
}
if ( V_4 -> V_1613 ) {
F_645 ( & V_1516 -> V_1611 [ 3 ] , V_4 -> V_1613 ,
F_643 ( & V_1516 -> V_1611 [ 3 ] ) ) ;
V_4 -> V_1613 = NULL ;
}
if ( V_4 -> V_1498 ) {
F_645 ( & V_1516 -> V_1611 [ 1 ] , V_4 -> V_1498 ,
F_643 ( & V_1516 -> V_1611 [ 1 ] ) ) ;
V_4 -> V_1498 = NULL ;
}
V_1598:
