...
return 0 ;
V_28 -> V_49 . V_52 = F_23 ;
V_32 = F_25 ( V_2 -> V_15 , V_51 , V_53 ,
& V_28 -> V_49 ) ;
if ( V_32 < 0 )
F_15 ( V_2 -> V_15 , L_11 ) ;
V_28 -> V_47 . V_52 = F_22 ;
V_32 = F_25 ( V_2 -> V_15 , V_51 , V_54 ,
& V_28 -> V_47 ) ;
if ( V_32 < 0 )
F_15 ( V_2 -> V_15 , L_12 ) ;
F_4 ( V_2 -> V_15 , L_13 ,
...
static int F_38 ( struct V_64 * V_65 , void * V_66 )
{
struct V_1 * V_2 = V_65 -> V_67 ;
struct V_27 * V_28 = & V_2 -> V_3 ;
F_32 ( V_65 , L_18 ,
F_39 ( V_28 -> V_31 ) ? L_6 : L_7 ) ;
return 0 ;
}
static int F_40 ( struct V_69 * V_69 , struct V_70 * V_70 )
{
return F_34 ( V_70 , F_38 , V_69 -> V_71 ) ;
}
static T_3 F_41 ( struct V_70 * V_70 ,
const char T_4 * V_72 , T_5 V_73 , T_6 * V_74 )
{
struct V_64 * V_65 = V_70 -> V_75 ;
struct V_1 * V_2 = V_65 -> V_67 ;
...
{
struct V_80 * V_81 ;
V_81 = F_44 ( F_45 ( V_2 -> V_15 ) , V_82 ) ;
if ( ! V_81 ) {
F_15 ( V_2 -> V_15 , L_20 ) ;
return;
}
V_2 -> V_83 = V_81 ;
F_46 ( L_21 , 0644 , V_81 , V_2 , & V_84 ) ;
F_46 ( L_22 , 0644 , V_81 , V_2 , & V_85 ) ;
}
