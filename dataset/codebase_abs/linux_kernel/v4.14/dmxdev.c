...
V_120 = V_91 -> V_102 ;
V_120 -> V_29 = V_86 ;
V_12 = V_120 -> V_129 ( V_120 , V_91 -> V_105 , V_117 , V_119 , V_76 ) ;
if ( V_12 < 0 ) {
...
V_12 = ( * V_132 ) -> V_129 ( * V_132 , V_72 -> V_105 ,
( V_72 -> V_87 & V_134 ) ? 1 : 0 ) ;
if ( V_12 < 0 ) {
F_54 ( L_5 ,
V_31 ) ;
...
static inline void F_59 ( struct V_144 * V_86 )
{
int V_104 ;
...
return - V_53 ;
V_91 = F_61 ( sizeof( struct V_97 ) , V_145 ) ;
if ( V_91 == NULL )
return - V_46 ;
V_91 -> V_105 = V_105 ;
...
F_44 ( V_64 ) ;
F_51 ( V_64 ) ;
if ( ( unsigned int ) V_73 -> V_121 > V_122 )
return - V_53 ;
V_64 -> type = V_101 ;
...
static T_3 F_67 ( struct V_63 * V_147 ,
...
if ( F_68 ( V_147 -> V_151 - V_147 -> V_10 , V_2 , V_148 ) )
return - V_152 ;
V_2 += V_148 ;
V_150 = V_148 ;
V_8 -= V_148 ;
...
if ( V_147 -> V_10 > - 3 )
return V_150 ;
V_147 -> V_10 = ( ( V_147 -> V_151 [ 1 ] << 8 ) | V_147 -> V_151 [ 2 ] ) & 0xfff ;
if ( ! V_8 )
return V_150 ;
}
if ( V_8 > V_147 -> V_10 )
...
unsigned int V_153 , void * V_154 )
{
struct V_63 * V_64 = V_24 -> V_27 ;
struct V_28 * V_28 = V_64 -> V_66 ;
unsigned long V_155 = ( unsigned long ) V_154 ;
int V_12 = 0 ;
if ( F_15 ( & V_28 -> V_32 ) )
return - V_33 ;
switch ( V_153 ) {
...
V_28 -> V_17 -> V_162 ( V_28 -> V_17 , V_154 ) ;
break;
case V_163 :
if ( ! V_28 -> V_17 -> V_164 ) {
V_12 = - V_53 ;
...
V_12 = V_28 -> V_17 -> V_164 ( V_28 -> V_17 ,
( (struct V_165 * ) V_154 ) -> V_166 ,
& ( (struct V_165 * ) V_154 ) -> V_167 ,
& ( (struct V_165 * ) V_154 ) -> V_168 ) ;
break;
case V_169 :
if ( F_15 ( & V_64 -> V_32 ) ) {
V_12 = - V_33 ;
...
static long F_71 ( struct V_24 * V_24 , unsigned int V_153 ,
unsigned long V_155 )
{
return F_72 ( V_24 , V_153 , V_155 , F_70 ) ;
}
static unsigned int F_73 ( struct V_24 * V_24 , T_8 * V_171 )
{
struct V_63 * V_64 = V_24 -> V_27 ;
unsigned int V_139 = 0 ;
if ( ( ! V_64 ) || V_64 -> V_66 -> exit )
return V_172 ;
F_74 ( V_24 , & V_64 -> V_67 . V_14 , V_171 ) ;
if ( V_64 -> V_65 != V_68 &&
V_64 -> V_65 != V_89 &&
V_64 -> V_65 != V_70 )
return 0 ;
if ( V_64 -> V_67 . error )
V_139 |= ( V_173 | V_174 | V_175 | V_172 ) ;
if ( ! F_7 ( & V_64 -> V_67 ) )
V_139 |= ( V_173 | V_174 | V_175 ) ;
return V_139 ;
}
...
unsigned int V_153 , unsigned long V_155 )
{
return F_72 ( V_24 , V_153 , V_155 , F_76 ) ;
}
static unsigned int F_78 ( struct V_24 * V_24 , T_8 * V_171 )
{
struct V_25 * V_26 = V_24 -> V_27 ;
struct V_28 * V_28 = V_26 -> V_29 ;
unsigned int V_139 = 0 ;
...
if ( V_28 -> exit )
return V_172 ;
F_74 ( V_24 , & V_28 -> V_47 . V_14 , V_171 ) ;
if ( ( V_24 -> V_35 & V_36 ) == V_41 ) {
if ( V_28 -> V_47 . error )
V_139 |= ( V_173 | V_174 | V_175 | V_172 ) ;
if ( ! F_7 ( & V_28 -> V_47 ) )
...
V_139 |= ( V_176 | V_177 | V_175 ) ;
return V_139 ;
}
int F_79 ( struct V_28 * V_28 , struct V_178 * V_178 )
{
int V_104 ;
if ( V_28 -> V_17 -> V_179 ( V_28 -> V_17 ) < 0 )
return - V_180 ;
...
F_81 ( V_178 , & V_28 -> V_26 , & V_181 , V_28 ,
V_182 , V_28 -> V_106 ) ;
F_81 ( V_178 , & V_28 -> V_183 , & V_184 ,
V_28 , V_185 , V_28 -> V_106 ) ;
...
if ( V_28 -> V_183 -> V_56 > 1 ) {
F_83 ( V_28 -> V_183 -> V_58 ,
V_28 -> V_183 -> V_56 == 1 ) ;
}
F_84 ( V_28 -> V_26 ) ;
F_84 ( V_28 -> V_183 ) ;
