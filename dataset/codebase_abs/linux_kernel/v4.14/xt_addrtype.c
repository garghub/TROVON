...
{
const struct V_42 * V_43 = F_10 ( V_39 ) ;
bool V_13 = true ;
if ( V_41 -> V_44 )
V_13 &= F_7 ( V_1 , V_3 , & V_43 -> V_45 , V_41 -> V_44 ) ^
( V_41 -> V_46 & V_47 ) ;
if ( V_13 && V_41 -> V_48 )
V_13 &= F_7 ( V_1 , V_3 , & V_43 -> V_15 , V_41 -> V_48 ) ^
! ! ( V_41 -> V_46 & V_49 ) ;
return V_13 ;
}
...
T_3 V_5 , T_4 V_6 )
{
return ! ! ( V_6 & ( 1 << F_12 ( V_1 , V_3 , V_5 ) ) ) ;
}
static bool
F_13 ( const struct V_38 * V_39 , struct V_50 * V_51 )
{
struct V_1 * V_1 = F_14 ( V_51 ) ;
const struct V_52 * V_41 = V_51 -> V_53 ;
const struct V_54 * V_43 = F_15 ( V_39 ) ;
bool V_13 = true ;
if ( V_41 -> V_44 )
V_13 &= F_11 ( V_1 , NULL , V_43 -> V_45 , V_41 -> V_44 ) ^
V_41 -> V_55 ;
if ( V_41 -> V_48 )
V_13 &= F_11 ( V_1 , NULL , V_43 -> V_15 , V_41 -> V_48 ) ^
V_41 -> V_56 ;
return V_13 ;
}
static bool
F_16 ( const struct V_38 * V_39 , struct V_50 * V_51 )
{
struct V_1 * V_1 = F_14 ( V_51 ) ;
...
#if F_19 ( V_59 )
if ( F_20 ( V_51 ) == V_18 )
return F_9 ( V_1 , V_3 , V_39 , V_41 ) ;
#endif
V_43 = F_15 ( V_39 ) ;
if ( V_41 -> V_44 )
V_13 &= F_11 ( V_1 , V_3 , V_43 -> V_45 , V_41 -> V_44 ) ^
( V_41 -> V_46 & V_47 ) ;
if ( V_13 && V_41 -> V_48 )
V_13 &= F_11 ( V_1 , V_3 , V_43 -> V_15 , V_41 -> V_48 ) ^
! ! ( V_41 -> V_46 & V_49 ) ;
return V_13 ;
}
static int F_21 ( const struct V_60 * V_51 )
{
