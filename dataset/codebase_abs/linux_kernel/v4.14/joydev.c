...
static bool F_69 ( struct V_46 * V_42 )
{
const struct V_124 * V_125 ;
for ( V_125 = V_126 ; V_125 -> V_127 ; V_125 ++ ) {
if ( F_70 ( V_42 , V_125 ) ) {
F_71 ( & V_42 -> V_42 ,
L_1 , V_42 -> V_93 ) ;
return true ;
...
static bool F_72 ( struct V_46 * V_42 )
{
F_73 ( V_128 , V_129 ) ;
F_74 ( V_130 > V_129 || V_131 > V_129 ) ;
F_75 ( V_128 , V_131 ) ;
F_76 ( V_32 , V_128 ) ;
F_76 ( V_27 , V_128 ) ;
F_76 ( V_132 , V_128 ) ;
if ( ! F_77 ( V_128 , V_42 -> V_133 , V_131 ) )
return false ;
F_75 ( V_128 , V_130 ) ;
F_76 ( V_134 , V_128 ) ;
F_76 ( V_135 , V_128 ) ;
if ( ! F_77 ( V_42 -> V_136 , V_128 , V_130 ) )
return false ;
F_75 ( V_128 , V_129 ) ;
F_76 ( V_137 , V_128 ) ;
F_76 ( V_138 , V_128 ) ;
F_76 ( V_139 , V_128 ) ;
if ( ! F_77 ( V_42 -> V_140 , V_128 , V_129 ) )
return false ;
if ( V_42 -> V_125 . V_141 == V_142 )
return false ;
return true ;
}
static bool F_78 ( struct V_143 * V_144 , struct V_46 * V_42 )
{
if ( F_69 ( V_42 ) )
return false ;
if ( F_72 ( V_42 ) )
...
static int F_79 ( struct V_143 * V_144 , struct V_46 * V_42 ,
const struct V_124 * V_125 )
{
struct V_11 * V_11 ;
int V_47 , V_145 , V_146 , V_147 , V_148 ;
int error ;
V_147 = F_80 ( V_149 , V_150 , true ) ;
if ( V_147 < 0 ) {
error = V_147 ;
F_81 ( L_2 , error ) ;
return error ;
...
V_148 -= V_149 ;
F_85 ( & V_11 -> V_42 , L_3 , V_148 ) ;
V_11 -> V_24 . V_42 = F_86 ( V_42 ) ;
V_11 -> V_24 . V_93 = F_87 ( & V_11 -> V_42 ) ;
V_11 -> V_24 . V_144 = V_144 ;
V_11 -> V_24 . V_26 = V_11 ;
F_88 (i, dev->absbit, ABS_CNT) {
V_11 -> V_34 [ V_47 ] = V_11 -> V_16 ;
V_11 -> V_49 [ V_11 -> V_16 ] = V_47 ;
V_11 -> V_16 ++ ;
}
for ( V_47 = V_152 - V_28 ; V_47 < V_91 - V_28 + 1 ; V_47 ++ )
if ( F_42 ( V_47 + V_28 , V_42 -> V_140 ) ) {
...
if ( F_89 ( V_42 , V_145 ) == F_90 ( V_42 , V_145 ) ) {
V_11 -> V_3 [ V_47 ] . type = V_4 ;
continue;
}
V_11 -> V_3 [ V_47 ] . type = V_5 ;
V_11 -> V_3 [ V_47 ] . V_153 = F_91 ( V_42 , V_145 ) ;
V_146 = ( F_89 ( V_42 , V_145 ) + F_90 ( V_42 , V_145 ) ) / 2 ;
V_11 -> V_3 [ V_47 ] . V_6 [ 0 ] = V_146 - F_92 ( V_42 , V_145 ) ;
V_11 -> V_3 [ V_47 ] . V_6 [ 1 ] = V_146 + F_92 ( V_42 , V_145 ) ;
V_146 = ( F_89 ( V_42 , V_145 ) - F_90 ( V_42 , V_145 ) ) / 2
- 2 * F_92 ( V_42 , V_145 ) ;
if ( V_146 ) {
...
V_11 -> V_42 . V_154 = F_93 ( V_155 , V_147 ) ;
V_11 -> V_42 . V_156 = & V_157 ;
V_11 -> V_42 . V_158 = & V_42 -> V_42 ;
V_11 -> V_42 . V_159 = F_15 ;
F_94 ( & V_11 -> V_42 ) ;
error = F_95 ( & V_11 -> V_24 ) ;
if ( error )
goto V_160;
F_96 ( & V_11 -> V_58 , & V_161 ) ;
error = F_97 ( & V_11 -> V_58 , & V_11 -> V_42 ) ;
if ( error )
goto V_162;
return 0 ;
V_162:
...
{
struct V_11 * V_11 = V_24 -> V_26 ;
F_102 ( & V_11 -> V_58 , & V_11 -> V_42 ) ;
F_68 ( V_11 ) ;
F_100 ( F_103 ( V_11 -> V_42 . V_154 ) ) ;
F_98 ( V_24 ) ;
F_99 ( & V_11 -> V_42 ) ;
}
