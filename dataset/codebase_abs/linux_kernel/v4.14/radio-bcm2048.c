...
static void F_77 ( struct V_1 * V_2 , int V_123 ,
int V_140 , int V_141 )
{
if ( V_141 ) {
...
static int F_78 ( struct V_1 * V_2 , int V_123 ,
int V_140 )
{
int V_141 ;
V_141 = F_71 ( V_2 , V_123 ) ;
...
static void F_79 ( struct V_1 * V_2 , int V_123 ,
int V_140 )
{
int V_141 ;
V_141 = F_71 ( V_2 , V_123 ) ;
...
if ( ( V_2 -> V_37 . V_137 [ V_123 ] & V_146 ) ==
V_155 )
F_77 ( V_2 , V_123 , V_140 , V_141 ) ;
}
static int F_80 ( struct V_1 * V_2 , int V_123 )
{
...
if ( V_156 ) {
V_156 = 0 ;
V_140 = F_80 ( V_2 , V_123 ) ;
if ( V_140 >= 0 && V_140 < ( V_132 - 1 ) )
V_157 = 1 ;
continue;
} else if ( V_157 ) {
V_157 = 0 ;
if ( F_78 ( V_2 , V_123 , V_140 ) )
V_158 = 1 ;
continue;
} else if ( V_158 ) {
V_158 = 0 ;
F_79 ( V_2 , V_123 , V_140 ) ;
continue;
}
if ( ( V_2 -> V_37 . V_137 [ V_123 ] & V_146 ) ==
V_138 ) {
...
static int F_84 ( struct V_1 * V_2 , char * V_7 )
{
...
V_127 = F_85 ( V_169 , 5 , V_170 ) ;
if ( ! V_127 ) {
V_24 = - V_171 ;
goto V_92;
}
for ( V_123 = 0 ; V_123 < V_2 -> V_37 . V_129 ; V_123 ++ ) {
V_168 += sprintf ( V_127 + V_168 , L_9 ,
...
static void F_91 ( struct V_179 * V_180 )
{
struct V_1 * V_2 ;
T_1 V_181 = 0 , V_182 = 0 , V_19 ;
V_2 = F_92 ( V_180 , struct V_1 , V_180 ) ;
F_4 ( V_2 , V_112 , & V_181 ) ;
F_4 ( V_2 , V_113 , & V_182 ) ;
if ( V_181 & ( V_90 |
V_91 ) ) {
...
static T_5 F_94 ( int V_185 , void * V_9 )
{
struct V_1 * V_2 = V_9 ;
F_95 ( & V_2 -> V_6 -> V_9 , L_10 ) ;
if ( V_2 -> V_8 )
F_96 ( & V_2 -> V_180 ) ;
return V_186 ;
}
...
if ( F_100 ( & V_2 -> V_6 -> V_9 , & V_188 [ V_123 ] ) != 0 ) {
F_2 ( & V_2 -> V_6 -> V_9 ,
L_11 ) ;
V_24 = - V_131 ;
F_97 ( V_2 , V_123 ) ;
...
static int F_101 ( struct V_189 * V_189 )
{
struct V_1 * V_2 = F_102 ( V_189 ) ;
V_2 -> V_178 ++ ;
V_2 -> V_177 = 0 ;
V_2 -> V_176 = 0 ;
return 0 ;
}
static int F_103 ( struct V_189 * V_189 )
{
struct V_1 * V_2 = F_102 ( V_189 ) ;
V_2 -> V_178 -- ;
return 0 ;
}
static unsigned int F_104 ( struct V_189 * V_189 ,
struct V_190 * V_191 )
{
struct V_1 * V_2 = F_102 ( V_189 ) ;
int V_192 = 0 ;
F_105 ( V_189 , & V_2 -> V_167 , V_191 ) ;
if ( V_2 -> V_176 )
V_192 = V_193 | V_194 ;
return V_192 ;
}
static T_6 F_106 ( struct V_189 * V_189 , char T_7 * V_17 ,
T_8 V_195 , T_9 * V_196 )
{
struct V_1 * V_2 = F_102 ( V_189 ) ;
int V_123 ;
...
static int F_109 ( struct V_189 * V_189 , void * V_204 ,
struct V_205 * V_206 )
{
struct V_1 * V_2 = F_110 ( F_111 ( V_189 ) ) ;
F_112 ( V_206 -> V_207 , V_208 ,
sizeof( V_206 -> V_207 ) ) ;
F_112 ( V_206 -> V_209 , V_210 ,
sizeof( V_206 -> V_209 ) ) ;
snprintf ( V_206 -> V_211 , 32 , L_12 , V_2 -> V_6 -> V_18 ) ;
...
static int F_113 ( struct V_189 * V_218 , void * V_204 ,
unsigned int * V_123 )
{
* V_123 = 0 ;
return 0 ;
...
static int F_115 ( struct V_189 * V_189 , void * V_204 ,
struct V_219 * V_220 )
{
int V_123 ;
...
static int F_122 ( struct V_189 * V_189 , void * V_204 ,
...
if ( ! V_2 -> V_8 )
return - V_225 ;
V_24 = F_21 ( V_2 , F_125 ( V_252 -> V_46 ) ) ;
V_24 |= F_43 ( V_2 , V_254 ) ;
return V_24 ;
}
static int F_126 ( struct V_189 * V_189 , void * V_204 ,
...
F_130 ( & V_2 -> V_25 ) ;
F_131 ( & V_2 -> V_98 ) ;
F_132 ( & V_2 -> V_180 , F_91 ) ;
if ( V_6 -> V_185 ) {
V_24 = F_133 ( V_6 -> V_185 ,
F_94 , V_259 ,
V_6 -> V_229 , V_2 ) ;
if ( V_24 < 0 ) {
F_2 ( & V_6 -> V_9 , L_15 ) ;
...
V_2 -> V_261 = V_262 ;
F_134 ( & V_2 -> V_261 , V_2 ) ;
if ( F_135 ( & V_2 -> V_261 , V_263 , V_264 ) ) {
F_95 ( & V_6 -> V_9 , L_18 ) ;
V_24 = - V_10 ;
goto V_265;
}
