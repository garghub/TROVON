...
void
F_170 ( struct V_13 * V_14 , T_2 V_132 )
{
struct V_18 * V_19 = F_42 ( V_14 ) ;
struct V_20 * V_21 = F_10 ( V_19 ) ;
unsigned long V_136 ;
...
int F_176 ( struct V_190 * V_273 )
{
struct V_13 * V_14 = F_4 ( V_11 ( V_273 -> V_8 ) ) ;
if ( F_177 ( ! V_14 ) )
return V_272 ;
return F_174 ( V_14 ) ;
}
...
F_181 ( & V_19 -> V_172 . V_282 , F_179 ( V_9 ) ) ;
F_149 ( V_9 ) ;
F_150 ( V_9 ) ;
F_151 ( V_9 ) ;
F_98 ( V_9 ) ;
...
static enum V_189
F_182 ( struct V_285 * V_286 )
{
struct V_287 * V_288 = F_183 ( V_286 ) ;
struct V_18 * V_19 = F_184 ( V_288 ) ;
struct V_13 * V_14 = F_185 ( V_288 ) ;
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
int V_77 = 0 , V_289 = 0 ;
if ( V_14 && V_14 -> V_40 == V_115 )
return V_192 ;
V_289 = F_186 ( V_288 ) ;
if ( V_289 && V_3 -> V_121 -> V_290 ) {
V_77 = V_3 -> V_121 -> V_290 ( V_288 ) ;
if ( V_77 == - V_291 ) {
F_187 ( V_288 ) ;
return V_192 ;
} else if ( V_77 )
...
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
struct V_293 * V_294 = V_288 -> V_285 ;
struct V_295 * V_296 = V_288 -> V_297 ;
int V_298 = sizeof( V_299 ) ;
int V_153 ;
if ( V_288 -> V_300 < V_298 ) {
V_153 = - V_301 ;
goto V_302;
}
switch ( V_294 -> V_303 ) {
case V_304 :
V_298 += sizeof( struct V_305 ) ;
break;
case V_306 :
V_298 += sizeof( struct V_307 ) ;
break;
case V_308 :
V_298 += sizeof( struct V_309 ) ;
if ( ( ! V_288 -> V_310 . V_311 ) ||
( ! V_288 -> V_312 . V_311 ) ) {
V_153 = - V_111 ;
goto V_302;
}
...
break;
case V_315 :
V_298 += sizeof( struct V_316 ) ;
if ( ( V_19 -> V_232 -> V_89 == 0L ) ||
( V_294 -> V_317 . V_318 . V_89 !=
V_19 -> V_232 -> V_89 ) ) {
V_153 = - V_319 ;
goto V_302;
}
...
V_153 = V_3 -> V_121 -> V_294 ( V_288 ) ;
if ( ! V_153 )
return 0 ;
V_302:
F_115 ( V_288 -> V_321 < sizeof( V_299 ) ) ;
V_296 -> V_322 = 0 ;
V_296 -> V_323 = V_153 ;
V_288 -> V_321 = sizeof( V_299 ) ;
F_189 ( V_288 , V_296 -> V_323 ,
V_296 -> V_322 ) ;
return 0 ;
}
static void
...
{
struct V_324 * V_325 = V_14 -> V_64 ;
unsigned long V_136 ;
if ( ! V_325 )
return;
F_53 ( V_325 -> V_326 , V_136 ) ;
F_190 ( V_325 ) ;
F_54 ( V_325 -> V_326 , V_136 ) ;
}
static int F_191 ( struct V_18 * V_19 , struct V_287 * V_288 )
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
struct V_293 * V_294 = V_288 -> V_285 ;
struct V_295 * V_296 = V_288 -> V_297 ;
...
switch ( V_294 -> V_303 ) {
case V_328 :
V_298 += sizeof( struct V_329 ) ;
goto V_330;
case V_331 :
V_298 += sizeof( struct V_332 ) ;
V_330:
if ( ( ! V_288 -> V_310 . V_311 ) ||
( ! V_288 -> V_312 . V_311 ) ) {
V_153 = - V_111 ;
...
static int F_192 ( struct V_287 * V_288 )
{
struct V_18 * V_19 = F_184 ( V_288 ) ;
if ( F_100 ( V_288 -> V_9 ) )
return F_191 ( V_19 , V_288 ) ;
else
...
if ( ! V_3 -> V_121 -> V_294 )
return - V_334 ;
snprintf ( V_333 , sizeof( V_333 ) ,
L_48 , V_19 -> V_57 ) ;
V_325 = F_193 ( V_9 , V_333 , F_192 , V_3 -> V_121 -> V_335 ,
NULL ) ;
if ( F_194 ( V_325 ) ) {
F_195 ( V_9 ,
L_49 ,
...
static int F_200 ( struct V_324 * V_325 , struct V_285 * V_286 )
{
struct V_13 * V_14 = F_97 ( V_325 -> V_337 ) ;
if ( V_14 -> V_40 == V_115 &&
! ( V_14 -> V_136 & V_265 ) )
return V_338 ;
if ( V_14 -> V_40 != V_197 )
...
if ( ! V_3 -> V_121 -> V_294 )
return - V_334 ;
V_325 = F_193 ( V_9 , NULL , F_192 , V_3 -> V_121 -> V_335 ,
NULL ) ;
if ( F_194 ( V_325 ) ) {
F_195 ( V_9 , L_50 ) ;
return F_196 ( V_325 ) ;
