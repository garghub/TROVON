...
static inline bool
F_31 ( const struct V_60 * V_2 ,
const struct V_60 * V_3 ,
T_1 * V_4 )
{
return F_32 ( & V_2 -> V_5 . V_61 , & V_3 -> V_5 . V_61 ) &&
F_32 ( & V_2 -> V_3 . V_61 , & V_3 -> V_3 . V_61 ) &&
V_2 -> V_6 == V_3 -> V_6 &&
V_2 -> V_7 == V_3 -> V_7 ;
}
static bool
...
{
if ( F_34 ( V_9 , V_11 , & V_10 -> V_5 . V_61 ) ||
F_34 ( V_9 , V_12 , & V_10 -> V_3 . V_61 ) ||
F_4 ( V_9 , V_13 , V_10 -> V_6 ) ||
F_5 ( V_9 , V_14 , V_10 -> V_7 ) )
goto V_15;
return false ;
...
static inline void
F_35 ( struct V_60 * V_16 ,
const struct V_60 * V_17 )
{
V_16 -> V_6 = V_17 -> V_6 ;
}
static int
F_36 ( struct V_18 * V_19 , const struct V_8 * V_9 ,
const struct V_20 * V_21 ,
enum V_22 V_23 , struct V_24 * V_25 )
{
T_2 V_26 = V_19 -> V_27 -> V_23 [ V_23 ] ;
...
struct V_29 V_30 = F_8 ( V_9 , V_25 , V_19 ) ;
if ( ! F_37 ( V_9 , V_25 -> V_31 & V_32 ,
& V_28 . V_6 , & V_28 . V_7 ) )
return - V_33 ;
F_38 ( V_9 , V_25 -> V_31 & V_34 , & V_28 . V_5 . V_61 ) ;
F_38 ( V_9 , V_25 -> V_31 & V_35 , & V_28 . V_3 . V_61 ) ;
return V_26 ( V_19 , & V_28 , & V_30 , & V_25 -> V_30 , V_25 -> V_36 ) ;
}
static int
F_39 ( struct V_18 * V_19 , struct V_37 * V_38 [] ,
enum V_22 V_23 , T_1 * V_39 , T_1 V_31 , bool V_40 )
{
...
V_47 = F_40 ( V_38 [ V_11 ] , & V_28 . V_5 ) ;
if ( V_47 )
return V_47 ;
V_47 = F_18 ( V_19 , V_38 , & V_30 ) ;
if ( V_47 )
return V_47 ;
V_47 = F_40 ( V_38 [ V_12 ] , & V_28 . V_3 ) ;
if ( V_47 )
return V_47 ;
V_28 . V_6 = F_19 ( V_38 [ V_13 ] ) ;
if ( V_38 [ V_14 ] ) {
