...
F_63 ( V_110 , L_22 , V_102 ) ;
}
return 0 ;
}
static int F_143 ( struct V_221 * V_222 ,
struct V_223 * V_224 , struct V_50 * V_51 )
{
int V_165 = 0 ;
int V_37 = 0 , V_148 = 0 , V_225 = 0 , V_8 ;
struct V_226 * V_227 ;
struct V_101 * V_102 = V_222 -> V_110 . V_213 ;
struct V_101 * V_138 ;
int V_162 = 0 ;
int V_228 = 0 ;
struct V_205 * V_206 ;
F_81 ( V_51 , V_102 ) ;
if ( ! V_51 -> V_139 ) {
F_57 ( & V_222 -> V_110 , L_23 ) ;
return - V_99 ;
}
F_63 ( & V_222 -> V_110 , L_24 , V_51 -> V_139 ) ;
F_63 ( & V_222 -> V_110 , L_25 , V_51 -> V_121 ) ;
F_63 ( & V_222 -> V_110 , L_26 , V_51 -> V_93 ) ;
V_51 -> V_122 = F_58 ( & V_222 -> V_110 ,
V_51 -> V_121 * sizeof( * V_51 -> V_122 ) , V_111 ) ;
V_51 -> V_95 = F_58 ( & V_222 -> V_110 ,
V_51 -> V_93 * sizeof( * V_51 -> V_95 ) , V_111 ) ;
V_51 -> V_152 = F_58 ( & V_222 -> V_110 ,
...
V_51 -> V_34 = F_145 ( V_229 , V_102 ) -> V_34 ;
V_228 = F_146 ( V_222 , 0 ) ;
if ( V_228 > 0 ) {
V_206 = F_147 ( V_222 ,
V_230 , L_29 ) ;
V_51 -> V_202 = F_134 ( & V_222 -> V_110 , V_206 ) ;
if ( F_94 ( V_51 -> V_202 ) )
return F_135 ( V_51 -> V_202 ) ;
F_148 ( V_228 , F_130 ,
V_51 ) ;
}
V_224 -> V_98 = V_51 -> V_139 * V_11 ;
V_227 = F_58 ( & V_222 -> V_110 ,
sizeof( * V_227 ) * V_224 -> V_98 , V_111 ) ;
if ( ! V_227 )
return - V_112 ;
V_224 -> V_97 = V_227 ;
V_8 = 0 ;
...
if ( V_165 )
return V_165 ;
V_225 = V_51 -> V_152 [ V_8 ] . V_6 . V_216 ;
V_231 = V_51 -> V_152 [ V_8 ] . V_6 . V_96 ;
for ( V_148 = 0 ; V_148 < V_11 ; V_148 ++ , V_225 ++ ) {
V_227 -> V_232 = V_225 ;
V_227 -> V_96 = F_149 ( V_111 , L_30 ,
V_231 , V_148 ) ;
V_227 ++ ;
}
F_99 ( V_51 , V_8 , V_138 ) ;
...
static int F_150 ( struct V_221 * V_222 )
{
struct V_50 * V_51 ;
struct V_223 * V_224 ;
int V_165 , V_37 ;
if ( ! V_222 -> V_110 . V_213 ) {
F_57 ( & V_222 -> V_110 , L_32 ) ;
return - V_99 ;
}
V_224 = F_58 ( & V_222 -> V_110 , sizeof( * V_224 ) , V_111 ) ;
if ( ! V_224 )
return - V_112 ;
V_51 = F_58 ( & V_222 -> V_110 , sizeof( * V_51 ) , V_111 ) ;
if ( ! V_51 )
return - V_112 ;
V_51 -> V_110 = & V_222 -> V_110 ;
F_151 ( V_222 , V_51 ) ;
V_165 = F_143 ( V_222 , V_224 , V_51 ) ;
if ( V_165 )
return V_165 ;
V_224 -> V_233 = V_234 ;
V_224 -> V_235 = & V_236 ;
V_224 -> V_237 = & V_238 ;
V_224 -> V_239 = & V_240 ;
V_224 -> V_96 = F_152 ( & V_222 -> V_110 ) ;
V_51 -> V_241 = F_153 ( & V_222 -> V_110 , V_224 , V_51 ) ;
if ( F_94 ( V_51 -> V_241 ) ) {
F_57 ( & V_222 -> V_110 , L_33 ) ;
return F_135 ( V_51 -> V_241 ) ;
}
for ( V_37 = 0 ; V_37 < V_51 -> V_139 ; V_37 ++ )
F_154 ( V_51 -> V_241 , & V_51 -> V_152 [ V_37 ] . V_6 ) ;
return 0 ;
}
