...
static int F_46 ( struct V_29 * V_30 , T_4 V_70 )
{
int V_31 ;
struct V_33 * V_71 = F_44 ( V_30 ) ;
struct V_1 * V_2 = F_33 ( V_71 ) ;
if ( V_2 -> type != V_59 ) {
F_47 ( & V_30 -> V_15 , L_9 ) ;
return 0 ;
}
