...
V_4 -> V_9 [ 1 ] = 0x51 ;
V_4 -> V_9 [ 2 ] = V_4 -> V_19 ;
V_4 -> V_9 [ 3 ] = ( V_4 -> V_20 ? 0 : 1 ) | ( V_4 -> V_21 ? 4 : 0 ) ;
V_4 -> V_9 [ 4 ] = 0x00 ;
V_4 -> V_9 [ 5 ] = 0x00 ;
V_4 -> V_9 [ 6 ] = 0x00 ;
V_4 -> V_9 [ 7 ] = 0x00 ;
...
{
struct V_1 * V_4 = F_20 ( V_26 ) ;
unsigned V_5 = V_54 -> V_55 ;
if ( V_54 -> V_56 != 0 || V_54 -> type != V_57 )
return - V_40 ;
V_5 = F_26 ( V_5 , V_43 * V_44 , V_46 * V_44 ) ;
...
return F_7 ( V_4 ) ;
case V_69 :
V_4 -> V_19 = V_60 [ ( V_59 -> V_65 - ( V_70 ) V_59 -> V_71 ) / ( V_70 ) V_59 -> V_72 ] ;
return F_7 ( V_4 ) ;
}
return - V_40 ;
}
...
{
struct V_74 * V_16 = F_33 ( V_23 ) ;
struct V_1 * V_4 ;
struct V_75 * V_62 ;
int V_76 = 0 ;
if ( V_16 -> V_77 && strcmp ( V_16 -> V_77 , L_5 ) )
return - V_78 ;
V_4 = F_34 ( sizeof( struct V_1 ) , V_79 ) ;
if ( V_4 )
V_4 -> V_9 = F_35 ( V_13 , V_79 ) ;
if ( ! V_4 || ! V_4 -> V_9 ) {
F_36 ( & V_23 -> V_16 , L_6 ) ;
F_31 ( V_4 ) ;
V_76 = - V_80 ;
...
F_42 ( & V_4 -> V_15 , V_4 ) ;
F_43 ( 20 ) ;
F_3 ( V_4 , 95.16 * V_44 , false ) ;
V_76 = F_44 ( & V_4 -> V_15 , V_94 , - 1 ) ;
if ( V_76 < 0 ) {
F_36 ( & V_23 -> V_16 , L_8 ) ;
goto V_95;
}
