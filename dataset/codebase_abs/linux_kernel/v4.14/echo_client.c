...
V_106 = F_143 ( & V_232 -> V_237 , ++ V_239 ) ;
if ( V_106 )
goto V_240;
}
V_106 = F_144 ( V_26 , V_73 -> V_241 , V_232 ) ;
if ( V_106 != 0 ) {
F_69 ( L_17 , V_106 ) ;
goto V_240;
}
...
if ( V_106 )
F_69 ( L_20 ,
V_11 -> V_86 -> V_74 -> V_241 -> V_243 -> V_147 , V_106 ) ;
}
static void
...
break;
case 3 :
V_106 = F_158 ( V_26 , V_73 -> V_241 , V_204 , V_232 , V_11 ,
...
V_106 = F_146 ( & V_11 , V_70 , V_232 ) ;
if ( V_106 == 0 ) {
V_106 = F_145 ( V_26 , V_73 -> V_241 , V_232 ) ;
if ( V_106 == 0 )
V_11 -> V_153 = 1 ;
F_147 ( V_11 ) ;
}
...
V_106 = F_146 ( & V_11 , V_70 , V_232 ) ;
if ( V_106 == 0 ) {
V_106 = F_170 ( V_26 , V_73 -> V_241 , V_232 ) ;
F_147 ( V_11 ) ;
}
goto V_127;
case V_311 :
...
V_106 = F_146 ( & V_11 , V_70 , V_232 ) ;
if ( V_106 == 0 ) {
V_106 = F_171 ( V_26 , V_73 -> V_241 , V_232 ) ;
F_147 ( V_11 ) ;
}
goto V_127;
case V_312 :
...
V_320 -> V_335 = V_336 ;
V_320 -> V_337 = V_166 ;
V_106 = F_175 ( V_26 , & V_73 -> V_241 , V_124 , & V_318 , V_320 , NULL ) ;
F_60 ( V_320 ) ;
if ( V_106 != 0 ) {
F_69 ( L_27 ,
F_83 ( V_316 , 1 ) ) ;
...
F_14 ( F_56 ( & V_73 -> V_241 -> V_339 ) > 0 ) ;
V_106 = F_176 ( V_73 -> V_241 ) ;
if ( V_106 != 0 )
F_69 ( L_29 , V_106 ) ;
return V_106 ;
}
