...
V_19 -> V_72 = ( ( V_17 % V_22 -> V_73 -> V_74 ) == 0 ) ;
F_18 ( & V_22 -> V_26 , V_25 ) ;
...
static int
F_35 ( struct V_42 * V_43 , T_5 V_75 , T_5 V_76 , int V_77 )
{
struct V_1 * V_22 = V_43 -> V_49 ;
...
static unsigned int
F_39 ( struct V_42 * V_43 , T_7 * V_79 )
{
struct V_1 * V_22 = V_43 -> V_49 ;
unsigned long V_25 ;
int V_24 = 0 ;
...
F_18 ( & V_22 -> V_26 , V_25 ) ;
F_30 ( & V_22 -> V_65 ) ;
F_40 ( V_43 , & V_22 -> V_36 , V_79 ) ;
F_40 ( V_43 , & V_22 -> V_38 , V_79 ) ;
F_11 ( & V_22 -> V_26 , V_25 ) ;
if ( F_21 ( ! F_22 ( & V_22 -> V_37 ) ) )
V_24 |= V_80 | V_81 ;
if ( F_21 ( V_22 -> V_62 ) ||
...
static long
F_41 ( struct V_42 * V_43 , unsigned int V_84 , unsigned long V_85 )
{
struct V_1 * V_22 = V_43 -> V_49 ;
unsigned long V_25 ;
int V_24 = 0 ;
...
{
int V_89 = 0 ;
V_22 -> V_73 -> V_90 = F_3 ( V_22 -> V_7 , & V_91 , & V_92 ,
& V_93 ) ;
V_22 -> V_73 -> V_23 = V_22 ;
...
V_89 = F_43 ( V_22 -> V_73 ) ;
if ( V_89 != 0 ) {
F_14 ( V_22 , L_15 , V_22 -> V_73 -> V_34 , V_89 ) ;
goto V_97;
}
V_89 = F_43 ( V_22 -> V_55 ) ;
if ( V_89 != 0 ) {
...
static int F_46 ( struct V_1 * V_22 , unsigned V_100 )
{
int V_89 = 0 ;
F_45 ( V_22 ) ;
V_89 = F_42 ( V_22 ) ;
...
T_8 V_104 = F_50 ( V_102 -> V_105 ) ;
T_8 V_106 = F_50 ( V_102 -> V_107 ) ;
T_8 V_108 = F_50 ( V_102 -> V_109 ) ;
if ( V_103 )
return false ;
if ( ( V_102 -> V_110 & V_111 ) != V_112 ||
( V_102 -> V_110 & V_113 ) != V_114 )
return false ;
switch ( V_102 -> V_115 ) {
case V_116 :
V_104 >>= 8 ;
if ( V_117 & V_102 -> V_110 )
break;
return false ;
case V_118 :
if ( ! V_106 && V_108 == 1 &&
...
T_6 * V_21 = V_19 -> V_21 ;
int V_71 = - V_123 ;
T_8 V_105 = F_50 ( V_102 -> V_105 ) ;
T_8 V_107 = F_50 ( V_102 -> V_107 ) ;
T_8 V_109 = F_50 ( V_102 -> V_109 ) ;
F_14 ( V_22 , L_23 ,
V_102 -> V_110 , V_102 -> V_115 , V_107 , V_105 , V_109 ) ;
switch ( V_102 -> V_110 & V_113 ) {
case V_114 :
switch ( V_102 -> V_115 ) {
case V_116 :
if ( ( V_105 >> 8 ) != V_22 -> V_98 )
break;
if ( ! V_22 -> V_124 ) {
V_71 = 0 ;
break;
}
V_71 = strlen ( V_22 -> V_124 ) ;
V_21 [ 0 ] = ( V_71 >> 8 ) & 0xFF ;
V_21 [ 1 ] = V_71 & 0xFF ;
memcpy ( V_21 + 2 , V_22 -> V_124 , V_71 ) ;
F_14 ( V_22 , L_24 , V_71 ,
V_22 -> V_124 ) ;
break;
case V_118 :
...
F_16 ( V_22 ,
L_25 ,
V_102 -> V_110 , V_102 -> V_115 ,
V_107 , V_105 , V_109 ) ;
break;
}
if ( V_71 >= 0 ) {
V_19 -> V_20 = V_71 ;
V_19 -> V_72 = V_71 < V_109 ;
V_71 = F_27 ( V_121 -> V_7 -> V_126 , V_19 , V_56 ) ;
if ( V_71 < 0 ) {
...
struct V_2 * V_3 )
{
struct V_6 * V_7 = V_128 -> V_121 -> V_7 ;
struct V_1 * V_22 = F_1 ( V_3 ) ;
struct V_129 * V_130 ;
struct V_120 * V_121 = V_128 -> V_121 ;
struct V_15 * V_73 ;
...
V_55 = F_55 ( V_121 -> V_7 , & V_94 ) ;
if ( ! V_55 )
goto V_136;
V_92 . V_138 = V_91 . V_138 ;
V_95 . V_138 = V_94 . V_138 ;
V_93 . V_138 = V_91 . V_138 ;
V_96 . V_138 = V_94 . V_138 ;
V_44 = F_57 ( V_3 , V_139 ,
V_140 , V_141 , NULL ) ;
if ( V_44 )
return V_44 ;
...
if ( ! V_162 -> V_124 )
goto V_164;
V_89 = F_73 ( V_163 , V_162 -> V_124 , V_165 ) ;
if ( V_89 >= V_165 ) {
V_89 = V_165 ;
} else if ( V_163 [ V_89 - 1 ] != '\n' && V_89 + 1 < V_165 ) {
V_163 [ V_89 ++ ] = '\n' ;
V_163 [ V_89 ] = '\0' ;
}
V_164:
...
int V_89 ;
F_29 ( & V_162 -> V_26 ) ;
V_89 = sprintf ( V_163 , L_31 , V_162 -> V_143 ) ;
F_30 ( & V_162 -> V_26 ) ;
return V_89 ;
}
