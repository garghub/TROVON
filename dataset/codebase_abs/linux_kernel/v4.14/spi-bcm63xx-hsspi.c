...
V_82 = F_37 ( V_80 ) ;
if ( ! V_82 ) {
struct V_80 * V_86 = F_36 ( V_53 , L_4 ) ;
if ( F_34 ( V_86 ) )
return F_35 ( V_86 ) ;
V_82 = F_37 ( V_86 ) ;
if ( ! V_82 )
...
F_41 ( & V_2 -> V_6 ) ;
F_42 ( & V_2 -> V_45 ) ;
V_24 -> V_53 . V_89 = V_53 -> V_89 ;
if ( ! V_53 -> V_89 )
V_24 -> V_90 = V_91 ;
F_43 ( V_53 -> V_89 , L_5 , & V_83 ) ;
if ( V_83 > 8 ) {
F_44 ( V_53 , L_6 ,
V_83 ) ;
V_83 = V_84 ;
...
F_5 ( V_5 | V_100 ,
V_2 -> V_7 + V_8 ) ;
V_81 = F_47 ( V_53 , V_69 , F_28 , V_101 ,
V_52 -> V_102 , V_2 ) ;
if ( V_81 )
goto V_103;
V_81 = F_48 ( V_53 , V_24 ) ;
