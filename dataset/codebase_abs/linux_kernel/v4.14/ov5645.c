...
static int F_45 ( struct V_2 * V_70 ,
struct V_64 * V_65 )
{
struct V_87 V_86 = { 0 } ;
...
return - V_63 ;
V_103 -> V_106 = * F_39 ( V_1 , V_65 , V_103 -> V_81 ,
V_103 -> V_83 ) ;
return 0 ;
}
static int F_47 ( struct V_2 * V_70 , int V_21 )
{
...
static int F_49 ( struct V_14 * V_110 ,
const struct V_111 * V_55 )
{
struct V_112 * V_6 = & V_110 -> V_6 ;
struct V_113 * V_114 ;
struct V_1 * V_1 ;
T_2 V_115 , V_116 ;
T_3 V_117 ;
int V_4 ;
V_1 = F_50 ( V_6 , sizeof( struct V_1 ) , V_118 ) ;
if ( ! V_1 )
return - V_119 ;
V_1 -> V_14 = V_110 ;
V_1 -> V_6 = V_6 ;
V_114 = F_51 ( V_6 -> V_120 , NULL ) ;
if ( ! V_114 ) {
F_5 ( V_6 , L_14 ) ;
return - V_63 ;
}
...
F_54 ( V_114 ) ;
if ( V_1 -> V_121 . V_122 != V_123 ) {
F_5 ( V_6 , L_16 ) ;
return - V_63 ;
}
V_1 -> V_27 = F_55 ( V_6 , L_17 ) ;
if ( F_56 ( V_1 -> V_27 ) ) {
F_5 ( V_6 , L_18 ) ;
return F_57 ( V_1 -> V_27 ) ;
}
V_4 = F_58 ( V_6 -> V_120 , L_19 , & V_117 ) ;
if ( V_4 ) {
F_5 ( V_6 , L_20 ) ;
return V_4 ;
}
...
V_4 = F_59 ( V_1 -> V_27 , V_117 ) ;
if ( V_4 ) {
F_5 ( V_6 , L_22 ) ;
return V_4 ;
}
V_1 -> V_5 = F_60 ( V_6 , L_23 ) ;
if ( F_56 ( V_1 -> V_5 ) ) {
F_5 ( V_6 , L_24 ) ;
return F_57 ( V_1 -> V_5 ) ;
}
...
V_1 -> V_28 = F_62 ( V_6 , L_32 , V_127 ) ;
if ( F_56 ( V_1 -> V_28 ) ) {
F_5 ( V_6 , L_33 ) ;
return F_57 ( V_1 -> V_28 ) ;
}
V_1 -> V_29 = F_62 ( V_6 , L_34 , V_127 ) ;
if ( F_56 ( V_1 -> V_29 ) ) {
F_5 ( V_6 , L_35 ) ;
return F_57 ( V_1 -> V_29 ) ;
}
F_63 ( & V_1 -> V_31 ) ;
F_64 ( & V_1 -> V_54 , 9 ) ;
F_65 ( & V_1 -> V_54 , & V_128 ,
...
F_24 ( V_130 ) - 1 ,
0 , 0 , V_130 ) ;
V_1 -> V_95 = F_65 ( & V_1 -> V_54 ,
& V_128 ,
V_131 ,
1 , V_132 , 1 , 1 ) ;
V_1 -> V_96 = F_68 ( & V_1 -> V_54 ,
& V_128 ,
V_133 ,
F_24 ( V_96 ) - 1 ,
0 , V_96 ) ;
if ( V_1 -> V_96 )
V_1 -> V_96 -> V_134 |= V_135 ;
V_1 -> V_3 . V_136 = & V_1 -> V_54 ;
if ( V_1 -> V_54 . error ) {
F_5 ( V_6 , L_36 ,
V_15 , V_1 -> V_54 . error ) ;
V_4 = V_1 -> V_54 . error ;
...
F_69 ( & V_1 -> V_3 , V_110 , & V_138 ) ;
V_1 -> V_3 . V_134 |= V_139 ;
V_1 -> V_81 . V_134 = V_140 ;
V_1 -> V_3 . V_6 = & V_110 -> V_6 ;
V_1 -> V_3 . V_141 . V_142 = V_143 ;
V_4 = F_70 ( & V_1 -> V_3 . V_141 , 1 , & V_1 -> V_81 ) ;
if ( V_4 < 0 ) {
F_5 ( V_6 , L_37 ) ;
goto V_137;
}
...
V_4 = F_10 ( V_1 , V_145 , & V_115 ) ;
if ( V_4 < 0 || V_115 != V_146 ) {
F_5 ( V_6 , L_39 ) ;
V_4 = - V_147 ;
goto V_148;
}
V_4 = F_10 ( V_1 , V_149 , & V_116 ) ;
if ( V_4 < 0 || V_116 != V_150 ) {
F_5 ( V_6 , L_40 ) ;
V_4 = - V_147 ;
goto V_148;
}
F_71 ( V_6 , L_41 , V_110 -> V_151 ) ;
V_4 = F_10 ( V_1 , V_20 ,
& V_1 -> V_17 ) ;
if ( V_4 < 0 ) {
F_5 ( V_6 , L_42 ) ;
...
static int F_76 ( struct V_14 * V_110 )
{
struct V_2 * V_3 = F_77 ( V_110 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
F_78 ( & V_1 -> V_3 ) ;
F_73 ( & V_1 -> V_3 . V_141 ) ;
F_74 ( & V_1 -> V_54 ) ;
