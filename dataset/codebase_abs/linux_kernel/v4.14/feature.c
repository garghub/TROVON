...
const T_1 * V_332 = F_56 ( V_9 , L_45 , NULL ) ;
if ( * V_332 == 0x00000025 )
type = V_119 ;
if ( * V_332 == 0x0000003e )
type = V_120 ;
...
V_6 [ V_4 ] . V_22 = V_333 [ type ] ;
V_329 = F_56 ( V_9 , L_46 , NULL ) ;
if ( V_329 )
V_6 [ V_4 ] . V_241 = * V_329 ;
F_67 ( V_315 L_47 ,
V_333 [ type ] , V_6 [ V_4 ] . V_241 , V_6 [ V_4 ] . V_72 ) ;
}
static int T_6
F_109 ( void )
{
...
int V_342 = V_343 ;
int V_344 = 0 ;
V_340 = F_56 ( V_153 , L_57 , & V_337 ) ;
V_341 = F_56 ( V_153 , L_58 , & V_337 ) ;
if ( V_341 && ( strcmp ( V_341 , L_59 ) == 0 ) )
V_342 = V_32 ;
else if ( F_79 ( V_153 , L_60 ) )
V_344 = 1 ;
else if ( V_340 && V_340 -> V_339 > 0 ) {
if ( strcmp ( V_340 -> V_22 , L_61 ) == 0 )
V_342 = V_32 ;
else if ( strcmp ( V_340 -> V_22 , L_62 ) == 0 )
V_344 = 1 ;
}
if ( V_344 )
F_111 ( V_345 , V_153 , 0 , 0 ) ;
F_111 ( V_346 , V_153 , V_342 , 0 ) ;
}
static void T_6
F_112 ( void )
{
...
void F_117 ( void (* F_118)( void * V_351 ) , void * V_351 )
{
if ( ! F_119 ( V_352 ) )
return;
F_120 () ;
...
void F_123 ( struct V_122 * V_355 ,
int (* F_124)( struct V_122 * V_355 ) ,
int (* F_125)( struct V_122 * V_355 ) )
{
if ( F_124 || F_125 ) {
V_356 = V_355 ;
V_357 = F_124 ;
...
void F_126 ( struct V_122 * V_359 )
{
if ( V_356 == NULL || V_357 == NULL )
return;
if ( V_356 -> V_360 != V_359 -> V_360 )
return;
V_357 ( V_356 ) ;
}
void F_127 ( struct V_122 * V_359 )
{
if ( V_356 == NULL || V_358 == NULL )
return;
if ( V_356 -> V_360 != V_359 -> V_360 )
return;
V_358 ( V_356 ) ;
