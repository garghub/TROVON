...
static struct V_7 * F_34 ( const char * V_1 , T_1 V_28 ,
struct V_7 * V_45 , void * V_16 ,
const struct V_30 * V_31 )
{
return F_23 ( V_1 , V_28 , V_45 , V_16 , NULL , V_31 , NULL ) ;
}
static struct V_7 * F_35 ( const char * V_1 , struct V_7 * V_45 )
{
return F_23 ( V_1 , V_55 | 0755 , V_45 , NULL , NULL , NULL ,
NULL ) ;
}
static struct V_7 * F_36 ( const char * V_1 ,
struct V_7 * V_45 ,
const char * V_2 ,
const struct V_32 * V_33 )
{
...
static void F_38 ( struct V_7 * V_7 )
{
struct V_8 * V_27 ;
if ( ! V_7 || F_28 ( V_7 ) )
return;
...
static struct V_60 * F_43 ( const char T_2 * V_61 ,
T_3 V_62 ,
T_3 V_63 ,
T_4 * V_64 )
{
...
return V_16 ;
V_16 -> V_66 = V_63 ;
if ( F_45 ( V_16 -> V_16 , V_61 , V_63 ) ) {
F_46 ( V_16 ) ;
return F_25 ( - V_67 ) ;
}
return V_16 ;
}
static T_5 F_47 ( T_6 V_68 , const char T_2 * V_69 , T_3 V_66 ,
...
T_5 error ;
V_73 = F_48 () ;
error = F_49 ( V_73 , V_71 , V_68 ) ;
if ( error )
return error ;
V_16 = F_43 ( V_69 , V_66 , V_66 , V_64 ) ;
error = F_29 ( V_16 ) ;
if ( ! F_28 ( V_16 ) ) {
...
int error = F_47 ( V_77 , V_69 , V_66 , V_64 , V_71 ) ;
F_55 ( V_71 ) ;
return error ;
}
...
struct V_70 * V_71 = F_54 ( V_75 -> V_76 -> V_39 ) ;
V_73 = F_48 () ;
error = F_49 ( V_73 , V_71 , V_79 ) ;
if ( error )
goto V_80;
V_16 = F_43 ( V_69 , V_66 + 1 , V_66 , V_64 ) ;
error = F_29 ( V_16 ) ;
if ( ! F_28 ( V_16 ) ) {
V_16 -> V_16 [ V_66 ] = 0 ;
...
if ( ! V_173 -> V_1 )
return - V_35 ;
V_27 = F_35 ( V_173 -> V_1 , F_144 ( V_71 ) ) ;
if ( F_28 ( V_27 ) )
return F_29 ( V_27 ) ;
V_173 -> V_177 [ V_179 ] = V_27 ;
V_56 = F_34 ( L_16 , V_48 | 0444 , V_27 , V_173 ,
& V_180 ) ;
if ( F_28 ( V_56 ) )
goto V_181;
V_173 -> V_177 [ V_182 ] = V_56 ;
V_56 = F_34 ( L_17 , V_48 | 0444 , V_27 , V_173 ,
& V_183 ) ;
if ( F_28 ( V_56 ) )
goto V_181;
V_173 -> V_177 [ V_184 ] = V_56 ;
if ( V_185 ) {
V_56 = F_34 ( L_18 , V_48 | 0444 , V_27 ,
V_173 , & V_186 ) ;
if ( F_28 ( V_56 ) )
goto V_181;
V_173 -> V_177 [ V_187 ] = V_56 ;
}
V_56 = F_34 ( L_19 , V_48 | 0444 ,
V_27 , V_173 , & V_188 ) ;
if ( F_28 ( V_56 ) )
goto V_181;
...
static struct V_7 * F_151 ( struct V_7 * V_27 , const char * V_1 ,
struct V_98 * V_99 ,
const struct V_30 * V_31 )
{
struct V_163 * V_164 = F_152 ( V_99 -> V_73 . V_164 ) ;
struct V_7 * V_56 ;
V_56 = F_34 ( V_1 , V_48 | 0444 , V_27 , V_164 , V_31 ) ;
if ( F_28 ( V_56 ) )
F_113 ( V_164 ) ;
return V_56 ;
}
static int F_153 ( struct V_98 * V_99 )
{
int V_194 = 0 ;
F_154 () ;
for ( V_194 = 0 ; V_99 ; V_99 = F_155 ( V_99 -> V_45 ) )
V_194 ++ ;
F_156 () ;
return V_194 ;
}
static int F_157 ( char * V_85 , T_3 V_195 , int V_194 ,
...
int F_158 ( struct V_98 * V_99 , struct V_7 * V_45 )
{
struct V_98 * V_192 ;
struct V_7 * V_56 = NULL , * V_27 ;
int error ;
F_16 ( ! V_99 ) ;
F_16 ( ! F_141 ( & F_150 ( V_99 ) -> V_88 ) ) ;
if ( ! V_45 ) {
struct V_98 * V_126 ;
V_126 = F_159 ( V_99 ) ;
V_56 = F_160 ( V_126 ) ;
...
V_56 = F_35 ( V_99 -> V_196 , V_45 ) ;
if ( F_28 ( V_56 ) )
goto V_181;
F_160 ( V_99 ) = V_27 = V_56 ;
V_56 = F_151 ( V_27 , L_24 , V_99 ,
& V_202 ) ;
if ( F_28 ( V_56 ) )
goto V_181;
V_99 -> V_177 [ V_203 ] = V_56 ;
V_56 = F_151 ( V_27 , L_25 , V_99 ,
& V_204 ) ;
if ( F_28 ( V_56 ) )
goto V_181;
V_99 -> V_177 [ V_205 ] = V_56 ;
V_56 = F_151 ( V_27 , L_26 , V_99 ,
& V_206 ) ;
if ( F_28 ( V_56 ) )
goto V_181;
V_99 -> V_177 [ V_207 ] = V_56 ;
if ( V_99 -> V_169 ) {
V_56 = F_151 ( V_27 , L_18 , V_99 ,
& V_208 ) ;
if ( F_28 ( V_56 ) )
goto V_181;
...
if ( V_99 -> V_173 ) {
char V_2 [ 64 ] ;
int V_194 = F_153 ( V_99 ) ;
error = F_157 ( V_2 , sizeof( V_2 ) , V_194 ,
V_99 -> V_173 -> V_1 , L_18 ) ;
if ( error < 0 )
goto V_201;
V_56 = F_36 ( L_27 , V_27 , V_2 , NULL ) ;
if ( F_28 ( V_56 ) )
goto V_181;
...
if ( error < 0 )
goto V_201;
V_56 = F_36 ( L_19 , V_27 , V_2 , NULL ) ;
if ( F_28 ( V_56 ) )
goto V_181;
V_99 -> V_177 [ V_212 ] = V_56 ;
}
F_148 (child, &profile->base.profiles, base.list) {
error = F_158 ( V_192 , F_161 ( V_99 ) ) ;
if ( error )
goto V_201;
}
return 0 ;
...
static int F_163 ( struct V_8 * V_27 , struct V_7 * V_7 , T_1 V_28 )
{
struct V_70 * V_71 , * V_45 ;
struct V_72 * V_73 ;
int error ;
V_73 = F_48 () ;
error = F_49 ( V_73 , NULL , V_77 ) ;
F_52 ( V_73 ) ;
if ( error )
return error ;
V_45 = F_54 ( V_27 -> V_39 ) ;
F_16 ( F_3 ( F_164 ( V_45 ) ) != V_27 ) ;
F_31 ( V_27 ) ;
error = F_24 ( & V_49 , & V_50 , & V_51 ) ;
F_61 ( & V_45 -> V_88 ) ;
F_165 ( V_27 , V_213 ) ;
...
if ( error )
goto V_214;
V_71 = F_166 ( V_45 , F_64 ( V_7 -> V_215 . V_1 ) ,
V_7 ) ;
if ( F_28 ( V_71 ) ) {
error = F_29 ( V_71 ) ;
V_71 = NULL ;
...
static int F_167 ( struct V_8 * V_27 , struct V_7 * V_7 )
{
struct V_70 * V_71 , * V_45 ;
struct V_72 * V_73 ;
int error ;
...
F_31 ( V_7 -> F_3 ) ;
F_61 ( & V_45 -> V_88 ) ;
V_71 = F_54 ( F_168 ( & V_45 -> V_216 , V_7 -> V_215 . V_1 ,
V_7 -> V_215 . V_4 ) ) ;
if ( ! V_71 ) {
error = - V_175 ;
goto V_80;
...
F_16 ( ! F_141 ( & V_71 -> V_88 ) ) ;
F_172 (ent, tmp, &ns->rawdata_list, list)
F_140 ( V_217 ) ;
}
void F_173 ( struct V_70 * V_71 )
{
struct V_70 * V_218 ;
struct V_98 * V_192 ;
int V_119 ;
...
if ( F_177 ( V_71 ) ) {
V_218 = F_3 ( F_177 ( V_71 ) ) -> V_39 ;
F_55 ( V_218 ) ;
}
for ( V_119 = V_219 - 1 ; V_119 >= 0 ; -- V_119 ) {
F_38 ( V_71 -> V_177 [ V_119 ] ) ;
V_71 -> V_177 [ V_119 ] = NULL ;
}
}
static int F_178 ( struct V_70 * V_71 , struct V_7 * V_27 )
{
struct V_7 * V_56 ;
F_16 ( ! V_71 ) ;
F_16 ( ! V_27 ) ;
...
return F_29 ( V_56 ) ;
F_144 ( V_71 ) = V_56 ;
V_56 = F_34 ( L_17 , 0444 , V_27 , V_71 ,
& V_220 ) ;
if ( F_28 ( V_56 ) )
return F_29 ( V_56 ) ;
F_54 ( V_71 ) ;
F_177 ( V_71 ) = V_56 ;
V_56 = F_34 ( L_29 , 0640 , V_27 , V_71 ,
& V_221 ) ;
if ( F_28 ( V_56 ) )
return F_29 ( V_56 ) ;
F_54 ( V_71 ) ;
F_174 ( V_71 ) = V_56 ;
V_56 = F_34 ( L_30 , 0640 , V_27 , V_71 ,
& V_222 ) ;
if ( F_28 ( V_56 ) )
return F_29 ( V_56 ) ;
F_54 ( V_71 ) ;
F_175 ( V_71 ) = V_56 ;
V_56 = F_34 ( L_31 , 0640 , V_27 , V_71 ,
& V_223 ) ;
if ( F_28 ( V_56 ) )
return F_29 ( V_56 ) ;
F_54 ( V_71 ) ;
...
int F_180 ( struct V_70 * V_71 , struct V_7 * V_45 , const char * V_1 ,
struct V_7 * V_56 )
{
struct V_70 * V_218 ;
struct V_98 * V_192 ;
...
F_22 ( V_56 ) ;
F_169 ( V_71 ) = V_27 = V_56 ;
error = F_178 ( V_71 , V_27 ) ;
if ( error )
goto V_201;
F_148 (child, &ns->base.profiles, base.list) {
error = F_158 ( V_192 , F_179 ( V_71 ) ) ;
if ( error )
goto V_201;
}
F_148 (sub, &ns->sub_ns, base.list) {
F_61 ( & V_218 -> V_88 ) ;
error = F_180 ( V_218 , F_164 ( V_71 ) , NULL , NULL ) ;
F_62 ( & V_218 -> V_88 ) ;
if ( error )
goto V_201;
}
...
static struct V_70 * F_181 ( struct V_70 * V_225 , struct V_70 * V_71 )
{
struct V_70 * V_45 , * V_226 ;
F_16 ( ! V_225 ) ;
F_16 ( ! V_71 ) ;
F_16 ( V_71 != V_225 && ! F_141 ( & V_71 -> V_45 -> V_88 ) ) ;
if ( ! F_182 ( & V_71 -> V_216 ) ) {
V_226 = F_183 ( & V_71 -> V_216 , F_184 ( * V_71 ) , V_165 . V_178 ) ;
F_61 ( & V_226 -> V_88 ) ;
return V_226 ;
}
V_45 = V_71 -> V_45 ;
while ( V_71 != V_225 ) {
F_62 ( & V_71 -> V_88 ) ;
V_226 = F_185 ( V_71 , V_165 . V_178 ) ;
if ( ! F_186 ( V_226 , & V_45 -> V_216 , V_165 . V_178 ) ) {
F_61 ( & V_226 -> V_88 ) ;
return V_226 ;
}
V_71 = V_45 ;
...
static struct V_98 * F_187 ( struct V_70 * V_225 ,
struct V_70 * V_71 )
{
F_16 ( ! V_225 ) ;
F_16 ( V_71 && ! F_141 ( & V_71 -> V_88 ) ) ;
for (; V_71 ; V_71 = F_181 ( V_225 , V_71 ) ) {
if ( ! F_182 ( & V_71 -> V_165 . V_227 ) )
return F_183 ( & V_71 -> V_165 . V_227 ,
struct V_98 , V_165 . V_178 ) ;
}
return NULL ;
}
static struct V_98 * F_188 ( struct V_98 * V_126 )
{
struct V_98 * V_45 ;
struct V_70 * V_71 = V_126 -> V_71 ;
F_16 ( ! F_141 ( & F_150 ( V_126 ) -> V_88 ) ) ;
if ( ! F_182 ( & V_126 -> V_165 . V_227 ) )
return F_183 ( & V_126 -> V_165 . V_227 , F_184 ( * V_126 ) ,
V_165 . V_178 ) ;
V_45 = F_189 ( V_126 -> V_45 ,
F_141 ( & V_126 -> V_71 -> V_88 ) ) ;
while ( V_45 ) {
V_126 = F_185 ( V_126 , V_165 . V_178 ) ;
if ( ! F_186 ( V_126 , & V_45 -> V_165 . V_227 , V_165 . V_178 ) )
return V_126 ;
V_126 = V_45 ;
V_45 = F_189 ( V_45 -> V_45 ,
F_141 ( & V_45 -> V_71 -> V_88 ) ) ;
}
V_126 = F_185 ( V_126 , V_165 . V_178 ) ;
if ( ! F_186 ( V_126 , & V_71 -> V_165 . V_227 , V_165 . V_178 ) )
return V_126 ;
return NULL ;
}
static struct V_98 * F_190 ( struct V_70 * V_225 ,
struct V_98 * V_99 )
{
struct V_98 * V_226 = F_188 ( V_99 ) ;
if ( V_226 )
return V_226 ;
return F_187 ( V_225 , F_181 ( V_225 , V_99 -> V_71 ) ) ;
}
static void * F_191 ( struct V_5 * V_75 , T_4 * V_64 )
{
...
V_75 -> V_157 = V_225 ;
F_61 ( & V_225 -> V_88 ) ;
V_99 = F_187 ( V_225 , V_225 ) ;
for (; V_99 && V_228 > 0 ; V_228 -- )
V_99 = F_190 ( V_225 , V_99 ) ;
return V_99 ;
}
static void * F_192 ( struct V_5 * V_75 , void * V_126 , T_4 * V_64 )
{
struct V_98 * V_99 = V_126 ;
struct V_70 * V_71 = V_75 -> V_157 ;
( * V_64 ) ++ ;
return F_190 ( V_71 , V_99 ) ;
}
static void F_193 ( struct V_5 * V_75 , void * V_126 )
{
struct V_98 * V_99 = V_126 ;
...
static int F_194 ( struct V_5 * V_75 , void * V_126 )
{
struct V_98 * V_99 = (struct V_98 * ) V_126 ;
struct V_70 * V_225 = V_75 -> V_157 ;
F_195 ( V_75 , V_225 , & V_99 -> V_73 ,
V_229 | V_230 , V_57 ) ;
F_123 ( V_75 , '\n' ) ;
return 0 ;
}
static int F_196 ( struct V_8 * V_8 , struct V_74 * V_74 )
{
if ( ! F_136 ( NULL ) )
return - V_174 ;
return F_197 ( V_74 , & V_231 ) ;
}
static int F_198 ( struct V_8 * V_8 , struct V_74 * V_74 )
{
return F_199 ( V_8 , V_74 ) ;
}
static int T_9 F_200 ( struct V_155 * V_156 ,
struct V_7 * V_45 )
{
int error = 0 ;
V_156 -> V_7 = F_201 ( V_156 -> V_1 ,
V_48 | V_156 -> V_28 ,
V_45 , V_156 ,
V_156 -> V_232 ) ;
if ( F_28 ( V_156 -> V_7 ) ) {
error = F_29 ( V_156 -> V_7 ) ;
V_156 -> V_7 = NULL ;
}
return error ;
}
static int T_9 F_202 ( struct V_155 * V_233 ,
struct V_7 * V_45 )
{
struct V_155 * V_156 ;
struct V_7 * V_27 ;
int error ;
V_27 = F_203 ( V_233 -> V_1 , V_45 ) ;
if ( F_28 ( V_27 ) )
return F_29 ( V_27 ) ;
V_233 -> V_7 = V_27 ;
for ( V_156 = V_233 -> V_154 . V_19 ; V_156 && V_156 -> V_1 ; ++ V_156 ) {
if ( V_156 -> V_158 == V_234 )
error = F_202 ( V_156 , V_233 -> V_7 ) ;
else
error = F_200 ( V_156 , V_233 -> V_7 ) ;
if ( error )
goto V_235;
}
return 0 ;
...
static void T_9 F_205 ( struct V_155 * V_156 )
{
if ( ! V_156 -> V_7 )
return;
F_206 ( V_156 -> V_7 ) ;
...
static void T_9 F_204 ( struct V_155 * V_233 )
{
struct V_155 * V_156 ;
for ( V_156 = V_233 -> V_154 . V_19 ; V_156 && V_156 -> V_1 ; ++ V_156 ) {
if ( V_156 -> V_158 == V_234 )
...
static int F_208 ( struct V_7 * V_45 )
{
...
V_8 -> V_36 = V_8 -> V_37 = V_8 -> V_38 = F_18 ( V_8 ) ;
F_209 ( V_8 , V_242 | V_243 | V_244 ,
F_210 ( V_245 , 3 ) ) ;
F_21 ( V_7 , V_8 ) ;
V_246 . V_7 = F_22 ( V_7 ) ;
V_246 . V_247 = F_211 ( V_237 ) ;
error = 0 ;
V_241:
F_32 ( V_7 ) ;
V_80:
...
static const char * F_212 ( struct V_7 * V_7 ,
struct V_8 * V_8 ,
struct V_248 * V_249 )
{
struct V_70 * V_71 ;
...
return F_25 ( - V_251 ) ;
V_71 = F_68 () ;
V_250 . V_247 = F_211 ( V_50 ) ;
V_250 . V_7 = F_22 ( F_169 ( V_71 ) ) ;
F_213 ( & V_250 ) ;
F_55 ( V_71 ) ;
return NULL ;
}
static int F_214 ( char * V_69 , T_3 V_66 , struct V_70 * V_71 ,
struct V_8 * V_8 )
{
...
static int F_215 ( struct V_7 * V_7 , char T_2 * V_85 ,
int V_253 )
{
struct V_70 * V_71 ;
char V_1 [ 32 ] ;
int V_252 ;
V_71 = F_68 () ;
V_252 = F_214 ( V_1 , sizeof( V_1 ) , V_71 , F_3 ( V_7 ) ) ;
if ( V_252 >= 0 )
V_252 = F_216 ( V_85 , V_253 , V_1 ) ;
F_55 ( V_71 ) ;
return V_252 ;
}
...
error = F_202 ( & V_155 , NULL ) ;
if ( error )
goto error;
V_56 = F_201 ( L_29 , 0666 , V_155 . V_7 ,
NULL , & V_221 ) ;
if ( F_28 ( V_56 ) ) {
error = F_29 ( V_56 ) ;
goto error;
...
F_174 ( V_259 ) = V_56 ;
V_56 = F_201 ( L_30 , 0666 , V_155 . V_7 ,
NULL , & V_222 ) ;
if ( F_28 ( V_56 ) ) {
error = F_29 ( V_56 ) ;
goto error;
...
F_175 ( V_259 ) = V_56 ;
V_56 = F_201 ( L_31 , 0666 , V_155 . V_7 ,
NULL , & V_223 ) ;
if ( F_28 ( V_56 ) ) {
error = F_29 ( V_56 ) ;
goto error;
...
F_176 ( V_259 ) = V_56 ;
V_56 = F_201 ( L_17 , 0444 , V_155 . V_7 ,
NULL , & V_220 ) ;
if ( F_28 ( V_56 ) ) {
error = F_29 ( V_56 ) ;
goto error;
...
F_177 ( V_259 ) = V_56 ;
F_61 ( & V_259 -> V_88 ) ;
error = F_180 ( V_259 , V_50 -> V_260 , L_35 ,
V_50 -> V_260 ) ;
F_62 ( & V_259 -> V_88 ) ;
if ( error )
goto error;
V_56 = F_221 ( L_36 , V_155 . V_7 ,
NULL , & V_261 ) ;
if ( F_28 ( V_56 ) ) {
error = F_29 ( V_56 ) ;
goto error;
}
error = F_208 ( V_155 . V_7 ) ;
if ( error )
goto error;
F_222 ( L_37 ) ;
return 0 ;
