...
T_1 * V_349 , struct V_50 * V_51 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_350 * V_21 ;
struct V_351 * V_63 ;
int V_32 ;
V_63 = F_1 ( V_2 , V_352 , sizeof( * V_63 ) ) ;
V_63 -> V_59 = V_51 -> V_220 . V_221 ;
V_63 -> V_353 = V_51 -> V_354 ? 1 : 0 ;
F_4 ( V_2 , & V_5 -> V_10 , V_66 ,
sizeof( struct V_34 ) ) ;
V_21 = & V_5 -> V_14 -> V_355 ;
V_32 = F_7 ( V_2 , & V_21 -> V_23 . V_24 , sizeof( * V_21 ) ) ;
if ( V_32 )
...
int
F_61 ( struct V_1 * V_2 ,
T_1 V_357 , T_1 V_358 , struct V_50 * V_51 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_359 * V_63 ;
struct V_62 * V_21 ;
int V_32 ;
V_63 = F_1 ( V_2 , V_360 , sizeof( * V_63 ) ) ;
V_63 -> V_357 = V_357 ;
V_63 -> V_358 = V_358 ;
V_63 -> V_59 = V_51 -> V_220 . V_221 ;
F_3 ( V_2 ,
...
goto exit;
if ( V_357 )
V_2 -> V_69 -> V_361 = V_357 ;
if ( V_358 )
V_2 -> V_69 -> V_362 = V_358 ;
exit:
F_5 ( V_2 , V_32 ) ;
return V_32 ;
}
T_1 F_62 ( struct V_1 * V_2 , T_1 V_363 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
if ( ! V_5 ) {
F_15 ( V_2 , L_28 ) ;
...
return V_5 -> V_54 . V_124 . V_364 [ V_363 ] . V_365 ;
}
void F_63 ( struct V_1 * V_2 ,
T_1 V_363 , struct V_256 * V_257 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
if ( ! V_5 ) {
F_15 ( V_2 , L_28 ) ;
...
V_5 -> V_258 [ V_363 ] = V_257 ;
}
int F_64 ( struct V_1 * V_2 , V_11 * V_367 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_74 V_368 ;
T_2 V_369 , V_370 ;
V_370 = sizeof( V_5 -> V_72 . V_73 -> V_369 ) ;
* V_367 = 0 ;
memcpy ( & V_368 , V_5 -> V_72 . V_73 , V_5 -> V_72 . V_64 ) ;
if ( V_368 . V_371 == V_5 -> V_372 . V_371 )
return 0 ;
V_369 = F_65 ( 0 , ( V_11 * ) & V_368 + V_370 ,
V_5 -> V_72 . V_64 - V_370 ) ;
if ( V_369 != V_368 . V_369 )
return - V_67 ;
memcpy ( & V_5 -> V_372 , & V_368 , V_5 -> V_72 . V_64 ) ;
F_3 ( V_2 , V_9 ,
L_30 , V_368 . V_371 ) ;
* V_367 = 1 ;
return 0 ;
...
V_285 -> V_375 . V_376 = V_374 -> V_377 ;
V_285 -> V_375 . V_378 = V_374 -> V_379 ;
V_285 -> V_375 . V_380 = V_374 -> V_381 ;
V_285 -> V_382 . V_376 = V_374 -> V_383 ;
V_285 -> V_382 . V_384 = V_374 -> V_385 ;
V_285 -> V_382 . V_386 = V_374 -> V_387 ;
V_285 -> V_388 = V_374 -> V_389 ;
}
...
V_392 -> V_393 = V_374 -> V_393 ;
V_392 -> V_375 = V_374 -> V_375 ;
V_392 -> V_394 = V_374 -> V_394 ;
V_392 -> V_395 = V_374 -> V_376 ;
V_392 -> V_396 = V_374 -> V_397 ;
V_392 -> V_398 = V_374 -> V_398 ;
V_392 -> V_399 = V_374 -> V_399 ;
V_392 -> V_400 = V_374 -> V_400 ;
V_392 -> V_401 = V_374 -> V_401 ;
V_392 -> V_402 = V_374 -> V_402 ;
V_392 -> V_403 = V_374 -> V_403 ;
V_392 -> V_404 = V_374 -> V_404 ;
}
...
void F_72 ( struct V_1 * V_2 , V_11 * V_79 )
{
* V_79 = V_2 -> V_6 -> V_54 . V_124 . V_79 ;
}
void F_73 ( struct V_1 * V_2 , V_11 * V_80 )
{
* V_80 = V_2 -> V_6 -> V_54 . V_124 . V_80 ;
}
void F_74 ( struct V_1 * V_2 , V_11 * V_85 )
{
* V_85 = V_2 -> V_6 -> V_54 . V_124 . V_85 ;
}
void F_75 ( struct V_1 * V_2 , V_11 * V_410 )
{
memcpy ( V_410 ,
V_2 -> V_6 -> V_54 . V_55 . V_410 , V_346 ) ;
}
void F_76 ( struct V_1 * V_2 , V_11 * V_83 )
{
struct V_4 * V_411 ;
V_411 = V_2 -> V_6 ;
* V_83 = V_411 -> V_54 . V_124 . V_83 ;
}
void F_77 ( struct V_1 * V_2 , V_11 * V_82 )
{
struct V_4 * V_411 = V_2 -> V_6 ;
* V_82 = V_411 -> V_54 . V_124 . V_82 ;
}
bool F_78 ( struct V_1 * V_2 , V_11 * V_341 )
{
struct V_74 * V_72 ;
V_72 = & V_2 -> V_6 -> V_372 ;
if ( ! ( V_72 -> V_412 & ( 1 << V_413 ) ) )
return true ;
if ( F_79 ( V_72 -> V_341 , V_341 ) )
return false ;
return false ;
}
static bool F_80 ( struct V_1 * V_414 ,
V_11 * V_415 , V_11 * V_416 )
{
struct V_74 * V_72 ;
V_72 = & V_414 -> V_6 -> V_372 ;
if ( V_72 -> V_412 & ( 1 << V_413 ) ) {
if ( V_416 )
* V_416 = 1 ;
} else if ( V_72 -> V_412 & ( 1 << V_417 ) ) {
if ( V_416 )
* V_416 = 0 ;
} else {
return false ;
}
F_81 ( V_415 , V_72 -> V_341 ) ;
return true ;
}
static void
F_82 ( struct V_1 * V_2 ,
...
{
struct V_87 * V_422 ;
V_422 = & V_2 -> V_6 -> V_54 . V_55 ;
* V_102 = V_422 -> V_102 ;
* V_104 = V_422 -> V_104 ;
* V_420 = V_422 -> V_420 ;
* V_421 = V_422 -> V_421 ;
}
static void F_84 ( struct V_1 * V_414 )
{
struct V_423 * V_424 = V_414 -> V_69 -> V_425 . V_426 ;
V_11 V_341 [ V_346 ] , V_427 , V_428 ;
void * V_429 = V_414 -> V_69 -> V_430 ;
T_1 V_204 , V_202 ;
F_82 ( V_414 , & V_204 , & V_202 ) ;
V_427 = F_80 ( V_414 , V_341 ,
& V_428 ) ;
if ( V_427 && V_429 )
V_424 -> V_431 ( V_429 , V_341 , ! ! V_428 ) ;
V_424 -> V_432 ( V_429 , V_204 , V_202 ) ;
F_85 ( V_414 ) ;
}
void F_86 ( struct V_433 * V_434 )
{
struct V_1 * V_414 = F_87 ( V_434 , struct V_1 ,
V_435 . V_434 ) ;
V_11 V_436 = 0 ;
if ( F_88 ( V_437 , & V_414 -> V_438 ) )
return;
F_64 ( V_414 , & V_436 ) ;
if ( F_88 ( V_439 ,
& V_414 -> V_438 ) )
...
if ( V_436 )
F_84 ( V_414 ) ;
F_89 ( V_414 -> V_440 , & V_414 -> V_435 , V_441 ) ;
}
