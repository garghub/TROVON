...
static int F_54 ( struct V_66 * V_67 , const void * V_81 )
{
const struct V_82 * V_83 = V_81 ;
struct V_84 V_85 ;
T_1 V_86 , V_87 ;
if ( F_55 ( V_67 -> V_88 != F_56 ( V_83 -> V_89 . V_90 ) ) )
goto V_91;
V_67 -> V_92 = F_56 ( V_83 -> V_89 . V_93 ) ;
V_67 -> V_71 . V_72 = F_57 ( V_83 -> V_94 ) ;
V_67 -> V_71 . V_95 = 0 ;
switch ( V_67 -> V_71 . V_72 & V_96 ) {
case V_97 :
case V_98 :
V_67 -> V_71 . V_95 = F_58 ( F_57 ( V_83 -> V_99 ) ,
F_57 ( V_83 -> V_100 ) ) ;
break;
} ;
F_59 ( & V_67 -> V_71 , F_57 ( V_83 -> V_101 ) ) ;
F_60 ( & V_67 -> V_71 , F_57 ( V_83 -> V_102 ) ) ;
F_61 ( & V_67 -> V_71 , F_57 ( V_83 -> V_103 ) ) ;
F_62 ( & V_67 -> V_71 , F_56 ( V_83 -> V_104 ) ) ;
F_63 ( & V_67 -> V_71 , F_56 ( V_83 -> V_105 ) ) ;
V_85 . V_106 = F_56 ( V_83 -> V_107 ) ;
V_85 . V_108 = F_57 ( V_83 -> V_109 ) ;
if ( F_64 ( & V_67 -> V_71 . V_110 , & V_85 ) < 0 )
V_67 -> V_71 . V_110 = V_85 ;
V_67 -> V_71 . V_111 . V_106 = F_56 ( V_83 -> V_112 ) ;
V_67 -> V_71 . V_111 . V_108 = F_57 ( V_83 -> V_113 ) ;
V_67 -> V_71 . V_114 . V_106 = F_56 ( V_83 -> V_115 ) ;
V_67 -> V_71 . V_114 . V_108 = F_57 ( V_83 -> V_116 ) ;
V_67 -> V_117 = F_56 ( V_83 -> V_118 ) ;
V_67 -> V_119 = F_56 ( V_83 -> V_120 ) ;
V_67 -> V_121 = F_57 ( V_83 -> V_122 ) ;
V_67 -> V_123 = F_56 ( V_83 -> V_124 ) ;
F_65 ( & V_67 -> V_71 ) ;
V_86 = F_66 ( V_83 -> V_125 ) ;
if ( F_55 ( V_86 > V_126 ) )
goto V_91;
V_67 -> V_127 = ( V_128 ) V_86 ;
V_87 = F_66 ( V_83 -> V_129 ) ;
if ( F_55 ( V_87 > V_130 ) )
goto V_91;
V_67 -> V_131 = ( V_128 ) V_87 ;
V_67 -> V_132 = F_57 ( V_83 -> V_133 ) ;
...
struct V_3 * V_135 ;
int error ;
error = F_70 ( V_67 , & V_135 ) ;
if ( error )
return error ;
error = F_54 ( V_67 , V_135 -> V_136 ) ;
F_71 ( V_135 ) ;
F_46 ( V_77 , & V_67 -> V_69 ) ;
return error ;
}
...
static void F_77 ( struct V_149 * V_150 , const struct V_1 * V_2 )
{
...
F_79 ( V_67 -> V_71 . V_72 ) , V_67 -> V_69 ,
( unsigned int ) V_67 -> V_121 ,
( unsigned long long ) F_80 ( & V_67 -> V_71 ) ) ;
}
...
struct V_16 * V_17 = V_2 -> V_5 . V_6 ;
if ( V_2 -> V_58 == V_151 &&
F_73 ( V_152 , & V_17 -> V_153 ) ) {
F_82 ( & V_17 -> V_154 , V_155 ) ;
error = F_83 ( V_17 -> V_156 ) ;
if ( error ) {
F_84 ( V_157 L_6 , error ) ;
F_32 ( V_17 , 0 ) ;
}
F_85 ( V_158 , & V_17 -> V_159 ) ;
F_20 ( V_17 , NULL , V_160 ) ;
}
}
static int F_86 ( struct V_1 * V_2 , struct V_137 * V_138 )
{
struct V_16 * V_17 = V_2 -> V_5 . V_6 ;
struct V_66 * V_67 = F_52 ( V_17 -> V_161 -> V_162 ) ;
struct V_1 * V_163 = V_67 -> V_164 ;
struct V_165 V_19 ;
int error ;
if ( F_73 ( V_152 , & V_17 -> V_153 ) ) {
...
struct V_66 * V_67 = V_2 -> V_55 ;
struct V_16 * V_17 = V_2 -> V_5 . V_6 ;
if ( ! V_174 || F_92 ( V_17 -> V_156 ) )
return;
if ( V_2 -> V_175 == V_176 &&
V_2 -> V_58 == V_151 && V_67 ) {
V_2 -> V_53 . V_177 ++ ;
if ( F_85 ( V_178 , & V_2 -> V_179 ) == 0 )
V_2 -> V_53 . V_177 -- ;
}
}
