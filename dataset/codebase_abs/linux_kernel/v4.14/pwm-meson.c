...
static void F_16 ( struct V_1 * V_17 ,
struct V_6 * V_7 ,
unsigned int V_18 )
{
...
V_33 = F_17 ( V_17 -> V_46 + V_47 ) ;
V_33 &= ~ ( V_30 << V_34 ) ;
V_33 |= V_7 -> V_21 << V_34 ;
V_33 |= V_35 ;
F_18 ( V_33 , V_17 -> V_46 + V_47 ) ;
V_33 = ( V_7 -> V_31 << V_48 ) | V_7 -> V_32 ;
F_18 ( V_33 , V_17 -> V_46 + V_37 ) ;
V_33 = F_17 ( V_17 -> V_46 + V_47 ) ;
V_33 |= V_36 ;
F_18 ( V_33 , V_17 -> V_46 + V_47 ) ;
}
static void F_19 ( struct V_1 * V_17 , unsigned int V_18 )
{
T_2 V_33 , V_36 ;
switch ( V_18 ) {
case 0 :
...
static void F_24 ( struct V_2 * V_3 , struct V_4 * V_5 ,
struct V_49 * V_16 )
{
struct V_1 * V_17 = F_1 ( V_3 ) ;
T_2 V_33 , V_57 ;
...
static int F_25 ( struct V_1 * V_17 ,
struct V_6 * V_58 )
{
...
snprintf ( V_65 , sizeof( V_65 ) , L_10 , V_60 , V_64 ) ;
V_63 . V_65 = V_65 ;
V_63 . V_14 = & V_67 ;
V_63 . V_50 = V_68 ;
V_63 . V_69 = V_17 -> V_70 -> V_69 ;
V_63 . V_71 = V_17 -> V_70 -> V_71 ;
V_7 -> V_72 . V_73 = V_17 -> V_46 + V_47 ;
V_7 -> V_72 . V_74 = V_75 [ V_64 ] ;
V_7 -> V_72 . V_57 = F_22 ( V_76 ) - 1 ;
V_7 -> V_72 . V_50 = 0 ;
V_7 -> V_72 . V_51 = & V_17 -> V_51 ;
V_7 -> V_72 . V_77 = NULL ;
V_7 -> V_72 . V_78 . V_63 = & V_63 ;
V_7 -> V_13 = F_26 ( V_9 , & V_7 -> V_72 . V_78 ) ;
if ( F_27 ( V_7 -> V_13 ) ) {
V_10 = F_28 ( V_7 -> V_13 ) ;
...
static void F_30 ( struct V_1 * V_17 ,
struct V_6 * V_58 )
{
unsigned int V_64 ;
for ( V_64 = 0 ; V_64 < V_17 -> V_3 . V_66 ; V_64 ++ )
F_31 ( & V_17 -> V_3 . V_80 [ V_64 ] , & V_58 [ V_64 ] ) ;
}
...
struct V_83 * V_84 ;
int V_10 ;
V_17 = F_33 ( & V_82 -> V_9 , sizeof( * V_17 ) , V_85 ) ;
if ( ! V_17 )
return - V_86 ;
V_84 = F_34 ( V_82 , V_87 , 0 ) ;
V_17 -> V_46 = F_35 ( & V_82 -> V_9 , V_84 ) ;
if ( F_27 ( V_17 -> V_46 ) )
return F_28 ( V_17 -> V_46 ) ;
F_36 ( & V_17 -> V_51 ) ;
V_17 -> V_3 . V_9 = & V_82 -> V_9 ;
V_17 -> V_3 . V_14 = & V_88 ;
V_17 -> V_3 . V_46 = - 1 ;
V_17 -> V_3 . V_66 = 2 ;
V_17 -> V_3 . V_89 = V_90 ;
V_17 -> V_3 . V_91 = 3 ;
V_17 -> V_70 = F_37 ( & V_82 -> V_9 ) ;
V_17 -> V_26 = F_22 ( V_17 -> V_3 . V_66 ) - 1 ;
V_58 = F_38 ( & V_82 -> V_9 , V_17 -> V_3 . V_66 , sizeof( * V_17 ) ,
V_85 ) ;
if ( ! V_58 )
return - V_86 ;
V_10 = F_25 ( V_17 , V_58 ) ;
...
{
struct V_1 * V_17 = F_42 ( V_82 ) ;
return F_43 ( & V_17 -> V_3 ) ;
}
