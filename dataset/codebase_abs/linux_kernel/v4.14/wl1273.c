...
V_51 -> V_56 . V_57 . V_58 [ 0 ] = V_55 -> V_9 ;
return 0 ;
}
...
struct V_52 * V_53 = F_8 ( V_49 ) ;
struct V_54 * V_55 = F_9 ( V_53 ) ;
if ( V_55 -> V_9 == V_51 -> V_56 . V_57 . V_58 [ 0 ] )
return 0 ;
if ( F_11 ( V_53 ) )
return - V_59 ;
if ( V_51 -> V_56 . V_57 . V_58 [ 0 ] >= F_12 ( V_60 ) )
return - V_22 ;
V_55 -> V_9 = V_51 -> V_56 . V_57 . V_58 [ 0 ] ;
return 1 ;
}
...
V_51 -> V_56 . V_57 . V_58 [ 0 ] = V_55 -> V_2 -> V_61 ;
return 0 ;
}
...
int V_62 , V_8 = 0 ;
F_2 ( V_53 -> V_6 , L_9 , V_39 ) ;
V_62 = V_51 -> V_56 . V_57 . V_58 [ 0 ] ;
if ( V_55 -> V_2 -> V_61 == V_62 )
return 0 ;
V_8 = V_55 -> V_2 -> V_63 ( V_55 -> V_2 , V_62 ) ;
if ( V_8 < 0 )
return V_8 ;
return 1 ;
}
...
struct V_54 * V_55 = F_9 ( V_53 ) ;
F_2 ( V_53 -> V_6 , L_9 , V_39 ) ;
V_51 -> V_56 . integer . V_56 [ 0 ] = V_55 -> V_2 -> V_64 ;
return 0 ;
}
...
struct V_68 * V_69 )
{
struct V_54 * V_55 = F_9 ( V_69 -> V_53 ) ;
...
int F_25 ( struct V_52 * V_53 , unsigned int * V_84 )
{
struct V_54 * V_55 ;
...
V_55 = F_27 ( sizeof( struct V_54 ) , V_91 ) ;
if ( ! V_55 )
return - V_92 ;
V_55 -> V_9 = V_70 ;
V_55 -> V_2 = * V_2 ;
