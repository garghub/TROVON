...
V_25 = F_22 ( & V_18 -> V_26 , V_5 , L_7 ) ;
if ( V_25 ) {
if ( V_25 == - V_29 )
V_25 = - V_10 ;
return V_25 ;
}
V_25 = F_22 ( & V_18 -> V_26 , V_6 , L_8 ) ;
if ( V_25 ) {
if ( V_25 == - V_29 )
V_25 = - V_10 ;
return V_25 ;
}
V_20 = F_23 ( & V_18 -> V_26 , sizeof( * V_20 ) , V_30 ) ;
if ( ! V_20 )
return - V_31 ;
V_24 = & V_20 -> V_24 ;
V_22 = & V_20 -> V_22 ;
...
V_24 -> V_37 = V_38 ;
if ( V_18 -> V_26 . V_27 )
F_24 ( V_24 -> V_39 , F_25 ( & V_18 -> V_26 ) , sizeof( V_24 -> V_39 ) ) ;
else
snprintf ( V_24 -> V_39 , sizeof( V_24 -> V_39 ) , L_9 , V_18 -> V_40 ) ;
V_24 -> V_41 = V_22 ;
V_24 -> V_42 = V_43 | V_44 ;
V_24 -> V_26 . V_45 = & V_18 -> V_26 ;
