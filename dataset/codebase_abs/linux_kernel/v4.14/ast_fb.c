...
V_35 -> V_67 = & V_68 ;
V_35 -> V_69 -> V_70 [ 0 ] . V_16 = F_28 ( V_49 -> V_71 , 0 ) ;
V_35 -> V_69 -> V_70 [ 0 ] . V_51 = F_29 ( V_49 -> V_71 , 0 ) ;
F_30 ( V_35 , V_57 -> V_32 [ 0 ] , V_57 -> V_17 -> V_72 ) ;
F_31 ( V_35 , & V_2 -> V_50 , V_55 -> V_73 , V_55 -> V_74 ) ;
V_35 -> V_75 = V_33 ;
V_35 -> V_76 = V_51 ;
V_35 -> V_77 . V_25 = V_78 ;
F_32 ( L_4 ,
...
{
struct V_80 * V_81 = V_49 -> V_82 ;
struct V_1 * V_2 ;
int V_19 ;
V_2 = F_41 ( sizeof( struct V_1 ) , V_83 ) ;
if ( ! V_2 )
return - V_63 ;
V_81 -> V_84 = V_2 ;
F_42 ( & V_2 -> V_26 ) ;
F_43 ( V_49 , & V_2 -> V_50 , & V_85 ) ;
V_19 = F_44 ( V_49 , & V_2 -> V_50 , 1 ) ;
if ( V_19 )
goto free;
V_19 = F_45 ( & V_2 -> V_50 ) ;
if ( V_19 )
...
void F_50 ( struct V_48 * V_49 , int V_87 )
{
struct V_80 * V_81 = V_49 -> V_82 ;
if ( ! V_81 -> V_84 )
return;
F_51 ( & V_81 -> V_84 -> V_50 , V_87 ) ;
}
void F_52 ( struct V_80 * V_81 , unsigned long V_88 )
{
V_81 -> V_84 -> V_50 . V_84 -> V_65 . V_89 =
V_81 -> V_84 -> V_50 . V_84 -> V_69 -> V_70 [ 0 ] . V_16 + V_88 ;
V_81 -> V_84 -> V_50 . V_84 -> V_65 . V_90 = V_81 -> V_91 - V_88 ;
}
