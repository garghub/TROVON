...
int V_48 ;
static const unsigned int V_120 [] = {
1 , 2 , 4 , 6
} ;
...
static int F_147 ( struct V_195 * V_2 )
{
struct V_320 * V_39 = F_142 ( V_2 ) ;
struct V_13 * V_14 = V_39 -> V_47 ;
int V_9 ;
...
static int F_153 ( struct V_326 * V_195 )
{
struct V_13 * V_14 = V_195 -> V_327 ;
return F_149 ( V_14 ) ;
}
static int F_154 ( struct V_320 * V_39 ,
struct V_5 * V_6 ,
int V_92 ,
int V_109 ,
unsigned int V_254 ,
...
struct V_13 * V_14 ;
int V_48 ;
static struct V_329 V_249 = {
. V_330 = F_153 ,
} ;
if ( ( V_48 = F_155 ( V_6 ) ) < 0 )
return V_48 ;
if ( ( V_14 = F_156 ( sizeof( * V_14 ) , V_21 ) ) == NULL ) {
F_152 ( V_6 ) ;
return - V_19 ;
}
V_14 -> V_92 = V_92 ;
V_14 -> V_109 = V_109 ;
F_157 ( & V_14 -> V_75 ) ;
F_157 ( & V_14 -> V_139 [ 0 ] . V_133 ) ;
F_157 ( & V_14 -> V_139 [ 1 ] . V_133 ) ;
V_14 -> V_39 = V_39 ;
V_14 -> V_6 = V_6 ;
V_14 -> V_68 = - 1 ;
...
F_94 ( V_14 -> V_6 , V_270 ,
V_14 -> V_287 & ~ ( V_331 | V_332 ) ) ;
if ( ( V_48 = F_158 ( V_6 , V_39 -> V_333 ) ) < 0 ) {
F_13 ( V_14 ) ;
F_152 ( V_6 ) ;
return V_48 ;
}
...
if ( ( V_48 = F_160 ( V_39 , V_337 , V_14 , & V_249 ) ) < 0 ) {
F_149 ( V_14 ) ;
return V_48 ;
}
F_161 ( V_6 ) ;
...
static int F_162 ( struct V_5 * V_6 , int V_109 )
{
const struct V_338 * V_339 ;
V_339 = F_163 ( V_6 , V_340 ) ;
if ( V_339 ) {
F_39 ( & V_6 -> V_2 , L_24 ,
F_164 ( V_339 ) ) ;
return V_339 -> V_229 ;
...
unsigned int V_9 ;
int V_48 ;
V_48 = F_166 ( & V_6 -> V_2 , V_227 , V_184 , V_347 , 0 , & V_39 ) ;
if ( V_48 < 0 )
return V_48 ;
V_346 = V_345 -> V_348 ;
switch ( V_346 ) {
case V_349 :
strcpy ( V_39 -> V_333 , L_29 ) ;
sprintf ( V_39 -> V_201 , L_30 , V_6 -> V_109 ) ;
V_92 = V_93 ;
break;
case V_350 :
V_92 = V_334 ;
...
if ( V_6 -> V_109 == V_351 [ V_9 ] . V_109 ) {
V_92 = V_351 [ V_9 ] . type ;
strcpy ( V_39 -> V_201 , V_351 [ V_9 ] . V_206 ) ;
break;
}
}
if ( V_92 != V_273 ) {
if ( V_352 == V_353 )
V_352 = F_162 ( V_6 , V_6 -> V_109 ) ;
if ( V_352 == V_354 )
V_92 = V_273 ;
else
V_92 = V_334 ;
...
if ( V_92 == V_273 )
strcpy ( V_39 -> V_333 , L_32 ) ;
else if ( V_6 -> V_109 >= V_355 )
strcpy ( V_39 -> V_333 , L_33 ) ;
else
strcpy ( V_39 -> V_333 , L_34 ) ;
break;
default:
F_7 ( V_39 -> V_2 , L_35 , V_346 ) ;
V_48 = - V_25 ;
goto V_356;
}
if ( ( V_48 = F_154 ( V_39 , V_6 , V_92 , V_6 -> V_109 ,
V_254 , & V_14 ) ) < 0 )
goto V_356;
V_39 -> V_47 = V_14 ;
if ( ( V_48 = F_102 ( V_14 , V_357 ) ) < 0 )
goto V_356;
if ( V_92 == V_93 ) {
if ( ( V_48 = F_85 ( V_14 ) ) < 0 ||
( V_48 = F_125 ( V_14 ) ) < 0 )
...
L_36 , V_39 -> V_201 ,
F_167 ( V_14 -> V_46 ) , V_14 -> V_197 , V_14 -> V_68 ) ;
F_132 ( V_14 ) ;
if ( ( V_48 = F_168 ( V_39 ) ) < 0 ) {
F_169 ( V_39 ) ;
return V_48 ;
}
F_170 ( V_6 , V_39 ) ;
