...
F_15 ,
V_2 , V_121 -> V_128 ) ;
V_2 -> V_87 -> V_129 = V_2 -> V_109 ;
V_2 -> V_87 -> V_130 |= V_131 ;
V_2 -> V_87 -> V_80 = V_45 ;
V_2 -> V_107 -> V_132 = V_47 | V_48 |
V_49 ;
V_2 -> V_107 -> V_133 = V_46 ;
V_2 -> V_107 -> V_134 = F_67 ( 0x200 ) ;
V_2 -> V_107 -> V_135 = F_67 ( V_119 -> V_124 . V_136 ) ;
V_2 -> V_107 -> V_137 = F_67 ( V_44 ) ;
F_68 ( V_2 -> V_84 , V_45 , F_10 ( V_45 , 0 ) ,
( void * ) V_2 -> V_107 , V_2 -> V_52 , V_44 ,
F_19 , V_2 ) ;
V_2 -> V_84 -> V_129 = V_2 -> V_108 ;
V_2 -> V_84 -> V_130 |= V_131 ;
V_2 -> V_84 -> V_80 = V_45 ;
F_69 ( V_45 , V_2 -> V_138 , sizeof( V_2 -> V_138 ) ) ;
F_70 ( V_2 -> V_138 , L_11 , sizeof( V_2 -> V_138 ) ) ;
V_38 -> V_105 = V_117 -> V_105 ;
V_38 -> V_138 = V_2 -> V_138 ;
F_71 ( V_45 , & V_38 -> V_114 ) ;
V_38 -> V_80 . V_139 = & V_79 -> V_80 ;
F_72 ( V_38 , V_2 ) ;
V_38 -> V_140 = F_20 ;
V_38 -> V_141 = F_22 ;
V_38 -> V_142 [ 0 ] = F_73 ( V_143 ) ;
for ( V_5 = 0 ; V_5 < 256 ; V_5 ++ ) {
int V_144 = F_4 ( V_5 ) ;
if ( V_144 >= 0 ) {
F_74 ( V_144 & 0xff , V_38 -> V_145 ) ;
if ( V_144 >> 8 )
F_74 ( V_144 >> 8 , V_38 -> V_145 ) ;
}
}
V_77 = F_75 ( V_2 -> V_39 ) ;
if ( V_77 )
