...
struct V_21 * V_22 ;
V_108 = F_85 ( V_2 -> V_82 , sizeof( * V_108 ) , V_74 ) ;
if ( ! V_108 )
return - V_110 ;
for ( V_15 = 0 ; V_15 < V_2 -> V_82 ; V_15 ++ ) {
V_22 = & V_2 -> V_83 [ V_15 ] ;
...
return - V_64 ;
V_66 = F_59 ( V_22 ) ;
if ( ! ( V_43 -> V_76 . V_68 & V_144 ) ) {
if ( V_142 . V_145 ) {
F_90 ( V_22 , V_142 . V_145 ) ;
V_142 . V_145 = F_91 ( V_22 , V_142 . V_145 ) ;
}
if ( F_92 ( V_22 ) == 0 &&
! F_60 ( V_66 ) &&
( V_142 . V_145 == 0 ||
...
F_93 ( V_22 , V_142 . V_147 ) ;
V_142 . V_147 =
F_94 ( V_22 , V_142 . V_147 ) ;
}
V_142 . V_145 = 0 ;
}
V_142 . V_148 = V_43 -> V_148 ;
V_142 . V_149 = V_43 -> V_149 ;
V_142 . V_150 = V_43 -> V_150 ;
V_142 . V_151 = V_43 -> V_151 ;
if ( V_143 )
F_68 ( V_2 , V_22 ) ;
if ( V_44 )
return V_44 ;
...
F_98 ( & V_189 ) ;
V_154 [ 0 ] = ( unsigned int ) V_189 . V_190 ;
V_154 [ 1 ] = V_189 . V_191 / V_192 ;
V_80 = 2 ;
break;
}
case V_193 :
...
V_80 = V_22 -> V_43 -> V_75 ( V_2 , V_22 , V_154 [ 0 ] ) ;
if ( V_80 >= 0 )
V_80 = 1 ;
break;
default:
...
switch ( V_153 -> V_153 ) {
case V_201 :
V_80 = V_22 -> V_202 ( V_2 , V_22 , V_153 , V_154 ) ;
if ( V_80 == - V_203 ) {
F_40 ( V_2 -> V_9 ,
L_18 ,
V_22 -> V_52 ) ;
...
if ( V_80 == 0 ) {
V_80 = V_22 -> V_205 ( V_2 , V_22 , V_153 , V_154 ) ;
if ( V_80 == - V_203 ) {
F_40 ( V_2 -> V_9 ,
L_20 ,
V_22 -> V_52 ) ;
...
unsigned int V_207 = V_154 [ 0 ] ;
unsigned int V_208 = 0 ;
if ( V_22 -> V_111 <= 32 ) {
V_208 = F_101 ( V_153 -> V_200 ) ;
if ( V_208 > 0 ) {
V_153 -> V_200 = 0 ;
V_154 [ 0 ] <<= V_208 ;
V_154 [ 1 ] <<= V_208 ;
...
if ( V_80 )
break;
V_80 = V_22 -> V_210 ( V_2 , V_22 , V_153 , V_154 ) ;
break;
default:
V_80 = - V_64 ;
break;
...
struct V_211 T_3 * V_85 , void * V_32 )
{
struct V_211 V_212 ;
struct V_152 * V_213 = NULL ;
unsigned int * V_154 = NULL ;
int V_15 = 0 ;
int V_80 = 0 ;
if ( F_77 ( & V_212 , V_85 , sizeof( V_212 ) ) )
return - V_88 ;
V_154 = F_103 ( V_214 , sizeof( unsigned int ) , V_74 ) ;
if ( ! V_154 ) {
V_80 = - V_110 ;
goto error;
}
...
if ( V_213 [ V_15 ] . V_155 > V_214 ) {
F_40 ( V_2 -> V_9 ,
L_22 ) ;
V_80 = - V_64 ;
goto error;
}
if ( V_213 [ V_15 ] . V_153 & V_216 ) {
if ( F_77 ( V_154 , V_213 [ V_15 ] . V_154 ,
V_213 [ V_15 ] . V_155 * sizeof( unsigned int ) ) ) {
F_40 ( V_2 -> V_9 ,
L_21 ) ;
V_80 = - V_88 ;
goto error;
...
V_80 = F_97 ( V_2 , V_213 + V_15 , V_154 , V_32 ) ;
if ( V_80 < 0 )
goto error;
if ( V_213 [ V_15 ] . V_153 & V_217 ) {
if ( F_81 ( V_213 [ V_15 ] . V_154 , V_154 ,
V_213 [ V_15 ] . V_155 * sizeof( unsigned int ) ) ) {
F_40 ( V_2 -> V_9 ,
L_23 ) ;
V_80 = - V_88 ;
...
struct V_218 T_3 * V_85 ,
struct V_218 * V_76 )
{
struct V_21 * V_22 ;
if ( F_77 ( V_76 , V_85 , sizeof( * V_76 ) ) ) {
F_40 ( V_2 -> V_9 , L_24 ) ;
return - V_88 ;
}
if ( V_76 -> V_137 >= V_2 -> V_82 ) {
F_40 ( V_2 -> V_9 , L_25 , V_76 -> V_137 ) ;
return - V_60 ;
}
V_22 = & V_2 -> V_83 [ V_76 -> V_137 ] ;
if ( V_22 -> type == V_197 ) {
F_40 ( V_2 -> V_9 , L_26 ,
V_76 -> V_137 ) ;
return - V_198 ;
}
if ( ! V_22 -> V_129 || ! V_22 -> V_219 || ! V_22 -> V_43 ) {
F_40 ( V_2 -> V_9 ,
L_27 ,
V_76 -> V_137 ) ;
return - V_198 ;
}
if ( V_76 -> V_220 > V_22 -> V_115 ) {
F_40 ( V_2 -> V_9 , L_28 ,
V_76 -> V_220 , V_22 -> V_115 ) ;
return - V_64 ;
}
...
if ( F_110 ( V_77 ) )
return F_111 ( V_77 ) ;
V_80 = F_100 ( V_22 , V_76 -> V_220 , V_77 ) ;
if ( V_80 < 0 ) {
F_10 ( V_77 ) ;
return V_80 ;
}
...
struct V_218 T_3 * V_85 , void * V_32 )
{
struct V_218 V_76 ;
struct V_21 * V_22 ;
struct V_42 * V_43 ;
...
V_43 -> V_76 = V_76 ;
V_43 -> V_76 . V_154 = NULL ;
V_80 = F_108 ( V_2 , V_22 , V_221 , & V_43 -> V_76 ) ;
if ( V_80 )
goto V_222;
V_80 = V_22 -> V_219 ( V_2 , V_22 , & V_43 -> V_76 ) ;
if ( V_43 -> V_76 . V_68 & V_223 || V_80 ) {
F_40 ( V_2 -> V_9 , L_32 , V_80 ) ;
V_76 = V_43 -> V_76 ;
V_76 . V_77 = ( unsigned int V_224 * ) V_221 ;
V_76 . V_154 = NULL ;
if ( F_81 ( V_85 , & V_76 , sizeof( V_76 ) ) ) {
F_40 ( V_2 -> V_9 , L_33 ) ;
V_80 = - V_88 ;
goto V_222;
}
...
V_22 = & V_2 -> V_83 [ V_76 . V_137 ] ;
if ( V_221 ) {
V_80 = F_108 ( V_2 , V_22 , V_221 , & V_76 ) ;
if ( V_80 )
return V_80 ;
}
V_80 = V_22 -> V_219 ( V_2 , V_22 , & V_76 ) ;
F_10 ( V_76 . V_77 ) ;
V_76 . V_77 = ( unsigned int V_224 * ) V_221 ;
if ( F_81 ( V_85 , & V_76 , sizeof( V_76 ) ) ) {
F_40 ( V_2 -> V_9 , L_24 ) ;
...
break;
case V_239 :
V_234 = F_82 ( V_2 , (struct V_99 T_3 * ) V_85 ,
V_32 ) ;
break;
case V_240 :
V_234 = F_84 ( V_2 ,
...
break;
case V_241 :
V_234 = F_87 ( V_2 , ( void T_3 * ) V_85 ) ;
break;
case V_242 :
V_234 = F_121 ( V_2 , ( void T_3 * ) V_85 ) ;
break;
case V_243 :
V_234 = F_89 ( V_2 ,
...
break;
case V_244 :
V_234 = F_114 ( V_2 , V_85 , V_32 ) ;
break;
case V_245 :
V_234 = F_115 ( V_2 , V_85 , V_32 ) ;
break;
case V_246 :
V_234 = F_116 ( V_2 , V_85 , V_32 ) ;
break;
case V_247 :
V_234 = F_112 ( V_2 , (struct V_218 T_3 * ) V_85 , V_32 ) ;
break;
case V_248 :
V_234 = F_113 ( V_2 , (struct V_218 T_3 * ) V_85 ,
V_32 ) ;
break;
case V_249 :
V_234 = F_102 ( V_2 ,
(struct V_211 T_3 * ) V_85 ,
V_32 ) ;
break;
case V_250 :
V_234 = F_106 ( V_2 , (struct V_152 T_3 * ) V_85 ,
V_32 ) ;
break;
case V_251 :
V_234 = F_117 ( V_2 , V_85 , V_32 ) ;
break;
case V_252 :
V_234 = F_118 ( V_2 , V_85 , V_32 ) ;
break;
case V_253 :
V_234 = F_119 ( V_2 , V_85 , V_32 ) ;
break;
default:
V_234 = - V_236 ;
break;
...
V_43 = V_22 -> V_43 ;
if ( V_22 -> V_47 != V_32 || ! ( V_43 -> V_76 . V_68 & V_144 ) ) {
V_44 = - V_64 ;
goto V_196;
}
...
F_145 ( V_298 ) ;
V_291 = V_43 -> V_149 ;
V_292 = F_149 ( V_155 , V_43 -> V_53 - V_291 ) ;
V_293 = V_155 - V_292 ;
...
F_145 ( V_298 ) ;
V_301 = V_43 -> V_151 ;
V_292 = F_149 ( V_155 , V_43 -> V_53 - V_301 ) ;
V_293 = V_155 - V_292 ;
...
if ( V_43 -> V_225 & V_308 ) {
F_159 ( & V_43 -> V_78 ) ;
V_309 = V_43 -> V_76 . V_68 & V_144 ? V_311 : V_312 ;
}
F_57 ( & V_22 -> V_69 , V_68 ) ;
if ( V_309 )
