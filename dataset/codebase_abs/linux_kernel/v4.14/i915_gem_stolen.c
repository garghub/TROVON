...
struct V_83 * V_85 ;
struct V_86 * V_87 ;
F_52 ( F_53 ( V_84 , V_5 , V_2 -> V_20 . V_40 ) ) ;
...
V_87 -> V_84 = 0 ;
V_87 -> V_91 = V_5 ;
F_58 ( V_87 ) = ( T_2 ) V_2 -> V_10 . V_55 + V_84 ;
F_59 ( V_87 ) = V_5 ;
return V_85 ;
}
static struct V_83 *
...
{
struct V_1 * V_2 = F_33 ( V_93 -> V_23 . V_49 ) ;
struct V_3 * V_11 = F_64 ( & V_93 -> V_11 ) ;
F_52 ( ! V_11 ) ;
F_65 ( V_93 ) ;
F_7 ( V_2 , V_11 ) ;
F_57 ( V_11 ) ;
...
if ( V_93 == NULL )
return NULL ;
F_68 ( & V_2 -> V_18 , & V_93 -> V_23 , V_11 -> V_5 ) ;
F_69 ( V_93 , & V_96 ) ;
V_93 -> V_11 = V_11 ;
V_93 -> V_23 . V_97 = V_98 | V_99 ;
V_95 = F_70 ( V_2 ) ? V_100 : V_101 ;
F_71 ( V_93 , V_95 ) ;
if ( F_72 ( V_93 ) )
goto V_102;
return V_93 ;
...
if ( V_9 )
goto V_111;
V_106 = F_80 ( V_93 , & V_20 -> V_23 , NULL ) ;
if ( F_81 ( V_106 ) ) {
V_9 = F_82 ( V_106 ) ;
goto V_112;
}
V_9 = F_83 ( & V_20 -> V_23 , & V_106 -> V_4 ,
V_5 , V_104 , V_93 -> V_95 ,
0 ) ;
if ( V_9 ) {
F_28 ( L_12 ) ;
...
V_106 -> V_113 |= V_114 ;
F_85 ( V_106 ) ;
F_86 ( & V_106 -> V_115 , & V_20 -> V_23 . V_116 ) ;
F_86 ( & V_93 -> V_117 , & V_2 -> V_10 . V_118 ) ;
V_93 -> V_119 ++ ;
return V_93 ;
V_112:
F_87 ( V_93 ) ;
