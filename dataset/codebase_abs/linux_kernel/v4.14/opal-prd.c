...
static int F_35 ( struct V_12 * V_12 , struct V_13 * V_13 )
{
struct V_51 V_42 ;
V_42 . V_2 = F_36 ( sizeof( V_42 ) ) ;
V_42 . type = V_54 ;
F_33 ( (struct F_33 * ) & V_42 ) ;
F_9 ( & V_14 , 0 ) ;
return 0 ;
}
static long F_37 ( struct V_13 * V_13 , unsigned int V_55 ,
unsigned long V_56 )
{
struct V_57 V_58 ;
struct V_59 V_60 ;
...
V_58 . V_62 = V_63 ;
V_19 = F_25 ( ( void T_6 * ) V_56 , & V_58 , sizeof( V_58 ) ) ;
if ( V_19 )
return - V_50 ;
break;
case V_64 :
V_19 = F_29 ( & V_60 , ( void T_6 * ) V_56 , sizeof( V_60 ) ) ;
if ( V_19 )
return - V_50 ;
V_60 . V_19 = F_38 ( V_60 . V_65 , V_60 . V_1 ,
( V_66 * ) & V_60 . V_67 ) ;
V_60 . V_67 = F_39 ( V_60 . V_67 ) ;
F_11 ( L_5 ,
V_60 . V_65 , V_60 . V_1 , V_60 . V_67 , V_60 . V_19 ) ;
V_19 = F_25 ( ( void T_6 * ) V_56 , & V_60 , sizeof( V_60 ) ) ;
if ( V_19 )
return - V_50 ;
break;
case V_68 :
...
if ( V_19 )
return - V_50 ;
V_60 . V_19 = F_40 ( V_60 . V_65 , V_60 . V_1 , V_60 . V_67 ) ;
F_11 ( L_6 ,
V_60 . V_65 , V_60 . V_1 , V_60 . V_67 , V_60 . V_19 ) ;
V_19 = F_25 ( ( void T_6 * ) V_56 , & V_60 , sizeof( V_60 ) ) ;
if ( V_19 )
...
V_52 = ( void * ) V_42 -> V_77 ;
V_74 = F_24 ( V_52 -> V_2 ) ;
V_75 = V_74 + sizeof( * V_40 ) - sizeof( V_40 -> V_42 ) ;
V_40 = F_42 ( V_75 , V_78 ) ;
if ( ! V_40 )
return - V_79 ;
memcpy ( & V_40 -> V_42 , V_42 -> V_77 , V_74 ) ;
F_15 ( & V_29 , V_27 ) ;
F_43 ( & V_40 -> V_44 , & V_30 ) ;
F_17 ( & V_29 , V_27 ) ;
F_44 ( & V_33 ) ;
