...
static T_2 F_22 ( char * V_55 , const int * V_56 , unsigned int V_57 ,
bool V_58 )
{
T_3 V_59 = 0 ;
int V_28 ;
...
static T_4 F_37 ( int V_81 , void * V_82 )
{
...
F_31 ( & V_2 -> V_69 ) ;
F_40 ( V_65 , V_2 -> V_88 , V_85 ) ;
V_23:
F_41 ( V_65 -> V_89 ) ;
return V_90 ;
}
static int F_42 ( struct V_91 * V_89 ,
bool V_20 )
{
struct V_64 * V_65 = F_43 ( V_89 ) ;
struct V_1 * V_2 = F_25 ( V_65 ) ;
return F_9 ( V_2 , V_20 ) ;
}
static int F_44 ( struct V_91 * V_89 )
{
struct V_64 * V_65 = F_43 ( V_89 ) ;
struct V_1 * V_2 = F_25 ( V_65 ) ;
return F_8 ( V_2 ) ;
}
static int F_45 ( struct V_92 * V_9 ,
...
V_2 -> V_9 = V_9 ;
if ( V_9 -> V_11 . V_98 )
V_96 = (enum V_95 ) F_48 ( & V_9 -> V_11 ) ;
else
V_96 = V_94 -> V_99 ;
V_2 -> V_17 = & V_100 [ V_96 ] ;
V_5 = V_2 -> V_17 -> V_101 ( V_2 ) ;
if ( V_5 < 0 )
goto V_102;
F_49 ( & V_2 -> V_69 ) ;
V_65 -> V_11 . V_103 = & V_9 -> V_11 ;
V_65 -> V_104 = V_2 -> V_17 -> V_104 ;
V_65 -> V_105 = V_2 -> V_17 -> V_105 ;
V_65 -> V_106 = V_94 -> V_106 ;
V_65 -> V_107 = V_108 ;
V_65 -> V_109 = & V_110 ;
if ( V_9 -> V_81 > 0 ) {
V_2 -> V_89 = F_50 ( L_15 , V_65 -> V_106 ,
V_65 -> V_94 ) ;
if ( ! V_2 -> V_89 ) {
V_5 = - V_97 ;
goto V_102;
}
V_5 = F_51 ( & V_9 -> V_11 , V_9 -> V_81 ,
V_111 , V_112 ,
L_16 , V_2 -> V_89 ) ;
if ( V_5 ) {
F_3 ( & V_9 -> V_11 , L_17 ) ;
...
V_2 -> V_89 -> V_11 . V_103 = & V_9 -> V_11 ;
V_2 -> V_89 -> V_114 = & V_115 ;
F_52 ( V_2 -> V_89 , V_65 ) ;
V_65 -> V_89 = F_53 ( V_2 -> V_89 ) ;
V_5 = F_54 ( V_2 -> V_89 ) ;
if ( V_5 )
goto V_113;
}
...
static int F_60 ( struct V_92 * V_9 )
{
struct V_64 * V_65 = F_61 ( V_9 ) ;
struct V_1 * V_2 = F_25 ( V_65 ) ;
F_62 ( V_65 ) ;
F_57 ( V_65 ) ;
if ( V_2 -> V_89 ) {
...
{
struct V_64 * V_65 = F_61 ( F_64 ( V_11 ) ) ;
struct V_1 * V_2 = F_25 ( V_65 ) ;
int V_5 ;
F_30 ( & V_2 -> V_69 ) ;
V_5 = F_10 ( V_2 , true ) ;
...
static int F_65 ( struct V_61 * V_11 )
{
struct V_64 * V_65 = F_61 ( F_64 ( V_11 ) ) ;
struct V_1 * V_2 = F_25 ( V_65 ) ;
int V_5 ;
