...
{
int V_76 ;
for ( V_76 = 1 ; V_76 < F_128 ( V_25 -> V_30 ) ; V_76 ++ )
if ( F_118 ( V_25 , V_76 ) )
F_126 ( V_25 , V_76 ) ;
F_96 ( V_25 -> V_218 ) ;
}
static int F_129 ( struct V_25 * V_25 )
{
unsigned int V_229 = F_128 ( V_25 -> V_30 ) ;
T_6 V_230 ;
T_1 V_79 , V_183 ;
int V_76 ;
int V_34 ;
...
static void F_130 ( struct V_23 * V_23 ,
enum V_232 V_233 )
{
if ( V_233 == V_234 ) {
F_131 ( V_23 -> V_59 , L_19 ) ;
F_132 ( V_23 -> V_59 ) ;
} else {
F_131 ( V_23 -> V_59 , L_20 ) ;
F_107 ( V_23 -> V_59 ) ;
}
}
...
static void F_135 ( const struct V_235 * V_236 ,
...
static void F_139 ( struct V_1 * V_2 , T_1 V_13 ,
void * V_238 )
{
struct V_25 * V_25 = V_238 ;
struct V_23 * V_23 = V_25 -> V_218 [ V_13 ] ;
...
V_61 -> V_74 += V_2 -> V_62 ;
F_55 ( & V_61 -> V_67 ) ;
V_2 -> V_239 = F_141 ( V_2 , V_2 -> V_59 ) ;
F_142 ( V_2 ) ;
}
static int F_143 ( struct V_240 * V_240 , T_1 V_13 ,
enum V_225 V_241 )
{
struct V_25 * V_25 = F_144 ( V_240 ) ;
T_1 V_79 , V_183 ;
int V_34 ;
if ( V_241 == V_242 )
return - V_106 ;
...
static int F_145 ( struct V_25 * V_25 )
{
char V_243 [ V_244 ] ;
int V_76 ;
int V_34 ;
...
if ( V_34 )
return V_34 ;
for ( V_76 = 0 ; V_76 < F_148 ( V_253 ) ; V_76 ++ ) {
V_34 = F_149 ( V_25 -> V_30 ,
& V_253 [ V_76 ] ,
V_25 ) ;
if ( V_34 )
goto V_254;
...
static void F_151 ( struct V_25 * V_25 )
{
int V_76 ;
for ( V_76 = 0 ; V_76 < F_148 ( V_253 ) ; V_76 ++ ) {
F_150 ( V_25 -> V_30 ,
...
static int F_152 ( struct V_25 * V_25 )
{
char V_255 [ V_256 ] ;
char V_257 [ V_258 ] ;
char * V_259 ;
...
static int F_156 ( struct V_240 * V_240 )
{
char V_243 [ V_244 ] ;
F_146 ( V_243 , V_272 ,
V_246 ,
...
static int F_158 ( struct V_240 * V_240 ,
...
static void F_159 ( struct V_240 * V_240 )
{
struct V_25 * V_25 = F_144 ( V_240 ) ;
F_151 ( V_25 ) ;
F_127 ( V_25 ) ;
