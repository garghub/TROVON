...
if ( ! V_15 -> V_139 )
return 0 ;
if ( V_18 -> V_128 + V_15 -> V_139 <= V_18 -> V_153 ) {
...
V_31 -> V_76 [ V_21 ] ^= V_183 ;
V_31 -> V_33 [ V_21 ] ^= V_184 ;
}
}
return V_52 ;
}
static int F_114 ( struct V_185 * V_27 , const char * V_186 )
{
struct V_28 * V_29 = F_82 ( V_27 ) ;
const char * V_187 = F_115 ( V_27 ) ;
V_29 -> V_178 = F_116 ( V_187 , 0 ,
V_188 ) ;
if ( F_117 ( V_29 -> V_178 ) ) {
F_43 ( L_17
L_18 , V_187 ) ;
...
static int F_122 ( struct V_185 * V_27 )
{
return F_114 ( V_27 , NULL ) ;
}
static int F_123 ( struct V_185 * V_27 )
{
return F_114 ( V_27 , L_20 ) ;
}
static int F_124 ( struct V_185 * V_27 )
{
return F_114 ( V_27 , L_21 ) ;
}
static int F_125 ( struct V_185 * V_27 )
{
return F_114 ( V_27 , L_22 ) ;
}
static int F_126 ( struct V_185 * V_27 )
{
return F_114 ( V_27 , L_23 ) ;
}
static int F_127 ( struct V_185 * V_27 )
{
return F_114 ( V_27 , L_24 ) ;
}
static int F_128 ( struct V_185 * V_27 )
{
return F_114 ( V_27 , L_25 ) ;
}
static void F_129 ( struct V_185 * V_27 )
{
struct V_28 * V_29 = F_82 ( V_27 ) ;
F_121 ( V_29 -> V_178 ) ;
V_29 -> V_178 = NULL ;
...
{
struct V_17 * V_140 = F_9 ( V_15 ) ;
const struct V_17 * V_189 = V_34 ;
memcpy ( V_140 , V_34 , sizeof( * V_140 ) + V_189 -> V_128 ) ;
return 0 ;
}
...
static T_4 F_136 ( int V_192 , void * V_193 )
{
...
static T_4 F_138 ( int V_192 , void * V_193 )
{
struct V_1 * V_2 = V_193 ;
...
struct V_195 * V_53 , struct V_196 * V_197 )
{
struct V_198 * V_199 = V_53 -> V_200 ;
const struct V_201 * V_202 ;
int V_52 = 0 ;
V_202 = F_140 ( F_141 ( V_203 ) , V_53 ) ;
if ( ! V_202 ) {
F_22 ( V_53 , L_28 ) ;
V_52 = - V_100 ;
goto V_52;
}
V_52 = F_142 ( V_199 , 0 , V_197 ) ;
if ( V_52 < 0 ) {
F_22 ( V_53 , L_29 ) ;
V_52 = - V_100 ;
goto V_52;
}
V_2 -> V_192 = F_143 ( V_199 , 0 ) ;
if ( ! V_2 -> V_192 ) {
F_22 ( V_53 , L_30 ) ;
V_52 = - V_100 ;
goto V_52;
}
V_2 -> V_22 = V_202 -> V_176 ;
V_52:
return V_52 ;
}
static int F_139 ( struct V_1 * V_2 ,
...
struct V_204 * V_205 , struct V_196 * V_197 )
{
struct V_195 * V_53 = & V_205 -> V_53 ;
struct V_196 * V_206 ;
int V_52 = 0 ;
V_206 = F_145 ( V_205 , V_207 , 0 ) ;
if ( ! V_206 ) {
F_22 ( V_53 , L_31 ) ;
V_52 = - V_208 ;
goto V_52;
}
memcpy ( V_197 , V_206 , sizeof( * V_197 ) ) ;
V_2 -> V_192 = F_146 ( V_205 , 0 ) ;
if ( V_2 -> V_192 < 0 ) {
F_22 ( V_53 , L_32 ) ;
V_52 = V_2 -> V_192 ;
goto V_52;
...
static int F_147 ( struct V_204 * V_205 )
{
struct V_1 * V_2 ;
struct V_195 * V_53 = & V_205 -> V_53 ;
struct V_196 V_197 ;
...
F_153 ( & V_2 -> V_170 , V_214 ) ;
V_52 = ( V_53 -> V_200 ) ? F_139 ( V_2 , V_53 , & V_197 ) :
F_144 ( V_2 , V_205 , & V_197 ) ;
if ( V_52 )
goto V_212;
V_2 -> V_4 = F_154 ( V_53 , & V_197 ) ;
if ( F_117 ( V_2 -> V_4 ) ) {
V_52 = F_118 ( V_2 -> V_4 ) ;
goto V_212;
}
V_2 -> V_113 = V_197 . V_215 ;
V_52 = F_155 ( V_53 , V_2 -> V_192 , V_2 -> V_22 -> V_216 ,
V_217 , F_156 ( V_53 ) , V_2 ) ;
if ( V_52 ) {
F_22 ( V_53 , L_34 ,
V_2 -> V_192 , V_52 ) ;
goto V_212;
...
V_211 = F_1 ( V_2 , F_164 ( V_2 ) ) ;
F_165 ( & V_205 -> V_53 ) ;
F_166 ( V_53 , L_37 ,
( V_211 & V_2 -> V_22 -> V_222 ) >> V_2 -> V_22 -> V_223 ,
( V_211 & V_2 -> V_22 -> V_224 ) >> V_2 -> V_22 -> V_225 ) ;
F_167 ( & V_149 . V_150 ) ;
F_168 ( & V_2 -> V_213 , & V_149 . V_226 ) ;
F_169 ( & V_149 . V_150 ) ;
for ( V_21 = 0 ; V_21 < V_2 -> V_22 -> V_227 ; V_21 ++ ) {
for ( V_210 = 0 ; V_210 < V_2 -> V_22 -> V_228 [ V_21 ] . V_229 ; V_210 ++ ) {
struct V_230 * V_231 ;
V_231 = & V_2 -> V_22 -> V_228 [ V_21 ] . V_232 [ V_210 ] ;
V_231 -> V_233 = F_130 ;
V_231 -> V_234 = F_131 ;
V_231 -> V_235 . V_236 = sizeof( struct V_17 ) +
V_154 ;
V_52 = F_170 ( V_231 ) ;
if ( V_52 )
goto V_237;
V_2 -> V_22 -> V_228 [ V_21 ] . V_238 ++ ;
}
}
return 0 ;
V_237:
for ( V_21 = V_2 -> V_22 -> V_227 - 1 ; V_21 >= 0 ; V_21 -- )
for ( V_210 = V_2 -> V_22 -> V_228 [ V_21 ] . V_238 - 1 ; V_210 >= 0 ; V_210 -- )
F_171 (
& V_2 -> V_22 -> V_228 [ V_21 ] . V_232 [ V_210 ] ) ;
V_221:
F_172 ( V_53 ) ;
if ( ! V_2 -> V_158 )
F_173 ( V_2 -> V_117 ) ;
...
static int F_174 ( struct V_204 * V_205 )
{
struct V_1 * V_2 ;
int V_21 , V_210 ;
V_2 = F_175 ( V_205 ) ;
...
static int F_178 ( struct V_195 * V_53 )
{
F_165 ( V_53 ) ;
return 0 ;
}
static int F_179 ( struct V_195 * V_53 )
{
int V_52 = F_21 ( V_53 ) ;
if ( V_52 < 0 ) {
F_22 ( V_53 , L_1 , V_52 ) ;
