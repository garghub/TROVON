...
if ( ! V_254 )
return - V_257 ;
V_4 = F_50 ( & V_252 -> V_16 , sizeof( struct V_1 ) , V_258 ) ;
if ( V_4 == NULL )
return - V_259 ;
V_4 -> V_16 = & V_252 -> V_16 ;
V_4 -> V_63 = V_254 -> V_260 ;
V_256 = F_51 ( V_252 , V_261 , 0 ) ;
V_4 -> V_5 = F_52 ( & V_252 -> V_16 , V_256 ) ;
if ( F_53 ( V_4 -> V_5 ) )
return F_54 ( V_4 -> V_5 ) ;
V_4 -> V_262 = V_256 -> V_263 ;
V_4 -> V_264 = F_55 ( V_256 ) ;
F_56 ( & V_4 -> V_141 ) ;
V_4 -> V_265 = V_266 ;
F_57 ( V_252 , V_4 ) ;
F_58 ( V_4 -> V_16 , L_1 ) ;
