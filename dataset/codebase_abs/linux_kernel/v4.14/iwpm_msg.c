...
int F_17 ( struct V_36 * V_3 , T_1 V_4 )
{
struct V_5 * V_6 = NULL ;
struct V_7 * V_8 = NULL ;
struct V_9 * V_10 ;
...
int F_19 ( struct V_36 * V_3 , T_1 V_4 )
{
struct V_5 * V_6 = NULL ;
struct V_7 * V_8 = NULL ;
struct V_9 * V_10 ;
...
int F_20 ( struct V_40 * V_51 , T_1 V_4 )
{
struct V_5 * V_6 = NULL ;
struct V_9 * V_10 ;
T_2 V_11 ;
...
int F_23 ( struct V_5 * V_6 , struct V_55 * V_56 )
{
struct V_7 * V_8 = NULL ;
...
V_3 = V_8 -> V_34 ;
V_4 = V_8 -> V_4 ;
V_27 = ( char * ) F_27 ( V_58 [ V_65 ] ) ;
V_60 = ( char * ) F_27 ( V_58 [ V_66 ] ) ;
V_61 = F_28 ( V_58 [ V_67 ] ) ;
...
int F_34 ( struct V_5 * V_6 , struct V_55 * V_56 )
{
struct V_36 * V_3 ;
struct V_7 * V_8 = NULL ;
...
int F_37 ( struct V_5 * V_6 , struct V_55 * V_56 )
{
struct V_57 * V_58 [ V_83 ] ;
struct V_40 * V_76 , * V_84 ;
struct V_40 * V_85 , * V_86 ;
...
V_95 = F_39 ( sizeof( struct V_94 ) , V_97 ) ;
if ( ! V_95 ) {
V_13 = - V_45 ;
return V_13 ;
}
...
int F_41 ( struct V_5 * V_6 , struct V_55 * V_56 )
{
...
V_60 = ( char * ) F_27 ( V_58 [ V_100 ] ) ;
V_61 = F_28 ( V_58 [ V_101 ] ) ;
if ( strcmp ( V_30 , V_60 ) ||
V_61 != V_68 ) {
F_14 ( L_34 ,
V_32 , V_60 , V_61 ) ;
...
V_106 , V_58 , V_62 ) )
return - V_14 ;
V_104 = F_25 ( V_58 [ V_107 ] ) ;
V_105 = F_25 ( V_58 [ V_108 ] ) ;
if ( V_105 != V_104 )
F_14 ( L_36 ,
V_32 , V_104 , V_105 ) ;
F_29 ( & V_21 , V_56 -> V_10 -> V_19 ) ;
...
int F_45 ( struct V_5 * V_6 , struct V_55 * V_56 )
{
struct V_7 * V_8 = NULL ;
int V_4 = F_38 ( V_56 -> V_10 -> V_96 ) ;
...
V_110 , V_58 , V_62 ) )
return - V_14 ;
V_11 = F_25 ( V_58 [ V_111 ] ) ;
V_69 = F_28 ( V_58 [ V_112 ] ) ;
F_14 ( L_38 ,
V_32 , V_11 , V_69 , V_4 ) ;
V_8 = F_26 ( V_11 ) ;
if ( ! V_8 ) {
