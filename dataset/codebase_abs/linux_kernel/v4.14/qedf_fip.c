...
V_61 = F_16 ( V_47 -> V_21 ) ;
V_63 = V_47 -> V_23 ;
F_24 ( V_4 , F_5 ( V_66 ) , V_2 -> V_55 ) ;
F_25 ( V_4 , & V_62 ) ;
F_11 ( & ( V_2 -> V_38 ) , V_67 , L_8
L_9 , V_60 -> V_15 , V_61 , V_63 ,
F_16 ( V_62 ) ) ;
if ( V_68 )
F_26 ( V_69 , L_10 , V_70 , 16 , 1 ,
V_4 -> V_11 , V_4 -> V_71 , false ) ;
V_42 -> V_43 -> V_44 ( V_2 -> V_45 , V_4 ) ;
}
...
V_61 = F_16 ( V_47 -> V_21 ) ;
V_63 = V_47 -> V_23 ;
F_11 ( & ( V_2 -> V_38 ) , V_67 , L_11
L_12 , V_4 , V_47 ,
V_60 -> V_13 , V_61 , V_63 ) ;
if ( V_68 )
F_26 ( V_69 , L_10 , V_70 , 16 , 1 ,
V_4 -> V_11 , V_4 -> V_71 , false ) ;
if ( V_61 == V_22 && V_63 == V_79 ) {
F_15 ( V_2 , V_4 ) ;
F_14 ( V_4 ) ;
} else if ( V_61 == V_80 && V_63 == V_81 ) {
F_11 ( & ( V_2 -> V_38 ) , V_39 , L_13
L_14 ) ;
if ( V_2 -> V_58 . V_82 == NULL ) {
F_11 ( & ( V_2 -> V_38 ) , V_39 ,
L_15
L_16 ) ;
return;
...
break;
case V_34 :
V_75 = (struct V_74 * ) V_26 ;
F_11 ( & ( V_2 -> V_38 ) , V_67 ,
L_18 ,
F_29 ( & V_75 -> V_36 ) ) ;
break;
case V_84 :
V_77 = (struct V_76 * ) V_26 ;
F_11 ( & ( V_2 -> V_38 ) , V_67 ,
L_19 , F_30 ( V_77 -> V_85 ) ) ;
if ( F_30 ( V_77 -> V_85 ) ==
V_2 -> V_35 -> V_86 )
