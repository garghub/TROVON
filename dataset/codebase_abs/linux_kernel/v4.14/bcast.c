...
static int F_29 ( struct V_2 * V_2 , struct V_21 * V_35 ,
struct V_41 * V_19 , T_1 * V_36 )
{
struct V_21 V_42 ;
struct V_43 * V_44 , * V_45 ;
T_2 V_46 , V_47 ;
V_47 = F_30 ( F_31 ( F_32 ( V_35 ) ) ) ;
F_20 ( & V_42 ) ;
F_33 (n, tmp, &dests->list, list) {
V_46 = V_44 -> V_48 ;
if ( ! F_34 ( V_46 , V_35 , & V_42 ) )
return - V_49 ;
if ( F_35 ( V_2 , & V_42 , V_46 , V_47 ) == - V_40 )
( * V_36 ) ++ ;
}
return 0 ;
}
int F_36 ( struct V_2 * V_2 , struct V_21 * V_35 ,
...
int F_39 ( struct V_2 * V_2 , struct V_37 * V_38 , struct V_23 * V_24 )
{
