...
V_10 = NULL ;
while ( ( V_10 =
F_42 ( V_57 -> V_61 , V_57 -> V_62 , V_57 -> V_63 ,
V_57 -> V_64 , V_10 ) ) != NULL ) {
...
int F_44 ( struct V_1 * V_2 , T_3 * V_67 )
{
struct V_42 * V_68 ;
T_3 V_69 , V_70 ;
* V_67 = 0 ;
...
F_46 ( L_4 , V_68 -> V_61 , V_68 -> V_62 , V_69 , V_70 ) ;
return 0 ;
}
int F_47 ( struct V_1 * V_2 , T_3 * V_84 )
{
struct V_42 * V_68 ;
T_3 V_69 ;
* V_84 = 0 ;
...
F_45 ( V_68 , V_74 , & V_69 ) ;
* V_84 = ( V_69 & V_85 ) >> 4 ;
F_46 ( L_5 , V_68 -> V_61 , V_68 -> V_62 , V_69 ) ;
return 0 ;
}
void F_27 ( struct V_1 * V_2 ) {}
int F_20 ( struct V_1 * V_2 , void * V_30 ,
...
void F_48 ( struct V_45 * V_46 , struct V_55 * V_56 )
{
struct V_1 * V_2 , * V_86 ;
F_19 ( L_3 ) ;
if ( ! ( V_46 -> V_59 & V_33 ) ) {
...
F_49 (dev, tmp, &driver->legacy_dev_list,
legacy_dev_list) {
F_50 ( & V_2 -> V_54 ) ;
F_51 ( V_2 ) ;
}
