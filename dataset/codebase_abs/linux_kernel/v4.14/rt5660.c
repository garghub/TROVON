...
static int F_39 ( struct V_117 * V_118 , struct V_1 * V_2 )
{
V_118 -> V_229 . V_231 = F_40 ( V_2 ,
L_13 ) ;
V_118 -> V_229 . V_232 = F_40 ( V_2 ,
L_14 ) ;
V_118 -> V_229 . V_230 = F_40 ( V_2 ,
L_15 ) ;
F_41 ( V_2 , L_16 ,
& V_118 -> V_229 . V_233 ) ;
return 0 ;
}
static int F_42 ( struct V_234 * V_235 ,
const struct V_236 * V_152 )
{
struct V_237 * V_229 = F_43 ( & V_235 -> V_2 ) ;
struct V_117 * V_118 ;
int V_199 ;
unsigned int V_128 ;
V_118 = F_44 ( & V_235 -> V_2 , sizeof( struct V_117 ) ,
V_238 ) ;
if ( V_118 == NULL )
return - V_239 ;
V_118 -> V_220 = F_45 ( & V_235 -> V_2 , L_17 ) ;
if ( F_46 ( V_118 -> V_220 ) == - V_240 )
return - V_240 ;
F_47 ( V_235 , V_118 ) ;
if ( V_229 )
V_118 -> V_229 = * V_229 ;
else if ( V_235 -> V_2 . V_241 )
F_39 ( V_118 , & V_235 -> V_2 ) ;
V_118 -> V_122 = F_48 ( V_235 , & V_242 ) ;
if ( F_26 ( V_118 -> V_122 ) ) {
V_199 = F_46 ( V_118 -> V_122 ) ;
F_9 ( & V_235 -> V_2 , L_18 ,
V_199 ) ;
return V_199 ;
}
F_49 ( V_118 -> V_122 , V_17 , & V_128 ) ;
if ( V_128 != V_243 ) {
F_9 ( & V_235 -> V_2 ,
L_19 , V_128 ) ;
return - V_244 ;
}
F_50 ( V_118 -> V_122 , V_10 , 0 ) ;
V_199 = F_51 ( V_118 -> V_122 , V_245 ,
F_2 ( V_245 ) ) ;
if ( V_199 != 0 )
F_52 ( & V_235 -> V_2 , L_20 , V_199 ) ;
F_53 ( V_118 -> V_122 , V_106 ,
V_246 | V_247 | V_248 ,
V_246 | V_247 | V_248 ) ;
if ( V_118 -> V_229 . V_233 ) {
F_53 ( V_118 -> V_122 , V_84 ,
V_249 , V_250 ) ;
if ( V_118 -> V_229 . V_233 == V_251 )
F_53 ( V_118 -> V_122 , V_53 ,
V_252 ,
V_253 ) ;
...
return F_54 ( & V_235 -> V_2 , & V_256 ,
V_257 , F_2 ( V_257 ) ) ;
}
static int F_55 ( struct V_234 * V_235 )
{
F_56 ( & V_235 -> V_2 ) ;
return 0 ;
}
