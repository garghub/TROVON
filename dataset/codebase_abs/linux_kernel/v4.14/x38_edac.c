...
V_11 -> V_69 = V_68 ;
V_11 -> V_70 = V_71 ;
V_11 -> V_72 = V_73 [ V_52 ] . V_72 ;
V_11 -> V_74 = F_27 ( V_2 ) ;
V_11 -> V_75 = F_14 ;
V_11 -> V_76 = NULL ;
V_11 -> V_17 = V_16 ;
V_47 = F_22 ( V_2 , V_38 ) ;
for ( V_40 = 0 ; V_40 < V_11 -> V_77 ; V_40 ++ ) {
unsigned long V_78 ;
struct V_79 * V_80 = V_11 -> V_81 [ V_40 ] ;
V_78 = F_23 ( V_38 , V_47 ,
V_40 / V_9 ,
V_40 % V_9 ) ;
if ( V_78 == 0 )
...
struct V_82 * V_83 = V_80 -> V_84 [ V_54 ] -> V_83 ;
V_83 -> V_78 = V_78 / V_5 ;
V_83 -> V_85 = V_78 << V_51 ;
V_83 -> V_86 = V_87 ;
V_83 -> V_88 = V_89 ;
...
static int F_31 ( struct V_1 * V_2 , const struct V_93 * V_94 )
{
int V_53 ;
F_3 ( 0 , L_10 ) ;
if ( F_32 ( V_2 ) < 0 )
return - V_95 ;
V_53 = F_24 ( V_2 , V_94 -> V_96 ) ;
if ( ! V_97 )
V_97 = F_33 ( V_2 ) ;
return V_53 ;
}
