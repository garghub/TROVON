...
F_34 ( V_37 , V_123 , V_92 -> V_124 ) ;
F_34 ( V_37 , V_125 , V_92 -> V_126 ) ;
F_34 ( V_37 , V_127 ,
V_92 -> V_128 ) ;
F_34 ( V_37 , V_129 , V_92 -> V_130 ) ;
F_34 ( V_37 , V_131 , V_92 -> V_132 ) ;
F_34 ( V_37 , V_133 ,
V_92 -> V_134 ) ;
F_34 ( V_37 , V_135 ,
V_92 -> V_136 ) ;
...
F_34 ( V_37 , V_159 , V_92 -> V_160 ) ;
F_34 ( V_37 , V_161 , V_92 -> V_162 ) ;
if ( V_106 )
F_34 ( V_37 , V_163 , V_105 ) ;
F_34 ( V_37 , V_164 , V_92 -> V_165 ) ;
F_47 ( V_37 ) ;
return 0 ;
}
...
static bool F_60 ( struct V_13 * V_37 , T_2 V_181 ,
T_3 V_69 , T_3 V_70 )
{
T_3 V_182 ;
bool V_93 = false ;
T_3 V_183 , V_184 ;
F_46 ( V_37 , V_69 , V_70 ) ;
V_182 = F_36 ( V_37 , V_164 ) ;
if ( V_182 ) {
V_183 = F_61 ( V_181 >> 8 ) ;
V_184 = F_62 ( V_181 >> 8 ) ;
if ( V_183 == F_36 ( V_37 , V_113 ) &&
V_184 == F_36 ( V_37 , V_115 ) )
V_93 = true ;
}
F_47 ( V_37 ) ;
return V_93 ;
...
static int F_64 ( struct V_13 * V_37 , void * V_99 , T_3 V_186 ,
unsigned int V_187 , T_3 V_69 ,
T_3 V_70 )
{
T_3 V_188 ;
F_46 ( V_37 , V_69 , V_70 ) ;
F_34 ( V_37 , V_151 , 0 ) ;
F_34 ( V_37 , V_189 , V_186 ) ;
while ( true ) {
V_188 = F_36 ( V_37 , V_164 ) ;
if ( V_188 & 0x1 )
break;
if ( V_187 == 0 ) {
F_65 ( L_6 ,
...
V_92 = F_56 ( V_99 ) ;
V_166 = F_53 ( V_92 ) ;
V_188 = F_36 ( V_37 , V_166 + V_179 ) ;
V_188 = V_188 & ~ V_185 ;
F_34 ( V_37 , V_166 + V_179 , V_188 ) ;
while ( true ) {
V_188 = F_36 ( V_37 , V_166 +
V_191 ) ;
if ( V_188 & V_192 )
break;
if ( V_187 == 0 )
...
F_34 ( V_37 , V_166 + V_177 , 0 ) ;
F_34 ( V_37 , V_166 + V_193 , 0 ) ;
F_34 ( V_37 , V_166 + V_194 , 0 ) ;
F_34 ( V_37 , V_166 + V_169 , 0 ) ;
return 0 ;
}
...
T_3 V_215 ;
F_43 ( & V_10 -> V_216 ) ;
F_34 ( V_37 , V_217 , V_213 ) ;
F_34 ( V_37 , V_218 , V_214 ) ;
V_215 = V_219 | V_220 |
V_221 ;
F_34 ( V_37 , V_217 , V_215 ) ;
F_45 ( & V_10 -> V_216 ) ;
return 0 ;
}
...
unsigned int V_222 )
{
return V_204 [ V_207 * V_205 + V_222 ]
/ 4 ;
}
...
{
struct V_9 * V_10 = (struct V_9 * ) V_37 ;
return F_76 ( V_225 , 1 << V_66 ) ;
}
static T_6 F_77 ( struct V_13 * V_37 , enum V_226 type )
{
struct V_9 * V_10 = (struct V_9 * ) V_37 ;
const union V_227 * V_228 ;
F_17 ( V_37 == NULL || V_10 -> V_229 == NULL ) ;
switch ( type ) {
case V_230 :
V_228 = ( const union V_227 * ) V_10 -> V_231 -> V_215 ;
break;
case V_232 :
V_228 = ( const union V_227 * ) V_10 -> V_233 -> V_215 ;
break;
case V_234 :
V_228 = ( const union V_227 * ) V_10 -> V_235 -> V_215 ;
break;
case V_236 :
V_228 = ( const union V_227 * ) V_10 -> V_229 -> V_215 ;
break;
case V_237 :
V_228 = ( const union V_227 * )
V_10 -> V_238 -> V_215 ;
break;
case V_239 :
V_228 = ( const union V_227 * ) V_10 -> V_240 -> V_215 ;
break;
case V_241 :
case V_242 :
V_228 = ( const union V_227 * )
