...
T_7 V_248 = 0 ;
memset ( V_247 , 0 , 512 ) ;
if ( strlen ( & V_241 -> V_249 [ 0 ] ) >= 512 ) {
F_10 ( L_103
L_104 ) ;
return - V_239 ;
}
snprintf ( V_247 , 512 , L_105 , V_250 , & V_241 -> V_249 [ 0 ] ) ;
...
V_234 = ( strlen ( V_3 ) + 1 ) ;
V_54 = F_84 ( V_242 , V_3 , V_234 , & V_248 ) ;
if ( V_54 < 0 )
F_12 ( L_107 , V_247 ) ;
F_85 ( V_242 ) ;
...
{
unsigned char * V_3 ;
int V_41 , V_237 = V_252 ;
if ( ! V_123 ) {
char * V_253 = L_108 ;
V_41 = F_80 ( V_14 , V_253 ) ;
V_14 -> V_32 . V_179 = 0 ;
F_12 ( L_109 ) ;
if ( V_41 )
return V_225 ;
...
static T_2
F_89 ( struct V_11 * V_12 , T_3 V_256 , T_3 V_121 ,
bool V_123 , bool V_122 , bool V_257 , enum V_180 V_180 )
{
struct V_16 * V_18 = V_12 -> V_18 ;
struct V_13 * V_14 = V_12 -> V_15 ;
...
if ( ( V_180 == REGISTER ) && ( V_256 != V_2 -> V_111 ) ) {
F_10 ( L_117
L_118
L_119
L_120 , V_256 ,
...
static T_2
F_91 ( struct V_11 * V_12 , int type , int V_264 , T_3 V_256 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_16 * V_18 = V_12 -> V_18 ;
struct V_49 * V_49 = V_12 -> V_49 ;
...
static T_2
F_92 ( struct V_11 * V_12 , int type , int V_264 ,
T_3 V_256 )
{
switch ( type ) {
case V_70 :
...
case V_9 :
case V_10 :
return F_91 ( V_12 , type , V_264 , V_256 ) ;
default:
F_10 ( L_148
L_149 , type ) ;
return V_261 ;
...
static T_2
F_95 ( struct V_11 * V_12 , int type , int V_264 ,
T_3 V_256 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_16 * V_18 = V_12 -> V_18 ;
...
static T_2
F_96 ( struct V_11 * V_12 , T_3 V_256 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_24 * V_112 ;
struct V_16 * V_18 = V_12 -> V_18 ;
...
static T_2
F_99 ( struct V_11 * V_12 , int type , int V_264 , T_3 V_256 ,
...
static T_2
F_101 ( struct V_11 * V_12 , int type , int V_264 ,
...
case V_9 :
case V_10 :
return F_99 ( V_12 , type , V_264 , V_256 ,
V_121 , V_274 ) ;
default:
F_10 ( L_166
...
static T_2
F_102 ( struct V_11 * V_12 , T_3 V_256 ,
...
V_3 = NULL ;
F_12 ( L_185
L_186 , V_282 -> V_48 () , ( V_221 != NULL ) ?
L_187 : L_188 , V_284 , ( V_221 != NULL ) ?
V_221 : L_29 ) ;
V_112 = V_2 -> V_112 ;
V_287 = ( ! strcmp ( V_284 ,
V_112 -> V_52 ) ) ? 1 : 0 ;
...
break;
case V_86 :
V_54 = F_92 ( V_12 , type , V_264 , V_256 ) ;
break;
case V_87 :
V_54 = F_95 ( V_12 , type , V_264 , V_256 ) ;
break;
case V_80 :
V_54 = F_96 ( V_12 , V_256 ) ;
break;
case V_81 :
V_54 = F_101 ( V_12 , type , V_264 ,
V_256 , V_121 , V_293 ) ;
break;
case V_82 :
V_54 = F_101 ( V_12 , type , V_264 ,
...
case V_84 :
V_54 = F_89 ( V_12 ,
0 , V_121 , V_123 , V_122 , V_257 , V_182 ) ;
break;
case V_85 :
V_54 = F_102 ( V_12 , V_256 ,
V_121 , V_123 , V_269 ) ;
break;
default:
F_10 ( L_14
...
if ( ! V_2 -> V_138 ) {
T_4 V_301 = V_2 -> V_136 ;
F_110 ( V_301 , & V_3 [ V_295 ] ) ;
V_295 += 2 ;
} else
V_295 += 2 ;
V_3 [ V_295 + 4 ] = V_42 -> V_232 ;
V_300 = F_113 ( V_267 , V_2 ,
& V_298 , & V_3 [ V_295 + 4 ] ) ;
F_7 ( & V_31 -> V_36 ) ;
F_54 ( & V_2 -> V_131 ) ;
if ( V_300 < 0 )
break;
F_106 ( V_300 , & V_3 [ V_295 ] ) ;
V_297 = ( 24 + V_300 ) ;
V_295 += V_300 ;
V_294 += V_297 ;
}
