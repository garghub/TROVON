...
F_38 ( V_2 -> V_41 [ V_10 ] ) ;
if ( V_2 -> V_39 [ V_10 ] ) {
F_39 ( & V_2 -> V_39 [ V_10 ] -> V_12 ) ;
F_40 ( & V_2 -> V_39 [ V_10 ] -> V_12 , NULL ) ;
F_41 ( & V_2 -> V_39 [ V_10 ] -> V_12 ) ;
}
}
F_42 ( V_2 -> V_29 ) ;
return V_9 ;
...
{
struct V_1 * V_2 = F_44 ( V_7 ) ;
T_1 V_42 ;
int V_10 ;
for ( V_10 = 0 ; V_10 < V_40 ; V_10 ++ )
if ( V_2 -> V_41 [ V_10 ] )
F_38 ( V_2 -> V_41 [ V_10 ] ) ;
V_42 = F_45 ( V_2 -> V_26 + F_46 ( V_2 ) ) ;
V_42 &= ~ V_43 ;
F_6 ( V_42 , V_2 -> V_26 + F_46 ( V_2 ) ) ;
F_42 ( V_2 -> V_29 ) ;
}
