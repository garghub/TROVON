...
V_26 = F_8 ( V_23 ) ;
V_28 = (struct V_27 * ) & ( ( ( char * ) V_26 ) [ V_26 -> V_46 * 4 ] ) ;
V_7 = V_67 = ( char * ) V_28 + ( V_28 -> V_47 << 2 ) ;
V_8 = F_9 ( V_23 ) ;
while ( V_7 <= V_8 - 6 ) {
...
& V_15 , & V_16 ) != 1 )
return 1 ;
F_10 ( 7 , L_5 , & V_68 . V_49 , F_11 ( V_14 ) ) ;
V_4 -> V_44 = NULL ;
F_10 ( 7 , L_6 ,
F_22 ( V_26 -> V_54 ) ,
& V_68 . V_49 , F_11 ( V_14 ) , & V_4 -> V_56 . V_49 , 0 ) ;
{
struct V_51 V_19 ;
F_12 ( V_4 -> V_52 , V_53 ,
V_26 -> V_54 , & V_68 , V_14 , & V_4 -> V_56 ,
F_23 ( F_11 ( V_4 -> V_60 ) - 1 ) , & V_19 ) ;
V_31 = F_24 ( & V_19 ) ;
if ( ! V_31 ) {
V_31 = F_14 ( & V_19 , V_53 , & V_4 -> V_70 ,
F_23 ( F_11 ( V_4 -> V_71 ) - 1 ) ,
V_6 , V_4 -> V_58 ,
V_23 -> V_59 ) ;
if ( ! V_31 )
return 0 ;
...
static int T_4 F_25 ( struct V_72 * V_72 )
{
int V_20 , V_34 ;
struct V_1 * V_2 ;
struct V_73 * V_52 = F_26 ( V_72 ) ;
if ( ! V_52 )
return - V_74 ;
V_2 = F_27 ( V_52 , & V_75 ) ;
if ( F_28 ( V_2 ) )
...
if ( ! V_77 [ V_20 ] )
continue;
V_34 = F_30 ( V_52 , V_2 , V_2 -> V_54 , V_77 [ V_20 ] ) ;
if ( V_34 )
goto V_78;
F_31 ( L_7 ,
V_2 -> V_79 , V_20 , V_77 [ V_20 ] ) ;
}
return 0 ;
V_78:
F_32 ( V_52 , & V_75 ) ;
...
static void F_33 ( struct V_72 * V_72 )
{
struct V_73 * V_52 = F_26 ( V_72 ) ;
if ( ! V_52 )
return;
