...
V_139 -> V_109 = F_69 ( V_139 -> V_109 , 65535U ) ;
}
V_139 -> V_184 = ( F_70 ( F_71 ( V_9 ) -> V_185 ) <<
V_139 -> V_69 . V_183 ) ;
...
T_3 V_204 = F_74 ( V_18 ) & ( V_205 | V_206 | V_207 ) ;
bool V_21 = false ;
bool V_208 ;
V_20 . V_22 = 0 ;
...
V_212 += F_69 ( V_152 << V_102 -> V_210 ,
V_214 ) ;
if ( ! V_202 )
F_76 ( & V_102 -> V_215 , V_212 ) ;
else
...
F_77 ( V_203 , V_9 ) ;
F_78 ( V_203 , V_102 ) ;
return F_79 ( V_52 , V_203 , V_102 , V_208 ) ;
V_227:
if ( ! V_228 ) {
F_39 ( V_102 ) -> V_223 = 1 ;
return NULL ;
...
int F_83 ( struct V_13 * V_231 , struct V_13 * V_203 ,
struct V_8 * V_9 )
{
int V_232 = 0 ;
