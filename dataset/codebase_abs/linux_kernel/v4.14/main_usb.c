...
int V_33 ;
for ( V_33 = 0 ; V_33 < V_2 -> V_6 ; V_33 ++ ) {
V_104 = F_26 ( sizeof( * V_104 ) , V_111 ) ;
if ( ! V_104 )
goto V_112;
V_2 -> V_104 [ V_33 ] = V_104 ;
V_104 -> V_2 = V_2 ;
V_104 -> V_113 = V_33 ;
V_104 -> V_105 = F_27 ( 0 , V_111 ) ;
if ( ! V_104 -> V_105 )
goto V_112;
V_104 -> V_114 = false ;
}
for ( V_33 = 0 ; V_33 < V_2 -> V_11 ; V_33 ++ ) {
V_2 -> V_107 [ V_33 ] = F_28 ( sizeof( * V_2 -> V_107 [ V_33 ] ) , V_111 ) ;
if ( ! V_2 -> V_107 [ V_33 ] ) {
F_29 ( & V_2 -> V_40 -> V_41 ,
L_9 , V_33 ) ;
goto V_115;
...
V_107 = V_2 -> V_107 [ V_33 ] ;
V_107 -> V_2 = V_2 ;
V_107 -> V_105 = F_27 ( 0 , V_111 ) ;
if ( ! V_107 -> V_105 )
goto V_115;
V_107 -> V_108 = F_30 ( V_2 -> V_116 ) ;
if ( ! V_107 -> V_108 )
goto V_115;
V_107 -> V_114 = false ;
if ( F_31 ( V_2 , V_107 ) )
...
V_2 -> V_117 = F_27 ( 0 , V_111 ) ;
if ( ! V_2 -> V_117 )
goto V_115;
V_2 -> V_109 . V_110 = F_26 ( V_118 , V_111 ) ;
if ( ! V_2 -> V_109 . V_110 ) {
F_20 ( V_2 -> V_117 ) ;
goto V_115;
}
...
static void F_32 ( struct V_119 * V_120 ,
struct V_121 * V_122 ,
struct V_123 * V_108 )
{
...
V_2 -> V_116 = V_124 ;
if ( ! F_25 ( V_2 ) ) {
F_3 ( & V_2 -> V_40 -> V_41 , L_10 ) ;
return - V_125 ;
}
F_36 ( V_126 , & V_2 -> V_127 ) ;
if ( F_2 ( V_2 ) == false ) {
...
static void F_40 ( struct V_119 * V_120 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
int V_130 ;
if ( ! V_2 )
...
F_41 ( V_2 , V_130 ) ;
V_2 -> V_132 = 0 ;
if ( ! F_42 ( V_133 , & V_2 -> V_127 ) )
F_43 ( V_2 ) ;
F_44 ( V_120 ) ;
F_45 ( V_126 , & V_2 -> V_127 ) ;
F_46 ( & V_2 -> V_134 ) ;
V_2 -> V_135 = false ;
F_18 ( V_2 ) ;
F_22 ( V_2 ) ;
...
static int F_47 ( struct V_119 * V_120 , struct V_136 * V_137 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
V_2 -> V_137 = V_137 ;
switch ( V_137 -> type ) {
...
static int F_51 ( struct V_119 * V_120 , T_2 V_152 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
struct V_153 * V_154 = & V_120 -> V_154 ;
if ( V_152 & V_155 ) {
if ( V_154 -> V_127 & V_156 )
F_52 ( V_2 , V_154 -> V_157 ) ;
else
F_53 ( V_2 ) ;
}
if ( ( V_152 & V_158 ) ||
( V_154 -> V_127 & V_159 ) ) {
F_54 ( V_2 , V_154 -> V_160 . V_161 -> V_162 ) ;
...
static void F_56 ( struct V_119 * V_120 ,
struct V_136 * V_137 ,
struct V_169 * V_154 , T_2 V_152 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
V_2 -> V_170 = V_154 -> V_171 ;
if ( V_152 & V_172 && V_154 -> V_173 )
F_57 ( V_2 , ( T_1 * ) V_154 -> V_173 ) ;
if ( V_152 & V_174 ) {
V_2 -> V_175 = V_154 -> V_175 ;
F_58 ( V_2 ) ;
F_48 ( V_2 ) ;
F_3 ( & V_2 -> V_40 -> V_41 , L_12 , V_154 -> V_175 ) ;
}
if ( V_152 & V_176 ) {
if ( V_154 -> V_177 ) {
F_59 ( V_2 ) ;
...
F_14 ( V_2 , V_150 ,
V_151 ) ;
F_67 ( V_2 , V_154 -> V_189 -> V_162 ,
V_154 -> V_190 , V_2 -> V_191 ) ;
F_68 ( V_2 , V_154 -> V_192 ) ;
...
static T_3 F_71 ( struct V_119 * V_120 ,
struct V_193 * V_194 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
struct V_195 * V_196 ;
...
T_2 V_198 = 0 ;
F_72 (ha, mc_list) {
V_198 = F_73 ( V_199 , V_196 -> V_200 ) >> 26 ;
...
static int F_76 ( struct V_119 * V_120 , enum V_214 V_215 ,
...
switch ( V_215 ) {
case V_220 :
if ( F_77 ( V_120 , V_217 , V_137 , V_219 ) )
return - V_146 ;
break;
case V_221 :
if ( F_42 ( V_219 -> V_222 , & V_2 -> V_132 ) )
F_36 ( V_219 -> V_222 , & V_2 -> V_132 ) ;
default:
break;
}
return 0 ;
...
static T_3 F_81 ( struct V_119 * V_120 , struct V_136 * V_137 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
return V_2 -> V_191 ;
}
static void F_82 ( struct V_119 * V_120 , struct V_136 * V_137 ,
T_3 V_226 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
F_83 ( V_2 , V_226 , V_137 -> V_227 . V_192 ) ;
}
static void F_84 ( struct V_119 * V_120 , struct V_136 * V_137 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
F_15 ( V_2 , V_150 , V_151 ) ;
F_70 ( V_2 ) ;
...
static int
F_89 ( struct V_231 * V_232 , const struct V_233 * V_234 )
{
struct V_235 * V_236 ;
struct V_1 * V_2 ;
struct V_119 * V_120 ;
struct V_237 * V_237 ;
int V_207 = 0 ;
V_236 = F_90 ( F_91 ( V_232 ) ) ;
F_92 ( & V_236 -> V_41 , L_16 ,
V_238 , V_239 ) ;
F_92 ( & V_236 -> V_41 ,
L_17 ) ;
V_120 = F_93 ( sizeof( struct V_1 ) , & V_240 ) ;
if ( ! V_120 ) {
F_29 ( & V_236 -> V_41 , L_18 ) ;
V_207 = - V_125 ;
goto V_241;
}
V_2 = V_120 -> V_2 ;
...
F_94 ( & V_2 -> V_242 ) ;
F_95 ( & V_2 -> V_243 ) ;
F_96 ( & V_2 -> V_134 , V_244 ) ;
F_97 ( V_232 , V_2 ) ;
V_237 = V_2 -> V_120 -> V_237 ;
V_237 -> V_245 = V_246 ;
V_237 -> V_247 = V_248 ;
V_237 -> V_249 = F_98 ( V_138 ) |
F_98 ( V_139 ) | F_98 ( V_144 ) ;
F_99 ( V_2 -> V_120 , V_250 ) ;
F_99 ( V_2 -> V_120 , V_251 ) ;
F_99 ( V_2 -> V_120 , V_252 ) ;
F_99 ( V_2 -> V_120 , V_253 ) ;
F_99 ( V_2 -> V_120 , V_254 ) ;
V_2 -> V_120 -> V_255 = 100 ;
F_100 ( V_2 -> V_120 , & V_232 -> V_41 ) ;
V_207 = F_101 ( V_2 -> V_40 ) ;
if ( V_207 )
F_102 ( & V_2 -> V_40 -> V_41 ,
L_19 , V_256 , V_207 ) ;
F_36 ( V_126 , & V_2 -> V_127 ) ;
...
F_97 ( V_232 , NULL ) ;
F_105 ( F_91 ( V_232 ) ) ;
F_45 ( V_133 , & V_2 -> V_127 ) ;
F_109 ( V_2 -> V_120 ) ;
}
static int F_110 ( struct V_231 * V_232 , T_4 V_258 )
{
return 0 ;
}
static int F_111 ( struct V_231 * V_232 )
{
return 0 ;
}
