...
{
char V_79 [ 64 ] ;
snprintf ( V_79 , sizeof( V_79 ) , L_14 , V_1 -> V_82 ) ;
F_26 ( V_1 , V_79 , - 1 ) ;
F_26 ( V_1 , L_15 , - 1 ) ;
}
static char *
F_29 ( T_1 * V_1 , int V_83 , int V_84 )
{
static char V_79 [ 6 ] ;
switch ( V_1 -> V_66 ) {
case V_70 :
...
F_26 ( V_1 , L_19 , V_7 + 1 ) ;
sprintf ( V_79 , L_20 , F_29 ( V_1 , 1 , 3 ) ) ;
F_26 ( V_1 , V_79 , V_7 + 1 ) ;
F_10 ( & V_1 -> V_31 , V_28 ) ;
}
static void
...
static void
F_32 ( unsigned long V_27 )
{
T_1 * V_1 = ( T_1 * ) V_27 ;
F_30 ( V_1 , 1 ) ;
}
static void
F_33 ( T_1 * V_1 , int V_7 )
{
unsigned long V_28 ;
F_8 ( & V_1 -> V_31 , V_28 ) ;
F_34 ( & V_1 -> V_87 [ V_7 ] ) ;
...
static int
F_36 ( T_1 * V_1 , char * V_60 , int V_89 , T_2 * V_14 )
{
T_1 * V_90 = V_91 ;
unsigned long V_28 ;
int V_7 ;
...
static char *
F_37 ( T_1 * V_1 , char * V_40 , int V_101 )
{
int V_93 ;
...
F_35 ( V_1 , V_7 - 1 ) ;
if ( V_1 -> V_8 [ V_7 - 1 ] ) {
F_35 ( V_1 -> V_8 [ V_7 - 1 ] , V_1 -> V_9 [ V_7 - 1 ] ) ;
...
case 5 :
V_60 += 6 ;
switch ( F_36 ( V_1 , V_60 , V_7 - 1 , & V_14 ) ) {
case 0 :
sprintf ( V_79 , L_30 ,
( V_48 == 4 ) ? L_31 : L_32 ,
F_37 ( V_1 , V_14 . V_24 . V_37 . V_43 , 1 ) ,
V_14 . V_24 . V_37 . V_41 ,
V_14 . V_24 . V_37 . V_42 ,
F_37 ( V_1 -> V_8 [ V_7 - 1 ] ,
...
case 1 :
F_26 ( V_1 , L_19 , V_7 ) ;
sprintf ( V_79 , L_20 , F_29 ( V_1 , 1 , 1 ) ) ;
F_26 ( V_1 , V_79 , V_7 ) ;
break;
case 2 :
F_26 ( V_1 , L_19 , V_7 ) ;
sprintf ( V_79 , L_20 , F_29 ( V_1 , 1 , 2 ) ) ;
F_26 ( V_1 , V_79 , V_7 ) ;
break;
}
break;
...
case 7 :
V_60 += 3 ;
if ( strlen ( V_60 ) >= sizeof( V_1 -> V_97 [ 0 ] ) )
break;
...
static int
F_39 ( const T_3 * V_79 , int V_10 , int V_105 , T_1 * V_1 )
{
int V_106 = 0 ;
int V_107 = 1 ;
T_2 V_14 ;
...
if ( V_1 -> V_28 & V_110 )
return - V_114 ;
if ( F_40 ( ( char * ) & V_113 , ( char * ) V_112 , sizeof( V_113 ) ) )
return - V_81 ;
for ( V_93 = 0 ; V_93 < 3 ; V_93 ++ ) {
if ( ! memchr ( V_113 . V_50 [ V_93 ] , 0 , sizeof( V_113 . V_50 [ V_93 ] ) ) )
return - V_77 ;
}
F_8 ( & V_1 -> V_31 , V_28 ) ;
switch ( V_113 . V_66 ) {
...
sizeof( V_118 ) ) )
return - V_81 ;
return F_45 ( V_118 . V_123 ) ;
break;
case V_124 :
if ( V_116 ) {
if ( ! V_1 -> V_125 ) {
V_1 -> V_125 = 1 ;
while ( V_1 -> V_66 == V_126 )
F_46 ( 10 ) ;
F_46 ( 10 ) ;
sprintf ( V_117 , L_41 ) ;
V_93 = F_39 ( V_117 , strlen ( V_117 ) , 0 , V_1 ) ;
F_5 ( V_64
L_42 ,
V_65 ) ;
V_14 . V_22 = V_127 ;
...
L_45 , ( int ) ( V_116 + 1 ) ,
V_131 , V_60 , V_53 -> V_24 . V_37 . V_41 ,
...
if ( V_1 )
return F_44 ( V_53 , V_1 ) ;
F_5 ( V_147
L_65 ) ;
return - V_129 ;
}
static int
F_50 ( const T_3 T_6 * V_79 , int V_10 , int V_148 , int V_2 )
{
T_1 * V_1 = F_48 ( V_148 ) ;
if ( V_1 ) {
if ( ! ( V_1 -> V_28 & V_110 ) )
return - V_129 ;
return F_39 ( V_79 , V_10 , 1 , V_1 ) ;
}
F_5 ( V_147
L_66 ) ;
return - V_129 ;
...
static int
F_51 ( T_3 T_6 * V_79 , int V_10 , int V_148 , int V_2 )
{
T_1 * V_1 = F_48 ( V_148 ) ;
if ( V_1 ) {
if ( ! ( V_1 -> V_28 & V_110 ) )
...
static int
F_52 ( int V_148 , int V_2 , int V_11 , struct V_12 * V_13 )
{
T_1 * V_1 = F_48 ( V_148 ) ;
if ( V_1 ) {
if ( ! ( V_1 -> V_28 & V_110 ) )
...
T_1 * V_1 ;
int V_93 ;
V_1 = F_54 ( sizeof( T_1 ) , V_149 ) ;
if ( ! V_1 ) {
F_5 ( V_21
L_69 , V_148 ) ;
return ( T_1 * ) 0 ;
}
V_1 -> V_19 . V_150 = V_151 ;
V_1 -> V_19 . V_152 = V_130 ;
V_1 -> V_19 . V_153 = 1 ;
V_1 -> V_19 . V_154 = 4000 ;
V_1 -> V_19 . V_22 = F_49 ;
V_1 -> V_19 . V_155 = F_52 ;
...
V_163 ;
V_1 -> V_66 = V_126 ;
F_12 ( V_1 -> V_19 . V_148 , V_148 , sizeof( V_1 -> V_19 . V_148 ) ) ;
V_1 -> V_54 = V_1 -> V_57 ;
V_1 -> V_55 = V_1 -> V_57 ;
V_1 -> V_56 = & V_1 -> V_57 [ sizeof( V_1 -> V_57 ) - 1 ] ;
for ( V_93 = 0 ; V_93 < V_130 ; V_93 ++ ) {
V_1 -> V_133 [ V_93 ] = V_134 ;
F_55 ( & V_1 -> V_5 [ V_93 ] ) ;
}
F_55 ( & V_1 -> V_61 ) ;
F_56 ( & V_1 -> V_31 ) ;
