...
int F_57 ( struct V_87 * V_27 , void T_5 * V_88 , int V_89 ,
...
int F_58 ( struct V_87 * V_27 , struct V_17 * V_2 )
{
int V_9 ;
struct V_1 * V_93 = V_2 -> V_92 ;
V_9 = V_93 -> V_47 . V_110 ( V_93 ) ;
if ( V_9 < 0 ) {
F_8 ( V_27 , L_29 , V_9 ) ;
return V_9 ;
}
...
void F_60 ( struct V_87 * V_27 , struct V_17 * V_2 )
{
if ( V_2 -> V_92 -> V_25 )
F_10 ( V_2 -> V_92 -> V_25 ) ;
F_49 ( V_2 -> V_92 ) ;
