...
F_84 ( & V_202 ) ;
F_16 ( V_215 , L_28 ,
V_216 , V_87 -> V_214 ? V_87 -> V_214 -> V_166 : L_5 ,
...
int F_155 ( struct V_197 * V_217 , ... )
{
struct V_197 * V_87 = V_217 ;
T_1 args ;
int V_49 ;
va_start ( args , V_217 ) ;
do {
...
while ( V_217 != V_87 ) {
F_153 ( V_217 ) ;
V_217 = va_arg ( args , struct V_197 * ) ;
}
va_end ( args ) ;
}
return V_49 ;
}
void F_156 ( struct V_197 * V_217 , ... )
{
T_1 args ;
va_start ( args , V_217 ) ;
do {
...
int F_167 ( struct V_208 * V_209 , T_5 V_226 )
{
int V_167 ;
...
{
F_150 ( V_209 -> V_218 == V_227 || V_209 -> V_218 == V_231 ) ;
V_209 -> V_218 = V_232 ;
if ( ( V_209 -> V_212 & V_228 ) == 0 ) {
F_4 ( F_5 ( & V_209 -> V_229 ) ) ;
F_160 ( V_209 ) ;
} else {
F_82 ( & V_202 ) ;
...
F_150 ( V_209 -> V_218 == V_219 ) ;
V_209 -> V_218 = V_231 ;
if ( V_209 -> V_212 & V_224 && V_209 -> V_211 ) {
for ( V_74 = 0 ; V_74 < F_50 ( V_203 ) ; ++ V_74 ) {
if ( V_209 -> V_212 & V_228 )
F_82 ( & V_202 ) ;
if ( V_209 -> V_211 [ V_74 ] ) {
struct V_197 * V_87 ;
V_87 = V_203 [ V_74 ] ;
...
{
return F_60 ( V_209 -> V_225 == V_207 ) ? 0 : F_162 ( V_209 ) ;
}
int F_171 ( struct V_1 * V_2 , T_5 V_226 )
{
int V_49 ;
V_2 -> V_233 = NULL ;
V_49 = F_167 ( & V_2 -> V_90 , V_226 ) ;
if ( F_60 ( V_49 == 0 ) )
F_169 ( & V_2 -> V_90 ) ;
return V_49 ;
}
...
V_235 -> V_239 +=
F_175 ( & V_13 ) - V_6 -> V_30 ;
V_235 -> V_240 += F_175 ( & V_13 ) ;
V_235 -> V_241 = F_176 ( ( int ) V_235 -> V_241 ,
F_177 ( & V_13 ) ) ;
if ( ! V_236 ) {
F_17 ( V_122 , & V_13 , 1 ) ;
continue;
...
static unsigned long F_180 ( struct V_243 * V_244 ,
struct V_245 * V_246 )
{
struct V_9 * V_63 ;
struct V_9 * V_247 ;
...
V_248 += F_182 ( & V_63 -> V_31 ) ;
F_183 ( & V_179 ) ;
V_248 = ( V_248 / 100 ) * V_251 ;
F_16 ( V_32 , L_31 ,
V_248 , V_251 ) ;
return V_248 ;
}
static unsigned long F_184 ( struct V_243 * V_244 ,
struct V_245 * V_246 )
{
struct V_9 * V_63 ;
struct V_9 * V_247 ;
unsigned long V_252 = V_246 -> V_253 , V_254 = 0 ;
F_185 ( V_58 ) ;
if ( ! ( V_246 -> V_249 & V_250 ) )
return V_255 ;
F_120 ( & V_179 ) ;
F_42 (s, tmp, &lu_sites, ls_linkage) {
V_254 = F_145 ( & V_180 , V_63 , V_252 ) ;
V_252 -= V_254 ;
F_186 ( & V_63 -> V_177 , & V_58 ) ;
}
F_187 ( & V_58 , V_181 . V_60 ) ;
F_121 ( & V_179 ) ;
return V_246 -> V_253 - V_252 ;
}
int F_188 ( void )
{
int V_49 ;
...
static T_5 F_195 ( struct V_258 * V_235 , int V_259 )
{
struct V_260 V_261 ;
F_196 ( V_235 , V_259 , & V_261 ) ;
return ( T_5 ) V_261 . V_262 ;
}
int F_197 ( const struct V_9 * V_63 , struct V_263 * V_264 )
{
struct V_234 V_235 ;
memset ( & V_235 , 0 , sizeof( V_235 ) ) ;
F_174 ( V_63 -> V_26 , & V_235 , 1 ) ;
F_198 ( V_264 , L_33 ,
V_235 . V_239 ,
V_235 . V_240 ,
V_235 . V_242 ,
...
int F_200 ( struct V_265 * V_266 )
{
int V_49 ;
struct V_265 * V_267 = V_266 ;
for ( V_49 = 0 ; V_267 -> V_268 ; ++ V_267 ) {
* V_267 -> V_268 = F_201 ( V_267 -> V_269 ,
V_267 -> V_270 ,
0 , 0 , NULL ) ;
if ( ! * V_267 -> V_268 ) {
V_49 = - V_52 ;
...
void F_202 ( struct V_265 * V_266 )
{
for (; V_266 -> V_268 ; ++ V_266 ) {
F_203 ( * V_266 -> V_268 ) ;
* V_266 -> V_268 = NULL ;
}
}
void F_204 ( struct V_271 * V_272 )
{
F_4 ( V_272 ) ;
if ( V_272 -> V_273 ) {
F_4 ( V_272 -> V_274 > 0 ) ;
...
void F_206 ( struct V_271 * V_272 , T_6 V_118 )
{
F_4 ( V_272 ) ;
F_4 ( ! V_272 -> V_273 ) ;
F_4 ( ! V_272 -> V_274 ) ;
V_272 -> V_273 = F_207 ( V_118 , V_168 ) ;
if ( F_60 ( V_272 -> V_273 ) )
V_272 -> V_274 = V_118 ;
}
void F_208 ( struct V_271 * V_272 , T_6 V_118 )
{
F_204 ( V_272 ) ;
F_206 ( V_272 , V_118 ) ;
}
struct V_271 * F_209 ( struct V_271 * V_272 , T_6 V_275 )
{
if ( ! V_272 -> V_273 && ! V_272 -> V_274 )
F_206 ( V_272 , V_275 ) ;
if ( ( V_275 > V_272 -> V_274 ) && V_272 -> V_273 )
F_208 ( V_272 , V_275 ) ;
return V_272 ;
}
int F_210 ( struct V_271 * V_272 , T_6 V_275 )
{
char * V_276 ;
if ( V_275 <= V_272 -> V_274 )
return 0 ;
V_276 = F_207 ( V_275 , V_168 ) ;
if ( ! V_276 )
return - V_52 ;
if ( V_272 -> V_273 ) {
memcpy ( V_276 , V_272 -> V_273 , V_272 -> V_274 ) ;
F_205 ( V_272 -> V_273 ) ;
}
V_272 -> V_273 = V_276 ;
V_272 -> V_274 = V_275 ;
