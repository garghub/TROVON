...
static void F_73 ( int V_113 , int V_96 , int V_114 , int V_115 , int V_116 )
{
...
static void F_74 ( int V_113 , int V_96 , int V_114 , int V_115 )
{
const char * type = L_50 ;
void (* F_75)( int V_95 , int V_96 );
int V_117 ;
if ( V_114 == V_115 )
return;
F_75 = NULL ;
...
static void F_76 ( int V_95 , int V_96 )
{
int V_119 , V_114 , V_115 , V_116 , V_120 , V_121 , V_122 ;
if ( ! F_77 ( V_95 , 3 , V_123 ) )
return;
V_119 = F_2 ( V_95 ) ;
F_5 ( 0x20 , V_95 ) ;
V_120 = F_2 ( V_95 + 1 ) ;
...
goto V_124;
F_73 ( V_95 , V_96 , V_114 , V_115 , V_116 ) ;
V_124:
F_78 ( V_95 , 3 ) ;
}
...
static void F_80 ( int V_95 , int V_96 )
{
...
static struct V_92 * F_85 ( struct V_1 * V_7 )
{
int V_60 ;
for ( V_60 = 0 ; V_60 < V_93 ; V_60 ++ )
...
static int F_92 ( struct V_1 * V_2 ) { return 0 ; }
static int F_93 ( struct V_1 * V_2 )
{
return 0 ;
}
...
int V_78 ;
F_6 ( V_7 , V_155 ) ;
V_78 = F_2 ( F_95 ( V_7 ) ) & 0x07 ;
if ( ( V_78 & 0x03 ) == 0 )
V_78 = V_80 ;
F_14 ( V_7 , V_14 ) ;
return V_78 ;
}
static int F_111 ( struct V_1 * V_7 )
{
...
struct V_1 * F_112 ( unsigned long int V_130 ,
...
return NULL ;
V_30 = & V_167 -> V_30 ;
V_53 = F_115 ( V_30 , F_116 ( 24 ) ) ;
if ( V_53 ) {
F_117 ( V_30 , L_96 ) ;
V_78 = V_80 ;
}
}
V_148 = F_118 ( sizeof( struct V_160 ) , V_168 ) ;
if ( ! V_148 )
goto V_169;
V_11 = F_118 ( sizeof( struct V_10 ) , V_168 ) ;
if ( ! V_11 )
goto V_170;
V_7 = F_119 ( V_130 , V_37 , V_78 , V_148 ) ;
if ( ! V_7 )
goto V_171;
V_163 = F_77 ( V_130 , 3 , V_7 -> V_48 ) ;
if ( ! V_163 )
goto V_172;
...
V_7 -> V_13 = V_11 ;
if ( V_158 ) {
V_164 = F_77 ( V_158 , 3 , V_7 -> V_48 ) ;
if ( V_164 )
F_91 ( V_7 ) ;
}
if ( V_130 != 0x3bc ) {
V_165 = F_77 ( V_130 + 0x3 , 5 , V_7 -> V_48 ) ;
if ( V_165 )
if ( ! F_99 ( V_7 ) )
F_100 ( V_7 ) ;
}
...
F_78 ( V_7 -> V_130 , 3 ) ;
if ( V_7 -> V_177 > 3 )
F_78 ( V_7 -> V_130 + 3 , V_7 -> V_177 - 3 ) ;
if ( V_7 -> V_103 & V_183 )
F_78 ( V_7 -> V_158 , 3 ) ;
#if F_138 ( F_121 ) && F_138 ( F_61 )
if ( V_11 -> V_77 )
F_140 ( V_7 -> V_12 -> V_30 , V_75 ,
V_11 -> V_77 ,
V_11 -> V_69 ) ;
#endif
F_133 ( V_7 -> V_13 ) ;
...
static int F_141 ( struct V_197 * V_167 , int V_198 , int V_199 ,
...
F_143 ( V_167 , 0x3c , & V_206 ) ;
F_144 ( V_167 , 0x1c , & V_204 ) ;
V_204 &= 0x0000ff00 ;
F_144 ( V_167 , 0x20 , & V_205 ) ;
V_205 &= 0x0000ff00 ;
F_142 ( V_167 , 0x6c , 0xe3000000 | V_204 ) ;
F_142 ( V_167 , 0x70 , 0xe3000000 | V_205 ) ;
F_142 ( V_167 , 0x80 , ( V_205 << 16 ) | V_204 ) ;
F_142 ( V_167 , 0x9c ,
V_203 | ( V_206 * 0x11111 ) ) ;
F_4 ( V_6 L_123 , V_206 ) ;
F_4 ( V_6 L_124 ,
...
static int F_145 ( struct V_197 * V_167 , int V_198 , int V_199 ,
const struct V_200 * V_201 )
{
...
F_143 ( V_167 , V_201 -> V_222 , & V_208 ) ;
V_208 |= V_201 -> V_223 ;
F_146 ( V_167 , V_201 -> V_222 , V_208 ) ;
...
F_143 ( V_167 , V_201 -> V_230 , & V_208 ) ;
V_37 = ( ( V_208 & V_231 ) >> 4 ) ;
if ( V_210 == V_219 ) {
F_143 ( V_167 , V_201 -> V_232 , & V_208 ) ;
V_78 = ( ( V_208 & V_233 ) >> 2 ) ;
} else
V_78 = V_80 ;
if ( V_198 == V_38 ) {
...
if ( F_112 ( V_212 , V_213 , V_37 , V_78 , & V_167 -> V_30 , 0 ) ) {
F_8 ( V_15
L_140 , V_212 ) ;
if ( V_37 != V_38 )
F_72 ( L_127 , V_37 ) ;
...
static int F_147 ( struct V_197 * V_30 ,
...
if ( V_235 )
return V_235 ;
V_238 = F_118 ( sizeof( struct V_237 ) , V_168 ) ;
if ( ! V_238 )
return - V_240 ;
if ( V_241 [ V_60 ] . V_242 &&
...
V_248 = F_149 ( V_30 , V_245 ) ;
V_249 = 0 ;
if ( ( V_247 >= 0 ) && ( V_247 <= 6 ) )
V_249 = F_149 ( V_30 , V_247 ) ;
else if ( V_247 > 6 )
V_248 += V_247 ;
V_37 = V_30 -> V_37 ;
if ( V_37 == V_250 ) {
...
static void F_151 ( struct V_197 * V_30 )
{
struct V_237 * V_238 = F_152 ( V_30 ) ;
int V_60 ;
if ( V_238 ) {
for ( V_60 = V_238 -> V_254 - 1 ; V_60 >= 0 ; V_60 -- )
F_135 ( V_238 -> V_252 [ V_60 ] ) ;
F_133 ( V_238 ) ;
}
}
static int T_7 F_153 ( int V_198 , int V_199 )
{
const struct V_234 * V_117 ;
struct V_197 * V_167 = NULL ;
int V_53 = 0 ;
F_154 (pdev) {
V_117 = F_155 ( V_256 , V_167 ) ;
if ( V_117 == NULL || V_117 -> V_236 >= V_239 )
continue;
if ( V_257 [ V_117 -> V_236 ] . F_156 (
V_167 , V_198 , V_199 ,
...
static int F_157 ( struct V_258 * V_30 ,
...
V_78 = V_80 ;
F_167 ( & V_30 -> V_30 , L_145 , V_30 -> V_263 -> V_48 ) ;
V_260 = F_112 ( V_248 , V_249 , V_37 , V_78 , & V_30 -> V_30 , 0 ) ;
if ( V_260 == NULL )
return - V_243 ;
F_168 ( V_30 , V_260 ) ;
return 0 ;
}
static void F_169 ( struct V_258 * V_30 )
{
struct V_1 * V_260 = (struct V_1 * ) F_170 ( V_30 ) ;
if ( ! V_260 )
return;
F_135 ( V_260 ) ;
}
static int F_171 ( struct V_166 * V_167 )
{
return 0 ;
}
static void T_7 F_172 ( int V_198 , int V_199 )
{
int V_76 = 0 , V_235 ;
#ifdef F_173
F_83 () ;
...
static int T_7 F_177 ( const char * V_32 , int * V_268 ,
...
char * V_272 ;
unsigned long V_28 = F_178 ( V_32 , & V_272 , 0 ) ;
if ( V_272 != V_32 )
* V_268 = V_28 ;
else {
...
static int T_7 F_179 ( const char * V_274 , int * V_268 )
{
return F_177 ( V_274 , V_268 , V_179 ,
V_38 , 0 ) ;
}
static int T_7 F_180 ( const char * V_275 , int * V_268 )
{
return F_177 ( V_275 , V_268 , V_181 ,
V_80 , V_182 ) ;
}
static int T_7 F_181 ( char * V_276 )
{
F_8 ( V_6
L_150 , V_276 ) ;
...
if ( F_179 ( V_37 [ V_60 ] , & V_268 ) )
return 1 ;
V_279 [ V_60 ] = V_268 ;
if ( F_180 ( V_78 [ V_60 ] , & V_268 ) )
return 1 ;
V_280 [ V_60 ] = V_268 ;
}
if ( ! V_95 [ 0 ] ) {
if ( V_37 [ 0 ] && ! F_179 ( V_37 [ 0 ] , & V_268 ) )
switch ( V_268 ) {
case V_38 :
case V_179 :
V_279 [ 0 ] = V_268 ;
...
static int T_7 F_184 ( char * V_276 )
{
char * V_281 ;
char * V_282 ;
int V_268 ;
...
F_112 ( V_95 [ V_60 ] , V_249 [ V_60 ] ,
V_279 [ V_60 ] , V_280 [ V_60 ] , NULL , 0 ) ;
}
} else
F_172 ( V_279 [ 0 ] , V_280 [ 0 ] ) ;
return 0 ;
}
