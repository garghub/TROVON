...
if ( error )
goto V_98;
error = F_62 ( & V_3 -> V_3 , V_99 , & V_3 -> V_3 . V_100 ) ;
if ( error ) {
F_14 ( V_3 -> V_3 . V_28 ,
L_4 ) ;
goto V_98;
...
V_3 -> V_3 . V_101 =
F_63 ( int , F_64 ( V_3 -> V_3 . V_100 ) , V_3 -> V_3 . V_101 ) ;
error = F_65 ( & V_3 -> V_3 , V_3 -> V_3 . V_100 ) ;
if ( error )
goto V_98;
V_3 -> V_3 . V_102 =
( V_103 - 1 ) << ( V_104 - 9 ) ;
...
{
if ( ! F_79 ( & V_3 -> V_3 , V_109 ) )
return - V_110 ;
if ( ! F_80 ( V_111 , & V_3 -> V_108 ) )
return - V_110 ;
return 0 ;
}
...
static void F_83 ( struct V_112 * V_73 )
{
struct V_1 * V_3 ;
F_42 ( & V_76 ) ;
F_84 (ctrl, &nvme_loop_ctrl_list, list) {
if ( V_3 -> V_3 . V_113 == V_73 -> V_113 )
F_78 ( V_3 ) ;
}
F_44 ( & V_76 ) ;
}
...
V_3 -> V_16 . V_84 = & V_119 ;
V_3 -> V_16 . V_86 = V_3 -> V_3 . V_79 -> V_120 ;
V_3 -> V_16 . V_87 = 1 ;
V_3 -> V_16 . V_69 = V_88 ;
V_3 -> V_16 . V_48 = V_121 ;
...
static struct V_2 * F_91 ( struct V_28 * V_124 ,
struct V_81 * V_79 )
{
struct V_1 * V_3 ;
bool V_115 ;
int V_45 ;
V_3 = F_92 ( sizeof( * V_3 ) , V_125 ) ;
if ( ! V_3 )
return F_93 ( - V_126 ) ;
V_3 -> V_3 . V_79 = V_79 ;
F_94 ( & V_3 -> V_74 ) ;
F_31 ( & V_3 -> V_108 , F_73 ) ;
F_31 ( & V_3 -> V_3 . V_114 , F_85 ) ;
V_45 = F_95 ( & V_3 -> V_3 , V_124 , & V_127 ,
0 ) ;
if ( V_45 )
goto V_128;
V_45 = - V_126 ;
V_3 -> V_3 . V_101 = V_79 -> V_120 - 1 ;
V_3 -> V_3 . V_129 = V_79 -> V_129 ;
...
if ( V_45 )
goto V_131;
if ( V_79 -> V_120 > V_3 -> V_3 . V_132 ) {
F_89 ( V_3 -> V_3 . V_28 ,
L_6 ,
V_79 -> V_120 , V_3 -> V_3 . V_132 ) ;
V_79 -> V_120 = V_3 -> V_3 . V_132 ;
}
if ( V_79 -> V_82 ) {
V_45 = F_90 ( V_3 ) ;
...
static int F_99 ( struct V_138 * V_50 )
{
if ( V_51 )
return - V_139 ;
V_51 = V_50 ;
...
static void F_100 ( struct V_138 * V_50 )
{
if ( V_50 == V_51 )
V_51 = NULL ;
}
