...
static enum V_275 F_219 ( struct V_276 * V_97 )
{
...
V_7 -> V_4 = V_4 ;
F_224 ( & V_7 -> V_58 . V_219 , V_281 ,
V_235 ) ;
V_7 -> V_58 . V_219 . V_282 = F_219 ;
V_4 -> V_8 . V_259 = V_260 ;
F_41 ( & V_52 . V_53 ) ;
F_210 ( V_4 , false ) ;
F_225 ( & V_7 -> V_204 , & V_283 ) ;
return 0 ;
V_280:
F_202 ( V_7 ) ;
V_279:
...
{
T_2 V_285 = F_16 ( V_4 -> V_8 . V_7 , V_251 ) ;
int V_143 = 0 ;
if ( ! F_14 ( V_4 -> V_8 . V_7 ) )
V_143 = 1 ;
if ( ( V_285 & V_56 ) == 0 &&
...
struct V_287 * V_288 , bool V_289 )
{
if ( F_29 ( V_4 -> V_8 . V_7 ) ) {
T_2 * V_54 = ( T_2 * ) ( V_288 -> V_9 + V_12 ) ;
if ( V_4 -> V_31 -> V_8 . V_290 ) {
if ( * V_54 != V_4 -> V_13 )
return - V_291 ;
} else {
if ( V_289 )
...
int F_232 ( struct V_3 * V_4 , struct V_287 * V_288 )
{
memcpy ( V_288 -> V_9 , V_4 -> V_8 . V_7 -> V_9 , sizeof( * V_288 ) ) ;
return F_231 ( V_4 , V_288 , false ) ;
}
int F_233 ( struct V_3 * V_4 , struct V_287 * V_288 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
int V_143 ;
F_207 ( V_4 , V_4 -> V_8 . V_259 ) ;
F_38 ( V_7 , * ( ( T_2 * ) ( V_288 -> V_9 + V_50 ) ) ) ;
V_143 = F_231 ( V_4 , V_288 , true ) ;
if ( V_143 )
return V_143 ;
memcpy ( V_4 -> V_8 . V_7 -> V_9 , V_288 -> V_9 , sizeof *V_288 ) ;
F_23 ( V_4 -> V_31 ) ;
F_52 ( V_4 ) ;
F_88 ( V_7 ) ;
F_151 ( & V_7 -> V_58 . V_219 ) ;
