...
static int F_19 ( struct V_54 * V_18 , struct V_1 * V_2 ,
int V_3 , T_3 V_46 , T_3 V_53 )
{
struct V_12 * V_13 = V_2 -> V_12 + V_3 ;
T_3 V_55 ;
int V_56 ;
V_55 = ( V_13 -> V_15 & V_20 ) ? V_57 : V_58 ;
V_56 = F_20 ( V_18 , V_13 , V_46 , V_53 , V_55 ,
V_59 | V_29 ,
F_18 , V_2 ) ;
if ( V_56 == 0 )
return 0 ;
if ( ( V_13 -> V_15 & ( V_59 | V_29 ) ) ==
( V_59 | V_29 ) ) {
V_56 = F_20 ( V_18 , V_13 , V_46 , V_53 , V_55 ,
V_59 ,
F_18 , V_2 ) ;
...
if ( V_13 -> V_15 & ( V_59 | V_29 ) )
V_56 = F_20 ( V_18 , V_13 , V_46 , V_53 , V_55 , 0 ,
F_18 , V_2 ) ;
return V_56 ;
}
static int F_21 ( struct V_1 * V_2 , int V_3 ,
T_3 V_46 , T_3 V_60 )
{
struct V_54 * V_18 ;
int V_56 ;
V_18 = V_2 -> V_18 ;
while ( ( V_56 = F_19 ( V_18 , V_2 , V_3 , V_46 , V_60 ) ) ) {
...
int F_22 ( struct V_1 * V_2 , int V_3 )
{
struct V_12 * V_13 = V_2 -> V_12 + V_3 ;
T_3 V_53 , V_46 ;
int V_56 ;
...
V_46 = F_24 ( V_13 ) ;
V_56 = F_21 ( V_2 , V_3 , V_46 , V_53 ) ;
if ( V_56 < 0 ) {
F_12 ( & V_2 -> V_2 , L_10 , V_3 , V_13 ) ;
V_56 = F_17 ( V_13 , V_2 , V_3 , V_46 ) ;
}
if ( V_56 < 0 ) {
...
int F_25 ( struct V_1 * V_2 , int V_3 , T_3 V_66 ,
T_3 V_60 )
{
struct V_12 * V_13 = V_2 -> V_12 + V_3 ;
unsigned long V_15 ;
...
int F_26 ( struct V_1 * V_2 , int V_10 )
{
T_1 V_7 , V_68 ;
int V_69 ;
struct V_12 * V_70 ;
