...
int F_104 ( struct V_109 * V_110 , void * V_111 )
{
struct V_30 * V_31 = F_26 ( (struct V_112 * ) V_110 -> V_113 ) ;
struct V_77 * V_89 = & V_31 -> V_41 ;
struct V_28 * V_29 , * V_114 = NULL ;
unsigned int V_115 = 0 ;
if ( V_111 != V_116 )
return 0 ;
F_28 ( & V_31 -> V_34 ) ;
F_105 (ei, &sbi->s_es_list, i_es_list) {
V_115 ++ ;
if ( V_114 && V_114 -> V_43 < V_29 -> V_43 )
V_114 = V_29 ;
else if ( ! V_114 )
V_114 = V_29 ;
}
...
V_89 -> V_81 ) ;
if ( V_115 )
F_106 ( V_110 , L_35 , V_115 ) ;
F_106 ( V_110 , L_36 ,
F_108 ( V_89 -> V_98 , 1000 ) ) ;
F_106 ( V_110 , L_37 , V_89 -> V_100 ) ;
if ( V_115 )
F_106 ( V_110 ,
L_38
L_39 ,
V_114 -> V_96 . V_14 , V_114 -> V_43 , V_114 -> V_40 ,
F_108 ( V_89 -> V_99 , 1000 ) ) ;
return 0 ;
}
int F_109 ( struct V_30 * V_31 )
{
int V_73 ;
F_110 ( V_117 < 48 ) ;
F_111 ( & V_31 -> V_35 ) ;
...
V_31 -> V_41 . V_98 = 0 ;
V_31 -> V_41 . V_99 = 0 ;
V_73 = F_113 ( & V_31 -> V_41 . V_44 , 0 , V_118 ) ;
if ( V_73 )
return V_73 ;
V_73 = F_113 ( & V_31 -> V_41 . V_42 , 0 , V_118 ) ;
if ( V_73 )
goto V_119;
V_31 -> V_107 . V_120 = F_101 ;
V_31 -> V_107 . V_121 = F_97 ;
V_31 -> V_107 . V_122 = V_123 ;
V_73 = F_114 ( & V_31 -> V_107 ) ;
if ( V_73 )
goto V_124;
return 0 ;
V_124:
F_115 ( & V_31 -> V_41 . V_42 ) ;
V_119:
F_115 ( & V_31 -> V_41 . V_44 ) ;
return V_73 ;
}
void F_116 ( struct V_30 * V_31 )
{
F_115 ( & V_31 -> V_41 . V_44 ) ;
F_115 ( & V_31 -> V_41 . V_42 ) ;
F_117 ( & V_31 -> V_107 ) ;
}
static int F_118 ( struct V_28 * V_29 , T_2 V_23 ,
int * V_87 , int * V_93 )
{
...
struct V_10 * V_10 = & V_29 -> V_96 ;
int V_93 = 0 ;
T_2 V_128 = V_29 -> V_125 ;
static F_120 ( V_129 , V_130 ,
V_131 ) ;
if ( V_29 -> V_40 == 0 )
return 0 ;
if ( F_90 ( V_10 , V_97 ) &&
F_121 ( & V_129 ) )
F_73 ( V_10 -> V_32 , L_40 ) ;
if ( ! F_118 ( V_29 , V_47 , V_87 , & V_93 ) &&
V_128 != 0 )
F_118 ( V_29 , V_128 - 1 , V_87 , & V_93 ) ;
V_29 -> V_15 . V_9 = NULL ;
return V_93 ;
}
