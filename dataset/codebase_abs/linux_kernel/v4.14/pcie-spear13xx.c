...
struct V_2 * V_3 ;
struct V_1 * V_1 ;
struct V_48 * V_49 = V_12 -> V_50 ;
struct V_51 * V_13 ;
int V_42 ;
V_1 = F_25 ( V_12 , sizeof( * V_1 ) , V_52 ) ;
if ( ! V_1 )
return - V_53 ;
V_3 = F_25 ( V_12 , sizeof( * V_3 ) , V_52 ) ;
if ( ! V_3 )
return - V_53 ;
V_3 -> V_12 = V_12 ;
V_3 -> V_46 = & V_54 ;
V_1 -> V_3 = V_3 ;
V_1 -> V_55 = F_26 ( V_12 , L_6 ) ;
if ( F_27 ( V_1 -> V_55 ) ) {
V_42 = F_28 ( V_1 -> V_55 ) ;
if ( V_42 == - V_56 )
F_29 ( V_12 , L_7 ) ;
...
F_30 ( V_1 -> V_55 ) ;
V_1 -> V_57 = F_31 ( V_12 , NULL ) ;
if ( F_27 ( V_1 -> V_57 ) ) {
F_3 ( V_12 , L_9 ) ;
return F_28 ( V_1 -> V_57 ) ;
}
V_42 = F_32 ( V_1 -> V_57 ) ;
if ( V_42 ) {
F_3 ( V_12 , L_10 ) ;
