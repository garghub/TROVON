...
F_146 ( V_205 , sizeof( V_205 ) , V_247 ) ;
V_19 -> V_6 = F_118 ( & V_214 , V_205 , V_19 ) ;
if ( F_119 ( V_19 -> V_6 ) ) {
V_7 = F_120 ( V_19 -> V_6 ) ;
goto V_215;
...
unsigned int V_34 ;
for ( V_34 = 0 ; ; V_34 ++ ) {
V_254 = F_148 ( V_252 , V_254 ) ;
if ( ! V_254 )
break;
V_255 = F_149 ( V_254 ) ;
if ( ! V_255 ) {
F_150 ( V_2 , L_27 , V_254 ) ;
continue;
}
if ( ! V_34 )
...
if ( V_19 -> V_78 -> V_79 == 0 ) {
F_185 ( V_19 -> V_78 , V_303 ) ;
F_185 ( V_19 -> V_78 , V_304 ) ;
F_185 ( V_19 -> V_78 , V_305 ) ;
}
V_7 = F_186 ( V_19 -> V_78 , V_306 , - 1 ) ;
if ( V_7 < 0 ) {
