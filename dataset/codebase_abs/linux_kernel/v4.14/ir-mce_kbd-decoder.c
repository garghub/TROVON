...
if ( ! V_8 )
return - V_71 ;
snprintf ( V_3 -> V_72 , sizeof( V_3 -> V_72 ) ,
L_12 , V_34 -> V_73 ) ;
F_22 ( V_3 -> V_74 , L_13 , sizeof( V_3 -> V_74 ) ) ;
V_8 -> V_72 = V_3 -> V_72 ;
V_8 -> V_74 = V_3 -> V_74 ;
F_23 ( V_75 , V_8 -> V_76 ) ;
F_23 ( V_77 , V_8 -> V_76 ) ;
for ( V_4 = 0 ; V_4 < sizeof( V_6 ) ; V_4 ++ )
F_23 ( V_6 [ V_4 ] , V_8 -> V_78 ) ;
F_23 ( V_79 , V_8 -> V_76 ) ;
F_23 ( V_29 , V_8 -> V_80 ) ;
F_23 ( V_30 , V_8 -> V_80 ) ;
F_23 ( V_31 , V_8 -> V_78 ) ;
...
static int F_31 ( enum V_83 V_84 , T_1 V_18 ,
struct V_35 * V_85 , unsigned int V_86 )
{
struct V_35 * V_87 = V_85 ;
int V_88 , V_68 ;
T_3 V_37 ;
if ( V_84 == V_89 ) {
V_37 = V_18 |
...
V_68 = F_32 ( & V_87 , V_86 , & V_90 , V_88 , V_37 ) ;
if ( V_68 < 0 )
return V_68 ;
return V_87 - V_85 ;
}
