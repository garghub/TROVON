...
F_12 ( V_35 , V_2 -> V_16 + V_36 ) ;
F_12 ( V_37 , V_2 -> V_16 + V_36 ) ;
...
V_14 | V_15 | ( V_10 << 3 ) ;
F_3 ( V_33 , V_2 -> V_16 + V_17 ) ;
F_12 ( V_41 , V_2 -> V_16 + V_36 ) ;
F_12 ( V_35 , V_2 -> V_16 + V_36 ) ;
F_12 ( V_42 , V_2 -> V_16 + V_38 ) ;
F_12 ( V_43 , V_2 -> V_16 + V_36 ) ;
F_12 ( V_44 , V_2 -> V_16 + V_36 ) ;
F_12 ( V_45 , V_2 -> V_16 + V_36 ) ;
F_12 ( V_46 , V_2 -> V_16 + V_36 ) ;
}
}
...
struct V_3 * V_4 ;
int V_49 ;
V_49 = F_15 ( V_2 , V_48 -> V_50 [ 0 ] , V_51 ) ;
if ( V_49 )
return V_49 ;
V_49 = F_16 ( V_2 , 5 ) ;
if ( V_49 )
