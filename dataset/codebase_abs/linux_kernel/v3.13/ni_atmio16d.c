...
V_91 = 0xf0 ;
V_92 = F_24 ( V_2 , V_23 , V_69 , V_70 , V_91 ) ;
if ( V_92 )
return V_92 ;
V_8 -> V_55 &= ~ ( V_93 | V_94 ) ;
if ( V_23 -> V_95 & 0x0f )
...
struct V_96 * V_97 )
{
const struct V_98 * V_99 = F_26 ( V_2 ) ;
struct V_7 * V_8 ;
struct V_22 * V_23 ;
unsigned int V_20 ;
int V_92 ;
V_92 = F_27 ( V_2 , V_97 -> V_100 [ 0 ] , V_101 ) ;
if ( V_92 )
return V_92 ;
V_92 = F_28 ( V_2 , 4 ) ;
if ( V_92 )
return V_92 ;
V_8 = F_29 ( V_2 , sizeof( * V_8 ) ) ;
if ( ! V_8 )
return - V_102 ;
F_3 ( V_2 ) ;
V_20 = V_97 -> V_100 [ 1 ] ;
if ( V_20 ) {
V_92 = F_30 ( V_20 , F_4 , 0 , L_3 , V_2 ) ;
if ( V_92 < 0 ) {
F_18 ( V_81 L_4 , V_20 ) ;
return V_92 ;
}
...
V_8 -> V_103 = V_97 -> V_100 [ 5 ] ;
V_8 -> V_104 = V_97 -> V_100 [ 6 ] ;
V_8 -> V_105 = V_97 -> V_100 [ 7 ] ;
V_8 -> V_106 = V_97 -> V_100 [ 8 ] ;
V_8 -> V_84 = V_97 -> V_100 [ 9 ] ;
V_8 -> V_107 = V_97 -> V_100 [ 10 ] ;
V_8 -> V_108 = V_97 -> V_100 [ 11 ] ;
V_8 -> V_86 = V_97 -> V_100 [ 12 ] ;
V_23 = & V_2 -> V_24 [ 0 ] ;
V_2 -> V_109 = V_23 ;
V_23 -> type = V_110 ;
V_23 -> V_111 = V_112 | V_113 | V_114 ;
V_23 -> V_115 = ( V_8 -> V_103 ? 16 : 8 ) ;
V_23 -> V_116 = 16 ;
V_23 -> V_117 = F_17 ;
V_23 -> V_118 = F_8 ;
V_23 -> V_119 = F_13 ;
