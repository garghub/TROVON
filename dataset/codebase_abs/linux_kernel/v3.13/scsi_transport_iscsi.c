...
if ( ! V_72 ) {
F_50 ( L_78 ,
V_445 , V_336 -> V_382 . V_431 . V_77 ) ;
return - V_414 ;
}
V_15 = V_34 -> V_448 ( V_72 , V_12 , V_338 ) ;
F_82 ( V_72 ) ;
return V_15 ;
}
...
if ( ! V_34 -> V_449 )
return - V_428 ;
V_72 = F_171 ( V_336 -> V_382 . V_449 . V_77 ) ;
if ( ! V_72 ) {
F_12 ( V_18 L_78 ,
V_445 , V_336 -> V_382 . V_449 . V_77 ) ;
return - V_414 ;
}
V_15 = V_34 -> V_449 ( V_72 , V_336 -> V_382 . V_449 . V_447 ) ;
F_82 ( V_72 ) ;
return V_15 ;
}
char * F_184 ( int V_450 )
{
int V_32 ;
char * V_273 = L_79 ;
for ( V_32 = 0 ; V_32 < F_77 ( V_451 ) ; V_32 ++ ) {
if ( V_451 [ V_32 ] . V_275 & V_450 ) {
V_273 = V_451 [ V_32 ] . V_223 ;
break;
}
}
return V_273 ;
...
V_72 = F_171 ( V_336 -> V_382 . V_454 . V_77 ) ;
if ( ! V_72 ) {
F_50 ( L_78 ,
V_445 , V_336 -> V_382 . V_454 . V_77 ) ;
V_15 = - V_414 ;
goto V_455;
}
V_222 = V_336 -> V_382 . V_454 . V_456 ;
V_82 = F_42 ( V_72 , V_222 ) ;
if ( ! V_82 ) {
F_50 ( L_80 ,
V_445 , V_222 , V_336 -> V_382 . V_454 . V_77 ) ;
V_15 = - V_414 ;
goto V_455;
}
V_2 = F_46 ( V_82 ) ;
...
V_154 = F_34 ( V_2 ) ;
V_15 = V_34 -> V_452 ( V_82 , V_154 , V_12 , V_338 ) ;
F_21 ( V_2 ) ;
V_457:
F_21 ( & V_82 -> V_2 ) ;
V_455:
...
V_72 = F_171 ( V_336 -> V_382 . V_458 . V_77 ) ;
if ( ! V_72 ) {
F_50 ( L_78 ,
V_445 , V_336 -> V_382 . V_458 . V_77 ) ;
V_15 = - V_414 ;
goto V_455;
}
V_214 = V_34 -> V_458 ( V_72 , V_12 , V_338 ) ;
if ( V_214 >= 0 )
V_336 -> V_344 . V_460 . V_456 = V_214 ;
else
V_15 = - V_461 ;
V_455:
F_82 ( V_72 ) ;
...
V_72 = F_171 ( V_336 -> V_382 . V_462 . V_77 ) ;
if ( ! V_72 ) {
F_50 ( L_78 ,
V_445 , V_336 -> V_382 . V_462 . V_77 ) ;
V_15 = - V_414 ;
goto V_455;
}
V_222 = V_336 -> V_382 . V_462 . V_456 ;
V_82 = F_42 ( V_72 , V_222 ) ;
if ( ! V_82 ) {
F_50 ( L_80 ,
V_445 , V_222 , V_336 -> V_382 . V_462 . V_77 ) ;
V_15 = - V_414 ;
goto V_455;
}
V_15 = V_34 -> V_462 ( V_82 ) ;
F_21 ( & V_82 -> V_2 ) ;
V_455:
F_82 ( V_72 ) ;
V_463:
...
V_72 = F_171 ( V_336 -> V_382 . V_464 . V_77 ) ;
if ( ! V_72 ) {
F_50 ( L_78 ,
V_445 , V_336 -> V_382 . V_464 . V_77 ) ;
V_15 = - V_414 ;
goto V_455;
}
V_222 = V_336 -> V_382 . V_464 . V_456 ;
V_82 = F_42 ( V_72 , V_222 ) ;
if ( ! V_82 ) {
F_50 ( L_80 ,
V_445 , V_222 , V_336 -> V_382 . V_464 . V_77 ) ;
V_15 = - V_414 ;
goto V_455;
}
V_2 = F_46 ( V_82 ) ;
...
V_72 = F_171 ( V_336 -> V_382 . V_466 . V_77 ) ;
if ( ! V_72 ) {
F_50 ( L_78 ,
V_445 , V_336 -> V_382 . V_466 . V_77 ) ;
V_15 = - V_414 ;
goto V_455;
}
V_222 = V_336 -> V_382 . V_466 . V_456 ;
V_82 = F_42 ( V_72 , V_222 ) ;
if ( ! V_82 ) {
F_50 ( L_80 ,
V_445 , V_222 , V_336 -> V_382 . V_466 . V_77 ) ;
V_15 = - V_414 ;
goto V_455;
}
V_2 = F_46 ( V_82 ) ;
...
V_72 = F_171 ( V_336 -> V_382 . V_468 . V_77 ) ;
if ( ! V_72 ) {
F_50 ( L_78 ,
V_445 , V_336 -> V_382 . V_466 . V_77 ) ;
V_15 = - V_414 ;
...
V_276 = F_71 ( V_336 -> V_382 . V_468 . V_268 ) ;
if ( ! V_276 ) {
F_50 ( L_81 ,
V_445 , V_336 -> V_382 . V_468 . V_268 ) ;
V_15 = - V_339 ;
goto V_455;
}
V_15 = V_34 -> V_468 ( V_276 ) ;
V_455:
F_82 ( V_72 ) ;
V_469:
return V_15 ;
...
static int
F_191 ( struct V_325 * V_326 , struct V_333 * V_334 , T_5 * V_327 )
{
int V_15 = 0 ;
struct V_335 * V_336 = F_155 ( V_334 ) ;
...
if ( V_334 -> V_386 == V_470 )
* V_327 = V_351 ;
else
* V_327 = V_346 ;
V_4 = F_146 ( F_192 ( V_336 -> V_342 ) ) ;
if ( ! V_4 )
return - V_339 ;
V_34 = V_4 -> V_8 ;
if ( ! F_193 ( V_34 -> V_471 ) )
...
F_194 ( V_326 ) . V_473 ,
V_336 -> V_382 . V_474 . V_396 ,
V_336 -> V_382 . V_474 . V_397 ,
V_336 -> V_382 . V_474 . V_398 ) ;
break;
case V_475 :
V_10 = F_20 ( V_336 -> V_382 . V_476 . V_417 ) ;
if ( ! V_10 ) {
V_15 = - V_339 ;
break;
}
V_15 = F_166 ( V_4 , V_10 , V_336 ,
F_194 ( V_326 ) . V_473 ,
V_336 -> V_382 . V_476 . V_396 ,
V_336 -> V_382 . V_476 . V_397 ,
V_336 -> V_382 . V_476 . V_398 ) ;
break;
case V_477 :
...
break;
case V_482 :
V_276 = F_71 ( V_336 -> V_382 . V_483 . V_268 ) ;
V_265 = F_75 ( V_336 -> V_382 . V_483 . V_268 , V_336 -> V_382 . V_483 . V_271 ) ;
if ( V_265 && V_265 -> V_10 )
...
V_336 -> V_344 . V_422 = V_34 -> V_484 ( V_276 , V_265 ,
V_336 -> V_382 . V_483 . V_485 ,
V_336 -> V_382 . V_483 . V_486 ) ;
if ( V_336 -> V_344 . V_422 || ! V_34 -> V_411 )
break;
V_10 = F_20 ( V_336 -> V_382 . V_483 . V_485 ) ;
if ( V_10 ) {
V_10 -> V_265 = V_265 ;
F_90 ( & V_265 -> V_318 ) ;
V_265 -> V_10 = V_10 ;
...
break;
case V_488 :
V_265 = F_75 ( V_336 -> V_382 . V_489 . V_268 , V_336 -> V_382 . V_489 . V_271 ) ;
if ( V_265 )
V_336 -> V_344 . V_422 = V_34 -> V_489 ( V_265 ) ;
else
V_15 = - V_339 ;
break;
case V_490 :
V_265 = F_75 ( V_336 -> V_382 . V_491 . V_268 , V_336 -> V_382 . V_491 . V_271 ) ;
if ( V_265 )
V_34 -> V_491 ( V_265 , V_336 -> V_382 . V_491 . V_492 ) ;
else
V_15 = - V_339 ;
break;
case V_493 :
V_265 = F_75 ( V_336 -> V_382 . V_494 . V_268 , V_336 -> V_382 . V_494 . V_271 ) ;
if ( V_265 )
V_336 -> V_344 . V_422 = V_34 -> V_494 ( V_265 ,
(struct V_330 * ) ( ( char * ) V_336 + sizeof( * V_336 ) ) ,
( char * ) V_336 + sizeof( * V_336 ) + V_336 -> V_382 . V_494 . V_495 ,
V_336 -> V_382 . V_494 . V_332 ) ;
else
V_15 = - V_339 ;
break;
case V_496 :
...
static void
F_197 ( struct V_325 * V_326 )
{
F_90 ( & V_510 ) ;
while ( V_326 -> V_338 >= V_511 ) {
int V_15 ;
T_5 V_512 ;
struct V_333 * V_334 ;
struct V_335 * V_336 ;
...
V_336 = F_155 ( V_334 ) ;
V_512 = F_164 ( V_334 -> V_388 ) ;
if ( V_512 > V_326 -> V_338 )
V_512 = V_326 -> V_338 ;
V_15 = F_191 ( V_326 , V_334 , & V_327 ) ;
if ( V_15 ) {
V_336 -> type = V_513 ;
V_336 -> V_514 = V_15 ;
}
do {
if ( V_336 -> type == V_496 && ! V_15 )
break;
if ( V_336 -> type == V_501 && ! V_15 )
break;
V_15 = F_160 ( V_327 , V_334 -> V_515 ,
...
static T_4 F_200 ( struct V_30 * V_22 ,
struct V_31 * V_6 , int V_32 )
{
struct V_1 * V_260 = F_25 ( V_22 , struct V_1 , V_22 ) ;
struct V_264 * V_265 = F_201 ( V_260 ) ;
...
V_35 = V_571 ;
else if ( V_6 == & V_572 . V_6 )
V_35 = V_573 ;
else {
F_26 ( 1 , L_84 ) ;
return 0 ;
}
return V_33 -> V_69 ( V_574 , V_35 ) ;
}
static T_1
...
static T_4 F_205 ( struct V_30 * V_22 ,
struct V_31 * V_6 , int V_32 )
{
struct V_1 * V_260 = F_25 ( V_22 , struct V_1 , V_22 ) ;
struct V_266 * V_276 = F_206 ( V_260 ) ;
...
return V_4 -> V_8 -> V_69 ( V_673 , V_35 ) ;
}
...
V_674 = V_676 [ V_32 ] . V_223 ;
break;
}
}
return V_674 ;
}
char * F_210 ( struct V_71 * V_72 )
{
int V_32 ;
char * V_273 = L_79 ;
struct V_249 * V_250 = V_72 -> V_261 ;
T_5 V_677 = V_250 -> V_677 ;
for ( V_32 = 0 ; V_32 < F_77 ( V_678 ) ; V_32 ++ ) {
if ( V_678 [ V_32 ] . V_275 & V_677 ) {
V_273 = V_678 [ V_32 ] . V_223 ;
break;
}
}
return V_273 ;
}
static int F_211 ( struct V_679 * V_680 ,
struct V_1 * V_2 )
{
struct V_266 * V_276 ;
struct V_71 * V_72 ;
...
return 0 ;
V_4 = F_55 ( V_72 -> V_231 ) ;
if ( V_4 -> V_681 . V_682 . V_20 != & V_683 . V_20 )
return 0 ;
return & V_4 -> V_681 . V_682 == V_680 ;
}
static int F_212 ( struct V_679 * V_680 ,
struct V_1 * V_2 )
{
struct V_266 * V_276 ;
struct V_264 * V_265 ;
...
return 0 ;
V_4 = F_55 ( V_72 -> V_231 ) ;
if ( V_4 -> V_684 . V_682 . V_20 != & V_685 . V_20 )
return 0 ;
return & V_4 -> V_684 . V_682 == V_680 ;
}
static int F_213 ( struct V_679 * V_680 ,
struct V_1 * V_2 )
{
struct V_71 * V_72 ;
struct V_3 * V_4 ;
...
V_72 = F_64 ( V_2 ) ;
if ( ! V_72 -> V_231 ||
V_72 -> V_231 -> V_686 . V_682 . V_20 != & V_687 . V_20 )
return 0 ;
V_4 = F_55 ( V_72 -> V_231 ) ;
return & V_4 -> V_33 . V_686 . V_682 == V_680 ;
}
struct V_688 *
F_215 ( struct V_8 * V_323 )
{
struct V_3 * V_4 ;
unsigned long V_269 ;
int V_15 ;
...
if ( V_15 )
goto V_693;
V_15 = F_16 ( & V_4 -> V_2 . V_22 , & V_694 ) ;
if ( V_15 )
goto V_24;
V_4 -> V_33 . V_686 . V_682 . V_20 = & V_687 . V_20 ;
V_4 -> V_33 . V_686 . V_682 . V_695 = F_213 ;
V_4 -> V_33 . V_686 . V_682 . V_696 = & V_697 ;
V_4 -> V_33 . V_698 = sizeof( struct V_249 ) ;
F_216 ( & V_4 -> V_33 . V_686 ) ;
V_4 -> V_684 . V_682 . V_20 = & V_685 . V_20 ;
V_4 -> V_684 . V_682 . V_695 = F_212 ;
V_4 -> V_684 . V_682 . V_696 = & V_699 ;
F_216 ( & V_4 -> V_684 ) ;
V_4 -> V_681 . V_682 . V_20 = & V_683 . V_20 ;
V_4 -> V_681 . V_682 . V_695 = F_211 ;
V_4 -> V_681 . V_682 . V_696 = & V_700 ;
F_216 ( & V_4 -> V_681 ) ;
F_72 ( & V_324 , V_269 ) ;
F_130 ( & V_4 -> V_689 , & V_701 ) ;
F_74 ( & V_324 , V_269 ) ;
F_12 ( V_702 L_90 , V_323 -> V_223 ) ;
return & V_4 -> V_33 ;
V_24:
F_17 ( & V_4 -> V_2 ) ;
return NULL ;
...
F_218 ( & V_4 -> V_684 ) ;
F_218 ( & V_4 -> V_681 ) ;
F_218 ( & V_4 -> V_33 . V_686 ) ;
F_19 ( & V_4 -> V_2 . V_22 , & V_694 ) ;
F_17 ( & V_4 -> V_2 ) ;
F_92 ( & V_510 ) ;
return 0 ;
}
