...
static void F_8 ( struct V_9 * V_10 , struct V_24 * V_25 )
{
struct V_26 * V_27 ;
int V_28 = 1 ;
V_25 [ 0 ] . V_29 = V_30 ;
...
static int F_11 ( struct V_9 * V_10 , struct V_41 * V_42 ,
struct V_1 * V_43 )
{
struct V_44 * V_45 = ( void * ) V_42 -> V_5 ;
if ( F_12 ( V_43 -> V_4 ) < sizeof( * V_45 ) )
return - V_46 ;
F_13 ( L_1 , V_43 -> V_3 , F_12 ( V_45 -> V_47 ) ) ;
F_14 ( V_42 , sizeof( * V_45 ) ) ;
return 0 ;
}
static int F_15 ( struct V_9 * V_10 , struct V_41 * V_42 ,
struct V_1 * V_43 )
{
struct V_48 * V_49 = ( void * ) V_42 -> V_5 ;
T_2 V_4 = F_12 ( V_43 -> V_4 ) ;
struct V_50 * V_51 ;
T_2 V_52 ;
T_1 V_53 ;
struct V_26 * V_27 ;
if ( V_4 < sizeof( * V_49 ) )
return - V_46 ;
F_14 ( V_42 , sizeof( * V_49 ) ) ;
V_52 = F_12 ( V_49 -> V_52 ) ;
F_13 ( L_2 , F_12 ( V_49 -> V_54 ) , V_52 ) ;
while ( V_52 & V_55 ) {
if ( V_4 < sizeof( V_52 ) )
return - V_46 ;
V_52 = F_16 ( V_42 -> V_5 ) ;
...
return - V_46 ;
V_4 -= sizeof( * V_51 ) ;
F_14 ( V_42 , sizeof( * V_51 ) ) ;
V_52 = F_12 ( V_51 -> V_52 ) ;
F_13 ( L_2 , F_12 ( V_51 -> V_54 ) , V_52 ) ;
while ( V_52 & V_55 ) {
if ( V_4 < sizeof( V_52 ) )
return - V_46 ;
V_52 = F_16 ( V_42 -> V_5 ) ;
...
F_13 ( L_4 , V_25 -> V_29 , V_25 -> type ,
V_25 -> V_32 ) ;
if ( V_25 -> V_29 != V_30 && V_25 -> type != V_31 ) {
struct V_62 V_49 ;
V_61 = true ;
V_49 . V_29 = V_25 -> V_29 ;
F_4 ( V_10 , V_63 , F_7 ( V_10 ) ,
sizeof( V_49 ) , & V_49 ) ;
}
V_4 -= sizeof( * V_25 ) ;
V_25 = ( void * ) F_14 ( V_42 , sizeof( * V_25 ) ) ;
}
if ( ! V_61 ) {
struct V_64 * V_65 = V_10 -> V_64 ;
struct V_11 * V_12 ;
F_22 ( & V_65 -> V_66 ) ;
F_9 (chan, &conn->chan_l, list) {
F_13 ( L_5 , V_12 ,
F_23 ( V_12 -> V_67 ) ) ;
if ( V_12 -> V_68 == V_69 )
continue;
...
F_13 ( L_6 , V_25 -> V_29 , V_25 -> type ,
V_25 -> V_32 ) ;
V_25 = (struct V_24 * ) F_14 ( V_42 , sizeof( * V_25 ) ) ;
}
return 0 ;
}
...
struct V_77 V_49 ;
struct V_78 * V_79 ;
if ( F_12 ( V_43 -> V_4 ) < sizeof( * V_51 ) )
return - V_46 ;
F_13 ( L_8 , V_51 -> V_29 , V_51 -> V_32 ) ;
if ( V_51 -> V_32 )
return - V_46 ;
...
return - V_58 ;
V_49 . V_29 = V_51 -> V_29 ;
F_4 ( V_10 , V_80 , F_7 ( V_10 ) , sizeof( V_49 ) ,
& V_49 ) ;
F_14 ( V_42 , sizeof( * V_51 ) ) ;
return 0 ;
}
...
if ( ! V_87 )
goto V_74;
F_13 ( L_10 , V_87 , V_27 -> V_29 , V_51 -> V_29 ) ;
...
if ( V_79 ) {
T_3 V_88 = F_12 ( V_43 -> V_4 ) - sizeof( * V_49 ) ;
T_1 * V_89 ;
...
V_43 = ( void * ) V_42 -> V_5 ;
V_4 = F_12 ( V_43 -> V_4 ) ;
F_13 ( L_15 , V_43 -> V_2 , V_43 -> V_3 , V_4 ) ;
F_14 ( V_42 , sizeof( * V_43 ) ) ;
...
unsigned long V_4 , int V_117 )
{
return F_60 ( V_4 , V_8 ) ;
}
static struct V_11 * F_61 ( struct V_64 * V_65 , bool V_118 )
{
struct V_11 * V_12 ;
int V_109 ;
V_12 = F_62 () ;
...
V_12 -> V_121 = & V_122 ;
F_63 ( V_12 ) ;
V_12 -> V_123 = V_12 -> V_124 ;
V_12 -> V_125 = V_12 -> V_126 ;
V_12 -> V_127 = V_128 ;
V_12 -> V_129 = V_130 ;
F_64 ( & V_12 -> V_131 ) ;
V_12 -> V_132 = V_133 ;
...
F_68 ( V_65 , V_12 ) ;
V_12 -> V_135 = V_12 -> V_136 ;
V_12 -> V_137 = V_12 -> V_136 ;
V_12 -> V_67 = V_138 ;
return V_12 ;
}
struct V_9 * F_54 ( struct V_9 * V_10 )
{
F_13 ( L_19 , V_10 , F_69 ( & V_10 -> V_139 . V_140 ) ) ;
F_70 ( & V_10 -> V_139 ) ;
return V_10 ;
}
static void F_71 ( struct V_139 * V_139 )
{
struct V_9 * V_10 = F_72 ( V_139 , struct V_9 , V_139 ) ;
F_13 ( L_20 , V_10 ) ;
F_22 ( & V_141 ) ;
F_73 ( & V_10 -> V_142 ) ;
F_27 ( & V_141 ) ;
...
{
F_13 ( L_19 , V_10 , F_69 ( & V_10 -> V_139 . V_140 ) ) ;
return F_75 ( & V_10 -> V_139 , & F_71 ) ;
}
static struct V_9 * F_76 ( struct V_64 * V_65 , bool V_118 )
{
struct V_9 * V_10 ;
struct V_11 * V_12 ;
...
F_79 ( & V_10 -> V_144 ) ;
F_22 ( & V_141 ) ;
F_80 ( & V_10 -> V_142 , & V_145 ) ;
F_27 ( & V_141 ) ;
return V_10 ;
}
struct V_11 * F_81 ( struct V_64 * V_65 ,
struct V_41 * V_42 )
{
struct V_9 * V_10 ;
if ( V_65 -> V_87 -> type != V_146 )
return NULL ;
V_10 = F_76 ( V_65 , false ) ;
if ( ! V_10 ) {
F_51 ( L_22 ) ;
return NULL ;
}
...
struct V_9 * V_10 ;
F_22 ( & V_141 ) ;
F_9 (mgr, &amp_mgr_list, list) {
if ( F_82 ( V_67 , & V_10 -> V_67 ) ) {
F_54 ( V_10 ) ;
F_27 ( & V_141 ) ;
return V_10 ;
}
...
if ( ! V_10 )
return;
F_13 ( L_24 , V_27 -> V_147 , V_10 ) ;
V_51 . V_29 = V_27 -> V_29 ;
V_51 . V_32 = V_72 ;
if ( V_27 -> V_36 != V_31 ) {
V_51 . V_32 = 0 ;
V_51 . V_148 = F_84 ( V_27 -> V_149 ) ;
V_51 . V_150 = F_84 ( V_27 -> V_151 ) ;
V_51 . V_152 = F_84 ( V_27 -> V_153 ) ;
V_51 . V_154 = F_3 ( V_27 -> V_155 ) ;
V_51 . V_156 = F_3 ( V_27 -> V_157 ) ;
}
F_4 ( V_10 , V_73 , V_10 -> V_3 , sizeof( V_51 ) , & V_51 ) ;
F_38 ( V_10 ) ;
}
void F_85 ( struct V_26 * V_27 , T_1 V_32 )
{
struct V_9 * V_10 ;
struct V_90 * V_158 = & V_27 -> V_158 ;
struct V_83 * V_51 ;
T_3 V_4 ;
V_10 = F_37 ( V_82 ) ;
if ( ! V_10 )
return;
F_13 ( L_24 , V_27 -> V_147 , V_10 ) ;
V_4 = sizeof( struct V_83 ) + V_158 -> V_4 ;
V_51 = F_2 ( V_4 , V_8 ) ;
if ( ! V_51 ) {
F_38 ( V_10 ) ;
return;
...
V_51 -> V_32 = V_101 ;
memcpy ( V_51 -> V_90 , V_158 -> V_5 , V_158 -> V_4 ) ;
}
...
if ( ! V_10 )
return;
V_4 = sizeof( * V_49 ) + V_158 -> V_4 ;
F_13 ( L_25 , V_27 -> V_147 , V_10 , V_4 ) ;
V_49 = F_2 ( V_4 , V_8 ) ;
if ( ! V_49 ) {
F_38 ( V_10 ) ;
return;
...
V_49 -> V_97 = V_27 -> V_29 ;
V_49 -> V_98 = V_93 -> V_94 ;
memcpy ( V_49 -> V_90 , V_158 -> V_5 , V_158 -> V_4 ) ;
F_4 ( V_10 , V_113 , F_7 ( V_10 ) , V_4 , V_49 ) ;
V_107:
F_38 ( V_10 ) ;
F_6 ( V_49 ) ;
}
...
if ( ! V_10 )
return;
V_160 = F_88 ( V_27 , V_104 , V_70 ) ;
if ( ! V_160 ) {
V_51 . V_32 = V_100 ;
} else {
V_51 . V_98 = V_160 -> V_98 ;
V_51 . V_32 = V_101 ;
}
F_13 ( L_26 , V_27 -> V_147 , V_10 , V_160 ,
V_32 ) ;
V_51 . V_97 = V_27 -> V_29 ;
