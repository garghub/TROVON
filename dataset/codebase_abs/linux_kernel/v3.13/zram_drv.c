...
static void F_78 ( struct V_1 * V_1 , struct V_34 * V_34 , int V_87 )
{
int V_103 , V_56 ;
T_2 V_25 ;
struct V_30 * V_31 ;
...
F_80 ( V_109 , & V_34 -> V_110 ) ;
F_81 ( V_34 , 0 ) ;
return;
V_47:
F_82 ( V_34 ) ;
}
static void F_83 ( struct V_111 * V_95 , struct V_34 * V_34 )
{
...
{
struct V_1 * V_1 ;
V_1 = F_85 ( V_114 , struct V_1 , V_91 ) ;
F_62 ( & V_1 -> V_89 ) ;
F_58 ( V_1 ) ;
F_63 ( & V_1 -> V_89 ) ;
}
static void F_86 ( struct V_1 * V_1 , struct V_82 * V_83 )
{
F_59 ( & V_1 -> V_84 ) ;
V_83 -> V_86 = V_1 -> V_85 ;
V_1 -> V_85 = V_83 ;
...
static void F_87 ( struct V_100 * V_101 ,
unsigned long V_25 )
{
struct V_1 * V_1 ;
struct V_82 * V_83 ;
...
static int F_89 ( struct V_1 * V_1 , int V_117 )
{
int V_70 = - V_77 ;
F_90 ( & V_1 -> V_89 ) ;
F_90 ( & V_1 -> V_23 ) ;
...
F_66 ( V_1 -> V_92 , 0 ) ;
F_97 ( V_1 -> V_92 -> V_95 , V_33 ) ;
F_98 ( V_1 -> V_92 -> V_95 ,
V_41 ) ;
F_99 ( V_1 -> V_92 -> V_95 , V_33 ) ;
F_100 ( V_1 -> V_92 -> V_95 , V_33 ) ;
F_101 ( V_1 -> V_92 ) ;
V_70 = F_102 ( & F_103 ( V_1 -> V_92 ) -> V_125 ,
& V_126 ) ;
if ( V_70 < 0 ) {
F_96 ( L_23 ) ;
goto V_127;
