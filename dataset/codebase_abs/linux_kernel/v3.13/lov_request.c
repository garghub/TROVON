...
int V_30 = 0 ;
F_26 ( & V_34 -> V_43 ) ;
if ( V_34 -> V_38 [ V_42 ] == NULL ||
V_34 -> V_38 [ V_42 ] -> V_40 ||
( V_34 -> V_38 [ V_42 ] -> V_44 != NULL &&
F_27 ( V_34 -> V_38 [ V_42 ] -> V_44 ) -> V_45 ) )
V_30 = 1 ;
F_28 ( & V_34 -> V_43 ) ;
return V_30 ;
}
int F_29 ( struct V_33 * V_34 , int V_46 )
{
T_1 V_47 ;
struct V_48 V_49 ;
struct V_50 * V_51 ;
...
if ( F_31 ( V_51 -> V_40 ) )
GOTO ( V_52 , V_30 = 1 ) ;
if ( V_51 -> V_44 && F_27 ( V_51 -> V_44 ) -> V_45 )
GOTO ( V_52 , V_30 = 0 ) ;
F_28 ( & V_34 -> V_43 ) ;
F_4 ( & V_47 ) ;
V_49 = F_32 ( F_33 ( V_53 ) ,
F_33 ( 1 ) , NULL , NULL ) ;
V_30 = F_34 ( V_47 , F_25 ( V_34 , V_46 ) , & V_49 ) ;
if ( V_51 != NULL && V_51 -> V_40 )
return 1 ;
return 0 ;
V_52:
F_28 ( & V_34 -> V_43 ) ;
...
struct V_55 * V_56 ,
struct V_57 * V_58 , int V_59 , int V_42 ,
...
int F_38 ( struct V_15 * V_16 , T_2 V_71 , int V_30 )
{
...
static int F_44 ( struct V_1 * V_2 , T_2 V_71 )
{
struct V_15 * V_16 ;
struct V_33 * V_34 = & V_2 -> V_35 -> V_36 -> V_37 . V_34 ;
int V_28 = F_16 ( & V_2 -> V_4 ) ;
...
if ( ! F_46 ( V_56 ) )
continue;
V_30 = F_47 ( V_34 -> V_38 [ V_16 -> V_39 ] -> V_44 ,
...
int F_48 ( struct V_1 * V_2 , T_2 V_71 , int V_30 ,
struct V_87 * V_88 )
{
int V_89 = 0 ;
if ( V_2 == NULL )
...
int F_57 ( struct V_1 * V_2 , T_2 V_71 , int V_59 )
{
int V_30 = 0 ;
if ( V_2 == NULL )
return 0 ;
...
struct V_94 * V_95 , T_4 * V_118 ,
T_2 V_71 , struct V_55 * V_119 ,
struct V_1 * * V_101 )
{
struct V_33 * V_34 = & exp -> V_36 -> V_37 . V_34 ;
struct V_1 * V_2 ;
...
V_16 -> V_18 . V_19 -> V_159 -- ;
F_17 ( V_160 , L_15 V_161 L_16 V_161 L_17 ,
...
sizeof( * V_16 -> V_18 . V_19 ) ) ;
V_16 -> V_18 . V_19 -> V_126 = V_58 -> V_69 ;
V_16 -> V_18 . V_19 -> V_124 |= V_164 ;
V_16 -> V_18 . V_19 -> V_142 = V_102 ;
V_16 -> V_18 . V_112 = F_82 ;
V_16 -> V_18 . V_109 . V_110 . V_107 = V_162 ;
V_16 -> V_18 . V_109 . V_110 . V_108 = V_163 ;
...
if ( ! F_55 ( V_81 -> V_20 , V_102 , V_107 , V_108 , & V_162 ,
& V_163 ) )
continue;
F_87 ( V_16 ) ;
if ( V_16 == NULL )
...
int F_88 ( struct V_165 * V_166 , struct V_167 * V_168 , int V_169 )
{
if ( V_169 ) {
T_2 V_170 = F_89 ( & V_166 -> V_37 . V_34 ,
V_171 , 0 ) ;
if ( V_168 -> V_172 != V_173 )
F_90 ( V_168 -> V_172 , V_170 ) ;
if ( V_168 -> V_174 != V_173 )
F_90 ( V_168 -> V_174 , V_170 ) ;
F_91 ( & V_166 -> V_175 ) ;
memcpy ( & V_166 -> V_176 , V_168 , sizeof( * V_168 ) ) ;
V_166 -> V_177 = F_92 () ;
F_93 ( & V_166 -> V_175 ) ;
return 0 ;
}
...
return 0 ;
if ( F_16 ( & V_2 -> V_4 ) ) {
V_30 = F_88 ( V_2 -> V_178 , V_2 -> V_73 -> V_22 ,
F_16 ( & V_2 -> V_5 ) ) ;
}
F_49 ( V_2 ) ;
return V_30 ;
}
void F_95 ( struct V_167 * V_168 , struct V_167 * V_179 ,
int V_169 )
{
int V_139 = 0 , V_180 = 0 ;
T_6 V_181 ;
...
if ( V_168 -> V_182 != V_179 -> V_182 ) {
V_181 = V_168 -> V_182 | V_179 -> V_182 ;
...
V_168 -> V_183 += V_179 -> V_183 ;
V_168 -> V_184 += V_179 -> V_184 ;
V_168 -> V_185 += V_179 -> V_185 ;
F_96 ( V_168 -> V_172 , V_179 -> V_172 ) ;
F_96 ( V_168 -> V_174 , V_179 -> V_174 ) ;
}
}
...
struct V_15 * V_84 ;
struct V_1 * V_2 ;
struct V_167 * V_168 , * V_179 ;
struct V_33 * V_34 ;
struct V_50 * V_51 ;
struct V_165 * V_186 , * V_187 ;
int V_169 ;
V_84 = F_43 ( V_81 , struct V_15 , V_18 ) ;
V_2 = V_84 -> V_41 ;
V_186 = V_2 -> V_178 ;
V_34 = & V_186 -> V_37 . V_34 ;
V_168 = V_2 -> V_73 -> V_22 ;
V_179 = V_81 -> V_22 ;
V_169 = F_16 ( & V_2 -> V_5 ) ;
F_19 ( V_2 , V_84 , V_30 ) ;
...
GOTO ( V_52 , V_30 ) ;
F_98 ( V_186 ) ;
V_51 = V_34 -> V_38 [ V_84 -> V_39 ] ;
if ( ! V_51 || ! V_51 -> V_40 )
GOTO ( V_188 , V_30 ) ;
V_187 = F_99 ( V_51 -> V_44 ) ;
F_91 ( & V_187 -> V_175 ) ;
memcpy ( & V_187 -> V_176 , V_179 , sizeof( * V_179 ) ) ;
if ( ( V_81 -> V_77 & V_189 ) == 0 )
V_187 -> V_177 = F_92 () ;
F_93 ( & V_187 -> V_175 ) ;
V_188:
F_95 ( V_168 , V_179 , V_169 ) ;
F_100 ( V_186 ) ;
V_52:
if ( V_2 -> V_73 -> V_77 & V_190 &&
F_15 ( V_2 , 0 ) ) {
...
int F_102 ( struct V_165 * V_166 , struct V_72 * V_81 ,
struct V_1 * * V_101 )
{
struct V_1 * V_2 ;
struct V_33 * V_34 = & V_166 -> V_37 . V_34 ;
int V_30 = 0 , V_102 ;
F_52 ( V_2 , sizeof( * V_2 ) ) ;
if ( V_2 == NULL )
return - V_103 ;
...
V_2 -> V_178 = V_166 ;
V_2 -> V_73 = V_81 ;
for ( V_102 = 0 ; V_102 < V_34 -> V_191 . V_192 ; V_102 ++ ) {
struct V_15 * V_16 ;
...
if ( ! V_34 -> V_38 [ V_102 ] -> V_44 ) {
F_17 ( V_111 , L_18 , V_102 ) ;
continue;
}
F_52 ( V_16 , sizeof( * V_16 ) ) ;
if ( V_16 == NULL )
