...
return - V_45 ;
V_12 = F_22 ( V_28 , V_4 , V_31 , V_32 , & V_16 , & V_46 ) ;
if ( V_12 < 0 )
return V_12 ;
V_15 = F_23 ( V_31 [ V_44 ] ) ;
V_41 = F_24 ( V_31 [ V_42 ] ) ;
...
memcpy ( V_20 , F_25 ( V_31 [ V_43 ] ) , V_40 ) ;
V_25 . V_50 = V_41 ;
V_25 . V_14 = (struct V_33 V_51 * ) V_20 ;
V_12 = F_26 ( & V_38 , & V_25 ) ;
if ( V_12 )
goto V_52;
F_14 ( V_4 ) ;
...
V_11 -> V_6 . V_15 = V_15 ;
F_16 ( V_4 ) ;
F_27 ( V_4 , & V_11 -> V_6 , V_29 ) ;
F_28 ( V_4 , & V_11 -> V_16 , & V_16 ) ;
if ( V_39 )
F_11 ( V_39 ) ;
if ( V_34 )
F_12 ( V_34 ) ;
...
struct V_7 * V_8 )
{
unsigned int V_53 = 0x80000000 ;
do {
if ( ++ V_8 -> V_54 == 0x7FFFFFFF )
V_8 -> V_54 = 1 ;
} while ( -- V_53 > 0 && F_19 ( V_4 , V_8 -> V_54 ) );
if ( V_53 == 0 )
F_30 ( L_1 ) ;
return V_53 ;
}
static int F_31 ( struct V_28 * V_28 , struct V_1 * V_55 ,
struct V_3 * V_4 , unsigned long V_29 ,
T_1 V_26 , struct V_30 * * V_56 ,
unsigned long * V_21 )
{
struct V_7 * V_8 = V_4 -> V_9 ;
struct V_10 * V_11 = (struct V_10 * ) * V_21 ;
struct V_30 * V_31 [ V_57 + 1 ] ;
int V_12 ;
if ( V_56 [ V_58 ] == NULL )
return - V_45 ;
V_12 = F_32 ( V_31 , V_57 , V_56 [ V_58 ] , V_59 ) ;
if ( V_12 < 0 )
return V_12 ;
if ( V_11 != NULL ) {
...
V_12 = F_21 ( V_28 , V_4 , V_11 , V_29 , V_31 , V_56 [ V_60 ] ) ;
if ( V_12 < 0 )
goto V_48;
F_14 ( V_4 ) ;
F_33 ( & V_11 -> V_23 , & V_8 -> V_19 ) ;
F_16 ( V_4 ) ;
...
static int F_34 ( struct V_3 * V_4 , unsigned long V_61 ,
struct V_1 * V_2 , struct V_62 * V_63 )
{
struct V_10 * V_11 = (struct V_10 * ) V_61 ;
struct V_30 * V_64 , * V_65 ;
if ( V_11 == NULL )
return V_2 -> V_50 ;
V_63 -> V_66 = V_11 -> V_26 ;
V_64 = F_35 ( V_2 , V_58 ) ;
if ( V_64 == NULL )
goto V_67;
if ( F_36 ( V_2 , V_44 , V_11 -> V_6 . V_15 ) )
goto V_67;
if ( F_37 ( V_2 , V_42 , V_11 -> V_41 ) )
goto V_67;
V_65 = F_38 ( V_2 , V_43 , V_11 -> V_41 *
sizeof( struct V_33 ) ) ;
if ( V_65 == NULL )
goto V_67;
memcpy ( F_25 ( V_65 ) , V_11 -> V_20 , F_39 ( V_65 ) ) ;
if ( F_40 ( V_2 , & V_11 -> V_16 , & V_46 ) < 0 )
goto V_67;
F_41 ( V_2 , V_64 ) ;
if ( F_42 ( V_2 , & V_11 -> V_16 , & V_46 ) < 0 )
goto V_67;
return V_2 -> V_50 ;
V_67:
F_43 ( V_2 , V_64 ) ;
...
static void F_44 ( struct V_3 * V_4 , struct V_68 * V_21 )
{
struct V_7 * V_8 = V_4 -> V_9 ;
struct V_10 * V_11 ;
F_2 (prog, &head->plist, link) {
if ( V_21 -> V_69 < V_21 -> V_70 )
goto V_70;
if ( V_21 -> V_71 ( V_4 , ( unsigned long ) V_11 , V_21 ) < 0 ) {
V_21 -> V_72 = 1 ;
break;
}
V_70:
