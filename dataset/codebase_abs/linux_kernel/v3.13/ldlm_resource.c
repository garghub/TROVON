...
F_24 ( F_74 ( V_29 ) ) ,
F_89 ( & V_29 -> V_169 ) - 1 ) ;
F_7 ( L_41 V_170 L_42 V_170 L_42 V_170 L_42
V_170 L_43 , V_29 ,
V_29 -> V_102 . V_66 [ 0 ] , V_29 -> V_102 . V_66 [ 1 ] ,
V_29 -> V_102 . V_66 [ 2 ] , V_29 -> V_102 . V_66 [ 3 ] ,
F_89 ( & V_29 -> V_169 ) - 1 ) ;
F_90 ( V_171 , V_29 ) ;
F_79 ( V_29 ) ;
return 0 ;
...
F_91 ( V_27 -> V_62 , F_86 , & V_150 ) ;
F_91 ( V_27 -> V_62 , F_88 , NULL ) ;
return V_173 ;
}
static int F_92 ( struct V_26 * V_27 , int V_174 )
{
F_69 ( V_27 , V_174 ? V_152 : 0 ) ;
if ( F_89 ( & V_27 -> V_135 ) > 0 ) {
struct V_175 V_176 = F_93 ( V_177 , NULL ) ;
int V_8 ;
F_23 ( V_6 ,
L_45 ,
F_24 ( V_27 ) , F_89 ( & V_27 -> V_135 ) ) ;
V_178:
if ( V_174 )
V_176 = F_94 ( V_179 * V_180 / 4 , NULL , NULL ) ;
V_8 = F_95 ( V_27 -> V_136 ,
F_89 ( & V_27 -> V_135 ) == 0 , & V_176 ) ;
if ( V_174 && V_8 == - V_181 ) {
F_96 ( L_46
L_47
L_48 , F_24 ( V_27 ) ,
...
F_103 ( V_27 , V_27 -> V_131 ) ;
F_104 ( & V_27 -> V_146 ) ;
F_31 ( V_27 ) ;
F_70 ( V_27 -> V_62 ) ;
F_4 ( F_105 ( & V_27 -> V_132 ) ) ;
F_71 ( V_27 ) ;
F_72 () ;
}
...
{
return F_110 ( & V_27 -> V_135 ) ;
}
void F_111 ( struct V_26 * V_27 )
{
if ( F_112 ( & V_27 -> V_135 , & V_27 -> V_134 ) ) {
F_113 ( & V_27 -> V_136 ) ;
F_99 ( & V_27 -> V_134 ) ;
}
}
...
F_114 ( F_115 ( V_105 ) ) ;
F_4 ( F_105 ( & V_27 -> V_132 ) ) ;
F_116 ( & V_27 -> V_132 , F_117 ( V_105 ) ) ;
F_118 ( V_105 ) ;
F_119 ( F_115 ( V_105 ) ) ;
}
void F_103 ( struct V_26 * V_27 , T_6 V_105 )
{
F_114 ( F_115 ( V_105 ) ) ;
F_4 ( ! F_105 ( & V_27 -> V_132 ) ) ;
F_120 ( & V_27 -> V_132 ) ;
...
{
F_4 ( ! F_105 ( & V_27 -> V_132 ) ) ;
F_4 ( F_123 ( F_115 ( V_105 ) ) ) ;
F_124 ( & V_27 -> V_132 , F_125 ( V_105 ) ) ;
}
...
struct V_26 * F_127 ( T_6 V_105 )
{
F_4 ( F_123 ( F_115 ( V_105 ) ) ) ;
F_4 ( ! F_105 ( F_125 ( V_105 ) ) ) ;
return F_128 ( F_125 ( V_105 ) -> V_185 ,
struct V_26 , V_132 ) ;
}
static struct V_100 * F_129 ( void )
{
struct V_100 * V_29 ;
int V_111 ;
F_130 ( V_29 , V_186 , V_187 ) ;
if ( V_29 == NULL )
return NULL ;
F_62 ( & V_29 -> V_166 ) ;
F_62 ( & V_29 -> V_167 ) ;
...
struct V_100 *
F_133 ( struct V_26 * V_27 , struct V_100 * V_196 ,
...
F_4 ( V_27 -> V_62 != NULL ) ;
F_4 ( V_66 -> V_66 [ 0 ] != 0 ) ;
F_134 ( V_27 -> V_62 , ( void * ) V_66 , & V_31 , 0 ) ;
V_99 = F_135 ( V_27 -> V_62 , & V_31 , ( void * ) V_66 ) ;
if ( V_99 != NULL ) {
F_136 ( V_27 -> V_62 , & V_31 , 0 ) ;
V_29 = F_46 ( V_99 , struct V_100 , V_101 ) ;
if ( V_27 -> V_200 && V_27 -> V_200 -> V_201 ) {
F_114 ( & V_29 -> V_195 ) ;
F_119 ( & V_29 -> V_195 ) ;
}
if ( F_137 ( V_29 -> V_202 < 0 ) ) {
F_55 ( V_29 ) ;
V_29 = NULL ;
}
return V_29 ;
...
V_29 -> V_206 = type ;
V_29 -> V_207 = V_208 ;
F_140 ( V_27 -> V_62 , & V_31 , 1 ) ;
V_99 = ( V_198 == F_138 ( & V_31 ) ) ? NULL :
F_135 ( V_27 -> V_62 , & V_31 , ( void * ) V_66 ) ;
if ( V_99 != NULL ) {
F_136 ( V_27 -> V_62 , & V_31 , 1 ) ;
F_141 ( & V_29 -> V_194 ) ;
F_119 ( & V_29 -> V_195 ) ;
F_142 ( V_29 , V_186 , sizeof( * V_29 ) ) ;
V_29 = F_46 ( V_99 , struct V_100 , V_101 ) ;
if ( V_27 -> V_200 && V_27 -> V_200 -> V_201 ) {
F_114 ( & V_29 -> V_195 ) ;
F_119 ( & V_29 -> V_195 ) ;
...
F_143 ( V_27 -> V_62 , & V_31 , & V_29 -> V_101 ) ;
if ( F_14 ( & V_31 ) == 1 )
V_199 = F_109 ( V_27 ) ;
F_136 ( V_27 -> V_62 , & V_31 , 1 ) ;
if ( V_27 -> V_200 && V_27 -> V_200 -> V_201 ) {
...
if ( V_8 < 0 ) {
F_7 ( L_53 V_210 L_54
V_210 L_55 , V_27 -> V_129 -> V_211 ,
V_66 -> V_66 [ 0 ] , V_66 -> V_66 [ 1 ] , V_8 ) ;
if ( V_29 -> V_212 ) {
F_145 ( V_29 -> V_212 , V_29 -> V_202 ) ;
V_29 -> V_212 = NULL ;
}
V_29 -> V_202 = V_8 ;
F_119 ( & V_29 -> V_195 ) ;
...
struct V_30 V_31 ;
F_149 ( & V_29 -> V_169 , 0 , V_214 ) ;
F_23 ( V_172 , L_57 ,
V_29 , F_89 ( & V_29 -> V_169 ) - 1 ) ;
F_150 ( V_27 -> V_62 , & V_29 -> V_102 , & V_31 ) ;
if ( F_151 ( V_27 -> V_62 , & V_31 , & V_29 -> V_169 ) ) {
F_146 ( & V_31 , V_29 ) ;
F_136 ( V_27 -> V_62 , & V_31 , 1 ) ;
...
void F_153 ( struct V_100 * V_29 , struct V_148 * V_216 ,
struct V_153 * V_154 )
{
F_154 ( V_29 ) ;
F_80 ( V_154 , L_58 ) ;
...
F_4 ( F_105 ( & V_154 -> V_155 ) ) ;
F_155 ( & V_154 -> V_155 , V_216 ) ;
}
void F_156 ( struct V_153 * V_219 ,
struct V_153 * V_220 )
{
struct V_100 * V_29 = V_219 -> V_221 ;
F_154 ( V_29 ) ;
F_90 ( V_172 , V_29 ) ;
F_80 ( V_220 , L_60 , V_219 ) ;
if ( V_220 -> V_156 & V_217 ) {
F_23 ( V_218 , L_59 ) ;
goto V_222;
}
F_4 ( F_105 ( & V_220 -> V_155 ) ) ;
F_116 ( & V_220 -> V_155 , & V_219 -> V_155 ) ;
V_222: ;
}
...
void F_159 ( struct V_100 * V_29 , struct V_226 * V_227 )
{
...
static int F_161 ( struct V_79 * V_80 , struct V_30 * V_31 ,
struct V_98 * V_99 , void * V_165 )
{
struct V_100 * V_29 = F_87 ( V_80 , V_99 ) ;
...
void F_160 ( int V_228 , struct V_26 * V_27 )
{
if ( ! ( ( V_229 | V_171 ) & V_228 ) )
return;
F_23 ( V_228 , L_61 ,
...
void F_90 ( int V_228 , struct V_100 * V_29 )
{
struct V_153 * V_154 ;
...
if ( ! ( ( V_229 | V_171 ) & V_228 ) )
return;
F_23 ( V_228 , L_64 V_170 L_42 V_170 L_42 V_170 L_42 V_170
L_43 , V_29 , V_29 -> V_102 . V_66 [ 0 ] , V_29 -> V_102 . V_66 [ 1 ] ,
V_29 -> V_102 . V_66 [ 2 ] , V_29 -> V_102 . V_66 [ 3 ] ,
F_89 ( & V_29 -> V_169 ) ) ;
if ( ! F_105 ( & V_29 -> V_166 ) ) {
F_23 ( V_228 , L_65 ) ;
