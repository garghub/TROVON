...
V_41 -> V_65 = F_36 ( V_41 -> V_95 . V_100 + 2 ) ;
if ( V_41 -> V_65 == NULL ) {
F_19 ( V_102 L_5 , V_2 -> V_56 ) ;
return ERROR ;
}
F_37 ( V_41 -> V_65 , 2 ) ;
F_38 ( V_41 -> V_65 , V_41 -> V_95 . V_100 ) ;
V_41 -> V_65 -> V_2 = V_2 ;
V_41 -> V_57 = V_103 ;
V_41 -> V_104 = 0 ;
V_41 -> V_105 = 0 ;
...
{
int V_131 ;
V_131 = F_57 ( V_65 , V_2 , type , V_129 , V_130 , V_114 ) ;
if ( V_131 >= 0 )
F_52 ( V_2 , (struct V_78 * ) V_65 -> V_11 ) ;
return V_131 ;
}
static int F_58 ( const struct V_132 * V_133 ,
struct V_134 * V_135 , T_2 type )
{
int V_131 ;
V_131 = F_59 ( V_133 , V_135 , type ) ;
if ( V_131 == 0 ) {
struct V_78 * V_79 ;
...
static int
F_73 ( struct V_1 * V_2 , struct V_142 * V_143 , int V_144 )
{
struct V_6 * V_12 = F_2 ( V_2 ) ;
...
static int T_4 F_86 ( char * V_172 )
{
int V_173 [ 4 ] ;
V_172 = F_87 ( V_172 , F_88 ( V_173 ) , V_173 ) ;
if ( ! strncmp ( V_172 , L_29 , 7 ) ) {
int V_174 = F_89 ( V_172 + 7 , NULL , 10 ) ;
if ( V_175 < V_158 )
V_4 [ V_175 ++ ] = V_174 ;
else
F_19 ( V_166 L_30 ,
