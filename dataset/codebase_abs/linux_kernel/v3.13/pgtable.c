...
static void F_42 ( struct V_1 * V_2 , T_6 * V_35 )
{
int V_31 ;
for( V_31 = 0 ; V_31 < V_32 ; V_31 ++ ) {
T_6 V_17 = V_35 [ V_31 ] ;
if ( F_43 ( V_17 ) != 0 ) {
T_4 * V_13 = ( T_4 * ) F_44 ( V_17 ) ;
V_35 [ V_31 ] = F_45 ( 0 ) ;
F_15 ( F_43 ( V_17 ) >> V_14 ) ;
F_46 ( V_2 , V_13 ) ;
}
...
static void F_47 ( struct V_1 * V_2 , T_6 * V_17 , T_4 * V_30 [] )
{
T_5 * V_16 ;
int V_31 ;
if ( V_32 == 0 )
...
T_4 * V_13 = V_30 [ V_31 ] ;
if ( V_31 >= V_24 )
memcpy ( V_13 , ( T_4 * ) F_44 ( V_25 [ V_31 ] ) ,
sizeof( T_4 ) * V_36 ) ;
F_33 ( V_2 , V_16 , V_13 ) ;
}
}
T_6 * F_49 ( struct V_1 * V_2 )
{
T_6 * V_17 ;
T_4 * V_30 [ V_32 ] ;
V_17 = ( T_6 * ) F_2 ( V_4 ) ;
...
void F_51 ( struct V_1 * V_2 , T_6 * V_17 )
{
F_42 ( V_2 , V_17 ) ;
F_30 ( V_17 ) ;
F_52 ( V_2 , V_17 ) ;
...
T_1 V_43 , int V_44 )
{
int V_45 = ! F_54 ( * V_42 , V_43 ) ;
if ( V_45 && V_44 ) {
* V_42 = V_43 ;
F_55 ( V_41 -> V_46 , V_3 , V_42 ) ;
}
return V_45 ;
}
...
T_4 V_43 , int V_44 )
{
int V_45 = ! F_57 ( * V_47 , V_43 ) ;
F_58 ( V_3 & ~ V_48 ) ;
if ( V_45 && V_44 ) {
* V_47 = V_43 ;
F_59 ( V_41 -> V_46 , V_3 , V_47 ) ;
}
return V_45 ;
}
...
( unsigned long * ) V_47 ) ;
if ( V_50 )
F_66 ( V_41 -> V_46 , V_49 , V_47 ) ;
return V_50 ;
}
int F_67 ( struct V_40 * V_41 ,
unsigned long V_3 , T_1 * V_42 )
{
int V_52 ;
V_52 = F_60 ( V_41 , V_3 , V_42 ) ;
if ( V_52 )
F_68 ( V_41 , V_3 ) ;
return V_52 ;
}
...
int V_52 ;
F_58 ( V_3 & ~ V_48 ) ;
V_52 = F_64 ( V_41 , V_3 , V_47 ) ;
if ( V_52 )
F_70 ( V_41 , V_3 , V_3 + V_53 ) ;
return V_52 ;
}
void F_71 ( struct V_40 * V_41 ,
unsigned long V_3 , T_4 * V_47 )
{
int V_54 ;
F_58 ( V_3 & ~ V_48 ) ;
...
( unsigned long * ) V_47 ) ;
if ( V_54 ) {
F_66 ( V_41 -> V_46 , V_3 , V_47 ) ;
F_70 ( V_41 , V_3 , V_3 + V_53 ) ;
}
}
void T_3 F_73 ( unsigned long V_56 )
{
#ifdef F_74
F_75 ( V_57 > 0 ) ;
F_76 ( V_58 L_2 ,
...
void F_77 ( enum V_61 V_62 , T_1 V_6 )
{
unsigned long V_3 = F_78 ( V_62 ) ;
if ( V_62 >= V_63 ) {
F_79 () ;
return;
}
...
void F_81 ( enum V_61 V_62 , T_7 V_64 ,
T_8 V_65 )
{
F_77 ( V_62 , F_82 ( V_64 >> V_14 , V_65 ) ) ;
}
