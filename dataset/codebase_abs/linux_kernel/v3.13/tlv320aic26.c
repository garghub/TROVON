...
V_17 |= 0x0800 ;
F_6 ( V_8 , V_38 , V_17 ) ;
V_69 = F_17 ( V_8 -> V_19 , & V_73 ) ;
if ( V_69 )
F_18 ( V_8 -> V_19 , L_12 ) ;
return 0 ;
}
static int F_19 ( struct V_74 * V_18 )
{
struct V_9 * V_9 ;
int V_69 ;
F_3 ( & V_18 -> V_19 , L_13 ) ;
V_9 = F_20 ( & V_18 -> V_19 , sizeof *V_9 , V_75 ) ;
if ( ! V_9 )
return - V_76 ;
V_9 -> V_77 = F_21 ( V_18 , & V_78 ) ;
if ( F_22 ( V_9 -> V_77 ) )
return F_23 ( V_9 -> V_77 ) ;
V_9 -> V_18 = V_18 ;
F_24 ( & V_18 -> V_19 , V_9 ) ;
V_9 -> V_37 = 1 ;
V_69 = F_25 ( & V_18 -> V_19 ,
...
static int F_26 ( struct V_74 * V_18 )
{
F_27 ( & V_18 -> V_19 ) ;
return 0 ;
}
