...
int V_46 = - V_138 ;
int V_8 ;
V_11 = F_62 ( V_44 , sizeof( * V_11 ) , V_139 ) ;
if ( ! V_11 )
return - V_138 ;
F_63 ( & V_11 -> V_62 ) ;
F_64 ( & V_11 -> V_55 ) ;
V_11 -> V_45 = V_45 ;
if ( V_44 -> V_120 ) {
V_133 = F_65 ( V_140 , V_44 -> V_120 ) ;
if ( F_66 ( V_133 == NULL ) )
return - V_42 ;
V_135 = V_133 -> V_85 ;
V_11 -> V_15 = V_135 -> V_15 ;
V_46 = F_55 ( V_45 , V_11 ) ;
} else {
V_46 = F_53 ( V_45 , V_11 ) ;
}
...
V_11 -> V_141 = F_67 ( V_44 , L_23 ) ;
if ( F_16 ( V_11 -> V_141 ) )
return F_22 ( V_11 -> V_141 ) ;
V_137 = F_68 ( V_45 , V_142 , 0 ) ;
V_11 -> V_104 = F_69 ( V_44 , V_137 ) ;
if ( F_16 ( V_11 -> V_104 ) )
return F_22 ( V_11 -> V_104 ) ;
V_11 -> V_94 = F_70 ( V_45 , 0 ) ;
if ( V_11 -> V_94 < 0 ) {
F_24 ( V_44 , L_24 ) ;
return V_11 -> V_94 ;
}
for ( V_8 = 0 ; V_8 < V_143 ; V_8 ++ )
V_11 -> V_144 [ V_8 ] . V_145 = V_146 [ V_8 ] ;
V_46 = F_71 ( V_44 , V_143 ,
V_11 -> V_144 ) ;
if ( V_46 )
return V_46 ;
V_46 = F_20 ( V_11 ) ;
...
return V_46 ;
if ( V_11 -> V_111 )
V_46 = F_72 ( V_11 -> clock [ V_147 ] ,
V_11 -> V_111 ) ;
else
F_73 ( V_44 , L_25 ) ;
if ( V_46 < 0 )
goto V_148;
V_46 = F_74 ( V_11 -> clock [ V_147 ] ) ;
if ( V_46 < 0 )
goto V_148;
V_46 = F_75 ( V_44 , V_11 -> V_94 , F_51 ,
0 , F_76 ( V_44 ) , V_11 ) ;
if ( V_46 ) {
F_24 ( V_44 , L_26 ) ;
goto V_149;
...
F_77 ( & V_11 -> V_4 , & V_150 ) ;
V_11 -> V_4 . V_151 = V_152 ;
snprintf ( V_11 -> V_4 . V_51 , sizeof( V_11 -> V_4 . V_51 ) , L_27 ,
V_153 , V_11 -> V_70 ) ;
V_11 -> V_4 . V_54 |= V_154 ;
V_11 -> V_29 = & V_9 [ 0 ] ;
...
V_11 -> V_23 . V_25 = V_90 ;
V_11 -> V_23 . V_26 = V_91 ;
V_11 -> V_155 [ V_156 ] . V_54 = V_157 ;
V_11 -> V_155 [ V_80 ] . V_54 = V_158 ;
V_46 = F_78 ( & V_11 -> V_4 . V_159 ,
V_160 , V_11 -> V_155 , 0 ) ;
if ( V_46 < 0 )
goto V_149;
F_79 ( & V_11 -> V_4 , V_45 ) ;
F_80 ( V_45 , & V_11 -> V_4 ) ;
memcpy ( V_11 -> V_57 , V_161 , sizeof( V_11 -> V_57 ) ) ;
F_81 ( V_44 ) ;
F_82 ( & V_45 -> V_44 , L_28 ,
...
return 0 ;
V_149:
F_83 ( V_11 -> clock [ V_147 ] ) ;
V_148:
F_15 ( V_11 ) ;
return V_46 ;
}
static int F_84 ( struct V_43 * V_44 , bool V_162 )
{
struct V_107 * V_45 = F_85 ( V_44 ) ;
struct V_2 * V_4 = F_86 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
int V_46 = 0 ;
F_12 ( 1 , V_24 , V_4 , L_29 ,
V_61 , V_11 -> V_54 ) ;
F_37 ( & V_11 -> V_62 ) ;
if ( V_11 -> V_54 & V_87 ) {
F_28 ( V_11 ) ;
V_46 = F_87 ( V_11 -> V_141 ) ;
if ( V_46 )
goto V_65;
V_46 = F_88 ( V_143 ,
V_11 -> V_144 ) ;
...
static int F_89 ( struct V_43 * V_44 , bool V_162 )
{
struct V_107 * V_45 = F_85 ( V_44 ) ;
struct V_2 * V_4 = F_86 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
