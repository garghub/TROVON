...
V_35 = F_37 ( ( int ) V_38 , V_35 ) ;
if ( F_38 ( V_37 , V_4 -> V_36 , V_35 ) )
V_35 = - V_49 ;
}
F_30 ( & V_4 -> V_28 ) ;
return V_35 ;
...
static inline int
F_39 ( struct V_3 * V_4 , int V_38 )
{
return F_40 ( V_4 -> V_9 , V_4 -> V_10 , V_4 -> V_50 , V_38 ) ;
}
static T_2
F_41 ( struct V_17 * V_17 , const char T_3 * V_37 ,
T_4 V_38 , T_5 * V_39 )
{
unsigned long V_5 ;
int V_6 ;
...
V_38 = F_37 ( ( int ) V_38 , V_44 ) ;
if ( F_42 ( V_4 -> V_50 , V_37 , V_38 ) ) {
F_30 ( & V_4 -> V_29 ) ;
return - V_49 ;
}
F_2 ( & V_4 -> V_8 , V_5 ) ;
...
static unsigned int
F_43 ( struct V_17 * V_17 , struct V_51 * V_45 )
{
unsigned int V_52 = 0 ;
int V_6 = 0 ;
struct V_3 * V_4 = (struct V_3 * ) V_17 -> V_30 ;
unsigned long V_5 ;
F_44 ( V_17 , & V_4 -> V_12 , V_45 ) ;
F_44 ( V_17 , & V_4 -> V_14 , V_45 ) ;
F_2 ( & V_4 -> V_7 , V_5 ) ;
F_3 ( & V_4 -> V_8 ) ;
V_6 = F_4 ( V_4 -> V_9 , V_4 -> V_10 ) ;
F_7 ( & V_4 -> V_8 ) ;
