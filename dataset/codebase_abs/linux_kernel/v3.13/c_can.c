...
static int F_61 ( struct V_196 * V_197 , int V_148 )
{
T_2 V_198 ;
int V_176 = 0 ;
int V_199 = 0 ;
...
static T_5 F_63 ( int V_209 , void * V_210 )
{
...
V_143 = F_67 ( V_26 -> V_209 , & F_63 , V_215 , V_26 -> V_216 ,
V_26 ) ;
if ( V_143 < 0 ) {
F_20 ( V_26 , L_18 ) ;
goto V_217;
...
struct V_25 * F_74 ( void )
{
struct V_25 * V_26 ;
struct V_1 * V_2 ;
V_26 = F_75 ( sizeof( struct V_1 ) , V_220 ) ;
if ( ! V_26 )
return NULL ;
V_2 = F_18 ( V_26 ) ;
F_76 ( V_26 , & V_2 -> V_197 , F_61 , V_221 ) ;
V_2 -> V_26 = V_26 ;
