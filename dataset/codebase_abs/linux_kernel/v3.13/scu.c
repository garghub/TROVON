...
bool F_11 ( struct V_3 * V_4 )
{
struct V_30 * V_31 = F_12 ( V_4 ) ;
T_1 V_32 = F_13 ( V_31 ) ;
return ! ! ( V_32 & V_33 ) ;
}
...
if ( V_36 < 0 )
return V_36 ;
V_36 = F_7 ( V_2 , V_4 , V_6 , V_8 ) ;
if ( V_36 < 0 )
return V_36 ;
V_36 = F_8 ( V_2 , V_4 , V_6 , V_8 ) ;
if ( V_36 < 0 )
return V_36 ;
F_17 ( V_35 , L_2 , F_18 ( V_4 ) , F_3 ( V_4 ) ) ;
return 0 ;
}
struct V_3 * F_19 ( struct V_1 * V_2 , int V_14 )
{
if ( F_20 ( V_14 < 0 || V_14 >= F_21 ( V_2 ) ) )
V_14 = 0 ;
...
int V_41 , V_42 ;
V_42 = V_40 -> V_43 ;
V_31 = F_23 ( V_35 , sizeof( * V_31 ) * V_42 , V_44 ) ;
if ( ! V_31 ) {
F_24 ( V_35 , L_3 ) ;
return - V_45 ;
}
