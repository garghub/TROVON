...
{
int V_56 ;
V_56 = F_30 ( V_6 , 7 , 9 , V_106 ) ;
if ( V_56 < 0 ) {
F_31 ( V_6 -> V_107 , L_3 , V_56 ) ;
return V_56 ;
}
F_4 ( V_6 , V_108 , 0 ) ;
F_24 ( V_6 , V_100 ) ;
...
struct V_57 * V_57 ;
int V_56 ;
if ( ! F_35 ( V_121 -> V_124 , V_125 ) )
return - V_47 ;
V_57 = F_36 ( & V_121 -> V_107 , sizeof( struct V_57 ) , V_126 ) ;
if ( V_57 == NULL )
return - V_127 ;
V_57 -> V_105 = F_37 ( V_121 , & V_128 ) ;
if ( F_38 ( V_57 -> V_105 ) )
return F_39 ( V_57 -> V_105 ) ;
F_40 ( V_121 , V_57 ) ;
V_56 = F_41 ( & V_121 -> V_107 ,
& V_129 , & V_130 , 1 ) ;
return V_56 ;
}
static int T_3 F_42 ( struct V_120 * V_121 )
{
F_43 ( & V_121 -> V_107 ) ;
return 0 ;
}
