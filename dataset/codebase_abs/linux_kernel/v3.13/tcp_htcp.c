...
static void F_19 ( struct V_11 * V_12 , T_1 V_46 , T_1 V_47 , T_1 V_48 )
{
...
if ( ( V_14 -> V_49 * V_2 -> V_32 ) >> 7 >= V_14 -> V_15 ) {
if ( V_14 -> V_15 < V_14 -> V_50 )
V_14 -> V_15 ++ ;
V_14 -> V_49 = 0 ;
F_15 ( V_2 ) ;
} else
...
static void F_23 ( struct V_11 * V_12 , T_4 V_51 )
{
switch ( V_51 ) {
case V_22 :
{
