...
static bool F_33 ( struct V_82 V_73 )
{
bool V_44 ;
V_44 = ( ( V_73 . V_82 [ 7 ] == 0 ) &&
( V_73 . V_82 [ 6 ] == 0 ) &&
...
F_36 ( V_2 -> V_25 , V_120 ,
& V_115 -> V_121 ) ;
V_115 -> V_122 = F_37 ( V_2 -> V_25 -> V_123 ,
V_2 -> V_25 -> V_124 ) ;
V_115 -> V_125 = V_126 ;
V_115 -> V_127 = V_128 ;
V_115 -> V_129 = V_130 ;
V_115 -> V_131 . V_132 = V_2 -> V_25 -> V_133 -> V_134 ;
V_115 -> V_131 . V_135 = F_38 ( V_2 -> V_25 -> V_136 ) ;
V_115 -> V_131 . V_137 = F_39 ( V_2 -> V_25 -> V_136 ) ;
memset ( V_115 -> V_138 , 0 , sizeof( V_115 -> V_138 ) ) ;
V_115 -> V_139 = F_40 ( F_41 ( V_2 -> V_140 ) ) ;
V_115 -> V_141 = F_42 ( F_41 ( V_2 -> V_140 ) ) ;
V_115 -> V_142 = F_40 ( F_43 ( V_2 -> V_140 ) ) ;
V_115 -> V_143 = F_42 ( F_43 ( V_2 -> V_140 ) ) ;
V_115 -> V_144 = F_42 ( F_43 ( V_2 -> V_145 ) ) ;
V_115 -> V_146 = F_40 ( F_43 ( V_2 -> V_145 ) ) ;
V_115 -> V_147 = F_41 ( V_2 -> V_145 ) ;
if ( F_31 ( V_148 , & V_2 -> V_149 ) )
V_115 -> V_150 = V_151
| V_152 ;
else
V_115 -> V_150 = V_153
...
static V_33 F_49 ( struct V_1 * V_2 , struct V_83 * V_76 )
{
struct V_38 V_43 ;
memset ( & V_43 , 0 , sizeof( V_43 ) ) ;
V_43 . V_2 = V_2 ;
...
V_249 -> V_257 . V_266 = F_38 ( V_2 -> V_25 -> V_136 ) ;
V_249 -> V_257 . V_267 = F_39 ( V_2 -> V_25 -> V_136 ) ;
V_251 = F_54 ( V_2 -> V_25 , V_268 ) ;
if ( V_251 ) {
T_3 V_269 ;
T_1 V_270 ;
F_55 ( V_2 -> V_25 ,
...
strcpy ( V_249 -> V_307 , F_56 ( V_2 ) ) ;
strcpy ( V_249 -> V_308 , F_35 ( V_2 ) ) ;
V_249 -> V_309 = V_310 ;
V_249 -> V_311 = 1 ;
...
if ( V_210 -> V_67 >= V_310 || ! F_33 ( V_73 ) ) {
V_207 -> V_21 = V_341 ;
break;
}
F_21 ( V_8 , V_2 , V_4 , NULL ) ;
V_8 -> V_48 = V_207 -> V_353 ;
V_8 -> V_12 += F_58 ( struct V_206 , V_95 . V_365 )
+ sizeof( struct V_209 ) ;
...
if ( F_31 ( V_394 , & V_2 -> V_72 ) )
V_388 -> V_395 = V_396 ;
else if ( F_31 ( V_397 , & V_2 -> V_72 ) )
V_388 -> V_395 = V_398 ;
else if ( F_31 ( V_399 , & V_2 -> V_72 ) )
V_388 -> V_395 = V_400 ;
else if ( F_31 ( V_401 , & V_2 -> V_72 ) )
V_388 -> V_395 = V_402 ;
else if ( F_31 ( V_79 , & V_2 -> V_72 ) )
V_388 -> V_395 = V_403 ;
else
V_388 -> V_395 = V_404 ;
break;
...
int F_64 ( void * V_419 , int V_420 , void T_4 * V_421 )
{
...
|| ( V_420 > V_427 ) )
return - V_428 ;
if ( ! F_65 ( V_429 , V_421 , sizeof( struct V_422 ) ) ) {
F_19 ( V_430 ,
L_10
L_11 , V_420 ,
V_421 ) ;
...
V_53 = F_66 ( sizeof( struct V_422 ) , V_29 ) ;
if ( V_53 == NULL ) {
F_19 ( V_430 ,
L_12 ,
sizeof( struct V_422 ) ) ;
...
V_424 = F_67 ( V_53 , V_421 , sizeof( struct V_422 ) ) ;
if ( V_424 != 0 ) {
F_19 ( V_430 ,
L_13 ,
V_424 ,
...
case V_474 :
V_53 -> V_23 . V_436 =
F_49 ( V_2 , & V_53 -> V_95 . V_70 ) ;
break;
case V_475 :
V_53 -> V_23 . V_436 = F_61 ( V_2 ,
& V_53 -> V_95 .
V_410 ) ;
break;
case V_476 :
...
V_424 = F_76 ( V_421 , V_53 , sizeof( struct V_422 ) ) ;
if ( V_424 != 0 ) {
F_19 ( V_430 ,
L_18
L_19 , V_424 ,
...
int F_77 ( struct V_489 * V_490 , int V_420 , void T_4 * V_421 )
{
return F_64 ( V_490 -> V_470 -> V_419 , V_420 , V_421 ) ;
}
...
static int F_79 ( struct V_1 * V_2 , T_1 V_48 )
{
F_78 ( V_2 ) ;
V_2 -> V_14 . V_16 = V_48 ;
...
int V_496 = F_81 ( int , V_493 , sizeof( V_2 -> V_14 . V_23 ) ) ;
F_82 () ;
...
T_1 V_48 = V_520 -> V_527 . V_48 + F_58 (
struct V_519 ,
V_95 ) ;
if ( V_520 -> V_527 . V_527 == V_528 )
V_48 = F_58 ( struct V_519 , V_95 ) ;
if ( V_493 < F_58 ( struct V_519 , V_95 ) )
return - V_486 ;
if ( V_2 -> V_521 ) {
if ( V_2 -> V_523 < V_48 ) {
F_13 ( & V_2 -> V_25 -> V_26 ,
