...
bool V_107 = false ;
unsigned char * V_61 ;
struct V_108 * V_109 = F_40 ( & V_2 -> V_11 ) ;
...
&& ! F_41 ( V_105 , V_114 ) )
return - V_13 ;
V_20 = F_42 ( & V_2 -> V_11 , sizeof( struct V_20 ) , V_115 ) ;
if ( ! V_20 )
return - V_116 ;
F_43 ( V_2 , V_20 ) ;
V_20 -> V_2 = V_2 ;
V_20 -> type = V_97 -> V_103 ;
if ( V_109 && V_109 -> V_117 && V_101 -> V_118 )
F_7 ( V_2 , V_101 -> V_118 ,
V_119 | V_109 -> V_117 ) ;
V_61 = V_20 -> V_45 ;
if ( F_41 ( V_105 , V_114 ) ) {
...
if ( V_20 -> V_45 [ 0 ] & V_120 )
V_20 -> V_45 [ 0 ] &= ~ V_120 ;
if ( V_20 -> V_2 -> V_36 > 0 && V_101 -> V_121 ) {
F_44 ( & V_20 -> V_19 , F_13 ) ;
V_20 -> V_45 [ 0 ] |= V_122
| V_110 [ V_20 -> type ] ;
...
V_131 = F_26 ( V_20 -> V_45 [ V_50 ] ) ;
if ( V_131 == 12 )
V_131 = 0 ;
if ( V_20 -> V_45 [ V_50 ] & V_132 )
V_131 += 12 ;
F_7 ( V_2 ,
V_50 << 4 | 0x08 ,
V_131 ) ;
...
V_20 -> V_25 = F_46 ( & V_2 -> V_11 , V_2 -> V_145 ,
& V_146 , V_147 ) ;
if ( F_47 ( V_20 -> V_25 ) ) {
V_98 = F_48 ( V_20 -> V_25 ) ;
F_5 ( & V_2 -> V_11 ,
...
V_20 -> V_92 -> V_89 . V_145 = L_29 ;
V_20 -> V_92 -> V_89 . V_151 = V_152 | V_153 ;
F_52 ( V_20 -> V_92 ) ;
V_20 -> V_92 -> V_154 = F_34 ;
V_20 -> V_92 -> V_155 = F_37 ;
V_20 -> V_92 -> V_93 = V_101 -> V_149 ;
V_20 -> V_94 = V_101 -> V_94 ;
V_98 = F_53 ( & V_2 -> V_11 . V_87 , V_20 -> V_92 ) ;
if ( V_98 )
goto V_150;
F_51 ( V_156 , & V_20 -> V_35 ) ;
...
if ( F_57 ( V_156 , & V_20 -> V_35 ) )
F_59 ( & V_2 -> V_11 . V_87 , V_20 -> V_92 ) ;
return 0 ;
}
