...
case V_62 :
case V_63 :
F_3 ( V_5 -> V_58 ) -> V_10 = F_34 ( V_57 ) ;
F_40 ( V_5 -> V_58 , 4 ) ;
F_41 ( V_2 -> V_20 , V_5 -> V_58 ) ;
V_5 -> V_58 = NULL ;
break;
default:
F_33 ( V_2 ) ;
...
static int F_42 ( struct V_1 * V_2 , unsigned char V_64 )
{
struct V_5 * V_5 = V_2 -> V_6 ;
F_37 ( V_2 ) ;
F_18 ( V_5 ) ;
...
const unsigned char * V_57 = V_5 -> V_58 -> V_3 ;
F_8 ( L_10 ,
V_2 -> V_20 -> V_21 , F_46 ( V_57 ) , F_39 ( V_57 ) ,
F_44 ( V_57 ) , F_38 ( V_57 ) , F_34 ( V_57 ) ,
F_35 ( V_57 ) ) ;
...
if ( F_38 ( V_57 ) && F_46 ( V_57 ) != V_5 -> V_59 ) {
F_28 ( L_12 ,
F_46 ( V_57 ) , V_5 -> V_59 ) ;
F_18 ( V_5 ) ;
return 0 ;
...
static int F_47 ( struct V_1 * V_2 , unsigned char V_64 )
{
struct V_5 * V_5 = V_2 -> V_6 ;
if ( V_64 == V_67 )
return 1 ;
...
static int F_49 ( struct V_1 * V_2 , unsigned char V_64 )
{
struct V_5 * V_5 = V_2 -> V_6 ;
if ( V_64 == V_67 )
V_5 -> V_65 = F_47 ;
...
static void F_50 ( struct V_5 * V_5 , unsigned char V_64 )
{
const T_2 V_70 = V_67 , V_71 = V_72 ;
const T_2 * V_73 = & V_64 ;
if ( ! F_51 ( V_74 , & V_5 -> V_19 ) && V_64 == V_72 ) {
F_20 ( V_74 , & V_5 -> V_19 ) ;
return;
}
if ( F_52 ( V_74 , & V_5 -> V_19 ) ) {
switch ( V_64 ) {
case V_75 :
V_73 = & V_70 ;
break;
...
static int F_54 ( struct V_1 * V_2 , void * V_3 , int V_77 )
{
struct V_5 * V_5 = V_2 -> V_6 ;
...
static int F_55 ( struct V_1 * V_2 , struct V_7 * V_18 )
{
struct V_5 * V_5 = V_2 -> V_6 ;
if ( V_18 -> V_4 > 0xfff ) {
F_28 ( L_19 , V_18 -> V_4 ) ;
...
static void F_56 ( struct V_7 * V_18 )
{
const char V_70 = V_67 ;
memcpy ( F_4 ( V_18 , 1 ) , & V_70 , 1 ) ;
}
static void F_57 ( struct V_7 * V_18 , T_2 V_64 )
{
...
static struct V_7 * F_59 ( struct V_1 * V_2 , T_2 V_10 ,
...
static struct V_7 * F_60 ( struct V_1 * V_2 )
{
struct V_5 * V_5 = V_2 -> V_6 ;
unsigned long V_19 ;
struct V_7 * V_18 , * V_8 ;
...
return F_59 ( V_2 , V_11 , V_54 , 2 ) ;
}
if ( ( V_18 = F_61 ( & V_5 -> V_12 ) ) != NULL ) {
V_8 = F_59 ( V_2 , F_3 ( V_18 ) -> V_10 ,
V_18 -> V_3 , V_18 -> V_4 ) ;
if ( V_8 ) {
F_31 ( V_18 ) ;
return V_8 ;
...
V_50:
F_13 ( & V_5 -> V_33 . V_35 , V_19 ) ;
if ( F_51 ( V_60 , & V_5 -> V_19 ) )
return F_59 ( V_2 , V_83 , NULL , 0 ) ;
return NULL ;
}
