...
{
struct V_146 V_147 ;
F_13 ( V_20 , V_148 , V_149 , NULL , 0 , ( T_1 * ) & V_147 , sizeof( V_147 ) ) ;
F_5 ( L_22 ,
V_147 . V_150 , V_147 . V_151 , V_147 . V_152 , V_147 . V_153 ) ;
...
unsigned long V_27 ;
T_2 V_18 ;
F_8 ( V_20 , 0xa0 , & V_18 ) ; V_18 . V_158 . V_159 = 1 ;
...
struct V_166 V_85 ;
int V_21 ;
if ( ( V_21 = F_8 ( V_20 , 0xca , & V_165 ) ) < 0 )
return V_21 ;
F_5 ( L_30 , V_165 . V_19 ) ;
switch ( V_165 . V_167 . V_168 ) {
case V_169 :
F_5 ( L_31 ) ;
if ( ( V_21 = F_39 ( V_20 ) ) < 0 )
return V_21 ;
...
memset ( & V_85 , 0 , 1 ) ;
V_85 . V_171 = 1 ;
F_13 ( V_20 , V_172 , V_173 , ( T_1 * ) & V_85 , sizeof( V_85 ) , NULL , 0 ) ;
return 0 ;
}
struct V_57 * F_41 ( const struct V_174 * V_11 ,
struct V_175 * V_14 )
{
struct V_1 * V_2 = NULL ;
int V_21 ;
T_2 V_18 ;
V_2 = F_42 ( sizeof( struct V_1 ) , V_176 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_11 = V_11 ;
V_2 -> V_14 = V_14 ;
memcpy ( & V_2 -> V_164 . V_177 , & V_178 , sizeof( struct V_179 ) ) ;
V_2 -> V_164 . V_60 = V_2 ;
F_43 ( & V_2 -> V_44 ) ;
if ( ( V_21 = F_8 ( V_2 , 0xe0 , & V_18 ) ) < 0 )
goto error;
F_5 ( L_33 , V_18 . V_180 . V_181 , V_18 . V_180 . V_182 ) ;
if ( ( V_18 . V_180 . V_181 != 0x1 && V_18 . V_180 . V_182 != 0xb ) &&
( V_18 . V_180 . V_181 != 0x8 && V_18 . V_180 . V_182 != 0x0 ) )
goto error;
F_44 ( L_34 , V_18 . V_180 . V_181 , V_18 . V_180 . V_182 ) ;
F_37 ( V_2 ) ;
return & V_2 -> V_164 ;
error:
F_31 ( V_2 ) ;
