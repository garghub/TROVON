...
V_172 = F_62 ( V_10 , & V_178 , V_175 , false ) ;
if ( F_63 ( V_172 ) ) {
V_10 -> V_187 = 0 ;
...
{
int V_205 ;
if ( F_74 ( ( void V_206 * * ) V_1 -> V_207 . V_208 ,
sizeof( struct V_209 ) ,
F_75 ( struct V_209 ) ) < 0 )
return - V_210 ;
if ( F_74 ( ( void V_206 * * ) V_1 -> V_207 . V_211 ,
sizeof( struct V_209 ) ,
F_75 ( struct V_209 ) ) < 0 )
goto V_212;
if ( F_74 ( ( void V_206 * * ) V_1 -> V_207 . V_213 ,
sizeof( struct V_214 ) ,
F_75 ( struct V_214 ) ) < 0 )
goto V_215;
F_76 (i) {
struct V_214 * V_216 ;
V_216 = F_77 ( V_1 -> V_207 . V_213 [ 0 ] , V_205 ) ;
F_78 ( & V_216 -> V_217 ) ;
#if V_218 == 2
V_216 = F_77 ( V_1 -> V_207 . V_213 [ 1 ] , V_205 ) ;
F_78 ( & V_216 -> V_217 ) ;
#endif
}
if ( F_74 ( ( void V_206 * * ) V_1 -> V_207 . V_219 ,
sizeof( struct V_220 ) ,
F_75 ( struct V_220 ) ) < 0 )
goto V_221;
V_1 -> V_207 . V_222 = F_79 ( sizeof( struct V_223 ) ,
V_35 ) ;
if ( ! V_1 -> V_207 . V_222 )
goto V_224;
return 0 ;
V_224:
F_80 ( ( void V_206 * * ) V_1 -> V_207 . V_219 ) ;
V_221:
F_80 ( ( void V_206 * * ) V_1 -> V_207 . V_213 ) ;
V_215:
F_80 ( ( void V_206 * * ) V_1 -> V_207 . V_211 ) ;
V_212:
F_80 ( ( void V_206 * * ) V_1 -> V_207 . V_208 ) ;
return - V_210 ;
}
...
struct V_160 * V_230 ;
int V_18 = 0 ;
F_94 ( sizeof( struct V_189 ) > F_95 ( struct V_129 , V_231 ) ) ;
for ( V_230 = & V_167 [ 0 ] ; V_230 < & V_167 [ V_165 ] ; ++ V_230 )
F_96 ( V_230 ) ;
if ( V_232 ) {
F_97 ( L_6 ) ;
goto V_36;
