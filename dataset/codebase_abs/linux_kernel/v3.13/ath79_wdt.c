...
static T_2 F_16 ( struct V_13 * V_13 , const char * V_18 ,
T_3 V_19 , T_4 * V_20 )
{
if ( V_19 ) {
if ( ! V_21 ) {
...
static long F_19 ( struct V_13 * V_13 , unsigned int V_25 ,
unsigned long V_26 )
{
...
if ( V_3 )
return - V_16 ;
V_43 = F_23 ( V_41 , V_45 , 0 ) ;
V_3 = F_24 ( & V_41 -> V_46 , V_43 ) ;
if ( F_25 ( V_3 ) )
return F_26 ( V_3 ) ;
V_47 = F_27 ( & V_41 -> V_46 , L_2 ) ;
if ( F_25 ( V_47 ) )
return F_26 ( V_47 ) ;
V_29 = F_28 ( V_47 ) ;
if ( V_29 )
