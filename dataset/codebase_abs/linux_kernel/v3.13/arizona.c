...
V_226 ,
V_71 -> V_198 << V_227 ) ;
F_52 ( V_8 , V_187 -> V_109 , V_71 , V_187 -> V_223 ,
false ) ;
if ( V_187 -> V_225 >= 0 ) {
...
if ( V_187 -> V_233 ) {
if ( V_191 > 0 ) {
V_30 = F_49 ( V_187 , & V_71 , V_191 , V_187 -> V_233 ) ;
if ( V_30 != 0 )
return V_30 ;
}
if ( V_187 -> V_225 >= 0 ) {
V_30 = F_49 ( V_187 , & V_208 , V_187 -> V_229 ,
V_187 -> V_233 ) ;
if ( V_30 != 0 )
return V_30 ;
}
...
if ( V_192 ) {
if ( V_187 -> V_223 >= 0 ) {
V_30 = F_49 ( V_187 , & V_71 , V_187 -> V_224 ,
V_192 ) ;
if ( V_30 != 0 )
return V_30 ;
}
...
int F_65 ( struct V_8 * V_8 , int V_139 , int V_109 , int V_234 ,
...
L_43 , V_139 ) ;
V_30 = F_16 ( V_8 , V_235 , V_187 -> V_242 ,
F_46 , V_187 ) ;
if ( V_30 != 0 ) {
F_11 ( V_8 -> V_9 , L_44 ,
V_139 , V_30 ) ;
...
int F_67 ( struct V_6 * V_7 , int V_243 , bool V_244 )
{
...
V_14 = 0 ;
return F_7 ( V_7 , V_53 , V_246 , V_14 ) ;
}
