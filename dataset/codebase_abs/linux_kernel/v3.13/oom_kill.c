...
V_15 = F_12 ( V_6 -> V_8 ) + F_13 ( & V_6 -> V_8 -> V_19 ) +
F_14 ( V_6 -> V_8 , V_20 ) ;
F_7 ( V_6 ) ;
if ( F_15 ( V_6 , V_21 ) )
V_16 -= 30 ;
...
static enum V_22 F_16 ( struct V_23 * V_23 ,
T_2 V_24 , T_1 * V_11 ,
unsigned long * V_14 )
{
struct V_25 * V_25 ;
struct V_26 * V_27 ;
enum V_28 V_29 = F_17 ( V_24 ) ;
bool V_30 = false ;
int V_31 ;
* V_14 = V_32 + V_33 ;
if ( ! V_23 )
...
if ( V_24 & V_35 )
return V_34 ;
if ( V_11 && ! F_18 ( V_36 [ V_37 ] , * V_11 ) ) {
* V_14 = V_33 ;
F_19 ( V_31 , * V_11 )
* V_14 += F_20 ( V_31 ) ;
return V_38 ;
}
F_21 (zone, z, zonelist,
...
enum V_41 F_23 ( struct V_1 * V_42 ,
...
static struct V_1 * F_29 ( unsigned int * V_54 ,
unsigned long V_14 , const T_1 * V_11 ,
bool V_43 )
{
struct V_1 * V_55 , * V_6 ;
