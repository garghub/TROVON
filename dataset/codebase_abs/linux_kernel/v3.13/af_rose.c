...
if ( ( V_54 = F_98 ( V_19 , V_210 , V_206 -> V_212 & V_213 , & V_165 ) ) == NULL )
return V_165 ;
F_99 ( V_54 , V_220 + V_221 + V_222 ) ;
F_100 ( V_54 ) ;
F_101 ( V_54 , V_88 ) ;
V_165 = F_102 ( F_103 ( V_54 ) , V_206 -> V_223 , V_88 ) ;
if ( V_165 ) {
F_39 ( V_54 ) ;
return V_165 ;
}
...
#ifdef F_55
#define F_106 (256-ROSE_MIN_LEN)
if ( V_54 -> V_88 - V_222 > F_106 ) {
unsigned char V_227 [ V_222 ] ;
struct V_53 * V_228 ;
int V_229 ;
int V_230 ;
F_107 ( V_54 , V_227 , V_222 ) ;
F_104 ( V_54 , V_222 ) ;
V_229 = F_108 ( V_54 ) ;
while ( V_54 -> V_88 > 0 ) {
if ( ( V_228 = F_98 ( V_19 , V_229 + F_106 , 0 , & V_165 ) ) == NULL ) {
F_39 ( V_54 ) ;
return V_165 ;
}
V_228 -> V_19 = V_19 ;
...
V_228 -> V_231 = 1 ;
F_99 ( V_228 , V_229 ) ;
V_230 = ( F_106 > V_54 -> V_88 ) ? V_54 -> V_88 : F_106 ;
F_107 ( V_54 , F_101 ( V_228 , V_230 ) , V_230 ) ;
F_104 ( V_54 , V_230 ) ;
F_105 ( V_228 , V_222 ) ;
F_109 ( V_228 , V_227 , V_222 ) ;
if ( V_54 -> V_88 > 0 )
V_228 -> V_52 [ 2 ] |= F_55 ;
F_110 ( & V_19 -> V_232 , V_228 ) ;
}
V_54 -> free = 1 ;
F_39 ( V_54 ) ;
} else {
F_110 ( & V_19 -> V_232 , V_54 ) ;
}
#else
F_110 ( & V_19 -> V_232 , V_54 ) ;
#endif
...
static int F_112 ( struct V_203 * V_204 , struct V_63 * V_18 ,
...
if ( V_19 -> V_45 != V_128 )
return - V_188 ;
if ( ( V_54 = F_113 ( V_19 , V_162 & ~ V_213 , V_162 & V_213 , & V_234 ) ) == NULL )
return V_234 ;
...
F_114 ( V_54 , 0 , V_206 -> V_223 , V_233 ) ;
if ( V_206 -> V_208 ) {
struct V_143 * V_187 ;
struct V_148 * V_236 = V_206 -> V_208 ;
...
static int F_116 ( struct V_63 * V_18 , unsigned int V_237 , unsigned long V_238 )
{
struct V_18 * V_19 = V_18 -> V_19 ;
struct V_24 * V_25 = F_14 ( V_19 ) ;
...
struct V_53 * V_54 ;
long V_241 = 0L ;
if ( ( V_54 = F_118 ( & V_19 -> V_55 ) ) != NULL )
V_241 = V_54 -> V_88 ;
return F_48 ( V_241 , ( unsigned int T_3 * ) V_239 ) ;
}
case V_243 :
return F_119 ( V_19 , (struct V_244 T_3 * ) V_239 ) ;
case V_245 :
return F_120 ( V_19 , (struct V_246 T_3 * ) V_239 ) ;
case V_247 :
case V_248 :
case V_249 :
case V_250 :
...
case V_265 : {
struct V_263 V_264 ;
if ( F_122 ( & V_264 , V_239 , sizeof( struct V_263 ) ) )
return - V_72 ;
...
F_123 ( & V_267 , NULL ) ;
if ( F_122 ( & V_267 , V_239 , sizeof( T_2 ) ) )
return - V_72 ;
if ( F_26 ( & V_267 , & V_48 ) != 0 )
return F_124 ( & V_267 , NULL ) ;
return 0 ;
case V_268 :
...
static void * F_125 ( struct V_271 * V_272 , T_6 * V_273 )
__acquires( V_20 )
{
F_9 ( & V_20 ) ;
return F_126 ( & V_40 , * V_273 ) ;
}
static void * F_127 ( struct V_271 * V_272 , void * V_274 , T_6 * V_273 )
{
return F_128 ( V_274 , & V_40 , V_273 ) ;
}
static void F_129 ( struct V_271 * V_272 , void * V_274 )
__releases( V_20 )
{
F_11 ( & V_20 ) ;
}
static int F_130 ( struct V_271 * V_272 , void * V_274 )
{
...
F_133 ( V_272 , L_5 ,
F_5 ( V_275 , & V_25 -> V_91 ) ,
F_134 ( V_10 , & V_25 -> V_93 ) ) ;
if ( F_26 ( & V_25 -> V_43 , & V_48 ) == 0 )
V_278 = L_6 ;
else
V_278 = F_134 ( V_10 , & V_25 -> V_43 ) ;
F_133 ( V_272 ,
L_7 ,
F_5 ( V_275 , & V_25 -> V_42 ) ,
V_278 ,
...
V_25 -> V_200 ,
V_25 -> V_199 ,
F_135 ( & V_25 -> V_115 ) / V_62 ,
V_25 -> V_76 / V_62 ,
V_25 -> V_78 / V_62 ,
V_25 -> V_80 / V_62 ,
V_25 -> V_82 / V_62 ,
F_135 ( & V_25 -> V_116 ) / ( 60 * V_62 ) ,
V_25 -> V_84 / ( 60 * V_62 ) ,
F_117 ( V_23 ) ,
F_136 ( V_23 ) ,
V_23 -> V_281 ? F_137 ( V_23 -> V_281 ) -> V_282 : 0L ) ;
}
return 0 ;
}
static int F_138 ( struct V_283 * V_283 , struct V_284 * V_284 )
{
return F_139 ( V_284 , & V_285 ) ;
}
...
goto V_289;
V_267 = V_48 ;
V_290 = F_143 ( V_287 * sizeof( struct V_1 * ) , V_291 ) ;
if ( V_290 == NULL ) {
F_141 ( V_288 L_9 ) ;
V_286 = - V_108 ;
goto V_292;
...
F_153 () ;
F_154 () ;
F_155 ( L_13 , V_300 , V_35 . V_301 , & V_302 ) ;
F_155 ( L_14 , V_300 , V_35 . V_301 ,
& V_303 ) ;
F_155 ( L_15 , V_300 , V_35 . V_301 ,
& V_304 ) ;
F_155 ( L_16 , V_300 , V_35 . V_301 ,
& V_305 ) ;
V_289:
return V_286 ;
V_295:
...
{
int V_15 ;
F_160 ( L_13 , V_35 . V_301 ) ;
F_160 ( L_14 , V_35 . V_301 ) ;
F_160 ( L_15 , V_35 . V_301 ) ;
F_160 ( L_16 , V_35 . V_301 ) ;
F_161 () ;
F_162 () ;
F_163 ( V_306 ) ;
F_164 ( & V_299 ) ;
