...
return - V_83 ;
return F_11 ( F_16 ( V_33 ) , V_29 ) ? - V_26 : V_97 ;
}
static int
...
L_30 V_102 L_31 ) ;
if ( V_2 -> V_84 > 0 ) {
V_100 = F_42 ( & V_2 -> V_33 , V_2 -> V_84 , NULL ,
F_29 ,
V_103 ,
V_104 . V_105 . V_106 ,
V_2 ) ;
...
V_89 = F_45 ( & V_2 -> V_33 , V_104 . V_105 . V_106 ,
& V_107 ,
V_108 ) ;
if ( F_46 ( V_89 ) )
return F_47 ( V_89 ) ;
...
F_49 ( & V_2 -> V_33 , L_34
L_35 ) ;
V_100 = F_50 ( & V_2 -> V_33 . V_109 , & V_110 ) ;
if ( V_100 )
return V_100 ;
return 0 ;
}
