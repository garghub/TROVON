...
static void F_32 ( unsigned long V_19 , unsigned long V_16 ,
T_2 * V_45 , T_2 * V_46 )
{
unsigned long V_47 ;
...
static void F_34 ( unsigned long V_19 , unsigned long V_16 ,
...
static void F_36 ( unsigned long V_19 , unsigned long V_16 ,
...
static void F_37 ( unsigned long V_19 , unsigned long V_16 ,
T_2 * V_45 , T_2 * V_48 , T_2 * V_49 )
{
T_2 V_50 , V_51 , V_52 ;
T_2 V_53 , V_54 , V_55 ;
...
switch ( V_61 -> type ) {
case V_63 :
F_32 ( V_19 , V_16 , & V_50 , & V_51 ) ;
V_62 = F_40 ( V_50 , V_51 ) ;
break;
case V_64 :
F_34 ( V_19 , V_16 , & V_50 , & V_51 , & V_52 ) ;
V_62 = F_41 ( V_50 , V_51 , V_52 ) ;
break;
case V_65 :
F_36 ( V_19 , V_16 , & V_59 , & V_50 , & V_51 , & V_52 ) ;
V_62 = F_42 ( V_59 , V_50 , V_51 , V_52 ) ;
break;
case V_66 :
F_37 ( V_19 , V_16 , & V_50 , & V_51 , & V_52 ) ;
...
switch ( V_61 -> type ) {
case V_63 :
F_32 ( V_19 , * V_20 , & V_50 , & V_51 ) ;
V_68 = F_45 ( * V_20 , V_50 , V_51 ) ;
break;
case V_64 :
F_34 ( V_19 , * V_20 , & V_50 , & V_51 , & V_52 ) ;
V_68 = F_46 ( * V_20 , V_50 , V_51 , V_52 ) ;
break;
case V_65 :
F_36 ( V_19 , * V_20 , & V_59 , & V_50 , & V_51 , & V_52 ) ;
V_68 = F_47 ( * V_20 , V_50 , V_51 , V_52 ) ;
break;
case V_66 :
F_37 ( V_19 , * V_20 , & V_50 , & V_51 , & V_52 ) ;
V_68 = F_48 ( * V_20 , V_50 , V_51 , V_52 ) ;
break;
default:
V_68 = 0 ;
}
...
static T_1 void F_58 ( struct V_1 * V_23 , int V_70 )
{
T_2 V_67 ;
struct V_24 * V_24 ;
struct V_60 * V_71 ;
...
if ( ! V_3 )
F_1 () ;
V_31 = F_24 ( V_23 , L_15 , & V_67 ) ;
if ( F_23 ( V_31 ) )
return;
V_71 = F_22 ( sizeof( * V_71 ) , V_33 ) ;
if ( F_23 ( ! V_71 ) )
return;
V_71 -> V_67 = V_3 + V_67 ;
V_71 -> V_13 = & V_34 ;
