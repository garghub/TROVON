...
static int F_34 ( struct V_51 * V_21 , unsigned int V_49 ,
T_2 V_22 )
{
...
static int F_38 ( struct V_56 * V_14 )
{
struct V_5 * V_6 ;
struct V_1 * V_57 ;
...
unsigned V_22 ;
int V_63 = - V_18 ;
V_6 = F_39 ( V_15 , sizeof( struct V_5 ) , V_64 ) ;
if ( ! V_6 ) {
F_7 ( V_15 , L_3 ) ;
return - V_65 ;
}
...
V_6 -> V_10 = V_59 -> V_68 ;
V_62 = F_42 ( V_59 ) ;
if ( ! F_43 ( V_15 , V_6 -> V_10 , V_62 , L_5 ) ) {
F_7 ( V_15 , L_6 ,
...
static int F_51 ( struct V_61 * V_15 )
{
return 0 ;
}
static int F_52 ( struct V_61 * V_15 )
{
return 0 ;
}
static int F_53 ( struct V_56 * V_14 )
{
