...
if ( V_4 -> V_124 == NULL )
return - V_125 ;
return V_4 -> V_124 ( V_4 -> V_13 , V_123 ) ;
}
...
struct V_16 * V_23 ;
int V_5 ;
V_5 = F_8 ( V_2 , V_25 , V_128 ,
NULL , 0 , & V_23 ) ;
if ( V_5 == 0 ) {
if ( V_23 -> V_27 == 2 && V_23 -> V_29 [ 0 ] == 0x00 )
F_38 ( V_2 -> V_65 , V_126 ++ , V_129 ) ;
F_9 ( V_23 ) ;
}
V_5 = F_11 ( V_2 , V_130 ,
V_131 ,
& V_127 , 1 ) ;
if ( V_5 == 0 )
F_38 ( V_2 -> V_65 , V_126 ++ , V_132 ) ;
return ! V_126 ;
}
static int F_39 ( struct V_1 * V_2 , T_2 V_126 )
{
struct V_133 * V_134 ;
T_1 V_12 = V_135 ;
static struct V_136 {
...
struct V_136 * V_21 = V_136 ;
int V_22 = F_7 ( V_136 ) ;
struct V_16 * V_23 ;
int V_5 ;
V_134 = F_40 ( V_2 -> V_65 , V_126 ) ;
switch ( V_134 -> type ) {
case V_129 :
while ( V_22 -- ) {
V_5 = F_8 ( V_2 , V_25 ,
...
return F_10 ( V_2 , V_138 ,
V_139 , & V_12 , 1 ) ;
case V_132 :
return F_10 ( V_2 , V_130 ,
V_140 , & V_12 , 1 ) ;
default:
return - V_44 ;
}
}
static int F_41 ( struct V_1 * V_2 , T_2 V_126 )
{
struct V_133 * V_134 ;
T_1 V_15 = V_141 ;
V_134 = F_40 ( V_2 -> V_65 , V_126 ) ;
...
int F_42 ( void * V_13 , struct V_142 * V_11 , char * V_143 ,
...
struct V_148 V_149 ;
int V_5 ;
V_4 = F_43 ( sizeof( struct V_3 ) , V_150 ) ;
if ( ! V_4 ) {
V_5 = - V_151 ;
goto V_152;
}
...
V_4 -> V_7 = V_8 ;
F_44 ( & V_4 -> V_6 ) ;
V_149 . V_153 = F_7 ( V_154 ) ;
memcpy ( V_149 . V_155 , V_154 , sizeof( V_154 ) ) ;
strcpy ( V_149 . V_156 , L_9 ) ;
V_147 = V_61 |
V_60 |
V_62 |
V_59 |
