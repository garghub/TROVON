...
if ( ! F_116 ( V_29 , sizeof( struct V_195 ) ) ) {
V_65 = - V_46 ;
goto V_53;
}
V_196 = F_128 ( V_29 ) ;
...
goto V_53;
V_190 = V_196 -> V_97 ?
F_129 ( V_196 -> V_97 ) * ( V_100 / V_101 ) : 1 ;
}
...
if ( V_23 -> V_54 &&
( F_31 ( & V_23 -> V_52 ) ?
F_130 ( V_23 -> V_52 . V_198 , V_134 + V_190 ) :
F_111 ( & V_23 -> V_52 ) >= 0 ) )
...
V_58 = & V_48 -> V_59 ) {
if ( F_31 ( & V_48 -> V_52 ) ?
F_130 ( V_48 -> V_52 . V_198 , V_134 + V_190 ) :
F_111 ( & V_48 -> V_52 ) >= 0 )
...
if ( ! F_116 ( V_29 , sizeof( * V_199 ) ) ) {
V_65 = - V_46 ;
goto V_53;
}
V_199 = (struct V_105 * ) F_68 ( V_29 ) ;
V_190 = F_132 ( F_118 ( V_199 -> V_120 ) ) ;
if ( V_190 )
V_69 = & V_199 -> V_122 ;
} else {
if ( ! F_116 ( V_29 , sizeof( * V_201 ) ) ) {
V_65 = - V_46 ;
goto V_53;
}
V_201 = (struct V_200 * ) F_68 ( V_29 ) ;
if ( ! V_201 -> V_202 )
V_69 = & V_201 -> V_203 ;
V_190 = V_18 ( F_132 ( F_133 ( V_201 ) ) , 1UL ) ;
}
F_126 ( V_27 , V_61 , & V_27 -> V_155 ,
! F_69 ( & V_104 -> V_90 ) , V_190 ) ;
if ( ! V_69 )
goto V_53;
...
F_40 ( & V_48 -> V_52 ) ;
F_34 ( & V_48 -> V_36 , F_26 ) ;
F_87 ( V_27 -> V_51 , V_61 , V_69 , V_206 ) ;
if ( ! V_23 -> V_55 && ! V_23 -> V_54 &&
F_30 ( V_27 -> V_51 ) )
F_41 ( & V_23 -> V_52 , V_60 ) ;
}
...
V_134 = V_60 ;
time = V_134 + V_27 -> V_197 *
V_27 -> V_98 ;
if ( ! V_61 ) {
if ( V_23 -> V_54 &&
( F_31 ( & V_23 -> V_52 ) ?
F_130 ( V_23 -> V_52 . V_198 , time ) :
F_111 ( & V_23 -> V_52 ) >= 0 ) ) {
F_41 ( & V_23 -> V_52 , time ) ;
}
goto V_53;
...
V_140 . V_4 = F_2 ( V_6 ) ;
V_140 . V_5 = V_5 ;
F_134 ( V_27 , V_61 , & V_140 , & V_27 -> V_154 , V_145 ) ;
}
...
V_140 . V_4 = F_2 ( V_10 ) ;
V_140 . V_5 = V_5 ;
F_134 ( V_27 , V_61 , & V_140 , & V_27 -> V_155 , V_145 ) ;
}
...
return - V_46 ;
if ( ! F_116 ( V_29 , F_138 ( V_29 ) ) )
return - V_46 ;
V_75 = F_18 ( V_29 ) ;
if ( F_75 ( F_139 ( ( V_94 * ) V_75 , V_75 -> V_82 ) ) )
return - V_46 ;
if ( V_75 -> V_32 != V_89 ) {
if ( ! F_89 ( V_75 -> V_33 ) )
F_17 ( V_29 ) -> V_209 = 1 ;
...
if ( V_29 -> V_42 < V_42 || V_42 < F_138 ( V_29 ) )
return - V_46 ;
if ( V_29 -> V_42 > V_42 ) {
V_207 = F_140 ( V_29 , V_66 ) ;
if ( ! V_207 )
return - V_67 ;
V_65 = F_141 ( V_207 , V_42 ) ;
if ( V_65 )
goto V_210;
}
V_42 -= F_138 ( V_207 ) ;
V_208 = F_142 ( V_207 ) + F_138 ( V_207 ) ;
F_61 ( V_207 , V_208 ) ;
F_143 ( V_207 ) ;
V_65 = - V_46 ;
if ( ! F_116 ( V_207 , sizeof( * V_71 ) ) )
goto V_53;
switch ( V_207 -> V_211 ) {
case V_212 :
if ( ! F_144 ( V_207 -> V_102 ) )
break;
case V_213 :
V_207 -> V_102 = 0 ;
if ( F_145 ( V_207 ) )
...
break;
case V_216 :
V_65 = F_115 ( V_27 , V_61 , V_207 , V_5 ) ;
break;
case V_96 :
V_65 = F_127 ( V_27 , V_61 , V_207 , V_5 ) ;
break;
case V_217 :
F_135 ( V_27 , V_61 , V_71 -> V_69 , V_5 ) ;
break;
}
V_53:
F_100 ( V_207 , V_208 ) ;
...
return - V_46 ;
V_110 = V_104 -> V_110 ;
V_208 = F_147 ( V_29 , sizeof( * V_104 ) , & V_110 , & V_86 ) ;
...
return - V_67 ;
V_65 = - V_46 ;
if ( ! F_116 ( V_207 , V_208 + sizeof( struct V_177 ) ) )
goto V_53;
V_42 -= V_208 - F_142 ( V_207 ) ;
F_61 ( V_207 , V_208 ) ;
F_143 ( V_207 ) ;
F_148 ( V_207 , F_149 ( V_207 ) ,
F_150 ( V_207 ) ) ;
...
break;
case V_213 :
V_207 -> V_102 = ~ F_151 ( F_71 ( & V_104 -> V_90 ,
& V_104 -> V_33 ,
V_207 -> V_42 ,
V_113 , 0 ) ) ;
if ( F_152 ( V_207 ) )
...
{
struct V_105 * V_199 ;
if ( ! F_116 ( V_207 , sizeof( * V_199 ) ) ) {
V_65 = - V_46 ;
goto V_53;
}
V_199 = (struct V_105 * ) F_153 ( V_207 ) ;
F_17 ( V_29 ) -> V_209 = 1 ;
V_65 = F_90 ( V_27 , V_61 , & V_199 -> V_122 , V_5 ) ;
break;
}
case V_221 :
V_65 = F_119 ( V_27 , V_61 , V_207 , V_5 ) ;
break;
case V_117 :
V_65 = F_131 ( V_27 , V_61 , V_207 , V_5 ) ;
break;
case V_220 :
{
struct V_105 * V_199 ;
...
V_199 = (struct V_105 * ) F_153 ( V_207 ) ;
F_136 ( V_27 , V_61 , & V_199 -> V_122 , V_5 ) ;
}
}
V_53:
F_66 ( V_207 ) ;
...
int F_154 ( struct V_26 * V_27 , struct V_123 * V_61 ,
struct V_28 * V_29 , T_3 V_5 )
{
F_17 ( V_29 ) -> V_31 = 0 ;
F_17 ( V_29 ) -> V_209 = 0 ;
...
switch ( V_29 -> V_32 ) {
case F_2 ( V_6 ) :
return F_137 ( V_27 , V_61 , V_29 , V_5 ) ;
#if F_3 ( V_9 )
case F_2 ( V_10 ) :
return F_146 ( V_27 , V_61 , V_29 , V_5 ) ;
#endif
}
return 0 ;
}
...
{
struct V_26 * V_27 = ( void * ) V_49 ;
F_155 ( V_27 , & V_27 -> V_146 ) ;
}
static void F_157 ( unsigned long V_49 )
{
struct V_26 * V_27 = ( void * ) V_49 ;
F_155 ( V_27 , & V_27 -> V_147 ) ;
}
void F_158 ( struct V_26 * V_27 )
{
V_27 -> V_125 = 4 ;
V_27 -> V_127 = 512 ;
V_27 -> V_141 = 1 ;
...
( unsigned long ) V_27 ) ;
F_82 ( & V_27 -> V_146 . V_52 , F_156 ,
( unsigned long ) V_27 ) ;
#if F_3 ( V_9 )
F_82 ( & V_27 -> V_155 . V_52 , F_98 ,
( unsigned long ) V_27 ) ;
F_82 ( & V_27 -> V_147 . V_52 , F_157 ,
( unsigned long ) V_27 ) ;
#endif
}
...
{
F_160 ( V_27 , & V_27 -> V_146 ) ;
#if F_3 ( V_9 )
F_160 ( V_27 , & V_27 -> V_147 ) ;
#endif
}
...
int F_166 ( struct V_26 * V_27 , unsigned long V_222 )
{
int V_65 = - V_223 ;
F_163 ( & V_27 -> V_50 ) ;
if ( ! F_30 ( V_27 -> V_51 ) )
...
int F_167 ( struct V_123 * V_48 , unsigned long V_222 )
{
...
int F_169 ( struct V_26 * V_27 , unsigned long V_222 )
{
int V_65 = 0 ;
struct V_12 * V_13 ;
F_163 ( & V_27 -> V_50 ) ;
