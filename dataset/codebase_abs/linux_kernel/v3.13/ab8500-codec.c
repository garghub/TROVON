...
V_31 = V_65 == V_71 || V_65 == V_70 ;
V_32 = V_65 == V_72 || V_65 == V_70 ;
V_11 = F_26 ( & V_9 -> V_73 ,
L_17 ) ;
if ( V_11 < 0 ) {
F_5 ( V_14 ,
...
static int F_39 ( struct V_119 * V_120 , unsigned int V_125 )
{
unsigned int V_122 ;
unsigned int V_19 ;
struct V_8 * V_9 = V_120 -> V_9 ;
...
{
struct V_8 * V_9 = V_120 -> V_9 ;
unsigned int V_19 , V_122 , V_159 , V_160 ;
V_122 = F_11 ( V_161 ) |
F_11 ( V_162 ) ;
V_19 = 0 ;
switch ( V_158 ) {
...
case 1 :
V_159 = F_42 ( V_155 ) ;
F_10 ( V_9 , V_168 , V_122 , V_159 ) ;
F_10 ( V_9 , V_169 , V_122 , V_159 ) ;
F_10 ( V_9 , V_170 , V_122 , V_159 ) ;
F_10 ( V_9 , V_171 , V_122 , V_159 ) ;
break;
case 2 :
V_159 = F_42 ( V_155 ) ;
F_10 ( V_9 , V_168 , V_122 , V_159 ) ;
...
static void F_47 ( struct V_64 * V_14 , struct V_175 * V_176 ,
struct V_177 * V_9 )
{
T_2 V_12 ;
if ( F_48 ( V_176 , L_62 , NULL ) )
V_9 -> V_91 . V_105 = V_7 ;
else
V_9 -> V_91 . V_105 = V_6 ;
if ( F_48 ( V_176 , L_63 , NULL ) )
V_9 -> V_91 . V_108 = V_7 ;
else
V_9 -> V_91 . V_108 = V_6 ;
if ( F_48 ( V_176 , L_64 , NULL ) )
V_9 -> V_91 . V_99 = V_4 ;
else
V_9 -> V_91 . V_99 = V_3 ;
if ( F_48 ( V_176 , L_65 , NULL ) )
V_9 -> V_91 . V_101 = V_4 ;
else
V_9 -> V_91 . V_101 = V_3 ;
if ( F_48 ( V_176 , L_66 , NULL ) )
V_9 -> V_91 . V_103 = V_3 ;
else
V_9 -> V_91 . V_103 = V_4 ;
if ( ! F_49 ( V_176 , L_67 , & V_12 ) ) {
switch ( V_12 ) {
case 950 :
V_9 -> V_111 = V_113 ;
break;
...
V_11 = F_34 ( V_9 , & V_181 -> V_9 -> V_91 ) ;
if ( V_11 < 0 ) {
F_54 ( L_71 , V_16 , V_11 ) ;
return V_11 ;
}
V_11 = F_36 ( V_9 , V_181 -> V_9 -> V_111 ) ;
if ( V_11 < 0 ) {
F_54 ( L_72 ,
V_16 , V_11 ) ;
return V_11 ;
...
V_34 = F_53 ( & V_194 -> V_14 , sizeof( struct V_33 ) ,
V_183 ) ;
if ( ! V_34 )
return - V_184 ;
V_34 -> V_44 = V_195 ;
V_34 -> V_63 = V_196 ;
F_58 ( & V_194 -> V_14 , V_34 ) ;
F_6 ( & V_194 -> V_14 , L_75 , V_16 ) ;
V_11 = F_59 ( & V_194 -> V_14 , & V_197 ,
V_198 ,
F_25 ( V_198 ) ) ;
if ( V_11 < 0 )
F_5 ( & V_194 -> V_14 ,
