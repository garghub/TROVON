...
char V_75 [ V_76 + 1 ] ;
struct V_87 V_191 ;
struct V_89 * V_220 = (struct V_89 * ) & V_191 ;
int error ;
F_58 ( L_29 , V_64 ,
( unsigned long long ) V_121 -> V_175 . V_176 ,
( unsigned long long ) V_121 -> V_175 . V_177 ,
...
error = F_69 ( V_213 , V_220 , sizeof( V_191 ) ) ;
if ( error != 0 ) {
F_58 ( L_31 ,
V_64 , error ) ;
goto V_23;
...
error = - V_221 ;
if ( F_70 ( V_220 , V_75 , sizeof( V_75 ) ) == 0 ) {
F_58 ( L_32 ,
V_64 , error ) ;
goto V_23;
}
...
if ( V_121 -> V_1 -> V_222 == NULL )
V_121 -> V_1 -> V_222 = F_128 ( V_132 , V_11 ) ;
F_111 ( V_121 ) ;
error = F_123 ( V_121 ) ;
if ( error < 0 )
goto V_23;
