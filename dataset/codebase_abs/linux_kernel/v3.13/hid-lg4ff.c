...
static T_6 F_18 ( struct V_54 * V_23 , struct V_55 * V_56 , char * V_57 )
{
...
static T_6 F_21 ( struct V_54 * V_23 , struct V_55 * V_56 , const char * V_57 , T_7 V_58 )
{
struct V_5 * V_6 = F_19 ( V_23 ) ;
struct V_13 * V_14 ;
struct V_11 * V_12 ;
...
if ( V_2 == 0 )
V_2 = V_14 -> V_3 ;
if ( V_14 -> V_60 != NULL && V_2 >= V_14 -> V_61 && V_2 <= V_14 -> V_3 ) {
V_14 -> V_60 ( V_6 , V_2 ) ;
V_14 -> V_2 = V_2 ;
}
return V_58 ;
}
static void F_23 ( struct V_5 * V_6 , T_5 V_62 )
{
struct V_27 * V_28 = & V_6 -> V_29 [ V_30 ] . V_28 ;
struct V_31 * V_32 = F_8 ( V_28 -> V_33 , struct V_31 , V_34 ) ;
T_1 * V_1 = V_32 -> V_8 [ 0 ] -> V_1 ;
...
enum V_65 V_1 )
{
struct V_54 * V_23 = V_64 -> V_23 -> V_66 ;
...
if ( V_64 != V_14 -> V_68 [ V_51 ] )
continue;
V_67 = ( V_14 -> V_69 >> V_51 ) & 1 ;
if ( V_1 == V_70 && V_67 ) {
V_14 -> V_69 &= ~ ( 1 << V_51 ) ;
F_23 ( V_6 , V_14 -> V_69 ) ;
} else if ( V_1 != V_70 && ! V_67 ) {
V_14 -> V_69 |= 1 << V_51 ;
F_23 ( V_6 , V_14 -> V_69 ) ;
}
break;
...
static enum V_65 F_26 ( struct V_63 * V_64 )
{
struct V_54 * V_23 = V_64 -> V_23 -> V_66 ;
struct V_5 * V_6 = F_25 ( V_23 , struct V_5 , V_23 ) ;
struct V_11 * V_12 = F_12 ( V_6 ) ;
...
{
struct V_72 * V_20 = F_8 ( V_6 -> V_73 . V_33 , struct V_72 , V_34 ) ;
...
return - 1 ;
for ( V_51 = 0 ; V_51 < F_29 ( V_79 ) ; V_51 ++ ) {
if ( V_6 -> V_80 == V_79 [ V_51 ] . V_16 ) {
F_15 ( L_9 , V_79 [ V_51 ] . V_16 ) ;
break;
}
}
if ( V_51 == F_29 ( V_79 ) ) {
...
V_77 = V_76 >> 8 ;
V_78 = V_76 & 0xff ;
if ( V_79 [ V_51 ] . V_16 == V_82 ) {
F_15 ( L_13 ) ;
F_15 ( L_14 , V_77 , V_78 ) ;
for ( V_52 = 0 ; V_52 < F_29 ( V_83 ) ; V_52 ++ ) {
if ( V_83 [ V_52 ] . V_77 == V_77 && V_83 [ V_52 ] . V_78 == V_78 ) {
F_17 ( V_6 , V_83 [ V_52 ] . V_84 ) ;
F_32 ( V_6 , L_15 ) ;
}
}
}
for ( V_52 = 0 ; V_79 [ V_51 ] . V_85 [ V_52 ] >= 0 ; V_52 ++ )
F_33 ( V_79 [ V_51 ] . V_85 [ V_52 ] , V_23 -> V_86 ) ;
...
V_14 = F_35 ( sizeof( struct V_13 ) , V_87 ) ;
if ( ! V_14 ) {
F_4 ( V_6 , L_17 ) ;
return - V_88 ;
}
V_12 -> V_15 = V_14 ;
V_14 -> V_16 = V_79 [ V_51 ] . V_16 ;
V_14 -> V_61 = V_79 [ V_51 ] . V_61 ;
V_14 -> V_3 = V_79 [ V_51 ] . V_3 ;
V_14 -> V_60 = V_79 [ V_51 ] . V_60 ;
if ( F_36 ( V_89 , V_23 -> V_86 ) ) {
if ( V_77 == V_90 && V_78 == V_91 )
V_23 -> V_92 -> V_93 = F_13 ;
else
V_23 -> V_92 -> V_93 = F_11 ;
V_23 -> V_92 -> V_93 ( V_23 , 0 ) ;
}
error = F_37 ( & V_6 -> V_23 , & V_94 ) ;
if ( error )
return error ;
F_15 ( L_18 ) ;
V_14 -> V_2 = V_14 -> V_3 ;
if ( V_14 -> V_60 != NULL )
V_14 -> V_60 ( V_6 , V_14 -> V_2 ) ;
#ifdef F_38
V_14 -> V_69 = 0 ;
for ( V_52 = 0 ; V_52 < 5 ; V_52 ++ )
V_14 -> V_68 [ V_52 ] = NULL ;
if ( V_79 [ V_51 ] . V_16 == V_95 ) {
struct V_63 * V_68 ;
T_7 V_96 ;
char * V_97 ;
F_23 ( V_6 , 0 ) ;
V_96 = strlen ( F_39 ( & V_6 -> V_23 ) ) + 8 ;
for ( V_52 = 0 ; V_52 < 5 ; V_52 ++ ) {
V_68 = F_35 ( sizeof( struct V_63 ) + V_96 , V_87 ) ;
if ( ! V_68 ) {
F_4 ( V_6 , L_19 , V_52 ) ;
goto V_98;
}
V_97 = ( void * ) ( & V_68 [ 1 ] ) ;
snprintf ( V_97 , V_96 , L_20 , F_39 ( & V_6 -> V_23 ) , V_52 + 1 ) ;
V_68 -> V_97 = V_97 ;
V_68 -> V_99 = 0 ;
V_68 -> V_100 = 1 ;
V_68 -> V_101 = F_26 ;
