...
F_62 ( V_2 -> V_11 -> V_82 ,
F_67 ( V_2 , V_52 ) ,
V_2 -> V_11 -> V_83 * V_121 , V_2 -> V_23 -> V_84 ) ;
}
STATIC void
F_69 (
T_3 * V_2 ,
...
F_76 ( & V_131 -> V_13 . V_14 . V_15 , & V_10 -> V_12 . V_16 ) ;
V_131 -> V_13 . V_14 . V_138 = 0 ;
V_131 -> V_13 . V_14 . V_59 = 0 ;
}
} else {
...
F_76 ( & V_131 -> V_13 . V_42 . V_15 , & V_10 -> V_12 . V_16 ) ;
V_131 -> V_13 . V_42 . V_59 = 0 ;
}
}
}
void
...
F_74 ( V_2 -> V_11 , F_24 ( V_7 ) , V_7 -> V_18 ,
F_6 ( V_2 ) , V_5 , V_134 ,
V_135 , V_2 -> V_46 ) ;
}
STATIC int
...
{
if ( V_2 -> V_46 & V_47 )
V_52 -> V_14 = F_4 ( F_81 ( V_2 -> V_11 ,
F_36 ( V_7 ) ) ) ;
else {
V_52 -> V_42 = F_17 ( F_82 ( V_2 -> V_11 ,
F_36 ( V_7 ) ) ) ;
}
}
STATIC void
...
{
F_93 ( V_2 , V_162 ) ;
F_94 ( V_2 , V_7 , V_114 , V_115 ) ;
if ( V_7 ) {
F_95 ( V_2 -> V_69 , V_7 , V_163 ) ;
F_96 ( V_2 -> V_69 , V_7 ,
F_40 ( V_2 , V_114 ) ,
F_40 ( V_2 , V_115 + 1 ) - 1 ) ;
} else {
F_97 ( V_2 -> V_69 , V_2 -> V_39 . V_72 . V_99 ,
F_98 ( V_2 -> V_39 . V_72 . V_100 ) ) ;
}
F_93 ( V_2 , V_164 ) ;
}
void
...
F_102 ( struct V_3 , V_20 ) ,
F_102 ( struct V_3 , V_21 ) ,
F_102 ( struct V_3 , V_22 ) ,
F_102 ( struct V_3 , V_13 . V_42 . V_25 ) ,
F_102 ( struct V_3 , V_13 . V_42 . V_27 ) ,
F_102 ( struct V_3 , V_13 . V_42 . V_17 ) ,
F_102 ( struct V_3 , V_13 . V_42 . V_59 ) ,
F_102 ( struct V_3 , V_13 . V_42 . V_15 ) ,
F_102 ( struct V_3 , V_13 . V_42 . V_137 ) ,
F_102 ( struct V_3 , V_13 . V_42 . V_166 ) ,
V_88
} ;
...
F_102 ( struct V_3 , V_21 ) ,
F_102 ( struct V_3 , V_22 ) ,
F_102 ( struct V_3 , V_13 . V_14 . V_25 ) ,
F_102 ( struct V_3 , V_13 . V_14 . V_27 ) ,
F_102 ( struct V_3 , V_13 . V_14 . V_17 ) ,
F_102 ( struct V_3 , V_13 . V_14 . V_59 ) ,
F_102 ( struct V_3 , V_13 . V_14 . V_15 ) ,
F_102 ( struct V_3 , V_13 . V_14 . V_137 ) ,
F_102 ( struct V_3 , V_13 . V_14 . V_166 ) ,
F_102 ( struct V_3 , V_13 . V_14 . V_138 ) ,
V_86
} ;
F_93 ( V_2 , V_162 ) ;
F_103 ( V_2 , V_7 , V_111 ) ;
...
V_7 = V_2 -> V_68 [ V_5 ] ;
if ( V_7 && F_36 ( V_7 ) == F_67 ( V_2 , V_180 ) ) {
* V_181 = F_24 ( V_7 ) ;
return 0 ;
}
error = F_85 ( V_2 , V_180 , V_5 , 0 , V_181 , & V_7 ) ;
if ( error )
return error ;
F_69 ( V_2 , V_5 , V_7 ) ;
return 0 ;
...
F_86 ( V_2 , V_183 , V_195 , 1 ) ;
F_92 ( V_2 , V_7 , V_52 , V_52 ) ;
}
F_93 ( V_2 , V_164 ) ;
return 0 ;
}
...
F_87 ( V_2 , V_196 , V_161 , 1 ) ;
F_99 ( V_2 , V_7 , V_52 , V_52 ) ;
if ( F_79 ( V_2 , V_4 , 0 ) ) {
...
goto V_173;
#endif
F_72 ( V_2 , V_125 , & V_203 , V_129 ) ;
if ( F_70 ( V_2 , & V_203 ) )
goto V_175;
if ( V_2 -> V_80 [ V_5 ] <= 1 )
goto V_175;
error = F_85 ( V_2 , & V_203 , V_5 , 0 , & V_124 , & V_199 ) ;
if ( error )
goto V_173;
V_200 = F_107 ( V_124 ) ;
...
F_88 ( V_2 , V_210 , V_205 , 1 ) ;
F_92 ( V_2 , V_199 , V_200 , V_200 ) ;
F_100 ( V_2 , V_199 , V_200 , V_200 ) ;
...
F_87 ( V_2 , V_212 , V_206 , 1 ) ;
F_99 ( V_2 , V_199 , V_200 , V_200 ) ;
ASSERT ( V_2 -> V_23 -> V_213 ( V_2 ,
F_42 ( V_2 , V_200 - 1 , V_124 ) , V_212 ) ) ;
}
F_119 ( V_124 , V_200 ) ;
F_101 ( V_2 , V_199 , V_214 ) ;
F_119 ( V_125 , V_202 ) ;
F_101 ( V_2 , V_201 , V_214 ) ;
F_118 ( V_2 , V_208 , V_202 - 1 ) ;
if ( V_5 > 0 ) {
#ifdef F_106
int V_66 ;
...
F_44 ( V_2 , 2 , V_125 ) ,
- 1 , V_202 ) ;
F_92 ( V_2 , V_201 , 1 , V_202 ) ;
F_100 ( V_2 , V_201 , 1 , V_202 ) ;
} else {
F_90 ( V_2 ,
F_42 ( V_2 , 2 , V_125 ) ,
- 1 , V_202 ) ;
...
goto V_173;
#endif
F_72 ( V_2 , V_124 , & V_216 , V_130 ) ;
if ( F_70 ( V_2 , & V_216 ) )
goto V_175;
V_200 = F_107 ( V_124 ) ;
if ( V_2 -> V_80 [ V_5 ] >= V_200 )
goto V_175;
error = F_85 ( V_2 , & V_216 , V_5 , 0 , & V_125 , & V_201 ) ;
if ( error )
goto V_173;
V_202 = F_107 ( V_125 ) ;
...
#endif
F_89 ( V_2 , V_204 , 1 , V_202 ) ;
F_91 ( V_2 , V_205 , 1 , V_202 ) ;
#ifdef F_106
...
F_88 ( V_2 , V_205 , V_210 , 1 ) ;
F_92 ( V_2 , V_201 , 1 , V_202 + 1 ) ;
F_100 ( V_2 , V_201 , 1 , V_202 + 1 ) ;
...
V_212 = F_42 ( V_2 , V_200 , V_124 ) ;
V_206 = F_42 ( V_2 , 1 , V_125 ) ;
F_90 ( V_2 , V_206 , 1 , V_202 ) ;
F_87 ( V_2 , V_206 , V_212 , 1 ) ;
...
V_66 = F_57 ( V_215 , V_5 ) ;
F_121 ( V_66 == 1 , V_173 ) ;
error = F_104 ( V_215 , V_5 , & V_66 ) ;
if ( error )
goto V_218;
error = F_113 ( V_215 , V_204 , V_5 + 1 ) ;
if ( error )
goto V_218;
F_31 ( V_215 , V_219 ) ;
F_93 ( V_2 , V_164 ) ;
...
goto V_175;
F_108 ( V_2 , V_228 ) ;
error = F_84 ( V_2 , & V_216 , 0 , & V_125 , & V_201 ) ;
if ( error )
goto V_173;
F_78 ( V_2 , V_201 , F_45 ( V_124 ) , 0 ) ;
V_200 = F_107 ( V_124 ) ;
V_202 = V_200 / 2 ;
...
#endif
F_86 ( V_2 , V_204 , V_209 , V_202 ) ;
F_88 ( V_2 , V_205 , V_210 , V_202 ) ;
F_92 ( V_2 , V_201 , 1 , V_202 ) ;
F_100 ( V_2 , V_201 , 1 , V_202 ) ;
F_86 ( V_2 , V_159 , V_204 , 1 ) ;
} else {
union V_95 * V_212 ;
union V_95 * V_206 ;
V_212 = F_42 ( V_2 , V_225 , V_124 ) ;
V_206 = F_42 ( V_2 , 1 , V_125 ) ;
F_87 ( V_2 , V_206 , V_212 , V_202 ) ;
F_99 ( V_2 , V_201 , 1 , V_202 ) ;
V_2 -> V_23 -> V_184 ( V_159 ,
F_42 ( V_2 , 1 , V_125 ) ) ;
}
F_72 ( V_2 , V_124 , & V_222 , V_130 ) ;
F_73 ( V_2 , V_125 , & V_222 , V_130 ) ;
F_73 ( V_2 , V_125 , & V_203 , V_129 ) ;
F_73 ( V_2 , V_124 , & V_216 , V_130 ) ;
V_200 -= V_202 ;
F_119 ( V_124 , V_200 ) ;
F_119 ( V_125 , F_107 ( V_125 ) + V_202 ) ;
F_101 ( V_2 , V_201 , V_168 ) ;
F_101 ( V_2 , V_199 , V_214 | V_130 ) ;
if ( ! F_70 ( V_2 , & V_222 ) ) {
error = F_85 ( V_2 , & V_222 , V_5 ,
0 , & V_224 , & V_223 ) ;
if ( error )
goto V_173;
F_73 ( V_2 , V_224 , & V_216 , V_129 ) ;
F_101 ( V_2 , V_223 , V_129 ) ;
}
...
F_108 ( V_2 , V_228 ) ;
error = F_84 ( V_2 , & V_234 , 0 , & V_231 , & V_230 ) ;
if ( error )
goto V_173;
...
F_86 ( V_2 , V_232 , V_183 , F_107 ( V_231 ) ) ;
...
#endif
F_88 ( V_2 , V_233 , V_180 , F_107 ( V_231 ) ) ;
#ifdef F_106
error = F_22 ( V_2 , & V_234 , 0 , V_5 ) ;
if ( error )
goto V_173;
#endif
F_88 ( V_2 , V_180 , & V_234 , 1 ) ;
F_126 ( V_2 -> V_39 . V_72 . V_99 ,
1 - F_107 ( V_231 ) ,
V_2 -> V_39 . V_72 . V_100 ) ;
F_69 ( V_2 , V_5 , V_230 ) ;
F_101 ( V_2 , V_230 , V_168 ) ;
F_92 ( V_2 , V_230 , 1 , F_7 ( V_231 -> V_22 ) ) ;
F_100 ( V_2 , V_230 , 1 , F_7 ( V_231 -> V_22 ) ) ;
* V_229 |=
V_236 | F_98 ( V_2 -> V_39 . V_72 . V_100 ) ;
* V_172 = 1 ;
F_93 ( V_2 , V_164 ) ;
return 0 ;
V_173:
...
goto V_175;
F_108 ( V_2 , V_228 ) ;
error = F_84 ( V_2 , & V_203 , 0 , & V_76 , & V_237 ) ;
if ( error )
goto V_173;
...
goto V_173;
#endif
F_72 ( V_2 , V_4 , & V_216 , V_130 ) ;
if ( ! F_70 ( V_2 , & V_216 ) ) {
V_199 = V_7 ;
F_80 ( V_2 , V_199 , & V_203 ) ;
V_124 = V_4 ;
error = F_85 ( V_2 , & V_216 ,
...
V_201 = V_7 ;
F_80 ( V_2 , V_201 , & V_216 ) ;
V_125 = V_4 ;
F_72 ( V_2 , V_125 , & V_203 , V_129 ) ;
error = F_85 ( V_2 , & V_203 ,
...
F_78 ( V_2 , V_237 , V_2 -> V_67 , 2 ) ;
F_101 ( V_2 , V_237 , V_168 ) ;
ASSERT ( ! F_70 ( V_2 , & V_203 ) &&
! F_70 ( V_2 , & V_216 ) ) ;
if ( F_45 ( V_124 ) > 0 ) {
F_86 ( V_2 ,
F_43 ( V_2 , 1 , V_76 ) ,
...
F_126 ( V_99 , 1 , V_2 -> V_39 . V_72 . V_100 ) ;
} else {
int V_229 = 0 ;
error = F_124 ( V_2 , & V_229 , V_172 ) ;
if ( error || * V_172 == 0 )
return error ;
F_97 ( V_2 -> V_69 , V_99 , V_229 ) ;
}
return 0 ;
}
error = F_120 ( V_2 , V_5 , V_172 ) ;
if ( error || * V_172 )
return error ;
error = F_117 ( V_2 , V_5 , V_172 ) ;
if ( error )
return error ;
if ( * V_172 ) {
...
error = F_122 ( V_2 , V_5 , V_234 , & V_159 , V_75 , V_172 ) ;
if ( error || * V_172 == 0 )
return error ;
* V_53 = V_2 -> V_80 [ V_5 ] ;
...
#endif
F_93 ( V_2 , V_162 ) ;
F_130 ( V_2 , V_5 , * V_177 , V_244 ) ;
V_75 = NULL ;
if ( ! ( V_2 -> V_46 & V_103 ) &&
( V_5 >= V_2 -> V_67 ) ) {
error = F_127 ( V_2 , V_172 ) ;
F_71 ( V_2 , V_177 ) ;
F_93 ( V_2 , V_164 ) ;
return error ;
}
...
#endif
F_89 ( V_2 , V_183 , 1 , V_134 - V_52 + 1 ) ;
F_91 ( V_2 , V_180 , 1 , V_134 - V_52 + 1 ) ;
#ifdef F_106
error = F_22 ( V_2 , V_177 , 0 , V_5 ) ;
if ( error )
goto V_173;
#endif
F_86 ( V_2 , V_183 , & V_159 , 1 ) ;
F_88 ( V_2 , V_180 , V_177 , 1 ) ;
V_134 ++ ;
F_119 ( V_4 , V_134 ) ;
F_100 ( V_2 , V_7 , V_52 , V_134 ) ;
F_92 ( V_2 , V_7 , V_52 , V_134 ) ;
#ifdef F_106
if ( V_52 < V_134 ) {
...
union V_95 * V_196 ;
V_196 = F_42 ( V_2 , V_52 , V_4 ) ;
F_90 ( V_2 , V_196 , 1 , V_134 - V_52 + 1 ) ;
F_87 ( V_2 , V_196 , V_244 , 1 ) ;
F_119 ( V_4 , ++ V_134 ) ;
...
do {
error = F_129 ( V_248 , V_5 , & V_234 , & V_161 , & V_75 , & V_66 ) ;
if ( error ) {
if ( V_248 != V_2 )
F_31 ( V_248 , V_220 ) ;
goto V_173;
...
#ifdef F_106
F_72 ( V_2 , V_4 , & V_52 , V_129 ) ;
ASSERT ( F_70 ( V_2 , & V_52 ) ) ;
F_72 ( V_2 , V_4 , & V_52 , V_130 ) ;
ASSERT ( F_70 ( V_2 , & V_52 ) ) ;
#endif
V_53 = V_134 - V_2 -> V_23 -> V_24 ( V_2 , V_5 ) ;
if ( V_53 ) {
F_126 ( V_2 -> V_39 . V_72 . V_99 , V_53 ,
V_2 -> V_39 . V_72 . V_100 ) ;
V_4 = V_98 -> V_101 ;
}
F_125 ( & V_4 -> V_22 , V_53 ) ;
...
#endif
if ( V_52 < V_134 ) {
F_89 ( V_2 , V_209 , - 1 , V_134 - V_52 ) ;
F_91 ( V_2 , V_210 , - 1 , V_134 - V_52 ) ;
F_92 ( V_2 , V_7 , V_52 , V_134 - 1 ) ;
F_100 ( V_2 , V_7 , V_52 , V_134 - 1 ) ;
}
if ( V_52 == 1 )
...
if ( V_5 == V_2 -> V_67 - 1 ) {
if ( V_2 -> V_46 & V_103 ) {
F_126 ( V_2 -> V_39 . V_72 . V_99 , - 1 ,
V_2 -> V_39 . V_72 . V_100 ) ;
error = F_132 ( V_2 ) ;
if ( error )
goto V_173;
error = F_134 ( V_2 , V_5 , V_172 ) ;
if ( error )
goto V_173;
* V_172 = 1 ;
return 0 ;
...
goto V_173;
#endif
F_72 ( V_215 , V_125 , & V_253 , V_129 ) ;
if ( F_107 ( V_125 ) - 1 >=
V_2 -> V_23 -> V_256 ( V_215 , V_5 ) ) {
error = F_117 ( V_215 , V_5 , & V_66 ) ;
if ( error )
goto V_173;
if ( V_66 ) {
ASSERT ( F_107 ( V_4 ) >=
...
goto V_173;
#endif
F_72 ( V_215 , V_124 , & V_253 , V_130 ) ;
if ( F_107 ( V_124 ) - 1 >=
V_2 -> V_23 -> V_256 ( V_215 , V_5 ) ) {
error = F_120 ( V_215 , V_5 , & V_66 ) ;
if ( error )
goto V_173;
if ( V_66 ) {
ASSERT ( F_107 ( V_4 ) >=
...
V_125 = V_4 ;
V_201 = V_7 ;
error = F_85 ( V_2 , & V_203 , V_5 ,
0 , & V_124 , & V_199 ) ;
if ( error )
goto V_173;
} else if ( ! F_70 ( V_2 , & V_216 ) &&
V_202 + F_107 ( V_4 ) <=
V_2 -> V_23 -> V_24 ( V_2 , V_5 ) ) {
V_203 = V_253 ;
V_124 = V_4 ;
V_199 = V_7 ;
error = F_85 ( V_2 , & V_216 , V_5 ,
0 , & V_125 , & V_201 ) ;
if ( error )
goto V_173;
} else {
...
#endif
F_86 ( V_2 , V_209 , V_204 , V_202 ) ;
F_88 ( V_2 , V_210 , V_205 , V_202 ) ;
F_92 ( V_2 , V_199 , V_200 + 1 , V_200 + V_202 ) ;
F_100 ( V_2 , V_199 , V_200 + 1 , V_200 + V_202 ) ;
} else {
union V_95 * V_212 ;
union V_95 * V_206 ;
V_212 = F_42 ( V_2 , V_200 + 1 , V_124 ) ;
V_206 = F_42 ( V_2 , 1 , V_125 ) ;
F_87 ( V_2 , V_212 , V_206 , V_202 ) ;
F_99 ( V_2 , V_199 , V_200 + 1 , V_200 + V_202 ) ;
}
F_108 ( V_2 , V_257 ) ;
F_119 ( V_124 , V_200 + V_202 ) ;
F_72 ( V_2 , V_125 , & V_253 , V_130 ) ,
F_73 ( V_2 , V_124 , & V_253 , V_130 ) ;
F_101 ( V_2 , V_199 , V_214 | V_130 ) ;
F_72 ( V_2 , V_124 , & V_253 , V_130 ) ;
if ( ! F_70 ( V_2 , & V_253 ) ) {
error = F_85 ( V_2 , & V_253 , V_5 ,
0 , & V_224 , & V_223 ) ;
if ( error )
goto V_173;
F_73 ( V_2 , V_224 , & V_203 , V_129 ) ;
F_101 ( V_2 , V_223 , V_129 ) ;
}
...
V_4 = F_48 ( V_2 , V_5 , & V_7 ) ;
if ( V_2 -> V_46 & V_47 )
V_4 -> V_13 . V_14 . V_137 = F_4 ( V_258 ) ;
else
V_4 -> V_13 . V_42 . V_137 = F_17 ( V_258 ) ;
if ( V_7 ) {
if ( V_2 -> V_69 ) {
F_139 ( V_2 -> V_69 , V_7 ) ;
F_101 ( V_2 , V_7 , V_261 ) ;
...
if ( F_70 ( V_2 , & V_216 ) )
return V_262 ;
return F_110 ( V_2 , V_5 , & V_216 , & V_4 ) ;
}
int
F_141 (
struct V_1 * V_2 ,
...
struct V_3 * V_4 = NULL ;
int error = 0 ;
V_2 -> V_23 -> V_187 ( V_2 , & V_203 ) ;
for ( V_5 = V_2 -> V_67 - 1 ; V_5 >= 0 ; V_5 -- ) {
error = F_110 ( V_2 , V_5 , & V_203 , & V_4 ) ;
if ( error )
return error ;
if ( V_5 > 0 ) {
union V_51 * V_52 ;
