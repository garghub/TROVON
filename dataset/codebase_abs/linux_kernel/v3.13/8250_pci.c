...
unsigned int V_157 = 6912 ;
unsigned int V_158 = 15625 ;
T_4 V_126 ;
if ( V_156 == 1000000 || V_156 == 2000000 || V_156 == 4000000 ) {
V_157 = 64 ;
V_158 = 100 ;
V_47 -> V_144 = 64000000 ;
} else if ( V_156 == 3000000 ) {
V_157 = 48 ;
V_158 = 100 ;
V_47 -> V_144 = 48000000 ;
} else {
