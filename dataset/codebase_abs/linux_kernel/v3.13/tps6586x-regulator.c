...
F_14 ( V_40 ) ;
if ( V_43 < 0 ) {
F_8 ( & V_13 -> V_17 , L_4 , V_43 ) ;
return NULL ;
}
V_42 = F_15 ( & V_13 -> V_17 , sizeof( * V_42 ) , V_44 ) ;
if ( ! V_42 ) {
F_8 ( & V_13 -> V_17 , L_5 ) ;
return NULL ;
}
...
V_3 [ V_14 ] = F_19 ( & V_13 -> V_17 , & V_6 -> V_31 ,
& V_54 ) ;
if ( F_20 ( V_3 [ V_14 ] ) ) {
F_8 ( & V_13 -> V_17 , L_11 ,
V_6 -> V_31 . V_49 ) ;
return F_21 ( V_3 [ V_14 ] ) ;
}
if ( V_55 ) {
V_43 = F_7 ( V_13 , V_14 ,
V_55 ) ;
