...
int F_154 ( struct V_70 * V_71 , int V_284 ,
T_11 V_249 ,
int V_37 )
{
F_79 ( V_167 ) ;
int V_168 , V_46 ;
V_168 = F_148 ( V_71 , & V_167 , V_284 , 0 , V_37 ) ;
...
T_5 * V_74 ,
T_6 V_75 , int V_132 ,
T_11 V_249 , void * V_285 )
{
struct V_4 * V_5 ;
int V_168 = 0 ;
F_157 ( V_208 ) ;
F_113 (lock, &res->lr_granted, l_res_link) {
if ( V_285 != NULL && V_5 -> V_286 != V_285 ) {
F_15 ( V_5 , L_67 ,
V_5 -> V_286 , V_285 ) ;
continue;
}
...
static int F_166 ( struct V_287 * V_288 , struct V_289 * V_290 ,
struct V_291 * V_292 , void * V_293 )
{
struct V_207 * V_208 = F_167 ( V_288 , V_292 ) ;
...
int F_171 ( struct V_207 * V_208 , T_15 V_300 ,
void * V_301 )
{
struct V_166 * V_302 , * V_251 ;
struct V_4 * V_5 ;
int V_46 = V_303 ;
if ( ! V_208 )
return V_303 ;
...
V_5 = F_160 ( V_302 , struct V_4 , V_304 ) ;
...
static int F_173 ( struct V_4 * V_5 , void * V_301 )
{
struct V_306 * V_307 = V_301 ;
return V_307 -> V_300 ( V_5 , V_307 -> V_301 ) ;
}
static int F_174 ( struct V_287 * V_288 , struct V_289 * V_290 ,
struct V_291 * V_292 , void * V_293 )
{
struct V_207 * V_208 = F_167 ( V_288 , V_292 ) ;
return F_171 ( V_208 , F_173 , V_293 ) ==
V_305 ;
}
void F_175 ( struct V_70 * V_71 ,
T_15 V_300 , void * V_301 )
{
struct V_306 V_307 = {
. V_300 = V_300 ,
. V_301 = V_301 ,
...
return 0 ;
F_163 ( V_208 ) ;
V_46 = F_171 ( V_208 , V_300 , V_1 ) ;
F_164 ( V_208 ) ;
F_165 ( V_208 ) ;
return V_46 ;
}
static int F_177 ( struct V_4 * V_5 , void * V_301 )
{
struct V_166 * V_308 = V_301 ;
F_60 ( F_130 ( & V_5 -> V_309 ) ,
L_75 ,
V_5 , & V_5 -> V_309 . V_251 , & V_5 -> V_309 . V_310 ) ;
if ( ! ( V_5 -> V_33 & ( V_35 | V_215 ) ) ) {
F_131 ( & V_5 -> V_309 , V_308 ) ;
F_150 ( V_5 ) ;
}
return V_303 ;
}
static int F_178 ( const struct V_311 * V_312 ,
struct V_108 * V_109 ,
...
struct V_114 * V_115 ;
struct V_107 * exp ;
F_179 ( & V_109 -> V_230 -> V_315 ) ;
if ( V_46 != V_98 )
GOTO ( V_99 , V_46 ) ;
V_115 = F_62 ( & V_109 -> V_122 , & V_123 ) ;
if ( V_115 == NULL )
GOTO ( V_99 , V_46 = - V_124 ) ;
V_5 = F_59 ( & V_314 -> V_130 ) ;
if ( ! V_5 ) {
F_42 ( L_76 V_135
L_77 V_135 L_78 ,
V_314 -> V_130 . V_136 , V_115 -> V_130 . V_136 ,
...
V_5 -> V_119 ) ;
F_96 ( V_109 ) ;
F_184 ( V_109 -> V_322 , V_323 ) ;
F_7 ( V_5 , L_82 ) ;
F_185 ( & V_109 -> V_230 -> V_315 ) ;
F_186 ( sizeof( * V_314 ) <= sizeof( V_109 -> V_324 ) ) ;
V_314 = F_187 ( V_109 ) ;
V_314 -> V_130 = V_187 -> V_130 [ 0 ] ;
V_109 -> V_325 = ( V_326 ) F_178 ;
F_118 ( V_109 , V_228 , - 1 ) ;
return 0 ;
}
...
V_327 = F_83 ( V_71 , & V_167 , V_71 -> V_277 , 0 ,
V_254 , V_271 ) ;
F_67 ( V_17 , L_85 ,
V_327 , F_189 ( V_71 ) ) ;
}
...
struct V_4 * V_5 , * V_251 ;
int V_46 = 0 ;
F_47 ( F_191 ( & V_8 -> V_315 ) == 0 ) ;
if ( V_8 -> V_328 )
return 0 ;
F_185 ( & V_8 -> V_315 ) ;
if ( V_329 )
F_188 ( V_71 ) ;
F_175 ( V_71 , F_177 , & V_308 ) ;
