...
if ( ! F_46 ( V_13 -> V_22 ) )
continue;
if ( V_100 && ! F_58 ( V_13 -> V_22 ) ) {
F_9 ( V_101 L_18
L_19 , V_47 -> V_103 , V_13 -> V_22 ) ;
goto error;
}
}
F_52 (drhd) {
...
/ sizeof( struct V_113 ) ;
while ( -- V_17 > 0 ) {
V_55 = F_63 ( V_55 , V_114 -> V_116 , V_114 -> V_117 ,
V_118 ) ;
V_114 ++ ;
}
V_39 [ V_119 ] . V_55 = V_55 ;
V_39 [ V_119 ] . V_56 = F_64 ( V_114 -> V_116 , V_114 -> V_117 ) ;
...
V_43 [ V_121 ] . V_56 = F_64 ( V_114 -> V_116 , V_114 -> V_117 ) ;
...
F_9 ( V_101 L_27
L_28 , V_112 -> V_120 ,
V_47 -> V_127 , V_13 -> V_128 ) ;
F_65 ( V_112 , V_13 ) ;
} else if ( V_112 -> V_125 == V_129 ) {
if ( V_119 == V_38 ) {
F_9 ( V_81 L_29 ) ;
return - 1 ;
}
...
static void F_75 ( struct V_5 * V_5 , int V_136 ,
unsigned int V_137 )
{
...
V_5 -> V_136 = V_136 ;
V_5 -> V_143 = F_76 ( V_137 ) ;
V_5 -> V_144 = 1 ;
}
static int F_77 ( int V_2 ,
struct V_145 * V_146 ,
unsigned int V_147 , int V_136 ,
struct V_148 * V_149 )
{
int V_134 = F_67 ( V_149 -> V_150 ) ;
struct V_16 * V_13 = F_20 ( V_134 ) ;
struct V_151 * V_6 ;
struct V_5 V_5 ;
int V_9 ;
if ( ! V_13 ) {
...
F_75 ( & V_5 , V_136 , V_147 ) ;
F_26 ( & V_5 , V_134 ) ;
F_16 ( V_2 , & V_5 ) ;
F_78 ( V_153 , V_154 L_36
L_37
L_38
L_39
L_40 ,
V_149 -> V_150 , V_5 . V_24 , V_5 . V_155 , V_5 . V_138 ,
V_5 . V_144 , V_5 . V_140 , V_5 . V_141 ,
V_5 . V_156 , V_5 . V_136 , V_5 . V_143 ,
...
static int
F_79 ( struct V_163 * V_164 , const struct V_165 * V_20 ,
bool V_166 )
{
struct V_3 * V_4 = V_164 -> V_167 ;
unsigned int V_137 , V_2 = V_164 -> V_2 ;
struct V_5 V_5 ;
int V_168 ;
if ( ! F_80 ( V_169 ) )
return - V_170 ;
...
if ( F_2 ( V_2 , & V_5 ) )
return - V_172 ;
V_168 = F_82 ( V_2 , V_4 , V_20 ) ;
if ( V_168 )
return V_168 ;
V_168 = V_41 -> V_173 ( V_4 -> V_174 , V_20 , & V_137 ) ;
if ( V_168 ) {
if ( F_82 ( V_2 , V_4 , V_164 -> V_175 ) )
F_68 ( L_41 , V_2 ) ;
return V_168 ;
}
V_5 . V_136 = V_4 -> V_136 ;
...
if ( V_4 -> V_176 )
F_83 ( V_4 ) ;
F_84 ( V_164 -> V_175 , V_20 ) ;
return 0 ;
}
static void F_85 ( struct V_44 * V_177 ,
unsigned int V_2 , unsigned int V_137 ,
struct V_178 * V_179 , T_2 V_37 )
{
struct V_3 * V_4 ;
struct V_5 V_5 ;
T_1 V_12 = 0 ;
...
static int F_89 ( struct V_44 * V_45 , int V_2 , int V_187 )
{
struct V_16 * V_13 ;
int V_9 ;
V_13 = F_21 ( V_45 ) ;
...
static int F_91 ( struct V_44 * V_177 , unsigned int V_2 ,
int V_9 , int V_12 )
{
struct V_16 * V_13 ;
V_13 = F_21 ( V_177 ) ;
