...
union V_115 * V_25 )
{
int V_75 = F_35 ( V_2 , V_114 , V_25 ) ;
return V_75 ;
}
static int F_36 ( struct V_1 * V_2 , T_3 V_114 ,
union V_115 * V_25 )
{
int V_75 = F_37 ( V_2 , V_114 , V_25 ) ;
return V_75 ;
}
static struct V_1 * F_38 ( struct V_14 * V_14 ,
unsigned int V_114 )
{
struct V_18 * V_19 ;
struct V_1 * V_2 ;
int V_116 ;
V_19 = F_39 ( V_117 , V_118 ) ;
if ( ! V_19 ) {
V_116 = - V_119 ;
goto V_120;
}
...
V_116 = F_40 ( V_2 , V_14 , V_114 ) ;
if ( V_116 )
goto V_121;
V_116 = F_41 ( V_19 ) ;
if ( V_116 )
goto V_122;
V_2 -> V_15 . V_54 = ( void * ) F_42 ( V_118 | V_123 ) ;
if ( ! V_2 -> V_15 . V_54 )
goto V_124;
return V_2 ;
V_124:
...
{
struct V_18 * V_19 = F_19 ( V_2 ) ;
F_48 ( ( unsigned long ) V_2 -> V_15 . V_54 ) ;
F_43 ( V_19 ) ;
F_44 ( V_2 ) ;
F_45 ( V_117 , V_19 ) ;
}
...
F_55 ( 64 ) ;
F_56 ( 0 ) ;
V_75 = F_57 ( NULL , sizeof( struct V_18 ) , 0 , V_126 ) ;
if ( V_75 )
goto V_125;
V_127 . V_128 = V_126 ;
V_129 = & V_127 ;
