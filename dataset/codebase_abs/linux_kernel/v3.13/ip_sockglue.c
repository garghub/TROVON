...
V_28 = F_61 ( V_4 , 0 , V_2 -> V_109 , V_104 ) ;
if ( V_28 )
goto V_110;
F_62 ( V_2 , V_43 , V_4 ) ;
V_83 = F_46 ( V_4 ) ;
sin = (struct V_30 * ) V_2 -> V_111 ;
if ( sin ) {
sin -> V_35 = V_36 ;
...
memcpy ( & V_103 . V_85 , & V_83 -> V_85 , sizeof( struct V_101 ) ) ;
sin = & V_103 . V_102 ;
sin -> V_35 = V_112 ;
...
F_4 ( V_2 , V_10 , V_114 , sizeof( V_103 ) , & V_103 ) ;
V_2 -> V_21 |= V_115 ;
V_28 = V_104 ;
F_37 ( & V_43 -> V_106 . V_116 ) ;
V_43 -> V_117 = 0 ;
V_100 = F_63 ( & V_43 -> V_106 ) ;
if ( V_100 != NULL ) {
V_43 -> V_117 = F_46 ( V_100 ) -> V_85 . V_86 ;
F_40 ( & V_43 -> V_106 . V_116 ) ;
V_43 -> V_118 ( V_43 ) ;
} else
F_40 ( & V_43 -> V_106 . V_116 ) ;
V_110:
...
static int F_64 ( struct V_67 * V_43 , int V_119 ,
...
case V_136 :
if ( V_17 >= sizeof( int ) ) {
if ( F_65 ( V_49 , ( int T_6 * ) V_121 ) )
return - V_137 ;
} else if ( V_17 >= sizeof( char ) ) {
unsigned char V_138 ;
if ( F_65 ( V_138 , ( unsigned char T_6 * ) V_121 ) )
return - V_137 ;
V_49 = ( int ) V_138 ;
}
}
if ( F_66 ( V_120 ) )
return F_67 ( V_43 , V_120 , V_121 , V_17 ) ;
V_28 = 0 ;
F_68 ( V_43 ) ;
switch ( V_120 ) {
case V_139 :
...
if ( V_17 != sizeof( int ) )
goto V_142;
V_179 = ( V_180 int ) F_77 ( ( V_180 T_5 ) V_49 ) ;
if ( V_179 == 0 ) {
V_42 -> V_181 = 0 ;
V_28 = 0 ;
break;
}
V_178 = F_78 ( F_70 ( V_43 ) , V_179 ) ;
V_28 = - V_182 ;
if ( ! V_178 )
break;
F_79 ( V_178 ) ;
...
if ( F_80 ( & V_186 , V_121 , sizeof( V_186 ) ) )
break;
} else {
...
if ( F_80 ( & V_186 . V_189 , V_121 ,
sizeof( struct V_187 ) ) )
break;
}
}
if ( ! V_186 . V_190 ) {
if ( V_186 . V_189 . V_8 == F_81 ( V_191 ) ) {
V_42 -> V_192 = 0 ;
V_42 -> V_193 = 0 ;
V_28 = 0 ;
break;
}
V_178 = F_82 ( F_70 ( V_43 ) , V_186 . V_189 . V_8 ) ;
if ( V_178 )
V_186 . V_190 = V_178 -> V_179 ;
} else
V_178 = F_78 ( F_70 ( V_43 ) , V_186 . V_190 ) ;
V_28 = - V_182 ;
if ( ! V_178 )
break;
F_79 ( V_178 ) ;
...
memset ( & V_186 , 0 , sizeof( V_186 ) ) ;
if ( F_80 ( & V_186 , V_121 , sizeof( struct V_188 ) ) )
break;
}
if ( V_120 == V_194 )
V_28 = F_83 ( V_43 , & V_186 ) ;
else
...
if ( F_85 ( V_199 -> V_201 ) > V_17 ) {
F_33 ( V_199 ) ;
V_28 = - V_52 ;
break;
}
V_28 = F_86 ( V_43 , V_199 , 0 ) ;
F_33 ( V_199 ) ;
break;
}
case V_203 :
...
goto V_142;
if ( F_80 ( & V_208 , V_121 , sizeof( V_208 ) ) ) {
V_28 = - V_137 ;
break;
}
if ( V_120 == V_203 ) {
...
V_28 = F_87 ( V_210 , V_209 , V_43 , & V_208 , 0 ) ;
break;
}
case V_215 :
case V_216 :
...
goto V_142;
V_28 = - V_137 ;
if ( F_80 ( & V_218 , V_121 , sizeof( V_218 ) ) )
break;
...
goto V_142;
if ( F_80 ( & V_227 , V_121 , sizeof( V_227 ) ) ) {
V_28 = - V_137 ;
break;
}
...
V_28 = F_87 ( V_210 , V_209 , V_43 , & V_208 ,
V_227 . V_232 ) ;
break;
}
case V_233 :
...
if ( F_88 ( V_235 -> V_239 ) > V_17 ) {
V_28 = - V_52 ;
goto V_238;
}
V_236 = F_85 ( V_235 -> V_239 ) ;
...
case V_251 :
V_28 = - V_252 ;
if ( ! F_89 ( F_70 ( V_43 ) -> V_253 , V_254 ) )
break;
V_28 = F_90 ( V_43 , V_120 , V_121 , V_17 ) ;
break;
case V_129 :
if ( ! ! V_49 && ! F_89 ( F_70 ( V_43 ) -> V_253 , V_255 ) &&
! F_89 ( F_70 ( V_43 ) -> V_253 , V_254 ) ) {
V_28 = - V_252 ;
break;
}
if ( V_17 < 1 )
...
void F_92 ( const struct V_67 * V_43 , struct V_3 * V_4 )
{
struct V_5 * V_258 = F_2 ( V_4 ) ;
if ( ( F_20 ( V_43 ) -> V_45 & V_158 ) &&
F_93 ( V_4 ) ) {
V_258 -> V_57 = F_94 ( V_4 ) ;
V_258 -> V_59 . V_8 = F_95 ( V_4 ) ;
} else {
V_258 -> V_57 = 0 ;
V_258 -> V_59 . V_8 = 0 ;
}
...
int F_97 ( struct V_67 * V_43 , int V_119 ,
int V_120 , char T_6 * V_121 , unsigned int V_17 )
{
int V_28 ;
if ( V_119 != V_10 )
return - V_169 ;
V_28 = F_64 ( V_43 , V_119 , V_120 , V_121 , V_17 ) ;
#ifdef F_98
...
! F_66 ( V_120 ) ) {
F_68 ( V_43 ) ;
V_28 = F_99 ( V_43 , V_149 , V_120 , V_121 , V_17 ) ;
F_91 ( V_43 ) ;
}
#endif
return V_28 ;
}
int F_100 ( struct V_67 * V_43 , int V_119 , int V_120 ,
...
return F_101 ( V_43 , V_119 , V_120 , V_121 , V_17 ,
F_97 ) ;
V_28 = F_64 ( V_43 , V_119 , V_120 , V_121 , V_17 ) ;
#ifdef F_98
if ( V_28 == - V_169 && V_120 != V_124 &&
...
static int F_103 ( struct V_67 * V_43 , int V_119 , int V_120 ,
...
return - V_259 ;
if ( F_66 ( V_120 ) )
return F_104 ( V_43 , V_120 , V_121 , V_17 ) ;
if ( F_65 ( V_34 , V_17 ) )
return - V_137 ;
if ( V_34 < 0 )
return - V_52 ;
...
break;
case V_132 :
V_49 = ( V_180 int ) F_81 ( ( V_265 ) V_42 -> V_181 ) ;
break;
case V_184 :
{
struct V_187 V_58 ;
...
if ( F_80 ( & V_199 , V_121 , F_85 ( 0 ) ) ) {
F_91 ( V_43 ) ;
return - V_137 ;
}
V_28 = F_111 ( V_43 , & V_199 ,
...
if ( F_80 ( & V_235 , V_121 , F_88 ( 0 ) ) ) {
F_91 ( V_43 ) ;
return - V_137 ;
}
V_28 = F_112 ( V_43 , & V_235 ,
...
if ( V_42 -> V_45 & V_158 ) {
struct V_5 V_6 ;
V_6 . V_7 . V_8 = V_42 -> V_269 ;
V_6 . V_59 . V_8 = V_42 -> V_269 ;
V_6 . V_57 = V_42 -> V_192 ;
F_4 ( & V_2 , V_10 , V_11 , sizeof( V_6 ) , & V_6 ) ;
}
if ( V_42 -> V_45 & V_159 ) {
int V_270 = V_42 -> V_175 ;
F_4 ( & V_2 , V_10 , V_13 , sizeof( V_270 ) , & V_270 ) ;
}
if ( V_42 -> V_45 & V_160 ) {
int V_15 = V_42 -> V_271 ;
...
if ( F_105 ( V_34 , V_17 ) )
return - V_137 ;
if ( F_107 ( V_121 , & V_138 , 1 ) )
return - V_137 ;
} else {
V_34 = F_106 (unsigned int, sizeof(int), len) ;
if ( F_105 ( V_34 , V_17 ) )
return - V_137 ;
if ( F_107 ( V_121 , & V_49 , V_34 ) )
return - V_137 ;
}
return 0 ;
}
int F_113 ( struct V_67 * V_43 , int V_119 ,
int V_120 , char T_6 * V_121 , int T_6 * V_17 )
{
int V_28 ;
V_28 = F_103 ( V_43 , V_119 , V_120 , V_121 , V_17 , 0 ) ;
#ifdef F_98
if ( V_28 == - V_169 && V_120 != V_266 &&
! F_66 ( V_120 ) ) {
int V_34 ;
if ( F_65 ( V_34 , V_17 ) )
return - V_137 ;
F_68 ( V_43 ) ;
V_28 = F_114 ( V_43 , V_149 , V_120 , V_121 ,
& V_34 ) ;
F_91 ( V_43 ) ;
if ( V_28 >= 0 )
...
int F_115 ( struct V_67 * V_43 , int V_119 , int V_120 ,
char T_6 * V_121 , int T_6 * V_17 )
{
int V_28 ;
if ( V_120 == V_233 )
return F_116 ( V_43 , V_119 , V_120 , V_121 , V_17 ,
F_113 ) ;
V_28 = F_103 ( V_43 , V_119 , V_120 , V_121 , V_17 ,
V_272 ) ;
#ifdef F_98
if ( V_28 == - V_169 && V_120 != V_266 &&
! F_66 ( V_120 ) ) {
...
return - V_137 ;
F_68 ( V_43 ) ;
V_28 = F_117 ( V_43 , V_149 , V_120 , V_121 , & V_34 ) ;
F_91 ( V_43 ) ;
if ( V_28 >= 0 )
V_28 = F_105 ( V_34 , V_17 ) ;
return V_28 ;
