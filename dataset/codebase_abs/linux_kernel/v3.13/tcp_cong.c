...
int F_43 ( struct V_45 * V_46 , T_3 V_53 )
{
T_3 V_54 = V_46 -> V_48 + V_53 ;
if ( V_54 > V_46 -> V_55 )
V_54 = V_46 -> V_55 + 1 ;
V_53 -= V_54 - V_46 -> V_48 ;
V_46 -> V_48 = F_44 ( V_54 , V_46 -> V_56 ) ;
return V_53 ;
}
void F_45 ( struct V_45 * V_46 , T_3 V_57 )
{
if ( V_46 -> V_58 >= V_57 ) {
if ( V_46 -> V_48 < V_46 -> V_56 )
V_46 -> V_48 ++ ;
V_46 -> V_58 = 0 ;
} else {
V_46 -> V_58 ++ ;
...
void F_46 ( struct V_13 * V_14 , T_3 V_59 , T_3 V_53 , T_3 V_44 )
{
struct V_45 * V_46 = F_40 ( V_14 ) ;
if ( ! F_39 ( V_14 , V_44 ) )
return;
if ( V_46 -> V_48 <= V_46 -> V_55 )
F_43 ( V_46 , V_53 ) ;
else
F_45 ( V_46 , V_46 -> V_48 ) ;
}
