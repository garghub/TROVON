...
static void T_3 F_37 ( char * V_91 )
{
char * V_92 ;
if ( ! V_91 || ! * V_91 )
return;
while ( ( V_92 = F_38 ( & V_91 , L_10 ) ) ) {
if ( ! * V_92 )
continue;
if ( ! strncmp ( V_92 , L_11 , 5 ) )
F_39 ( V_88 , V_92 + 5 , sizeof( V_88 ) ) ;
else if ( ! strncmp ( V_92 , L_12 , 4 ) )
V_80 = ! ! F_40 ( V_92 + 4 , NULL , 0 ) ;
else if ( ! strncmp ( V_92 , L_13 , 6 ) )
F_39 ( V_53 , V_92 + 6 , sizeof( V_53 ) ) ;
else
F_39 ( V_88 , V_92 , sizeof( V_88 ) ) ;
}
}
