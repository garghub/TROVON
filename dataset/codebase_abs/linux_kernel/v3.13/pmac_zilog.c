...
static void F_84 ( struct V_113 * V_36 , unsigned char V_208 )
{
struct V_1 * V_2 = (struct V_1 * ) V_36 ;
while ( ( F_2 ( V_2 , V_27 ) & V_82 ) == 0 )
F_3 ( 5 ) ;
...
if ( F_86 ( V_210 , 0 , & V_218 ) )
return - V_221 ;
V_2 -> V_36 . V_222 = V_218 . V_223 ;
V_2 -> V_36 . V_224 = F_87 ( V_2 -> V_36 . V_222 , 0x1000 ) ;
V_2 -> V_225 = V_2 -> V_36 . V_224 ;
V_2 -> V_226 = V_2 -> V_225 + 0x10 ;
#ifdef F_88
if ( F_86 ( V_210 , 1 , & V_220 ) == 0 &&
F_86 ( V_210 , 2 , & V_219 ) == 0 )
V_2 -> V_30 |= V_227 ;
#else
...
#endif
if ( F_89 ( V_2 ) ) {
V_2 -> V_228 = F_87 ( V_220 . V_223 , 0x100 ) ;
if ( V_2 -> V_228 == NULL ) {
V_2 -> V_30 &= ~ V_227 ;
goto V_229;
}
V_2 -> V_230 = F_87 ( V_219 . V_223 , 0x100 ) ;
if ( V_2 -> V_230 == NULL ) {
F_90 ( V_2 -> V_228 ) ;
V_2 -> V_228 = NULL ;
V_2 -> V_30 &= ~ V_227 ;
...
V_2 -> V_231 = F_91 ( V_210 , 1 ) ;
V_2 -> V_232 = F_91 ( V_210 , 2 ) ;
}
V_229:
if ( F_92 ( V_210 , L_35 ) )
V_2 -> V_30 |= V_233 ;
V_211 = F_93 ( V_210 , L_36 , & V_216 ) ;
if ( V_211 && ( strcmp ( V_211 , L_37 ) == 0 ) )
V_2 -> V_30 |= V_234 ;
V_2 -> V_135 = V_235 ;
V_215 = F_93 ( V_210 , L_38 , & V_216 ) ;
...
F_92 ( V_210 -> V_248 -> V_248 , L_45 ) ) {
V_2 -> V_36 . V_93 = F_97 ( NULL , 64 + 15 ) ;
V_2 -> V_231 = F_97 ( NULL , 64 + 4 ) ;
V_2 -> V_232 = F_97 ( NULL , 64 + 5 ) ;
}
...
static int F_99 ( struct V_249 * V_250 , const struct V_251 * V_252 )
{
struct V_1 * V_2 ;
int V_4 ;
...
F_100 ( & V_250 -> V_255 . V_256 , V_2 ) ;
if ( F_101 ( V_2 -> V_256 , L_46 ) )
F_95 ( V_258 L_47
L_48 ,
V_2 -> V_134 -> V_214 ) ;
else
V_2 -> V_30 |= V_259 ;
return F_102 ( & V_260 , & V_2 -> V_36 ) ;
}
static int F_103 ( struct V_249 * V_250 )
{
struct V_1 * V_2 = F_104 ( & V_250 -> V_255 . V_256 ) ;
if ( ! V_2 )
return - V_221 ;
F_105 ( & V_260 , & V_2 -> V_36 ) ;
if ( V_2 -> V_30 & V_259 ) {
F_106 ( V_2 -> V_256 ) ;
V_2 -> V_30 &= ~ V_259 ;
}
F_100 ( & V_250 -> V_255 . V_256 , NULL ) ;
V_2 -> V_256 = NULL ;
V_2 -> V_36 . V_256 = NULL ;
return 0 ;
}
static int F_107 ( struct V_249 * V_250 , T_4 V_261 )
{
struct V_1 * V_2 = F_104 ( & V_250 -> V_255 . V_256 ) ;
if ( V_2 == NULL ) {
F_95 ( L_49 ) ;
...
F_108 ( & V_260 , & V_2 -> V_36 ) ;
return 0 ;
}
static int F_109 ( struct V_249 * V_250 )
{
struct V_1 * V_2 = F_104 ( & V_250 -> V_255 . V_256 ) ;
if ( V_2 == NULL )
return 0 ;
F_110 ( & V_260 , & V_2 -> V_36 ) ;
return 0 ;
}
...
int V_213 = 0 ;
int V_97 ;
V_262 = F_94 ( NULL , L_50 ) ;
while ( V_262 ) {
V_263 = V_264 = NULL ;
for ( V_210 = NULL ; ( V_210 = F_112 ( V_262 , V_210 ) ) != NULL ; ) {
...
struct V_217 * V_218 ;
int V_93 ;
V_218 = F_114 ( V_2 -> V_270 , V_271 , 0 ) ;
V_93 = F_115 ( V_2 -> V_270 , 0 ) ;
if ( ! V_218 || ! V_93 )
return - V_221 ;
V_2 -> V_36 . V_222 = V_218 -> V_223 ;
V_2 -> V_36 . V_224 = ( unsigned char V_272 * ) V_218 -> V_223 ;
V_2 -> V_36 . V_241 = V_242 ;
V_2 -> V_36 . V_93 = V_93 ;
V_2 -> V_36 . V_243 = V_166 ;
V_2 -> V_36 . V_244 = 1 ;
...
static int T_3 F_99 ( struct V_276 * V_270 )
{
struct V_1 * V_2 ;
int V_4 ;
for ( V_4 = 0 ; V_4 < V_269 ; V_4 ++ )
if ( V_254 [ V_4 ] . V_270 == V_270 )
break;
if ( V_4 >= V_269 )
return - V_221 ;
V_2 = & V_254 [ V_4 ] ;
V_2 -> V_36 . V_256 = & V_270 -> V_256 ;
F_116 ( V_270 , V_2 ) ;
return F_102 ( & V_260 , & V_2 -> V_36 ) ;
}
static int T_5 F_103 ( struct V_276 * V_270 )
{
struct V_1 * V_2 = F_117 ( V_270 ) ;
if ( ! V_2 )
return - V_221 ;
F_105 ( & V_260 , & V_2 -> V_36 ) ;
V_2 -> V_36 . V_256 = NULL ;
...
static void F_128 ( struct V_113 * V_36 , int V_37 )
{
struct V_1 * V_2 = (struct V_1 * ) V_36 ;
while ( ( F_2 ( V_2 , V_27 ) & V_82 ) == 0 )
F_3 ( 5 ) ;
...
static void F_129 ( struct V_282 * V_283 , const char * V_284 , unsigned int V_213 )
{
struct V_1 * V_2 = & V_254 [ V_283 -> V_285 ] ;
unsigned long V_30 ;
F_44 ( & V_2 -> V_36 . V_56 , V_30 ) ;
F_7 ( V_2 , V_6 , V_2 -> V_32 [ 1 ] & ~ V_9 ) ;
F_7 ( V_2 , V_15 , V_2 -> V_32 [ 5 ] | V_16 | V_119 | V_121 ) ;
F_130 ( & V_2 -> V_36 , V_284 , V_213 , F_128 ) ;
F_7 ( V_2 , V_6 , V_2 -> V_32 [ 1 ] ) ;
F_45 ( & V_2 -> V_36 . V_56 , V_30 ) ;
}
static int T_3 F_131 ( struct V_282 * V_286 , char * V_287 )
{
struct V_1 * V_2 ;
struct V_113 * V_36 ;
int V_161 = 38400 ;
...
|| F_132 ( L_59 ) )
V_161 = 57600 ;
if ( V_286 -> V_285 >= V_269 )
V_286 -> V_285 = 0 ;
V_2 = & V_254 [ V_286 -> V_285 ] ;
#ifdef F_121
if ( V_2 -> V_134 == NULL )
return - V_221 ;
#else
...
F_71 ( V_150 ) ;
if ( V_287 )
F_134 ( V_287 , & V_161 , & V_62 , & V_288 , & V_289 ) ;
return F_135 ( V_36 , V_286 , V_161 , V_62 , V_288 , V_289 ) ;
}
