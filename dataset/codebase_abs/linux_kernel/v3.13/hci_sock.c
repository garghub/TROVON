...
V_54 -> V_22 = V_22 ;
V_54 -> V_56 = F_21 ( V_27 -> V_57 ) ;
V_54 -> V_29 = F_21 ( V_7 -> V_29 ) ;
}
V_32 = F_13 ( V_28 , V_41 ) ;
if ( ! V_32 )
continue;
...
static struct V_6 * F_23 ( struct V_26 * V_27 , int V_58 )
{
struct V_53 * V_54 ;
struct V_59 * V_60 ;
struct V_6 * V_7 ;
...
if ( ! V_7 )
return NULL ;
V_60 = ( void * ) F_25 ( V_7 , V_62 ) ;
V_60 -> type = V_27 -> V_63 ;
V_60 -> V_64 = V_27 -> V_64 ;
F_26 ( & V_60 -> V_65 , & V_27 -> V_65 ) ;
...
static void F_30 ( struct V_26 * V_27 , int type , int V_71 , void * V_19 )
{
struct V_72 * V_54 ;
struct V_73 * V_74 ;
struct V_6 * V_7 ;
V_7 = F_24 ( V_75 + sizeof( * V_74 ) + V_71 , V_41 ) ;
if ( ! V_7 )
return;
V_54 = ( void * ) F_25 ( V_7 , V_75 ) ;
V_54 -> V_76 = V_77 ;
V_54 -> V_78 = sizeof( * V_74 ) + V_71 ;
V_74 = ( void * ) F_25 ( V_7 , sizeof( * V_74 ) + V_71 ) ;
V_74 -> type = type ;
...
void F_31 ( struct V_26 * V_27 , int V_58 )
{
struct V_79 V_74 ;
...
V_74 . V_58 = V_58 ;
V_74 . V_80 = V_27 -> V_57 ;
F_30 ( NULL , V_81 , sizeof( V_74 ) , & V_74 ) ;
if ( V_58 == V_68 ) {
struct V_4 * V_5 ;
F_9 ( & V_30 . V_31 ) ;
F_10 (sk, &hci_sk_list.head) {
...
static int F_35 ( struct V_86 * V_4 )
{
...
static int F_44 ( struct V_26 * V_27 , void T_1 * V_92 )
{
T_2 V_65 ;
int V_93 ;
if ( F_45 ( & V_65 , V_92 , sizeof( V_65 ) ) )
return - V_94 ;
F_46 ( V_27 ) ;
V_93 = F_47 ( V_27 , & V_65 , V_95 ) ;
F_48 ( V_27 ) ;
return V_93 ;
}
static int F_49 ( struct V_26 * V_27 , void T_1 * V_92 )
{
T_2 V_65 ;
int V_93 ;
if ( F_45 ( & V_65 , V_92 , sizeof( V_65 ) ) )
return - V_94 ;
F_46 ( V_27 ) ;
V_93 = F_50 ( V_27 , & V_65 , V_95 ) ;
F_48 ( V_27 ) ;
return V_93 ;
}
static int F_51 ( struct V_4 * V_5 , unsigned int V_96 ,
unsigned long V_92 )
{
...
return - V_103 ;
if ( V_92 )
F_53 ( V_106 , & V_27 -> V_107 ) ;
else
F_39 ( V_106 , & V_27 -> V_107 ) ;
return 0 ;
case V_108 :
return F_54 ( V_27 , ( void T_1 * ) V_92 ) ;
case V_109 :
return F_55 ( V_27 , ( void T_1 * ) V_92 ) ;
case V_110 :
if ( ! F_52 ( V_102 ) )
return - V_103 ;
return F_44 ( V_27 , ( void T_1 * ) V_92 ) ;
case V_111 :
if ( ! F_52 ( V_102 ) )
return - V_103 ;
return F_49 ( V_27 , ( void T_1 * ) V_92 ) ;
}
return - V_112 ;
}
static int F_56 ( struct V_86 * V_4 , unsigned int V_96 ,
unsigned long V_92 )
{
...
if ( ! F_52 ( V_102 ) )
return - V_103 ;
return F_65 ( V_96 , V_113 ) ;
case V_130 :
return F_66 ( V_113 ) ;
}
F_57 ( V_5 ) ;
V_93 = F_51 ( V_5 , V_96 , V_92 ) ;
V_114:
F_58 ( V_5 ) ;
return V_93 ;
}
static int F_67 ( struct V_86 * V_4 , struct V_131 * V_2 ,
int V_132 )
{
struct V_133 V_134 ;
struct V_4 * V_5 = V_4 -> V_5 ;
...
V_29 = F_68 (unsigned int, sizeof(haddr), addr_len) ;
...
static int F_73 ( struct V_86 * V_4 , struct V_131 * V_2 ,
int * V_132 , int V_147 )
{
...
static void F_74 ( struct V_4 * V_5 , struct V_148 * V_149 ,
struct V_6 * V_7 )
{
V_3 V_150 = F_3 ( V_5 ) -> V_151 ;
if ( V_150 & V_152 ) {
int V_38 = F_4 ( V_7 ) -> V_38 ;
F_75 ( V_149 , V_153 , V_152 , sizeof( V_38 ) ,
& V_38 ) ;
}
if ( V_150 & V_154 ) {
#ifdef F_76
...
#endif
F_75 ( V_149 , V_153 , V_154 , V_29 , V_19 ) ;
}
}
static int F_78 ( struct V_164 * V_165 , struct V_86 * V_4 ,
...
F_80 ( V_7 ) ;
V_93 = F_81 ( V_7 , 0 , V_149 -> V_172 , V_168 ) ;
switch ( F_3 ( V_5 ) -> V_35 ) {
case V_36 :
F_74 ( V_5 , V_149 , V_7 ) ;
break;
...
static int F_84 ( struct V_164 * V_165 , struct V_86 * V_4 ,
...
V_7 = F_86 ( V_5 , V_29 , V_149 -> V_160 & V_167 , & V_93 ) ;
if ( ! V_7 )
goto V_114;
if ( F_87 ( F_25 ( V_7 , V_29 ) , V_149 -> V_172 , V_29 ) ) {
V_93 = - V_94 ;
goto V_177;
}
...
F_89 ( & V_27 -> V_178 , V_7 ) ;
F_90 ( V_27 -> V_179 , & V_27 -> V_180 ) ;
} else if ( F_4 ( V_7 ) -> V_13 == V_45 ) {
T_4 V_22 = F_91 ( V_7 -> V_19 ) ;
T_4 V_181 = F_92 ( V_22 ) ;
T_4 V_182 = F_93 ( V_22 ) ;
if ( ( ( V_181 > V_183 ) ||
! F_1 ( V_182 & V_184 ,
...
V_29 = F_68 (unsigned int, len, sizeof(uf)) ;
if ( F_45 ( & V_195 , V_193 , V_29 ) ) {
V_93 = - V_94 ;
break;
}
if ( ! F_52 ( V_146 ) ) {
...
static int F_96 ( struct V_86 * V_4 , int V_191 , int V_192 ,
...
static int F_99 ( struct V_204 * V_204 , struct V_86 * V_4 , int V_205 ,
int V_206 )
{
struct V_4 * V_5 ;
F_8 ( L_8 , V_4 ) ;
...
return - V_208 ;
V_4 -> V_209 = & V_210 ;
V_5 = F_100 ( V_204 , V_211 , V_41 , & V_212 ) ;
if ( ! V_5 )
return - V_213 ;
F_101 ( V_4 , V_5 ) ;
F_102 ( V_5 , V_214 ) ;
...
if ( V_93 < 0 )
return V_93 ;
V_93 = F_106 ( V_218 , & V_219 ) ;
if ( V_93 < 0 ) {
F_107 ( L_9 ) ;
goto error;
}
V_93 = F_108 ( & V_220 , L_10 , & V_30 , NULL ) ;
if ( V_93 < 0 ) {
F_107 ( L_11 ) ;
F_109 ( V_218 ) ;
goto error;
