...
struct V_43 * V_44 ;
int V_11 ;
if ( ! F_17 ( V_9 ) || V_9 -> V_56 != V_33 ||
V_9 -> V_1 > V_57 )
return;
V_11 = F_2 ( V_9 ) ;
if ( V_11 == - 1 )
return;
V_44 = F_18 ( sizeof( struct V_43 ) , V_16 ) ;
if ( ! V_44 )
return;
V_44 -> V_46 . V_9 = V_9 ;
V_44 -> V_46 . V_58 = - 1 ;
...
V_44 -> V_48 = V_9 -> V_18 ;
V_44 -> V_47 = ( V_60 ) V_9 -> V_1 / V_9 -> V_18 ;
F_7 ( L_11 ,
V_44 -> V_49 , V_44 -> V_48 , V_44 -> V_47 ,
F_19 ( V_44 -> V_47 , V_52 ) ) ;
V_44 -> V_61 = 16 ;
V_44 -> V_62 = 32 ;
F_1 ( V_9 -> V_1 , NULL , & V_44 -> V_61 , & V_44 -> V_62 ) ;
V_44 -> V_63 = ( unsigned short ) ( ( ( V_60 ) V_9 -> V_1 >> V_21 ) /
( ( long ) V_44 -> V_62 * ( long ) V_44 -> V_61 ) ) ;
F_7 ( L_12 ,
V_44 -> V_63 , V_44 -> V_61 , V_44 -> V_62 ,
( long ) V_44 -> V_63 * ( long ) V_44 -> V_61 *
( long ) V_44 -> V_62 ) ;
V_44 -> V_46 . V_1 = ( long ) V_44 -> V_61 * ( long ) V_44 -> V_63 *
( long ) V_44 -> V_62 ;
...
goto V_64;
F_6 ( V_65 L_13 ,
V_44 -> V_46 . V_58 + 'a' , V_9 -> V_23 , V_9 -> V_22 ) ;
return;
V_64:
F_8 ( V_44 -> V_53 ) ;
F_8 ( V_44 ) ;
...
{
struct V_43 * V_44 = (struct V_43 * ) V_67 ;
F_7 ( L_14 , V_67 -> V_58 ) ;
F_22 ( V_67 ) ;
F_8 ( V_44 -> V_53 ) ;
}
static int F_23 ( struct V_66 * V_67 ,
unsigned long V_68 , char * V_26 )
{
struct V_43 * V_44 = (struct V_43 * ) V_67 ;
int V_69 , V_13 , V_40 ;
V_69 = V_44 -> V_48 >> V_21 ;
...
static int F_25 ( struct V_66 * V_67 , struct V_71 * V_72 )
{
struct V_43 * V_44 = (struct V_43 * ) V_67 ;
F_7 ( L_19 ,
V_44 -> V_63 , V_44 -> V_61 , V_44 -> V_62 ) ;
