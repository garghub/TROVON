...
void F_52 ( struct V_1 * V_2 , char V_52 )
{
int V_4 = V_2 -> V_77 - V_2 -> V_3 ;
if ( V_4 > 0 )
F_22 ( V_2 , L_1 , V_4 , L_2 ) ;
if ( V_52 )
F_46 ( V_2 , V_52 ) ;
}
struct V_78 * F_53 ( struct V_78 * V_79 , T_1 V_19 )
{
struct V_78 * V_80 ;
F_54 (lh, head)
if ( V_19 -- == 0 )
...
struct V_78 * F_55 ( struct V_78 * V_79 , T_1 V_19 )
{
if ( ! V_19 )
return V_79 ;
return F_53 ( V_79 , V_19 - 1 ) ;
}
struct V_78 * F_56 ( void * V_64 , struct V_78 * V_79 , T_1 * V_31 )
{
struct V_78 * V_80 ;
V_80 = ( (struct V_78 * ) V_64 ) -> V_28 ;
++ * V_31 ;
return V_80 == V_79 ? NULL : V_80 ;
}
struct V_81 * F_57 ( struct V_82 * V_79 , T_1 V_19 )
{
struct V_81 * V_83 ;
F_58 (node, head)
if ( V_19 -- == 0 )
...
struct V_81 * F_59 ( struct V_82 * V_79 , T_1 V_19 )
{
if ( ! V_19 )
return V_84 ;
return F_57 ( V_79 , V_19 - 1 ) ;
}
struct V_81 * F_60 ( void * V_64 , struct V_82 * V_79 ,
T_1 * V_31 )
{
...
struct V_81 * F_61 ( struct V_82 * V_79 ,
T_1 V_19 )
{
struct V_81 * V_83 ;
F_62 (node, head)
...
struct V_81 * F_63 ( struct V_82 * V_79 ,
T_1 V_19 )
{
if ( ! V_19 )
return V_84 ;
return F_61 ( V_79 , V_19 - 1 ) ;
}
struct V_81 * F_64 ( void * V_64 ,
struct V_82 * V_79 ,
T_1 * V_31 )
{
struct V_81 * V_83 = V_64 ;
++ * V_31 ;
if ( V_64 == V_84 )
return F_65 ( V_79 -> V_85 ) ;
else
return F_65 ( V_83 -> V_28 ) ;
}
struct V_81 *
F_66 ( struct V_82 T_6 * V_79 , int * V_86 , T_1 V_19 )
{
struct V_81 * V_83 ;
F_67 (*cpu) {
F_58 (node, per_cpu_ptr(head, *cpu)) {
if ( V_19 -- == 0 )
return V_83 ;
}
}
...
struct V_81 *
F_68 ( void * V_64 , struct V_82 T_6 * V_79 ,
int * V_86 , T_1 * V_19 )
{
struct V_81 * V_83 = V_64 ;
++ * V_19 ;
if ( V_83 -> V_28 )
return V_83 -> V_28 ;
for ( * V_86 = F_69 ( * V_86 , V_87 ) ; * V_86 < V_88 ;
* V_86 = F_69 ( * V_86 , V_87 ) ) {
struct V_82 * V_89 = F_70 ( V_79 , * V_86 ) ;
if ( ! F_71 ( V_89 ) )
return V_89 -> V_85 ;
}
return NULL ;
