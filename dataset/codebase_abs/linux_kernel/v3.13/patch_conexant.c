...
static T_2 F_144 ( T_3 V_297 , T_4 V_298 , void * V_299 ,
void * * V_300 )
{
bool * V_301 = V_299 ;
* V_301 = true ;
...
static bool F_145 ( struct V_9 * V_10 )
{
bool V_301 = false ;
if ( V_10 -> V_142 >> 16 != 0x17aa )
return false ;
if ( F_146 ( F_147 ( L_15 , F_144 , & V_301 , NULL ) ) && V_301 )
return true ;
V_301 = false ;
return F_146 ( F_147 ( L_16 , F_144 , & V_301 , NULL ) ) && V_301 ;
}
static void F_148 ( void * V_293 , int V_294 )
{
struct V_9 * V_10 = V_293 ;
struct V_1 * V_2 = V_10 -> V_2 ;
if ( V_2 -> V_290 )
...
if ( ! V_64 || ! V_303 )
return;
if ( strcmp ( L_17 , V_64 -> V_66 . V_15 ) == 0 && V_64 -> V_66 . V_216 == 0 ) {
bool V_305 = V_64 -> V_67 . integer . V_67 [ 0 ] || V_64 -> V_67 . integer . V_67 [ 1 ] ;
V_303 ( V_306 , ! V_305 ) ;
}
}
static void F_150 ( struct V_9 * V_10 ,
const struct V_307 * V_308 , int V_309 )
{
struct V_1 * V_2 = V_10 -> V_2 ;
bool V_310 = false ;
if ( V_309 == V_311 ) {
...
V_310 = true ;
if ( V_303 ( V_304 , false ) >= 0 ) {
V_2 -> V_6 . V_314 . V_315 = F_148 ;
V_310 = false ;
}
if ( V_303 ( V_306 , false ) >= 0 ) {
if ( V_2 -> V_6 . V_52 > 1 )
F_93 ( L_19 ) ;
else {
V_2 -> V_6 . V_316 = F_149 ;
...
bool V_319 = false ;
struct V_1 * V_2 = V_10 -> V_2 ;
struct V_320 * V_250 = & V_2 -> V_6 . V_321 ;
T_1 V_322 = V_2 -> V_6 . V_323 [ V_2 -> V_6 . V_70 [ 0 ] ] ;
for ( V_77 = 0 ; V_77 < V_250 -> V_324 ; V_77 ++ )
if ( V_250 -> V_325 [ V_77 ] . V_326 == V_322 ) {
V_319 = ! ! V_250 -> V_325 [ V_77 ] . V_327 ;
break;
}
if ( V_319 ) {
...
V_2 -> V_6 . V_328 = F_61 ( V_10 , V_2 -> V_6 . V_321 . V_329 [ 0 ] ) ;
}
F_157 ( V_10 ) ;
}
...
T_1 * V_334 ;
for ( V_334 = V_333 ; * V_334 ; V_334 ++ )
F_71 ( V_10 , * V_334 , V_85 ,
V_335 |
F_161 ( V_10 , * V_334 , V_85 ) ) ;
}
...
F_160 ( V_10 ) ;
V_10 -> V_154 = 1 ;
F_164 ( V_10 , NULL , V_340 , V_341 ) ;
break;
default:
V_10 -> V_154 = 1 ;
F_164 ( V_10 , NULL , V_342 , V_341 ) ;
break;
}
switch ( V_10 -> V_142 >> 16 ) {
case 0x103c :
...
F_141 ( V_10 , V_318 ) ;
V_11 = F_165 ( V_10 , & V_2 -> V_6 . V_321 , NULL ,
V_2 -> V_330 ) ;
if ( V_11 < 0 )
goto error;
V_11 = F_166 ( V_10 , & V_2 -> V_6 . V_321 ) ;
if ( V_11 < 0 )
goto error;
V_10 -> V_122 = V_344 ;
if ( ! V_10 -> V_345 -> V_346 ) {
