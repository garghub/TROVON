...
{
int V_16 ;
V_16 = F_25 ( V_2 , V_36 , V_38 , V_3 , 0xff ) ;
if ( V_16 )
return V_16 ;
F_8 ( V_2 , V_36 -> V_54 ? V_55 : V_56 ) ;
F_4 ( V_2 , ( V_36 == & V_2 -> V_49 [ 3 ] ) ? 1 : 0 ) ;
return V_38 -> V_41 ;
}
static int F_26 ( struct V_1 * V_2 , struct V_57 * V_58 )
{
const struct V_59 * V_60 = F_27 ( V_2 ) ;
struct V_43 * V_44 ;
struct V_35 * V_36 ;
int V_20 , type ;
int V_16 = 0 ;
int V_61 ;
V_16 = F_28 ( V_2 , V_58 -> V_62 [ 0 ] , V_63 ) ;
if ( V_16 )
return V_16 ;
V_20 = F_10 ( V_2 ) ;
if ( ! V_20 )
V_20 = F_10 ( V_2 ) ;
for ( type = 0 ; type < F_29 ( V_64 ) ; type ++ ) {
if ( V_64 [ type ] . V_65 == V_20 )
goto V_66;
}
F_9 ( L_14 ,
V_20 ) ;
...
V_36 -> V_76 = V_60 -> V_77 / 2 ;
#endif
V_36 -> V_78 = ( 1 << V_60 -> V_79 ) - 1 ;
V_36 -> V_80 = F_15 ( V_60 -> V_81 , V_58 -> V_62 [ 3 ] ) ;
V_36 -> V_82 = F_17 ;
V_36 = & V_2 -> V_49 [ 1 ] ;
V_36 -> type = V_83 ;
V_36 -> V_73 = V_84 ;
V_36 -> V_76 = 2 ;
V_36 -> V_78 = ( 1 << V_60 -> V_85 ) - 1 ;
V_36 -> V_86 = V_44 -> V_87 ;
V_44 -> V_87 [ 0 ] = F_14 ( V_58 -> V_62 [ 4 ] ) ;
V_44 -> V_87 [ 1 ] = F_14 ( V_58 -> V_62 [ 5 ] ) ;
V_36 -> V_82 = F_20 ;
V_36 -> V_88 = F_21 ;
V_36 = & V_2 -> V_49 [ 2 ] ;
V_36 -> type = V_89 ;
