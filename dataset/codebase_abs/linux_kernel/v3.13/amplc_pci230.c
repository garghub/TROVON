...
V_56 = & V_2 -> V_285 [ 0 ] ;
V_56 -> type = V_286 ;
V_56 -> V_287 = V_288 | V_289 | V_290 ;
V_56 -> V_68 = V_4 -> V_291 ;
V_56 -> V_292 = ( 1 << V_4 -> V_11 ) - 1 ;
V_56 -> V_293 = & V_294 ;
V_56 -> V_295 = & F_25 ;
V_56 -> V_296 = 256 ;
if ( V_273 == 0 ) {
...
if ( V_4 -> V_281 > 0 ) {
V_56 -> type = V_301 ;
V_56 -> V_287 = V_302 | V_290 ;
V_56 -> V_68 = V_4 -> V_281 ;
V_56 -> V_292 = ( 1 << V_4 -> V_15 ) - 1 ;
V_56 -> V_293 = & V_303 ;
V_56 -> V_304 = & F_33 ;
V_56 -> V_295 = & F_34 ;
V_56 -> V_296 = V_4 -> V_281 ;
if ( V_273 == 0 ) {
V_2 -> V_251 = V_56 ;
V_56 -> V_287 |= V_305 ;
V_56 -> V_298 = & F_58 ;
...
int V_274 ;
F_66 ( V_2 -> V_87 , L_32 ,
V_4 -> V_276 , V_260 -> V_262 [ 0 ] , V_260 -> V_262 [ 1 ] ) ;
V_274 = F_86 ( V_2 ) ;
if ( V_274 )
return V_274 ;
...
const struct V_310 * V_256 )
{
return F_108 ( V_2 , & V_311 ,
V_256 -> V_312 ) ;
}
