...
static bool
F_16 ( struct V_9 * V_10 , struct V_1 * V_2 )
{
if ( V_2 -> V_3 < 0 )
return false ;
if ( ! V_2 -> V_60 )
...
static void
F_18 ( struct V_11 * V_12 , unsigned int * V_3 ,
bool V_64 )
{
int V_13 , V_65 ;
V_65 = V_13 = * V_3 / V_4 ;
...
struct V_1 * V_92 = V_91 -> V_93 . V_19 ;
struct V_8 * V_2 , * V_94 ;
...
V_12 -> V_46 ++ ;
V_12 -> V_47 += V_91 -> V_93 . V_47 ;
if ( ! V_12 -> V_105 && ! V_12 -> V_106 && V_12 -> V_49 > 0 ) {
V_12 -> V_105 = 16 + 2 * F_12 ( V_12 -> V_37 ) ;
V_12 -> V_106 = 1 ;
V_12 -> V_49 -- ;
}
if ( V_91 -> V_5 & V_107 )
V_12 -> V_108 += V_91 -> V_93 . V_47 ;
V_95 = ! F_16 ( V_10 , & V_92 [ 0 ] ) ;
for ( V_44 = 0 ; ! V_95 ; V_44 ++ ) {
V_95 = ( V_44 == V_109 - 1 ) ||
! F_16 ( V_10 , & V_92 [ V_44 + 1 ] ) ;
V_2 = F_3 ( V_10 , V_12 , & V_92 [ V_44 ] ) ;
if ( V_95 )
...
F_9 ( 20 , 100 ) ) {
F_18 ( V_12 , & V_12 -> V_51 , true ) ;
V_96 = true ;
}
V_94 = F_6 ( V_12 , V_12 -> V_52 ) ;
if ( V_94 -> V_22 > 30 &&
F_9 ( V_94 -> V_25 , V_94 -> V_22 ) <
F_9 ( 20 , 100 ) ) {
F_18 ( V_12 , & V_12 -> V_52 , false ) ;
V_96 = true ;
}
if ( F_29 ( V_59 , V_12 -> V_58 + ( V_10 -> V_110 / 2 * V_111 ) / 1000 ) ) {
V_96 = true ;
F_13 ( V_10 , V_12 ) ;
if ( ! ( V_91 -> V_5 & V_101 ) &&
V_12 -> V_53 / V_4 != V_15 )
...
static void
F_31 ( struct V_9 * V_10 , struct V_11 * V_12 ,
int V_20 )
{
struct V_8 * V_21 ;
const struct V_112 * V_13 ;
unsigned int V_113 , V_114 , V_115 ;
unsigned int V_116 = V_10 -> V_117 ;
...
V_21 -> V_54 = true ;
V_13 = & V_38 [ V_20 / V_4 ] ;
V_115 = V_13 -> V_39 [ V_20 % V_4 ] * V_47 / 1000 ;
ctime = ( V_118 * V_116 ) >> 1 ;
V_116 = F_32 ( ( V_116 << 1 ) | 1 , V_10 -> V_122 ) ;
ctime += ( V_118 * V_116 ) >> 1 ;
V_116 = F_32 ( ( V_116 << 1 ) | 1 , V_10 -> V_122 ) ;
if ( V_20 / V_4 != V_15 ) {
V_36 = V_12 -> V_36 ;
...
if ( V_114 < V_10 -> V_123 )
V_21 -> V_121 ++ ;
} while ( ( V_113 < V_10 -> V_123 ) &&
( ++ V_21 -> V_120 < V_10 -> V_124 ) );
}
static void
F_33 ( struct V_9 * V_10 , struct V_11 * V_12 ,
struct V_125 * V_126 , int V_127 , int V_20 )
{
const struct V_112 * V_13 = & V_38 [ V_20 / V_4 ] ;
struct V_8 * V_21 ;
T_2 V_3 ;
T_1 V_5 ;
V_21 = F_6 ( V_12 , V_20 ) ;
...
struct V_125 * V_19 ;
int V_44 = 0 ;
V_19 = F_34 ( sizeof( * V_19 ) , V_131 ) ;
if ( ! V_19 )
return;
F_33 ( V_10 , V_12 , V_19 , V_44 ++ , V_12 -> V_51 ) ;
if ( V_10 -> V_132 -> V_133 >= 3 ) {
F_33 ( V_10 , V_12 , V_19 , V_44 ++ , V_12 -> V_52 ) ;
}
if ( V_10 -> V_132 -> V_133 >= 2 ) {
F_33 ( V_10 , V_12 , V_19 , V_44 ++ , V_12 -> V_53 ) ;
}
V_19 -> V_2 [ V_44 ] . V_3 = - 1 ;
F_35 ( V_10 -> V_132 , V_12 -> V_74 , V_19 ) ;
}
static inline int
F_36 ( int V_20 )
{
...
static int
F_37 ( struct V_9 * V_10 , struct V_11 * V_12 )
{
struct V_8 * V_21 ;
struct V_40 * V_41 ;
...
return - 1 ;
V_41 = & V_12 -> V_17 [ V_12 -> V_61 ] ;
V_135 = V_63 [ V_41 -> V_62 ] [ V_41 -> V_20 ] ;
V_21 = & V_41 -> V_19 [ V_135 ] ;
V_61 = V_12 -> V_61 ;
V_135 += V_61 * V_4 ;
F_17 ( V_12 ) ;
if ( V_135 == V_12 -> V_51 ||
...
return - 1 ;
V_134 = F_36 ( V_135 ) ;
if ( V_134 >= F_36 ( V_12 -> V_52 ) &&
( V_12 -> V_55 <
V_38 [ V_61 ] . V_56 ||
V_134 >= F_36 ( V_12 -> V_53 ) ) ) {
if ( V_21 -> V_23 < 20 )
return - 1 ;
if ( V_12 -> V_48 ++ > 2 )
return - 1 ;
...
struct V_11 * V_12 , bool V_136 )
{
T_2 V_18 = V_12 -> V_17 [ V_15 ] . V_18 ;
if ( ! V_18 || ! V_12 -> V_137 )
return;
if ( V_18 & ( V_12 -> V_137 << ( V_136 * 4 ) ) )
return;
V_18 ^= V_12 -> V_137 | ( V_12 -> V_137 << 4 ) ;
...
struct V_1 * V_2 = & V_91 -> V_93 . V_19 [ 0 ] ;
struct V_87 * V_88 = V_86 ;
struct V_11 * V_12 = & V_88 -> V_89 ;
struct V_9 * V_10 = V_83 ;
int V_135 ;
...
V_91 -> V_5 |= V_12 -> V_141 ;
F_38 ( V_10 , V_12 , V_139 -> V_142 ) ;
#ifdef F_15
if ( V_10 -> V_57 != - 1 )
return;
#endif
if ( V_10 -> V_132 -> V_133 == 1 &&
( V_91 -> V_143 . V_5 & V_144 ) )
V_135 = - 1 ;
else
V_135 = F_37 ( V_10 , V_12 ) ;
V_12 -> V_145 ++ ;
if ( V_12 -> V_145 == ~ 0 ) {
V_12 -> V_145 = 0 ;
V_12 -> V_108 = 0 ;
...
if ( V_85 -> V_146 != V_147 )
return;
if ( ! ( V_10 -> V_132 -> V_5 & V_148 ) )
return;
V_12 -> V_149 = 0 ;
V_12 -> V_137 = 0 ;
for ( V_44 = 0 ; V_44 < 4 ; V_44 ++ ) {
if ( ! F_42 ( V_74 , V_85 -> V_146 , V_10 -> V_16 [ V_44 ] ) )
continue;
V_12 -> V_149 |= F_5 ( V_44 ) ;
if ( V_85 -> V_150 [ V_44 ] . V_5 & V_151 )
V_12 -> V_137 |= F_5 ( V_44 ) ;
}
...
V_12 -> V_36 = F_45 ( V_85 -> V_146 , 0 , 60 , 1 , 1 , 0 ) ;
V_12 -> V_36 += V_160 ;
V_12 -> V_119 = V_12 -> V_36 + 2 * V_160 ;
V_12 -> V_37 = F_9 ( 1 , 1 ) ;
if ( V_10 -> V_166 ) {
V_12 -> V_49 = 16 ;
V_12 -> V_105 = 0 ;
