...
V_3 -> V_189 = 0 ;
F_71 ( V_3 , 0 ) ;
V_25 = F_88 ( V_3 -> V_17 , & V_3 -> V_31 ) ;
if ( V_25 )
goto V_190;
return 0 ;
V_190:
V_3 -> V_31 . V_32 . V_191 = NULL ;
F_89 ( & V_3 -> V_31 . V_32 ) ;
return V_25 ;
}
...
static int F_92 ( struct V_144 * V_31 ,
struct V_194 * V_195 )
{
struct V_3 * V_3 = F_66 ( V_31 ) ;
struct V_196 * V_158 = V_3 -> V_150 -> V_158 ;
unsigned long V_105 ;
int V_143 = 0 ;
if ( V_195 -> V_180 < V_181 ) {
V_143 = - V_107 ;
goto V_190;
}
F_80 ( V_3 -> V_17 ) ;
F_15 ( V_3 -> V_17 , L_62 , V_195 -> V_197 ) ;
V_3 -> V_170 = 0 ;
V_3 -> V_198 = V_195 ;
F_42 ( & V_3 -> V_26 , V_105 ) ;
V_3 -> V_189 = 1 ;
...
F_49 ( & V_3 -> V_26 , V_105 ) ;
F_94 ( V_3 ) ;
if ( V_3 -> V_150 -> V_199 == V_200 )
F_95 ( V_3 , 1 ) ;
if ( V_3 -> V_150 -> V_199 == V_201 )
F_81 ( V_3 -> V_17 ) ;
return 0 ;
V_190:
return V_143 ;
}
static void F_96 ( struct V_3 * V_3 , struct V_194 * V_195 )
{
int V_202 ;
struct V_84 * V_52 ;
...
static int F_98 ( struct V_144 * V_31 ,
struct V_194 * V_195 )
{
struct V_3 * V_3 = F_66 ( V_31 ) ;
unsigned long V_105 ;
...
V_3 -> V_150 -> V_151 = V_203 ;
F_96 ( V_3 , V_195 ) ;
F_93 ( V_3 -> V_150 -> V_158 , NULL ) ;
F_15 ( V_3 -> V_17 , L_63 ,
V_195 ? V_195 -> V_197 : L_64 ) ;
V_3 -> V_189 = 0 ;
V_3 -> V_198 = NULL ;
F_71 ( V_3 , 0 ) ;
F_49 ( & V_3 -> V_26 , V_105 ) ;
...
case V_152 :
V_3 -> V_189 = 1 ;
if ( V_3 -> V_198 && V_3 -> V_198 -> V_205 ) {
F_14 ( & V_3 -> V_26 ) ;
V_3 -> V_198 -> V_205 ( & V_3 -> V_31 ) ;
F_16 ( & V_3 -> V_26 ) ;
}
break;
default:
...
switch ( V_3 -> V_150 -> V_151 ) {
case V_155 :
if ( ( V_148 & V_206 ) == V_206 )
V_3 -> V_150 -> V_151 = V_152 ;
break;
case V_152 :
V_3 -> V_154 = 1 ;
if ( V_3 -> V_198 && V_3 -> V_198 -> V_207 ) {
F_14 ( & V_3 -> V_26 ) ;
V_3 -> V_198 -> V_207 ( & V_3 -> V_31 ) ;
F_16 ( & V_3 -> V_26 ) ;
}
break;
default:
...
( void ) F_77 ( & V_3 -> V_31 , 0 ) ;
V_3 -> V_31 . V_182 = V_183 ;
if ( V_3 -> V_198 && V_3 -> V_198 -> V_208 ) {
F_14 ( & V_3 -> V_26 ) ;
V_3 -> V_198 -> V_208 ( & V_3 -> V_31 ) ;
F_16 ( & V_3 -> V_26 ) ;
}
switch ( V_3 -> V_150 -> V_151 ) {
default:
