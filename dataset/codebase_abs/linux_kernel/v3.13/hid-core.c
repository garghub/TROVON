...
F_67 ( V_188 , V_272 ) )
return true ;
return ! ! F_67 ( V_188 , V_273 ) ;
}
int F_99 ( struct V_2 * V_188 )
{
static T_9 V_4 = F_100 ( 0 ) ;
int V_102 ;
if ( F_44 ( V_188 -> V_114 & V_274 ) )
return - V_185 ;
if ( F_98 ( V_188 ) )
return - V_183 ;
V_102 = V_188 -> V_275 -> V_276 ( V_188 ) ;
if ( V_102 )
return V_102 ;
if ( ! V_188 -> V_117 )
return - V_183 ;
...
return F_108 ( V_102 ) ;
F_109 ( & V_188 -> V_116 ) ;
V_188 -> V_116 . V_279 = F_25 ;
V_188 -> V_116 . V_190 = & V_280 ;
F_23 ( V_188 ) ;
F_110 ( & V_188 -> V_281 ) ;
F_24 ( & V_188 -> V_163 ) ;
F_111 ( & V_188 -> V_282 ) ;
...
int F_117 ( struct V_161 * V_162 , struct V_283 * V_284 ,
const char * V_285 )
{
int V_102 ;
V_162 -> V_150 . V_165 = V_162 -> V_165 ;
V_162 -> V_150 . V_190 = & V_280 ;
V_162 -> V_150 . V_284 = V_284 ;
V_162 -> V_150 . V_285 = V_285 ;
F_24 ( & V_162 -> V_233 ) ;
F_111 ( & V_162 -> V_232 ) ;
V_102 = F_118 ( & V_162 -> V_150 ) ;
if ( V_102 )
return V_102 ;
V_102 = F_119 ( & V_162 -> V_150 , & V_286 ) ;
if ( V_102 )
F_120 ( & V_162 -> V_150 ) ;
return V_102 ;
}
...
for ( V_48 = 0 ; V_48 < F_124 ( V_289 ) ; V_48 ++ )
if ( V_288 -> V_290 -> V_291 [ V_48 ] )
return 1 ;
}
return 0 ;
}
