...
F_11 ( & V_2 -> V_15 -> V_16 , L_5 , V_28 , V_23 ) ;
if ( V_23 == 0 ) {
V_6 = - V_29 ;
goto error;
}
return V_6 ;
error:
F_11 ( & V_2 -> V_15 -> V_16 , L_6 , V_28 , V_6 ) ;
return V_6 ;
}
...
F_11 ( & V_2 -> V_15 -> V_16 , L_9 , V_28 , V_38 ) ;
switch ( V_38 ) {
case V_40 :
V_39 = 0 ;
break;
...
for ( V_23 = 0 , V_77 = 0xff ; V_23 < F_23 ( V_95 ) ; V_23 ++ ) {
if ( V_75 -> V_67 == V_95 [ V_23 ] . V_67 &&
V_75 -> V_81 == V_95 [ V_23 ] . V_81 &&
V_75 -> V_96 == V_95 [ V_23 ] . V_97 ) {
V_77 = V_95 [ V_23 ] . V_4 ;
...
V_25 . args [ 8 ] = ( V_99 . V_100 . V_101 >> 8 ) & 0xff ;
V_25 . args [ 9 ] = ( V_99 . V_100 . V_101 >> 0 ) & 0xff ;
V_25 . args [ 10 ] = V_78 ;
V_25 . args [ 11 ] = V_80 ;
V_25 . args [ 12 ] = V_79 ;
V_25 . args [ 13 ] = 0x00 ;
...
if ( V_22 == V_95 [ V_23 ] . V_4 ) {
V_75 -> V_81 = V_95 [ V_23 ] . V_81 ;
V_75 -> V_96 = V_95 [ V_23 ] . V_97 ;
V_75 -> V_67 = V_95 [ V_23 ] . V_67 ;
}
}
switch ( ( V_7 [ 1 ] >> 0 ) & 0x01 ) {
case 0 :
...
if ( V_6 )
goto error;
V_75 -> V_83 = ( V_7 [ 0 ] << 16 ) | ( V_7 [ 1 ] << 8 ) | ( V_7 [ 2 ] << 0 ) ;
return V_6 ;
error:
F_11 ( & V_2 -> V_15 -> V_16 , L_6 , V_28 , V_6 ) ;
return V_6 ;
...
if ( V_2 -> V_26 ) {
for ( V_23 = 0 ; V_23 < F_23 ( V_109 ) ; V_23 ++ ) {
V_6 = F_7 ( V_2 , V_109 [ V_23 ] . V_3 ,
V_109 [ V_23 ] . V_4 , V_109 [ V_23 ] . V_21 ) ;
if ( V_6 )
goto error;
}
V_25 . args [ 0 ] = V_112 ;
...
V_6 = F_26 ( & V_105 , V_106 , V_2 -> V_15 -> V_16 . V_113 ) ;
if ( V_6 ) {
F_27 ( & V_2 -> V_15 -> V_16 , L_25 \
L_26 \
L_27 \
L_28 ,
V_17 , V_106 , V_6 ) ;
...
if ( V_6 )
goto V_114;
F_28 ( & V_2 -> V_15 -> V_16 , L_29 \
L_30 , V_17 ,
V_99 . V_100 . V_115 ) ;
F_28 ( & V_2 -> V_15 -> V_16 , L_31 \
L_32 , V_17 , V_106 ) ;
V_103 = V_105 -> V_116 - 1 ;
for ( V_102 = V_103 ; V_102 > 0 ;
V_102 -= ( V_2 -> V_12 . V_117 - 1 ) ) {
V_5 = V_102 ;
if ( V_5 > ( V_2 -> V_12 . V_117 - 1 ) )
V_5 = ( V_2 -> V_12 . V_117 - 1 ) ;
V_6 = F_1 ( V_2 , 0xfa ,
( T_1 * ) & V_105 -> V_118 [ V_103 - V_102 ] , V_5 ) ;
if ( V_6 ) {
F_27 ( & V_2 -> V_15 -> V_16 , L_33 \
L_34 ,
V_17 , V_6 ) ;
if ( V_6 )
goto V_114;
...
if ( V_6 )
goto error;
F_28 ( & V_2 -> V_15 -> V_16 , L_36 ,
V_17 , V_7 [ 0 ] , V_7 [ 1 ] , V_7 [ 2 ] , V_7 [ 3 ] ) ;
F_28 ( & V_2 -> V_15 -> V_16 , L_37 ,
V_17 , V_99 . V_100 . V_115 ) ;
V_6 = F_4 ( V_2 , 0x81 , V_7 , 2 ) ;
if ( V_6 )
goto error;
V_25 . args [ 0 ] = V_120 ;
V_25 . args [ 1 ] = ( ( V_2 -> V_12 . V_121 / 1000 ) >> 8 ) & 0xff ;
V_25 . args [ 2 ] = ( ( V_2 -> V_12 . V_121 / 1000 ) >> 0 ) & 0xff ;
V_25 . args [ 3 ] = V_7 [ 0 ] ;
V_25 . args [ 4 ] = V_7 [ 1 ] ;
V_25 . args [ 5 ] = V_2 -> V_12 . V_111 ;
V_25 . args [ 6 ] = V_2 -> V_12 . V_122 ;
V_25 . args [ 7 ] = 0x00 ;
V_25 . V_5 = 8 ;
V_6 = F_9 ( V_2 , & V_25 ) ;
if ( V_6 )
...
V_25 . args [ 3 ] = 0x00 ;
V_25 . args [ 4 ] = 0x00 ;
V_25 . args [ 5 ] = ( V_2 -> V_12 . V_124 ) ? V_2 -> V_12 . V_124 : 0x14 ;
V_25 . args [ 6 ] = 0x00 ;
V_25 . args [ 7 ] = 0x03 ;
V_25 . args [ 8 ] = 0x02 ;
V_25 . args [ 9 ] = 0x02 ;
...
goto error;
for ( V_23 = 0 ; V_23 < F_23 ( V_109 ) ; V_23 ++ ) {
V_6 = F_7 ( V_2 , V_109 [ V_23 ] . V_3 , V_109 [ V_23 ] . V_4 ,
V_109 [ V_23 ] . V_21 ) ;
if ( V_6 )
goto error;
}
...
struct V_30 * F_35 ( const struct V_134 * V_135 ,
struct V_136 * V_15 )
{
int V_6 ;
struct V_1 * V_2 = NULL ;
T_1 V_22 ;
V_2 = F_36 ( sizeof( struct V_1 ) , V_137 ) ;
if ( V_2 == NULL ) {
V_6 = - V_138 ;
goto error;
}
if ( ! V_135 -> V_13 ) {
F_11 ( & V_15 -> V_16 , L_38 , V_28 ) ;
V_6 = - V_18 ;
goto error;
}
if ( ! V_135 -> V_124 ) {
F_11 ( & V_15 -> V_16 , L_39 , V_28 ) ;
V_6 = - V_18 ;
goto error;
}
V_2 -> V_15 = V_15 ;
memcpy ( & V_2 -> V_12 , V_135 , sizeof( struct V_134 ) ) ;
...
if ( V_6 || V_22 != 0x01 )
goto error;
memcpy ( & V_2 -> V_31 . V_139 , & V_99 , sizeof( struct V_140 ) ) ;
V_2 -> V_31 . V_33 = V_2 ;
return & V_2 -> V_31 ;
error:
F_11 ( & V_15 -> V_16 , L_6 , V_28 , V_6 ) ;
F_34 ( V_2 ) ;
return NULL ;
}
