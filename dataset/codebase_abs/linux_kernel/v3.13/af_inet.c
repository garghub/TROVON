...
( V_302 int ) ( ( V_256 -> V_284 ^ V_300 -> V_284 ) & F_17 ( V_299 ) ) |
( ( V_298 ) ( F_40 ( V_300 -> V_266 ) + F_119 ( V_219 ) -> V_306 ) ^ V_266 ) ;
F_119 ( V_219 ) -> V_295 |= V_295 ;
}
F_119 ( V_253 ) -> V_295 |= V_295 ;
F_120 ( V_253 , sizeof( * V_256 ) ) ;
F_121 ( V_253 , F_112 ( V_253 ) ) ;
...
static int F_122 ( struct V_252 * V_253 )
{
T_5 V_307 = F_17 ( V_253 -> V_287 - F_123 ( V_253 ) ) ;
struct V_255 * V_256 = F_96 ( V_253 ) ;
const struct V_254 * V_63 ;
int V_48 = V_256 -> V_44 ;
int V_27 = - V_308 ;
F_124 ( & V_256 -> V_309 , V_256 -> V_288 , V_307 ) ;
V_256 -> V_288 = V_307 ;
F_23 () ;
V_63 = F_92 ( V_258 [ V_48 ] ) ;
if ( F_7 ( ! V_63 || ! V_63 -> V_259 . V_310 ) )
goto V_297;
V_27 = V_63 -> V_259 . V_310 ( V_253 ) ;
V_297:
F_26 () ;
return V_27 ;
}
int F_125 ( struct V_1 * * V_2 , unsigned short V_311 ,
unsigned short type , unsigned char V_44 ,
struct V_43 * V_43 )
{
struct V_24 * V_1 ;
int V_312 = F_126 ( V_311 , type , V_44 , & V_1 ) ;
if ( V_312 == 0 ) {
* V_2 = V_1 -> V_2 ;
( * V_2 ) -> V_313 = V_314 ;
( * V_2 ) -> V_20 -> V_315 ( * V_2 ) ;
...
unsigned long F_128 ( void T_6 * V_316 [] , int V_317 )
{
unsigned long V_318 = 0 ;
int V_319 , V_320 ;
F_129 (i) {
for ( V_320 = 0 ; V_320 < V_321 ; V_320 ++ )
V_318 += * ( ( ( unsigned long * ) F_130 ( V_316 [ V_320 ] , V_319 ) ) + V_317 ) ;
}
return V_318 ;
}
T_7 F_131 ( void T_6 * V_316 [] , int V_317 , T_2 V_322 )
{
T_7 V_318 = 0 ;
int V_323 ;
F_129 (cpu) {
...
T_7 V_327 ;
unsigned int V_328 ;
V_324 = F_130 ( V_316 [ 0 ] , V_323 ) ;
V_326 = (struct V_325 * ) ( V_324 + V_322 ) ;
do {
V_328 = F_132 ( V_326 ) ;
V_327 = * ( ( ( T_7 * ) V_324 ) + V_317 ) ;
} while ( F_133 ( V_326 , V_328 ) );
V_318 += V_327 ;
}
return V_318 ;
}
int F_134 ( void T_6 * V_329 [ 2 ] , T_2 V_330 , T_2 V_331 )
{
F_135 ( V_329 == NULL ) ;
V_329 [ 0 ] = F_136 ( V_330 , V_331 ) ;
if ( ! V_329 [ 0 ] )
return - V_332 ;
#if V_321 == 2
V_329 [ 1 ] = F_136 ( V_330 , V_331 ) ;
if ( ! V_329 [ 1 ] ) {
F_137 ( V_329 [ 0 ] ) ;
V_329 [ 0 ] = NULL ;
return - V_332 ;
...
{
int V_319 ;
if ( F_134 ( ( void T_6 * * ) V_43 -> V_316 . V_333 ,
sizeof( struct V_334 ) ,
F_139 ( struct V_334 ) ) < 0 )
goto V_335;
if ( F_134 ( ( void T_6 * * ) V_43 -> V_316 . V_336 ,
sizeof( struct V_337 ) ,
F_139 ( struct V_337 ) ) < 0 )
goto V_338;
F_129 (i) {
struct V_337 * V_339 ;
V_339 = F_130 ( V_43 -> V_316 . V_336 [ 0 ] , V_319 ) ;
F_140 ( & V_339 -> V_326 ) ;
#if V_321 == 2
V_339 = F_130 ( V_43 -> V_316 . V_336 [ 1 ] , V_319 ) ;
F_140 ( & V_339 -> V_326 ) ;
#endif
}
if ( F_134 ( ( void T_6 * * ) V_43 -> V_316 . V_340 ,
sizeof( struct V_341 ) ,
F_139 ( struct V_341 ) ) < 0 )
goto V_342;
if ( F_134 ( ( void T_6 * * ) V_43 -> V_316 . V_343 ,
sizeof( struct V_344 ) ,
F_139 ( struct V_344 ) ) < 0 )
goto V_345;
if ( F_134 ( ( void T_6 * * ) V_43 -> V_316 . V_346 ,
sizeof( struct V_344 ) ,
F_139 ( struct V_344 ) ) < 0 )
goto V_347;
if ( F_134 ( ( void T_6 * * ) V_43 -> V_316 . V_348 ,
sizeof( struct V_349 ) ,
F_139 ( struct V_349 ) ) < 0 )
goto V_350;
V_43 -> V_316 . V_351 = F_141 ( sizeof( struct V_352 ) ,
V_69 ) ;
if ( ! V_43 -> V_316 . V_351 )
goto V_353;
F_142 ( V_43 ) ;
return 0 ;
V_353:
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_348 ) ;
V_350:
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_346 ) ;
V_347:
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_343 ) ;
V_345:
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_340 ) ;
V_342:
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_336 ) ;
V_338:
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_333 ) ;
V_335:
return - V_332 ;
}
static T_9 void F_144 ( struct V_43 * V_43 )
{
F_9 ( V_43 -> V_316 . V_351 ) ;
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_348 ) ;
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_346 ) ;
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_343 ) ;
F_143 ( ( void T_6 * * ) V_43 -> V_316 . V_340 ) ;
...
struct V_220 * V_359 ;
int V_312 = - V_28 ;
F_154 ( sizeof( struct V_360 ) > F_155 ( struct V_252 , V_361 ) ) ;
V_362 = F_141 ( 65536 / 8 , V_69 ) ;
if ( ! V_362 )
goto V_31;
V_312 = F_156 ( & V_363 , 1 ) ;
if ( V_312 )
...
F_159 () ;
#endif
if ( F_160 ( & V_372 , V_373 ) < 0 )
F_149 ( L_11 , V_249 ) ;
if ( F_160 ( & V_374 , V_282 ) < 0 )
F_149 ( L_12 , V_249 ) ;
if ( F_160 ( & V_375 , V_156 ) < 0 )
F_149 ( L_13 , V_249 ) ;
#ifdef F_161
if ( F_160 ( & V_376 , V_377 ) < 0 )
F_149 ( L_14 , V_249 ) ;
#endif
for ( V_359 = & V_226 [ 0 ] ; V_359 < & V_226 [ V_224 ] ; ++ V_359 )
F_162 ( V_359 ) ;
for ( V_358 = V_378 ; V_358 < & V_378 [ V_379 ] ; ++ V_358 )
F_72 ( V_358 ) ;
F_163 () ;
F_164 () ;
F_165 () ;
