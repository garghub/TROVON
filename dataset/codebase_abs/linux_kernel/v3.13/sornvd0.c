...
struct V_6 * V_7 = ( void * ) V_11 ;
const T_1 V_26 = F_4 ( V_7 , V_8 ) ;
const T_1 V_14 = F_3 ( V_2 ) ;
T_1 V_27 , V_28 [ 3 ] ;
T_2 V_29 , V_30 , V_31 , V_32 ;
struct V_33 V_34 ;
struct V_35 V_36 ;
V_27 = F_9 ( V_25 , V_2 -> V_37 , V_2 -> V_38 ,
& V_29 , & V_30 , & V_31 , & V_32 , & V_34 ) ;
if ( ! V_27 )
return - V_39 ;
V_27 = F_10 ( V_25 , V_27 , 0 , V_22 , V_23 ,
& V_29 , & V_30 , & V_31 , & V_32 , & V_36 ) ;
if ( ! V_27 )
return - V_40 ;
V_28 [ 0 ] = F_11 ( V_7 , 0x61c118 + V_14 ) & ~ ( 0x000000ff << V_26 ) ;
V_28 [ 1 ] = F_11 ( V_7 , 0x61c120 + V_14 ) & ~ ( 0x000000ff << V_26 ) ;
V_28 [ 2 ] = F_11 ( V_7 , 0x61c130 + V_14 ) & ~ ( 0x0000ff00 ) ;
F_12 ( V_7 , 0x61c118 + V_14 , V_28 [ 0 ] | ( V_36 . V_41 << V_26 ) ) ;
F_12 ( V_7 , 0x61c120 + V_14 , V_28 [ 1 ] | ( V_36 . V_42 << V_26 ) ) ;
F_12 ( V_7 , 0x61c130 + V_14 , V_28 [ 2 ] | ( V_36 . V_43 << 8 ) ) ;
