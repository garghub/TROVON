...
{
struct V_273 V_274 ;
if ( V_250 < sizeof( V_274 ) )
return - V_126 ;
if ( F_41 ( & V_274 , V_36 , sizeof( V_274 ) ) )
return - V_44 ;
...
int V_244 ;
if ( V_34 == V_245 && V_2 -> V_8 != V_9 )
return V_73 . V_277 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
if( V_34 != V_247 )
return - V_12 ;
...
return - V_44 ;
F_21 ( V_2 ) ;
V_244 = F_82 ( V_2 , V_248 , V_35 , V_36 ,
& V_250 ) ;
F_57 ( V_2 ) ;
if ( V_244 >= 0 )
...
int F_83 ( struct V_1 * V_2 , int V_34 , int V_35 ,
char T_1 * V_36 , int T_1 * V_37 )
{
int V_244 ;
if ( V_34 == V_245 && V_2 -> V_8 != V_9 ) {
if ( V_73 . V_278 != NULL )
return V_73 . V_278 ( V_2 , V_34 , V_35 ,
V_36 , V_37 ) ;
return V_73 . V_277 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
}
if ( V_34 != V_247 )
return - V_12 ;
if ( V_35 == V_205 )
return F_84 ( V_2 , V_34 , V_35 , V_36 , V_37 ,
F_81 ) ;
