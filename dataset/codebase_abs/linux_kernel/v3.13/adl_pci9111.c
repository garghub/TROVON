...
V_17 -> V_88 *= ( 1 + V_17 -> V_90 ) ;
V_17 -> V_76 = V_82 -> V_76 ;
V_17 -> V_92 = 0 ;
V_17 -> V_93 =
V_17 -> V_76 * ( 1 + V_17 -> V_90 ) ;
return 0 ;
}
...
static T_1 F_26 ( int V_84 , void * V_102 )
{
...
{
unsigned int V_129 = F_22 ( V_128 -> V_130 ) ;
unsigned int V_56 = F_20 ( V_128 -> V_130 ) ;
unsigned int V_98 = V_51 -> V_98 ;
unsigned int V_99 = ( V_98 + 1 ) >> 1 ;
unsigned int V_100 = ( V_98 == 0xffff ) ? 0 : 4 ;
unsigned int V_105 ;
...
F_12 ( V_15 ) ;
for ( V_58 = 0 ; V_58 < V_128 -> V_132 ; V_58 ++ ) {
F_2 ( 0 , V_15 -> V_20 + V_133 ) ;
V_131 = V_134 ;
while ( V_131 -- ) {
V_105 = F_8 ( V_15 -> V_20 + V_87 ) ;
if ( V_105 & V_135 )
...
return - V_137 ;
V_136:
V_94 [ V_58 ] = F_33 ( V_15 -> V_20 + V_123 ) ;
...
{
if ( F_39 ( V_51 , V_94 ) )
F_35 ( V_51 -> V_142 , V_15 -> V_20 + V_141 ) ;
V_94 [ 1 ] = V_51 -> V_142 ;
return V_128 -> V_132 ;
}
...
unsigned long V_143 )
{
struct V_144 * V_145 = F_42 ( V_15 ) ;
struct V_16 * V_17 ;
struct V_50 * V_51 ;
int V_146 ;
V_17 = F_43 ( V_15 , sizeof( * V_17 ) ) ;
if ( ! V_17 )
return - V_147 ;
V_146 = F_44 ( V_15 ) ;
if ( V_146 )
return V_146 ;
V_17 -> V_52 = F_45 ( V_145 , 1 ) ;
V_15 -> V_20 = F_45 ( V_145 , 2 ) ;
F_40 ( V_15 ) ;
if ( V_145 -> V_84 > 0 ) {
V_146 = F_46 ( V_15 -> V_84 , F_26 ,
V_148 , V_15 -> V_149 , V_15 ) ;
if ( V_146 )
return V_146 ;
V_15 -> V_84 = V_145 -> V_84 ;
}
V_146 = F_47 ( V_15 , 4 ) ;
if ( V_146 )
return V_146 ;
...
V_51 -> V_158 = & V_170 ;
V_51 -> V_171 = F_38 ;
F_48 ( V_15 -> V_173 , L_10 , V_15 -> V_149 ) ;
return 0 ;
}
...
static int F_52 ( struct V_144 * V_15 ,
const struct V_174 * V_175 )
{
return F_53 ( V_15 , & V_176 ,
V_175 -> V_177 ) ;
}
