...
F_38 ( V_76 ) ;
V_15 = F_35 ( V_2 , V_2 -> V_151 -> V_34 ) ;
if ( V_15 )
goto V_77;
V_15 = F_31 ( V_2 , & V_2 -> V_58 , & V_2 -> V_59 ) ;
if ( V_15 )
goto V_77;
V_15 = F_23 ( V_2 , V_96 , & V_148 ) ;
if ( V_15 )
goto V_77;
if ( V_148 == V_97 )
F_36 ( L_27
...
for ( V_99 = 0 ; V_99 < F_70 ( V_152 ) ; V_99 ++ ) {
...
V_15 = F_71 ( & V_2 -> V_9 -> V_93 , V_2 -> V_58 ,
& V_152 [ 0 ] , & V_149 , & V_150 ) ;
if ( V_15 ) {
F_43 ( V_89 -> V_93 , L_30 ,
V_15 ) ;
...
static int F_75 ( struct V_162 * V_9 )
{
struct V_1 * V_2 ;
struct V_88 * V_89 = NULL ;
struct V_163 * V_151 = F_76 ( & V_9 -> V_93 ) ;
int V_15 = 0 ;
F_38 ( V_76 ) ;
if ( ! V_151 ) {
V_15 = - V_103 ;
...
if ( V_151 -> V_161 ) {
V_15 = V_151 -> V_161 ( V_9 ) ;
if ( V_15 )
goto V_77;
}
V_2 = F_65 ( sizeof( struct V_1 ) , V_164 ) ;
if ( ! V_2 ) {
V_15 = - V_140 ;
goto V_165;
}
...
static int F_88 ( struct V_162 * V_9 )
{
