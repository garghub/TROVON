...
static void T_4 F_70 ( unsigned long V_95 ,
unsigned long V_96 )
{
T_3 * V_3 ;
T_1 * V_6 ;
...
static void T_4 F_73 ( unsigned long V_95 ,
unsigned long V_96 )
{
unsigned long V_101 ;
unsigned long V_24 ;
...
V_24 = V_95 - V_43 ;
if ( ! ( V_95 & ~ ( V_104 ) ) ) {
if ( F_71 ( V_24 + V_105 ) == V_101 )
V_102 = 1 ;
}
if ( ! ( V_95 & ~ ( V_106 ) ) ) {
if ( F_71 ( V_24 + V_107 ) == V_101 )
V_102 = 2 ;
}
V_3 = F_29 ( V_95 ) ;
if ( V_102 == 2 ) {
* ( T_3 * ) F_26 ( V_3 ) = F_74 ( V_101 ) ;
V_95 += V_107 ;
continue;
}
if ( F_68 ( * ( T_3 * ) F_26 ( V_3 ) ) ) {
...
static void T_4 F_75 ( unsigned long V_33 , unsigned long V_111 )
{
T_3 * V_3 = F_29 ( V_33 ) ;
unsigned long V_112 ;
V_112 = F_76 ( V_111 >> 4 ) ;
* ( T_3 * ) F_26 ( V_3 ) = F_74 ( V_112 ) ;
}
static unsigned long T_4 F_77 ( unsigned long V_113 , int V_114 )
{
unsigned long V_115 = ( V_36 [ V_114 ] . V_116 & V_106 ) ;
unsigned long V_117 = ( V_113 & V_106 ) ;
unsigned long V_118 = F_78 ( V_113 + V_36 [ V_114 ] . V_37 ) ;
...
F_77 ( ( unsigned long ) F_80 ( V_36 [ V_9 ] . V_116 ) , V_9 ) ;
}
}
void T_4 F_81 ( void )
{
