...
V_8 -> V_84 . V_85 [ V_147 ] . V_155 = 0 ;
break;
} else if ( V_8 -> V_84 . V_85 [ V_147 ] . V_86 < 0 ) {
break;
} else if ( V_147 >= V_2 -> V_156 ) {
V_8 -> V_84 . V_85 [ V_147 ] . V_86 = - 1 ;
V_8 -> V_84 . V_85 [ V_147 ] . V_155 = 0 ;
break;
}
V_91 += V_8 -> V_84 . V_85 [ V_147 ] . V_155 ;
}
V_148 = V_147 - 1 ;
if ( V_91 < 0 )
V_91 = 0 ;
F_41 () ;
V_90 = V_6 -> V_2 . V_157 -> V_158 [ V_8 -> V_159 ] ;
V_144 = V_22 -> V_33 ;
F_57 (local, hdr->addr1, sta, tmp) {
if ( ! F_58 ( V_22 -> V_160 , V_20 -> V_28 -> V_27 . V_48 ) )
continue;
V_93 = F_59 ( & V_20 -> V_28 -> V_27 ) ;
if ( V_8 -> V_12 & V_161 )
F_60 ( V_20 , V_162 ) ;
...
F_13 ( V_22 ) ,
V_20 , true , V_130 ) ;
if ( ( V_6 -> V_2 . V_12 & V_163 ) &&
( V_148 != - 1 ) )
V_20 -> V_164 = V_8 -> V_84 . V_85 [ V_148 ] ;
if ( ( V_8 -> V_12 & V_165 ) &&
( F_12 ( V_144 ) ) ) {
T_2 V_36 , V_81 ;
T_1 * V_59 ;
...
V_25 = F_63 ( V_151 -> V_25 ) ;
if ( ! ( V_25 & V_168 ) ) {
T_2 V_81 = F_63 ( V_151 -> V_169 ) ;
V_36 = ( V_25 &
V_170 ) >>
V_171 ;
F_29 ( V_20 , V_36 , V_81 ) ;
...
F_65 ( V_6 , V_90 , V_20 , V_4 ) ;
if ( F_61 ( & V_20 -> V_28 -> V_27 ) )
F_66 ( V_6 , V_20 , V_4 ) ;
if ( ! ( V_8 -> V_12 & V_175 ) && V_130 )
F_25 ( V_20 , V_4 ) ;
if ( ( V_20 -> V_28 -> V_27 . type == V_76 ) &&
( V_6 -> V_2 . V_12 & V_57 ) )
F_67 ( V_20 -> V_28 , ( void * ) V_4 -> V_23 , V_130 ) ;
if ( V_6 -> V_2 . V_12 & V_57 ) {
if ( V_8 -> V_12 & V_105 ) {
if ( V_20 -> V_176 )
V_20 -> V_176 = 0 ;
} else if ( ++ V_20 -> V_176 >= V_177 ) {
F_68 ( V_20 -> V_28 -> V_135 ,
V_20 -> V_20 . V_48 ,
V_20 -> V_176 ,
V_137 ) ;
V_20 -> V_176 = 0 ;
...
if ( F_44 ( V_144 ) && F_73 ( V_144 ) &&
( V_6 -> V_2 . V_12 & V_57 ) &&
! ( V_8 -> V_12 & V_175 ) &&
V_6 -> V_186 && ! ( V_6 -> V_187 ) ) {
if ( V_8 -> V_12 & V_105 ) {
V_6 -> V_186 -> V_61 . V_188 . V_12 |=
V_189 ;
} else
F_18 ( & V_6 -> V_190 , V_26 +
F_74 ( 10 ) ) ;
...
F_40 ( V_6 , V_4 , false ) ;
F_75 ( V_4 ) ;
V_149 = ! ! ( V_8 -> V_12 & V_175 ) ||
! ( F_71 ( V_144 ) ) ;
if ( ! V_6 -> V_191 && ( ! V_149 || ! V_6 -> V_192 ) ) {
F_76 ( V_4 ) ;
return;
}
V_92 = F_30 ( V_8 ) ;
if ( F_77 ( F_78 ( V_4 ) < V_92 ) ) {
F_79 ( L_2 ) ;
F_76 ( V_4 ) ;
return;
}
...
V_4 -> V_193 = V_194 ;
V_4 -> V_10 = V_195 ;
V_4 -> V_196 = F_81 ( V_197 ) ;
memset ( V_4 -> V_198 , 0 , sizeof( V_4 -> V_198 ) ) ;
F_41 () ;
F_42 (sdata, &local->interfaces, list) {
if ( V_28 -> V_27 . type == V_199 ) {
if ( ! F_27 ( V_28 ) )
continue;
if ( ( V_28 -> V_61 . V_200 & V_201 ) &&
! V_149 )
continue;
if ( V_146 ) {
V_143 = F_82 ( V_4 , V_137 ) ;
if ( V_143 ) {
V_143 -> V_135 = V_146 ;
F_83 ( V_143 ) ;
}
...
void F_84 ( struct V_202 * V_203 , T_5 V_204 )
{
struct V_19 * V_20 = F_85 ( V_203 , struct V_19 , V_20 ) ;
F_68 ( V_20 -> V_28 -> V_135 , V_20 -> V_20 . V_48 ,
V_204 , V_137 ) ;
}
