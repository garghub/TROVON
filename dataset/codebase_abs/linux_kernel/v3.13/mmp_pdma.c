...
F_32 ( & V_35 -> V_45 ) ;
F_32 ( & V_35 -> V_47 ) ;
F_47 ( & V_35 -> V_35 . V_145 ,
& V_28 -> V_36 . V_146 ) ;
return 0 ;
}
static struct V_61 * F_69 ( struct V_147 * V_148 ,
struct V_149 * V_150 )
{
struct V_27 * V_151 = V_150 -> V_152 ;
struct V_61 * V_35 , * V_153 ;
V_154:
V_153 = NULL ;
...
V_35 = F_70 ( V_153 ) ;
if ( V_35 ) {
struct V_32 * V_156 = F_25 ( V_35 ) ;
V_156 -> V_10 = V_148 -> args [ 0 ] ;
return V_35 ;
}
goto V_154;
}
...
struct V_159 * V_160 = F_72 ( & V_143 -> V_20 ) ;
struct V_161 * V_162 ;
...
F_67 ( & V_28 -> V_39 ) ;
V_162 = F_73 ( V_143 , V_163 , 0 ) ;
V_28 -> V_7 = F_74 ( V_28 -> V_20 , V_162 ) ;
if ( F_75 ( V_28 -> V_7 ) )
return F_76 ( V_28 -> V_7 ) ;
V_158 = F_77 ( V_164 , V_28 -> V_20 ) ;
if ( V_158 )
F_78 ( V_28 -> V_20 -> V_165 ,
L_12 , & V_40 ) ;
else if ( V_160 && V_160 -> V_40 )
V_40 = V_160 -> V_40 ;
else
V_40 = 32 ;
V_28 -> V_40 = V_40 ;
...
F_80 ( V_166 , V_28 -> V_36 . V_167 ) ;
F_80 ( V_168 , V_28 -> V_36 . V_167 ) ;
F_80 ( V_169 , V_28 -> V_36 . V_167 ) ;
F_80 ( V_170 , V_28 -> V_36 . V_167 ) ;
V_28 -> V_36 . V_20 = & V_143 -> V_20 ;
V_28 -> V_36 . V_171 = F_34 ;
V_28 -> V_36 . V_172 = F_42 ;
V_28 -> V_36 . V_173 = F_54 ;
V_28 -> V_36 . V_174 = F_44 ;
V_28 -> V_36 . V_175 = F_48 ;
V_28 -> V_36 . V_176 = F_52 ;
V_28 -> V_36 . V_177 = F_56 ;
V_28 -> V_36 . V_178 = F_53 ;
V_28 -> V_36 . V_179 = V_180 ;
if ( V_28 -> V_20 -> V_181 )
F_81 ( V_28 -> V_20 , V_28 -> V_20 -> V_181 ) ;
else
...
F_85 ( V_143 , V_28 ) ;
F_86 ( V_28 -> V_36 . V_20 , L_15 , V_40 ) ;
return 0 ;
}
bool F_87 ( struct V_61 * V_35 , void * V_182 )
{
struct V_32 * V_156 = F_25 ( V_35 ) ;
if ( V_35 -> V_36 -> V_20 -> V_183 != & V_184 . V_183 )
return false ;
V_156 -> V_10 = * ( unsigned int * ) V_182 ;
return true ;
}
