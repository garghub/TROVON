...
return - V_51 ;
V_64 = V_2 -> V_65 [ V_62 ] . V_64 ;
F_36 ( V_38 -> V_43 . V_55 . V_33 , V_64 [ V_67 ] ,
...
V_71 . V_76 = 0 ;
V_71 . V_40 =
F_40 ( V_67 / 2 , 1 , 0 , 0 ) | V_82 ;
V_68 = F_41 ( V_2 -> V_83 , F_42 ( & V_71 , V_2 ) ) ;
if ( V_68 < 0 )
return V_68 ;
}
memset ( & V_71 , 0 , sizeof( V_71 ) ) ;
...
case V_13 :
V_71 . V_40 =
F_40 ( V_67 / 2 , ( V_67 % 2 ) + 6 , 0 , 127 ) |
V_88 ;
V_71 . V_89 . V_90 = V_91 ;
break;
case V_14 :
V_71 . V_40 =
F_40 ( V_67 / 2 , ( V_67 % 2 ) + 4 , 0 , 127 ) |
V_88 ;
V_71 . V_89 . V_90 = V_91 ;
break;
case V_16 : {
...
V_71 . V_40 =
F_40 ( 0 , V_5 , 0 , 255 ) | V_82 ;
V_71 . V_89 . V_90 = V_92 ;
break;
}
case V_17 :
V_71 . V_40 = F_40 ( 0 , V_67 + 4 , 0 , 255 ) ;
V_71 . V_89 . V_90 = V_92 ;
break;
case V_18 : {
int V_48 = V_67 < 6 ? V_67 + 4 : V_67 + 5 ;
V_71 . V_40 =
F_40 ( 0 , V_48 , 0 , 127 ) | V_93 ;
V_71 . V_89 . V_90 = V_94 ;
break;
}
case V_19 :
V_71 . V_40 =
F_40 ( V_67 / 2 , ( V_67 % 2 ) + 3 , 0 , 255 ) ;
V_71 . V_89 . V_90 = V_95 ;
break;
case V_15 :
V_71 . V_40 =
F_40 ( V_67 / 2 , ( V_67 % 2 ) + 6 , 0 , 255 ) ;
V_71 . V_89 . V_90 = V_95 ;
break;
default:
return - V_51 ;
...
case V_14 :
case V_15 :
V_71 . V_40 = F_40 ( V_67 , 3 , 0 , 0 ) ;
break;
case V_16 : {
int V_58 = V_67 == 3 ? 6 : ( 2 - V_67 ) * 2 ;
V_71 . V_40 = F_40 ( 0 , 8 , V_58 , 0 ) ;
break;
}
case V_17 :
case V_18 :
...
struct V_101 * V_102 ;
int V_68 ;
V_68 = F_48 ( V_2 -> V_83 , V_2 -> V_33 , & V_102 ) ;
if ( V_68 < 0 )
return V_68 ;
F_49 ( V_102 , V_2 , F_45 ) ;
return 0 ;
}
static int F_47 ( struct V_1 * V_2 ) { return 0 ; }
