...
if ( F_31 ( V_51 , V_20 + 2 , 0 , V_84 [ V_20 ] , 0 ) != 0 )
return - V_79 ;
return 0 ;
}
static int F_32 ( struct V_88 * V_89 )
{
struct V_1 * V_2 = V_89 -> V_52 -> V_2 ;
int V_9 ;
V_89 -> V_53 [ 0 ] . V_51 = F_33 ( V_90 , & V_91 ,
& V_89 -> V_52 -> V_78 , V_92 ) ;
if ( V_89 -> V_53 [ 0 ] . V_51 ) {
struct V_93 * V_94 ;
V_94 = F_33 ( V_95 ,
...
V_91 . V_98 = V_94 -> V_98 ;
V_91 . V_99 = V_94 -> V_99 ;
V_91 . V_100 = V_94 -> V_100 ;
V_91 . V_101 = V_94 -> V_101 ;
V_91 . V_102 = V_94 -> V_102 ;
V_91 . V_103 = V_94 -> V_103 ;
V_91 . V_104 = V_94 -> V_104 ;
V_91 . V_105 = V_94 -> V_105 ;
V_91 . V_106 = V_94 -> V_106 ;
V_91 . V_107 = V_94 -> V_107 ;
if ( V_89 -> V_53 [ 0 ] . V_51 -> V_58 . V_108 )
V_89 -> V_53 [ 0 ] . V_51 -> V_58 . V_108 ( V_89 -> V_53 [ 0 ] . V_51 ) ;
if ( F_10 ( & V_89 -> V_52 -> V_23 ) < 0 )
return - V_24 ;
...
if ( V_9 != 0 )
F_4 ( L_14 ) ;
V_89 -> V_53 [ 0 ] . V_51 -> V_58 . V_110 = F_30 ;
F_34 ( V_89 -> V_53 [ 0 ] . V_51 -> V_58 . F_23 . V_111 , V_89 -> V_52 -> V_66 -> V_111 ,
sizeof( V_89 -> V_53 [ 0 ] . V_51 -> V_58 . F_23 . V_111 ) ) ;
} else {
F_35 ( V_89 -> V_53 [ 0 ] . V_51 ) ;
V_89 -> V_53 [ 0 ] . V_51 = NULL ;
}
}
F_16 ( V_89 -> V_52 , 1 , 1 ) ;
return V_89 -> V_53 [ 0 ] . V_51 == NULL ? - V_12 : 0 ;
}
...
V_113 . V_118 = 0 ;
while ( 1 ) {
V_113 . V_118 = ! V_113 . V_118 ;
V_113 . V_119 = ( * V_8 * V_120 * V_121 ) / 1000 ;
F_37 ( V_22 -> V_122 , & V_113 ) ;
V_8 ++ ;
if ( * V_8 == 0xff ) {
V_113 . V_118 = 0 ;
V_113 . V_119 = 888888 * 2 ;
F_37 ( V_22 -> V_122 , & V_113 ) ;
break;
}
}
