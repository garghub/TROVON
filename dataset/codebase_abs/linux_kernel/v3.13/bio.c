...
void F_142 ( struct V_4 * V_4 , int V_104 , int V_202 )
{
int V_10 ;
struct V_31 * V_107 ;
int V_203 = 0 ;
V_202 <<= 9 ;
if ( V_104 == 0 && V_202 == V_4 -> V_94 )
return;
F_131 ( V_86 , & V_4 -> V_55 ) ;
F_74 ( V_4 , V_104 << 9 ) ;
V_4 -> V_94 = V_202 ;
if ( V_4 -> V_95 ) {
memmove ( V_4 -> V_52 , V_4 -> V_52 + V_4 -> V_95 ,
( V_4 -> V_93 - V_4 -> V_95 ) * sizeof( struct V_31 ) ) ;
V_4 -> V_93 -= V_4 -> V_95 ;
V_4 -> V_95 = 0 ;
}
F_46 (bvec, bio, i) {
if ( V_203 + V_107 -> V_82 > V_202 )
V_107 -> V_82 = V_202 - V_203 ;
if ( V_107 -> V_82 == 0 ) {
V_4 -> V_93 = V_10 ;
break;
}
...
T_4 F_143 ( struct V_4 * V_4 , unsigned short V_204 ,
unsigned int V_104 )
{
unsigned int V_205 ;
struct V_31 * V_32 ;
T_4 V_206 ;
int V_10 ;
V_205 = F_144 ( V_4 -> V_90 -> V_207 -> V_208 ) ;
V_206 = 0 ;
if ( V_204 >= V_4 -> V_95 )
V_204 = V_4 -> V_93 - 1 ;
F_79 (bv, bio, i) {
if ( V_10 == V_204 ) {
if ( V_104 > V_32 -> V_109 )
V_206 += ( V_104 - V_32 -> V_109 ) / V_205 ;
break;
}
V_206 += V_32 -> V_82 / V_205 ;
}
return V_206 ;
}
T_1 * F_145 ( struct V_23 * V_24 , int V_209 )
{
struct V_35 * V_192 = V_28 + V_34 ;
return F_146 ( V_209 , V_192 -> V_5 ) ;
}
...
struct V_23 * F_151 ( unsigned int V_210 , unsigned int V_53 )
{
unsigned int V_211 = V_76 * sizeof( struct V_31 ) ;
struct V_23 * V_24 ;
V_24 = F_152 ( sizeof( * V_24 ) , V_19 ) ;
if ( ! V_24 )
return NULL ;
V_24 -> V_53 = V_53 ;
F_153 ( & V_24 -> V_64 ) ;
F_38 ( & V_24 -> V_65 ) ;
F_154 ( & V_24 -> V_63 , F_31 ) ;
V_24 -> V_6 = F_1 ( V_53 + V_211 ) ;
if ( ! V_24 -> V_6 ) {
F_27 ( V_24 ) ;
return NULL ;
}
V_24 -> V_54 = F_146 ( V_210 , V_24 -> V_6 ) ;
if ( ! V_24 -> V_54 )
goto V_212;
V_24 -> V_51 = F_145 ( V_24 , V_210 ) ;
if ( ! V_24 -> V_51 )
goto V_212;
V_24 -> V_70 = F_155 ( L_5 , V_213 , 0 ) ;
if ( ! V_24 -> V_70 )
goto V_212;
return V_24 ;
V_212:
...
V_4 -> V_218 = V_215 ;
F_158 () ;
V_217 = F_159 ( V_69 , V_221 ) ;
if ( V_217 && F_160 ( V_217 ) )
V_4 -> V_222 = V_217 ;
F_161 () ;
return 0 ;
}
...
V_18 = 2 ;
V_13 = 0 ;
V_14 = F_152 ( V_18 * sizeof( struct V_6 ) , V_19 ) ;
if ( ! V_14 )
F_166 ( L_6 ) ;
F_167 () ;
F_164 () ;
