...
struct V_42 * V_43 ;
int V_71 , V_11 = 0 ;
if ( F_44 ( F_45 ( V_40 ) ) != V_72 )
return - V_46 ;
V_71 = F_46 ( F_45 ( V_40 ) ) ;
if ( V_71 == 0 ) {
struct V_73 * V_74 = F_47 () ;
if ( ! V_74 || V_74 -> V_75 -> V_76 != V_77 ) {
F_48 ( V_74 ) ;
return - V_46 ;
}
V_71 = V_74 -> V_78 ;
...
F_51 ( & V_6 -> V_14 ) ;
V_6 -> V_17 = F_52 ( F_53 ( V_82 ) ) ;
V_11 = F_54 ( & V_6 -> V_10 , & V_79 , V_71 ) ;
if ( V_11 ) {
F_41 ( & V_6 -> V_10 ) ;
goto V_81;
}
...
static int
F_58 ( struct V_70 * V_70 , struct V_39 * V_40 )
{
struct V_5 * V_6 ;
V_6 = V_40 -> V_45 ;
V_40 -> V_45 = NULL ;
...
static void F_61 ( int V_71 )
{
F_62 ( V_72 , V_71 , 1 , L_1 , & V_83 ) ;
F_63 ( V_84 , NULL , F_64 ( V_72 , V_71 ) ,
NULL , L_2 , V_71 ) ;
}
static void F_65 ( int V_71 )
{
F_66 ( V_84 , F_64 ( V_72 , V_71 ) ) ;
F_67 ( V_72 , V_71 , 1 , L_1 ) ;
}
static int T_5
F_68 ( void )
{
int V_11 ;
V_11 = F_62 ( V_72 , 0 , 1 , L_3 , & V_83 ) ;
if ( V_11 )
return V_11 ;
F_63 ( V_84 , NULL , F_64 ( V_72 , 0 ) ,
NULL , L_4 ) ;
F_69 ( & V_85 ) ;
return 0 ;
}
