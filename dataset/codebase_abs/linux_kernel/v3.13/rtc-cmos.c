...
#if F_51 ( V_86 )
V_80 = 64 ;
#elif F_51 ( V_87 ) || F_51 ( V_88 ) || F_51 ( V_89 ) \
|| F_51 ( V_90 ) || F_51 ( V_91 ) \
|| F_51 ( V_92 )
V_80 = 128 ;
#else
...
V_80 = 128 ;
#endif
if ( V_67 && V_76 -> V_93 > ( V_76 -> V_83 + 1 ) )
V_80 = 256 ;
if ( V_79 ) {
if ( V_79 -> V_94 && V_79 -> V_94 < 128 )
V_17 . V_31 = V_79 -> V_94 ;
...
V_17 . V_13 = V_13 ;
F_52 ( V_13 , & V_17 ) ;
V_17 . V_41 = F_53 ( V_84 , V_13 ,
& V_99 , V_100 ) ;
if ( F_54 ( V_17 . V_41 ) ) {
V_64 = F_55 ( V_17 . V_41 ) ;
goto V_101;
}
F_56 ( V_76 , F_57 ( & V_17 . V_41 -> V_13 ) ) ;
F_23 ( & V_24 ) ;
V_17 . V_41 -> V_53 = 1024 ;
F_6 ( V_17 . V_41 -> V_53 ) ;
...
V_107 = F_43 ;
V_64 = F_59 ( V_77 , V_107 ,
0 , F_57 ( & V_17 . V_41 -> V_13 ) ,
V_17 . V_41 ) ;
if ( V_64 < 0 ) {
F_50 ( V_13 , L_16 , V_77 ) ;
goto V_106;
...
F_8 () ;
V_110 . V_65 = V_80 - V_66 ;
V_64 = F_60 ( & V_13 -> V_58 , & V_110 ) ;
if ( V_64 < 0 ) {
F_50 ( V_13 , L_17 , V_64 ) ;
goto V_111;
}
...
unsigned char V_112 ;
F_23 ( & V_24 ) ;
V_18 -> V_72 = V_112 = F_24 ( V_33 ) ;
if ( V_112 & ( V_50 | V_38 | V_51 ) ) {
unsigned char V_4 ;
if ( F_69 ( V_13 ) )
V_4 = V_3 & ~ V_38 ;
else
...
static inline void F_78 ( struct V_12 * V_13 )
{
F_79 ( V_116 , F_74 , V_13 ) ;
F_76 ( V_116 ) ;
F_77 ( V_116 , 0 ) ;
}
...
V_119 . V_97 = F_80 ;
V_119 . V_98 = F_82 ;
if ( V_120 . V_121 && ! V_120 . V_122 ) {
F_50 ( V_13 , L_29 ,
V_120 . V_121 ) ;
V_120 . V_121 = 0 ;
}
V_119 . V_94 = V_120 . V_122 ;
V_119 . V_95 = V_120 . V_121 ;
V_119 . V_96 = V_120 . V_69 ;
if ( V_120 . V_44 & V_123 )
F_61 ( V_13 , L_30 ) ;
V_13 -> V_124 = & V_119 ;
F_84 ( V_13 , 1 ) ;
...
static int F_85 ( struct V_125 * V_126 , const struct V_127 * V_128 )
{
F_83 ( & V_126 -> V_13 ) ;
if ( F_86 ( V_126 , 0 ) == 0x70 && ! F_87 ( V_126 , 0 ) )
return F_46 ( & V_126 -> V_13 ,
F_88 ( V_126 , V_129 , 0 ) , 8 ) ;
else
return F_46 ( & V_126 -> V_13 ,
F_88 ( V_126 , V_129 , 0 ) ,
F_89 ( V_126 , 0 ) ) ;
}
static void T_8 F_90 ( struct V_125 * V_126 )
{
F_66 ( & V_126 -> V_13 ) ;
}
static void F_91 ( struct V_125 * V_126 )
{
if ( V_130 == V_131 && ! F_71 ( & V_126 -> V_13 ) )
return;
F_65 () ;
}
static T_10 void F_92 ( struct V_132 * V_133 )
{
...
if ( ! V_135 )
return;
V_11 = F_93 ( V_135 , L_31 , NULL ) ;
if ( V_11 )
F_30 ( F_94 ( V_11 ) , V_33 ) ;
V_11 = F_93 ( V_135 , L_32 , NULL ) ;
if ( V_11 )
F_30 ( F_94 ( V_11 ) , V_103 ) ;
F_17 ( & time ) ;
V_137 = F_95 ( & time ) ;
if ( V_137 ) {
struct V_14 V_138 = {
...
static inline void F_92 ( struct V_132 * V_133 ) {}
static int T_10 F_96 ( struct V_132 * V_133 )
{
F_92 ( V_133 ) ;
F_83 ( & V_133 -> V_13 ) ;
...
static int T_8 F_99 ( struct V_132 * V_133 )
{
F_66 ( & V_133 -> V_13 ) ;
return 0 ;
}
...
{
if ( V_130 == V_131 && ! F_71 ( & V_133 -> V_13 ) )
return;
F_65 () ;
}
