...
F_126 ( V_47 ) ;
if ( V_47 -> V_152 )
F_127 ( V_47 , V_47 -> V_152 , V_47 -> V_153 ) ;
if ( V_47 -> V_154 )
...
for ( V_3 = 0 ; V_3 < F_129 ( V_47 -> V_78 -> V_10 ) ; V_3 ++ ) {
...
static int F_139 ( struct V_60 * V_47 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < V_47 -> V_85 ; V_3 ++ ) {
...
static void F_152 ( struct V_219 * V_72 )
{
struct V_221 * V_222 = V_223 . V_222 ;
F_153 ( V_222 , V_223 . V_224 ) ;
F_154 ( V_223 . V_225 , 1 ) ;
F_155 ( 10 ) ;
F_154 ( V_223 . V_225 , 0 ) ;
F_153 ( V_222 , V_223 . V_226 ) ;
F_156 ( 2 ) ;
}
static void F_157 ( struct V_219 * V_72 )
{
struct V_221 * V_222 = V_223 . V_222 ;
F_153 ( V_222 , V_223 . V_227 ) ;
F_154 ( V_223 . V_225 , 0 ) ;
F_154 ( V_223 . V_228 , 0 ) ;
F_154 ( V_223 . V_229 , 0 ) ;
F_155 ( 10 ) ;
...
V_231 -> V_222 = V_22 ;
V_233 = F_162 ( V_22 , L_68 ) ;
if ( F_160 ( V_233 ) ) {
F_50 ( V_27 , L_69 ) ;
return F_161 ( V_233 ) ;
}
V_231 -> V_227 = V_233 ;
V_233 = F_162 ( V_22 , L_70 ) ;
if ( F_160 ( V_233 ) ) {
F_50 ( V_27 , L_71 ) ;
return F_161 ( V_233 ) ;
}
V_231 -> V_224 = V_233 ;
V_233 = F_162 ( V_22 , L_72 ) ;
if ( F_160 ( V_233 ) ) {
F_50 ( V_27 , L_73 ) ;
return F_161 ( V_233 ) ;
}
V_231 -> V_226 = V_233 ;
V_234 = F_163 ( V_27 -> V_121 , L_74 , 0 ) ;
if ( V_234 < 0 ) {
F_50 ( V_27 , L_75 ) ;
return V_234 ;
}
V_14 = F_164 ( V_27 , V_234 , L_76 ) ;
if ( V_14 ) {
F_50 ( V_27 , L_77 ) ;
return V_14 ;
}
V_231 -> V_225 = V_234 ;
V_234 = F_163 ( V_27 -> V_121 , L_74 , 1 ) ;
if ( V_234 < 0 ) {
F_50 ( V_27 , L_78 , V_234 ) ;
return V_234 ;
}
V_14 = F_164 ( V_27 , V_234 , L_79 ) ;
if ( V_14 ) {
F_50 ( V_27 , L_80 ) ;
return V_14 ;
}
V_231 -> V_228 = V_234 ;
V_234 = F_163 ( V_27 -> V_121 , L_74 , 2 ) ;
if ( V_234 < 0 ) {
F_50 ( V_27 , L_81 ) ;
return V_234 ;
}
V_14 = F_164 ( V_27 , V_234 , L_82 ) ;
if ( V_14 ) {
F_50 ( V_27 , L_83 ) ;
return V_14 ;
}
...
int F_170 ( struct V_4 * V_5 , unsigned short V_6 ,
...
int V_239 ;
F_151 ( & V_5 -> V_190 ) ;
V_239 = F_170 ( V_5 , V_6 , V_238 , V_42 ) ;
F_134 ( & V_5 -> V_190 ) ;
return V_239 ;
}
int F_173 ( struct V_4 * V_5 , unsigned short V_6 ,
unsigned int V_238 , unsigned int V_42 )
{
int V_239 ;
unsigned int V_240 , V_241 ;
...
struct V_242 * F_174 ( const struct V_243 * V_244 ,
...
V_207 = V_247 . V_49 ;
if ( V_246 ) {
V_49 = F_175 ( V_37 , L_84 , V_246 , V_207 ) ;
if ( ! V_49 )
return NULL ;
V_247 . V_49 = V_49 ;
} else {
...
V_248 = F_176 ( & V_247 , V_245 ) ;
F_16 ( V_49 ) ;
return V_248 ;
}
static int F_177 ( struct V_78 * V_47 , struct V_26 * V_27 ,
...
V_74 = F_178 ( V_47 , F_174 ( V_250 , V_245 ,
V_250 -> V_49 , V_246 ) ) ;
if ( V_74 < 0 ) {
F_50 ( V_27 , L_85 ,
V_250 -> V_49 , V_74 ) ;
...
struct V_242 * F_179 ( struct V_60 * V_251 ,
const char * V_49 )
{
...
return F_177 ( V_47 , V_5 -> V_27 , V_152 , V_153 ,
V_5 -> V_143 , V_5 ) ;
}
...
return F_177 ( V_47 , V_56 -> V_27 , V_152 , V_153 ,
NULL , V_56 ) ;
}
int F_127 ( struct V_60 * V_251 ,
const struct V_243 * V_152 , int V_153 )
{
struct V_78 * V_47 = V_251 -> V_78 ;
return F_177 ( V_47 , V_251 -> V_27 , V_152 , V_153 ,
NULL , V_251 ) ;
}
int F_181 ( struct V_58 * V_59 ,
const struct V_243 * V_152 , int V_153 )
{
struct V_78 * V_47 = V_59 -> V_47 -> V_78 ;
return F_177 ( V_47 , V_59 -> V_27 , V_152 , V_153 ,
NULL , V_59 ) ;
}
int F_182 ( struct V_242 * V_248 ,
struct V_254 * V_255 )
{
...
F_183 ( V_255 -> V_42 . V_262 . V_49 ,
V_257 -> V_266 [ V_255 -> V_42 . V_262 . V_265 ] ,
sizeof( V_255 -> V_42 . V_262 . V_49 ) ) ;
return 0 ;
}
int F_184 ( struct V_242 * V_248 ,
struct V_267 * V_268 )
{
struct V_4 * V_5 = F_185 ( V_248 ) ;
struct V_256 * V_257 = (struct V_256 * ) V_248 -> V_258 ;
unsigned int V_1 ;
...
return F_172 ( V_5 , V_257 -> V_6 , V_238 , V_1 ) ;
}
...
V_255 -> type = V_276 ;
V_255 -> V_18 = F_190 ( V_273 ) ? 2 : 1 ;
V_255 -> V_42 . integer . F_7 = 0 ;
V_255 -> V_42 . integer . V_264 = V_274 ;
return 0 ;
}
int F_191 ( struct V_242 * V_248 ,
struct V_267 * V_268 )
{
struct V_272 * V_273 =
(struct V_272 * ) V_248 -> V_258 ;
...
unsigned int V_238 = ( 1 << F_192 ( V_264 ) ) - 1 ;
...
V_74 = F_172 ( V_5 , V_6 , V_284 , V_1 ) ;
if ( V_74 < 0 )
return V_74 ;
if ( V_282 )
V_74 = F_172 ( V_5 , V_277 , V_284 , V_283 ) ;
return V_74 ;
}
...
int V_264 = V_273 -> V_264 ;
int F_7 = V_273 -> F_7 ;
int V_238 = ( 1 << ( F_192 ( F_7 + V_264 ) - 1 ) ) - 1 ;
V_268 -> V_42 . integer . V_42 [ 0 ] =
...
V_283 = V_283 << V_280 ;
if ( F_172 ( V_5 , V_277 , V_284 , V_283 ) )
return V_74 ;
}
return 0 ;
}
...
return F_172 ( V_5 , V_6 , 0xffff , V_1 ) ;
}
...
V_284 = V_238 << V_279 ;
V_1 = V_1 << V_279 ;
V_14 = F_172 ( V_5 , V_278 , V_284 , V_1 ) ;
}
return V_14 ;
}
...
int V_14 ;
if ( V_5 -> V_107 )
V_14 = F_205 ( V_5 -> V_108 , V_180 -> V_289 ,
...
V_245 = F_209 ( V_268 -> V_42 . V_290 . V_245 , V_8 , V_37 | V_293 ) ;
if ( ! V_245 )
return - V_38 ;
if ( V_180 -> V_238 ) {
V_14 = F_210 ( V_5 -> V_108 , V_180 -> V_289 , & V_1 ) ;
if ( V_14 != 0 )
goto V_172;
V_1 &= V_180 -> V_238 ;
switch ( V_5 -> V_288 ) {
...
break;
case 2 :
( ( V_291 * ) V_245 ) [ 0 ] &= F_206 ( ~ V_180 -> V_238 ) ;
( ( V_291 * ) V_245 ) [ 0 ] |= F_206 ( V_1 ) ;
break;
case 4 :
( ( V_292 * ) V_245 ) [ 0 ] &= F_207 ( ~ V_180 -> V_238 ) ;
( ( V_292 * ) V_245 ) [ 0 ] |= F_207 ( V_1 ) ;
break;
default:
V_14 = - V_17 ;
goto V_172;
...
V_14 = F_211 ( V_5 -> V_108 , V_180 -> V_289 ,
V_245 , V_8 ) ;
V_172:
F_16 ( V_245 ) ;
return V_14 ;
}
int F_212 ( struct V_242 * V_248 ,
struct V_254 * V_255 )
{
struct V_295 * V_273 =
...
int V_74 ;
V_74 = F_172 ( V_5 , V_6 , V_238 , V_305 ) ;
if ( V_74 < 0 )
return V_74 ;
V_74 = F_172 ( V_5 , V_6 , V_238 , V_283 ) ;
return V_74 ;
}
int F_217 ( struct V_58 * V_59 , int V_306 ,
...
int F_218 ( struct V_4 * V_5 , int V_306 ,
...
int F_220 ( struct V_58 * V_59 , int V_313 , int V_310 ,
...
int F_221 ( struct V_4 * V_5 , int V_313 , int V_310 ,
unsigned int V_314 , unsigned int V_315 )
{
if ( V_5 -> V_10 -> V_316 )
...
int F_222 ( struct V_58 * V_59 , unsigned int V_317 )
{
...
int F_128 ( struct V_58 * V_59 , unsigned int V_319 )
{
if ( V_59 -> V_10 == NULL )
return - V_17 ;
...
int F_225 ( struct V_58 * V_59 , int V_331 )
{
...
int F_226 ( struct V_58 * V_59 , int V_333 ,
int V_334 )
{
if ( ! V_59 -> V_10 )
return - V_199 ;
...
static char * F_229 ( struct V_26 * V_27 , int * V_253 )
{
char * V_187 , V_49 [ V_339 ] ;
int V_340 , V_341 ;
if ( F_71 ( V_27 ) == NULL )
return NULL ;
F_183 ( V_49 , F_71 ( V_27 ) , V_339 ) ;
...
F_183 ( V_49 , V_342 , V_339 ) ;
} else
* V_253 = 0 ;
}
return F_230 ( V_49 , V_37 ) ;
}
static inline char * F_231 ( struct V_26 * V_27 ,
struct V_87 * V_343 )
{
if ( V_343 -> V_49 == NULL ) {
F_50 ( V_27 ,
...
if ( V_59 == NULL )
return - V_38 ;
V_59 -> V_49 = F_229 ( V_27 , & V_59 -> V_253 ) ;
if ( V_59 -> V_49 == NULL ) {
F_16 ( V_59 ) ;
return - V_38 ;
}
...
static int F_234 ( struct V_26 * V_27 ,
...
V_59 -> V_49 = F_231 ( V_27 , & V_343 [ V_3 ] ) ;
if ( V_59 -> V_49 == NULL ) {
F_16 ( V_59 ) ;
V_14 = - V_17 ;
goto V_74;
...
static void F_235 ( struct V_26 * V_27 , T_1 V_18 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < V_18 ; V_3 ++ )
F_233 ( V_27 ) ;
...
V_348 -> V_49 = F_229 ( V_27 , & V_348 -> V_253 ) ;
if ( ! V_348 -> V_49 ) {
F_50 ( V_27 , L_104 ) ;
return - V_38 ;
}
...
V_348 -> V_351 = V_351 ;
if ( ( 1 == V_351 ) && V_352 )
V_14 = F_232 ( V_27 , V_343 ) ;
else
V_14 = F_234 ( V_27 , V_343 , V_351 ) ;
if ( V_14 < 0 ) {
...
int F_237 ( struct V_26 * V_27 ,
const struct V_349 * V_350 ,
struct V_87 * V_343 ,
int V_351 )
{
struct V_347 * V_348 ;
V_348 = F_228 ( V_27 , sizeof( * V_348 ) , V_37 ) ;
if ( ! V_348 ) {
F_50 ( V_27 , L_107 ) ;
return - V_38 ;
}
return F_236 ( V_27 , V_348 , V_350 ,
V_343 , V_351 , true ) ;
}
...
int F_239 ( struct V_26 * V_27 , struct V_55 * V_56 ,
const struct V_158 * V_355 )
{
V_56 -> V_49 = F_229 ( V_27 , & V_56 -> V_253 ) ;
if ( V_56 -> V_49 == NULL )
return - V_38 ;
V_56 -> V_27 = V_27 ;
V_56 -> V_10 = V_355 ;
...
if ( V_56 == NULL )
return - V_38 ;
V_14 = F_239 ( V_27 , V_56 , V_355 ) ;
if ( V_14 )
F_16 ( V_56 ) ;
return V_14 ;
}
void F_241 ( struct V_55 * V_56 )
{
F_151 ( & V_345 ) ;
F_74 ( & V_56 -> V_156 ) ;
F_134 ( & V_345 ) ;
...
struct V_55 * F_242 ( struct V_26 * V_27 )
{
struct V_55 * V_56 ;
F_34 (platform, &platform_list, list) {
if ( V_27 == V_56 -> V_27 )
...
static void F_244 ( struct V_358 * V_66 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_129 ( V_359 ) ; V_3 ++ )
if ( V_66 -> V_360 & V_359 [ V_3 ] )
V_66 -> V_360 |= V_359 [ V_3 ] ;
}
int F_245 ( struct V_26 * V_27 ,
...
F_244 ( & V_343 [ V_3 ] . V_365 ) ;
F_244 ( & V_343 [ V_3 ] . V_366 ) ;
}
F_151 ( & V_345 ) ;
F_91 ( & V_5 -> V_156 , & V_367 ) ;
F_134 ( & V_345 ) ;
V_14 = F_236 ( V_27 , & V_5 -> V_368 ,
& V_361 -> V_369 ,
V_343 , V_351 , false ) ;
if ( V_14 < 0 ) {
...
int F_248 ( struct V_60 * V_47 ,
const char * V_371 )
{
struct V_372 * V_373 = V_47 -> V_27 -> V_121 ;
int V_14 ;
V_14 = F_249 ( V_373 , V_371 , 0 , & V_47 -> V_49 ) ;
if ( V_14 < 0 && V_14 != - V_17 ) {
F_50 ( V_47 -> V_27 ,
L_116 ,
V_371 , V_14 ) ;
...
V_376 = F_228 ( V_47 -> V_27 , V_374 * sizeof( * V_376 ) ,
V_37 ) ;
if ( ! V_376 ) {
F_50 ( V_47 -> V_27 ,
L_119 ) ;
...
unsigned int F_252 ( struct V_372 * V_373 ,
const char * V_246 )
{
int V_14 , V_3 ;
char V_378 [ 128 ] ;
...
V_14 = F_253 ( V_373 , V_378 , & V_382 ) ;
if ( V_14 == 0 ) {
for ( V_3 = 0 ; V_3 < F_129 ( V_383 ) ; V_3 ++ ) {
...
if ( F_254 ( V_373 , V_378 , NULL ) )
V_379 |= V_393 ;
else
V_379 |= V_394 ;
snprintf ( V_378 , sizeof( V_378 ) , L_133 , V_246 ) ;
V_380 = ! ! F_254 ( V_373 , V_378 , NULL ) ;
snprintf ( V_378 , sizeof( V_378 ) , L_134 , V_246 ) ;
V_381 = ! ! F_254 ( V_373 , V_378 , NULL ) ;
...
int F_255 ( struct V_372 * V_121 ,
const char * * V_398 )
{
struct V_347 * V_19 ;
struct V_399 args ;
int V_14 ;
V_14 = F_256 ( V_121 , L_137 ,
L_138 , 0 , & args ) ;
if ( V_14 )
return V_14 ;
V_14 = - V_124 ;
