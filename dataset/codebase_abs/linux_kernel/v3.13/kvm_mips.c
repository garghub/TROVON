...
int
F_136 ( struct V_1 * V_2 , struct V_176 * V_177 )
{
return 0 ;
}
...
int F_142 ( struct V_69 * V_70 , struct V_1 * V_2 )
{
...
V_192 = F_143 ( V_184 , V_188 , V_70 , V_2 ) ;
if ( V_192 == V_198 ) {
goto V_199;
} else if ( V_192 == V_200 ) {
V_70 -> V_195 = V_201 ;
...
F_43
( L_30 ,
V_186 , V_188 , F_147 ( V_188 , V_2 ) , V_189 ,
F_82 ( V_2 -> V_4 . V_77 ) ) ;
F_122 ( V_2 ) ;
V_70 -> V_195 = V_201 ;
V_150 = V_202 ;
...
{
int V_150 ;
V_150 = F_150 ( NULL , sizeof( struct V_1 ) , 0 , V_249 ) ;
if ( V_150 )
return V_150 ;
V_250 = V_251 ;
F_23 = V_252 ;
