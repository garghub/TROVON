...
if ( F_47 ( V_162 -> V_115 ) )
V_144 |= V_185 ;
F_14 ( V_162 -> V_50 , V_186 , V_144 ) ;
V_144 = F_48 ( V_162 -> V_124 ) ;
F_14 ( V_162 -> V_50 , V_187 , V_144 ) ;
if ( F_8 ( V_162 -> V_22 ) || ! V_162 -> V_167 )
F_44 ( V_162 -> V_140 ,
V_188 , 0 ) ;
else
F_30 ( V_162 -> V_22 , V_189 ,
...
if ( F_52 ( V_162 -> V_90 , V_162 -> V_156 ) ) {
V_193 = true ;
break;
}
...
V_162 . V_167 = true ;
V_25 = F_6 ( V_26 , V_126 ) ;
if ( F_56 ( V_22 -> V_30 . V_31 , V_25 , & V_198 , & V_199 ) ) {
if ( V_199 > 1 ) {
V_162 . V_167 = false ;
}
}
...
V_162 . V_175 |= V_205 ;
V_144 = F_15 ( V_50 , V_206 ) ;
if ( F_57 ( V_22 ) && ( V_144 & V_207 ) )
V_162 . V_197 = true ;
else
V_162 . V_197 = false ;
memcpy ( V_162 . V_115 , V_53 -> V_115 , V_208 ) ;
V_162 . V_22 = V_22 ;
V_162 . V_140 = V_140 ;
V_162 . V_114 = V_114 ;
V_162 . V_50 = V_50 ;
