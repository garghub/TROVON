...
V_274 ) ;
V_275 = F_13 ( & V_1 . V_271 ,
V_276 ) ;
}
int F_85 ( void * V_156 , T_2 V_201 )
{
struct V_1 V_277 , V_278 ;
struct V_183 V_279 , V_280 ;
struct V_5 * V_281 , * V_4 = NULL ;
struct V_261 args ;
T_3 V_191 ;
T_1 V_282 ;
int V_178 = 0 ;
struct V_283 V_284 = { V_156 , V_201 } , * V_285 = & V_284 ;
if ( ! V_179 ) {
F_86 () ;
V_178 = F_87 ( & V_1 , V_285 ) ;
if ( V_178 ) {
F_88 () ;
return V_178 ;
}
...
#endif
V_178 = F_87 ( & V_278 , V_285 ) ;
if ( V_178 )
return V_178 ;
V_278 . V_201 = V_201 ;
if ( V_1 . V_39 && ! V_278 . V_39 )
F_4 ( V_22 L_35 ) ;
else if ( ! V_1 . V_39 && V_278 . V_39 )
F_4 ( V_22 L_36 ) ;
V_178 = F_90 ( & V_278 , & V_280 ) ;
if ( V_178 ) {
F_4 ( V_181 L_37 ) ;
F_89 ( & V_278 ) ;
return V_178 ;
}
V_178 = F_1 ( & V_278 , V_286 , & V_4 , & V_282 ) ;
if ( V_178 )
goto V_24;
V_178 = F_97 ( & V_278 ) ;
if ( V_178 ) {
...
F_98 ( & V_183 ) ;
V_178 = F_99 ( & V_183 , F_76 , & V_280 ) ;
if ( V_178 )
goto V_24;
args . V_265 = & V_1 ;
args . V_264 = & V_278 ;
V_178 = F_99 ( & V_280 , F_79 , & args ) ;
if ( V_178 ) {
F_4 ( V_181 L_39
L_40
L_41 ) ;
...
memcpy ( & V_277 , & V_1 , sizeof V_1 ) ;
F_100 ( & V_279 , & V_183 ) ;
F_101 ( & V_180 ) ;
memcpy ( & V_1 , & V_278 , sizeof V_1 ) ;
F_100 ( & V_183 , & V_280 ) ;
F_84 () ;
V_281 = V_29 ;
V_29 = V_4 ;
...
int F_105 ( T_5 V_287 , T_1 V_288 , T_3 * V_239 )
{
struct V_165 * V_48 ;
int V_178 = 0 ;
F_39 ( & V_180 ) ;
V_48 = V_1 . V_267 [ V_289 ] ;
while ( V_48 ) {
if ( V_48 -> V_290 . V_288 . V_287 == V_287 &&
V_48 -> V_290 . V_288 . V_291 <= V_288 &&
V_48 -> V_290 . V_288 . V_292 >= V_288 )
break;
V_48 = V_48 -> V_59 ;
}
if ( V_48 ) {
...
int F_106 ( char * V_15 , T_3 * V_294 )
{
int V_178 = 0 ;
struct V_165 * V_48 ;
F_39 ( & V_180 ) ;
V_48 = V_1 . V_267 [ V_295 ] ;
while ( V_48 ) {
if ( strcmp ( V_15 , V_48 -> V_290 . V_15 ) == 0 )
break;
V_48 = V_48 -> V_59 ;
}
if ( V_48 ) {
...
static int F_107 ( T_3 * V_297 , T_3 * V_298 , T_3 * V_118 )
{
int V_10 , V_299 = 0 ;
for ( V_10 = 0 ; V_10 < 4 ; V_10 ++ )
if ( V_298 [ V_10 ] != ( V_297 [ V_10 ] & V_118 [ V_10 ] ) ) {
V_299 = 1 ;
break;
}
return ! V_299 ;
...
goto V_114;
V_298 = * ( ( T_3 * ) V_301 ) ;
V_48 = V_1 . V_267 [ V_304 ] ;
while ( V_48 ) {
if ( V_48 -> V_290 . V_135 . V_298 == ( V_298 & V_48 -> V_290 . V_135 . V_118 ) )
break;
V_48 = V_48 -> V_59 ;
}
break;
...
case V_305 :
V_178 = - V_14 ;
if ( V_302 != sizeof( V_306 ) * 2 )
goto V_114;
V_48 = V_1 . V_267 [ V_307 ] ;
while ( V_48 ) {
if ( F_107 ( V_301 , V_48 -> V_290 . V_308 . V_298 ,
V_48 -> V_290 . V_308 . V_118 ) )
break;
V_48 = V_48 -> V_59 ;
}
break;
...
T_3 * V_313 )
{
struct V_40 * V_314 , V_315 ;
T_3 * V_316 = NULL , * V_317 , V_206 ;
T_3 V_318 = 0 , V_319 = V_320 ;
struct V_215 * V_67 ;
struct V_49 * V_70 ;
struct V_140 * V_321 , * V_142 ;
...
F_56 ( & V_315 ) ;
V_178 = - V_14 ;
V_314 = F_40 ( & V_183 , V_310 ) ;
if ( ! V_314 )
goto V_210;
V_178 = - V_14 ;
V_67 = F_57 ( V_1 . V_219 . V_113 , V_311 ) ;
if ( ! V_67 )
goto V_210;
V_315 . V_67 = V_67 -> V_21 ;
V_178 = - V_17 ;
V_316 = F_2 ( V_319 , sizeof( * V_316 ) , V_16 ) ;
if ( ! V_316 )
goto V_210;
...
V_315 . type = V_11 + 1 ;
if ( F_110 ( V_314 , V_67 , & V_315 ) )
continue;
V_178 = F_62 ( & V_183 , & V_315 , & V_206 ) ;
if ( V_178 )
goto V_210;
if ( V_318 < V_319 ) {
V_316 [ V_318 ++ ] = V_206 ;
...
V_178 = - V_17 ;
V_319 += V_320 ;
V_317 = F_2 ( V_319 , sizeof( * V_317 ) , V_16 ) ;
if ( ! V_317 )
goto V_210;
memcpy ( V_317 , V_316 , V_318 * sizeof( * V_317 ) ) ;
F_6 ( V_316 ) ;
V_316 = V_317 ;
V_316 [ V_318 ++ ] = V_206 ;
}
...
V_178 = - V_17 ;
V_317 = F_2 ( V_318 , sizeof( * V_317 ) , V_227 ) ;
if ( ! V_317 ) {
F_6 ( V_316 ) ;
goto V_114;
}
for ( V_10 = 0 , V_11 = 0 ; V_10 < V_318 ; V_10 ++ ) {
struct V_32 V_322 ;
V_178 = F_111 ( V_310 , V_316 [ V_10 ] ,
V_247 ,
V_323 , V_324 ,
& V_322 ) ;
if ( ! V_178 )
V_317 [ V_11 ++ ] = V_316 [ V_10 ] ;
F_112 () ;
}
V_178 = 0 ;
F_6 ( V_316 ) ;
...
struct V_165 * V_48 ;
int V_178 , V_330 = 0 ;
while ( V_326 [ 0 ] == '/' && V_326 [ 1 ] == '/' )
V_326 ++ ;
F_39 ( & V_180 ) ;
V_328 = F_7 ( V_327 ) ;
* V_206 = V_269 ;
for ( V_329 = V_1 . V_329 ; V_329 ; V_329 = V_329 -> V_59 ) {
V_330 = strcmp ( V_325 , V_329 -> V_325 ) ;
if ( V_330 <= 0 )
break;
}
V_178 = - V_331 ;
if ( ! V_329 || V_330 )
goto V_114;
for ( V_48 = V_329 -> V_332 ; V_48 ; V_48 = V_48 -> V_59 ) {
V_201 = strlen ( V_48 -> V_290 . V_15 ) ;
if ( ( ! V_48 -> V_333 . V_328 || V_328 == V_48 -> V_333 . V_328 ) &&
( strncmp ( V_48 -> V_290 . V_15 , V_326 , V_201 ) == 0 ) )
break;
}
V_178 = - V_331 ;
if ( ! V_48 )
...
int F_114 ( struct V_334 * V_335 )
{
int V_178 = 0 ;
struct V_165 * V_48 ;
struct V_336 * V_337 = V_335 -> V_338 ;
const char * V_325 = V_335 -> V_339 -> V_15 ;
F_39 ( & V_180 ) ;
V_48 = V_1 . V_267 [ V_340 ] ;
while ( V_48 ) {
if ( strcmp ( V_325 , V_48 -> V_290 . V_15 ) == 0 )
break;
V_48 = V_48 -> V_59 ;
}
if ( V_48 ) {
V_337 -> V_341 = V_48 -> V_333 . V_341 ;
if ( ! V_48 -> V_206 [ 0 ] ) {
...
V_337 -> V_206 = V_48 -> V_206 [ 0 ] ;
} else {
V_178 = F_113 ( V_325 , L_42 , V_342 , & V_337 -> V_206 ) ;
if ( V_178 ) {
V_337 -> V_341 = V_343 ;
V_178 = 0 ;
} else {
...
int F_115 ( int * V_201 , char * * * V_91 , int * * V_345 )
{
int V_10 , V_178 ;
F_39 ( & V_180 ) ;
* V_91 = NULL ;
...
goto V_24;
V_178 = - V_17 ;
* V_345 = F_2 ( * V_201 , sizeof( int ) , V_16 ) ;
if ( ! * V_345 )
goto V_24;
for ( V_10 = 0 ; V_10 < * V_201 ; V_10 ++ ) {
T_2 V_347 ;
( * V_345 ) [ V_10 ] = V_1 . V_348 [ V_10 ] -> V_349 ;
V_347 = strlen ( F_20 ( & V_1 , V_350 , V_10 ) ) + 1 ;
V_178 = - V_17 ;
( * V_91 ) [ V_10 ] = F_48 ( sizeof( char ) * V_347 , V_16 ) ;
if ( ! ( * V_91 ) [ V_10 ] )
goto V_24;
strncpy ( ( * V_91 ) [ V_10 ] , F_20 ( & V_1 , V_350 , V_10 ) , V_347 ) ;
( * V_91 ) [ V_10 ] [ V_347 - 1 ] = 0 ;
}
V_178 = 0 ;
V_114:
...
F_101 ( & V_180 ) ;
V_178 = - V_354 ;
V_351 = V_1 . V_346 . V_144 ;
if ( V_201 != V_351 )
goto V_114;
for ( V_10 = 0 ; V_10 < V_201 ; V_10 ++ ) {
if ( ! ! V_345 [ V_10 ] != V_1 . V_348 [ V_10 ] -> V_349 ) {
F_37 ( V_115 -> V_116 , V_16 ,
V_355 ,
L_43 ,
F_20 ( & V_1 , V_350 , V_10 ) ,
! ! V_345 [ V_10 ] ,
V_1 . V_348 [ V_10 ] -> V_349 ,
F_117 ( & V_356 , F_118 ( V_115 ) ) ,
F_119 ( V_115 ) ) ;
}
if ( V_345 [ V_10 ] )
V_1 . V_348 [ V_10 ] -> V_349 = 1 ;
else
V_1 . V_348 [ V_10 ] -> V_349 = 0 ;
}
for ( V_353 = V_1 . V_357 ; V_353 ; V_353 = V_353 -> V_59 ) {
V_178 = F_120 ( & V_1 , V_353 ) ;
if ( V_178 )
goto V_114;
}
V_191 = ++ V_192 ;
...
{
int V_178 , V_358 = 0 , * V_359 = NULL , V_10 ;
char * * V_360 = NULL ;
struct V_361 * V_362 ;
struct V_352 * V_353 ;
V_178 = F_115 ( & V_358 , & V_360 , & V_359 ) ;
if ( V_178 )
goto V_114;
for ( V_10 = 0 ; V_10 < V_358 ; V_10 ++ ) {
V_362 = F_57 ( V_217 -> V_346 . V_113 , V_360 [ V_10 ] ) ;
if ( V_362 )
V_362 -> V_349 = V_359 [ V_10 ] ;
}
for ( V_353 = V_217 -> V_357 ; V_353 ; V_353 = V_353 -> V_59 ) {
V_178 = F_120 ( V_217 , V_353 ) ;
if ( V_178 )
goto V_114;
}
V_114:
...
int F_122 ( T_3 V_206 , T_3 V_363 , T_3 * V_186 )
{
struct V_40 * V_364 ;
struct V_40 * V_365 ;
struct V_40 V_366 ;
...
V_178 = - V_14 ;
V_365 = F_40 ( & V_183 , V_363 ) ;
if ( ! V_365 ) {
F_4 ( V_181 L_17 ,
V_182 , V_363 ) ;
goto V_210;
}
V_366 . V_67 = V_364 -> V_67 ;
V_366 . V_70 = V_364 -> V_70 ;
V_366 . type = V_364 -> type ;
V_178 = F_123 ( & V_366 , V_365 ) ;
if ( V_178 )
goto V_210;
if ( ! F_59 ( & V_1 , & V_366 ) ) {
V_178 = F_78 ( & V_366 ) ;
if ( V_178 ) {
if ( ! F_22 ( & V_366 , & V_56 , & V_201 ) ) {
F_37 ( V_115 -> V_116 , V_16 , V_117 ,
L_44 , V_56 ) ;
F_6 ( V_56 ) ;
}
...
V_178 = - V_14 ;
V_372 = F_40 ( & V_183 , V_369 ) ;
if ( ! V_372 ) {
F_4 ( V_181 L_17 ,
V_182 , V_369 ) ;
goto V_114;
}
V_178 = ( F_125 ( V_371 , V_372 ) ? 0 : - V_230 ) ;
if ( V_178 )
goto V_114;
* V_370 = V_369 ;
V_114:
...
char * V_15 = V_12 , * * V_374 = args ;
int V_21 = V_155 -> V_21 - 1 ;
V_374 [ V_21 ] = F_46 ( V_15 , V_16 ) ;
if ( ! V_374 [ V_21 ] )
return - V_17 ;
return 0 ;
}
int F_127 ( char * * * V_374 , int * V_375 )
{
int V_178 ;
F_39 ( & V_180 ) ;
V_178 = - V_17 ;
* V_375 = V_1 . V_143 . V_144 ;
* V_374 = F_2 ( * V_375 , sizeof( * * V_374 ) , V_16 ) ;
if ( ! * V_374 )
goto V_114;
...
int F_129 ( char * V_376 , char * * * V_25 , int * V_377 )
{
int V_178 , V_10 ;
struct V_100 * V_378 ;
F_39 ( & V_180 ) ;
V_178 = - V_14 ;
V_378 = F_57 ( V_1 . V_143 . V_113 , V_376 ) ;
if ( ! V_378 ) {
F_4 ( V_181 L_45 ,
V_182 , V_376 ) ;
goto V_114;
...
V_178 = - V_17 ;
* V_377 = V_378 -> V_96 . V_144 ;
* V_25 = F_2 ( * V_377 , sizeof( * * V_25 ) , V_16 ) ;
if ( ! * V_25 )
goto V_114;
if ( V_378 -> V_112 ) {
V_178 = F_21 ( V_378 -> V_112 -> V_96 . V_113 ,
F_128 , * V_25 ) ;
if ( V_178 )
goto V_24;
}
V_178 = F_21 ( V_378 -> V_96 . V_113 , F_128 ,
* V_25 ) ;
if ( V_178 )
goto V_24;
V_114:
...
int F_132 ( unsigned int V_379 )
{
int V_178 ;
F_39 ( & V_180 ) ;
V_178 = F_13 ( & V_1 . V_271 , V_379 ) ;
F_41 ( & V_180 ) ;
return V_178 ;
}
void F_133 ( void * V_380 )
{
...
int F_134 ( T_3 V_384 , T_3 V_72 , char * V_385 , void * * V_380 )
{
struct V_381 * V_386 ;
struct V_49 * V_387 ;
struct V_122 * V_388 ;
struct V_215 * V_389 ;
struct V_381 * * V_382 = (struct V_381 * * ) V_380 ;
int V_178 = 0 ;
* V_382 = NULL ;
if ( ! V_179 )
return - V_390 ;
...
V_386 = F_135 ( sizeof( struct V_381 ) , V_227 ) ;
if ( ! V_386 )
return - V_17 ;
F_56 ( & V_386 -> V_383 ) ;
F_39 ( & V_180 ) ;
...
case V_394 :
V_178 = - V_14 ;
V_389 = F_57 ( V_1 . V_219 . V_113 , V_385 ) ;
if ( ! V_389 )
goto V_114;
V_386 -> V_383 . V_67 = V_389 -> V_21 ;
break;
case V_392 :
case V_395 :
V_178 = - V_14 ;
V_387 = F_57 ( V_1 . V_220 . V_113 , V_385 ) ;
if ( ! V_387 )
goto V_114;
V_386 -> V_383 . V_70 = V_387 -> V_21 ;
break;
case V_393 :
case V_396 :
V_178 = - V_14 ;
V_388 = F_57 ( V_1 . V_221 . V_113 , V_385 ) ;
if ( ! V_388 )
goto V_114;
V_386 -> V_383 . type = V_388 -> V_21 ;
break;
case V_399 :
case V_400 :
case V_401 :
case V_402 :
V_178 = F_136 ( V_385 , & V_386 -> V_383 , V_16 ) ;
if ( V_178 )
goto V_114;
break;
}
...
int F_137 ( struct V_404 * V_382 )
{
int V_10 ;
for ( V_10 = 0 ; V_10 < V_382 -> V_405 ; V_10 ++ ) {
struct V_406 * V_407 = & V_382 -> V_408 [ V_10 ] ;
switch ( V_407 -> type ) {
case V_391 :
case V_392 :
case V_393 :
...
int F_138 ( T_3 V_206 , T_3 V_384 , T_3 V_72 , void * V_380 ,
struct V_116 * V_409 )
{
struct V_40 * V_410 ;
struct V_52 * V_79 ;
...
int V_378 = 0 ;
if ( ! V_382 ) {
F_37 ( V_409 , V_16 , V_117 ,
L_46 ) ;
return - V_331 ;
}
F_39 ( & V_180 ) ;
if ( V_382 -> V_403 < V_192 ) {
F_37 ( V_409 , V_16 , V_117 ,
L_47 ) ;
V_378 = - V_411 ;
goto V_114;
}
V_410 = F_40 ( & V_183 , V_206 ) ;
if ( ! V_410 ) {
F_37 ( V_409 , V_16 , V_117 ,
L_48 ,
V_206 ) ;
...
switch ( V_72 ) {
case V_397 :
V_378 = ( V_410 -> V_67 == V_382 -> V_383 . V_67 ) ;
break;
case V_398 :
V_378 = ( V_410 -> V_67 != V_382 -> V_383 . V_67 ) ;
break;
...
switch ( V_72 ) {
case V_397 :
V_378 = ( V_410 -> V_70 == V_382 -> V_383 . V_70 ) ;
break;
case V_398 :
V_378 = ( V_410 -> V_70 != V_382 -> V_383 . V_70 ) ;
break;
...
switch ( V_72 ) {
case V_397 :
V_378 = ( V_410 -> type == V_382 -> V_383 . type ) ;
break;
case V_398 :
V_378 = ( V_410 -> type != V_382 -> V_383 . type ) ;
break;
...
V_79 = ( ( V_384 == V_399 ||
V_384 == V_401 ) ?
& V_410 -> V_78 . V_79 [ 0 ] : & V_410 -> V_78 . V_79 [ 1 ] ) ;
switch ( V_72 ) {
case V_397 :
V_378 = F_14 ( & V_382 -> V_383 . V_78 . V_79 [ 0 ] ,
V_79 ) ;
break;
case V_398 :
V_378 = ! F_14 ( & V_382 -> V_383 . V_78 . V_79 [ 0 ] ,
...
break;
case V_412 :
V_378 = ( F_15 ( & V_382 -> V_383 . V_78 . V_79 [ 0 ] ,
V_79 ) &&
! F_14 ( & V_382 -> V_383 . V_78 . V_79 [ 0 ] ,
V_79 ) ) ;
break;
case V_413 :
V_378 = F_15 ( & V_382 -> V_383 . V_78 . V_79 [ 0 ] ,
...
{
int V_24 ;
V_24 = F_141 ( F_139 , V_417 ) ;
if ( V_24 )
F_142 ( L_49 , V_24 ) ;
return V_24 ;
}
static void F_143 ( struct V_419 * V_420 ,
T_3 V_206 )
{
T_3 * V_421 ;
V_421 = F_48 ( sizeof( * V_421 ) , V_16 ) ;
if ( V_421 == NULL )
return;
V_420 -> V_422 = F_144 ( V_16 ) ;
if ( V_420 -> V_422 == NULL ) {
F_6 ( V_421 ) ;
return;
}
* V_421 = V_206 ;
V_420 -> V_422 -> free = F_6 ;
V_420 -> V_422 -> V_156 = V_421 ;
V_420 -> V_193 |= V_423 ;
}
int F_145 ( struct V_419 * V_420 ,
T_3 * V_206 )
{
int V_178 ;
struct V_40 * V_212 ;
...
F_39 ( & V_180 ) ;
if ( V_420 -> V_193 & V_423 )
* V_206 = * ( T_3 * ) V_420 -> V_422 -> V_156 ;
else if ( V_420 -> V_193 & V_425 )
* V_206 = V_420 -> V_65 . V_426 ;
else if ( V_420 -> V_193 & V_427 ) {
V_178 = - V_428 ;
V_212 = F_40 ( & V_183 , V_429 ) ;
if ( V_212 == NULL )
goto V_114;
F_56 ( & V_424 ) ;
V_424 . V_67 = V_212 -> V_67 ;
V_424 . V_70 = V_212 -> V_70 ;
V_424 . type = V_212 -> type ;
F_146 ( & V_424 , V_420 ) ;
if ( V_420 -> V_193 & V_430 ) {
V_178 = F_147 ( & V_424 . V_78 . V_79 [ 0 ] . V_431 ,
V_420 -> V_65 . V_432 . V_431 ) ;
if ( V_178 )
goto V_114;
memcpy ( & V_424 . V_78 . V_79 [ 1 ] . V_431 ,
& V_424 . V_78 . V_79 [ 0 ] . V_431 ,
sizeof( V_424 . V_78 . V_79 [ 0 ] . V_431 ) ) ;
}
V_178 = - V_428 ;
if ( ! F_148 ( & V_1 , & V_424 ) )
goto V_433;
V_178 = F_62 ( & V_183 , & V_424 , V_206 ) ;
if ( V_178 )
goto V_433;
F_143 ( V_420 , * V_206 ) ;
F_149 ( & V_424 . V_78 . V_79 [ 0 ] . V_431 ) ;
} else
* V_206 = V_226 ;
F_41 ( & V_180 ) ;
return 0 ;
...
int F_150 ( T_3 V_206 , struct V_419 * V_420 )
{
int V_178 ;
struct V_40 * V_212 ;
if ( ! V_179 )
...
goto V_114;
V_178 = - V_17 ;
V_420 -> V_300 = F_46 ( F_20 ( & V_1 , V_205 , V_212 -> type - 1 ) ,
V_16 ) ;
if ( V_420 -> V_300 == NULL )
goto V_114;
V_420 -> V_65 . V_426 = V_206 ;
V_420 -> V_193 |= V_434 | V_425 ;
F_151 ( V_212 , V_420 ) ;
V_178 = F_152 ( V_212 , V_420 ) ;
V_114:
F_41 ( & V_180 ) ;
return V_178 ;
}
...
V_285 . V_201 = * V_201 ;
F_39 ( & V_180 ) ;
V_178 = F_155 ( & V_1 , & V_285 ) ;
F_41 ( & V_180 ) ;
if ( V_178 )
return V_178 ;
* V_201 = ( unsigned long ) V_285 . V_156 - ( unsigned long ) * V_156 ;
return 0 ;
}
