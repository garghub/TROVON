...
static int F_144 ( struct V_168 * V_169 , struct V_14 * V_15 )
{
int V_64 ;
F_22 ( & V_15 -> V_89 ) ;
V_64 = F_145 ( V_169 , V_15 ) ;
F_27 ( & V_15 -> V_89 ) ;
return V_64 ;
}
...
static int F_155 ( struct V_168 * V_169 , const struct V_50 * V_51 )
{
...
int F_145 ( struct V_168 * V_169 , const struct V_14 * V_15 )
{
const struct V_28 * V_29 = V_15 -> V_17 ;
...
F_53 (gh, &gl->gl_holders, gh_list) {
error = F_155 ( V_169 , V_51 ) ;
if ( error )
goto V_94;
}
if ( V_15 -> V_30 != V_31 && V_29 -> V_240 )
error = V_29 -> V_240 ( V_169 , V_15 ) ;
V_94:
return error ;
}
