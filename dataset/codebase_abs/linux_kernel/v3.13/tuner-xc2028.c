...
static int F_29 ( struct V_60 * V_61 , T_1 * V_133 )
{
struct V_1 * V_2 = V_61 -> V_64 ;
T_1 V_134 , signal = 0 ;
int V_67 , V_55 ;
...
static int F_32 ( struct V_60 * V_61 , T_5 * V_138 )
{
struct V_1 * V_2 = V_61 -> V_64 ;
int V_55 , V_67 ;
T_1 V_134 = 0 ;
...
static int F_33 ( struct V_60 * V_61 , T_7 V_141 ,
enum V_142 V_143 ,
unsigned int type ,
T_2 V_115 ,
T_1 V_9 )
...
if ( V_2 -> V_107 . V_151 )
type |= V_22 ;
return F_33 ( V_61 , ( 625l * V_65 -> V_148 ) / 10 ,
V_146 , type , 0 , 0 ) ;
}
if ( ! V_65 -> V_115 )
V_65 -> V_115 = V_152 ;
...
type |= V_12 ;
V_65 -> V_115 |= F_6 () ;
return F_33 ( V_61 , 62500l * V_65 -> V_148 ,
...
F_30 ( & V_172 ) ;
V_182 = F_48 ( struct V_1 , V_2 ,
V_185 ,
V_181 -> V_186 , V_181 -> V_187 ,
L_107 ) ;
switch ( V_182 ) {
case 0 :
goto V_128;
...
memcpy ( & V_61 -> V_188 . V_189 , & V_190 ,
sizeof( V_190 ) ) ;
F_13 ( L_108 , L_109 ) ;
if ( V_181 -> V_107 )
F_44 ( V_61 , V_181 -> V_107 ) ;
F_31 ( & V_172 ) ;
return V_61 ;
V_128:
F_31 ( & V_172 ) ;
