...
static void F_104 ( struct V_1 * V_98 )
{
int V_118 ;
int V_119 = 1 << F_16 ( V_98 ) ;
for ( V_118 = 0 ; V_118 < V_119 ; V_118 ++ )
...
int F_106 ( unsigned long V_29 , int V_28 , int V_30 )
{
struct V_102 * V_103 ;
struct V_1 * V_2 ;
struct V_1 * V_98 ;
...
if ( F_91 ( V_2 ) && F_116 ( V_2 ) && F_110 ( V_98 ) ) {
F_77 ( V_29 , L_26 ,
V_90 ) ;
F_101 ( V_98 ) ;
F_96 ( V_98 ) ;
...
void F_118 ( unsigned long V_29 , int V_28 , int V_30 )
{
struct V_129 * V_130 ;
unsigned long V_131 ;
struct V_132 V_133 = {
...
V_130 = & F_119 ( V_129 ) ;
F_120 ( & V_130 -> V_134 , V_131 ) ;
if ( F_121 ( & V_130 -> V_135 , V_133 ) )
F_122 ( F_123 () , & V_130 -> V_136 ) ;
else
F_78 ( L_29 ,
V_29 ) ;
F_124 ( & V_130 -> V_134 , V_131 ) ;
F_125 ( V_129 ) ;
}
static void F_126 ( struct V_137 * V_136 )
{
struct V_129 * V_130 ;
...
for (; ; ) {
F_120 ( & V_130 -> V_134 , V_131 ) ;
V_138 = F_128 ( & V_130 -> V_135 , & V_133 ) ;
F_124 ( & V_130 -> V_134 , V_131 ) ;
if ( ! V_138 )
break;
if ( V_133 . V_30 & V_139 )
F_129 ( F_109 ( V_133 . V_29 ) , V_133 . V_30 ) ;
else
F_106 ( V_133 . V_29 , V_133 . V_28 , V_133 . V_30 ) ;
}
}
...
int V_140 ;
F_131 (cpu) {
V_130 = & F_132 ( V_129 , V_140 ) ;
F_133 ( & V_130 -> V_134 ) ;
F_134 ( V_130 -> V_135 ) ;
F_135 ( & V_130 -> V_136 , F_126 ) ;
}
return 0 ;
}
int F_136 ( unsigned long V_29 )
{
struct V_1 * V_1 ;
struct V_1 * V_2 ;
int V_141 = 0 ;
...
F_101 ( V_1 ) ;
F_96 ( V_1 ) ;
if ( V_141 && ! ( V_29 == F_138 ( 0 ) && F_28 ( V_2 ) == 1 ) )
F_96 ( V_1 ) ;
return 0 ;
}
static struct V_1 * F_139 ( struct V_1 * V_2 , unsigned long V_142 , int * * V_143 )
{
int V_52 = F_25 ( V_2 ) ;
if ( F_91 ( V_2 ) )
return F_140 ( F_141 ( F_17 ( V_2 ) ) ,
V_52 ) ;
else
return F_142 ( V_52 , V_144 , 0 ) ;
}
static int F_143 ( struct V_1 * V_2 , unsigned long V_29 , int V_30 )
{
int V_33 ;
if ( V_30 & V_124 )
return 1 ;
if ( ! F_112 ( F_17 ( V_2 ) ) ) {
if ( F_91 ( V_2 ) ) {
F_32 ( L_35 , V_145 , V_29 ) ;
V_33 = 0 ;
} else if ( F_24 ( V_2 ) ) {
F_32 ( L_36 , V_145 , V_29 ) ;
V_33 = 0 ;
} else {
F_32 ( L_37 ,
V_145 , V_29 , V_2 -> V_30 ) ;
...
static int F_144 ( struct V_1 * V_1 , unsigned long V_29 , int V_30 )
{
int V_33 = F_143 ( V_1 , V_29 , V_30 ) ;
if ( V_33 == 1 && ! F_91 ( V_1 ) && ! F_22 ( V_1 ) ) {
F_96 ( V_1 ) ;
F_20 ( V_1 , 1 ) ;
V_33 = F_143 ( V_1 , V_29 , 0 ) ;
if ( ! F_22 ( V_1 ) ) {
F_32 ( L_38 ,
V_29 , V_1 -> V_30 ) ;
return - V_89 ;
...
static int F_145 ( struct V_1 * V_1 , int V_30 )
{
int V_33 ;
...
F_101 ( V_98 ) ;
F_146 ( & V_98 -> V_147 , & V_146 ) ;
V_33 = F_147 ( & V_146 , F_139 , V_148 ,
V_149 , V_150 ) ;
if ( V_33 ) {
F_32 ( L_40 ,
V_29 , V_33 , V_1 -> V_30 ) ;
...
static int F_150 ( struct V_1 * V_1 , int V_30 )
{
int V_33 ;
unsigned long V_29 = F_33 ( V_1 ) ;
F_98 ( V_1 ) ;
...
int F_129 ( struct V_1 * V_1 , int V_30 )
{
int V_33 ;
unsigned long V_29 = F_33 ( V_1 ) ;
struct V_1 * V_98 = F_155 ( V_1 ) ;
if ( F_95 ( V_1 ) ) {
F_32 ( L_41 , V_29 ) ;
return - V_106 ;
}
