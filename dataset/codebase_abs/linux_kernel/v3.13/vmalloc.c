...
static int F_208 ( T_2 * V_12 , T_10 V_163 , unsigned long V_10 , void * V_164 )
{
T_2 * * * V_4 = V_164 ;
if ( V_4 ) {
* ( * V_4 ) = V_12 ;
...
struct V_113 * F_209 ( T_8 V_46 , T_2 * * V_165 )
{
struct V_113 * V_119 ;
...
if ( V_38 -> va_end > V_11 ) {
* V_166 = V_38 ;
* V_167 = F_212 ( F_55 ( & ( * V_166 ) -> V_35 ) ) ;
} else {
* V_167 = V_38 ;
* V_166 = F_212 ( F_214 ( & ( * V_167 ) -> V_35 ) ) ;
}
return true ;
}
static unsigned long F_215 ( struct V_34 * * V_166 ,
struct V_34 * * V_167 ,
unsigned long V_47 )
{
...
unsigned long V_10 ;
if ( * V_166 )
V_10 = F_216 ( ( * V_166 ) -> va_start & ~ ( V_47 - 1 ) , V_168 ) ;
else
V_10 = V_168 ;
...
struct V_113 * * F_217 ( const unsigned long * V_169 ,
...
V_174 = F_219 ( V_171 , sizeof( V_174 [ 0 ] ) , V_112 ) ;
V_173 = F_219 ( V_171 , sizeof( V_173 [ 0 ] ) , V_112 ) ;
if ( ! V_173 || ! V_174 )
goto V_182;
...
V_25 = V_169 [ V_119 ] ;
V_11 = V_25 + V_170 [ V_119 ] ;
if ( ! F_213 ( V_71 , & V_17 , & V_44 ) ) {
V_178 = V_168 - V_179 ;
goto V_65;
}
V_178 = F_215 ( & V_17 , & V_44 , V_47 ) - V_11 ;
while ( true ) {
...
void F_220 ( struct V_113 * * V_174 , int V_171 )
{
int V_103 ;
...
static void * F_221 ( struct V_184 * V_185 , T_11 * V_186 )
__acquires( &vmap_area_lock
static void * F_222 ( struct V_184 * V_185 , void * V_4 , T_11 * V_186 )
{
struct V_34 * V_38 = V_4 , * V_17 ;
++ * V_186 ;
V_17 = F_66 ( V_38 -> V_8 . V_17 , F_223 ( * V_38 ) , V_8 ) ;
if ( & V_17 -> V_8 != & V_45 )
return V_17 ;
return NULL ;
}
static void F_224 ( struct V_184 * V_185 , void * V_4 )
__releases( &vmap_area_lock
static void F_225 ( struct V_184 * V_185 , struct V_113 * V_187 )
{
if ( F_226 ( V_188 ) ) {
...
V_189 [ F_228 ( V_187 -> V_21 [ V_22 ] ) ] ++ ;
F_229 (nr, N_HIGH_MEMORY)
if ( V_189 [ V_22 ] )
F_230 ( V_185 , L_7 , V_22 , V_189 [ V_22 ] ) ;
}
}
static int F_231 ( struct V_184 * V_185 , void * V_4 )
{
...
if ( V_187 -> V_120 )
F_230 ( V_185 , L_9 , V_187 -> V_120 ) ;
if ( V_187 -> V_127 )
F_230 ( V_185 , L_10 , V_187 -> V_127 ) ;
if ( V_187 -> V_192 )
F_230 ( V_185 , L_11 , ( unsigned long long ) V_187 -> V_192 ) ;
if ( V_187 -> V_66 & V_122 )
F_230 ( V_185 , L_12 ) ;
if ( V_187 -> V_66 & V_139 )
F_230 ( V_185 , L_13 ) ;
...
static int F_233 ( struct V_194 * V_194 , struct V_195 * V_195 )
{
unsigned int * V_196 = NULL ;
int V_27 ;
if ( F_226 ( V_188 ) ) {
V_196 = F_234 ( V_191 * sizeof( unsigned int ) , V_112 ) ;
if ( V_196 == NULL )
return - V_23 ;
}
V_27 = F_235 ( V_195 , & V_197 ) ;
if ( ! V_27 ) {
...
{
F_237 ( L_17 , V_199 , NULL , & V_200 ) ;
return 0 ;
}
void F_238 ( struct V_201 * V_202 )
{
struct V_34 * V_38 ;
unsigned long V_203 ;
unsigned long V_204 ;
