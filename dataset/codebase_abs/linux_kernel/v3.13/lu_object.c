...
int V_44 ;
int V_45 ;
V_8 = V_37 -> V_46 -> V_47 ( V_2 , NULL , V_37 ) ;
if ( V_8 == NULL )
return F_24 ( - V_48 ) ;
if ( F_25 ( V_8 ) )
return V_8 ;
...
V_44 = 0 ;
V_41 -> V_16 = V_8 -> V_16 ;
V_45 = V_41 -> V_24 -> V_52 ( V_2 , V_41 , V_40 ) ;
if ( V_45 != 0 ) {
F_8 ( V_2 , V_8 ) ;
return F_24 ( V_45 ) ;
}
...
V_4 -> V_17 -> V_98 -> V_99 , V_4 ) ;
if ( V_4 -> V_24 -> V_100 != NULL )
V_4 -> V_24 -> V_100 ( V_2 , V_77 , V_90 , V_4 ) ;
(* V_90)( V_2 , V_77 , L_11 ) ;
}
...
* V_103 = V_106 ;
V_6 = F_10 ( V_61 -> V_26 , V_13 ) ;
V_105 = F_55 ( V_61 -> V_26 , V_13 , ( void * ) V_38 ) ;
if ( V_105 == NULL ) {
F_27 ( V_61 -> V_54 , V_108 ) ;
return F_24 ( - V_107 ) ;
}
V_63 = F_31 ( V_105 , struct V_7 , V_19 ) ;
if ( F_56 ( ! F_12 ( V_63 ) ) ) {
F_57 ( V_61 -> V_26 , V_105 ) ;
F_27 ( V_61 -> V_54 , V_109 ) ;
F_22 ( & V_63 -> V_22 ) ;
return F_42 ( V_63 ) ;
}
F_58 ( V_102 ) ;
...
V_114 = V_61 -> V_26 ;
F_21 ( V_114 , ( void * ) V_38 , & V_13 , 1 ) ;
V_4 = F_53 ( V_61 , & V_13 , V_38 , V_102 , & V_103 ) ;
F_15 ( V_114 , & V_13 , 1 ) ;
if ( ! F_25 ( V_4 ) || F_67 ( V_4 ) != - V_107 )
return V_4 ;
V_4 = F_23 ( V_2 , V_37 , V_38 , V_40 ) ;
if ( F_64 ( F_25 ( V_4 ) ) )
return V_4 ;
...
F_37 ( V_114 , & V_13 , 1 ) ;
V_115 = F_53 ( V_61 , & V_13 , V_38 , V_102 , & V_103 ) ;
if ( F_56 ( F_25 ( V_115 ) && F_67 ( V_115 ) == - V_107 ) ) {
struct V_5 * V_6 ;
V_6 = F_10 ( V_114 , & V_13 ) ;
F_65 ( V_114 , & V_13 , & V_4 -> V_16 -> V_19 ) ;
V_6 -> V_29 ++ ;
...
struct V_104 * V_105 , void * V_130 )
{
struct V_131 * V_132 = (struct V_131 * ) V_130 ;
struct V_7 * V_63 ;
V_63 = F_78 ( V_105 , struct V_7 , V_19 ) ;
if ( ! F_5 ( & V_63 -> V_49 ) ) {
...
{
return F_78 ( V_105 , struct V_7 , V_19 ) ;
}
static void * F_89 ( struct V_104 * V_105 )
{
struct V_7 * V_63 ;
V_63 = F_78 ( V_105 , struct V_7 , V_19 ) ;
return & V_63 -> V_27 ;
}
static int F_90 ( const void * V_82 , struct V_104 * V_105 )
{
struct V_7 * V_63 ;
V_63 = F_78 ( V_105 , struct V_7 , V_19 ) ;
return F_68 ( & V_63 -> V_27 , (struct V_14 * ) V_82 ) ;
}
static void F_91 ( struct V_34 * V_114 , struct V_104 * V_105 )
{
struct V_7 * V_63 ;
V_63 = F_78 ( V_105 , struct V_7 , V_19 ) ;
...
static void F_93 ( struct V_34 * V_114 , struct V_104 * V_105 )
{
F_94 () ;
}
...
V_137 = F_81 () ;
snprintf ( V_153 , 16 , L_15 , V_8 -> V_98 -> V_99 ) ;
...
V_20 = V_41 -> V_98 -> V_124 -> V_177 ( V_2 , V_41 ) ;
F_114 ( & V_41 -> V_164 , L_26 , & F_99 ) ;
F_115 ( V_41 ) ;
}
F_33 ( V_2 , V_10 , ~ 0 ) ;
for ( V_41 = V_8 ; V_41 != NULL ; V_41 = V_20 ) {
const struct V_121 * V_122 = V_41 -> V_98 ;
struct V_178 * type ;
...
int V_45 ;
V_45 = F_118 ( & V_2 -> V_85 ) ;
if ( V_45 == 0 && V_2 -> V_218 != NULL )
V_45 = F_118 ( V_2 -> V_218 ) ;
return V_45 ;
}
...
for ( V_45 = 0 ; V_256 -> V_257 != NULL ; ++ V_256 ) {
...
V_115 = F_53 ( V_61 , & V_13 , V_15 , & V_102 , & V_103 ) ;
F_4 ( F_25 ( V_115 ) && F_67 ( V_115 ) == - V_107 ) ;
* V_260 = * V_15 ;
V_6 = F_10 ( V_114 , & V_13 ) ;
F_65 ( V_114 , & V_13 , & V_4 -> V_16 -> V_19 ) ;
V_6 -> V_29 ++ ;
