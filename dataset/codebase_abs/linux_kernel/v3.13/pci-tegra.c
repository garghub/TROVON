...
static void F_52 ( struct V_43 * V_26 )
{
if ( F_53 ( V_91 ) ) {
struct V_4 * V_8 = F_3 ( V_26 -> V_44 ) ;
...
static struct V_43 * F_54 ( int V_32 , struct V_5 * V_6 )
{
struct V_4 * V_8 = F_3 ( V_6 ) ;
struct V_43 * V_26 ;
V_26 = F_55 ( V_8 -> V_40 , V_6 -> V_16 , & V_93 , V_6 ,
& V_6 -> V_82 ) ;
if ( ! V_26 )
return NULL ;
F_56 ( V_26 ) ;
...
static T_7 F_57 ( int V_90 , void * V_94 )
{
const char * V_95 [] = {
L_3 ,
L_4 ,
...
{
const struct V_63 * V_64 = V_8 -> V_65 ;
V_8 -> V_181 = F_75 ( V_8 -> V_40 , L_25 ) ;
if ( F_24 ( V_8 -> V_181 ) )
return F_76 ( V_8 -> V_181 ) ;
V_8 -> V_180 = F_75 ( V_8 -> V_40 , L_26 ) ;
if ( F_24 ( V_8 -> V_180 ) )
return F_76 ( V_8 -> V_180 ) ;
V_8 -> V_164 = F_75 ( V_8 -> V_40 , L_27 ) ;
if ( F_24 ( V_8 -> V_164 ) )
return F_76 ( V_8 -> V_164 ) ;
V_8 -> V_189 = F_75 ( V_8 -> V_40 , L_28 ) ;
if ( F_24 ( V_8 -> V_189 ) )
return F_76 ( V_8 -> V_189 ) ;
if ( V_64 -> V_187 ) {
V_8 -> V_188 = F_75 ( V_8 -> V_40 , L_29 ) ;
if ( F_24 ( V_8 -> V_188 ) )
return F_76 ( V_8 -> V_188 ) ;
}
return 0 ;
}
static int F_77 ( struct V_4 * V_8 )
{
struct V_190 * V_88 = F_78 ( V_8 -> V_40 ) ;
...
V_12 = F_79 ( V_88 , V_193 , L_32 ) ;
V_8 -> V_12 = F_80 ( & V_88 -> V_40 , V_12 ) ;
if ( F_24 ( V_8 -> V_12 ) ) {
V_28 = F_76 ( V_8 -> V_12 ) ;
goto V_194;
}
V_11 = F_79 ( V_88 , V_193 , L_26 ) ;
V_8 -> V_11 = F_80 ( & V_88 -> V_40 , V_11 ) ;
if ( F_24 ( V_8 -> V_11 ) ) {
V_28 = F_76 ( V_8 -> V_11 ) ;
goto V_194;
}
V_192 = F_79 ( V_88 , V_193 , L_33 ) ;
if ( ! V_192 ) {
V_28 = - V_195 ;
goto V_194;
}
V_8 -> V_24 = F_81 ( V_8 -> V_40 , V_192 -> V_25 ,
...
V_28 = F_82 ( V_88 , L_34 ) ;
if ( V_28 < 0 ) {
F_19 ( & V_88 -> V_40 , L_35 , V_28 ) ;
goto V_194;
}
V_8 -> V_90 = V_28 ;
V_28 = F_83 ( V_8 -> V_90 , F_57 , V_197 , L_36 , V_8 ) ;
if ( V_28 ) {
F_19 ( & V_88 -> V_40 , L_37 , V_28 ) ;
goto V_194;
}
return 0 ;
V_194:
...
static void F_91 ( struct V_1 * V_3 , unsigned long V_90 )
{
struct V_202 * V_40 = V_3 -> V_3 . V_40 ;
F_87 ( & V_3 -> V_198 ) ;
if ( ! F_92 ( V_90 , V_3 -> V_199 ) )
F_19 ( V_40 , L_38 , V_90 ) ;
else
F_93 ( V_90 , V_3 -> V_199 ) ;
F_90 ( & V_3 -> V_198 ) ;
}
static T_7 F_94 ( int V_90 , void * V_203 )
{
...
while ( V_71 ) {
unsigned int V_10 = F_95 ( & V_71 , 32 ) ;
unsigned int V_49 = V_27 * 32 + V_10 ;
unsigned int V_90 ;
F_4 ( V_8 , 1 << V_10 , V_205 + V_27 * 4 ) ;
V_90 = F_96 ( V_92 -> V_206 , V_49 ) ;
if ( V_90 ) {
if ( F_92 ( V_49 , V_92 -> V_199 ) )
F_97 ( V_90 ) ;
else
F_98 ( V_8 -> V_40 , L_39 ) ;
} else {
...
static int F_99 ( struct V_2 * V_3 , struct V_70 * V_88 ,
struct V_207 * V_208 )
{
...
if ( V_211 < 0 )
return V_211 ;
V_90 = F_100 ( V_92 -> V_206 , V_211 ) ;
if ( ! V_90 )
return - V_212 ;
F_101 ( V_90 , V_208 ) ;
V_210 . V_213 = F_102 ( ( void * ) V_92 -> V_214 ) ;
V_210 . V_215 = 0 ;
V_210 . V_203 = V_211 ;
F_103 ( V_90 , & V_210 ) ;
return 0 ;
}
static void F_104 ( struct V_2 * V_3 , unsigned int V_90 )
{
struct V_1 * V_92 = F_1 ( V_3 ) ;
struct V_216 * V_217 = F_105 ( V_90 ) ;
F_91 ( V_92 , V_217 -> V_211 ) ;
}
static int F_106 ( struct V_218 * V_206 , unsigned int V_90 ,
T_9 V_211 )
{
F_107 ( V_90 , & V_219 , V_220 ) ;
F_108 ( V_90 , V_206 -> V_221 ) ;
F_109 ( V_90 , V_222 ) ;
F_51 () ;
return 0 ;
}
static int F_110 ( struct V_4 * V_8 )
{
struct V_190 * V_88 = F_78 ( V_8 -> V_40 ) ;
const struct V_63 * V_64 = V_8 -> V_65 ;
struct V_1 * V_92 = & V_8 -> V_92 ;
...
V_92 -> V_3 . V_223 = F_99 ;
V_92 -> V_3 . V_224 = F_104 ;
V_92 -> V_206 = F_112 ( V_8 -> V_40 -> V_225 , V_200 ,
& V_226 , & V_92 -> V_3 ) ;
if ( ! V_92 -> V_206 ) {
F_19 ( & V_88 -> V_40 , L_41 ) ;
return - V_30 ;
...
V_92 -> V_90 = V_28 ;
V_28 = F_83 ( V_92 -> V_90 , F_94 , 0 ,
V_219 . V_196 , V_8 ) ;
if ( V_28 < 0 ) {
F_19 ( & V_88 -> V_40 , L_43 , V_28 ) ;
goto V_28;
}
V_92 -> V_214 = F_113 ( V_29 , 0 ) ;
V_50 = F_102 ( ( void * ) V_92 -> V_214 ) ;
...
static int F_115 ( struct V_4 * V_8 )
{
struct V_1 * V_92 = & V_8 -> V_92 ;
...
static int F_118 ( struct V_4 * V_8 , T_1 V_237 ,
T_1 * V_238 )
{
...
static int F_120 ( struct V_4 * V_8 )
{
const struct V_63 * V_64 = V_8 -> V_65 ;
...
T_1 V_237 = 0 ;
int V_28 ;
if ( F_121 ( & V_247 , V_240 ) ) {
F_19 ( V_8 -> V_40 , L_51 ) ;
return - V_212 ;
}
V_8 -> V_186 = F_122 ( V_8 -> V_40 , L_52 ) ;
if ( F_24 ( V_8 -> V_186 ) )
return F_76 ( V_8 -> V_186 ) ;
V_8 -> V_185 = F_122 ( V_8 -> V_40 , L_53 ) ;
if ( F_24 ( V_8 -> V_185 ) )
return F_76 ( V_8 -> V_185 ) ;
if ( V_64 -> V_183 ) {
V_8 -> V_184 = F_122 ( V_8 -> V_40 , L_54 ) ;
if ( F_24 ( V_8 -> V_184 ) )
return F_76 ( V_8 -> V_184 ) ;
}
F_123 (&parser, &range) {
F_124 ( & V_249 , V_240 , & V_192 ) ;
switch ( V_192 . V_250 & V_251 ) {
case V_252 :
memcpy ( & V_8 -> V_87 , & V_192 , sizeof( V_192 ) ) ;
V_8 -> V_87 . V_196 = L_55 ;
break;
case V_193 :
if ( V_192 . V_250 & V_253 ) {
...
F_19 ( V_8 -> V_40 , L_60 , V_49 ) ;
return - V_212 ;
}
V_49 -- ;
V_28 = F_128 ( V_48 , L_61 , & V_9 ) ;
if ( V_28 < 0 ) {
F_19 ( V_8 -> V_40 , L_62 ,
V_28 ) ;
return V_28 ;
...
if ( V_9 > 16 ) {
F_19 ( V_8 -> V_40 , L_63 , V_9 ) ;
return - V_212 ;
}
V_237 |= V_9 << ( V_49 << 3 ) ;
if ( ! F_129 ( V_48 ) )
continue;
V_256 = F_130 ( V_8 -> V_40 , sizeof( * V_256 ) , V_29 ) ;
if ( ! V_256 )
return - V_30 ;
V_28 = F_131 ( V_48 , 0 , & V_256 -> V_69 ) ;
if ( V_28 < 0 ) {
F_19 ( V_8 -> V_40 , L_59 ,
V_28 ) ;
return V_28 ;
...
V_256 -> V_237 = V_9 ;
V_256 -> V_8 = V_8 ;
V_256 -> V_50 = F_80 ( V_8 -> V_40 , & V_256 -> V_69 ) ;
if ( F_24 ( V_256 -> V_50 ) )
return F_76 ( V_256 -> V_50 ) ;
F_25 ( & V_256 -> V_31 , & V_8 -> V_257 ) ;
}
V_28 = F_118 ( V_8 , V_237 , & V_8 -> V_144 ) ;
if ( V_28 < 0 ) {
F_19 ( V_8 -> V_40 , L_64 ) ;
return V_28 ;
}
...
static bool F_132 ( struct V_47 * V_48 )
{
unsigned int V_258 = 3 ;
unsigned long V_9 ;
do {
unsigned int V_138 = V_259 ;
do {
V_9 = F_7 ( V_48 -> V_50 + V_260 ) ;
if ( V_9 & V_261 )
break;
F_31 ( 1000 , 2000 ) ;
} while ( -- V_138 );
if ( ! V_138 ) {
F_19 ( V_48 -> V_8 -> V_40 , L_65 ,
V_48 -> V_49 ) ;
goto V_262;
}
V_138 = V_259 ;
do {
V_9 = F_7 ( V_48 -> V_50 + V_263 ) ;
if ( V_9 & V_264 )
return true ;
F_31 ( 1000 , 2000 ) ;
} while ( -- V_138 );
...
struct V_265 V_266 ;
F_134 (port, tmp, &pcie->ports, list) {
F_98 ( V_8 -> V_40 , L_66 ,
V_48 -> V_49 , V_48 -> V_237 ) ;
F_32 ( V_48 ) ;
if ( F_132 ( V_48 ) )
continue;
F_98 ( V_8 -> V_40 , L_67 , V_48 -> V_49 ) ;
F_33 ( V_48 ) ;
F_34 ( V_48 ) ;
}
...
V_266 . V_271 = F_54 ;
V_266 . V_272 = & V_93 ;
F_135 ( V_8 -> V_40 , & V_266 ) ;
return 0 ;
}
static int F_136 ( struct V_190 * V_88 )
{
const struct V_273 * V_274 ;
struct V_4 * V_8 ;
int V_28 ;
V_274 = F_137 ( V_275 , & V_88 -> V_40 ) ;
if ( ! V_274 )
return - V_276 ;
V_8 = F_130 ( & V_88 -> V_40 , sizeof( * V_8 ) , V_29 ) ;
if ( ! V_8 )
return - V_30 ;
F_16 ( & V_8 -> V_42 ) ;
F_16 ( & V_8 -> V_257 ) ;
V_8 -> V_65 = V_274 -> V_203 ;
V_8 -> V_40 = & V_88 -> V_40 ;
V_28 = F_120 ( V_8 ) ;
if ( V_28 < 0 )
return V_28 ;
