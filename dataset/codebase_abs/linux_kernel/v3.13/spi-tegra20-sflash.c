...
{
struct V_97 * V_98 = V_2 -> V_81 -> V_99 ;
if ( F_34 ( V_98 , L_6 ,
& V_2 -> V_70 ) )
V_2 -> V_70 = 25000000 ;
}
...
V_105 = F_36 ( V_106 , & V_101 -> V_81 ) ;
if ( ! V_105 ) {
F_21 ( & V_101 -> V_81 , L_7 ) ;
return - V_107 ;
}
V_46 = F_37 ( & V_101 -> V_81 , sizeof( * V_2 ) ) ;
if ( ! V_46 ) {
F_21 ( & V_101 -> V_81 , L_8 ) ;
return - V_108 ;
}
...
F_39 ( & V_2 -> V_89 ) ;
F_33 ( V_2 ) ;
V_103 = F_40 ( V_101 , V_116 , 0 ) ;
V_2 -> V_4 = F_41 ( & V_101 -> V_81 , V_103 ) ;
if ( F_42 ( V_2 -> V_4 ) ) {
V_77 = F_43 ( V_2 -> V_4 ) ;
goto V_117;
}
V_2 -> V_93 = F_44 ( V_101 , 0 ) ;
...
V_2 -> V_51 = F_47 ( & V_101 -> V_81 , NULL ) ;
if ( F_42 ( V_2 -> V_51 ) ) {
F_21 ( & V_101 -> V_81 , L_10 ) ;
V_77 = F_43 ( V_2 -> V_51 ) ;
goto V_118;
}
F_48 ( & V_2 -> V_80 ) ;
F_49 ( & V_101 -> V_81 ) ;
if ( ! F_50 ( & V_101 -> V_81 ) ) {
V_77 = F_51 ( & V_101 -> V_81 ) ;
if ( V_77 )
goto V_119;
}
V_77 = F_52 ( & V_101 -> V_81 ) ;
if ( V_77 < 0 ) {
F_21 ( & V_101 -> V_81 , L_11 , V_77 ) ;
goto V_119;
}
F_28 ( V_2 -> V_51 ) ;
F_24 ( 2 ) ;
F_29 ( V_2 -> V_51 ) ;
V_2 -> V_54 = V_120 | V_121 ;
F_3 ( V_2 , V_2 -> V_54 , V_68 ) ;
F_53 ( & V_101 -> V_81 ) ;
V_46 -> V_81 . V_99 = V_101 -> V_81 . V_99 ;
V_77 = F_54 ( & V_101 -> V_81 , V_46 ) ;
if ( V_77 < 0 ) {
F_21 ( & V_101 -> V_81 , L_12 , V_77 ) ;
goto V_119;
}
return V_77 ;
V_119:
...
static int F_60 ( struct V_100 * V_101 )
{
struct V_71 * V_46 = F_61 ( V_101 ) ;
struct V_1 * V_2 = F_13 ( V_46 ) ;
F_58 ( V_2 -> V_93 , V_2 ) ;
F_55 ( & V_101 -> V_81 ) ;
if ( ! F_56 ( & V_101 -> V_81 ) )
...
static int F_62 ( struct V_122 * V_81 )
{
struct V_71 * V_46 = F_63 ( V_81 ) ;
return F_64 ( V_46 ) ;
}
static int F_65 ( struct V_122 * V_81 )
{
struct V_71 * V_46 = F_63 ( V_81 ) ;
struct V_1 * V_2 = F_13 ( V_46 ) ;
int V_77 ;
...
static int F_57 ( struct V_122 * V_81 )
{
struct V_71 * V_46 = F_63 ( V_81 ) ;
struct V_1 * V_2 = F_13 ( V_46 ) ;
F_1 ( V_2 , V_68 ) ;
...
static int F_51 ( struct V_122 * V_81 )
{
struct V_71 * V_46 = F_63 ( V_81 ) ;
struct V_1 * V_2 = F_13 ( V_46 ) ;
int V_77 ;
