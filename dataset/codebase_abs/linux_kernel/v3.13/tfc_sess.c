...
int F_38 ( struct V_39 * V_32 )
{
struct V_24 * V_27 = V_32 -> V_40 ;
F_25 ( L_4 , V_27 -> V_22 ) ;
return 1 ;
}
void F_39 ( struct V_39 * V_32 )
{
struct V_24 * V_27 = V_32 -> V_40 ;
T_1 V_22 ;
F_13 ( & V_10 ) ;
...
T_1 F_41 ( struct V_39 * V_32 )
{
struct V_24 * V_27 = V_32 -> V_40 ;
return V_27 -> V_22 ;
}
T_1 F_42 ( struct V_39 * V_32 ,
unsigned char * V_41 , T_1 V_42 )
{
struct V_24 * V_27 = V_32 -> V_40 ;
return F_43 ( V_41 , V_42 , V_27 -> V_43 ) ;
}
...
if ( ! ( V_50 & V_59 ) )
return V_63 ;
V_27 = F_26 ( V_6 , V_45 -> V_64 . V_22 , V_31 ) ;
if ( ! V_27 )
return V_65 ;
if ( ! V_27 -> V_38 )
V_45 -> V_66 ++ ;
V_27 -> V_38 = V_50 ;
V_27 -> V_43 = V_45 -> V_64 . V_43 ;
V_27 -> V_67 = V_45 -> V_68 ;
}
V_53:
V_50 = F_46 ( V_49 -> V_58 ) ;
...
static void F_55 ( struct V_2 * V_3 , struct V_74 * V_75 )
{
struct V_24 * V_27 ;
T_1 V_76 = F_56 ( V_75 ) ;
F_25 ( L_6 , V_76 ) ;
