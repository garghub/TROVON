...
static int F_29 ( struct V_58 * V_59 , unsigned long V_60 ,
void * V_61 )
{
struct V_16 * V_17 = F_30 ( V_61 ) ;
struct V_20 * V_30 = & V_43 [ 0 ] ;
struct V_20 * V_44 = & V_43 [ V_45 ] ;
if ( ! F_13 ( F_14 ( V_17 ) , & V_32 ) )
return V_62 ;
...
static int F_35 ( struct V_3 * V_4 , char * V_71 , int V_72 )
{
if ( V_72 < 18 )
return 1 ;
...
static int F_36 ( struct V_3 * V_4 , char * V_73 )
{
memset ( V_73 , 0 , V_74 ) ;
V_73 [ V_75 ] = V_9 ;
memcpy ( V_73 + V_76 , V_4 -> V_6 , V_7 ) ;
return 0 ;
}
