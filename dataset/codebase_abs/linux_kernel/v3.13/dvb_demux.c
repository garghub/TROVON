...
static inline int F_27 ( const T_2 * V_1 , int V_81 , T_4 V_12 ,
const int V_82 )
{
int V_83 = V_81 , V_84 ;
while ( V_81 < V_12 ) {
if ( V_1 [ V_81 ] == 0x47 ||
( V_82 == 204 && V_1 [ V_81 ] == 0xB8 ) )
break;
V_81 ++ ;
}
V_84 = V_81 - V_83 ;
if ( V_84 ) {
int V_85 = V_81 - V_82 ;
if ( V_85 >= 0 && ( V_1 [ V_85 ] == 0x47 ||
( V_82 == 204 && V_1 [ V_85 ] == 0xB8 ) ) )
return V_85 ;
}
return V_81 ;
}
static inline void F_28 ( struct V_30 * V_31 , const T_2 * V_1 ,
T_4 V_12 , const int V_82 )
{
int V_13 = 0 , V_20 , V_86 ;
const T_2 * V_87 ;
unsigned long V_79 ;
F_25 ( & V_31 -> V_80 , V_79 ) ;
if ( V_31 -> V_88 ) {
...
V_86 = V_82 - V_20 ;
if ( V_12 < V_86 ) {
memcpy ( & V_31 -> V_89 [ V_20 ] , V_1 , V_12 ) ;
V_31 -> V_88 += V_12 ;
goto V_90;
}
memcpy ( & V_31 -> V_89 [ V_20 ] , V_1 , V_86 ) ;
if ( V_31 -> V_89 [ 0 ] == 0x47 )
F_16 ( V_31 , V_31 -> V_89 ) ;
V_31 -> V_88 = 0 ;
V_13 += V_86 ;
...
while ( 1 ) {
V_13 = F_27 ( V_1 , V_13 , V_12 , V_82 ) ;
if ( V_13 >= V_12 )
break;
if ( V_12 - V_13 < V_82 )
break;
V_87 = & V_1 [ V_13 ] ;
if ( V_82 == 204 && ( * V_87 == 0xB8 ) ) {
memcpy ( V_31 -> V_89 , V_87 , 188 ) ;
V_31 -> V_89 [ 0 ] = 0x47 ;
V_87 = V_31 -> V_89 ;
}
F_16 ( V_31 , V_87 ) ;
...
V_20 = V_12 - V_13 ;
if ( V_20 ) {
memcpy ( V_31 -> V_89 , & V_1 [ V_13 ] , V_20 ) ;
V_31 -> V_88 = V_20 ;
if ( V_82 == 204 && V_31 -> V_89 [ 0 ] == 0xB8 )
V_31 -> V_89 [ 0 ] = 0x47 ;
}
V_90:
F_26 ( & V_31 -> V_80 , V_79 ) ;
...
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_31 -> V_91 ; V_20 ++ )
if ( V_31 -> V_23 [ V_20 ] . V_92 == V_93 )
break;
if ( V_20 == V_31 -> V_91 )
return NULL ;
V_31 -> V_23 [ V_20 ] . V_92 = V_94 ;
return & V_31 -> V_23 [ V_20 ] ;
}
static struct V_3 * F_33 ( struct V_30 * V_31 )
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_31 -> V_95 ; V_20 ++ )
if ( V_31 -> V_7 [ V_20 ] . V_92 == V_93 )
break;
if ( V_20 == V_31 -> V_95 )
return NULL ;
V_31 -> V_7 [ V_20 ] . V_92 = V_94 ;
...
if ( F_34 ( V_7 ) ) {
F_12 ( V_97 L_13 ,
V_98 , V_7 -> type , V_7 -> V_92 , V_7 -> V_61 ) ;
goto V_99;
}
F_37 ( & V_7 -> V_100 , & V_7 -> V_31 -> V_101 ) ;
V_99:
F_38 ( & V_7 -> V_31 -> V_80 ) ;
}
...
static int F_41 ( struct V_102 * V_103 , T_1 V_61 , int V_55 ,
enum V_104 V_105 ,
T_4 V_106 , struct V_64 V_107 )
{
struct V_3 * V_7 = (struct V_3 * ) V_103 ;
struct V_30 * V_31 = V_7 -> V_31 ;
if ( V_61 > V_108 )
return - V_109 ;
if ( F_42 ( & V_31 -> V_110 ) )
...
if ( V_31 -> V_113 [ V_105 ] &&
V_31 -> V_113 [ V_105 ] != V_7 ) {
F_43 ( & V_31 -> V_110 ) ;
return - V_109 ;
}
V_31 -> V_113 [ V_105 ] = V_7 ;
V_31 -> V_114 [ V_105 ] = V_61 ;
}
F_35 ( V_7 ) ;
V_7 -> V_61 = V_61 ;
V_7 -> V_115 = V_106 ;
...
if ( F_42 ( & V_31 -> V_110 ) )
return - V_111 ;
if ( V_7 -> V_92 != V_118 || V_7 -> type != V_54 ) {
F_43 ( & V_31 -> V_110 ) ;
return - V_109 ;
}
if ( ! V_31 -> V_120 ) {
...
T_6 V_126 )
{
struct V_30 * V_31 = (struct V_30 * ) V_125 ;
struct V_3 * V_7 ;
if ( F_42 ( & V_31 -> V_110 ) )
return - V_111 ;
if ( ! ( V_7 = F_33 ( V_31 ) ) ) {
...
F_39 ( V_7 ) ;
V_7 -> V_61 = 0xffff ;
if ( V_7 -> V_55 & V_58 && V_7 -> V_105 < V_112 )
V_31 -> V_113 [ V_7 -> V_105 ] = NULL ;
F_43 ( & V_31 -> V_110 ) ;
return 0 ;
}
...
struct V_133 * * V_23 )
{
struct V_3 * V_134 = (struct V_3 * ) V_7 ;
struct V_30 * V_135 = V_134 -> V_31 ;
struct V_18 * V_136 ;
if ( F_42 ( & V_135 -> V_110 ) )
return - V_111 ;
V_136 = F_32 ( V_135 ) ;
...
V_134 -> V_61 = V_61 ;
V_134 -> V_115 = V_106 ;
V_134 -> V_7 . V_8 . V_35 = V_35 ;
#ifdef F_44
V_134 -> V_116 = NULL ;
#else
V_134 -> V_116 = F_45 ( V_134 -> V_115 ) ;
if ( ! V_134 -> V_116 ) {
F_43 ( & V_137 -> V_110 ) ;
return - V_117 ;
}
...
static void F_54 ( struct V_3 * V_134 )
{
int V_20 ;
struct V_18 * V_4 ;
struct V_133 * V_138 ;
T_2 V_139 , V_140 , V_28 ;
if ( ! ( V_4 = V_134 -> V_23 ) )
return;
do {
V_138 = & V_4 -> V_23 ;
V_28 = 0 ;
for ( V_20 = 0 ; V_20 < V_21 ; V_20 ++ ) {
V_140 = V_138 -> V_141 [ V_20 ] ;
V_139 = V_138 -> V_142 [ V_20 ] ;
V_4 -> V_26 [ V_20 ] = V_139 & V_140 ;
V_28 |= V_4 -> V_27 [ V_20 ] = V_139 & ~ V_140 ;
}
V_4 -> V_28 = V_28 ? 1 : 0 ;
} while ( ( V_4 = V_4 -> V_37 ) );
}
...
V_134 -> V_7 . V_8 . V_39 = 0 ;
V_134 -> V_7 . V_8 . V_25 = V_134 -> V_7 . V_8 . V_41 ;
V_134 -> V_7 . V_8 . V_38 = 0 ;
V_134 -> V_7 . V_8 . V_29 = 0 ;
if ( ! V_137 -> V_120 ) {
F_43 ( & V_137 -> V_110 ) ;
return - V_121 ;
}
F_54 ( V_134 ) ;
if ( ( V_119 = V_137 -> V_120 ( V_134 ) ) < 0 ) {
F_43 ( & V_137 -> V_110 ) ;
return V_119 ;
}
F_36 ( & V_137 -> V_80 ) ;
...
struct V_133 * V_23 )
{
struct V_18 * V_136 = (struct V_18 * ) V_23 , * V_4 ;
struct V_3 * V_134 = (struct V_3 * ) V_7 ;
struct V_30 * V_137 = V_134 -> V_31 ;
F_48 ( & V_137 -> V_110 ) ;
if ( V_136 -> V_7 != V_134 ) {
...
V_4 = V_134 -> V_23 ;
if ( V_4 == V_136 ) {
V_134 -> V_23 = V_136 -> V_37 ;
} else {
while ( V_4 -> V_37 != V_136 )
V_4 = V_4 -> V_37 ;
...
static int F_58 ( struct V_124 * V_31 ,
struct V_32 * * V_7 ,
T_7 V_126 )
{
struct V_30 * V_137 = (struct V_30 * ) V_31 ;
struct V_3 * V_134 ;
if ( F_42 ( & V_137 -> V_110 ) )
return - V_111 ;
if ( ! ( V_134 = F_33 ( V_137 ) ) ) {
...
V_134 -> type = V_60 ;
V_134 -> V_15 . V_8 = V_126 ;
V_134 -> V_31 = V_137 ;
V_134 -> V_61 = 0xffff ;
V_134 -> V_7 . V_8 . V_25 = V_134 -> V_7 . V_8 . V_41 ;
V_134 -> V_7 . V_8 . V_38 = V_134 -> V_7 . V_8 . V_29 = 0 ;
V_134 -> V_7 . V_8 . V_39 = 0 ;
V_134 -> V_23 = NULL ;
V_134 -> V_116 = NULL ;
( * V_7 ) = & V_134 -> V_7 . V_8 ;
...
static int F_59 ( struct V_124 * V_31 ,
struct V_32 * V_7 )
{
struct V_3 * V_134 = (struct V_3 * ) V_7 ;
struct V_30 * V_137 = (struct V_30 * ) V_31 ;
...
static int F_60 ( struct V_124 * V_31 )
{
struct V_30 * V_135 = (struct V_30 * ) V_31 ;
if ( V_135 -> V_145 >= V_146 )
return - V_147 ;
V_135 -> V_145 ++ ;
return 0 ;
}
static int F_61 ( struct V_124 * V_31 )
{
struct V_30 * V_135 = (struct V_30 * ) V_31 ;
if ( V_135 -> V_145 == 0 )
return - V_121 ;
...
static int F_62 ( struct V_124 * V_31 , const char T_8 * V_1 , T_4 V_12 )
{
struct V_30 * V_135 = (struct V_30 * ) V_31 ;
void * V_13 ;
if ( ( ! V_31 -> V_148 ) || ( V_31 -> V_148 -> V_149 != V_150 ) )
return - V_109 ;
V_13 = F_63 ( V_1 , V_12 ) ;
if ( F_64 ( V_13 ) )
return F_65 ( V_13 ) ;
...
static int F_68 ( struct V_124 * V_31 ,
struct V_153 * V_148 )
{
struct V_30 * V_135 = (struct V_30 * ) V_31 ;
struct V_100 * V_154 = & V_135 -> V_155 ;
F_37 ( & ( V_148 -> V_156 ) , V_154 ) ;
return 0 ;
}
static int F_69 ( struct V_124 * V_31 ,
struct V_153 * V_148 )
{
struct V_30 * V_135 = (struct V_30 * ) V_31 ;
struct V_100 * V_81 , * V_40 , * V_154 = & V_135 -> V_155 ;
F_70 (pos, n, head) {
if ( F_71 ( V_81 ) == V_148 ) {
F_40 ( V_81 ) ;
return 0 ;
...
static struct V_100 * F_72 ( struct V_124 * V_31 )
{
struct V_30 * V_135 = (struct V_30 * ) V_31 ;
if ( F_73 ( & V_135 -> V_155 ) )
return NULL ;
...
static int F_74 ( struct V_124 * V_31 ,
struct V_153 * V_148 )
{
struct V_30 * V_135 = (struct V_30 * ) V_31 ;
if ( V_31 -> V_148 )
...
static int F_75 ( struct V_124 * V_31 )
{
struct V_30 * V_135 = (struct V_30 * ) V_31 ;
F_48 ( & V_135 -> V_110 ) ;
V_31 -> V_148 = NULL ;
...
static int F_76 ( struct V_124 * V_31 , T_1 * V_114 )
{
struct V_30 * V_135 = (struct V_30 * ) V_31 ;
memcpy ( V_114 , V_135 -> V_114 , 5 * sizeof( T_1 ) ) ;
return 0 ;
}
int F_77 ( struct V_30 * V_135 )
{
int V_20 ;
struct V_124 * V_125 = & V_135 -> V_125 ;
V_135 -> V_76 = NULL ;
V_135 -> V_145 = 0 ;
V_135 -> V_23 = F_45 ( V_135 -> V_91 * sizeof( struct V_18 ) ) ;
if ( ! V_135 -> V_23 )
return - V_117 ;
V_135 -> V_7 = F_45 ( V_135 -> V_95 * sizeof( struct V_3 ) ) ;
if ( ! V_135 -> V_7 ) {
F_51 ( V_135 -> V_23 ) ;
V_135 -> V_23 = NULL ;
return - V_117 ;
}
for ( V_20 = 0 ; V_20 < V_135 -> V_91 ; V_20 ++ ) {
V_135 -> V_23 [ V_20 ] . V_92 = V_93 ;
V_135 -> V_23 [ V_20 ] . V_157 = V_20 ;
}
for ( V_20 = 0 ; V_20 < V_135 -> V_95 ; V_20 ++ ) {
V_135 -> V_7 [ V_20 ] . V_92 = V_93 ;
V_135 -> V_7 [ V_20 ] . V_157 = V_20 ;
}
V_135 -> V_76 = F_45 ( V_78 + 1 ) ;
if ( ! V_135 -> V_76 )
F_12 ( V_158 L_15 ) ;
F_78 ( & V_135 -> V_155 ) ;
for ( V_20 = 0 ; V_20 < V_112 ; V_20 ++ ) {
V_135 -> V_113 [ V_20 ] = NULL ;
V_135 -> V_114 [ V_20 ] = 0xffff ;
}
F_78 ( & V_135 -> V_101 ) ;
V_135 -> V_159 = 0 ;
V_135 -> V_160 = 0 ;
