...
if ( F_6 ( & V_67 -> V_86 ) )
F_43 ( V_40 , & V_67 -> V_87 , V_63 ) ;
if ( F_6 ( & V_68 -> V_86 ) )
F_43 ( V_40 , & V_68 -> V_87 , V_63 ) ;
if ( V_3 -> V_19 -> V_28 -> V_88 )
V_3 -> V_19 -> V_28 -> V_88 ( V_3 -> V_23 ) ;
F_5 ( & V_67 -> V_89 , V_12 ) ;
if ( ! F_6 ( & V_67 -> V_86 ) )
V_70 = F_8 ( & V_67 -> V_86 , struct V_69 ,
V_90 ) ;
if ( V_70 && ( V_70 -> V_91 == V_92
|| V_70 -> V_91 == V_93 ) )
V_72 |= V_78 | V_79 ;
F_7 ( & V_67 -> V_89 , V_12 ) ;
F_5 ( & V_68 -> V_89 , V_12 ) ;
if ( ! F_6 ( & V_68 -> V_86 ) )
V_71 = F_8 ( & V_68 -> V_86 , struct V_69 ,
V_90 ) ;
if ( V_71 && ( V_71 -> V_91 == V_92
|| V_71 -> V_91 == V_93 ) )
V_72 |= V_80 | V_81 ;
F_7 ( & V_68 -> V_89 , V_12 ) ;
V_84:
...
int F_46 ( struct V_40 * V_40 , struct V_2 * V_3 ,
struct V_94 * V_95 )
{
unsigned long V_54 = V_95 -> V_96 << V_97 ;
struct V_7 * V_43 ;
if ( V_54 < V_53 ) {
V_43 = F_44 ( V_3 ) ;
} else {
...
return F_47 ( V_43 , V_95 ) ;
}
struct V_18 * F_48 ( const struct V_98 * V_28 )
{
struct V_18 * V_19 ;
if ( ! V_28 || F_49 ( ! V_28 -> V_29 ) ||
F_49 ( ! V_28 -> V_38 ) )
return F_50 ( - V_99 ) ;
V_19 = F_51 ( sizeof *V_19 , V_100 ) ;
if ( ! V_19 )
return F_50 ( - V_101 ) ;
V_19 -> V_22 = NULL ;
V_19 -> V_28 = V_28 ;
...
void * V_102 ,
int (* F_56)( void * V_23 , struct V_7 * V_103 , struct V_7 * V_104 ) )
{
struct V_2 * V_3 ;
struct V_1 * V_5 , * V_6 ;
int V_20 ;
V_3 = F_51 ( sizeof *V_3 , V_100 ) ;
if ( ! V_3 )
return F_50 ( - V_101 ) ;
V_3 -> V_23 = V_102 ;
V_3 -> V_19 = V_19 ;
...
F_52 ( & V_6 -> V_13 ) ;
F_37 ( & V_3 -> V_25 ) ;
V_20 = F_56 ( V_102 , & V_5 -> V_9 , & V_6 -> V_9 ) ;
if ( V_20 )
goto V_105;
return V_3 ;
V_105:
...
void F_60 ( struct V_2 * V_3 , struct V_69 * V_16 )
{
