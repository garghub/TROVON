...
unsigned int * V_81 )
{
unsigned int V_84 = F_23 ( V_80 -> V_85 ) ;
T_3 V_64 = 0 ;
int V_14 ;
int V_27 ;
for ( V_27 = 0 ; V_27 < V_80 -> V_82 ; V_27 ++ ) {
V_14 = F_17 ( V_2 , V_84 , & V_64 , V_56 ) ;
if ( V_14 )
return V_14 ;
V_81 [ V_27 ] = V_64 ;
}
...
V_9 -> V_21 . V_102 = F_29 ( V_92 -> V_103 ) ;
break;
case 2 :
V_97 = V_99 ;
V_9 -> V_24 . V_22 = V_92 -> V_101 ;
V_9 -> V_24 . V_102 = F_29 ( V_92 -> V_103 ) ;
break;
case 3 :
V_97 = V_100 ;
break;
...
V_78 = & V_2 -> V_114 [ 2 ] ;
V_78 -> type = V_125 ;
V_78 -> V_116 = V_117 | V_126 ;
V_78 -> V_118 = 8 ;
V_78 -> V_119 = 0x0fff ;
V_78 -> V_120 = V_112 ? & V_127 : & V_128 ;
V_78 -> V_129 = F_22 ;
V_78 = & V_2 -> V_114 [ 3 ] ;
V_78 -> type = V_130 ;
V_78 -> V_116 = V_124 ;
...
V_78 -> V_131 = F_25 ;
V_78 -> V_129 = F_24 ;
V_9 -> V_76 [ 0 ] = V_112 ? 0x0000 : 0x0800 ;
V_9 -> V_76 [ 1 ] = V_112 ? 0x0000 : 0x0800 ;
return 0 ;
}
...
{
return F_41 ( V_87 , & V_134 , V_133 -> V_135 ) ;
}
