...
{
T_3 V_20 , V_19 , V_213 ;
T_2 V_155 , V_214 , V_215 ;
int error ;
struct V_94 V_162 ;
T_2 * V_216 = F_77 ( V_23 -> V_29 , V_201 ) ;
if ( ! V_216 )
return - V_202 ;
F_40 ( L_51 ) ;
...
F_53 ( L_66 ) ;
V_23 -> V_222 = V_163 ;
F_85 ( & V_23 -> V_224 , V_23 -> V_116 ) ;
}
static int F_86 ( struct V_22 * V_23 )
{
F_87 ( & V_23 -> V_223 , F_81 ,
( unsigned long ) V_23 ) ;
if ( ! V_23 -> V_225 )
V_23 -> V_225 = F_77 ( V_23 -> V_170 , V_201 ) ;
if ( ! V_23 -> V_225 )
return - V_202 ;
F_83 ( V_23 ) ;
return 0 ;
...
F_53 ( L_67 ,
V_20 , V_23 -> V_222 ) ;
F_64 ( & V_10 , V_23 -> V_225 , V_23 -> V_170 ) ;
for ( V_149 = 0 ; V_149 < V_23 -> V_116 ; V_149 ++ ) {
if ( F_19 ( V_149 , & V_23 -> V_224 ) )
continue;
...
if ( error )
return error ;
if ( ( V_162 . V_155 & V_226 ) !=
V_226 ) {
F_40 ( L_70 , V_149 ) ;
continue;
}
F_89 ( V_149 , & V_23 -> V_224 ) ;
}
error = F_69 ( V_23 , V_23 -> V_222 , & V_10 , 0 ) ;
V_20 = V_23 -> V_179 [ V_23 -> V_222 ] ;
if ( ! error ) {
for ( V_149 = 0 ; V_149 < V_23 -> V_116 ; V_149 ++ ) {
if ( F_19 ( V_149 , & V_23 -> V_224 ) )
continue;
...
int V_149 , bool V_227 , struct V_1 * V_10 , int V_5 )
{
int error ;
struct V_1 V_228 [ 10 ] ;
if ( V_23 -> V_31 )
...
F_41 ( V_228 , F_42 ( V_228 ) ) ;
F_1 ( V_10 , V_228 , F_42 ( V_228 ) , V_5 , V_23 -> V_102 ) ;
F_92 ( V_228 , F_10 ( V_228 ) ,
V_23 -> V_225 + V_149 * V_23 -> V_102 , V_23 -> V_102 ) ;
F_89 ( V_149 , & V_23 -> V_224 ) ;
return 0 ;
}
...
int error = 0 ;
if ( V_19 == V_23 -> V_222 &&
F_19 ( V_149 , & V_23 -> V_224 ) ) {
F_53 ( L_74 ,
V_19 , V_20 , V_149 ) ;
F_41 ( V_228 , F_42 ( V_228 ) ) ;
F_1 ( V_10 , V_228 , F_42 ( V_228 ) ,
V_5 , V_23 -> V_102 ) ;
F_94 ( V_228 , F_10 ( V_228 ) ,
V_23 -> V_225 + V_23 -> V_102 * V_149 ,
V_23 -> V_102 ) ;
} else {
F_53 ( L_75 ,
V_19 , V_20 , V_149 ) ;
...
struct V_131 * V_52 = V_44 -> V_52 ;
struct V_181 * V_207 ;
int error = 0 , V_25 , V_230 ;
V_23 -> V_62 = 0 ;
if ( V_44 -> V_37 . V_231 >= V_232 &&
V_44 -> V_37 . V_231 <= V_232 )
V_23 -> V_31 = true ;
V_23 -> V_47 = - 1 ;
...
if ( ! V_23 -> V_169 )
return - V_202 ;
V_230 = ( V_23 -> V_170 * V_23 -> V_29 ) >> 20 ;
for ( V_25 = 0 ; V_235 [ V_25 ] . V_236 ; V_25 ++ ) {
if ( V_235 [ V_25 ] . V_236 != V_230 )
continue;
V_23 -> V_237 . V_238 = V_235 [ V_25 ] . V_239 ;
V_23 -> V_237 . V_240 = V_235 [ V_25 ] . V_241 ;
V_23 -> V_237 . V_242 = V_235 [ V_25 ] . V_243 ;
break;
}
if ( V_207 -> V_191 . V_244 == 1 )
V_23 -> V_62 |= V_233 ;
if ( V_207 -> V_191 . V_245 & 0x03 )
V_23 -> V_31 = true ;
F_40 ( L_77 , V_23 -> V_29 ) ;
F_40 ( L_78 , V_23 -> V_116 ) ;
F_40 ( L_79 , V_23 -> V_102 ) ;
F_40 ( L_80 , ! ! ( V_23 -> V_62 & V_233 ) ) ;
F_40 ( L_81 , V_23 -> V_31 ) ;
#if 0
...
int V_149 , struct V_1 * V_10 , T_1 V_6 , int * V_246 )
{
int error = 0 ;
T_5 V_5 = 0 ;
* V_246 = 0 ;
...
int V_149 , struct V_1 * V_10 , int V_6 , int * V_247 )
{
int error = 0 ;
int V_5 = 0 ;
* V_247 = 0 ;
...
static void F_98 ( struct V_248 * V_249 )
{
struct V_22 * V_23 = F_99 ( V_249 , struct V_22 , V_221 ) ;
int V_149 , error , V_6 ;
T_6 V_19 ;
unsigned long V_164 ;
struct V_1 * V_10 = V_23 -> V_250 ;
F_53 ( L_85 ) ;
while ( 1 ) {
F_100 ( & V_23 -> V_251 , V_164 ) ;
if ( V_23 -> V_219 ) {
V_23 -> V_219 = false ;
F_101 ( & V_23 -> V_251 , V_164 ) ;
F_88 ( V_23 ) ;
continue;
}
if ( ! V_23 -> V_46 ) {
V_23 -> V_46 = F_102 ( V_23 -> V_252 ) ;
if ( ! V_23 -> V_46 ) {
F_53 ( L_86 ) ;
F_101 ( & V_23 -> V_251 , V_164 ) ;
return;
...
return;
F_53 ( L_87 ) ;
F_103 ( V_23 -> V_252 , V_23 -> V_46 , V_10 ) ;
V_19 = F_104 ( V_23 -> V_46 ) ;
F_105 ( V_19 , V_23 -> V_102 / 512 ) ;
V_149 = F_106 ( V_19 , V_23 -> V_116 ) ;
if ( F_107 ( V_23 -> V_46 ) == V_253 )
...
F_100 ( & V_23 -> V_251 , V_164 ) ;
if ( V_6 )
if ( ! F_109 ( V_23 -> V_46 , 0 , V_6 ) )
V_23 -> V_46 = NULL ;
if ( error && V_23 -> V_46 ) {
F_53 ( L_88 ) ;
if ( ! F_109 ( V_23 -> V_46 , error , V_23 -> V_102 ) )
V_23 -> V_46 = NULL ;
}
if ( V_23 -> V_46 )
F_53 ( L_89 ) ;
...
static int F_110 ( struct V_254 * V_255 , T_7 V_256 )
{
struct V_257 * V_258 = V_255 -> V_259 ;
struct V_22 * V_23 = V_258 -> V_260 ;
F_53 ( L_90 ) ;
F_111 ( & V_261 ) ;
if ( V_23 && V_23 -> V_44 )
V_23 -> V_262 ++ ;
...
static void F_117 ( struct V_257 * V_258 , T_7 V_256 )
{
F_114 ( V_258 ) ;
}
...
struct V_265 * V_266 )
{
struct V_22 * V_23 = V_255 -> V_259 -> V_260 ;
* V_266 = V_23 -> V_237 ;
return 0 ;
}
static int F_119 ( struct V_267 * V_268 , struct V_269 * V_46 )
{
if ( V_46 -> V_270 != V_271 &&
V_46 -> V_270 != V_272 ) {
F_120 ( V_46 , L_92 ) ;
...
static void F_121 ( struct V_267 * V_268 )
{
struct V_43 * V_44 = V_268 -> V_277 ;
struct V_22 * V_23 = F_39 ( V_44 ) ;
struct V_269 * V_46 = NULL ;
F_53 ( L_93 ) ;
if ( V_23 -> V_278 ) {
F_40 ( L_94 ) ;
F_27 ( ! V_23 -> V_279 ) ;
while ( ( V_46 = F_102 ( V_268 ) ) != NULL )
F_122 ( V_46 , - V_148 ) ;
return;
}
if ( V_23 -> V_46 )
...
static void F_124 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
unsigned long V_164 ;
F_40 ( L_95 ) ;
...
if ( V_23 -> V_46 ) {
F_100 ( & V_23 -> V_251 , V_164 ) ;
F_127 ( V_23 -> V_252 , V_23 -> V_46 ) ;
V_23 -> V_46 = NULL ;
F_101 ( & V_23 -> V_251 , V_164 ) ;
}
}
static void F_128 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
unsigned long V_164 ;
F_40 ( L_96 ) ;
...
static int F_130 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
struct V_131 * V_52 = V_44 -> V_52 ;
int V_280 ;
T_8 V_281 = V_282 ;
unsigned long V_283 ;
if ( V_52 -> V_284 . V_285 && * ( V_52 -> V_284 . V_285 ) )
V_281 = * ( V_52 -> V_284 . V_285 ) ;
F_111 ( & V_261 ) ;
V_23 -> V_264 = F_131 ( & V_263 , V_44 , 0 , 256 , V_201 ) ;
F_112 ( & V_261 ) ;
if ( V_23 -> V_264 < 0 )
return V_23 -> V_264 ;
V_23 -> V_258 = F_132 ( 0 ) ;
...
V_23 -> V_252 = F_133 ( F_121 , & V_23 -> V_251 ) ;
if ( ! V_23 -> V_252 ) {
V_280 = - V_202 ;
goto V_287;
}
V_23 -> V_252 -> V_277 = V_44 ;
F_134 ( V_23 -> V_252 , F_119 ) ;
F_135 ( V_23 -> V_252 , V_281 ) ;
F_136 ( V_23 -> V_252 , V_288 ) ;
F_137 ( V_23 -> V_252 , V_289 ) ;
F_138 ( V_23 -> V_252 ,
V_288 * V_23 -> V_102 ) ;
F_139 ( V_23 -> V_252 , V_23 -> V_102 ) ;
sprintf ( V_23 -> V_258 -> V_290 , L_97 , V_23 -> V_264 ) ;
V_23 -> V_258 -> V_291 = & V_292 ;
V_23 -> V_258 -> V_260 = V_23 ;
V_23 -> V_258 -> V_252 = V_23 -> V_252 ;
V_23 -> V_258 -> V_293 = & V_44 -> V_284 ;
V_23 -> V_258 -> V_164 |= V_294 ;
V_283 = V_23 -> V_116 * V_23 -> V_172 ;
V_283 *= ( V_23 -> V_102 / 512 ) ;
F_140 ( V_23 -> V_258 , V_283 ) ;
F_40 ( L_98 , V_283 ) ;
V_23 -> V_262 = 1 ;
V_23 -> V_220 = F_141 ( L_99 , V_295 ) ;
F_142 ( & V_23 -> V_221 , F_98 ) ;
F_41 ( V_23 -> V_250 , V_289 + 1 ) ;
if ( V_23 -> V_31 )
F_143 ( V_23 -> V_258 , 1 ) ;
F_128 ( V_44 ) ;
F_144 ( V_23 -> V_258 ) ;
...
static int F_145 ( struct V_43 * V_44 )
{
struct V_22 * V_23 ;
int V_280 = 0 ;
...
static int F_151 ( struct V_43 * V_44 , T_9 V_47 )
{
F_124 ( V_44 ) ;
return 0 ;
}
static int F_152 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
struct V_22 * V_300 = NULL ;
bool V_278 = true ;
#ifndef F_153
V_23 -> V_278 = true ;
return 0 ;
#endif
F_111 ( & V_44 -> V_52 -> V_301 ) ;
V_300 = F_77 ( sizeof( struct V_22 ) , V_201 ) ;
if ( ! V_300 )
goto V_9;
V_300 -> V_44 = V_44 ;
F_146 ( V_44 , V_300 ) ;
...
if ( F_95 ( V_44 ) )
goto V_9;
if ( V_23 -> V_170 != V_300 -> V_170 )
goto V_9;
if ( memcmp ( V_23 -> V_200 , V_300 -> V_200 ,
sizeof( struct V_181 ) ) )
goto V_9;
if ( V_23 -> V_172 != V_300 -> V_172 ||
memcmp ( V_23 -> V_179 , V_300 -> V_179 ,
V_23 -> V_172 ) )
goto V_9;
if ( V_23 -> V_29 != V_300 -> V_29 ||
memcmp ( V_23 -> V_30 , V_300 -> V_30 ,
V_23 -> V_29 / 8 ) )
goto V_9;
V_278 = false ;
V_9:
...
F_128 ( V_44 ) ;
F_112 ( & V_44 -> V_52 -> V_301 ) ;
return 0 ;
}
static int T_10 F_154 ( void )
{
int V_280 = F_155 ( 0 , V_302 ) ;
if ( V_280 < 0 ) {
F_17 ( L_103 , V_280 ) ;
return V_280 ;
}
