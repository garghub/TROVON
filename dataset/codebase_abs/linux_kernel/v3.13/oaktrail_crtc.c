...
struct V_8 * V_9 = V_7 -> V_10 ;
struct V_42 * V_42 = F_10 ( V_3 ) ;
struct V_139 * V_140 = F_29 ( V_3 -> V_141 ) ;
int V_43 = V_42 -> V_43 ;
const struct V_44 * V_45 = & V_9 -> V_46 [ V_43 ] ;
...
if ( ! F_12 ( V_7 , true ) )
return 0 ;
V_142 = V_140 -> V_145 -> V_143 ;
V_143 = V_78 * V_3 -> V_141 -> V_146 [ 0 ] + V_77 * ( V_3 -> V_141 -> V_147 / 8 ) ;
F_19 ( V_45 -> V_148 , V_3 -> V_141 -> V_146 [ 0 ] ) ;
V_82 = F_17 ( V_45 -> V_58 ) ;
V_82 &= ~ V_149 ;
switch ( V_3 -> V_141 -> V_147 ) {
case 8 :
V_82 |= V_150 ;
break;
case 16 :
if ( V_3 -> V_141 -> V_151 == 15 )
V_82 |= V_152 ;
else
V_82 |= V_153 ;
break;
...
F_19 ( V_45 -> V_58 , V_82 ) ;
F_19 ( V_45 -> V_60 , V_143 ) ;
F_17 ( V_45 -> V_60 ) ;
F_19 ( V_45 -> V_157 , V_142 ) ;
F_17 ( V_45 -> V_157 ) ;
V_156:
F_20 ( V_7 ) ;
return V_144 ;
