...
F_40 ( V_2 , V_7 , 0 , V_1 -> V_19 . V_72 - 1 ) ;
error = F_36 ( V_2 , 0 ) ;
if ( error )
goto error;
}
...
V_78 = V_76 ;
F_47 ( V_78 , V_73 -> V_94 ) ;
V_77 = F_48 ( V_78 , V_98 * V_86 -> V_72 ) ;
V_79 = F_21 ( V_78 ) ;
V_81 = V_79 + 1 ;
V_82 = ( T_17 ) sizeof( T_6 ) * V_81 * V_77 ;
V_80 = F_49 ( V_1 , V_82 ) ;
V_82 = F_50 ( V_1 , V_80 ) ;
if ( V_80 > ( V_1 -> V_19 . V_99 >> 1 ) )
return F_34 ( V_96 ) ;
V_84 = F_49 ( V_1 , V_1 -> V_91 -> V_100 . V_101 ) ;
V_85 = F_49 ( V_1 , V_1 -> V_102 -> V_100 . V_101 ) ;
...
V_83 -> V_72 * V_83 -> V_95 ) ;
V_83 -> V_20 = V_83 -> V_93 ;
F_47 ( V_83 -> V_20 , V_83 -> V_95 ) ;
ASSERT ( V_83 -> V_20 != 0 ) ;
V_83 -> V_105 = F_21 ( V_83 -> V_20 ) ;
V_81 = V_75 -> V_40 = V_83 -> V_105 + 1 ;
V_82 =
( T_17 ) sizeof( T_6 ) * V_81 *
V_83 -> V_41 ;
V_80 = F_49 ( V_1 , V_82 ) ;
V_75 -> V_106 = V_82 = F_50 ( V_1 , V_80 ) ;
V_2 = F_26 ( V_1 , V_107 ) ;
...
if ( V_116 )
F_54 ( V_2 , V_123 , - V_122 ) ;
else
F_54 ( V_2 , V_115 , - V_122 ) ;
}
* V_25 = V_39 ;
return 0 ;
}
...
V_1 -> V_106 =
( T_17 ) sizeof( T_6 ) * V_1 -> V_40 *
V_86 -> V_41 ;
V_1 -> V_106 = F_61 ( V_1 -> V_106 , V_86 -> V_72 ) ;
V_1 -> V_91 = V_1 -> V_102 = NULL ;
V_47 = ( T_10 ) F_45 ( V_1 , V_1 -> V_19 . V_93 ) ;
if ( F_62 ( V_1 , V_47 ) != V_1 -> V_19 . V_93 ) {
F_60 ( V_1 , L_2 ,
( unsigned long long ) F_62 ( V_1 , V_47 ) ,
...
if ( V_86 -> V_126 == V_127 )
return 0 ;
error = F_64 ( V_1 , NULL , V_86 -> V_126 , 0 , 0 , & V_1 -> V_91 ) ;
if ( error )
return error ;
ASSERT ( V_1 -> V_91 != NULL ) ;
ASSERT ( V_86 -> V_128 != V_127 ) ;
error = F_64 ( V_1 , NULL , V_86 -> V_128 , 0 , 0 , & V_1 -> V_102 ) ;
if ( error ) {
F_65 ( V_1 -> V_91 ) ;
return error ;
}
