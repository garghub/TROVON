...
static const struct V_111 * F_69 ( struct V_9 * V_10 ,
struct V_112 * V_113 )
{
...
V_116 = F_70 ( & V_114 , V_115 , & V_10 -> V_59 ) ;
if ( V_116 < 0 ) {
if ( V_116 == - V_125 ) {
F_9 ( L_14 ,
V_10 -> V_13 , V_116 ) ;
...
if ( F_70 ( & V_114 , V_115 , & V_10 -> V_59 ) < 0 ) {
F_9 ( L_17 ,
V_10 -> V_13 , V_115 ) ;
return NULL ;
}
}
F_71 ( L_18 , V_10 -> V_13 , V_115 ) ;
return V_114 ;
}
...
if ( ! V_92 || ! V_132 || V_133 < 0 ) {
F_9 ( L_22 , V_10 -> V_13 ) ;
return - V_136 ;
}
V_58 = F_73 ( V_10 , F_16 ( V_129 -> V_137 ) , V_129 -> V_135 ,
V_130 , V_92 -> V_92 , V_110 ) ;
if ( F_67 ( V_58 ) ) {
F_9 ( L_23 ,
V_10 -> V_13 , V_129 -> V_137 , F_68 ( V_58 ) ) ;
return F_68 ( V_58 ) ;
}
if ( V_58 -> V_52 != V_92 -> V_135 ) {
F_9 ( L_24 , V_10 -> V_13 ,
F_16 ( V_129 -> V_137 ) ) ;
F_33 ( V_58 ) ;
return - V_136 ;
}
if ( memcmp ( V_58 -> V_2 , V_132 , V_92 -> V_135 ) ) {
F_9 ( L_25 ,
...
F_7 ( L_4 , V_10 -> V_13 ) ;
V_58 = F_66 ( V_10 , V_143 , 0 , NULL , V_110 ) ;
if ( F_67 ( V_58 ) ) {
F_9 ( L_26 ,
V_10 -> V_13 , F_68 ( V_58 ) ) ;
return F_68 ( V_58 ) ;
...
V_114 = F_69 ( V_10 , V_113 ) ;
if ( ! V_114 ) {
F_33 ( V_58 ) ;
return 0 ;
}
V_126 = V_114 -> V_2 ;
V_58 = F_66 ( V_10 , 0xfc11 , 2 , V_139 , V_110 ) ;
if ( F_67 ( V_58 ) ) {
F_9 ( L_32 ,
V_10 -> V_13 , F_68 ( V_58 ) ) ;
F_76 ( V_114 ) ;
...
if ( V_127 )
goto V_148;
V_58 = F_66 ( V_10 , 0xfc11 , sizeof( V_142 ) ,
V_142 , V_110 ) ;
if ( F_67 ( V_58 ) ) {
F_9 ( L_34 ,
V_10 -> V_13 , F_68 ( V_58 ) ) ;
...
return 0 ;
V_148:
V_58 = F_66 ( V_10 , 0xfc11 , sizeof( V_140 ) , V_140 ,
V_110 ) ;
if ( F_67 ( V_58 ) ) {
F_9 ( L_34 ,
V_10 -> V_13 , F_68 ( V_58 ) ) ;
...
V_147:
F_76 ( V_114 ) ;
V_58 = F_66 ( V_10 , 0xfc11 , sizeof( V_141 ) ,
V_141 , V_110 ) ;
if ( F_67 ( V_58 ) ) {
F_9 ( L_34 ,
V_10 -> V_13 , F_68 ( V_58 ) ) ;
...
static int F_77 ( struct V_95 * V_65 ,
...
struct V_163 * V_23 = F_79 ( V_65 ) ;
if ( F_16 ( V_23 -> V_164 . V_165 ) <= 0x0001 )
return - V_27 ;
}
V_2 = F_80 ( & V_65 -> V_59 , sizeof( * V_2 ) , V_67 ) ;
if ( ! V_2 )
return - V_33 ;
for ( V_44 = 0 ; V_44 < V_65 -> V_100 -> V_101 . V_102 ; V_44 ++ ) {
V_98 = & V_65 -> V_100 -> V_103 [ V_44 ] . V_101 ;
if ( ! V_2 -> V_32 && F_81 ( V_98 ) ) {
V_2 -> V_32 = V_98 ;
continue;
}
if ( ! V_2 -> V_85 && F_82 ( V_98 ) ) {
V_2 -> V_85 = V_98 ;
continue;
}
if ( ! V_2 -> V_43 && F_83 ( V_98 ) ) {
V_2 -> V_43 = V_98 ;
continue;
}
}
...
static void F_95 ( struct V_95 * V_65 )
{
struct V_1 * V_2 = F_96 ( V_65 ) ;
struct V_9 * V_10 ;
F_7 ( L_39 , V_65 ) ;
if ( ! V_2 )
return;
...
static int F_99 ( struct V_95 * V_65 , T_3 V_189 )
{
struct V_1 * V_2 = F_96 ( V_65 ) ;
F_7 ( L_39 , V_65 ) ;
if ( V_2 -> V_190 ++ )
...
static int F_105 ( struct V_95 * V_65 )
{
struct V_1 * V_2 = F_96 ( V_65 ) ;
struct V_9 * V_10 = V_2 -> V_10 ;
int V_12 = 0 ;
