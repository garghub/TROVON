...
static void F_177 ( struct V_348 * V_349 , T_6 V_338 )
{
...
static int F_237 ( void * V_478 , int V_479 )
{
struct V_4 * V_5 = V_478 ;
struct V_480 * V_424 ;
char V_481 = '-' ;
int V_18 = 0 ;
if ( ! F_238 ( V_5 ) ) {
...
V_18 = F_240 ( & V_424 -> V_486 , V_479 ) ;
F_83 ( V_5 ) ;
if ( V_18 )
V_481 = 'b' ;
}
if ( V_479 & ( 1 << V_484 ) && F_90 ( V_274 , & V_5 -> V_14 -> V_43 ) ) {
V_18 |= ( 1 << V_484 ) ;
V_481 = V_481 == 'b' ? 'a' : 'n' ;
}
V_482:
...
static void F_241 ( struct V_488 * V_470 )
{
F_32 ( & V_470 -> V_489 ) ;
F_182 ( & V_470 -> V_424 ) ;
F_184 ( & V_470 -> V_490 ) ;
...
struct V_13 * F_244 ( void * V_492 , int V_493 ,
void * V_494 , int V_495 )
{
struct V_13 * V_14 ;
F_48 () ;
F_243 (tconn, &drbd_tconns, all_tconn) {
if ( V_14 -> V_493 == V_493 &&
V_14 -> V_495 == V_495 &&
! memcmp ( & V_14 -> V_492 , V_492 , V_493 ) &&
! memcmp ( & V_14 -> V_494 , V_494 , V_495 ) ) {
F_36 ( & V_14 -> V_57 ) ;
goto V_491;
}
}
...
{
V_100 -> V_496 = ( void * ) F_246 ( V_497 ) ;
if ( ! V_100 -> V_496 )
return - V_444 ;
V_100 -> V_101 = ( void * ) F_246 ( V_497 ) ;
if ( ! V_100 -> V_101 )
return - V_444 ;
return 0 ;
}
...
F_248 ( ( unsigned long ) V_100 -> V_496 ) ;
}
...
int F_252 ( struct V_13 * V_14 , struct V_503 * V_503 )
{
T_7 V_504 ;
int V_106 ;
if ( ! F_253 ( & V_504 , V_497 ) )
return - V_444 ;
if ( V_505 > 1 && V_503 -> V_77 [ 0 ] != 0 ) {
V_106 = F_254 ( V_503 -> V_77 , 32 ,
F_255 ( V_504 ) , V_505 ) ;
if ( V_106 ) {
...
V_14 -> V_503 = * V_503 ;
if ( ! F_257 ( V_14 -> V_77 , V_504 ) ) {
F_258 ( V_14 -> V_77 , V_504 ) ;
F_52 ( V_14 ) ;
V_14 -> V_69 . V_63 = 1 ;
V_14 -> V_70 . V_63 = 1 ;
V_14 -> V_71 . V_63 = 1 ;
...
struct V_13 * F_260 ( const char * V_47 , struct V_503 * V_503 )
{
struct V_13 * V_14 ;
V_14 = F_261 ( sizeof( struct V_13 ) , V_497 ) ;
if ( ! V_14 )
return NULL ;
V_14 -> V_47 = F_262 ( V_47 , V_497 ) ;
if ( ! V_14 -> V_47 )
goto V_506;
if ( F_245 ( & V_14 -> V_104 ) )
goto V_506;
if ( F_245 ( & V_14 -> V_108 ) )
goto V_506;
if ( ! F_253 ( & V_14 -> V_77 , V_497 ) )
goto V_506;
if ( F_252 ( V_14 , V_503 ) )
goto V_506;
V_14 -> V_507 = F_261 ( sizeof( struct V_508 ) , V_497 ) ;
if ( ! V_14 -> V_507 )
goto V_506;
F_182 ( & V_14 -> V_509 ) ;
F_182 ( & V_14 -> V_507 -> V_378 ) ;
V_14 -> V_510 = 1 ;
F_32 ( & V_14 -> V_511 ) ;
V_14 -> V_512 = V_513 ;
V_14 -> V_514 . V_515 = false ;
V_14 -> V_514 . V_516 = 0 ;
V_14 -> V_514 . V_517 = 0 ;
V_14 -> V_247 = V_354 ;
F_181 ( & V_14 -> V_518 ) ;
...
F_30 ( V_14 , & V_14 -> V_69 , V_521 , L_41 ) ;
F_30 ( V_14 , & V_14 -> V_71 , V_522 , L_42 ) ;
F_30 ( V_14 , & V_14 -> V_70 , V_523 , L_43 ) ;
F_264 ( & V_14 -> V_57 ) ;
F_265 ( & V_14 -> V_475 , & V_524 ) ;
return V_14 ;
V_506:
F_212 ( V_14 -> V_507 ) ;
F_259 ( V_14 -> V_77 ) ;
...
if ( F_218 ( & V_14 -> V_507 -> V_525 ) != 0 )
F_11 ( V_14 , L_44 , F_218 ( & V_14 -> V_507 -> V_525 ) ) ;
F_212 ( V_14 -> V_507 ) ;
F_235 ( & V_14 -> V_74 ) ;
F_259 ( V_14 -> V_77 ) ;
F_247 ( & V_14 -> V_108 ) ;
...
{
V_5 -> V_474 . V_470 = F_267 ( L_45 ,
V_526 | V_527 , 1 , V_5 -> V_528 ) ;
if ( ! V_5 -> V_474 . V_470 )
return - V_444 ;
F_268 ( & V_5 -> V_474 . V_71 , V_529 ) ;
F_32 ( & V_5 -> V_474 . V_462 ) ;
F_182 ( & V_5 -> V_474 . V_461 ) ;
return 0 ;
}
enum V_530 F_269 ( struct V_13 * V_14 , unsigned int V_528 , int V_72 )
{
struct V_4 * V_5 ;
struct V_348 * V_11 ;
struct V_480 * V_424 ;
int V_531 = V_72 ;
int V_532 = V_528 ;
enum V_530 V_106 = V_533 ;
V_5 = F_270 ( V_528 ) ;
if ( V_5 )
return V_534 ;
V_5 = F_261 ( sizeof( struct V_4 ) , V_497 ) ;
if ( ! V_5 )
return V_533 ;
F_36 ( & V_14 -> V_57 ) ;
V_5 -> V_14 = V_14 ;
...
V_11 -> V_539 = V_528 ;
V_11 -> V_540 = & V_541 ;
sprintf ( V_11 -> V_542 , L_46 , V_528 ) ;
V_11 -> V_339 = V_5 ;
V_5 -> V_193 = F_274 ( F_275 ( V_476 , V_528 ) ) ;
V_5 -> V_193 -> V_543 = V_5 -> V_193 ;
V_424 -> V_486 . V_544 = F_237 ;
V_424 -> V_486 . V_478 = V_5 ;
F_276 ( V_424 , V_545 ) ;
F_277 ( V_424 , V_302 | V_300 ) ;
F_278 ( V_424 , V_406 >> 8 ) ;
F_279 ( V_424 , V_546 ) ;
F_280 ( V_424 , V_547 ) ;
V_424 -> V_548 = & V_5 -> V_14 -> V_22 ;
V_5 -> V_453 = F_202 ( V_497 ) ;
if ( ! V_5 -> V_453 )
goto V_549;
if ( F_281 ( V_5 ) )
goto V_550;
V_5 -> V_551 = V_552 ;
V_5 -> V_553 = V_552 ;
V_532 = F_282 ( & V_473 , V_5 , V_528 , V_528 + 1 , V_497 ) ;
if ( V_532 < 0 ) {
if ( V_532 == - V_554 ) {
V_106 = V_534 ;
F_283 ( L_47 ) ;
...
V_531 = F_282 ( & V_14 -> V_74 , V_5 , V_72 , V_72 + 1 , V_497 ) ;
if ( V_531 < 0 ) {
if ( V_531 == - V_554 ) {
V_106 = V_556 ;
F_283 ( L_48 ) ;
...
goto V_506;
V_106 = - V_444 ;
V_472 = F_293 ( L_38 , V_567 | V_568 , NULL , & V_569 , NULL ) ;
if ( ! V_472 ) {
F_236 ( V_562 L_53 ) ;
goto V_506;
}
V_460 . V_470 = F_294 ( L_54 ) ;
if ( ! V_460 . V_470 ) {
F_236 ( V_562 L_55 ) ;
goto V_506;
}
F_268 ( & V_460 . V_71 , F_215 ) ;
F_32 ( & V_460 . V_462 ) ;
F_182 ( & V_460 . V_461 ) ;
F_236 ( V_477 L_56
L_57 V_570 L_58 ,
V_571 , V_572 , V_573 ) ;
F_236 ( V_477 L_59 , F_295 () ) ;
F_236 ( V_477 L_60 ,
V_476 ) ;
return 0 ;
V_506:
...
void F_189 ( struct V_574 * V_124 )
{
if ( V_124 == NULL )
return;
F_296 ( V_124 -> V_185 , V_575 | V_343 | V_576 ) ;
F_296 ( V_124 -> V_577 , V_575 | V_343 | V_576 ) ;
F_212 ( V_124 -> V_116 ) ;
F_212 ( V_124 ) ;
}
...
if ( V_14 -> V_104 . V_100 ) {
F_70 ( & V_14 -> V_104 . V_102 ) ;
F_297 ( V_14 -> V_104 . V_100 , V_578 ) ;
F_298 ( V_14 -> V_104 . V_100 ) ;
V_14 -> V_104 . V_100 = NULL ;
F_71 ( & V_14 -> V_104 . V_102 ) ;
}
if ( V_14 -> V_108 . V_100 ) {
F_70 ( & V_14 -> V_108 . V_102 ) ;
F_297 ( V_14 -> V_108 . V_100 , V_578 ) ;
F_298 ( V_14 -> V_108 . V_100 ) ;
V_14 -> V_108 . V_100 = NULL ;
F_71 ( & V_14 -> V_108 . V_102 ) ;
}
}
void F_299 ( struct V_13 * V_14 )
{
struct V_4 * V_5 ;
int V_72 ;
F_48 () ;
...
void F_300 ( struct V_4 * V_5 , void * V_230 )
{
struct V_579 * V_96 = V_230 ;
T_3 V_251 ;
int V_154 ;
memset ( V_96 , 0 , sizeof( * V_96 ) ) ;
V_96 -> V_580 = F_88 ( F_105 ( V_5 -> V_193 ) ) ;
for ( V_154 = V_158 ; V_154 < V_159 ; V_154 ++ )
V_96 -> V_160 [ V_154 ] = F_88 ( V_5 -> V_124 -> V_156 . V_160 [ V_154 ] ) ;
V_96 -> V_43 = F_63 ( V_5 -> V_124 -> V_156 . V_43 ) ;
V_96 -> V_88 = F_63 ( V_581 ) ;
V_96 -> V_582 = F_63 ( V_5 -> V_124 -> V_156 . V_582 ) ;
V_96 -> V_583 = F_63 ( V_5 -> V_124 -> V_156 . V_583 ) ;
V_96 -> V_584 = F_63 ( V_5 -> V_450 -> V_585 ) ;
V_96 -> V_586 = F_63 ( V_587 ) ;
V_96 -> V_588 = F_88 ( V_5 -> V_124 -> V_156 . V_588 ) ;
V_96 -> V_589 = F_63 ( V_5 -> V_124 -> V_156 . V_589 ) ;
V_96 -> V_590 = F_63 ( V_5 -> V_405 ) ;
V_96 -> V_591 = F_63 ( V_5 -> V_124 -> V_156 . V_591 ) ;
V_96 -> V_592 = F_63 ( V_5 -> V_124 -> V_156 . V_592 ) ;
F_96 ( F_301 ( V_5 -> V_124 ) == V_5 -> V_124 -> V_156 . V_593 ) ;
V_251 = V_5 -> V_124 -> V_156 . V_593 ;
if ( F_302 ( V_5 , V_5 -> V_124 , V_251 , V_594 ) ) {
F_120 ( V_168 , L_63 ) ;
F_303 ( V_5 , 1 , V_595 ) ;
}
}
...
struct V_579 * V_96 ;
F_60 ( V_159 != 4 ) ;
F_60 ( sizeof( struct V_579 ) != 4096 ) ;
F_304 ( & V_5 -> V_392 ) ;
if ( ! F_305 ( V_596 , & V_5 -> V_43 ) )
return;
if ( ! F_87 ( V_5 , V_597 ) )
return;
V_96 = F_306 ( V_5 ) ;
...
goto V_482;
F_300 ( V_5 , V_96 ) ;
V_5 -> V_124 -> V_156 . V_580 = F_105 ( V_5 -> V_193 ) ;
F_307 ( V_5 ) ;
V_482:
F_83 ( V_5 ) ;
}
static int F_308 ( struct V_4 * V_5 ,
struct V_579 * V_598 ,
struct V_599 * V_600 )
{
T_4 V_591 = F_309 ( V_598 -> V_591 ) ;
T_4 V_592 = F_309 ( V_598 -> V_592 ) ;
T_2 V_601 ;
if ( V_591 == 0 && V_592 == 0 ) {
V_591 = 1 ;
V_592 = V_602 / 8 ;
...
if ( V_591 == 0 || V_592 == 0 )
goto V_106;
V_601 = ( T_2 ) V_591 * V_592 ;
if ( V_601 > ( 16 * 1024 * 1024 / 4 ) )
goto V_106;
if ( V_601 < V_602 / 8 )
goto V_106;
V_600 -> V_592 = V_592 ;
...
static int F_310 ( struct V_4 * V_5 , struct V_574 * V_337 )
{
T_3 V_603 = F_105 ( V_337 -> V_577 ) ;
struct V_599 * V_600 = & V_337 -> V_156 ;
T_9 V_604 ;
T_9 V_605 ;
if ( V_600 -> V_583 < 0 ) {
if ( V_600 -> V_589 > V_600 -> V_583 )
goto V_106;
V_604 = - V_600 -> V_583 ;
V_605 = V_600 -> V_583 - V_600 -> V_589 ;
} else {
if ( V_600 -> V_583 != V_606 )
goto V_106;
if ( V_600 -> V_589 < V_600 -> V_583 + V_600 -> V_601 * V_606 )
goto V_106;
V_604 = V_600 -> V_589 - V_606 ;
V_605 = V_600 -> V_582 - V_600 -> V_589 ;
}
if ( V_600 -> V_607 >= 0 ) {
if ( V_600 -> V_582 != V_608
|| V_600 -> V_583 != V_606
|| V_600 -> V_589 != V_606 + V_602
|| V_600 -> V_591 != 1
|| V_600 -> V_592 != V_602 / 8 )
goto V_106;
}
if ( V_603 < V_600 -> V_582 )
goto V_106;
if ( V_603 - V_600 -> V_582 < F_311 ( V_337 ) )
goto V_106;
if ( ( V_604 & 7 ) || ( V_604 < V_602 ) )
goto V_106;
if ( V_604 != V_600 -> V_601 * V_606 )
goto V_106;
if ( V_600 -> V_589 & 7 )
goto V_106;
if ( V_605 < ( V_600 -> V_580 + 7 ) / V_606 / 8 / 512 )
goto V_106;
return 0 ;
V_106:
F_120 ( V_168 , L_65
...
L_67 ,
V_600 -> V_607 ,
V_600 -> V_591 , V_600 -> V_592 ,
V_600 -> V_583 , V_600 -> V_589 , V_600 -> V_582 ,
( unsigned long long ) V_600 -> V_580 ,
( unsigned long long ) V_603 ) ;
return - V_563 ;
}
int F_312 ( struct V_4 * V_5 , struct V_574 * V_337 )
{
struct V_579 * V_96 ;
T_4 V_88 , V_43 ;
int V_154 , V_325 = V_559 ;
if ( V_5 -> V_10 . V_11 != V_355 )
return V_609 ;
V_96 = F_306 ( V_5 ) ;
if ( ! V_96 )
return V_533 ;
V_337 -> V_156 . V_607 = V_337 -> V_116 -> V_607 ;
V_337 -> V_156 . V_593 = F_301 ( V_337 ) ;
if ( F_302 ( V_5 , V_337 , V_337 -> V_156 . V_593 , V_610 ) ) {
F_120 ( V_168 , L_68 ) ;
V_325 = V_611 ;
goto V_106;
}
V_88 = F_309 ( V_96 -> V_88 ) ;
V_43 = F_309 ( V_96 -> V_43 ) ;
if ( V_88 == V_581 ||
( V_88 == V_612 && ! ( V_43 & V_613 ) ) ) {
F_120 ( V_168 , L_69 ) ;
V_325 = V_614 ;
goto V_106;
}
...
if ( F_309 ( V_96 -> V_586 ) != V_587 ) {
F_120 ( V_168 , L_72 ,
F_309 ( V_96 -> V_586 ) , V_587 ) ;
goto V_106;
}
V_337 -> V_156 . V_580 = F_313 ( V_96 -> V_580 ) ;
for ( V_154 = V_158 ; V_154 < V_159 ; V_154 ++ )
V_337 -> V_156 . V_160 [ V_154 ] = F_313 ( V_96 -> V_160 [ V_154 ] ) ;
V_337 -> V_156 . V_43 = F_309 ( V_96 -> V_43 ) ;
V_337 -> V_156 . V_588 = F_313 ( V_96 -> V_588 ) ;
V_337 -> V_156 . V_582 = F_309 ( V_96 -> V_582 ) ;
V_337 -> V_156 . V_583 = F_309 ( V_96 -> V_583 ) ;
V_337 -> V_156 . V_589 = F_309 ( V_96 -> V_589 ) ;
if ( F_308 ( V_5 , V_96 , & V_337 -> V_156 ) )
goto V_106;
if ( F_310 ( V_5 , V_337 ) )
goto V_106;
if ( F_309 ( V_96 -> V_589 ) != V_337 -> V_156 . V_589 ) {
F_120 ( V_168 , L_73 ,
F_309 ( V_96 -> V_589 ) , V_337 -> V_156 . V_589 ) ;
goto V_106;
}
if ( F_309 ( V_96 -> V_582 ) != V_337 -> V_156 . V_582 ) {
F_120 ( V_168 , L_74 ,
F_309 ( V_96 -> V_582 ) , V_337 -> V_156 . V_582 ) ;
goto V_106;
}
V_325 = V_559 ;
F_9 ( & V_5 -> V_14 -> V_22 ) ;
if ( V_5 -> V_10 . V_31 < V_255 ) {
unsigned int V_352 ;
V_352 = F_309 ( V_96 -> V_590 ) ;
V_352 = F_314 ( V_352 , V_406 ) ;
V_5 -> V_405 = V_352 ;
}
F_14 ( & V_5 -> V_14 -> V_22 ) ;
V_106:
...
void F_315 ( struct V_4 * V_5 , unsigned int line , const char * F_31 )
{
if ( ! F_316 ( V_596 , & V_5 -> V_43 ) ) {
F_317 ( & V_5 -> V_392 , V_617 + V_618 ) ;
V_5 -> V_619 . line = line ;
V_5 -> V_619 . F_31 = F_31 ;
}
}
...
{
if ( ! F_316 ( V_596 , & V_5 -> V_43 ) )
F_317 ( & V_5 -> V_392 , V_617 + 5 * V_618 ) ;
}
void F_319 ( struct V_4 * V_5 ) __must_hold( T_10 )
{
int V_154 ;
for ( V_154 = V_170 ; V_154 < V_171 ; V_154 ++ )
V_5 -> V_124 -> V_156 . V_160 [ V_154 + 1 ] = V_5 -> V_124 -> V_156 . V_160 [ V_154 ] ;
}
void F_320 ( struct V_4 * V_5 , int V_620 , T_2 V_200 ) __must_hold( T_10 )
{
if ( V_620 == V_158 ) {
if ( V_5 -> V_10 . V_341 == V_342 )
V_200 |= 1 ;
...
V_5 -> V_124 -> V_156 . V_160 [ V_620 ] = V_200 ;
F_318 ( V_5 ) ;
}
void F_322 ( struct V_4 * V_5 , int V_620 , T_2 V_200 ) __must_hold( T_10 )
{
unsigned long V_43 ;
F_23 ( & V_5 -> V_124 -> V_156 . V_157 , V_43 ) ;
F_320 ( V_5 , V_620 , V_200 ) ;
F_25 ( & V_5 -> V_124 -> V_156 . V_157 , V_43 ) ;
}
void F_98 ( struct V_4 * V_5 , int V_620 , T_2 V_200 ) __must_hold( T_10 )
{
unsigned long V_43 ;
F_23 ( & V_5 -> V_124 -> V_156 . V_157 , V_43 ) ;
if ( V_5 -> V_124 -> V_156 . V_160 [ V_620 ] ) {
F_319 ( V_5 ) ;
V_5 -> V_124 -> V_156 . V_160 [ V_170 ] = V_5 -> V_124 -> V_156 . V_160 [ V_620 ] ;
}
F_320 ( V_5 , V_620 , V_200 ) ;
F_25 ( & V_5 -> V_124 -> V_156 . V_157 , V_43 ) ;
}
void F_323 ( struct V_4 * V_5 ) __must_hold( T_10 )
{
T_2 V_200 ;
unsigned long long V_621 ;
F_97 ( & V_200 , sizeof( T_2 ) ) ;
F_9 ( & V_5 -> V_124 -> V_156 . V_157 ) ;
V_621 = V_5 -> V_124 -> V_156 . V_160 [ V_169 ] ;
if ( V_621 )
F_160 ( V_168 , L_75 , V_621 ) ;
V_5 -> V_124 -> V_156 . V_160 [ V_169 ] = V_5 -> V_124 -> V_156 . V_160 [ V_158 ] ;
F_320 ( V_5 , V_158 , V_200 ) ;
F_14 ( & V_5 -> V_124 -> V_156 . V_157 ) ;
F_93 ( V_5 , L_76 ) ;
F_99 ( V_5 ) ;
}
void F_324 ( struct V_4 * V_5 , T_2 V_200 ) __must_hold( T_10 )
{
unsigned long V_43 ;
...
unsigned long long V_621 = V_5 -> V_124 -> V_156 . V_160 [ V_169 ] ;
if ( V_621 )
F_160 ( V_168 , L_75 , V_621 ) ;
...
static int V_389 ( struct V_623 * V_38 , int V_447 )
{
struct V_383 * V_624 = F_208 ( V_38 , struct V_383 , V_38 ) ;
struct V_4 * V_5 = V_38 -> V_5 ;
int V_325 = - V_109 ;
F_96 ( F_218 ( & V_5 -> V_358 ) == 0 ) ;
if ( F_82 ( V_5 ) ) {
F_330 ( V_5 , V_624 -> V_625 , V_624 -> V_43 ) ;
V_325 = V_624 -> V_626 ( V_5 ) ;
F_331 ( V_5 ) ;
F_83 ( V_5 ) ;
}
F_332 ( V_627 , & V_5 -> V_43 ) ;
F_7 ( & V_5 -> V_12 ) ;
if ( V_624 -> V_628 )
V_624 -> V_628 ( V_5 , V_325 ) ;
F_161 ( V_629 , & V_5 -> V_43 ) ;
V_624 -> V_625 = NULL ;
V_624 -> V_43 = 0 ;
return 0 ;
}
void F_333 ( struct V_4 * V_5 )
{
F_211 ( V_5 -> V_451 ) ;
V_5 -> V_451 = NULL ;
F_211 ( V_5 -> V_450 ) ;
...
static int V_387 ( struct V_623 * V_38 , int V_447 )
{
struct V_4 * V_5 = V_38 -> V_5 ;
F_96 ( V_5 -> V_10 . V_11 == V_597 ) ;
if ( V_5 -> V_244 && V_5 -> V_124 ) {
if ( F_335 ( V_5 , F_131 ,
L_77 , V_631 ) ) {
if ( F_90 ( V_632 , & V_5 -> V_43 ) ) {
F_326 ( V_5 , V_245 ) ;
F_99 ( V_5 ) ;
}
}
}
F_336 ( V_5 , F_16 ( V_11 , V_355 ) ) ;
return 0 ;
}
void F_337 ( struct V_4 * V_5 ,
int (* V_626)( struct V_4 * ) ,
void (* V_628)( struct V_4 * , int ) ,
char * V_625 , enum V_633 V_43 )
{
F_96 ( V_45 == V_5 -> V_14 -> V_71 . V_54 ) ;
F_96 ( ! F_90 ( V_629 , & V_5 -> V_43 ) ) ;
F_96 ( ! F_90 ( V_627 , & V_5 -> V_43 ) ) ;
F_96 ( F_190 ( & V_5 -> V_383 . V_38 . V_378 ) ) ;
if ( V_5 -> V_383 . V_625 )
F_120 ( V_168 , L_78 ,
V_625 , V_5 -> V_383 . V_625 ) ;
V_5 -> V_383 . V_626 = V_626 ;
V_5 -> V_383 . V_628 = V_628 ;
V_5 -> V_383 . V_625 = V_625 ;
V_5 -> V_383 . V_43 = V_43 ;
F_9 ( & V_5 -> V_14 -> V_22 ) ;
F_151 ( V_627 , & V_5 -> V_43 ) ;
if ( F_218 ( & V_5 -> V_358 ) == 0 ) {
if ( ! F_316 ( V_629 , & V_5 -> V_43 ) )
F_338 ( & V_5 -> V_14 -> V_423 , & V_5 -> V_383 . V_38 ) ;
}
F_14 ( & V_5 -> V_14 -> V_22 ) ;
}
int F_339 ( struct V_4 * V_5 , int (* V_626)( struct V_4 * ) ,
char * V_625 , enum V_633 V_43 )
{
int V_325 ;
F_96 ( V_45 != V_5 -> V_14 -> V_71 . V_54 ) ;
...
void F_326 ( struct V_4 * V_5 , int V_635 ) __must_hold( T_10 )
{
if ( ( V_5 -> V_124 -> V_156 . V_43 & V_635 ) != V_635 ) {
F_318 ( V_5 ) ;
V_5 -> V_124 -> V_156 . V_43 |= V_635 ;
}
}
void F_132 ( struct V_4 * V_5 , int V_635 ) __must_hold( T_10 )
{
if ( ( V_5 -> V_124 -> V_156 . V_43 & V_635 ) != 0 ) {
F_318 ( V_5 ) ;
V_5 -> V_124 -> V_156 . V_43 &= ~ V_635 ;
}
}
int F_129 ( struct V_574 * V_337 , int V_635 )
{
return ( V_337 -> V_156 . V_43 & V_635 ) != 0 ;
}
static void V_396 ( unsigned long V_104 )
{
struct V_4 * V_5 = (struct V_4 * ) V_104 ;
if ( F_190 ( & V_5 -> V_381 . V_378 ) )
F_342 ( & V_5 -> V_14 -> V_423 , & V_5 -> V_381 ) ;
}
static int V_388 ( struct V_623 * V_38 , int V_447 )
{
struct V_4 * V_5 = V_38 -> V_5 ;
F_160 ( V_168 , L_79 ) ;
#ifdef F_343
F_160 ( V_168 , L_80 ,
V_5 -> V_619 . F_31 , V_5 -> V_619 . line ) ;
#endif
F_99 ( V_5 ) ;
return 0 ;
}
const char * F_344 ( enum V_85 V_86 )
{
static const char * V_636 [] = {
[ V_317 ] = L_81 ,
[ V_637 ] = L_82 ,
[ V_638 ] = L_83 ,
[ V_639 ] = L_84 ,
...
int F_345 ( struct V_4 * V_5 , struct V_665 * V_154 )
{
struct V_114 * V_115 ;
F_346 ( V_65 ) ;
long V_666 ;
...
V_666 = V_115 -> V_270 ? V_115 -> V_666 * V_618 / 10 * V_115 -> V_270 : V_668 ;
F_51 () ;
V_154 -> V_669 = true ;
F_347 ( & V_5 -> V_12 , & V_65 , V_670 ) ;
F_14 ( & V_5 -> V_14 -> V_22 ) ;
V_666 = F_348 ( V_666 ) ;
F_349 ( & V_5 -> V_12 , & V_65 ) ;
F_9 ( & V_5 -> V_14 -> V_22 ) ;
if ( ! V_666 || V_5 -> V_10 . V_31 < V_255 )
return - V_667 ;
if ( F_350 ( V_45 ) )
return - V_671 ;
return 0 ;
...
F_351 ( struct V_672 * V_673 )
{
long V_674 ;
if ( ! V_673 -> V_675 -- ) {
F_97 ( & V_674 , sizeof( V_674 ) ) ;
V_673 -> V_10 += V_674 ;
V_673 -> V_675 = V_676 ;
}
V_673 -> V_10 = V_673 -> V_10 * V_677 + V_678 ;
return F_352 ( V_673 -> V_10 ) ;
}
static char *
F_353 ( unsigned int type ) {
static char * V_679 [] = {
[ V_680 ] = L_130 ,
[ V_681 ] = L_131 ,
[ V_682 ] = L_132 ,
...
return ( type < V_690 ) ? V_679 [ type ] : L_140 ;
}
unsigned int
F_354 ( struct V_4 * V_5 , unsigned int type )
{
static struct V_672 V_691 = { 0 , 0 } ;
unsigned int V_692 = (
( V_693 == 0 ||
( ( 1 << F_50 ( V_5 ) ) & V_693 ) != 0 ) &&
( ( ( F_351 ( & V_691 ) % 100 ) + 1 ) <= V_694 ) ) ;
if ( V_692 ) {
V_695 ++ ;
if ( F_355 ( & V_696 ) )
F_160 ( V_168 , L_141 ,
...
const char * F_295 ( void )
{
static char V_697 [ 38 ] = L_142 ;
if ( V_697 [ 0 ] == 0 ) {
#ifdef F_288
sprintf ( V_697 , L_143 , V_59 -> V_698 ) ;
#else
V_697 [ 0 ] = 'b' ;
#endif
}
