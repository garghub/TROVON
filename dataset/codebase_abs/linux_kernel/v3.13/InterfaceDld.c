...
T_4 V_37 = 0 ;
if ( V_33 -> V_38 == NULL ) {
V_33 -> V_38 = F_2 ( sizeof( struct V_39 ) , V_13 ) ;
if ( V_33 -> V_38 == NULL )
return - V_14 ;
}
if ( V_35 -> V_40 != sizeof( struct V_39 ) )
return - V_31 ;
...
V_36 = F_21 ( V_33 , ( V_54 ) V_33 -> V_38 , sizeof( struct V_39 ) , V_30 ) ;
if ( V_36 )
...
int F_22 ( struct V_32 * V_33 , struct V_34 * V_35 )
{
int V_36 = V_27 ;
V_54 V_11 = NULL ;
F_23 ( & V_33 -> V_56 , false ) ;
if ( ! V_33 -> V_55 && V_35 -> V_57 != V_30 ) {
...
V_35 -> V_57 ) ;
if ( V_36 != V_27 ) {
F_7 ( V_33 , V_18 , V_19 , V_20 , L_16 , V_36 ) ;
goto error;
}
}
error:
...
static INT F_25 ( struct V_32 * V_33 , V_54 V_59 , T_5 V_40 , T_6 V_57 )
{
unsigned int V_7 = 0 ;
int V_36 = V_27 ;
V_7 = V_40 ;
...
static INT F_28 ( struct V_32 * V_33 , V_54 V_59 , T_5 V_40 , T_6 V_57 )
{
T_5 V_7 = V_40 ;
INT V_36 = V_27 ;
V_54 V_60 = F_24 ( V_12 , V_13 ) ;
int V_28 ;
if ( NULL == V_60 ) {
F_7 ( V_33 , V_18 , V_19 , V_20 , L_18 ) ;
return - V_14 ;
}
while ( V_40 && ! V_36 ) {
V_7 = F_26 ( V_40 , V_12 ) ;
V_28 = F_29 ( V_33 , V_57 , V_60 , V_7 ) ;
if ( V_28 < 0 ) {
V_36 = V_28 ;
F_7 ( V_33 , V_18 , V_19 , V_20 , L_19 , V_36 ) ;
break;
}
if ( memcmp ( V_60 , V_59 , V_7 ) != 0 ) {
F_30 ( L_20 ,
V_61 ) ;
V_36 = - V_31 ;
}
...
INT F_21 ( struct V_32 * V_33 , unsigned char * V_59 , unsigned int V_40 , unsigned long V_57 )
{
INT V_62 = V_27 ;
V_62 = F_25 ( V_33 , V_59 , V_40 , V_57 ) ;
if ( V_62 != V_27 ) {
F_7 ( V_33 , V_18 , V_19 , V_20 , L_21 ) ;
goto error;
}
V_62 = F_28 ( V_33 , V_59 , V_40 , V_57 ) ;
if ( V_62 != V_27 ) {
