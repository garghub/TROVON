...
static T_5 F_65 ( struct V_105 * V_106 , char * V_103 )
{
return sprintf ( V_103 , L_15 , V_15 . V_24 ) ;
}
static T_5 F_66 ( struct V_105 * V_106 , const char * V_103 ,
T_1 V_3 )
{
unsigned long V_10 ;
F_7 ( & V_15 . V_16 , V_10 ) ;
...
static void F_53 ( void ) {}
static void F_67 ( void ) { }
int F_68 ( struct V_7 * V_112 , struct V_113 * V_114 )
{
...
int V_13 = 0 ;
if ( V_114 -> V_117 )
V_115 = V_118 + F_69 ( V_114 -> V_117 ) ;
while ( true ) {
V_116 = F_70 ( V_119 , V_114 -> V_10 ,
V_112 -> V_120 ,
...
( V_114 -> V_117 && F_71 ( V_115 , V_118 ) ) )
break;
F_72 ( V_49 , L_16 , V_89 , V_116 ) ;
}
switch ( V_116 ) {
case V_98 :
V_13 = 0 ;
...
static struct V_137 * F_73 ( struct V_7 * V_49 )
{
const T_6 * V_138 ;
struct V_137 * V_139 ;
...
if ( ! V_138 )
return NULL ;
V_139 = F_74 ( sizeof( * V_139 ) , V_91 ) ;
if ( V_139 == NULL )
return NULL ;
F_75 ( V_49 -> V_49 . V_4 , V_138 ,
...
static const struct V_148 * F_77 (
...
int F_83 ( struct V_81 * V_82 , struct V_156 * V_157 ,
const char * V_158 )
{
F_84 ( L_18 , V_89 , V_82 -> V_159 ) ;
V_82 -> V_83 . V_159 = V_82 -> V_159 ;
V_82 -> V_83 . V_160 = V_82 -> V_160 ;
V_82 -> V_83 . V_161 = & V_107 ;
V_82 -> V_83 . V_157 = V_157 ;
V_82 -> V_83 . V_158 = V_158 ;
return F_85 ( & V_82 -> V_83 ) ;
}
void F_86 ( struct V_81 * V_82 )
{
F_87 ( & V_82 -> V_83 ) ;
}
static void F_88 ( struct V_48 * V_49 )
{
struct V_137 * V_139 = F_89 ( V_49 ) ;
if ( V_139 )
F_90 ( V_139 , F_91 ( V_49 -> V_4 ) ) ;
F_5 ( V_49 -> V_4 ) ;
F_49 ( F_24 ( V_49 ) ) ;
}
struct V_7 * F_92 ( struct V_1 * V_4 )
{
struct V_7 * V_8 ;
struct V_1 * V_162 ;
const T_6 * V_6 ;
...
if ( V_85 == V_87 ) {
if ( F_40 ( V_4 , L_24 , NULL ) ) {
F_84 ( L_25 ,
V_89 , V_164 ) ;
return NULL ;
}
}
V_8 = F_74 ( sizeof( struct V_7 ) , V_91 ) ;
if ( V_8 == NULL ) {
F_94 ( L_26 , V_89 ) ;
return NULL ;
}
...
V_166 = F_95 ( V_6 , 1 ) ;
F_96 ( & V_8 -> V_49 , L_31 , V_166 ) ;
V_8 -> V_167 = F_97 ( V_4 , 0 ) ;
V_8 -> V_166 = V_166 ;
} else {
V_6 = F_40 ( V_4 , L_32 , NULL ) ;
if ( V_6 != NULL )
V_8 -> V_120 = F_95 ( V_6 , 1 ) ;
F_96 ( & V_8 -> V_49 , L_33 , V_164 ) ;
V_8 -> type = V_164 ;
V_8 -> V_167 = 0 ;
}
V_8 -> V_159 = V_4 -> V_159 ;
V_8 -> V_49 . V_4 = F_98 ( V_4 ) ;
F_99 ( & V_8 -> V_49 , F_100 ( V_4 ) ) ;
...
if ( V_172 ) {
V_173 = F_107 ( V_172 , NULL ) ;
while ( V_173 ) {
F_92 ( V_173 ) ;
V_173 = F_107 ( V_172 , V_173 ) ;
}
F_5 ( V_172 ) ;
}
}
...
struct V_101 * V_102 , char * V_103 )
{
return sprintf ( V_103 , L_38 , F_24 ( V_49 ) -> V_159 ) ;
}
static T_5 F_112 ( struct V_48 * V_49 ,
struct V_101 * V_102 , char * V_103 )
{
struct V_1 * V_4 = V_49 -> V_4 ;
return sprintf ( V_103 , L_38 , F_91 ( V_4 ) ) ;
}
...
V_176 = F_40 ( V_175 , L_40 , NULL ) ;
if ( ! V_176 ) {
strcpy ( V_103 , L_39 ) ;
return strlen ( V_103 ) ;
}
return sprintf ( V_103 , L_41 , V_7 -> type , V_176 ) ;
}
void F_114 ( struct V_7 * V_8 )
{
F_115 ( & V_8 -> V_49 ) ;
}
static int F_116 ( struct V_48 * V_49 , struct V_177 * V_178 )
{
const struct V_7 * V_7 = F_24 ( V_49 ) ;
struct V_81 * V_179 = F_39 ( V_178 ) ;
const struct V_148 * V_149 = V_179 -> V_154 ;
return ( V_149 != NULL ) && ( F_77 ( V_149 , V_7 ) != NULL ) ;
}
static int F_117 ( struct V_48 * V_49 , struct V_180 * V_181 )
{
const struct V_7 * V_7 = F_24 ( V_49 ) ;
struct V_1 * V_175 ;
const char * V_176 ;
...
if ( ! V_176 )
return - V_152 ;
F_118 ( V_181 , L_42 , V_7 -> type , V_176 ) ;
return 0 ;
}
const void * F_119 ( struct V_7 * V_112 , char * V_182 , int * V_72 )
{
return F_40 ( V_112 -> V_49 . V_4 , V_182 , V_72 ) ;
}
static struct V_7 * F_120 ( const char * V_159 )
{
struct V_48 * V_79 ;
V_79 = F_121 ( & V_107 , NULL , V_159 ) ;
if ( ! V_79 )
return NULL ;
return F_24 ( V_79 ) ;
}
struct V_7 * F_122 ( struct V_1 * V_183 )
{
char V_184 [ 20 ] ;
struct V_1 * V_185 ;
const char * V_186 ;
...
if ( ! V_185 )
return NULL ;
V_186 = F_40 ( V_185 , L_43 , NULL ) ;
F_5 ( V_185 ) ;
if ( ! V_186 )
return NULL ;
if ( ! strcmp ( V_186 , L_1 ) ) {
const T_6 * V_6 ;
V_6 = F_40 ( V_183 , L_29 , NULL ) ;
if ( ! V_6 )
return NULL ;
...
{
int V_188 = F_124 ( V_49 -> V_166 , V_189 ) ;
if ( V_188 != V_98 )
...
{
int V_188 = F_124 ( V_49 -> V_166 , V_190 ) ;
if ( V_188 != V_98 )
F_58 ( V_99 L_45 , V_188 ) ;
return V_188 ;
}
