...
int F_69 ( struct V_66 * V_66 , int V_95 )
{
struct V_1 * V_2 = V_66 -> V_2 ;
if ( V_95 )
return 0 ;
...
{
struct V_66 * V_66 ;
V_66 = F_75 ( sizeof( * V_66 ) , V_97 ) ;
if ( ! V_66 )
return - V_98 ;
V_66 -> V_99 = F_76 ( L_34 , 0 , 0 , F_77 ( V_2 ) ) ;
if ( ! V_66 -> V_99 )
goto abort;
V_66 -> V_2 = V_2 ;
F_78 ( & V_66 -> V_100 ) ;
F_79 ( & V_66 -> V_101 , V_102 ) ;
V_2 -> V_66 = V_66 ;
return 0 ;
abort:
F_80 ( V_66 ) ;
...
F_85 ( V_2 , L_35 ) ;
F_85 ( V_2 , L_36 ,
F_86 ( V_105 ) , V_105 -> V_18 ) ;
F_85 ( V_2 , L_37 , V_105 -> V_106 ) ;
F_85 ( V_2 , L_38 , V_105 -> V_107 ) ;
F_85 ( V_2 , L_39 ,
V_105 -> V_108 ) ;
F_85 ( V_2 , L_40 ,
V_105 -> V_109 ) ;
...
F_85 ( V_2 , L_43 , V_2 -> V_112 ) ;
F_85 ( V_2 , L_44 , F_77 ( V_2 ) ) ;
F_85 ( V_2 , L_45 ,
F_65 ( V_2 ) ? L_46 : L_47 ) ;
F_85 ( V_2 , L_48 ,
F_88 ( V_2 ) ? L_46 : L_47 ) ;
...
struct V_1 * F_92 ( struct V_113 * V_6 )
{
struct V_1 * V_2 ;
T_2 V_112 , V_114 ;
struct V_5 * V_105 = V_6 -> V_8 ;
V_2 = F_75 ( sizeof( * V_2 ) , V_97 ) ;
if ( ! V_2 ) {
F_93 ( & V_6 -> V_107 , L_57 , V_36 ) ;
goto abort;
}
V_2 -> V_7 = V_6 ;
...
F_84 ( V_2 ) ;
if ( F_28 ( V_2 ) ||
! ( F_88 ( V_2 ) | F_89 ( V_2 ) | F_90 ( V_2 ) | F_91 ( V_2 ) ) )
V_2 -> V_38 = 1 ;
