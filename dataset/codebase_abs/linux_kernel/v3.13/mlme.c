...
struct V_7 * V_8 ,
struct V_46 * V_47 , bool V_116 ,
unsigned int V_117 , const T_1 * V_5 , T_2 V_6 ,
bool V_118 , bool V_119 , T_6 * V_120 )
{
...
if ( V_6 < 24 + 1 )
return - V_62 ;
V_14 = ( const struct V_13 * ) V_5 ;
if ( ! F_77 ( V_14 -> V_33 ) )
return - V_62 ;
V_121 = F_4 ( V_14 -> V_33 ) & V_102 ;
if ( ! ( V_8 -> V_10 -> V_98 [ V_8 -> V_103 ] . V_123 & F_62 ( V_121 >> 4 ) ) )
return - V_62 ;
if ( F_78 ( V_14 -> V_33 ) &&
V_14 -> V_16 . V_124 . V_125 != V_126 ) {
int V_60 = 0 ;
F_79 ( V_8 ) ;
switch ( V_8 -> V_103 ) {
case V_127 :
...
return - V_62 ;
return F_82 ( V_12 , V_8 , V_47 , V_116 ,
V_117 , V_5 , V_6 , V_118 , V_119 ,
V_120 ) ;
}
bool F_83 ( struct V_7 * V_8 , int V_136 , int V_137 ,
const T_1 * V_5 , T_2 V_6 , T_5 V_138 , T_4 V_39 )
{
struct V_10 * V_10 = V_8 -> V_10 ;
struct V_11 * V_12 = F_2 ( V_10 ) ;
struct V_94 * V_95 ;
...
F_67 ( V_100 | V_102 ) ;
T_3 V_121 ;
F_84 ( V_8 , V_136 , V_137 ) ;
V_121 = ( F_4 ( V_14 -> V_33 ) & V_102 ) >> 4 ;
if ( ! ( V_140 -> V_104 & F_62 ( V_121 ) ) ) {
F_85 ( false ) ;
return false ;
}
V_43 = V_5 + F_86 ( V_14 -> V_33 ) ;
V_141 = V_6 - F_86 ( V_14 -> V_33 ) ;
F_64 ( & V_8 -> V_106 ) ;
F_65 (reg, &wdev->mgmt_registrations, list) {
if ( V_95 -> V_91 != V_143 )
continue;
...
int V_155 , V_72 ;
V_146 = F_89 ( V_145 , struct V_146 , V_145 ) ;
V_12 = F_89 ( V_146 , struct V_11 ,
V_156 ) ;
V_10 = & V_12 -> V_10 ;
F_90 () ;
for ( V_155 = 0 ; V_155 < V_157 ; V_155 ++ ) {
V_150 = V_10 -> V_158 [ V_155 ] ;
if ( ! V_150 )
continue;
for ( V_72 = 0 ; V_72 < V_150 -> V_159 ; V_72 ++ ) {
V_151 = & V_150 -> V_160 [ V_72 ] ;
if ( V_151 -> V_161 != V_162 )
continue;
V_153 = V_151 -> V_163 + F_91 (
V_164 ) ;
if ( F_92 ( V_165 , V_153 ) ) {
V_151 -> V_161 = V_166 ;
V_151 -> V_163 = V_165 ;
...
V_154 = F_66 ( V_154 , V_153 - V_165 ) ;
V_152 = true ;
}
}
F_95 () ;
if ( V_152 )
F_96 ( V_170 , & V_12 -> V_156 ,
V_154 ) ;
}
...
unsigned long V_153 ;
F_98 ( V_10 , V_148 ) ;
F_99 ( V_10 , V_148 , V_162 ) ;
V_153 = F_91 ( V_164 ) ;
F_96 ( V_170 , & V_12 -> V_156 ,
V_153 ) ;
F_94 ( V_12 , V_148 , V_171 , NULL , V_39 ) ;
}
void F_100 ( struct V_1 * V_24 ,
enum V_172 V_173 , T_4 V_39 )
{
...
if ( F_22 ( ! V_8 -> V_66 ) )
return;
F_93 ( & V_148 , V_8 -> V_66 , V_167 ) ;
switch ( V_173 ) {
case V_175 :
V_153 = V_8 -> V_176 +
F_91 ( V_177 ) ;
F_22 ( ! F_92 ( V_165 , V_153 ) ) ;
F_99 ( V_10 , & V_148 , V_178 ) ;
break;
case V_179 :
break;
default:
...
V_8 -> V_174 = false ;
F_94 ( V_12 , & V_148 , V_173 , V_24 , V_39 ) ;
}
