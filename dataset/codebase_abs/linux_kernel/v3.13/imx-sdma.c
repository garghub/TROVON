...
struct V_151 * V_152 , T_2 V_185 , T_5 V_186 ,
T_5 V_187 , enum V_171 V_123 ,
unsigned long V_34 , void * V_122 )
{
struct V_6 * V_7 = F_34 ( V_152 ) ;
struct V_1 * V_2 = V_7 -> V_2 ;
...
static int F_47 ( struct V_151 * V_152 , enum V_190 V_191 ,
unsigned long V_192 )
{
struct V_6 * V_7 = F_34 ( V_152 ) ;
...
return 0 ;
case V_196 :
if ( V_194 -> V_123 == V_124 ) {
V_7 -> V_138 = V_194 -> V_197 ;
V_7 -> V_125 = V_194 -> V_198 *
V_194 -> V_199 ;
V_7 -> V_178 = V_194 -> V_199 ;
} else {
V_7 -> V_138 = V_194 -> V_200 ;
V_7 -> V_125 = V_194 -> V_201 *
V_194 -> V_202 ;
V_7 -> V_178 = V_194 -> V_202 ;
}
V_7 -> V_123 = V_194 -> V_123 ;
return F_31 ( V_7 ) ;
default:
return - V_203 ;
}
...
static enum V_204 F_48 ( struct V_151 * V_152 ,
T_4 V_155 ,
struct V_205 * V_206 )
{
struct V_6 * V_7 = F_34 ( V_152 ) ;
F_49 ( V_206 , V_152 -> V_207 , V_152 -> V_155 ,
V_7 -> V_175 - V_7 -> V_60 ) ;
return V_7 -> V_41 ;
}
...
{
T_6 * V_210 = ( T_1 * ) V_209 ;
T_6 * V_211 = ( T_1 * ) V_2 -> V_79 ;
int V_59 ;
for ( V_59 = 0 ; V_59 < V_212 ; V_59 ++ )
if ( V_210 [ V_59 ] > 0 )
V_211 [ V_59 ] = V_210 [ V_59 ] ;
}
static void F_52 ( const struct V_213 * V_214 , void * V_122 )
{
...
if ( V_214 -> V_27 < sizeof( * V_216 ) )
goto V_218;
V_216 = (struct V_215 * ) V_214 -> V_63 ;
if ( V_216 -> V_219 != V_220 )
goto V_218;
if ( V_216 -> V_221 + V_216 -> V_222 > V_214 -> V_27 )
goto V_218;
V_209 = ( void * ) V_216 + V_216 -> V_223 ;
V_217 = ( void * ) V_216 + V_216 -> V_221 ;
F_39 ( V_2 -> V_164 ) ;
F_39 ( V_2 -> V_165 ) ;
F_13 ( V_2 , V_217 ,
V_216 -> V_222 ,
...
for ( V_59 = 0 ; V_59 < V_232 ; V_59 ++ )
F_6 ( 0 , V_2 -> V_16 + V_142 + V_59 * 4 ) ;
V_21 = F_33 ( & V_2 -> V_11 [ 0 ] ) ;
if ( V_21 )
goto V_234;
F_2 ( & V_2 -> V_11 [ 0 ] , false , true , false ) ;
F_6 ( 0x4050 , V_2 -> V_16 + V_235 ) ;
F_6 ( 0 , V_2 -> V_16 + V_236 ) ;
F_6 ( V_230 , V_2 -> V_16 + V_231 ) ;
F_6 ( V_237 , V_2 -> V_16 + V_236 ) ;
F_32 ( & V_2 -> V_11 [ 0 ] , 7 ) ;
F_42 ( V_2 -> V_164 ) ;
F_42 ( V_2 -> V_165 ) ;
return 0 ;
...
static bool F_58 ( struct V_151 * V_152 , void * V_238 )
{
struct V_157 * V_63 = V_238 ;
if ( ! F_59 ( V_152 ) )
return false ;
V_152 -> V_158 = V_63 ;
return true ;
}
static struct V_151 * F_60 ( struct V_239 * V_240 ,
struct V_241 * V_242 )
{
struct V_1 * V_2 = V_242 -> V_243 ;
T_8 V_244 = V_2 -> V_245 . V_246 ;
struct V_157 V_63 ;
if ( V_240 -> V_247 != 3 )
return NULL ;
V_63 . V_163 = V_240 -> args [ 0 ] ;
V_63 . V_71 = V_240 -> args [ 1 ] ;
V_63 . V_139 = V_240 -> args [ 2 ] ;
return F_61 ( V_244 , F_58 , & V_63 ) ;
}
static int T_7 F_62 ( struct V_248 * V_249 )
{
const struct V_250 * V_251 =
F_63 ( V_252 , & V_249 -> V_24 ) ;
struct V_253 * V_254 = V_249 -> V_24 . V_255 ;
const char * V_227 ;
int V_21 ;
int V_65 ;
struct V_256 * V_257 ;
struct V_258 * V_259 = F_64 ( & V_249 -> V_24 ) ;
int V_59 ;
struct V_1 * V_2 ;
T_6 * V_211 ;
const struct V_260 * V_5 = NULL ;
if ( V_251 )
V_5 = V_251 -> V_63 ;
else if ( V_249 -> V_261 )
V_5 = ( void * ) V_249 -> V_261 -> V_262 ;
if ( ! V_5 ) {
F_12 ( & V_249 -> V_24 , L_20 ) ;
return - V_15 ;
}
V_21 = F_65 ( & V_249 -> V_24 , F_66 ( 32 ) ) ;
if ( V_21 )
return V_21 ;
...
V_2 -> V_24 = & V_249 -> V_24 ;
V_2 -> V_5 = V_5 ;
V_257 = F_69 ( V_249 , V_263 , 0 ) ;
V_65 = F_70 ( V_249 , 0 ) ;
if ( ! V_257 || V_65 < 0 ) {
V_21 = - V_15 ;
goto V_264;
}
if ( ! F_71 ( V_257 -> V_265 , F_72 ( V_257 ) , V_249 -> V_266 ) ) {
V_21 = - V_143 ;
goto V_267;
}
V_2 -> V_164 = F_73 ( & V_249 -> V_24 , L_21 ) ;
if ( F_74 ( V_2 -> V_164 ) ) {
V_21 = F_75 ( V_2 -> V_164 ) ;
goto V_268;
}
V_2 -> V_165 = F_73 ( & V_249 -> V_24 , L_22 ) ;
if ( F_74 ( V_2 -> V_165 ) ) {
V_21 = F_75 ( V_2 -> V_165 ) ;
goto V_268;
}
F_76 ( V_2 -> V_164 ) ;
F_76 ( V_2 -> V_165 ) ;
V_2 -> V_16 = F_77 ( V_257 -> V_265 , F_72 ( V_257 ) ) ;
if ( ! V_2 -> V_16 ) {
V_21 = - V_36 ;
goto V_269;
}
V_21 = F_78 ( V_65 , F_24 , 0 , L_23 , V_2 ) ;
if ( V_21 )
goto V_270;
...
for ( V_59 = 0 ; V_59 < V_212 ; V_59 ++ )
V_211 [ V_59 ] = - V_15 ;
F_79 ( V_272 , V_2 -> V_245 . V_246 ) ;
F_79 ( V_273 , V_2 -> V_245 . V_246 ) ;
F_80 ( & V_2 -> V_245 . V_274 ) ;
for ( V_59 = 0 ; V_59 < V_232 ; V_59 ++ ) {
struct V_6 * V_7 = & V_2 -> V_11 [ V_59 ] ;
V_7 -> V_2 = V_2 ;
F_68 ( & V_7 -> V_156 ) ;
V_7 -> V_152 . V_275 = & V_2 -> V_245 ;
F_81 ( & V_7 -> V_152 ) ;
V_7 -> V_11 = V_59 ;
F_82 ( & V_7 -> V_68 , F_23 ,
( unsigned long ) V_7 ) ;
if ( V_59 )
F_83 ( & V_7 -> V_152 . V_253 ,
& V_2 -> V_245 . V_274 ) ;
}
V_21 = F_57 ( V_2 ) ;
if ( V_21 )
...
F_51 ( V_2 , V_259 -> V_79 ) ;
if ( V_259 ) {
V_21 = F_55 ( V_2 , V_259 -> V_227 ) ;
if ( V_21 )
F_84 ( & V_249 -> V_24 , L_24 ) ;
} else {
V_21 = F_85 ( V_254 , L_25 ,
& V_227 ) ;
if ( V_21 )
F_84 ( & V_249 -> V_24 , L_26 ) ;
else {
V_21 = F_55 ( V_2 , V_227 ) ;
if ( V_21 )
F_84 ( & V_249 -> V_24 , L_27 ) ;
}
}
V_2 -> V_245 . V_24 = & V_249 -> V_24 ;
V_2 -> V_245 . V_277 = F_38 ;
V_2 -> V_245 . V_278 = F_41 ;
V_2 -> V_245 . V_279 = F_48 ;
V_2 -> V_245 . V_280 = F_43 ;
V_2 -> V_245 . V_281 = F_46 ;
V_2 -> V_245 . V_282 = F_47 ;
V_2 -> V_245 . V_283 = F_50 ;
V_2 -> V_245 . V_24 -> V_284 = & V_2 -> V_284 ;
F_86 ( V_2 -> V_245 . V_24 , 65535 ) ;
V_21 = F_87 ( & V_2 -> V_245 ) ;
if ( V_21 ) {
F_12 ( & V_249 -> V_24 , L_28 ) ;
goto V_276;
}
if ( V_254 ) {
V_21 = F_88 ( V_254 , F_60 , V_2 ) ;
if ( V_21 ) {
F_12 ( & V_249 -> V_24 , L_29 ) ;
goto V_285;
}
}
F_53 ( V_2 -> V_24 , L_30 ) ;
