...
enum V_227 V_2 , struct V_187 * * V_70 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
struct V_187 * V_161 ;
...
break;
case V_188 :
if ( V_161 -> V_172 . V_2 != V_229 )
V_44 = - V_45 ;
else if ( F_61 ( & V_161 -> V_177 ) )
V_44 = - V_164 ;
break;
case V_229 :
if ( V_161 -> V_172 . V_2 != V_188 )
V_44 = - V_45 ;
break;
default:
V_44 = - V_45 ;
...
{
return V_123 < V_32 -> V_60 . V_230 [ V_231 ] ;
}
static int F_86 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_44 ;
int V_35 ;
...
if ( V_44 )
return V_44 ;
V_44 = F_89 ( V_32 , V_35 , V_236 , & V_197 ) ;
if ( V_44 ) {
...
static int F_93 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_44 = - V_45 ;
int V_197 ;
...
static int F_96 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_44 = - V_45 ;
int V_218 ;
...
static int F_100 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_226 ;
int V_44 ;
...
static int F_103 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_240 ;
int V_44 ;
...
if ( V_44 )
break;
V_44 = F_104 ( V_32 , & V_240 ) ;
if ( V_44 ) {
F_11 ( V_32 , V_33 , V_22 , 1 , 0 ) ;
break;
}
V_44 = F_57 ( V_32 , V_33 , V_240 , 1 , V_22 , 0 ) ;
if ( V_44 ) {
F_11 ( V_32 , V_33 , V_22 , 1 , 0 ) ;
F_105 ( V_32 , V_240 ) ;
break;
...
static int F_106 ( struct V_31 * V_32 , int V_33 , T_1 V_241 , int V_36 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
struct V_242 * V_11 ;
...
static void F_107 ( struct V_31 * V_32 , int V_33 , T_1 V_241 ,
int V_36 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
struct V_243 * V_244 =
& V_200 -> V_81 [ V_33 ] . V_86 [ V_25 ] ;
struct V_242 * V_11 , * V_245 ;
F_108 (res, tmp, mac_list, list) {
if ( V_11 -> V_241 == V_241 && V_11 -> V_36 == ( T_2 ) V_36 ) {
F_74 ( & V_11 -> V_202 ) ;
F_11 ( V_32 , V_33 , V_25 , 1 , V_36 ) ;
F_25 ( V_11 ) ;
break;
...
F_108 (res, tmp, mac_list, list) {
F_74 ( & V_11 -> V_202 ) ;
F_110 ( V_32 , V_11 -> V_36 , V_11 -> V_241 ) ;
F_11 ( V_32 , V_33 , V_25 , 1 , V_11 -> V_36 ) ;
F_25 ( V_11 ) ;
}
}
static int F_111 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 , int V_246 )
{
int V_44 = - V_45 ;
int V_36 ;
T_1 V_241 ;
if ( V_232 != V_239 )
return V_44 ;
V_36 = ! V_246 ? F_87 ( V_235 ) : V_246 ;
V_241 = V_234 ;
V_44 = F_112 ( V_32 , V_36 , V_241 ) ;
if ( V_44 >= 0 ) {
F_91 ( V_235 , V_44 ) ;
V_44 = 0 ;
}
if ( ! V_44 ) {
V_44 = F_106 ( V_32 , V_33 , V_241 , V_36 ) ;
if ( V_44 )
F_110 ( V_32 , V_36 , V_241 ) ;
}
return V_44 ;
}
static int F_113 ( struct V_31 * V_32 , int V_33 , T_4 V_247 ,
int V_36 , int V_148 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
...
struct V_249 * V_11 , * V_245 ;
F_108 (res, tmp, vlan_list, list) {
if ( V_11 -> V_247 == V_247 && V_11 -> V_36 == ( T_2 ) V_36 ) {
++ V_11 -> V_177 ;
return 0 ;
}
}
...
static void F_114 ( struct V_31 * V_32 , int V_33 , T_4 V_247 ,
int V_36 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
...
F_115 ( V_32 , V_11 -> V_36 , V_11 -> V_247 ) ;
F_11 ( V_32 , V_33 , V_26 , 1 , V_11 -> V_36 ) ;
F_25 ( V_11 ) ;
}
}
static int F_116 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 , int V_246 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_250 * V_251 = V_38 -> V_41 . V_42 . V_251 ;
int V_44 ;
T_4 V_247 ;
int V_148 ;
int V_36 ;
...
if ( ! V_36 || V_232 != V_239 )
return - V_45 ;
if ( ! V_246 && V_36 > 0 && V_36 <= V_32 -> V_60 . V_252 ) {
V_251 [ V_33 ] . V_253 = true ;
return 0 ;
}
V_247 = ( T_4 ) V_234 ;
V_44 = F_117 ( V_32 , V_36 , V_247 , & V_148 ) ;
if ( ! V_44 ) {
F_91 ( V_235 , ( T_3 ) V_148 ) ;
V_44 = F_113 ( V_32 , V_33 , V_247 , V_36 , V_148 ) ;
if ( V_44 )
F_115 ( V_32 , V_36 , V_247 ) ;
}
return V_44 ;
}
static int F_118 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
T_3 V_218 ;
int V_44 ;
...
static int F_121 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
T_3 V_254 ;
int V_44 ;
if ( V_232 != V_237 )
return - V_45 ;
V_44 = F_122 ( V_32 , & V_254 ) ;
if ( V_44 )
return V_44 ;
V_44 = F_57 ( V_32 , V_33 , V_254 , 1 , V_30 , 0 ) ;
if ( V_44 )
F_123 ( V_32 , V_254 ) ;
else
F_91 ( V_235 , V_254 ) ;
...
{
int V_44 ;
int V_259 = V_256 -> V_260 ;
switch ( V_256 -> V_261 & 0xFF ) {
case V_20 :
V_44 = F_86 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_24 :
V_44 = F_93 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_23 :
V_44 = F_96 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_21 :
V_44 = F_100 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_22 :
V_44 = F_103 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_25 :
V_44 = F_111 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ,
( V_256 -> V_261 >> 8 ) & 0xFF ) ;
break;
case V_26 :
V_44 = F_116 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ,
( V_256 -> V_261 >> 8 ) & 0xFF ) ;
break;
case V_28 :
V_44 = F_118 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_30 :
V_44 = F_121 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
default:
V_44 = - V_45 ;
...
static int F_125 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 )
{
int V_44 ;
int V_35 ;
...
static int F_127 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_44 = - V_45 ;
int V_197 ;
...
static int F_128 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 )
{
int V_44 = - V_45 ;
int V_218 ;
...
static int F_130 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_226 ;
int V_44 ;
...
static int F_131 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_240 ;
int V_44 ;
...
case V_239 :
V_240 = F_87 ( & V_234 ) ;
V_44 = F_73 ( V_32 , V_33 , V_240 , 1 , V_22 , 0 ) ;
if ( V_44 )
break;
F_11 ( V_32 , V_33 , V_22 , 1 , 0 ) ;
F_105 ( V_32 , V_240 ) ;
...
static int F_132 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 , int V_246 )
{
int V_36 ;
int V_44 = 0 ;
...
case V_239 :
V_36 = ! V_246 ? F_87 ( V_235 ) : V_246 ;
F_107 ( V_32 , V_33 , V_234 , V_36 ) ;
F_110 ( V_32 , V_36 , V_234 ) ;
break;
default:
V_44 = - V_45 ;
break;
...
static int F_133 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 , int V_36 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_250 * V_251 = V_38 -> V_41 . V_42 . V_251 ;
int V_44 = 0 ;
...
if ( ! V_36 )
return - V_45 ;
F_114 ( V_32 , V_33 , V_234 , V_36 ) ;
F_115 ( V_32 , V_36 , V_234 ) ;
break;
default:
V_44 = - V_45 ;
break;
...
static int F_134 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_218 ;
int V_44 ;
...
static int F_135 ( struct V_31 * V_32 , int V_33 , int V_232 , int V_233 ,
T_1 V_234 , T_1 * V_235 )
{
int V_254 ;
int V_44 ;
...
return - V_45 ;
V_254 = F_87 ( & V_234 ) ;
V_44 = F_73 ( V_32 , V_33 , V_254 , 1 , V_30 , 0 ) ;
if ( V_44 )
return V_44 ;
F_123 ( V_32 , V_254 ) ;
return V_44 ;
...
switch ( V_256 -> V_261 & 0xFF ) {
case V_20 :
V_44 = F_125 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 ) ;
break;
case V_24 :
V_44 = F_127 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_23 :
V_44 = F_128 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 ) ;
break;
case V_21 :
V_44 = F_130 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_22 :
V_44 = F_131 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_25 :
V_44 = F_132 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ,
( V_256 -> V_261 >> 8 ) & 0xFF ) ;
break;
case V_26 :
V_44 = F_133 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ,
( V_256 -> V_261 >> 8 ) & 0xFF ) ;
break;
case V_28 :
V_44 = F_134 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
break;
case V_30 :
V_44 = F_135 ( V_32 , V_33 , V_256 -> V_260 , V_259 ,
V_256 -> V_234 , & V_256 -> V_235 ) ;
default:
break;
}
...
static int F_137 ( struct V_262 * V_75 )
{
return ( F_33 ( V_75 -> V_114 ) >> 9 ) & 1 ;
}
static int F_138 ( struct V_262 * V_75 )
{
return ( int ) F_139 ( V_75 -> V_263 ) & 0xfffffff8 ;
}
static int F_140 ( struct V_262 * V_75 )
{
return F_33 ( V_75 -> V_264 ) ;
}
static T_3 F_141 ( struct V_262 * V_75 )
{
return F_33 ( V_75 -> V_265 ) & 0x00ffffff ;
}
static int F_142 ( struct V_262 * V_75 )
{
return F_33 ( V_75 -> V_265 ) & V_266 ;
}
static int F_143 ( struct V_262 * V_75 )
{
return F_33 ( V_75 -> V_114 ) & V_267 ;
}
static int F_144 ( struct V_262 * V_75 )
{
return F_33 ( V_75 -> V_114 ) & V_268 ;
}
static int F_145 ( struct V_108 * V_124 )
{
return F_33 ( V_124 -> V_269 ) & 0xfffffff8 ;
}
static int F_146 ( struct V_270 * V_271 )
{
return F_33 ( V_271 -> V_269 ) & 0xfffffff8 ;
}
static int F_147 ( struct V_108 * V_124 )
{
int V_272 = ( V_124 -> V_273 & 0x3f ) + 12 ;
int V_274 = ( V_124 -> V_275 >> 3 ) & 0xf ;
int V_276 = V_124 -> V_275 & 7 ;
int V_277 = ( V_124 -> V_278 >> 3 ) & 0xf ;
int V_279 = V_124 -> V_278 & 7 ;
int V_70 = ( F_33 ( V_124 -> V_240 ) >> 24 ) & 1 ;
int V_280 = ( F_33 ( V_124 -> V_114 ) >> 13 ) & 1 ;
T_3 V_113 = ( F_33 ( V_124 -> V_114 ) >> 16 ) & 0xff ;
int V_281 = ( V_113 == V_282 ) ? 1 : 0 ;
int V_283 ;
int V_284 ;
int V_285 ;
int V_286 ;
int V_287 = ( F_33 ( V_124 -> V_288 ) >> 6 ) & 0x3f ;
V_283 = 1 << ( V_274 + V_276 + 4 ) ;
V_284 = ( V_70 | V_280 | V_281 ) ? 0 : ( 1 << ( V_277 + V_279 + 4 ) ) ;
V_286 = V_283 + V_284 ;
V_285 =
F_148 ( ( V_286 + ( V_287 << 6 ) ) >>
V_272 ) ;
...
static int F_149 ( struct V_31 * V_32 , int V_33 , int V_289 ,
int V_290 , struct V_179 * V_73 )
{
int V_291 = V_73 -> V_172 . V_7 ;
int V_292 = ( 1 << V_73 -> V_178 ) ;
if ( V_289 < V_291 || V_289 + V_290 > V_291 + V_292 )
return - V_166 ;
return 0 ;
}
...
{
int V_44 ;
int V_218 = V_256 -> V_261 ;
struct V_179 * V_73 ;
struct V_181 * V_75 ;
int V_293 = F_138 ( V_102 -> V_104 ) / V_32 -> V_60 . V_294 ;
int V_295 ;
int V_169 ;
T_3 V_296 ;
int V_297 ;
...
V_296 = F_141 ( V_102 -> V_104 ) ;
V_297 = ( V_296 >> 17 ) & 0x7f ;
if ( V_297 != 0 && V_297 != V_33 ) {
V_44 = - V_166 ;
goto V_298;
}
...
V_295 = F_137 ( V_102 -> V_104 ) ;
if ( ! V_295 ) {
V_44 = F_39 ( V_32 , V_33 , V_293 , V_24 , & V_73 ) ;
if ( V_44 )
goto V_298;
V_44 = F_149 ( V_32 , V_33 , V_293 ,
F_140 ( V_102 -> V_104 ) , V_73 ) ;
if ( V_44 )
goto V_299;
V_75 -> V_73 = V_73 ;
}
V_44 = F_151 ( V_32 , V_33 , V_256 , V_102 , V_257 , V_233 ) ;
if ( V_44 )
goto V_299;
if ( ! V_295 ) {
F_152 ( & V_73 -> V_177 ) ;
...
{
return F_33 ( V_124 -> V_300 ) & 0xffffff ;
}
...
{
return F_33 ( V_124 -> V_240 ) & 0x1ffffff ;
}
static void F_159 ( struct V_31 * V_32 , struct V_255 * V_256 ,
struct V_108 * V_302 )
{
T_3 V_123 = V_256 -> V_261 & 0xffffff ;
T_3 V_303 = 0 ;
if ( F_160 ( V_32 , V_123 , & V_303 ) )
return;
V_302 -> V_303 = F_36 ( V_303 ) ;
}
...
{
int V_44 ;
int V_123 = V_256 -> V_261 & 0x7fffff ;
struct V_179 * V_73 ;
struct V_170 * V_64 ;
struct V_108 * V_124 = V_102 -> V_104 + 8 ;
int V_293 = F_145 ( V_124 ) / V_32 -> V_60 . V_294 ;
int V_304 = F_147 ( V_124 ) ;
struct V_185 * V_305 ;
struct V_185 * V_306 ;
int V_307 = F_156 ( V_124 ) ;
int V_308 = F_157 ( V_124 ) ;
T_3 V_240 = F_158 ( V_124 ) & 0xffffff ;
int V_309 = ( F_158 ( V_124 ) >> 24 ) & 1 ;
struct V_187 * V_70 ;
...
V_64 -> V_148 = 0 ;
V_64 -> V_153 = 0 ;
V_64 -> V_311 = F_33 ( V_124 -> V_114 ) ;
V_44 = F_39 ( V_32 , V_33 , V_293 , V_24 , & V_73 ) ;
if ( V_44 )
goto V_298;
V_44 = F_149 ( V_32 , V_33 , V_293 , V_304 , V_73 ) ;
if ( V_44 )
goto V_312;
V_44 = F_39 ( V_32 , V_33 , V_307 , V_21 , & V_305 ) ;
if ( V_44 )
goto V_312;
if ( V_308 != V_307 ) {
...
V_306 = V_305 ;
if ( V_309 ) {
V_44 = F_39 ( V_32 , V_33 , V_240 , V_22 , & V_70 ) ;
if ( V_44 )
goto V_314;
}
F_159 ( V_32 , V_256 , V_124 ) ;
...
if ( V_309 ) {
F_152 ( & V_70 -> V_177 ) ;
F_44 ( V_32 , V_33 , V_240 , V_22 ) ;
V_64 -> V_70 = V_70 ;
}
F_44 ( V_32 , V_33 , V_307 , V_21 ) ;
F_44 ( V_32 , V_33 , V_293 , V_24 ) ;
F_81 ( V_32 , V_33 , V_20 , V_123 ) ;
return 0 ;
V_315:
if ( V_309 )
...
{
return F_33 ( V_317 -> V_269 ) & 0xfffffff8 ;
}
static int F_163 ( struct V_316 * V_317 )
{
int V_318 = V_317 -> V_318 & 0x1f ;
int V_272 = ( V_317 -> V_273 & 0x3f ) + 12 ;
if ( V_318 + 5 < V_272 )
return 1 ;
return 1 << ( V_318 + 5 - V_272 ) ;
}
static int F_164 ( struct V_319 * V_320 )
{
return F_33 ( V_320 -> V_269 ) & 0xfffffff8 ;
}
static int F_165 ( struct V_319 * V_320 )
{
int V_321 = ( F_33 ( V_320 -> V_322 ) >> 24 ) & 0x1f ;
int V_272 = ( V_320 -> V_273 & 0x3f ) + 12 ;
if ( V_321 + 5 < V_272 )
return 1 ;
return 1 << ( V_321 + 5 - V_272 ) ;
}
...
{
int V_44 ;
int V_323 = V_256 -> V_261 ;
int V_7 = ( V_33 << 8 ) | V_323 ;
struct V_316 * V_317 = V_102 -> V_104 ;
int V_293 = F_162 ( V_317 ) / V_32 -> V_60 . V_294 ;
int V_304 = F_163 ( V_317 ) ;
struct V_183 * V_223 ;
struct V_179 * V_73 ;
...
static int F_167 ( struct V_31 * V_32 , int V_33 , int V_289 ,
int V_327 , struct V_179 * * V_11 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
struct V_179 * V_73 ;
...
com.list) {
if ( ! F_149 ( V_32 , V_33 , V_289 , V_327 , V_73 ) ) {
* V_11 = V_73 ;
...
{
struct V_335 V_73 ;
T_5 * V_336 = V_102 -> V_104 ;
T_1 * V_337 = ( T_1 * ) V_336 ;
int V_78 ;
struct V_179 * V_338 = NULL ;
int V_289 = F_139 ( V_336 [ 0 ] ) ;
int V_339 = V_256 -> V_261 ;
int V_44 ;
V_44 = F_167 ( V_32 , V_33 , V_289 , V_339 , & V_338 ) ;
if ( V_44 )
return V_44 ;
V_73 . V_340 = 0 ;
V_73 . V_178 = 0 ;
V_73 . V_272 = 0 ;
for ( V_78 = 0 ; V_78 < V_339 ; ++ V_78 )
V_337 [ V_78 + 2 ] = ( F_139 ( V_336 [ V_78 + 2 ] ) & ~ 1ULL ) ;
V_44 = F_171 ( V_32 , & V_73 , F_139 ( V_336 [ 0 ] ) , V_339 ,
( ( T_1 * ) V_336 + 2 ) ) ;
if ( V_338 )
F_44 ( V_32 , V_33 , V_338 -> V_172 . V_7 , V_24 ) ;
return V_44 ;
}
...
int F_173 ( struct V_31 * V_32 , int V_33 , struct V_341 * V_342 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_343 * V_344 ;
struct V_101 * V_345 ;
...
int V_7 ;
struct V_183 * V_346 ;
if ( ! V_38 -> V_41 . V_42 . V_251 )
return - V_45 ;
V_344 = & V_38 -> V_41 . V_42 . V_251 [ V_33 ] . V_344 [ V_342 -> type ] ;
if ( V_344 -> V_323 < 0 )
return 0 ;
F_28 ( & V_38 -> V_41 . V_42 . V_347 [ V_33 ] ) ;
V_7 = ( V_33 << 8 ) | V_344 -> V_323 ;
V_44 = F_39 ( V_32 , V_33 , V_7 , V_27 , & V_346 ) ;
if ( V_44 )
goto V_348;
if ( V_346 -> V_172 . V_167 != V_225 ) {
V_44 = - V_45 ;
goto V_349;
}
V_345 = F_174 ( V_32 ) ;
...
if ( V_342 -> type == V_350 ) {
++ V_344 -> V_351 ;
V_342 -> V_352 . V_233 . V_351 = F_177 ( V_344 -> V_351 ) ;
}
memcpy ( V_345 -> V_104 , ( T_2 * ) V_342 , 28 ) ;
V_261 = ( V_33 & 0xff ) | ( ( V_344 -> V_323 & 0xff ) << 16 ) ;
V_44 = F_178 ( V_32 , V_345 -> V_353 , V_261 , 0 ,
V_354 , V_355 ,
V_356 ) ;
F_44 ( V_32 , V_33 , V_7 , V_27 ) ;
F_30 ( & V_38 -> V_41 . V_42 . V_347 [ V_33 ] ) ;
F_179 ( V_32 , V_345 ) ;
return V_44 ;
V_349:
F_44 ( V_32 , V_33 , V_7 , V_27 ) ;
...
{
int V_44 ;
int V_226 = V_256 -> V_261 ;
struct V_319 * V_320 = V_102 -> V_104 ;
int V_293 = F_164 ( V_320 ) / V_32 -> V_60 . V_294 ;
struct V_185 * V_67 ;
struct V_179 * V_73 ;
...
if ( V_44 )
goto V_325;
V_44 = F_149 ( V_32 , V_33 , V_293 , F_165 ( V_320 ) , V_73 ) ;
if ( V_44 )
goto V_326;
V_44 = F_151 ( V_32 , V_33 , V_256 , V_102 , V_257 , V_233 ) ;
if ( V_44 )
...
struct V_319 * V_320 = V_102 -> V_104 ;
int V_293 = F_164 ( V_320 ) / V_32 -> V_60 . V_294 ;
V_44 = F_39 ( V_32 , V_33 , V_67 -> V_73 -> V_172 . V_7 , V_24 , & V_357 ) ;
if ( V_44 )
return V_44 ;
if ( V_357 != V_67 -> V_73 ) {
V_44 = - V_45 ;
...
goto V_358;
F_154 ( & V_357 -> V_177 ) ;
F_44 ( V_32 , V_33 , V_357 -> V_172 . V_7 , V_24 ) ;
F_152 ( & V_73 -> V_177 ) ;
V_67 -> V_73 = V_73 ;
F_44 ( V_32 , V_33 , V_73 -> V_172 . V_7 , V_24 ) ;
return 0 ;
...
goto V_299;
if ( V_256 -> V_260 == 0 ) {
V_44 = F_184 ( V_32 , V_33 , V_256 , V_102 , V_257 , V_233 , V_67 ) ;
goto V_299;
}
V_44 = F_151 ( V_32 , V_33 , V_256 , V_102 , V_257 , V_233 ) ;
V_299:
...
static int F_186 ( struct V_270 * V_271 )
{
int V_359 = ( F_33 ( V_271 -> V_360 ) >> 24 ) & 0xf ;
int V_279 = V_271 -> V_361 & 7 ;
int V_272 = ( V_271 -> V_273 & 0x3f ) + 12 ;
if ( V_359 + V_279 + 4 < V_272 )
return 1 ;
return 1 << ( V_359 + V_279 + 4 - V_272 ) ;
}
...
{
int V_44 ;
int V_240 = V_256 -> V_261 ;
struct V_179 * V_73 ;
struct V_187 * V_70 ;
struct V_270 * V_271 = V_102 -> V_104 ;
int V_293 = F_146 ( V_271 ) / V_32 -> V_60 . V_294 ;
if ( V_240 != ( F_33 ( V_271 -> V_360 ) & 0xffffff ) )
return - V_45 ;
V_44 = F_79 ( V_32 , V_33 , V_240 , V_229 , & V_70 ) ;
if ( V_44 )
return V_44 ;
V_44 = F_39 ( V_32 , V_33 , V_293 , V_24 , & V_73 ) ;
if ( V_44 )
goto V_298;
V_44 = F_149 ( V_32 , V_33 , V_293 , F_186 ( V_271 ) ,
V_73 ) ;
if ( V_44 )
goto V_312;
V_44 = F_151 ( V_32 , V_33 , V_256 , V_102 , V_257 , V_233 ) ;
...
V_70 -> V_73 = V_73 ;
F_44 ( V_32 , V_33 , V_73 -> V_172 . V_7 , V_24 ) ;
F_81 ( V_32 , V_33 , V_22 , V_240 ) ;
return 0 ;
V_312:
F_44 ( V_32 , V_33 , V_73 -> V_172 . V_7 , V_24 ) ;
V_298:
F_80 ( V_32 , V_33 , V_22 , V_240 ) ;
return V_44 ;
}
...
int V_240 = V_256 -> V_261 ;
struct V_187 * V_70 ;
V_44 = F_79 ( V_32 , V_33 , V_240 , V_188 , & V_70 ) ;
if ( V_44 )
return V_44 ;
V_44 = F_151 ( V_32 , V_33 , V_256 , V_102 , V_257 , V_233 ) ;
if ( V_44 )
...
struct V_258 * V_233 )
{
struct V_108 * V_302 = V_102 -> V_104 + 8 ;
F_159 ( V_32 , V_256 , V_302 ) ;
F_31 ( V_32 , V_33 , V_102 ) ;
return F_191 ( V_32 , V_33 , V_256 , V_102 , V_257 , V_233 ) ;
}
...
struct V_170 * V_64 ;
T_2 V_362 ;
V_112 V_363 = V_124 -> V_133 ;
T_2 V_364 = V_124 -> V_116 . V_139 ;
T_2 V_365 = V_124 -> V_116 . V_146 ;
T_2 V_366 = V_124 -> V_116 . V_150 ;
T_2 V_367 = V_124 -> V_116 . V_148 ;
T_2 V_368 = V_124 -> V_116 . V_153 ;
V_44 = F_169 ( V_32 , V_102 , V_330 , V_33 ) ;
if ( V_44 )
return V_44 ;
F_31 ( V_32 , V_33 , V_102 ) ;
F_32 ( V_32 , V_102 , ( T_2 ) V_33 ) ;
F_159 ( V_32 , V_256 , V_124 ) ;
V_362 = V_124 -> V_116 . V_128 ;
...
static struct V_369 * F_200 ( struct V_31 * V_32 , int V_33 ,
struct V_170 * V_370 , T_2 * V_371 )
{
struct V_369 * V_11 ;
F_168 (res, &rqp->mcg_list, list) {
if ( ! memcmp ( V_11 -> V_371 , V_371 , 16 ) )
return V_11 ;
}
return NULL ;
}
static int F_201 ( struct V_31 * V_32 , int V_33 , struct V_170 * V_370 ,
T_2 * V_371 , enum V_372 V_373 ,
enum V_374 V_375 , T_1 V_376 )
{
struct V_369 * V_11 ;
int V_44 ;
V_11 = F_19 ( sizeof *V_11 , V_83 ) ;
...
return - V_84 ;
F_40 ( & V_370 -> V_176 ) ;
if ( F_200 ( V_32 , V_33 , V_370 , V_371 ) ) {
F_25 ( V_11 ) ;
V_44 = - V_17 ;
} else {
memcpy ( V_11 -> V_371 , V_371 , 16 ) ;
V_11 -> V_373 = V_373 ;
V_11 -> V_375 = V_375 ;
V_11 -> V_376 = V_376 ;
F_58 ( & V_11 -> V_202 , & V_370 -> V_175 ) ;
V_44 = 0 ;
}
F_42 ( & V_370 -> V_176 ) ;
return V_44 ;
}
static int F_202 ( struct V_31 * V_32 , int V_33 , struct V_170 * V_370 ,
T_2 * V_371 , enum V_372 V_373 ,
enum V_374 V_375 , T_1 * V_376 )
{
struct V_369 * V_11 ;
int V_44 ;
F_40 ( & V_370 -> V_176 ) ;
V_11 = F_200 ( V_32 , V_33 , V_370 , V_371 ) ;
if ( ! V_11 || V_11 -> V_373 != V_373 || V_11 -> V_375 != V_375 )
V_44 = - V_45 ;
else {
* V_376 = V_11 -> V_376 ;
F_74 ( & V_11 -> V_202 ) ;
...
static int F_203 ( struct V_31 * V_32 , struct V_377 * V_64 , T_2 V_371 [ 16 ] ,
int V_378 , enum V_372 V_373 ,
enum V_374 type , T_1 * V_376 )
{
switch ( V_32 -> V_60 . V_379 ) {
case V_380 :
return F_204 ( V_32 , V_64 , V_371 , V_371 [ 5 ] ,
V_378 , V_373 ,
V_376 ) ;
case V_381 :
return F_205 ( V_32 , V_64 , V_371 ,
V_378 , V_373 , type ) ;
default:
return - V_45 ;
}
}
static int F_206 ( struct V_31 * V_32 , struct V_377 * V_64 , T_2 V_371 [ 16 ] ,
enum V_372 V_373 , enum V_374 type ,
T_1 V_376 )
{
switch ( V_32 -> V_60 . V_379 ) {
case V_380 :
return F_207 ( V_32 , V_376 ) ;
case V_381 :
return F_208 ( V_32 , V_64 , V_371 , V_373 , type ) ;
default:
return - V_45 ;
}
}
...
{
struct V_377 V_64 ;
T_2 * V_371 = V_102 -> V_104 ;
enum V_372 V_373 = ( V_256 -> V_261 >> 28 ) & 0x7 ;
int V_44 ;
int V_123 ;
struct V_170 * V_370 ;
T_1 V_376 = 0 ;
int V_382 = V_256 -> V_260 ;
int V_378 = V_256 -> V_261 >> 31 ;
T_2 V_383 = 2 ;
enum V_374 type = ( V_371 [ 7 ] & V_383 ) >> 1 ;
V_123 = V_256 -> V_261 & 0xffffff ;
V_44 = F_39 ( V_32 , V_33 , V_123 , V_20 , & V_370 ) ;
if ( V_44 )
return V_44 ;
V_64 . V_123 = V_123 ;
if ( V_382 ) {
V_44 = F_203 ( V_32 , & V_64 , V_371 , V_378 , V_373 ,
type , & V_376 ) ;
if ( V_44 ) {
F_63 ( L_22 , V_123 ) ;
goto V_299;
}
V_44 = F_201 ( V_32 , V_33 , V_370 , V_371 , V_373 , type , V_376 ) ;
if ( V_44 )
goto V_384;
} else {
V_44 = F_202 ( V_32 , V_33 , V_370 , V_371 , V_373 , type , & V_376 ) ;
if ( V_44 )
goto V_299;
V_44 = F_206 ( V_32 , & V_64 , V_371 , V_373 , type , V_376 ) ;
if ( V_44 )
F_63 ( L_23 ,
V_123 , V_376 ) ;
}
...
return V_44 ;
V_384:
F_206 ( V_32 , & V_64 , V_371 , V_373 , type , V_376 ) ;
V_299:
F_44 ( V_32 , V_33 , V_123 , V_20 ) ;
return V_44 ;
}
static int F_210 ( int V_33 , struct V_385 * V_386 ,
struct V_243 * V_387 )
{
struct V_242 * V_11 , * V_245 ;
T_5 V_388 ;
if ( ! F_211 ( V_386 -> V_389 . V_390 ) &&
! F_212 ( V_386 -> V_389 . V_390 ) ) {
F_108 (res, tmp, rlist, list) {
V_388 = F_213 ( V_11 -> V_241 << 16 ) ;
if ( ! memcmp ( & V_388 , V_386 -> V_389 . V_390 , V_391 ) )
return 0 ;
}
F_63 ( L_24 ,
V_386 -> V_389 . V_390 , V_33 ) ;
return - V_45 ;
}
return 0 ;
}
...
V_36 = V_394 -> V_36 ;
V_386 = (struct V_395 * ) ( V_394 + 1 ) ;
switch ( V_392 ) {
case V_402 :
V_397 =
(struct V_396 * ) ( V_386 + 1 ) ;
memmove ( V_397 , V_386 ,
...
V_399 = (struct V_398 * )
( V_386 + 1 ) ;
memmove ( V_399 , V_386 , sizeof( * V_399 ) ) ;
break;
default:
return - V_45 ;
}
...
V_386 -> V_290 = sizeof( * V_386 ) >> 2 ;
V_386 -> V_169 = F_177 ( V_405 [ V_406 ] ) ;
memcpy ( V_386 -> V_390 , & V_388 , V_391 ) ;
memcpy ( V_386 -> V_407 , & V_400 , V_391 ) ;
return 0 ;
}
...
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
struct V_243 * V_387 = & V_200 -> V_81 [ V_33 ] . V_86 [ V_25 ] ;
int V_44 ;
int V_123 ;
struct V_170 * V_370 ;
struct V_393 * V_394 ;
...
V_408 = (struct V_385 * ) ( V_394 + 1 ) ;
V_392 = F_216 ( F_217 ( V_408 -> V_169 ) ) ;
switch ( V_392 ) {
case V_406 :
if ( F_210 ( V_33 , V_408 , V_387 ) ) {
V_44 = - V_45 ;
goto V_410;
}
break;
...
case V_404 :
F_218 ( L_27 ) ;
if ( F_214 ( V_32 , V_33 , V_102 , V_387 , V_392 ) ) {
V_44 = - V_45 ;
goto V_410;
}
V_256 -> V_261 +=
...
V_44 = F_219 ( V_32 , V_102 -> V_353 , & V_256 -> V_235 ,
V_256 -> V_261 , 0 ,
V_412 , V_413 ,
V_356 ) ;
if ( V_44 )
goto V_410;
V_44 = F_57 ( V_32 , V_33 , V_256 -> V_235 , 1 , V_29 , V_123 ) ;
if ( V_44 ) {
F_220 ( V_32 , L_29 ) ;
F_178 ( V_32 , V_256 -> V_235 , 0 , 0 ,
V_414 , V_413 ,
V_356 ) ;
goto V_410;
}
...
V_380 )
return - V_409 ;
V_44 = F_39 ( V_32 , V_33 , V_256 -> V_234 , V_29 , & V_415 ) ;
if ( V_44 )
return V_44 ;
F_44 ( V_32 , V_33 , V_256 -> V_234 , V_29 ) ;
V_44 = F_39 ( V_32 , V_33 , V_415 -> V_123 , V_20 , & V_370 ) ;
if ( V_44 )
return V_44 ;
V_44 = F_73 ( V_32 , V_33 , V_256 -> V_234 , 1 , V_29 , 0 ) ;
if ( V_44 ) {
F_220 ( V_32 , L_30 ) ;
goto V_57;
}
V_44 = F_178 ( V_32 , V_256 -> V_234 , 0 , 0 ,
V_414 , V_413 ,
V_356 ) ;
if ( ! V_44 )
F_154 ( & V_370 -> V_177 ) ;
V_57:
F_44 ( V_32 , V_33 , V_415 -> V_123 , V_20 ) ;
return V_44 ;
}
...
static void F_223 ( struct V_31 * V_32 , int V_33 , struct V_170 * V_370 )
{
struct V_369 * V_416 ;
struct V_369 * V_245 ;
struct V_377 V_64 ;
...
switch ( V_32 -> V_60 . V_379 ) {
case V_380 :
F_207 ( V_32 , V_416 -> V_376 ) ;
break;
case V_381 :
V_64 . V_123 = V_370 -> V_174 ;
( void ) F_208 ( V_32 , & V_64 , V_416 -> V_371 ,
V_416 -> V_373 , V_416 -> V_375 ) ;
break;
}
F_74 ( & V_416 -> V_202 ) ;
F_25 ( V_416 ) ;
...
enum V_18 type , int V_417 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 =
& V_38 -> V_41 . V_42 . V_43 ;
struct V_243 * V_387 = & V_200 -> V_81 [ V_33 ] . V_86 [ type ] ;
struct V_10 * V_161 ;
struct V_10 * V_245 ;
int V_418 ;
V_418 = 0 ;
...
static int F_225 ( struct V_31 * V_32 , int V_33 ,
enum V_18 type )
{
unsigned long V_420 ;
int V_418 ;
V_420 = V_421 ;
do {
V_418 = F_224 ( V_32 , V_33 , type , 0 ) ;
if ( F_226 ( V_421 , V_420 + 5 * V_422 ) )
break;
if ( V_418 )
F_227 () ;
} while ( V_418 );
if ( V_418 )
V_418 = F_224 ( V_32 , V_33 , type , 1 ) ;
return V_418 ;
}
static void F_228 ( struct V_31 * V_32 , int V_33 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
struct V_243 * V_423 =
...
static void F_233 ( struct V_31 * V_32 , int V_33 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
struct V_243 * V_430 =
...
F_42 ( F_41 ( V_32 ) ) ;
if ( V_435 -> V_172 . V_165 == V_33 ) {
V_197 = V_435 -> V_172 . V_7 ;
V_2 = V_435 -> V_172 . V_167 ;
while ( V_2 != 0 ) {
switch ( V_2 ) {
case V_194 :
...
V_356 ) ;
F_40 ( F_41 ( V_32 ) ) ;
F_59 ( & V_435 -> V_172 . V_9 ,
& V_200 -> V_88 [ V_29 ] ) ;
F_74 ( & V_435 -> V_172 . V_202 ) ;
F_42 ( F_41 ( V_32 ) ) ;
F_25 ( V_435 ) ;
V_2 = 0 ;
break;
...
int V_44 ;
int V_218 ;
V_44 = F_225 ( V_32 , V_33 , V_28 ) ;
if ( V_44 )
F_229 ( V_32 , L_53
L_38 , V_33 ) ;
F_40 ( F_41 ( V_32 ) ) ;
F_108 (counter, tmp, counter_list, com.list) {
if ( V_439 -> V_172 . V_165 == V_33 ) {
V_218 = V_439 -> V_172 . V_7 ;
F_59 ( & V_439 -> V_172 . V_9 ,
& V_200 -> V_88 [ V_28 ] ) ;
F_74 ( & V_439 -> V_172 . V_202 ) ;
F_25 ( V_439 ) ;
F_120 ( V_32 , V_218 ) ;
F_11 ( V_32 , V_33 , V_28 , 1 , 0 ) ;
}
...
static void F_239 ( struct V_31 * V_32 , int V_33 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 = & V_38 -> V_41 . V_42 . V_43 ;
struct V_243 * V_440 =
...
int V_44 ;
int V_254 ;
V_44 = F_225 ( V_32 , V_33 , V_30 ) ;
if ( V_44 )
F_229 ( V_32 , L_54
L_38 , V_33 ) ;
F_40 ( F_41 ( V_32 ) ) ;
F_108 (xrcd, tmp, xrcdn_list, com.list) {
if ( V_441 -> V_172 . V_165 == V_33 ) {
V_254 = V_441 -> V_172 . V_7 ;
F_59 ( & V_441 -> V_172 . V_9 , & V_200 -> V_88 [ V_30 ] ) ;
F_74 ( & V_441 -> V_172 . V_202 ) ;
F_25 ( V_441 ) ;
F_123 ( V_32 , V_254 ) ;
}
}
...
void F_240 ( struct V_442 * V_443 )
{
struct V_444 * V_445 =
F_3 ( V_443 , struct V_444 , V_445 ) ;
struct V_101 * V_345 ;
struct V_446 * V_447 ;
struct V_31 * V_32 = & V_445 -> V_38 -> V_32 ;
struct V_199 * V_200 =
& V_445 -> V_38 -> V_41 . V_42 . V_43 ;
struct V_243 * V_423 =
& V_200 -> V_81 [ V_445 -> V_33 ] . V_86 [ V_20 ] ;
struct V_170 * V_64 ;
struct V_170 * V_245 ;
T_1 V_448 =
( ( 1ULL << V_449 ) |
...
V_144 ;
V_447 = V_345 -> V_104 ;
V_447 -> V_466 = F_213 ( V_467 ) ;
F_40 ( F_41 ( V_32 ) ) ;
F_108 (qp, tmp, qp_list, com.list) {
F_42 ( F_41 ( V_32 ) ) ;
if ( V_64 -> V_172 . V_165 == V_445 -> V_33 ) {
if ( V_64 -> V_172 . V_167 != V_216 ||
! V_64 -> V_128 ||
...
if ( V_118 == ( ( V_64 -> V_311 >> 16 ) & 0xff ) )
V_447 -> V_469 = F_213 ( V_455 ) ;
else
V_447 -> V_469 =
F_213 ( V_455 | V_448 ) ;
if ( V_445 -> V_465 == V_131 ) {
V_447 -> V_470 . V_133 = V_64 -> V_133 ;
V_447 -> V_470 . V_116 . V_139 = V_64 -> V_139 ;
V_447 -> V_470 . V_116 . V_146 = V_64 -> V_146 ;
V_447 -> V_470 . V_116 . V_148 = V_64 -> V_148 ;
V_447 -> V_470 . V_116 . V_150 = V_64 -> V_310 ;
V_447 -> V_470 . V_116 . V_153 = V_64 -> V_153 ;
V_447 -> V_470 . V_116 . V_128 =
V_64 -> V_128 ;
} else {
V_447 -> V_470 . V_133 = V_64 -> V_133 & ~ F_36 ( V_134 ) ;
V_447 -> V_470 . V_116 . V_139 = V_139 ;
V_447 -> V_470 . V_116 . V_148 = V_445 -> V_471 ;
V_447 -> V_470 . V_116 . V_146 =
V_64 -> V_146 | V_147 ;
V_447 -> V_470 . V_116 . V_150 =
V_64 -> V_310 | V_151 | V_152 ;
V_447 -> V_470 . V_116 . V_153 =
...
if ( V_463 )
F_220 ( V_32 , L_58 ,
V_463 , V_445 -> V_33 , V_445 -> V_36 ) ;
if ( V_445 -> V_114 & V_475 && ! V_463 &&
V_476 != V_445 -> V_477 )
F_115 ( & V_445 -> V_38 -> V_32 , V_445 -> V_36 ,
V_445 -> V_478 ) ;
V_57:
F_25 ( V_445 ) ;
return;
