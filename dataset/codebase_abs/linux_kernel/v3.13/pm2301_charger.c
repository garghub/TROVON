...
static void F_52 ( struct V_166 * V_167 )
{
struct V_1 * V_2 = F_53 ( V_167 ,
struct V_1 , V_39 ) ;
F_19 ( & V_2 -> V_26 . V_27 ) ;
F_54 ( & V_2 -> V_26 . V_27 . V_11 -> V_168 , NULL , L_40 ) ;
}
static void F_55 ( struct V_166 * V_167 )
{
T_1 V_169 ;
struct V_1 * V_2 = F_53 ( V_167 ,
...
int V_10 ;
T_1 V_9 ;
struct V_1 * V_2 = F_53 ( V_167 , struct V_1 ,
V_23 ) ;
...
static int F_58 ( struct V_178 * V_11 )
{
struct V_179 * V_179 = F_59 ( V_11 ) ;
struct V_1 * V_2 ;
V_2 = (struct V_1 * ) F_60 ( V_179 ) ;
F_1 ( V_2 ) ;
if ( V_2 -> V_24 . V_25 )
F_20 ( V_2 -> V_22 ,
& V_2 -> V_28 , 0 ) ;
...
static int F_61 ( struct V_178 * V_11 )
{
struct V_179 * V_179 = F_59 ( V_11 ) ;
struct V_1 * V_2 ;
V_2 = (struct V_1 * ) F_60 ( V_179 ) ;
...
{
struct V_179 * V_180 = F_59 ( V_11 ) ;
struct V_1 * V_2 ;
V_2 = (struct V_1 * ) F_60 ( V_180 ) ;
F_5 ( V_2 ) ;
return 0 ;
}
static int F_66 ( struct V_178 * V_11 )
{
struct V_179 * V_180 = F_59 ( V_11 ) ;
struct V_1 * V_2 ;
V_2 = (struct V_1 * ) F_60 ( V_180 ) ;
...
static int F_67 ( struct V_179 * V_179 ,
...
V_2 = F_68 ( sizeof( struct V_1 ) , V_186 ) ;
if ( ! V_2 ) {
F_9 ( & V_179 -> V_11 , L_42 ) ;
return - V_187 ;
}
...
F_74 ( & V_2 -> V_28 ,
F_55 ) ;
V_2 -> V_157 = F_75 ( V_2 -> V_11 , L_48 ) ;
if ( F_76 ( V_2 -> V_157 ) ) {
V_10 = F_77 ( V_2 -> V_157 ) ;
F_9 ( V_2 -> V_11 , L_49 ) ;
goto V_214;
}
V_10 = F_78 ( V_2 -> V_11 , & V_2 -> V_26 . V_27 ) ;
if ( V_10 ) {
F_9 ( V_2 -> V_11 , L_50 ) ;
goto V_215;
}
...
static int F_98 ( struct V_179 * V_179 )
{
struct V_1 * V_2 = F_60 ( V_179 ) ;
F_99 ( V_2 -> V_11 ) ;
