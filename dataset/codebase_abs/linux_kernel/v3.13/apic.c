...
break;
if ( V_25 != V_181 )
F_196 ( F_197 ( V_25 ) , V_281 ) ;
}
V_278 = 0 ;
V_279 = 0 ;
for ( V_171 = 0 ; V_171 < V_282 ; V_171 ++ ) {
if ( F_198 ( V_171 , V_281 ) ) {
V_278 += 1 + V_279 ;
V_279 = 0 ;
} else
++ V_279 ;
...
static int F_199 ( const struct V_283 * V_284 )
{
if ( V_285 )
return 0 ;
