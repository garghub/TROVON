...
static void F_198 ( struct V_2 * V_3 , int V_188 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
int V_189 ;
...
if ( V_188 & V_190 ) {
V_189 = V_3 -> V_129 & V_190 ? 1 : - 1 ;
F_200 ( V_4 -> V_3 , V_189 ) ;
}
if ( V_188 & V_191 ) {
V_189 = V_3 -> V_129 & V_191 ? 1 : - 1 ;
F_201 ( V_4 -> V_3 , V_189 ) ;
}
}
F_202 () ;
...
static int F_206 ( struct V_2 * V_3 , void * V_192 )
{
struct V_8 * V_9 = V_192 ;
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
if ( V_3 -> type == V_193 && ! F_207 ( V_9 -> V_10 ) )
return - V_194 ;
...
static int F_208 ( struct V_2 * V_3 , int V_196 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
int V_29 ;
...
static struct V_198 *
F_210 ( struct V_2 * V_3 , struct V_198 * V_199 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_96 * V_192 ;
...
int V_28 ;
F_180 (i) {
V_192 = F_181 ( V_14 -> V_97 , V_28 ) ;
do {
V_200 = F_211 ( & V_192 -> V_98 ) ;
V_99 = V_192 -> V_99 ;
V_100 = V_192 -> V_100 ;
V_104 = V_192 -> V_104 ;
V_182 = V_192 -> V_182 ;
V_183 = V_192 -> V_183 ;
} while ( F_212 ( & V_192 -> V_98 , V_200 ) );
V_199 -> V_99 += V_99 ;
V_199 -> V_100 += V_100 ;
V_199 -> V_201 += V_104 ;
V_199 -> V_182 += V_182 ;
...
static int F_213 ( struct V_2 * V_3 , T_9 V_202 , T_3 V_203 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
int V_29 ;
F_121 ( & V_14 -> V_134 ) ;
F_14 (port, &team->port_list, list) {
V_29 = F_214 ( V_4 -> V_3 , V_202 , V_203 ) ;
if ( V_29 )
goto V_197;
}
F_122 ( & V_14 -> V_134 ) ;
...
V_197:
F_209 (port, &team->port_list, list)
F_215 ( V_4 -> V_3 , V_202 , V_203 ) ;
F_122 ( & V_14 -> V_134 ) ;
return V_29 ;
}
static int F_216 ( struct V_2 * V_3 , T_9 V_202 , T_3 V_203 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
F_199 () ;
...
static T_10 F_223 ( struct V_2 * V_3 ,
T_10 V_145 )
{
struct V_1 * V_4 ;
struct V_14 * V_14 = F_177 ( V_3 ) ;
...
static int F_224 ( struct V_2 * V_3 , bool V_209 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
V_14 -> V_71 = true ;
if ( V_209 )
...
struct V_210 * V_211 )
{
F_227 ( V_211 -> V_212 , V_213 , sizeof( V_211 -> V_212 ) ) ;
F_227 ( V_211 -> V_214 , V_215 , sizeof( V_211 -> V_214 ) ) ;
}
...
V_3 -> V_225 = 0 ;
V_3 -> V_129 |= V_226 ;
V_3 -> V_132 &= ~ ( V_131 | V_227 ) ;
V_3 -> V_132 |= V_228 | V_229 ;
V_3 -> V_145 |= V_230 ;
V_3 -> V_145 |= V_231 ;
V_3 -> V_232 = V_126 |
V_233 |
V_234 |
V_235 ;
V_3 -> V_232 &= ~ ( V_236 & ~ V_237 ) ;
V_3 -> V_145 |= V_3 -> V_232 ;
}
static int F_235 ( struct V_238 * V_239 , struct V_2 * V_3 ,
struct V_240 * V_241 [] , struct V_240 * V_160 [] )
{
int V_29 ;
if ( V_241 [ V_242 ] == NULL )
F_236 ( V_3 ) ;
...
static int F_238 ( struct V_240 * V_241 [] , struct V_240 * V_160 [] )
{
if ( V_241 [ V_242 ] ) {
if ( F_239 ( V_241 [ V_242 ] ) != V_243 )
return - V_62 ;
if ( ! F_207 ( F_240 ( V_241 [ V_242 ] ) ) )
return - V_194 ;
}
return 0 ;
}
...
static int F_243 ( struct V_67 * V_68 , struct V_246 * V_32 )
{
struct V_67 * V_247 ;
void * V_248 ;
int V_29 ;
V_247 = F_244 ( V_249 , V_30 ) ;
if ( ! V_247 )
return - V_31 ;
V_248 = F_245 ( V_247 , V_32 -> V_250 , V_32 -> V_251 ,
& V_252 , 0 , V_253 ) ;
if ( ! V_248 ) {
V_29 = - V_254 ;
goto V_255;
...
F_246 ( V_247 , V_248 ) ;
return F_247 ( F_248 ( V_32 ) , V_247 , V_32 -> V_250 ) ;
V_255:
F_249 ( V_247 ) ;
return V_29 ;
}
static struct V_14 * F_250 ( struct V_246 * V_32 )
{
struct V_238 * V_238 = F_248 ( V_32 ) ;
int V_256 ;
struct V_2 * V_3 ;
struct V_14 * V_14 ;
if ( ! V_32 -> V_257 [ V_258 ] )
return NULL ;
V_256 = F_251 ( V_32 -> V_257 [ V_258 ] ) ;
V_3 = F_252 ( V_238 , V_256 ) ;
...
static int F_254 ( struct V_67 * V_68 , struct V_14 * V_14 , T_4 V_259 )
{
return F_247 ( F_255 ( V_14 -> V_3 ) , V_68 , V_259 ) ;
}
...
if ( V_29 )
return V_29 ;
V_260 = F_257 ( V_68 , V_261 ) ;
if ( ! V_260 )
return - V_254 ;
if ( F_258 ( V_68 , V_262 , V_21 -> V_22 ) )
goto V_263;
if ( V_54 -> V_4 &&
F_259 ( V_68 , V_264 ,
V_54 -> V_4 -> V_3 -> V_256 ) )
...
switch ( V_21 -> type ) {
case V_266 :
if ( F_260 ( V_68 , V_267 , V_268 ) )
goto V_263;
if ( F_259 ( V_68 , V_269 , V_49 . V_160 . V_162 ) )
goto V_263;
break;
case V_270 :
if ( F_260 ( V_68 , V_267 , V_271 ) )
goto V_263;
if ( F_258 ( V_68 , V_269 ,
V_49 . V_160 . V_161 ) )
goto V_263;
break;
case V_272 :
if ( F_260 ( V_68 , V_267 , V_273 ) )
goto V_263;
if ( F_261 ( V_68 , V_269 , V_49 . V_160 . V_274 . V_101 ,
V_49 . V_160 . V_274 . V_275 ) )
goto V_263;
break;
case V_276 :
if ( F_260 ( V_68 , V_267 , V_277 ) )
goto V_263;
if ( V_49 . V_160 . V_163 &&
F_262 ( V_68 , V_269 ) )
goto V_263;
break;
case V_278 :
if ( F_260 ( V_68 , V_267 , V_279 ) )
goto V_263;
if ( F_263 ( V_68 , V_269 , V_49 . V_160 . V_164 ) )
goto V_263;
break;
default:
F_264 () ;
}
if ( V_24 -> V_35 && F_262 ( V_68 , V_280 ) )
goto V_263;
if ( V_24 -> V_34 ) {
if ( F_262 ( V_68 , V_281 ) )
goto V_263;
...
struct V_14 * V_14 , T_4 V_259 ,
T_11 * V_282 )
{
int V_29 ;
if ( * V_91 ) {
V_29 = V_282 ( * V_91 , V_14 , V_259 ) ;
if ( V_29 )
return V_29 ;
}
* V_91 = F_268 ( V_283 , V_30 ) ;
if ( ! * V_91 )
return - V_31 ;
return 0 ;
}
static int F_269 ( struct V_14 * V_14 , T_4 V_259 , T_4 V_284 ,
int V_129 , T_11 * V_282 ,
struct V_106 * V_285 )
{
struct V_240 * V_46 ;
struct V_286 * V_287 ;
...
struct V_23 , V_289 ) ;
V_290:
V_29 = F_267 ( & V_68 , V_14 , V_259 , V_282 ) ;
if ( V_29 )
return V_29 ;
V_248 = F_245 ( V_68 , V_259 , V_284 , & V_252 , V_129 | V_291 ,
V_292 ) ;
if ( ! V_248 )
return - V_254 ;
if ( F_259 ( V_68 , V_258 , V_14 -> V_3 -> V_256 ) )
goto V_293;
V_46 = F_257 ( V_68 , V_294 ) ;
if ( ! V_46 )
goto V_293;
V_28 = 0 ;
V_288 = false ;
...
goto V_290;
V_296:
V_287 = F_272 ( V_68 , V_259 , V_284 , V_297 , 0 , V_129 | V_291 ) ;
if ( ! V_287 ) {
V_29 = F_267 ( & V_68 , V_14 , V_259 , V_282 ) ;
if ( V_29 )
goto V_295;
...
static int F_274 ( struct V_67 * V_68 , struct V_246 * V_32 )
{
struct V_14 * V_14 ;
struct V_23 * V_24 ;
int V_29 ;
...
return - V_62 ;
F_14 (opt_inst, &team->option_inst_list, list)
F_22 ( & V_24 -> V_289 , & V_285 ) ;
V_29 = F_269 ( V_14 , V_32 -> V_250 , V_32 -> V_251 ,
V_298 , F_254 ,
& V_285 ) ;
F_253 ( V_14 ) ;
return V_29 ;
}
static int F_276 ( struct V_67 * V_68 , struct V_246 * V_32 )
{
struct V_14 * V_14 ;
int V_29 = 0 ;
int V_28 ;
...
char * V_20 ;
bool V_311 = false ;
if ( F_278 ( V_299 ) != V_261 ) {
V_29 = - V_62 ;
goto V_301;
}
V_29 = F_279 ( V_302 , V_303 ,
V_299 , V_312 ) ;
if ( V_29 )
goto V_301;
if ( ! V_302 [ V_262 ] ||
...
V_305 = V_302 [ V_269 ] ;
if ( V_307 != V_276 && ! V_305 ) {
V_29 = - V_62 ;
goto V_301;
}
V_20 = F_240 ( V_302 [ V_262 ] ) ;
V_304 = V_302 [ V_264 ] ;
if ( V_304 )
V_308 = F_251 ( V_304 ) ;
V_304 = V_302 [ V_265 ] ;
...
switch ( V_307 ) {
case V_266 :
V_49 . V_160 . V_162 = F_251 ( V_305 ) ;
break;
case V_270 :
if ( F_239 ( V_305 ) > V_314 ) {
V_29 = - V_62 ;
goto V_301;
}
V_49 . V_160 . V_161 = F_240 ( V_305 ) ;
break;
case V_272 :
V_49 . V_160 . V_274 . V_101 = F_239 ( V_305 ) ;
V_49 . V_160 . V_274 . V_275 = F_240 ( V_305 ) ;
break;
case V_276 :
V_49 . V_160 . V_163 = V_305 ? true : false ;
break;
case V_278 :
V_49 . V_160 . V_164 = F_281 ( V_305 ) ;
break;
default:
F_264 () ;
}
...
{
struct V_240 * V_315 ;
V_315 = F_257 ( V_68 , V_316 ) ;
if ( ! V_315 )
goto V_263;
if ( F_259 ( V_68 , V_317 , V_4 -> V_3 -> V_256 ) )
goto V_263;
if ( V_4 -> V_34 ) {
if ( F_262 ( V_68 , V_318 ) )
goto V_263;
...
( V_4 -> V_18 . V_15 &&
F_262 ( V_68 , V_320 ) ) ||
F_259 ( V_68 , V_321 , V_4 -> V_18 . V_322 ) ||
...
static int F_285 ( struct V_14 * V_14 , T_4 V_259 , T_4 V_284 ,
int V_129 , T_11 * V_282 ,
struct V_1 * V_325 )
{
struct V_240 * V_79 ;
...
if ( F_259 ( V_68 , V_258 , V_14 -> V_3 -> V_256 ) )
goto V_293;
V_79 = F_257 ( V_68 , V_327 ) ;
if ( ! V_79 )
goto V_293;
V_28 = 0 ;
V_288 = false ;
if ( V_325 ) {
V_29 = F_284 ( V_68 , V_325 ) ;
if ( V_29 )
goto V_295;
} else if ( V_4 ) {
...
if ( ! V_14 )
return - V_62 ;
V_29 = F_285 ( V_14 , V_32 -> V_250 , V_32 -> V_251 ,
V_298 , F_254 , NULL ) ;
F_253 ( V_14 ) ;
return V_29 ;
}
...
struct V_14 * V_14 , T_4 V_259 )
{
return F_289 ( & V_252 , F_255 ( V_14 -> V_3 ) ,
V_68 , 0 , 0 , V_30 ) ;
}
...
if ( V_15 ) {
struct V_331 V_332 ;
V_29 = F_297 ( V_4 -> V_3 , & V_332 ) ;
if ( ! V_29 ) {
V_4 -> V_18 . V_322 = F_298 ( & V_332 ) ;
V_4 -> V_18 . V_324 = V_332 . V_324 ;
goto V_333;
}
}
V_4 -> V_18 . V_322 = 0 ;
...
unsigned long V_336 , void * V_275 )
{
struct V_2 * V_3 = F_302 ( V_275 ) ;
struct V_1 * V_4 ;
V_4 = F_4 ( V_3 ) ;
if ( ! V_4 )
return V_337 ;
