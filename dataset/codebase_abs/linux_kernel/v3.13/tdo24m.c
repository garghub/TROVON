...
if ( V_10 )
return V_10 ;
V_2 = F_17 ( & V_42 -> V_48 , sizeof( struct V_1 ) , V_52 ) ;
if ( ! V_2 )
return - V_53 ;
V_2 -> V_15 = V_42 ;
V_2 -> V_34 = V_54 ;
V_2 -> V_17 = V_18 ;
V_2 -> V_13 = F_17 ( & V_42 -> V_48 , V_55 , V_52 ) ;
if ( V_2 -> V_13 == NULL )
return - V_53 ;
V_39 = & V_2 -> V_16 ;
V_5 = & V_2 -> V_6 ;
...
V_2 -> V_59 = F_21 ( & V_42 -> V_48 , L_2 , & V_42 -> V_48 ,
V_2 , & V_60 ) ;
if ( F_22 ( V_2 -> V_59 ) )
return F_23 ( V_2 -> V_59 ) ;
F_24 ( V_42 , V_2 ) ;
V_10 = F_8 ( V_2 , V_61 ) ;
if ( V_10 )
return V_10 ;
...
static int F_27 ( struct V_62 * V_48 )
{
struct V_1 * V_2 = F_28 ( V_48 ) ;
return F_8 ( V_2 , V_54 ) ;
}
static int F_29 ( struct V_62 * V_48 )
{
struct V_1 * V_2 = F_28 ( V_48 ) ;
return F_8 ( V_2 , V_61 ) ;
}
