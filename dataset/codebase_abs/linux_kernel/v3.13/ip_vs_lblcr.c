...
{
struct V_33 * V_34 ;
V_34 = F_35 ( V_4 -> V_26 , V_42 , V_46 ) ;
if ( ! V_34 ) {
V_34 = F_3 ( sizeof( * V_34 ) , V_8 ) ;
if ( ! V_34 )
return NULL ;
V_34 -> V_26 = V_4 -> V_26 ;
F_39 ( V_4 -> V_26 , & V_34 -> V_27 , V_46 ) ;
V_34 -> V_47 = V_12 ;
...
{
#ifdef F_47
struct V_57 * V_58 = F_48 ( V_49 -> V_59 ) ;
return V_58 -> F_46 ;
#else
return V_60 ;
#endif
...
{
struct V_41 * V_42 = V_49 -> V_50 ;
unsigned long V_61 = V_12 ;
int V_51 , V_62 ;
struct V_33 * V_34 ;
struct V_52 * V_53 ;
for ( V_51 = 0 , V_62 = V_42 -> V_63 ; V_51 < V_56 ; V_51 ++ ) {
V_62 = ( V_62 + 1 ) & V_40 ;
F_50 ( & V_49 -> V_54 ) ;
...
static void F_53 ( unsigned long V_64 )
{
struct V_48 * V_49 = (struct V_48 * ) V_64 ;
struct V_41 * V_42 = V_49 -> V_50 ;
unsigned long V_61 = V_12 ;
int V_65 ;
int V_51 , V_62 ;
...
if ( F_19 ( & V_42 -> V_45 ) <= V_42 -> V_69 ) {
V_42 -> V_66 ++ ;
goto V_68;
}
V_65 = ( F_19 ( & V_42 -> V_45 ) - V_42 -> V_69 ) * 4 / 3 ;
if ( V_65 > V_42 -> V_69 / 2 )
V_65 = V_42 -> V_69 / 2 ;
for ( V_51 = 0 , V_62 = V_42 -> V_63 ; V_51 < V_56 ; V_51 ++ ) {
V_62 = ( V_62 + 1 ) & V_40 ;
...
V_42 -> V_63 = V_62 ;
V_68:
F_55 ( & V_42 -> V_71 , V_12 + V_72 ) ;
}
static int F_56 ( struct V_48 * V_49 )
{
int V_51 ;
struct V_41 * V_42 ;
V_42 = F_3 ( sizeof( * V_42 ) , V_73 ) ;
if ( V_42 == NULL )
return - V_74 ;
V_49 -> V_50 = V_42 ;
F_57 ( 6 , L_3
...
static struct V_3 *
F_64 ( struct V_48 * V_49 , const struct V_76 * V_77 ,
struct V_78 * V_79 )
{
struct V_41 * V_42 = V_49 -> V_50 ;
struct V_3 * V_4 ;
struct V_33 * V_34 ;
F_57 ( 6 , L_7 , V_25 ) ;
V_34 = F_35 ( V_49 -> V_26 , V_42 , & V_79 -> V_46 ) ;
if ( V_34 ) {
V_34 -> V_47 = V_12 ;
V_4 = F_17 ( & V_34 -> V_2 ) ;
...
F_43 ( & V_49 -> V_54 ) ;
if ( ! V_42 -> V_55 )
F_38 ( V_42 , & V_79 -> V_46 , V_4 ) ;
F_45 ( & V_49 -> V_54 ) ;
V_68:
F_22 ( 6 , L_10 ,
F_23 ( V_49 -> V_26 , & V_79 -> V_46 ) ,
F_23 ( V_49 -> V_26 , & V_4 -> V_27 ) , F_24 ( V_4 -> V_28 ) ) ;
return V_4 ;
}
static int T_2 F_66 ( struct V_59 * V_59 )
{
struct V_57 * V_58 = F_48 ( V_59 ) ;
if ( ! V_58 )
return - V_81 ;
if ( ! F_67 ( V_59 , & V_82 ) ) {
V_58 -> V_83 = F_68 ( V_84 ,
...
return - V_74 ;
if ( V_59 -> V_85 != & V_86 )
V_58 -> V_83 [ 0 ] . V_87 = NULL ;
} else
V_58 -> V_83 = V_84 ;
V_58 -> F_46 = V_60 ;
V_58 -> V_83 [ 0 ] . V_64 = & V_58 -> F_46 ;
V_58 -> V_88 =
F_69 ( V_59 , L_11 , V_58 -> V_83 ) ;
if ( ! V_58 -> V_88 ) {
if ( ! F_67 ( V_59 , & V_82 ) )
F_10 ( V_58 -> V_83 ) ;
return - V_74 ;
...
static void T_3 F_70 ( struct V_59 * V_59 )
{
struct V_57 * V_58 = F_48 ( V_59 ) ;
F_71 ( V_58 -> V_88 ) ;
if ( ! F_67 ( V_59 , & V_82 ) )
...
static int T_2 F_66 ( struct V_59 * V_59 ) { return 0 ; }
static void T_3 F_70 ( struct V_59 * V_59 ) { }
