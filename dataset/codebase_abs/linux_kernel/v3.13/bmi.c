...
int F_14 ( struct V_1 * V_2 , T_1 V_23 , T_1 * V_37 )
{
struct V_6 V_7 ;
union V_15 V_16 ;
T_1 V_8 = sizeof( V_7 . V_9 ) + sizeof( V_7 . V_38 ) ;
T_1 V_18 = sizeof( V_16 . V_38 ) ;
int V_11 ;
F_2 ( V_3 , L_14 ,
V_23 , * V_37 ) ;
if ( V_2 -> V_4 . V_5 ) {
...
V_7 . V_9 = F_4 ( V_39 ) ;
V_7 . V_38 . V_30 = F_4 ( V_23 ) ;
V_7 . V_38 . V_37 = F_4 ( * V_37 ) ;
V_11 = F_5 ( V_2 , & V_7 , V_8 , & V_16 , & V_18 ) ;
if ( V_11 ) {
F_6 ( L_15 ) ;
return V_11 ;
}
if ( V_18 < sizeof( V_16 . V_38 ) ) {
F_6 ( L_16 ,
V_18 ) ;
return V_11 ;
}
* V_37 = F_8 ( V_16 . V_38 . V_40 ) ;
return 0 ;
}
