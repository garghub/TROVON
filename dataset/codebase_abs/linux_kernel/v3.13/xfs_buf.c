...
int V_159 , V_57 = V_5 - V_58 ;
if ( V_57 > V_56 )
V_57 = V_56 ;
V_159 = F_141 ( V_143 , V_2 -> V_50 [ V_148 ] , V_57 ,
V_58 ) ;
if ( V_159 < V_57 )
break;
V_58 = 0 ;
...
while ( V_175 < V_179 ) {
struct V_53 * V_53 ;
int V_148 , V_180 , V_181 ;
V_148 = ( V_175 + V_2 -> V_6 ) >> V_64 ;
V_180 = ( V_175 + V_2 -> V_6 ) & ~ V_63 ;
V_53 = V_2 -> V_50 [ V_148 ] ;
V_181 = F_44 ( T_4 , V_5 - V_180 ,
F_38 ( V_2 -> V_44 ) - V_175 ) ;
ASSERT ( ( V_181 + V_180 ) <= V_5 ) ;
switch ( V_178 ) {
case V_182 :
memset ( F_46 ( V_53 ) + V_180 , 0 , V_181 ) ;
break;
case V_183 :
memcpy ( V_177 , F_46 ( V_53 ) + V_180 , V_181 ) ;
break;
case V_184 :
memcpy ( F_46 ( V_53 ) + V_180 , V_177 , V_181 ) ;
}
V_175 += V_181 ;
V_177 += V_181 ;
}
...
void * V_189 )
{
struct V_1 * V_2 = F_114 ( V_187 , struct V_1 , V_16 ) ;
struct V_186 * V_190 = V_189 ;
if ( F_9 ( & V_2 -> V_17 ) > 1 ) {
F_154 ( V_2 , V_48 ) ;
return V_191 ;
}
...
while ( ! F_33 ( & V_190 ) ) {
struct V_1 * V_2 ;
V_2 = F_161 ( & V_190 , struct V_1 , V_16 ) ;
F_162 ( & V_2 -> V_16 ) ;
if ( V_2 -> V_7 & V_140 ) {
F_51 ( V_75 -> V_88 ,
L_6
...
struct V_198 * V_199 )
{
struct V_25 * V_75 = F_114 ( V_197 ,
struct V_25 , V_200 ) ;
F_158 ( V_190 ) ;
unsigned long V_201 ;
unsigned long V_202 = V_199 -> V_202 ;
V_201 = F_167 ( & V_75 -> V_15 , V_199 -> V_203 , F_164 ,
& V_190 , & V_202 ) ;
while ( ! F_33 ( & V_190 ) ) {
struct V_1 * V_2 ;
V_2 = F_161 ( & V_190 , struct V_1 , V_16 ) ;
...
struct V_25 * V_75 = F_114 ( V_197 ,
struct V_25 , V_200 ) ;
return F_169 ( & V_75 -> V_15 , V_199 -> V_203 ) ;
}
void
F_170 (
struct V_204 * V_205 ,
...
{
V_75 -> V_211 = V_208 ;
V_75 -> V_86 = F_175 ( V_209 ) - 1 ;
V_75 -> V_87 = V_209 - 1 ;
if ( F_176 ( V_75 -> V_156 , V_209 ) ) {
char V_212 [ V_213 ] ;
F_177 ( V_75 -> V_156 , V_212 ) ;
F_66 ( V_75 -> V_88 ,
L_8 ,
V_209 , V_212 ) ;
return V_214 ;
...
unsigned int V_209 )
{
return F_174 ( V_75 , V_208 , V_209 , 1 ) ;
}
T_13 *
F_181 (
struct V_204 * V_205 ,
...
{
T_13 * V_75 ;
V_75 = F_12 ( sizeof( * V_75 ) , V_219 | V_23 ) ;
V_75 -> V_88 = V_205 ;
V_75 -> V_220 = V_216 -> V_221 ;
V_75 -> V_156 = V_216 ;
V_75 -> V_110 = F_182 ( V_216 ) ;
if ( ! V_75 -> V_110 )
goto error;
if ( F_178 ( V_75 , V_216 ) )
goto error;
if ( F_183 ( & V_75 -> V_15 ) )
goto error;
V_75 -> V_200 . V_222 = F_168 ;
V_75 -> V_200 . V_223 = F_166 ;
V_75 -> V_200 . V_224 = V_225 ;
V_75 -> V_200 . V_29 = V_226 ;
F_184 ( & V_75 -> V_200 ) ;
return V_75 ;
error:
F_14 ( V_75 ) ;
...
struct V_186 * V_230 )
{
struct V_1 * V_231 = F_114 ( V_229 , struct V_1 , V_37 ) ;
struct V_1 * V_2 = F_114 ( V_230 , struct V_1 , V_37 ) ;
T_7 V_232 ;
...
F_193 ( & V_2 -> V_37 , V_234 ) ;
F_194 ( V_2 , V_48 ) ;
}
F_195 ( NULL , V_234 , F_189 ) ;
F_145 ( & V_162 ) ;
...
{
F_158 ( V_234 ) ;
return F_190 ( V_233 , & V_234 , false ) ;
}
int
F_197 (
struct V_186 * V_233 )
...
int error = 0 , V_237 ;
struct V_1 * V_2 ;
F_190 ( V_233 , & V_234 , true ) ;
while ( ! F_33 ( & V_234 ) ) {
V_2 = F_161 ( & V_234 , struct V_1 , V_37 ) ;
F_162 ( & V_2 -> V_37 ) ;
V_237 = F_71 ( V_2 ) ;
F_67 ( V_2 ) ;
if ( ! error )
