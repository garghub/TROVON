...
static T_1 F_33 ( struct V_17 * V_17 , const char T_2 * V_4 ,
T_3 V_23 , T_4 * V_24 )
{
if ( V_23 ) {
if ( ! V_20 ) {
...
static long F_35 ( struct V_17 * V_17 ,
...
switch ( V_28 ) {
case V_38 :
return F_36 ( V_32 . V_31 , & V_31 , sizeof( V_31 ) )
? - V_27 : 0 ;
case V_39 :
return F_37 ( F_24 () , V_32 . V_25 ) ;
case V_40 :
return F_37 ( 0 , V_32 . V_25 ) ;
case V_41 :
{
int V_33 , V_42 = - V_43 ;
if ( F_34 ( V_33 , V_32 . V_25 ) )
return - V_27 ;
if ( V_33 & V_44 ) {
F_21 () ;
V_42 = 0 ;
