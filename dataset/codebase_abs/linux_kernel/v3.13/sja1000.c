...
return V_165 ;
if ( ! ( V_2 -> V_4 & V_166 ) ) {
V_165 = F_39 ( V_12 -> V_147 , F_33 , V_2 -> V_167 ,
V_12 -> V_168 , ( void * ) V_12 ) ;
if ( V_165 ) {
F_40 ( V_12 ) ;
return - V_169 ;
}
...
struct V_11 * F_44 ( int V_172 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
V_12 = F_45 ( sizeof( struct V_1 ) + V_172 ,
V_173 ) ;
if ( ! V_12 )
return NULL ;
V_2 = F_6 ( V_12 ) ;
V_2 -> V_12 = V_12 ;
V_2 -> V_22 . V_174 = & V_175 ;
V_2 -> V_22 . V_176 = F_16 ;
V_2 -> V_22 . V_177 = F_13 ;
V_2 -> V_22 . V_178 = F_18 ;
V_2 -> V_22 . V_179 = V_49 |
