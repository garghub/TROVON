...
struct V_6 * V_115 ;
if ( F_54 ( V_15 ) )
V_115 = F_55 ( & V_15 -> V_116 ) ;
else
V_115 = F_20 ( V_15 ) ;
for ( V_3 = 0 ; V_3 < V_108 && ! V_112 ; V_3 ++ )
V_112 = F_24 ( V_115 , V_107 [ V_3 ] ) ;
if ( ! V_112 ) {
if ( ! F_37 ( V_115 ) || V_110 ) {
if ( F_56 ( & V_115 -> V_34 . V_62 ) )
error = - V_117 ;
else
error = - V_86 ;
F_10 ( V_115 ) ;
...
V_18 = F_49 ( V_115 -> V_34 . V_59 , V_107 [ 0 ] ) ;
F_10 ( V_115 ) ;
V_71 = V_18 ;
V_112 = F_38 ( V_15 , 1 ) ;
if ( ! V_112 ) {
...
V_28:
if ( ! V_110 )
error = F_41 ( V_15 , & V_21 , V_99 , V_121 , V_19 ,
V_18 , V_59 , V_120 , V_72 , error ) ;
F_27 ( V_17 ) ;
F_10 ( V_71 ) ;
F_59 ( V_74 ) ;
return error ;
