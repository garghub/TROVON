...
return F_29 ( V_16 -> V_77 , V_2 , V_67 , V_66 ) ;
}
...
static int F_33 ( struct V_10 * V_11 , struct V_1 * V_2 )
{
return F_34 ( V_2 ) ;
}
static int
F_35 ( struct V_15 * V_100 , struct V_1 * V_2 )
{
F_26 ( L_3 , V_100 -> V_11 -> V_101 ) ;
F_9 ( & V_100 -> V_22 ) ;
switch ( F_16 ( V_2 ) -> V_102 . V_32 ) {
case V_56 :
...
break;
case V_54 :
if ( F_16 ( V_2 ) -> V_102 . V_24 != V_100 -> V_24 &&
F_16 ( V_2 ) -> V_102 . V_24 != V_25 )
V_2 -> V_103 = V_104 ;
else if ( ! memcmp ( F_16 ( V_2 ) -> V_102 . V_55 , V_100 -> V_11 -> V_39 ,
V_9 ) )
V_2 -> V_103 = V_105 ;
else
V_2 -> V_103 = V_104 ;
...
F_16 ( V_2 ) -> V_102 . V_24 != V_25 )
V_2 -> V_103 = V_104 ;
else if ( F_16 ( V_2 ) -> V_102 . V_26 == V_100 -> V_26 )
V_2 -> V_103 = V_105 ;
else if ( F_16 ( V_2 ) -> V_102 . V_26 ==
V_27 )
V_2 -> V_103 = V_106 ;
else
V_2 -> V_103 = V_104 ;
...
goto V_20;
F_26 ( L_5 , V_51 , V_49 [ 2 ] ) ;
F_16 ( V_2 ) -> V_87 = F_38 ( V_51 ) ;
F_16 ( V_2 ) -> V_18 . V_32 = F_25 ( V_51 ) ;
F_16 ( V_2 ) -> V_102 . V_32 = F_24 ( V_51 ) ;
if ( V_51 & V_59 )
F_16 ( V_2 ) -> V_87 |= V_111 ;
if ( F_16 ( V_2 ) -> V_102 . V_32 != V_56 ) {
if ( F_5 ( V_2 , & ( F_16 ( V_2 ) -> V_102 . V_24 ) ) )
goto V_20;
if ( F_39 ( V_2 ) )
F_16 ( V_2 ) -> V_18 . V_24 = F_16 ( V_2 ) -> V_102 . V_24 ;
F_26 ( L_6 , F_16 ( V_2 ) -> V_102 . V_24 ) ;
if ( F_16 ( V_2 ) -> V_102 . V_32 == V_33 ) {
T_2 * V_102 = & ( F_16 ( V_2 ) -> V_102 . V_26 ) ;
if ( F_5 ( V_2 , V_102 ) )
goto V_20;
F_26 ( L_7 ,
F_16 ( V_2 ) -> V_102 . V_26 ) ;
...
if ( F_16 ( V_2 ) -> V_18 . V_32 != V_56 ) {
if ( ! ( F_39 ( V_2 ) ) ) {
T_2 * V_112 = & ( F_16 ( V_2 ) -> V_18 . V_24 ) ;
if ( F_5 ( V_2 , V_112 ) )
goto V_20;
}
F_26 ( L_9 , F_16 ( V_2 ) -> V_102 . V_24 ) ;
