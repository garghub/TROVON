...
return;
F_79 ( & V_150 , V_58 ) ;
F_304 (info, tmp, &domain->devices, link) {
...
if ( V_147 == 0 ) {
unsigned long V_349 ;
F_79 ( & V_56 -> V_171 , V_349 ) ;
F_144 ( V_49 -> V_168 , V_56 -> V_61 ) ;
V_56 -> V_172 -- ;
F_73 ( V_56 ) ;
F_80 ( & V_56 -> V_171 , V_349 ) ;
if ( ! ( V_56 -> V_58 & V_59 ) &&
! ( V_56 -> V_58 & V_60 ) ) {
...
static void F_318 ( struct V_55 * V_56 )
{
unsigned long V_58 ;
struct V_68 * V_69 ;
struct V_48 * V_49 ;
...
V_56 -> V_355 = V_55 ;
V_56 -> V_356 . V_357 = 0 ;
V_56 -> V_356 . V_358 = F_320 ( V_55 -> V_111 ) ;
V_56 -> V_356 . V_359 = true ;
return 0 ;
}
static void F_321 ( struct V_354 * V_56 )
{
struct V_55 * V_55 = V_56 -> V_355 ;
V_56 -> V_355 = NULL ;
F_145 ( V_55 ) ;
}
static int F_322 ( struct V_354 * V_56 ,
struct V_268 * V_151 )
{
struct V_55 * V_55 = V_56 -> V_355 ;
struct V_176 * V_177 = F_241 ( V_151 ) ;
...
static void F_323 ( struct V_354 * V_56 ,
struct V_268 * V_151 )
{
struct V_55 * V_55 = V_56 -> V_355 ;
struct V_176 * V_177 = F_241 ( V_151 ) ;
...
if ( V_55 -> V_353 < V_353 ) {
V_23 V_81 ;
V_81 = F_320 ( V_55 -> V_111 ) + 1 ;
if ( V_81 < V_353 ) {
F_42 ( V_145 L_79
L_80 ,
V_361 , V_55 -> V_111 , V_353 ) ;
return - V_197 ;
}
V_55 -> V_353 = V_353 ;
}
V_84 = F_181 ( V_362 , V_84 ) ;
V_88 = F_192 ( V_55 , V_46 >> V_10 ,
V_362 >> V_10 , V_84 , V_30 ) ;
return V_88 ;
}
static T_5 F_325 ( struct V_354 * V_56 ,
...
static T_6 F_326 ( struct V_354 * V_56 ,
V_222 V_46 )
{
struct V_55 * V_55 = V_56 -> V_355 ;
struct V_25 * V_26 ;
...
static int F_327 ( struct V_354 * V_56 ,
unsigned long V_52 )
{
struct V_55 * V_55 = V_56 -> V_355 ;
if ( V_52 == V_368 )
...
static int F_328 ( struct V_268 * V_151 )
{
struct V_176 * V_177 = F_241 ( V_151 ) ;
struct V_176 * V_334 , * V_371 = NULL ;
struct V_372 * V_373 ;
int V_88 ;
...
V_371 = F_330 ( V_177 ) ;
F_331 ( & V_371 , F_332 ( V_371 ) ) ;
if ( V_371 -> V_374 &&
! F_333 ( V_371 , V_375 ) ) {
T_2 V_64 , V_376 = F_172 ( V_371 -> V_74 ) ;
for ( V_64 = 0 ; V_64 < 8 ; V_64 ++ ) {
struct V_176 * V_202 ;
V_202 = F_334 ( V_371 -> V_73 , F_282 ( V_376 , V_64 ) ) ;
if ( ! V_202 )
continue;
if ( ! F_333 ( V_202 , V_375 ) ) {
F_331 ( & V_371 , V_202 ) ;
break;
}
F_335 ( V_202 ) ;
...
while ( ! F_224 ( V_371 -> V_73 ) ) {
struct V_333 * V_73 = V_371 -> V_73 ;
while ( ! V_73 -> V_203 ) {
if ( ! F_224 ( V_73 ) )
V_73 = V_73 -> V_93 ;
else
...
if ( F_336 ( V_73 -> V_203 , NULL , V_375 ) )
break;
F_331 ( & V_371 , F_330 ( V_73 -> V_203 ) ) ;
}
V_377:
V_373 = F_337 ( & V_371 -> V_151 ) ;
F_335 ( V_371 ) ;
if ( ! V_373 ) {
V_373 = F_338 () ;
if ( F_339 ( V_373 ) )
...
V_88 = F_341 ( V_373 , V_151 ) ;
F_342 ( V_373 ) ;
return V_88 ;
}
static void F_343 ( struct V_268 * V_151 )
{
F_344 ( V_151 ) ;
}
static void F_345 ( struct V_176 * V_151 )
{
F_42 ( V_35 L_81 ) ;
V_36 = 0 ;
}
...
struct V_176 * V_177 ;
T_8 V_381 ;
V_177 = F_349 ( V_382 , 0x3a3e , NULL ) ;
if ( ! V_177 )
return;
F_335 ( V_177 ) ;
V_177 = F_349 ( V_382 , 0x342e , NULL ) ;
if ( ! V_177 )
return;
if ( F_350 ( V_177 , 0x188 , & V_381 ) ) {
F_335 ( V_177 ) ;
return;
}
F_335 ( V_177 ) ;
