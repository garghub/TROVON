...
int V_44 ;
int V_73 ;
V_2 = F_30 ( & V_64 -> V_68 , sizeof( * V_2 ) , V_74 ) ;
if ( ! V_2 )
return - V_75 ;
V_2 -> V_76 = F_31 ( V_70 , L_2 ) ;
if ( V_2 -> V_76 < 0 )
return V_2 -> V_76 ;
V_2 -> V_3 = (enum V_77 ) V_66 -> V_78 ;
...
F_40 ( V_2 -> V_35 , F_12 ) ;
F_41 ( V_2 -> V_35 , V_2 ) ;
V_73 = F_42 ( & V_2 -> V_18 , & V_64 -> V_68 , 4 ,
V_2 -> V_19 + F_43 ( V_2 ) ,
...
if ( V_73 )
goto V_82;
V_2 -> V_18 . V_12 . V_83 = F_25 ;
V_2 -> V_18 . V_12 . V_19 = V_2 -> V_76 * 32 ;
V_73 = F_46 ( & V_2 -> V_18 . V_12 ) ;
if ( V_73 )
goto V_84;
return 0 ;
V_84:
