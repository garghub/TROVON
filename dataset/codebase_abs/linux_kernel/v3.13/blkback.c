...
static struct V_60 * F_46 ( struct V_1 * V_2 )
{
struct V_60 * V_61 = NULL ;
unsigned long V_4 ;
F_2 ( & V_2 -> V_62 , V_4 ) ;
if ( ! F_3 ( & V_2 -> V_63 ) ) {
V_61 = F_47 ( V_2 -> V_63 . V_64 , struct V_60 ,
V_65 ) ;
F_8 ( & V_61 -> V_65 ) ;
}
F_5 ( & V_2 -> V_62 , V_4 ) ;
...
static void F_48 ( struct V_1 * V_2 , struct V_60 * V_61 )
{
unsigned long V_4 ;
int V_66 ;
F_2 ( & V_2 -> V_62 , V_4 ) ;
...
static int F_50 ( struct V_68 * V_61 , struct V_1 * V_2 ,
int V_69 )
{
...
if ( F_52 ( V_77 < V_61 -> V_78 ) )
goto V_75;
if ( F_52 ( V_77 > F_53 ( V_20 ) ) )
goto V_75;
}
V_61 -> V_79 = V_20 -> V_80 ;
V_61 -> V_81 = V_20 -> V_81 ;
...
struct V_82 V_83 ;
int V_84 ;
struct V_85 * V_79 = F_55 ( V_2 -> V_86 ) ;
unsigned long long V_87 = F_53 ( V_20 ) ;
F_56 ( V_28 L_9 ,
V_2 -> V_88 , F_57 ( V_20 -> V_80 ) , F_58 ( V_20 -> V_80 ) ) ;
F_56 ( V_28 L_10 , V_87 ) ;
V_20 -> V_89 = V_87 ;
V_90:
V_84 = F_59 ( & V_83 ) ;
...
V_84 = F_61 ( V_83 , V_79 -> V_91 , L_12 , L_13 ,
( unsigned long long ) F_53 ( V_20 ) ) ;
if ( V_84 ) {
F_60 ( V_28 L_14 ) ;
goto abort;
}
V_84 = F_61 ( V_83 , V_79 -> V_91 , L_15 , L_16 , V_79 -> V_92 ) ;
if ( V_84 ) {
F_60 ( V_28 L_17 ) ;
goto abort;
}
...
V_111:
if ( V_2 -> V_20 . V_113 &&
F_75 ( V_107 , V_2 -> V_114 ) ) {
F_38 ( V_2 ) ;
V_2 -> V_114 = V_107 + F_66 ( V_110 ) ;
}
F_11 ( V_2 , V_115 ) ;
if ( V_116 && F_75 ( V_107 , V_2 -> V_106 ) )
F_65 ( V_2 ) ;
}
F_11 ( V_2 , 0 ) ;
if ( ! F_76 ( & V_2 -> V_23 ) )
...
V_60 -> V_139 ,
V_60 -> V_140 ) ;
F_91 ( V_60 -> V_2 , V_60 -> V_173 ,
V_60 -> V_69 , V_60 -> V_134 ) ;
F_77 ( V_60 -> V_2 ) ;
if ( F_41 ( & V_60 -> V_2 -> V_177 ) <= 2 ) {
if ( F_41 ( & V_60 -> V_2 -> V_176 ) )
F_100 ( & V_60 -> V_2 -> V_178 ) ;
}
F_48 ( V_60 -> V_2 , V_60 ) ;
}
}
...
if ( F_52 ( V_148 == 0 && V_69 != V_213 ) ||
F_52 ( ( V_61 -> V_69 != V_203 ) &&
( V_148 > V_40 ) ) ||
F_52 ( ( V_61 -> V_69 == V_203 ) &&
( V_148 > V_216 ) ) ) {
F_42 ( V_28 L_33 ,
...
unsigned short V_226 , int V_227 )
{
struct V_228 V_229 ;
unsigned long V_4 ;
union V_186 * V_187 = & V_2 -> V_187 ;
