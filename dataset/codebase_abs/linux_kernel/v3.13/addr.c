...
static int F_39 ( struct V_25 * V_26 , struct V_2 * V_2 )
{
int V_37 = F_27 ( V_26 , V_2 ) ;
F_40 ( V_2 ) ;
return V_37 ;
}
static void F_41 ( struct V_38 * V_39 , struct V_40 * V_41 )
{
struct V_6 * V_6 = V_39 -> V_42 ;
struct V_43 * V_44 ;
int V_45 = V_39 -> V_46 ;
int V_47 = F_42 ( V_41 -> V_48 . V_49 ) ;
int V_50 ;
int V_51 ;
F_7 ( L_9 , V_6 , V_39 , V_45 , V_47 ) ;
V_44 = F_43 ( V_39 , 0 ) ;
F_8 ( V_44 -> type != V_52 ) ;
V_50 = F_44 ( ( T_2 ) V_44 -> V_53 ,
( T_2 ) V_44 -> V_22 ) ;
