...
{
struct V_391 * V_10 = F_199 ( & V_377 -> V_377 ) ;
struct V_5 V_392 ;
...
V_392 . V_2 . V_17 = V_10 -> V_17 ;
V_392 . V_2 . V_14 = V_10 -> V_14 ;
V_392 . V_2 . V_145 = V_10 -> V_145 ;
V_392 . V_2 . V_239 = V_10 -> V_239 ;
V_392 . V_2 . V_59 = V_10 -> V_59 ;
V_392 . V_2 . V_13 = V_10 -> V_13 ;
V_392 . V_2 . V_20 = V_10 -> V_20 ;
V_392 . V_2 . V_102 = V_10 -> V_102 ;
V_392 . V_2 . V_124 = V_10 -> V_124 ;
V_392 . V_2 . V_16 = V_10 -> V_16 ;
V_392 . V_2 . V_389 = V_10 -> V_389 ;
V_392 . V_2 . type = V_10 -> type ;
V_392 . V_2 . F_3 = V_10 -> F_3 ;
V_392 . V_2 . F_5 = V_10 -> F_5 ;
V_392 . V_2 . V_28 = V_10 -> V_28 ;
V_392 . V_2 . V_393 = V_10 -> V_393 ;
V_392 . V_2 . V_336 = V_10 -> V_336 ;
V_392 . V_2 . V_341 = V_10 -> V_341 ;
V_392 . V_2 . V_377 = & V_377 -> V_377 ;
V_392 . V_2 . V_239 |= V_362 ;
V_213 = F_200 ( & V_392 ) ;
if ( V_213 < 0 ) {
F_201 ( & V_377 -> V_377 , L_29
L_30 , V_132 ,
...
static int F_202 ( struct V_390 * V_377 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_363 ; V_132 ++ ) {
struct V_5 * V_6 = & V_365 [ V_132 ] ;
...
static int F_204 ( struct V_390 * V_377 , T_4 V_183 )
{
int V_132 ;
...
static int F_205 ( struct V_390 * V_377 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_364 ; V_132 ++ ) {
struct V_5 * V_6 = & V_365 [ V_132 ] ;
...
static struct V_5 * F_206 ( struct V_1 * V_2 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_363 ; V_132 ++ )
...
F_105 ( & V_395 ) ;
V_392 = F_206 ( & V_6 -> V_2 ) ;
if ( V_392 && V_392 -> V_2 . type != V_273 ) {
if ( V_392 -> V_2 . V_377 )
F_207 ( & V_3 , & V_392 -> V_2 ) ;
V_392 -> V_2 . V_17 = V_6 -> V_2 . V_17 ;
V_392 -> V_2 . V_14 = V_6 -> V_2 . V_14 ;
V_392 -> V_2 . V_145 = V_6 -> V_2 . V_145 ;
V_392 -> V_2 . V_239 = V_6 -> V_2 . V_239 ;
V_392 -> V_2 . V_59 = V_6 -> V_2 . V_59 ;
V_392 -> V_2 . V_135 = V_6 -> V_2 . V_135 ;
V_392 -> V_2 . V_13 = V_6 -> V_2 . V_13 ;
V_392 -> V_2 . V_20 = V_6 -> V_2 . V_20 ;
V_392 -> V_2 . V_102 = V_6 -> V_2 . V_102 | V_396 ;
V_392 -> V_89 = V_6 -> V_89 ;
V_392 -> V_2 . V_124 = V_6 -> V_2 . V_124 ;
V_392 -> V_2 . V_389 = V_6 -> V_2 . V_389 ;
V_392 -> V_2 . V_135 = V_6 -> V_2 . V_135 ;
V_392 -> V_137 = V_6 -> V_137 ;
V_392 -> V_36 = V_6 -> V_36 ;
if ( V_392 -> V_2 . V_135 && ! V_392 -> V_137 )
V_392 -> V_137 = V_392 -> V_2 . V_135 ;
if ( V_6 -> V_2 . V_377 )
V_392 -> V_2 . V_377 = V_6 -> V_2 . V_377 ;
if ( V_6 -> V_2 . V_102 & V_378 )
F_175 ( V_392 , V_6 -> V_2 . type ) ;
F_26 ( & V_392 -> V_2 ) ;
if ( V_6 -> V_2 . F_3 )
V_392 -> V_2 . F_3 = V_6 -> V_2 . F_3 ;
if ( V_6 -> V_2 . F_5 )
V_392 -> V_2 . F_5 = V_6 -> V_2 . F_5 ;
if ( V_6 -> V_2 . V_28 )
V_392 -> V_2 . V_28 = V_6 -> V_2 . V_28 ;
if ( V_6 -> V_2 . V_336 )
V_392 -> V_2 . V_336 = V_6 -> V_2 . V_336 ;
if ( V_6 -> V_2 . V_341 )
V_392 -> V_2 . V_341 = V_6 -> V_2 . V_341 ;
if ( V_6 -> V_2 . V_393 )
V_392 -> V_2 . V_393 = V_6 -> V_2 . V_393 ;
if ( V_6 -> V_18 )
V_392 -> V_18 = V_6 -> V_18 ;
if ( V_6 -> V_19 )
V_392 -> V_19 = V_6 -> V_19 ;
if ( V_6 -> V_154 )
V_392 -> V_154 = V_6 -> V_154 ;
if ( V_360 != NULL )
V_360 ( 0 , & V_392 -> V_2 ,
& V_392 -> V_36 ) ;
V_213 = F_177 ( & V_3 , & V_392 -> V_2 ) ;
if ( V_213 == 0 )
V_213 = V_392 -> V_2 . line ;
}
F_109 ( & V_395 ) ;
return V_213 ;
}
void F_203 ( int line )
{
struct V_5 * V_392 = & V_365 [ line ] ;
F_105 ( & V_395 ) ;
F_207 ( & V_3 , & V_392 -> V_2 ) ;
if ( V_397 ) {
V_392 -> V_2 . V_102 &= ~ V_396 ;
V_392 -> V_2 . type = V_129 ;
V_392 -> V_2 . V_377 = & V_397 -> V_377 ;
V_392 -> V_36 = V_43 [ V_392 -> V_2 . type ] . V_102 ;
F_177 ( & V_3 , & V_392 -> V_2 ) ;
} else {
V_392 -> V_2 . V_377 = NULL ;
}
F_109 ( & V_395 ) ;
}
...
static void T_5 F_221 ( void )
{
struct V_390 * V_404 = V_397 ;
V_397 = NULL ;
F_222 ( & V_403 ) ;
F_223 ( V_404 ) ;
F_218 () ;
...
static void T_6 F_224 ( void )
{
#undef V_405
#define V_405 "8250_core."
F_225 ( V_369 , & V_406 , & V_369 , 0644 ) ;
F_225 ( V_363 , & V_406 , & V_363 , 0644 ) ;
F_225 ( V_289 , & V_406 , & V_289 , 0644 ) ;
#ifdef F_56
F_226 ( V_405 , V_134 ,
& V_407 , . V_408 = & V_409 ,
0444 , - 1 ) ;
