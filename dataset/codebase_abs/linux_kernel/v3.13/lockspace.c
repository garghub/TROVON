...
F_85 ( V_166 , & V_2 -> V_11 ) ) ;
V_2 -> V_23 . V_33 = V_41 ;
error = F_86 ( & V_2 -> V_23 , & V_167 , NULL ,
L_21 , V_2 -> V_36 ) ;
if ( error )
goto V_168;
F_25 ( & V_2 -> V_23 , V_169 ) ;
...
int F_96 ( const char * V_64 , const char * V_65 ,
T_3 V_66 , int V_67 ,
const struct V_68 * V_69 , void * V_70 ,
int * V_71 , T_5 * * V_57 )
{
...
static int F_101 ( int V_56 , void * V_54 , void * V_52 )
{
struct V_171 * V_172 = V_54 ;
if ( V_172 -> V_176 && V_172 -> V_177 & V_178 )
F_102 ( V_172 -> V_176 ) ;
F_103 ( V_172 ) ;
return 0 ;
}
static int F_104 ( struct V_1 * V_2 , int V_179 )
{
int V_180 ;
F_41 ( & V_2 -> V_110 ) ;
if ( V_179 == 0 ) {
V_180 = F_105 ( & V_2 -> V_109 , F_100 , V_2 ) ;
} else if ( V_179 == 1 ) {
V_180 = F_105 ( & V_2 -> V_109 , F_99 , V_2 ) ;
} else {
V_180 = 0 ;
}
F_44 ( & V_2 -> V_110 ) ;
...
static int F_106 ( struct V_1 * V_2 , int V_179 )
{
struct V_126 * V_181 ;
struct V_100 * V_6 ;
int V_72 , V_182 , V_180 ;
V_182 = F_104 ( V_2 , V_179 ) ;
F_41 ( & V_40 ) ;
if ( V_2 -> V_60 == 1 ) {
if ( V_182 ) {
V_180 = - V_183 ;
...
V_181 = F_114 ( & V_2 -> V_117 , struct V_126 ,
V_185 ) ;
F_63 ( & V_181 -> V_185 ) ;
F_112 ( V_181 ) ;
}
