...
if ( F_17 ( V_46 ) && ! V_13 && V_38 -> V_4 . V_41 )
V_13 = F_12 ( V_38 ) ;
if ( ! V_13 ) {
F_3 ( & V_38 -> V_4 , L_8 ,
V_8 ) ;
...
V_45 -> V_23 . V_51 = F_7 ;
V_45 -> V_23 . V_52 = V_53 ;
V_45 -> V_23 . V_54 = F_19 ( V_53 ) ;
V_45 -> V_23 . V_55 = V_13 -> V_55 ;
V_45 -> V_23 . V_56 = V_13 -> V_56 ;
V_45 -> V_23 . V_41 = V_38 -> V_4 . V_41 ;
V_3 = F_20 ( & V_38 -> V_4 , & V_45 -> V_23 ) ;
if ( V_3 ) {
F_3 ( & V_38 -> V_4 , L_11 ) ;
return V_3 ;
}
V_29 = F_21 ( V_38 , 0 ) ;
if ( V_29 <= 0 ) {
F_22 ( & V_38 -> V_4 , L_12 , V_29 ) ;
V_3 = V_29 ;
goto V_57;
}
V_45 -> V_29 = V_29 ;
V_3 = F_23 ( & V_38 -> V_4 , V_29 , NULL ,
F_9 , 0 , L_13 , V_45 ) ;
if ( V_3 ) {
