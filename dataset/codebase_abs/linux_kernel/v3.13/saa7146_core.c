...
V_10 = - V_49 ;
V_2 -> V_93 . V_94 = F_31 ( V_30 , V_95 ,
& V_2 -> V_93 . V_96 ) ;
if ( ! V_2 -> V_93 . V_94 )
goto V_97;
memset ( V_2 -> V_93 . V_94 , 0x0 , V_95 ) ;
V_2 -> V_98 . V_94 = F_31 ( V_30 , V_95 ,
& V_2 -> V_98 . V_96 ) ;
if ( ! V_2 -> V_98 . V_94 )
goto V_99;
memset ( V_2 -> V_98 . V_94 , 0x0 , V_95 ) ;
V_2 -> V_100 . V_94 = F_31 ( V_30 , V_95 ,
& V_2 -> V_100 . V_96 ) ;
if ( ! V_2 -> V_100 . V_94 )
goto V_101;
memset ( V_2 -> V_100 . V_94 , 0x0 , V_95 ) ;
...
static void F_60 ( struct V_29 * V_116 )
{
struct V_117 * V_115 = F_61 ( V_116 ) ;
...
V_62 -> V_121 . remove = F_60 ;
F_50 ( L_19 , V_62 -> V_13 ) ;
return F_64 ( & V_62 -> V_121 ) ;
}
