...
static inline int F_35 ( struct V_1 * V_7 , int V_55 )
{
return F_36 ( V_7 ) > V_55 ;
}
int F_37 ( struct V_1 * V_7 , int V_56 )
{
struct V_1 * V_12 , * V_45 ;
struct V_1 * V_57 = V_7 -> V_58 ;
int V_46 = 0 ;
if ( V_7 == V_57 )
return F_35 ( V_7 , V_56 ) ;
if ( ! F_10 ( & V_7 -> V_59 ) || F_35 ( V_7 , V_56 ) )
return 1 ;
for ( V_12 = F_21 ( V_57 , V_57 ) ; V_12 ;
V_12 = F_21 ( V_12 , V_57 ) ) {
V_45 = F_38 ( & V_12 -> V_7 , V_7 -> V_60 ) ;
if ( V_45 && F_10 ( & V_45 -> V_59 ) &&
( V_46 = F_35 ( V_45 , 1 ) ) )
break;
}
return V_46 ;
