...
void T_5 F_153 ( int V_147 , struct V_148 * V_149 )
{
F_68 ( 1 << V_147 ) ;
F_154 () ;
}
...
static void * T_6 F_156 ( unsigned int V_46 , T_8 V_211 ,
T_8 V_212 )
{
const unsigned long V_213 = F_40 ( V_214 ) ;
#ifdef F_157
int V_215 = F_158 ( V_46 ) ;
void * V_216 ;
if ( ! F_159 ( V_215 ) || ! F_160 ( V_215 ) ) {
V_216 = F_161 ( V_211 , V_212 , V_213 ) ;
F_162 ( L_33 ,
V_46 , V_215 ) ;
F_163 ( L_34 ,
V_46 , V_211 , F_40 ( V_216 ) ) ;
} else {
V_216 = F_164 ( F_160 ( V_215 ) ,
V_211 , V_212 , V_213 ) ;
F_163 ( L_35
...
return V_216 ;
#else
return F_161 ( V_211 , V_212 , V_213 ) ;
#endif
}
static void T_6 F_165 ( void * V_216 , T_8 V_211 )
{
F_166 ( F_40 ( V_216 ) , V_211 ) ;
}
static int T_6 F_167 ( unsigned int V_217 , unsigned int V_218 )
{
if ( F_158 ( V_217 ) == F_158 ( V_218 ) )
return V_219 ;
else
return V_220 ;
}
static void T_6 F_168 ( unsigned long V_221 )
{
T_9 * V_155 = F_169 ( V_221 ) ;
T_10 * V_222 ;
T_11 * V_223 ;
V_222 = F_170 ( V_155 , V_221 ) ;
if ( F_171 ( * V_222 ) ) {
T_11 * V_224 ;
V_224 = F_161 ( V_225 , V_225 , V_225 ) ;
F_172 ( & V_12 , V_222 , V_224 ) ;
}
V_223 = F_173 ( V_222 , V_221 ) ;
if ( ! F_174 ( * V_223 ) ) {
T_12 * V_224 ;
V_224 = F_161 ( V_225 , V_225 , V_225 ) ;
F_175 ( & V_12 , V_223 , V_224 ) ;
}
}
void T_6 F_176 ( void )
{
