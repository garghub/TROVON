...
T_4 V_139 ;
int V_21 ;
V_21 = F_71 ( - 1 , NULL , V_140 , sizeof( * V_49 ) , & V_91 ) ;
if ( V_21 < 0 )
return V_21 ;
F_72 ( V_91 , & V_60 -> V_61 ) ;
V_49 = V_91 -> V_50 ;
...
V_21 = F_75 ( & V_49 -> V_55 , V_60 , 0 ) ;
if ( V_21 < 0 )
goto V_142;
V_21 = F_76 ( & V_49 -> V_54 , V_60 , V_143 ) ;
if ( V_21 < 0 )
goto V_70;
V_91 -> V_144 = F_64 ;
...
F_77 ( & V_60 -> V_61 ) , 100 << V_138 -> V_151 ) ;
...
static void F_81 ( struct V_130 * V_60 )
{
struct V_49 * V_49 = F_82 ( & V_60 -> V_61 ) ;
F_83 ( V_49 -> V_60 ) ;
if ( F_84 ( & V_49 -> V_55 ) < 0 ) {
F_85 ( & V_49 -> V_54 ) ;
F_26 ( & V_49 -> V_64 ) ;
...
static void F_87 ( struct V_130 * V_60 )
{
struct V_49 * V_49 = F_82 ( & V_60 -> V_61 ) ;
F_85 ( & V_49 -> V_54 ) ;
F_88 ( V_49 -> V_91 ) ;
