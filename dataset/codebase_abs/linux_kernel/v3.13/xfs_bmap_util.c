...
if ( V_2 -> V_60 || F_68 ( V_2 ) > V_2 -> V_57 . V_161 ) {
...
V_133 = F_77 ( V_2 ) ;
if ( V_135 > F_78 ( V_2 , V_72 ) * 2 + 1 )
V_135 = F_78 ( V_2 , V_72 ) * 2 + 1 ;
V_140 = F_79 ( V_72 ) ;
if ( ! ( V_139 & V_164 ) )
V_140 |= V_165 ;
error = V_158 ;
V_137 = 16 ;
V_134 = F_80 ( V_137 * sizeof( * V_134 ) , V_166 | V_167 ) ;
if ( ! V_134 )
goto V_168;
V_128 -> V_155 = 0 ;
if ( F_78 ( V_2 , V_72 ) == 0 &&
...
error = F_81 ( V_2 , F_82 ( V_12 , V_128 -> V_122 ) ,
...
T_2 V_183 ;
T_4 V_6 ;
error = F_81 ( V_2 , V_179 , 1 , & V_181 , & V_182 ,
V_184 ) ;
if ( error ) {
if ( ! F_14 ( V_2 -> V_4 ) ) {
F_88 ( V_2 -> V_4 ,
...
V_182 = 1 ;
F_22 ( V_2 , V_198 ) ;
error = F_81 ( V_2 , V_194 , V_196 , & V_181 , & V_182 , 0 ) ;
F_85 ( V_2 , V_198 ) ;
if ( ! error && ( V_182 != 0 ) &&
( V_181 . V_173 != V_120 ||
V_2 -> V_60 ) ) {
...
V_234 = 1 ;
error = F_81 ( V_2 , V_232 , 1 , & V_181 , & V_234 , 0 ) ;
if ( error || V_234 < 1 )
break;
ASSERT ( V_181 . V_76 >= 1 ) ;
...
V_239 = F_105 ( V_12 , V_45 + V_205 ) ;
F_129 ( F_76 ( V_2 ) ) ;
V_242 = F_73 ( T_24 , 1 << V_12 -> V_39 . V_243 , V_244 ) ;
V_240 = V_45 & ~ ( V_242 - 1 ) ;
error = - F_130 ( F_76 ( V_2 ) -> V_162 ,
V_240 , - 1 ) ;
if ( error )
goto V_113;
F_131 ( F_76 ( V_2 ) , V_240 , - 1 ) ;
if ( V_214 && ! F_132 ( & V_12 -> V_39 ) ) {
V_234 = 1 ;
error = F_81 ( V_2 , V_211 , 1 ,
& V_181 , & V_234 , 0 ) ;
if ( error )
goto V_113;
...
ASSERT ( V_181 . V_173 != V_124 ) ;
V_85 = V_181 . V_173 ;
V_241 = F_26 ( V_85 , V_12 -> V_39 . V_40 ) ;
if ( V_241 )
V_211 += V_12 -> V_39 . V_40 - V_241 ;
}
V_234 = 1 ;
error = F_81 ( V_2 , V_239 - 1 , 1 ,
& V_181 , & V_234 , 0 ) ;
if ( error )
goto V_113;
ASSERT ( V_234 == 0 || V_234 == 1 ) ;
...
T_24 V_251 ;
int error ;
V_249 = F_73 ( V_105 , 1 << V_12 -> V_39 . V_243 , V_244 ) ;
V_250 = F_135 ( V_45 , V_249 ) ;
V_251 = F_136 ( V_45 + V_205 , V_249 ) ;
ASSERT ( V_250 >= V_45 ) ;
...
goto V_113;
if ( V_250 != V_45 ) {
error = F_137 ( V_2 , V_45 , V_250 - V_45 ) ;
if ( error )
goto V_113;
}
if ( V_251 != V_45 + V_205 )
error = F_137 ( V_2 , V_251 ,
V_45 + V_205 - V_251 ) ;
} else {
error = F_137 ( V_2 , V_45 , V_205 ) ;
}
V_113:
return error ;
}
...
V_254 -> V_57 . V_149 == V_147 )
return V_148 ;
if ( V_2 -> V_57 . V_255 < V_254 -> V_57 . V_255 )
return V_148 ;
if ( V_2 -> V_57 . V_149 == V_103 &&
V_254 -> V_57 . V_149 == V_146 )
return V_148 ;
if ( V_254 -> V_57 . V_149 == V_103 &&
F_78 ( V_254 , V_125 ) >
F_139 ( V_2 , V_125 ) )
return V_148 ;
if ( V_2 -> V_57 . V_149 == V_103 &&
...
F_139 ( V_254 , V_125 ) )
return V_148 ;
if ( V_254 -> V_57 . V_149 == V_146 ) {
if ( F_140 ( V_2 ) &&
F_141 ( V_254 -> V_190 . V_106 ) > F_140 ( V_2 ) )
return V_148 ;
if ( F_78 ( V_254 , V_125 ) <=
F_139 ( V_2 , V_125 ) )
return V_148 ;
...
if ( F_140 ( V_254 ) &&
F_141 ( V_2 -> V_190 . V_106 ) > F_140 ( V_254 ) )
return V_148 ;
if ( F_78 ( V_2 , V_125 ) <=
F_139 ( V_254 , V_125 ) )
return V_148 ;
...
T_13 * V_259 , * V_77 , * V_260 ;
int V_261 , V_262 ;
int error = 0 ;
int V_263 = 0 ;
int V_264 = 0 ;
T_27 V_265 ;
V_259 = F_80 ( sizeof( T_13 ) , V_166 ) ;
if ( ! V_259 ) {
error = F_58 ( V_158 ) ;
goto V_113;
}
F_143 ( V_2 , V_254 , V_200 ) ;
F_143 ( V_2 , V_254 , V_49 ) ;
if ( ( V_2 -> V_57 . V_188 & V_266 ) != ( V_254 -> V_57 . V_188 & V_266 ) ) {
error = F_58 ( V_148 ) ;
goto V_267;
}
if ( F_2 ( V_2 ) != F_2 ( V_254 ) ) {
error = F_58 ( V_148 ) ;
goto V_267;
}
error = - F_75 ( F_76 ( V_254 ) -> V_162 ) ;
if ( error )
goto V_267;
F_131 ( F_76 ( V_254 ) , 0 , - 1 ) ;
if ( F_94 ( F_76 ( V_254 ) ) != 0 ) {
error = F_58 ( V_148 ) ;
goto V_267;
}
if ( V_256 -> V_268 != 0 ||
V_256 -> V_269 != V_2 -> V_57 . V_161 ||
V_256 -> V_269 != V_254 -> V_57 . V_161 ) {
error = F_58 ( V_270 ) ;
goto V_267;
}
F_144 ( V_2 , 0 ) ;
F_144 ( V_254 , 1 ) ;
error = F_138 ( V_2 , V_254 ) ;
if ( error ) {
F_145 ( V_12 ,
L_7 ,
V_271 , V_2 -> V_185 ) ;
...
if ( ( V_257 -> V_272 . V_273 != F_76 ( V_2 ) -> V_274 . V_273 ) ||
( V_257 -> V_272 . V_275 != F_76 ( V_2 ) -> V_274 . V_275 ) ||
( V_257 -> V_276 . V_273 != F_76 ( V_2 ) -> V_277 . V_273 ) ||
( V_257 -> V_276 . V_275 != F_76 ( V_2 ) -> V_277 . V_275 ) ) {
error = F_58 ( V_278 ) ;
goto V_267;
}
if ( F_146 ( F_76 ( V_2 ) ) ) {
...
F_131 ( F_76 ( V_2 ) , 0 , - 1 ) ;
V_5 = F_97 ( V_12 , V_279 ) ;
error = F_11 ( V_5 , & F_100 ( V_12 ) -> V_280 , 0 , 0 ) ;
if ( error ) {
F_85 ( V_2 , V_200 ) ;
F_85 ( V_254 , V_200 ) ;
F_99 ( V_5 , 0 ) ;
...
F_143 ( V_2 , V_254 , V_49 ) ;
if ( ( ( F_72 ( V_2 ) != 0 ) && ( V_2 -> V_57 . V_281 > 0 ) ) &&
( V_2 -> V_57 . V_145 != V_147 ) ) {
error = F_60 ( V_5 , V_2 , V_144 , & V_263 ) ;
if ( error )
goto V_282;
}
if ( ( ( F_72 ( V_254 ) != 0 ) && ( V_254 -> V_57 . V_281 > 0 ) ) &&
( V_254 -> V_57 . V_145 != V_147 ) ) {
error = F_60 ( V_5 , V_254 , V_144 ,
& V_264 ) ;
if ( error )
goto V_282;
}
F_23 ( V_5 , V_2 , V_49 | V_200 ) ;
F_23 ( V_5 , V_254 , V_49 | V_200 ) ;
V_261 = V_59 ;
V_262 = V_59 ;
if ( V_2 -> V_57 . V_283 == 3 &&
V_2 -> V_57 . V_149 == V_146 ) {
V_262 |= V_284 ;
error = F_147 ( V_5 , V_2 , V_125 ,
V_254 -> V_185 , NULL ) ;
if ( error )
goto V_282;
}
if ( V_254 -> V_57 . V_283 == 3 &&
V_254 -> V_57 . V_149 == V_146 ) {
V_261 |= V_284 ;
error = F_147 ( V_5 , V_254 , V_125 ,
V_2 -> V_185 , NULL ) ;
if ( error )
goto V_282;
}
...
V_2 -> V_57 . V_58 = V_254 -> V_57 . V_58 - V_264 + V_263 ;
V_254 -> V_57 . V_58 = V_265 + V_264 - V_263 ;
V_265 = ( T_27 ) V_2 -> V_57 . V_255 ;
V_2 -> V_57 . V_255 = V_254 -> V_57 . V_255 ;
V_254 -> V_57 . V_255 = V_265 ;
V_265 = ( T_27 ) V_2 -> V_57 . V_149 ;
V_2 -> V_57 . V_149 = V_254 -> V_57 . V_149 ;
V_254 -> V_57 . V_149 = V_265 ;
ASSERT ( V_254 -> V_60 == 0 ) ;
V_254 -> V_60 = V_2 -> V_60 ;
V_2 -> V_60 = 0 ;
switch ( V_2 -> V_57 . V_149 ) {
case V_103 :
if ( V_2 -> V_57 . V_255 <= V_285 ) {
V_77 -> V_286 . V_287 =
V_77 -> V_288 . V_289 ;
}
V_261 |= V_290 ;
...
switch ( V_254 -> V_57 . V_149 ) {
case V_103 :
if ( V_254 -> V_57 . V_255 <= V_285 ) {
V_260 -> V_286 . V_287 =
V_260 -> V_288 . V_289 ;
}
V_262 |= V_290 ;
...
case V_146 :
V_262 |= V_291 ;
ASSERT ( V_254 -> V_57 . V_283 < 3 ||
( V_262 & V_284 ) ) ;
break;
}
F_28 ( V_5 , V_2 , V_261 ) ;
F_28 ( V_5 , V_254 , V_262 ) ;
if ( V_12 -> V_292 & V_293 )
F_148 ( V_5 ) ;
error = F_9 ( V_5 , 0 ) ;
F_149 ( V_2 , 0 ) ;
