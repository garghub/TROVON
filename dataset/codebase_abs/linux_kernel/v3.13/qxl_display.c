...
F_49 ( V_6 , V_108 , V_115 , V_32 , V_109 ,
V_111 , V_112 , V_116 ) ;
return 0 ;
}
int
...
int V_58 ;
V_122 -> V_70 = V_70 ;
V_58 = F_51 ( V_39 , & V_122 -> V_113 , & V_125 ) ;
if ( V_58 ) {
V_122 -> V_70 = NULL ;
return V_58 ;
}
F_52 ( & V_122 -> V_113 , V_124 ) ;
return 0 ;
}
static void F_53 ( struct V_51 * V_52 , int V_46 )
{
}
static bool F_54 ( struct V_51 * V_52 ,
...
F_58 ( V_6 , V_68 -> V_44 , 0 , 0 , 0 , 0 , 0 ) ;
F_55 ( V_6 ) ;
}
static int F_66 ( struct V_38 * V_39 , int V_144 )
{
struct V_53 * V_53 ;
V_53 = F_4 ( sizeof( struct V_53 ) , V_10 ) ;
if ( ! V_53 )
return - V_145 ;
F_67 ( V_39 , & V_53 -> V_113 , & V_146 ) ;
V_53 -> V_44 = V_144 ;
F_68 ( & V_53 -> V_113 , 256 ) ;
F_69 ( & V_53 -> V_113 , & V_147 ) ;
return 0 ;
}
static void F_70 ( struct V_148 * V_149 , int V_46 )
{
F_60 ( L_18 ) ;
}
static bool F_71 ( struct V_148 * V_149 ,
const struct V_45 * V_46 ,
struct V_45 * V_126 )
{
F_60 ( L_18 ) ;
...
static void F_76 ( struct V_148 * V_149 ,
struct V_45 * V_46 ,
struct V_45 * V_126 )
{
F_60 ( L_18 ) ;
...
struct V_45 * V_46 )
{
F_60 ( L_24 , V_46 -> V_150 , V_46 -> V_127 ,
V_46 -> V_128 , V_46 -> V_151 ) ;
return V_152 ;
}
static struct V_148 * F_79 ( struct V_34 * V_35 )
{
struct V_41 * V_41 =
F_13 ( V_35 ) ;
F_60 ( L_18 ) ;
...
F_60 ( L_25 , V_42 -> V_44 , V_156 ) ;
if ( ! V_156 )
F_58 ( V_6 , V_42 -> V_44 , 0 , 0 , 0 , 0 , 0 ) ;
return V_156 ? V_157
: V_158 ;
}
...
static int F_91 ( struct V_38 * V_39 , int V_164 )
{
struct V_5 * V_6 = V_39 -> V_40 ;
struct V_41 * V_41 ;
struct V_34 * V_35 ;
...
V_35 = & V_41 -> V_113 ;
V_149 = & V_41 -> V_153 ;
F_92 ( V_39 , & V_41 -> V_113 ,
& V_165 , V_166 ) ;
F_93 ( V_39 , & V_41 -> V_153 , & V_167 ,
V_168 ) ;
V_35 -> V_169 = V_170 ;
V_149 -> V_171 = 1 << V_164 ;
F_94 ( & V_41 -> V_113 ,
...
if ( V_108 == NULL )
return NULL ;
V_58 = F_50 ( V_39 , V_108 , V_124 , V_70 ) ;
if ( V_58 ) {
F_3 ( V_108 ) ;
F_41 ( V_70 ) ;
return NULL ;
