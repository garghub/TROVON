...
V_54 = V_63 ;
if ( V_29 -> V_30 -> V_65 ) {
char V_60 * V_70 = ( char V_60 * ) V_62 ;
V_69 = V_29 -> V_30 -> V_65 ( V_29 , V_70 , V_54 ) ;
} else {
...
unsigned int V_56 ;
void * V_43 ;
V_56 = V_92 -> V_43 . V_84 * V_92 -> V_43 . V_93 ;
if ( V_29 -> V_30 -> V_65 ) {
V_43 = NULL ;
} else {
V_43 = F_32 ( V_56 , V_27 ) ;
...
V_69 = V_29 -> V_30 -> V_102 ( V_29 , V_92 ) ;
if ( V_69 )
goto V_75;
V_29 -> V_103 = false ;
V_29 -> V_104 = false ;
...
if ( ! V_92 )
return - V_28 ;
V_69 = V_29 -> V_30 -> V_107 ( V_29 , V_92 ) ;
if ( V_69 )
goto V_75;
...
if ( ! V_29 -> V_30 -> V_110 )
return - V_76 ;
if ( F_21 ( & V_109 , ( void V_60 * ) V_57 , sizeof( V_109 ) ) )
return - V_61 ;
V_69 = V_29 -> V_30 -> V_110 ( V_29 , & V_109 ) ;
if ( V_69 != 0 )
return V_69 ;
if ( F_18 ( ( void V_60 * ) V_57 , & V_109 , sizeof( V_109 ) ) )
return - V_61 ;
return 0 ;
}
static int
...
if ( F_21 ( & V_109 , ( void V_60 * ) V_57 , sizeof( V_109 ) ) )
return - V_61 ;
V_69 = V_29 -> V_30 -> V_111 ( V_29 , & V_109 ) ;
V_29 -> V_103 = true ;
return V_69 ;
}
static inline int
...
return - V_105 ;
V_69 = V_29 -> V_30 -> V_41 ( V_29 , V_113 ) ;
if ( ! V_69 )
V_29 -> V_9 -> V_33 = V_38 ;
return V_69 ;
}
...
if ( V_29 -> V_103 == false )
return - V_105 ;
V_69 = V_29 -> V_30 -> V_41 ( V_29 , V_117 ) ;
if ( V_69 != 0 )
return V_69 ;
V_29 -> V_103 = false ;
V_29 -> V_104 = true ;
...
if ( V_29 -> V_104 == false )
return - V_105 ;
V_69 = V_29 -> V_30 -> V_41 ( V_29 , V_118 ) ;
if ( V_69 ) {
F_14 ( L_16 ) ;
F_45 ( & V_29 -> V_9 -> V_35 ) ;
return V_69 ;
...
static long F_49 ( struct V_2 * V_3 , unsigned int V_119 , unsigned long V_57 )
{
struct V_6 * V_7 = V_3 -> V_31 ;
struct V_44 * V_29 ;
int V_69 = - V_120 ;
...
static int F_52 ( struct V_138 * V_32 )
{
int V_13 = - V_20 ;
char V_139 [ 16 ] ;
struct V_4 * V_5 ;
if ( F_23 ( ! V_32 || ! V_32 -> V_140 ) )
return - V_23 ;
V_5 = V_32 -> V_140 ;
sprintf ( V_139 , L_17 , V_5 -> V_26 -> V_141 , V_5 -> V_32 ) ;
F_14 ( L_18 , V_139 , V_5 -> V_142 ,
V_5 -> V_25 ) ;
V_13 = F_53 ( V_22 , V_5 -> V_26 ,
V_5 -> V_32 , & V_143 , V_5 , V_139 ) ;
if ( V_13 < 0 ) {
F_5 ( L_19 , V_13 ) ;
return V_13 ;
}
...
static int F_54 ( struct V_138 * V_32 )
{
struct V_4 * V_5 ;
V_5 = V_32 -> V_140 ;
F_55 ( V_22 , V_5 -> V_26 ,
...
int F_56 ( struct V_144 * V_26 , int V_32 ,
int V_11 , struct V_4 * V_5 )
{
static struct V_145 V_30 = {
. V_146 = NULL ,
. V_147 = F_52 ,
. V_148 = F_54 ,
} ;
...
V_5 -> V_32 = V_32 ;
V_5 -> V_25 = V_11 ;
return F_57 ( V_26 , V_149 , V_5 , & V_30 ) ;
}
static int F_58 ( struct V_4 * V_32 )
{
int V_13 ;
if ( ! V_32 -> V_26 )
return - V_20 ;
...
static int F_60 ( struct V_4 * V_32 )
{
return F_61 ( V_32 -> V_26 ) ;
}
int F_62 ( struct V_4 * V_32 )
{
int V_69 ;
if ( V_32 -> V_142 == NULL || V_32 -> V_150 == NULL || V_32 -> V_30 == NULL )
return - V_20 ;
F_14 ( L_21 , V_32 -> V_142 ) ;
if ( F_23 ( ! V_32 -> V_30 -> V_37 ) )
return - V_20 ;
if ( F_23 ( ! V_32 -> V_30 -> free ) )
return - V_20 ;
if ( F_23 ( ! V_32 -> V_30 -> V_102 ) )
return - V_20 ;
...
int F_64 ( struct V_4 * V_32 )
{
F_14 ( L_22 , V_32 -> V_142 ) ;
F_10 ( & V_151 ) ;
F_60 ( V_32 ) ;
F_11 ( & V_151 ) ;
return 0 ;
