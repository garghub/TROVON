...
{
int V_104 = F_46 ( & V_100 ) ;
F_47 ( & V_6 -> V_79 ) ;
F_48 () ;
F_49 ( & V_6 -> V_79 ) ;
return V_104 ;
}
struct V_5 * F_50 ( int V_105 )
{
struct V_77 * V_78 ;
struct V_5 * V_6 ;
F_20 (item, &mc_devices) {
...
static void F_58 ( unsigned long V_119 , unsigned long V_120 ,
T_1 V_44 )
{
struct V_119 * V_121 ;
void * V_122 ;
...
F_62 ( V_123 ) ;
V_122 = F_63 ( V_121 ) ;
F_64 ( V_122 + V_120 , V_44 ) ;
F_65 ( V_122 ) ;
if ( F_61 ( V_121 ) )
F_66 ( V_123 ) ;
}
int F_67 ( struct V_5 * V_6 , unsigned long V_119 )
{
struct V_25 * * V_37 = V_6 -> V_37 ;
int V_50 , V_7 , V_65 , V_8 ;
F_3 ( 1 , L_48 , V_6 -> V_71 , V_119 ) ;
V_50 = - 1 ;
for ( V_7 = 0 ; V_7 < V_6 -> V_36 ; V_7 ++ ) {
...
F_70 ( V_6 , V_142 -> V_129 , V_62 , V_142 -> V_130 , V_142 -> V_14 , V_142 -> V_22 ,
...
L_60 ,
V_142 -> V_133 , V_142 -> V_134 , V_142 -> V_24 ) ;
F_72 ( V_6 , V_142 -> V_129 , V_62 , V_142 -> V_130 , V_142 -> V_14 , V_142 -> V_22 ,
V_131 , V_142 -> V_132 , V_142 -> V_124 ) ;
}
}
void F_77 ( const enum V_140 type ,
struct V_5 * V_6 ,
const T_2 V_129 ,
const unsigned long V_133 ,
const unsigned long V_134 ,
...
if ( ! V_142 -> V_124 ) {
strcpy ( V_142 -> V_22 , L_64 ) ;
} else {
F_3 ( 4 , L_65 , V_50 , V_16 ) ;
if ( V_10 == V_142 -> V_22 )
strcpy ( V_142 -> V_22 , L_66 ) ;
if ( type == V_146 ) {
if ( V_50 >= 0 ) {
...
if ( V_10 > V_142 -> V_14 )
* ( V_10 - 1 ) = '\0' ;
V_149 = F_78 ( V_142 -> V_24 ) + 1 ;
F_79 ( type , V_142 -> V_130 , V_142 -> V_22 , V_142 -> V_129 ,
V_6 -> V_71 , V_142 -> V_143 , V_142 -> V_144 , V_142 -> V_145 ,
F_80 ( V_142 -> V_133 ) | V_142 -> V_134 ,
