...
F_25 ( V_136 | V_137 | V_155 ,
V_70 -> V_40 + V_141 ) ;
V_70 -> V_102 = V_156 ;
F_25 ( V_110 , V_70 -> V_40 + V_157 ) ;
return 0 ;
}
...
F_25 ( V_136 | V_137 | V_155 ,
V_70 -> V_40 + V_48 ) ;
F_25 ( V_151 , V_70 -> V_40 + V_158 ) ;
F_69 ( V_2 -> V_152 ) ;
}
static unsigned int F_70 ( struct V_69 * V_70 )
{
if ( F_24 ( V_70 -> V_40 + V_41 ) & V_159 )
return V_160 ;
else
return 0 ;
}
...
{
struct V_1 * V_2 = F_36 ( V_70 ) ;
F_25 ( V_161 , V_70 -> V_40 + V_154 ) ;
F_9 ( V_2 ) ;
}
static void F_23 ( struct V_69 * V_70 )
{
F_25 ( V_161 , V_70 -> V_40 + V_97 ) ;
}
static void F_72 ( struct V_69 * V_70 )
{
F_25 ( V_128 , V_70 -> V_40 + V_97 ) ;
}
static void F_73 ( struct V_69 * V_70 , int V_162 )
{
if ( V_162 )
F_25 ( V_163 ,
V_70 -> V_40 + V_157 ) ;
...
static void F_75 ( struct V_69 * V_10 , int V_165 )
{
unsigned int V_166 = 1000 ;
while ( F_24 ( V_10 -> V_40 + V_41 ) & V_42 ) {
if ( ! V_166 -- )
break;
F_65 ( 1 ) ;
}
F_25 ( V_165 , V_10 -> V_40 + V_46 ) ;
}
static void
F_76 ( struct V_167 * V_168 , const char * V_169 , unsigned int V_86 )
{
struct V_1 * V_2 ;
struct V_69 * V_10 ;
unsigned int V_170 , V_171 ;
unsigned int V_166 = 20000 ;
if ( V_168 -> V_172 >= V_173 || V_168 -> V_172 < 0 )
return;
V_2 = V_174 [ V_168 -> V_172 ] ;
V_10 = & V_2 -> V_10 ;
F_77 ( V_2 -> V_152 ) ;
V_171 = F_24 ( V_10 -> V_40 + V_77 ) ;
V_170 = F_24 ( V_10 -> V_40 + V_150 ) ;
F_25 ( V_151 ,
V_10 -> V_40 + V_149 ) ;
F_25 ( V_153 | V_161 ,
V_10 -> V_40 + V_154 ) ;
F_78 ( V_10 , V_169 , V_86 , F_75 ) ;
while ( F_24 ( V_10 -> V_40 + V_41 ) & V_175 ) {
F_65 ( 1 ) ;
if ( ! V_166 -- )
break;
}
if ( ! ( F_24 ( V_10 -> V_40 + V_41 ) & V_175 ) ) {
F_25 ( V_170 , V_10 -> V_40 + V_150 ) ;
F_25 ( V_171 , V_10 -> V_40 + V_77 ) ;
}
F_79 ( V_2 -> V_152 ) ;
}
static void T_4
...
if ( V_178 == 0 )
V_178 = 1 ;
* V_108 = ( V_10 -> V_134 << 2 ) / V_178 ;
}
static int T_4
F_81 ( struct V_167 * V_168 , char * V_184 )
{
struct V_1 * V_2 ;
int V_108 = 9600 ;
int V_176 = 8 ;
...
int V_185 = 'n' ;
int V_186 ;
if ( V_168 -> V_172 == - 1 || V_168 -> V_172 >= F_82 ( V_174 ) )
V_168 -> V_172 = 0 ;
V_2 = V_174 [ V_168 -> V_172 ] ;
if ( ! V_2 )
return - V_187 ;
F_67 ( V_2 -> V_152 ) ;
if ( V_184 )
F_83 ( V_184 , & V_108 , & V_59 , & V_176 , & V_185 ) ;
else
F_80 ( & V_2 -> V_10 , & V_108 , & V_59 , & V_176 ) ;
V_186 = F_84 ( & V_2 -> V_10 , V_168 , V_108 , V_59 , V_176 , V_185 ) ;
F_69 ( V_2 -> V_152 ) ;
return V_186 ;
}
...
if ( ! V_191 )
return 1 ;
V_186 = F_86 ( V_191 , L_7 ) ;
if ( V_186 < 0 ) {
F_13 ( & V_189 -> V_12 , L_8 , V_186 ) ;
return V_186 ;
}
V_2 -> V_10 . line = V_186 ;
...
V_2 -> V_152 = F_91 ( & V_189 -> V_12 , NULL ) ;
if ( F_92 ( V_2 -> V_152 ) ) {
V_186 = F_93 ( V_2 -> V_152 ) ;
goto V_201;
}
...
V_2 -> V_10 . V_102 = V_156 ;
V_2 -> V_10 . V_134 = F_97 ( V_2 -> V_152 ) ;
V_2 -> V_10 . type = V_74 ;
V_2 -> V_10 . V_12 = V_2 -> V_12 = & V_189 -> V_12 ;
V_2 -> V_76 = 0 ;
V_2 -> V_138 = F_98 ( V_189 , 0 ) ;
V_2 -> V_10 . V_138 = V_2 -> V_138 ;
V_186 = F_99 ( V_2 -> V_138 , F_62 , 0 , F_37 ( & V_189 -> V_12 ) , V_2 ) ;
if ( V_186 )
goto V_207;
F_100 ( V_189 , V_2 ) ;
V_174 [ V_2 -> V_10 . line ] = V_2 ;
F_64 ( & V_2 -> V_10 ) ;
V_186 = F_101 ( & V_214 , & V_2 -> V_10 ) ;
if ( V_186 )
goto V_215;
