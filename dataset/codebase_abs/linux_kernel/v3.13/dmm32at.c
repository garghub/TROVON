...
if ( ( V_76 -> V_103 & V_108 ) == 0 ) {
V_101 = ( V_4 -> V_106 & 0x0000ff00 ) >> 8 ;
F_4 ( V_101 , V_2 -> V_19 + V_109 ) ;
}
if ( ( V_76 -> V_103 & V_110 ) == 0 ) {
V_101 = ( V_4 -> V_106 & 0x000000ff ) ;
F_4 ( V_101 , V_2 -> V_19 + V_111 ) ;
}
}
V_101 = F_5 ( V_2 -> V_19 + V_111 ) ;
V_101 |= F_5 ( V_2 -> V_19 + V_109 ) << 8 ;
V_101 |= F_5 ( V_2 -> V_19 + V_107 ) << 16 ;
V_4 -> V_106 = V_101 ;
V_7 [ 1 ] = V_101 ;
return V_6 -> V_8 ;
}
...
V_113 = F_28 ( V_2 , V_4 , V_6 , V_7 , V_100 ) ;
if ( V_113 )
return V_113 ;
if ( V_7 [ 0 ] == V_114 )
V_76 -> V_103 &= ~ V_112 ;
...
unsigned int V_85 ;
V_85 = V_117 -> V_123 [ 1 ] ;
V_113 = F_30 ( V_2 , V_117 -> V_123 [ 0 ] , V_124 ) ;
if ( V_113 )
return V_113 ;
...
if ( V_85 ) {
V_113 = F_32 ( V_85 , F_20 , 0 , V_2 -> V_131 , V_2 ) ;
if ( V_113 < 0 ) {
F_6 ( V_129 L_8 ) ;
return V_113 ;
}
