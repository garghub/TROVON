...
{
int V_104 ;
V_104 = F_48 ( V_103 , 1280 , 1024 ) ;
F_49 ( V_103 , 1024 , 768 ) ;
return V_104 ;
}
static int F_50 ( struct V_89 * V_103 ,
struct V_28 * V_17 )
{
return V_105 ;
}
struct V_95 * F_51 ( struct V_89
* V_103 )
{
...
static enum V_110 F_54 ( struct V_89
* V_103 , bool V_111 )
{
return V_112 ;
}
static void F_55 ( struct V_89 * V_103 )
{
F_56 ( V_103 ) ;
F_28 ( V_103 ) ;
}
static struct V_89 * F_57 ( struct V_4 * V_5 )
{
struct V_89 * V_103 ;
struct V_113 * V_113 ;
V_113 = F_30 ( sizeof( struct V_113 ) , V_90 ) ;
if ( ! V_113 )
return NULL ;
V_103 = & V_113 -> V_91 ;
F_58 ( V_5 , V_103 ,
...
F_61 ( V_7 -> V_5 ) ;
V_7 -> V_49 . V_117 = true ;
V_7 -> V_5 -> V_118 . V_119 = V_120 ;
V_7 -> V_5 -> V_118 . V_121 = V_122 ;
V_7 -> V_5 -> V_118 . V_123 = V_7 -> V_124 . V_125 ;
V_7 -> V_5 -> V_118 . V_126 = 24 ;
V_7 -> V_5 -> V_118 . V_127 = 0 ;
F_29 ( V_7 -> V_5 ) ;
V_96 = F_44 ( V_7 -> V_5 ) ;
if ( ! V_96 ) {
F_19 ( L_2 ) ;
