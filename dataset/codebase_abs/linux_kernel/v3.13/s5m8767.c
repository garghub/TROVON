...
if ( V_32 )
return - V_26 ;
if ( F_34 ( V_72 , L_23 , NULL ) )
V_70 -> V_100 = true ;
if ( F_34 ( V_72 , L_24 , NULL ) )
V_70 -> V_101 = true ;
if ( F_34 ( V_72 , L_25 , NULL ) )
V_70 -> V_102 = true ;
if ( V_70 -> V_100 || V_70 -> V_101
|| V_70 -> V_102 ) {
if ( F_33 ( V_72 , L_26 ,
& V_70 -> V_103 ) )
V_70 -> V_103 = 0 ;
...
struct V_1 * * V_2 ;
struct V_8 * V_9 ;
int V_5 , V_32 , V_106 , V_107 ;
if ( ! V_70 ) {
F_21 ( V_77 -> V_74 . V_78 , L_27 ) ;
return - V_87 ;
}
if ( V_35 -> V_74 -> V_86 ) {
V_32 = F_23 ( V_77 , V_70 ) ;
...
if ( ! V_9 )
return - V_89 ;
V_106 = sizeof( struct V_1 * ) * ( V_108 - 2 ) ;
V_9 -> V_2 = F_27 ( & V_77 -> V_74 , V_106 , V_88 ) ;
if ( ! V_9 -> V_2 )
return - V_89 ;
V_2 = V_9 -> V_2 ;
V_9 -> V_74 = & V_77 -> V_74 ;
...
V_9 -> V_67 = V_70 -> V_103 ;
V_9 -> V_109 = V_70 -> V_100 ;
V_9 -> V_110 = V_70 -> V_101 ;
V_9 -> V_111 = V_70 -> V_102 ;
V_9 -> V_28 = V_70 -> V_28 ;
V_107 = F_10 ( & V_112 ,
V_70 -> V_113 ) ;
F_39 ( V_9 -> V_35 , V_114 , V_107 ) ;
V_107 = F_10 ( & V_112 ,
V_70 -> V_115 ) ;
F_39 ( V_9 -> V_35 , V_116 , V_107 ) ;
V_107 = F_10 ( & V_112 ,
V_70 -> V_117 ) ;
F_39 ( V_9 -> V_35 , V_118 , V_107 ) ;
for ( V_5 = 0 ; V_5 < 8 ; V_5 ++ ) {
if ( V_9 -> V_38 ) {
V_9 -> V_59 [ V_5 ] =
F_10 (
...
V_32 = F_40 ( & V_77 -> V_74 , V_70 -> V_75 [ 0 ] , L_33 ) ;
if ( V_32 )
return V_32 ;
V_32 = F_40 ( & V_77 -> V_74 , V_70 -> V_75 [ 1 ] , L_34 ) ;
if ( V_32 )
return V_32 ;
V_32 = F_40 ( & V_77 -> V_74 , V_70 -> V_75 [ 2 ] , L_35 ) ;
if ( V_32 )
return V_32 ;
...
V_105 . V_74 = V_9 -> V_74 ;
V_105 . V_127 = V_70 -> V_90 [ V_5 ] . V_92 ;
V_105 . V_128 = V_9 ;
V_105 . V_129 = V_35 -> V_130 ;
V_105 . V_86 = V_70 -> V_90 [ V_5 ] . V_93 ;
V_2 [ V_5 ] = F_42 ( & V_77 -> V_74 , & V_90 [ V_29 ] ,
& V_105 ) ;
if ( F_43 ( V_2 [ V_5 ] ) ) {
V_32 = F_44 ( V_2 [ V_5 ] ) ;
F_21 ( V_9 -> V_74 , L_36 ,
