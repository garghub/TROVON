...
V_25 = F_24 ( & V_12 -> V_19 , sizeof( * V_7 ) ) ;
if ( V_25 == NULL ) {
V_28 = - V_58 ;
goto V_59;
}
...
V_7 -> V_1 = V_54 -> V_1 ;
V_7 -> V_12 = V_12 ;
V_7 -> V_48 = F_26 ( V_12 ) -> V_60 ;
V_7 -> V_57 = V_57 ;
V_25 -> V_19 . V_61 = & V_12 -> V_19 ;
V_25 -> V_62 = F_26 ( V_12 ) -> V_62 ;
switch ( V_7 -> V_48 ) {
case V_49 :
case V_50 :
V_25 -> V_63 = & V_64 ;
...
V_7 -> V_70 [ 1 ] . V_23 = 2 ;
F_27 ( & V_7 -> V_13 ) ;
F_28 ( & V_7 -> V_70 [ 0 ] , & V_7 -> V_13 ) ;
F_28 ( & V_7 -> V_70 [ 1 ] , & V_7 -> V_13 ) ;
V_7 -> V_39 = V_72 | V_45 ;
if ( ! V_54 -> V_73 )
V_7 -> V_39 |= V_74 ;
...
V_28 = F_3 ( V_7 , V_34 , V_54 -> V_78 ) ;
if ( V_28 )
goto V_59;
V_28 = F_3 ( V_7 , V_35 , V_54 -> V_79 ) ;
if ( V_28 )
goto V_59;
V_28 = F_7 ( V_7 , V_36 , V_54 -> V_80 ) ;
if ( V_28 )
goto V_59;
V_28 = F_7 ( V_7 , V_37 , V_54 -> V_81 ) ;
if ( V_28 )
goto V_59;
V_28 = F_30 ( V_25 ) ;
if ( V_28 )
...
static int F_32 ( struct V_52 * V_12 )
{
struct V_24 * V_25 = F_33 ( V_12 ) ;
struct V_6 * V_7 = F_10 ( V_25 ) ;
F_34 ( V_25 ) ;
if ( ! F_22 ( V_7 -> V_57 ) )
F_31 ( V_7 -> V_57 ) ;
