...
static int F_142 ( int V_171 )
{
switch ( V_171 & ( V_57 | V_61 ) ) {
case V_57 :
return V_172 ;
case V_61 :
return V_173 ;
...
int F_143 ( struct V_175 * V_176 ,
struct V_15 * V_17 ,
const struct V_177 * V_178 ,
int V_171 , int V_33 )
{
struct V_43 * V_43 = V_17 -> V_10 -> V_43 ;
int V_179 = F_142 ( V_171 ) ;
struct V_180 * V_181 ;
struct V_182 V_183 = {
. V_184 = & V_17 -> args ,
. V_185 = & V_17 -> V_186 ,
. V_187 = V_17 -> V_10 -> V_159 ,
} ;
struct V_188 V_189 = {
. V_190 = V_176 ,
. V_181 = & V_17 -> V_181 ,
...
F_146 ( F_48 ( V_43 ) -> V_199 ,
& V_189 . V_190 , & V_183 , V_17 ) ;
V_181 = F_147 ( & V_189 ) ;
if ( F_64 ( V_181 ) ) {
V_65 = F_63 ( V_181 ) ;
goto V_21;
...
int V_171 , struct V_101 * V_102 )
{
struct V_34 * V_38 = V_17 -> V_10 -> V_38 ;
V_17 -> args . V_202 = F_151 ( V_17 -> V_10 -> V_43 ) ;
V_17 -> args . V_46 = F_152 ( V_38 ) + V_46 ;
V_17 -> V_203 = V_17 -> args . V_46 ;
V_17 -> args . V_204 = V_38 -> V_140 + V_46 ;
V_17 -> args . V_5 = V_17 -> V_5 . V_26 ;
V_17 -> args . V_47 = V_47 ;
V_17 -> args . V_25 = F_153 ( V_38 -> V_96 ) ;
V_17 -> args . V_205 = V_38 -> V_146 ;
V_17 -> args . V_206 = V_207 ;
switch ( V_171 & ( V_58 | V_62 ) ) {
case 0 :
break;
case V_62 :
if ( F_119 ( V_102 ) )
break;
default:
V_17 -> args . V_206 = V_118 ;
}
V_17 -> V_186 . V_208 = & V_17 -> V_208 ;
V_17 -> V_186 . V_47 = V_47 ;
V_17 -> V_186 . V_14 = & V_17 -> V_14 ;
F_154 ( & V_17 -> V_208 ) ;
}
...
{
struct V_43 * V_43 = V_17 -> V_10 -> V_43 ;
return F_143 ( F_156 ( V_43 ) , V_17 , V_178 , V_171 , 0 ) ;
}
static int F_157 ( struct V_99 * V_209 ,
const struct V_177 * V_178 ,
int V_171 )
{
struct V_15 * V_17 ;
...
while ( ! F_116 ( V_209 ) ) {
int V_210 ;
V_17 = F_158 ( V_209 , struct V_15 , V_115 ) ;
F_159 ( & V_17 -> V_115 ) ;
V_210 = F_155 ( V_17 , V_178 , V_171 ) ;
if ( V_65 == 0 )
V_65 = V_210 ;
}
return V_65 ;
...
static void F_160 ( struct V_99 * V_209 )
{
struct V_34 * V_38 ;
while ( ! F_116 ( V_209 ) ) {
V_38 = F_117 ( V_209 -> V_121 ) ;
F_102 ( V_38 ) ;
F_67 ( V_38 ) ;
}
}
static void F_161 ( struct V_73 * V_211 ,
struct V_8 * V_9 )
{
F_21 ( V_120 , & V_9 -> V_33 ) ;
...
V_211 -> V_212 -> V_213 ( & V_211 -> V_214 ) ;
}
static int F_163 ( struct V_73 * V_211 ,
struct V_8 * V_9 )
{
struct V_34 * V_38 = V_9 -> V_38 ;
struct V_37 * V_37 = V_38 -> V_41 ;
struct V_15 * V_17 ;
T_3 V_215 = V_211 -> V_216 , V_217 ;
unsigned int V_46 ;
int V_218 = 0 ;
struct V_101 V_102 ;
F_105 ( & V_102 , V_211 -> V_219 , V_211 -> V_220 ) ;
if ( ( V_211 -> V_221 & V_62 ) &&
( V_211 -> V_222 || F_119 ( & V_102 ) ||
V_211 -> V_223 > V_215 ) )
V_211 -> V_221 &= ~ V_62 ;
V_46 = 0 ;
V_217 = V_211 -> V_223 ;
do {
T_3 V_224 = F_164 ( V_217 , V_215 ) ;
V_17 = F_9 ( V_9 , 1 ) ;
if ( ! V_17 ) {
F_161 ( V_211 , V_9 ) ;
return - V_225 ;
...
F_150 ( V_17 , V_224 , V_46 , V_211 -> V_221 , & V_102 ) ;
...
static int F_166 ( struct V_73 * V_211 ,
struct V_8 * V_9 )
{
struct V_34 * V_38 ;
struct V_37 * * V_5 ;
struct V_15 * V_17 ;
struct V_99 * V_209 = & V_211 -> V_214 ;
struct V_101 V_102 ;
V_17 = F_9 ( V_9 , F_167 ( V_211 -> V_228 ,
V_211 -> V_223 ) ) ;
if ( ! V_17 ) {
F_161 ( V_211 , V_9 ) ;
return - V_225 ;
...
( V_211 -> V_222 || F_119 ( & V_102 ) ) )
V_211 -> V_221 &= ~ V_62 ;
F_150 ( V_17 , V_211 -> V_223 , 0 , V_211 -> V_221 , & V_102 ) ;
F_165 ( & V_17 -> V_115 , & V_9 -> V_11 ) ;
V_211 -> V_226 = & V_227 ;
return 0 ;
}
int F_168 ( struct V_73 * V_211 ,
struct V_8 * V_9 )
{
if ( V_211 -> V_216 < V_229 )
return F_163 ( V_211 , V_9 ) ;
return F_166 ( V_211 , V_9 ) ;
}
static int F_169 ( struct V_73 * V_211 )
{
struct V_6 * V_22 ;
struct V_8 * V_9 ;
int V_65 ;
...
V_9 = & V_22 -> V_10 ;
F_170 ( V_211 , V_9 , F_15 ) ;
F_13 ( & V_9 -> V_13 ) ;
V_65 = F_168 ( V_211 , V_9 ) ;
if ( V_65 == 0 )
V_65 = F_157 ( & V_9 -> V_11 ,
V_211 -> V_226 ,
V_211 -> V_221 ) ;
...
struct V_43 * V_43 , int V_230 ,
const struct V_231 * V_232 )
{
F_172 ( V_74 , V_43 , & V_233 , V_232 ,
F_48 ( V_43 ) -> V_215 , V_230 ) ;
}
void F_173 ( struct V_73 * V_74 )
{
V_74 -> V_234 = & V_233 ;
V_74 -> V_216 = F_48 ( V_74 -> V_219 ) -> V_215 ;
}
void F_174 ( struct V_180 * V_181 , void * V_235 )
{
struct V_15 * V_17 = V_235 ;
int V_82 ;
V_82 = F_73 ( V_17 -> V_10 -> V_43 ) -> F_175 ( V_181 , V_17 ) ;
if ( V_82 )
F_176 ( V_181 , V_82 ) ;
}
void F_177 ( struct V_180 * V_181 , void * V_235 )
{
struct V_1 * V_17 = V_235 ;
F_73 ( V_17 -> V_43 ) -> F_178 ( V_181 , V_17 ) ;
}
static void F_179 ( struct V_180 * V_181 , void * V_235 )
{
struct V_15 * V_17 = V_235 ;
F_180 ( V_181 , V_17 ) ;
}
static void F_181 ( void * V_235 )
{
struct V_15 * V_17 = V_235 ;
struct V_8 * V_9 = V_17 -> V_10 ;
int V_145 = V_17 -> V_181 . V_201 ;
...
void F_180 ( struct V_180 * V_181 , struct V_15 * V_17 )
{
struct V_236 * V_237 = & V_17 -> args ;
struct V_238 * V_239 = & V_17 -> V_186 ;
struct V_43 * V_43 = V_17 -> V_10 -> V_43 ;
int V_145 ;
F_141 ( L_5 ,
V_181 -> V_196 , V_181 -> V_201 ) ;
V_145 = F_73 ( V_43 ) -> F_183 ( V_181 , V_17 ) ;
if ( V_145 != 0 )
return;
F_69 ( V_43 , V_240 , V_239 -> V_47 ) ;
#if F_184 ( V_241 ) || F_184 ( V_242 )
if ( V_239 -> V_14 -> V_116 < V_237 -> V_206 && V_181 -> V_201 >= 0 ) {
static unsigned long V_243 ;
if ( F_185 ( V_243 , V_244 ) ) {
F_141 ( L_6
L_7 ,
F_48 ( V_43 ) -> V_199 -> V_245 ,
V_239 -> V_14 -> V_116 , V_237 -> V_206 ) ;
V_243 = V_244 + 300 * V_246 ;
}
}
#endif
if ( V_181 -> V_201 < 0 )
F_186 ( V_17 -> V_10 , V_181 -> V_201 , V_237 -> V_46 ) ;
...
F_186 ( V_17 -> V_10 , - V_249 , V_237 -> V_46 ) ;
V_181 -> V_201 = - V_249 ;
return;
}
if ( V_239 -> V_14 -> V_116 != V_207 ) {
V_17 -> V_203 += V_239 -> V_47 ;
V_237 -> V_46 += V_239 -> V_47 ;
V_237 -> V_204 += V_239 -> V_47 ;
...
static int F_189 ( struct V_35 * V_36 , int V_250 )
{
int V_65 ;
if ( ! F_182 ( V_251 , & V_36 -> V_33 ) )
return 1 ;
if ( ! V_250 )
return 0 ;
...
int F_193 ( struct V_175 * V_176 , struct V_1 * V_17 ,
const struct V_177 * V_178 ,
int V_171 , int V_33 )
{
struct V_180 * V_181 ;
...
F_73 ( V_17 -> V_43 ) -> F_194 ( V_17 , & V_183 ) ;
F_141 ( L_9 , V_17 -> V_181 . V_196 ) ;
F_195 ( F_48 ( V_17 -> V_43 ) -> V_199 ,
V_252 , & V_189 . V_190 , & V_183 ) ;
V_181 = F_147 ( & V_189 ) ;
if ( F_64 ( V_181 ) )
return F_63 ( V_181 ) ;
if ( V_171 & V_200 )
...
struct V_101 * V_102 )
{
struct V_34 * V_253 = F_117 ( V_209 -> V_121 ) ;
struct V_43 * V_43 = V_253 -> V_96 -> V_97 -> V_98 ;
F_197 ( V_209 , & V_17 -> V_5 ) ;
V_17 -> V_43 = V_43 ;
V_17 -> V_159 = V_253 -> V_96 -> V_159 ;
V_17 -> V_114 = V_114 ;
V_17 -> V_254 = & V_255 ;
V_17 -> V_28 = V_102 -> V_28 ;
V_17 -> V_105 = V_102 -> V_105 ;
V_17 -> args . V_202 = F_151 ( V_17 -> V_43 ) ;
V_17 -> args . V_46 = 0 ;
V_17 -> args . V_47 = 0 ;
V_17 -> V_25 = F_153 ( V_253 -> V_96 ) ;
V_17 -> V_186 . V_208 = & V_17 -> V_208 ;
V_17 -> V_186 . V_14 = & V_17 -> V_14 ;
F_154 ( & V_17 -> V_208 ) ;
}
void F_198 ( struct V_99 * V_256 ,
struct V_113 * V_114 ,
struct V_101 * V_102 )
{
struct V_34 * V_38 ;
while ( ! F_116 ( V_256 ) ) {
V_38 = F_117 ( V_256 -> V_121 ) ;
F_102 ( V_38 ) ;
...
static int
F_199 ( struct V_43 * V_43 , struct V_99 * V_209 , int V_171 ,
struct V_101 * V_102 )
{
struct V_1 * V_17 ;
V_17 = F_1 () ;
if ( ! V_17 )
goto V_257;
F_196 ( V_17 , V_209 , NULL , V_102 ) ;
F_13 ( & V_102 -> V_103 -> V_258 ) ;
return F_193 ( F_156 ( V_43 ) , V_17 , V_17 -> V_254 ,
V_171 , 0 ) ;
V_257:
F_198 ( V_209 , NULL , V_102 ) ;
V_102 -> V_28 -> V_213 ( F_32 ( V_43 ) ) ;
return - V_225 ;
}
static void F_200 ( struct V_180 * V_181 , void * V_235 )
{
struct V_1 * V_17 = V_235 ;
F_141 ( L_10 ,
V_181 -> V_196 , V_181 -> V_201 ) ;
F_73 ( V_17 -> V_43 ) -> F_201 ( V_181 , V_17 ) ;
}
...
F_141 ( L_14 ) ;
F_93 ( V_38 ) ;
F_21 ( V_260 , & V_38 -> V_96 -> V_33 ) ;
V_121:
F_130 ( V_38 ) ;
}
F_105 ( & V_102 , V_17 -> V_43 , V_17 -> V_105 ) ;
if ( F_18 ( & V_102 . V_103 -> V_258 ) )
F_191 ( F_32 ( V_17 -> V_43 ) ) ;
}
static void F_203 ( void * V_235 )
{
struct V_1 * V_17 = V_235 ;
V_17 -> V_28 -> V_29 ( V_17 ) ;
F_192 ( V_235 ) ;
}
int F_204 ( struct V_43 * V_43 , struct V_99 * V_209 ,
int V_171 , struct V_101 * V_102 )
{
int V_145 ;
V_145 = F_205 ( V_43 , V_209 , V_171 , V_102 ) ;
if ( V_145 == V_261 )
V_145 = F_199 ( V_43 , V_209 , V_171 , V_102 ) ;
return V_145 ;
}
int F_206 ( struct V_43 * V_43 , int V_171 )
{
F_207 ( V_209 ) ;
struct V_101 V_102 ;
int V_250 = V_171 & V_200 ;
int V_186 ;
V_186 = F_189 ( F_32 ( V_43 ) , V_250 ) ;
if ( V_186 <= 0 )
goto V_262;
F_103 ( & V_102 , V_43 ) ;
V_186 = F_123 ( V_43 , & V_209 , & V_102 ) ;
if ( V_186 ) {
int error ;
error = F_204 ( V_43 , & V_209 , V_171 , & V_102 ) ;
if ( error < 0 )
return error ;
if ( ! V_250 )
goto V_262;
...
int F_221 ( struct V_85 * V_83 , struct V_37 * V_270 ,
struct V_37 * V_37 , enum V_271 V_272 )
{
if ( F_23 ( V_37 ) )
return - V_273 ;
if ( ! F_222 ( V_37 , V_20 ) )
return - V_273 ;
return F_223 ( V_83 , V_270 , V_37 , V_272 ) ;
}
int T_4 F_224 ( void )
{
V_274 = F_225 ( L_15 ,
