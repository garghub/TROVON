...
static struct V_23 * F_14 ( struct V_26 * V_27 , int * V_28 )
{
struct V_23 * V_24 ;
if ( F_15 ( & V_27 -> V_29 ) )
return NULL ;
V_24 = F_16 ( V_27 -> V_29 . V_30 , struct V_23 , V_31 ) ;
F_17 ( & V_24 -> V_31 ) ;
V_27 -> V_32 -- ;
* V_28 = F_15 ( & V_27 -> V_29 ) ? 1 : 0 ;
return V_24 ;
}
static void F_18 ( struct V_26 * V_27 , struct V_23 * V_24 )
{
F_19 ( & V_24 -> V_31 , & V_27 -> V_29 ) ;
V_27 -> V_32 ++ ;
}
static struct V_33 * F_20 ( void )
{
struct V_33 * V_34 = NULL ;
int V_9 = 0 ;
V_34 = F_8 ( sizeof( struct V_33 ) , V_19 ) ;
if ( ! V_34 ) {
V_9 = - V_20 ;
goto V_21;
}
V_34 -> V_22 = F_7 ( 0 , V_19 ) ;
V_34 -> V_3 = F_8 ( V_35 , V_19 ) ;
...
static struct V_33 * F_22 ( struct V_36 * V_37 , int * V_28 )
{
struct V_33 * V_34 ;
unsigned long V_38 ;
F_23 ( & V_37 -> V_39 , V_38 ) ;
...
V_34 = F_16 ( V_37 -> V_29 . V_30 , struct V_33 , V_29 ) ;
F_17 ( & V_34 -> V_29 ) ;
V_37 -> V_32 -- ;
* V_28 = F_15 ( & V_37 -> V_29 ) ? 1 : 0 ;
F_24 ( & V_37 -> V_39 , V_38 ) ;
return V_34 ;
}
static void F_25 ( struct V_36 * V_37 , struct V_33 * V_34 )
{
unsigned long V_38 ;
F_23 ( & V_37 -> V_39 , V_38 ) ;
F_19 ( & V_34 -> V_29 , & V_37 -> V_29 ) ;
V_37 -> V_32 ++ ;
F_24 ( & V_37 -> V_39 , V_38 ) ;
}
...
static int F_34 ( T_1 * V_14 , void * V_64 )
{
...
if ( F_35 ( V_65 , & V_2 -> V_70 -> V_71 , V_68 ) < 0 )
F_36 ( L_1 ) ;
V_2 -> V_16 = 0 ;
return 1 ;
}
...
{
struct V_1 * V_2 = F_37 ( V_73 , struct V_1 , V_62 . V_73 ) ;
struct V_36 * V_37 = & V_2 -> V_37 ;
struct V_33 * V_34 ;
struct V_4 * V_5 ;
struct V_65 * V_65 ;
...
V_34 = F_16 ( V_37 -> V_47 . V_30 , struct V_33 , V_47 ) ;
F_17 ( & V_34 -> V_47 ) ;
F_24 ( & V_37 -> V_45 , V_38 ) ;
...
static void F_40 ( struct V_33 * V_34 , struct V_36 * V_37 )
{
unsigned long V_38 ;
...
unsigned long V_38 ;
struct V_1 * V_2 = F_37 ( V_34 -> V_37 , struct V_1 , V_37 ) ;
struct V_6 * V_7 = V_2 -> V_7 ;
F_40 ( V_34 , V_37 ) ;
if ( ! V_22 -> V_84 && V_34 -> V_76 ) {
F_23 ( & V_37 -> V_45 , V_38 ) ;
F_19 ( & V_34 -> V_47 , & V_37 -> V_47 ) ;
F_42 ( V_85 , & V_2 -> V_62 . V_73 ) ;
F_24 ( & V_37 -> V_45 , V_38 ) ;
} else {
...
int (* F_44)( void * V_74 , void * V_14 , int V_13 , int V_83 ) ,
void * V_74 ,
int V_83 )
{
struct V_1 * V_2 = V_66 ;
...
V_34 ) ;
F_23 ( & V_37 -> V_44 , V_38 ) ;
F_19 ( & V_34 -> V_55 , & V_37 -> V_55 ) ;
F_24 ( & V_37 -> V_44 , V_38 ) ;
if ( V_83 == V_78 )
V_9 = F_47 ( V_34 -> V_22 , V_88 ) ;
else
V_9 = F_47 ( V_34 -> V_22 , V_19 ) ;
if ( V_9 ) {
F_23 ( & V_37 -> V_44 , V_38 ) ;
F_17 ( & V_34 -> V_55 ) ;
F_24 ( & V_37 -> V_44 , V_38 ) ;
...
struct V_1 * V_2 = F_37 ( V_27 , struct V_1 , V_27 ) ;
unsigned long V_38 ;
if ( V_22 -> V_84 == - V_89 ) {
F_49 ( L_7 ) ;
return;
...
F_23 ( & V_27 -> V_43 , V_38 ) ;
V_2 -> V_49 = 1 ;
F_42 ( V_90 , & V_2 -> V_60 . V_73 ) ;
F_24 ( & V_27 -> V_43 , V_38 ) ;
}
static int F_50 ( struct V_6 * V_7 , struct V_17 * V_18 , T_3 V_13 )
{
int V_9 = 0 ;
if ( ! ( V_13 % 512 ) )
V_13 ++ ;
...
F_48 ,
V_18 ) ;
V_9 = F_47 ( V_18 -> V_22 , V_19 ) ;
if ( V_9 )
F_36 ( L_8 , V_9 ) ;
F_43 ( V_7 ) ;
return V_9 ;
}
static T_3 F_51 ( struct V_1 * V_2 , T_1 * V_91 )
{
struct V_26 * V_27 = & V_2 -> V_27 ;
struct V_23 * V_24 = NULL ;
...
V_24 = F_16 ( V_27 -> V_53 . V_30 , struct V_23 , V_31 ) ;
...
return V_93 + F_52 ( struct V_92 , V_14 ) ;
}
static void V_61 ( struct V_72 * V_73 )
{
struct V_1 * V_2 = F_37 ( V_73 , struct V_1 , V_60 . V_73 ) ;
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_26 * V_27 = & V_2 -> V_27 ;
struct V_17 * V_18 = NULL ;
int V_98 = 0 ;
...
if ( ! F_15 ( & V_27 -> V_54 ) ) {
V_18 = F_16 ( V_27 -> V_54 . V_30 , struct V_17 , V_31 ) ;
F_17 ( & V_18 -> V_31 ) ;
V_13 = V_18 -> V_13 ;
V_18 -> V_100 = 0 ;
V_98 = 1 ;
} else if ( ! F_15 ( & V_27 -> V_53 ) ) {
if ( V_2 -> V_50 ) {
V_2 -> V_49 = 1 ;
F_24 ( & V_27 -> V_43 , V_38 ) ;
return;
...
F_24 ( & V_27 -> V_43 , V_38 ) ;
if ( V_18 -> V_100 )
V_13 = F_51 ( V_2 , V_18 -> V_3 ) ;
if ( F_50 ( V_7 , V_18 , V_13 ) ) {
F_36 ( L_9 ) ;
V_18 -> V_76 = NULL ;
F_48 ( V_18 -> V_22 ) ;
}
}
static int F_55 ( void * V_66 , void * V_14 , int V_13 ,
unsigned int V_102 , unsigned int V_103 ,
void (* F_44)( void * V_14 ) , void * V_74 ,
int V_104 , int V_105 )
{
struct V_1 * V_2 = V_66 ;
struct V_26 * V_27 = & V_2 -> V_27 ;
...
V_106 -> V_102 = F_56 ( & V_2 -> V_11 , V_102 ) ;
V_106 -> V_113 = F_56 ( & V_2 -> V_11 , V_103 ) ;
V_106 -> V_105 = F_56 ( & V_2 -> V_11 , V_105 ) ;
V_24 -> V_13 = V_93 + V_114 ;
V_24 -> V_76 = F_44 ;
V_24 -> V_74 = V_74 ;
F_23 ( & V_27 -> V_43 , V_38 ) ;
F_19 ( & V_24 -> V_31 , & V_27 -> V_53 ) ;
F_42 ( V_90 , & V_2 -> V_60 . V_73 ) ;
F_24 ( & V_27 -> V_43 , V_38 ) ;
if ( V_28 )
return V_115 ;
...
static int F_57 ( void * V_66 , void * V_14 , int V_13 ,
void (* F_44)( void * V_14 ) , void * V_74 )
{
struct V_1 * V_2 = V_66 ;
struct V_26 * V_27 = & V_2 -> V_27 ;
...
V_18 -> V_100 = 0 ;
F_23 ( & V_27 -> V_43 , V_38 ) ;
F_19 ( & V_18 -> V_31 , & V_27 -> V_54 ) ;
F_42 ( V_90 , & V_2 -> V_60 . V_73 ) ;
F_24 ( & V_27 -> V_43 , V_38 ) ;
return 0 ;
}
static struct V_116 * F_58 ( void * V_66 )
{
struct V_1 * V_2 = V_66 ;
return & V_2 -> V_11 ;
}
static int F_59 ( struct V_117 * V_70 , const struct V_118 * V_119 )
{
int V_9 = 0 ;
...
T_2 V_120 , V_121 ;
int V_122 ;
struct V_6 * V_7 = F_60 ( V_70 ) ;
V_122 = V_70 -> V_123 -> V_124 . V_122 ;
V_120 = F_61 ( V_7 -> V_125 . V_120 ) ;
V_121 = F_61 ( V_7 -> V_125 . V_121 ) ;
F_49 ( L_14 , V_120 , V_121 ) ;
if ( V_122 > V_126 ) {
F_49 ( L_15 ) ;
return - 1 ;
}
V_65 = F_8 ( sizeof( struct V_65 ) , V_19 ) ;
if ( ! V_65 ) {
V_9 = - V_20 ;
goto V_21;
}
V_2 = F_8 ( sizeof( struct V_1 ) , V_19 ) ;
if ( ! V_2 ) {
V_9 = - V_20 ;
goto V_21;
}
...
static void F_68 ( struct V_117 * V_70 )
{
struct V_65 * V_65 ;
struct V_1 * V_2 ;
T_2 V_120 , V_121 ;
...
static int F_72 ( struct V_117 * V_70 , T_4 V_136 )
{
struct V_65 * V_65 ;
struct V_1 * V_2 ;
struct V_36 * V_37 ;
...
static int F_73 ( struct V_117 * V_70 )
{
struct V_65 * V_65 ;
struct V_1 * V_2 ;
struct V_26 * V_27 ;
