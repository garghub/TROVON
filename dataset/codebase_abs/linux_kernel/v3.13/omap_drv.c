...
if ( V_4 -> V_89 ) {
for ( V_16 = 0 ; V_16 < V_4 -> V_17 ; V_16 ++ ) {
F_66 ( & V_4 -> V_20 [ V_16 ] -> V_90 ,
V_4 -> V_89 , 0 ) ;
}
for ( V_16 = 0 ; V_16 < V_4 -> V_45 ; V_16 ++ ) {
F_66 ( & V_4 -> V_44 [ V_16 ] -> V_90 ,
V_4 -> V_89 , 0 ) ;
}
}
F_67 ( V_2 ) ;
...
static void F_70 ( struct V_1 * V_2 , struct V_59 * V_87 )
{
F_2 ( L_24 , V_2 ) ;
}
...
static int F_72 ( struct V_91 * V_92 , T_1 V_93 )
{
F_2 ( L_26 ) ;
return 0 ;
}
static int F_73 ( struct V_91 * V_94 )
{
F_2 ( L_26 ) ;
return 0 ;
}
static void F_74 ( struct V_91 * V_94 )
{
F_2 ( L_26 ) ;
}
static int F_75 ( struct V_91 * V_94 )
{
if ( F_76 () == false )
return - V_95 ;
F_2 ( L_27 , V_94 -> V_33 ) ;
return F_77 ( & V_96 , V_94 ) ;
}
static int F_78 ( struct V_91 * V_94 )
{
F_2 ( L_26 ) ;
F_79 ( & V_96 , V_94 ) ;
F_80 ( & V_97 ) ;
