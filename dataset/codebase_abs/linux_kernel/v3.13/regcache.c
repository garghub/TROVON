...
if ( V_2 -> V_50 [ V_3 ] . V_23 % V_2 -> V_17 ) {
V_5 = - V_10 ;
goto V_47;
}
V_5 = F_21 ( V_2 , V_2 -> V_50 [ V_3 ] . V_23 , V_2 -> V_50 [ V_3 ] . V_24 ) ;
if ( V_5 != 0 ) {
F_10 ( V_2 -> V_13 , L_8 ,
...
void F_32 ( struct V_1 * V_2 , bool V_54 )
{
V_2 -> V_44 ( V_2 -> V_45 ) ;
F_29 ( V_2 -> V_55 && V_54 ) ;
V_2 -> V_12 = V_54 ;
...
bool F_34 ( struct V_1 * V_2 , void * V_56 , unsigned int V_57 ,
unsigned int V_7 )
{
...
return - V_10 ;
if ( V_2 -> V_58 . V_60 )
return V_2 -> V_58 . V_60 ( F_36 ( V_2 , V_56 ,
V_57 ) ) ;
switch ( V_2 -> V_30 ) {
case 1 : {
const T_2 * V_32 = V_56 ;
...
static int F_37 ( const void * V_61 , const void * V_62 )
{
...
sizeof( struct V_19 ) , F_37 ) ;
if ( V_66 )
return V_66 - V_2 -> V_18 ;
else
return - V_67 ;
}
static bool F_38 ( unsigned long * V_68 , unsigned int V_57 )
{
if ( ! V_68 )
return true ;
return F_39 ( V_57 , V_68 ) ;
}
static int F_40 ( struct V_1 * V_2 , void * V_69 ,
unsigned long * V_68 ,
unsigned int V_70 ,
...
static int F_41 ( struct V_1 * V_2 , const void * * V_74 ,
...
V_6 = V_75 - V_56 ;
F_13 ( V_2 -> V_13 , L_13 ,
V_6 * V_76 , V_6 , V_56 , V_75 - 1 ) ;
V_2 -> V_12 = 1 ;
V_5 = F_42 ( V_2 , V_56 , * V_74 , V_6 * V_76 ) ;
V_2 -> V_12 = 0 ;
* V_74 = NULL ;
return V_5 ;
}
static int F_43 ( struct V_1 * V_2 , void * V_69 ,
unsigned long * V_68 ,
...
if ( ! V_74 ) {
V_74 = F_36 ( V_2 , V_69 , V_3 ) ;
V_56 = V_73 ;
}
}
return F_41 ( V_2 , & V_74 , V_56 , V_73 +
V_2 -> V_17 ) ;
}
int F_44 ( struct V_1 * V_2 , void * V_69 ,
unsigned long * V_68 ,
unsigned int V_70 , unsigned int V_71 ,
unsigned int V_72 )
{
if ( F_45 ( V_2 ) )
return F_43 ( V_2 , V_69 , V_68 ,
V_70 , V_71 , V_72 ) ;
else
return F_40 ( V_2 , V_69 , V_68 ,
V_70 , V_71 , V_72 ) ;
}
