...
if ( V_50 ) {
printf ( L_32 ) ;
printf ( L_33 , F_49 ( V_121 ) , V_121 -> V_107 ) ;
printf ( L_34 , F_49 ( V_120 ) , V_120 -> V_107 ) ;
}
F_17 ( V_7 , V_121 -> V_107 , F_49 ( V_121 ) ) ;
F_17 ( V_7 , V_120 -> V_107 , F_49 ( V_120 ) ) ;
return 0 ;
}
static int
F_50 ( struct V_125 * V_126 , struct V_127 * V_128 , struct V_127 * V_129 )
{
struct V_130 * V_131 ;
int V_55 = 0 ;
F_11 ( F_51 ( V_126 ) ) ;
...
static struct V_127 *
F_53 ( struct V_133 * V_134 , struct V_89 * V_89 ,
struct V_125 * V_135 )
{
...
struct V_127 * V_26 ;
int V_132 ;
V_26 = F_54 ( V_137 , struct V_127 , V_137 ) ;
V_132 = F_50 ( V_135 , & V_138 , V_26 ) ;
if ( V_132 > 0 )
V_137 = V_137 -> V_139 ;
else if ( V_132 < 0 )
V_137 = V_137 -> V_140 ;
...
static void
F_55 ( struct V_133 * V_134 , struct V_127 * V_141 ,
struct V_125 * V_135 )
{
...
struct V_127 * V_143 ;
int V_132 ;
V_143 = F_54 ( * V_142 , struct V_127 , V_137 ) ;
V_121 = * V_142 ;
V_132 = F_50 ( V_135 , V_141 , V_143 ) ;
if ( V_132 > 0 )
V_142 = & ( ( * V_142 ) -> V_139 ) ;
else
V_142 = & ( ( * V_142 ) -> V_140 ) ;
}
F_56 ( & V_141 -> V_137 , V_121 , V_142 ) ;
F_57 ( & V_141 -> V_137 , V_134 ) ;
}
static int F_58 ( struct V_6 * V_7 , struct V_89 * V_89 )
{
...
V_26 -> V_89 = V_89 ;
F_59 ( & V_26 -> V_145 ) ;
F_55 ( & V_7 -> V_146 , V_26 , & V_7 -> V_147 ) ;
return 0 ;
}
static char F_60 ( T_1 V_112 )
{
const char * V_148 = V_149 ;
return V_148 [ V_112 ] ;
}
static int
F_61 ( struct V_127 * V_26 ,
char V_150 ,
T_1 V_20 )
{
...
F_62 ( & V_54 -> V_126 , & V_26 -> V_145 ) ;
return 0 ;
}
static void
F_63 ( struct V_127 * V_26 , T_1 V_12 ,
T_1 V_20 V_41 )
{
struct V_151 * V_54 ;
F_11 ( F_51 ( & V_26 -> V_145 ) ) ;
V_54 = F_64 ( V_26 -> V_145 . V_113 , struct V_151 , V_126 ) ;
V_54 -> V_72 += V_12 ;
V_26 -> V_156 += V_12 ;
}
static void
F_65 ( struct V_127 * V_26 , T_1 V_20 )
{
struct V_151 * V_54 ;
T_1 V_12 ;
if ( F_51 ( & V_26 -> V_145 ) )
...
V_164 = F_53 ( & V_7 -> V_146 , V_166 , & V_7 -> V_147 ) ;
if ( ! V_164 ) {
if ( F_58 ( V_7 , V_166 ) )
return - 1 ;
V_164 = F_53 ( & V_7 -> V_146 , V_166 , & V_7 -> V_147 ) ;
...
if ( F_61 ( V_164 , F_60 ( V_112 ) , V_20 ) )
return - 1 ;
V_165 = F_53 ( & V_7 -> V_146 , V_167 , & V_7 -> V_147 ) ;
if ( ! V_165 ) {
if ( F_58 ( V_7 , V_167 ) )
return - 1 ;
V_165 = F_53 ( & V_7 -> V_146 , V_167 , & V_7 -> V_147 ) ;
...
struct V_127 * V_26 = F_53 ( & V_7 -> V_146 , V_89 , & V_7 -> V_147 ) ;
T_1 V_20 = V_104 -> time ;
int V_116 = V_104 -> V_116 ;
F_11 ( V_116 >= V_117 || V_116 < 0 ) ;
if ( ! V_26 ) {
if ( F_58 ( V_7 , V_89 ) )
return - 1 ;
V_26 = F_53 ( & V_7 -> V_146 , V_89 , & V_7 -> V_147 ) ;
if ( ! V_26 ) {
F_27 ( L_38 ) ;
return - 1 ;
}
...
V_26 = F_53 ( & V_7 -> V_146 , V_32 , & V_7 -> V_147 ) ;
if ( ! V_26 ) {
if ( F_58 ( V_7 , V_32 ) )
return - 1 ;
V_26 = F_53 ( & V_7 -> V_146 , V_32 , & V_7 -> V_147 ) ;
...
V_26 = F_53 ( & V_7 -> V_146 , V_174 , & V_7 -> V_147 ) ;
if ( ! V_26 ) {
if ( F_58 ( V_7 , V_174 ) )
return - 1 ;
F_17 ( V_7 , V_174 -> V_107 , F_49 ( V_174 ) ) ;
V_26 = F_53 ( & V_7 -> V_146 , V_174 , & V_7 -> V_147 ) ;
if ( ! V_26 ) {
F_27 ( L_42 ) ;
return - 1 ;
...
static void F_70 ( struct V_6 * V_7 , struct V_127 * V_145 )
{
int V_14 ;
int V_55 ;
T_1 V_175 ;
if ( ! V_145 -> V_163 )
return;
if ( ! strcmp ( F_49 ( V_145 -> V_89 ) , L_43 ) )
return;
V_7 -> V_176 += V_145 -> V_156 ;
V_7 -> V_177 += V_145 -> V_163 ;
V_55 = printf ( L_44 , F_49 ( V_145 -> V_89 ) , V_145 -> V_89 -> V_107 ) ;
...
static int F_76 ( const char * V_180 , struct V_125 * V_126 )
{
T_2 V_14 ;
...
for ( V_14 = 0 ; V_14 < F_77 ( V_187 ) ; V_14 ++ ) {
if ( ! strcmp ( V_187 [ V_14 ] -> V_182 , V_180 ) ) {
F_62 ( & V_187 [ V_14 ] -> V_126 , V_126 ) ;
return 0 ;
}
}
return - 1 ;
...
for (; ; ) {
struct V_127 * V_141 ;
V_137 = F_79 ( & V_7 -> V_146 ) ;
if ( ! V_137 )
break;
F_80 ( V_137 , & V_7 -> V_146 ) ;
V_141 = F_81 ( V_137 , struct V_127 , V_137 ) ;
F_55 ( & V_7 -> V_188 , V_141 , & V_7 -> V_135 ) ;
}
}
...
struct V_105 * V_105 )
{
struct V_6 * V_7 = F_54 ( V_190 , struct V_6 , V_190 ) ;
if ( V_7 -> V_191 -> V_192 )
...
if ( V_193 ) {
printf ( L_57 ,
V_167 -> V_197 , F_49 ( V_167 ) , V_167 -> V_107 ) ;
} else {
printf ( L_12 ) ;
}
return 0 ;
...
static int F_89 ( struct V_189 * V_190 V_41 ,
...
V_217 = F_92 ( & V_219 , false , & V_7 -> V_190 ) ;
if ( V_217 == NULL ) {
F_46 ( L_63 ) ;
return - 1 ;
}
...
printf ( L_72 ) ;
printf ( L_73 ) ;
V_114 = F_79 ( & V_7 -> V_188 ) ;
while ( V_114 ) {
struct V_127 * V_145 ;
V_145 = F_81 ( V_114 , struct V_127 , V_137 ) ;
F_70 ( V_7 , V_145 ) ;
V_114 = F_100 ( V_114 ) ;
}
printf ( L_74 ) ;
...
static void F_104 ( struct V_6 * V_7 , const struct V_231 * V_232 ,
const char * const V_233 [] )
{
char * V_234 , * V_180 , * V_148 = F_105 ( V_7 -> V_235 ) ;
for ( V_180 = strtok_r ( V_148 , L_85 , & V_234 ) ;
V_180 ; V_180 = strtok_r ( NULL , L_85 , & V_234 ) ) {
if ( F_76 ( V_180 , & V_7 -> V_135 ) < 0 ) {
error ( L_86 , V_180 ) ;
F_106 ( V_233 , V_232 ) ;
}
}
...
static int F_107 ( int V_236 , const char * * V_237 )
{
...
V_238 = F_77 ( V_240 ) + V_236 - 1 ;
V_239 = calloc ( V_238 + 1 , sizeof( char * ) ) ;
if ( V_239 == NULL )
return - V_241 ;
for ( V_14 = 0 ; V_14 < F_77 ( V_240 ) ; V_14 ++ )
V_239 [ V_14 ] = F_105 ( V_240 [ V_14 ] ) ;
for ( V_53 = 1 ; V_53 < ( unsigned int ) V_236 ; V_53 ++ , V_14 ++ )
V_239 [ V_14 ] = V_237 [ V_53 ] ;
F_11 ( V_14 != V_238 ) ;
return F_108 ( V_14 , V_239 , NULL ) ;
}
int F_109 ( int V_236 , const char * * V_237 , const char * T_8 V_41 )
{
const char V_242 [] = L_99 ;
struct V_6 V_7 = {
. V_190 = {
. V_104 = F_89 ,
. V_44 = V_243 ,
...
. V_147 = F_110 ( V_7 . V_147 ) ,
. V_135 = F_110 ( V_7 . V_135 ) ,
. V_83 = V_247 ,
. V_86 = V_247 ,
. V_235 = V_242 ,
. V_230 = 10 ,
...
F_111 ( 's' , L_100 , & V_7 . V_235 , L_101 ,
L_102 ) ,
F_112 ( 'v' , L_103 , & V_50 ,
L_104 ) ,
F_113 ( 'C' , L_105 , & V_7 . V_169 ,
L_106 ) ,
F_114 ( 'D' , L_107 , & V_249 ,
L_108 ) ,
F_115 ()
...
unsigned int V_14 ;
for ( V_14 = 0 ; V_14 < F_77 ( V_7 . V_200 ) ; V_14 ++ )
V_7 . V_200 [ V_14 ] = - 1 ;
V_236 = F_117 ( V_236 , V_237 , V_251 , V_254 ,
V_259 ) ;
if ( ! V_236 )
F_106 ( V_254 , V_251 ) ;
if ( ! strcmp ( V_237 [ 0 ] , L_117 ) )
return F_118 ( V_236 , V_237 , T_8 ) ;
F_119 () ;
if ( ! strncmp ( V_237 [ 0 ] , L_118 , 3 ) ) {
return F_107 ( V_236 , V_237 ) ;
} else if ( ! strncmp ( V_237 [ 0 ] , L_119 , 3 ) ) {
V_7 . V_191 = & V_256 ;
if ( V_236 > 1 ) {
V_236 = F_117 ( V_236 , V_237 , V_248 , V_252 , 0 ) ;
if ( V_236 )
F_106 ( V_252 , V_248 ) ;
}
F_104 ( & V_7 , V_248 , V_252 ) ;
return F_98 ( & V_7 ) ;
} else if ( ! strcmp ( V_237 [ 0 ] , L_120 ) ) {
V_7 . V_191 = & V_257 ;
F_104 ( & V_7 , V_248 , V_252 ) ;
return F_101 ( & V_7 ) ;
} else if ( ! strncmp ( V_237 [ 0 ] , L_121 , 3 ) ) {
V_7 . V_191 = & V_258 ;
if ( V_236 ) {
V_236 = F_117 ( V_236 , V_237 , V_250 , V_253 , 0 ) ;
if ( V_236 )
F_106 ( V_253 , V_250 ) ;
}
return F_103 ( & V_7 ) ;
