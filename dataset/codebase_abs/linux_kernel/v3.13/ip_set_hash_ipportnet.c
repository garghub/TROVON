...
static inline bool
F_43 ( const struct V_77 * V_2 ,
const struct V_77 * V_3 ,
T_1 * V_4 )
{
return F_44 ( & V_2 -> V_5 . V_78 , & V_3 -> V_5 . V_78 ) &&
F_44 ( & V_2 -> V_3 . V_78 , & V_3 -> V_3 . V_78 ) &&
V_2 -> V_6 == V_3 -> V_6 &&
V_2 -> V_7 == V_3 -> V_7 &&
V_2 -> V_8 == V_3 -> V_8 ;
}
static inline int
F_45 ( const struct V_77 * V_9 )
{
return V_9 -> V_10 ? - V_11 : 1 ;
}
static inline void
F_46 ( struct V_77 * V_9 , T_1 V_12 )
{
V_9 -> V_10 = ! ! ( ( V_12 >> 16 ) & V_13 ) ;
}
static inline void
F_47 ( struct V_77 * V_9 , T_2 * V_12 )
{
F_5 ( * V_12 , V_9 -> V_10 ) ;
}
static inline void
F_48 ( struct V_77 * V_9 , T_2 V_6 )
{
F_49 ( & V_9 -> V_3 , V_6 ) ;
V_9 -> V_6 = V_6 - 1 ;
}
...
{
T_1 V_12 = V_16 -> V_10 ? V_13 : 0 ;
if ( F_51 ( V_15 , V_17 , & V_16 -> V_5 . V_78 ) ||
F_51 ( V_15 , V_18 , & V_16 -> V_3 . V_78 ) ||
F_10 ( V_15 , V_19 , V_16 -> V_7 ) ||
F_11 ( V_15 , V_20 , V_16 -> V_6 + 1 ) ||
F_11 ( V_15 , V_21 , V_16 -> V_8 ) ||
( V_12 &&
...
& V_38 . V_7 , & V_38 . V_8 ) )
return - V_45 ;
F_55 ( V_15 , V_33 -> V_12 & V_46 , & V_38 . V_5 . V_78 ) ;
F_55 ( V_15 , V_33 -> V_12 & V_47 , & V_38 . V_3 . V_78 ) ;
