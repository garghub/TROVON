...
if ( type == V_54 ) {
if ( F_41 ( V_80 , 1 ) -> V_95 >= V_96 &&
F_41 ( V_80 , 1 ) -> V_97 >= 1 &&
F_41 ( V_80 , 1 ) -> V_97 <= 9 )
V_5 -> V_98 = F_41 ( V_80 , 1 ) -> V_97 ;
else if ( F_18 ( V_6 -> V_7 ) == V_99 )
V_5 -> V_98 = 1 ;
else if ( F_41 ( V_80 , 1 ) -> V_100 >= 1 &&
F_41 ( V_80 , 1 ) -> V_100 <= 16 )
V_5 -> V_98 = F_41 ( V_80 , 1 ) -> V_100 - 1 ;
else
V_5 -> V_98 = 3 ;
V_5 -> V_58 = F_42 ( F_41 ( V_80 , 1 ) -> V_101 ) ;
}
...
{
unsigned long V_104 = V_105 + F_45 ( 1000 ) ;
int V_106 ;
do {
V_106 = F_46 ( & V_5 -> V_72 , V_5 -> V_107 ) ;
if ( ! V_106 )
break;
F_47 ( 1 ) ;
} while ( F_48 ( V_105 , V_104 ) );
if ( V_106 )
F_26 ( V_70 L_17 ,
V_106 , V_5 -> V_81 ) ;
F_30 ( V_108 , & V_5 -> V_26 ) ;
...
static int F_50 ( struct V_22 * V_5 , bool V_109 )
{
unsigned int V_40 ;
...
static void F_53 ( struct V_22 * V_5 , int V_109 )
{
int V_40 ;
V_5 -> V_35 = NULL ;
V_5 -> V_42 = NULL ;
...
V_124 -= V_124 >> 3 ;
V_124 = F_56 ( V_124 , 1u ) ;
V_127 = F_58 ( V_117 , V_124 ) ;
V_128 = F_58 ( V_127 ,
V_126 ) ;
V_129 = F_58 ( V_127 , V_128 ) ;
V_5 -> V_141 = F_58 ( V_118 ,
V_128 ) ;
...
V_3 -> V_44 ++ ;
V_3 -> V_8 = F_59 ( V_3 -> V_44 , V_93 ) ;
if ( ! V_3 -> V_8 )
goto V_145;
V_3 -> V_8 -> V_9 =
F_60 ( V_5 -> V_6 -> V_7 , V_3 -> V_4 ,
V_93 , & V_3 -> V_8 -> V_10 ) ;
if ( ! V_3 -> V_8 -> V_9 )
goto V_145;
...
static int F_61 ( struct V_22 * V_5 )
{
int V_40 ;
V_5 -> V_112 = F_60 ( V_5 -> V_6 -> V_7 , V_113 * 4 ,
V_93 , & V_5 -> V_114 ) ;
if ( ! V_5 -> V_112 )
return - V_149 ;
...
int F_63 ( struct V_22 * V_5 , bool V_159 )
{
int V_11 ;
unsigned int V_40 ;
if ( V_5 -> V_6 -> V_76 )
...
void F_68 ( struct V_161 * V_162 )
{
struct V_22 * V_5 ;
V_5 = F_69 ( V_162 , struct V_22 , V_102 ) ;
F_53 ( V_5 , 1 ) ;
F_70 ( V_5 ) ;
}
...
V_165 >>= - V_5 -> V_157 ;
if ( F_72 ( V_165 >= V_5 -> V_56 - V_5 -> V_56 / 8 && V_165 <= V_5 -> V_135 ) ) {
F_10 ( & V_5 -> V_30 , V_26 ) ;
V_5 -> V_32 = V_165 ;
F_12 ( & V_5 -> V_30 , V_26 ) ;
} else {
