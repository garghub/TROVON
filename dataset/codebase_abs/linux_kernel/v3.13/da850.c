...
{
int V_30 , V_12 = 0 , V_36 ;
unsigned int V_37 = ( unsigned int ) - 1 ;
struct V_38 * V_39 = V_24 . V_25 ;
V_35 /= 1000 ;
for ( V_30 = 0 ; V_39 [ V_30 ] . V_33 != V_40 ; V_30 ++ ) {
V_36 = V_39 [ V_30 ] . V_33 - V_35 ;
if ( V_36 < 0 )
V_36 = - V_36 ;
if ( V_36 < V_37 ) {
V_37 = V_36 ;
...
static int F_22 ( struct V_1 * V_1 , unsigned long V_35 )
{
return - V_48 ;
}
static int F_24 ( struct V_1 * V_1 , unsigned long V_49 )
{
return - V_48 ;
}
static int F_21 ( struct V_1 * V_1 , unsigned long V_35 )
...
V_53 -> V_58 = F_30 ( V_59 ) ;
V_53 -> V_60 = V_61 ;
V_53 -> V_62 = F_31 ( V_63 , V_64 ) ;
if ( ! V_53 -> V_62 )
return - V_65 ;
V_53 -> V_66 = F_31 ( V_67 , V_64 ) ;
if ( ! V_53 -> V_66 ) {
V_12 = - V_65 ;
goto V_68;
}
V_53 -> V_69 = F_31 ( V_70 , V_64 ) ;
if ( ! V_53 -> V_69 ) {
V_12 = - V_65 ;
goto V_71;
}
...
int T_2 F_34 ( struct V_73
* V_74 )
{
V_75 . V_54 . V_55 = V_74 ;
return F_20 ( & V_75 ) ;
}
int T_2 F_35 ( struct V_76
* V_77 )
{
V_78 . V_54 . V_55 = V_77 ;
return F_20 ( & V_78 ) ;
