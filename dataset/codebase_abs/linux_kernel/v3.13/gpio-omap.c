...
static inline void F_41 ( struct V_1 * V_2 , int V_9 )
{
F_40 ( V_2 , F_9 ( V_2 , V_9 ) ) ;
}
...
static void F_43 ( struct V_1 * V_2 , int V_69 )
{
void T_1 * V_11 = V_2 -> V_5 ;
T_2 V_12 ;
if ( V_2 -> V_13 -> V_75 ) {
...
static void F_44 ( struct V_1 * V_2 , int V_69 )
{
void T_1 * V_11 = V_2 -> V_5 ;
T_2 V_12 ;
if ( V_2 -> V_13 -> V_77 ) {
...
static inline void F_45 ( struct V_1 * V_2 , int V_9 , int V_17 )
{
if ( V_17 )
F_43 ( V_2 , F_9 ( V_2 , V_9 ) ) ;
else
F_44 ( V_2 , F_9 ( V_2 , V_9 ) ) ;
}
static int F_46 ( struct V_1 * V_2 , int V_9 , int V_17 )
{
T_2 V_21 = F_9 ( V_2 , V_9 ) ;
unsigned long V_61 ;
if ( V_2 -> V_41 & V_21 ) {
...
static int F_48 ( struct V_58 * V_59 , unsigned int V_17 )
{
struct V_1 * V_2 = F_30 ( V_59 ) ;
unsigned int V_9 = F_1 ( V_2 , V_59 -> V_65 ) ;
return F_46 ( V_2 , V_9 , V_17 ) ;
}
static int F_49 ( struct V_6 * V_4 , unsigned V_7 )
{
struct V_1 * V_2 = F_3 ( V_4 , struct V_1 , V_4 ) ;
unsigned long V_61 ;
if ( ! F_25 ( V_2 ) )
...
static void F_50 ( struct V_6 * V_4 , unsigned V_7 )
{
struct V_1 * V_2 = F_3 ( V_4 , struct V_1 , V_4 ) ;
unsigned long V_61 ;
F_34 ( & V_2 -> V_66 , V_61 ) ;
V_2 -> V_56 &= ~ ( 1 << V_7 ) ;
F_26 ( V_2 , V_7 ) ;
F_47 ( V_2 , V_2 -> V_4 . V_5 + V_7 ) ;
F_36 ( & V_2 -> V_66 , V_61 ) ;
if ( ! F_25 ( V_2 ) )
F_51 ( V_2 -> V_62 ) ;
}
static void F_52 ( unsigned int V_63 , struct V_79 * V_80 )
{
void T_1 * V_81 = NULL ;
T_2 V_82 ;
unsigned int V_83 ;
...
static int F_66 ( struct V_89 * V_62 )
{
struct V_90 * V_91 = F_67 ( V_62 ) ;
struct V_1 * V_2 = F_68 ( V_91 ) ;
...
static int F_69 ( struct V_89 * V_62 )
{
struct V_90 * V_91 = F_67 ( V_62 ) ;
struct V_1 * V_2 = F_68 ( V_91 ) ;
void T_1 * V_92 = V_2 -> V_5 +
...
static int F_74 ( struct V_6 * V_4 , unsigned V_7 )
{
struct V_1 * V_2 ;
unsigned long V_61 ;
...
static int F_76 ( struct V_6 * V_4 , unsigned V_7 , int V_97 )
{
struct V_1 * V_2 ;
unsigned long V_61 ;
V_2 = F_3 ( V_4 , struct V_1 , V_4 ) ;
...
static int F_77 ( struct V_6 * V_4 , unsigned V_7 ,
unsigned V_29 )
{
struct V_1 * V_2 ;
unsigned long V_61 ;
...
static void F_78 ( struct V_6 * V_4 , unsigned V_7 , int V_97 )
{
struct V_1 * V_2 ;
unsigned long V_61 ;
V_2 = F_3 ( V_4 , struct V_1 , V_4 ) ;
...
return;
V_99 = F_80 ( V_2 -> V_5 + V_2 -> V_13 -> V_100 ) ;
F_81 ( L_3 ,
...
V_2 -> V_27 = F_83 ( V_2 -> V_62 , L_4 ) ;
if ( F_84 ( V_2 -> V_27 ) )
F_38 ( V_2 -> V_62 , L_5 ) ;
}
static void
F_85 ( struct V_1 * V_2 , unsigned int V_103 ,
unsigned int V_104 )
{
struct V_105 * V_106 ;
struct V_107 * V_108 ;
V_106 = F_86 ( L_6 , 1 , V_103 , V_2 -> V_5 ,
V_109 ) ;
if ( ! V_106 ) {
F_38 ( V_2 -> V_62 , L_7 ) ;
return;
...
if ( V_2 -> V_13 -> V_42 )
V_108 -> V_4 . V_115 = F_48 ;
V_108 -> V_13 . V_23 = V_116 / V_2 -> V_94 ;
F_87 ( V_106 , F_88 ( V_104 ) , V_117 ,
V_118 | V_119 , 0 ) ;
}
...
int V_63 = F_91 ( V_2 -> V_8 , V_120 ) ;
F_92 ( V_63 , & V_129 ) ;
F_93 ( V_63 , V_2 ) ;
if ( V_2 -> V_102 ) {
F_85 ( V_2 , V_63 , V_2 -> V_72 ) ;
} else {
F_94 ( V_63 , & V_130 ,
V_109 ) ;
F_95 ( V_63 , V_131 ) ;
...
int V_141 ;
#endif
V_136 = F_99 ( F_100 ( V_142 ) , V_62 ) ;
V_138 = V_136 ? V_136 -> V_143 : F_101 ( V_62 ) ;
if ( ! V_138 )
return - V_50 ;
V_2 = F_102 ( V_62 , sizeof( struct V_1 ) , V_144 ) ;
if ( ! V_2 ) {
F_38 ( V_62 , L_10 ) ;
return - V_145 ;
}
V_140 = F_103 ( V_91 , V_146 , 0 ) ;
if ( F_104 ( ! V_140 ) ) {
F_38 ( V_62 , L_11 ) ;
return - V_147 ;
}
...
#ifdef F_32
V_141 = F_108 ( - 1 , 0 , V_2 -> V_72 , 0 ) ;
if ( V_141 < 0 ) {
F_38 ( V_62 , L_13 ) ;
return - V_147 ;
}
V_2 -> V_8 = F_109 ( V_133 , V_2 -> V_72 , V_141 ,
0 , & V_153 , NULL ) ;
#else
V_2 -> V_8 = F_110 ( V_133 , V_2 -> V_72 ,
& V_153 , NULL ) ;
#endif
if ( ! V_2 -> V_8 ) {
F_38 ( V_62 , L_14 ) ;
...
V_2 -> V_18 = F_10 ;
F_111 ( & V_2 -> V_66 ) ;
V_140 = F_103 ( V_91 , V_154 , 0 ) ;
if ( F_104 ( ! V_140 ) ) {
F_38 ( V_62 , L_15 ) ;
F_112 ( V_2 -> V_8 ) ;
return - V_147 ;
}
if ( ! F_113 ( V_62 , V_140 -> V_148 , F_114 ( V_140 ) ,
V_91 -> V_155 ) ) {
F_38 ( V_62 , L_16 ) ;
F_112 ( V_2 -> V_8 ) ;
return - V_156 ;
}
V_2 -> V_5 = F_115 ( V_62 , V_140 -> V_148 , F_114 ( V_140 ) ) ;
if ( ! V_2 -> V_5 ) {
F_38 ( V_62 , L_17 ) ;
F_112 ( V_2 -> V_8 ) ;
return - V_145 ;
...
F_79 ( V_2 ) ;
F_51 ( V_2 -> V_62 ) ;
F_118 ( & V_2 -> V_133 , & V_157 ) ;
return 0 ;
}
static int F_119 ( struct V_89 * V_62 )
{
struct V_90 * V_91 = F_67 ( V_62 ) ;
struct V_1 * V_2 = F_68 ( V_91 ) ;
T_2 V_158 = 0 , V_159 = 0 ;
...
static int F_120 ( struct V_89 * V_62 )
{
struct V_90 * V_91 = F_67 ( V_62 ) ;
struct V_1 * V_2 = F_68 ( V_91 ) ;
...
void F_123 ( int V_176 )
{
struct V_1 * V_2 ;
F_124 (bank, &omap_gpio_list, node) {
...
static void F_121 ( struct V_1 * V_177 )
{
...
static inline void F_121 ( struct V_1 * V_177 ) {}
