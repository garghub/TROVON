...
V_6 -> V_24 [ V_63 ] . V_110 = V_111 [ V_63 ] ;
...
V_105 |= V_3 & 0xff ;
if ( V_105 != 0x2000 ) {
F_14 ( & V_2 -> V_20 , L_32 , V_105 ) ;
V_10 = - V_112 ;
goto V_113;
}
V_3 = F_4 ( V_2 , V_93 ) ;
F_52 ( & V_2 -> V_20 , L_33 , V_3 + 'A' ) ;
V_6 -> V_25 = F_53 ( & V_2 -> V_20 , L_34 ) ;
if ( F_49 ( V_6 -> V_25 ) ) {
V_10 = F_50 ( V_6 -> V_25 ) ;
...
V_101 = F_54 ( & V_2 -> V_20 ) ;
if ( V_101 ) {
V_6 -> V_44 = ! V_101 -> V_114 ;
if ( V_101 -> V_115 )
V_102 = V_101 -> V_115 ;
}
V_10 = F_55 ( & V_104 , V_102 , & V_2 -> V_20 ) ;
if ( V_10 != 0 ) {
F_14 ( & V_2 -> V_20 , L_37 , V_10 ) ;
goto V_113;
}
V_6 -> V_35 = V_104 -> V_116 + 2 ;
...
V_6 -> V_36 [ 0 ] = 0x80 ;
V_6 -> V_36 [ 1 ] = 0x00 ;
memcpy ( V_6 -> V_36 + 2 , V_104 -> V_117 , V_104 -> V_116 ) ;
V_6 -> V_69 = 1 ;
V_6 -> V_71 = 1 ;
V_6 -> V_70 = 1 ;
V_6 -> V_2 = V_2 ;
F_6 ( V_6 ) ;
V_10 = F_56 ( & V_2 -> V_20 , & V_118 , NULL , 0 ) ;
V_113:
F_16 ( V_23 , V_6 -> V_24 ) ;
V_109:
F_57 ( V_104 ) ;
