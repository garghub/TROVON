...
unsigned long V_38 , unsigned long V_139 )
{
unsigned long V_37 , V_39 , V_140 ;
long V_141 ;
int V_61 , V_142 , V_143 , V_40 ;
unsigned long V_9 ;
struct V_42 * V_42 ;
struct V_89 V_86 ;
if ( ! F_166 ( V_21 , V_120 ) )
...
F_171 () ;
F_173 ( V_21 , V_38 ) ;
V_141 = F_157 ( V_21 , V_38 ) ;
if ( V_141 < 0 ) {
V_61 = - V_130 ;
goto V_146;
}
F_98 ( V_152 L_9 , V_141 ) ;
F_154 ( V_21 , V_38 ) ;
F_174 ( V_21 , V_38 , V_144 ) ;
F_81 ( F_45 ( V_21 ) , - V_141 ) ;
V_42 -> V_107 -= V_141 ;
F_49 ( V_42 -> V_56 , & V_9 ) ;
V_42 -> V_56 -> V_108 -= V_141 ;
F_50 ( V_42 -> V_56 , & V_9 ) ;
F_100 () ;
if ( ! F_94 ( V_42 ) ) {
F_97 ( V_42 ) ;
...
{
return F_165 ( V_21 , V_21 + V_39 , 120 * V_155 ) ;
}
int F_177 ( unsigned long V_21 , unsigned long V_38 ,
void * V_86 , int (* F_178)( struct V_156 * , void * ) )
{
...
( V_24 <= V_157 -> V_160 ) )
continue;
V_157 = F_180 ( V_158 , V_157 ) ;
if ( ! V_157 )
continue;
V_61 = F_178 ( V_157 , V_86 ) ;
if ( V_61 ) {
F_181 ( & V_157 -> V_161 . V_162 ) ;
return V_61 ;
}
}
if ( V_157 )
...
static int F_182 ( struct V_156 * V_157 , void * V_86 )
{
int V_61 = ! F_183 ( V_157 ) ;
if ( F_61 ( V_61 ) ) {
T_8 V_163 , V_164 ;
V_163 = F_184 ( F_72 ( V_157 -> V_159 ) ) ;
V_164 = F_184 ( F_72 ( V_157 -> V_160 + 1 ) ) - 1 ;
F_76 ( L_11
L_12 ,
& V_163 , & V_164 ) ;
}
