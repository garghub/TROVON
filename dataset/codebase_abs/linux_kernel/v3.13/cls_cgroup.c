...
static int F_21 ( struct V_28 * V_29 , const struct V_30 * V_31 ,
struct V_32 * V_33 )
{
...
if ( ! V_12 )
return - 1 ;
if ( ! F_25 ( V_29 , & V_35 -> V_38 , NULL ) )
return - 1 ;
V_33 -> V_12 = V_12 ;
V_33 -> V_39 = 0 ;
return F_26 ( V_29 , & V_35 -> V_40 , V_33 ) ;
}
static unsigned long F_27 ( struct V_30 * V_31 , V_21 V_41 )
{
return 0UL ;
}
static void F_28 ( struct V_30 * V_31 , unsigned long V_42 )
{
}
...
static int F_30 ( struct V_43 * V_43 , struct V_28 * V_44 ,
...
if ( V_41 != V_35 -> V_41 )
return - V_58 ;
V_16 = F_33 ( V_49 , V_50 , V_47 [ V_55 ] ,
V_59 ) ;
if ( V_16 < 0 )
return V_16 ;
V_16 = F_34 ( V_43 , V_31 , V_49 , V_47 [ V_60 ] , & V_54 ,
& V_61 ) ;
if ( V_16 < 0 )
return V_16 ;
V_16 = F_35 ( V_31 , V_49 [ V_62 ] , & V_52 ) ;
if ( V_16 < 0 )
return V_16 ;
F_36 ( V_31 , & V_35 -> V_40 , & V_54 ) ;
F_37 ( V_31 , & V_35 -> V_38 , & V_52 ) ;
return 0 ;
}
...
static int F_41 ( struct V_30 * V_31 , unsigned long V_48 )
{
return - V_63 ;
}
static void F_42 ( struct V_30 * V_31 , struct V_64 * V_48 )
{
struct V_34 * V_35 = V_31 -> V_36 ;
...
static int F_43 ( struct V_30 * V_31 , unsigned long V_69 ,
struct V_28 * V_29 , struct V_70 * V_52 )
{
struct V_34 * V_35 = V_31 -> V_36 ;
unsigned char * V_71 = F_44 ( V_29 ) ;
struct V_46 * V_72 ;
V_52 -> V_73 = V_35 -> V_41 ;
V_72 = F_45 ( V_29 , V_55 ) ;
if ( V_72 == NULL )
goto V_74;
if ( F_46 ( V_29 , & V_35 -> V_40 , & V_61 ) < 0 ||
F_47 ( V_29 , & V_35 -> V_38 , V_62 ) < 0 )
goto V_74;
F_48 ( V_29 , V_72 ) ;
if ( F_49 ( V_29 , & V_35 -> V_40 , & V_61 ) < 0 )
goto V_74;
return V_29 -> V_75 ;
V_74:
F_50 ( V_29 , V_71 ) ;
