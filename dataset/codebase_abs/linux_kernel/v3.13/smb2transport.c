...
return - V_11 ;
F_12 ( & V_99 ) ;
F_34 ( & ( * V_79 ) -> V_100 , & V_21 -> V_2 -> V_101 ) ;
F_14 ( & V_99 ) ;
return 0 ;
}
int
...
bool V_102 )
{
unsigned int V_103 = F_36 ( V_79 -> V_104 ) ;
struct V_31 V_32 ;
struct V_25 V_26 = { . V_33 = & V_32 ,
. V_35 = 1 } ;
V_32 . V_37 = ( char * ) V_79 -> V_104 ;
V_32 . V_43 = F_36 ( V_79 -> V_104 ) + 4 ;
F_37 ( V_79 -> V_104 , F_38 ( V_105 , 80 , V_103 ) ) ;
if ( V_103 > 24 && V_2 -> V_106 ) {
int V_3 ;
V_3 = F_25 ( & V_26 , V_2 ) ;
if ( V_3 )
F_4 ( V_8 , L_33 ,
