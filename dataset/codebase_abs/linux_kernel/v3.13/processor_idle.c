...
static int F_54 ( struct V_109 * V_110 , int V_87 )
{
struct V_12 * V_13 = F_50 ( V_113 [ V_87 ] , V_110 -> V_114 ) ;
F_55 () ;
while ( 1 ) {
...
if ( ! V_13 -> V_117 && F_41 () ) {
if ( V_112 -> V_118 >= 0 ) {
return V_112 -> V_30 [ V_112 -> V_118 ] . F_60 ( V_110 ,
V_112 , V_112 -> V_118 ) ;
} else {
F_4 () ;
return - V_119 ;
...
strncpy ( V_9 -> V_90 , V_13 -> V_90 , V_131 ) ;
V_9 -> V_132 = V_13 -> V_49 ;
