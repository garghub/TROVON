...
int F_72 ( struct V_32 * V_7 , int V_89 )
{
struct V_80 V_90 , V_91 ;
...
void F_82 ( struct V_16 * V_17 , int V_89 )
{
struct V_32 * V_7 ;
struct V_80 V_90 ;
int V_96 ;
...
struct V_80 V_90 ;
struct V_80 V_91 ;
struct V_103 * V_87 , * V_82 ;
int V_26 = 0 ;
F_22 ( & V_90 ) ;
F_22 ( & V_91 ) ;
F_73 ( & V_7 -> V_17 -> V_104 ) ;
F_27 ( & V_7 -> V_17 -> V_58 ) ;
F_74 ( & V_101 -> V_85 , & V_90 ) ;
while ( ! F_30 ( & V_90 ) ) {
V_99 = F_59 ( V_90 . V_82 , struct V_99 ,
V_85 ) ;
V_13 = & V_99 -> V_105 ;
F_51 ( & V_99 -> V_85 ) ;
V_13 = F_18 ( V_13 ) ;
...
{
T_1 V_28 = V_2 -> V_3 ;
T_1 V_106 = V_28 + V_2 -> V_4 - 1 ;
F_88 ( V_13 , V_2 ) ;
if ( ! F_53 ( V_45 , & V_2 -> V_37 ) )
F_89 ( V_13 -> V_83 , V_28 , V_106 ) ;
if ( V_47 ) {
...
V_26 = F_89 ( V_13 -> V_83 , V_28 , V_107 ) ;
if ( V_26 )
return V_26 ;
if ( F_53 ( V_109 ,
& F_16 ( V_13 ) -> V_110 ) ) {
V_26 = F_89 ( V_13 -> V_83 , V_28 ,
V_107 ) ;
if ( V_26 )
return V_26 ;
}
V_26 = F_92 ( V_13 -> V_83 , V_28 , V_107 ) ;
if ( V_26 )
return V_26 ;
V_106 = V_107 ;
while ( 1 ) {
V_74 = F_93 ( V_13 , V_106 ) ;
if ( ! V_74 )
break;
if ( V_74 -> V_3 > V_107 ) {
F_54 ( V_74 ) ;
...
F_70 ( V_13 , V_74 , 1 ) ;
V_106 = V_74 -> V_3 ;
if ( F_53 ( V_72 , & V_74 -> V_37 ) )
V_26 = - V_111 ;
F_54 ( V_74 ) ;
if ( V_26 || V_106 == 0 || V_106 == V_28 )
break;
V_106 -- ;
}
return V_26 ;
...
if ( V_74 ) {
V_15 = F_1 ( V_74 ) ;
if ( F_53 ( V_115 , & V_74 -> V_37 ) )
V_15 = F_41 ( V_15 ,
V_74 -> V_3 +
V_74 -> V_42 ) ;
} else {
V_15 = F_98 ( V_15 , F_16 ( V_13 ) -> V_7 -> V_116 ) ;
}
V_112 = F_16 ( V_13 ) -> V_112 ;
if ( V_112 > V_114 ) {
F_16 ( V_13 ) -> V_112 = V_114 ;
V_26 = 0 ;
goto V_70;
}
if ( V_112 == V_114 )
...
if ( F_53 ( V_118 , & V_22 -> V_37 ) )
continue;
if ( V_22 -> V_3 + V_22 -> V_4 <= V_112 )
break;
if ( V_22 -> V_3 >= V_114 )
break;
if ( F_1 ( V_22 ) > V_112 ) {
...
V_113 = F_99 ( T_1 , V_15 , V_114 ) ;
if ( V_74 && V_74 -> V_117 > V_113 )
V_113 = F_99 ( T_1 , V_74 -> V_117 , V_114 ) ;
F_16 ( V_13 ) -> V_112 = V_113 ;
V_26 = 0 ;
V_70:
if ( V_74 )
F_19 ( V_118 , & V_74 -> V_37 ) ;
F_26 ( & V_25 -> V_53 ) ;
return V_26 ;
}
int F_100 ( struct V_13 * V_13 , T_1 V_15 , T_1 V_119 ,
T_2 * V_63 , int V_4 )
{
struct V_62 * V_120 ;
struct V_1 * V_74 ;
...
if ( V_119 >= V_120 -> V_123 &&
V_119 < V_120 -> V_123 + V_120 -> V_4 ) {
V_122 = ( V_119 - V_120 -> V_123 ) >>
V_13 -> V_18 -> V_124 ;
V_121 = V_120 -> V_4 >>
V_13 -> V_18 -> V_124 ;
V_121 = F_99 ( int , V_4 - V_75 , V_121 - V_122 ) ;
memcpy ( V_63 + V_75 , V_120 -> V_125 + V_122 ,
V_121 ) ;
V_75 += ( int ) V_121 ;
if ( V_75 == V_4 )
goto V_70;
...
void F_102 ( struct V_97 * V_98 ,
struct V_32 * V_7 , struct V_13 * V_13 )
{
struct V_100 * V_101 = V_98 -> V_102 ;
T_1 V_126 ;
V_126 = F_40 ( F_16 ( V_13 ) -> V_127 , F_16 ( V_13 ) -> V_128 ) ;
if ( V_126 <= V_7 -> V_17 -> V_129 )
return;
F_27 ( & V_7 -> V_17 -> V_58 ) ;
if ( F_30 ( & F_16 ( V_13 ) -> V_85 ) ) {
F_28 ( & F_16 ( V_13 ) -> V_85 ,
