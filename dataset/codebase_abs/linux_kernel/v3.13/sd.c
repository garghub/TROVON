...
return V_55 ;
if ( V_158 ) {
if ( memcmp ( V_5 , V_158 -> V_4 , sizeof( V_5 ) ) != 0 )
return - V_160 ;
V_2 = V_158 ;
} else {
V_2 = F_54 ( V_39 , & V_161 ) ;
...
static int F_76 ( struct V_119 * V_39 )
{
int V_55 ;
V_55 = F_72 ( V_39 ) ;
if ( ! V_55 ) {
...
if ( ! F_73 ( V_39 -> V_2 ) )
goto V_62;
F_80 ( V_39 , V_39 -> V_2 -> V_143 ) ;
V_55 = F_51 ( V_39 , V_39 -> V_2 -> V_143 , V_39 -> V_2 ) ;
F_81 ( V_39 -> V_2 ) ;
V_62:
F_71 ( V_39 ) ;
return V_55 ;
}
static int F_82 ( struct V_119 * V_39 )
{
int V_55 = 0 ;
if ( ! ( V_39 -> V_77 & V_169 ) ) {
V_55 = F_79 ( V_39 ) ;
...
static int F_86 ( struct V_119 * V_39 )
{
int V_55 ;
if ( ! ( V_39 -> V_77 & V_170 ) )
return 0 ;
...
static int F_87 ( struct V_119 * V_39 )
{
int V_55 ;
if ( ! ( V_39 -> V_77 & ( V_170 | V_169 ) ) )
return 0 ;
V_55 = F_79 ( V_39 ) ;
if ( V_55 )
F_6 ( L_24 ,
...
static int F_88 ( struct V_119 * V_39 )
{
int V_171 ;
V_39 -> V_2 -> V_166 &= ~ V_167 ;
F_68 ( V_39 ) ;
V_171 = F_51 ( V_39 , V_39 -> V_2 -> V_143 , V_39 -> V_2 ) ;
F_71 ( V_39 ) ;
return V_171 ;
}
static void F_89 ( struct V_119 * V_39 )
{
...
F_89 ( V_39 ) ;
if ( V_39 -> V_176 )
V_39 -> V_177 = V_39 -> V_176 ;
if ( F_32 ( V_39 ) ) {
F_34 ( V_39 ) ;
V_55 = F_93 ( V_39 , 0 , & V_143 ) ;
if ( V_55 )
goto V_55;
}
V_144 = F_94 ( V_39 , V_143 ) ;
if ( ! V_144 ) {
V_55 = - V_40 ;
goto V_55;
}
V_55 = F_51 ( V_39 , V_144 , NULL ) ;
if ( V_55 )
goto V_55;
F_71 ( V_39 ) ;
V_55 = F_95 ( V_39 -> V_2 ) ;
