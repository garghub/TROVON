...
static int F_38 ( const char * V_65 , char * * V_66 , unsigned int V_67 )
{
unsigned long V_68 = F_39 ( V_65 , V_66 , V_67 ) ;
switch ( * * V_66 ) {
case 'G' :
V_68 *= 1024 ;
case 'M' :
...
static int F_40 ( T_2 * V_69 , const char * V_70 )
{
char * V_66 ;
T_2 V_71 ;
V_71 = ( T_2 ) F_38 ( V_70 , & V_66 , 0 ) ;
if ( * V_66 )
return - V_72 ;
* V_69 = V_71 ;
return 0 ;
}
static inline void F_41 ( char * V_73 )
{
char * V_74 = strrchr ( V_73 , '\n' ) ;
if ( V_74 && ! V_74 [ 1 ] )
* V_74 = 0 ;
}
static int F_42 ( const char * V_75 )
{
char V_31 [ 80 + 12 ] ;
char * V_73 = V_31 ;
char * V_70 [ 2 ] ;
...
T_2 V_40 = V_16 ;
int V_76 , V_77 ;
if ( F_43 ( V_75 , sizeof( V_31 ) ) >= sizeof( V_31 ) ) {
F_15 ( L_7 ) ;
return 0 ;
}
strcpy ( V_73 , V_75 ) ;
...
static int F_45 ( const char * V_75 , struct V_78 * V_79 )
{
#ifdef F_29
return F_42 ( V_75 ) ;
#else
...
F_49 (pos, next, &blkmtd_device_list) {
struct V_5 * V_6 = F_50 ( V_83 , F_51 ( * V_6 ) , V_63 ) ;
F_20 ( & V_6 -> V_18 ) ;
F_52 ( & V_6 -> V_18 ) ;
F_37 ( L_13 ,
V_6 -> V_18 . V_4 ,
