...
if ( ( TRUE == V_37 -> V_39 ) && ( TRUE == V_2 -> V_40 ) ) {
V_4 = F_10 ( V_37 -> V_41 ) ;
...
if ( V_2 -> V_14 == V_15 ) {
V_50 = 0 ;
V_48 = F_4 ( V_2 , V_16 , & V_50 , sizeof( V_50 ) ) ;
if ( V_48 ) {
F_2 ( V_2 , V_13 , 0 , 0 , L_24 , V_48 ) ;
return;
}
}
else {
V_7 = F_5 ( V_2 , V_18 , & V_50 , sizeof( V_50 ) ) ;
if ( V_7 < 0 ) {
V_48 = V_7 ;
F_2 ( V_2 , V_13 , 0 , 0 , L_25 , V_48 ) ;
return;
}
V_7 = F_5 ( V_2 , V_19 , & V_50 , sizeof( V_50 ) ) ;
if ( V_7 < 0 ) {
V_48 = V_7 ;
F_2 ( V_2 , V_13 , 0 , 0 , L_26 , V_48 ) ;
return;
}
}
}
