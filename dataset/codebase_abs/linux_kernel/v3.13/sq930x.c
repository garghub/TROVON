...
return;
V_15 -> V_93 = 0 ;
F_21 ( V_1 , F_30 ( V_15 -> V_119 ) ,
F_30 ( V_15 -> V_67 ) ) ;
V_1 -> V_75 . V_92 = 1 ;
V_4 = F_31 ( V_1 -> V_120 [ 0 ] , V_121 ) ;
if ( V_4 < 0 )
F_4 ( L_17 , V_4 ) ;
F_8 ( 100 ) ;
}
...
if ( V_15 -> V_93 )
V_1 -> V_75 . V_92 = 0 ;
F_33 ( V_1 , V_122 , NULL , 0 ) ;
F_33 ( V_1 , V_123 , V_14 , V_3 - 8 ) ;
F_33 ( V_1 , V_124 , NULL , 0 ) ;
}
static int F_34 ( struct V_125 * V_126 )
{
struct V_1 * V_1 =
F_35 ( V_126 -> V_127 , struct V_1 , V_128 ) ;
struct V_15 * V_15 = (struct V_15 * ) V_1 ;
V_1 -> V_5 = 0 ;
if ( ! V_1 -> V_129 )
return 0 ;
switch ( V_126 -> V_74 ) {
case V_130 :
F_21 ( V_1 , V_126 -> V_21 , V_15 -> V_67 -> V_21 ) ;
break;
}
return V_1 -> V_5 ;
}
...
{
struct V_131 * V_132 = & V_1 -> V_128 ;
struct V_15 * V_15 = (struct V_15 * ) V_1 ;
V_1 -> V_133 . V_128 = V_132 ;
F_37 ( V_132 , 2 ) ;
V_15 -> V_119 = F_38 ( V_132 , & V_134 ,
V_130 , 1 , 0xfff , 1 , 0x356 ) ;
V_15 -> V_67 = F_38 ( V_132 , & V_134 ,
V_135 , 1 , 255 , 1 , 0x8d ) ;
if ( V_132 -> error ) {
F_4 ( L_18 ) ;
return V_132 -> error ;
...
static int F_40 ( struct V_136 * V_137 ,
const struct V_73 * V_74 )
{
return F_41 ( V_137 , V_74 , & V_138 , sizeof( struct V_15 ) ,
V_139 ) ;
}
