...
V_193 -> V_290 = V_291 ;
V_193 -> V_292 = & F_54 ;
V_193 -> V_162 = & V_161 -> V_175 -> V_293 [ V_208 ] ;
V_161 -> V_175 -> V_293 [ V_208 ] . V_158 =
V_208 / V_12 ;
V_161 -> V_175 -> V_293 [ V_208 ] . V_11 =
V_208 % V_12 ;
} else {
V_193 -> type = V_266 ;
}
...
{
return F_95 ( V_15 , & V_300 , V_299 -> V_301 ) ;
}
