...
V_283 -> V_263 = V_285 ;
V_283 -> V_286 . V_287 . V_288 = V_289 ;
V_283 -> V_286 . V_290 . V_288 = V_291 ;
V_283 -> V_286 . V_292 . V_288 = NULL ;
V_283 -> V_286 . V_293 . V_288 = NULL ;
V_283 -> V_286 . V_294 . V_288 = NULL ;
V_283 -> V_286 . V_295 . V_288 = NULL ;
V_283 -> V_286 . V_296 . V_288 = NULL ;
V_283 -> V_286 . V_297 . V_288 = NULL ;
V_283 -> V_286 . V_298 . V_288 = NULL ;
V_10 = F_151 ( V_283 ) ;
if ( V_10 < 0 ) {
F_93 ( V_238 L_45
L_46 ) ;
...
static void F_155 ( struct V_16 * * V_299 )
{
...
static int F_156 ( struct V_301 * V_302 , struct V_2 * V_3 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
...
int V_303 ;
int V_10 ;
V_303 = F_157 ( V_302 , V_3 ) ;
if ( V_303 < 0 )
return V_303 ;
V_304 . V_305 = V_303 ;
V_306 . V_305 = V_303 ;
V_9 -> V_303 = V_303 ;
V_17 = F_158 ( V_50 , & V_307 ,
& V_308 ) ;
if ( ! V_17 )
goto V_309;
V_17 -> V_300 = V_9 ;
V_9 -> V_32 = V_17 ;
V_17 = F_158 ( V_50 , & V_310 ,
& V_311 ) ;
if ( ! V_17 )
goto V_309;
V_17 -> V_300 = V_9 ;
V_9 -> V_13 = V_17 ;
V_17 = F_158 ( V_50 , & V_312 ,
& V_313 ) ;
if ( ! V_17 )
goto V_309;
V_17 -> V_300 = V_9 ;
V_9 -> V_105 = V_17 ;
V_17 = F_158 ( V_50 , & V_314 ,
& V_315 ) ;
if ( ! V_17 )
goto V_309;
V_17 -> V_300 = V_9 ;
...
static void F_160 ( struct V_301 * V_302 , struct V_2 * V_3 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
F_161 ( V_3 ) ;
F_29 ( V_9 ) ;
}
static void F_162 ( struct V_180 * V_328 )
{
struct V_329 * V_181 = F_2 ( V_328 , struct V_329 ,
V_181 ) ;
struct V_1 * V_9 = V_181 -> V_9 ;
int V_330 = V_181 -> V_330 ;
F_29 ( V_181 ) ;
if ( V_9 -> V_11 & V_77 )
F_31 ( V_9 ) ;
if ( V_9 -> V_11 & V_131 )
...
static int F_164 ( struct V_2 * V_3 , unsigned V_333 , unsigned V_330 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
if ( ( V_330 == V_331 ) || ( V_330 == V_332 ) ) {
struct V_329 * V_181 ;
...
static int F_168 ( struct V_301 * V_302 )
{
struct V_1 * V_9 ;
int V_10 ;
...
V_9 -> V_4 . V_340 = F_166 ;
V_9 -> V_97 = V_259 ;
V_304 . V_341 = V_342 [ V_343 ] . V_344 ;
V_306 . V_341 = V_342 [ V_345 ] . V_344 ;
V_10 = F_169 ( V_302 , & V_9 -> V_4 ) ;
if ( V_10 )
goto V_65;
return 0 ;
V_65:
...
{
int V_10 ;
V_10 = F_171 ( V_76 , V_342 ) ;
if ( V_10 )
return V_10 ;
V_346 . V_347 =
V_342 [ V_348 ] . V_344 ;
V_346 . V_349 = V_342 [ V_350 ] . V_344 ;
V_346 . V_351 =
V_342 [ V_352 ] . V_344 ;
V_353 . V_354 =
V_342 [ V_355 ] . V_344 ;
V_10 = F_172 ( V_76 , & V_353 ,
F_168 ) ;
if ( V_10 )
return V_10 ;
F_173 ( V_76 , & V_356 ) ;
