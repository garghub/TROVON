...
V_138 = F_74 ( V_9 , V_83 & V_141 , V_128 ) ;
V_133 = 0 ;
do {
T_5 V_142 ;
if ( F_55 ( V_92 ) ) {
...
static int F_92 ( struct V_26 * V_8 , unsigned int V_167 ,
unsigned long V_168 )
{
return - V_169 ;
}
static int F_93 ( struct V_26 * V_8 , int V_170 , int V_171 ,
...
static int F_95 ( struct V_26 * V_8 , int V_170 , int V_171 ,
...
V_10 = 0 ;
if ( F_96 ( V_128 , V_173 ) || F_97 ( V_172 , & V_200 , V_128 ) )
V_10 = - V_151 ;
V_43:
F_28 ( V_9 ) ;
return V_10 ;
