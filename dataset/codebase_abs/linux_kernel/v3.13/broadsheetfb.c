...
static T_5 F_66 ( struct V_66 * V_34 , const char T_6 * V_64 ,
T_4 V_120 , T_7 * V_121 )
{
struct V_1 * V_2 = V_34 -> V_2 ;
...
static int F_68 ( struct V_133 * V_61 )
{
struct V_66 * V_34 ;
struct V_134 * V_4 ;
int V_135 = - V_51 ;
...
static int F_84 ( struct V_133 * V_61 )
{
struct V_66 * V_34 = F_85 ( V_61 ) ;
if ( V_34 ) {
struct V_1 * V_2 = V_34 -> V_2 ;
F_86 ( V_34 -> V_61 , & V_168 ) ;
F_79 ( V_34 ) ;
F_87 ( V_34 ) ;
V_2 -> V_4 -> V_170 ( V_2 ) ;
F_80 ( & V_34 -> V_159 ) ;
