...
static int F_100 ( struct V_87 * V_8 )
{
struct V_109 * V_110 ;
...
static int F_104 ( void * V_127 , bool V_149 )
{
int V_68 ;
...
static int F_105 ( struct V_31 * V_87 ,
enum V_152 V_153 )
{
int V_154 = 0 ;
struct V_155 * V_156 ;
...
V_156 = F_106 ( V_39 , & V_87 -> V_8 , type ,
& V_168 , ( void * ) V_153 ) ;
if ( ! V_156 )
return - V_37 ;
...
static T_6 F_112 ( struct V_87 * V_8 ,
struct V_88 * V_89 ,
const char * V_82 , T_5 V_77 )
{
int V_57 = 0 ;
...
static T_6 F_114 ( struct V_87 * V_8 ,
struct V_88 * V_89 , char * V_82 )
{
T_6 V_77 = 0 ;
...
V_169 -> V_175 . V_89 . V_39 = L_59 ;
V_169 -> V_175 . V_89 . V_100 = V_101 | V_176 ;
V_169 -> V_175 . V_102 = F_114 ;
V_169 -> V_175 . V_177 = F_112 ;
F_53 ( & V_169 -> V_178 . V_89 ) ;
V_169 -> V_178 . V_89 . V_39 = L_60 ;
V_169 -> V_178 . V_89 . V_100 = V_101 | V_176 ;
V_169 -> V_178 . V_102 = F_117 ;
V_169 -> V_178 . V_177 = F_116 ;
...
V_182 -> V_185 [ 0 ] . V_89 . V_39 = L_61 ;
V_182 -> V_185 [ 0 ] . V_89 . V_100 = V_101 | V_176 ;
V_182 -> V_185 [ 0 ] . V_102 = F_119 ;
V_182 -> V_185 [ 0 ] . V_177 = F_118 ;
...
V_182 -> V_185 [ 1 ] . V_89 . V_39 = L_62 ;
V_182 -> V_185 [ 1 ] . V_89 . V_100 = V_101 ;
V_182 -> V_185 [ 1 ] . V_102 = F_120 ;
...
static int F_121 ( unsigned short V_100 )
{
unsigned int V_68 ;
...
V_191 += snprintf ( V_82 + V_191 , V_92 - V_191 , L_63 ,
V_192 [ V_190 ] ) ;
}
...
if ( V_100 < 0 )
return V_100 ;
V_77 = snprintf ( V_82 , V_92 , L_64 , V_192 [ V_100 ] ) ;
return V_77 ;
}
...
V_187 -> V_194 . V_89 . V_39 = L_67 ;
V_187 -> V_194 . V_89 . V_100 = V_101 ;
V_187 -> V_194 . V_102 = F_123 ;
F_53 ( & V_187 -> V_175 . V_89 ) ;
V_187 -> V_175 . V_89 . V_39 = L_68 ;
V_187 -> V_175 . V_89 . V_100 = V_101 | V_176 ;
V_187 -> V_175 . V_102 = F_125 ;
V_187 -> V_175 . V_177 = F_124 ;
...
if ( V_77 > 31 )
return - V_81 ;
if ( F_113 ( V_82 , 10 , & V_67 ) || V_67 > 1 )
return - V_81 ;
if ( strcmp ( V_89 -> V_89 . V_39 , L_69 ) == 0 )
V_196 = 2 ;
else if ( strcmp ( V_89 -> V_89 . V_39 , L_70 ) == 0 )
V_196 = 1 ;
else if ( strcmp ( V_89 -> V_89 . V_39 , L_71 ) == 0 )
V_196 = 0 ;
else
return - V_81 ;
if ( V_67 )
...
V_197 -> V_185 [ 0 ] . V_89 . V_39 = L_69 ;
V_197 -> V_185 [ 0 ] . V_89 . V_100 = V_101 | V_176 ;
V_197 -> V_185 [ 0 ] . V_102 = F_127 ;
V_197 -> V_185 [ 0 ] . V_177 = F_126 ;
F_53 ( & V_197 -> V_185 [ 1 ] . V_89 ) ;
V_197 -> V_185 [ 1 ] . V_89 . V_39 = L_70 ;
V_197 -> V_185 [ 1 ] . V_89 . V_100 = V_101 | V_176 ;
V_197 -> V_185 [ 1 ] . V_102 = F_127 ;
V_197 -> V_185 [ 1 ] . V_177 = F_126 ;
F_53 ( & V_197 -> V_185 [ 2 ] . V_89 ) ;
V_197 -> V_185 [ 2 ] . V_89 . V_39 = L_71 ;
V_197 -> V_185 [ 2 ] . V_89 . V_100 = V_101 | V_176 ;
V_197 -> V_185 [ 2 ] . V_102 = F_127 ;
V_197 -> V_185 [ 2 ] . V_177 = F_126 ;
...
if ( V_196 < 0 )
return V_196 ;
return snprintf ( V_82 , V_92 , L_64 ,
V_196 == V_201 ? L_73 :
V_196 == V_202 ? L_74 :
V_196 == AUTO ? L_75 : L_76 ) ;
}
...
V_200 -> V_89 . V_89 . V_39 = L_77 ;
V_200 -> V_89 . V_89 . V_100 = V_101 ;
V_200 -> V_89 . V_102 = F_128 ;
...
return - V_37 ;
F_53 ( & V_205 -> V_89 ) ;
V_205 -> V_89 . V_39 = L_79 ;
V_205 -> V_89 . V_100 = V_101 | V_176 ;
V_205 -> V_102 = F_130 ;
V_205 -> V_177 = F_129 ;
...
V_206 -> V_89 . V_89 . V_39 = L_80 ;
V_206 -> V_89 . V_89 . V_100 = V_101 | V_176 ;
V_206 -> V_89 . V_102 = F_132 ;
V_206 -> V_89 . V_177 = F_131 ;
...
static int F_139 ( struct V_31 * V_87 )
{
T_4 V_72 ;
int V_68 = 0 ;
struct V_109 * V_110 ;
F_71 ( L_85 , V_221 , V_222 ) ;
V_133 = V_87 ;
strcpy ( F_140 ( V_87 ) , L_86 ) ;
V_97 = V_87 -> V_65 ;
V_68 = F_141 ( V_87 ) ;
...
static int F_144 ( struct V_31 * V_87 )
{
struct V_109 * V_110 ;
F_137 () ;
V_133 = NULL ;
...
static T_1 F_145 ( T_1 V_8 )
{
T_1 V_230 , V_231 ;
F_146 ( F_147 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 ,
V_236 ) ;
F_148 ( V_8 , V_232 . V_233 -> V_234 . V_235 + 4 ) ;
V_230 = F_147 ( V_232 . V_233 -> V_234 . V_235 + 4 ) ;
V_231 = F_147 ( V_232 . V_233 -> V_234 . V_235 ) ;
F_13 ( L_95 , V_8 , ( V_231 << 8 ) | V_230 ) ;
return V_231 ;
}
static T_1 F_149 ( T_1 V_8 , T_1 V_237 )
{
T_1 V_230 ;
F_146 ( F_147 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 ,
V_236 ) ;
...
F_146 ( F_147 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 ,
V_236 ) ;
F_148 ( V_237 , V_232 . V_233 -> V_234 . V_235 ) ;
V_230 = F_147 ( V_232 . V_233 -> V_234 . V_235 ) ;
F_13 ( L_96 , V_8 , V_237 , V_230 ) ;
return V_230 ;
}
static T_1 F_150 ( T_1 V_8 , T_1 V_237 , T_1 V_80 )
{
T_1 V_230 ;
F_146 ( F_147 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 , V_236 ) ;
F_148 ( V_8 , V_232 . V_233 -> V_234 . V_235 + 4 ) ;
F_146 ( F_147 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 , V_236 ) ;
F_148 ( V_237 , V_232 . V_233 -> V_234 . V_235 ) ;
F_146 ( F_147 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 , V_236 ) ;
F_148 ( V_80 , V_232 . V_233 -> V_234 . V_235 ) ;
V_230 = F_147 ( V_232 . V_233 -> V_234 . V_235 ) ;
F_13 ( L_97 ,
V_8 , V_237 , V_80 , V_230 ) ;
return V_230 ;
}
static int F_151 ( const T_1 V_238 , const T_1 V_239 )
{
if ( V_238 == 0x31 ) {
...
static void F_152 ( struct V_240 * V_8 )
{
struct V_241 * V_242 ;
V_242 = F_153 ( V_243 ,
V_244 , NULL ) ;
...
for ( V_270 = 0 ; V_270 < 100 && F_149 ( 0x91 , 0x1 ) ; V_270 ++ )
F_158 ( 10 ) ;
F_145 ( 0x93 ) ;
...
F_146 ( F_150 ( 0x90 , V_271 ,
0x5a ) ,
V_267 ) ;
V_232 . V_268 = 1 ;
return 0 ;
}
int F_159 ( int V_272 , T_1 V_67 )
{
if ( ! V_264 )
return - V_112 ;
F_160 ( & V_232 . V_273 ) ;
...
break;
case V_275 :
F_146 ( F_150 ( 0x90 , V_276 , V_67 ) ,
V_267 ) ;
break;
case V_277 :
F_146 ( F_150 ( 0x90 , V_278 , V_67 ) ,
V_267 ) ;
break;
case V_279 :
F_146 ( F_150 ( 0x90 , V_280 , V_67 ) ,
V_267 ) ;
break;
case V_281 :
F_146 ( F_150 ( 0x90 , V_282 , V_67 ) ,
V_267 ) ;
break;
case V_283 :
F_146 ( F_150 ( 0x90 , V_284 , V_67 ) ,
V_267 ) ;
break;
case V_285 :
F_146 ( F_150 ( 0x90 , V_265 , V_67 ) ,
V_267 ) ;
break;
case V_286 :
F_146 ( F_150 ( 0x90 , V_287 , V_67 ) ,
V_267 ) ;
break;
default:
F_20 ( L_101 , V_272 ) ;
...
static T_6 F_163 ( struct V_87 * V_8 ,
struct V_88 * V_89 ,
const char * V_82 , T_5 V_77 )
{
unsigned long V_67 ;
...
static T_6 F_166 ( struct V_87 * V_8 ,
struct V_88 * V_89 ,
const char * V_82 , T_5 V_77 )
{
unsigned long V_67 ;
...
static int F_168 ( unsigned long V_67 )
{
return F_169 ( V_291 , V_67 ) ;
}
static int F_170 ( T_1 * V_67 )
{
return F_171 ( V_291 , V_67 ) ;
}
static T_6 F_172 ( struct V_87 * V_8 ,
struct V_88 * V_89 ,
const char * V_82 , T_5 V_77 )
{
unsigned long V_67 ;
...
static int F_174 ( int V_292 , struct V_293 * V_294 , int V_295 )
{
return F_175 ( V_292 , V_294 , V_295 , & V_296 . V_297 ) ;
}
static int F_176 ( struct V_298 * V_298 , struct V_293 * V_293 )
{
F_30 ( & V_296 . V_299 ) ;
return 0 ;
}
...
unsigned long V_4 ;
F_2 ( & V_296 . V_6 , V_4 ) ;
if ( F_178 ( & V_296 . V_299 ) == 1 )
F_179 ( & V_296 . V_7 ) ;
F_9 ( & V_296 . V_6 , V_4 ) ;
return 0 ;
}
static T_6 F_180 ( struct V_293 * V_293 , char T_8 * V_300 ,
T_5 V_77 , T_9 * V_196 )
{
T_6 V_57 ;
unsigned char V_301 ;
...
( V_293 -> V_302 & V_303 ) )
return - V_304 ;
V_57 = F_181 ( V_296 . V_305 ,
F_6 ( & V_296 . V_7 ) != 0 ) ;
if ( V_57 )
return V_57 ;
while ( V_57 < V_77 &&
( F_182 ( & V_296 . V_7 , & V_301 , sizeof( V_301 ) ,
& V_296 . V_6 ) == sizeof( V_301 ) ) ) {
if ( F_183 ( V_301 , V_300 ++ ) )
return - V_306 ;
V_57 ++ ;
}
if ( V_57 > 0 ) {
struct V_298 * V_298 = F_184 ( V_293 ) ;
V_298 -> V_307 = F_185 ( V_298 -> V_308 ) ;
}
return V_57 ;
}
static unsigned int F_186 ( struct V_293 * V_293 , T_10 * V_309 )
{
F_187 ( V_293 , & V_296 . V_305 , V_309 ) ;
if ( F_6 ( & V_296 . V_7 ) )
return V_310 | V_311 ;
return 0 ;
}
static int F_188 ( T_1 V_312 , T_11 * V_67 )
{
T_1 V_313 , V_314 ;
if ( F_171 ( V_312 , & V_313 ) )
return - 1 ;
if ( F_171 ( V_312 + 1 , & V_314 ) )
return - 1 ;
* V_67 = V_313 | ( V_314 << 8 ) ;
return 0 ;
}
static long F_189 ( struct V_293 * V_315 , unsigned int V_181 ,
unsigned long V_96 )
{
int V_57 = 0 ;
...
V_317 = ( ( V_67 & 0xff ) - 1 ) << 5 ;
if ( F_190 ( V_316 , & V_317 , sizeof( V_317 ) ) )
V_57 = - V_306 ;
break;
case V_320 :
if ( V_217 . V_8 == NULL ) {
...
if ( F_191 ( & V_317 , V_316 , sizeof( V_317 ) ) ) {
V_57 = - V_306 ;
break;
}
V_67 = ( V_317 >> 5 ) + 1 ;
...
break;
case V_321 :
if ( F_188 ( V_322 , & V_318 ) ) {
V_57 = - V_112 ;
break;
}
if ( F_190 ( V_316 , & V_318 , sizeof( V_318 ) ) )
V_57 = - V_306 ;
break;
case V_323 :
if ( F_188 ( V_324 , & V_318 ) ) {
V_57 = - V_112 ;
break;
}
if ( F_190 ( V_316 , & V_318 , sizeof( V_318 ) ) )
...
static void F_192 ( T_1 V_12 )
{
F_15 ( & V_296 . V_7 , ( unsigned char * ) & V_12 ,
sizeof( V_12 ) , & V_296 . V_6 ) ;
F_193 ( & V_296 . V_297 , V_337 , V_338 ) ;
F_194 ( & V_296 . V_305 ) ;
}
...
static int F_195 ( void ) { return 0 ; }
static void F_198 ( void ) { }
static void F_192 ( T_1 V_12 ) { }
static T_4
F_200 ( struct V_341 * V_342 , void * V_137 )
{
T_7 V_32 ;
...
struct V_344 * V_345 =
F_202 ( & V_8 -> V_348 , struct V_344 , V_347 ) ;
if ( ! V_363 ) {
F_13 ( L_106 ) ;
return V_142 ;
}
...
static int F_205 ( struct V_31 * V_87 )
{
T_4 V_57 = F_43 ( V_87 -> V_65 , L_117 , NULL ,
NULL ) ;
...
V_239 = F_147 ( V_8 -> V_233 -> V_234 . V_235 ) ;
if ( V_8 -> V_233 -> V_365 . V_235 )
V_238 = F_147 ( V_8 -> V_233 -> V_365 . V_235 ) ;
else
V_238 = F_147 ( V_8 -> V_233 -> V_234 . V_235 +
V_8 -> V_247 ) ;
F_13 ( L_120 ,
...
static int F_208 ( struct V_31 * V_87 )
{
...
F_209 ( V_232 . V_387 -> V_353 . V_357 [ 0 ] , & V_232 ) ;
F_210 ( V_232 . V_233 -> V_234 . V_235 ,
V_232 . V_233 -> V_234 . V_364 ) ;
if ( V_232 . V_233 -> V_365 . V_235 )
F_210 ( V_232 . V_233 -> V_365 . V_235 ,
V_232 . V_233 -> V_365 . V_364 ) ;
F_198 () ;
F_31 () ;
F_211 ( & V_61 -> V_8 . V_388 , & V_389 ) ;
F_40 () ;
F_212 (io, tmp_io, &spic_dev.ioports, list) {
F_213 ( & V_363 -> V_347 ) ;
F_47 ( V_363 ) ;
}
F_212 (irq, tmp_irq, &spic_dev.interrupts, list) {
F_213 ( & V_353 -> V_347 ) ;
F_47 ( V_353 ) ;
}
V_232 . V_233 = NULL ;
...
static int F_214 ( struct V_31 * V_87 )
{
int V_68 ;
struct V_344 * V_363 , * V_385 ;
struct V_354 * V_353 , * V_386 ;
F_71 ( L_85 , V_390 , V_222 ) ;
V_232 . V_391 = V_87 ;
strcpy ( F_140 ( V_87 ) , L_86 ) ;
F_152 ( & V_232 ) ;
F_215 ( & V_232 . V_273 ) ;
...
if ( V_68 )
goto V_393;
F_216 (io, &spic_dev.ioports, list) {
if ( F_217 ( V_363 -> V_234 . V_235 , V_363 -> V_234 . V_364 ,
L_124 ) ) {
F_13 ( L_125 ,
V_363 -> V_234 . V_235 , V_363 -> V_234 . V_394 ,
V_363 -> V_234 . V_364 ) ;
if ( V_363 -> V_365 . V_235 ) {
if ( F_217 ( V_363 -> V_365 . V_235 ,
V_363 -> V_365 . V_364 ,
L_124 ) ) {
F_13 ( L_126 ,
...
F_216 (irq, &spic_dev.interrupts, list) {
if ( ! F_218 ( V_353 -> V_353 . V_357 [ 0 ] , V_354 ,
0 , L_6 , & V_232 ) ) {
F_13 ( L_130
L_131 ,
V_353 -> V_353 . V_357 [ 0 ] ,
...
V_68 = F_206 ( V_87 , V_232 . V_233 , V_232 . V_387 ) ;
if ( V_68 ) {
F_20 ( L_133 ) ;
goto V_397;
}
...
if ( V_68 )
goto V_398;
V_68 = F_219 ( & V_61 -> V_8 . V_388 , & V_389 ) ;
if ( V_68 )
goto V_399;
return 0 ;
V_399:
...
static int F_220 ( struct V_87 * V_8 )
{
if ( F_205 ( F_221 ( V_8 ) ) )
return - V_372 ;
return 0 ;
}
static int F_222 ( struct V_87 * V_8 )
{
F_206 ( F_221 ( V_8 ) ,
