...
static long F_77 ( struct V_65 * V_65 , unsigned int V_115 ,
unsigned long V_116 , void T_2 * V_117 )
{
int V_20 ;
struct V_5 * V_6 = V_65 -> V_69 ;
struct V_108 V_109 ;
...
break;
case V_123 :
V_20 = F_78 ( V_116 , V_45 , V_124 ) ;
break;
case V_125 :
V_20 = F_78 ( V_116 , V_126 , V_127 ) ;
break;
case V_128 :
V_20 = F_78 ( V_116 , V_129 , V_130 ) ;
break;
case V_131 :
V_20 = F_78 ( V_116 , V_74 , V_132 ) ;
break;
case V_133 :
V_20 = F_78 ( V_116 , V_134 , V_135 ) ;
break;
case V_136 :
V_20 = F_78 ( V_116 , V_137 , V_138 ) ;
break;
case V_139 :
V_20 = F_78 ( V_116 , V_140 , V_141 ) ;
break;
case V_142 :
V_20 = F_78 ( V_116 , V_143 , V_144 ) ;
break;
case V_145 :
V_20 = F_78 ( V_116 , V_146 , V_147 ) ;
break;
case V_148 :
V_20 = F_78 ( V_116 , V_149 , V_150 ) ;
break;
case V_151 :
if ( V_6 -> V_22 == V_23 ) {
V_20 = - V_42 ;
...
break;
case V_152 :
V_20 = F_75 ( V_117 , & V_109 ) ;
if ( V_20 )
break;
V_120 = F_8 ( V_6 , V_109 . V_113 ) ;
if ( ! V_120 || V_120 -> V_3 != V_43 ||
! V_120 -> V_38 . V_44 . V_35 ) {
V_20 = - V_42 ;
break;
}
V_109 . V_20 = 0 ;
V_109 . V_35 = * V_120 -> V_38 . V_44 . V_35 ;
if ( V_120 -> V_38 . V_44 . V_36 )
V_109 . V_36 = * V_120 -> V_38 . V_44 . V_36 ;
else
memset ( & V_109 . V_36 , 0 , sizeof( struct V_34 ) ) ;
V_20 = F_73 ( V_117 , & V_109 ) ;
break;
case V_153 :
if ( F_76 ( & V_119 , V_117 , sizeof( V_119 ) ) ) {
V_20 = - V_96 ;
break;
}
V_120 = F_8 ( V_6 , V_119 . V_113 ) ;
if ( ! V_120 || V_120 -> V_3 != V_47 ) {
V_20 = - V_42 ;
break;
}
V_119 . V_20 = 0 ;
V_119 . V_33 = V_120 -> V_38 . V_33 ;
if ( F_74 ( V_117 , & V_119 , sizeof( V_119 ) ) ) {
V_20 = - V_96 ;
break;
}
break;
...
static long F_80 ( struct V_65 * V_65 , unsigned int V_115 , unsigned long V_116 )
{
return F_77 ( V_65 , V_115 , V_116 , ( void T_2 * ) V_116 ) ;
}
static long F_81 ( struct V_65 * V_65 ,
unsigned int V_115 , unsigned long V_116 )
{
return F_77 ( V_65 , V_115 , V_116 , F_82 ( V_116 ) ) ;
}
