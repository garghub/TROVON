...
F_8 ( V_6
L_143 ,
V_250 [ V_60 + V_238 ] . V_251 ,
V_250 [ V_60 + V_238 ] . V_67 ,
V_247 , V_248 ) ;
V_37 = V_38 ;
} else {
F_8 ( V_6
...
F_147 ( V_30 , NULL ) ;
if ( V_237 ) {
for ( V_60 = V_237 -> V_254 - 1 ; V_60 >= 0 ; V_60 -- )
F_132 ( V_237 -> V_252 [ V_60 ] ) ;
F_130 ( V_237 ) ;
}
}
