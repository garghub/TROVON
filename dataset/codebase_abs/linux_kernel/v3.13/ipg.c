...
static int F_118 ( struct V_265 * V_175 , const struct V_377 * V_378 )
{
...
if ( V_302 < 0 )
goto V_305;
F_120 ( L_73 , F_121 ( V_175 ) , V_380 [ V_6 ] ) ;
F_122 ( V_175 ) ;
V_302 = F_123 ( V_175 , F_124 ( 40 ) ) ;
if ( V_302 < 0 ) {
V_302 = F_123 ( V_175 , F_124 ( 32 ) ) ;
if ( V_302 < 0 ) {
F_125 ( L_74 , F_121 ( V_175 ) ) ;
goto V_381;
}
}
V_2 = F_126 ( sizeof( struct V_3 ) ) ;
if ( ! V_2 ) {
V_302 = - V_174 ;
goto V_381;
}
...
F_129 ( V_2 , & V_175 -> V_2 ) ;
F_130 ( V_2 , & V_388 ) ;
V_302 = F_131 ( V_175 , V_389 ) ;
if ( V_302 )
goto V_390;
V_5 = F_132 ( V_175 , 1 , F_133 ( V_175 , 1 ) ) ;
if ( ! V_5 ) {
F_125 ( L_75 , F_121 ( V_175 ) ) ;
V_302 = - V_391 ;
goto V_392;
}
V_4 -> V_5 = V_5 ;
