...
V_16 = F_33 ( & V_2 -> V_39 , V_20 ) ;
while ( V_16 > 0 ) {
V_25 = F_23 (unsigned int, count, sizeof(buffer)) ;
F_34 ( V_2 -> V_23 , & V_25 , V_38 ) ;
V_15 = F_35 ( & V_2 -> V_39 , V_38 , V_25 ) ;
if ( V_15 != V_25 )
break;
V_16 -= V_25 ;
}
...
V_15 = F_16 ( V_2 -> V_23 , & V_25 , V_2 -> V_43 + V_2 -> V_44 ) ;
if ( ! V_15 || ( V_15 == V_18 ) )
V_2 -> V_44 = ( V_2 -> V_44 + V_25 ) & ( V_45 - 1 ) ;
V_16 = F_39 ( V_2 -> V_46 , V_2 -> V_44 , V_45 ) ;
F_40 ( & V_2 -> V_42 , V_41 ) ;
} while ( V_16 && ! V_15 );
F_38 ( & V_2 -> V_42 , V_41 ) ;
if ( F_39 ( V_2 -> V_46 , V_2 -> V_44 , V_45 ) )
F_1 ( V_2 ) ;
else
F_3 ( V_2 ) ;
F_40 ( & V_2 -> V_42 , V_41 ) ;
}
static T_3 F_41 ( int V_37 , void * V_14 )
{
struct V_1 * V_2 = V_14 ;
F_37 ( V_2 ) ;
F_42 ( & V_2 -> V_39 ) ;
...
static int F_43 ( struct V_47 * V_48 , const unsigned char * V_24 ,
int V_16 )
{
...
while ( 1 ) {
F_38 ( & V_2 -> V_42 , V_41 ) ;
V_25 = F_44 ( V_2 -> V_46 , V_2 -> V_44 , V_45 ) ;
if ( V_16 < V_25 )
V_25 = V_16 ;
if ( V_25 ) {
...
static int F_45 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
struct V_1 * V_2 = & V_53 [ V_48 -> V_33 ] ;
if ( ! V_2 -> V_54 )
return - V_35 ;
return F_46 ( & V_2 -> V_39 , V_48 , V_52 ) ;
}
static void F_47 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
struct V_1 * V_2 = & V_53 [ V_48 -> V_33 ] ;
if ( V_2 -> V_54 )
F_48 ( & V_2 -> V_39 , V_48 , V_52 ) ;
}
...
int V_16 ;
F_38 ( & V_2 -> V_42 , V_41 ) ;
V_16 = F_50 ( V_2 -> V_46 , V_2 -> V_44 , V_45 ) ;
F_40 ( & V_2 -> V_42 , V_41 ) ;
return V_16 ;
}
...
static int F_56 ( struct V_56 * V_39 ,
struct V_47 * V_48 )
{
struct V_1 * V_2 = F_57 ( V_39 , struct V_1 , V_39 ) ;
int V_15 ;
V_48 -> V_49 = V_2 ;
V_15 = F_58 ( V_2 -> V_55 , F_32 , 0 , L_14 , V_2 ) ;
if ( V_15 < 0 ) {
F_59 ( V_2 -> V_54 , L_15 ,
V_2 -> V_55 , V_15 ) ;
return V_15 ;
...
V_2 -> V_3 = 1 ;
V_15 = F_58 ( V_2 -> V_4 , F_41 , 0 , L_14 , V_2 ) ;
if ( V_15 < 0 ) {
F_59 ( V_2 -> V_54 , L_16 ,
V_2 -> V_4 , V_15 ) ;
F_60 ( V_2 -> V_55 , V_2 ) ;
...
static void F_61 ( struct V_56 * V_39 )
{
struct V_1 * V_2 = F_57 ( V_39 , struct V_1 , V_39 ) ;
F_60 ( V_2 -> V_4 , V_2 ) ;
F_60 ( V_2 -> V_55 , V_2 ) ;
...
F_64 ( & V_2 -> V_39 ) ;
V_2 -> V_39 . V_60 = & V_61 ;
V_2 -> V_54 = F_65 ( & V_2 -> V_39 , V_34 , V_30 ,
& V_58 -> V_54 ) ;
if ( F_66 ( V_2 -> V_54 ) ) {
V_15 = F_67 ( V_2 -> V_54 ) ;
F_59 ( & V_58 -> V_54 , L_19 , V_15 ) ;
goto error;
}
F_68 ( & V_58 -> V_54 , V_2 ) ;
F_69 ( & V_58 -> V_54 , L_20 ,
...
if ( ! V_16 )
return - V_35 ;
V_53 = F_77 ( V_16 * sizeof( struct V_1 ) , V_62 ) ;
if ( ! V_53 )
return - V_63 ;
V_34 = F_78 ( V_16 ) ;
if ( ! V_34 ) {
