...
V_110 -> V_336 ) ;
if ( V_162 != 0 ) {
F_8 ( & V_355 -> V_2 , L_30 , V_162 ) ;
return V_162 ;
}
V_162 = F_71 ( V_110 -> V_337 , V_4 , & V_157 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_355 -> V_2 , L_43 , V_162 ) ;
goto V_364;
}
if ( V_157 != 0x8904 ) {
F_8 ( & V_355 -> V_2 , L_44 , V_157 ) ;
V_162 = - V_122 ;
goto V_364;
}
...
F_72 ( & V_355 -> V_2 , L_46 , V_157 + 'A' ) ;
V_162 = F_73 ( V_110 -> V_337 , V_4 , 0 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_355 -> V_2 , L_47 , V_162 ) ;
goto V_364;
}
