...
F_3 ( V_24 -> V_8 , V_28 , V_69 , V_24 -> V_68 ) ;
V_70 = V_24 -> V_68 & 0x0f ;
F_46 ( V_61 ) ;
return V_70 ;
}
...
F_20 ( & V_112 -> V_12 , L_31 , V_117 , V_9 ) ;
...
V_117 -> V_141 = 0x03 ;
F_3 ( V_8 , V_130 , V_142 , V_117 -> V_141 ) ;
V_117 -> V_143 = 0x0b ;
...
F_20 ( & V_112 -> V_12 , L_33 , V_45 , V_150 ) ;
return V_150 ;
}
...
V_9 = V_117 -> V_141 & ~ V_152 ;
V_117 -> V_141 = V_9 ;
F_3 ( V_8 , V_112 -> V_130 , V_142 , V_117 -> V_141 ) ;
}
...
F_20 ( & V_112 -> V_12 , L_33 , V_45 , V_153 ) ;
return V_153 ;
}
...
F_20 ( & V_112 -> V_12 , L_34 , V_149 ) ;
break;
}
}
if ( V_34 == NULL ) {
F_20 ( & V_112 -> V_12 , L_35 , V_45 ) ;
goto exit;
}
if ( V_34 -> V_106 == NULL ) {
V_34 -> V_106 = F_9 ( V_136 ,
...
V_156 = F_94 ( V_154 , V_136 ) ;
memcpy ( V_34 -> V_106 , V_157 , V_156 ) ;
F_95 ( & V_112 -> V_12 , V_45 , V_156 ,
V_34 -> V_106 ) ;
F_96 ( V_34 , V_8 -> V_12 ,
F_63 ( V_8 -> V_12 ,
V_112 -> V_158 ) ,
...
static void F_100 ( struct V_127 * V_128 )
{
struct V_111 * V_112 = V_128 -> V_148 ;
...
if ( F_98 ( V_128 ) ) {
unsigned char V_164 = F_101 ( V_128 ) ;
V_18 = F_92 ( V_128 , V_112 , & V_164 , 1 ) ;
if ( V_18 <= 0 )
return;
}
if ( V_128 -> V_160 . V_161 & V_162 ) {
...
V_166 = V_138 ;
F_3 ( V_8 , V_28 , V_166 , V_165 * 0x10 ) ;
F_3 ( V_8 , V_28 , V_145 , 0x03 ) ;
V_117 -> V_143 = 0x2b ;
F_3 ( V_8 , V_130 , V_144 , V_117 -> V_143 ) ;
V_117 -> V_141 = V_117 -> V_141 | V_168 ;
F_3 ( V_8 , V_130 , V_142 , V_117 -> V_141 ) ;
F_3 ( V_8 , V_130 , V_169 , 0x01 ) ;
F_3 ( V_8 , V_130 , V_170 , 0x00 ) ;
V_117 -> V_141 = V_117 -> V_141 & ~ V_168 ;
F_3 ( V_8 , V_130 , V_142 , V_117 -> V_141 ) ;
return 0 ;
}
static int F_103 ( struct V_111 * V_112 , int V_171 , int * V_172 )
{
int V_149 ;
T_1 V_173 ;
T_1 V_174 ;
T_1 V_175 ;
F_20 ( & V_112 -> V_12 , L_41 , V_45 , V_171 ) ;
for ( V_149 = 0 ; V_149 < F_104 ( V_176 ) ; V_149 ++ ) {
if ( V_176 [ V_149 ] . V_171 == V_171 ) {
* V_172 = V_176 [ V_149 ] . V_172 ;
return 0 ;
}
}
if ( V_171 > 75 && V_171 < 230400 ) {
V_173 = ( T_1 ) ( 230400L / V_171 ) ;
V_174 = ( T_1 ) ( 2304000L / V_171 ) ;
V_175 = ( T_1 ) ( V_174 - ( V_173 * 10 ) ) ;
if ( V_175 > 4 )
V_173 ++ ;
* V_172 = V_173 ;
F_20 ( & V_112 -> V_12 , L_42 , V_171 , V_173 ) ;
return 0 ;
}
F_20 ( & V_112 -> V_12 , L_43 ) ;
return - V_167 ;
}
...
V_8 = V_112 -> V_8 ;
V_177 = V_112 -> V_130 ;
F_20 ( & V_112 -> V_12 , L_44 , V_45 , V_171 ) ;
V_18 = F_103 ( V_112 , V_171 , & V_172 ) ;
if ( V_18 ) {
F_6 ( & V_112 -> V_12 , L_45 , V_45 ) ;
return V_18 ;
}
V_117 -> V_141 = V_117 -> V_141 | V_168 ;
F_3 ( V_8 , V_177 , V_142 , V_117 -> V_141 ) ;
F_3 ( V_8 , V_177 , V_169 , ( T_2 ) ( V_172 & 0xff ) ) ;
F_3 ( V_8 , V_177 , V_170 , ( T_2 ) ( ( V_172 & 0xff00 ) >> 8 ) ) ;
V_117 -> V_141 = V_117 -> V_141 & ~ V_168 ;
F_3 ( V_8 , V_177 , V_142 , V_117 -> V_141 ) ;
return V_18 ;
}
...
V_184 = 0x00 ;
V_183 = 0x00 ;
V_180 = V_128 -> V_160 . V_161 ;
V_181 = V_128 -> V_160 . V_186 ;
switch ( V_180 & V_187 ) {
case V_188 :
V_182 = V_189 ;
V_71 = 0x1f ;
...
if ( V_180 & V_196 ) {
V_183 = V_197 ;
F_20 ( & V_112 -> V_12 , L_46 , V_45 ) ;
} else {
V_183 = ( V_198 | V_197 ) ;
F_20 ( & V_112 -> V_12 , L_47 , V_45 ) ;
}
} else {
F_20 ( & V_112 -> V_12 , L_48 , V_45 ) ;
}
if ( V_180 & V_199 )
V_183 = V_183 | 0x20 ;
if ( V_180 & V_200 ) {
...
V_117 -> V_143 = V_147 ;
if ( V_180 & V_202 )
V_117 -> V_143 |= ( V_203 | V_163 ) ;
if ( V_180 & V_162 ) {
V_117 -> V_143 |= ( V_204 ) ;
if ( V_130 )
F_3 ( V_8 , V_28 , V_145 , 0x01 ) ;
else
F_3 ( V_8 , V_28 , V_145 , 0x02 ) ;
} else
V_117 -> V_143 &= ~ ( V_204 ) ;
F_3 ( V_8 , V_130 , V_144 , V_117 -> V_143 ) ;
V_165 = F_110 ( V_128 ) ;
if ( ! V_165 ) {
F_20 ( & V_112 -> V_12 , L_51 ) ;
V_165 = 9600 ;
}
if ( V_165 >= 230400 ) {
F_102 ( V_117 , V_165 ) ;
...
F_20 ( & V_112 -> V_12 , L_52 , V_45 , V_165 ) ;
V_18 = F_105 ( V_117 , V_165 ) ;
if ( V_180 & V_202 )
F_111 ( V_128 , V_165 , V_165 ) ;
F_3 ( V_8 , V_130 , V_139 , 0x0c ) ;
if ( V_112 -> V_114 -> V_18 != - V_115 ) {
V_18 = F_29 ( V_112 -> V_114 , V_51 ) ;
if ( V_18 )
F_20 ( & V_112 -> V_12 , L_53 , V_18 ) ;
}
}
static void F_112 ( struct V_127 * V_128 ,
struct V_111 * V_112 , struct V_178 * V_179 )
{
int V_18 ;
unsigned int V_180 ;
struct V_7 * V_8 ;
...
F_20 ( & V_112 -> V_12 , L_54 ) ;
V_180 = V_128 -> V_160 . V_161 ;
F_20 ( & V_112 -> V_12 , L_55 , V_45 ,
V_128 -> V_160 . V_161 , F_113 ( V_128 -> V_160 . V_186 ) ) ;
F_20 ( & V_112 -> V_12 , L_56 , V_45 ,
V_179 -> V_161 , F_113 ( V_179 -> V_186 ) ) ;
F_106 ( V_128 , V_117 , V_179 ) ;
if ( V_112 -> V_114 -> V_18 != - V_115 ) {
V_18 = F_29 ( V_112 -> V_114 , V_51 ) ;
if ( V_18 )
F_20 ( & V_112 -> V_12 , L_53 , V_18 ) ;
...
V_39 . V_239 = 5 * V_240 ;
V_39 . V_241 = 30 * V_240 ;
if ( F_115 ( V_231 , & V_39 , sizeof( * V_231 ) ) )
return - V_208 ;
return 0 ;
}
...
if ( V_117 == NULL )
return - V_59 ;
F_20 ( & V_112 -> V_12 , L_58 , V_45 , V_226 ) ;
switch ( V_226 ) {
case V_242 :
F_20 ( & V_112 -> V_12 , L_59 , V_45 ) ;
return F_114 ( V_128 , V_117 ,
( unsigned int T_6 * ) V_227 ) ;
case V_228 :
case V_229 :
F_20 ( & V_112 -> V_12 , L_60 , V_45 ) ;
return F_118 ( V_117 , V_226 ,
( unsigned int T_6 * ) V_227 ) ;
case V_243 :
F_20 ( & V_112 -> V_12 , L_61 , V_45 ) ;
return F_120 ( V_117 ,
...
static int F_131 ( struct V_111 * V_112 )
{
struct V_116 * V_117 ;
