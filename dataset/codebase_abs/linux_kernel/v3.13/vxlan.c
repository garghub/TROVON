...
if ( V_304 -> V_327 & V_328 &&
! ( V_304 -> V_327 & ( V_329 | V_330 ) ) ) {
struct V_45 * V_308 ;
F_198 ( V_304 ) ;
...
F_218 ( V_72 ) ;
F_117 ( V_159 , & V_46 -> V_362 ) ;
}
F_110 ( & V_32 -> V_158 ) ;
return 0 ;
}
static void F_219 ( struct V_45 * V_46 )
{
struct V_37 * V_100 ;
F_95 ( & V_46 -> V_143 ) ;
...
static void F_220 ( struct V_99 * V_72 )
{
struct V_45 * V_46 = F_51 ( V_72 ) ;
struct V_24 * V_25 = V_46 -> V_164 ;
F_219 ( V_46 ) ;
...
static int F_222 ( struct V_99 * V_72 )
{
struct V_31 * V_32 = F_20 ( F_44 ( V_72 ) , V_33 ) ;
struct V_45 * V_46 = F_51 ( V_72 ) ;
struct V_24 * V_25 = V_46 -> V_164 ;
...
static void F_223 ( struct V_45 * V_46 )
{
unsigned int V_148 ;
F_95 ( & V_46 -> V_143 ) ;
for ( V_148 = 0 ; V_148 < V_149 ; ++ V_148 ) {
...
static int F_224 ( struct V_99 * V_72 )
{
struct V_31 * V_32 = F_20 ( F_44 ( V_72 ) , V_33 ) ;
struct V_45 * V_46 = F_51 ( V_72 ) ;
struct V_24 * V_25 = V_46 -> V_164 ;
...
static void F_226 ( struct V_99 * V_72 )
{
}
void F_227 ( struct V_99 * V_72 )
{
struct V_24 * V_25 ;
...
static void F_228 ( struct V_99 * V_72 )
{
struct V_45 * V_46 = F_51 ( V_72 ) ;
unsigned int V_148 ;
int V_365 , V_366 ;
...
V_72 -> V_367 = V_368 + V_369 ;
else
V_72 -> V_367 = V_368 + V_370 ;
V_72 -> V_113 = & V_371 ;
V_72 -> V_261 = V_372 ;
F_231 ( V_72 , & V_373 ) ;
V_72 -> V_374 = 0 ;
V_72 -> V_196 |= V_375 ;
V_72 -> V_196 |= V_376 ;
V_72 -> V_196 |= V_377 | V_378 ;
V_72 -> V_196 |= V_197 ;
V_72 -> V_196 |= V_379 ;
V_72 -> V_380 = V_72 -> V_196 ;
V_72 -> V_196 |= V_381 | V_382 ;
V_72 -> V_383 |= V_377 | V_378 | V_197 ;
V_72 -> V_383 |= V_379 ;
V_72 -> V_383 |= V_381 | V_382 ;
V_72 -> V_384 &= ~ V_385 ;
V_72 -> V_384 |= V_386 ;
F_52 ( & V_46 -> V_40 ) ;
F_232 ( & V_46 -> V_143 ) ;
F_233 ( & V_46 -> V_163 , F_118 ) ;
F_233 ( & V_46 -> V_171 , F_122 ) ;
F_233 ( & V_46 -> V_362 , V_387 ) ;
F_234 ( & V_46 -> V_359 ) ;
V_46 -> V_359 . V_388 = F_207 ;
V_46 -> V_359 . V_266 = ( unsigned long ) V_46 ;
F_235 ( F_44 ( V_72 ) , & V_365 , & V_366 ) ;
V_46 -> V_262 = V_365 ;
V_46 -> V_263 = V_366 ;
V_46 -> V_81 = F_128 ( V_389 ) ;
V_46 -> V_72 = V_72 ;
for ( V_148 = 0 ; V_148 < V_149 ; ++ V_148 )
F_236 ( & V_46 -> V_108 [ V_148 ] ) ;
}
static int F_237 ( struct V_14 * V_135 [] , struct V_14 * V_266 [] )
{
if ( V_135 [ V_390 ] ) {
if ( F_11 ( V_135 [ V_390 ] ) != V_78 ) {
F_238 ( L_14 ) ;
return - V_138 ;
}
if ( ! F_239 ( F_240 ( V_135 [ V_390 ] ) ) ) {
F_238 ( L_15 ) ;
return - V_140 ;
}
}
...
return - V_138 ;
if ( V_266 [ V_391 ] ) {
V_93 V_26 = F_90 ( V_266 [ V_391 ] ) ;
if ( V_26 >= V_392 )
return - V_393 ;
}
if ( V_266 [ V_394 ] ) {
const struct V_395 * V_355
= F_240 ( V_266 [ V_394 ] ) ;
if ( F_21 ( V_355 -> V_366 ) < F_21 ( V_355 -> V_365 ) ) {
F_238 ( L_16 ,
F_21 ( V_355 -> V_365 ) , F_21 ( V_355 -> V_366 ) ) ;
return - V_138 ;
}
}
return 0 ;
}
static void F_241 ( struct V_99 * V_396 ,
struct V_397 * V_398 )
{
F_242 ( V_398 -> V_297 , V_399 , sizeof( V_398 -> V_297 ) ) ;
F_242 ( V_398 -> V_400 , L_17 , sizeof( V_398 -> V_400 ) ) ;
}
static void F_243 ( struct V_161 * V_162 )
{
struct V_24 * V_25 = F_81 ( V_162 , struct V_24 , V_160 ) ;
F_244 ( V_25 -> V_42 -> V_43 ) ;
F_100 ( V_25 , V_132 ) ;
}
static struct V_401 * F_245 ( struct V_29 * V_29 , T_2 V_30 )
{
struct V_42 * V_43 ;
struct V_401 * V_42 ;
struct V_402 V_1 = {
...
int V_120 , V_405 = 1 ;
V_120 = F_246 ( V_6 , V_406 , V_293 , & V_42 ) ;
if ( V_120 < 0 ) {
F_238 ( L_18 ) ;
return F_247 ( V_120 ) ;
}
V_43 = V_42 -> V_43 ;
F_248 ( V_43 , V_29 ) ;
F_249 ( V_42 , V_407 , V_408 ,
( char * ) & V_405 , sizeof( V_405 ) ) ;
V_120 = F_250 ( V_42 , (struct V_409 * ) & V_1 ,
sizeof( struct V_402 ) ) ;
if ( V_120 < 0 ) {
F_238 ( L_19 ,
...
static struct V_401 * F_252 ( struct V_29 * V_29 , T_2 V_30 )
{
struct V_42 * V_43 ;
struct V_401 * V_42 ;
struct V_412 V_1 = {
...
int V_120 ;
V_120 = F_246 ( V_18 , V_406 , V_293 , & V_42 ) ;
if ( V_120 < 0 ) {
F_238 ( L_20 ) ;
return F_247 ( V_120 ) ;
}
...
static struct V_24 * F_253 ( struct V_29 * V_29 , T_2 V_30 ,
...
F_236 ( & V_25 -> V_27 [ V_148 ] ) ;
F_233 ( & V_25 -> V_160 , F_243 ) ;
if ( V_415 )
V_42 = F_245 ( V_29 , V_30 ) ;
else
V_42 = F_252 ( V_29 , V_30 ) ;
if ( F_197 ( V_42 ) ) {
F_83 ( V_25 ) ;
return F_254 ( V_42 ) ;
}
...
struct V_24 * F_258 ( struct V_29 * V_29 , T_2 V_30 ,
T_12 * V_181 , void * V_266 ,
bool V_421 , bool V_415 )
{
struct V_31 * V_32 = F_20 ( V_29 , V_33 ) ;
struct V_24 * V_25 ;
V_25 = F_253 ( V_29 , V_30 , V_181 , V_266 , V_415 ) ;
if ( ! F_197 ( V_25 ) )
return V_25 ;
if ( V_421 )
return V_25 ;
...
static void V_387 ( struct V_161 * V_162 )
{
struct V_45 * V_46 = F_81 ( V_162 , struct V_45 , V_362 ) ;
struct V_29 * V_29 = F_44 ( V_46 -> V_72 ) ;
struct V_31 * V_32 = F_20 ( V_29 , V_33 ) ;
T_2 V_30 = V_46 -> V_81 ;
struct V_24 * V_423 ;
V_423 = F_258 ( V_29 , V_30 , F_130 , NULL , false , V_46 -> V_51 & V_424 ) ;
F_108 ( & V_32 -> V_158 ) ;
if ( ! F_197 ( V_423 ) )
F_212 ( V_423 , V_46 ) ;
F_110 ( & V_32 -> V_158 ) ;
...
static int F_259 ( struct V_29 * V_29 , struct V_99 * V_72 ,
...
#endif
if ( ! V_135 [ V_436 ] )
V_72 -> V_437 = V_431 -> V_437 - ( V_425 ? V_369 : V_370 ) ;
V_72 -> V_367 = V_431 -> V_367 +
( V_425 ? V_369 : V_370 ) ;
} else if ( V_425 )
V_46 -> V_51 |= V_424 ;
if ( V_266 [ V_438 ] )
V_46 -> V_200 = F_261 ( V_266 [ V_438 ] ) ;
if ( V_266 [ V_439 ] )
V_46 -> V_274 = F_261 ( V_266 [ V_439 ] ) ;
if ( ! V_266 [ V_440 ] || F_261 ( V_266 [ V_440 ] ) )
V_46 -> V_51 |= V_192 ;
if ( V_266 [ V_441 ] )
V_46 -> V_357 = F_90 ( V_266 [ V_441 ] ) ;
else
V_46 -> V_357 = V_442 ;
if ( V_266 [ V_443 ] && F_261 ( V_266 [ V_443 ] ) )
V_46 -> V_51 |= V_344 ;
if ( V_266 [ V_444 ] && F_261 ( V_266 [ V_444 ] ) )
V_46 -> V_51 |= V_347 ;
if ( V_266 [ V_445 ] && F_261 ( V_266 [ V_445 ] ) )
V_46 -> V_51 |= V_349 ;
if ( V_266 [ V_446 ] && F_261 ( V_266 [ V_446 ] ) )
V_46 -> V_51 |= V_239 ;
if ( V_266 [ V_447 ] )
...
const struct V_395 * V_355
= F_240 ( V_266 [ V_394 ] ) ;
V_46 -> V_262 = F_21 ( V_355 -> V_365 ) ;
V_46 -> V_263 = F_21 ( V_355 -> V_366 ) ;
}
if ( V_266 [ V_448 ] )
...
F_264 ( & V_46 -> V_40 , & V_32 -> V_450 ) ;
return 0 ;
}
static void F_265 ( struct V_99 * V_72 , struct V_451 * V_109 )
{
struct V_31 * V_32 = F_20 ( F_44 ( V_72 ) , V_33 ) ;
struct V_45 * V_46 = F_51 ( V_72 ) ;
F_108 ( & V_32 -> V_158 ) ;
...
static T_3 F_269 ( const struct V_99 * V_72 )
{
...
F_42 ( sizeof( V_93 ) ) +
F_42 ( sizeof( V_93 ) ) +
F_42 ( sizeof( struct V_395 ) ) +
F_42 ( sizeof( T_2 ) ) +
0 ;
}
static int F_270 ( struct V_20 * V_21 , const struct V_99 * V_72 )
{
const struct V_45 * V_46 = F_51 ( V_72 ) ;
const struct V_36 * V_272 = & V_46 -> V_47 ;
struct V_395 V_452 = {
. V_365 = F_128 ( V_46 -> V_262 ) ,
. V_366 = F_128 ( V_46 -> V_263 ) ,
} ;
if ( F_36 ( V_21 , V_391 , V_272 -> V_48 ) )
goto V_79;
if ( ! F_3 ( & V_272 -> V_66 ) ) {
...
if ( F_271 ( V_21 , V_439 , V_46 -> V_274 ) ||
F_271 ( V_21 , V_438 , V_46 -> V_200 ) ||
F_271 ( V_21 , V_440 ,
! ! ( V_46 -> V_51 & V_192 ) ) ||
F_271 ( V_21 , V_443 ,
! ! ( V_46 -> V_51 & V_344 ) ) ||
F_271 ( V_21 , V_444 , ! ! ( V_46 -> V_51 & V_347 ) ) ||
F_271 ( V_21 , V_445 ,
! ! ( V_46 -> V_51 & V_349 ) ) ||
F_271 ( V_21 , V_446 ,
! ! ( V_46 -> V_51 & V_239 ) ) ||
...
goto V_79;
if ( F_15 ( V_21 , V_394 , sizeof( V_452 ) , & V_452 ) )
goto V_79;
return 0 ;
V_79:
return - V_63 ;
}
static T_13 int F_272 ( struct V_29 * V_29 )
{
struct V_31 * V_32 = F_20 ( V_29 , V_33 ) ;
unsigned int V_148 ;
F_52 ( & V_32 -> V_450 ) ;
F_232 ( & V_32 -> V_158 ) ;
for ( V_148 = 0 ; V_148 < V_364 ; ++ V_148 )
F_236 ( & V_32 -> V_34 [ V_148 ] ) ;
return 0 ;
}
static T_14 void F_273 ( struct V_29 * V_29 )
{
struct V_31 * V_32 = F_20 ( V_29 , V_33 ) ;
struct V_45 * V_46 ;
F_274 ( V_41 ) ;
F_275 () ;
F_64 (vxlan, &vn->vxlan_list, next)
F_268 ( V_46 -> V_72 , & V_41 ) ;
F_276 ( & V_41 ) ;
F_277 () ;
}
static int T_15 F_278 ( void )
{
int V_120 ;
V_159 = F_279 ( L_17 , 0 , 0 ) ;
if ( ! V_159 )
return - V_128 ;
F_280 ( & V_453 , sizeof( V_453 ) ) ;
V_120 = F_281 ( & V_454 ) ;
if ( V_120 )
goto V_455;
V_120 = F_282 ( & V_456 ) ;
