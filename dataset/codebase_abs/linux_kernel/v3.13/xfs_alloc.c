...
if ( args -> V_20 == 0 )
args -> V_20 = 1 ;
ASSERT ( F_128 ( V_69 , args -> V_257 ) < V_69 -> V_75 . V_258 ) ;
ASSERT ( F_129 ( V_69 , args -> V_257 ) < V_250 ) ;
ASSERT ( args -> V_21 <= args -> V_41 ) ;
ASSERT ( args -> V_21 <= V_250 ) ;
ASSERT ( args -> V_39 < args -> V_40 ) ;
if ( F_128 ( V_69 , args -> V_257 ) >= V_69 -> V_75 . V_258 ||
F_129 ( V_69 , args -> V_257 ) >= V_250 ||
...
case V_113 :
case V_114 :
args -> V_98 = F_128 ( V_69 , args -> V_257 ) ;
...
args -> V_46 = F_129 ( V_69 , args -> V_257 ) ;
if ( ( error = F_52 ( args ) ) )
goto V_125;
break;
case V_260 :
...
if ( type == V_266 )
args -> type = V_112 ;
args -> V_98 = V_251 = F_128 ( V_69 , args -> V_257 ) ;
V_52 = V_200 ;
}
for (; ; ) {
args -> V_106 = F_97 ( V_69 , args -> V_98 ) ;
...
args -> V_257 = F_133 ( V_69 , args -> V_98 , args -> V_46 ) ;
#ifdef F_21
ASSERT ( args -> V_4 >= args -> V_21 ) ;
ASSERT ( args -> V_4 <= args -> V_41 ) ;
ASSERT ( args -> V_46 % args -> V_20 == 0 ) ;
F_136 ( V_69 , F_137 ( V_69 , args -> V_257 ) ,
args -> V_4 ) ;
#endif
}
F_98 ( args -> V_106 ) ;
...
args . V_98 = F_128 ( args . V_69 , V_3 ) ;
if ( args . V_98 >= args . V_69 -> V_75 . V_258 )
return V_90 ;
args . V_46 = F_129 ( args . V_69 , V_3 ) ;
...
if ( ! error )
F_139 ( V_97 , args . V_98 , args . V_46 , V_4 , 0 ) ;
V_125:
F_98 ( args . V_106 ) ;
return error ;
}
