...
V_40 -> V_77 = V_70 -> V_78 ;
V_40 -> V_79 = F_34 ( V_70 ) ;
if ( ! F_35 ( V_40 -> V_77 , V_40 -> V_79 , V_80 ) ) {
F_36 ( L_15 ) ;
V_38 = - V_81 ;
goto V_76;
}
V_40 -> V_82 = F_37 ( V_40 -> V_77 , V_40 -> V_79 ) ;
if ( ! V_40 -> V_82 ) {
F_36 ( L_16 ) ;
V_38 = - V_60 ;
goto V_83;
...
void F_45 ( struct V_39 * V_40 , struct V_51 * V_52 )
{
...
if ( F_48 () )
return - V_72 ;
return F_26 ( & V_87 , V_52 ) ;
}
static int F_49 ( struct V_51 * V_52 )
{
struct V_39 * V_40 = F_50 ( V_52 ) ;
F_45 ( V_40 , V_52 ) ;
return 0 ;
}
...
struct V_39 * V_40 = F_10 ( V_37 ) ;
struct V_1 * V_2 = F_38 ( V_40 ) ;
struct V_67 * V_68 = F_39 ( V_40 ) ;
bool V_88 = F_52 ( V_37 ) ;
int V_58 ;
if ( F_53 ( V_89 , V_68 -> V_90 ) )
F_54 ( 5 ) ;
V_68 -> V_90 = V_89 ;
V_58 = F_55 ( V_40 , V_88 ) ;
if ( V_58 )
