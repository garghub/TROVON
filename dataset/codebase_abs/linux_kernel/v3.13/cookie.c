...
void F_62 ( struct V_2 * V_3 , bool V_94 )
{
F_7 ( & V_95 ) ;
if ( V_94 )
F_7 ( & V_96 ) ;
...
if ( F_31 ( & V_3 -> V_6 ) )
return 0 ;
V_100 = F_67 ( sizeof( * V_100 ) , V_103 | V_104 | V_105 ) ;
if ( ! V_100 )
return - V_106 ;
F_68 ( V_100 , NULL , NULL ) ;
V_100 -> V_23 = V_107 |
( 1 << V_108 ) |
( 1 << V_109 ) ;
F_30 ( & V_3 -> V_4 ) ;
...
V_41 = F_33 ( V_3 -> V_6 . V_55 ,
struct V_40 , V_56 ) ;
if ( F_20 ( V_111 , & V_41 -> V_43 -> V_23 ) )
goto V_110;
V_100 -> V_66 = F_41 ( & V_112 ) ;
F_69 ( V_3 ) ;
if ( F_70 ( V_41 , V_100 ) < 0 )
goto V_113;
F_32 ( & V_3 -> V_4 ) ;
V_45 = F_71 ( V_41 , V_100 ,
NULL , NULL , NULL ) ;
if ( V_45 == 0 ) {
V_45 = V_41 -> V_43 -> V_62 -> V_114 ( V_100 ) ;
F_72 ( V_100 , false ) ;
} else if ( V_45 == - V_59 ) {
V_45 = 0 ;
}
