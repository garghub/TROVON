...
{
return ( V_12 && F_36 ( V_41 ) ) ? V_43 -> V_44 : 0 ;
}
...
static inline unsigned short F_48 ( unsigned short V_37 )
{
unsigned int V_61 ;
V_61 = ~ V_37 ;
...
static inline T_2 F_49 ( struct V_14 * V_32 )
{
struct V_62 * V_63 ;
...
F_51 ( & V_74 , V_41 ) ;
V_39 = F_45 ( & V_45 , & V_46 , & V_47 , & V_48 , & V_74 , 0 , - 1 ) ;
if ( ! V_39 )
F_55 ( V_41 , & V_74 ) ;
if ( V_51 )
...
int F_61 ( struct V_3 * V_4 , struct V_90 * V_29 )
{
struct V_5 * V_8 = V_1 ;
int V_91 ;
V_91 = ! ! F_62 () ;
