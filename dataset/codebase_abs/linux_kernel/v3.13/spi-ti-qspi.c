...
struct V_51 * V_8 ;
struct V_83 * V_84 ;
struct V_85 * V_86 = V_82 -> V_17 . V_87 ;
T_1 V_88 ;
int V_12 = 0 , V_89 , V_69 ;
V_8 = F_40 ( & V_82 -> V_17 , sizeof( * V_2 ) ) ;
if ( ! V_8 )
return - V_90 ;
V_8 -> V_91 = V_59 | V_57 | V_92 | V_93 ;
V_8 -> V_94 = - 1 ;
V_8 -> V_95 = V_96 ;
V_8 -> V_97 = F_5 ;
V_8 -> V_98 = true ;
V_8 -> V_99 = F_23 ;
V_8 -> V_17 . V_87 = V_82 -> V_17 . V_87 ;
V_8 -> V_100 = F_41 ( 32 - 1 ) | F_41 ( 16 - 1 ) | F_41 ( 8 - 1 ) ;
if ( ! F_42 ( V_86 , L_18 , & V_89 ) )
V_8 -> V_101 = V_89 ;
V_2 = F_6 ( V_8 ) ;
V_2 -> V_8 = V_8 ;
V_2 -> V_17 = & V_82 -> V_17 ;
F_43 ( V_82 , V_2 ) ;
V_84 = F_44 ( V_82 , V_102 , 0 ) ;
V_69 = F_45 ( V_82 , 0 ) ;
if ( V_69 < 0 ) {
F_8 ( & V_82 -> V_17 , L_19 ) ;
return V_69 ;
...
F_46 ( & V_2 -> V_66 ) ;
V_2 -> V_4 = F_47 ( & V_82 -> V_17 , V_84 ) ;
if ( F_48 ( V_2 -> V_4 ) ) {
V_12 = F_49 ( V_2 -> V_4 ) ;
goto V_103;
}
V_12 = F_50 ( & V_82 -> V_17 , V_69 , F_35 , 0 ,
F_51 ( & V_82 -> V_17 ) , V_2 ) ;
if ( V_12 < 0 ) {
F_8 ( & V_82 -> V_17 , L_20 ,
V_69 ) ;
...
V_2 -> V_21 = F_52 ( & V_82 -> V_17 , L_21 ) ;
if ( F_48 ( V_2 -> V_21 ) ) {
V_12 = F_49 ( V_2 -> V_21 ) ;
F_8 ( & V_82 -> V_17 , L_22 , V_12 ) ;
}
F_53 ( & V_2 -> V_39 ) ;
F_54 ( & V_82 -> V_17 ) ;
F_55 ( & V_82 -> V_17 , V_104 ) ;
F_56 ( & V_82 -> V_17 ) ;
if ( ! F_42 ( V_86 , L_23 , & V_88 ) )
V_2 -> V_19 = V_88 ;
V_12 = F_57 ( & V_82 -> V_17 , V_8 ) ;
if ( V_12 )
goto V_103;
return 0 ;
V_103:
