...
int F_32 ( struct V_8 * V_9 , struct V_2 * V_3 ,
T_3 V_12 , T_2 * V_49 )
{
struct V_1 * V_50 ;
struct V_46 * V_5 ;
...
return - V_14 ;
V_5 -> V_48 = V_48 ;
V_5 -> V_34 = F_39 ( V_58 , sizeof( struct V_29 * ) ) ;
if ( V_5 -> V_34 == NULL ) {
F_40 ( L_1 , V_58 ) ;
return - V_14 ;
}
F_41 ( V_48 , V_5 -> V_34 , NULL , V_58 ) ;
* V_57 = V_5 ;
return 0 ;
}
struct V_46 * F_42 ( struct V_2 * V_3 ,
struct V_59 * V_59 )
{
struct V_60 * V_61 ;
struct V_56 * V_48 ;
...
V_11 = F_38 ( V_3 , V_59 -> V_4 , V_48 , & V_62 ) ;
if ( V_11 ) {
goto V_65;
}
V_62 -> V_7 . V_41 = V_61 ;
