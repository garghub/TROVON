...
{
char * V_40 ;
V_40 = F_12 ( V_128 + 1 , V_48 ) ;
if ( V_40 == NULL )
return - V_129 ;
if ( F_93 ( V_40 , V_127 , V_128 ) ) {
V_128 = - V_130 ;
goto V_46;
}
V_40 [ V_128 ] = '\0' ;
F_90 ( V_123 , V_131 , V_40 , V_128 ) ;
V_46:
F_9 ( V_40 ) ;
return V_128 ;
}
...
if ( V_123 == NULL )
return 0 ;
V_133 = F_95 ( L_42 , 0200 , NULL , & V_134 ) ;
if ( V_133 == NULL ) {
F_21 ( V_125 L_49 ) ;
return 0 ;
}
...
{
if ( ! strncmp ( V_67 , V_136 , strlen ( V_136 ) ) ) {
V_67 += strlen ( V_136 ) ;
V_123 = V_67 ;
}
...
static int F_99 ( struct V_1 * V_137 , unsigned long V_138 ,
void * V_34 )
{
char * V_139 = V_34 ;
if ( V_123 == NULL )
return 0 ;
F_90 ( V_123 , V_140 , V_139 ,
strlen ( V_139 ) + 1 ) ;
return 0 ;
}
