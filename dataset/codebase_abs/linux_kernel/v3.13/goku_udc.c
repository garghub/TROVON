...
static int F_100 ( struct V_227 * V_228 , const struct V_233 * V_234 )
{
...
int V_131 ;
if ( ! V_228 -> V_210 ) {
F_101 ( V_238 L_120 , F_102 ( V_228 ) ) ;
V_131 = - V_62 ;
goto V_239;
}
V_10 = F_21 ( sizeof *V_10 , V_240 ) ;
if ( V_10 == NULL ) {
F_103 ( L_121 , F_102 ( V_228 ) ) ;
V_131 = - V_241 ;
goto V_239;
}
F_104 ( & V_10 -> V_38 ) ;
...
V_235 = F_97 ( V_228 , 0 ) ;
V_236 = F_98 ( V_228 , 0 ) ;
if ( ! F_106 ( V_235 , V_236 , V_244 ) ) {
F_12 ( V_10 , L_123 ) ;
V_131 = - V_30 ;
goto V_239;
}
V_10 -> V_231 = 1 ;
V_237 = F_107 ( V_235 , V_236 ) ;
if ( V_237 == NULL ) {
F_12 ( V_10 , L_124 ) ;
V_131 = - V_245 ;
goto V_239;
