...
if ( F_36 ( & V_2 -> V_24 ) )
return V_75 ;
V_14 = F_37 ( V_2 -> V_24 . V_79 , struct V_13 , V_35 ) ;
V_28 = V_14 -> V_39 -> V_28 ;
V_74 = F_38 ( V_2 -> V_3 + V_80 , V_81 ) ;
if ( ! V_74 )
goto V_82;
F_39 ( V_74 , V_2 -> V_4 + V_80 ) ;
F_33 ( V_74 , V_28 ) ;
if ( ! F_40 ( V_72 ) ) {
...
F_46 ( V_74 ) ;
V_73 -> V_86 = F_47 ( V_2 -> V_22 ) ;
V_73 -> V_87 = F_47 ( V_2 -> V_23 ) ;
...
V_73 -> V_88 = F_56 ( V_74 , 0 ) ;
} else {
V_74 -> V_103 = V_104 ;
V_74 -> V_105 = ( F_57 ( V_74 ) -
V_74 -> V_106 ) ;
V_74 -> V_107 = F_58 ( struct V_33 , V_88 ) ;
}
}
(* V_72 -> V_108 -> V_12 )( V_74 -> V_28 ) ;
if ( V_17 ) {
V_17 -> V_66 . V_109 ++ ;
if ( V_17 -> V_53 . V_110 != V_72 )
V_17 -> V_53 . V_110 = V_72 ;
}
if ( V_7 ) {
struct V_47 * V_48 ;
unsigned long V_111 ;
if ( F_59 ( V_17 , V_112 ) &&
V_17 -> V_113 [ V_114 ] ) {
V_48 = & V_17 -> V_49 [ V_114 ] ;
V_111 = V_17 -> V_113 [ V_114 ] ;
if ( ! F_60 ( V_48 , V_63 + V_111 ) )
F_61 ( V_17 ) ;
}
}
F_3 ( L_10 , V_74 -> V_92 ) ;
V_74 -> V_115 = V_2 -> V_9 ;
(* V_72 -> V_108 -> V_116 )( V_74 , V_72 ) ;
V_56:
F_1 ( V_2 ) ;
return V_75 ;
V_85:
F_62 ( V_74 ) ;
F_63 ( F_64 ( V_17 -> V_27 . V_28 ) , V_117 ) ;
V_75:
F_11 (chunk, tmp, &packet->chunk_list, list) {
F_12 ( & V_14 -> V_35 ) ;
if ( ! F_20 ( V_14 ) )
...
V_120 && F_59 ( V_17 , V_112 ) ) {
unsigned int V_130 = V_16 -> V_131 - V_2 -> V_4 ;
unsigned int V_92 = V_14 -> V_39 -> V_92 + V_123 -> V_132 ;
if ( ( V_92 < V_130 ) && V_14 -> V_133 -> V_134 ) {
V_37 = V_43 ;
goto V_60;
}
}
