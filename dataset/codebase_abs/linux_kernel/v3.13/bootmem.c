...
{
struct V_28 * V_28 ;
unsigned long * V_29 , V_12 , V_13 , V_3 , V_30 = 0 ;
if ( ! V_6 -> V_15 )
return 0 ;
V_29 = V_6 -> V_15 ;
V_12 = V_6 -> V_8 ;
...
void * T_1 F_70 ( unsigned long V_25 , unsigned long V_61 ,
unsigned long V_62 )
{
return F_58 ( V_25 , V_61 , V_62 , V_83 ) ;
}
void * T_1 F_71 ( unsigned long V_25 ,
unsigned long V_61 ,
unsigned long V_62 )
{
...
void * T_1 F_72 ( T_3 * V_18 , unsigned long V_25 ,
unsigned long V_61 , unsigned long V_62 )
{
if ( F_53 ( F_54 () ) )
return F_64 ( V_25 , V_74 , V_18 -> V_80 ) ;
