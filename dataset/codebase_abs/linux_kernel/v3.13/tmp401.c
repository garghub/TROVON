...
if ( V_1 > 15 )
return - V_68 ;
F_36 ( V_63 -> type , V_82 [ V_14 ] . V_83 , V_84 ) ;
return 0 ;
}
static int F_37 ( struct V_6 * V_7 ,
const struct V_85 * V_86 )
{
const char * V_87 [] = { L_5 , L_6 , L_7 , L_8 } ;
struct V_23 * V_24 = & V_7 -> V_24 ;
struct V_23 * V_88 ;
struct V_8 * V_9 ;
int V_89 = 0 ;
V_9 = F_38 ( V_24 , sizeof( struct V_8 ) , V_90 ) ;
if ( ! V_9 )
return - V_91 ;
V_9 -> V_7 = V_7 ;
F_39 ( & V_9 -> V_27 ) ;
...
if ( V_9 -> V_14 == V_17 )
V_9 -> V_89 [ V_89 ++ ] = & V_95 ;
V_88 = F_40 ( V_24 , V_7 -> V_83 ,
V_9 , V_9 -> V_89 ) ;
if ( F_17 ( V_88 ) )
return F_18 ( V_88 ) ;
F_41 ( V_24 , L_9 , V_87 [ V_9 -> V_14 ] ) ;
return 0 ;
}
