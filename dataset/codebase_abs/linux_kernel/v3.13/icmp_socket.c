...
memcpy ( V_50 -> V_81 , V_44 -> V_74 -> V_75 , V_76 ) ;
F_36 ( V_46 , V_54 -> V_70 , V_54 -> V_82 ) ;
goto V_56;
V_68:
V_50 -> V_64 = V_83 ;
F_35 ( V_6 , V_50 , V_29 ) ;
...
static unsigned int F_41 ( struct V_3 * V_3 , T_5 * V_84 )
{
struct V_5 * V_6 = V_3 -> V_19 ;
