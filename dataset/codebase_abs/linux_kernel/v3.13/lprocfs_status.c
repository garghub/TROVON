...
{
struct V_180 * V_181 = V_44 -> V_182 ;
struct V_173 * V_183 ;
while ( ! F_83 ( & V_44 -> V_184 ) ) {
V_183 = F_84 ( V_44 -> V_184 . V_185 ,
struct V_173 , V_186 ) ;
F_85 ( & V_183 -> V_186 ) ;
F_86 ( V_181 , & V_183 -> V_118 , & V_183 -> V_187 ) ;
F_77 ( V_183 ) ;
}
}
...
static T_7 F_98 ( struct V_2 * V_2 ,
const char T_3 * V_201 ,
T_8 V_202 , T_9 * V_203 )
{
...
static void * F_99 ( struct V_28 * V_32 , T_9 * V_207 )
{
...
static void * F_101 ( struct V_28 * V_32 , void * V_208 , T_9 * V_207 )
{
( * V_207 ) ++ ;
...
F_103 ( & V_155 ) ;
V_27 = F_22 ( V_32 , L_64 ,
L_65 , V_155 . V_212 , ( unsigned long ) V_155 . V_213 ) ;
if ( V_27 < 0 )
return V_27 ;
}
...
if ( V_210 . V_85 == 0 )
goto V_26;
V_27 = F_22 ( V_32 , L_66 V_214 L_67 , V_209 -> V_215 ,
V_210 . V_85 , V_209 -> V_129 ) ;
if ( V_27 < 0 )
goto V_26;
if ( ( V_209 -> V_216 & V_217 ) && ( V_210 . V_85 > 0 ) ) {
V_27 = F_22 ( V_32 , L_68 V_214 L_68 V_214 L_68 V_214 ,
V_210 . V_86 , V_210 . V_92 , V_210 . V_91 ) ;
if ( V_27 < 0 )
goto V_26;
if ( V_209 -> V_216 & V_218 )
V_27 = F_22 ( V_32 , L_68 V_214 , V_210 . V_93 ) ;
if ( V_27 < 0 )
goto V_26;
}
V_27 = F_22 ( V_32 , L_4 ) ;
...
void F_108 ( struct V_74 * V_75 , int V_221 ,
unsigned V_222 , const char * V_5 , const char * V_223 )
{
struct V_81 * V_107 ;
struct V_77 * V_80 ;
unsigned long V_84 = 0 ;
...
unsigned int V_224 ;
F_17 ( V_75 != NULL ) ;
V_107 = & V_75 -> V_90 [ V_221 ] ;
F_79 ( V_107 != NULL , L_69 ,
V_221 , V_5 , V_223 ) ;
V_107 -> V_216 = V_222 ;
V_107 -> V_215 = V_5 ;
V_107 -> V_129 = V_223 ;
V_224 = F_48 ( V_75 , V_88 , & V_84 ) ;
for ( V_83 = 0 ; V_83 < V_224 ; ++ V_83 ) {
if ( V_75 -> V_89 [ V_83 ] == NULL )
continue;
V_80 = F_49 ( V_75 , V_83 , V_221 ) ;
V_80 -> V_85 = 0 ;
V_80 -> V_86 = V_87 ;
V_80 -> V_92 = 0 ;
V_80 -> V_93 = 0 ;
...
void F_109 ( int V_225 , struct V_74 * V_75 )
{
F_110 ( V_225 , V_75 , V_226 ) ;
F_110 ( V_225 , V_75 , V_227 ) ;
F_110 ( V_225 , V_75 , V_228 ) ;
F_110 ( V_225 , V_75 , V_229 ) ;
F_110 ( V_225 , V_75 , V_230 ) ;
F_110 ( V_225 , V_75 , V_231 ) ;
F_110 ( V_225 , V_75 , V_232 ) ;
F_110 ( V_225 , V_75 , V_233 ) ;
F_110 ( V_225 , V_75 , V_234 ) ;
F_110 ( V_225 , V_75 , V_235 ) ;
F_110 ( V_225 , V_75 , V_236 ) ;
F_110 ( V_225 , V_75 , V_237 ) ;
F_110 ( V_225 , V_75 , V_238 ) ;
for ( V_83 = V_225 ; V_83 < V_293 ; V_83 ++ ) {
F_79 ( V_75 -> V_90 [ V_83 ] . V_215 != NULL ,
L_70
L_71 , V_83 - V_225 ) ;
}
...
void F_113 ( int V_225 , struct V_74 * V_75 )
{
F_114 ( V_225 , V_75 , V_297 ) ;
F_114 ( V_225 , V_75 , V_298 ) ;
F_114 ( V_225 , V_75 , V_269 ) ;
F_114 ( V_225 , V_75 , V_299 ) ;
F_114 ( V_225 , V_75 , V_250 ) ;
F_114 ( V_225 , V_75 , V_300 ) ;
F_114 ( V_225 , V_75 , V_267 ) ;
F_114 ( V_225 , V_75 , V_255 ) ;
F_114 ( V_225 , V_75 , V_301 ) ;
F_114 ( V_225 , V_75 , V_302 ) ;
F_114 ( V_225 , V_75 , V_303 ) ;
F_114 ( V_225 , V_75 , rename ) ;
F_114 ( V_225 , V_75 , V_304 ) ;
F_114 ( V_225 , V_75 , V_253 ) ;
F_114 ( V_225 , V_75 , V_261 ) ;
F_114 ( V_225 , V_75 , V_305 ) ;
F_114 ( V_225 , V_75 , V_306 ) ;
F_114 ( V_225 , V_75 , V_307 ) ;
F_114 ( V_225 , V_75 , V_308 ) ;
F_114 ( V_225 , V_75 , V_309 ) ;
F_114 ( V_225 , V_75 , V_310 ) ;
F_114 ( V_225 , V_75 , V_311 ) ;
F_114 ( V_225 , V_75 , V_312 ) ;
F_114 ( V_225 , V_75 , V_313 ) ;
F_114 ( V_225 , V_75 , V_314 ) ;
F_114 ( V_225 , V_75 , V_315 ) ;
F_114 ( V_225 , V_75 , V_271 ) ;
F_114 ( V_225 , V_75 , V_316 ) ;
F_114 ( V_225 , V_75 , V_317 ) ;
F_114 ( V_225 , V_75 , V_318 ) ;
F_114 ( V_225 , V_75 , V_319 ) ;
F_114 ( V_225 , V_75 , V_320 ) ;
}
...
int F_120 ( struct V_180 * V_331 , struct V_332 * V_333 ,
struct V_334 * V_335 , void * V_6 )
{
struct V_336 * exp = F_121 ( V_331 , V_335 ) ;
...
int F_125 ( struct V_180 * V_331 , struct V_332 * V_333 ,
...
{
struct V_173 * V_183 = V_345 ;
F_78 ( V_346 , L_85 , F_28 ( & V_183 -> V_178 ) ) ;
if ( F_28 ( & V_183 -> V_178 ) == 1 ) {
F_56 ( & V_183 -> V_340 -> V_347 ) ;
F_131 ( & V_183 -> V_186 , V_6 ) ;
F_59 ( & V_183 -> V_340 -> V_347 ) ;
return 1 ;
}
if ( V_183 -> V_177 )
F_97 ( V_183 -> V_177 ) ;
...
int F_135 ( struct V_336 * exp , T_10 * V_118 , int * V_349 )
{
...
if ( V_350 -> V_176 != NULL )
F_14 ( & V_350 -> V_176 ) ;
F_86 ( V_44 -> V_182 , V_118 , & V_350 -> V_187 ) ;
V_354:
F_138 ( V_350 ) ;
F_81 ( V_350 ) ;
return V_27 ;
...
if ( V_223 )
V_360 = V_360 < 0 ? - V_223 : V_223 ;
V_371 *= V_360 ;
F_60 ( V_371 , V_372 ) ;
* V_41 = V_370 * V_360 + V_371 ;
return 0 ;
}
static char * F_150 ( const char * V_373 , const char * V_374 , T_8 V_202 )
{
T_8 V_375 ;
V_375 = strlen ( V_374 ) ;
if ( ! V_375 )
