...
F_66 () ;
F_40 ( V_21 ) ;
} while ( V_21 -> V_93 && ! F_67 ( V_94 ) );
F_68 ( V_96 ) ;
return ( V_21 -> V_93 == NULL ) ;
}
static int F_69 ( T_1 exp , enum V_54 type ,
struct V_73 T_5 * V_97 )
{
struct V_73 V_98 ;
T_1 V_99 ;
V_99 = F_22 ( exp , V_29 [ type ] . V_35 () ) ;
if ( V_99 . V_49 <= 0 )
return 0 ;
V_98 = F_53 ( V_99 ) ;
if ( F_70 ( V_97 , & V_98 , sizeof( * V_97 ) ) )
return - V_100 ;
return 1 ;
}
static long T_6 F_71 ( struct V_101 * V_31 )
{
enum V_54 type = V_31 -> V_102 . V_60 ;
T_1 exp ;
struct V_73 T_5 * V_97 ;
struct V_21 V_21 ;
int V_3 = 0 ;
exp . V_49 = V_31 -> V_102 . V_36 ;
F_56 ( & V_21 , type , F_61 ) ;
if ( F_63 ( & V_21 , exp ) )
goto V_103;
if ( F_72 ( V_94 ) )
F_33 ( exp , type ) ;
V_97 = V_31 -> V_102 . V_97 ;
if ( V_97 ) {
V_3 = F_69 ( exp , type , V_97 ) ;
if ( V_3 <= 0 )
goto V_103;
}
V_3 = - V_104 ;
...
struct V_73 * V_105 , struct V_73 T_5 * V_97 )
{
...
V_31 = & F_74 () -> V_101 ;
V_31 -> V_108 = F_71 ;
V_31 -> V_102 . V_60 = type ;
V_31 -> V_102 . V_36 = exp . V_49 ;
V_31 -> V_102 . V_97 = V_97 ;
V_3 = - V_104 ;
V_103:
return V_3 ;
}
