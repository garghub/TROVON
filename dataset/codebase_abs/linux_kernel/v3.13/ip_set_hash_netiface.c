...
struct V_17 V_51 = {
. V_22 = F_26 ( V_48 -> V_52 [ 0 ] . V_22 [ 0 ] , V_53 ) ,
. V_24 = 1 ,
} ;
struct V_54 V_55 = F_27 ( V_30 , V_46 , V_40 ) ;
int V_56 ;
if ( V_51 . V_22 == 0 )
return - V_57 ;
if ( V_44 == V_58 )
V_51 . V_22 = V_53 ;
F_28 ( V_30 , V_46 -> V_27 & V_59 , & V_51 . V_21 ) ;
V_51 . V_21 &= F_17 ( V_51 . V_22 ) ;
#define F_29 ( T_4 ) (par->dir ? par->dir->name : NULL)
#define F_30 ( T_4 ) (nf_bridge->dir ? nf_bridge->dir->name : NULL)
#define F_31 (opt->flags & IPSET_DIM_TWO_SRC)
if ( V_46 -> V_60 & V_32 ) {
#ifdef F_32
const struct V_61 * V_62 = V_30 -> V_62 ;
if ( ! V_62 )
return - V_57 ;
V_51 . V_11 = F_31 ? F_30 ( V_63 ) : F_30 ( V_64 ) ;
V_51 . V_23 = 1 ;
#else
V_51 . V_11 = NULL ;
#endif
} else
V_51 . V_11 = F_31 ? F_29 ( V_65 ) : F_29 ( V_66 ) ;
if ( ! V_51 . V_11 )
return - V_57 ;
...
static int
F_33 ( struct V_39 * V_40 , struct V_69 * V_70 [] ,
enum V_43 V_44 , T_1 * V_71 , T_1 V_27 , bool V_72 )
{
struct V_47 * V_48 = V_40 -> V_31 ;
T_3 V_49 = V_40 -> V_50 -> V_44 [ V_44 ] ;
struct V_17 V_51 = { . V_22 = V_53 , . V_24 = 1 } ;
struct V_54 V_55 = F_34 ( V_40 ) ;
T_1 V_21 = 0 , V_73 = 0 , V_74 ;
char V_11 [ V_75 ] ;
int V_56 ;
if ( F_35 ( ! V_70 [ V_33 ] ||
! V_70 [ V_35 ] ||
...
if ( V_70 [ V_80 ] )
* V_71 = F_37 ( V_70 [ V_80 ] ) ;
V_56 = F_38 ( V_70 [ V_33 ] , & V_21 ) ||
F_39 ( V_40 , V_70 , & V_55 ) ;
if ( V_56 )
return V_56 ;
if ( V_70 [ V_34 ] ) {
V_51 . V_22 = F_40 ( V_70 [ V_34 ] ) ;
if ( V_51 . V_22 > V_53 )
return - V_81 ;
}
strcpy ( V_11 , F_41 ( V_70 [ V_35 ] ) ) ;
V_51 . V_11 = V_11 ;
V_56 = F_5 ( & V_48 -> V_67 , & V_51 . V_11 ) ;
if ( V_44 == V_68 ) {
if ( ! V_56 ) {
...
V_51 . V_21 = F_23 ( V_21 & F_43 ( V_51 . V_22 ) ) ;
V_56 = V_49 ( V_40 , & V_51 , & V_55 , & V_55 , V_27 ) ;
return F_44 ( V_56 , V_27 , V_44 , V_40 ) ? - V_56 :
F_45 ( V_56 , V_27 ) ? 0 : V_56 ;
}
if ( V_70 [ V_83 ] ) {
V_56 = F_38 ( V_70 [ V_83 ] , & V_73 ) ;
if ( V_56 )
return V_56 ;
if ( V_73 < V_21 )
F_15 ( V_21 , V_73 ) ;
...
F_46 ( V_21 , V_73 , V_51 . V_22 ) ;
if ( V_72 )
V_21 = F_47 ( V_48 -> V_38 . V_21 ) ;
while ( ! F_48 ( V_21 , V_73 ) ) {
V_51 . V_21 = F_23 ( V_21 ) ;
V_74 = F_49 ( V_21 , V_73 , & V_51 . V_22 ) ;
V_56 = V_49 ( V_40 , & V_51 , & V_55 , & V_55 , V_27 ) ;
if ( V_56 && ! F_45 ( V_56 , V_27 ) )
return V_56 ;
else
V_56 = 0 ;
V_21 = V_74 + 1 ;
...
static inline bool
F_50 ( const struct V_86 * V_18 ,
const struct V_86 * V_19 ,
T_1 * V_20 )
{
return F_51 ( & V_18 -> V_21 . V_87 , & V_19 -> V_21 . V_87 ) &&
V_18 -> V_22 == V_19 -> V_22 &&
( ++ * V_20 ) &&
V_18 -> V_23 == V_19 -> V_23 &&
V_18 -> V_11 == V_19 -> V_11 ;
...
static inline int
F_52 ( const struct V_86 * V_24 )
{
return V_24 -> V_25 ? - V_26 : 1 ;
}
static inline void
F_53 ( struct V_86 * V_24 , T_1 V_27 )
{
V_24 -> V_25 = ( V_27 >> 16 ) & V_28 ;
}
static inline void
F_54 ( struct V_86 * V_24 , T_2 * V_27 )
{
F_15 ( * V_27 , V_24 -> V_25 ) ;
}
static inline void
F_55 ( struct V_86 * V_24 , T_2 V_22 )
{
F_56 ( & V_24 -> V_21 , V_22 ) ;
V_24 -> V_22 = V_22 ;
}
...
if ( V_31 -> V_25 )
V_27 |= V_28 ;
if ( F_58 ( V_30 , V_33 , & V_31 -> V_21 . V_87 ) ||
F_20 ( V_30 , V_34 , V_31 -> V_22 ) ||
F_21 ( V_30 , V_35 , V_31 -> V_11 ) ||
( V_27 &&
F_22 ( V_30 , V_36 , F_23 ( V_27 ) ) ) )
...
static inline void
F_59 ( struct V_17 * V_38 ,
const struct V_86 * V_12 )
{
}
static int
F_60 ( struct V_39 * V_40 , const struct V_29 * V_30 ,
const struct V_41 * V_42 ,
enum V_43 V_44 , struct V_45 * V_46 )
{
struct V_47 * V_48 = V_40 -> V_31 ;
...
if ( V_44 == V_58 )
V_51 . V_22 = V_53 ;
F_61 ( V_30 , V_46 -> V_27 & V_59 , & V_51 . V_21 . V_87 ) ;
F_56 ( & V_51 . V_21 , V_51 . V_22 ) ;
if ( V_46 -> V_60 & V_32 ) {
#ifdef F_32
const struct V_61 * V_62 = V_30 -> V_62 ;
if ( ! V_62 )
...
static int
F_62 ( struct V_39 * V_40 , struct V_69 * V_70 [] ,
enum V_43 V_44 , T_1 * V_71 , T_1 V_27 , bool V_72 )
{
struct V_47 * V_48 = V_40 -> V_31 ;
T_3 V_49 = V_40 -> V_50 -> V_44 [ V_44 ] ;
