...
void F_47 ( struct V_53 * V_50 )
{
struct V_83 * V_83 = F_48 ( V_50 ) ;
if ( ! V_83 )
return;
F_45 ( & V_83 ) ;
}
static inline T_5 F_49 ( struct V_83 * V_96 )
{
return F_50 ( & V_96 -> V_96 . V_99 ) ;
}
int
F_51 ( struct V_55 * V_89 ,
struct V_9 * V_10 ,
T_1 V_92 ,
T_6 * V_100 )
{
