...
static int
F_21 ( struct V_25 * V_26 , struct V_30 * V_31 )
{
int V_5 , V_37 ;
for ( V_37 = 0 ; V_37 < F_22 ( V_47 ) ; V_37 ++ ) {
V_5 = F_5 ( & V_26 -> V_7 , 0 ,
V_47 [ V_37 ] ,
V_48 [ V_37 ] ) ;
if ( V_5 ) {
...
for ( V_37 = 0 ; V_37 < F_22 ( V_49 ) ; V_37 ++ ) {
V_5 = F_16 (
...
{
struct V_27 * V_23 = F_24 ( & V_26 -> V_7 ) ;
