...
const struct V_62 * V_181 )
{
return F_10 ( & V_17 -> V_28 . V_30 , & V_181 -> V_71 ) ;
}
...
break;
case F_8 ( V_184 ) :
V_182 = F_100 ( V_56 , V_7 ) ;
break;
default:
V_182 = F_103 ( V_56 , V_7 ) ;
break;
}
if ( V_182 < 0 )
goto V_183;
...
static void F_25 ( struct V_5 * V_17 , int V_188 )
{
struct V_6 * V_7 = V_17 -> V_7 ;
struct V_35 * V_36 = & V_17 -> V_28 ;
struct V_130 * V_131 = & V_17 -> V_165 . V_166 . V_167 ;
int V_189 = sizeof( struct V_62 ) + 4 ;
if ( V_7 -> type != V_24 ) {
memcpy ( V_7 -> V_190 , & V_36 -> V_29 , sizeof( struct V_1 ) ) ;
memcpy ( V_7 -> V_191 , & V_36 -> V_30 , sizeof( struct V_1 ) ) ;
}
V_131 -> V_71 = V_36 -> V_29 ;
V_131 -> V_70 = V_36 -> V_30 ;
V_131 -> V_192 = V_36 -> V_13 ;
V_131 -> V_155 = 0 ;
if ( ! ( V_36 -> V_32 & V_170 ) )
V_131 -> V_155 |= V_173 & V_36 -> V_193 ;
if ( ! ( V_36 -> V_32 & V_179 ) )
V_131 -> V_155 |= V_180 & V_36 -> V_193 ;
...
V_17 -> V_143 = V_189 ;
if ( V_36 -> V_32 & V_194 ) {
int V_199 = ( F_107 ( & V_36 -> V_30 ) &
( V_200 | V_201 ) ) ;
struct V_202 * V_203 = F_108 ( F_5 ( V_7 ) ,
& V_36 -> V_30 , & V_36 -> V_29 ,
V_36 -> V_13 , V_199 ) ;
if ( V_203 == NULL )
return;
if ( V_203 -> V_137 . V_7 ) {
V_7 -> V_204 = V_203 -> V_137 . V_7 -> V_204 + V_189 ;
if ( V_188 ) {
V_7 -> V_75 = V_203 -> V_137 . V_7 -> V_75 - V_189 ;
if ( ! ( V_17 -> V_28 . V_32 & V_164 ) )
V_7 -> V_75 -= 8 ;
if ( V_7 -> V_75 < V_83 )
V_7 -> V_75 = V_83 ;
...
const struct V_35 * V_36 , int V_188 )
{
...
static void F_113 ( struct V_205 * V_166 ,
const struct V_35 * V_36 )
{
V_166 -> V_140 = V_206 ;
...
V_17 = NULL ;
if ( V_7 == V_20 -> V_34 ) {
if ( F_115 ( & V_36 , V_208 -> V_212 . V_213 , sizeof( V_36 ) ) ) {
V_91 = - V_214 ;
break;
}
F_112 ( & V_210 , & V_36 ) ;
...
if ( F_116 ( V_208 -> V_212 . V_213 , & V_36 , sizeof( V_36 ) ) )
V_91 = - V_214 ;
break;
case V_215 :
case V_216 :
V_91 = - V_217 ;
if ( ! F_117 ( V_12 -> V_218 , V_219 ) )
goto V_220;
V_91 = - V_214 ;
if ( F_115 ( & V_36 , V_208 -> V_212 . V_213 , sizeof( V_36 ) ) )
goto V_220;
...
static int F_121 ( struct V_6 * V_7 , int V_226 )
{
if ( V_226 < 68 ||
...
memcpy ( V_7 -> V_190 , & V_90 -> V_28 . V_29 , sizeof( struct V_1 ) ) ;
memcpy ( V_7 -> V_191 , & V_90 -> V_28 . V_30 , sizeof( struct V_1 ) ) ;
...
static void F_131 ( struct V_19 * V_20 ,
struct V_241 * V_242 )
{
int V_38 ;
...
while ( V_17 != NULL ) {
F_132 ( V_17 -> V_7 , V_242 ) ;
V_17 = F_18 ( V_17 -> V_41 ) ;
}
}
}
}
static int T_11 F_133 ( struct V_12 * V_12 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
int V_91 ;
...
static void T_12 F_135 ( struct V_12 * V_12 )
{
struct V_19 * V_20 ;
F_136 ( V_247 ) ;
V_20 = F_7 ( V_12 , V_21 ) ;
...
static int F_140 ( struct V_248 * V_249 [] , struct V_248 * V_64 [] )
{
T_3 V_32 ;
if ( ! V_64 )
return 0 ;
V_32 = 0 ;
if ( V_64 [ V_250 ] )
V_32 |= F_141 ( V_64 [ V_250 ] ) ;
if ( V_64 [ V_251 ] )
V_32 |= F_141 ( V_64 [ V_251 ] ) ;
if ( V_32 & ( V_69 | V_68 ) )
return - V_221 ;
return 0 ;
}
static int F_142 ( struct V_248 * V_249 [] , struct V_248 * V_64 [] )
{
struct V_1 V_70 ;
if ( V_249 [ V_252 ] ) {
if ( F_143 ( V_249 [ V_252 ] ) != V_253 )
return - V_221 ;
if ( ! F_144 ( F_145 ( V_249 [ V_252 ] ) ) )
return - V_254 ;
}
if ( ! V_64 )
goto V_255;
if ( V_64 [ V_256 ] ) {
F_146 ( & V_70 , V_64 [ V_256 ] , sizeof( struct V_1 ) ) ;
if ( F_14 ( & V_70 ) )
return - V_221 ;
}
V_255:
return F_140 ( V_249 , V_64 ) ;
}
static void F_147 ( struct V_248 * V_64 [] ,
struct V_35 * V_28 )
{
...
return;
if ( V_64 [ V_257 ] )
V_28 -> V_13 = F_148 ( V_64 [ V_257 ] ) ;
if ( V_64 [ V_250 ] )
V_28 -> V_106 = F_141 ( V_64 [ V_250 ] ) ;
if ( V_64 [ V_251 ] )
V_28 -> V_51 = F_141 ( V_64 [ V_251 ] ) ;
if ( V_64 [ V_258 ] )
V_28 -> V_31 = F_149 ( V_64 [ V_258 ] ) ;
if ( V_64 [ V_259 ] )
V_28 -> V_160 = F_149 ( V_64 [ V_259 ] ) ;
if ( V_64 [ V_260 ] )
F_146 ( & V_28 -> V_29 , V_64 [ V_260 ] , sizeof( struct V_1 ) ) ;
if ( V_64 [ V_256 ] )
F_146 ( & V_28 -> V_30 , V_64 [ V_256 ] , sizeof( struct V_1 ) ) ;
if ( V_64 [ V_261 ] )
V_28 -> V_156 = F_150 ( V_64 [ V_261 ] ) ;
if ( V_64 [ V_262 ] )
V_28 -> V_81 = F_150 ( V_64 [ V_262 ] ) ;
if ( V_64 [ V_263 ] )
V_28 -> V_193 = F_148 ( V_64 [ V_263 ] ) ;
if ( V_64 [ V_264 ] )
V_28 -> V_32 = F_148 ( V_64 [ V_264 ] ) ;
}
...
static int F_154 ( struct V_12 * V_267 , struct V_6 * V_7 ,
...
static int F_156 ( struct V_6 * V_7 , struct V_248 * V_249 [] ,
struct V_248 * V_64 [] )
{
struct V_5 * V_17 , * V_44 ;
struct V_12 * V_12 = F_5 ( V_7 ) ;
...
V_17 = V_44 ;
F_19 ( V_20 , V_17 ) ;
F_110 ( V_17 , & V_36 , ! V_249 [ V_268 ] ) ;
F_16 ( V_20 , V_17 ) ;
F_119 ( V_7 ) ;
}
return 0 ;
}
static T_13 F_157 ( const struct V_6 * V_7 )
{
return
F_158 ( 4 ) +
F_158 ( 2 ) +
...
static int F_159 ( struct V_55 * V_56 , const struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_160 ( V_56 , V_257 , V_36 -> V_13 ) ||
F_161 ( V_56 , V_250 , V_36 -> V_106 ) ||
F_161 ( V_56 , V_251 , V_36 -> V_51 ) ||
F_162 ( V_56 , V_258 , V_36 -> V_31 ) ||
F_162 ( V_56 , V_259 , V_36 -> V_160 ) ||
F_163 ( V_56 , V_260 , sizeof( struct V_1 ) , & V_36 -> V_29 ) ||
F_163 ( V_56 , V_256 , sizeof( struct V_1 ) , & V_36 -> V_30 ) ||
F_164 ( V_56 , V_261 , V_36 -> V_156 ) ||
F_164 ( V_56 , V_262 , V_36 -> V_81 ) ||
F_162 ( V_56 , V_263 , V_36 -> V_193 ) ||
F_160 ( V_56 , V_264 , V_36 -> V_32 ) )
goto V_269;
return 0 ;
V_269:
return - V_149 ;
