...
break;
case 1 : {
const struct V_139 * V_139 = F_62 () ;
if ( ! F_63 ( V_140 , V_141 ) ||
! F_64 ( V_139 -> V_142 , V_139 -> V_143 ) ||
! F_65 ( V_139 -> V_144 , V_139 -> V_145 ) )
V_56 = NULL ;
break;
}
case 2 :
...
case 'a' :
V_26 . V_31 |= V_32 | V_34 | V_36 ;
V_26 . V_38 = sizeof( V_146 ) * 2 + 2 ;
V_26 . V_3 = 16 ;
return F_15 ( V_9 , V_24 ,
( unsigned long long ) * ( ( V_146 * ) V_56 ) , V_26 ) ;
case 'd' :
return F_18 ( V_9 , V_24 , V_56 , V_26 , V_49 ) ;
case 'D' :
return F_18 ( V_9 , V_24 ,
( ( const struct V_147 * ) V_56 ) -> V_148 . V_47 ,
V_26 , V_49 ) ;
}
V_26 . V_31 |= V_34 ;
if ( V_26 . V_38 == - 1 ) {
...
static T_1
int F_66 ( const char * V_49 , struct V_25 * V_26 )
{
...
V_152:
V_26 -> V_152 = - 1 ;
if ( * V_49 == 'h' || F_67 ( * V_49 ) == 'l' ||
F_67 ( * V_49 ) == 'z' || * V_49 == 't' ) {
V_26 -> V_152 = * V_49 ++ ;
if ( F_68 ( V_26 -> V_152 == * V_49 ) ) {
if ( V_26 -> V_152 == 'l' ) {
V_26 -> V_152 = 'L' ;
++ V_49 ;
} else if ( V_26 -> V_152 == 'h' ) {
V_26 -> V_152 = 'H' ;
++ V_49 ;
}
}
...
if ( V_26 -> V_152 == 'L' )
V_26 -> type = V_160 ;
else if ( V_26 -> V_152 == 'l' ) {
if ( V_26 -> V_31 & V_37 )
V_26 -> type = V_161 ;
else
V_26 -> type = V_162 ;
} else if ( F_67 ( V_26 -> V_152 ) == 'z' ) {
V_26 -> type = V_163 ;
} else if ( V_26 -> V_152 == 't' ) {
V_26 -> type = V_164 ;
} else if ( V_26 -> V_152 == 'H' ) {
if ( V_26 -> V_31 & V_37 )
V_26 -> type = V_165 ;
...
while ( * V_49 ) {
const char * V_172 = V_49 ;
int V_173 = F_66 ( V_49 , & V_26 ) ;
V_49 += V_173 ;
switch ( V_26 . type ) {
case V_150 : {
int V_174 = V_173 ;
...
case V_155 :
V_171 = string ( V_171 , V_24 , va_arg ( args , char * ) , V_26 ) ;
break;
case V_156 :
V_171 = F_56 ( V_49 + 1 , V_171 , V_24 , va_arg ( args , void * ) ,
V_26 ) ;
while ( isalnum ( * V_49 ) )
V_49 ++ ;
break;
...
V_171 = F_15 ( V_171 , V_24 , V_20 , V_26 ) ;
}
}
if ( V_19 > 0 ) {
if ( V_171 < V_24 )
...
int F_71 ( char * V_9 , T_3 V_19 , const char * V_49 , T_6 args )
{
int V_8 ;
...
int F_73 ( char * V_9 , T_3 V_19 , const char * V_49 , ... )
{
T_6 args ;
int V_8 ;
va_start ( args , V_49 ) ;
V_8 = F_71 ( V_9 , V_19 , V_49 , args ) ;
va_end ( args ) ;
return V_8 ;
}
...
int F_74 ( T_7 * V_179 , T_3 V_19 , const char * V_49 , T_6 args )
{
struct V_25 V_26 = { 0 } ;
char * V_171 , * V_24 ;
V_171 = ( char * ) V_179 ;
...
break;
case V_157 : {
T_4 V_152 = V_26 . V_152 ;
void * V_175 ;
if ( V_152 == 'l' )
V_175 = va_arg ( args , long * ) ;
else if ( F_67 ( V_152 ) == 'z' )
V_175 = va_arg ( args , T_3 * ) ;
else
V_175 = va_arg ( args , int * ) ;
break;
}
default:
switch ( V_26 . type ) {
...
return ( T_7 * ) ( F_76 ( V_171 , sizeof( T_7 ) ) ) - V_179 ;
#undef F_75
}
int F_77 ( char * V_9 , T_3 V_19 , const char * V_49 , const T_7 * V_179 )
{
struct V_25 V_26 = { 0 } ;
char * V_171 , * V_24 ;
...
args += strlen ( V_181 ) + 1 ;
V_171 = string ( V_171 , V_24 , ( char * ) V_181 , V_26 ) ;
break;
}
case V_156 :
V_171 = F_56 ( V_49 + 1 , V_171 , V_24 , F_78 ( void * ) , V_26 ) ;
while ( isalnum ( * V_49 ) )
V_49 ++ ;
break;
case V_158 :
...
break;
case V_166 :
V_20 = F_78 (unsigned char) ;
break;
case V_165 :
V_20 = F_78 (signed char) ;
break;
case V_168 :
V_20 = F_78 (unsigned short) ;
break;
case V_167 :
V_20 = F_78 ( short ) ;
break;
case V_170 :
V_20 = F_78 (unsigned int) ;
break;
default:
V_20 = F_78 ( int ) ;
}
...
int F_79 ( T_7 * V_179 , T_3 V_19 , const char * V_49 , ... )
{
T_6 args ;
int V_182 ;
va_start ( args , V_49 ) ;
V_182 = F_74 ( V_179 , V_19 , V_49 , args ) ;
va_end ( args ) ;
return V_182 ;
}
int vsscanf ( const char * V_9 , const char * V_49 , T_6 args )
{
const char * V_171 = V_9 ;
char * V_183 ;
char V_184 ;
int V_20 = 0 ;
T_4 V_152 ;
...
V_38 = V_188 ;
V_171 = F_80 ( V_171 ) ;
while ( * V_171 && ! isspace ( * V_171 ) && V_38 -- )
* V_7 ++ = * V_171 ++ ;
* V_7 = '\0' ;
V_20 ++ ;
}
...
F_4 ( V_171 , & V_183 , V_3 ) :
F_1 ( V_171 , & V_183 , V_3 ) ;
if ( V_38 > 0 && V_183 - V_171 > V_38 ) {
if ( V_3 == 0 )
F_2 ( V_171 , & V_3 ) ;
while ( V_183 - V_171 > V_38 ) {
if ( V_187 )
V_186 . V_7 = F_81 ( V_186 . V_7 , V_3 ) ;
else
V_186 . V_185 = F_82 ( V_186 . V_185 , V_3 ) ;
-- V_183 ;
}
}
switch ( V_152 ) {
