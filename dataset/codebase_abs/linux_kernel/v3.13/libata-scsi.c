...
F_200 ( & V_10 -> V_24 ) ;
if ( V_10 -> V_361 )
for ( V_159 = 0 ; V_159 < V_484 ; V_159 ++ )
F_200 ( & V_10 -> V_361 [ V_159 ] ) ;
F_179 ( V_10 , 0 ) ;
F_196 ( & V_10 -> V_483 ) ;
F_97 ( L_33 ) ;
}
int F_208 ( struct V_7 * V_8 , unsigned int V_362 ,
...
if ( ! V_10 -> V_61 -> V_171 )
return - V_34 ;
if ( V_363 != V_485 && V_363 )
return - V_17 ;
if ( ! F_153 ( V_10 ) ) {
if ( V_362 != V_485 && V_362 )
return - V_17 ;
V_40 = V_89 ;
} else {
if ( V_89 != V_485 && V_89 )
...
if ( V_2 ) {
struct V_486 * V_487 = & V_2 -> V_24 -> V_48 ;
V_487 -> V_488 |= 1 << V_2 -> V_40 ;
V_487 -> V_84 |= V_85 ;
} else
V_29 = - V_17 ;
}
...
void F_209 ( struct V_479 * V_480 )
{
struct V_9 * V_10 =
F_206 ( V_480 , struct V_9 , V_490 ) ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
unsigned long V_13 ;
F_193 ( & V_10 -> V_483 ) ;
...
struct V_9 * F_211 ( struct V_447 * V_30 ,
struct V_491 * V_492 ,
struct V_7 * V_8 )
{
struct V_9 * V_10 ;
...
V_10 -> V_493 = 0 ;
V_10 -> V_18 = & V_30 -> V_18 ;
V_10 -> V_494 = V_492 -> V_494 ;
V_10 -> V_495 = V_492 -> V_495 ;
V_10 -> V_496 = V_492 -> V_496 ;
V_10 -> V_13 |= V_492 -> V_13 ;
V_10 -> V_61 = V_492 -> V_497 ;
V_10 -> V_498 = V_499 ;
return V_10 ;
}
...
{
int V_29 = V_10 -> V_61 -> V_501 ( V_10 ) ;
if ( V_29 )
return V_29 ;
V_10 -> V_176 = F_220 ( & V_502 ) ;
return 0 ;
}
void F_221 ( struct V_9 * V_10 )
{
if ( V_10 -> V_61 -> V_503 )
V_10 -> V_61 -> V_503 ( V_10 ) ;
F_43 ( V_10 ) ;
}
