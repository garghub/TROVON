...
V_200 -> V_202 = 0 ;
memset ( & V_200 -> V_203 , 0 , sizeof( V_200 -> V_203 ) ) ;
}
static int
F_59 ( struct V_1 * V_2 , struct V_199 * V_200 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_200 -> V_202 & ~ V_201 )
return - V_196 ;
if ( ! F_58 ( V_6 ) ) {
...
int V_204 , V_66 ;
struct V_24 V_205 ;
static const V_95 V_206 [ 2 ] = {
0x5a5a5a5a5a5a5a5aULL , 0xa5a5a5a5a5a5a5a5ULL
} ;
V_205 . V_33 = sizeof( struct V_207 ) ;
V_205 . V_35 = F_61 ( & V_6 -> V_16 -> V_37 , V_205 . V_33 ,
& V_205 . V_36 , V_208 ) ;
if ( ! V_205 . V_35 )
return - V_38 ;
for ( V_66 = 0 ; V_66 < 2 ; V_66 ++ ) {
V_204 = F_62 ( V_6 , V_206 [ V_66 ] ,
4096 , & V_205 ) ;
if ( V_204 != 0 )
goto V_209;
}
V_209:
F_63 ( & V_6 -> V_16 -> V_37 , V_205 . V_33 , V_205 . V_35 ,
V_205 . V_36 ) ;
return V_204 ;
}
static V_95 F_64 ( struct V_5 * V_6 , T_2 V_210 ,
V_95 * V_26 )
{
F_65 ( V_6 , V_6 -> V_186 ,
V_210 , 1 ) ;
...
static void
F_67 ( struct V_1 * V_2 , struct V_212 * V_213 , V_95 * V_71 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_26 ;
T_2 V_143 = 0 ;
...
static int
F_68 ( struct V_1 * V_2 , struct V_222 * V_223 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_69 ( V_6 , V_223 -> V_71 ) ;
}
static int
F_70 ( struct V_1 * V_2 )
{
...
static int
F_71 ( struct V_1 * V_2 , struct V_227 * V_228 ,
T_5 * V_71 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_24 V_229 ;
...
if ( F_16 ( V_6 ) ) {
if ( F_15 ( V_6 ) )
return F_7 ( V_6 , V_224 ,
V_228 -> V_46 , V_71 ) ;
else
return F_7 ( V_6 , V_225 ,
V_228 -> V_46 , V_71 ) ;
}
V_228 -> V_232 = V_233 | ( V_6 -> V_16 -> V_195 << 16 ) ;
memset ( & V_229 , 0 , sizeof( struct V_24 ) ) ;
V_229 . V_33 = sizeof( struct V_234 ) ;
V_229 . V_35 = F_61 ( & V_6 -> V_16 -> V_37 , V_229 . V_33 ,
& V_229 . V_36 , V_208 ) ;
if ( ! V_229 . V_35 )
return - V_38 ;
V_26 = F_72 ( V_6 , & V_229 ) ;
if ( ! V_26 ) {
V_231 = V_229 . V_35 ;
memcpy ( V_71 , V_231 -> V_235 + V_228 -> V_83 , V_228 -> V_46 ) ;
}
F_63 ( & V_6 -> V_16 -> V_37 , V_229 . V_33 , V_229 . V_35 ,
V_229 . V_36 ) ;
return V_26 ;
}
...
static void F_74 ( struct V_5 * V_6 , T_1 V_237 )
{
struct V_24 V_238 ;
struct V_239 * V_240 ;
int V_26 ;
int V_66 , V_77 ;
memset ( & V_238 , 0 , sizeof( struct V_24 ) ) ;
V_238 . V_33 = sizeof( struct V_241 ) ;
V_238 . V_35 = F_8 ( V_6 -> V_16 , V_238 . V_33 ,
& V_238 . V_36 ) ;
if ( ! V_238 . V_35 ) {
...
V_26 = F_75 ( V_6 , & V_238 ) ;
if ( ! V_26 ) {
V_240 = (struct V_239 * ) ( V_238 . V_35 +
sizeof( struct V_243 ) ) ;
for ( V_66 = 0 ; V_66 < F_76 ( V_240 -> V_244 ) ; V_66 ++ ) {
T_1 V_245 = F_76 ( V_240 -> V_246 [ V_66 ] . V_245 ) ;
for ( V_77 = 0 ; V_77 < V_245 ; V_77 ++ ) {
if ( V_240 -> V_246 [ V_66 ] . V_247 [ V_77 ] . V_248 ==
V_249 )
V_240 -> V_246 [ V_66 ] . V_247 [ V_77 ] . V_250 =
F_77 ( V_237 ) ;
}
}
V_26 = F_78 ( V_6 , & V_238 ,
...
F_12 ( V_6 -> V_16 , V_238 . V_33 , V_238 . V_35 ,
V_238 . V_36 ) ;
V_209:
return;
}
static void F_79 ( struct V_1 * V_2 , T_1 V_237 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( F_16 ( V_6 ) ) {
F_9 ( & V_6 -> V_16 -> V_37 , L_12 ) ;
...
if ( V_6 -> V_236 == V_237 )
return;
if ( ( V_237 & V_251 ) != ( V_6 -> V_236 & V_251 ) )
F_74 ( V_6 , V_237 & V_251 ?
V_252 : V_253 ) ;
V_6 -> V_236 = V_237 ;
return;
}
static V_95 F_80 ( struct V_5 * V_6 , V_95 V_254 )
{
V_95 V_71 = 0 ;
switch ( V_254 ) {
case V_255 :
...
static int F_81 ( struct V_1 * V_2 , struct V_270 * V_271 ,
T_1 * V_272 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ! F_82 ( V_6 ) ) {
...
switch ( V_271 -> V_271 ) {
case V_273 :
V_271 -> V_71 = F_80 ( V_6 , V_271 -> V_254 ) ;
break;
case V_274 :
V_271 -> V_71 = V_6 -> V_100 - 1 ;
break;
default:
return - V_105 ;
}
...
T_1 V_256 = V_6 -> V_256 ;
if ( V_271 -> V_71 != V_276 &&
V_271 -> V_71 != ( V_276 | V_277 ) )
return - V_105 ;
switch ( V_271 -> V_254 ) {
case V_255 :
if ( V_271 -> V_71 == V_276 )
V_256 &= ~ V_260 ;
else if ( V_271 -> V_71 == ( V_276 | V_277 ) )
V_256 |= V_257 |
V_260 ;
break;
case V_265 :
...
if ( ( V_77 + V_66 ) >= 128 )
break;
V_275 [ V_77 + V_66 ] = V_73 -> V_278 ;
}
}
}
V_26 = F_86 ( V_6 , V_275 , V_256 , 128 ) ;
if ( ! V_26 )
V_6 -> V_256 = V_256 ;
return V_26 ;
}
static int F_87 ( struct V_1 * V_2 , struct V_270 * V_271 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_26 = 0 ;
if ( ! F_82 ( V_6 ) ) {
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_281 -> V_282 = V_6 -> V_283 ;
V_281 -> V_284 = F_89 ( V_6 ) ;
}
static int F_90 ( struct V_1 * V_2 ,
struct V_280 * V_281 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_281 -> V_285 || V_281 -> V_286 || V_281 -> V_287 ||
! V_281 -> V_282 || V_281 -> V_282 > F_89 ( V_6 ) )
return - V_105 ;
V_6 -> V_288 = V_281 -> V_282 ;
return F_91 ( V_6 ) ;
}
