...
static void V_236 ( struct V_235 * V_37 )
{
V_37 -> V_240 = 16 ;
V_37 -> V_241 = & V_242 ;
V_37 -> V_243 = & V_244 ;
memcpy ( V_37 -> V_245 , & V_246 , V_247 ) ;
memcpy ( V_37 -> V_248 , & V_249 , V_247 ) ;
V_37 -> V_3 = 0 ;
V_37 -> type = V_250 ;
V_37 -> V_251 = V_252 + V_253 ;
V_37 -> V_254 = V_255 ;
V_37 -> V_256 = V_247 ;
}
static int F_68 ( struct V_235 * V_37 )
{
struct V_7 * V_8 = (struct V_7 * ) V_37 -> V_238 ;
if ( ! V_8 -> V_257 )
return - V_218 ;
V_8 -> V_12 = NULL ;
F_69 ( & V_8 -> V_13 ) ;
...
V_8 -> V_70 . V_258 ++ ;
V_8 -> V_70 . V_259 += V_16 -> V_39 ;
V_16 -> V_260 = F_73 ( V_16 , V_8 -> V_37 ) ;
F_74 ( V_16 ) ;
}
...
V_8 -> V_70 . V_264 ++ ;
V_8 -> V_70 . V_265 += V_16 -> V_39 ;
V_8 -> V_22 . V_266 ++ ;
V_261 = * V_16 -> V_25 & 0x1f ;
F_26 ( V_16 , 1 ) ;
if ( V_261 ) {
F_56 ( V_8 , V_261 , * V_16 -> V_25 ) ;
F_13 ( V_16 ) ;
return V_263 ;
}
F_2 ( & V_8 -> V_11 , V_3 ) ;
if ( F_76 ( & V_8 -> V_13 ) > V_8 -> V_37 -> V_240 ) {
struct V_15 * V_267 ;
V_267 = F_15 ( & V_8 -> V_13 ) ;
F_13 ( V_267 ) ;
}
...
static int F_78 ( struct V_235 * V_37 , struct V_269 * V_270 , int V_199 )
{
struct V_271 V_272 ;
struct V_273 V_274 ;
struct V_275 V_276 ;
...
struct V_7 * V_8 = (struct V_7 * ) V_37 -> V_238 ;
int V_279 ;
unsigned char V_280 [ V_281 ] ;
void T_4 * V_200 = V_270 -> V_282 ;
if ( ! V_232 )
{
if ( V_199 == V_283 )
{
int V_284 = 1 ;
if ( ! F_79 ( V_285 ) ) return - V_286 ;
if ( ! V_200 ) return - V_287 ;
if ( V_94 >= V_288 )
return - V_218 ;
if ( F_80 ( & V_276 , V_200 , sizeof( V_276 ) ) )
return - V_287 ;
if ( V_276 . V_88 == 2 ) V_276 . V_88 = 9 ;
if ( V_276 . V_88 < 0 || V_276 . V_88 >= V_225 )
return - V_218 ;
if ( ! V_226 [ V_276 . V_88 ] . V_227 && V_276 . V_88 )
{
if ( F_81 ( V_276 . V_88 , F_37 ,
0 , L_10 ,
( void * ) ( long ) V_276 . V_88 ) )
F_31 ( V_97 L_11 , V_276 . V_88 ) ;
else
V_226 [ V_276 . V_88 ] . V_227 = 1 ;
}
if ( V_276 . V_289 && ! V_92 ) {
if ( ! F_82 ( V_276 . V_289 , 1 , L_12 ) )
F_31 ( V_97 L_13 , V_276 . V_289 ) ;
else
V_92 = V_276 . V_289 ;
}
if ( V_276 . clock == 0 )
V_276 . clock = V_290 ;
#ifndef F_83
if( F_82 ( V_276 . V_291 , 1 , L_14 ) )
{
F_43 ( V_276 . V_88 ) ;
F_4 ( V_276 . V_291 , 0 ) ;
F_8 ( V_276 . V_291 , V_125 , V_231 ) ;
F_5 ( 100 ) ;
F_8 ( V_276 . V_291 , V_106 , 0x55 ) ;
F_5 ( 5 ) ;
if ( F_1 ( V_276 . V_291 , V_106 ) != 0x55 )
V_284 = 0 ;
F_45 ( V_276 . V_88 ) ;
F_84 ( V_276 . V_291 , 1 ) ;
}
...
if ( V_284 )
{
V_95 [ 2 * V_94 ] . V_9 = V_276 . V_291 ;
V_95 [ 2 * V_94 ] . V_25 = V_276 . V_292 ;
V_95 [ 2 * V_94 ] . V_88 = V_276 . V_88 ;
V_95 [ 2 * V_94 + 1 ] . V_9 = V_276 . V_293 ;
V_95 [ 2 * V_94 + 1 ] . V_25 = V_276 . V_294 ;
V_95 [ 2 * V_94 + 1 ] . V_88 = V_276 . V_88 ;
V_99 [ V_94 ] . V_100 = V_276 . V_291 ;
V_99 [ V_94 ] . V_101 = V_276 . V_293 ;
V_99 [ V_94 ] . V_88 = V_276 . V_88 ;
}
for ( V_279 = 0 ; V_279 < 2 ; V_279 ++ )
{
sprintf ( V_280 , L_15 , V_295 , 2 * V_94 + V_279 ) ;
V_95 [ 2 * V_94 + V_279 ] . V_229 = V_276 . V_229 ;
V_95 [ 2 * V_94 + V_279 ] . clock = V_276 . clock ;
V_95 [ 2 * V_94 + V_279 ] . V_138 = V_276 . V_138 ;
V_95 [ 2 * V_94 + V_279 ] . V_161 = V_276 . V_161 ;
V_95 [ 2 * V_94 + V_279 ] . V_46 = V_276 . V_296 ;
#ifdef F_83
F_31 ( V_224 L_16 ,
V_280 ,
V_95 [ 2 * V_94 + V_279 ] . V_25 ,
V_95 [ 2 * V_94 + V_279 ] . V_9 ) ;
#else
F_31 ( V_224 L_17 ,
V_280 ,
V_279 ? V_276 . V_294 : V_276 . V_292 ,
V_279 ? V_276 . V_293 : V_276 . V_291 ,
V_284 ? L_18 : L_19 ) ;
#endif
if ( V_284 )
{
F_82 ( V_95 [ 2 * V_94 + V_279 ] . V_9 , 1 , L_20 ) ;
F_82 ( V_95 [ 2 * V_94 + V_279 ] . V_25 , 1 , L_21 ) ;
if ( V_94 + V_279 != 0 &&
F_62 ( V_280 ,
& V_95 [ 2 * V_94 + V_279 ] ) )
return - V_218 ;
...
if ( V_199 == V_298 )
{
if ( ! F_79 ( V_299 ) ) return - V_286 ;
if ( ! V_200 ) return - V_218 ;
V_8 -> V_22 . V_69 = V_300 ;
if ( F_80 ( & V_8 -> V_28 , V_200 , sizeof( struct V_301 ) ) )
return - V_218 ;
...
case V_304 :
if ( ! F_79 ( V_285 ) ) return - V_286 ;
if ( ! V_200 || F_80 ( & V_274 , V_200 , sizeof( V_274 ) ) )
return - V_218 ;
V_8 -> V_22 . V_69 = V_274 . V_69 ;
return 0 ;
case V_305 :
...
return 0 ;
case V_306 :
if ( ! V_200 || F_80 ( & V_272 , V_200 , sizeof( V_272 ) ) )
return - V_218 ;
V_272 . V_307 = F_57 ( V_8 , V_272 . V_308 ) ;
if ( F_85 ( V_200 , & V_272 , sizeof( V_272 ) ) )
return - V_218 ;
return 0 ;
case V_309 :
if ( ! F_79 ( V_299 ) ) return - V_286 ;
if ( ! V_200 || F_80 ( & V_272 , V_200 , sizeof( V_272 ) ) )
return - V_218 ;
return F_56 ( V_8 , V_272 . V_308 , V_272 . V_307 ) ;
case V_310 :
if ( ! F_79 ( V_285 ) ) return - V_286 ;
if ( ! V_200 || F_80 ( & V_278 , V_200 , sizeof( V_278 ) ) || V_278 . time == 0 )
return - V_218 ;
F_60 ( V_8 , V_278 . time , V_278 . V_221 ) ;
return 0 ;
default:
return - V_303 ;
}
...
static int F_86 ( struct V_235 * V_37 , void * V_311 )
{
struct V_312 * V_313 = (struct V_312 * ) V_311 ;
memcpy ( V_37 -> V_248 , V_313 -> V_314 , V_37 -> V_256 ) ;
return 0 ;
}
static struct V_315 * F_87 ( struct V_235 * V_37 )
{
struct V_7 * V_8 = (struct V_7 * ) V_37 -> V_238 ;
V_8 -> V_70 . V_316 = V_8 -> V_22 . V_27 + V_8 -> V_22 . V_76 ;
V_8 -> V_70 . V_317 = V_8 -> V_22 . V_198 + V_8 -> V_22 . V_64 ;
V_8 -> V_70 . V_318 = V_8 -> V_22 . V_76 ;
V_8 -> V_70 . V_319 = V_8 -> V_22 . V_64 ;
return & V_8 -> V_70 ;
}
static inline struct V_7 * F_88 ( T_5 V_320 )
{
int V_24 ;
for ( V_24 = 0 ; V_24 < V_94 * 2 ; ++ V_24 ) {
if ( ! V_95 [ V_24 ] . V_257 )
...
static void * F_89 ( struct V_321 * V_322 , T_5 * V_320 )
{
return * V_320 ? F_88 ( * V_320 - 1 ) : V_323 ;
}
static void * F_90 ( struct V_321 * V_322 , void * V_324 , T_5 * V_320 )
{
unsigned V_24 ;
struct V_7 * V_8 = V_324 ;
++ * V_320 ;
for ( V_24 = ( V_324 == V_323 ) ? 0 : ( V_8 - V_95 ) + 1 ;
V_24 < V_94 * 2 ; ++ V_24 ) {
if ( V_95 [ V_24 ] . V_257 )
return & V_95 [ V_24 ] ;
}
...
static void F_91 ( struct V_321 * V_322 , void * V_324 )
{
}
static int F_92 ( struct V_321 * V_322 , void * V_324 )
{
if ( V_324 == V_323 ) {
F_93 ( V_322 , L_22 V_325 L_8 ) ;
} else if ( ! V_232 ) {
F_93 ( V_322 , L_23 ) ;
} else if ( ! V_94 ) {
F_93 ( V_322 , L_24 ) ;
} else {
const struct V_7 * V_8 = V_324 ;
const struct V_326 * V_22 = & V_8 -> V_22 ;
const struct V_327 * V_18 = & V_8 -> V_18 ;
F_94 ( V_322 , L_25 ,
V_8 -> V_37 -> V_233 ,
...
V_22 -> V_266 , V_22 -> V_198 , V_22 -> V_64 ,
V_22 -> V_23 , V_22 -> V_40 ) ;
...
F_94 ( V_322 , L_31 , V_8 -> V_10 [ V_2 ] ) ;
F_94 ( V_322 , L_8 ) ;
F_94 ( V_322 , L_32 , F_1 ( V_8 -> V_9 , V_42 ) , F_1 ( V_8 -> V_9 , V_74 ) ) ;
for ( V_2 = 3 ; V_2 < 8 ; V_2 ++ )
F_94 ( V_322 , L_31 , F_1 ( V_8 -> V_9 , V_2 ) ) ;
F_94 ( V_322 , L_33 ) ;
...
static int F_98 ( struct V_328 * V_328 , struct V_329 * V_329 )
{
return F_99 ( V_329 , & V_330 ) ;
}
static int T_7 F_100 ( void )
{
char V_331 [ V_281 ] ;
F_31 ( V_332 ) ;
sprintf ( V_331 , L_34 , V_295 ) ;
F_101 () ;
if ( F_62 ( V_331 , V_95 ) ) {
F_102 () ;
F_31 ( V_239 L_35 ) ;
...
F_102 () ;
F_103 ( L_36 , 0 , V_334 . V_335 , & V_336 ) ;
return 0 ;
}
