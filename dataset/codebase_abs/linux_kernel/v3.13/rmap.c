...
if ( V_73 && ! F_94 ( V_11 -> V_17 , V_73 ) )
continue;
V_68 += F_86 ( V_38 , V_11 , V_51 ,
& V_67 , V_55 ) ;
if ( ! V_67 )
break;
}
...
F_96 ( V_38 -> V_46 != F_120 ( V_11 , V_51 ) ) ;
#endif
}
...
bool V_86 ;
unsigned long V_87 ;
F_138 ( V_38 , & V_86 , & V_87 ) ;
if ( F_126 ( & V_38 -> V_83 ) ) {
F_127 ( V_38 , V_88 ) ;
F_139 ( V_38 , V_89 ) ;
}
F_140 ( V_38 , & V_86 , & V_87 ) ;
}
void F_141 ( struct V_38 * V_38 )
{
bool V_90 = F_63 ( V_38 ) ;
bool V_86 ;
unsigned long V_87 ;
...
F_110 ( V_11 , V_51 , F_81 ( V_38 ) ) ;
V_92 = F_111 ( V_11 , V_51 , V_64 ) ;
if ( F_108 ( V_92 ) )
F_150 ( V_38 ) ;
F_151 ( V_16 ) ;
if ( F_152 ( V_38 ) && ! ( V_87 & V_100 ) ) {
if ( ! F_73 ( V_38 ) ) {
if ( F_63 ( V_38 ) )
F_153 ( V_16 , V_101 ) ;
else
...
F_96 ( F_149 ( V_87 ) != V_110 ) ;
V_79 = F_162 ( V_38 , F_109 ( V_92 ) ) ;
}
V_104 = F_154 ( V_79 ) ;
if ( F_163 ( V_92 ) )
V_104 = F_164 ( V_104 ) ;
...
T_9 V_79 ;
V_79 = F_162 ( V_38 , F_109 ( V_92 ) ) ;
F_114 ( V_16 , V_51 , V_64 , F_154 ( V_79 ) ) ;
} else
F_153 ( V_16 , V_102 ) ;
F_141 ( V_38 ) ;
F_166 ( V_38 ) ;
...
static int F_168 ( unsigned long V_113 , unsigned int * V_67 ,
...
V_115 = V_51 ;
V_116 = V_117 ;
F_169 ( V_16 , V_115 , V_116 ) ;
if ( F_50 ( & V_11 -> V_17 -> V_111 ) ) {
V_118 = ( V_11 -> V_55 & V_70 ) ;
if ( ! V_118 )
F_51 ( & V_11 -> V_17 -> V_111 ) ;
}
V_64 = F_170 ( V_16 , V_61 , V_51 , & V_65 ) ;
F_151 ( V_16 ) ;
for (; V_51 < V_117 ; V_64 ++ , V_51 += V_121 ) {
if ( ! F_78 ( * V_64 ) )
continue;
V_38 = F_171 ( V_11 , V_51 , * V_64 ) ;
F_96 ( ! V_38 || F_63 ( V_38 ) ) ;
if ( V_118 ) {
F_167 ( V_38 ) ;
if ( V_38 == V_114 )
...
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 ;
if ( F_161 ( V_109 ) && ( V_87 & V_110 ) &&
F_175 ( V_11 ) )
continue;
V_51 = F_61 ( V_38 , V_11 ) ;
V_78 = F_148 ( V_38 , V_11 , V_51 , V_87 ) ;
...
static int F_177 ( struct V_38 * V_38 , enum V_91 V_87 )
{
struct V_74 * V_40 = V_38 -> V_40 ;
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
struct V_10 * V_11 ;
...
if ( F_149 ( V_87 ) == V_96 )
goto V_43;
F_179 (vma, &mapping->i_mmap_nonlinear,
shared.nonlinear) {
...
F_179 (vma, &mapping->i_mmap_nonlinear, shared.nonlinear)
V_11 -> V_130 = NULL ;
V_43:
F_100 ( & V_40 -> V_75 ) ;
return V_78 ;
}
int F_181 ( struct V_38 * V_38 , enum V_91 V_87 )
{
int V_78 ;
F_96 ( ! F_97 ( V_38 ) ) ;
F_5 ( ! F_73 ( V_38 ) && F_87 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
V_78 = F_182 ( V_38 , V_87 ) ;
else if ( F_63 ( V_38 ) )
V_78 = F_176 ( V_38 , V_87 ) ;
else
V_78 = F_177 ( V_38 , V_87 ) ;
if ( V_78 != V_112 && ! F_46 ( V_38 ) )
V_78 = V_131 ;
return V_78 ;
}
int F_183 ( struct V_38 * V_38 )
{
F_5 ( ! F_97 ( V_38 ) || F_184 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
return F_182 ( V_38 , V_96 ) ;
else if ( F_63 ( V_38 ) )
...
static int F_185 ( struct V_38 * V_38 , int (* F_186)( struct V_38 * ,
...
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 = F_61 ( V_38 , V_11 ) ;
V_78 = F_186 ( V_38 , V_11 , V_51 , V_132 ) ;
if ( V_78 != V_93 )
break;
}
F_54 ( V_1 ) ;
...
static int F_187 ( struct V_38 * V_38 , int (* F_186)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_132 )
{
struct V_74 * V_40 = V_38 -> V_40 ;
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
...
int F_188 ( struct V_38 * V_38 , int (* F_186)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_132 )
{
F_5 ( ! F_97 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
return F_189 ( V_38 , F_186 , V_132 ) ;
else if ( F_63 ( V_38 ) )
return F_185 ( V_38 , F_186 , V_132 ) ;
else
return F_187 ( V_38 , F_186 , V_132 ) ;
}
