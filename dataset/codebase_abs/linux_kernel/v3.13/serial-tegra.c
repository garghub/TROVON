...
unsigned int V_27 ;
int V_33 = 1 ;
struct V_194 * V_195 = F_92 ( V_2 -> V_49 ) ;
unsigned long V_196 = F_19 ( V_195 ) ;
int V_197 = ( V_2 -> V_37 -> V_48 ) ? 0x7FFF : 0xFFFF ;
V_197 *= 16 ;
F_32 ( & V_9 -> V_99 , V_92 ) ;
if ( V_2 -> V_23 )
F_8 ( V_2 , false ) ;
...
V_2 -> V_28 = V_27 ;
V_2 -> V_33 = V_33 ;
V_44 = F_93 ( V_9 , V_192 , V_193 ,
V_196 / V_197 ,
V_196 / 16 ) ;
F_36 ( & V_9 -> V_99 , V_92 ) ;
F_16 ( V_2 , V_44 ) ;
if ( F_94 ( V_192 ) )
F_95 ( V_192 , V_44 , V_44 ) ;
F_32 ( & V_9 -> V_99 , V_92 ) ;
...
static int F_99 ( struct V_217 * V_218 ,
struct V_1 * V_2 )
{
struct V_219 * V_220 = V_218 -> V_50 . V_221 ;
T_5 V_222 [ 2 ] ;
int V_126 ;
if ( F_100 ( V_220 , L_20 ,
V_222 , 2 ) >= 0 ) {
...
F_18 ( & V_218 -> V_50 , L_21 ) ;
return - V_223 ;
}
V_126 = F_101 ( V_220 , L_22 ) ;
if ( V_126 < 0 ) {
F_18 ( & V_218 -> V_50 , L_23 , V_126 ) ;
return V_126 ;
}
V_2 -> V_4 . line = V_126 ;
V_2 -> V_10 = F_102 ( V_220 ,
L_24 ) ;
return 0 ;
}
...
struct V_224 * V_224 ;
int V_47 ;
const struct V_225 * V_37 ;
const struct V_226 * V_227 ;
V_227 = F_104 ( V_228 , & V_218 -> V_50 ) ;
if ( ! V_227 ) {
F_18 ( & V_218 -> V_50 , L_25 ) ;
return - V_229 ;
}
V_37 = V_227 -> V_142 ;
V_2 = F_105 ( & V_218 -> V_50 , sizeof( * V_2 ) , V_174 ) ;
if ( ! V_2 ) {
F_18 ( & V_218 -> V_50 , L_26 ) ;
return - V_175 ;
}
V_47 = F_99 ( V_218 , V_2 ) ;
if ( V_47 < 0 )
...
V_2 -> V_37 = V_37 ;
F_106 ( V_218 , V_2 ) ;
V_224 = F_107 ( V_218 , V_233 , 0 ) ;
if ( ! V_224 ) {
F_18 ( & V_218 -> V_50 , L_27 ) ;
return - V_229 ;
}
V_9 -> V_179 = V_224 -> V_234 ;
V_9 -> V_5 = F_108 ( & V_218 -> V_50 , V_224 ) ;
if ( F_109 ( V_9 -> V_5 ) )
return F_110 ( V_9 -> V_5 ) ;
V_2 -> V_49 = F_111 ( & V_218 -> V_50 , NULL ) ;
if ( F_109 ( V_2 -> V_49 ) ) {
F_18 ( & V_218 -> V_50 , L_28 ) ;
return F_110 ( V_2 -> V_49 ) ;
}
V_9 -> V_235 = V_236 ;
V_9 -> V_141 = F_112 ( V_218 , 0 ) ;
V_9 -> V_6 = 2 ;
V_47 = F_113 ( & V_237 , V_9 ) ;
if ( V_47 < 0 ) {
F_18 ( & V_218 -> V_50 , L_29 , V_47 ) ;
return V_47 ;
}
return V_47 ;
}
...
{
struct V_1 * V_2 = F_115 ( V_218 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
F_116 ( & V_237 , V_9 ) ;
return 0 ;
}
static int F_117 ( struct V_238 * V_50 )
{
struct V_1 * V_2 = F_118 ( V_50 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
return F_119 ( & V_237 , V_9 ) ;
}
static int F_120 ( struct V_238 * V_50 )
{
struct V_1 * V_2 = F_118 ( V_50 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
return F_121 ( & V_237 , V_9 ) ;
}
