...
static inline int
F_86 ( struct V_38 * V_39 , int V_112 )
{
return V_39 -> V_2 -> F_86 ( V_39 , V_112 ) ;
}
static struct V_22 *
F_87 ( struct V_1 * V_2 , struct V_31 * V_57 )
{
...
static struct V_22 *
F_89 ( struct V_1 * V_2 , struct V_31 * V_57 )
{
...
static struct V_22 *
F_91 ( struct V_1 * V_2 , struct V_31 * V_57 )
{
return V_2 -> F_91 ( V_2 , V_57 ) ;
}
static void
...
static void
F_92 ( struct V_1 * V_2 , struct V_22 * V_113 )
{
V_2 -> F_92 ( V_2 , V_113 ) ;
}
static int
...
V_115 += 2 ;
if ( F_94 ( V_3 ) ) {
V_236 = F_95 ( & V_2 -> V_239 -> V_240 , F_2 ( V_3 ) ,
F_94 ( V_3 ) , V_237 ) ;
if ( F_96 ( ! V_236 ) )
return 1 ;
V_23 -> V_226 = V_236 ;
...
V_124 -> V_245 = F_101 ( F_102 ( V_3 ) ) ;
V_231 -> V_63 . V_246 . V_247 = F_102 ( V_3 ) ;
return 0 ;
}
static int
F_103 ( struct V_1 * V_2 , struct V_3 * V_15 ,
...
if ( V_2 -> V_259 != V_260 ) {
V_254 = F_8 ( V_15 ) ;
V_255 = ( F_102 ( V_15 ) + V_254 - 1 ) / V_254 ;
if ( ( V_2 -> V_259 < V_256 ) ||
...
static int
F_111 ( struct V_1 * V_2 , struct V_3 * V_15 ,
...
unsigned V_254 ;
V_219 V_290 , V_291 ;
V_159 = F_109 ( V_2 , V_15 , & V_290 , & V_291 ) ;
if ( V_159 )
goto V_307;
V_254 = F_8 ( V_15 ) ;
V_248 = ( T_1 ) F_105 ( V_15 ) ;
#ifdef F_112
V_208 = F_103 ( V_2 , V_15 , & V_248 , NULL , 1 ) ;
if ( V_208 ) {
if ( V_208 & V_288 )
F_110 ( V_2 , V_15 , & V_290 , & V_291 ) ;
if ( V_208 & V_275 )
V_306 = 0 ;
}
#endif
...
V_115 -> V_137 . V_138 . V_139 = F_100 ( V_8 ) ;
if ( V_237 == V_324 )
V_115 -> V_137 . V_138 . V_140 = V_141 ;
else
...
static int
F_113 ( struct V_1 * V_2 , struct V_3 * V_15 ,
...
V_235 ++ ;
V_115 ++ ;
V_331 = F_99 ( V_251 ) + V_336 ;
V_335 = F_100 ( V_251 ) - V_336 ;
F_114 ( V_335 % 8 ) ;
...
static int
F_116 ( struct V_1 * V_2 , struct V_3 * V_15 ,
...
{
int V_292 = V_366 ;
unsigned char V_253 = F_104 ( V_15 ) ;
switch ( V_253 ) {
case V_281 :
case V_276 :
V_292 = V_19 ;
...
goto V_371;
V_235 = F_111 ( V_2 , V_3 , V_115 ,
V_301 ) ;
if ( V_235 < 2 )
goto V_371;
break;
case V_367 :
V_369 = F_95 ( & V_2 -> V_239 -> V_240 ,
F_7 ( V_3 ) ,
F_119 ( V_3 ) , V_237 ) ;
if ( F_96 ( ! V_369 ) ) {
F_97 ( V_3 ) ;
...
V_231 -> V_153 = 1 ;
V_231 -> V_154 = 1 ;
V_368 = F_117 ( V_2 , V_23 ) ;
V_124 -> V_245 = F_106 ( V_368 ) ;
...
T_4
F_121 ( V_219 * V_129 , int V_372 )
{
T_4 V_373 = 0 ;
T_4 V_374 ;
V_373 = F_122 ( V_129 , V_372 ) ;
V_374 = F_108 ( V_373 ) ;
return V_374 ;
}
T_4
F_123 ( V_219 * V_129 , int V_372 )
{
T_4 V_292 ;
V_292 = F_124 ( V_129 , V_372 ) ;
return V_292 ;
}
void
...
F_63 ( & V_408 ) ;
if ( F_129 ( V_406 ) ) {
V_33 -> V_43 = F_127 ( V_410 , 0 ) ;
F_3 ( V_2 , V_398 , V_127 | V_11 ,
L_47
L_48
L_49 , V_33 -> V_4 [ 0 ] ,
( unsigned long long ) F_105 ( V_33 ) ,
F_130 ( V_33 -> V_411 ) , V_406 , V_405 ) ;
V_292 = ( - 1 ) ;
goto V_307;
}
if ( F_131 ( V_406 ) ) {
...
static int
F_137 ( struct V_1 * V_2 , struct V_22 * V_23 )
{
struct V_3 * V_3 = V_23 -> V_34 ;
struct V_7 * V_230 = NULL ;
struct V_124 * V_124 = V_23 -> V_124 ;
...
static inline int
F_141 ( struct V_1 * V_2 , struct V_22 * V_23 )
{
return V_2 -> F_141 ( V_2 , V_23 ) ;
}
static void
F_142 ( struct V_1 * V_2 , struct V_38 * V_39 ,
...
static void
F_143 ( struct V_1 * V_2 , struct V_22 * V_113 )
{
if ( V_113 -> V_226 > 0 )
F_97 ( V_113 -> V_34 ) ;
if ( V_113 -> V_228 > 0 )
F_120 ( & V_2 -> V_239 -> V_240 , F_7 ( V_113 -> V_34 ) ,
F_119 ( V_113 -> V_34 ) ,
V_113 -> V_34 -> V_238 ) ;
}
static void
F_144 ( struct V_38 * V_39 , struct V_22 * V_23 ,
struct V_172 * V_419 )
{
struct V_3 * V_4 = V_23 -> V_34 ;
...
L_66 ,
V_4 -> V_4 [ 0 ] , V_423 ,
F_106 ( * V_450 ) , F_106 ( * ( V_450 + 3 ) ) , V_421 ,
F_106 ( V_420 -> V_439 ) ,
F_106 ( V_420 -> V_431 ) ,
F_106 ( V_420 -> V_458 ) ,
V_420 -> V_460 ) ;
F_145 ( V_4 , 0 ) ;
if ( V_421 & V_441 ) {
F_145 ( V_4 , F_106 ( V_420 -> V_439 ) ) ;
F_50 ( V_39 , V_126 , V_466 ,
L_67
L_68 ,
F_106 ( V_449 -> V_245 ) ,
F_146 ( V_4 ) , V_247 , V_4 -> V_4 [ 0 ] ,
V_4 -> V_467 ) ;
if ( ( V_4 -> V_238 == V_315 ) &&
V_247 &&
( F_146 ( V_4 ) != V_247 ) ) {
...
V_307:
V_4 -> V_43 = F_127 ( V_451 , V_423 ) ;
F_142 ( V_39 -> V_2 , V_39 , V_23 , V_419 ) ;
}
static void
F_147 ( struct V_1 * V_2 , struct V_172 * V_468 ,
struct V_172 * V_401 )
{
struct V_22 * V_23 =
...
switch ( V_23 -> V_159 ) {
case V_483 :
F_144 ( V_39 , V_23 , V_401 ) ;
break;
case V_488 :
case V_489 :
V_33 -> V_43 = F_127 ( V_490 , 0 ) ;
V_62 = F_22 ( V_2 ) ;
if ( ! V_62 )
break;
...
if ( ! V_32 || ! F_23 ( V_32 )
|| ( V_32 -> V_507 != V_508 ) )
V_33 -> V_43 = F_127 ( V_490 ,
V_426 ) ;
} else
V_33 -> V_43 = F_127 ( V_452 , 0 ) ;
...
static void
F_153 ( V_219 * V_129 , struct V_124 * V_124 )
{
int V_42 , V_521 ;
for ( V_42 = 0 , V_521 = 0 ; V_42 < sizeof( struct V_124 ) ;
V_42 += sizeof( T_1 ) , V_521 ++ ) {
( ( T_1 * ) V_129 ) [ V_521 ] = F_101 ( ( ( T_1 * ) V_124 ) [ V_521 ] ) ;
}
}
static void
F_154 ( struct V_38 * V_39 , struct V_22 * V_23 ,
struct V_31 * V_32 )
{
struct V_1 * V_2 = V_39 -> V_2 ;
struct V_3 * V_3 = V_23 -> V_34 ;
...
if ( V_2 -> V_146 == 3 &&
! ( V_2 -> V_147 & V_148 ) )
F_153 ( V_231 -> V_150 . V_151 . V_152 , V_124 ) ;
...
F_155 ( V_58 , & V_124 -> V_526 ) ;
V_124 -> V_456 = V_560 ;
if ( V_39 -> V_2 -> V_146 == 3 &&
! ( V_39 -> V_2 -> V_147 & V_148 ) )
F_153 ( V_561 -> V_150 . V_151 . V_152 , V_124 ) ;
V_561 -> V_536 = V_550 ;
...
V_561 -> V_556 = ( V_57 -> V_554 & V_555 ) ? 1 : 0 ;
...
int
F_158 ( struct V_1 * V_2 , V_219 V_562 )
{
V_2 -> F_143 = F_143 ;
V_2 -> F_154 = F_154 ;
switch ( V_562 ) {
...
static T_7 void F_162 ( struct V_1 * V_2 )
{
unsigned long V_581 =
( V_44 + F_150 ( V_2 -> V_582 ) ) ;
...
void F_165 ( unsigned long V_524 )
{
...
static int
F_167 ( struct V_36 * V_37 , struct V_3 * V_4 )
{
struct V_38 * V_39 = (struct V_38 * ) V_37 -> V_40 ;
struct V_1 * V_2 = V_39 -> V_2 ;
...
V_589 [ F_104 ( V_4 ) ] ,
V_4 -> V_4 [ 0 ] ,
( unsigned long long ) F_105 ( V_4 ) ,
F_130 ( V_4 -> V_411 ) ,
( V_4 -> V_4 [ 1 ] >> 5 ) ) ;
}
V_371 = F_141 ( V_2 , V_23 ) ;
} else {
if ( V_39 -> V_2 -> V_216 ) {
F_50 ( V_39 ,
V_126 , V_592 ,
...
if ( V_371 )
goto V_593;
F_154 ( V_39 , V_23 , V_57 ) ;
F_34 ( & V_57 -> V_477 ) ;
V_371 = F_169 ( V_2 , V_583 ,
& V_23 -> V_132 , V_594 ) ;
if ( V_371 ) {
F_148 ( & V_57 -> V_477 ) ;
goto V_593;
...
static int
F_178 ( struct V_38 * V_39 , struct V_22 * V_23 )
{
struct V_125 * V_420 = V_23 -> V_125 ;
T_1 V_625 ;
T_1 V_626 ;
...
static int
F_179 ( struct V_38 * V_39 , struct V_29 * V_30 ,
unsigned V_631 , unsigned int V_632 ,
V_219 V_560 )
{
struct V_1 * V_2 = V_39 -> V_2 ;
struct V_22 * V_23 ;
...
if ( ! V_32 || ! F_23 ( V_32 ) )
return V_602 ;
V_23 = F_91 ( V_2 , V_30 -> V_32 ) ;
if ( V_23 == NULL )
return V_602 ;
V_23 -> V_559 = V_2 -> V_634 ;
V_23 -> V_30 = V_30 ;
V_159 = F_157 ( V_39 , V_23 , V_632 ,
V_560 ) ;
if ( ! V_159 ) {
F_92 ( V_2 , V_23 ) ;
return V_602 ;
...
L_131
L_132 ,
F_177 ( V_560 ) , V_631 , V_632 ,
V_32 -> V_552 , V_32 -> V_541 , V_173 -> V_180 ,
V_173 -> V_133 ) ;
V_159 = F_181 ( V_2 , V_583 ,
V_173 , V_633 , V_23 -> V_559 ) ;
if ( ( V_159 != V_635 ) ||
( V_633 -> V_116 . V_474 != V_160 ) ) {
F_50 ( V_39 , V_10 , V_127 ,
L_133
L_134 ,
F_177 ( V_560 ) ,
V_631 , V_632 , V_633 -> V_116 . V_474 ,
V_633 -> V_116 . V_63 . V_472 [ 4 ] ,
V_173 -> V_133 ) ;
if ( V_159 == V_635 ) {
if ( V_633 -> V_116 . V_474 == V_483 )
V_292 = F_178 ( V_39 , V_23 ) ;
else
V_292 = V_602 ;
} else if ( V_159 == V_636 ) {
V_292 = V_637 ;
...
static int
F_182 ( struct V_38 * V_39 , struct V_3 * V_4 )
{
struct V_29 * V_30 = V_4 -> V_16 -> V_40 ;
struct V_31 * V_32 ;
unsigned long V_638 ;
...
V_32 = V_30 -> V_32 ;
V_638 = F_150 ( 2 * V_39 -> V_617 * 1000 ) + V_44 ;
while ( F_149 ( V_638 , V_44 ) ) {
if ( ! V_32 || ! F_23 ( V_32 ) )
return V_602 ;
if ( V_32 -> V_507 == V_508 )
return V_599 ;
...
static int
F_184 ( struct V_38 * V_39 , T_4 V_631 ,
T_6 V_632 , T_8 V_639 )
{
struct V_1 * V_2 = V_39 -> V_2 ;
unsigned long V_638 ;
int V_640 ;
V_640 = F_185 ( V_39 , V_631 , V_632 , V_639 ) ;
if ( V_640 )
F_186 ( V_39 , & V_2 -> V_177 . V_178 [ V_2 -> V_177 . V_641 ] ,
V_631 , V_632 , V_639 ) ;
V_638 = F_150 ( 2 * V_39 -> V_617 * 1000 ) + V_44 ;
while ( F_149 ( V_638 , V_44 ) && V_640 ) {
F_183 ( F_150 ( 20 ) ) ;
V_640 = F_185 ( V_39 , V_631 , V_632 , V_639 ) ;
}
if ( V_640 ) {
...
static int
F_187 ( struct V_3 * V_4 )
{
struct V_36 * V_37 = V_4 -> V_16 -> V_20 ;
struct V_38 * V_39 = (struct V_38 * ) V_37 -> V_40 ;
struct V_29 * V_30 = V_4 -> V_16 -> V_40 ;
struct V_31 * V_32 ;
unsigned V_631 = V_4 -> V_16 -> V_459 ;
unsigned int V_632 = V_4 -> V_16 -> V_58 ;
struct V_645 V_65 ;
int V_159 ;
if ( ! V_30 ) {
F_50 ( V_39 , V_10 , V_127 ,
...
F_188 ( V_37 , F_189 () ,
sizeof( V_65 ) , ( char * ) & V_65 , V_647 ) ;
V_159 = F_179 ( V_39 , V_30 , V_631 , V_632 ,
V_621 ) ;
F_50 ( V_39 , V_10 , V_127 ,
L_143
L_144 , V_631 , V_632 , V_159 ) ;
if ( V_159 == V_599 )
V_159 = F_184 ( V_39 , V_631 , V_632 ,
V_642 ) ;
return V_159 ;
}
static int
...
V_65 . V_68 = V_650 ;
V_65 . V_58 = 0 ;
memcpy ( V_65 . V_70 , & V_39 -> V_651 , sizeof( struct V_72 ) ) ;
memcpy ( V_65 . V_73 , & V_39 -> V_652 , sizeof( struct V_72 ) ) ;
F_188 ( V_37 , F_189 () ,
sizeof( V_65 ) , ( char * ) & V_65 , V_647 ) ;
V_159 = F_172 ( V_4 ) ;
if ( V_159 != 0 && V_159 != V_599 )
return V_159 ;
for ( V_42 = 0 ; V_42 < V_653 ; V_42 ++ ) {
V_649 = 0 ;
F_80 ( V_37 -> V_46 ) ;
F_192 (ndlp, &vport->fc_nodes, nlp_listp) {
if ( ! F_23 ( V_57 ) )
continue;
if ( V_39 -> V_2 -> V_654 &&
( V_57 -> V_554 & V_555 ) )
...
if ( ! V_649 )
continue;
V_159 = F_179 ( V_39 , V_57 -> V_111 -> V_656 ,
V_42 , 0 , V_622 ) ;
if ( V_159 != V_599 ) {
F_50 ( V_39 , V_10 , V_127 ,
L_148 ,
...
int V_659 = 0 ;
T_1 V_660 ;
if ( ! V_111 || F_168 ( V_111 ) )
return - V_661 ;
V_84 -> V_40 = V_111 -> V_656 ;
V_660 = F_201 ( & V_2 -> V_660 ) ;
V_658 = V_2 -> V_662 ;
V_112 = V_39 -> V_102 + 2 ;
if ( ( V_660 * ( V_39 -> V_102 + 2 ) ) < V_658 )
return 0 ;
if ( V_658 >= V_2 -> V_663 - V_664 ) {
F_50 ( V_39 , V_398 , V_127 ,
L_152
L_153 , V_658 ) ;
return 0 ;
...
V_112 , V_2 -> V_663 ,
( V_2 -> V_663 - V_658 ) ) ;
V_112 = V_2 -> V_663 - V_658 ;
}
V_659 = F_86 ( V_39 , V_112 ) ;
if ( V_112 != V_659 ) {
F_50 ( V_39 , V_10 , V_127 ,
L_157
L_158
