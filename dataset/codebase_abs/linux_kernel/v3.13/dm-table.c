...
V_89 = F_48 ( V_90 * sizeof( * V_89 ) , V_91 ) ;
if ( V_89 ) {
...
int F_64 ( int * V_93 , char * * * V_94 , char * V_95 )
{
...
if ( F_74 ( V_43 -> type ) && ! ( V_7 -> V_28 & V_106 ) ) {
F_71 ( L_19 ,
F_39 ( V_7 -> V_30 ) , type ) ;
return - V_103 ;
}
...
static int F_76 ( struct V_112 * V_113 , struct V_114 * V_115 ,
unsigned * V_116 , char * * error , unsigned V_117 )
{
const char * V_118 = F_77 ( V_115 ) ;
char V_78 ;
if ( ! V_118 ||
...
{
return F_76 ( V_113 , V_115 , V_116 , error , 0 ) ;
}
int F_79 ( struct V_112 * V_113 , struct V_114 * V_115 ,
unsigned * V_116 , char * * error )
{
return F_76 ( V_113 , V_115 , V_116 , error , 1 ) ;
}
const char * F_77 ( struct V_114 * V_121 )
{
char * V_52 ;
if ( V_121 -> V_93 ) {
V_121 -> V_93 -- ;
...
void F_80 ( struct V_114 * V_121 , unsigned V_122 )
{
F_27 ( V_121 -> V_93 < V_122 ) ;
V_121 -> V_93 -= V_122 ;
V_121 -> V_89 += V_122 ;
}
...
struct V_129 * F_88 ( struct V_6 * V_7 )
{
return V_7 -> V_107 ;
}
bool F_89 ( struct V_6 * V_7 )
{
return F_87 ( V_7 ) == V_127 ;
}
...
V_7 -> V_45 = F_91 ( type , V_7 -> V_132 , V_130 ) ;
if ( ! V_7 -> V_45 )
return - V_24 ;
return 0 ;
}
...
struct V_133 * F_93 ( struct V_6 * V_7 )
{
return V_7 -> V_45 ;
}
...
static struct V_138 * F_96 ( struct V_6 * V_7 ,
bool V_139 )
{
...
struct V_21 * F_110 ( struct V_6 * V_7 , T_1 V_149 )
{
...
if ( ! V_54 -> type -> V_102 )
return false ;
V_54 -> type -> V_102 ( V_54 , F_111 , & V_150 ) ;
if ( V_150 )
return false ;
}
return true ;
...
if ( V_54 -> type -> V_102 ( V_54 , F_36 ,
& V_101 ) )
return - V_103 ;
V_151:
if ( F_114 ( V_61 , & V_101 , 0 ) < 0 )
F_19 ( L_40
L_41
L_42 ,
F_39 ( V_70 -> V_30 ) ,
...
static bool F_117 ( struct V_6 * V_7 , unsigned V_153 )
{
struct V_21 * V_54 ;
unsigned V_42 = 0 ;
while ( V_42 < F_67 ( V_7 ) ) {
...
return 1 ;
if ( V_54 -> type -> V_102 &&
V_54 -> type -> V_102 ( V_54 , F_116 , & V_153 ) )
return 1 ;
}
return 0 ;
}
...
return false ;
if ( ! V_54 -> type -> V_102 ||
V_54 -> type -> V_102 ( V_54 , F_124 , NULL ) )
return false ;
}
return true ;
}
...
static void F_133 ( struct V_6 * V_7 , unsigned V_168 )
{
int V_42 = V_7 -> V_23 ;
...
if ( V_52 ) {
F_71 ( L_45 ,
F_39 ( V_7 -> V_30 ) , V_54 -> type -> V_41 , V_52 ) ;
return V_52 ;
}
}
for ( V_42 = 0 ; V_42 < V_7 -> V_23 ; V_42 ++ ) {
...
void F_137 ( struct V_6 * V_7 , struct V_172 * V_173 )
{
F_51 ( & V_173 -> V_39 , & V_7 -> V_33 ) ;
}
int F_138 ( struct V_6 * V_7 , int V_174 )
{
struct V_37 * V_38 ;
struct V_34 * V_32 = F_85 ( V_7 ) ;
struct V_172 * V_173 ;
...
return 1 ;
if ( V_54 -> type -> V_102 &&
V_54 -> type -> V_102 ( V_54 , F_144 , NULL ) )
return 1 ;
}
return 0 ;
}
