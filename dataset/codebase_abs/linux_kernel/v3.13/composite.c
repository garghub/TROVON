...
const struct V_140 * V_141 , unsigned V_142 )
{
struct V_9 * V_67 = V_16 -> V_67 ;
struct V_44 * V_60 = NULL ;
int V_143 = - V_48 ;
unsigned V_144 = F_39 ( V_67 ) ? 8 : 100 ;
int V_145 ;
if ( V_142 ) {
F_28 (c, &cdev->configs, list) {
if ( V_60 -> V_85 == V_142 ) {
...
F_40 ( V_16 , L_5 ,
F_41 ( V_67 -> V_25 ) ,
V_142 , V_60 ? V_60 -> V_50 : L_6 ) ;
if ( ! V_60 )
goto V_53;
V_16 -> V_45 = V_60 ;
for ( V_145 = 0 ; V_145 < V_70 ; V_145 ++ ) {
struct V_11 * V_12 = V_60 -> V_71 [ V_145 ] ;
struct V_5 * * V_89 ;
if ( ! V_12 )
break;
switch ( V_67 -> V_25 ) {
...
if ( ( * V_89 ) -> V_7 != V_8 )
continue;
V_146 = (struct V_17 * ) * V_89 ;
V_147 = ( ( V_146 -> V_31 & 0x80 ) >> 3 )
| ( V_146 -> V_31 & 0x0f ) ;
F_42 ( V_147 , V_12 -> V_61 ) ;
}
V_143 = V_12 -> V_51 ( V_12 , V_145 , 0 ) ;
if ( V_143 < 0 ) {
F_11 ( V_16 , L_7 ,
V_145 , V_12 -> V_49 , V_12 , V_143 ) ;
F_37 ( V_16 ) ;
goto V_53;
}
if ( V_143 == V_148 ) {
F_11 ( V_16 ,
L_8 ,
V_149 , V_145 , V_12 -> V_49 ) ;
V_16 -> V_139 ++ ;
F_11 ( V_16 , L_9 ,
V_16 -> V_139 ) ;
}
}
V_144 = V_60 -> V_75 ? V_60 -> V_75 : V_76 ;
V_53:
F_43 ( V_67 , V_144 ) ;
if ( V_143 >= 0 && V_16 -> V_139 )
V_143 = V_148 ;
return V_143 ;
}
...
for ( V_145 = V_77 ; * V_145 && V_145 < & V_77 [ 126 ] ; V_145 ++ ) {
if ( * V_145 == V_155 )
goto V_156;
}
* V_145 ++ = V_155 ;
...
static void F_67 ( struct V_13 * V_146 , struct V_182 * V_95 )
{
if ( V_95 -> V_64 || V_95 -> V_183 != V_95 -> V_184 )
F_11 ( (struct V_15 * ) V_146 -> V_185 ,
L_21 ,
V_95 -> V_64 , V_95 -> V_183 , V_95 -> V_184 ) ;
}
int
F_68 ( struct V_9 * V_67 , const struct V_140 * V_141 )
{
struct V_15 * V_16 = F_4 ( V_67 ) ;
struct V_182 * V_95 = V_16 -> V_95 ;
int V_47 = - V_186 ;
int V_64 = 0 ;
T_3 V_187 = F_33 ( V_141 -> V_188 ) ;
T_1 V_189 = V_187 & 0xFF ;
T_3 V_91 = F_33 ( V_141 -> V_190 ) ;
T_3 V_191 = F_33 ( V_141 -> V_192 ) ;
...
F_71 ( V_16 ,
L_26 ,
V_141 -> V_198 , V_141 -> V_196 ,
V_91 , V_187 , V_191 ) ;
switch ( V_141 -> V_198 & V_218 ) {
case V_208 :
if ( ! V_16 -> V_45 || V_189 >= V_70 )
break;
V_12 = V_16 -> V_45 -> V_71 [ V_189 ] ;
...
if ( V_12 && V_12 -> V_220 )
V_47 = V_12 -> V_220 ( V_12 , V_141 ) ;
else {
struct V_44 * V_60 ;
V_60 = V_16 -> V_45 ;
if ( V_60 && V_60 -> V_220 )
V_47 = V_60 -> V_220 ( V_60 , V_141 ) ;
}
goto V_53;
}
if ( V_47 >= 0 && V_47 != V_148 ) {
V_95 -> V_184 = V_47 ;
...
static T_4 F_79 ( struct V_223 * V_224 , struct V_225 * V_226 ,
char * V_77 )
{
...
struct V_182 * V_95 = V_16 -> V_95 ;
unsigned long V_63 ;
F_11 ( V_16 , L_35 , V_149 ) ;
F_17 ( & V_16 -> V_65 , V_63 ) ;
if ( V_16 -> V_139 == 0 ) {
F_77 ( V_16 , L_36 , V_149 ) ;
} else if ( -- V_16 -> V_139 == 0 ) {
F_11 ( V_16 , L_37 , V_149 ) ;
V_95 -> V_184 = 0 ;
