...
{
struct V_1 * V_2 = (struct V_1 * ) V_24 ;
struct V_58 * V_90 = F_27 ( V_2 -> V_91 ) ;
int V_92 ;
if ( V_90 -> V_93 ) {
struct V_57 * V_60 ;
V_60 = F_19 ( V_90 , V_27 ) ;
...
F_32 ( & V_2 -> V_26 . V_98 , 1 << V_2 -> V_26 . V_27 . V_50 , 0 ) ;
F_33 ( V_27 , V_2 ) ;
return 0 ;
}
...
if ( V_2 -> V_6 != V_9 )
return 0 ;
memcpy ( & V_99 , & V_2 -> V_26 . V_27 , sizeof( V_99 ) ) ;
...
static int F_36 ( int V_111 , struct V_23 * V_24 )
{
struct V_1 * V_2 = (struct V_1 * ) V_24 ;
int V_65 ;
switch ( V_111 ) {
...
if ( V_2 -> V_26 . V_39 . V_40 == V_45 ||
V_2 -> V_26 . V_39 . V_40 == V_44 )
F_37 ( & V_2 -> V_26 . V_98 , V_24 ) ;
F_5 ( V_2 , V_9 ) ;
}
return 0 ;
}
static void F_38 ( struct V_117 * V_118 )
{
int V_119 = V_118 -> V_26 . V_39 . V_78 * V_118 -> V_26 . V_27 . V_86 ;
unsigned long V_120 = V_118 -> V_121 ;
F_39 ( V_118 -> V_2 , V_122 , V_123 , V_120 , V_119 ) ;
}
...
F_3 ( V_118 -> V_2 , V_125 , V_118 -> V_130 [ 0 ] & ~ V_126 ) ;
F_3 ( V_118 -> V_2 , V_133 , F_42 ( 1 ) ) ;
F_3 ( V_118 -> V_2 , V_132 , V_131 & ~ F_42 ( 1 ) ) ;
F_3 ( V_118 -> V_2 , V_108 , V_118 -> V_2 -> V_109 [ V_122 ] | 0x3 ) ;
if ( F_43 ( & V_118 -> V_134 , 1 * V_135 ) == 0 )
F_44 ( L_2 , V_136 ) ;
F_3 ( V_118 -> V_2 , V_132 , V_131 ) ;
}
static void F_45 ( struct V_117 * V_118 )
{
int V_119 , div = 1 , V_137 = F_46 ( V_118 -> V_26 . V_27 . V_138 ) ;
unsigned long V_120 [ 3 ] = { V_118 -> V_121 , 0 , 0 } ;
if ( V_137 == V_139 || V_137 == V_140 ) {
V_119 = V_118 -> V_26 . V_39 . V_78 * V_118 -> V_26 . V_27 . V_86 ;
F_39 ( V_118 -> V_2 , V_141 , - 1 , V_120 [ 0 ] , V_119 ) ;
} else {
V_119 = V_118 -> V_26 . V_27 . V_83 * V_118 -> V_26 . V_27 . V_86 ;
switch ( V_137 ) {
...
F_39 ( V_118 -> V_2 , V_141 , - 1 , V_120 [ 0 ] , V_119 ) ;
F_39 ( V_118 -> V_2 , V_145 , - 1 , V_120 [ 1 ] , V_119 / div ) ;
F_39 ( V_118 -> V_2 , V_146 , - 1 , V_120 [ 2 ] , V_119 / div ) ;
}
}
static void F_47 ( struct V_117 * V_118 )
{
int V_137 = F_46 ( V_118 -> V_26 . V_27 . V_138 ) ;
...
V_131 = F_1 ( V_118 -> V_2 , V_132 ) ;
F_3 ( V_118 -> V_2 , V_147 , V_118 -> V_130 [ 0 ] & ~ V_126 ) ;
F_3 ( V_118 -> V_2 , V_133 , F_42 ( 2 ) ) ;
F_3 ( V_118 -> V_2 , V_132 , V_131 & ~ F_42 ( 2 ) ) ;
...
static int F_49 ( struct V_23 * V_24 , int V_158 )
{
struct V_117 * V_118 = (struct V_117 * ) V_24 ;
if ( V_158 == 0 )
return - V_159 ;
if ( V_118 -> V_160 ++ == 0 ) {
F_50 () ;
F_51 ( & V_118 -> V_2 -> V_26 , V_116 ) ;
F_52 () ;
}
return 0 ;
}
static int F_53 ( struct V_23 * V_24 , int V_158 )
{
struct V_117 * V_118 = (struct V_117 * ) V_24 ;
if ( V_118 -> V_160 == 1 ) {
V_118 -> V_161 -> V_162 ( V_118 ) ;
V_118 -> V_26 . V_27 . V_163 = - 1 ;
V_118 -> V_26 . V_27 . V_164 = - 1 ;
V_118 -> V_26 . V_27 . V_67 = V_118 -> V_26 . V_27 . V_83 = 0 ;
V_118 -> V_26 . V_27 . V_68 = V_118 -> V_26 . V_27 . V_86 = 0 ;
V_118 -> V_160 -- ;
}
return 0 ;
}
...
{
struct V_117 * V_118 = (struct V_117 * ) V_24 ;
struct V_46 * V_165 = & V_118 -> V_2 -> V_26 . V_27 ;
int V_166 , V_167 , V_137 , V_48 ;
V_166 = F_55 ( V_27 -> V_138 ) ;
V_167 = F_56 ( V_27 -> V_138 ) ;
V_137 = F_46 ( V_27 -> V_138 ) ;
V_48 = F_13 ( V_27 ) ;
if ( V_48 < 0 )
return - V_49 ;
...
{
struct V_46 * V_27 = & V_118 -> V_26 . V_27 ;
int V_137 = F_46 ( V_27 -> V_138 ) ;
int V_119 , V_48 = 0 ;
switch ( V_137 ) {
...
V_118 -> V_26 . V_39 . V_78 = V_27 -> V_83 * V_48 / 8 ;
V_119 = F_59 ( V_118 -> V_26 . V_39 . V_78 * V_27 -> V_86 ) ;
if ( V_118 -> V_170 ) {
...
V_167 = F_56 ( V_27 -> V_138 ) ;
V_137 = F_46 ( V_27 -> V_138 ) ;
V_118 -> V_130 [ 0 ] = F_61 ( V_27 -> V_67 ) | F_62 ( V_27 -> V_68 ) |
F_63 ( V_48 ) ;
V_118 -> V_130 [ 1 ] = F_64 ( V_166 ) | F_65 ( V_167 ) ;
if ( V_118 -> V_168 == V_172 )
V_118 -> V_130 [ 1 ] |= F_66 ( V_137 ) ;
V_118 -> V_161 -> V_173 ( V_118 ) ;
V_118 -> V_161 -> V_174 ( V_118 ) ;
return 0 ;
}
static void F_67 ( struct V_1 * V_2 , struct V_117 * V_118 ,
int V_168 )
{
sprintf ( V_118 -> V_26 . V_39 . V_168 , L_4 , V_168 + 1 ) ;
V_118 -> V_26 . V_39 . type = V_175 ;
V_118 -> V_26 . V_39 . V_176 = 0 ;
V_118 -> V_26 . V_39 . V_177 = 1 ;
V_118 -> V_26 . V_27 . V_178 = V_179 ;
V_118 -> V_26 . V_27 . V_163 = - 1 ;
V_118 -> V_26 . V_27 . V_164 = - 1 ;
V_118 -> V_26 . V_27 . V_105 = V_180 ;
V_118 -> V_26 . V_181 = & V_182 ;
V_118 -> V_26 . V_7 = V_183 ;
V_118 -> V_26 . V_184 = - 1 ;
V_118 -> V_26 . V_43 = NULL ;
V_118 -> V_168 = V_168 ;
...
static int F_72 ( struct V_1 * V_186 ,
struct V_117 * V_118 )
{
V_118 -> V_170 = F_73 ( F_59 ( V_186 -> V_171 ) ,
V_187 | V_188 ) ;
if ( V_118 -> V_170 == NULL )
return - V_189 ;
V_118 -> V_121 = F_74 ( V_118 -> V_170 ) ;
V_118 -> V_171 = F_59 ( V_186 -> V_171 ) ;
F_75 ( & V_118 -> V_26 . V_190 ) ;
V_118 -> V_26 . V_39 . V_191 = V_118 -> V_121 ;
V_118 -> V_26 . V_39 . V_87 = V_186 -> V_171 ;
F_76 ( & V_118 -> V_26 . V_190 ) ;
V_118 -> V_26 . V_192 = V_118 -> V_170 ;
return 0 ;
}
...
F_67 ( V_2 , V_118 , V_65 ) ;
V_37 = F_78 ( & V_118 -> V_26 ) ;
if ( V_37 ) {
F_79 ( V_2 -> V_91 , L_5 , V_65 ) ;
continue;
}
V_37 = F_72 ( V_2 , V_118 ) ;
if ( V_37 ) {
...
{
unsigned long V_197 ;
if ( ( V_195 == 0 ) || ( V_2 -> V_26 . V_27 . V_69 == 0 ) ) {
V_2 -> V_198 = 0 ;
return;
}
V_197 = F_85 ( V_2 -> V_196 ) / ( V_195 * V_2 -> V_26 . V_27 . V_69 ) ;
V_2 -> V_198 = V_197 ;
}
unsigned long F_88 ( struct V_199 * V_91 )
{
struct V_1 * V_2 = F_89 ( V_91 ) ;
if ( ! V_2 || ( V_2 -> V_6 != V_9 ) )
return 0 ;
return V_2 -> V_198 ;
}
static int F_39 ( struct V_1 * V_2 , int V_100 , int V_42 ,
...
V_203 = F_90 ( struct V_205 , V_201 [ V_100 ] ) ;
V_201 -> V_206 = V_120 ;
V_201 -> V_207 = 0 ;
V_201 -> V_208 = V_119 ;
...
V_202 -> V_208 = V_2 -> V_25 * sizeof( V_95 ) ;
else
V_202 -> V_208 = V_2 -> V_25 * sizeof( V_34 ) ;
V_202 -> V_208 |= V_212 ;
...
int V_213 )
{
struct V_214 * V_39 = & V_2 -> V_26 . V_39 ;
...
if ( V_2 -> V_81 & V_107 ) {
V_215 = V_215 / 2 ;
F_39 ( V_2 , V_100 + 1 , V_123 , V_17 + V_215 , V_215 ) ;
}
F_39 ( V_2 , V_100 , V_42 , V_17 , V_215 ) ;
}
...
{
struct V_1 * V_2 = F_93 ( V_24 , struct V_1 , V_26 ) ;
T_2 V_222 ;
int V_37 = 0 ;
...
V_254 = F_25 ( V_60 -> V_258 , V_60 -> V_259 ) ;
V_255 = F_25 ( V_60 -> V_260 , V_60 -> V_261 ) ;
V_256 = V_60 -> V_262 ;
V_257 = V_60 -> V_263 ;
V_2 -> V_235 =
F_99 ( V_27 -> V_67 ) |
...
if ( V_2 -> V_290 )
V_2 -> V_290 ( V_288 , & V_2 -> V_26 . V_27 ) ;
}
static void F_124 ( struct V_1 * V_2 )
{
F_29 ( L_18 ) ;
F_29 ( L_19 , ( unsigned int ) V_2 -> V_109 [ 0 ] ) ;
F_29 ( L_20 , ( unsigned int ) V_2 -> V_109 [ 1 ] ) ;
...
break;
case V_314 :
V_195 = F_84 ( V_2 , V_2 -> V_26 . V_27 . V_56 ) ;
F_87 ( V_2 , V_195 ) ;
...
{
int V_119 = F_59 ( V_2 -> V_171 ) ;
V_2 -> V_170 = F_73 ( V_119 , V_187 | V_188 ) ;
if ( V_2 -> V_170 == NULL )
return - V_189 ;
V_2 -> V_121 = F_74 ( V_2 -> V_170 ) ;
V_2 -> V_171 = V_119 ;
V_2 -> V_26 . V_39 . V_191 = V_2 -> V_121 ;
V_2 -> V_26 . V_39 . V_87 = V_2 -> V_171 ;
V_2 -> V_26 . V_192 = V_2 -> V_170 ;
...
strcpy ( V_2 -> V_26 . V_39 . V_168 , V_341 ) ;
V_2 -> V_26 . V_39 . type = V_175 ;
V_2 -> V_26 . V_39 . V_342 = 0 ;
V_2 -> V_26 . V_39 . V_176 = 0 ;
V_2 -> V_26 . V_39 . V_177 = 1 ;
V_2 -> V_26 . V_39 . V_343 = 0 ;
V_2 -> V_26 . V_39 . V_344 = V_345 ;
V_2 -> V_26 . V_27 . V_138 = 0 ;
V_2 -> V_26 . V_27 . V_178 = V_179 ;
V_2 -> V_26 . V_27 . V_163 = - 1 ;
V_2 -> V_26 . V_27 . V_164 = - 1 ;
V_2 -> V_26 . V_27 . V_84 = V_85 ;
V_2 -> V_26 . V_27 . V_105 = V_180 ;
V_2 -> V_26 . V_181 = & V_346 ;
V_2 -> V_26 . V_7 = V_347 ;
V_2 -> V_26 . V_184 = - 1 ;
V_340 = V_2 ;
...
V_2 -> V_387 = F_59 ( sizeof( struct V_205 ) ) ;
...
return 0 ;
V_392:
if ( V_2 -> V_26 . V_98 . V_396 )
F_31 ( & V_2 -> V_26 . V_98 ) ;
V_391:
F_171 ( V_294 , V_2 ) ;
V_390:
F_83 ( V_2 -> V_170 , V_2 -> V_171 ) ;
V_389:
