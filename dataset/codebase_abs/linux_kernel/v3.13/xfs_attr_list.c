...
args . V_80 = V_52 ;
args . V_29 = V_29 ;
args . V_81 = F_7 ( V_29 , V_31 | V_32 ) ;
args . V_82 = F_22 ( V_78 -> V_83 ) ;
args . V_84 = F_30 (
args . V_13 -> V_34 , V_29 ) ;
V_72 = F_31 ( & args ) ;
if ( V_72 )
...
unsigned char * V_81 )
{
struct V_91 * V_92 = (struct V_91 * ) V_7 -> V_92 ;
T_13 * V_93 ;
int V_94 ;
ASSERT ( ! ( V_7 -> V_26 & V_95 ) ) ;
ASSERT ( V_7 -> V_16 >= 0 ) ;
ASSERT ( V_7 -> V_16 < ( V_96 / 8 ) ) ;
ASSERT ( V_7 -> V_97 >= sizeof( * V_92 ) ) ;
ASSERT ( V_7 -> V_97 <= V_7 -> V_22 ) ;
if ( ( ( V_7 -> V_26 & V_98 ) == 0 ) !=
( ( V_26 & V_99 ) == 0 ) )
return 0 ;
if ( ( ( V_7 -> V_26 & V_100 ) == 0 ) !=
...
V_93 = ( T_13 * ) & V_7 -> V_92 [ V_7 -> V_97 ] ;
V_93 -> V_104 = V_29 ;
memcpy ( V_93 -> V_105 , V_36 , V_28 ) ;
V_93 -> V_105 [ V_28 ] = 0 ;
V_92 -> V_102 [ V_7 -> V_16 ++ ] = V_7 -> V_97 ;
V_92 -> V_106 = V_7 -> V_16 ;
F_45 ( V_7 ) ;
return 0 ;
}
...
struct V_91 * V_92 ;
int error ;
if ( V_8 -> V_108 || V_8 -> V_109 )
return ( F_11 ( V_110 ) ) ;
if ( ( V_8 -> V_37 == 0 ) &&
( V_8 -> V_39 || V_8 -> V_38 || V_8 -> V_40 ) )
return F_11 ( V_110 ) ;
if ( ( ( long ) V_107 ) & ( sizeof( int ) - 1 ) )
return F_11 ( V_111 ) ;
if ( V_26 & V_95 )
V_22 = 0 ;
...
V_7 . V_97 = V_7 . V_22 ;
V_7 . V_25 = F_42 ;
V_92 = (struct V_91 * ) V_7 . V_92 ;
V_92 -> V_106 = 0 ;
V_92 -> V_103 = 0 ;
V_92 -> V_102 [ 0 ] = V_7 . V_22 ;
error = F_35 ( & V_7 ) ;
ASSERT ( error >= 0 ) ;
return error ;
}
