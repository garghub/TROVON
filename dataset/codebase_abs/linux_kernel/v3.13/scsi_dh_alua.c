...
return V_59 ;
if ( V_55 -> V_62 == 0x29 && V_55 -> V_63 == 0x04 )
return V_59 ;
...
static int F_27 ( struct V_2 * V_3 , struct V_1 * V_6 , int V_93 )
{
struct V_54 V_55 ;
...
unsigned char V_101 ;
if ( ! V_6 -> V_102 )
V_98 = F_28 ( V_103 + V_31 * V_32 ) ;
else
V_98 = F_28 ( V_103 + V_6 -> V_102 * V_32 ) ;
V_79:
...
V_94 < V_7 ;
V_94 += V_95 , V_97 += V_95 ) {
if ( V_6 -> V_66 == ( V_97 [ 2 ] << 8 ) + V_97 [ 3 ] ) {
V_6 -> V_64 = V_97 [ 0 ] & 0x0f ;
V_6 -> V_107 = V_97 [ 0 ] >> 7 ;
V_96 = V_97 [ 1 ] ;
}
V_95 = 8 + ( V_97 [ 7 ] * 4 ) ;
...
static int F_32 ( struct V_2 * V_3 , const char * V_117 )
{
...
V_6 -> V_3 = V_3 ;
V_33 = F_31 ( V_3 , V_6 ) ;
if ( ( V_33 != V_56 ) && ( V_33 != V_115 ) )
goto V_140;
if ( ! F_38 ( V_141 ) )
goto V_140;
F_39 ( V_3 -> V_18 -> V_142 , V_123 ) ;
V_3 -> V_4 = V_4 ;
F_40 ( V_3 -> V_18 -> V_142 , V_123 ) ;
F_8 ( V_143 , V_3 , L_21 , V_45 ) ;
return 0 ;
V_140:
F_4 ( V_4 ) ;
F_8 ( V_135 , V_3 , L_22 , V_45 ) ;
return - V_122 ;
}
