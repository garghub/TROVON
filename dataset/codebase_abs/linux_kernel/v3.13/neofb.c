...
V_270 = F_85 ( & V_21 -> V_164 , 256 , 0 ) ;
if ( V_270 < 0 )
goto V_275;
V_270 = F_86 ( V_21 ) ;
if ( V_270 < 0 )
goto V_277;
V_20 ( V_21 , L_45 , V_21 -> V_35 . V_249 ) ;
F_87 ( V_225 , V_21 ) ;
return 0 ;
V_277:
F_80 ( & V_21 -> V_164 ) ;
...
static int T_9 F_92 ( char * V_278 )
{
char * V_279 ;
F_37 ( L_48 ) ;
if ( ! V_278 || ! * V_278 )
return 0 ;
while ( ( V_279 = F_93 ( & V_278 , L_49 ) ) != NULL ) {
if ( ! * V_279 )
continue;
if ( ! strncmp ( V_279 , L_23 , 8 ) )
V_253 = 1 ;
else if ( ! strncmp ( V_279 , L_24 , 8 ) )
V_254 = 1 ;
else if ( ! strncmp ( V_279 , L_50 , 9 ) )
V_252 = 1 ;
else if ( ! strncmp ( V_279 , L_51 , 10 ) )
V_251 = 1 ;
else if ( ! strncmp ( V_279 , L_52 , 8 ) )
V_104 = 1 ;
else
V_274 = V_279 ;
}
