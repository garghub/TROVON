...
V_114 = F_8 ( V_2 ) ;
if ( V_114 ) {
F_41 ( & V_5 -> V_112 , L_1 , - V_114 ) ;
return V_114 ;
}
V_114 = F_9 ( V_2 , & V_27 ) ;
if ( V_114 ) {
F_41 ( & V_5 -> V_112 , L_2 , - V_114 ) ;
return V_114 ;
}
F_42 ( & V_2 -> V_82 ) ;
V_2 -> V_21 = 0x0 ;
...
V_2 -> V_86 = 1 ;
V_100 ( & V_5 -> V_112 , L_3 , V_27 >> 4 , V_27 & 0x0f ) ;
V_70 -> V_117 = V_5 -> V_117 ;
V_70 -> V_118 = V_119 ;
V_70 -> V_120 = F_44 ( V_119 ) ;
V_70 -> V_112 . V_121 = & V_5 -> V_112 ;
V_70 -> V_122 = V_123 ;
if ( V_5 -> V_98 )
V_70 -> V_94 = & V_124 ;
else
...
V_70 ) ;
if ( V_114 ) {
F_41 ( & V_5 -> V_112 , L_5 , - V_114 ) ;
return V_114 ;
}
}
V_114 = F_5 ( V_2 ) ;
if ( V_114 ) {
F_41 ( & V_5 -> V_112 , L_6 , - V_114 ) ;
return V_114 ;
}
F_46 ( & V_2 -> V_25 , F_6 ) ;
F_19 ( & V_2 -> V_25 , 5 * V_50 ) ;
...
static int F_53 ( struct V_129 * V_112 )
{
struct V_1 * V_2 = F_50 ( F_54 ( V_112 ) ) ;
int V_11 ;
F_27 ( & V_2 -> V_82 ) ;
V_11 = F_1 ( V_2 , 0 ) ;
if ( V_11 )
...
static int F_55 ( struct V_129 * V_112 )
{
struct V_1 * V_2 = F_50 ( F_54 ( V_112 ) ) ;
int V_11 ;
F_27 ( & V_2 -> V_82 ) ;
