...
int V_4 = - V_5 , V_19 ;
F_51 (i, d) {
V_64 -> V_101 = F_59 ( & V_64 -> V_98 , false , & T_5 ) ;
if ( ! V_64 -> V_101 ) {
F_3 ( L_25 , V_64 -> V_98 . V_99 ) ;
V_4 = - V_49 ;
goto V_108;
}
V_4 = F_60 ( V_64 -> V_101 , & T_5 ) ;
if ( V_4 ) {
...
break;
if ( V_31 -> V_35 . V_37 )
V_119 = V_31 -> V_35 . V_40 ;
else
V_119 = F_8 ( V_25 , V_31 ) ;
if ( V_119 > 0.0 )
F_11 ( V_18 , V_42 , L_33 , V_119 ) ;
break;
case V_122 :
if ( V_25 -> V_114 )
break;
...
static int F_69 ( struct V_109 * V_126 , struct V_110 * V_111 ,
struct V_24 * V_25 )
{
struct V_65 * V_66 =
F_29 ( V_126 , struct V_65 , V_69 ) ;
char V_18 [ V_127 ] = L_27 ;
F_68 ( V_25 , V_66 , V_18 , V_127 ) ;
if ( V_116 . V_117 )
return F_11 ( V_111 -> V_18 , V_111 -> V_42 , L_35 , V_18 ) ;
else
return F_11 ( V_111 -> V_18 , V_111 -> V_42 , L_29 ,
V_66 -> V_115 , V_18 ) ;
}
static int F_70 ( struct V_109 * V_69 ,
struct V_110 * V_111 )
{
struct V_65 * V_66 =
F_29 ( V_69 , struct V_65 , V_69 ) ;
...
static int F_71 ( struct V_109 * V_69 ,
...
V_58 = V_130 [ V_66 -> V_68 ] . V_131 ;
V_129 = V_130 [ V_66 -> V_68 ] . V_129 ;
F_15 ( ! V_58 ) ;
if ( V_105 > 2 )
F_11 ( V_18 , F_73 , L_36 , V_58 , V_64 -> V_68 ) ;
#define F_74 (data__files_cnt > 2 ? buf : header)
V_66 -> V_115 = V_129 ;
V_129 = ( int ) strlen ( F_74 ) ;
if ( V_66 -> V_115 < V_129 )
V_66 -> V_115 = V_129 ;
F_11 ( V_128 , F_73 , L_29 ,
V_66 -> V_115 , F_74 ) ;
V_66 -> V_58 = F_75 ( V_128 ) ;
#undef F_73
#undef F_74
}
...
int V_19 ;
F_51 (i, d) {
F_76 ( V_64 , V_19 ? V_134 [ V_10 ] :
V_125 ) ;
if ( V_135 && V_19 )
F_76 ( V_64 , V_123 ) ;
if ( V_136 )
F_76 ( V_64 , V_19 ? V_124 :
V_118 ) ;
}
}
static int F_79 ( int V_137 , const char * * V_138 )
{
struct V_63 * V_64 ;
static const char * V_139 [] = {
L_37 ,
L_38 ,
} ;
bool V_140 = true ;
...
V_78 = F_80 ( sizeof( * V_78 ) * V_105 ) ;
if ( ! V_78 )
return - V_49 ;
F_51 (i, d) {
struct V_143 * V_98 = & V_64 -> V_98 ;
V_98 -> V_99 = V_140 ? V_139 [ V_19 ] : V_138 [ V_19 ] ;
V_98 -> V_144 = V_145 ,
V_98 -> V_146 = V_146 ,
V_64 -> V_68 = V_19 ;
}
...
int F_81 ( int V_137 , const char * * V_138 , const char * T_7 V_14 )
{
V_147 = V_148 ;
V_137 = F_82 ( V_137 , V_138 , V_149 , V_150 , 0 ) ;
if ( F_83 () < 0 )
return - 1 ;
if ( F_79 ( V_137 , V_138 ) < 0 )
return - 1 ;
F_78 () ;
if ( F_84 () < 0 )
F_85 ( V_150 , V_149 ) ;
