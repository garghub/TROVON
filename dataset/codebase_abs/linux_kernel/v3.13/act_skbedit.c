...
return - V_38 ;
V_33 = F_8 ( V_30 [ V_40 ] ) ;
V_35 = F_9 ( V_33 -> V_44 , V_4 , V_29 , & V_45 ) ;
if ( ! V_35 ) {
...
struct F_1 * V_7 = V_4 -> V_8 ;
if ( V_7 )
return F_14 ( & V_7 -> V_50 , V_29 , & V_45 ) ;
return 0 ;
}
static int F_19 ( struct V_1 * V_2 , struct V_3 * V_4 ,
int V_29 , int V_51 )
{
unsigned char * V_52 = F_20 ( V_2 ) ;
struct F_1 * V_7 = V_4 -> V_8 ;
struct V_32 V_53 = {
. V_44 = V_7 -> V_54 ,
. V_55 = V_7 -> V_56 - V_51 ,
...
struct V_59 V_60 ;
if ( F_21 ( V_2 , V_40 , sizeof( V_53 ) , & V_53 ) )
goto V_61;
if ( ( V_7 -> V_14 & V_15 ) &&
...
& V_7 -> V_22 ) )
goto V_61;
V_60 . V_62 = F_22 ( V_12 - V_7 -> V_10 . V_62 ) ;
V_60 . V_11 = F_22 ( V_12 - V_7 -> V_10 . V_11 ) ;
V_60 . V_63 = F_22 ( V_7 -> V_10 . V_63 ) ;
if ( F_21 ( V_2 , V_64 , sizeof( V_60 ) , & V_60 ) )
goto V_61;
return V_2 -> V_65 ;
V_61:
F_23 ( V_2 , V_52 ) ;
