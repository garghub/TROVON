...
static int F_42 ( struct V_8 * V_22 )
{
int V_7 = 0 ;
if ( F_43 ( & V_22 -> V_44 ) ) {
F_44 ( & V_22 -> V_45 ) ;
...
static int
F_49 ( struct V_4 * V_4 , struct V_15 * V_16 , T_3 V_47 ,
...
V_51 -> V_58 = V_59 ;
V_51 -> V_60 = 0 ;
if ( F_21 ( V_16 , V_27 , F_22 ( V_3 -> V_86 ) ) ||
F_23 ( V_16 , V_28 , V_3 -> V_3 ) )
goto V_62;
if ( F_2 ( V_3 -> V_8 . V_63 ) ) {
struct V_5 * V_64 ;
unsigned int * V_1 = V_3 -> V_85 ( V_4 ) ;
int V_7 ;
V_64 = F_27 ( V_16 ,
V_29 | V_65 ) ;
if ( ! V_64 )
...
static int F_50 ( struct V_13 * V_14 , struct V_15 * V_16 ,
const struct V_17 * V_18 ,
const struct V_5 * const V_19 [] )
{
T_1 V_20 ;
...
V_7 = F_49 ( V_4 , V_79 , F_34 ( V_16 ) . V_47 ,
V_18 -> V_71 ,
F_35 ( V_18 -> V_72 ) ,
V_87 ,
V_3 ) ;
...
static struct V_8 * F_51 ( const char * V_25 )
{
struct V_8 * V_22 , * V_23 = NULL ;
F_32 () ;
...
static void F_55 ( struct V_8 * V_22 )
{
F_56 ( & V_22 -> V_44 ) ;
F_54 ( V_88 ) ;
}
...
{
struct V_8 * V_69 , * V_93 ;
F_63 ( L_3 ) ;
F_64 ( & V_89 ) ;
F_65 (cur, tmp, &cttimeout_list, head) {
F_44 ( & V_69 -> V_45 ) ;
F_16 ( V_69 -> V_3 ) ;
F_45 ( V_69 , V_84 ) ;
}
