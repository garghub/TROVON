...
strcpy ( V_138 -> V_139 , L_23 ) ;
strcpy ( V_138 -> V_140 , L_23 ) ;
...
return - V_128 ;
V_168 -> type = V_170 ;
sprintf ( V_168 -> V_118 , L_27 , V_168 -> V_106 ) ;
return 0 ;
}
...
{
const struct V_245 * V_246 = F_102 ( L_31 ) ;
int V_157 = 0 , V_163 ;
if ( V_246 == NULL ) {
F_103 ( V_247 L_32 ) ;
return - V_248 ;
