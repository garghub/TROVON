...
extern void F_43 ( struct V_143 * V_144 )
{
...
extern void F_56 ( struct V_1 * V_2 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
extern void F_58 ( struct V_1 * V_2 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
V_4 -> V_187 = false ;
V_4 -> V_188 = false ;
...
extern void F_60 ( struct V_1 * V_2 ,
T_2 V_190 ,
T_2 V_191 )
{
if ( V_190 == V_192 )
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
T_3 V_222 = ( T_3 ) & ( V_4 -> V_23 ) ;
if( V_219 == 0 )
{
if( V_220 > 1 )
V_220 = 1 ;
V_223 . V_224 = ( T_4 ) V_220 ;
}
else if( V_219 == 1 )
{
if( V_220 > 1 )
V_220 = 1 ;
V_223 . V_225 = ( T_4 ) V_220 ;
}
else if( V_219 == 2 )
{
if( V_220 > 40 )
V_220 = 40 ;
V_223 . V_226 = ( T_4 ) V_220 ;
}
else if( V_219 == 3 )
{
if( V_220 > 25 )
V_220 = 25 ;
V_223 . V_227 = ( T_4 ) V_220 ;
}
else if( V_219 == 4 )
{
if( V_220 >= V_228 )
V_220 = V_229 ;
V_223 . V_230 = ( T_4 ) V_220 ;
}
else if( V_219 == 10 )
{
if( V_220 > 100 )
V_220 = 50 ;
V_223 . V_231 [ 0 ] = ( T_4 ) V_220 ;
}
else if( V_219 == 11 )
{
if( V_220 > 100 )
V_220 = 50 ;
V_223 . V_231 [ 1 ] = ( T_4 ) V_220 ;
}
else if( V_219 == 12 )
{
if( V_220 > 100 )
V_220 = 50 ;
V_223 . V_231 [ 2 ] = ( T_4 ) V_220 ;
}
else if( V_219 == 13 )
{
if( V_220 > 100 )
V_220 = 50 ;
V_223 . V_231 [ 3 ] = ( T_4 ) V_220 ;
}
else if( V_219 == 20 )
{
if( V_220 > 1 )
V_220 = 1 ;
V_222 -> V_37 = ( T_4 ) V_220 ;
}
else if( V_219 == 21 )
{
if( V_220 > 30 )
...
if( V_171 . V_248 == V_171 . V_245 )
{
if( V_171 . V_245 == V_246 )
{
if( ( V_171 . V_208 + 10 - V_171 . V_214 ) > V_171 . V_218 )
V_171 . V_260 = V_171 . V_218 ;
else if( ( V_171 . V_208 + 10 - V_171 . V_214 ) < V_171 . V_216 )
V_171 . V_260 = V_171 . V_216 ;
else
V_171 . V_260 = V_171 . V_208 + 10 - V_171 . V_214 ;
}
else
{
if( V_171 . V_260 == 0 )
V_171 . V_260 = V_4 -> V_261 [ 0 ] ;
else
V_171 . V_260 = V_171 . V_262 ;
}
}
else
{
...
F_35 ( V_2 , V_175 , & V_259 ) ;
if ( V_171 . V_262 != V_259 )
V_258 = 1 ;
{
if( ( V_171 . V_262 != V_171 . V_260 )
|| ! V_257 || V_258 )
{
V_256 = ( T_4 ) V_171 . V_260 ;
F_31 ( V_2 , V_175 , V_256 ) ;
F_31 ( V_2 , V_178 , V_256 ) ;
F_31 ( V_2 , V_180 , V_256 ) ;
F_31 ( V_2 , V_182 , V_256 ) ;
V_171 . V_262 = V_171 . V_260 ;
V_257 = 1 ;
V_258 = 0 ;
}
}
...
( V_171 . V_208 < V_171 . V_236 ) )
V_171 . V_263 = V_266 ;
else
V_171 . V_263 = V_171 . V_267 ;
}
else
{
V_171 . V_263 = V_265 ;
...
{
if( ( V_171 . V_267 != V_171 . V_263 ) ||
( V_257 <= 3 ) || V_258 )
{
if( V_171 . V_263 == V_265 )
{
if ( V_4 -> V_66 != V_67 )
{
F_31 ( V_2 , ( V_251 + 3 ) , 0x00 ) ;
...
{
if( ( V_171 . V_271 != V_171 . V_268 ) ||
! V_257 || V_258 )
{
if( V_171 . V_268 == V_269 )
{
F_31 ( V_2 , 0xa0a , 0x08 ) ;
}
else if( V_171 . V_268 == V_270 )
{
F_31 ( V_2 , 0xa0a , 0xcd ) ;
}
V_171 . V_271 = V_171 . V_268 ;
V_257 = 1 ;
V_258 = 0 ;
}
}
...
if( V_11 > 4 * V_10 )
{
if( ! V_4 -> V_274 || ! V_4 -> V_272 )
{
F_14 ( V_2 , V_278 , V_279 [ V_6 -> V_280 ] ) ;
V_4 -> V_274 = true ;
}
}
else
...
if( V_4 -> V_274 || ! V_4 -> V_272 )
{
F_14 ( V_2 , V_278 , V_281 [ V_6 -> V_280 ] ) ;
V_4 -> V_274 = false ;
}
}
V_4 -> V_272 = true ;
...
T_4 V_282 ;
T_2 V_283 ;
struct V_284 * V_285 = & V_4 -> V_7 -> V_120 . V_286 . V_287 ;
T_4 V_57 = V_4 -> V_7 -> V_57 ;
F_6 ( V_2 ) ;
V_282 = V_285 -> V_288 [ 0 ] * ( ( V_57 & ( V_289 | V_290 ) ) ? 9 : 20 ) + V_291 ;
V_283 = ( ( ( ( T_2 ) ( V_285 -> V_292 [ 0 ] ) ) << V_293 ) |
( ( ( T_2 ) ( V_285 -> V_294 [ 0 ] ) ) << V_295 ) |
( ( ( T_2 ) ( V_285 -> V_296 [ 0 ] ) ) << V_297 ) |
( ( T_2 ) V_282 << V_298 ) ) ;
F_14 ( V_2 , V_278 , V_283 ) ;
{
T_8 V_299 = ( T_8 ) & ( V_285 -> V_288 [ 0 ] ) ;
T_4 V_300 ;
F_35 ( V_2 , V_301 , & V_300 ) ;
...
F_29 ( V_305 , L_41 , V_300 ) ;
F_31 ( V_2 , V_301 , V_300 ) ;
}
}
V_4 -> V_272 = false ;
}
...
extern void F_69 ( struct V_1 * V_2 , T_2 V_219 , T_2 V_220 )
{
struct V_3 * V_4 = F_2 ( (struct V_1 * ) V_2 ) ;
if ( V_219 == 0 )
{
if( V_220 > 1 )
V_220 = 1 ;
V_4 -> V_7 -> V_306 = ( bool ) V_220 ;
}
else if( V_219 == 1 )
{
if( V_220 >= 50 )
V_220 = 50 ;
V_4 -> V_7 -> V_307 = ( T_4 ) V_220 ;
}
}
...
struct V_3 * V_4 = F_2 ( V_2 ) ;
T_4 V_311 ;
F_35 ( V_2 , V_312 , & V_311 ) ;
if( V_311 == 0xff )
return;
if ( V_311 & V_313 || V_311 & V_314 )
{
F_29 ( V_315 , L_42 ) ;
V_4 -> V_316 = true ;
}
}
extern void F_70 ( struct V_143 * V_144 )
{
struct V_145 * V_146 = F_44 ( V_144 , struct V_145 , V_144 ) ;
struct V_3 * V_4 = F_44 ( V_146 , struct V_3 , V_317 ) ;
struct V_1 * V_2 = V_4 -> V_7 -> V_2 ;
T_4 V_318 = 0 , V_88 ;
F_35 ( V_2 , 0xc04 , & V_318 ) ;
for ( V_88 = 0 ; V_88 < V_319 ; V_88 ++ )
{
if ( V_318 & ( 0x01 << V_88 ) )
V_4 -> V_320 [ V_88 ] = 1 ;
else
...
V_223 . V_231 [ V_88 ] = 50 ;
V_223 . V_325 [ V_88 ] = - 64 ;
V_223 . V_326 [ V_88 ] = 100 ;
}
}
static void F_71 ( struct V_1 * V_2 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
T_4 V_88 , V_327 = 0 , V_328 = 0 , V_329 = 0 , V_330 = 0 ;
T_4 V_331 = 0 , V_332 = 0 , V_333 = 0 ;
T_4 V_334 = 0x2 ;
T_4 V_335 = 0x3 ;
long V_336 = 0 , V_337 = 0 , V_338 = 0 ;
T_4 V_339 = 0 , V_340 = 0 , V_341 = 0 ;
T_4 V_342 ;
long V_343 ;
static T_4 V_344 , V_345 ;
T_4 V_346 ;
if( V_4 -> V_39 != V_40 )
return;
if( ! V_345 )
{
F_35 ( V_2 , 0xa07 , & V_223 . V_347 ) ;
V_223 . V_347 &= 0xf ;
V_345 = 1 ;
}
F_35 ( V_2 , 0xc04 , & V_223 . V_324 ) ;
V_223 . V_324 = ~ V_223 . V_324 & 0xf ;
if( V_4 -> V_7 -> V_57 == V_348 )
{
V_223 . V_230 = V_323 ;
}
for ( V_88 = 0 ; V_88 < V_319 ; V_88 ++ )
{
if( ! V_223 . V_225 )
V_223 . V_231 [ V_88 ] = V_4 -> V_12 . V_349 [ V_88 ] ;
if( V_4 -> V_320 [ V_88 ] )
{
V_330 ++ ;
V_342 = V_223 . V_231 [ V_88 ] ;
if( V_330 == 1 )
{
V_327 = V_328 = V_329 = V_88 ;
V_331 = V_332 = V_333 = V_342 ;
}
else if( V_330 == 2 )
{
if( V_342 >= V_331 )
...
else if( ( V_342 < V_331 ) && ( V_342 > V_333 ) )
{
V_333 = V_342 ;
V_329 = V_88 ;
}
...
else if( ( V_342 < V_333 ) && ( V_342 > V_332 ) )
{
}
else if( V_342 == V_332 )
{
...
{
V_330 ++ ;
V_343 = V_223 . V_325 [ V_88 ] ;
if( V_330 == 1 )
{
V_339 = V_340 = V_341 = V_88 ;
V_336 = V_337 = V_338 = V_343 ;
}
else if( V_330 == 2 )
{
if( V_343 >= V_336 )
...
else if( ( V_343 < V_336 ) && ( V_343 > V_338 ) )
{
V_338 = V_343 ;
V_341 = V_88 ;
}
...
else if( ( V_343 < V_338 ) && ( V_343 > V_337 ) )
{
}
else if( V_343 == V_337 )
{
...
if( V_332 < V_223 . V_226 && V_344 < 2 )
{
if( ( V_331 - V_332 ) >= V_223 . V_227 )
{
V_223 . V_326 [ V_328 ] = V_331 + 5 ;
F_37 ( V_2 , V_350 , 0x1 << V_328 , 0x0 ) ;
F_37 ( V_2 , V_351 , 0x1 << V_328 , 0x0 ) ;
V_344 ++ ;
}
if( V_223 . V_230 == V_229 )
{
V_334 = V_327 ;
V_335 = V_329 ;
if( V_331 )
...
if( V_346 )
{
V_223 . V_347 = ( V_334 << 2 ) | ( V_335 ) ;
F_37 ( V_2 , V_352 , 0x0f000000 , V_223 . V_347 ) ;
}
if( V_223 . V_324 )
{
for( V_88 = 0 ; V_88 < 4 ; V_88 ++ )
{
if( ( V_223 . V_324 >> V_88 ) & 0x1 )
{
if( V_331 >= V_223 . V_326 [ V_88 ] )
{
F_37 ( V_2 , V_350 , 0x1 << V_88 , 0x1 ) ;
F_37 ( V_2 , V_351 , 0x1 << V_88 , 0x1 ) ;
V_223 . V_326 [ V_88 ] = 100 ;
V_344 -- ;
}
}
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_49 ( V_4 -> V_156 , & V_4 -> V_317 , 0 ) ;
}
static void F_8 ( struct V_1 * V_2 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
V_4 -> V_7 -> V_353 = 500 ;
V_4 -> V_7 -> V_354 = 0x0f000800 ;
V_4 -> V_7 -> V_355 = 30 ;
V_4 -> V_7 -> V_356 = false ;
V_4 -> V_7 -> V_357 = 3 ;
V_4 -> V_7 -> V_358 = 100 ;
...
extern void V_365 ( unsigned long V_363 )
{
...
if( V_4 -> V_7 -> V_60 == V_61 &&
V_4 -> V_7 -> V_356 &&
( V_4 -> V_7 -> V_6 -> V_276 & V_371 ) )
{
T_2 V_372 ;
for( V_366 = 0 ; V_366 <= 27 ; V_366 ++ )
{
V_372 = 1 << V_366 ;
if( V_4 -> V_7 -> V_354 & V_372 )
...
if( V_4 -> V_5 > V_4 -> V_7 -> V_355 && V_369 )
{
V_370 = true ;
V_4 -> V_187 = ! V_4 -> V_187 ;
if( V_4 -> V_187 )
...
if( F_74 ( & V_4 -> V_362 ) )
F_73 ( & V_4 -> V_362 ) ;
V_4 -> V_362 . V_379 = V_380 + F_75 ( V_4 -> V_7 -> V_353 * V_4 -> V_7 -> V_357 ) ;
F_76 ( & V_4 -> V_362 ) ;
}
else{
if( F_74 ( & V_4 -> V_362 ) )
F_73 ( & V_4 -> V_362 ) ;
V_4 -> V_362 . V_379 = V_380 + F_75 ( V_4 -> V_7 -> V_353 ) ;
F_76 ( & V_4 -> V_362 ) ;
}
}
else
...
#define F_83 2
struct V_3 * V_4 = F_2 ( V_2 ) ;
static T_4 V_385 = F_81 ;
static T_2 V_249 ;
F_29 ( V_378 , L_46 , V_4 -> V_7 -> V_355 , V_4 -> V_7 -> V_353 , V_4 -> V_7 -> V_357 ) ;
F_29 ( V_378 , L_47 , V_4 -> V_7 -> V_354 , V_4 -> V_7 -> V_358 , V_4 -> V_7 -> V_359 ) ;
if( V_4 -> V_7 -> V_60 == V_61 &&
( V_4 -> V_7 -> V_6 -> V_276 & V_371 ) )
{
if( V_4 -> V_7 -> V_356 == 0 )
{
switch ( V_4 -> V_7 -> V_360 )
{
case V_361 :
F_77 ( V_2 ) ;
V_4 -> V_7 -> V_360 = V_386 ;
...
extern void F_84 ( struct V_1 * V_2 )
{
T_4 V_391 ;
T_6 V_392 ;
...
if( ( V_4 -> V_7 -> V_120 . V_399 ) && ( V_4 -> V_7 -> V_57 == V_289 ) ) {
V_397 = V_400 ;
V_398 = V_401 ;
}
else
...
#if F_85 ( F_52 ) || F_85 ( V_405 )
F_86 ( V_406 , V_407 -> V_408 ) ;
#endif
F_87 ( V_2 , V_4 -> V_7 -> V_120 . V_121 ) ;
}
V_4 -> V_394 = V_4 -> V_101 ;
V_4 -> V_395 = V_4 -> V_396 ;
}
