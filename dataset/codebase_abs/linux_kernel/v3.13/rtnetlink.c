...
struct V_28 * F_155 ( struct V_27 * V_27 ,
...
V_194 = V_20 -> V_318 () ;
V_26 = - V_307 ;
V_29 = F_156 ( V_20 -> V_319 , V_293 , V_20 -> V_320 ,
V_192 , V_194 ) ;
if ( ! V_29 )
goto V_26;
F_157 ( V_29 , V_27 ) ;
...
static int F_159 ( struct V_27 * V_27 , int V_53 ,
struct V_97 * V_98 ,
struct V_32 * * V_259 )
{
struct V_28 * V_29 ;
...
static int F_160 ( struct V_39 * V_40 , struct V_60 * V_61 )
{
struct V_27 * V_27 = F_107 ( V_40 -> V_252 ) ;
const struct V_18 * V_20 ;
struct V_28 * V_29 ;
...
if ( F_128 ( V_329 ) )
return F_129 ( V_329 ) ;
V_29 = F_155 ( V_329 , V_293 , V_20 , V_259 ) ;
if ( F_128 ( V_29 ) ) {
V_26 = F_129 ( V_29 ) ;
goto V_45;
}
...
static int F_166 ( struct V_39 * V_40 , struct V_60 * V_61 )
{
struct V_27 * V_27 = F_107 ( V_40 -> V_252 ) ;
struct V_97 * V_98 ;
char V_293 [ V_146 ] ;
...
if ( V_29 == NULL )
return - V_303 ;
V_339 = F_167 ( F_84 ( V_29 , V_129 ) , V_15 ) ;
if ( V_339 == NULL )
return - V_16 ;
...
static T_8 F_170 ( struct V_39 * V_40 , struct V_60 * V_61 )
{
struct V_27 * V_27 = F_107 ( V_40 -> V_252 ) ;
struct V_28 * V_29 ;
struct V_32 * V_259 [ V_260 + 1 ] ;
...
V_340 = F_171 ( T_8 , V_340 ,
F_84 ( V_29 ,
V_129 ) ) ;
}
return V_340 ;
}
static int F_172 ( struct V_39 * V_40 , struct V_250 * V_251 )
{
int V_255 ;
...
void F_173 ( int type , struct V_28 * V_29 , unsigned int V_166 ,
T_6 V_62 )
{
...
int V_26 = - V_16 ;
T_4 V_345 ;
V_40 = F_167 ( ( V_345 = F_84 ( V_29 , 0 ) ) , V_62 ) ;
if ( V_40 == NULL )
goto V_295;
...
F_58 ( V_40 , V_27 , 0 , V_346 , NULL , V_62 ) ;
return;
V_295:
if ( V_26 < 0 )
...
F_21 ( L_14 ) ;
F_218 ( & V_430 ) ;
F_20 ( V_12 , V_431 , F_166 ,
F_106 , F_170 ) ;
F_20 ( V_12 , V_432 , F_148 , NULL , NULL ) ;
F_20 ( V_12 , V_267 , F_160 , NULL , NULL ) ;
F_20 ( V_12 , V_433 , F_151 , NULL , NULL ) ;
F_20 ( V_12 , V_434 , NULL , F_172 , NULL ) ;
F_20 ( V_12 , V_435 , NULL , F_172 , NULL ) ;
