...
return;
V_110 = F_115 ( V_186 ) ;
if ( V_110 >= V_111 || ! F_116 ( V_110 ) )
return;
V_6 -> V_110 = V_110 ;
return;
}
static int T_8
F_117 ( struct V_187 * V_34 ,
...
T_2 V_1 , V_127 ;
struct V_190 * V_191 ;
V_183 = F_118 ( V_34 -> V_156 , & V_1 , & V_127 ) ;
if ( F_119 ( V_183 ) )
return 1 ;
V_183 = F_120 ( V_34 -> V_156 , & V_191 ) ;
if ( F_119 ( V_183 ) )
return 1 ;
if ( strncmp ( L_71 , V_191 -> V_192 . string , 7 ) == 0 ) {
V_1 += V_193 ;
if ( ! V_31 )
V_31 = F_61 ( V_194 , 16 ) ;
}
...
#ifdef F_90
{
struct V_181 * V_201 = NULL ;
while ( ( V_201 = F_130 ( V_201 ) ) != NULL )
F_107 ( V_201 ) ;
}
#endif
#ifdef F_131
...
static int F_134 ( struct V_34 * V_35 , T_6 V_203 )
{
return 0 ;
}
static int T_8
