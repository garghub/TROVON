...
F_2 ( L_6 , V_2 -> V_7 ,
V_2 -> V_77 [ 0 ] [ 0 ] , V_2 -> V_77 [ 0 ] [ 1 ] ,
V_2 -> V_77 [ 0 ] [ 2 ] , V_2 -> V_77 [ 0 ] [ 3 ] ,
V_2 -> V_77 [ 0 ] [ 4 ] , V_2 -> V_77 [ 0 ] [ 5 ] ,
V_2 -> V_77 [ 0 ] [ 6 ] , V_2 -> V_77 [ 0 ] [ 7 ] ) ;
}
...
V_2 -> V_196 = V_2 -> V_194 ;
F_2 ( L_10 , V_2 -> V_7 , V_2 -> V_193 , V_2 -> V_194 ) ;
}
...
F_2 ( L_12 , V_2 -> V_7 , V_13 -> V_5 , V_13 -> V_213 ) ;
if ( ! V_13 -> V_5 )
...
F_12 ( V_2 ) ;
V_15 = F_67 ( V_2 , V_188 , & V_185 -> V_133 ) ;
F_2 ( L_14 , V_2 -> V_7 , & V_185 -> V_133 , V_15 ) ;
if ( V_5 ) {
...
( V_15 -> type == V_188 || V_15 -> type == V_345 ) ) {
if ( V_302 -> V_5 ) {
F_122 ( V_2 , & V_15 -> V_285 , V_15 -> type ,
V_15 -> V_286 , V_302 -> V_5 ) ;
} else {
...
F_2 ( L_38 , V_289 , V_289 -> V_521 , V_524 ) ;
V_525 = V_289 -> V_521 ;
...
F_2 ( L_1 , V_2 -> V_7 , V_302 -> V_5 ) ;
F_12 ( V_2 ) ;
V_15 = F_222 ( V_2 , V_345 , V_227 ) ;
if ( ! V_15 ) {
V_15 = F_95 ( V_2 , V_345 , & V_302 -> V_133 ) ;
if ( ! V_15 ) {
F_85 ( L_15 ) ;
goto V_186;
}
...
T_6 V_267 ;
while ( V_540 -- ) {
struct V_542 * V_302 = V_541 ;
V_267 = V_302 -> V_6 [ V_302 -> V_543 ] ;
F_129 ( V_2 , & V_302 -> V_133 , V_345 , V_302 -> V_532 ,
NULL , V_267 , 0 , 1 , V_302 -> V_6 , V_302 -> V_543 ) ;
V_541 += sizeof( * V_302 ) + V_302 -> V_543 + 1 ;
}
}
static void F_225 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_544 * V_302 = ( void * ) V_4 -> V_6 ;
struct V_545 V_185 ;
struct V_546 V_547 ;
struct V_14 * V_15 ;
struct V_548 * V_549 ;
F_2 ( L_16 , V_2 -> V_7 , F_14 ( V_302 -> V_16 ) ) ;
F_12 ( V_2 ) ;
V_15 = F_13 ( V_2 , F_14 ( V_302 -> V_16 ) ) ;
if ( V_15 == NULL )
goto V_441;
V_549 = F_226 ( V_2 , V_302 -> V_550 , V_302 -> V_551 ) ;
if ( V_549 == NULL )
goto V_441;
memcpy ( V_185 . V_549 , V_549 -> V_447 , sizeof( V_549 -> V_447 ) ) ;
V_185 . V_16 = F_134 ( V_15 -> V_16 ) ;
if ( V_549 -> V_552 )
V_15 -> V_242 = V_245 ;
else
V_15 -> V_242 = V_553 ;
V_15 -> V_554 = V_549 -> V_555 ;
F_103 ( V_2 , V_556 , sizeof( V_185 ) , & V_185 ) ;
if ( V_549 -> type & V_557 ) {
F_110 ( & V_549 -> V_265 ) ;
F_227 ( V_549 ) ;
}
...
return;
V_441:
V_547 . V_16 = V_302 -> V_16 ;
F_103 ( V_2 , V_558 , sizeof( V_547 ) , & V_547 ) ;
F_15 ( V_2 ) ;
}
static void F_228 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_559 * V_560 = ( void * ) V_4 -> V_6 ;
F_163 ( V_4 , sizeof( * V_560 ) ) ;
switch ( V_560 -> V_561 ) {
case V_562 :
F_221 ( V_2 , V_4 ) ;
break;
...
{
struct V_565 * V_302 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_289 ;
F_2 ( L_40 , V_2 -> V_7 , V_302 -> V_180 ) ;
F_163 ( V_4 , sizeof( * V_302 ) ) ;
V_289 = F_13 ( V_2 , V_302 -> V_180 ) ;
if ( ! V_289 )
return;
...
{
struct V_566 * V_567 = ( void * ) V_4 -> V_6 ;
T_1 V_409 = V_567 -> V_568 ;
F_12 ( V_2 ) ;
if ( V_2 -> V_569 == V_570 ) {
F_232 ( V_2 -> V_571 ) ;
V_2 -> V_571 = F_233 ( V_4 , V_572 ) ;
}
F_15 ( V_2 ) ;
F_163 ( V_4 , V_573 ) ;
if ( V_2 -> V_407 && F_170 ( V_2 -> V_407 ) -> V_408 . V_409 == V_409 ) {
struct V_574 * V_575 = ( void * ) V_2 -> V_407 -> V_6 ;
T_7 V_360 = F_14 ( V_575 -> V_360 ) ;
F_165 ( V_2 , V_360 , 0 ) ;
}
switch ( V_409 ) {
case V_576 :
