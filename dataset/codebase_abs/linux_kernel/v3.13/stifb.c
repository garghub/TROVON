...
V_116 = F_70 ( V_2 -> V_113 -> V_134 [ 0 ] ) ;
else
V_116 = F_70 ( V_2 -> V_113 -> V_134 [ 1 ] ) ;
V_2 -> V_135 = F_71 ( V_116 ) ;
if ( F_53 ( V_2 ) ) {
if ( V_114 == 8 || V_114 == 32 )
V_118 = V_114 ;
else
...
V_51 -> V_137 = F_70 ( V_2 -> V_113 -> V_134 [ 1 ] ) ;
...
V_11 -> V_151 = & V_152 ;
V_11 -> V_50 = F_73 ( F_69 ( V_2 , 1 ) , V_51 -> V_138 ) ;
V_11 -> V_153 = V_51 -> V_138 ;
V_11 -> V_154 = V_155 ;
V_11 -> V_106 = & V_2 -> V_106 ;
if ( F_74 ( & V_11 -> V_156 , V_101 , 0 ) )
goto V_157;
F_63 ( V_2 ) ;
if ( ! F_75 ( V_51 -> V_137 , V_51 -> V_138 , L_13 ) ) {
F_66 ( V_120 L_14 ,
V_51 -> V_137 , V_51 -> V_137 + V_51 -> V_138 ) ;
goto V_158;
}
if ( ! F_75 ( V_51 -> V_127 , V_51 -> V_128 , L_15 ) ) {
F_66 ( V_120 L_16 ,
...
return 0 ;
V_160:
F_77 ( V_51 -> V_127 , V_51 -> V_128 ) ;
V_159:
F_77 ( V_51 -> V_137 , V_51 -> V_138 ) ;
V_158:
F_78 ( & V_11 -> V_156 ) ;
V_157:
F_79 ( V_11 -> V_50 ) ;
...
F_87 ( V_113 -> V_11 ) ;
F_77 ( V_11 -> V_51 . V_127 , V_11 -> V_51 . V_128 ) ;
F_77 ( V_11 -> V_51 . V_137 , V_11 -> V_51 . V_138 ) ;
if ( V_11 -> V_50 )
F_79 ( V_11 -> V_50 ) ;
F_78 ( & V_11 -> V_156 ) ;
F_88 ( V_11 ) ;
...
if ( * V_169 ++ != ':' )
break;
V_168 [ V_163 ] = F_89 ( V_169 , & V_169 , 10 ) ;
}
}
return 1 ;
}
