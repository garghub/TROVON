...
V_23 -> V_153 -> V_154 . V_147 |= F_74 ( V_155 ) ;
else if ( V_101 -> V_151 == V_156 )
V_23 -> V_153 -> V_154 . V_147 |= F_74 ( V_157 ) ;
}
memcpy ( V_23 -> V_153 -> V_154 . V_158 , V_101 -> V_159 , V_101 -> V_160 ) ;
V_23 -> V_153 -> V_154 . V_16 = F_74 ( V_144 ) ;
V_23 -> V_161 = V_101 -> V_4 -> V_34 ;
V_23 -> V_153 -> V_154 . V_147 |= F_74 ( V_101 -> V_4 -> V_162 ) ;
V_23 -> V_163 = V_101 -> V_164 ;
V_23 -> V_165 = V_166 ;
F_75 ( & V_134 , V_15 , V_23 , NULL ) ;
V_134 . V_16 = V_144 ;
V_134 . V_137 = NULL ;
V_134 . V_142 = F_76 ( V_101 ) ;
V_134 . V_138 = NULL ;
V_134 . V_140 = F_77 ( V_101 ) ;
V_134 . V_139 = 0 ;
...
if ( F_70 ( ! F_78 ( V_15 , V_23 , & V_134 ) ) ) {
F_79 ( V_101 ) ;
F_22 ( V_15 , V_23 ) ;
return V_150 ;
}
F_72 ( L_75 , V_23 , ( int ) V_101 -> V_4 -> V_34 ,
( int ) V_101 -> V_4 -> V_162 ) ;
F_80 ( V_15 , V_23 ) ;
return 0 ;
}
...
static int F_82 ( struct V_1 * V_15 ,
struct V_22 * * V_171 ,
struct V_143 * V_101 ,
struct V_172 * V_173 )
{
...
F_83 (element, next, queue) {
V_23 = F_84 ( V_176 , struct V_22 , V_178 ) ;
if ( V_23 -> V_101 == V_101 ) {
if ( V_173 == & V_15 -> V_179 ) {
V_175 = F_20 ( V_15 ) ;
if ( V_175 == NULL ) {
...
V_175 -> V_153 -> V_154 . V_147 |= F_74 (
( V_141 ) F_85 ( V_23 -> V_153 -> V_154 . V_147 ) ) ;
...
if ( F_71 ( V_146 , & V_15 -> V_147 ) ) {
V_101 -> V_18 = V_184 << 16 ;
F_88 ( V_101 , 0 ) ;
V_101 -> V_149 ( V_101 ) ;
return 0 ;
}
F_89 ( & V_15 -> V_185 , V_147 ) ;
V_173 = & V_15 -> V_186 ;
V_187:
V_18 = F_82 ( V_15 , & V_171 , V_101 , V_173 ) ;
if ( ! V_18 ) {
F_90 ( & V_15 -> V_185 , V_147 ) ;
return V_188 ;
...
static int F_94 ( struct V_143 * V_101 , bool V_194 )
{
struct V_1 * V_15 =
(struct V_1 * ) V_101 -> V_4 -> V_7 -> V_8 ;
if ( F_71 ( V_146 , & V_15 -> V_147 ) )
...
return F_94 ( V_101 , true ) ;
}
int F_98 ( struct V_143 * V_101 )
{
F_29 ( V_42 , L_79 , V_101 ) ;
return F_94 ( V_101 , false ) ;
}
static int F_99 ( struct V_143 * V_101 , bool V_196 )
{
struct V_1 * V_15 =
(struct V_1 * ) V_101 -> V_4 -> V_7 -> V_8 ;
struct V_22 * V_23 ;
...
F_72 ( L_83 , V_23 ,
V_101 -> V_4 -> V_34 ) ;
V_197 = F_100 ( V_15 , V_23 , 0x20 ) ;
} else {
F_72 ( L_84 , V_23 ,
V_101 -> V_4 -> V_34 , V_101 -> V_4 -> V_162 ) ;
V_197 = F_100 ( V_15 , V_23 , 0x10 ) ;
}
if ( V_197 ) {
F_22 ( V_15 , V_23 ) ;
} else {
...
return F_99 ( V_101 , false ) ;
}
int F_102 ( struct V_143 * V_101 )
{
F_29 ( V_42 , L_86 , V_101 ) ;
return F_99 ( V_101 , true ) ;
}
int F_103 ( struct V_200 * V_5 , int V_201 , int V_202 )
{
F_29 ( V_42 , L_87 , V_5 , V_201 ) ;
F_104 ( V_5 , F_105 ( V_5 ) , V_201 ) ;
return V_5 -> V_203 ;
}
int F_106 ( struct V_200 * V_5 , int type )
{
...
void F_112 ( struct V_200 * V_5 )
{
F_31 ( V_42 , & ( V_5 -> V_205 ) ,
L_90 ) ;
}
void F_113 ( struct V_1 * V_15 ,
struct V_22 * V_23 )
{
...
void F_114 ( struct V_1 * V_15 , struct V_22 * V_23 )
{
T_6 V_219 ;
T_6 V_220 ;
V_219 = F_115 ( V_221 ) ;
...
T_6 F_122 ( struct V_1 * V_15 , T_6 V_224 )
{
...
V_233 -= V_136 ;
while ( V_136 -- ) {
* V_234 ++ = F_126 ( V_15 , V_225 ) ;
V_225 ++ ;
}
}
return true ;
}
void F_127 ( V_141 V_209 , void * V_236 )
{
struct V_237 * V_238 ;
struct V_239 * V_240 ;
struct V_241 * V_242 ;
...
V_249 -> V_252 = F_85 ( V_249 -> V_252 ) ;
break;
case V_253 :
case V_254 :
V_247 = (struct V_246 * ) V_236 ;
V_247 -> V_34 = F_85 ( V_247 -> V_34 ) ;
break;
case V_255 :
case V_256 :
case V_257 :
...
V_240 -> V_261 = F_128 ( V_240 -> V_261 ) ;
V_240 -> V_262 = F_85 ( V_240 -> V_262 ) ;
V_240 -> V_263 = F_129 ( V_240 -> V_263 ) ;
V_240 -> V_161 = F_129 ( V_240 -> V_161 ) ;
V_240 -> V_162 = F_129 ( V_240 -> V_162 ) ;
V_240 -> V_264 = F_129 ( V_240 -> V_264 ) ;
break;
case V_265 :
case V_266 :
case V_267 :
...
V_238 -> V_261 = F_128 ( V_238 -> V_261 ) ;
V_238 -> V_262 = F_85 ( V_238 -> V_262 ) ;
V_238 -> V_282 = F_85 ( V_238 -> V_282 ) ;
V_238 -> V_264 = F_129 ( V_238 -> V_264 ) ;
for ( V_81 = 0 ; V_81 < 32 ; V_81 ++ )
V_238 -> V_283 [ V_81 ] = F_129 ( V_238 -> V_283 [ V_81 ] ) ;
break;
case V_284 :
case V_285 :
case V_286 :
...
V_242 -> V_290 = F_128 ( V_242 -> V_290 ) ;
V_242 -> V_291 = F_85 ( V_242 -> V_291 ) ;
V_242 -> V_262 = F_85 ( V_242 -> V_262 ) ;
V_242 -> V_161 = F_129 ( V_242 -> V_161 ) ;
break;
case V_292 :
V_244 = (struct V_243 * ) V_236 ;
V_244 -> V_293 = F_85 ( V_244 -> V_293 ) ;
V_244 -> V_294 = F_85 ( V_244 -> V_294 ) ;
break;
case V_295 :
V_110 = (struct V_245 * ) V_236 ;
for ( V_81 = 0 ; V_81 < 32 ; V_81 ++ )
V_110 -> V_296 [ V_81 ] = F_129 ( V_110 -> V_296 [ V_81 ] ) ;
break;
default:
break;
}
}
void F_130 ( V_141 V_209 , void * V_236 )
{
struct V_297 * V_298 ;
switch ( V_209 ) {
case V_299 :
...
V_298 -> V_302 . V_303 = F_129 ( V_298 -> V_302 . V_303 ) ;
V_298 -> V_82 = F_85 ( V_298 -> V_82 ) ;
V_298 -> V_304 = F_85 ( V_298 -> V_304 ) ;
V_298 -> V_305 = F_85 ( V_298 -> V_305 ) ;
V_298 -> V_306 = F_85 ( V_298 -> V_306 ) ;
V_298 -> V_307 = F_85 ( V_298 -> V_307 ) ;
break;
default:
break;
}
}
void F_131 ( union V_308 * V_309 )
{
struct V_310 * V_311 = & V_309 -> V_312 ;
struct V_313 * V_314 = & V_309 -> V_315 ;
switch ( V_309 -> V_316 . V_317 ) {
case V_318 :
V_311 -> V_319 = F_85 ( V_311 -> V_319 ) ;
break;
case V_320 :
V_314 -> V_321 = F_85 ( V_314 -> V_321 ) ;
V_314 -> V_322 = F_129 ( V_314 -> V_322 ) ;
V_314 -> V_34 . V_323 . V_324 = F_129 ( V_314 -> V_34 . V_323 . V_324 ) ;
if ( V_314 -> V_316 . V_325 >= F_132 ( struct V_313 , V_34 )
+ sizeof( struct V_326 ) ) {
V_314 -> V_34 . V_327 . V_328
= F_85 ( V_314 -> V_34 . V_327 . V_328 ) ;
V_314 -> V_34 . V_327 . V_329
= F_85 ( V_314 -> V_34 . V_327 . V_329 ) ;
}
break;
case V_330 :
default:
...
unsigned long V_147 ;
F_133 ( V_23 , V_15 ) ;
F_89 ( & V_15 -> V_331 , V_147 ) ;
F_134 ( & V_23 -> V_332 , & V_15 -> V_333 ) ;
F_90 ( & V_15 -> V_331 , V_147 ) ;
}
...
unsigned long V_147 ;
F_89 ( & V_15 -> V_331 , V_147 ) ;
if ( F_70 ( F_135 ( & V_15 -> V_333 ) ) ) {
F_90 ( & V_15 -> V_331 , V_147 ) ;
return NULL ;
}
V_23 = F_136 ( & V_15 -> V_333 , struct V_22 ,
V_332 ) ;
F_137 ( & V_23 -> V_332 ) ;
F_90 ( & V_15 -> V_331 , V_147 ) ;
F_138 ( V_23 , V_15 ) ;
...
void F_141 ( unsigned long V_337 )
{
struct V_1 * V_15 = (struct V_1 * ) V_337 ;
if ( F_70 ( F_71 ( V_338 , & V_15 -> V_339 ) ) ) {
F_142 ( V_338 , & V_15 -> V_339 ) ;
F_143 ( V_15 ) ;
}
if ( F_64 ( F_71 ( V_340 , & V_15 -> V_339 ) ) ) {
F_142 ( V_340 , & V_15 -> V_339 ) ;
F_144 ( V_15 ) ;
}
if ( F_145 ( V_15 ) )
F_146 ( V_15 ) ;
if ( F_145 ( V_15 )
|| ( F_71 ( V_340 , & V_15 -> V_339 ) )
|| ( F_71 ( V_338 , & V_15 -> V_339 ) ) ) {
F_142 ( V_341 , & V_15 -> V_147 ) ;
F_147 ( V_15 ) ;
} else {
F_142 ( V_341 , & V_15 -> V_147 ) ;
}
}
void F_148 ( struct V_1 * V_15 )
{
F_149 ( & V_15 -> V_342 ) ;
...
{
struct V_1 * V_15 = (struct V_1 * ) V_337 ;
F_151 ( V_338 , & V_15 -> V_339 ) ;
F_147 ( V_15 ) ;
F_148 ( V_15 ) ;
}
static void
F_152 ( struct V_345 * V_346 )
{
unsigned long V_147 ;
struct V_1 * V_15 = V_346 -> V_15 ;
F_89 ( & V_15 -> V_347 , V_147 ) ;
F_137 ( & V_346 -> V_348 ) ;
F_153 ( V_346 ) ;
F_90 ( & V_15 -> V_347 , V_147 ) ;
}
void
F_154 ( struct V_1 * V_15 )
{
unsigned long V_147 ;
F_89 ( & V_15 -> V_347 , V_147 ) ;
V_15 -> V_349 = 1 ;
...
static void F_155 ( struct V_1 * V_15 , V_126 V_161 )
{
int V_350 ;
struct V_200 * V_351 ;
V_351 = F_156 ( V_15 -> V_7 , 0 , V_161 , 0 ) ;
if ( V_351 ) {
F_31 (
V_30 ,
& ( V_351 ->
...
L_98 ,
V_161 ) ;
V_350 = F_158 ( V_15 -> V_7 , 0 , V_161 , 0 ) ;
if ( V_350 ) {
F_31 (
V_45 ,
& ( V_15 -> V_7 ->
...
static void F_159 ( struct V_1 * V_15 , V_126 V_161 )
{
struct V_200 * V_351 ;
V_351 = F_156 ( V_15 -> V_7 , 0 , V_161 , 0 ) ;
if ( V_351 ) {
...
static void F_162 ( struct V_345 * V_346 )
{
...
L_119 ,
type ) ;
F_163 ( V_30 , & V_309 -> V_354 ,
V_309 -> V_354 . V_316 . V_325 ) ;
}
static void
F_164 ( struct V_367 * V_368 )
{
struct V_345 * V_346 =
...
V_346 -> V_15 = V_15 ;
F_89 ( & V_15 -> V_347 , V_147 ) ;
F_166 ( & V_346 -> V_348 , & V_15 -> V_381 ) ;
F_167 ( & V_346 -> V_368 , F_164 ) ;
F_168 (
F_169 () , V_15 -> V_382 , & V_346 -> V_368 ,
F_118 ( 1 ) ) ;
F_90 ( & V_15 -> V_347 , V_147 ) ;
}
void F_170 ( struct V_1 * V_15 , V_126 V_383 ,
V_141 V_384 )
{
if ( V_384 == V_385 )
F_165 ( V_15 , V_371 , & V_383 ,
sizeof( V_383 ) ) ;
else if ( V_384 == V_125 )
F_165 ( V_15 , V_372 , & V_383 ,
sizeof( V_383 ) ) ;
else if ( V_384 == V_386 )
F_165 ( V_15 , V_373 , & V_383 ,
sizeof( V_383 ) ) ;
}
int F_140 ( V_141 V_170 )
{
switch ( V_170 ) {
case V_387 :
case V_218 :
