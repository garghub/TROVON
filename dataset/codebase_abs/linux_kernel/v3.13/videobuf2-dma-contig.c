...
static struct V_53 * F_53 ( void * V_16 , unsigned long V_72 )
{
struct V_17 * V_18 = V_16 ;
struct V_53 * V_54 ;
if ( ! V_18 -> V_27 )
...
if ( F_54 ( ! V_18 -> V_27 ) )
return NULL ;
V_54 = F_55 ( V_18 , & V_73 , V_18 -> V_15 , V_72 ) ;
if ( F_56 ( V_54 ) )
return NULL ;
F_29 ( & V_18 -> V_21 ) ;
return V_54 ;
...
{
return ! ! ( V_39 -> V_44 & ( V_74 | V_75 ) ) ;
}
static int F_58 ( unsigned long V_76 , int V_8 ,
struct V_38 * V_39 , unsigned long * V_77 )
{
...
static int F_60 ( unsigned long V_76 , struct V_3 * * V_82 ,
int V_8 , struct V_38 * V_39 , int V_83 )
{
if ( F_57 ( V_39 ) ) {
unsigned int V_7 ;
for ( V_7 = 0 ; V_7 < V_8 ; ++ V_7 , V_76 += V_71 ) {
unsigned long V_78 ;
int V_40 = F_59 ( V_39 , V_76 , & V_78 ) ;
if ( ! F_61 ( V_78 ) )
return - V_42 ;
if ( V_40 ) {
F_33 ( L_8 , V_76 ) ;
...
int V_84 ;
V_84 = F_63 ( V_85 , V_85 -> V_86 , V_76 & V_87 ,
...
static inline T_1 F_70 ( struct V_32 * V_24 , unsigned long V_78 )
{
return ( T_1 ) F_71 ( V_24 , V_78 ) ;
}
static inline T_1 F_70 ( struct V_32 * V_24 , unsigned long V_78 )
{
return ( T_1 ) F_72 ( V_78 ) ;
}
static inline T_1 F_70 ( struct V_32 * V_24 , unsigned long V_78 )
{
...
struct V_1 * V_2 ;
unsigned long V_89 ;
unsigned long V_90 = F_75 () ;
if ( ! F_76 ( V_20 | V_15 , V_90 ) ) {
F_34 ( L_10 , V_90 ) ;
return F_25 ( - V_42 ) ;
}
if ( ! V_15 ) {
...
return F_25 ( - V_34 ) ;
V_18 -> V_24 = V_31 -> V_24 ;
V_18 -> V_26 = V_83 ? V_91 : V_92 ;
V_76 = V_20 & V_87 ;
V_9 = V_20 & ~ V_87 ;
V_88 = F_5 ( V_20 + V_15 ) ;
V_8 = ( V_88 - V_76 ) >> V_11 ;
V_82 = F_51 ( V_8 * sizeof( V_82 [ 0 ] ) , V_33 ) ;
if ( ! V_82 ) {
V_40 = - V_34 ;
F_33 ( L_12 ) ;
goto V_93;
}
V_39 = F_77 ( V_85 -> V_86 , V_20 ) ;
if ( ! V_39 ) {
F_33 ( L_13 , V_20 ) ;
V_40 = - V_81 ;
goto V_94;
}
if ( V_39 -> V_95 < V_20 + V_15 ) {
F_33 ( L_14 , V_20 , V_15 ) ;
V_40 = - V_81 ;
goto V_94;
}
...
V_40 = F_60 ( V_76 , V_82 , V_8 , V_39 , V_83 ) ;
if ( V_40 ) {
unsigned long V_78 ;
if ( F_58 ( V_76 , V_8 , V_39 , & V_78 ) == 0 ) {
V_18 -> V_19 = F_70 ( V_18 -> V_24 , V_78 ) ;
V_18 -> V_15 = V_15 ;
F_20 ( V_82 ) ;
return V_18 ;
}
