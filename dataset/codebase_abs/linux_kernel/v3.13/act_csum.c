...
V_51 = F_14 ( V_35 , V_36 , V_37 , sizeof( * V_51 ) ) ;
if ( V_51 == NULL )
return 0 ;
V_53 = F_26 ( V_35 ) ;
V_51 -> V_54 = 0 ;
V_35 -> V_45 = F_22 ( V_51 , V_37 - V_36 , 0 ) ;
V_51 -> V_54 = F_27 ( & V_53 -> V_55 , & V_53 -> V_56 ,
V_37 - V_36 , V_57 ,
V_35 -> V_45 ) ;
V_35 -> V_46 = V_47 ;
return 1 ;
...
V_59 = F_14 ( V_35 , V_36 , V_37 , sizeof( * V_59 ) ) ;
if ( V_59 == NULL )
return 0 ;
V_61 = F_29 ( V_35 ) ;
V_59 -> V_62 = 0 ;
V_35 -> V_45 = F_22 ( V_59 , V_37 - V_36 , 0 ) ;
V_59 -> V_62 = F_30 ( V_37 - V_36 ,
V_61 -> V_55 , V_61 -> V_56 , V_35 -> V_45 ) ;
V_35 -> V_46 = V_47 ;
return 1 ;
}
...
V_59 -> V_62 = 0 ;
V_35 -> V_45 = F_22 ( V_59 , V_37 - V_36 , 0 ) ;
V_59 -> V_62 = F_27 ( & V_53 -> V_55 , & V_53 -> V_56 ,
V_37 - V_36 , V_63 ,
V_35 -> V_45 ) ;
V_35 -> V_46 = V_47 ;
return 1 ;
...
V_66 -> V_62 = F_34 ( V_61 -> V_55 , V_61 -> V_56 ,
V_67 , V_61 -> V_70 ,
V_35 -> V_45 ) ;
if ( ! V_66 -> V_62 )
V_66 -> V_62 = V_71 ;
...
V_66 -> V_62 = F_27 ( & V_53 -> V_55 , & V_53 -> V_56 , V_67 ,
V_64 ? V_72 : V_73 ,
V_35 -> V_45 ) ;
if ( ! V_66 -> V_62 )
V_66 -> V_62 = V_71 ;
...
static int F_36 ( struct V_34 * V_35 , T_2 V_31 )
{
const struct V_60 * V_61 ;
int V_39 ;
V_39 = F_15 ( V_35 ) ;
if ( ! F_16 ( V_35 , sizeof( * V_61 ) + V_39 ) )
goto V_74;
V_61 = F_29 ( V_35 ) ;
switch ( V_61 -> V_75 & F_37 ( V_76 ) ? 0 : V_61 -> V_70 ) {
case V_77 :
if ( V_31 & V_78 )
if ( ! F_21 ( V_35 , V_61 -> V_36 * 4 ,
F_33 ( V_61 -> V_79 ) ) )
goto V_74;
break;
case V_80 :
if ( V_31 & V_81 )
if ( ! F_24 ( V_35 , V_61 -> V_36 * 4 ,
F_33 ( V_61 -> V_79 ) ) )
goto V_74;
break;
case V_63 :
if ( V_31 & V_82 )
if ( ! F_28 ( V_35 , V_61 -> V_36 * 4 ,
F_33 ( V_61 -> V_79 ) ) )
goto V_74;
break;
case V_73 :
if ( V_31 & V_83 )
if ( ! F_32 ( V_35 , V_61 -> V_36 * 4 ,
F_33 ( V_61 -> V_79 ) , 0 ) )
goto V_74;
break;
case V_72 :
...
static int F_41 ( struct V_34 * V_35 , T_2 V_31 )
{
struct V_52 * V_53 ;
struct V_86 * V_87 ;
