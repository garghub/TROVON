...
static int F_26 ( struct V_1 * V_2 , int V_68 ,
int V_69 , int V_70 )
{
int V_71 = 1 ;
int V_72 ;
...
static int
F_30 ( struct V_31 * V_32 , char * V_75 )
{
struct V_1 * V_2 = F_20 ( V_32 ) ;
...
V_33 |= 0x0008 ;
V_95 -> V_107 = F_40 ( V_33 ) ;
V_96 = F_41 ( V_2 ) ;
memset ( V_95 -> V_108 . V_109 . V_110 , 0xff ,
sizeof( V_95 -> V_108 . V_109 . V_110 ) ) ;
V_95 -> V_108 . V_109 . V_110 [ 0 ] = V_96 & V_111 ;
if ( V_2 -> V_86 > 7 ) {
V_95 -> V_108 . V_109 . V_110 [ 1 ] = ( V_96 & V_111 ) >> 8 ;
V_95 -> V_108 . V_109 . V_110 [ 2 ] = 0xff ;
} else
V_95 -> V_108 . V_109 . V_110 [ 1 ] = 0xff ;
}
static int F_42 ( struct V_31 * V_32 , unsigned V_112 )
{
struct V_1 * V_2 = F_20 ( V_32 ) ;
T_1 V_5 ;
if ( ! V_112 )
return - V_113 ;
V_112 -- ;
V_5 = F_2 ( V_2 , & V_2 -> V_7 -> V_82 . V_114 [ V_112 ] ) ;
if ( ! ( V_5 & V_87 ) )
return - V_115 ;
F_4 ( V_2 , V_116 , & V_2 -> V_7 -> V_82 . V_114 [ V_112 ] ) ;
return 0 ;
}
static inline int F_43 ( struct V_1 * V_2 , unsigned V_112 )
{
T_3 T_4 * V_117 = & V_2 -> V_7 -> V_82 . V_114 [ V_112 ] ;
T_1 V_33 = 0 ;
T_2 V_118 = F_2 ( V_2 , & V_2 -> V_7 -> V_119 ) ;
T_2 V_120 = V_118 + V_121 ;
int V_122 = F_44 ( V_121 , V_123 ) ;
do {
int V_124 ;
V_124 = V_123 * 2 ;
while ( -- V_124 >= 0 ) {
...
F_4 ( V_2 , V_116 , V_117 ) ;
F_6 ( V_123 ) ;
V_118 = F_2 ( V_2 , & V_2 -> V_7 -> V_119 ) ;
} while ( F_46 ( V_118 , V_120 ) && -- V_122 >= 0 );
return 0 ;
}
static int F_47 (
struct V_31 * V_32 ,
...
F_4 ( V_2 , V_33 ,
& V_2 -> V_7 -> V_82 . V_114 [ V_127 ] ) ;
break;
case V_145 :
F_39 ( V_2 , (struct V_94 * ) V_75 ) ;
break;
case V_146 :
V_33 = F_34 ( V_2 ) & ~ ( V_147 | V_148 ) ;
F_48 ( V_33 , V_75 ) ;
break;
case V_149 :
if ( ! V_127 || V_127 > V_129 )
