...
int V_97 ;
int V_43 ;
V_147 = F_101 ( V_103 , V_148 , 0 ) ;
if ( ! V_147 ) {
F_102 ( & V_103 -> V_42 , L_16 ) ;
V_97 = - V_149 ;
goto V_98;
}
V_147 = F_103 ( & V_103 -> V_42 , V_147 -> V_150 ,
F_104 ( V_147 ) , F_56 ( & V_103 -> V_42 ) ) ;
if ( ! V_147 ) {
F_102 ( & V_103 -> V_42 , L_17 ) ;
V_97 = - V_151 ;
goto V_98;
}
V_152 = F_105 ( & V_103 -> V_42 ,
