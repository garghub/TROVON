...
int F_41 ( struct V_83 * V_84 V_106 ,
...
char V_135 ;
char * V_136 ;
char * V_137 = NULL , * V_138 , * V_139 , * V_140 , * V_141 ;
int V_4 , V_53 , V_130 ;
char * * V_129 ;
F_3 ( L_92 , V_128 ) ;
V_129 = F_64 ( V_128 , & V_130 ) ;
...
V_139 = strtok_r ( V_137 , L_94 , & V_138 ) ;
V_140 = strtok_r ( NULL , L_95 , & V_138 ) ;
V_141 = strtok_r ( NULL , L_96 , & V_138 ) ;
if ( V_139 == NULL || strlen ( V_139 ) != 1 || V_140 == NULL
|| V_141 == NULL ) {
F_55 ( L_97 , V_129 [ 0 ] ) ;
V_4 = - V_101 ;
goto V_11;
...
V_135 = V_139 [ 0 ] ;
V_134 -> V_118 = F_22 ( V_140 ) ;
V_134 -> V_117 = F_22 ( V_141 ) ;
if ( V_134 -> V_118 == NULL || V_134 -> V_117 == NULL ) {
V_4 = - V_38 ;
goto V_11;
}
F_3 ( L_98 , V_134 -> V_118 , V_134 -> V_117 , V_135 ) ;
V_34 -> V_40 = ( V_135 == 'r' ) ;
...
V_136 = V_129 [ 1 ] ;
V_139 = strtok_r ( V_136 , L_99 , & V_138 ) ;
V_34 -> V_14 = F_22 ( V_139 ) ;
if ( V_34 -> V_14 == NULL ) {
V_4 = - V_38 ;
goto V_11;
}
V_140 = strtok_r ( NULL , L_3 , & V_138 ) ;
if ( V_140 == NULL )
V_34 -> V_39 = 0 ;
else
V_34 -> V_39 = strtoul ( V_140 , NULL , 10 ) ;
V_134 -> V_133 = V_130 - 2 ;
V_134 -> args = F_62 ( sizeof( struct V_142 ) * V_134 -> V_133 ) ;
if ( V_134 -> args == NULL ) {
V_4 = - V_38 ;
goto V_11;
}
...
V_134 -> args [ V_53 ] . V_143 = F_22 ( V_136 ) ;
if ( V_134 -> args [ V_53 ] . V_15 == NULL || V_134 -> args [ V_53 ] . V_143 == NULL ) {
V_4 = - V_38 ;
goto V_11;
}
}
...
int F_67 ( struct V_120 * V_144 , char * V_78 , T_1 V_145 )
{
struct V_122 * V_124 = V_144 -> V_124 ;
int V_4 ;
char * V_54 = V_78 ;
if ( V_144 -> V_15 && V_144 -> V_100 )
V_4 = F_1 ( V_54 , V_145 , L_100 , V_144 -> V_15 , V_144 -> V_100 ) ;
else
V_4 = F_1 ( V_54 , V_145 , L_28 , V_144 -> V_15 ? V_144 -> V_15 : V_144 -> V_100 ) ;
if ( V_4 <= 0 )
goto error;
V_54 += V_4 ;
V_145 -= V_4 ;
while ( V_124 ) {
if ( V_124 -> V_15 [ 0 ] == '[' )
V_4 = F_1 ( V_54 , V_145 , L_28 , V_124 -> V_15 ) ;
else
V_4 = F_1 ( V_54 , V_145 , L_101 ,
V_124 -> V_126 ? L_102 : L_103 , V_124 -> V_15 ) ;
if ( V_4 <= 0 )
goto error;
V_54 += V_4 ;
V_145 -= V_4 ;
...
if ( V_144 -> type ) {
V_4 = F_1 ( V_54 , V_145 , L_104 , V_144 -> type ) ;
if ( V_4 <= 0 )
goto error;
V_54 += V_4 ;
V_145 -= V_4 ;
...
{
char * V_78 , * V_54 ;
char V_146 [ 32 ] = L_3 , line [ 32 ] = L_3 , V_112 [ 32 ] = L_3 ;
int V_4 , V_145 ;
V_78 = F_62 ( V_147 ) ;
if ( V_78 == NULL ) {
V_4 = - V_38 ;
...
if ( V_36 -> V_39 ) {
V_4 = F_1 ( V_146 , 32 , L_106 , V_36 -> V_39 ) ;
if ( V_4 <= 0 )
goto error;
}
if ( V_36 -> line ) {
V_4 = F_1 ( line , 32 , L_107 , V_36 -> line ) ;
if ( V_4 <= 0 )
goto error;
}
if ( V_36 -> V_112 ) {
...
V_145 = strlen ( V_54 ) ;
if ( V_145 > 30 ) {
V_54 = strchr ( V_36 -> V_112 + V_145 - 30 , '/' ) ;
V_54 = V_54 ? V_54 + 1 : V_36 -> V_112 + V_145 - 30 ;
}
V_4 = F_1 ( V_112 , 32 , L_108 , V_54 ) ;
if ( V_4 <= 0 )
goto error;
}
if ( V_36 -> V_37 )
V_4 = F_1 ( V_78 , V_147 , L_109 , V_36 -> V_37 ,
V_146 , V_36 -> V_40 ? L_110 : L_3 , line ,
V_112 ) ;
else
V_4 = F_1 ( V_78 , V_147 , L_101 , V_112 , line ) ;
if ( V_4 <= 0 )
goto error;
return V_78 ;
error:
...
static int F_68 ( struct V_148 * V_126 ,
char * * V_78 , T_1 * V_149 ,
int V_150 )
{
int V_4 ;
if ( V_126 -> V_127 ) {
V_150 = F_68 ( V_126 -> V_127 , V_78 ,
V_149 , V_150 + 1 ) ;
if ( V_150 < 0 )
goto V_11;
}
V_4 = F_1 ( * V_78 , * V_149 , L_112 , V_126 -> V_39 ) ;
if ( V_4 < 0 )
V_150 = V_4 ;
else {
* V_78 += V_4 ;
...
static int F_69 ( struct V_142 * V_110 ,
char * V_78 , T_1 V_149 )
{
struct V_148 * V_126 = V_110 -> V_126 ;
int V_4 , V_150 = 0 ;
char * V_54 = V_78 ;
if ( V_110 -> V_15 )
V_4 = F_1 ( V_78 , V_149 , L_113 , V_110 -> V_15 ) ;
else
V_4 = F_1 ( V_78 , V_149 , L_114 ) ;
if ( V_4 < 0 )
return V_4 ;
V_78 += V_4 ;
V_149 -= V_4 ;
if ( V_110 -> V_143 [ 0 ] == '@' && V_110 -> V_126 )
V_126 = V_126 -> V_127 ;
if ( V_126 ) {
V_150 = F_68 ( V_126 , & V_78 ,
& V_149 , 1 ) ;
if ( V_150 < 0 )
return V_150 ;
}
if ( V_110 -> V_143 [ 0 ] == '@' && V_110 -> V_126 )
V_4 = F_1 ( V_78 , V_149 , L_115 , V_110 -> V_143 ,
V_110 -> V_126 -> V_39 ) ;
else
V_4 = F_1 ( V_78 , V_149 , L_28 , V_110 -> V_143 ) ;
if ( V_4 < 0 )
return V_4 ;
V_78 += V_4 ;
V_149 -= V_4 ;
while ( V_150 -- ) {
V_4 = F_1 ( V_78 , V_149 , L_116 ) ;
if ( V_4 < 0 )
return V_4 ;
V_78 += V_4 ;
V_149 -= V_4 ;
...
if ( V_110 -> type ) {
V_4 = F_1 ( V_78 , V_149 , L_104 , V_110 -> type ) ;
if ( V_4 <= 0 )
return V_4 ;
V_78 += V_4 ;
}
...
return NULL ;
if ( V_134 -> V_61 )
V_145 = F_1 ( V_78 , V_147 , L_117 ,
V_34 -> V_40 ? 'r' : 'p' ,
V_134 -> V_118 , V_134 -> V_117 ,
V_34 -> V_18 , V_34 -> V_14 ) ;
else
V_145 = F_1 ( V_78 , V_147 , L_118 ,
V_34 -> V_40 ? 'r' : 'p' ,
V_134 -> V_118 , V_134 -> V_117 ,
V_34 -> V_18 ? : L_3 , V_34 -> V_18 ? L_94 : L_3 ,
V_34 -> V_14 , V_34 -> V_39 ) ;
if ( V_145 <= 0 )
goto error;
for ( V_53 = 0 ; V_53 < V_134 -> V_133 ; V_53 ++ ) {
V_4 = F_69 ( & V_134 -> args [ V_53 ] , V_78 + V_145 ,
V_147 - V_145 ) ;
if ( V_4 <= 0 )
goto error;
V_145 += V_4 ;
...
if ( V_134 -> args [ V_53 ] . V_143 )
free ( V_134 -> args [ V_53 ] . V_143 ) ;
...
static void F_74 ( const char * V_112 , bool V_151 )
{
if ( V_70 == V_45 ) {
const char * V_152 ;
if ( ! V_151 )
...
static int F_75 ( const char * V_153 , bool V_154 ,
bool V_151 )
{
char V_78 [ V_155 ] ;
const char * V_156 ;
...
V_4 = F_1 ( V_78 , V_155 , L_25 , V_156 , V_153 ) ;
if ( V_4 >= 0 ) {
F_3 ( L_125 , V_78 , V_154 ) ;
if ( V_154 && ! V_157 )
V_4 = F_77 ( V_78 , V_158 , V_159 ) ;
else
V_4 = F_77 ( V_78 , V_160 , 0 ) ;
if ( V_4 < 0 )
F_74 ( V_78 , V_151 ) ;
}
return V_4 ;
}
static int F_78 ( bool V_154 )
{
return F_75 ( L_126 , V_154 , true ) ;
}
static int F_79 ( bool V_154 )
{
return F_75 ( L_127 , V_154 , false ) ;
}
static struct V_161 * F_80 ( int V_162 )
{
int V_4 , V_163 ;
T_4 * V_74 ;
char V_78 [ V_147 ] ;
char * V_136 ;
struct V_161 * V_164 ;
V_164 = F_81 ( true , NULL ) ;
V_74 = fdopen ( F_82 ( V_162 ) , L_36 ) ;
while ( ! feof ( V_74 ) ) {
V_136 = fgets ( V_78 , V_147 , V_74 ) ;
if ( ! V_136 )
break;
V_163 = strlen ( V_136 ) - 1 ;
if ( V_136 [ V_163 ] == '\n' )
V_136 [ V_163 ] = '\0' ;
V_4 = F_83 ( V_164 , V_78 ) ;
if ( V_4 < 0 ) {
F_3 ( L_128 , strerror ( - V_4 ) ) ;
F_52 ( V_164 ) ;
return NULL ;
}
}
...
char V_78 [ 128 ] ;
char * V_165 ;
V_165 = F_35 ( & V_57 -> V_55 ) ;
if ( ! V_165 )
return - V_101 ;
V_4 = F_1 ( V_78 , 128 , L_129 , V_57 -> V_118 , V_57 -> V_117 ) ;
if ( V_4 < 0 )
return V_4 ;
printf ( L_130 , V_78 , V_165 ) ;
if ( V_57 -> V_133 > 0 ) {
printf ( L_131 ) ;
for ( V_53 = 0 ; V_53 < V_57 -> V_133 ; V_53 ++ ) {
...
static int F_85 ( int V_162 , bool V_151 )
{
int V_4 = 0 ;
struct V_50 V_134 ;
struct V_56 V_57 ;
...
V_162 = F_79 ( false ) ;
if ( V_162 >= 0 ) {
V_4 = F_85 ( V_162 , false ) ;
F_87 ( V_162 ) ;
}
return V_4 ;
}
static struct V_161 * F_88 ( int V_162 , bool V_168 )
{
char V_78 [ 128 ] ;
struct V_161 * V_164 , * V_166 ;
struct V_95 * V_167 ;
struct V_50 V_134 ;
int V_4 = 0 ;
memset ( & V_134 , 0 , sizeof( V_134 ) ) ;
...
break;
if ( V_168 ) {
V_4 = F_1 ( V_78 , 128 , L_129 , V_134 . V_118 ,
V_134 . V_117 ) ;
if ( V_4 >= 0 )
V_4 = F_83 ( V_164 , V_78 ) ;
} else
V_4 = F_83 ( V_164 , V_134 . V_117 ) ;
F_73 ( & V_134 ) ;
if ( V_4 < 0 )
break;
}
...
static int F_89 ( int V_162 , struct V_50 * V_134 )
{
int V_4 = 0 ;
...
F_3 ( L_135 , V_78 ) ;
if ( ! V_157 ) {
V_4 = F_90 ( V_162 , V_78 , strlen ( V_78 ) ) ;
if ( V_4 <= 0 )
F_7 ( L_136 ,
strerror ( V_70 ) ) ;
}
...
static int F_91 ( char * V_78 , T_1 V_145 , const char * V_169 ,
struct V_161 * V_170 , bool V_171 )
{
int V_53 , V_4 ;
V_4 = F_1 ( V_78 , V_145 , L_28 , V_169 ) ;
if ( V_4 < 0 ) {
F_3 ( L_137 , strerror ( - V_4 ) ) ;
return V_4 ;
}
if ( ! F_92 ( V_170 , V_78 ) )
return 0 ;
...
for ( V_53 = 1 ; V_53 < V_173 ; V_53 ++ ) {
V_4 = F_1 ( V_78 , V_145 , L_140 , V_169 , V_53 ) ;
if ( V_4 < 0 ) {
F_3 ( L_137 , strerror ( - V_4 ) ) ;
return V_4 ;
}
...
if ( V_162 < 0 )
return V_162 ;
V_170 = F_88 ( V_162 , false ) ;
if ( ! V_170 ) {
F_3 ( L_142 ) ;
return - V_174 ;
}
V_4 = 0 ;
printf ( L_143 , ( V_52 > 1 ) ? L_144 : L_94 ) ;
for ( V_53 = 0 ; V_53 < V_52 ; V_53 ++ ) {
V_134 = & V_51 [ V_53 ] ;
if ( V_57 -> V_117 )
V_117 = V_57 -> V_117 ;
...
if ( V_134 -> V_133 ) {
V_134 -> args = F_62 ( sizeof( struct V_142 )
* V_134 -> V_133 ) ;
if ( V_134 -> args == NULL ) {
V_4 = - V_38 ;
goto error;
...
V_134 -> args [ V_53 ] . V_143 = F_22 ( V_57 -> args [ V_53 ] . V_100 ) ;
if ( V_134 -> args [ V_53 ] . V_143 == NULL ) {
V_4 = - V_38 ;
goto error;
}
if ( V_57 -> args [ V_53 ] . type ) {
...
int V_58 , const char * V_59 , bool V_176 )
{
int V_53 , V_177 , V_4 ;
struct V_178 * V_179 ;
V_4 = 0 ;
V_179 = F_62 ( sizeof( struct V_178 ) * V_105 ) ;
if ( V_179 == NULL )
return - V_38 ;
if ( ! V_104 -> V_61 )
V_4 = F_2 () ;
...
V_179 [ V_53 ] . V_57 = & V_104 [ V_53 ] ;
V_4 = F_94 ( V_179 [ V_53 ] . V_57 ,
& V_179 [ V_53 ] . V_51 ,
V_58 ,
V_59 ) ;
if ( V_4 < 0 )
...
for ( V_53 = 0 ; V_53 < V_105 ; V_53 ++ ) {
V_4 = F_93 ( V_179 [ V_53 ] . V_57 , V_179 [ V_53 ] . V_51 ,
V_179 [ V_53 ] . V_52 , V_176 ) ;
if ( V_4 < 0 )
break;
}
V_87:
for ( V_53 = 0 ; V_53 < V_105 ; V_53 ++ ) {
for ( V_177 = 0 ; V_177 < V_179 [ V_53 ] . V_52 ; V_177 ++ )
F_73 ( & V_179 [ V_53 ] . V_51 [ V_177 ] ) ;
free ( V_179 [ V_53 ] . V_51 ) ;
}
free ( V_179 ) ;
return V_4 ;
}
static int F_96 ( int V_162 , struct V_95 * V_167 )
{
char * V_136 ;
char V_78 [ 128 ] ;
int V_4 ;
V_4 = F_1 ( V_78 , 128 , L_149 , V_167 -> V_103 ) ;
if ( V_4 < 0 )
goto error;
V_136 = strchr ( V_78 + 2 , ':' ) ;
if ( ! V_136 ) {
...
printf ( L_151 , V_167 -> V_103 ) ;
return 0 ;
error:
F_7 ( L_152 , strerror ( - V_4 ) ) ;
return V_4 ;
}
static int F_97 ( int V_162 , const char * V_78 ,
struct V_161 * V_170 )
{
struct V_95 * V_167 , * V_180 ;
int V_4 = - 1 ;
if ( strpbrk ( V_78 , L_153 ) ) {
F_98 (ent, n, namelist)
if ( F_99 ( V_167 -> V_103 , V_78 ) ) {
V_4 = F_96 ( V_162 , V_167 ) ;
if ( V_4 < 0 )
break;
F_100 ( V_170 , V_167 ) ;
}
} else {
V_167 = F_101 ( V_170 , V_78 ) ;
if ( V_167 ) {
V_4 = F_96 ( V_162 , V_167 ) ;
if ( V_4 >= 0 )
F_100 ( V_170 , V_167 ) ;
...
int F_102 ( struct V_161 * V_181 )
{
int V_4 = - 1 , V_182 = - 1 , V_183 = - 1 ;
char V_78 [ 128 ] ;
const char * V_118 , * V_117 ;
char * V_136 , * V_1 ;
struct V_95 * V_167 ;
struct V_161 * V_170 = NULL , * V_184 = NULL ;
V_183 = F_78 ( true ) ;
if ( V_183 < 0 )
return V_183 ;
V_170 = F_88 ( V_183 , true ) ;
V_182 = F_79 ( true ) ;
if ( V_182 >= 0 )
V_184 = F_88 ( V_182 , true ) ;
if ( V_170 == NULL && V_184 == NULL )
goto error;
F_50 (ent, dellist) {
V_1 = F_22 ( V_167 -> V_103 ) ;
if ( V_1 == NULL ) {
V_4 = - V_38 ;
goto error;
}
...
V_4 = F_1 ( V_78 , 128 , L_129 , V_118 , V_117 ) ;
if ( V_4 < 0 ) {
F_24 ( L_156 ) ;
free ( V_1 ) ;
goto error;
}
F_3 ( L_157 , V_118 , V_117 ) ;
if ( V_170 )
V_4 = F_97 ( V_183 , V_78 , V_170 ) ;
if ( V_184 && V_4 != 0 )
V_4 = F_97 ( V_182 , V_78 , V_184 ) ;
if ( V_4 != 0 )
F_103 ( L_158 , V_78 ) ;
free ( V_1 ) ;
}
...
static int F_33 ( struct V_56 * V_57 , const char * V_189 )
{
struct V_35 * V_36 = & V_57 -> V_55 ;
struct V_14 * V_43 ;
...
if ( ! V_43 ) {
F_7 ( L_165 , V_37 , V_189 ) ;
goto V_11;
}
if ( V_16 -> V_48 > V_43 -> V_48 )
V_190 = V_16 -> V_48 ;
V_190 += V_43 -> V_48 + V_36 -> V_39 + V_16 -> V_191 ;
V_36 -> V_39 = 0 ;
if ( ! V_57 -> V_117 ) {
V_57 -> V_117 = V_37 ;
V_37 = NULL ;
...
V_192 = F_22 ( F_119 ( V_194 ) ) ;
if ( V_192 ) {
V_193 = strpbrk ( V_192 , L_167 ) ;
if ( V_193 )
* V_193 = '\0' ;
F_1 ( V_57 -> V_118 , 64 , L_168 , V_175 ,
V_192 ) ;
free ( V_192 ) ;
}
free ( V_194 ) ;
...
F_1 ( V_36 -> V_37 , V_131 , L_170 , V_190 ) ;
V_4 = 0 ;
V_11:
if ( V_16 ) {
F_113 ( V_16 -> V_27 ) ;
