...
static inline void F_42 ( struct V_53 * V_54 )
{
if ( V_54 -> V_15 & V_56 ) {
F_43 ( V_54 -> V_41 , V_54 -> V_15 ) ;
V_54 -> V_15 = 0 ;
}
}
...
F_48 ( ! ( V_54 -> V_15 & V_56 ) ) ;
V_13 -> V_18 = F_29 ( V_67 ) | F_49 ( V_31 ) | V_43 ;
V_13 -> V_9 = ( V_68 & V_72 ) |
F_4 ( V_31 -> V_9 , V_69 ) ;
...
static inline int F_50 ( struct V_27 * V_28 ,
...
V_82 = V_74 -> V_83 ;
F_51 () ;
V_78 = F_52 ( V_28 -> V_34 . V_74 , V_76 ) ;
V_79 = F_53 ( V_78 , V_76 ) ;
if ( V_29 == 1 ) {
struct V_84 * V_85 ;
F_54 ( & V_86 -> V_87 -> V_88 ) ;
V_85 = F_55 ( V_86 -> V_87 , V_79 ) ;
...
( V_85 -> V_90 & V_105 ) ) {
unsigned long V_106 = F_57 ( V_85 ) ;
V_67 = ( V_31 -> V_18 & V_100 ) >>
V_101 ;
V_67 = F_58 ( F_59 ( V_106 ) - 10 , V_67 ) ;
V_67 = F_56 ( V_45 , V_67 & ~ 1 ) ;
}
F_60 ( & V_86 -> V_87 -> V_88 ) ;
}
...
static int F_70 ( struct V_27 * V_28 , int V_52 ,
struct V_12 * V_13 )
{
struct V_12 * V_31 ;
struct V_53 * V_54 ;
...
int V_30 ;
int V_112 ;
V_112 = F_50 ( V_28 , V_68 , V_76 , V_31 , 1 , V_13 ,
V_54 ) ;
if ( V_112 )
return V_112 ;
if ( F_76 ( V_13 ) == V_45 ) {
...
V_30 = F_73 ( V_28 , V_54 , V_52 ) ;
F_18 ( V_28 , V_31 , V_13 , 1 , V_30 ) ;
return 0 ;
}
void F_77 ( struct V_35 * V_34 , V_47 V_25 , T_6 V_115 ,
unsigned int V_116 )
{
struct V_27 * V_28 = F_24 ( V_34 ) ;
struct V_117 * V_118 ;
...
int F_84 ( struct V_74 * V_74 , unsigned long V_92 , unsigned long V_93 )
{
F_81 ( V_74 , V_92 ) ;
return 0 ;
}
...
int F_86 ( struct V_74 * V_74 , unsigned long V_79 )
{
return 0 ;
}
void F_87 ( struct V_74 * V_74 , unsigned long V_79 , T_7 V_119 )
{
F_81 ( V_74 , V_79 ) ;
}
int F_88 ( struct V_27 * V_28 )
{
...
V_1 [ 0 ] . V_2 / V_1 [ 0 ] . V_124 ;
V_1 [ 1 ] . V_127 = 1 ;
V_28 -> V_63 = F_91 ( sizeof( unsigned int ) *
V_1 [ 1 ] . V_2 ,
V_128 ) ;
if ( ! V_28 -> V_63 )
return - V_108 ;
