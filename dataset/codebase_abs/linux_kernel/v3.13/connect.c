...
{
unsigned int V_3 , V_405 ;
struct V_1 * V_2 = V_8 -> V_2 ;
F_5 ( V_20 , L_95 , V_21 , V_8 -> V_404 ) ;
F_2 ( & V_22 ) ;
if ( V_8 -> V_403 == V_16 ) {
F_3 ( & V_22 ) ;
return;
...
V_8 -> V_403 = V_16 ;
F_3 ( & V_22 ) ;
if ( V_8 -> V_403 == V_16 && V_2 -> V_49 -> V_406 ) {
V_405 = F_141 () ;
V_3 = V_2 -> V_49 -> V_406 ( V_405 , V_8 ) ;
if ( V_3 )
F_5 ( V_59 , L_96 ,
V_21 , V_3 ) ;
F_142 ( V_405 ) ;
...
sprintf ( V_407 , L_97 , & V_410 -> V_367 . V_368 ) ;
break;
case V_369 :
V_411 = (struct V_370 * ) & V_2 -> V_96 ;
sprintf ( V_407 , L_98 , & V_411 -> V_373 . V_416 ) ;
break;
default:
F_5 ( V_20 , L_99 ,
V_2 -> V_96 . V_415 ) ;
...
sprintf ( V_8 -> V_425 , L_114 , & V_381 -> V_373 ) ;
else
sprintf ( V_8 -> V_425 , L_115 , & V_374 -> V_367 ) ;
if ( V_389 -> V_335 ) {
...
V_3 = F_152 ( V_405 , V_8 ) ;
if ( ! V_3 )
V_3 = F_154 ( V_405 , V_8 , V_389 -> V_423 ) ;
F_12 ( & V_8 -> V_422 ) ;
if ( V_3 )
goto V_424;
F_2 ( & V_22 ) ;
...
F_5 ( V_20 , L_116 , V_21 , V_10 -> V_429 ) ;
F_2 ( & V_22 ) ;
if ( -- V_10 -> V_429 > 0 ) {
F_3 ( & V_22 ) ;
return;
...
V_405 = F_141 () ;
V_3 = V_8 -> V_2 -> V_49 -> V_431 ( V_405 , V_8 , V_389 -> V_195 , V_10 ,
V_389 -> V_423 ) ;
F_153 ( V_405 ) ;
F_5 ( V_20 , L_119 , V_3 ) ;
if ( V_3 )
...
int
F_174 ( const unsigned int V_405 , struct V_7 * V_8 , const char * V_461 ,
...
strcpy ( V_467 + 2 + strlen ( V_8 -> V_425 ) , L_121 ) ;
V_3 = V_8 -> V_2 -> V_49 -> V_431 ( V_405 , V_8 , V_467 , NULL ,
V_463 ) ;
F_5 ( V_20 , L_122 , V_3 , V_8 -> V_25 ) ;
F_11 ( V_467 ) ;
}
if ( V_3 == 0 )
V_3 = V_8 -> V_2 -> V_49 -> V_468 ( V_405 , V_8 , V_461 ,
V_466 , V_464 ,
V_463 , V_256 ) ;
return V_3 ;
}
...
void F_187 ( unsigned int V_405 , struct V_9 * V_10 ,
...
F_5 ( V_20 , L_160 , V_21 , V_554 ) ;
return V_554 ;
}
static int
F_197 ( const unsigned int V_405 , struct V_7 * V_8 ,
...
V_3 = F_174 ( V_405 , V_8 , V_558 , V_443 -> V_423 ,
& V_464 , & V_466 ,
V_443 -> V_452 & V_534 ) ;
if ( ! V_3 && V_464 > 0 ) {
char * V_560 = NULL ;
...
int V_563 = 0 ;
#endif
V_3 = F_206 ( & V_443 -> V_564 , L_165 , V_565 ) ;
if ( V_3 )
return V_3 ;
#ifdef F_205
V_566:
...
#ifdef F_205
if ( V_563 == 0 ) {
int V_576 = F_197 ( V_405 , V_8 , V_389 , V_443 ,
false ) ;
if ( ! V_576 ) {
V_563 ++ ;
goto V_566;
...
V_3 = V_2 -> V_49 -> V_577 ( V_405 , V_10 , V_443 ,
V_554 ) ;
if ( V_3 != 0 && V_3 != - V_578 ) {
F_11 ( V_554 ) ;
goto V_567;
...
V_3 = F_197 ( V_405 , V_8 , V_389 , V_443 , true ) ;
if ( ! V_3 ) {
V_563 ++ ;
goto V_566;
}
...
int
F_212 ( const unsigned int V_405 , struct V_7 * V_8 ,
...
V_3 = F_220 ( V_405 , V_8 , V_587 , V_588 , & V_78 ,
0 ) ;
if ( ( V_3 == 0 ) && ( V_10 != NULL ) ) {
bool V_622 ;
V_10 -> V_426 = V_62 ;
...
V_592 , V_622 ,
V_463 ) ;
F_5 ( V_20 , L_169 , V_10 -> V_625 ) ;
if ( ( V_588 -> V_626 == 3 ) ||
( V_588 -> V_626 == 7 ) )
V_10 -> V_433 = F_225 ( V_590 -> V_627 ) ;
else
V_10 -> V_433 = 0 ;
F_5 ( V_20 , L_170 , V_10 -> V_433 ) ;
...
static void F_226 ( struct V_628 * V_122 )
{
struct V_442 * V_629 = F_22 ( V_122 , struct V_442 , V_630 ) ;
F_227 ( V_629 -> V_423 ) ;
F_11 ( V_629 ) ;
}
void
F_228 ( struct V_442 * V_443 )
{
struct V_631 * V_632 = & V_443 -> V_529 ;
struct V_633 * V_634 ;
struct V_436 * V_437 ;
F_118 ( & V_443 -> V_526 ) ;
F_2 ( & V_443 -> V_528 ) ;
while ( ( V_634 = F_229 ( V_632 ) ) ) {
V_437 = F_230 ( V_634 , struct V_436 , V_635 ) ;
F_173 ( V_437 ) ;
F_231 ( V_439 , & V_437 -> V_440 ) ;
F_232 ( V_634 , V_632 ) ;
F_3 ( & V_443 -> V_528 ) ;
F_164 ( V_437 ) ;
F_2 ( & V_443 -> V_528 ) ;
...
F_207 ( & V_443 -> V_564 ) ;
F_11 ( V_443 -> V_197 ) ;
F_233 ( & V_443 -> V_630 , F_226 ) ;
}
int
F_152 ( const unsigned int V_405 , struct V_7 * V_8 )
{
int V_3 = 0 ;
struct V_1 * V_2 = V_8 -> V_2 ;
if ( ! V_2 -> V_49 -> V_50 || ! V_2 -> V_49 -> V_636 )
return - V_55 ;
if ( ! V_2 -> V_49 -> V_50 ( V_2 ) )
return 0 ;
F_234 ( V_2 , 1 ) ;
V_3 = V_2 -> V_49 -> V_636 ( V_405 , V_8 ) ;
if ( V_3 == 0 ) {
F_2 ( & V_14 ) ;
if ( V_2 -> V_15 == V_45 )
V_2 -> V_15 = V_62 ;
...
int
F_154 ( const unsigned int V_405 , struct V_7 * V_8 ,
struct V_462 * V_638 )
{
int V_3 = - V_55 ;
struct V_1 * V_2 = V_8 -> V_2 ;
...
F_5 ( V_20 , L_171 ,
V_2 -> V_602 , V_2 -> V_610 , V_2 -> V_640 ) ;
if ( V_2 -> V_49 -> V_641 )
V_3 = V_2 -> V_49 -> V_641 ( V_405 , V_8 , V_638 ) ;
if ( V_3 )
F_5 ( V_59 , L_172 , V_3 ) ;
return V_3 ;
}
static int
F_235 ( struct V_146 * V_147 , struct V_7 * V_8 )
{
V_147 -> V_149 = V_8 -> V_149 ;
...
static struct V_9 *
F_236 ( struct V_442 * V_443 , T_3 V_642 )
{
int V_3 ;
struct V_9 * V_643 = F_237 ( V_443 ) ;
struct V_7 * V_8 ;
...
V_507 -> V_220 = V_642 ;
V_507 -> V_219 = V_642 ;
V_507 -> V_195 = V_643 -> V_427 ;
V_507 -> V_250 = V_643 -> V_250 ;
V_507 -> V_268 = V_643 -> V_268 ;
V_507 -> V_302 = V_643 -> V_302 ;
V_507 -> V_266 = ! V_643 -> V_511 ;
V_507 -> V_149 = V_643 -> V_8 -> V_149 ;
V_507 -> V_151 = V_643 -> V_8 -> V_151 ;
V_3 = F_235 ( V_507 , V_643 -> V_8 ) ;
if ( V_3 ) {
V_10 = F_71 ( V_3 ) ;
goto V_460;
}
...
static struct V_436 *
F_239 ( struct V_631 * V_632 , T_3 V_144 )
{
struct V_633 * V_634 = V_632 -> V_633 ;
struct V_436 * V_437 ;
while ( V_634 ) {
V_437 = F_230 ( V_634 , struct V_436 , V_635 ) ;
if ( F_240 ( V_437 -> V_582 , V_144 ) )
V_634 = V_634 -> V_645 ;
else if ( F_241 ( V_437 -> V_582 , V_144 ) )
V_634 = V_634 -> V_646 ;
else
return V_437 ;
}
...
static void
F_211 ( struct V_631 * V_632 , struct V_436 * V_647 )
{
struct V_633 * * V_65 = & ( V_632 -> V_633 ) , * V_648 = NULL ;
struct V_436 * V_437 ;
while ( * V_65 ) {
V_437 = F_230 ( * V_65 , struct V_436 , V_635 ) ;
V_648 = * V_65 ;
if ( F_240 ( V_437 -> V_582 , V_647 -> V_582 ) )
V_65 = & ( ( * V_65 ) -> V_645 ) ;
else
V_65 = & ( ( * V_65 ) -> V_646 ) ;
}
F_242 ( & V_647 -> V_635 , V_648 , V_65 ) ;
F_243 ( & V_647 -> V_635 , V_632 ) ;
}
struct V_436 *
F_244 ( struct V_442 * V_443 )
{
int V_649 ;
T_3 V_642 = F_245 () ;
struct V_436 * V_437 , * V_650 ;
if ( ! ( V_443 -> V_452 & V_550 ) )
return F_173 ( F_168 ( V_443 ) ) ;
F_2 ( & V_443 -> V_528 ) ;
V_437 = F_239 ( & V_443 -> V_529 , V_642 ) ;
if ( V_437 )
F_173 ( V_437 ) ;
F_3 ( & V_443 -> V_528 ) ;
if ( V_437 == NULL ) {
V_650 = F_99 ( sizeof( * V_437 ) , V_116 ) ;
if ( V_650 == NULL )
return F_71 ( - V_83 ) ;
V_650 -> V_582 = V_642 ;
V_650 -> V_583 = F_71 ( - V_569 ) ;
F_210 ( V_651 , & V_650 -> V_440 ) ;
F_210 ( V_439 , & V_650 -> V_440 ) ;
F_173 ( V_650 ) ;
F_2 ( & V_443 -> V_528 ) ;
V_437 = F_239 ( & V_443 -> V_529 , V_642 ) ;
if ( V_437 ) {
...
return V_437 ;
if ( F_23 ( V_38 , V_437 -> V_441 + V_653 ) ) {
F_164 ( V_437 ) ;
return F_71 ( - V_569 ) ;
}
if ( F_247 ( V_651 , & V_437 -> V_440 ) )
goto V_652;
}
V_437 -> V_583 = F_236 ( V_443 , V_642 ) ;
F_231 ( V_651 , & V_437 -> V_440 ) ;
F_248 ( & V_437 -> V_440 , V_651 ) ;
if ( F_125 ( V_437 -> V_583 ) ) {
F_164 ( V_437 ) ;
return F_71 ( - V_569 ) ;
}
...
V_526 . V_47 ) ;
struct V_631 * V_632 = & V_443 -> V_529 ;
struct V_633 * V_634 = F_229 ( V_632 ) ;
struct V_633 * V_5 ;
struct V_436 * V_437 ;
F_2 ( & V_443 -> V_528 ) ;
V_634 = F_229 ( V_632 ) ;
...
V_5 = V_634 ;
V_634 = F_249 ( V_5 ) ;
V_437 = F_230 ( V_5 , struct V_436 , V_635 ) ;
