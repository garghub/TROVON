...
return F_54 ( V_5 -> V_420 , V_259 + V_419 ,
V_341 | V_424 |
V_421 , V_65 ) ;
}
...
unsigned int V_88 ;
int V_47 ;
V_47 = F_57 ( V_5 -> V_420 , V_259 + V_419 , & V_88 ) ;
if ( V_47 < 0 )
return V_47 ;
return ( V_88 & V_421 ) != 0 ;
}
...
int F_63 ( struct V_1 * V_2 , struct V_429 * V_430 ,
T_2 V_431 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
V_5 -> V_430 = V_430 ;
...
static T_3 F_72 ( int V_59 , void * V_461 )
{
...
F_4 ( V_2 -> V_29 , L_49 ,
V_5 -> V_15 ) ;
V_5 -> V_472 . V_383 = V_5 -> V_15 ;
V_5 -> V_472 . V_476 = V_5 -> V_26 ;
V_47 = F_78 ( V_2 , V_471 , F_5 ( V_471 ) ) ;
if ( V_47 != 0 )
F_23 ( V_2 -> V_29 ,
L_50 , V_47 ) ;
}
...
F_80 ( & V_5 -> V_413 ) ;
V_2 -> V_295 = V_5 -> V_420 ;
V_47 = F_81 ( V_2 , 16 , 16 , V_478 ) ;
if ( V_47 != 0 ) {
F_23 ( V_2 -> V_29 , L_51 , V_47 ) ;
goto V_479;
}
if ( V_5 -> V_7 . V_23 )
F_75 ( V_2 ) ;
...
V_477 = V_481 ;
V_477 |= V_482 ;
if ( V_477 & ( V_483 | V_484 ) )
V_47 = F_82 ( V_56 -> V_59 , NULL ,
F_74 ,
V_477 , L_52 , V_2 ) ;
else
V_47 = F_82 ( V_56 -> V_59 , NULL , F_72 ,
V_477 , L_52 , V_2 ) ;
if ( V_47 == 0 ) {
F_6 ( V_2 , V_271 ,
V_485 , 0 ) ;
...
const struct V_490 * V_37 )
{
struct V_4 * V_5 ;
int V_47 , V_12 ;
unsigned int V_88 ;
V_5 = F_86 ( & V_56 -> V_29 , sizeof( struct V_4 ) ,
V_475 ) ;
if ( V_5 == NULL )
return - V_491 ;
F_87 ( V_56 , V_5 ) ;
V_5 -> V_29 = & V_56 -> V_29 ;
if ( F_88 ( & V_56 -> V_29 ) )
memcpy ( & V_5 -> V_7 , F_88 ( & V_56 -> V_29 ) ,
sizeof( V_5 -> V_7 ) ) ;
if ( V_5 -> V_7 . V_294 > 0 ) {
V_47 = F_89 ( V_5 -> V_7 . V_294 ,
V_492 , L_54 ) ;
if ( V_47 < 0 ) {
F_23 ( & V_56 -> V_29 , L_55 ,
V_5 -> V_7 . V_294 , V_47 ) ;
...
V_47 = F_90 ( & V_56 -> V_29 , F_5 ( V_5 -> V_293 ) ,
V_5 -> V_293 ) ;
if ( V_47 != 0 ) {
...
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_293 ) ; V_12 ++ ) {
V_47 = F_91 ( V_5 -> V_293 [ V_12 ] . V_501 ,
& V_5 -> V_496 [ V_12 ] ) ;
if ( V_47 != 0 ) {
F_23 ( & V_56 -> V_29 ,
L_57 ,
...
V_5 -> V_420 = F_92 ( V_56 , & V_502 ) ;
if ( F_93 ( V_5 -> V_420 ) ) {
V_47 = F_94 ( V_5 -> V_420 ) ;
F_23 ( & V_56 -> V_29 , L_58 , V_47 ) ;
goto V_503;
}
V_47 = F_57 ( V_5 -> V_420 , V_89 , & V_88 ) ;
if ( V_47 < 0 ) {
F_23 ( & V_56 -> V_29 , L_59 , V_47 ) ;
goto V_504;
}
if ( V_88 != 0x8915 ) {
F_23 ( & V_56 -> V_29 , L_60 , V_88 ) ;
V_47 = - V_32 ;
goto V_504;
}
V_47 = F_57 ( V_5 -> V_420 , V_128 , & V_88 ) ;
if ( V_47 < 0 ) {
F_23 ( & V_56 -> V_29 , L_61 ,
V_47 ) ;
goto V_504;
...
F_54 ( V_5 -> V_420 , V_97 ,
V_516 , V_516 ) ;
F_54 ( V_5 -> V_420 , V_101 ,
V_517 , V_517 ) ;
F_54 ( V_5 -> V_420 , V_102 ,
V_517 , V_517 ) ;
F_54 ( V_5 -> V_420 , V_103 ,
V_518 , V_518 ) ;
F_54 ( V_5 -> V_420 , V_104 ,
V_518 , V_518 ) ;
F_54 ( V_5 -> V_420 , V_105 ,
V_517 , V_517 ) ;
F_54 ( V_5 -> V_420 , V_106 ,
V_517 , V_517 ) ;
F_54 ( V_5 -> V_420 , V_107 ,
V_518 , V_518 ) ;
F_54 ( V_5 -> V_420 , V_108 ,
V_518 , V_518 ) ;
F_54 ( V_5 -> V_420 , V_183 ,
V_519 , V_519 ) ;
F_54 ( V_5 -> V_420 , V_184 ,
V_519 , V_519 ) ;
F_54 ( V_5 -> V_420 , V_213 ,
V_520 , V_520 ) ;
F_54 ( V_5 -> V_420 , V_214 ,
V_520 , V_520 ) ;
F_54 ( V_5 -> V_420 , V_185 ,
V_521 , V_521 ) ;
F_54 ( V_5 -> V_420 , V_186 ,
V_521 , V_521 ) ;
F_54 ( V_5 -> V_420 , V_215 ,
V_522 , V_522 ) ;
F_54 ( V_5 -> V_420 , V_216 ,
V_522 , V_522 ) ;
F_54 ( V_5 -> V_420 ,
V_160 ,
V_523 |
...
V_561 ,
1 << V_548 | 1 ) ;
V_47 = F_57 ( V_5 -> V_420 , V_259 , & V_88 ) ;
if ( V_47 != 0 ) {
F_23 ( & V_56 -> V_29 , L_64 , V_47 ) ;
goto V_504;
}
if ( V_88 & V_341 )
F_54 ( V_5 -> V_420 , V_148 ,
V_562 ,
V_562 ) ;
V_47 = F_57 ( V_5 -> V_420 , V_260 , & V_88 ) ;
if ( V_47 != 0 ) {
F_23 ( & V_56 -> V_29 , L_65 , V_47 ) ;
goto V_504;
}
if ( V_88 & V_342 )
F_54 ( V_5 -> V_420 , V_171 ,
V_563 ,
V_563 ) ;
F_59 ( V_5 ) ;
V_47 = F_97 ( & V_56 -> V_29 ,
...
static int F_99 ( struct V_55 * V_567 )
{
struct V_4 * V_5 = F_100 ( V_567 ) ;
int V_12 ;
F_101 ( & V_567 -> V_29 ) ;
F_61 ( V_5 ) ;
if ( V_5 -> V_7 . V_294 > 0 ) {
