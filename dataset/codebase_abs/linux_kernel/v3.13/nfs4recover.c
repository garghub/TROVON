...
F_87 ( & V_118 -> V_122 ) ;
F_9 ( L_29 , V_119 , V_3 -> V_123 . V_120 ) ;
return V_3 ;
}
static void
...
if ( ! V_156 )
return V_156 ;
V_155 = snprintf ( V_156 , V_23 , V_158 L_37 ,
F_73 () ) ;
if ( V_155 >= V_23 ) {
F_17 ( V_156 ) ;
return NULL ;
...
if ( ! V_156 )
return V_156 ;
V_155 = snprintf ( V_156 , V_23 , V_159 L_38 ,
F_73 () ) ;
if ( V_155 > ( V_23 - V_38 ) ) {
F_17 ( V_156 ) ;
return NULL ;
...
F_9 ( L_40 , V_119 , V_160 ) ;
F_9 ( L_41 , V_119 , V_59 ? V_59 : L_42 ) ;
F_9 ( L_43 , V_119 , V_161 ? V_161 : L_42 ) ;
V_162 [ 0 ] = V_161 ;
V_162 [ 1 ] = NULL ;
V_163 [ 0 ] = ( char * ) V_164 ;
V_163 [ 1 ] = V_160 ;
