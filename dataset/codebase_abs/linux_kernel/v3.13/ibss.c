...
if ( V_5 -> V_65 . V_87 ) {
V_75 = F_39 ( V_5 -> V_65 . V_87 , sizeof( * V_75 ) , V_19 ) ;
if ( ! V_75 )
return - V_93 ;
for ( V_71 = 0 ; V_71 < 6 ; V_71 ++ )
...
if ( ! V_26 -> V_72 -> V_102 )
return - V_103 ;
V_101 = F_41 ( V_5 -> V_14 , V_99 ) ;
if ( V_101 < 0 )
return V_101 ;
if ( V_101 ) {
V_51 = F_42 ( V_5 -> V_14 , V_101 ) ;
if ( ! V_51 )
return - V_84 ;
if ( V_51 -> V_29 & V_82 ||
V_51 -> V_29 & V_83 )
...
V_44 = 0 ;
if ( V_5 -> V_13 )
V_44 = F_33 ( V_26 , V_2 , true ) ;
F_29 ( V_5 ) ;
if ( V_44 )
return V_44 ;
if ( V_51 ) {
F_37 ( & V_5 -> V_65 . V_66 . V_50 , V_51 ,
V_85 ) ;
