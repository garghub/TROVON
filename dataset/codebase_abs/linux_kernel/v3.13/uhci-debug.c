...
break;
case 1 :
V_167 = V_151 -> V_168 + V_165 ;
break;
}
if ( V_167 < 0 || V_167 > V_154 -> V_160 )
return - V_169 ;
return ( V_151 -> V_168 = V_167 ) ;
}
static T_4 F_39 ( struct V_151 * V_151 , char T_5 * V_1 ,
T_6 V_170 , T_3 * V_171 )
{
struct V_153 * V_154 = V_151 -> V_164 ;
return F_40 ( V_1 , V_170 , V_171 , V_154 -> V_158 , V_154 -> V_160 ) ;
}
static int F_41 ( struct V_150 * V_150 , struct V_151 * V_151 )
{
struct V_153 * V_154 = V_151 -> V_164 ;
F_35 ( V_154 -> V_158 ) ;
F_35 ( V_154 ) ;
