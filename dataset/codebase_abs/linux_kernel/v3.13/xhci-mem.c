...
struct V_142 * V_273 = & V_3 -> V_131 [ V_8 ] . V_143 ;
for ( V_139 = 0 ; V_139 < V_147 ; V_139 ++ ) {
struct V_124 * V_84 = & V_273 -> V_148 [ V_139 ] . V_149 ;
while ( ! F_63 ( V_84 ) )
F_125 ( V_84 -> V_16 ) ;
}
}
for ( V_8 = 0 ; V_8 < V_138 ; V_8 ++ ) {
struct V_126 * V_137 , * V_274 ;
...
struct V_1 * V_6 ;
V_292 = F_52 ( V_285 , V_286 ) ;
V_293 = F_52 ( V_285 , V_287 ) ;
V_6 = F_127 ( V_285 , V_286 , V_287 , V_288 ) ;
if ( V_6 != V_289 ) {
F_64 ( V_3 , L_38 ,
V_290 , V_291 ) ;
F_64 ( V_3 , L_39
...
static int F_128 ( struct V_2 * V_3 , T_1 V_82 )
{
struct {
T_2 V_288 ;
struct V_1 * V_289 ;
...
{ . V_285 = V_3 -> V_267 -> V_37 ,
. V_286 = V_3 -> V_267 -> V_37 -> V_9 ,
. V_287 = & V_3 -> V_267 -> V_37 -> V_9 [ V_12 - 1 ] ,
. V_288 = V_3 -> V_269 -> V_37 -> V_7 ,
. V_289 = NULL ,
} ,
{ . V_285 = V_3 -> V_267 -> V_37 ,
. V_286 = V_3 -> V_267 -> V_37 -> V_9 ,
. V_287 = & V_3 -> V_269 -> V_37 -> V_9 [ V_12 - 1 ] ,
. V_288 = V_3 -> V_269 -> V_37 -> V_7 ,
. V_289 = NULL ,
} ,
{ . V_285 = V_3 -> V_267 -> V_37 ,
. V_286 = V_3 -> V_269 -> V_37 -> V_9 ,
. V_287 = & V_3 -> V_269 -> V_37 -> V_9 [ V_12 - 1 ] ,
. V_288 = V_3 -> V_269 -> V_37 -> V_7 ,
. V_289 = NULL ,
} ,
{ . V_285 = V_3 -> V_267 -> V_37 ,
. V_286 = & V_3 -> V_267 -> V_37 -> V_9 [ 0 ] ,
. V_287 = & V_3 -> V_267 -> V_37 -> V_9 [ 3 ] ,
. V_288 = V_3 -> V_267 -> V_37 -> V_7 + 4 * 16 ,
. V_289 = NULL ,
} ,
{ . V_285 = V_3 -> V_267 -> V_37 ,
. V_286 = & V_3 -> V_267 -> V_37 -> V_9 [ 3 ] ,
. V_287 = & V_3 -> V_267 -> V_37 -> V_9 [ 6 ] ,
. V_288 = V_3 -> V_267 -> V_37 -> V_7 + 2 * 16 ,
. V_289 = NULL ,
} ,
{ . V_285 = V_3 -> V_267 -> V_37 ,
. V_286 = & V_3 -> V_267 -> V_37 -> V_9 [ V_12 - 3 ] ,
. V_287 = & V_3 -> V_267 -> V_37 -> V_9 [ 1 ] ,
. V_288 = V_3 -> V_267 -> V_37 -> V_7 + 2 * 16 ,
. V_289 = NULL ,
} ,
{ . V_285 = V_3 -> V_267 -> V_37 ,
. V_286 = & V_3 -> V_267 -> V_37 -> V_9 [ V_12 - 3 ] ,
. V_287 = & V_3 -> V_267 -> V_37 -> V_9 [ 1 ] ,
. V_288 = V_3 -> V_267 -> V_37 -> V_7 + ( V_12 - 4 ) * 16 ,
. V_289 = NULL ,
} ,
{ . V_285 = V_3 -> V_267 -> V_37 ,
. V_286 = & V_3 -> V_267 -> V_37 -> V_9 [ V_12 - 3 ] ,
. V_287 = & V_3 -> V_267 -> V_37 -> V_9 [ 1 ] ,
. V_288 = V_3 -> V_269 -> V_37 -> V_7 + 2 * 16 ,
. V_289 = NULL ,
} ,
} ;
unsigned int V_296 ;
...
F_64 ( V_3 , L_47
L_48 ) ;
V_297 = F_132 ( V_3 , & V_3 -> V_298 -> V_299 ) ;
V_297 &= V_300 ;
V_297 &= ~ V_301 ;
F_24 ( V_3 , V_238 ,
L_49
L_50 ) ;
F_133 ( V_3 , ( ( T_4 ) V_118 & ( T_4 ) ~ V_300 ) | V_297 ,
& V_3 -> V_298 -> V_299 ) ;
}
static void F_134 ( struct V_2 * V_3 , unsigned int V_138 ,
T_5 T_6 * V_98 , T_7 V_302 , int V_303 )
{
T_3 V_297 , V_304 , V_305 ;
int V_8 ;
if ( V_302 > 0x03 ) {
F_64 ( V_3 , L_51
L_52 ,
...
V_297 = F_135 ( V_3 , V_98 + 2 ) ;
V_304 = F_136 ( V_297 ) ;
V_305 = F_137 ( V_297 ) ;
F_24 ( V_3 , V_238 ,
L_53
L_54 ,
V_98 , V_304 , V_305 , V_302 ) ;
if ( V_304 == 0 || ( V_304 + V_305 - 1 ) > V_138 )
return;
if ( V_302 < 0x03 && V_3 -> V_306 < V_303 )
V_3 -> V_281 [ V_3 -> V_306 ++ ] = V_297 ;
if ( ( V_3 -> V_221 == 0x96 ) && ( V_302 != 0x03 ) &&
( V_297 & V_307 ) ) {
F_24 ( V_3 , V_238 ,
L_55 ) ;
V_3 -> V_308 = 1 ;
}
if ( ( V_3 -> V_221 >= 0x100 ) && ( V_302 != 0x03 ) ) {
F_24 ( V_3 , V_238 ,
L_56 ) ;
V_3 -> V_308 = 1 ;
if ( V_297 & V_309 ) {
...
V_304 -- ;
for ( V_8 = V_304 ; V_8 < ( V_304 + V_305 ) ; V_8 ++ ) {
if ( V_3 -> V_280 [ V_8 ] != 0 ) {
F_64 ( V_3 , L_58
L_59 , V_98 , V_8 ) ;
F_64 ( V_3 , L_60
...
static int F_138 ( struct V_2 * V_3 , T_1 V_5 )
{
T_5 T_6 * V_98 , * V_312 ;
T_3 V_313 , V_314 ;
unsigned int V_138 ;
...
V_138 = F_57 ( V_3 -> V_130 ) ;
V_3 -> V_280 = F_2 ( sizeof( * V_3 -> V_280 ) * V_138 , V_5 ) ;
if ( ! V_3 -> V_280 )
return - V_43 ;
...
V_98 = & V_3 -> V_317 -> V_319 + V_313 ;
V_312 = V_98 ;
V_314 = V_313 ;
do {
T_3 V_320 ;
V_320 = F_135 ( V_3 , V_312 ) ;
if ( F_141 ( V_320 ) == V_321 )
V_316 ++ ;
V_314 = F_142 ( V_320 ) ;
V_312 += V_314 ;
} while ( V_314 );
V_3 -> V_281 = F_2 ( sizeof( * V_3 -> V_281 ) * V_316 , V_5 ) ;
if ( ! V_3 -> V_281 )
return - V_43 ;
while ( 1 ) {
T_3 V_320 ;
V_320 = F_135 ( V_3 , V_98 ) ;
if ( F_141 ( V_320 ) == V_321 )
F_134 ( V_3 , V_138 , V_98 ,
( T_7 ) F_143 ( V_320 ) ,
V_316 ) ;
V_313 = F_142 ( V_320 ) ;
if ( ! V_313 || ( V_3 -> V_275 + V_3 -> V_276 )
== V_138 )
break;
V_98 += V_313 ;
}
...
if ( V_3 -> V_275 ) {
V_3 -> V_278 = F_144 ( sizeof( * V_3 -> V_278 ) *
V_3 -> V_275 , V_5 ) ;
if ( ! V_3 -> V_278 )
return - V_43 ;
V_315 = 0 ;
...
if ( V_3 -> V_276 ) {
V_3 -> V_279 = F_144 ( sizeof( * V_3 -> V_279 ) *
V_3 -> V_276 , V_5 ) ;
if ( ! V_3 -> V_279 )
return - V_43 ;
V_315 = 0 ;
...
int F_145 ( struct V_2 * V_3 , T_1 V_5 )
{
T_2 V_7 ;
struct V_235 * V_78 = F_34 ( V_3 ) -> V_75 . V_76 ;
unsigned int V_20 , V_326 ;
T_4 V_327 ;
struct V_1 * V_6 ;
T_3 V_249 , V_297 ;
int V_8 ;
F_19 ( & V_3 -> V_270 ) ;
V_249 = F_135 ( V_3 , & V_3 -> V_323 -> V_249 ) ;
F_24 ( V_3 , V_238 ,
L_71 , V_249 ) ;
...
F_64 ( V_3 , L_73 ) ;
V_3 -> V_282 = 12 ;
V_3 -> V_249 = 1 << V_3 -> V_282 ;
F_24 ( V_3 , V_238 ,
L_74 , V_3 -> V_249 / 1024 ) ;
V_20 = F_146 ( F_135 ( V_3 , & V_3 -> V_317 -> V_130 ) ) ;
F_24 ( V_3 , V_238 ,
L_75 , V_20 ) ;
V_326 = F_135 ( V_3 , & V_3 -> V_323 -> V_328 ) ;
V_20 |= ( V_326 & ~ V_329 ) ;
F_24 ( V_3 , V_238 ,
L_76 , V_20 ) ;
F_147 ( V_3 , V_20 , & V_3 -> V_323 -> V_328 ) ;
...
F_133 ( V_3 , V_7 , & V_3 -> V_323 -> V_331 ) ;
V_3 -> V_10 = F_148 ( L_78 , V_78 ,
V_11 , 64 , V_3 -> V_249 ) ;
V_3 -> V_66 = F_148 ( L_79 , V_78 ,
2112 , 64 , V_3 -> V_249 ) ;
...
goto V_46;
V_3 -> V_269 = F_18 ( V_3 , 1 , 1 , V_332 , V_5 ) ;
if ( ! V_3 -> V_269 )
goto V_46;
F_24 ( V_3 , V_238 ,
L_82 , V_3 -> V_269 ) ;
...
V_327 = F_132 ( V_3 , & V_3 -> V_323 -> V_269 ) ;
V_327 = ( V_327 & ( T_4 ) V_333 ) |
( V_3 -> V_269 -> V_37 -> V_7 & ( T_4 ) ~ V_333 ) |
V_3 -> V_269 -> V_4 ;
F_24 ( V_3 , V_238 ,
L_84 , V_20 ) ;
F_133 ( V_3 , V_327 , & V_3 -> V_323 -> V_269 ) ;
F_149 ( V_3 ) ;
V_3 -> V_268 = F_42 ( V_3 , true , true , V_5 ) ;
if ( ! V_3 -> V_268 )
goto V_46;
V_3 -> V_99 ++ ;
V_20 = F_135 ( V_3 , & V_3 -> V_317 -> V_334 ) ;
V_20 &= V_335 ;
F_24 ( V_3 , V_238 ,
L_85
L_86 , V_20 ) ;
V_3 -> V_336 = ( void T_6 * ) V_3 -> V_317 + V_20 ;
F_150 ( V_3 ) ;
F_151 ( V_3 ) ;
V_3 -> V_298 = & V_3 -> V_337 -> V_298 [ 0 ] ;
F_24 ( V_3 , V_238 , L_87 ) ;
V_3 -> V_267 = F_18 ( V_3 , V_338 , 1 , V_21 ,
V_5 ) ;
if ( ! V_3 -> V_267 )
goto V_46;
if ( F_128 ( V_3 , V_5 ) < 0 )
...
memset ( V_3 -> V_263 . V_265 , 0 , sizeof( struct V_262 ) * V_338 ) ;
V_3 -> V_263 . V_264 = V_338 ;
V_3 -> V_263 . V_266 = V_7 ;
F_24 ( V_3 , V_238 ,
L_89 ,
V_3 -> V_263 . V_264 ,
...
for ( V_20 = 0 , V_6 = V_3 -> V_267 -> V_37 ; V_20 < V_338 ; V_20 ++ ) {
struct V_262 * V_339 = & V_3 -> V_263 . V_265 [ V_20 ] ;
V_339 -> V_340 = F_9 ( V_6 -> V_7 ) ;
V_339 -> V_341 = F_13 ( V_12 ) ;
V_339 -> V_342 = 0 ;
V_6 = V_6 -> V_16 ;
}
V_20 = F_135 ( V_3 , & V_3 -> V_298 -> V_343 ) ;
V_20 &= V_344 ;
V_20 |= V_338 ;
F_24 ( V_3 , V_238 ,
L_90 ,
V_20 ) ;
F_147 ( V_3 , V_20 , & V_3 -> V_298 -> V_343 ) ;
F_24 ( V_3 , V_238 ,
L_91 ) ;
F_24 ( V_3 , V_238 ,
L_92 ,
( unsigned long long ) V_3 -> V_263 . V_266 ) ;
V_327 = F_132 ( V_3 , & V_3 -> V_298 -> V_345 ) ;
V_327 &= V_300 ;
V_327 |= ( V_3 -> V_263 . V_266 & ( T_4 ) ~ V_300 ) ;
F_133 ( V_3 , V_327 , & V_3 -> V_298 -> V_345 ) ;
F_130 ( V_3 ) ;
F_24 ( V_3 , V_238 ,
L_93 ) ;
F_152 ( V_3 , 0 ) ;
...
V_3 -> V_151 [ V_8 ] = NULL ;
for ( V_8 = 0 ; V_8 < V_322 ; ++ V_8 ) {
V_3 -> V_283 [ 0 ] . V_347 [ V_8 ] = 0 ;
V_3 -> V_283 [ 1 ] . V_347 [ V_8 ] = 0 ;
F_67 ( & V_3 -> V_283 [ 1 ] . V_348 [ V_8 ] ) ;
}
if ( F_119 ( V_3 , V_5 ) )
goto V_46;
if ( F_138 ( V_3 , V_5 ) )
goto V_46;
V_297 = F_135 ( V_3 , & V_3 -> V_323 -> V_349 ) ;
V_297 &= ~ V_350 ;
V_297 |= V_351 ;
F_147 ( V_3 , V_297 , & V_3 -> V_323 -> V_349 ) ;
return 0 ;
V_46:
F_64 ( V_3 , L_94 ) ;
F_153 ( V_3 ) ;
