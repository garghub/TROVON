...
F_6 ( V_4 ) ;
F_14 ( V_4 , V_54 -> V_36 , V_54 -> V_37 ) ;
}
static int F_17 ( struct V_7 * V_4 )
{
int V_24 ;
T_1 V_18 ;
V_24 = F_10 ( V_4 , V_55 , & V_18 ) ;
if ( V_24 ) {
...
static int F_19 ( struct V_7 * V_4 , char * V_64 )
{
struct V_65 * V_66 = V_4 -> V_66 ;
int V_24 ;
T_1 V_67 ;
V_24 = F_10 ( V_4 , V_68 , & V_67 ) ;
if ( V_24 < 0 )
return V_24 ;
if ( V_66 -> V_69 != V_70 )
return 0 ;
...
{
struct V_1 * V_2 = F_21 ( V_74 , struct V_1 ,
V_75 ) ;
...
static T_3 F_24 ( struct V_79 * V_52 ,
struct V_80 * V_81 ,
char * V_64 , int V_82 )
{
...
static T_3 F_27 ( struct V_79 * V_52 ,
struct V_80 * V_81 ,
...
V_24 = F_19 ( V_4 , V_64 ) ;
F_23 ( & V_4 -> V_76 ) ;
return F_30 ( V_64 , V_91 , L_13 , V_24 ? L_14 : L_15 ) ;
}
...
V_66 = F_32 ( & V_93 -> V_52 ) ;
V_4 = F_34 ( & V_93 -> V_52 , sizeof( * V_4 ) , V_99 ) ;
if ( ! V_4 )
return - V_100 ;
V_2 = F_34 ( & V_93 -> V_52 ,
...
if ( V_24 )
goto V_104;
F_38 ( & V_93 -> V_52 , L_17 , V_95 -> V_105 ) ;
V_24 = F_39 ( V_2 , V_4 ) ;
if ( V_24 )
goto V_106;
V_24 = F_40 ( V_4 ) ;
