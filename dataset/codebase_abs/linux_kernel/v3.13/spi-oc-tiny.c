...
V_7 -> V_54 . V_67 = F_6 ;
V_7 -> V_54 . V_68 = F_15 ;
V_59 = F_31 ( V_46 , V_69 , 0 ) ;
V_7 -> V_20 = F_32 ( & V_46 -> V_43 , V_59 ) ;
if ( F_33 ( V_7 -> V_20 ) ) {
V_60 = F_34 ( V_7 -> V_20 ) ;
goto exit;
}
...
if ( V_7 -> V_34 >= 0 ) {
F_36 ( & V_7 -> V_39 ) ;
V_60 = F_37 ( & V_46 -> V_43 , V_7 -> V_34 , F_18 , 0 ,
V_46 -> V_70 , V_7 ) ;
if ( V_60 )
goto exit;
}
...
for ( V_33 = 0 ; V_33 < V_7 -> V_11 ; V_33 ++ ) {
V_60 = F_38 ( V_7 -> V_12 [ V_33 ] , F_39 ( & V_46 -> V_43 ) ) ;
if ( V_60 )
goto V_72;
F_40 ( V_7 -> V_12 [ V_33 ] , 1 ) ;
}
V_7 -> V_54 . V_4 -> V_63 = F_41 ( 1 , V_7 -> V_11 ) ;
V_60 = F_42 ( & V_7 -> V_54 ) ;
if ( V_60 )
goto exit;
