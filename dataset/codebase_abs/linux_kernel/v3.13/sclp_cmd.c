...
if ( ! V_99 )
return 0 ;
if ( ( V_100 & 0xe00000000000ULL ) != 0xe00000000000ULL )
return 0 ;
V_8 = - V_10 ;
...
static int F_48 ( T_1 V_5 , T_5 V_106 )
{
struct V_107 * V_6 ;
int V_8 ;
if ( ! V_108 )
return - V_34 ;
V_6 = (struct V_107 * ) F_12 ( V_9 | V_35 ) ;
if ( ! V_6 )
return - V_10 ;
V_6 -> V_36 . V_37 = V_48 ;
V_6 -> V_109 = V_110 ;
...
int F_50 ( T_5 V_106 )
{
return F_48 ( V_112 , V_106 ) ;
}
int F_51 ( T_5 V_106 )
{
return F_48 ( V_113 , V_106 ) ;
}
...
if ( ! V_115 )
return - V_34 ;
V_6 = (struct V_114 * ) F_12 ( V_9 | V_35 ) ;
if ( ! V_6 )
return - V_10 ;
V_6 -> V_36 . V_37 = sizeof( * V_6 ) ;
V_8 = F_3 ( V_5 , V_6 ) ;
...
int F_53 ( struct V_116 V_117 )
{
return F_52 ( V_118 | V_117 . V_50 << 8 ) ;
}
int F_54 ( struct V_116 V_117 )
{
return F_52 ( V_119 | V_117 . V_50 << 8 ) ;
}
int F_55 ( struct V_120 * V_20 )
{
struct V_121 * V_6 ;
int V_8 ;
if ( ! V_122 )
return - V_34 ;
V_6 = (struct V_121 * ) F_12 ( V_9 | V_35 ) ;
if ( ! V_6 )
return - V_10 ;
V_6 -> V_36 . V_37 = sizeof( * V_6 ) ;
V_8 = F_3 ( V_123 , V_6 ) ;
...
memcpy ( V_20 -> V_124 , V_6 -> V_124 , V_125 ) ;
memcpy ( V_20 -> V_25 , V_6 -> V_25 , V_125 ) ;
memcpy ( V_20 -> V_23 , V_6 -> V_23 , V_125 ) ;
V_16:
F_13 ( ( unsigned long ) V_6 ) ;
return V_8 ;
}
