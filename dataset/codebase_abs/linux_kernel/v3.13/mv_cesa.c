...
static T_3 F_105 ( int V_194 , void * V_195 )
{
V_100 V_196 ;
...
V_194 = F_113 ( V_203 -> V_216 . V_217 , 0 ) ;
else
V_194 = F_114 ( V_203 , 0 ) ;
if ( V_194 < 0 || V_194 == V_218 ) {
V_39 = V_194 ;
goto V_219;
}
V_205 -> V_194 = V_194 ;
F_115 ( V_203 , V_205 ) ;
V_3 = V_205 ;
V_205 -> V_11 = F_116 ( F_60 , V_205 , L_12 ) ;
if ( F_97 ( V_205 -> V_11 ) ) {
V_39 = F_98 ( V_205 -> V_11 ) ;
goto V_219;
}
V_39 = F_117 ( V_194 , F_105 , 0 , F_118 ( & V_203 -> V_216 ) ,
V_205 ) ;
if ( V_39 )
goto V_220;
V_205 -> V_221 = F_119 ( & V_203 -> V_216 , NULL ) ;
if ( ! F_97 ( V_205 -> V_221 ) )
F_120 ( V_205 -> V_221 ) ;
F_5 ( 0 , V_3 -> V_4 + V_197 ) ;
...
static int F_130 ( struct V_202 * V_203 )
{
struct V_204 * V_205 = F_131 ( V_203 ) ;
F_123 ( & V_226 ) ;
F_123 ( & V_228 ) ;
if ( V_205 -> V_231 )
F_132 ( & V_230 ) ;
