...
struct V_9 * V_10 = F_52 ( V_150 , V_148 -> V_2 ) ;
T_1 V_151 ;
T_1 V_152 ;
int V_153 ;
if ( ! V_10 )
...
F_9 ( L_97 ,
V_148 -> V_2 , V_10 -> V_70 [ V_149 ] . V_72 , V_148 -> V_154 ,
V_148 -> V_155 ) ;
if ( F_8 ( V_10 ) )
return - V_80 ;
F_9 ( L_98 ,
...
F_55 ( & V_157 ) ;
V_148 -> V_158 = F_4 ( V_10 -> V_14 ) ;
return 0 ;
}
static int F_56 ( struct V_136 * V_148 , unsigned V_95 )
{
struct V_146 V_147 = { . V_148 = V_148 , . V_149 = V_95 } ;
return F_57 ( V_148 -> V_2 , F_51 , & V_147 ) ;
}
static void F_58 ( void * V_159 )
{
...
struct V_160 V_160 ;
int V_50 ;
F_60 ( V_148 -> V_2 , F_24 , & V_50 , 1 ) ;
if ( V_50 )
return - V_51 ;
V_10 = F_61 ( sizeof( * V_10 ) , V_75 ) ;
if ( ! V_10 ) {
...
if ( V_50 != 0 )
goto V_163;
F_64 ( V_148 -> V_164 , F_1 ( V_148 -> V_2 ) ) ;
V_10 -> V_165 = V_148 -> V_164 ;
if ( F_65 ( V_148 , V_10 -> V_70 ) ) {
...
static int F_66 ( struct V_136 * V_148 )
{
struct V_9 * V_10 = F_52 ( V_150 , V_148 -> V_2 ) ;
if ( ! V_10 )
return - V_67 ;
...
F_32 ( V_10 -> V_70 ) ;
F_32 ( V_10 ) ;
F_52 ( V_150 , V_148 -> V_2 ) = NULL ;
return 0 ;
}
static void F_68 ( void * V_166 )
{
int * V_167 = V_166 ;
...
{
const char * V_170 , * V_171 = L_108 ;
V_170 = F_72 () ;
if ( ! V_170 )
goto V_172;
if ( strncmp ( V_170 , V_171 , F_73 ( V_173 , strlen ( V_170 ) , strlen ( V_171 ) ) ) )
F_74 ( V_156 L_109 , V_170 ) ;
return;
V_172:
F_74 ( V_156 L_110 ) ;
F_75 ( V_171 ) ;
...
if ( V_153 )
return V_153 ;
F_53 ( V_156 L_111 V_178 L_112 ,
F_83 () , V_179 . V_180 , V_174 ) ;
return V_153 ;
}
