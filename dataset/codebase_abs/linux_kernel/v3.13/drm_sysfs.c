...
for ( V_75 = 0 ; V_75 < F_43 ( V_82 ) ; V_75 ++ ) {
V_36 = F_44 ( V_33 -> V_78 , & V_82 [ V_75 ] ) ;
if ( V_36 )
goto V_83;
}
switch ( V_33 -> V_65 ) {
...
case V_70 :
case V_71 :
for ( V_76 = 0 ; V_76 < F_43 ( V_84 ) ; V_76 ++ ) {
V_36 = F_44 ( V_33 -> V_78 , & V_84 [ V_76 ] ) ;
if ( V_36 )
goto V_83;
}
break;
...
F_47 ( V_33 -> V_78 , & V_84 [ V_77 ] ) ;
for ( V_77 = 0 ; V_77 < V_75 ; V_77 ++ )
F_47 ( V_33 -> V_78 , & V_82 [ V_77 ] ) ;
F_48 ( V_33 -> V_78 ) ;
V_81:
return V_36 ;
}
void F_49 ( struct V_32 * V_33 )
{
int V_77 ;
if ( ! V_33 -> V_78 )
return;
F_42 ( L_12 ,
F_41 ( V_33 ) ) ;
for ( V_77 = 0 ; V_77 < F_43 ( V_82 ) ; V_77 ++ )
F_47 ( V_33 -> V_78 , & V_82 [ V_77 ] ) ;
F_50 ( & V_33 -> V_78 -> V_49 , & V_85 ) ;
F_48 ( V_33 -> V_78 ) ;
V_33 -> V_78 = NULL ;
}
void F_46 ( struct V_6 * V_2 )
{
char * V_86 = L_13 ;
char * V_87 [] = { V_86 , NULL } ;
F_42 ( L_14 ) ;
F_51 ( & V_2 -> V_79 -> V_78 -> V_49 , V_88 , V_87 ) ;
}
static void F_52 ( struct V_1 * V_2 )
{
F_53 ( V_2 ) ;
}
int F_54 ( struct V_5 * V_89 )
{
char * V_90 ;
int V_91 ;
if ( V_89 -> type == V_92 )
...
V_90 = L_17 ;
V_89 -> V_78 = F_55 ( sizeof( * V_89 -> V_78 ) , V_16 ) ;
if ( ! V_89 -> V_78 ) {
V_91 = - V_94 ;
goto error;
}
F_56 ( V_89 -> V_78 ) ;
V_89 -> V_78 -> V_95 = F_57 ( V_96 , V_89 -> V_80 ) ;
V_89 -> V_78 -> V_17 = V_29 ;
V_89 -> V_78 -> type = & V_4 ;
V_89 -> V_78 -> V_97 = V_89 -> V_2 -> V_2 ;
V_89 -> V_78 -> V_98 = F_52 ;
F_58 ( V_89 -> V_78 , V_89 ) ;
V_91 = F_59 ( V_89 -> V_78 , V_90 , V_89 -> V_80 ) ;
if ( V_91 < 0 )
goto error;
V_91 = F_60 ( V_89 -> V_78 ) ;
if ( V_91 < 0 )
