...
F_16 ( L_3 , ( ( T_2 * ) args ) [ V_13 ] ) ;
for (; V_13 < 8 ; V_13 ++ )
F_16 ( L_4 ) ;
for ( V_13 = 0 ; V_13 < F_17 ( V_32 ) ; V_13 ++ ) {
if ( V_30 == V_32 [ V_13 ] . V_30 ) {
F_16 ( L_5 , V_32 [ V_13 ] . V_33 ) ;
break;
}
}
if ( V_13 == F_17 ( V_32 ) )
...
static bool F_18 ( struct V_1 * V_1 , T_2 V_30 ,
const void * args , int V_31 )
{
...
static bool F_23 ( struct V_1 * V_1 , T_2 V_30 , const void * V_52 , int V_25 )
{
if ( ! F_18 ( V_1 , V_30 , V_52 , V_25 ) )
return false ;
return F_19 ( V_1 , NULL , 0 ) ;
}
static bool
F_24 ( struct V_1 * V_1 , T_2 V_30 , void * V_53 , int V_25 )
{
if ( ! F_18 ( V_1 , V_30 , NULL , 0 ) )
return false ;
return F_19 ( V_1 , V_53 , V_25 ) ;
}
...
static bool F_26 ( struct V_1 * V_1 , bool * V_57 , bool * V_58 )
{
struct V_59 V_38 ;
F_27 ( sizeof( V_38 ) != 1 ) ;
if ( ! F_24 ( V_1 , V_60 ,
...
static bool F_32 ( struct V_1 * V_1 , T_2 V_30 ,
struct V_83 * V_84 )
{
return F_23 ( V_1 , V_30 , & V_84 -> V_85 , sizeof( V_84 -> V_85 ) ) &&
F_23 ( V_1 , V_30 + 1 , & V_84 -> V_86 , sizeof( V_84 -> V_86 ) ) ;
}
...
struct V_83 * V_84 )
{
F_27 ( sizeof( V_84 -> V_85 ) != 8 ) ;
F_27 ( sizeof( V_84 -> V_86 ) != 8 ) ;
return F_24 ( V_1 , V_99 ,
& V_84 -> V_85 , sizeof( V_84 -> V_85 ) ) &&
F_24 ( V_1 , V_100 ,
& V_84 -> V_86 , sizeof( V_84 -> V_86 ) ) ;
}
static bool F_37 ( struct V_1 * V_1 , T_2 V_8 )
{
return F_23 ( V_1 , V_101 , & V_8 , 1 ) ;
}
...
T_5 V_49 )
{
return F_23 ( V_1 , V_143 , & V_49 , 1 ) ;
}
static bool F_42 ( struct V_1 * V_1 ,
T_5 V_49 )
{
return F_23 ( V_1 , V_144 , & V_49 , 1 ) ;
}
...
struct V_158 * V_158 = F_52 ( V_157 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_1 V_159 ;
struct V_160 V_161 ;
struct V_83 V_153 ;
int V_162 = F_53 ( V_152 ) ;
int V_163 ;
int V_15 = F_8 ( V_10 ) ? 1 : 0 ;
if ( ! V_49 )
return;
...
static void F_56 ( struct V_2 * V_3 , int V_49 )
{
struct V_9 * V_10 = V_3 -> V_10 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_1 V_183 ;
...
static bool F_60 ( struct V_1 * V_1 , struct V_195 * V_196 )
{
F_27 ( sizeof( * V_196 ) != 8 ) ;
if ( ! F_24 ( V_1 ,
V_197 ,
...
V_34 = V_224 ;
if ( V_1 -> V_225 ) {
V_1 -> V_167 = F_66 ( V_210 ) ;
V_1 -> V_179 = F_67 ( V_210 ) ;
}
} else
V_34 = V_226 ;
F_68 ( V_210 ) ;
...
static enum V_219
F_69 ( struct V_5 * V_6 , bool V_228 )
{
T_4 V_38 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
struct V_7 * V_7 = F_5 ( V_6 ) ;
...
if ( ! F_19 ( V_1 , & V_240 , 3 ) )
return;
for ( V_13 = 0 ; V_13 < F_17 ( V_242 ) ; V_13 ++ )
if ( V_240 & ( 1 << V_13 ) ) {
struct V_48 * V_243 ;
V_243 = F_76 ( V_6 -> V_10 ,
& V_242 [ V_13 ] ) ;
...
V_246:
F_81 (newmode, &connector->probed_modes, head) {
if ( V_244 -> type & V_248 ) {
V_1 -> V_94 =
F_76 ( V_6 -> V_10 , V_244 ) ;
F_48 ( V_1 -> V_94 ,
...
T_5 V_30 ;
int V_28 ;
V_28 = F_92 ( & V_6 -> V_4 , V_270 , V_8 ) ;
if ( V_28 )
return V_28 ;
if ( V_270 == V_214 -> V_272 ) {
int V_13 = V_8 ;
bool V_268 ;
if ( V_13 == V_7 -> V_227 )
return 0 ;
...
if ( V_270 == V_214 -> V_274 ) {
if ( V_8 == ! ! V_1 -> V_275 )
return 0 ;
V_1 -> V_275 = V_8 ? V_276 : 0 ;
goto V_273;
}
#define F_93 ( V_33 , T_8 ) \
...
F_93 (hpos, HPOS)
F_93 (vpos, VPOS)
F_93 (saturation, SATURATION)
F_93 (contrast, CONTRAST)
F_93 (hue, HUE)
F_93 (brightness, BRIGHTNESS)
F_93 (sharpness, SHARPNESS)
F_93 (flicker_filter, FLICKER_FILTER)
F_93 (flicker_filter_2d, FLICKER_FILTER_2D)
F_93 (flicker_filter_adaptive, FLICKER_FILTER_ADAPTIVE)
F_93 (tv_chroma_filter, TV_CHROMA_FILTER)
F_93 (tv_luma_filter, TV_LUMA_FILTER)
F_93 (dot_crawl, DOT_CRAWL)
}
return - V_278 ;
V_284:
if ( ! F_23 ( V_1 , V_30 , & V_271 , 2 ) )
return - V_289 ;
V_273:
if ( V_1 -> V_4 . V_4 . V_157 ) {
struct V_156 * V_157 = V_1 -> V_4 . V_4 . V_157 ;
F_95 ( V_157 , & V_157 -> V_49 , V_157 -> V_290 ,
V_157 -> V_291 , V_157 -> V_292 ) ;
}
return 0 ;
#undef F_93
}
...
{
struct V_9 * V_10 = V_6 -> V_10 ;
struct V_293 * V_293 = F_4 ( V_6 ) ;
struct V_1 * V_211 = F_1 ( & V_293 -> V_4 ) ;
V_211 -> V_294 = F_55 ( V_211 -> V_16 ) ;
}
...
struct V_156 * V_157 = V_3 -> V_157 ;
F_98 ( V_211 -> V_16 , V_211 -> V_294 ) ;
if ( V_6 -> V_34 == V_224 )
F_95 ( V_157 , & V_157 -> V_49 , V_157 -> V_290 , V_157 -> V_291 ,
NULL ) ;
}
...
static void
F_104 ( struct V_213 * V_214 ,
struct V_1 * V_211 , T_1 V_295 )
{
struct V_296 * V_297 ;
if ( F_105 ( V_295 ) )
V_297 = & ( V_214 -> V_298 [ 0 ] ) ;
...
V_297 = & ( V_214 -> V_298 [ 1 ] ) ;
if ( V_297 -> V_299 )
V_211 -> V_50 = 1 << ( ( V_297 -> V_300 & 0xf0 ) >> 4 ) ;
else
F_103 ( V_211 ) ;
}
static void
F_106 ( struct V_213 * V_214 ,
struct V_1 * V_211 , T_1 V_295 )
{
struct V_296 * V_297 ;
T_2 V_301 , V_302 ;
...
if ( V_301 < V_307 ) {
V_211 -> V_29 = & V_214 -> V_216 [ V_301 ] . V_218 ;
F_107 ( V_211 -> V_29 , V_302 ) ;
F_108 ( V_211 -> V_29 , true ) ;
} else
V_211 -> V_29 = & V_214 -> V_216 [ V_303 ] . V_218 ;
}
static bool
F_109 ( struct V_1 * V_1 , int V_308 )
{
return F_40 ( V_1 ) ;
}
static T_2
F_110 ( struct V_9 * V_10 , int V_16 )
{
struct V_213 * V_214 = V_10 -> V_215 ;
struct V_296 * V_309 , * V_310 ;
if ( F_105 ( V_16 ) ) {
V_309 = & V_214 -> V_298 [ 0 ] ;
V_310 = & V_214 -> V_298 [ 1 ] ;
} else {
...
static bool
F_117 ( struct V_1 * V_1 , int V_308 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_319 * V_320 ;
struct V_7 * V_7 ;
V_7 = F_118 ( sizeof( struct V_7 ) , V_321 ) ;
if ( ! V_7 )
return false ;
if ( V_308 == 0 ) {
V_1 -> V_322 |= V_323 ;
...
V_1 -> V_155 = true ;
V_1 -> V_4 . V_233 = true ;
V_1 -> V_4 . V_329 = 1 << V_334 ;
F_111 ( V_7 , V_1 ) ;
if ( ! F_120 ( V_1 , V_7 , type ) )
goto V_335;
if ( ! F_121 ( V_1 , V_7 ) )
goto V_335;
return true ;
...
static bool
F_122 ( struct V_1 * V_1 , int V_308 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_319 * V_320 ;
...
static bool
F_123 ( struct V_1 * V_1 , int V_308 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_319 * V_320 ;
...
return false ;
if ( ( V_24 & V_349 ) == 0 ) {
unsigned char V_350 [ 2 ] ;
V_1 -> V_322 = 0 ;
memcpy ( V_350 , & V_1 -> V_196 . V_209 , 2 ) ;
F_13 ( L_34 ,
F_15 ( V_1 ) ,
V_350 [ 0 ] , V_350 [ 1 ] ) ;
return false ;
}
V_1 -> V_4 . V_351 = ( 1 << 0 ) | ( 1 << 1 ) ;
return true ;
}
static bool F_120 ( struct V_1 * V_1 ,
struct V_7 * V_7 ,
int type )
{
struct V_9 * V_10 = V_1 -> V_4 . V_4 . V_10 ;
...
return false ;
V_7 -> V_353 = 0 ;
for ( V_13 = 0 ; V_13 < V_277 ; V_13 ++ )
if ( V_147 & ( 1 << V_13 ) )
V_7 -> V_279 [ V_7 -> V_353 ++ ] = V_13 ;
V_7 -> V_267 =
F_125 ( V_10 , V_354 ,
L_35 , V_7 -> V_353 ) ;
if ( ! V_7 -> V_267 )
return false ;
for ( V_13 = 0 ; V_13 < V_7 -> V_353 ; V_13 ++ )
F_126 (
V_7 -> V_267 , V_13 ,
V_13 , V_355 [ V_7 -> V_279 [ V_13 ] ] ) ;
V_1 -> V_148 = V_7 -> V_279 [ 0 ] ;
F_127 ( & V_7 -> V_4 . V_4 . V_4 ,
V_7 -> V_267 , 0 ) ;
return true ;
}
static bool
...
return false ;
V_7 -> V_282 = V_358 [ 0 ] ;
V_7 -> V_280 = V_358 [ 0 ] - V_38 ;
V_7 -> V_281 = V_7 -> V_280 ;
V_7 -> V_250 =
F_129 ( V_10 , 0 , L_36 , 0 , V_358 [ 0 ] ) ;
if ( ! V_7 -> V_250 )
return false ;
F_127 ( & V_6 -> V_4 ,
V_7 -> V_250 ,
...
return false ;
V_7 -> V_287 = V_358 [ 0 ] ;
V_7 -> V_285 = V_358 [ 0 ] - V_38 ;
V_7 -> V_286 = V_7 -> V_285 ;
V_7 -> V_252 =
F_129 ( V_10 , 0 , L_40 , 0 , V_358 [ 0 ] ) ;
if ( ! V_7 -> V_252 )
return false ;
F_127 ( & V_6 -> V_4 ,
V_7 -> V_252 ,
...
F_130 ( V_263 , V_376 ) ;
if ( V_357 . V_265 ) {
if ( ! F_24 ( V_1 , V_377 , & V_38 , 2 ) )
return false ;
V_7 -> V_378 = 1 ;
V_7 -> V_379 = V_38 & 0x1 ;
V_7 -> V_265 =
F_129 ( V_10 , 0 , L_43 , 0 , 1 ) ;
if ( ! V_7 -> V_265 )
return false ;
F_127 ( & V_6 -> V_4 ,
V_7 -> V_265 ,
...
if ( F_83 ( V_7 ) )
return F_128 ( V_1 , V_7 , V_357 . V_240 ) ;
else if( F_84 ( V_7 ) )
return F_131 ( V_1 , V_7 , V_357 . V_240 ) ;
else
return true ;
}
static int F_132 ( struct V_381 * V_218 ,
struct V_21 * V_22 ,
int V_382 )
{
struct V_1 * V_211 = V_218 -> V_383 ;
if ( ! F_22 ( V_211 , V_211 -> V_50 ) )
return - V_289 ;
return V_211 -> V_29 -> V_384 -> V_385 ( V_211 -> V_29 , V_22 , V_382 ) ;
}
static T_1 F_133 ( struct V_381 * V_218 )
{
struct V_1 * V_211 = V_218 -> V_383 ;
return V_211 -> V_29 -> V_384 -> V_386 ( V_211 -> V_29 ) ;
}
static bool
F_134 ( struct V_1 * V_211 ,
struct V_9 * V_10 )
{
V_211 -> V_212 . V_387 = V_388 ;
V_211 -> V_212 . V_389 = V_390 ;
snprintf ( V_211 -> V_212 . V_33 , V_391 , L_46 ) ;
V_211 -> V_212 . V_10 . V_392 = & V_10 -> V_393 -> V_10 ;
V_211 -> V_212 . V_383 = V_211 ;
V_211 -> V_212 . V_384 = & V_394 ;
return F_135 ( & V_211 -> V_212 ) == 0 ;
}
bool F_136 ( struct V_9 * V_10 , int V_16 )
{
struct V_213 * V_214 = V_10 -> V_215 ;
struct V_293 * V_293 ;
struct V_1 * V_1 ;
int V_13 ;
V_1 = F_118 ( sizeof( struct V_1 ) , V_321 ) ;
if ( ! V_1 )
return false ;
V_1 -> V_16 = V_16 ;
V_1 -> V_23 = F_110 ( V_10 , V_16 ) >> 1 ;
F_106 ( V_214 , V_1 , V_16 ) ;
if ( ! F_134 ( V_1 , V_10 ) ) {
F_68 ( V_1 ) ;
return false ;
}
V_293 = & V_1 -> V_4 ;
V_293 -> type = V_395 ;
F_137 ( V_10 , & V_293 -> V_4 , & V_396 , 0 ) ;
for ( V_13 = 0 ; V_13 < 0x40 ; V_13 ++ ) {
T_2 V_397 ;
if ( ! F_11 ( V_1 , V_13 , & V_397 ) ) {
F_13 ( L_47 ,
F_105 ( V_16 ) ? 'B' : 'C' ) ;
goto V_335;
}
...
V_214 -> V_398 |= V_400 ;
F_138 ( & V_293 -> V_4 , & V_401 ) ;
if ( ! F_60 ( V_1 , & V_1 -> V_196 ) )
goto V_335;
if ( F_124 ( V_1 ,
