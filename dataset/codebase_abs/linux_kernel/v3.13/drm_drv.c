...
( ( V_51 < V_61 ) || ( V_51 >= V_62 ) ) )
goto V_63;
if ( ( V_51 >= V_61 ) && ( V_51 < V_62 ) &&
( V_51 < V_61 + V_24 -> V_31 -> V_64 ) ) {
T_5 V_65 ;
V_49 = & V_24 -> V_31 -> V_66 [ V_51 - V_61 ] ;
V_65 = F_26 ( V_49 -> V_67 ) ;
V_56 = V_57 = F_26 ( V_45 ) ;
if ( V_65 > V_57 )
V_57 = V_65 ;
...
F_27 ( L_6 ,
F_28 ( V_69 ) ,
( long ) F_29 ( V_27 -> V_34 -> V_70 ) ,
V_27 -> V_71 , V_49 -> V_37 ) ;
V_50 = V_49 -> V_50 ;
if ( ! V_50 ) {
F_27 ( L_7 ) ;
V_52 = - V_53 ;
} else if ( ( ( V_49 -> V_72 & V_73 ) && ! F_30 ( V_74 ) ) ||
( ( V_49 -> V_72 & V_75 ) && ! F_31 ( V_27 ) && ! V_27 -> V_71 ) ||
( ( V_49 -> V_72 & V_76 ) && ! V_27 -> V_77 ) ||
( ! ( V_49 -> V_72 & V_78 ) && ( V_27 -> V_34 -> type == V_79 ) ) ||
( ! ( V_49 -> V_72 & V_80 ) && F_31 ( V_27 ) ) ) {
V_52 = - V_81 ;
} else {
if ( V_45 & ( V_82 | V_83 ) ) {
if ( V_57 <= sizeof( V_54 ) ) {
