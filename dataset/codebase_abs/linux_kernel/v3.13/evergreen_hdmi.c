...
V_109 = F_50 ( & V_86 , V_29 ) ;
if ( V_109 < 0 ) {
F_11 ( L_4 , V_109 ) ;
return;
}
V_109 = F_51 ( & V_86 , V_84 , sizeof( V_84 ) ) ;
if ( V_109 < 0 ) {
F_11 ( L_5 , V_109 ) ;
return;
}
...
F_52 ( V_124 + V_14 ,
V_136 ) ;
F_4 ( V_137 + V_14 , 0x00FFFFFF ) ;
F_4 ( V_138 + V_14 , 0x007FFFFF ) ;
F_4 ( V_139 + V_14 , 0x00000001 ) ;
F_4 ( V_140 + V_14 , 0x00000001 ) ;
}
void F_55 ( struct V_1 * V_2 , bool V_141 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_10 * V_10 = F_3 ( V_2 ) ;
...
if ( ! V_12 || ! V_12 -> V_15 )
return;
if ( V_141 && V_12 -> V_15 -> V_110 )
return;
if ( ! V_141 && ! V_12 -> V_15 -> V_110 )
return;
if ( V_141 ) {
if ( F_30 ( V_6 ) )
V_12 -> V_15 -> V_142 = F_56 ( V_6 ) ;
else
V_12 -> V_15 -> V_142 = F_57 ( V_6 ) ;
} else {
V_12 -> V_15 -> V_142 = NULL ;
}
V_12 -> V_15 -> V_110 = V_141 ;
F_58 ( L_6 ,
V_141 ? L_7 : L_8 , V_12 -> V_15 -> V_14 , V_10 -> V_143 ) ;
}
