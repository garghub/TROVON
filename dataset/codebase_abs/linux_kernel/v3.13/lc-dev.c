...
static
int F_46 ( struct V_21 * V_22 , void * V_53 )
{
struct V_16 * V_54 = V_53 ;
struct V_16 * V_16 = F_15 ( V_22 ) ;
if ( V_16 == V_54 ) {
F_47 ( V_16 ) ;
return 1 ;
...
char V_55 [ V_32 ] , V_56 [ V_32 ] ;
F_23 ( V_55 , sizeof( V_55 ) , & V_16 -> V_26 ) ;
F_25 ( V_56 , sizeof( V_56 ) , & V_16 -> V_25 ) ;
F_51 ( V_22 , L_4 ,
V_55 , V_56 ,
V_7 ? V_7 -> V_16 . V_22 . V_50 -> V_57 -> V_58 : L_5 ,
V_7 ? F_44 ( V_7 -> V_16 . V_22 . V_50 ) : L_6 ) ;
F_45 ( V_16 ) ;
F_10 ( & V_16 -> V_23 -> V_59 ) ;
F_16 ( V_16 -> V_23 ) ;
F_52 ( V_16 ) ;
...
struct V_16 * V_16 ;
char V_55 [ V_32 ] , V_56 [ V_32 ] ;
F_23 ( V_55 , sizeof( V_55 ) , V_23 -> V_26 ) ;
F_25 ( V_56 , sizeof( V_56 ) , & V_23 -> V_25 ) ;
V_16 = F_55 ( sizeof( struct V_16 ) , V_61 ) ;
if ( V_16 == NULL ) {
F_56 ( V_22 , L_7 ,
V_55 ) ;
return;
...
F_58 ( V_23 ) ;
F_51 ( V_22 , L_10 ,
V_55 , V_56 , V_7 -> V_16 . V_22 . V_50 -> V_57 -> V_58 ,
F_44 ( V_7 -> V_16 . V_22 . V_50 ) ) ;
F_11 ( V_7 , V_16 , V_63 ) ;
return;
V_62:
F_17 ( V_16 ) ;
...
int F_49 ( struct V_6 * V_7 , T_4 V_64 , void * V_65 )
{
return F_59 ( & V_7 -> V_16 . V_22 , V_65 , V_64 ) ;
}
