...
T_2 V_70 ;
unsigned V_71 ;
F_23 ( V_65 , V_66 , V_67 , V_68 , V_69 ) ;
if ( ( V_69 & V_72 ) || ( V_67 == 1 ) ) {
while ( V_67 ) {
V_71 = V_67 * 2 ;
if ( V_71 > 0xFFFFE )
V_71 = 0xFFFFE ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = F_3 ( V_11 , 0 , 0 , V_71 ) ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = V_65 ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = F_4 ( V_65 ) & 0xff ;
for (; V_71 > 0 ; V_71 -= 2 , -- V_67 , V_65 += 8 ) {
if ( V_69 & V_72 ) {
V_70 = F_24 ( V_2 , V_66 ) ;
V_70 &= 0xFFFFFFFFFFFFF000ULL ;
} else if ( V_69 & V_74 ) {
V_70 = V_66 ;
} else {
V_70 = 0 ;
...
V_66 += V_68 ;
V_70 |= V_69 ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = V_70 ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = F_4 ( V_70 ) ;
}
}
} else {
while ( V_67 ) {
...
V_70 = 0 ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = F_25 ( V_71 ) ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = V_65 ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = F_4 ( V_65 ) & 0xff ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = V_69 ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = 0 ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = V_70 ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = F_4 ( V_70 ) ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = V_68 ;
V_4 -> V_73 [ V_4 -> V_18 ++ ] = 0 ;
V_65 += V_71 * 4 ;
V_66 += ( V_71 / 2 ) * V_68 ;
V_67 -= V_71 / 2 ;
...
while ( V_4 -> V_18 & 0x7 )
V_4 -> V_73 [ V_4 -> V_18 ++ ] = F_3 ( V_13 , 0 , 0 , 0 ) ;
}
void F_26 ( struct V_1 * V_2 , int V_75 , struct V_76 * V_15 )
{
struct V_5 * V_6 = & V_2 -> V_6 [ V_75 ] ;
if ( V_15 == NULL )
return;
F_2 ( V_6 , F_3 ( V_77 , 0 , 0 , 0 ) ) ;
F_2 ( V_6 , ( 0xf << 16 ) | ( ( V_78 + ( V_15 -> V_16 << 2 ) ) >> 2 ) ) ;
F_2 ( V_6 , V_15 -> V_79 >> 12 ) ;
F_2 ( V_6 , F_3 ( V_77 , 0 , 0 , 0 ) ) ;
F_2 ( V_6 , ( 0xf << 16 ) | ( V_80 >> 2 ) ) ;
F_2 ( V_6 , 1 ) ;
F_2 ( V_6 , F_3 ( V_77 , 0 , 0 , 0 ) ) ;
