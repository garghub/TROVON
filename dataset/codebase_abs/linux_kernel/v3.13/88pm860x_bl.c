...
struct V_45 * V_46 = F_23 ( & V_37 -> V_29 ) ;
struct V_13 * V_14 ;
struct V_10 * V_11 ;
struct V_47 * V_48 ;
struct V_49 V_30 ;
char V_38 [ V_50 ] ;
int V_5 = 0 ;
V_14 = F_24 ( & V_37 -> V_29 , sizeof( struct V_13 ) ,
V_51 ) ;
if ( V_14 == NULL )
return - V_52 ;
V_48 = F_25 ( V_37 , V_53 , L_8 ) ;
if ( ! V_48 ) {
F_15 ( & V_37 -> V_29 , L_9 ) ;
return - V_54 ;
}
V_14 -> V_18 = V_48 -> V_55 ;
V_48 = F_25 ( V_37 , V_53 , L_10 ) ;
if ( ! V_48 ) {
F_15 ( & V_37 -> V_29 , L_11 ) ;
return - V_54 ;
}
V_14 -> V_27 = V_48 -> V_55 ;
V_48 = F_25 ( V_37 , V_53 , L_12 ) ;
if ( ! V_48 ) {
F_15 ( & V_37 -> V_29 , L_13 ) ;
return - V_54 ;
}
...
V_30 . type = V_60 ;
V_30 . V_61 = V_16 ;
V_11 = F_26 ( & V_37 -> V_29 , V_38 , & V_37 -> V_29 , V_14 ,
& V_62 , & V_30 ) ;
if ( F_27 ( V_11 ) ) {
F_15 ( & V_37 -> V_29 , L_15 ) ;
return F_28 ( V_11 ) ;
