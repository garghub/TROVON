...
static int F_59 ( struct V_1 * V_2 , const void * V_104 )
{
struct V_4 * V_105 ;
const unsigned short * V_106 = V_104 ;
V_105 = F_3 ( V_2 ) ;
return V_105 -> V_29 == * V_106 ;
}
struct V_4 * F_60 ( unsigned short V_106 )
{
struct V_1 * V_107 ;
struct V_4 * V_5 = NULL ;
V_107 = F_61 ( & V_95 , NULL , & V_106 ,
F_59 ) ;
if ( V_107 ) {
V_5 = F_62 ( F_3 ( V_107 ) ) ;
F_2 ( V_107 ) ;
...
{
return V_2 -> type == & V_93 ;
}
int F_68 ( struct V_4 * V_5 , struct V_108 * V_109 )
{
if ( F_69 ( ! V_5 -> V_46 ) ) {
F_21 ( V_18
L_11
