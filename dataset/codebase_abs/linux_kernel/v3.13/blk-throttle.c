...
F_92 ( V_90 , V_91 ) ;
V_98 = V_90 ;
if ( V_7 -> V_80 [ V_45 ] + V_35 -> V_100 <= V_98 ) {
if ( V_92 )
* V_92 = 0 ;
return 1 ;
}
V_99 = V_7 -> V_80 [ V_45 ] + V_35 -> V_100 - V_98 ;
...
{
bool V_45 = F_94 ( V_35 ) ;
unsigned long V_101 = 0 , V_102 = 0 , V_103 = 0 ;
F_91 ( V_7 -> V_15 . V_104 [ V_45 ] &&
...
if ( F_95 ( V_7 , V_35 , & V_101 ) &&
F_93 ( V_7 , V_35 , & V_102 ) ) {
if ( V_92 )
* V_92 = 0 ;
return 1 ;
}
V_103 = F_98 ( V_101 , V_102 ) ;
if ( V_92 )
* V_92 = V_103 ;
if ( F_70 ( V_7 -> V_83 [ V_45 ] , V_77 + V_103 ) )
F_87 ( V_7 , V_45 , V_77 + V_103 ) ;
return 0 ;
}
static void F_99 ( struct V_4 * V_5 , T_1 V_105 ,
int V_45 )
{
struct V_1 * V_7 = F_3 ( V_5 ) ;
struct V_16 * V_22 ;
...
F_102 ( & V_22 -> V_18 , V_45 , V_105 ) ;
F_103 ( V_44 ) ;
}
static void F_104 ( struct V_1 * V_7 , struct V_35 * V_35 )
{
bool V_45 = F_94 ( V_35 ) ;
V_7 -> V_80 [ V_45 ] += V_35 -> V_100 ;
V_7 -> V_81 [ V_45 ] ++ ;
if ( ! ( V_35 -> V_106 & V_107 ) ) {
V_35 -> V_106 |= V_107 ;
F_99 ( F_5 ( V_7 ) , V_35 -> V_100 ,
V_35 -> V_106 ) ;
}
}
...
{
struct V_12 * V_13 = & V_7 -> V_15 ;
unsigned long V_109 = - 1 , V_110 = - 1 , V_111 = - 1 , V_69 ;
struct V_35 * V_35 ;
if ( ( V_35 = F_32 ( & V_13 -> V_37 [ V_50 ] ) ) )
F_97 ( V_7 , V_35 , & V_109 ) ;
if ( ( V_35 = F_32 ( & V_13 -> V_37 [ V_51 ] ) ) )
F_97 ( V_7 , V_35 , & V_110 ) ;
V_111 = F_107 ( V_109 , V_110 ) ;
V_69 = V_77 + V_111 ;
F_76 ( V_7 ) ;
V_7 -> V_69 = V_69 ;
F_74 ( V_7 ) ;
...
static void F_108 ( struct V_1 * V_112 ,
...
unsigned int V_115 = V_116 * 3 / 4 ;
unsigned int V_117 = V_116 - V_115 ;
struct V_35 * V_35 ;
...
static void V_42 ( unsigned long V_120 )
{
struct V_12 * V_13 = ( void * ) V_120 ;
struct V_1 * V_7 = F_8 ( V_13 ) ;
...
while ( true ) {
F_79 ( V_13 , L_6 ,
V_13 -> V_104 [ V_50 ] + V_13 -> V_104 [ V_51 ] ,
V_13 -> V_104 [ V_50 ] , V_13 -> V_104 [ V_51 ] ) ;
V_122 = F_111 ( V_13 ) ;
if ( V_122 ) {
F_79 ( V_13 , L_7 , V_122 ) ;
...
F_19 ( V_43 -> V_123 ) ;
for ( V_45 = V_50 ; V_45 <= V_51 ; V_45 ++ )
while ( ( V_35 = F_35 ( & V_128 -> V_37 [ V_45 ] , NULL ) ) )
F_29 ( & V_130 , V_35 ) ;
F_24 ( V_43 -> V_123 ) ;
if ( ! F_37 ( & V_130 ) ) {
F_115 ( & V_132 ) ;
while( ( V_35 = F_36 ( & V_130 ) ) )
F_116 ( V_35 ) ;
F_117 ( & V_132 ) ;
}
}
static T_1 F_118 ( struct V_133 * V_134 ,
struct V_2 * V_3 , int V_135 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
struct V_136 V_137 = { } , V_90 ;
int V_138 , V_27 ;
F_17 (cpu) {
struct V_16 * V_60 = F_18 ( V_7 -> V_22 , V_27 ) ;
V_90 = F_119 ( ( void * ) V_60 + V_135 ) ;
for ( V_138 = 0 ; V_138 < V_139 ; V_138 ++ )
V_137 . V_140 [ V_138 ] += V_90 . V_140 [ V_138 ] ;
}
return F_120 ( V_134 , V_3 , & V_137 ) ;
}
static int F_121 ( struct V_141 * V_47 ,
struct V_142 * V_143 , struct V_133 * V_134 )
{
struct V_46 * V_46 = F_122 ( V_47 ) ;
F_123 ( V_134 , V_46 , F_118 , & V_6 ,
V_143 -> V_144 , true ) ;
return 0 ;
}
static T_1 F_124 ( struct V_133 * V_134 , struct V_2 * V_3 ,
int V_135 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
T_1 V_145 = * ( T_1 * ) ( ( void * ) V_7 + V_135 ) ;
if ( V_145 == - 1 )
return 0 ;
return F_125 ( V_134 , V_3 , V_145 ) ;
}
static T_1 F_126 ( struct V_133 * V_134 , struct V_2 * V_3 ,
int V_135 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
unsigned int V_145 = * ( unsigned int * ) ( ( void * ) V_7 + V_135 ) ;
if ( V_145 == - 1 )
return 0 ;
return F_125 ( V_134 , V_3 , V_145 ) ;
}
static int F_127 ( struct V_141 * V_47 ,
struct V_142 * V_143 , struct V_133 * V_134 )
{
F_123 ( V_134 , F_122 ( V_47 ) , F_124 ,
& V_6 , V_143 -> V_144 , false ) ;
return 0 ;
}
static int F_128 ( struct V_141 * V_47 ,
struct V_142 * V_143 , struct V_133 * V_134 )
{
F_123 ( V_134 , F_122 ( V_47 ) , F_126 ,
& V_6 , V_143 -> V_144 , false ) ;
return 0 ;
}
static int F_129 ( struct V_141 * V_47 , struct V_142 * V_143 ,
const char * V_146 , bool V_147 )
{
struct V_46 * V_46 = F_122 ( V_47 ) ;
struct V_148 V_149 ;
struct V_1 * V_7 ;
...
struct V_141 * V_150 ;
int V_122 ;
V_122 = F_130 ( V_46 , & V_6 , V_146 , & V_149 ) ;
if ( V_122 )
return V_122 ;
V_7 = F_3 ( V_149 . V_5 ) ;
V_13 = & V_7 -> V_15 ;
...
V_149 . V_145 = - 1 ;
if ( V_147 )
* ( T_1 * ) ( ( void * ) V_7 + V_143 -> V_144 ) = V_149 . V_145 ;
else
* ( unsigned int * ) ( ( void * ) V_7 + V_143 -> V_144 ) = V_149 . V_145 ;
F_79 ( & V_7 -> V_15 ,
L_8 ,
V_7 -> V_55 [ V_50 ] , V_7 -> V_55 [ V_51 ] ,
V_7 -> V_56 [ V_50 ] , V_7 -> V_56 [ V_51 ] ) ;
F_131 (blkg, pos_css, ctx.blkg)
F_50 ( F_3 ( V_5 ) ) ;
F_84 ( V_7 , 0 ) ;
F_84 ( V_7 , 1 ) ;
if ( V_7 -> V_44 & V_75 ) {
...
static int F_133 ( struct V_141 * V_47 , struct V_142 * V_143 ,
const char * V_146 )
{
return F_129 ( V_47 , V_143 , V_146 , true ) ;
}
static int F_134 ( struct V_141 * V_47 , struct V_142 * V_143 ,
const char * V_146 )
{
return F_129 ( V_47 , V_143 , V_146 , false ) ;
}
static void F_135 ( struct V_62 * V_43 )
{
struct V_8 * V_9 = V_43 -> V_9 ;
F_136 ( & V_9 -> V_127 ) ;
}
bool F_137 ( struct V_62 * V_43 , struct V_35 * V_35 )
{
struct V_8 * V_9 = V_43 -> V_9 ;
...
F_79 ( V_13 , L_9 ,
V_45 == V_50 ? 'R' : 'W' ,
V_7 -> V_80 [ V_45 ] , V_35 -> V_100 , V_7 -> V_55 [ V_45 ] ,
...
static void F_143 ( struct V_12 * V_14 )
{
struct V_1 * V_7 ;
while ( ( V_7 = F_62 ( V_14 ) ) ) {
struct V_12 * V_13 = & V_7 -> V_15 ;
...
void F_144 ( struct V_62 * V_43 )
__releases( V_43 -> V_123 ) __acquires( V_43 -> V_123 )
{
struct V_8 * V_9 = V_43 -> V_9 ;
struct V_4 * V_5 ;
struct V_141 * V_150 ;
...
F_145 ( V_43 ) ;
F_138 () ;
F_146 (blkg, pos_css, td->queue->root_blkg)
F_143 ( & F_3 ( V_5 ) -> V_15 ) ;
F_143 ( & V_9 -> V_15 ) ;
F_142 () ;
F_24 ( V_43 -> V_123 ) ;
...
int F_147 ( struct V_62 * V_43 )
{
struct V_8 * V_9 ;
int V_122 ;
V_9 = F_148 ( sizeof( * V_9 ) , V_154 , V_43 -> V_33 ) ;
if ( ! V_9 )
return - V_155 ;
F_149 ( & V_9 -> V_127 , F_114 ) ;
F_40 ( & V_9 -> V_15 , NULL ) ;
V_43 -> V_9 = V_9 ;
V_9 -> V_10 = V_43 ;
V_122 = F_150 ( V_43 , & V_6 ) ;
if ( V_122 )
F_151 ( V_9 ) ;
return V_122 ;
}
void F_152 ( struct V_62 * V_43 )
{
F_91 ( ! V_43 -> V_9 ) ;
F_135 ( V_43 ) ;
F_153 ( V_43 , & V_6 ) ;
