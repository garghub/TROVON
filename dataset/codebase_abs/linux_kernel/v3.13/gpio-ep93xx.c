...
int V_61 ;
V_61 = F_32 ( V_53 , V_55 , 1 , V_59 , NULL , NULL , V_60 , NULL , 0 ) ;
if ( V_61 )
return V_61 ;
...
int V_17 ;
int V_73 ;
V_69 = F_35 ( sizeof( * V_69 ) , V_74 ) ;
if ( ! V_69 )
return - V_75 ;
V_71 = F_36 ( V_68 , V_76 , 0 ) ;
if ( ! V_71 ) {
V_73 = - V_77 ;
goto V_78;
}
if ( ! F_37 ( V_71 -> V_79 , F_38 ( V_71 ) , V_68 -> V_80 ) ) {
V_73 = - V_81 ;
goto V_78;
}
V_72 = F_39 ( V_71 -> V_79 , F_38 ( V_71 ) ) ;
if ( ! V_72 ) {
V_73 = - V_77 ;
goto V_82;
}
V_69 -> V_56 = V_72 ;
for ( V_17 = 0 ; V_17 < F_40 ( V_83 ) ; V_17 ++ ) {
struct V_52 * V_53 = & V_69 -> V_53 [ V_17 ] ;
struct V_57 * V_58 = & V_83 [ V_17 ] ;
if ( F_31 ( V_53 , & V_68 -> V_55 , V_72 , V_58 ) )
F_41 ( & V_68 -> V_55 , L_1 ,
V_58 -> V_63 ) ;
}
F_25 () ;
return 0 ;
V_82:
F_42 ( V_71 -> V_79 , F_38 ( V_71 ) ) ;
V_78:
F_43 ( V_69 ) ;
F_44 ( & V_68 -> V_55 , L_2 , V_84 , V_73 ) ;
return V_73 ;
}
