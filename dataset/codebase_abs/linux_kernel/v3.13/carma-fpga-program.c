...
{
struct V_1 * V_2 = V_96 -> V_97 ;
V_20 = F_33 ( T_4 , V_2 -> V_5 - * V_104 , V_20 ) ;
if ( F_64 ( V_43 , V_2 -> V_3 . V_50 + * V_104 , V_20 ) )
return - V_106 ;
* V_104 += V_20 ;
return V_20 ;
}
static T_10 F_65 ( struct V_95 * V_96 , T_10 V_107 , int V_108 )
{
struct V_1 * V_2 = V_96 -> V_97 ;
T_10 V_109 ;
if ( ( V_96 -> V_100 & V_110 ) != V_111 )
return - V_93 ;
switch ( V_108 ) {
case V_112 :
V_109 = V_107 ;
break;
case V_113 :
V_109 = V_96 -> V_104 + V_107 ;
break;
case V_114 :
V_109 = V_2 -> V_92 - V_107 ;
break;
default:
return - V_93 ;
}
...
static T_8 F_66 ( struct V_78 * V_33 , struct V_115 * V_116 ,
char * V_43 )
{
struct V_1 * V_2 = F_67 ( V_33 ) ;
T_3 V_18 ;
V_18 = F_21 ( V_2 -> V_13 + V_117 ) ;
return snprintf ( V_43 , V_102 , L_33 , V_18 ) ;
}
static T_8 F_68 ( struct V_78 * V_33 , struct V_115 * V_116 ,
char * V_43 )
{
struct V_1 * V_2 = F_67 ( V_33 ) ;
return snprintf ( V_43 , V_102 , L_34 , F_20 ( V_2 ) ) ;
}
static T_8 F_69 ( struct V_78 * V_33 , struct V_115 * V_116 ,
char * V_43 )
{
struct V_1 * V_2 = F_67 ( V_33 ) ;
return snprintf ( V_43 , V_102 , L_34 , F_29 ( V_2 ) ) ;
}
static T_8 F_70 ( struct V_78 * V_33 , struct V_115 * V_116 ,
const char * V_43 , T_4 V_20 )
{
struct V_1 * V_2 = F_67 ( V_33 ) ;
unsigned long V_18 ;
int V_49 ;
V_49 = F_71 ( V_43 , 0 , & V_18 ) ;
if ( V_49 )
return V_49 ;
if ( V_18 ) {
V_49 = F_27 ( V_2 ) ;
...
static T_8 F_72 ( struct V_78 * V_33 , struct V_115 * V_116 ,
char * V_43 )
{
struct V_1 * V_2 = F_67 ( V_33 ) ;
return snprintf ( V_43 , V_102 , L_34 , F_30 ( V_2 ) ) ;
}
static T_8 F_73 ( struct V_78 * V_33 , struct V_115 * V_116 ,
const char * V_43 , T_4 V_20 )
{
struct V_1 * V_2 = F_67 ( V_33 ) ;
unsigned long V_18 ;
...
{
return V_55 -> V_120 == 0 && V_55 -> V_78 -> V_89 == 0 ;
}
static int F_75 ( struct V_121 * V_122 )
{
struct V_1 * V_2 = F_76 ( V_122 ) ;
struct V_78 * V_123 = V_2 -> V_98 . V_123 ;
F_77 ( & V_123 -> V_124 , & V_125 ) ;
F_78 ( & V_2 -> V_98 ) ;
F_79 ( V_2 -> V_88 , V_2 ) ;
F_80 ( V_2 -> V_88 ) ;
F_22 ( V_2 ) ;
...
static int F_83 ( struct V_121 * V_122 )
{
struct V_127 * V_128 = V_122 -> V_33 . V_128 ;
struct V_78 * V_123 ;
struct V_1 * V_2 ;
T_11 V_129 ;
T_2 V_130 ;
int V_49 ;
V_2 = F_84 ( sizeof( * V_2 ) , V_68 ) ;
if ( ! V_2 ) {
F_19 ( & V_122 -> V_33 , L_35 ) ;
V_49 = - V_69 ;
goto V_70;
}
V_2 -> V_98 . V_131 = V_132 ;
V_2 -> V_98 . V_133 = V_134 ;
V_2 -> V_98 . V_135 = & V_136 ;
F_85 ( & V_2 -> V_7 ) ;
F_86 ( V_122 , V_2 ) ;
V_2 -> V_33 = & V_122 -> V_33 ;
F_87 ( & V_2 -> V_8 ) ;
...
F_92 ( V_138 , V_129 ) ;
F_92 ( V_139 , V_129 ) ;
V_2 -> V_55 = F_93 ( V_129 , F_74 , NULL ) ;
if ( ! V_2 -> V_55 ) {
F_19 ( & V_122 -> V_33 , L_36 ) ;
V_49 = - V_140 ;
goto V_141;
}
V_2 -> V_13 = F_94 ( V_128 , 0 ) ;
if ( ! V_2 -> V_13 ) {
F_19 ( & V_122 -> V_33 , L_37 ) ;
V_49 = - V_69 ;
goto V_142;
}
V_2 -> V_126 = F_95 ( F_96 () , 0x100000 ) ;
if ( ! V_2 -> V_126 ) {
F_19 ( & V_122 -> V_33 , L_38 ) ;
V_49 = - V_69 ;
goto V_143;
}
if ( ( F_10 ( V_2 -> V_126 + 0x114 ) & 0xE00 ) != 0xE00 ) {
F_19 ( & V_122 -> V_33 , L_39 ) ;
V_49 = - V_140 ;
goto V_144;
}
V_130 = F_21 ( V_2 -> V_13 + V_145 ) ;
if ( V_130 != 0x02 && V_130 != 0x03 ) {
F_19 ( & V_122 -> V_33 , L_40 ) ;
V_49 = - V_140 ;
goto V_144;
}
V_130 = F_10 ( V_2 -> V_13 + V_146 ) ;
V_2 -> V_92 = ( V_130 & ( 1 << 18 ) ) ? V_147 : V_148 ;
V_2 -> V_88 = F_97 ( V_128 , 0 ) ;
if ( V_2 -> V_88 == V_149 ) {
F_19 ( & V_122 -> V_33 , L_41 ) ;
V_49 = - V_140 ;
goto V_144;
}
V_49 = F_98 ( V_2 -> V_88 , F_49 , V_150 , V_134 , V_2 ) ;
if ( V_49 ) {
F_19 ( & V_122 -> V_33 , L_42 , V_2 -> V_88 ) ;
V_49 = - V_140 ;
goto V_151;
}
F_51 ( V_2 ) ;
V_49 = F_99 ( & V_2 -> V_98 ) ;
if ( V_49 ) {
F_19 ( & V_122 -> V_33 , L_43 ) ;
goto V_152;
}
V_123 = V_2 -> V_98 . V_123 ;
F_90 ( V_123 , V_2 ) ;
V_49 = F_100 ( & V_123 -> V_124 , & V_125 ) ;
if ( V_49 ) {
F_19 ( & V_122 -> V_33 , L_44 ) ;
goto V_153;
}
F_101 ( V_2 -> V_33 , L_45 ,
( V_130 & ( 1 << 17 ) ) ? L_46 : L_47 ,
( V_130 & ( 1 << 16 ) ) ? L_48 : L_49 ,
( V_130 & ( 1 << 18 ) ) ? L_50 : L_51 ) ;
return 0 ;
V_153:
F_78 ( & V_2 -> V_98 ) ;
V_152:
