...
V_125 [ V_126 ] = {} ;
int V_127 , V_128 [ V_126 ] ;
int V_112 , V_30 , V_129 = 0 , V_130 = 0 , V_131 = 0 ;
struct V_3 * V_4 ;
struct V_119 * V_36 ;
struct V_132 * V_33 , * V_67 , * V_133 , * V_134 ;
if ( V_111 -> V_37 . V_84 )
V_7 = F_68 ( V_135 , & V_111 -> V_37 ) -> V_16 ;
else
V_7 = F_69 ( & V_111 -> V_37 ) ;
if ( ! V_7 || ! V_7 -> V_31 )
return - V_136 ;
V_33 = F_70 ( V_111 , V_137 , 0 ) ;
V_67 = F_70 ( V_111 , V_137 , 1 ) ;
V_133 = F_70 ( V_111 , V_138 , 0 ) ;
if ( ! V_33 || ! V_133 )
return - V_136 ;
...
V_36 = & V_4 -> V_35 . V_36 ;
V_4 -> V_14 = F_71 ( & V_111 -> V_37 , V_33 ) ;
if ( F_72 ( V_4 -> V_14 ) )
return F_73 ( V_4 -> V_14 ) ;
if ( V_67 ) {
V_4 -> V_67 = F_71 ( & V_111 -> V_37 , V_67 ) ;
if ( F_72 ( V_4 -> V_67 ) )
return F_73 ( V_4 -> V_67 ) ;
}
if ( ! V_7 -> V_139 )
F_74 ( V_140 , V_36 -> V_141 ) ;
if ( V_7 -> V_86 && V_7 -> V_87 )
F_74 ( V_142 , V_36 -> V_141 ) ;
V_36 -> V_143 = V_65 ;
V_4 -> V_35 . V_144 = & V_145 ;
V_4 -> V_35 . V_146 = sizeof( struct V_74 ) ;
V_112 = F_75 ( & V_111 -> V_37 , & V_4 -> V_35 ,
V_7 -> V_31 ) ;
if ( V_112 < 0 )
goto V_147;
V_4 -> V_7 = V_7 ;
...
F_76 ( V_111 , V_4 ) ;
F_77 ( & V_111 -> V_37 ) ;
V_112 = F_78 ( & V_111 -> V_37 ) ;
if ( V_112 < 0 )
F_51 ( & V_111 -> V_37 , L_10 , V_150 , V_112 ) ;
F_79 ( & V_25 ) ;
F_80 ( & V_4 -> V_151 , & V_152 ) ;
F_81 ( & V_25 ) ;
V_112 = F_16 ( V_4 ) ;
if ( V_112 )
goto V_153;
#if F_82 ( V_154 ) || F_82 ( V_155 )
V_134 = F_70 ( V_111 , V_138 , 1 ) ;
if ( ! V_134 )
V_134 = V_133 ;
else
V_130 ++ ;
if ( V_134 == V_133 ||
( V_133 -> V_24 & V_156 ) == V_157 )
V_124 = V_158 ;
V_127 = V_133 -> V_159 ;
V_112 = F_83 ( & V_111 -> V_37 , V_127 , F_40 , V_124 ,
L_11 , V_4 ) ;
if ( V_112 ) {
F_51 ( & V_111 -> V_37 ,
L_12 ,
...
V_134 = V_133 ;
#endif
if ( V_134 -> V_159 == V_134 -> V_161 &&
! F_70 ( V_111 , V_138 , 1 ) ) {
for (; V_129 < V_7 -> V_31 ; V_129 ++ ) {
if ( V_129 < V_126 ) {
V_128 [ V_129 ] = V_134 -> V_159 ;
V_125 [ V_129 ] = V_158 ;
} else {
V_131 = 1 ;
break;
...
do {
for ( V_30 = V_134 -> V_159 ; V_30 <= V_134 -> V_161 ; V_30 ++ ) {
if ( V_129 >= V_126 ) {
V_131 = 1 ;
break;
}
...
V_134 = F_70 ( V_111 ,
V_138 , ++ V_130 ) ;
} while ( V_129 < V_7 -> V_31 && V_134 );
}
for ( V_30 = 0 ; V_30 < V_129 ; V_30 ++ ) {
V_112 = F_48 ( V_4 , V_30 , V_128 [ V_30 ] , V_125 [ V_30 ] ) ;
if ( V_112 )
goto V_162;
}
if ( V_131 )
...
{
int V_112 = F_95 ( & V_164 ) ;
if ( V_112 )
return V_112 ;
return F_96 ( & V_165 , F_67 ) ;
}
