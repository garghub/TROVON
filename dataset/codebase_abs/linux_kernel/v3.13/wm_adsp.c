...
{
struct V_109 * V_110 = F_47 ( V_108 ,
struct V_109 ,
V_108 ) ;
F_28 ( V_110 -> V_19 , V_110 -> V_43 ) ;
F_4 ( V_110 ) ;
}
...
V_43 -> V_56 = 1 ;
V_43 -> V_57 = 0 ;
V_43 -> V_115 . V_116 = F_27 ;
V_43 -> V_115 . V_117 = F_23 ;
V_43 -> V_19 = V_28 ;
V_43 -> V_3 = V_32 -> V_3 ;
...
switch ( V_28 -> type ) {
case V_96 :
V_48 = F_26 ( V_51 , V_31 -> V_35 , & V_121 ,
sizeof( V_121 ) ) ;
if ( V_48 != 0 ) {
F_20 ( V_28 , L_37 ,
V_48 ) ;
...
V_6 = & V_121 ;
V_130 = sizeof( V_121 ) ;
V_129 = F_38 ( V_121 . V_129 ) ;
V_28 -> V_132 = F_38 ( V_121 . V_22 . V_133 ) ;
F_35 ( V_28 , L_38 ,
V_28 -> V_132 ,
( F_38 ( V_121 . V_22 . V_94 ) & 0xff0000 ) >> 16 ,
( F_38 ( V_121 . V_22 . V_94 ) & 0xff00 ) >> 8 ,
F_38 ( V_121 . V_22 . V_94 ) & 0xff ,
V_129 ) ;
V_32 = F_2 ( sizeof( * V_32 ) , V_7 ) ;
if ( ! V_32 )
return - V_50 ;
V_32 -> type = V_39 ;
V_32 -> V_112 = F_38 ( V_121 . V_22 . V_133 ) ;
V_32 -> V_35 = F_38 ( V_121 . V_99 ) ;
F_5 ( & V_32 -> V_5 , & V_28 -> V_134 ) ;
V_32 = F_2 ( sizeof( * V_32 ) , V_7 ) ;
if ( ! V_32 )
return - V_50 ;
V_32 -> type = V_36 ;
V_32 -> V_112 = F_38 ( V_121 . V_22 . V_133 ) ;
V_32 -> V_35 = F_38 ( V_121 . V_97 ) ;
F_5 ( & V_32 -> V_5 , & V_28 -> V_134 ) ;
V_70 = sizeof( V_121 ) / 2 ;
...
V_6 = & V_123 ;
V_130 = sizeof( V_123 ) ;
V_129 = F_38 ( V_123 . V_129 ) ;
V_28 -> V_132 = F_38 ( V_123 . V_22 . V_133 ) ;
F_35 ( V_28 , L_38 ,
V_28 -> V_132 ,
...
return - V_50 ;
V_32 -> type = V_37 ;
V_32 -> V_112 = F_38 ( V_123 . V_22 . V_133 ) ;
V_32 -> V_35 = F_38 ( V_123 . V_101 ) ;
F_5 ( & V_32 -> V_5 , & V_28 -> V_134 ) ;
V_32 = F_2 ( sizeof( * V_32 ) , V_7 ) ;
if ( ! V_32 )
return - V_50 ;
...
if ( V_129 > 1024 ) {
F_20 ( V_28 , L_40 , V_129 ) ;
F_52 ( F_53 ( V_28 -> V_89 ) , V_136 ,
V_6 , V_130 ) ;
return - V_24 ;
}
V_48 = F_26 ( V_51 , V_31 -> V_35 + V_128 , & V_131 , sizeof( V_131 ) ) ;
if ( V_48 != 0 ) {
F_20 ( V_28 , L_41 ,
V_48 ) ;
return V_48 ;
}
if ( F_38 ( V_131 ) != 0xbedead )
F_39 ( V_28 , L_42 ,
V_128 , F_38 ( V_131 ) ) ;
V_112 = F_2 ( ( V_128 - V_70 ) * 2 , V_7 | V_8 ) ;
if ( ! V_112 )
return - V_50 ;
V_48 = F_26 ( V_51 , V_31 -> V_35 + V_70 , V_112 , ( V_128 - V_70 ) * 2 ) ;
if ( V_48 != 0 ) {
F_20 ( V_28 , L_43 ,
V_48 ) ;
goto V_90;
...
V_125 = V_112 ;
V_127 = V_112 ;
for ( V_29 = 0 ; V_29 < V_129 ; V_29 ++ ) {
switch ( V_28 -> type ) {
case V_96 :
F_35 ( V_28 , L_44 ,
V_29 , F_38 ( V_125 [ V_29 ] . V_112 . V_133 ) ,
( F_38 ( V_125 [ V_29 ] . V_112 . V_94 ) & 0xff0000 ) >> 16 ,
( F_38 ( V_125 [ V_29 ] . V_112 . V_94 ) & 0xff00 ) >> 8 ,
F_38 ( V_125 [ V_29 ] . V_112 . V_94 ) & 0xff ,
F_38 ( V_125 [ V_29 ] . V_97 ) ,
F_38 ( V_125 [ V_29 ] . V_99 ) ) ;
V_32 = F_2 ( sizeof( * V_32 ) , V_7 ) ;
if ( ! V_32 )
return - V_50 ;
V_32 -> type = V_36 ;
V_32 -> V_112 = F_38 ( V_125 [ V_29 ] . V_112 . V_133 ) ;
V_32 -> V_35 = F_38 ( V_125 [ V_29 ] . V_97 ) ;
V_32 -> V_3 = 0 ;
F_5 ( & V_32 -> V_5 , & V_28 -> V_134 ) ;
if ( V_29 + 1 < V_129 ) {
V_32 -> V_3 = F_38 ( V_125 [ V_29 + 1 ] . V_97 ) ;
V_32 -> V_3 -= F_38 ( V_125 [ V_29 ] . V_97 ) ;
V_32 -> V_3 *= 4 ;
F_48 ( V_28 , V_32 ) ;
} else {
F_39 ( V_28 , L_45 ,
F_38 ( V_125 [ V_29 ] . V_112 . V_133 ) ) ;
}
V_32 = F_2 ( sizeof( * V_32 ) , V_7 ) ;
if ( ! V_32 )
return - V_50 ;
V_32 -> type = V_39 ;
V_32 -> V_112 = F_38 ( V_125 [ V_29 ] . V_112 . V_133 ) ;
V_32 -> V_35 = F_38 ( V_125 [ V_29 ] . V_99 ) ;
V_32 -> V_3 = 0 ;
F_5 ( & V_32 -> V_5 , & V_28 -> V_134 ) ;
if ( V_29 + 1 < V_129 ) {
V_32 -> V_3 = F_38 ( V_125 [ V_29 + 1 ] . V_99 ) ;
V_32 -> V_3 -= F_38 ( V_125 [ V_29 ] . V_99 ) ;
V_32 -> V_3 *= 4 ;
F_48 ( V_28 , V_32 ) ;
} else {
F_39 ( V_28 , L_46 ,
...
F_35 ( V_28 ,
L_47 ,
V_29 , F_38 ( V_127 [ V_29 ] . V_112 . V_133 ) ,
( F_38 ( V_127 [ V_29 ] . V_112 . V_94 ) & 0xff0000 ) >> 16 ,
( F_38 ( V_127 [ V_29 ] . V_112 . V_94 ) & 0xff00 ) >> 8 ,
F_38 ( V_127 [ V_29 ] . V_112 . V_94 ) & 0xff ,
F_38 ( V_127 [ V_29 ] . V_101 ) ,
F_38 ( V_127 [ V_29 ] . V_102 ) ,
F_38 ( V_127 [ V_29 ] . V_99 ) ) ;
V_32 = F_2 ( sizeof( * V_32 ) , V_7 ) ;
if ( ! V_32 )
return - V_50 ;
V_32 -> type = V_37 ;
V_32 -> V_112 = F_38 ( V_127 [ V_29 ] . V_112 . V_133 ) ;
V_32 -> V_35 = F_38 ( V_127 [ V_29 ] . V_101 ) ;
V_32 -> V_3 = 0 ;
F_5 ( & V_32 -> V_5 , & V_28 -> V_134 ) ;
if ( V_29 + 1 < V_129 ) {
V_32 -> V_3 = F_38 ( V_127 [ V_29 + 1 ] . V_101 ) ;
V_32 -> V_3 -= F_38 ( V_127 [ V_29 ] . V_101 ) ;
V_32 -> V_3 *= 4 ;
F_48 ( V_28 , V_32 ) ;
} else {
F_39 ( V_28 , L_48 ,
F_38 ( V_127 [ V_29 ] . V_112 . V_133 ) ) ;
}
V_32 = F_2 ( sizeof( * V_32 ) , V_7 ) ;
if ( ! V_32 )
return - V_50 ;
V_32 -> type = V_38 ;
V_32 -> V_112 = F_38 ( V_127 [ V_29 ] . V_112 . V_133 ) ;
V_32 -> V_35 = F_38 ( V_127 [ V_29 ] . V_102 ) ;
V_32 -> V_3 = 0 ;
F_5 ( & V_32 -> V_5 , & V_28 -> V_134 ) ;
if ( V_29 + 1 < V_129 ) {
V_32 -> V_3 = F_38 ( V_127 [ V_29 + 1 ] . V_102 ) ;
V_32 -> V_3 -= F_38 ( V_127 [ V_29 ] . V_102 ) ;
V_32 -> V_3 *= 4 ;
F_48 ( V_28 , V_32 ) ;
} else {
F_39 ( V_28 , L_49 ,
...
struct V_46 * V_141 ;
const char * V_80 ;
int V_48 , V_70 , V_142 , type , V_33 , V_49 ;
char * V_81 ;
struct V_1 * V_6 ;
int V_143 ;
V_81 = F_2 ( V_85 , V_7 ) ;
...
switch ( F_38 ( V_138 -> V_144 ) & 0xff ) {
case 1 :
break;
default:
F_20 ( V_28 , L_52 ,
V_81 , F_38 ( V_138 -> V_144 ) & 0xff ) ;
V_48 = - V_24 ;
goto V_92;
}
F_22 ( V_28 , L_53 , V_81 ,
( F_36 ( V_138 -> V_94 ) >> 16 ) & 0xff ,
( F_36 ( V_138 -> V_94 ) >> 8 ) & 0xff ,
F_36 ( V_138 -> V_94 ) & 0xff ) ;
V_70 = F_36 ( V_138 -> V_3 ) ;
V_142 = 0 ;
while ( V_70 < V_69 -> V_91 &&
V_70 - V_69 -> V_91 > sizeof( * V_140 ) ) {
V_140 = ( void * ) ( & V_69 -> V_54 [ V_70 ] ) ;
type = F_55 ( V_140 -> type ) ;
V_33 = F_55 ( V_140 -> V_33 ) ;
F_22 ( V_28 , L_54 ,
V_81 , V_142 , F_36 ( V_140 -> V_133 ) ,
( F_36 ( V_140 -> V_94 ) >> 16 ) & 0xff ,
( F_36 ( V_140 -> V_94 ) >> 8 ) & 0xff ,
F_36 ( V_140 -> V_94 ) & 0xff ) ;
F_22 ( V_28 , L_55 ,
V_81 , V_142 , F_36 ( V_140 -> V_3 ) , V_33 , type ) ;
V_49 = 0 ;
V_80 = L_20 ;
switch ( type ) {
case ( V_104 << 8 ) :
...
break;
case ( V_106 << 8 ) :
if ( F_36 ( V_140 -> V_133 ) == V_28 -> V_132 &&
V_33 == 0 ) {
V_80 = L_56 ;
V_31 = F_14 ( V_28 , type ) ;
if ( ! V_31 ) {
...
case V_38 :
F_22 ( V_28 , L_59 ,
V_81 , V_142 , F_36 ( V_140 -> V_3 ) ,
type , F_36 ( V_140 -> V_133 ) ) ;
V_31 = F_14 ( V_28 , type ) ;
if ( ! V_31 ) {
F_20 ( V_28 , L_2 , type ) ;
break;
...
if ( F_36 ( V_140 -> V_133 ) == V_141 -> V_112 &&
type == V_141 -> type ) {
V_49 = V_141 -> V_35 ;
V_49 = F_15 ( V_31 ,
V_49 ) ;
...
F_20 ( V_28 ,
L_63 ,
V_81 , V_142 , V_49 , V_80 , V_48 ) ;
}
}
V_143 = F_36 ( V_140 -> V_3 ) % 4 ;
if ( V_143 )
V_70 += F_36 ( V_140 -> V_3 ) + ( 4 - V_143 ) + sizeof( * V_140 ) ;
else
V_70 += F_36 ( V_140 -> V_3 ) + sizeof( * V_140 ) ;
V_142 ++ ;
}
V_48 = F_41 ( V_51 ) ;
if ( V_48 != 0 )
...
int F_58 ( struct V_145 * V_146 ,
struct V_9 * V_10 ,
int V_147 )
{
struct V_13 * V_14 = V_146 -> V_14 ;
struct V_18 * V_148 = F_12 ( V_14 ) ;
struct V_18 * V_28 = & V_148 [ V_146 -> V_149 ] ;
struct V_46 * V_141 ;
struct V_42 * V_43 ;
int V_48 ;
int V_131 ;
...
switch ( V_147 ) {
case V_150 :
F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_151 ,
V_152 , V_152 ) ;
if( V_28 -> V_153 ) {
V_48 = F_60 ( V_28 -> V_51 , V_28 -> V_153 , & V_131 ) ;
if ( V_48 != 0 ) {
F_20 ( V_28 , L_64 ,
V_48 ) ;
return V_48 ;
}
V_131 = ( V_131 & V_28 -> V_154 )
>> V_28 -> V_155 ;
V_48 = F_59 ( V_28 -> V_51 ,
V_28 -> V_35 + V_156 ,
V_157 , V_131 ) ;
...
F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_151 ,
V_159 | V_160 , 0 ) ;
F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_162 ,
V_163 , 0 ) ;
F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_151 ,
V_152 , 0 ) ;
F_44 (ctl, &dsp->ctl_list, list)
V_43 -> V_56 = 0 ;
while ( ! F_7 ( & V_28 -> V_134 ) ) {
V_141 = F_8 ( & V_28 -> V_134 ,
struct V_46 ,
V_5 ) ;
F_9 ( & V_141 -> V_5 ) ;
F_4 ( V_141 ) ;
...
unsigned int V_131 ;
int V_48 , V_45 ;
V_48 = F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_164 ,
V_165 , V_165 ) ;
if ( V_48 != 0 )
return V_48 ;
for ( V_45 = 0 ; V_45 < 10 ; ++ V_45 ) {
V_48 = F_60 ( V_28 -> V_51 , V_28 -> V_35 + V_166 ,
& V_131 ) ;
if ( V_48 != 0 )
return V_48 ;
if ( V_131 & V_167 )
...
int F_63 ( struct V_145 * V_146 ,
struct V_9 * V_10 , int V_147 )
{
struct V_13 * V_14 = V_146 -> V_14 ;
struct V_18 * V_148 = F_12 ( V_14 ) ;
struct V_18 * V_28 = & V_148 [ V_146 -> V_149 ] ;
...
switch ( V_147 ) {
case V_150 :
V_48 = F_60 ( V_28 -> V_51 , V_168 , & V_131 ) ;
if ( V_48 != 0 ) {
F_20 ( V_28 , L_64 ,
V_48 ) ;
return V_48 ;
...
V_165 | V_174 |
V_175 , 0 ) ;
F_67 ( V_28 -> V_51 , V_28 -> V_35 + V_176 , 0 ) ;
F_67 ( V_28 -> V_51 , V_28 -> V_35 + V_177 , 0 ) ;
F_67 ( V_28 -> V_51 , V_28 -> V_35 + V_178 , 0 ) ;
if ( V_28 -> V_173 ) {
V_48 = F_66 ( V_28 -> V_173 , 1200000 ,
1800000 ) ;
if ( V_48 != 0 )
F_68 ( V_28 -> V_89 ,
L_71 ,
V_48 ) ;
V_48 = F_69 ( V_28 -> V_173 ) ;
if ( V_48 != 0 )
F_64 ( V_28 -> V_89 ,
L_69 ,
V_48 ) ;
...
int F_70 ( struct V_18 * V_19 , bool V_173 )
{
int V_48 ;
V_48 = F_59 ( V_19 -> V_51 , V_19 -> V_35 + V_164 ,
V_179 , 0 ) ;
if ( V_48 != 0 ) {
F_20 ( V_19 , L_72 , V_48 ) ;
return V_48 ;
...
F_57 ( & V_19 -> V_67 ) ;
if ( V_173 ) {
V_19 -> V_173 = F_71 ( V_19 -> V_89 , L_73 ) ;
if ( F_72 ( V_19 -> V_173 ) ) {
V_48 = F_73 ( V_19 -> V_173 ) ;
F_64 ( V_19 -> V_89 , L_74 , V_48 ) ;
return V_48 ;
}
V_48 = F_65 ( V_19 -> V_173 ) ;
if ( V_48 != 0 ) {
F_64 ( V_19 -> V_89 , L_75 ,
V_48 ) ;
return V_48 ;
}
V_48 = F_66 ( V_19 -> V_173 , 1200000 , 1800000 ) ;
if ( V_48 != 0 ) {
F_64 ( V_19 -> V_89 , L_76 ,
V_48 ) ;
return V_48 ;
}
V_48 = F_69 ( V_19 -> V_173 ) ;
if ( V_48 != 0 ) {
F_64 ( V_19 -> V_89 , L_77 ,
V_48 ) ;
return V_48 ;
