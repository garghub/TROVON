...
int F_117 ( unsigned V_162 , T_6 V_163 )
{
T_6 V_164 = V_163 - 1 ;
T_6 V_165 =
V_164 >> ( V_11 - V_162 ) ;
...
int F_118 ( struct V_28 * V_28 , T_1 V_154 , T_1 V_155 , int V_156 )
{
return 0 ;
}
void F_119 ( struct V_1 * V_1 , struct V_167 * V_168 ,
void * V_169 )
{
char * V_68 = F_120 ( V_168 ) ;
if ( ! F_33 ( V_68 ) )
F_106 ( V_68 ) ;
}
static int F_121 ( struct V_106 * V_106 )
{
return 0 ;
}
struct V_7 * F_122 ( struct V_67 * V_68 )
{
static const struct V_170 V_171 = {
. F_69 = F_121 ,
} ;
struct V_7 * V_7 = F_123 ( V_68 ) ;
if ( ! V_7 )
return F_8 ( - V_33 ) ;
V_7 -> V_55 = F_124 () ;
V_7 -> V_9 -> V_172 = & V_171 ;
