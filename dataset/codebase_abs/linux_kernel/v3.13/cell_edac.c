...
static int F_16 ( struct V_58 * V_15 )
{
struct V_59 T_3 * V_26 ;
struct V_1 * V_2 ;
struct V_60 V_61 [ 2 ] ;
struct V_5 * V_6 ;
T_1 V_62 ;
int V_63 , V_17 , V_64 ;
V_26 = F_17 ( F_18 ( V_15 -> V_65 ) ) ;
if ( V_26 == NULL )
return - V_66 ;
V_67 = V_68 ;
V_62 = F_6 ( & V_26 -> V_69 ) ;
F_2 ( & V_15 -> V_70 , L_9 , V_62 ) ;
V_17 = 0 ;
if ( V_62 & V_71 )
V_17 |= 0x1 ;
if ( V_62 & V_72 )
...
V_61 [ 1 ] . V_74 = V_64 ;
V_61 [ 1 ] . V_75 = false ;
V_2 = F_20 ( V_15 -> V_65 , F_21 ( V_61 ) , V_61 ,
sizeof( struct V_5 ) ) ;
if ( V_2 == NULL )
return - V_77 ;
V_6 = V_2 -> V_7 ;
...
static int F_25 ( struct V_58 * V_15 )
{
struct V_1 * V_2 = F_26 ( & V_15 -> V_70 ) ;
if ( V_2 )
F_24 ( V_2 ) ;
return 0 ;
}
