...
static T_1 F_19 ( struct V_34 * V_34 , const char T_2 * V_35 ,
T_3 V_36 , T_4 * V_37 )
{
if ( V_36 ) {
T_3 V_38 ;
...
static long F_21 ( struct V_34 * V_34 , unsigned int V_42 ,
unsigned long V_43 )
{
...
static int F_24 ( struct V_63 * V_63 , struct V_34 * V_34 )
{
int V_24 ;
if ( F_25 ( 0 , & V_64 ) )
return - V_8 ;
...
if ( V_24 )
return V_24 ;
return F_26 ( V_63 , V_34 ) ;
}
static int F_27 ( struct V_63 * V_63 , struct V_34 * V_34 )
{
if ( V_39 != 42 ) {
F_28 ( L_6 ) ;
} else if ( ! V_32 ) {
...
static int T_5 F_30 ( unsigned short * V_11 )
{
int V_65 = - V_66 ;
int V_67 ;
int V_24 = F_7 () ;
