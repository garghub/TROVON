...
if ( F_27 ( V_45 ) ) {
if ( V_45 -> V_71 == NULL ) {
V_45 -> V_71 = F_28 ( F_29 ( V_45 -> V_46 . V_36 >> V_72 ) ,
sizeof( long ) , V_73 ) ;
}
} else {
F_30 ( V_45 -> V_71 ) ;
...
struct V_75 * V_75 = F_39 ( & V_81 ) ;
char V_82 = F_40 ( V_75 ) >> 17 ;
if ( ( V_82 & 0x1 ) !=
( F_41 ( V_78 , V_45 -> V_71 ) != 0 ) ) {
F_34 ( V_75 ) ;
F_42 ( V_75 ) ;
}
V_78 ++ ;
...
{
struct V_80 V_81 ;
int V_83 = V_45 -> V_46 . V_36 >> V_72 ;
int V_78 ;
if ( V_45 -> V_71 == NULL ) {
V_45 -> V_71 = F_28 ( F_29 ( V_83 ) ,
sizeof( long ) , V_73 ) ;
if ( V_45 -> V_71 == NULL ) {
F_10 ( L_4
L_5 ) ;
