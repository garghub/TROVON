...
T_4 F_13 ( struct V_44 * V_45 , struct V_46 * V_47 , T_6 * V_37 )
{
...
V_15 -> V_20 = V_57 . V_20 ;
V_15 -> V_93 = V_57 . V_60 ;
V_13 -> V_94 = V_57 . V_60 ? V_57 . V_95 : 0 ;
V_70 -> V_96 = V_57 . V_60 ? V_57 . V_59 : 0 ;
V_70 -> V_97 = NULL ;
if ( V_68 && V_68 -> V_98 ) {
int V_99 = sizeof( struct V_100 ) + V_68 -> V_98 ;
V_15 -> V_68 = F_33 ( V_99 , V_101 ) ;
if ( V_15 -> V_68 != NULL && F_34 ( & V_15 -> V_68 -> V_68 , V_47 ) ) {
F_35 ( V_15 -> V_68 ) ;
V_15 -> V_68 = NULL ;
}
}
...
V_13 -> V_102 = 0UL ;
V_13 -> V_103 = 0 ;
F_37 ( & V_79 , V_45 -> V_104 , V_45 -> V_105 ,
F_38 ( V_45 ) , V_106 , V_107 ,
F_39 ( V_45 ) ,
( V_68 && V_68 -> V_108 ) ? V_68 -> V_109 : V_15 -> V_92 ,
V_15 -> V_91 , V_36 -> V_41 , V_36 -> V_42 ) ;
F_40 ( V_13 , F_41 ( & V_79 ) ) ;
V_76 = F_42 ( F_18 ( V_45 ) , & V_79 ) ;
if ( F_43 ( V_76 ) ) {
F_23 ( V_13 ) ;
goto V_83;
}
V_13 -> V_110 = V_72 -> V_110 ? : F_44 ( & V_76 -> V_50 , V_111 ) ;
F_45 ( F_46 ( V_45 ) , V_13 -> V_39 ,
& V_13 -> V_112 , & V_13 -> V_110 ,
V_15 -> V_20 , & V_77 ,
F_44 ( & V_76 -> V_50 , V_113 ) ) ;
V_15 -> V_77 = V_77 ;
V_74 = F_20 ( V_45 , V_47 , V_13 , & V_76 -> V_50 ) ;
if ( V_74 )
F_47 ( V_74 ) -> V_114 . V_115 . V_116 . V_117 = V_79 ;
V_83: return V_74 ;
}
