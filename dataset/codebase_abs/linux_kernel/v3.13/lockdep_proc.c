...
static void * F_43 ( struct V_1 * V_2 , T_1 * V_4 )
{
...
static void * F_44 ( struct V_1 * V_2 , void * V_3 , T_1 * V_4 )
{
( * V_4 ) ++ ;
return F_43 ( V_2 , V_4 ) ;
}
static void F_45 ( struct V_1 * V_2 , void * V_3 )
{
}
...
static int F_47 ( struct V_21 * V_21 , struct V_22 * V_22 )
{
int V_140 ;
struct V_6 * V_7 ;
struct V_136 * V_121 = F_48 ( sizeof( struct V_136 ) ) ;
if ( ! V_121 )
return - V_141 ;
...
F_17 (class, &all_lock_classes, lock_entry) {
V_138 -> V_7 = V_7 ;
V_138 -> V_106 = F_49 ( V_7 ) ;
V_138 ++ ;
}
V_121 -> V_139 = V_138 ;
F_50 ( V_121 -> V_106 , V_121 -> V_139 - V_121 -> V_106 ,
sizeof( struct V_101 ) ,
F_33 , NULL ) ;
V_2 -> V_137 = V_121 ;
} else
...
static T_5 F_52 ( struct V_22 * V_22 , const char T_6 * V_112 ,
T_2 V_144 , T_1 * V_145 )
{
struct V_6 * V_7 ;
char V_109 ;
...
static int F_55 ( struct V_21 * V_21 , struct V_22 * V_22 )
{
struct V_1 * V_147 = V_22 -> V_143 ;
F_51 ( V_147 -> V_137 ) ;
return F_56 ( V_21 , V_22 ) ;
}
static int T_7 F_57 ( void )
{
F_58 ( L_86 , V_148 , NULL , & V_149 ) ;
#ifdef F_12
F_58 ( L_87 , V_148 , NULL ,
& V_150 ) ;
#endif
F_58 ( L_88 , V_148 , NULL ,
& V_151 ) ;
#ifdef F_59
F_58 ( L_89 , V_148 | V_152 , NULL ,
& V_153 ) ;
#endif
return 0 ;
}
