...
return 0 ;
V_103 = F_27 ( (struct V_102 * ) & V_2 -> V_104 [ V_20 ] ,
V_2 -> V_67 - V_20 , V_21 ) ;
if ( V_103 )
...
static int F_32 ( struct V_18 * V_13 , int V_108 )
{
T_3 * V_109 , V_110 = 0 ;
int V_111 , V_112 = 0 ;
F_33 ( V_23 > 16 ) ;
V_109 = F_34 ( V_108 * sizeof( * V_109 ) , V_113 ) ;
if ( ! V_109 )
return - V_15 ;
...
int F_36 ( struct V_18 * V_13 , unsigned int V_108 )
{
...
case V_64 :
V_154 = false ;
#define F_38 ( T_4 ) case SKF_AD_OFF + SKF_AD_##CODE: \
...
case V_79 :
case V_80 :
return F_32 ( V_13 , V_108 ) ;
}
return - V_114 ;
}
void F_39 ( struct V_172 * V_173 )
{
struct F_7 * V_174 = F_40 ( V_173 , struct F_7 , V_173 ) ;
F_41 ( V_174 ) ;
}
static int F_42 ( struct F_7 * V_174 )
{
int V_12 ;
V_174 -> V_175 = F_16 ;
V_12 = F_36 ( V_174 -> V_176 , V_174 -> V_67 ) ;
if ( V_12 )
return V_12 ;
F_43 ( V_174 ) ;
return 0 ;
}
int F_44 ( struct F_7 * * V_177 ,
struct V_178 * V_179 )
{
struct F_7 * V_174 ;
...
if ( V_179 -> V_13 == NULL )
return - V_114 ;
V_174 = F_34 ( F_45 ( V_179 -> V_67 ) , V_113 ) ;
if ( ! V_174 )
return - V_15 ;
...
void F_47 ( struct F_7 * V_174 )
{
F_48 ( V_174 ) ;
}
int F_49 ( struct V_178 * V_179 , struct V_10 * V_11 )
{
struct F_7 * V_174 , * V_183 ;
unsigned int V_180 = sizeof( struct V_18 ) * V_179 -> V_67 ;
unsigned int V_184 = F_45 ( V_179 -> V_67 ) ;
int V_12 ;
if ( F_9 ( V_11 , V_185 ) )
return - V_17 ;
if ( V_179 -> V_13 == NULL )
return - V_114 ;
V_174 = F_50 ( V_11 , V_184 , V_113 ) ;
if ( ! V_174 )
return - V_15 ;
if ( F_51 ( V_174 -> V_176 , V_179 -> V_13 , V_180 ) ) {
F_52 ( V_11 , V_174 , V_184 ) ;
return - V_186 ;
}
F_46 ( & V_174 -> V_181 , 1 ) ;
V_174 -> V_67 = V_179 -> V_67 ;
...
void F_59 ( struct V_18 * V_188 , struct V_18 * V_189 )
{
...
int F_60 ( struct V_10 * V_11 , struct V_18 T_5 * V_191 , unsigned int V_67 )
{
struct F_7 * V_13 ;
int V_192 , V_112 ;
F_61 ( V_11 ) ;
...
struct V_18 V_194 ;
F_59 ( & V_13 -> V_176 [ V_192 ] , & V_194 ) ;
if ( F_62 ( & V_191 [ V_192 ] , & V_194 , sizeof( V_194 ) ) )
goto V_193;
}
V_112 = V_13 -> V_67 ;
V_193:
