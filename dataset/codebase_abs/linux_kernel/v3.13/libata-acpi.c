...
return;
F_23 ( & V_8 -> V_6 , V_31 , V_8 -> V_35 ) ;
if ( F_24 ( V_8 , & V_8 -> V_36 ) == 0 )
V_8 -> V_37 |= V_38 ;
F_25 ( F_4 ( & V_8 -> V_6 ) ,
& V_39 , V_8 , NULL , NULL ) ;
}
...
if ( V_8 -> V_4 & V_34 ) {
if ( ! F_27 ( V_8 ) )
V_42 = F_28 ( V_8 -> V_35 , V_43 ) ;
else
V_42 = F_28 ( V_8 -> V_35 , V_2 -> V_15 -> V_44 ) ;
V_41 = V_31 ;
} else {
V_42 = V_2 -> V_45 ;
V_41 = V_40 ;
}
F_23 ( & V_2 -> V_6 , V_41 , V_42 ) ;
F_25 ( F_3 ( V_2 ) ,
& V_46 , V_2 , NULL , NULL ) ;
}
void F_29 ( struct V_47 * V_32 )
{
int V_48 ;
for ( V_48 = 0 ; V_48 < V_32 -> V_49 ; V_48 ++ ) {
struct V_7 * V_8 = V_32 -> V_50 [ V_48 ] ;
const struct F_24 * V_51 = F_30 ( V_8 ) ;
if ( F_4 ( & V_8 -> V_6 ) && V_51 )
F_31 ( V_8 , V_51 ) ;
}
}
int F_24 ( struct V_7 * V_8 , struct F_24 * V_51 )
{
...
if ( V_57 -> V_66 . V_54 != sizeof( struct F_24 ) ) {
F_34 ( V_8 , L_6 ,
V_57 -> V_66 . V_54 ) ;
goto V_63;
}
memcpy ( V_51 , V_57 -> V_66 . V_64 , sizeof( struct F_24 ) ) ;
V_59 = 0 ;
V_63:
F_2 ( V_53 . V_64 ) ;
return V_59 ;
}
int F_31 ( struct V_7 * V_8 , const struct F_24 * V_67 )
{
T_4 V_58 ;
struct F_24 V_68 = * V_67 ;
struct V_69 V_70 ;
union V_56 V_71 [ 3 ] ;
V_71 [ 0 ] . type = V_65 ;
V_71 [ 0 ] . V_66 . V_54 = sizeof( struct F_24 ) ;
...
static int F_36 ( struct V_1 * V_2 , struct V_76 * * V_77 )
{
struct V_7 * V_8 = V_2 -> V_15 -> V_8 ;
T_4 V_58 ;
struct V_52 V_53 ;
...
if ( ! ( V_51 -> V_4 & 0x10 ) )
V_82 = 0 ;
V_83 = F_41 ( V_84 , V_51 -> V_85 [ V_82 ] . V_86 ) ;
V_81 |= F_42 ( V_83 ) ;
if ( ! ( V_51 -> V_4 & ( 1 << ( 2 * V_82 ) ) ) )
type = V_87 ;
else
type = V_88 ;
V_83 = F_41 ( type , V_51 -> V_85 [ V_82 ] . V_89 ) ;
V_81 |= F_42 ( V_83 ) ;
return V_81 ;
}
int F_43 ( struct V_7 * V_8 , const struct F_24 * V_51 )
{
struct V_1 * V_2 ;
F_7 (dev, &ap->link, ENABLED) {
unsigned long V_81 , V_90 ;
V_81 = F_40 ( V_2 , V_51 ) ;
F_44 ( V_81 , NULL , NULL , & V_90 ) ;
if ( V_90 & ~ V_91 )
return 1 ;
}
return 0 ;
...
F_45 ( V_2 , V_77 , & V_93 ) ;
if ( V_125 ) {
F_45 ( V_2 , V_125 , & V_104 ) ;
V_126 = & V_104 ;
}
if ( ! F_47 ( V_2 , & V_93 , V_126 ) ) {
V_127 = V_93 ;
V_128 = F_49 ( V_2 , & V_127 , NULL ,
V_132 , NULL , 0 , 0 ) ;
switch ( V_128 ) {
case 0 :
V_129 = V_133 ;
...
static int F_52 ( struct V_1 * V_2 , int * V_138 )
{
...
static int F_58 ( struct V_1 * V_2 , bool V_143 )
{
int V_144 = V_145 ;
if ( ! V_143 )
goto V_146;
...
V_144 = V_149 ;
V_146:
return F_61 ( & V_2 -> V_6 , NULL , V_144 ) ;
}
static void F_62 ( struct V_7 * V_8 , T_5 V_150 )
{
bool V_143 = F_63 ( V_150 ) ;
struct V_1 * V_2 ;
T_1 V_22 ;
int V_151 ;
F_7 (dev, &ap->link, ENABLED) {
...
static void F_67 ( struct V_7 * V_8 , T_5 V_150 )
{
struct V_1 * V_2 ;
T_1 V_40 ;
V_40 = F_4 ( & V_8 -> V_6 ) ;
...
if ( ! V_154 )
continue;
F_65 ( V_154 , V_150 . V_12 & V_152 ?
V_153 : V_145 ) ;
}
if ( ! ( V_150 . V_12 & V_152 ) )
F_65 ( V_40 , V_145 ) ;
}
void F_68 ( struct V_7 * V_8 , T_5 V_150 )
{
if ( V_8 -> V_4 & V_34 )
F_62 ( V_8 , V_150 ) ;
else
