...
goto V_119;
F_16 ( V_28 , 9600 ) ;
V_49 -> V_120 = F_94 ( V_47 , & V_49 -> V_121 , V_122 ) ;
if ( ! V_49 -> V_120 ) {
V_118 = - V_123 ;
goto V_124;
}
...
static int F_99 ( T_4 * V_126 , int V_127 )
{
...
V_118 = F_103 ( V_132 [ V_9 -> V_131 ] , V_122 ) ;
if ( V_118 )
return V_118 ;
} else {
F_104 ( & V_9 -> V_47 , L_11 ) ;
...
V_49 -> V_121 . V_148 . V_149 &= V_130 ;
V_49 -> V_121 . V_150 . V_149 = 1 ;
F_107 ( & V_49 -> V_121 ) ;
V_118 = F_108 ( V_47 ) ;
if ( V_118 ) {
