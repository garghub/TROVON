...
goto V_517;
V_66 = & V_1 -> V_66 ;
V_510 . V_518 = F_324 ( V_1 -> V_23 -> V_511 ) ;
V_510 . V_519 = F_319 ( V_1 -> V_23 -> V_511 ) ;
V_510 . V_520 = V_1 -> V_23 -> V_521 ;
V_510 . V_522 = V_1 -> V_498 ;
F_80 ( & V_1 -> V_134 , V_40 ) ;
F_325 ( V_66 , V_1 , & V_510 , & V_1 -> V_254 [ 0 ] ) ;
F_81 ( & V_1 -> V_134 , V_40 ) ;
...
F_80 ( & V_1 -> V_134 , V_40 ) ;
if ( F_327 ( V_66 , V_396 + 1 ) ||
F_328 ( V_66 , V_397 + 1 ) ) {
F_237 ( V_1 , F_329 ( V_66 ) -> V_290 - 1 ,
F_329 ( V_66 ) -> V_530 - 1 ) ;
if ( F_327 ( V_66 , V_396 + 1 ) ||
F_328 ( V_66 , V_397 + 1 ) )
V_222 = - V_531 ;
...
static void
F_336 ( struct V_496 * V_497 )
{
struct V_47 * V_48 = F_337 ( V_497 ) ;
struct V_1 * V_1 ;
struct V_66 * V_66 ;
unsigned long V_40 ;
if ( ! V_48 )
