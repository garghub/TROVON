...
static void F_261 ( struct V_389 * V_390 , struct V_153 * V_154 , void * V_316 )
{
struct V_5 * V_6 = V_316 ;
struct V_391 * V_392 = F_262 ( V_390 ) ;
struct V_77 * V_76 = V_392 -> V_65 ;
T_1 * V_393 ;
if ( F_121 ( V_154 ) )
goto V_394;
V_393 = F_263 ( V_154 ) -> V_395 ;
if ( F_43 ( V_393 ) )
F_264 ( V_6 , V_76 , V_154 ) ;
if ( ! F_43 ( V_393 ) )
V_60 ( V_76 , V_393 ) ;
V_394:
F_265 ( V_390 , V_154 , V_76 ) ;
}
static void F_266 ( struct V_389 * V_390 , struct V_153 * V_154 , void * V_316 )
{
...
static struct V_389 * F_268 ( struct V_77 * V_76 , T_2 V_397 ,
struct V_153 * V_154 , unsigned int V_398 ,
void (* F_269)( struct V_389 * ,
struct V_153 * ,
void * ) ,
...
if ( V_76 -> V_402 )
break;
return F_270 ( V_76 , V_397 , V_154 , V_398 , F_261 ,
V_6 , V_399 ) ;
case V_307 :
if ( F_149 ( V_156 -> V_253 ) != V_309 )
break;
return F_270 ( V_76 , V_397 , V_154 , V_398 , F_266 ,
V_76 , V_399 ) ;
}
return F_270 ( V_76 , V_397 , V_154 , V_398 , F_269 , V_316 , V_399 ) ;
}
static int F_271 ( struct V_191 * V_117 , bool V_403 )
{
...
V_121 = F_272 ( V_117 ) ;
if ( V_121 ) {
F_273 ( V_117 -> V_202 , V_405 , sizeof( V_405 ) ) ;
F_66 ( V_177 L_65
L_66 ,
V_405 ) ;
return V_121 ;
...
static int F_276 ( struct V_191 * V_117 )
{
struct V_189 * V_190 = F_108 ( V_117 ) ;
struct V_77 * V_188 = F_109 ( V_190 ) ;
...
static int F_277 ( struct V_191 * V_117 , bool V_408 )
{
...
static void F_278 ( struct V_191 * V_117 )
{
struct V_77 * V_76 = V_117 -> V_407 ;
struct V_153 * V_154 ;
T_9 V_242 ;
...
if ( V_76 -> V_259 != V_410 )
return;
V_242 = F_279 ( F_63 ( V_76 -> V_66 ) , 255 ) ;
V_154 = F_280 ( V_76 ,
sizeof( struct V_411 ) +
...
static void F_281 ( struct V_417 * V_418 )
{
struct V_45 * V_46 =
F_282 ( V_418 ) ;
...
static void F_283 ( struct V_77 * V_76 ,
