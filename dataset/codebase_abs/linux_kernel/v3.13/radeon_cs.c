...
case V_132 :
if ( V_5 -> V_49 < V_57 ) {
V_128 -> V_133 = F_50 ( V_129 ) ;
V_128 -> V_131 =
F_51 ( V_129 ) ;
} else
V_128 -> V_133 = F_52 ( V_129 ) ;
break;
case V_134 :
V_128 -> V_135 = F_53 ( V_129 ) ;
break;
case V_136 :
V_128 -> V_130 = - 1 ;
break;
...
* V_139 = NULL ;
V_141 = & V_2 -> V_12 [ V_2 -> V_11 ] ;
V_22 = F_46 ( V_2 , & V_137 , V_2 -> V_68 ) ;
if ( V_22 )
return V_22 ;
V_2 -> V_68 += V_137 . V_130 + 2 ;
if ( V_137 . type != V_134 ||
V_137 . V_135 != V_138 ) {
F_4 ( L_18 ,
V_137 . V_68 ) ;
...
* V_139 = V_2 -> V_19 ;
( * V_139 ) -> V_29 . V_142 =
( V_143 ) V_141 -> V_23 [ V_68 + 3 ] << 32 ;
( * V_139 ) -> V_29 . V_142 |= V_141 -> V_23 [ V_68 + 0 ] ;
} else
* V_139 = V_2 -> V_16 [ ( V_68 / 4 ) ] ;
return 0 ;
}
