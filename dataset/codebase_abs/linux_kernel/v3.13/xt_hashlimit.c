...
static void F_45 ( struct V_9 * V_31 )
{
F_46 ( & V_31 -> V_46 ) ;
F_43 ( V_31 ) ;
F_38 ( V_31 , F_35 ) ;
...
static struct V_9 * F_47 ( struct V_2 * V_2 ,
const char * V_39 ,
T_2 V_30 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
struct V_9 * V_31 ;
F_48 (hinfo, &hashlimit_net->htables, node) {
...
static void F_49 ( struct V_9 * V_31 )
{
F_50 ( & V_59 ) ;
if ( -- V_31 -> V_38 == 0 ) {
F_51 ( & V_31 -> V_24 ) ;
...
static V_12 F_55 ( V_12 V_62 )
{
V_14 V_66 = V_62 ;
V_66 *= V_63 * V_67 ;
return ( V_12 ) ( V_66 >> 32 ) ;
}
static void F_56 ( struct V_4 * V_53 , unsigned long V_68 , V_12 V_69 )
{
...
static void F_57 ( struct V_4 * V_53 ,
struct V_9 * V_31 )
{
V_53 -> V_71 . V_72 = V_49 ;
if ( V_31 -> V_15 . V_69 & V_74 ) {
V_53 -> V_71 . V_76 = V_67 * V_63 ;
V_53 -> V_71 . V_78 = F_55 ( V_31 -> V_15 . V_79 ) ;
V_53 -> V_71 . V_77 = V_31 -> V_15 . V_80 ;
} else {
V_53 -> V_71 . V_76 = F_54 ( V_31 -> V_15 . V_79 *
V_31 -> V_15 . V_80 ) ;
V_53 -> V_71 . V_78 = F_54 ( V_31 -> V_15 . V_79 ) ;
V_53 -> V_71 . V_77 = V_53 -> V_71 . V_76 ;
}
}
static inline T_3 F_58 ( T_3 V_81 , unsigned int V_82 )
{
return V_82 ? F_59 ( F_60 ( V_81 ) & ~ 0 << ( 32 - V_82 ) ) : 0 ;
}
static void F_61 ( T_3 * V_32 , unsigned int V_83 )
{
switch ( V_83 ) {
case 0 ... 31 :
V_32 [ 0 ] = F_58 ( V_32 [ 0 ] , V_83 ) ;
V_32 [ 1 ] = V_32 [ 2 ] = V_32 [ 3 ] = 0 ;
break;
case 32 ... 63 :
V_32 [ 1 ] = F_58 ( V_32 [ 1 ] , V_83 - 32 ) ;
V_32 [ 2 ] = V_32 [ 3 ] = 0 ;
break;
case 64 ... 95 :
V_32 [ 2 ] = F_58 ( V_32 [ 2 ] , V_83 - 64 ) ;
V_32 [ 3 ] = 0 ;
break;
case 96 ... 127 :
V_32 [ 3 ] = F_58 ( V_32 [ 3 ] , V_83 - 96 ) ;
break;
case 128 :
break;
}
...
V_8 -> V_92 . V_8 = F_58 ( F_63 ( V_85 ) -> V_93 ,
V_31 -> V_15 . V_94 ) ;
if ( V_31 -> V_15 . V_69 & V_95 )
V_8 -> V_92 . V_96 = F_58 ( F_63 ( V_85 ) -> V_97 ,
V_31 -> V_15 . V_98 ) ;
if ( ! ( V_31 -> V_15 . V_69 &
( V_99 | V_100 ) ) )
return 0 ;
V_89 = F_63 ( V_85 ) -> V_101 ;
break;
#if F_64 ( V_102 )
case V_103 :
{
T_4 V_104 ;
if ( V_31 -> V_15 . V_69 & V_91 ) {
memcpy ( & V_8 -> V_105 . V_8 , & F_65 ( V_85 ) -> V_93 ,
sizeof( V_8 -> V_105 . V_8 ) ) ;
F_61 ( V_8 -> V_105 . V_8 , V_31 -> V_15 . V_94 ) ;
}
if ( V_31 -> V_15 . V_69 & V_95 ) {
memcpy ( & V_8 -> V_105 . V_96 , & F_65 ( V_85 ) -> V_97 ,
sizeof( V_8 -> V_105 . V_96 ) ) ;
F_61 ( V_8 -> V_105 . V_96 , V_31 -> V_15 . V_98 ) ;
}
if ( ! ( V_31 -> V_15 . V_69 &
( V_99 | V_100 ) ) )
return 0 ;
V_89 = F_65 ( V_85 ) -> V_89 ;
V_86 = F_66 ( V_85 , sizeof( struct V_106 ) , & V_89 , & V_104 ) ;
if ( ( int ) V_86 < 0 )
return - 1 ;
break;
}
...
V_90 = F_68 ( V_89 ) ;
if ( V_90 >= 0 ) {
V_88 = F_69 ( V_85 , V_86 + V_90 , sizeof( V_87 ) ,
& V_87 ) ;
} else {
V_87 [ 0 ] = V_87 [ 1 ] = 0 ;
V_88 = V_87 ;
...
static V_12 F_70 ( unsigned int V_60 , struct V_4 * V_53 )
{
V_14 V_75 = F_53 ( V_60 ) ;
...
static bool
F_71 ( const struct V_84 * V_85 , struct V_109 * V_110 )
{
...
bool V_18 = false ;
V_12 V_78 ;
if ( F_62 ( V_31 , & V_8 , V_85 , V_110 -> V_113 ) < 0 )
goto V_114;
F_72 () ;
V_53 = F_6 ( V_31 , & V_8 ) ;
if ( V_53 == NULL ) {
...
static int F_74 ( const struct V_117 * V_110 )
{
...
if ( V_111 -> V_15 . V_69 & V_74 ) {
if ( F_55 ( V_111 -> V_15 . V_79 ) == 0 ) {
F_75 ( L_3 , V_111 -> V_15 . V_79 ) ;
return - V_119 ;
}
} else if ( V_111 -> V_15 . V_80 == 0 ||
F_54 ( V_111 -> V_15 . V_79 * V_111 -> V_15 . V_80 ) <
F_54 ( V_111 -> V_15 . V_79 ) ) {
F_75 ( L_4 ,
V_111 -> V_15 . V_79 , V_111 -> V_15 . V_80 ) ;
return - V_121 ;
}
F_50 ( & V_59 ) ;
V_111 -> V_31 = F_47 ( V_2 , V_111 -> V_39 , V_110 -> V_30 ) ;
if ( V_111 -> V_31 == NULL ) {
...
static void F_76 ( const struct V_122 * V_110 )
{
const struct V_28 * V_111 = V_110 -> V_112 ;
F_49 ( V_111 -> V_31 ) ;
}
static void * F_77 ( struct V_123 * V_124 , T_6 * V_125 )
...
return NULL ;
V_128 = F_78 ( sizeof( unsigned int ) , V_23 ) ;
if ( ! V_128 )
return F_79 ( - V_37 ) ;
* V_128 = * V_125 ;
return V_128 ;
}
static void * F_80 ( struct V_123 * V_124 , void * V_129 , T_6 * V_125 )
{
struct V_9 * V_126 = V_124 -> V_127 ;
...
static void F_81 ( struct V_123 * V_124 , void * V_129 )
...
static int F_83 ( struct V_4 * V_5 , T_2 V_30 ,
struct V_123 * V_124 )
{
int V_130 ;
const struct V_9 * V_10 = V_124 -> V_127 ;
F_9 ( & V_5 -> V_17 ) ;
F_56 ( V_5 , V_49 , V_10 -> V_15 . V_69 ) ;
switch ( V_30 ) {
case V_42 :
V_130 = F_84 ( V_124 , L_5 ,
...
static int F_86 ( struct V_123 * V_124 , void * V_129 )
{
struct V_9 * V_126 = V_124 -> V_127 ;
unsigned int * V_128 = ( unsigned int * ) V_129 ;
struct V_4 * V_5 ;
if ( ! F_7 ( & V_126 -> V_11 [ * V_128 ] ) ) {
F_48 (ent, &htable->hash[*bucket], node)
if ( F_83 ( V_5 , V_126 -> V_30 , V_124 ) )
return - 1 ;
}
return 0 ;
}
static int F_87 ( struct V_131 * V_131 , struct V_132 * V_132 )
{
int V_118 = F_88 ( V_132 , & V_133 ) ;
if ( ! V_118 ) {
struct V_123 * V_134 = V_132 -> V_135 ;
V_134 -> V_127 = F_89 ( V_131 ) ;
}
return V_118 ;
}
static int T_7 F_90 ( struct V_2 * V_2 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
V_1 -> V_43 = F_91 ( L_7 , V_2 -> V_136 ) ;
if ( ! V_1 -> V_43 )
return - V_37 ;
#if F_64 ( V_102 )
V_1 -> V_44 = F_91 ( L_8 , V_2 -> V_136 ) ;
if ( ! V_1 -> V_44 ) {
F_44 ( L_7 , V_2 -> V_136 ) ;
return - V_37 ;
}
...
static int T_7 F_93 ( struct V_2 * V_2 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
F_26 ( & V_1 -> V_51 ) ;
return F_90 ( V_2 ) ;
}
static void T_8 F_94 ( struct V_2 * V_2 )
{
F_92 ( V_2 ) ;
}
