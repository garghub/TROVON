...
{
return F_14 ( V_1 -> V_7 -> V_5 , V_1 -> V_3 ) ;
}
void F_15 ( struct V_1 * V_1 )
{
F_16 ( V_1 -> V_7 -> V_5 , V_1 -> V_3 ) ;
}
void F_17 ( struct V_1 * V_1 )
{
F_18 ( V_1 -> V_7 -> V_5 , V_1 -> V_3 ) ;
}
...
struct V_6 * V_7 = F_22 () ;
int V_24 ;
V_24 = F_46 ( V_1 -> V_2 , 256 ) ;
if ( V_24 )
return V_24 ;
F_47 ( V_1 -> V_2 ,
V_1 -> V_22 . V_52 ) ;
F_48 ( V_7 -> V_5 , V_1 -> V_2 ,
V_1 -> V_22 . V_53 ) ;
F_31 ( V_7 -> V_5 ) ;
return 0 ;
}
static int F_49 ( struct V_4 * V_5 , unsigned long V_54 )
{
struct V_6 * V_7 = F_22 () ;
int V_24 ;
V_7 -> V_5 = V_5 ;
...
F_10 (imx_drm_crtc, &imxdrm->crtc_list, list) {
if ( V_1 -> V_60 . V_60 == V_60 -> V_60 &&
V_1 -> V_60 . V_61 == V_60 -> V_61 ) {
V_47 |= 1 << V_1 -> V_3 ;
}
}
}
...
int F_55 ( struct V_11 * V_2 ,
struct V_1 * * V_63 ,
const struct V_18 * V_22 ,
struct V_64 * V_37 , void * V_60 , int V_61 )
{
struct V_6 * V_7 = F_22 () ;
struct V_1 * V_1 ;
int V_24 ;
...
int F_61 ( struct V_75 * V_48 ,
struct V_33 * * V_76 , struct V_64 * V_37 )
{
struct V_6 * V_7 = F_22 () ;
struct V_33 * V_33 ;
int V_24 ;
...
if ( V_24 < 0 )
break;
V_81 = F_56 ( sizeof( * V_81 ) , V_69 ) ;
if ( ! V_81 ) {
F_65 ( args . V_79 ) ;
return - V_70 ;
}
V_81 -> V_60 = args . V_79 ;
V_81 -> V_61 = args . V_82 > 0 ? args . args [ 0 ] : 0 ;
F_65 ( args . V_79 ) ;
F_30 ( & V_7 -> V_41 ) ;
F_57 ( & V_81 -> V_72 , & V_33 -> V_47 ) ;
F_29 ( & V_7 -> V_41 ) ;
}
F_54 () ;
return 0 ;
...
static int F_72 ( struct V_89 * V_90 )
{
int V_24 ;
V_24 = F_73 ( & V_90 -> V_16 , F_74 ( 32 ) ) ;
if ( V_24 )
return V_24 ;
V_6 -> V_16 = & V_90 -> V_16 ;
return F_75 ( & V_91 , V_90 ) ;
}
