...
if ( ! V_54 && F_27 () )
return - V_55 ;
V_2 -> V_12 = F_32 ( V_2 -> V_6 -> V_56 , 0644 ,
V_54 ,
V_2 , & V_57 ) ;
if ( ! V_2 -> V_12 )
return - V_21 ;
...
return - V_59 ;
F_5 ( & V_60 ) ;
F_34 (node, &all_stat_sessions, session_list) {
if ( V_24 -> V_6 == V_58 ) {
F_6 ( & V_60 ) ;
return - V_59 ;
}
...
void F_38 ( struct V_29 * V_58 )
{
struct V_1 * V_24 , * V_63 ;
F_5 ( & V_60 ) ;
F_39 (node, tmp, &all_stat_sessions, session_list) {
if ( V_24 -> V_6 == V_58 ) {
F_40 ( & V_24 -> V_61 ) ;
F_7 ( V_24 ) ;
break;
