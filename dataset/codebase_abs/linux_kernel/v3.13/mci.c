...
V_125 &= ~ V_154 ;
if ( V_125 & V_155 ) {
int V_156 = F_61 ( V_29 -> V_157 ,
V_158 ) ;
V_125 &= ~ V_155 ;
F_19 ( V_8 , V_41 ,
L_17 ,
F_61 ( V_29 -> V_157 , V_159 ) ?
L_18 : L_19 ,
F_61 ( V_29 -> V_157 , V_160 ) ,
V_156 ) ;
}
if ( V_125 & V_161 )
V_125 &= ~ V_161 ;
...
void F_63 ( struct V_25 * V_26 , bool V_170 )
{
struct V_52 * V_53 = V_26 -> V_27 ;
...
V_3 -> V_180 [ V_78 ] = V_173 [ V_78 ] ;
F_45 ( V_53 ) ;
F_43 ( V_53 , V_181 ) ;
}
void F_67 ( struct V_25 * V_26 , bool V_182 ,
bool V_183 )
{
struct V_52 * V_53 = V_26 -> V_27 ;
struct V_28 * V_29 = & V_26 -> V_27 -> V_30 . V_3 ;
bool V_184 = V_29 -> V_183 ;
if ( ! ( V_29 -> V_32 & V_185 ) ) {
V_29 -> V_183 = false ;
return;
}
...
return;
if ( V_182 ) {
struct V_186 * V_187 = & V_26 -> V_187 ;
if ( F_64 ( V_53 -> V_45 ) &&
( V_53 -> V_45 -> V_178 > V_187 -> V_178 ) &&
( V_53 -> V_45 -> V_178 <= V_187 -> V_178 + 20 ) )
return;
if ( F_65 ( V_53 -> V_45 ) &&
( V_53 -> V_45 -> V_178 < V_187 -> V_178 ) &&
( V_53 -> V_45 -> V_178 >= V_187 -> V_178 - 20 ) )
...
V_29 -> V_183 = V_183 ;
if ( V_184 != V_29 -> V_183 )
F_68 ( V_53 , V_26 -> V_32 . V_188 , false ) ;
}
