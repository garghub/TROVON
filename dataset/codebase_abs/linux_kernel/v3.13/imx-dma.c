...
L_12 ,
V_31 , V_10 -> V_29 ,
( unsigned long long ) V_20 -> V_89 ,
( unsigned long long ) V_20 -> V_88 , V_20 -> V_24 ) ;
break;
case V_15 :
case V_90 :
if ( V_20 -> V_26 == V_27 ) {
...
L_13 ,
V_31 , V_10 -> V_29 ,
V_20 -> V_22 , V_20 -> V_93 , V_20 -> V_24 ,
( unsigned long long ) V_10 -> V_91 ) ;
...
struct V_11 * V_12 ;
F_20 ( V_2 -> V_30 , L_18 ,
V_31 , V_10 -> V_29 , ( unsigned long long ) V_88 ,
( unsigned long long ) V_89 , V_24 ) ;
if ( F_7 ( & V_10 -> V_98 ) ||
F_6 ( V_10 ) )
return NULL ;
V_12 = F_8 ( & V_10 -> V_98 , struct V_11 , V_14 ) ;
...
F_20 ( V_2 -> V_30 , L_19
L_20 , V_31 ,
V_10 -> V_29 , ( unsigned long long ) V_160 -> V_161 ,
( unsigned long long ) V_160 -> V_162 ,
V_160 -> V_163 ? L_21 : L_22 , V_160 -> V_164 ? L_21 : L_22 ,
...
if ( V_42 < 0 )
return V_42 ;
V_2 -> V_197 = F_80 ( & V_186 -> V_30 , L_24 ) ;
if ( F_77 ( V_2 -> V_197 ) )
return F_78 ( V_2 -> V_197 ) ;
V_2 -> V_198 = F_80 ( & V_186 -> V_30 , L_25 ) ;
if ( F_77 ( V_2 -> V_198 ) )
