...
void T_3 F_67 ( int V_132 , int V_5 )
{
if ( V_132 >= V_117 ) {
F_68 ( V_133 L_3 , V_134 , V_132 ) ;
return;
}
switch ( V_5 ) {
case 1 :
...
static void
F_70 ( struct V_147 * V_148 , const char * V_149 , unsigned int V_150 )
{
...
static int T_3
F_76 ( struct V_147 * V_148 , char * V_153 )
{
struct V_1 * V_2 ;
int V_77 = 9600 ;
int V_152 = 8 ;
...
if ( V_153 )
F_77 ( V_153 , & V_77 , & V_38 , & V_152 , & V_154 ) ;
else
F_72 ( V_2 , & V_77 , & V_38 , & V_152 ) ;
return F_78 ( & V_2 -> V_5 , V_148 , V_77 , V_38 , V_152 , V_154 ) ;
}
...
static int F_81 ( struct V_156 * V_157 , T_4 V_16 )
{
struct V_1 * V_2 = F_82 ( V_157 ) ;
if ( V_2 )
F_83 ( & V_158 , & V_2 -> V_5 ) ;
return 0 ;
}
...
F_87 ( & V_158 , & V_118 [ V_116 ] . V_5 ) ;
F_88 ( V_157 , & V_118 [ V_116 ] ) ;
break;
}
}
return 0 ;
}
static int F_89 ( struct V_156 * V_164 )
{
struct V_1 * V_2 = F_82 ( V_164 ) ;
if ( V_2 )
F_90 ( & V_158 , & V_2 -> V_5 ) ;
return 0 ;
}
