...
if ( ( V_8 -> V_11 . V_36 . V_37 !=
V_38 ) ||
( V_8 -> V_11 . V_39 . V_37 !=
V_38 ) ) {
F_2 ( L_18 ,
( T_1 ) ( V_8 -> V_11 . V_36 . V_37 ) ,
( T_1 ) ( V_8 -> V_11 . V_39 . V_37 ) ) ;
V_31 = - V_4 ;
goto V_35;
}
V_8 -> V_40 = F_19 ( sizeof( * V_8 -> V_40 ) *
( V_8 -> V_11 . V_12 + 1 ) ,
V_32 ) ;
if ( ! V_8 -> V_40 ) {
V_31 = - V_33 ;
...
for ( V_10 = 0 ; V_10 <= V_8 -> V_11 . V_12 ; V_10 ++ )
{
V_8 -> V_40 [ V_10 ] . V_43 = V_10 ;
if ( V_10 < V_8 -> V_11 . V_12 ) {
V_8 -> V_40 [ V_10 ] . V_44 =
V_8 -> V_11 . V_13 [ V_10 ] . V_15 * 1000 ;
} else {
V_8 -> V_40 [ V_10 ] . V_44 = V_45 ;
}
}
V_31 = F_20 ( V_24 , V_8 -> V_40 ) ;
if ( V_31 ) {
goto V_46;
}
F_21 ( V_47 ) ;
