...
static int
F_49 ( struct V_9 * V_10 , int V_108 , unsigned long V_109 ,
struct V_110 * V_111 )
{
struct V_42 V_3 * V_43 ;
struct V_28 V_3 * V_28 ;
...
static T_11 F_64 ( struct V_173 * V_174 , void * V_8 )
{
struct V_131 * V_132 ;
T_11 V_175 ;
struct V_176 V_5 ;
...
if ( F_66 ( V_175 ) ) {
V_132 -> V_133 = V_5 . V_177 ;
V_132 -> V_154 = F_67 ( V_5 . V_177 , V_5 . V_178 ) ;
if ( F_55 ( V_132 ) ) {
F_68 ( V_132 -> V_154 ) ;
return V_179 ;
}
} else if ( V_174 -> type == V_180 ) {
struct V_181 * V_182 ;
V_182 = & V_174 -> V_8 . V_183 ;
V_132 -> V_133 = V_182 -> V_184 ;
V_132 -> V_154 = F_67 ( V_182 -> V_184 ,
V_185 ) ;
if ( F_55 ( V_132 ) ) {
F_68 ( V_132 -> V_154 ) ;
return V_179 ;
...
static int F_72 ( struct V_197 * V_198 )
{
return - V_61 ;
}
