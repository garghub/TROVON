...
static inline int F_192 ( T_3 V_360 , int V_361 , T_3 V_362 , int V_363 )
{
return ! ( ( V_360 + ( V_361 >> 9 ) <= V_362 ) || ( V_360 >= V_362 + ( V_363 >> 9 ) ) ) ;
}
...
F_27 () ;
V_366 = F_28 ( V_10 -> V_26 -> V_29 ) -> V_367 ;
F_29 () ;
if ( ! V_366 )
break;
F_31 ( & V_10 -> V_359 , & V_31 , V_36 ) ;
F_12 ( & V_10 -> V_358 ) ;
F_27 () ;
...
F_12 ( & V_10 -> V_358 ) ;
F_35 ( & V_10 -> V_359 , & V_31 ) ;
return V_365 ;
}
static unsigned long F_197 ( struct V_9 * V_10 , T_8 V_368 )
{
...
return 0 ;
F_21 ( & V_10 -> V_412 ) ;
V_4 = F_214 ( V_10 -> V_413 , F_215 ( V_46 ) ) ;
if ( V_4 ) {
struct V_414 * V_415 = F_216 ( V_4 , struct V_414 , V_416 ) ;
...
F_22 ( & V_10 -> V_412 ) ;
V_409 = ( int ) F_217 ( & V_402 -> V_418 , V_419 [ 0 ] ) +
( int ) F_217 ( & V_402 -> V_418 , V_419 [ 1 ] ) -
F_30 ( & V_10 -> V_326 ) ;
...
switch ( V_171 -> V_168 ) {
case V_436 :
F_221 ( V_10 , V_437 , V_298 ) ;
break;
case V_438 :
case V_439 :
case V_440 :
F_221 ( V_10 , V_441 , V_298 ) ;
break;
case V_442 :
V_432 = 0 ;
F_170 ( V_10 ) ;
F_222 ( V_10 , V_443 , V_46 , V_58 , V_444 ) ;
break;
default:
F_223 () ;
}
...
V_10 -> V_456 = V_46 ;
V_10 -> V_458 = V_46 ;
V_10 -> V_426 = F_225 ( V_10 ) - F_224 ( V_46 ) ;
...
if ( V_10 -> V_345 . V_461 != V_462 && F_213 ( V_10 , V_46 ) )
F_226 ( V_100 / 10 ) ;
if ( F_227 ( V_10 , V_46 ) )
goto V_451;
V_455:
...
F_171 ( V_10 ) ;
F_21 ( & V_10 -> V_26 -> V_27 ) ;
F_204 ( & V_19 -> V_22 . V_23 , & V_10 -> V_463 ) ;
F_22 ( & V_10 -> V_26 -> V_27 ) ;
...
if ( V_487 == - 1 && V_10 -> V_345 . V_489 == V_462 ) {
enum V_194 V_491 ;
V_491 = F_230 ( V_10 , V_196 , F_69 ( V_489 , V_490 ) ) ;
if ( V_491 != V_197 ) {
F_231 ( V_10 , L_57 ) ;
} else {
F_33 ( V_38 , L_58 ) ;
...
static void F_233 ( struct V_9 * V_10 , char * V_493 , T_2 * V_471 ,
T_2 V_494 , T_2 V_63 )
{
if ( ! V_471 ) {
...
static int F_234 ( struct V_9 * V_10 , int * V_498 ) __must_hold( T_5 )
{
T_2 V_465 , V_461 ;
int V_6 , V_499 ;
...
F_233 ( V_10 , L_62 , V_10 -> V_243 -> V_470 . V_471 ,
V_10 -> V_345 . V_402 >= V_502 ? F_218 ( V_10 ) : 0 , 0 ) ;
* V_498 = 34 ;
} else {
F_129 ( V_38 , L_63 ) ;
* V_498 = 36 ;
...
F_233 ( V_10 , L_65 , V_10 -> V_473 , V_10 -> V_473 [ V_474 ] , V_10 -> V_473 [ V_503 ] ) ;
* V_498 = 35 ;
} else {
F_129 ( V_38 , L_66 ) ;
* V_498 = 37 ;
...
if ( V_10 -> V_26 -> V_180 < 91 )
return - 1091 ;
F_236 ( V_10 , V_472 , V_10 -> V_243 -> V_470 . V_471 [ V_496 ] ) ;
F_236 ( V_10 , V_496 , V_10 -> V_243 -> V_470 . V_471 [ V_496 + 1 ] ) ;
F_129 ( V_38 , L_68 ) ;
F_233 ( V_10 , L_62 , V_10 -> V_243 -> V_470 . V_471 ,
V_10 -> V_345 . V_402 >= V_502 ? F_218 ( V_10 ) : 0 , 0 ) ;
return 1 ;
...
static enum V_506 F_237 ( struct V_9 * V_10 , enum V_507 V_508 ,
...
F_233 ( V_10 , L_62 , V_10 -> V_243 -> V_470 . V_471 , V_10 -> V_475 , 0 ) ;
F_233 ( V_10 , L_65 , V_10 -> V_473 ,
V_10 -> V_473 [ V_474 ] , V_10 -> V_473 [ V_503 ] ) ;
V_487 = F_234 ( V_10 , & V_498 ) ;
...
F_129 ( V_38 , L_92 ,
F_238 ( V_487 > 0 ? V_346 : V_390 ) ,
abs ( V_487 ) >= 2 ? L_93 : L_94 ) ;
return V_511 ;
}
if ( abs ( V_487 ) >= 2 ) {
F_129 ( V_38 , L_95 ) ;
if ( F_239 ( V_10 , & V_523 , L_96 ,
V_524 ) )
return V_511 ;
}
if ( V_487 > 0 ) {
...
static enum V_468 F_240 ( enum V_468 V_461 )
{
if ( V_461 == V_486 )
return V_485 ;
if ( V_461 == V_485 )
...
if ( F_240 ( V_529 ) != V_30 -> V_469 ) {
F_65 ( V_26 , L_99 , L_101 ) ;
goto V_546;
}
if ( F_240 ( V_530 ) != V_30 -> V_488 ) {
F_65 ( V_26 , L_99 , L_102 ) ;
goto V_546;
}
if ( F_240 ( V_531 ) != V_30 -> V_492 ) {
...
* V_537 = * V_536 ;
V_537 -> V_391 = V_532 ;
V_537 -> V_469 = F_240 ( V_529 ) ;
V_537 -> V_488 = F_240 ( V_530 ) ;
V_537 -> V_492 = F_240 ( V_531 ) ;
V_537 -> V_367 = V_534 ;
F_243 ( V_26 -> V_29 , V_537 ) ;
F_118 ( & V_26 -> V_225 ) ;
...
struct V_540 * F_246 ( const struct V_9 * V_10 ,
const char * V_551 , const char * V_552 )
{
struct V_540 * V_553 ;
if ( ! V_551 [ 0 ] )
return NULL ;
V_553 = F_242 ( V_551 , 0 , V_548 ) ;
if ( F_247 ( V_553 ) ) {
F_43 ( V_38 , L_112 ,
V_551 , V_552 , F_248 ( V_553 ) ) ;
return V_553 ;
}
return V_553 ;
}
...
if ( F_127 ( V_10 ) ) {
V_560 = F_253 ( sizeof( struct V_268 ) , V_550 ) ;
if ( ! V_560 ) {
F_131 ( V_10 ) ;
...
if ( V_557 || V_558 ) {
V_537 = F_253 ( sizeof( struct V_29 ) , V_550 ) ;
if ( ! V_537 ) {
F_43 ( V_38 , L_109 ) ;
goto V_549;
}
...
if ( V_560 ) {
F_243 ( V_10 -> V_243 -> V_268 , V_560 ) ;
F_131 ( V_10 ) ;
}
if ( V_564 ) {
V_563 = V_10 -> V_577 ;
F_243 ( V_10 -> V_577 , V_564 ) ;
}
F_118 ( & V_10 -> V_26 -> V_225 ) ;
F_245 () ;
if ( V_537 )
...
F_29 () ;
F_255 ( V_10 , L_126 ,
V_585 , F_257 ( V_10 -> V_243 ) ) ;
F_255 ( V_10 , L_127 ,
V_586 , V_587 ) ;
if ( V_10 -> V_345 . V_105 == V_103 )
V_586 = F_258 ( V_587 , V_586 ) ;
if ( F_259 ( V_10 , V_10 -> V_243 , V_586 , 0 ) <
F_151 ( V_10 -> V_301 ) &&
...
L_134 ,
V_609 ) ;
F_267 ( V_10 , V_495 , V_473 [ V_495 ] ) ;
F_267 ( V_10 , V_472 , 0 ) ;
F_268 ( F_269 ( V_10 , V_402 , V_435 , V_397 , V_435 ) ,
V_196 , NULL ) ;
F_261 ( V_10 ) ;
V_604 = 1 ;
}
...
static union V_610 F_272 ( union V_610 V_611 )
{
union V_610 V_612 ;
...
V_621 = F_272 ( V_621 ) ;
V_622 = F_272 ( V_622 ) ;
V_92 = F_230 ( V_10 , V_196 , V_621 , V_622 ) ;
F_275 ( V_10 , V_92 ) ;
F_261 ( V_10 ) ;
return 0 ;
}
...
F_129 ( V_38 , L_136 , F_279 ( V_630 ) ) ;
}
F_21 ( & V_10 -> V_26 -> V_27 ) ;
V_28:
V_627 = V_628 = F_280 ( V_10 ) ;
F_22 ( & V_10 -> V_26 -> V_27 ) ;
...
V_629 . V_105 <= V_526 ) ) ;
if ( V_635 )
V_628 . V_105 = F_237 ( V_10 , V_629 . V_489 , V_630 ) ;
F_131 ( V_10 ) ;
if ( V_628 . V_105 == V_511 ) {
V_628 . V_105 = V_527 ;
if ( V_10 -> V_345 . V_402 == V_502 ) {
F_283 ( V_10 , F_69 ( V_402 , V_637 ) ) ;
} else if ( V_629 . V_402 == V_502 ) {
F_43 ( V_38 , L_137 ) ;
V_629 . V_402 = V_638 ;
V_630 = V_638 ;
} else {
if ( F_264 ( V_522 , & V_10 -> V_26 -> V_63 ) )
return - V_108 ;
...
if ( V_628 . V_397 == V_521 && F_284 ( V_10 ) && V_628 . V_105 == V_527 && V_627 . V_105 < V_527 &&
...
F_68 ( V_10 -> V_26 , F_287 ( V_105 , V_640 , V_641 , 0 ) , V_107 ) ;
return - V_108 ;
}
V_92 = F_268 ( V_10 , V_628 , V_632 , NULL ) ;
V_628 = F_280 ( V_10 ) ;
F_22 ( & V_10 -> V_26 -> V_27 ) ;
if ( V_92 < V_197 ) {
F_68 ( V_10 -> V_26 , F_69 ( V_105 , V_150 ) , V_107 ) ;
...
if ( F_137 ( V_10 , V_502 ) ) {
F_267 ( V_10 , V_495 , F_176 ( V_298 -> V_471 ) ) ;
F_267 ( V_10 , V_472 , 0UL ) ;
F_271 ( V_10 , L_139 ) ;
F_289 ( V_10 , V_390 ) ;
F_131 ( V_10 ) ;
} else
...
if ( V_70 )
return V_70 ;
F_291 ( V_10 , V_645 -> V_648 , V_646 , V_298 ) ;
V_645 -> V_648 += V_646 ;
...
static enum V_653 F_292 ( struct V_654 * V_298 )
{
return (enum V_653 ) ( V_298 -> V_655 & 0x0f ) ;
}
static int F_293 ( struct V_654 * V_298 )
{
...
unsigned long V_660 ;
int V_661 = F_293 ( V_298 ) ;
int V_662 ;
int V_494 ;
F_296 ( & V_657 , V_298 -> V_663 , V_5 , F_294 ( V_298 ) ) ;
V_494 = F_297 ( & V_657 , & V_658 , 64 ) ;
if ( V_494 < 0 )
return - V_108 ;
for ( V_662 = V_494 ; V_662 > 0 ; V_201 += V_659 , V_661 = ! V_661 ) {
V_494 = F_298 ( & V_659 , V_658 ) ;
if ( V_494 <= 0 )
return - V_108 ;
if ( V_661 ) {
V_660 = V_201 + V_659 - 1 ;
...
V_658 = 0 ;
V_662 -= V_494 ;
V_494 = F_297 ( & V_657 , & V_4 , 64 - V_662 ) ;
if ( V_494 < 0 )
return - V_108 ;
V_658 |= V_4 << V_662 ;
V_662 += V_494 ;
...
unsigned int V_5 )
{
if ( F_292 ( V_298 ) == V_666 )
return F_295 ( V_10 , V_298 , V_645 , V_5 - sizeof( * V_298 ) ) ;
...
unsigned int V_668 =
V_169 * ( F_303 ( V_645 -> V_647 , V_47 ) + 1 ) +
...
V_70 = F_290 ( V_10 , V_171 -> V_58 , V_171 -> V_95 , & V_645 ) ;
...
if ( V_70 )
goto V_104;
V_70 = F_301 ( V_10 , V_298 , & V_645 , V_171 -> V_58 ) ;
} else {
...
F_302 ( V_10 , L_151 , & V_645 ) ;
if ( V_10 -> V_345 . V_105 == V_526 ) {
enum V_194 V_92 ;
V_70 = F_307 ( V_10 ) ;
if ( V_70 )
goto V_104;
V_92 = F_308 ( V_10 , F_69 ( V_105 , V_643 ) , V_196 ) ;
F_49 ( V_92 == V_197 ) ;
} else if ( V_10 -> V_345 . V_105 != V_525 ) {
F_129 ( V_38 , L_152 ,
F_238 ( V_10 -> V_345 . V_105 ) ) ;
}
V_70 = 0 ;
V_104:
F_309 ( V_10 ) ;
...
F_210 ( V_10 , F_176 ( V_298 -> V_46 ) , F_123 ( V_298 -> V_434 ) ) ;
return 0 ;
}
...
if ( F_177 ( V_171 . V_168 >= F_316 ( V_681 ) || ! V_168 -> V_682 ) ) {
F_65 ( V_26 , L_155 ,
...
F_64 ( V_26 , L_159 ) ;
if ( F_325 ( V_26 ) == V_462 && F_326 ( V_26 ) >= V_695 )
F_327 ( V_26 ) ;
F_21 ( & V_26 -> V_27 ) ;
V_690 = V_26 -> V_102 ;
if ( V_690 >= V_696 )
F_206 ( V_26 , F_69 ( V_105 , V_696 ) , V_196 ) ;
F_22 ( & V_26 -> V_27 ) ;
if ( V_690 == V_150 )
...
F_285 ( V_10 -> V_26 ) ;
F_261 ( V_10 ) ;
F_209 ( V_10 -> V_295 , ! F_66 ( V_699 , & V_10 -> V_63 ) ) ;
...
V_718 . V_63 = 0 ;
V_92 = F_333 ( V_26 -> V_217 , ( V_720 * ) V_715 , V_714 ) ;
if ( V_92 ) {
...
F_335 ( & V_710 , 1 ) ;
F_336 ( & V_710 , V_713 , V_171 . V_58 ) ;
V_92 = F_337 ( & V_718 , & V_710 , V_710 . V_234 , V_711 ) ;
if ( V_92 ) {
...
F_336 ( & V_710 , V_707 , V_708 ) ;
V_92 = F_337 ( & V_718 , & V_710 , V_710 . V_234 , V_712 ) ;
if ( V_92 ) {
F_65 ( V_26 , L_176 , V_92 ) ;
V_92 = - 1 ;
goto V_57;
...
return F_348 ( V_10 , V_298 -> V_64 , V_46 ,
& V_10 -> V_294 , V_55 ,
V_117 , false ) ;
}
...
V_70 = F_348 ( V_10 , V_298 -> V_64 , V_46 ,
& V_10 -> V_294 , V_55 ,
V_380 , true ) ;
if ( V_70 ) {
...
struct V_9 * V_10 ;
int V_189 ;
F_354 ( V_26 , V_298 -> V_299 , F_123 ( V_298 -> V_744 ) ) ;
F_27 () ;
F_115 (&tconn->volumes, mdev, vnr) {
if ( V_10 -> V_345 . V_105 == V_633 &&
F_30 ( & V_10 -> V_185 ) == 0 &&
! F_345 ( V_745 , & V_10 -> V_63 ) ) {
...
F_358 ( V_10 , V_10 -> V_426 ) ;
if ( V_10 -> V_426 == 0 ) {
V_22 = F_148 ( sizeof( * V_22 ) , V_211 ) ;
if ( V_22 ) {
V_22 -> V_73 = V_749 ;
V_22 -> V_10 = V_10 ;
F_319 ( & V_10 -> V_26 -> V_689 , V_22 ) ;
} else {
F_43 ( V_38 , L_186 ) ;
F_282 ( V_10 ) ;
F_281 ( V_10 ) ;
...
if ( V_171 . V_168 >= F_316 ( V_761 ) || ! V_168 -> V_682 ) {
F_65 ( V_26 , L_192 ,
F_251 ( V_171 . V_168 ) , V_171 . V_168 ) ;
goto V_549;
}
