...
struct V_97 * V_98 ;
unsigned long V_99 ;
unsigned long V_100 = V_2 -> V_101 . V_9 ;
struct V_3 V_102 ;
F_13 () ;
V_98 = F_14 ( V_92 , V_93 , V_94 ) ;
if ( F_15 ( V_98 ) ) {
F_16 () ;
return F_17 ( V_98 ) ;
}
V_102 . V_9 = F_18 ( V_98 ) ;
V_102 . V_85 = F_19 ( V_98 ) ;
F_16 () ;
V_99 = V_102 . V_9 ;
if ( V_100 == V_99 )
return 0 ;
F_20 ( V_92 , L_1 , V_99 , V_102 . V_85 ) ;
F_21 ( & V_2 -> V_103 ) ;
if ( V_2 -> V_104 )
goto V_105;
if ( V_100 < V_99 )
...
{
T_3 V_106 = V_2 -> V_71 [ 0 ] . V_79 [ 0 ] ;
T_3 V_107 = V_2 -> V_71 [ 1 ] . V_79 [ 0 ] ;
V_106 *= V_2 -> V_71 [ 1 ] . V_76 ;
V_107 *= V_2 -> V_71 [ 0 ] . V_76 ;
...
F_6 ( V_2 ) ;
V_110 = F_23 ( V_2 ) ;
V_109 -> V_115 = V_2 -> V_101 . V_9 ;
if ( V_110 )
V_112 = V_116 ;
else
V_112 = V_117 ;
V_114 = F_3 ( V_112 + 0x04 ) ;
V_113 = F_3 ( V_112 + 0x38 ) ;
switch ( ( V_114 >> 8 ) & 0xf ) {
case 0x4 :
V_111 = ( ( V_113 >> 16 ) & 0xf ) * 2 ;
break;
case 0x5 :
case 0x6 :
V_111 = ( ( V_113 >> 8 ) & 0xf ) + ( ( V_113 >> 0 ) & 0xf ) ;
break;
default:
F_26 ( L_2 , V_118 ,
( V_114 >> 8 ) & 0xf ) ;
...
V_109 -> V_119 = V_2 -> V_71 [ V_110 ] . V_79 [ 0 ] / 2 * ( V_111 + 2 ) ;
V_109 -> V_119 *= 100 / V_120 ;
V_109 -> V_121 = V_2 -> V_71 [ V_110 ] . V_76 ;
if ( V_2 -> V_71 [ V_110 ] . V_77 ||
V_2 -> V_71 [ V_110 ] . V_80 [ 0 ] )
return - V_122 ;
return 0 ;
}
...
for ( V_69 = V_7 ; V_69 < V_8 ; V_69 ++ )
V_10 [ V_69 ] . V_85 = V_146 [ V_124 ] [ V_69 ] ;
for ( V_69 = V_7 ; V_69 < V_8 ; V_69 ++ ) {
...
for ( V_69 = 0 ; V_69 < V_28 ; V_69 ++ ) {
V_147 = F_33 ( V_2 -> V_92 , V_29 [ V_69 ] . V_11 ,
V_29 [ V_69 ] . V_85 ) ;
if ( V_147 ) {
F_34 ( V_2 -> V_92 , L_7 ) ;
return V_147 ;
...
static int F_36 ( struct V_153 * V_154 ,
unsigned long V_73 , void * V_155 )
{
struct V_1 * V_2 = F_11 ( V_154 , struct V_1 ,
V_156 ) ;
struct V_97 * V_98 ;
struct V_3 V_102 ;
...
int V_84 = 0 ;
V_2 = F_39 ( & V_96 -> V_92 , sizeof( struct V_1 ) , V_165 ) ;
if ( V_2 == NULL ) {
F_34 ( V_92 , L_9 ) ;
return - V_166 ;
}
V_2 -> type = V_96 -> V_167 -> V_168 ;
V_2 -> V_71 [ 0 ] . V_72 = V_117 ;
V_2 -> V_71 [ 1 ] . V_72 = V_116 ;
V_2 -> V_156 . V_169 = F_36 ;
V_2 -> V_92 = V_92 ;
F_40 ( & V_2 -> V_103 ) ;
switch ( V_2 -> type ) {
case V_86 :
...
V_2 -> V_101 . V_9 = F_18 ( V_98 ) ;
V_2 -> V_101 . V_85 = F_19 ( V_98 ) ;
F_16 () ;
F_42 ( V_96 , V_2 ) ;
F_5 ( V_2 ) ;
V_2 -> V_123 = F_43 ( V_92 , & V_170 ,
L_16 , NULL ) ;
if ( F_15 ( V_2 -> V_123 ) )
return F_17 ( V_2 -> V_123 ) ;
F_44 ( V_92 , V_2 -> V_123 ) ;
V_84 = F_45 ( & V_2 -> V_156 ) ;
if ( V_84 ) {
F_34 ( V_92 , L_17 ) ;
