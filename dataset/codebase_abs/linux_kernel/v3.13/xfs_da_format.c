...
{
return F_66 ( V_33 ) + V_69 / F_63 ( V_33 ) ;
}
static int
...
{
return ( V_33 -> V_34 - sizeof( struct V_70 ) ) /
sizeof( V_67 ) ;
}
static T_3 *
F_69 ( struct V_68 * free )
{
return ( T_3 * ) ( ( char * ) free + sizeof( struct V_70 ) ) ;
}
static T_4
F_70 ( struct V_32 * V_33 , T_4 V_69 )
{
return F_66 ( V_33 ) + V_69 / F_68 ( V_33 ) ;
}
static int
...
struct V_71 * V_16 )
{
ASSERT ( V_16 -> V_47 == V_75 ) ;
V_20 -> V_2 . V_47 = F_53 ( V_16 -> V_47 ) ;
V_20 -> V_2 . V_72 = F_53 ( V_16 -> V_72 ) ;
...
struct V_68 * V_16 )
{
struct V_70 * V_51 = (struct V_70 * ) V_16 ;
V_20 -> V_47 = F_50 ( V_51 -> V_2 . V_47 ) ;
V_20 -> V_72 = F_50 ( V_51 -> V_72 ) ;
...
struct V_71 * V_16 )
{
struct V_70 * V_51 = (struct V_70 * ) V_20 ;
ASSERT ( V_16 -> V_47 == V_76 ) ;
V_51 -> V_2 . V_47 = F_53 ( V_16 -> V_47 ) ;
V_51 -> V_72 = F_53 ( V_16 -> V_72 ) ;
