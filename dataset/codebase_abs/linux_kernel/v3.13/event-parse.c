...
static enum V_54
F_62 ( struct V_49 * V_50 , struct V_7 * V_63 , char * * V_97 )
{
enum V_54 type ;
char * V_110 ;
type = F_42 ( & V_110 ) ;
* V_97 = V_110 ;
return F_63 ( V_50 , V_63 , V_97 , type ) ;
}
static enum V_54
F_64 ( struct V_49 * V_50 , struct V_7 * V_63 , char * * V_97 )
{
enum V_54 type ;
type = F_62 ( V_50 , V_63 , V_97 ) ;
while ( type == V_96 ) {
type = F_65 ( V_50 , V_63 , V_97 ) ;
}
return type ;
}
static enum V_54
F_66 ( struct V_49 * V_50 , struct V_7 * V_144 , char * * V_97 )
{
...
static int F_69 ( struct V_7 * V_63 )
{
if ( ! V_63 -> V_86 . V_87 || V_63 -> V_86 . V_87 -> type == V_90 )
V_63 -> V_86 . V_146 = 0 ;
else
V_63 -> V_86 . V_146 = F_68 ( V_63 -> V_86 . V_86 ) ;
...
return F_65 ( V_50 , V_63 , V_97 ) ;
return F_65 ( V_50 , V_88 , V_97 ) ;
}
return type ;
V_147:
F_47 ( L_46 , V_126 ) ;
...
static enum V_54
F_70 ( struct V_49 * V_50 V_150 , struct V_7 * V_63 ,
char * * V_97 )
{
enum V_54 type ;
char * V_68 ;
...
V_63 -> V_68 . V_69 = V_68 ;
if ( V_152 ) {
V_63 -> V_68 . V_68 = F_71 ( V_50 , V_63 -> V_68 . V_69 ) ;
...
F_72 ( unsigned long long V_156 , const char * type , int V_157 )
{
int V_158 = 0 ;
char * V_159 ;
int V_130 ;
...
static unsigned long long
F_73 ( unsigned long long V_156 , struct V_7 * V_63 , int V_157 )
{
if ( V_63 -> type != V_78 ) {
F_47 ( L_78 ) ;
return 0 ;
}
return F_72 ( V_156 , V_63 -> V_79 . type , V_157 ) ;
}
static int F_74 ( struct V_7 * V_63 , long long * V_156 )
{
long long V_87 , V_88 ;
int V_114 = 1 ;
switch ( V_63 -> type ) {
...
break;
case V_78 :
V_114 = F_74 ( V_63 -> V_79 . V_17 , V_156 ) ;
if ( ! V_114 )
break;
* V_156 = F_73 ( * V_156 , V_63 , 0 ) ;
break;
case V_85 :
switch ( V_63 -> V_86 . V_86 [ 0 ] ) {
case '|' :
V_114 = F_74 ( V_63 -> V_86 . V_87 , & V_87 ) ;
if ( ! V_114 )
break;
V_114 = F_74 ( V_63 -> V_86 . V_88 , & V_88 ) ;
if ( ! V_114 )
break;
if ( V_63 -> V_86 . V_86 [ 1 ] )
* V_156 = V_87 || V_88 ;
...
static char * F_75 ( struct V_7 * V_63 )
{
long long V_156 ;
static char V_1 [ 20 ] ;
switch ( V_63 -> type ) {
...
static enum V_54
F_76 ( struct V_49 * V_50 , struct V_59 * * V_160 , char * * V_97 )
{
enum V_54 type ;
...
static enum V_54
F_77 ( struct V_49 * V_50 , struct V_7 * V_63 , char * * V_97 )
{
struct V_7 * V_68 ;
enum V_54 type ;
char * V_110 ;
...
if ( F_48 ( type , V_110 , V_58 , L_82 ) )
goto V_38;
type = F_76 ( V_50 , & V_63 -> V_71 . V_71 , & V_110 ) ;
...
goto V_161;
V_63 -> V_74 . V_68 = V_68 ;
type = F_76 ( V_50 , & V_63 -> V_74 . V_75 , & V_110 ) ;
if ( F_48 ( type , V_110 , V_58 , L_69 ) )
goto V_38;
F_41 ( V_110 ) ;
type = F_45 ( V_97 ) ;
...
static enum V_54
F_82 ( struct V_49 * V_50 , struct V_7 * V_63 , char * * V_97 )
{
struct V_7 * V_163 ;
enum V_54 type ;
char * V_110 ;
...
type = F_63 ( V_50 , V_163 , & V_110 , type ) ;
}
* V_97 = V_110 ;
return type ;
V_38:
...
static enum V_54
F_83 ( struct V_49 * V_50 V_150 , struct V_7 * V_63 ,
char * * V_97 )
{
enum V_54 type ;
char * V_110 ;
...
static struct V_164 *
F_84 ( struct V_14 * V_14 , char * V_165 )
{
struct V_164 * V_35 ;
if ( ! V_14 )
return NULL ;
...
static void F_85 ( struct V_14 * V_14 , char * V_165 )
{
struct V_164 * V_35 ;
struct V_164 * * V_22 ;
V_22 = & V_14 -> V_166 ;
...
static enum V_54
F_87 ( struct V_49 * V_50 , struct V_164 * V_35 ,
...
for ( V_19 = 0 ; V_19 < V_35 -> V_169 ; V_19 ++ ) {
V_64 = F_6 () ;
if ( ! V_64 ) {
F_47 ( L_46 , V_126 ) ;
return V_57 ;
}
type = F_62 ( V_50 , V_64 , & V_110 ) ;
if ( V_19 < ( V_35 -> V_169 - 1 ) )
V_168 = L_82 ;
else
V_168 = L_69 ;
if ( F_48 ( type , V_110 , V_58 , V_168 ) ) {
F_32 ( V_64 ) ;
F_41 ( V_110 ) ;
return V_57 ;
}
...
static enum V_54
F_88 ( struct V_49 * V_50 , struct V_7 * V_63 ,
char * V_110 , char * * V_97 )
{
struct V_164 * V_35 ;
if ( strcmp ( V_110 , L_86 ) == 0 ) {
F_41 ( V_110 ) ;
V_152 = 1 ;
return F_77 ( V_50 , V_63 , V_97 ) ;
}
if ( strcmp ( V_110 , L_87 ) == 0 ) {
F_41 ( V_110 ) ;
V_154 = 1 ;
...
F_41 ( V_110 ) ;
return F_83 ( V_50 , V_63 , V_97 ) ;
}
if ( strcmp ( V_110 , L_90 ) == 0 ) {
F_41 ( V_110 ) ;
return F_80 ( V_50 , V_63 , V_97 ) ;
}
V_35 = F_84 ( V_50 -> V_14 , V_110 ) ;
if ( V_35 ) {
F_41 ( V_110 ) ;
return F_87 ( V_50 , V_35 , V_63 , V_97 ) ;
}
F_47 ( L_91 , V_110 ) ;
F_41 ( V_110 ) ;
return V_57 ;
...
static enum V_54
F_63 ( struct V_49 * V_50 , struct V_7 * V_63 ,
...
F_41 ( V_110 ) ;
V_110 = NULL ;
type = F_88 ( V_50 , V_63 , V_66 , & V_110 ) ;
break;
}
while ( type == V_55 ) {
char * V_149 ;
...
static int F_89 ( struct V_49 * V_50 , struct V_7 * * V_160 )
{
enum V_54 type = V_57 ;
struct V_7 * V_63 ;
char * V_110 ;
...
if ( type == V_94 ) {
char * V_171 ;
if ( F_39 ( & V_171 , L_96 , V_50 -> V_170 . V_140 , V_110 ) < 0 )
goto V_115;
F_41 ( V_110 ) ;
...
goto V_115;
F_41 ( V_110 ) ;
V_114 = F_89 ( V_50 , & V_50 -> V_170 . args ) ;
if ( V_114 < 0 )
return - 1 ;
return V_114 ;
V_115:
...
struct V_116 *
F_91 ( struct V_49 * V_50 , const char * V_69 )
{
struct V_116 * V_140 ;
...
struct V_116 *
F_81 ( struct V_49 * V_50 , const char * V_69 )
{
struct V_116 * V_140 ;
...
struct V_116 *
F_71 ( struct V_49 * V_50 , const char * V_69 )
{
struct V_116 * V_140 ;
V_140 = F_91 ( V_50 , V_69 ) ;
if ( V_140 )
return V_140 ;
return F_81 ( V_50 , V_69 ) ;
}
unsigned long long F_92 ( struct V_14 * V_14 ,
...
int F_96 ( struct V_116 * V_68 , const void * V_173 ,
...
static int F_98 ( struct V_14 * V_14 , void * V_173 ,
int * V_2 , int * V_136 , const char * V_69 )
{
int V_114 ;
if ( ! * V_2 ) {
V_114 = F_97 ( V_14 , V_69 , V_136 , V_2 ) ;
if ( V_114 < 0 )
return V_114 ;
}
return F_92 ( V_14 , V_173 + * V_136 , * V_2 ) ;
}
static int F_99 ( struct V_14 * V_14 , void * V_173 )
{
return F_98 ( V_14 , V_173 ,
...
struct V_49 * F_105 ( struct V_14 * V_14 , int V_53 )
{
struct V_49 * * V_183 ;
struct V_49 V_23 ;
...
static unsigned long long
F_107 ( void * V_173 , int V_2 , struct V_49 * V_50 , struct V_7 * V_63 )
{
...
return 0 ;
case V_65 :
return F_108 ( V_63 -> V_66 . V_66 , NULL , 0 ) ;
case V_67 :
if ( ! V_63 -> V_68 . V_68 ) {
V_63 -> V_68 . V_68 = F_71 ( V_50 , V_63 -> V_68 . V_69 ) ;
if ( ! V_63 -> V_68 . V_68 )
...
V_156 = F_92 ( V_14 , V_173 + V_63 -> V_68 . V_68 -> V_136 ,
V_63 -> V_68 . V_68 -> V_2 ) ;
break;
case V_70 :
case V_73 :
...
break;
case V_78 :
V_156 = F_107 ( V_173 , V_2 , V_50 , V_63 -> V_79 . V_17 ) ;
return F_73 ( V_156 , V_63 , 0 ) ;
case V_80 :
case V_81 :
return 0 ;
case V_89 : {
struct V_192 V_193 ;
F_109 ( & V_193 ) ;
V_156 = F_110 ( & V_193 , V_173 , V_2 , V_50 , V_63 ) ;
F_111 ( & V_193 ) ;
return V_156 ;
}
case V_85 :
if ( strcmp ( V_63 -> V_86 . V_86 , L_38 ) == 0 ) {
V_88 = F_107 ( V_173 , V_2 , V_50 , V_63 -> V_86 . V_88 ) ;
...
V_173 + V_136 , V_190 ) ;
if ( V_188 )
V_156 = F_73 ( V_156 , V_188 , 1 ) ;
break;
} else if ( strcmp ( V_63 -> V_86 . V_86 , L_60 ) == 0 ) {
V_87 = F_107 ( V_173 , V_2 , V_50 , V_63 -> V_86 . V_87 ) ;
V_63 = V_63 -> V_86 . V_88 ;
if ( V_87 )
V_156 = F_107 ( V_173 , V_2 , V_50 , V_63 -> V_86 . V_87 ) ;
else
V_156 = F_107 ( V_173 , V_2 , V_50 , V_63 -> V_86 . V_88 ) ;
break;
}
V_194:
V_87 = F_107 ( V_173 , V_2 , V_50 , V_63 -> V_86 . V_87 ) ;
...
return V_156 ;
V_195:
F_47 ( L_104 , V_126 , V_63 -> V_86 . V_86 ) ;
return 0 ;
V_191:
F_47 ( L_105 , V_126 , V_63 -> V_68 . V_69 ) ;
return 0 ;
}
static unsigned long long F_112 ( const char * V_196 )
{
int V_19 ;
if ( isdigit ( V_196 [ 0 ] ) )
return F_108 ( V_196 , NULL , 0 ) ;
for ( V_19 = 0 ; V_19 < ( int ) ( sizeof( V_71 ) / sizeof( V_71 [ 0 ] ) ) ; V_19 ++ )
if ( strcmp ( V_71 [ V_19 ] . V_69 , V_196 ) == 0 )
return V_71 [ V_19 ] . V_61 ;
return 0 ;
}
static void F_113 ( struct V_192 * V_193 , const char * V_140 ,
int V_197 , const char * V_62 )
{
if ( V_197 >= 0 )
F_114 ( V_193 , V_140 , V_197 , V_62 ) ;
else
F_114 ( V_193 , V_140 , V_62 ) ;
}
static void F_115 ( struct V_192 * V_193 , void * V_173 , int V_2 ,
...
return;
case V_65 :
F_113 ( V_193 , V_140 , V_197 , V_63 -> V_66 . V_66 ) ;
return;
case V_67 :
V_68 = V_63 -> V_68 . V_68 ;
if ( ! V_68 ) {
V_68 = F_71 ( V_50 , V_63 -> V_68 . V_69 ) ;
if ( ! V_68 ) {
V_62 = V_63 -> V_68 . V_69 ;
goto V_191;
}
...
V_46 = F_25 ( V_14 , V_31 ) ;
if ( V_46 )
F_116 ( V_193 , V_46 -> V_46 ) ;
else
F_114 ( V_193 , L_106 , V_31 ) ;
break;
}
V_62 = malloc ( V_130 + 1 ) ;
if ( ! V_62 ) {
...
V_62 [ V_130 ] = 0 ;
F_113 ( V_193 , V_140 , V_197 , V_62 ) ;
free ( V_62 ) ;
break;
case V_70 :
V_156 = F_107 ( V_173 , V_2 , V_50 , V_63 -> V_71 . V_68 ) ;
V_199 = 0 ;
for ( V_196 = V_63 -> V_71 . V_71 ; V_196 ; V_196 = V_196 -> V_22 ) {
V_198 = F_112 ( V_196 -> V_61 ) ;
if ( ! V_156 && ! V_198 ) {
F_113 ( V_193 , V_140 , V_197 , V_196 -> V_62 ) ;
break;
}
if ( V_198 && ( V_156 & V_198 ) == V_198 ) {
if ( V_199 && V_63 -> V_71 . V_72 )
F_116 ( V_193 , V_63 -> V_71 . V_72 ) ;
F_113 ( V_193 , V_140 , V_197 , V_196 -> V_62 ) ;
V_199 = 1 ;
V_156 &= ~ V_198 ;
}
...
break;
case V_73 :
V_156 = F_107 ( V_173 , V_2 , V_50 , V_63 -> V_74 . V_68 ) ;
...
V_130 = F_107 ( V_173 , V_2 , V_50 , V_63 -> V_77 . V_2 ) ;
for ( V_19 = 0 ; V_19 < V_130 ; V_19 ++ ) {
if ( V_19 )
F_117 ( V_193 , ' ' ) ;
F_114 ( V_193 , L_107 , V_77 [ V_19 ] ) ;
}
break;
case V_78 :
break;
...
struct V_116 * V_201 ;
V_201 = F_71 ( V_50 , V_63 -> string . string ) ;
V_63 -> string . V_136 = V_201 -> V_136 ;
}
V_200 = F_94 ( V_14 , V_173 + V_63 -> string . V_136 ) ;
V_200 &= 0xffff ;
F_113 ( V_193 , V_140 , V_197 , ( ( char * ) V_173 ) + V_200 ) ;
break;
}
case V_81 :
F_113 ( V_193 , V_140 , V_197 , V_63 -> string . string ) ;
break;
case V_85 :
if ( V_63 -> V_86 . V_86 [ 0 ] != '?' )
return;
...
break;
case V_89 :
F_110 ( V_193 , V_173 , V_2 , V_50 , V_63 ) ;
break;
default:
break;
}
...
static unsigned long long
F_110 ( struct V_192 * V_193 , void * V_173 , int V_2 ,
...
V_204 = V_202 -> V_207 ;
V_114 = V_208 ;
args = malloc ( sizeof( * args ) * V_202 -> V_169 ) ;
if ( ! args )
goto V_105;
for ( V_19 = 0 ; V_19 < V_202 -> V_169 ; V_19 ++ ) {
switch ( V_204 -> type ) {
case V_209 :
case V_210 :
case V_211 :
args [ V_19 ] = F_107 ( V_173 , V_2 , V_50 , V_64 ) ;
break;
case V_212 :
F_109 ( & V_62 ) ;
F_115 ( & V_62 , V_173 , V_2 , V_50 , L_108 , - 1 , V_64 ) ;
F_118 ( & V_62 ) ;
string = malloc ( sizeof( * string ) ) ;
if ( ! string ) {
F_47 ( L_109 , V_126 , __LINE__ ) ;
goto V_38;
}
string -> V_22 = V_206 ;
...
static void F_119 ( struct V_7 * args )
{
struct V_7 * V_22 ;
while ( args ) {
V_22 = args -> V_22 ;
...
static struct V_7 * F_120 ( char * V_47 , void * V_173 , int V_2 , struct V_49 * V_50 )
{
struct V_14 * V_14 = V_50 -> V_14 ;
...
V_215 = V_14 -> V_220 ;
if ( ! V_68 ) {
V_68 = F_81 ( V_50 , L_111 ) ;
if ( ! V_68 ) {
F_47 ( L_112 ) ;
return NULL ;
}
V_215 = F_81 ( V_50 , L_113 ) ;
if ( ! V_215 ) {
F_47 ( L_114 ) ;
return NULL ;
}
...
V_216 = F_92 ( V_14 , V_173 + V_215 -> V_136 , V_215 -> V_2 ) ;
args = F_6 () ;
if ( ! args ) {
F_47 ( L_115 , V_126 , __LINE__ ) ;
return NULL ;
}
V_63 = args ;
V_63 -> V_22 = NULL ;
...
static char *
F_121 ( void * V_173 , int V_2 V_150 ,
struct V_49 * V_50 )
{
struct V_14 * V_14 = V_50 -> V_14 ;
unsigned long long V_31 ;
...
V_31 = F_92 ( V_14 , V_173 + V_68 -> V_136 , V_68 -> V_2 ) ;
V_46 = F_25 ( V_14 , V_31 ) ;
if ( ! V_46 ) {
if ( F_39 ( & V_140 , L_117 , V_31 ) < 0 )
return NULL ;
return V_140 ;
}
if ( F_39 ( & V_140 , L_118 , L_119 , V_46 -> V_46 ) < 0 )
return NULL ;
return V_140 ;
}
static void F_122 ( struct V_192 * V_193 , int V_224 , void * V_173 , int V_2 ,
struct V_49 * V_50 , struct V_7 * V_63 )
{
unsigned char * V_1 ;
const char * V_47 = L_120 ;
if ( V_63 -> type == V_89 ) {
F_110 ( V_193 , V_173 , V_2 , V_50 , V_63 ) ;
return;
}
...
F_114 ( V_193 , V_47 , V_1 [ 0 ] , V_1 [ 1 ] , V_1 [ 2 ] , V_1 [ 3 ] , V_1 [ 4 ] , V_1 [ 5 ] ) ;
}
static int F_123 ( char * V_48 , unsigned int V_130 )
{
unsigned int V_19 ;
...
static void F_124 ( struct V_192 * V_193 , void * V_173 ,
int V_2 V_150 ,
struct V_49 * V_50 )
{
struct V_116 * V_68 ;
...
while ( V_68 ) {
F_114 ( V_193 , L_124 , V_68 -> V_69 ) ;
if ( V_68 -> V_71 & V_117 ) {
V_136 = V_68 -> V_136 ;
V_130 = V_68 -> V_2 ;
if ( V_68 -> V_71 & V_133 ) {
V_156 = F_92 ( V_50 -> V_14 , V_173 + V_136 , V_130 ) ;
V_136 = V_156 ;
V_130 = V_136 >> 16 ;
V_136 &= 0xffff ;
}
if ( V_68 -> V_71 & V_132 &&
F_123 ( V_173 + V_136 , V_130 ) ) {
F_114 ( V_193 , L_108 , ( char * ) V_173 + V_136 ) ;
} else {
F_116 ( V_193 , L_125 ) ;
for ( V_19 = 0 ; V_19 < V_130 ; V_19 ++ ) {
if ( V_19 )
...
V_156 = F_92 ( V_50 -> V_14 , V_173 + V_68 -> V_136 ,
V_68 -> V_2 ) ;
if ( V_68 -> V_71 & V_124 ) {
F_114 ( V_193 , L_127 , V_156 ) ;
} else if ( V_68 -> V_71 & V_137 ) {
switch ( V_68 -> V_2 ) {
case 4 :
if ( V_68 -> V_71 & V_134 )
F_114 ( V_193 , L_128 , ( int ) V_156 ) ;
else
F_114 ( V_193 , L_129 , ( int ) V_156 ) ;
break;
case 2 :
F_114 ( V_193 , L_130 , ( short ) V_156 ) ;
break;
case 1 :
F_114 ( V_193 , L_131 , ( char ) V_156 ) ;
break;
default:
F_114 ( V_193 , L_80 , V_156 ) ;
}
} else {
if ( V_68 -> V_71 & V_134 )
F_114 ( V_193 , L_127 , V_156 ) ;
else
F_114 ( V_193 , L_132 , V_156 ) ;
}
}
V_68 = V_68 -> V_22 ;
}
}
static void F_125 ( struct V_192 * V_193 , void * V_173 , int V_2 , struct V_49 * V_50 )
{
struct V_14 * V_14 = V_50 -> V_14 ;
...
if ( V_50 -> V_71 & V_148 ) {
F_114 ( V_193 , L_133 ) ;
F_124 ( V_193 , V_173 , V_2 , V_50 ) ;
return;
}
if ( V_50 -> V_71 & V_229 ) {
V_226 = F_121 ( V_173 , V_2 , V_50 ) ;
args = F_120 ( V_226 , V_173 , V_2 , V_50 ) ;
V_63 = args ;
V_172 = V_226 ;
}
for (; * V_172 ; V_172 ++ ) {
...
V_197 = F_107 ( V_173 , V_2 , V_50 , V_63 ) ;
V_228 = 1 ;
V_63 = V_63 -> V_22 ;
goto V_230;
case '.' :
...
F_122 ( V_193 , * ( V_172 + 1 ) , V_173 , V_2 , V_50 , V_63 ) ;
V_172 ++ ;
V_63 = V_63 -> V_22 ;
break;
}
...
V_140 [ V_130 ] = 0 ;
V_156 = F_107 ( V_173 , V_2 , V_50 , V_63 ) ;
V_63 = V_63 -> V_22 ;
if ( V_227 ) {
V_35 = F_18 ( V_14 , V_156 ) ;
if ( V_35 ) {
F_116 ( V_193 , V_35 -> V_35 ) ;
if ( V_227 == 'F' )
F_114 ( V_193 ,
L_136 ,
V_156 - V_35 -> V_31 ) ;
...
else if ( strcmp ( V_140 , L_137 ) == 0 )
strcpy ( V_140 , L_127 ) ;
}
switch ( V_221 ) {
case - 2 :
if ( V_228 )
F_114 ( V_193 , V_140 , V_197 , ( char ) V_156 ) ;
else
F_114 ( V_193 , V_140 , ( char ) V_156 ) ;
break;
case - 1 :
if ( V_228 )
F_114 ( V_193 , V_140 , V_197 , ( short ) V_156 ) ;
else
F_114 ( V_193 , V_140 , ( short ) V_156 ) ;
break;
case 0 :
if ( V_228 )
F_114 ( V_193 , V_140 , V_197 , ( int ) V_156 ) ;
else
F_114 ( V_193 , V_140 , ( int ) V_156 ) ;
break;
case 1 :
if ( V_228 )
F_114 ( V_193 , V_140 , V_197 , ( long ) V_156 ) ;
else
F_114 ( V_193 , V_140 , ( long ) V_156 ) ;
break;
case 2 :
if ( V_228 )
F_114 ( V_193 , V_140 , V_197 ,
( long long ) V_156 ) ;
else
F_114 ( V_193 , V_140 , ( long long ) V_156 ) ;
break;
default:
F_47 ( L_138 , V_221 ) ;
V_50 -> V_71 |= V_148 ;
...
V_238 = F_102 ( V_14 , V_173 ) ;
V_239 = F_101 ( V_14 , V_173 ) ;
if ( V_236 )
V_240 = F_103 ( V_14 , V_173 ) ;
else if ( V_234 ) {
V_240 = F_103 ( V_14 , V_173 ) ;
if ( V_240 < 0 )
V_234 = 0 ;
...
F_114 ( V_193 , L_129 , V_241 ) ;
}
if ( V_236 ) {
if ( V_240 < 0 )
F_117 ( V_193 , '.' ) ;
else
F_114 ( V_193 , L_129 , V_240 ) ;
}
F_118 ( V_193 ) ;
}
int F_127 ( struct V_14 * V_14 , struct V_232 * V_249 )
{
return F_99 ( V_14 , V_249 -> V_173 ) ;
}
struct V_49 * F_128 ( struct V_14 * V_14 , int type )
{
return F_105 ( V_14 , type ) ;
}
int F_129 ( struct V_14 * V_14 , struct V_232 * V_249 )
{
return F_100 ( V_14 , V_249 -> V_173 ) ;
}
const char * F_130 ( struct V_14 * V_14 , int V_13 )
{
const char * V_21 ;
V_21 = F_9 ( V_14 , V_13 ) ;
return V_21 ;
}
void F_131 ( struct V_192 * V_193 , struct V_49 * V_50 ,
struct V_232 * V_233 )
{
int V_250 = 1 ;
if ( V_50 -> V_14 -> V_251 || ( V_50 -> V_71 & V_252 ) )
F_124 ( V_193 , V_233 -> V_173 , V_233 -> V_2 , V_50 ) ;
else {
...
static bool F_132 ( char * V_27 , bool V_256 )
{
if ( ! V_256 )
return true ;
if ( ! strcmp ( V_27 , L_143 ) || ! strcmp ( V_27 , L_144 )
|| ! strcmp ( V_27 , L_145 ) || ! strcmp ( V_27 , L_146 ) )
return true ;
return false ;
}
void F_133 ( struct V_14 * V_14 , struct V_192 * V_193 ,
struct V_232 * V_233 , bool V_256 )
{
static const char * V_257 = L_147 ;
struct V_49 * V_50 ;
unsigned long V_258 ;
unsigned long V_259 ;
unsigned long V_260 ;
...
if ( V_233 -> V_2 < 0 ) {
F_47 ( L_148 , V_233 -> V_2 ) ;
return;
}
type = F_99 ( V_14 , V_173 ) ;
V_50 = F_105 ( V_14 , type ) ;
if ( ! V_50 ) {
F_47 ( L_149 , type ) ;
return;
}
V_13 = F_100 ( V_14 , V_173 ) ;
V_21 = F_9 ( V_14 , V_13 ) ;
if ( V_14 -> V_264 ) {
F_114 ( V_193 , L_150 ,
V_21 , V_13 , V_233 -> V_265 ) ;
F_126 ( V_14 , V_193 , V_233 ) ;
} else
F_114 ( V_193 , L_151 , V_21 , V_13 , V_233 -> V_265 ) ;
if ( V_261 ) {
if ( V_14 -> V_71 & V_266 ) {
V_259 = V_260 ;
V_48 = 9 ;
...
if ( V_130 < 20 )
F_114 ( V_193 , L_154 , 20 - V_130 , V_257 ) ;
F_131 ( V_193 , V_50 , V_233 ) ;
}
...
static int F_134 ( const void * V_8 , const void * V_9 )
{
struct V_49 * const * V_268 = V_8 ;
struct V_49 * const * V_269 = V_9 ;
int V_270 ;
...
struct V_49 * * F_136 ( struct V_14 * V_14 , enum V_271 V_272 )
{
struct V_49 * * V_51 ;
int (* F_137)( const void * V_8 , const void * V_9 );
V_51 = V_14 -> V_273 ;
...
qsort ( V_51 , V_14 -> V_52 , sizeof( * V_51 ) , F_137 ) ;
V_14 -> V_127 = V_272 ;
return V_51 ;
}
static struct V_116 * *
F_138 ( const char * type , const char * V_69 ,
...
struct V_116 * * F_139 ( struct V_49 * V_50 )
{
return F_138 ( L_157 , V_50 -> V_69 ,
V_50 -> V_140 . V_142 ,
V_50 -> V_140 . V_141 ) ;
}
struct V_116 * * F_140 ( struct V_49 * V_50 )
{
return F_138 ( L_158 , V_50 -> V_69 ,
V_50 -> V_140 . V_143 ,
V_50 -> V_140 . V_119 ) ;
}
static void F_141 ( struct V_192 * V_193 , struct V_59 * V_68 )
{
F_114 ( V_193 , L_159 , V_68 -> V_61 , V_68 -> V_62 ) ;
if ( V_68 -> V_22 ) {
F_116 ( V_193 , L_126 ) ;
F_141 ( V_193 , V_68 -> V_22 ) ;
}
}
static void F_142 ( struct V_7 * args )
{
int V_277 = 1 ;
struct V_192 V_193 ;
switch ( args -> type ) {
...
break;
case V_65 :
printf ( L_108 , args -> V_66 . V_66 ) ;
break;
case V_67 :
printf ( L_161 , args -> V_68 . V_69 ) ;
break;
case V_70 :
printf ( L_162 ) ;
F_142 ( args -> V_71 . V_68 ) ;
printf ( L_163 , args -> V_71 . V_72 ) ;
F_109 ( & V_193 ) ;
F_141 ( & V_193 , args -> V_71 . V_71 ) ;
F_143 ( & V_193 ) ;
F_111 ( & V_193 ) ;
printf ( L_69 ) ;
break;
case V_73 :
printf ( L_164 ) ;
F_142 ( args -> V_74 . V_68 ) ;
printf ( L_126 ) ;
F_109 ( & V_193 ) ;
F_141 ( & V_193 , args -> V_74 . V_75 ) ;
F_143 ( & V_193 ) ;
F_111 ( & V_193 ) ;
printf ( L_69 ) ;
break;
...
case V_80 :
case V_81 :
printf ( L_166 , args -> string . string ) ;
break;
case V_78 :
printf ( L_167 , args -> V_79 . type ) ;
F_142 ( args -> V_79 . V_17 ) ;
break;
case V_85 :
...
if ( V_277 )
printf ( L_84 ) ;
F_142 ( args -> V_86 . V_87 ) ;
printf ( L_168 , args -> V_86 . V_86 ) ;
F_142 ( args -> V_86 . V_88 ) ;
if ( V_277 )
printf ( L_69 ) ;
break;
default:
...
static void F_144 ( const char * V_68 ,
...
int F_145 ( struct V_14 * V_14 , char * V_1 , unsigned long V_2 ,
int V_139 )
{
int V_280 ;
if ( ! V_2 ) {
...
F_1 ( V_1 , V_2 ) ;
F_144 ( L_169 , & V_14 -> V_285 ,
& V_14 -> V_281 , 1 ) ;
F_144 ( L_170 , & V_14 -> V_286 ,
& V_14 -> V_282 , 1 ) ;
F_144 ( L_171 , & V_14 -> V_287 ,
& V_280 , 0 ) ;
F_144 ( L_172 , & V_14 -> V_283 ,
& V_14 -> V_288 , 1 ) ;
return 0 ;
}
...
static void F_147 ( struct V_291 * V_292 )
{
free ( ( void * ) V_292 -> V_289 ) ;
free ( ( void * ) V_292 -> V_290 ) ;
free ( V_292 ) ;
}
static int F_148 ( struct V_14 * V_14 , struct V_49 * V_50 )
{
struct V_291 * V_292 , * * V_22 ;
for ( V_22 = & V_14 -> V_293 ; * V_22 ;
V_22 = & ( * V_22 ) -> V_22 ) {
V_292 = * V_22 ;
if ( F_146 ( V_50 , V_292 -> V_53 ,
V_292 -> V_289 ,
V_292 -> V_290 ) )
break;
}
...
enum V_294 F_150 ( struct V_49 * * V_295 ,
...
if ( strcmp ( V_187 , L_174 ) == 0 ) {
V_50 -> V_71 |= V_123 ;
if ( strcmp ( V_50 -> V_69 , L_175 ) == 0 )
V_50 -> V_71 |= V_229 ;
}
V_50 -> V_53 = F_55 () ;
if ( V_50 -> V_53 < 0 ) {
...
enum V_294 F_151 ( struct V_49 * * V_295 , const char * V_1 ,
unsigned long V_2 , const char * V_187 )
{
return F_150 ( V_295 , NULL , V_1 , V_2 , V_187 ) ;
}
enum V_294 F_152 ( struct V_14 * V_14 , const char * V_1 ,
unsigned long V_2 , const char * V_187 )
{
struct V_49 * V_50 = NULL ;
int V_114 = F_150 ( & V_50 , V_14 , V_1 , V_2 , V_187 ) ;
if ( V_50 == NULL )
return V_114 ;
if ( F_29 ( V_14 , V_50 ) ) {
V_114 = V_296 ;
...
F_142 ( V_50 -> V_170 . args ) ;
return 0 ;
V_304:
F_154 ( V_50 ) ;
return V_114 ;
}
int F_155 ( struct V_14 * V_14 V_150 ,
enum V_294 V_305 , char * V_1 , T_1 V_306 )
{
int V_307 ;
const char * V_308 ;
if ( V_305 >= 0 ) {
V_308 = F_156 ( V_305 , V_1 , V_306 ) ;
if ( V_308 != V_1 ) {
T_1 V_130 = strlen ( V_308 ) ;
memcpy ( V_1 , V_308 , F_157 ( V_306 - 1 , V_130 ) ) ;
* ( V_1 + F_157 ( V_306 - 1 , V_130 ) ) = '\0' ;
}
return 0 ;
}
if ( V_305 <= V_309 ||
...
case V_303 :
case V_313 :
snprintf ( V_1 , V_306 , L_108 , V_308 ) ;
break;
default:
break;
}
...
int F_158 ( struct V_192 * V_193 , struct V_116 * V_68 ,
const char * V_69 , struct V_232 * V_233 ,
unsigned long long * V_156 , int V_314 )
{
if ( ! V_68 ) {
if ( V_314 )
F_114 ( V_193 , L_176 , V_69 ) ;
return - 1 ;
}
if ( F_96 ( V_68 , V_233 -> V_173 , V_156 ) ) {
if ( V_314 )
F_114 ( V_193 , L_177 , V_69 ) ;
return - 1 ;
}
return 0 ;
}
void * F_159 ( struct V_192 * V_193 , struct V_49 * V_50 ,
const char * V_69 , struct V_232 * V_233 ,
int * V_130 , int V_314 )
{
struct V_116 * V_68 ;
...
int F_160 ( struct V_192 * V_193 , struct V_49 * V_50 ,
const char * V_69 , struct V_232 * V_233 ,
unsigned long long * V_156 , int V_314 )
{
struct V_116 * V_68 ;
...
return - 1 ;
V_68 = F_81 ( V_50 , V_69 ) ;
return F_158 ( V_193 , V_68 , V_69 , V_233 , V_156 , V_314 ) ;
}
int F_161 ( struct V_192 * V_193 , struct V_49 * V_50 ,
const char * V_69 , struct V_232 * V_233 ,
unsigned long long * V_156 , int V_314 )
{
struct V_116 * V_68 ;
...
int F_163 ( struct V_192 * V_193 , const char * V_47 ,
struct V_49 * V_50 , const char * V_69 ,
struct V_232 * V_233 , int V_314 )
{
struct V_116 * V_68 = F_81 ( V_50 , V_69 ) ;
unsigned long long V_156 ;
if ( ! V_68 )
goto V_316;
if ( F_96 ( V_68 , V_233 -> V_173 , & V_156 ) )
goto V_316;
return F_114 ( V_193 , V_47 , V_156 ) ;
V_316:
if ( V_314 )
F_114 ( V_193 , L_178 , V_69 ) ;
return - 1 ;
}
int F_164 ( struct V_192 * V_193 , const char * V_47 ,
struct V_49 * V_50 , const char * V_69 ,
struct V_232 * V_233 , int V_314 )
{
struct V_116 * V_68 = F_81 ( V_50 , V_69 ) ;
...
V_35 = F_18 ( V_14 , V_156 ) ;
if ( V_35 )
snprintf ( V_317 , 128 , L_179 , V_35 -> V_35 , V_35 -> V_31 - V_156 ) ;
else
sprintf ( V_317 , L_180 , V_156 ) ;
return F_114 ( V_193 , V_47 , V_317 ) ;
V_316:
if ( V_314 )
F_114 ( V_193 , L_178 , V_69 ) ;
return - 1 ;
}
static void F_86 ( struct V_164 * V_35 )
{
struct V_203 * V_207 ;
free ( V_35 -> V_69 ) ;
while ( V_35 -> V_207 ) {
...
int F_166 ( struct V_14 * V_14 , int V_53 ,
...
static void F_169 ( struct V_116 * V_68 )
{
struct V_116 * V_22 ;
while ( V_68 ) {
V_22 = V_68 -> V_22 ;
...
static void F_170 ( struct V_140 * V_140 )
{
F_169 ( V_140 -> V_141 ) ;
F_169 ( V_140 -> V_119 ) ;
}
...
F_119 ( V_50 -> V_170 . args ) ;
free ( V_50 ) ;
}
void F_171 ( struct V_14 * V_14 )
{
struct V_15 * V_16 , * V_326 ;
struct V_32 * V_33 , * V_327 ;
struct V_43 * V_44 , * V_328 ;
struct V_164 * V_329 ;
struct V_291 * V_292 ;
int V_19 ;
if ( ! V_14 )
