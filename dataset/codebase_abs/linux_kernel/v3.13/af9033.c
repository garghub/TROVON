...
struct V_35 * F_31 ( const struct V_151 * V_152 ,
struct V_153 * V_15 )
{
int V_6 ;
struct V_1 * V_2 ;
...
V_2 = F_32 ( sizeof( struct V_1 ) , V_154 ) ;
if ( V_2 == NULL )
goto V_29;
V_2 -> V_15 = V_15 ;
memcpy ( & V_2 -> V_12 , V_152 , sizeof( struct V_151 ) ) ;
if ( V_2 -> V_12 . clock != 12000000 ) {
F_33 ( & V_2 -> V_15 -> V_16 , L_20 \
L_21 ,
V_17 , V_2 -> V_12 . clock ) ;
goto V_29;
}
...
if ( V_6 < 0 )
goto V_29;
F_34 ( & V_2 -> V_15 -> V_16 , L_22 \
L_23 , V_17 , V_7 [ 0 ] , V_7 [ 1 ] ,
...
memcpy ( & V_2 -> V_36 . V_95 , & V_156 , sizeof( struct V_157 ) ) ;
V_2 -> V_36 . V_37 = V_2 ;
return & V_2 -> V_36 ;
V_29:
F_14 ( V_2 ) ;
