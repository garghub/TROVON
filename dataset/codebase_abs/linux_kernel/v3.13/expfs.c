...
static int F_24 ( void * V_38 , const char * V_5 , int V_39 ,
...
error = - V_56 ;
if ( ! V_4 || ! F_26 ( V_4 -> V_57 ) )
goto V_58;
error = - V_59 ;
if ( ! V_4 -> V_60 )
goto V_58;
error = F_27 ( & V_52 , & V_51 ) ;
if ( error )
return error ;
V_53 . V_41 = V_51 . V_41 ;
V_49 = F_28 ( V_11 , V_61 , V_48 ) ;
error = F_20 ( V_49 ) ;
if ( F_18 ( V_49 ) )
goto V_58;
error = - V_59 ;
...
static int F_31 ( struct V_16 * V_16 , struct V_66 * V_66 ,
...
int F_32 ( struct V_16 * V_16 , struct V_66 * V_66 ,
int * V_67 , struct V_16 * V_21 )
{
const struct V_7 * V_8 = V_16 -> V_76 -> V_10 ;
if ( V_8 && V_8 -> V_77 )
return V_8 -> V_77 ( V_16 , V_66 -> V_78 , V_67 , V_21 ) ;
return F_31 ( V_16 , V_66 , V_67 , V_21 ) ;
}
int F_33 ( struct V_3 * V_3 , struct V_66 * V_66 , int * V_67 ,
int V_79 )
{
int error ;
struct V_3 * V_80 = NULL ;
struct V_16 * V_16 = V_3 -> V_17 , * V_21 = NULL ;
if ( V_79 && ! F_26 ( V_16 -> V_57 ) ) {
V_80 = F_10 ( V_3 ) ;
V_21 = V_80 -> V_17 ;
}
error = F_32 ( V_16 , V_66 , V_67 , V_21 ) ;
F_8 ( V_80 ) ;
return error ;
}
struct V_3 * F_34 ( struct V_1 * V_2 , struct V_66 * V_66 ,
int V_81 , int V_82 ,
