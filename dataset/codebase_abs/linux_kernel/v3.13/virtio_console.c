...
V_98 . V_33 = V_28 -> V_33 ;
F_70 ( V_98 . V_33 , V_98 . V_37 ) ;
V_53 = F_71 ( V_93 , & V_96 , F_61 ) ;
F_72 ( V_93 ) ;
if ( F_73 ( V_53 > 0 ) )
...
static unsigned int F_75 ( struct V_80 * V_81 , T_7 * V_115 )
{
struct V_1 * V_1 ;
unsigned int V_53 ;
V_1 = V_81 -> V_85 ;
F_76 ( V_81 , & V_1 -> V_90 , V_115 ) ;
if ( ! V_1 -> V_78 ) {
return V_116 ;
}
V_53 = 0 ;
...
static int F_77 ( struct V_120 * V_120 , struct V_80 * V_81 )
{
struct V_1 * V_1 ;
V_1 = V_81 -> V_85 ;
F_46 ( V_1 , V_121 , 0 ) ;
...
static int F_79 ( struct V_120 * V_120 , struct V_80 * V_81 )
{
...
F_55 ( & V_1 -> V_71 ) ;
F_80 ( V_120 , V_81 ) ;
F_46 ( V_81 -> V_85 , V_121 , 1 ) ;
return 0 ;
V_7:
F_78 ( & V_1 -> V_13 , V_122 ) ;
return V_53 ;
}
static int F_81 ( int V_126 , struct V_80 * V_81 , int V_127 )
{
struct V_1 * V_1 ;
V_1 = V_81 -> V_85 ;
return F_82 ( V_126 , V_81 , V_127 , & V_1 -> V_128 ) ;
}
static int F_83 ( T_1 V_2 , const char * V_28 , int V_83 )
{
struct V_1 * V_1 ;
struct V_44 V_33 [ 1 ] ;
if ( F_74 ( V_129 ) )
...
static int F_84 ( T_1 V_2 , char * V_28 , int V_83 )
{
struct V_1 * V_1 ;
if ( F_74 ( V_129 ) )
return 0 ;
...
if ( ! F_12 ( V_21 ) &&
F_87 ( V_21 , V_131 ) )
F_88 ( V_1 -> V_4 . V_19 , V_1 -> V_4 . V_132 ) ;
}
static int F_89 ( struct V_133 * V_134 , int V_69 )
{
struct V_1 * V_1 ;
V_1 = F_1 ( V_134 -> V_2 ) ;
if ( ! V_1 )
...
static void F_90 ( struct V_133 * V_134 , int V_69 )
{
V_134 -> V_135 = 0 ;
}
int T_8 F_91 ( int (* F_83)( T_1 , const char * , int ) )
{
V_129 = F_83 ;
return F_92 ( 0 , 0 , & V_136 ) ;
}
static int F_93 ( struct V_1 * V_1 )
{
int V_53 ;
V_1 -> V_4 . V_2 = V_137 . V_138 ;
V_1 -> V_4 . V_19 = F_94 ( V_1 -> V_4 . V_2 , 0 , & V_136 , V_108 ) ;
if ( F_95 ( V_1 -> V_4 . V_19 ) ) {
V_53 = F_96 ( V_1 -> V_4 . V_19 ) ;
F_97 ( V_1 -> V_10 ,
L_3 , V_53 ) ;
V_1 -> V_4 . V_19 = NULL ;
return V_53 ;
...
static T_4 F_98 ( struct V_23 * V_10 ,
...
static T_4 F_100 ( struct V_80 * V_81 , char T_5 * V_82 ,
T_3 V_83 , T_6 * V_84 )
{
struct V_1 * V_1 ;
char * V_28 ;
...
V_144 += snprintf ( V_28 + V_144 , V_75 - V_144 ,
L_16 , V_1 -> V_4 . V_2 ) ;
V_53 = F_101 ( V_82 , V_83 , V_84 , V_28 , V_144 ) ;
F_17 ( V_28 ) ;
return V_53 ;
}
static void F_102 ( struct V_1 * V_1 , T_9 V_145 , T_9 V_146 )
{
if ( ! V_1 || ! F_11 ( V_1 ) )
return;
...
static unsigned int F_103 ( struct V_15 * V_16 , T_10 * V_149 )
{
struct V_27 * V_28 ;
unsigned int V_150 ;
int V_53 ;
...
F_105 ( & V_1 -> V_128 , V_151 , V_152 ) ;
}
static int F_106 ( struct V_8 * V_9 , T_1 V_14 )
{
char V_153 [ 16 ] ;
struct V_1 * V_1 ;
struct V_27 * V_28 ;
...
V_1 -> V_12 = F_108 () ;
if ( ! V_1 -> V_12 ) {
F_97 ( & V_1 -> V_9 -> V_21 -> V_10 , L_17 ) ;
V_56 = - V_91 ;
goto V_158;
}
V_1 -> V_12 -> V_101 = & V_159 ;
V_154 = F_109 ( V_9 -> V_160 , V_14 ) ;
V_56 = F_110 ( V_1 -> V_12 , V_154 , 1 ) ;
if ( V_56 < 0 ) {
F_97 ( & V_1 -> V_9 -> V_21 -> V_10 ,
L_18 , V_56 , V_14 ) ;
goto V_161;
}
V_1 -> V_10 = F_111 ( V_137 . V_162 , & V_1 -> V_9 -> V_21 -> V_10 ,
V_154 , V_1 , L_19 ,
...
return 0 ;
V_165:
while ( ( V_28 = F_115 ( V_1 -> V_17 ) ) )
F_14 ( V_28 , true ) ;
V_164:
F_116 ( V_137 . V_162 , V_1 -> V_10 -> V_154 ) ;
V_161:
F_117 ( V_1 -> V_12 ) ;
V_158:
F_17 ( V_1 ) ;
...
sizeof( V_37 ) ) ;
F_102 ( V_1 , V_37 . V_145 , V_37 . V_146 ) ;
...
F_128 ( & V_1 -> V_10 -> V_171 , V_182 ) ;
}
break;
}
}
static void F_129 ( struct V_183 * V_184 )
{
struct V_8 * V_9 ;
struct V_15 * V_16 ;
struct V_27 * V_28 ;
...
F_5 ( & V_1 -> V_58 , V_5 ) ;
F_120 ( & V_1 -> V_90 ) ;
if ( F_11 ( V_1 ) && F_132 ( V_1 -> V_4 . V_19 ) )
F_133 () ;
}
...
struct V_1 * V_1 ;
T_9 V_145 , V_146 ;
F_137 ( V_21 , struct V_189 , V_146 , & V_146 ) ;
F_137 ( V_21 , struct V_189 , V_145 , & V_145 ) ;
V_1 = F_9 ( V_9 , 0 ) ;
F_102 ( V_1 , V_145 , V_146 ) ;
F_86 ( V_1 ) ;
}
}
...
char * * V_191 ;
struct V_15 * * V_192 ;
T_1 V_30 , V_193 , V_194 , V_195 ;
int V_56 ;
V_194 = V_9 -> V_175 . V_176 ;
V_195 = F_13 ( V_9 ) ? ( V_194 + 1 ) * 2 : 2 ;
V_192 = F_28 ( V_195 * sizeof( struct V_15 * ) , V_45 ) ;
V_190 = F_28 ( V_195 * sizeof( T_12 * ) , V_45 ) ;
V_191 = F_28 ( V_195 * sizeof( char * ) , V_45 ) ;
V_9 -> V_156 = F_28 ( V_194 * sizeof( struct V_15 * ) ,
V_45 ) ;
V_9 -> V_157 = F_28 ( V_194 * sizeof( struct V_15 * ) ,
V_45 ) ;
if ( ! V_192 || ! V_190 || ! V_191 || ! V_9 -> V_156 ||
! V_9 -> V_157 ) {
V_56 = - V_91 ;
goto free;
}
...
V_56 = V_9 -> V_21 -> V_175 -> V_196 ( V_9 -> V_21 , V_195 , V_192 ,
V_190 ,
( const char * * ) V_191 ) ;
if ( V_56 )
goto free;
...
V_193 += 2 ;
if ( F_13 ( V_9 ) ) {
V_9 -> V_186 = V_192 [ V_193 ] ;
V_9 -> V_64 = V_192 [ V_193 + 1 ] ;
for ( V_30 = 1 ; V_30 < V_194 ; V_30 ++ ) {
V_193 += 2 ;
V_9 -> V_156 [ V_30 ] = V_192 [ V_193 ] ;
V_9 -> V_157 [ V_30 ] = V_192 [ V_193 + 1 ] ;
}
}
F_17 ( V_191 ) ;
F_17 ( V_190 ) ;
...
F_112 ( & V_9 -> V_187 ) ;
F_112 ( & V_9 -> V_65 ) ;
F_146 ( & V_9 -> V_185 , & F_129 ) ;
V_150 = F_103 ( V_9 -> V_186 ,
& V_9 -> V_187 ) ;
if ( ! V_150 ) {
F_97 ( & V_21 -> V_10 ,
L_35 ) ;
...
return V_53 ;
if ( F_13 ( V_9 ) )
F_103 ( V_9 -> V_186 , & V_9 -> V_187 ) ;
F_3 (port, &portdev->ports, list) {
V_1 -> V_17 = V_9 -> V_156 [ V_1 -> V_14 ] ;
V_1 -> V_18 = V_9 -> V_157 [ V_1 -> V_14 ] ;
F_103 ( V_1 -> V_17 , & V_1 -> V_58 ) ;
F_46 ( V_1 , V_167 , 1 ) ;
if ( V_1 -> V_78 )
F_46 ( V_1 , V_121 , 1 ) ;
}
...
{
int V_56 ;
V_137 . V_162 = F_155 ( V_208 , L_36 ) ;
if ( F_95 ( V_137 . V_162 ) ) {
V_56 = F_96 ( V_137 . V_162 ) ;
F_156 ( L_37 , V_56 ) ;
return V_56 ;
}
V_137 . V_168 = F_157 ( L_36 , NULL ) ;
if ( ! V_137 . V_168 )
F_158 ( L_38 ) ;
F_145 ( & V_137 . V_139 ) ;
F_145 ( & V_137 . V_203 ) ;
