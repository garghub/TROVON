...
static int F_31 ( struct V_51 * V_31 , unsigned int V_40 ,
T_4 V_52 )
{
...
static int F_35 ( struct V_57 * V_27 )
{
F_36 ( V_27 , 500 ) ;
return - V_58 ;
}
...
int V_64 ;
struct V_65 * V_66 =
(struct V_65 * ) V_61 -> V_67 ;
V_64 = F_38 ( V_26 ) ;
if ( V_64 )
return V_64 ;
V_64 = F_39 ( V_26 , 1 << 0 | 1 << 1 , F_40 ( V_26 ) ) ;
if ( V_64 ) {
F_41 ( & V_26 -> V_27 , L_2 ) ;
return V_64 ;
}
V_45 = F_42 ( V_26 ) [ 1 ] ;
V_63 = F_5 ( V_45 ) ;
V_62 = F_5 ( sizeof( T_3 ) + V_45 ) ;
F_43 ( V_26 , 1 << 1 ) ;
V_7 = F_44 ( & V_26 -> V_27 , sizeof( * V_7 ) , V_68 ) ;
if ( ! V_7 ) {
F_41 ( & V_26 -> V_27 , L_3 ) ;
return - V_69 ;
}
V_7 -> V_11 = F_42 ( V_26 ) [ 0 ] ;
V_7 -> V_2 . V_70 = F_45 ( & V_26 -> V_27 ) ;
V_7 -> V_2 . V_71 = F_4 ;
V_7 -> V_2 . V_72 = F_10 ;
V_7 -> V_2 . V_73 = F_15 ;
V_7 -> V_2 . V_74 = F_7 ;
...
V_7 -> V_2 . V_76 = F_16 ;
V_7 -> V_2 . V_45 = V_62 ;
V_7 -> V_2 . V_9 = V_66 -> V_9 ;
V_7 -> V_2 . V_77 = 0 ;
V_7 -> V_26 = V_26 ;
F_46 ( & V_7 -> V_28 ) ;
V_7 -> V_29 = F_47 ( V_26 -> V_27 . V_78 , V_66 -> V_9 ,
V_63 , & V_79 , V_7 ) ;
if ( ! V_7 -> V_29 )
return - V_69 ;
F_48 ( V_26 , V_7 ) ;
