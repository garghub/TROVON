...
void T_2 F_31 ( struct V_61 * V_23 ,
struct V_61 * V_24 )
{
struct V_61 * V_62 ;
char V_28 [ V_29 ] ;
...
struct V_81 * V_82 [ 2 ] ;
int V_83 ;
if ( ! F_41 ( ( unsigned long ) V_77 ) ) {
V_82 [ 0 ] = F_42 ( V_77 ) ;
V_82 [ 1 ] = F_42 ( V_77 + V_84 ) ;
} else {
V_82 [ 0 ] = F_43 ( V_77 ) ;
F_44 ( ! F_45 ( V_82 [ 0 ] ) ) ;
...
F_10 ( ! V_82 [ 0 ] ) ;
F_38 ( V_79 ) ;
F_46 ( V_85 , F_47 ( V_82 [ 0 ] ) ) ;
if ( V_82 [ 1 ] )
F_46 ( V_86 , F_47 ( V_82 [ 1 ] ) ) ;
V_80 = ( char * ) F_48 ( V_85 ) ;
...
static void F_51 ( void * V_88 )
{
F_39 () ;
}
int F_52 ( struct V_89 * V_90 )
{
F_53 () ;
if ( F_54 ( ! V_91 ) )
return 0 ;
if ( F_55 ( V_90 ) || V_90 -> V_92 != ( unsigned long ) V_93 )
return 0 ;
V_90 -> V_92 = ( unsigned long ) V_94 ;
return 1 ;
}
void * F_56 ( void * V_77 , const void * V_78 , T_4 V_19 , void * V_95 )
{
