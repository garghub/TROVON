...
V_6 = F_43 ( V_8 ) ;
if ( V_167 -> V_200 ) {
struct V_98 * V_111 = (struct V_98 * ) V_167 -> V_200 ;
V_9 = - V_112 ;
...
static int F_111 ( struct V_93 * V_7 , int V_202 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
F_2 ( 1 , L_3 , V_10 , V_6 ) ;
...
static unsigned int F_112 ( struct V_203 * V_203 , struct V_93 * V_7 ,
T_11 * V_189 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
...
static int F_116 ( struct V_93 * V_7 , unsigned int V_212 , unsigned long V_213 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
int V_9 ;
...
case V_214 : {
long V_215 ;
V_215 = V_8 -> V_216 - F_117 ( V_8 ) ;
if ( V_215 < 0 )
V_215 = 0 ;
V_9 = F_118 ( V_215 , ( unsigned int V_217 * ) V_213 ) ;
break;
}
case V_218 : {
struct V_3 * V_4 ;
...
case V_219 :
if ( V_8 != NULL )
V_9 = F_119 ( V_8 , (struct V_220 V_217 * ) V_213 ) ;
break;
case V_221 :
case V_222 :
case V_223 :
...
static int F_120 ( struct V_93 * V_7 , unsigned int V_212 , unsigned long V_213 )
{
return - V_231 ;
}
static int F_121 ( struct V_93 * V_7 , int V_232 , int V_233 ,
...
V_237 = F_122 ( sizeof( struct V_236 ) , V_246 ) ;
if ( V_237 == NULL ) {
V_9 = - V_69 ;
goto V_107;
}
if ( F_123 ( V_237 , V_234 , V_235 ) ) {
F_41 ( V_237 ) ;
V_9 = - V_195 ;
goto V_107;
}
...
if ( F_130 ( V_241 , ( int V_217 * ) V_234 ) ) {
V_9 = - V_195 ;
goto V_107;
}
if ( V_8 -> V_26 != V_29 ) {
...
static int F_132 ( struct V_236 * V_237 ,
struct V_43 * V_43 )
{
switch ( V_43 -> type ) {
case V_81 :
...
static int F_133 ( struct V_93 * V_7 , int V_232 , int V_233 ,
...
if ( V_273 > V_168 )
V_273 = V_168 ;
if ( F_134 ( V_234 + V_272 , V_84 , V_273 - V_272 ) )
V_9 = - V_195 ;
if ( F_118 ( V_273 , V_235 ) )
V_9 = - V_195 ;
V_275:
F_41 ( V_84 ) ;
break;
...
V_271 = V_6 -> V_28 ;
V_168 = sizeof( int ) ;
if ( F_118 ( V_168 , V_235 ) ) {
V_9 = - V_195 ;
goto V_107;
}
if ( F_134 ( V_234 , & V_271 , V_168 ) ) {
V_9 = - V_195 ;
goto V_107;
}
break;
...
V_9 = F_132 ( V_237 , V_240 -> V_44 ) ;
if( V_9 ) {
F_41 ( V_237 ) ;
goto V_107;
}
if ( F_134 ( V_234 , V_237 ,
sizeof( struct V_236 ) ) ) {
F_41 ( V_237 ) ;
V_9 = - V_195 ;
goto V_107;
...
if ( F_130 ( V_271 , ( int V_217 * ) V_234 ) ) {
V_9 = - V_195 ;
goto V_107;
}
F_135 ( V_6 -> V_160 , V_6 -> V_89 . V_90 ,
F_27 ,
NULL , ( void * ) V_6 ) ;
F_136 ( V_6 -> V_91 ) ;
if ( ! V_6 -> V_53 ) {
