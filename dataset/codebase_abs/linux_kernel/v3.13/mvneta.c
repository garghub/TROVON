...
V_2 -> V_296 = V_296 ;
V_2 -> V_297 = V_344 ;
V_2 -> V_145 = F_217 ( & V_349 -> V_17 , NULL ) ;
if ( F_218 ( V_2 -> V_145 ) ) {
V_216 = F_219 ( V_2 -> V_145 ) ;
goto V_305;
}
F_220 ( V_2 -> V_145 ) ;
V_2 -> V_5 = F_221 ( V_352 , 0 ) ;
if ( V_2 -> V_5 == NULL ) {
V_216 = - V_202 ;
goto V_366;
}
...
if ( V_350 )
F_204 ( V_2 , V_350 ) ;
F_228 ( V_17 , & V_2 -> V_219 , F_134 , V_2 -> V_364 ) ;
...
static int F_235 ( struct V_348 * V_349 )
{
struct V_16 * V_17 = F_236 ( V_349 ) ;
struct V_1 * V_2 = F_9 ( V_17 ) ;
F_237 ( V_17 ) ;
F_203 ( V_2 ) ;
F_232 ( V_2 -> V_145 ) ;
