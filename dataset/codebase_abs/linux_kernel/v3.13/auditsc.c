...
{
struct V_206 * V_207 ;
T_8 V_45 , V_349 , V_350 ;
V_45 = F_70 ( & V_210 , F_124 ( V_95 ) ) ;
V_349 = F_70 ( & V_210 , V_346 ) ;
V_350 = F_70 ( & V_210 , V_347 ) ,
V_207 = F_68 ( NULL , V_39 , V_351 ) ;
if ( ! V_207 )
return;
F_69 ( V_207 , L_63
L_64 , V_95 -> V_100 , V_45 , V_349 ,
V_350 , V_348 , V_204 , ! V_49 ) ;
F_74 ( V_207 ) ;
}
int F_125 ( T_2 V_62 )
{
struct V_52 * V_352 = V_95 ;
...
V_352 -> V_62 = V_62 ;
V_332:
F_123 ( V_353 , V_62 , V_348 , V_204 , V_49 ) ;
return V_49 ;
}
...
void F_131 ( T_9 V_252 , const struct V_355 * V_356 )
{
struct V_7 * V_174 = V_95 -> V_7 ;
if ( V_356 )
V_174 -> V_259 . V_260 = V_356 -> V_260 ;
else
V_174 -> V_259 . V_260 = 0 ;
...
void F_133 ( struct V_357 * V_358 )
{
struct V_7 * V_174 = V_95 -> V_7 ;
V_174 -> V_147 . V_45 = V_358 -> V_45 ;
V_174 -> V_147 . V_51 = V_358 -> V_51 ;
V_174 -> V_147 . V_24 = V_358 -> V_24 ;
V_174 -> V_147 . V_236 = 0 ;
F_134 ( V_358 , & V_174 -> V_147 . V_145 ) ;
V_174 -> type = V_146 ;
}
...
void F_136 ( struct V_359 * V_360 )
{
struct V_7 * V_174 = V_95 -> V_7 ;
V_174 -> type = V_227 ;
V_174 -> V_230 . V_231 = V_360 -> V_231 ;
}
int F_137 ( int V_234 , unsigned long * args )
{
struct V_7 * V_174 = V_95 -> V_7 ;
if ( V_234 <= 0 || V_234 > V_361 || ! args )
return - V_362 ;
V_174 -> type = V_233 ;
...
void F_138 ( int V_363 , int V_364 )
{
struct V_7 * V_174 = V_95 -> V_7 ;
V_174 -> V_284 [ 0 ] = V_363 ;
V_174 -> V_284 [ 1 ] = V_364 ;
}
int F_139 ( int V_208 , void * V_365 )
{
struct V_7 * V_174 = V_95 -> V_7 ;
if ( ! V_174 -> V_202 ) {
void * V_33 = F_84 ( sizeof( struct V_366 ) , V_39 ) ;
if ( ! V_33 )
return - V_201 ;
V_174 -> V_202 = V_33 ;
}
V_174 -> V_286 = V_208 ;
memcpy ( V_174 -> V_202 , V_365 , V_208 ) ;
return 0 ;
}
...
memcpy ( V_174 -> V_295 , V_341 -> V_205 , V_367 ) ;
}
int F_141 ( int V_368 , struct V_52 * V_341 )
{
struct V_288 * V_369 ;
struct V_52 * V_53 = V_95 ;
struct V_7 * V_8 = V_53 -> V_7 ;
T_2 V_45 = F_142 () , V_370 = F_124 ( V_341 ) ;
if ( V_168 && V_341 -> V_169 == V_168 ) {
if ( V_368 == V_371 || V_368 == V_372 || V_368 == V_373 || V_368 == V_374 ) {
V_375 = V_53 -> V_100 ;
if ( F_122 ( V_53 -> V_62 ) )
V_376 = V_53 -> V_62 ;
else
...
memcpy ( V_8 -> V_295 , V_341 -> V_205 , V_367 ) ;
return 0 ;
}
V_369 = ( void * ) V_8 -> V_196 ;
if ( ! V_369 || V_369 -> V_289 == V_379 ) {
V_369 = F_13 ( sizeof( * V_369 ) , V_157 ) ;
if ( ! V_369 )
return - V_201 ;
V_369 -> V_311 . type = V_209 ;
V_369 -> V_311 . V_38 = V_8 -> V_196 ;
V_8 -> V_196 = ( void * ) V_369 ;
}
F_97 ( V_369 -> V_289 >= V_379 ) ;
V_369 -> V_290 [ V_369 -> V_289 ] = V_341 -> V_169 ;
V_369 -> V_291 [ V_369 -> V_289 ] = F_126 ( V_341 ) ;
V_369 -> V_292 [ V_369 -> V_289 ] = V_370 ;
V_369 -> V_293 [ V_369 -> V_289 ] = F_127 ( V_341 ) ;
F_37 ( V_341 , & V_369 -> V_294 [ V_369 -> V_289 ] ) ;
memcpy ( V_369 -> V_295 [ V_369 -> V_289 ] , V_341 -> V_205 , V_367 ) ;
V_369 -> V_289 ++ ;
return 0 ;
}
int F_144 ( struct V_359 * V_360 ,
const struct V_54 * V_380 , const struct V_54 * V_381 )
{
struct V_277 * V_382 ;
struct V_7 * V_174 = V_95 -> V_7 ;
struct V_383 V_384 ;
struct V_192 * V_192 ;
V_382 = F_84 ( sizeof( * V_382 ) , V_39 ) ;
if ( ! V_382 )
return - V_201 ;
V_382 -> V_311 . type = V_276 ;
V_382 -> V_311 . V_38 = V_174 -> V_195 ;
V_174 -> V_195 = ( void * ) V_382 ;
V_192 = F_145 ( V_360 -> V_385 -> V_386 ) ;
F_146 ( V_192 , & V_384 ) ;
F_147 ( V_192 ) ;
V_382 -> V_280 . V_269 = V_384 . V_269 ;
V_382 -> V_280 . V_268 = V_384 . V_268 ;
V_382 -> V_280 . V_281 = ! ! ( V_384 . V_387 & V_388 ) ;
V_382 -> V_279 = ( V_384 . V_387 & V_389 ) >> V_390 ;
V_382 -> V_282 . V_269 = V_381 -> V_391 ;
V_382 -> V_282 . V_268 = V_381 -> V_392 ;
V_382 -> V_282 . V_270 = V_381 -> V_393 ;
V_382 -> V_283 . V_269 = V_380 -> V_391 ;
V_382 -> V_283 . V_268 = V_380 -> V_392 ;
V_382 -> V_283 . V_270 = V_380 -> V_393 ;
return 0 ;
}
void F_148 ( T_5 V_100 ,
const struct V_54 * V_380 , const struct V_54 * V_381 )
{
struct V_7 * V_174 = V_95 -> V_7 ;
V_174 -> V_266 . V_100 = V_100 ;
V_174 -> V_266 . V_267 . V_270 = V_380 -> V_393 ;
V_174 -> V_266 . V_267 . V_268 = V_380 -> V_393 ;
V_174 -> V_266 . V_267 . V_269 = V_380 -> V_391 ;
V_174 -> type = V_265 ;
}
void F_149 ( int V_273 , int V_1 )
{
struct V_7 * V_174 = V_95 -> V_7 ;
...
static void F_150 ( struct V_206 * V_207 )
{
T_2 V_203 , V_45 ;
T_3 V_51 ;
unsigned int V_204 ;
...
V_204 ) ;
F_152 ( V_207 ) ;
F_69 ( V_207 , L_66 , V_95 -> V_100 ) ;
F_73 ( V_207 , V_95 -> V_205 ) ;
}
static void F_153 ( struct V_206 * V_207 , char * V_394 , long V_395 )
{
F_150 ( V_207 ) ;
F_69 ( V_207 , L_67 ) ;
F_82 ( V_207 , V_394 ) ;
F_69 ( V_207 , L_68 , V_395 ) ;
}
void F_154 ( long V_395 )
{
struct V_206 * V_207 ;
if ( ! V_303 )
return;
if ( V_395 == V_396 )
return;
V_207 = F_68 ( NULL , V_39 , V_397 ) ;
if ( F_4 ( ! V_207 ) )
return;
F_153 ( V_207 , L_69 , V_395 ) ;
F_74 ( V_207 ) ;
}
void F_155 ( unsigned long V_398 , long V_395 , int V_399 )
{
struct V_206 * V_207 ;
V_207 = F_68 ( NULL , V_39 , V_400 ) ;
if ( F_4 ( ! V_207 ) )
return;
F_150 ( V_207 ) ;
F_69 ( V_207 , L_68 , V_395 ) ;
F_69 ( V_207 , L_70 , V_398 ) ;
F_69 ( V_207 , L_71 , F_156 () ) ;
F_69 ( V_207 , L_72 , F_157 ( V_95 ) ) ;
F_69 ( V_207 , L_73 , V_399 ) ;
F_74 ( V_207 ) ;
}
struct V_166 * F_158 ( void )
{
