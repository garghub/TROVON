...
static int F_25 ( struct V_12 * V_13 , struct V_14 * V_2 , struct V_15 * V_39 ,
T_1 V_40 )
{
...
int V_44 ;
error = - V_45 ;
if ( F_26 ( V_3 , V_46 ) || ! ( V_3 -> V_21 & V_47 ) )
goto error;
error = - V_48 ;
V_4 = F_1 ( V_3 ) ;
if ( V_4 == NULL )
...
error = - V_54 ;
V_10 = F_28 ( V_3 , V_55 + sizeof( struct V_56 ) +
V_44 + V_4 -> V_57 +
sizeof( V_41 ) + V_40 ,
0 , V_58 ) ;
if ( ! V_10 )
...
F_29 ( V_10 , V_55 ) ;
F_30 ( V_10 ) ;
F_29 ( V_10 , sizeof( struct V_56 ) ) ;
F_31 ( V_10 ) ;
F_29 ( V_10 , V_44 ) ;
V_10 -> V_11 [ 0 ] = V_41 [ 0 ] ;
V_10 -> V_11 [ 1 ] = V_41 [ 1 ] ;
F_32 ( V_10 , 2 ) ;
error = F_33 ( F_32 ( V_10 , V_40 ) , V_39 -> V_27 ,
V_40 ) ;
if ( error < 0 ) {
F_12 ( V_10 ) ;
goto V_59;
...
static int F_37 ( struct V_60 * V_36 , struct V_9 * V_10 )
{
...
static int F_53 ( struct V_2 * V_3 , struct V_9 * V_10 )
{
int V_70 ;
V_70 = F_54 ( V_3 , V_10 ) ;
if ( V_70 )
...
static int F_55 ( struct V_72 * V_72 , struct V_14 * V_2 )
{
int error = - V_54 ;
struct V_2 * V_3 ;
V_3 = F_56 ( V_72 , V_73 , V_58 , & V_74 ) ;
if ( ! V_3 )
goto V_6;
F_57 ( V_2 , V_3 ) ;
V_2 -> V_75 = V_76 ;
...
static void F_58 ( struct V_87 * V_39 , void * V_88 )
{
struct V_1 * V_4 = V_88 ;
struct V_29 * V_30 = F_14 ( V_4 ) ;
if ( V_30 ) {
...
if ( V_33 )
F_59 ( V_39 , L_4 , F_60 ( & V_33 -> V_36 ) ) ;
}
}
static int F_61 ( struct V_14 * V_2 , struct V_89 * V_90 ,
int V_91 , int V_18 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
...
error = F_64 ( F_63 ( V_3 ) , V_103 , V_102 , V_98 , V_99 , & V_119 , & V_43 ) ;
if ( error < 0 )
goto V_23;
}
} else {
...
if ( V_43 -> V_99 == 0 )
V_43 -> V_99 = V_99 ;
V_4 = F_65 ( F_63 ( V_3 ) , V_43 , V_100 ) ;
if ( V_4 == NULL ) {
V_97 . V_123 = V_97 . V_124 = 1500 - V_125 ;
V_4 = F_66 ( sizeof( struct V_29 ) ,
V_43 , V_100 ,
V_101 , & V_97 ) ;
if ( V_4 == NULL ) {
error = - V_54 ;
...
static int F_73 ( struct V_72 * V_72 , T_3 V_98 , T_3 V_100 , T_3 V_101 , struct V_96 * V_97 )
{
int error ;
struct V_42 * V_43 ;
struct V_1 * V_4 ;
...
static int F_74 ( struct V_14 * V_2 , struct V_89 * V_143 ,
int * V_144 , int V_145 )
{
int V_17 = 0 ;
int error = 0 ;
...
static void F_77 ( struct V_167 * V_168 ,
struct V_169 * V_37 )
{
V_168 -> V_170 = F_78 ( & V_37 -> V_170 ) ;
V_168 -> V_171 = F_78 ( & V_37 -> V_171 ) ;
V_168 -> V_172 = F_78 ( & V_37 -> V_172 ) ;
V_168 -> V_173 = F_78 ( & V_37 -> V_173 ) ;
V_168 -> V_174 = F_78 ( & V_37 -> V_174 ) ;
V_168 -> V_175 = F_78 ( & V_37 -> V_175 ) ;
V_168 -> V_176 = F_78 ( & V_37 -> V_176 ) ;
V_168 -> V_38 = F_78 ( & V_37 -> V_38 ) ;
}
...
break;
V_19 = - V_183 ;
if ( F_80 ( & V_179 , ( void V_184 * ) V_88 , sizeof( struct V_178 ) ) )
break;
V_179 . V_185 = V_4 -> V_123 ;
if ( F_81 ( ( void V_184 * ) V_88 , & V_179 , sizeof( struct V_178 ) ) )
break;
F_21 ( V_4 , V_142 , L_7 ,
V_4 -> V_35 , V_4 -> V_123 ) ;
V_19 = 0 ;
...
break;
V_19 = - V_183 ;
if ( F_82 ( V_4 -> V_124 , ( int V_184 * ) V_88 ) )
break;
F_21 ( V_4 , V_142 , L_9 ,
V_4 -> V_35 , V_4 -> V_124 ) ;
V_19 = 0 ;
...
case V_189 :
V_19 = - V_183 ;
if ( F_82 ( V_30 -> V_18 , ( int V_184 * ) V_88 ) )
break;
F_21 ( V_4 , V_142 , L_11 ,
V_4 -> V_35 , V_30 -> V_18 ) ;
V_19 = 0 ;
...
if ( V_37 . V_100 != 0 ) {
struct V_1 * V_4 =
F_65 ( F_63 ( V_3 ) , V_43 , V_37 . V_100 ) ;
if ( V_4 != NULL )
V_19 = F_79 ( V_4 , V_177 , V_88 ) ;
else
V_19 = - V_193 ;
break;
}
...
#endif
F_77 ( & V_37 , & V_43 -> V_37 ) ;
if ( F_81 ( ( void V_184 * ) V_88 , & V_37 , sizeof( V_37 ) ) ) {
V_19 = - V_183 ;
break;
}
F_21 ( V_43 , V_142 , L_13 ,
V_43 -> V_35 ) ;
V_19 = 0 ;
break;
default:
...
static int F_86 ( struct V_14 * V_2 , unsigned int V_177 ,
unsigned long V_88 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_1 * V_4 ;
...
static int F_90 ( struct V_14 * V_2 , int V_209 , int V_196 ,
...
if ( V_43 == NULL )
goto V_149;
V_19 = F_87 ( V_3 , V_43 , V_196 , V_180 ) ;
F_3 ( V_30 -> V_49 ) ;
} else
V_19 = F_88 ( V_3 , V_4 , V_196 , V_180 ) ;
V_19 = 0 ;
V_149:
F_3 ( V_3 ) ;
V_23:
...
static int F_94 ( struct V_14 * V_2 , int V_209 , int V_196 ,
...
if ( V_43 == NULL )
goto V_149;
V_19 = F_91 ( V_3 , V_43 , V_196 , & V_180 ) ;
F_3 ( V_30 -> V_49 ) ;
} else
V_19 = F_92 ( V_3 , V_4 , V_196 , & V_180 ) ;
V_19 = - V_183 ;
if ( F_82 ( V_17 , V_211 ) )
goto V_149;
if ( F_81 ( ( void V_184 * ) V_210 , & V_180 , V_17 ) )
goto V_149;
V_19 = 0 ;
V_149:
F_3 ( V_3 ) ;
...
static void F_96 ( struct V_72 * V_72 , struct V_216 * V_217 )
{
for (; ; ) {
V_217 -> V_43 = F_97 ( V_72 , V_217 -> V_218 ) ;
V_217 -> V_218 ++ ;
if ( V_217 -> V_43 == NULL )
break;
...
{
V_217 -> V_4 = F_99 ( V_217 -> V_43 , V_217 -> V_219 ) ;
V_217 -> V_219 ++ ;
if ( V_217 -> V_4 == NULL ) {
V_217 -> V_219 = 0 ;
F_96 ( V_72 , V_217 ) ;
...
static void * F_100 ( struct V_87 * V_39 , T_4 * V_220 )
{
...
static void * F_102 ( struct V_87 * V_39 , void * V_223 , T_4 * V_222 )
{
( * V_222 ) ++ ;
return NULL ;
}
static void F_103 ( struct V_87 * V_224 , void * V_223 )
{
}
static void F_104 ( struct V_87 * V_39 , void * V_223 )
{
...
F_59 ( V_39 , L_27 ,
V_43 -> V_120 ,
F_78 ( & V_43 -> V_37 . V_170 ) ,
F_78 ( & V_43 -> V_37 . V_171 ) ,
F_78 ( & V_43 -> V_37 . V_172 ) ,
F_78 ( & V_43 -> V_37 . V_173 ) ,
F_78 ( & V_43 -> V_37 . V_174 ) ,
F_78 ( & V_43 -> V_37 . V_38 ) ) ;
}
...
T_5 V_227 = 0 ;
if ( V_43 -> V_2 ) {
struct V_146 * V_147 = F_75 ( V_43 -> V_2 ) ;
V_226 = F_107 ( V_147 -> V_228 ) ;
V_227 = F_108 ( V_147 -> V_229 ) ;
}
F_59 ( V_39 , L_28
L_29 ,
...
static int F_109 ( struct V_87 * V_39 , void * V_223 )
{
struct V_216 * V_217 = V_223 ;
if ( V_223 == V_221 ) {
F_110 ( V_39 , L_34 V_232 L_35 ) ;
F_110 ( V_39 , L_36 ) ;
F_110 ( V_39 , L_37 ) ;
F_110 ( V_39 , L_38
L_39 ) ;
...
if ( V_217 -> V_4 == NULL )
F_104 ( V_39 , V_217 -> V_43 ) ;
else
F_106 ( V_39 , V_217 -> V_4 ) ;
V_6:
return 0 ;
}
static int F_111 ( struct V_233 * V_233 , struct V_234 * V_234 )
{
return F_112 ( V_233 , V_234 , & V_235 ,
sizeof( struct V_216 ) ) ;
}
static T_6 int F_113 ( struct V_72 * V_72 )
{
struct V_236 * V_237 ;
int V_19 = 0 ;
V_237 = F_114 ( L_42 , V_238 , V_72 -> V_239 ,
& V_240 ) ;
if ( ! V_237 ) {
V_19 = - V_54 ;
goto V_6;
...
static T_7 void F_115 ( struct V_72 * V_72 )
{
F_116 ( L_42 , V_72 -> V_239 ) ;
}
...
if ( V_19 )
goto V_242;
V_19 = F_120 ( V_81 , & V_243 ) ;
if ( V_19 )
goto V_244;
#ifdef F_121
V_19 = F_122 ( V_245 , & V_246 ) ;
if ( V_19 )
goto V_247;
#endif
F_123 ( L_43 , V_232 ) ;
