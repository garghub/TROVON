...
{
struct V_6 * V_7 = F_7 ( sizeof( * V_7 ) ) ;
const char * V_14 = NULL ;
if ( V_7 )
V_7 -> V_8 = F_8 ( V_21 , & V_14 ) ;
...
bool F_13 ( struct V_6 * V_7 , const char * V_23 )
{
if ( ! V_7 )
return false ;
return F_11 ( V_7 -> V_8 , V_23 ) ;
}
