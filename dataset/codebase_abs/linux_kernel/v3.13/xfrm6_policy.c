...
int V_58 = 0 ;
if ( F_24 ( V_46 ) )
V_58 = F_24 ( V_46 ) -> V_11 -> V_59 ;
memset ( V_7 , 0 , sizeof( struct V_6 ) ) ;
V_7 -> V_60 = V_46 -> V_61 ;
V_7 -> V_62 = V_47 ? V_46 -> V_63 : V_58 ;
V_7 -> V_5 = V_47 ? V_52 -> V_4 : V_52 -> V_5 ;
V_7 -> V_4 = V_47 ? V_52 -> V_5 : V_52 -> V_4 ;
while ( V_55 + V_50 + 1 < V_46 -> V_64 ||
F_25 ( V_46 , V_55 + V_50 + 1 - V_46 -> V_64 ) ) {
V_55 = F_22 ( V_46 ) ;
...
case V_72 :
case V_73 :
if ( ! V_49 && ( V_55 + V_50 + 4 < V_46 -> V_64 ||
F_25 ( V_46 , V_55 + V_50 + 4 - V_46 -> V_64 ) ) ) {
T_4 * V_74 = ( T_4 * ) V_54 ;
V_7 -> V_75 = V_74 [ ! ! V_47 ] ;
V_7 -> V_76 = V_74 [ ! V_47 ] ;
}
...
return;
case V_78 :
if ( ! V_49 && F_25 ( V_46 , V_55 + V_50 + 2 - V_46 -> V_64 ) ) {
T_3 * V_79 = ( T_3 * ) V_54 ;
V_7 -> V_80 = V_79 [ 0 ] ;
V_7 -> V_81 = V_79 [ 1 ] ;
}
...
#if F_27 ( V_82 )
case V_83 :
if ( ! V_49 && F_25 ( V_46 , V_55 + V_50 + 3 - V_46 -> V_64 ) ) {
struct V_84 * V_85 ;
V_85 = (struct V_84 * ) V_54 ;
V_7 -> V_86 = V_85 -> V_87 ;
}
V_7 -> V_77 = V_56 ;
return;
...
V_52 = F_53 ( V_2 , L_1 , V_111 ) ;
if ( ! V_52 )
goto V_117;
V_2 -> V_21 . V_118 . V_119 = V_52 ;
return 0 ;
V_117:
if ( ! F_51 ( V_2 , & V_114 ) )
F_54 ( V_111 ) ;
