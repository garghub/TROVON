...
V_13 = V_12 -> V_15 . V_16 -> V_94 ( V_12 , & V_2 -> V_95 ) ;
if ( V_13 ) {
F_22 ( & V_2 -> V_48 -> V_49 , L_9 ) ;
goto V_96;
}
V_13 = V_12 -> V_15 . V_16 -> V_97 ( V_12 , & V_85 ) ;
if ( V_13 ) {
...
if ( V_13 )
goto V_45;
V_13 = F_18 ( V_2 , V_2 -> V_102 ) ;
if ( V_13 )
goto V_45;
V_13 = V_12 -> V_15 . V_16 -> V_103 ( V_12 , V_2 -> V_18 ) ;
if ( V_13 )
goto V_45;
V_2 -> V_62 = 1 ;
if ( ! V_2 -> V_104 ) {
...
struct V_11 * V_12 = V_2 -> V_12 ;
int V_13 ;
V_12 -> V_15 . V_16 -> V_105 ( V_12 , V_2 -> V_18 ) ;
V_13 = F_6 ( V_2 , V_106 ) ;
if ( ! V_13 )
V_13 = F_8 ( V_2 ) ;
if ( V_13 ) {
...
if ( F_51 ( V_66 ) )
return 0 ;
V_13 = V_12 -> V_15 . V_16 -> V_107 ( V_12 , V_66 ) ;
if ( V_13 ) {
F_22 ( V_49 , L_15 ) ;
return V_13 ;
}
V_13 = V_12 -> V_15 . V_16 -> V_108 ( V_2 -> V_12 , & V_2 -> V_18 ) ;
if ( V_13 ) {
F_22 ( V_49 , L_16 ) ;
goto V_109;
}
V_13 = V_12 -> V_15 . V_16 -> V_110 ( V_2 -> V_12 , V_2 -> V_18 , V_111 ) ;
if ( V_13 ) {
F_22 ( V_49 , L_17 ) ;
goto V_112;
}
return 0 ;
V_112:
V_12 -> V_15 . V_16 -> V_113 ( V_2 -> V_12 , V_2 -> V_18 ) ;
V_109:
V_12 -> V_15 . V_16 -> V_114 ( V_12 , V_66 ) ;
return V_13 ;
}
...
if ( ! F_51 ( V_66 ) )
return;
V_12 -> V_15 . V_16 -> V_113 ( V_12 , V_2 -> V_18 ) ;
V_12 -> V_15 . V_16 -> V_114 ( V_12 , V_66 ) ;
}
...
static T_5 F_57 ( int V_118 , void * V_10 )
{
struct V_1 * V_2 = V_10 ;
struct V_11 * V_12 = V_2 -> V_12 ;
int V_119 ;
int V_13 ;
V_119 = F_58 ( & V_2 -> V_120 , 1 , 0 ) ;
if ( V_119 ) {
F_16 ( & V_2 -> V_121 ) ;
V_13 = V_12 -> V_15 . V_16 -> V_122 ( V_12 , V_2 -> V_18 , F_56 ,
V_2 ) ;
if ( V_13 )
goto V_45;
}
...
{
struct V_1 * V_2 = F_60 ( V_125 , struct V_1 ,
V_121 . V_125 ) ;
struct V_11 * V_12 = V_2 -> V_12 ;
...
int V_13 ;
if ( V_50 )
V_13 = F_7 ( V_2 , V_126 , 0 ) ;
else
V_13 = F_6 ( V_2 , V_127 ) ;
if ( ! F_19 ( V_2 -> V_46 ) )
V_12 -> V_15 . V_16 -> V_128 ( V_12 , V_50 ) ;
F_65 ( 100 ) ;
return V_13 ;
}
...
V_130 = F_69 ( V_33 * V_34 * 3 ,
V_66 -> V_69 . V_70 . V_71 *
V_66 -> V_69 . V_70 . V_72 * 3 ) ;
V_12 -> V_15 . V_16 -> V_63 ( V_12 ) ;
V_13 = F_26 ( V_2 ) ;
if ( V_13 )
goto V_53;
...
V_13 = V_12 -> V_15 . V_16 -> V_135 ( V_12 , V_2 -> V_18 , V_132 ) ;
if ( V_13 )
goto V_53;
while ( V_133 < V_130 ) {
T_1 V_9 = V_131 ? 0x2e : 0x3e ;
V_131 = 0 ;
V_13 = V_12 -> V_15 . V_16 -> V_17 ( V_12 , V_2 -> V_18 , V_9 ,
V_14 + V_133 , V_130 - V_133 ) ;
if ( V_13 < 0 ) {
F_22 ( V_66 -> V_49 , L_27 ) ;
goto V_136;
}
...
static void F_71 ( struct V_124 * V_125 )
{
struct V_1 * V_2 = F_60 ( V_125 , struct V_1 ,
V_43 . V_125 ) ;
...
struct V_1 * V_2 = F_36 ( V_48 ) ;
struct V_11 * V_66 , * V_12 ;
V_140 = F_73 ( & V_48 -> V_49 ) ;
V_12 = F_74 ( V_140 -> V_141 ) ;
if ( V_12 == NULL ) {
F_22 ( & V_48 -> V_49 , L_31 ) ;
return - V_142 ;
}
...
V_2 -> V_46 = - 1 ;
V_2 -> V_41 = V_140 -> V_41 ;
V_2 -> V_144 = V_140 -> V_144 ;
V_2 -> V_95 = V_140 -> V_95 ;
V_66 = & V_2 -> V_66 ;
V_66 -> V_145 = V_140 -> V_145 ;
return 0 ;
}
static int F_75 ( struct V_76 * V_48 )
{
struct V_146 V_56 ;
struct V_1 * V_2 ;
...
int V_13 ;
F_29 ( V_49 , L_32 ) ;
V_2 = F_76 ( V_49 , sizeof( * V_2 ) , V_148 ) ;
if ( ! V_2 )
return - V_134 ;
F_77 ( V_48 , V_2 ) ;
V_2 -> V_48 = V_48 ;
...
V_2 -> V_70 . V_71 = 864 ;
V_2 -> V_70 . V_72 = 480 ;
V_2 -> V_70 . V_149 = F_78 ( 864 * 480 * 60 , 1000 ) ;
V_66 = & V_2 -> V_66 ;
V_66 -> V_49 = V_49 ;
V_66 -> V_150 = & V_151 ;
...
static int T_6 F_93 ( struct V_76 * V_48 )
{
struct V_1 * V_2 = F_36 ( V_48 ) ;
struct V_11 * V_66 = & V_2 -> V_66 ;
struct V_54 * V_147 ;
...
F_55 ( V_66 ) ;
F_52 ( V_66 ) ;
F_95 ( & V_48 -> V_49 . V_167 , & V_168 ) ;
V_147 = V_2 -> V_147 ;
if ( V_147 != NULL ) {
V_147 -> V_56 . V_59 = V_170 ;
F_27 ( V_147 ) ;
F_91 ( V_147 ) ;
}
F_96 ( V_2 -> V_12 ) ;
