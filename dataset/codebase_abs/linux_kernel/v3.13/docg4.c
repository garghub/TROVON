...
static void F_42 ( struct V_3 * V_4 , int V_37 )
{
struct V_8 * V_9 = V_4 -> V_10 ;
struct V_14 * V_15 = V_9 -> V_10 ;
void T_1 * V_1 = V_15 -> V_18 ;
...
F_5 ( V_4 , V_5 , V_46 ) ;
F_5 ( V_4 , V_9 -> V_42 , 6 ) ;
F_2 ( V_9 -> V_42 [ 6 ] , V_1 + V_121 ) ;
F_1 ( V_1 ) ;
F_1 ( V_1 ) ;
if ( F_38 ( V_102 == true ) ) {
T_2 V_122 = F_10 ( V_1 + V_123 ) ;
V_122 = F_10 ( V_1 + V_123 ) ;
F_2 ( V_122 , V_1 + V_121 ) ;
F_1 ( V_1 ) ;
F_18 ( V_1 , V_36 ) ;
V_36 [ 7 ] = 0 ;
...
struct V_8 * V_9 = V_4 -> V_10 ;
struct V_14 * V_15 = V_9 -> V_10 ;
T_4 V_91 = F_35 ( V_124 , 0 ) ;
T_2 * V_5 ;
int V_7 , V_125 ;
T_6 V_126 = V_4 -> V_111 . V_112 ;
V_5 = F_49 ( V_46 , V_127 ) ;
if ( V_5 == NULL )
return - V_128 ;
F_33 ( V_4 , V_91 ) ;
F_40 ( V_4 , V_9 , V_5 , 0 , V_124 ) ;
if ( V_9 -> V_129 == NULL )
goto exit;
if ( V_4 -> V_111 . V_112 > V_126 ) {
V_126 = V_4 -> V_111 . V_112 ;
F_40 ( V_4 , V_9 , V_5 , 0 , V_130 ) ;
if ( V_4 -> V_111 . V_112 > V_126 ) {
F_16 ( V_15 -> V_19 ,
L_28 ) ;
goto exit;
...
static int F_51 ( struct V_3 * V_4 , T_7 V_136 )
{
int V_137 , V_7 ;
T_2 * V_5 ;
struct V_8 * V_9 = V_4 -> V_10 ;
...
int V_37 = ( int ) ( V_136 >> V_9 -> V_141 ) ;
T_4 V_91 = F_35 ( V_37 , 0 ) ;
F_7 ( V_15 -> V_19 , L_30 , V_20 , V_136 ) ;
if ( F_12 ( V_136 & ( V_142 - 1 ) ) )
F_16 ( V_15 -> V_19 , L_31 ,
V_20 , V_136 ) ;
V_5 = F_49 ( V_46 , V_127 ) ;
if ( V_5 == NULL )
return - V_128 ;
memset ( V_9 -> V_42 , 0xff , V_4 -> V_143 ) ;
for ( V_7 = 0 ; V_7 < V_139 -> V_6 ; V_7 ++ )
V_9 -> V_42 [ V_139 -> V_144 + V_7 ] = ~ V_139 -> V_145 [ V_7 ] ;
F_34 ( V_4 , V_91 ) ;
F_46 ( V_4 , V_9 , V_5 , 1 ) ;
V_137 = F_31 ( V_4 ) ;
F_50 ( V_5 ) ;
...
static int F_52 ( struct V_3 * V_4 , T_7 V_136 , int V_146 )
{
return 0 ;
}
static int F_53 ( struct V_147 * V_148 , T_8 V_149 )
{
int V_7 ;
T_2 V_150 ;
struct V_14 * V_15 = F_54 ( V_148 ) ;
void T_1 * V_1 = V_15 -> V_18 ;
F_7 ( V_15 -> V_19 , L_1 , V_20 ) ;
...
static int F_55 ( struct V_147 * V_148 )
{
struct V_14 * V_15 = F_54 ( V_148 ) ;
void T_1 * V_1 = V_15 -> V_18 ;
int V_7 ;
...
V_9 -> V_158 = V_154 ;
V_9 -> V_159 = V_160 ;
V_9 -> V_161 = V_9 -> V_162 = V_163 ;
V_9 -> V_164 = 20 ;
V_9 -> V_141 = V_165 ;
V_9 -> V_166 = 0x3ffff ;
V_9 -> V_167 = V_168 ;
V_9 -> V_169 = 8 ;
V_9 -> V_115 . V_170 = & V_171 ;
V_9 -> V_115 . V_172 = V_173 ;
V_9 -> V_115 . V_116 = V_46 ;
V_9 -> V_115 . V_174 = 8 ;
V_9 -> V_115 . V_175 = 8 ;
V_9 -> V_115 . V_176 = V_177 ;
V_9 -> V_178 = V_179 | V_180 ;
V_9 -> V_12 = V_9 -> V_13 = V_15 -> V_18 + V_57 ;
V_9 -> V_181 = & V_9 -> V_182 ;
F_57 ( & V_9 -> V_181 -> V_183 ) ;
F_58 ( & V_9 -> V_181 -> V_184 ) ;
V_9 -> V_185 = F_36 ;
V_9 -> V_186 = F_14 ;
V_9 -> V_187 = F_15 ;
V_9 -> V_188 = F_27 ;
...
static int T_5 F_61 ( struct V_147 * V_148 )
{
struct V_3 * V_4 ;
struct V_8 * V_9 ;
void T_1 * V_18 ;
...
int V_6 , V_64 ;
struct V_206 * V_207 ;
struct V_208 * V_19 = & V_148 -> V_19 ;
V_207 = F_62 ( V_148 , V_209 , 0 ) ;
if ( V_207 == NULL ) {
F_13 ( V_19 , L_36 ) ;
return - V_205 ;
}
...
V_15 -> V_19 = V_19 ;
F_56 ( V_4 ) ;
V_15 -> V_47 = F_65 ( V_214 , V_177 , V_215 ) ;
if ( V_15 -> V_47 == NULL ) {
V_64 = - V_216 ;
goto V_211;
}
...
if ( V_64 )
goto V_211;
V_64 = F_68 ( V_4 , V_217 , NULL , NULL , 0 ) ;
if ( V_64 )
goto V_211;
V_15 -> V_4 = V_4 ;
return 0 ;
...
static int T_9 F_72 ( struct V_147 * V_148 )
{
struct V_14 * V_15 = F_54 ( V_148 ) ;
F_70 ( V_15 -> V_4 ) ;
F_71 ( V_15 -> V_47 ) ;
