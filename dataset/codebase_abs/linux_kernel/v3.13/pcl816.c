...
const struct V_82 * V_83 = F_26 ( V_2 ) ;
struct V_23 * V_24 = V_2 -> V_25 ;
unsigned int V_86 = 0 , V_87 = 0 , V_47 , V_98 , V_99 ;
...
F_35 ( V_2 , - 1 , 0 , 0 ) ;
V_100 = F_33 ( V_2 , V_4 , V_69 -> V_97 , V_69 -> V_81 ) ;
if ( V_100 < 1 )
return - V_101 ;
F_36 ( V_2 , V_4 , V_69 -> V_97 , V_100 ) ;
F_7 ( 1 ) ;
V_24 -> V_37 = V_69 -> V_81 ;
V_24 -> V_38 = 0 ;
V_4 -> V_29 -> V_36 = 0 ;
...
V_98 = V_24 -> V_53 [ 0 ] ;
if ( ! V_24 -> V_39 ) {
V_98 = V_4 -> V_29 -> V_69 . V_81 *
V_4 -> V_29 -> V_69 . V_81 *
sizeof( short ) ;
V_24 -> V_50 = V_98 /
V_24 -> V_53 [ 0 ] ;
V_24 -> V_54 = V_98 % V_24 -> V_53 [ 0 ] ;
V_24 -> V_50 -- ;
if ( V_24 -> V_50 >= 0 )
V_98 = V_24 -> V_53 [ 0 ] ;
} else
...
V_99 = ( ( V_24 -> V_48 & 0x3 ) << 4 ) | ( V_2 -> V_21 & 0x7 ) ;
switch ( V_69 -> V_73 ) {
case V_91 :
V_24 -> V_58 = V_59 ;
F_3 ( 0x32 , V_2 -> V_10 + V_11 ) ;
F_3 ( V_99 , V_2 -> V_10 + V_17 ) ;
break;
default:
V_24 -> V_58 = V_60 ;
...
struct V_23 * V_24 = V_2 -> V_25 ;
unsigned long V_96 ;
unsigned int V_104 , V_105 , V_44 ;
if ( ! V_24 -> V_48 )
return 0 ;
F_39 ( & V_2 -> V_106 , V_96 ) ;
for ( V_44 = 0 ; V_44 < 20 ; V_44 ++ ) {
V_104 = F_40 ( V_24 -> V_48 ) ;
...
V_104 = V_24 -> V_53 [ 0 ] - V_104 ;
V_104 >>= 1 ;
V_105 = V_104 - V_24 -> V_56 ;
if ( V_105 < 1 ) {
F_41 ( & V_2 -> V_106 , V_96 ) ;
return 0 ;
}
...
V_24 -> V_56 = V_104 ;
F_41 ( & V_2 -> V_106 , V_96 ) ;
return V_4 -> V_29 -> V_107 - V_4 -> V_29 -> V_108 ;
}
...
F_7 ( 1 ) ;
F_3 ( 0 , V_2 -> V_10 + V_11 ) ;
F_3 ( 0xb0 , V_2 -> V_10 + V_109 ) ;
F_3 ( 0x70 , V_2 -> V_10 + V_109 ) ;
F_3 ( 0 , V_2 -> V_10 + V_16 ) ;
F_6 ( V_2 -> V_10 + V_16 ) ;
F_6 ( V_2 -> V_10 + V_19 ) ;
F_3 ( 0 , V_2 -> V_10 + V_12 ) ;
...
F_3 ( 0xb0 , V_2 -> V_10 + V_109 ) ;
F_3 ( 0x70 , V_2 -> V_10 + V_109 ) ;
F_3 ( 0x30 , V_2 -> V_10 + V_109 ) ;
F_3 ( 0 , V_2 -> V_10 + V_15 ) ;
}
static void
F_35 ( struct V_1 * V_2 , int V_111 , unsigned int V_86 ,
unsigned int V_87 )
{
F_3 ( 0x32 , V_2 -> V_10 + V_109 ) ;
F_3 ( 0xff , V_2 -> V_10 + V_112 ) ;
F_3 ( 0x00 , V_2 -> V_10 + V_112 ) ;
F_7 ( 1 ) ;
F_3 ( 0xb4 , V_2 -> V_10 + V_109 ) ;
F_3 ( 0x74 , V_2 -> V_10 + V_109 ) ;
F_7 ( 1 ) ;
if ( V_111 == 1 ) {
F_2 ( L_16 , V_111 , V_86 ,
V_87 ) ;
F_3 ( V_87 & 0xff , V_2 -> V_10 + V_113 ) ;
F_3 ( ( V_87 >> 8 ) & 0xff , V_2 -> V_10 + V_113 ) ;
F_3 ( V_86 & 0xff , V_2 -> V_10 + V_114 ) ;
F_3 ( ( V_86 >> 8 ) & 0xff , V_2 -> V_10 + V_114 ) ;
}
}
static int
F_33 ( struct V_1 * V_2 ,
struct V_3 * V_4 , unsigned int * V_97 ,
unsigned int V_115 )
{
unsigned int V_116 [ 16 ] ;
unsigned int V_44 , V_117 , V_100 , V_118 ;
if ( V_115 < 1 ) {
F_8 ( V_2 , L_17 ) ;
return 0 ;
}
if ( V_115 > 1 ) {
V_116 [ 0 ] = V_97 [ 0 ] ;
for ( V_44 = 1 , V_100 = 1 ; V_44 < V_115 ; V_44 ++ , V_100 ++ ) {
...
break;
V_117 =
( F_4 ( V_116 [ V_44 - 1 ] ) + 1 ) % V_115 ;
if ( V_117 != F_4 ( V_97 [ V_44 ] ) ) {
F_24 ( V_119
L_19
L_20
L_21 , V_2 -> V_120 ,
V_44 , F_4 ( V_97 [ V_44 ] ) , V_117 ,
F_4 ( V_97 [ 0 ] ) ) ;
return 0 ;
}
V_116 [ V_44 ] = V_97 [ V_44 ] ;
}
for ( V_44 = 0 , V_118 = 0 ; V_44 < V_115 ; V_44 ++ ) {
F_27 (printk(L_22,
CR_CHAN(chansegment[i % seglen]),
CR_RANGE(chansegment[i % seglen]),
CR_CHAN(chanlist[i]),
CR_RANGE(chanlist[i]));)
if ( V_97 [ V_44 ] != V_116 [ V_44 % V_100 ] ) {
F_24 ( V_119
L_23
L_24
L_25 , V_2 -> V_120 , V_44 ,
...
V_24 -> V_121 [ V_44 ] = F_4 ( V_97 [ V_44 ] ) ;
F_3 ( F_4 ( V_97 [ 0 ] ) & 0xf , V_2 -> V_10 + V_14 ) ;
F_3 ( F_5 ( V_97 [ 0 ] ) , V_2 -> V_10 + V_15 ) ;
}
F_7 ( 1 ) ;
F_3 ( V_24 -> V_121 [ 0 ] |
( V_24 -> V_121 [ V_100 - 1 ] << 4 ) ,
V_2 -> V_10 + V_14 ) ;
}
static int F_45 ( struct V_1 * V_2 , struct V_122 * V_123 )
{
const struct V_82 * V_83 = F_26 ( V_2 ) ;
struct V_23 * V_24 ;
int V_124 ;
...
unsigned long V_125 ;
struct V_3 * V_4 ;
V_124 = F_46 ( V_2 , V_123 -> V_126 [ 0 ] , V_83 -> V_127 ) ;
if ( V_124 )
return V_124 ;
if ( F_42 ( V_2 -> V_10 ) ) {
F_24 ( V_128 L_26 ) ;
...
if ( V_48 < 1 )
goto V_132;
if ( ( ( 1 << V_48 ) & V_83 -> V_133 ) == 0 ) {
F_24 ( L_31 ) ;
return - V_101 ;
}
V_124 = F_49 ( V_48 , V_2 -> V_131 ) ;
if ( V_124 ) {
F_24 ( V_128
L_32 , V_48 ) ;
return - V_102 ;
...
V_24 -> V_53 [ 0 ] = ( 1 << V_125 ) * V_136 ;
V_24 -> V_55 [ 1 ] = F_50 ( V_134 , V_125 ) ;
if ( ! V_24 -> V_55 [ 1 ] ) {
F_24 ( V_128
L_35
L_36 ) ;
...
V_24 -> V_139 = V_4 ;
V_2 -> V_140 = V_4 ;
V_4 -> V_141 = V_142 | V_143 ;
V_4 -> V_144 = V_83 -> V_137 ;
V_4 -> V_141 |= V_145 ;
V_4 -> V_146 = V_83 -> V_147 ;
V_4 -> V_148 = V_83 -> V_149 ;
V_4 -> V_150 = V_83 -> V_151 ;
V_4 -> V_152 = F_10 ;
V_4 -> V_153 = F_25 ;
V_4 -> V_154 = F_34 ;
V_4 -> V_155 = F_38 ;
...
F_54 ( V_24 -> V_48 ) ;
if ( V_24 -> V_55 [ 0 ] )
F_55 ( V_24 -> V_55 [ 0 ] , V_24 -> V_135 [ 0 ] ) ;
if ( V_24 -> V_55 [ 1 ] )
F_55 ( V_24 -> V_55 [ 1 ] , V_24 -> V_135 [ 1 ] ) ;
}
F_56 ( V_2 ) ;
}
