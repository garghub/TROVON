...
goto V_37;
V_5 -> V_38 = V_18 ;
V_5 -> V_6 = & V_26 [ V_5 -> V_38 ] ;
V_5 -> V_2 = F_22 ( L_3 , V_5 -> V_38 ) ;
if ( ! V_5 -> V_2 ) {
V_18 = - V_35 ;
goto V_37;
}
V_5 -> V_2 -> V_39 = & V_40 ;
V_5 -> V_2 -> V_11 . V_41 = V_42 ;
F_23 ( V_5 -> V_2 , V_5 ) ;
V_18 = F_24 ( V_5 -> V_2 ) ;
if ( V_18 )
goto V_43;
...
V_5 -> V_49 = true ;
V_18 = F_26 ( V_5 -> V_6 -> V_50 , V_5 -> V_2 -> V_44 ) ;
if ( V_18 )
goto V_51;
V_16 = ( unsigned long long ) F_10 () * V_31 -> V_52 ;
F_27 ( V_16 , V_53 ) ;
V_5 -> V_19 = V_16 ;
if ( V_31 -> V_54 )
V_33 |= V_55 ;
