...
static void * F_138 ( struct V_1 * V_2 , T_7 * V_128 )
{
struct V_3 * V_4 ;
T_7 V_129 = * V_128 ;
int V_130 ;
...
static void * F_141 ( struct V_1 * V_2 , void * V_131 , T_7 * V_128 )
{
struct V_3 * V_132 = V_131 ;
struct V_3 * V_133 = NULL ;
struct V_3 * V_134 = V_132 ;
++ ( * V_128 ) ;
...
static void F_143 ( struct V_1 * V_2 , void * V_131 )
{
if ( ! F_78 ( V_131 ) ) {
F_32 () ;
F_132 ( & V_126 ) ;
...
static int F_144 ( struct V_1 * V_2 , void * V_131 )
{
...
static int F_145 ( struct V_135 * V_135 , struct V_136 * V_136 )
{
return F_146 ( V_136 , & V_137 ) ;
}
static int F_147 ( struct V_135 * V_135 , struct V_136 * V_136 )
{
return F_148 ( V_135 , V_136 ) ;
}
static int F_149 ( const char * V_138 )
{
unsigned long V_21 ;
struct V_3 * V_4 ;
unsigned long V_139 ;
if ( F_150 ( V_138 , 0 , & V_139 ) )
return - V_140 ;
V_4 = F_28 ( V_139 , 0 ) ;
if ( ! V_4 ) {
F_127 ( L_41 , V_139 ) ;
...
static T_8 F_152 ( struct V_136 * V_136 , const char T_9 * V_141 ,
V_13 V_12 , T_7 * V_142 )
{
char V_143 [ 64 ] ;
int V_144 ;
...
if ( ! F_58 ( & V_79 ) )
return - V_146 ;
V_144 = F_2 ( V_12 , ( sizeof( V_143 ) - 1 ) ) ;
if ( F_153 ( V_143 , V_141 , V_144 ) < 0 )
return - V_147 ;
V_143 [ V_144 ] = 0 ;
V_145 = F_139 ( & V_126 ) ;
if ( V_145 < 0 )
return V_145 ;
if ( strncmp ( V_143 , L_42 , 3 ) == 0 )
F_39 () ;
else if ( strncmp ( V_143 , L_43 , 8 ) == 0 )
V_114 = 1 ;
else if ( strncmp ( V_143 , L_44 , 9 ) == 0 )
V_114 = 0 ;
else if ( strncmp ( V_143 , L_45 , 7 ) == 0 )
F_134 () ;
else if ( strncmp ( V_143 , L_46 , 8 ) == 0 )
F_136 () ;
else if ( strncmp ( V_143 , L_47 , 5 ) == 0 ) {
unsigned long V_148 ;
V_145 = F_150 ( V_143 + 5 , 0 , & V_148 ) ;
if ( V_145 < 0 )
goto V_66;
F_136 () ;
if ( V_148 ) {
V_125 = F_154 ( V_148 * 1000 ) ;
F_134 () ;
}
} else if ( strncmp ( V_143 , L_48 , 4 ) == 0 )
F_110 () ;
else if ( strncmp ( V_143 , L_49 , 5 ) == 0 )
F_151 () ;
else if ( strncmp ( V_143 , L_50 , 5 ) == 0 )
V_145 = F_149 ( V_143 + 5 ) ;
else
V_145 = - V_140 ;
V_66:
...
static int F_158 ( char * V_138 )
{
if ( ! V_138 )
return - V_140 ;
if ( strcmp ( V_138 , L_42 ) == 0 )
F_39 () ;
else if ( strcmp ( V_138 , L_52 ) == 0 )
V_154 = 1 ;
else
return - V_140 ;
return 0 ;
...
#endif
V_24 = F_154 ( V_155 ) ;
V_125 = F_154 ( V_156 * 1000 ) ;
V_50 = F_162 ( V_3 , V_157 ) ;
V_49 = F_162 ( V_46 , V_157 ) ;
if ( V_78 >= F_74 ( V_76 ) )
F_38 ( L_54
L_55 , V_78 ) ;
F_75 ( V_21 ) ;
...
V_159 = F_164 ( L_39 , V_161 , NULL , NULL ,
& V_162 ) ;
if ( ! V_159 )
F_38 ( L_57 ) ;
F_131 ( & V_126 ) ;
