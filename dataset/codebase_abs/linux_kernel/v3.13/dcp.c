...
V_4 -> V_6 = F_78 ( & V_126 -> V_4 , V_128 ) ;
if ( F_49 ( V_4 -> V_6 ) )
return F_50 ( V_4 -> V_6 ) ;
F_4 ( V_4 , V_132 , V_133 ) ;
F_79 ( 10 ) ;
F_5 ( V_4 , V_132 | V_134 , V_133 ) ;
F_2 ( V_4 , V_135 |
V_136 | V_137 ,
V_133 ) ;
F_2 ( V_4 , V_138 , V_139 ) ;
...
F_5 ( V_4 , - 1 , V_71 ) ;
V_128 = F_77 ( V_126 , V_140 , 0 ) ;
if ( ! V_128 ) {
F_14 ( & V_126 -> V_4 , L_9 ) ;
return - V_141 ;
}
V_4 -> F_34 = V_128 -> V_142 ;
V_102 = F_80 ( & V_126 -> V_4 , V_4 -> F_34 , F_34 , 0 ,
L_10 , V_4 ) ;
if ( V_102 != 0 ) {
F_14 ( & V_126 -> V_4 , L_11 ) ;
return - V_141 ;
}
V_128 = F_77 ( V_126 , V_140 , 1 ) ;
if ( ! V_128 ) {
F_14 ( & V_126 -> V_4 , L_12 ) ;
return - V_141 ;
}
V_4 -> F_35 = V_128 -> V_142 ;
V_102 = F_80 ( & V_126 -> V_4 , V_4 -> F_35 , F_35 , 0 , L_10 ,
V_4 ) ;
if ( V_102 != 0 ) {
F_14 ( & V_126 -> V_4 , L_13 ) ;
return - V_141 ;
}
V_4 -> V_39 [ 0 ] = F_81 ( & V_126 -> V_4 ,
...
V_4 -> V_39 [ V_129 - 1 ] -> V_143 = V_4 -> V_59
+ V_129 * sizeof( struct V_7 ) ;
V_4 -> V_39 [ V_129 ] = V_4 -> V_39 [ V_129 - 1 ] + 1 ;
}
V_4 -> V_39 [ V_129 - 1 ] -> V_143 = V_4 -> V_59 ;
V_4 -> V_46 = F_81 ( & V_126 -> V_4 , 2 * V_77 ,
& V_4 -> V_26 , V_123 ) ;
if ( ! V_4 -> V_46 ) {
F_14 ( & V_126 -> V_4 , L_15 ) ;
V_102 = - V_19 ;
...
V_4 -> V_114 . V_146 = V_147 ,
V_4 -> V_114 . V_92 = L_16 ,
V_4 -> V_114 . V_148 = & V_149 ,
V_102 = F_86 ( & V_4 -> V_114 ) ;
if ( V_102 != 0 ) {
F_14 ( V_4 -> V_4 , L_17 ) ;
goto V_150;
}
for ( V_129 = 0 ; V_129 < F_87 ( V_151 ) ; V_129 ++ ) {
V_151 [ V_129 ] . V_152 = 300 ;
V_151 [ V_129 ] . V_153 = sizeof( struct V_21 ) ;
V_151 [ V_129 ] . V_154 = V_155 ;
V_151 [ V_129 ] . V_156 = F_46 ;
V_151 [ V_129 ] . V_157 = F_51 ;
if ( F_88 ( & V_151 [ V_129 ] ) ) {
F_14 ( & V_126 -> V_4 , L_18 ) ;
V_102 = - V_19 ;
goto V_158;
...
static int F_93 ( struct V_125 * V_126 )
{
struct V_3 * V_4 ;
int V_130 ;
V_4 = F_94 ( V_126 ) ;
F_95 ( & V_4 -> V_114 ) ;
for ( V_130 = 0 ; V_130 < F_87 ( V_151 ) ; V_130 ++ )
F_90 ( & V_151 [ V_130 ] ) ;
F_91 ( & V_4 -> V_74 ) ;
F_91 ( & V_4 -> V_66 ) ;
F_92 ( & V_126 -> V_4 , 2 * V_77 , V_4 -> V_46 ,
