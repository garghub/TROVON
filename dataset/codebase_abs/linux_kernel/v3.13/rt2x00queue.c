...
F_76 ( & V_45 -> V_176 ) ;
F_15 ( V_45 -> V_175 ) ;
if ( V_8 -> V_133 -> V_134 -> V_177 )
V_8 -> V_133 -> V_134 -> V_177 ( V_45 -> V_175 ) ;
F_77 ( & V_45 -> V_176 ) ;
return 0 ;
}
...
return - V_168 ;
F_15 ( V_45 -> V_175 ) ;
V_45 -> V_175 -> V_9 = F_79 ( V_8 -> V_117 , V_47 ) ;
if ( ! V_45 -> V_175 -> V_9 )
return - V_29 ;
...
memset ( V_11 , 0 , sizeof( * V_11 ) ) ;
V_11 -> V_3 = V_45 -> V_175 ;
V_8 -> V_133 -> V_134 -> V_178 ( V_45 -> V_175 , & V_39 ) ;
return 0 ;
}
...
bool F_81 ( struct V_5 * V_6 ,
enum V_179 V_180 ,
enum V_179 V_181 ,
void * V_22 ,
bool (* F_82)( struct V_2 * V_3 ,
void * V_22 ) )
{
unsigned long V_182 ;
unsigned int V_183 ;
unsigned int V_184 ;
unsigned int V_185 ;
if ( F_9 ( V_180 >= V_186 || V_181 >= V_186 ) ) {
F_52 ( V_6 -> V_8 ,
L_5 ,
V_180 , V_181 ) ;
return true ;
}
F_83 ( & V_6 -> V_187 , V_182 ) ;
V_183 = V_6 -> V_188 [ V_180 ] ;
V_184 = V_6 -> V_188 [ V_181 ] ;
F_84 ( & V_6 -> V_187 , V_182 ) ;
if ( V_183 < V_184 ) {
for ( V_185 = V_183 ; V_185 < V_184 ; V_185 ++ ) {
if ( F_82 ( & V_6 -> V_189 [ V_185 ] , V_22 ) )
return true ;
}
} else {
for ( V_185 = V_183 ; V_185 < V_6 -> V_190 ; V_185 ++ ) {
if ( F_82 ( & V_6 -> V_189 [ V_185 ] , V_22 ) )
return true ;
}
...
F_83 ( & V_6 -> V_187 , V_182 ) ;
V_3 = & V_6 -> V_189 [ V_6 -> V_188 [ V_188 ] ] ;
F_84 ( & V_6 -> V_187 , V_182 ) ;
return V_3 ;
}
void F_73 ( struct V_2 * V_3 , enum V_179 V_188 )
{
struct V_5 * V_6 = V_3 -> V_6 ;
unsigned long V_182 ;
if ( F_9 ( V_188 >= V_186 ) ) {
...
{
F_76 ( & V_6 -> V_202 ) ;
if ( ! F_89 ( V_199 , & V_6 -> V_25 ) ) {
F_77 ( & V_6 -> V_202 ) ;
return;
}
F_85 ( V_6 ) ;
V_6 -> V_8 -> V_133 -> V_134 -> V_204 ( V_6 ) ;
F_77 ( & V_6 -> V_202 ) ;
}
void F_93 ( struct V_5 * V_6 , bool V_205 )
{
bool V_206 =
( V_6 -> V_136 == V_194 ) ||
( V_6 -> V_136 == V_195 ) ||
...
if ( ! V_205 && V_206 )
V_6 -> V_8 -> V_133 -> V_134 -> V_143 ( V_6 ) ;
if ( F_58 ( V_6 -> V_8 -> V_133 -> V_134 -> V_207 ) )
V_6 -> V_8 -> V_133 -> V_134 -> V_207 ( V_6 , V_205 ) ;
if ( F_9 ( ! F_94 ( V_6 ) ) )
F_95 ( V_6 -> V_8 , L_8 ,
V_6 -> V_136 ) ;
}
...
void F_100 ( struct V_7 * V_8 , bool V_205 )
{
struct V_5 * V_6 ;
F_97 (rt2x00dev, queue)
F_93 ( V_6 , V_205 ) ;
F_93 ( V_8 -> V_208 , V_205 ) ;
}
...
F_101 ( V_6 ) ;
for ( V_185 = 0 ; V_185 < V_6 -> V_190 ; V_185 ++ )
V_8 -> V_133 -> V_134 -> V_209 ( & V_6 -> V_189 [ V_185 ] ) ;
}
}
...
unsigned int V_185 ;
F_101 ( V_6 ) ;
V_210 = sizeof( * V_189 ) + V_6 -> V_211 ;
V_189 = F_105 ( V_6 -> V_190 , V_210 , V_212 ) ;
if ( ! V_189 )
return - V_29 ;
...
V_189 [ V_185 ] . V_25 = 0 ;
V_189 [ V_185 ] . V_6 = V_6 ;
V_189 [ V_185 ] . V_9 = NULL ;
V_189 [ V_185 ] . V_213 = V_185 ;
V_189 [ V_185 ] . V_214 =
F_106 ( V_189 , V_185 , V_6 -> V_190 ,
sizeof( * V_189 ) , V_6 -> V_211 ) ;
}
#undef F_106
V_6 -> V_189 = V_189 ;
return 0 ;
...
struct V_1 * V_9 ;
for ( V_185 = 0 ; V_185 < V_6 -> V_190 ; V_185 ++ ) {
V_9 = F_1 ( & V_6 -> V_189 [ V_185 ] , V_212 ) ;
if ( ! V_9 )
return - V_29 ;
V_6 -> V_189 [ V_185 ] . V_9 = V_9 ;
}
return 0 ;
}
...
V_215 = F_104 ( V_8 -> V_216 ) ;
if ( V_215 )
goto exit;
if ( F_7 ( V_217 , & V_8 -> V_19 ) ) {
V_215 = F_104 ( V_8 -> V_218 ) ;
if ( V_215 )
goto exit;
}
V_215 = F_108 ( V_8 -> V_208 ) ;
if ( V_215 )
goto exit;
return 0 ;
exit:
...
struct V_5 * V_6 , enum V_219 V_136 )
{
F_113 ( & V_6 -> V_202 ) ;
F_114 ( & V_6 -> V_167 ) ;
F_114 ( & V_6 -> V_187 ) ;
...
unsigned int V_225 =
! ! F_7 ( V_217 , & V_8 -> V_19 ) ;
V_8 -> V_226 = 2 + V_8 -> V_133 -> V_227 + V_225 ;
V_6 = F_105 ( V_8 -> V_226 , sizeof( * V_6 ) , V_212 ) ;
if ( ! V_6 ) {
F_52 ( V_8 , L_10 ) ;
return - V_29 ;
}
V_8 -> V_208 = V_6 ;
V_8 -> V_228 = & V_6 [ 1 ] ;
V_8 -> V_216 = & V_6 [ 1 + V_8 -> V_133 -> V_227 ] ;
V_8 -> V_218 = V_225 ? & V_6 [ 2 + V_8 -> V_133 -> V_227 ] : NULL ;
F_112 ( V_8 , V_8 -> V_208 , V_201 ) ;
V_136 = V_194 ;
F_97 (rt2x00dev, queue)
F_112 ( V_8 , V_6 , V_136 ++ ) ;
F_112 ( V_8 , V_8 -> V_216 , V_229 ) ;
if ( V_225 )
F_112 ( V_8 , V_8 -> V_218 , V_230 ) ;
return 0 ;
}
