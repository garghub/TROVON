...
V_15 -> V_29 = F_24 ( & V_14 -> V_21 -> V_22 ) << 9 ;
V_15 -> V_30 = F_25 ( F_24 ( & V_14 -> V_21 -> V_22 ) ,
V_31 ) ;
V_15 -> V_26 = & V_14 -> V_12 ;
V_15 -> V_32 = V_15 -> V_33 ;
F_26 ( V_15 , NULL ) ;
...
{
struct V_13 * V_14 = F_2 ( V_12 , struct V_13 , V_12 ) ;
struct V_34 * V_19 = & V_14 -> V_19 ;
if ( ! V_19 -> error ) {
F_19 ( V_14 ) ;
V_14 -> V_15 . V_15 . V_35 = F_28 ( & V_14 -> V_21 -> V_22 ) ;
V_19 -> V_36 = 1 ;
V_19 -> V_15 = & V_14 -> V_15 . V_15 ;
V_19 -> V_37 = F_16 ( & V_14 -> V_21 -> V_22 ) ;
V_19 -> V_38 = F_29 ( & V_14 -> V_21 -> V_22 ) ;
F_30 ( & V_19 -> V_39 , & V_14 -> V_21 -> V_22 ) ;
V_19 -> V_40 = true ;
F_31 ( & V_19 -> V_12 , V_41 , NULL , V_12 ) ;
}
F_32 ( V_12 , F_8 , V_42 ) ;
}
...
* F_25 ( F_24 ( & V_21 -> V_22 ) , V_31 ) ,
V_47 ) ;
if ( ! V_14 )
goto V_48;
V_21 -> V_49 = V_14 ;
V_14 -> V_21 = V_21 ;
V_14 -> V_19 . V_50 = F_40 ( & V_21 -> V_22 ) ;
V_14 -> V_19 . V_6 = V_6 ;
F_19 ( V_14 ) ;
V_15 = & V_14 -> V_15 . V_15 ;
V_15 -> V_51 = V_52 ;
...
if ( 0 ) {
V_48: if ( ! F_44 ( V_21 -> V_49 ) )
F_7 ( V_21 -> V_49 ) ;
F_12 ( & V_6 -> V_7 , V_21 ) ;
}
F_45 ( & V_12 ) ;
}
static bool F_46 ( struct V_9 * V_54 , struct V_9 * V_55 )
{
return F_47 ( V_54 ) < F_47 ( V_55 ) ;
}
static unsigned F_48 ( struct V_56 * V_57 )
{
struct V_9 * V_25 ;
return ( V_25 = F_49 ( & V_57 -> V_58 ) ) ? F_47 ( V_25 ) : 0 ;
}
...
F_52 (ca, c, i) {
unsigned V_61 = 0 ;
unsigned V_62 = V_57 -> V_63 . V_64 *
F_53 ( F_54 ( & V_57 -> free ) , V_57 -> free . V_65 / 2 ) ;
V_57 -> V_58 . V_66 = 0 ;
F_55 (b, ca) {
if ( ! F_47 ( V_25 ) )
continue;
if ( ! F_56 ( & V_57 -> V_58 ) ) {
V_61 += F_47 ( V_25 ) ;
F_57 ( & V_57 -> V_58 , V_25 , F_46 ) ;
} else if ( F_46 ( V_25 , F_49 ( & V_57 -> V_58 ) ) ) {
V_61 -= F_48 ( V_57 ) ;
V_61 += F_47 ( V_25 ) ;
V_57 -> V_58 . V_67 [ 0 ] = V_25 ;
F_58 ( & V_57 -> V_58 , 0 , F_46 ) ;
}
}
while ( V_61 > V_62 ) {
F_59 ( & V_57 -> V_58 , V_25 , F_46 ) ;
V_61 -= F_47 ( V_25 ) ;
}
while ( F_59 ( & V_57 -> V_58 , V_25 , F_46 ) )
F_60 ( V_25 , 1 ) ;
}
F_61 ( & V_6 -> V_60 ) ;
V_6 -> V_7 . V_68 = V_69 ;
