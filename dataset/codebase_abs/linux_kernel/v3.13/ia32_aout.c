...
V_122 = F_34 ( V_91 ) ;
V_123 = V_91 . V_99 + V_91 . V_100 ;
error = F_7 ( V_122 & V_124 , V_123 ) ;
if ( error != ( V_122 & V_124 ) ) {
F_38 ( V_121 , V_4 , 0 ) ;
return error ;
}
error = F_40 ( V_78 -> V_98 , V_122 , 32 ,
...
#ifdef F_41
static unsigned long V_125 , V_126 ;
if ( ( V_91 . V_99 & 0xfff || V_91 . V_100 & 0xfff ) &&
( F_22 ( V_91 ) != V_97 ) &&
F_42 ( V_127 , V_126 + 5 * V_128 ) ) {
F_43 ( V_129 L_1 ) ;
V_126 = V_127 ;
}
if ( ( V_88 & ~ V_124 ) != 0 &&
F_42 ( V_127 , V_125 + 5 * V_128 ) ) {
F_43 ( V_130
L_2
L_3 ,
V_78 -> V_98 -> V_131 . V_132 -> V_133 . V_134 ) ;
V_125 = V_127 ;
}
#endif
if ( ! V_78 -> V_98 -> V_135 -> V_136 || ( V_88 & ~ V_124 ) != 0 ) {
F_7 ( F_34 ( V_91 ) , V_91 . V_99 + V_91 . V_100 ) ;
F_40 ( V_78 -> V_98 , F_34 ( V_91 ) , V_88 ,
V_91 . V_99 + V_91 . V_100 ) ;
goto V_137;
}
error = F_44 ( V_78 -> V_98 , F_34 ( V_91 ) , V_91 . V_99 ,
V_138 | V_139 ,
V_140 | V_141 | V_142 |
V_143 | V_144 ,
V_88 ) ;
...
error = F_44 ( V_78 -> V_98 , F_35 ( V_91 ) , V_91 . V_100 ,
V_138 | V_145 | V_139 ,
V_140 | V_141 | V_142 |
V_143 | V_144 ,
V_88 + V_91 . V_99 ) ;
...
static int F_48 ( struct V_98 * V_98 )
{
unsigned long V_149 , V_150 , V_151 , error ;
int V_92 ;
struct V_90 V_91 ;
V_92 = - V_101 ;
error = F_49 ( V_98 , 0 , ( char * ) & V_91 , sizeof( V_91 ) ) ;
if ( error != sizeof( V_91 ) )
goto V_152;
if ( ( F_22 ( V_91 ) != V_94 && F_22 ( V_91 ) != V_96 ) || F_23 ( V_91 ) ||
F_24 ( V_91 ) || ( ( V_91 . V_148 & 0xfff ) && F_22 ( V_91 ) == V_94 ) ||
F_25 ( F_26 ( V_98 ) ) <
V_91 . V_99 + V_91 . V_100 + F_27 ( V_91 ) + F_28 ( V_91 ) ) {
goto V_152;
}
if ( F_50 ( V_91 ) )
goto V_152;
V_150 = V_91 . V_148 & 0xfffff000 ;
if ( ( F_28 ( V_91 ) & ~ V_124 ) != 0 ) {
#ifdef F_41
static unsigned long V_125 ;
if ( F_42 ( V_127 , V_125 + 5 * V_128 ) ) {
F_43 ( V_130
L_4
L_5 ,
V_98 -> V_131 . V_132 -> V_133 . V_134 ) ;
V_125 = V_127 ;
}
#endif
F_7 ( V_150 , V_91 . V_99 + V_91 . V_100 + V_91 . V_104 ) ;
F_40 ( V_98 , V_150 , F_28 ( V_91 ) ,
V_91 . V_99 + V_91 . V_100 ) ;
V_92 = 0 ;
goto V_152;
}
error = F_44 ( V_98 , V_150 , V_91 . V_99 + V_91 . V_100 ,
V_138 | V_145 | V_139 ,
V_140 | V_141 | V_142 | V_144 ,
F_28 ( V_91 ) ) ;
V_92 = error ;
if ( error != V_150 )
goto V_152;
V_151 = F_6 ( V_91 . V_99 + V_91 . V_100 ) ;
V_149 = V_91 . V_99 + V_91 . V_100 + V_91 . V_104 ;
if ( V_149 > V_151 ) {
error = F_7 ( V_150 + V_151 , V_149 - V_151 ) ;
V_92 = error ;
if ( error != V_150 + V_151 )
goto V_152;
}
V_92 = 0 ;
V_152:
