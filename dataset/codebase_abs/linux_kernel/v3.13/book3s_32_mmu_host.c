...
{
F_22 ( V_2 , V_4 -> V_60 , 0xfffffffffULL ) ;
}
...
V_64 -> V_66 = 0 ;
memset ( V_64 -> V_18 , 0 ,
sizeof( struct V_10 ) * V_68 ) ;
F_24 ( V_2 , 0 , 0 ) ;
F_25 ( V_2 ) ;
}
V_11 -> V_20 = V_64 -> V_69 [ V_64 -> V_66 ] ;
V_64 -> V_66 ++ ;
V_11 -> V_19 = V_7 ;
V_11 -> V_70 = true ;
return V_11 ;
...
T_1 V_72 ;
struct V_10 * V_11 ;
struct V_73 * V_74 = F_26 ( V_2 ) ;
int V_38 = 0 ;
if ( V_2 -> V_13 . V_45 . V_46 ( V_2 , V_71 , & V_7 ) ) {
V_74 -> V_72 [ V_71 ] = V_75 ;
V_38 = - V_76 ;
goto V_44;
}
...
int V_79 ;
struct V_73 * V_74 = F_26 ( V_2 ) ;
F_5 ( L_10 , F_28 ( V_74 -> V_72 ) ) ;
for ( V_79 = 0 ; V_79 < F_28 ( V_74 -> V_72 ) ; V_79 ++ )
V_74 -> V_72 [ V_79 ] = V_75 ;
F_27 ( V_74 ) ;
}
...
F_32 ( F_4 ( V_2 ) -> V_81 [ V_79 ] ) ;
F_33 () ;
}
int F_34 ( struct V_1 * V_2 )
{
struct V_63 * V_82 = F_4 ( V_2 ) ;
int V_83 ;
T_4 V_84 ;
int V_79 ;
int V_85 ;
...
V_82 -> V_69 [ ( V_79 * 16 ) + V_85 ] = F_36 ( V_83 , V_85 ) ;
}
V_82 -> V_66 = 0 ;
asm ( "mfsdr1 %0" : "=r"(sdr1) );
V_28 = ( ( V_84 & 0x1FF ) << 16 ) | 0xFFC0 ;
V_26 = ( T_4 ) F_37 ( V_84 & 0xffff0000 ) ;
F_38 ( V_2 ) ;
return 0 ;
V_86:
