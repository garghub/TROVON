...
static int F_55 ( struct V_106 * V_23 )
{
struct V_72 * V_73 = V_23 -> V_13 ;
int V_75 = V_151 ;
if ( V_75 == 0 )
...
{
struct V_72 * V_73 = V_23 -> V_13 ;
if ( ( V_73 -> V_153 && ! strcmp ( V_73 -> V_153 , L_31 ) ) ||
( V_73 -> V_154 && ! strcmp ( V_73 -> V_154 , L_32 ) ) )
return F_56 ( V_23 ) ;
return 0 ;
}
...
{
struct V_155 * V_156 = V_23 -> V_13 -> V_157 [ 1 ] ;
struct V_121 * V_122 = & V_156 -> V_111 ;
if ( V_156 -> V_158 && V_122 -> V_128 == 0 ) {
V_122 -> V_128 = F_35 ( 0x40 ) ;
F_33 ( & V_23 -> V_13 -> V_13 ,
L_33 ) ;
}
...
static int F_61 ( struct V_29 * V_30 , struct V_6 * V_7 )
{
...
if ( V_30 )
F_62 ( V_30 , V_7 , NULL ) ;
return F_63 ( V_30 , V_7 ) ;
}
static void F_64 ( struct V_6 * V_7 , int V_162 )
{
struct V_10 * V_11 = F_8 ( V_7 ) ;
if ( ! V_162 ) {
...
V_11 = F_8 ( V_7 ) ;
if ( V_11 -> V_38 == V_39 ) {
unsigned char * V_167 = V_165 ;
int V_126 , V_168 , V_169 ;
V_133 = 0 ;
F_68 ( & V_7 -> V_170 , V_33 ) ;
for ( V_126 = 0 ; V_126 < V_166 - 1 ; V_126 += V_11 -> V_129 ) {
V_168 = F_69 ( int , V_166 - V_126 , V_11 -> V_129 ) - 1 ;
V_169 = F_70 ( & V_7 -> V_171 , & V_167 [ V_126 + 1 ] , V_168 ) ;
if ( ! V_169 )
break;
V_7 -> V_172 . V_173 += V_169 ;
V_167 [ V_126 ] = ( V_169 << 2 ) + 1 ;
V_133 += V_169 + 1 ;
}
F_71 ( & V_7 -> V_170 , V_33 ) ;
} else {
V_133 = F_72 ( & V_7 -> V_171 , V_165 , V_166 ,
& V_7 -> V_170 ) ;
V_7 -> V_172 . V_173 += V_133 ;
}
return V_133 ;
}
static int F_73 ( struct V_6 * V_7 ,
struct V_10 * V_11 , char * V_174 , int V_168 )
{
int V_126 ;
char V_175 ;
char V_176 ;
...
V_7 -> V_172 . V_194 ++ ;
F_78 ( V_7 ) ;
} else if ( V_174 [ 1 ] & V_195 ) {
V_176 = V_196 ;
V_7 -> V_172 . V_197 ++ ;
} else if ( V_174 [ 1 ] & V_198 ) {
V_176 = V_199 ;
V_7 -> V_172 . V_200 ++ ;
}
if ( V_174 [ 1 ] & V_201 ) {
V_7 -> V_172 . V_202 ++ ;
F_79 ( & V_7 -> V_7 , 0 , V_203 ) ;
}
}
if ( V_174 [ 1 ] & V_204 )
V_11 -> V_104 = 1 ;
...
if ( ! V_168 )
return 0 ;
V_7 -> V_172 . V_205 += V_168 ;
V_177 = V_174 + 2 ;
if ( V_7 -> V_7 . V_206 && V_7 -> V_207 ) {
for ( V_126 = 0 ; V_126 < V_168 ; V_126 ++ , V_177 ++ ) {
if ( ! F_80 ( V_7 , * V_177 ) )
F_79 ( & V_7 -> V_7 , * V_177 , V_176 ) ;
}
} else {
F_81 ( & V_7 -> V_7 , V_177 , V_176 , V_168 ) ;
}
return V_168 ;
}
static void F_82 ( struct V_208 * V_208 )
{
struct V_6 * V_7 = V_208 -> V_209 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
char * V_210 = ( char * ) V_208 -> V_211 ;
int V_126 ;
int V_168 ;
int V_133 = 0 ;
for ( V_126 = 0 ; V_126 < V_208 -> V_212 ; V_126 += V_11 -> V_129 ) {
V_168 = F_69 ( int , V_208 -> V_212 - V_126 , V_11 -> V_129 ) ;
V_133 += F_73 ( V_7 , V_11 , & V_210 [ V_126 ] , V_168 ) ;
}
if ( V_133 )
F_83 ( & V_7 -> V_7 ) ;
}
static void F_84 ( struct V_29 * V_30 , int V_213 )
{
struct V_6 * V_7 = V_30 -> V_214 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
T_2 V_14 ;
if ( V_213 )
V_14 = V_11 -> V_215 | V_216 ;
else
V_14 = V_11 -> V_215 ;
if ( F_10 ( V_7 -> V_23 -> V_13 ,
F_11 ( V_7 -> V_23 -> V_13 , 0 ) ,
...
static bool F_85 ( struct V_6 * V_7 )
{
...
struct V_6 * V_7 , struct V_219 * V_220 )
{
struct V_72 * V_13 = V_7 -> V_23 -> V_13 ;
struct V_12 * V_221 = & V_7 -> V_13 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
struct V_219 * V_222 = & V_30 -> V_222 ;
unsigned int V_223 = V_222 -> V_224 ;
T_2 V_14 ;
unsigned int V_225 = V_222 -> V_226 ;
unsigned char V_227 ;
unsigned char V_228 ;
if ( V_11 -> V_149 && ( ( V_222 -> V_224 & V_229 ) != V_230 ) ) {
F_9 ( V_221 , L_38 , V_18 ) ;
...
if ( ( F_87 ( V_30 ) != V_232 ) && ( F_87 ( V_30 ) != V_233 ) ) {
F_88 ( V_221 , L_40 ) ;
V_222 -> V_224 &= ~ V_234 ;
if ( V_220 )
V_222 -> V_224 |= V_220 -> V_224 & V_234 ;
else
V_222 -> V_224 |= V_232 ;
}
V_223 = V_222 -> V_224 ;
if ( ! V_220 )
goto V_235;
if ( V_220 -> V_224 == V_222 -> V_224
&& V_220 -> V_236 == V_222 -> V_236
&& V_220 -> V_237 == V_222 -> V_237 )
goto V_238;
if ( ( V_220 -> V_224 & ( V_234 | V_239 | V_240 | V_241 | V_242 ) ) ==
( V_222 -> V_224 & ( V_234 | V_239 | V_240 | V_241 | V_242 ) ) )
goto V_243;
V_235:
V_14 = 0 ;
V_14 |= ( V_223 & V_242 ? V_244 :
V_245 ) ;
if ( V_223 & V_240 ) {
if ( V_223 & V_241 )
V_14 |= V_223 & V_239 ?
...
F_28 ( & V_11 -> V_91 ) ;
if ( F_17 ( V_30 , V_7 ) )
F_19 ( V_221 , L_45 , V_18 ) ;
F_30 ( & V_11 -> V_91 ) ;
if ( V_220 && ( V_220 -> V_224 & V_229 ) == V_230 )
F_65 ( V_7 , V_16 | V_17 ) ;
}
V_238:
if ( V_223 & V_231 ) {
...
F_9 ( V_221 , L_48 ,
V_18 , V_225 ) ;
V_228 = V_222 -> V_253 [ V_254 ] ;
V_227 = V_222 -> V_253 [ V_255 ] ;
V_14 = ( V_227 << 8 ) | ( V_228 ) ;
if ( F_10 ( V_13 ,
F_11 ( V_13 , 0 ) ,
V_163 ,
...
V_175 [ 1 ] = 0 ;
F_9 ( & V_7 -> V_13 , L_54 , V_18 , V_175 [ 0 ] ,
V_175 [ 1 ] ) ;
V_257:
F_23 ( V_79 ) ;
return V_147 ;
...
unsigned int V_268 , unsigned long V_269 )
{
struct V_6 * V_7 = V_30 -> V_214 ;
F_9 ( & V_7 -> V_13 , L_55 , V_18 , V_268 ) ;
switch ( V_268 ) {
case V_270 :
return F_24 ( V_7 ,
(struct V_84 T_3 * ) V_269 ) ;
case V_271 :
return F_26 ( V_30 , V_7 ,
(struct V_84 T_3 * ) V_269 ) ;
case V_272 :
return F_31 ( V_7 , (struct V_84 T_3 * ) V_269 ) ;
break;
default:
break;
}
