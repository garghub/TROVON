...
if ( F_28 ( V_2 , V_62 ) )
F_37 ( V_10 , V_2 ) ;
V_26 = F_38 ( V_2 , V_57 -> V_63 ) ;
if ( V_26 )
goto V_64;
F_39 ( L_8 ,
V_19 -> V_22 , V_19 -> V_65 , V_19 -> V_66 , V_19 -> V_67 ,
V_19 -> V_68 , F_40 ( V_10 ) , V_2 -> V_69 -> V_70 ) ;
return 0 ;
V_64:
F_41 ( V_10 ) ;
V_59:
...
int F_43 ( struct V_58 * V_19 , struct V_17 * V_18 )
{
struct V_55 * V_10 = NULL ;
const struct V_56 * V_71 ;
int V_72 ;
F_23 ( L_7 ) ;
F_44 ( & V_19 -> V_73 ) ;
V_19 -> V_20 . V_21 = V_18 ;
...
if ( V_19 -> V_75 & V_62 )
return F_45 ( V_18 ) ;
for ( V_72 = 0 ; V_18 -> V_76 [ V_72 ] . V_77 != 0 ; V_72 ++ ) {
V_71 = & V_18 -> V_76 [ V_72 ] ;
V_10 = NULL ;
while ( ( V_10 =
F_46 ( V_71 -> V_77 , V_71 -> V_78 , V_71 -> V_79 ,
V_71 -> V_80 , V_10 ) ) != NULL ) {
if ( ( V_10 -> V_81 & V_71 -> V_82 ) != V_71 -> V_81 )
continue;
F_47 ( V_10 ) ;
F_34 ( V_10 , V_71 , V_19 ) ;
}
...
int F_48 ( struct V_1 * V_2 , T_3 * V_83 )
{
struct V_55 * V_84 ;
T_3 V_85 , V_86 ;
* V_83 = 0 ;
...
F_39 ( L_9 , V_84 -> V_77 , V_84 -> V_78 , V_85 , V_86 ) ;
return 0 ;
}
int F_43 ( struct V_58 * V_19 , struct V_17 * V_18 )
{
...
void F_50 ( struct V_58 * V_19 , struct V_17 * V_18 )
{
...
F_52 (dev, tmp, &driver->device_list, driver_item)
F_53 ( V_2 ) ;
}
F_39 ( L_10 ) ;
}
