...
for ( V_33 = 0 ; V_33 < F_42 ( V_156 ) ; V_33 ++ ) {
if ( V_2 -> V_24 & V_157 & ( 1 << V_33 ) )
F_60 ( & V_6 -> V_6 , L_23 ,
V_156 [ V_33 ] ) ;
}
V_2 -> V_24 &= ~ V_157 ;
...
V_116 = F_63 ( & V_6 -> V_161 [ V_159 ] ) ;
if ( V_116 ) {
V_116 = - V_160 ;
goto exit;
}
V_116 = F_64 ( V_6 , V_159 , V_162 . V_98 ) ;
if ( V_116 ) {
F_4 ( & V_6 -> V_6 , L_27
L_28 , V_2 -> V_158 ,
( unsigned long long ) F_65 ( V_6 , V_159 ) ) ;
goto exit;
}
...
if ( V_2 -> V_24 & V_25 ) {
F_67 ( & V_2 -> V_28 ) ;
V_116 = F_68 ( V_6 -> V_46 , F_20 , V_166 ,
V_162 . V_98 , V_2 ) ;
if ( V_116 ) {
F_4 ( & V_6 -> V_6 , L_31 ,
V_6 -> V_46 , V_116 ) ;
...
F_53 ( V_2 ) ;
F_76 ( & V_2 -> V_84 ) ;
F_28 ( V_6 , V_59 , V_2 -> V_163 ) ;
if ( V_2 -> V_24 & V_25 )
F_71 ( V_6 -> V_46 , V_2 ) ;
F_72 ( V_6 , V_159 ) ;
F_73 ( V_2 ) ;
}
static int F_77 ( struct V_5 * V_6 , T_9 V_170 )
{
struct V_1 * V_2 = F_75 ( V_6 ) ;
F_78 ( V_6 ) ;
F_28 ( V_6 , V_59 , V_2 -> V_163 ) ;
F_79 ( V_6 , F_80 ( V_6 , V_170 ) ) ;
return 0 ;
}
