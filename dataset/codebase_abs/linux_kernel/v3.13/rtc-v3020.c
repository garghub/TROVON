...
{
struct V_5 * V_6 = F_31 ( & V_4 -> V_37 ) ;
struct V_1 * V_2 ;
int V_57 = - V_8 ;
int V_16 ;
int V_58 ;
V_2 = F_32 ( & V_4 -> V_37 , sizeof( * V_2 ) , V_59 ) ;
if ( ! V_2 )
return - V_60 ;
if ( V_6 -> V_61 )
V_2 -> V_33 = & V_62 ;
...
V_2 -> V_33 = & V_63 ;
V_57 = V_2 -> V_33 -> V_64 ( V_2 , V_4 , V_6 ) ;
if ( V_57 )
return V_57 ;
for ( V_16 = 0 ; V_16 < 8 ; V_16 ++ )
V_58 = V_2 -> V_33 -> V_35 ( V_2 ) ;
F_21 ( V_2 , V_41 , 0x33 ) ;
...
static int F_38 ( struct V_3 * V_37 )
{
struct V_1 * V_2 = F_39 ( V_37 ) ;
V_2 -> V_33 -> V_71 ( V_2 ) ;
return 0 ;
}
