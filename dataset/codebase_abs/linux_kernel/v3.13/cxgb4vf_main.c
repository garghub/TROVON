...
while ( ( V_34 = F_191 ( V_1 -> V_104 , V_302 , V_361 ) ) >= V_362 )
V_361 = V_34 ;
if ( V_34 == 0 ) {
int V_31 = V_361 - V_365 ;
if ( V_31 < V_7 -> V_352 ) {
...
F_192 ( V_1 -> V_104 ) ;
F_193 ( V_1 -> V_66 , L_111
L_112 , V_34 ) ;
}
return V_34 ;
}
static int F_194 ( struct V_367 * V_104 ,
...
struct V_9 * V_10 ;
struct V_4 * V_294 ;
F_195 ( L_113 , V_371 , V_201 ) ;
V_34 = F_196 ( V_104 ) ;
if ( V_34 ) {
F_32 ( & V_104 -> V_5 , L_114 ) ;
return V_34 ;
}
V_34 = F_197 ( V_104 , V_199 ) ;
if ( V_34 ) {
F_32 ( & V_104 -> V_5 , L_115 ) ;
goto V_372;
}
V_34 = F_198 ( V_104 , F_199 ( 64 ) ) ;
if ( V_34 == 0 ) {
V_34 = F_200 ( V_104 , F_199 ( 64 ) ) ;
if ( V_34 ) {
...
V_394 ) ;
if ( F_163 ( V_1 -> V_333 ) )
F_184 ( & V_104 -> V_5 , L_125
L_126 ) ;
else
F_162 ( V_1 ) ;
}
if ( V_29 == V_395 && F_190 ( V_1 ) == 0 )
V_1 -> V_47 |= V_103 ;
else {
V_34 = F_215 ( V_104 ) ;
if ( V_34 ) {
...
static void F_225 ( struct V_367 * V_104 )
{
struct V_1 * V_1 = F_226 ( V_104 ) ;
if ( V_1 ) {
int V_2 ;
F_13 (adapter, pidx)
if ( F_217 ( V_2 , & V_1 -> V_393 ) )
...
static void F_229 ( struct V_367 * V_104 )
{
struct V_1 * V_1 ;
int V_2 ;
V_1 = F_226 ( V_104 ) ;
...
{
int V_18 ;
if ( V_29 != V_395 && V_29 != V_397 ) {
F_231 ( L_133 ,
V_29 , V_395 , V_397 ) ;
return - V_172 ;
}
V_394 = F_214 ( V_199 , NULL ) ;
if ( F_163 ( V_394 ) )
F_231 ( L_134 ) ;
V_18 = F_232 ( & V_398 ) ;
if ( V_18 < 0 && ! F_163 ( V_394 ) )
F_233 ( V_394 ) ;
return V_18 ;
}
