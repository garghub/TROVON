...
static void F_62 ( struct V_20 * V_4 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned long V_33 = 0 ;
...
V_139 ) ;
F_65 ( & V_2 -> V_157 , V_2 -> V_158 ) ;
if ( F_54 ( V_2 -> V_137 ) )
F_66 ( V_2 -> V_137 ,
V_2 -> V_138 != V_2 -> V_140 ) ;
}
static void
F_67 ( struct V_20 * V_4 , struct V_159 * V_160 ,
struct V_159 * V_161 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
...
V_162 |= V_180 ;
V_21 = F_68 ( V_4 , V_160 , V_161 , 0 , V_4 -> V_23 / 13 ) ;
V_163 = F_13 ( V_4 , V_21 ) ;
...
static void
F_72 ( struct V_20 * V_4 , unsigned int V_50 ,
unsigned int V_237 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned char V_203 ;
F_16 ( V_2 -> V_4 . V_14 , L_10 , V_2 -> V_4 . line ) ;
F_17 ( V_2 -> V_14 ) ;
F_3 ( V_2 , V_144 , V_202 ) ;
V_203 = F_1 ( V_2 , V_204 ) ;
...
static void F_76 ( struct V_20 * V_4 )
{
F_16 ( V_4 -> V_14 , L_11 ) ;
}
static int F_77 ( struct V_20 * V_4 )
{
F_16 ( V_4 -> V_14 , L_12 ) ;
return 0 ;
}
static void F_78 ( struct V_20 * V_4 , int V_33 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
F_16 ( V_2 -> V_4 . V_14 , L_13 ,
V_2 -> V_4 . line ) ;
V_2 -> V_4 . type = V_239 ;
V_2 -> V_4 . V_33 |= V_229 | V_226 ;
}
static int
F_79 ( struct V_20 * V_4 , struct V_240 * V_241 )
{
F_16 ( V_4 -> V_14 , L_14 ) ;
return - V_16 ;
}
static const char *
F_80 ( struct V_20 * V_4 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
F_16 ( V_2 -> V_4 . V_14 , L_15 , V_2 -> V_4 . line ) ;
return V_2 -> V_147 ;
}
...
static void F_83 ( struct V_20 * V_4 , unsigned char V_78 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
F_17 ( V_2 -> V_14 ) ;
F_81 ( V_2 ) ;
...
static int F_84 ( struct V_20 * V_4 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned int V_64 ;
F_17 ( V_2 -> V_14 ) ;
...
static void F_85 ( struct V_20 * V_4 , int V_78 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
F_81 ( V_2 ) ;
F_3 ( V_2 , V_53 , V_78 ) ;
...
static void
F_86 ( struct V_249 * V_250 , const char * V_251 ,
unsigned int V_51 )
{
...
V_253 = F_88 ( & V_2 -> V_4 . V_61 ) ;
else
F_31 ( & V_2 -> V_4 . V_61 ) ;
V_28 = F_1 ( V_2 , V_30 ) ;
F_3 ( V_2 , V_30 , 0 ) ;
F_89 ( & V_2 -> V_4 , V_251 , V_51 , F_85 ) ;
F_81 ( V_2 ) ;
F_3 ( V_2 , V_30 , V_28 ) ;
if ( V_2 -> V_66 )
F_38 ( V_2 ) ;
...
static int T_2
F_91 ( struct V_249 * V_250 , char * V_256 )
{
struct V_1 * V_2 ;
int V_21 = 115200 ;
int V_257 = 8 ;
...
if ( V_256 )
F_92 ( V_256 , & V_21 , & V_88 , & V_257 , & V_258 ) ;
return F_93 ( & V_2 -> V_4 , V_250 , V_21 , V_88 , V_257 , V_258 ) ;
}
...
{}
static void
F_95 ( struct V_20 * V_4 , struct V_260 * V_261 )
{
struct V_1 * V_2 = F_15 ( V_4 ) ;
unsigned long V_33 ;
unsigned int V_27 ;
...
static int
F_96 ( struct V_20 * V_4 , unsigned int V_263 , unsigned long V_264 )
{
struct V_260 V_261 ;
switch ( V_263 ) {
case V_265 :
if ( F_97 ( & V_261 , (struct V_260 * ) V_264 ,
sizeof( V_261 ) ) )
return - V_266 ;
F_95 ( V_4 , & V_261 ) ;
break;
case V_267 :
if ( F_98 ( (struct V_260 * ) V_264 ,
& ( F_15 ( V_4 ) -> V_32 ) ,
sizeof( V_261 ) ) )
return - V_266 ;
break;
...
static int F_99 ( struct V_269 * V_14 )
{
struct V_1 * V_2 = F_100 ( V_14 ) ;
V_2 -> V_270 = true ;
return 0 ;
}
static void F_101 ( struct V_269 * V_14 )
{
struct V_1 * V_2 = F_100 ( V_14 ) ;
V_2 -> V_270 = false ;
}
static int F_102 ( struct V_269 * V_14 )
{
struct V_1 * V_2 = F_100 ( V_14 ) ;
F_103 ( & V_271 , & V_2 -> V_4 ) ;
F_104 ( & V_2 -> V_139 ) ;
...
static int F_105 ( struct V_269 * V_14 )
{
struct V_1 * V_2 = F_100 ( V_14 ) ;
F_106 ( & V_271 , & V_2 -> V_4 ) ;
return 0 ;
...
V_272 = F_108 ( V_2 -> V_4 . V_6 + ( V_277 << V_2 -> V_4 . V_5 ) ) ;
V_273 = V_272 >> V_278 ;
switch ( V_273 ) {
case 0 :
V_275 = ( V_272 & V_279 ) >>
...
static struct V_12 * F_111 ( struct V_269 * V_14 )
{
struct V_12 * V_289 ;
V_289 = F_112 ( V_14 , sizeof( * V_289 ) , V_290 ) ;
if ( ! V_289 )
return NULL ;
F_113 ( V_14 -> V_291 , L_17 ,
& V_289 -> V_23 ) ;
return V_289 ;
}
...
V_261 -> V_33 |= V_38 ;
V_2 -> V_39 = F_116 ( V_293 , L_19 , 0 , & V_33 ) ;
if ( F_54 ( V_2 -> V_39 ) ) {
V_99 = F_117 ( V_2 -> V_39 , L_20 ) ;
if ( V_99 < 0 )
return V_99 ;
V_99 = F_118 ( V_2 -> V_39 ,
V_33 & V_38 ) ;
...
static int F_120 ( struct V_296 * V_297 )
{
struct V_1 * V_2 ;
struct V_298 * V_299 , * V_96 ;
struct V_12 * V_289 = F_7 ( & V_297 -> V_14 ) ;
int V_99 , V_300 = 0 , V_18 = 0 ;
if ( V_297 -> V_14 . V_291 ) {
V_300 = F_121 ( V_297 -> V_14 . V_291 , 0 ) ;
if ( ! V_300 )
return - V_301 ;
V_18 = F_121 ( V_297 -> V_14 . V_291 , 1 ) ;
V_289 = F_111 ( & V_297 -> V_14 ) ;
V_297 -> V_14 . V_302 = V_289 ;
} else {
V_96 = F_122 ( V_297 , V_303 , 0 ) ;
if ( ! V_96 ) {
F_123 ( & V_297 -> V_14 , L_24 ) ;
return - V_259 ;
}
V_300 = V_96 -> V_304 ;
}
V_299 = F_122 ( V_297 , V_305 , 0 ) ;
if ( ! V_299 ) {
F_123 ( & V_297 -> V_14 , L_25 ) ;
return - V_259 ;
}
if ( ! F_124 ( & V_297 -> V_14 , V_299 -> V_304 , F_125 ( V_299 ) ,
V_297 -> V_14 . V_306 -> V_147 ) ) {
F_123 ( & V_297 -> V_14 , L_26 ) ;
return - V_307 ;
}
if ( F_54 ( V_289 -> V_137 ) &&
V_289 -> V_308 ) {
V_99 = F_117 ( V_289 -> V_137 , L_20 ) ;
if ( V_99 < 0 )
return V_99 ;
V_99 = F_118 ( V_289 -> V_137 ,
V_289 -> V_140 ) ;
if ( V_99 < 0 )
return V_99 ;
}
V_2 = F_112 ( & V_297 -> V_14 , sizeof( * V_2 ) , V_290 ) ;
if ( ! V_2 )
return - V_309 ;
if ( F_54 ( V_289 -> V_137 ) &&
V_289 -> V_308 ) {
...
V_2 -> V_4 . V_312 = & V_313 ;
if ( V_297 -> V_14 . V_291 )
V_2 -> V_4 . line = F_126 ( V_297 -> V_14 . V_291 , L_27 ) ;
else
V_2 -> V_4 . line = V_297 -> V_314 ;
if ( V_2 -> V_4 . line < 0 ) {
F_123 ( & V_297 -> V_14 , L_28 ,
V_2 -> V_4 . line ) ;
V_99 = - V_259 ;
goto V_315;
}
V_99 = F_114 ( V_2 , V_297 -> V_14 . V_291 ) ;
if ( V_99 < 0 )
goto V_316;
sprintf ( V_2 -> V_147 , L_29 , V_2 -> V_4 . line ) ;
V_2 -> V_4 . V_317 = V_299 -> V_304 ;
V_2 -> V_4 . V_6 = F_127 ( & V_297 -> V_14 , V_299 -> V_304 ,
F_125 ( V_299 ) ) ;
if ( ! V_2 -> V_4 . V_6 ) {
F_123 ( & V_297 -> V_14 , L_30 ) ;
V_99 = - V_309 ;
goto V_318;
}
...
V_316:
V_315:
F_123 ( & V_297 -> V_14 , L_32 ,
V_297 -> V_314 , V_326 , V_99 ) ;
return V_99 ;
}
...
static void F_71 ( struct V_1 * V_2 , T_5 V_185 )
{
T_5 V_327 = 255 ;
F_3 ( V_2 , V_215 , V_185 ) ;
F_82 ( 2 ) ;
