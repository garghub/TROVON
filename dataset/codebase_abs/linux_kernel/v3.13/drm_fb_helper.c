...
V_6 = V_15 -> V_6 ;
V_208 [ V_71 ] = NULL ;
V_215 = F_74 ( V_2 , V_208 , V_198 , V_71 + 1 , V_144 , V_145 ) ;
if ( V_198 [ V_71 ] == NULL )
return V_215 ;
V_217 = F_3 ( V_4 -> V_85 . V_101 *
...
V_214 ++ ;
V_211 = V_6 -> V_53 ;
V_213 = V_211 -> V_218 ( V_6 ) ;
if ( ! V_213 )
goto V_140;
for ( V_60 = 0 ; V_60 < V_2 -> V_48 ; V_60 ++ ) {
V_33 = & V_2 -> V_51 [ V_60 ] ;
if ( ( V_213 -> V_219 & ( 1 << V_60 ) ) == 0 )
continue;
...
V_217 [ V_71 ] = V_33 ;
memcpy ( V_217 , V_208 , V_71 * sizeof( struct V_100 * ) ) ;
V_216 = V_214 + F_74 ( V_2 , V_217 , V_198 , V_71 + 1 ,
V_144 , V_145 ) ;
if ( V_216 > V_215 ) {
V_215 = V_216 ;
memcpy ( V_208 , V_217 ,
...
int V_7 ;
F_10 ( L_30 ) ;
V_144 = V_4 -> V_85 . V_220 ;
V_145 = V_4 -> V_85 . V_221 ;
V_217 = F_38 ( V_4 -> V_85 . V_101 ,
sizeof( struct V_100 * ) , V_10 ) ;
...
F_69 ( V_2 , V_52 ) ;
if ( ! ( V_2 -> V_38 -> V_222 &&
V_2 -> V_38 -> V_222 ( V_2 , V_217 , V_198 ,
V_52 , V_144 , V_145 ) ) ) {
memset ( V_198 , 0 , V_4 -> V_85 . V_101 * sizeof( V_198 [ 0 ] ) ) ;
memset ( V_217 , 0 , V_4 -> V_85 . V_101 * sizeof( V_217 [ 0 ] ) ) ;
if ( ! F_70 ( V_2 ,
...
F_10 ( L_33 ,
V_144 , V_145 ) ;
F_74 ( V_2 , V_217 , V_198 , 0 , V_144 , V_145 ) ;
}
for ( V_7 = 0 ; V_7 < V_2 -> V_48 ; V_7 ++ ) {
V_149 = & V_2 -> V_51 [ V_7 ] . V_50 ;
V_149 -> V_103 = 0 ;
...
struct V_100 * V_223 = V_217 [ V_7 ] ;
V_149 = & V_223 -> V_50 ;
if ( V_17 && V_223 ) {
F_10 ( L_34 ,
V_17 -> V_207 , V_223 -> V_50 . V_33 -> V_61 . V_62 ) ;
V_223 -> V_162 = V_17 ;
if ( V_149 -> V_17 )
F_35 ( V_4 , V_149 -> V_17 ) ;
V_149 -> V_17 = F_76 ( V_4 ,
...
bool F_78 ( struct V_1 * V_2 , int V_224 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
int V_188 = 0 ;
F_5 ( V_2 ) ;
...
if ( ! V_2 -> V_55 )
return 0 ;
F_79 ( & V_2 -> V_4 -> V_85 . V_225 ) ;
if ( ! F_25 ( V_2 ) ) {
V_2 -> V_148 = true ;
F_80 ( & V_2 -> V_4 -> V_85 . V_225 ) ;
return 0 ;
}
F_10 ( L_30 ) ;
V_220 = V_2 -> V_55 -> V_144 ;
V_221 = V_2 -> V_55 -> V_145 ;
F_61 ( V_2 , V_220 , V_221 ) ;
F_80 ( & V_2 -> V_4 -> V_85 . V_225 ) ;
F_30 ( V_4 ) ;
F_75 ( V_2 ) ;
F_31 ( V_4 ) ;
