...
F_4 ( V_58 | V_59 | V_60 ,
V_18 + V_61 ) ;
F_16 ( & V_6 -> V_62 , & V_9 -> V_63 ) ;
F_16 ( & V_6 -> V_62 , & V_9 -> V_44 ) ;
return 1 ;
}
static int T_3 F_17 ( struct V_8 * V_9 )
{
void * * V_10 ;
int V_64 ;
if ( V_65 . V_66 < V_67 )
goto V_68;
V_64 = V_67 + V_69 ;
V_10 = F_18 ( V_64 * sizeof( void * ) , V_70 ) ;
if ( ! V_10 )
return - V_71 ;
V_67 = V_64 ;
if ( V_65 . V_10 ) {
...
static int T_3 F_20 ( struct V_72 * V_73 )
{
struct V_74 * V_50 , * V_44 ;
struct V_8 * V_9 ;
void T_1 * V_18 ;
V_50 = F_21 ( V_73 , V_75 , 0 ) ;
V_18 = F_22 ( & V_73 -> V_24 , V_50 ) ;
if ( ! V_18 )
return - V_76 ;
V_44 = F_21 ( V_73 , V_75 , 1 ) ;
if ( ! V_44 || ! V_44 -> V_45 )
return - V_76 ;
V_9 = F_23 ( & V_73 -> V_24 ,
