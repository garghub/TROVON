...
static void *
F_61 ( struct V_25 * V_25 , struct V_128 * V_129 )
{
struct V_11 * V_12 = V_25 -> V_130 ;
V_57 * V_70 = F_5 ( V_25 -> V_131 ) ;
...
F_6 ( V_12 , L_37 ) ;
V_132 = F_62 ( V_76 , V_133 ) ;
if ( ! V_132 ) {
V_132 = F_14 ( - V_127 ) ;
} else if ( F_63 ( V_12 , V_109 , V_132 , V_76 ) != V_76 ) {
F_16 ( V_132 ) ;
F_7 ( V_12 , L_38 ) ;
V_132 = F_14 ( - V_21 ) ;
} else {
...
static void *
F_65 ( struct V_25 * V_25 , struct V_128 * V_129 )
{
V_57 * V_70 = F_5 ( V_25 -> V_131 ) ;
F_64 ( V_129 , V_70 -> V_15 . V_108 ) ;
return NULL ;
}
static int
...
if ( ! V_152 )
return 1 ;
while ( ( V_154 = F_69 ( & V_152 , L_50 ) ) != NULL ) {
int V_161 ;
if ( ! * V_154 )
continue;
...
{
F_16 ( F_12 ( V_12 ) -> V_84 . V_159 ) ;
F_12 ( V_12 ) -> V_84 . V_159 = NULL ;
F_77 ( F_12 ( V_12 ) -> V_34 ) ;
F_16 ( V_12 -> V_169 ) ;
V_12 -> V_169 = NULL ;
}
static int
F_78 ( struct V_11 * V_12 , void * V_109 , int V_170 )
{
struct V_8 * V_67 ;
T_8 * V_69 ;
T_15 * V_171 ;
...
const T_16 V_174 = 512 ;
F_79 ( V_12 , V_109 ) ;
V_12 -> V_169 = F_62 ( sizeof ( * V_69 ) , V_60 ) ;
if ( V_12 -> V_169 == NULL ) {
F_57 ( V_126
L_58
L_59 , V_12 -> V_175 ) ;
...
#endif
F_81 ( V_12 , 1024 ) ;
if ( ! ( V_67 = F_82 ( V_12 , V_173 ) ) ) {
F_7 ( V_12 , L_63 ) ;
goto V_176;
}
V_171 = ( T_15 * ) V_67 -> V_78 ;
...
F_6 ( V_12 , L_65 ) ;
V_171 =
( T_15 * ) ( ( void * ) V_67 -> V_78 + V_174 ) ;
}
if ( F_83 ( V_12 , V_171 ) != V_23 )
goto V_79;
F_84 ( V_12 , V_171 ) ;
F_52 ( V_67 ) ;
if ( F_85 ( V_12 ) != V_23 )
...
V_12 -> V_185 = & V_186 ;
V_172 = F_18 ( V_12 , F_9 ( V_12 , & ( V_69 -> V_187 ) ) ) ;
if ( F_19 ( V_172 ) ) {
V_29 = F_87 ( V_172 ) ;
goto V_176;
}
V_12 -> V_188 = F_88 ( V_172 ) ;
if ( ! V_12 -> V_188 ) {
F_7 ( V_12 , L_68 ) ;
goto V_176;
}
...
F_6 ( V_12 , L_69 ,
V_69 -> V_84 . V_159 ) ;
V_69 -> V_34 = F_89 ( V_69 -> V_84 . V_159 ) ;
if ( ! V_69 -> V_34 ) {
F_17 ( V_12 , L_70
L_71 ,
V_69 -> V_84 . V_159 ) ;
...
static int
F_92 ( struct V_25 * V_25 , struct V_189 * V_190 )
{
struct V_11 * V_12 = V_25 -> V_130 ;
T_17 V_191 = F_93 ( V_12 -> V_192 -> V_193 ) ;
F_6 ( V_12 , L_73 ) ;
V_190 -> V_194 = V_184 ;
...
static struct V_25 *
F_94 ( struct V_207 * V_208 , int V_27 , const char * V_209 ,
void * V_109 )
{
return F_95 ( V_208 , V_27 , V_209 , V_109 , F_78 ) ;
}
static int T_18
F_96 ( void )
{
int V_210 ;
F_57 ( V_211 L_75 , V_212 ) ;
V_210 = F_55 () ;
if ( V_210 )
goto V_77;
V_210 = F_97 ( & V_213 ) ;
