...
struct V_87 * V_88 , const char * V_89 , T_2 V_18 )
{
struct V_4 * V_63 = F_45 ( V_48 ) ;
F_9 ( L_42 , V_89 ) ;
strncpy ( V_63 -> V_90 , V_89 , V_18 ) ;
F_9 ( L_43 , V_63 -> V_90 ) ;
return V_18 ;
}
...
static int F_53 ( struct V_94 * V_95 , struct V_96 * V_97 )
{
return F_54 ( V_97 , F_40 , V_95 -> V_98 ) ;
}
static int F_55 ( struct V_94 * V_95 , struct V_96 * V_97 )
{
return F_54 ( V_97 , F_42 , V_95 -> V_98 ) ;
}
static int F_56 ( struct V_1 * V_93 )
{
struct V_4 * V_5 ;
struct V_67 * V_68 = V_93 -> V_48 . V_69 ;
int V_41 ;
if ( ( V_93 -> V_2 != - 1 ) && ( V_93 -> V_2 < V_99 ) ) {
V_3 [ V_93 -> V_2 ] = V_93 ;
} else {
V_3 [ 0 ] = V_93 ;
}
...
F_62 ( & V_5 -> V_12 ) ;
F_62 ( & V_5 -> V_64 ) ;
V_41 = F_63 ( & V_93 -> V_48 . V_75 , & V_103 ) ;
if ( V_41 ) {
F_5 ( L_54 ) ;
goto V_104;
}
strncpy ( V_5 -> V_90 , V_68 -> V_90 , V_105 ) ;
V_5 -> V_92 = V_68 -> V_92 ;
V_5 -> V_91 = V_68 -> V_91 ;
F_13 ( L_55 ) ;
V_106 = F_64 ( L_56 , NULL ) ;
if ( F_65 ( V_106 ) ) {
F_5 ( L_57 ) ;
V_41 = - V_32 ;
goto V_107;
}
F_66 ( L_58 , V_108 , V_106 ,
V_5 , & V_109 ) ;
F_66 ( L_59 , V_108 , V_106 ,
V_5 , & V_110 ) ;
F_13 ( L_60 ) ;
return 0 ;
V_107:
F_67 ( & V_93 -> V_48 . V_75 , & V_103 ) ;
V_104:
F_68 ( V_5 -> V_31 ) ;
V_101:
F_69 ( V_5 ) ;
...
static int F_70 ( struct V_1 * V_93 )
{
struct V_67 * V_68 = V_93 -> V_48 . V_69 ;
struct V_4 * V_5 ;
V_5 = F_52 ( V_93 ) ;
...
static int F_73 ( struct V_1 * V_93 , T_3 V_111 )
{
struct V_67 * V_68 = V_93 -> V_48 . V_69 ;
if ( V_68 -> V_112 )
return V_68 -> V_112 ( V_93 , V_111 ) ;
return - V_113 ;
}
static int F_74 ( struct V_1 * V_93 )
{
struct V_67 * V_68 = V_93 -> V_48 . V_69 ;
if ( V_68 -> V_114 )
return V_68 -> V_114 ( V_93 ) ;
return - V_113 ;
}
