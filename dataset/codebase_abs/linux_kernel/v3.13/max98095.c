...
F_28 ( V_71 , ( unsigned long long int ) V_41 -> V_80 ) ;
F_5 ( V_24 , V_81 ,
( V_71 >> 8 ) & 0x7F ) ;
F_5 ( V_24 , V_82 ,
V_71 & 0xFF ) ;
...
F_32 ( V_25 -> V_2 , L_3 , V_95 , V_96 ) ;
V_41 -> V_80 = V_96 ;
return 0 ;
}
static int F_33 ( struct V_68 * V_99 ,
unsigned int V_100 )
{
...
static int F_39 ( const char * V_133 )
{
...
int V_56 = F_39 ( V_37 -> V_136 . V_133 ) ;
struct V_69 * V_70 ;
unsigned int V_42 = V_39 -> V_43 . integer . V_43 [ 0 ] ;
struct V_137 * V_138 ;
...
V_123 = F_47 ( V_24 , V_168 , F_22 ( V_168 ) ) ;
if ( V_123 != 0 )
...
struct V_40 * V_41 = F_11 ( V_24 ) ;
struct V_134 * V_135 = V_41 -> V_135 ;
int V_56 = F_48 ( V_24 , V_37 -> V_136 . V_133 ) ;
struct V_69 * V_70 ;
unsigned int V_42 = V_39 -> V_43 . integer . V_43 [ 0 ] ;
struct V_174 * V_138 ;
int V_139 , V_140 , V_141 , V_29 ;
...
static T_3 F_54 ( int V_188 , void * V_189 )
{
...
{
struct V_40 * V_41 = F_11 ( V_24 ) ;
struct V_214 * V_215 = F_59 ( V_24 -> V_2 ) ;
int V_123 = 0 ;
V_41 -> V_196 = V_213 ;
V_41 -> V_199 = V_199 ;
if ( ! V_213 && ! V_199 )
...
F_66 ( V_24 -> V_2 , L_22 , V_123 - 0x40 + 'A' ) ;
...
static int F_69 ( struct V_214 * V_247 ,
const struct V_248 * V_136 )
{
struct V_40 * V_41 ;
int V_123 ;
V_41 = F_70 ( & V_247 -> V_2 , sizeof( struct V_40 ) ,
V_170 ) ;
if ( V_41 == NULL )
return - V_249 ;
V_41 -> V_130 = F_71 ( V_247 , & V_250 ) ;
if ( F_72 ( V_41 -> V_130 ) ) {
