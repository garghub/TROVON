...
static int F_37 ( struct V_66 * V_56 , unsigned int V_47 ,
T_4 V_59 )
{
F_38 ( V_47 , V_56 -> V_67 ) ;
F_39 ( V_47 , & V_68 ) ;
...
int V_7 ;
F_45 ( & V_1 -> V_65 ) ;
V_1 -> V_60 = F_46 ( V_3 -> V_9 , V_20 * 6 , V_70 ) ;
if ( ! V_1 -> V_60 )
return - V_71 ;
...
V_1 -> V_56 = F_47 ( V_3 -> V_44 , V_3 -> V_41 ,
& V_72 , V_1 ) ;
V_7 = F_48 ( V_1 -> V_8 -> V_47 , NULL , F_25 ,
V_73 | V_74 ,
F_49 ( V_3 -> V_9 ) , V_1 ) ;
if ( V_7 != 0 ) {
F_5 ( V_3 -> V_9 , L_13 ,
...
static int F_54 ( struct V_76 * V_8 ,
...
T_5 V_32 ;
int V_7 ;
V_7 = F_55 ( V_80 , L_14 , & V_32 ) ;
if ( V_7 < 0 )
return V_7 ;
V_8 -> V_47 = F_56 ( V_80 , 0 ) ;
if ( ! V_8 -> V_47 )
return - V_81 ;
V_1 = F_46 ( & V_8 -> V_9 , sizeof( * V_1 ) , V_70 ) ;
if ( ! V_1 )
return - V_71 ;
F_45 ( & V_1 -> V_14 ) ;
V_1 -> V_8 = V_8 ;
...
static int F_60 ( struct V_76 * V_8 )
{
struct V_1 * V_1 = F_61 ( V_8 ) ;
struct V_79 * V_80 = V_8 -> V_9 . V_44 ;
int V_7 ;
V_7 = F_62 ( & V_1 -> V_4 ) ;
if ( V_7 < 0 ) {
F_5 ( & V_8 -> V_9 , L_1 , L_16 ,
V_7 ) ;
return V_7 ;
}
if ( F_57 ( V_80 , L_15 , NULL ) )
