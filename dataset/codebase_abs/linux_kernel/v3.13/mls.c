...
switch ( V_84 ) {
case V_92 :
return F_28 ( V_78 , V_21 ) ;
case V_93 :
return F_29 ( V_78 , V_21 ) ;
case V_94 :
return F_15 ( V_78 , V_21 ) ;
case V_95 :
return F_28 ( V_78 , V_75 ) ;
case V_96 :
...
if ( ! V_12 . V_13 )
return 0 ;
V_51 = F_33 ( & V_1 -> V_15 . V_16 [ 0 ] . V_19 ,
...
if ( ! V_12 . V_13 )
return 0 ;
V_51 = F_35 ( & V_1 -> V_15 . V_16 [ 0 ] . V_19 ,
V_102 -> V_103 . V_104 . V_19 ) ;
if ( V_51 != 0 )
goto V_109;
V_51 = F_17 ( & V_1 -> V_15 . V_16 [ 1 ] . V_19 ,
...
return 0 ;
V_109:
F_26 ( & V_1 -> V_15 . V_16 [ 0 ] . V_19 ) ;
F_26 ( & V_1 -> V_15 . V_16 [ 1 ] . V_19 ) ;
return V_51 ;
}
