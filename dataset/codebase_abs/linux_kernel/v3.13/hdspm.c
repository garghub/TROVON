...
break;
case V_536 :
if ( F_236 ( & V_13 , V_470 , sizeof( V_13 ) ) )
return - V_500 ;
...
static int F_237 ( struct V_183 * V_184 ,
struct V_3 * V_3 )
{
struct V_466 * V_457 ;
int V_185 ;
V_185 = F_238 ( V_184 , L_171 , 0 , & V_457 ) ;
if ( V_185 < 0 )
return V_185 ;
V_3 -> V_538 = V_457 ;
V_457 -> V_177 = V_3 ;
...
F_3 ( V_3 , V_7 + 4 * V_19 ,
F_242 ( V_174 , 4096 * V_19 ) ) ;
}
static int F_243 ( struct V_183 * V_184 ,
struct V_3 * V_3 )
{
struct V_544 * V_545 ;
int V_185 ;
V_185 = F_244 ( V_184 , V_3 -> V_369 , 0 , 1 , 1 , & V_545 ) ;
if ( V_185 < 0 )
return V_185 ;
V_3 -> V_545 = V_545 ;
V_545 -> V_177 = V_3 ;
...
static int F_247 ( struct V_183 * V_184 ,
struct V_3 * V_3 )
{
int V_185 , V_19 ;
F_200 ( L_175 ) ;
V_185 = F_243 ( V_184 , V_3 ) ;
if ( V_185 < 0 )
return V_185 ;
V_19 = 0 ;
while ( V_19 < V_3 -> V_221 ) {
...
static int F_249 ( struct V_183 * V_184 ,
struct V_3 * V_3 )
{
...
return V_185 ;
F_252 ( V_3 -> V_548 ) ;
V_185 = F_253 ( V_548 , L_156 ) ;
if ( V_185 < 0 )
return V_185 ;
V_3 -> V_376 = F_254 ( V_548 , 0 ) ;
V_556 = F_255 ( V_548 , 0 ) ;
F_200 ( L_190 ,
V_3 -> V_376 , V_3 -> V_376 + V_556 - 1 ) ;
V_3 -> V_9 = F_256 ( V_3 -> V_376 , V_556 ) ;
if ( ! V_3 -> V_9 ) {
F_45 ( V_125 L_1
L_191 ,
V_3 -> V_376 , V_3 -> V_376 + V_556 - 1 ) ;
...
F_200 ( L_195 ,
sizeof( struct V_537 ) ) ;
V_3 -> V_13 = F_258 ( sizeof( struct V_537 ) , V_566 ) ;
if ( ! V_3 -> V_13 ) {
F_45 ( V_125 L_1
L_196 ,
...
V_605 ) {
V_3 -> V_221 ++ ;
V_3 -> V_239 = F_258 ( sizeof( struct V_606 ) ,
V_566 ) ;
if ( NULL != V_3 -> V_239 ) {
F_147 ( V_3 ) ;
}
...
F_260 ( V_184 , V_184 -> V_158 ) ;
}
}
F_200 ( L_202 ) ;
V_185 = F_247 ( V_184 , V_3 ) ;
if ( V_185 < 0 )
return V_185 ;
F_246 ( V_3 ) ;
return 0 ;
...
static void F_267 ( struct V_183 * V_184 )
{
struct V_3 * V_3 = V_184 -> V_177 ;
if ( V_3 )
F_261 ( V_3 ) ;
}
static int F_268 ( struct V_555 * V_548 ,
...
V_185 = F_269 ( V_241 [ V_615 ] , V_158 [ V_615 ] ,
...
V_3 -> V_615 = V_615 ;
V_3 -> V_548 = V_548 ;
F_270 ( V_184 , & V_548 -> V_615 ) ;
V_185 = F_249 ( V_184 , V_3 ) ;
if ( V_185 < 0 ) {
F_271 ( V_184 ) ;
return V_185 ;
}
...
static void F_273 ( struct V_555 * V_548 )
{
F_271 ( F_274 ( V_548 ) ) ;
}
