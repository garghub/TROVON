...
F_42 ( V_39 -> V_55 [ V_33 ] -> V_56 ) ;
if ( V_39 -> V_55 [ V_33 ] -> V_57 )
F_42 ( V_39 -> V_55 [ V_33 ] -> V_57 ) ;
if ( V_39 -> V_55 [ V_33 ] -> V_58 )
F_42 ( V_39 -> V_55 [ V_33 ] -> V_58 ) ;
F_42 ( V_39 -> V_55 [ V_33 ] ) ;
V_39 -> V_55 [ V_33 ] = NULL ;
}
}
...
unsigned long V_6 ;
V_39 = V_36 [ V_4 ] =
F_43 ( sizeof( * V_39 ) , V_63 ) ;
if ( ! V_39 )
return - V_64 ;
V_39 -> V_53 = V_39 -> V_51 =
F_43 ( sizeof( V_65 ) * 8192 , V_63 ) ;
if ( ! V_39 -> V_53 ) {
F_42 ( V_39 ) ;
return - V_64 ;
}
...
F_47 ( V_26 , V_86 , & V_39 -> V_87 ) ;
F_47 ( V_26 , V_88 , & V_39 -> V_89 ) ;
F_48 ( V_26 , V_90 , & V_39 -> V_91 ) ;
V_62 = V_26 -> V_48 ;
V_39 -> V_48 = V_62 ;
switch( V_39 -> V_42 ) {
case V_43 :
...
V_39 -> V_92 = V_93 | V_94 ;
F_9 ( ( L_11 ) ) ;
V_39 -> V_95 = F_49 ( V_26 , 4 ) ;
if ( ! V_39 -> V_95 ) {
F_2 ( ( L_12 ) ) ;
return - V_96 ;
}
V_39 -> V_97 = F_50 ( V_26 , 4 ) ;
if ( V_39 -> V_95 & 1 )
V_39 -> V_95 &= ~ 3 ;
else
V_39 -> V_95 &= ~ 15 ;
V_39 -> V_47 = F_49 ( V_26 , 1 ) ;
V_39 -> V_98 = F_50 ( V_26 , 1 ) ;
...
F_9 ( ( L_13 ) ) ;
V_39 -> V_95 = F_49 ( V_26 , 0 ) ;
V_39 -> V_97 = F_50 ( V_26 , 0 ) ;
if ( V_39 -> V_95 & 1 )
V_39 -> V_95 &= ~ 3 ;
else
V_39 -> V_95 &= ~ 15 ;
...
F_51 ( V_39 ) ;
if ( V_39 -> V_50 ) {
V_39 -> V_120 = F_52 ( V_39 -> V_50 + 0x8D ) ;
V_39 -> V_99 -> V_103 ( V_39 ) ;
}
break;
default:
...
V_39 -> V_79 = V_124 ;
F_56 ( V_39 ) ;
F_57 ( & V_39 -> V_49 , V_39 -> V_99 -> V_125 , ( unsigned long ) V_39 ) ;
F_9 ( ( L_18 , V_33 ) ) ;
F_16 ( V_52 , V_6 ) ;
V_39 -> V_53 = NULL ;
F_6 ( L_10 , V_39 -> V_51 ) ;
...
F_9 ( ( L_20 ) ) ;
if ( V_39 -> V_48 ) {
V_1 = F_59 ( V_39 -> V_48 , V_39 -> V_99 -> V_127 , V_128 , L_21 , V_39 ) ;
if ( V_1 ) {
F_6 ( L_22 , V_39 -> V_48 ) ;
V_39 -> V_84 = V_121 ;
V_39 -> V_79 = V_80 ;
...
if ( ! V_39 || V_39 -> V_40 != V_41 )
return;
V_39 -> V_50 = F_60 ( V_39 -> V_95 , 0x1000 ) ;
F_9 ( ( L_24 , V_39 -> V_50 ) ) ;
}
