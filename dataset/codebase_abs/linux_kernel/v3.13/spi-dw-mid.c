...
( unsigned long ) & V_39 ) ;
memset ( & V_5 -> V_69 , 0 , sizeof( V_5 -> V_69 ) ) ;
V_5 -> V_69 . V_60 = V_5 -> V_44 ;
V_5 -> V_69 . V_61 = V_5 -> V_62 ;
V_36 = F_14 ( V_18 ,
& V_5 -> V_69 ,
1 ,
V_66 ,
...
if ( ! V_71 )
return - V_74 ;
V_72 = ( F_17 ( V_71 ) & V_75 ) >> V_76 ;
V_5 -> V_77 = V_78 / ( V_72 + 1 ) ;
F_18 ( V_71 ) ;
V_5 -> V_79 = 16 ;
V_5 -> V_80 = 40 ;
#ifdef F_19
V_5 -> V_11 = F_20 ( sizeof( struct V_9 ) , V_81 ) ;
if ( ! V_5 -> V_11 )
return - V_74 ;
V_5 -> V_82 = & V_83 ;
#endif
