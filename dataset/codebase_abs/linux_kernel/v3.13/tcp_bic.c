...
T_1 V_26 )
{
struct V_27 * V_28 = F_4 ( V_11 ) ;
struct V_1 * V_2 = F_3 ( V_11 ) ;
if ( ! F_7 ( V_11 , V_26 ) )
return;
if ( V_28 -> V_29 <= V_28 -> V_14 )
F_8 ( V_28 , V_25 ) ;
else {
F_5 ( V_2 , V_28 -> V_29 ) ;
F_9 ( V_28 , V_2 -> V_3 ) ;
...
{
const struct V_27 * V_28 = F_4 ( V_11 ) ;
struct V_1 * V_2 = F_3 ( V_11 ) ;
V_2 -> V_7 = 0 ;
if ( V_28 -> V_29 < V_2 -> V_4 && V_30 )
V_2 -> V_4 = ( V_28 -> V_29 * ( V_31 + V_32 ) )
/ ( 2 * V_31 ) ;
else
V_2 -> V_4 = V_28 -> V_29 ;
V_2 -> V_12 = V_28 -> V_29 ;
if ( V_28 -> V_29 <= V_19 )
return F_11 ( V_28 -> V_29 >> 1U , 2U ) ;
else
return F_11 ( ( V_28 -> V_29 * V_32 ) / V_31 , 2U ) ;
}
static T_1 F_12 ( struct V_10 * V_11 )
{
const struct V_27 * V_28 = F_4 ( V_11 ) ;
const struct V_1 * V_2 = F_3 ( V_11 ) ;
return F_11 ( V_28 -> V_29 , V_2 -> V_12 ) ;
}
static void F_13 ( struct V_10 * V_11 , T_3 V_33 )
{
if ( V_33 == V_34 )
F_1 ( F_3 ( V_11 ) ) ;
}
static void F_14 ( struct V_10 * V_11 , T_1 V_3 , V_16 V_35 )
{
const struct V_36 * V_37 = F_15 ( V_11 ) ;
if ( V_37 -> V_38 == V_39 ) {
struct V_1 * V_2 = F_3 ( V_11 ) ;
V_3 -= V_2 -> V_8 >> V_9 ;
V_2 -> V_8 += V_3 ;
