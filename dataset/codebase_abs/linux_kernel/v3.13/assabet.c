...
static enum V_104 F_52 ( struct V_102 * V_103 )
{
struct V_106 * V_107 = F_51 ( V_103 ,
struct V_106 , V_103 ) ;
return ( V_5 & V_107 -> V_1 ) ? V_108 : V_109 ;
}
...
if ( ! F_10 () )
return - V_110 ;
for ( V_60 = 0 ; V_60 < F_22 ( V_111 ) ; V_60 ++ ) {
struct V_106 * V_107 ;
V_107 = F_54 ( sizeof( * V_107 ) , V_112 ) ;
if ( ! V_107 )
break;
V_107 -> V_103 . V_113 = V_111 [ V_60 ] . V_113 ;
V_107 -> V_103 . V_114 = F_50 ;
V_107 -> V_103 . V_115 = F_52 ;
V_107 -> V_103 . V_116 = V_111 [ V_60 ] . V_117 ;
if ( ! V_60 )
V_107 -> V_1 = V_118 ;
else
V_107 -> V_1 = V_119 ;
if ( F_55 ( NULL , & V_107 -> V_103 ) < 0 ) {
F_56 ( V_107 ) ;
break;
}
}
