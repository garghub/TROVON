...
return - V_78 ;
V_74 = ( F_46 ( V_71 ) + V_2 -> V_77 + ( V_79 - 1 ) )
& ~ ( V_79 - 1 ) ;
F_52 ( V_73 , 0 , F_46 ( V_71 ) + V_2 -> V_77 ) ;
F_53 ( & V_3 -> V_80 -> V_81 , V_56 -> V_82 , V_56 -> V_83 ,
V_84 ) ;
V_8 = F_28 ( V_2 , V_2 -> V_77 , V_56 ,
F_45 ( V_71 ) - F_54 ( V_3 ) ,
V_74 , F_54 ( V_3 ) ,
F_55 ( V_3 ) ) ;
F_56 ( & V_3 -> V_80 -> V_81 , V_56 -> V_82 , V_56 -> V_83 ,
V_84 ) ;
F_57 ( V_56 -> V_82 , V_56 -> V_83 ,
V_2 -> V_39 , V_2 -> V_77 ) ;
return V_8 ;
}
...
return - V_78 ;
V_73 -> V_75 . V_6 &= ~ ( V_76 | V_86 | V_87 ) ;
if ( ! F_40 ( V_71 ) ) {
V_54 = V_2 -> V_15 ;
V_73 -> V_75 . V_6 |= V_76 ;
F_52 ( V_73 , 0 , F_41 ( V_71 ) + V_2 -> V_15 ) ;
} else {
V_73 -> V_75 . V_6 |= V_86 ;
F_52 ( V_73 , 0 , F_41 ( V_71 ) ) ;
}
V_85 = ( F_44 ( V_71 ) - F_27 ( V_3 ) + sizeof( * V_71 ) )
% F_25 ( V_3 ) ;
V_74 = ( F_41 ( V_71 ) + V_54 + ( V_79 - 1 ) )
& ~ ( V_79 - 1 ) ;
F_53 ( & V_3 -> V_80 -> V_81 , V_56 -> V_82 , V_56 -> V_83 ,
V_84 ) ;
...
V_73 = F_64 ( & V_2 -> V_105 , struct V_101 , V_106 ) ;
F_65 ( & V_73 -> V_106 ) ;
F_6 ( & V_2 -> V_104 , V_6 ) ;
F_59 ( V_2 , & V_73 -> V_73 , V_89 ) ;
V_103:
F_66 ( & V_2 -> V_102 ) ;
}
...
continue;
V_89 . V_71 = V_3 -> V_116 ;
if ( F_44 ( V_89 . V_71 ) != F_27 ( V_3 ) + V_51 )
continue;
if ( F_2 ( V_2 ) )
V_89 . V_92 = 1 ;
else
...
static int F_73 ( void * V_117 )
{
struct V_3 * V_3 = V_117 ;
F_74 ( V_118 , V_119 ) ;
F_75 () ;
F_76 ( & V_3 -> V_107 , & V_118 ) ;
for (; ; ) {
long V_120 = F_77 ( V_121 ) ;
if ( V_120 == - V_122 || F_78 () )
break;
F_79 ( V_3 , V_123 ) ;
F_69 ( V_3 ) ;
...
F_82 ( & V_3 -> V_107 , & V_118 ) ;
return 0 ;
}
static int F_83 ( struct V_124 * V_125 , const struct V_126 * V_93 ,
...
struct V_1 * V_2 = F_85 ( V_132 ) ;
struct V_101 * V_133 =
F_86 ( V_73 , struct V_101 , V_73 ) ;
F_87 ( & V_2 -> V_104 ) ;
F_88 ( & V_133 -> V_106 , & V_2 -> V_105 ) ;
F_89 ( & V_2 -> V_104 ) ;
}
static int F_90 ( struct V_3 * V_3 )
{
V_3 -> V_134 = F_91 ( F_73 , V_3 ,
V_135 L_2 ) ;
if ( F_92 ( V_3 -> V_134 ) ) {
int V_136 = F_93 ( V_3 -> V_134 ) ;
V_3 -> V_134 = NULL ;
return V_136 ;
}
F_80 ( V_3 , V_123 ) ;
...
static int F_96 ( struct V_124 * V_125 , unsigned int V_137 )
{
struct V_1 * V_2 = F_85 ( V_125 ) ;
int V_8 ;
V_8 = F_13 ( V_2 ) ;
if ( V_8 )
return V_8 ;
...
static int F_99 ( struct V_138 * V_138 , void * V_139 ,
struct V_140 * V_141 )
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
...
static int F_102 ( struct V_138 * V_138 , void * V_139 ,
struct V_151 * V_152 )
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
...
if ( ! F_103 ( V_3 , V_2 -> V_5 ) )
V_152 -> V_159 = V_160 ;
return 0 ;
}
static int F_104 ( struct V_138 * V_138 , void * V_139 ,
unsigned int V_153 )
{
if ( V_153 )
return - V_53 ;
...
static inline int F_107 ( T_1 V_168 , int V_163 )
{
return ( V_168 == V_95 && V_163 == V_27 )
|| ( V_168 == V_94 && V_163 == V_38 )
|| V_168 == V_166 ? 0 : - V_53 ;
}
static int F_108 ( struct V_138 * V_138 , void * V_139 ,
struct V_126 * V_162 )
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
struct V_169 * V_170 = & V_162 -> V_93 . V_170 ;
if ( F_107 ( V_170 -> V_164 , V_3 -> type ) )
return - V_53 ;
...
static int F_111 ( struct V_138 * V_138 , void * V_139 ,
struct V_126 * V_162 )
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_169 * V_170 = & V_162 -> V_93 . V_170 ;
...
static int F_112 ( struct V_138 * V_138 , void * V_139 , T_6 * V_61 )
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
if ( V_3 -> V_28 == V_29 )
...
static int F_113 ( struct V_138 * V_138 , void * V_139 , T_6 V_156 )
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
return F_114 ( V_2 -> V_3 , V_156 & V_182 ) ;
}
static int F_115 ( struct V_138 * V_138 , void * V_139 ,
struct V_183 * V_184 )
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
if ( F_107 ( V_184 -> V_185 , V_3 -> type ) )
return - V_53 ;
switch ( V_184 -> V_153 ) {
case 0 :
V_184 -> V_186 . V_23 = V_3 -> V_24 >> 1 ;
V_184 -> V_186 . V_25 = V_3 -> V_26 ;
break;
case 1 :
V_184 -> V_186 . V_23 = V_3 -> V_24 ;
V_184 -> V_186 . V_25 = V_3 -> V_26 << 1 ;
break;
default:
return - V_53 ;
}
...
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
if ( F_107 ( V_189 -> V_185 , V_3 -> type ) )
return - V_53 ;
if ( V_189 -> V_153 )
return - V_53 ;
if ( ( V_189 -> V_23 != V_3 -> V_24 >> 1 ||
V_189 -> V_25 != V_3 -> V_26 ) &&
( V_189 -> V_23 != V_3 -> V_24 ||
V_189 -> V_25 != V_3 -> V_26 << 1 ) )
return - V_53 ;
V_189 -> type = V_190 ;
V_189 -> V_191 . F_34 . V_192 = 1 ;
V_189 -> V_191 . F_34 . V_193 = V_3 -> V_20 ;
V_189 -> V_191 . F_11 . V_192 = 15 ;
V_189 -> V_191 . F_11 . V_193 = V_3 -> V_20 ;
V_189 -> V_191 . V_194 . V_192 = 1 ;
V_189 -> V_191 . V_194 . V_193 = V_3 -> V_20 ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_197 * V_198 = & V_196 -> V_199 . V_200 ;
V_198 -> V_201 = V_202 ;
V_198 -> V_203 . V_192 = V_2 -> V_21 ;
V_198 -> V_203 . V_193 = V_2 -> V_3 -> V_20 ;
V_198 -> V_204 = 0 ;
V_198 -> V_205 = 2 ;
return 0 ;
}
static inline int F_118 ( T_3 V_20 , T_1 V_206 , T_1 V_207 )
{
if ( ! V_206 || ! V_207 )
return 1 ;
if ( V_207 == V_20 )
return V_206 ;
V_206 *= V_20 ;
return F_34 ( 15U , V_206 / V_207 + ( V_206 % V_207 >= ( V_20 >> 1 ) ) ) ;
}
static int F_119 ( struct V_138 * V_138 , void * V_139 ,
struct V_195 * V_196 )
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_208 * V_209 = & V_196 -> V_199 . V_200 . V_203 ;
T_3 V_20 = V_2 -> V_3 -> V_20 ;
if ( F_120 ( & V_2 -> V_179 ) )
return - V_45 ;
V_2 -> V_21 = F_118 ( V_20 , V_209 -> V_192 , V_209 -> V_193 ) ;
F_10 ( V_2 ) ;
return F_117 ( V_138 , V_139 , V_196 ) ;
}
static long F_121 ( struct V_138 * V_138 , void * V_210 ,
bool V_211 , unsigned int V_212 , void * V_213 )
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
...
return - V_45 ;
V_2 -> V_217 = * V_215 ;
if ( V_2 -> V_219 && ! V_2 -> V_220 )
return F_122 ( V_3 , V_2 -> V_5 ,
& V_2 -> V_217 ) ;
return 0 ;
default:
return - V_221 ;
...
{
struct V_1 * V_2 =
F_86 ( V_223 -> V_224 , struct V_1 , V_225 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
int V_136 ;
switch ( V_223 -> V_226 ) {
case V_227 :
...
return 0 ;
case V_234 :
V_2 -> V_235 = V_223 -> V_232 ;
if ( ! V_2 -> V_220 || ! V_2 -> V_219 )
return 0 ;
return F_125 ( V_3 , V_2 -> V_5 , V_223 -> V_232 ) ;
case V_236 :
V_2 -> V_220 = V_223 -> V_232 == 1 ;
V_2 -> V_219 = V_223 -> V_232 > 0 ;
if ( V_223 -> V_232 ) {
if ( V_2 -> V_220 )
F_125 ( V_3 , V_2 -> V_5 ,
V_2 -> V_235 ) ;
...
static struct V_1 * F_127 ( struct V_3 * V_3 ,
T_3 V_5 , unsigned V_239 )
{
struct V_1 * V_2 ;
struct V_240 * V_225 ;
int V_8 ;
int V_241 , V_242 ;
V_2 = F_128 ( sizeof( * V_2 ) , V_243 ) ;
if ( ! V_2 )
return F_129 ( - V_244 ) ;
V_225 = & V_2 -> V_225 ;
F_130 ( V_225 , 10 ) ;
...
F_133 ( V_225 , & V_246 , NULL ) ;
F_133 ( V_225 , & V_247 , NULL ) ;
F_133 ( V_225 , & V_248 , NULL ) ;
if ( V_225 -> error ) {
V_8 = V_225 -> error ;
goto V_249;
}
...
V_2 -> V_220 = true ;
V_2 -> V_235 = V_251 ;
for ( V_242 = 0 ; V_242 < V_252 ; V_242 ++ )
for ( V_241 = 0 ; V_241 < V_252 ; V_241 ++ )
V_2 -> V_217 . V_215 [ V_242 ] [ V_241 ] =
V_251 ;
V_2 -> V_179 . type = V_253 ;
V_2 -> V_179 . V_254 = V_255 | V_256 | V_257 ;
V_2 -> V_179 . V_258 = & V_259 ;
V_2 -> V_179 . V_260 = & V_261 ;
V_2 -> V_179 . V_262 = V_2 ;
V_2 -> V_179 . V_263 = V_264 ;
V_2 -> V_179 . V_265 = V_266 ;
V_2 -> V_179 . V_267 = sizeof( struct V_101 ) ;
...
goto V_268;
* V_2 -> V_157 = V_269 ;
V_2 -> V_157 -> V_270 = & V_3 -> V_270 ;
V_2 -> V_157 -> V_271 = V_225 ;
V_2 -> V_157 -> V_272 = & V_2 -> V_179 ;
V_2 -> V_157 -> V_102 = & V_2 -> V_102 ;
F_139 ( V_273 , & V_2 -> V_157 -> V_6 ) ;
F_140 ( V_2 -> V_157 , V_2 ) ;
V_8 = F_141 ( V_2 -> V_157 , V_274 , V_239 ) ;
if ( V_8 < 0 )
goto V_275;
snprintf ( V_2 -> V_157 -> V_154 , sizeof( V_2 -> V_157 -> V_154 ) ,
L_9 , V_135 , V_3 -> V_157 -> V_276 ,
V_2 -> V_157 -> V_276 ) ;
return V_2 ;
V_275:
F_142 ( V_2 -> V_157 ) ;
...
int F_148 ( struct V_3 * V_3 , unsigned V_239 )
{
int V_61 ;
F_149 ( & V_3 -> V_107 ) ;
V_3 -> V_277 = sizeof( T_5 ) ;
V_3 -> V_116 = F_137 ( V_3 -> V_80 ,
V_3 -> V_277 ,
& V_3 -> V_115 ) ;
if ( V_3 -> V_116 == NULL )
return - V_244 ;
for ( V_61 = 0 ; V_61 < V_3 -> V_278 ; V_61 ++ ) {
V_3 -> V_114 [ V_61 ] = F_127 ( V_3 , V_61 , V_239 ) ;
if ( F_92 ( V_3 -> V_114 [ V_61 ] ) )
break;
}
if ( V_61 != V_3 -> V_278 ) {
int V_8 = F_93 ( V_3 -> V_114 [ V_61 ] ) ;
while ( V_61 -- )
F_146 ( V_3 -> V_114 [ V_61 ] ) ;
F_143 ( V_3 -> V_80 , V_3 -> V_277 ,
V_3 -> V_116 , V_3 -> V_115 ) ;
V_3 -> V_116 = NULL ;
return V_8 ;
}
...
F_150 ( & V_3 -> V_80 -> V_81 , L_10 ,
V_3 -> V_114 [ 0 ] -> V_157 -> V_276 ,
V_3 -> V_114 [ V_3 -> V_278 - 1 ] -> V_157 -> V_276 ) ;
return 0 ;
}
void F_151 ( struct V_3 * V_3 )
{
int V_61 ;
for ( V_61 = 0 ; V_61 < V_3 -> V_278 ; V_61 ++ )
F_146 ( V_3 -> V_114 [ V_61 ] ) ;
