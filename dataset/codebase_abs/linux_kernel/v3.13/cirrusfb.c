...
static int T_4 F_99 ( char * V_315 )
{
char * V_316 ;
if ( ! V_315 || ! * V_315 )
return 0 ;
while ( ( V_316 = F_100 ( & V_315 , L_69 ) ) != NULL ) {
if ( ! * V_316 )
continue;
if ( ! strcmp ( V_316 , L_70 ) )
V_259 = 1 ;
else if ( ! strncmp ( V_316 , L_71 , 5 ) )
V_275 = V_316 + 5 ;
else
V_275 = V_316 ;
}
...
F_109 ( V_2 -> V_13 , V_321 + V_320 , V_144 ) ;
}
static unsigned char F_110 ( const struct V_1 * V_2 , int V_320 )
{
unsigned long V_321 = 0 ;
if ( V_2 -> V_3 == V_117 ) {
if ( V_320 == V_322 || V_320 == V_323 )
...
return F_111 ( V_2 -> V_13 , V_321 + V_320 ) ;
}
static void F_33 ( const struct V_1 * V_2 )
{
assert ( V_2 != NULL ) ;
if ( F_41 ( V_2 -> V_13 , V_324 ) & 0x80 ) {
F_109 ( V_2 -> V_13 , V_325 ,
F_111 ( V_2 -> V_13 , V_326 ) ) ;
}
F_109 ( V_2 -> V_13 , V_325 , 0x33 ) ;
F_109 ( V_2 -> V_13 , V_325 , 0x00 ) ;
}
...
F_25 ( V_2 , V_123 , 0x00 ) ;
F_44 ( 200 ) ;
V_327 = F_110 ( V_2 , V_328 ) ;
F_44 ( 200 ) ;
}
V_327 = F_110 ( V_2 , V_123 ) ;
F_44 ( 200 ) ;
V_327 = F_110 ( V_2 , V_123 ) ;
F_44 ( 200 ) ;
V_327 = F_110 ( V_2 , V_123 ) ;
...
static void F_38 ( struct V_1 * V_2 , unsigned char V_320 , unsigned char V_36 ,
unsigned char V_39 , unsigned char V_40 )
{
unsigned int V_238 = V_323 ;
F_109 ( V_2 -> V_13 , V_328 , V_320 ) ;
...
T_6 V_333 , T_6 V_73 )
{
F_26 ( V_13 , V_334 , V_73 & 0xff ) ;
F_26 ( V_13 , V_335 , V_73 >> 8 ) ;
F_26 ( V_13 , V_336 , V_73 & 0xff ) ;
F_26 ( V_13 , V_337 , V_73 >> 8 ) ;
F_26 ( V_13 , V_338 , V_329 & 0xff ) ;
F_26 ( V_13 , V_339 , V_329 >> 8 ) ;
F_26 ( V_13 , V_340 , V_330 & 0xff ) ;
F_26 ( V_13 , V_341 , V_330 >> 8 ) ;
F_26 ( V_13 , V_342 , ( V_343 ) ( V_332 & 0xff ) ) ;
F_26 ( V_13 , V_344 , ( V_343 ) ( V_332 >> 8 ) ) ;
F_26 ( V_13 , V_345 , ( V_343 ) ( V_332 >> 16 ) ) ;
F_26 ( V_13 , V_346 , ( V_343 ) ( V_331 & 0xff ) ) ;
F_26 ( V_13 , V_347 , ( V_343 ) ( V_331 >> 8 ) ) ;
F_26 ( V_13 , V_348 , ( V_343 ) ( V_331 >> 16 ) ) ;
F_26 ( V_13 , V_349 , V_333 ) ;
F_26 ( V_13 , V_350 , 0x0d ) ;
...
V_331 = ( V_352 * V_73 ) + V_351 ;
V_332 = ( V_354 * V_73 ) + V_353 ;
if ( V_333 ) {
V_331 += V_330 * V_73 + V_329 ;
V_332 += V_330 * V_73 + V_329 ;
}
F_40 ( V_13 ) ;
F_113 ( V_13 , V_329 , V_330 ,
V_331 , V_332 , V_333 , V_73 ) ;
}
static void F_52 ( T_1 T_2 * V_13 , int V_20 ,
T_6 V_355 , T_6 V_356 , T_6 V_220 , T_6 V_221 ,
T_3 V_235 , T_3 V_236 , T_6 V_73 ,
V_343 V_357 )
{
T_7 V_332 = ( V_356 * V_73 ) + V_355 ;
V_343 V_230 ;
F_40 ( V_13 ) ;
...
V_230 = 0x80 ;
if ( V_20 >= 16 ) {
F_26 ( V_13 , V_358 , V_236 >> 8 ) ;
F_26 ( V_13 , V_359 , V_235 >> 8 ) ;
V_230 = 0x90 ;
}
if ( V_20 >= 24 ) {
F_26 ( V_13 , V_360 , V_236 >> 16 ) ;
F_26 ( V_13 , V_361 , V_235 >> 16 ) ;
V_230 = 0xa0 ;
}
if ( V_20 == 32 ) {
F_26 ( V_13 , V_362 , V_236 >> 24 ) ;
F_26 ( V_13 , V_363 , V_235 >> 24 ) ;
V_230 = 0xb0 ;
}
F_113 ( V_13 , V_220 - 1 , V_221 - 1 ,
0 , V_332 , V_230 | V_357 , V_73 ) ;
}
...
V_11 = 8000 ;
V_367 = V_11 ;
for ( V_364 = 32 ; V_364 < 128 ; V_364 ++ ) {
int V_368 = 0 ;
V_365 = ( 14318 * V_364 ) / V_11 ;
if ( ( V_365 >= 7 ) && ( V_365 <= 63 ) ) {
int V_369 = V_365 ;
if ( V_369 > 31 ) {
V_368 = 1 ;
...
V_366 = ( ( 14318 * V_364 ) / V_369 ) >> V_368 ;
V_366 = V_366 > V_11 ? V_366 - V_11 : V_11 - V_366 ;
if ( V_366 < V_367 ) {
V_367 = V_366 ;
* V_68 = V_364 ;
* V_69 = V_369 ;
...
unsigned V_373 ;
char * V_266 ;
va_start ( V_372 , V_371 ) ;
V_266 = va_arg ( V_372 , char * ) ;
while ( V_266 != NULL ) {
V_373 = va_arg ( V_372 , int ) ;
switch ( V_371 ) {
case V_374 :
V_144 = F_41 ( V_13 , ( unsigned char ) V_373 ) ;
break;
case V_375 :
V_144 = F_6 ( V_13 , ( unsigned char ) V_373 ) ;
break;
default:
assert ( false ) ;
break;
...
static void F_35 ( struct V_6 * V_7 , V_309 V_13 )
{
F_7 ( V_7 -> V_15 , L_73 ) ;
