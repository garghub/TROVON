...
* V_45 = V_51 ;
#ifdef F_16
V_48 = ( T_6 * ) & V_45 -> V_52 [ 0 ] ;
V_49 = ( T_6 * ) & V_45 -> V_52 [ 4 ] ;
#else
...
static int F_21 ( T_7 * V_58 , struct V_34 * V_35 )
{
if ( * V_58 != V_59 ) {
F_13 ( L_11 ,
V_35 -> V_26 , * V_58 ) ;
...
case V_7 :
if ( V_62 -> V_30 == V_31 ) {
V_64 = F_19 ( V_15 , V_64 , V_35 ) ;
if ( ! V_64 )
return - V_77 ;
if ( ! F_21 ( ( T_7 * ) V_63 + 1 , V_35 ) )
return - V_44 ;
}
...
#ifdef F_9
V_35 -> V_38 . V_80 = F_14 ( V_15 , V_35 ) ;
V_35 -> V_38 . V_81 = F_19 ( V_15 ,
( unsigned long ) V_82 ,
V_35 ) ;
#endif
return 0 ;
