...
T_2 V_26 ;
int V_27 ;
V_22 = F_20 ( & V_19 -> V_15 , sizeof( * V_22 ) , V_28 ) ;
if ( ! V_22 )
return - V_29 ;
V_24 = F_21 ( V_19 , V_30 , 0 ) ;
if ( ! V_24 )
return - V_31 ;
V_25 = F_22 ( & V_19 -> V_15 , V_24 -> V_32 ,
F_23 ( V_24 ) , V_19 -> V_33 ) ;
if ( ! V_25 )
return - V_34 ;
V_2 = F_20 ( & V_19 -> V_15 , sizeof( * V_2 ) , V_28 ) ;
if ( ! V_2 )
return - V_29 ;
V_2 -> V_14 = false ;
V_2 -> V_25 = V_25 ;
...
V_2 -> V_5 = 0x1234 ;
F_24 ( & V_2 -> V_13 ) ;
V_2 -> V_3 = F_25 ( & V_19 -> V_15 , V_24 -> V_32 , F_23 ( V_24 ) ) ;
if ( ! V_2 -> V_3 )
return - V_29 ;
V_22 -> V_35 = & V_36 ;
V_22 -> V_37 = & V_38 ;
...
static int F_37 ( struct V_18 * V_19 , T_3 V_51 )
{
struct V_11 * V_12 = F_34 ( V_19 ) ;
struct V_1 * V_2 = F_10 ( V_12 ) ;
F_11 ( & V_2 -> V_13 ) ;
