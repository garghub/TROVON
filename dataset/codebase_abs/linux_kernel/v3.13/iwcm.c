...
V_3 -> V_34 = V_54 ;
F_40 ( & V_3 -> V_38 , V_29 ) ;
V_50 = V_8 -> V_31 -> V_58 -> V_62 ( V_8 , V_61 ) ;
if ( V_50 )
V_3 -> V_34 = V_35 ;
F_38 ( & V_3 -> V_38 , V_29 ) ;
break;
...
V_41 = V_8 -> V_31 -> V_58 -> V_65 ( V_8 -> V_31 , V_64 -> V_66 ) ;
if ( ! V_41 ) {
F_40 ( & V_3 -> V_38 , V_29 ) ;
F_47 ( V_51 , & V_3 -> V_29 ) ;
F_48 ( & V_3 -> V_39 ) ;
...
V_3 -> V_41 = V_41 ;
F_40 ( & V_3 -> V_38 , V_29 ) ;
V_50 = V_8 -> V_31 -> V_58 -> V_67 ( V_8 , V_64 ) ;
if ( V_50 ) {
F_11 ( V_3 -> V_34 != V_55 ) ;
V_3 -> V_34 = V_35 ;
F_38 ( & V_3 -> V_38 , V_29 ) ;
...
int F_50 ( struct V_25 * V_8 , struct V_63 * V_64 )
{
struct V_2 * V_3 ;
int V_50 ;
unsigned long V_29 ;
...
V_3 -> V_34 = V_56 ;
F_40 ( & V_3 -> V_38 , V_29 ) ;
V_50 = V_8 -> V_31 -> V_58 -> V_68 ( V_8 , V_64 ) ;
if ( V_50 ) {
F_38 ( & V_3 -> V_38 , V_29 ) ;
if ( V_3 -> V_41 ) {
V_8 -> V_31 -> V_58 -> F_24 ( V_41 ) ;
...
static void F_51 ( struct V_2 * V_69 ,
struct V_16 * V_70 )
{
unsigned long V_29 ;
struct V_25 * V_8 ;
...
V_3 -> V_34 = V_52 ;
F_40 ( & V_3 -> V_38 , V_29 ) ;
V_50 = V_3 -> V_26 . V_32 ( & V_3 -> V_26 , V_70 ) ;
F_48 ( & V_3 -> V_39 ) ;
return V_50 ;
}
...
F_11 ( V_3 -> V_34 != V_56 ) ;
if ( V_70 -> V_71 == 0 ) {
V_3 -> V_26 . V_74 = V_70 -> V_74 ;
V_3 -> V_26 . V_75 = V_70 -> V_75 ;
V_3 -> V_34 = V_52 ;
} else {
V_3 -> V_26 . V_31 -> V_58 -> F_24 ( V_3 -> V_41 ) ;
V_3 -> V_41 = NULL ;
...
{
struct V_1 * V_4 = F_22 ( V_82 , struct V_1 , V_4 ) ;
struct V_16 V_83 ;
