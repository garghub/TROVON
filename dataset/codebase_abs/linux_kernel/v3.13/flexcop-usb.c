...
L_18 , V_91 ,
V_103 , V_96 , V_102 ) ;
V_7 -> V_93 = F_29 ( V_7 -> V_18 ,
V_102 , V_106 , & V_7 -> V_95 ) ;
if ( V_7 -> V_93 == NULL )
return - V_107 ;
...
F_18 ( L_21 ,
V_42 , V_104 , V_109 ) ;
V_80 -> V_85 [ V_104 ] . V_88 = V_109 ;
V_80 -> V_85 [ V_104 ] . V_116 = V_96 ;
V_109 += V_96 ;
}
...
static void F_45 ( struct V_129 * V_130 )
{
struct V_6 * V_7 = F_46 ( V_130 ) ;
F_23 ( V_7 ) ;
F_43 ( V_7 -> V_79 ) ;
F_38 ( V_7 ) ;
F_44 ( V_7 -> V_79 ) ;
