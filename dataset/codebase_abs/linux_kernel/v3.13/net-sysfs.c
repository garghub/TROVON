...
static const void * F_142 ( struct V_5 * V_45 )
{
struct V_1 * V_2 ;
V_2 = F_83 ( V_45 , struct V_1 , V_2 ) ;
return F_9 ( V_2 ) ;
}
void F_143 ( struct V_1 * V_9 )
{
...
int F_147 ( struct V_1 * V_9 )
{
struct V_5 * V_2 = & ( V_9 -> V_2 ) ;
const struct V_142 * * V_143 = V_9 -> V_144 ;
int error = 0 ;
F_148 ( V_2 ) ;
V_2 -> V_145 = & V_146 ;
V_2 -> V_147 = V_9 ;
V_2 -> V_143 = V_143 ;
F_149 ( V_2 , L_17 , V_9 -> V_139 ) ;
#ifdef F_125
if ( * V_143 )
V_143 ++ ;
* V_143 ++ = & V_148 ;
#if F_150 ( V_149 ) || F_150 ( V_150 )
if ( V_9 -> V_151 )
* V_143 ++ = & V_152 ;
#if F_150 ( V_149 )
else if ( V_9 -> V_153 )
...
int F_152 ( struct V_154 * V_155 ,
const void * V_131 )
{
return F_153 ( & V_146 , V_155 , V_131 ) ;
}
void F_154 ( struct V_154 * V_155 ,
const void * V_131 )
{
F_155 ( & V_146 , V_155 , V_131 ) ;
}
int F_156 ( void )
{
F_157 ( & V_156 ) ;
