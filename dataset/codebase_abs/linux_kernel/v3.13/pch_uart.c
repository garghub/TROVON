...
if ( V_6 == NULL )
goto V_293;
V_152 = ( unsigned char * ) F_125 ( V_13 ) ;
if ( ! V_152 )
goto V_294;
switch ( V_260 ) {
case V_295 :
...
#endif
V_10 = F_132 ( & V_306 , & V_6 -> V_14 ) ;
if ( V_10 < 0 )
goto V_297;
#ifdef F_133
snprintf ( V_291 , sizeof( V_291 ) , L_44 , V_290 -> V_305 ) ;
