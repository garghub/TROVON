...
{
struct V_64 * V_65 = V_77 -> V_15 ;
struct V_1 * V_17 = V_65 -> V_78 ;
struct V_32 * V_26 = F_13 ( V_17 -> V_33 ) ;
F_46 ( L_20 , F_40 ( & V_65 -> V_79 ) ) ;
return V_26 -> V_34 -> V_80 && F_57 ( V_65 ) ?
V_81 : V_82 ;
}
...
static int F_63 ( const struct V_15 * V_4 )
{
...
static int F_65 ( struct V_84 * V_85 , struct V_15 * V_4 )
{
struct V_1 * V_17 ;
struct V_32 * V_26 ;
if ( ! F_66 ( V_4 ) )
...
void F_67 ( struct V_2 * V_24 )
{
F_68 ( & V_24 -> V_4 ) ;
}
void F_69 ( struct V_2 * V_24 )
{
F_61 ( & V_24 -> V_4 ) ;
}
struct V_2 * F_70 ( struct V_1 * V_17 ,
struct V_92 * V_93 )
{
struct V_2 * V_24 ;
...
F_38 ) ;
F_75 ( & V_24 -> V_62 , F_43 ) ;
V_94 = F_76 ( & F_5 ( V_17 ) -> V_20 ) ;
F_77 ( & V_24 -> V_4 , L_21 , V_17 -> V_99 , V_94 ) ;
F_78 ( & V_24 -> V_4 ) ;
V_95 = F_79 ( & V_24 -> V_4 ) ;
if ( V_95 ) {
F_80 ( & V_24 -> V_4 ) ;
...
if ( V_17 -> V_100 & V_101 &&
V_93 -> V_30 == V_102 ) {
V_95 = F_81 ( V_17 , ( unsigned long ) V_24 ,
V_24 -> V_98 ) ;
if ( V_95 ) {
F_82 ( & V_24 -> V_4 ) ;
F_80 ( & V_24 -> V_4 ) ;
...
void F_85 ( struct V_2 * V_24 )
{
struct V_15 * V_4 = & V_24 -> V_4 ;
struct V_1 * V_17 = F_2 ( V_4 -> V_5 ) ;
if ( V_17 -> V_100 & V_101 &&
V_24 -> V_30 == V_102 )
F_86 ( V_17 , ( unsigned long ) V_24 ) ;
F_87 ( V_4 ) ;
F_82 ( V_4 ) ;
F_80 ( V_4 ) ;
F_41 ( & V_24 -> V_53 ) ;
...
static int F_88 ( struct V_15 * V_4 , void * V_103 )
{
if ( F_63 ( V_4 ) )
F_85 ( F_59 ( V_4 ) ) ;
return 0 ;
}
void F_89 ( struct V_1 * V_17 )
{
F_90 ( & V_17 -> V_61 , NULL , F_88 ) ;
}
static int F_91 ( struct V_1 * V_17 , T_3 V_104 , T_3 V_105 ,
int V_106 )
{
struct V_32 * V_26 = F_13 ( V_17 -> V_33 ) ;
return V_26 -> V_34 -> V_107 ( V_17 , V_104 , V_105 , V_106 ) ;
}
static int F_92 ( struct V_1 * V_17 , T_3 V_104 , int V_106 )
{
struct V_32 * V_26 = F_13 ( V_17 -> V_33 ) ;
return V_26 -> V_34 -> V_108 ( V_17 , V_104 , V_106 ) ;
}
struct V_109 *
F_93 ( struct V_110 * V_111 )
{
int V_31 ;
struct V_32 * V_26 ;
V_26 = F_71 ( sizeof( * V_26 ) , V_96 ) ;
if ( ! V_26 )
return NULL ;
V_26 -> V_91 . V_112 = F_56 ;
V_26 -> V_91 . V_107 = F_91 ;
V_26 -> V_91 . V_108 = F_92 ;
V_26 -> V_91 . V_113 = sizeof( struct V_18 ) ;
V_26 -> V_91 . V_86 . V_87 . V_114 = & V_26 -> V_86 [ 0 ] ;
V_26 -> V_91 . V_86 . V_87 . V_88 = & V_89 . V_88 ;
V_26 -> V_91 . V_86 . V_87 . V_115 = F_65 ;
V_26 -> V_86 [ 0 ] = NULL ;
F_94 ( & V_26 -> V_91 . V_86 ) ;
V_26 -> V_90 . V_87 . V_114 = & V_26 -> V_116 [ 0 ] ;
V_26 -> V_90 . V_87 . V_88 = & V_117 . V_88 ;
V_26 -> V_90 . V_87 . V_115 = F_64 ;
V_31 = 0 ;
V_26 -> V_116 [ V_31 ++ ] = & V_118 ;
V_26 -> V_116 [ V_31 ++ ] = & V_119 ;
if ( V_111 -> V_120 ) {
V_26 -> V_116 [ V_31 ++ ] = & V_121 ;
V_26 -> V_116 [ V_31 ++ ] = & V_122 ;
V_26 -> V_116 [ V_31 ++ ] = & V_123 ;
}
if ( V_111 -> V_70 ) {
V_26 -> V_116 [ V_31 ++ ] = & V_124 ;
V_26 -> V_116 [ V_31 ++ ] = & V_125 ;
}
if ( V_111 -> V_35 )
V_26 -> V_116 [ V_31 ++ ] = & V_126 ;
V_26 -> V_116 [ V_31 ++ ] = NULL ;
F_95 ( V_31 > F_11 ( V_26 -> V_116 ) ) ;
F_94 ( & V_26 -> V_90 ) ;
V_26 -> V_34 = V_111 ;
return & V_26 -> V_91 ;
}
void F_96 ( struct V_109 * V_91 )
{
