...
V_11 = F_40 ( V_21 , V_21 -> V_182 + V_185 , & V_27 ) ;
if ( V_11 )
goto V_184;
V_181 = F_64 ( V_27 ) ;
if ( V_181 > V_2 -> V_28 . V_137 ) {
V_11 = - V_7 ;
goto V_184;
}
V_2 -> V_181 = F_65 ( sizeof( struct V_179 ) * V_181 ,
V_186 ) ;
if ( ! V_2 -> V_181 ) {
V_11 = - V_187 ;
goto V_184;
...
V_2 -> V_181 [ V_26 ] . V_188 = V_26 ;
V_11 = F_66 ( V_21 , V_2 -> V_181 , V_181 ) ;
if ( V_11 < 0 )
goto V_189;
if ( V_11 > 0 ) {
if ( V_2 -> V_43 != V_44 ) {
...
for ( V_26 = 0 ; V_26 < V_181 ; V_26 ++ ) {
V_180 = & V_2 -> V_181 [ V_26 ] ;
F_67 ( ! V_180 -> V_190 ) ;
if ( V_2 -> V_43 == V_44 ) {
V_11 = F_68 ( V_180 -> V_190 , F_57 , 0 ,
L_31 , & V_2 -> V_10 [ V_26 ] ) ;
if ( V_11 )
goto V_191;
} else {
if ( V_26 == V_181 - 1 ) {
V_11 = F_68 ( V_180 -> V_190 ,
F_59 , 0 ,
L_32 , V_2 ) ;
if ( V_11 )
goto V_191;
...
while ( -- V_26 >= 0 ) {
V_180 = & V_2 -> V_181 [ V_26 ] ;
if ( V_2 -> V_43 != V_44 && V_26 == V_2 -> V_192 - 1 )
F_69 ( V_180 -> V_190 , V_2 ) ;
else
F_69 ( V_180 -> V_190 , & V_2 -> V_10 [ V_26 ] ) ;
}
F_70 ( V_21 ) ;
V_189:
F_71 ( V_2 -> V_181 ) ;
...
if ( V_11 )
return V_11 ;
V_11 = F_68 ( V_21 -> V_175 , F_60 , 0 , L_34 , V_2 ) ;
if ( V_11 ) {
F_74 ( V_21 ) ;
F_47 ( & V_21 -> V_22 , L_35 ) ;
return V_11 ;
...
F_76 ( V_21 ) ;
F_77 ( V_21 , 1 ) ;
V_11 = F_68 ( V_21 -> V_175 , F_60 , V_193 , L_36 ,
V_2 ) ;
if ( V_11 )
return V_11 ;
return 0 ;
...
struct V_179 * V_180 ;
T_1 V_26 ;
for ( V_26 = 0 ; V_26 < V_2 -> V_192 ; V_26 ++ ) {
V_180 = & V_2 -> V_181 [ V_26 ] ;
if ( V_2 -> V_43 != V_44 && V_26 == V_2 -> V_192 - 1 )
F_69 ( V_180 -> V_190 , V_2 ) ;
else
...
return;
if ( ! V_196 )
V_196 = F_86 ( V_197 , NULL ) ;
V_2 -> V_196 = F_86 ( F_87 ( V_2 -> V_21 ) ,
V_196 ) ;
}
...
static int F_93 ( struct V_23 * V_21 , const struct V_204 * V_205 )
{
struct V_1 * V_2 ;
int V_11 , V_26 ;
V_2 = F_94 ( sizeof( struct V_1 ) , V_186 ) ;
if ( ! V_2 )
return - V_187 ;
V_2 -> V_21 = V_21 ;
V_2 -> V_61 = V_72 ;
...
goto V_184;
F_97 ( V_2 -> V_21 ) ;
V_11 = F_98 ( V_21 , V_206 , V_197 ) ;
if ( V_11 )
goto V_189;
V_2 -> V_47 = F_99 ( V_21 , V_207 ) ;
if ( ! V_2 -> V_47 ) {
F_10 ( & V_21 -> V_22 , L_38 ) ;
V_11 = - V_183 ;
goto V_191;
...
V_2 -> V_32 [ V_26 ] . V_34 = F_100 ( V_21 , F_29 ( V_26 ) ) ;
V_2 -> V_32 [ V_26 ] . V_33 =
F_101 ( F_28 ( V_21 , F_29 ( V_26 ) ) ,
V_2 -> V_32 [ V_26 ] . V_34 ) ;
F_39 ( & V_21 -> V_22 , L_39 , V_26 ,
...
V_11 = F_102 ( V_21 , F_103 ( 64 ) ) ;
if ( V_11 ) {
V_11 = F_102 ( V_21 , F_103 ( 32 ) ) ;
if ( V_11 )
goto V_209;
F_10 ( & V_21 -> V_22 , L_41 ) ;
}
V_11 = F_104 ( V_21 , F_103 ( 64 ) ) ;
if ( V_11 ) {
V_11 = F_104 ( V_21 , F_103 ( 32 ) ) ;
if ( V_11 )
goto V_209;
F_10 ( & V_21 -> V_22 , L_42 ) ;
}
...
F_88 ( V_2 ) ;
F_71 ( V_2 ) ;
F_47 ( & V_21 -> V_22 , L_43 , V_197 ) ;
return V_11 ;
}
static void F_109 ( struct V_23 * V_21 )
{
struct V_1 * V_2 = F_16 ( V_21 ) ;
int V_26 ;
F_92 ( V_2 ) ;
