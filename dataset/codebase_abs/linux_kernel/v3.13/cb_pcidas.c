...
return 4 ;
if ( V_89 -> V_119 ) {
V_92 = F_9 ( V_89 -> V_119 [ 0 ] ) ;
V_93 = F_8 ( V_89 -> V_119 [ 0 ] ) ;
for ( V_20 = 1 ; V_20 < V_89 -> V_112 ; V_20 ++ ) {
if ( F_8 ( V_89 -> V_119 [ V_20 ] ) !=
( V_93 + V_20 ) % V_11 -> V_120 ) {
F_31 ( V_4 ,
L_4 ) ;
V_90 ++ ;
}
if ( F_9 ( V_89 -> V_119 [ V_20 ] ) != V_92 ) {
F_31 ( V_4 ,
L_5 ) ;
V_90 ++ ;
}
...
static void F_49 ( struct V_3 * V_4 , unsigned int * V_121 ,
int V_122 )
{
struct V_5 * V_6 = V_4 -> V_7 ;
F_48 ( V_116 ,
& V_6 -> V_117 , & V_6 -> V_118 ,
V_121 , V_122 ) ;
F_50 ( V_6 -> V_123 + V_124 , 0 , 1 ,
V_6 -> V_117 , 2 ) ;
F_50 ( V_6 -> V_123 + V_124 , 0 , 2 ,
V_6 -> V_118 , 2 ) ;
}
...
struct V_88 * V_89 = & V_126 -> V_89 ;
unsigned int V_18 ;
unsigned long V_39 ;
F_11 ( 0 , V_6 -> V_22 + V_23 ) ;
F_11 ( 0 , V_6 -> V_22 + V_127 ) ;
F_11 ( 0 , V_6 -> V_29 + V_30 ) ;
V_18 = F_12 ( F_8 ( V_89 -> V_119 [ 0 ] ) ) |
F_13 ( F_8 ( V_89 -> V_119 [ V_89 -> V_112 - 1 ] ) ) |
F_14 ( F_9 ( V_89 -> V_119 [ 0 ] ) ) ;
if ( F_9 ( V_89 -> V_119 [ 0 ] ) & V_24 )
V_18 |= V_25 ;
if ( F_10 ( V_89 -> V_119 [ 0 ] ) != V_26 )
V_18 |= V_27 ;
...
if ( V_90 )
return 4 ;
if ( V_89 -> V_119 && V_89 -> V_112 > 1 ) {
if ( F_8 ( V_89 -> V_119 [ 0 ] ) != 0 ||
F_8 ( V_89 -> V_119 [ 1 ] ) != 1 ) {
F_31 ( V_4 ,
L_7 ) ;
V_90 ++ ;
...
struct V_125 * V_126 = V_11 -> V_126 ;
struct V_88 * V_89 = & V_11 -> V_126 -> V_89 ;
unsigned long V_39 ;
if ( V_154 != 0 )
return - V_38 ;
...
V_6 -> V_41 |=
F_3 ( F_8 ( V_89 -> V_119 [ V_20 ] ) ) ;
V_6 -> V_41 |= F_1 ( F_8 ( V_89 -> V_119 [ V_20 ] ) ,
F_9 ( V_89 ->
V_119 [ V_20 ] ) ) ;
}
F_11 ( V_6 -> V_41 , V_6 -> V_22 + V_44 ) ;
...
& V_6 -> V_152 ,
& V_89 -> V_110 , V_89 -> V_39 ) ;
F_50 ( V_6 -> V_123 + V_166 , 0 , 1 ,
V_6 -> V_151 , 2 ) ;
F_50 ( V_6 -> V_123 + V_166 , 0 , 2 ,
V_6 -> V_152 , 2 ) ;
}
if ( V_89 -> V_103 == V_102 )
...
V_179 * sizeof( short ) ) ;
V_6 -> V_131 -= V_179 ;
if ( V_126 -> V_89 . V_103 == V_102 && V_6 -> V_131 == 0 ) {
V_126 -> V_172 |= V_174 ;
F_53 ( V_4 , V_11 ) ;
}
F_19 ( & V_4 -> V_40 , V_39 ) ;
...
V_11 -> V_220 = F_33 ;
V_11 -> V_230 = F_32 ;
for ( V_20 = 0 ; V_20 < V_11 -> V_120 ; V_20 ++ )
...
const struct V_242 * V_34 )
{
return F_85 ( V_4 , & V_243 ,
V_34 -> V_244 ) ;
}
