...
struct V_50 * V_51 ;
int V_52 ;
V_5 = F_22 ( & V_49 -> V_2 , sizeof( * V_5 ) , V_53 ) ;
if ( ! V_5 )
return - V_54 ;
V_51 = F_23 ( V_49 , V_55 , 0 ) ;
if ( ! V_51 ) {
F_24 ( & V_49 -> V_2 , L_2 ) ;
return - V_56 ;
}
V_5 -> V_6 = F_25 ( & V_49 -> V_2 , V_51 -> V_57 , F_26 ( V_51 ) ) ;
if ( ! V_5 -> V_6 ) {
F_24 ( & V_49 -> V_2 , L_3 ) ;
return - V_58 ;
}
V_5 -> V_59 = F_27 ( V_49 , 0 ) ;
if ( ! ( F_8 ( V_21 + V_5 -> V_6 ) &
V_60 ) ) {
F_24 ( & V_49 -> V_2 , L_4 ) ;
return - V_61 ;
...
V_43 ,
V_5 -> V_6 + V_33 ) ;
V_5 -> V_34 = F_30 ( & V_49 -> V_2 , V_49 -> V_64 ,
& V_65 , V_66 ) ;
if ( F_31 ( V_5 -> V_34 ) )
return F_32 ( V_5 -> V_34 ) ;
V_52 = F_33 ( & V_49 -> V_2 , V_5 -> V_59 ,
F_13 , 0 , L_6 , & V_49 -> V_2 ) ;
if ( V_52 ) {
F_24 ( & V_49 -> V_2 , L_7 ,
V_5 -> V_59 ) ;
