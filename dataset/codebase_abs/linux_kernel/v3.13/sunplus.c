...
F_34 ( V_1 , V_83 , V_19 , V_4 ) ;
}
static int F_35 ( struct V_84 * V_85 )
{
struct V_1 * V_1 =
F_36 ( V_85 -> V_86 , struct V_1 , V_87 ) ;
struct V_32 * V_32 = (struct V_32 * ) V_1 ;
V_1 -> V_7 = 0 ;
if ( ! V_1 -> V_88 )
return 0 ;
...
const struct V_48 * V_49 )
{
return F_41 ( V_98 , V_49 , & V_99 , sizeof( struct V_32 ) ,
V_100 ) ;
}
