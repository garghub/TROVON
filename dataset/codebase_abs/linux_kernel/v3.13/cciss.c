...
goto V_522;
if ( F_245 ( V_1 -> V_24 , V_523 ) ) {
V_79 = F_246 ( V_1 -> V_24 , V_521 , 4 ) ;
if ( ! V_79 ) {
...
if ( F_245 ( V_1 -> V_24 , V_526 ) ) {
if ( ! F_247 ( V_1 -> V_24 ) )
V_1 -> V_527 = 1 ;
else
F_153 ( & V_1 -> V_24 -> V_25 , L_128 ) ;
}
V_522:
#endif
...
static int F_248 ( struct V_475 * V_24 , T_11 * V_48 )
{
int V_20 ;
T_11 V_528 , V_529 ;
V_528 = V_24 -> V_530 ;
...
F_153 ( & V_24 -> V_25 , L_129 ,
* V_48 ) ;
return - V_534 ;
}
static inline bool F_249 ( T_1 * V_1 )
{
T_38 V_535 ;
( void ) F_250 ( V_1 -> V_24 , V_536 , & V_535 ) ;
return ( ( V_535 & V_537 ) == 0 ) ;
}
static int F_251 ( struct V_475 * V_24 ,
unsigned long * V_538 )
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_480 ; V_20 ++ )
if ( F_234 ( V_24 , V_20 ) & V_539 ) {
* V_538 = F_252 ( V_24 , V_20 ) ;
...
static int F_253 ( struct V_475 * V_24 ,
...
static int F_257 ( struct V_475 * V_24 , void T_34 * V_207 ,
...
if ( * V_549 == - 1 ) {
F_153 ( & V_24 -> V_25 , L_133
L_134 , * V_548 ) ;
return - V_534 ;
}
return 0 ;
}
static int F_258 ( T_1 * V_1 )
{
T_39 V_550 ;
T_11 V_548 ;
T_39 V_549 ;
T_11 V_494 ;
int V_279 ;
V_279 = F_257 ( V_1 -> V_24 , V_1 -> V_207 , & V_548 ,
& V_549 , & V_550 ) ;
if ( V_279 )
return V_279 ;
V_1 -> V_202 = F_175 ( F_252 ( V_1 -> V_24 ,
V_549 ) + V_550 , sizeof( * V_1 -> V_202 ) ) ;
if ( ! V_1 -> V_202 )
return - V_83 ;
V_279 = F_259 ( V_1 -> V_202 ) ;
if ( V_279 )
return V_279 ;
V_494 = F_109 ( & V_1 -> V_202 -> V_497 ) ;
V_1 -> V_498 = F_175 ( F_252 ( V_1 -> V_24 ,
V_549 ) + V_550 + V_494 ,
sizeof( * V_1 -> V_498 ) ) ;
if ( ! V_1 -> V_498 )
return - V_83 ;
...
static void F_260 ( struct V_100 * V_1 )
{
V_1 -> V_442 = F_109 ( & ( V_1 -> V_202 -> V_553 ) ) ;
if ( V_445 && V_1 -> V_442 > 32 )
V_1 -> V_442 = 32 ;
if ( V_1 -> V_442 < 16 ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_135
L_136
L_137 ,
V_1 -> V_442 ) ;
V_1 -> V_442 = 16 ;
...
static inline bool F_262 ( T_1 * V_1 )
{
if ( ! F_263 ( V_1 -> V_202 -> V_469 , L_138 , 4 ) ) {
...
static int F_269 ( T_1 * V_1 )
{
int V_562 , V_79 ;
V_562 = F_248 ( V_1 -> V_24 , & V_1 -> V_48 ) ;
if ( V_562 < 0 )
return - V_534 ;
...
V_79 = F_271 ( V_1 -> V_24 ) ;
if ( V_79 ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_141 ) ;
return V_79 ;
}
V_79 = F_272 ( V_1 -> V_24 , L_142 ) ;
if ( V_79 ) {
F_153 ( & V_1 -> V_24 -> V_25 ,
L_143 ) ;
return V_79 ;
}
F_87 ( & V_1 -> V_24 -> V_25 , L_144 , V_1 -> V_24 -> V_446 ) ;
F_87 ( & V_1 -> V_24 -> V_25 , L_145 , V_1 -> V_48 ) ;
F_243 ( V_1 ) ;
V_79 = F_251 ( V_1 -> V_24 , & V_1 -> V_566 ) ;
if ( V_79 )
goto V_567;
...
V_79 = F_253 ( V_1 -> V_24 , V_1 -> V_207 , F_254 ) ;
if ( V_79 )
goto V_567;
V_79 = F_258 ( V_1 ) ;
if ( V_79 )
...
static int F_276 ( struct V_475 * V_24 )
{
int V_20 ;
...
F_153 ( & V_24 -> V_25 , L_146
L_147 , V_568 ) ;
return - 1 ;
V_569:
F_153 ( & V_24 -> V_25 , L_148 ) ;
return - 1 ;
}
...
static int F_278 ( struct V_475 * V_24 , unsigned char V_570 ,
unsigned char type )
{
typedef struct {
T_40 V_571 ;
...
void T_34 * V_207 ;
int V_20 , V_79 ;
V_207 = F_279 ( F_252 ( V_24 , 0 ) , F_280 ( V_24 , 0 ) ) ;
if ( V_207 == NULL )
return - V_83 ;
V_79 = F_281 ( V_24 , F_282 ( 32 ) ) ;
if ( V_79 ) {
F_274 ( V_207 ) ;
return - V_83 ;
}
V_155 = F_78 ( V_24 , V_573 , & V_574 ) ;
if ( V_155 == NULL ) {
F_274 ( V_207 ) ;
return - V_83 ;
}
...
static int F_283 ( struct V_475 * V_24 ,
void * T_34 V_207 , T_11 V_581 )
{
T_38 V_582 ;
int V_56 ;
if ( V_581 ) {
F_173 ( & V_24 -> V_25 , L_152 ) ;
F_111 ( V_581 , V_207 + V_208 ) ;
} else {
V_56 = F_245 ( V_24 , V_583 ) ;
if ( V_56 == 0 ) {
F_18 ( & V_24 -> V_25 ,
L_153
L_154 ) ;
...
F_173 ( & V_24 -> V_25 , L_155 ) ;
F_250 ( V_24 , V_56 + V_584 , & V_582 ) ;
V_582 &= ~ V_585 ;
V_582 |= V_586 ;
...
static void F_285 ( char * V_588 , int V_40 )
{
memset ( V_588 , 0 , V_40 ) ;
strncpy ( V_588 , L_156 V_589 , V_40 - 1 ) ;
}
static int F_259 ( T_37 T_34 * V_202 )
{
char * V_588 ;
...
static void F_286 ( T_37 T_34 * V_202 ,
unsigned char * V_590 )
{
int V_20 ;
...
static int F_287 ( T_37 T_34 * V_202 )
{
char * V_590 , * V_591 ;
...
static int F_288 ( struct V_475 * V_24 )
{
T_39 V_550 ;
T_11 V_548 ;
T_39 V_549 ;
...
F_289 ( V_24 ) ;
F_290 ( V_24 ) ;
V_279 = F_251 ( V_24 , & V_566 ) ;
if ( V_279 )
return V_279 ;
V_207 = F_175 ( V_566 , 0x250 ) ;
if ( ! V_207 )
return - V_83 ;
V_279 = F_257 ( V_24 , V_207 , & V_548 ,
& V_549 , & V_550 ) ;
if ( V_279 )
goto V_595;
V_202 = F_175 ( F_252 ( V_24 ,
...
V_279 = F_283 ( V_24 , V_207 , V_581 ) ;
if ( V_279 )
goto V_599;
F_291 ( V_24 ) ;
V_279 = F_271 ( V_24 ) ;
if ( V_279 ) {
F_153 ( & V_24 -> V_25 , L_163 ) ;
goto V_599;
}
F_284 ( V_24 , 4 , V_593 ) ;
F_256 ( V_600 ) ;
F_173 ( & V_24 -> V_25 , L_164 ) ;
V_279 = F_253 ( V_24 , V_207 , F_255 ) ;
if ( V_279 ) {
F_153 ( & V_24 -> V_25 , L_165
L_166 ) ;
V_279 = - V_594 ;
goto V_599;
}
V_279 = F_253 ( V_24 , V_207 , F_254 ) ;
if ( V_279 ) {
F_153 ( & V_24 -> V_25 ,
L_167
L_168 ) ;
...
goto V_599;
if ( V_279 ) {
F_153 ( & V_24 -> V_25 , L_169
L_170 ) ;
V_279 = - V_594 ;
} else {
F_173 ( & V_24 -> V_25 , L_171 ) ;
}
V_599:
F_274 ( V_202 ) ;
V_595:
...
static int F_292 ( struct V_475 * V_24 )
{
int V_279 , V_20 ;
if ( ! V_445 )
return 0 ;
...
static int F_294 ( T_1 * V_1 )
{
V_1 -> V_127 = F_17 ( F_295 ( V_1 -> V_19 ) *
sizeof( unsigned long ) , V_23 ) ;
V_1 -> V_128 = F_78 ( V_1 -> V_24 ,
V_1 -> V_19 * sizeof( T_2 ) ,
& ( V_1 -> V_129 ) ) ;
V_1 -> V_131 = F_78 ( V_1 -> V_24 ,
...
static int F_303 ( T_1 * V_1 )
{
if ( F_167 ( V_1 , V_151 , V_604 ) ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_182 ) ;
return - V_275 ;
}
F_173 ( & V_1 -> V_24 -> V_25 , L_183 ) ;
if ( F_253 ( V_1 -> V_24 , V_1 -> V_207 , F_255 ) ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_184 ) ;
return - 1 ;
}
F_173 ( & V_1 -> V_24 -> V_25 , L_185 ) ;
if ( F_253 ( V_1 -> V_24 , V_1 -> V_207 , F_254 ) ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_186
L_187 ) ;
return - 1 ;
}
return 0 ;
...
if ( V_1 -> V_207 )
F_274 ( V_1 -> V_207 ) ;
F_308 ( V_1 -> V_288 , V_1 -> V_46 ) ;
F_67 ( V_1 ) ;
F_275 ( V_1 -> V_24 ) ;
F_15 ( V_1 ) ;
V_266 [ V_62 ] = NULL ;
}
static int F_309 ( struct V_475 * V_24 , const struct V_605 * V_606 )
{
int V_20 ;
int V_22 = 0 ;
int V_279 ;
...
V_279 = F_313 ( V_1 -> V_288 , V_1 -> V_46 ) ;
if ( V_279 == - V_58 || V_279 == - V_81 ) {
F_18 ( & V_1 -> V_24 -> V_25 ,
L_190
L_191 , V_1 -> V_288 , V_1 -> V_46 , V_20 ) ;
goto V_614;
} else {
if ( V_20 >= V_615 )
V_1 -> V_288 = V_279 ;
...
V_279 = F_299 ( V_1 , F_222 , F_221 ) ;
if ( V_279 )
goto V_619;
F_173 ( & V_1 -> V_24 -> V_25 , L_192 ,
V_1 -> V_46 , V_24 -> V_97 , F_314 ( V_24 ) ,
V_1 -> V_50 [ V_1 -> V_51 ] , V_608 ? L_175 : L_193 ) ;
if ( F_294 ( V_1 ) )
goto V_620;
if ( F_296 ( V_1 ) )
goto V_620;
...
F_13 ( & V_1 -> V_14 , V_13 ) ;
F_305 ( V_1 -> V_50 [ V_1 -> V_51 ] , V_1 ) ;
V_279 = F_299 ( V_1 , F_220 ,
F_219 ) ;
if ( V_279 ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_194
L_195 ) ;
goto V_620;
}
V_279 = F_303 ( V_1 ) ;
if ( V_279 ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_196 ) ;
goto V_620;
}
F_173 ( & V_1 -> V_24 -> V_25 , L_197 ) ;
F_173 ( & V_1 -> V_24 -> V_25 ,
L_198 ) ;
V_1 -> V_385 . V_617 ( V_1 , V_621 ) ;
F_256 ( 10000 ) ;
V_1 -> V_385 . V_617 ( V_1 , V_618 ) ;
V_279 = F_287 ( V_1 -> V_202 ) ;
if ( V_279 )
F_173 ( & V_1 -> V_24 -> V_25 ,
L_199 ) ;
F_304 ( V_1 ) ;
...
static void F_319 ( struct V_475 * V_24 )
{
T_1 * V_1 ;
char * V_622 ;
int V_317 ;
...
static int F_273 ( struct V_100 * V_1 )
{
T_11 V_514 ;
V_514 = F_109 ( & ( V_1 -> V_202 -> V_471 ) ) ;
if ( ! ( V_514 & V_623 ) )
...
F_153 ( & V_1 -> V_24 -> V_25 , L_204 ) ;
return - V_534 ;
}
V_1 -> V_3 = V_624 ;
return 0 ;
}
static void F_321 ( struct V_475 * V_24 )
{
T_1 * V_1 ;
int V_20 , V_22 ;
if ( F_320 ( V_24 ) == NULL ) {
...
static int T_44 F_324 ( void )
{
int V_79 ;
F_241 ( sizeof( T_2 ) % V_625 ) ;
F_325 (KERN_INFO DRIVER_NAME L_207 ) ;
V_79 = F_326 ( & V_120 ) ;
if ( V_79 )
return V_79 ;
V_102 = F_327 ( F_228 , NULL , L_208 ) ;
if ( F_328 ( V_102 ) ) {
V_79 = F_329 ( V_102 ) ;
goto V_626;
}
