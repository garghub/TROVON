...
static int F_37 ( struct V_191 * V_191 ,
const struct V_192 * V_134 )
{
struct V_107 * V_171 ;
struct V_193 * V_188 = F_38 ( & V_191 -> V_2 ) ;
int V_185 ;
unsigned int V_194 = 0 ;
unsigned int V_3 ;
T_1 V_195 ;
V_171 = F_39 ( & V_191 -> V_2 , sizeof( struct V_107 ) ,
V_196 ) ;
if ( ! V_171 ) {
F_15 ( & V_191 -> V_2 , L_8 ) ;
return - V_197 ;
}
V_171 -> V_180 = F_40 ( V_191 , & V_198 ) ;
if ( F_41 ( V_171 -> V_180 ) ) {
V_185 = F_42 ( V_171 -> V_180 ) ;
F_15 ( & V_191 -> V_2 , L_9 , V_185 ) ;
return V_185 ;
}
if ( V_188 ) {
V_171 -> V_188 = * V_188 ;
} else {
V_188 = F_39 ( & V_191 -> V_2 ,
sizeof( struct V_193 ) ,
V_196 ) ;
if ( ! V_188 ) {
F_15 ( & V_191 -> V_2 , L_10 ) ;
...
if ( V_191 -> V_2 . V_199 ) {
if ( F_43 ( V_191 -> V_2 . V_199 ,
L_11 , & V_195 ) >= 0 )
V_188 -> V_189 = V_195 ;
}
V_188 -> V_200 = F_44 ( V_191 -> V_2 . V_199 ,
L_12 , 0 ) ;
V_171 -> V_188 = * V_188 ;
}
F_45 ( V_191 , V_171 ) ;
if ( V_171 -> V_188 . V_200 ) {
V_185 = F_46 ( V_171 -> V_188 . V_200 ,
V_201 , L_13 ) ;
if ( V_185 < 0 ) {
F_15 ( & V_191 -> V_2 , L_14 ,
V_171 -> V_188 . V_200 , V_185 ) ;
return V_185 ;
}
F_47 ( V_171 -> V_188 . V_200 , 0 ) ;
F_47 ( V_171 -> V_188 . V_200 , 1 ) ;
}
F_48 ( V_171 -> V_180 , true ) ;
V_185 = F_49 ( V_171 -> V_180 , V_6 , & V_3 ) ;
V_194 = ( V_3 & 0xFF ) << 12 ;
V_185 = F_49 ( V_171 -> V_180 , V_7 , & V_3 ) ;
V_194 |= ( V_3 & 0xFF ) << 4 ;
V_185 = F_49 ( V_171 -> V_180 , V_8 , & V_3 ) ;
V_194 |= ( V_3 & 0xF0 ) >> 4 ;
if ( V_194 != V_202 ) {
V_185 = - V_203 ;
F_15 ( & V_191 -> V_2 ,
...
V_185 = F_49 ( V_171 -> V_180 , V_9 , & V_3 ) ;
if ( V_185 < 0 ) {
F_15 ( & V_191 -> V_2 , L_16 ) ;
return V_185 ; ;
}
F_50 ( & V_191 -> V_2 ,
L_17 , V_3 & 0xFF ) ;
F_48 ( V_171 -> V_180 , false ) ;
V_185 = F_51 ( & V_191 -> V_2 ,
& V_204 , V_205 ,
F_9 ( V_205 ) ) ;
if ( V_185 < 0 )
return V_185 ;
...
static int F_52 ( struct V_191 * V_206 )
{
F_53 ( & V_206 -> V_2 ) ;
return 0 ;
}
