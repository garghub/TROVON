...
if ( ! V_4 )
return - V_30 ;
V_4 -> V_11 . V_31 = V_27 -> V_31 ;
if ( ! V_27 -> V_32 ) {
V_28 = - V_33 ;
F_5 ( & V_25 -> V_12 , L_2 ) ;
goto V_34;
}
V_4 -> V_11 . V_12 . V_35 = & V_25 -> V_12 ;
V_4 -> V_11 . V_36 = V_27 -> V_32 ;
...
;
V_4 -> V_13 = V_9 ;
V_4 -> V_10 = F_12 ( & V_25 -> V_12 , V_27 -> V_39 ) ;
if ( F_13 ( V_4 -> V_10 ) ) {
V_28 = F_14 ( V_4 -> V_10 ) ;
goto V_34;
}
V_4 -> V_22 = F_15 ( V_27 -> V_40 ) ;
F_16 ( & V_4 -> V_5 , F_1 ) ;
F_17 ( V_25 , V_4 ) ;
V_28 = F_18 ( & V_4 -> V_11 ) ;
if ( V_28 )
goto V_34;
V_4 -> V_19 = F_19 ( V_25 , 0 ) ;
if ( ! V_4 -> V_19 ) {
F_5 ( & V_25 -> V_12 , L_5 ) ;
V_28 = - V_41 ;
goto V_42;
