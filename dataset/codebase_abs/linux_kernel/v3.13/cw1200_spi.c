...
static int F_53 ( struct V_51 * V_19 )
{
...
static int F_56 ( struct V_67 * V_53 , T_5 V_68 )
{
struct V_1 * V_2 = F_54 ( F_57 ( V_53 ) ) ;
if ( ! F_58 ( V_2 -> V_37 ) )
return - V_69 ;
return 0 ;
}
static int F_59 ( struct V_67 * V_53 )
{
return 0 ;
}
