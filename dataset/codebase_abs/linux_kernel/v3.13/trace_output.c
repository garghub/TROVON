...
static int
F_45 ( struct V_3 * V_4 , struct V_13 * V_14 , int V_89 )
{
char V_90 [ V_91 ] ;
F_46 ( V_14 -> V_92 , V_90 ) ;
if ( ! F_10 ( V_4 , L_18 ,
...
static int
F_47 ( struct V_10 * V_11 , T_4 V_93 )
{
...
if ( V_94 && V_96 ) {
unsigned long V_104 = F_49 ( V_99 , V_105 ) ;
unsigned long V_106 = ( unsigned long ) V_99 ;
unsigned long V_107 = F_49 ( V_103 , V_105 ) ;
...
if ( V_11 -> V_97 & V_98 ) {
V_110 = F_48 ( V_11 -> V_100 ) ;
V_112 = F_49 ( V_110 , V_114 ) ;
...
V_7 = F_45 ( V_4 , V_14 , V_11 -> V_89 ) ;
}
if ( V_7 )
V_7 = F_47 ( V_11 , V_93 ) ;
return V_7 ;
}
static int F_53 ( unsigned long V_118 )
{
int V_119 = V_118 ? F_54 ( V_118 ) + 1 : 0 ;
...
int V_146 , V_147 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
V_147 = F_53 ( V_17 -> V_148 ) ;
V_146 = F_53 ( V_17 -> V_149 ) ;
F_46 ( V_17 -> V_150 , V_90 ) ;
if ( ! F_10 ( & V_11 -> V_12 ,
L_31 ,
V_17 -> V_151 ,
V_17 -> V_152 ,
...
static int F_83 ( struct V_10 * V_11 , char V_146 )
{
struct V_145 * V_17 ;
int V_147 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
