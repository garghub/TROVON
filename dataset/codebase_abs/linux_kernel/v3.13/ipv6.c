...
goto V_42;
V_50 = F_31 ( V_2 , F_32 ( V_28 ) ) ;
if ( ! V_50 )
goto V_42;
if ( F_2 ( V_2 ) -> V_56 > F_33 ( V_50 ) )
F_34 ( V_2 , F_33 ( V_50 ) ) ;
goto V_42;
}
F_35 ( type , V_26 , & V_34 ) ;
...
if ( F_25 ( V_2 ) )
goto V_42;
V_58 = F_36 ( V_2 , & V_59 , V_18 -> V_22 ,
& V_30 -> V_11 , & V_30 -> V_10 ,
F_21 ( V_8 ) ) ;
if ( V_58 == NULL )
goto V_42;
F_37 ( V_58 -> V_2 != NULL ) ;
if ( ! F_29 ( V_35 , F_38 ( V_58 ) -> V_61 ,
F_38 ( V_58 ) -> V_62 ) ) {
F_26 ( V_36 , V_47 ) ;
goto V_42;
}
...
static int F_44 ( struct V_1 * V_2 , struct V_57 * V_58 )
{
struct V_70 * V_71 = F_45 ( V_58 ) ;
struct V_15 * V_16 = F_10 ( V_2 ) ;
struct V_7 * V_8 ;
...
V_75 . V_80 = V_71 -> V_81 ;
V_75 . V_82 = V_71 -> V_83 ;
V_75 . V_84 = F_46 ( V_71 -> V_85 ) ;
F_47 ( V_58 , F_48 ( & V_75 ) ) ;
V_72 = F_49 ( & V_75 , V_16 -> V_25 , & V_73 ) ;
V_50 = F_50 ( V_2 , & V_75 , V_72 , false ) ;
if ( F_51 ( V_50 ) ) {
V_34 = F_52 ( V_50 ) ;
V_50 = NULL ;
goto V_86;
}
V_8 = F_53 ( V_2 , V_50 , V_58 ) ;
if ( V_8 != NULL ) {
struct V_17 * V_18 = V_17 ( V_8 ) ;
V_18 -> V_19 = F_7 ( V_8 ,
& V_71 -> V_78 ,
& V_71 -> V_77 ) ;
V_75 . V_11 = V_71 -> V_77 ;
V_34 = F_54 ( V_2 , V_8 , & V_75 , V_16 -> V_25 , V_16 -> V_87 ) ;
V_34 = F_55 ( V_34 ) ;
}
V_86:
F_56 ( V_50 ) ;
...
static void F_57 ( struct V_57 * V_58 )
{
F_58 ( & F_38 ( V_58 ) -> V_88 ) ;
F_59 ( F_45 ( V_58 ) -> V_89 ) ;
}
static void F_60 ( struct V_1 * V_2 , struct V_7 * V_90 )
{
const struct V_29 * V_91 ;
struct V_7 * V_8 ;
struct V_74 V_75 ;
struct V_36 * V_36 = F_16 ( F_61 ( V_90 ) -> V_37 ) ;
...
F_64 ( V_90 , F_48 ( & V_75 ) ) ;
V_50 = F_50 ( V_92 , & V_75 , NULL , false ) ;
if ( ! F_51 ( V_50 ) ) {
F_65 ( V_8 , V_50 ) ;
F_54 ( V_92 , V_8 , & V_75 , NULL , 0 ) ;
F_40 ( V_97 ) ;
F_40 ( V_98 ) ;
return;
}
...
struct V_1 * V_100 ;
struct V_57 * * V_59 ;
struct V_57 * V_58 = F_36 ( V_2 , & V_59 ,
V_18 -> V_23 ,
& V_99 -> V_10 ,
& V_99 -> V_11 ,
F_21 ( V_8 ) ) ;
if ( V_58 != NULL )
return F_67 ( V_2 , V_8 , V_58 , V_59 ) ;
V_100 = F_68 ( F_69 ( V_2 ) , & V_39 ,
& V_99 -> V_10 , V_18 -> V_23 ,
& V_99 -> V_11 , F_70 ( V_18 -> V_22 ) ,
F_21 ( V_8 ) ) ;
if ( V_100 != NULL ) {
if ( V_100 -> V_3 != V_40 ) {
F_24 ( V_100 ) ;
...
struct V_70 * V_71 ;
struct V_15 * V_16 = F_10 ( V_2 ) ;
const T_4 V_103 = F_72 ( V_8 ) -> V_104 ;
struct V_105 * V_106 = F_73 ( V_8 ) ;
if ( V_8 -> V_107 == F_46 ( V_108 ) )
return F_74 ( V_2 , V_8 ) ;
if ( ! F_62 ( V_8 ) )
return 0 ;
if ( F_75 ( V_2 , V_103 ) ) {
...
if ( F_76 ( V_2 ) )
goto V_111;
if ( F_77 ( V_2 ) && F_78 ( V_2 ) > 1 )
goto V_111;
V_58 = F_79 ( & V_113 ) ;
if ( V_58 == NULL )
goto V_111;
if ( F_80 ( V_58 , F_27 ( V_2 ) , V_8 ) )
goto V_114;
V_102 = F_38 ( V_58 ) ;
if ( F_81 ( V_2 , V_102 , V_8 ) )
goto V_114;
if ( F_82 ( V_2 , V_8 , V_58 ) )
goto V_114;
V_71 = F_45 ( V_58 ) ;
...
static struct V_1 * F_88 ( struct V_1 * V_2 ,
struct V_7 * V_8 ,
struct V_57 * V_58 ,
struct V_49 * V_50 )
{
...
F_91 ( V_131 -> V_137 , & V_134 -> V_20 ) ;
F_91 ( V_131 -> V_138 , & V_129 -> V_10 ) ;
...
V_134 = F_93 ( V_2 , V_58 , V_8 ) ;
if ( V_134 == NULL )
goto V_147;
F_94 ( V_134 , V_50 , NULL , NULL ) ;
...
V_129 -> V_142 = NULL ;
if ( V_71 -> V_89 != NULL ) {
V_129 -> V_142 = F_95 ( V_71 -> V_89 , V_154 ) ;
F_96 ( V_71 -> V_89 ) ;
V_71 -> V_89 = NULL ;
if ( V_129 -> V_142 )
F_97 ( V_129 -> V_142 , V_134 ) ;
}
V_129 -> V_25 = NULL ;
V_129 -> V_143 = F_21 ( V_8 ) ;
V_129 -> V_144 = F_14 ( V_8 ) -> V_145 ;
if ( V_16 -> V_25 != NULL )
V_129 -> V_25 = F_98 ( V_134 , V_16 -> V_25 ) ;
F_2 ( V_134 ) -> V_155 = 0 ;
if ( V_129 -> V_25 != NULL )
F_2 ( V_134 ) -> V_155 = ( V_129 -> V_25 -> V_156 +
V_129 -> V_25 -> V_157 ) ;
F_34 ( V_134 , F_33 ( V_50 ) ) ;
...
if ( V_2 -> V_3 == V_60 ) {
struct V_1 * V_100 = F_66 ( V_2 , V_8 ) ;
if ( V_100 == NULL )
goto V_163;
if ( V_100 != V_2 ) {
if ( F_105 ( V_2 , V_100 , V_8 ) )
goto V_165;
if ( V_162 != NULL )
F_104 ( V_162 ) ;
return 0 ;
...
V_18 = V_17 ( V_8 ) ;
F_73 ( V_8 ) -> V_125 = F_28 ( V_18 ) ;
F_73 ( V_8 ) -> V_168 = V_18 -> V_95 ;
if ( F_110 ( V_8 ) )
F_73 ( V_8 ) -> V_169 = V_170 ;
else
F_73 ( V_8 ) -> V_169 = F_111 ( V_8 ) ;
V_2 = F_112 ( & V_39 , V_8 ,
V_18 -> V_23 , V_18 -> V_22 ) ;
if ( V_2 == NULL ) {
F_113 ( L_2
...
if ( V_75 . V_79 & V_196 ) {
struct V_197 * V_79 ;
V_79 = F_118 ( V_2 , V_75 . V_79 ) ;
if ( V_79 == NULL )
return - V_189 ;
F_119 ( V_79 ) ;
}
}
if ( F_120 ( & V_181 -> V_198 ) )
V_181 -> V_198 . V_199 [ 15 ] = 1 ;
V_185 = F_85 ( & V_181 -> V_198 ) ;
if ( V_185 & V_200 )
return - V_201 ;
if ( V_185 & V_123 ) {
...
V_183 -> V_5 = & V_6 ;
V_2 -> V_140 = V_141 ;
V_34 = F_123 ( V_2 , (struct V_177 * ) & sin , sizeof( sin ) ) ;
if ( V_34 ) {
V_183 -> V_155 = V_205 ;
V_183 -> V_5 = & V_213 ;
V_2 -> V_140 = F_101 ;
...
F_91 ( V_184 -> V_138 , & V_16 -> V_10 ) ;
F_91 ( V_184 -> V_159 , & V_2 -> V_139 ) ;
return V_34 ;
}
if ( ! F_120 ( & V_2 -> V_139 ) )
V_10 = & V_2 -> V_139 ;
...
static int T_7 F_134 ( struct V_36 * V_36 )
{
if ( V_39 . V_221 == NULL )
return - V_222 ;
return F_135 ( & V_36 -> V_93 . V_94 , V_223 ,
V_224 , V_13 , V_36 ) ;
}
static void T_8 F_136 ( struct V_36 * V_36 )
{
F_137 ( V_36 -> V_93 . V_94 ) ;
}
static int T_9 F_138 ( void )
{
int V_34 = F_139 ( & V_225 , 1 ) ;
if ( V_34 != 0 )
goto V_42;
V_34 = F_140 ( & V_226 , V_13 ) ;
if ( V_34 != 0 )
goto V_227;
F_141 ( & V_228 ) ;
V_34 = F_142 ( & V_229 ) ;
