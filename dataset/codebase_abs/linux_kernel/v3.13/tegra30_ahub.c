...
V_1 = V_46 +
( V_15 * V_47 ) ;
V_3 -> V_48 -> V_49 ( V_3 -> V_4 , V_1 , & V_17 ) ;
return 0 ;
}
...
if ( V_3 )
return - V_112 ;
V_101 = F_32 ( V_113 , & V_99 -> V_7 ) ;
if ( ! V_101 )
return - V_114 ;
V_48 = V_101 -> V_115 ;
for ( V_104 = 0 ; V_104 < F_33 ( V_116 ) ; V_104 ++ ) {
if ( ! ( V_116 [ V_104 ] . V_117 &
V_48 -> V_117 ) )
continue;
V_103 = F_34 ( & V_99 -> V_7 , V_116 [ V_104 ] . V_118 ) ;
if ( F_35 ( V_103 ) ) {
F_11 ( & V_99 -> V_7 , L_3 ,
V_116 [ V_104 ] . V_118 ) ;
V_10 = F_36 ( V_103 ) ;
...
V_3 = F_39 ( & V_99 -> V_7 , sizeof( struct V_120 ) ,
V_121 ) ;
if ( ! V_3 ) {
F_11 ( & V_99 -> V_7 , L_4 ) ;
V_10 = - V_122 ;
...
V_3 -> V_48 = V_48 ;
V_3 -> V_7 = & V_99 -> V_7 ;
V_3 -> V_9 = F_34 ( & V_99 -> V_7 , L_5 ) ;
if ( F_35 ( V_3 -> V_9 ) ) {
F_11 ( & V_99 -> V_7 , L_6 ) ;
V_10 = F_36 ( V_3 -> V_9 ) ;
goto V_119;
}
V_3 -> V_8 = F_34 ( & V_99 -> V_7 , L_7 ) ;
if ( F_35 ( V_3 -> V_8 ) ) {
F_11 ( & V_99 -> V_7 , L_8 ) ;
V_10 = F_36 ( V_3 -> V_8 ) ;
goto V_123;
}
if ( F_41 ( V_99 -> V_7 . V_124 ,
L_9 ,
V_109 , 2 ) < 0 ) {
F_11 ( & V_99 -> V_7 ,
L_10 ) ;
...
V_3 -> V_25 = V_109 [ 1 ] ;
V_106 = F_42 ( V_99 , V_125 , 0 ) ;
if ( ! V_106 ) {
F_11 ( & V_99 -> V_7 , L_11 ) ;
V_10 = - V_112 ;
goto V_126;
}
V_108 = F_43 ( & V_99 -> V_7 , V_106 -> V_127 ,
F_44 ( V_106 ) , V_128 ) ;
if ( ! V_108 ) {
F_11 ( & V_99 -> V_7 , L_12 ) ;
V_10 = - V_20 ;
...
V_3 -> V_22 = V_106 -> V_127 ;
V_110 = F_45 ( & V_99 -> V_7 , V_106 -> V_127 ,
F_44 ( V_106 ) ) ;
if ( ! V_110 ) {
F_11 ( & V_99 -> V_7 , L_13 ) ;
V_10 = - V_122 ;
...
F_7 ( V_3 -> V_4 , true ) ;
V_107 = F_42 ( V_99 , V_125 , 1 ) ;
if ( ! V_107 ) {
F_11 ( & V_99 -> V_7 , L_15 ) ;
V_10 = - V_112 ;
goto V_126;
}
V_108 = F_43 ( & V_99 -> V_7 , V_107 -> V_127 ,
F_44 ( V_107 ) , V_128 ) ;
if ( ! V_108 ) {
F_11 ( & V_99 -> V_7 , L_16 ) ;
V_10 = - V_20 ;
...
V_111 = F_45 ( & V_99 -> V_7 , V_107 -> V_127 ,
F_44 ( V_107 ) ) ;
if ( ! V_111 ) {
F_11 ( & V_99 -> V_7 , L_17 ) ;
V_10 = - V_122 ;
...
F_49 ( V_99 -> V_7 . V_124 , NULL , NULL , & V_99 -> V_7 ) ;
return 0 ;
V_131:
F_50 ( & V_99 -> V_7 ) ;
V_126:
...
void F_59 ( struct V_132 * V_132 , unsigned int V_1 ,
struct V_16 * V_133 )
{
unsigned int V_134 ;
V_134 = ( V_133 -> V_33 <<
