...
int V_131 ;
F_11 ( V_21 ) ;
V_131 = F_77 ( V_99 , V_21 -> V_25 , V_163 ) ;
F_13 ( V_21 ) ;
return V_131 ;
}
static int F_78 ( struct V_99 * V_99 , struct V_164 * V_165 )
{
struct V_20 * V_21 = V_99 -> V_160 ;
return F_79 ( V_99 , V_21 -> V_25 , V_165 ) ;
}
...
F_82 ( V_170 ) ;
F_83 ( V_172 , V_170 ) ;
V_23 -> V_44 = F_84 ( V_170 , NULL , V_23 ) ;
if ( ! V_23 -> V_44 )
goto V_173;
if ( ! F_85 ( V_172 , V_23 -> V_44 -> V_48 -> V_174 ) ) {
F_24 ( & V_23 -> V_60 , L_24 ) ;
goto V_175;
}
V_131 = F_86 ( & V_167 -> V_24 , & V_23 -> V_60 ) ;
if ( V_131 )
goto V_175;
F_16 ( & V_23 -> V_26 , 0 ) ;
F_87 ( & V_23 -> V_29 ) ;
...
V_169 -> V_60 = & V_23 -> V_60 ;
V_131 = F_89 ( V_169 , V_179 , 0 ) ;
if ( V_131 ) {
F_24 ( & V_23 -> V_60 , L_26 ) ;
goto V_180;
}
F_90 ( V_169 , V_23 ) ;
snprintf ( V_169 -> V_118 , sizeof( V_169 -> V_118 ) , L_27 , V_177 . V_118 ) ;
V_23 -> V_169 = V_169 ;
F_91 ( & V_23 -> V_60 , V_181
L_28 , V_169 -> V_115 ) ;
F_92 ( V_167 , V_23 ) ;
V_23 -> V_142 = F_93 ( & V_167 -> V_24 ) ;
if ( F_71 ( V_23 -> V_142 ) ) {
F_24 ( & V_23 -> V_60 , L_29 ) ;
...
{
struct V_22 * V_23 = F_102 ( V_167 ) ;
F_91 ( & V_23 -> V_60 , L_31 V_181 ) ;
F_95 ( V_23 -> V_28 ) ;
F_96 ( V_23 -> V_169 ) ;
F_99 ( & V_23 -> V_60 ) ;
F_97 ( V_23 -> V_142 ) ;
