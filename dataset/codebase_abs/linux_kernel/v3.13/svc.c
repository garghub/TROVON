...
{
int error ;
error = F_83 ( V_43 , V_111 , V_112 , NULL , L_16 ) ;
if ( error == - V_129 )
...
F_91 ( & V_151 -> V_152 -> V_153 , V_149 ) ;
F_92 () ;
F_93 ( & V_151 -> V_152 -> V_153 , V_149 ) ;
}
int
...
struct V_39 * V_40 = V_86 -> V_98 ;
T_2 V_160 ;
V_86 -> V_161 = & V_86 -> V_162 [ 1 ] ;
V_158 -> V_163 = F_95 ( V_86 -> V_162 [ 0 ] ) ;
V_158 -> V_164 = 0 ;
V_86 -> V_159 . V_88 = V_86 -> V_162 + 1 ;
V_86 -> V_159 . V_165 = 0 ;
V_86 -> V_159 . V_166 = 0 ;
V_86 -> V_159 . V_167 = 0 ;
V_86 -> V_159 . V_168 = V_64 ;
V_86 -> V_159 . V_169 [ 0 ] . V_163 = NULL ;
V_86 -> V_159 . V_169 [ 0 ] . V_164 = 0 ;
V_86 -> V_170 = F_96 ( V_155 ) ;
V_160 = F_97 ( V_155 ) ;
if ( V_160 != 0 ) {
F_98 ( V_86 , L_19 , V_160 ) ;
V_40 -> V_59 -> V_171 ++ ;
F_99 ( V_86 ) ;
return 0 ;
}
if ( F_100 ( V_86 , V_155 , V_158 ) )
return F_101 ( V_86 ) ;
else {
F_99 ( V_86 ) ;
return 0 ;
...
int
F_102 ( struct V_39 * V_40 , struct V_172 * V_173 ,
struct V_85 * V_86 )
{
struct V_154 * V_155 = & V_86 -> V_156 . V_157 [ 0 ] ;
struct V_154 * V_158 = & V_86 -> V_159 . V_157 [ 0 ] ;
