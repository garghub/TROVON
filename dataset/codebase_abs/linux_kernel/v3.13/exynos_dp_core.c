...
static struct V_112 * F_97 ( struct V_113 * V_5 )
{
struct V_114 * V_115 = V_5 -> V_116 ;
struct V_112 * V_117 ;
V_117 = F_98 ( V_5 ,
sizeof( * V_117 ) , V_118 ) ;
if ( ! V_117 ) {
...
{
struct V_114 * V_127 = F_103 ( V_2 -> V_5 -> V_116 ) ;
T_2 V_128 ;
int V_111 = 0 ;
V_127 = F_104 ( V_127 , L_46 ) ;
if ( ! V_127 ) {
V_2 -> V_129 = F_105 ( V_2 -> V_5 , L_47 ) ;
if ( F_106 ( V_2 -> V_129 ) )
return F_107 ( V_2 -> V_129 ) ;
else
return 0 ;
}
if ( F_101 ( V_127 , L_48 , & V_128 ) ) {
F_13 ( V_2 -> V_5 , L_49 ) ;
V_111 = - V_59 ;
goto V_130;
}
...
T_2 V_65 ;
V_65 = F_112 ( V_2 -> V_132 ) ;
V_65 |= V_2 -> V_131 ;
F_113 ( V_65 , V_2 -> V_132 ) ;
}
}
...
struct V_1 * V_2 ;
int V_111 = 0 ;
V_2 = F_98 ( & V_135 -> V_5 , sizeof( struct V_1 ) ,
V_118 ) ;
if ( ! V_2 ) {
F_13 ( & V_135 -> V_5 , L_53 ) ;
return - V_119 ;
...
V_2 -> V_5 = & V_135 -> V_5 ;
V_2 -> V_112 = F_97 ( & V_135 -> V_5 ) ;
if ( F_106 ( V_2 -> V_112 ) )
return F_107 ( V_2 -> V_112 ) ;
V_111 = F_102 ( V_2 ) ;
if ( V_111 )
return V_111 ;
V_2 -> clock = F_117 ( & V_135 -> V_5 , L_47 ) ;
if ( F_106 ( V_2 -> clock ) ) {
F_13 ( & V_135 -> V_5 , L_54 ) ;
return F_107 ( V_2 -> clock ) ;
}
F_118 ( V_2 -> clock ) ;
V_137 = F_119 ( V_135 , V_138 , 0 ) ;
V_2 -> V_139 = F_120 ( & V_135 -> V_5 , V_137 ) ;
if ( F_106 ( V_2 -> V_139 ) )
return F_107 ( V_2 -> V_139 ) ;
V_2 -> V_100 = F_121 ( V_135 , 0 ) ;
if ( V_2 -> V_100 == - V_140 ) {
F_13 ( & V_135 -> V_5 , L_55 ) ;
return - V_141 ;
}
F_122 ( & V_2 -> V_105 , F_94 ) ;
F_110 ( V_2 ) ;
F_1 ( V_2 ) ;
V_111 = F_123 ( & V_135 -> V_5 , V_2 -> V_100 , F_90 , 0 ,
L_56 , V_2 ) ;
if ( V_111 ) {
F_13 ( & V_135 -> V_5 , L_57 ) ;
return V_111 ;
...
static int F_125 ( struct V_134 * V_135 )
{
struct V_1 * V_2 = F_126 ( V_135 ) ;
F_127 ( & V_2 -> V_105 ) ;
F_114 ( V_2 ) ;
F_128 ( V_2 -> clock ) ;
return 0 ;
}
static int F_129 ( struct V_113 * V_5 )
{
struct V_1 * V_2 = F_130 ( V_5 ) ;
F_131 ( V_2 -> V_100 ) ;
F_127 ( & V_2 -> V_105 ) ;
F_114 ( V_2 ) ;
F_128 ( V_2 -> clock ) ;
...
static int F_132 ( struct V_113 * V_5 )
{
struct V_1 * V_2 = F_130 ( V_5 ) ;
F_110 ( V_2 ) ;
F_118 ( V_2 -> clock ) ;
