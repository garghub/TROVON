...
F_2 ( V_6 , L_13 ) ;
F_49 ( & V_160 ) ;
if ( ! V_155 -> V_8 . V_9 && ! V_155 -> V_7 ) {
V_155 -> V_7 = true ;
F_50 ( & V_160 ) ;
if ( V_74 -> V_95 -> V_161 )
V_74 -> V_95 -> V_161 ( V_80 , V_90 , & V_155 -> V_112 ) ;
} else
F_50 ( & V_160 ) ;
if ( V_155 -> V_8 . V_162 ) {
F_2 ( V_6 , L_14 ) ;
...
int V_165 ;
char * V_166 ;
char * V_119 = V_155 -> V_8 . V_162 +
V_74 -> V_95 -> V_167 (
V_155 -> V_8 . V_162 ) ;
V_166 = V_155 -> V_8 . V_168 ;
V_153 = V_155 -> V_8 . V_158
- V_155 -> V_8 . V_159 ;
V_152 = V_154 - V_153 ;
F_2 ( V_6 , L_17 , V_152 ) ;
for ( V_165 = 0 ; ( V_165 < ( V_152 ) ) && ( V_166 != NULL ) ; V_165 ++ ) {
V_166 = F_35 ( V_166 , V_119 ,
V_155 -> V_8 . V_101 ) ;
}
if ( ( V_166 == NULL ) && ( V_165 < V_152 ) ) {
F_2 ( V_126 , L_18 ,
V_152 , V_154 , V_82 ) ;
}
V_82 = 0 ;
...
static int F_53 ( char * V_169 , struct V_1 * V_1 ,
struct V_170 * V_171 ,
char * V_172 , unsigned int V_173 )
{
...
int V_82 = 0 ;
T_11 V_134 ;
V_82 = F_43 ( & V_128 , V_169 , V_146 -> V_8 . V_101 ,
V_146 -> V_8 . V_147 ) ;
if ( V_82 )
return V_82 ;
if ( V_128 . V_131 > V_173 ) {
F_2 ( V_126 , L_21 ,
V_128 . V_131 ) ;
return - V_140 ;
}
...
return 0 ;
if ( V_146 -> V_8 . V_147 ) {
struct V_174 * V_175 = V_24 -> V_176 ;
V_14 . V_14 = V_172 ;
V_14 . V_115 =
F_54 ( ( char * ) V_14 . V_14 , ( T_4 * ) V_128 . V_14 ,
V_177 ,
F_55 ( V_178 , V_128 . V_131 ,
( V_178 ) V_173 ) , V_175 ,
V_24 -> V_27 &
V_179 ) ;
V_14 . V_115 -= F_56 ( V_175 ) ;
} else {
...
V_16 . V_29 = F_58 ( V_20 , V_180 ) ;
F_59 ( V_24 ) ;
}
if ( ( V_24 -> V_27 & V_181 ) &&
F_60 ( & V_16 ) )
V_16 . V_32 |= V_33 ;
F_3 ( V_1 -> V_182 , & V_14 , & V_16 ) ;
V_134 = F_61 ( V_16 . V_29 ) ;
return ! F_62 ( V_171 , V_14 . V_14 , V_14 . V_115 , V_134 , V_16 . V_43 ) ;
}
int F_63 ( struct V_1 * V_1 , struct V_170 * V_171 )
{
int V_82 = 0 ;
unsigned int V_80 ;
int V_165 ;
...
V_90 = F_29 ( V_84 -> V_88 ) ;
V_82 = F_48 ( V_80 , V_90 , V_171 -> V_150 , V_1 , & V_145 ,
& V_183 ) ;
if ( V_82 ) {
F_2 ( V_6 , L_24 , V_82 ) ;
goto V_185;
} else if ( V_145 != NULL ) {
F_2 ( V_6 , L_25 , V_171 -> V_150 ) ;
} else {
F_2 ( V_6 , L_26 ) ;
goto V_185;
}
F_2 ( V_6 , L_27 ,
V_183 , V_84 -> V_8 . V_162 ) ;
V_173 = V_90 -> V_73 -> V_74 -> V_95 -> V_167 (
V_84 -> V_8 . V_162 ) ;
V_119 = V_84 -> V_8 . V_162 + V_173 ;
V_184 = F_66 ( V_177 , V_92 ) ;
if ( V_184 == NULL ) {
V_82 = - V_93 ;
goto V_185;
}
