...
struct V_135 * F_43 ( struct V_22 * V_23 )
{
struct V_1 * V_2 = V_23 -> V_25 ;
return & V_2 -> V_134 ;
}
struct V_22 * F_44 ( const struct V_145 * V_9 ,
struct V_135 * V_17 )
{
struct V_1 * V_2 = F_45 ( sizeof( struct V_1 ) , V_146 ) ;
T_1 V_35 ;
if ( V_2 == NULL )
goto error;
V_2 -> V_9 = V_9 ;
...
memcpy ( & V_2 -> V_148 . V_106 , & V_149 , sizeof( struct V_150 ) ) ;
V_2 -> V_148 . V_25 = V_2 ;
F_46 ( V_2 -> V_134 . V_151 , L_14 ,
sizeof( V_2 -> V_134 . V_151 ) ) ;
V_2 -> V_134 . V_152 = & V_153 ;
V_2 -> V_134 . V_154 = NULL ;
F_47 ( & V_2 -> V_134 , V_2 ) ;
if ( F_48 ( & V_2 -> V_134 ) < 0 ) {
F_17 ( V_60 L_15 ) ;
goto error;
