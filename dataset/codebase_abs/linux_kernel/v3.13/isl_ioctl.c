...
if ( memcmp ( V_332 -> V_41 , V_41 -> V_190 , V_79 ) == 0 ) {
F_87 ( & V_332 -> V_333 ) ;
V_122 -> V_39 -- ;
F_9 ( V_332 ) ;
F_10 ( & V_122 -> V_327 ) ;
...
static int
F_95 ( struct V_91 * V_92 , struct V_96 * V_97 ,
struct V_138 * V_139 , char * V_99 )
{
T_1 * V_1 = F_12 ( V_92 ) ;
struct V_326 * V_122 = & V_1 -> V_122 ;
...
static int
F_98 ( struct V_326 * V_122 , char * V_337 )
{
struct V_331 * V_332 ;
int V_338 = 0 ;
if ( F_91 ( & V_122 -> V_327 ) )
...
V_283 . V_63 . V_144 = 0 ;
F_101 ( V_1 , V_345 , V_343 , V_34 , & V_283 . V_63 . V_144 ,
error ) ;
F_103 ( V_1 -> V_92 , V_171 , & V_283 , V_345 ) ;
F_9 ( V_345 ) ;
}
static void
...
static void
F_105 ( struct V_91 * V_92 , T_2 V_184 )
{
T_1 * V_1 = F_12 ( V_92 ) ;
if ( V_184 ) {
F_106 ( V_92 ) ;
...
NULL ) ;
F_103 ( V_92 , V_169 , & V_117 , NULL ) ;
} else
F_104 ( F_12 ( V_92 ) ,
L_17 ) ;
} else {
F_107 ( V_92 ) ;
F_104 ( F_12 ( V_92 ) , L_18 ) ;
}
}
static void
F_108 ( T_1 * V_1 , T_4 * V_188 ,
T_4 * V_197 , T_5 V_199 )
{
struct V_329 * V_77 ;
...
static void
F_115 ( T_1 * V_1 , T_2 V_325 , T_4 * V_41 ,
T_4 * V_356 , T_5 V_281 )
{
struct V_357 * V_358 ;
T_4 * V_359 , * V_360 ;
...
static void
F_116 ( T_1 * V_1 , struct V_340 * V_34 , enum V_320 V_325 )
{
if ( ( ( V_34 -> V_363 == V_364 ) ||
( V_34 -> V_363 == V_365 ) )
&& F_117 ( V_1 ) ) {
V_34 -> V_87 = F_98 ( & V_1 -> V_122 ,
V_34 -> V_78 ) ? 0 : 1 ;
F_17 ( V_1 , V_325 , 0 , V_34 ) ;
}
}
static int
F_118 ( T_1 * V_1 , enum V_320 V_325 ,
char * V_63 )
{
...
F_115 ( V_1 , V_325 , V_367 -> V_78 ,
V_356 , V_281 ) ;
F_119 ( V_322 [ V_325 ] . V_204 & V_323 , ( void * ) V_34 ) ;
switch ( V_325 ) {
case V_239 :
F_105 ( V_1 -> V_92 , ( T_2 ) * V_63 ) ;
break;
case V_371 :
F_104 ( V_1 , L_23 ) ;
break;
...
enum V_320 V_321 = F_121 ( V_382 -> V_384 -> V_325 ) ;
if ( V_321 != V_385 )
F_118 ( F_12 ( V_92 ) , V_321 , V_382 -> V_63 ) ;
F_122 ( V_382 ) ;
}
int
F_123 ( struct V_91 * V_92 , void * V_41 )
{
T_1 * V_1 = F_12 ( V_92 ) ;
int V_235 ;
if ( V_92 -> V_386 != 6 )
...
static int
F_124 ( struct V_91 * V_92 , struct V_96 * V_97 ,
T_3 * V_117 , char * V_99 )
{
T_1 * V_1 = F_12 ( V_92 ) ;
...
F_134 ( V_1 , & V_325 , 1 ) ;
F_25 ( & V_1 -> V_120 ) ;
return F_135 ( V_92 , V_97 , V_117 , V_99 ) ;
}
