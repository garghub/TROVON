...
V_29 = F_9 ( V_27 ) ;
if ( F_10 ( V_27 ) )
V_29 -> V_33 . V_34 ( F_10 ( V_27 ) ) ;
F_11 ( V_27 ) ;
F_12 ( & V_31 -> V_35 , V_2 -> V_8 . V_36 ) ;
F_13 ( V_2 -> V_12 ) ;
}
...
V_2 -> V_13 = V_29 -> V_33 . V_58 ( V_2 -> V_13 ) ;
F_23 ( V_27 , V_59 , V_5 -> V_20 , V_5 -> V_19 , V_60 ,
V_61 | V_62 | V_63 , 0 ) ;
V_29 -> V_33 . V_64 ( V_29 , V_2 -> V_13 , V_27 ) ;
V_29 -> V_33 . V_65 ( V_2 -> V_13 ) ;
return 0 ;
}
...
V_7 = F_10 ( V_27 ) ;
if ( V_7 ) {
V_29 -> V_33 . V_64 ( V_29 , V_7 , V_27 ) ;
V_29 -> V_33 . V_65 ( V_7 ) ;
} else {
V_29 -> V_33 . V_100 ( V_29 , V_27 ) ;
}
}
...
int V_103 ;
T_3 V_104 ;
V_38 = F_20 ( V_2 -> V_32 , sizeof( * V_38 ) ) ;
switch ( V_38 -> V_105 ) {
case V_106 :
V_104 = V_107 ;
break;
...
V_103 = F_40 ( & V_2 -> V_8 , V_2 -> V_12 -> V_31 ,
...
int V_134 ;
V_134 = F_44 ( & V_31 -> V_35 , V_135 ) ;
if ( V_134 < 0 )
goto V_136;
V_2 = & ( (struct V_1 * ) V_31 -> V_137 ) [ V_134 ] ;
memset ( V_2 , 0 , sizeof( struct V_1 ) ) ;
V_2 -> V_8 . V_36 = V_134 ;
V_2 -> V_12 = V_12 ;
V_2 -> V_13 = V_29 -> V_33 . V_138 ( V_29 , V_27 ) ;
if ( ! V_2 -> V_13 ) {
F_12 ( & V_31 -> V_35 , V_134 ) ;
goto V_136;
}
V_2 -> V_32 = V_27 ;
F_45 ( & V_2 -> V_139 , V_140 ) ;
F_46 ( V_12 -> V_101 -> V_141 -> V_142 , & V_2 -> V_139 ) ;
return;
V_136:
F_2 ( L_11 ) ;
...
struct V_69 * V_70 = F_26 ( V_2 -> V_32 ) ;
struct V_102 * V_38 ;
int V_147 = 0 ;
int V_148 ;
V_38 = F_20 ( V_2 -> V_32 , sizeof( * V_38 ) ) ;
...
F_5 ( V_2 -> V_13 ) -> V_42 -> V_33 . V_167 ( V_2 -> V_13 , F_30 , V_2 ) ;
if ( F_48 ( & V_2 -> V_8 , V_2 -> V_12 -> V_31 , V_38 -> V_168 ,
& V_2 -> V_117 [ 0 ] , F_41 ( & V_38 -> V_118 ) ,
F_49 ( V_38 -> V_169 ) , V_148 , V_147 , 0 ) )
goto V_149;
F_2 ( L_12 , V_70 -> V_79 ) ;
return;
V_149:
