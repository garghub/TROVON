...
F_48 ( V_24 ) ;
V_109:
if ( V_8 >= 0 && F_76 ( V_102 , V_7 , V_113 ) )
V_8 = - V_15 ;
V_16:
F_9 ( V_7 ) ;
return V_8 ;
}
static long V_6 ( struct V_19 * V_19 , T_5 V_101 , T_6 V_114 )
{
int V_8 ;
V_8 = F_71 ( V_101 , (struct V_6 T_2 * ) V_114 ) ;
return ( long ) V_8 ;
}
static long F_77 ( struct V_19 * V_19 , T_5 V_101 , T_6 V_114 )
{
return ( long ) V_6 ( V_19 , V_101 , ( T_6 ) F_78 ( V_114 ) ) ;
}
int F_79 ( void )
{
int V_115 ;
