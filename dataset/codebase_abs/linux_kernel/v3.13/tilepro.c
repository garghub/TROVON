...
static int F_132 ( struct V_35 * V_36 , struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
int V_8 = F_2 () ;
struct V_15 * V_16 = V_59 -> V_82 [ V_8 ] ;
...
static void F_134 ( struct V_56 * V_39 )
{
F_74 ( L_37 ) ;
F_74 ( L_38 , V_67 ,
V_67 - V_39 -> V_234 ) ;
...
static int F_136 ( struct V_56 * V_39 , struct V_245 * V_246 , int V_206 )
{
return - V_247 ;
}
static struct V_248 * F_137 ( struct V_56 * V_39 ,
struct V_248 * V_85 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
...
static int F_140 ( struct V_56 * V_39 , int V_257 )
{
F_74 ( L_39 ) ;
...
static int F_141 ( struct V_56 * V_39 , void * V_260 )
{
struct V_261 * V_262 = V_260 ;
if ( ! F_142 ( V_262 -> V_263 ) )
return - V_264 ;
...
V_59 -> V_119 = F_144 ( ( V_120 ) V_266 , 0 ) ;
F_74 ( L_42 ,
...
static struct V_56 * F_149 ( const char * V_138 )
{
int V_116 ;
struct V_56 * V_39 ;
struct V_58 * V_59 ;
V_39 = F_150 ( sizeof( * V_59 ) , V_138 , F_147 ) ;
if ( ! V_39 ) {
F_64 ( L_47 , V_138 ) ;
return NULL ;
}
...
V_59 -> V_39 = V_39 ;
F_151 ( & V_59 -> V_166 , F_100 ) ;
F_152 ( & V_59 -> V_63 ) ;
V_59 -> V_124 = F_153 ( V_286 | V_287 , V_125 ) ;
if ( ! V_59 -> V_124 ) {
F_154 ( V_39 ) ;
return NULL ;
}
V_59 -> V_49 = F_155 ( V_59 -> V_124 ) ;
V_116 = F_156 ( V_39 ) ;
if ( V_116 ) {
F_64 ( L_48 , V_39 -> V_138 , V_116 ) ;
F_157 ( V_59 -> V_124 , V_125 ) ;
F_154 ( V_39 ) ;
return NULL ;
}
V_116 = F_143 ( V_39 ) ;
...
static int T_20 F_161 ( char * V_290 )
{
int V_291 = F_162 ( V_290 , & V_133 ) ;
if ( V_291 != 0 ) {
F_71 ( L_50 ,
V_290 ) ;
} else {
