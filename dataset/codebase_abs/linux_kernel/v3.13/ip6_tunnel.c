...
F_5 (i) {
unsigned int V_13 ;
const struct V_9 * V_14 = F_6 ( V_8 -> V_14 , V_12 ) ;
do {
V_13 = F_7 ( & V_14 -> V_15 ) ;
V_10 . V_16 = V_14 -> V_16 ;
V_10 . V_17 = V_14 -> V_17 ;
...
static T_8
F_130 ( struct V_65 * V_66 , struct V_7 * V_8 )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
struct V_6 * V_20 = & V_23 -> V_8 -> V_20 ;
int V_150 ;
...
V_170 -> V_206 = V_47 -> V_147 ;
V_170 -> V_185 = 0 ;
if ( ! ( V_47 -> V_43 & V_193 ) )
V_170 -> V_185 |= V_195 & V_47 -> V_207 ;
if ( ! ( V_47 -> V_43 & V_198 ) )
V_170 -> V_185 |= V_199 & V_47 -> V_207 ;
...
static int
F_132 ( struct V_22 * V_23 , const struct V_46 * V_47 )
{
...
static int F_133 ( struct V_22 * V_23 , struct V_46 * V_47 )
{
struct V_34 * V_34 = V_23 -> V_34 ;
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
int V_54 ;
F_23 ( V_38 , V_23 ) ;
F_134 () ;
V_54 = F_132 ( V_23 , V_47 ) ;
F_20 ( V_38 , V_23 ) ;
F_135 ( V_23 -> V_8 ) ;
return V_54 ;
}
static void
F_136 ( struct V_46 * V_47 , const struct V_212 * V_191 )
{
...
case V_217 :
if ( V_8 == V_38 -> V_64 ) {
if ( F_139 ( & V_47 , V_214 -> V_218 . V_219 , sizeof ( V_47 ) ) ) {
V_54 = - V_220 ;
break;
}
F_136 ( & V_216 , & V_47 ) ;
...
if ( V_23 == NULL )
V_23 = F_28 ( V_8 ) ;
F_137 ( & V_47 , & V_23 -> V_40 ) ;
if ( F_140 ( V_214 -> V_218 . V_219 , & V_47 , sizeof ( V_47 ) ) ) {
V_54 = - V_220 ;
}
break;
case V_221 :
...
static int
F_143 ( struct V_7 * V_8 , int V_230 )
{
...
V_23 -> V_8 = V_8 ;
V_23 -> V_34 = F_29 ( V_8 ) ;
V_8 -> V_14 = F_146 ( struct V_9 ) ;
if ( ! V_8 -> V_14 )
return - V_245 ;
F_5 (i) {
struct V_9 * V_246 ;
V_246 = F_6 ( V_8 -> V_14 , V_12 ) ;
F_147 ( & V_246 -> V_15 ) ;
}
return 0 ;
}
...
static int F_149 ( struct V_247 * V_248 [] , struct V_247 * V_76 [] )
{
T_5 V_104 ;
if ( ! V_76 )
return 0 ;
V_104 = F_150 ( V_76 [ V_249 ] ) ;
if ( V_104 != V_135 &&
V_104 != V_121 &&
V_104 != 0 )
return - V_226 ;
...
static void F_151 ( struct V_247 * V_76 [] ,
struct V_46 * V_40 )
{
...
return;
if ( V_76 [ V_250 ] )
V_40 -> V_147 = F_152 ( V_76 [ V_250 ] ) ;
if ( V_76 [ V_251 ] )
F_153 ( & V_40 -> V_41 , V_76 [ V_251 ] ,
sizeof( struct V_1 ) ) ;
if ( V_76 [ V_252 ] )
F_153 ( & V_40 -> V_42 , V_76 [ V_252 ] ,
sizeof( struct V_1 ) ) ;
if ( V_76 [ V_253 ] )
V_40 -> V_186 = F_150 ( V_76 [ V_253 ] ) ;
if ( V_76 [ V_254 ] )
V_40 -> V_111 = F_150 ( V_76 [ V_254 ] ) ;
if ( V_76 [ V_255 ] )
V_40 -> V_207 = F_154 ( V_76 [ V_255 ] ) ;
if ( V_76 [ V_256 ] )
V_40 -> V_43 = F_152 ( V_76 [ V_256 ] ) ;
if ( V_76 [ V_249 ] )
V_40 -> V_104 = F_150 ( V_76 [ V_249 ] ) ;
}
static int F_155 ( struct V_34 * V_257 , struct V_7 * V_8 ,
struct V_247 * V_248 [] , struct V_247 * V_76 [] )
{
struct V_34 * V_34 = F_29 ( V_8 ) ;
struct V_22 * V_258 ;
V_258 = F_28 ( V_8 ) ;
F_151 ( V_76 , & V_258 -> V_40 ) ;
if ( F_37 ( V_34 , & V_258 -> V_40 , 0 ) )
return - V_227 ;
return F_27 ( V_8 ) ;
}
static int F_156 ( struct V_7 * V_8 , struct V_247 * V_248 [] ,
struct V_247 * V_76 [] )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
struct V_46 V_47 ;
...
V_23 = F_28 ( V_8 ) ;
return F_133 ( V_23 , & V_47 ) ;
}
static void F_157 ( struct V_7 * V_8 , struct V_259 * V_260 )
{
struct V_34 * V_34 = F_29 ( V_8 ) ;
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
if ( V_8 != V_38 -> V_64 )
...
if ( F_162 ( V_66 , V_250 , V_262 -> V_147 ) ||
F_163 ( V_66 , V_251 , sizeof( struct V_1 ) ,
& V_262 -> V_41 ) ||
F_163 ( V_66 , V_252 , sizeof( struct V_1 ) ,
& V_262 -> V_42 ) ||
F_164 ( V_66 , V_253 , V_262 -> V_186 ) ||
F_164 ( V_66 , V_254 , V_262 -> V_111 ) ||
F_165 ( V_66 , V_255 , V_262 -> V_207 ) ||
F_162 ( V_66 , V_256 , V_262 -> V_43 ) ||
F_164 ( V_66 , V_249 , V_262 -> V_104 ) )
goto V_263;
return 0 ;
V_263:
return - V_179 ;
...
if ( V_54 < 0 )
goto V_273;
V_54 = F_177 ( & V_274 , V_275 ) ;
if ( V_54 < 0 ) {
F_178 ( L_11 , V_276 ) ;
goto V_277;
}
V_54 = F_177 ( & V_278 , V_279 ) ;
if ( V_54 < 0 ) {
F_178 ( L_12 , V_276 ) ;
goto V_280;
}
...
{
F_183 ( & V_58 ) ;
if ( F_180 ( & V_274 , V_275 ) )
F_184 ( L_13 , V_276 ) ;
if ( F_180 ( & V_278 , V_279 ) )
F_184 ( L_14 , V_276 ) ;
F_181 ( & V_272 ) ;
}
