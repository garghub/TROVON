...
V_22 = F_33 ( V_4 , V_21 , V_11 ) ;
if ( F_8 ( V_17 ) )
memcpy ( V_22 , V_17 , V_11 ) ;
return 0 ;
}
inline int F_34 ( struct V_2 * V_3 , T_2 V_17 )
{
return F_28 ( V_3 , & V_17 , 1 ) ;
}
int F_20 ( struct V_2 * V_3 , const void * V_25 , T_1 V_11 )
{
struct V_7 * V_4 = F_3 ( V_3 ) ;
struct V_7 * V_21 ;
T_2 * V_22 ;
...
if ( F_11 ( F_2 ( V_3 ) ) )
return - V_19 ;
if ( F_11 ( F_35 ( V_4 ) < V_11 ) ) {
F_21 ( V_3 , L_4 ) ;
return - V_19 ;
}
V_26 = F_32 ( V_4 , 0 , & V_21 ) ;
if ( F_11 ( V_26 < 0 ) ) {
F_21 ( V_3 , L_3 ) ;
return V_26 ;
}
...
inline int F_37 ( struct V_2 * V_3 , const void * V_17 , T_1 V_11 )
{
return F_28 ( V_3 , V_17 , V_11 ) ;
}
inline T_1 F_38 ( struct V_2 * V_3 )
{
struct V_7 * V_4 = F_3 ( V_3 ) ;
return V_4 -> V_11 ;
}
inline T_1 F_39 ( struct V_2 * V_3 ,
T_1 (* F_40)( T_1 , void * , T_1 ) ,
T_1 V_17 )
{
if ( F_11 ( F_2 ( V_3 ) ) )
return - V_19 ;
...
return F_40 ( V_17 , V_3 -> V_4 . V_17 , F_38 ( V_3 ) ) ;
}
int F_41 ( struct V_2 * V_3 , T_1 V_11 )
{
struct V_7 * V_4 = F_3 ( V_3 ) ;
if ( F_11 ( F_2 ( V_3 ) ) )
return - V_19 ;
...
struct V_2 * F_43 ( struct V_2 * V_28 ,
struct V_2 * V_29 ,
T_1 V_30 )
{
...
struct V_2 * F_45 ( struct V_2 * V_3 , T_1 V_40 )
{
struct V_7 * V_41 ;
struct V_7 * V_4 = F_3 ( V_3 ) ;
struct V_2 * V_39 ;
...
struct V_45 * F_47 ( struct V_2 * V_3 )
{
return (struct V_45 * ) & F_3 ( V_3 ) -> V_5 ;
}
void F_48 ( struct V_2 * V_3 , int V_46 )
{
F_3 ( V_3 ) -> V_44 = V_46 ;
}
