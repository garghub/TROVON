...
if ( V_23 & V_86 )
F_45 ( V_71 , 0 , 0 , V_71 -> V_35 ) ;
if ( V_23 & V_87 )
F_46 ( V_71 , 0 , 0 , V_71 -> V_35 ) ;
}
static T_4 F_47 ( int V_36 , void * V_37 )
{
...
struct V_42 V_43 ;
int V_44 ;
if ( ! F_21 ( & V_41 -> V_2 , F_48 , V_45 ) )
return - V_46 ;
V_71 = F_49 ( sizeof( * V_9 ) ,
L_28 , 1 , L_29 , 1 , 2 , NULL , 0 ,
V_88 ) ;
if ( ! V_71 ) {
F_36 ( & V_41 -> V_2 , F_48 ) ;
return - V_46 ;
...
F_16 (KERN_INFO EDAC_MOD_STR L_36 ,
pdata->irq) ;
V_71 -> V_91 = V_92 ;
...
{
struct V_70 * V_71 = F_54 ( & V_41 -> V_2 ) ;
struct V_72 * V_9 = V_71 -> V_10 ;
F_29 ( 0 , L_38 ) ;
if ( V_47 == V_49 ) {
F_7 ( V_9 -> V_73 + V_93 , 0 ) ;
...
static T_5 F_55 ( T_3 V_95 , T_3 V_96 )
{
T_3 V_97 ;
T_3 V_98 ;
int V_99 ;
...
static T_5 F_56 ( unsigned int V_104 ) {
int V_101 ;
T_5 V_105 = 0 ;
...
static void F_57 ( T_3 V_106 , T_3 V_107 , T_3 V_108 ,
int * V_109 , int * V_110 )
{
int V_101 ;
T_5 V_105 ;
...
L_43 ,
V_106 , V_107 , V_105 ) ;
F_59 ( V_7 , V_28 , L_44 , V_114 ) ;
F_59 ( V_7 , V_28 , L_45 , V_115 ) ;
if ( V_116 == V_7 -> V_125 )
F_59 ( V_7 , V_28 , L_46 ) ;
if ( V_23 & V_118 )
F_60 ( V_131 , V_7 , 1 ,
...
static T_4 F_61 ( int V_36 , void * V_37 )
{
struct V_6 * V_7 = V_37 ;
struct V_8 * V_9 = V_7 -> V_10 ;
T_3 V_23 ;
...
V_167 [ 1 ] . V_169 = 1 ;
V_167 [ 1 ] . V_170 = false ;
V_7 = F_64 ( V_172 , F_65 ( V_167 ) , V_167 ,
sizeof( * V_9 ) ) ;
if ( ! V_7 ) {
F_36 ( & V_41 -> V_2 , F_63 ) ;
return - V_46 ;
...
static void T_6 F_70 ( void * V_5 )
{
V_198 [ F_71 () ] = F_72 ( V_199 ) ;
F_73 ( V_199 , ( V_198 [ F_71 () ] & ~ V_200 ) ) ;
}
...
static void T_7 F_79 ( void * V_5 )
{
F_73 ( V_199 , V_198 [ F_71 () ] ) ;
}
static void T_7 F_80 ( void )
{
#ifdef F_76
T_3 V_201 = F_72 ( V_205 ) ;
if ( ( F_77 ( V_201 ) == V_206 ) ||
( F_77 ( V_201 ) == V_207 ) ) {
F_78 ( F_79 , NULL , 0 ) ;
}
