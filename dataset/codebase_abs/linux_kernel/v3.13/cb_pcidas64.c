...
struct V_31 * V_32 = V_15 -> V_33 ;
int V_383 ;
V_383 = F_132 ( V_15 , V_170 , V_172 , V_164 , 0 ) ;
if ( V_383 )
return V_383 ;
F_85 ( V_170 -> V_384 ,
V_32 -> V_201 + V_385 ) ;
...
V_164 [ 1 ] = F_37 ( V_32 -> V_201 + V_386 ) ;
return V_172 -> V_173 ;
}
static int F_134 ( struct V_14 * V_15 , unsigned int V_163 ,
T_2 V_387 )
{
struct V_31 * V_32 = V_15 -> V_33 ;
static const int V_388 = 8 ;
static const int V_389 = 11 ;
unsigned int V_166 = ( ( V_163 & 0x7 ) << 8 ) | V_387 ;
unsigned int V_161 , V_390 ;
static const int V_391 = 1 ;
if ( V_163 >= V_388 ) {
F_21 ( V_15 , L_72 ) ;
return - 1 ;
}
for ( V_161 = 1 << ( V_389 - 1 ) ; V_161 ; V_161 >>= 1 ) {
V_390 = 0 ;
if ( V_166 & V_161 )
V_390 |= V_392 ;
F_50 ( V_391 ) ;
F_32 ( V_390 , V_32 -> V_46 + V_120 ) ;
V_390 |= V_393 ;
F_50 ( V_391 ) ;
F_32 ( V_390 , V_32 -> V_46 + V_120 ) ;
}
F_50 ( V_391 ) ;
F_32 ( V_394 , V_32 -> V_46 + V_120 ) ;
F_50 ( V_391 ) ;
F_32 ( 0 , V_32 -> V_46 + V_120 ) ;
F_50 ( V_391 ) ;
return 0 ;
...
const struct V_8 * V_17 = F_19 ( V_15 ) ;
struct V_31 * V_32 = V_15 -> V_33 ;
V_32 -> V_405 [ V_1 ] = V_387 ;
switch ( V_17 -> V_10 ) {
case V_19 :
case V_18 :
F_134 ( V_15 , V_1 , V_387 ) ;
break;
case V_11 :
...
if ( V_32 -> V_405 [ V_1 ] == V_164 [ 0 ] )
return 1 ;
F_136 ( V_15 , V_1 , V_164 [ 0 ] ) ;
return 1 ;
}
...
unsigned int V_161 , V_390 ;
unsigned int V_166 = ( ( V_1 & 0x3 ) << 8 ) | ( V_387 & 0xff ) ;
static const int V_406 = 1 ;
V_32 -> V_407 [ V_1 ] = V_387 ;
V_390 = V_408 ;
F_50 ( V_406 ) ;
F_32 ( V_390 , V_32 -> V_46 + V_120 ) ;
for ( V_161 = 1 << ( V_389 - 1 ) ; V_161 ; V_161 >>= 1 ) {
...
struct V_31 * V_32 = V_15 -> V_33 ;
int V_1 = F_58 ( V_172 -> V_176 ) ;
if ( V_32 -> V_407 [ V_1 ] == V_164 [ 0 ] )
return 1 ;
V_32 -> V_407 [ V_1 ] = V_164 [ 0 ] ;
F_139 ( V_15 , V_1 , V_164 [ 0 ] ) ;
return 1 ;
}
...
struct V_31 * V_32 = V_15 -> V_33 ;
unsigned int V_1 = F_58 ( V_172 -> V_176 ) ;
V_164 [ 0 ] = V_32 -> V_407 [ V_1 ] ;
return 1 ;
}
static T_1 F_142 ( struct V_14 * V_15 , T_2 V_163 )
{
struct V_31 * V_32 = V_15 -> V_33 ;
static const int V_389 = 11 ;
static const int V_409 = 0x6 ;
unsigned int V_166 = ( V_409 << 8 ) | V_163 ;
unsigned int V_161 ;
void T_4 * const V_155 =
V_32 -> V_36 + V_54 ;
T_1 V_387 ;
static const int V_410 = 16 ;
static const int V_411 = 1 ;
F_50 ( V_411 ) ;
V_32 -> V_53 &= ~ V_412 & ~ V_168 ;
V_32 -> V_53 |= V_159 ;
F_30 ( V_32 -> V_53 , V_155 ) ;
F_50 ( V_411 ) ;
V_32 -> V_53 |= V_168 ;
...
V_387 = 0 ;
for ( V_161 = 1 << ( V_410 - 1 ) ; V_161 ; V_161 >>= 1 ) {
F_50 ( V_411 ) ;
V_32 -> V_53 |= V_412 ;
F_30 ( V_32 -> V_53 , V_155 ) ;
F_50 ( V_411 ) ;
...
struct V_171 * V_172 , unsigned int * V_164 )
{
V_164 [ 0 ] = F_142 ( V_15 , F_58 ( V_172 -> V_176 ) ) ;
return 1 ;
}
...
V_15 -> V_305 = V_170 ;
V_170 -> type = V_416 ;
V_170 -> V_417 = V_418 | V_419 | V_420 | V_421 ;
if ( V_17 -> V_10 == V_19 )
V_170 -> V_417 |= V_422 | V_423 ;
else if ( V_17 -> V_10 == V_18 )
V_170 -> V_417 |= V_423 ;
V_170 -> V_424 = V_17 -> V_425 ;
V_170 -> V_426 = 0x2000 ;
V_170 -> V_427 = ( 1 << V_17 -> V_428 ) - 1 ;
V_170 -> V_429 = V_17 -> V_24 ;
V_170 -> V_430 = F_57 ;
V_170 -> V_431 = F_68 ;
V_170 -> V_432 = F_90 ;
V_170 -> V_433 = F_71 ;
...
T_2 V_164 ;
V_32 -> V_191 = F_15 ( 4 ) ;
for ( V_128 = 0 ; V_128 < V_170 -> V_424 ; V_128 ++ )
...
if ( V_17 -> V_30 ) {
V_170 -> type = V_435 ;
V_170 -> V_417 = V_418 | V_436 |
V_419 | V_437 ;
V_170 -> V_424 = V_17 -> V_30 ;
V_170 -> V_427 = ( 1 << V_17 -> V_438 ) - 1 ;
V_170 -> V_429 = V_17 -> V_439 ;
V_170 -> V_430 = F_114 ;
V_170 -> V_440 = F_113 ;
if ( F_24 ( V_17 ) ) {
V_15 -> V_270 = V_170 ;
...
if ( V_17 -> V_446 ) {
if ( V_17 -> V_10 == V_11 ) {
V_414 = V_32 -> V_46 + V_447 ;
F_146 ( V_15 , V_170 , F_127 ,
( unsigned long ) V_414 ) ;
} else {
V_414 =
V_32 -> V_201 + V_448 ;
F_146 ( V_15 , V_170 , F_126 ,
( unsigned long ) V_414 ) ;
}
} else
V_170 -> type = V_441 ;
...
V_170 -> V_440 = F_137 ;
for ( V_128 = 0 ; V_128 < V_170 -> V_424 ; V_128 ++ )
F_136 ( V_15 , V_128 , V_170 -> V_427 / 2 ) ;
V_170 = & V_15 -> V_415 [ 7 ] ;
if ( V_17 -> V_10 == V_18 ) {
V_170 -> type = V_450 ;
V_170 -> V_417 = V_418 | V_436 | V_451 ;
...
V_170 -> V_427 = 0xff ;
for ( V_128 = 0 ; V_128 < V_170 -> V_424 ; V_128 ++ )
F_139 ( V_15 , V_128 , V_170 -> V_427 / 2 ) ;
} else
V_170 -> type = V_441 ;
V_170 = & V_15 -> V_415 [ 8 ] ;
if ( F_36 ( V_32 -> V_36 + V_54 ) & V_452 ) {
V_170 -> type = V_453 ;
V_170 -> V_417 = V_418 | V_451 ;
V_170 -> V_424 = 128 ;
V_170 -> V_427 = 0xffff ;
V_170 -> V_430 = F_143 ;
} else
...
return V_109 ;
F_151 ( V_127 ) ;
V_15 -> V_460 = V_17 -> V_461 ;
V_32 -> V_462 = F_152 ( V_127 , 2 ) ;
V_32 -> V_463 = F_152 ( V_127 , 3 ) ;
V_32 -> V_36 = F_153 ( V_127 , 0 ) ;
V_32 -> V_46 = F_153 ( V_127 , 2 ) ;
V_32 -> V_201 = F_153 ( V_127 , 3 ) ;
if ( ! V_32 -> V_36 || ! V_32 -> V_46
|| ! V_32 -> V_201 ) {
F_154 ( V_15 -> V_199 , L_74 ) ;
return - V_132 ;
}
F_33 ( L_75 , V_32 -> V_36 ) ;
F_33 ( L_76 , V_32 -> V_46 ) ;
F_33 ( L_77 ,
V_32 -> V_201 ) ;
V_455 = F_36 ( V_32 -> V_36 + V_464 ) &
V_465 ;
V_456 = F_36 ( V_32 -> V_36 + V_466 ) &
V_455 & V_467 ;
V_32 -> V_145 = ( ( T_3 ) V_32 -> V_462 &
~ V_455 ) | V_456 ;
V_455 = F_36 ( V_32 -> V_36 + V_468 ) &
V_465 ;
V_456 = F_36 ( V_32 -> V_36 + V_469 ) &
V_455 & V_467 ;
V_32 -> V_143 = ( ( T_3 ) V_32 -> V_463 &
~ V_455 ) | V_456 ;
...
F_35 ( V_15 ) ;
F_43 ( V_15 ) ;
if ( F_155 ( V_127 -> V_344 , F_111 , V_470 ,
L_81 , V_15 ) ) {
...
static int F_161 ( struct V_126 * V_15 ,
const struct V_471 * V_213 )
{
return F_162 ( V_15 , & V_472 ,
V_213 -> V_473 ) ;
}
