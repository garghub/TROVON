...
V_2 -> V_12 = V_12 ;
V_2 -> V_24 = & V_12 -> V_24 ;
V_2 -> V_41 = F_28 ( & V_12 -> V_24 ) ;
if ( ! V_2 -> V_41 ) {
F_9 ( & V_12 -> V_24 , L_11 ) ;
return - V_46 ;
}
V_43 = F_29 ( & V_12 -> V_24 , L_12 , & V_12 -> V_24 , V_2 ,
& V_62 ) ;
if ( F_30 ( V_43 ) )
return F_31 ( V_43 ) ;
V_2 -> V_43 = V_43 ;
...
static int F_37 ( struct V_67 * V_24 )
{
struct V_1 * V_2 = F_38 ( V_24 ) ;
F_39 ( V_24 , L_15 , V_2 -> V_35 ) ;
return F_18 ( V_2 , V_53 ) ;
}
static int F_40 ( struct V_67 * V_24 )
{
struct V_1 * V_2 = F_38 ( V_24 ) ;
V_2 -> V_35 = V_53 ;
return F_18 ( V_2 , V_52 ) ;
}
static void F_41 ( struct V_57 * V_12 )
{
struct V_1 * V_2 = F_36 ( V_12 ) ;
F_18 ( V_2 , V_53 ) ;
}
