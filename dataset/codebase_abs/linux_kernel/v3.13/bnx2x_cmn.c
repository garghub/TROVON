...
memcpy ( & V_2 -> V_28 [ V_20 ] ,
& V_2 -> V_28 [ V_19 ] ,
sizeof( struct V_29 ) ) ;
V_8 -> V_30 [ 0 ] = & V_2 -> V_28 [ V_20 ] ;
}
void F_4 ( struct V_1 * V_2 , char * V_31 , T_1 V_32 )
{
if ( F_5 ( V_2 ) ) {
T_2 V_33 [ V_34 ] ;
V_33 [ 0 ] = '\0' ;
F_6 ( & V_2 -> V_35 ,
V_33 , V_34 ) ;
F_7 ( V_31 , V_2 -> V_36 , V_32 ) ;
snprintf ( V_31 + strlen ( V_2 -> V_36 ) , 32 - strlen ( V_2 -> V_36 ) ,
L_1 ,
( V_2 -> V_37 . V_38 & 0xff0000 ) >> 16 ,
( V_2 -> V_37 . V_38 & 0xff00 ) >> 8 ,
( V_2 -> V_37 . V_38 & 0xff ) ,
( ( V_33 [ 0 ] != '\0' ) ? L_2 : L_3 ) , V_33 ) ;
} else {
F_8 ( V_2 , V_31 , V_32 ) ;
}
}
static void F_9 ( struct V_1 * V_2 , int V_39 )
{
int V_40 , cos , V_41 = F_2 ( V_2 ) ;
for ( cos = 1 ; cos < V_2 -> V_26 ; cos ++ ) {
for ( V_40 = 0 ; V_40 < V_41 - V_39 ; V_40 ++ ) {
struct V_5 * V_7 = & V_2 -> V_7 [ V_40 ] ;
int V_42 = cos * ( V_41 - V_39 ) + V_40 ;
memcpy ( & V_2 -> V_28 [ V_42 ] , V_7 -> V_30 [ cos ] ,
sizeof( struct V_29 ) ) ;
V_7 -> V_30 [ cos ] = & V_2 -> V_28 [ V_42 ] ;
}
}
}
static T_3 F_10 ( struct V_1 * V_2 , struct V_29 * V_43 ,
T_3 V_44 , unsigned int * V_45 ,
unsigned int * V_46 )
{
struct V_47 * V_48 = & V_43 -> V_49 [ V_44 ] ;
struct V_50 * V_51 ;
struct V_52 * V_53 ;
struct V_54 * V_55 = V_48 -> V_55 ;
T_3 V_56 = F_11 ( V_48 -> V_57 ) , V_58 ;
int V_59 ;
T_3 V_60 = 0 ;
F_12 ( & V_55 -> V_61 ) ;
F_13 ( V_62 , L_4 ,
V_43 -> V_63 , V_44 , V_48 , V_55 ) ;
V_51 = & V_43 -> V_64 [ V_56 ] . V_65 ;
V_59 = F_14 ( V_51 -> V_59 ) - 1 ;
#ifdef F_15
if ( ( V_59 - 1 ) > ( V_66 + 2 ) ) {
F_16 ( L_5 ) ;
F_17 () ;
...
V_56 = F_11 ( F_18 ( V_56 ) ) ;
if ( V_48 -> V_67 & V_68 ) {
V_53 = & V_43 -> V_64 [ V_56 ] . V_69 ;
V_60 = F_19 ( V_53 ) ;
-- V_59 ;
V_56 = F_11 ( F_18 ( V_56 ) ) ;
}
F_20 ( & V_2 -> V_70 -> V_71 , F_21 ( V_51 ) ,
F_19 ( V_51 ) + V_60 ,
V_72 ) ;
while ( V_59 > 0 ) {
V_53 = & V_43 -> V_64 [ V_56 ] . V_69 ;
F_22 ( & V_2 -> V_70 -> V_71 , F_21 ( V_53 ) ,
F_19 ( V_53 ) , V_72 ) ;
if ( -- V_59 )
V_56 = F_11 ( F_18 ( V_56 ) ) ;
}
...
int F_26 ( struct V_1 * V_2 , struct V_29 * V_43 )
{
struct V_74 * V_75 ;
T_3 V_76 , V_77 , V_78 = V_43 -> V_79 ;
unsigned int V_45 = 0 , V_46 = 0 ;
#ifdef F_15
if ( F_27 ( V_2 -> V_80 ) )
return - 1 ;
#endif
V_75 = F_28 ( V_2 -> V_71 , V_43 -> V_63 ) ;
V_76 = F_14 ( * V_43 -> V_81 ) ;
V_77 = V_43 -> V_82 ;
while ( V_77 != V_76 ) {
T_3 V_83 ;
...
F_13 ( V_62 ,
L_6 ,
V_43 -> V_63 , V_76 , V_77 , V_83 ) ;
V_78 = F_10 ( V_2 , V_43 , V_83 ,
& V_45 , & V_46 ) ;
V_77 ++ ;
}
F_29 ( V_75 , V_45 , V_46 ) ;
...
F_40 ( V_7 -> V_94 ,
F_41 ( F_14 ( V_91 -> V_95 . V_96 [ V_40 ] ) ) ) ;
F_13 ( V_97 , L_7 ,
V_89 - 1 , F_14 ( V_91 -> V_95 . V_96 [ V_89 - 1 ] ) ) ;
F_12 ( ( void * ) ( V_7 -> V_94 ) ) ;
F_37 ( V_7 ,
F_14 ( V_91 -> V_95 . V_96 [ V_89 - 1 ] ) ) ;
V_87 = F_41 ( V_7 -> V_88 ) ;
V_92 = V_87 >> V_98 ;
V_93 = F_41 ( V_7 -> V_99 ) >> V_98 ;
if ( V_92 + 1 != V_93 )
V_92 ++ ;
for ( V_40 = V_93 ; V_40 != V_92 ; V_40 = F_42 ( V_40 ) ) {
if ( F_24 ( V_7 -> V_94 [ V_40 ] ) )
break;
V_7 -> V_94 [ V_40 ] = V_100 ;
V_39 += V_101 ;
}
...
bool * V_103 )
{
if ( ( V_2 -> V_71 -> V_104 & V_105 ) &&
( V_91 -> V_106 & V_107 ) ) {
enum V_108 V_109 ;
V_109 = V_91 -> V_106 & V_110 ;
* V_103 = ( V_109 == V_111 ) ||
( V_109 == V_112 ) ;
return F_45 ( V_91 -> V_113 ) ;
}
* V_103 = false ;
return 0 ;
}
static void F_46 ( struct V_5 * V_7 , T_3 V_114 ,
T_3 V_115 , T_3 V_116 ,
struct V_102 * V_91 )
{
struct V_1 * V_2 = V_7 -> V_2 ;
struct V_117 * V_118 = & V_7 -> V_119 [ V_115 ] ;
struct V_117 * V_120 = & V_7 -> V_119 [ V_116 ] ;
struct V_121 * V_122 = & V_7 -> V_123 [ V_116 ] ;
T_5 V_124 ;
struct V_21 * V_23 = & V_7 -> V_23 [ V_114 ] ;
struct V_117 * V_125 = & V_23 -> V_125 ;
if ( V_23 -> V_126 != V_127 )
F_16 ( L_9 , V_114 ) ;
V_124 = F_47 ( & V_2 -> V_70 -> V_71 ,
V_125 -> V_128 + V_129 ,
V_7 -> V_130 , V_131 ) ;
if ( F_27 ( F_48 ( & V_2 -> V_70 -> V_71 , V_124 ) ) ) {
F_49 ( V_7 , V_115 , V_116 ) ;
V_23 -> V_126 = V_132 ;
return;
}
V_120 -> V_128 = V_125 -> V_128 ;
F_50 ( V_120 , V_124 , V_124 ) ;
V_122 -> V_133 = F_51 ( F_52 ( V_124 ) ) ;
V_122 -> V_134 = F_51 ( F_53 ( V_124 ) ) ;
* V_125 = * V_118 ;
V_23 -> V_135 =
F_14 ( V_91 -> V_136 . V_67 ) ;
V_23 -> V_137 = F_14 ( V_91 -> V_137 ) ;
V_23 -> V_126 = V_138 ;
V_23 -> V_139 = F_14 ( V_91 -> V_139 ) ;
V_23 -> V_140 = V_91 -> V_140 ;
V_23 -> V_141 = F_44 ( V_2 , V_91 , & V_23 -> V_103 ) ;
if ( V_7 -> V_142 == V_143 ) {
T_3 V_144 = F_14 ( V_91 -> V_145 ) ;
V_23 -> V_146 = V_147 / V_144 * V_144 ;
V_23 -> V_144 = V_144 ;
}
#ifdef F_15
V_7 -> V_148 |= ( 1 << V_114 ) ;
...
#define F_60 ( T_7 ) ((__force __le32) swab32((__force __u32) (b32)))
#define F_61 ( T_8 ) ((__force __le16) swab16((__force __u16) (b16)))
