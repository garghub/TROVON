...
for ( V_35 = 0 ; V_35 < F_26 ( V_115 ) ; V_35 ++ ) {
if ( V_113 & V_115 [ V_35 ] . V_113 )
V_114 |= V_115 [ V_35 ] . V_114 ;
}
return V_114 ;
}
int F_62 ( struct V_71 * V_71 , struct V_134 * V_134 )
{
int V_23 ;
struct V_25 * V_26 ;
struct V_20 * V_21 ;
...
if ( F_64 ( V_1 -> V_3 ) )
F_65 ( V_1 -> V_153 ) ;
V_23 = F_66 ( V_21 , & V_136 ) ;
if ( V_23 < 0 )
return V_23 ;
if ( ( V_134 -> V_138 & V_122 ) &&
V_134 -> V_144 != F_67 ( V_1 ) )
F_68 ( V_1 , V_134 -> V_144 ) ;
F_41 ( V_1 ) ;
F_69 ( V_1 , V_134 ) ;
F_70 ( V_1 ) ;
...
V_1 -> V_5 = V_108 -> V_166 ;
F_72 ( V_1 , V_108 -> V_167 ) ;
V_78 = V_108 -> V_12 & V_168 ;
V_78 |= V_1 -> V_3 & ~ V_168 ;
V_1 -> V_3 = V_78 ;
F_73 ( V_1 , V_108 -> V_169 ) ;
...
struct V_25 * V_26 ;
V_79 = ( char * ) V_71 -> V_88 . V_79 ;
F_36 ( V_89 , L_11 , V_70 -> V_24 , V_79 , V_185 ) ;
V_26 = F_35 ( V_70 ) ;
V_80 = F_37 ( V_71 -> V_90 ) ;
if ( F_22 ( V_80 ) ) {
V_76 = F_33 ( V_80 ) ;
...
V_77 = F_1 ( V_70 ) ;
V_76 = F_78 ( V_80 , V_79 , ( char * ) V_185 , V_77 , & V_15 ) ;
if ( V_76 < 0 ) {
F_36 ( V_89 , L_12 , V_76 ) ;
goto error;
}
...
static int
F_79 ( struct V_71 * V_187 , struct V_1 * V_70 ,
struct V_71 * V_71 )
{
int V_76 ;
char * V_79 ;
...
return F_33 ( V_188 ) ;
V_79 = ( char * ) V_71 -> V_88 . V_79 ;
V_76 = F_80 ( V_80 , V_188 , ( char * ) V_71 -> V_88 . V_79 ) ;
if ( V_76 < 0 ) {
F_36 ( V_89 , L_14 , V_76 ) ;
return V_76 ;
}
...
if ( F_22 ( V_21 ) )
return F_33 ( V_21 ) ;
F_81 ( V_21 , V_187 -> V_87 ) ;
}
F_82 ( V_187 -> V_87 ) ;
F_45 ( V_71 , V_187 -> V_87 ) ;
return V_76 ;
}
static int
...
V_79 = ( char * ) V_71 -> V_88 . V_79 ;
V_76 = F_86 ( V_80 , V_79 , V_78 , V_189 , V_77 , & V_15 ) ;
if ( V_76 < 0 )
goto error;
F_41 ( V_70 ) ;
V_21 = F_38 ( V_80 , 1 , & V_79 , 1 ) ;
...
static void *
F_87 ( struct V_71 * V_71 , struct V_191 * V_192 )
{
int V_23 ;
struct V_20 * V_21 ;
char * V_193 = F_88 () ;
char * V_194 ;
F_36 ( V_89 , L_17 , V_71 -> V_88 . V_79 ) ;
if ( ! V_193 ) {
V_193 = F_12 ( - V_28 ) ;
goto V_195;
}
