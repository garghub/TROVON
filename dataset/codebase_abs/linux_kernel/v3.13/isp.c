...
V_2 -> V_27 = V_27 ;
V_2 -> V_254 = 0 ;
V_152 = F_196 ( V_2 -> V_24 , F_197 ( 32 ) ) ;
if ( V_152 )
return V_152 ;
F_198 ( V_324 , V_2 ) ;
V_2 -> V_337 . V_338 = F_199 ( & V_324 -> V_24 , L_76 ) ;
V_2 -> V_339 . V_338 = F_199 ( & V_324 -> V_24 , L_77 ) ;
...
if ( V_152 < 0 )
goto V_340;
for ( V_335 = 0 ; V_335 < F_22 ( V_341 ) ; V_335 ++ )
if ( V_2 -> V_63 == V_341 [ V_335 ] . V_342 )
break;
if ( V_335 == F_22 ( V_341 ) ) {
F_122 ( V_2 -> V_24 , L_79 ,
...
if ( V_341 [ V_335 ] . V_344 & 1 << V_30 ) {
V_152 = F_188 ( V_324 , V_2 , V_30 ) ;
if ( V_152 )
goto V_340;
}
}
V_2 -> V_257 = F_202 ( V_324 -> V_24 . V_345 ) ;
if ( ! V_2 -> V_257 ) {
F_122 ( V_2 -> V_24 , L_80 ) ;
V_152 = - V_43 ;
goto V_340;
}
V_152 = F_203 ( V_2 -> V_257 , & V_324 -> V_24 ) ;
if ( V_152 ) {
F_122 ( & V_324 -> V_24 , L_81 , V_152 ) ;
V_152 = - V_346 ;
goto V_347;
}
V_2 -> V_348 = F_204 ( V_324 , 0 ) ;
if ( V_2 -> V_348 <= 0 ) {
F_122 ( V_2 -> V_24 , L_82 ) ;
V_152 = - V_329 ;
goto V_349;
}
if ( F_205 ( V_2 -> V_24 , V_2 -> V_348 , F_44 , V_350 ,
L_83 , V_2 ) ) {
F_122 ( V_2 -> V_24 , L_84 ) ;
V_152 = - V_303 ;
goto V_349;
