...
{
struct V_21 * V_6 = (struct V_21 * ) V_1 ;
F_26 ( V_6 -> V_43 , V_1 -> V_68 . V_69 ,
V_1 -> V_68 . V_70 ,
0x21 ) ;
F_27 ( V_6 -> V_43 , V_6 -> V_54 ) ;
F_20 ( V_37 , L_8 ,
V_1 -> V_68 . V_69 , V_1 -> V_68 . V_70 ) ;
F_13 ( V_1 ) ;
return V_1 -> V_4 ;
}
...
{
struct V_1 * V_1 =
F_29 ( V_72 -> V_73 , struct V_1 , V_74 ) ;
struct V_21 * V_21 = (struct V_21 * ) V_1 ;
V_1 -> V_4 = 0 ;
if ( ! V_1 -> V_75 )
return 0 ;
