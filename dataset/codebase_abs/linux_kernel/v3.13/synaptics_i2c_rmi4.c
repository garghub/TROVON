...
V_144 -> V_152 = F_34 ( & V_41 -> V_12 , L_16 ) ;
if ( F_35 ( V_144 -> V_152 ) ) {
F_3 ( & V_41 -> V_12 , L_17 ,
V_13 ) ;
...
V_6 = F_46 ( V_144 -> V_42 ) ;
if ( V_6 ) {
F_3 ( & V_41 -> V_12 , L_22 , V_13 ) ;
goto V_170;
}
return V_6 ;
V_170:
F_47 ( V_41 -> V_69 , V_144 ) ;
V_156:
F_48 ( V_144 -> V_152 ) ;
V_154:
F_49 ( V_144 -> V_152 ) ;
...
static int F_55 ( struct V_171 * V_12 )
{
int V_6 ;
unsigned char V_60 ;
...
static int F_58 ( struct V_171 * V_12 )
{
int V_6 ;
unsigned char V_60 ;
struct V_1 * V_144 = F_56 ( V_12 ) ;
