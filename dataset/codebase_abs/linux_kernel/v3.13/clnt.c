...
if ( V_98 . V_71 == NULL ) {
struct V_113 * V_114 =
(struct V_113 * ) args -> V_104 ;
struct V_115 * sin =
(struct V_115 * ) args -> V_104 ;
struct V_116 * V_117 =
(struct V_116 * ) args -> V_104 ;
V_71 [ 0 ] = '\0' ;
switch ( args -> V_104 -> V_118 ) {
case V_119 :
...
static struct V_1 * F_67 ( struct V_65 * args ,
struct V_1 * V_2 )
{
struct V_39 * V_40 ;
struct V_1 * V_136 ;
...
V_136 -> V_46 = 0 ;
V_136 -> V_129 = V_2 -> V_129 ;
V_136 -> V_133 = V_2 -> V_133 ;
V_136 -> V_135 = V_2 -> V_135 ;
return V_136 ;
V_75:
F_43 ( L_11 , V_31 , V_28 ) ;
return F_19 ( V_28 ) ;
}
struct V_1 * F_72 ( struct V_1 * V_2 )
{
struct V_65 args = {
. V_68 = V_2 -> V_16 ,
. V_83 = V_2 -> V_82 ,
...
return F_67 ( & args , V_2 ) ;
}
struct V_1 *
F_73 ( struct V_1 * V_2 , T_2 V_139 )
{
struct V_65 args = {
. V_68 = V_2 -> V_16 ,
. V_83 = V_2 -> V_82 ,
...
struct V_1 * F_92 ( struct V_1 * V_43 ,
...
static
void F_94 ( struct V_142 * V_151 , struct V_1 * V_2 )
{
if ( V_2 != NULL ) {
F_93 ( V_151 ) ;
V_151 -> V_152 = V_2 ;
...
F_4 ( & V_2 -> V_44 ) ;
F_96 ( & V_151 -> V_153 , & V_2 -> V_90 ) ;
F_6 ( & V_2 -> V_44 ) ;
}
}
void F_97 ( struct V_142 * V_151 , struct V_1 * V_2 )
{
F_93 ( V_151 ) ;
F_94 ( V_151 , V_2 ) ;
}
static void
F_98 ( struct V_142 * V_151 , const struct V_159 * V_160 )
{
if ( V_160 != NULL ) {
...
if ( V_160 -> V_165 != NULL )
V_151 -> V_161 . V_165 = F_99 ( V_160 -> V_165 ) ;
}
}
static void
F_100 ( struct V_142 * V_151 , void * V_166 )
{
}
struct V_142 * F_101 ( const struct V_167 * V_168 )
{
struct V_142 * V_151 ;
V_151 = F_102 ( V_168 ) ;
if ( F_18 ( V_151 ) )
goto V_59;
F_94 ( V_151 , V_168 -> V_169 ) ;
F_98 ( V_151 , V_168 -> V_159 ) ;
if ( V_151 -> V_170 == NULL )
F_103 ( V_151 ) ;
F_58 ( & V_151 -> V_171 ) ;
F_104 ( V_151 ) ;
...
int F_105 ( struct V_1 * V_2 , const struct V_159 * V_160 , int V_108 )
{
struct V_142 * V_151 ;
struct V_167 V_168 = {
. V_169 = V_2 ,
...
int
F_109 ( struct V_1 * V_2 , const struct V_159 * V_160 , int V_108 ,
...
struct V_142 * F_110 ( struct V_180 * V_181 ,
...
void
F_103 ( struct V_142 * V_151 )
{
V_151 -> V_170 = V_192 ;
}
T_4 F_112 ( struct V_1 * V_2 , struct V_193 * V_194 , T_4 V_195 )
{
T_4 V_196 ;
struct V_39 * V_40 ;
F_68 () ;
...
const char * F_113 ( struct V_1 * V_2 ,
enum V_198 V_199 )
{
struct V_39 * V_40 ;
V_40 = F_70 ( V_2 -> V_45 ) ;
...
static int F_114 ( struct V_3 * V_3 , struct V_193 * V_201 , T_4 V_202 ,
struct V_193 * V_194 , int V_203 )
{
struct V_204 * V_205 ;
int V_28 ;
V_28 = F_115 ( V_3 , V_201 -> V_118 ,
V_206 , V_207 , & V_205 , 1 ) ;
if ( V_28 < 0 ) {
F_43 ( L_22 , V_28 ) ;
goto V_59;
...
V_28 = F_117 ( V_205 , V_201 , V_202 , 0 ) ;
if ( V_28 < 0 ) {
F_43 ( L_24 , V_28 ) ;
goto V_211;
}
V_28 = F_118 ( V_205 , V_194 , & V_203 ) ;
if ( V_28 < 0 ) {
F_43 ( L_25 , V_28 ) ;
goto V_211;
}
V_28 = 0 ;
if ( V_194 -> V_118 == V_124 ) {
struct V_116 * V_117 = (struct V_116 * ) V_194 ;
V_117 -> V_212 = 0 ;
}
F_43 ( L_26 , V_31 ) ;
V_211:
...
static int F_120 ( int V_213 , struct V_193 * V_194 , T_4 V_203 )
{
switch ( V_213 ) {
case V_121 :
...
int F_121 ( struct V_1 * V_2 , struct V_193 * V_194 , T_4 V_203 )
{
struct V_214 V_104 ;
struct V_193 * V_201 = (struct V_193 * ) & V_104 ;
struct V_39 * V_40 ;
struct V_3 * V_3 ;
T_4 V_202 ;
int V_28 ;
...
V_3 = F_122 ( V_40 -> V_215 ) ;
F_71 () ;
F_123 ( V_201 , 0 ) ;
V_28 = F_114 ( V_3 , V_201 , V_202 , V_194 , V_203 ) ;
F_124 ( V_3 ) ;
if ( V_28 != 0 )
return F_120 ( V_201 -> V_118 , V_194 , V_203 ) ;
return 0 ;
}
void
F_125 ( struct V_1 * V_2 , unsigned int V_216 , unsigned int V_217 )
{
struct V_39 * V_40 ;
F_68 () ;
V_40 = F_70 ( V_2 -> V_45 ) ;
...
struct V_3 * V_221 ;
F_68 () ;
V_221 = F_70 ( V_2 -> V_45 ) -> V_215 ;
F_71 () ;
return V_221 ;
}
T_4 F_127 ( struct V_1 * V_2 )
{
T_4 V_221 ;
F_68 () ;
V_221 = F_70 ( V_2 -> V_45 ) -> V_222 ;
F_71 () ;
return V_221 ;
}
unsigned long F_128 ( struct V_1 * V_2 )
{
unsigned long V_221 ;
F_68 () ;
V_221 = F_70 ( V_2 -> V_45 ) -> V_42 -> V_94 ;
F_71 () ;
return V_221 ;
}
...
static const char * F_134 ( const struct V_142 * V_151 )
{
...
static inline void
F_147 ( struct V_182 * V_194 , void * V_262 , T_4 V_186 )
{
...
if ( V_264 == NULL )
return;
V_151 -> V_177 = F_150 ( V_151 , V_264 , V_181 , V_265 ,
V_151 -> V_161 . V_163 ) ;
}
static void
...
F_43 ( L_49 ,
V_151 -> V_228 , V_40 ,
( F_153 ( V_40 ) ? L_50 : L_51 ) ) ;
V_151 -> V_170 = V_286 ;
if ( ! F_153 ( V_40 ) ) {
V_151 -> V_170 = V_287 ;
if ( V_151 -> V_177 < 0 )
return;
if ( V_151 -> V_144 & V_288 ) {
F_80 ( V_151 , - V_280 ) ;
return;
}
F_154 ( V_151 ) ;
...
return;
if ( V_290 )
V_151 -> V_152 -> V_86 -> V_293 ++ ;
V_292 ( V_151 ) ;
if ( F_159 ( V_151 ) )
return;
V_151 -> V_170 = V_294 ;
F_82 ( & V_151 -> V_185 -> V_247 -> V_295 , V_151 ) ;
}
static void
...
break;
default:
F_106 ( V_151 -> V_177 == - V_234 ) ;
F_20 ( V_296 L_52
L_53 , V_151 -> V_177 ) ;
break;
}
F_82 ( & V_181 -> V_247 -> V_295 , V_151 ) ;
}
static void
V_291 ( struct V_142 * V_151 )
{
struct V_1 * V_2 = V_151 -> V_152 ;
struct V_180 * V_181 = V_151 -> V_185 ;
int V_174 ;
if ( V_181 -> V_298 > 0 && ! V_181 -> V_261 )
V_151 -> V_177 = V_181 -> V_298 ;
F_136 ( V_151 ) ;
V_174 = V_151 -> V_177 ;
if ( V_174 >= 0 ) {
V_151 -> V_170 = V_299 ;
...
static void
V_285 ( struct V_142 * V_151 )
{
struct V_1 * V_2 = V_151 -> V_152 ;
if ( F_163 ( V_151 -> V_185 ) == 0 ) {
...
static void
V_299 ( struct V_142 * V_151 )
{
struct V_1 * V_2 = V_151 -> V_152 ;
struct V_180 * V_181 = V_151 -> V_185 ;
T_7 V_304 = V_151 -> V_161 . V_162 -> V_252 ;
T_6 * V_265 ;
F_136 ( V_151 ) ;
if ( V_151 -> V_144 & V_303 ) {
if ( V_2 -> V_135 ) {
...
F_166 () ;
V_181 -> V_266 . V_186 = V_181 -> V_305 . V_186 ;
F_167 ( memcmp ( & V_181 -> V_266 , & V_181 -> V_305 ,
...
V_151 -> V_170 = V_294 ;
if ( V_304 ) {
V_151 -> V_177 = F_169 ( V_151 , V_304 , V_181 , V_265 ,
V_151 -> V_161 . V_164 ) ;
}
...
V_181 -> V_298 = V_181 -> V_266 . V_186 = 0 ;
if ( V_151 -> V_152 -> V_133 )
F_161 ( V_181 -> V_247 ,
V_181 -> V_297 ) ;
}
}
...
struct V_1 * V_2 = V_151 -> V_152 ;
struct V_180 * V_181 = V_151 -> V_185 ;
T_6 * V_265 = V_181 -> V_307 [ 0 ] . V_263 ;
V_265 = F_170 ( V_181 -> V_247 , V_265 ) ;
* V_265 ++ = V_181 -> V_308 ;
* V_265 ++ = F_171 ( V_309 ) ;
* V_265 ++ = F_171 ( V_310 ) ;
* V_265 ++ = F_171 ( V_2 -> V_82 ) ;
* V_265 ++ = F_171 ( V_2 -> V_85 ) ;
* V_265 ++ = F_171 ( V_151 -> V_161 . V_162 -> V_250 ) ;
V_265 = F_172 ( V_151 , V_265 ) ;
V_181 -> V_311 = F_173 ( & V_181 -> V_307 [ 0 ] , V_265 ) ;
return V_265 ;
}
static T_6 *
F_168 ( struct V_142 * V_151 )
{
struct V_1 * V_2 = V_151 -> V_152 ;
struct V_312 * V_313 = & V_151 -> V_185 -> V_266 . V_187 [ 0 ] ;
int V_186 = V_151 -> V_185 -> V_266 . V_186 >> 2 ;
T_6 * V_265 = V_313 -> V_263 ;
T_3 V_314 ;
int error = - V_240 ;
...
goto V_315;
V_265 += 1 ;
if ( ( V_314 = F_174 ( * V_265 ++ ) ) != V_316 ) {
F_43 ( L_64 ,
V_151 -> V_228 , V_31 , V_314 ) ;
error = - V_146 ;
goto V_317;
}
if ( ( V_314 = F_174 ( * V_265 ++ ) ) != V_318 ) {
if ( -- V_186 < 0 )
goto V_315;
switch ( ( V_314 = F_174 ( * V_265 ++ ) ) ) {
case V_319 :
break;
case V_320 :
F_43 ( L_65 ,
...
static void F_176 ( void * V_335 , struct V_336 * V_337 , void * V_338 )
{
}
static int F_177 ( void * V_335 , struct V_336 * V_337 , void * V_338 )
{
return 0 ;
}
...
int V_28 ;
V_160 . V_165 = V_340 . V_341 ( NULL , NULL , 0 ) ;
V_28 = F_105 ( V_2 , & V_160 , V_154 | V_342 ) ;
F_178 ( V_160 . V_165 ) ;
return V_28 ;
}
struct V_142 * F_179 ( struct V_1 * V_2 , struct V_165 * V_343 , int V_108 )
{
struct V_159 V_160 = {
. V_162 = & V_339 ,
. V_165 = V_343 ,
...
static void F_181 ( const struct V_1 * V_2 ,
const struct V_142 * V_151 )
{
const char * V_344 = L_87 ;
if ( F_81 ( V_151 ) )
V_344 = F_182 ( V_151 -> V_147 ) ;
F_20 ( V_21 L_88 ,
V_151 -> V_228 , V_151 -> V_144 , V_151 -> V_177 ,
V_2 , V_151 -> V_185 , V_151 -> V_270 , V_151 -> V_179 ,
V_2 -> V_16 -> V_18 , V_2 -> V_85 , F_134 ( V_151 ) ,
V_151 -> V_170 , V_344 ) ;
}
