...
V_141 = F_101 ( V_234 , V_243 , 0 ) ;
V_127 = F_102 ( V_234 , 0 ) ;
if ( V_141 == NULL || V_127 < 0 )
return - V_241 ;
V_141 = F_103 ( V_141 -> V_244 , F_104 ( V_141 ) ,
V_234 -> V_47 ) ;
if ( V_141 == NULL )
return - V_245 ;
V_4 = F_105 ( sizeof( struct V_7 ) , V_246 ) ;
if ( V_4 == NULL ) {
V_240 = - V_213 ;
goto V_247;
}
...
V_4 -> V_168 = 1 ;
V_4 -> V_127 = V_127 ;
V_4 -> V_183 = V_4 -> V_249 -> V_244 ;
V_4 -> V_137 = F_110 ( V_141 -> V_244 , F_104 ( V_141 ) ) ;
if ( ! V_4 -> V_137 )
goto V_250;
V_4 -> V_251 = F_111 ( & V_234 -> V_41 , L_35 ) ;
if ( F_112 ( V_4 -> V_251 ) ) {
V_240 = F_113 ( V_4 -> V_251 ) ;
goto V_252;
}
F_5 ( V_4 -> V_251 ) ;
...
V_4 -> V_177 = - 1 ;
V_4 -> V_178 = - 1 ;
V_141 = F_116 ( V_234 , V_255 , L_37 ) ;
if ( V_141 )
V_239 = V_141 -> V_244 ;
V_4 -> V_93 = F_117 ( V_238 ,
V_256 , & V_239 , & V_234 -> V_41 , L_37 ) ;
if ( ! V_4 -> V_93 )
F_118 ( V_4 -> V_41 , L_38 ,
V_239 ) ;
V_141 = F_116 ( V_234 , V_255 , L_39 ) ;
if ( V_141 )
V_239 = V_141 -> V_244 ;
V_4 -> V_95 = F_117 ( V_238 ,
V_256 , & V_239 , & V_234 -> V_41 , L_39 ) ;
if ( ! V_4 -> V_95 )
F_118 ( V_4 -> V_41 , L_40 ,
V_239 ) ;
V_240 = F_119 ( V_4 -> V_127 , F_57 , 0 , V_257 , V_4 ) ;
if ( V_240 )
goto V_258;
if ( V_21 -> V_259 != NULL ) {
V_240 = V_21 -> V_259 ( & V_234 -> V_41 ) ;
if ( V_240 < 0 )
goto V_260;
}
V_4 -> V_35 = V_21 -> V_35 ;
V_4 -> V_261 = ( F_120 () ? 1 : 2 ) ;
V_4 -> V_38 = F_121 ( L_41 , 0 , 0 ) ;
if ( ! V_4 -> V_38 )
goto V_262;
...
F_127 ( V_4 ) ;
V_247:
F_128 ( V_141 -> V_244 , F_104 ( V_141 ) ) ;
return V_240 ;
}
static int F_129 ( struct V_233 * V_234 )
{
...
F_124 ( V_4 -> V_95 ) ;
F_126 ( V_4 -> V_137 ) ;
F_128 ( V_234 -> V_237 [ 0 ] . V_244 ,
V_234 -> V_237 [ 0 ] . V_265 - V_234 -> V_237 [ 0 ] . V_244 + 1 ) ;
F_122 ( V_4 -> V_38 ) ;
F_127 ( V_4 ) ;
return 0 ;
}
