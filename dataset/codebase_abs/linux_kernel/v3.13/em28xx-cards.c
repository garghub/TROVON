...
F_41 ( & V_8 -> V_87 ) ;
F_42 ( V_8 -> V_164 ) ;
F_43 ( V_8 -> V_165 , & V_166 ) ;
}
static int F_44 ( struct V_7 * V_8 , struct V_167 * V_164 ,
struct V_168 * V_169 ,
int V_170 )
{
struct V_171 * V_172 = & V_8 -> V_163 ;
int V_173 ;
static const char * V_174 = L_48 ;
const char * V_175 = V_174 ;
V_8 -> V_164 = V_164 ;
F_45 ( & V_8 -> V_176 ) ;
F_45 ( & V_8 -> V_177 ) ;
F_45 ( & V_8 -> V_178 ) ;
...
case V_193 :
V_175 = L_53 ;
if ( F_47 ( V_8 -> V_164 -> V_194 . V_195 )
== 0xeb1a ) {
T_1 V_196 = V_8 -> V_164 -> V_194 . V_197 ;
if ( F_47 ( V_196 ) == 0x2710 )
V_175 = L_50 ;
else if ( F_47 ( V_196 ) == 0x2820 )
V_175 = L_54 ;
}
break;
case V_198 :
...
F_48 (KERN_INFO DRIVER_NAME
L_63 , chip_name) ;
snprintf ( V_8 -> V_112 , sizeof( V_8 -> V_112 ) , L_64 , V_175 , V_8 -> V_165 ) ;
if ( V_8 -> V_205 ) {
V_173 = F_49 ( V_8 ) ;
if ( V_173 )
return - V_206 ;
...
F_4 ( V_8 ) ;
if ( ! V_8 -> V_15 . V_27 ) {
V_173 = F_5 ( V_8 , V_28 , V_8 -> V_15 . V_22 ) ;
if ( V_173 < 0 ) {
F_15 ( L_65
L_66 ,
V_207 , V_173 ) ;
...
V_173 = F_50 ( & V_169 -> V_8 , & V_8 -> V_87 ) ;
if ( V_173 < 0 ) {
F_15 ( L_67 ) ;
return V_173 ;
}
F_51 ( V_172 , 8 ) ;
V_8 -> V_87 . V_163 = V_172 ;
F_52 ( & V_8 -> V_208 ) ;
if ( V_8 -> V_15 . V_27 )
V_173 = F_53 ( V_8 , 0 , V_209 ) ;
else
V_173 = F_53 ( V_8 , 0 , V_210 ) ;
if ( V_173 < 0 ) {
F_15 ( L_68 ,
V_207 , V_173 ) ;
goto V_211;
...
if ( V_8 -> V_218 . V_219 != V_220 ) {
F_54 ( V_172 , & V_221 ,
V_222 , 0 , 1 , 1 , 1 ) ;
F_54 ( V_172 , & V_221 ,
V_223 , 0 , 0x1f , 1 , 0x1f ) ;
} else {
F_55 ( F_56 ( V_172 , V_222 ) ,
V_224 , V_8 ) ;
F_55 ( F_56 ( V_172 , V_223 ) ,
V_224 , V_8 ) ;
}
F_57 ( V_8 ) ;
F_58 ( & V_8 -> V_225 . V_226 ) ;
F_58 ( & V_8 -> V_227 . V_226 ) ;
if ( V_8 -> V_15 . V_129 ) {
V_173 = F_5 ( V_8 , V_33 , 0xf7 ) ;
if ( V_173 < 0 ) {
F_15 ( L_71
L_72 ,
V_207 , V_173 ) ;
...
struct V_7 * V_8 = NULL ;
int V_173 ;
bool V_232 = false , V_233 = false , V_157 = false ;
int V_102 , V_234 , V_235 ;
const int V_236 = V_169 -> V_237 [ 0 ] . V_238 . V_239 ;
char * V_240 ;
V_164 = F_61 ( F_62 ( V_169 ) ) ;
do {
V_234 = F_63 ( & V_166 , V_241 ) ;
if ( V_234 >= V_241 ) {
F_48 ( V_242 L_74 ,
V_241 ) ;
V_173 = - V_243 ;
...
} while ( F_64 ( V_234 , & V_166 ) );
if ( V_169 -> V_237 [ 0 ] . V_238 . V_245 == V_246 ) {
F_65 ( V_242 L_75
L_76 ,
F_47 ( V_164 -> V_194 . V_195 ) ,
F_47 ( V_164 -> V_194 . V_197 ) ,
V_236 ,
V_169 -> V_237 [ 0 ] . V_238 . V_245 ) ;
V_173 = - V_206 ;
goto V_247;
}
V_8 = F_66 ( sizeof( * V_8 ) , V_248 ) ;
if ( V_8 == NULL ) {
F_65 ( V_242 L_77 ) ;
V_173 = - V_243 ;
goto V_247;
...
for ( V_102 = 0 ; V_102 < V_169 -> V_250 ; V_102 ++ ) {
int V_251 ;
for ( V_251 = 0 ; V_251 < V_169 -> V_237 [ V_102 ] . V_238 . V_252 ; V_251 ++ ) {
const struct V_253 * V_254 ;
int V_255 , V_256 ;
V_254 = & V_169 -> V_237 [ V_102 ] . V_257 [ V_251 ] . V_238 ;
V_255 = F_47 ( V_254 -> V_258 ) ;
V_256 = V_255 & 0x7ff ;
if ( V_164 -> V_240 == V_259 )
V_256 = V_256 * F_68 ( V_255 ) ;
if ( F_69 ( V_254 ) ) {
switch ( V_254 -> V_260 ) {
case 0x82 :
V_233 = true ;
...
if ( V_256 > V_8 -> V_263 ) {
V_157 = true ;
V_8 -> V_264 = V_254 -> V_260 ;
V_8 -> V_263 = V_256 ;
V_8 -> V_265 = V_102 ;
}
} else {
V_157 = true ;
V_8 -> V_266 = V_254 -> V_260 ;
}
}
break;
}
...
V_8 -> V_165 = V_234 ;
V_8 -> V_18 = V_231 -> V_272 ;
V_8 -> V_273 = - 1 ;
V_8 -> V_205 = V_232 && ! ( V_233 || V_157 ) ;
V_8 -> V_156 = V_232 ;
V_8 -> V_274 = V_236 ;
for ( V_102 = 0 ; V_102 < V_164 -> V_275 -> V_238 . V_276 ; V_102 ++ ) {
struct V_168 * V_277 = V_164 -> V_275 -> V_169 [ V_102 ] ;
if ( V_277 -> V_237 [ 0 ] . V_238 . V_245 == V_246 ) {
V_8 -> V_155 = 1 ;
break;
}
}
...
V_8 -> V_278 = V_169 -> V_250 ;
if ( ( unsigned ) V_279 [ V_234 ] < V_115 )
V_8 -> V_18 = V_279 [ V_234 ] ;
F_72 ( V_169 , V_8 ) ;
F_73 ( V_8 ) ;
F_45 ( & V_8 -> V_280 ) ;
F_74 ( & V_8 -> V_280 ) ;
V_173 = F_44 ( V_8 , V_164 , V_169 , V_234 ) ;
if ( V_173 ) {
goto V_281;
}
if ( V_282 < 0 ) {
...
if ( V_233 ) {
if ( ! V_8 -> V_261 || ( V_235 && V_8 -> V_262 ) )
V_8 -> V_283 = 1 ;
F_19 ( L_97 ,
V_8 -> V_283 ? L_98 : L_99 ) ;
}
if ( V_157 ) {
if ( ! V_8 -> V_264 || ( V_235 && V_8 -> V_266 ) )
V_8 -> V_284 = 1 ;
F_19 ( L_100 ,
V_8 -> V_284 ? L_98 : L_99 ) ;
if ( V_8 -> V_284 ) {
V_173 = F_75 ( V_8 , V_285 ,
V_8 -> V_284 ,
V_286 ,
512 ,
V_287 ) ;
