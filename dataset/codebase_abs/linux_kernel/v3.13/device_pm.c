...
static int F_26 ( struct V_8 * V_33 , struct V_7 * V_27 ,
...
V_49 = V_36 ;
V_42 = F_27 ( V_33 ) && V_27 -> V_42 . V_12 . V_32
&& V_27 -> V_42 . V_54 >= V_46 ;
} else if ( F_28 ( V_33 , V_55 ) !=
V_56 ) {
...
int F_30 ( struct V_8 * V_33 , int * V_47 , int V_57 )
{
T_1 V_19 = F_31 ( V_33 ) ;
struct V_7 * V_27 ;
int V_36 , V_49 , V_50 ;
...
static void F_34 ( T_1 V_19 , T_4 V_63 , void * V_39 )
{
...
int F_37 ( struct V_7 * V_27 , bool V_65 )
{
struct V_66 * V_42 = & V_27 -> V_42 ;
if ( V_65 ) {
T_2 V_67 ;
int error ;
error = F_38 ( V_27 , V_51 ) ;
if ( error )
return error ;
V_67 = F_39 ( V_42 -> V_68 , V_42 -> V_69 ) ;
if ( F_5 ( V_67 ) ) {
F_40 ( V_27 ) ;
return - V_70 ;
}
} else {
F_41 ( V_42 -> V_68 , V_42 -> V_69 ) ;
F_40 ( V_27 ) ;
}
return 0 ;
}
...
return F_37 ( V_27 , V_65 ) ;
}
static inline void F_34 ( T_1 V_19 , T_4 V_63 ,
void * V_39 ) {}
int F_44 ( struct V_7 * V_27 , T_4 V_46 ,
bool V_65 )
{
return V_65 ?
F_38 ( V_27 , V_46 ) :
...
int F_45 ( struct V_8 * V_33 , bool V_65 )
{
T_1 V_19 ;
struct V_7 * V_27 ;
int error ;
...
struct V_7 * F_48 ( struct V_8 * V_33 )
{
T_1 V_19 = F_31 ( V_33 ) ;
struct V_7 * V_27 ;
return V_19 && ! F_13 ( V_19 , & V_27 ) ? V_27 : NULL ;
}
static int F_49 ( struct V_8 * V_33 , struct V_7 * V_27 ,
T_4 V_72 )
{
int V_36 , V_1 ;
if ( ! F_50 ( V_27 ) )
return 0 ;
V_36 = F_26 ( V_33 , V_27 , V_72 , NULL , & V_1 ) ;
return V_36 ? V_36 : F_9 ( V_27 , V_1 ) ;
}
static int F_51 ( struct V_7 * V_27 )
{
return F_50 ( V_27 ) ?
F_9 ( V_27 , V_2 ) : 0 ;
}
int F_52 ( struct V_8 * V_33 )
{
struct V_7 * V_27 = F_48 ( V_33 ) ;
bool V_73 ;
int error ;
if ( ! V_27 )
return 0 ;
V_73 = F_28 ( V_33 , V_55 ) >
V_56 ;
error = F_37 ( V_27 , V_73 ) ;
if ( V_73 && error )
return - V_74 ;
error = F_49 ( V_33 , V_27 , V_51 ) ;
if ( error )
F_37 ( V_27 , false ) ;
return error ;
}
...
int F_54 ( struct V_8 * V_33 )
{
int V_36 = F_55 ( V_33 ) ;
return V_36 ? V_36 : F_52 ( V_33 ) ;
}
int F_56 ( struct V_8 * V_33 )
{
int V_36 = F_53 ( V_33 ) ;
return V_36 ? V_36 : F_57 ( V_33 ) ;
}
...
V_46 = F_33 () ;
V_42 = F_27 ( V_33 ) ;
error = F_44 ( V_27 , V_46 , V_42 ) ;
if ( V_42 && error )
return error ;
error = F_49 ( V_33 , V_27 , V_46 ) ;
if ( error )
F_44 ( V_27 , V_10 , false ) ;
return error ;
}
int F_59 ( struct V_8 * V_33 )
{
struct V_7 * V_27 = F_48 ( V_33 ) ;
int error ;
if ( ! V_27 )
...
{
int V_36 = F_63 ( V_33 ) ;
return V_36 ? V_36 : F_58 ( V_33 ) ;
}
int F_64 ( struct V_8 * V_33 )
{
int V_36 = F_59 ( V_33 ) ;
return V_36 ? V_36 : F_65 ( V_33 ) ;
}
int F_66 ( struct V_8 * V_33 , bool V_75 )
{
struct V_7 * V_27 = F_48 ( V_33 ) ;
if ( ! V_27 )
return - V_22 ;
...
void F_67 ( struct V_8 * V_33 , bool V_79 )
{
struct V_7 * V_27 = F_48 ( V_33 ) ;
