...
{
return F_31 ( V_39 , V_59 , V_2 . V_29 -> V_70 ) ;
}
...
{
V_84 -> V_6 = F_41 ( V_85 -> V_6 , V_86 -> V_6 ) ;
V_84 -> V_8 = F_41 ( V_85 -> V_8 , V_86 -> V_8 ) ;
V_84 -> V_7 = F_41 ( V_85 -> V_7 , V_86 -> V_7 ) ;
V_84 -> V_9 = F_41 ( V_85 -> V_9 , V_86 -> V_9 ) ;
}
static inline T_2 F_42 ( T_2 V_10 , T_2 V_87 )
{
T_2 V_88 ;
V_88 = V_10 * V_87 ;
V_88 = F_43 ( V_88 , 1000 * 1000 ) ;
return V_88 ;
}
...
V_92 = F_42 ( V_91 , V_2 . V_29 -> V_93 ) << V_89 ;
V_92 |= F_42 ( V_91 , V_2 . V_29 -> V_94 ) ;
...
V_96 ++ ;
V_59 = F_49 ( sizeof( * V_59 ) * V_96 , V_80 ) ;
if ( ! V_59 ) {
F_20 ( V_47 L_34 , V_49 ) ;
return - V_81 ;
}
...
int T_1 F_53 ( struct V_41 * V_105 ,
unsigned int V_106 )
{
struct V_41 * V_107 ;
unsigned int V_96 ;
V_96 = sizeof( * V_107 ) * ( V_106 + 1 ) ;
V_107 = F_49 ( V_96 , V_80 ) ;
if ( V_107 ) {
