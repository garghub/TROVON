...
V_38 = V_21 . V_26 ;
V_23 = V_21 . V_23 ;
V_36 = F_15 ( ( sizeof( struct V_34 ) ) , V_39 ) ;
if ( ! V_36 )
return NULL ;
V_35 = V_36 ;
V_36 -> V_40 = 0 ;
while ( V_23 > 0 ) {
V_36 -> V_41 [ V_36 -> V_40 ] . V_26 =
( void * ) ( F_16 ( V_38 ) << V_42 ) ;
if ( V_23 > V_43 )
V_36 -> V_41 [ V_36 -> V_40 ] . V_44 = V_43 ;
else
V_36 -> V_41 [ V_36 -> V_40 ] . V_44 = V_23 ;
V_36 -> V_40 ++ ;
if ( V_36 -> V_40 >= V_45 ) {
V_36 -> V_37 = F_15 ( ( sizeof( struct V_34 ) ) ,
V_39 ) ;
if ( ! V_36 -> V_37 ) {
F_17 ( L_2 ,
V_46 ) ;
...
V_48 -> V_37 = NULL ;
V_48 -> V_40 = ( V_53 << 56 ) |
( V_48 -> V_40 * sizeof( struct V_54 ) + 16 ) ;
}
F_19 ( L_4 , V_21 . V_23 ) ;
F_19 ( L_5 ) ;
F_19 ( L_6 ) ;
