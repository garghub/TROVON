...
V_16 -> V_3 = V_3 ;
V_3 -> V_99 . V_16 = V_16 ;
V_16 -> V_100 . V_169 = & V_170 ;
F_75 ( & V_16 -> V_65 ) ;
F_76 ( & V_16 -> V_67 ) ;
V_106 = F_77 ( V_3 -> V_138 , & V_16 -> V_100 ,
V_171 ,
V_172 ) ;
if ( V_106 ) {
F_30 ( V_16 ) ;
...
void F_81 ( struct V_2 * V_3 , int V_173 )
{
F_82 ( V_3 -> V_99 . V_16 -> V_100 . V_101 , V_173 ) ;
}
bool F_83 ( struct V_2 * V_3 , struct V_104 * V_174 )
{
