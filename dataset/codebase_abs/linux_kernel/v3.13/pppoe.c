...
static int F_32 ( struct V_37 * V_38 , struct V_54 * V_55 )
{
struct V_18 * V_26 = F_33 ( V_38 ) ;
struct V_18 * V_56 ;
if ( V_38 -> V_40 & V_42 ) {
F_34 ( & V_26 -> V_57 , V_55 ) ;
...
static int F_39 ( struct V_54 * V_55 , struct V_32 * V_33 ,
...
if ( ! V_55 )
goto V_71;
if ( ! F_41 ( V_55 , sizeof( struct V_67 ) ) )
goto V_72;
V_68 = V_67 ( V_55 ) ;
V_69 = F_42 ( V_68 -> V_73 ) ;
F_43 ( V_55 , sizeof( * V_68 ) ) ;
if ( V_55 -> V_69 < V_69 )
goto V_72;
if ( F_44 ( V_55 , V_69 ) )
goto V_72;
V_19 = F_2 ( F_24 ( V_33 ) ) ;
V_26 = F_11 ( V_19 , V_68 -> V_1 , F_45 ( V_55 ) -> V_74 , V_33 -> V_20 ) ;
if ( ! V_26 )
goto V_72;
return F_46 ( F_14 ( V_26 ) , V_55 , 0 ) ;
V_72:
F_38 ( V_55 ) ;
V_71:
return V_63 ;
}
static int F_47 ( struct V_54 * V_55 , struct V_32 * V_33 ,
struct V_64 * V_65 , struct V_32 * V_66 )
{
struct V_67 * V_68 ;
struct V_18 * V_26 ;
...
static int F_51 ( struct V_3 * V_3 , struct V_77 * V_37 )
{
struct V_37 * V_38 ;
V_38 = F_52 ( V_3 , V_78 , V_79 , & V_80 ) ;
if ( ! V_38 )
return - V_81 ;
F_53 ( V_37 , V_38 ) ;
V_37 -> V_82 = V_83 ;
...
static int F_54 ( struct V_77 * V_37 )
{
...
static int F_58 ( struct V_77 * V_37 , struct V_97 * V_98 ,
int V_99 , int V_100 )
{
struct V_37 * V_38 = V_37 -> V_38 ;
...
error = - V_105 ;
V_3 = F_35 ( V_38 ) ;
V_33 = F_59 ( V_3 , V_31 -> V_34 . V_35 . V_33 ) ;
if ( ! V_33 )
goto V_106;
V_26 -> V_39 = V_33 ;
V_26 -> V_24 = V_33 -> V_20 ;
...
error = F_60 ( F_24 ( V_33 ) , & V_26 -> V_57 ) ;
if ( error ) {
F_20 ( V_19 , V_26 -> V_23 . V_1 ,
V_26 -> V_23 . V_8 , V_26 -> V_24 ) ;
goto V_106;
...
static int F_61 ( struct V_77 * V_37 , struct V_97 * V_114 ,
int * V_115 , int V_116 )
{
...
V_31 . V_117 = V_118 ;
V_31 . V_102 = V_92 ;
memcpy ( & V_31 . V_34 . V_35 , & F_33 ( V_37 -> V_38 ) -> V_23 ,
sizeof( struct V_5 ) ) ;
memcpy ( V_114 , & V_31 , V_69 ) ;
* V_115 = V_69 ;
return 0 ;
}
static int F_62 ( struct V_77 * V_37 , unsigned int V_119 ,
unsigned long V_120 )
{
struct V_37 * V_38 = V_37 -> V_38 ;
struct V_18 * V_26 = F_33 ( V_38 ) ;
...
static int F_66 ( struct V_134 * V_135 , struct V_77 * V_37 ,
...
char * V_140 ;
F_25 ( V_38 ) ;
if ( F_55 ( V_38 , V_93 ) || ! ( V_38 -> V_40 & V_41 ) ) {
error = - V_131 ;
goto V_103;
}
V_139 . V_141 = 1 ;
...
goto V_103;
V_55 = F_67 ( V_38 , V_138 + V_33 -> V_109 + 32 ,
0 , V_79 ) ;
if ( ! V_55 ) {
error = - V_81 ;
goto V_103;
}
F_68 ( V_55 , V_33 -> V_109 ) ;
F_69 ( V_55 ) ;
V_55 -> V_33 = V_33 ;
V_55 -> V_143 = V_38 -> V_144 ;
V_55 -> V_145 = F_70 ( V_146 ) ;
V_68 = (struct V_67 * ) F_71 ( V_55 , V_138 + sizeof( struct V_67 ) ) ;
V_140 = ( char * ) & V_68 -> V_147 [ 0 ] ;
error = F_72 ( V_140 , V_137 -> V_148 , V_138 ) ;
if ( error < 0 ) {
F_38 ( V_55 ) ;
goto V_103;
}
error = V_138 ;
F_73 ( V_55 , V_33 , V_146 ,
V_26 -> V_23 . V_8 , NULL , V_138 ) ;
memcpy ( V_68 , & V_139 , sizeof( struct V_67 ) ) ;
V_68 -> V_73 = F_74 ( V_138 ) ;
F_75 ( V_55 ) ;
V_103:
F_28 ( V_38 ) ;
return error ;
}
static int F_36 ( struct V_37 * V_38 , struct V_54 * V_55 )
{
struct V_18 * V_26 = F_33 ( V_38 ) ;
...
if ( ! V_33 )
goto abort;
if ( F_76 ( V_55 , sizeof( * V_68 ) + V_33 -> V_109 ) )
goto abort;
F_77 ( V_55 , sizeof( * V_68 ) ) ;
F_69 ( V_55 ) ;
V_68 = V_67 ( V_55 ) ;
V_68 -> V_141 = 1 ;
V_68 -> type = 1 ;
...
static int F_78 ( struct V_150 * V_57 , struct V_54 * V_55 )
{
struct V_37 * V_38 = (struct V_37 * ) V_57 -> V_111 ;
return F_36 ( V_38 , V_55 ) ;
}
static int F_79 ( struct V_134 * V_135 , struct V_77 * V_37 ,
...
V_55 = F_80 ( V_38 , V_100 & ~ V_152 ,
V_100 & V_152 , & error ) ;
if ( error < 0 )
goto V_103;
if ( V_55 ) {
V_138 = F_81 ( T_2 , V_138 , V_55 -> V_69 ) ;
error = F_82 ( V_55 , 0 , V_137 -> V_148 , V_138 ) ;
if ( error == 0 ) {
F_83 ( V_55 ) ;
return V_138 ;
}
...
static int F_84 ( struct V_153 * V_154 , void * V_155 )
{
struct V_18 * V_26 ;
char * V_156 ;
if ( V_155 == V_157 ) {
...
static inline struct V_18 * F_87 ( struct V_2 * V_19 , T_3 V_158 )
{
struct V_18 * V_26 ;
int V_12 ;
for ( V_12 = 0 ; V_12 < V_36 ; V_12 ++ ) {
...
static void * F_88 ( struct V_153 * V_154 , T_3 * V_158 )
__acquires( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_89 ( V_154 ) ) ;
T_3 V_159 = * V_158 ;
F_12 ( & V_19 -> V_29 ) ;
return V_159 ? F_87 ( V_19 , -- V_159 ) : V_157 ;
}
static void * F_90 ( struct V_153 * V_154 , void * V_155 , T_3 * V_158 )
{
struct V_2 * V_19 = F_2 ( F_89 ( V_154 ) ) ;
struct V_18 * V_26 ;
++ * V_158 ;
...
static void F_91 ( struct V_153 * V_154 , void * V_155 )
__releases( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_89 ( V_154 ) ) ;
F_15 ( & V_19 -> V_29 ) ;
}
static int F_92 ( struct V_160 * V_160 , struct V_161 * V_161 )
{
return F_93 ( V_160 , V_161 , & V_162 ,
sizeof( struct V_163 ) ) ;
}
static T_4 int F_94 ( struct V_3 * V_3 )
{
struct V_2 * V_19 = F_2 ( V_3 ) ;
struct V_164 * V_165 ;
F_95 ( & V_19 -> V_29 ) ;
V_165 = F_96 ( L_3 , V_166 , V_3 -> V_167 , & V_168 ) ;
#ifdef F_97
if ( ! V_165 )
return - V_81 ;
#endif
...
static T_5 void F_98 ( struct V_3 * V_3 )
{
F_99 ( L_3 , V_3 -> V_167 ) ;
}
