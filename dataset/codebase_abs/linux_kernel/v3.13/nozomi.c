...
char * V_95 = V_9 ;
V_93 & V_96 ? V_95 += snprintf ( V_95 , V_94 , L_35 ) : NULL ;
...
F_20 ( & V_16 -> V_56 -> V_57 , L_72 , V_16 -> V_138 ) ;
}
...
return sprintf ( V_9 , L_73 , V_16 -> V_138 ) ;
}
static T_6 F_56 ( struct V_145 * V_57 , struct V_146 * V_147 ,
char * V_9 )
{
const struct V_1 * V_16 = F_54 ( F_55 ( V_57 ) ) ;
return sprintf ( V_9 , L_74 , V_16 -> V_148 ) ;
}
...
static int F_61 ( struct V_151 * V_56 ,
...
V_161 , V_16 ) ;
if ( F_4 ( V_87 ) ) {
F_18 ( & V_56 -> V_57 , L_86 , V_56 -> V_129 ) ;
goto V_167;
}
F_19 ( L_87 , V_16 -> V_18 ) ;
F_57 ( V_16 ) ;
...
static void F_89 ( struct V_151 * V_56 )
{
int V_12 ;
struct V_62 V_124 ;
...
static void F_91 ( const struct V_2 * V_3 , int V_179 )
{
struct V_7 * V_7 = F_2 ( V_3 ) ;
V_7 -> V_62 . V_177 = V_179 ;
V_7 -> V_125 = 1 ;
F_21 ( V_36 , F_1 ( V_3 ) ) ;
}
static void F_92 ( const struct V_2 * V_3 , int V_180 )
{
struct V_7 * V_7 = F_2 ( V_3 ) ;
F_19 ( L_91 , V_3 -> V_5 , V_180 ) ;
V_7 -> V_62 . V_178 = V_180 ;
V_7 -> V_125 = 1 ;
F_21 ( V_36 , F_1 ( V_3 ) ) ;
}
static int F_93 ( struct V_181 * V_182 , struct V_2 * V_3 )
{
struct V_7 * V_7 = F_2 ( V_3 ) ;
...
static int F_96 ( struct V_184 * V_185 , struct V_2 * V_3 )
{
struct V_7 * V_7 = F_97 ( V_185 , struct V_7 , V_7 ) ;
...
F_100 ( L_93 , V_3 -> V_5 , V_185 ) ;
return 0 ;
}
static int F_101 ( struct V_2 * V_3 , struct V_186 * V_187 )
{
struct V_7 * V_7 = V_3 -> V_183 ;
return F_102 ( & V_7 -> V_7 , V_3 , V_187 ) ;
}
static void F_103 ( struct V_184 * V_185 )
{
struct V_7 * V_7 = F_97 ( V_185 , struct V_7 , V_7 ) ;
struct V_1 * V_16 = V_7 -> V_16 ;
unsigned long V_89 ;
...
static void F_104 ( struct V_2 * V_3 , struct V_186 * V_187 )
{
struct V_7 * V_7 = V_3 -> V_183 ;
if ( V_7 )
F_105 ( & V_7 -> V_7 , V_3 , V_187 ) ;
}
...
static int F_108 ( struct V_2 * V_3 , const unsigned char * V_188 ,
int V_189 )
{
int V_190 = - V_191 ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
...
if ( ! V_16 || ! V_7 )
return - V_163 ;
V_190 = F_109 ( & V_7 -> V_83 , ( unsigned char * ) V_188 , V_189 ) ;
F_98 ( & V_16 -> V_133 , V_89 ) ;
...
struct V_201 * V_202 )
{
const struct V_201 V_203 = V_7 -> V_112 ;
int V_87 ;
V_87 = ( ( V_89 & V_196 ) && ( V_203 . V_117 != V_202 -> V_117 ) ) ||
( ( V_89 & V_197 ) && ( V_203 . V_115 != V_202 -> V_115 ) ) ||
( ( V_89 & V_204 ) && ( V_203 . V_119 != V_202 -> V_119 ) ) ||
( ( V_89 & V_198 ) && ( V_203 . V_113 != V_202 -> V_113 ) ) ;
* V_202 = V_203 ;
return V_87 ;
}
...
struct V_7 * V_7 = V_3 -> V_183 ;
const struct V_201 V_203 = V_7 -> V_112 ;
V_206 -> V_113 = V_203 . V_113 ;
V_206 -> V_115 = V_203 . V_115 ;
V_206 -> V_117 = V_203 . V_117 ;
V_206 -> V_119 = V_203 . V_119 ;
V_206 -> V_207 = V_203 . V_207 ;
V_206 -> V_208 = V_203 . V_208 ;
V_206 -> V_209 = V_203 . V_209 ;
V_206 -> V_210 = V_203 . V_210 ;
V_206 -> V_211 = V_203 . V_211 ;
V_206 -> V_212 = V_203 . V_212 ;
V_206 -> V_213 = V_203 . V_213 ;
return 0 ;
}
...
switch ( V_214 ) {
case V_217 : {
struct V_201 V_202 = V_7 -> V_112 ;
V_190 = F_117 ( V_7 -> V_120 ,
F_114 ( V_7 , V_215 , & V_202 ) ) ;
break;
}
default:
F_19 ( L_99 , V_214 , V_214 ) ;
break;
}
return V_190 ;
}
...
V_174 -> type = V_226 ;
V_174 -> V_227 = V_228 ;
V_174 -> V_89 = V_229 | V_230 ;
V_174 -> V_231 = V_232 ;
V_174 -> V_231 . V_233 = V_234 | V_235 | V_236 | \
V_237 | V_238 ;
V_174 -> V_231 . V_239 = 115200 ;
V_174 -> V_231 . V_240 = 115200 ;
F_123 ( V_174 , & V_241 ) ;
V_87 = F_124 ( V_174 ) ;
if ( V_87 ) {
F_100 ( V_242 L_104 ) ;
