...
static void F_25 ( const struct V_56 * V_57 )
{
F_26 ( L_26 , V_57 -> V_58 ) ;
if ( V_47 == - 1 ) {
if ( F_27 ( NULL ,
...
static int F_29 ( const struct V_56 * V_57 )
{
F_25 ( V_57 ) ;
V_35 -> V_59 = V_60 ;
V_35 -> V_61 = V_62 ;
...
return - V_37 ;
V_35 -> T_2 = V_48 -> V_13 ;
sprintf ( F_32 ( V_48 ) , L_29 , V_71 ) ;
sprintf ( F_33 ( V_48 ) , L_29 , V_72 ) ;
V_48 -> V_73 = V_35 ;
V_35 -> V_70 = V_70 = F_34 () ;
if ( ! V_70 ) {
error = - V_74 ;
...
V_35 -> V_49 = V_48 ;
if ( F_27 ( V_48 -> V_13 , V_90 ) ) {
F_4 ( V_91 , L_35 ) ;
if ( F_3
( F_42
( V_48 -> V_13 , V_90 , NULL , NULL ) ) )
F_40 ( L_36 ) ;
}
V_47 = V_47 == 1 ? 1 : 0 ;
V_92 = V_92 == 1 ? 1 : 0 ;
...
{
struct V_94 * V_35 = F_46 ( V_48 ) ;
struct V_69 * V_70 = V_35 -> V_70 ;
F_43 ( V_70 ) ;
V_35 -> T_2 = NULL ;
return 0 ;
}
static void F_47 ( struct V_67 * V_48 , T_5 V_95 )
{
struct V_69 * V_70 ;
int V_96 ;
int V_97 , V_98 ;
...
V_70 -> V_49 . V_81 = & V_48 -> V_49 ;
F_37 ( V_83 , V_70 -> V_82 ) ;
F_37 ( V_35 -> V_59 , V_70 -> V_85 ) ;
F_37 ( V_35 -> V_61 , V_70 -> V_85 ) ;
F_37 ( V_35 -> V_63 , V_70 -> V_85 ) ;
F_37 ( V_35 -> V_65 , V_70 -> V_85 ) ;
F_37 ( V_87 , V_70 -> V_85 ) ;
error = F_38 ( V_70 ) ;
if ( error )
goto V_88;
V_68 = F_39 ( V_14 -> T_2 , & V_38 ) ;
if ( V_68 ) {
F_40 ( L_31 ) ;
goto V_89;
}
...
static void F_58 ( struct V_67 * V_48 , T_5 V_95 )
{
struct V_69 * V_70 ;
int V_96 , V_119 ;
...
if ( V_125 )
return - V_16 ;
V_35 = F_62 ( sizeof( struct V_94 ) , V_105 ) ;
if ( ! V_35 )
return - V_74 ;
V_35 -> V_59 = V_126 ;
V_35 -> V_61 = V_127 ;
