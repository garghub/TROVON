...
int F_60 ( struct V_14 * V_5 , void * V_183 ,
struct V_184 * V_185 )
{
...
V_61 = F_65 ( sizeof( * V_61 ) , V_191 ) ;
if ( ! V_61 )
return - V_119 ;
V_188 = F_66 ( V_5 , V_186 -> V_192 ,
V_193 ) ;
if ( ! V_188 ) {
V_18 = - V_194 ;
goto V_195;
}
V_41 = F_67 ( F_68 ( V_188 ) ) ;
V_108 = F_69 ( F_70 ( V_5 , V_185 ,
V_186 -> V_196 ) ) ;
if ( & V_108 -> V_39 == NULL ) {
V_18 = - V_194 ;
goto V_195;
...
static bool F_75 ( T_3 V_208 , T_3 V_209 )
{
int V_210 ;
...
{
if ( ! F_75 ( 0 , V_213 -> V_214 ) ||
! F_75 ( V_213 -> V_214 , V_213 -> V_208 ) ||
! F_75 ( V_213 -> V_208 , V_213 -> V_209 ) ||
! F_75 ( V_213 -> V_209 , V_213 -> V_215 ) ||
! F_75 ( V_213 -> V_215 , V_213 -> V_216 ) ||
! F_75 ( V_213 -> V_216 , V_213 -> V_211 ) ||
! F_75 ( V_213 -> V_211 , 0x00ffffff ) )
return - V_49 ;
if ( ! F_76 ( V_213 -> V_211 ) )
return - V_49 ;
return 0 ;
}
int F_78 ( struct V_14 * V_5 , void * V_183 ,
struct V_184 * V_185 )
{
...
if ( V_18 )
goto V_198;
F_79 ( V_218 , V_213 -> V_214 ) ;
F_79 ( V_219 , V_213 -> V_208 ) ;
F_79 ( V_220 , V_213 -> V_209 ) ;
F_79 ( V_221 , V_213 -> V_215 ) ;
F_79 ( V_222 , V_213 -> V_216 ) ;
F_79 ( V_223 , V_213 -> V_211 ) ;
}
}
V_18 = 0 ;
V_198:
...
V_18 = F_86 ( V_8 , V_226 , true , false ) ;
if ( V_18 ) {
F_71 ( L_5 ) ;
goto V_228;
}
...
void F_90 ( struct V_14 * V_5 )
{
T_2 * V_4 = V_5 -> V_6 ;
if ( ! V_4 -> V_3 )
return;
F_9 ( V_4 -> V_3 -> V_22 ) ;
F_73 ( & V_4 -> V_3 -> V_8 -> V_39 ) ;
F_72 ( V_4 -> V_3 ) ;
}
static struct V_1 T_1 *
F_91 ( struct V_2 * V_3 )
...
F_98 ( V_238 , L_9 ,
error -> V_39 ) ;
#define F_99 ( T_4 ) i915_error_printf(m, " " #x ": 0x%08x\n", error->regs.x)
F_99 ( V_134 ) ;
F_99 ( V_239 ) ;
F_99 ( V_140 ) ;
F_99 ( V_141 ) ;
