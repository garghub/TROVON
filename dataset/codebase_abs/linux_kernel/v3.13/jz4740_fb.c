...
F_14 ( V_46 , V_1 -> V_82 + V_99 ) ;
do {
V_46 = F_21 ( V_1 -> V_82 + V_103 ) ;
} while ( ! ( V_46 & V_108 ) );
F_23 ( V_101 , F_1 ( V_1 ) ) ;
F_23 ( V_102 , F_2 ( V_1 ) ) ;
F_15 ( V_1 -> V_78 ) ;
}
static int F_24 ( int V_109 , struct V_22 * V_38 )
{
struct V_1 * V_1 = V_38 -> V_36 ;
switch ( V_109 ) {
case V_110 :
...
V_111 *= F_5 ( V_1 ) >> 3 ;
V_1 -> V_104 = F_26 ( & V_1 -> V_113 -> V_114 ,
sizeof( * V_1 -> V_104 ) ,
& V_1 -> V_115 , V_116 ) ;
if ( ! V_1 -> V_104 )
return - V_117 ;
V_1 -> V_118 = F_27 ( V_111 ) ;
V_1 -> V_119 = F_26 ( & V_1 -> V_113 -> V_114 ,
V_1 -> V_118 ,
& V_1 -> V_120 , V_116 ) ;
if ( ! V_1 -> V_119 )
goto V_121;
for ( V_112 = V_1 -> V_119 ;
V_112 < V_1 -> V_119 + F_27 ( V_1 -> V_118 ) ;
V_112 += V_122 ) {
F_28 ( F_29 ( V_112 ) ) ;
}
...
return 0 ;
V_121:
F_30 ( & V_1 -> V_113 -> V_114 , sizeof( * V_1 -> V_104 ) ,
V_1 -> V_104 , V_1 -> V_115 ) ;
return - V_117 ;
}
static void F_31 ( struct V_1 * V_1 )
{
F_30 ( & V_1 -> V_113 -> V_114 , V_1 -> V_118 ,
V_1 -> V_119 , V_1 -> V_120 ) ;
F_30 ( & V_1 -> V_113 -> V_114 , sizeof( * V_1 -> V_104 ) ,
V_1 -> V_104 , V_1 -> V_115 ) ;
}
static int F_32 ( struct V_126 * V_113 )
{
int V_127 ;
struct V_1 * V_1 ;
struct V_22 * V_23 ;
...
struct V_129 * V_130 ;
if ( ! V_3 ) {
F_33 ( & V_113 -> V_114 , L_1 ) ;
return - V_131 ;
}
V_23 = F_34 ( sizeof( struct V_1 ) , & V_113 -> V_114 ) ;
if ( ! V_23 ) {
F_33 ( & V_113 -> V_114 , L_2 ) ;
return - V_117 ;
}
V_23 -> V_132 = & V_133 ;
V_23 -> V_134 = V_135 ;
...
V_1 -> V_113 = V_113 ;
V_1 -> V_3 = V_3 ;
V_1 -> V_78 = F_35 ( & V_113 -> V_114 , L_3 ) ;
if ( F_36 ( V_1 -> V_78 ) ) {
V_127 = F_37 ( V_1 -> V_78 ) ;
F_33 ( & V_113 -> V_114 , L_4 , V_127 ) ;
goto V_136;
}
V_1 -> V_100 = F_35 ( & V_113 -> V_114 , L_5 ) ;
if ( F_36 ( V_1 -> V_100 ) ) {
V_127 = F_37 ( V_1 -> V_100 ) ;
F_33 ( & V_113 -> V_114 , L_6 , V_127 ) ;
goto V_136;
}
V_130 = F_38 ( V_113 , V_137 , 0 ) ;
V_1 -> V_82 = F_39 ( & V_113 -> V_114 , V_130 ) ;
if ( F_36 ( V_1 -> V_82 ) ) {
V_127 = F_37 ( V_1 -> V_82 ) ;
goto V_136;
}
...
static int F_50 ( struct V_126 * V_113 )
{
struct V_1 * V_1 = F_51 ( V_113 ) ;
F_24 ( V_150 , V_1 -> V_23 ) ;
F_47 ( V_101 , F_1 ( V_1 ) ) ;
F_47 ( V_102 , F_2 ( V_1 ) ) ;
F_48 ( & V_1 -> V_23 -> V_148 ) ;
...
static int F_52 ( struct V_151 * V_114 )
{
struct V_1 * V_1 = F_53 ( V_114 ) ;
F_54 () ;
F_55 ( V_1 -> V_23 , 1 ) ;
F_56 () ;
F_12 ( & V_1 -> V_76 ) ;
...
static int F_57 ( struct V_151 * V_114 )
{
struct V_1 * V_1 = F_53 ( V_114 ) ;
F_19 ( V_1 -> V_78 ) ;
F_12 ( & V_1 -> V_76 ) ;
