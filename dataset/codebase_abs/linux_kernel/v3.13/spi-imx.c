...
static int T_1 F_23 ( struct V_1 * V_18 )
{
return F_15 ( V_18 -> V_25 + V_46 ) & V_47 ;
}
static void T_1 F_24 ( struct V_1 * V_18 )
{
while ( F_23 ( V_18 ) )
F_15 ( V_18 -> V_25 + V_48 ) ;
}
static void T_1 F_25 ( struct V_1 * V_18 , int V_19 )
{
unsigned int V_20 = 0 ;
if ( V_19 & V_21 )
V_20 |= V_49 ;
...
static void T_1 F_26 ( struct V_1 * V_18 )
{
unsigned int V_27 ;
...
static int T_1 F_28 ( struct V_1 * V_18 )
{
return F_15 ( V_18 -> V_25 + V_66 ) & V_67 ;
}
static void T_1 F_29 ( struct V_1 * V_18 )
{
while ( F_15 ( V_18 -> V_25 + V_66 ) & V_67 )
F_15 ( V_18 -> V_25 + V_48 ) ;
}
static void T_1 F_30 ( struct V_1 * V_18 , int V_19 )
{
unsigned int V_20 = 0 ;
if ( V_19 & V_21 )
V_20 |= V_68 ;
...
static void T_1 F_31 ( struct V_1 * V_18 )
{
unsigned int V_27 ;
V_27 = F_15 ( V_18 -> V_25 + V_52 ) ;
V_27 |= V_70 ;
...
static int T_1 F_33 ( struct V_1 * V_18 )
{
return F_15 ( V_18 -> V_25 + V_51 ) & V_78 ;
}
static void T_1 F_34 ( struct V_1 * V_18 )
{
F_13 ( 1 , V_18 -> V_25 + V_79 ) ;
}
static void T_1 F_35 ( struct V_1 * V_18 , int V_19 )
{
unsigned int V_20 = 0 ;
if ( V_19 & V_21 )
V_20 |= V_80 ;
...
static void T_1 F_36 ( struct V_1 * V_18 )
{
unsigned int V_27 ;
V_27 = F_15 ( V_18 -> V_25 + V_52 ) ;
V_27 |= V_82 ;
...
static int T_1 F_38 ( struct V_1 * V_18 )
{
return F_15 ( V_18 -> V_25 + V_51 ) & V_88 ;
}
static void T_1 F_39 ( struct V_1 * V_18 )
{
F_13 ( 1 , V_18 -> V_25 + V_79 ) ;
}
static void F_40 ( struct V_89 * V_90 , int V_91 )
{
struct V_1 * V_18 = F_41 ( V_90 -> V_92 ) ;
...
static T_3 F_45 ( int V_102 , void * V_103 )
{
...
struct V_1 * V_18 = F_41 ( V_90 -> V_92 ) ;
int V_93 = V_18 -> V_56 [ V_90 -> V_94 ] ;
F_52 ( & V_90 -> V_123 , L_3 , V_15 ,
V_90 -> V_41 , V_90 -> V_111 , V_90 -> V_112 ) ;
if ( F_42 ( V_93 ) )
F_53 ( V_93 , V_90 -> V_41 & V_44 ? 0 : 1 ) ;
F_40 ( V_90 , V_96 ) ;
return 0 ;
}
...
static int
F_55 ( struct V_124 * V_92 , struct V_125 * V_126 )
{
struct V_1 * V_18 = F_41 ( V_92 ) ;
int V_127 ;
V_127 = F_56 ( V_18 -> V_128 ) ;
if ( V_127 )
return V_127 ;
V_127 = F_56 ( V_18 -> V_129 ) ;
if ( V_127 ) {
F_57 ( V_18 -> V_128 ) ;
return V_127 ;
}
...
static int
F_58 ( struct V_124 * V_92 , struct V_125 * V_126 )
{
struct V_1 * V_18 = F_41 ( V_92 ) ;
F_57 ( V_18 -> V_129 ) ;
F_57 ( V_18 -> V_128 ) ;
...
{
struct V_132 * V_133 = V_131 -> V_123 . V_134 ;
const struct V_135 * V_136 =
F_60 ( V_137 , & V_131 -> V_123 ) ;
struct V_138 * V_139 =
F_61 ( & V_131 -> V_123 ) ;
struct V_124 * V_92 ;
struct V_1 * V_18 ;
struct V_140 * V_141 ;
int V_11 , V_127 , V_142 ;
if ( ! V_133 && ! V_139 ) {
F_62 ( & V_131 -> V_123 , L_4 ) ;
return - V_143 ;
}
V_127 = F_63 ( V_133 , L_5 , & V_142 ) ;
if ( V_127 < 0 ) {
if ( V_139 )
V_142 = V_139 -> V_144 ;
else
...
V_92 = F_64 ( & V_131 -> V_123 ,
sizeof( struct V_1 ) + sizeof( int ) * V_142 ) ;
if ( ! V_92 )
return - V_145 ;
F_65 ( V_131 , V_92 ) ;
V_92 -> V_146 = F_66 ( 1 , 32 ) ;
V_92 -> V_147 = V_131 -> V_148 ;
V_92 -> V_144 = V_142 ;
V_18 = F_41 ( V_92 ) ;
V_18 -> V_149 . V_92 = V_92 ;
for ( V_11 = 0 ; V_11 < V_92 -> V_144 ; V_11 ++ ) {
int V_150 = F_67 ( V_133 , L_6 , V_11 ) ;
if ( ! F_42 ( V_150 ) && V_139 )
V_150 = V_139 -> V_56 [ V_11 ] ;
V_18 -> V_56 [ V_11 ] = V_150 ;
if ( ! F_42 ( V_150 ) )
continue;
V_127 = F_68 ( & V_131 -> V_123 , V_18 -> V_56 [ V_11 ] ,
V_151 ) ;
if ( V_127 ) {
F_62 ( & V_131 -> V_123 , L_7 ) ;
goto V_152;
}
}
V_18 -> V_149 . V_56 = F_40 ;
V_18 -> V_149 . V_153 = F_47 ;
V_18 -> V_149 . V_154 = F_48 ;
V_18 -> V_149 . V_92 -> V_155 = F_51 ;
V_18 -> V_149 . V_92 -> V_156 = F_54 ;
V_18 -> V_149 . V_92 -> V_157 = F_55 ;
V_18 -> V_149 . V_92 -> V_158 = F_58 ;
V_18 -> V_149 . V_92 -> V_159 = V_43 | V_42 | V_44 ;
F_49 ( & V_18 -> V_108 ) ;
V_18 -> V_3 = V_136 ? V_136 -> V_160 :
(struct V_161 * ) V_131 -> V_162 -> V_163 ;
V_141 = F_69 ( V_131 , V_164 , 0 ) ;
V_18 -> V_25 = F_70 ( & V_131 -> V_123 , V_141 ) ;
if ( F_71 ( V_18 -> V_25 ) ) {
V_127 = F_72 ( V_18 -> V_25 ) ;
goto V_152;
}
V_18 -> V_102 = F_73 ( V_131 , 0 ) ;
if ( V_18 -> V_102 < 0 ) {
V_127 = - V_143 ;
goto V_152;
}
V_127 = F_74 ( & V_131 -> V_123 , V_18 -> V_102 , F_45 , 0 ,
V_151 , V_18 ) ;
if ( V_127 ) {
F_62 ( & V_131 -> V_123 , L_8 , V_18 -> V_102 , V_127 ) ;
goto V_152;
}
V_18 -> V_129 = F_75 ( & V_131 -> V_123 , L_9 ) ;
if ( F_71 ( V_18 -> V_129 ) ) {
V_127 = F_72 ( V_18 -> V_129 ) ;
goto V_152;
}
V_18 -> V_128 = F_75 ( & V_131 -> V_123 , L_10 ) ;
if ( F_71 ( V_18 -> V_128 ) ) {
V_127 = F_72 ( V_18 -> V_128 ) ;
goto V_152;
}
V_127 = F_76 ( V_18 -> V_128 ) ;
if ( V_127 )
goto V_152;
V_127 = F_76 ( V_18 -> V_129 ) ;
if ( V_127 )
goto V_165;
V_18 -> V_36 = F_77 ( V_18 -> V_128 ) ;
V_18 -> V_3 -> V_166 ( V_18 ) ;
V_18 -> V_3 -> V_107 ( V_18 , 0 ) ;
V_92 -> V_123 . V_134 = V_131 -> V_123 . V_134 ;
V_127 = F_78 ( & V_18 -> V_149 ) ;
if ( V_127 ) {
F_62 ( & V_131 -> V_123 , L_11 , V_127 ) ;
goto V_167;
}
F_79 ( & V_131 -> V_123 , L_12 ) ;
F_57 ( V_18 -> V_129 ) ;
F_57 ( V_18 -> V_128 ) ;
return V_127 ;
V_167:
...
static int F_82 ( struct V_130 * V_131 )
{
struct V_124 * V_92 = F_83 ( V_131 ) ;
struct V_1 * V_18 = F_41 ( V_92 ) ;
F_84 ( & V_18 -> V_149 ) ;
