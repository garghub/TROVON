...
struct V_238 * V_19 ;
int V_64 ;
V_248 = F_97 ( & V_246 -> V_19 ) ;
if ( ! V_248 )
return - V_251 ;
F_6 ( & V_246 -> V_19 , L_31 , V_248 -> V_252 ) ;
V_19 = & V_246 -> V_19 ;
V_106 = F_98 ( sizeof( * V_2 ) , 0 ) ;
if ( ! V_106 ) {
F_9 ( V_19 , L_32 ) ;
V_64 = - V_20 ;
goto V_253;
...
V_2 -> V_106 = V_106 ;
V_2 -> V_19 = & V_246 -> V_19 ;
V_2 -> V_168 = V_248 -> V_252 ;
F_100 ( V_106 , & V_2 -> V_196 , F_65 , V_57 ) ;
F_101 ( & V_2 -> V_128 ) ;
F_102 ( & V_2 -> V_37 ) ;
F_103 ( & V_2 -> V_167 ) ;
F_103 ( & V_2 -> V_164 ) ;
...
V_106 -> V_256 = & V_257 ;
V_106 -> V_34 |= V_258 ;
F_104 ( V_106 , & V_246 -> V_19 ) ;
V_2 -> V_101 . clock . V_259 = V_260 ;
V_2 -> V_101 . V_261 = & V_262 ;
V_2 -> V_101 . V_263 = F_87 ;
V_2 -> V_101 . V_264 = F_88 ;
V_2 -> V_101 . V_265 = F_89 ;
V_2 -> V_101 . V_266 = V_231
| V_130
| V_103 ;
V_2 -> V_201 = F_105 ( V_246 , 0 ) ;
if ( V_2 -> V_201 < 0 ) {
F_9 ( V_19 , L_33 ) ;
V_64 = - V_124 ;
goto V_267;
...
V_250 = F_106 ( V_246 , V_268 , 0 ) ;
if ( ! V_250 ) {
F_9 ( V_19 , L_34 ) ;
V_64 = - V_124 ;
goto V_267;
}
V_2 -> V_15 = F_107 ( V_250 -> V_208 , F_108 ( V_250 ) ) ;
if ( ! V_2 -> V_15 ) {
F_9 ( V_19 , L_35 ) ;
V_64 = - V_20 ;
goto V_267;
...
V_250 = F_106 ( V_246 , V_268 , 1 ) ;
if ( ! V_250 ) {
F_9 ( V_19 , L_36 ) ;
V_64 = - V_124 ;
goto V_269;
}
V_2 -> V_199 = F_107 ( V_250 -> V_208 , F_108 ( V_250 ) ) ;
if ( ! V_2 -> V_199 ) {
F_9 ( V_19 , L_37 ) ;
V_64 = - V_20 ;
goto V_269;
...
F_3 ( 1 << V_2 -> V_168 , & V_2 -> V_199 -> V_204 ) ;
V_64 = F_109 ( V_2 -> V_201 , F_70 , V_270 , V_271 , V_2 ) ;
if ( V_64 ) {
F_9 ( V_19 , L_38 ) ;
goto V_272;
}
...
static int F_116 ( struct V_245 * V_246 )
{
struct V_105 * V_106 = F_117 ( V_246 ) ;
struct V_1 * V_2 = F_78 ( V_106 ) ;
F_118 ( V_106 ) ;
F_112 ( & V_2 -> V_196 ) ;
F_3 ( 1 << V_2 -> V_168 , & V_2 -> V_199 -> V_204 ) ;
