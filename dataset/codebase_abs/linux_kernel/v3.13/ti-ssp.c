...
const struct V_49 * V_50 = F_33 ( & V_48 -> V_3 ) ;
int error = 0 , V_51 = 0xff , V_5 ;
unsigned long V_52 ;
struct V_2 * V_3 = & V_48 -> V_3 ;
struct V_53 V_54 [ 2 ] ;
V_6 = F_34 ( sizeof( * V_6 ) , V_55 ) ;
if ( ! V_6 ) {
F_35 ( V_3 , L_1 ) ;
return - V_56 ;
}
V_6 -> V_3 = V_3 ;
F_36 ( V_3 , V_6 ) ;
V_6 -> V_57 = F_37 ( V_48 , V_58 , 0 ) ;
if ( ! V_6 -> V_57 ) {
error = - V_59 ;
F_35 ( V_3 , L_2 ) ;
goto V_60;
}
if ( ! F_38 ( V_6 -> V_57 -> V_61 , F_39 ( V_6 -> V_57 ) ,
V_48 -> V_62 ) ) {
error = - V_56 ;
F_35 ( V_3 , L_3 ) ;
goto V_60;
}
V_6 -> V_8 = F_40 ( V_6 -> V_57 -> V_61 , F_39 ( V_6 -> V_57 ) ) ;
if ( ! V_6 -> V_8 ) {
error = - V_56 ;
F_35 ( V_3 , L_4 ) ;
goto V_63;
}
V_6 -> V_64 = F_41 ( V_3 , NULL ) ;
if ( F_42 ( V_6 -> V_64 ) ) {
error = F_43 ( V_6 -> V_64 ) ;
F_35 ( V_3 , L_5 ) ;
goto V_65;
}
V_6 -> V_43 = F_44 ( V_48 , 0 ) ;
if ( V_6 -> V_43 < 0 ) {
error = - V_59 ;
F_35 ( V_3 , L_6 ) ;
goto V_66;
}
error = F_45 ( V_6 -> V_43 , NULL , F_30 , 0 ,
F_46 ( V_3 ) , V_6 ) ;
if ( error < 0 ) {
F_35 ( V_3 , L_7 ) ;
goto V_66;
...
F_7 ( V_6 , V_45 , 0x3 ) ;
F_7 ( V_6 , V_69 , 0 ) ;
F_11 ( V_6 , 0 , V_16 , V_70 ) ;
F_11 ( V_6 , 1 , V_16 , V_70 ) ;
F_11 ( V_6 , 0 , V_30 , V_71 ) ;
F_11 ( V_6 , 1 , V_30 , V_71 ) ;
V_52 = F_50 ( V_6 -> V_64 ) ;
if ( V_50 && V_50 -> V_72 )
V_51 = ( V_52 / V_50 -> V_72 ) - 1 ;
V_51 = F_51 ( V_51 , 0 , 0xff ) ;
F_9 ( V_6 , V_73 , 0xff , V_51 ) ;
memset ( V_54 , 0 , sizeof( V_54 ) ) ;
for ( V_5 = 0 ; V_5 < 2 ; V_5 ++ ) {
const struct V_74 * V_75 = & V_50 -> V_44 [ V_5 ] ;
V_54 [ V_5 ] . V_5 = V_5 ;
V_54 [ V_5 ] . V_62 = V_75 -> F_46 ;
V_54 [ V_5 ] . V_76 = V_75 -> V_50 ;
}
error = F_52 ( V_3 , 0 , V_54 , 2 , NULL , 0 , NULL ) ;
if ( error < 0 ) {
F_35 ( V_3 , L_9 ) ;
goto V_67;
}
...
F_55 ( V_6 -> V_8 ) ;
V_63:
F_56 ( V_6 -> V_57 -> V_61 , F_39 ( V_6 -> V_57 ) ) ;
V_60:
F_57 ( V_6 ) ;
return error ;
}
