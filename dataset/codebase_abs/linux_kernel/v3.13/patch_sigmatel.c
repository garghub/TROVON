...
return;
if ( F_43 ( V_4 -> V_92 ) ) {
unsigned int V_168 = F_27 ( V_4 , 0x0f ) ;
if ( F_98 ( V_168 ) == V_169 ||
F_98 ( V_168 ) == V_170 ||
F_98 ( V_168 ) == V_171 ) {
V_168 = ( V_168 & ( ~ V_172 ) )
...
if ( V_9 -> V_161 )
V_186 |= V_187 ;
V_185 = F_111 ( V_4 , & V_9 -> V_15 . V_104 , NULL , V_186 ) ;
if ( V_185 < 0 )
return V_185 ;
V_9 -> V_15 . V_188 = F_1 ;
V_9 -> V_15 . V_189 = F_3 ;
...
V_9 -> V_15 . V_192 = F_21 ;
V_9 -> V_15 . V_193 = F_23 ;
V_185 = F_112 ( V_4 , & V_9 -> V_15 . V_104 ) ;
if ( V_185 < 0 )
return V_185 ;
V_9 -> V_15 . V_194 [ 3 ] |= V_195 ;
if ( V_9 -> V_122 > 0 ) {
V_185 = F_50 ( V_4 ,
V_9 -> V_122 ) ;
if ( V_185 < 0 )
...
#endif
if ( V_9 -> V_53 )
V_9 -> V_15 . V_199 . V_200 = F_12 ;
if ( V_9 -> V_201 &&
F_34 ( V_4 , L_18 ) == 1 ) {
if ( ! F_55 ( & V_9 -> V_15 , NULL , V_9 -> V_201 ) )
return - V_123 ;
}
if ( V_9 -> V_202 ) {
V_185 = F_66 ( V_4 ) ;
...
{
F_119 ( V_204 , L_20 ,
F_7 ( V_4 , V_4 -> V_31 , 0 , V_206 , 0 ) ) ;
}
static void F_121 ( struct V_203 * V_204 ,
struct V_3 * V_4 , T_1 V_18 )
{
F_118 ( V_204 , V_4 , V_18 ) ;
if ( V_18 == V_4 -> V_31 )
F_120 ( V_204 , V_4 , 0xfa0 ) ;
}
static void F_122 ( struct V_203 * V_204 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_120 ( V_204 , V_4 , 0xfe0 ) ;
}
static void F_123 ( struct V_203 * V_204 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_120 ( V_204 , V_4 , 0xfeb ) ;
}
...
static void F_125 ( struct V_3 * V_4 , T_1 V_207 ,
unsigned int V_208 )
{
...
V_9 -> V_43 = 0x01 ;
V_9 -> V_64 = 1 ;
V_9 -> V_68 = F_135 ( V_232 ) ;
V_9 -> V_69 = V_232 ;
V_9 -> V_15 . V_213 = 1 ;
V_9 -> V_15 . V_233 = 1 ;
V_4 -> V_214 = V_215 ;
F_100 ( V_4 , V_234 , V_235 ,
V_236 ) ;
F_101 ( V_4 , V_149 ) ;
if ( ! V_9 -> V_154 )
F_75 ( V_4 , V_237 ) ;
...
V_9 -> V_15 . V_196 = 0x21 ;
V_9 -> V_69 = V_242 ;
V_9 -> V_68 = F_135 ( V_242 ) ;
V_9 -> V_96 = - 1 ;
V_4 -> V_214 = V_215 ;
F_75 ( V_4 , V_243 ) ;
F_100 ( V_4 , V_244 , V_245 ,
V_246 ) ;
F_101 ( V_4 , V_149 ) ;
F_136 ( V_4 ) ;
V_185 = F_110 ( V_4 ) ;
...
{
struct V_8 * V_9 ;
const struct V_248 * V_249 = V_250 ;
int V_185 ;
V_185 = F_127 ( V_4 ) ;
if ( V_185 < 0 )
return V_185 ;
...
if ( F_140 ( F_141 ( V_4 , 0x28 ) ) == V_252 )
F_75 ( V_4 , V_253 ) ;
if ( F_141 ( V_4 , 0xa ) & V_254 )
F_142 ( V_4 , V_249 ) ;
V_9 -> V_201 = & V_255 ;
V_9 -> V_86 = 0x50 ;
V_9 -> V_90 = 0 ;
V_9 -> V_14 = 1 ;
V_9 -> V_15 . V_196 = 0x26 ;
V_9 -> V_68 = F_135 ( V_256 ) ;
V_9 -> V_69 = V_256 ;
F_100 ( V_4 , V_257 , V_258 ,
V_259 ) ;
F_101 ( V_4 , V_149 ) ;
F_136 ( V_4 ) ;
V_185 = F_110 ( V_4 ) ;
...
V_4 -> V_214 = V_215 ;
F_75 ( V_4 , V_260 ) ;
F_144 ( V_4 , 0x12 , V_113 ,
( 0 << V_261 ) |
( 2 << V_125 ) |
( 0x27 << V_262 ) |
( 0 << V_120 ) ) ;
F_100 ( V_4 , V_263 , V_264 ,
V_177 ) ;
F_101 ( V_4 , V_149 ) ;
V_185 = F_110 ( V_4 ) ;
if ( V_185 < 0 ) {
