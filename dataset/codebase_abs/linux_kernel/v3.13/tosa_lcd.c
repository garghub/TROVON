...
int V_43 ;
struct V_15 * V_4 ;
V_4 = F_19 ( & V_2 -> V_44 , sizeof( struct V_15 ) ,
V_45 ) ;
if ( ! V_4 )
return - V_46 ;
V_4 -> V_23 = true ;
...
F_6 ( V_4 ) ;
F_9 ( V_4 ) ;
V_4 -> V_36 = F_23 ( L_3 , & V_2 -> V_44 , V_4 ,
& V_49 ) ;
if ( F_24 ( V_4 -> V_36 ) ) {
V_43 = F_25 ( V_4 -> V_36 ) ;
V_4 -> V_36 = NULL ;
...
static int F_30 ( struct V_51 * V_44 )
{
struct V_15 * V_4 = F_31 ( V_44 ) ;
F_12 ( V_4 ) ;
return 0 ;
}
static int F_32 ( struct V_51 * V_44 )
{
struct V_15 * V_4 = F_31 ( V_44 ) ;
F_6 ( V_4 ) ;
if ( F_15 ( V_4 -> V_38 ) )
