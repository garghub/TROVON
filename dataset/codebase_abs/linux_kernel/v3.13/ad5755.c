...
static int F_37 ( struct V_101 * V_9 )
{
enum V_102 type = F_38 ( V_9 ) -> V_103 ;
const struct V_68 * V_69 = F_39 ( & V_9 -> V_104 ) ;
struct V_1 * V_2 ;
struct V_5 * V_6 ;
int V_12 ;
V_2 = F_40 ( & V_9 -> V_104 , sizeof( * V_6 ) ) ;
if ( V_2 == NULL ) {
F_41 ( & V_9 -> V_104 , L_2 ) ;
return - V_105 ;
}
...
static int F_44 ( struct V_101 * V_9 )
{
