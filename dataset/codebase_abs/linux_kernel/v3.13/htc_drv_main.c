...
static int F_107 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
struct V_123 * V_124 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
...
F_7 ( V_3 ) ;
V_129 = (struct V_128 * ) V_124 -> V_127 ;
F_109 ( V_3 -> V_78 , V_129 -> V_96 ) ;
V_10 = F_51 ( V_3 , V_27 , V_124 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
return V_10 ;
}
static void F_110 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
...
V_271 . V_274 = V_269 -> V_275 ;
V_271 . V_276 = V_269 -> V_277 ;
V_271 . V_278 = V_269 -> V_279 ;
V_271 . V_280 = V_269 -> V_281 * 32 ;
V_272 = F_112 ( V_267 , V_3 -> V_282 ) ;
F_43 ( V_45 , V_90 ,
L_44 ,
V_267 , V_272 , V_269 -> V_275 , V_269 -> V_277 ,
V_269 -> V_279 , V_269 -> V_281 ) ;
V_10 = F_113 ( V_3 , V_272 , & V_271 ) ;
if ( V_10 ) {
F_32 ( V_45 , L_45 ) ;
goto V_244;
}
if ( ( V_3 -> V_12 -> V_50 == V_51 ) &&
( V_272 == V_3 -> V_282 [ V_283 ] ) )
F_114 ( V_3 ) ;
V_244:
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
...
switch ( V_285 ) {
case V_294 :
V_10 = F_116 ( V_45 , V_27 , V_124 , V_287 ) ;
if ( V_10 >= 0 ) {
V_287 -> V_295 = V_10 ;
V_287 -> V_88 |= V_296 ;
...
F_119 ( V_3 -> V_12 ) ;
F_43 ( V_45 , V_90 , L_47 ,
V_45 -> V_131 , V_45 -> V_301 ) ;
}
static void F_120 ( void * V_24 , T_1 * V_25 , struct V_26 * V_27 )
{
struct V_2 * V_3 = (struct V_2 * ) V_24 ;
struct V_44 * V_45 = F_20 ( V_3 -> V_12 ) ;
struct V_28 * V_29 = & V_27 -> V_29 ;
if ( ( V_27 -> type == V_54 ) && V_29 -> V_34 ) {
V_45 -> V_301 = V_29 -> V_302 ;
...
static void F_122 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
struct V_28 * V_29 ,
T_4 V_246 )
{
...
static T_5 F_126 ( struct V_81 * V_36 ,
struct V_26 * V_27 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
T_5 V_314 ;
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
V_314 = F_127 ( V_3 -> V_12 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
return V_314 ;
}
static void F_128 ( struct V_81 * V_36 ,
struct V_26 * V_27 , T_5 V_314 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
F_129 ( V_3 -> V_12 , V_314 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
}
static void F_130 ( struct V_81 * V_36 ,
struct V_26 * V_27 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
F_4 ( & V_3 -> V_65 ) ;
...
static int F_132 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
enum V_177 V_178 ,
struct V_123 * V_124 ,
T_3 V_179 , T_3 * V_315 , T_1 V_316 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_128 * V_129 ;
int V_10 = 0 ;
...
if ( ! V_10 )
F_133 ( V_27 , V_124 -> V_46 , V_179 ) ;
break;
case V_319 :
case V_320 :
case V_321 :
F_64 ( V_3 , V_27 , V_124 , V_178 , V_179 ) ;
F_134 ( V_27 , V_124 -> V_46 , V_179 ) ;
break;
case V_322 :
V_129 = (struct V_128 * ) V_124 -> V_127 ;
F_65 ( & V_3 -> V_66 . V_188 ) ;
V_129 -> V_189 [ V_179 ] = V_323 ;
F_66 ( & V_3 -> V_66 . V_188 ) ;
break;
default:
...
static void F_136 ( struct V_81 * V_36 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
F_4 ( & V_3 -> V_65 ) ;
F_65 ( & V_3 -> V_324 ) ;
...
static int F_137 ( struct V_81 * V_36 , T_4 V_325 )
{
return 0 ;
}
...
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
V_3 -> V_12 -> V_326 = V_326 ;
F_125 ( V_3 -> V_12 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
}
static int F_139 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
const struct V_327 * V_43 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_44 * V_45 = F_20 ( V_3 -> V_12 ) ;
struct V_328 V_329 ;
...
V_329 . V_115 = V_126 -> V_96 ;
V_329 . V_150 = V_330 ;
V_329 . V_43 = F_53 ( V_43 -> V_216 [ V_330 ] . V_331 ) ;
F_36 ( V_332 , & V_329 ) ;
if ( V_10 ) {
F_32 ( V_45 ,
L_53
...
V_329 . V_150 = V_333 ;
V_329 . V_43 = F_53 ( V_43 -> V_216 [ V_333 ] . V_331 ) ;
F_36 ( V_332 , & V_329 ) ;
if ( V_10 ) {
F_32 ( V_45 ,
L_55
...
F_43 ( V_45 , V_90 , L_56 ,
V_43 -> V_216 [ V_330 ] . V_331 ,
V_43 -> V_216 [ V_333 ] . V_331 ) ;
V_244:
return V_10 ;
}
static int F_140 ( struct V_81 * V_36 ,
struct V_334 * V_335 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_55 * V_12 = V_3 -> V_12 ;
struct V_336 * V_337 = & V_12 -> V_338 ;
...
struct V_347 * F_141 ( struct V_2 * V_3 )
{
struct V_347 * V_348 = NULL ;
if ( F_142 ( V_3 -> V_12 ) )
V_348 = (struct V_347 * )
& V_3 -> V_12 -> V_349 . V_350 . V_351 ;
else if ( V_3 -> V_12 -> V_352 . V_353 == V_354 )
V_348 = (struct V_347 * )
& V_3 -> V_12 -> V_349 . V_355 . V_351 ;
else if ( V_3 -> V_12 -> V_352 . V_353 == V_356 )
V_348 = (struct V_347 * )
& V_3 -> V_12 -> V_349 . V_357 . V_351 ;
return V_348 ;
}
static int F_143 ( struct V_81 * V_36 , T_4 * V_358 ,
T_4 * V_359 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_347 * V_348 = F_141 ( V_3 ) ;
if ( V_348 ) {
* V_358 = V_348 -> V_360 ;
* V_359 = V_348 -> V_361 ;
} else {
