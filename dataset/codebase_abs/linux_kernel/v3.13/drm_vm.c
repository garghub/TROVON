...
return V_57 ;
V_42 = ( unsigned long ) V_24 -> V_43 - V_4 -> V_16 ;
V_85 = V_2 -> V_42 - ( unsigned long ) V_30 -> V_84 -> V_87 ;
V_86 = ( V_42 >> V_56 ) + ( V_85 >> V_56 ) ;
V_47 = V_83 -> V_81 [ V_86 ] ;
F_15 ( V_47 ) ;
V_24 -> V_47 = V_47 ;
return 0 ;
...
V_4 -> V_16 , V_4 -> V_17 - V_4 -> V_16 ) ;
F_40 ( & V_30 -> V_65 ) ;
V_88 = F_41 ( sizeof( * V_88 ) , V_89 ) ;
if ( V_88 ) {
V_88 -> V_4 = V_4 ;
V_88 -> V_90 = V_91 -> V_90 ;
F_42 ( & V_88 -> V_54 , & V_30 -> V_92 ) ;
}
}
...
static int F_46 ( struct V_93 * V_94 , struct V_3 * V_4 )
{
struct V_25 * V_26 = V_94 -> V_28 ;
struct V_29 * V_30 ;
struct V_78 * V_79 ;
unsigned long V_95 = V_4 -> V_17 - V_4 -> V_16 ;
V_30 = V_26 -> V_31 -> V_30 ;
V_79 = V_30 -> V_79 ;
F_16 ( L_6 ,
V_4 -> V_16 , V_4 -> V_17 , V_4 -> V_40 ) ;
if ( ! V_79 || ( V_95 >> V_56 ) != V_79 -> F_17 ) {
return - V_96 ;
}
if ( ! F_47 ( V_97 ) &&
( V_79 -> V_10 & V_98 ) ) {
...
{
#ifdef F_13
return V_30 -> V_48 -> V_107 ;
#else
return 0 ;
#endif
}
int F_53 ( struct V_93 * V_94 , struct V_3 * V_4 )
{
struct V_25 * V_26 = V_94 -> V_28 ;
struct V_29 * V_30 = V_26 -> V_31 -> V_30 ;
struct V_1 * V_2 = NULL ;
...
#if V_110
&& ( ! V_30 -> V_37
|| V_30 -> V_37 -> V_111 . V_112 -> V_113 != V_114 )
#endif
)
return F_46 ( V_94 , V_4 ) ;
if ( F_11 ( & V_30 -> V_39 , V_4 -> V_40 , & V_35 ) ) {
F_30 ( L_7 ) ;
return - V_96 ;
}
V_2 = F_12 ( V_35 , struct V_32 , V_35 ) -> V_2 ;
if ( ! V_2 || ( ( V_2 -> V_10 & V_115 ) && ! F_47 ( V_97 ) ) )
return - V_116 ;
if ( V_2 -> V_76 < V_4 -> V_17 - V_4 -> V_16 )
return - V_96 ;
if ( ! F_47 ( V_97 ) && ( V_2 -> V_10 & V_117 ) ) {
V_4 -> V_6 &= ~ ( V_99 | V_100 ) ;
#if F_3 ( V_7 ) || F_3 ( V_8 )
F_6 ( V_4 -> V_101 ) &= ~ V_102 ;
#else
...
F_56 ( F_33 ( V_2 -> V_60 ) ) ,
V_4 -> V_17 - V_4 -> V_16 , V_4 -> V_101 ) )
return - V_119 ;
V_4 -> V_101 = F_8 ( V_2 -> type , V_4 ) ;
case V_71 :
V_4 -> V_103 = & V_120 ;
V_4 -> V_58 = ( void * ) V_2 ;
break;
...
int F_57 ( struct V_93 * V_94 , struct V_3 * V_4 )
{
struct V_25 * V_26 = V_94 -> V_28 ;
struct V_29 * V_30 = V_26 -> V_31 -> V_30 ;
int V_122 ;
