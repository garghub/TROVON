...
V_43 -> V_40 = F_72 ( * V_133 ++ ) ;
V_43 -> V_43 = F_72 ( * V_133 ++ ) ;
V_5 -> V_11 [ V_134 ] = V_43 -> V_40 * V_44 + V_43 -> V_43 ;
V_43 -> V_31 = F_72 ( * V_133 ++ ) ;
V_43 -> V_38 = F_72 ( * V_133 ++ ) ;
F_48 ( V_3 -> V_9 , V_43 ) ;
V_43 ++ ;
}
return 0 ;
...
V_146 -> V_150 = V_147 ;
V_146 -> V_4 = F_78 ( V_27 , L_36 , V_6 + 'A' , V_134 ) ;
V_146 ++ ;
}
}
F_79 ( V_139 , V_3 ) ;
V_3 -> V_151 = F_80 ( & V_149 , & V_139 -> V_9 , V_3 ) ;
if ( ! V_3 -> V_151 ) {
F_11 ( & V_139 -> V_9 , L_37 ) ;
V_88 = - V_15 ;
goto V_152;
...
static void F_93 ( struct V_106 * V_107 , unsigned V_18 ,
int V_158 )
{
struct V_104 * V_155 = F_91 ( V_107 ) ;
void T_1 * V_45 = V_155 -> V_42 ;
...
static void F_97 ( struct V_16 * V_17 , struct V_106 * V_107 )
{
enum V_59 V_165 ;
int V_6 ;
struct V_104 * V_155 = F_91 ( V_107 ) ;
...
{
struct V_104 * V_155 = F_100 ( V_169 ) ;
void T_1 * V_45 = V_155 -> V_42 ;
unsigned V_46 = 1 << V_169 -> V_170 ;
if ( V_45 )
F_22 ( V_46 , V_45 + V_47 ) ;
}
static void F_101 ( struct V_168 * V_169 )
{
struct V_104 * V_155 = F_100 ( V_169 ) ;
void T_1 * V_45 = V_155 -> V_42 ;
unsigned V_46 = 1 << V_169 -> V_170 ;
...
static int F_103 ( struct V_168 * V_169 , unsigned type )
{
struct V_104 * V_155 = F_100 ( V_169 ) ;
void T_1 * V_45 = V_155 -> V_42 ;
unsigned V_46 = 1 << V_169 -> V_170 ;
...
case V_172 :
default:
F_105 ( L_46 , F_106 ( V_169 -> V_175 ) ) ;
return - V_15 ;
}
F_22 ( V_46 , V_45 + V_186 ) ;
return 0 ;
}
static int F_107 ( struct V_168 * V_169 , unsigned V_187 )
{
struct V_104 * V_155 = F_100 ( V_169 ) ;
unsigned V_40 = V_155 -> V_188 ;
unsigned V_46 = 1 << V_169 -> V_170 ;
if ( F_108 ( V_40 >= V_189 ) )
return - V_15 ;
if ( V_187 )
...
static void F_117 ( unsigned V_175 , struct V_196 * V_197 )
{
struct V_198 * V_107 = F_118 ( V_197 ) ;
struct V_168 * V_199 = F_119 ( V_197 ) ;
struct V_104 * V_155 = F_100 ( V_199 ) ;
void T_1 * V_45 = V_155 -> V_42 ;
unsigned long V_200 ;
int V_201 ;
F_120 ( V_107 , V_197 ) ;
for (; ; ) {
V_200 = F_24 ( V_45 + V_202 ) & F_24 ( V_45 + V_194 ) ;
if ( ! V_200 ) {
if ( ! V_155 -> V_203 )
break;
V_155 = V_155 -> V_203 ;
...
F_121 (n, &isr, BITS_PER_LONG) {
F_122 ( F_123 ( V_155 -> V_162 , V_201 ) ) ;
}
}
F_124 ( V_107 , V_197 ) ;
}
static int F_125 ( struct V_204 * V_205 , unsigned int V_161 ,
T_5 V_206 )
{
struct V_104 * V_155 = V_205 -> V_207 ;
void T_1 * V_45 = V_155 -> V_42 ;
T_2 V_46 = 1 << V_206 ;
F_126 ( V_161 , & V_208 ) ;
F_127 ( V_161 , & V_209 ) ;
if ( ( V_155 -> V_91 == & V_210 ) &&
( F_24 ( V_45 + V_211 ) & V_46 ) &&
...
static int F_130 ( struct V_204 * V_169 ,
struct V_19 * V_214 ,
const T_2 * V_215 , unsigned int V_216 ,
T_5 * V_217 ,
unsigned int * V_218 )
{
struct V_104 * V_155 = V_169 -> V_207 ;
int V_88 ;
int V_43 = V_155 -> V_107 . V_109 + V_215 [ 0 ] ;
if ( F_131 ( V_216 < 2 ) )
return - V_15 ;
* V_217 = V_215 [ 0 ] ;
* V_218 = V_215 [ 1 ] & V_219 ;
V_88 = F_132 ( V_43 , V_214 -> V_220 ) ;
if ( V_88 )
return V_88 ;
V_88 = F_133 ( V_43 ) ;
if ( V_88 )
...
static int F_134 ( struct V_19 * V_221 ,
struct V_104 * V_155 )
{
struct V_104 * V_222 = NULL ;
struct V_168 * V_169 = F_135 ( V_155 -> V_191 ) ;
V_155 -> V_223 = F_136 ( V_169 ) ;
V_209 . V_224 = V_155 -> V_91 -> V_225 ;
F_22 ( ~ 0 , V_155 -> V_42 + V_47 ) ;
V_155 -> V_162 = F_137 ( V_221 , V_155 -> V_107 . V_154 ,
& V_226 , V_155 ) ;
if ( ! V_155 -> V_162 )
F_138 ( L_48 ,
V_155 -> V_188 ) ;
if ( V_155 -> V_188 )
V_222 = V_41 [ V_155 -> V_188 - 1 ] ;
if ( V_222 && V_222 -> V_203 == V_155 )
return 0 ;
F_129 ( V_155 -> V_191 , V_155 ) ;
F_139 ( V_155 -> V_191 , F_117 ) ;
return 0 ;
}
static void F_140 ( void )
{
unsigned V_6 ;
struct V_104 * V_155 , * V_227 = NULL ;
for ( V_6 = 0 ; V_6 < V_192 ; V_6 ++ ) {
V_155 = V_41 [ V_6 ] ;
if ( V_227 && V_227 -> V_191 == V_155 -> V_191 )
V_227 -> V_203 = V_155 ;
V_227 = V_155 ;
}
}
...
int V_88 = 0 ;
int V_175 , V_6 ;
int V_230 = F_142 ( V_20 , L_49 ) ;
T_3 V_154 ;
char * * V_231 ;
F_143 ( V_230 >= F_144 ( V_41 ) ) ;
if ( V_41 [ V_230 ] ) {
V_88 = - V_232 ;
goto V_152;
}
...
V_229 = F_146 ( V_139 , V_233 , 0 ) ;
V_105 -> V_42 = F_147 ( & V_139 -> V_9 , V_229 ) ;
if ( F_148 ( V_105 -> V_42 ) ) {
V_88 = F_149 ( V_105 -> V_42 ) ;
goto V_152;
}
V_105 -> V_91 = (struct V_143 * )
F_75 ( V_234 , & V_139 -> V_9 ) -> V_30 ;
V_105 -> V_191 = V_175 ;
V_105 -> V_188 = V_230 ;
V_105 -> clock = F_150 ( & V_139 -> V_9 , NULL ) ;
if ( F_148 ( V_105 -> clock ) ) {
F_11 ( & V_139 -> V_9 , L_50 ) ;
goto V_152;
}
if ( F_115 ( V_105 -> clock ) )
goto V_235;
if ( F_116 ( V_105 -> clock ) ) {
F_11 ( & V_139 -> V_9 , L_51 ) ;
goto V_236;
}
V_105 -> V_107 = V_237 ;
...
V_107 -> V_9 = & V_139 -> V_9 ;
V_107 -> V_238 = V_239 ;
V_107 -> V_109 = V_230 * V_44 ;
if ( ! F_151 ( V_20 , L_52 , & V_154 ) ) {
if ( V_154 >= V_44 )
F_152 ( L_53 ,
V_230 , V_44 , V_44 ) ;
else
...
V_231 = F_12 ( & V_139 -> V_9 , sizeof( char * ) * V_107 -> V_154 ,
V_27 ) ;
if ( ! V_231 ) {
V_88 = - V_28 ;
goto V_236;
...
for ( V_6 = 0 ; V_6 < V_107 -> V_154 ; V_6 ++ )
V_231 [ V_6 ] = F_78 ( V_27 , L_36 , V_230 + 'A' , V_6 ) ;
V_107 -> V_231 = ( const char * const * ) V_231 ;
V_102 = & V_105 -> V_102 ;
V_102 -> V_4 = V_107 -> V_164 ;
V_102 -> V_110 = V_230 ;
V_102 -> V_240 = V_102 -> V_109 = V_102 -> V_110 * V_44 ;
...
goto V_236;
V_41 [ V_230 ] = V_105 ;
V_192 = F_154 ( V_192 , V_230 + 1 ) ;
F_140 () ;
F_134 ( V_20 , V_105 ) ;
F_82 ( & V_139 -> V_9 , L_54 , V_105 -> V_42 ) ;
return 0 ;
V_236:
F_111 ( V_105 -> clock ) ;
V_235:
F_155 ( V_105 -> clock ) ;
V_152:
F_11 ( & V_139 -> V_9 , L_55 , V_88 , V_230 ) ;
return V_88 ;
}
