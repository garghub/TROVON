...
V_2 = F_29 ( V_2 , 0x11 ) ;
F_13 ( & V_17 -> V_19 ) ;
V_17 -> V_36 [ V_14 ] = V_2 * 0x11 ;
V_2 |= F_4 ( V_5 , V_37 [ V_14 ] ) & 0xf0 ;
...
static T_2
F_31 ( struct V_8 * V_9 , struct V_10 * V_11 , char * V_12 )
{
int V_14 = F_9 ( V_11 ) -> V_15 ;
struct V_16 * V_17 = F_18 ( V_9 ) ;
...
static int
F_33 ( struct V_4 * V_5 , struct V_44 * V_45 )
{
...
F_36 ( V_45 -> type , L_6 , V_57 ) ;
return 0 ;
}
static int
F_37 ( struct V_4 * V_5 , const struct V_58 * V_59 )
{
struct V_8 * V_9 = & V_5 -> V_9 ;
struct V_16 * V_17 ;
int V_3 , V_18 = 0 ;
T_1 V_60 ;
V_17 = F_38 ( & V_5 -> V_9 , sizeof( struct V_16 ) ,
V_61 ) ;
if ( ! V_17 )
return - V_62 ;
F_39 ( V_5 , V_17 ) ;
