...
return V_17 ;
V_47 -> V_83 = V_84 ;
if ( ! F_33 ( & V_2 -> V_85 . V_61 ) ||
V_2 -> V_8 != V_9 ) {
F_6 ( & V_2 -> V_20 -> V_2 ,
L_22 , V_2 -> V_8 ) ;
F_6 ( & V_2 -> V_20 -> V_2 , L_23 ) ;
F_30 ( & V_47 -> V_61 , & V_2 -> V_85 . V_61 ) ;
return 0 ;
}
...
T_5 * V_92 , struct V_37 * V_93 )
{
struct V_1 * V_2 = V_14 -> V_2 ;
struct V_68 V_69 ;
T_2 V_94 = V_2 -> V_4 - V_2 -> V_5 ;
T_6 V_95 = F_39 ( V_94 ) ;
int V_45 ;
V_45 = F_26 ( V_14 ) ;
if ( V_45 < 0 )
...
V_69 . V_43 = V_94 ;
V_69 . V_74 = 1 ;
} else if ( * V_92 == V_2 -> V_96 ) {
V_95 = * V_92 ;
V_94 = ( * V_92 * sizeof( T_6 ) ) - sizeof( struct V_68 ) ;
V_69 . V_43 = V_94 ;
V_69 . V_74 = 0 ;
} else {
return 0 ;
}
F_6 ( & V_2 -> V_20 -> V_2 , V_97 , F_41 ( & V_69 ) ) ;
* V_92 -= V_95 ;
V_45 = F_28 ( V_2 , & V_69 ,
V_2 -> V_27 + V_2 -> V_5 ) ;
if ( V_45 ) {
...
F_44 ( V_2 -> V_8 != V_100 ) ;
V_99 = V_2 -> V_27 + V_2 -> V_5 ;
F_44 ( V_2 -> V_24 < V_2 -> V_5 + V_69 -> V_43 ) ;
F_45 ( V_2 , V_99 , V_69 -> V_43 ) ;
V_2 -> V_5 += V_69 -> V_43 ;
if ( ! V_69 -> V_74 )
return 0 ;
...
F_30 ( & V_47 -> V_61 , & V_98 -> V_61 ) ;
}
return 0 ;
}
int F_46 ( struct V_1 * V_2 , T_5 * V_92 )
{
T_6 V_95 = F_39 ( sizeof( struct V_101 ) ) ;
if ( * V_92 < V_95 )
return - V_102 ;
* V_92 -= V_95 ;
...
{
bool V_109 = false ;
F_51 ( V_2 , V_38 , & V_2 -> V_85 . V_61 ) ;
if ( F_51 ( V_2 , V_38 , & V_2 -> V_104 . V_61 ) )
V_109 = true ;
F_51 ( V_2 , V_38 , & V_2 -> V_110 . V_61 ) ;
if ( F_51 ( V_2 , V_38 , & V_2 -> V_111 . V_61 ) )
V_109 = true ;
if ( F_51 ( V_2 , V_38 , & V_2 -> V_81 . V_61 ) )
V_109 = true ;
