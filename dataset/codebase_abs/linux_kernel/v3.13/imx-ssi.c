...
V_132 = F_44 ( & V_153 ) ;
if ( V_132 != 0 ) {
F_37 ( & V_126 -> V_100 , L_6 , V_132 ) ;
goto V_140;
}
V_132 = F_45 ( & V_126 -> V_100 , & V_154 ,
V_78 , 1 ) ;
if ( V_132 ) {
F_37 ( & V_126 -> V_100 , L_7 ) ;
goto V_140;
}
V_8 -> V_155 . V_136 = V_8 -> V_136 ;
V_8 -> V_155 . V_10 = V_8 -> V_10 ;
V_8 -> V_155 . V_104 = & V_8 -> V_104 ;
V_8 -> V_155 . V_102 = & V_8 -> V_102 ;
V_8 -> V_156 = F_46 ( V_126 , & V_8 -> V_155 ) ;
V_8 -> V_157 = F_47 ( V_126 ) ;
if ( V_8 -> V_156 && V_8 -> V_157 ) {
V_132 = V_8 -> V_156 ;
goto V_158;
}
return 0 ;
