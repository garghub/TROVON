...
F_9 ( V_4 ) ;
F_18 ( V_4 , V_74 -> V_65 , V_74 -> V_66 ) ;
}
static T_3 F_20 ( struct V_75 * V_64 ,
struct V_76 * V_77 ,
char * V_78 , int V_79 )
{
struct V_1 * V_2 = F_21 ( F_22 ( V_64 ) ) ;
...
static T_3 F_23 ( struct V_75 * V_64 ,
struct V_76 * V_77 ,
...
static int F_26 ( const char * V_78 , T_4 * V_89 , T_2 V_85 )
{
T_4 V_90 = 0 ;
int V_39 ;
V_85 = F_27 ( int , V_85 , V_40 ) ;
...
static T_3 F_30 ( struct V_75 * V_64 ,
struct V_76 * V_77 ,
char * V_78 , int V_79 )
{
struct V_1 * V_2 = F_21 ( F_22 ( V_64 ) ) ;
struct V_7 * V_4 = V_2 -> V_4 ;
char V_89 [ V_40 + 1 ] ;
F_28 ( V_4 -> V_81 [ V_79 - 1 ] . V_91 , V_89 ) ;
return sprintf ( V_78 , L_13 , V_89 ) ;
}
static int F_31 ( struct V_7 * V_4 , T_4 V_89 , int V_79 )
{
struct V_86 * V_87 = & V_4 -> V_81 [ V_79 - 1 ] ;
int V_8 ;
T_1 V_94 [] = {
...
static T_3 F_32 ( struct V_75 * V_64 ,
struct V_76 * V_77 ,
const char * V_78 , T_2 V_85 , int V_79 )
{
struct V_1 * V_2 = F_21 ( F_22 ( V_64 ) ) ;
