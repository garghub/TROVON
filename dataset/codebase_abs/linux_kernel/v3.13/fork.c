...
struct V_50 * F_165 ( struct V_5 * V_6 )
{
...
static void F_198 ( unsigned long V_158 , struct V_5 * V_111 )
{
...
static void F_199 ( struct V_5 * V_111 )
{
F_200 ( & V_111 -> V_220 ) ;
#ifdef F_201
F_202 ( & V_111 -> V_221 ) ;
...
static inline void
F_204 ( struct V_5 * V_137 , enum V_226 type , struct V_227 * V_227 )
{
V_137 -> V_228 [ type ] . V_227 = V_227 ;
}
...
if ( V_199 >= V_32 )
goto V_252;
if ( ! F_168 ( F_215 ( V_111 ) -> V_253 -> V_133 ) )
goto V_252;
V_111 -> V_254 = 0 ;
F_216 ( V_111 ) ;
F_198 ( V_158 , V_111 ) ;
...
V_111 -> V_150 = ( V_158 & V_315 ) ? V_231 : NULL ;
#ifdef F_176
V_111 -> V_316 = NULL ;
#endif
#ifdef F_156
...
F_252 () ;
if ( F_253 ( V_28 ) ) {
F_132 ( & V_28 -> V_187 -> V_335 ) ;
F_254 ( & V_1 ) ;
V_61 = - V_336 ;
goto V_337;
}
if ( F_107 ( V_111 -> V_227 ) ) {
F_255 ( V_111 , ( V_158 & V_338 ) || V_232 ) ;
F_204 ( V_111 , V_339 , V_227 ) ;
if ( F_256 ( V_111 ) ) {
F_204 ( V_111 , V_340 , F_257 ( V_28 ) ) ;
F_204 ( V_111 , V_341 , F_258 ( V_28 ) ) ;
if ( F_259 ( V_227 ) ) {
F_260 ( V_227 ) -> V_342 = V_111 ;
V_111 -> signal -> V_115 |= V_237 ;
}
V_111 -> signal -> V_343 = V_227 ;
V_111 -> signal -> V_344 = F_261 ( V_28 -> signal -> V_344 ) ;
F_262 ( & V_111 -> V_256 , & V_111 -> V_332 -> V_255 ) ;
F_263 ( & V_111 -> V_345 , & V_34 . V_345 ) ;
F_264 ( V_111 , V_340 ) ;
F_264 ( V_111 , V_341 ) ;
F_265 ( V_4 ) ;
} else {
...
{
struct V_5 * V_137 ;
V_137 = F_205 ( V_165 , 0 , 0 , NULL , & V_312 , 0 ) ;
if ( ! F_229 ( V_137 ) ) {
F_281 ( V_137 -> V_228 ) ;
F_284 ( V_137 , V_2 ) ;
}
...
V_232 = V_357 ;
if ( F_107 ( ! F_286 ( V_28 , V_232 ) ) )
V_232 = 0 ;
}
V_111 = F_205 ( V_158 , V_229 , V_230 ,
V_231 , NULL , V_232 ) ;
if ( ! F_229 ( V_111 ) ) {
struct V_142 V_143 ;
F_287 ( V_28 , V_111 ) ;
