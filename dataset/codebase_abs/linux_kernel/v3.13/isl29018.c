...
static bool F_30 ( struct V_44 * V_23 , unsigned int V_72 )
{
switch ( V_72 ) {
case V_25 :
case V_26 :
...
struct V_48 * V_49 ;
int V_77 ;
V_49 = F_32 ( & V_74 -> V_23 , sizeof( * V_2 ) ) ;
if ( V_49 == NULL ) {
F_7 ( & V_74 -> V_23 , L_17 ) ;
return - V_78 ;
}
...
{
struct V_48 * V_49 = F_40 ( V_74 ) ;
F_41 ( & V_74 -> V_23 , L_20 , V_89 ) ;
F_42 ( V_49 ) ;
return 0 ;
}
static int F_43 ( struct V_44 * V_23 )
{
struct V_1 * V_2 = F_16 ( F_44 ( V_23 ) ) ;
F_19 ( & V_2 -> V_52 ) ;
V_2 -> V_63 = true ;
F_20 ( & V_2 -> V_52 ) ;
return 0 ;
