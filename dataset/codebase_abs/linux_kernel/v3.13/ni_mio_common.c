...
struct V_9 * V_10 = V_5 -> V_11 ;
int V_163 ;
V_163 = F_163 ( V_5 , V_100 , V_247 , V_71 , 0 ) ;
if ( V_163 )
return V_163 ;
V_10 -> V_507 &= ~ V_508 ;
V_10 -> V_507 |= F_164 ( V_100 -> V_509 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_507 , V_510 ) ;
return V_247 -> V_168 ;
}
...
{
struct V_9 * V_10 = V_5 -> V_11 ;
if ( ( V_71 [ 0 ] & ( V_511 | V_512 ) ) && V_10 -> V_513 )
return - V_42 ;
if ( F_166 ( V_100 , V_71 ) ) {
V_10 -> V_514 &= ~ V_515 ;
V_10 -> V_514 |= F_167 ( V_100 -> V_516 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_514 ,
V_517 ) ;
}
V_71 [ 1 ] = V_10 -> V_73 ( V_5 , V_518 ) ;
return V_247 -> V_168 ;
}
...
static int F_172 ( struct V_4 * V_5 , struct V_99 * V_100 )
{
struct V_9 * V_10 V_197 = V_5 -> V_11 ;
const struct V_170 * V_171 = & V_100 -> V_103 -> V_171 ;
...
F_33 ( V_523 , V_529 ) ;
if ( V_100 -> V_509 ) {
F_33 ( V_100 -> V_516 , V_530 ) ;
F_33 ( V_531 , V_527 ) ;
F_33 ( V_100 -> V_509 , V_532 ) ;
} else {
F_19 ( V_5 ,
L_38 ) ;
return - V_208 ;
...
V_100 -> V_103 -> V_389 = & V_533 ;
return 0 ;
}
static int V_533 ( struct V_4 * V_5 , struct V_99 * V_100 ,
unsigned int V_391 )
{
#ifdef F_24
struct V_9 * V_10 = V_5 -> V_11 ;
...
V_71 [ 1 ] = V_554 ;
V_10 -> V_513 = V_71 [ 1 ] ;
} else if ( V_71 [ 1 ] <= V_556 ) {
V_10 -> V_507 &= ~ V_557 ;
V_10 -> V_558 |= V_559 ;
V_10 -> V_558 &= ~ V_560 ;
V_71 [ 1 ] = V_556 ;
V_10 -> V_513 = V_71 [ 1 ] ;
} else if ( V_71 [ 1 ] <= V_561 ) {
V_10 -> V_507 &= ~ V_557 ;
V_10 -> V_558 |= V_559 |
V_560 ;
V_71 [ 1 ] = V_561 ;
V_10 -> V_513 = V_71 [ 1 ] ;
} else if ( V_71 [ 1 ] <= V_562 ) {
V_10 -> V_507 |= V_557 ;
V_10 -> V_558 |= V_559 |
V_560 ;
V_71 [ 1 ] = V_562 ;
...
V_10 -> V_16 ( V_5 , V_10 -> V_507 ,
V_510 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_558 ,
V_563 ) ;
return 1 ;
break;
case V_564 :
...
V_549 = V_71 [ 1 ] & 0xFF ;
if ( V_10 -> V_552 ) {
V_175 = F_175 ( V_5 , V_100 , V_549 ,
& V_550 ) ;
} else if ( V_10 -> V_513 > 0 ) {
V_175 = F_176 ( V_5 , V_100 , V_549 ,
& V_550 ) ;
} else {
F_6 ( L_42 ) ;
return - V_392 ;
...
#endif
V_10 -> V_514 &= ~ V_568 ;
V_10 -> V_514 |= F_177 ( V_565 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_514 , V_517 ) ;
V_567 = V_10 -> V_73 ( V_5 , V_569 ) ;
if ( V_567 & V_570 ) {
V_175 = - V_42 ;
goto Error;
}
...
static void F_180 ( struct V_4 * V_5 , struct V_99 * V_100 )
{
int V_106 ;
for ( V_106 = 0 ; V_106 < V_100 -> V_257 ; V_106 ++ ) {
...
static unsigned F_181 ( enum V_576 V_6 )
{
unsigned V_577 ;
switch ( V_6 ) {
case V_578 :
...
static void F_190 ( struct V_605 * V_606 , unsigned V_72 ,
enum V_576 V_6 )
{
struct V_4 * V_5 = V_606 -> V_52 -> V_5 ;
struct V_9 * V_10 = V_5 -> V_11 ;
unsigned V_577 ;
static const unsigned V_607 = V_608 | V_609 ;
...
default:
V_577 = F_181 ( V_6 ) ;
V_10 -> V_16 ( V_5 , V_72 , V_577 ) ;
}
}
static unsigned F_191 ( struct V_605 * V_606 ,
enum V_576 V_6 )
{
struct V_4 * V_5 = V_606 -> V_52 -> V_5 ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
case V_585 :
V_577 = F_181 ( V_6 ) ;
return V_10 -> V_636 ( V_5 , V_577 ) ;
break;
default:
V_577 = F_181 ( V_6 ) ;
return V_10 -> V_73 ( V_5 , V_577 ) ;
break;
}
return 0 ;
}
...
switch ( V_71 [ 0 ] ) {
case V_646 :
return F_195 ( V_5 , V_71 [ 1 ] ) ;
break;
case V_647 :
F_196 ( V_5 , & V_71 [ 1 ] , & V_71 [ 2 ] ) ;
return 3 ;
default:
break;
}
...
static int F_201 ( int V_43 , int V_649 , int V_71 , unsigned long V_650 )
{
struct V_4 * V_5 = (struct V_4 * ) V_650 ;
struct V_9 * V_10 V_197 = V_5 -> V_11 ;
if ( V_43 ) {
F_5 ( V_71 , V_651 + 2 * V_649 ) ;
return 0 ;
} else {
return F_90 ( V_651 + 2 * V_649 ) ;
}
}
...
struct V_246 * V_247 , unsigned int * V_71 )
{
V_71 [ 0 ] = F_203 ( V_5 , F_111 ( V_247 -> V_251 ) ) ;
return 1 ;
}
static int F_203 ( struct V_4 * V_5 , int V_74 )
{
struct V_9 * V_10 V_197 = V_5 -> V_11 ;
int V_652 ;
int V_653 ;
V_653 = 0x0300 | ( ( V_74 & 0x100 ) << 3 ) | ( V_74 & 0xff ) ;
F_5 ( 0x04 , V_654 ) ;
for ( V_652 = 0x8000 ; V_652 ; V_652 >>= 1 ) {
F_5 ( 0x04 | ( ( V_652 & V_653 ) ? 0x02 : 0 ) ,
V_654 ) ;
F_5 ( 0x05 | ( ( V_652 & V_653 ) ? 0x02 : 0 ) ,
V_654 ) ;
}
V_653 = 0 ;
for ( V_652 = 0x80 ; V_652 ; V_652 >>= 1 ) {
F_5 ( 0x04 , V_654 ) ;
F_5 ( 0x05 , V_654 ) ;
V_653 |= ( ( F_90 ( V_198 ) & V_655 ) ? V_652 : 0 ) ;
}
F_5 ( 0x00 , V_654 ) ;
return V_653 ;
}
...
{
struct V_9 * V_10 = V_5 -> V_11 ;
V_71 [ 0 ] = V_10 -> V_656 [ F_111 ( V_247 -> V_251 ) ] ;
return 1 ;
}
static int F_205 ( struct V_4 * V_5 , unsigned int * V_71 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
V_71 [ 1 ] = V_10 -> V_657 * V_10 -> V_310 ;
V_71 [ 2 ] = V_10 -> V_658 * V_10 -> V_310 ;
return 3 ;
}
...
if ( V_659 * V_10 -> V_310 != V_71 [ 2 ] ||
V_660 * V_10 -> V_310 != V_71 [ 4 ] ) {
V_71 [ 2 ] = V_659 * V_10 -> V_310 ;
V_71 [ 4 ] = V_660 * V_10 -> V_310 ;
return - V_407 ;
}
F_33 ( F_207 ( V_659 ) |
F_208 ( V_660 ) ,
...
struct V_246 * V_247 , unsigned int * V_71 )
{
F_211 ( V_5 , F_111 ( V_247 -> V_251 ) , V_71 [ 0 ] ) ;
return 1 ;
}
...
{
struct V_9 * V_10 = V_5 -> V_11 ;
V_71 [ 0 ] = V_10 -> V_666 [ F_111 ( V_247 -> V_251 ) ] ;
return 1 ;
}
static void F_213 ( struct V_4 * V_5 , struct V_99 * V_100 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
int V_106 , V_667 ;
...
if ( type == V_672 )
return;
V_669 = V_666 [ type ] . V_669 ;
for ( V_106 = 0 ; V_106 < 3 ; V_106 ++ ) {
type = V_59 -> V_671 [ V_106 ] ;
if ( type == V_672 )
break;
if ( V_666 [ type ] . V_669 != V_669 )
V_670 = 1 ;
V_410 += V_666 [ type ] . V_410 ;
}
V_668 = V_106 ;
V_100 -> V_257 = V_410 ;
if ( V_670 ) {
...
V_100 -> V_673 = V_673 = V_10 -> V_675 ;
V_172 = 0 ;
for ( V_106 = 0 ; V_106 < V_668 ; V_106 ++ ) {
type = V_59 -> V_671 [ V_106 ] ;
for ( V_667 = 0 ; V_667 < V_666 [ type ] . V_410 ; V_667 ++ ) {
V_673 [ V_172 ] =
( 1 << V_666 [ type ] . V_669 ) - 1 ;
V_172 ++ ;
}
}
for ( V_172 = 0 ; V_172 < V_100 -> V_257 ; V_172 ++ )
F_211 ( V_5 , V_106 , V_100 -> V_673 [ V_106 ] / 2 ) ;
} else {
type = V_59 -> V_671 [ 0 ] ;
V_100 -> V_676 = ( 1 << V_666 [ type ] . V_669 ) - 1 ;
for ( V_172 = 0 ; V_172 < V_100 -> V_257 ; V_172 ++ )
F_211 ( V_5 , V_106 , V_100 -> V_676 / 2 ) ;
}
}
static void F_211 ( struct V_4 * V_5 , int V_74 , int V_677 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
unsigned int V_678 = 0 , V_72 = 0 , V_652 , V_653 = 0 ;
int V_106 ;
int type ;
if ( V_10 -> V_666 [ V_74 ] == V_677 )
return;
V_10 -> V_666 [ V_74 ] = V_677 ;
for ( V_106 = 0 ; V_106 < 3 ; V_106 ++ ) {
type = V_59 -> V_671 [ V_106 ] ;
if ( type == V_672 )
break;
if ( V_74 < V_666 [ type ] . V_410 ) {
V_72 = V_666 [ type ] . F_214 ( V_74 , V_677 , & V_653 ) ;
V_678 = F_215 ( V_106 ) ;
break;
}
V_74 -= V_666 [ type ] . V_410 ;
}
for ( V_652 = 1 << ( V_72 - 1 ) ; V_652 ; V_652 >>= 1 ) {
F_5 ( ( ( V_652 & V_653 ) ? 0x02 : 0 ) , V_654 ) ;
F_60 ( 1 ) ;
F_5 ( 1 | ( ( V_652 & V_653 ) ? 0x02 : 0 ) , V_654 ) ;
F_60 ( 1 ) ;
}
F_5 ( V_678 , V_654 ) ;
F_60 ( 1 ) ;
...
static int F_216 ( int V_74 , int V_677 , int * V_653 )
{
V_74 ++ ;
* V_653 = ( ( V_74 & 0x1 ) << 11 ) |
( ( V_74 & 0x2 ) << 9 ) |
( ( V_74 & 0x4 ) << 7 ) | ( ( V_74 & 0x8 ) << 5 ) | ( V_677 & 0xff ) ;
return 12 ;
}
static int F_217 ( int V_74 , int V_677 , int * V_653 )
{
* V_653 = ( ( V_74 & 0x7 ) << 8 ) | ( V_677 & 0xff ) ;
return 11 ;
}
static int F_218 ( int V_74 , int V_677 , int * V_653 )
{
* V_653 = V_677 & 0xfff ;
return 12 ;
}
static int F_219 ( int V_74 , int V_677 , int * V_653 )
{
* V_653 = ( V_677 & 0xfff ) | ( V_74 ? 0xc000 : 0xa000 ) ;
return 16 ;
}
static int F_220 ( int V_74 , int V_677 , int * V_653 )
{
* V_653 = ( ( V_74 & 0xf ) << 8 ) | ( V_677 & 0xff ) ;
return 12 ;
}
static int F_221 ( int V_74 , int V_677 , int * V_653 )
{
* V_653 = ( ( V_74 + 1 ) << 8 ) | ( V_677 & 0xff ) ;
return 12 ;
}
...
struct V_246 * V_247 , unsigned int * V_71 )
{
struct V_605 * V_606 = V_100 -> V_11 ;
return F_223 ( V_606 , V_247 , V_71 ) ;
}
...
{
struct V_605 * V_606 = V_100 -> V_11 ;
return F_227 ( V_606 , V_247 , V_71 ) ;
}
static int F_228 ( struct V_4 * V_5 , struct V_99 * V_100 )
{
int V_194 ;
struct V_605 * V_606 = V_100 -> V_11 ;
V_194 = F_21 ( V_5 , V_606 -> V_1 ,
V_44 ) ;
if ( V_194 ) {
F_19 ( V_5 ,
L_50 ) ;
...
F_229 ( V_606 , NULL , NULL , NULL , NULL ) ;
F_30 ( V_5 , V_606 -> V_1 , 1 ) ;
V_194 = F_230 ( V_606 , V_100 -> V_103 ) ;
return V_194 ;
}
...
static int F_234 ( struct V_4 * V_5 , unsigned V_172 ,
unsigned V_680 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
unsigned V_681 ;
...
unsigned V_680 )
{
if ( V_680 != F_239 ( V_5 , V_172 ) )
return - V_392 ;
return 2 ;
}
static int F_240 ( struct V_4 * V_5 , unsigned V_172 ,
unsigned V_680 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_59 -> V_60 & V_61 )
return F_234 ( V_5 , V_172 , V_680 ) ;
else
return F_238 ( V_5 , V_172 , V_680 ) ;
}
static unsigned F_241 ( struct V_4 * V_5 ,
unsigned V_172 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
const unsigned V_682 = V_172 / 3 ;
return F_242 ( V_172 ,
V_10 ->
V_683
[ V_682 ] ) ;
}
static unsigned F_239 ( struct V_4 * V_5 , unsigned V_172 )
{
switch ( V_172 ) {
case 0 :
return V_684 ;
...
static unsigned F_243 ( struct V_4 * V_5 , unsigned V_172 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_59 -> V_60 & V_61 )
return F_241 ( V_5 , V_172 ) ;
else
return F_239 ( V_5 , V_172 ) ;
}
static int F_244 ( struct V_4 * V_5 , unsigned V_694 ,
enum V_695 V_696 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 V_197 = V_5 -> V_11 ;
...
break;
case V_701 :
return F_240 ( V_5 , V_172 , V_71 [ 1 ] ) ;
break;
case V_702 :
V_71 [ 1 ] = F_243 ( V_5 , V_172 ) ;
break;
case V_703 :
return F_244 ( V_5 , V_172 , V_71 [ 1 ] ) ;
break;
default:
return - V_392 ;
}
...
static int F_253 ( unsigned V_719 ,
unsigned * V_720 ,
unsigned * V_721 ,
unsigned * V_722 )
{
unsigned div ;
unsigned V_723 = 1 ;
static const unsigned V_724 = 0x10 ;
unsigned V_725 ;
unsigned V_726 = 1 ;
static const unsigned V_727 = 0x100 ;
static const unsigned V_728 = 1000 ;
const unsigned V_729 = V_719 * V_728 ;
static const unsigned V_730 = 12500 ;
static const unsigned V_731 = 4 ;
int V_732 = 0 ;
for ( div = 1 ; div <= V_724 ; ++ div ) {
for ( V_725 = 1 ; V_725 <= V_727 ; ++ V_725 ) {
unsigned V_733 =
( V_729 * div ) / V_725 ;
if ( abs ( V_733 - V_730 ) <
abs ( V_732 - V_730 ) ) {
...
static inline unsigned F_254 ( struct V_4 * V_5 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_59 -> V_60 & V_61 )
return 8 ;
...
unsigned V_680 , unsigned V_734 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
static const unsigned V_735 = 50 ;
static const unsigned V_736 = 1000 ;
...
{
unsigned V_750 ;
static const unsigned V_751 = 7 ;
for ( V_750 = 0 ; V_750 <= V_751 ;
++ V_750 ) {
if ( V_680 ==
F_256 ( V_750 ) ) {
V_10 -> V_704 |=
...
static int F_250 ( struct V_4 * V_5 , unsigned V_680 ,
unsigned V_734 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
static int F_260 ( struct V_4 * V_5 , unsigned V_172 ,
unsigned V_680 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_172 >= F_254 ( V_5 ) ) {
...
static int F_261 ( struct V_4 * V_5 , unsigned V_172 ,
unsigned V_680 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
if ( F_260 ( V_5 , V_172 , V_680 ) == 0 )
return - V_392 ;
if ( V_172 < 4 ) {
V_10 -> V_707 &= ~ F_262 ( V_172 ) ;
V_10 -> V_707 |=
F_251 ( V_172 , V_680 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_707 ,
V_712 ) ;
} else if ( V_172 < 8 ) {
V_10 -> V_713 &= ~ F_262 ( V_172 ) ;
V_10 -> V_713 |=
F_251 ( V_172 , V_680 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_713 ,
V_718 ) ;
...
static unsigned F_263 ( struct V_4 * V_5 , unsigned V_172 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
if ( V_172 < 4 ) {
return F_264 ( V_172 ,
V_10 -> V_707 ) ;
} else if ( V_172 < F_254 ( V_5 ) ) {
return F_264 ( V_172 ,
V_10 -> V_713 ) ;
} else {
if ( V_172 == V_758 )
...
break;
case V_646 :
return F_250 ( V_5 , V_71 [ 1 ] , V_71 [ 2 ] ) ;
break;
case V_647 :
V_71 [ 1 ] = V_10 -> V_639 ;
V_71 [ 2 ] = V_10 -> V_310 ;
...
break;
case V_701 :
return F_261 ( V_5 , V_172 , V_71 [ 1 ] ) ;
break;
case V_702 :
V_71 [ 1 ] = F_263 ( V_5 , V_172 ) ;
return 2 ;
break;
default:
return - V_392 ;
...
const int V_105 = V_764 ;
int V_106 ;
for ( V_106 = 0 ; V_106 < V_105 ; V_106 ++ ) {
V_130 = F_41 ( V_5 , V_765 ) ;
if ( ( V_130 & V_766 ) == 0 ) {
break;
}
F_268 ( V_767 ) ;
...
if ( V_106 == V_105 ) {
F_6 ( L_60 , __FILE__ , V_25 ) ;
return - V_255 ;
}
return 0 ;
}
static void F_270 ( struct V_4 * V_5 , unsigned short V_78 )
{
static const int V_105 = 100 ;
int V_106 ;
F_38 ( V_5 , V_78 , V_768 ) ;
for ( V_106 = 0 ; V_106 < V_105 ; V_106 ++ ) {
if ( ( F_41 ( V_5 , V_765 ) & V_766 ) )
break;
F_60 ( 1 ) ;
}
if ( V_106 == V_105 ) {
...
static void F_271 ( struct V_4 * V_5 , unsigned int V_78 ,
unsigned int V_769 )
{
...
V_771 ) ;
V_769 &= V_772 ;
F_270 ( V_5 , V_773 | V_769 ) ;
if ( F_267 ( V_5 ) )
F_19 ( V_5 , L_62 ) ;
}
static unsigned int F_272 ( struct V_4 * V_5 ,
unsigned int V_769 )
{
unsigned int V_78 ;
V_769 &= V_772 ;
F_270 ( V_5 , V_773 | V_774 | V_769 ) ;
if ( F_267 ( V_5 ) )
F_19 ( V_5 , L_63 ) ;
V_78 = ( F_41 ( V_5 ,
V_770 ) << 16 ) &
0xff0000 ;
V_78 |= F_41 ( V_5 , V_771 ) & 0xffff ;
return V_78 ;
}
static int F_273 ( struct V_4 * V_5 , unsigned short * V_71 )
{
int V_194 ;
unsigned short V_130 ;
F_270 ( V_5 , V_773 | V_775 ) ;
V_194 = F_267 ( V_5 ) ;
if ( V_194 ) {
F_19 ( V_5 ,
L_64 ) ;
...
static int F_274 ( struct V_4 * V_5 ,
struct V_99 * V_100 ,
struct V_246 * V_247 , unsigned int * V_71 )
{
int V_168 , V_194 ;
...
V_780 = F_111 ( V_247 -> V_251 ) ;
F_38 ( V_5 , V_780 , V_782 ) ;
for ( V_168 = 0 ; V_168 < V_247 -> V_168 ; V_168 ++ ) {
V_194 = F_273 ( V_5 , & V_779 ) ;
if ( V_194 < 0 )
return V_194 ;
V_71 [ V_168 ] = V_779 ;
}
...
V_783 | V_784 ;
#if 1
F_271 ( V_5 , V_278 | V_785 ,
V_786 ) ;
F_273 ( V_5 , NULL ) ;
#else
F_271 ( V_5 , 0x400000 , V_787 ) ;
F_271 ( V_5 , V_278 | V_788 ,
V_786 ) ;
if ( F_267 ( V_5 ) )
F_19 ( V_5 , L_67 ) ;
#endif
