...
void F_20 ( struct V_18 * V_19 , T_5 clock )
{
struct V_20 * V_21 = V_19 -> V_21 ;
struct V_22 * V_23 = V_21 -> V_24 ;
struct V_26 * V_26 = F_8 ( V_19 ) ;
...
F_41 ( 2 ) ) ;
F_9 ( V_142 + V_30 , 0 ) ;
V_122 = F_42 ( & V_40 , V_118 ) ;
if ( V_122 < 0 ) {
F_26 ( L_7 , V_122 ) ;
return;
}
V_122 = F_43 ( & V_40 , V_38 , sizeof( V_38 ) ) ;
if ( V_122 < 0 ) {
F_26 ( L_8 , V_122 ) ;
return;
}
...
F_9 ( V_143 + V_30 , 0x00FFFFFF ) ;
F_9 ( V_144 + V_30 , 0x007FFFFF ) ;
F_9 ( V_145 + V_30 , 0x00000001 ) ;
...
struct V_26 * V_26 = F_8 ( V_19 ) ;
struct V_27 * V_28 = V_26 -> V_29 ;
struct V_147 V_148 = F_45 ( V_23 ) ;
T_4 V_38 [ V_119 + V_149 ] ;
struct V_150 V_40 ;
T_1 V_30 ;
T_1 V_151 ;
T_7 V_122 ;
...
F_4 ( L_9 ,
F_15 ( V_19 ) ? L_10 : L_11 ,
V_148 . V_115 , V_148 . V_152 , V_148 . V_153 ) ;
F_4 ( L_12 ,
( int ) V_148 . V_154 , ( int ) V_148 . V_155 ) ;
V_151 = 0 ;
if ( V_148 . V_154 & V_156 )
V_151 |= 1 << 0 ;
if ( V_148 . V_154 & V_157 )
V_151 |= 1 << 1 ;
if ( V_148 . V_154 & V_158 )
V_151 |= 1 << 2 ;
if ( V_148 . V_154 & V_159 )
V_151 |= 1 << 3 ;
V_151 |= F_46 ( V_148 . V_155 ) ;
switch ( V_148 . V_152 ) {
case 32000 :
V_151 |= F_47 ( 0x3 ) ;
break;
...
if ( V_148 . V_154 & V_161 )
V_151 |= 0x5 << 16 ;
F_19 ( V_162 + V_30 , V_151 , ~ 0x5000f ) ;
V_122 = F_49 ( & V_40 ) ;
if ( V_122 < 0 ) {
F_26 ( L_13 ) ;
return;
}
V_40 . V_115 = V_148 . V_115 ;
V_122 = F_50 ( & V_40 , V_38 , sizeof( V_38 ) ) ;
if ( V_122 < 0 ) {
F_26 ( L_14 ) ;
return;
}
...
void F_51 ( struct V_18 * V_19 , bool V_163 )
{
struct V_20 * V_21 = V_19 -> V_21 ;
struct V_22 * V_23 = V_21 -> V_24 ;
struct V_26 * V_26 = F_8 ( V_19 ) ;
...
if ( ! V_28 || ! V_28 -> V_31 )
return;
if ( V_163 && V_28 -> V_31 -> V_51 )
return;
if ( ! V_163 && ! V_28 -> V_31 -> V_51 )
return;
if ( V_163 )
V_28 -> V_31 -> V_166 = F_52 ( V_23 ) ;
else
V_28 -> V_31 -> V_166 = NULL ;
if ( ! F_53 ( V_23 ) ) {
if ( V_163 )
V_164 |= V_167 ;
switch ( V_26 -> V_168 ) {
...
F_9 ( V_183 + V_28 -> V_31 -> V_30 , V_164 ) ;
}
if ( V_23 -> V_184 . V_185 ) {
if ( V_163 )
F_58 ( V_23 , V_28 -> V_31 -> V_186 ) ;
else
F_59 ( V_23 , V_28 -> V_31 -> V_186 ) ;
}
V_28 -> V_31 -> V_51 = V_163 ;
F_4 ( L_16 ,
V_163 ? L_17 : L_18 , V_28 -> V_31 -> V_30 , V_26 -> V_168 ) ;
}
