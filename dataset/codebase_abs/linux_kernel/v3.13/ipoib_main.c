...
if ( F_98 ( V_101 -> V_102 [ 4 ] == 0xff ) ) {
if ( ( V_105 -> V_107 != F_99 ( V_108 ) ) &&
( V_105 -> V_107 != F_99 ( V_109 ) ) &&
( V_105 -> V_107 != F_99 ( V_110 ) ) &&
( V_105 -> V_107 != F_99 ( V_111 ) ) &&
( V_105 -> V_107 != F_99 ( V_112 ) ) ) {
++ V_2 -> V_95 . V_96 ;
F_91 ( V_48 ) ;
return V_113 ;
}
...
V_68 = F_100 ( V_2 , V_101 -> V_102 ) ;
if ( F_101 ( V_68 ) )
goto V_114;
F_102 ( V_2 , V_101 -> V_102 , V_48 ) ;
return V_113 ;
}
switch ( V_105 -> V_107 ) {
case F_99 ( V_108 ) :
...
struct V_104 * V_105 ;
struct V_100 * V_101 = (struct V_100 * ) V_48 -> V_101 ;
V_105 = (struct V_104 * ) F_109 ( V_48 , sizeof *V_105 ) ;
V_105 -> V_107 = F_99 ( type ) ;
V_105 -> V_122 = 0 ;
...
F_111 ( V_125 , & V_4 -> V_126 ) ;
}
static T_3 F_112 ( struct V_127 * V_128 , T_2 * V_79 )
{
T_3 * V_129 = ( T_3 * ) V_79 ;
T_3 V_130 ;
V_130 = F_113 ( V_129 [ 3 ] , V_129 [ 4 ] , V_131 & V_129 [ 0 ] , 0 ) ;
return V_130 & V_128 -> V_132 ;
}
struct V_67 * F_100 ( struct V_1 * V_2 , T_2 * V_79 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
T_3 V_135 ;
F_114 () ;
V_128 = F_115 ( V_134 -> V_128 ) ;
if ( ! V_128 )
goto V_136;
V_135 = F_112 ( V_128 , V_79 ) ;
for ( V_68 = F_115 ( V_128 -> V_137 [ V_135 ] ) ;
V_68 != NULL ;
V_68 = F_115 ( V_68 -> V_138 ) ) {
...
while ( ( V_68 = F_119 ( * V_148 ,
F_120 ( & V_4 -> V_54 ) ) ) != NULL ) {
if ( F_121 ( V_141 , V_68 -> V_140 ) ) {
F_122 ( * V_148 ,
F_119 ( V_68 -> V_138 ,
F_120 ( & V_4 -> V_54 ) ) ) ;
F_123 ( & V_68 -> V_45 ) ;
...
V_135 = F_112 ( V_128 , V_79 ) ;
for ( V_68 = F_119 ( V_128 -> V_137 [ V_135 ] ,
F_120 ( & V_4 -> V_54 ) ) ;
V_68 != NULL ;
V_68 = F_119 ( V_68 -> V_138 ,
F_120 ( & V_4 -> V_54 ) ) ) {
if ( memcmp ( V_79 , V_68 -> V_79 , V_123 ) == 0 ) {
if ( ! F_116 ( & V_68 -> V_139 ) ) {
V_68 = NULL ;
...
V_68 -> V_140 = V_116 ;
F_122 ( V_68 -> V_138 ,
F_119 ( V_128 -> V_137 [ V_135 ] ,
F_120 ( & V_4 -> V_54 ) ) ) ;
F_122 ( V_128 -> V_137 [ V_135 ] , V_68 ) ;
F_130 ( & V_134 -> V_154 ) ;
V_136:
return V_68 ;
}
...
if ( ! V_128 )
return;
V_135 = F_112 ( V_128 , V_68 -> V_79 ) ;
V_148 = & V_128 -> V_137 [ V_135 ] ;
for ( V_32 = F_119 ( * V_148 ,
F_120 ( & V_4 -> V_54 ) ) ;
V_32 != NULL ;
V_32 = F_119 ( * V_148 ,
F_120 ( & V_4 -> V_54 ) ) ) {
...
F_15 ( V_155 , & V_4 -> V_6 ) ;
V_134 -> V_128 = NULL ;
V_128 = F_83 ( sizeof( * V_128 ) , V_53 ) ;
if ( ! V_128 )
return - V_159 ;
F_4 ( V_144 , & V_4 -> V_6 ) ;
V_147 = F_135 ( V_145 . V_160 ) ;
V_137 = F_83 ( V_147 * sizeof( * V_137 ) , V_53 ) ;
if ( ! V_137 ) {
F_46 ( V_128 ) ;
return - V_159 ;
}
...
if ( F_134 ( V_4 ) < 0 )
goto V_167;
V_4 -> V_168 = F_83 ( V_169 * sizeof * V_4 -> V_168 ,
V_53 ) ;
if ( ! V_4 -> V_168 ) {
F_143 ( V_170 L_24 ,
V_74 -> V_171 , V_169 ) ;
...
V_2 -> V_180 = & V_181 ;
F_153 ( V_2 ) ;
F_154 ( V_2 , & V_4 -> V_182 , V_183 , V_184 ) ;
V_2 -> V_185 = V_186 ;
V_2 -> V_6 |= V_187 | V_188 ;
V_2 -> V_189 = V_190 ;
V_2 -> V_191 = V_123 ;
...
int V_35 ;
V_169 = F_135 ( V_169 ) ;
V_169 = F_27 ( V_169 , V_263 ) ;
V_169 = F_201 ( V_169 , V_264 ) ;
V_174 = F_135 ( V_174 ) ;
V_174 = F_27 ( V_174 , V_263 ) ;
