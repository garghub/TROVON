...
return F_2 ( V_2 , V_14 ) ;
V_44 = 0 ;
V_43 = F_29 ( V_2 -> V_17 , V_2 -> V_36 -> V_37 . V_38 . V_45 [ 6 ] , 0 ) ;
if ( ! V_43 )
goto V_46;
V_44 = 1 ;
if ( V_33 ) {
...
if ( V_65 )
return F_2 ( V_2 , V_16 ) ;
V_2 -> V_8 . V_9 -> V_131 [ V_129 ] &= 0xffffffff00000000ul ;
V_2 -> V_8 . V_9 -> V_131 [ V_129 ] |= V_5 ;
V_28 += 4 ;
if ( V_129 == V_128 )
break;
V_129 = ( V_129 + 1 ) % 16 ;
...
do {
V_65 = F_4 ( V_2 , V_2 -> V_8 . V_9 -> V_131 [ V_129 ] ,
( T_2 V_15 * ) V_28 ) ;
if ( V_65 )
return F_2 ( V_2 , V_16 ) ;
V_28 += 8 ;
...
{
T_8 V_108 ;
V_108 = V_133 [ V_2 -> V_8 . V_9 -> V_60 & 0xff ] ;
if ( V_108 )
return V_108 ( V_2 ) ;
return - V_64 ;
}
...
return - V_64 ;
F_70 ( & V_124 -> V_125 -> V_141 ) ;
V_138 = F_71 ( V_134 , V_2 -> V_8 . V_121 ) ;
if ( F_72 ( V_138 ) )
goto V_142;
V_137 = F_73 ( V_124 -> V_125 , V_138 ) ;
if ( ! V_137 )
goto V_142;
V_2 -> V_8 . V_9 -> V_10 . V_11 &= ~ ( 3ul << 44 ) ;
if ( ! ( V_137 -> V_143 & V_144 ) && ( V_137 -> V_143 & V_145 ) )
V_2 -> V_8 . V_9 -> V_10 . V_11 |= ( 1ul << 44 ) ;
if ( ! ( V_137 -> V_143 & V_144 ) && ! ( V_137 -> V_143 & V_145 ) )
V_2 -> V_8 . V_9 -> V_10 . V_11 |= ( 2ul << 44 ) ;
F_74 ( & V_124 -> V_125 -> V_141 ) ;
return 0 ;
V_142:
F_74 ( & V_124 -> V_125 -> V_141 ) ;
return F_2 ( V_2 , V_16 ) ;
...
return F_2 ( V_2 ,
V_14 ) ;
V_146 = V_2 -> V_36 -> V_37 . V_38 . V_39 [ 0 ] & 0x000000000000ffff ;
V_2 -> V_8 . V_9 -> V_147 = V_146 ;
return 0 ;
}
int F_77 ( struct V_1 * V_2 )
{
T_8 V_108 ;
V_108 = V_148 [ V_2 -> V_8 . V_9 -> V_63 & 0x00ff ] ;
if ( V_108 )
return V_108 ( V_2 ) ;
return - V_64 ;
}
