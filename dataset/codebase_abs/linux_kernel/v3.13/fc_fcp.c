...
F_127 ( V_316 , F_128 ( V_316 ) ,
V_319 ) ;
return 0 ;
}
int F_129 ( struct V_315 * V_316 , int V_320 , int V_321 )
{
switch ( V_321 ) {
case V_322 :
F_127 ( V_316 , F_128 ( V_316 ) , V_320 ) ;
break;
case V_323 :
F_130 ( V_316 , V_320 ) ;
break;
...
int F_131 ( struct V_315 * V_316 , int V_327 )
{
if ( V_316 -> V_318 ) {
F_132 ( V_316 , V_327 ) ;
if ( V_327 )
F_126 ( V_316 , V_316 -> V_326 ) ;
else
F_133 ( V_316 , V_316 -> V_326 ) ;
} else
V_327 = 0 ;
return V_327 ;
}
...
V_3 -> V_30 . V_202 = F_90 ;
if ( ! V_3 -> V_30 . V_331 )
V_3 -> V_30 . V_331 = F_102 ;
if ( ! V_3 -> V_30 . V_332 )
V_3 -> V_30 . V_332 = F_82 ;
V_6 = F_143 ( sizeof( struct V_5 ) , V_333 ) ;
if ( ! V_6 )
return - V_109 ;
V_3 -> V_328 = V_6 ;
