...
int V_54 ;
V_36 = F_15 ( V_50 , V_55 , 0 ) ;
V_38 = F_15 ( V_50 , V_55 , 1 ) ;
if ( ! V_36 || ! V_38 )
return - V_56 ;
V_25 = F_16 ( & V_50 -> V_4 , 1 ) ;
if ( ! V_25 )
return - V_57 ;
V_54 = F_17 ( & V_50 -> V_4 , F_18 ( 32 ) ) ;
if ( V_54 )
return V_54 ;
V_24 -> V_36 = F_19 ( & V_50 -> V_4 , V_36 -> V_58 , 0x1000 ) ;
V_24 -> V_38 = F_19 ( & V_50 -> V_4 , V_38 -> V_58 , 0x1000 ) ;
...
F_22 ( & V_50 -> V_4 , V_69 ) ;
return F_23 ( V_25 , V_51 , V_70 , 0 , & V_71 ) ;
}
