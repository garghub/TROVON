...
F_2 ( V_2 , L_19 ,
( V_42 ) V_37 -> V_43 , V_37 -> V_22 , V_37 -> V_17 ) ;
F_5 ( V_2 , V_37 -> V_43 + V_37 -> V_22 , V_37 -> V_17 , V_19 ,
V_37 -> V_43 , V_39 ) ;
if ( ! V_28 -> V_40 )
F_9 ( V_37 -> V_41 , V_39 ) ;
}
...
static void F_10 ( struct V_44 * V_45 ,
struct V_46 * V_47 ,
struct V_1 * V_2 )
{
struct V_18 * V_19 = & V_47 -> V_19 ;
T_1 V_48 , V_49 , V_50 ;
T_1 V_51 , V_52 ;
T_1 V_3 , V_43 , V_53 ;
V_48 = F_11 ( V_47 , V_54 ) ;
V_49 = F_11 ( V_47 , V_55 ) ;
V_50 = F_11 ( V_47 , V_56 ) ;
V_52 = F_12 ( V_45 , F_13 ( V_47 -> V_57 ) ) ;
V_51 = F_12 ( V_45 , F_14 ( V_47 -> V_57 ) ) ;
F_2 ( V_2 , L_20 , V_47 -> V_57 , F_15 ( V_47 -> V_58 ) ) ;
if ( F_16 ( V_50 ) ||
! V_47 -> V_19 . V_59 . V_39 ) {
F_2 ( V_2 , L_21 ) ;
return;
...
struct V_1 * V_2 )
{
T_1 V_3 , V_63 , V_64 , V_65 , V_66 ;
unsigned int V_23 = 0 ;
F_2 ( V_2 , L_28 , V_47 -> V_57 ) ;
V_3 = F_11 ( V_47 , V_67 ) ;
F_2 ( V_2 , L_29 , V_3 ) ;
if ( F_21 ( V_3 ) ) {
F_2 ( V_2 , L_30 ) ;
...
static void F_31 ( struct V_44 * V_45 , struct V_1 * V_2 )
{
int V_24 ;
F_2 ( V_2 , L_33 ) ;
for ( V_24 = 0 ; V_24 < F_32 ( V_45 ) ; V_24 ++ ) {
T_1 V_71 =
F_12 ( V_45 , F_33 ( V_24 ) ) ;
if ( F_34 ( V_71 ) )
F_2 ( V_2 , L_34 ,
