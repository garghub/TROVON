...
static int F_41 ( struct V_47 * V_10 , T_1 * V_1 )
{
...
V_48 = V_6 -> V_50 == V_51
|| V_6 -> V_50 == V_52 ;
V_49 = ( F_43 ( V_6 -> V_53 ) << 16 ) | F_44 ( V_6 -> V_53 ) ;
* V_1 = F_45 ( F_19 ( V_10 -> V_41 ) , V_49 , V_48 ) ;
if ( ! * V_1 )
return - V_35 ;
return 0 ;
}
static void F_46 ( struct V_47 * V_10 )
{
struct V_6 * V_6 = F_42 ( V_10 ) ;
struct V_13 * V_54 = F_47 ( V_10 ) ;
if ( ! V_54 )
return;
F_11 ( V_54 , V_6 ) ;
...
F_48 ( V_10 , true ) ;
F_31 ( V_6 , false ) ;
if ( V_54 -> V_55 . V_56 . V_58 )
F_49 ( V_10 , true ) ;
}
static void F_50 ( struct V_47 * V_10 )
{
struct V_13 * V_54 = F_47 ( V_10 ) ;
if ( ! V_54 )
return;
...
static bool F_51 ( struct V_47 * V_10 )
{
return V_10 -> V_39 == & V_59 ;
}
