...
static int F_193 ( struct V_1 * V_2 , int V_296 )
{
if ( V_296 < 68 )
return - V_66 ;
if ( V_296 > ( ( V_194 != 0 ) ? 9000 : 1500 ) )
return - V_66 ;
V_2 -> V_297 = V_296 ;
return 0 ;
}
static int F_194 ( struct V_1 * V_2 , void * V_298 )
{
struct V_299 * V_30 = V_298 ;
if ( ! F_195 ( V_30 -> V_300 ) )
return - V_66 ;
memcpy ( V_2 -> V_88 , V_30 -> V_300 , V_2 -> V_301 ) ;
return 0 ;
}
...
static void F_199 ( const char * V_229 , const T_5 * V_313 )
{
int V_164 ;
int V_117 ;
int V_314 = 0 ;
...
F_83 ( & V_228 ) ;
F_100 ( F_205 , NULL , 1 ) ;
for ( V_117 = 0 ; F_207 ( V_117 , V_229 , V_313 ) >= 0 ; V_117 ++ )
F_199 ( V_229 , V_313 ) ;
if ( ! F_3 () )
V_9 = * V_319 ;
return 0 ;
