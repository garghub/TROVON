...
int F_34 ( struct V_6 * V_7 , unsigned short V_62 )
{
...
* ( unsigned short * ) ( V_7 -> V_11 + V_7 -> V_38 ) = V_62 ;
F_28 ( V_7 , sizeof( short ) ) ;
return 1 ;
}
int F_35 ( struct V_6 * V_7 , unsigned short * V_62 )
{
unsigned int V_63 = F_29 ( V_7 ) ;
if ( V_63 < sizeof( short ) )
return 0 ;
F_31 ( V_7 , sizeof( short ) ) ;
* V_62 = * ( unsigned short * ) ( V_7 -> V_11 + V_7 -> V_39 ) ;
