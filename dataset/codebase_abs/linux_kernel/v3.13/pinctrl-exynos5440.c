...
static void F_30 ( struct V_78 * V_79 , unsigned V_60 , int V_35 )
{
struct V_3 * V_4 = F_31 ( V_79 -> V_17 ) ;
...
static int F_35 ( struct V_78 * V_79 , unsigned V_60 )
{
struct V_3 * V_4 = F_31 ( V_79 -> V_17 ) ;
unsigned int V_84 ;
if ( V_60 < 16 || V_60 > 23 )
...
* V_90 = F_38 ( V_17 , * V_91 * sizeof( * * V_90 ) , V_28 ) ;
if ( ! * V_90 ) {
F_8 ( V_17 , L_11 ) ;
return - V_29 ;
}
return F_39 ( V_89 , L_9 ,
* V_90 , * V_91 ) ;
}
...
if ( ! V_103 )
return - V_27 ;
V_52 = F_38 ( V_17 , V_103 * sizeof( * V_52 ) , V_28 ) ;
if ( ! V_52 ) {
F_8 ( V_17 , L_12 ) ;
return - V_27 ;
}
V_99 = V_52 ;
V_101 = F_38 ( V_17 , V_103 * sizeof( * V_101 ) , V_28 ) ;
if ( ! V_101 ) {
F_8 ( V_17 , L_13 ) ;
return - V_27 ;
}
...
F_42 (dev_np, cfg_np) {
T_1 V_47 ;
V_105 = F_37 ( V_88 , V_89 ,
& V_90 , & V_91 ) ;
if ( V_105 ) {
V_20 = NULL ;
goto V_106;
}
V_20 = F_38 ( V_17 , strlen ( V_89 -> V_8 ) + V_30 ,
V_28 ) ;
if ( ! V_20 ) {
F_8 ( V_17 , L_5 ) ;
return - V_29 ;
...
if ( V_105 )
continue;
V_21 = F_38 ( V_17 , strlen ( V_89 -> V_8 ) + V_42 ,
V_28 ) ;
if ( ! V_21 ) {
F_8 ( V_17 , L_8 ) ;
return - V_29 ;
...
V_44 ) ;
V_102 -> V_8 = V_21 ;
V_102 -> V_52 = F_38 ( V_17 , sizeof( char * ) , V_28 ) ;
if ( ! V_102 -> V_52 ) {
F_8 ( V_17 , L_14
L_15 ) ;
return - V_29 ;
...
char * V_114 ;
int V_62 , V_105 ;
V_108 = F_38 ( V_17 , sizeof( * V_108 ) , V_28 ) ;
if ( ! V_108 ) {
F_8 ( V_17 , L_16 ) ;
return - V_29 ;
}
...
V_108 -> V_119 = & V_120 ;
V_108 -> V_121 = & V_122 ;
V_111 = F_38 ( & V_88 -> V_17 , sizeof( * V_111 ) *
V_123 , V_28 ) ;
if ( ! V_111 ) {
F_8 ( & V_88 -> V_17 , L_18 ) ;
return - V_29 ;
...
V_112 -> V_124 = V_62 ;
V_114 = F_38 ( & V_88 -> V_17 , sizeof( char ) * V_125 *
V_108 -> V_91 , V_28 ) ;
if ( ! V_114 ) {
F_8 ( & V_88 -> V_17 , L_19 ) ;
return - V_29 ;
...
if ( V_105 )
return V_105 ;
V_109 = F_44 ( V_108 , & V_88 -> V_17 , V_4 ) ;
if ( ! V_109 ) {
F_8 ( & V_88 -> V_17 , L_21 ) ;
return - V_27 ;
}
...
struct V_78 * V_79 ;
int V_105 ;
V_79 = F_38 ( & V_88 -> V_17 , sizeof( * V_79 ) , V_28 ) ;
if ( ! V_79 ) {
F_8 ( & V_88 -> V_17 , L_23 ) ;
return - V_29 ;
}
...
static void F_50 ( struct V_134 * V_135 )
{
struct V_3 * V_136 ;
unsigned long V_137 ;
V_136 = F_51 ( V_135 ) ;
...
static void F_52 ( struct V_134 * V_135 )
{
struct V_3 * V_136 ;
unsigned long V_137 ;
V_136 = F_51 ( V_135 ) ;
...
static T_3 F_53 ( int V_140 , void * V_37 )
{
struct V_141 * V_142 = V_37 ;
struct V_3 * V_136 = V_142 -> V_4 ;
int V_84 ;
V_84 = F_54 ( V_136 -> V_86 , V_142 -> V_137 ) ;
if ( ! V_84 )
return V_143 ;
F_55 ( V_84 ) ;
return V_144 ;
}
static int F_56 ( struct V_86 * V_145 , unsigned int V_84 ,
T_4 V_146 )
{
...
V_142 = F_38 ( V_17 , sizeof( * V_142 ) * V_151 ,
V_28 ) ;
if ( ! V_142 ) {
F_8 ( V_17 , L_28 ) ;
return - V_29 ;
...
V_154 = F_66 ( V_88 , V_156 , 0 ) ;
V_4 -> V_56 = F_67 ( & V_88 -> V_17 , V_154 ) ;
if ( F_68 ( V_4 -> V_56 ) )
