...
struct V_22 * V_23 = V_7 -> V_23 ;
int V_38 ;
V_38 = F_32 ( V_7 -> V_47 -> V_48 -> V_49 , V_46 ,
V_23 -> V_50 , V_23 -> V_51 , V_23 -> V_52 ) ;
F_33 ( L_1 , V_53 , V_38 ,
V_23 -> V_50 ,
V_23 -> V_51 ,
V_23 -> V_52 ) ;
...
V_57 -> V_24 = NULL ;
V_57 -> V_61 = F_35 ( V_47 -> V_48 -> V_49 , V_58 ,
& V_57 -> V_62 , V_39 ) ;
if ( ! V_57 -> V_61 )
return - V_40 ;
V_57 -> V_63 = V_58 ;
...
V_7 = V_47 -> V_55 [ V_68 ] . V_7 ;
if ( V_7 ) {
struct V_56 * V_57 = & V_7 -> V_27 ;
V_70 = ( unsigned long ) V_57 -> V_61 ;
}
F_40 ( & V_71 ,
& V_72 - & V_71 ) ;
return 0 ;
...
int F_46 ( struct V_75 * V_76 ,
struct V_77 * V_21 )
{
int V_38 ;
V_38 = F_47 ( & V_74 ) ;
if ( V_38 ) {
F_48 ( & V_76 -> V_49 , L_2 , V_38 ) ;
return V_38 ;
}
F_44 ( V_21 -> V_78 , 1 ) ;
V_73 = V_21 -> V_78 ;
V_33 = V_21 -> V_78 ;
V_79 = ( unsigned long ) V_21 -> V_80 ;
V_21 -> V_81 -> V_82 = 4 ;
V_21 -> V_83 -> V_82 = 6 ;
V_38 = F_49 ( & V_76 -> V_49 , & V_84 ) ;
if ( V_38 )
goto V_85;
return 0 ;
V_85:
