...
V_6 -> V_9 = false ;
if ( F_47 ( V_12 , V_86 ) ) {
F_48 ( V_12 , struct V_87 , V_82 , & V_82 ) ;
} else {
V_39 = - V_88 ;
goto V_85;
}
...
F_49 ( V_12 , F_50 ( struct V_87 , V_24 ) ,
V_24 , V_82 ) ;
V_6 -> V_24 = V_24 ;
V_6 -> V_82 = V_82 ;
V_39 = F_51 ( & ( V_12 -> V_77 . V_89 ) , & V_90 . V_79 ) ;
if ( V_39 ) {
goto V_91;
}
V_6 -> V_23 = F_33 ( sizeof( V_92 ) , V_83 ) ;
if ( ! V_6 -> V_23 ) {
V_39 = - V_72 ;
goto V_91;
}
...
static int
F_56 ( struct V_3 * V_4 , const char * V_98 , char * args )
{
struct V_5 * V_6 ;
int V_99 = - V_100 ;
int V_101 = 0 ;
F_3 ( & V_8 ) ;
F_57 (chan, &virtio_chan_list, chan_list) {
...
static void F_58 ( struct V_81 * V_12 )
{
