...
if ( ! V_118 )
F_68 ( V_131 , V_126 ) ;
if ( ! strncmp ( V_119 [ 0 ] , L_65 , 3 ) ) {
return F_56 ( V_118 , V_119 ) ;
} else if ( ! strncmp ( V_119 [ 0 ] , L_66 , 6 ) ) {
V_77 = & V_135 ;
if ( V_118 ) {
V_118 = F_67 ( V_118 , V_119 ,
V_129 , V_132 , 0 ) ;
if ( V_118 )
F_68 ( V_132 , V_129 ) ;
}
V_91 = F_49 ( false ) ;
} else if ( ! strcmp ( V_119 [ 0 ] , L_67 ) ) {
return F_69 ( V_118 , V_119 , T_5 ) ;
} else if ( ! strcmp ( V_119 [ 0 ] , L_68 ) ) {
if ( V_118 ) {
V_118 = F_67 ( V_118 , V_119 ,
V_125 , V_130 , 0 ) ;
if ( V_118 )
