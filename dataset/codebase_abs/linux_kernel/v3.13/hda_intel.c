...
if ( V_2 -> V_47 & V_318 )
F_17 ( V_2 , V_319 ,
F_46 ( V_2 , V_319 ) | V_309 ) ;
else
F_17 ( V_2 , V_320 , F_46 ( V_2 , V_320 ) | V_309 ) ;
F_152 (s, substream) {
if ( V_305 -> V_198 -> V_223 != V_20 -> V_198 -> V_223 )
continue;
V_18 = F_117 ( V_305 ) ;
if ( V_307 ) {
V_18 -> V_321 = F_46 ( V_2 , V_252 ) ;
if ( ! V_306 )
V_18 -> V_321 -=
V_18 -> V_301 ;
F_64 ( V_2 , V_18 ) ;
...
V_29 V_341 ;
unsigned int V_333 ;
V_341 = F_46 ( V_2 , V_252 ) - V_18 -> V_321 ;
...
static int F_45 ( struct V_1 * V_2 , int V_368 )
{
...
F_41 ( V_75 L_64 , F_42 ( V_2 -> V_24 ) , V_450 ) ;
