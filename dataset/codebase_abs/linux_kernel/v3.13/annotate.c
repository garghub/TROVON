...
struct V_104 V_6 = {
. V_34 = V_34 ,
. V_12 = V_59 -> V_2 . V_6 . V_12 ,
} ;
if ( ! F_56 ( & V_6 , NULL ) &&
V_6 . V_36 -> V_53 == V_6 . V_105 )
V_59 -> V_2 . V_6 . V_5 = F_7 ( V_6 . V_36 -> V_5 ) ;
}
...
! F_66 ( V_108 ) ) {
char V_8 [ V_125 * 2 + 16 ] = L_30 ;
char * V_126 = NULL ;
if ( V_108 -> V_127 )
goto V_128;
if ( V_108 -> V_119 ) {
F_67 ( V_108 -> V_129 ,
sizeof( V_108 -> V_129 ) , V_8 + 15 ) ;
V_126 = V_8 ;
}
V_113 = - V_130 ;
V_108 -> V_127 = 1 ;
...
F_68 ( L_40 ,
V_108 , V_108 -> V_122 , V_36 , V_36 -> V_5 ) ;
if ( F_66 ( V_108 ) ) {
V_116 . V_131 = V_114 ;
V_116 . V_12 = F_55 ( V_34 , V_36 -> V_53 ) ;
V_116 . V_132 = V_36 -> V_53 ;
V_116 . V_81 = V_36 -> V_54 + 1 - V_36 -> V_53 ;
if ( ! F_69 ( & V_116 ) ) {
V_117 = true ;
F_70 ( V_114 , V_116 . V_133 ,
sizeof( V_114 ) ) ;
if ( V_110 ) {
free ( V_109 ) ;
V_110 = false ;
...
V_44 . V_136 ? L_37 : L_46 ,
V_44 . V_137 ? L_47 : L_37 ,
V_114 , V_109 ) ;
F_68 ( L_48 , V_111 ) ;
V_98 = F_71 ( V_111 , L_49 ) ;
if ( ! V_98 )
goto V_128;
while ( ! feof ( V_98 ) )
...
static void F_74 ( struct V_138 * V_139 , struct V_71 * V_72 )
{
struct V_71 * V_140 ;
struct V_141 * * V_76 = & V_139 -> V_141 ;
struct V_141 * V_142 = NULL ;
int V_89 , V_143 ;
while ( * V_76 != NULL ) {
V_142 = * V_76 ;
V_140 = F_75 ( V_142 , struct V_71 , V_68 ) ;
V_143 = strcmp ( V_140 -> V_70 , V_72 -> V_70 ) ;
if ( V_143 == 0 ) {
for ( V_89 = 0 ; V_89 < V_72 -> V_77 ; V_89 ++ )
V_140 -> V_76 [ V_89 ] . V_144 += V_72 -> V_76 [ V_89 ] . V_74 ;
return;
}
if ( V_143 < 0 )
V_76 = & ( * V_76 ) -> V_145 ;
...
for ( V_89 = 0 ; V_89 < V_72 -> V_77 ; V_89 ++ )
V_72 -> V_76 [ V_89 ] . V_144 = V_72 -> V_76 [ V_89 ] . V_74 ;
F_76 ( & V_72 -> V_68 , V_142 , V_76 ) ;
F_77 ( & V_72 -> V_68 , V_139 ) ;
}
static int F_78 ( struct V_71 * V_147 , struct V_71 * V_148 )
{
int V_89 ;
for ( V_89 = 0 ; V_89 < V_147 -> V_77 ; V_89 ++ ) {
if ( V_147 -> V_76 [ V_89 ] . V_144 == V_148 -> V_76 [ V_89 ] . V_144 )
continue;
return V_147 -> V_76 [ V_89 ] . V_144 > V_148 -> V_76 [ V_89 ] . V_144 ;
}
return 0 ;
}
static void F_79 ( struct V_138 * V_139 , struct V_71 * V_72 )
{
struct V_71 * V_140 ;
struct V_141 * * V_76 = & V_139 -> V_141 ;
struct V_141 * V_142 = NULL ;
...
static void F_80 ( struct V_138 * V_149 , struct V_138 * V_150 )
{
struct V_71 * V_72 ;
struct V_141 * V_68 ;
V_68 = F_81 ( V_150 ) ;
while ( V_68 ) {
struct V_141 * V_92 ;
V_72 = F_75 ( V_68 , struct V_71 , V_68 ) ;
V_92 = F_82 ( V_68 ) ;
F_83 ( V_68 , V_150 ) ;
F_79 ( V_149 , V_72 ) ;
V_68 = V_92 ;
...
static void F_84 ( struct V_35 * V_36 , int V_81 )
{
struct V_37 * V_38 = F_28 ( V_36 ) ;
struct V_71 * V_72 = V_38 -> V_43 -> V_73 ;
T_1 V_75 ;
...
static int F_86 ( struct V_35 * V_36 , struct V_34 * V_34 ,
struct V_79 * V_80 ,
struct V_138 * V_139 , int V_81 )
{
T_2 V_53 ;
int V_89 , V_151 ;
int V_48 = V_80 -> V_94 ;
...
V_49 = F_38 ( V_38 , V_48 + V_151 ) ;
V_72 -> V_76 [ V_151 ] . V_74 = 100.0 * V_49 -> V_12 [ V_89 ] / V_49 -> V_56 ;
if ( V_72 -> V_76 [ V_151 ] . V_74 > V_155 )
V_155 = V_72 -> V_76 [ V_151 ] . V_74 ;
}
if ( V_155 <= 0.5 )
goto V_92;
V_17 = V_53 + V_89 ;
V_72 -> V_70 = F_87 ( V_34 -> V_108 , V_17 ) ;
F_74 ( & V_152 , V_72 ) ;
V_92:
V_72 = ( void * ) V_72 + V_75 ;
}
...
static void F_88 ( struct V_138 * V_139 , const char * V_109 )
{
struct V_71 * V_72 ;
struct V_141 * V_68 ;
printf ( L_50 , V_109 ) ;
...
V_68 = F_81 ( V_139 ) ;
while ( V_68 ) {
double V_74 , V_155 = 0.0 ;
const char * V_91 ;
char * V_70 ;
int V_89 ;
V_72 = F_75 ( V_68 , struct V_71 , V_68 ) ;
for ( V_89 = 0 ; V_89 < V_72 -> V_77 ; V_89 ++ ) {
V_74 = V_72 -> V_76 [ V_89 ] . V_144 ;
V_91 = F_51 ( V_74 ) ;
F_52 ( stdout , V_91 , L_16 , V_74 ) ;
if ( V_74 > V_155 )
V_155 = V_74 ;
...
V_70 = V_72 -> V_70 ;
V_91 = F_51 ( V_155 ) ;
F_52 ( stdout , V_91 , L_53 , V_70 ) ;
V_68 = F_82 ( V_68 ) ;
}
}
static void F_90 ( struct V_35 * V_36 , struct V_79 * V_80 )
{
struct V_37 * V_38 = F_28 ( V_36 ) ;
...
if ( V_49 -> V_12 [ V_17 ] != 0 )
printf ( L_54 V_14 L_55 V_57 L_10 , V_157 / 2 ,
V_36 -> V_53 + V_17 , V_49 -> V_12 [ V_17 ] ) ;
printf ( L_56 V_57 L_10 , V_157 / 2 , L_57 , V_49 -> V_56 ) ;
}
int F_91 ( struct V_35 * V_36 , struct V_34 * V_34 ,
struct V_79 * V_80 , bool V_158 ,
int V_82 , int V_83 , int V_159 )
{
struct V_108 * V_108 = V_34 -> V_108 ;
char * V_109 ;
const char * V_160 ;
...
V_97 *= V_80 -> V_93 ;
printf ( L_58 ,
V_97 , V_97 , L_59 , V_160 ) ;
printf ( L_60 ,
V_97 + V_163 , V_97 + V_163 , V_164 ) ;
if ( V_165 )
F_90 ( V_36 , V_80 ) ;
F_93 (pos, &notes->src->source, node) {
if ( V_159 && V_84 == NULL ) {
V_84 = V_69 ;
V_161 = 0 ;
}
...
break;
if ( V_161 == V_159 )
V_84 = F_59 ( V_84 -> V_68 . V_92 , F_94 ( * V_84 ) , V_68 ) ;
else
++ V_161 ;
break;
}
...
void F_95 ( struct V_35 * V_36 , int V_48 )
{
struct V_37 * V_38 = F_28 ( V_36 ) ;
struct V_42 * V_49 = F_38 ( V_38 , V_48 ) ;
memset ( V_49 , 0 , V_38 -> V_43 -> V_40 ) ;
}
void F_96 ( struct V_35 * V_36 , int V_48 )
{
struct V_37 * V_38 = F_28 ( V_36 ) ;
struct V_42 * V_49 = F_38 ( V_38 , V_48 ) ;
...
void F_97 ( struct V_66 * V_67 )
{
struct V_58 * V_69 , * V_166 ;
F_98 (pos, n, head, node) {
F_60 ( & V_69 -> V_68 ) ;
F_41 ( V_69 ) ;
}
}
static T_1 F_99 ( struct V_58 * V_59 , T_4 * V_167 )
{
T_1 V_27 ;
if ( V_59 -> V_17 == - 1 )
return fprintf ( V_167 , L_20 , V_59 -> line ) ;
V_27 = fprintf ( V_167 , L_11 V_14 L_15 , V_59 -> V_17 , V_59 -> V_5 ) ;
if ( V_59 -> V_2 . V_4 [ 0 ] != '\0' ) {
V_27 += fprintf ( V_167 , L_61 , 6 - ( int ) V_27 , L_22 ,
V_59 -> V_2 . V_4 ) ;
}
return V_27 + fprintf ( V_167 , L_10 ) ;
}
T_1 F_100 ( struct V_66 * V_67 , T_4 * V_167 )
{
struct V_58 * V_69 ;
T_1 V_27 = 0 ;
F_93 (pos, head, node)
V_27 += F_99 ( V_69 , V_167 ) ;
return V_27 ;
}
int F_101 ( struct V_35 * V_36 , struct V_34 * V_34 ,
struct V_79 * V_80 , bool V_168 ,
bool V_158 , int V_82 , int V_83 )
{
struct V_108 * V_108 = V_34 -> V_108 ;
struct V_138 V_71 = V_153 ;
T_2 V_81 ;
if ( F_61 ( V_36 , V_34 , 0 ) < 0 )
return - 1 ;
V_81 = F_31 ( V_36 ) ;
if ( V_168 ) {
F_86 ( V_36 , V_34 , V_80 , & V_71 , V_81 ) ;
F_88 ( & V_71 , V_108 -> V_122 ) ;
}
F_91 ( V_36 , V_34 , V_80 , V_158 ,
V_82 , V_83 , 0 ) ;
if ( V_168 )
F_84 ( V_36 , V_81 ) ;
F_97 ( & F_28 ( V_36 ) -> V_43 -> V_3 ) ;
return 0 ;
}
