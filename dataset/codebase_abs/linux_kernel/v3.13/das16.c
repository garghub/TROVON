...
unsigned int V_87 = F_30 ( V_114 -> V_116 ) ;
unsigned int V_117 ;
int V_118 ;
int V_19 ;
F_4 ( V_3 ) ;
...
static int F_53 ( struct V_2 * V_3 , struct V_125 * V_126 )
{
const struct V_52 * V_53 = F_24 ( V_3 ) ;
struct V_6 * V_7 ;
struct V_26 * V_27 ;
...
V_7 = F_54 ( V_3 , sizeof( * V_7 ) ) ;
if ( ! V_7 )
return - V_135 ;
if ( V_53 -> V_136 < 0x400 ) {
V_118 = F_55 ( V_3 , V_126 -> V_134 [ 0 ] , V_53 -> V_136 ) ;
if ( V_118 )
return V_118 ;
} else {
V_118 = F_55 ( V_3 , V_126 -> V_134 [ 0 ] , 0x10 ) ;
if ( V_118 )
return V_118 ;
V_118 = F_56 ( V_3 , V_3 -> V_16 + 0x400 ,
V_53 -> V_136 & 0x3ff ) ;
if ( V_118 )
return V_118 ;
...
V_131 = F_61 ( sizeof( * V_131 ) + sizeof( * V_133 ) , V_146 ) ;
if ( ! V_131 )
return - V_135 ;
V_7 -> V_147 = V_131 ;
V_131 -> V_148 = 1 ;
...
if ( V_53 -> V_153 ) {
V_27 = & V_3 -> V_154 [ 4 ] ;
V_118 = F_63 ( V_3 , V_27 , NULL ,
V_3 -> V_16 + V_53 -> V_182 ) ;
if ( V_118 )
return V_118 ;
}
F_52 ( V_3 ) ;
V_7 -> V_9 = F_64 ( V_3 -> V_183 ) ;
F_3 ( V_7 -> V_9 , V_3 -> V_16 + V_17 ) ;
if ( V_7 -> V_62 ) {
