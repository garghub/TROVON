...
static void F_161 ( struct V_20 * V_31 ,
struct V_150 * V_151 ,
...
F_161 ( V_31 , V_151 , V_6 , V_50 ) ;
F_80 ( & V_13 -> V_67 ) ;
if ( V_31 -> V_22 -> V_172 == 1 || V_31 -> V_22 -> V_133 )
F_171 ( & V_31 -> V_22 -> V_161 ) ;
else
F_181 ( & V_31 -> V_22 -> V_161 ) ;
F_172 ( & V_31 -> V_22 -> V_161 ) ;
return true ;
V_171:
F_80 ( & V_13 -> V_67 ) ;
return false ;
...
int F_197 ( T_1 V_175 , struct V_176 * V_177 )
{
if ( ! F_198 () ) {
V_175 ( & V_177 -> V_6 ) ;
return 0 ;
}
F_192 ( & V_177 -> V_6 , V_175 ) ;
F_77 ( & V_177 -> V_6 ) ;
return 1 ;
}
static struct V_21 * F_199 ( struct V_178 * V_179 )
{
struct V_180 * V_181 = F_160 ( V_179 , struct V_180 , V_179 ) ;
return V_181 -> V_22 ;
}
static T_3 F_200 ( struct V_178 * V_179 , struct V_182 * V_183 ,
char * V_184 )
{
struct V_21 * V_22 = F_199 ( V_179 ) ;
return F_201 ( V_184 , V_185 , L_8 , ( bool ) ! ( V_22 -> V_30 & V_69 ) ) ;
}
static T_3 F_202 ( struct V_178 * V_179 ,
struct V_182 * V_183 , char * V_184 )
{
struct V_21 * V_22 = F_199 ( V_179 ) ;
return F_201 ( V_184 , V_185 , L_8 , V_22 -> V_172 ) ;
}
...
F_206 () ;
F_207 (node) {
V_190 += F_201 ( V_184 + V_190 , V_185 - V_190 ,
L_10 , V_189 , V_23 ,
F_22 ( V_22 , V_23 ) -> V_13 -> V_19 ) ;
V_189 = L_11 ;
}
V_190 += F_201 ( V_184 + V_190 , V_185 - V_190 , L_12 ) ;
F_208 () ;
return V_190 ;
}
static T_3 F_209 ( struct V_178 * V_179 , struct V_182 * V_183 ,
char * V_184 )
{
struct V_21 * V_22 = F_199 ( V_179 ) ;
int V_190 ;
F_137 ( & V_22 -> V_162 ) ;
V_190 = F_201 ( V_184 , V_185 , L_8 , V_22 -> V_191 -> V_122 ) ;
F_138 ( & V_22 -> V_162 ) ;
return V_190 ;
}
static struct V_192 * F_210 ( struct V_21 * V_22 )
{
struct V_192 * V_121 ;
V_121 = F_211 ( V_18 ) ;
if ( ! V_121 )
return NULL ;
F_137 ( & V_22 -> V_162 ) ;
F_212 ( V_121 , V_22 -> V_191 ) ;
F_138 ( & V_22 -> V_162 ) ;
return V_121 ;
}
static T_3 F_213 ( struct V_178 * V_179 , struct V_182 * V_183 ,
...
int V_190 ;
F_137 ( & V_22 -> V_162 ) ;
V_190 = F_217 ( V_184 , V_185 , V_22 -> V_191 -> V_125 ) ;
F_138 ( & V_22 -> V_162 ) ;
V_190 += F_201 ( V_184 + V_190 , V_185 - V_190 , L_12 ) ;
return V_190 ;
}
...
if ( ! V_121 )
return - V_128 ;
V_14 = F_219 ( V_184 , V_121 -> V_125 ) ;
if ( ! V_14 )
V_14 = F_214 ( V_22 , V_121 ) ;
F_215 ( V_121 ) ;
return V_14 ? : V_186 ;
}
static T_3 F_220 ( struct V_178 * V_179 , struct V_182 * V_183 ,
char * V_184 )
{
struct V_21 * V_22 = F_199 ( V_179 ) ;
int V_190 ;
F_137 ( & V_22 -> V_162 ) ;
V_190 = F_201 ( V_184 , V_185 , L_8 ,
! V_22 -> V_191 -> V_193 ) ;
F_138 ( & V_22 -> V_162 ) ;
return V_190 ;
}
...
{
return F_223 ( & V_195 , NULL ) ;
}
static void F_224 ( struct V_178 * V_179 )
{
struct V_180 * V_181 = F_160 ( V_179 , struct V_180 , V_179 ) ;
F_134 ( V_181 ) ;
}
int F_225 ( struct V_21 * V_22 )
{
struct V_180 * V_181 ;
int V_14 ;
...
V_181 -> V_179 . V_199 = F_224 ;
F_226 ( & V_181 -> V_179 , true ) ;
V_14 = F_227 ( & V_181 -> V_179 ) ;
if ( V_14 ) {
F_134 ( V_181 ) ;
V_22 -> V_181 = NULL ;
return V_14 ;
...
struct V_192 * F_211 ( T_6 V_203 )
{
struct V_192 * V_121 ;
V_121 = F_123 ( sizeof( * V_121 ) , V_203 ) ;
if ( ! V_121 )
goto V_87;
if ( ! F_233 ( & V_121 -> V_125 , V_203 ) )
goto V_87;
F_234 ( V_121 -> V_125 , V_204 ) ;
return V_121 ;
V_87:
F_215 ( V_121 ) ;
return NULL ;
}
static void F_212 ( struct V_192 * V_205 ,
const struct V_192 * V_206 )
{
V_205 -> V_122 = V_206 -> V_122 ;
F_234 ( V_205 -> V_125 , V_206 -> V_125 ) ;
V_205 -> V_193 = V_206 -> V_193 ;
}
static T_7 F_235 ( const struct V_192 * V_121 )
{
T_7 V_207 = 0 ;
V_207 = F_236 ( V_121 -> V_122 , V_207 ) ;
V_207 = F_237 ( F_238 ( V_121 -> V_125 ) ,
F_239 ( V_208 ) * sizeof( long ) , V_207 ) ;
return V_207 ;
}
static bool F_240 ( const struct V_192 * V_209 ,
const struct V_192 * V_210 )
{
if ( V_209 -> V_122 != V_210 -> V_122 )
return false ;
if ( ! F_241 ( V_209 -> V_125 , V_210 -> V_125 ) )
return false ;
return true ;
}
...
F_249 ( & V_13 -> V_213 ) ;
V_13 -> V_68 = 1 ;
V_13 -> V_121 = F_211 ( V_18 ) ;
if ( ! V_13 -> V_121 )
return - V_128 ;
return 0 ;
}
static void F_250 ( struct V_214 * V_215 )
{
...
F_185 ( & V_13 -> V_112 ) ;
F_185 ( & V_13 -> V_136 ) ;
F_254 ( & V_13 -> V_215 , F_250 ) ;
}
static struct V_12 * F_255 ( const struct V_192 * V_121 )
{
T_7 V_207 = F_235 ( V_121 ) ;
struct V_12 * V_13 ;
int V_23 ;
F_20 ( & V_15 ) ;
F_71 (unbound_pool_hash, pool, hash_node, hash) {
if ( F_240 ( V_13 -> V_121 , V_121 ) ) {
V_13 -> V_68 ++ ;
goto V_164;
}
}
V_13 = F_123 ( sizeof( * V_13 ) , V_18 ) ;
if ( ! V_13 || F_242 ( V_13 ) < 0 )
goto V_87;
if ( V_216 )
V_13 -> V_30 |= V_217 ;
F_256 ( & V_13 -> V_67 , 1 ) ;
F_212 ( V_13 -> V_121 , V_121 ) ;
V_13 -> V_121 -> V_193 = false ;
if ( V_218 ) {
F_207 (node) {
if ( F_257 ( V_13 -> V_121 -> V_125 ,
V_219 [ V_23 ] ) ) {
V_13 -> V_23 = V_23 ;
break;
}
...
static void F_259 ( struct V_214 * V_215 )
{
F_260 ( V_221 ,
F_160 ( V_215 , struct V_20 , V_215 ) ) ;
}
static void F_261 ( struct V_2 * V_6 )
{
struct V_20 * V_31 = F_160 ( V_6 , struct V_20 ,
V_70 ) ;
struct V_21 * V_22 = V_31 -> V_22 ;
struct V_12 * V_13 = V_31 -> V_13 ;
bool V_222 ;
...
F_252 ( V_13 ) ;
F_138 ( & V_15 ) ;
F_254 ( & V_31 -> V_215 , F_259 ) ;
if ( V_222 ) {
F_215 ( V_22 -> V_191 ) ;
F_134 ( V_22 ) ;
}
}
static void F_263 ( struct V_20 * V_31 )
{
struct V_21 * V_22 = V_31 -> V_22 ;
...
static void F_264 ( struct V_20 * V_31 , struct V_21 * V_22 ,
struct V_12 * V_13 )
{
F_265 ( ( unsigned long ) V_31 & V_227 ) ;
...
F_124 ( & V_31 -> V_223 ) ;
F_124 ( & V_31 -> V_134 ) ;
F_192 ( & V_31 -> V_70 , F_261 ) ;
}
static void F_266 ( struct V_20 * V_31 )
{
struct V_21 * V_22 = V_31 -> V_22 ;
F_20 ( & V_22 -> V_162 ) ;
if ( ! F_48 ( & V_31 -> V_223 ) )
...
F_263 ( V_31 ) ;
F_267 ( & V_31 -> V_223 , & V_22 -> V_224 ) ;
}
static struct V_20 * F_268 ( struct V_21 * V_22 ,
...
if ( ! V_13 )
return NULL ;
V_31 = F_269 ( V_221 , V_18 , V_13 -> V_23 ) ;
if ( ! V_31 ) {
F_252 ( V_13 ) ;
return NULL ;
}
F_264 ( V_31 , V_22 , V_13 ) ;
return V_31 ;
}
static void F_270 ( struct V_20 * V_31 )
{
F_20 ( & V_15 ) ;
if ( V_31 ) {
F_252 ( V_31 -> V_13 ) ;
...
static bool F_271 ( const struct V_192 * V_121 , int V_23 ,
int V_228 , T_8 * V_125 )
{
if ( ! V_218 || V_121 -> V_193 )
goto V_229;
F_272 ( V_125 , F_273 ( V_23 ) , V_121 -> V_125 ) ;
if ( V_228 >= 0 )
F_274 ( V_228 , V_125 ) ;
if ( F_275 ( V_125 ) )
goto V_229;
F_272 ( V_125 , V_121 -> V_125 , V_219 [ V_23 ] ) ;
return ! F_241 ( V_125 , V_121 -> V_125 ) ;
V_229:
F_234 ( V_125 , V_121 -> V_125 ) ;
return false ;
}
static struct V_20 * F_276 ( struct V_21 * V_22 ,
int V_23 ,
struct V_20 * V_31 )
{
struct V_20 * V_230 ;
F_20 ( & V_22 -> V_162 ) ;
F_266 ( V_31 ) ;
V_230 = F_277 ( V_22 -> V_24 [ V_23 ] ) ;
F_278 ( V_22 -> V_24 [ V_23 ] , V_31 ) ;
return V_230 ;
}
int F_214 ( struct V_21 * V_22 ,
const struct V_192 * V_121 )
{
...
goto V_236;
F_212 ( V_231 , V_121 ) ;
F_272 ( V_231 -> V_125 , V_231 -> V_125 , V_204 ) ;
F_212 ( V_232 , V_231 ) ;
F_190 () ;
F_137 ( & V_15 ) ;
V_234 = F_268 ( V_22 , V_231 ) ;
if ( ! V_234 )
goto V_237;
F_207 (node) {
if ( F_271 ( V_121 , V_23 , - 1 , V_232 -> V_125 ) ) {
V_233 [ V_23 ] = F_268 ( V_22 , V_232 ) ;
if ( ! V_233 [ V_23 ] )
goto V_237;
} else {
V_234 -> V_68 ++ ;
...
F_138 ( & V_15 ) ;
F_137 ( & V_22 -> V_162 ) ;
F_212 ( V_22 -> V_191 , V_231 ) ;
F_207 (node)
V_233 [ V_23 ] = F_276 ( V_22 , V_23 , V_233 [ V_23 ] ) ;
F_266 ( V_234 ) ;
F_279 ( V_22 -> V_234 , V_234 ) ;
F_138 ( & V_22 -> V_162 ) ;
F_207 (node)
F_78 ( V_233 [ V_23 ] ) ;
F_78 ( V_234 ) ;
...
static void F_280 ( struct V_21 * V_22 , int V_54 ,
bool V_239 )
{
int V_23 = F_105 ( V_54 ) ;
...
if ( V_22 -> V_191 -> V_193 )
goto V_164;
F_212 ( V_241 , V_22 -> V_191 ) ;
V_31 = F_22 ( V_22 , V_23 ) ;
if ( F_271 ( V_22 -> V_191 , V_23 , V_240 , V_125 ) ) {
if ( F_241 ( V_125 , V_31 -> V_13 -> V_121 -> V_125 ) )
goto V_164;
} else {
if ( V_31 == V_22 -> V_234 )
goto V_164;
...
F_137 ( & V_22 -> V_162 ) ;
V_230 = F_276 ( V_22 , V_23 , V_31 ) ;
goto V_164;
V_243:
F_79 ( & V_22 -> V_234 -> V_13 -> V_67 ) ;
F_75 ( V_22 -> V_234 ) ;
F_80 ( & V_22 -> V_234 -> V_13 -> V_67 ) ;
V_230 = F_276 ( V_22 , V_23 , V_22 -> V_234 ) ;
V_164:
F_138 ( & V_22 -> V_162 ) ;
F_78 ( V_230 ) ;
}
...
V_14 = F_214 ( V_22 , V_248 [ V_244 ] ) ;
F_285 ( ! V_14 && ( V_22 -> V_224 . V_109 != & V_22 -> V_234 -> V_223 ||
V_22 -> V_224 . V_131 != & V_22 -> V_234 -> V_223 ) ,
L_14 , V_22 -> V_99 ) ;
return V_14 ;
} else {
return F_214 ( V_22 , V_249 [ V_244 ] ) ;
}
}
static int F_286 ( int V_77 , unsigned int V_30 ,
const char * V_99 )
{
...
F_176 ( L_15 ,
V_77 , V_99 , 1 , V_250 ) ;
return F_287 ( V_77 , 1 , V_250 ) ;
}
struct V_21 * F_288 ( const char * V_253 ,
unsigned int V_30 ,
int V_77 ,
struct V_254 * V_255 ,
const char * V_256 , ... )
...
va_end ( args ) ;
V_77 = V_77 ? : V_261 ;
V_77 = F_286 ( V_77 , V_30 , V_22 -> V_99 ) ;
V_22 -> V_30 = V_30 ;
V_22 -> V_172 = V_77 ;
F_247 ( & V_22 -> V_162 ) ;
F_166 ( & V_22 -> V_79 , 0 ) ;
...
F_124 ( & V_22 -> V_163 ) ;
F_124 ( & V_22 -> V_135 ) ;
F_289 ( & V_22 -> V_161 , V_256 , V_255 , 0 ) ;
F_124 ( & V_22 -> V_159 ) ;
if ( F_282 ( V_22 ) < 0 )
goto V_260;
if ( V_30 & V_262 ) {
...
goto V_263;
V_133 -> V_146 = V_22 ;
V_133 -> V_52 = F_290 ( F_155 , V_133 , L_16 ,
V_22 -> V_99 ) ;
if ( F_129 ( V_133 -> V_52 ) ) {
F_134 ( V_133 ) ;
goto V_263;
...
F_207 (node) {
V_31 = F_277 ( V_22 -> V_24 [ V_23 ] ) ;
F_292 ( V_22 -> V_24 [ V_23 ] , NULL ) ;
F_78 ( V_31 ) ;
}
V_31 = V_22 -> V_234 ;
V_22 -> V_234 = NULL ;
...
void F_204 ( struct V_21 * V_22 , int V_77 )
{
struct V_20 * V_31 ;
if ( F_10 ( V_22 -> V_30 & V_196 ) )
return;
V_77 = F_286 ( V_77 , V_22 -> V_30 , V_22 -> V_99 ) ;
F_137 ( & V_22 -> V_162 ) ;
V_22 -> V_172 = V_77 ;
F_167 (pwq, wq)
F_263 ( V_31 ) ;
...
bool F_294 ( int V_54 , struct V_21 * V_22 )
{
struct V_20 * V_31 ;
bool V_14 ;
F_206 () ;
...
void F_298 ( const char * V_271 , struct V_53 * V_52 )
{
T_1 * V_175 = NULL ;
char V_99 [ V_272 ] = { } ;
char V_269 [ V_273 ] = { } ;
...
F_300 ( & V_31 , & V_50 -> V_91 , sizeof( V_31 ) ) ;
F_300 ( & V_22 , & V_31 -> V_22 , sizeof( V_22 ) ) ;
F_300 ( V_99 , V_22 -> V_99 , sizeof( V_99 ) - 1 ) ;
F_300 ( & V_270 , & V_50 -> V_270 , sizeof( V_270 ) ) ;
if ( V_270 )
F_300 ( V_269 , V_50 -> V_269 , sizeof( V_269 ) - 1 ) ;
if ( V_175 || V_99 [ 0 ] || V_269 [ 0 ] ) {
F_301 ( L_17 , V_271 , V_99 , V_175 ) ;
if ( V_269 [ 0 ] )
F_302 ( L_18 , V_269 ) ;
F_302 ( L_12 ) ;
}
...
int V_274 ;
F_20 ( & V_13 -> V_118 ) ;
if ( ! F_309 ( V_54 , V_13 -> V_121 -> V_125 ) )
return;
F_272 ( & V_125 , V_13 -> V_121 -> V_125 , V_276 ) ;
if ( F_310 ( & V_125 ) != 1 )
return;
F_305 (worker, wi, pool)
F_9 ( F_131 ( V_50 -> V_52 ,
...
static int F_311 ( struct V_277 * V_278 ,
unsigned long V_279 ,
void * V_280 )
{
...
{
struct V_291 * V_292 = F_160 ( V_6 , struct V_291 , V_6 ) ;
V_292 -> V_14 = V_292 -> V_175 ( V_292 -> V_293 ) ;
}
long F_315 ( int V_54 , long (* V_175)( void * ) , void * V_293 )
{
struct V_291 V_292 = { . V_175 = V_175 , . V_293 = V_293 } ;
F_162 ( & V_292 . V_6 , F_314 ) ;
F_193 ( V_54 , & V_292 . V_6 ) ;
F_182 ( & V_292 . V_6 ) ;
return V_292 . V_14 ;
}
void F_316 ( void )
...
F_265 ( ! V_295 ) ;
F_207 (node)
F_265 ( ! F_323 ( & V_295 [ V_23 ] , V_18 ,
F_324 ( V_23 ) ? V_23 : V_211 ) ) ;
F_283 (cpu) {
V_23 = F_105 ( V_54 ) ;
if ( F_10 ( V_23 == V_211 ) ) {
F_176 ( L_20 , V_54 ) ;
...
int V_266 , V_54 ;
F_10 ( F_327 ( struct V_20 ) < F_327 (long long) ) ;
V_221 = F_328 ( V_20 , V_300 ) ;
F_329 ( F_311 , V_301 ) ;
F_330 ( F_313 , V_302 ) ;
F_319 () ;
F_283 (cpu) {
...
F_265 ( F_242 ( V_13 ) ) ;
V_13 -> V_54 = V_54 ;
F_234 ( V_13 -> V_121 -> V_125 , F_331 ( V_54 ) ) ;
...
V_174 = F_332 ( L_21 , 0 , 0 ) ;
V_290 = F_332 ( L_22 , V_245 , 0 ) ;
V_303 = F_332 ( L_23 , 0 , 0 ) ;
V_304 = F_332 ( L_24 , V_69 ,
V_251 ) ;
V_305 = F_332 ( L_25 ,
V_226 , 0 ) ;
V_306 = F_332 ( L_26 ,
