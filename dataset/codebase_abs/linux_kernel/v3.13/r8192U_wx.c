...
if( V_26 == 1 && ( 4 * V_26 + 1 ) == V_6 -> V_107 . V_28 ) V_103 = 0x00 ;
if( V_26 == 3 && ( 4 * V_26 + 1 ) == V_6 -> V_107 . V_28 ) V_103 = 0x00 ;
...
case 0 : V_104 = V_76 -> V_109 ; break;
case 1 : V_104 = 0 ; break;
case 2 : V_104 = 1 ; break;
case 3 : V_104 = 2 ; break;
case 4 : V_104 = 3 ; break;
default: break;
}
...
static int F_59 ( struct V_1 * V_2 , struct V_3 * V_113 , union
V_5 * V_6 , char * V_114 ) {
struct V_8 * V_9 = F_2 ( V_2 ) ;
int * V_17 = ( int * ) V_114 ;
int V_115 = V_17 [ 0 ] ;
