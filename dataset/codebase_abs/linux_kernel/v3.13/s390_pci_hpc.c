...
if ( ! V_7 )
return 0 ;
V_5 = F_19 ( sizeof( * V_5 ) , V_24 ) ;
if ( ! V_5 )
goto error;
V_10 = F_19 ( sizeof( * V_10 ) , V_24 ) ;
if ( ! V_10 )
goto V_25;
V_10 -> V_11 = V_5 ;
V_5 -> V_10 = V_10 ;
V_5 -> V_7 = V_7 ;
V_19 = F_19 ( sizeof( * V_19 ) , V_24 ) ;
if ( ! V_19 )
goto V_26;
V_10 -> V_19 = V_19 ;
V_10 -> V_27 = & V_28 ;
...
void F_22 ( struct V_20 * V_7 )
{
struct V_36 * V_37 , * V_38 ;
struct V_5 * V_5 ;
F_23 (tmp, n, &s390_hotplug_slot_list) {
V_5 = F_24 ( V_37 , struct V_5 , V_33 ) ;
if ( V_5 -> V_7 != V_7 )
continue;
F_25 ( & V_5 -> V_33 ) ;
F_26 ( V_5 -> V_10 ) ;
