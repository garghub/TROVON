...
T_3 V_56 = F_26 ( V_12 -> V_57 . V_56 ) ;
V_55 = ( int ) F_27 () ;
F_28 ( V_11 , 0x80c6 , & V_55 , 4 ) ;
F_5 ( V_12 , 0x0301 , 0x0000 ) ;
switch ( F_26 ( V_12 -> V_57 . V_56 ) ) {
case V_58 :
case V_59 :
case V_60 :
case V_61 :
...
struct V_8 * V_50 )
{
int V_62 = F_29 ( V_7 , V_50 ) ;
if ( V_62 < 0 )
F_23 ( V_7 ) ;
return V_62 ;
}
void F_42 ( struct V_8 * V_50 )
{
F_25 ( V_50 ) ;
}
...
V_50 = F_4 ( V_7 ) ;
F_44 ( & V_50 -> V_72 ) ;
V_56 = F_26 ( V_50 -> V_11 . V_12 -> V_57 . V_56 ) ;
if ( F_1 ( V_56 ) ) {
F_45 ( & V_7 -> V_5 , & V_70 ) ;
F_45 ( & V_7 -> V_5 , & V_71 ) ;
}
