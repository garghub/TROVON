...
V_133 -> V_170 = V_106 -> V_191 ;
V_133 -> V_171 = V_106 -> V_192 ;
V_133 -> V_164 |= V_173 | V_174 ;
F_65 ( V_133 , V_106 -> V_193 ) ;
memset ( V_142 , 0 , sizeof( * V_142 ) ) ;
V_142 -> V_134 = V_133 ;
V_142 -> V_178 = V_106 -> V_194 ;
F_54 ( & V_135 -> V_117 ) ;
...
{
struct V_31 * V_19 = V_3 -> V_107 ;
struct V_189 * V_106 = & V_19 -> V_108 . V_195 ;
struct V_65 * V_66 = V_3 -> V_45 ;
struct V_28 * V_29 = F_14 ( V_66 ) ;
T_1 V_120 = F_48 ( V_66 , V_106 -> V_191 ) ;
T_1 V_196 = F_48 ( V_66 , V_106 -> V_192 ) ;
int V_39 = 0 ;
if ( V_106 -> V_192 == V_172 )
V_196 = V_131 ;
V_39 = F_68 ( V_11 , V_29 , V_120 , V_196 , 0 ,
V_106 -> V_197 == V_198 ) ;
if ( V_39 > 0 ) {
V_106 -> V_199 += V_39 ;
V_39 = 0 ;
}
if ( V_106 -> V_197 == V_200 ) {
int V_114 ;
V_114 = F_69 ( V_11 , V_29 , V_120 , V_196 ) ;
if ( V_39 == 0 )
V_39 = V_114 ;
...
const struct V_12 * V_3 )
{
struct V_189 * V_106 = & V_3 -> V_107 -> V_108 . V_195 ;
struct V_65 * V_66 = V_3 -> V_45 ;
T_1 V_120 = F_48 ( V_66 , V_106 -> V_191 ) ;
T_1 V_196 = F_48 ( V_66 , V_106 -> V_192 ) ;
int V_39 = 0 ;
if ( V_106 -> V_197 == V_201 ) {
V_39 = F_69 ( V_11 , F_14 ( V_66 ) , V_120 , V_196 ) ;
} else if ( V_106 -> V_197 == V_200 ) {
struct V_9 * V_13 = F_4 ( V_11 , V_3 ) ;
struct V_115 * V_135 = & V_13 -> V_136 ;
F_58 ( & V_135 -> V_117 ) ;
if ( V_39 == 0 )
...
const struct V_2 * V_3 , int V_203 )
{
struct V_1 * V_204 ;
V_204 = F_1 ( V_3 ) ;
F_75 ( V_204 , V_205 ) ;
...
if ( V_207 & V_216 ) {
V_209 = V_3 -> V_217 ;
F_8 ( ! F_18 ( & V_209 -> V_218 ) ) ;
V_210 = F_81 ( V_209 -> V_218 . V_219 ,
struct V_16 , V_220 ) ;
V_30 = F_6 ( V_210 ) ;
V_210 = V_30 -> V_87 . V_88 ;
V_212 = F_82 ( V_11 , V_210 -> V_221 , V_210 , NULL , 1 , 1 ) ;
if ( V_212 == NULL ) {
struct V_222 * V_223 ;
struct V_211 * V_224 ;
V_223 = V_222 ( V_210 -> V_221 ) ;
F_83 (scan, &head->coh_locks,
cll_linkage)
F_84 ( V_122 , V_11 , V_224 ,
L_14 ) ;
F_44 ( V_122 , V_11 , V_210 ,
L_15 ) ;
F_85 () ;
F_86 () ;
}
V_214 = F_87 ( V_212 ) ;
F_8 ( V_214 != NULL ) ;
F_8 ( F_88 ( V_30 -> V_225 , V_214 -> V_226 == NULL ) ) ;
if ( V_214 -> V_226 != NULL ) {
V_133 -> V_227 = V_214 -> V_226 -> V_228 ;
V_133 -> V_164 |= V_216 ;
}
F_89 ( V_11 , V_212 ) ;
}
...
struct V_9 * V_13 = F_5 ( V_11 ) ;
F_91 ( V_13 , V_14 ) ;
F_92 ( V_19 , & V_13 -> V_14 , V_66 , & V_229 ) ;
return 0 ;
}
int F_93 ( const struct V_10 * V_11 , struct V_230 * V_93 ,
struct V_208 * V_231 )
{
struct V_1 * V_204 ;
int V_39 ;
F_94 ( V_204 , V_205 , V_232 ) ;
if ( V_204 != NULL ) {
F_95 ( V_231 , & V_204 -> V_8 , V_93 , & V_233 ) ;
V_39 = 0 ;
} else
V_39 = - V_234 ;
return V_39 ;
