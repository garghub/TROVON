...
{
struct V_45 * V_46 = F_32 ( & V_13 -> V_7 ) ;
struct V_1 * V_2 ;
int V_47 , V_48 ;
int V_5 = 0 ;
V_2 = F_33 ( & V_13 -> V_7 , sizeof( struct V_1 ) ,
V_33 ) ;
if ( ! V_2 ) {
F_2 ( & V_13 -> V_7 ,
L_16 ) ;
...
for ( V_48 = 0 ; V_48 < F_38 ( V_55 ) ; V_48 ++ ) {
...
V_5 = F_39 ( V_2 -> V_7 , 0 , V_55 ,
F_38 ( V_55 ) , NULL , 0 , NULL ) ;
if ( V_5 != 0 ) {
...
static int F_43 ( struct V_60 * V_7 )
{
...
static int F_45 ( struct V_60 * V_7 )
{
struct V_42 * V_13 = F_44 ( V_7 ) ;
struct V_1 * V_2 = F_41 ( V_13 ) ;
