...
void F_55 ( struct V_109 * V_110 )
{
struct V_1 * V_2 = F_56 ( V_110 ) ;
F_51 ( V_2 ) ;
}
...
int F_66 ( struct V_116 * V_117 , void * V_118 )
{
struct V_109 * V_110 = (struct V_109 * ) V_117 -> V_119 ;
struct V_1 * V_2 = F_56 ( V_110 ) ;
struct V_44 * V_19 = V_2 -> V_3 . V_19 ;
struct V_7 * V_8 ;
struct V_120 * V_121 ;
...
if ( ! V_121 )
goto V_50;
F_68 ( V_117 , L_17 , V_110 -> V_126 ) ;
F_68 ( V_117 , L_18 , L_19 ,
L_20 , L_21 , L_22 ) ;
for ( V_18 = 0 ; V_18 < V_19 -> V_20 ; V_18 ++ ) {
V_17 = & V_19 -> V_21 [ V_18 ] ;
F_25 () ;
...
goto V_50;
V_127 = (struct V_127 * ) ( V_33 -> V_36 + V_34 ) ;
if ( V_127 -> V_130 != F_73 ( V_131 ) )
goto V_50;
if ( F_36 ( ! F_72 ( V_33 , V_34 + V_37 +
F_74 ( V_33 -> V_132 ) ) ) )
goto V_50;
V_38 = (struct V_38 * ) ( V_33 -> V_36 + V_34 + V_37 ) ;
if ( V_38 -> V_133 != F_73 ( V_134 ) )
goto V_50;
if ( V_38 -> V_135 != F_73 ( V_136 ) )
goto V_50;
if ( V_38 -> V_137 != V_39 )
goto V_50;
if ( V_38 -> V_138 != 4 )
...
F_77 ( V_59 ) || F_78 ( V_59 ) )
goto V_50;
V_128 = F_18 ( V_33 , V_34 ) ;
if ( F_79 ( V_128 ) || F_80 ( V_128 ) )
goto V_50;
if ( V_38 -> V_139 != F_73 ( V_140 ) ) {
V_129 = F_20 ( V_33 , V_34 ) ;
if ( F_79 ( V_129 ) ||
F_80 ( V_129 ) )
goto V_50;
}
type = F_81 ( V_38 -> V_139 ) ;
V_50:
return type ;
}
...
V_143 = F_86 ( V_145 , V_131 , V_58 ,
V_2 -> V_146 , V_59 , V_128 ,
V_8 -> V_46 , V_128 ) ;
if ( ! V_143 )
goto V_50;
if ( V_41 & V_141 )
V_143 = F_87 ( V_143 , F_73 ( V_147 ) ,
V_41 & V_148 ) ;
F_88 ( V_143 ) ;
V_143 -> V_149 = F_89 ( V_143 ,
V_2 -> V_146 ) ;
V_2 -> V_150 . V_151 ++ ;
...
V_155 = F_92 ( V_2 , V_143 ,
V_68 ,
V_41 ) ;
else
V_155 = F_93 ( V_2 , V_143 , V_41 ) ;
if ( V_155 != V_156 ) {
F_48 ( V_2 , V_157 ) ;
V_81 = true ;
}
...
if ( V_159 -> V_160 )
goto V_50;
V_41 = F_82 ( V_159 -> V_33 , & V_34 ) ;
type = F_71 ( V_2 , V_159 -> V_33 , V_34 ) ;
if ( type != V_140 )
goto V_50;
