...
V_7 = V_22 -> V_47 -> V_91 -> V_148 ;
F_21 ( V_7 != NULL ) ;
F_60 ( & V_22 -> V_34 , & V_149 ) ;
V_24 = F_61 ( & V_22 -> V_34 , & V_150 ) ;
if ( V_24 == NULL ) {
...
V_27 = F_77 ( & V_24 -> V_151 [ 0 ] , 0 ) ;
if ( V_27 < 0 )
F_28 ( L_34 , V_27 ) ;
}
V_5 = F_78 ( & V_24 -> V_151 [ 0 ] , 0 ) ;
if ( ! V_5 ) {
F_13 ( V_17 , L_35 V_110 L_36
L_37 , V_24 -> V_151 [ 0 ] . V_112 ) ;
V_27 = F_43 ( V_22 , - V_40 ) ;
F_64 ( V_22 , L_38 , V_27 ,
& V_24 -> V_151 [ 0 ] ) ;
return 0 ;
...
case V_128 :
F_13 ( V_157 , L_43 ) ;
F_81 ( & V_22 -> V_34 , & V_159 ) ;
F_43 ( V_22 , 0 ) ;
F_15 ( V_22 , V_7 , V_24 , V_5 ) ;
break;
case V_130 :
F_13 ( V_157 , L_44 ) ;
F_81 ( & V_22 -> V_34 , & V_160 ) ;
...
static struct V_65 * F_83 ( struct V_68 * V_69 )
{
struct V_65 * V_66 = NULL ;
static unsigned int V_161 = 0 ;
F_46 ( & V_69 -> V_71 ) ;
if ( ! F_84 ( & V_69 -> V_76 ) &&
( F_84 ( & V_69 -> V_75 ) || V_161 == 0 ) )
V_66 = F_85 ( V_69 -> V_76 . V_162 ,
struct V_65 , V_74 ) ;
else
if ( ! F_84 ( & V_69 -> V_75 ) )
V_66 = F_85 ( V_69 -> V_75 . V_162 ,
struct V_65 ,
V_74 ) ;
if ( V_66 ) {
if ( ++ V_161 >= F_86 ( & V_69 -> V_163 ) )
V_161 = 0 ;
F_87 ( & V_66 -> V_74 ) ;
}
F_48 ( & V_69 -> V_71 ) ;
...
{
struct V_164 V_165 = { . V_166 = V_69 } ;
struct V_167 * V_168 ;
F_51 ( & V_165 . V_169 ) ;
V_165 . V_170 = F_86 ( & V_69 -> V_163 ) ;
snprintf ( V_165 . V_171 , sizeof( V_165 . V_171 ) ,
L_45 , V_165 . V_170 ) ;
V_168 = F_89 ( V_172 , & V_165 , L_46 , V_165 . V_171 ) ;
if ( F_90 ( V_168 ) ) {
F_28 ( L_47 ,
F_86 ( & V_69 -> V_163 ) , F_91 ( V_168 ) ) ;
return F_91 ( V_168 ) ;
}
F_49 ( & V_165 . V_169 ) ;
return 0 ;
...
( V_66 = F_83 ( V_69 ) ) != NULL ,
& V_176 ) ;
V_177 = F_96 ( & V_69 -> V_174 ) ;
} else {
V_177 = F_86 ( & V_69 -> V_174 ) ;
}
if ( V_66 -> V_85 == NULL )
break;
if ( F_22 ( V_177 < V_69 -> V_178 &&
V_177 >= F_86 ( & V_69 -> V_163 ) &&
! V_66 -> V_84 ) )
F_88 ( V_69 ) ;
if ( V_66 -> V_84 )
F_97 () ;
...
static unsigned
F_108 ( struct V_183 * V_184 , const void * V_92 , unsigned V_185 )
{
return F_109 ( ( (struct V_108 * ) V_92 ) -> V_112 , V_185 ) ;
}
static void *
F_110 ( struct V_186 * V_187 )
{
struct V_4 * V_5 ;
V_5 = F_111 ( V_187 , struct V_4 , V_188 ) ;
return & V_5 -> V_189 ;
}
static void
F_112 ( struct V_186 * V_187 , void * V_92 )
{
struct V_4 * V_5 ;
V_5 = F_111 ( V_187 , struct V_4 , V_188 ) ;
V_5 -> V_189 = * (struct V_108 * ) V_92 ;
}
static int
F_113 ( const void * V_92 , struct V_186 * V_187 )
{
return F_114 ( F_110 ( V_187 ) , V_92 ) ;
}
static void *
F_115 ( struct V_186 * V_187 )
{
return F_111 ( V_187 , struct V_4 , V_188 ) ;
}
static void
F_116 ( struct V_183 * V_184 , struct V_186 * V_187 )
{
struct V_4 * V_5 ;
V_5 = F_111 ( V_187 , struct V_4 , V_188 ) ;
F_117 ( V_5 ) ;
...
static void
F_118 ( struct V_183 * V_184 , struct V_186 * V_187 )
{
struct V_4 * V_5 ;
V_5 = F_111 ( V_187 , struct V_4 , V_188 ) ;
F_14 ( V_5 ) ;
}
int F_119 ( struct V_190 * exp )
{
exp -> V_191 =
F_120 ( F_121 ( & exp -> V_192 ) ,
V_193 ,
V_194 ,
V_195 , 0 ,
V_196 , V_197 ,
...
V_69 -> V_244 = V_69 -> V_178 = \
F_132 ( int , V_230 , F_133 ( int , V_226 ,
V_232 ) ) ;
}
for ( V_204 = 0 ; V_204 < V_69 -> V_244 ; V_204 ++ ) {
V_27 = F_88 ( V_69 ) ;
if ( V_27 < 0 )
GOTO ( V_37 , V_27 ) ;
}
...
F_101 ( V_69 , sizeof( * V_69 ) ) ;
}
if ( V_70 -> V_242 != NULL )
F_138 ( V_70 -> V_242 ) ;
F_139 () ;
F_101 ( V_70 , sizeof( * V_70 ) ) ;
V_70 = NULL ;
return 0 ;
}
int F_140 ( void )
