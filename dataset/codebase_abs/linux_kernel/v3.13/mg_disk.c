...
static void F_48 ( unsigned long V_122 )
{
...
static int F_58 ( struct V_139 * V_34 )
{
...
if ( ! V_33 -> V_38 )
F_28 ( V_64 , ( unsigned long ) V_2 -> V_20 + V_65 ) ;
F_28 ( V_140 , ( unsigned long ) V_2 -> V_20 + V_67 ) ;
F_16 ( 1 ) ;
if ( F_9 ( V_2 , V_40 , V_72 ) ) {
if ( ! V_33 -> V_38 )
F_28 ( 0 , ( unsigned long ) V_2 -> V_20 + V_65 ) ;
...
static int F_59 ( struct V_139 * V_34 )
{
struct V_32 * V_33 = V_34 -> V_35 ;
struct V_1 * V_2 = V_33 -> V_2 ;
if ( F_9 ( V_2 , V_40 , V_72 ) )
return - V_98 ;
F_28 ( V_141 , ( unsigned long ) V_2 -> V_20 + V_67 ) ;
F_16 ( 1 ) ;
if ( F_9 ( V_2 , V_40 , V_72 ) )
return - V_98 ;
if ( ! V_33 -> V_38 )
...
struct V_1 * V_2 ;
struct V_144 * V_145 ;
struct V_32 * V_33 = V_143 -> V_34 . V_35 ;
int V_3 = 0 ;
if ( ! V_33 ) {
F_6 ( V_12 L_32 ,
V_146 , __LINE__ ) ;
...
F_75 ( V_2 -> V_120 , V_173 ) ;
F_76 ( V_2 -> V_120 , V_69 ) ;
F_77 ( & V_2 -> V_49 ) ;
V_2 -> V_49 . V_174 = F_48 ;
V_2 -> V_49 . V_122 = ( unsigned long ) V_2 ;
V_2 -> V_175 = F_78 ( V_176 ) ;
if ( ! V_2 -> V_175 ) {
F_6 ( V_12 L_45 ,
V_146 , __LINE__ ) ;
V_3 = - V_150 ;
...
V_2 -> V_175 -> V_151 = V_2 -> V_151 ;
V_2 -> V_175 -> V_178 = 0 ;
V_2 -> V_175 -> V_179 = & V_180 ;
V_2 -> V_175 -> V_181 = V_2 -> V_120 ;
V_2 -> V_175 -> V_113 = V_2 ;
sprintf ( V_2 -> V_175 -> V_11 , V_9 L_46 ) ;
F_79 ( V_2 -> V_175 , V_2 -> V_75 ) ;
F_80 ( V_2 -> V_175 ) ;
return V_3 ;
V_177:
F_81 ( & V_2 -> V_49 ) ;
