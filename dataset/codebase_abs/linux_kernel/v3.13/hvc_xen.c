...
if ( V_5 )
goto V_64;
V_5 = F_61 ( V_58 , V_55 -> V_60 , L_6 , L_7 ) ;
if ( V_5 )
goto V_64;
V_5 = F_62 ( V_58 , 0 ) ;
if ( V_5 ) {
...
static void F_78 ( struct V_47 * V_47 , const char * string ,
unsigned V_13 )
{
unsigned int V_87 , V_88 = 0 ;
const char * V_89 ;
if ( ! F_29 () )
return;
F_18 ( 0 , string , V_13 ) ;
...
return;
F_12 ( 0 , L_11 , 8 ) ;
while ( V_88 < V_13 && NULL != ( V_89 = strchr ( string + V_88 , '\n' ) ) ) {
V_87 = V_89 - string + V_88 ;
if ( V_88 + V_87 > V_13 )
break;
F_12 ( 0 , string + V_88 , V_87 ) ;
F_12 ( 0 , L_12 , 2 ) ;
V_88 += V_87 + 1 ;
}
if ( V_88 < V_13 )
F_12 ( 0 , string + V_88 , V_13 - V_88 ) ;
}
void F_79 ( const char * V_29 )
{
T_7 V_13 = strlen ( V_29 ) ;
int V_30 = 0 ;
if ( F_71 () ) {
...
void F_83 ( const char * V_93 , ... )
{
static char V_23 [ 512 ] ;
T_8 V_94 ;
va_start ( V_94 , V_93 ) ;
vsnprintf ( V_23 , sizeof( V_23 ) , V_93 , V_94 ) ;
va_end ( V_94 ) ;
F_79 ( V_23 ) ;
}
