...
static int F_41 ( struct V_145 * V_32 , T_1 V_23 ,
...
if ( ! V_147 ) {
V_80 = F_43 ( V_32 , V_23 , & V_149 ) ;
if ( V_80 )
goto V_80;
}
if ( F_38 ( V_32 ) ) {
V_80 = F_44 ( V_32 , V_153 ) ;
if ( V_80 )
goto V_80;
}
V_5 = F_45 ( V_32 , NULL ) ;
...
if ( ( V_149 & V_154 ) &&
F_46 ( V_32 , V_23 & V_149 , V_5 -> V_155 , NULL ) == 0 ) {
V_5 -> type = V_89 ;
if ( V_146 && ( V_146 -> type != V_89 ||
memcmp ( V_5 -> V_155 , V_146 -> V_155 , sizeof( V_5 -> V_155 ) ) != 0 ) ) {
F_47 ( V_5 ) ;
return - V_156 ;
}
} else {
...
if ( V_32 -> V_107 -> V_157 )
V_32 -> V_107 -> V_157 ( V_32 , V_5 ) ;
if ( ! V_147 && ( V_149 & V_23 & V_26 ) ) {
V_80 = F_48 ( V_32 , V_158 ,
V_23 ) ;
if ( V_80 == - V_159 ) {
F_49 ( V_32 ) ;
F_50 ( V_32 ) ;
F_51 ( V_32 , V_32 -> V_160 ) ;
F_47 ( V_5 ) ;
V_148 -- ;
goto V_152;
} else if ( V_80 ) {
...
if ( ! V_147 && ! F_38 ( V_32 ) ) {
V_80 = F_52 ( V_32 , & V_5 -> V_161 ) ;
if ( V_80 )
goto remove;
if ( V_146 )
V_146 -> V_161 = V_5 -> V_161 ;
}
...
goto remove;
if ( V_146 ) {
int V_164 = ( V_5 -> V_19 . V_18 == V_146 -> V_19 . V_18 &&
...
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
for ( V_167 = 0 ; V_167 < V_32 -> V_5 -> V_168 ; V_167 ++ ) {
if ( V_32 -> V_5 -> V_1 [ V_167 ] ) {
F_11 ( V_32 -> V_5 -> V_1 [ V_167 ] ) ;
V_32 -> V_5 -> V_1 [ V_167 ] = NULL ;
}
}
F_47 ( V_32 -> V_5 ) ;
V_32 -> V_5 = NULL ;
}
static int F_63 ( struct V_145 * V_32 )
{
return F_55 ( V_32 -> V_5 ) ;
}
static void F_64 ( struct V_145 * V_32 )
{
int V_80 ;
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
if ( V_32 -> V_71 & V_169 ) {
V_80 = F_65 ( & V_32 -> V_5 -> V_165 ) ;
if ( V_80 < 0 ) {
F_66 ( & V_32 -> V_5 -> V_165 ) ;
goto V_10;
}
...
static int F_73 ( struct V_145 * V_32 )
{
int V_167 , V_80 = 0 ;
for ( V_167 = 0 ; V_167 < V_32 -> V_5 -> V_168 ; V_167 ++ ) {
struct V_1 * V_2 = V_32 -> V_5 -> V_1 [ V_167 ] ;
if ( V_2 && F_74 ( V_2 ) && V_2 -> V_165 . V_170 ) {
const struct V_171 * V_172 = V_2 -> V_165 . V_170 -> V_173 ;
if ( ! V_172 || ! V_172 -> V_174 || ! V_172 -> V_175 ) {
V_80 = - V_176 ;
break;
}
}
...
static int F_75 ( struct V_145 * V_32 )
{
int V_167 , V_80 = 0 ;
for ( V_167 = 0 ; V_167 < V_32 -> V_5 -> V_168 ; V_167 ++ ) {
struct V_1 * V_2 = V_32 -> V_5 -> V_1 [ V_167 ] ;
...
if ( V_2 && F_74 ( V_2 ) && V_2 -> V_165 . V_170 ) {
const struct V_171 * V_172 = V_2 -> V_165 . V_170 -> V_173 ;
V_172 -> V_175 ( & V_2 -> V_165 ) ;
}
}
if ( ! V_80 && F_76 ( V_32 ) && F_77 ( V_32 ) ) {
F_67 ( V_32 ) ;
F_20 ( V_32 -> V_5 ) ;
F_69 ( V_32 ) ;
}
...
if ( F_83 ( V_32 ) || ! F_76 ( V_32 ) ) {
F_49 ( V_32 ) ;
F_50 ( V_32 ) ;
V_80 = F_41 ( V_32 , V_32 -> V_5 -> V_23 , V_32 -> V_5 ,
F_76 ( V_32 ) ) ;
} else if ( F_76 ( V_32 ) && F_77 ( V_32 ) ) {
V_80 = F_22 ( V_32 -> V_5 ) ;
if ( V_80 > 0 ) {
F_21 ( V_32 , V_84 ) ;
V_80 = 0 ;
...
F_84 ( V_32 -> V_178 ) ;
F_69 ( V_32 ) ;
for ( V_167 = 0 ; ! V_80 && V_167 < V_32 -> V_5 -> V_168 ; V_167 ++ ) {
struct V_1 * V_2 = V_32 -> V_5 -> V_1 [ V_167 ] ;
if ( V_2 && F_74 ( V_2 ) && V_2 -> V_165 . V_170 ) {
const struct V_171 * V_172 = V_2 -> V_165 . V_170 -> V_173 ;
V_80 = V_172 -> V_175 ( & V_2 -> V_165 ) ;
}
}
V_32 -> V_179 &= ~ V_180 ;
return V_80 ;
}
static int F_85 ( struct V_145 * V_32 )
{
int V_3 ;
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
...
static int F_87 ( struct V_145 * V_32 )
{
F_72 ( V_32 ) ;
return 0 ;
}
static int F_88 ( struct V_145 * V_32 )
{
F_79 ( V_32 , V_32 -> V_5 -> V_23 ) ;
return F_85 ( V_32 ) ;
}
int F_89 ( struct V_145 * V_32 )
{
int V_80 , V_167 , V_181 ;
T_1 V_23 , V_149 ;
struct V_12 * V_5 ;
F_6 ( ! V_32 ) ;
F_42 ( ! V_32 -> V_151 ) ;
...
F_90 ( V_32 , & V_182 ) ;
if ( V_32 -> V_183 )
V_32 -> V_160 = V_32 -> V_183 ;
V_149 = F_91 ( V_32 , V_23 ) ;
if ( ! V_149 ) {
V_80 = - V_33 ;
goto V_80;
}
V_80 = F_41 ( V_32 , V_149 , NULL , 0 ) ;
if ( V_80 )
goto V_80;
V_5 = V_32 -> V_5 ;
if ( V_32 -> V_71 & V_169 ) {
...
V_5 -> V_168 = 0 ;
for ( V_167 = 0 ; V_167 < V_181 ; V_167 ++ , V_5 -> V_168 ++ ) {
V_80 = F_5 ( V_32 -> V_5 , V_167 + 1 ) ;
if ( V_80 )
goto remove;
if ( V_32 -> V_71 & V_169 )
F_82 ( & V_5 -> V_1 [ V_167 ] -> V_165 ) ;
}
F_69 ( V_32 ) ;
V_80 = F_92 ( V_32 -> V_5 ) ;
if ( V_80 )
goto V_184;
for ( V_167 = 0 ; V_167 < V_181 ; V_167 ++ ) {
V_80 = F_93 ( V_32 -> V_5 -> V_1 [ V_167 ] ) ;
if ( V_80 )
goto V_184;
}
F_67 ( V_32 ) ;
