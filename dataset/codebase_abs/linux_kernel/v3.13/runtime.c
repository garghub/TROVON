...
V_2 -> V_6 . V_47 = true ;
if ( V_2 -> V_54 )
F_25 = V_2 -> V_54 -> V_55 . V_56 ;
else if ( V_2 -> type && V_2 -> type -> V_57 )
F_25 = V_2 -> type -> V_57 -> V_56 ;
else if ( V_2 -> V_58 && V_2 -> V_58 -> V_57 )
F_25 = V_2 -> V_58 -> V_57 -> V_56 ;
else if ( V_2 -> V_59 && V_2 -> V_59 -> V_57 )
F_25 = V_2 -> V_59 -> V_57 -> V_56 ;
else
F_25 = NULL ;
if ( ! F_25 && V_2 -> V_60 && V_2 -> V_60 -> V_57 )
F_25 = V_2 -> V_60 -> V_57 -> V_56 ;
if ( F_25 )
V_32 = F_22 ( F_25 , V_2 ) ;
V_2 -> V_6 . V_47 = false ;
F_29 ( & V_2 -> V_6 . V_61 ) ;
V_24:
F_28 ( V_2 , V_53 , V_32 ) ;
return V_32 ? V_32 : F_30 ( V_2 , V_44 | V_62 ) ;
}
...
V_2 -> V_6 . V_33 = V_32 ;
return V_32 != - V_35 ? V_32 : - V_65 ;
}
static int F_30 ( struct V_1 * V_2 , int V_44 )
__releases( &dev->power.lock
static int F_34 ( struct V_1 * V_2 , int V_44 )
__releases( &dev->power.lock
static void F_35 ( struct V_66 * V_52 )
{
