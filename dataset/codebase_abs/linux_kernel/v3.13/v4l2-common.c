...
F_11 ( V_41 , V_45 ) ;
V_41 -> V_6 |= V_46 ;
V_41 -> V_47 = V_43 -> V_48 . V_49 -> V_47 ;
V_41 -> V_48 = & V_43 -> V_48 ;
F_12 ( V_41 , V_43 ) ;
F_13 ( V_43 , V_41 ) ;
snprintf ( V_41 -> V_25 , sizeof( V_41 -> V_25 ) , L_1 ,
V_43 -> V_48 . V_49 -> V_25 , F_14 ( V_43 -> V_50 ) ,
V_43 -> V_51 ) ;
}
...
V_43 = F_19 ( V_50 , V_56 ) ;
if ( V_43 == NULL || V_43 -> V_48 . V_49 == NULL )
goto error;
if ( ! F_20 ( V_43 -> V_48 . V_49 -> V_47 ) )
goto error;
V_41 = F_21 ( V_43 ) ;
if ( F_22 ( V_53 , V_41 ) )
V_41 = NULL ;
F_23 ( V_43 -> V_48 . V_49 -> V_47 ) ;
error:
if ( V_43 && V_41 == NULL )
F_24 ( V_43 ) ;
return V_41 ;
...
F_11 ( V_41 , V_45 ) ;
V_41 -> V_6 |= V_72 ;
V_41 -> V_47 = V_71 -> V_48 . V_49 -> V_47 ;
V_41 -> V_48 = & V_71 -> V_48 ;
F_12 ( V_41 , V_71 ) ;
F_31 ( V_71 , V_41 ) ;
F_4 ( V_41 -> V_25 , V_71 -> V_48 . V_49 -> V_25 , sizeof( V_41 -> V_25 ) ) ;
}
...
F_17 ( V_56 -> V_76 ) ;
V_71 = F_33 ( V_74 , V_56 ) ;
if ( V_71 == NULL || V_71 -> V_48 . V_49 == NULL )
goto error;
if ( ! F_20 ( V_71 -> V_48 . V_49 -> V_47 ) )
goto error;
V_41 = F_34 ( V_71 ) ;
if ( F_22 ( V_53 , V_41 ) )
V_41 = NULL ;
F_23 ( V_71 -> V_48 . V_49 -> V_47 ) ;
error:
if ( V_71 && V_41 == NULL )
F_35 ( V_71 ) ;
return V_41 ;
