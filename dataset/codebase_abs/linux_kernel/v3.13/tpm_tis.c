...
static int F_62 ( struct V_73 * V_2 )
{
struct V_7 * V_8 = F_63 ( V_2 ) ;
int V_97 ;
if ( V_8 -> V_12 . V_24 )
F_61 ( V_8 ) ;
V_97 = F_64 ( V_2 ) ;
...
if ( V_22 < 0 )
return V_22 ;
V_102 = F_78 ( L_22 , - 1 , NULL , 0 ) ;
if ( F_79 ( V_102 ) ) {
V_22 = F_80 ( V_102 ) ;
goto V_103;
}
V_22 = F_40 ( & V_102 -> V_2 , V_104 , V_105 , 0 ) ;
if ( V_22 )
goto V_106;
return 0 ;
V_106:
...
{
struct V_107 * V_68 , * V_108 ;
struct V_7 * V_8 ;
F_56 ( & V_95 ) ;
F_84 (i, j, &tis_chips, list) {
V_8 = F_85 ( V_68 ) ;
F_60 ( V_8 -> V_2 ) ;
F_37 ( ~ V_93 &
F_35 ( V_8 -> V_12 . V_14 +
