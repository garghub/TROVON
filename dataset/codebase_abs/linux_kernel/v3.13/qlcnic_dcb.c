...
{
struct V_7 * V_8 ;
V_8 = F_21 ( sizeof( struct V_7 ) , V_17 ) ;
if ( ! V_8 )
return - V_18 ;
V_2 -> V_8 = V_8 ;
V_8 -> V_2 = V_2 ;
...
V_8 -> V_22 = F_21 ( sizeof( struct V_28 ) , V_17 ) ;
if ( ! V_8 -> V_22 ) {
V_24 = - V_18 ;
goto V_29;
}
V_8 -> V_23 = F_21 ( sizeof( struct V_30 ) , V_17 ) ;
if ( ! V_8 -> V_23 ) {
V_24 = - V_18 ;
goto V_31;
}
...
static int F_66 ( struct V_7 * V_8 , bool V_90 )
{
...
static void F_67 ( struct V_7 * V_8 , void * V_79 )
{
T_2 * V_3 = V_79 ;
if ( F_61 ( V_19 , & V_8 -> V_10 ) )
return;
...
F_79 ( V_2 , V_59 ) ;
F_80 ( V_2 -> V_11 , V_127 , V_128 , 0 , 0 ) ;
}
static T_1 F_81 ( struct V_129 * V_11 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
return F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) ;
}
static void F_83 ( struct V_129 * V_11 , T_1 * V_58 )
{
memcpy ( V_58 , V_11 -> V_130 , V_11 -> V_131 ) ;
}
static void
F_84 ( struct V_129 * V_11 , int V_98 , T_1 * V_132 ,
...
static void F_85 ( struct V_129 * V_11 , int V_99 ,
T_1 * V_136 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_110 * V_137 ;
...
static void F_86 ( struct V_129 * V_11 , int V_132 ,
T_1 * V_138 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_96 * V_97 ;
...
static T_1 F_87 ( struct V_129 * V_11 , int V_139 ,
T_1 * V_40 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
if ( ! F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) )
...
static int F_88 ( struct V_129 * V_11 , int V_147 , T_1 * V_148 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_28 * V_22 = V_2 -> V_8 -> V_22 ;
if ( ! F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) )
...
static T_1 F_89 ( struct V_129 * V_11 , T_1 V_151 , T_3 V_152 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_120 V_73 = {
. V_122 = V_151 ,
...
if ( ! F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) )
return 0 ;
return F_90 ( V_11 , & V_73 ) ;
}
static T_1 F_91 ( struct V_129 * V_11 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_7 * V_8 = V_2 -> V_8 ;
if ( ! F_17 ( V_9 , & V_8 -> V_10 ) )
return 0 ;
return V_8 -> V_22 -> type [ V_125 ] . V_102 ;
}
static T_1 F_92 ( struct V_129 * V_11 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_28 * V_22 = V_2 -> V_8 -> V_22 ;
if ( ! F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) )
...
static T_1 F_93 ( struct V_129 * V_11 , int V_153 , T_1 * V_90 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_95 * type ;
if ( ! F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) )
...
break;
default:
F_94 ( V_11 , L_11 , V_153 ) ;
return 1 ;
}
return 0 ;
}
static inline void
F_95 ( struct V_129 * V_11 , int V_132 , T_1 * V_106 ,
T_1 * V_99 , T_1 * V_136 , T_1 * V_159 )
{
* V_106 = * V_99 = * V_136 = * V_159 = 0 ;
}
static inline void
F_96 ( struct V_129 * V_11 , int V_99 , T_1 * V_136 )
{
* V_136 = 0 ;
}
static int F_97 ( struct V_129 * V_11 ,
struct V_160 * V_161 ,
T_3 * V_162 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
...
static int F_98 ( struct V_129 * V_11 ,
struct V_120 * V_165 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_95 * V_163 ;
...
static int F_99 ( struct V_129 * V_11 ,
struct V_166 * V_134 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_95 * V_163 ;
...
static int F_100 ( struct V_129 * V_11 ,
struct V_169 * V_170 )
{
struct V_1 * V_2 = F_82 ( V_11 ) ;
struct V_28 * V_22 = V_2 -> V_8 -> V_22 ;
