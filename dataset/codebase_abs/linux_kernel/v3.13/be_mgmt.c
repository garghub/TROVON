...
F_12 ( V_2 ) ;
F_7 ( & V_22 -> V_29 ) ;
V_214 = F_45 ( V_2 , V_27 , NULL , V_41 -> V_48 ) ;
if ( V_214 ) {
if ( V_214 == - V_216 )
return V_214 ;
F_3 ( V_2 , V_14 ,
...
static int F_46 ( struct V_1 * V_2 , struct V_40 * V_217 ,
int V_218 , int V_47 )
{
V_217 -> V_48 = F_25 ( V_2 -> V_22 . V_90 , V_47 , & V_217 -> V_51 ) ;
if ( ! V_217 -> V_48 ) {
F_3 ( V_2 , V_14 , V_15 ,
L_27 ) ;
return - V_91 ;
}
memset ( V_217 -> V_48 , 0 , V_47 ) ;
V_217 -> V_47 = V_47 ;
F_11 ( V_217 -> V_48 , V_119 , V_218 , V_47 ) ;
return 0 ;
}
static int
F_47 ( struct V_1 * V_2 ,
...
if ( V_214 )
return V_214 ;
V_185 = ( V_222 -> V_227 == V_228 ) ?
V_192 : V_186 ;
V_26 = V_41 . V_48 ;
V_26 -> V_229 . V_230 = 1 ;
V_26 -> V_229 . V_231 . V_232 = V_224 ;
V_26 -> V_229 . V_231 . V_233 =
V_2 -> V_210 ;
V_26 -> V_229 . V_231 . V_234 . V_235 =
sizeof( struct V_236 ) ;
V_26 -> V_229 . V_231 . V_234 . V_185 = V_185 ;
if ( V_224 == V_237 ) {
memcpy ( V_26 -> V_229 . V_231 . V_234 . V_187 , V_222 -> V_238 ,
V_222 -> V_53 ) ;
if ( V_223 )
memcpy ( V_26 -> V_229 . V_231 . V_234 . V_239 ,
V_223 -> V_238 , V_223 -> V_53 ) ;
} else {
memcpy ( V_26 -> V_229 . V_231 . V_234 . V_187 ,
V_220 -> V_234 . V_187 , V_222 -> V_53 ) ;
memcpy ( V_26 -> V_229 . V_231 . V_234 . V_239 ,
V_220 -> V_234 . V_239 , V_222 -> V_53 ) ;
}
...
static int F_48 ( struct V_1 * V_2 , T_2 * V_240 ,
T_1 V_241 , T_1 V_242 )
{
struct V_243 * V_26 ;
struct V_40 V_41 ;
...
V_26 = V_41 . V_48 ;
V_26 -> V_232 = V_241 ;
V_26 -> V_234 . V_185 = V_186 ;
memcpy ( V_26 -> V_234 . V_187 , V_240 , V_242 ) ;
...
if ( V_220 -> V_234 . V_187 [ 0 ] ) {
V_214 = F_47 ( V_2 , V_220 , V_222 , NULL ,
V_260 ) ;
if ( V_214 )
return V_214 ;
}
...
V_214 = F_52 ( V_2 , V_186 , & V_248 ) ;
if ( V_214 ) {
F_3 ( V_2 , V_126 , V_15 ,
L_31 ) ;
return V_214 ;
}
if ( V_248 . V_234 . V_187 [ 0 ] ) {
V_253 = ( T_2 * ) & V_248 . V_234 . V_187 ;
V_214 = F_48 ( V_2 , V_253 ,
V_260 , V_258 ) ;
if ( V_214 ) {
F_3 ( V_2 , V_126 ,
V_15 ,
...
V_250 -> V_262 = V_263 ;
V_250 -> V_264 = 1 ;
V_250 -> V_233 = V_2 -> V_210 ;
V_250 -> V_185 = V_265 ;
return F_43 ( V_2 , & V_41 , NULL , 0 ) ;
} else {
return F_47 ( V_2 , V_220 , V_222 ,
V_223 , V_237 ) ;
}
return V_214 ;
}
...
V_253 = ( T_2 * ) & V_266 -> V_238 ;
V_244 = F_48 ( V_2 , V_253 , V_237 ,
V_266 -> V_53 ) ;
if ( V_244 )
F_3 ( V_2 , V_126 , V_15 ,
L_33 ) ;
...
return V_214 ;
V_26 = V_41 . V_48 ;
V_26 -> V_233 = V_2 -> V_210 ;
V_26 -> V_185 = V_185 ;
* V_220 = F_54 ( V_271 , V_273 ) ;
if ( ! * V_220 ) {
F_3 ( V_2 , V_14 ,
V_65 | V_15 ,
L_34 ) ;
...
if ( V_214 )
return V_214 ;
return F_43 ( V_2 , & V_41 , V_277 , sizeof( * V_277 ) ) ;
}
