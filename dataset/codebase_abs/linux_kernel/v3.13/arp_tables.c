...
static int F_85 ( struct V_175 * V_175 , const void T_6 * V_123 ,
...
static inline void F_87 ( struct V_173 * V_78 )
{
struct V_76 * V_102 ;
V_102 = F_88 ( V_78 ) ;
F_40 ( V_102 -> V_104 . V_105 . V_106 -> V_138 ) ;
...
static int
F_90 ( struct V_173 * V_78 , void * * V_204 ,
...
static int F_92 ( const char * V_94 ,
unsigned int V_116 ,
struct V_90 * * V_207 ,
void * * V_208 ,
unsigned int V_162 ,
...
static int F_93 ( struct V_175 * V_175 , void T_6 * V_123 ,
unsigned int V_8 )
{
int V_10 ;
struct V_215 V_179 ;
...
V_10 = F_92 ( V_179 . V_94 , V_179 . V_116 ,
...
static int F_96 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 ,
unsigned int V_8 )
{
int V_10 ;
if ( ! F_97 ( F_98 ( V_217 ) -> V_219 , V_220 ) )
return - V_221 ;
switch ( V_218 ) {
case V_222 :
V_10 = F_93 ( F_98 ( V_217 ) , V_123 , V_8 ) ;
break;
case V_223 :
V_10 = F_85 ( F_98 ( V_217 ) , V_123 , V_8 , 1 ) ;
break;
default:
F_11 ( L_56 , V_218 ) ;
V_10 = - V_130 ;
...
static int F_99 ( struct V_77 * V_78 , void T_6 * * V_204 ,
T_7 * V_126 ,
struct V_144 * V_103 ,
unsigned int V_9 )
{
...
V_102 = F_15 ( V_78 ) ;
V_10 = F_100 ( V_102 , V_204 , V_126 ) ;
if ( V_10 )
return V_10 ;
V_128 = V_78 -> V_128 - ( V_206 - * V_126 ) ;
if ( F_101 ( V_122 , & V_224 -> V_122 ) != 0 ||
F_101 ( V_128 , & V_224 -> V_128 ) != 0 )
return - V_167 ;
return 0 ;
}
static int F_102 ( unsigned int V_162 ,
struct V_1 * V_84 ,
void T_6 * V_163 )
{
struct V_144 * V_103 ;
...
static int F_103 ( struct V_175 * V_175 ,
...
static int F_104 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 ,
int * V_8 )
{
int V_10 ;
if ( ! F_97 ( F_98 ( V_217 ) -> V_219 , V_220 ) )
...
switch ( V_218 ) {
case V_226 :
V_10 = F_69 ( F_98 ( V_217 ) , V_123 , V_8 , 1 ) ;
break;
case V_227 :
V_10 = F_103 ( F_98 ( V_217 ) , V_123 , V_8 ) ;
break;
default:
V_10 = F_105 ( V_217 , V_218 , V_123 , V_8 ) ;
}
return V_10 ;
}
static int F_106 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 , unsigned int V_8 )
{
int V_10 ;
if ( ! F_97 ( F_98 ( V_217 ) -> V_219 , V_220 ) )
return - V_221 ;
switch ( V_218 ) {
case V_222 :
V_10 = F_83 ( F_98 ( V_217 ) , V_123 , V_8 ) ;
break;
case V_223 :
V_10 = F_85 ( F_98 ( V_217 ) , V_123 , V_8 , 0 ) ;
break;
default:
F_11 ( L_56 , V_218 ) ;
V_10 = - V_130 ;
...
static int F_105 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 , int * V_8 )
{
int V_10 ;
if ( ! F_97 ( F_98 ( V_217 ) -> V_219 , V_220 ) )
return - V_221 ;
switch ( V_218 ) {
case V_226 :
V_10 = F_69 ( F_98 ( V_217 ) , V_123 , V_8 , 0 ) ;
break;
case V_227 :
V_10 = F_79 ( F_98 ( V_217 ) , V_123 , V_8 ) ;
break;
case V_228 : {
struct V_229 V_230 ;
if ( * V_8 != sizeof( V_230 ) ) {
...
struct V_1 * F_108 ( struct V_175 * V_175 ,
const struct V_1 * V_84 ,
const struct V_147 * V_148 )
{
int V_10 ;
...
if ( V_10 != 0 )
goto V_233;
V_232 = F_109 ( V_175 , V_84 , & V_231 , V_115 ) ;
if ( F_38 ( V_232 ) ) {
V_10 = F_39 ( V_232 ) ;
goto V_233;
}
...
static int T_9 F_112 ( struct V_175 * V_175 )
{
return F_113 ( V_175 , V_100 ) ;
}
static void T_10 F_114 ( struct V_175 * V_175 )
{
F_115 ( V_175 , V_100 ) ;
}
