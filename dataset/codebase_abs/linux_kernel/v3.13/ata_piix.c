...
T_1 V_132 ;
char V_133 [ 32 ] ;
char * V_134 = V_133 , * V_135 = V_133 + sizeof( V_133 ) ;
F_12 ( V_9 , V_136 , & V_132 ) ;
V_130 = V_123 -> V_130 [ V_132 & V_123 -> V_17 ] ;
for ( V_91 = 0 ; V_91 < 4 ; V_91 ++ ) {
switch ( V_130 [ V_91 ] ) {
case V_137 :
V_131 = 1 ;
V_134 += F_62 ( V_134 , V_135 - V_134 , L_32 ) ;
break;
case V_138 :
V_134 += F_62 ( V_134 , V_135 - V_134 , L_33 ) ;
break;
case V_139 :
F_63 ( ( V_91 & 1 ) || V_130 [ V_91 + 1 ] != V_139 ) ;
V_129 [ V_91 / 2 ] = V_140 [ V_141 ] ;
V_91 ++ ;
V_134 += F_62 ( V_134 , V_135 - V_134 , L_34 ) ;
break;
default:
V_134 += F_62 ( V_134 , V_135 - V_134 , L_35 , V_130 [ V_91 ] ) ;
if ( V_91 & 1 )
V_129 [ V_91 / 2 ] . V_3 |= V_142 ;
break;
}
}
F_64 ( & V_9 -> V_11 , L_36 , V_133 ) ;
if ( V_131 )
...
{
struct V_8 * V_9 = F_4 ( V_10 -> V_11 ) ;
if ( V_9 -> V_143 == V_119 && V_9 -> V_18 == 0x2920 &&
V_9 -> V_20 == V_144 &&
V_9 -> V_22 == 0xb049 ) {
F_57 ( V_10 -> V_11 ,
L_38 ) ;
...
struct V_30 * V_145 = & V_10 -> V_146 [ 0 ] -> V_31 ;
T_3 V_147 ;
int V_91 , V_100 ;
for ( V_91 = 0 ; V_91 < 4 ; V_91 ++ )
if ( V_13 -> V_130 [ V_91 ] == V_139 )
return 0 ;
if ( F_65 ( V_10 ) )
return 0 ;
if ( ! ( V_10 -> V_146 [ 0 ] -> V_3 & V_148 ) )
return 0 ;
if ( F_51 ( V_9 , V_149 ) == 0 ||
F_52 ( V_9 , V_149 ) != V_150 )
return 0 ;
if ( F_67 ( V_9 , 1 << V_149 , V_151 ) )
return 0 ;
V_13 -> V_71 = F_68 ( V_9 ) [ V_149 ] ;
F_23 ( V_145 , V_152 , & V_147 ) ;
if ( ( V_147 & 0xf00 ) != 0x300 ) {
V_147 |= 0x300 ;
F_26 ( V_145 , V_152 , V_147 ) ;
F_23 ( V_145 , V_152 , & V_147 ) ;
if ( ( V_147 & 0xf00 ) != 0x300 ) {
F_64 ( V_10 -> V_11 ,
L_39 ) ;
...
struct V_1 * V_2 = V_10 -> V_146 [ V_91 ] ;
V_2 -> V_81 = & V_153 ;
if ( V_2 -> V_3 & V_142 ) {
V_100 = F_69 ( V_2 ) ;
if ( V_100 )
...
{
static const struct V_84 V_155 [] = {
{
. V_86 = L_43 ,
. V_87 = {
F_32 ( V_88 , L_44 ) ,
...
const struct V_84 * V_157 = F_73 ( V_155 ) ;
if ( V_157 ) {
unsigned long V_158 = ( unsigned long ) V_157 -> V_156 ;
return V_158 == F_74 ( V_9 -> V_159 ) ;
}
return false ;
}
...
{
#if F_76 ( V_160 )
static const struct V_84 V_161 [] = {
{
. V_86 = L_46 ,
. V_87 = {
F_32 ( V_88 ,
...
static const struct V_84 V_162 [] = {
{
. V_86 = L_49 ,
. V_87 = {
F_32 ( V_88 ,
...
const struct V_84 * V_163 = F_73 ( V_161 ) ;
const struct V_84 * V_164 = F_73 ( V_162 ) ;
...
static int F_77 ( struct V_8 * V_9 , const struct V_167 * V_168 )
{
struct V_18 * V_11 = & V_9 -> V_11 ;
struct V_128 V_169 [ 2 ] ;
const struct V_128 * V_170 [] = { & V_169 [ 0 ] , & V_169 [ 1 ] } ;
...
int V_100 ;
F_78 ( & V_9 -> V_11 , V_175 ) ;
if ( ! V_176 && V_168 -> V_156 >= V_177 )
return - V_178 ;
if ( F_72 ( V_9 ) ) {
V_140 [ V_168 -> V_156 ] . V_3 |=
V_179 |
V_180 ;
F_64 ( & V_9 -> V_11 , L_52
L_53 ) ;
}
V_169 [ 0 ] = V_140 [ V_168 -> V_156 ] ;
V_169 [ 1 ] = V_140 [ V_168 -> V_156 ] ;
V_174 = V_169 [ 0 ] . V_3 ;
V_100 = F_79 ( V_9 ) ;
if ( V_100 )
return V_100 ;
V_13 = F_80 ( V_11 , sizeof( * V_13 ) , V_181 ) ;
if ( ! V_13 )
return - V_112 ;
F_81 ( V_9 , V_154 , & V_13 -> V_27 ) ;
if ( V_9 -> V_143 == V_119 && V_9 -> V_18 == 0x2652 ) {
V_100 = F_50 ( V_9 ) ;
if ( V_100 )
return V_100 ;
}
if ( V_174 & V_182 )
V_13 -> V_130 = F_61 ( V_9 , V_169 ,
V_183 [ V_168 -> V_156 ] ) ;
V_100 = F_82 ( V_9 , V_170 , & V_10 ) ;
if ( V_100 )
return V_100 ;
V_10 -> V_14 = V_13 ;
if ( V_174 & V_182 ) {
F_58 ( V_10 , V_183 [ V_168 -> V_156 ] ) ;
V_100 = F_66 ( V_10 ) ;
if ( V_100 )
return V_100 ;
if ( V_10 -> V_146 [ 0 ] -> V_81 == & V_153 )
V_172 = & V_184 ;
}
F_70 ( V_10 ) ;
if ( V_174 & V_185 )
F_83 ( V_9 , 1 ) ;
if ( F_55 ( V_9 ) ) {
V_10 -> V_146 [ 0 ] -> V_186 = 0 ;
V_10 -> V_146 [ 0 ] -> V_52 = 0 ;
V_10 -> V_146 [ 1 ] -> V_186 = 0 ;
V_10 -> V_146 [ 1 ] -> V_52 = 0 ;
}
V_10 -> V_3 |= V_187 ;
F_75 ( V_10 ) ;
F_84 ( V_9 ) ;
return F_85 ( V_10 , V_188 , V_172 ) ;
}
static void F_86 ( struct V_8 * V_9 )
{
struct V_99 * V_10 = F_37 ( V_9 ) ;
struct V_12 * V_13 = V_10 -> V_14 ;
F_71 ( V_9 , V_154 , V_13 -> V_27 ) ;
F_87 ( V_9 ) ;
}
