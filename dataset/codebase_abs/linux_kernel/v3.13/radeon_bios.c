...
V_2 -> V_3 = F_11 ( & V_122 -> V_137 , V_123 -> V_132 , V_9 ) ;
V_28 = ! ! V_2 -> V_3 ;
V_124:
return V_28 ;
}
...
V_138 = V_2 -> V_140 + 4 ;
if ( ! memcmp ( V_2 -> V_3 + V_138 , L_13 , 4 ) ||
! memcmp ( V_2 -> V_3 + V_138 , L_14 , 4 ) ) {
V_2 -> V_141 = true ;
} else {
V_2 -> V_141 = false ;
}
F_43 ( L_15 , V_2 -> V_141 ? L_13 : L_16 ) ;
return true ;
V_139:
F_19 ( V_2 -> V_3 ) ;
V_2 -> V_3 = NULL ;
