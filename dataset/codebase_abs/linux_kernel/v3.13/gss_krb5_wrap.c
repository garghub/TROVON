...
if ( V_38 > V_29 -> V_67 )
return V_68 ;
V_105 = F_44 (unsigned int, buf->head[0].iov_len, buf->len) ;
...
V_4 -> V_7 -= V_47 + V_102 ;
F_45 ( V_4 , V_90 + V_47 + V_103 ) ;
return V_69 ;
}
T_3
F_46 ( struct V_107 * V_108 , int V_5 ,
struct V_3 * V_4 , struct V_30 * * V_24 )
{
...
T_3
F_47 ( struct V_107 * V_108 , int V_5 , struct V_3 * V_4 )
{
struct V_28 * V_29 = V_108 -> V_109 ;
switch ( V_29 -> V_60 ) {
default:
