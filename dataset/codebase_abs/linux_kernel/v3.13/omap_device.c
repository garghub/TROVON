...
V_51 = F_15 ( sizeof( struct V_36 ) * V_53 , V_28 ) ;
if ( ! V_51 )
goto V_60;
if ( ! V_9 -> V_35 ) {
F_2 ( & V_9 -> V_10 , L_11 ,
...
static int F_57 ( struct V_70 * V_10 )
{
F_6 ( V_10 , L_17 , V_61 ) ;
return - V_27 ;
}
...
static int F_62 ( struct V_70 * V_10 )
{
struct V_18 * V_9 = F_24 ( V_10 ) ;
struct V_1 * V_2 = F_26 ( V_9 ) ;
if ( V_2 -> V_33 & V_72 ) {
...
int F_66 ( struct V_18 * V_9 , const char * V_37 )
{
struct V_1 * V_2 = F_26 ( V_9 ) ;
int V_25 = 0 ;
int V_13 ;
for ( V_13 = 0 ; V_13 < V_2 -> V_49 ; V_13 ++ ) {
V_25 = F_67 ( V_2 -> V_19 [ V_13 ] , V_37 ) ;
if ( V_25 )
break;
}
return V_25 ;
...
int V_13 ;
for ( V_13 = 0 ; V_13 < V_2 -> V_49 ; V_13 ++ ) {
V_25 = F_69 ( V_2 -> V_19 [ V_13 ] , V_37 ) ;
if ( V_25 )
break;
}
return V_25 ;
}
struct V_70 * F_70 ( const char * V_23 )
{
struct V_11 * V_12 ;
if ( ! V_23 ) {
F_63 ( 1 , L_21 , V_61 ) ;
...
static int T_2 F_73 ( struct V_70 * V_10 , void * V_78 )
{
struct V_18 * V_9 = F_24 ( V_10 ) ;
struct V_1 * V_2 = F_26 ( V_9 ) ;
int V_13 ;
