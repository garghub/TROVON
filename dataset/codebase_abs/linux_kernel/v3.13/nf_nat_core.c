...
unsigned int
F_52 ( struct V_12 * V_13 , unsigned int V_103 )
{
union V_70 V_82 =
( F_53 ( V_103 ) == V_56 ?
...
return F_39 ( V_13 , & V_52 , F_53 ( V_103 ) ) ;
}
unsigned int F_54 ( struct V_12 * V_13 ,
enum V_14 V_15 ,
unsigned int V_103 ,
struct V_7 * V_8 )
{
...
static int F_55 ( struct V_12 * V_72 , void * V_109 )
{
...
( V_111 -> V_50 && F_56 ( V_72 ) != V_111 -> V_50 ) )
return 0 ;
return V_72 -> V_96 & V_105 ? 1 : 0 ;
}
static void F_57 ( T_1 V_11 , T_1 V_50 )
{
struct V_110 V_111 = {
. V_11 = V_11 ,
. V_50 = V_50 ,
...
F_58 () ;
F_59 (net)
F_60 ( V_40 , F_55 , & V_111 , 0 , 0 ) ;
F_61 () ;
}
static void F_62 ( T_1 V_11 )
{
struct V_110 V_111 = {
. V_11 = V_11 ,
} ;
...
int F_63 ( T_1 V_11 , const struct V_4 * V_50 )
{
...
F_64 ( & V_114 ) ;
if ( V_6 [ V_11 ] == NULL ) {
V_112 = F_65 ( V_115 * sizeof( struct V_4 * ) ,
V_116 ) ;
if ( V_112 == NULL ) {
V_113 = - V_39 ;
goto V_24;
...
F_66 ( V_6 [ V_11 ] [ V_50 -> V_50 ] , V_50 ) ;
V_24:
F_70 ( & V_114 ) ;
return V_113 ;
}
void F_71 ( T_1 V_11 , const struct V_4 * V_50 )
{
F_64 ( & V_114 ) ;
F_66 ( V_6 [ V_11 ] [ V_50 -> V_50 ] ,
& V_117 ) ;
F_70 ( & V_114 ) ;
F_72 () ;
F_57 ( V_11 , V_50 -> V_50 ) ;
}
int F_73 ( const struct V_1 * V_11 )
{
int V_31 ;
V_31 = F_74 ( V_11 -> V_11 ) ;
if ( V_31 < 0 )
return V_31 ;
F_64 ( & V_114 ) ;
F_66 ( V_6 [ V_11 -> V_11 ] [ V_119 ] ,
& V_120 ) ;
F_66 ( V_6 [ V_11 -> V_11 ] [ V_121 ] ,
& V_122 ) ;
F_70 ( & V_114 ) ;
F_66 ( V_3 [ V_11 -> V_11 ] , V_11 ) ;
return 0 ;
}
void F_75 ( const struct V_1 * V_11 )
{
F_64 ( & V_114 ) ;
F_66 ( V_3 [ V_11 -> V_11 ] , NULL ) ;
F_70 ( & V_114 ) ;
F_72 () ;
F_62 ( V_11 -> V_11 ) ;
F_76 ( V_11 -> V_11 ) ;
...
{
struct V_65 * V_66 = F_78 ( V_13 , V_93 ) ;
...
static void F_80 ( void * V_123 , void * V_124 )
{
...
const struct V_4 * V_50 ;
int V_31 ;
V_31 = F_83 ( V_129 , V_130 , V_128 , V_131 ) ;
if ( V_31 < 0 )
return V_31 ;
V_50 = F_3 ( F_33 ( V_13 ) , F_56 ( V_13 ) ) ;
if ( V_50 -> V_132 )
V_31 = V_50 -> V_132 ( V_129 , V_52 ) ;
return V_31 ;
}
static int
F_84 ( const struct V_127 * V_66 ,
...
V_31 = F_83 ( V_129 , V_133 , V_66 , V_134 ) ;
if ( V_31 < 0 )
return V_31 ;
F_6 () ;
V_11 = F_1 ( F_33 ( V_13 ) ) ;
...
if ( ! V_129 [ V_136 ] )
goto V_24;
V_31 = F_82 ( V_129 [ V_136 ] , V_13 , V_52 ) ;
V_24:
F_8 () ;
return V_31 ;
}
...
static int T_3 F_86 ( struct V_40 * V_40 )
{
V_40 -> V_13 . V_47 = V_40 -> V_13 . V_140 ;
V_40 -> V_13 . V_100 = F_87 ( & V_40 -> V_13 . V_47 , 0 ) ;
if ( ! V_40 -> V_13 . V_100 )
return - V_39 ;
return 0 ;
}
static void T_4 F_88 ( struct V_40 * V_40 )
{
struct V_110 V_111 = {} ;
F_60 ( V_40 , & F_55 , & V_111 , 0 , 0 ) ;
F_72 () ;
F_89 ( V_40 -> V_13 . V_100 , V_40 -> V_13 . V_47 ) ;
}
