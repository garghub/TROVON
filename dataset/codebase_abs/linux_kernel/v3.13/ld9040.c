...
V_2 -> V_21 = V_21 ;
V_2 -> V_32 = & V_21 -> V_32 ;
V_2 -> V_6 = F_35 ( & V_21 -> V_32 ) ;
if ( ! V_2 -> V_6 ) {
F_16 ( & V_21 -> V_32 , L_12 ) ;
return - V_53 ;
}
F_36 ( & V_2 -> V_7 ) ;
V_3 = F_37 ( V_2 -> V_32 , F_4 ( V_9 ) , V_9 ) ;
if ( V_3 ) {
F_16 ( V_2 -> V_32 , L_13 , V_3 ) ;
return V_3 ;
}
V_54 = F_38 ( & V_21 -> V_32 , L_14 , & V_21 -> V_32 , V_2 ,
& V_73 ) ;
if ( F_39 ( V_54 ) )
return F_40 ( V_54 ) ;
V_2 -> V_54 = V_54 ;
...
V_63 . type = V_74 ;
V_63 . V_66 = V_67 ;
V_62 = F_41 ( & V_21 -> V_32 , L_15 , & V_21 -> V_32 ,
V_2 , & V_75 , & V_63 ) ;
if ( F_39 ( V_62 ) )
return F_40 ( V_62 ) ;
V_62 -> V_63 . V_64 = V_67 ;
...
static int F_46 ( struct V_77 * V_32 )
{
struct V_1 * V_2 = F_47 ( V_32 ) ;
F_48 ( V_32 , L_17 , V_2 -> V_50 ) ;
return F_25 ( V_2 , V_60 ) ;
}
static int F_49 ( struct V_77 * V_32 )
{
struct V_1 * V_2 = F_47 ( V_32 ) ;
V_2 -> V_50 = V_60 ;
return F_25 ( V_2 , V_59 ) ;
}
static void F_50 ( struct V_68 * V_21 )
{
struct V_1 * V_2 = F_45 ( V_21 ) ;
F_25 ( V_2 , V_60 ) ;
}
