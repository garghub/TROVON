...
static int F_91 ( struct V_139 * V_139 , struct V_82 * V_82 )
{
return F_92 ( V_139 , V_82 , & V_140 ,
sizeof( struct V_141 ) ) ;
}
struct V_2 * F_93 ( struct V_14 * V_14 , T_3 V_19 )
{
struct V_2 * V_3 ;
if ( ! F_12 ( V_14 , & V_142 ) )
return NULL ;
F_8 () ;
V_3 = F_94 ( V_143 . V_3 [ V_19 ] ) ;
if ( V_3 )
F_16 ( V_3 ) ;
F_17 () ;
return V_3 ;
...
F_16 ( V_3 ) ;
F_97 ( V_143 . V_3 [ V_19 ] , V_3 ) ;
V_144 = 0 ;
}
F_26 ( & V_149 ) ;
return V_144 ;
}
int F_98 ( struct V_2 * V_3 , T_3 V_19 )
{
int V_144 = - V_150 ;
if ( ! F_96 ( V_146 ) )
return - V_147 ;
...
static struct V_2 * * F_101 ( struct V_131 * V_132 , T_6 V_133 )
{
struct V_14 * V_14 = F_74 ( V_132 ) ;
unsigned int V_6 ;
if ( ! F_12 ( V_14 , & V_142 ) )
...
static struct V_2 * * F_102 ( struct V_131 * V_132 , struct V_2 * * V_3 )
{
struct V_14 * V_14 = F_74 ( V_132 ) ;
unsigned int V_6 ;
...
static void * F_103 ( struct V_131 * V_132 , T_6 * V_133 )
__acquires( V_149 )
{
F_24 ( & V_149 ) ;
return * V_133 ? F_101 ( V_132 , * V_133 - 1 ) : V_134 ;
}
static void * F_104 ( struct V_131 * V_132 , void * V_135 , T_6 * V_133 )
{
struct V_2 * * V_3 ;
if ( V_135 == V_134 )
V_3 = F_101 ( V_132 , 0 ) ;
else
V_3 = F_102 ( V_132 , V_135 ) ;
( * V_133 ) ++ ;
return V_3 ;
}
static void F_105 ( struct V_131 * V_132 , void * V_135 )
__releases( V_149 )
{
F_26 ( & V_149 ) ;
}
static int F_106 ( struct V_131 * V_132 , void * V_135 )
{
F_81 ( V_132 , 63 ) ;
if ( V_135 == V_134 )
F_82 ( V_132 , L_5 ) ;
...
static int F_107 ( struct V_139 * V_139 , struct V_82 * V_82 )
{
return F_92 ( V_139 , V_82 , & V_153 ,
sizeof( struct V_141 ) ) ;
}
