...
V_95 -> V_4 , V_95 -> V_3 ) ;
if ( V_147 )
return F_164 ( V_8 , V_2 , V_147 , V_148 , false ) ;
V_311 = F_165 ( F_19 ( V_8 ) , & V_110 , V_95 -> V_4 ,
...
int F_167 ( struct V_7 * V_8 , struct V_1 * V_2 )
{
struct V_7 * V_312 ;
if ( V_8 -> V_112 == V_313 ) {
...
F_170 ( V_8 , V_2 , F_4 ( V_2 ) , V_2 -> V_157 ) ;
return 0 ;
}
if ( V_2 -> V_157 < F_171 ( V_2 ) || F_172 ( V_2 ) )
goto V_317;
if ( V_8 -> V_112 == V_123 ) {
...
F_168 ( V_8 , V_2 ) ;
if ( F_174 ( V_8 , V_2 , F_4 ( V_2 ) , V_2 -> V_157 ) ) {
V_312 = V_8 ;
goto V_319;
}
return 0 ;
...
if ( V_2 -> V_322 != V_323 )
return;
if ( ! F_177 ( V_2 , F_178 ( V_2 ) + sizeof( struct V_97 ) ) )
return;
V_95 = F_3 ( V_2 ) ;
V_98 = F_4 ( V_2 ) ;
if ( V_98 -> V_161 < sizeof( struct V_97 ) / 4 )
return;
V_8 = F_179 ( F_41 ( V_2 -> V_109 ) , & V_110 ,
V_95 -> V_4 , V_98 -> V_6 ,
V_95 -> V_3 , F_81 ( V_98 -> V_5 ) ,
V_2 -> V_316 ) ;
if ( V_8 ) {
...
V_2 -> V_324 = V_325 ;
if ( V_8 -> V_112 != V_113 ) {
struct V_82 * V_68 = F_180 ( V_8 -> V_314 ) ;
if ( V_68 )
V_68 = F_181 ( V_68 , 0 ) ;
if ( V_68 &&
...
return false ;
if ( V_2 -> V_157 <= F_171 ( V_2 ) &&
F_184 ( & V_14 -> V_327 . V_329 ) == 0 )
return false ;
if ( F_21 ( V_8 -> V_314 ) )
F_185 ( V_2 ) ;
else
F_186 ( V_2 ) ;
F_187 ( & V_14 -> V_327 . V_329 , V_2 ) ;
V_14 -> V_327 . V_330 += V_2 -> V_331 ;
if ( V_14 -> V_327 . V_330 > V_8 -> V_332 ) {
struct V_1 * V_333 ;
F_57 ( F_13 ( V_8 ) ) ;
while ( ( V_333 = F_188 ( & V_14 -> V_327 . V_329 ) ) != NULL ) {
F_189 ( V_8 , V_333 ) ;
F_48 ( F_19 ( V_8 ) ,
V_334 ) ;
}
V_14 -> V_327 . V_330 = 0 ;
} else if ( F_184 ( & V_14 -> V_327 . V_329 ) == 1 ) {
F_190 ( F_191 ( V_8 ) ,
V_335 | V_336 | V_337 ) ;
if ( ! F_192 ( V_8 ) )
F_60 ( V_8 , V_338 ,
...
goto V_339;
F_90 ( V_108 , V_340 ) ;
if ( ! F_177 ( V_2 , sizeof( struct V_97 ) ) )
goto V_339;
V_98 = F_4 ( V_2 ) ;
if ( V_98 -> V_161 < sizeof( struct V_97 ) / 4 )
goto V_341;
if ( ! F_177 ( V_2 , V_98 -> V_161 * 4 ) )
goto V_339;
if ( F_195 ( V_2 , V_57 , V_342 ) )
goto V_343;
V_98 = F_4 ( V_2 ) ;
V_95 = F_3 ( V_2 ) ;
memmove ( & F_89 ( V_2 ) -> V_195 . V_196 , F_196 ( V_2 ) ,
sizeof( struct V_344 ) ) ;
F_197 () ;
...
F_89 ( V_2 ) -> V_346 = F_198 ( V_98 ) ;
F_89 ( V_2 ) -> V_347 = 0 ;
F_89 ( V_2 ) -> V_348 = F_199 ( V_95 ) ;
F_89 ( V_2 ) -> V_349 = 0 ;
V_8 = F_200 ( & V_110 , V_2 , V_98 -> V_6 , V_98 -> V_5 ) ;
if ( ! V_8 )
goto V_350;
V_351:
if ( V_8 -> V_112 == V_113 )
...
return V_293 ;
V_350:
if ( ! F_201 ( NULL , V_354 , V_2 ) )
goto V_339;
if ( V_2 -> V_157 < ( V_98 -> V_161 << 2 ) || F_172 ( V_2 ) ) {
V_343:
F_90 ( V_108 , V_320 ) ;
V_341:
F_90 ( V_108 , V_321 ) ;
...
switch ( F_207 ( F_46 ( V_8 ) , V_2 , V_98 ) ) {
case V_357 : {
struct V_7 * V_358 = F_208 ( F_41 ( V_2 -> V_109 ) ,
& V_110 ,
V_95 -> V_4 , V_98 -> V_6 ,
V_95 -> V_3 , V_98 -> V_5 ,
F_43 ( V_2 ) ) ;
...
static void * F_222 ( struct V_368 * V_105 , void * V_369 )
{
struct V_100 * V_101 ;
struct V_370 * V_259 ;
...
struct V_108 * V_108 = F_223 ( V_105 ) ;
if ( ! V_8 ) {
V_372 = & V_110 . V_376 [ V_374 -> V_377 ] ;
F_224 ( & V_372 -> V_378 ) ;
V_8 = F_225 ( & V_372 -> V_159 ) ;
V_374 -> V_208 = 0 ;
goto V_379;
}
V_372 = & V_110 . V_376 [ V_374 -> V_377 ] ;
...
V_8 = F_226 ( V_374 -> V_383 ) ;
V_374 -> V_381 = V_390 ;
F_227 ( & V_101 -> V_237 . V_391 ) ;
} else {
V_101 = F_23 ( V_8 ) ;
F_228 ( & V_101 -> V_237 . V_391 ) ;
if ( F_229 ( & V_101 -> V_237 ) )
goto V_392;
F_227 ( & V_101 -> V_237 . V_391 ) ;
V_8 = F_226 ( V_8 ) ;
}
...
static void * F_234 ( struct V_368 * V_105 , T_10 * V_396 )
{
struct V_373 * V_374 = V_105 -> V_375 ;
void * V_397 ;
V_374 -> V_377 = 0 ;
V_374 -> V_208 = 0 ;
V_397 = F_222 ( V_105 , NULL ) ;
while ( V_397 && * V_396 ) {
V_397 = F_222 ( V_105 , V_397 ) ;
-- * V_396 ;
}
return V_397 ;
}
...
{
return F_236 ( & V_110 . V_398 [ V_374 -> V_377 ] . V_399 ) ;
}
static void * F_237 ( struct V_368 * V_105 )
{
struct V_373 * V_374 = V_105 -> V_375 ;
struct V_108 * V_108 = F_223 ( V_105 ) ;
void * V_397 = NULL ;
...
struct V_7 * V_8 ;
struct V_370 * V_259 ;
T_11 * V_378 = F_238 ( & V_110 , V_374 -> V_377 ) ;
if ( F_235 ( V_374 ) )
continue;
F_224 ( V_378 ) ;
F_239 (sk, node, &tcp_hashinfo.ehash[st->bucket].chain) {
if ( V_8 -> V_393 != V_374 -> V_241 ||
! F_231 ( F_19 ( V_8 ) , V_108 ) ) {
continue;
}
V_397 = V_8 ;
goto V_117;
...
static void * F_240 ( struct V_368 * V_105 , void * V_369 )
{
struct V_7 * V_8 = V_369 ;
struct V_370 * V_259 ;
struct V_373 * V_374 = V_105 -> V_375 ;
...
V_8 = F_226 ( V_8 ) ;
F_230 (sk, node) {
if ( V_8 -> V_393 == V_374 -> V_241 && F_231 ( F_19 ( V_8 ) , V_108 ) )
return V_8 ;
}
F_233 ( F_238 ( & V_110 , V_374 -> V_377 ) ) ;
++ V_374 -> V_377 ;
return F_237 ( V_105 ) ;
}
static void * F_241 ( struct V_368 * V_105 , T_10 V_396 )
{
struct V_373 * V_374 = V_105 -> V_375 ;
void * V_397 ;
V_374 -> V_377 = 0 ;
...
struct V_373 * V_374 = V_105 -> V_375 ;
V_374 -> V_381 = V_390 ;
V_397 = F_234 ( V_105 , & V_396 ) ;
if ( ! V_397 ) {
V_374 -> V_381 = V_401 ;
V_397 = F_241 ( V_105 , V_396 ) ;
}
return V_397 ;
}
static void * F_243 ( struct V_368 * V_105 )
{
struct V_373 * V_374 = V_105 -> V_375 ;
...
static void * F_244 ( struct V_368 * V_105 , T_10 * V_396 )
{
struct V_373 * V_374 = V_105 -> V_375 ;
void * V_397 ;
...
V_374 -> V_377 = 0 ;
V_374 -> V_208 = 0 ;
V_397 = * V_396 ? F_242 ( V_105 , * V_396 - 1 ) : V_404 ;
V_117:
V_374 -> V_403 = * V_396 ;
return V_397 ;
}
static void * F_245 ( struct V_368 * V_105 , void * V_405 , T_10 * V_396 )
{
struct V_373 * V_374 = V_105 -> V_375 ;
void * V_397 = NULL ;
if ( V_405 == V_404 ) {
...
static void F_246 ( struct V_368 * V_105 , void * V_405 )
{
struct V_373 * V_374 = V_105 -> V_375 ;
switch ( V_374 -> V_381 ) {
case V_382 :
...
case V_390 :
if ( V_405 != V_404 )
F_233 ( & V_110 . V_376 [ V_374 -> V_377 ] . V_378 ) ;
break;
case V_401 :
if ( V_405 )
F_233 ( F_238 ( & V_110 , V_374 -> V_377 ) ) ;
...
int F_247 ( struct V_406 * V_406 , struct V_407 * V_407 )
{
struct V_408 * V_409 = F_248 ( V_406 ) ;
struct V_373 * V_410 ;
int V_37 ;
V_37 = F_249 ( V_406 , V_407 , & V_409 -> V_411 ,
sizeof( struct V_373 ) ) ;
if ( V_37 < 0 )
return V_37 ;
...
int F_250 ( struct V_108 * V_108 , struct V_408 * V_409 )
{
int V_397 = 0 ;
struct V_413 * V_414 ;
V_409 -> V_411 . V_415 = F_244 ;
V_409 -> V_411 . V_416 = F_245 ;
V_409 -> V_411 . V_417 = F_246 ;
V_414 = F_251 ( V_409 -> V_418 , V_419 , V_108 -> V_420 ,
V_409 -> V_421 , V_409 ) ;
if ( ! V_414 )
V_397 = - V_257 ;
return V_397 ;
}
void F_252 ( struct V_108 * V_108 , struct V_408 * V_409 )
{
F_253 ( V_409 -> V_418 , V_108 -> V_420 ) ;
}
static void F_254 ( const struct V_7 * V_8 , const struct V_103 * V_147 ,
...
F_256 ( V_424 ) ,
V_147 -> V_427 ,
F_257 ( F_258 ( V_422 ) , V_394 ) ,
0 ,
0 ,
F_259 ( & V_8 -> V_428 ) ,
V_147 ) ;
}
static void F_260 ( struct V_7 * V_8 , struct V_368 * V_422 , int V_423 )
{
int V_429 ;
unsigned long V_430 ;
...
V_436 = F_262 ( int , V_14 -> V_218 - V_14 -> V_444 , 0 ) ;
F_255 ( V_422 , L_9
L_10 ,
...
F_256 ( V_430 - V_79 ) ,
V_101 -> V_137 ,
F_257 ( F_258 ( V_422 ) , F_232 ( V_8 ) ) ,
V_101 -> V_445 ,
F_263 ( V_8 ) ,
F_259 ( & V_8 -> V_428 ) , V_8 ,
F_264 ( V_101 -> V_139 ) ,
F_264 ( V_101 -> V_446 . V_447 ) ,
( V_101 -> V_446 . V_448 << 1 ) | V_101 -> V_446 . V_449 ,
V_14 -> V_450 ,
V_8 -> V_112 == V_123 ?
( V_432 ? V_432 -> V_451 : 0 ) :
( F_265 ( V_14 ) ? - 1 : V_14 -> V_452 ) ) ;
}
...
3 , F_256 ( V_424 ) , 0 , 0 , 0 , 0 ,
F_259 ( & V_210 -> V_459 ) , V_210 ) ;
}
static int F_268 ( struct V_368 * V_105 , void * V_405 )
{
struct V_373 * V_374 ;
...
case V_401 :
if ( V_8 -> V_112 == V_113 )
F_266 ( V_405 , V_105 , V_374 -> V_380 ) ;
else
F_260 ( V_405 , V_105 , V_374 -> V_380 ) ;
break;
case V_382 :
F_254 ( V_374 -> V_383 , V_405 , V_105 , V_374 -> V_380 , V_374 -> V_394 ) ;
break;
}
V_117:
F_271 ( V_105 , '\n' ) ;
...
static int T_15 F_272 ( struct V_108 * V_108 )
{
return F_250 ( V_108 , & V_461 ) ;
}
static void T_16 F_273 ( struct V_108 * V_108 )
{
F_252 ( V_108 , & V_461 ) ;
}
int T_17 F_274 ( void )
...
static void T_16 F_278 ( struct V_108 * V_108 )
{
int V_463 ;
F_279 (cpu)
F_280 ( * F_281 ( V_108 -> V_194 . F_7 , V_463 ) ) ;
F_282 ( V_108 -> V_194 . F_7 ) ;
}
static int T_15 F_283 ( struct V_108 * V_108 )
{
int V_464 , V_463 ;
V_108 -> V_194 . F_7 = F_284 ( struct V_7 * ) ;
if ( ! V_108 -> V_194 . F_7 )
return - V_257 ;
F_279 (cpu) {
struct V_7 * V_8 ;
V_464 = F_285 ( & V_8 , V_465 , V_466 ,
V_57 , V_108 ) ;
if ( V_464 )
goto V_467;
* F_281 ( V_108 -> V_194 . F_7 , V_463 ) = V_8 ;
}
V_108 -> V_194 . V_468 = 2 ;
V_108 -> V_194 . V_469 = V_470 ;
return 0 ;
V_467:
F_278 ( V_108 ) ;
return V_464 ;
}
static void T_16 F_286 ( struct V_471 * V_472 )
{
F_287 ( & V_110 , & V_66 , V_42 ) ;
}
void T_17 F_288 ( void )
{
F_289 ( & V_110 ) ;
if ( F_275 ( & V_473 ) )
F_290 ( L_15 ) ;
