...
static void
F_11 ( struct V_1 * V_2 , void * V_9 , struct V_7 * V_8 )
{
int V_134 ;
if ( ! V_2 -> V_23 )
return;
...
static void F_16 ( struct V_7 * V_116 , int V_134 )
{
if ( V_116 == NULL )
return;
...
static struct V_7 * F_17 ( int V_134 )
{
struct V_7 * V_8 ;
int V_80 ;
V_8 = F_18 ( V_134 * sizeof( struct V_7 ) , V_137 ) ;
if ( V_8 ) {
...
struct V_5 * F_19 ( int V_134 )
{
struct V_5 * V_79 ;
V_79 = F_18 ( sizeof( * V_79 ) , V_137 ) ;
if ( V_79 ) {
V_79 -> V_11 = F_17 ( V_134 ) ;
V_79 -> V_16 = NULL ;
V_79 -> V_15 = V_134 ;
}
return V_79 ;
