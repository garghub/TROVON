...
if ( V_17 -> V_3 <= V_63 -> V_18 [ V_17 -> V_4 ] ) {
return false ;
}
return true ;
}
...
V_64 -> V_18 [ V_49 ] = F_65 ( V_64 -> V_18 [ V_49 ] , V_65 -> V_18 [ V_49 ] ) ;
}
}
