...
const char V_111 * V_116 , int V_117 )
{
int V_118 ;
if ( V_117 > V_115 )
return - V_119 ;
...
int F_81 ( char V_111 * V_116 , int V_117 ,
...
int F_85 ( void V_111 * V_126 , int V_127 )
{
char * V_85 ;
int V_45 ;
...
int V_45 = 0 ;
F_67 () ;
if ( strcmp ( V_85 , L_13 ) == 0 ) {
F_76 () ;
F_87 () ;
F_67 () ;
memset ( V_128 , 0 , sizeof( V_128 ) ) ;
} else if ( strncmp ( V_85 , L_14 , 5 ) == 0 ) {
...
int F_90 ( void V_111 * V_126 , int V_127 )
{
char * V_85 ;
int V_45 ;
V_45 = F_83 ( & V_85 , V_127 + 1 ) ;
...
int F_94 ( void V_111 * V_126 , int V_127 )
{
char V_85 [ 32 ] ;
int V_45 ;
...
V_112 = 0 ;
else if ( V_112 > F_100 ( F_101 ( V_100 ) ) )
V_112 = F_100 ( F_101 ( V_100 ) ) ;
V_101 = F_71 ( V_7 -> V_6 ) ;
V_45 = F_72 ( V_100 , ( V_110 const char V_111 * ) V_101 ,
V_7 -> V_21 , & V_112 ) ;
F_73 ( V_7 -> V_6 ) ;
...
F_104 ( & V_140 , V_146 ) ;
F_105 ( & V_31 -> V_33 , & V_140 ) ;
F_106 ( V_147 ) ;
F_107 ( F_44 ( 1 ) ) ;
F_108 ( & V_31 -> V_33 , & V_140 ) ;
}
F_99 ( & V_31 -> V_148 ) ;
return 0 ;
}
