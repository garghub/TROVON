...
void F_61 ( struct V_1 * V_1 , unsigned V_81 ,
unsigned V_82 )
{
struct V_68 * V_69 = F_62 ( V_1 ) ;
V_69 -> V_83 = V_81 ;
V_69 -> V_84 = ( 1 << V_1 -> V_12 ) / V_81 ;
V_69 -> V_85 = F_63 ( V_82 , V_81 ) ;
}
...
struct V_68 * V_69 = F_62 ( V_1 ) ;
struct V_5 * V_6 = F_3 ( V_1 ) ;
struct V_86 * V_87 = V_69 -> V_91 ;
int V_8 ;
V_8 = F_69 ( & V_87 -> V_89 , V_1 -> V_21 ) ;
if ( V_8 )
goto V_31;
V_8 = F_69 ( & V_87 -> V_90 ,
& V_6 -> V_92 ) ;
if ( V_8 )
goto V_31;
F_70 ( V_6 -> V_10 , & V_87 -> V_93 ) ;
V_31:
return V_8 ;
}
int F_71 ( struct V_1 * V_1 , struct V_3 * V_4 )
{
struct V_86 * V_87 = F_62 ( V_1 ) -> V_91 ;
struct V_3 * V_94 ;
struct V_50 * V_50 ;
int V_95 = V_1 -> V_12 ;
V_50 = F_72 ( & V_87 -> V_89 , V_4 -> V_11 -> V_48 ) ;
if ( ! V_50 )
return - V_20 ;
if ( ! F_41 ( V_50 ) )
F_73 ( V_50 , 1 << V_95 , 0 ) ;
...
struct V_50 * V_50 ;
int V_97 ;
V_50 = F_39 ( & V_87 -> V_89 , V_4 -> V_11 -> V_48 ) ;
if ( V_50 ) {
if ( F_41 ( V_50 ) ) {
...
{
struct V_98 * V_99 = & V_87 -> V_88 ;
struct V_3 * V_4 ;
while ( ! F_75 ( V_99 ) ) {
V_4 = F_80 ( V_99 , struct V_3 ,
V_96 ) ;
F_81 ( & V_4 -> V_96 ) ;
F_23 ( V_4 ) ;
}
...
F_84 ( V_1 ) ;
F_85 ( V_1 -> V_21 , true ) ;
F_86 ( V_1 -> V_21 , & V_87 -> V_89 ) ;
F_85 ( & V_6 -> V_92 , true ) ;
F_86 ( & V_6 -> V_92 , & V_87 -> V_90 ) ;
F_87 ( V_6 -> V_10 , & V_87 -> V_93 ) ;
F_88 ( & V_69 -> V_71 ) ;
}
