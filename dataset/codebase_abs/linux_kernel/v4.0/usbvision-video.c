...
if ( V_11 -> V_5 == NULL )
goto V_221;
if ( F_114 ( V_11 -> V_5 , V_222 , V_223 ) < 0 )
goto V_221;
F_46 ( V_53 L_33 ,
V_11 -> V_224 , F_109 ( V_11 -> V_5 ) ) ;
if ( V_12 [ V_11 -> V_13 ] . V_97 ) {
V_11 -> V_207 = F_105 ( V_11 ,
& V_225 ,
L_34 ) ;
if ( V_11 -> V_207 == NULL )
goto V_221;
if ( F_114 ( V_11 -> V_207 , V_226 , V_227 ) < 0 )
goto V_221;
F_46 ( V_53 L_35 ,
...
static struct V_1 * F_115 ( struct V_215 * V_6 ,
struct V_228 * V_229 )
{
struct V_1 * V_11 ;
V_11 = F_116 ( sizeof( struct V_1 ) , V_230 ) ;
if ( V_11 == NULL )
return NULL ;
V_11 -> V_6 = V_6 ;
if ( F_117 ( & V_229 -> V_6 , & V_11 -> V_218 ) )
goto V_231;
F_118 ( & V_11 -> V_45 ) ;
V_11 -> V_232 = F_119 ( V_233 , V_230 ) ;
if ( V_11 -> V_232 == NULL )
goto V_234;
F_120 ( & V_11 -> V_235 ) ;
F_121 ( V_11 ) ;
...
static int F_126 ( struct V_228 * V_229 ,
const struct V_243 * V_244 )
{
struct V_215 * V_6 = F_127 ( F_128 ( V_229 ) ) ;
struct V_228 * V_245 ;
...
V_250 = & V_6 -> V_259 -> V_250 [ V_12 [ V_237 ] . V_250 ] -> V_247 [ 0 ] ;
else
V_250 = & V_6 -> V_259 -> V_250 [ V_246 ] -> V_247 [ 0 ] ;
...
V_245 = V_6 -> V_259 -> V_250 [ 0 ] ;
V_11 -> V_267 = V_245 -> V_268 ;
F_22 ( V_219 , L_45 , V_11 -> V_267 ) ;
V_11 -> V_236 = F_131 ( 32 * V_11 -> V_267 , V_230 ) ;
if ( V_11 -> V_236 == NULL ) {
F_17 ( & V_229 -> V_6 , L_46 ) ;
F_47 ( V_11 ) ;
return - V_261 ;
}
for ( V_159 = 0 ; V_159 < V_11 -> V_267 ; V_159 ++ ) {
T_8 V_269 = F_132 ( V_245 -> V_247 [ V_159 ] . V_252 [ 1 ] . V_167 .
V_270 ) ;
V_11 -> V_236 [ V_159 ] =
( V_269 & 0x07ff ) * ( ( ( V_269 & 0x1800 ) >> 11 ) + 1 ) ;
...
if ( V_11 -> V_69 )
V_11 -> V_272 = V_12 [ V_237 ] . V_272 ;
V_11 -> V_13 = V_237 ;
V_11 -> V_52 = 0 ;
V_11 -> V_213 = V_246 ;
V_11 -> V_212 = 0 ;
V_11 -> V_273 = V_252 -> V_274 ;
V_11 -> V_275 = 0 ;
V_11 -> V_276 = 0 ;
V_11 -> V_20 = 0 ;
V_11 -> V_26 = V_277 ;
...
static void F_133 ( struct V_228 * V_229 )
{
struct V_1 * V_11 = F_134 ( F_135 ( V_229 ) ) ;
F_22 ( V_219 , L_28 ) ;
if ( V_11 == NULL ) {
F_136 ( L_48 , V_41 ) ;
return;
