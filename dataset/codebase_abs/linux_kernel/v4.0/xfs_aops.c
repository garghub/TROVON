...
if ( F_35 ( V_13 ) )
return - V_56 ;
V_43 = ( T_2 ) V_167 << V_9 -> V_65 ;
ASSERT ( V_168 -> V_106 >= ( 1 << V_9 -> V_65 ) ) ;
V_44 = V_168 -> V_106 ;
if ( ! V_169 && V_170 && V_43 >= F_119 ( V_9 ) )
return 0 ;
if ( V_169 && ! V_170 ) {
V_171 = V_46 ;
F_19 ( V_11 , V_171 ) ;
...
V_172 = 1 ;
error = F_133 ( V_11 , V_43 , V_44 , & V_62 ) ;
if ( error )
goto V_173;
F_21 ( V_11 , V_171 ) ;
}
F_134 ( V_11 , V_43 , V_44 , 0 , & V_62 ) ;
} else if ( V_70 ) {
F_135 ( V_11 , V_43 , V_44 , 0 , & V_62 ) ;
F_21 ( V_11 , V_171 ) ;
} else {
F_136 ( V_11 , V_43 , V_44 ) ;
goto V_173;
}
if ( V_62 . V_83 != V_84 &&
V_62 . V_83 != V_85 ) {
if ( V_169 || ! F_137 ( & V_62 ) )
F_85 ( V_9 , V_168 , & V_62 , V_43 ) ;
if ( V_169 && F_137 ( & V_62 ) ) {
if ( V_170 ) {
V_168 -> V_21 = V_9 ;
F_138 ( V_168 ) ;
...
if ( V_170 || V_44 > ( 1 << V_9 -> V_65 ) ) {
T_2 V_174 ;
V_174 = V_62 . V_86 + V_62 . V_87 - V_167 ;
V_174 <<= V_9 -> V_65 ;
ASSERT ( V_174 > 0 ) ;
if ( V_174 > V_44 )
V_174 = V_44 ;
if ( V_43 < F_119 ( V_9 ) &&
V_43 + V_174 >= F_119 ( V_9 ) ) {
V_174 = F_142 ( F_119 ( V_9 ) - V_43 ,
1 << V_9 -> V_65 ) ;
}
if ( V_174 > V_175 )
V_174 = V_175 ;
...
void * V_178 )
{
struct V_9 * V_9 = F_146 ( V_177 -> V_179 ) ;
struct V_10 * V_11 = F_6 ( V_9 ) ;
struct V_12 * V_13 = V_11 -> V_14 ;
if ( F_35 ( V_13 ) )
return;
...
if ( V_178 && V_44 > 0 ) {
F_36 ( V_11 , V_43 , V_44 ) ;
} else if ( V_43 + V_44 > V_11 -> V_29 . V_30 ) {
struct V_31 * V_32 ;
int error ;
V_32 = F_12 ( V_13 , V_33 ) ;
error = F_13 ( V_32 , & F_14 ( V_13 ) -> V_34 , 0 , 0 ) ;
...
T_5 V_43 )
{
struct V_9 * V_9 = V_177 -> V_179 -> V_183 -> V_146 ;
struct V_8 * V_184 = F_5 ( V_9 ) ;
if ( V_180 & V_99 ) {
return F_149 ( V_180 , V_177 , V_9 , V_184 , V_182 ,
V_43 , F_144 ,
F_145 , NULL ,
V_185 ) ;
}
...
T_7 V_67 ;
int error ;
V_149 = F_43 ( V_11 -> V_14 , V_186 ) ;
V_67 = F_43 ( V_11 -> V_14 , V_187 ) ;
if ( V_67 <= V_149 )
return;
F_19 ( V_11 , V_46 ) ;
...
T_5 V_190 ;
T_5 V_191 ;
T_5 V_192 = V_188 & ( V_136 - 1 ) ;
T_5 V_193 = V_192 + V_130 ;
struct V_4 * V_5 , * V_6 ;
V_189 = ( V_188 >> V_161 ) << V_161 ;
ASSERT ( V_189 + V_192 == V_188 ) ;
V_6 = F_2 ( V_1 ) ;
V_190 = 0 ;
for ( V_5 = V_6 ; V_5 != V_6 || ! V_190 ;
V_5 = V_5 -> V_7 , V_190 = V_191 ,
V_189 += V_5 -> V_106 ) {
V_191 = V_190 + V_5 -> V_106 ;
if ( V_191 <= V_192 )
continue;
if ( V_190 >= V_193 )
break;
...
if ( ! V_1 )
return - V_198 ;
V_197 = F_158 ( V_1 , V_188 , V_130 , F_143 ) ;
if ( F_159 ( V_197 ) ) {
struct V_9 * V_9 = V_124 -> V_146 ;
T_3 V_45 = F_119 ( V_9 ) ;
F_151 ( V_9 , V_1 , V_188 , V_130 ) ;
F_74 ( V_1 ) ;
if ( V_188 + V_130 > V_45 ) {
T_6 V_186 = F_160 ( T_6 , V_188 , V_45 ) ;
F_161 ( V_9 , V_186 , V_188 + V_130 ) ;
}
F_162 ( V_1 ) ;
V_1 = NULL ;
}
...
int V_200 ;
ASSERT ( V_130 <= V_136 ) ;
V_200 = F_164 ( V_194 , V_124 , V_188 , V_130 , V_199 , V_1 , V_196 ) ;
if ( F_159 ( V_200 < V_130 ) ) {
struct V_9 * V_9 = V_124 -> V_146 ;
T_3 V_45 = F_119 ( V_9 ) ;
T_5 V_193 = V_188 + V_130 ;
if ( V_193 > V_45 ) {
if ( V_188 > V_45 )
V_45 = V_188 ;
F_150 ( V_9 , V_45 , V_193 ) ;
F_161 ( V_9 , V_45 , V_193 ) ;
}
}
return V_200 ;
}
...
F_167 ( V_124 ) ;
F_21 ( V_11 , V_202 ) ;
return F_168 ( V_124 , V_201 , F_143 ) ;
}
STATIC int
F_169 (
struct V_194 * V_203 ,
...
unsigned V_205 )
{
return F_172 ( V_124 , V_144 , V_205 , F_143 ) ;
}
STATIC int
F_173 (
struct V_1 * V_1 )
...
F_182 ( & V_124 -> V_208 , V_157 ) ;
F_183 ( V_124 -> V_146 , V_211 ) ;
}
return V_206 ;
}
