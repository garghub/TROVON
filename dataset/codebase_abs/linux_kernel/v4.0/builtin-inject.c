...
F_49 ( T_2 , T_2 -> V_79 , V_65 , true ) ;
}
return V_16 ;
}
int F_50 ( int V_80 , const char * * V_81 , const char * T_10 V_13 )
{
struct V_5 V_6 = {
. V_2 = {
. T_3 = F_8 ,
...
F_52 ( 'b' , L_14 , & V_6 . V_67 ,
L_15 ) ,
F_53 ( 'i' , L_16 , & V_6 . V_89 , L_17 ,
L_18 ) ,
F_53 ( 'o' , L_19 , & V_6 . V_8 . V_90 , L_17 ,
L_20 ) ,
F_52 ( 's' , L_21 , & V_6 . V_68 ,
L_22
L_23 ) ,
F_54 ( 'v' , L_24 , & V_97 ,
L_25 ) ,
F_53 ( 0 , L_26 , & V_98 . V_99 , L_17 ,
L_27 ) ,
F_55 ()
} ;
...
V_80 = F_56 ( V_80 , V_81 , V_96 , V_100 , 0 ) ;
if ( V_80 )
F_57 ( V_100 , V_96 ) ;
if ( F_58 ( & V_6 . V_8 ) ) {
perror ( L_29 ) ;
...
V_93 . V_90 = V_6 . V_89 ;
V_6 . T_2 = F_59 ( & V_93 , true , & V_6 . V_2 ) ;
if ( V_6 . T_2 == NULL )
return - 1 ;
if ( F_60 ( & V_6 . T_2 -> V_9 . V_101 ) < 0 )
return - 1 ;
V_16 = F_43 ( & V_6 ) ;
F_61 ( V_6 . T_2 ) ;
return V_16 ;
