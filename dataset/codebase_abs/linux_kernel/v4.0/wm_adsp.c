...
switch ( F_40 ( V_138 -> V_144 ) & 0xff ) {
case 1 :
break;
default:
F_21 ( V_27 , L_52 ,
V_81 , F_40 ( V_138 -> V_144 ) & 0xff ) ;
V_47 = - V_23 ;
goto V_92;
}
F_24 ( V_27 , L_53 , V_81 ,
...
V_143 = F_38 ( V_140 -> V_3 ) % 4 ;
if ( V_143 )
V_70 += F_38 ( V_140 -> V_3 ) + ( 4 - V_143 ) + sizeof( * V_140 ) ;
else
V_70 += F_38 ( V_140 -> V_3 ) + sizeof( * V_140 ) ;
V_142 ++ ;
}
V_47 = F_43 ( V_51 ) ;
if ( V_47 != 0 )
...
int F_60 ( struct V_145 * V_146 ,
struct V_8 * V_9 ,
int V_147 )
{
struct V_12 * V_13 = F_61 ( V_146 -> V_148 ) ;
struct V_17 * V_149 = F_13 ( V_13 ) ;
struct V_17 * V_27 = & V_149 [ V_146 -> V_150 ] ;
struct V_45 * V_141 ;
struct V_41 * V_42 ;
int V_47 ;
int V_131 ;
V_27 -> V_65 = V_13 -> V_151 . V_65 ;
switch ( V_147 ) {
case V_152 :
F_62 ( V_27 -> V_51 , V_27 -> V_34 + V_153 ,
V_154 , V_154 ) ;
if( V_27 -> V_155 ) {
V_47 = F_63 ( V_27 -> V_51 , V_27 -> V_155 , & V_131 ) ;
if ( V_47 != 0 ) {
F_21 ( V_27 , L_64 ,
V_47 ) ;
return V_47 ;
}
V_131 = ( V_131 & V_27 -> V_156 )
>> V_27 -> V_157 ;
V_47 = F_62 ( V_27 -> V_51 ,
V_27 -> V_34 + V_158 ,
V_159 , V_131 ) ;
...
F_62 ( V_27 -> V_51 , V_27 -> V_34 + V_153 ,
V_161 | V_162 , 0 ) ;
F_62 ( V_27 -> V_51 , V_27 -> V_34 + V_164 ,
V_165 , 0 ) ;
F_62 ( V_27 -> V_51 , V_27 -> V_34 + V_153 ,
V_154 , 0 ) ;
...
unsigned int V_131 ;
int V_47 , V_44 ;
V_47 = F_65 ( V_27 -> V_51 , V_27 -> V_34 + V_166 ,
V_167 , V_167 ) ;
if ( V_47 != 0 )
return V_47 ;
for ( V_44 = 0 ; V_44 < 10 ; ++ V_44 ) {
V_47 = F_63 ( V_27 -> V_51 , V_27 -> V_34 + V_168 ,
& V_131 ) ;
if ( V_47 != 0 )
return V_47 ;
if ( V_131 & V_169 )
...
int V_47 ;
unsigned int V_131 ;
V_47 = F_63 ( V_27 -> V_51 , V_171 , & V_131 ) ;
if ( V_47 != 0 ) {
F_21 ( V_27 , L_64 , V_47 ) ;
return;
}
...
if ( V_27 -> V_176 ) {
V_47 = F_63 ( V_27 -> V_51 ,
V_27 -> V_34 + V_174 , & V_131 ) ;
if ( V_47 != 0 ) {
F_21 ( V_27 , L_68 , V_47 ) ;
return;
}
if ( ( V_131 & V_175 ) >= 3 ) {
V_47 = F_68 ( V_27 -> V_176 ) ;
if ( V_47 != 0 ) {
F_21 ( V_27 ,
L_69 ,
V_47 ) ;
...
return;
V_160:
F_62 ( V_27 -> V_51 , V_27 -> V_34 + V_166 ,
V_167 | V_177 | V_178 , 0 ) ;
}
int F_70 ( struct V_145 * V_146 ,
...
F_74 ( V_27 -> V_51 , V_27 -> V_34 + V_184 , 0 ) ;
if ( V_27 -> V_176 ) {
V_47 = F_69 ( V_27 -> V_176 , 1200000 ,
1800000 ) ;
if ( V_47 != 0 )
F_41 ( V_27 ,
L_71 ,
V_47 ) ;
V_47 = F_75 ( V_27 -> V_176 ) ;
if ( V_47 != 0 )
F_21 ( V_27 ,
L_69 ,
V_47 ) ;
...
int F_76 ( struct V_17 * V_18 , bool V_176 )
{
int V_47 ;
V_47 = F_62 ( V_18 -> V_51 , V_18 -> V_34 + V_166 ,
V_185 , 0 ) ;
if ( V_47 != 0 ) {
F_21 ( V_18 , L_73 , V_47 ) ;
return V_47 ;
...
F_59 ( & V_18 -> V_134 ) ;
F_59 ( & V_18 -> V_67 ) ;
F_51 ( & V_18 -> V_170 , F_67 ) ;
if ( V_176 ) {
V_18 -> V_176 = F_77 ( V_18 -> V_89 , L_74 ) ;
if ( F_78 ( V_18 -> V_176 ) ) {
V_47 = F_79 ( V_18 -> V_176 ) ;
F_21 ( V_18 , L_75 , V_47 ) ;
return V_47 ;
}
V_47 = F_68 ( V_18 -> V_176 ) ;
if ( V_47 != 0 ) {
F_21 ( V_18 , L_76 , V_47 ) ;
return V_47 ;
}
V_47 = F_69 ( V_18 -> V_176 , 1200000 , 1800000 ) ;
if ( V_47 != 0 ) {
F_21 ( V_18 , L_77 , V_47 ) ;
return V_47 ;
}
V_47 = F_75 ( V_18 -> V_176 ) ;
if ( V_47 != 0 ) {
F_21 ( V_18 , L_78 , V_47 ) ;
return V_47 ;
}
