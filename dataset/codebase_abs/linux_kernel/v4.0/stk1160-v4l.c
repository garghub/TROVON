...
{
struct V_1 * V_2 = F_21 ( V_45 ) ;
return F_3 ( V_2 , V_19 -> V_19 , V_19 -> V_20 ) ;
}
static int F_39 ( struct V_78 * V_95 , const struct V_67 * V_96 ,
...
* V_97 = F_41 (unsigned int, *nbuffers,
...
{
unsigned long V_104 ;
struct V_1 * V_2 = F_40 ( V_103 -> V_78 ) ;
struct V_105 * V_106 =
F_43 ( V_103 , struct V_105 , V_103 ) ;
F_44 ( & V_2 -> V_107 , V_104 ) ;
if ( ! V_2 -> V_28 ) {
F_45 ( & V_106 -> V_103 , V_108 ) ;
} else {
V_106 -> V_109 = F_46 ( V_103 , 0 ) ;
V_106 -> V_110 = F_47 ( V_103 , 0 ) ;
V_106 -> V_111 = 0 ;
V_106 -> V_112 = 0 ;
if ( V_106 -> V_110 < V_2 -> V_70 * V_2 -> V_71 * 2 )
F_45 ( & V_106 -> V_103 , V_108 ) ;
else
F_48 ( & V_106 -> V_113 , & V_2 -> V_114 ) ;
}
F_49 ( & V_2 -> V_107 , V_104 ) ;
}
static int F_50 ( struct V_78 * V_95 , unsigned int V_115 )
{
struct V_1 * V_2 = F_40 ( V_95 ) ;
return F_7 ( V_2 ) ;
}
static void F_51 ( struct V_78 * V_95 )
{
struct V_1 * V_2 = F_40 ( V_95 ) ;
F_17 ( V_2 ) ;
}
...
unsigned long V_104 ;
F_44 ( & V_2 -> V_107 , V_104 ) ;
while ( ! F_52 ( & V_2 -> V_114 ) ) {
V_106 = F_53 ( & V_2 -> V_114 ,
struct V_105 , V_113 ) ;
F_54 ( & V_106 -> V_113 ) ;
F_45 ( & V_106 -> V_103 , V_108 ) ;
F_5 ( L_14 ,
...
int V_30 ;
V_2 -> V_90 = V_130 ;
V_2 -> V_90 . V_131 = & V_2 -> V_80 ;
V_2 -> V_90 . V_132 = & V_2 -> V_32 ;
V_2 -> V_90 . V_131 -> V_132 = & V_2 -> V_133 ;
