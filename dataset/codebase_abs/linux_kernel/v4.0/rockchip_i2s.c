...
F_10 ( V_4 -> V_12 , V_13 , V_63 ,
F_18 ( 16 ) ) ;
F_10 ( V_4 -> V_12 , V_13 , V_64 ,
F_19 ( 16 ) ) ;
return 0 ;
}
static int F_20 ( struct V_53 * V_54 ,
int V_65 , struct V_7 * V_8 )
{
struct V_3 * V_4 = F_7 ( V_8 ) ;
int V_6 = 0 ;
switch ( V_65 ) {
...
static int F_21 ( struct V_7 * V_28 , int V_74 ,
unsigned int V_75 , int V_76 )
{
struct V_3 * V_4 = F_7 ( V_28 ) ;
int V_6 ;
V_6 = F_22 ( V_4 -> V_5 , V_75 ) ;
if ( V_6 )
F_6 ( V_4 -> V_2 , L_3 , V_6 ) ;
return V_6 ;
}
...
static bool F_24 ( struct V_1 * V_2 , unsigned int V_79 )
{
switch ( V_79 ) {
case V_47 :
case V_52 :
...
static bool F_25 ( struct V_1 * V_2 , unsigned int V_79 )
{
switch ( V_79 ) {
case V_47 :
case V_52 :
...
static bool F_26 ( struct V_1 * V_2 , unsigned int V_79 )
{
switch ( V_79 ) {
case V_84 :
case V_23 :
...
static bool F_27 ( struct V_1 * V_2 , unsigned int V_79 )
{
switch ( V_79 ) {
default:
return false ;
...
void T_1 * V_89 ;
int V_6 ;
V_4 = F_29 ( & V_86 -> V_2 , sizeof( * V_4 ) , V_90 ) ;
if ( ! V_4 ) {
F_6 ( & V_86 -> V_2 , L_4 ) ;
return - V_91 ;
}
V_4 -> V_92 = F_30 ( & V_86 -> V_2 , L_5 ) ;
if ( F_31 ( V_4 -> V_92 ) ) {
F_6 ( & V_86 -> V_2 , L_6 ) ;
return F_32 ( V_4 -> V_92 ) ;
}
V_6 = F_5 ( V_4 -> V_92 ) ;
if ( V_6 ) {
F_6 ( V_4 -> V_2 , L_7 , V_6 ) ;
...
V_4 -> V_5 = F_30 ( & V_86 -> V_2 , L_8 ) ;
if ( F_31 ( V_4 -> V_5 ) ) {
F_6 ( & V_86 -> V_2 , L_9 ) ;
return F_32 ( V_4 -> V_5 ) ;
}
V_88 = F_33 ( V_86 , V_93 , 0 ) ;
V_89 = F_34 ( & V_86 -> V_2 , V_88 ) ;
if ( F_31 ( V_89 ) )
return F_32 ( V_89 ) ;
V_4 -> V_12 = F_35 ( & V_86 -> V_2 , V_89 ,
& V_94 ) ;
if ( F_31 ( V_4 -> V_12 ) ) {
F_6 ( & V_86 -> V_2 ,
L_10 ) ;
...
V_4 -> V_78 . V_95 = V_88 -> V_96 + V_81 ;
V_4 -> V_78 . V_97 = V_98 ;
V_4 -> V_78 . V_99 = 4 ;
V_4 -> V_77 . V_95 = V_88 -> V_96 + V_82 ;
V_4 -> V_77 . V_97 = V_98 ;
V_4 -> V_77 . V_99 = 4 ;
V_4 -> V_2 = & V_86 -> V_2 ;
F_36 ( & V_86 -> V_2 , V_4 ) ;
