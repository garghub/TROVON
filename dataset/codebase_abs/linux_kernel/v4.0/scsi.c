...
if ( ! F_77 ( & V_74 -> V_137 ) )
return - V_136 ;
F_78 ( V_74 -> V_28 -> V_36 -> V_138 ) ;
return 0 ;
}
void F_79 ( struct V_26 * V_74 )
{
F_80 ( V_74 -> V_28 -> V_36 -> V_138 ) ;
F_81 ( & V_74 -> V_137 ) ;
}
struct V_26 * F_82 ( struct V_2 * V_3 ,
struct V_26 * V_139 )
{
struct V_140 * V_23 = ( V_139 ? & V_139 -> V_141 : & V_3 -> V_142 ) ;
struct V_26 * V_22 = NULL ;
unsigned long V_19 ;
F_11 ( V_3 -> V_143 , V_19 ) ;
while ( V_23 -> V_22 != & V_3 -> V_142 ) {
V_22 = F_14 ( V_23 -> V_22 , struct V_26 , V_141 ) ;
if ( ! F_76 ( V_22 ) )
break;
V_22 = NULL ;
V_23 = V_23 -> V_22 ;
...
void F_83 ( struct V_75 * V_76 , void * V_144 ,
void (* F_84)( struct V_26 * , void * ) )
{
struct V_2 * V_3 = F_85 ( V_76 -> V_27 . V_145 ) ;
struct V_26 * V_74 ;
F_86 (sdev, shost) {
if ( ( V_74 -> V_146 == V_76 -> V_146 ) &&
( V_74 -> V_147 == V_76 -> V_147 ) )
F_84 ( V_74 , V_144 ) ;
}
}
void F_87 ( struct V_75 * V_76 , void * V_144 ,
void (* F_84)( struct V_26 * , void * ) )
{
struct V_2 * V_3 = F_85 ( V_76 -> V_27 . V_145 ) ;
struct V_26 * V_74 ;
...
if ( V_74 -> V_146 == V_146 && V_74 -> V_147 == V_147 &&
V_74 -> V_148 == V_148 )
return V_74 ;
}
return NULL ;
...
unsigned long V_19 ;
F_11 ( V_3 -> V_143 , V_19 ) ;
V_74 = F_92 ( V_3 , V_146 , V_147 , V_148 ) ;
if ( V_74 && F_76 ( V_74 ) )
V_74 = NULL ;
F_16 ( V_3 -> V_143 , V_19 ) ;
return V_74 ;
