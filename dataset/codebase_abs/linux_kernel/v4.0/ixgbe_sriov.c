...
V_2 -> V_9 &= ~ V_13 ;
V_2 -> V_9 &= ~ V_10 ;
V_47 = F_10 ( int , F_21 ( V_2 ) ,
F_22 () ) ;
} else {
V_47 = F_10 ( int , V_54 , F_22 () ) ;
}
V_2 -> V_14 [ V_15 ] . V_17 = 0 ;
V_2 -> V_14 [ V_55 ] . V_16 = V_47 ;
F_23 ( 100 ) ;
return 0 ;
}
static int F_24 ( struct V_56 * V_43 , int V_12 )
{
#ifdef F_15
...
static int F_28 ( struct V_56 * V_43 )
{
struct V_1 * V_2 = F_25 ( V_43 ) ;
int V_44 ;
#ifdef F_15
...
V_44 = F_13 ( V_2 ) ;
#ifdef F_15
if ( ! V_44 && V_59 != V_2 -> V_9 )
F_27 ( V_2 ) ;
#endif
return V_44 ;
}
int F_29 ( struct V_56 * V_43 , int V_12 )
{
if ( V_12 == 0 )
return F_28 ( V_43 ) ;
else
return F_24 ( V_43 , V_12 ) ;
}
...
T_1 V_81 ;
if ( V_2 -> V_4 . V_18 . type == V_31 ) {
struct V_82 * V_43 = V_2 -> V_83 ;
int V_84 = V_43 -> V_85 + V_86 ;
T_1 V_87 , V_88 , V_89 ;
T_3 V_44 = 0 ;
#ifdef F_38
if ( V_43 -> V_90 & V_91 )
...
int F_26 ( struct V_56 * V_42 , unsigned int V_121 )
{
...
V_44 = F_36 ( V_2 , V_76 , V_77 , F_71 ( 0 ) ) ;
V_44 = F_36 ( V_2 , V_76 , V_77 , V_24 ) ;
if ( ! V_44 && V_2 -> V_29 [ V_24 ] . V_39 )
V_4 -> V_18 . V_78 . V_109 ( V_4 , true , V_24 ) ;
if ( ! V_76 && V_2 -> V_83 -> V_9 & V_154 ) {
V_150 = F_68 ( V_4 , V_77 ) ;
if ( V_150 < 0 )
...
if ( V_2 -> V_29 [ V_24 ] . V_39 )
F_75 ( V_2 -> V_83 , V_24 , false ) ;
}
V_44 = F_51 ( V_2 , V_24 , V_114 , V_142 ) ;
if ( V_44 == - V_120 )
F_66 ( V_98 ,
L_16 ,
V_24 ) ;
...
F_91 ( & V_2 -> V_42 -> V_43 , L_20 , V_18 , V_24 ) ;
F_91 ( & V_2 -> V_42 -> V_43 , L_21
L_22 ) ;
if ( F_73 ( V_178 , & V_2 -> V_179 ) ) {
F_9 ( & V_2 -> V_42 -> V_43 , L_23
L_24 ) ;
F_9 ( & V_2 -> V_42 -> V_43 , L_25
L_26 ) ;
}
...
if ( V_44 )
goto V_181;
V_44 = F_92 ( V_2 , V_24 , V_144 , V_180 ) ;
} else {
V_44 = F_93 ( V_2 , V_24 ) ;
}
V_181:
...
V_211 -> V_212 = V_2 -> V_29 [ V_24 ] . V_39 ;
return 0 ;
}
