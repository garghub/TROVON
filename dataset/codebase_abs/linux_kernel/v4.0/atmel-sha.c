...
struct V_165 * V_166 ;
if ( ! V_182 ) {
F_40 ( & V_180 -> V_33 , L_20 ) ;
return F_96 ( - V_48 ) ;
}
V_166 = F_97 ( & V_180 -> V_33 , sizeof( * V_166 ) , V_184 ) ;
if ( ! V_166 ) {
F_40 ( & V_180 -> V_33 , L_21 ) ;
return F_96 ( - V_167 ) ;
}
...
unsigned long V_187 ;
int V_107 ;
V_142 = F_97 ( & V_180 -> V_33 , sizeof( struct V_1 ) ,
V_184 ) ;
if ( V_142 == NULL ) {
F_40 ( V_33 , L_23 ) ;
V_107 = - V_167 ;
...
F_99 ( V_180 , V_142 ) ;
F_100 ( & V_142 -> V_189 ) ;
F_101 ( & V_142 -> V_120 , F_79 ,
( unsigned long ) V_142 ) ;
F_102 ( & V_142 -> V_129 , V_190 ) ;
V_142 -> V_140 = - 1 ;
V_186 = F_103 ( V_180 , V_191 , 0 ) ;
if ( ! V_186 ) {
F_40 ( V_33 , L_24 ) ;
V_107 = - V_192 ;
goto V_193;
}
V_142 -> V_174 = V_186 -> V_194 ;
V_187 = F_104 ( V_186 ) ;
...
V_107 = F_106 ( V_142 -> V_140 , F_80 , V_195 , L_26 ,
V_142 ) ;
if ( V_107 ) {
F_40 ( V_33 , L_27 ) ;
goto V_193;
...
V_142 -> V_4 = F_110 ( V_142 -> V_174 , V_187 ) ;
if ( ! V_142 -> V_4 ) {
F_40 ( V_33 , L_30 ) ;
V_107 = - V_167 ;
goto V_197;
...
F_94 ( V_142 ) ;
if ( V_142 -> V_54 . V_55 ) {
V_166 = V_180 -> V_33 . V_198 ;
if ( ! V_166 ) {
V_166 = F_95 ( V_180 ) ;
if ( F_108 ( V_166 ) ) {
F_40 ( & V_180 -> V_33 , L_31 ) ;
V_107 = F_109 ( V_166 ) ;
goto V_199;
}
}
...
goto V_201;
F_62 ( V_33 , L_32 ,
F_111 ( V_142 -> V_92 . V_96 ) ) ;
}
F_112 ( & V_31 . V_32 ) ;
F_113 ( & V_142 -> V_189 , & V_31 . V_202 ) ;
F_114 ( & V_31 . V_32 ) ;
V_107 = F_85 ( V_142 ) ;
if ( V_107 )
goto V_203;
...
static int F_120 ( struct V_179 * V_180 )
{
