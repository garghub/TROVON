...
void F_268 ( struct V_31 * V_356 , int V_206 )
{
...
int F_271 ( struct V_31 * V_356 , int V_206 )
{
struct V_3 * V_4 = & V_356 -> V_371 ;
struct V_36 * V_39 = F_46 ( V_356 -> V_99 . V_100 ) ;
int V_1 = V_206 ? V_136 : V_137 ;
...
int F_272 ( struct V_33 * V_377 , int V_206 )
{
int V_162 ;
int V_1 = V_206 ? V_136 : V_137 ;
...
void F_273 ( struct V_33 * V_377 , int V_206 )
{
int V_1 = V_206 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_377 -> V_35 ;
struct V_36 * V_39 = V_4 -> V_28 ;
