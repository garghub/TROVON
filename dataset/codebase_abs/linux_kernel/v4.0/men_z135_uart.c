...
if ( V_111 == 0 )
V_111 = V_140 ;
V_109 = F_52 ( V_6 , V_108 , V_80 , 0 , V_111 / 16 ) ;
F_53 ( & V_6 -> V_9 ) ;
if ( F_54 ( V_108 ) )
F_55 ( V_108 , V_109 , V_109 ) ;
V_110 = V_111 / ( 4 * V_109 ) ;
F_4 ( V_110 , V_6 -> V_10 + V_141 ) ;
F_56 ( V_6 , V_108 -> V_113 , V_109 ) ;
F_57 ( & V_6 -> V_9 ) ;
}
static const char * F_58 ( struct V_5 * V_6 )
{
return V_142 ;
}
...
F_60 ( V_6 -> V_10 ) ;
V_6 -> V_10 = NULL ;
F_61 ( V_6 -> V_143 , V_144 ) ;
}
static int F_62 ( struct V_5 * V_6 )
{
int V_35 = V_144 ;
if ( ! F_63 ( V_6 -> V_143 , V_35 , L_7 ) )
return - V_145 ;
V_6 -> V_10 = F_64 ( V_6 -> V_143 , V_144 ) ;
if ( V_6 -> V_10 == NULL ) {
F_61 ( V_6 -> V_143 , V_144 ) ;
return - V_146 ;
}
...
static void F_65 ( struct V_5 * V_6 , int type )
{
V_6 -> type = V_147 ;
F_62 ( V_6 ) ;
}
...
static int F_67 ( struct V_151 * V_38 ,
...
int V_76 ;
V_39 = & V_38 -> V_39 ;
V_2 = F_68 ( V_39 , sizeof( struct V_1 ) , V_156 ) ;
if ( ! V_2 )
return - V_146 ;
V_2 -> V_40 = ( unsigned char * ) F_69 ( V_156 ) ;
if ( ! V_2 -> V_40 )
return - V_146 ;
V_155 = & V_38 -> V_155 ;
F_70 ( V_38 , V_2 ) ;
...
F_72 ( & V_2 -> V_6 . V_9 ) ;
F_72 ( & V_2 -> V_9 ) ;
V_76 = F_73 ( & V_167 , & V_2 -> V_6 ) ;
if ( V_76 )
goto V_76;
return 0 ;
V_76:
F_74 ( ( unsigned long ) V_2 -> V_40 ) ;
F_24 ( V_39 , L_8 , V_76 ) ;
return V_76 ;
}
static void F_75 ( struct V_151 * V_38 )
{
struct V_1 * V_2 = F_76 ( V_38 ) ;
line -- ;
F_77 ( & V_167 , & V_2 -> V_6 ) ;
F_74 ( ( unsigned long ) V_2 -> V_40 ) ;
}
