...
{
struct V_12 * V_13 = V_98 -> V_137 ;
struct V_138 * V_74 = V_98 -> V_74 ;
int V_139 = 0 ;
...
static int F_54 ( struct V_147 * V_148 )
{
return F_55 ( V_148 ) ;
}
...
int V_118 ;
struct V_152 * V_69 ;
V_151 = F_57 ( & V_150 -> V_2 , sizeof( * V_151 ) , V_105 ) ;
if ( V_151 == NULL ) {
return - V_106 ;
}
V_69 = F_57 ( & V_150 -> V_2 , sizeof( * V_69 ) , V_105 ) ;
if ( V_69 == NULL ) {
return - V_106 ;
}
V_69 -> V_70 = V_153 ;
V_69 -> V_71 = F_58 ( V_153 ) ;
V_151 -> V_69 = V_69 ;
V_151 -> V_150 = V_150 ;
F_59 ( & V_151 -> V_154 ) ;
F_60 ( & V_150 -> V_2 , V_151 ) ;
V_118 = F_61 ( & V_150 -> V_2 , & V_155 ) ;
if ( V_118 ) {
F_5 ( & V_150 -> V_2 , L_16 ) ;
return V_118 ;
}
V_118 = F_62 ( & V_150 -> V_2 , & V_156 ,
V_157 , F_58 ( V_157 ) ) ;
if ( V_118 ) {
F_5 ( & V_150 -> V_2 , L_17 ) ;
F_63 ( & V_150 -> V_2 ) ;
...
static int F_64 ( struct V_149 * V_150 )
{
F_65 ( & V_150 -> V_2 ) ;
F_63 ( & V_150 -> V_2 ) ;
F_8 ( & V_150 -> V_2 , L_18 ) ;
