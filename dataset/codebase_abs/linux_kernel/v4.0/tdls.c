...
{
struct V_62 * V_63 ;
struct V_258 * V_138 = V_135 ;
int V_259 = 0 ;
unsigned long V_14 ;
if ( ! F_81 ( V_2 -> V_17 -> V_260 ) )
return 0 ;
if ( ! ( V_2 -> V_198 == V_261 && V_2 -> V_262 ) )
return 0 ;
F_3 ( & V_2 -> V_263 , V_14 ) ;
F_19 (sta_ptr, &priv->sta_list, list) {
if ( V_63 -> V_232 == V_25 ) {
F_82 ( V_138 -> V_264 , V_63 -> V_265 ) ;
V_138 ++ ;
V_259 ++ ;
if ( V_259 >= V_266 )
break;
...
F_1 ( V_2 , V_63 -> V_265 ,
V_241 ) ;
memcpy ( & V_231 . V_234 , V_63 -> V_265 , V_152 ) ;
V_231 . V_235 = V_243 ;
if ( F_70 ( V_2 , V_237 ,
V_238 , 0 , & V_231 , false ) )
F_34 ( V_2 -> V_17 -> V_18 ,
...
int F_85 ( struct V_1 * V_2 , struct V_9 * V_10 )
{
struct V_268 * V_138 ;
unsigned long V_14 ;
T_1 V_3 [ V_152 ] ;
...
if ( ! memcmp ( V_3 , V_138 -> V_265 , V_152 ) ) {
if ( V_138 -> V_270 <= V_271 &&
V_138 -> V_232 == V_242 &&
( V_138 -> V_272 <
V_273 ) ) {
V_138 -> V_232 = V_239 ;
...
{
struct V_268 * V_138 , * V_280 ;
unsigned long V_14 ;
F_3 ( & V_2 -> V_269 , V_14 ) ;
F_88 (peer, tmp_node, &priv->auto_tdls_list, list) {
F_89 ( & V_138 -> V_29 ) ;
F_90 ( V_138 ) ;
}
F_91 ( & V_2 -> V_281 ) ;
...
void F_92 ( struct V_1 * V_2 , const T_1 * V_3 )
{
struct V_268 * V_282 ;
unsigned long V_14 ;
if ( ! V_2 -> V_17 -> V_283 )
...
if ( ! memcmp ( V_282 -> V_265 , V_3 , V_152 ) ) {
V_282 -> V_232 = V_239 ;
V_282 -> V_284 = V_285 ;
F_17 ( & V_2 -> V_269 , V_14 ) ;
return;
...
V_282 = F_93 ( sizeof( * V_282 ) , V_276 ) ;
if ( V_282 ) {
F_82 ( V_282 -> V_265 , V_3 ) ;
V_282 -> V_232 = V_239 ;
V_282 -> V_284 = V_285 ;
F_91 ( & V_282 -> V_29 ) ;
F_94 ( & V_282 -> V_29 , & V_2 -> V_281 ) ;
...
F_3 ( & V_2 -> V_269 , V_14 ) ;
F_19 (peer, &priv->auto_tdls_list, list) {
if ( ! memcmp ( V_138 -> V_265 , V_3 , V_152 ) ) {
if ( ( V_286 == V_242 ) &&
( V_138 -> V_232 == V_239 ) )
V_138 -> V_272 ++ ;
else if ( V_286 == V_25 )
...
void F_96 ( unsigned long V_289 )
{
struct V_1 * V_2 = (struct V_1 * ) V_289 ;
struct V_268 * V_282 ;
unsigned long V_14 ;
T_3 V_290 = V_291 ;
if ( F_97 ( ! V_2 || ! V_2 -> V_17 ) ) {
F_98 ( L_16 ,
V_19 ) ;
return;
}
if ( F_33 ( ! V_2 -> V_17 -> V_283 ) )
return;
if ( ! V_2 -> V_292 ) {
F_2 ( V_2 -> V_17 -> V_18 ,
L_17 ) ;
...
F_3 ( & V_2 -> V_269 , V_14 ) ;
F_19 (tdls_peer, &priv->auto_tdls_list, list) {
if ( ( V_285 - V_282 -> V_284 ) >
( V_295 * V_296 ) ) {
V_282 -> V_270 = 0 ;
V_282 -> V_279 = true ;
V_2 -> V_278 = true ;
}
if ( ( ( V_282 -> V_270 >= V_297 ) ||
! V_282 -> V_270 ) &&
V_282 -> V_232 == V_25 ) {
V_282 -> V_232 = V_241 ;
F_2 ( V_2 -> V_17 -> V_18 ,
L_18 ,
V_282 -> V_265 , - V_282 -> V_270 ) ;
V_282 -> V_279 = true ;
V_2 -> V_278 = true ;
F_86 ( V_2 -> V_274 ,
V_282 -> V_265 ,
