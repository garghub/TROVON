...
{
struct V_118 * V_119 = F_6 ( V_116 ) ;
F_35 ( V_119 -> V_131 , false ) ;
F_38 ( V_116 ) ;
return 0 ;
}
static int F_39 ( struct V_259 * V_260 ,
const struct V_261 * V_180 )
{
struct V_262 * V_263 = F_40 ( & V_260 -> V_2 ) ;
struct V_118 * V_119 ;
int V_229 ;
V_119 = F_41 ( & V_260 -> V_2 , sizeof( * V_119 ) ,
V_264 ) ;
if ( NULL == V_119 )
return - V_265 ;
F_42 ( V_260 , V_119 ) ;
if ( V_263 )
V_119 -> V_263 = * V_263 ;
V_119 -> V_131 = F_43 ( V_260 , & V_266 ) ;
if ( F_44 ( V_119 -> V_131 ) ) {
V_229 = F_45 ( V_119 -> V_131 ) ;
F_8 ( & V_260 -> V_2 , L_13 ,
V_229 ) ;
return V_229 ;
}
F_46 ( V_119 -> V_131 , V_19 , & V_229 ) ;
if ( V_229 != V_267 ) {
F_8 ( & V_260 -> V_2 ,
L_14 , V_229 ) ;
return - V_268 ;
...
V_229 = F_47 ( V_119 -> V_131 , V_269 ,
F_2 ( V_269 ) ) ;
if ( V_229 != 0 )
F_48 ( & V_260 -> V_2 , L_15 , V_229 ) ;
...
V_273 , V_274 ) ;
V_119 -> V_162 = 1 ;
V_229 = F_49 ( & V_260 -> V_2 , & V_275 ,
V_276 , F_2 ( V_276 ) ) ;
return V_229 ;
}
static int F_50 ( struct V_259 * V_260 )
{
F_51 ( & V_260 -> V_2 ) ;
return 0 ;
}
