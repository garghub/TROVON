...
const T_3 * V_74 ;
int V_3 ;
V_74 = F_21 ( V_60 , L_1 , & V_3 ) ;
if ( V_74 && V_3 >= sizeof( T_3 ) )
V_2 -> V_36 = F_22 ( V_74 ) ;
}
if ( ! V_2 -> V_36 )
V_2 -> V_36 = V_71 ;
...
V_44 -> V_75 = V_9 -> V_64 -> V_76 ;
V_44 -> V_77 = V_30 | V_32 | V_34 ;
V_44 -> V_78 = F_23 ( 8 ) ;
V_44 -> V_79 = F_15 ;
V_44 -> V_80 = F_9 ;
V_44 -> V_58 . V_61 = V_60 ;
V_44 -> V_81 = V_2 -> V_36 / 128 ;
V_44 -> V_82 = V_2 -> V_36 / 4 ;
error = F_24 ( V_58 , V_44 ) ;
if ( error )
goto V_83;
return 0 ;
V_83:
