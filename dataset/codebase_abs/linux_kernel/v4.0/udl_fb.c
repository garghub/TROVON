...
V_2 -> V_91 = & V_125 ;
F_54 ( V_2 , V_37 -> V_59 [ 0 ] , V_37 -> V_126 ) ;
F_55 ( V_2 , & V_10 -> V_109 , V_111 -> V_127 , V_111 -> V_128 ) ;
V_43 = F_56 ( & V_2 -> V_129 , 256 , 0 ) ;
if ( V_43 ) {
V_43 = - V_53 ;
goto V_119;
}
...
int V_43 ;
T_2 V_66 ;
V_51 = F_76 ( V_13 , V_95 , V_105 -> V_135 [ 0 ] ) ;
if ( V_51 == NULL )
return F_77 ( - V_136 ) ;
V_66 = V_105 -> V_59 [ 0 ] * V_105 -> V_41 ;
V_66 = F_51 ( V_66 , V_33 ) ;
