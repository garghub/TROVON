...
if ( V_120 == 0 )
return F_57 ( - V_121 ) ;
V_119 = F_49 ( V_42 , sizeof( * V_119 ) , V_101 ) ;
if ( ! V_119 )
return F_57 ( - V_102 ) ;
V_119 -> V_122 = F_59 ( V_42 , V_120 , sizeof( * V_62 ) , V_101 ) ;
if ( ! V_119 -> V_122 )
return F_57 ( - V_102 ) ;
V_119 -> V_120 = V_120 ;
V_70 = 0 ;
...
V_5 -> V_7 = F_59 ( & V_126 -> V_42 , V_5 -> V_115 ,
sizeof( * V_5 -> V_7 ) , V_101 ) ;
if ( ! V_5 -> V_7 )
return - V_102 ;
V_128 = F_69 ( V_126 , V_129 , 0 ) ;
V_5 -> V_9 = F_70 ( & V_126 -> V_42 , V_128 ) ;
if ( F_67 ( V_5 -> V_9 ) )
return F_68 ( V_5 -> V_9 ) ;
...
{
struct V_4 * V_5 = F_73 ( V_126 ) ;
F_53 ( V_5 ) ;
F_45 ( V_5 ) ;
return 0 ;
}
static int F_74 ( struct V_117 * V_42 )
{
struct V_125 * V_126 = F_75 ( V_42 ) ;
struct V_4 * V_5 = F_73 ( V_126 ) ;
struct V_2 * V_3 = & V_5 -> V_7 [ 0 ] . V_3 ;
unsigned long V_39 ;
int V_70 ;
...
V_100 -> V_136 = F_3 ( V_5 , V_41 ) ;
V_100 -> V_137 = F_3 ( V_5 , V_19 ) ;
V_100 -> V_138 = F_3 ( V_5 , V_51 ) ;
V_100 -> V_139 = F_3 ( V_5 , V_56 ) ;
...
static int F_77 ( struct V_117 * V_42 )
{
struct V_125 * V_126 = F_75 ( V_42 ) ;
struct V_4 * V_5 = F_73 ( V_126 ) ;
struct V_2 * V_3 = & V_5 -> V_7 [ 0 ] . V_3 ;
...
if ( V_99 == 0 ) {
F_4 ( V_5 , V_51 , V_100 -> V_138 ) ;
F_4 ( V_5 , V_19 , V_100 -> V_137 ) ;
F_4 ( V_5 , V_56 , V_100 -> V_139 ) ;
F_4 ( V_5 , V_41 , V_100 -> V_136 ) ;
