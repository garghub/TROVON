...
static inline const char * F_51 ( int V_101 )
{
switch ( V_101 ) {
case V_16 :
...
struct V_102 * V_103 ;
T_1 V_2 ;
V_103 = F_53 ( sizeof( struct V_102 ) * V_4 . V_5 ) ;
V_104 = V_103 ;
for ( V_3 = 0 ; V_3 < V_4 . V_5 ; V_3 ++ ) {
...
V_103 -> V_106 = F_51 ( V_4 . V_8 [ V_3 ] . type ) ;
...
F_55 ( V_111 -> V_9 ,
V_111 -> V_9 + V_111 -> V_10 ,
F_51 ( V_111 -> type ) ) ;
}
}
static unsigned long F_56 ( V_105 V_112 )
{
...
& V_48 ) ;
V_116 . V_117 = V_48 ;
if ( F_14 ( V_116 . V_118 , V_116 . V_117 )
< 0 ) {
T_1 V_91 ;
if ( V_116 . V_119
< V_116 . V_120 . V_121 ) {
V_91 = V_116 . V_120 . V_121 ;
V_22 = L_35 ;
} else {
V_91 = V_116 . V_119 ;
V_22 = L_36 ;
...
V_87 = F_17 ( V_87 , V_130 ) ;
V_88 = F_17 ( V_88 , V_130 ) ;
V_127 += V_88 - V_87 ;
}
