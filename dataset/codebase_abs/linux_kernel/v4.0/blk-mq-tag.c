...
V_65 = F_53 ( V_19 -> V_12 , V_62 + V_66 ) ;
if ( V_65 -> V_47 == V_19 -> V_67 )
V_63 ( V_19 , V_65 , V_42 , V_51 ) ;
}
V_62 += ( 1 << V_2 -> V_38 ) ;
}
}
void F_54 ( struct V_18 * V_19 , T_2 * V_63 ,
void * V_68 )
{
struct V_11 * V_12 = V_19 -> V_12 ;
if ( V_12 -> V_52 )
F_50 ( V_19 , & V_12 -> V_28 , 0 , V_63 , V_68 , true ) ;
F_50 ( V_19 , & V_12 -> V_13 , V_12 -> V_52 , V_63 , V_68 ,
false ) ;
}
...
unsigned int V_10 )
{
unsigned int V_70 = 1U << V_2 -> V_38 ;
unsigned int V_71 = V_10 ;
if ( V_10 ) {
int V_3 ;
for ( V_3 = 0 ; V_3 < V_2 -> V_4 ; V_3 ++ ) {
V_2 -> V_7 [ V_3 ] . V_10 = F_58 ( V_71 , V_70 ) ;
...
static int F_59 ( struct V_1 * V_2 , unsigned int V_10 ,
int V_73 , bool V_51 )
{
int V_3 ;
V_2 -> V_38 = F_60 ( V_74 ) ;
...
V_75 = F_61 ( V_10 , V_70 ) / V_70 ;
V_2 -> V_7 = F_62 ( V_75 * sizeof( struct V_5 ) ,
V_76 , V_73 ) ;
if ( ! V_2 -> V_7 )
return - V_77 ;
V_2 -> V_4 = V_75 ;
}
V_2 -> V_26 = F_63 ( V_15 * sizeof( * V_2 -> V_26 ) , V_76 ) ;
if ( ! V_2 -> V_26 ) {
F_64 ( V_2 -> V_7 ) ;
V_2 -> V_7 = NULL ;
return - V_77 ;
...
F_57 ( V_2 , V_10 ) ;
for ( V_3 = 0 ; V_3 < V_15 ; V_3 ++ ) {
F_65 ( & V_2 -> V_26 [ V_3 ] . V_27 ) ;
F_66 ( & V_2 -> V_26 [ V_3 ] . V_56 , V_2 -> V_57 ) ;
}
return 0 ;
}
...
static struct V_11 * F_68 ( struct V_11 * V_12 ,
int V_73 , int V_60 )
{
unsigned int V_10 = V_12 -> V_59 - V_12 -> V_52 ;
V_12 -> V_60 = V_60 ;
if ( F_59 ( & V_12 -> V_13 , V_10 , V_73 , false ) )
goto V_78;
if ( F_59 ( & V_12 -> V_28 , V_12 -> V_52 , V_73 , true ) )
goto V_78;
return V_12 ;
V_78:
F_67 ( & V_12 -> V_13 ) ;
...
struct V_11 * F_69 ( unsigned int V_79 ,
unsigned int V_80 ,
int V_73 , int V_60 )
{
struct V_11 * V_12 ;
...
V_12 = F_62 ( sizeof( * V_12 ) , V_76 , V_73 ) ;
if ( ! V_12 )
return NULL ;
V_12 -> V_59 = V_79 ;
V_12 -> V_52 = V_80 ;
return F_68 ( V_12 , V_73 , V_60 ) ;
}
...
void F_72 ( struct V_11 * V_12 , unsigned int * V_35 )
{
unsigned int V_10 = V_12 -> V_59 - V_12 -> V_52 ;
* V_35 = F_73 () % V_10 ;
}
int F_74 ( struct V_11 * V_12 , unsigned int V_82 )
{
V_82 -= V_12 -> V_52 ;
if ( V_82 > V_12 -> V_59 )
return - V_83 ;
...
T_3 F_75 ( struct V_64 * V_65 )
{
struct V_84 * V_47 = V_65 -> V_47 ;
struct V_18 * V_19 ;
int V_85 = 0 ;
if ( V_47 -> V_48 ) {
V_19 = V_47 -> V_48 -> V_49 ( V_47 , V_65 -> V_86 -> V_50 ) ;
V_85 = V_19 -> V_87 ;
}
return ( V_85 << V_88 ) |
( V_65 -> V_35 & V_89 ) ;
}
T_4 F_76 ( struct V_11 * V_12 , char * V_90 )
{
char * V_91 = V_90 ;
