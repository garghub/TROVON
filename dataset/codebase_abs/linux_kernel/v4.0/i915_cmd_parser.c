...
struct V_73 V_74 ;
struct V_75 * * V_76 ;
V_76 = F_31 ( V_72 -> V_77 . V_78 >> V_79 , sizeof( * V_76 ) ) ;
if ( V_76 == NULL ) {
F_2 ( L_8 ) ;
goto V_80;
}
V_20 = 0 ;
F_32 (obj->pages->sgl, &sg_iter, obj->pages->nents, 0 ) {
V_76 [ V_20 ] = F_33 ( & V_74 ) ;
V_20 ++ ;
}
V_70 = F_34 ( V_76 , V_20 , 0 , V_81 ) ;
if ( V_70 == NULL ) {
F_2 ( L_9 ) ;
goto V_80;
}
...
static T_1 * F_36 ( struct V_71 * V_82 ,
struct V_71 * V_83 ,
T_1 V_84 ,
T_1 V_85 )
{
...
T_1 * V_87 , * V_88 = NULL ;
T_1 * V_89 , * V_90 ;
T_1 V_91 = V_84 / sizeof( * V_90 ) ;
T_1 V_92 = V_84 + V_85 ;
if ( V_92 > V_82 -> V_77 . V_78 || V_92 > V_83 -> V_77 . V_78 )
return F_37 ( - V_93 ) ;
V_21 = F_38 ( V_83 , & V_86 ) ;
if ( V_21 ) {
F_2 ( L_10 ) ;
...
V_90 = V_88 + V_91 ;
if ( V_84 != 0 )
memset ( ( V_96 * ) V_88 , 0 , V_84 ) ;
memcpy ( V_90 , V_89 , V_85 ) ;
memset ( ( V_96 * ) V_90 + V_85 , 0 , V_82 -> V_77 . V_78 - V_92 ) ;
V_95:
F_41 ( V_87 ) ;
V_94:
F_42 ( V_83 ) ;
return V_21 ? F_37 ( V_21 ) : V_88 ;
}
bool F_43 ( struct V_15 * V_16 )
{
if ( ! V_16 -> V_63 )
return false ;
if ( ! F_44 ( V_16 -> V_47 ) )
...
static bool F_45 ( const struct V_15 * V_16 ,
const struct V_26 * V_27 ,
const T_1 * V_29 ,
const bool V_99 ,
bool * V_100 )
...
if ( ( V_27 -> V_67 & V_102 ) && ! V_99 ) {
F_2 ( L_15 ,
* V_29 ) ;
return false ;
}
if ( V_27 -> V_67 & V_103 ) {
T_1 V_104 = V_29 [ V_27 -> V_105 . V_91 ] & V_27 -> V_105 . V_31 ;
if ( V_104 == V_106 ) {
if ( V_27 -> V_29 . V_30 == V_107 ) {
F_2 ( L_16 ) ;
return false ;
}
if ( V_27 -> V_29 . V_30 == F_46 ( 1 ) )
* V_100 = ( V_29 [ 2 ] != 0 ) ;
}
if ( ! F_29 ( V_16 -> V_34 ,
V_16 -> V_35 , V_104 ) ) {
...
T_1 V_110 ;
if ( V_27 -> V_111 [ V_20 ] . V_31 == 0 )
break;
if ( V_27 -> V_111 [ V_20 ] . V_112 != 0 ) {
T_1 V_91 =
V_27 -> V_111 [ V_20 ] . V_113 ;
T_1 V_114 = V_29 [ V_91 ] &
V_27 -> V_111 [ V_20 ] . V_112 ;
if ( V_114 == 0 )
continue;
}
V_110 = V_29 [ V_27 -> V_111 [ V_20 ] . V_91 ] &
V_27 -> V_111 [ V_20 ] . V_31 ;
if ( V_110 != V_27 -> V_111 [ V_20 ] . V_115 ) {
F_2 ( L_18 ,
* V_29 ,
V_27 -> V_111 [ V_20 ] . V_31 ,
V_27 -> V_111 [ V_20 ] . V_115 ,
V_110 , V_16 -> V_32 ) ;
return false ;
}
}
...
{
int V_21 = 0 ;
T_1 * V_29 , * V_118 , * V_119 ;
struct V_26 V_66 = { 0 } ;
bool V_100 = false ;
V_21 = F_48 ( V_117 , 4096 , 0 ) ;
if ( V_21 ) {
F_2 ( L_19 ) ;
return - 1 ;
}
V_118 = F_36 ( V_117 , V_116 ,
V_84 , V_85 ) ;
if ( F_49 ( V_118 ) ) {
F_2 ( L_20 ) ;
F_50 ( V_117 ) ;
...
V_29 = V_118 + ( V_84 / sizeof( * V_29 ) ) ;
V_119 = V_29 + ( V_85 / sizeof( * V_119 ) ) ;
while ( V_29 < V_119 ) {
const struct V_26 * V_27 ;
T_1 V_69 ;
if ( * V_29 == V_120 )
...
if ( V_27 -> V_29 . V_30 == V_122 ) {
V_21 = - V_123 ;
break;
}
if ( V_27 -> V_67 & V_124 )
V_69 = V_27 -> V_69 . V_125 ;
else
V_69 = ( ( * V_29 & V_27 -> V_69 . V_31 ) + V_126 ) ;
if ( ( V_119 - V_29 ) < V_69 ) {
F_2 ( L_22 ,
* V_29 ,
V_69 ,
...
if ( ! F_45 ( V_16 , V_27 , V_29 , V_99 , & V_100 ) ) {
V_21 = - V_121 ;
break;
}
V_29 += V_69 ;
