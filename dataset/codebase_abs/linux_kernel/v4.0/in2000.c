...
V_2 -> V_134 = 0 ;
V_2 -> V_161 = V_198 ;
if ( V_225 == 0x41564f4e && ( V_226 & V_256 ) )
V_2 -> V_257 = 0x00 ;
else
V_2 -> V_257 = 0xff ;
#ifdef F_57
V_2 -> V_258 = V_259 | V_260 | V_261 | V_262 | V_263 | V_264 | V_265 ;
#ifdef F_28
V_2 -> V_112 = 0 ;
#endif
#endif
...
V_2 -> args = ( V_222 & V_269 ) ;
#ifdef F_57
if ( F_45 ( L_79 , & V_222 , V_75 ) )
V_2 -> V_258 = V_222 ;
#endif
F_27 ( V_58 -> V_111 , V_110 ) ;
V_10 = F_36 ( V_58 , ( V_2 -> args & V_268 ) ? V_270 : V_182 ) ;
F_34 ( V_58 -> V_111 , V_110 ) ;
V_2 -> V_271 = F_1 ( V_2 , V_272 ) ;
if ( V_10 & 0x01 ) {
if ( V_10 & V_193 )
V_2 -> V_273 = V_274 ;
else
...
V_2 -> V_273 = V_276 ;
F_33 ( L_80 , ( V_226 & 0x7f ) , V_58 -> V_250 , V_2 -> V_99 , ( V_226 & V_277 ) ? L_81 : L_82 , ( V_226 & V_256 ) ? L_81 : L_82 ) ;
F_33 ( L_83 , V_233 , ( V_2 -> V_273 == V_276 ) ? L_84 : ( V_2 -> V_273 == V_275 ) ? L_85 : ( V_2 -> V_273 == V_274 ) ? L_86 : L_87 , V_2 -> V_271 ) ;
#ifdef F_58
F_33 ( L_88 ) ;
for ( V_10 = 0 ; V_10 < V_217 ; V_10 ++ )
...
if ( V_2 -> V_257 == 0xff )
F_33 ( L_91 ) ;
F_33 ( L_92 , V_278 , V_279 ) ;
}
return V_230 ;
}
static int F_59 ( struct V_57 * V_280 )
{
if ( V_280 -> V_250 )
F_60 ( V_280 -> V_250 , V_280 ) ;
if ( V_280 -> V_243 && V_280 -> V_251 )
F_61 ( V_280 -> V_243 , V_280 -> V_251 ) ;
return 0 ;
}
static int F_62 ( struct V_281 * V_282 , struct V_283 * V_284 , T_7 V_285 , int * V_286 )
{
int V_287 ;
V_287 = V_285 ;
V_286 [ 0 ] = 64 ;
...
V_286 [ 0 ] = 64 ;
V_286 [ 1 ] = 63 ;
V_286 [ 2 ] = ( unsigned long ) V_285 / ( V_286 [ 0 ] * V_286 [ 1 ] ) ;
}
if ( V_286 [ 2 ] > 1024 ) {
V_286 [ 0 ] = 128 ;
V_286 [ 1 ] = 63 ;
...
static int F_63 ( struct V_57 * V_58 , char * V_75 , int V_288 )
{
#ifdef F_57
char * V_289 ;
struct V_1 * V_290 ;
int V_10 , V_80 ;
V_290 = (struct V_1 * ) V_58 -> V_2 ;
V_75 [ V_288 ] = '\0' ;
V_289 = V_75 ;
if ( ! strncmp ( V_289 , L_93 , 6 ) ) {
V_289 += 6 ;
V_290 -> args = F_46 ( V_289 , NULL , 0 ) & V_269 ;
} else if ( ! strncmp ( V_289 , L_94 , 11 ) ) {
V_289 += 11 ;
V_10 = F_46 ( V_289 , NULL , 0 ) ;
if ( V_10 < V_266 || V_10 > V_267 )
V_10 = V_254 ;
V_290 -> V_156 = V_10 ;
} else if ( ! strncmp ( V_289 , L_95 , 7 ) ) {
V_289 += 7 ;
V_10 = F_46 ( V_289 , NULL , 0 ) ;
V_290 -> V_161 = V_51 [ F_11 ( ( unsigned int ) V_10 ) ] . V_52 ;
} else if ( ! strncmp ( V_289 , L_96 , 7 ) ) {
V_289 += 7 ;
V_10 = F_46 ( V_289 , NULL , 0 ) ;
for ( V_80 = 0 ; V_80 < 7 ; V_80 ++ )
if ( V_10 & ( 1 << V_80 ) )
V_290 -> V_128 [ V_80 ] = V_199 ;
} else if ( ! strncmp ( V_289 , L_97 , 5 ) ) {
V_289 += 5 ;
V_290 -> V_258 = F_46 ( V_289 , NULL , 0 ) ;
} else if ( ! strncmp ( V_289 , L_98 , 7 ) ) {
V_289 += 7 ;
V_290 -> V_87 = F_46 ( V_289 , NULL , 0 ) ;
}
#endif
return V_288 ;
}
static int F_64 ( struct V_291 * V_292 , struct V_57 * V_58 )
{
#ifdef F_57
unsigned long V_110 ;
struct V_1 * V_290 ;
...
V_290 = (struct V_1 * ) V_58 -> V_2 ;
F_27 ( V_58 -> V_111 , V_110 ) ;
if ( V_290 -> V_258 & V_259 )
F_65 ( V_292 , L_99 , V_278 , V_279 ) ;
if ( V_290 -> V_258 & V_260 ) {
F_65 ( V_292 , L_100 , ( V_290 -> V_244 & 0x7f ) , V_58 -> V_250 , V_290 -> V_99 , ( V_290 -> V_244 & 0x40 ) ? L_81 : L_82 , ( V_290 -> V_244 & 0x20 ) ? L_81 : L_82 ) ;
F_66 ( V_292 , L_101 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_292 , L_102 , V_290 -> V_82 [ V_10 ] ) ;
F_66 ( V_292 , L_103 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_292 , L_102 , V_290 -> V_128 [ V_10 ] ) ;
}
#ifdef F_28
if ( V_290 -> V_258 & V_261 ) {
F_66 ( V_292 , L_104 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_292 , L_105 , V_290 -> V_252 [ V_10 ] ) ;
F_66 ( V_292 , L_106 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_292 , L_105 , V_290 -> V_253 [ V_10 ] ) ;
F_66 ( V_292 , L_107 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_292 , L_105 , V_290 -> V_175 [ V_10 ] ) ;
F_65 ( V_292 , L_108 , V_290 -> V_112 ) ;
}
#endif
if ( V_290 -> V_258 & V_262 ) {
F_66 ( V_292 , L_109 ) ;
if ( V_290 -> V_114 ) {
V_7 = ( T_2 * ) V_290 -> V_114 ;
F_65 ( V_292 , L_110 , V_7 -> V_60 -> V_83 , V_7 -> V_60 -> V_106 , V_7 -> V_20 [ 0 ] ) ;
}
}
if ( V_290 -> V_258 & V_263 ) {
F_66 ( V_292 , L_111 ) ;
V_7 = ( T_2 * ) V_290 -> V_73 ;
while ( V_7 ) {
F_65 ( V_292 , L_110 , V_7 -> V_60 -> V_83 , V_7 -> V_60 -> V_106 , V_7 -> V_20 [ 0 ] ) ;
