...
if ( V_119 ) {
V_10 -> V_122 = V_118 ;
V_41 = F_34 ( V_10 , V_123 , 0 ) & 0xfffc ;
F_23 ( V_10 , V_123 , 0 , V_41 | V_118 ) ;
}
return V_119 ;
}
...
for ( V_40 = 0 ; V_40 < F_59 ( V_125 ) ; V_40 ++ ) {
if ( ( V_14 = F_60 ( V_26 , F_61 ( & V_125 [ V_40 ] ,
V_10 ) ) ) < 0 )
return V_14 ;
}
return 0 ;
...
for ( V_40 = 0 ; V_40 < 0x80 ; V_40 ++ , V_118 ++ )
* V_118 = F_34 ( V_10 , V_40 , V_128 ) ;
}
