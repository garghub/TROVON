...
static int
F_59 ( struct V_81 * V_82 , T_3 V_83 )
{
struct V_3 * V_4 ;
int V_26 ;
V_4 = V_82 -> V_84 -> V_70 ;
...
static void
F_61 ( struct V_86 * V_87 , T_3 V_83 )
{
...
unsigned long V_98 ;
V_98 = 0 ;
V_4 = V_90 -> V_99 -> V_84 -> V_70 ;
if ( V_4 == NULL )
goto V_100;
if ( ( V_90 -> V_101 . V_102 & 7 ) != 0 ||
( V_90 -> V_101 . V_103 & 4095 ) != 0 )
goto V_100;
if ( F_64 ( V_90 ) > F_65 ( V_90 -> V_99 -> V_84 ) ) {
goto V_100;
}
if ( V_4 -> V_42 ) {
switch ( V_4 -> V_32 ) {
...
V_95 = ( V_90 -> V_101 . V_102 >> 3 ) ;
F_68 (bvec, bio, iter) {
V_96 = ( unsigned long )
F_69 ( V_92 . V_105 ) + V_92 . V_106 ;
V_97 = V_4 -> V_23 + ( V_95 << 12 ) + V_98 ;
if ( F_70 ( ( V_96 & 4095 ) != 0 ) || ( V_92 . V_107 & 4095 ) != 0 )
goto V_100;
if ( F_66 ( V_90 ) == V_108 ) {
...
static long
F_73 ( struct V_81 * V_82 , T_4 V_109 ,
void * * V_110 , unsigned long * V_111 , long V_112 )
{
struct V_3 * V_4 ;
...
if ( ! V_4 )
return - V_77 ;
V_114 = V_4 -> V_20 - V_4 -> V_23 ;
V_113 = V_109 * 512 ;
* V_110 = ( void * ) ( V_4 -> V_23 + V_113 ) ;
* V_111 = F_74 ( * V_110 ) >> V_115 ;
return V_114 - V_113 ;
}
static void
F_75 ( void )
{
int V_26 , V_24 , V_25 , V_116 ;
char V_41 [ V_117 + 1 ] ;
struct V_3 * V_4 ;
for ( V_24 = 0 ; ( V_24 < V_117 ) && ( V_118 [ V_24 ] != '\0' ) ;
V_24 ++ ) {
for ( V_25 = V_24 ; ( V_118 [ V_25 ] != ',' ) &&
( V_118 [ V_25 ] != '\0' ) &&
( V_118 [ V_25 ] != '(' ) &&
( V_25 < V_117 ) ; V_25 ++ )
{
V_41 [ V_25 - V_24 ] = V_118 [ V_25 ] ;
}
V_41 [ V_25 - V_24 ] = '\0' ;
V_26 = F_43 ( V_57 , NULL , V_41 , V_25 - V_24 ) ;
if ( ( V_26 >= 0 ) && ( V_118 [ V_25 ] == '(' ) ) {
for ( V_116 = 0 ; ( V_41 [ V_116 ] != ':' ) && ( V_41 [ V_116 ] != '\0' ) ; V_116 ++ )
V_41 [ V_116 ] = toupper ( V_41 [ V_116 ] ) ;
V_41 [ V_116 ] = '\0' ;
if ( ! strncmp ( & V_118 [ V_25 ] , L_33 , 7 ) ) {
F_17 ( & V_36 ) ;
V_4 = F_9 ( V_41 ) ;
F_18 ( & V_36 ) ;
if ( V_4 )
...
V_26 = F_91 ( V_57 , & V_125 ) ;
if ( V_26 )
goto V_126;
V_26 = F_91 ( V_57 , & V_127 ) ;
if ( V_26 )
goto V_126;
V_26 = F_92 ( 0 , V_122 ) ;
if ( V_26 < 0 )
