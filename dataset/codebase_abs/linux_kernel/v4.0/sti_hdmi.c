...
struct V_128 * V_129 ;
int V_130 ;
V_129 = F_59 ( V_123 -> V_131 , L_24 , 0 ) ;
if ( V_129 ) {
V_2 -> V_107 = F_60 ( V_129 ) ;
if ( ! V_2 -> V_107 ) {
V_130 = - V_132 ;
F_61 ( V_129 ) ;
return V_130 ;
...
if ( ! V_117 )
goto V_133;
V_102 = F_62 ( V_123 , sizeof( * V_102 ) , V_134 ) ;
if ( ! V_102 )
goto V_133;
V_102 -> V_2 = V_2 ;
V_86 = F_62 ( V_123 , sizeof( * V_86 ) , V_134 ) ;
if ( ! V_86 )
goto V_133;
V_86 -> V_87 = V_2 ;
V_86 -> V_135 = & V_136 ;
...
F_54 ( V_101 ) ;
V_133:
F_68 ( & V_2 -> V_107 -> V_123 ) ;
return - V_145 ;
}
static void F_69 ( struct V_126 * V_123 ,
struct V_126 * V_127 , void * V_50 )
{
}
static int F_70 ( struct V_146 * V_147 )
{
struct V_126 * V_123 = & V_147 -> V_123 ;
struct V_1 * V_2 ;
struct V_128 * V_148 = V_123 -> V_131 ;
struct V_149 * V_150 ;
int V_70 ;
F_33 ( L_26 , V_151 ) ;
V_2 = F_62 ( V_123 , sizeof( * V_2 ) , V_134 ) ;
if ( ! V_2 )
return - V_152 ;
V_2 -> V_123 = V_147 -> V_123 ;
V_150 = F_71 ( V_147 , V_153 , L_27 ) ;
if ( ! V_150 ) {
F_18 ( L_28 ) ;
return - V_152 ;
}
V_2 -> V_4 = F_72 ( V_123 , V_150 -> V_97 , F_73 ( V_150 ) ) ;
if ( ! V_2 -> V_4 )
return - V_152 ;
if ( F_74 ( V_148 , L_29 ) ) {
V_150 = F_71 ( V_147 , V_153 ,
L_30 ) ;
if ( ! V_150 ) {
F_18 ( L_31 ) ;
return - V_152 ;
}
V_2 -> V_154 = F_72 ( V_123 , V_150 -> V_97 ,
F_73 ( V_150 ) ) ;
if ( ! V_2 -> V_154 )
return - V_152 ;
}
V_2 -> V_89 = (struct V_155 * )
F_75 ( V_156 , V_148 ) -> V_50 ;
...
F_84 ( V_2 -> V_158 ) ;
F_85 ( V_147 , V_2 ) ;
return F_86 ( & V_147 -> V_123 , & V_159 ) ;
}
static int F_87 ( struct V_146 * V_147 )
{
struct V_1 * V_2 = F_58 ( & V_147 -> V_123 ) ;
if ( V_2 -> V_107 )
F_68 ( & V_2 -> V_107 -> V_123 ) ;
F_88 ( & V_147 -> V_123 , & V_159 ) ;
return 0 ;
}
