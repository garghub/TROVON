...
static int F_14 ( unsigned int V_37 )
{
int V_13 ;
V_13 = F_5 () ;
if ( V_13 )
...
{
return F_14 ( V_10 -> V_37 ) ;
}
static int F_16 ( struct V_9 * V_10 )
{
return F_14 ( 0 ) ;
}
static int F_17 ( struct V_9 * V_10 , unsigned int V_37 )
{
V_10 -> V_37 = V_37 ;
return 0 ;
}
...
static int F_19 ( struct V_39 * V_40 , unsigned long V_41 ,
void * V_42 )
{
