...
F_56 ( & V_102 -> V_116 ) ;
F_57 ( & V_102 -> V_106 ) ;
V_102 -> V_106 . V_120 = F_53 ;
V_102 -> V_106 . V_121 = ( unsigned long ) V_102 ;
V_102 -> V_2 = V_2 ;
F_58 ( & V_102 -> V_110 , F_45 ) ;
F_33 ( V_102 -> V_68 . V_67 , V_68 . V_67 , V_69 ) ;
F_59 ( & V_102 -> V_116 , & V_2 -> V_122 ) ;
...
static void F_61 ( struct V_1 * V_2 , struct V_12 * V_95 ,
struct V_76 * V_77 ,
struct V_41 * V_26 )
{
struct V_19 * V_20 ;
V_20 = F_62 ( V_2 , V_95 , V_26 ) ;
if ( ! V_20 ) {
return;
}
if ( V_20 -> V_80 == V_98 ) {
...
static bool F_64 ( struct V_1 * V_2 , struct V_41 * V_26 )
{
return F_65 ( & V_2 -> V_12 . V_123 , & V_26 -> V_123 ) == 0 ;
}
static void F_66 ( struct V_1 * V_2 , struct V_76 * V_77 ,
struct V_12 * V_95 , struct V_41 * V_26 )
{
if ( F_17 ( V_26 ) == V_55 )
F_55 ( V_2 , V_26 ) ;
else if ( F_64 ( V_2 , V_26 ) )
F_61 ( V_2 , V_95 , V_77 , V_26 ) ;
else
F_60 ( V_2 , V_77 , V_26 ) ;
}
static void F_67 ( struct V_1 * V_2 , struct V_12 * V_95 ,
struct V_40 * V_124 )
{
F_33 ( V_95 -> V_100 ,
V_124 -> V_125 , V_69 ) ;
...
static
void F_68 ( struct V_1 * V_2 , struct V_76 * V_77 ,
T_3 V_126 , struct V_12 * V_127 )
{
struct V_84 * V_13 = & V_2 -> V_12 . V_13 ;
struct V_128 * V_129 ;
void * V_130 ;
V_130 = V_77 -> V_131 ;
for (; ; ) {
V_129 = F_69 ( & V_130 , & V_126 ) ;
if ( ! V_129 )
break;
switch ( V_129 -> V_132 ) {
case V_133 :
F_67 ( V_2 , V_127 , (struct V_40 * ) V_129 ) ;
break;
case V_134 :
F_66 ( V_2 , V_77 , V_127 , (struct V_41 * ) V_129 ) ;
break;
default:
F_38 ( V_13 , L_6 ) ;
break;
...
int F_70 ( struct V_135 * V_136 )
{
struct V_84 * V_13 = & V_136 -> V_2 -> V_12 . V_13 ;
struct V_1 * V_2 = V_136 -> V_2 ;
struct V_76 * V_77 ;
T_3 V_137 , V_138 ;
struct V_139 V_140 ;
struct V_12 * V_127 ;
if ( V_136 -> V_141 . V_142 < sizeof( * V_77 ) ) {
F_2 ( V_13 , L_8
L_9 ,
V_136 -> V_141 . V_142 , sizeof( * V_77 ) ) ;
return 0 ;
}
V_138 = V_136 -> V_141 . V_142 - sizeof( * V_77 ) ;
V_77 = F_46 ( V_136 -> V_141 . V_143 , struct V_76 , V_143 ) ;
V_137 = F_71 ( V_77 -> V_144 ) ;
if ( V_138 != V_137 ) {
F_2 ( V_13 , L_10
L_11 ,
V_138 , V_137 ) ;
...
memcpy ( V_140 . V_121 , & V_77 -> V_140 , sizeof( V_140 ) ) ;
V_127 = F_72 ( V_2 , & V_140 ) ;
if ( ! V_127 ) {
return 0 ;
}
F_47 ( & V_2 -> V_115 ) ;
F_68 ( V_2 , V_77 , V_137 , V_127 ) ;
F_52 ( & V_2 -> V_115 ) ;
F_73 ( V_127 ) ;
return 0 ;
}
