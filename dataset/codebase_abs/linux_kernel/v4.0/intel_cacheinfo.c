...
#ifdef F_37
if ( F_40 ( V_118 , V_64 ) == V_119 )
F_40 ( V_118 , V_64 ) = V_83 -> V_120 ;
#endif
...
int V_66 , V_121 ;
if ( V_78 ) {
unsigned int V_102 , V_122 , V_123 , V_124 ;
if ( ! F_40 ( V_125 , V_64 ) )
return 0 ;
V_54 = F_42 ( V_64 , V_55 ) ;
V_122 = V_54 -> V_61 . V_3 . V_28 . V_33 + 1 ;
V_102 = F_43 ( V_64 ) . V_102 ;
V_123 = V_102 - ( V_102 % V_122 ) ;
V_124 = V_123 + V_122 - 1 ;
F_44 (i) {
V_102 = F_43 ( V_66 ) . V_102 ;
if ( ( V_102 < V_123 ) || ( V_102 > V_124 ) )
continue;
if ( ! F_40 ( V_125 , V_66 ) )
continue;
V_54 = F_42 ( V_66 , V_55 ) ;
F_44 (sibling) {
V_102 = F_43 ( V_121 ) . V_102 ;
if ( ( V_102 < V_123 ) || ( V_102 > V_124 ) )
continue;
F_45 ( V_121 , V_54 -> V_73 ) ;
}
}
} else if ( V_55 == 3 ) {
...
for ( V_66 = 0 ; V_66 < V_86 ; V_66 ++ )
F_50 ( V_64 , V_66 ) ;
F_53 ( F_40 ( V_125 , V_64 ) ) ;
F_40 ( V_125 , V_64 ) = NULL ;
}
static void F_54 ( void * V_127 )
{
int V_103 , * V_99 = V_127 , V_64 = F_12 () ;
...
if ( V_86 == 0 )
return - V_128 ;
F_40 ( V_125 , V_64 ) = F_57 (
sizeof( struct V_59 ) * V_86 , V_129 ) ;
if ( F_40 ( V_125 , V_64 ) == NULL )
return - V_130 ;
...
int type , char * V_60 )
{
const struct V_131 * V_132 = F_24 ( V_54 -> V_73 ) ;
int V_67 ;
if ( type )
V_67 = F_61 ( V_60 , V_133 - 1 , L_6 ,
F_62 ( V_132 ) ) ;
else
V_67 = F_61 ( V_60 , V_133 - 1 , L_7 ,
F_62 ( V_132 ) ) ;
V_60 [ V_67 ++ ] = '\n' ;
V_60 [ V_67 ] = '\0' ;
return V_67 ;
}
static inline T_2 F_63 ( struct V_59 * V_1 , char * V_60 ,
unsigned int V_64 )
{
...
static T_2 F_65 ( struct V_59 * V_54 , char * V_60 ,
unsigned int V_64 )
{
...
case V_134 :
return sprintf ( V_60 , L_10 ) ;
default:
return sprintf ( V_60 , L_11 ) ;
}
}
static struct V_135 * * F_66 ( void )
{
...
if ( F_16 ( V_74 ) )
V_104 += 1 ;
V_136 = F_57 ( V_104 * sizeof ( struct V_135 * ) , V_129 ) ;
if ( V_136 == NULL )
return V_136 = V_137 ;
for ( V_104 = 0 ; V_137 [ V_104 ] ; V_104 ++ )
V_136 [ V_104 ] = V_137 [ V_104 ] ;
if ( F_16 ( V_62 ) ) {
V_136 [ V_104 ++ ] = & V_138 . V_139 ;
V_136 [ V_104 ++ ] = & V_140 . V_139 ;
}
if ( F_16 ( V_74 ) )
V_136 [ V_104 ++ ] = & V_49 . V_139 ;
return V_136 ;
}
static T_2 F_68 ( struct V_141 * V_142 , struct V_135 * V_139 , char * V_60 )
{
struct V_143 * V_144 = F_69 ( V_139 ) ;
struct V_145 * V_54 = F_70 ( V_142 ) ;
T_2 V_67 ;
V_67 = V_144 -> F_68 ?
V_144 -> F_68 ( F_42 ( V_54 -> V_64 , V_54 -> V_55 ) ,
V_60 , V_54 -> V_64 ) :
0 ;
return V_67 ;
}
static T_2 F_71 ( struct V_141 * V_142 , struct V_135 * V_139 ,
const char * V_60 , T_3 V_69 )
{
struct V_143 * V_144 = F_69 ( V_139 ) ;
struct V_145 * V_54 = F_70 ( V_142 ) ;
T_2 V_67 ;
V_67 = V_144 -> F_71 ?
V_144 -> F_71 ( F_42 ( V_54 -> V_64 , V_54 -> V_55 ) ,
V_60 , V_69 , V_54 -> V_64 ) :
0 ;
return V_67 ;
}
static void F_72 ( unsigned int V_64 )
{
F_53 ( F_40 ( V_146 , V_64 ) ) ;
F_53 ( F_40 ( V_147 , V_64 ) ) ;
F_40 ( V_146 , V_64 ) = NULL ;
F_40 ( V_147 , V_64 ) = NULL ;
F_52 ( V_64 ) ;
}
static int F_73 ( unsigned int V_64 )
{
int V_70 ;
if ( V_86 == 0 )
return - V_128 ;
...
return V_70 ;
F_40 ( V_146 , V_64 ) =
F_57 ( sizeof( struct V_141 ) , V_129 ) ;
if ( F_55 ( F_40 ( V_146 , V_64 ) == NULL ) )
goto V_148;
F_40 ( V_147 , V_64 ) = F_57 (
sizeof( struct V_145 ) * V_86 , V_129 ) ;
if ( F_55 ( F_40 ( V_147 , V_64 ) == NULL ) )
goto V_148;
return 0 ;
V_148:
F_72 ( V_64 ) ;
...
static int F_74 ( struct V_149 * V_150 )
{
unsigned int V_64 = V_150 -> V_151 ;
...
if ( F_55 ( V_99 < 0 ) )
return V_99 ;
V_99 = F_75 ( F_40 ( V_146 , V_64 ) ,
& V_153 ,
& V_150 -> V_142 , L_12 , L_13 ) ;
if ( V_99 < 0 ) {
F_72 ( V_64 ) ;
return V_99 ;
}
for ( V_66 = 0 ; V_66 < V_86 ; V_66 ++ ) {
V_152 = F_76 ( V_64 , V_66 ) ;
V_152 -> V_64 = V_64 ;
V_152 -> V_55 = V_66 ;
V_54 = F_42 ( V_64 , V_66 ) ;
V_154 . V_137 = V_137 ;
...
V_154 . V_137 = F_66 () ;
#endif
V_99 = F_75 ( & ( V_152 -> V_142 ) ,
& V_154 ,
F_40 ( V_146 , V_64 ) ,
L_14 , V_66 ) ;
if ( F_55 ( V_99 ) ) {
for ( V_103 = 0 ; V_103 < V_66 ; V_103 ++ )
F_78 ( & ( F_76 ( V_64 , V_103 ) -> V_142 ) ) ;
F_78 ( F_40 ( V_146 , V_64 ) ) ;
F_72 ( V_64 ) ;
return V_99 ;
}
F_79 ( & ( V_152 -> V_142 ) , V_155 ) ;
}
F_49 ( V_64 , F_24 ( V_156 ) ) ;
F_79 ( F_40 ( V_146 , V_64 ) , V_155 ) ;
return 0 ;
}
static void F_80 ( struct V_149 * V_150 )
{
unsigned int V_64 = V_150 -> V_151 ;
unsigned long V_66 ;
if ( F_40 ( V_125 , V_64 ) == NULL )
return;
if ( ! F_81 ( V_64 , F_24 ( V_156 ) ) )
return;
F_51 ( V_64 , F_24 ( V_156 ) ) ;
for ( V_66 = 0 ; V_66 < V_86 ; V_66 ++ )
F_78 ( & ( F_76 ( V_64 , V_66 ) -> V_142 ) ) ;
F_78 ( F_40 ( V_146 , V_64 ) ) ;
F_72 ( V_64 ) ;
}
...
{
unsigned int V_64 = ( unsigned long ) V_160 ;
struct V_149 * V_150 ;
V_150 = F_83 ( V_64 ) ;
switch ( V_159 ) {
case V_161 :
