...
int F_35 ( struct V_1 * V_2 , struct V_89 * V_90 )
{
struct V_91 * V_92 = & V_2 -> V_93 ;
if ( ! ( V_2 -> V_30 & V_44 ) )
return - V_35 ;
return F_36 ( V_90 -> V_94 , V_92 , sizeof( * V_92 ) ) ?
- V_95 : 0 ;
}
...
int F_38 ( struct V_1 * V_2 , struct V_89 * V_90 )
{
struct V_91 V_92 ;
int V_130 ;
if ( ! ( V_2 -> V_30 & V_44 ) )
return - V_35 ;
if ( F_39 ( & V_92 , V_90 -> V_94 , sizeof( V_92 ) ) )
return - V_95 ;
V_130 = F_37 ( V_2 , & V_92 ) ;
if ( V_130 )
return V_130 ;
...
V_2 -> V_19 . V_142 = F_19 ;
V_2 -> V_19 . V_143 = F_20 ;
V_2 -> V_131 = F_42 ( & V_2 -> V_19 , & V_2 -> V_62 -> V_63 ) ;
if ( F_43 ( V_2 -> V_131 ) ) {
...
if ( V_130 ) {
V_2 -> V_131 = NULL ;
F_48 ( & V_2 -> V_62 -> V_63 , L_4 ,
V_64 ) ;
} else {
struct V_3 V_4 ;
T_1 V_97 ;
F_46 ( & V_2 -> V_62 -> V_63 , L_5 , V_64 ,
V_145 -> V_132 ) ;
V_2 -> V_30 |= V_44 ;
V_97 = F_2 ( V_6 , V_124 ) ;
V_97 |= V_150 ;
