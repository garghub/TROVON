...
static inline int F_104 ( const char * V_95 )
{
int V_11 ;
V_11 = F_105 ( V_95 , V_95 , 0 , 0 ) ;
if ( V_96 && V_11 == - V_97 )
V_11 = 0 ;
return V_11 ;
}
static int F_106 ( const char * V_95 , T_3 type , T_3 V_98 , int V_99 )
{
int V_15 ;
int V_11 = 0 ;
switch ( V_99 ) {
...
V_77 = F_106 ( V_95 , type , V_98 , V_118 ) ;
if ( V_77 ) {
F_5 ( V_75 L_144 ) ;
goto V_121;
}
