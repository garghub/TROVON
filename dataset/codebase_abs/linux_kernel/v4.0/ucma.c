...
static int F_98 ( struct V_1 * V_5 , int V_180 ,
...
V_49 = F_98 ( V_5 , V_64 . V_180 , V_64 . V_168 , V_169 ,
V_64 . V_170 ) ;
F_19 ( V_169 ) ;
V_57:
F_9 ( V_5 ) ;
...
if ( F_6 ( V_5 ) )
return F_37 ( V_5 ) ;
V_49 = F_102 ( V_5 -> V_47 , (enum V_185 ) V_64 . V_37 ) ;
F_9 ( V_5 ) ;
return V_49 ;
}
static T_1 F_103 ( struct V_3 * V_4 ,
struct V_186 * V_64 , int V_62 )
{
struct V_84 V_44 ;
struct V_1 * V_5 ;
struct V_16 * V_17 ;
...
if ( F_28 ( & V_64 , V_60 , sizeof( V_64 ) ) )
return - V_66 ;
V_189 . V_74 = V_64 . V_74 ;
V_189 . V_45 = V_64 . V_45 ;
V_189 . V_2 = V_64 . V_2 ;
V_189 . V_95 = F_51 ( (struct V_91 * ) & V_64 . V_92 ) ;
V_189 . V_94 = 0 ;
memcpy ( & V_189 . V_92 , & V_64 . V_92 , V_189 . V_95 ) ;
return F_103 ( V_4 , & V_189 , V_62 ) ;
}
...
static void F_109 ( struct V_3 * V_190 , struct V_3 * V_191 )
{
if ( V_190 < V_191 ) {
F_5 ( & V_190 -> V_9 ) ;
F_5 ( & V_191 -> V_9 ) ;
...
static void F_110 ( struct V_3 * V_190 , struct V_3 * V_191 )
{
if ( V_190 < V_191 ) {
F_8 ( & V_191 -> V_9 ) ;
F_8 ( & V_190 -> V_9 ) ;
...
static T_1 F_112 ( struct V_3 * V_192 ,
const char T_2 * V_60 ,
int V_61 , int V_62 )
{
struct V_193 V_64 ;
...
if ( F_28 ( & V_64 , V_60 , sizeof( V_64 ) ) )
return - V_66 ;
V_196 = F_113 ( V_64 . V_195 ) ;
if ( ! V_196 . V_4 )
return - V_7 ;
V_5 = F_4 ( V_196 . V_4 -> V_24 , V_64 . V_2 ) ;
if ( F_6 ( V_5 ) ) {
V_49 = F_37 ( V_5 ) ;
goto V_198;
}
...
static T_1 F_115 ( struct V_4 * V_67 , const char T_2 * V_199 ,
T_3 V_200 , T_4 * V_201 )
{
struct V_3 * V_4 = V_67 -> V_24 ;
struct V_202 V_203 ;
T_1 V_49 ;
if ( V_200 < sizeof( V_203 ) )
return - V_8 ;
if ( F_28 ( & V_203 , V_199 , sizeof( V_203 ) ) )
return - V_66 ;
if ( V_203 . V_64 >= F_116 ( V_204 ) )
return - V_8 ;
if ( V_203 . V_205 + sizeof( V_203 ) > V_200 )
return - V_8 ;
if ( ! V_204 [ V_203 . V_64 ] )
return - V_153 ;
V_49 = V_204 [ V_203 . V_64 ] ( V_4 , V_199 + sizeof( V_203 ) , V_203 . V_205 , V_203 . V_57 ) ;
if ( ! V_49 )
V_49 = V_200 ;
return V_49 ;
}
static unsigned int F_117 ( struct V_4 * V_67 , struct V_206 * V_207 )
{
struct V_3 * V_4 = V_67 -> V_24 ;
unsigned int V_208 = 0 ;
V_59 ( V_67 , & V_4 -> V_59 , V_207 ) ;
if ( ! F_29 ( & V_4 -> V_58 ) )
V_208 = V_209 | V_210 ;
return V_208 ;
}
static int F_118 ( struct V_211 * V_211 , struct V_4 * V_67 )
{
struct V_3 * V_4 ;
...
V_67 -> V_24 = V_4 ;
V_4 -> V_67 = V_67 ;
return F_122 ( V_211 , V_67 ) ;
}
static int F_123 ( struct V_211 * V_211 , struct V_4 * V_67 )
{
struct V_3 * V_4 = V_67 -> V_24 ;
struct V_1 * V_5 , * V_87 ;
F_5 ( & V_4 -> V_9 ) ;
...
static T_1 F_124 ( struct V_121 * V_212 ,
struct V_213 * V_214 ,
char * V_199 )
{
return sprintf ( V_199 , L_1 , V_215 ) ;
}
...
if ( V_49 )
return V_49 ;
V_49 = F_127 ( V_216 . V_217 , & V_218 ) ;
if ( V_49 ) {
F_128 ( V_219 L_2 ) ;
goto V_85;
}
V_220 = F_129 ( & V_221 , L_3 , V_222 ) ;
if ( ! V_220 ) {
F_128 ( V_219 L_4 ) ;
V_49 = - V_56 ;
goto V_86;
