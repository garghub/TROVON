...
static int F_44 ( struct V_7 * V_8 , T_4 V_68 )
{
struct V_69 * V_70 ;
F_27 ( V_71 ) ;
unsigned int V_72 ;
...
if ( ! V_48 )
return;
V_15 -> V_18 . V_84 = F_49 ( V_8 -> V_8 . V_22 -> V_23 , V_48 ,
& V_15 -> V_18 . V_26 , V_82 ) ;
if ( ! V_15 -> V_18 . V_84 )
return;
V_15 -> V_18 . V_48 = V_48 ;
...
struct V_20 * V_21 ;
struct V_85 * V_86 ;
F_46 ( V_8 , V_15 , V_15 -> V_25 * sizeof( * V_86 ) ) ;
V_86 = V_15 -> V_18 . V_84 ;
if ( ! V_86 )
return - V_73 ;
...
F_27 ( V_75 ) ;
F_22 ( & V_8 -> V_66 , V_64 ) ;
F_37 ( & V_8 -> V_15 . V_67 , & V_75 ) ;
F_37 ( & V_8 -> V_15 . V_91 , & V_75 ) ;
F_37 ( & V_8 -> V_15 . V_92 , & V_75 ) ;
F_37 ( & V_8 -> V_15 . V_80 , & V_75 ) ;
V_8 -> V_15 . V_16 = NULL ;
F_25 ( & V_8 -> V_66 , V_64 ) ;
...
F_37 ( & V_133 -> V_15 . free , & V_71 ) ;
F_37 ( & V_133 -> V_15 . V_67 , & V_71 ) ;
F_37 ( & V_133 -> V_15 . V_91 , & V_71 ) ;
F_37 ( & V_133 -> V_15 . V_92 , & V_71 ) ;
F_37 ( & V_133 -> V_15 . V_80 , & V_71 ) ;
F_51 (desc, &list, node)
F_46 ( V_133 , V_15 , 0 ) ;
...
F_78 ( V_148 ) ) ;
F_62 ( & V_118 [ V_72 ] ) = V_148 ;
F_63 ( & V_118 [ V_72 ] ) = V_146 ;
}
V_120 = V_122 == V_105
? V_133 -> V_142 : V_133 -> V_143 ;
...
unsigned long V_64 ;
F_22 ( & V_133 -> V_66 , V_64 ) ;
if ( F_41 ( & V_133 -> V_15 . V_67 ) )
goto V_92;
F_35 ( & V_133 -> V_15 . V_67 , & V_133 -> V_15 . V_91 ) ;
if ( ! V_133 -> V_15 . V_16 ) {
struct V_14 * V_15 ;
