...
if ( V_36 == - V_81 )
V_75 = false ;
F_41 ( V_36 && V_36 != - V_81 , L_21 , V_36 ) ;
}
if ( ! V_75 ) {
struct V_82 V_83 ;
V_83 . V_59 = V_2 -> V_59 -> V_60 ;
V_83 . V_61 = V_2 -> V_61 ;
V_36 = F_9 ( V_84 , & V_83 ) ;
F_41 ( V_36 && V_36 != - V_81 , L_22 , V_36 ) ;
}
}
static void F_42 ( struct V_1 * V_2 )
{
struct V_38 * V_39 ;
V_39 = F_43 ( V_2 -> V_85 . V_86 , struct V_38 , V_87 ) ;
if ( V_39 -> V_74 . V_88 )
F_44 ( V_2 ) ;
else
F_45 ( V_2 ) ;
...
static struct V_112 * F_61 ( struct V_1 * V_2 )
{
struct V_112 * V_113 ;
...
int F_64 ( struct V_1 * V_2 , T_6 V_114 )
{
struct V_112 * V_113 ;
V_113 = F_17 ( sizeof( struct V_112 ) , V_42 ) ;
if ( ! V_113 )
return - V_57 ;
F_62 ( & V_115 ) ;
if ( F_61 ( V_2 ) ) {
