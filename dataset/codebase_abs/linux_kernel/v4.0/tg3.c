...
static int F_524 ( struct V_364 * V_111 , struct V_1979 * V_1980 , T_4 * V_72 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
int V_56 , V_1981 = 0 ;
T_4 * V_1982 ;
...
static int F_528 ( struct V_364 * V_111 , struct V_1979 * V_1980 , T_4 * V_72 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
int V_56 ;
...
static int F_529 ( struct V_364 * V_111 , struct V_1993 * V_642 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
if ( F_23 ( V_5 , V_267 ) ) {
struct V_211 * V_212 ;
...
static int F_532 ( struct V_364 * V_111 , struct V_1993 * V_642 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
...
static void F_535 ( struct V_364 * V_111 , struct V_2018 * V_987 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
F_536 ( V_987 -> V_2019 , V_2020 , sizeof( V_987 -> V_2019 ) ) ;
F_536 ( V_987 -> V_1977 , V_2021 , sizeof( V_987 -> V_1977 ) ) ;
F_536 ( V_987 -> V_2022 , V_5 -> V_2023 , sizeof( V_987 -> V_2022 ) ) ;
F_536 ( V_987 -> V_2024 , F_537 ( V_5 -> V_12 ) , sizeof( V_987 -> V_2024 ) ) ;
}
static void F_538 ( struct V_364 * V_111 , struct V_2025 * V_2026 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
...
static int F_540 ( struct V_364 * V_111 , struct V_2025 * V_2026 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
...
return - V_64 ;
if ( ( V_2026 -> V_2028 & V_2027 ) &&
! ( F_23 ( V_5 , V_717 ) && F_539 ( V_2030 ) ) )
return - V_64 ;
F_541 ( V_2030 , V_2026 -> V_2028 & V_2027 ) ;
if ( F_44 ( V_2030 ) )
F_83 ( V_5 , V_112 ) ;
else
F_85 ( V_5 , V_112 ) ;
...
static void F_543 ( struct V_364 * V_111 , T_1 V_2032 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
V_5 -> V_2031 = V_2032 ;
}
...
static void F_545 ( struct V_364 * V_111 , struct V_2034 * V_2035 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
...
static int F_546 ( struct V_364 * V_111 , struct V_2034 * V_2035 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
...
static void F_547 ( struct V_364 * V_111 , struct V_2040 * V_2041 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
...
static int F_548 ( struct V_364 * V_111 , struct V_2040 * V_2041 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
int V_75 = 0 ;
if ( V_5 -> V_329 . V_352 == V_357 )
...
static int F_549 ( struct V_364 * V_111 , int V_2045 )
{
switch ( V_2045 ) {
case V_2046 :
return V_2047 ;
...
static int F_550 ( struct V_364 * V_111 , struct V_2050 * V_987 ,
T_1 * T_19 V_2051 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
if ( ! F_23 ( V_5 , V_1064 ) )
...
static int F_553 ( struct V_364 * V_111 , T_1 * V_2054 , T_4 * V_2055 , T_4 * V_2056 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
int V_42 ;
if ( V_2056 )
...
static int F_554 ( struct V_364 * V_111 , const T_1 * V_2054 , const T_4 * V_2055 ,
const T_4 V_2056 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
T_20 V_42 ;
...
static void F_557 ( struct V_364 * V_111 , T_1 V_2066 , T_4 * V_626 )
{
switch ( V_2066 ) {
case V_2048 :
...
static T_5 * F_561 ( struct V_4 * V_5 , T_1 * V_2079 )
{
int V_42 ;
T_5 * V_626 ;
T_1 V_595 = 0 , V_74 = 0 ;
...
if ( V_2092 != F_565 ( V_626 [ 0x10 / 4 ] ) )
goto V_502;
V_2092 = F_448 ( ( unsigned char * ) & V_626 [ 0x74 / 4 ] , 0x88 ) ;
if ( V_2092 != F_565 ( V_626 [ 0xfc / 4 ] ) )
goto V_502;
F_175 ( V_626 ) ;
V_626 = F_561 ( V_5 , & V_74 ) ;
if ( ! V_626 )
return - V_268 ;
V_42 = F_566 ( ( T_4 * ) V_626 , 0 , V_74 , V_2122 ) ;
if ( V_42 > 0 ) {
...
continue;
if ( ! V_2128 && ( V_2134 [ V_42 ] . V_10 & F_572 ) )
continue;
if ( F_23 ( V_5 , V_1651 ) &&
( V_2134 [ V_42 ] . V_10 & F_574 ) )
continue;
if ( V_2129 && ( V_2134 [ V_42 ] . V_10 & F_575 ) )
continue;
...
int V_42 ;
T_1 V_627 ;
for ( V_42 = 0 ; V_42 < F_578 ( V_2139 ) ; V_42 ++ ) {
...
V_75 = F_577 ( V_5 , V_2147 [ V_42 ] . V_595 , V_2147 [ V_42 ] . V_74 ) ;
if ( V_75 )
break;
}
return V_75 ;
}
static int F_580 ( struct V_4 * V_5 , T_1 V_2148 , bool V_2149 )
{
...
static int F_583 ( struct V_4 * V_5 , T_6 * V_72 , bool V_2167 )
{
int V_75 = - V_210 ;
T_1 V_2168 ;
T_1 V_2169 = 9000 ;
...
! F_23 ( V_5 , V_152 ) ) {
F_391 ( V_5 , true ) ;
if ( F_580 ( V_5 , V_2174 , false ) )
V_72 [ V_2170 ] |= V_2175 ;
if ( F_23 ( V_5 , V_1348 ) &&
F_580 ( V_5 , V_2169 + V_1202 , false ) )
V_72 [ V_2170 ] |= V_2176 ;
F_391 ( V_5 , false ) ;
}
if ( ! ( V_5 -> V_178 & V_567 ) &&
...
static void F_584 ( struct V_364 * V_111 , struct V_2178 * V_2179 ,
T_6 * V_72 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
...
static int F_585 ( struct V_364 * V_111 , struct V_2190 * V_2191 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
struct V_2192 V_2193 ;
if ( ! F_23 ( V_5 , V_992 ) )
return - V_1040 ;
if ( F_586 ( & V_2193 , V_2191 -> V_2194 , sizeof( V_2193 ) ) )
return - V_2195 ;
if ( V_2193 . V_10 )
return - V_64 ;
...
F_85 ( V_5 , V_1317 ) ;
return F_587 ( V_2191 -> V_2194 , & V_2193 , sizeof( V_2193 ) ) ?
- V_2195 : 0 ;
}
static int F_588 ( struct V_364 * V_111 , struct V_2190 * V_2191 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
struct V_2192 V_2193 ;
if ( ! F_23 ( V_5 , V_992 ) )
...
static int F_590 ( struct V_364 * V_111 , struct V_2190 * V_2191 , int V_642 )
{
struct V_2216 * V_72 = F_591 ( V_2191 ) ;
struct V_4 * V_5 = F_110 ( V_111 ) ;
int V_75 ;
if ( F_23 ( V_5 , V_267 ) ) {
struct V_211 * V_212 ;
...
return - V_85 ;
V_212 = V_5 -> V_213 -> V_214 [ V_5 -> V_160 ] ;
return F_592 ( V_212 , V_2191 , V_642 ) ;
}
switch ( V_642 ) {
case V_2217 :
...
return V_75 ;
case V_2224 :
return F_585 ( V_111 , V_2191 ) ;
case V_2225 :
return F_588 ( V_111 , V_2191 ) ;
default:
break;
}
return - V_1040 ;
}
static int F_593 ( struct V_364 * V_111 , struct V_1467 * V_1468 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
...
static int F_595 ( struct V_364 * V_111 , struct V_451 * V_2240 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
if ( ! ( V_5 -> V_178 & V_338 ) ) {
...
static struct V_1960 * F_597 ( struct V_364 * V_111 ,
...
static int F_601 ( struct V_364 * V_111 , int V_2242 )
{
struct V_4 * V_5 = F_110 ( V_111 ) ;
int V_75 ;
bool V_1541 = false ;
...
if ( V_7 != 0 ) {
V_5 -> V_1978 = F_604 ( ( T_3 ) ( V_7 & 0x0000ffff ) ) * 1024 ;
return;
}
}
V_5 -> V_1978 = V_2246 ;
...
static void F_606 ( struct V_4 * V_5 , T_1 V_2267 )
{
...
static struct V_2380 * F_616 ( struct V_4 * V_5 )
{
int V_42 ;
for ( V_42 = 0 ; V_42 < F_578 ( V_2381 ) ; V_42 ++ ) {
...
T_1 V_2079 ;
int V_627 , V_42 = 0 ;
V_2473 = ( T_4 * ) F_561 ( V_5 , & V_2079 ) ;
if ( ! V_2473 )
goto V_2476;
V_42 = F_566 ( V_2473 , 0 , V_2079 , V_2122 ) ;
if ( V_42 < 0 )
goto V_2477;
V_2475 = F_567 ( & V_2473 [ V_42 ] ) ;
V_2474 = V_42 + V_2123 + V_2475 ;
V_42 += V_2123 ;
if ( V_2474 > V_2079 )
goto V_2477;
V_627 = F_568 ( V_2473 , V_42 , V_2475 ,
V_2478 ) ;
if ( V_627 > 0 ) {
V_74 = F_626 ( & V_2473 [ V_627 ] ) ;
V_627 += V_2125 ;
...
V_2479:
V_42 = F_568 ( V_2473 , V_42 , V_2475 ,
V_2481 ) ;
if ( V_42 < 0 )
goto V_2477;
V_74 = F_626 ( & V_2473 [ V_42 ] ) ;
V_42 += V_2125 ;
if ( V_74 > V_2482 ||
( V_74 + V_42 ) > V_2079 )
goto V_2477;
...
if ( F_30 ( V_5 ) != V_767 )
return;
if ( ! F_619 ( V_5 , V_2543 , & V_7 ) &&
! F_619 ( V_5 , V_2543 + 4 , & V_2440 ) &&
F_635 ( V_7 ) ) {
...
static void F_641 ( struct V_4 * V_5 , T_1 V_2552 )
{
...
static int F_643 ( struct V_4 * V_5 , const struct V_2569 * V_2570 )
{
T_1 V_2552 ;
T_1 V_2576 , V_2571 ;
T_1 V_7 ;
...
V_2591 = F_644 ( V_2590 -> V_2581 , V_2590 -> V_543 ,
V_2591 ) ;
if ( ! V_2591 ) {
V_2590 ++ ;
continue;
...
F_23 ( V_5 , 5780_CLASS ) ) {
V_5 -> V_1400 = F_646 ( V_5 -> V_12 , V_2610 ) ;
if ( ! V_5 -> V_1400 ) {
F_116 ( & V_5 -> V_12 -> V_111 ,
L_111 ) ;
return - V_210 ;
...
! F_23 ( V_5 , V_1082 ) )
F_83 ( V_5 , V_31 ) ;
F_648 ( V_5 -> V_12 , V_1395 ,
& V_5 -> V_1396 ) ;
F_648 ( V_5 -> V_12 , V_1397 ,
& V_5 -> V_1398 ) ;
if ( F_30 ( V_5 ) == V_499 &&
V_5 -> V_1398 < 64 ) {
V_5 -> V_1398 = 64 ;
...
struct V_364 * V_111 = V_5 -> V_111 ;
struct V_1794 * V_12 = V_5 -> V_12 ;
struct V_2661 * V_2030 = F_653 ( V_12 ) ;
const unsigned char * V_184 ;
int V_74 ;
V_184 = F_654 ( V_2030 , L_113 , & V_74 ) ;
...
static int F_660 ( struct V_4 * V_5 , T_1 * V_626 , T_9 V_2704 ,
...
( 0x6 << V_2719 ) ) ;
V_5 -> V_1583 = F_659 ( V_5 , V_5 -> V_1583 ) ;
if ( F_23 ( V_5 , 57765_PLUS ) )
goto V_502;
if ( F_23 ( V_5 , V_1082 ) ) {
...
V_1449 [ V_42 ] = V_42 ;
V_56 = F_660 ( V_5 , V_626 , V_2704 , V_2716 , true ) ;
if ( V_56 ) {
F_116 ( & V_5 -> V_12 -> V_111 ,
L_114 ,
V_657 , V_56 ) ;
...
V_56 = F_660 ( V_5 , V_626 , V_2704 , V_2716 , false ) ;
if ( V_56 ) {
...
static char * F_664 ( struct V_4 * V_5 , char * V_2771 )
{
if ( F_23 ( V_5 , V_1082 ) ) {
strcpy ( V_2771 , L_145 ) ;
return V_2771 ;
...
static int F_666 ( struct V_1794 * V_12 ,
const struct V_2569 * V_2570 )
{
struct V_364 * V_111 ;
struct V_4 * V_5 ;
...
T_6 V_2790 , V_2791 ;
T_15 V_1192 = 0 ;
F_667 ( V_2792 L_155 , V_1977 ) ;
V_75 = F_668 ( V_12 ) ;
if ( V_75 ) {
F_116 ( & V_12 -> V_111 , L_156 ) ;
return V_75 ;
}
V_75 = F_669 ( V_12 , V_2020 ) ;
if ( V_75 ) {
F_116 ( & V_12 -> V_111 , L_157 ) ;
goto V_2793;
}
F_670 ( V_12 ) ;
V_111 = F_671 ( sizeof( * V_5 ) , V_1898 ) ;
if ( ! V_111 ) {
V_75 = - V_268 ;
goto V_2794;
}
...
F_679 ( & V_5 -> V_209 ) ;
F_679 ( & V_5 -> V_11 ) ;
F_680 ( & V_5 -> V_1225 , F_487 ) ;
V_5 -> V_8 = F_681 ( V_12 , V_2806 ) ;
if ( ! V_5 -> V_8 ) {
