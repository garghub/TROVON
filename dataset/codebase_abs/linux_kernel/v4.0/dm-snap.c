...
V_3 -> V_7 -> type -> V_166 ( V_3 -> V_7 , & V_75 -> V_68 ,
F_146 , V_75 ) ;
}
...
V_170 = F_149 ( V_169 , struct V_74 , V_168 ) ;
if ( V_170 -> V_167 < V_75 -> V_167 )
break;
}
F_75 ( & V_75 -> V_168 , V_169 ) ;
}
}
...
V_102 . V_42 = F_82 ( ( T_1 ) V_3 -> V_7 -> V_51 , V_171 - V_102 . V_110 ) ;
...
{
void * V_172 = V_13 -> V_162 ;
F_152 ( V_172 , 0 , error ? 1 : 0 ) ;
}
...
V_75 -> V_173 = 0 ;
V_75 -> V_159 = NULL ;
if ( V_3 -> V_7 -> type -> V_174 ( V_3 -> V_7 , & V_75 -> V_68 ) ) {
F_67 ( V_75 ) ;
return NULL ;
}
V_75 -> V_167 = V_3 -> V_130 ++ ;
...
{
V_13 -> V_175 = V_3 -> V_5 -> V_29 ;
V_13 -> V_176 . V_177 =
F_3 ( V_3 -> V_7 , F_73 ( V_68 -> V_80 ) +
( V_8 - V_68 -> V_69 ) ) +
( V_13 -> V_176 . V_177 & V_3 -> V_7 -> V_178 ) ;
}
...
V_8 = F_160 ( V_3 -> V_7 , V_13 -> V_176 . V_177 ) ;
if ( ! V_3 -> V_108 )
return - V_154 ;
F_46 ( & V_3 -> V_46 ) ;
if ( ! V_3 -> V_108 ) {
...
{
struct V_2 * V_3 = V_45 -> V_141 ;
struct V_2 * V_39 = NULL , * V_40 = NULL , * V_187 = NULL ;
struct V_36 * V_33 ;
...
if ( V_33 )
V_189 = F_170 ( V_33 -> V_45 -> V_61 ) ;
if ( ! V_189 ) {
( void ) F_39 ( V_3 , NULL , NULL , & V_187 ) ;
if ( V_187 )
V_189 = F_170 ( V_187 -> V_45 -> V_61 ) ;
}
if ( V_189 == F_170 ( V_45 -> V_61 ) )
V_189 = NULL ;
if ( V_189 ) {
if ( F_171 ( V_189 ) )
V_189 = NULL ;
...
if ( V_189 ) {
F_172 ( V_189 ) ;
if ( V_187 && F_101 ( V_90 , & V_187 -> V_91 ) ) {
V_190 = true ;
F_109 ( V_187 ) ;
}
}
...
if ( V_38 -> V_7 -> type -> V_198 ) {
T_1 V_199 , V_200 ,
V_201 ;
V_38 -> V_7 -> type -> V_198 ( V_38 -> V_7 ,
& V_199 ,
& V_200 ,
& V_201 ) ;
F_179 ( L_39 ,
...
break;
case V_202 :
F_179 ( L_41 , V_38 -> V_4 -> V_203 , V_38 -> V_5 -> V_203 ) ;
V_38 -> V_7 -> type -> V_204 ( V_38 -> V_7 , type , V_194 + V_196 ,
V_195 - V_196 ) ;
break;
}
}
static int F_180 ( struct V_116 * V_45 ,
T_8 V_205 , void * V_206 )
{
struct V_2 * V_38 = V_45 -> V_141 ;
int V_54 ;
V_54 = V_205 ( V_45 , V_38 -> V_4 , 0 , V_45 -> V_207 , V_206 ) ;
if ( ! V_54 )
V_54 = V_205 ( V_45 , V_38 -> V_5 , 0 , F_81 ( V_38 -> V_5 -> V_29 ) , V_206 ) ;
return V_54 ;
}
...
V_33 = F_31 ( V_4 -> V_29 ) ;
if ( V_33 )
V_54 = F_181 ( & V_33 -> V_55 , V_13 -> V_176 . V_177 , V_13 ) ;
F_42 ( & V_28 ) ;
return V_54 ;
}
static int F_103 ( struct V_2 * V_211 ,
...
struct V_4 * V_33 ;
F_41 ( & V_28 ) ;
V_33 = F_31 ( V_211 -> V_4 -> V_29 ) ;
for ( V_150 = 0 ; V_150 < V_58 ; V_150 += V_211 -> V_45 -> V_149 )
...
struct V_36 * V_33 = V_45 -> V_141 ;
unsigned V_215 ;
V_13 -> V_175 = V_33 -> V_37 -> V_29 ;
if ( F_102 ( V_13 -> V_179 & V_180 ) )
return V_152 ;
if ( F_161 ( V_13 ) != V_182 )
return V_152 ;
V_215 = V_33 -> V_216 -
( ( unsigned ) V_13 -> V_176 . V_177 & ( V_33 -> V_216 - 1 ) ) ;
if ( F_186 ( V_13 ) > V_215 )
F_187 ( V_13 , V_215 ) ;
...
{
struct V_36 * V_33 = V_45 -> V_141 ;
V_33 -> V_216 = F_176 ( V_33 -> V_37 -> V_29 ) ;
F_46 ( & V_28 ) ;
F_36 ( V_33 ) ;
F_47 ( & V_28 ) ;
}
...
break;
case V_202 :
snprintf ( V_194 , V_195 , L_45 , V_33 -> V_37 -> V_203 ) ;
break;
}
}
static int F_191 ( struct V_116 * V_45 , struct V_217 * V_218 ,
struct V_219 * V_220 , int V_221 )
{
struct V_36 * V_33 = V_45 -> V_141 ;
struct V_222 * V_223 = F_192 ( V_33 -> V_37 -> V_29 ) ;
if ( ! V_223 -> V_224 )
return V_221 ;
V_218 -> V_175 = V_33 -> V_37 -> V_29 ;
return F_82 ( V_221 , V_223 -> V_224 ( V_223 , V_218 , V_220 ) ) ;
}
static int F_193 ( struct V_116 * V_45 ,
T_8 V_205 , void * V_206 )
{
struct V_36 * V_33 = V_45 -> V_141 ;
return V_205 ( V_45 , V_33 -> V_37 , 0 , V_45 -> V_207 , V_206 ) ;
}
