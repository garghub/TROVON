...
static void
F_95 ( T_14 * V_168 , int V_169 )
{
int V_170 = F_96 ( T_14 , V_171 [ V_169 ] ) ;
while ( -- V_169 >= 0 )
F_97 ( V_168 -> V_171 [ V_169 ] . V_172 ) ;
F_37 ( V_168 , V_170 ) ;
}
static T_14 *
F_98 ( T_15 * V_173 , int V_80 )
{
...
static int
F_104 ( T_15 * V_173 , int V_188 , int V_80 )
{
T_14 * V_168 ;
int V_81 ;
if ( V_173 -> V_183 != 0 ) {
...
F_107 (rtrp, i, the_lnet.ln_rtrpools) {
F_105 ( & V_190 [ 0 ] , 0 ) ;
V_66 = F_104 ( & V_190 [ 0 ] , V_208 , V_81 ) ;
if ( V_66 != 0 )
goto V_213;
F_105 ( & V_190 [ 1 ] , V_207 ) ;
V_66 = F_104 ( & V_190 [ 1 ] , V_209 , V_81 ) ;
if ( V_66 != 0 )
goto V_213;
F_105 ( & V_190 [ 2 ] , V_204 ) ;
V_66 = F_104 ( & V_190 [ 2 ] , V_210 , V_81 ) ;
if ( V_66 != 0 )
goto V_213;
}
F_9 ( V_74 ) ;
...
int V_81 ;
T_10 V_222 ;
V_66 = F_123 ( & V_30 . V_144 , 1 , 0 , & V_222 , & V_81 ) ;
if ( V_66 == 0 )
break;
if ( V_66 == - V_223 ) {
F_36 ( L_42 ) ;
