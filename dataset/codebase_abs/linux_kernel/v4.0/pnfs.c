...
if ( ! V_241 -> V_244 ) {
F_169 ( V_241 ) ;
V_241 -> V_248 -> V_249 ( & V_241 -> V_173 , V_241 ) ;
} else
F_165 ( V_241 ) ;
V_241 -> V_248 -> V_250 ( V_241 ) ;
}
static void
F_170 ( struct V_220 * V_232 ,
struct V_240 * V_241 )
{
struct V_251 * V_252 = F_171 ( V_232 ) ;
if ( ! F_34 ( V_246 , & V_241 -> V_154 ) ) {
F_172 ( & V_241 -> V_253 , & V_252 -> V_254 ) ;
F_157 ( V_232 ) ;
V_252 -> V_255 = 1 ;
}
F_173 ( V_241 ) ;
...
V_241 -> V_248 = V_258 ;
F_3 ( L_62 , V_5 ,
V_36 -> V_116 , V_241 -> args . V_205 , V_241 -> args . V_64 , V_259 ) ;
V_260 = V_9 -> V_10 -> V_261 ( V_241 , V_259 ) ;
if ( V_260 != V_262 )
F_175 ( V_36 , V_263 ) ;
F_3 ( L_63 , V_5 , V_260 ) ;
return V_260 ;
...
struct V_240 * V_241 , int V_259 )
{
const struct V_257 * V_258 = V_232 -> V_264 ;
struct V_71 * V_72 = V_232 -> V_226 ;
enum V_256 V_260 ;
V_260 = F_174 ( V_241 , V_258 , V_72 , V_259 ) ;
if ( V_260 == V_262 )
F_170 ( V_232 , V_241 ) ;
}
...
struct V_240 * V_241 ;
int V_111 ;
V_241 = F_180 ( V_232 -> V_265 ) ;
if ( ! V_241 ) {
V_232 -> V_266 -> V_267 ( & V_252 -> V_254 ) ;
return - V_151 ;
}
...
static void F_196 ( struct V_36 * V_36 , struct V_101 * V_274 )
{
struct V_71 * V_72 ;
F_2 (lseg, &NFS_I(inode)->layout->plh_segs, pls_list) {
if ( V_72 -> V_107 . V_54 == V_55 &&
F_36 ( V_155 , & V_72 -> V_77 ) )
F_17 ( & V_72 -> V_74 , V_274 ) ;
}
}
static void F_197 ( struct V_36 * V_36 , struct V_101 * V_274 )
{
struct V_71 * V_72 , * V_27 ;
...
void
F_169 ( struct V_240 * V_241 )
{
struct V_36 * V_36 = V_241 -> V_36 ;
struct V_47 * V_48 = F_28 ( V_36 ) ;
T_6 V_275 = V_241 -> V_276 + V_241 -> V_217 . V_205 ;
bool V_277 = false ;
F_5 ( & V_36 -> V_52 ) ;
...
if ( ! F_34 ( V_155 , & V_241 -> V_72 -> V_77 ) ) {
F_133 ( V_241 -> V_72 ) ;
}
if ( V_275 > V_48 -> V_49 -> V_278 )
V_48 -> V_49 -> V_278 = V_275 ;
F_7 ( & V_36 -> V_52 ) ;
F_3 ( L_67 ,
V_5 , V_241 -> V_72 , V_48 -> V_49 -> V_278 ) ;
if ( V_277 )
F_199 ( V_36 ) ;
}
void F_200 ( struct V_279 * V_280 )
{
struct V_36 * V_36 = V_280 -> V_36 ;
struct V_47 * V_48 = F_28 ( V_36 ) ;
bool V_277 = false ;
F_5 ( & V_36 -> V_52 ) ;
if ( ! F_34 ( V_153 , & V_48 -> V_154 ) ) {
...
if ( ! F_34 ( V_155 , & V_280 -> V_72 -> V_77 ) ) {
F_133 ( V_280 -> V_72 ) ;
}
if ( V_280 -> V_281 > V_48 -> V_49 -> V_278 )
V_48 -> V_49 -> V_278 = V_280 -> V_281 ;
F_7 ( & V_36 -> V_52 ) ;
F_3 ( L_67 ,
V_5 , V_280 -> V_72 , V_48 -> V_49 -> V_278 ) ;
if ( V_277 )
F_199 ( V_36 ) ;
}
void F_201 ( struct V_282 * V_280 )
{
struct V_8 * V_9 = F_22 ( V_280 -> args . V_36 ) ;
if ( V_9 -> V_10 -> V_283 )
V_9 -> V_10 -> V_283 ( V_280 ) ;
...
V_25 = - V_113 ;
if ( F_34 ( V_273 , & V_48 -> V_154 ) ) {
if ( ! V_156 )
goto V_4;
V_25 = F_203 ( & V_48 -> V_154 ,
V_273 ,
F_137 ,
V_284 ) ;
if ( V_25 )
...
F_204 ( & V_280 -> V_286 ) ;
V_280 -> args . V_287 = F_22 ( V_36 ) -> V_288 ;
V_280 -> V_217 . V_286 = & V_280 -> V_286 ;
V_280 -> args . V_289 = V_275 - 1 ;
V_280 -> V_217 . V_14 = F_22 ( V_36 ) ;
if ( V_39 -> V_290 ) {
V_25 = V_39 -> V_290 ( & V_280 -> args ) ;
if ( V_25 ) {
F_5 ( & V_36 -> V_52 ) ;
if ( V_275 < V_48 -> V_49 -> V_278 )
V_48 -> V_49 -> V_278 = V_275 ;
...
{
struct V_181 * V_291 ;
V_291 = F_103 ( sizeof( * V_291 ) , V_159 ) ;
if ( ! V_291 ) {
F_3 ( L_70 , V_5 ) ;
return NULL ;
}
