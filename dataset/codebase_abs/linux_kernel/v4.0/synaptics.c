...
V_121 ) ;
if ( V_86 . V_91 > 30 ) F_68 ( V_113 , V_136 , 1 ) ;
if ( V_86 . V_91 < 25 ) F_68 ( V_113 , V_136 , 0 ) ;
if ( V_121 > 0 ) {
F_64 ( V_113 , V_137 , V_86 . V_90 ) ;
F_64 ( V_113 , V_138 , F_6 ( V_86 . V_13 ) ) ;
}
F_64 ( V_113 , V_139 , V_86 . V_91 ) ;
if ( F_84 ( V_18 -> V_35 ) )
F_64 ( V_113 , V_140 , V_134 ) ;
F_68 ( V_113 , V_141 , V_121 == 1 ) ;
if ( F_82 ( V_18 -> V_35 ) ) {
F_68 ( V_113 , V_142 , V_121 == 2 ) ;
F_68 ( V_113 , V_143 , V_121 == 3 ) ;
}
F_72 ( V_1 , & V_86 ) ;
F_79 ( V_113 ) ;
}
static int F_85 ( struct V_1 * V_1 ,
int V_144 , unsigned char V_145 )
{
static const unsigned char V_146 [] = { 0xC8 , 0x00 , 0x00 , 0xC8 , 0x00 } ;
static const unsigned char V_147 [] = { 0xC0 , 0x00 , 0x00 , 0xC0 , 0x00 } ;
static const unsigned char V_148 [] = { 0x80 , 0x00 , 0x00 , 0xC0 , 0x00 } ;
static const unsigned char V_149 [] = { 0xC0 , 0x60 , 0x00 , 0xC0 , 0x60 } ;
static const unsigned char V_150 [] = { 0xC0 , 0x00 , 0x00 , 0x80 , 0x00 } ;
...
case V_151 :
case V_152 :
return ( V_71 [ V_144 ] & V_147 [ V_144 ] ) == V_148 [ V_144 ] ;
case V_153 :
return ( V_71 [ V_144 ] & V_146 [ V_144 ] ) == V_148 [ V_144 ] ;
case V_154 :
return ( V_71 [ V_144 ] & V_149 [ V_144 ] ) == V_150 [ V_144 ] ;
default:
F_35 ( V_1 , L_16 , V_145 ) ;
return 0 ;
}
...
return F_85 ( V_1 , V_1 -> V_155 - 1 , V_18 -> V_145 ) ?
V_157 : V_158 ;
}
static void F_90 ( struct V_112 * V_113 ,
struct V_17 * V_18 , int V_159 ,
int V_160 )
{
int V_50 = V_18 -> V_50 ? : V_161 ;
int V_47 = V_18 -> V_47 ? : V_162 ;
int V_51 = V_18 -> V_51 ? : V_15 ;
int V_48 = V_18 -> V_48 ? : V_14 ;
int V_163 = F_91 ( V_18 -> V_37 ) ?
V_164 : 0 ;
F_92 ( V_113 , V_159 , V_50 , V_47 , V_163 , 0 ) ;
F_92 ( V_113 , V_160 , V_51 , V_48 , V_163 , 0 ) ;
F_93 ( V_113 , V_159 , V_18 -> V_44 ) ;
F_93 ( V_113 , V_160 , V_18 -> V_45 ) ;
}
...
struct V_112 * V_113 = V_1 -> V_113 ;
int V_52 ;
F_95 ( V_165 , V_113 -> V_166 ) ;
F_95 ( V_167 , V_113 -> V_168 ) ;
F_95 ( V_124 , V_113 -> V_169 ) ;
F_95 ( V_125 , V_113 -> V_169 ) ;
if ( F_59 ( V_18 -> V_35 ) )
F_95 ( V_126 , V_113 -> V_169 ) ;
if ( ! V_18 -> V_58 ) {
F_95 ( V_170 , V_113 -> V_168 ) ;
F_95 ( V_171 , V_113 -> V_172 ) ;
F_95 ( V_173 , V_113 -> V_172 ) ;
return;
}
F_95 ( V_174 , V_113 -> V_168 ) ;
F_90 ( V_113 , V_18 , V_137 , V_138 ) ;
F_92 ( V_113 , V_139 , 0 , 255 , 0 , 0 ) ;
if ( V_135 )
F_92 ( V_113 , V_133 , 0 , 255 , 0 , 0 ) ;
if ( F_32 ( V_18 -> V_37 ) ) {
F_90 ( V_113 , V_18 , V_117 ,
V_118 ) ;
F_92 ( V_113 , V_133 , 0 , 255 , 0 , 0 ) ;
F_96 ( V_113 , 2 , V_175 | V_176 ) ;
F_95 ( V_177 , V_113 -> V_169 ) ;
F_95 ( V_178 , V_113 -> V_169 ) ;
...
if ( F_84 ( V_18 -> V_35 ) )
F_92 ( V_113 , V_140 , 0 , 15 , 0 , 0 ) ;
F_95 ( V_136 , V_113 -> V_169 ) ;
F_95 ( V_141 , V_113 -> V_169 ) ;
if ( F_82 ( V_18 -> V_35 ) ) {
F_95 ( V_142 , V_113 -> V_169 ) ;
F_95 ( V_143 , V_113 -> V_169 ) ;
}
if ( F_60 ( V_18 -> V_35 ) ||
F_59 ( V_18 -> V_35 ) ) {
F_95 ( V_127 , V_113 -> V_169 ) ;
F_95 ( V_128 , V_113 -> V_169 ) ;
}
if ( ! F_67 ( V_18 -> V_25 ) )
for ( V_52 = 0 ; V_52 < F_19 ( V_18 -> V_36 ) ; V_52 ++ )
F_95 ( V_122 + V_52 , V_113 -> V_169 ) ;
F_97 ( V_170 , V_113 -> V_168 ) ;
F_97 ( V_171 , V_113 -> V_172 ) ;
F_97 ( V_173 , V_113 -> V_172 ) ;
if ( F_58 ( V_18 -> V_37 ) ) {
F_95 ( V_180 , V_113 -> V_166 ) ;
if ( F_28 ( V_1 , V_181 ) &&
! F_67 ( V_18 -> V_25 ) )
F_95 ( V_182 , V_113 -> V_166 ) ;
F_97 ( V_125 , V_113 -> V_169 ) ;
F_97 ( V_126 , V_113 -> V_169 ) ;
}
}
static T_2 F_98 ( struct V_1 * V_1 ,
void * V_183 , char * V_23 )
{
struct V_17 * V_18 = V_1 -> V_19 ;
return sprintf ( V_23 , L_18 , V_18 -> V_60 ? '1' : '0' ) ;
}
static T_2 F_99 ( struct V_1 * V_1 ,
void * V_183 , const char * V_23 ,
T_3 V_184 )
{
struct V_17 * V_18 = V_1 -> V_19 ;
unsigned int V_185 ;
int V_186 ;
V_186 = F_100 ( V_23 , 10 , & V_185 ) ;
if ( V_186 )
return V_186 ;
if ( V_185 > 1 )
return - V_187 ;
...
F_3 ( & V_1 -> V_5 , V_3 , V_193 ) ;
error = F_4 ( V_1 , 0 ) ;
} while ( error && ++ V_192 < 3 );
if ( error )
return - 1 ;
if ( V_192 > 1 )
F_108 ( V_1 , L_19 , V_192 ) ;
if ( F_29 ( V_1 ) ) {
F_35 ( V_1 , L_20 ) ;
return - 1 ;
}
...
if ( V_191 . V_27 != V_18 -> V_27 ||
V_191 . V_22 != V_18 -> V_22 ||
V_191 . V_35 != V_18 -> V_35 ||
V_191 . V_36 != V_18 -> V_36 ) {
F_35 ( V_1 ,
L_22 ,
V_191 . V_27 , V_18 -> V_27 ,
V_191 . V_22 , V_18 -> V_22 ,
V_191 . V_35 , V_18 -> V_35 ,
V_191 . V_36 , V_18 -> V_36 ) ;
return - 1 ;
...
V_18 -> V_145 = F_55 ( V_18 -> V_22 ) ? V_151 : V_154 ;
F_25 ( V_1 ,
L_24 ,
F_112 ( V_18 -> V_27 ) ,
...
V_18 -> V_29 , V_18 -> V_32 ) ;
F_94 ( V_1 , V_18 ) ;
V_1 -> V_202 = ( ( V_18 -> V_22 & 0x00ff0000 ) >> 8 ) |
...
if ( ! V_18 -> V_58 && F_102 ( V_18 -> V_27 ) ) {
V_186 = F_115 ( & V_1 -> V_5 . V_65 -> V_113 ,
& V_189 . V_190 ) ;
if ( V_186 ) {
F_35 ( V_1 ,
L_26 ,
