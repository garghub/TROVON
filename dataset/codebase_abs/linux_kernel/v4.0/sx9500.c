...
return V_6 ;
V_6 = F_41 ( V_79 ) ;
F_42 ( V_37 , L_3 , F_43 ( V_79 ) , V_6 ) ;
return V_6 ;
}
static int F_44 ( struct V_76 * V_36 ,
const struct V_81 * V_82 )
{
int V_6 ;
struct V_21 * V_22 ;
struct V_1 * V_2 ;
V_22 = F_45 ( & V_36 -> V_37 , sizeof( * V_2 ) ) ;
if ( V_22 == NULL )
return - V_64 ;
V_2 = F_10 ( V_22 ) ;
V_2 -> V_36 = V_36 ;
F_46 ( & V_2 -> V_15 ) ;
V_2 -> V_32 = false ;
V_2 -> V_8 = F_47 ( V_36 , & V_83 ) ;
if ( F_38 ( V_2 -> V_8 ) )
return F_39 ( V_2 -> V_8 ) ;
F_35 ( V_22 ) ;
V_22 -> V_37 . V_84 = & V_36 -> V_37 ;
V_22 -> V_85 = V_86 ;
V_22 -> V_70 = V_87 ;
V_22 -> V_88 = F_13 ( V_87 ) ;
V_22 -> V_89 = & V_90 ;
...
if ( V_36 -> V_30 > 0 ) {
V_6 = F_49 ( & V_36 -> V_37 , V_36 -> V_30 ,
F_16 , F_18 ,
V_93 | V_94 ,
V_95 , V_22 ) ;
if ( V_6 < 0 )
return V_6 ;
V_2 -> V_33 = F_50 ( & V_36 -> V_37 ,
L_4 , V_22 -> V_85 , V_22 -> V_82 ) ;
if ( ! V_2 -> V_33 )
return - V_64 ;
V_2 -> V_33 -> V_37 . V_84 = & V_36 -> V_37 ;
V_2 -> V_33 -> V_96 = & V_97 ;
F_51 ( V_2 -> V_33 , V_22 ) ;
V_6 = F_52 ( V_2 -> V_33 ) ;
if ( V_6 )
...
static int F_57 ( struct V_76 * V_36 )
{
struct V_21 * V_22 = F_58 ( V_36 ) ;
struct V_1 * V_2 = F_10 ( V_22 ) ;
F_59 ( V_22 ) ;
F_55 ( V_22 ) ;
if ( V_36 -> V_30 > 0 )
