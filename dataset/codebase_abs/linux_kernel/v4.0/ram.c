...
return 0 ;
V_30 = F_4 ( V_18 ) ;
V_24 = F_5 ( F_9 ( V_18 ) , time ,
V_22 ) ;
V_30 -= V_24 ;
V_31 = F_7 ( V_18 , NULL , 0 ) ;
* V_29 = F_10 ( V_30 + V_31 + 1 , V_40 ) ;
if ( * V_29 == NULL )
return - V_41 ;
...
static T_4 F_11 ( struct V_10 * V_18 ,
bool V_22 )
{
char * V_42 ;
struct V_21 V_43 ;
...
static int T_5 F_17 ( enum V_15 type ,
enum V_46 V_47 ,
...
if ( ! V_4 -> V_34 )
return - V_41 ;
F_15 ( V_4 -> V_34 , V_29 , V_30 ) ;
return 0 ;
} else if ( type == V_37 ) {
if ( ! V_4 -> V_36 )
return - V_41 ;
F_15 ( V_4 -> V_36 , V_29 , V_30 ) ;
return 0 ;
} else if ( type == V_39 ) {
if ( ! V_4 -> V_38 )
return - V_41 ;
F_15 ( V_4 -> V_38 , V_29 , V_30 ) ;
return 0 ;
}
if ( type != V_33 )
return - V_50 ;
...
static int F_18 ( enum V_15 type , T_2 V_14 , int V_28 ,
...
T_4 V_65 = V_4 -> V_62 ;
V_4 -> V_11 [ V_19 ] = F_27 ( * V_59 , V_65 , 0 ,
& V_4 -> V_66 ,
V_4 -> V_67 ) ;
if ( F_28 ( V_4 -> V_11 [ V_19 ] ) ) {
V_61 = F_29 ( V_4 -> V_11 [ V_19 ] ) ;
F_25 ( V_58 , L_6 ,
V_65 , ( unsigned long long ) * V_59 , V_61 ) ;
goto V_64;
}
* V_59 += V_65 ;
}
...
struct V_10 * * V_18 ,
T_6 * V_59 , T_4 V_65 , T_7 V_68 )
{
if ( ! V_65 )
return 0 ;
if ( * V_59 + V_65 - V_4 -> V_63 > V_4 -> V_30 ) {
F_25 ( V_58 , L_7 ,
V_65 , ( unsigned long long ) * V_59 ,
V_4 -> V_30 , ( unsigned long long ) V_4 -> V_63 ) ;
return - V_41 ;
}
* V_18 = F_27 ( * V_59 , V_65 , V_68 , & V_4 -> V_66 , V_4 -> V_67 ) ;
if ( F_28 ( * V_18 ) ) {
int V_61 = F_29 ( * V_18 ) ;
F_25 ( V_58 , L_6 ,
V_65 , ( unsigned long long ) * V_59 , V_61 ) ;
...
V_4 -> V_86 . V_29 = F_10 ( V_4 -> V_86 . V_87 , V_40 ) ;
F_35 ( & V_4 -> V_86 . V_88 ) ;
if ( ! V_4 -> V_86 . V_29 ) {
F_32 ( L_10 ) ;
V_61 = - V_41 ;
...
V_94 -> V_79 = V_97 ;
V_94 -> V_53 = V_53 ;
V_94 -> V_66 . V_91 = V_98 == 1 ? 16 : V_98 ;
V_99 = F_40 ( NULL , L_15 , - 1 ,
V_94 , sizeof( struct V_71 ) ) ;
if ( F_28 ( V_99 ) ) {
F_37 ( L_16 ,
F_29 ( V_99 ) ) ;
}
