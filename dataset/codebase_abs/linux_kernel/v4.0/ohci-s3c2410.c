...
static int F_22 ( const struct V_51 * V_52 ,
struct V_6 * V_7 )
{
struct V_2 * V_3 = NULL ;
struct V_1 * V_8 = F_2 ( & V_7 -> V_7 ) ;
...
F_11 ( V_8 , 1 , 1 ) ;
F_11 ( V_8 , 2 , 1 ) ;
V_3 = F_23 ( V_52 , & V_7 -> V_7 , L_12 ) ;
if ( V_3 == NULL )
return - V_54 ;
V_3 -> V_55 = V_7 -> V_56 [ 0 ] . V_57 ;
V_3 -> V_58 = F_24 ( & V_7 -> V_56 [ 0 ] ) ;
V_3 -> V_59 = F_25 ( & V_7 -> V_7 , & V_7 -> V_56 [ 0 ] ) ;
if ( F_26 ( V_3 -> V_59 ) ) {
V_53 = F_27 ( V_3 -> V_59 ) ;
goto V_60;
}
...
F_3 ( V_7 , V_3 ) ;
V_53 = F_30 ( V_3 , V_7 -> V_56 [ 1 ] . V_57 , 0 ) ;
if ( V_53 != 0 )
goto V_61;
F_31 ( V_3 -> V_4 . V_5 ) ;
return 0 ;
...
static int F_32 ( struct V_6 * V_62 )
{
return F_22 ( & V_63 , V_62 ) ;
}
static int F_33 ( struct V_6 * V_62 )
{
struct V_2 * V_3 = F_34 ( V_62 ) ;
F_19 ( V_3 , V_62 ) ;
return 0 ;
}
static int F_35 ( struct V_64 * V_7 )
{
struct V_2 * V_3 = F_36 ( V_7 ) ;
struct V_6 * V_62 = F_37 ( V_7 ) ;
bool V_65 = F_38 ( V_7 ) ;
int V_66 = 0 ;
V_66 = F_39 ( V_3 , V_65 ) ;
if ( V_66 )
...
static int F_40 ( struct V_64 * V_7 )
{
struct V_2 * V_3 = F_36 ( V_7 ) ;
struct V_6 * V_62 = F_37 ( V_7 ) ;
F_3 ( V_62 , V_3 ) ;
