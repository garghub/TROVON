...
F_260 ( V_307 , V_150 ) ;
F_261 ( V_362 , V_307 ) ;
V_307 -> V_363 . V_364 = V_150 ;
V_307 -> V_363 . V_365 = V_150 ;
V_307 -> V_363 . V_366 = V_150 / V_339 ;
V_307 -> V_363 . V_367 = 1 ;
F_262 ( V_307 , F_233 ) ;
V_36 -> V_335 = V_307 ;
V_307 -> V_308 = V_22 ;
...
static struct V_21 * F_263 ( struct V_17 * V_18 )
{
return F_53 ( V_18 , struct V_21 , V_18 ) ;
}
static T_11 F_264 ( struct V_17 * V_18 ,
struct V_368 * V_11 , char * V_162 )
{
struct V_21 * V_22 = F_263 ( V_18 ) ;
...
F_269 ( V_22 -> V_53 -> V_63 ) ) ;
}
static T_11 F_270 ( struct V_17 * V_18 ,
struct V_368 * V_11 , char * V_162 )
{
struct V_21 * V_22 = F_263 ( V_18 ) ;
return sprintf ( V_162 , L_63 , V_22 -> V_45 -> V_369 ) ;
}
...
struct V_21 * V_22 = F_263 ( V_18 ) ;
return sprintf ( V_162 , L_58 ,
( unsigned long long ) V_22 -> V_45 -> V_370 ) ;
}
...
struct V_21 * V_22 = F_263 ( V_18 ) ;
if ( V_22 -> V_45 -> V_371 )
return sprintf ( V_162 , L_63 , V_22 -> V_45 -> V_371 ) ;
...
struct V_374 * V_45 = V_22 -> V_257 ;
V_373 += sprintf ( & V_162 [ V_373 ] , L_66
L_67
L_68
L_69
L_70 ,
! V_373 ? L_71 : L_72 ,
V_45 -> V_370 , V_45 -> V_369 ,
V_45 -> V_372 , V_45 -> V_371 ? : L_73 ,
...
static struct V_374 * F_278 ( struct V_374 * V_45 )
{
F_40 ( & V_45 -> V_61 ) ;
return V_45 ;
}
static void F_170 ( struct V_374 * V_45 )
{
if ( V_45 )
F_56 ( & V_45 -> V_61 , V_375 ) ;
}
static struct V_374 * F_279 ( void )
{
struct V_374 * V_45 ;
V_45 = F_280 ( sizeof ( * V_45 ) , V_59 ) ;
if ( ! V_45 )
return NULL ;
V_45 -> V_370 = V_376 ;
V_45 -> V_46 = V_47 ;
...
static void V_375 ( struct V_61 * V_61 )
{
struct V_374 * V_45 = F_53 ( V_61 , struct V_374 , V_61 ) ;
F_36 ( V_45 -> V_369 ) ;
F_36 ( V_45 -> V_372 ) ;
F_36 ( V_45 -> V_371 ) ;
F_36 ( V_45 -> V_133 ) ;
...
static struct V_21 * F_281 ( struct V_53 * V_56 ,
struct V_374 * V_45 )
{
struct V_21 * V_22 ;
V_22 = F_280 ( sizeof ( * V_22 ) , V_59 ) ;
if ( ! V_22 )
return NULL ;
F_176 ( & V_22 -> V_30 ) ;
V_22 -> V_32 = 0 ;
...
V_22 -> V_45 = V_45 ;
V_22 -> V_53 = V_56 ;
V_22 -> V_252 . V_377 = F_284 ( 1 << V_378 ) ;
V_22 -> V_252 . V_379 = F_284 ( 1 ) ;
V_22 -> V_252 . V_380 = F_284 ( 1 << V_378 ) ;
V_22 -> V_252 . V_381 = F_284 ( ( T_5 ) V_45 -> V_370 ) ;
return V_22 ;
}
...
if ( V_39 < 0 )
return V_39 ;
if ( V_39 < sizeof ( V_385 ) )
return - V_386 ;
if ( V_101 ) {
* V_101 = V_385 . V_101 ;
F_25 ( L_76 , ( unsigned int ) * V_101 ) ;
}
* V_141 = F_60 ( V_385 . V_96 ) ;
F_25 ( L_77 ,
...
goto V_49;
V_388 = V_387 ;
V_22 -> V_109 . V_111 = F_289 ( & V_388 ,
V_388 + V_39 , NULL , V_148 ) ;
V_39 = 0 ;
...
if ( V_39 < 0 )
return V_39 ;
if ( V_39 < sizeof ( V_391 ) )
return - V_386 ;
V_390 = F_60 ( V_391 . V_390 ) ;
if ( V_390 & ~ V_392 )
return - V_318 ;
* V_142 = F_60 ( V_391 . V_130 ) ;
F_25 ( L_81 ,
( unsigned long long ) V_46 ,
( unsigned long long ) * V_142 ,
( unsigned long long ) F_60 ( V_391 . V_390 ) ) ;
return 0 ;
}
...
sizeof ( V_105 ) +
sizeof ( V_105 ) ;
V_387 = F_26 ( V_96 , V_59 ) ;
if ( ! V_387 ) {
V_39 = - V_57 ;
goto V_117;
}
V_382 = F_286 ( V_22 -> V_45 -> V_46 ) ;
V_39 = F_217 ( V_22 , V_22 -> V_288 ,
L_41 , L_82 ,
& V_382 , sizeof ( V_382 ) ,
V_387 , V_96 ) ;
...
V_39 = - V_131 ;
if ( V_370 > ( V_106 ) V_395 ) {
F_103 ( NULL , L_84 ,
( unsigned long long ) V_370 , V_395 ) ;
goto V_117;
}
V_372 = F_289 ( & V_388 , V_169 , NULL , V_59 ) ;
if ( F_30 ( V_372 ) ) {
V_39 = F_198 ( V_372 ) ;
goto V_117;
}
F_291 ( & V_388 , V_169 , V_46 , V_117 ) ;
F_291 ( & V_388 , V_169 , V_393 , V_117 ) ;
if ( ! V_22 -> V_257 ) {
V_257 -> V_370 = V_370 ;
V_257 -> V_372 = V_372 ;
V_257 -> V_46 = V_46 ;
...
return - V_386 ;
V_39 = - V_4 ;
V_397 = ( V_106 ) 1 << V_22 -> V_109 . V_125 ;
V_388 = & V_396 ;
V_128 = F_294 ( & V_388 ) ;
if ( V_128 != V_397 ) {
F_103 ( V_22 , L_88
...
char * V_371 = NULL ;
int V_39 ;
F_17 ( ! V_22 -> V_45 -> V_371 ) ;
V_116 = strlen ( V_22 -> V_45 -> V_372 ) ;
V_398 = sizeof ( V_283 ) + V_116 ;
V_372 = F_26 ( V_398 , V_59 ) ;
if ( ! V_372 )
return NULL ;
V_388 = V_372 ;
V_169 = V_372 + V_398 ;
F_296 ( & V_388 , V_169 , V_22 -> V_45 -> V_372 , ( T_5 ) V_116 ) ;
V_96 = sizeof ( V_283 ) + V_399 ;
V_387 = F_26 ( V_96 , V_59 ) ;
if ( ! V_387 )
goto V_49;
V_39 = F_217 ( V_22 , V_400 ,
L_41 , L_92 ,
V_372 , V_398 ,
V_387 , V_96 ) ;
if ( V_39 < 0 )
...
V_388 = V_387 ;
V_169 = V_387 + V_39 ;
V_371 = F_289 ( & V_388 , V_169 , & V_116 , V_59 ) ;
if ( F_30 ( V_371 ) )
V_371 = NULL ;
else
F_25 ( L_93 , V_58 , V_371 , V_116 ) ;
V_49:
F_36 ( V_387 ) ;
F_36 ( V_372 ) ;
return V_371 ;
...
{
struct V_374 * V_45 = V_22 -> V_45 ;
F_17 ( V_45 -> V_370 != V_376 && V_45 -> V_369 ) ;
F_17 ( V_45 -> V_372 && V_45 -> V_371 ) ;
F_17 ( V_45 -> V_133 ) ;
...
const char * V_133 ;
int V_39 ;
F_17 ( V_45 -> V_370 != V_376 ) ;
F_17 ( V_45 -> V_372 ) ;
F_17 ( V_45 -> V_46 != V_47 ) ;
V_369 = F_302 ( V_206 -> V_401 , V_45 -> V_370 ) ;
if ( ! V_369 ) {
F_103 ( V_22 , L_94 , V_45 -> V_370 ) ;
return - V_131 ;
}
V_369 = F_66 ( V_369 , V_59 ) ;
if ( ! V_369 )
return - V_57 ;
V_371 = F_295 ( V_22 ) ;
if ( ! V_371 )
...
V_169 = V_387 + V_39 ;
V_39 = - V_386 ;
F_291 ( & V_388 , V_169 , V_118 , V_49 ) ;
F_304 ( & V_388 , V_169 , V_97 , V_49 ) ;
if ( V_97 > ( V_103 - sizeof ( struct V_104 ) )
/ sizeof ( V_106 ) ) {
V_39 = - V_4 ;
goto V_49;
}
if ( ! F_305 ( & V_388 , V_169 , V_97 * sizeof ( V_105 ) ) )
goto V_49;
V_39 = 0 ;
V_112 = F_63 ( V_97 , V_59 ) ;
if ( ! V_112 ) {
...
V_388 = V_387 ;
V_169 = V_387 + V_39 ;
V_133 = F_289 ( & V_388 , V_169 , NULL , V_59 ) ;
if ( F_30 ( V_133 ) )
goto V_49;
F_25 ( L_99 ,
...
F_316 ( & V_22 -> V_62 ) ;
F_34 ( & V_413 ) ;
F_317 ( & V_411 , V_22 -> V_5 ) ;
F_25 ( L_102 , V_22 , V_22 -> V_5 ) ;
}
static inline T_6 F_318 ( const char * * V_162 )
{
const char * V_415 = L_103 ;
* V_162 += strspn ( * V_162 , V_415 ) ;
return strcspn ( * V_162 , V_415 ) ;
}
static inline char * F_319 ( const char * * V_162 , T_6 * V_416 )
{
char * V_417 ;
T_6 V_116 ;
V_116 = F_318 ( V_162 ) ;
V_417 = F_320 ( * V_162 , V_116 + 1 , V_59 ) ;
if ( ! V_417 )
return NULL ;
* ( V_417 + V_116 ) = '\0' ;
* V_162 += V_116 ;
...
* ( V_133 + V_116 ) = '\0' ;
V_45 -> V_133 = V_133 ;
V_74 = F_280 ( sizeof ( * V_74 ) , V_59 ) ;
if ( ! V_74 )
goto V_422;
V_74 -> V_28 = V_424 ;
V_421 = F_322 ( V_100 , V_419 ,
V_419 + V_420 - 1 ,
F_44 , V_74 ) ;
if ( F_30 ( V_421 ) ) {
V_39 = F_198 ( V_421 ) ;
...
static int F_323 ( struct V_53 * V_56 , const char * V_369 )
{
V_106 V_425 ;
unsigned long V_426 = V_56 -> V_63 -> V_100 -> V_427 * V_428 ;
int V_429 = 0 ;
int V_39 ;
V_430:
V_39 = F_324 ( V_56 -> V_63 -> V_206 . V_401 , V_369 ) ;
if ( V_39 == - V_34 && V_429 ++ < 1 ) {
V_39 = F_325 ( & V_56 -> V_63 -> V_431 , L_108 ,
& V_425 ) ;
if ( V_39 < 0 )
return V_39 ;
if ( V_56 -> V_63 -> V_206 . V_401 -> V_432 < V_425 ) {
F_326 ( & V_56 -> V_63 -> V_431 ) ;
( void ) F_327 ( & V_56 -> V_63 -> V_431 ,
V_425 , V_426 ) ;
goto V_430;
} else {
return - V_34 ;
...
char * V_372 ;
if ( V_22 -> V_45 -> V_372 ) {
V_22 -> V_93 = * V_22 -> V_45 -> V_372 ? 2 : 1 ;
return 0 ;
}
V_96 = sizeof ( V_434 ) + strlen ( V_22 -> V_45 -> V_371 ) ;
V_239 = F_26 ( V_96 , V_148 ) ;
if ( ! V_239 )
return - V_57 ;
sprintf ( V_239 , L_109 , V_434 , V_22 -> V_45 -> V_371 ) ;
F_25 ( L_110 , V_239 ) ;
V_96 = sizeof ( V_283 ) + V_394 ;
V_433 = F_280 ( V_96 , V_148 ) ;
if ( ! V_433 ) {
V_39 = - V_57 ;
goto V_49;
}
...
F_25 ( L_75 , V_58 , V_39 ) ;
if ( V_39 == - V_34 ) {
V_372 = F_66 ( L_71 , V_59 ) ;
V_39 = V_372 ? 0 : - V_57 ;
if ( ! V_39 )
V_22 -> V_93 = 1 ;
} else if ( V_39 >= 0 ) {
void * V_388 = V_433 ;
V_372 = F_289 ( & V_388 , V_388 + V_39 ,
NULL , V_148 ) ;
V_39 = F_329 ( V_372 ) ;
if ( ! V_39 )
V_22 -> V_93 = 2 ;
...
if ( ! V_22 -> V_257 )
return 0 ;
V_257 = F_278 ( V_22 -> V_257 ) ;
V_56 = F_39 ( V_22 -> V_53 ) ;
V_39 = - V_57 ;
V_266 = F_281 ( V_56 , V_257 ) ;
if ( ! V_266 )
goto V_117;
...
F_17 ( F_57 ( V_22 -> V_93 ) ) ;
if ( V_22 -> V_93 == 1 )
V_96 = strlen ( V_45 -> V_371 ) + sizeof ( V_443 ) ;
else
V_96 = sizeof ( V_444 ) + strlen ( V_45 -> V_372 ) ;
...
V_22 -> V_288 = NULL ;
V_22 -> V_93 = 0 ;
F_36 ( V_22 -> V_45 -> V_372 ) ;
V_22 -> V_45 -> V_372 = NULL ;
F_285 ( V_22 ) ;
}
...
static T_11 F_340 ( struct V_450 * V_404 ,
const char * V_162 ,
T_6 V_373 )
{
struct V_21 * V_22 = NULL ;
...
if ( ! F_341 ( V_452 ) )
return - V_453 ;
V_451 = F_321 ( V_162 , & V_55 , & V_74 , & V_45 ) ;
if ( V_451 < 0 )
goto V_454;
V_28 = V_74 -> V_28 ;
F_36 ( V_74 ) ;
...
V_451 = F_323 ( V_56 , V_45 -> V_369 ) ;
if ( V_451 < 0 )
goto V_456;
V_45 -> V_370 = ( V_106 ) V_451 ;
if ( V_45 -> V_370 > ( V_106 ) V_395 ) {
F_103 ( NULL , L_117 ,
( unsigned long long ) V_45 -> V_370 , V_395 ) ;
V_451 = - V_131 ;
goto V_456;
}
V_22 = F_281 ( V_56 , V_45 ) ;
if ( ! V_22 )
goto V_456;
V_56 = NULL ;
V_45 = NULL ;
V_451 = F_332 ( V_22 , true ) ;
if ( V_451 < 0 )
goto V_457;
if ( V_22 -> V_45 -> V_46 != V_47 )
V_28 = true ;
...
static T_11 F_343 ( struct V_450 * V_404 ,
const char * V_162 ,
T_6 V_373 )
{
if ( V_13 )
return - V_4 ;
return F_340 ( V_404 , V_162 , V_373 ) ;
}
static T_11 F_344 ( struct V_450 * V_404 ,
const char * V_162 ,
T_6 V_373 )
{
return F_340 ( V_404 , V_162 , V_373 ) ;
}
static void V_409 ( struct V_17 * V_18 )
{
struct V_21 * V_22 = F_263 ( V_18 ) ;
F_235 ( V_22 ) ;
F_139 ( V_317 , & V_22 -> V_32 ) ;
...
{
while ( V_22 -> V_266 ) {
struct V_21 * V_458 = V_22 ;
struct V_21 * V_459 = V_458 -> V_266 ;
struct V_21 * V_460 ;
while ( V_459 && ( V_460 = V_459 -> V_266 ) ) {
V_458 = V_459 ;
V_459 = V_460 ;
}
F_17 ( V_459 ) ;
...
static T_11 F_345 ( struct V_450 * V_404 ,
const char * V_162 ,
T_6 V_373 )
{
struct V_21 * V_22 = NULL ;
...
static T_11 F_350 ( struct V_450 * V_404 ,
const char * V_162 ,
T_6 V_373 )
{
if ( V_13 )
return - V_4 ;
return F_345 ( V_404 , V_162 , V_373 ) ;
}
static T_11 F_351 ( struct V_450 * V_404 ,
const char * V_162 ,
T_6 V_373 )
{
return F_345 ( V_404 , V_162 , V_373 ) ;
