...
V_2 -> V_67 . V_171 = V_170 ;
return 0 ;
}
static int F_47 ( struct V_187 * V_188 ,
const struct V_189 * V_190 )
{
struct V_61 * V_62 ;
int V_154 ;
V_62 = F_48 ( & V_188 -> V_9 , sizeof( struct V_61 ) ,
V_191 ) ;
if ( NULL == V_62 )
return - V_192 ;
F_49 ( V_188 , V_62 ) ;
V_62 -> V_176 = F_50 ( V_188 , & V_193 ) ;
if ( F_51 ( V_62 -> V_176 ) )
return F_52 ( V_62 -> V_176 ) ;
V_154 = F_53 ( & V_188 -> V_9 , & V_194 ,
V_195 , F_32 ( V_195 ) ) ;
return V_154 ;
}
static int F_54 ( struct V_187 * V_196 )
{
F_55 ( & V_196 -> V_9 ) ;
return 0 ;
}
