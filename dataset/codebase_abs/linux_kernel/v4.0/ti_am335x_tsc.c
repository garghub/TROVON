...
struct V_1 * V_8 )
{
struct V_85 * V_86 = V_84 -> V_57 . V_87 ;
int V_88 ;
if ( ! V_86 )
return - V_14 ;
...
V_88 = F_29 ( V_8 -> V_56 , F_16 ,
V_95 , V_84 -> V_57 . V_96 -> V_97 , V_8 ) ;
if ( V_88 ) {
F_28 ( & V_84 -> V_57 , L_12 ) ;
goto V_94;
}
...
V_8 -> V_35 * 2 + 2 - 1 ) ;
V_58 -> V_97 = L_14 ;
V_58 -> V_57 . V_101 = & V_84 -> V_57 ;
V_58 -> V_102 [ 0 ] = F_30 ( V_103 ) | F_30 ( V_104 ) ;
V_58 -> V_105 [ F_31 ( V_72 ) ] = F_30 ( V_72 ) ;
F_32 ( V_58 , V_78 , 0 , V_77 , 0 , 0 ) ;
F_32 ( V_58 , V_79 , 0 , V_77 , 0 , 0 ) ;
F_32 ( V_58 , V_73 , 0 , V_77 , 0 , 0 ) ;
V_88 = F_33 ( V_58 ) ;
if ( V_88 )
goto V_99;
F_34 ( V_84 , V_8 ) ;
...
static int F_42 ( struct V_107 * V_57 )
{
...
static int F_46 ( struct V_107 * V_57 )
{
struct V_1 * V_8 = F_43 ( V_57 ) ;
struct V_90 * V_91 ;
V_91 = F_25 ( F_44 ( V_57 ) ) ;
