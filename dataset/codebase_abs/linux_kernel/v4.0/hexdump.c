...
void F_9 ( const char * V_27 , const char * V_28 , int V_29 ,
int V_10 , int V_11 ,
...
break;
case V_34 :
F_11 ( L_7 , V_27 , V_28 , V_30 , V_12 ) ;
break;
default:
F_11 ( L_8 , V_27 , V_28 , V_12 ) ;
break;
}
}
}
void F_12 ( const char * V_28 , int V_29 ,
const void * V_8 , T_2 V_9 )
{
F_9 ( V_35 , V_28 , V_29 , 16 , 1 ,
V_8 , V_9 , true ) ;
}
