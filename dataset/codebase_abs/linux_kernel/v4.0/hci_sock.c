...
void F_19 ( struct V_26 * V_27 , struct V_6 * V_7 )
{
struct V_6 * V_28 = NULL ;
struct V_45 * V_46 ;
V_24 V_22 ;
...
V_28 = F_11 ( V_7 , V_55 , V_41 , true ) ;
if ( ! V_28 )
return;
V_46 = ( void * ) F_12 ( V_28 , V_55 ) ;
V_46 -> V_22 = V_22 ;
V_46 -> V_56 = F_21 ( V_27 -> V_57 ) ;
V_46 -> V_29 = F_21 ( V_7 -> V_29 ) ;
F_18 ( V_28 ) ;
F_15 ( V_28 ) ;
}
...
F_26 ( V_7 ) ;
V_46 = ( void * ) F_12 ( V_7 , V_55 ) ;
V_46 -> V_22 = V_22 ;
V_46 -> V_56 = F_21 ( V_27 -> V_57 ) ;
V_46 -> V_29 = F_21 ( V_7 -> V_29 - V_55 ) ;
return V_7 ;
}
...
if ( ! V_7 )
return;
V_46 = ( void * ) F_24 ( V_7 , V_75 ) ;
V_46 -> V_76 = V_77 ;
V_46 -> V_78 = sizeof( * V_74 ) + V_71 ;
...
{
int V_93 ;
F_103 ( sizeof( struct V_131 ) > sizeof( struct V_129 ) ) ;
V_93 = F_104 ( & V_211 , 0 ) ;
if ( V_93 < 0 )
return V_93 ;
V_93 = F_105 ( V_217 , & V_218 ) ;
if ( V_93 < 0 ) {
F_106 ( L_9 ) ;
goto error;
}
V_93 = F_107 ( & V_219 , L_10 , & V_30 , NULL ) ;
if ( V_93 < 0 ) {
F_106 ( L_11 ) ;
F_108 ( V_217 ) ;
goto error;
