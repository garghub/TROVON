...
V_284 -> V_310 = F_71 ( & V_152 -> V_311 -> V_9 , V_33 -> V_4 ,
V_164 , V_312 ) ;
V_284 -> V_313 = V_285 ;
V_284 -> V_314 = V_164 ;
V_284 -> V_315 = V_316 ;
...
T_3 V_262 ;
struct V_12 * V_12 ;
F_74 ( & V_152 -> V_311 -> V_9 , V_152 -> V_308 . V_309 -> V_310 ,
V_164 , V_312 ) ;
V_41 = F_35 ( V_33 ) -> V_41 ;
if ( ! V_41 ) {
F_9 ( L_70 ) ;
...
T_3 * V_358 ;
V_152 = F_31 ( V_9 ) ;
V_352 = F_81 ( & V_152 -> V_311 -> V_9 , V_359 ,
& V_152 -> V_360 , V_361 ) ;
if ( ! V_352 ) {
...
F_16 ( 0 , V_152 -> V_279 + V_363 ) ;
F_16 ( V_364 , V_152 -> V_279 + V_365 ) ;
F_16 ( V_366 >> 16 , V_152 -> V_279 + V_367 ) ;
F_16 ( V_152 -> V_179 , V_152 -> V_279 + V_368 ) ;
V_152 -> V_293 = V_152 -> V_111 + V_366 * V_152 -> V_113 ;
V_282 = V_152 -> V_293 ;
...
V_31 = V_369 * V_152 -> V_113 ;
F_16 ( V_31 >> 16 , V_152 -> V_279 + V_370 ) ;
...
V_31 = ( V_374 * V_152 -> V_113 ) & 0xffff ;
F_16 ( V_31 , V_152 -> V_279 + V_375 ) ;
F_16 ( V_31 + V_152 -> V_70 * sizeof( T_3 ) , V_152 -> V_279 + V_376 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_292 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_288 ) ;
V_31 = ( V_377 * V_152 -> V_113 ) & 0xffff ;
F_16 ( V_31 , V_152 -> V_279 + V_378 ) ;
F_16 ( V_31 + V_379 * sizeof( V_380 ) ,
V_152 -> V_279 + V_381 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_382 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_383 ) ;
V_152 -> V_275 . V_278 = F_61 ( V_152 -> V_279 + V_371 ) & 0xffff ;
V_152 -> V_275 . V_277 = F_61 ( V_152 -> V_279 + V_372 ) & 0xffff ;
V_152 -> V_275 . V_384 = F_61 ( V_152 -> V_279 + V_373 ) & 0xffff ;
V_152 -> V_275 . V_276 = F_61 ( V_152 -> V_279 + V_280 ) & 0xffff ;
V_152 -> V_275 . V_291 = F_61 ( V_152 -> V_279 + V_375 ) & 0xffff ;
V_152 -> V_275 . V_290 = F_61 ( V_152 -> V_279 + V_376 ) & 0xffff ;
V_152 -> V_275 . V_287 = F_61 ( V_152 -> V_279 + V_292 ) & 0xffff ;
V_152 -> V_275 . V_385 = F_61 ( V_152 -> V_279 + V_288 ) & 0xffff ;
F_47 (printk(L_84,
iadev->rfL.pcq_st, iadev->rfL.pcq_ed, iadev->rfL.pcq_rd,
iadev->rfL.pcq_wr);)
V_31 = V_112 * V_152 -> V_113 ;
F_16 ( ( V_31 >> 3 ) , V_152 -> V_279 + V_386 ) ;
V_354 = ( T_4 * ) ( V_152 -> V_111 + V_31 ) ;
V_355 = V_387 * V_152 -> V_113 ;
...
F_16 ( ( ( V_31 >> 3 ) & 0xfff8 ) | V_356 , V_152 -> V_279 + V_388 ) ;
V_346 = ( T_4 * ) ( V_152 -> V_111 + V_350 * V_152 -> V_113 ) ;
V_355 = V_389 * V_152 -> V_113 ;
for( V_31 = 0 ; V_31 < V_355 ; V_31 ++ )
{
* V_346 = ( V_31 << 6 ) | 15 ;
V_346 ++ ;
...
F_16 ( 0xff00 , V_152 -> V_279 + V_391 ) ;
F_16 ( 0 , V_152 -> V_279 + V_392 ) ;
F_16 ( 0x1 , V_152 -> V_279 + V_393 ) ;
F_16 ( 0xF6F8 , V_152 -> V_279 + V_394 ) ;
V_31 = ( V_355 >> 6 ) & 0xFF ;
V_355 += 2 * ( V_355 - 1 ) ;
V_31 |= ( ( V_355 << 2 ) & 0xFF00 ) ;
F_16 ( V_31 , V_152 -> V_279 + V_395 ) ;
for( V_31 = 0 ; V_31 < V_152 -> V_39 ; V_31 ++ )
...
F_83 ( & V_152 -> V_307 ) ;
V_152 -> V_396 = NULL ;
V_152 -> V_295 = F_84 ( 4 * V_152 -> V_70 , V_361 ) ;
if ( ! V_152 -> V_295 ) {
...
V_152 -> V_326 = 1 ;
V_152 -> V_329 = 0 ;
F_16 ( V_398 , V_152 -> V_279 + V_363 ) ;
return 0 ;
V_397:
F_85 ( & V_152 -> V_311 -> V_9 , V_359 , V_152 -> V_308 . V_318 ,
V_152 -> V_360 ) ;
V_362:
return - V_399 ;
}
...
F_74 ( & V_152 -> V_311 -> V_9 , V_283 -> V_310 , V_33 -> V_164 ,
V_406 ) ;
}
V_41 = F_35 ( V_33 ) -> V_41 ;
if ( ! V_41 ) {
...
V_152 -> V_450 = F_4 ( V_152 -> V_39 * sizeof( struct V_451 ) , V_361 ) ;
if ( ! V_152 -> V_450 ) {
...
{
struct V_340 * V_452 ;
V_452 = F_4 ( sizeof( * V_452 ) , V_361 | V_453 ) ;
if( ! V_452 ) {
F_9 (KERN_ERR DEV_LABEL L_102 ) ;
goto V_454;
}
V_152 -> V_450 [ V_31 ] . V_452 = V_452 ;
V_152 -> V_450 [ V_31 ] . V_286 = F_71 ( & V_152 -> V_311 -> V_9 ,
V_452 ,
sizeof( * V_452 ) ,
V_406 ) ;
}
V_152 -> V_18 = F_4 ( V_152 -> V_39 *
sizeof( struct V_5 ) , V_361 ) ;
if ( ! V_152 -> V_18 ) {
F_9 (KERN_ERR DEV_LABEL L_101 ) ;
goto V_455;
}
...
V_408 = (struct V_47 * ) V_152 -> V_49 ;
V_409 = (struct V_50 * ) V_152 -> V_52 ;
V_152 -> V_57 = F_4 ( sizeof( long ) * V_152 -> V_70 , V_361 ) ;
if ( ! V_152 -> V_57 ) {
F_9 ( L_109 ) ;
goto V_480;
}
...
F_74 ( & V_152 -> V_311 -> V_9 , V_274 -> V_286 ,
sizeof( * V_274 -> V_452 ) , V_406 ) ;
F_41 ( V_274 -> V_452 ) ;
}
F_41 ( V_152 -> V_450 ) ;
V_397:
F_85 ( & V_152 -> V_311 -> V_9 , V_359 , V_152 -> V_403 . V_318 ,
V_152 -> V_441 ) ;
V_362:
return - V_399 ;
}
...
static int F_107 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
unsigned long V_515 ;
void T_13 * V_516 ;
...
static int F_121 ( struct V_273 * V_9 )
{
T_2 * V_152 ;
int error ;
unsigned char V_195 ;
...
static int F_135 ( struct V_273 * V_9 , unsigned int V_592 , void T_15 * V_547 )
{
T_16 V_593 ;
T_2 * V_152 ;
int V_31 , V_594 ;
...
static int F_148 ( struct V_273 * V_9 , T_20 * V_642 , char * V_643 )
{
...
static int F_149 ( struct V_648 * V_649 , const struct V_650 * V_651 )
{
struct V_273 * V_9 ;
T_2 * V_152 ;
int V_410 ;
V_152 = F_84 ( sizeof( * V_152 ) , V_361 ) ;
if ( ! V_152 ) {
V_410 = - V_399 ;
goto V_362;
}
...
static void F_155 ( struct V_648 * V_649 )
{
