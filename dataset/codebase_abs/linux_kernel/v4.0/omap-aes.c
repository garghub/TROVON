...
V_57 -> V_124 . V_125 = sizeof( struct V_106 ) ;
return 0 ;
}
...
static T_4 F_91 ( int V_126 , void * V_127 )
{
struct V_1 * V_2 = V_127 ;
T_1 V_128 , V_13 ;
T_1 * V_112 , * V_113 ;
V_128 = F_1 ( V_2 , F_92 ( V_2 ) ) ;
if ( V_128 & V_129 ) {
F_3 ( V_2 , F_40 ( V_2 ) , 0x0 ) ;
F_72 ( ! V_2 -> V_58 ) ;
F_72 ( F_93 ( V_130 ) > V_2 -> V_58 -> V_28 ) ;
V_112 = F_76 ( V_2 -> V_58 ) + F_93 ( V_130 ) ;
for ( V_13 = 0 ; V_13 < V_131 ; V_13 ++ ) {
F_3 ( V_2 , F_42 ( V_2 , V_13 ) , * V_112 ) ;
F_35 ( & V_2 -> V_69 , 4 ) ;
if ( V_2 -> V_58 -> V_28 == F_93 ( V_130 ) ) {
...
struct V_134 * V_44 , struct V_135 * V_136 )
{
struct V_137 * V_138 = V_44 -> V_139 ;
const struct V_140 * V_141 ;
int V_11 = 0 ;
V_141 = F_95 ( F_96 ( V_142 ) , V_44 ) ;
if ( ! V_141 ) {
F_29 ( V_44 , L_21 ) ;
V_11 = - V_84 ;
goto V_11;
}
V_11 = F_97 ( V_138 , 0 , V_136 ) ;
if ( V_11 < 0 ) {
F_29 ( V_44 , L_22 ) ;
V_11 = - V_84 ;
goto V_11;
...
struct V_143 * V_144 , struct V_135 * V_136 )
{
struct V_134 * V_44 = & V_144 -> V_44 ;
struct V_135 * V_145 ;
int V_11 = 0 ;
V_145 = F_99 ( V_144 , V_146 , 0 ) ;
if ( ! V_145 ) {
F_29 ( V_44 , L_23 ) ;
V_11 = - V_118 ;
goto V_11;
}
memcpy ( V_136 , V_145 , sizeof( * V_136 ) ) ;
V_145 = F_99 ( V_144 , V_147 , 0 ) ;
if ( ! V_145 ) {
F_29 ( V_44 , L_24 ) ;
V_11 = - V_118 ;
goto V_11;
...
static int F_100 ( struct V_143 * V_144 )
{
struct V_134 * V_44 = & V_144 -> V_44 ;
struct V_1 * V_2 ;
struct V_149 * V_150 ;
struct V_135 V_136 ;
int V_11 = - V_40 , V_13 , V_151 , V_126 = - 1 ;
T_1 V_152 ;
V_2 = F_101 ( V_44 , sizeof( struct V_1 ) , V_153 ) ;
if ( V_2 == NULL ) {
F_29 ( V_44 , L_26 ) ;
goto V_154;
}
...
F_102 ( V_144 , V_2 ) ;
F_103 ( & V_2 -> V_108 ) ;
F_104 ( & V_2 -> V_109 , V_155 ) ;
V_11 = ( V_44 -> V_139 ) ? F_94 ( V_2 , V_44 , & V_136 ) :
F_98 ( V_2 , V_144 , & V_136 ) ;
if ( V_11 )
goto V_156;
V_2 -> V_4 = F_105 ( V_44 , & V_136 ) ;
if ( F_106 ( V_2 -> V_4 ) ) {
V_11 = F_107 ( V_2 -> V_4 ) ;
goto V_156;
}
...
F_18 ( V_2 ) ;
V_152 = F_1 ( V_2 , F_109 ( V_2 ) ) ;
F_90 ( V_44 ) ;
F_110 ( V_44 , L_27 ,
( V_152 & V_2 -> V_29 -> V_157 ) >> V_2 -> V_29 -> V_158 ,
( V_152 & V_2 -> V_29 -> V_159 ) >> V_2 -> V_29 -> V_160 ) ;
F_111 ( & V_2 -> V_39 , F_75 , ( unsigned long ) V_2 ) ;
F_111 ( & V_2 -> V_117 , F_78 , ( unsigned long ) V_2 ) ;
V_11 = F_25 ( V_2 ) ;
...
F_115 ( & V_2 -> V_162 ) ;
F_116 ( & V_37 ) ;
F_117 ( & V_2 -> V_162 , & V_163 ) ;
F_118 ( & V_37 ) ;
for ( V_13 = 0 ; V_13 < V_2 -> V_29 -> V_164 ; V_13 ++ ) {
for ( V_151 = 0 ; V_151 < V_2 -> V_29 -> V_165 [ V_13 ] . V_166 ; V_151 ++ ) {
V_150 = & V_2 -> V_29 -> V_165 [ V_13 ] . V_167 [ V_151 ] ;
F_50 ( L_30 , V_150 -> V_168 ) ;
F_115 ( & V_150 -> V_169 ) ;
V_11 = F_119 ( V_150 ) ;
if ( V_11 )
goto V_170;
...
for ( V_151 = V_2 -> V_29 -> V_165 [ V_13 ] . V_171 - 1 ; V_151 >= 0 ; V_151 -- )
F_120 (
& V_2 -> V_29 -> V_165 [ V_13 ] . V_167 [ V_151 ] ) ;
if ( ! V_2 -> V_68 )
F_32 ( V_2 ) ;
V_161:
F_121 ( & V_2 -> V_39 ) ;
...
static int F_126 ( struct V_134 * V_44 )
{
F_90 ( V_44 ) ;
return 0 ;
}
static int F_127 ( struct V_134 * V_44 )
{
F_88 ( V_44 ) ;
return 0 ;
}
