...
static int F_43 ( struct V_110 * V_111 , const struct V_112 * V_113 ,
...
* V_114 = V_120 ;
* V_115 = 1 ;
V_118 = F_45 ( V_3 , V_121 , V_122 ) ;
V_116 [ 0 ] = F_46 ( V_123 [ V_118 ] [ 0 ] *
V_123 [ V_118 ] [ 1 ] * 3 / 2 ) ;
return 0 ;
}
static int F_47 ( struct V_124 * V_22 )
{
...
static int F_49 ( struct V_124 * V_22 )
{
...
static void F_50 ( struct V_124 * V_22 )
{
struct V_2 * V_3 = F_44 ( V_22 -> V_110 ) ;
struct V_1 * V_5 = F_39 ( V_22 , struct V_1 , V_22 ) ;
if ( V_22 -> V_103 == V_28 ) {
...
static void F_52 ( struct V_124 * V_22 )
{
struct V_1 * V_5 = F_39 ( V_22 , struct V_1 , V_22 ) ;
F_53 ( V_5 -> V_17 ) ;
}
static void F_54 ( struct V_124 * V_22 )
{
struct V_2 * V_3 = F_44 ( V_22 -> V_110 ) ;
struct V_1 * V_5 = F_39 ( V_22 , struct V_1 , V_22 ) ;
unsigned long V_4 = 0 ;
...
static int F_56 ( struct V_110 * V_111 , unsigned int V_127 )
{
struct V_2 * V_3 = F_44 ( V_111 ) ;
int V_128 ;
if ( ! V_3 -> V_60 )
...
F_36 ( V_3 , V_49 ) ;
if ( V_3 -> V_15 )
F_14 ( & V_3 -> V_15 -> V_22 , V_49 ) ;
F_60 ( & V_3 -> V_129 ) ;
}
static int F_63 ( struct V_63 * V_64 , const struct V_133 * V_134 )
{
...
V_140 = 0 ;
memset ( V_142 , 0 , 30 ) ;
F_67 ( V_60 , V_60 -> V_144 . V_150 , V_142 , 29 ) ;
F_65 ( L_104 , V_142 ) ;
...
F_65 ( L_108 , V_3 -> V_172 ) ;
V_3 -> V_109 = F_76 ( sizeof( V_3 -> V_174 ) , V_87 ) ;
if ( ! V_3 -> V_109 ) {
F_17 ( L_106 ) ;
V_138 = - V_88 ;
goto V_167;
...
V_138 = F_80 ( & V_64 -> V_91 , & V_3 -> V_107 ) ;
if ( V_138 ) {
F_17 ( L_111 , V_138 ) ;
goto V_176;
}
...
V_138 = F_81 ( & V_3 -> V_168 , V_177 , - 1 ) ;
if ( V_138 < 0 ) {
F_17 ( L_112 , V_138 ) ;
goto V_178;
}
F_66 ( L_113 , F_82 ( & V_3 -> V_168 ) ) ;
#ifdef F_9
V_3 -> V_12 = F_83 () ;
if ( ! V_3 -> V_12 ) {
V_138 = - V_88 ;
...
F_84 ( V_60 , V_3 -> V_180 , sizeof( V_3 -> V_180 ) ) ;
F_85 ( V_3 -> V_180 , L_114 , sizeof( V_3 -> V_180 ) ) ;
V_3 -> V_12 -> V_143 = L_115 ;
V_3 -> V_12 -> V_181 = V_3 -> V_180 ;
F_86 ( V_3 -> V_60 , & V_3 -> V_12 -> V_134 ) ;
V_3 -> V_12 -> V_91 . V_182 = & V_3 -> V_60 -> V_91 ;
V_3 -> V_12 -> V_183 [ 0 ] = F_87 ( V_184 ) ;
V_3 -> V_12 -> V_185 [ F_88 ( V_13 ) ] = F_87 ( V_13 ) ;
V_138 = F_89 ( V_3 -> V_12 ) ;
if ( V_138 ) {
F_90 ( V_3 -> V_12 ) ;
V_3 -> V_12 = NULL ;
