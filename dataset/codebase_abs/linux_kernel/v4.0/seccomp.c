...
static long F_88 ( unsigned int V_143 , unsigned int V_100 ,
const char T_4 * V_144 )
{
switch ( V_143 ) {
case V_145 :
if ( V_100 != 0 || V_144 != NULL )
return - V_22 ;
return F_78 () ;
case V_146 :
return F_83 ( V_100 , V_144 ) ;
default:
return - V_22 ;
}
}
