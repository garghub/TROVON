...
{
int V_5 ;
struct V_6 * V_107 = NULL ;
V_5 = F_15 ( V_2 , V_87 ,
V_108 , & V_107 ) ;
if ( V_5 < 0 )
goto exit;
if ( V_107 -> V_21 == 0 || V_107 -> V_21 > V_109 ) {
V_5 = - V_102 ;
goto exit;
}
V_28 = V_107 -> V_22 ;
...
memcpy ( V_111 -> V_115 , V_112 -> V_22 , V_112 -> V_21 ) ;
V_111 -> V_116 = V_112 -> V_22 [ 1 ] ;
V_111 -> V_117 = 1 ;
exit:
F_7 ( V_112 ) ;
return V_5 ;
...
struct V_110 * V_111 , T_1 V_118 ,
T_1 * V_75 , T_4 V_77 )
{
struct V_36 * V_10 = F_9 ( V_2 ) ;
V_10 -> V_119 . V_120 = V_111 -> V_120 ;
...
if ( V_5 < 0 )
return V_5 ;
V_5 = F_28 ( V_2 , V_121 , & V_21 ) ;
if ( V_5 < 0 )
return V_5 ;
V_111 -> V_122 =
F_35 ( V_104 ) ;
if ( V_111 -> V_122 == 0xffffffff )
return - V_102 ;
V_111 -> V_125 = V_99 ;
V_111 -> V_126 = V_104 ;
memcpy ( V_111 -> V_127 , V_121 , V_21 ) ;
V_111 -> V_128 = V_21 ;
}
break;
case V_88 :
...
if ( V_130 -> V_21 > 0 ) {
memcpy ( V_111 -> V_133 , V_130 -> V_22 ,
V_130 -> V_21 ) ;
V_111 -> V_134 = V_130 -> V_21 ;
if ( V_111 -> V_133 [ 0 ] == 0x01 &&
V_111 -> V_133 [ 1 ] == 0xfe )
V_111 -> V_122 =
V_78 ;
else
...
struct V_36 * V_10 = F_9 ( V_2 ) ;
F_20 ( V_71 L_4 , V_72 ,
V_111 -> V_136 , V_47 -> V_21 ) ;
switch ( V_111 -> V_136 ) {
case V_74 :
if ( V_111 -> V_122 == V_78 )
return F_40 ( V_2 , V_47 ) ;
* F_41 ( V_47 , 1 ) = 0x1a ;
return F_42 ( V_2 , V_111 -> V_136 ,
V_145 , V_47 -> V_22 ,
