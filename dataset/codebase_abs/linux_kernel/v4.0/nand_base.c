...
static void F_117 ( struct V_5 * V_6 , int V_166 )
{
if ( ! V_6 -> V_97 )
V_6 -> V_97 = 20 ;
if ( V_6 -> V_45 == NULL )
...
static void F_120 ( T_3 * V_269 , T_9 V_4 )
{
T_10 V_32 ;
V_269 [ V_4 - 1 ] = 0 ;
...
static T_4 F_122 ( T_4 V_270 , T_11 const * V_28 , T_9 V_4 )
{
int V_32 ;
while ( V_4 -- ) {
V_270 ^= * V_28 ++ << 8 ;
...
int V_4 ;
int V_32 ;
V_4 = F_111 ( V_28 -> V_277 ) * 16 ;
V_273 = F_124 ( V_4 , V_278 ) ;
if ( ! V_273 )
return - V_279 ;
V_6 -> V_45 ( V_2 , V_280 , 0 , - 1 ) ;
V_6 -> V_45 ( V_2 , V_103 ,
sizeof( * V_28 ) * V_28 -> V_281 , - 1 ) ;
V_6 -> V_127 ( V_2 , ( T_3 * ) V_273 , V_4 ) ;
if ( ( F_122 ( V_282 , ( ( T_3 * ) V_273 ) + 2 , V_4 - 2 )
!= F_111 ( V_273 -> V_270 ) ) ) {
F_2 ( L_21 ) ;
goto V_283;
}
...
if ( V_269 -> type == V_287 )
break;
V_276 += V_269 -> V_177 * 16 ;
}
if ( V_32 == V_285 ) {
F_2 ( L_24 ) ;
goto V_283;
}
V_131 = (struct V_275 * ) V_276 ;
if ( ! V_131 -> V_288 ) {
F_2 ( L_25 ) ;
goto V_283;
}
V_6 -> V_289 = V_131 -> V_290 ;
V_6 -> V_291 = 1 << V_131 -> V_288 ;
V_8 = 0 ;
V_283:
F_125 ( V_273 ) ;
return V_8 ;
}
static int F_126 ( struct V_1 * V_2 , int V_179 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
T_3 V_292 [ V_260 ] = { V_179 } ;
...
if ( F_111 ( V_28 -> V_297 ) < 1 )
return;
V_6 -> V_180 = V_295 -> V_298 ;
V_6 -> V_181 = F_126 ;
}
static int F_128 ( struct V_1 * V_2 , struct V_5 * V_6 ,
int * V_166 )
{
...
F_120 ( V_28 -> V_303 , sizeof( V_28 -> V_303 ) ) ;
F_120 ( V_28 -> V_304 , sizeof( V_28 -> V_304 ) ) ;
if ( ! V_2 -> V_305 )
V_2 -> V_305 = V_28 -> V_304 ;
V_2 -> V_37 = F_130 ( V_28 -> V_306 ) ;
V_2 -> V_36 = 1 << ( F_131 ( F_130 ( V_28 -> V_246 ) ) - 1 ) ;
V_2 -> V_36 *= V_2 -> V_37 ;
V_2 -> V_129 = F_111 ( V_28 -> V_307 ) ;
V_6 -> V_91 = 1 << ( F_131 ( F_130 ( V_28 -> V_308 ) ) - 1 ) ;
...
static int F_135 ( T_11 * V_321 , int V_322 , int V_323 )
{
int V_32 , V_299 ;
...
static int F_136 ( T_11 * V_321 , int V_322 )
{
int V_324 , V_323 ;
...
T_11 V_321 [ 8 ] , int * V_166 )
{
int V_329 , V_330 ;
V_6 -> V_310 = F_137 ( V_321 [ 2 ] ) ;
V_329 = V_321 [ 3 ] ;
V_330 = F_136 ( V_321 , 8 ) ;
if ( V_330 == 6 && V_321 [ 0 ] == V_331 &&
! F_139 ( V_6 ) && V_321 [ 5 ] != 0x00 ) {
...
V_329 >>= 2 ;
V_2 -> V_129 = ( 8 << ( V_329 & 0x01 ) ) *
( V_2 -> V_37 >> 9 ) ;
V_329 >>= 2 ;
V_2 -> V_36 = ( 64 * 1024 ) << ( V_329 & 0x03 ) ;
V_329 >>= 2 ;
* V_166 = ( V_329 & 0x01 ) ? V_44 : 0 ;
...
static void F_140 ( struct V_1 * V_2 , struct V_5 * V_6 ,
...
static inline bool F_142 ( struct V_335 * type )
{
return type -> V_330 ;
}
static bool F_143 ( struct V_1 * V_2 , struct V_5 * V_6 ,
struct V_335 * type , T_11 * V_321 , int * V_166 )
{
...
V_6 -> V_43 |= type -> V_43 ;
V_6 -> V_289 = F_144 ( type ) ;
V_6 -> V_291 = F_145 ( type ) ;
V_6 -> V_343 =
type -> V_343 ;
* V_166 = type -> V_43 & V_44 ;
if ( ! V_2 -> V_305 )
...
static struct V_335 * F_146 ( struct V_1 * V_2 ,
struct V_5 * V_6 ,
int * V_336 , int * V_344 ,
struct V_335 * type )
{
...
if ( F_142 ( type ) ) {
if ( F_143 ( V_2 , V_6 , type , V_321 , & V_166 ) )
goto V_348;
...
if ( F_128 ( V_2 , V_6 , & V_166 ) )
goto V_348;
if ( F_133 ( V_2 , V_6 , & V_166 ) )
goto V_348;
}
if ( ! type -> V_305 )
return F_147 ( - V_346 ) ;
...
V_166 = V_6 -> V_349 ( V_2 , V_6 , V_321 ) ;
} else if ( ! type -> V_337 ) {
F_138 ( V_2 , V_6 , V_321 , & V_166 ) ;
} else {
F_140 ( V_2 , V_6 , type , V_321 , & V_166 ) ;
}
V_6 -> V_43 |= type -> V_43 ;
...
F_129 ( L_33 ,
* V_336 , * V_344 ) ;
F_129 ( L_34 , V_351 [ V_345 ] . V_305 , V_2 -> V_305 ) ;
F_105 ( L_35 ,
( V_6 -> V_43 & V_44 ) ? 16 : 8 ,
V_166 ? 16 : 8 ) ;
return F_147 ( - V_11 ) ;
...
F_141 ( V_2 , V_6 , V_321 ) ;
V_6 -> V_38 = F_148 ( V_2 -> V_37 ) - 1 ;
V_6 -> V_39 = ( V_6 -> V_91 >> V_6 -> V_38 ) - 1 ;
V_6 -> V_353 = V_6 -> V_9 =
F_148 ( V_2 -> V_36 ) - 1 ;
if ( V_6 -> V_91 & 0xffffffff )
V_6 -> V_40 = F_148 ( ( unsigned ) V_6 -> V_91 ) - 1 ;
else {
V_6 -> V_40 = F_148 ( ( unsigned ) ( V_6 -> V_91 >> 32 ) ) ;
V_6 -> V_40 += 32 - 1 ;
}
V_6 -> V_50 = 8 ;
V_6 -> V_249 = F_103 ;
...
type -> V_305 ) ;
F_129 ( L_36 ,
( int ) ( V_6 -> V_91 >> 20 ) , F_139 ( V_6 ) ? L_37 : L_38 ,
V_2 -> V_36 >> 10 , V_2 -> V_37 , V_2 -> V_129 ) ;
return type ;
}
int F_149 ( struct V_1 * V_2 , int V_354 ,
struct V_335 * V_355 )
{
int V_32 , V_356 , V_357 ;
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_335 * type ;
F_117 ( V_6 , V_6 -> V_43 & V_44 ) ;
type = F_146 ( V_2 , V_6 , & V_356 ,
& V_357 , V_355 ) ;
if ( F_150 ( type ) ) {
if ( ! ( V_6 -> V_43 & V_358 ) )
F_105 ( L_39 ) ;
...
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_360 * V_131 = & V_6 -> V_131 ;
int V_361 , V_362 ;
if ( V_131 -> V_120 == 0 || V_6 -> V_291 == 0 )
return true ;
V_361 = ( V_2 -> V_37 * V_131 -> V_363 ) / V_131 -> V_120 ;
V_362 = ( V_2 -> V_37 * V_6 -> V_289 ) / V_6 -> V_291 ;
return V_361 >= V_362 && V_131 -> V_363 >= V_6 -> V_289 ;
}
...
! ( V_6 -> V_34 & V_366 ) ) ;
if ( ! ( V_6 -> V_43 & V_367 ) ) {
V_365 = F_155 ( sizeof( * V_365 ) + V_2 -> V_37
+ V_2 -> V_129 * 3 , V_278 ) ;
if ( ! V_365 )
return - V_279 ;
V_365 -> V_141 = ( T_3 * ) ( V_365 + 1 ) ;
V_365 -> V_143 = V_365 -> V_141 + V_2 -> V_129 ;
V_365 -> V_195 = V_365 -> V_143 + V_2 -> V_129 ;
V_6 -> V_140 = V_365 ;
} else {
if ( ! V_6 -> V_140 )
return - V_279 ;
...
if ( ! V_131 -> V_145 && ( V_131 -> V_58 != V_368 ) ) {
switch ( V_2 -> V_129 ) {
case 8 :
V_131 -> V_145 = & V_369 ;
break;
...
V_131 -> V_133 = F_157 (
V_131 -> V_363 * F_131 ( 8 * V_131 -> V_120 ) , 8 ) ;
V_131 -> V_7 = F_158 ( V_2 , V_131 -> V_120 , V_131 -> V_133 ,
& V_131 -> V_145 ) ;
if ( ! V_131 -> V_7 ) {
F_105 ( L_46 ) ;
F_14 () ;
...
&& V_32 < F_159 ( V_131 -> V_145 -> V_174 ) ; V_32 ++ )
...
V_2 -> type = F_139 ( V_6 ) ? V_385 : V_386 ;
...
V_2 -> V_407 = F_109 ;
V_2 -> V_408 = V_2 -> V_37 ;
V_2 -> V_409 = V_131 -> V_145 ;
V_2 -> V_410 = V_131 -> V_363 ;
V_2 -> V_411 = V_131 -> V_120 ;
if ( ! V_2 -> V_412 )
V_2 -> V_412 = F_157 ( V_2 -> V_410 * 3 , 4 ) ;
if ( V_6 -> V_43 & V_413 )
return 0 ;
return V_6 -> V_266 ( V_2 ) ;
}
int F_160 ( struct V_1 * V_2 , int V_354 )
{
int V_8 ;
if ( ! V_2 -> V_414 && F_161 () ) {
F_162 ( L_51 , V_10 ) ;
...
{
struct V_5 * V_6 = V_2 -> V_7 ;
if ( V_6 -> V_131 . V_58 == V_368 )
F_164 ( (struct V_415 * ) V_6 -> V_131 . V_7 ) ;
F_165 ( V_2 ) ;
F_125 ( V_6 -> V_66 ) ;
if ( ! ( V_6 -> V_43 & V_367 ) )
F_125 ( V_6 -> V_140 ) ;
