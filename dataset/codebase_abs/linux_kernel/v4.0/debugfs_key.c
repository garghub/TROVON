...
case V_22 :
case V_23 :
V_12 = F_5 ( & V_7 -> V_17 . V_24 . V_25 ) ;
V_13 = F_4 ( V_5 , sizeof( V_5 ) , L_4 ,
( V_26 ) ( V_12 >> 40 ) , ( V_26 ) ( V_12 >> 32 ) , ( V_26 ) ( V_12 >> 24 ) ,
( V_26 ) ( V_12 >> 16 ) , ( V_26 ) ( V_12 >> 8 ) , ( V_26 ) V_12 ) ;
break;
case V_27 :
case V_28 :
V_12 = F_5 ( & V_7 -> V_17 . V_29 . V_25 ) ;
V_13 = F_4 ( V_5 , sizeof( V_5 ) , L_4 ,
( V_26 ) ( V_12 >> 40 ) , ( V_26 ) ( V_12 >> 32 ) , ( V_26 ) ( V_12 >> 24 ) ,
( V_26 ) ( V_12 >> 16 ) , ( V_26 ) ( V_12 >> 8 ) , ( V_26 ) V_12 ) ;
break;
...
V_37 += F_4 ( V_37 , sizeof( V_5 ) + V_5 - V_37 ,
L_3 ,
V_7 -> V_17 . V_18 . V_40 [ V_38 ] . V_20 ,
V_7 -> V_17 . V_18 . V_40 [ V_38 ] . V_21 ) ;
V_13 = V_37 - V_5 ;
break;
case V_22 :
case V_23 :
for ( V_38 = 0 ; V_38 < V_36 + 1 ; V_38 ++ ) {
V_39 = V_7 -> V_17 . V_24 . V_41 [ V_38 ] ;
V_37 += F_4 ( V_37 , sizeof( V_5 ) + V_5 - V_37 ,
L_4 ,
...
case V_22 :
case V_23 :
V_13 = F_4 ( V_5 , sizeof( V_5 ) , L_5 , V_7 -> V_17 . V_24 . V_42 ) ;
break;
case V_27 :
case V_28 :
...
case V_33 :
case V_34 :
V_13 = F_4 ( V_5 , sizeof( V_5 ) , L_5 , V_7 -> V_17 . V_35 . V_42 ) ;
break;
default:
return 0 ;
}
...
{
struct V_6 * V_7 = V_1 -> V_8 ;
int V_38 , V_46 = 2 * V_7 -> V_10 . V_47 + 2 ;
char * V_5 = F_11 ( V_46 , V_48 ) ;
char * V_37 = V_5 ;
T_1 V_49 ;
if ( ! V_5 )
return - V_50 ;
for ( V_38 = 0 ; V_38 < V_7 -> V_10 . V_47 ; V_38 ++ )
V_37 += F_4 ( V_37 , V_46 + V_5 - V_37 , L_6 , V_7 -> V_10 . V_7 [ V_38 ] ) ;
V_37 += F_4 ( V_37 , V_46 + V_5 - V_37 , L_2 ) ;
V_49 = F_2 ( V_2 , V_3 , V_4 , V_5 , V_37 - V_5 ) ;
F_12 ( V_5 ) ;
return V_49 ;
}
