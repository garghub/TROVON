...
int F_90 ( struct V_89 * V_90 , unsigned int V_194 )
{
struct V_92 * V_195 ;
unsigned int V_196 ;
int V_49 = - V_36 ;
...
V_196 = F_91 ( V_90 ) ;
F_92 ( V_90 -> V_100 [ V_194 ] , V_196 ) ;
if ( V_90 -> V_100 [ V_194 ] != NULL ) {
V_49 = 0 ;
if ( F_93 ( V_90 -> V_199 <= V_194 ) ) {
if ( V_90 -> V_197 & V_200 )
F_94 ( & V_90 -> V_201 , V_3 ) ;
else
F_59 ( & V_90 -> V_201 ) ;
...
V_195 = F_53 ( V_90 , V_194 , V_6 ) ;
V_195 -> V_97 = V_98 ;
}
}
return V_49 ;
}
struct V_89 * F_96 ( unsigned int V_203 ,
enum V_204 V_3 )
{
struct V_89 * V_90 ;
unsigned int V_94 ;
...
V_94 = F_97 () ;
F_98 ( V_90 , F_99 ( F_100 ( * V_90 ) , V_100 [ V_94 ] ) ) ;
if ( V_90 == NULL )
return NULL ;
V_90 -> V_202 = V_203 ;
V_90 -> V_197 = V_3 ;
...
for ( V_6 = 0 ; V_6 < V_94 ; V_6 ++ )
if ( V_90 -> V_100 [ V_6 ] != NULL )
F_102 ( V_90 -> V_100 [ V_6 ] , V_196 ) ;
if ( V_90 -> V_129 != NULL )
F_102 ( V_90 -> V_129 , V_90 -> V_202 *
sizeof( struct V_111 ) ) ;
F_102 ( V_90 , F_99 ( F_100 ( * V_90 ) , V_100 [ V_94 ] ) ) ;
}
void F_103 ( struct V_89 * V_90 )
{
struct V_92 * V_95 ;
int V_6 ;
int V_114 ;
...
static T_8 F_104 ( struct V_25 * V_25 ,
...
static void * F_105 ( struct V_50 * V_52 , T_10 * V_215 )
{
struct V_89 * V_90 = V_52 -> V_214 ;
return ( * V_215 < V_90 -> V_202 ) ? V_215 : NULL ;
}
static void F_106 ( struct V_50 * V_52 , void * V_216 )
{
}
static void * F_107 ( struct V_50 * V_52 , void * V_216 , T_10 * V_215 )
{
( * V_215 ) ++ ;
return F_105 ( V_52 , V_215 ) ;
}
static int F_108 ( struct V_50 * V_52 , void * V_216 )
{
struct V_89 * V_90 = V_52 -> V_214 ;
struct V_111 * V_217 ;
struct V_92 V_218 ;
...
F_109 ( & V_161 ) ;
V_49 = F_28 ( V_52 , L_65 ,
L_66 , V_161 . V_220 , ( unsigned long ) V_161 . V_221 ) ;
if ( V_49 < 0 )
return V_49 ;
}
V_217 = & V_90 -> V_129 [ V_91 ] ;
F_51 ( V_90 , V_91 , & V_218 ) ;
if ( V_218 . V_96 == 0 )
goto V_48;
V_49 = F_28 ( V_52 , L_67 , V_217 -> V_222 ,
V_218 . V_96 , V_217 -> V_135 ) ;
if ( V_49 < 0 )
goto V_48;
if ( ( V_217 -> V_223 & V_224 ) && ( V_218 . V_96 > 0 ) ) {
V_49 = F_28 ( V_52 , L_68 ,
V_218 . V_97 , V_218 . V_102 , V_218 . V_101 ) ;
if ( V_49 < 0 )
goto V_48;
if ( V_217 -> V_223 & V_225 )
V_49 = F_28 ( V_52 , L_69 , V_218 . V_103 ) ;
if ( V_49 < 0 )
goto V_48;
}
V_49 = F_28 ( V_52 , L_53 ) ;
...
static int F_110 ( struct V_24 * V_24 , struct V_25 * V_25 )
{
struct V_50 * V_212 ;
int V_49 ;
V_49 = F_111 ( V_25 , & V_226 ) ;
if ( V_49 )
return V_49 ;
V_212 = V_25 -> V_213 ;
V_212 -> V_214 = F_112 ( V_24 ) ;
return 0 ;
}
int F_113 ( struct V_26 * V_27 , const char * V_28 ,
struct V_89 * V_90 )
{
struct V_26 * V_39 ;
F_23 ( V_27 != NULL ) ;
...
void F_114 ( struct V_89 * V_90 , int V_228 ,
...
V_112 -> V_222 = V_28 ;
V_112 -> V_135 = V_230 ;
V_231 = F_52 ( V_90 , V_99 , & V_3 ) ;
for ( V_6 = 0 ; V_6 < V_231 ; ++ V_6 ) {
if ( V_90 -> V_100 [ V_6 ] == NULL )
continue;
V_95 = F_53 ( V_90 , V_6 , V_228 ) ;
V_95 -> V_96 = 0 ;
V_95 -> V_97 = V_98 ;
V_95 -> V_102 = 0 ;
V_95 -> V_103 = 0 ;
...
void F_115 ( int V_232 , struct V_89 * V_90 )
{
F_116 ( V_232 , V_90 , V_233 ) ;
F_116 ( V_232 , V_90 , V_234 ) ;
F_116 ( V_232 , V_90 , V_235 ) ;
F_116 ( V_232 , V_90 , V_236 ) ;
F_116 ( V_232 , V_90 , V_237 ) ;
F_116 ( V_232 , V_90 , V_238 ) ;
F_116 ( V_232 , V_90 , V_239 ) ;
F_116 ( V_232 , V_90 , V_240 ) ;
F_116 ( V_232 , V_90 , V_241 ) ;
F_116 ( V_232 , V_90 , V_242 ) ;
F_116 ( V_232 , V_90 , V_243 ) ;
F_116 ( V_232 , V_90 , V_244 ) ;
F_116 ( V_232 , V_90 , V_245 ) ;
F_116 ( V_232 , V_90 , V_246 ) ;
F_116 ( V_232 , V_90 , V_247 ) ;
F_116 ( V_232 , V_90 , V_248 ) ;
F_116 ( V_232 , V_90 , V_249 ) ;
F_116 ( V_232 , V_90 , V_250 ) ;
F_116 ( V_232 , V_90 , V_251 ) ;
F_116 ( V_232 , V_90 , V_252 ) ;
F_116 ( V_232 , V_90 , V_253 ) ;
F_116 ( V_232 , V_90 , V_254 ) ;
F_116 ( V_232 , V_90 , V_255 ) ;
F_116 ( V_232 , V_90 , V_256 ) ;
F_116 ( V_232 , V_90 , V_257 ) ;
F_116 ( V_232 , V_90 , V_258 ) ;
F_116 ( V_232 , V_90 , V_259 ) ;
F_116 ( V_232 , V_90 , V_260 ) ;
F_116 ( V_232 , V_90 , V_261 ) ;
F_116 ( V_232 , V_90 , V_262 ) ;
F_116 ( V_232 , V_90 , V_263 ) ;
F_116 ( V_232 , V_90 , V_264 ) ;
F_116 ( V_232 , V_90 , V_265 ) ;
F_116 ( V_232 , V_90 , V_266 ) ;
F_116 ( V_232 , V_90 , V_267 ) ;
F_116 ( V_232 , V_90 , V_268 ) ;
F_116 ( V_232 , V_90 , V_269 ) ;
F_116 ( V_232 , V_90 , V_270 ) ;
F_116 ( V_232 , V_90 , V_271 ) ;
F_116 ( V_232 , V_90 , V_272 ) ;
F_116 ( V_232 , V_90 , V_273 ) ;
F_116 ( V_232 , V_90 , V_274 ) ;
F_116 ( V_232 , V_90 , V_275 ) ;
F_116 ( V_232 , V_90 , V_276 ) ;
F_116 ( V_232 , V_90 , V_277 ) ;
F_116 ( V_232 , V_90 , V_278 ) ;
F_116 ( V_232 , V_90 , V_279 ) ;
}
int F_117 ( struct V_58 * V_59 , unsigned V_232 )
{
struct V_89 * V_90 ;
unsigned int V_280 ;
int V_49 , V_6 ;
...
F_82 ( V_90 -> V_129 [ V_6 ] . V_222 != NULL ,
L_71 ,
V_6 - V_232 ) ;
}
V_49 = F_113 ( V_59 -> V_177 , L_72 , V_90 ) ;
if ( V_49 < 0 ) {
F_83 ( & V_90 ) ;
} else {
V_59 -> V_281 = V_90 ;
...
void F_118 ( struct V_58 * V_59 )
{
if ( V_59 -> V_281 )
F_83 ( & V_59 -> V_281 ) ;
}
void F_119 ( int V_232 , struct V_89 * V_90 )
{
F_120 ( V_232 , V_90 , V_284 ) ;
F_120 ( V_232 , V_90 , V_285 ) ;
F_120 ( V_232 , V_90 , V_265 ) ;
F_120 ( V_232 , V_90 , V_286 ) ;
F_120 ( V_232 , V_90 , V_256 ) ;
F_120 ( V_232 , V_90 , V_287 ) ;
F_120 ( V_232 , V_90 , V_288 ) ;
F_120 ( V_232 , V_90 , V_260 ) ;
F_120 ( V_232 , V_90 , V_289 ) ;
F_120 ( V_232 , V_90 , V_290 ) ;
F_120 ( V_232 , V_90 , V_291 ) ;
F_120 ( V_232 , V_90 , rename ) ;
F_120 ( V_232 , V_90 , V_292 ) ;
F_120 ( V_232 , V_90 , V_258 ) ;
F_120 ( V_232 , V_90 , V_293 ) ;
F_120 ( V_232 , V_90 , V_294 ) ;
F_120 ( V_232 , V_90 , V_295 ) ;
F_120 ( V_232 , V_90 , V_296 ) ;
F_120 ( V_232 , V_90 , V_297 ) ;
F_120 ( V_232 , V_90 , V_298 ) ;
F_120 ( V_232 , V_90 , V_299 ) ;
F_120 ( V_232 , V_90 , V_300 ) ;
F_120 ( V_232 , V_90 , V_301 ) ;
F_120 ( V_232 , V_90 , V_302 ) ;
F_120 ( V_232 , V_90 , V_303 ) ;
F_120 ( V_232 , V_90 , V_304 ) ;
F_120 ( V_232 , V_90 , V_305 ) ;
F_120 ( V_232 , V_90 , V_306 ) ;
F_120 ( V_232 , V_90 , V_307 ) ;
F_120 ( V_232 , V_90 , V_308 ) ;
F_120 ( V_232 , V_90 , V_309 ) ;
F_120 ( V_232 , V_90 , V_310 ) ;
}
int F_121 ( struct V_58 * V_59 ,
unsigned V_232 )
{
struct V_89 * V_90 ;
unsigned int V_280 ;
...
V_49 = F_113 ( V_59 -> V_177 , L_74 , V_90 ) ;
if ( V_49 < 0 ) {
F_83 ( & V_90 ) ;
} else {
V_59 -> V_311 = V_90 ;
...
int F_126 ( struct V_186 * V_321 , struct V_322 * V_323 ,
struct V_324 * V_325 , void * V_29 )
{
struct V_326 * exp = F_127 ( V_321 , V_325 ) ;
struct V_50 * V_51 = (struct V_50 * ) V_29 ;
if ( exp -> V_327 )
F_28 ( V_51 , L_10 , F_128 ( & exp -> V_328 ) ) ;
return 0 ;
}
static int
F_129 ( struct V_50 * V_51 , void * V_329 )
{
struct V_179 * V_90 = (struct V_179 * ) V_51 -> V_214 ;
struct V_58 * V_59 = V_90 -> V_330 ;
F_130 ( V_59 -> V_331 , & V_90 -> V_123 ,
F_126 , V_51 ) ;
return 0 ;
}
int F_131 ( struct V_186 * V_321 , struct V_322 * V_323 ,
...
F_133 ( V_321 , V_29 -> V_51 ) ;
}
return 0 ;
}
static int
F_134 ( struct V_50 * V_51 , void * V_329 )
{
struct V_179 * V_90 = (struct V_179 * ) V_51 -> V_214 ;
struct V_58 * V_59 = V_90 -> V_330 ;
struct V_333 V_332 = {
...
int F_135 ( struct V_50 * V_51 , void * V_29 )
{
return F_28 ( V_51 , L_10 ,
L_82 ) ;
}
static int F_136 ( void * V_335 , void * V_29 )
{
struct V_179 * V_189 = V_335 ;
F_81 ( V_336 , L_83 , F_32 ( & V_189 -> V_184 ) ) ;
if ( F_32 ( & V_189 -> V_184 ) == 1 ) {
F_59 ( & V_189 -> V_330 -> V_337 ) ;
F_137 ( & V_189 -> V_192 , V_29 ) ;
F_62 ( & V_189 -> V_330 -> V_337 ) ;
return 1 ;
}
if ( V_189 -> V_183 )
F_103 ( V_189 -> V_183 ) ;
...
int F_138 ( struct V_25 * V_25 , const char * V_9 ,
unsigned long V_2 , void * V_29 )
{
struct V_58 * V_59 = (struct V_58 * ) V_29 ;
struct V_179 * V_180 ;
...
F_136 , & V_338 ) ;
while ( ! F_86 ( & V_338 ) ) {
V_180 = F_87 ( V_338 . V_191 , struct V_179 ,
V_192 ) ;
F_88 ( & V_180 -> V_192 ) ;
F_80 ( V_180 ) ;
}
...
int F_141 ( struct V_326 * exp , T_11 * V_123 , int * V_339 )
{
...
F_14 ( L_86 ,
F_61 ( * V_123 ) ) ;
V_49 = F_78 ( V_340 -> V_182 ) ;
V_340 -> V_182 = NULL ;
goto V_347;
}
V_39 = F_11 ( V_340 -> V_182 , L_87 ,
V_340 , & V_348 ) ;
if ( F_77 ( V_39 ) ) {
F_146 ( L_88 ) ;
V_49 = F_78 ( V_39 ) ;
...
* V_339 = 1 ;
F_59 ( & V_59 -> V_337 ) ;
F_147 ( & V_340 -> V_192 , & V_59 -> V_190 ) ;
F_62 ( & V_59 -> V_337 ) ;
return V_49 ;
V_347:
if ( V_340 -> V_182 != NULL )
F_20 ( & V_340 -> V_182 ) ;
F_89 ( V_59 -> V_188 , V_123 , & V_340 -> V_193 ) ;
V_345:
F_144 ( V_340 ) ;
F_84 ( V_340 ) ;
return V_49 ;
}
int F_148 ( struct V_326 * exp )
{
...
int F_150 ( struct V_50 * V_51 , long V_10 , int V_11 )
{
long V_12 , V_13 ;
V_12 = V_10 / V_11 ;
F_28 ( V_51 , L_4 , V_12 ) ;
...
F_28 ( V_51 , L_91 , V_13 / 10 ) ;
}
F_28 ( V_51 , L_53 ) ;
return 0 ;
}
int F_151 ( const char T_2 * V_9 , unsigned long V_2 ,
T_1 * V_10 )
{
return F_152 ( V_9 , V_2 , V_10 , 1 ) ;
}
int F_152 ( const char * V_9 , unsigned long V_2 ,
T_1 * V_10 , int V_11 )
{
...
static char * F_154 ( const char * V_364 , const char * V_365 , T_9 V_210 )
{
T_9 V_366 ;
V_366 = strlen ( V_365 ) ;
if ( ! V_366 )
...
char * F_155 ( const char * V_9 , const char * V_28 ,
T_9 * V_2 )
{
char * V_10 ;
T_9 V_367 = * V_2 ;
V_10 = F_154 ( V_9 , V_28 , V_367 ) ;
if ( V_10 == NULL )
return ( char * ) V_9 ;
V_10 += strlen ( V_28 ) ;
...
int F_157 ( struct V_58 * V_62 ,
const char * V_28 ,
T_3 V_33 ,
const struct V_30 * V_368 ,
void * V_29 )
{
return F_156 ( V_62 -> V_177 , V_28 ,
V_33 , V_368 , V_29 ) ;
}
void F_158 ( struct V_369 * V_370 , unsigned int V_371 )
{
if ( V_371 >= V_372 )
V_371 = V_372 - 1 ;
F_59 ( & V_370 -> V_373 ) ;
...
void F_159 ( struct V_369 * V_370 , unsigned int V_371 )
{
unsigned int V_10 ;
...
unsigned long F_160 ( struct V_369 * V_370 )
{
unsigned long V_7 = 0 ;
int V_6 ;
...
int F_162 ( struct V_50 * V_51 , void * V_29 )
{
struct V_58 * V_62 = V_29 ;
struct V_375 * V_81 = & V_62 -> V_80 . V_81 ;
int V_49 ;
F_163 ( & V_81 -> V_376 ) ;
V_49 = F_28 ( V_51 , L_9 , V_81 -> V_377 ) ;
F_164 ( & V_81 -> V_376 ) ;
return V_49 ;
}
