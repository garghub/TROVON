...
struct V_11 * F_18 ( char * type , char * V_19 , T_1 V_20 ,
struct V_21 * V_13 )
{
struct V_1 * V_2 ;
struct V_11 * V_11 ;
...
V_11 -> type = V_2 -> type ;
V_11 -> V_2 = V_2 ;
V_11 -> V_9 = V_2 -> V_22 ( V_19 , V_20 , V_13 ) ;
V_11 -> V_13 = V_13 ;
if ( ! V_11 -> V_9 ) {
F_21 ( L_5 , type ) ;
F_15 ( V_2 ) ;
...
int F_26 ( struct V_11 * V_11 , T_2 V_25 , T_1 V_20 ,
unsigned long * V_10 )
{
return V_11 -> V_2 -> malloc ( V_11 -> V_9 , V_25 , V_20 , V_10 ) ;
}
void F_27 ( struct V_11 * V_11 , unsigned long V_10 )
{
V_11 -> V_2 -> free ( V_11 -> V_9 , V_10 ) ;
}
int F_28 ( struct V_11 * V_11 , unsigned int V_26 ,
unsigned int * V_27 )
{
return V_11 -> V_2 -> V_28 ( V_11 -> V_9 , V_26 , V_27 ) ;
}
void * F_29 ( struct V_11 * V_11 , unsigned long V_10 ,
enum V_29 V_30 )
{
return V_11 -> V_2 -> V_31 ( V_11 -> V_9 , V_10 , V_30 ) ;
}
void F_30 ( struct V_11 * V_11 , unsigned long V_10 )
{
V_11 -> V_2 -> V_32 ( V_11 -> V_9 , V_10 ) ;
}
T_3 F_31 ( struct V_11 * V_11 )
{
return V_11 -> V_2 -> V_33 ( V_11 -> V_9 ) ;
}
