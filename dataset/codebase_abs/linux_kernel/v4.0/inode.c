...
return F_14 ( F_121 ( & V_45 -> V_160 ) ) ? - V_161 : 0 ;
}
...
F_9 ( L_60 ,
F_28 ( F_100 ( V_45 ) ) ,
F_28 ( V_45 -> V_120 . V_121 . V_162 ) ) ;
}
F_101 ( V_45 ) ;
F_123 ( & V_45 -> V_128 ) ;
}
struct V_9 * F_124 ( struct V_9 * V_163 , T_7 V_164 )
{
struct V_107 * V_108 = V_163 -> V_12 ;
struct V_10 * V_11 = V_108 -> V_13 ;
struct V_9 * V_9 ;
struct V_44 * V_45 ;
struct V_35 * V_14 ;
...
static int F_134 ( struct V_9 * V_9 , int V_169 )
{
struct V_44 * V_45 = F_36 ( V_9 ) ;
