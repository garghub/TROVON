...
if ( F_68 ( V_116 ) ) {
unsigned char V_159 = F_71 ( V_116 ) ;
...
struct V_22 * V_23 , struct V_182 * V_183 )
{
int V_184 ;
unsigned V_185 ;
unsigned V_186 ;
...
V_189 = V_191 ;
V_188 = V_192 ;
V_185 = V_116 -> V_155 . V_156 ;
V_186 = V_116 -> V_155 . V_193 ;
switch ( V_185 & V_194 ) {
case V_195 :
V_187 = V_196 ;
break;
...
F_2 ( & V_2 -> V_6 , L_74 , V_18 , V_184 ) ;
V_52 = F_75 ( V_23 , V_184 ) ;
V_92 = 0x0c ;
F_9 ( V_2 , V_126 , V_92 ) ;
if ( V_23 -> V_105 == false ) {
V_23 -> V_105 = true ;
...
V_116 -> V_155 . V_156 , F_80 ( V_116 -> V_155 . V_193 ) ) ;
F_2 ( & V_2 -> V_6 , L_79 , V_18 ,
V_183 -> V_156 , F_80 ( V_183 -> V_193 ) ) ;
F_77 ( V_116 , V_23 , V_183 ) ;
if ( ! V_23 -> V_109 ) {
...
static int F_81 ( struct V_115 * V_116 ,
...
return F_81 ( V_116 , V_230 ) ;
case V_232 :
F_2 ( & V_2 -> V_6 , L_82 , V_18 ) ;
return F_83 ( V_23 , V_230 ) ;
case V_233 :
...
static int F_85 ( struct V_91 * V_7 )
{
int V_95 , V_235 = 0 ;
T_2 * V_12 ;
T_1 V_27 = 0 , V_236 = 0 ;
...
{
T_5 V_242 = F_87 ( V_7 -> V_6 -> V_243 . V_244 ) ;
T_2 * V_12 ;
int V_245 ;
if ( V_242 == V_246 ||
V_242 == V_247 ) {
...
F_8 ( V_12 ) ;
V_57:
F_89 ( V_7 , ( void * ) ( unsigned long ) V_245 ) ;
return 0 ;
}
static int F_90 ( struct V_91 * V_7 )
{
int V_245 = ( unsigned long ) F_91 ( V_7 ) ;
int V_249 ;
