...
int F_21 ( struct V_3 * V_4 , int V_23 )
__acquires( &tcd->tc_lock
void F_22 ( struct V_3 * V_4 , int V_23 )
__releases( &tcd->tcd_lock
int F_23 ( struct V_3 * V_4 ,
struct V_24 * V_25 )
{
return V_4 -> V_15 == V_25 -> V_26 ;
}
void
...
void F_29 ( struct V_27 * V_52 , int V_55 ,
