...
if ( V_52 == V_57 ) {
if ( V_7 -> V_7 . V_24 . type == V_58 )
F_10 ( V_56 ) ;
else {
V_56 -> V_59 . V_60 = F_28 ( V_54 , NULL , 0 ) ;
F_29 ( & V_56 -> V_21 , & V_7 -> V_61 ) ;
}
} else if ( V_7 -> V_7 . V_24 . type == V_62 ) {
F_30 (trans, &u->transactions, list)
if ( V_56 -> V_59 . V_60 == V_7 -> V_7 . V_24 . V_63 )
break;
F_31 ( & V_56 -> V_21 == & V_7 -> V_61 ) ;
F_9 ( & V_56 -> V_21 ) ;
F_10 ( V_56 ) ;
}
F_2 ( & V_7 -> V_13 ) ;
...
{
struct V_32 * V_33 , * V_64 ;
char * V_36 , * V_35 ;
int V_65 , V_53 ;
F_20 ( V_48 ) ;
V_36 = V_7 -> V_7 . V_66 + sizeof( V_7 -> V_7 . V_24 ) ;
...
if ( V_4 == 0 )
goto V_26;
if ( V_4 > sizeof( V_7 -> V_7 . V_66 ) - V_7 -> V_4 ) {
V_7 -> V_4 = 0 ;
V_53 = - V_74 ;
goto V_26;
}
V_12 = F_37 ( V_7 -> V_7 . V_66 + V_7 -> V_4 , V_3 , V_4 ) ;
if ( V_12 != 0 ) {
V_53 = - V_25 ;
goto V_26;
}
...
goto V_26;
if ( ( sizeof( V_7 -> V_7 . V_24 ) + V_7 -> V_7 . V_24 . V_4 ) > sizeof( V_7 -> V_7 . V_66 ) ) {
V_53 = - V_75 ;
V_7 -> V_4 = 0 ;
goto V_26;
}
...
static int F_38 ( struct V_77 * V_77 , struct V_1 * V_2 )
{
struct V_6 * V_7 ;
if ( V_78 == 0 )
return - V_79 ;
...
static int F_43 ( struct V_77 * V_77 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_2 -> V_8 ;
struct V_55 * V_56 , * V_80 ;
struct V_32 * V_33 , * V_64 ;
struct V_9 * V_10 , * V_81 ;
...
static unsigned int F_45 ( struct V_1 * V_1 , T_6 * V_82 )
{
struct V_6 * V_7 = V_1 -> V_8 ;
F_46 ( V_1 , & V_7 -> V_19 , V_82 ) ;
if ( ! F_3 ( & V_7 -> V_15 ) )
return V_83 | V_84 ;
return 0 ;
}
