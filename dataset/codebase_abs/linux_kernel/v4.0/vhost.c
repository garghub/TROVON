...
F_120 ( & V_188 , V_189 , V_33 -> V_62 , V_22 , V_162 ) ;
F_115 () ;
V_185 = V_162 / sizeof V_35 ;
if ( F_107 ( V_185 > V_190 + 1 ) ) {
F_118 ( V_33 , L_5 ,
V_62 -> V_162 ) ;
return - V_121 ;
}
do {
unsigned V_191 = * V_184 + * V_183 ;
...
if ( F_107 ( F_121 ( & V_35 , sizeof( V_35 ) , & V_188 ) !=
sizeof( V_35 ) ) ) {
F_118 ( V_33 , L_8 ,
V_64 , ( T_8 ) F_119 ( V_33 , V_62 -> V_92 ) + V_64 * sizeof V_35 ) ;
return - V_25 ;
}
if ( F_107 ( V_35 . V_29 & F_106 ( V_33 , V_192 ) ) ) {
F_118 ( V_33 , L_9 ,
V_64 , ( T_8 ) F_119 ( V_33 , V_62 -> V_92 ) + V_64 * sizeof V_35 ) ;
return - V_25 ;
}
V_22 = F_113 ( V_33 , F_119 ( V_33 , V_35 . V_92 ) ,
F_117 ( V_33 , V_35 . V_162 ) , V_176 + V_191 ,
V_177 - V_191 ) ;
if ( F_107 ( V_22 < 0 ) ) {
F_118 ( V_33 , L_10 ,
V_22 , V_64 ) ;
...
int F_122 ( struct V_32 * V_33 ,
struct V_175 V_176 [] , unsigned int V_177 ,
unsigned int * V_183 , unsigned int * V_184 ,
struct V_171 * log , unsigned int * V_172 )
{
struct V_108 V_35 ;
unsigned int V_64 , V_194 , V_186 = 0 ;
T_12 V_38 ;
T_13 V_39 ;
T_13 V_195 ;
int V_22 ;
...
V_194 = F_112 ( V_33 , V_195 ) ;
if ( F_107 ( V_194 >= V_33 -> V_34 ) ) {
F_118 ( V_33 , L_16 ,
V_194 , V_33 -> V_34 ) ;
return - V_25 ;
}
...
V_22 = F_124 ( & V_35 , V_33 -> V_35 + V_64 , sizeof V_35 ) ;
if ( F_107 ( V_22 ) ) {
F_118 ( V_33 , L_19 ,
V_64 , V_33 -> V_35 + V_64 ) ;
return - V_117 ;
}
if ( V_35 . V_29 & F_106 ( V_33 , V_192 ) ) {
...
V_33 -> V_38 ++ ;
F_20 ( ! ( V_33 -> V_43 & V_196 ) ) ;
return V_194 ;
}
void F_125 ( struct V_32 * V_33 , int V_197 )
{
V_33 -> V_38 -= V_197 ;
}
int F_126 ( struct V_32 * V_33 , unsigned int V_194 , int V_162 )
{
struct V_198 V_63 = {
F_127 ( V_33 , V_194 ) ,
F_127 (vq, len)
} ;
return F_128 ( V_33 , & V_63 , 1 ) ;
}
static int F_129 ( struct V_32 * V_33 ,
struct V_198 * V_63 ,
unsigned V_185 )
{
struct V_198 T_6 * V_37 ;
T_12 V_199 , V_200 ;
int V_201 ;
V_201 = V_33 -> V_40 % V_33 -> V_34 ;
V_37 = V_33 -> V_37 -> V_113 + V_201 ;
if ( V_185 == 1 ) {
if ( F_105 ( V_63 [ 0 ] . V_202 , & V_37 -> V_202 ) ) {
F_118 ( V_33 , L_25 ) ;
return - V_117 ;
}
...
} else if ( F_130 ( V_37 , V_63 , V_185 * sizeof *V_37 ) ) {
F_118 ( V_33 , L_27 ) ;
return - V_117 ;
}
if ( F_107 ( V_33 -> V_44 ) ) {
...
V_199 = V_33 -> V_40 ;
V_200 = ( V_33 -> V_40 += V_185 ) ;
if ( F_107 ( ( T_12 ) ( V_200 - V_33 -> V_41 ) < ( T_12 ) ( V_200 - V_199 ) ) )
V_33 -> V_42 = false ;
return 0 ;
}
int F_128 ( struct V_32 * V_33 , struct V_198 * V_63 ,
unsigned V_185 )
{
int V_201 , V_197 , V_136 ;
V_201 = V_33 -> V_40 % V_33 -> V_34 ;
V_197 = V_33 -> V_34 - V_201 ;
if ( V_197 < V_185 ) {
V_136 = F_129 ( V_33 , V_63 , V_197 ) ;
if ( V_136 < 0 )
return V_136 ;
V_63 += V_197 ;
V_185 -= V_197 ;
}
V_136 = F_129 ( V_33 , V_63 , V_185 ) ;
F_100 () ;
...
static bool F_131 ( struct V_20 * V_21 , struct V_32 * V_33 )
{
T_14 V_199 , V_200 ;
T_13 V_203 ;
bool V_204 ;
...
return ! ( V_29 & F_106 ( V_33 , V_206 ) ) ;
}
V_199 = V_33 -> V_41 ;
V_204 = V_33 -> V_42 ;
V_200 = V_33 -> V_41 = V_33 -> V_40 ;
V_33 -> V_42 = true ;
if ( F_107 ( ! V_204 ) )
return true ;
if ( F_111 ( V_203 , F_133 ( V_33 ) ) ) {
F_118 ( V_33 , L_30 ) ;
return true ;
}
return F_134 ( F_112 ( V_33 , V_203 ) , V_200 , V_199 ) ;
}
void F_135 ( struct V_20 * V_21 , struct V_32 * V_33 )
{
if ( V_33 -> V_51 && F_131 ( V_21 , V_33 ) )
F_102 ( V_33 -> V_51 , 1 ) ;
}
void F_136 ( struct V_20 * V_21 ,
struct V_32 * V_33 ,
unsigned int V_194 , int V_162 )
{
F_126 ( V_33 , V_194 , V_162 ) ;
F_135 ( V_21 , V_33 ) ;
}
void F_137 ( struct V_20 * V_21 ,
struct V_32 * V_33 ,
struct V_198 * V_63 , unsigned V_185 )
{
F_128 ( V_33 , V_63 , V_185 ) ;
F_135 ( V_21 , V_33 ) ;
}
bool F_138 ( struct V_20 * V_21 , struct V_32 * V_33 )
{
T_13 V_39 ;
int V_136 ;
if ( ! ( V_33 -> V_43 & V_196 ) )
...
void F_139 ( struct V_20 * V_21 , struct V_32 * V_33 )
{
int V_136 ;
if ( V_33 -> V_43 & V_196 )
return;
