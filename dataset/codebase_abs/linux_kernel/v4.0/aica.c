...
return - V_58 ;
V_28 = V_23 -> V_31 -> V_32 ;
V_43 = F_32 ( sizeof( struct V_44 ) , V_59 ) ;
if ( ! V_43 )
return - V_60 ;
V_43 -> V_61 = V_62 ;
V_43 -> V_63 = V_17 ;
...
{
struct V_27 * V_28 = V_23 -> V_31 -> V_32 ;
if ( ( V_23 -> V_30 ) -> V_72 == V_73 )
V_28 -> V_43 -> V_61 = V_74 ;
V_28 -> V_43 -> V_75 = V_23 -> V_30 -> V_76 ;
V_28 -> V_23 = V_23 ;
return 0 ;
}
...
int V_25 ;
V_25 =
F_46 ( V_28 -> V_82 , L_2 , V_80 , 1 , 0 ,
& V_31 ) ;
if ( F_19 ( V_25 < 0 ) )
return V_25 ;
V_31 -> V_32 = V_28 ;
strcpy ( V_31 -> V_83 , L_2 ) ;
F_47 ( V_31 , V_84 ,
& V_85 ) ;
V_25 =
F_48 ( V_31 ,
...
struct V_89 * V_90 )
{
V_90 -> V_91 . integer . V_91 [ 0 ] = 1 ;
return 0 ;
}
static int F_51 ( struct V_87 * V_88 ,
struct V_89 * V_90 )
{
if ( V_90 -> V_91 . integer . V_91 [ 0 ] == 1 )
return 0 ;
else
F_16 () ;
return 0 ;
...
V_93 -> type = V_94 ;
V_93 -> V_95 = 1 ;
V_93 -> V_91 . integer . V_96 = 0 ;
V_93 -> V_91 . integer . V_97 = 0xFF ;
return 0 ;
}
...
if ( F_19 ( ! V_28 -> V_43 ) )
return - V_98 ;
V_90 -> V_91 . integer . V_91 [ 0 ] = V_28 -> V_43 -> V_64 ;
return 0 ;
}
...
if ( F_19 ( ! V_28 -> V_43 ) )
return - V_98 ;
V_64 = V_90 -> V_91 . integer . V_91 [ 0 ] ;
if ( V_64 > 0xff )
return - V_79 ;
if ( F_19 ( V_28 -> V_43 -> V_64 == V_64 ) )
return 0 ;
V_28 -> V_43 -> V_64 = V_90 -> V_91 . integer . V_91 [ 0 ] ;
V_28 -> V_65 = V_90 -> V_91 . integer . V_91 [ 0 ] ;
F_9 ( V_42 ,
V_28 -> V_43 , sizeof( struct V_44 ) ) ;
return 1 ;
}
...
F_13 () ;
V_25 = F_56 ( & V_100 , L_3 , & V_101 -> V_102 ) ;
if ( F_19 ( V_25 ) )
return V_25 ;
F_11 () ;
F_9 ( 0 , V_100 -> V_56 , V_100 -> V_103 ) ;
F_12 () ;
F_57 ( V_100 ) ;
return V_25 ;
}
...
int V_25 ;
struct V_27 * V_28 ;
V_28 = F_32 ( sizeof( struct V_27 ) , V_59 ) ;
if ( F_19 ( ! V_28 ) )
return - V_60 ;
V_25 = F_65 ( & V_107 -> V_102 , V_109 , V_110 ,
V_111 , 0 , & V_28 -> V_82 ) ;
if ( F_19 ( V_25 < 0 ) ) {
F_36 ( V_28 ) ;
return V_25 ;
}
strcpy ( V_28 -> V_82 -> V_112 , L_4 ) ;
strcpy ( V_28 -> V_82 -> V_113 , V_110 ) ;
strcpy ( V_28 -> V_82 -> V_114 ,
L_5 ) ;
F_66 ( & ( V_28 -> V_47 ) , F_22 ) ;
V_25 = F_45 ( V_28 , 0 ) ;
if ( F_19 ( V_25 < 0 ) )
