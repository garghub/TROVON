...
if ( ! V_6 -> V_96 [ V_10 ] )
return - V_15 ;
V_6 -> V_95 [ V_10 ] = F_58 ( 0 , V_14 ) ;
if ( ! V_6 -> V_95 [ V_10 ] )
return - V_15 ;
F_59 ( V_6 -> V_95 [ V_10 ] , V_6 -> V_63 ,
F_60 ( V_6 -> V_63 , V_6 -> V_101 ) ,
V_6 -> V_96 [ V_10 ] , V_99 , F_21 , V_6 ) ;
}
return 0 ;
}
static int F_61 ( struct V_5 * V_6 , T_4 V_60 )
{
struct V_25 * V_7 = & V_6 -> V_26 -> V_7 ;
int V_13 ;
int V_10 ;
for ( V_10 = 0 ; V_10 < V_94 ; V_10 ++ ) {
V_13 = F_25 ( V_6 -> V_95 [ V_10 ] , V_60 ) ;
if ( V_13 < 0 ) {
F_23 ( V_7 , L_12 , V_13 ) ;
return V_13 ;
}
...
struct V_30 * V_31 = & V_28 -> V_35 [ V_102 ] ;
if ( V_31 -> V_37 )
F_14 ( & V_31 -> V_38 ) ;
}
F_7 ( & V_28 -> V_36 , V_12 ) ;
}
F_63 ( V_6 -> V_85 , ! V_6 -> V_78 ) ;
F_53 ( V_6 ) ;
}
static void F_64 ( struct V_103 * V_26 )
{
struct V_5 * V_6 = F_65 ( V_26 ) ;
F_62 ( V_6 ) ;
F_66 ( & V_26 -> V_7 ) ;
F_55 ( V_6 ) ;
}
static int F_67 ( struct V_103 * V_26 ,
...
V_6 -> V_63 = F_68 ( F_69 ( V_26 ) ) ;
V_6 -> V_26 = V_26 ;
F_70 ( V_26 , V_6 ) ;
F_71 ( & V_6 -> V_85 ) ;
for ( V_10 = 0 ; V_10 < V_54 ; V_10 ++ ) {
F_71 ( & V_6 -> V_29 [ V_10 ] . V_70 ) ;
F_72 ( & V_6 -> V_29 [ V_10 ] . V_36 ) ;
for ( V_102 = 0 ; V_102 < V_33 ; V_102 ++ )
F_73 ( & V_6 -> V_29 [ V_10 ] . V_35 [ V_102 ] . V_38 ) ;
}
F_72 ( & V_6 -> V_17 ) ;
F_72 ( & V_6 -> V_77 ) ;
F_74 ( & V_6 -> V_20 ) ;
...
V_13 = F_75 ( V_7 , V_114 , F_76 ( V_114 ) ) ;
if ( V_13 != 0 ) {
F_23 ( V_7 , L_14 ) ;
goto V_113;
}
...
static int F_77 ( struct V_103 * V_115 , T_6 V_116 )
{
struct V_5 * V_6 = F_65 ( V_115 ) ;
F_62 ( V_6 ) ;
return 0 ;
}
static int F_78 ( struct V_103 * V_115 )
{
struct V_5 * V_6 = F_65 ( V_115 ) ;
V_6 -> V_67 = false ;
return F_61 ( V_6 , V_117 ) ;
}
