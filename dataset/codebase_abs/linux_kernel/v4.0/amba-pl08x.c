...
V_44 = F_77 ( V_9 ) ;
if ( ! V_44 ) {
F_46 ( & V_24 -> V_29 -> V_30 , L_38 , V_123 ) ;
return NULL ;
}
if ( V_180 == V_185 ) {
V_56 = V_106 ;
...
static T_6 F_96 ( int V_221 , void * V_30 )
{
...
V_3 -> V_81 = F_101 ( V_232 , L_52 , V_75 ) ;
if ( ! V_3 -> V_81 ) {
F_53 ( V_3 ) ;
return - V_201 ;
}
...
static const char * F_105 ( enum V_236 V_82 )
{
switch ( V_82 ) {
case V_89 :
return L_57 ;
...
static int F_106 ( struct V_237 * V_238 , void * V_239 )
{
...
static int F_108 ( struct V_241 * V_241 , struct V_242 * V_242 )
{
return F_109 ( V_242 , F_106 , V_241 -> V_243 ) ;
}
...
static int F_113 ( struct V_247 * V_29 , const struct V_248 * V_31 )
{
struct V_23 * V_24 ;
const struct V_249 * V_8 = V_31 -> V_239 ;
T_1 V_250 ;
int V_13 = 0 ;
int V_75 ;
...
F_117 ( V_252 , V_24 -> memcpy . V_253 ) ;
V_24 -> memcpy . V_30 = & V_29 -> V_30 ;
V_24 -> memcpy . V_254 = F_60 ;
V_24 -> memcpy . V_255 = F_61 ;
V_24 -> memcpy . V_256 = F_80 ;
V_24 -> memcpy . V_257 = F_64 ;
V_24 -> memcpy . V_258 = F_65 ;
V_24 -> memcpy . V_259 = F_75 ;
V_24 -> memcpy . V_260 = F_90 ;
V_24 -> memcpy . V_261 = F_92 ;
V_24 -> memcpy . V_262 = F_93 ;
V_24 -> memcpy . V_263 = F_91 ;
V_24 -> memcpy . V_264 = V_265 ;
V_24 -> memcpy . V_266 = V_265 ;
V_24 -> memcpy . V_267 = F_118 ( V_268 ) ;
V_24 -> memcpy . V_269 = V_270 ;
F_117 ( V_271 , V_24 -> V_211 . V_253 ) ;
F_117 ( V_272 , V_24 -> V_211 . V_253 ) ;
V_24 -> V_211 . V_30 = & V_29 -> V_30 ;
V_24 -> V_211 . V_254 = F_60 ;
V_24 -> V_211 . V_255 = F_61 ;
V_24 -> V_211 . V_257 = F_64 ;
V_24 -> V_211 . V_258 = F_65 ;
V_24 -> V_211 . V_259 = F_75 ;
V_24 -> V_211 . V_273 = F_85 ;
V_24 -> V_211 . V_274 = F_89 ;
V_24 -> V_211 . V_260 = F_90 ;
V_24 -> V_211 . V_261 = F_92 ;
V_24 -> V_211 . V_262 = F_93 ;
V_24 -> V_211 . V_263 = F_91 ;
V_24 -> V_211 . V_264 = V_265 ;
V_24 -> V_211 . V_266 = V_265 ;
V_24 -> V_211 . V_267 = F_118 ( V_190 ) | F_118 ( V_185 ) ;
V_24 -> V_211 . V_269 = V_270 ;
V_24 -> V_11 = F_119 ( & V_29 -> V_30 ) ;
if ( ! V_24 -> V_11 ) {
F_46 ( & V_29 -> V_30 , L_73 ) ;
V_13 = - V_212 ;
goto V_275;
...
V_24 -> V_71 = V_277 ;
V_250 = V_72 * V_24 -> V_71 * sizeof( T_1 ) ;
V_24 -> V_121 = F_120 ( V_278 , & V_24 -> V_29 -> V_30 ,
V_250 , V_279 , 0 ) ;
if ( ! V_24 -> V_121 ) {
V_13 = - V_201 ;
goto V_280;
}
V_24 -> V_37 = F_121 ( V_29 -> V_281 . V_282 , F_122 ( & V_29 -> V_281 ) ) ;
if ( ! V_24 -> V_37 ) {
V_13 = - V_201 ;
goto V_283;
}
...
V_13 = F_123 ( V_29 -> V_221 [ 0 ] , F_96 , 0 , V_278 , V_24 ) ;
if ( V_13 ) {
F_46 ( & V_29 -> V_30 , L_74 ,
V_123 , V_29 -> V_221 [ 0 ] ) ;
goto V_284;
...
V_19 -> V_31 = V_75 ;
V_19 -> V_37 = V_24 -> V_37 + F_124 ( V_75 ) ;
V_19 -> V_21 = V_19 -> V_37 + V_8 -> V_286 ;
F_125 ( & V_19 -> V_78 ) ;
if ( V_8 -> V_219 ) {
T_1 V_20 ;
V_20 = F_8 ( V_19 -> V_21 ) ;
...
V_24 -> V_8 -> V_76 , false ) ;
if ( V_13 <= 0 ) {
F_126 ( & V_24 -> V_29 -> V_30 ,
L_81 ,
V_123 , V_13 ) ;
goto V_289;
}
V_13 = F_100 ( V_24 , & V_24 -> V_211 ,
V_24 -> V_11 -> V_290 , true ) ;
if ( V_13 < 0 ) {
F_126 ( & V_24 -> V_29 -> V_30 ,
L_82 ,
V_123 , V_13 ) ;
...
F_129 ( V_29 ) , V_24 -> V_8 -> V_28 ? L_86 : L_10 , F_130 ( V_29 ) ,
( unsigned long long ) V_29 -> V_281 . V_282 , V_29 -> V_221 [ 0 ] ) ;
return 0 ;
V_293:
F_131 ( & V_24 -> memcpy ) ;
V_292:
...
V_143 = F_137 ( & V_217 ) ;
if ( V_143 )
F_138 (KERN_WARNING DRIVER_NAME
L_87 ,
retval) ;
return V_143 ;
}
