...
break;
case V_137 :
if ( V_34 -> V_80 . V_138 == V_139 ) {
V_51 = F_28 ( F_11 ( V_49 -> V_140 ) ,
V_49 -> V_140 ) ;
if ( V_51 != 0 ) {
F_12 ( V_34 -> V_2 ,
L_9 ,
...
V_142 |
V_133 , 0 ) ;
F_31 ( F_11 ( V_49 -> V_140 ) ,
V_49 -> V_140 ) ;
break;
}
V_34 -> V_80 . V_138 = V_130 ;
return 0 ;
}
static int F_32 ( struct V_33 * V_34 )
{
struct V_48 * V_49 = F_10 ( V_34 ) ;
struct V_145 * V_146 = F_33 ( V_34 -> V_2 ) ;
int V_51 , V_50 ;
for ( V_50 = 0 ; V_50 < F_11 ( V_49 -> V_140 ) ; V_50 ++ )
V_49 -> V_140 [ V_50 ] . V_147 = V_148 [ V_50 ] ;
V_51 = F_34 ( V_34 -> V_2 , F_11 ( V_49 -> V_140 ) ,
V_49 -> V_140 ) ;
if ( V_51 != 0 ) {
...
F_27 ( V_34 , V_137 ) ;
F_31 ( F_11 ( V_49 -> V_140 ) , V_49 -> V_140 ) ;
return 0 ;
V_149:
F_31 ( F_11 ( V_49 -> V_140 ) , V_49 -> V_140 ) ;
return V_51 ;
}
static int F_35 ( struct V_166 * V_167 ,
const struct V_168 * V_169 )
{
struct V_48 * V_49 ;
int V_51 ;
V_49 = F_36 ( & V_167 -> V_2 , sizeof( struct V_48 ) ,
V_170 ) ;
if ( V_49 == NULL )
return - V_171 ;
V_49 -> V_141 = F_37 ( V_167 , & V_172 ) ;
if ( F_38 ( V_49 -> V_141 ) ) {
V_51 = F_39 ( V_49 -> V_141 ) ;
F_12 ( & V_167 -> V_2 , L_12 ,
V_51 ) ;
return V_51 ;
}
...
static int F_42 ( struct V_166 * V_175 )
{
F_43 ( & V_175 -> V_2 ) ;
return 0 ;
}
