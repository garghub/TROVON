...
return false ;
F_95 () ;
V_4 -> V_34 = F_96 ( 0 , ( void * ) V_4 -> V_6 , V_4 -> V_12 ) ;
F_97 () ;
...
static void F_101 ( void * V_95 , void * V_96 ,
struct V_3 * V_97 , int V_98 )
{
unsigned long * V_5 ;
unsigned long * V_67 = F_102 ( V_95 , V_99 ) ;
...
! ( V_4 -> V_21 & V_71 ) ) {
F_101 ( V_67 , F_2 ( V_67 + V_101 , V_68 ) ,
V_4 , 0 ) ;
V_67 += V_101 ;
F_60 ( & V_4 -> V_64 , V_21 ) ;
F_103 () ;
...
F_108 (area, &object->area_list, node)
F_101 ( ( void * ) V_47 -> V_67 ,
...
{
struct V_3 * V_4 , * V_45 ;
V_4 = F_110 ( V_62 . V_102 , F_111 ( * V_4 ) , V_62 ) ;
while ( & V_4 -> V_62 != & V_62 ) {
F_103 () ;
if ( ! F_98 () )
F_106 ( V_4 ) ;
V_45 = F_110 ( V_4 -> V_62 . V_102 , F_111 ( * V_4 ) ,
V_62 ) ;
F_112 ( & V_4 -> V_62 ) ;
F_24 ( V_4 ) ;
V_4 = V_45 ;
...
V_25 = V_23 ;
F_29 () ;
F_115 (object, &object_list, object_list) {
F_59 ( & V_4 -> V_64 , V_21 ) ;
#ifdef F_62
if ( F_58 ( & V_4 -> V_41 ) > 1 ) {
F_83 ( L_35 ,
...
F_32 () ;
F_101 ( V_104 , V_105 , NULL , 1 ) ;
F_101 ( V_106 , V_107 , NULL , 1 ) ;
#ifdef F_116
F_80 (i)
F_101 ( V_108 + F_117 ( V_7 ) ,
V_109 + F_117 ( V_7 ) , NULL , 1 ) ;
#endif
F_118 () ;
F_119 (i) {
unsigned long V_110 = F_120 ( V_7 ) ;
unsigned long V_111 = F_121 ( V_7 ) ;
unsigned long V_112 ;
...
static void * F_142 ( struct V_1 * V_2 , T_7 * V_129 )
{
struct V_3 * V_4 ;
T_7 V_130 = * V_129 ;
int V_131 ;
...
static void * F_145 ( struct V_1 * V_2 , void * V_132 , T_7 * V_129 )
{
struct V_3 * V_133 = V_132 ;
struct V_3 * V_134 = NULL ;
struct V_3 * V_135 = V_133 ;
++ ( * V_129 ) ;
F_146 (obj, &object_list, object_list) {
if ( F_17 ( V_135 ) ) {
V_134 = V_135 ;
break;
}
...
static void F_147 ( struct V_1 * V_2 , void * V_132 )
{
if ( ! F_78 ( V_132 ) ) {
F_32 () ;
F_136 ( & V_127 ) ;
...
static int F_148 ( struct V_1 * V_2 , void * V_132 )
{
...
static int F_149 ( struct V_136 * V_136 , struct V_137 * V_137 )
{
return F_150 ( V_137 , & V_138 ) ;
}
static int F_151 ( const char * V_139 )
{
unsigned long V_21 ;
struct V_3 * V_4 ;
unsigned long V_140 ;
if ( F_152 ( V_139 , 0 , & V_140 ) )
return - V_141 ;
V_4 = F_28 ( V_140 , 0 ) ;
if ( ! V_4 ) {
F_131 ( L_42 , V_140 ) ;
...
static T_8 F_154 ( struct V_137 * V_137 , const char T_9 * V_142 ,
V_13 V_12 , T_7 * V_143 )
{
char V_144 [ 64 ] ;
int V_145 ;
...
unsigned long V_149 ;
V_146 = F_152 ( V_144 + 5 , 0 , & V_149 ) ;
if ( V_146 < 0 )
goto V_66;
F_140 () ;
if ( V_149 ) {
V_126 = F_157 ( V_149 * 1000 ) ;
F_138 () ;
}
...
static void T_3 F_162 ( struct V_76 * log )
{
struct V_31 V_30 ;
V_30 . V_32 = log -> V_29 ;
V_30 . V_33 = log -> V_30 ;
...
#endif
V_24 = F_157 ( V_155 ) ;
V_126 = F_157 ( V_156 * 1000 ) ;
V_50 = F_165 ( V_3 , V_157 ) ;
V_49 = F_165 ( V_46 , V_157 ) ;
if ( V_78 >= F_74 ( V_76 ) )
F_38 ( L_57
L_58 , V_78 ) ;
F_75 ( V_21 ) ;
...
V_159 = F_167 ( L_40 , V_161 , NULL , NULL ,
& V_162 ) ;
if ( ! V_159 )
F_38 ( L_60 ) ;
F_135 ( & V_127 ) ;
