...
V_53 &= F_10 ( V_14 , V_60 [ V_54 ] [ 0 ] , V_60 [ V_54 ] [ 1 ] ) ;
} else {
for ( V_54 = 0 ; V_54 < V_61 ; V_54 ++ )
V_53 &= F_10 ( V_14 , V_62 [ V_54 ] [ 0 ] , V_62 [ V_54 ] [ 1 ] ) ;
for ( V_54 = 0 ; V_54 < V_63 ; V_54 ++ )
V_53 &= F_10 ( V_14 , V_64 [ V_54 ] [ 0 ] , V_64 [ V_54 ] [ 1 ] ) ;
F_12 ( V_41 + V_65 , 0x23 ) ;
...
V_53 &= F_10 ( V_14 , V_72 [ V_54 ] [ 0 ] , V_72 [ V_54 ] [ 1 ] ) ;
for ( V_54 = 0 ; V_54 < V_73 ; V_54 ++ )
V_53 &= F_10 ( V_14 , V_74 [ V_54 ] [ 0 ] , V_74 [ V_54 ] [ 1 ] ) ;
V_14 -> V_67 [ 0 ] = 0x1C ;
V_14 -> V_67 [ 1 ] = 0x10 ;
V_14 -> V_67 [ 2 ] = 0x0 ;
V_14 -> V_67 [ 3 ] = 0x0 ;
...
V_53 &= F_10 ( V_14 , V_77 [ V_54 ] [ 0 ] , V_77 [ V_54 ] [ 1 ] ) ;
for ( V_54 = 0 ; V_54 < V_73 ; V_54 ++ )
V_53 &= F_10 ( V_14 , V_74 [ V_54 ] [ 0 ] , V_74 [ V_54 ] [ 1 ] ) ;
F_5 ( V_41 + V_65 , 0x23 ) ;
F_6 ( V_41 , V_66 , F_13 ( 0 ) ) ;
