...
V_129 = ( V_160 << V_162 ) | ( V_161 << V_163 ) ;
F_18 ( V_129 , V_45 -> V_24 + V_164 ) ;
V_129 |= V_165 | V_166 ;
F_18 ( V_129 , V_45 -> V_24 + V_164 ) ;
F_89 ( V_45 , V_157 , V_158 ) ;
}
static bool F_90 ( struct V_167 * V_168 , void * V_169 )
{
struct V_170 * V_171 = V_169 ;
if ( V_171 -> V_172 != V_168 -> V_5 -> V_3 )
return false ;
V_168 -> V_173 = V_171 ;
return true ;
}
...
struct V_10 * V_11 , int V_28 )
{
struct V_2 * V_174 = V_9 -> V_3 ;
struct V_5 * V_3 = V_11 -> V_11 . V_3 ;
struct V_175 * V_176 ;
struct V_170 * V_177 , * V_178 ;
struct V_2 * V_172 ;
int V_96 ;
V_176 = F_92 ( V_3 , sizeof( * V_176 ) , V_179 ) ;
if ( ! V_176 )
return - V_19 ;
V_177 = F_92 ( V_3 , sizeof( * V_177 ) , V_179 ) ;
if ( ! V_177 )
return - V_19 ;
V_178 = F_92 ( V_3 , sizeof( * V_178 ) , V_179 ) ;
if ( ! V_178 )
return - V_19 ;
switch ( V_174 -> V_5 ) {
case V_180 :
...
V_178 -> V_186 = 1 ;
V_178 -> V_187 = 0 ;
V_176 -> V_188 . V_189 = 16 ;
V_177 -> V_186 = 1 ;
V_177 -> V_187 = 0 ;
V_176 -> V_190 . V_191 = 16 ;
V_172 = F_93 ( V_174 -> V_68 , F_94 ( F_95 ( V_174 -> V_192 ) , 0 ) ) ;
V_178 -> V_172 = & V_172 -> V_3 ;
V_177 -> V_172 = & V_172 -> V_3 ;
V_176 -> V_193 = F_90 ;
V_176 -> V_178 = V_178 ;
V_176 -> V_177 = V_177 ;
V_96 = F_51 ( V_9 , V_27 , V_11 , V_28 ) ;
V_11 -> V_11 . V_20 = V_21 ;
V_11 -> V_11 . type = V_194 ;
V_11 -> V_11 . V_30 = ( V_11 -> V_11 . V_30 | V_153 | V_154 ) ;
V_11 -> V_11 . V_195 = F_87 ;
V_11 -> V_11 . V_196 = 64 ;
V_11 -> V_197 = 64 ;
V_11 -> V_176 = V_176 ;
V_11 -> V_198 = V_199 | V_200 ;
F_18 ( V_201 , V_11 -> V_11 . V_24 + V_202 ) ;
return V_96 ;
}
static int
F_96 ( struct V_8 * V_9 ,
...
if ( V_28 < 4 ) {
V_121 = F_7 ( V_9 -> V_3 , 3 ) ;
V_204 = ( int ) ( V_121 + ( 0x8 * V_28 ) ) ;
}
F_14 ( V_174 , 0x24 , & V_206 [ 0 ] ) ;
F_14 ( V_174 , 0x20 , & V_206 [ 1 ] ) ;
F_14 ( V_174 , 0x1c , & V_206 [ 2 ] ) ;
V_22 = ( V_206 [ V_28 / 4 ] & 0xffffffe0 ) + ( V_28 % 4 ) * 8 ;
F_15 ( & V_174 -> V_3 , L_21 ,
V_207 , V_28 , V_22 , V_204 , V_205 ) ;
F_34 ( V_174 , V_205 + 0x00 , 0x01 ) ;
F_34 ( V_174 , V_205 + 0x01 , 0x33 ) ;
F_34 ( V_174 , V_205 + 0x04 , ( T_2 ) ( V_22 & 0xff ) ) ;
F_34 ( V_174 , V_205 + 0x05 , ( T_2 ) ( ( V_22 & 0xff00 ) >> 8 ) ) ;
F_34 ( V_174 , V_205 + 0x06 , V_174 -> V_208 ) ;
V_11 -> V_11 . V_20 = V_25 ;
V_11 -> V_11 . V_22 = V_22 ;
V_11 -> V_11 . V_23 = 0 ;
V_11 -> V_11 . V_24 = NULL ;
...
{
struct V_10 * V_210 = F_101 ( V_45 ) ;
F_102 ( V_210 ) ;
}
static unsigned int F_103 ( struct V_155 * V_45 , int V_13 )
{
struct V_10 * V_210 = F_101 ( V_45 ) ;
unsigned int V_123 ;
...
struct V_10 * V_11 , int V_28 )
{
V_11 -> V_11 . V_30 |= V_213 ;
V_11 -> V_11 . V_214 = F_103 ;
V_11 -> V_11 . V_215 = F_100 ;
return F_99 ( V_9 , V_27 , V_11 , V_28 ) ;
}
static int F_105 ( struct V_2 * V_3 )
{
#if F_106 ( V_216 ) || F_106 ( V_217 )
return - V_43 ;
#else
return 0 ;
#endif
...
F_26 ( 0x00 , V_45 + V_219 ) ;
F_26 ( V_220 , V_45 + V_221 ) ;
F_26 ( 128 , V_45 + V_222 ) ;
F_26 ( 128 , V_45 + V_223 ) ;
F_20 ( V_45 ) ;
return F_51 ( V_9 , V_27 , V_11 , V_28 ) ;
...
{
V_11 -> V_11 . V_30 |= V_154 ;
V_11 -> V_11 . type = V_228 ;
return F_51 ( V_9 , V_27 , V_11 , V_28 ) ;
}
static inline int F_112 ( T_1 V_229 , T_1 V_230 )
{
return V_229 == V_231 || V_229 == V_230 ;
}
static struct V_232 * F_113 ( struct V_2 * V_3 )
{
struct V_232 * V_233 ;
for ( V_233 = V_234 ; ; V_233 ++ )
if ( F_112 ( V_233 -> V_4 , V_3 -> V_4 ) &&
F_112 ( V_233 -> V_5 , V_3 -> V_5 ) &&
F_112 ( V_233 -> V_235 , V_3 -> V_6 ) &&
F_112 ( V_233 -> V_236 , V_3 -> V_7 ) )
break;
return V_233 ;
}
static inline int F_114 ( struct V_2 * V_3 ,
const struct V_26 * V_27 )
{
if ( V_27 -> V_30 & V_237 )
return 0 ;
...
static int
F_115 ( struct V_2 * V_3 , struct V_26 * V_27 )
{
const struct V_238 * V_239 ;
int V_240 , V_241 , V_242 = - 1 , V_61 ;
if ( ( ( ( V_3 -> V_85 >> 8 ) != V_243 ) &&
( ( V_3 -> V_85 >> 8 ) != V_244 ) ) ||
( V_3 -> V_85 & 0xff ) > 6 )
return - V_43 ;
for ( V_239 = V_245 ;
V_239 < V_245 + F_40 ( V_245 ) ;
V_239 ++ ) {
if ( V_3 -> V_4 == V_239 -> V_4 &&
V_3 -> V_5 == V_239 -> V_5 )
return - V_43 ;
}
V_240 = V_241 = 0 ;
for ( V_61 = 0 ; V_61 < V_15 ; V_61 ++ ) {
if ( F_5 ( V_3 , V_61 ) & V_246 ) {
V_241 ++ ;
if ( V_242 == - 1 )
V_242 = V_61 ;
}
...
static inline int
F_116 ( const struct V_26 * V_27 ,
const struct V_26 * V_247 )
{
return
V_27 -> V_80 == V_247 -> V_80 &&
V_27 -> V_248 == V_247 -> V_248 &&
V_27 -> V_31 == V_247 -> V_31 &&
V_27 -> V_32 == V_247 -> V_32 &&
V_27 -> V_29 == V_247 -> V_29 ;
}
struct V_8 *
F_117 ( struct V_2 * V_3 , const struct V_26 * V_27 )
{
struct V_10 V_249 ;
struct V_8 * V_9 ;
struct V_232 * V_233 ;
...
V_9 = F_119 ( sizeof( struct V_8 ) +
sizeof( unsigned int ) * V_250 ,
V_179 ) ;
if ( ! V_9 ) {
V_9 = F_118 ( - V_19 ) ;
goto V_253;
...
V_249 . V_11 . V_30 = V_254 | V_255 | V_256 ;
V_249 . V_11 . V_147 = V_27 -> V_248 * 16 ;
V_249 . V_11 . V_208 = F_114 ( V_3 , V_27 ) ;
V_249 . V_11 . V_3 = & V_3 -> V_3 ;
for ( V_61 = 0 ; V_61 < V_250 ; V_61 ++ ) {
if ( V_233 -> V_257 ( V_9 , V_27 , & V_249 , V_61 ) )
break;
F_15 ( & V_3 -> V_3 , L_23 ,
V_249 . V_11 . V_22 , V_249 . V_11 . V_208 , V_249 . V_11 . V_20 ) ;
V_9 -> line [ V_61 ] = F_120 ( & V_249 ) ;
if ( V_9 -> line [ V_61 ] < 0 ) {
F_2 ( & V_3 -> V_3 ,
L_24 ,
V_249 . V_11 . V_22 , V_249 . V_11 . V_208 ,
V_249 . V_11 . V_20 , V_9 -> line [ V_61 ] ) ;
break;
}
}
V_9 -> V_258 = V_61 ;
...
struct V_232 * V_233 ;
int V_61 ;
for ( V_61 = 0 ; V_61 < V_9 -> V_258 ; V_61 ++ )
F_122 ( V_9 -> line [ V_61 ] ) ;
for ( V_61 = 0 ; V_61 < V_15 ; V_61 ++ ) {
if ( V_9 -> V_18 [ V_61 ] )
F_20 ( V_9 -> V_18 [ V_61 ] ) ;
...
F_125 ( V_9 -> line [ V_61 ] ) ;
if ( V_9 -> V_233 -> exit )
V_9 -> V_233 -> exit ( V_9 -> V_3 ) ;
}
void F_126 ( struct V_8 * V_9 )
{
int V_61 ;
if ( V_9 -> V_233 -> V_251 )
V_9 -> V_233 -> V_251 ( V_9 -> V_3 ) ;
for ( V_61 = 0 ; V_61 < V_9 -> V_258 ; V_61 ++ )
if ( V_9 -> line [ V_61 ] >= 0 )
F_127 ( V_9 -> line [ V_61 ] ) ;
}
static int
F_128 ( struct V_2 * V_3 , const struct V_238 * V_259 )
{
struct V_232 * V_233 ;
struct V_8 * V_9 ;
const struct V_26 * V_27 ;
...
V_233 = F_113 ( V_3 ) ;
if ( V_233 -> V_260 ) {
V_33 = V_233 -> V_260 ( V_3 ) ;
if ( V_33 )
return V_33 ;
}
if ( V_259 -> V_261 >= F_40 ( V_262 ) ) {
F_2 ( & V_3 -> V_3 , L_25 ,
V_259 -> V_261 ) ;
return - V_16 ;
}
V_27 = & V_262 [ V_259 -> V_261 ] ;
V_33 = F_129 ( V_3 ) ;
F_130 ( V_3 ) ;
if ( V_33 )
return V_33 ;
if ( V_259 -> V_261 == V_263 ) {
memcpy ( & V_146 , V_27 , sizeof( struct V_26 ) ) ;
V_27 = & V_146 ;
V_33 = F_115 ( V_3 , & V_146 ) ;
if ( V_33 )
goto V_264;
} else {
memcpy ( & V_146 , & V_262 [ V_263 ] ,
sizeof( struct V_26 ) ) ;
V_33 = F_115 ( V_3 , & V_146 ) ;
if ( V_33 == 0 && F_116 ( V_27 , & V_146 ) )
F_1 ( L_26 ,
V_3 ) ;
}
V_9 = F_117 ( V_3 , V_27 ) ;
...
{
struct V_8 * V_9 = F_136 ( V_3 ) ;
F_121 ( V_9 ) ;
F_134 ( V_3 ) ;
}
static int F_137 ( struct V_2 * V_3 , T_5 V_265 )
{
struct V_8 * V_9 = F_136 ( V_3 ) ;
if ( V_9 )
F_124 ( V_9 ) ;
F_130 ( V_3 ) ;
F_138 ( V_3 , F_139 ( V_3 , V_265 ) ) ;
return 0 ;
}
...
static T_6 F_142 ( struct V_2 * V_3 ,
T_7 V_265 )
{
struct V_8 * V_9 = F_136 ( V_3 ) ;
if ( V_265 == V_268 )
...
static T_6 F_143 ( struct V_2 * V_3 )
{
int V_33 ;
V_33 = F_129 ( V_3 ) ;
if ( V_33 )
