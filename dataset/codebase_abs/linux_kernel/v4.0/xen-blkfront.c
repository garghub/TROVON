...
F_109 ( & V_2 -> V_148 ) ;
while ( ( V_254 = F_164 ( & V_261 ) ) != NULL ) {
if ( F_165 ( V_254 ) > V_211 ) {
V_257 = ( F_165 ( V_254 ) + V_211 - 1 ) / V_211 ;
V_255 = F_5 ( sizeof( * V_255 ) , V_19 ) ;
F_2 ( V_255 == NULL ) ;
F_166 ( & V_255 -> V_257 , V_257 ) ;
V_255 -> V_254 = V_254 ;
for ( V_18 = 0 ; V_18 < V_257 ; V_18 ++ ) {
V_120 = ( V_18 * V_211 * V_132 ) >> 9 ;
V_263 = F_167 ( ( unsigned int ) ( V_211 * V_132 ) >> 9 ,
( unsigned int ) F_168 ( V_254 ) - V_120 ) ;
V_260 = F_169 ( V_254 , V_19 ) ;
F_2 ( V_260 == NULL ) ;
F_170 ( V_260 , V_120 , V_263 ) ;
V_260 -> V_256 = V_255 ;
V_260 -> V_272 = F_151 ;
F_171 ( V_260 -> V_273 , V_260 ) ;
}
continue;
}
F_171 ( V_254 -> V_273 , V_254 ) ;
}
return 0 ;
}
static int F_172 ( struct V_235 * V_69 )
{
struct V_1 * V_2 = F_173 ( & V_69 -> V_69 ) ;
int V_190 ;
...
unsigned int V_278 ;
V_2 -> V_150 = 1 ;
V_190 = F_182 ( V_249 , V_2 -> V_32 -> V_279 ,
L_62 , L_41 , & V_153 ,
L_63 , L_41 , & V_154 ,
NULL ) ;
if ( ! V_190 ) {
...
static void F_188 ( struct V_235 * V_69 ,
enum V_287 V_288 )
{
struct V_1 * V_2 = F_173 ( & V_69 -> V_69 ) ;
...
static int F_189 ( struct V_235 * V_32 )
{
struct V_1 * V_2 = F_173 ( & V_32 -> V_69 ) ;
struct V_55 * V_64 = NULL ;
struct V_75 * V_295 ;
...
static int F_191 ( struct V_235 * V_69 )
{
struct V_1 * V_2 = F_173 ( & V_69 -> V_69 ) ;
return V_2 -> V_286 && V_2 -> V_32 ;
}
static int F_192 ( struct V_55 * V_64 , T_3 V_65 )
{
...
static void F_193 ( struct V_75 * V_295 , T_3 V_65 )
{
