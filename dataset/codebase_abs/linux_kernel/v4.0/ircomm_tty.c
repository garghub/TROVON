...
V_134 = F_76 ( 200 ) ;
if ( V_132 )
V_134 = F_77 (unsigned long, timeout, poll_time) ;
F_33 ( & V_4 -> V_101 , V_35 ) ;
...
F_22 ( L_23 , V_17 , V_4 -> line ,
( V_139 & V_11 ) ? L_24 : L_25 ) ;
if ( V_139 & V_11 ) {
F_94 ( & V_4 -> V_2 . V_75 ) ;
} else {
F_22 ( L_26 , V_17 ) ;
...
F_13 (skb != NULL, return -1;) ;
V_146 = V_118 -> V_145 [ 0 ] ;
F_104 ( V_4 , V_118 -> V_145 + 1 , F_105 ( V_118 -> V_127 - 1 , V_146 ) ,
& V_147 ) ;
return 0 ;
}
...
static void F_106 ( struct V_3 * V_4 , struct V_149 * V_150 )
{
struct V_61 * V_62 ;
char V_151 ;
F_107 ( V_150 , L_33 , V_152 [ V_4 -> V_84 ] ) ;
F_108 ( V_150 , L_34 ) ;
if ( V_4 -> V_58 & V_110 )
F_108 ( V_150 , L_35 ) ;
...
F_108 ( V_150 , L_38 ) ;
F_109 ( V_150 , '\n' ) ;
F_107 ( V_150 , L_39 , V_4 -> V_5 . V_153 ) ;
F_107 ( V_150 , L_40 ) ;
V_151 = ' ' ;
if ( V_4 -> V_5 . V_6 & V_7 ) {
F_107 ( V_150 , L_41 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_6 & V_8 ) {
F_107 ( V_150 , L_42 , V_151 ) ;
V_151 = '|' ;
}
F_109 ( V_150 , '\n' ) ;
F_108 ( V_150 , L_43 ) ;
...
F_107 ( V_150 , L_44 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_10 & V_112 ) {
F_107 ( V_150 , L_45 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_10 & V_11 ) {
F_107 ( V_150 , L_46 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_10 & V_113 ) {
F_107 ( V_150 , L_47 , V_151 ) ;
V_151 = '|' ;
}
F_109 ( V_150 , '\n' ) ;
F_108 ( V_150 , L_48 ) ;
...
F_108 ( V_150 , L_50 ) ;
F_107 ( V_150 , L_51 , V_4 -> V_5 . V_155 ) ;
F_108 ( V_150 , L_52 ) ;
V_151 = ' ' ;
if ( V_4 -> V_5 . V_156 & V_157 ) {
F_107 ( V_150 , L_53 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_158 ) {
F_107 ( V_150 , L_54 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_159 ) {
F_107 ( V_150 , L_55 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_160 ) {
F_107 ( V_150 , L_56 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_161 ) {
F_107 ( V_150 , L_57 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_162 ) {
F_107 ( V_150 , L_58 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_163 ) {
F_107 ( V_150 , L_59 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_164 ) {
F_107 ( V_150 , L_60 , V_151 ) ;
V_151 = '|' ;
}
F_109 ( V_150 , '\n' ) ;
F_108 ( V_150 , L_61 ) ;
V_151 = ' ' ;
if ( F_99 ( & V_4 -> V_2 ) ) {
F_107 ( V_150 , L_62 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_141 ) {
F_107 ( V_150 , L_63 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_165 ) {
F_107 ( V_150 , L_64 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_107 ) {
F_107 ( V_150 , L_65 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_166 ) {
F_107 ( V_150 , L_66 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_70 ) {
F_107 ( V_150 , L_67 , V_151 ) ;
V_151 = '|' ;
}
F_109 ( V_150 , '\n' ) ;
F_107 ( V_150 , L_68 , V_4 -> V_167 ? L_69 : L_70 ) ;
F_107 ( V_150 , L_71 , V_4 -> V_2 . V_76 ) ;
F_107 ( V_150 , L_72 , V_4 -> V_98 ) ;
F_107 ( V_150 , L_73 , V_4 -> V_96 ) ;
V_62 = F_63 ( & V_4 -> V_2 ) ;
if ( V_62 ) {
F_107 ( V_150 , L_74 ,
V_62 -> V_121 ? L_75 : L_76 ) ;
F_68 ( V_62 ) ;
}
}
static int F_110 ( struct V_149 * V_150 , void * V_168 )
{
struct V_3 * V_4 ;
unsigned long V_35 ;
...
F_34 ( & V_15 -> V_169 , V_35 ) ;
return 0 ;
}
static int F_113 ( struct V_170 * V_170 , struct V_63 * V_63 )
{
return F_114 ( V_63 , F_110 , NULL ) ;
}
