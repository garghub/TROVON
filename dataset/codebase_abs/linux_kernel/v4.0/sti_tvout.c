...
static void F_43 ( struct V_90 * V_36 , struct V_90 * V_91 ,
void * V_92 )
{
}
static int F_44 ( struct V_90 * V_36 , void * V_92 )
{
return V_36 -> V_37 == V_92 ;
}
static int F_45 ( struct V_90 * V_36 )
{
return 0 ;
}
static void F_46 ( struct V_90 * V_36 )
{
}
static int F_47 ( struct V_99 * V_100 )
{
struct V_90 * V_36 = & V_100 -> V_36 ;
...
return - V_107 ;
V_2 -> V_36 = V_36 ;
V_102 = F_49 ( V_100 , V_108 , L_7 ) ;
if ( ! V_102 ) {
F_50 ( L_8 ) ;
return - V_107 ;
}
V_2 -> V_4 = F_51 ( V_36 , V_102 -> V_109 , F_52 ( V_102 ) ) ;
if ( ! V_2 -> V_4 )
return - V_107 ;
V_2 -> V_110 = F_53 ( V_36 , L_9 ) ;
if ( ! F_54 ( V_2 -> V_110 ) )
F_55 ( V_2 -> V_110 ) ;
F_56 ( V_100 , V_2 ) ;
F_57 ( V_35 , NULL , NULL , V_36 ) ;
V_103 = F_58 ( V_35 , NULL ) ;
while ( V_103 ) {
F_59 ( V_36 , & V_105 , F_44 , V_103 ) ;
F_60 ( V_103 ) ;
V_103 = F_58 ( V_35 , V_103 ) ;
}
F_61 ( V_36 , & V_111 , V_105 ) ;
return F_62 ( V_36 , & V_112 ) ;
}
static int F_63 ( struct V_99 * V_100 )
{
F_64 ( & V_100 -> V_36 , & V_111 ) ;
F_65 ( & V_100 -> V_36 , & V_112 ) ;
return 0 ;
}
