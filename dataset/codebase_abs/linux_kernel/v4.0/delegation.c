...
static int F_20 ( struct V_7 * V_7 , const T_2 * V_17 )
{
...
if ( V_2 == NULL )
goto V_84;
if ( ! V_56 -> V_85 -> V_86 ( & V_2 -> V_17 , V_17 ) )
goto V_84;
F_75 ( V_64 , V_2 ) ;
F_11 () ;
F_78 ( V_56 ) ;
...
struct V_7 * F_94 ( struct V_55 * V_56 ,
const struct V_88 * V_89 )
{
struct V_63 * V_64 ;
struct V_7 * V_47 = NULL ;
...
bool F_99 ( T_2 * V_91 , struct V_7 * V_7 ,
T_1 V_6 )
{
struct V_32 * V_33 = F_9 ( V_7 ) ;
struct V_1 * V_2 ;
