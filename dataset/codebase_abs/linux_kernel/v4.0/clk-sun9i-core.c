...
static void T_3 F_9 ( struct V_10 * V_11 )
{
void T_4 * V_12 ;
struct V_16 * V_17 ;
V_12 = F_4 ( V_11 , 0 , F_5 ( V_11 ) ) ;
...
static void F_12 ( T_1 * V_1 , T_1 V_2 ,
T_2 * V_7 , T_2 * V_4 , T_2 * V_8 , T_2 * V_9 )
{
T_1 V_20 ;
if ( V_2 < * V_1 )
* V_1 = V_2 ;
V_20 = F_13 ( F_2 ( V_2 , * V_1 ) ) ;
if ( V_20 > 3 )
V_20 = 3 ;
* V_1 = V_2 >> V_20 ;
if ( ! V_9 )
...
static void T_3 F_14 ( struct V_10 * V_11 )
{
void T_4 * V_12 ;
V_12 = F_4 ( V_11 , 0 , F_5 ( V_11 ) ) ;
if ( ! V_12 ) {
...
static void F_16 ( T_1 * V_1 , T_1 V_2 ,
T_2 * V_7 , T_2 * V_4 , T_2 * V_8 , T_2 * V_9 )
{
T_1 div ;
T_2 V_25 , V_26 ;
...
static void T_3 F_17 ( struct V_10 * V_11 )
{
void T_4 * V_12 ;
V_12 = F_4 ( V_11 , 0 , F_5 ( V_11 ) ) ;
if ( ! V_12 ) {
