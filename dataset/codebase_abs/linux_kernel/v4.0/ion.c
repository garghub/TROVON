...
V_19 -> V_8 = V_8 ;
F_92 ( & V_8 -> V_47 ) ;
F_157 ( & V_19 -> V_14 , - V_19 -> V_65 ) ;
F_158 ( & V_19 -> V_14 , & V_8 -> V_192 ) ;
V_190 = F_95 ( V_19 -> V_82 , 0664 ,
V_8 -> V_193 , V_19 ,
& V_194 ) ;
if ( ! V_190 ) {
char V_100 [ 256 ] , * V_101 ;
V_101 = F_96 ( V_8 -> V_193 , V_100 , 256 ) ;
F_9 ( L_44 ,
V_101 , V_19 -> V_82 ) ;
}
#ifdef F_159
...
struct V_7 * V_196 ;
int V_27 ;
V_196 = F_14 ( sizeof( struct V_7 ) , V_28 ) ;
if ( ! V_196 )
return F_15 ( - V_29 ) ;
V_196 -> V_8 . V_197 = V_198 ;
V_196 -> V_8 . V_82 = L_47 ;
V_196 -> V_8 . V_199 = & V_200 ;
V_196 -> V_8 . V_12 = NULL ;
V_27 = F_161 ( & V_196 -> V_8 ) ;
if ( V_27 ) {
F_9 ( L_48 ) ;
return F_15 ( V_27 ) ;
}
V_196 -> V_97 = F_162 ( L_47 , NULL ) ;
if ( ! V_196 -> V_97 ) {
F_9 ( L_49 ) ;
goto V_201;
}
V_196 -> V_193 = F_162 ( L_50 , V_196 -> V_97 ) ;
if ( ! V_196 -> V_193 ) {
F_9 ( L_51 ) ;
goto V_201;
}
V_196 -> V_98 = F_162 ( L_52 ,
V_196 -> V_97 ) ;
if ( ! V_196 -> V_98 )
F_9 ( L_53 ) ;
V_201:
...
void T_5 F_167 ( struct V_202 * V_162 )
{
int V_26 ;
for ( V_26 = 0 ; V_26 < V_162 -> V_203 ; V_26 ++ ) {
if ( V_162 -> V_192 [ V_26 ] . V_35 == 0 )
continue;
if ( V_162 -> V_192 [ V_26 ] . V_204 == 0 ) {
T_6 V_205 ;
V_205 = F_168 ( V_162 -> V_192 [ V_26 ] . V_35 ,
V_162 -> V_192 [ V_26 ] . V_21 ,
V_206 ) ;
if ( ! V_205 ) {
F_9 ( L_54 ,
V_17 , V_26 ) ;
...
V_162 -> V_192 [ V_26 ] . V_204 = V_205 ;
} else {
int V_27 = F_169 ( V_162 -> V_192 [ V_26 ] . V_204 ,
V_162 -> V_192 [ V_26 ] . V_35 ) ;
if ( V_27 )
F_9 ( L_55 ,
V_162 -> V_192 [ V_26 ] . V_35 ,
V_162 -> V_192 [ V_26 ] . V_204 ) ;
}
F_170 ( L_56 , V_17 ,
V_162 -> V_192 [ V_26 ] . V_82 ,
V_162 -> V_192 [ V_26 ] . V_204 ,
V_162 -> V_192 [ V_26 ] . V_35 ) ;
}
}
