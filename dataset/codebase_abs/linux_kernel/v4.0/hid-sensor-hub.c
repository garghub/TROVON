...
static int F_28 ( struct V_3 * V_4 , T_3 V_80 )
{
struct V_36 * V_37 = F_7 ( V_4 ) ;
struct V_34 * V_35 ;
unsigned long V_38 ;
...
V_6 -> V_18 [ V_7 ] -> V_72 -> V_73 ) {
F_29 ( V_4 , L_7 ) ;
V_37 -> V_60 . V_69 = F_33 ( V_83 , V_84 , V_44 ) ;
if ( V_37 -> V_60 . V_69 )
V_37 -> V_60 . V_62 = V_84 ;
else
V_37 -> V_60 . V_62 = 0 ;
...
static T_4 * F_40 ( struct V_3 * V_4 , T_4 * V_89 ,
unsigned int * V_90 )
{
int V_15 ;
...
V_91 = F_42 ( & V_4 -> V_100 , sizeof( * V_91 ) , V_101 ) ;
if ( ! V_91 ) {
F_37 ( V_4 , L_11 ) ;
return - V_45 ;
}
...
V_91 -> V_107 = F_42 ( & V_4 -> V_100 , V_98 *
sizeof( struct V_108 ) ,
V_101 ) ;
if ( V_91 -> V_107 == NULL ) {
F_37 ( V_4 , L_15 ) ;
...
struct V_10 * V_11 = & V_4 -> V_11 [ V_7 ] ;
if ( V_11 -> type == V_12 ) {
V_32 = F_42 ( & V_4 -> V_100 , sizeof( * V_32 ) ,
V_101 ) ;
if ( ! V_32 ) {
F_37 ( V_4 , L_16 ) ;
V_51 = - V_45 ;
