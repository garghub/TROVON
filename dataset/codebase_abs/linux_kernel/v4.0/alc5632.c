...
static int F_26 ( struct V_123 * V_124 ,
...
V_54 = F_27 ( & V_124 -> V_2 ,
sizeof( struct V_53 ) , V_131 ) ;
if ( V_54 == NULL )
return - V_132 ;
F_28 ( V_124 , V_54 ) ;
V_54 -> V_12 = F_29 ( V_124 , & V_133 ) ;
if ( F_30 ( V_54 -> V_12 ) ) {
V_126 = F_31 ( V_54 -> V_12 ) ;
F_32 ( & V_124 -> V_2 , L_1 , V_126 ) ;
return V_126 ;
}
V_127 = F_33 ( V_54 -> V_12 , V_10 , & V_129 ) ;
V_128 = F_33 ( V_54 -> V_12 , V_11 , & V_130 ) ;
if ( V_127 != 0 || V_128 != 0 ) {
F_32 ( & V_124 -> V_2 ,
L_2 , V_127 , V_128 ) ;
return - V_134 ;
...
V_126 = F_34 ( & V_124 -> V_2 ,
& V_138 , & V_136 , 1 ) ;
if ( V_126 < 0 ) {
F_32 ( & V_124 -> V_2 , L_6 , V_126 ) ;
return V_126 ;
}
return V_126 ;
}
