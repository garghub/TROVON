...
return - V_111 ;
if ( V_113 -> V_87 &&
F_38 ( V_109 , V_86 , V_113 -> V_87 ) )
return - V_111 ;
if ( V_113 -> V_89 &&
F_38 ( V_109 , V_88 , V_113 -> V_89 ) )
return - V_111 ;
if ( V_113 -> V_91 &&
...
if ( ! V_5 && V_153 -> V_155 & F_49 ( 0xFFF00000 ) ) {
F_7 ( log , L_23 ,
F_50 ( V_153 -> V_155 ) , ( 1 << 20 ) - 1 ) ;
return - V_62 ;
}
...
static void F_51 ( struct V_52 * V_53 , T_3 V_208 ,
...
F_51 ( V_57 , V_208 , V_210 [ F_15 ( V_57 ) ] . V_211 ) ;
else
...
static T_1 F_57 ( const struct V_52 * V_53 , bool log )
{
T_1 V_64 ;
if ( ! V_53 )
return 0 ;
...
bool F_58 ( struct V_223 * V_224 , const struct V_52 * V_53 ,
bool log )
{
V_224 -> V_225 = F_57 ( V_53 , log ) ;
if ( V_224 -> V_225 )
memcpy ( V_224 -> V_226 , F_17 ( V_53 ) , V_224 -> V_225 ) ;
return V_224 -> V_225 ;
}
int F_59 ( struct V_223 * V_224 , const struct V_52 * V_226 ,
const struct V_227 * V_30 , bool log )
{
struct V_227 * V_228 ;
if ( F_58 ( V_224 , V_226 , log ) )
return 0 ;
V_228 = F_60 ( sizeof( * V_228 ) , V_219 ) ;
if ( ! V_228 )
return - V_220 ;
...
T_6 F_61 ( const struct V_52 * V_53 )
{
return V_53 ? F_26 ( V_53 ) : 0 ;
}
int F_62 ( const struct V_52 * V_53 ,
struct V_227 * V_30 ,
bool log )
{
const struct V_52 * V_54 [ V_61 + 1 ] ;
...
static int F_63 ( const struct V_227 * V_230 ,
...
goto V_231;
V_57 = F_65 ( V_109 , V_14 , sizeof( * V_133 ) ) ;
if ( ! V_57 )
goto V_231;
V_133 = F_17 ( V_57 ) ;
F_66 ( V_133 -> V_134 , V_113 -> V_31 . V_46 ) ;
F_66 ( V_133 -> V_137 , V_113 -> V_31 . V_136 ) ;
...
struct V_144 * V_145 ;
V_57 = F_65 ( V_109 , V_16 , sizeof( * V_145 ) ) ;
if ( ! V_57 )
goto V_231;
V_145 = F_17 ( V_57 ) ;
...
struct V_152 * V_153 ;
V_57 = F_65 ( V_109 , V_17 , sizeof( * V_153 ) ) ;
if ( ! V_57 )
goto V_231;
V_153 = F_17 ( V_57 ) ;
...
struct V_163 * V_164 ;
V_57 = F_65 ( V_109 , V_24 , sizeof( * V_164 ) ) ;
if ( ! V_57 )
goto V_231;
V_164 = F_17 ( V_57 ) ;
...
F_66 ( V_164 -> V_170 , V_113 -> V_150 . V_168 . V_169 ) ;
F_66 ( V_164 -> V_172 , V_113 -> V_150 . V_168 . V_171 ) ;
} else if ( F_6 ( V_230 -> V_31 . type ) ) {
struct V_173 * V_174 ;
V_57 = F_65 ( V_109 , V_26 , sizeof( * V_174 ) ) ;
if ( ! V_57 )
goto V_231;
V_174 = F_17 ( V_57 ) ;
...
struct V_178 * V_179 ;
V_57 = F_65 ( V_109 , V_18 , sizeof( * V_179 ) ) ;
if ( ! V_57 )
goto V_231;
V_179 = F_17 ( V_57 ) ;
...
struct V_183 * V_184 ;
V_57 = F_65 ( V_109 , V_20 , sizeof( * V_184 ) ) ;
if ( ! V_57 )
goto V_231;
V_184 = F_17 ( V_57 ) ;
...
struct V_187 * V_188 ;
V_57 = F_65 ( V_109 , V_21 , sizeof( * V_188 ) ) ;
if ( ! V_57 )
goto V_231;
V_188 = F_17 ( V_57 ) ;
...
struct V_191 * V_192 ;
V_57 = F_65 ( V_109 , V_22 , sizeof( * V_192 ) ) ;
if ( ! V_57 )
goto V_231;
V_192 = F_17 ( V_57 ) ;
V_192 -> V_193 = F_48 ( V_113 -> V_45 . V_46 ) ;
V_192 -> V_194 = F_48 ( V_113 -> V_45 . V_136 ) ;
} else if ( V_230 -> V_31 . type == F_5 ( V_43 ) &&
V_230 -> V_35 . V_38 == V_44 ) {
struct V_195 * V_196 ;
V_57 = F_65 ( V_109 , V_23 ,
sizeof( * V_196 ) ) ;
if ( ! V_57 )
goto V_231;
V_196 = F_17 ( V_57 ) ;
V_196 -> V_197 = F_48 ( V_113 -> V_45 . V_46 ) ;
V_196 -> V_198 = F_48 ( V_113 -> V_45 . V_136 ) ;
if ( V_196 -> V_197 == V_47 ||
V_196 -> V_197 == V_48 ) {
struct V_199 * V_200 ;
V_57 = F_65 ( V_109 , V_25 , sizeof( * V_200 ) ) ;
if ( ! V_57 )
goto V_231;
V_200 = F_17 ( V_57 ) ;
memcpy ( V_200 -> V_203 , & V_113 -> V_156 . V_201 . V_202 ,
sizeof( V_200 -> V_203 ) ) ;
F_66 ( V_200 -> V_205 , V_113 -> V_156 . V_201 . V_204 ) ;
F_66 ( V_200 -> V_207 , V_113 -> V_156 . V_201 . V_206 ) ;
}
}
}
V_234:
...
int F_67 ( const struct V_227 * V_230 ,
...
if ( ! V_57 )
return - V_111 ;
V_73 = F_63 ( V_230 , V_113 , V_5 , V_109 ) ;
if ( V_73 )
return V_73 ;
F_35 ( V_109 , V_57 ) ;
return 0 ;
}
int F_68 ( const struct V_235 * V_236 , struct V_108 * V_109 )
{
if ( F_69 ( & V_236 -> V_237 ) )
return F_42 ( V_109 , V_238 , V_236 -> V_237 . V_225 ,
V_236 -> V_237 . V_226 ) ;
return F_67 ( V_236 -> V_237 . V_229 , V_236 -> V_237 . V_229 ,
V_239 , false , V_109 ) ;
}
int F_70 ( const struct V_235 * V_236 , struct V_108 * V_109 )
{
return F_67 ( & V_236 -> V_30 , & V_236 -> V_30 ,
V_239 , false , V_109 ) ;
}
int F_71 ( const struct V_235 * V_236 , struct V_108 * V_109 )
{
return F_67 ( & V_236 -> V_30 , & V_236 -> V_10 -> V_30 ,
V_240 , true , V_109 ) ;
}
static struct V_241 * F_72 ( int V_4 , bool log )
{
struct V_241 * V_242 ;
if ( V_4 > V_243 ) {
F_7 ( log , L_33 , V_4 ) ;
...
V_242 = F_60 ( sizeof( * V_242 ) + V_4 , V_219 ) ;
if ( ! V_242 )
return F_73 ( - V_220 ) ;
V_242 -> V_244 = 0 ;
return V_242 ;
}
void F_74 ( struct V_241 * V_245 )
{
F_75 ( V_245 , V_246 ) ;
}
static struct V_52 * F_76 ( struct V_241 * * V_242 ,
int V_247 , bool log )
{
struct V_241 * V_248 ;
int V_249 ;
int V_250 = F_77 ( V_247 ) ;
int V_251 = F_78 ( struct V_241 , V_252 ) +
( * V_242 ) -> V_244 ;
if ( V_250 <= ( F_79 ( * V_242 ) - V_251 ) )
goto V_253;
V_249 = F_79 ( * V_242 ) * 2 ;
if ( V_249 > V_243 ) {
...
static struct V_52 * F_81 ( struct V_241 * * V_242 ,
int V_254 , void * V_255 , int V_64 , bool log )
{
struct V_52 * V_54 ;
V_54 = F_76 ( V_242 , F_82 ( V_64 ) , log ) ;
if ( F_80 ( V_54 ) )
return V_54 ;
V_54 -> F_15 = V_254 ;
V_54 -> F_16 = F_82 ( V_64 ) ;
...
memset ( ( unsigned char * ) V_54 + V_54 -> F_16 , 0 , F_83 ( V_64 ) ) ;
return V_54 ;
}
static int F_84 ( struct V_241 * * V_242 , int V_254 ,
void * V_255 , int V_64 , bool log )
{
struct V_52 * V_54 ;
V_54 = F_81 ( V_242 , V_254 , V_255 , V_64 , log ) ;
return F_85 ( V_54 ) ;
}
static inline int F_86 ( struct V_241 * * V_242 ,
int V_254 , bool log )
{
int V_256 = ( * V_242 ) -> V_244 ;
int V_73 ;
V_73 = F_84 ( V_242 , V_254 , NULL , 0 , log ) ;
if ( V_73 )
return V_73 ;
return V_256 ;
}
static inline void F_87 ( struct V_241 * V_242 ,
int V_257 )
{
...
static int F_88 ( const struct V_52 * V_53 ,
...
return - V_62 ;
V_8 = F_86 ( V_242 , V_266 , log ) ;
if ( V_8 < 0 )
return V_8 ;
V_73 = F_84 ( V_242 , V_263 ,
F_17 ( V_261 ) , sizeof( T_6 ) , log ) ;
if ( V_73 )
return V_73 ;
V_262 = F_86 ( V_242 , V_264 , log ) ;
if ( V_262 < 0 )
return V_262 ;
V_73 = F_89 ( V_252 , V_30 , V_258 + 1 , V_242 ,
V_141 , V_259 , log ) ;
if ( V_73 )
return V_73 ;
F_87 ( * V_242 , V_262 ) ;
...
static int F_91 ( struct V_227 * V_30 )
{
struct V_268 * V_269 ;
int V_270 = V_30 -> V_68 ;
bool V_271 = false ;
V_269 = (struct V_268 * ) F_64 ( V_30 , V_30 -> V_68 ) ;
while ( V_270 > 0 ) {
int V_64 ;
...
static int F_92 ( const struct V_52 * V_53 ,
...
V_8 = F_86 ( V_242 , V_276 , log ) ;
if ( V_8 < 0 )
return V_8 ;
V_54 = F_81 ( V_242 , V_49 , NULL ,
...
static bool F_94 ( T_3 * V_255 , int V_64 )
{
T_3 * V_10 = V_255 + V_64 ;
while ( V_64 -- )
if ( * V_255 ++ & ~ * V_10 ++ )
...
static int F_95 ( const struct V_52 * V_54 ,
...
return - V_62 ;
if ( V_279 && ! F_94 ( F_17 ( V_280 ) , V_282 ) )
return - V_62 ;
switch ( V_281 ) {
const struct V_144 * V_145 ;
const struct V_152 * V_153 ;
...
if ( F_50 ( V_153 -> V_155 ) & 0xFFF00000 )
return - V_62 ;
break;
case V_18 :
if ( ( V_141 != F_5 ( V_34 ) &&
...
if ( V_8 < 0 )
return V_8 ;
V_283 = F_81 ( V_242 , V_281 , NULL , V_64 , log ) ;
if ( F_80 ( V_283 ) )
return F_93 ( V_283 ) ;
...
V_10 -> V_155 &= F_49 ( 0x000FFFFF ) ;
}
F_87 ( * V_242 , V_8 ) ;
}
return 0 ;
}
static int F_96 ( const struct V_52 * V_53 )
{
...
static int F_97 ( const struct V_52 * V_293 ,
struct V_241 * * V_242 , bool log )
{
int V_294 = F_77 ( V_293 -> F_16 ) ;
struct V_52 * V_295 ;
V_295 = F_76 ( V_242 , V_293 -> F_16 , log ) ;
if ( F_80 ( V_295 ) )
return F_93 ( V_295 ) ;
...
break;
case V_266 :
V_73 = F_88 ( V_54 , V_30 , V_258 , V_242 ,
V_141 , V_259 , log ) ;
if ( V_73 )
return V_73 ;
V_278 = true ;
...
int F_98 ( const struct V_52 * V_53 ,
const struct V_227 * V_30 ,
struct V_241 * * V_242 , bool log )
{
int V_73 ;
* V_242 = F_72 ( F_16 ( V_53 ) , log ) ;
if ( F_80 ( * V_242 ) )
return F_93 ( * V_242 ) ;
V_73 = F_89 ( V_53 , V_30 , 0 , V_242 , V_30 -> V_31 . type ,
V_30 -> V_31 . V_139 , log ) ;
if ( V_73 )
F_56 ( * V_242 ) ;
return V_73 ;
}
static int F_99 ( const struct V_52 * V_53 , struct V_108 * V_109 )
{
const struct V_52 * V_54 ;
struct V_52 * V_8 ;
int V_73 = 0 , V_59 ;
...
if ( ! V_319 )
return - V_111 ;
V_73 = F_100 ( F_17 ( V_54 ) , F_16 ( V_54 ) , V_109 ) ;
if ( V_73 )
return V_73 ;
F_35 ( V_109 , V_319 ) ;
break;
...
static int F_101 ( const struct V_52 * V_54 , struct V_108 * V_109 )
{
const struct V_52 * V_280 = F_17 ( V_54 ) ;
int V_281 = F_15 ( V_280 ) ;
struct V_52 * V_8 ;
...
static int F_102 ( const struct V_52 * V_54 ,
struct V_108 * V_109 )
{
const struct V_52 * V_280 = F_17 ( V_54 ) ;
struct V_52 * V_57 ;
...
int F_100 ( const struct V_52 * V_53 , int V_64 , struct V_108 * V_109 )
{
const struct V_52 * V_54 ;
int V_59 , V_73 ;
F_103 (a, attr, len, rem) {
int type = F_15 ( V_54 ) ;
switch ( type ) {
case V_276 :
V_73 = F_101 ( V_54 , V_109 ) ;
if ( V_73 )
return V_73 ;
break;
case V_284 :
