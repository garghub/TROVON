...
F_4 ( L_12 ) ;
if ( V_2 -> V_100 )
V_7 = V_2 -> V_100 ( V_5 -> V_101 . V_102 -> V_103 ,
V_104 ,
V_105 ,
V_5 -> V_19 ) ;
break;
...
T_1 V_113 = V_111 -> V_114 ;
T_1 V_26 = V_111 -> V_115 ;
T_1 V_25 = V_111 -> V_116 ;
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_117 * V_118 = & V_5 -> V_30 ;
struct V_23 * V_24 ;
int V_7 ;
V_5 -> V_19 = V_22 ;
switch ( V_113 ) {
...
if ( V_2 -> V_133 . V_134 . V_3 )
V_2 -> V_133 . V_134 . V_3 ( V_2 ) ;
...
char * V_19 ;
int V_7 ;
T_1 V_25 = V_137 -> V_116 * 125 *
( ( V_137 -> V_19 == V_138 ) ? 1 : 1000 ) / 2 ;
V_5 -> V_19 = V_20 ;
if ( V_137 -> V_19 == V_138 ) {
V_24 = & V_118 -> V_139 ;
V_19 = L_17 ;
} else if ( V_137 -> V_30 & V_140 ) {
V_24 = & V_118 -> V_141 ;
V_19 = L_18 ;
} else if ( V_137 -> V_30 & V_142 ) {
V_24 = & V_118 -> V_143 ;
V_19 = L_19 ;
} else if ( V_137 -> V_30 & V_144 ) {
V_24 = & V_118 -> V_145 ;
V_19 = L_20 ;
} else if ( V_137 -> V_30 & V_146 ) {
V_24 = & V_118 -> V_147 ;
V_19 = L_21 ;
} else if ( V_137 -> V_30 & V_148 ) {
V_24 = & V_118 -> V_149 ;
V_19 = L_22 ;
} else if ( V_137 -> V_30 & V_150 ) {
V_24 = & V_118 -> V_151 ;
V_19 = L_23 ;
} else if ( V_137 -> V_30 & V_152 ) {
V_24 = & V_118 -> V_153 ;
V_19 = L_24 ;
} else {
V_24 = & V_118 -> V_147 ;
...
static int F_56 ( struct V_1 * V_2 , T_1 * V_116 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
* V_116 = V_5 -> V_116 ;
return 0 ;
}
static int F_57 ( struct V_1 * V_2 , T_1 * V_135 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
* V_135 = V_5 -> V_135 ;
return 0 ;
}
static int F_58 ( struct V_1 * V_2 , T_1 * V_116 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
* V_116 = ( T_1 ) V_5 -> V_42 * 1000 ;
return 0 ;
}
static int F_59 ( struct V_1 * V_2 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_117 * V_30 = & V_5 -> V_30 ;
F_4 ( L_27 ) ;
F_60 ( V_139 , L_28 ) ;
F_60 ( V_143 , L_29 ) ;
F_60 ( V_149 , L_30 ) ;
...
if ( V_7 ) {
F_39 ( L_49 ,
F_64 ( V_5 -> V_101 . V_102 ) ,
V_5 -> V_101 . V_156 ) ;
return - V_157 ;
}
switch ( V_17 [ V_158 ] & 0x7f ) {
case 3 :
V_155 = L_50 ;
V_5 -> V_31 = V_109 ;
break;
...
default:
F_39 ( L_52 ,
V_17 [ V_158 ] , F_64 ( V_5 -> V_101 . V_102 ) ,
V_5 -> V_101 . V_156 ) ;
return - V_108 ;
}
F_39 ( L_53 , V_155 ,
F_64 ( V_5 -> V_101 . V_102 ) , V_5 -> V_101 . V_156 ) ;
return 0 ;
}
...
{
struct V_4 * V_5 = V_2 -> V_6 ;
V_5 -> V_161 = ( V_160 ) ? V_160 -> V_161 : V_162 ;
V_5 -> V_13 = ( V_160 ) ? V_160 -> V_13 : V_40 ;
V_5 -> V_95 = ( V_160 ) ? V_160 -> V_95 : 0 ;
V_5 -> V_163 = ( V_160 ) ?
V_160 -> V_163 : V_164 ;
V_5 -> V_8 = ( V_160 ) ?
V_160 -> V_8 : V_165 ;
...
static inline int F_66 ( struct V_159 * V_160 )
{
return ( ( V_166 == - 1 ) ?
( ( V_160 ) && ( V_160 -> V_167 ) ) :
( V_166 ) ) ? 1 : 0 ;
}
static int F_67 ( struct V_1 * V_2 , void * V_168 )
{
struct V_159 * V_160 = (struct V_159 * ) V_168 ;
F_65 ( V_2 , V_160 ) ;
if ( F_66 ( V_160 ) )
F_44 ( V_2 ) ;
if ( ( V_160 ) && ( V_160 -> V_118 ) )
F_61 ( V_2 , V_160 -> V_118 ) ;
return 0 ;
}
struct V_1 * F_68 ( struct V_1 * V_2 , T_2 V_156 ,
struct V_169 * V_170 ,
struct V_159 * V_160 )
{
struct V_4 * V_5 = NULL ;
...
V_5 -> V_161 = V_160 -> V_161 ;
if ( V_160 -> V_13 )
V_5 -> V_13 = V_160 -> V_13 ;
if ( V_160 -> V_95 )
V_5 -> V_95 = V_160 -> V_95 ;
if ( V_160 -> V_163 )
V_5 -> V_163 = V_160 -> V_163 ;
if ( V_160 -> V_8 )
V_5 -> V_8 = V_160 -> V_8 ;
if ( V_160 -> V_118 )
F_61 ( V_2 , V_160 -> V_118 ) ;
