...
{
return V_48 -> V_49 ( V_4 -> V_14 -> V_50 , V_2 , V_45 , V_46 , V_47 ) ;
}
static int F_15 ( struct V_3 * V_4 , void * V_2 ,
T_2 V_45 , T_2 V_46 ,
T_2 T_3 * V_47 )
{
return V_48 -> V_51 ( V_4 -> V_14 -> V_50 , V_2 ) ;
}
...
T_2 V_46 )
{
return V_48 -> V_87 ( V_4 -> V_14 -> V_50 , type , V_86 ,
V_45 , V_46 ) ;
}
...
T_2 V_46 )
{
return V_48 -> V_88 ( V_4 -> V_14 -> V_50 , V_2 , V_86 ) ;
}
static bool F_26 ( struct V_3 * V_4 , void * V_2 ,
T_1 V_58 , T_2 V_45 ,
T_2 V_46 )
{
return V_48 -> V_89 ( V_4 -> V_14 -> V_50 , V_58 ,
V_45 , V_46 ) ;
}
...
T_2 V_46 )
{
return V_48 -> V_90 ( V_4 -> V_14 -> V_50 , V_2 ) ;
}
