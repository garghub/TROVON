...
void F_61 ( struct V_2 * V_3 , T_3 V_215 )
{
if ( V_215 ) {
...
} else if ( F_76 ( V_3 , & V_300 ) == 0 ) {
for ( V_41 = 0 ; V_41 < V_305 ; V_41 ++ ) {
V_301 = V_306 + V_41 ;
if ( F_77 ( V_3 , & V_32 , & V_302 ,
V_301 ,
V_300 ) == 0 ) {
if ( V_32 != 0 && V_32 != V_301 ) {
V_4 -> V_303 . V_307 [ V_4 -> V_303 . V_46 ] = V_32 ;
...
static void F_78 ( struct V_2 * V_3 , T_3 V_308 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
bool V_309 ;
enum V_310 V_311 ;
...
static int F_82 ( struct V_2 * V_3 , bool V_131 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
T_5 V_149 ;
if ( V_131 ) {
...
V_202 |= V_344 ;
F_26 ( V_343 , V_202 ) ;
F_70 ( V_3 , F_12 ( V_345 , V_346 ) , 0x1000 ) ;
F_83 ( V_347 , 0 , ~ V_348 ) ;
...
static void F_88 ( struct V_2 * V_3 , bool V_131 )
{
...
static T_5 F_89 ( struct V_2 * V_3 ,
T_9 V_357 , T_3 * V_358 )
{
T_5 V_149 ;
...
static int F_90 ( struct V_2 * V_3 , T_3 V_360 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
if ( ! V_4 -> V_326 ) {
T_5 V_149 =
F_56 ( V_3 , V_361 , 1 << V_360 ) ;
if ( V_149 != V_152 )
return - V_45 ;
}
return 0 ;
...
F_26 ( V_428 , V_202 ) ;
F_70 ( V_3 , F_12 ( V_345 , V_429 ) , 0x64 ) ;
F_70 ( V_3 , F_12 ( V_345 , V_430 ) , ( V_420 - V_419 ) ) ;
F_107 ( V_3 , ( V_3 -> V_5 . V_6 . V_188 == 1 ) ) ;
}
...
V_4 -> V_475 = V_498 ;
V_4 -> V_480 = V_498 ;
if ( F_273 ( V_3 , V_470 , V_471 ) )
V_4 -> V_468 = V_469 ;
else if ( F_273 ( V_3 , V_470 , V_1087 ) )
V_4 -> V_468 = V_472 ;
if ( V_3 -> V_5 . V_6 . V_48 & V_1088 ) {
if ( F_273 ( V_3 , V_476 , V_471 ) )
V_4 -> V_475 = V_469 ;
else if ( F_273 ( V_3 , V_476 , V_1087 ) )
V_4 -> V_475 = V_472 ;
else
V_3 -> V_5 . V_6 . V_48 &= ~ V_1088 ;
}
if ( V_3 -> V_5 . V_6 . V_48 & V_1089 ) {
if ( F_273 ( V_3 , V_481 , V_471 ) )
V_4 -> V_480 = V_469 ;
else if ( F_273 ( V_3 , V_481 , V_1087 ) )
V_4 -> V_480 = V_472 ;
else
...
T_3 V_181 = F_93 ( V_3 ) ;
T_3 V_182 = F_94 ( V_3 ) ;
F_277 ( V_1093 , L_33 , V_4 -> V_646 ? L_34 : L_35 ) ;
F_277 ( V_1093 , L_36 , V_10 -> V_183 ? L_34 : L_35 ) ;
F_277 ( V_1093 , L_37 ,
V_181 , V_182 ) ;
}
...
struct V_993 * V_994 ;
int V_41 ;
F_279 ( V_10 -> V_189 , V_10 -> V_983 ) ;
F_280 ( V_10 -> V_980 ) ;
F_281 ( L_38 , V_10 -> V_562 , V_10 -> V_564 ) ;
for ( V_41 = 0 ; V_41 < V_11 -> V_196 ; V_41 ++ ) {
...
T_3 F_283 ( struct V_2 * V_3 , bool V_1094 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
...
T_3 F_284 ( struct V_2 * V_3 , bool V_1094 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_8 * V_1095 = F_2 ( & V_4 -> V_970 ) ;
if ( V_1094 )
