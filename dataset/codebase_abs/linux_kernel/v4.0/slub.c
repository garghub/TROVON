...
static T_9 F_399 ( struct V_1 * V_2 , const char * V_79 ,
T_1 V_47 )
{
if ( V_2 -> V_305 > 1 )
return - V_270 ;
...
static T_9 F_403 ( struct V_1 * V_2 ,
const char * V_79 , T_1 V_47 )
{
if ( F_368 ( V_2 ) )
return - V_341 ;
...
static T_9 F_411 ( struct V_1 * V_2 , const char * V_79 ,
T_1 V_47 )
{
if ( V_2 -> V_305 > 1 )
return - V_270 ;
...
static int F_417 ( struct V_1 * V_2 , char * V_79 , enum V_6 V_7 )
{
...
static void F_418 ( struct V_1 * V_2 , enum V_6 V_7 )
{
int V_63 ;
F_387 (cpu)
F_200 ( V_2 -> V_8 , V_63 ) -> F_9 [ V_7 ] = 0 ;
}
static T_9 F_419 ( struct V_344 * V_345 ,
struct V_346 * V_347 ,
char * V_79 )
{
struct V_348 * V_346 ;
...
static T_9 F_422 ( struct V_344 * V_345 ,
struct V_346 * V_347 ,
...
#ifdef F_423
if ( V_257 >= V_352 && V_306 >= 0 && F_424 ( V_2 ) ) {
struct V_1 * V_164 ;
F_307 ( & V_278 ) ;
if ( V_2 -> V_353 < V_329 )
V_2 -> V_353 = V_329 ;
...
if ( ! V_355 -> V_353 )
return;
for ( V_55 = 0 ; V_55 < F_425 ( V_357 ) ; V_55 ++ ) {
char V_358 [ 64 ] ;
char * V_79 ;
struct V_348 * V_347 = F_420 ( V_357 [ V_55 ] ) ;
if ( ! V_347 || ! V_347 -> V_351 || ! V_347 -> V_349 )
continue;
if ( V_354 )
V_79 = V_354 ;
else if ( V_355 -> V_353 < F_425 ( V_358 ) )
V_79 = V_358 ;
else {
V_354 = ( char * ) F_426 ( V_259 ) ;
if ( F_168 ( ! V_354 ) )
continue;
V_79 = V_354 ;
}
...
if ( V_354 )
F_427 ( ( unsigned long ) V_354 ) ;
#endif
}
static void F_428 ( struct V_344 * V_359 )
{
F_429 ( F_421 ( V_359 ) ) ;
}
static int F_430 ( struct V_360 * V_360 , struct V_344 * V_345 )
{
struct V_361 * V_362 = F_431 ( V_345 ) ;
if ( V_362 == & V_363 )
return 1 ;
return 0 ;
}
static inline struct V_360 * F_432 ( struct V_1 * V_2 )
{
#ifdef F_423
if ( ! F_424 ( V_2 ) )
...
int V_367 = F_434 ( V_2 ) ;
if ( V_367 ) {
F_435 ( & V_365 -> V_345 , V_2 -> V_44 ) ;
V_44 = V_2 -> V_44 ;
} else {
V_44 = F_433 ( V_2 ) ;
}
V_2 -> V_345 . V_360 = F_432 ( V_2 ) ;
V_306 = F_436 ( & V_2 -> V_345 , & V_363 , NULL , L_16 , V_44 ) ;
if ( V_306 )
goto V_368;
V_306 = F_437 ( & V_2 -> V_345 , & V_369 ) ;
if ( V_306 )
goto V_370;
#ifdef F_423
if ( F_424 ( V_2 ) ) {
V_2 -> V_364 = F_438 ( L_104 , NULL , & V_2 -> V_345 ) ;
if ( ! V_2 -> V_364 ) {
V_306 = - V_283 ;
goto V_370;
}
...
struct V_373 * V_374 ;
if ( V_257 == V_352 ) {
F_435 ( & V_365 -> V_345 , V_44 ) ;
return F_444 ( & V_365 -> V_345 , & V_2 -> V_345 , V_44 ) ;
}
...
static int T_6 F_445 ( void )
{
struct V_1 * V_2 ;
int V_306 ;
F_307 ( & V_278 ) ;
V_365 = F_438 ( L_105 , & V_376 , V_377 ) ;
if ( ! V_365 ) {
F_308 ( & V_278 ) ;
F_58 ( L_106 ) ;
return - V_253 ;
...
void F_446 ( struct V_1 * V_2 , struct V_378 * V_379 )
{
...
void F_447 ( struct V_386 * V_190 , struct V_1 * V_2 )
{
}
T_9 F_448 ( struct V_387 * V_387 , const char T_10 * V_354 ,
