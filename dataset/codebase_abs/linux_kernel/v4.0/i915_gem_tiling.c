...
if ( args -> V_46 == V_71 )
args -> V_70 = V_4 -> V_41 . V_42 ;
else
args -> V_70 = V_4 -> V_41 . V_43 ;
if ( args -> V_70 == V_33 )
args -> V_70 = V_15 ;
if ( args -> V_70 == V_32 )
args -> V_70 = V_14 ;
...
if ( F_29 ( V_54 ) ) {
if ( V_54 -> V_80 == NULL ) {
V_54 -> V_80 = F_30 ( F_31 ( V_54 -> V_55 . V_45 >> V_81 ) ,
sizeof( long ) , V_82 ) ;
}
} else {
F_32 ( V_54 -> V_80 ) ;
...
static void
F_36 ( struct V_85 * V_85 )
{
char V_86 [ 64 ] ;
char * V_87 ;
int V_88 ;
V_87 = F_37 ( V_85 ) ;
for ( V_88 = 0 ; V_88 < V_89 ; V_88 += 128 ) {
memcpy ( V_86 , & V_87 [ V_88 ] , 64 ) ;
memcpy ( & V_87 [ V_88 ] , & V_87 [ V_88 + 64 ] , 64 ) ;
memcpy ( & V_87 [ V_88 + 64 ] , V_86 , 64 ) ;
}
F_38 ( V_85 ) ;
}
void
...
struct V_85 * V_85 = F_41 ( & V_91 ) ;
char V_92 = F_42 ( V_85 ) >> 17 ;
if ( ( V_92 & 0x1 ) !=
( F_43 ( V_88 , V_54 -> V_80 ) != 0 ) ) {
F_36 ( V_85 ) ;
F_44 ( V_85 ) ;
}
V_88 ++ ;
...
{
struct V_90 V_91 ;
int V_93 = V_54 -> V_55 . V_45 >> V_81 ;
int V_88 ;
if ( V_54 -> V_80 == NULL ) {
V_54 -> V_80 = F_30 ( F_31 ( V_93 ) ,
sizeof( long ) , V_82 ) ;
if ( V_54 -> V_80 == NULL ) {
F_11 ( L_4
L_5 ) ;
