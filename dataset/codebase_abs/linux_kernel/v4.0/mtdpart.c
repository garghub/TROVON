...
V_74 -> V_2 . V_90 . V_91 = V_12 -> V_90 . V_91 ;
V_74 -> V_2 . V_14 = F_1 ;
V_74 -> V_2 . V_44 = F_15 ;
if ( V_12 -> V_45 )
V_74 -> V_2 . V_45 = F_16 ;
...
if ( V_12 -> V_65 )
V_74 -> V_2 . V_65 = F_26 ;
if ( ! V_80 && ! V_12 -> V_90 . V_92 && V_12 -> V_66 &&
V_12 -> V_67 ) {
V_74 -> V_2 . V_66 = F_27 ;
V_74 -> V_2 . V_67 = F_28 ;
}
...
V_74 -> V_15 = V_81 ;
if ( F_45 ( V_81 , V_12 ) != 0 ) {
V_74 -> V_15 = ( F_46 ( V_81 , V_12 ) + 1 ) * V_12 -> V_95 ;
F_43 ( V_96 L_2
L_3 , V_80 ,
...
if ( V_74 -> V_2 . V_26 == V_99 )
V_74 -> V_2 . V_26 = V_12 -> V_26 - V_74 -> V_15 ;
F_43 ( V_96 L_5 , ( unsigned long long ) V_74 -> V_15 ,
...
T_6 V_104 = V_74 -> V_15 + V_74 -> V_2 . V_26 ;
struct V_105 * V_106 = V_12 -> V_107 ;
for ( V_102 = 0 ; V_102 < V_103 && V_106 [ V_102 ] . V_15 <= V_74 -> V_15 ; V_102 ++ )
;
if ( V_102 > 0 )
V_102 -- ;
for (; V_102 < V_103 && V_106 [ V_102 ] . V_15 < V_104 ; V_102 ++ ) {
if ( V_74 -> V_2 . V_95 < V_106 [ V_102 ] . V_95 ) {
V_74 -> V_2 . V_95 = V_106 [ V_102 ] . V_95 ;
}
}
F_47 ( V_74 -> V_2 . V_95 == 0 ) ;
} else {
V_74 -> V_2 . V_95 = V_12 -> V_95 ;
}
if ( ( V_74 -> V_2 . V_22 & V_108 ) &&
...
V_74 -> V_2 . V_109 = V_12 -> V_109 ;
V_74 -> V_2 . V_110 = V_12 -> V_110 ;
V_74 -> V_2 . V_111 = V_12 -> V_111 ;
V_74 -> V_2 . V_112 = V_12 -> V_112 ;
if ( V_12 -> V_69 ) {
T_5 V_113 = 0 ;
while ( V_113 < V_74 -> V_2 . V_26 ) {
if ( F_48 ( V_12 , V_113 + V_74 -> V_15 ) )
V_74 -> V_2 . V_13 . V_114 ++ ;
else if ( F_49 ( V_12 , V_113 + V_74 -> V_15 ) )
V_74 -> V_2 . V_13 . V_71 ++ ;
V_113 += V_74 -> V_2 . V_95 ;
}
}
...
long long V_15 , long long V_115 )
{
struct V_79 V_8 ;
struct V_7 * V_72 , * V_116 ;
T_5 V_117 , V_104 ;
int V_55 = 0 ;
if ( V_15 == V_93 ||
V_15 == V_94 )
...
if ( V_72 -> V_12 == V_12 ) {
if ( ( V_117 >= V_72 -> V_15 ) &&
( V_117 < ( V_72 -> V_15 + V_72 -> V_2 . V_26 ) ) )
goto V_118;
if ( ( V_104 >= V_72 -> V_15 ) &&
( V_104 < ( V_72 -> V_15 + V_72 -> V_2 . V_26 ) ) )
goto V_118;
}
F_54 ( & V_116 -> V_78 , & V_119 ) ;
F_39 ( & V_77 ) ;
F_55 ( & V_116 -> V_2 ) ;
return V_55 ;
V_118:
...
const struct V_79 * V_121 ,
int V_122 )
{
struct V_7 * V_74 ;
T_5 V_81 = 0 ;
int V_102 ;
F_43 ( V_96 L_10 , V_122 , V_12 -> V_73 ) ;
for ( V_102 = 0 ; V_102 < V_122 ; V_102 ++ ) {
V_74 = F_40 ( V_12 , V_121 + V_102 , V_102 , V_81 ) ;
if ( F_51 ( V_74 ) )
return F_52 ( V_74 ) ;
F_35 ( & V_77 ) ;
F_54 ( & V_74 -> V_78 , & V_119 ) ;
F_39 ( & V_77 ) ;
F_55 ( & V_74 -> V_2 ) ;
...
static struct V_123 * F_58 ( const char * V_73 )
{
struct V_123 * V_72 , * V_55 = NULL ;
F_59 ( & V_124 ) ;
...
void F_62 ( struct V_123 * V_72 )
{
F_59 ( & V_124 ) ;
F_54 ( & V_72 -> V_78 , & V_125 ) ;
F_61 ( & V_124 ) ;
}
void F_63 ( struct V_123 * V_72 )
{
F_59 ( & V_124 ) ;
F_38 ( & V_72 -> V_78 ) ;
F_61 ( & V_124 ) ;
}
int F_64 ( struct V_1 * V_12 , const char * const * V_126 ,
struct V_79 * * V_127 ,
struct V_128 * V_129 )
{
struct V_123 * V_130 ;
...
if ( ! V_126 )
V_126 = V_131 ;
for ( ; V_55 <= 0 && * V_126 ; V_126 ++ ) {
V_130 = F_58 ( * V_126 ) ;
if ( ! V_130 && ! F_65 ( L_11 , * V_126 ) )
V_130 = F_58 ( * V_126 ) ;
if ( ! V_130 )
continue;
V_55 = (* V_130 -> V_132 )( V_12 , V_127 , V_129 ) ;
F_66 ( V_130 ) ;
if ( V_55 > 0 ) {
F_43 ( V_96 L_12 ,
V_55 , V_130 -> V_73 , V_12 -> V_73 ) ;
break;
}
}
return V_55 ;
