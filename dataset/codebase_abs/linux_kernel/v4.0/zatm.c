...
static void F_71 ( struct V_12 * V_12 , unsigned long V_13 ,
...
static unsigned long F_73 ( struct V_12 * V_12 , unsigned short V_209 )
{
unsigned int V_13 ;
int error ;
...
static void F_75 ( struct V_12 * V_12 , unsigned long V_46 ,
...
static void F_76 ( struct V_12 * V_12 , unsigned char * V_215 ,
unsigned short V_209 )
{
int V_10 ;
* V_215 = 0 ;
...
static unsigned char F_77 ( struct V_23 * V_24 , unsigned short V_209 ,
int V_32 , int V_217 )
{
...
if ( ! V_272 [ V_10 ] )
continue;
V_58 = F_87 ( & V_254 -> V_24 ,
2 * F_88 ( V_10 ) , & V_271 , V_121 ) ;
if ( ! V_58 ) {
error = - V_122 ;
goto V_273;
}
...
L_97 , dev->number) ;
F_89 ( & V_254 -> V_24 , 2 * F_88 ( V_10 ) , V_58 , V_271 ) ;
error = - V_274 ;
goto V_273;
}
...
static int F_100 ( struct V_23 * V_24 , unsigned int V_209 , void T_4 * V_288 )
{
struct V_12 * V_12 ;
unsigned long V_30 ;
V_12 = F_9 ( V_24 ) ;
...
if ( V_310 < 0 )
goto V_315;
V_310 = F_115 ( & V_210 -> V_24 , F_116 ( 32 ) ) ;
if ( V_310 < 0 )
goto V_315;
V_12 -> V_210 = V_210 ;
V_24 -> V_282 = V_12 ;
