...
if ( F_53 ( V_88 , L_8 ) )
V_11 -> V_52 |= V_59 ;
F_54 ( V_88 , L_9 , & V_11 -> V_57 ) ;
F_54 ( V_88 , L_10 , & V_11 -> V_61 ) ;
F_54 ( V_88 , L_11 , & V_11 -> V_12 ) ;
...
struct V_97 * V_98 ;
int V_8 ;
V_7 = F_56 ( & V_96 -> V_44 , sizeof( * V_7 ) , V_99 ) ;
if ( V_7 == NULL )
return - V_100 ;
V_7 -> V_44 = & V_96 -> V_44 ;
F_57 ( & V_7 -> V_84 ) ;
...
if ( V_8 < 0 )
return V_8 ;
V_98 = F_59 ( V_96 , V_101 , 0 ) ;
V_7 -> V_102 = F_60 ( & V_96 -> V_44 , V_98 ) ;
if ( F_23 ( V_7 -> V_102 ) )
return F_24 ( V_7 -> V_102 ) ;
V_7 -> clock = F_61 ( & V_96 -> V_44 , NULL ) ;
if ( F_23 ( V_7 -> clock ) ) {
F_20 ( & V_96 -> V_44 , L_15 ) ;
return F_24 ( V_7 -> clock ) ;
}
V_1 = F_59 ( V_96 , V_103 , 0 ) ;
if ( ! V_1 ) {
F_20 ( & V_96 -> V_44 , L_16 ) ;
return - V_92 ;
}
V_8 = F_62 ( & V_96 -> V_44 , V_1 -> V_104 , F_1 ,
...
static int F_64 ( struct V_95 * V_96 )
{
struct V_6 * V_7 = F_65 ( V_96 ) ;
F_10 ( V_7 ) ;
return 0 ;
}
