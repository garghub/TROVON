...
static enum V_105 F_56 ( struct V_39 * V_40 ,
...
V_122 ;
return F_63 ( & V_8 -> V_41 , & V_43 -> V_58 , V_25 ) ;
}
static struct V_56 * F_64 (
...
F_62 ( & V_65 -> V_67 , & V_43 -> V_60 ) ;
V_65 -> V_69 = F_67 ( V_144 ) ;
if ( V_127 == V_140 ) {
V_65 -> V_78 = F_69 ( V_144 ) ;
V_65 -> V_82 = V_129 ;
} else {
V_65 -> V_78 = V_129 ;
V_65 -> V_82 = F_69 ( V_144 ) ;
}
}
return F_63 ( & V_8 -> V_41 , & V_43 -> V_58 , V_25 ) ;
}
...
V_40 = F_73 ( V_148 -> V_34 , sizeof( * V_40 ) , V_149 ) ;
if ( ! V_40 ) {
F_9 ( V_148 -> V_34 ,
L_14 , V_150 ) ;
return - V_151 ;
...
if ( V_19 ) {
V_40 -> V_19 = true ;
V_40 -> V_92 = F_74 ( V_149 , L_15 , V_26 ) ;
if ( ! V_40 -> V_92 )
return - V_151 ;
} else {
V_40 -> V_92 = F_74 ( V_149 , L_16 , V_26 ) ;
if ( ! V_40 -> V_92 )
return - V_151 ;
}
F_38 ( V_148 -> V_34 ,
...
F_75 ( & V_40 -> V_41 , V_148 ) ;
}
F_76 ( V_148 -> V_34 , L_18 ,
V_26 , V_19 ? L_19 : L_20 ) ;
return V_26 ;
}
...
if ( ! V_20 )
return - V_53 ;
V_10 = F_73 ( & V_33 -> V_34 , sizeof( * V_10 ) , V_149 ) ;
if ( ! V_10 )
return - V_151 ;
V_10 -> V_33 = V_33 ;
V_10 -> V_13 = V_13 ;
...
V_10 -> memcpy . V_168 =
F_53 ;
V_10 -> memcpy . V_169 = F_61 ;
V_10 -> memcpy . V_170 = F_56 ;
V_10 -> memcpy . V_171 = F_70 ;
V_10 -> memcpy . V_172 = F_17 ;
V_10 -> memcpy . V_173 = F_51 ;
F_91 ( V_174 , V_10 -> V_19 . V_165 ) ;
F_91 ( V_175 , V_10 -> V_19 . V_165 ) ;
...
V_10 -> V_19 . V_168 =
F_53 ;
V_10 -> V_19 . V_170 = F_56 ;
V_10 -> V_19 . V_171 = F_70 ;
V_10 -> V_19 . V_176 = F_66 ;
V_10 -> V_19 . V_177 = F_64 ;
V_10 -> V_19 . V_172 = F_17 ;
V_10 -> V_19 . V_173 = F_51 ;
...
static int F_96 ( struct V_155 * V_33 )
{
const struct V_12 * V_13 = F_81 ( & V_33 -> V_34 ) ;
...
bool F_98 ( struct V_39 * V_40 , void * V_183 )
{
struct V_7 * V_8 ;
