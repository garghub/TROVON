...
struct V_98 * V_99 ;
V_192 = V_88 & V_194 ;
if ( V_88 & V_195 || V_88 & V_196 )
return - V_197 ;
V_2 = 0 ;
V_99 = F_114 ( & V_66 -> V_64 , V_88 , V_192 , & V_2 ) ;
if ( V_2 )
return V_2 ;
if ( ! V_99 )
return - V_198 ;
...
goto V_90;
V_193 = V_32 -> V_35 ;
if ( V_193 != V_99 -> V_188 - sizeof( * V_32 ) ) {
V_2 = - V_15 ;
goto V_90;
}
if ( V_193 > V_188 ) {
...
V_2 = F_115 ( V_99 , sizeof( * V_32 ) , V_187 , V_193 ) ;
if ( V_2 )
goto V_90;
if ( V_187 -> V_201 ) {
F_116 ( struct V_22 * , V_202 , V_187 -> V_201 ) ;
F_6 ( V_202 , V_32 -> V_23 . V_58 , V_32 -> V_23 . V_108 ) ;
V_187 -> V_203 = sizeof( * V_202 ) ;
}
V_2 = V_193 ;
V_90:
...
static void F_134 ( struct V_65 * V_66 , T_4 V_207 )
{
if ( V_207 < F_63 ( V_66 ) -> V_143 )
F_63 ( V_66 ) -> V_143 = V_207 ;
if ( V_207 > F_63 ( V_66 ) -> V_144 )
F_63 ( V_66 ) -> V_144 = V_207 ;
F_63 ( V_66 ) -> V_145 = V_207 ;
}
static void F_135 ( struct V_65 * V_66 ,
T_4 V_207 )
{
if ( V_207 > F_63 ( V_66 ) -> V_145 )
F_63 ( V_66 ) -> V_145 = V_207 ;
F_63 ( V_66 ) -> V_143 = V_207 ;
}
...
bool * V_209 )
{
return F_63 ( V_66 ) -> V_113 -> V_210 (
& V_66 -> V_64 , V_208 , V_209 ) ;
}
static int F_138 (
struct V_65 * V_66 ,
T_6 V_208 ,
bool * V_211 )
{
return F_63 ( V_66 ) -> V_113 -> V_212 (
& V_66 -> V_64 , V_208 , V_211 ) ;
}
static int F_139 (
struct V_65 * V_66 ,
T_6 V_208 ,
