...
struct V_21 * V_22 = F_33 ( V_29 ) ;
if ( V_29 -> V_64 != V_65 )
return V_66 ;
if ( F_34 ( V_29 ) != V_67 )
return V_66 ;
F_35 ( & V_22 -> V_34 ) ;
F_36 ( V_20 -> V_68 , & V_22 -> V_56 ) ;
return V_69 ;
}
static int F_37 ( void * V_70 , struct V_28 * V_29 ,
unsigned int V_71 ,
unsigned int V_72 ,
unsigned int V_73 )
{
struct V_21 * V_22 = F_33 ( V_29 ) ;
F_38 ( V_22 -> V_34 . V_57 , V_74 ) ;
F_39 ( & V_22 -> V_56 , F_27 ) ;
return 0 ;
}
int F_40 ( struct V_75 * V_76 )
{
struct V_19 * V_20 ;
struct V_48 * V_47 ;
...
F_22 ( & V_81 ) ;
V_20 = F_41 ( sizeof( struct V_19 ) , V_83 ) ;
if ( ! V_20 )
return - V_84 ;
F_42 ( & V_20 -> V_40 ) ;
V_20 -> V_16 = V_76 -> V_16 ;
...
V_20 -> V_68 = F_48 ( L_9 , 0 , 0 , V_47 -> V_94 ) ;
if ( ! V_20 -> V_68 ) {
V_5 = - V_84 ;
goto V_107;
}
F_16 ( & V_81 ) ;
F_49 ( & V_20 -> V_108 , & V_109 ) ;
F_22 ( & V_81 ) ;
F_50 ( V_20 -> V_47 ) ;
F_51 ( F_20 ( V_20 -> V_47 ) , L_10 ,
...
F_64 ( const char * V_18 , int V_16 , int V_17 )
{
if ( V_16 == - 1 )
return F_65 ( V_18 , V_46 ) ;
else if ( V_17 == - 1 )
return F_66 ( V_16 , V_18 , V_46 ) ;
else
...
V_126 = & V_7 [ V_4 ] ;
V_33 = F_64 ( V_126 -> V_18 , V_126 -> V_16 , V_126 -> V_17 ) ;
if ( F_18 ( V_33 ) ) {
F_4 (
L_14 ,
...
struct V_19 * V_127 ;
struct V_19 * V_20 ;
F_70 (dev, next, &ubiblock_devices, list) {
F_71 ( V_20 -> V_33 ) ;
F_60 ( & V_20 -> V_108 ) ;
F_56 ( V_20 ) ;
F_55 ( V_20 ) ;
