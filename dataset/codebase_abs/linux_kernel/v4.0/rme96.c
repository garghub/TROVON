...
static T_7 F_112 ( struct V_238 * V_239 )
{
T_7 V_17 = 0 ;
...
static void F_113 ( struct V_238 * V_239 , T_7 V_17 )
{
...
static int F_133 ( struct V_78 * V_193 )
{
struct V_253 * V_156 = F_129 ( V_193 ) ;
struct V_1 * V_1 = V_156 -> V_183 ;
...
static void F_136 ( struct V_253 * V_156 )
{
F_69 ( V_156 -> V_183 ) ;
}
static int
F_137 ( struct V_191 * V_77 ,
...
V_100 = F_138 ( & V_77 -> V_193 , V_269 [ V_193 ] , V_159 [ V_193 ] , V_270 ,
...
#endif
strcpy ( V_156 -> V_271 , L_67 ) ;
switch ( V_1 -> V_77 -> V_78 ) {
case V_204 :
strcpy ( V_156 -> V_272 , L_68 ) ;
break;
case V_234 :
...
sprintf ( V_156 -> V_213 , L_73 , V_156 -> V_272 ,
V_1 -> V_104 , V_1 -> V_137 ) ;
if ( ( V_100 = F_141 ( V_156 ) ) < 0 ) {
F_139 ( V_156 ) ;
return V_100 ;
}
F_142 ( V_77 , V_156 ) ;
...
static void F_143 ( struct V_191 * V_77 )
{
F_139 ( F_144 ( V_77 ) ) ;
}
