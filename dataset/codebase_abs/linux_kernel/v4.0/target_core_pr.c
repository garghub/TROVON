...
{
unsigned char * V_3 ;
int V_41 , V_240 = V_254 ;
if ( ! V_122 ) {
char * V_255 = L_110 ;
V_41 = F_69 ( V_10 , V_255 ) ;
V_10 -> V_28 . V_175 = 0 ;
F_11 ( L_111 ) ;
if ( V_41 )
return V_227 ;
...
static T_2
F_78 ( struct V_7 * V_8 , T_3 V_258 , T_3 V_120 ,
bool V_122 , bool V_121 , bool V_259 , enum V_176 V_176 )
{
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_59 * V_51 ;
...
if ( ( V_176 == REGISTER ) && ( V_258 != V_2 -> V_111 ) ) {
F_9 ( L_119
L_120
L_121
L_122 , V_258 ,
...
static T_2
F_80 ( struct V_7 * V_8 , int type , int V_266 , T_3 V_258 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_49 * V_49 = V_8 -> V_49 ;
...
static T_2
F_81 ( struct V_7 * V_8 , int type , int V_266 ,
T_3 V_258 )
{
switch ( type ) {
case V_69 :
...
case V_34 :
case V_35 :
return F_80 ( V_8 , type , V_266 , V_258 ) ;
default:
F_9 ( L_149
L_150 , type ) ;
return V_263 ;
...
int V_271 )
{
struct V_143 * V_144 = V_269 -> V_42 -> V_47 ;
char V_169 [ V_170 ] ;
int V_31 = 0 , V_161 = 0 ;
memset ( V_169 , 0 , V_170 ) ;
F_1 ( V_2 , V_169 , V_170 ) ;
...
F_11 ( L_151
L_148 ,
V_144 -> V_48 () , ( V_270 ) ? L_152 :
L_153 , F_15 ( V_31 ) ,
( V_2 -> V_134 ) ? 1 : 0 ) ;
}
F_11 ( L_154 ,
V_144 -> V_48 () , V_269 -> V_53 ,
V_169 ) ;
V_2 -> V_30 = V_2 -> V_31 = V_2 -> V_161 = 0 ;
}
static T_2
F_84 ( struct V_7 * V_8 , int type , int V_266 ,
T_3 V_258 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_49 * V_49 = V_8 -> V_49 ;
struct V_1 * V_2 , * V_260 , * V_30 ;
struct V_26 * V_27 = & V_10 -> V_28 ;
int V_63 = 0 ;
T_2 V_55 = 0 ;
if ( ! V_14 || ! V_49 ) {
...
static T_2
F_85 ( struct V_7 * V_8 , T_3 V_258 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_20 * V_112 ;
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_26 * V_27 = & V_10 -> V_28 ;
struct V_1 * V_2 , * V_146 , * V_274 , * V_30 ;
T_1 V_132 = 0 ;
int V_275 = 0 ;
V_274 = F_4 ( V_8 -> V_11 ,
V_14 -> V_20 , V_14 ) ;
...
if ( V_258 != V_274 -> V_111 ) {
F_9 ( L_119
L_120
L_121
L_122 , V_258 , V_274 -> V_111 ) ;
F_5 ( V_274 ) ;
return V_21 ;
}
F_6 ( & V_10 -> V_44 ) ;
...
F_11 ( L_162
L_148 ,
V_144 -> V_48 () , ( V_277 == V_278 ) ? L_163 : L_30 ,
F_15 ( type ) ,
( V_2 -> V_134 ) ? 1 : 0 ) ;
F_11 ( L_164 ,
V_144 -> V_48 () , ( V_277 == V_278 ) ? L_163 : L_30 ,
...
static T_2
F_88 ( struct V_7 * V_8 , int type , int V_266 , T_3 V_258 ,
T_3 V_120 , enum V_277 V_277 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_20 * V_112 ;
struct V_12 * V_14 = V_8 -> V_14 ;
...
if ( ! V_14 )
return V_227 ;
V_274 = F_4 ( V_8 -> V_11 , V_14 -> V_20 ,
V_14 ) ;
if ( ! V_274 ) {
F_9 ( L_137
L_166 ,
( V_277 == V_278 ) ? L_163 : L_30 ) ;
return V_21 ;
}
if ( V_274 -> V_111 != V_258 ) {
F_5 ( V_274 ) ;
return V_21 ;
}
if ( V_266 != V_268 ) {
...
static T_2
F_90 ( struct V_7 * V_8 , int type , int V_266 ,
T_3 V_258 , T_3 V_120 , enum V_277 V_277 )
{
switch ( type ) {
case V_69 :
case V_70 :
...
case V_34 :
case V_35 :
return F_88 ( V_8 , type , V_266 , V_258 ,
V_120 , V_277 ) ;
default:
F_9 ( L_167
L_168 , ( V_277 == V_278 ) ? L_163 : L_30 , type ) ;
return V_263 ;
}
}
static T_2
F_91 ( struct V_7 * V_8 , T_3 V_258 ,
T_3 V_120 , int V_122 , int V_271 )
{
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_9 * V_10 = V_8 -> V_11 ;
...
struct V_140 * V_140 ;
struct V_39 * V_42 , * V_284 = NULL ;
struct V_143 * V_285 = NULL , * V_286 ;
...
V_287 = V_285 -> V_234 ( V_284 ,
( const char * ) & V_3 [ 24 ] , & V_288 , & V_222 ) ;
if ( ! V_287 ) {
F_9 ( L_179
L_188 ) ;
V_55 = V_230 ;
...
V_3 = NULL ;
F_11 ( L_189
L_190 , V_285 -> V_48 () , ( V_222 != NULL ) ?
L_191 : L_192 , V_287 , ( V_222 != NULL ) ?
V_222 : L_30 ) ;
V_112 = V_2 -> V_112 ;
V_290 = ( ! strcmp ( V_287 ,
V_112 -> V_53 ) ) ? 1 : 0 ;
...
L_202 , V_285 -> V_48 () ,
V_206 -> V_53 ) ;
V_207 = F_66 ( V_206 , V_291 ) ;
if ( ! V_207 ) {
F_9 ( L_203
L_181 , V_285 -> V_48 () , V_291 ) ;
V_55 = V_230 ;
goto V_43;
}
if ( F_30 ( V_207 ) ) {
...
static unsigned long long F_92 ( unsigned char * V_58 )
{
unsigned int V_293 , V_294 ;
V_293 = ( V_58 [ 0 ] << 24 ) | ( V_58 [ 1 ] << 16 ) | ( V_58 [ 2 ] << 8 ) | V_58 [ 3 ] ;
V_294 = ( V_58 [ 4 ] << 24 ) | ( V_58 [ 5 ] << 16 ) | ( V_58 [ 6 ] << 8 ) | V_58 [ 7 ] ;
return ( ( unsigned long long ) V_294 ) | ( unsigned long long ) V_293 << 32 ;
}
T_2
F_93 ( struct V_7 * V_8 )
{
...
unsigned char * V_3 ;
T_3 V_258 , V_120 ;
int V_295 , V_266 , type , V_122 ;
int V_259 = 0 , V_121 = 0 , V_271 = 0 ;
T_2 V_55 ;
...
F_67 ( V_8 ) ;
V_3 = NULL ;
if ( V_259 && ( ( V_58 [ 1 ] & 0x1f ) != V_83 ) )
return V_230 ;
if ( ! V_259 && ( ( V_58 [ 1 ] & 0x1f ) != V_85 ) &&
( V_8 -> V_229 != 24 ) ) {
F_61 ( L_221
L_222 , V_8 -> V_229 ) ;
return V_230 ;
...
case V_83 :
V_55 = F_78 ( V_8 ,
V_258 , V_120 , V_122 , V_121 , V_259 , REGISTER ) ;
break;
case V_86 :
V_55 = F_81 ( V_8 , type , V_266 , V_258 ) ;
break;
case V_87 :
V_55 = F_84 ( V_8 , type , V_266 , V_258 ) ;
break;
case V_80 :
V_55 = F_85 ( V_8 , V_258 ) ;
break;
case V_81 :
V_55 = F_90 ( V_8 , type , V_266 ,
V_258 , V_120 , V_297 ) ;
break;
case V_82 :
V_55 = F_90 ( V_8 , type , V_266 ,
...
case V_84 :
V_55 = F_78 ( V_8 ,
0 , V_120 , V_122 , V_121 , V_259 , V_178 ) ;
break;
case V_85 :
V_55 = F_91 ( V_8 , V_258 ,
V_120 , V_122 , V_271 ) ;
...
F_28 (pr_reg, &dev->t10_pr.registration_list,
pr_reg_list) {
if ( ( V_298 + 8 ) > ( V_8 -> V_229 - 8 ) )
break;
V_3 [ V_299 ++ ] = ( ( V_2 -> V_111 >> 56 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( ( V_2 -> V_111 >> 48 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( ( V_2 -> V_111 >> 40 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( ( V_2 -> V_111 >> 32 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( ( V_2 -> V_111 >> 24 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( ( V_2 -> V_111 >> 16 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( ( V_2 -> V_111 >> 8 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( V_2 -> V_111 & 0xff ) ;
V_298 += 8 ;
}
F_8 ( & V_10 -> V_28 . V_36 ) ;
V_3 [ 4 ] = ( ( V_298 >> 24 ) & 0xff ) ;
...
struct V_26 * V_27 = & V_10 -> V_28 ;
unsigned char * V_3 ;
T_1 V_301 = 0 , V_298 = 0 , V_302 , V_303 ;
T_1 V_299 = 8 ;
int V_304 = 0 , V_31 = 0 , V_161 = 0 ;
bool V_63 = false ;
if ( V_8 -> V_229 < 8 ) {
F_9 ( L_228
L_224 , V_8 -> V_229 ) ;
...
F_26 ( & V_2 -> V_130 ) ;
F_8 ( & V_27 -> V_36 ) ;
V_303 = V_42 -> V_47 -> V_305 (
V_42 , V_269 , V_2 , & V_304 ) ;
if ( ( V_303 + V_298 ) > V_8 -> V_229 ) {
F_61 ( L_229
L_230 , V_8 -> V_229 ) ;
F_6 ( & V_27 -> V_36 ) ;
F_31 ( & V_2 -> V_130 ) ;
...
if ( V_2 -> V_30 ) {
V_3 [ V_299 ++ ] |= 0x01 ;
V_3 [ V_299 ++ ] = ( V_2 -> V_161 & 0xf0 ) |
( V_2 -> V_31 & 0x0f ) ;
} else if ( V_63 ) {
V_3 [ V_299 ++ ] |= 0x01 ;
V_3 [ V_299 ++ ] = ( V_161 & 0xf0 ) |
( V_31 & 0x0f ) ;
} else {
V_299 += 2 ;
}
...
V_3 [ V_299 ++ ] = ( ( V_141 -> V_235 >> 8 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( V_141 -> V_235 & 0xff ) ;
} else
V_299 += 2 ;
V_302 = V_42 -> V_47 -> V_306 ( V_42 ,
V_269 , V_2 , & V_304 , & V_3 [ V_299 + 4 ] ) ;
F_6 ( & V_27 -> V_36 ) ;
F_31 ( & V_2 -> V_130 ) ;
V_3 [ V_299 ++ ] = ( ( V_302 >> 24 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( ( V_302 >> 16 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( ( V_302 >> 8 ) & 0xff ) ;
V_3 [ V_299 ++ ] = ( V_302 & 0xff ) ;
V_301 = ( 24 + V_302 ) ;
V_299 += V_302 ;
V_298 += V_301 ;
}
...
if ( ! V_8 -> V_14 )
return 0 ;
if ( V_10 -> V_311 -> V_312 & V_313 )
return 0 ;
if ( V_10 -> V_179 -> V_314 == V_315 )
return 0 ;
F_6 ( & V_10 -> V_44 ) ;
if ( V_10 -> V_22 & V_46 )
V_55 = F_2 ( V_8 ) ;
