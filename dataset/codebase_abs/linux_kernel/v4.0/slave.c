...
if ( V_6 -> V_9 -> V_128 )
V_124 = V_6 -> V_9 -> V_128 ( V_6 , V_28 -> V_45 ) ;
if ( V_121 )
...
F_64 ( V_28 -> V_46 , F_56 ) ;
if ( ! V_28 -> V_46 ) {
V_28 -> V_46 = V_6 -> V_13 -> V_129 [ V_28 -> V_45 ] ;
if ( ! V_28 -> V_46 )
return - V_130 ;
V_28 -> V_127 = V_28 -> V_46 -> V_131 ;
...
struct V_25 *
F_73 ( struct V_5 * V_6 , struct V_132 * V_22 ,
int V_45 , char * V_14 )
{
...
if ( V_117 == NULL )
return V_117 ;
V_117 -> V_135 = V_33 -> V_136 ;
V_117 -> V_137 = & V_138 ;
F_75 ( V_117 , V_33 ) ;
V_117 -> V_139 = 0 ;
V_117 -> V_140 = & V_141 ;
F_76 ( V_117 , V_22 ) ;
V_117 -> V_26 . V_142 = V_6 -> V_20 -> V_122 [ V_45 ] ;
V_117 -> V_136 = V_33 -> V_136 ;
V_28 = F_5 ( V_117 ) ;
V_28 -> V_26 = V_117 ;
V_28 -> V_22 = V_6 ;
V_28 -> V_45 = V_45 ;
switch ( V_6 -> V_30 -> V_143 ) {
#ifdef F_77
case V_144 :
V_28 -> V_60 = V_145 . V_60 ;
break;
#endif
#ifdef F_78
case V_146 :
V_28 -> V_60 = V_147 . V_60 ;
break;
#endif
#ifdef F_79
case V_148 :
V_28 -> V_60 = V_149 . V_60 ;
break;
#endif
#ifdef F_80
case V_150 :
V_28 -> V_60 = V_151 . V_60 ;
break;
#endif
default:
V_28 -> V_60 = F_27 ;
