...
int F_24 ( struct V_1 * V_2 , struct V_31 * V_25 ,
bool V_63 )
{
struct V_64 * V_65 ;
T_1 V_66 , V_41 ;
int V_67 = 0 ;
if ( ! V_2 || V_25 -> V_55 -> V_57 != V_58 ) {
goto V_40;
}
V_65 = V_2 -> V_25 -> V_55 -> V_68 ;
V_67 = F_25 ( V_65 , V_69 , & V_41 ) ;
if ( V_67 )
goto V_40;
V_66 = F_26 ( V_25 -> V_33 ) << 8 ;
if ( V_63 )
V_41 |= V_66 ;
else
V_41 &= ~ V_66 ;
V_67 = F_27 ( V_65 , V_69 , V_41 ) ;
V_40:
return V_67 ;
}
static void F_28 ( struct V_1 * V_2 , bool V_70 )
{
T_1 V_71 ;
V_71 = F_1 ( V_2 , V_72 ) ;
if ( V_70 )
