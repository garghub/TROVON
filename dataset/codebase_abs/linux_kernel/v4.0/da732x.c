...
V_2 -> V_61 . V_234 = V_227 ;
return 0 ;
}
static int F_31 ( struct V_272 * V_273 ,
const struct V_274 * V_114 )
{
struct V_157 * V_158 ;
unsigned int V_47 ;
int V_5 ;
V_158 = F_32 ( & V_273 -> V_170 , sizeof( struct V_157 ) ,
V_275 ) ;
if ( ! V_158 )
return - V_276 ;
F_33 ( V_273 , V_158 ) ;
V_158 -> V_269 = F_34 ( V_273 , & V_277 ) ;
if ( F_35 ( V_158 -> V_269 ) ) {
V_5 = F_36 ( V_158 -> V_269 ) ;
F_19 ( & V_273 -> V_170 , L_3 ) ;
goto V_278;
}
V_5 = F_37 ( V_158 -> V_269 , V_279 , & V_47 ) ;
if ( V_5 < 0 ) {
F_19 ( & V_273 -> V_170 , L_4 , V_5 ) ;
goto V_278;
}
F_38 ( & V_273 -> V_170 , L_5 ,
( V_47 & V_280 ) >> 4 ,
( V_47 & V_281 ) ) ;
V_5 = F_39 ( & V_273 -> V_170 , & V_282 ,
V_283 , F_40 ( V_283 ) ) ;
if ( V_5 != 0 )
F_19 ( & V_273 -> V_170 , L_6 ) ;
V_278:
return V_5 ;
}
static int F_41 ( struct V_272 * V_284 )
{
F_42 ( & V_284 -> V_170 ) ;
return 0 ;
}
