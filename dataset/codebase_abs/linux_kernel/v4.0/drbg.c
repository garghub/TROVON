...
int V_27 = 0 ;
* V_105 = true ;
if ( ! memcmp ( V_140 , L_27 , 10 ) ) {
V_141 = 10 ;
* V_105 = false ;
} else if ( ! memcmp ( V_140 , L_28 , 8 ) ) {
V_141 = 8 ;
} else {
return;
}
...
memcpy ( V_157 -> V_142 , L_34 , 6 ) ;
if ( V_105 ) {
memcpy ( V_157 -> V_140 , L_28 , 8 ) ;
V_26 = 8 ;
} else {
memcpy ( V_157 -> V_140 , L_27 , 10 ) ;
V_26 = 10 ;
}
