...
return V_118 ;
F_42 ( 10 ) ;
F_43 ( V_10 -> V_168 , false ) ;
V_118 = F_44 ( V_10 -> V_168 ) ;
if ( V_118 != 0 ) {
F_18 ( V_7 -> V_88 ,
L_9 , V_118 ) ;
F_43 ( V_10 -> V_168 , true ) ;
F_45 ( F_41 ( V_10 -> V_167 ) ,
V_10 -> V_167 ) ;
return V_118 ;
}
}
...
static bool F_46 ( struct V_169 * V_88 , unsigned int V_31 )
{
switch ( V_31 ) {
case V_170 :
case V_45 :
...
static bool F_47 ( struct V_169 * V_88 , unsigned int V_31 )
{
switch ( V_31 ) {
case V_170 :
case V_172 :
...
int V_216 ;
struct V_9 * V_10 = F_3 ( V_7 ) ;
V_212 = F_49 ( V_10 -> V_167 [ V_217 ] . V_218 ) ;
V_213 = F_49 ( V_10 -> V_167 [ V_219 ] . V_218 ) ;
V_211 = F_49 ( V_10 -> V_167 [ V_220 ] . V_218 ) ;
V_212 = V_212 / 1000 ;
V_213 = V_213 / 1000 ;
V_211 = V_211 / 1000 ;
...
struct V_9 * V_10 = F_3 ( V_7 ) ;
int V_118 ;
V_118 = F_29 ( V_7 , & V_240 , V_241 ) ;
if ( V_118 ) {
F_18 ( V_7 -> V_88 ,
L_12 , V_118 ) ;
return V_118 ;
}
V_10 -> V_167 [ V_220 ] . V_242 = V_243 ;
F_51 ( V_7 -> V_88 , L_13 ) ;
return 0 ;
}
...
struct V_9 * V_10 = F_3 ( V_7 ) ;
struct V_246 * V_211 ;
for ( V_244 = 0 ; V_244 < F_41 ( V_10 -> V_167 ) ; V_244 ++ )
V_10 -> V_167 [ V_244 ] . V_242 = V_247 [ V_244 ] ;
if ( V_10 -> V_248 < 0x11 ) {
V_211 = F_53 ( V_7 -> V_88 , L_14 ) ;
if ( F_35 ( V_211 ) ) {
if ( F_36 ( V_211 ) == - V_249 )
return - V_249 ;
} else {
...
V_118 = F_55 ( V_7 -> V_88 , F_41 ( V_10 -> V_167 ) ,
V_10 -> V_167 ) ;
if ( V_118 )
goto V_250;
V_118 = F_40 ( F_41 ( V_10 -> V_167 ) ,
V_10 -> V_167 ) ;
if ( V_118 )
goto V_251;
F_42 ( 10 ) ;
...
{
int V_244 , V_118 , V_262 , V_263 ;
for ( V_244 = 0 ; V_244 < F_41 ( V_264 ) ; V_244 ++ ) {
V_262 = V_264 [ V_244 ] . V_265 ;
V_263 = V_264 [ V_244 ] . V_31 ;
V_118 = F_60 ( V_10 -> V_168 , V_263 , V_262 ) ;
if ( V_118 )
return V_118 ;
}
return 0 ;
}
static int F_61 ( struct V_266 * V_267 ,
const struct V_268 * V_269 )
{
struct V_9 * V_10 ;
int V_118 , V_31 , V_270 ;
struct V_271 * V_272 = V_267 -> V_88 . V_273 ;
T_1 V_26 ;
V_10 = F_62 ( & V_267 -> V_88 , sizeof( * V_10 ) , V_149 ) ;
if ( ! V_10 )
return - V_150 ;
V_10 -> V_168 = F_63 ( V_267 , & V_274 ) ;
if ( F_35 ( V_10 -> V_168 ) ) {
V_118 = F_36 ( V_10 -> V_168 ) ;
F_18 ( & V_267 -> V_88 , L_15 , V_118 ) ;
return V_118 ;
}
V_10 -> V_275 = F_64 ( & V_267 -> V_88 , NULL ) ;
if ( F_35 ( V_10 -> V_275 ) ) {
V_118 = F_36 ( V_10 -> V_275 ) ;
F_18 ( & V_267 -> V_88 , L_16 , V_118 ) ;
if ( V_118 == - V_276 )
return - V_249 ;
return V_118 ;
}
V_118 = F_65 ( V_10 -> V_275 ) ;
if ( V_118 )
return V_118 ;
F_42 ( 1 ) ;
V_118 = F_66 ( V_10 -> V_168 , V_170 , & V_31 ) ;
if ( V_118 )
goto V_277;
if ( ( ( V_31 & V_278 ) >> V_279 ) !=
V_280 ) {
...
V_270 = ( V_31 & V_282 ) >> V_283 ;
F_51 ( & V_267 -> V_88 , L_18 , V_270 ) ;
V_10 -> V_248 = V_270 ;
if ( V_272 ) {
if ( ! F_67 ( V_272 ,
L_19 , & V_26 ) ) {
...
static int F_71 ( struct V_266 * V_267 )
{
struct V_9 * V_10 = F_72 ( V_267 ) ;
F_73 ( & V_267 -> V_88 ) ;
F_70 ( V_10 -> V_275 ) ;
return 0 ;
}
