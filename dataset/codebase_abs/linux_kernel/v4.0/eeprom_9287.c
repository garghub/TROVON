...
if ( V_2 -> V_294 ) {
int V_295 ;
V_295 = ( F_45 ( V_128 ) ) ? V_46 : 0 ;
F_53 ( V_2 , V_185 , V_128 , V_295 ) ;
F_29 ( V_2 , V_296 ,
V_228 | V_297 ) ;
} else {
F_29 ( V_2 , V_296 , V_228 ) ;
}
F_37 ( V_2 ) ;
}
...
int V_84 ;
V_103 = & V_8 -> V_58 ;
F_29 ( V_2 , V_299 , V_103 -> V_27 ) ;
for ( V_84 = 0 ; V_84 < V_92 ; V_84 ++ ) {
V_163 = V_84 * 0x1000 ;
F_29 ( V_2 , V_300 + V_163 ,
V_103 -> V_26 [ V_84 ] ) ;
F_29 ( V_2 , F_55 ( 0 ) + V_163 ,
( F_28 ( V_2 , F_55 ( 0 ) + V_163 )
& ~ ( V_301 |
V_302 ) ) |
...
V_301 ) ) ;
V_298 = V_103 -> V_30 [ V_84 ] ;
F_32 ( V_2 , V_303 + V_163 ,
V_304 ,
V_103 -> V_48 [ V_84 ] ) ;
F_32 ( V_2 , V_303 + V_163 ,
V_305 ,
V_103 -> V_47 [ V_84 ] ) ;
F_32 ( V_2 , V_306 + V_163 ,
V_307 ,
V_298 ) ;
F_32 ( V_2 , V_306 + V_163 ,
V_308 ,
...
V_312 , V_103 -> V_32 ) ;
F_29 ( V_2 , V_313 ,
F_35 ( V_103 -> V_33 , V_314 )
| F_35 ( V_103 -> V_33 , V_315 )
| F_35 ( V_103 -> V_35 , V_316 )
| F_35 ( V_103 -> V_35 , V_317 ) ) ;
F_32 ( V_2 , V_318 ,
V_319 , V_103 -> V_34 ) ;
F_32 ( V_2 , V_320 ,
V_321 , V_103 -> V_36 ) ;
...
V_329 |
V_330 ) ;
V_164 |= ( F_35 ( V_103 -> V_50 , V_325 ) |
F_35 ( V_103 -> V_331 , V_326 ) |
F_35 ( V_103 -> V_51 , V_327 ) |
F_35 ( V_103 -> V_52 , V_328 ) |
F_35 ( V_103 -> V_53 , V_329 ) |
F_35 ( V_103 -> V_54 , V_330 ) ) ;
F_56 ( V_2 , V_324 , V_164 ) ;
V_164 = F_28 ( V_2 , V_332 ) ;
V_164 &= ~ ( V_325 |
V_326 |
V_327 |
V_328 |
