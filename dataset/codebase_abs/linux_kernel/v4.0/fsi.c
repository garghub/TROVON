...
V_24 -> V_202 ,
V_203 ,
V_24 -> V_204 -> V_205 -> V_66 ,
V_206 , V_207 ) ;
}
static void F_132 ( char * V_208 ,
struct V_209 * V_210 ,
struct V_211 * V_212 ,
struct V_70 * V_66 )
{
...
for ( V_123 = 0 ; V_123 < F_133 ( V_214 ) ; V_123 ++ ) {
sprintf ( V_213 , L_39 , V_208 , V_214 [ V_123 ] . V_208 ) ;
if ( F_134 ( V_210 , V_213 , NULL ) )
V_8 |= V_214 [ V_123 ] . V_4 ;
}
V_212 -> V_8 = V_8 ;
F_41 ( V_66 , L_40 , V_208 , V_212 -> V_8 ) ;
}
...
V_14 -> V_53 . V_55 = V_14 ;
if ( V_212 -> V_218 ) {
V_14 -> V_49 . V_157 = V_212 -> V_218 ;
V_14 -> V_49 . V_164 = & V_219 ;
}
}
static int F_137 ( struct V_220 * V_221 )
{
struct V_5 * V_6 ;
struct V_209 * V_210 = V_221 -> V_66 . V_222 ;
struct V_223 V_212 ;
...
V_228 = F_138 ( V_229 , & V_221 -> V_66 ) ;
if ( V_228 ) {
V_11 = V_228 -> V_2 ;
F_132 ( L_41 , V_210 , & V_212 . V_230 , & V_221 -> V_66 ) ;
F_132 ( L_42 , V_210 , & V_212 . V_231 , & V_221 -> V_66 ) ;
}
} else {
...
if ( V_221 -> V_66 . V_235 )
memcpy ( & V_212 , V_221 -> V_66 . V_235 , sizeof( V_212 ) ) ;
}
if ( ! V_11 ) {
F_36 ( & V_221 -> V_66 , L_43 ) ;
return - V_236 ;
}
V_226 = F_139 ( V_221 , V_237 , 0 ) ;
V_134 = F_140 ( V_221 , 0 ) ;
if ( ! V_226 || ( int ) V_134 <= 0 ) {
F_36 ( & V_221 -> V_66 , L_44 ) ;
return - V_236 ;
}
V_6 = F_141 ( & V_221 -> V_66 , sizeof( * V_6 ) , V_238 ) ;
if ( ! V_6 ) {
F_36 ( & V_221 -> V_66 , L_45 ) ;
return - V_239 ;
}
V_6 -> V_10 = F_142 ( & V_221 -> V_66 ,
V_226 -> V_153 , F_143 ( V_226 ) ) ;
if ( ! V_6 -> V_10 ) {
...
V_14 -> V_10 = V_6 -> V_10 ;
V_14 -> V_6 = V_6 ;
F_135 ( V_14 , & V_212 . V_230 ) ;
F_136 ( V_14 , & V_212 . V_230 ) ;
...
V_14 -> V_6 = V_6 ;
F_135 ( V_14 , & V_212 . V_231 ) ;
F_136 ( V_14 , & V_212 . V_231 ) ;
V_7 = F_38 ( V_14 , & V_221 -> V_66 ) ;
if ( V_7 < 0 ) {
...
F_145 ( & V_221 -> V_66 ) ;
F_146 ( & V_221 -> V_66 , V_6 ) ;
V_7 = F_147 ( & V_221 -> V_66 , V_134 , & F_87 , 0 ,
F_148 ( & V_221 -> V_66 ) , V_6 ) ;
if ( V_7 ) {
F_36 ( & V_221 -> V_66 , L_49 ) ;
goto V_242;
}
V_7 = F_149 ( & V_221 -> V_66 , & V_243 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_221 -> V_66 , L_50 ) ;
goto V_242;
}
V_7 = F_150 ( & V_221 -> V_66 , & V_244 ,
V_245 , F_133 ( V_245 ) ) ;
if ( V_7 < 0 ) {
F_36 ( & V_221 -> V_66 , L_51 ) ;
goto V_246;
}
return V_7 ;
V_246:
...
static int F_158 ( struct V_70 * V_66 )
{
struct V_5 * V_6 = F_154 ( V_66 ) ;
struct V_13 * V_29 = & V_6 -> V_29 ;
struct V_13 * V_30 = & V_6 -> V_30 ;
F_156 ( V_29 , & V_29 -> V_49 , V_66 ) ;
F_156 ( V_29 , & V_29 -> V_53 , V_66 ) ;
F_156 ( V_30 , & V_30 -> V_49 , V_66 ) ;
F_156 ( V_30 , & V_30 -> V_53 , V_66 ) ;
return 0 ;
}
static int F_159 ( struct V_70 * V_66 )
{
struct V_5 * V_6 = F_154 ( V_66 ) ;
struct V_13 * V_29 = & V_6 -> V_29 ;
struct V_13 * V_30 = & V_6 -> V_30 ;
F_157 ( V_29 , & V_29 -> V_49 , V_66 ) ;
F_157 ( V_29 , & V_29 -> V_53 , V_66 ) ;
F_157 ( V_30 , & V_30 -> V_49 , V_66 ) ;
F_157 ( V_30 , & V_30 -> V_53 , V_66 ) ;
return 0 ;
}
