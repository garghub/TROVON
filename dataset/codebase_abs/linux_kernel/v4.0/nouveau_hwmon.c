...
static T_1
F_24 ( struct V_1 * V_2 , struct V_3 * V_28 ,
char * V_5 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_8 * V_9 = V_8 ( V_7 ) ;
...
F_33 ( struct V_6 * V_7 )
{
#if F_34 ( V_37 ) || ( F_34 ( V_38 ) && F_34 ( V_39 ) )
struct V_8 * V_9 = V_8 ( V_7 ) ;
struct V_10 * V_11 = F_3 ( & V_9 -> V_1 ) ;
struct V_40 * V_41 ;
struct V_1 * V_42 ;
int V_30 = 0 ;
V_41 = V_9 -> V_41 = F_35 ( sizeof( * V_41 ) , V_43 ) ;
if ( ! V_41 )
return - V_44 ;
V_41 -> V_7 = V_7 ;
if ( ! V_11 || ! V_11 -> V_13 || ! V_11 -> V_15 || ! V_11 -> V_20 )
return - V_33 ;
V_42 = F_36 ( & V_7 -> V_45 -> V_7 ) ;
if ( F_37 ( V_42 ) ) {
V_30 = F_38 ( V_42 ) ;
F_39 ( V_9 , L_5 , V_30 ) ;
return V_30 ;
...
F_40 ( V_42 , V_7 ) ;
V_30 = F_41 ( & V_42 -> V_46 , & V_47 ) ;
if ( V_30 )
goto error;
if ( V_11 -> V_13 ( V_11 ) >= 0 ) {
V_30 = F_41 ( & V_42 -> V_46 , & V_48 ) ;
if ( V_30 )
goto error;
}
...
if ( V_41 -> V_41 ) {
F_44 ( & V_41 -> V_41 -> V_46 , & V_47 ) ;
F_44 ( & V_41 -> V_41 -> V_46 , & V_48 ) ;
F_44 ( & V_41 -> V_41 -> V_46 , & V_49 ) ;
F_44 ( & V_41 -> V_41 -> V_46 , & V_50 ) ;
F_42 ( V_41 -> V_41 ) ;
}
V_8 ( V_7 ) -> V_41 = NULL ;
F_45 ( V_41 ) ;
