...
static int F_137 ( void * V_31 , void * V_32 , int V_34 )
{
int error = 0 ;
struct V_1 * V_1 = V_31 ;
struct V_25 * V_26 = V_1 -> V_79 ;
...
static int F_138 ( struct V_25 * V_26 , struct V_1 * V_1 )
{
int V_178 ;
...
F_11 ( & V_48 ) ;
F_11 ( & V_91 ) ;
F_143 ( sizeof( void * ) <= 8 && sizeof( struct V_14 ) > 128 ) ;
V_68 = F_144 ( L_5 , sizeof( struct V_14 ) ,
0 , V_187 | V_188 , NULL ) ;
V_53 = F_144 ( L_6 ,
