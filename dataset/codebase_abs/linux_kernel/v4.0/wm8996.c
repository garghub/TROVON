...
unsigned int V_88 ;
int V_48 ;
V_48 = F_58 ( V_5 -> V_295 , V_259 + V_419 , & V_88 ) ;
if ( V_48 < 0 )
return V_48 ;
return ( V_88 & V_420 ) != 0 ;
}
...
static T_3 F_76 ( int V_60 , void * V_460 )
{
...
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_293 ) ; V_12 ++ ) {
V_48 = F_94 ( V_5 -> V_293 [ V_12 ] . V_500 ,
& V_5 -> V_495 [ V_12 ] ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 ,
L_55 ,
...
static int F_102 ( struct V_56 * V_566 )
{
