...
V_15 -> V_49 =
F_12 ( V_11 , L_18 ) ;
F_8 ( V_11 , L_19 , & V_15 -> V_50 ) ;
if ( V_15 -> V_50 < 0 || V_15 -> V_50 > 256 )
V_15 -> V_50 = 0 ;
}
V_8 -> V_51 = F_12 ( V_11 , L_20 ) ;
if ( V_8 -> V_51 ) {
V_8 -> V_41 = 0 ;
F_15 ( L_21 ) ;
}
...
if ( V_59 -> V_31 ) {
V_59 -> V_66 = V_59 -> V_31 ( V_6 ) ;
if ( F_21 ( V_59 -> V_66 ) )
return F_22 ( V_59 -> V_66 ) ;
}
if ( V_59 -> V_32 ) {
V_53 = V_59 -> V_32 ( V_6 , V_59 -> V_66 ) ;
if ( F_25 ( V_53 ) )
return V_53 ;
}
V_58 = F_26 ( & ( V_6 -> V_12 ) , V_59 , V_56 ) ;
if ( F_21 ( V_58 ) ) {
F_24 ( L_28 , V_65 ) ;
return F_22 ( V_58 ) ;
}
...
V_58 -> V_62 = V_62 ;
if ( V_9 )
memcpy ( V_58 -> V_12 -> V_67 , V_9 , V_68 ) ;
F_27 ( V_6 , V_58 -> V_12 ) ;
F_28 ( L_29 ) ;
return 0 ;
}
...
{
struct V_69 * V_70 = F_30 ( V_6 ) ;
struct V_57 * V_58 = F_31 ( V_70 ) ;
int V_53 = F_32 ( V_70 ) ;
if ( V_58 -> V_8 -> exit )
V_58 -> V_8 -> exit ( V_6 , V_58 -> V_8 -> V_66 ) ;
if ( V_58 -> V_8 -> free )
V_58 -> V_8 -> free ( V_6 , V_58 -> V_8 -> V_66 ) ;
return V_53 ;
}
static int F_33 ( struct V_17 * V_12 )
{
int V_53 ;
struct V_69 * V_70 = F_34 ( V_12 ) ;
struct V_57 * V_58 = F_31 ( V_70 ) ;
...
struct V_5 * V_6 = F_35 ( V_12 ) ;
if ( V_58 -> V_8 -> V_32 )
V_58 -> V_8 -> V_32 ( V_6 , V_58 -> V_8 -> V_66 ) ;
return F_38 ( V_70 ) ;
}
