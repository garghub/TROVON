...
static T_5 F_93 ( struct V_1 * V_8 , char * V_283 )
{
return sprintf ( V_283 , L_76 , V_8 -> V_100 . V_183 ) ;
}
static T_5 F_94 ( struct V_1 * V_8 , const char * V_283 ,
T_6 V_284 )
{
unsigned long V_285 ;
T_5 V_28 ;
V_28 = F_95 ( V_283 , 10 , & V_285 ) ;
...
static T_5
F_98 ( struct V_287 * V_288 , struct V_289 * V_290 , char * V_283 )
{
struct V_291 * V_292 ;
struct V_1 * V_8 ;
...
static T_5
F_99 ( struct V_287 * V_288 , struct V_289 * V_290 , const char * V_283 ,
T_6 V_284 )
{
struct V_291 * V_292 ;
struct V_1 * V_8 ;
...
static T_5 F_104 ( struct V_236 * V_30 ,
struct V_297 * V_290 ,
char * V_283 )
{
int V_28 ;
...
return F_105 ( V_283 , V_298 , L_76 , ( V_186 & 0x7F ) ) ;
V_48:
return V_28 ;
}
...
return F_105 ( V_283 , V_298 , L_76 , ( V_186 & 0xF ) ) ;
V_48:
return V_28 ;
}
...
return F_105 ( V_283 , V_298 , L_76 , ( V_186 & 0xF0 ) >> 4 ) ;
V_48:
return V_28 ;
}
...
if ( V_28 < 0 )
goto V_48;
return F_105 ( V_283 , V_298 , L_76 , ( V_186 & 0x1 ) ) ;
V_48:
return V_28 ;
}
...
return F_105 ( V_283 , V_298 , L_76 , ( ( V_186 & 0x10 ) >> 4 ) ) ;
V_48:
return V_28 ;
}
...
return F_105 ( V_283 , V_298 , L_76 , ( V_186 & 0x7 ) ) ;
V_48:
return V_28 ;
}
...
return F_105 ( V_283 , V_298 , L_76 , ( ( V_186 & 0x20 ) >> 5 ) ) ;
V_48:
return V_28 ;
}
static int F_120 ( struct V_236 * V_30 )
{
unsigned int V_6 ;
struct V_213 * V_214 = F_84 ( V_30 ) ;
struct V_1 * V_8 ;
...
F_17 ( V_30 , L_97 ) ;
while ( V_6 -- )
F_122 ( V_30 , & V_300 [ V_6 ] ) ;
return - V_294 ;
}
static void F_123 ( struct V_236 * V_30 )
{
unsigned int V_6 ;
struct V_213 * V_214 = F_84 ( V_30 ) ;
struct V_1 * V_8 ;
...
|| F_89 ( V_8 -> V_269 ) ) {
for ( V_6 = 0 ; V_6 < F_5 ( V_300 ) ; V_6 ++ )
( void ) F_122 ( V_30 , & V_300 [ V_6 ] ) ;
}
}
static int F_124 ( struct V_302 * V_303 )
{
struct V_1 * V_8 = F_125 ( V_303 ) ;
if ( ! V_8 -> V_39 . V_128 ) {
F_59 ( V_8 , V_172 ) ;
F_33 ( V_8 -> V_76 , & V_8 -> V_77 ) ;
}
...
int V_6 , V_52 ;
int V_28 = 0 ;
V_8 = F_135 ( & V_303 -> V_30 , sizeof( * V_8 ) , V_311 ) ;
if ( ! V_8 ) {
...
V_8 -> V_10 = V_309 ;
if ( V_306 ) {
V_28 = F_136 ( & V_303 -> V_30 , V_306 , V_8 -> V_10 ) ;
if ( V_28 ) {
...
V_52 = F_144 ( V_303 , V_317 [ V_6 ] . V_243 ) ;
V_28 = F_145 ( V_52 , NULL , V_317 [ V_6 ] . V_318 ,
V_319 | V_320 ,
V_317 [ V_6 ] . V_243 , V_8 ) ;
if ( V_28 != 0 ) {
F_17 ( V_8 -> V_30 , L_108
