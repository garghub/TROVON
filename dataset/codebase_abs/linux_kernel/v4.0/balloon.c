...
void F_60 ( unsigned long V_44 )
{
V_4 . V_21 = V_44 ;
F_34 ( & V_42 , 0 ) ;
}
int F_61 ( int V_45 , struct V_1 * * V_64 , bool V_65 )
{
int V_66 = 0 ;
struct V_1 * V_1 ;
F_31 ( & V_36 ) ;
...
void F_62 ( int V_45 , struct V_1 * * V_64 )
{
int V_33 ;
F_31 ( & V_36 ) ;
for ( V_33 = 0 ; V_33 < V_45 ; V_33 ++ ) {
...
static void T_3 F_63 ( unsigned long V_72 ,
unsigned long V_64 )
{
