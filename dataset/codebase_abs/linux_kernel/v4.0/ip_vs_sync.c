...
F_66 () ;
V_111 = F_67 ( V_81 , type , type , V_99 , V_95 ,
V_136 -> V_98 , V_136 -> V_94 , V_61 ,
V_123 , V_50 ) ;
V_46 = F_68 ( V_136 , type , V_99 , V_95 , V_50 , V_111 ,
V_123 ) ;
F_69 () ;
if ( ! V_46 ) {
F_14 ( V_136 -> V_110 ) ;
...
static void F_80 ( struct V_81 * V_81 , T_1 * V_147 ,
const V_118 V_148 )
{
struct V_8 * V_9 = F_44 ( V_81 ) ;
...
static void F_81 ( struct V_175 * V_176 , int V_177 , int V_178 )
{
F_82 ( V_176 ) ;
if ( V_177 ) {
V_178 = F_83 ( int , V_178 , ( V_179 + 1 ) / 2 ,
V_180 ) ;
V_176 -> V_181 = V_178 * 2 ;
V_176 -> V_182 |= V_183 ;
} else {
V_178 = F_83 ( int , V_178 , ( V_184 + 1 ) / 2 ,
V_185 ) ;
V_176 -> V_186 = V_178 * 2 ;
V_176 -> V_182 |= V_187 ;
}
...
static void F_85 ( struct V_175 * V_176 , T_4 V_188 )
{
struct V_189 * V_190 = F_86 ( V_176 ) ;
F_82 ( V_176 ) ;
V_190 -> V_191 = V_188 ? 1 : 0 ;
F_84 ( V_176 ) ;
}
static void F_87 ( struct V_175 * V_176 , T_4 V_192 )
{
struct V_189 * V_190 = F_86 ( V_176 ) ;
F_82 ( V_176 ) ;
V_190 -> V_193 = V_192 ;
...
static int F_88 ( struct V_175 * V_176 , char * V_194 )
{
struct V_195 * V_196 ;
struct V_189 * V_190 = F_86 ( V_176 ) ;
struct V_81 * V_81 = F_89 ( V_176 ) ;
V_196 = F_90 ( V_81 , V_194 ) ;
if ( ! V_196 )
return - V_197 ;
...
static int F_91 ( struct V_81 * V_81 , int V_37 )
{
struct V_8 * V_9 = F_44 ( V_81 ) ;
struct V_195 * V_196 ;
int V_201 ;
if ( V_37 == V_38 ) {
V_196 = F_90 ( V_81 , V_9 -> V_202 ) ;
if ( ! V_196 )
return - V_197 ;
...
V_206 - 20 ) / V_92 ;
V_9 -> V_22 = V_206 +
V_92 * F_92 ( V_201 , V_207 ) ;
F_57 ( 7 , L_28
L_29 , V_9 -> V_22 ) ;
} else if ( V_37 == V_208 ) {
V_196 = F_90 ( V_81 , V_9 -> V_209 ) ;
if ( ! V_196 )
return - V_197 ;
...
static int
F_93 ( struct V_175 * V_176 , struct V_211 * V_212 , char * V_194 )
{
struct V_81 * V_81 = F_89 ( V_176 ) ;
struct V_213 V_214 ;
struct V_195 * V_196 ;
...
F_82 ( V_176 ) ;
V_215 = F_94 ( V_176 , & V_214 ) ;
F_84 ( V_176 ) ;
return V_215 ;
}
static int F_95 ( struct V_218 * V_175 , char * V_194 )
{
struct V_81 * V_81 = F_89 ( V_175 -> V_176 ) ;
struct V_195 * V_196 ;
T_5 V_212 ;
struct V_219 sin ;
V_196 = F_90 ( V_81 , V_194 ) ;
...
static struct V_218 * F_97 ( struct V_81 * V_81 , int V_85 )
{
struct V_8 * V_9 = F_44 ( V_81 ) ;
struct V_219 V_228 = {
. V_221 = V_88 ,
. V_224 = F_98 ( V_229 + V_85 ) ,
. V_222 . V_223 = F_99 ( V_230 ) ,
} ;
struct V_218 * V_175 ;
int V_231 ;
V_231 = F_100 ( V_232 , V_233 , V_234 , & V_175 ) ;
if ( V_231 < 0 ) {
F_45 ( L_34 ) ;
return F_101 ( V_231 ) ;
}
F_102 ( V_175 -> V_176 , V_81 ) ;
V_231 = F_88 ( V_175 -> V_176 , V_9 -> V_202 ) ;
if ( V_231 < 0 ) {
F_45 ( L_35 ) ;
goto error;
}
...
V_231 = F_103 ( V_9 ) ;
if ( V_231 > 0 )
F_81 ( V_175 -> V_176 , 1 , V_231 ) ;
V_231 = F_95 ( V_175 , V_9 -> V_202 ) ;
if ( V_231 < 0 ) {
F_45 ( L_36 ) ;
goto error;
}
...
static struct V_218 * F_105 ( struct V_81 * V_81 , int V_85 )
{
struct V_8 * V_9 = F_44 ( V_81 ) ;
struct V_219 V_228 = {
. V_221 = V_88 ,
...
static int
F_106 ( struct V_218 * V_175 , const char * V_147 , const V_118 V_238 )
{
...
V_245 . V_247 = V_238 ;
V_86 = F_108 ( V_175 , & V_240 , & V_245 , 1 , ( V_118 ) ( V_238 ) ) ;
F_109 ( 7 ) ;
return V_86 ;
}
static int
F_110 ( struct V_218 * V_175 , struct V_29 * V_240 )
{
int V_248 ;
int V_215 ;
V_248 = F_46 ( V_240 -> V_28 ) ;
V_215 = F_106 ( V_175 , ( char * ) V_240 , V_248 ) ;
...
static int
F_111 ( struct V_218 * V_175 , char * V_147 , const V_118 V_148 )
{
...
V_86 = F_112 ( V_175 , & V_240 , & V_245 , 1 , V_148 , V_242 ) ;
if ( V_86 < 0 )
return V_86 ;
F_109 ( 7 ) ;
return V_86 ;
...
static inline struct V_7 *
F_115 ( struct V_8 * V_9 , struct V_10 * V_11 )
{
struct V_7 * V_12 ;
V_12 = F_5 ( V_9 , V_11 ) ;
if ( V_12 )
...
while ( F_110 ( V_254 -> V_175 , V_12 -> V_21 ) < 0 ) {
F_120 ( * F_121 ( V_176 ) ,
F_122 ( V_176 ) ||
F_118 () ) ;
if ( F_33 ( F_118 () ) )
...
if ( V_12 )
F_16 ( V_12 ) ;
F_104 ( V_254 -> V_175 -> V_176 ) ;
F_14 ( V_254 ) ;
return 0 ;
}
static int F_123 ( void * V_160 )
{
struct V_253 * V_254 = V_160 ;
struct V_8 * V_9 = F_44 ( V_254 -> V_81 ) ;
int V_86 ;
...
while ( ! F_118 () ) {
F_124 ( * F_121 ( V_254 -> V_175 -> V_176 ) ,
! F_125 ( & V_254 -> V_175 -> V_176 -> V_257 )
|| F_118 () ) ;
while ( ! F_125 ( & ( V_254 -> V_175 -> V_176 -> V_257 ) ) ) {
V_86 = F_111 ( V_254 -> V_175 , V_254 -> V_258 ,
V_9 -> V_210 ) ;
if ( V_86 <= 0 ) {
if ( V_86 != - V_249 )
F_45 ( L_44 ) ;
...
F_80 ( V_254 -> V_81 , V_254 -> V_258 , V_86 ) ;
}
}
F_104 ( V_254 -> V_175 -> V_176 ) ;
F_14 ( V_254 -> V_258 ) ;
...
int F_126 ( struct V_81 * V_81 , int V_63 , char * V_259 , T_1 V_26 )
{
struct V_253 * V_254 ;
...
struct V_8 * V_9 = F_44 ( V_81 ) ;
char * V_113 ;
int (* F_127)( void * V_160 );
int V_85 , V_263 ;
int V_231 = - V_135 ;
F_57 ( 7 , L_45 , V_264 , F_128 ( V_265 ) ) ;
F_57 ( 7 , L_46 ,
sizeof( struct F_43 ) ) ;
if ( ! V_9 -> V_37 ) {
V_263 = F_129 ( F_130 ( V_9 ) , 1 , V_266 ) ;
V_9 -> V_47 = V_263 - 1 ;
} else
V_263 = V_9 -> V_47 + 1 ;
if ( V_63 == V_38 ) {
...
if ( V_63 == V_38 ) {
struct V_10 * V_11 ;
V_9 -> V_11 = F_132 ( V_263 * sizeof( V_9 -> V_11 [ 0 ] ) , V_269 ) ;
if ( ! V_9 -> V_11 )
goto V_165;
V_11 = V_9 -> V_11 ;
...
V_261 = F_132 ( V_263 * sizeof( struct V_260 * ) ,
V_269 ) ;
if ( ! V_261 )
goto V_165;
}
...
if ( V_63 == V_38 )
V_175 = F_97 ( V_81 , V_85 ) ;
else
V_175 = F_105 ( V_81 , V_85 ) ;
if ( F_135 ( V_175 ) ) {
V_231 = F_136 ( V_175 ) ;
goto V_270;
}
...
V_254 -> V_85 = V_85 ;
V_262 = F_137 ( F_127 , V_254 , V_113 , V_9 -> V_272 , V_85 ) ;
if ( F_135 ( V_262 ) ) {
V_231 = F_136 ( V_262 ) ;
goto V_270;
}
...
int F_140 ( struct V_81 * V_81 , int V_63 )
{
struct V_8 * V_9 = F_44 ( V_81 ) ;
struct V_260 * * V_261 ;
int V_85 ;
...
int T_6 F_143 ( struct V_81 * V_81 )
{
struct V_8 * V_9 = F_44 ( V_81 ) ;
F_144 ( & V_9 -> V_274 , L_51 , & V_275 ) ;
F_145 ( & V_9 -> V_13 ) ;
F_145 ( & V_9 -> V_43 ) ;
return 0 ;
}
void F_146 ( struct V_81 * V_81 )
{
int V_164 ;
struct V_8 * V_9 = F_44 ( V_81 ) ;
F_147 ( & V_9 -> V_274 ) ;
V_164 = F_140 ( V_81 , V_38 ) ;
if ( V_164 && V_164 != - V_273 )
F_45 ( L_52 ) ;
V_164 = F_140 ( V_81 , V_208 ) ;
if ( V_164 && V_164 != - V_273 )
F_45 ( L_53 ) ;
F_148 ( & V_9 -> V_274 ) ;
}
