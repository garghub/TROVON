...
static int F_128 ( struct V_316 * V_317 , int V_320 )
{
return 0 ;
}
static int F_129 ( struct V_316 * V_317 , unsigned V_321 )
{
struct V_4 * V_5 ;
unsigned long V_306 ;
if ( V_317 == NULL ) {
...
{
int V_6 ;
F_110 ( & V_5 -> V_117 . V_324 ) ;
V_5 -> V_117 . V_325 = & V_5 -> V_60 [ 0 ] . V_60 ;
for ( V_6 = 0 ; V_6 < V_52 ; V_6 ++ ) {
struct V_59 * V_60 = & V_5 -> V_60 [ V_6 ] ;
V_60 -> V_5 = V_5 ;
V_60 -> V_305 = NULL ;
V_60 -> V_60 . V_326 = NULL ;
V_60 -> V_60 . V_327 = V_328 [ V_6 ] ;
V_60 -> V_60 . V_329 = & V_330 ;
V_60 -> V_60 . V_64 = ( V_6 == 0 ? V_137 : V_331 ) ;
F_116 ( & V_60 -> V_60 . V_324 , & V_5 -> V_117 . V_324 ) ;
F_110 ( & V_60 -> V_173 ) ;
}
F_74 ( & V_5 -> V_60 [ 0 ] . V_60 . V_324 ) ;
}
...
V_5 -> V_333 = V_333 ;
V_5 -> V_321 = 0 ;
V_5 -> V_333 -> V_10 . V_334 = F_135 ( 32 ) ;
F_132 ( V_5 ) ;
V_5 -> V_117 . V_329 = & V_335 ;
V_5 -> V_117 . V_325 = & V_5 -> V_60 [ 0 ] . V_60 ;
V_5 -> V_117 . V_203 = V_244 ;
V_5 -> V_117 . V_327 = V_336 ;
F_136 ( & V_5 -> V_117 . V_10 ) ;
F_137 ( & V_5 -> V_117 . V_10 , L_37 ) ;
V_5 -> V_117 . V_10 . V_118 = & V_333 -> V_10 ;
V_5 -> V_117 . V_10 . V_337 = V_333 -> V_10 . V_337 ;
return 0 ;
}
static int F_138 ( struct V_332 * V_333 )
{
int V_42 = - V_338 ;
struct V_4 * V_5 ;
struct V_339 * V_340 ;
...
F_139 ( V_333 , V_5 ) ;
V_340 = F_140 ( V_333 , V_343 , 0 ) ;
V_341 = F_141 ( & V_333 -> V_10 , V_340 ) ;
if ( F_142 ( V_341 ) )
return F_143 ( V_341 ) ;
V_293 = F_144 ( V_333 , 0 ) ;
if ( V_293 < 0 ) {
F_145 ( & V_333 -> V_10 , L_38 ) ;
return V_293 ;
}
V_42 = F_146 ( & V_333 -> V_10 , V_293 , F_99 ,
0 , V_336 , V_5 ) ;
V_5 -> V_53 = ( T_5 ) V_341 ;
if ( V_42 != 0 ) {
F_9 ( L_39 ) ;
...
static void F_149 ( struct V_332 * V_333 )
{
struct V_4 * V_5 ;
V_5 = F_150 ( V_333 ) ;
if ( V_5 == NULL )
...
static int T_11 F_151 ( struct V_332 * V_333 )
{
struct V_4 * V_5 ;
struct V_59 * V_60 ;
int V_6 ;
...
static int F_154 ( struct V_332 * V_333 , T_12 V_348 )
{
struct V_4 * V_5 ;
V_5 = F_150 ( V_333 ) ;
if ( V_5 == NULL )
...
static int F_155 ( struct V_332 * V_333 )
{
T_1 V_47 ;
struct V_4 * V_5 ;
V_5 = F_150 ( V_333 ) ;
