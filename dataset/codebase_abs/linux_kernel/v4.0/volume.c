...
V_8 = F_13 (
V_6 -> V_15 , & V_5 -> V_19 . V_38 [ V_11 ] ) ;
if ( F_4 ( V_8 ) ) {
V_10 = F_5 ( V_8 ) ;
goto V_39;
}
V_6 -> V_38 [ V_6 -> V_21 ] = V_8 ;
V_6 -> V_21 ++ ;
}
}
#ifdef F_14
V_6 -> V_40 = F_15 ( V_5 -> V_40 ,
& V_41 ,
V_6 , true ) ;
#endif
F_16 ( V_5 ) ;
...
struct V_7 * F_30 ( struct V_43 * V_44 )
{
struct V_1 * V_6 = V_44 -> V_6 ;
struct V_7 * V_8 ;
int V_10 , V_45 , V_11 ;
F_2 ( L_10 , V_6 -> V_5 -> V_19 . V_46 ) ;
if ( V_44 -> V_8 && V_44 -> V_8 -> V_47 == 0 ) {
F_31 ( V_44 -> V_8 ) ;
F_19 ( L_11 , V_44 -> V_8 ) ;
return V_44 -> V_8 ;
}
...
unsigned V_11 ;
F_2 ( L_15 ,
V_6 -> V_5 -> V_19 . V_46 , F_34 ( V_8 -> V_50 . V_51 ) ,
V_56 ) ;
switch ( V_56 ) {
case 0 :
V_8 -> V_57 = V_58 ;
...
F_6 ( & V_6 -> V_37 ) ;
for ( V_11 = 0 ; V_11 < V_6 -> V_21 ; V_11 ++ )
if ( V_6 -> V_38 [ V_11 ] == V_8 )
goto V_59;
goto V_60;
V_59:
V_6 -> V_21 -- ;
memmove ( & V_6 -> V_38 [ V_11 ] ,
& V_6 -> V_38 [ V_11 + 1 ] ,
sizeof( V_6 -> V_38 [ V_11 ] ) *
( V_6 -> V_21 - V_11 ) ) ;
V_6 -> V_38 [ V_6 -> V_21 ] = NULL ;
F_22 ( V_8 ) ;
V_6 -> V_48 ++ ;
if ( V_6 -> V_21 > 0 )
goto V_60;
