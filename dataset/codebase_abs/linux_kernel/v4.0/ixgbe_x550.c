...
static T_1 F_31 ( struct V_1 * V_2 , T_2 V_23 ,
T_2 V_24 , T_2 V_39 )
{
T_2 V_40 , V_41 , error ;
V_41 = ( ( V_23 << V_42 ) |
...
static enum V_200 F_42 ( struct V_1 * V_2 )
{
enum V_200 V_147 ;
switch ( V_2 -> V_5 ) {
case V_19 :
...
void F_49 ( struct V_1 * V_2 , bool V_235 ,
int V_236 )
{
int V_237 = V_236 >> 3 ;
int V_238 = V_236 % 8 + V_239 ;
T_2 V_240 ;
V_240 = F_2 ( V_2 , F_50 ( V_237 ) ) ;
if ( V_235 )
V_240 |= ( 1 << V_238 ) ;
else
V_240 &= ~ ( 1 << V_238 ) ;
F_3 ( V_2 , F_50 ( V_237 ) , V_240 ) ;
}
