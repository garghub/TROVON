...
struct V_19 * F_55 ( struct V_54 * V_23 ,
struct V_2 * V_12 )
{
struct V_19 * V_20 = NULL ;
...
F_48 ( & V_20 -> V_55 . V_56 ) ;
F_48 ( & V_20 -> V_55 . V_57 ) ;
V_20 -> V_55 . V_58 = V_23 -> V_58 ;
F_56 ( & V_20 -> V_26 , & V_12 -> V_50 ) ;
}
return V_20 ;
}
struct V_19 * F_57 ( struct V_54 * V_23 ,
struct V_2 * V_12 )
{
struct V_19 * V_20 ;
int V_36 ;
...
if ( V_20 -> V_59 )
return V_20 ;
V_36 = F_59 ( V_23 -> V_24 , V_12 -> V_25 , V_12 -> V_48 ) ;
if ( V_36 < 0 )
return F_8 ( V_36 ) ;
V_20 -> V_59 = true ;
return V_20 ;
}
void F_60 ( struct V_54 * V_23 , unsigned int V_25 )
{
struct V_2 * V_12 ;
struct V_19 * V_20 ;
int V_13 , V_60 ;
...
struct V_19 * V_20 )
{
if ( F_65 ( & V_20 -> V_26 , & V_12 -> V_50 ) )
return NULL ;
return F_66 ( V_20 , V_26 ) ;
}
bool F_67 ( struct V_2 * V_12 )
{
return ! ( F_68 ( & V_12 -> V_50 ) ) ;
}
