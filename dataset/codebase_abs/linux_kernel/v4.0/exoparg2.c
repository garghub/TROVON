...
F_19 ( V_25 -> string . V_37 ,
V_4 [ 0 ] -> V_36 . V_37 , V_27 ) ;
break;
case V_38 :
V_9 = F_20 ( V_4 [ 0 ] , V_4 [ 1 ] ,
& V_25 , V_2 ) ;
break;
case V_39 :
V_25 =
...
break;
case V_51 :
if ( V_26 >= V_4 [ 0 ] -> V_52 . V_53 ) {
V_27 = V_4 [ 0 ] -> V_52 . V_53 ;
V_9 = V_54 ;
}
V_25 -> V_41 . V_47 = V_51 ;
V_25 -> V_41 . V_55 =
& V_4 [ 0 ] -> V_52 . V_56 [ V_26 ] ;
break;
default:
V_9 = V_57 ;
goto V_23;
...
V_8 , & V_59 ) ;
goto V_62;
} else if ( V_2 -> V_29 -> V_30 & V_63 ) {
V_9 = F_27 ( V_2 -> V_12 , V_4 [ 0 ] ,
V_4 [ 1 ] , & V_59 ) ;
goto V_62;
}
switch ( V_2 -> V_12 ) {
