...
static T_4
F_48 ( struct V_64 * V_65 , void * V_118 , T_5 V_119 , T_5 V_110 )
{
...
struct V_2 * V_68 = V_65 -> V_68 ;
T_2 V_73 = V_119 * V_68 -> V_39 . V_83 ;
unsigned int V_78 = V_110 * V_68 -> V_39 . V_83 ;
int V_122 = V_123 | V_124 ;
if ( ! V_16 -> V_125 -> V_126 )
return V_114 ;
V_19 = V_16 -> V_125 -> V_126 ( V_16 , V_122 , V_73 , V_78 ) ;
if ( V_19 < 0 ) {
F_50 ( L_43 , V_19 ) ;
return V_114 ;
}
...
V_19 = F_48 ( V_65 , V_16 , V_119 , V_110 ) ;
if ( V_19 )
return V_19 ;
F_42 ( V_65 , V_127 ) ;
return 0 ;
...
if ( V_19 > 0 && V_65 -> V_131 ) {
T_1 V_132 = V_65 -> V_82 / V_3 -> V_39 . V_83 ;
V_80 = F_55 ( V_65 , V_65 -> V_74 , V_132 ,
0 , V_66 . V_87 , 0 ) ;
if ( V_80 ) {
F_8 ( V_66 . V_87 ) ;
F_25 ( V_66 . V_84 ) ;
...
if ( V_19 < 0 )
return V_114 ;
V_80 = F_56 ( V_65 , V_65 -> V_74 , V_132 ,
0 , V_66 . V_87 , 0 ) ;
if ( V_80 ) {
F_8 ( V_66 . V_87 ) ;
F_25 ( V_66 . V_84 ) ;
...
const char * V_136 , T_6 V_137 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
char * V_138 , * V_139 , * V_140 , * V_141 ;
T_7 args [ V_142 ] ;
int V_19 = 0 , V_143 , V_144 ;
V_141 = F_58 ( V_136 , V_8 ) ;
if ( ! V_141 )
return - V_9 ;
V_138 = V_141 ;
while ( ( V_139 = F_59 ( & V_141 , L_46 ) ) != NULL ) {
if ( ! * V_139 )
continue;
V_144 = F_60 ( V_139 , V_145 , args ) ;
switch ( V_144 ) {
case V_146 :
...
static T_6 F_65 ( struct V_2 * V_3 , char * V_151 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_6 V_152 = 0 ;
...
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
struct V_16 * V_153 , * V_16 = V_1 -> V_30 ;
struct V_17 * V_17 ;
...
if ( V_1 -> V_21 & V_27 )
V_18 &= ~ V_26 ;
snprintf ( V_76 , V_154 , L_62 ,
V_1 -> V_28 ) ;
V_153 = F_11 ( V_76 , V_18 , 0600 ) ;
if ( F_12 ( V_153 ) ) {
F_5 ( L_11 , V_76 ) ;
V_19 = F_13 ( V_153 ) ;
return V_19 ;
...
V_75 = ( V_3 -> V_161 -> V_162 ( V_3 ) + 1 ) * V_3 -> V_75 ;
V_79 = V_75 ;
F_6 ( L_66 ,
( unsigned long long ) V_75 ) ;
memset ( V_76 , 0xff , V_158 ) ;
for ( V_157 = 0 ; V_157 < V_75 ; V_157 += V_158 ) {
V_78 = F_69 ( V_158 , V_79 ) ;
