...
int F_131 ( struct V_36 * V_37 , T_3 * V_43 )
{
int V_44 = - V_91 ;
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
...
int F_132 ( struct V_101 * V_102 , T_3 * V_43 )
{
int V_44 = - V_91 ;
struct V_36 * V_37 = V_102 -> V_37 ;
F_76 ( & V_37 -> V_118 ) ;
...
static int F_133 ( struct V_101 * V_102 , T_3 * V_43 )
{
int V_44 ;
T_5 V_20 ;
T_3 V_154 ;
...
return V_44 ;
V_154 = F_8 ( V_20 ) ;
return F_134 ( & V_37 -> V_58 , V_154 , V_43 ) ;
}
int F_135 ( struct V_101 * V_102 ,
T_3 * V_43 )
{
int V_44 = - V_91 ;
struct V_36 * V_37 = V_102 -> V_37 ;
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
V_44 = F_133 ( V_102 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
static int F_136 ( struct V_21 * V_22 , T_3 V_155 )
{
int V_44 ;
T_3 V_156 ;
...
return F_137 ( V_22 , V_155 - V_156 ) ;
}
int F_138 ( struct V_36 * V_37 , T_3 V_155 )
{
int V_44 = - V_91 ;
F_86 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
V_44 = F_136 ( V_37 -> V_50 , V_155 ) ;
F_87 ( & V_37 -> V_118 ) ;
return V_44 ;
}
...
F_86 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_121 )
V_44 = F_136 ( V_37 -> V_62 , V_155 ) ;
F_87 ( & V_37 -> V_118 ) ;
return V_44 ;
}
void F_140 ( struct V_36 * V_37 )
{
F_86 ( & V_37 -> V_118 ) ;
V_37 -> V_120 = true ;
F_141 ( V_37 -> V_39 ) ;
...
int V_44 ;
F_86 ( & V_37 -> V_118 ) ;
V_44 = F_145 ( V_37 -> V_62 , V_157 , V_158 , V_19 ) ;
F_87 ( & V_37 -> V_118 ) ;
return V_44 ;
}
