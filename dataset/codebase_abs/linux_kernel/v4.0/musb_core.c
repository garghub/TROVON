...
F_4 ( V_1 -> V_33 ) ;
if ( V_271 && V_3 -> V_272 ) {
V_1 -> V_273 = F_155 ( V_1 , V_1 -> V_41 ) ;
if ( F_156 ( V_1 -> V_273 ) ) {
V_178 = F_157 ( V_1 -> V_273 ) ;
goto V_274;
}
}
F_77 ( V_1 ) ;
F_71 ( V_1 ) ;
F_158 ( & V_1 -> V_121 , F_125 ) ;
F_159 ( & V_1 -> V_120 , F_128 ) ;
F_159 ( & V_1 -> V_244 , F_145 ) ;
F_159 ( & V_1 -> V_275 , V_276 ) ;
V_178 = F_95 ( V_248 -> V_141 -> V_277
? V_191
: V_278 , V_1 ) ;
if ( V_178 < 0 )
goto V_279;
F_160 ( & V_1 -> V_102 , F_44 , ( unsigned long ) V_1 ) ;
if ( F_161 ( V_238 , V_1 -> V_259 , 0 , F_162 ( V_3 ) , V_1 ) ) {
...
if ( V_248 -> V_280 ) {
T_3 V_281 = F_165 ( V_1 -> V_41 ) ;
V_281 |= V_282 ;
F_166 ( V_1 -> V_41 , V_281 ) ;
}
...
if ( V_178 < 0 )
goto V_286;
V_178 = F_170 ( & V_1 -> V_33 -> V_228 , & V_242 ) ;
if ( V_178 )
goto V_287;
F_7 ( V_1 -> V_33 ) ;
return 0 ;
...
static int F_177 ( struct V_131 * V_132 )
{
struct V_2 * V_3 = & V_132 -> V_3 ;
int V_288 = F_178 ( V_132 , L_81 ) ;
struct V_289 * V_290 ;
void T_2 * V_291 ;
if ( V_288 <= 0 )
return - V_239 ;
V_290 = F_179 ( V_132 , V_292 , 0 ) ;
V_291 = F_180 ( V_3 , V_290 ) ;
if ( F_156 ( V_291 ) )
return F_157 ( V_291 ) ;
return F_147 ( V_3 , V_288 , V_291 ) ;
}
static int F_181 ( struct V_131 * V_132 )
{
struct V_2 * V_3 = & V_132 -> V_3 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
F_171 ( V_1 ) ;
...
V_1 -> V_295 . V_281 = F_165 ( V_1 -> V_41 ) ;
...
F_166 ( V_1 -> V_41 , V_1 -> V_295 . V_281 ) ;
V_11 = F_5 ( V_293 , V_14 ) ;
V_11 &= V_15 | V_74 ;
