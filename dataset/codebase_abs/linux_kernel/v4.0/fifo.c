...
static void F_102 ( struct V_8 * V_9 , struct V_22 * V_23 )
{
V_23 -> V_65 = F_103 ( V_9 , L_12 ) ;
if ( F_104 ( V_23 -> V_65 ) )
V_23 -> V_65 = NULL ;
V_23 -> V_67 = F_103 ( V_9 , L_13 ) ;
if ( F_104 ( V_23 -> V_67 ) )
V_23 -> V_67 = NULL ;
}
...
F_66 ( V_9 , L_19 , V_106 -> V_107 ) ;
F_107 (pipe, priv, i) {
if ( ! ( V_106 -> V_107 & ( 1 << V_57 ) ) )
continue;
V_26 = F_25 ( V_7 , V_30 ) ;
if ( V_26 < 0 )
...
F_66 ( V_9 , L_21 , V_106 -> V_108 ) ;
F_107 (pipe, priv, i) {
if ( ! ( V_106 -> V_108 & ( 1 << V_57 ) ) )
continue;
V_26 = F_25 ( V_7 , V_30 ) ;
if ( V_26 < 0 )
F_6 ( V_9 , L_22 , V_57 , V_26 ) ;
}
return 0 ;
}
...
{
struct V_110 * V_111 = F_111 ( V_6 ) ;
struct V_22 * V_112 = F_50 ( V_6 ) ;
struct V_22 * V_113 ;
int V_57 ;
V_111 -> V_114 = F_106 ;
V_111 -> V_115 = F_108 ;
