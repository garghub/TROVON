...
V_258 = V_277 ;
case V_277 :
V_283 -> V_109 = V_255 -> V_74 -> V_274 & V_275 ?
- V_276 : 0 ;
break;
case V_287 :
V_283 -> V_109 = - V_288 ;
...
if ( V_258 == V_147 || V_284 ) {
V_283 -> V_272 = V_283 -> V_116 ;
V_255 -> V_74 -> V_272 += V_283 -> V_116 ;
} else {
for ( V_103 = V_82 -> V_24 ,
...
V_281 += F_132 ( F_3 ( V_103 -> V_29 . V_30 [ 2 ] ) ) ;
}
V_281 += F_132 ( F_3 ( V_103 -> V_29 . V_30 [ 2 ] ) ) -
F_129 ( F_3 ( V_124 -> V_267 ) ) ;
if ( V_258 != V_269 ) {
V_283 -> V_272 = V_281 ;
V_255 -> V_74 -> V_272 += V_281 ;
}
}
return F_125 ( V_10 , V_255 , V_256 , V_124 , V_61 , V_109 , false ) ;
}
...
F_137 () ;
switch ( ( F_3 ( V_124 -> V_209 . V_136 ) & V_296 ) ) {
case F_38 ( V_297 ) :
F_95 ( V_10 , & V_124 -> V_209 ) ;
break;
case F_38 ( V_298 ) :
...
break;
default:
if ( ( F_3 ( V_124 -> V_209 . V_136 ) & V_296 ) >=
F_38 ( 48 ) )
F_101 ( V_10 , V_124 ) ;
else
V_10 -> V_173 |= 1 << 3 ;
...
if ( V_111 -> V_307 ) {
T_2 V_308 ;
V_308 = F_17 ( & V_10 -> V_309 -> V_308 ) ;
V_308 |= V_310 ;
F_16 ( V_308 , & V_10 -> V_309 -> V_308 ) ;
}
if ( V_10 -> V_53 & V_54 ) {
F_15 ( V_10 , L_101
L_102 ) ;
V_46 = F_19 ( V_10 , & V_10 -> V_309 -> V_311 ) ;
F_20 ( V_10 , V_46 | V_312 ,
& V_10 -> V_309 -> V_311 ) ;
F_47 ( & V_10 -> V_122 ) ;
return V_313 ;
}
V_302 = V_10 -> V_13 -> V_24 ;
while ( F_136 ( V_10 ) > 0 ) {}
V_46 = F_19 ( V_10 , & V_10 -> V_309 -> V_311 ) ;
if ( V_302 != V_10 -> V_13 -> V_24 ) {
...
L_104 ) ;
V_46 &= V_314 ;
V_46 |= ( ( T_3 ) V_97 & ( T_3 ) ~ V_314 ) ;
}
V_46 |= V_312 ;
F_20 ( V_10 , V_46 , & V_10 -> V_309 -> V_311 ) ;
F_47 ( & V_10 -> V_122 ) ;
return V_313 ;
}
T_7 F_140 ( int V_307 , void * V_111 )
{
return F_138 ( V_111 ) ;
}
...
struct V_194 * V_4 ;
V_4 = & V_12 -> V_20 -> V_29 ;
V_4 -> V_30 [ 0 ] = F_11 ( V_315 ) ;
V_4 -> V_30 [ 1 ] = F_11 ( V_316 ) ;
V_4 -> V_30 [ 2 ] = F_11 ( V_317 ) ;
V_4 -> V_30 [ 3 ] = F_11 ( V_318 ) ;
F_9 ( V_10 , V_12 , V_27 ) ;
}
static int F_142 ( struct V_9 * V_10 , struct V_11 * V_82 ,
T_2 V_64 , unsigned int V_38 , T_8 V_319 )
{
unsigned int V_320 ;
switch ( V_64 ) {
case V_321 :
...
F_34 ( V_10 , V_328 ,
L_110 ) ;
V_320 = V_38 - V_82 -> V_25 ;
if ( F_143 ( V_10 , V_82 , V_320 ,
V_319 ) ) {
F_22 ( V_10 , L_111 ) ;
return - V_327 ;
}
...
unsigned int V_281 = F_150 ( V_333 ) ;
V_331 = V_335 -
( F_151 ( V_333 ) & ( V_335 - 1 ) ) ;
V_331 &= V_335 - 1 ;
if ( V_331 != 0 )
V_38 ++ ;
while ( V_331 < F_150 ( V_333 ) && V_331 < V_221 ) {
V_38 ++ ;
V_331 += V_335 ;
}
V_281 = F_152 ( int , V_281 , V_221 ) ;
V_221 -= V_281 ;
if ( V_221 == 0 )
break;
}
...
static void F_153 ( struct V_74 * V_74 , int V_38 , int V_331 )
{
if ( V_38 != 0 )
F_154 ( & V_74 -> V_75 -> V_75 , L_113
L_114 , V_246 ,
V_74 -> V_61 -> V_76 . V_294 , V_38 ) ;
if ( V_331 != V_74 -> V_273 )
F_154 ( & V_74 -> V_75 -> V_75 , L_115
L_116 ,
V_246 ,
V_74 -> V_61 -> V_76 . V_294 ,
V_331 , V_331 ,
V_74 -> V_273 ,
V_74 -> V_273 ) ;
}
static void F_155 ( struct V_9 * V_10 , int V_56 ,
unsigned int V_57 , unsigned int V_58 , int V_336 ,
struct V_194 * V_248 )
{
F_12 () ;
if ( V_336 )
V_248 -> V_30 [ 3 ] |= F_11 ( V_336 ) ;
else
V_248 -> V_30 [ 3 ] &= F_11 ( ~ V_37 ) ;
F_25 ( V_10 , V_56 , V_57 , V_58 ) ;
}
int F_156 ( struct V_9 * V_10 , T_8 V_319 ,
...
int V_337 ;
int V_338 ;
V_337 = F_157 ( F_3 ( V_95 -> V_151 ) ) ;
V_338 = V_74 -> V_339 ;
if ( V_74 -> V_75 -> V_215 == V_340 ||
V_74 -> V_75 -> V_215 == V_341 )
V_338 *= 8 ;
if ( V_337 != V_338 ) {
...
return F_159 ( V_10 , V_319 , V_74 , V_56 , V_57 ) ;
}
static T_2 F_160 ( unsigned int V_342 )
{
T_2 V_343 = ( 1 << ( 21 - 17 + 1 ) ) - 1 ;
if ( ( V_342 >> 10 ) >= V_343 )
return V_343 << 17 ;
else
return ( V_342 >> 10 ) << 17 ;
}
static T_2 F_161 ( int V_331 , int V_344 ,
unsigned int V_345 , struct V_74 * V_74 ,
unsigned int V_346 )
{
int V_347 ;
if ( V_346 == 0 || ( V_331 == 0 && V_344 == 0 ) )
return 0 ;
V_347 = ( V_331 + V_344 ) /
F_162 ( F_163 ( & V_74 -> V_61 -> V_76 ) ) ;
if ( ( V_345 - V_347 ) > 31 )
return 31 << 17 ;
return ( V_345 - V_347 ) << 17 ;
}
static int F_164 ( struct V_9 * V_10 , T_8 V_319 ,
struct V_74 * V_74 , int V_56 , unsigned int V_57 )
{
struct V_11 * V_82 ;
unsigned int V_38 ;
...
V_330 = V_74 -> V_334 ;
V_345 = F_165 ( V_74 -> V_273 ,
F_163 ( & V_74 -> V_61 -> V_76 ) ) ;
V_344 = F_144 ( V_10 , V_10 -> V_62 [ V_56 ] ,
V_57 , V_74 -> V_58 ,
V_38 , V_74 , 0 , V_319 ) ;
if ( V_344 < 0 )
return V_344 ;
...
V_331 = 0 ;
V_333 = V_74 -> V_333 ;
V_85 = ( T_3 ) F_151 ( V_333 ) ;
V_348 = F_150 ( V_333 ) ;
V_344 = V_335 - ( V_85 & ( V_335 - 1 ) ) ;
V_344 = F_152 ( int , V_344 , V_348 ) ;
if ( V_344 > V_74 -> V_273 )
V_344 = V_74 -> V_273 ;
V_105 = true ;
do {
...
F_30 ( V_10 , L_120 ) ;
F_15 ( V_10 , L_121 ,
( unsigned int ) ( V_85 + V_335 ) & ~ ( V_335 - 1 ) ,
( unsigned int ) V_85 + V_344 ) ;
}
if ( V_10 -> V_352 < 0x100 ) {
V_342 = F_160 (
V_74 -> V_273 -
...
( V_85 & ( V_335 - 1 ) ) ;
V_344 = F_152 ( int , V_344 , V_348 ) ;
if ( V_331 + V_344 > V_74 -> V_273 )
V_344 =
V_74 -> V_273 - V_331 ;
} while ( V_331 < V_74 -> V_273 );
F_153 ( V_74 , V_38 , V_331 ) ;
F_155 ( V_10 , V_56 , V_57 , V_74 -> V_58 ,
V_336 , V_248 ) ;
return 0 ;
}
int F_159 ( struct V_9 * V_10 , T_8 V_319 ,
struct V_74 * V_74 , int V_56 , unsigned int V_57 )
{
struct V_11 * V_82 ;
struct V_112 * V_112 ;
...
int V_336 ;
T_2 V_30 , V_349 ;
int V_331 , V_344 , V_47 ;
unsigned int V_345 ;
T_3 V_85 ;
if ( V_74 -> V_330 )
return F_164 ( V_10 , V_319 , V_74 , V_56 , V_57 ) ;
V_82 = F_31 ( V_10 , V_74 ) ;
if ( ! V_82 )
return - V_324 ;
V_38 = 0 ;
...
V_248 = & V_82 -> V_20 -> V_29 ;
V_336 = V_82 -> V_26 ;
V_356 = (struct V_355 * ) V_74 -> V_357 ;
V_30 = 0 ;
V_30 |= V_358 | F_38 ( V_359 ) ;
if ( V_336 == 0 )
V_30 |= 0x1 ;
if ( V_10 -> V_352 == 0x100 ) {
if ( V_74 -> V_273 > 0 ) {
if ( V_356 -> V_360 & V_361 )
V_30 |= F_172 ( V_362 ) ;
else
V_30 |= F_172 ( V_363 ) ;
}
...
V_356 -> V_360 | V_356 -> V_364 << 8 | F_173 ( V_356 -> V_365 ) << 16 ,
F_173 ( V_356 -> V_366 ) | F_173 ( V_356 -> V_367 ) << 16 ,
F_132 ( 8 ) | F_167 ( 0 ) ,
V_30 ) ;
if ( F_166 ( V_74 ) )
V_30 = V_351 | F_38 ( V_368 ) ;
else
V_30 = F_38 ( V_368 ) ;
V_349 = F_132 ( V_74 -> V_273 ) |
F_160 ( V_74 -> V_273 ) |
F_167 ( 0 ) ;
if ( V_74 -> V_273 > 0 ) {
if ( V_356 -> V_360 & V_361 )
...
V_255 -> F_4 = V_82 -> V_20 ;
if ( V_74 -> V_273 > 0 && V_356 -> V_360 & V_361 )
V_30 = 0 ;
else
V_30 = V_369 ;
...
0 ,
F_167 ( 0 ) ,
V_30 | V_350 | F_38 ( V_370 ) | V_82 -> V_26 ) ;
...
int V_38 = 0 ;
T_3 V_85 , V_371 ;
V_85 = ( T_3 ) ( V_74 -> V_354 + V_74 -> V_285 [ V_134 ] . V_372 ) ;
V_371 = V_74 -> V_285 [ V_134 ] . V_116 ;
V_38 = F_165 ( V_371 + ( V_85 & ( V_335 - 1 ) ) ,
V_335 ) ;
if ( V_38 == 0 )
V_38 ++ ;
return V_38 ;
...
struct V_217 * V_218 ,
struct V_74 * V_74 , unsigned int V_345 )
{
unsigned int V_373 ;
if ( V_10 -> V_352 < 0x100 || V_218 -> V_215 != V_374 )
return 0 ;
V_373 = V_74 -> V_61 -> V_375 . V_376 ;
return F_165 ( V_345 , V_373 + 1 ) - 1 ;
}
...
static int F_177 ( struct V_9 * V_10 , T_8 V_319 ,
struct V_74 * V_74 , int V_56 , unsigned int V_57 )
{
struct V_11 * V_82 ;
struct V_112 * V_112 ;
...
int V_336 ;
T_2 V_30 , V_349 ;
int V_331 , V_344 , V_371 , V_380 , V_47 ;
T_3 V_381 , V_85 ;
int V_134 , V_135 ;
bool V_27 ;
...
V_105 = true ;
V_331 = 0 ;
V_85 = V_381 + V_74 -> V_285 [ V_134 ] . V_372 ;
V_371 = V_74 -> V_285 [ V_134 ] . V_116 ;
V_380 = V_371 ;
V_345 = F_165 ( V_371 ,
F_162 (
...
if ( V_345 == 0 )
V_345 ++ ;
V_383 = F_175 ( V_10 , V_74 -> V_75 , V_74 ,
V_345 ) ;
V_377 = F_176 ( V_10 ,
V_74 -> V_75 , V_74 , V_345 ) ;
V_379 = F_174 ( V_10 , V_74 , V_134 ) ;
V_47 = F_144 ( V_10 , V_10 -> V_62 [ V_56 ] , V_57 ,
V_74 -> V_58 , V_379 , V_74 , V_134 , V_319 ) ;
if ( V_47 < 0 ) {
if ( V_134 == 0 )
return V_47 ;
goto V_146;
...
int F_181 ( struct V_9 * V_10 , T_8 V_319 ,
struct V_74 * V_74 , int V_56 , unsigned int V_57 )
{
struct V_81 * V_265 ;
struct V_11 * V_82 ;
...
return F_177 ( V_10 , V_319 , V_74 , V_56 , V_57 ) ;
}
static int F_182 ( struct V_9 * V_10 , struct V_160 * V_174 ,
T_2 V_315 , T_2 V_316 ,
T_2 V_317 , T_2 V_318 , bool V_392 )
{
int V_393 = V_10 -> V_394 ;
int V_47 ;
if ( V_10 -> V_53 & V_54 )
return - V_55 ;
if ( ! V_392 )
V_393 ++ ;
V_47 = F_142 ( V_10 , V_10 -> V_49 , V_326 ,
V_393 , V_162 ) ;
if ( V_47 < 0 ) {
F_22 ( V_10 , L_124 ) ;
if ( V_392 )
...
F_141 ( V_10 , V_10 -> V_49 , false , V_315 , V_316 , V_317 ,
V_318 | V_10 -> V_49 -> V_26 ) ;
return 0 ;
}
...
T_1 V_395 , T_2 V_56 , enum V_396 V_356 )
{
return F_182 ( V_10 , V_174 , F_168 ( V_395 ) ,
F_169 ( V_395 ) , 0 ,
F_38 ( V_201 ) | F_185 ( V_56 )
| ( V_356 == V_397 ? V_398 : 0 ) , false ) ;
}
int F_187 ( struct V_9 * V_10 , struct V_160 * V_174 ,
T_2 V_315 , T_2 V_316 , T_2 V_317 , T_2 V_318 )
{
return F_182 ( V_10 , V_174 , V_315 , V_316 , V_317 , V_318 , false ) ;
}
...
int V_56 , unsigned int V_57 , int V_399 )
{
T_2 V_400 = F_185 ( V_56 ) ;
T_2 V_401 = F_191 ( V_57 ) ;
T_2 type = F_38 ( V_202 ) ;
T_2 V_402 = F_192 ( V_399 ) ;
return F_182 ( V_10 , V_174 , 0 , 0 , 0 ,
V_400 | V_401 | type | V_402 , false ) ;
}
...
F_168 ( V_85 ) | V_404 | V_128 -> V_98 ,
F_169 ( V_85 ) , V_403 ,
V_400 | V_401 | type , false ) ;
if ( V_47 < 0 ) {
F_195 ( V_10 , V_174 ) ;
return;
}
