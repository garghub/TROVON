...
struct V_22 * V_23 ;
struct V_2 * V_24 ;
struct V_25 * V_26 = & V_20 -> V_5 . V_27 -> V_26 ;
struct V_28 * V_29 ;
int V_30 , V_31 ;
char * V_32 = V_21 ;
F_15 ( V_26 ) ;
V_24 = V_20 -> V_5 . V_33 . V_34 -> V_34 -> V_34 ;
V_23 = F_16 ( V_24 ) ;
V_29 = & V_23 -> V_35 ;
F_15 ( & V_23 -> V_36 ) ;
...
static T_1 F_26 ( struct V_67 * V_68 , char * V_21 )
{
struct V_22 * V_23 ;
struct V_2 * V_24 ;
...
static T_1 F_40 ( struct V_88 * V_89 ,
char * V_21 )
{
struct V_22 * V_23 ;
struct V_2 * V_24 ;
...
static int F_45 ( const char * V_21 , T_2 V_72 ,
int (* F_46)( char * , void * ) , void * V_94 )
{
char V_93 [ 1 + sizeof( T_3 ) * 8 + 1 + 1 ] ;
const char * V_32 = V_21 ;
int V_31 , V_60 ;
if ( ! F_46 )
return - V_61 ;
while ( V_32 - V_21 < V_72 ) {
V_31 = 0 ;
while ( V_31 < sizeof( V_93 ) && ( V_32 - V_21 < V_72 ) &&
* V_32 != '\0' && * V_32 != '\n' )
V_93 [ V_31 ++ ] = * V_32 ++ ;
if ( V_31 == sizeof( V_93 ) )
return - V_61 ;
while ( ( V_32 - V_21 < V_72 ) && ( * V_32 == '\0' || * V_32 == '\n' ) )
++ V_32 ;
V_93 [ V_31 ] = '\0' ;
V_60 = F_46 ( V_93 , V_94 ) ;
if ( V_60 )
...
static T_1 F_47 ( struct V_88 * V_71 ,
const char * V_21 , T_2 V_72 )
{
struct V_22 * V_23 ;
struct V_2 * V_24 ;
...
static T_1 F_52 ( struct V_115 * V_71 ,
char * V_21 )
{
struct V_22 * V_23 ;
struct V_2 * V_24 ;
...
V_23 = F_16 ( V_24 ) ;
F_15 ( & V_23 -> V_36 ) ;
memcpy ( V_21 , V_71 -> V_10 . V_116 , sizeof( V_71 -> V_10 . V_116 ) ) ;
F_17 ( & V_23 -> V_36 ) ;
F_17 ( V_26 ) ;
return sizeof( V_71 -> V_10 . V_116 ) ;
}
static T_1 F_53 ( struct V_115 * V_71 ,
const char * V_21 , T_2 V_72 )
{
struct V_22 * V_23 ;
struct V_2 * V_24 ;
...
static inline T_1
F_55 ( struct V_115 * V_117 , char * V_21 )
{
return F_26 ( & V_117 -> V_80 , V_21 ) ;
}
static inline T_1
F_56 ( struct V_115 * V_71 ,
const char * V_21 , T_2 V_72 )
{
return F_27 ( & V_71 -> V_80 , V_21 , V_72 ) ;
}
...
static inline T_1
F_61 ( struct V_128 * V_117 , char * V_21 )
{
return F_26 ( & V_117 -> V_80 , V_21 ) ;
}
static inline T_1
F_62 ( struct V_128 * V_71 ,
const char * V_21 , T_2 V_72 )
{
return F_27 ( & V_71 -> V_80 , V_21 , V_72 ) ;
}
...
{
struct V_133 * V_48 = F_2 ( F_13 ( V_31 ) ,
struct V_133 , V_5 ) ;
if ( V_48 == & V_134 )
return & V_46 -> V_135 ;
if ( V_48 == & V_136 )
...
void * V_140 , void * V_141 ,
int (* F_46)( void * , void * , void * , int , enum V_142 type ) )
{
struct V_77 * V_68 ;
struct V_4 * V_143 ;
struct V_2 * V_3 ;
...
return - V_61 ;
V_31 = V_144 = 0 ;
V_60 = F_46 ( V_7 , V_140 , V_141 , 0 , V_145 ) ;
if ( V_60 )
return V_60 ;
F_68 (f, &h->formats, entry) {
V_60 = F_46 ( V_68 -> V_80 , V_140 , V_141 , V_31 ++ , V_146 ) ;
if ( V_60 )
return V_60 ;
V_143 = & V_68 -> V_80 -> V_5 ;
F_68 (item, &grp->cg_children, ci_entry) {
V_89 = F_39 ( V_3 ) ;
V_60 = F_46 ( V_89 , V_140 , V_141 , V_144 ++ , V_147 ) ;
if ( V_60 )
return V_60 ;
}
}
...
static int F_69 ( void * V_148 , void * V_140 , void * V_141 , int V_97 ,
enum V_142 type )
{
T_2 * V_149 = V_140 ;
T_2 * V_150 = V_141 ;
switch ( type ) {
case V_145 : {
struct V_74 * V_7 = V_148 ;
* V_149 += sizeof( V_7 -> V_10 ) ;
* V_149 += V_7 -> V_83 * V_69 ;
}
break;
case V_146 : {
struct V_67 * V_80 = V_148 ;
if ( V_80 -> type == V_107 ) {
struct V_115 * V_151 =
F_2 ( V_80 , struct V_115 ,
V_80 ) ;
* V_149 += sizeof( V_151 -> V_10 ) ;
} else if ( V_80 -> type == V_111 ) {
struct V_128 * V_152 =
F_2 ( V_80 , struct V_128 , V_80 ) ;
* V_149 += sizeof( V_152 -> V_10 ) ;
} else {
return - V_61 ;
}
}
break;
case V_147 : {
struct V_88 * V_89 = V_148 ;
int V_153 = sizeof( V_89 -> V_92 ) ;
* V_149 += sizeof( V_89 -> V_90 ) ;
* V_149 += V_89 -> V_90 . V_91 * V_153 ;
}
break;
}
++ * V_150 ;
...
static int F_70 ( void * V_148 , void * V_140 , void * V_141 , int V_97 ,
enum V_142 type )
{
void * * V_154 = V_140 ;
struct V_45 * * * V_155 = V_141 ;
T_2 V_153 ;
* * V_155 = * V_154 ;
++ * V_155 ;
switch ( type ) {
...
F_2 ( V_80 , struct V_115 ,
V_80 ) ;
memcpy ( * V_154 , & V_151 -> V_10 , sizeof( V_151 -> V_10 ) ) ;
* V_154 += sizeof( V_151 -> V_10 ) ;
...
V_59 = F_29 ( V_54 ) ;
V_60 = F_67 ( V_59 , & V_149 , & V_150 , F_69 ) ;
if ( V_60 )
goto V_63;
V_150 += 2 ;
* V_58 = F_48 ( V_150 , sizeof( void * ) , V_8 ) ;
if ( ! * V_58 ) {
V_60 = - V_9 ;
goto V_63;
}
V_166 = V_167 = F_4 ( V_149 , V_8 ) ;
if ( ! V_166 ) {
F_11 ( * V_58 ) ;
* V_58 = NULL ;
V_60 = F_74 ( V_166 ) ;
...
static inline void F_78 ( struct V_4 * V_170 ,
struct V_4 * * V_171 ,
const char * V_6 ,
struct V_172 * type )
{
