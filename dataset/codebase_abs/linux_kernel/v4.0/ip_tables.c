...
static int
F_98 ( struct V_78 * V_78 , const void T_4 * V_128 , unsigned int V_111 )
{
int V_12 ;
struct V_159 V_185 ;
struct V_73 * V_121 ;
...
static int
F_100 ( struct V_78 * V_78 , const void T_4 * V_128 ,
...
static int
F_102 ( struct V_43 * V_48 , void T_4 * * V_208 ,
...
F_33 (ematch, e) {
V_12 = F_103 ( V_106 , V_208 , V_130 ) ;
if ( V_12 != 0 )
return V_12 ;
}
V_62 = V_48 -> V_62 - ( V_210 - * V_130 ) ;
V_55 = F_14 ( V_48 ) ;
V_12 = F_104 ( V_55 , V_208 , V_130 ) ;
if ( V_12 )
return V_12 ;
V_133 = V_48 -> V_133 - ( V_210 - * V_130 ) ;
if ( F_105 ( V_62 , & V_209 -> V_62 ) != 0 ||
F_105 ( V_133 , & V_209 -> V_133 ) != 0 )
return - V_175 ;
return 0 ;
}
static int
F_106 ( struct V_105 * V_135 ,
const char * V_59 ,
...
static void F_107 ( struct V_180 * V_48 )
{
struct V_47 * V_55 ;
struct V_105 * V_106 ;
F_33 (ematch, e)
...
static int
F_110 ( struct V_180 * V_48 , void * * V_208 ,
...
static int
F_115 ( struct V_78 * V_78 , void T_4 * V_128 , unsigned int V_111 )
{
int V_12 ;
struct V_222 V_185 ;
struct V_73 * V_121 ;
...
V_12 = F_114 ( V_78 , V_185 . V_59 , V_185 . V_103 ,
...
static int
F_118 ( struct V_223 * V_224 , int V_225 , void T_4 * V_128 ,
unsigned int V_111 )
{
int V_12 ;
...
switch ( V_225 ) {
case V_229 :
V_12 = F_115 ( F_120 ( V_224 ) , V_128 , V_111 ) ;
break;
case V_230 :
V_12 = F_100 ( F_120 ( V_224 ) , V_128 , V_111 , 1 ) ;
break;
default:
F_8 ( L_60 , V_225 ) ;
V_12 = - V_139 ;
...
static int
F_121 ( unsigned int V_170 , struct V_1 * V_85 ,
void T_4 * V_171 )
{
struct V_157 * V_110 ;
const struct V_73 * V_74 = V_85 -> V_74 ;
...
static int
F_122 ( struct V_78 * V_78 , struct V_231 T_4 * V_188 ,
int * V_111 )
{
int V_12 ;
struct V_231 V_189 ;
...
switch ( V_225 ) {
case V_232 :
V_12 = F_83 ( F_120 ( V_224 ) , V_128 , V_111 , 1 ) ;
break;
case V_233 :
V_12 = F_122 ( F_120 ( V_224 ) , V_128 , V_111 ) ;
break;
default:
V_12 = F_124 ( V_224 , V_225 , V_128 , V_111 ) ;
}
return V_12 ;
}
static int
F_125 ( struct V_223 * V_224 , int V_225 , void T_4 * V_128 , unsigned int V_111 )
{
int V_12 ;
if ( ! F_119 ( F_120 ( V_224 ) -> V_226 , V_227 ) )
return - V_228 ;
switch ( V_225 ) {
case V_229 :
V_12 = F_98 ( F_120 ( V_224 ) , V_128 , V_111 ) ;
break;
case V_230 :
V_12 = F_100 ( F_120 ( V_224 ) , V_128 , V_111 , 0 ) ;
break;
default:
F_8 ( L_60 , V_225 ) ;
V_12 = - V_139 ;
...
static int
F_124 ( struct V_223 * V_224 , int V_225 , void T_4 * V_128 , int * V_111 )
{
int V_12 ;
if ( ! F_119 ( F_120 ( V_224 ) -> V_226 , V_227 ) )
return - V_228 ;
switch ( V_225 ) {
case V_232 :
V_12 = F_83 ( F_120 ( V_224 ) , V_128 , V_111 , 0 ) ;
break;
case V_233 :
V_12 = F_93 ( F_120 ( V_224 ) , V_128 , V_111 ) ;
break;
case V_234 :
case V_235 : {
struct V_236 V_237 ;
...
if ( V_12 != 0 )
goto V_240;
V_239 = F_128 ( V_78 , V_85 , & V_238 , V_121 ) ;
if ( F_50 ( V_239 ) ) {
V_12 = F_51 ( V_239 ) ;
goto V_240;
}
...
void F_129 ( struct V_78 * V_78 , struct V_1 * V_85 )
{
struct V_73 * V_74 ;
void * V_174 ;
...
static inline bool
F_131 ( T_7 V_243 , T_7 V_244 , T_7 V_245 ,
T_7 type , T_7 V_246 ,
bool V_247 )
{
return ( ( V_243 == 0xFF ) ||
...
if ( V_40 -> V_95 != 0 )
return false ;
V_249 = F_133 ( V_38 , V_40 -> V_98 , sizeof( V_250 ) , & V_250 ) ;
if ( V_249 == NULL ) {
F_8 ( L_66 ) ;
V_40 -> V_99 = true ;
return false ;
}
return F_131 ( V_252 -> type ,
V_252 -> V_246 [ 0 ] ,
V_252 -> V_246 [ 1 ] ,
V_249 -> type , V_249 -> V_246 ,
! ! ( V_252 -> V_22 & V_253 ) ) ;
}
static int F_134 ( const struct V_141 * V_40 )
{
const struct V_251 * V_252 = V_40 -> V_109 ;
...
if ( V_12 < 0 )
goto V_255;
V_12 = F_141 ( V_256 , F_142 ( V_256 ) ) ;
if ( V_12 < 0 )
goto V_257;
V_12 = F_143 ( V_258 , F_142 ( V_258 ) ) ;
if ( V_12 < 0 )
goto V_259;
V_12 = F_144 ( & V_260 ) ;
if ( V_12 < 0 )
...
return 0 ;
V_261:
F_146 ( V_258 , F_142 ( V_258 ) ) ;
V_259:
F_147 ( V_256 , F_142 ( V_256 ) ) ;
V_257:
F_148 ( & V_254 ) ;
V_255:
return V_12 ;
