...
if ( ! F_68 () ) {
struct V_139 V_44 ;
memset ( & V_44 , 0 , sizeof( struct V_139 ) ) ;
V_36 = V_35 -> V_36 ;
V_44 . type = V_140 ;
V_44 . V_36 = V_36 - 1 ;
V_35 -> V_141 = F_69 ( L_50 ,
NULL , NULL ,
& V_142 ,
& V_44 ) ;
if ( F_70 ( V_35 -> V_141 ) ) {
V_43 = F_71 ( V_35 -> V_141 ) ;
V_35 -> V_141 = NULL ;
goto V_143;
}
V_35 -> V_141 -> V_44 . V_22 = V_35 -> V_39 ;
}
V_43 = F_72 ( & V_144 ) ;
if ( V_43 )
goto V_145;
...
V_35 -> V_141 -> V_44 . V_45 = V_46 ;
else
V_35 -> V_141 -> V_44 . V_45 = V_149 ;
}
F_26 ( L_51 V_150 L_52 ) ;
return 0 ;
V_148:
F_73 ( V_14 ) ;
V_146:
