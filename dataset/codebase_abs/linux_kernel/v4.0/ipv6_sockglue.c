...
V_258 = V_38 -> V_76 ;
if ( V_258 )
F_68 ( V_2 , & V_142 , V_258 ) ;
F_55 ( V_2 ) ;
if ( ! V_258 ) {
if ( V_38 -> V_83 . V_84 . V_85 ) {
struct V_134 V_260 ;
V_260 . V_137 = V_38 -> V_170 ? V_38 -> V_170 :
V_38 -> V_138 . V_137 ;
V_260 . V_139 = V_38 -> V_170 ? V_2 -> V_60 : V_38 -> V_138 . V_139 ;
F_69 ( & V_142 , V_248 , V_133 , sizeof( V_260 ) , & V_260 ) ;
}
if ( V_38 -> V_83 . V_84 . V_89 ) {
int V_261 = V_38 -> V_157 ;
F_69 ( & V_142 , V_248 , V_262 , sizeof( V_261 ) , & V_261 ) ;
}
if ( V_38 -> V_83 . V_84 . V_107 ) {
int V_105 = ( int ) F_70 ( V_38 -> V_263 ) ;
F_69 ( & V_142 , V_248 , V_104 , sizeof( V_105 ) , & V_105 ) ;
}
if ( V_38 -> V_83 . V_84 . V_87 ) {
struct V_134 V_260 ;
V_260 . V_137 = V_38 -> V_170 ? V_38 -> V_170 :
V_38 -> V_138 . V_137 ;
V_260 . V_139 = V_38 -> V_170 ? V_2 -> V_60 :
V_38 -> V_138 . V_139 ;
F_69 ( & V_142 , V_248 , V_86 , sizeof( V_260 ) , & V_260 ) ;
}
if ( V_38 -> V_83 . V_84 . V_91 ) {
int V_261 = V_38 -> V_157 ;
F_69 ( & V_142 , V_248 , V_90 , sizeof( V_261 ) , & V_261 ) ;
}
if ( V_38 -> V_83 . V_84 . V_109 ) {
V_166 V_264 = V_38 -> V_263 ;
F_69 ( & V_142 , V_248 , V_108 , sizeof( V_264 ) , & V_264 ) ;
}
}
V_251 -= V_142 . V_151 ;
return F_71 ( V_251 , V_36 ) ;
}
case V_215 :
{
struct V_265 * V_266 ;
...
V_266 = F_73 ( V_2 ) ;
if ( V_266 )
V_269 . V_270 = F_74 ( V_266 ) ;
F_75 () ;
if ( ! V_269 . V_270 )
return - V_59 ;
if ( F_71 ( V_251 , V_36 ) )
return - V_43 ;
if ( F_64 ( V_35 , & V_269 , V_251 ) )
return - V_43 ;
return 0 ;
}
case V_112 :
...
if ( V_40 < 0 )
V_40 = F_15 ( V_2 ) -> V_271 . V_272 -> V_154 ;
break;
}
case V_159 :
V_40 = V_38 -> V_160 ;
...
break;
case V_161 :
V_40 = ( V_165 int ) F_77 ( ( V_273 ) V_38 -> V_167 ) ;
break;
case V_211 :
V_40 = V_38 -> V_214 ;
break;
...
struct V_274 V_275 ;
int V_256 ;
if ( V_251 < sizeof( V_275 ) )
return - V_125 ;
if ( F_39 ( & V_275 , V_35 , sizeof( V_275 ) ) )
return - V_43 ;
...
V_40 = F_78 ( V_2 , & V_275 , V_256 ) ;
if ( V_40 < 0 )
return V_40 ;
if ( F_71 ( V_251 , V_36 ) )
return - V_43 ;
if ( F_64 ( V_35 , & V_275 , V_251 ) )
return - V_43 ;
return 0 ;
}
case V_226 :
...
int F_79 ( struct V_1 * V_2 , int V_33 , int V_34 ,
char T_1 * V_35 , int T_1 * V_36 )
{
int V_245 ;
if ( V_33 == V_246 && V_2 -> V_8 != V_9 )
return V_72 . V_279 ( V_2 , V_33 , V_34 , V_35 , V_36 ) ;
if ( V_33 != V_248 )
return - V_12 ;
...
return - V_43 ;
F_19 ( V_2 ) ;
V_245 = F_80 ( V_2 , V_249 , V_34 , V_35 ,
& V_251 ) ;
F_55 ( V_2 ) ;
if ( V_245 >= 0 )
V_245 = F_71 ( V_251 , V_36 ) ;
}
#endif
return V_245 ;
}
int F_81 ( struct V_1 * V_2 , int V_33 , int V_34 ,
char T_1 * V_35 , int T_1 * V_36 )
{
int V_245 ;
if ( V_33 == V_246 && V_2 -> V_8 != V_9 ) {
if ( V_72 . V_280 != NULL )
return V_72 . V_280 ( V_2 , V_33 , V_34 ,
V_35 , V_36 ) ;
return V_72 . V_279 ( V_2 , V_33 , V_34 , V_35 , V_36 ) ;
}
if ( V_33 != V_248 )
return - V_12 ;
if ( V_34 == V_204 )
return F_82 ( V_2 , V_33 , V_34 , V_35 , V_36 ,
F_79 ) ;
