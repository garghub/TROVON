...
#ifdef F_64
if ( V_42 -> V_98 ) {
V_42 -> V_103 = ( V_4 -> V_246 - V_247 / 50 ) * V_42 -> V_156 * 3 /
V_4 -> V_53 / 2 ;
F_50 ( V_4 -> V_29 , L_31 ,
V_42 -> V_103 * 1000 / V_247 , V_4 -> V_246 ) ;
if ( V_42 -> V_103 < F_149 ( 20 ) )
V_42 -> V_103 = F_149 ( 20 ) ;
}
#endif
if ( ( V_228 -> V_233 & V_248 ) != 0 )
F_100 ( V_4 ) ;
F_17 ( V_42 ) ;
}
...
return 0 ;
if ( V_4 -> V_106 & V_251 ) {
V_4 -> V_10 = F_154 ( V_4 -> V_252 , V_9 ) ;
if ( F_77 ( ! V_4 -> V_10 ) ) {
F_80 ( V_4 -> V_29 , L_38 , V_4 -> line ) ;
return - V_253 ;
}
} else {
V_4 -> V_10 = ( void V_58 * ) ( V_59 ) V_4 -> V_252 ;
}
return 0 ;
}
...
struct V_254 * V_255 ;
int V_114 ;
V_255 = F_159 ( V_4 -> V_252 , V_9 , F_79 ( V_4 -> V_29 ) ) ;
if ( F_77 ( V_255 == NULL ) )
return - V_256 ;
V_114 = F_153 ( V_4 ) ;
if ( F_77 ( V_114 != 0 ) ) {
...
{
if ( V_106 & V_257 ) {
struct V_1 * V_258 = F_1 ( V_4 ) ;
V_4 -> type = V_258 -> V_14 -> type ;
F_158 ( V_4 ) ;
}
}
static int F_162 ( struct V_2 * V_4 , struct V_259 * V_260 )
{
if ( V_260 -> V_261 < 2400 )
return - V_28 ;
return 0 ;
}
static int F_163 ( struct V_262 * V_29 ,
struct V_1 * V_1 , unsigned int V_263 ,
struct V_13 * V_5 , bool V_264 )
{
struct V_2 * V_4 = & V_1 -> V_4 ;
...
V_4 -> V_266 = V_267 ;
V_4 -> line = V_263 ;
V_255 = F_164 ( V_29 , V_268 , 0 ) ;
if ( V_255 == NULL )
return - V_269 ;
V_4 -> V_252 = V_255 -> V_270 ;
for ( V_77 = 0 ; V_77 < F_165 ( V_1 -> V_129 ) ; ++ V_77 )
V_1 -> V_129 [ V_77 ] = F_166 ( V_29 , V_77 ) ;
if ( V_1 -> V_129 [ 0 ] < 0 )
return - V_253 ;
if ( V_1 -> V_129 [ 1 ] < 0 ) {
...
V_1 -> V_33 . V_273 = F_57 ;
F_171 ( & V_1 -> V_33 ) ;
V_1 -> V_274 = ( V_5 -> type == V_15 ) ?
V_275 : V_276 ;
V_1 -> V_274 |= 1 << V_1 -> V_90 ;
V_4 -> type = V_5 -> type ;
V_4 -> V_106 = V_277 | V_5 -> V_106 ;
V_4 -> V_11 = V_5 -> V_11 ;
...
static void F_175 ( struct V_2 * V_4 , int V_280 )
{
F_28 ( V_4 , V_280 ) ;
}
static void F_176 ( struct V_281 * V_282 , const char * V_42 ,
unsigned V_65 )
{
struct V_1 * V_1 = & V_283 [ V_282 -> V_263 ] ;
struct V_2 * V_4 = & V_1 -> V_4 ;
unsigned short V_284 , V_64 ;
unsigned long V_106 ;
int V_285 = 1 ;
F_177 ( V_106 ) ;
if ( V_4 -> V_286 )
...
V_285 = F_178 ( & V_4 -> V_107 ) ;
else
F_179 ( & V_4 -> V_107 ) ;
V_64 = F_22 ( V_4 , V_66 ) ;
F_24 ( V_4 , V_66 , V_1 -> V_14 -> V_108 ) ;
F_180 ( V_4 , V_42 , V_65 , F_175 ) ;
V_284 = F_29 ( V_4 ) | F_31 ( V_4 ) ;
while ( ( F_22 ( V_4 , V_37 ) & V_284 ) != V_284 )
F_181 () ;
F_24 ( V_4 , V_66 , V_64 ) ;
if ( V_285 )
F_182 ( & V_4 -> V_107 ) ;
...
static int F_184 ( struct V_281 * V_282 , char * V_288 )
{
struct V_1 * V_1 ;
struct V_2 * V_4 ;
int V_230 = 115200 ;
...
int V_289 = 'n' ;
int V_114 ;
if ( V_282 -> V_263 < 0 || V_282 -> V_263 >= V_290 )
return - V_291 ;
V_1 = & V_283 [ V_282 -> V_263 ] ;
V_4 = & V_1 -> V_4 ;
if ( ! V_4 -> V_45 )
return - V_291 ;
V_114 = F_153 ( V_4 ) ;
...
return V_114 ;
if ( V_288 )
F_185 ( V_288 , & V_230 , & V_85 , & V_284 , & V_289 ) ;
return F_186 ( V_4 , V_282 , V_230 , V_85 , V_284 , V_289 ) ;
}
static int F_187 ( struct V_262 * V_292 )
{
struct V_13 * V_14 = F_188 ( & V_292 -> V_29 ) ;
if ( V_293 . V_89 )
return - V_294 ;
V_293 . V_263 = V_292 -> V_295 ;
F_163 ( V_292 , & V_283 [ V_292 -> V_295 ] , V_292 -> V_295 , V_14 , true ) ;
F_184 ( & V_293 , V_296 ) ;
if ( ! strstr ( V_296 , L_44 ) )
V_293 . V_106 |= V_297 ;
F_189 ( & V_293 ) ;
return 0 ;
}
static inline int F_187 ( struct V_262 * V_292 )
{
return - V_28 ;
}
static int F_190 ( struct V_262 * V_29 )
{
...
static struct V_13 *
F_194 ( struct V_262 * V_292 , unsigned int * V_300 )
{
struct V_301 * V_302 = V_292 -> V_29 . V_303 ;
const struct V_304 * V_305 ;
const struct V_306 * V_307 ;
struct V_13 * V_5 ;
int V_295 ;
if ( ! F_195 ( V_308 ) || ! V_302 )
return NULL ;
V_305 = F_196 ( V_309 , V_292 -> V_29 . V_303 ) ;
if ( ! V_305 )
return NULL ;
V_307 = V_305 -> V_89 ;
V_5 = F_197 ( & V_292 -> V_29 , sizeof( struct V_13 ) , V_131 ) ;
if ( ! V_5 ) {
F_80 ( & V_292 -> V_29 , L_45 ) ;
return NULL ;
}
V_295 = F_198 ( V_302 , L_46 ) ;
if ( V_295 < 0 ) {
F_80 ( & V_292 -> V_29 , L_47 , V_295 ) ;
return NULL ;
}
* V_300 = V_295 ;
V_5 -> V_106 = V_251 | V_310 ;
V_5 -> type = V_307 -> type ;
V_5 -> V_16 = V_307 -> V_16 ;
V_5 -> V_108 = V_311 | V_189 ;
return V_5 ;
}
static int F_199 ( struct V_262 * V_29 ,
unsigned int V_263 ,
struct V_13 * V_5 ,
struct V_1 * V_312 )
{
...
V_114 = F_163 ( V_29 , V_312 , V_263 , V_5 , false ) ;
if ( V_114 )
return V_114 ;
V_114 = F_200 ( & V_299 , & V_312 -> V_4 ) ;
if ( V_114 ) {
F_172 ( V_312 ) ;
return V_114 ;
}
...
static int F_201 ( struct V_262 * V_29 )
{
struct V_13 * V_5 ;
struct V_1 * V_313 ;
unsigned int V_300 ;
...
V_313 = & V_283 [ V_300 ] ;
F_203 ( V_29 , V_313 ) ;
V_114 = F_199 ( V_29 , V_300 , V_5 , V_313 ) ;
if ( V_114 )
return V_114 ;
V_313 -> V_120 . V_315 = F_74 ;
V_114 = F_204 ( & V_313 -> V_120 ,
V_298 ) ;
if ( F_77 ( V_114 < 0 ) ) {
F_193 ( & V_299 , & V_313 -> V_4 ) ;
F_172 ( V_313 ) ;
return V_114 ;
}
#ifdef F_205
...
static T_6 int F_207 ( struct V_193 * V_29 )
{
struct V_1 * V_258 = F_208 ( V_29 ) ;
if ( V_258 )
F_209 ( & V_299 , & V_258 -> V_4 ) ;
return 0 ;
}
static T_6 int F_210 ( struct V_193 * V_29 )
{
struct V_1 * V_258 = F_208 ( V_29 ) ;
if ( V_258 )
F_211 ( & V_299 , & V_258 -> V_4 ) ;
return 0 ;
}
