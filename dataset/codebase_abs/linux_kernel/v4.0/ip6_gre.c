...
if ( V_91 ) {
struct V_94 * V_95 ;
if ( ! F_41 ( NULL , V_96 , V_57 ) )
goto V_93;
if ( ! F_42 ( V_91 , & V_64 -> V_71 , & V_64 -> V_72 ) ) {
V_91 -> V_7 -> V_97 . V_98 ++ ;
goto V_93;
}
V_57 -> V_99 = V_11 ;
...
V_64 = F_38 ( V_57 ) ;
V_57 -> V_99 = F_46 ( V_57 , V_91 -> V_7 ) ;
F_44 ( V_57 , F_47 ( V_57 ) , V_110 ) ;
}
F_48 ( V_57 , V_91 -> V_7 , V_91 -> V_12 ) ;
F_49 ( V_57 ) ;
V_92 = F_50 ( V_64 , V_57 ) ;
if ( F_51 ( V_92 ) ) {
if ( V_112 )
...
F_58 ( V_57 , V_77 , V_118 , 0 ) ;
V_93:
F_59 ( V_57 ) ;
return 0 ;
}
static void F_60 ( struct V_119 * V_59 , T_8 V_82 )
{
...
static T_9 F_61 ( struct V_56 * V_57 ,
struct V_6 * V_7 ,
T_8 V_127 ,
struct V_128 * V_129 ,
int V_82 ,
...
V_135 = F_63 ( V_91 ) ;
if ( ! V_135 ) {
V_136 = F_64 ( V_12 , NULL , V_129 ) ;
if ( V_136 -> error )
goto V_143;
V_136 = F_65 ( V_12 , V_136 , F_66 ( V_129 ) , NULL , 0 ) ;
if ( F_67 ( V_136 ) ) {
V_92 = F_68 ( V_136 ) ;
V_136 = NULL ;
goto V_143;
...
V_76 = V_84 ;
if ( F_70 ( V_57 ) )
F_70 ( V_57 ) -> V_123 -> V_146 ( F_70 ( V_57 ) , NULL , V_57 , V_76 ) ;
if ( V_57 -> V_117 > V_76 ) {
* V_130 = V_76 ;
V_92 = - V_147 ;
goto V_145;
...
F_72 ( V_57 , ! F_73 ( V_91 -> V_12 , F_5 ( V_7 ) ) ) ;
V_132 += F_74 ( V_131 ) + V_133 + V_135 -> V_148 ;
if ( F_75 ( V_57 ) < V_132 || F_76 ( V_57 ) ||
( F_77 ( V_57 ) && ! F_78 ( V_57 , 0 ) ) ) {
V_139 = F_79 ( V_57 , V_132 ) ;
if ( V_132 > V_7 -> V_149 )
V_7 -> V_149 = V_132 ;
if ( ! V_139 )
goto V_145;
if ( V_57 -> V_150 )
F_80 ( V_139 , V_57 -> V_150 ) ;
F_81 ( V_57 ) ;
V_57 = V_139 ;
}
if ( V_129 -> V_142 ) {
...
if ( V_82 >= 0 ) {
F_60 ( & V_59 , V_82 ) ;
F_84 ( V_57 , & V_59 . V_123 , & V_138 , NULL ) ;
}
if ( F_85 ( ! V_57 -> V_152 ) ) {
F_86 ( V_57 ) ;
V_57 -> V_152 = 1 ;
...
F_87 ( V_57 , V_133 ) ;
F_49 ( V_57 ) ;
F_88 ( V_57 , sizeof( * V_64 ) ) ;
V_64 = F_38 ( V_57 ) ;
F_89 ( V_64 , F_90 ( 0 , V_127 ) ,
F_91 ( V_12 , V_57 , V_129 -> V_153 , false ) ) ;
...
static inline int F_98 ( struct V_56 * V_57 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
const struct V_160 * V_161 = F_99 ( V_57 ) ;
int V_82 = - 1 ;
struct V_128 V_129 ;
T_8 V_127 ;
T_6 V_76 ;
...
V_129 . V_153 |= F_92 ( ( T_6 ) V_161 -> V_169 << V_170 )
& V_171 ;
if ( V_17 -> V_28 . V_32 & V_172 )
V_129 . V_142 = V_57 -> V_173 ;
V_92 = F_61 ( V_57 , V_7 , V_127 , & V_129 , V_82 , & V_76 ) ;
if ( V_92 != 0 ) {
if ( V_92 == - V_147 )
F_101 ( V_57 , V_174 , V_175 ,
F_92 ( V_76 ) ) ;
return - 1 ;
}
return 0 ;
}
static inline int F_102 ( struct V_56 * V_57 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_63 * V_64 = F_38 ( V_57 ) ;
int V_82 = - 1 ;
T_10 V_61 ;
struct V_128 V_129 ;
T_8 V_127 ;
...
return - 1 ;
V_61 = F_34 ( V_57 , F_103 ( V_57 ) ) ;
if ( V_61 > 0 ) {
struct V_74 * V_75 ;
V_75 = (struct V_74 * ) & F_103 ( V_57 ) [ V_61 ] ;
if ( V_75 -> V_82 == 0 ) {
F_58 ( V_57 , V_80 ,
V_81 , V_61 + 2 ) ;
return - 1 ;
...
V_129 . V_153 |= F_104 ( V_64 ) ;
if ( V_17 -> V_28 . V_32 & V_172 )
V_129 . V_142 = V_57 -> V_173 ;
V_92 = F_61 ( V_57 , V_7 , V_127 , & V_129 , V_82 , & V_76 ) ;
if ( V_92 != 0 ) {
if ( V_92 == - V_147 )
F_58 ( V_57 , V_83 , 0 , V_76 ) ;
return - 1 ;
}
return 0 ;
}
static inline bool F_105 ( const struct V_5 * V_17 ,
const struct V_63 * V_177 )
{
return F_10 ( & V_17 -> V_28 . V_30 , & V_177 -> V_72 ) ;
}
static int F_106 ( struct V_56 * V_57 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
int V_82 = - 1 ;
struct V_128 V_129 ;
...
V_92 = F_61 ( V_57 , V_7 , 0 , & V_129 , V_82 , & V_76 ) ;
return V_92 ;
}
static T_9 F_107 ( struct V_56 * V_57 ,
struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_137 * V_97 = & V_17 -> V_7 -> V_97 ;
int V_178 ;
if ( ! F_108 ( V_17 , & V_17 -> V_28 . V_29 , & V_17 -> V_28 . V_30 ) )
goto V_179;
switch ( V_57 -> V_99 ) {
case F_8 ( V_180 ) :
V_178 = F_98 ( V_57 , V_7 ) ;
break;
case F_8 ( V_101 ) :
V_178 = F_102 ( V_57 , V_7 ) ;
break;
default:
V_178 = F_106 ( V_57 , V_7 ) ;
break;
}
if ( V_178 < 0 )
goto V_179;
...
V_36 -> V_32 |= F_109 ( V_17 , & V_36 -> V_29 , & V_36 -> V_30 ) ;
if ( V_36 -> V_32 & V_191 &&
...
V_17 -> V_141 = V_185 ;
if ( V_36 -> V_32 & V_191 ) {
int V_195 = ( F_110 ( & V_36 -> V_30 ) &
( V_196 | V_197 ) ) ;
struct V_198 * V_199 = F_111 ( V_17 -> V_12 ,
& V_36 -> V_30 , & V_36 -> V_29 ,
V_36 -> V_13 , V_195 ) ;
if ( V_199 == NULL )
return;
...
static int F_113 ( struct V_5 * V_17 ,
...
static void F_116 ( struct V_201 * V_164 ,
const struct V_35 * V_36 )
{
V_164 -> V_138 = V_167 ;
...
case V_206 :
if ( V_7 == V_20 -> V_34 ) {
if ( F_118 ( & V_36 , V_203 -> V_207 . V_208 , sizeof( V_36 ) ) ) {
V_92 = - V_209 ;
break;
}
F_115 ( & V_205 , & V_36 ) ;
...
if ( F_119 ( V_203 -> V_207 . V_208 , & V_36 , sizeof( V_36 ) ) )
V_92 = - V_209 ;
break;
case V_210 :
case V_211 :
V_92 = - V_212 ;
if ( ! F_120 ( V_12 -> V_213 , V_214 ) )
goto V_215;
V_92 = - V_209 ;
if ( F_118 ( & V_36 , V_203 -> V_207 . V_208 , sizeof( V_36 ) ) )
goto V_215;
...
static int F_124 ( struct V_6 * V_7 , int V_221 )
{
if ( V_221 < 68 ||
...
static int F_125 ( struct V_56 * V_57 , struct V_6 * V_7 ,
unsigned short type ,
const void * V_71 , const void * V_72 , unsigned int V_117 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_63 * V_64 = (struct V_63 * ) F_87 ( V_57 , V_17 -> V_141 ) ;
T_3 * V_36 = ( T_3 * ) ( V_64 + 1 ) ;
F_89 ( V_64 , 0 ,
F_91 ( F_5 ( V_7 ) , V_57 ,
...
V_7 -> V_140 = & V_231 ;
V_7 -> V_95 = F_130 ( struct V_94 ) ;
if ( ! V_7 -> V_95 )
return - V_232 ;
F_131 (i) {
struct V_94 * V_233 ;
V_233 = F_132 ( V_7 -> V_95 , V_230 ) ;
F_133 ( & V_233 -> V_114 ) ;
}
...
static void F_135 ( struct V_12 * V_12 , struct V_234 * V_235 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
...
static int F_145 ( struct V_244 * V_245 [] , struct V_244 * V_65 [] )
{
T_3 V_32 ;
if ( ! V_65 )
return 0 ;
V_32 = 0 ;
if ( V_65 [ V_246 ] )
V_32 |= F_146 ( V_65 [ V_246 ] ) ;
if ( V_65 [ V_247 ] )
V_32 |= F_146 ( V_65 [ V_247 ] ) ;
if ( V_32 & ( V_70 | V_69 ) )
return - V_216 ;
return 0 ;
}
static int F_147 ( struct V_244 * V_245 [] , struct V_244 * V_65 [] )
{
struct V_1 V_71 ;
if ( V_245 [ V_248 ] ) {
if ( F_148 ( V_245 [ V_248 ] ) != V_249 )
return - V_216 ;
if ( ! F_149 ( F_150 ( V_245 [ V_248 ] ) ) )
return - V_250 ;
}
if ( ! V_65 )
goto V_251;
if ( V_65 [ V_252 ] ) {
F_151 ( & V_71 , V_65 [ V_252 ] , sizeof( struct V_1 ) ) ;
if ( F_14 ( & V_71 ) )
return - V_216 ;
}
V_251:
return F_145 ( V_245 , V_65 ) ;
}
static void F_152 ( struct V_244 * V_65 [] ,
struct V_35 * V_28 )
{
...
return;
if ( V_65 [ V_253 ] )
V_28 -> V_13 = F_153 ( V_65 [ V_253 ] ) ;
if ( V_65 [ V_246 ] )
V_28 -> V_104 = F_146 ( V_65 [ V_246 ] ) ;
if ( V_65 [ V_247 ] )
V_28 -> V_52 = F_146 ( V_65 [ V_247 ] ) ;
if ( V_65 [ V_254 ] )
V_28 -> V_31 = F_154 ( V_65 [ V_254 ] ) ;
if ( V_65 [ V_255 ] )
V_28 -> V_158 = F_154 ( V_65 [ V_255 ] ) ;
if ( V_65 [ V_256 ] )
F_151 ( & V_28 -> V_29 , V_65 [ V_256 ] , sizeof( struct V_1 ) ) ;
if ( V_65 [ V_252 ] )
F_151 ( & V_28 -> V_30 , V_65 [ V_252 ] , sizeof( struct V_1 ) ) ;
if ( V_65 [ V_257 ] )
V_28 -> V_154 = F_155 ( V_65 [ V_257 ] ) ;
if ( V_65 [ V_258 ] )
V_28 -> V_82 = F_155 ( V_65 [ V_258 ] ) ;
if ( V_65 [ V_259 ] )
V_28 -> V_189 = F_153 ( V_65 [ V_259 ] ) ;
if ( V_65 [ V_260 ] )
V_28 -> V_32 = F_153 ( V_65 [ V_260 ] ) ;
}
...
static int F_160 ( struct V_12 * V_262 , struct V_6 * V_7 ,
...
static int F_162 ( struct V_6 * V_7 , struct V_244 * V_245 [] ,
struct V_244 * V_65 [] )
{
...
V_17 = V_44 ;
F_19 ( V_20 , V_17 ) ;
F_113 ( V_17 , & V_36 , ! V_245 [ V_263 ] ) ;
F_16 ( V_20 , V_17 ) ;
F_122 ( V_7 ) ;
}
return 0 ;
}
static void F_163 ( struct V_6 * V_7 , struct V_234 * V_235 )
{
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
if ( V_7 != V_20 -> V_34 )
...
static T_13 F_164 ( const struct V_6 * V_7 )
{
return
F_165 ( 4 ) +
F_165 ( 2 ) +
...
static int F_166 ( struct V_56 * V_57 , const struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_167 ( V_57 , V_253 , V_36 -> V_13 ) ||
F_168 ( V_57 , V_246 , V_36 -> V_104 ) ||
F_168 ( V_57 , V_247 , V_36 -> V_52 ) ||
F_169 ( V_57 , V_254 , V_36 -> V_31 ) ||
F_169 ( V_57 , V_255 , V_36 -> V_158 ) ||
F_170 ( V_57 , V_256 , sizeof( struct V_1 ) , & V_36 -> V_29 ) ||
F_170 ( V_57 , V_252 , sizeof( struct V_1 ) , & V_36 -> V_30 ) ||
F_171 ( V_57 , V_257 , V_36 -> V_154 ) ||
F_171 ( V_57 , V_258 , V_36 -> V_82 ) ||
F_169 ( V_57 , V_259 , V_36 -> V_189 ) ||
F_167 ( V_57 , V_260 , V_36 -> V_32 ) )
goto V_264;
return 0 ;
V_264:
return - V_147 ;
}
static int T_14 F_172 ( void )
{
int V_92 ;
F_173 ( L_9 ) ;
V_92 = F_174 ( & V_265 ) ;
