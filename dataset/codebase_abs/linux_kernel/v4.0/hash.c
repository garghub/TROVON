...
int F_170 ( struct V_191 * V_192 )
{
return F_171 ( V_192 , L_6 ,
V_141 ,
...
int F_174 ( struct V_4 * V_5 , struct V_191 * V_192 )
{
int V_193 [ 8 ] = { 0 , } ;
int V_194 = - 1 ;
int V_195 = - 1 ;
...
F_171 ( V_192 , L_21 , V_196 , V_194 , V_195 ) ;
for ( V_98 = 0 ; V_98 < 8 ; V_98 ++ )
F_171 ( V_192 , L_22 , V_193 [ V_98 ] , ( V_98 == 7 ) ? '\n' : '/' ) ;
F_130 ( V_5 , 0 ) ;
return 0 ;
}
