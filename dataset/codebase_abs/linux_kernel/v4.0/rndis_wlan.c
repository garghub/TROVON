...
V_282 = F_87 ( V_5 -> V_190 . V_191 , V_182 ,
V_297 , V_141 -> V_291 ,
V_283 , V_284 , V_285 ,
...
static int F_81 ( struct V_2 * V_115 , T_2 * V_300 ,
bool * V_301 )
{
void * V_82 = NULL ;
struct V_302 * V_303 ;
...
V_289 = 0 ;
V_141 = F_89 ( V_303 -> V_141 , & V_289 , V_82 , V_81 ) ;
while ( F_90 ( V_141 , V_289 , V_82 , V_81 ) ) {
if ( F_83 ( V_115 , V_141 ) && V_300 &&
V_301 ) {
if ( F_70 ( V_141 -> V_291 , V_300 ) )
* V_301 = true ;
}
V_304 ++ ;
...
static void F_91 ( struct V_309 * V_310 )
{
struct V_1 * V_5 =
F_92 ( V_310 , struct V_1 , V_279 . V_310 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
int V_70 ;
...
V_70 = F_39 ( V_115 , V_312 -> V_315 . V_322 , V_312 -> V_152 ,
V_153 ) ;
if ( V_70 < 0 ) {
...
V_70 = F_52 ( V_115 , V_312 -> V_192 , V_312 -> V_193 , V_312 -> V_213 ) ;
if ( V_70 < 0 ) {
...
if ( V_312 -> V_141 && ! F_34 ( V_312 -> V_141 ) &&
! F_54 ( V_312 -> V_141 ) ) {
...
return F_52 ( V_115 , V_192 . V_199 , V_192 . V_81 , V_331 ) ;
}
...
static int F_109 ( struct V_191 * V_191 , struct V_254 * V_3 ,
...
static int F_110 ( struct V_191 * V_191 , struct V_254 * V_271 ,
struct V_247 * V_248 )
{
struct V_1 * V_5 = F_74 ( V_191 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
...
static int F_114 ( struct V_191 * V_191 , struct V_254 * V_271 )
{
struct V_1 * V_5 = F_74 ( V_191 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
struct V_236 V_245 ;
...
static int F_115 ( struct V_191 * V_191 , struct V_254 * V_3 ,
...
static int F_116 ( struct V_191 * V_191 ,
struct V_254 * V_3 ,
T_5 V_351 , T_1 V_352 )
{
struct V_1 * V_5 = F_74 ( V_191 ) ;
...
static void F_117 ( struct V_2 * V_115 , T_2 * V_141 ,
struct V_144 * V_145 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
struct V_188 * V_182 ;
...
static void F_118 ( struct V_2 * V_115 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
...
if ( ! V_145 ) {
F_119 ( V_367 , & V_5 -> V_368 ) ;
F_120 ( V_5 -> V_278 , & V_5 -> V_310 ) ;
return;
}
...
V_366 = false ;
F_81 ( V_115 , V_141 , & V_366 ) ;
if ( ! F_34 ( V_141 ) && ! V_366 ) {
F_117 ( V_115 , V_141 , V_145 ) ;
}
if ( V_5 -> V_179 == V_147 ) {
if ( ! V_365 )
F_122 ( V_115 -> V_104 , V_141 , V_364 ,
V_363 , V_357 ,
V_362 , 0 , V_96 ) ;
else
F_123 ( V_115 -> V_104 ,
...
static void F_126 ( struct V_2 * V_115 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
if ( V_5 -> V_327 ) {
V_5 -> V_327 = false ;
memset ( V_5 -> V_141 , 0 , V_142 ) ;
F_46 ( V_115 ) ;
F_127 ( V_115 -> V_104 , 0 , NULL , 0 , V_96 ) ;
}
F_128 ( V_115 -> V_104 ) ;
}
static void F_129 ( struct V_309 * V_310 )
{
struct V_1 * V_5 =
F_92 ( V_310 , struct V_1 , V_310 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
if ( F_130 ( V_367 , & V_5 -> V_368 ) )
F_118 ( V_115 ) ;
if ( F_130 ( V_373 , & V_5 -> V_368 ) )
F_126 ( V_115 ) ;
if ( F_130 ( V_374 , & V_5 -> V_368 ) )
F_58 ( V_115 ) ;
}
static void F_131 ( struct V_254 * V_3 )
{
struct V_2 * V_115 = F_80 ( V_3 ) ;
struct V_1 * V_5 = F_1 ( V_115 ) ;
if ( F_132 ( V_374 , & V_5 -> V_368 ) )
return;
F_119 ( V_374 , & V_5 -> V_368 ) ;
F_120 ( V_5 -> V_278 , & V_5 -> V_310 ) ;
}
static void F_133 ( struct V_2 * V_115 ,
struct V_375 * V_376 ,
int V_81 )
{
T_2 * V_82 ;
...
struct V_380 * V_381 ;
enum V_382 V_383 ;
if ( V_81 < F_134 ( struct V_375 , V_89 ) +
sizeof( struct V_380 ) ) {
F_135 ( V_115 -> V_104 , L_104 ,
V_81 ) ;
return;
}
V_82 = ( void * ) & V_376 -> V_89 . V_384 [ 0 ] ;
V_90 = V_81 - F_134 ( struct V_375 , V_89 ) ;
...
F_134 ( struct V_375 , V_89 ) ;
if ( V_81 < V_390 ) {
F_135 ( V_115 -> V_104 , L_112 ,
V_81 , V_390 ) ;
return;
}
V_388 = & V_376 -> V_89 . V_388 ;
F_135 ( V_115 -> V_104 , L_113 ,
F_9 ( V_388 -> V_393 ) ,
F_9 ( V_388 -> V_391 ) ) ;
...
F_138 ( V_115 -> V_104 , V_126 , V_394 -> V_141 ,
V_396 , V_234 ) ;
}
}
...
V_107 = F_134 ( struct V_398 , V_106 ) +
F_9 ( V_399 -> V_107 ) ;
V_81 = F_9 ( V_399 -> V_148 ) ;
if ( V_81 < 8 ) {
F_135 ( V_115 -> V_104 , L_115 ,
V_81 ) ;
return;
}
if ( V_81 > V_90 || V_107 > V_90 || V_107 + V_81 > V_90 ) {
F_135 ( V_115 -> V_104 , L_116 ,
V_107 + V_81 , V_90 ) ;
return;
}
...
case V_401 :
F_135 ( V_115 -> V_104 , L_117 ,
F_9 ( V_376 -> V_89 . V_402 ) ) ;
return;
case V_403 :
F_135 ( V_115 -> V_104 , L_118 ,
F_9 ( V_376 -> V_89 . V_404 ) ) ;
return;
case V_405 :
F_133 ( V_115 , V_376 , V_81 ) ;
return;
case V_406 :
F_137 ( V_115 , V_376 , V_81 ) ;
return;
default:
F_135 ( V_115 -> V_104 , L_119 ,
F_9 ( V_376 -> V_400 ) ) ;
}
}
static void F_140 ( struct V_2 * V_115 , void * V_407 , int V_90 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
...
F_97 ( V_115 ) ;
F_135 ( V_115 -> V_104 , L_121 ) ;
F_119 ( V_367 , & V_5 -> V_368 ) ;
F_120 ( V_5 -> V_278 , & V_5 -> V_310 ) ;
break;
case V_409 :
F_135 ( V_115 -> V_104 , L_122 ) ;
F_119 ( V_373 , & V_5 -> V_368 ) ;
F_120 ( V_5 -> V_278 , & V_5 -> V_310 ) ;
break;
case V_410 :
F_139 ( V_115 , V_399 , V_90 ) ;
break;
default:
F_135 ( V_115 -> V_104 , L_123 ,
F_9 ( V_399 -> V_106 ) ) ;
break;
}
}
static int F_141 ( struct V_2 * V_115 , struct V_191 * V_191 )
{
struct {
T_3 V_308 ;
T_3 V_411 [ 8 ] ;
...
static void F_142 ( struct V_2 * V_115 , T_5 V_294 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
enum V_427 V_428 ;
...
return;
V_5 -> V_355 = V_294 ;
F_143 ( V_115 -> V_104 , V_428 , V_96 ) ;
}
static void F_144 ( struct V_309 * V_310 )
{
struct V_1 * V_5 =
F_92 ( V_310 , struct V_1 ,
V_434 . V_310 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
T_3 V_294 , V_133 ;
int V_81 , V_70 , V_435 ;
...
F_82 ( V_5 -> V_278 , & V_5 -> V_434 ,
V_436 ) ;
}
static void F_147 ( struct V_2 * V_115 , int V_275 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
V_5 -> V_275 = V_275 ;
V_5 -> V_441 [ 0 ] = V_442 [ 0 ] ;
...
static int F_151 ( struct V_2 * V_115 , struct V_456 * V_457 )
{
struct V_191 * V_191 ;
struct V_1 * V_5 ;
int V_417 , V_81 ;
T_3 V_133 ;
V_191 = F_152 ( & V_458 , sizeof( struct V_1 ) ) ;
if ( ! V_191 )
return - V_97 ;
V_5 = F_74 ( V_191 ) ;
...
V_5 -> V_115 = V_115 ;
F_153 ( & V_5 -> V_99 ) ;
V_5 -> V_278 = F_154 ( L_139 ) ;
F_155 ( & V_5 -> V_310 , F_129 ) ;
F_156 ( & V_5 -> V_434 , F_144 ) ;
F_156 ( & V_5 -> V_279 , F_91 ) ;
V_417 = F_157 ( V_115 , V_457 , V_460 ) ;
if ( V_417 < 0 )
goto V_461;
...
V_5 -> V_475 . V_476 = F_158 ( V_472 ) ;
V_5 -> V_475 . V_477 = V_5 -> V_473 ;
V_5 -> V_475 . V_478 = F_158 ( V_474 ) ;
V_191 -> V_479 [ V_186 ] = & V_5 -> V_475 ;
V_191 -> V_480 = V_481 ;
memcpy ( V_5 -> V_482 , V_483 ,
sizeof( V_483 ) ) ;
V_191 -> V_482 = V_5 -> V_482 ;
V_191 -> V_484 = F_158 ( V_483 ) ;
F_159 ( V_191 , & V_115 -> V_485 -> V_3 ) ;
if ( F_160 ( V_191 ) ) {
V_417 = - V_486 ;
goto V_461;
}
...
static void F_166 ( struct V_2 * V_115 , struct V_456 * V_457 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
F_35 ( V_115 , false ) ;
F_161 ( & V_5 -> V_434 ) ;
