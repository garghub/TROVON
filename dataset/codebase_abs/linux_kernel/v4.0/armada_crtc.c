...
static void F_58 ( void T_1 * V_7 , T_2 * V_168 ,
...
static int F_60 ( struct V_1 * V_2 , bool V_180 )
{
...
V_181 = - V_2 -> V_191 ;
V_182 = 0 ;
V_183 -= F_61 ( V_181 , V_183 ) ;
} else if ( V_2 -> V_191 + V_183 > V_2 -> V_17 . V_18 . V_121 ) {
V_181 = 0 ;
V_182 = V_2 -> V_191 ;
V_183 = F_62 ( int , V_2 -> V_17 . V_18 . V_121 - V_2 -> V_191 , 0 ) ;
} else {
V_181 = 0 ;
V_182 = V_2 -> V_191 ;
}
...
V_186 = - V_2 -> V_192 ;
V_187 = 0 ;
V_188 -= F_61 ( V_186 , V_188 ) ;
} else if ( V_2 -> V_192 + V_188 > V_2 -> V_17 . V_18 . V_122 ) {
V_186 = 0 ;
V_187 = V_2 -> V_192 ;
V_188 = F_62 ( int , V_2 -> V_17 . V_18 . V_122 - V_2 -> V_192 , 0 ) ;
} else {
V_186 = 0 ;
V_187 = V_2 -> V_192 ;
}
...
F_58 ( V_2 -> V_7 , V_168 , V_185 , V_183 , V_188 ) ;
}
F_27 ( & V_2 -> V_80 ) ;
...
static int F_63 ( struct V_57 * V_17 ,
...
static int F_69 ( struct V_57 * V_17 , int V_29 , int V_30 )
{
struct V_46 * V_47 = V_17 -> V_47 ;
struct V_1 * V_2 = F_32 ( V_17 ) ;
int V_48 ;
...
static void F_70 ( struct V_57 * V_17 )
{
struct V_1 * V_2 = F_32 ( V_17 ) ;
...
if ( V_208 -> V_218 )
return 0 ;
V_208 -> V_218 = F_78 ( V_47 , 0 ,
L_8 , V_220 ,
F_79 ( V_220 ) ) ;
V_208 -> V_219 = F_78 ( V_47 , 0 ,
L_9 , V_221 ,
F_79 ( V_221 ) ) ;
...
int F_80 ( struct V_46 * V_222 , struct V_223 * V_47 ,
...
F_3 ( 0 , V_2 -> V_7 + V_110 ) ;
V_48 = F_89 ( V_47 , V_108 , F_46 , 0 , L_11 ,
V_2 ) ;
if ( V_48 < 0 ) {
F_20 ( V_2 ) ;
return V_48 ;
...
F_90 ( V_222 , & V_2 -> V_17 , & V_239 ) ;
F_91 ( & V_2 -> V_17 , & V_240 ) ;
F_92 ( & V_2 -> V_17 . V_7 , V_208 -> V_218 ,
V_2 -> V_115 ) ;
F_92 ( & V_2 -> V_17 . V_7 , V_208 -> V_219 ,
V_2 -> V_118 ) ;
return F_93 ( V_222 , 1 << V_2 -> V_49 ) ;
}
static int
F_94 ( struct V_223 * V_47 , struct V_223 * V_241 , void * V_83 )
{
struct V_242 * V_243 = F_95 ( V_47 ) ;
struct V_46 * V_222 = V_83 ;
struct V_224 * V_225 = F_96 ( V_243 , V_244 , 0 ) ;
int V_108 = F_97 ( V_243 , 0 ) ;
...
V_250 = F_99 ( V_47 -> V_253 -> V_254 , V_47 ) ;
if ( ! V_250 )
return - V_198 ;
V_251 = F_100 ( V_252 , L_12 ) ;
if ( V_251 )
V_252 = V_251 ;
V_211 = F_100 ( V_252 , L_13 ) ;
F_74 ( V_251 ) ;
if ( ! V_211 ) {
F_101 ( V_47 , L_14 ,
V_252 -> V_255 ) ;
...
return F_80 ( V_222 , V_47 , V_225 , V_108 , V_69 , V_211 ) ;
}
static void
F_102 ( struct V_223 * V_47 , struct V_223 * V_241 , void * V_83 )
{
struct V_1 * V_2 = F_103 ( V_47 ) ;
F_70 ( & V_2 -> V_17 ) ;
}
static int F_104 ( struct V_242 * V_243 )
{
return F_105 ( & V_243 -> V_47 , & V_256 ) ;
}
static int F_106 ( struct V_242 * V_243 )
{
F_107 ( & V_243 -> V_47 , & V_256 ) ;
return 0 ;
}
