...
error = F_29 ( V_6 , V_49 , V_50 , V_51 , 1 ) ;
F_30 ( V_6 ) ;
return error ;
}
...
goto V_17;
if ( ! strncmp ( L_11 , V_60 , 22 ) ) {
V_35 = V_60 + 23 ;
V_48 = F_36 ( V_35 , & V_35 , 0 ) ;
V_49 = F_36 ( V_35 + 1 , & V_35 , 0 ) ;
V_50 = F_36 ( V_35 + 1 , & V_35 , 0 ) ;
V_51 = F_36 ( V_35 + 1 , & V_35 , 0 ) ;
V_61 = F_27 ( V_48 , V_49 , V_50 , V_51 ) ;
} else if ( ! strncmp ( L_12 , V_60 , 25 ) ) {
V_35 = V_60 + 26 ;
V_48 = F_36 ( V_35 , & V_35 , 0 ) ;
V_49 = F_36 ( V_35 + 1 , & V_35 , 0 ) ;
V_50 = F_36 ( V_35 + 1 , & V_35 , 0 ) ;
V_51 = F_36 ( V_35 + 1 , & V_35 , 0 ) ;
V_61 = F_31 ( V_48 , V_49 , V_50 , V_51 ) ;
}
if ( ! V_61 )
V_61 = V_59 ;
V_17:
...
static inline struct V_41 * F_38 ( struct V_41 * V_62 )
{
struct V_41 * V_63 = F_39 ( & V_64 , V_62 , NULL ,
F_37 ) ;
F_40 ( V_62 ) ;
return V_63 ;
}
static void * F_41 ( struct V_18 * V_65 , T_4 * V_66 )
{
...
static void * F_42 ( struct V_18 * V_65 , void * V_20 , T_4 * V_66 )
{
( * V_66 ) ++ ;
V_65 -> V_21 ++ ;
return F_38 ( V_20 ) ;
}
static void F_43 ( struct V_18 * V_65 , void * V_20 )
{
F_40 ( V_20 ) ;
}
static int F_44 ( struct V_18 * V_65 , void * V_42 )
{
if ( ! V_65 -> V_21 )
F_25 ( V_65 , L_13 ) ;
