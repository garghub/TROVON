...
{
static const T_2 V_13 [] = { 0xE0 , 0x00 , 0x80 , 0x40 } ;
...
( const struct V_39 * ) V_2 -> V_37 -> V_13 ;
F_19 ( & V_40 -> V_41 ) ;
V_35 = F_20 ( V_40 -> V_42 ) ;
V_36 = F_20 ( V_40 -> V_41 . V_43 ) ;
V_10 = ( const T_2 * )
( V_2 -> V_37 -> V_13 + F_20 ( V_40 -> V_41 . V_44 ) ) ;
} else {
switch ( V_2 -> V_45 ) {
case V_46 :
V_35 = V_47 ;
