...
static long F_39 ( struct V_39 * V_40 , T_1 V_4 ,
void * * V_60 , unsigned long * V_61 , long V_62 )
{
struct V_2 * V_3 = V_40 -> V_42 -> V_43 ;
struct V_1 * V_1 ;
if ( ! V_3 )
...
static int F_42 ( struct V_39 * V_40 , T_5 V_64 ,
...
static int T_6 F_46 ( char * V_73 )
{
V_74 = F_47 ( V_73 , NULL , 0 ) ;
return 1 ;
}
...
static struct V_2 * F_64 ( int V_18 , bool * V_101 )
{
struct V_2 * V_3 ;
* V_101 = false ;
...
static struct V_104 * F_71 ( T_7 V_105 , int * V_106 , void * V_107 )
{
struct V_2 * V_3 ;
struct V_104 * V_108 ;
bool V_101 ;
F_43 ( & V_109 ) ;
V_3 = F_64 ( F_72 ( V_105 ) / V_90 , & V_101 ) ;
V_108 = V_3 ? F_73 ( V_3 -> V_89 ) : NULL ;
F_45 ( & V_109 ) ;
if ( V_101 )
* V_106 = 0 ;
return V_108 ;
...
F_65 (brd, &brd_devices, brd_list)
F_66 ( V_3 -> V_89 ) ;
F_76 ( F_77 ( V_93 , 0 ) , 1UL << V_113 ,
V_114 , F_71 , NULL , NULL ) ;
F_78 ( L_3 ) ;
return 0 ;
V_112:
