...
switch ( V_287 ) {
case V_290 :
return & V_48 -> V_304 [ 0 ] [ V_82 ] ;
case V_289 :
V_82 = V_305 ;
case V_291 :
return & V_48 -> V_304 [ 1 ] [ V_82 ] ;
case V_292 :
return & V_48 -> V_306 ;
default:
F_300 () ;
...
struct V_70 * V_70 , T_9 V_298 )
{
int V_287 = F_279 ( V_66 -> V_82 ) ;
int V_82 = F_283 ( V_66 -> V_82 ) ;
struct V_51 * * V_304 = NULL ;
struct V_51 * V_52 = NULL ;
if ( ! V_67 ) {
if ( ! F_301 ( V_66 -> V_82 ) ) {
struct V_230 * V_231 = V_232 ;
...
static void
F_302 ( struct V_307 * V_170 , unsigned long V_308 )
{
unsigned long V_309 = V_110 - V_170 -> V_171 ;
V_309 = F_81 ( V_309 , 2UL * V_308 ) ;
V_170 -> V_253 = ( 7 * V_170 -> V_253 + 256 ) / 8 ;
V_170 -> V_310 = ( 7 * V_170 -> V_310 + 256 * V_309 ) / 8 ;
V_170 -> V_254 = ( V_170 -> V_310 + 128 ) / V_170 -> V_253 ;
}
static void
...
{
if ( F_57 ( V_52 ) ) {
F_302 ( & V_66 -> V_170 , V_48 -> V_49 ) ;
F_302 ( & V_52 -> V_217 -> V_170 ,
V_48 -> V_49 ) ;
}
#ifdef F_304
F_302 ( & V_52 -> V_3 -> V_170 , V_48 -> V_250 ) ;
#endif
}
static void
...
{
T_4 V_311 = 0 ;
T_4 V_312 = F_198 ( V_227 ) ;
if ( V_52 -> V_313 ) {
if ( V_52 -> V_313 < F_94 ( V_227 ) )
V_311 = F_94 ( V_227 ) - V_52 -> V_313 ;
else
V_311 = V_52 -> V_313 - F_94 ( V_227 ) ;
}
V_52 -> V_314 <<= 1 ;
if ( F_235 ( V_48 -> V_65 ) )
V_52 -> V_314 |= ( V_312 < V_315 ) ;
else
V_52 -> V_314 |= ( V_311 > V_316 ) ;
}
static void
F_306 ( struct V_47 * V_48 , struct V_51 * V_52 ,
struct V_60 * V_66 )
{
int V_317 , V_318 ;
if ( ! F_57 ( V_52 ) || F_54 ( V_52 ) )
return;
V_318 = V_317 = F_58 ( V_52 ) ;
if ( V_52 -> V_22 [ 0 ] + V_52 -> V_22 [ 1 ] >= 4 )
F_307 ( V_52 ) ;
if ( V_52 -> V_222 && ( V_52 -> V_222 -> V_123 & V_319 ) )
V_318 = 0 ;
else if ( ! F_238 ( & V_66 -> V_62 . V_64 -> V_252 ) ||
! V_48 -> V_49 ||
( ! F_308 ( V_52 ) && F_222 ( V_52 ) ) )
V_318 = 0 ;
...
static bool
F_309 ( struct V_47 * V_48 , struct V_51 * V_214 ,
struct V_113 * V_227 )
{
struct V_51 * V_52 ;
V_52 = V_48 -> V_242 ;
...
static void F_310 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
enum V_6 V_320 = F_56 ( V_48 -> V_242 ) ;
F_86 ( V_48 , V_52 , L_28 ) ;
F_225 ( V_48 , 1 ) ;
if ( V_320 != F_56 ( V_52 ) )
V_52 -> V_3 -> V_154 = 0 ;
...
static void
F_311 ( struct V_47 * V_48 , struct V_51 * V_52 ,
struct V_113 * V_227 )
{
struct V_60 * V_66 = F_267 ( V_227 ) ;
V_48 -> V_235 ++ ;
...
F_305 ( V_48 , V_52 , V_227 ) ;
F_306 ( V_48 , V_52 , V_66 ) ;
V_52 -> V_313 = F_94 ( V_227 ) + F_198 ( V_227 ) ;
if ( V_52 == V_48 -> V_242 ) {
if ( F_219 ( V_52 ) ) {
if ( F_244 ( V_227 ) > V_321 ||
V_48 -> V_74 > 1 ) {
F_210 ( V_48 , V_52 ) ;
F_213 ( V_52 ) ;
F_312 ( V_48 -> V_65 ) ;
...
} else if ( F_309 ( V_48 , V_52 , V_227 ) ) {
F_310 ( V_48 , V_52 ) ;
F_312 ( V_48 -> V_65 ) ;
}
}
static void F_314 ( struct V_181 * V_44 , struct V_113 * V_227 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
struct V_51 * V_52 = F_187 ( V_227 ) ;
F_86 ( V_48 , V_52 , L_29 ) ;
F_277 ( V_52 , F_267 ( V_227 ) ) ;
V_227 -> V_241 = V_110 + V_48 -> V_322 [ F_93 ( V_227 ) ] ;
F_315 ( & V_227 -> V_234 , & V_52 -> V_256 ) ;
F_190 ( V_227 ) ;
F_35 ( F_193 ( V_227 ) , V_48 -> V_229 ,
V_227 -> V_123 ) ;
F_311 ( V_48 , V_52 , V_227 ) ;
}
static void F_316 ( struct V_47 * V_48 )
{
struct V_51 * V_52 = V_48 -> V_242 ;
if ( V_48 -> V_233 > V_48 -> V_323 )
V_48 -> V_323 = V_48 -> V_233 ;
if ( V_48 -> V_50 == 1 )
return;
if ( V_48 -> V_235 <= V_324 &&
V_48 -> V_233 <= V_324 )
...
static bool F_317 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
...
static void F_318 ( struct V_181 * V_44 , struct V_113 * V_227 )
{
struct V_51 * V_52 = F_187 ( V_227 ) ;
struct V_47 * V_48 = V_52 -> V_48 ;
const int V_76 = F_93 ( V_227 ) ;
...
V_52 -> V_251 -- ;
( F_193 ( V_227 ) ) -> V_251 -- ;
F_42 ( V_52 -> V_3 , F_319 ( V_227 ) ,
F_320 ( V_227 ) , V_227 -> V_123 ) ;
V_48 -> V_255 [ F_57 ( V_52 ) ] -- ;
if ( V_76 ) {
struct V_1 * V_90 ;
...
if ( ! F_124 ( V_227 -> V_38 + V_48 -> V_322 [ 1 ] , V_15 ) )
V_48 -> V_282 = V_15 ;
}
#ifdef F_304
...
#endif
if ( V_48 -> V_242 == V_52 ) {
const bool V_326 = F_189 ( & V_52 -> V_136 ) ;
if ( F_88 ( V_52 ) ) {
F_85 ( V_48 , V_52 ) ;
F_321 ( V_52 ) ;
}
if ( F_317 ( V_48 , V_52 ) ) {
unsigned long V_327 = V_48 -> V_49 ;
if ( ! V_48 -> V_49 )
V_327 = V_48 -> V_250 ;
V_52 -> V_111 = V_110 + V_327 ;
F_322 ( V_52 ) ;
F_86 ( V_48 , V_52 , L_31 ) ;
}
...
static inline int F_323 ( struct V_51 * V_52 )
{
if ( F_219 ( V_52 ) && ! F_324 ( V_52 ) ) {
F_325 ( V_52 ) ;
return V_328 ;
}
return V_329 ;
}
static int F_326 ( struct V_181 * V_44 , int V_31 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
struct V_230 * V_231 = V_232 ;
struct V_60 * V_66 ;
...
static void F_328 ( struct V_113 * V_227 )
{
struct V_51 * V_52 = F_187 ( V_227 ) ;
if ( V_52 ) {
const int V_31 = F_329 ( V_227 ) ;
F_25 ( ! V_52 -> V_261 [ V_31 ] ) ;
V_52 -> V_261 [ V_31 ] -- ;
F_33 ( F_193 ( V_227 ) ) ;
V_227 -> V_330 . V_331 [ 0 ] = NULL ;
V_227 -> V_330 . V_331 [ 1 ] = NULL ;
F_270 ( V_52 ) ;
}
}
static struct V_51 *
F_330 ( struct V_47 * V_48 , struct V_60 * V_66 ,
struct V_51 * V_52 )
{
...
static struct V_51 *
F_332 ( struct V_60 * V_66 , struct V_51 * V_52 )
{
if ( F_250 ( V_52 ) == 1 ) {
...
static int
F_335 ( struct V_181 * V_44 , struct V_113 * V_227 , struct V_70 * V_70 ,
T_9 V_298 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
struct V_60 * V_66 = F_61 ( V_227 -> V_330 . V_62 ) ;
const int V_31 = F_329 ( V_227 ) ;
...
if ( F_221 ( V_52 ) && F_337 ( V_52 ) ) {
F_86 ( V_48 , V_52 , L_33 ) ;
V_52 = F_332 ( V_66 , V_52 ) ;
if ( ! V_52 )
goto V_272;
}
if ( V_52 -> V_214 )
V_52 = F_330 ( V_48 , V_66 , V_52 ) ;
}
V_52 -> V_261 [ V_31 ] ++ ;
V_52 -> V_263 ++ ;
F_31 ( V_52 -> V_3 ) ;
V_227 -> V_330 . V_331 [ 0 ] = V_52 ;
V_227 -> V_330 . V_331 [ 1 ] = V_52 -> V_3 ;
F_162 ( V_44 -> V_45 ) ;
return 0 ;
}
static void F_338 ( struct V_332 * V_333 )
{
struct V_47 * V_48 =
F_3 ( V_333 , struct V_47 , V_75 ) ;
struct V_181 * V_44 = V_48 -> V_65 ;
F_160 ( V_44 -> V_45 ) ;
F_312 ( V_48 -> V_65 ) ;
F_162 ( V_44 -> V_45 ) ;
}
static void F_339 ( unsigned long V_334 )
{
struct V_47 * V_48 = (struct V_47 * ) V_334 ;
struct V_51 * V_52 ;
unsigned long V_335 ;
int V_244 = 1 ;
F_70 ( V_48 , L_34 ) ;
F_340 ( V_48 -> V_65 -> V_45 , V_335 ) ;
V_52 = V_48 -> V_242 ;
if ( V_52 ) {
V_244 = 0 ;
if ( F_258 ( V_52 ) )
...
static void F_345 ( struct V_47 * V_48 )
{
int V_167 ;
for ( V_167 = 0 ; V_167 < V_80 ; V_167 ++ ) {
if ( V_48 -> V_304 [ 0 ] [ V_167 ] )
F_270 ( V_48 -> V_304 [ 0 ] [ V_167 ] ) ;
if ( V_48 -> V_304 [ 1 ] [ V_167 ] )
F_270 ( V_48 -> V_304 [ 1 ] [ V_167 ] ) ;
}
if ( V_48 -> V_306 )
F_270 ( V_48 -> V_306 ) ;
}
static void F_346 ( struct V_338 * V_339 )
{
struct V_47 * V_48 = V_339 -> V_69 ;
struct V_181 * V_44 = V_48 -> V_65 ;
F_342 ( V_48 ) ;
F_160 ( V_44 -> V_45 ) ;
if ( V_48 -> V_242 )
...
static int F_349 ( struct V_181 * V_44 , struct V_340 * V_339 )
{
struct V_47 * V_48 ;
struct V_12 * V_27 V_341 ;
int V_167 , V_196 ;
struct V_338 * V_342 ;
V_342 = F_350 ( V_44 , V_339 ) ;
if ( ! V_342 )
return - V_343 ;
V_48 = F_351 ( sizeof( * V_48 ) , V_344 , V_44 -> V_138 ) ;
if ( ! V_48 ) {
F_352 ( & V_342 -> V_345 ) ;
return - V_343 ;
}
...
V_48 -> V_152 = V_169 ;
#ifdef F_304
V_196 = F_353 ( V_44 , & V_28 ) ;
if ( V_196 )
goto V_346;
V_48 -> V_183 = F_28 ( V_44 -> V_347 ) ;
#else
V_196 = - V_343 ;
V_48 -> V_183 = F_351 ( sizeof( * V_48 -> V_183 ) ,
V_344 , V_48 -> V_65 -> V_138 ) ;
if ( ! V_48 -> V_183 )
goto V_346;
F_126 ( V_48 -> V_183 ) ;
#endif
V_48 -> V_183 -> V_144 = 2 * V_348 ;
V_48 -> V_183 -> V_146 = 2 * V_348 ;
for ( V_167 = 0 ; V_167 < V_349 ; V_167 ++ )
V_48 -> V_224 [ V_167 ] = V_350 ;
...
F_162 ( V_44 -> V_45 ) ;
F_354 ( & V_48 -> V_243 ) ;
V_48 -> V_243 . V_351 = F_339 ;
V_48 -> V_243 . V_334 = ( unsigned long ) V_48 ;
F_355 ( & V_48 -> V_75 , F_338 ) ;
V_48 -> V_280 = V_280 ;
V_48 -> V_322 [ 0 ] = V_322 [ 0 ] ;
V_48 -> V_322 [ 1 ] = V_322 [ 1 ] ;
V_48 -> V_125 = V_125 ;
V_48 -> V_126 = V_126 ;
V_48 -> V_79 [ 0 ] = V_352 ;
V_48 -> V_79 [ 1 ] = V_353 ;
...
static T_5
F_356 ( unsigned int V_354 , char * V_355 )
{
return sprintf ( V_355 , L_6 , V_354 ) ;
}
static T_5
F_357 ( unsigned int * V_354 , const char * V_355 , T_6 V_59 )
{
char * V_211 = ( char * ) V_355 ;
* V_354 = F_358 ( V_211 , & V_211 , 10 ) ;
return V_59 ;
}
static int T_10 F_359 ( void )
{
int V_196 ;
if ( ! V_352 )
V_352 = 1 ;
