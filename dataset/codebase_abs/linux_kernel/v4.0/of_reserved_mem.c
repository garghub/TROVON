...
const V_21 * V_23 ;
int V_36 = 0 ;
V_23 = F_9 ( V_10 , L_15 , & V_22 ) ;
if ( ! V_23 )
V_23 = F_9 ( V_10 , L_16 , & V_22 ) ;
if ( V_23 )
V_13 -> V_37 = F_16 ( V_23 , V_22 / 4 ) ;
if ( V_13 -> V_1 == 0 )
...
static inline struct V_12 * F_17 ( struct V_38 * V_10 )
{
unsigned int V_29 ;
if ( ! V_10 -> V_37 )
return NULL ;
for ( V_29 = 0 ; V_29 < V_14 ; V_29 ++ )
if ( V_12 [ V_29 ] . V_37 == V_10 -> V_37 )
return & V_12 [ V_29 ] ;
return NULL ;
}
...
struct V_38 * V_41 ;
int V_24 ;
V_41 = F_19 ( V_40 -> V_42 , L_17 , 0 ) ;
if ( ! V_41 )
return - V_43 ;
V_13 = F_17 ( V_41 ) ;
F_20 ( V_41 ) ;
if ( ! V_13 || ! V_13 -> V_44 || ! V_13 -> V_44 -> V_45 )
return - V_25 ;
V_24 = V_13 -> V_44 -> V_45 ( V_13 , V_40 ) ;
if ( V_24 == 0 )
F_21 ( V_40 , L_18 , V_13 -> V_16 ) ;
return V_24 ;
}
...
V_13 = F_17 ( V_41 ) ;
F_20 ( V_41 ) ;
if ( ! V_13 || ! V_13 -> V_44 || ! V_13 -> V_44 -> V_46 )
return;
V_13 -> V_44 -> V_46 ( V_13 , V_40 ) ;
}
