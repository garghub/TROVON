...
if ( V_29 -> type == V_115 -> type && V_29 -> V_38 == V_115 -> V_38 )
return V_29 ;
}
return NULL ;
}
static int F_57 ( struct V_5 * V_25 ,
struct V_114 * V_115 , struct V_26 * V_27 )
{
struct V_26 V_30 = F_58 ( V_30 ) ;
struct V_28 * V_29 ;
T_2 V_116 = V_117 ;
int V_10 = V_115 -> V_10 , V_38 = V_115 -> V_38 ;
while ( V_115 -> V_10 > 0 ) {
V_29 = F_56 ( V_25 , V_115 ) ;
if ( ! V_29 ) {
F_59 ( & V_30 , & V_25 -> V_37 ) ;
V_115 -> V_10 = V_10 ;
V_115 -> V_38 = V_38 ;
...
F_60 ( & V_29 -> V_36 , & V_30 ) ;
V_115 -> V_38 += V_29 -> V_10 ;
V_115 -> V_10 -= V_29 -> V_10 ;
}
V_115 -> V_10 = V_10 ;
V_115 -> V_38 = V_38 ;
F_11 (block, &tmp, list) {
...
F_59 ( & V_30 , & V_25 -> V_118 ) ;
return 0 ;
}
static int F_61 ( struct V_5 * V_25 , struct V_114 * V_115 ,
struct V_26 * V_27 )
{
struct V_28 * V_29 , * V_30 ;
int V_39 = 0 ;
...
if ( V_29 -> type != V_115 -> type )
continue;
if ( V_115 -> V_10 > V_29 -> V_10 )
continue;
V_115 -> V_38 = V_29 -> V_38 ;
V_29 -> V_119 = V_115 -> V_10 % V_29 -> V_10 ;
F_44 ( & V_29 -> V_35 , V_27 ) ;
F_14 ( & V_29 -> V_36 , & V_25 -> V_118 ) ;
F_4 ( V_25 -> V_7 , L_17 ,
V_29 -> type , V_29 -> V_34 , V_29 -> V_38 ) ;
return 0 ;
}
...
int F_62 ( struct V_5 * V_25 , struct V_114 * V_115 ,
struct V_26 * V_27 )
{
int V_39 ;
F_4 ( V_25 -> V_7 , L_18 ,
V_115 -> V_10 , V_115 -> V_38 , V_115 -> type ) ;
F_43 ( & V_25 -> V_97 ) ;
V_39 = F_61 ( V_25 , V_115 , V_27 ) ;
if ( V_39 < 0 ) {
...
static int F_64 ( struct V_5 * V_25 , struct V_114 * V_115 ,
struct V_26 * V_27 )
{
struct V_28 * V_29 , * V_30 ;
struct V_114 V_121 = * V_115 ;
T_2 V_80 = V_115 -> V_38 + V_115 -> V_10 , V_122 ;
int V_31 ;
if ( V_115 -> type != V_123 && V_115 -> type != V_124 )
return 0 ;
F_12 (block, tmp, block_list, module_list) {
if ( V_29 -> type != V_115 -> type )
continue;
V_122 = V_29 -> V_38 + V_29 -> V_10 ;
if ( V_115 -> V_38 >= V_29 -> V_38 && V_80 <= V_122 )
return 0 ;
if ( V_115 -> V_38 >= V_29 -> V_38 && V_115 -> V_38 < V_122 ) {
V_121 . V_10 -= V_122 - V_115 -> V_38 ;
V_121 . V_38 = V_122 ;
V_31 = F_57 ( V_25 , & V_121 , V_27 ) ;
if ( V_31 < 0 )
return - V_48 ;
return 0 ;
}
...
V_115 . V_10 = V_100 -> V_10 ;
V_115 . type = V_100 -> type ;
V_115 . V_38 = V_100 -> V_38 ;
F_4 ( V_25 -> V_7 , L_18 ,
V_115 . V_10 , V_115 . V_38 , V_115 . type ) ;
F_43 ( & V_25 -> V_97 ) ;
V_39 = F_64 ( V_25 , & V_115 , & V_100 -> V_27 ) ;
if ( V_39 < 0 ) {
F_6 ( V_25 -> V_7 ,
L_21 ,
...
F_1 ( V_25 -> V_77 . V_126 + V_100 -> V_38 , V_100 -> V_94 ,
V_100 -> V_10 ) ;
F_45 ( & V_25 -> V_97 ) ;
return V_39 ;
V_31:
...
return 0 ;
memset ( & V_115 , 0 , sizeof( V_115 ) ) ;
V_115 . V_10 = V_100 -> V_111 ;
V_115 . type = V_124 ;
F_43 ( & V_25 -> V_97 ) ;
if ( V_38 != 0 ) {
V_115 . V_38 = V_38 ;
F_4 ( V_25 -> V_7 , L_24 ,
V_115 . V_10 , V_115 . type , V_115 . V_38 ) ;
V_39 = F_64 ( V_25 , & V_115 , & V_103 -> V_27 ) ;
} else {
F_4 ( V_25 -> V_7 , L_25 ,
V_115 . V_10 , V_115 . type ) ;
V_39 = F_61 ( V_25 , & V_115 , & V_103 -> V_27 ) ;
}
if ( V_39 < 0 ) {
F_6 ( V_25 -> V_7 ,
L_26 ,
...
int V_39 = 0 ;
F_4 ( V_25 -> V_7 , L_28 ,
V_103 -> V_109 , V_103 -> V_127 ,
V_100 -> V_111 ) ;
V_129 -> V_130 = F_41 ( V_25 -> V_54 ,
V_100 -> V_111 ,
& V_129 -> V_131 , V_93 | V_47 ) ;
if ( ! V_129 -> V_130 ) {
F_6 ( V_25 -> V_7 , L_29 ) ;
return - V_48 ;
}
...
if ( V_39 < 0 )
goto V_31;
V_39 = F_9 ( V_25 , V_129 -> V_131 ,
V_25 -> V_77 . V_78 + V_103 -> V_127 ,
V_100 -> V_111 ) ;
F_34 ( V_25 ) ;
if ( V_39 < 0 ) {
F_6 ( V_25 -> V_7 , L_30 ) ;
...
F_1 ( V_129 -> V_130 , V_25 -> V_77 . V_126 +
V_103 -> V_127 ,
V_100 -> V_111 ) ;
V_31:
F_45 ( & V_25 -> V_97 ) ;
...
F_1 ( V_25 -> V_77 . V_126 + V_103 -> V_127 ,
V_129 -> V_130 , V_100 -> V_111 ) ;
...
T_2 V_10 , enum V_132 type , struct V_133 * V_32 , T_2 V_34 ,
void * V_89 )
{
struct V_28 * V_29 ;
...
F_4 ( V_25 -> V_7 , L_36 ) ;
V_115 . V_10 = V_25 -> V_110 ;
V_115 . type = V_124 ;
if ( V_25 -> V_134 != 0 ) {
F_4 ( V_25 -> V_7 , L_37 ,
V_115 . V_10 , V_115 . type , V_115 . V_38 ) ;
V_115 . V_38 = V_25 -> V_134 ;
V_39 = F_64 ( V_25 , & V_115 , & V_25 -> V_105 ) ;
} else {
F_4 ( V_25 -> V_7 , L_38 ,
V_115 . V_10 , V_115 . type ) ;
V_115 . V_38 = 0 ;
V_39 = F_61 ( V_25 , & V_115 , & V_25 -> V_105 ) ;
}
if ( V_39 < 0 ) {
F_6 ( V_25 -> V_7 , L_39 ) ;
F_45 ( & V_25 -> V_97 ) ;
