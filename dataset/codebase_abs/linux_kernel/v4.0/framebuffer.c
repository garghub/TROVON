...
V_79 = 32 ;
do {
V_76 . V_82 [ 0 ] = F_26 ( V_76 . V_95 * ( ( V_79 + 7 ) / 8 ) , 4096 >> V_94 ) ;
...
V_93 = 0 ;
V_94 = 64 ;
V_76 . V_82 [ 0 ] = F_26 ( V_76 . V_95 * ( ( V_79 + 7 ) / 8 ) , 64 ) ;
V_92 = V_76 . V_82 [ 0 ] * V_76 . V_97 ;
V_92 = F_26 ( V_92 , V_58 ) ;
V_86 = F_22 ( V_26 , V_92 ) ;
if ( V_86 == NULL )
...
V_9 -> V_13 . V_12 = V_12 ;
V_9 -> V_13 . V_9 = V_7 ;
F_30 ( V_7 , V_12 -> V_82 [ 0 ] , V_12 -> V_80 ) ;
...
V_7 -> V_31 . V_129 = F_34 ( V_26 -> V_91 , 0 ) ;
V_7 -> V_31 . V_130 = F_35 ( V_26 -> V_91 , 0 ) ;
F_36 ( V_26 -> V_26 , L_4 ,
...
T_3 V_4 , int V_1 )
{
struct V_141 * V_141 = F_44 ( V_140 ) ;
V_141 -> V_142 [ V_1 ] = V_2 >> 8 ;
V_141 -> V_143 [ V_1 ] = V_3 >> 8 ;
V_141 -> V_144 [ V_1 ] = V_4 >> 8 ;
}
static void F_45 ( struct V_139 * V_140 , T_3 * V_2 ,
T_3 * V_3 , T_3 * V_4 , int V_1 )
{
struct V_141 * V_141 = F_44 ( V_140 ) ;
* V_2 = V_141 -> V_142 [ V_1 ] << 8 ;
* V_3 = V_141 -> V_143 [ V_1 ] << 8 ;
* V_4 = V_141 -> V_144 [ V_1 ] << 8 ;
}
static int F_46 ( struct V_145 * V_146 ,
struct V_88 * V_89 )
{
struct V_8 * V_8 =
F_42 ( V_146 , struct V_8 , V_13 ) ;
...
if ( V_147 == 3 )
V_147 = 4 ;
if ( F_26 ( V_89 -> V_127 * V_147 , 64 ) * V_89 -> V_128 >
V_40 -> V_148 ) {
V_89 -> V_99 = 16 ;
V_89 -> V_100 = 16 ;
}
...
V_40 -> V_9 = V_9 ;
F_55 ( V_26 , & V_9 -> V_13 , & V_150 ) ;
V_45 = F_56 ( V_26 , & V_9 -> V_13 ,
V_40 -> V_108 -> V_151 , V_152 ) ;
if ( V_45 )
goto free;
V_45 = F_57 ( & V_9 -> V_13 ) ;
if ( V_45 )
...
unsigned int * V_155 )
{
struct V_22 * V_23 = F_64 ( V_12 ) ;
struct V_77 * V_134 = V_23 -> V_28 ;
return F_65 ( V_154 , & V_134 -> V_87 , V_155 ) ;
}
...
F_71 ( V_26 ) ;
F_68 ( V_26 ) ;
V_40 -> V_108 -> V_161 ( V_26 ) ;
F_72 (connector, &dev->mode_config.connector_list,
head) {
struct V_162 * V_162 = F_73 ( V_160 ) ;
struct V_163 * V_164 = & V_162 -> V_27 ;
int V_165 = 0 , V_166 = 0 ;
switch ( V_162 -> type ) {
case V_167 :
V_165 = ( 1 << 0 ) ;
...
break;
case V_168 :
V_165 = V_40 -> V_108 -> V_169 ;
V_166 = ( 1 << V_168 ) ;
break;
case V_170 :
V_165 = V_40 -> V_108 -> V_171 ;
V_166 = ( 1 << V_170 ) ;
break;
case V_172 :
V_165 = ( 1 << 0 ) ;
...
V_26 -> V_117 . V_182 = 0 ;
V_26 -> V_117 . V_183 = 0 ;
V_26 -> V_117 . V_184 = & V_185 ;
F_77 ( V_26 -> V_91 , V_186 , ( T_2 * )
& ( V_26 -> V_117 . V_118 ) ) ;
for ( V_43 = 0 ; V_43 < V_40 -> V_187 ; V_43 ++ )
F_78 ( V_26 , V_43 , V_181 ) ;
V_26 -> V_117 . V_188 = 4096 ;
V_26 -> V_117 . V_189 = 4096 ;
F_70 ( V_26 ) ;
if ( V_40 -> V_108 -> V_190 )
V_40 -> V_108 -> V_190 ( V_26 ) ;
V_40 -> V_191 = true ;
}
