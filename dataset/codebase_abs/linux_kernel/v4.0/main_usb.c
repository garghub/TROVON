...
static T_3 F_68 ( struct V_120 * V_121 ,
struct V_187 * V_188 )
{
struct V_1 * V_2 = V_121 -> V_2 ;
struct V_189 * V_190 ;
...
T_2 V_192 = 0 ;
F_69 (ha, mc_list) {
V_192 = F_70 ( V_193 , V_190 -> V_194 ) >> 26 ;
V_191 |= 1ULL << ( V_192 & 0x3f ) ;
}
V_2 -> V_195 = V_188 -> V_196 ;
return V_191 ;
}
...
F_11 ( V_2 , V_50 , V_141 , V_200 ) ;
F_3 ( & V_2 -> V_40 -> V_41 , L_19 , V_200 ) ;
}
static int F_73 ( struct V_120 * V_121 , enum V_209 V_210 ,
struct V_137 * V_138 , struct V_211 * V_212 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = V_121 -> V_2 ;
switch ( V_210 ) {
case V_215 :
if ( F_74 ( V_121 , V_212 , V_138 , V_214 ) )
return - V_147 ;
break;
case V_216 :
if ( F_45 ( V_214 -> V_217 , & V_2 -> V_133 ) )
F_41 ( V_214 -> V_217 , & V_2 -> V_133 ) ;
default:
break;
}
return 0 ;
...
static T_3 F_78 ( struct V_120 * V_121 , struct V_137 * V_138 )
{
struct V_1 * V_2 = V_121 -> V_2 ;
return V_2 -> V_221 ;
}
static void F_79 ( struct V_120 * V_121 , struct V_137 * V_138 ,
T_3 V_222 )
{
struct V_1 * V_2 = V_121 -> V_2 ;
F_80 ( V_2 , V_222 , V_138 -> V_223 . V_224 ) ;
}
static void F_81 ( struct V_120 * V_121 , struct V_137 * V_138 )
{
struct V_1 * V_2 = V_121 -> V_2 ;
F_15 ( V_2 , V_151 , V_152 ) ;
F_82 ( V_2 ) ;
...
static int
F_87 ( struct V_228 * V_229 , const struct V_230 * V_231 )
{
struct V_232 * V_233 ;
struct V_1 * V_2 ;
struct V_120 * V_121 ;
struct V_234 * V_234 ;
int V_201 = 0 ;
V_233 = F_88 ( F_89 ( V_229 ) ) ;
F_90 ( & V_233 -> V_41 , L_20 ,
V_235 , V_236 ) ;
F_90 ( & V_233 -> V_41 ,
L_21 ) ;
V_121 = F_91 ( sizeof( struct V_1 ) , & V_237 ) ;
if ( ! V_121 ) {
F_31 ( & V_233 -> V_41 , L_22 ) ;
goto V_238;
}
V_2 = V_121 -> V_2 ;
V_2 -> V_121 = V_121 ;
...
F_92 ( & V_2 -> V_239 ) ;
F_93 ( & V_2 -> V_240 ) ;
F_94 ( & V_2 -> V_135 , V_241 ) ;
F_95 ( V_229 , V_2 ) ;
V_234 = V_2 -> V_121 -> V_234 ;
V_234 -> V_242 = V_243 ;
V_234 -> V_244 = V_245 ;
V_234 -> V_246 = F_96 ( V_139 ) |
F_96 ( V_140 ) | F_96 ( V_145 ) ;
V_2 -> V_121 -> V_128 = V_247 |
V_248 |
V_249 |
V_250 ;
V_2 -> V_121 -> V_251 = 100 ;
F_97 ( V_2 -> V_121 , & V_229 -> V_41 ) ;
F_24 ( V_2 ) ;
F_41 ( V_127 , & V_2 -> V_128 ) ;
F_98 ( V_2 ) ;
F_99 ( V_2 , V_252 ) ;
...
static void F_101 ( struct V_228 * V_229 )
{
struct V_1 * V_2 = F_102 ( V_229 ) ;
if ( ! V_2 )
return;
if ( V_2 -> V_227 )
F_103 ( V_2 -> V_121 ) ;
...
static int F_105 ( struct V_228 * V_229 , T_4 V_253 )
{
return 0 ;
}
static int F_106 ( struct V_228 * V_229 )
{
return 0 ;
}
