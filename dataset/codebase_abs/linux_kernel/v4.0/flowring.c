...
void F_21 ( struct V_1 * V_2 , T_1 V_25 ,
struct V_52 * V_53 )
{
struct V_27 * V_28 ;
V_28 = V_2 -> V_31 [ V_25 ] ;
...
F_11 ( V_2 , V_25 , true ) ;
F_24 ( V_55 , L_1 , V_25 ) ;
if ( F_23 ( & V_28 -> V_37 ) < V_56 )
F_11 ( V_2 , V_25 , false ) ;
}
}
struct V_52 * F_25 ( struct V_1 * V_2 , T_1 V_25 )
{
struct V_27 * V_28 ;
struct V_52 * V_53 ;
V_28 = V_2 -> V_31 [ V_25 ] ;
...
void F_26 ( struct V_1 * V_2 , T_1 V_25 ,
struct V_52 * V_53 )
{
struct V_27 * V_28 ;
V_28 = V_2 -> V_31 [ V_25 ] ;
...
T_2 F_28 ( struct V_1 * V_2 , T_1 V_25 )
{
struct V_27 * V_28 ;
V_28 = V_2 -> V_31 [ V_25 ] ;
if ( ! V_28 )
...
if ( V_28 -> V_35 != V_48 )
return 0 ;
return F_23 ( & V_28 -> V_37 ) ;
}
void F_29 ( struct V_1 * V_2 , T_1 V_25 )
{
struct V_27 * V_28 ;
V_28 = V_2 -> V_31 [ V_25 ] ;
if ( ! V_28 ) {
...
struct V_1 * F_31 ( struct V_57 * V_49 , T_3 V_30 )
{
struct V_1 * V_2 ;
T_2 V_15 ;
...
V_2 -> V_30 = V_30 ;
F_32 ( & V_2 -> V_47 ) ;
for ( V_15 = 0 ; V_15 < F_33 ( V_2 -> V_20 ) ; V_15 ++ )
V_2 -> V_20 [ V_15 ] = V_21 ;
for ( V_15 = 0 ; V_15 < F_33 ( V_2 -> V_13 ) ; V_15 ++ )
V_2 -> V_13 [ V_15 ] . V_11 = V_29 ;
V_2 -> V_31 = F_34 ( V_30 , sizeof( * V_2 -> V_31 ) ,
V_58 ) ;
if ( ! V_2 -> V_31 ) {
F_20 ( V_2 ) ;
V_2 = NULL ;
