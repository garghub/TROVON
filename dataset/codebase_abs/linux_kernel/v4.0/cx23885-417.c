...
if ( V_186 -> V_180 != 0 )
return - V_174 ;
F_68 ( V_186 -> V_210 , L_79 , sizeof( V_186 -> V_210 ) ) ;
V_186 -> V_211 = V_212 ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_51 ( V_171 ) ;
V_186 -> V_143 . V_213 . V_211 = V_212 ;
V_186 -> V_143 . V_213 . V_214 = 0 ;
V_186 -> V_143 . V_213 . V_215 =
V_2 -> V_125 . V_149 * V_2 -> V_125 . V_151 ;
V_186 -> V_143 . V_213 . V_216 = 0 ;
V_186 -> V_143 . V_213 . V_127 = V_2 -> V_125 . V_127 ;
V_186 -> V_143 . V_213 . V_126 = V_2 -> V_125 . V_126 ;
V_186 -> V_143 . V_213 . V_217 = V_218 ;
F_2 ( 1 , L_80 ,
...
V_186 -> V_143 . V_213 . V_217 = V_218 ;
F_2 ( 1 , L_82 ,
V_186 -> V_143 . V_213 . V_127 , V_186 -> V_143 . V_213 . V_126 , V_186 -> V_143 . V_213 . V_217 ) ;
return 0 ;
}
...
F_62 ( V_2 , V_219 , V_220 ) ;
F_75 ( & V_2 -> V_128 . V_221 , V_181 ) ;
return 0 ;
}
...
F_79 ( V_2 -> V_222 ) ;
F_80 ( & V_2 -> V_128 . V_221 ) ;
V_2 -> V_222 = NULL ;
}
}
static struct V_223 * F_81 (
struct V_193 * V_194 ,
struct V_224 * V_118 ,
struct V_223 * V_225 ,
char * type )
...
return NULL ;
* V_226 = * V_225 ;
snprintf ( V_226 -> V_181 , sizeof( V_226 -> V_181 ) , L_84 ,
...
struct V_140 * V_141 ;
F_2 ( 1 , L_1 , V_4 ) ;
if ( V_197 [ V_2 -> V_198 ] . V_230 != V_231 )
return V_100 ;
V_2 -> V_122 = V_173 [ 0 ] ;
if ( V_2 -> V_122 . V_123 & V_124 )
V_194 -> V_126 = 480 ;
...
F_86 ( & V_2 -> V_235 , & V_2 -> V_128 . V_221 , NULL ) ;
V_2 -> V_222 = F_81 ( V_194 ,
...
V_141 -> V_246 = 2 ;
V_141 -> V_148 = V_2 ;
V_141 -> V_247 = sizeof( struct V_157 ) ;
V_141 -> V_248 = & V_249 ;
V_141 -> V_250 = & V_251 ;
V_141 -> V_252 = V_253 ;
...
V_2 -> V_222 -> V_167 = V_141 ;
V_100 = F_89 ( V_2 -> V_222 ,
V_255 , - 1 ) ;
if ( V_100 < 0 ) {
F_20 ( V_256 L_86 , V_2 -> V_181 ) ;
return V_100 ;
}
F_20 ( V_256 L_87 ,
V_2 -> V_181 , F_90 ( V_2 -> V_222 ) ) ;
F_30 ( V_2 , 0 ) ;
return 0 ;
}
