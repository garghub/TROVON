...
V_87 = F_27 ( ( V_85 + 1 ) * sizeof( * V_80 ) + V_86 , V_107 ) ;
if ( V_87 == NULL )
return NULL ;
V_82 = V_87 ;
V_81 = V_87 ;
V_87 += ( V_85 + 1 ) * sizeof( * V_80 ) ;
F_28 ( V_87 , V_81 , & V_100 ) ;
F_28 ( V_87 , V_81 , & V_102 ) ;
V_75 = V_87 ;
F_29 ( V_87 , V_81 ,
( const struct V_70 * * ) V_77 ) ;
V_75 -> V_108 = F_30 ( V_83 ) ;
V_75 -> V_109 = 1 ;
V_75 -> V_110 [ 0 ] = V_8 -> V_39 ;
F_28 ( V_87 , V_81 , & V_103 ) ;
if ( V_50 == V_88 )
F_28 ( V_87 , V_81 , & V_106 ) ;
F_28 ( V_87 , V_81 , & V_104 ) ;
F_28 ( V_87 , V_81 , & V_105 ) ;
V_73 = V_87 ;
F_29 ( V_87 , V_81 ,
( const struct V_70 * * ) V_78 ) ;
V_73 -> V_108 = F_30 ( V_84 ) ;
...
static int
F_31 ( struct V_113 * V_114 , struct V_20 * V_21 )
{
...
int V_43 = - V_29 ;
F_6 ( V_28 , L_9 ) ;
V_120 = F_32 ( V_21 -> V_121 ) ;
V_120 -> V_122 = F_33 ( V_120 -> V_122 , 1U , 16U ) ;
V_120 -> V_123 = F_33 ( V_120 -> V_123 , 1U , 3072U ) ;
V_120 -> V_124 = F_34 ( V_120 -> V_124 , 15U ) ;
if ( V_120 -> V_123 <= 1024 ) {
V_117 = 1 ;
V_118 = V_120 -> V_123 ;
...
V_125 . V_126 =
F_30 ( F_34 ( V_120 -> V_123 , 1023U ) ) ;
V_125 . V_127 = V_120 -> V_122 ;
V_128 . V_126 =
F_30 ( V_118 | ( ( V_117 - 1 ) << 11 ) ) ;
V_128 . V_127 = V_120 -> V_122 ;
V_129 . V_126 = F_30 ( V_118 ) ;
...
V_8 -> V_44 = V_4 ;
V_4 -> V_41 = V_8 ;
if ( F_36 ( V_114 -> V_28 -> V_46 ) )
V_4 = F_37 ( V_28 -> V_46 , & V_129 ,
& V_130 ) ;
else if ( F_38 ( V_28 -> V_46 ) )
V_4 = F_35 ( V_28 -> V_46 , & V_128 ) ;
else
V_4 = F_35 ( V_28 -> V_46 , & V_125 ) ;
if ( ! V_4 ) {
F_6 ( V_28 , L_11 ) ;
goto error;
}
...
V_141 . V_143 = V_43 ;
V_8 -> V_39 = V_43 ;
V_21 -> V_144 = F_25 ( V_8 , V_96 ) ;
if ( F_41 ( V_21 -> V_144 ) ) {
V_43 = F_42 ( V_21 -> V_144 ) ;
V_21 -> V_144 = NULL ;
goto error;
}
if ( F_38 ( V_28 -> V_46 ) ) {
V_21 -> V_145 = F_25 ( V_8 , V_92 ) ;
if ( F_41 ( V_21 -> V_145 ) ) {
V_43 = F_42 ( V_21 -> V_145 ) ;
V_21 -> V_145 = NULL ;
goto error;
}
}
if ( F_36 ( V_114 -> V_28 -> V_46 ) ) {
V_21 -> V_146 = F_25 ( V_8 , V_88 ) ;
if ( F_41 ( V_21 -> V_146 ) ) {
V_43 = F_42 ( V_21 -> V_146 ) ;
V_21 -> V_146 = NULL ;
goto error;
}
}
V_8 -> V_147 = F_44 ( V_28 -> V_46 -> V_148 , V_107 ) ;
V_8 -> V_149 = F_27 ( V_31 , V_107 ) ;
...
if ( ( V_43 = F_19 ( V_21 ) ) < 0 )
goto error;
if ( F_45 ( & V_28 -> V_46 -> V_151 , & V_8 -> V_59 ) ) {
F_46 ( V_152 L_12 ) ;
goto error;
}
V_43 = F_47 ( & V_8 -> V_40 ) ;
...
V_8 -> V_40 . V_4 -> V_41 = NULL ;
if ( V_8 -> V_147 )
F_49 ( V_28 -> V_46 -> V_148 , V_8 -> V_147 ) ;
F_50 ( V_8 -> V_149 ) ;
F_51 ( V_21 ) ;
return V_43 ;
}
static void F_52 ( struct V_153 * V_21 )
{
struct V_119 * V_120 = F_32 ( V_21 ) ;
F_53 ( & V_120 -> V_154 ) ;
F_50 ( V_120 ) ;
}
static struct V_153 * F_54 ( void )
{
struct V_119 * V_120 ;
struct V_155 * V_156 ;
struct V_157 * V_158 ;
...
struct V_161 * V_162 ;
struct V_76 * * V_163 ;
V_120 = F_55 ( sizeof( * V_120 ) , V_107 ) ;
if ( ! V_120 )
return F_26 ( - V_58 ) ;
V_120 -> V_164 . V_165 = F_52 ;
F_56 ( & V_120 -> V_154 ) ;
V_156 = & V_120 -> V_166 ;
V_156 -> V_101 = F_57 ( 3 ) ;
V_156 -> V_167 = V_168 ;
...
{
struct V_7 * V_8 = F_5 ( V_21 ) ;
struct V_119 * V_120 = F_61 ( V_21 -> V_121 , struct V_119 ,
V_164 ) ;
-- V_120 -> V_197 ;
F_50 ( V_8 ) ;
}
static void F_62 ( struct V_113 * V_114 , struct V_20 * V_21 )
{
struct V_35 * V_28 = V_114 -> V_28 ;
struct V_7 * V_8 = F_5 ( V_21 ) ;
F_6 ( V_28 , L_14 , V_198 ) ;
...
static struct V_20 * F_64 ( struct V_153 * V_121 )
{
struct V_7 * V_8 ;
struct V_119 * V_120 ;
struct V_76 * * V_199 ;
V_8 = F_55 ( sizeof( * V_8 ) , V_107 ) ;
if ( V_8 == NULL )
return F_26 ( - V_58 ) ;
V_8 -> V_47 = V_48 ;
V_120 = F_32 ( V_121 ) ;
