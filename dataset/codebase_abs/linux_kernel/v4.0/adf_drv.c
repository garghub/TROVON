...
if ( F_32 ( V_42 , F_33 ( 64 ) ) ) {
if ( ( F_32 ( V_42 , F_33 ( 32 ) ) ) ) {
F_18 ( & V_42 -> V_52 , L_10 ) ;
V_50 = - V_57 ;
goto V_60;
} else {
...
struct V_7 * V_8 = & V_4 -> V_9 [ V_5 ] ;
V_49 = V_5 * 2 ;
V_8 -> V_77 = F_36 ( V_42 , V_49 ) ;
if ( ! V_8 -> V_77 )
break;
V_8 -> V_78 = F_37 ( V_42 , V_49 ) ;
V_8 -> V_10 = F_38 ( V_4 -> V_11 , V_49 , 0 ) ;
if ( ! V_8 -> V_10 ) {
...
static void T_1 F_45 ( struct V_11 * V_42 )
{
