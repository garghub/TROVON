...
static int F_115 ( struct V_1 * V_5 ,
struct V_132 * V_133 )
{
int V_115 ;
V_133 -> V_134 = V_5 -> V_134 ;
V_5 -> V_134 -> V_133 = V_133 ;
V_115 = F_116 ( V_133 -> V_8 , V_5 -> V_134 ) ;
if ( V_115 ) {
F_100 ( L_33 ) ;
return V_115 ;
}
...
V_5 -> V_133 = V_133 ;
if ( V_5 -> V_134 ) {
V_115 = F_115 ( V_5 , V_133 ) ;
if ( ! V_115 )
return 0 ;
}
V_120 -> V_135 = V_136 ;
V_115 = F_118 ( V_5 -> V_114 , V_120 ,
& V_137 , V_138 ) ;
if ( V_115 ) {
F_100 ( L_34 ) ;
return V_115 ;
...
F_121 ( V_120 , V_133 ) ;
if ( V_5 -> V_116 )
V_115 = F_122 ( V_5 -> V_116 , & V_5 -> V_120 ) ;
return V_115 ;
}
...
static void F_125 ( struct V_1 * V_5 )
{
if ( V_5 -> V_140 )
F_126 ( V_5 -> V_140 ) ;
}
static void F_127 ( struct V_1 * V_5 )
{
if ( V_5 -> V_141 == V_142 )
return;
if ( V_5 -> V_116 ) {
...
static void F_136 ( struct V_2 * V_4 , int V_124 )
{
struct V_1 * V_5 = F_1 ( V_4 ) ;
switch ( V_124 ) {
case V_142 :
...
static struct V_117 * F_137 ( struct V_146 * V_8 )
{
...
static int F_142 ( struct V_1 * V_5 )
{
int V_115 ;
V_115 = F_143 ( V_5 -> V_8 -> V_149 , & V_5 -> V_125 . V_126 ,
V_160 ) ;
if ( V_115 ) {
F_100 ( L_52 , V_115 ) ;
return V_115 ;
...
static int F_144 ( struct V_146 * V_8 , struct V_146 * V_161 , void * V_31 )
{
struct V_1 * V_5 = F_145 ( V_8 ) ;
struct V_162 * V_163 = F_146 ( V_8 ) ;
struct V_164 * V_114 = V_31 ;
struct V_165 * V_166 ;
unsigned int V_167 ;
int V_115 = 0 ;
V_5 -> V_8 = & V_163 -> V_8 ;
V_5 -> V_141 = V_145 ;
V_5 -> V_117 = F_137 ( & V_163 -> V_8 ) ;
if ( F_147 ( V_5 -> V_117 ) )
return F_148 ( V_5 -> V_117 ) ;
V_5 -> V_140 = F_149 ( V_5 -> V_8 , L_53 ) ;
if ( F_147 ( V_5 -> V_140 ) ) {
F_15 ( V_5 -> V_8 , L_54 ) ;
V_115 = F_148 ( V_5 -> V_140 ) ;
if ( V_115 ) {
if ( V_115 == - V_168 || V_115 == - V_169 )
V_5 -> V_140 = NULL ;
else
return V_115 ;
}
}
if ( ! V_5 -> V_116 && ! V_5 -> V_134 ) {
V_115 = F_142 ( V_5 ) ;
if ( V_115 )
return V_115 ;
}
V_5 -> clock = F_150 ( & V_163 -> V_8 , L_53 ) ;
if ( F_147 ( V_5 -> clock ) ) {
F_15 ( & V_163 -> V_8 , L_55 ) ;
return F_148 ( V_5 -> clock ) ;
}
F_129 ( V_5 -> clock ) ;
V_166 = F_151 ( V_163 , V_170 , 0 ) ;
V_5 -> V_171 = F_152 ( & V_163 -> V_8 , V_166 ) ;
if ( F_147 ( V_5 -> V_171 ) )
return F_148 ( V_5 -> V_171 ) ;
V_5 -> V_172 = F_153 ( V_8 -> V_149 , L_56 , 0 ) ;
if ( F_154 ( V_5 -> V_172 ) ) {
V_115 = F_155 ( & V_163 -> V_8 , V_5 -> V_172 , V_173 ,
L_57 ) ;
if ( V_115 ) {
F_15 ( & V_163 -> V_8 , L_58 ) ;
return V_115 ;
}
V_5 -> V_103 = F_156 ( V_5 -> V_172 ) ;
V_167 = V_174 | V_175 ;
} else {
V_5 -> V_172 = - V_169 ;
V_5 -> V_103 = F_157 ( V_163 , 0 ) ;
V_167 = 0 ;
}
if ( V_5 -> V_103 == - V_176 ) {
F_15 ( & V_163 -> V_8 , L_59 ) ;
...
F_158 ( & V_5 -> V_108 , F_96 ) ;
F_123 ( V_5 ) ;
F_3 ( V_5 ) ;
V_115 = F_159 ( & V_163 -> V_8 , V_5 -> V_103 , F_92 ,
V_167 , L_60 , V_5 ) ;
if ( V_115 ) {
F_15 ( & V_163 -> V_8 , L_61 ) ;
return V_115 ;
...
F_132 ( V_5 -> V_103 ) ;
V_5 -> V_114 = V_114 ;
return F_160 ( V_114 , & V_5 -> V_4 ) ;
}
static void F_161 ( struct V_146 * V_8 , struct V_146 * V_161 ,
void * V_31 )
{
struct V_1 * V_5 = F_145 ( V_8 ) ;
F_136 ( & V_5 -> V_4 , V_145 ) ;
}
static int F_162 ( struct V_162 * V_163 )
{
struct V_146 * V_8 = & V_163 -> V_8 ;
struct V_147 * V_177 , * V_178 , * V_179 ;
struct V_1 * V_5 ;
int V_115 ;
V_5 = F_138 ( & V_163 -> V_8 , sizeof( struct V_1 ) ,
V_151 ) ;
if ( ! V_5 )
return - V_152 ;
V_5 -> V_4 . type = V_180 ;
V_5 -> V_4 . V_181 = & V_182 ;
F_163 ( V_163 , V_5 ) ;
V_115 = F_164 ( & V_163 -> V_8 , V_183 ,
V_5 -> V_4 . type ) ;
if ( V_115 )
return V_115 ;
V_177 = F_165 ( V_8 -> V_149 , L_62 , 0 ) ;
if ( V_177 ) {
V_5 -> V_116 = F_166 ( V_177 ) ;
F_167 ( V_177 ) ;
if ( ! V_5 -> V_116 )
return - V_184 ;
}
V_179 = F_168 ( V_8 -> V_149 , NULL ) ;
if ( V_179 ) {
V_178 = F_169 ( V_179 ) ;
if ( V_178 ) {
V_5 -> V_134 = F_170 ( V_178 ) ;
F_167 ( V_178 ) ;
if ( ! V_5 -> V_134 )
return - V_184 ;
} else
...
V_115 = F_171 ( & V_163 -> V_8 , & V_185 ) ;
if ( V_115 )
F_172 ( & V_163 -> V_8 ,
V_183 ) ;
return V_115 ;
}
static int F_173 ( struct V_162 * V_163 )
{
F_174 ( & V_163 -> V_8 , & V_185 ) ;
F_172 ( & V_163 -> V_8 , V_183 ) ;
return 0 ;
}
static int F_175 ( struct V_146 * V_8 )
{
struct V_1 * V_5 = F_145 ( V_8 ) ;
F_136 ( & V_5 -> V_4 , V_145 ) ;
return 0 ;
}
static int F_176 ( struct V_146 * V_8 )
{
struct V_1 * V_5 = F_145 ( V_8 ) ;
F_136 ( & V_5 -> V_4 , V_142 ) ;
return 0 ;
