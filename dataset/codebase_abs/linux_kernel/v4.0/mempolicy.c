...
return F_107 ( V_5 , V_135 , 0 ) ;
}
static int F_108 ( struct V_55 * V_56 , int V_136 , int V_137 ,
int V_10 )
{
T_1 V_76 ;
F_109 ( V_80 ) ;
...
F_89 ( V_136 , V_76 ) ;
F_15 ( ! ( V_10 & ( V_78 | V_79 ) ) ) ;
F_67 ( V_56 , V_56 -> V_60 -> V_92 , V_56 -> V_138 , & V_76 ,
V_10 | V_93 , & V_80 ) ;
if ( ! F_110 ( & V_80 ) ) {
V_106 = F_111 ( & V_80 , F_102 , NULL , V_137 ,
V_139 , V_140 ) ;
if ( V_106 )
F_112 ( & V_80 ) ;
}
...
int F_113 ( struct V_55 * V_56 , const T_1 * V_141 ,
const T_1 * V_142 , int V_10 )
{
int V_143 = 0 ;
int V_106 ;
T_1 V_15 ;
...
int V_137 = 0 ;
F_115 (s, tmp) {
if ( ( F_6 ( * V_141 ) != F_6 ( * V_142 ) ) &&
( F_31 ( V_144 , * V_142 ) ) )
continue;
V_145 = F_34 ( V_144 , * V_141 , * V_142 ) ;
if ( V_144 == V_145 )
continue;
V_136 = V_144 ;
V_137 = V_145 ;
...
break;
F_116 ( V_136 , V_15 ) ;
V_106 = F_108 ( V_56 , V_136 , V_137 , V_10 ) ;
if ( V_106 > 0 )
V_143 += V_106 ;
if ( V_106 < 0 )
break;
...
if ( F_103 ( V_68 ) ) {
F_119 ( ! V_58 ) ;
return F_120 ( V_58 , V_147 , 1 ) ;
}
return F_121 ( V_135 , V_58 , V_147 ) ;
}
static void F_50 ( struct V_68 * V_68 , struct V_101 * V_80 ,
unsigned long V_10 )
{
...
static long F_122 ( unsigned long V_87 , unsigned long V_149 ,
...
return - V_17 ;
if ( ( V_10 & V_79 ) && ! F_123 ( V_152 ) )
return - V_153 ;
if ( V_87 & ~ V_127 )
return - V_17 ;
if ( V_8 == V_35 )
V_10 &= ~ V_100 ;
V_149 = ( V_149 + V_75 - 1 ) & V_127 ;
V_65 = V_87 + V_149 ;
if ( V_65 < V_87 )
return - V_17 ;
if ( V_65 == V_87 )
return 0 ;
V_54 = F_17 ( V_8 , V_150 , V_76 ) ;
if ( F_71 ( V_54 ) )
return F_72 ( V_54 ) ;
if ( V_10 & V_96 )
V_54 -> V_10 |= V_154 ;
...
V_162 = ( 1UL << ( V_159 % V_164 ) ) - 1 ;
if ( V_161 > F_126 ( V_49 ) ) {
if ( V_161 > V_75 / sizeof( long ) )
return - V_17 ;
for ( V_160 = F_126 ( V_49 ) ; V_160 < V_161 ; V_160 ++ ) {
unsigned long V_165 ;
if ( F_127 ( V_165 , V_76 + V_160 ) )
return - V_94 ;
if ( V_160 == V_161 - 1 ) {
if ( V_165 & V_162 )
return - V_17 ;
...
if ( F_128 ( F_19 ( * V_16 ) , V_76 , V_161 *sizeof( unsigned long ) ) )
return - V_94 ;
F_19 ( * V_16 ) [ V_161 - 1 ] &= V_162 ;
return 0 ;
}
static int F_129 ( unsigned long T_6 * V_166 , unsigned long V_159 ,
T_1 * V_16 )
{
unsigned long V_167 = F_130 ( V_159 - 1 , 64 ) / 8 ;
const int V_168 = F_126 ( V_49 ) * sizeof( long ) ;
if ( V_167 > V_168 ) {
if ( V_167 > V_75 )
return - V_17 ;
if ( F_131 ( ( char T_6 * ) V_166 + V_168 , V_167 - V_168 ) )
return - V_94 ;
V_167 = V_168 ;
}
return F_132 ( V_166 , F_19 ( * V_16 ) , V_167 ) ? - V_94 : 0 ;
}
...
if ( ! V_4 )
V_4 = F_1 ( V_47 ) ;
return V_4 -> V_10 & V_154 ;
}
static int F_138 ( struct V_1 * V_34 , enum V_169 V_170 )
{
enum V_169 V_171 = V_172 ;
F_119 ( V_171 == V_173 ) ;
if ( ! F_139 ( V_34 -> V_18 . V_16 , V_25 [ V_174 ] ) )
V_171 = V_173 ;
return V_170 >= V_171 ;
}
static T_1 * F_140 ( T_7 V_175 , struct V_1 * V_34 )
{
if ( F_141 ( V_34 -> V_8 == V_126 ) &&
F_138 ( V_34 , F_142 ( V_175 ) ) &&
F_143 ( & V_34 -> V_18 . V_16 ) )
return & V_34 -> V_18 . V_16 ;
return NULL ;
}
static struct V_176 * F_144 ( T_7 V_175 , struct V_1 * V_34 ,
int V_177 )
{
switch ( V_34 -> V_8 ) {
case V_27 :
...
break;
case V_126 :
if ( F_141 ( V_175 & V_178 ) &&
F_141 ( ! F_31 ( V_177 , V_34 -> V_18 . V_16 ) ) )
V_177 = F_11 ( V_34 -> V_18 . V_16 ) ;
break;
default:
F_29 () ;
}
return F_145 ( V_177 , V_175 ) ;
}
...
struct V_176 * V_176 ;
struct V_170 * V_170 ;
enum V_169 V_180 = F_142 ( V_39 ) ;
V_176 = & F_150 ( V_5 ) -> V_181 [ 0 ] ;
( void ) F_151 ( V_176 , V_180 ,
& V_34 -> V_18 . V_16 ,
& V_170 ) ;
return V_170 ? V_170 -> V_5 : V_5 ;
}
default:
F_29 () ;
}
...
struct V_176 * F_157 ( struct V_57 * V_58 , unsigned long V_64 ,
...
case V_126 :
case V_125 :
V_12 = F_139 ( V_1 -> V_18 . V_16 , * V_166 ) ;
break;
default:
F_29 () ;
}
...
static struct V_68 * F_162 ( T_7 V_175 , unsigned V_194 ,
unsigned V_72 )
{
struct V_176 * V_193 ;
struct V_68 * V_68 ;
V_193 = F_145 ( V_72 , V_175 ) ;
V_68 = F_163 ( V_175 , V_194 , V_193 ) ;
if ( V_68 && F_164 ( V_68 ) == F_165 ( & V_193 -> V_195 [ 0 ] ) )
F_100 ( V_68 , V_196 ) ;
return V_68 ;
}
struct V_68 *
F_166 ( T_7 V_175 , int V_194 , struct V_57 * V_58 ,
...
V_4 -> V_8 != V_125 ) ) {
V_76 = F_140 ( V_175 , V_4 ) ;
if ( ! V_76 || F_31 ( V_5 , * V_76 ) ) {
F_97 ( V_4 ) ;
V_68 = F_107 ( V_5 , V_175 , V_194 ) ;
goto V_123;
}
}
if ( V_4 -> V_8 == V_125 ) {
...
F_97 ( V_4 ) ;
V_68 = F_162 ( V_175 , V_194 , V_72 ) ;
goto V_123;
}
V_76 = F_140 ( V_175 , V_4 ) ;
V_193 = F_144 ( V_175 , V_4 , V_5 ) ;
F_97 ( V_4 ) ;
V_68 = F_169 ( V_175 , V_194 , V_193 , V_76 ) ;
V_123:
if ( F_141 ( ! V_68 && F_170 ( V_198 ) ) )
goto V_199;
return V_68 ;
}
struct V_68 * F_171 ( T_7 V_175 , unsigned V_194 )
{
struct V_1 * V_4 = & V_9 ;
struct V_68 * V_68 ;
unsigned int V_198 ;
if ( ! F_149 () && ! ( V_175 & V_178 ) )
V_4 = F_1 ( V_47 ) ;
V_199:
V_198 = F_167 () ;
if ( V_4 -> V_8 == V_125 )
V_68 = F_162 ( V_175 , V_194 , F_146 ( V_4 ) ) ;
else
V_68 = F_169 ( V_175 , V_194 ,
F_144 ( V_175 , V_4 , F_2 () ) ,
F_140 ( V_175 , V_4 ) ) ;
if ( F_141 ( ! V_68 && F_170 ( V_198 ) ) )
goto V_199;
...
while ( V_210 ) {
struct V_206 * V_3 = F_177 ( V_210 , struct V_206 , V_177 ) ;
if ( V_87 >= V_3 -> V_65 )
V_210 = V_210 -> V_212 ;
...
if ( ! V_95 )
break;
V_30 = F_177 ( V_95 , struct V_206 , V_177 ) ;
if ( V_30 -> V_65 <= V_87 )
break;
V_210 = V_95 ;
}
return F_177 ( V_210 , struct V_206 , V_177 ) ;
}
...
while ( * V_3 ) {
V_214 = * V_3 ;
V_177 = F_177 ( V_214 , struct V_206 , V_177 ) ;
if ( V_54 -> V_87 < V_177 -> V_87 )
V_3 = & ( * V_3 ) -> V_213 ;
...
F_180 ( & V_54 -> V_177 , V_214 , V_3 ) ;
F_181 ( & V_54 -> V_177 , & V_208 -> V_211 ) ;
...
struct V_209 * V_114 = F_194 ( & V_210 -> V_177 ) ;
if ( V_210 -> V_87 >= V_87 ) {
if ( V_210 -> V_65 <= V_65 )
F_189 ( V_208 , V_210 ) ;
else
...
if ( ! V_114 )
break;
V_210 = F_177 ( V_114 , struct V_206 , V_177 ) ;
}
if ( V_54 )
F_179 ( V_208 , V_54 ) ;
F_61 ( & V_208 -> V_217 ) ;
...
static int T_8 F_204 ( char * V_243 )
{
int V_12 = 0 ;
if ( ! V_243 )
goto V_123;
...
F_88 ( F_146 ) ;
F_210 (nid, N_MEMORY) {
unsigned long V_247 = F_211 ( V_72 ) ;
if ( V_244 < V_247 ) {
V_244 = V_247 ;
V_245 = V_72 ;
}
...
int F_214 ( char * V_243 , struct V_1 * * V_191 )
{
...
void F_217 ( char * V_253 , int V_254 , struct V_1 * V_4 )
{
char * V_3 = V_253 ;
T_1 V_16 = V_255 ;
...
if ( ! F_9 ( V_16 ) )
V_3 += F_218 ( V_3 , V_253 + V_254 - V_3 , L_23 ,
F_219 ( & V_16 ) ) ;
}
