...
struct V_1 * F_14 ( struct V_86 * V_5 , unsigned int V_6 )
{
struct V_21 * V_20 ;
struct V_81 * V_25 ;
struct V_1 * V_2 ;
int V_32 ;
V_2 = F_15 ( V_5 -> V_87 , sizeof( * V_2 ) , V_88 ) ;
if ( V_2 == NULL )
return F_16 ( - V_89 ) ;
V_2 -> V_90 = V_91 ;
V_2 -> V_92 = V_93 ;
...
V_20 -> V_4 . V_96 = & V_97 ;
V_20 -> V_98 = & V_99 ;
snprintf ( V_20 -> V_100 , sizeof( V_20 -> V_100 ) , L_1 ,
F_19 ( V_5 -> V_87 ) , V_6 ) ;
F_20 ( V_20 , V_2 ) ;
V_20 -> V_101 |= V_102 ;
F_21 ( V_20 , NULL ) ;
F_22 ( & V_2 -> V_12 , 1 ) ;
F_23 ( & V_2 -> V_12 , & V_103 , V_16 ,
0 , 255 , 1 , 255 ) ;
V_2 -> V_4 . V_20 . V_104 = & V_2 -> V_12 ;
if ( V_2 -> V_12 . error ) {
F_24 ( V_5 -> V_87 , L_2 ,
V_6 ) ;
V_32 = V_2 -> V_12 . error ;
