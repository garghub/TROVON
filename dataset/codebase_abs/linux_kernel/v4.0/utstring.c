...
void F_16 ( char * string , T_5 V_29 )
{
T_2 V_30 ;
if ( ! string ) {
F_17 ( L_2 ) ;
...
T_4 F_26 ( char * V_43 , T_6 V_44 , char * V_45 )
{
if ( F_27 ( V_45 ) >= V_44 ) {
return ( TRUE ) ;
}
...
T_4 F_29 ( char * V_43 , T_6 V_44 , char * V_45 )
{
if ( ( F_27 ( V_43 ) + F_27 ( V_45 ) ) >= V_44 ) {
return ( TRUE ) ;
}
F_30 ( V_43 , V_45 ) ;
return ( FALSE ) ;
