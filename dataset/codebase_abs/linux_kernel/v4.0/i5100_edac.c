...
static int F_54 ( struct V_11 * V_12 , T_1 V_62 )
{
struct V_15 * V_16 = V_12 -> V_17 ;
T_1 V_41 ;
F_48 ( V_16 -> V_1 , V_58 , & V_41 ) ;
...
static struct V_37 * F_57 ( unsigned V_63 ,
unsigned V_64 ,
unsigned V_65 )
{
struct V_37 * V_66 = NULL ;
while ( 1 ) {
V_66 = F_58 ( V_63 , V_64 , V_66 ) ;
if ( ! V_66 )
break;
if ( F_59 ( V_66 -> V_67 ) == V_65 )
break;
}
return V_66 ;
}
static unsigned long F_60 ( struct V_11 * V_12 , int V_25 )
{
struct V_15 * V_16 = V_12 -> V_17 ;
...
static int F_63 ( const struct V_11 * V_12 ,
T_3 V_86 , T_3 V_87 , T_3 V_80 , T_3 * V_88 )
{
struct V_15 * V_16 = V_12 -> V_17 ;
T_2 V_83 ;
unsigned long V_89 ;
F_62 ( V_16 -> V_1 , V_90 , & V_83 ) ;
if ( F_6 ( V_83 ) )
return - 1 ;
F_49 ( V_16 -> V_1 , V_91 ,
...
T_3 V_14 ;
if ( F_63 ( V_12 , V_10 , V_19 , 5 , & V_14 ) < 0 )
...
struct V_110 * V_111 ;
const unsigned long V_112 = F_60 ( V_12 , V_10 ) ;
const unsigned V_13 = F_43 ( V_12 , V_10 ) ;
const unsigned V_14 = F_42 ( V_12 , V_10 ) ;
if ( ! V_112 )
continue;
V_111 = F_69 ( V_12 -> V_113 , V_12 -> V_114 , V_12 -> V_115 ,
V_13 , V_14 , 0 ) ;
V_111 -> V_116 = V_112 ;
V_111 -> V_117 = 32 ;
...
F_73 ( V_16 -> V_1 , V_136 , V_127 ) ;
} else {
F_49 ( V_16 -> V_1 , V_137 , V_126 ) ;
F_73 ( V_16 -> V_1 , V_138 , V_127 ) ;
}
F_74 ( V_16 -> V_139 , V_140 , 0xaa ) ;
F_74 ( V_16 -> V_139 , V_140 , 0xab ) ;
}
static T_4 F_75 ( struct V_141 * V_141 , const char T_5 * V_7 ,
T_6 V_142 , T_7 * V_143 )
{
struct V_64 * V_144 = V_141 -> V_145 ;
struct V_11 * V_12 = F_76 ( V_144 ) ;
F_72 ( V_12 ) ;
return V_142 ;
}
...
if ( ! V_146 )
return - V_147 ;
V_16 -> V_148 = F_78 ( V_12 -> V_149 -> V_150 , V_146 ) ;
if ( ! V_16 -> V_148 )
return - V_151 ;
F_79 ( L_19 , V_152 | V_153 , V_16 -> V_148 ,
& V_16 -> V_134 ) ;
F_79 ( L_20 , V_152 | V_153 , V_16 -> V_148 ,
& V_16 -> V_128 ) ;
F_79 ( L_21 , V_152 | V_153 , V_16 -> V_148 ,
& V_16 -> V_132 ) ;
F_79 ( L_22 , V_152 | V_153 , V_16 -> V_148 ,
& V_16 -> V_131 ) ;
F_80 ( L_23 , V_152 | V_153 , V_16 -> V_148 ,
& V_16 -> V_130 ) ;
F_80 ( L_24 , V_152 | V_153 , V_16 -> V_148 ,
& V_16 -> V_133 ) ;
F_81 ( L_25 , V_153 , V_16 -> V_148 ,
& V_12 -> V_144 , & V_154 ) ;
return 0 ;
}
static int F_82 ( struct V_37 * V_38 , const struct V_155 * V_156 )
{
int V_157 ;
struct V_11 * V_12 ;
