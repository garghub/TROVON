...
static T_1 void F_45 ( void )
{
#ifdef F_6
unsigned long V_92 = ( unsigned long ) V_27 + ( 4UL << 20 ) ;
if ( ! V_28 || ! V_29 )
return;
if ( V_28 >= V_92 )
return;
memmove ( ( void * ) V_92 , ( void * ) V_28 , V_29 ) ;
V_28 = V_92 ;
#endif
}
static void T_1 F_46 ( T_4 (* F_47)( char * , T_4 ) )
{
char * V_93 , * V_94 ;
T_4 V_73 , V_14 ;
V_14 = strlen ( V_21 ) ;
V_94 = V_21 + V_14 ;
V_93 = V_21 + V_14 + 1 ;
V_73 = F_47 ( V_93 , V_95 - V_14 - 1 ) ;
if ( V_73 ) {
if ( * V_93 == '=' )
memmove ( V_21 , V_93 + 1 , V_73 ) ;
else
* V_94 = ' ' ;
}
}
static inline int F_48 ( const char * V_88 )
{
int V_5 ;
for ( V_5 = 0 ; V_88 [ V_5 ] ; V_5 ++ )
if ( V_88 [ V_5 ] & 0x80 )
return 1 ;
return 0 ;
}
