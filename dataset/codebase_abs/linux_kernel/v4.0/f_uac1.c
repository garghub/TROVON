...
static int
F_38 ( struct V_98 * V_99 , struct V_9 * V_10 )
{
...
V_101 = F_40 ( V_28 , V_104 , F_41 ( V_105 ) ) ;
if ( F_18 ( V_101 ) )
return F_42 ( V_101 ) ;
...
V_23 -> V_90 = V_28 ;
V_38 = - V_5 ;
V_38 = F_45 ( V_10 , V_127 , V_127 , NULL ) ;
if ( V_38 )
goto V_122;
return 0 ;
V_122:
...
{
F_50 ( & V_15 -> V_56 ) ;
F_51 ( & V_128 . V_20 , & V_15 -> V_56 ) ;
F_50 ( & V_128 . V_129 ) ;
F_51 ( & V_130 . V_20 , & V_128 . V_129 ) ;
F_51 ( & V_131 . V_20 , & V_128 . V_129 ) ;
...
static inline struct V_30 * F_52 ( struct V_136 * V_137 )
{
return F_7 ( F_53 ( V_137 ) , struct V_30 ,
V_35 . V_138 ) ;
}
static void F_54 ( struct V_136 * V_137 )
{
struct V_30 * V_31 = F_52 ( V_137 ) ;
F_55 ( & V_31 -> V_35 ) ;
}
static void F_56 ( struct V_139 * V_10 )
{
struct V_30 * V_31 ;
...
return F_3 ( - V_5 ) ;
F_58 ( & V_31 -> V_18 ) ;
V_31 -> V_35 . V_147 = F_56 ;
F_59 ( & V_31 -> V_35 . V_138 , L_8 ,
& V_148 ) ;
V_31 -> V_87 = V_149 ;
V_31 -> V_88 = V_150 ;
V_31 -> V_32 = V_151 ;
...
static void F_63 ( struct V_98 * V_99 , struct V_9 * V_10 )
{
F_64 ( V_10 ) ;
}
static struct V_9 * F_65 ( struct V_139 * V_34 )
{
struct V_8 * V_15 ;
struct V_30 * V_31 ;
...
F_50 ( & V_15 -> V_19 ) ;
F_66 ( & V_15 -> V_18 ) ;
V_15 -> V_11 . V_12 . V_156 = F_38 ;
V_15 -> V_11 . V_12 . V_157 = F_63 ;
V_15 -> V_11 . V_12 . V_158 = F_30 ;
V_15 -> V_11 . V_12 . V_159 = F_29 ;
V_15 -> V_11 . V_12 . V_160 = F_34 ;
V_15 -> V_11 . V_12 . V_161 = F_60 ;
F_49 ( V_15 ) ;
F_67 ( & V_15 -> V_16 , F_8 ) ;
