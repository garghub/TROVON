...
static int F_24 ( struct V_29 * V_30 , struct V_37 * V_38 )
{
struct V_3 * V_4 = F_2 ( V_30 , struct V_3 ,
V_29 ) ;
unsigned long V_20 ;
...
V_4 -> V_5 . V_50 = 14 ;
V_4 -> V_5 . V_34 =
F_33 ( 1000 * V_7 -> V_51 . V_52 , V_4 -> V_5 . V_50 ) ;
V_4 -> V_36 = V_4 -> V_5 . V_34 ;
F_17 ( & V_4 -> V_22 , V_20 ) ;
F_28 ( & V_4 -> clock , & V_4 -> V_5 ,
F_34 ( F_35 () ) ) ;
F_19 ( & V_4 -> V_22 , V_20 ) ;
V_40 = F_36 ( & V_4 -> V_5 , V_4 -> V_5 . V_8 , V_48 , & V_48 ) ;
F_37 ( V_40 , V_42 / 2 / V_53 ) ;
V_4 -> V_27 = V_40 ;
V_4 -> V_29 = V_54 ;
