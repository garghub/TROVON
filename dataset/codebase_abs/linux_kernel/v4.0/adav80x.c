...
static int F_31 ( struct V_4 * V_5 , int V_102 ,
...
return 0 ;
return F_43 ( V_81 -> V_122 ,
V_123 , V_7 -> V_18 , V_7 -> V_18 ) ;
}
...
int F_49 ( struct V_125 * V_126 , struct V_23 * V_23 )
{
struct V_7 * V_7 ;
if ( F_50 ( V_23 ) )
return F_51 ( V_23 ) ;
V_7 = F_52 ( V_126 , sizeof( * V_7 ) , V_127 ) ;
if ( ! V_7 )
return - V_128 ;
F_53 ( V_126 , V_7 ) ;
V_7 -> V_23 = V_23 ;
return F_54 ( V_126 , & V_129 ,
V_130 , F_55 ( V_130 ) ) ;
}
