...
if ( V_104 == V_106 || F_66 ( V_132 , & V_85 -> V_133 ) ) {
F_32 ( L_10 ) ;
F_67 ( V_85 , V_134 , NULL ) ;
return 0 ;
}
if ( V_85 -> V_115 != 0 )
* V_113 ++ = V_104 ;
...
F_67 ( V_85 , V_85 -> V_117 , V_109 + 1 ) ;
return 1 ;
}
int F_68 ( struct V_137 * V_137 , struct V_138 * V_138 )
{
int V_33 ;
struct V_22 * V_23 = F_5 ( V_137 -> V_139 -> V_140 , V_24 ) ;
F_6 ( & V_25 ) ;
if ( V_23 -> V_26 == NULL ) {
F_7 ( & V_25 ) ;
return - V_141 ;
...
F_38 ( V_23 -> V_26 ) ;
V_33 = F_69 ( V_23 -> V_26 , V_138 ) ;
F_7 ( & V_25 ) ;
return V_33 ;
}
int F_70 ( struct V_137 * V_137 , struct V_138 * V_138 )
{
int V_33 = F_71 ( V_137 , V_138 ) ;
struct V_20 * V_20 = V_137 -> V_139 -> V_140 ;
F_6 ( & V_25 ) ;
F_45 ( V_20 ) ;
F_7 ( & V_25 ) ;
return V_33 ;
