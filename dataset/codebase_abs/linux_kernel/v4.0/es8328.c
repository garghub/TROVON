...
{
struct V_82 * V_82 = F_22 ( V_2 -> V_11 , NULL ) ;
struct V_3 * V_4 ;
int V_18 ;
V_4 = F_2 ( V_2 ) ;
V_18 = F_23 ( V_4 -> V_36 ) ;
...
int F_32 ( struct V_84 * V_11 , struct V_82 * V_82 )
{
struct V_3 * V_4 ;
int V_18 ;
int V_6 ;
if ( F_29 ( V_82 ) )
return F_30 ( V_82 ) ;
V_4 = F_33 ( V_11 , sizeof( * V_4 ) , V_85 ) ;
if ( V_4 == NULL )
return - V_86 ;
V_4 -> V_82 = V_82 ;
for ( V_6 = 0 ; V_6 < F_3 ( V_4 -> V_81 ) ; V_6 ++ )
V_4 -> V_81 [ V_6 ] . V_87 = V_88 [ V_6 ] ;
V_18 = F_34 ( V_11 , F_3 ( V_4 -> V_81 ) ,
V_4 -> V_81 ) ;
if ( V_18 ) {
F_12 ( V_11 , L_9 ) ;
return V_18 ;
