...
T_1 V_11 ;
char * V_12 = V_5 ;
V_11 = F_6 ( V_2 , V_37 , & V_23 ,
L_19 ) ;
if ( V_11 )
return 0 ;
V_12 += sprintf ( V_12 , L_20 ,
F_4 ( V_23 . V_38 ) ) ;
V_11 = F_6 ( V_2 , V_39 , & V_23 ,
L_21 ) ;
if ( ! V_11 ) {
V_12 += sprintf ( V_12 ,
L_22 ,
...
{
struct V_13 * V_14 = F_2 ( V_2 ) ;
if ( V_14 -> V_50 . V_51 [ V_52 ] == 0 )
return 0 ;
return sprintf ( V_5 , L_24 ,
F_15 ( V_14 -> V_50 . V_51 [ V_53 ] ) ,
F_15 ( V_14 -> V_50 . V_51 [ V_54 ] ) ,
F_15 ( V_14 -> V_50 . V_51 [ V_52 ] ) ,
V_14 -> V_50 . V_55
? L_25 : L_26 ) ;
}
