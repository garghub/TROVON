...
static int F_47 ( struct V_138 * V_180 ,
struct V_1 * V_2 )
{
struct V_129 * V_130 = V_2 -> V_131 ;
int V_103 ;
V_2 -> V_152 = F_48 ( V_180 , L_14 ) ;
if ( F_49 ( V_2 -> V_152 ) ) {
F_28 ( V_130 -> V_146 ,
L_15 ) ;
return F_50 ( V_2 -> V_152 ) ;
}
V_103 = F_32 ( V_2 -> V_152 ) ;
if ( V_103 ) {
F_28 ( V_130 -> V_146 , L_3 ) ;
...
static int F_51 ( struct V_138 * V_176 ,
struct V_1 * V_2 )
{
int V_46 ;
T_3 V_181 ;
V_2 -> V_153 =
F_52 ( V_176 , L_16 ) ;
V_2 -> V_132 = F_52 ( V_176 , L_17 ) ;
V_2 -> V_106 =
F_52 ( V_176 , L_18 ) ;
V_2 -> V_108 = F_52 ( V_176 , L_19 ) ;
V_2 -> V_109 =
F_52 ( V_176 , L_20 ) ;
F_53 ( V_176 , L_21 , & V_2 -> V_160 ) ;
if ( ! V_2 -> V_160 )
V_2 -> V_160 = V_161 ;
for ( V_46 = 0 ; V_46 < V_182 ; V_46 ++ ) {
if ( ! F_54 ( V_176 , L_22 , V_46 , & V_181 ) )
V_2 -> V_133 [ V_46 ] = V_181 ;
}
return 0 ;
}
static int F_55 ( struct V_183 * V_184 )
{
...
struct V_170 * V_170 ;
int V_147 , V_187 = 0 ;
V_130 = F_56 ( & V_184 -> V_146 , sizeof( * V_130 ) , V_188 ) ;
if ( ! V_130 )
return - V_189 ;
V_130 -> V_178 = F_57 ( V_176 ) ;
V_130 -> V_179 = F_58 ( & V_184 -> V_146 , V_130 -> V_178 ,
sizeof( * V_130 -> V_179 ) , V_188 ) ;
if ( ! V_130 -> V_179 )
return - V_189 ;
V_130 -> V_136 = F_59 ( V_176 , L_22 ) ;
if ( F_49 ( V_130 -> V_136 ) ) {
F_28 ( V_130 -> V_146 , L_23 ) ;
return F_50 ( V_130 -> V_136 ) ;
}
V_130 -> V_146 = & V_184 -> V_146 ;
F_60 ( & V_184 -> V_146 , V_130 ) ;
F_61 ( & V_130 -> V_171 ) ;
F_62 (np, child) {
struct V_1 * V_2 ;
V_2 = F_56 ( & V_184 -> V_146 , sizeof( * V_2 ) ,
V_188 ) ;
if ( ! V_2 )
return - V_189 ;
V_130 -> V_179 [ V_187 ] = V_2 ;
V_170 = F_63 ( & V_184 -> V_146 , V_139 , & V_190 ) ;
if ( F_49 ( V_170 ) ) {
F_28 ( & V_184 -> V_146 , L_24 ) ;
return F_50 ( V_170 ) ;
}
V_130 -> V_179 [ V_187 ] -> V_170 = V_170 ;
V_130 -> V_179 [ V_187 ] -> V_131 = V_130 ;
V_147 = F_51 ( V_139 , V_2 ) ;
if ( V_147 )
return V_147 ;
V_147 = F_47 ( V_139 , V_130 -> V_179 [ V_187 ] ) ;
if ( V_147 )
return V_147 ;
F_64 ( V_170 , V_130 -> V_179 [ V_187 ] ) ;
V_187 ++ ;
}
V_186 = F_65 ( & V_184 -> V_146 , F_42 ) ;
if ( F_49 ( V_186 ) )
return F_50 ( V_186 ) ;
return 0 ;
}
