...
static int F_45 ( struct V_1 * V_2 , T_3 V_134 )
{
if ( F_46 ( V_2 , V_134 ) == 0 )
return 0 ;
F_40 ( V_2 -> V_59 ) ;
...
static int F_47 ( struct V_1 * V_2 , T_1 V_135 )
{
F_4 ( L_40 , V_135 ) ;
...
static int F_70 ( int V_161 , int V_162 , int V_163 )
{
F_19 ( V_162 , V_161 ) ;
F_19 ( V_163 , V_161 + 1 ) ;
...
static int F_71 ( int V_161 , int V_164 , T_1 V_46 )
{
...
static int F_72 ( int V_161 , int V_164 , T_1 V_46 )
{
if ( F_70 ( V_161 , V_165 , V_164 ) )
return - V_57 ;
...
static int F_73 ( int V_161 , int V_164 , T_1 V_36 )
{
if ( F_70 ( V_161 , V_165 , V_164 ) )
return - V_57 ;
...
static int F_74 ( int V_161 , int V_164 , int V_173 )
{
T_1 V_174 ;
V_173 >>= 8 ;
V_174 = ( T_1 ) ( V_173 & 0xfff ) ;
if ( F_70 ( V_161 , V_165 , V_164 ) )
return - V_57 ;
...
static int F_75 ( int V_161 , int V_164 )
{
if ( F_70 ( V_161 , V_165 , V_164 ) )
return - V_57 ;
...
static int F_76 ( int V_161 , int V_164 , T_1 V_182 ,
T_1 V_183 , T_1 V_36 , int V_173 )
{
if ( F_70 ( V_161 , V_165 , V_164 ) )
return - V_57 ;
...
static int F_78 ( struct V_133 * V_185 , unsigned int V_184 )
{
if ( V_46 [ V_184 ] == V_153 )
return 0 ;
...
static int F_79 ( struct V_133 * V_185 , unsigned int V_186 )
{
int V_112 ;
struct V_58 * V_59 ;
struct V_1 * V_2 ;
...
V_112 = F_81 ( V_185 , V_187 [ V_186 ] , V_188 [ V_186 ] , V_189 ,
...
static int F_84 ( struct V_133 * V_185 , unsigned int V_114 )
{
F_68 ( F_85 ( V_185 ) ) ;
return 0 ;
}
...
if ( V_186 >= V_226 )
return - V_67 ;
V_223 = F_87 ( V_220 , V_222 -> V_227 [ 0 ] . V_188 , NULL ) ;
if ( ! V_223 )
return - V_67 ;
V_224 = F_87 ( V_220 , V_222 -> V_227 [ 1 ] . V_188 , NULL ) ;
if ( ! V_224 )
return - V_67 ;
if ( ! F_88 ( V_223 ) && F_89 ( V_223 ) < 0 ) {
F_25 ( V_228 L_71 ) ;
return - V_147 ;
}
if ( ! F_88 ( V_224 ) && F_89 ( V_224 ) < 0 ) {
F_25 ( V_228 L_72 ) ;
return - V_147 ;
}
V_225 = F_81 ( & V_220 -> V_59 -> V_114 ,
V_187 [ V_186 ] , V_188 [ V_186 ] , V_189 ,
sizeof( struct V_1 ) , & V_59 ) ;
if ( V_225 < 0 )
return V_225 ;
V_2 = V_59 -> V_60 ;
V_2 -> V_59 = V_59 ;
V_46 [ V_186 ] = F_90 ( V_223 , 0 ) ;
V_36 [ V_186 ] = F_91 ( V_223 , 0 ) ;
V_173 [ V_186 ] = F_92 ( V_223 , 0 ) ;
V_152 [ V_186 ] = F_90 ( V_224 , 0 ) ;
V_157 [ V_186 ] = F_91 ( V_224 , 0 ) ;
F_1 ( V_2 ) ;
#ifdef F_10
V_2 -> type = V_210 ;
#else
...
static void F_94 ( struct V_219 * V_220 )
{
F_68 ( F_95 ( V_220 ) ) ;
F_93 ( V_220 , NULL ) ;
}
