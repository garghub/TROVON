...
V_77 = F_44 ( & V_76 , V_72 , sizeof( V_72 ) ) ;
if ( V_77 < 0 ) {
F_24 ( L_5 , V_77 ) ;
return V_77 ;
}
if ( V_61 && V_61 -> V_68 &&
V_38 -> V_6 && V_38 -> V_6 -> V_78 )
V_38 -> V_6 -> V_78 ( V_2 , V_61 -> V_68 -> V_3 ,
V_72 , sizeof( V_72 ) ) ;
return 0 ;
}
static void F_45 ( unsigned int clock , int * V_79 , int * V_80 , int V_81 )
{
int V_82 , V_83 ;
unsigned long div , V_84 ;
V_82 = 128 * V_81 ;
V_83 = clock * 1000 ;
div = F_46 ( V_82 , V_83 ) ;
V_82 /= div ;
V_83 /= div ;
V_84 = ( ( 128 * V_81 / 1000 ) + ( V_82 - 1 ) ) / V_82 ;
V_82 *= V_84 ;
V_83 *= V_84 ;
if ( V_82 < ( 128 * V_81 / 1500 ) )
F_47 ( V_85 L_6 ) ;
if ( V_82 > ( 128 * V_81 / 300 ) )
F_47 ( V_85 L_7 ) ;
* V_80 = V_82 ;
* V_79 = V_83 ;
F_32 ( L_8 ,
...
static const struct V_86 * F_48 ( unsigned int clock )
{
static struct V_86 V_87 ;
T_2 V_21 ;
static const struct V_86 V_88 [] = {
...
for ( V_21 = 0 ; V_21 < F_49 ( V_88 ) ; V_21 ++ )
if ( V_88 [ V_21 ] . clock == clock )
return & V_88 [ V_21 ] ;
F_45 ( clock , & V_87 . V_89 , & V_87 . V_90 , 32000 ) ;
F_45 ( clock , & V_87 . V_91 , & V_87 . V_92 , 44100 ) ;
F_45 ( clock , & V_87 . V_93 , & V_87 . V_94 , 48000 ) ;
return & V_87 ;
}
static void F_50 ( struct V_36 * V_37 , unsigned int clock )
{
const struct V_86 * V_95 = F_48 ( clock ) ;
struct V_38 * V_38 = F_28 ( V_37 ) ;
struct V_60 * V_61 = V_38 -> V_62 ;
if ( ! V_61 || ! V_61 -> V_68 )
return;
if ( V_38 -> V_6 && V_38 -> V_6 -> V_96 )
V_38 -> V_6 -> V_96 ( V_37 , V_61 -> V_68 -> V_3 , V_95 ) ;
}
...
if ( ! V_61 || ! V_61 -> V_68 )
return;
if ( V_38 -> V_6 && V_38 -> V_6 -> V_97 )
V_38 -> V_6 -> V_97 ( V_37 , V_61 -> V_68 -> V_3 ) ;
}
...
if ( V_38 -> V_6 && V_38 -> V_6 -> V_99 )
V_38 -> V_6 -> V_99 ( V_37 , V_61 -> V_68 -> V_3 , V_98 ) ;
}
...
if ( ! V_61 || ! V_61 -> V_68 )
return;
if ( V_38 -> V_6 && V_38 -> V_6 -> V_100 )
V_38 -> V_6 -> V_100 ( V_37 , V_61 -> V_68 -> V_3 ) ;
}
static void F_54 ( struct V_36 * V_37 , bool V_101 )
{
struct V_38 * V_38 = F_28 ( V_37 ) ;
struct V_60 * V_61 = V_38 -> V_62 ;
if ( ! V_61 || ! V_61 -> V_68 )
return;
if ( V_38 -> V_6 && V_38 -> V_6 -> V_102 )
V_38 -> V_6 -> V_102 ( V_37 , V_61 -> V_68 -> V_3 , V_101 ) ;
}
...
struct V_48 * V_49 )
{
struct V_103 * V_52 = V_37 -> V_52 ;
struct V_1 * V_2 = V_52 -> V_53 ;
struct V_38 * V_38 = F_28 ( V_37 ) ;
struct V_60 * V_61 = V_38 -> V_62 ;
struct V_39 * V_40 = F_57 ( V_37 ) ;
...
F_21 ( V_37 ) ;
F_33 ( V_37 , V_49 ) ;
if ( V_2 -> clock . V_107 || F_58 ( V_2 ) )
F_40 ( V_37 , V_2 -> clock . V_108 * 10 ) ;
else
F_40 ( V_37 , V_105 -> V_109 ) ;
F_53 ( V_37 ) ;
F_35 ( V_37 ) ;
if ( F_42 ( V_37 , V_49 ) < 0 )
return;
...
{
struct V_38 * V_38 = F_28 ( V_37 ) ;
if ( V_38 -> V_6 && V_38 -> V_6 -> V_110 )
V_38 -> V_6 -> V_110 ( V_37 , V_49 ) ;
}
void F_60 ( struct V_36 * V_37 , int V_49 )
{
struct V_38 * V_38 = F_28 ( V_37 ) ;
if ( V_38 -> V_6 && V_38 -> V_6 -> V_111 )
V_38 -> V_6 -> V_111 ( V_37 , V_49 == V_112 ) ;
}
