...
sizeof( V_195 . V_199 ) ) ;
V_195 . V_200 = V_32 ;
V_15 = F_122 ( V_2 , (struct V_201 * ) & V_195 ,
sizeof( V_195 ) ) ;
if ( V_15 < 0 )
goto V_17;
V_195 . V_198 = V_183 ;
...
V_203 . V_200 = V_106 ;
V_15 = F_123 ( V_2 , (struct V_201 * ) & V_203 ,
sizeof( V_203 ) , 0 ) ;
if ( V_15 < 0 )
goto V_17;
}
...
int F_124 ( struct V_6 * V_6 , int V_18 , int V_75 , T_1 V_32 , T_1 V_106 , struct V_174 * V_175 , struct V_1 * * V_204 )
{
struct V_1 * V_8 = NULL ;
int V_15 ;
struct V_16 * V_2 = NULL ;
...
V_8 = F_128 ( sizeof( struct V_1 ) , V_211 ) ;
if ( V_8 == NULL ) {
V_15 = - V_212 ;
goto V_15;
}
...
V_8 -> V_2 = V_3 ;
V_8 -> V_18 = V_18 ;
F_132 ( & V_3 -> V_223 . V_224 , & V_225 , L_34 ) ;
V_3 -> V_226 = V_227 ;
F_133 ( & V_8 -> V_172 , F_113 ) ;
F_134 ( & V_8 -> V_162 ) ;
F_5 ( & V_163 ) ;
F_135 ( V_8 ) ;
F_34 ( & V_11 -> V_161 ) ;
F_136 ( & V_8 -> V_162 , & V_11 -> V_228 ) ;
F_41 ( & V_11 -> V_161 ) ;
V_15 = 0 ;
V_15:
if ( V_204 )
...
int F_137 ( struct V_1 * V_8 )
{
F_102 ( V_8 ) ;
return ( false == F_138 ( V_230 , & V_8 -> V_172 ) ) ;
}
void F_139 ( struct V_20 * V_22 )
{
struct V_1 * V_8 = V_22 -> V_8 ;
...
struct V_20 * F_144 ( int V_234 , struct V_1 * V_8 , T_1 V_12 , T_1 V_107 , struct V_235 * V_175 )
{
struct V_20 * V_22 ;
V_22 = F_128 ( sizeof( struct V_20 ) + V_234 , V_211 ) ;
if ( V_22 != NULL ) {
V_22 -> V_89 = V_90 ;
V_22 -> V_8 = V_8 ;
V_22 -> V_12 = V_12 ;
...
static T_4 int F_149 ( struct V_6 * V_6 )
{
...
F_150 ( & V_11 -> V_161 ) ;
for ( V_27 = 0 ; V_27 < V_31 ; V_27 ++ )
F_151 ( & V_11 -> V_13 [ V_27 ] ) ;
F_150 ( & V_11 -> V_232 ) ;
return 0 ;
}
static T_5 void F_152 ( struct V_6 * V_6 )
{
struct V_5 * V_11 = F_1 ( V_6 ) ;
struct V_1 * V_8 = NULL ;
F_19 () ;
