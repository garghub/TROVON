...
int V_51 = - V_52 ;
int V_9 ;
struct V_53 * V_54 = F_8 ( & V_46 , false ,
& V_4 -> V_14 ) ;
if ( V_54 == NULL )
return - 1 ;
if ( V_4 -> V_55 ) {
V_9 = F_9 ( V_54 , V_4 -> V_55 ,
V_4 -> V_56 ) ;
if ( V_9 )
goto V_57;
}
if ( F_10 ( & V_54 -> V_24 . V_58 ) < 0 )
return - 1 ;
printf ( L_18 ) ;
V_51 = F_11 ( V_54 , & V_4 -> V_14 ) ;
if ( V_51 )
return V_51 ;
return 0 ;
V_57:
...
for ( V_7 = 1 ; V_7 < V_1 ; V_7 ++ , V_6 ++ )
V_59 [ V_6 ] = V_2 [ V_7 ] ;
V_9 = F_14 ( V_6 , V_59 , NULL ) ;
free ( V_59 ) ;
return V_9 ;
}
static int
F_15 ( const struct V_62 * V_63 , const char * V_64 , int V_65 )
{
int * V_49 = ( int * ) V_63 -> V_66 ;
...
if ( V_71 )
* V_71 = '\0' ;
for ( V_68 = V_72 ; V_68 -> V_42 ; V_68 ++ ) {
if ( ! strcasecmp ( V_69 , V_68 -> V_42 ) )
break;
}
if ( ! V_68 -> V_42 ) {
fprintf ( V_23 , L_24
...
L_27 , L_28 ,
F_15 ) ,
F_19 ( 'D' , L_29 , & V_4 . V_61 ,
L_30 ) ,
F_19 ( 'U' , L_31 , & V_4 . V_26 ,
L_32 ) ,
F_20 ( 'i' , L_33 , & V_48 , L_34 ,
L_35 ) ,
F_20 ( 'C' , L_36 , & V_4 . V_55 , L_36 ,
L_37 ) ,
F_20 ( 'x' , L_38 , & V_31 . V_32 ,
L_39 ,
L_40
L_41 ) ,
F_21 ()
...
V_1 = F_22 ( V_1 , V_2 , V_88 , V_89 ,
V_90 , V_91 ) ;
if ( ! V_1 || ! ( strncmp ( V_2 [ 0 ] , L_42 , 3 ) || V_4 . V_10 ) )
F_23 ( V_90 , V_88 ) ;
if ( ! V_4 . V_48 || ! strlen ( V_4 . V_48 ) ) {
if ( ! F_24 ( V_92 , & V_74 ) && F_25 ( V_74 . V_93 ) )
V_4 . V_48 = L_43 ;
else
V_4 . V_48 = L_26 ;
}
if ( ! strncmp ( V_2 [ 0 ] , L_42 , 3 ) )
return F_1 ( V_1 , V_2 , & V_4 ) ;
else if ( ! strncmp ( V_2 [ 0 ] , L_44 , 3 ) )
