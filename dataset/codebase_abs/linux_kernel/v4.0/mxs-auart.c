...
int V_172 , V_157 ;
struct V_227 * V_228 ;
V_2 = F_115 ( & V_209 -> V_12 , sizeof( * V_2 ) , V_115 ) ;
if ( ! V_2 )
return - V_229 ;
...
V_2 -> V_173 = F_116 ( & V_209 -> V_12 , NULL ) ;
if ( F_117 ( V_2 -> V_173 ) )
return F_118 ( V_2 -> V_173 ) ;
V_228 = F_119 ( V_209 , V_234 , 0 ) ;
if ( ! V_228 )
return - V_235 ;
V_2 -> V_10 . V_236 = V_228 -> V_237 ;
V_2 -> V_10 . V_40 = F_120 ( V_228 -> V_237 , F_121 ( V_228 ) ) ;
V_2 -> V_10 . V_238 = & V_239 ;
V_2 -> V_10 . V_240 = V_241 ;
V_2 -> V_10 . V_117 = V_177 ;
V_2 -> V_10 . V_150 = F_122 ( V_2 -> V_173 ) ;
V_2 -> V_10 . type = V_74 ;
...
V_172 = F_124 ( & V_209 -> V_12 , V_157 , F_75 , 0 ,
F_37 ( & V_209 -> V_12 ) , V_2 ) ;
if ( V_172 )
return V_172 ;
F_125 ( V_209 , V_2 ) ;
...
F_76 ( & V_2 -> V_10 ) ;
V_172 = F_126 ( & V_242 , & V_2 -> V_10 ) ;
if ( V_172 )
goto V_243;
V_226 = F_24 ( V_2 -> V_10 . V_40 + V_244 ) ;
F_127 ( & V_209 -> V_12 , L_13 ,
( V_226 >> 24 ) & 0xff ,
...
{
struct V_1 * V_2 = F_129 ( V_209 ) ;
F_130 ( & V_242 , & V_2 -> V_10 ) ;
V_196 [ V_209 -> V_230 ] = NULL ;
F_108 ( V_2 ) ;
return 0 ;
}
