...
V_39 = V_38 &&
F_16 ( V_38 , L_3 ) ;
for ( V_42 = 0 ; V_42 < V_25 [ V_17 -> type ] . V_49 ; V_42 ++ ) {
bool V_50 = false ;
V_43 = 0 ;
V_44 = 0 ;
if ( V_36 ) {
if ( V_42 < V_36 -> V_51 ) {
V_43 = V_36 -> V_52 [ V_42 ] . V_53 ;
V_44 = V_36 -> V_52 [ V_42 ] . V_44 ;
} else
break;
V_50 = V_36 -> V_52 [ V_42 ] . V_54 ;
}
V_17 -> V_55 [ V_42 ] =
...
const struct V_23 * V_24 = & V_25 [ V_17 -> type ] ;
int V_58 ;
for ( V_58 = 0 ; V_58 < V_24 -> V_49 ; ++ V_58 )
if ( V_17 -> V_55 [ V_58 ] ) {
F_20 ( V_17 -> V_55 [ V_58 ] ) ;
V_17 -> V_55 [ V_58 ] = NULL ;
}
...
static int F_22 ( struct V_59 * V_33 )
{
