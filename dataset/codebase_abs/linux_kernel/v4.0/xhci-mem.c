...
return;
if ( V_298 < 0x03 && V_3 -> V_302 < V_299 )
V_3 -> V_277 [ V_3 -> V_302 ++ ] = V_293 ;
...
int V_8 , V_139 , V_311 ;
int V_312 = 0 ;
V_101 = & V_3 -> V_313 -> V_72 ;
V_309 = F_148 ( F_144 ( V_101 ) ) ;
if ( V_309 == 0 ) {
F_149 ( V_3 , L_62
L_63 ) ;
return - V_314 ;
...
V_101 = & V_3 -> V_313 -> V_315 + V_309 ;
V_308 = V_101 ;
V_310 = V_309 ;
do {
T_3 V_316 ;
V_316 = F_144 ( V_308 ) ;
if ( F_150 ( V_316 ) == V_317 )
V_312 ++ ;
V_310 = F_151 ( V_316 ) ;
V_308 += V_310 ;
} while ( V_310 );
V_3 -> V_277 = F_2 ( sizeof( * V_3 -> V_277 ) * V_312 , V_5 ) ;
if ( ! V_3 -> V_277 )
return - V_52 ;
while ( 1 ) {
T_3 V_316 ;
...
if ( V_3 -> V_271 ) {
V_3 -> V_274 = F_153 ( sizeof( * V_3 -> V_274 ) *
V_3 -> V_271 , V_5 ) ;
if ( ! V_3 -> V_274 )
return - V_52 ;
V_311 = 0 ;
...
if ( V_3 -> V_272 ) {
V_3 -> V_275 = F_153 ( sizeof( * V_3 -> V_275 ) *
V_3 -> V_272 , V_5 ) ;
if ( ! V_3 -> V_275 )
return - V_52 ;
V_311 = 0 ;
...
T_2 V_7 ;
struct V_81 * V_82 = F_44 ( V_3 ) -> V_83 . V_84 ;
unsigned int V_20 , V_322 ;
T_5 V_323 ;
struct V_1 * V_6 ;
T_3 V_247 , V_293 ;
int V_8 ;
F_30 ( & V_3 -> V_255 ) ;
V_247 = F_144 ( & V_3 -> V_319 -> V_247 ) ;
F_35 ( V_3 , V_236 ,
L_71 , V_247 ) ;
...
F_35 ( V_3 , V_236 ,
L_74 , V_3 -> V_247 / 1024 ) ;
V_20 = F_155 ( F_144 ( & V_3 -> V_313 -> V_130 ) ) ;
F_35 ( V_3 , V_236 ,
L_75 , V_20 ) ;
V_322 = F_144 ( & V_3 -> V_319 -> V_324 ) ;
V_20 |= ( V_322 & ~ V_325 ) ;
F_35 ( V_3 , V_236 ,
L_76 , V_20 ) ;
F_156 ( V_20 , & V_3 -> V_319 -> V_324 ) ;
...
goto V_54;
V_3 -> V_266 = F_29 ( V_3 , 1 , 1 , V_328 , V_5 ) ;
if ( ! V_3 -> V_266 )
goto V_54;
F_35 ( V_3 , V_236 ,
L_82 , V_3 -> V_266 ) ;
...
V_323 = F_141 ( V_3 , & V_3 -> V_319 -> V_266 ) ;
V_323 = ( V_323 & ( T_5 ) V_329 ) |
( V_3 -> V_266 -> V_43 -> V_7 & ( T_5 ) ~ V_329 ) |
V_3 -> V_266 -> V_4 ;
F_35 ( V_3 , V_236 ,
L_84 , V_20 ) ;
F_142 ( V_3 , V_323 , & V_3 -> V_319 -> V_266 ) ;
F_158 ( V_3 ) ;
V_3 -> V_265 = F_51 ( V_3 , true , true , V_5 ) ;
if ( ! V_3 -> V_265 )
goto V_54;
V_3 -> V_102 ++ ;
V_20 = F_144 ( & V_3 -> V_313 -> V_330 ) ;
V_20 &= V_331 ;
F_35 ( V_3 , V_236 ,
L_85
L_86 , V_20 ) ;
V_3 -> V_332 = ( void T_7 * ) V_3 -> V_313 + V_20 ;
F_159 ( V_3 ) ;
F_160 ( V_3 ) ;
V_3 -> V_294 = & V_3 -> V_333 -> V_294 [ 0 ] ;
F_35 ( V_3 , V_236 , L_87 ) ;
V_3 -> V_264 = F_29 ( V_3 , V_334 , 1 , V_21 ,
V_5 ) ;
if ( ! V_3 -> V_264 )
goto V_54;
if ( F_137 ( V_3 ) < 0 )
...
memset ( V_3 -> V_260 . V_262 , 0 , sizeof( struct V_259 ) * V_334 ) ;
V_3 -> V_260 . V_261 = V_334 ;
V_3 -> V_260 . V_263 = V_7 ;
F_35 ( V_3 , V_236 ,
L_89 ,
V_3 -> V_260 . V_261 ,
...
for ( V_20 = 0 , V_6 = V_3 -> V_264 -> V_43 ; V_20 < V_334 ; V_20 ++ ) {
struct V_259 * V_335 = & V_3 -> V_260 . V_262 [ V_20 ] ;
V_335 -> V_336 = F_10 ( V_6 -> V_7 ) ;
V_335 -> V_337 = F_5 ( V_12 ) ;
V_335 -> V_338 = 0 ;
V_6 = V_6 -> V_16 ;
}
V_20 = F_144 ( & V_3 -> V_294 -> V_339 ) ;
V_20 &= V_340 ;
V_20 |= V_334 ;
F_35 ( V_3 , V_236 ,
L_90 ,
V_20 ) ;
F_156 ( V_20 , & V_3 -> V_294 -> V_339 ) ;
F_35 ( V_3 , V_236 ,
L_91 ) ;
F_35 ( V_3 , V_236 ,
L_92 ,
( unsigned long long ) V_3 -> V_260 . V_263 ) ;
V_323 = F_141 ( V_3 , & V_3 -> V_294 -> V_341 ) ;
V_323 &= V_296 ;
V_323 |= ( V_3 -> V_260 . V_263 & ( T_5 ) ~ V_296 ) ;
F_142 ( V_3 , V_323 , & V_3 -> V_294 -> V_341 ) ;
F_139 ( V_3 ) ;
F_35 ( V_3 , V_236 ,
L_93 ) ;
F_161 ( V_3 , 0 ) ;
F_62 ( & V_3 -> V_258 , V_342 ,
( unsigned long ) V_3 ) ;
F_74 ( & V_3 -> V_343 ) ;
for ( V_8 = 0 ; V_8 < V_268 ; ++ V_8 )
V_3 -> V_151 [ V_8 ] = NULL ;
for ( V_8 = 0 ; V_8 < V_318 ; ++ V_8 ) {
V_3 -> V_279 [ 0 ] . V_344 [ V_8 ] = 0 ;
V_3 -> V_279 [ 1 ] . V_344 [ V_8 ] = 0 ;
F_74 ( & V_3 -> V_279 [ 1 ] . V_345 [ V_8 ] ) ;
}
if ( F_126 ( V_3 , V_5 ) )
goto V_54;
if ( F_147 ( V_3 , V_5 ) )
goto V_54;
V_293 = F_144 ( & V_3 -> V_319 -> V_346 ) ;
V_293 &= ~ V_347 ;
V_293 |= V_348 ;
F_156 ( V_293 , & V_3 -> V_319 -> V_346 ) ;
return 0 ;
V_54:
F_71 ( V_3 , L_94 ) ;
F_162 ( V_3 ) ;
