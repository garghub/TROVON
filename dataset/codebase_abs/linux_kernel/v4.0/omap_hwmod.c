...
V_11 -> V_81 -> V_169 . V_170 -> V_171 ,
V_11 -> V_98 . V_99 . V_229 ,
V_11 -> V_98 . V_99 . V_230 ) ;
}
static int F_137 ( struct V_10 * V_11 ,
struct V_146 * V_147 )
{
return F_131 ( V_147 -> V_151 , 0 ,
V_11 -> V_81 -> V_169 . V_170 -> V_171 ,
V_11 -> V_98 . V_99 . V_229 ) ;
}
T_1 F_5 ( struct V_10 * V_11 , T_3 V_231 )
{
if ( V_11 -> V_66 & V_232 )
return F_138 ( V_11 -> V_196 + V_231 ) ;
else
return F_139 ( V_11 -> V_196 + V_231 ) ;
}
void F_7 ( T_1 V_22 , struct V_10 * V_11 , T_3 V_231 )
{
if ( V_11 -> V_66 & V_232 )
F_140 ( V_22 , V_11 -> V_196 + V_231 ) ;
else
F_141 ( V_22 , V_11 -> V_196 + V_231 ) ;
}
...
struct V_10 * F_143 ( const char * V_14 )
{
struct V_10 * V_11 ;
if ( ! V_14 )
return NULL ;
...
int F_144 ( int (* F_145)( struct V_10 * V_11 , void * V_142 ) ,
void * V_142 )
{
struct V_10 * V_140 ;
int V_87 = 0 ;
...
return - V_15 ;
F_62 (temp_oh, &omap_hwmod_list, node) {
V_87 = (* F_145)( V_140 , V_142 ) ;
if ( V_87 )
break;
}
return V_87 ;
}
int T_4 F_146 ( struct V_1 * * V_224 )
{
int V_165 , V_4 ;
if ( ! V_233 )
return - V_15 ;
...
static void T_4 F_147 ( struct V_10 * V_11 )
{
...
int T_4 F_148 ( const char * V_235 )
{
struct V_10 * V_11 ;
F_18 ( L_26 , V_235 , V_101 ) ;
V_11 = F_61 ( V_235 ) ;
if ( ! V_11 ) {
F_4 ( 1 , L_66 , V_235 ) ;
return - V_15 ;
...
int F_153 ( struct V_10 * V_11 , unsigned long V_66 )
{
int V_87 = 0 ;
if ( V_66 & V_236 )
V_87 += F_49 ( V_11 ) ;
...
int F_154 ( struct V_10 * V_11 , struct V_239 * V_188 )
{
struct V_1 * V_89 ;
struct V_2 * V_3 ;
int V_4 , V_61 , V_240 , V_241 , V_242 ;
int V_165 = 0 ;
V_240 = F_49 ( V_11 ) ;
for ( V_4 = 0 ; V_4 < V_240 ; V_4 ++ ) {
unsigned int V_110 ;
if ( V_11 -> V_243 )
V_110 = V_11 -> V_243 ( ( V_11 -> V_109 + V_4 ) -> V_110 ) ;
else
V_110 = ( V_11 -> V_109 + V_4 ) -> V_110 ;
...
V_89 = F_1 ( & V_3 , & V_4 ) ;
V_242 = F_51 ( V_89 ) ;
for ( V_61 = 0 ; V_61 < V_242 ; V_61 ++ ) {
( V_188 + V_165 ) -> V_14 = ( V_89 -> V_117 + V_61 ) -> V_14 ;
( V_188 + V_165 ) -> V_244 = ( V_89 -> V_117 + V_61 ) -> V_118 ;
( V_188 + V_165 ) -> V_245 = ( V_89 -> V_117 + V_61 ) -> V_119 ;
...
int F_155 ( struct V_10 * V_11 , struct V_239 * V_188 )
{
int V_4 , V_241 ;
int V_165 = 0 ;
V_241 = F_50 ( V_11 ) ;
...
int F_156 ( struct V_10 * V_11 , unsigned int type ,
const char * V_14 , struct V_239 * V_246 )
{
int V_165 ;
...
struct V_247 * F_157 ( struct V_10 * V_11 )
{
struct V_80 * V_41 ;
struct V_1 * V_5 ;
struct V_78 * V_81 ;
...
void T_5 * F_158 ( struct V_10 * V_11 )
{
if ( ! V_11 )
return NULL ;
if ( V_11 -> V_20 & V_105 )
...
V_101 , V_248 ) ;
F_62 (temp_oh, &omap_hwmod_list, node) {
if ( ! strcmp ( V_140 -> V_12 -> V_14 , V_248 ) ) {
F_18 ( L_68 ,
V_101 , V_140 -> V_14 ) ;
V_87 = (* F_145)( V_140 , V_123 ) ;
if ( V_87 )
break;
}
}
...
int F_164 ( struct V_10 * V_11 , T_2 V_249 )
{
int V_87 ;
unsigned long V_66 ;
if ( ! V_11 )
