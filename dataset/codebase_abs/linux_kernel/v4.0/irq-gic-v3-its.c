...
V_135 = ( 1 << V_134 ) * V_146 ;
V_46 = ( void * ) F_93 ( V_105 | V_147 , V_134 ) ;
if ( ! V_46 ) {
V_124 = - V_106 ;
goto V_148;
}
...
V_131 |= ( V_135 / V_125 ) - 1 ;
F_94 ( V_131 , V_40 -> V_46 + V_132 + V_112 * 8 ) ;
...
static int F_95 ( struct V_39 * V_40 )
{
...
V_19 = F_99 ( 2UL , F_107 ( V_191 ) ) ;
V_194 = V_19 * V_40 -> V_195 ;
V_194 = F_99 ( V_194 , V_21 ) + V_21 - 1 ;
...
{
int V_202 , V_203 ;
V_202 = F_99 ( F_116 ( V_201 ) , 0 ) ;
V_203 = F_99 ( F_117 ( V_201 ) , 0 ) ;
return F_99 ( V_202 , V_203 ) ;
}
