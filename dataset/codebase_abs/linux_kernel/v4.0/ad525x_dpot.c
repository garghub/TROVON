...
static inline void F_31 ( struct V_82 * V_83 ,
unsigned V_96 , unsigned V_97 )
{
F_32 ( & V_83 -> V_98 ,
V_99 [ V_97 ] ) ;
...
int F_33 ( struct V_82 * V_83 ,
struct V_107 * V_3 , unsigned long V_61 ,
const char * V_108 )
{
struct V_1 * V_87 ;
int V_109 , V_94 = 0 ;
V_87 = F_34 ( sizeof( struct V_1 ) , V_110 ) ;
if ( ! V_87 ) {
V_94 = - V_111 ;
goto exit;
}
...
V_87 -> V_3 = * V_3 ;
V_87 -> V_61 = V_61 ;
V_87 -> V_56 = 1 << F_13 ( V_61 ) ;
V_87 -> V_92 = V_87 -> V_56 - 1 ;
V_87 -> V_18 = F_37 ( V_61 ) ;
V_87 -> V_22 = F_8 ( V_61 ) ;
V_87 -> V_112 = F_38 ( V_61 ) ;
for ( V_109 = V_44 ; V_109 < V_113 ; V_109 ++ )
if ( V_87 -> V_112 & ( 1 << V_109 ) ) {
V_94 = F_28 ( V_83 , V_87 -> V_18 , V_109 ) ;
if ( V_94 )
goto V_114;
if ( V_87 -> V_18 & V_19 )
V_87 -> V_20 [ V_109 ] = V_87 -> V_56 / 2 ;
}
if ( V_87 -> V_18 & V_115 )
V_94 = F_39 ( & V_83 -> V_98 , & V_116 ) ;
if ( V_94 ) {
F_30 ( V_83 , L_7 ) ;
goto V_117;
}
