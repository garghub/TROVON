...
F_49 ( V_11 ) ;
F_50 ( V_11 ) ;
V_42 = F_51 ( V_46 , V_57 , 0 ) ;
if ( V_42 ) {
V_48 = F_51 ( V_46 , V_58 , V_49 ++ ) ;
V_2 -> V_4 = F_52 ( V_11 , V_48 ) ;
if ( F_53 ( V_2 -> V_4 ) )
return F_54 ( V_2 -> V_4 ) ;
V_51 = 0 ;
}
...
if ( ! V_48 )
break;
V_9 = F_46 ( V_11 , sizeof( * V_9 ) , V_54 ) ;
if ( ! V_9 ) {
V_16 = - V_55 ;
goto V_59;
}
V_9 -> V_4 = F_52 ( V_11 , V_48 ) ;
if ( F_53 ( V_9 -> V_4 ) ) {
V_16 = F_54 ( V_9 -> V_4 ) ;
goto V_59;
}
...
if ( F_16 ( V_9 ) )
F_35 ( V_9 ) ;
F_58 ( & V_9 -> V_60 , & V_2 -> V_56 ) ;
V_53 |= 3 << ( V_12 * 8 ) ;
}
if ( V_42 ) {
V_16 = F_59 ( V_11 , V_42 -> V_62 , F_38 , 0 ,
F_60 ( V_11 ) , V_2 ) ;
if ( V_16 ) {
F_15 ( V_11 , L_11 ) ;
goto V_59;
