...
#if F_22 ( V_47 )
if ( V_86 ) {
if ( F_39 ( V_16 , V_48 , sizeof( V_86 -> V_112 ) ,
& V_86 -> V_112 ) ||
F_39 ( V_16 , V_49 , sizeof( V_82 -> V_113 ) ,
& V_82 -> V_113 ) )
goto V_88;
} else
#endif
if ( F_40 ( V_16 , V_52 , V_84 -> V_114 ) ||
F_40 ( V_16 , V_53 , V_84 -> V_115 ) )
goto V_88;
break;
}
V_24:
...
( V_9 -> V_140 &&
F_39 ( V_16 , V_139 , V_9 -> V_140 ,
& V_9 -> V_141 [ 0 ] ) ) ||
( V_9 -> V_143 &&
F_39 ( V_16 , V_142 , V_9 -> V_143 ,
& V_9 -> V_144 [ 0 ] ) ) ||
...
static int F_56 ( struct V_15 * V_16 , struct V_2 * V_3 )
{
struct V_1 * V_9 ;
struct V_15 * V_17 ;
int V_19 ;
...
static int F_57 ( struct V_15 * V_16 , struct V_117 * V_118 )
{
struct V_10 * V_10 = F_44 ( V_16 -> V_82 ) ;
struct V_1 * V_9 ;
struct V_7 * V_8 = NULL ;
...
int F_59 ( enum V_177 V_128 , const struct V_159 * V_178 )
{
int V_19 ;
V_19 = - V_41 ;
if ( V_128 >= V_129 )
