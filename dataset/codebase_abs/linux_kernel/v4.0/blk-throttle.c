...
static T_2 F_131 ( struct V_144 * V_145 ,
char * V_146 , T_3 V_147 , T_4 V_136 , bool V_148 )
{
struct V_46 * V_46 = F_123 ( F_132 ( V_145 ) ) ;
struct V_149 V_150 ;
struct V_1 * V_7 ;
struct V_12 * V_13 ;
struct V_4 * V_5 ;
struct V_151 * V_152 ;
int V_123 ;
V_123 = F_133 ( V_46 , & V_6 , V_146 , & V_150 ) ;
if ( V_123 )
return V_123 ;
V_7 = F_3 ( V_150 . V_5 ) ;
V_13 = & V_7 -> V_15 ;
...
V_150 . V_142 = - 1 ;
if ( V_148 )
* ( T_1 * ) ( ( void * ) V_7 + F_134 ( V_145 ) -> V_143 ) = V_150 . V_142 ;
else
* ( unsigned int * ) ( ( void * ) V_7 + F_134 ( V_145 ) -> V_143 ) = V_150 . V_142 ;
F_79 ( & V_7 -> V_15 ,
L_8 ,
V_7 -> V_55 [ V_50 ] , V_7 -> V_55 [ V_51 ] ,
V_7 -> V_56 [ V_50 ] , V_7 -> V_56 [ V_51 ] ) ;
F_135 (blkg, pos_css, ctx.blkg)
F_50 ( F_3 ( V_5 ) ) ;
F_84 ( V_7 , 0 ) ;
F_84 ( V_7 , 1 ) ;
if ( V_7 -> V_44 & V_75 ) {
...
static T_2 F_137 ( struct V_144 * V_145 ,
char * V_146 , T_3 V_147 , T_4 V_136 )
{
return F_131 ( V_145 , V_146 , V_147 , V_136 , true ) ;
}
static T_2 F_138 ( struct V_144 * V_145 ,
char * V_146 , T_3 V_147 , T_4 V_136 )
{
return F_131 ( V_145 , V_146 , V_147 , V_136 , false ) ;
}
static void F_139 ( struct V_62 * V_43 )
{
struct V_8 * V_9 = V_43 -> V_9 ;
F_140 ( & V_9 -> V_128 ) ;
}
bool F_141 ( struct V_62 * V_43 , struct V_35 * V_35 )
{
struct V_8 * V_9 = V_43 -> V_9 ;
...
static void F_147 ( struct V_12 * V_14 )
{
struct V_1 * V_7 ;
while ( ( V_7 = F_62 ( V_14 ) ) ) {
struct V_12 * V_13 = & V_7 -> V_15 ;
...
F_149 ( V_43 ) ;
F_142 () ;
F_150 (blkg, pos_css, td->queue->root_blkg)
F_147 ( & F_3 ( V_5 ) -> V_15 ) ;
F_147 ( & V_9 -> V_15 ) ;
F_146 () ;
F_24 ( V_43 -> V_124 ) ;
...
int F_151 ( struct V_62 * V_43 )
{
struct V_8 * V_9 ;
int V_123 ;
V_9 = F_152 ( sizeof( * V_9 ) , V_156 , V_43 -> V_33 ) ;
if ( ! V_9 )
return - V_157 ;
F_153 ( & V_9 -> V_128 , F_114 ) ;
F_40 ( & V_9 -> V_15 , NULL ) ;
V_43 -> V_9 = V_9 ;
V_9 -> V_10 = V_43 ;
V_123 = F_154 ( V_43 , & V_6 ) ;
if ( V_123 )
F_155 ( V_9 ) ;
return V_123 ;
}
void F_156 ( struct V_62 * V_43 )
{
F_91 ( ! V_43 -> V_9 ) ;
F_139 ( V_43 ) ;
F_157 ( V_43 , & V_6 ) ;
