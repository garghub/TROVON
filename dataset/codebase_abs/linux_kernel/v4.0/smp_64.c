...
static void * T_6 F_163 ( unsigned int V_46 , T_8 V_209 ,
T_8 V_210 )
{
const unsigned long V_211 = F_40 ( V_212 ) ;
#ifdef F_164
int V_213 = F_165 ( V_46 ) ;
void * V_214 ;
if ( ! F_166 ( V_213 ) || ! F_167 ( V_213 ) ) {
V_214 = F_168 ( V_209 , V_210 , V_211 ) ;
F_169 ( L_35 ,
V_46 , V_213 ) ;
F_170 ( L_36 ,
V_46 , V_209 , F_40 ( V_214 ) ) ;
} else {
V_214 = F_171 ( F_167 ( V_213 ) ,
V_209 , V_210 , V_211 ) ;
F_170 ( L_37
L_38 , V_46 , V_209 , V_213 , F_40 ( V_214 ) ) ;
}
return V_214 ;
#else
return F_168 ( V_209 , V_210 , V_211 ) ;
#endif
}
static void T_6 F_172 ( void * V_214 , T_8 V_209 )
{
F_173 ( F_40 ( V_214 ) , V_209 ) ;
}
static int T_6 F_174 ( unsigned int V_215 , unsigned int V_216 )
{
if ( F_165 ( V_215 ) == F_165 ( V_216 ) )
return V_217 ;
else
return V_218 ;
}
static void T_6 F_175 ( unsigned long V_219 )
{
T_9 * V_152 = F_176 ( V_219 ) ;
T_10 * V_220 ;
T_11 * V_221 ;
if ( F_177 ( * V_152 ) ) {
T_10 * V_222 ;
V_222 = F_168 ( V_223 , V_223 , V_223 ) ;
F_178 ( & V_12 , V_152 , V_222 ) ;
}
V_220 = F_179 ( V_152 , V_219 ) ;
if ( F_180 ( * V_220 ) ) {
T_11 * V_222 ;
V_222 = F_168 ( V_223 , V_223 , V_223 ) ;
F_181 ( & V_12 , V_220 , V_222 ) ;
}
V_221 = F_182 ( V_220 , V_219 ) ;
if ( ! F_183 ( * V_221 ) ) {
T_12 * V_222 ;
V_222 = F_168 ( V_223 , V_223 , V_223 ) ;
F_184 ( & V_12 , V_221 , V_222 ) ;
}
}
void T_6 F_185 ( void )
{
...
if ( V_224 < 0 )
F_25 ( L_41 , V_224 ) ;
V_33 = ( unsigned long ) V_230 - ( unsigned long ) V_231 ;
F_189 (cpu)
F_8 ( V_46 ) = V_33 + V_232 [ V_46 ] ;
V_6 = F_8 ( F_24 () ) ;
F_190 () ;
if ( V_7 == V_8 )
F_191 ( V_233 ) ;
