...
{
struct V_185 * V_230 = V_13 -> V_193 -> V_231 ;
struct V_159 V_203 ;
struct V_204 * V_225 ;
int V_232 = 1 ;
int error = 0 ;
...
V_13 -> V_237 = F_83 ( V_13 , V_13 -> V_198 . V_242 ) ;
error = F_48 ( V_13 , V_13 -> V_198 . V_242 ,
& V_243 ,
V_165 , V_166 ,
& V_13 -> V_244 ) ;
if ( error ) {
...
if ( error ) {
F_41 ( V_13 , L_35 ,
V_13 -> V_237 -> V_220 , error ) ;
goto V_233;
}
F_9 ( & V_13 -> V_238 , V_13 -> V_237 -> V_239 ) ;
F_9 ( & V_13 -> V_240 , 2 * V_13 -> V_237 -> V_239 / 5 ) ;
F_9 ( & V_13 -> V_241 , 4 * V_13 -> V_237 -> V_239 / 5 ) ;
F_84 ( V_13 , V_13 -> V_237 ) ;
}
F_85 ( V_13 , F_86 ( & V_13 -> V_238 ) ) ;
if ( V_13 -> V_198 . V_247 ) {
unsigned int V_122 ;
for ( V_122 = 0 ; V_122 < V_13 -> V_212 ; V_122 ++ ) {
struct V_208 * V_209 = F_83 ( V_13 , V_122 ) ;
if ( V_13 -> V_152 . V_236 ) {
...
F_62 ( V_13 ) ;
} else if ( ! V_13 -> V_152 . V_236 ) {
error = F_87 ( V_13 -> V_237 , true ) ;
if ( error ) {
...
static int F_90 ( struct V_10 * V_13 , int V_161 )
{
int error = 0 ;
struct V_185 * V_230 = V_13 -> V_193 -> V_231 ;
if ( V_161 )
...
if ( error )
goto V_168;
V_13 -> V_252 = F_81 ( V_230 , L_38 ) ;
if ( F_54 ( V_13 -> V_252 ) ) {
error = F_55 ( V_13 -> V_252 ) ;
F_41 ( V_13 , L_39 , error ) ;
goto V_253;
}
V_13 -> V_254 = F_81 ( V_230 , L_40 ) ;
if ( F_54 ( V_13 -> V_254 ) ) {
...
if ( V_161 )
goto V_263;
V_262 = F_81 ( V_230 , L_44 ) ;
if ( F_54 ( V_262 ) ) {
error = F_55 ( V_262 ) ;
F_41 ( V_13 , L_45 , error ) ;
return error ;
}
sprintf ( V_86 , L_46 , V_13 -> V_237 -> V_220 ) ;
V_13 -> V_264 = F_81 ( V_262 , V_86 ) ;
if ( F_54 ( V_13 -> V_264 ) ) {
error = F_55 ( V_13 -> V_264 ) ;
F_41 ( V_13 , L_47 , error ) ;
goto V_168;
}
sprintf ( V_86 , L_48 , V_13 -> V_237 -> V_220 ) ;
V_13 -> V_265 = F_81 ( V_262 , V_86 ) ;
if ( F_54 ( V_13 -> V_265 ) ) {
...
static int F_96 ( struct V_10 * V_13 , int V_71 )
{
...
V_274 -> V_199 = V_272 ;
V_274 -> V_247 = 1 ;
for ( V_277 = args -> V_281 ; ( V_276 = F_99 ( & V_277 , L_56 ) ) ; ) {
T_3 V_282 [ V_283 ] ;
int V_284 , V_285 ;
if ( ! V_276 || ! * V_276 )
continue;
...
sprintf ( V_299 , L_61 , V_13 -> V_152 . V_236 ? 1 : 0 ) ;
F_64 ( & V_13 -> V_201 , V_302 , V_197 ) ;
}
static int F_109 ( struct V_11 * V_12 , struct V_275 * args , int V_71 )
{
struct V_10 * V_13 ;
struct V_159 V_160 ;
int error ;
...
F_110 ( V_12 ) -> V_49 |= V_323 ;
V_12 -> V_324 = 1 ;
V_12 -> V_325 = V_326 ;
V_13 -> V_73 . V_95 = F_111 ( V_12 , V_327 ) ;
...
if ( error )
goto V_340;
if ( V_13 -> V_198 . V_242 < 0 ) {
error = V_13 -> V_198 . V_242 ;
V_13 -> V_198 . V_242 = 0 ;
goto V_340;
}
if ( V_13 -> V_152 . V_236 )
...
static int F_120 ( struct V_11 * V_87 , void * V_343 )
{
V_87 -> V_47 = V_343 ;
V_87 -> V_344 = V_87 -> V_47 -> V_345 ;
V_87 -> V_346 = & F_121 ( V_87 -> V_47 ) -> V_347 ;
return 0 ;
}
static int F_122 ( struct V_11 * V_87 , void * V_348 )
{
struct V_349 * V_350 = V_348 ;
return ( V_350 == V_87 -> V_47 ) ;
}
static struct V_182 * F_123 ( struct V_351 * V_352 , int V_49 ,
...
V_87 = F_126 ( V_352 , F_122 , F_120 , V_49 , V_350 ) ;
F_76 ( & V_350 -> V_358 ) ;
error = F_55 ( V_87 ) ;
if ( F_54 ( V_87 ) )
goto V_361;
...
char V_370 [ V_371 ] ;
V_87 -> V_372 = V_354 ;
F_46 ( V_87 -> V_155 , F_131 ( V_350 , V_370 ) , sizeof( V_87 -> V_155 ) ) ;
F_59 ( V_87 , F_132 ( V_350 ) ) ;
error = F_109 ( V_87 , & args , V_49 & V_373 ? 1 : 0 ) ;
if ( error )
goto V_369;
V_87 -> V_300 |= V_374 ;
V_350 -> V_375 = V_87 ;
...
static int F_135 ( struct V_11 * V_87 , void * V_348 )
{
return - V_78 ;
}
static struct V_182 * F_136 ( struct V_351 * V_352 ,
...
V_87 = F_126 ( & V_378 , F_122 , F_135 , V_49 ,
V_376 . V_182 -> V_231 -> V_379 -> V_47 ) ;
F_138 ( & V_376 ) ;
if ( F_54 ( V_87 ) ) {
F_17 ( L_70 ) ;
return F_125 ( V_87 ) ;
