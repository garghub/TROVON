...
F_12 () ;
V_33 = F_13 ( V_17 [ V_6 ] . V_33 ) ;
V_34 = F_13 ( V_17 [ V_6 ] . V_34 ) ;
V_35 = F_13 ( V_17 [ V_6 ] . V_35 ) ;
V_37 = V_17 [ V_6 ] . V_37 ;
V_36 = V_17 [ V_6 ] . V_36 ;
V_27 = F_14 ( V_17 [ V_6 ] . V_27 ) ;
V_29 = & V_17 [ V_6 ] . V_29 [ 0 ] ;
V_8 = F_4 ( V_15 , & V_17 [ V_6 ] , V_16 ) ;
if ( F_13 ( V_17 [ V_6 ] . V_8 ) != V_8 ) {
F_15 ( V_2 , L_1 ,
V_6 , V_8 , F_13 ( V_17 [ V_6 ] . V_8 ) ) ;
F_16 ( & V_17 [ V_6 ] , V_6 ) ;
return 1 ;
}
if ( V_33 == 0 ) {
...
int V_45 = F_14 ( V_17 [ V_6 ] . V_27 ) ;
int V_46 = F_14 ( V_17 [ V_32 ] . V_27 ) ;
if ( V_45 > 0 && V_45 == V_46 &&
...
return 0 ;
V_39:
F_15 ( V_2 , L_5 , V_6 , V_7 ) ;
F_16 ( & V_17 [ V_6 ] , V_6 ) ;
return - V_47 ;
}
static int F_18 ( struct V_1 * V_2 , struct V_48 * V_49 ,
int V_50 , void * V_17 )
{
int V_7 , V_51 = 0 ;
struct V_52 * V_53 ;
...
V_53 -> V_35 = F_5 ( 0 ) ;
V_53 -> V_65 = F_5 ( V_50 ) ;
V_53 -> V_66 = F_24 ( ++ V_49 -> V_67 ) ;
V_7 = F_25 ( V_2 , V_55 -> V_68 , V_53 ) ;
if ( V_7 )
goto V_69;
V_7 = F_26 ( V_2 , V_17 , V_55 -> V_68 , 0 , V_2 -> V_19 ) ;
if ( V_7 )
goto V_69;
V_7 = F_27 ( V_2 , V_49 , V_55 -> V_68 , V_55 -> V_70 , V_53 , 0 ) ;
F_28 ( V_49 -> V_71 , V_55 ) ;
F_29 ( V_2 , V_53 ) ;
return V_7 ;
V_69:
if ( V_7 == - V_72 && ++ V_51 <= 5 ) {
F_30 ( & V_55 -> V_73 . V_74 , & V_49 -> V_75 ) ;
goto V_58;
}
F_28 ( V_49 -> V_71 , V_55 ) ;
V_59:
...
static struct V_4 * F_31 ( struct V_1 * V_2 ,
struct V_48 * V_49 ,
struct V_76 * V_77 )
{
int V_7 ;
...
int V_82 [ V_18 ] = { 1 , 1 } ;
F_19 ( L_7 ) ;
F_32 (rb, aeb, &av->root, u.rb) {
V_81 [ V_80 -> V_65 ] = F_33 ( V_2 -> V_19 ) ;
if ( ! V_81 [ V_80 -> V_65 ] ) {
V_7 = - V_57 ;
goto V_59;
}
V_7 = F_34 ( V_2 , V_81 [ V_80 -> V_65 ] , V_80 -> V_68 , 0 ,
V_2 -> V_19 ) ;
if ( V_7 == V_83 || F_35 ( V_7 ) )
V_80 -> V_84 = 1 ;
else if ( V_7 )
goto V_59;
}
...
static struct V_4 * F_40 ( struct V_1 * V_2 ,
struct V_48 * V_49 )
{
int V_6 ;
struct V_4 * V_17 ;
...
for ( V_6 = 0 ; V_6 < V_2 -> V_11 ; V_6 ++ ) {
F_12 () ;
if ( F_13 ( V_17 [ V_6 ] . V_33 ) == 0 )
continue;
V_24 = F_42 ( sizeof( struct V_9 ) , V_56 ) ;
if ( ! V_24 )
return - V_57 ;
V_24 -> V_33 = F_13 ( V_17 [ V_6 ] . V_33 ) ;
V_24 -> V_34 = F_13 ( V_17 [ V_6 ] . V_34 ) ;
V_24 -> V_35 = F_13 ( V_17 [ V_6 ] . V_35 ) ;
V_24 -> V_37 = V_17 [ V_6 ] . V_37 ;
V_24 -> V_36 = V_17 [ V_6 ] . V_36 == V_42 ?
V_85 : V_86 ;
V_24 -> V_27 = F_14 ( V_17 [ V_6 ] . V_27 ) ;
...
if ( ! V_77 ) {
if ( V_49 -> V_109 ) {
V_2 -> V_17 = F_40 ( V_2 , V_49 ) ;
if ( F_22 ( V_2 -> V_17 ) )
return F_23 ( V_2 -> V_17 ) ;
} else {
F_15 ( V_2 , L_20 ) ;
return - V_47 ;
}
...
V_2 -> V_17 = F_31 ( V_2 , V_49 , V_77 ) ;
if ( F_22 ( V_2 -> V_17 ) )
return F_23 ( V_2 -> V_17 ) ;
}
V_2 -> V_100 = V_2 -> V_44 - V_2 -> V_101 ;
V_7 = F_41 ( V_2 , V_49 , V_2 -> V_17 ) ;
if ( V_7 )
goto V_59;
V_7 = F_48 ( V_2 , V_49 ) ;
if ( V_7 )
