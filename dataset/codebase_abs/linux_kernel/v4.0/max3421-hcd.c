...
V_103 -> V_239 = 0x29 ;
V_103 -> V_240 = 9 ;
V_103 -> V_241 = F_98 ( V_242 |
V_243 ) ;
V_103 -> V_244 = 1 ;
}
static void
F_99 ( struct V_5 * V_6 , T_3 V_245 , T_3 V_246 )
{
struct V_4 * V_4 = F_2 ( V_6 ) ;
T_3 V_247 , V_248 ;
-- V_245 ;
...
static int
F_100 ( struct V_5 * V_6 , T_2 V_249 , T_2 V_246 , T_2 V_250 ,
char * V_28 , T_2 V_251 )
{
struct V_9 * V_10 = F_6 ( V_6 -> V_11 . V_12 ) ;
struct V_4 * V_4 = F_2 ( V_6 ) ;
...
V_285 = V_4 ;
F_82 ( & V_4 -> V_102 ) ;
V_4 -> V_17 = F_110 ( sizeof( * V_4 -> V_17 ) , V_286 ) ;
if ( ! V_4 -> V_17 ) {
F_26 ( & V_10 -> V_30 , L_24 ) ;
goto error;
}
V_4 -> V_24 = F_110 ( sizeof( * V_4 -> V_24 ) , V_286 ) ;
if ( ! V_4 -> V_24 ) {
F_26 ( & V_10 -> V_30 , L_25 ) ;
goto error;
}
...
{
struct V_4 * V_4 = NULL , * * V_288 ;
struct V_5 * V_6 = NULL ;
unsigned long V_98 ;
for ( V_288 = & V_285 ; * V_288 ; V_288 = & ( * V_288 ) -> V_284 ) {
V_4 = * V_288 ;
V_6 = F_3 ( V_4 ) ;
