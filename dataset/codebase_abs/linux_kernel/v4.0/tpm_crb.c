...
if ( V_11 -> V_48 . V_49 < sizeof( struct V_40 ) ) {
F_11 ( V_29 , L_4 ) ;
return - V_50 ;
}
...
V_41 = F_2 ( V_11 -> V_53 ) ;
if ( V_41 == V_54 || V_41 == V_55 ||
! strcmp ( F_25 ( V_39 ) , L_6 ) )
V_4 -> V_32 |= V_33 ;
if ( V_41 == V_56 || V_41 == V_55 )
V_4 -> V_32 |= V_34 ;
V_4 -> V_7 = (struct V_57 V_58 * )
F_26 ( V_29 , V_11 -> V_59 , 0x1000 ) ;
if ( ! V_4 -> V_7 ) {
F_11 ( V_29 , L_7 ) ;
return - V_52 ;
}
