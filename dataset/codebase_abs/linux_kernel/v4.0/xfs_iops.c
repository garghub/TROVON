...
V_56 = V_54 -> V_42 -> V_43 ;
F_6 ( & V_57 , V_52 , V_56 ) ;
F_6 ( & V_58 , V_54 , V_52 -> V_42 -> V_43 ) ;
return F_48 ( F_2 ( V_51 ) , & V_57 , F_2 ( V_52 -> V_42 ) ,
F_2 ( V_53 ) , & V_58 ,
V_55 ? F_2 ( V_55 ) : NULL , V_32 ) ;
}
STATIC void *
F_49 (
struct V_15 * V_15 ,
...
char * V_63 ;
int error = - V_64 ;
V_63 = F_50 ( V_65 + 1 , V_66 ) ;
if ( ! V_63 )
goto V_67;
error = F_51 ( F_2 ( V_15 -> V_42 ) , V_63 ) ;
if ( F_12 ( error ) )
goto V_68;
F_52 ( V_62 , V_63 ) ;
return NULL ;
...
V_72 -> ctime = V_1 -> V_94 ;
V_72 -> V_95 =
F_58 ( V_74 , V_6 -> V_80 . V_96 + V_6 -> V_97 ) ;
switch ( V_1 -> V_43 & V_20 ) {
case V_98 :
case V_99 :
V_72 -> V_100 = V_101 ;
V_72 -> V_23 = F_59 ( F_60 ( V_6 -> V_102 . V_103 . V_104 ) & 0x1ff ,
F_61 ( V_6 -> V_102 . V_103 . V_104 ) ) ;
break;
default:
if ( F_62 ( V_6 ) ) {
V_72 -> V_100 =
F_63 ( V_6 ) << V_74 -> V_45 . V_105 ;
} else
V_72 -> V_100 = F_64 ( V_74 ) ;
V_72 -> V_23 = 0 ;
break;
}
return 0 ;
...
if ( F_56 ( V_74 ) )
return - V_76 ;
error = F_70 ( V_1 , V_106 ) ;
if ( error )
return error ;
}
ASSERT ( ( V_123 & V_138 ) == 0 ) ;
if ( F_71 ( V_74 ) && ( V_123 & ( V_139 | V_140 ) ) ) {
T_7 V_141 = 0 ;
if ( ( V_123 & V_139 ) && F_72 ( V_74 ) ) {
V_84 = V_106 -> V_142 ;
V_141 |= V_143 ;
} else {
V_84 = V_1 -> V_85 ;
}
if ( ( V_123 & V_140 ) && F_73 ( V_74 ) ) {
V_86 = V_106 -> V_144 ;
V_141 |= V_145 ;
} else {
V_86 = V_1 -> V_87 ;
...
V_124 = F_78 ( V_74 , V_146 ) ;
error = F_79 ( V_124 , & F_80 ( V_74 ) -> V_147 , 0 , 0 ) ;
if ( error )
goto V_148;
F_81 ( V_6 , V_108 ) ;
...
if ( F_82 ( V_74 ) &&
( ( F_72 ( V_74 ) && ! F_83 ( V_126 , V_84 ) ) ||
( F_73 ( V_74 ) && ! F_84 ( V_128 , V_86 ) ) ) ) {
ASSERT ( V_124 ) ;
error = F_85 ( V_124 , V_6 , V_130 , V_131 ,
NULL , F_86 ( V_149 ) ?
V_150 : 0 ) ;
if ( error )
goto V_151;
...
if ( ! F_83 ( V_126 , V_84 ) ) {
if ( F_82 ( V_74 ) && F_72 ( V_74 ) ) {
ASSERT ( V_123 & V_139 ) ;
ASSERT ( V_130 ) ;
V_132 = F_88 ( V_124 , V_6 ,
& V_6 -> V_155 , V_130 ) ;
}
V_6 -> V_80 . V_156 = F_75 ( V_84 ) ;
V_1 -> V_85 = V_84 ;
}
if ( ! F_84 ( V_128 , V_86 ) ) {
if ( F_82 ( V_74 ) && F_73 ( V_74 ) ) {
ASSERT ( F_89 ( & V_74 -> V_45 ) ||
! F_90 ( V_74 ) ) ;
ASSERT ( V_123 & V_140 ) ;
ASSERT ( V_131 ) ;
V_133 = F_88 ( V_124 , V_6 ,
& V_6 -> V_157 , V_131 ) ;
}
V_6 -> V_80 . V_158 = F_76 ( V_86 ) ;
V_1 -> V_87 = V_86 ;
}
}
if ( V_123 & V_159 )
...
if ( error )
return error ;
ASSERT ( F_66 ( V_6 , V_169 ) ) ;
ASSERT ( F_100 ( V_6 -> V_80 . V_81 ) ) ;
ASSERT ( ( V_106 -> V_109 & ( V_139 | V_140 | V_110 | V_170 |
V_171 | V_172 | V_173 ) ) == 0 ) ;
V_163 = V_1 -> V_174 ;
V_164 = V_106 -> V_175 ;
if ( V_164 == 0 && V_163 == 0 && V_6 -> V_80 . V_176 == 0 ) {
if ( ! ( V_106 -> V_109 & ( V_117 | V_120 ) ) )
return 0 ;
V_106 -> V_109 &= ~ V_138 ;
return F_68 ( V_6 , V_106 , 0 ) ;
}
error = F_101 ( V_6 , 0 ) ;
if ( error )
return error ;
if ( V_164 > V_163 ) {
error = F_102 ( V_6 , V_164 , V_163 , & V_168 ) ;
if ( error )
return error ;
}
if ( V_164 > V_6 -> V_80 . V_177 &&
( V_163 != V_6 -> V_80 . V_177 || V_168 ) ) {
error = F_103 ( F_19 ( V_6 ) -> V_178 ,
V_6 -> V_80 . V_177 , V_164 ) ;
if ( error )
return error ;
}
F_104 ( V_1 ) ;
error = F_105 ( V_1 -> V_178 , V_164 , V_179 ) ;
if ( error )
return error ;
F_106 ( V_1 , V_164 ) ;
if ( V_164 > V_163 && F_107 ( F_19 ( V_6 ) -> V_178 ) ) {
error = F_103 (
F_19 ( V_6 ) -> V_178 ,
F_108 ( V_163 , V_180 ) ,
F_109 ( V_163 , V_180 ) - 1 ) ;
...
V_124 = F_78 ( V_74 , V_181 ) ;
error = F_79 ( V_124 , & F_80 ( V_74 ) -> V_182 , 0 , 0 ) ;
if ( error )
goto V_151;
V_167 = V_183 ;
V_166 |= V_108 ;
...
F_91 ( V_124 , V_6 , V_160 ) ;
if ( V_164 <= V_163 ) {
error = F_111 ( & V_124 , V_6 , V_184 , V_164 ) ;
if ( error )
goto V_185;
F_112 ( V_6 , V_186 ) ;
F_113 ( V_6 ) ;
...
T_7 V_189 = V_169 ;
F_81 ( V_6 , V_189 ) ;
error = F_115 ( V_15 -> V_42 , & V_189 ) ;
if ( ! error )
error = F_99 ( V_6 , V_106 ) ;
F_95 ( V_6 , V_189 ) ;
} else {
error = F_68 ( V_6 , V_106 , 0 ) ;
}
return error ;
}
STATIC int
...
int error ;
F_117 ( V_6 ) ;
V_124 = F_78 ( V_74 , V_192 ) ;
error = F_79 ( V_124 , & F_80 ( V_74 ) -> V_193 , 0 , 0 ) ;
if ( error ) {
F_98 ( V_124 , 0 ) ;
return error ;
}
...
F_87 ( V_124 , V_6 , V_108 ) ;
F_91 ( V_124 , V_6 , V_198 ) ;
return F_94 ( V_124 , 0 ) ;
}
STATIC int
F_118 (
...
if ( V_201 -> V_209 == - 1LL )
return 0 ;
V_206 = F_119 ( V_201 -> V_210 ) ;
V_207 = F_119 ( V_201 -> V_209 ) ;
V_208 = F_119 ( V_201 -> V_211 ) ;
...
struct V_200 V_221 ;
int error ;
error = F_122 ( V_204 , V_222 ) ;
if ( error )
return error ;
V_221 . V_210 = F_123 ( V_220 ) ;
if ( V_208 == V_223 )
V_221 . V_211 = - 1LL ;
else
V_221 . V_211 = F_124 ( V_220 + V_208 ) - V_221 . V_210 ;
V_221 . V_224 = ! V_204 -> V_225 ? V_226 :
V_204 -> V_225 + 1 ;
V_221 . V_224 = F_125 ( V_227 , V_221 . V_224 ,
...
V_221 . V_229 |= V_236 ;
error = F_126 ( V_6 , & V_221 , F_118 , V_204 ) ;
if ( error )
return error ;
return 0 ;
}
...
F_130 ( V_1 ) ;
F_131 ( & V_1 -> V_251 ) ;
V_1 -> V_43 = V_6 -> V_80 . V_81 ;
F_132 ( V_1 , V_6 -> V_80 . V_83 ) ;
V_1 -> V_85 = F_133 ( V_6 -> V_80 . V_156 ) ;
V_1 -> V_87 = F_134 ( V_6 -> V_80 . V_158 ) ;
switch ( V_1 -> V_43 & V_20 ) {
case V_98 :
case V_99 :
V_1 -> V_252 =
F_59 ( F_60 ( V_6 -> V_102 . V_103 . V_104 ) & 0x1ff ,
F_61 ( V_6 -> V_102 . V_103 . V_104 ) ) ;
break;
default:
V_1 -> V_252 = 0 ;
...
F_136 ( & V_6 -> V_257 . V_258 , & V_259 ) ;
switch ( V_1 -> V_43 & V_20 ) {
case V_260 :
V_1 -> V_261 = & V_262 ;
V_1 -> V_263 = & V_264 ;
V_1 -> V_178 -> V_265 = & V_266 ;
break;
case V_33 :
F_136 ( & V_6 -> V_257 . V_258 , & V_267 ) ;
...
default:
V_1 -> V_261 = & V_262 ;
F_137 ( V_1 , V_1 -> V_43 , V_1 -> V_252 ) ;
break;
}
V_248 = F_138 ( V_1 -> V_178 ) ;
F_139 ( V_1 -> V_178 , ( V_248 & ~ ( V_275 ) ) ) ;
if ( ! F_140 ( V_6 ) ) {
F_141 ( V_1 ) ;
F_142 ( V_1 ) ;
}
