...
return 0 ;
V_6 -> V_2 = V_27 ;
sprintf ( V_6 -> V_2 . V_28 , L_4 , V_27 . V_28 ,
...
int V_83 = 4 ;
while ( V_20 > 0 ) {
V_82 = ( V_20 > V_83 ) ? V_83 : V_20 ;
V_80 = F_25 ( V_6 , V_3 , V_79 , V_82 ) ;
if ( V_80 > 0 ) {
V_20 -= V_82 ;
V_79 += V_82 ;
V_81 += V_82 ;
} else
return ( V_80 < 0 ) ? V_80 : - V_84 ;
}
return V_81 ;
}
...
while ( V_20 > 0 ) {
V_82 = ( V_20 > 3 ) ? 4 : V_20 ;
V_80 = F_23 ( V_6 , V_3 , V_85 , V_82 ) ;
if ( V_80 > 0 ) {
for ( V_7 = 0 ; V_7 < V_20 ; V_7 ++ )
V_9 [ V_86 + V_7 ] = V_85 [ V_7 ] ;
V_20 -= V_82 ;
V_86 += V_82 ;
} else
return ( V_80 < 0 ) ? V_80 : - V_84 ;
