...
V_12 -> V_15 = F_118 (
sizeof( struct V_28 ) * ( V_12 -> V_32 + 1 ) , V_162 ) ;
if ( ! V_12 -> V_15 ) {
F_3 (KERN_ERR DEV_LABEL L_77 ,
dev->number) ;
error = - V_163 ;
...
V_40 -> V_46 ) ;
if ( ! F_123 ( V_318 , & V_40 -> V_254 ) ) {
V_41 = F_118 ( sizeof( struct V_41 ) , V_162 ) ;
...
static int F_125 ( struct V_39 * V_40 , struct V_319 * V_118 , int V_320 )
{
struct V_12 * V_12 = F_6 ( V_40 -> V_19 ) ;
...
static int F_127 ( struct V_18 * V_19 , unsigned int V_332 , void T_5 * V_333 )
{
struct V_12 * V_12 = F_6 ( V_19 ) ;
if ( V_332 == V_334 ) {
if ( ! F_128 ( V_335 ) ) return - V_336 ;
...
if ( V_332 == V_342 ) {
struct V_343 V_344 ;
if ( F_129 ( & V_344 , V_333 , sizeof( struct V_343 ) ) )
return - V_341 ;
...
static int F_130 ( struct V_39 * V_40 , int V_348 , int V_349 ,
...
static int F_132 ( struct V_39 * V_40 , struct V_55 * V_56 )
{
enum V_168 V_202 ;
F_9 ( L_160 ) ;
if ( ! F_7 ( V_40 ) -> V_21 ) {
...
* ( T_2 * ) V_56 -> V_67 = F_134 ( * ( T_2 * ) V_56 -> V_67 ) ;
}
V_352 ++ ;
F_23 ( V_56 ) -> V_40 = V_40 ;
...
static void F_135 ( struct V_18 * V_19 , unsigned char V_354 ,
unsigned long V_355 )
{
F_29 ( V_354 , F_6 ( V_19 ) -> V_249 + V_355 * 4 ) ;
}
static unsigned char F_136 ( struct V_18 * V_19 , unsigned long V_355 )
{
return F_16 ( F_6 ( V_19 ) -> V_249 + V_355 * 4 ) ;
}
static int F_137 ( struct V_18 * V_19 , T_6 * V_356 , char * V_357 )
{
struct V_358 * V_1 ;
...
static int F_145 ( struct V_66 * V_66 ,
...
if ( V_370 < 0 )
goto V_300;
V_370 = F_147 ( & V_66 -> V_19 , F_148 ( 32 ) ) ;
if ( V_370 < 0 )
goto V_300;
V_370 = - V_163 ;
V_12 = F_118 ( sizeof( struct V_12 ) , V_162 ) ;
if ( ! V_12 )
goto V_371;
V_185 = & V_12 -> V_185 ;
V_185 -> V_355 = F_149 ( & V_66 -> V_19 ,
V_372 , & V_185 -> V_61 , V_162 ) ;
if ( ! V_185 -> V_355 )
goto V_373;
V_19 = F_150 ( V_91 , & V_66 -> V_19 , & V_374 , - 1 , NULL ) ;
if ( ! V_19 )
goto V_375;
V_19 -> V_316 = V_12 ;
F_151 ( V_66 , V_19 ) ;
...
F_152 ( V_19 ) ;
V_375:
F_153 ( & V_66 -> V_19 , V_372 , V_185 -> V_355 , V_185 -> V_61 ) ;
V_373:
F_119 ( V_12 ) ;
V_371:
F_154 ( V_66 ) ;
...
static void F_155 ( struct V_66 * V_381 )
{
struct V_18 * V_19 = F_156 ( V_381 ) ;
struct V_12 * V_301 = F_6 ( V_19 ) ;
struct V_369 * V_185 = & V_301 -> V_185 ;
F_111 ( V_19 ) ;
F_152 ( V_19 ) ;
F_153 ( & V_381 -> V_19 , V_372 , V_185 -> V_355 , V_185 -> V_61 ) ;
F_119 ( V_301 ) ;
F_154 ( V_381 ) ;
}
...
{
struct V_55 * V_56 ;
if ( sizeof( V_56 -> V_132 ) < sizeof( struct V_133 ) ) {
F_3 ( V_382 L_186 ,
sizeof( V_56 -> V_132 ) , sizeof( struct V_133 ) ) ;
return - V_271 ;
}
return F_158 ( & V_383 ) ;
}
