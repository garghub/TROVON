...
{
struct V_8 * V_9 = & V_10 -> V_9 ;
F_252 ( V_10 -> V_1 -> V_58 . V_84 , V_9 -> V_39 . V_261 [ V_432 ] ,
V_9 -> V_39 . V_261 [ V_457 ] ) ;
F_253 ( V_9 , V_9 -> V_39 . V_261 [ V_457 ] ) ;
V_10 -> V_71 = F_34 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
{
F_255 ( V_10 -> V_1 -> V_58 . V_84 , V_10 -> V_9 . V_39 . V_261 [ V_457 ] ) ;
F_176 ( & V_10 -> V_9 , V_216 ) ;
return 1 ;
}
...
T_1 V_145 = F_258 ( & V_10 -> V_9 , V_432 ) ;
if ( F_259 ( & V_10 -> V_9 , V_145 , V_476 ) == 0 ) {
V_10 -> V_71 = F_34 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
}
return 1 ;
...
if ( V_479 != V_496 )
V_481 = - 1 ;
if ( F_261 ( & V_10 -> V_9 , V_477 , V_481 , V_478 ,
V_79 , V_80 ) == V_498 ) {
...
F_253 ( & V_10 -> V_9 , V_10 -> V_1 -> V_2 . V_371 ) ;
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
bool F_270 ( struct V_7 * V_10 , unsigned long V_97 )
{
...
if ( V_513 >= 16 ) {
if ( ! F_277 ( & V_10 -> V_9 , V_513 - 16 ) )
return 1 ;
V_97 = F_258 ( & V_10 -> V_9 , V_308 ) ;
F_278 ( & V_10 -> V_9 , V_513 - 16 , V_97 ) ;
} else {
if ( ! F_277 ( & V_10 -> V_9 , V_513 ) )
return 1 ;
F_279 ( & V_10 -> V_9 , V_513 , & V_97 ) ;
F_113 ( & V_10 -> V_9 , V_308 , V_97 ) ;
}
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
...
struct V_376 * V_376 = V_10 -> V_9 . V_377 ;
int V_141 ;
T_4 V_514 = F_275 ( & V_10 -> V_9 ) ;
V_141 = F_271 ( V_10 ) ;
if ( F_281 ( V_10 -> V_9 . V_278 ) )
return V_141 ;
if ( V_514 <= F_275 ( & V_10 -> V_9 ) )
return V_141 ;
V_376 -> V_380 = V_515 ;
return 0 ;
}
static T_2 F_282 ( struct V_8 * V_9 , T_2 V_516 )
{
...
static void F_307 ( struct V_8 * V_9 , T_2 * V_552 , T_2 * V_553 )
{
...
if ( F_7 ( V_9 ) ) {
int V_417 ;
F_309 ( V_10 -> V_1 -> V_58 . V_84 , V_407 ,
V_10 -> V_1 -> V_2 . V_371 ,
V_10 -> V_1 -> V_2 . V_369 ,
V_10 -> V_1 -> V_2 . V_449 ,
V_10 -> V_1 -> V_2 . V_450 ,
...
static inline void F_316 ( struct V_7 * V_10 , int V_562 )
{
struct V_11 * V_2 ;
V_2 = & V_10 -> V_1 -> V_2 ;
V_2 -> V_448 = V_562 ;
...
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_72 ( ! ( F_20 ( V_10 ) ) ) ;
F_318 ( V_9 -> V_39 . V_565 . V_78 ) ;
++ V_9 -> V_301 . V_566 ;
V_10 -> V_1 -> V_2 . V_90 = V_9 -> V_39 . V_565 . V_78 |
V_63 | V_64 ;
}
static void F_319 ( struct V_8 * V_9 , int V_567 , int V_568 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_320 ( struct V_8 * V_9 , bool V_569 )
{
return;
}
static int F_321 ( struct V_278 * V_278 )
{
return 0 ;
}
static void F_322 ( struct V_8 * V_9 , T_2 * V_570 )
{
return;
}
...
static bool F_325 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
return ! ! ( V_10 -> V_9 . V_39 . V_40 & V_560 ) ;
}
static void F_326 ( struct V_8 * V_9 , bool V_571 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( V_571 ) {
V_10 -> V_9 . V_39 . V_40 |= V_560 ;
...
static int F_327 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
struct V_1 * V_1 = V_10 -> V_1 ;
int V_65 ;
...
static int F_330 ( struct V_278 * V_278 , unsigned int V_50 )
{
return 0 ;
}
...
static inline void F_333 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
T_2 V_574 ;
if ( F_7 ( V_9 ) && ( V_9 -> V_39 . V_40 & V_422 ) )
...
F_336 ( & V_10 -> V_9 , V_576 , V_96 ) ;
} else
F_337 ( & V_10 -> V_9 , V_576 ) ;
break;
case V_495 :
F_338 ( & V_10 -> V_9 , V_576 , false ) ;
break;
default:
break;
}
...
F_341 ( V_10 -> V_1 -> V_2 . V_407 , V_9 , V_452 ) ;
...
F_332 ( V_9 ) ;
V_10 -> V_71 = 0 ;
V_10 -> V_1 -> V_2 . V_360 = V_580 ;
if ( V_10 -> V_1 -> V_2 . V_407 == V_418 + V_215 )
V_10 -> V_370 = F_344 () ;
if ( V_55 ) {
V_9 -> V_39 . V_581 &= ~ ( 1 << V_309 ) ;
...
static void F_346 ( struct V_8 * V_9 , unsigned long V_403 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_401 = V_403 ;
F_3 ( V_10 -> V_1 , V_404 ) ;
...
static void
F_348 ( struct V_8 * V_9 , unsigned char * V_585 )
{
V_585 [ 0 ] = 0x0f ;
V_585 [ 1 ] = 0x01 ;
V_585 [ 2 ] = 0xd9 ;
}
static void F_349 ( void * V_586 )
{
* ( int * ) V_586 = 0 ;
}
...
static T_2 F_351 ( struct V_8 * V_9 , T_11 V_587 , bool V_588 )
{
return 0 ;
}
...
static void F_353 ( T_1 V_589 , struct V_590 * V_591 )
{
switch ( V_589 ) {
case 0x80000001 :
if ( V_17 )
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_417 , V_65 = V_600 ;
struct V_601 V_602 ;
struct V_1 * V_1 = V_10 -> V_1 ;
if ( V_61 -> V_22 >= F_311 ( V_603 ) )
goto V_284;
V_602 = V_603 [ V_61 -> V_22 ] ;
if ( V_599 != V_602 . V_599 )
goto V_284;
switch ( V_602 . V_407 ) {
case V_437 :
if ( V_61 -> V_22 == V_604 )
V_602 . V_407 += V_61 -> V_605 ;
break;
case V_606 : {
...
static void F_363 ( struct V_8 * V_9 , int V_140 )
{
}
static int T_5 F_364 ( void )
{
return F_365 ( & V_628 , sizeof( struct V_7 ) ,
F_366 ( struct V_7 ) , V_629 ) ;
}
