...
static int T_9 F_134 ( struct V_133 * V_134 )
{
...
T_4 V_94 ;
int V_140 ;
V_159 = F_135 ( V_134 , V_160 , 0 ) ;
if ( ! V_159 )
return - V_128 ;
V_15 = F_120 ( & V_134 -> V_19 , sizeof( * V_15 ) , V_132 ) ;
if ( ! V_15 )
return - V_143 ;
if ( ! F_136 ( & V_134 -> V_19 , V_159 -> V_161 , F_137 ( V_159 ) ,
F_126 ( & V_134 -> V_19 ) ) )
return - V_162 ;
V_15 -> V_16 = F_138 ( & V_134 -> V_19 , V_159 -> V_161 , F_137 ( V_159 ) ) ;
if ( ! V_15 -> V_16 )
return - V_143 ;
...
V_94 |= F_139 ( V_139 -> V_149 ) ;
F_117 ( V_15 , V_95 , V_94 ) ;
F_128 ( V_134 , V_15 ) ;
return 0 ;
}
static int F_140 ( struct V_133 * V_134 )
{
...
static void F_141 ( struct V_133 * V_134 )
{
struct V_14 * V_15 = F_122 ( V_134 ) ;
F_116 ( V_15 ) ;
}
