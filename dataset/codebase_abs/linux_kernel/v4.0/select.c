...
static int F_65 ( unsigned int V_134 , struct V_135 * V_136 ,
...
struct V_135 * V_138 ;
bool V_95 = false ;
for ( V_138 = V_136 ; V_138 != NULL ; V_138 = V_138 -> V_32 ) {
struct V_126 * V_139 , * V_140 ;
V_139 = V_138 -> V_31 ;
V_140 = V_139 + V_138 -> V_141 ;
for (; V_139 != V_140 ; V_139 ++ ) {
if ( F_64 ( V_139 , V_15 , & V_95 ,
V_86 ) ) {
V_137 ++ ;
V_15 -> V_89 = NULL ;
V_86 = 0 ;
...
int F_66 ( struct V_126 T_5 * V_142 , unsigned int V_134 ,
struct V_1 * V_55 )
{
struct V_13 V_19 ;
int V_143 = - V_116 , V_144 , V_141 , V_112 ;
long V_145 [ V_146 / sizeof( long ) ] ;
struct V_135 * const V_147 = (struct V_135 * ) V_145 ;
struct V_135 * V_138 = V_147 ;
unsigned long V_148 = V_134 ;
if ( V_134 > F_67 ( V_149 ) )
return - V_54 ;
V_141 = F_68 (unsigned int, nfds, N_STACK_PPS) ;
for (; ; ) {
V_138 -> V_32 = NULL ;
V_138 -> V_141 = V_141 ;
if ( ! V_141 )
break;
if ( F_60 ( V_138 -> V_31 , V_142 + V_134 - V_148 ,
sizeof( struct V_126 ) * V_138 -> V_141 ) )
goto V_150;
V_148 -= V_138 -> V_141 ;
if ( ! V_148 )
break;
V_141 = F_69 ( V_148 , V_151 ) ;
V_112 = sizeof( struct V_135 ) + sizeof( struct V_126 ) * V_141 ;
V_138 = V_138 -> V_32 = F_54 ( V_112 , V_35 ) ;
if ( ! V_138 ) {
V_143 = - V_36 ;
goto V_150;
}
...
F_7 ( & V_19 ) ;
V_144 = F_65 ( V_134 , V_147 , & V_19 , V_55 ) ;
F_12 ( & V_19 ) ;
for ( V_138 = V_147 ; V_138 ; V_138 = V_138 -> V_32 ) {
struct V_126 * V_66 = V_138 -> V_31 ;
int V_102 ;
for ( V_102 = 0 ; V_102 < V_138 -> V_141 ; V_102 ++ , V_142 ++ )
if ( F_70 ( V_66 [ V_102 ] . V_133 , & V_142 -> V_133 ) )
goto V_150;
}
V_143 = V_144 ;
V_150:
...
{
struct V_126 T_5 * V_142 = V_153 -> V_108 . V_142 ;
int V_134 = V_153 -> V_108 . V_134 ;
