...
return;
V_2 -> V_63 = * V_71 ;
V_2 -> V_39 -> V_80 -> V_81 ( V_2 , * V_71 ) ;
}
static void F_44 ( void * V_27 , T_3 * V_82 ,
struct V_44 * V_26 )
{
struct V_45 * V_46 = F_30 ( V_26 ) ;
if ( V_26 -> type != V_57 &&
...
int F_46 ( struct V_28 * V_19 , struct V_88 * V_42 ,
bool V_89 )
{
struct V_1 * V_2 = V_19 -> V_30 ;
...
V_2 -> V_19 , V_91 ,
F_44 , V_2 ) ;
F_48 ( V_2 -> V_19 , & V_2 -> V_92 ) ;
return 0 ;
}
static void F_49 ( struct V_93 * V_94 , T_3 * V_95 , T_3 V_96 )
{
if ( V_96 > V_97 )
memcpy ( V_94 -> V_95 ,
& V_95 [ V_97 ] ,
...
int F_50 ( struct V_28 * V_19 , enum V_102 V_103 ,
...
V_94 . V_113 = F_53 ( V_2 , V_26 ) ;
V_94 . V_114 = F_54 ( V_95 ) ;
if ( V_94 . V_114 == V_115 )
return - V_109 ;
if ( V_94 . V_114 == V_116 && F_55 ( V_2 ) )
return - V_109 ;
V_94 . V_103 = V_103 ;
if ( V_42 ) {
...
V_94 . V_117 = V_105 ;
if ( V_94 . V_114 == V_116 )
F_49 ( & V_94 , & V_95 -> V_95 [ 0 ] , V_95 -> V_111 ) ;
else
memcpy ( V_94 . V_95 , & V_95 -> V_95 [ 0 ] , V_95 -> V_111 ) ;
if ( V_103 == V_119 )
V_95 -> V_120 = 0 ;
if ( V_95 -> V_15 & V_110 )
F_51 = V_2 -> V_39 -> V_80 -> V_121 ;
else
F_51 = V_2 -> V_39 -> V_80 -> V_122 ;
if ( ! F_51 )
return - V_109 ;
return F_51 ( V_2 , & V_94 , V_95 ) ;
}
int F_57 ( struct V_28 * V_19 , struct V_44 * V_26 ,
struct V_88 * V_42 )
{
struct V_1 * V_2 = V_19 -> V_30 ;
struct V_107 * V_108 = F_56 ( V_42 ) ;
if ( V_2 -> V_39 -> V_80 -> V_123 ( V_2 , V_26 , V_42 ) )
V_108 -> V_118 = - 1 ;
return 0 ;
}
...
if ( V_108 -> V_118 < 0 )
return 0 ;
return V_2 -> V_39 -> V_80 -> V_124 ( V_2 , V_108 -> V_118 ) ;
}
