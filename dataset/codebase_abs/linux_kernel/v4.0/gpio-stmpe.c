...
struct V_2 * V_21 ,
unsigned V_4 , unsigned V_48 )
{
struct V_1 * V_1 = F_1 ( V_21 ) ;
struct V_5 * V_5 = V_1 -> V_5 ;
const char * V_49 = F_22 ( V_21 , V_4 ) ;
int V_33 = F_17 ( V_5 -> V_34 , 8 ) ;
bool V_11 = ! ! F_3 ( V_21 , V_4 ) ;
T_1 V_50 = V_5 -> V_7 [ V_15 ] - ( V_4 / 8 ) ;
T_1 V_9 = 1 << ( V_4 % 8 ) ;
int V_10 ;
T_1 V_51 ;
V_10 = F_4 ( V_5 , V_50 ) ;
...
T_1 V_52 = V_5 -> V_7 [ V_53 ] + V_33 - 1 - ( V_4 / 8 ) ;
T_1 V_54 = V_5 -> V_7 [ V_36 ] - ( V_4 / 8 ) ;
T_1 V_55 = V_5 -> V_7 [ V_37 ] - ( V_4 / 8 ) ;
T_1 V_56 = V_5 -> V_7 [ V_39 ] - ( V_4 / 8 ) ;
bool V_57 ;
bool V_58 ;
bool V_59 ;
bool V_60 ;
...
static void F_24 ( struct V_46 * V_47 , struct V_2 * V_21 )
{
unsigned V_40 ;
...
unsigned int V_70 = V_1 -> V_7 [ V_38 ] [ V_69 ] ;
...
int V_73 = F_28 ( V_1 -> V_3 . V_74 ,
line ) ;
F_29 ( V_73 ) ;
V_71 &= ~ ( 1 << V_72 ) ;
}
F_7 ( V_5 , V_65 + V_40 , V_67 [ V_40 ] ) ;
if ( V_5 -> V_26 != V_27 )
F_7 ( V_5 , V_5 -> V_7 [ V_53 ]
+ V_40 , V_67 [ V_40 ] ) ;
}
return V_75 ;
}
...
int V_63 = 0 ;
V_63 = F_32 ( V_77 , 0 ) ;
V_1 = F_33 ( sizeof( struct V_1 ) , V_82 ) ;
if ( ! V_1 )
return - V_83 ;
F_34 ( & V_1 -> V_32 ) ;
V_1 -> V_64 = & V_77 -> V_64 ;
V_1 -> V_5 = V_5 ;
V_1 -> V_3 = V_84 ;
V_1 -> V_3 . V_62 = V_5 -> V_34 ;
V_1 -> V_3 . V_64 = & V_77 -> V_64 ;
V_1 -> V_3 . V_81 = V_80 ;
V_1 -> V_3 . V_61 = - 1 ;
if ( F_35 ( V_85 ) )
V_1 -> V_3 . V_86 = F_24 ;
