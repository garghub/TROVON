...
if ( V_42 < 0 )
goto V_107;
V_40 -> V_13 . type = & V_108 ;
F_28 ( & V_40 -> V_13 ) ;
V_40 -> V_13 . V_47 = V_109 ;
...
if ( V_40 -> V_75 ) {
V_111 . V_112 . V_113 |= V_100 ;
V_111 . V_114 = & F_54 ;
}
if ( V_40 -> V_72 ) {
V_111 . V_112 . V_113 |= V_101 ;
V_111 . V_115 = & F_52 ;
}
V_42 = F_32 ( & V_40 -> V_13 , & V_111 ) ;
if ( V_42 ) {
F_23 ( 1 , L_33 ) ;
goto V_116;
}
}
for ( V_21 = 0 ; V_21 < V_40 -> V_117 ; V_21 ++ ) {
struct V_52 * V_25 = V_40 -> V_118 [ V_21 ] ;
if ( ! V_25 -> V_22 )
continue;
#ifdef F_80
F_23 ( 1 , L_34 , V_21 ) ;
if ( V_119 >= 1 ) {
int V_120 ;
for ( V_120 = 0 ; V_120 < V_40 -> V_63 ; V_120 ++ )
F_64 ( V_121 L_16 ,
V_83 [ V_40 -> V_64 [ V_120 ] . type ] ,
V_25 -> V_122 [ V_120 ] ) ;
F_64 ( V_121 L_35 ) ;
}
#endif
