...
V_39 = F_61 ( V_66 ) ;
memset ( V_39 , 0 , sizeof( * V_39 ) ) ;
V_24 = F_66 ( V_39 , V_81 . V_84 -> V_88 . V_89 ) ;
if ( V_24 < 0 ) {
F_6 ( V_78 ) ;
goto V_76;
}
...
if ( ! F_69 ( & V_55 , V_9 ) )
return - V_10 ;
V_24 = F_49 ( V_2 -> V_82 [ V_90 ] , V_55 ) ;
if ( V_24 < 0 )
goto V_49;
V_24 = F_42 ( V_2 -> V_91 , V_55 , REGISTER ) ;
V_49:
F_70 ( V_55 ) ;
return V_24 ;
}
...
if ( ! F_69 ( & V_55 , V_9 ) )
return - V_10 ;
V_24 = F_49 ( V_2 -> V_82 [ V_92 ] , V_55 ) ;
if ( V_24 < 0 )
goto V_49;
V_24 = F_42 ( V_2 -> V_91 , V_55 , V_93 ) ;
V_49:
F_70 ( V_55 ) ;
return V_24 ;
}
...
int V_24 ;
V_6 = F_72 () ;
V_24 = F_1 ( V_2 , V_94 , & V_78 , V_6 ) ;
if ( V_24 < 0 )
return V_24 ;
V_24 = - V_14 ;
V_29 = F_63 ( V_2 -> V_82 [ V_95 ] ) ;
...
return V_24 ;
V_24 = - V_14 ;
V_46 = F_63 ( V_2 -> V_82 [ V_96 ] ) ;
V_39 = F_54 ( V_78 , V_97 , V_46 ) ;
if ( ! V_39 )
goto V_76;
V_24 = F_37 ( V_46 , V_39 ) ;
if ( V_24 < 0 )
...
if ( V_2 -> V_82 [ V_90 ] )
return F_68 ( V_2 ) ;
else if ( V_2 -> V_82 [ V_92 ] )
return F_71 ( V_2 ) ;
else if ( V_2 -> V_82 [ V_95 ] )
return F_73 ( V_2 ) ;
else if ( V_2 -> V_82 [ V_96 ] )
return F_74 ( V_2 ) ;
else
return - V_14 ;
}
...
{
struct V_98 * V_99 = V_37 -> signal ;
struct V_38 * V_39 ;
if ( V_99 -> V_39 || F_77 ( V_37 ) )
goto V_53;
V_39 = F_78 ( V_100 , V_9 ) ;
F_79 ( & V_37 -> V_51 -> V_52 ) ;
if ( ! V_99 -> V_39 ) {
...
void F_82 ( struct V_36 * V_37 , int V_101 )
{
int V_24 ;
struct V_17 * V_18 ;
struct V_38 * V_39 ;
...
{
unsigned int V_105 ;
V_100 = F_88 ( V_38 , V_106 ) ;
F_89 (i) {
F_90 ( & ( F_47 ( V_63 , V_105 ) . V_27 ) ) ;
F_91 ( & ( F_47 ( V_63 , V_105 ) . V_26 ) ) ;
}
}
static int T_6 F_92 ( void )
{
int V_24 ;
V_24 = F_93 ( & V_13 , V_107 ) ;
if ( V_24 )
return V_24 ;
V_103 = 1 ;
F_94 ( L_1 , V_108 ) ;
