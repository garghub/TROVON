...
F_95 ( V_140 , L_12 , F_96 ( & V_29 -> V_15 ) ) ;
return 0 ;
}
static int F_97 ( struct V_143 * V_143 ,
struct V_144 * V_144 )
{
return F_98 ( V_144 , F_94 , F_99 ( V_143 ) ) ;
}
static void F_61 ( struct V_7 * V_29 )
{
char V_145 [ 64 ] ;
snprintf ( V_145 , sizeof( V_145 ) , L_13 , V_29 -> V_93 ) ;
F_100 ( V_145 , 0444 , V_29 -> type -> V_146 ,
& V_147 , V_29 ) ;
}
...
if ( V_29 )
F_95 ( V_148 , L_14 , V_29 -> type -> V_50 , V_29 -> V_93 ) ;
}
return V_151 ;
}
void F_103 ( struct V_152 * V_153 )
{
int V_80 ;
for ( V_80 = 0 ; V_80 < V_81 ; ++ V_80 ) {
...
continue;
if ( V_154 == NULL )
V_154 = F_104 ( L_15 , V_153 ) ;
V_25 -> V_146 = F_104 ( V_25 -> V_50 , V_154 ) ;
}
}
static long F_105 ( struct V_144 * V_144 , unsigned int V_155 , unsigned long V_156 )
{
struct V_7 * V_29 = V_144 -> V_157 ;
int V_158 = F_106 ( V_144 -> V_159 -> V_160 ) ;
struct V_24 * V_25 ;
if ( F_107 ( V_155 ) != V_161 )
return - V_21 ;
F_108 ( V_81 != V_162 ) ;
F_108 ( V_81 !=
...
static long F_114 ( struct V_144 * V_144 ,
unsigned int V_155 , unsigned long V_156 )
{
return F_105 ( V_144 , V_155 , ( unsigned long ) F_115 ( V_156 ) ) ;
}
static int F_116 ( struct V_144 * V_144 , T_5 V_169 )
{
struct V_7 * V_29 = V_144 -> V_157 ;
...
static int F_118 ( struct V_143 * V_143 , struct V_144 * V_144 )
{
F_90 ( V_144 -> V_157 ) ;
return 0 ;
}
...
int V_85 ;
T_6 V_172 ;
V_85 = F_120 ( & V_172 , 0 , V_81 , L_15 ) ;
if ( V_85 < 0 )
return V_85 ;
F_121 ( & V_173 , & V_174 ) ;
V_85 = F_122 ( & V_173 , V_172 , V_81 ) ;
if ( V_85 < 0 )
return V_85 ;
return 0 ;
}
