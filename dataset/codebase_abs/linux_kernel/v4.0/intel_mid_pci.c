...
if ( ! V_43 )
return;
if ( F_6 ( V_32 -> V_2 -> V_10 , V_32 -> V_3 , V_44 ) )
return;
V_32 -> V_45 = 0 ;
}
...
F_25 ( V_32 , V_16 + 8 + ( V_47 * 4 ) , & V_17 ) ;
V_32 -> V_50 [ V_47 ] . V_51 = V_32 -> V_50 [ V_47 ] . V_52 + V_17 - 1 ;
V_32 -> V_50 [ V_47 ] . V_53 |= V_54 ;
}
}
