...
F_10 ( L_5 ,
V_26 -> V_33 -> V_38 , V_6 -> V_30 ) ;
return 0 ;
} else if ( V_6 && ( V_6 -> type & V_34 ) ) {
F_9 ( & V_26 -> V_37 , & V_6 -> V_11 ) ;
V_26 -> V_6 = V_6 ;
V_21 = V_6 ;
while ( V_21 ) {
...
F_10 ( L_6 ,
V_26 -> V_33 -> V_38 , V_6 -> V_30 , V_6 -> V_21 -> V_30 ) ;
return 0 ;
}
...
static void * F_33 ( void * V_12 , void * V_23 )
{
struct V_3 * V_6 = (struct V_3 * ) V_12 ;
int V_42 = * ( ( int * ) V_23 ) ;
struct V_25 * V_26 , * V_27 ;
...
void F_35 ( struct V_3 * V_6 , int V_42 )
{
F_15 ( V_6 , F_33 , & V_42 ) ;
}
...
void F_37 ( struct V_3 * V_6 , int V_55 )
{
F_16 ( V_6 , F_36 , & V_55 ) ;
}
...
void F_39 ( struct V_3 * V_6 , int V_42 )
{
F_15 ( V_6 , F_38 , & V_42 ) ;
}
...
void F_49 ( struct V_3 * V_6 )
{
F_16 ( V_6 , F_47 , NULL ) ;
}
const char * F_50 ( struct V_3 * V_6 )
{
struct V_91 * V_92 = F_51 ( V_6 ) ;
struct V_32 * V_33 = F_52 ( V_92 ) ;
const char * V_93 = NULL ;
if ( ! V_33 )
goto V_94;
if ( F_53 ( V_92 ) ) {
V_93 = F_54 ( V_33 , L_17 , NULL ) ;
if ( ! V_93 )
V_93 = F_54 ( V_33 , L_18 , NULL ) ;
if ( V_93 )
goto V_94;
V_33 = V_33 -> V_10 ;
if ( ! V_33 )
...
V_93 = F_54 ( V_33 , L_17 , NULL ) ;
if ( ! V_93 )
V_93 = F_54 ( V_33 , L_19 , NULL ) ;
V_94:
return V_93 ? V_93 : L_20 ;
}
struct V_91 * F_51 ( struct V_3 * V_6 )
{
...
V_26 = F_55 ( & V_6 -> V_11 , struct V_25 , V_37 ) ;
V_48 = F_34 ( V_26 ) ;
if ( V_48 )
V_92 = V_48 -> V_92 ;
}
