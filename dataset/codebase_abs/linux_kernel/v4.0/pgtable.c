...
void F_53 ( struct V_1 * V_2 , T_6 * V_17 )
{
F_44 ( V_2 , V_17 ) ;
F_30 ( V_17 ) ;
F_54 ( V_2 , V_17 ) ;
...
T_1 V_43 , int V_44 )
{
int V_45 = ! F_56 ( * V_42 , V_43 ) ;
if ( V_45 && V_44 ) {
* V_42 = V_43 ;
F_57 ( V_41 -> V_46 , V_3 , V_42 ) ;
}
return V_45 ;
}
int F_58 ( struct V_40 * V_41 ,
unsigned long V_3 , T_4 * V_47 ,
T_4 V_43 , int V_44 )
{
int V_45 = ! F_59 ( * V_47 , V_43 ) ;
F_60 ( V_3 & ~ V_48 ) ;
if ( V_45 && V_44 ) {
* V_47 = V_43 ;
F_61 ( V_41 -> V_46 , V_3 , V_47 ) ;
}
return V_45 ;
}
...
( unsigned long * ) V_47 ) ;
if ( V_50 )
F_68 ( V_41 -> V_46 , V_49 , V_47 ) ;
return V_50 ;
}
int F_69 ( struct V_40 * V_41 ,
unsigned long V_3 , T_1 * V_42 )
{
return F_62 ( V_41 , V_3 , V_42 ) ;
}
...
int V_52 ;
F_60 ( V_3 & ~ V_48 ) ;
V_52 = F_66 ( V_41 , V_3 , V_47 ) ;
if ( V_52 )
F_71 ( V_41 , V_3 , V_3 + V_53 ) ;
return V_52 ;
}
void F_72 ( struct V_40 * V_41 ,
unsigned long V_3 , T_4 * V_47 )
{
int V_54 ;
F_60 ( V_3 & ~ V_48 ) ;
...
( unsigned long * ) V_47 ) ;
if ( V_54 ) {
F_68 ( V_41 -> V_46 , V_3 , V_47 ) ;
F_71 ( V_41 , V_3 , V_3 + V_53 ) ;
}
}
void T_3 F_74 ( unsigned long V_56 )
{
#ifdef F_75
F_76 ( V_57 > 0 ) ;
V_58 = F_77 ( - V_56 , 1 << V_59 ) - V_60 ;
F_78 ( V_61 L_2 ,
- V_56 , V_58 + V_60 ) ;
#endif
}
void F_79 ( enum V_62 V_63 , T_1 V_6 )
{
unsigned long V_3 = F_80 ( V_63 ) ;
if ( V_63 >= V_64 ) {
F_81 () ;
return;
}
...
void F_83 ( enum V_62 V_63 , T_7 V_65 ,
T_8 V_66 )
{
F_79 ( V_63 , F_84 ( V_65 >> V_14 , V_66 ) ) ;
}
