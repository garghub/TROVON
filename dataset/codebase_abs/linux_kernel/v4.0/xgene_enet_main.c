...
if ( ! strcasecmp ( V_172 , F_98 ( V_5 ) ) )
return V_5 ;
}
return - V_170 ;
}
static int F_99 ( struct V_37 * V_38 )
{
struct V_174 * V_141 ;
struct V_15 * V_16 ;
struct V_17 * V_18 ;
...
V_18 = & V_141 -> V_18 ;
V_16 = V_38 -> V_16 ;
V_176 = F_100 ( V_141 , V_178 , V_179 ) ;
if ( ! V_176 ) {
F_79 ( V_18 , L_10 ) ;
return - V_170 ;
}
V_38 -> V_177 = F_101 ( V_18 , V_176 -> V_180 , F_102 ( V_176 ) ) ;
if ( ! V_38 -> V_177 ) {
F_79 ( V_18 , L_11 ) ;
return - V_26 ;
}
V_176 = F_100 ( V_141 , V_178 , V_181 ) ;
if ( ! V_176 ) {
F_79 ( V_18 , L_12 ) ;
return - V_170 ;
}
V_38 -> V_182 = F_101 ( V_18 , V_176 -> V_180 ,
F_102 ( V_176 ) ) ;
if ( ! V_38 -> V_182 ) {
F_79 ( V_18 , L_13 ) ;
return - V_26 ;
}
V_176 = F_100 ( V_141 , V_178 , V_183 ) ;
if ( ! V_176 ) {
F_79 ( V_18 , L_14 ) ;
return - V_170 ;
}
V_38 -> V_146 = F_101 ( V_18 , V_176 -> V_180 ,
F_102 ( V_176 ) ) ;
if ( ! V_38 -> V_146 ) {
F_79 ( V_18 , L_15 ) ;
return - V_26 ;
...
V_38 -> V_160 = V_62 ;
if ( F_94 ( V_18 , V_16 -> V_185 ) != V_171 )
F_104 ( V_16 ) ;
memcpy ( V_16 -> V_186 , V_16 -> V_185 , V_16 -> V_187 ) ;
V_38 -> V_124 = F_96 ( V_18 ) ;
if ( V_38 -> V_124 < 0 ) {
F_79 ( V_18 , L_17 ) ;
return V_38 -> V_124 ;
}
...
V_38 -> V_190 = F_105 ( & V_141 -> V_18 , NULL ) ;
if ( F_106 ( V_38 -> V_190 ) ) {
V_38 -> V_190 = NULL ;
}
V_177 = V_38 -> V_177 ;
V_38 -> V_191 = V_177 + V_192 ;
V_38 -> V_193 = V_177 + V_194 ;
V_38 -> V_195 = V_177 + V_196 ;
if ( V_38 -> V_124 == V_125 ||
V_38 -> V_124 == V_188 ) {
V_38 -> V_197 = V_177 + V_198 ;
V_38 -> V_199 = V_177 + V_200 ;
} else {
V_38 -> V_197 = V_177 + V_201 ;
V_38 -> V_199 = V_177 + V_202 ;
}
V_38 -> V_203 = V_204 ;
return 0 ;
}
...
V_2 = V_38 -> V_55 -> V_2 ;
F_1 ( V_2 ) ;
V_62 = F_4 ( V_2 , V_38 -> V_203 ) ;
if ( V_62 ) {
F_77 ( V_38 ) ;
return V_62 ;
}
V_10 = F_15 ( V_38 -> V_55 ) ;
V_38 -> V_205 -> V_206 ( V_38 , V_10 , V_2 -> V_145 ) ;
V_38 -> V_117 -> V_207 ( V_38 ) ;
return V_62 ;
}
...
static int F_109 ( struct V_174 * V_141 )
{
struct V_15 * V_16 ;
struct V_37 * V_38 ;
...
goto V_158;
V_56 = & V_38 -> V_55 -> V_56 ;
F_117 ( V_16 , V_56 , F_56 , V_221 ) ;
V_117 = V_38 -> V_117 ;
if ( V_38 -> V_124 == V_125 )
V_62 = F_118 ( V_38 ) ;
else
F_119 ( & V_38 -> V_127 , V_117 -> V_222 ) ;
return V_62 ;
V_158:
F_120 ( V_16 ) ;
F_121 ( V_16 ) ;
...
static int F_122 ( struct V_174 * V_141 )
{
struct V_37 * V_38 ;
struct V_121 * V_117 ;
struct V_15 * V_16 ;
