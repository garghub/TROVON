...
static void T_1 F_72 ( struct V_5 * V_6 )
{
struct V_1 * V_54 = F_3 ( V_6 ) ;
struct V_2 * V_65 = & V_54 -> V_4 ;
F_73 ( V_65 ) ;
...
static void T_1 F_76 ( struct V_107 * V_108 )
{
struct V_1 * V_54 = V_108 -> V_33 ;
struct V_2 * V_65 = & V_54 -> V_4 ;
F_73 ( V_65 ) ;
...
{
struct V_1 * V_54 ;
V_54 = F_78 ( & V_6 -> V_7 , sizeof( * V_54 ) , V_109 ) ;
if ( ! V_54 )
return - V_110 ;
V_54 -> V_6 = V_6 ;
F_79 ( & V_6 -> V_7 , V_54 ) ;
...
static int T_1 F_81 ( struct V_5 * V_6 )
{
F_72 ( V_6 ) ;
return 0 ;
}
...
int T_3 F_86 ( struct V_5 * V_6 , struct V_107 * V_108 )
{
struct V_1 * V_54 ;
struct V_107 * V_112 ;
T_2 V_113 ;
...
if ( ! V_54 )
return - V_110 ;
V_112 = F_87 ( V_108 , NULL ) ;
if ( ! V_112 )
return 0 ;
V_61 = F_75 ( V_112 , L_18 , & V_113 ) ;
if ( V_61 ) {
F_36 ( L_19 ) ;
goto V_114;
}
...
void T_1 F_89 ( struct V_107 * V_108 )
{
struct V_1 * V_54 = V_108 -> V_33 ;
if ( ! V_54 -> V_115 )
return;
