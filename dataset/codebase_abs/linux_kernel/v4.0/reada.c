...
{
struct V_46 * V_51 = F_47 ( V_79 , struct V_46 , V_24 ) ;
F_45 ( & V_51 -> V_59 -> V_55 ,
V_51 -> V_54 >> V_19 ) ;
F_20 ( V_51 ) ;
}
...
{
struct V_35 * V_36 = F_47 ( V_79 , struct V_35 ,
V_24 ) ;
F_20 ( V_36 ) ;
}
...
V_47 -> V_86 = V_13 -> V_48 + V_15 -> V_89 -> V_71 ;
V_13 -> V_24 ++ ;
F_5 ( & V_15 -> V_22 ) ;
for ( V_9 = 0 ; V_9 < V_13 -> V_69 ; ++ V_9 ) {
...
return 0 ;
F_48 ( & V_47 -> V_44 ) ;
V_45 = F_53 ( V_15 -> V_90 , V_48 ,
V_87 , & V_4 ) ;
if ( V_45 )
F_1 ( V_15 -> V_90 , NULL , V_48 , V_45 ) ;
else if ( V_4 )
F_1 ( V_15 -> V_90 , V_4 , V_4 -> V_5 , V_45 ) ;
if ( V_4 )
F_54 ( V_4 ) ;
return 1 ;
}
...
struct V_14 * V_15 ;
int V_95 ;
V_94 = F_47 ( V_92 , struct V_93 , V_92 ) ;
V_15 = V_94 -> V_15 ;
F_20 ( V_94 ) ;
V_95 = F_56 ( F_57 ( V_96 ) ,
F_58 ( V_96 ) ) ;
...
{
struct V_93 * V_94 ;
V_94 = F_33 ( sizeof( * V_94 ) , V_57 ) ;
if ( ! V_94 ) {
F_62 () ;
}
F_63 ( & V_94 -> V_92 , V_103 ,
F_55 , NULL , NULL ) ;
V_94 -> V_15 = V_15 ;
F_64 ( V_15 -> V_104 , & V_94 -> V_92 ) ;
}
static void F_65 ( struct V_14 * V_15 , int V_105 )
{
struct V_20 * V_59 ;
struct V_98 * V_99 = V_15 -> V_99 ;
unsigned long V_18 ;
...
V_51 -> V_58 ) ;
for ( V_106 = 0 ; V_106 < V_51 -> V_63 ; ++ V_106 ) {
F_66 ( V_110 L_6 ,
V_51 -> V_61 [ V_106 ] -> V_109 ) ;
}
if ( V_59 -> V_85 == V_51 )
F_66 ( V_110 L_7 ,
V_59 -> V_86 - V_51 -> V_5 ) ;
...
V_13 -> V_74 [ V_9 ] -> V_5 ,
V_13 -> V_74 [ V_9 ] -> V_54 ) ;
for ( V_106 = 0 ; V_106 < V_13 -> V_74 [ V_9 ] -> V_63 ; ++ V_106 ) {
F_66 ( V_110 L_6 ,
V_13 -> V_74 [ V_9 ] -> V_61 [ V_106 ] -> V_109 ) ;
}
}
F_66 ( V_110 L_8 ) ;
...
V_11 = F_8 ( V_111 ) ;
F_54 ( V_111 ) ;
if ( F_16 ( V_36 , V_5 , & V_112 , V_7 , V_11 ) ) {
F_20 ( V_36 ) ;
return F_68 ( - V_114 ) ;
}
F_28 ( V_2 -> V_15 ) ;
