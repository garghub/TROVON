...
T_3 V_49 )
{
return F_87 ( V_25 , V_15 , V_16 , V_123 , NULL ,
NULL , V_49 ) ;
}
int F_96 ( struct V_24 * V_25 , T_1 V_15 , T_1 V_16 ,
struct V_1 * * V_97 , T_3 V_49 )
{
return F_87 ( V_25 , V_15 , V_16 , V_120 , NULL ,
V_97 , V_49 ) ;
}
int F_97 ( struct V_24 * V_25 , T_1 V_15 , T_1 V_16 ,
struct V_1 * * V_97 , T_3 V_49 )
{
return F_68 ( V_25 , V_15 , V_16 , V_120 , 0 , 0 ,
V_97 , V_49 ) ;
}
...
T_1 V_115 ;
while ( 1 ) {
V_95 = F_86 ( V_25 , V_15 , V_16 , V_124 | V_80 ,
V_124 , & V_115 ,
V_97 , V_125 ) ;
if ( V_95 == - V_84 ) {
F_81 ( V_25 , V_115 , V_16 , V_124 ) ;
V_15 = V_115 ;
} else
break;
F_41 ( V_15 > V_16 ) ;
...
int V_95 ;
T_1 V_115 ;
V_95 = F_86 ( V_25 , V_15 , V_16 , V_124 , V_124 ,
& V_115 , NULL , V_125 ) ;
if ( V_95 == - V_84 ) {
if ( V_115 > V_15 )
...
{
return F_68 ( V_25 , V_15 , V_16 , V_124 , 1 , 0 , V_98 ,
V_49 ) ;
}
int F_102 ( struct V_24 * V_25 , T_1 V_15 , T_1 V_16 )
{
return F_68 ( V_25 , V_15 , V_16 , V_124 , 1 , 0 , NULL ,
V_125 ) ;
}
...
if ( F_123 ( V_25 , V_15 , V_16 , V_120 , 1 , NULL ) )
F_137 ( V_129 ) ;
}
...
static int F_189 ( int V_273 , struct V_24 * V_25 , struct V_129 * V_129 ,
unsigned long V_56 , T_10 V_277 , struct V_41 * V_41 ,
unsigned long V_217 )
{
int V_74 = 0 ;
if ( V_25 -> V_46 && V_25 -> V_46 -> V_278 )
V_74 = V_25 -> V_46 -> V_278 ( V_273 , V_129 , V_56 , V_277 , V_41 ,
V_217 ) ;
F_72 ( V_74 < 0 ) ;
return V_74 ;
}
static int F_190 ( int V_273 , struct V_24 * V_25 ,
struct V_129 * V_129 , T_11 V_179 ,
T_10 V_277 , unsigned long V_56 ,
struct V_264 * V_194 ,
struct V_41 * * V_279 ,
unsigned long V_280 ,
T_6 V_281 ,
...
int V_283 ;
int V_161 = 0 ;
int V_284 = V_217 & V_220 ;
int V_285 = V_282 & V_220 ;
T_10 V_286 = F_117 ( T_10 , V_277 , V_149 ) ;
if ( V_279 && * V_279 ) {
V_41 = * V_279 ;
if ( V_285 )
V_161 = V_41 -> V_188 . V_193 == V_179 ;
else
V_161 = F_191 ( V_41 ) == V_179 ;
if ( V_282 != V_217 || ! V_161 ||
F_189 ( V_273 , V_25 , V_129 , V_56 , V_286 , V_41 , V_217 ) ||
F_146 ( V_41 , V_129 , V_286 , V_56 ) < V_286 ) {
...
V_283 = F_192 ( V_194 ) ;
V_41 = F_181 ( V_194 , V_179 , V_283 , V_125 | V_288 ) ;
if ( ! V_41 )
return - V_36 ;
F_146 ( V_41 , V_129 , V_286 , V_56 ) ;
V_41 -> V_228 = V_281 ;
V_41 -> V_231 = V_25 ;
if ( V_279 )
* V_279 = V_41 ;
...
T_1 V_15 , T_1 V_21 , T_12 * V_290 ,
struct V_212 * * V_291 )
{
struct V_212 * V_213 ;
if ( V_291 && * V_291 ) {
V_213 = * V_291 ;
if ( F_200 ( V_213 ) && V_15 >= V_213 -> V_15 &&
V_15 < F_201 ( V_213 ) ) {
F_82 ( & V_213 -> V_17 ) ;
return V_213 ;
}
...
V_213 = V_290 ( V_26 , V_129 , V_173 , V_15 , V_21 , 0 ) ;
if ( V_291 && ! F_202 ( V_213 ) ) {
F_72 ( * V_291 ) ;
F_82 ( & V_213 -> V_17 ) ;
* V_291 = V_213 ;
}
...
int V_74 ;
int V_283 = 0 ;
int V_297 = * V_217 & V_298 ;
T_10 V_173 = 0 ;
T_10 V_299 ;
T_10 V_300 ;
T_10 V_301 = V_26 -> V_33 -> V_302 ;
unsigned long V_303 = * V_217 & V_298 ;
F_198 ( V_129 ) ;
V_16 = V_292 ;
if ( ! F_204 ( V_129 ) ) {
if ( F_205 ( V_129 ) == 0 ) {
...
if ( V_129 -> V_126 == V_295 >> V_127 ) {
char * V_304 ;
T_10 V_305 = V_295 & ( V_149 - 1 ) ;
if ( V_305 ) {
V_299 = V_149 - V_305 ;
V_304 = F_206 ( V_129 ) ;
memset ( V_304 + V_305 , 0 , V_299 ) ;
F_207 ( V_129 ) ;
F_208 ( V_304 ) ;
}
}
while ( V_293 <= V_16 ) {
unsigned long V_306 = ( V_295 >> V_127 ) + 1 ;
if ( V_293 >= V_295 ) {
char * V_304 ;
struct V_1 * V_98 = NULL ;
V_299 = V_149 - V_173 ;
V_304 = F_206 ( V_129 ) ;
memset ( V_304 + V_173 , 0 , V_299 ) ;
F_207 ( V_129 ) ;
F_208 ( V_304 ) ;
F_96 ( V_25 , V_293 , V_293 + V_299 - 1 ,
& V_98 , V_125 ) ;
if ( ! V_297 )
F_101 ( V_25 , V_293 ,
V_293 + V_299 - 1 ,
...
V_213 = F_199 ( V_26 , V_129 , V_173 , V_293 ,
V_16 - V_293 + 1 , V_290 , V_291 ) ;
if ( F_202 ( V_213 ) ) {
F_128 ( V_129 ) ;
if ( ! V_297 )
F_102 ( V_25 , V_293 , V_16 ) ;
break;
}
V_294 = V_293 - V_213 -> V_15 ;
F_72 ( F_201 ( V_213 ) <= V_293 ) ;
F_72 ( V_16 < V_293 ) ;
if ( F_164 ( V_219 , & V_213 -> V_7 ) ) {
V_303 |= V_220 ;
F_165 ( & V_303 ,
...
V_299 = F_131 ( F_201 ( V_213 ) - V_293 , V_16 - V_293 + 1 ) ;
V_296 = F_131 ( F_201 ( V_213 ) - 1 , V_16 ) ;
V_299 = F_209 ( V_299 , V_301 ) ;
if ( V_303 & V_220 ) {
V_300 = V_213 -> V_307 ;
V_179 = V_213 -> V_218 >> 9 ;
} else {
V_179 = ( V_213 -> V_218 + V_294 ) >> 9 ;
V_300 = V_299 ;
}
V_194 = V_213 -> V_194 ;
V_218 = V_213 -> V_218 ;
if ( F_164 ( V_308 , & V_213 -> V_7 ) )
V_218 = V_309 ;
F_163 ( V_213 ) ;
V_213 = NULL ;
if ( V_218 == V_309 ) {
...
F_96 ( V_25 , V_293 , V_293 + V_299 - 1 ,
& V_98 , V_125 ) ;
F_101 ( V_25 , V_293 , V_293 + V_299 - 1 ,
& V_98 , V_125 ) ;
V_293 = V_293 + V_299 ;
V_173 += V_299 ;
continue;
}
if ( F_123 ( V_25 , V_293 , V_296 ,
V_120 , 1 , NULL ) ) {
F_135 ( V_25 , V_129 ) ;
if ( ! V_297 )
F_102 ( V_25 , V_293 , V_293 + V_299 - 1 ) ;
V_293 = V_293 + V_299 ;
V_173 += V_299 ;
continue;
}
...
static inline void F_211 ( struct V_24 * V_25 ,
...
F_203 ( V_25 , V_138 [ V_126 ] , V_290 , V_291 , V_41 ,
V_174 , V_217 , V_273 ) ;
F_106 ( V_138 [ V_126 ] ) ;
}
}
...
int V_314 = 0 ;
for ( V_126 = 0 ; V_126 < V_139 ; V_126 ++ ) {
V_313 = F_136 ( V_138 [ V_126 ] ) ;
if ( ! V_16 ) {
V_15 = V_313 ;
V_16 = V_15 + V_149 - 1 ;
V_314 = V_126 ;
} else if ( V_16 + 1 == V_313 ) {
V_16 += V_149 ;
} else {
F_211 ( V_25 , & V_138 [ V_314 ] ,
V_126 - V_314 , V_15 ,
V_16 , V_290 , V_291 ,
V_41 , V_174 , V_217 ,
V_273 ) ;
...
F_211 ( V_25 , & V_138 [ V_314 ] ,
V_126 - V_314 , V_15 ,
V_16 , V_290 , V_291 , V_41 ,
V_174 , V_217 , V_273 ) ;
}
static int F_216 ( struct V_24 * V_25 ,
struct V_129 * V_129 ,
T_12 * V_290 ,
struct V_41 * * V_41 , int V_174 ,
unsigned long * V_217 , int V_273 )
...
V_74 = F_203 ( V_25 , V_129 , V_290 , NULL , V_41 , V_174 ,
V_217 , V_273 ) ;
return V_74 ;
}
int F_218 ( struct V_24 * V_25 , struct V_129 * V_129 ,
T_12 * V_290 , int V_174 )
{
struct V_41 * V_41 = NULL ;
unsigned long V_217 = 0 ;
int V_74 ;
V_74 = F_216 ( V_25 , V_129 , V_290 , & V_41 , V_174 ,
& V_217 , V_315 ) ;
if ( V_41 )
V_74 = F_185 ( V_315 , V_41 , V_174 , V_217 ) ;
return V_74 ;
}
...
{
V_317 -> V_319 -= V_318 ;
if ( V_317 -> V_320 || ( V_317 -> V_319 > 0 &&
V_317 -> V_321 == 0 && V_317 -> V_322 == V_323 ) )
V_129 -> V_28 -> V_324 = V_129 -> V_126 + V_318 ;
}
static T_13 int F_221 ( struct V_26 * V_26 ,
struct V_129 * V_129 , struct V_316 * V_317 ,
struct V_325 * V_326 ,
T_1 V_141 ,
unsigned long * V_318 )
{
struct V_24 * V_25 = V_326 -> V_25 ;
T_1 V_292 = V_141 + V_149 - 1 ;
T_1 V_327 ;
T_1 V_328 = 0 ;
T_1 V_142 = 0 ;
int V_74 ;
int V_329 = 0 ;
if ( V_326 -> V_330 || ! V_25 -> V_46 || ! V_25 -> V_46 -> V_331 )
return 0 ;
while ( V_142 < V_292 ) {
V_327 = F_122 ( V_26 , V_25 ,
V_129 ,
& V_141 ,
& V_142 ,
V_332 ) ;
...
V_74 = V_25 -> V_46 -> V_331 ( V_26 , V_129 ,
V_141 ,
V_142 ,
& V_329 ,
V_318 ) ;
...
if ( V_317 -> V_319 < V_328 ) {
int V_333 = 8192 ;
if ( V_328 < V_333 * 2 )
V_333 = V_328 ;
V_317 -> V_319 = F_117 ( T_1 , V_328 ,
V_333 ) ;
}
if ( V_329 ) {
V_317 -> V_319 -= * V_318 ;
...
int V_283 = 0 ;
bool V_336 ;
if ( V_25 -> V_46 && V_25 -> V_46 -> V_337 ) {
V_74 = V_25 -> V_46 -> V_337 ( V_129 , V_15 ,
V_292 ) ;
if ( V_74 ) {
if ( V_74 == - V_338 )
V_317 -> V_339 ++ ;
...
F_223 ( V_317 , V_129 ) ;
F_220 ( V_129 , V_317 , V_318 ) ;
F_118 ( V_129 ) ;
V_74 = 1 ;
goto V_340;
}
}
F_220 ( V_129 , V_317 , V_318 + 1 ) ;
V_16 = V_292 ;
if ( V_261 <= V_15 ) {
if ( V_25 -> V_46 && V_25 -> V_46 -> V_245 )
...
V_301 = V_26 -> V_33 -> V_302 ;
while ( V_293 <= V_16 ) {
T_1 V_341 ;
if ( V_293 >= V_261 ) {
if ( V_25 -> V_46 && V_25 -> V_46 -> V_245 )
V_25 -> V_46 -> V_245 ( V_129 , V_293 ,
V_292 , NULL , 1 ) ;
break;
}
V_213 = V_326 -> V_290 ( V_26 , V_129 , V_173 , V_293 ,
V_16 - V_293 + 1 , 1 ) ;
if ( F_202 ( V_213 ) ) {
F_128 ( V_129 ) ;
V_74 = F_224 ( V_213 ) ;
...
F_72 ( V_341 <= V_293 ) ;
F_72 ( V_16 < V_293 ) ;
V_299 = F_131 ( V_341 - V_293 , V_16 - V_293 + 1 ) ;
V_299 = F_209 ( V_299 , V_301 ) ;
V_179 = ( V_213 -> V_218 + V_294 ) >> 9 ;
V_194 = V_213 -> V_194 ;
V_218 = V_213 -> V_218 ;
V_336 = F_164 ( V_219 , & V_213 -> V_7 ) ;
F_163 ( V_213 ) ;
V_213 = NULL ;
if ( V_336 || V_218 == V_309 ||
V_218 == V_310 ) {
if ( ! V_336 && V_25 -> V_46 &&
V_25 -> V_46 -> V_245 )
V_25 -> V_46 -> V_245 ( V_129 , V_293 ,
...
if ( V_25 -> V_46 && V_25 -> V_46 -> V_342 ) {
V_74 = V_25 -> V_46 -> V_342 ( V_129 , V_293 ,
V_293 + V_299 - 1 ) ;
} else {
V_74 = 0 ;
}
...
unsigned long V_343 = ( V_261 >> V_127 ) + 1 ;
F_110 ( V_25 , V_293 , V_293 + V_299 - 1 ) ;
if ( ! F_225 ( V_129 ) ) {
F_174 ( F_125 ( V_26 ) -> V_54 -> V_175 ,
L_27 ,
V_129 -> V_126 , V_293 , V_16 ) ;
}
V_74 = F_190 ( V_334 , V_25 , V_129 ,
V_179 , V_299 , V_173 ,
V_194 , & V_326 -> V_41 , V_343 ,
F_172 ,
0 , 0 , 0 ) ;
if ( V_74 )
F_128 ( V_129 ) ;
...
static int F_226 ( struct V_129 * V_129 , struct V_316 * V_317 ,
void * V_226 )
{
struct V_26 * V_26 = V_129 -> V_28 -> V_29 ;
struct V_325 * V_326 = V_226 ;
T_1 V_15 = F_136 ( V_129 ) ;
T_1 V_292 = V_15 + V_149 - 1 ;
int V_74 ;
int V_283 = 0 ;
...
if ( V_317 -> V_344 == V_345 )
V_334 = V_197 ;
else
V_334 = V_190 ;
F_227 ( V_129 , V_26 , V_317 ) ;
F_41 ( ! F_228 ( V_129 ) ) ;
F_229 ( V_129 ) ;
V_173 = V_261 & ( V_149 - 1 ) ;
if ( V_129 -> V_126 > V_128 ||
( V_129 -> V_126 == V_128 && ! V_173 ) ) {
V_129 -> V_28 -> V_346 -> V_347 ( V_129 , 0 , V_149 ) ;
F_118 ( V_129 ) ;
return 0 ;
}
if ( V_129 -> V_126 == V_128 ) {
...
V_173 = 0 ;
F_198 ( V_129 ) ;
V_74 = F_221 ( V_26 , V_129 , V_317 , V_326 , V_15 , & V_318 ) ;
if ( V_74 == 1 )
goto V_340;
if ( V_74 )
goto V_147;
V_74 = F_222 ( V_26 , V_129 , V_317 , V_326 ,
V_261 , V_318 , V_334 , & V_283 ) ;
if ( V_74 == 1 )
goto V_340;
V_147:
if ( V_283 == 0 ) {
...
F_70 ( & V_11 -> V_352 ) ;
if ( F_237 ( V_353 , & V_11 -> V_348 ) ) {
F_238 ( V_349 , & V_11 -> V_348 ) ;
F_74 ( & V_11 -> V_352 ) ;
F_239 ( V_11 , V_354 ) ;
F_240 ( & V_175 -> V_355 ,
- V_11 -> V_21 ,
...
{
F_243 ( V_349 , & V_11 -> V_348 ) ;
F_244 () ;
F_245 ( & V_11 -> V_348 , V_349 ) ;
}
static void F_246 ( struct V_129 * V_129 )
{
struct V_10 * V_11 = (struct V_10 * ) V_129 -> V_50 ;
struct V_357 * V_358 = F_125 ( V_11 -> V_175 -> V_204 ) ;
F_128 ( V_129 ) ;
if ( F_247 ( V_359 , & V_11 -> V_348 ) )
return;
switch ( V_11 -> V_360 ) {
case - 1 :
F_238 ( V_361 , & V_358 -> V_362 ) ;
break;
case 0 :
F_238 ( V_363 , & V_358 -> V_362 ) ;
break;
case 1 :
F_238 ( V_364 , & V_358 -> V_362 ) ;
break;
default:
F_248 () ;
}
}
static void F_249 ( struct V_41 * V_41 , int V_95 )
{
struct V_246 * V_247 ;
struct V_10 * V_11 ;
int V_140 , V_147 ;
...
F_72 ( ! V_11 ) ;
V_147 = F_40 ( & V_11 -> V_365 ) ;
if ( V_95 || F_164 ( V_359 , & V_11 -> V_348 ) ) {
F_171 ( V_129 ) ;
F_246 ( V_129 ) ;
}
F_129 ( V_129 ) ;
...
unsigned long V_140 , V_202 ;
unsigned long V_217 = 0 ;
int V_273 = ( V_326 -> V_351 ? V_197 : V_190 ) | V_366 ;
int V_74 = 0 ;
F_243 ( V_359 , & V_11 -> V_348 ) ;
V_202 = F_152 ( V_11 -> V_15 , V_11 -> V_21 ) ;
F_36 ( & V_11 -> V_365 , V_202 ) ;
if ( F_251 ( V_11 ) == V_367 )
V_217 = V_368 ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ ) {
struct V_129 * V_60 = V_11 -> V_138 [ V_140 ] ;
F_105 ( V_60 ) ;
F_111 ( V_60 ) ;
V_74 = F_190 ( V_273 , V_25 , V_60 , V_56 >> 9 ,
V_149 , 0 , V_194 , & V_326 -> V_41 ,
- 1 , F_249 ,
0 , V_326 -> V_217 , V_217 ) ;
V_326 -> V_217 = V_217 ;
if ( V_74 ) {
F_246 ( V_60 ) ;
F_129 ( V_60 ) ;
if ( F_252 ( V_202 - V_140 , & V_11 -> V_365 ) )
F_242 ( V_11 ) ;
V_74 = - V_154 ;
break;
}
...
V_126 = V_317 -> V_321 >> V_127 ;
V_16 = V_317 -> V_322 >> V_127 ;
V_373 = 1 ;
}
if ( V_317 -> V_344 == V_345 )
V_374 = V_375 ;
...
while ( ! V_147 && ! V_370 && ( V_126 <= V_16 ) &&
( V_139 = F_256 ( & V_372 , V_28 , & V_126 , V_374 ,
F_131 ( V_16 - V_126 , ( T_9 ) V_378 - 1 ) + 1 ) ) ) {
unsigned V_140 ;
V_373 = 1 ;
for ( V_140 = 0 ; V_140 < V_139 ; V_140 ++ ) {
struct V_129 * V_129 = V_372 . V_138 [ V_140 ] ;
if ( ! F_194 ( V_129 ) )
continue;
if ( ! V_317 -> V_320 && V_129 -> V_126 > V_16 ) {
V_147 = 1 ;
break;
}
F_70 ( & V_28 -> V_379 ) ;
...
V_74 = F_257 ( & V_11 -> V_17 ) ;
F_74 ( & V_28 -> V_379 ) ;
if ( ! V_74 )
continue;
V_369 = V_11 ;
V_74 = F_232 ( V_11 , V_175 , & V_326 ) ;
if ( ! V_74 ) {
F_258 ( V_11 ) ;
continue;
}
V_74 = F_250 ( V_11 , V_175 , V_317 , & V_326 ) ;
if ( V_74 ) {
V_147 = 1 ;
F_258 ( V_11 ) ;
break;
...
static void F_265 ( struct V_325 * V_326 )
{
if ( V_326 -> V_41 ) {
int V_273 = V_190 ;
int V_74 ;
if ( V_326 -> V_351 )
V_273 = V_197 ;
V_74 = F_185 ( V_273 , V_326 -> V_41 , 0 , V_326 -> V_217 ) ;
F_72 ( V_74 < 0 ) ;
V_326 -> V_41 = NULL ;
}
}
static T_5 void F_234 ( void * V_226 )
{
struct V_325 * V_326 = V_226 ;
F_265 ( V_326 ) ;
}
...
V_74 = F_226 ( V_129 , V_317 , & V_326 ) ;
F_265 ( & V_326 ) ;
return V_74 ;
}
int F_267 ( struct V_24 * V_25 , struct V_26 * V_26 ,
T_1 V_15 , T_1 V_16 , T_12 * V_290 ,
int V_383 )
{
int V_74 = 0 ;
...
unsigned V_385 ;
unsigned long V_217 = 0 ;
struct V_129 * V_386 [ 16 ] ;
struct V_129 * V_129 ;
struct V_212 * V_291 = NULL ;
int V_283 = 0 ;
for ( V_385 = 0 ; V_385 < V_139 ; V_385 ++ ) {
V_129 = F_11 ( V_138 -> V_71 , struct V_129 , V_387 ) ;
F_270 ( & V_129 -> V_7 ) ;
F_8 ( & V_129 -> V_387 ) ;
if ( F_271 ( V_129 , V_28 ,
V_129 -> V_126 , V_125 ) ) {
...
V_386 [ V_283 ++ ] = V_129 ;
if ( V_283 < F_272 ( V_386 ) )
continue;
F_215 ( V_25 , V_386 , V_283 , V_290 , & V_291 ,
& V_41 , 0 , & V_217 , V_315 ) ;
V_283 = 0 ;
}
if ( V_283 )
...
F_72 ( ! F_10 ( V_138 ) ) ;
if ( V_41 )
return F_185 ( V_315 , V_41 , 0 , V_217 ) ;
return 0 ;
}
...
T_1 V_15 = F_136 ( V_129 ) ;
T_1 V_16 = V_15 + V_149 - 1 ;
T_10 V_301 = V_129 -> V_28 -> V_29 -> V_33 -> V_302 ;
V_15 += F_209 ( V_56 , V_301 ) ;
if ( V_15 > V_16 )
return 0 ;
...
static int F_274 ( struct V_214 * V_388 ,
struct V_24 * V_25 ,
...
V_21 = V_16 - V_15 + 1 ;
F_276 ( & V_388 -> V_48 ) ;
V_213 = F_161 ( V_388 , V_15 , V_21 ) ;
if ( ! V_213 ) {
F_277 ( & V_388 -> V_48 ) ;
break;
}
if ( F_164 ( V_390 , & V_213 -> V_7 ) ||
V_213 -> V_15 != V_15 ) {
F_277 ( & V_388 -> V_48 ) ;
F_163 ( V_213 ) ;
break;
...
return F_274 ( V_388 , V_25 , V_129 , V_49 ) ;
}
static struct V_212 * F_279 ( struct V_26 * V_26 ,
T_1 V_56 ,
T_1 V_162 ,
T_12 * V_290 )
{
T_1 V_392 = F_125 ( V_26 ) -> V_54 -> V_392 ;
struct V_212 * V_213 ;
T_1 V_21 ;
if ( V_56 >= V_162 )
return NULL ;
...
if ( V_21 == 0 )
break;
V_21 = F_209 ( V_21 , V_392 ) ;
V_213 = V_290 ( V_26 , NULL , 0 , V_56 , V_21 , 0 ) ;
if ( F_202 ( V_213 ) )
return V_213 ;
if ( ! F_164 ( V_393 , & V_213 -> V_7 ) &&
V_213 -> V_218 != V_309 ) {
return V_213 ;
}
V_56 = F_201 ( V_213 ) ;
...
int F_280 ( struct V_26 * V_26 , struct V_394 * V_395 ,
T_15 V_15 , T_15 V_21 , T_12 * V_290 )
{
int V_74 = 0 ;
T_1 V_262 = V_15 ;
T_1 F_132 = V_15 + V_21 ;
...
return - V_36 ;
V_402 -> V_406 = 1 ;
V_15 = F_282 ( V_15 , F_125 ( V_26 ) -> V_54 -> V_392 ) ;
V_21 = F_283 ( F_132 , F_125 ( V_26 ) -> V_54 -> V_392 ) - V_15 ;
V_74 = F_284 ( NULL , V_54 , V_402 , F_19 ( V_26 ) , - 1 ,
0 ) ;
if ( V_74 < 0 ) {
F_285 ( V_402 ) ;
return V_74 ;
...
F_41 ( ! V_74 ) ;
V_402 -> V_407 [ 0 ] -- ;
F_286 ( V_402 -> V_408 [ 0 ] , & V_400 , V_402 -> V_407 [ 0 ] ) ;
V_396 = V_400 . type ;
if ( V_400 . V_409 != F_19 ( V_26 ) ||
V_396 != V_410 ) {
V_162 = ( T_1 ) - 1 ;
V_397 = V_27 ;
} else {
...
while ( ! V_16 ) {
T_1 V_411 = 0 ;
if ( V_213 -> V_15 >= F_132 || F_201 ( V_213 ) < V_262 )
break;
V_403 = F_132 ( V_213 -> V_15 , V_262 ) ;
if ( ! F_164 ( V_219 , & V_213 -> V_7 ) )
V_411 = V_403 - V_213 -> V_15 ;
V_341 = F_201 ( V_213 ) ;
V_404 = V_341 - V_403 ;
V_398 = 0 ;
V_7 = 0 ;
...
if ( V_262 >= F_132 )
V_16 = 1 ;
if ( V_213 -> V_218 == V_412 ) {
V_16 = 1 ;
V_7 |= V_413 ;
} else if ( V_213 -> V_218 == V_310 ) {
V_7 |= ( V_414 |
V_415 ) ;
} else if ( V_213 -> V_218 == V_416 ) {
V_7 |= ( V_417 |
V_418 ) ;
} else if ( V_395 -> V_419 ) {
T_1 V_420 = V_213 -> V_218 -
( V_213 -> V_15 - V_213 -> V_421 ) ;
V_398 = V_213 -> V_218 + V_411 ;
V_74 = F_290 ( NULL , V_54 -> V_175 ,
V_54 -> V_409 ,
F_19 ( V_26 ) , V_420 ) ;
if ( V_74 < 0 )
goto V_422;
...
F_163 ( V_213 ) ;
V_213 = NULL ;
if ( ( V_403 >= V_162 ) || V_404 == ( T_1 ) - 1 ||
( V_162 == ( T_1 ) - 1 && V_27 <= V_341 ) ) {
V_7 |= V_413 ;
V_16 = 1 ;
}
V_213 = F_279 ( V_26 , V_262 , V_397 ,
V_290 ) ;
if ( F_288 ( V_213 ) ) {
V_74 = F_289 ( V_213 ) ;
goto V_107;
...
{
return ( F_13 ( & V_11 -> V_365 ) ||
F_164 ( V_349 , & V_11 -> V_348 ) ||
F_164 ( V_353 , & V_11 -> V_348 ) ) ;
}
static void F_294 ( struct V_10 * V_11 )
{
unsigned long V_126 ;
struct V_129 * V_129 ;
int V_425 = ! F_164 ( V_426 , & V_11 -> V_348 ) ;
F_72 ( F_293 ( V_11 ) ) ;
...
if ( V_129 && V_425 ) {
F_70 ( & V_129 -> V_28 -> V_379 ) ;
if ( F_194 ( V_129 ) &&
V_129 -> V_50 == ( unsigned long ) V_11 ) {
F_72 ( F_164 ( V_353 , & V_11 -> V_348 ) ) ;
F_72 ( F_121 ( V_129 ) ) ;
F_72 ( F_225 ( V_129 ) ) ;
F_295 ( V_129 ) ;
F_197 ( V_129 , 0 ) ;
...
static struct V_10 *
F_297 ( struct V_32 * V_175 , T_1 V_15 ,
unsigned long V_21 )
{
struct V_10 * V_11 = NULL ;
V_11 = F_298 ( V_22 , V_125 ) ;
if ( V_11 == NULL )
return NULL ;
V_11 -> V_15 = V_15 ;
V_11 -> V_21 = V_21 ;
...
struct V_10 * F_301 ( struct V_10 * V_438 )
{
unsigned long V_140 ;
struct V_129 * V_60 ;
struct V_10 * V_5 ;
unsigned long V_202 = F_152 ( V_438 -> V_15 , V_438 -> V_21 ) ;
V_5 = F_297 ( V_438 -> V_175 , V_438 -> V_15 , V_438 -> V_21 ) ;
if ( V_5 == NULL )
return NULL ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ ) {
V_60 = F_302 ( V_125 ) ;
...
F_303 ( V_5 , V_438 , 0 , 0 , V_438 -> V_21 ) ;
F_238 ( V_439 , & V_5 -> V_348 ) ;
F_238 ( V_426 , & V_5 -> V_348 ) ;
return V_5 ;
}
struct V_10 * F_304 ( struct V_32 * V_175 ,
T_1 V_15 )
{
struct V_10 * V_11 ;
unsigned long V_21 ;
...
V_21 = V_175 -> V_440 -> V_441 ;
}
V_202 = F_152 ( 0 , V_21 ) ;
V_11 = F_297 ( V_175 , V_15 , V_21 ) ;
if ( ! V_11 )
return NULL ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ ) {
...
int V_17 ;
V_17 = F_13 ( & V_11 -> V_17 ) ;
if ( V_17 >= 2 && F_164 ( V_442 , & V_11 -> V_348 ) )
return;
F_70 ( & V_11 -> V_352 ) ;
if ( ! F_247 ( V_442 , & V_11 -> V_348 ) )
F_82 ( & V_11 -> V_17 ) ;
F_74 ( & V_11 -> V_352 ) ;
}
...
struct V_10 * F_311 ( struct V_32 * V_175 ,
T_1 V_15 )
{
struct V_10 * V_11 ;
F_312 () ;
V_11 = F_313 ( & V_175 -> V_444 ,
V_15 >> V_127 ) ;
...
struct V_10 * F_315 ( struct V_32 * V_175 ,
T_1 V_15 )
{
struct V_10 * V_11 , * V_445 = NULL ;
int V_74 ;
V_11 = F_311 ( V_175 , V_15 ) ;
if ( V_11 )
return V_11 ;
V_11 = F_304 ( V_175 , V_15 ) ;
if ( ! V_11 )
return NULL ;
V_11 -> V_175 = V_175 ;
V_104:
V_74 = F_316 ( V_125 & ~ V_446 ) ;
if ( V_74 )
goto V_447;
F_70 ( & V_175 -> V_448 ) ;
V_74 = F_317 ( & V_175 -> V_444 ,
V_15 >> V_127 , V_11 ) ;
F_74 ( & V_175 -> V_448 ) ;
F_318 () ;
if ( V_74 == - V_84 ) {
V_445 = F_311 ( V_175 , V_15 ) ;
if ( V_445 )
goto V_447;
else
goto V_104;
...
struct V_10 * F_319 ( struct V_32 * V_175 ,
T_1 V_15 )
{
unsigned long V_21 = V_175 -> V_440 -> V_441 ;
...
static inline void F_323 ( struct V_450 * V_6 )
{
struct V_10 * V_11 =
F_324 ( V_6 , struct V_10 , V_450 ) ;
F_292 ( V_11 ) ;
}
...
F_294 ( V_11 ) ;
#ifdef F_327
if ( F_180 ( F_164 ( V_426 , & V_11 -> V_348 ) ) ) {
F_292 ( V_11 ) ;
return 1 ;
}
#endif
F_328 ( & V_11 -> V_450 , F_323 ) ;
return 1 ;
}
F_74 ( & V_11 -> V_352 ) ;
return 0 ;
...
if ( V_17 <= 3 )
break;
V_451 = F_329 ( & V_11 -> V_17 , V_17 , V_17 - 1 ) ;
if ( V_451 == V_17 )
return;
}
F_70 ( & V_11 -> V_352 ) ;
if ( F_13 ( & V_11 -> V_17 ) == 2 &&
F_164 ( V_426 , & V_11 -> V_348 ) )
F_71 ( & V_11 -> V_17 ) ;
if ( F_13 ( & V_11 -> V_17 ) == 2 &&
F_164 ( V_452 , & V_11 -> V_348 ) &&
! F_293 ( V_11 ) &&
F_237 ( V_442 , & V_11 -> V_348 ) )
F_71 ( & V_11 -> V_17 ) ;
F_325 ( V_11 ) ;
}
...
if ( ! F_121 ( V_129 ) ) {
F_333 ( & V_129 -> V_28 -> V_454 ,
F_334 ( V_129 ) ,
V_376 ) ;
}
F_335 ( & V_129 -> V_28 -> V_453 ) ;
F_229 ( V_129 ) ;
F_118 ( V_129 ) ;
}
F_41 ( F_13 ( & V_11 -> V_17 ) == 0 ) ;
...
int V_455 = 0 ;
F_308 ( V_11 ) ;
V_455 = F_247 ( V_353 , & V_11 -> V_348 ) ;
V_202 = F_152 ( V_11 -> V_15 , V_11 -> V_21 ) ;
F_41 ( F_13 ( & V_11 -> V_17 ) == 0 ) ;
F_41 ( ! F_164 ( V_442 , & V_11 -> V_348 ) ) ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ )
F_337 ( V_11 -> V_138 [ V_140 ] ) ;
return V_455 ;
}
...
int F_339 ( struct V_10 * V_11 )
{
return F_164 ( V_439 , & V_11 -> V_348 ) ;
}
int F_340 ( struct V_24 * V_25 ,
...
V_202 = F_152 ( V_11 -> V_15 , V_11 -> V_21 ) ;
for ( V_140 = V_456 ; V_140 < V_202 ; V_140 ++ ) {
V_129 = V_11 -> V_138 [ V_140 ] ;
if ( V_109 == V_460 ) {
if ( ! F_241 ( V_129 ) )
goto V_461;
...
F_243 ( V_462 , & V_11 -> V_348 ) ;
V_11 -> V_463 = 0 ;
F_36 ( & V_11 -> V_365 , V_459 ) ;
for ( V_140 = V_456 ; V_140 < V_202 ; V_140 ++ ) {
V_129 = V_11 -> V_138 [ V_140 ] ;
if ( ! F_204 ( V_129 ) ) {
F_229 ( V_129 ) ;
V_95 = F_216 ( V_25 , V_129 ,
V_290 , & V_41 ,
V_174 , & V_217 ,
V_315 | V_366 ) ;
if ( V_95 )
...
if ( V_41 ) {
V_95 = F_185 ( V_315 | V_366 , V_41 , V_174 ,
V_217 ) ;
if ( V_95 )
return V_95 ;
}
...
void F_342 ( struct V_10 * V_11 , void * V_465 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_10 V_293 ;
...
V_56 = ( V_468 + V_15 ) & ( V_149 - 1 ) ;
while ( V_21 > 0 ) {
V_129 = V_11 -> V_138 [ V_140 ] ;
V_293 = F_131 ( V_21 , ( V_149 - V_56 ) ) ;
V_466 = F_343 ( V_129 ) ;
memcpy ( V_467 , V_466 + V_56 , V_293 ) ;
V_467 += V_293 ;
V_21 -= V_293 ;
V_56 = 0 ;
V_140 ++ ;
...
int F_344 ( struct V_10 * V_11 , void T_17 * V_465 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_10 V_293 ;
...
V_293 = F_131 ( V_21 , ( V_149 - V_56 ) ) ;
V_466 = F_343 ( V_129 ) ;
if ( F_345 ( V_467 , V_466 + V_56 , V_293 ) ) {
V_74 = - V_469 ;
break;
}
V_467 += V_293 ;
...
int F_346 ( struct V_10 * V_11 , unsigned long V_15 ,
unsigned long V_470 , char * * V_388 ,
unsigned long * V_471 ,
unsigned long * V_472 )
{
...
int F_347 ( struct V_10 * V_11 , const void * V_474 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_10 V_293 ;
...
V_293 = F_131 ( V_21 , ( V_149 - V_56 ) ) ;
V_466 = F_343 ( V_129 ) ;
V_74 = memcmp ( V_475 , V_466 + V_56 , V_293 ) ;
if ( V_74 )
break;
V_475 += V_293 ;
V_21 -= V_293 ;
...
void F_348 ( struct V_10 * V_11 , const void * V_476 ,
...
void F_349 ( struct V_10 * V_11 , char V_477 ,
unsigned long V_15 , unsigned long V_21 )
{
T_10 V_293 ;
T_10 V_56 ;
...
V_293 = F_131 ( V_21 , V_149 - V_56 ) ;
V_466 = F_343 ( V_129 ) ;
memset ( V_466 + V_56 , V_477 , V_293 ) ;
V_21 -= V_293 ;
V_56 = 0 ;
V_140 ++ ;
}
}
void F_303 ( struct V_10 * V_467 , struct V_10 * V_438 ,
...
F_41 ( V_438 -> V_21 != V_480 ) ;
V_56 = ( V_468 + V_478 ) &
( V_149 - 1 ) ;
while ( V_21 > 0 ) {
V_129 = V_467 -> V_138 [ V_140 ] ;
F_41 ( ! F_204 ( V_129 ) ) ;
V_293 = F_131 ( V_21 , ( unsigned long ) ( V_149 - V_56 ) ) ;
V_466 = F_343 ( V_129 ) ;
F_342 ( V_438 , V_466 + V_56 , V_479 , V_293 ) ;
V_479 += V_293 ;
V_21 -= V_293 ;
V_56 = 0 ;
V_140 ++ ;
...
static inline bool F_350 ( unsigned long V_438 , unsigned long V_467 , unsigned long V_21 )
{
unsigned long V_481 = ( V_438 > V_467 ) ? V_438 - V_467 : V_467 - V_438 ;
return V_481 < V_21 ;
}
static void F_351 ( struct V_129 * V_482 , struct V_129 * V_483 ,
unsigned long V_484 , unsigned long V_485 ,
unsigned long V_21 )
{
char * V_486 = F_343 ( V_482 ) ;
char * V_487 ;
int V_488 = 0 ;
if ( V_482 != V_483 ) {
V_487 = F_343 ( V_483 ) ;
...
V_487 = V_486 ;
if ( F_350 ( V_485 , V_484 , V_21 ) )
V_488 = 1 ;
}
if ( V_488 )
memmove ( V_486 + V_484 , V_487 + V_485 , V_21 ) ;
else
memcpy ( V_486 + V_484 , V_487 + V_485 , V_21 ) ;
}
void F_352 ( struct V_10 * V_467 , unsigned long V_478 ,
...
V_490 = ( V_468 + V_479 ) &
( V_149 - 1 ) ;
V_491 = ( V_468 + V_478 ) >> V_127 ;
V_492 = ( V_468 + V_479 ) >> V_127 ;
V_293 = F_131 ( V_21 , ( unsigned long ) ( V_149 -
V_490 ) ) ;
V_293 = F_117 (unsigned long, cur,
(unsigned long)(PAGE_CACHE_SIZE - dst_off_in_page)) ;
F_351 ( V_467 -> V_138 [ V_491 ] , V_467 -> V_138 [ V_492 ] ,
V_489 , V_490 , V_293 ) ;
V_479 += V_293 ;
V_478 += V_293 ;
V_21 -= V_293 ;
...
void F_353 ( struct V_10 * V_467 , unsigned long V_478 ,
unsigned long V_479 , unsigned long V_21 )
{
T_10 V_293 ;
T_10 V_489 ;
...
unsigned long V_494 = V_479 + V_21 - 1 ;
T_10 V_468 = V_467 -> V_15 & ( ( T_1 ) V_149 - 1 ) ;
unsigned long V_491 ;
unsigned long V_492 ;
if ( V_479 + V_21 > V_467 -> V_21 ) {
...
if ( V_478 < V_479 ) {
F_352 ( V_467 , V_478 , V_479 , V_21 ) ;
return;
}
while ( V_21 > 0 ) {
V_491 = ( V_468 + V_493 ) >> V_127 ;
V_492 = ( V_468 + V_494 ) >> V_127 ;
V_489 = ( V_468 + V_493 ) &
( V_149 - 1 ) ;
V_490 = ( V_468 + V_494 ) &
( V_149 - 1 ) ;
V_293 = F_117 (unsigned long, len, src_off_in_page + 1 ) ;
V_293 = F_131 ( V_293 , V_489 + 1 ) ;
F_351 ( V_467 -> V_138 [ V_491 ] , V_467 -> V_138 [ V_492 ] ,
V_489 - V_293 + 1 ,
V_490 - V_293 + 1 , V_293 ) ;
V_493 -= V_293 ;
