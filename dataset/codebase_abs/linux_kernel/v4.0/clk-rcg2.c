...
V_29 >>= V_39 ;
V_29 &= V_32 ;
return F_12 ( V_57 , V_55 -> V_61 , V_55 -> V_62 , ! ! V_55 -> V_62 ,
V_29 ) ;
}
return - V_20 ;
}
...
int V_56 = 100000 ;
const struct V_40 * V_41 = V_4 -> V_40 ;
const struct V_54 * V_55 = V_63 ;
struct V_13 * V_64 = F_19 ( V_2 -> V_13 , V_41 -> V_46 ) ;
* V_45 = F_21 ( V_64 ) ;
for (; V_55 -> V_61 ; V_55 ++ ) {
V_58 = ( V_25 * V_55 -> V_62 ) / V_55 -> V_61 ;
V_57 = F_32 ( V_64 , V_58 ) ;
if ( ( V_57 < ( V_58 - V_56 ) ) ||
( V_57 > ( V_58 + V_56 ) ) )
continue;
* V_42 = V_57 ;
return ( V_57 * V_55 -> V_61 ) / V_55 -> V_62 ;
}
return - V_20 ;
}
