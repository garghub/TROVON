...
V_71 = F_57 ( V_72 ) ;
V_43 += V_42 - V_41 ;
if ( V_43 > V_71 && ! F_58 ( V_73 ) )
goto V_74;
}
if ( ! F_59 ( V_2 , ( V_42 - V_41 ) >> V_56 ) )
goto V_75;
if ( V_8 -> V_44 & V_59 ) {
...
goto V_83;
V_80 = F_52 ( V_2 , V_15 , V_42 ) ;
if ( V_80 )
goto V_83;
if ( V_41 >= V_42 ) {
V_80 = F_52 ( V_2 , V_3 + V_42 , V_41 - V_42 ) ;
if ( V_80 && V_41 != V_42 )
goto V_83;
V_41 = V_42 ;
}
V_8 = F_54 ( V_3 , V_41 , V_42 , & V_76 ) ;
if ( F_63 ( V_8 ) ) {
V_80 = F_64 ( V_8 ) ;
goto V_83;
}
...
if ( V_8 -> V_44 & V_86 )
V_81 |= V_87 ;
V_80 = F_65 ( V_8 -> V_25 , V_15 , V_42 , V_8 -> V_54 +
( ( V_3 - V_8 -> V_55 ) >> V_56 ) ,
V_81 ) ;
if ( V_80 & ~ V_82 )
goto V_88;
V_80 = F_48 ( V_8 , V_3 , V_41 , V_42 , V_15 , V_43 ) ;
if ( ! ( V_80 & ~ V_82 ) )
goto V_83;
V_88:
F_53 ( V_76 ) ;
...
static int F_66 ( struct V_7 * V_8 , unsigned long V_89 )
{
...
return 0 ;
if ( F_65 ( NULL , V_8 -> V_55 , V_90 - V_8 -> V_55 ,
0 , V_85 ) & ~ V_82 )
return 0 ;
return 1 ;
}
