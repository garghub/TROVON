...
return;
F_4 ( V_8 , L_48 , V_11 , & V_10 -> V_66 [ V_11 ] . V_69 ) ;
}
...
F_3 ( V_10 -> V_66 [ V_11 ] . V_52 , sizeof( V_10 -> V_66 [ V_11 ] . V_52 ) ) ;
F_3 ( V_10 -> V_66 [ V_11 ] . V_73 , sizeof( V_10 -> V_66 [ V_11 ] . V_73 ) ) ;
F_5 ( V_8 , '\n' ) ;
F_4 ( V_8 , L_49 , V_11 , V_10 -> V_66 [ V_11 ] . V_52 ) ;
F_4 ( V_8 , L_50 , V_11 , V_10 -> V_66 [ V_11 ] . V_73 ) ;
F_4 ( V_8 , L_51 , V_11 , V_10 -> V_66 [ V_11 ] . V_58 ) ;
F_4 ( V_8 , L_52 , V_11 , V_10 -> V_66 [ V_11 ] . V_40 ) ;
F_4 ( V_8 , L_53 , V_11 , V_10 -> V_66 [ V_11 ] . V_41 ) ;
F_4 ( V_8 , L_54 , V_11 , V_10 -> V_66 [ V_11 ] . V_42 ) ;
F_4 ( V_8 , L_55 , V_11 , V_10 -> V_66 [ V_11 ] . V_43 ) ;
F_12 ( V_8 , V_11 , V_10 ) ;
F_13 ( V_8 , V_11 , V_10 ) ;
}
}
...
F_48 ( V_99 , & V_98 ) ;
if ( ( V_10 -> V_44 >> 23 ) == 0 )
F_49 ( V_100 , ( long ) V_10 -> V_44 , 64 , long ) ;
else
F_48 ( V_100 , & V_10 -> V_44 ) ;
F_50 ( V_101 , V_99 , V_100 ) ;
F_51 ( V_44 , V_101 , 32 , 0 ) ;
} else
V_44 = 42 ;
V_103 = V_44 * ( 500000 / V_104 ) ;
F_17 ( ( unsigned long ) V_10 ) ;
}
void F_52 ( void )
{
