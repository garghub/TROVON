...
return - V_59 ;
V_171 = F_101 ( V_169 , sizeof( * V_171 ) , V_172 ) ;
if ( ! V_171 )
return - V_164 ;
...
F_94 ( V_175 , V_36 -> V_154 ) ;
V_36 -> V_154 -> V_176 . V_177 = 512 ;
V_36 -> V_154 -> V_176 . V_178 = V_179 ;
V_36 -> V_154 -> V_176 . V_180 = 0 ;
F_105 ( V_36 -> V_154 , 65536 ) ;
V_36 -> V_154 -> V_176 . V_181 = 256 ;
}
if ( F_106 ( V_182 , L_52 ) ) {
V_103 = - V_23 ;
goto V_106;
}
F_15 ( V_183 L_53 , V_182 ) ;
F_4 ( V_184 , L_54 , V_185 ) ;
for ( V_165 = 0 ; V_165 < V_169 ; V_165 ++ ) {
struct V_121 * V_36 = V_171 [ V_165 ] . V_36 ;
V_171 [ V_165 ] . V_90 = V_124 ;
F_107 ( & V_171 [ V_165 ] . V_128 ) ;
F_108 ( & V_171 [ V_165 ] . V_30 ) ;
F_107 ( & V_171 [ V_165 ] . V_126 ) ;
F_109 ( & V_171 [ V_165 ] . V_34 ) ;
F_110 ( & V_171 [ V_165 ] . V_104 ) ;
F_110 ( & V_171 [ V_165 ] . V_138 ) ;
V_171 [ V_165 ] . V_147 = 1024 ;
V_171 [ V_165 ] . V_148 = 0 ;
V_36 -> V_186 = V_182 ;
V_36 -> V_187 = V_165 << V_166 ;
V_36 -> V_188 = & V_189 ;
V_36 -> V_122 = & V_171 [ V_165 ] ;
...
V_106:
while ( V_165 -- ) {
F_112 ( V_171 [ V_165 ] . V_36 -> V_154 ) ;
F_104 ( V_171 [ V_165 ] . V_36 ) ;
}
F_113 ( V_171 ) ;
return V_103 ;
}
