...
static struct V_14 * F_24 ( struct V_14 * V_89 ,
bool V_90 )
{
T_3 V_91 = 0 ;
struct V_14 * V_71 ;
...
static T_4 F_28 ( const struct V_99 * V_27 )
{
...
V_71 = F_24 ( V_102 , V_90 ) ;
if ( ! V_71 )
return NULL ;
V_1 -> V_83 ++ ;
F_32 ( & V_71 -> V_81 , V_27 , V_105 ) ;
F_33 ( & V_71 -> V_81 , V_1 -> V_107 ) ;
V_108:
if ( V_90 )
...
struct V_14 * F_34 ( struct V_1 * V_1 ,
struct V_103 * V_104 ,
struct V_99 * V_111 ,
struct V_29 * V_112 ,
struct V_36 * V_113 ,
...
. V_27 = V_111 ,
. V_55 = F_28 ( V_111 ) | V_104 -> V_55 ,
. V_1 = V_1 ,
. V_29 = V_112 ,
. V_36 = V_113 ,
. V_47 = V_47 ,
} ;
return F_29 ( V_1 , & V_102 , V_104 , V_90 ) ;
}
static int
...
static int
F_40 ( struct V_118 * T_6 , struct V_103 * V_104 )
{
T_2 V_124 ;
struct V_36 * V_113 = T_6 -> V_123 ;
struct V_1 * V_1 = F_41 ( T_6 -> V_125 ) ;
struct V_14 * V_71 ;
if ( V_113 == NULL )
return - V_126 ;
...
if ( ! V_124 )
V_124 = 1 ;
V_71 = F_34 ( V_1 , V_104 , T_6 -> V_27 , NULL , V_113 ,
V_124 , V_124 , 0 , true ) ;
if ( ! V_71 )
return - V_122 ;
T_6 -> V_71 = V_71 ;
...
static int
F_42 ( struct V_118 * T_6 ,
struct V_103 * V_104 V_119 )
{
struct V_127 * V_125 = T_6 -> V_125 ;
struct V_1 * V_1 = F_41 ( V_125 ) ;
struct V_14 * V_71 = T_6 -> V_71 ;
int V_128 = - V_126 ;
if ( V_71 == NULL )
goto V_108;
F_43 ( V_1 , V_71 -> V_55 ) ;
V_128 = F_44 ( V_71 , T_6 -> V_121 ) ;
V_108:
T_6 -> V_123 = NULL ;
T_6 -> V_71 = NULL ;
return V_128 ;
...
goto V_108;
V_71 = F_34 ( V_1 , V_104 , T_6 -> V_27 , & V_112 [ V_133 ] , NULL ,
1 , 1 , 0 , true ) ;
if ( V_71 == NULL )
return - V_122 ;
F_43 ( V_1 , V_71 -> V_55 ) ;
...
static int
F_52 ( struct V_118 * T_6 , struct V_103 * V_104 )
{
struct V_127 * V_125 = T_6 -> V_125 ;
struct V_120 * V_121 = T_6 -> V_121 ;
struct V_14 * V_71 ;
V_71 = F_34 ( F_41 ( V_125 ) , V_104 , T_6 -> V_27 , NULL , NULL ,
...
return 0 ;
T_6 -> V_71 = NULL ;
F_43 ( F_41 ( V_125 ) , V_71 -> V_55 ) ;
return F_44 ( V_71 , V_121 ) ;
}
static int
F_54 ( struct V_118 * T_6 V_119 ,
struct V_103 * V_104 V_119 )
{
struct V_14 * * V_135 ;
F_55 ( & V_136 ) ;
...
struct V_14 * V_71 ;
int V_128 = 0 ;
V_71 = F_34 ( V_1 , V_104 , T_6 -> V_27 , NULL , NULL ,
V_121 -> V_58 , V_121 -> V_67 ,
V_121 -> V_47 , true ) ;
if ( V_71 == NULL )
return - V_122 ;
...
if ( V_98 == NULL )
return 0 ;
return F_59 ( V_104 , V_98 , T_6 -> V_134 ) ;
}
static int
F_60 ( struct V_118 * T_6 ,
struct V_103 * V_104 )
{
struct V_127 * V_125 = T_6 -> V_125 ;
struct V_120 * V_121 = T_6 -> V_121 ;
...
V_135 [ T_6 -> V_129 ++ ] = V_71 ;
if ( V_10 . V_92 )
F_63 ( V_71 -> V_96 , & V_140 , V_121 -> V_58 ) ;
return 0 ;
}
static int
F_64 ( struct V_118 * T_6 ,
struct V_103 * V_104 V_119 )
{
F_31 ( & T_6 -> V_123 ) ;
T_6 -> V_71 = NULL ;
...
int F_65 ( struct V_118 * T_6 , struct V_103 * V_104 ,
struct V_127 * V_125 , struct V_120 * V_121 ,
int V_141 , void * V_142 )
{
int V_128 , V_143 ;
V_128 = F_66 ( V_121 , & T_6 -> V_27 , V_125 , V_104 ,
V_141 ) ;
if ( V_128 )
return V_128 ;
T_6 -> V_125 = V_125 ;
...
T_5
F_30 ( struct V_14 * V_151 , struct V_14 * V_152 )
{
struct V_153 * V_154 ;
T_5 V_106 = 0 ;
F_67 (fmt) {
if ( F_68 ( V_154 ) )
continue;
V_106 = V_154 -> V_106 ( V_154 , V_151 , V_152 ) ;
if ( V_106 )
break;
}
return V_106 ;
...
T_5
F_69 ( struct V_14 * V_151 , struct V_14 * V_152 )
{
struct V_153 * V_154 ;
T_5 V_106 = 0 ;
F_67 (fmt) {
if ( F_68 ( V_154 ) )
continue;
V_106 = V_154 -> V_155 ( V_154 , V_151 , V_152 ) ;
if ( V_106 )
break;
}
return V_106 ;
...
static bool F_72 ( struct V_1 * V_1 V_119 ,
struct V_157 * V_158 ,
struct V_14 * V_71 )
{
...
V_1 -> V_83 ++ ;
F_32 ( & V_71 -> V_81 , V_27 , V_105 ) ;
F_33 ( & V_71 -> V_81 , V_158 ) ;
return true ;
}
static struct V_157 * F_75 ( struct V_1 * V_1 )
{
struct V_157 * V_158 ;
F_76 ( & V_1 -> V_159 ) ;
V_158 = V_1 -> V_107 ;
...
static void F_78 ( struct V_1 * V_1 , struct V_14 * V_71 )
{
F_79 ( V_1 , V_71 ) ;
F_80 ( V_1 , V_71 ) ;
F_81 ( V_1 , V_71 ) ;
}
void F_82 ( struct V_1 * V_1 , struct V_161 * V_162 )
{
struct V_157 * V_158 ;
struct V_50 * V_51 ;
struct V_14 * V_53 ;
...
V_51 = F_13 ( & V_53 -> V_81 ) ;
F_20 ( & V_53 -> V_81 , V_158 ) ;
if ( F_72 ( V_1 , & V_1 -> V_82 , V_53 ) ) {
F_78 ( V_1 , V_53 ) ;
}
if ( V_162 )
F_84 ( V_162 , 1 ) ;
...
static int F_85 ( struct V_14 * V_163 , struct V_14 * V_164 )
{
struct V_153 * V_154 ;
T_5 V_106 = 0 ;
F_67 (fmt) {
if ( F_68 ( V_154 ) )
continue;
V_106 = V_154 -> V_165 ( V_154 , V_163 , V_164 ) ;
if ( V_106 )
break;
}
return V_106 ;
...
void F_89 ( struct V_1 * V_1 , struct V_14 * V_15 )
{
if ( ! V_15 -> V_55 )
F_88 ( V_1 , V_15 ) ;
V_1 -> V_83 ++ ;
...
static void F_90 ( struct V_157 * V_52 ,
struct V_14 * V_71 ,
T_2 V_166 )
{
...
F_32 ( & V_71 -> V_50 , V_27 , V_105 ) ;
F_33 ( & V_71 -> V_50 , V_52 ) ;
}
void F_91 ( struct V_1 * V_1 , struct V_161 * V_162 )
{
struct V_157 * V_158 ;
struct V_50 * V_51 ;
struct V_14 * V_53 ;
...
static void F_92 ( struct V_1 * V_1 , struct V_14 * V_15 ,
enum V_171 V_172 )
{
V_15 -> V_55 &= ~ ( 1 << V_172 ) ;
if ( V_15 -> V_55 )
...
void F_96 ( struct V_184 * V_77 , T_7 type )
{
++ V_77 -> V_68 [ 0 ] ;
++ V_77 -> V_68 [ type ] ;
}
void F_97 ( struct V_1 * V_1 , T_7 type )
{
F_96 ( & V_1 -> V_77 , type ) ;
}
void F_43 ( struct V_1 * V_1 , bool V_55 )
{
F_96 ( & V_1 -> V_77 , V_185 ) ;
if ( ! V_55 )
V_1 -> V_77 . V_175 ++ ;
...
void F_100 ( struct V_1 * V_188 , struct V_1 * V_189 )
{
struct V_157 * V_158 ;
struct V_50 * V_178 ;
...
V_186 = F_99 ( V_189 , V_190 ) ;
if ( V_186 )
F_101 ( V_186 , V_190 ) ;
}
}
int F_102 ( struct V_1 * V_188 , struct V_1 * V_189 )
{
struct V_157 * V_158 ;
struct V_50 * V_178 ;
struct V_14 * V_190 , * V_186 ;
...
T_3 F_104 ( struct V_191 * V_192 , T_8 * V_193 )
{
struct V_127 * V_190 ;
T_3 V_194 = 0 ;
F_105 (evlist, pos) {
V_194 += fprintf ( V_193 , L_1 , F_106 ( V_190 ) ) ;
V_194 += F_107 ( & F_41 ( V_190 ) -> V_77 , V_193 ) ;
}
return V_194 ;
}
T_2 F_108 ( struct V_1 * V_1 )
{
return V_10 . V_195 ? V_1 -> V_77 . V_79 :
V_1 -> V_77 . V_78 ;
}
int F_109 ( const struct V_196 * T_9 V_119 ,
...
int F_110 ( const char * V_197 , const char * V_198 )
{
if ( ! strcmp ( V_197 , L_4 ) )
return F_109 ( NULL , V_198 , 0 ) ;
return 0 ;
}
static int F_111 ( struct V_127 * V_125 )
{
struct V_1 * V_1 = F_41 ( V_125 ) ;
...
V_1 -> V_82 = V_170 ;
V_1 -> V_52 = V_170 ;
F_112 ( & V_1 -> V_159 , NULL ) ;
return 0 ;
}
int F_113 ( void )
{
int V_128 = F_114 ( sizeof( struct V_199 ) ,
F_111 , NULL ) ;
if ( V_128 )
fputs ( L_5 , V_200 ) ;
return V_128 ;
