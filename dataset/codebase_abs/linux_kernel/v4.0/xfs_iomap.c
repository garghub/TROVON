...
F_42 ( V_1 , V_86 ) ;
V_78 = V_1 -> V_42 . V_87 ;
if ( V_78 < V_1 -> V_88 [ V_89 ] ) {
V_79 = 2 ;
if ( V_78 < V_1 -> V_88 [ V_90 ] )
V_79 ++ ;
if ( V_78 < V_1 -> V_88 [ V_91 ] )
V_79 ++ ;
if ( V_78 < V_1 -> V_88 [ V_92 ] )
V_79 ++ ;
if ( V_78 < V_1 -> V_88 [ V_93 ] )
V_79 ++ ;
}
...
& V_78 ) ;
if ( F_35 ( V_2 , V_96 , V_70 ) )
F_38 ( V_2 , V_96 , & V_36 , & V_76 ,
& V_78 ) ;
V_70 = F_14 ( V_70 , V_36 ) ;
V_79 = F_43 ( V_79 , V_76 ) ;
if ( V_79 )
...
F_25 ( & V_35 , & V_106 ) ;
V_31 = 1 ;
V_104 = F_13 ( V_1 , F_3 ( V_2 ) ) ;
error = F_56 ( V_2 , & V_103 ,
V_12 ) ;
if ( error )
goto V_112;
V_103 = F_57 ( V_103 , V_104 ) ;
if ( ( V_105 + V_26 ) > V_103 ) {
V_26 = V_103 - V_105 ;
if ( V_26 == 0 ) {
error = - V_113 ;
...
do {
F_61 ( V_1 -> V_63 ) ;
V_34 = F_62 ( V_1 , V_109 , V_118 ) ;
V_34 -> V_110 |= V_111 | V_119 ;
error = F_19 ( V_34 , & F_20 ( V_1 ) -> V_47 ,
V_37 , 0 ) ;
if ( error ) {
F_21 ( V_34 , 0 ) ;
...
if ( error )
goto V_121;
V_117 = F_4 ( V_1 , V_25 + V_26 ) ;
if ( V_117 > V_22 + V_23 )
V_117 = V_22 + V_23 ;
V_117 = F_63 ( V_2 , V_117 ) ;
if ( V_117 ) {
