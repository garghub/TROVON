...
static T_1 F_15 ( struct V_12 * V_12 ,
const char T_2 * V_13 ,
T_3 V_14 , T_4 * V_15 )
{
struct V_4 * V_5 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
...
static T_1 F_26 ( struct V_12 * V_12 ,
const char T_2 * V_13 ,
T_3 V_14 , T_4 * V_15 )
{
...
static T_1 F_33 ( struct V_12 * V_12 ,
const char T_2 * V_13 ,
T_3 V_14 , T_4 * V_15 )
{
struct V_4 * V_43 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
...
static T_1 F_37 ( struct V_12 * V_12 ,
const char T_2 * V_13 ,
T_3 V_14 , T_4 * V_15 )
{
struct V_4 * V_43 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
...
static T_1 F_39 ( struct V_12 * V_12 ,
const char T_2 * V_13 ,
T_3 V_14 , T_4 * V_15 )
{
struct V_4 * V_43 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
...
static T_1 F_43 ( struct V_12 * V_12 ,
const char T_2 * V_13 ,
T_3 V_14 , T_4 * V_15 )
{
struct V_4 * V_43 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
...
static T_1 F_45 ( struct V_12 * V_12 ,
const char T_2 * V_13 ,
T_3 V_14 , T_4 * V_15 )
{
struct V_4 * V_43 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
...
static T_1 F_49 ( struct V_12 * V_12 ,
const char T_2 * V_13 ,
T_3 V_14 , T_4 * V_15 )
{
struct V_4 * V_5 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
...
static T_1 F_55 ( struct V_12 * V_12 ,
const char T_2 * V_91 ,
T_3 V_92 , T_4 * V_15 )
{
...
static T_1 F_58 ( struct V_12 * V_12 ,
const char T_2 * V_91 ,
T_3 V_92 , T_4 * V_15 )
{
struct V_1 * V_68 = V_12 -> V_16 ;
...
{
int V_7 ;
V_7 = F_60 ( V_5 -> V_99 , L_24 , 0644 ,
& V_100 , V_5 ) ;
if ( V_7 == 0 )
V_7 = F_61 ( V_5 , L_25 , 0644 ,
& V_101 , V_5 ) ;
return V_7 ;
}
