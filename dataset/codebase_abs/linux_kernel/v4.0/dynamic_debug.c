...
return F_65 ( V_111 , V_42 , V_20 , - V_115 ) ;
}
...
if ( ! V_119 )
return - V_120 ;
V_118 = F_74 ( L_64 , NULL ) ;
if ( ! V_118 )
return - V_92 ;
V_83 = F_75 ( L_65 , 0644 , V_118 , NULL ,
& V_121 ) ;
if ( ! V_83 ) {
F_76 ( V_118 ) ;
return - V_92 ;
...
{
struct V_3 * V_95 , * V_122 ;
const char * V_47 = NULL ;
char * V_123 ;
int V_88 = 0 ;
int V_104 = 0 , V_124 = 0 , V_125 = 0 ;
int V_126 = 0 ;
if ( V_127 == V_128 ) {
F_41 ( L_66 ) ;
return 1 ;
...
for (; V_95 < V_128 ; V_95 ++ ) {
V_124 ++ ;
V_126 += strlen ( V_95 -> V_47 ) + strlen ( V_95 -> V_18 )
+ strlen ( V_95 -> V_19 ) + strlen ( V_95 -> V_17 ) ;
if ( strcmp ( V_47 , V_95 -> V_47 ) ) {
V_125 ++ ;
V_88 = F_61 ( V_122 , V_104 , V_47 ) ;
if ( V_88 )
goto V_129;
V_104 = 0 ;
V_47 = V_95 -> V_47 ;
...
V_123 = F_63 ( V_130 , V_91 ) ;
F_78 ( L_71 , V_123 , NULL ,
0 , 0 , 0 , & F_66 ) ;
F_46 ( V_123 ) ;
return 0 ;
V_129:
