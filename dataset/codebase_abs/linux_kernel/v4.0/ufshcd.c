...
static int F_299 ( struct V_8 * V_9 , enum V_603 V_604 )
{
int V_10 = 0 ;
enum V_2 V_605 ;
enum V_1 V_606 ;
...
if ( ( V_606 != V_9 -> V_596 ) &&
( ( F_301 ( V_604 ) && ! V_9 -> V_455 ) ||
! F_301 ( V_604 ) ) ) {
F_206 ( V_9 ) ;
V_10 = F_285 ( V_9 , V_606 ) ;
if ( V_10 )
goto V_613;
}
V_10 = F_291 ( V_9 , V_597 , 1 ) ;
if ( V_10 )
goto V_614;
F_292 ( V_9 ) ;
V_612:
...
if ( V_9 -> V_376 && V_9 -> V_376 -> V_615 ) {
V_10 = V_9 -> V_376 -> V_615 ( V_9 , V_604 ) ;
if ( V_10 )
goto V_616;
}
if ( V_9 -> V_376 && V_9 -> V_376 -> V_574 ) {
...
goto V_44;
V_617:
if ( V_9 -> V_376 && V_9 -> V_376 -> V_618 )
V_9 -> V_376 -> V_618 ( V_9 , V_604 ) ;
V_616:
F_296 ( V_9 ) ;
...
static int F_303 ( struct V_8 * V_9 , enum V_603 V_604 )
{
int V_10 ;
enum V_6 V_619 ;
V_9 -> V_550 = 1 ;
...
goto V_620;
if ( V_9 -> V_376 && V_9 -> V_376 -> V_618 ) {
V_10 = V_9 -> V_376 -> V_618 ( V_9 , V_604 ) ;
if ( V_10 )
goto V_621;
}
if ( F_48 ( V_9 ) ) {
...
int F_304 ( struct V_8 * V_9 )
{
int V_10 = 0 ;
if ( ! V_9 || ! V_9 -> V_583 )
return 0 ;
if ( F_305 ( V_9 -> V_16 ) ) {
if ( V_9 -> V_607 == V_9 -> V_608 )
if ( ( F_1 ( V_9 -> V_608 ) ==
V_9 -> V_596 ) && ! V_9 -> V_455 )
goto V_44;
V_10 = F_306 ( V_9 ) ;
...
{
if ( ! V_9 || ! V_9 -> V_583 || F_305 ( V_9 -> V_16 ) )
return 0 ;
return F_303 ( V_9 , V_624 ) ;
}
int F_308 ( struct V_8 * V_9 )
{
if ( ! V_9 || ! V_9 -> V_583 )
return 0 ;
return F_299 ( V_9 , V_626 ) ;
}
...
{
if ( V_9 -> V_151 & V_629 ) {
if ( ! F_316 ( V_9 -> V_16 , F_317 ( 64 ) ) )
return 0 ;
}
return F_316 ( V_9 -> V_16 , F_317 ( 32 ) ) ;
}
int F_318 ( struct V_103 * V_16 , struct V_8 * * V_630 )
{
struct V_236 * V_78 ;
struct V_8 * V_9 ;
int V_23 = 0 ;
...
static int F_320 ( struct V_8 * V_9 , bool V_633 )
{
int V_10 = 0 ;
struct V_568 * V_569 ;
struct V_570 * V_571 = & V_9 -> V_572 ;
...
V_569 -> V_576 = V_569 -> V_575 ;
} else if ( ! V_633 && V_569 -> V_634 ) {
if ( V_569 -> V_576 == V_569 -> V_634 )
continue;
V_10 = F_277 ( V_569 -> V_573 , V_569 -> V_634 ) ;
if ( V_10 ) {
F_5 ( V_9 -> V_16 , L_92 ,
V_17 , V_569 -> V_114 ,
V_569 -> V_634 , V_10 ) ;
...
static int F_321 ( struct V_103 * V_16 ,
unsigned long * V_636 , T_1 V_74 )
{
int V_23 = 0 ;
struct V_8 * V_9 = F_70 ( V_16 ) ;
if ( ! F_51 ( V_9 ) )
...
V_121 -> V_123 += F_84 ( F_85 ( F_82 () ,
V_121 -> V_119 ) ) ;
V_639 -> V_641 = F_323 ( ( long ) V_25 -
( long ) V_121 -> V_101 ) ;
V_639 -> V_642 = V_121 -> V_123 ;
V_640:
V_121 -> V_101 = V_25 ;
V_121 -> V_123 = 0 ;
if ( V_9 -> V_122 ) {
...
int F_324 ( struct V_8 * V_9 , void T_9 * V_643 , unsigned int V_12 )
{
int V_23 ;
...
F_158 ( V_9 ) ;
V_78 -> V_645 = V_9 -> V_153 ;
V_78 -> V_646 = V_9 -> V_153 ;
V_78 -> V_647 = V_648 ;
V_78 -> V_649 = V_650 ;
V_78 -> V_651 = V_652 ;
V_78 -> V_653 = V_78 -> V_654 ;
V_78 -> V_655 = V_656 ;
...
F_326 ( & V_9 -> V_169 ) ;
F_326 ( & V_9 -> V_134 . V_270 ) ;
F_325 ( & V_9 -> V_134 . V_261 ) ;
F_73 ( V_9 ) ;
V_23 = F_327 ( V_16 , V_12 , V_13 , V_14 , V_15 , V_9 ) ;
if ( V_23 ) {
F_5 ( V_9 -> V_16 , L_103 ) ;
goto V_657;
} else {
...
V_23 = F_328 ( V_78 , V_78 -> V_645 ) ;
if ( V_23 ) {
F_5 ( V_9 -> V_16 , L_104 ) ;
goto V_657;
}
V_23 = F_329 ( V_78 , V_9 -> V_16 ) ;
if ( V_23 ) {
F_5 ( V_9 -> V_16 , L_105 ) ;
goto V_657;
}
