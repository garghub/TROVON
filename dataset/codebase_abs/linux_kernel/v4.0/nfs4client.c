...
{
struct V_32 * V_32 = V_125 -> V_213 -> V_214 -> V_215 ;
struct V_170 * V_171 ;
int error ;
V_171 = F_106 () ;
if ( V_171 == NULL )
return - V_29 ;
error = F_110 ( V_125 , F_124 ( V_32 ) , V_171 ) ;
F_112 ( V_171 ) ;
return error ;
}
int F_125 ( struct V_124 * V_125 , const char * V_136 ,
struct V_90 * V_91 , T_3 V_216 , struct V_126 * V_126 )
{
struct V_1 * V_2 = V_125 -> V_1 ;
struct V_20 * V_217 = V_125 -> V_33 ;
struct V_218 V_219 = {
. V_220 = V_2 -> V_221 ,
. V_126 = V_126 ,
. V_222 = V_91 ,
...
char V_76 [ V_77 + 1 ] ;
struct V_88 V_195 ;
struct V_90 * V_224 = (struct V_90 * ) & V_195 ;
int error ;
F_58 ( L_28 , V_65 ,
( unsigned long long ) V_125 -> V_179 . V_180 ,
( unsigned long long ) V_125 -> V_179 . V_181 ,
V_136 ) ;
error = F_126 ( V_217 , & V_219 , V_217 -> V_212 ) ;
if ( error != 0 ) {
F_58 ( L_29 ,
V_65 , error ) ;
goto V_23;
}
error = F_69 ( V_217 , V_224 , sizeof( V_195 ) ) ;
if ( error != 0 ) {
F_58 ( L_30 ,
V_65 , error ) ;
goto V_23;
...
error = - V_225 ;
if ( F_70 ( V_224 , V_76 , sizeof( V_76 ) ) == 0 ) {
F_58 ( L_31 ,
V_65 , error ) ;
goto V_23;
}
F_127 ( V_125 ) ;
error = F_97 ( V_125 , V_136 , V_91 , V_216 , V_76 ,
V_2 -> V_30 -> V_21 -> V_22 ,
V_2 -> V_221 , V_217 -> V_212 ,
V_2 -> V_47 , V_126 ) ;
F_74 ( V_2 ) ;
if ( error != 0 ) {
F_111 ( V_125 ) ;
...
if ( V_125 -> V_1 -> V_226 == NULL )
V_125 -> V_1 -> V_226 = F_128 ( V_136 , V_11 ) ;
F_111 ( V_125 ) ;
error = F_123 ( V_125 ) ;
if ( error < 0 )
goto V_23;
