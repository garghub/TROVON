...
V_228 = F_82 ( V_230 -> V_258 [ V_225 ] ,
V_40 -> V_235 ) ;
else
V_228 = F_82 ( V_230 -> V_235 [ V_225 ] , V_40 -> V_235 ) ;
} else {
V_228 = V_230 -> V_259 ;
}
return V_228 ;
...
V_40 -> V_4 = - 1 ;
if ( V_418 )
V_40 -> V_176 = V_418 -> V_423 ;
else if ( V_13 && F_167 ( V_75 -> V_81 ) && V_13 -> V_424 > 0 )
V_40 -> V_176 = V_13 -> V_424 ;
else
V_40 -> V_176 = V_177 ;
V_40 -> V_324 = V_324 ;
V_40 -> V_199 = V_199 ;
...
T_2 F_115 ( struct V_1 * V_2 , T_2 V_425 , V_98 V_266 )
{
struct V_229 * V_230 = V_2 -> V_90 ;
struct V_426 * V_427 = V_230 -> V_427 ;
if ( ( V_230 -> V_91 . V_178 & V_428 ) && F_168 ( V_427 ) &&
( V_425 == 0x7 ) && ( V_266 < 0x90 ) )
return 0x3 ;
...
V_429 = F_172 ( V_75 -> V_430 ) & V_431 ;
V_29 = V_6 -> V_341 ;
V_75 -> V_430 = F_44 ( V_6 -> V_341 << V_32 ) ;
if ( V_429 )
V_75 -> V_430 |= F_44 ( V_429 ) ;
if ( ! F_173 ( V_75 -> V_81 ) )
F_37 ( V_6 -> V_341 , V_70 ) ;
V_36 -> V_62 . V_29 = V_29 ;
}
...
if ( V_39 -> V_55 & V_433 )
V_12 -> V_434 += 0x10 ;
V_75 -> V_430 &= F_44 ( V_431 ) ;
V_75 -> V_430 |= F_44 ( V_12 -> V_434 ) ;
}
...
struct V_74 * V_75 = (struct V_74 * ) V_25 -> V_80 ;
struct V_26 * V_39 = F_8 ( V_25 ) ;
struct V_34 * V_30 = V_436 -> V_30 ;
struct V_33 * V_14 = V_39 -> V_137 . V_14 ;
struct V_11 * V_12 ;
struct V_1 * V_2 = V_47 -> V_349 ;
int V_153 = V_25 -> V_261 + V_437 ;
int V_438 , V_439 ;
if ( V_30 )
V_436 -> V_13 = (struct V_49 * ) V_30 -> V_15 ;
else if ( V_14 && F_167 ( V_75 -> V_81 ) ) {
V_12 = ( void * ) V_14 -> V_15 ;
V_436 -> V_13 = & V_12 -> V_440 ;
}
if ( V_39 -> V_137 . V_418 )
V_153 += V_39 -> V_137 . V_418 -> V_441 ;
F_176 ( F_113 ( V_2 -> V_90 ) , V_25 ) ;
if ( ( V_14 && V_14 -> type != V_442 &&
V_14 -> type != V_443 ) ||
! F_167 ( V_75 -> V_81 ) )
V_39 -> V_55 |= V_187 ;
V_438 = F_178 ( V_75 -> V_81 ) ;
V_439 = V_438 & 3 ;
if ( V_439 && V_25 -> V_261 > V_438 ) {
if ( F_179 ( V_25 ) < V_439 )
return - V_444 ;
F_180 ( V_25 , V_439 ) ;
memmove ( V_25 -> V_80 , V_25 -> V_80 + V_439 , V_438 ) ;
}
...
struct V_5 * V_6 = NULL ;
struct V_35 * V_36 ;
bool V_217 , V_445 = false , V_446 ;
int V_41 , V_447 ;
if ( V_14 )
V_12 = ( void * ) V_14 -> V_15 ;
if ( V_39 -> V_55 & V_448 )
V_436 -> V_449 = true ;
V_446 = ! ! ( V_39 -> V_137 . V_55 & V_450 ) ;
V_447 = F_177 ( V_47 , V_25 , V_436 ) ;
if ( V_447 )
return V_447 ;
V_75 = (struct V_74 * ) V_25 -> V_80 ;
V_41 = F_182 ( V_25 ) ;
...
if ( V_436 -> V_13 && V_217 )
V_6 = F_19 ( V_2 , V_436 -> V_13 , V_25 ) ;
if ( ! V_445 && V_446 ) {
F_2 ( V_2 , V_4 ) ;
V_4 = V_2 -> V_42 . V_314 ;
F_1 ( V_2 , V_4 ) ;
} else if ( V_436 -> V_13 && V_217 ) {
F_16 ( V_6 -> V_8 -> V_4 != V_436 -> V_4 ) ;
if ( V_39 -> V_55 & V_187 )
V_6 -> V_8 -> V_141 = true ;
F_43 ( V_4 -> V_78 , V_451 ) ;
F_70 ( & V_6 -> V_52 , V_25 ) ;
...
V_36 -> V_62 . V_256 = V_436 -> V_453 ;
if ( V_436 -> V_453 )
V_36 -> V_62 . V_454 = V_455 ;
F_12 ( V_14 , V_30 , V_36 ) ;
...
V_2 -> V_393 -> V_394 . V_457 / V_458 ;
do {
struct V_23 * V_40 = F_7 ( V_25 ) ;
if ( F_177 ( V_47 , V_25 , & V_436 ) )
break;
V_36 = F_27 ( V_2 , V_436 . V_4 , NULL , V_25 ) ;
if ( ! V_36 )
break;
V_36 -> V_109 = V_36 ;
F_12 ( V_14 , NULL , V_36 ) ;
...
F_1 ( V_2 , V_436 . V_4 ) ;
F_122 ( V_2 , V_36 , V_436 . V_4 , 0 ) ;
F_126 ( V_2 , V_436 . V_4 , & V_106 , false ) ;
F_43 ( V_436 . V_4 -> V_78 , V_416 ) ;
F_2 ( V_2 , V_436 . V_4 ) ;
}
...
if ( V_2 -> V_90 -> V_461 )
F_188 ( V_462 , & V_2 -> V_90 -> V_461 -> V_463 ) ;
if ( ! ( V_460 & V_72 ) ) {
if ( V_27 -> V_55 & V_316 )
V_27 -> V_55 |= V_464 ;
else
...
V_438 = F_178 ( V_75 -> V_81 ) ;
V_439 = V_438 & 3 ;
if ( V_439 && V_25 -> V_261 > V_438 + V_439 ) {
memmove ( V_25 -> V_80 + V_439 , V_25 -> V_80 , V_438 ) ;
F_189 ( V_25 , V_439 ) ;
}
F_190 ( & V_2 -> V_466 , V_55 ) ;
if ( ( V_2 -> V_467 & V_468 ) && ! V_4 -> V_147 ) {
V_2 -> V_467 &= ~ V_468 ;
F_157 ( V_264 , V_469 ,
L_9 ,
V_2 -> V_467 & ( V_470 |
...
F_196 ( V_2 , V_36 , V_59 , V_4 , V_460 ) ;
F_41 ( V_2 , V_25 , V_460 , V_4 ) ;
}
V_474:
V_36 -> V_37 = NULL ;
...
T_2 V_124 , V_477 ;
if ( V_94 )
V_27 -> V_478 . V_479 = V_59 -> V_480 ;
V_477 = V_59 -> V_126 ;
F_16 ( V_477 >= V_47 -> V_481 ) ;
if ( V_27 -> V_55 & V_56 ) {
V_27 -> V_55 |= V_482 ;
F_139 ( V_96 > V_95 ) ;
}
V_27 -> V_478 . V_483 = V_95 ;
V_27 -> V_478 . V_484 = V_95 - V_96 ;
if ( ( V_59 -> V_122 & V_139 ) == 0 &&
( V_27 -> V_55 & V_316 ) == 0 ) {
if ( F_48 ( V_59 -> V_129 & ( V_485 |
V_486 ) ) &&
F_167 ( V_75 -> V_81 ) &&
V_230 -> V_487 >= V_2 -> V_90 -> V_488 . V_489 )
V_27 -> V_478 . V_38 [ V_477 ] . V_73 =
V_47 -> V_490 ;
}
for ( V_124 = V_477 + 1 ; V_124 < V_47 -> V_481 ; V_124 ++ ) {
V_27 -> V_478 . V_38 [ V_124 ] . V_73 = 0 ;
V_27 -> V_478 . V_38 [ V_124 ] . V_150 = - 1 ;
}
V_27 -> V_478 . V_38 [ V_477 ] . V_73 = V_59 -> V_125 + 1 ;
}
static void F_197 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_229 * V_230 = V_2 -> V_90 ;
struct V_263 * V_264 = F_113 ( V_230 ) ;
struct V_35 * V_36 , * V_398 , * V_491 = NULL ;
struct V_9 V_57 ;
struct V_492 * V_493 ;
struct V_58 V_59 ;
int V_478 ;
...
if ( V_36 -> V_62 . V_93 ) {
V_491 = V_36 ;
if ( F_199 ( & V_491 -> V_10 , & V_4 -> V_379 ) )
break;
V_36 = F_155 ( V_491 -> V_10 . V_494 , struct V_35 ,
V_10 ) ;
}
V_398 = V_36 -> V_109 ;
V_493 = V_398 -> V_89 ;
memset ( & V_59 , 0 , sizeof( V_59 ) ) ;
V_478 = F_200 ( V_230 , V_493 , & V_59 ) ;
if ( V_478 == - V_495 )
break;
F_43 ( V_4 -> V_78 , V_496 ) ;
...
{
struct V_229 * V_230 = V_2 -> V_90 ;
V_98 V_497 = ( ( 1 << V_402 ) - 1 ) & V_230 -> V_498 ;
int V_124 ;
for ( V_124 = 0 ; V_124 < V_402 ; V_124 ++ ) {
if ( F_136 ( V_2 , V_124 ) && ( V_497 & ( 1 << V_124 ) ) )
...
if ( F_36 ( V_406 , & V_264 -> V_401 ) )
break;
V_478 = F_200 ( V_230 , NULL , ( void * ) & V_59 ) ;
if ( V_478 == - V_495 )
break;
if ( V_478 == - V_390 ) {
...
if ( V_59 . V_500 == V_2 -> V_394 . V_501 ) {
V_2 -> V_394 . V_502 = true ;
V_2 -> V_394 . V_503 = ! ( V_59 . V_122 & V_145 ) ;
if ( F_17 () ) {
F_204 ( V_2 , NULL ,
V_504 ) ;
}
...
V_4 = & V_2 -> V_42 . V_4 [ V_59 . V_500 ] ;
F_1 ( V_2 , V_4 ) ;
F_43 ( V_4 -> V_78 , V_496 ) ;
V_499 = & V_4 -> V_385 [ V_4 -> V_383 ] ;
if ( F_49 ( V_499 ) ) {
F_2 ( V_2 , V_4 ) ;
return;
}
V_36 = F_51 ( V_499 , struct V_35 , V_10 ) ;
if ( V_36 -> V_62 . V_93 ) {
F_52 ( & V_36 -> V_10 ) ;
F_53 ( V_2 , V_36 ) ;
V_36 = F_51 ( V_499 , struct V_35 , V_10 ) ;
...
static int F_206 ( struct V_1 * V_2 , int V_505 )
{
struct V_506 * V_507 = & V_2 -> V_508 ;
T_2 V_509 = V_2 -> V_90 -> V_91 . V_509 ;
V_507 -> V_510 = V_505 * V_509 ;
V_507 -> V_511 = F_207 ( V_2 -> V_83 , V_507 -> V_510 ,
& V_507 -> V_512 , V_513 ) ;
if ( ! V_507 -> V_511 )
return - V_444 ;
return 0 ;
...
{
int V_514 ;
V_514 = F_206 ( V_2 , V_515 ) ;
if ( ! V_514 )
F_209 ( V_2 -> V_90 , V_2 -> V_508 . V_511 ,
V_2 -> V_508 . V_512 ,
V_515 ) ;
return V_514 ;
}
int F_210 ( struct V_1 * V_2 , int V_516 )
{
struct V_263 * V_264 = F_113 ( V_2 -> V_90 ) ;
int error = 0 ;
F_137 ( & V_2 -> V_42 . V_86 ) ;
error = F_211 ( V_2 , & V_2 -> V_42 . V_517 , & V_2 -> V_42 . V_87 ,
L_12 , V_516 , 1 , 1 ) ;
if ( error != 0 ) {
F_142 ( V_264 ,
L_13 , error ) ;
...
error = F_211 ( V_2 , & V_2 -> V_394 . V_518 , & V_2 -> V_394 . V_519 ,
L_14 , V_458 , 1 , 1 ) ;
if ( error != 0 ) {
F_142 ( V_264 ,
L_15 , error ) ;
...
F_64 ( & V_6 -> V_53 ) ;
V_522 = F_6 ( V_22 ) ;
V_6 -> V_8 = & V_13 -> V_8 [ V_522 ] ;
}
for ( V_522 = 0 , V_8 = & V_13 -> V_8 [ V_522 ] ;
V_522 < V_408 ; V_522 ++ , V_8 ++ ) {
V_8 -> V_19 = false ;
V_8 -> V_141 = true ;
V_8 -> V_4 = V_2 -> V_42 . V_43 [ V_522 ] ;
F_31 ( & V_8 -> V_20 ) ;
}
}
...
F_12 ( V_2 -> V_526 , NULL , V_36 ) ;
F_159 ( V_2 -> V_90 , V_36 -> V_89 , V_36 -> V_312 ) ;
F_216 ( V_2 -> V_90 , V_436 -> V_4 -> V_78 ) ;
F_163 ( V_2 , V_436 -> V_4 , NULL , V_25 ) ;
return 0 ;
}
