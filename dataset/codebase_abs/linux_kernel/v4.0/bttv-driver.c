...
static int F_122 ( struct V_415 * V_293 )
{
int V_298 = - 1 , V_53 ;
for ( V_53 = 0 ; V_53 < V_245 ; V_53 ++ ) {
...
static int F_126 ( struct V_289 * V_289 , void * V_293 , unsigned int V_422 )
{
struct V_16 * V_17 = V_293 ;
struct V_9 * V_10 = V_17 -> V_10 ;
struct V_247 * V_248 ;
int V_360 = 0 ;
if ( V_422 ) {
if ( F_127 ( ! V_10 -> V_278 . V_365 ) ) {
return - V_97 ;
}
if ( F_127 ( ! V_17 -> V_366 . V_368 ) ) {
...
{
struct V_16 * V_17 = V_290 ;
return F_131 ( F_108 ( V_17 ) , V_428 ) ;
}
static int F_132 ( struct V_289 * V_289 , void * V_290 ,
struct V_429 * V_332 )
{
struct V_16 * V_17 = V_290 ;
return F_133 ( F_108 ( V_17 ) , V_332 ) ;
}
static int F_134 ( struct V_289 * V_289 , void * V_290 , struct V_429 * V_332 )
{
struct V_16 * V_17 = V_290 ;
struct V_9 * V_10 = V_17 -> V_10 ;
int V_373 = F_109 ( V_17 ) ;
...
return - V_345 ;
return F_135 ( F_108 ( V_17 ) , V_332 ) ;
}
static int F_136 ( struct V_289 * V_289 , void * V_290 , struct V_429 * V_332 )
{
struct V_16 * V_17 = V_290 ;
return F_137 ( F_108 ( V_17 ) , V_332 ,
V_289 -> V_430 & V_431 ) ;
}
...
static int F_146 ( struct V_289 * V_289 , void * V_293 , struct V_443 * V_26 )
{
struct V_16 * V_17 = V_293 ;
struct V_9 * V_10 = V_17 -> V_10 ;
if ( V_26 -> type != V_370 &&
...
static int F_147 ( struct V_289 * V_289 , void * V_293 , const struct V_443 * V_26 )
{
struct V_16 * V_17 = V_293 ;
struct V_9 * V_10 = V_17 -> V_10 ;
const struct V_331 * V_332 ;
...
V_445 = F_148 ( V_332 -> V_25 , V_10 -> V_29 ) ;
if ( V_445 + 32 >= V_447 ) {
return V_360 ;
}
V_11 . V_28 . V_276 = F_149 ( V_448 , V_26 -> V_11 . V_276 , V_444 , V_446 - 48 ) ;
V_11 . V_28 . V_276 = F_94 ( V_11 . V_28 . V_276 , ( T_2 ) V_336 ) ;
V_11 . V_28 . V_145 = F_149 ( V_448 , V_26 -> V_11 . V_145 ,
48 , V_446 - V_11 . V_28 . V_276 ) ;
V_11 . V_28 . V_25 = F_149 ( V_448 , V_26 -> V_11 . V_25 , V_445 , V_447 - 32 ) ;
V_11 . V_28 . V_25 = ( V_11 . V_28 . V_25 + 1 ) & ~ 1 ;
V_11 . V_28 . V_39 = F_149 ( V_448 , V_26 -> V_11 . V_39 ,
...
V_360 = F_151 ( & V_17 -> V_255 , V_237 , V_280 , V_449 ,
V_289 -> V_430 & V_431 ) ;
...
return - V_345 ;
V_360 = F_152 ( & V_17 -> V_372 , V_237 , V_280 , V_449 , 1 ,
V_289 -> V_430 & V_431 ) ;
break;
default:
F_99 () ;
...
static unsigned int F_153 ( struct V_289 * V_289 , T_10 * V_452 )
{
struct V_16 * V_17 = V_289 -> V_450 ;
struct V_247 * V_5 ;
enum V_260 V_261 ;
unsigned int V_264 = 0 ;
unsigned long V_453 = F_154 ( V_452 ) ;
if ( F_155 ( & V_17 -> V_17 ) )
V_264 = V_454 ;
else if ( V_453 & V_454 )
F_156 ( V_289 , & V_17 -> V_17 . V_452 , V_452 ) ;
if ( ! ( V_453 & ( V_455 | V_456 ) ) )
return V_264 ;
if ( V_371 == V_17 -> type ) {
if ( ! F_11 ( V_17 -> V_10 , V_17 , V_374 ) )
return V_264 | V_457 ;
return V_264 | F_157 ( V_289 , & V_17 -> V_372 , V_452 ) ;
}
if ( F_12 ( V_17 , V_22 ) ) {
if ( F_158 ( & V_17 -> V_255 . V_458 ) )
return V_264 | V_457 ;
V_5 = F_159 ( V_17 -> V_255 . V_458 . V_459 , struct V_247 , V_250 . V_458 ) ;
} else {
...
F_156 ( V_289 , & V_5 -> V_250 . V_468 , V_452 ) ;
...
V_289 -> V_450 = V_17 ;
* V_17 = V_10 -> V_369 ;
F_165 ( & V_17 -> V_17 , V_325 ) ;
V_17 -> type = type ;
V_17 -> V_366 . V_368 = 0 ;
F_166 ( & V_17 -> V_255 , & V_471 ,
& V_10 -> V_11 . V_396 -> V_8 , & V_10 -> V_166 ,
V_370 ,
V_352 ,
sizeof( struct V_247 ) ,
V_17 , & V_10 -> V_472 ) ;
F_166 ( & V_17 -> V_372 , & V_473 ,
& V_10 -> V_11 . V_396 -> V_8 , & V_10 -> V_166 ,
V_371 ,
V_386 ,
sizeof( struct V_247 ) ,
...
static int
F_174 ( struct V_289 * V_289 , struct V_475 * V_476 )
{
struct V_16 * V_17 = V_289 -> V_450 ;
F_22 ( L_26 ,
V_17 -> V_10 -> V_11 . V_58 , V_451 [ V_17 -> type ] ,
V_476 -> V_477 , V_476 -> V_478 - V_476 -> V_477 ) ;
return F_175 ( F_108 ( V_17 ) , V_476 ) ;
}
...
V_10 -> V_312 ( V_10 , V_310 , 0 ) ;
if ( V_10 -> V_322 )
return F_179 ( & V_10 -> V_323 , V_310 ) ;
return 0 ;
}
static int F_180 ( struct V_289 * V_289 , void * V_290 ,
const struct V_309 * V_310 )
{
struct V_16 * V_17 = V_290 ;
struct V_9 * V_10 = V_17 -> V_10 ;
...
struct V_9 * V_10 = V_17 -> V_10 ;
if ( V_10 -> V_322 )
return F_182 ( V_289 , & V_10 -> V_323 , V_485 ) ;
return - V_486 ;
}
...
struct V_9 * V_10 = V_17 -> V_10 ;
if ( V_10 -> V_322 )
return F_184 ( & V_10 -> V_323 , V_488 ) ;
return - V_486 ;
}
static T_1 F_185 ( struct V_289 * V_289 , char T_7 * V_237 ,
T_8 V_280 , T_9 * V_449 )
{
struct V_16 * V_17 = V_289 -> V_450 ;
struct V_9 * V_10 = V_17 -> V_10 ;
...
static unsigned int F_186 ( struct V_289 * V_289 , T_10 * V_452 )
{
struct V_16 * V_17 = V_289 -> V_450 ;
struct V_9 * V_10 = V_17 -> V_10 ;
unsigned long V_453 = F_154 ( V_452 ) ;
...
for ( V_53 = F_189 ( V_44 ) - 1 ; V_53 >= 0 ; V_53 -- )
if ( V_497 & ( 1 << ( V_53 + 12 ) ) )
F_188 ( L_55 , V_44 [ V_53 ] ) ;
F_188 ( L_56 , V_497 & 0xfff ) ;
...
V_359 = F_187 ( F_191 ( V_497 -> V_510 [ V_53 ] ) ) ;
...
static void F_193 ( T_4 V_514 , T_4 V_515 )
{
unsigned int V_53 ;
F_188 ( L_64 ) ;
for ( V_53 = 0 ; V_53 < F_189 ( V_516 ) ; V_53 ++ ) {
if ( V_514 & ( 1 << V_53 ) )
F_188 ( L_55 , V_516 [ V_53 ] ) ;
if ( V_515 & ( 1 << V_53 ) )
F_188 ( L_65 ) ;
}
}
static void F_194 ( struct V_9 * V_10 , T_4 V_264 )
{
F_195 ( L_66 ,
V_10 -> V_11 . V_58 ,
( unsigned long ) V_10 -> main. V_511 ,
( unsigned long ) F_191 ( V_10 -> main. V_510 [ V_517 + 1 ] ) ,
( unsigned long ) F_191 ( V_10 -> main. V_510 [ V_518 + 1 ] ) ,
( unsigned long ) V_264 ) ;
...
static int
F_198 ( struct V_9 * V_10 , struct V_519 * V_520 )
{
struct V_247 * V_521 ;
memset ( V_520 , 0 , sizeof( * V_520 ) ) ;
if ( ! F_158 ( & V_10 -> V_286 ) ) {
V_520 -> V_168 = 1 ;
V_521 = F_159 ( V_10 -> V_286 . V_459 , struct V_247 , V_250 . V_285 ) ;
if ( F_199 ( V_521 -> V_250 . V_261 ) )
V_520 -> V_25 = V_521 ;
if ( F_200 ( V_521 -> V_250 . V_261 ) )
V_520 -> V_513 = V_521 ;
if ( ! F_93 ( V_521 -> V_250 . V_261 ) &&
( V_521 -> V_250 . V_285 . V_459 != & V_10 -> V_286 ) ) {
V_521 = F_159 ( V_521 -> V_250 . V_285 . V_459 , struct V_247 , V_250 . V_285 ) ;
if ( ! F_93 ( V_521 -> V_250 . V_261 ) ) {
if ( NULL == V_520 -> V_513 &&
...
static void
F_201 ( struct V_9 * V_10 , struct V_519 * V_523 ,
...
F_203 ( & V_523 -> V_513 -> V_250 . V_468 ) ;
}
}
}
static void
F_204 ( struct V_9 * V_10 , struct V_247 * V_523 ,
unsigned int V_251 )
{
struct V_524 V_525 ;
if ( NULL == V_523 )
return;
F_202 ( & V_525 ) ;
V_523 -> V_250 . V_525 = V_525 ;
V_523 -> V_250 . V_242 = V_10 -> V_242 ;
V_523 -> V_250 . V_251 = V_251 ;
F_203 ( & V_523 -> V_250 . V_468 ) ;
}
static void F_205 ( unsigned long V_237 )
{
...
F_207 ( V_10 , NULL ) ;
F_59 ( V_10 , 0 ) ;
F_201 ( V_10 , & V_249 , & V_248 , V_469 ) ;
F_204 ( V_10 , V_527 , V_469 ) ;
while ( ! F_158 ( & V_10 -> V_286 ) ) {
V_521 = F_159 ( V_10 -> V_286 . V_459 , struct V_247 , V_250 . V_285 ) ;
F_208 ( & V_521 -> V_250 . V_285 ) ;
V_521 -> V_250 . V_251 = V_469 ;
F_203 ( & V_521 -> V_250 . V_468 ) ;
}
while ( ! F_158 ( & V_10 -> V_532 ) ) {
V_521 = F_159 ( V_10 -> V_532 . V_459 , struct V_247 , V_250 . V_285 ) ;
F_208 ( & V_521 -> V_250 . V_285 ) ;
V_521 -> V_250 . V_251 = V_469 ;
F_203 ( & V_521 -> V_250 . V_468 ) ;
}
...
F_211 ( V_10 , V_518 , NULL , 0 ) ;
F_202 ( & V_523 -> V_250 . V_525 ) ;
V_523 -> V_250 . V_242 = V_10 -> V_242 ;
V_523 -> V_250 . V_251 = V_252 ;
F_203 ( & V_523 -> V_250 . V_468 ) ;
F_212 ( & V_10 -> V_166 ) ;
}
static inline int F_213 ( struct V_508 * V_497 , T_4 V_264 )
{
...
F_198 ( V_10 , & V_248 ) ;
V_264 = F_16 ( V_531 ) ;
if ( ( V_10 -> V_167 . V_25 && F_213 ( & V_10 -> V_167 . V_25 -> V_25 , V_264 ) ) ||
( V_10 -> V_167 . V_513 && F_213 ( & V_10 -> V_167 . V_513 -> V_513 , V_264 ) ) ) {
V_10 -> V_528 ++ ;
if ( V_533 )
F_194 ( V_10 , V_264 ) ;
F_212 ( & V_10 -> V_166 ) ;
...
F_210 ( & V_10 -> V_166 ) ;
if ( ! F_158 ( & V_10 -> V_532 ) )
V_248 = F_159 ( V_10 -> V_532 . V_459 , struct V_247 , V_250 . V_285 ) ;
V_249 = V_10 -> V_512 ;
V_264 = F_16 ( V_531 ) ;
if ( NULL != V_249 && ( F_213 ( & V_249 -> V_25 , V_264 ) ||
F_213 ( & V_249 -> V_513 , V_264 ) ) ) {
V_10 -> V_528 ++ ;
if ( V_533 )
F_194 ( V_10 , V_264 ) ;
F_212 ( & V_10 -> V_166 ) ;
...
F_207 ( V_10 , V_248 ) ;
F_59 ( V_10 , 0 ) ;
F_204 ( V_10 , V_249 , V_252 ) ;
F_212 ( & V_10 -> V_166 ) ;
}
static T_12 F_216 ( int V_534 , void * V_535 )
{
T_4 V_536 , V_537 ;
T_4 V_538 ;
int V_280 ;
...
static struct V_6 * F_219 ( struct V_9 * V_10 ,
...
if ( V_389 > 0 )
F_196 ( L_95 ) ;
V_10 -> V_394 = F_219 ( V_10 , & V_554 , L_96 ) ;
if ( NULL == V_10 -> V_394 )
goto V_291;
if ( F_227 ( V_10 -> V_394 , V_411 ,
V_555 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_291;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_163 ( V_10 -> V_394 ) ) ;
if ( F_228 ( & V_10 -> V_394 -> V_8 ,
& V_556 ) < 0 ) {
F_19 ( L_98 , V_10 -> V_11 . V_58 ) ;
goto V_291;
}
V_10 -> V_403 = F_219 ( V_10 , & V_554 , L_99 ) ;
if ( NULL == V_10 -> V_403 )
goto V_291;
if ( F_227 ( V_10 -> V_403 , V_413 ,
...
if ( ! V_10 -> V_558 )
return 0 ;
V_10 -> V_405 = F_219 ( V_10 , & V_559 , L_100 ) ;
if ( NULL == V_10 -> V_405 )
goto V_291;
V_10 -> V_405 -> V_121 = & V_10 -> V_560 ;
if ( F_227 ( V_10 -> V_405 , V_561 ,
V_562 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_291;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_163 ( V_10 -> V_405 ) ) ;
return 0 ;
V_291:
F_223 ( V_10 ) ;
return - 1 ;
}
static void F_229 ( struct V_563 * V_8 )
{
#if F_230 ( V_564 )
unsigned int V_481 ;
F_231 ( V_8 , V_565 , & V_481 ) ;
V_481 = ( V_481 | V_566 ) ;
F_232 ( V_8 , V_565 , V_481 ) ;
#endif
}
static int F_233 ( struct V_563 * V_8 , const struct V_567 * V_568 )
{
struct V_314 V_569 = {
. V_287 = 0 ,
. type = V_440 ,
...
return - V_363 ;
F_23 ( L_101 , V_573 ) ;
V_575 [ V_573 ] = V_10 = F_234 ( sizeof( * V_10 ) , V_362 ) ;
if ( V_10 == NULL ) {
F_19 ( L_102 ) ;
return - V_363 ;
}
...
F_236 ( & V_10 -> V_576 ) ;
F_237 ( & V_10 -> V_543 ) ;
F_238 ( & V_10 -> V_11 . V_577 ) ;
F_238 ( & V_10 -> V_286 ) ;
F_238 ( & V_10 -> V_532 ) ;
F_239 ( & V_10 -> V_578 ) ;
V_10 -> V_578 . V_579 = F_205 ;
...
V_10 -> V_149 = V_8 -> V_1 ;
if ( F_240 ( V_8 ) ) {
F_195 ( L_104 , V_10 -> V_11 . V_58 ) ;
return - V_582 ;
}
if ( F_241 ( V_8 , F_242 ( 32 ) ) ) {
F_195 ( L_105 , V_10 -> V_11 . V_58 ) ;
return - V_582 ;
}
if ( ! F_243 ( F_244 ( V_8 , 0 ) ,
F_245 ( V_8 , 0 ) ,
V_10 -> V_11 . V_326 . V_301 ) ) {
F_195 ( L_106 ,
V_10 -> V_11 . V_58 ,
( unsigned long long ) F_244 ( V_8 , 0 ) ) ;
return - V_345 ;
}
F_246 ( V_8 ) ;
F_229 ( V_8 ) ;
V_493 = F_247 ( & V_8 -> V_8 , & V_10 -> V_11 . V_326 ) ;
if ( V_493 < 0 ) {
F_195 ( L_107 , V_10 -> V_11 . V_58 ) ;
goto V_583;
}
V_572 = & V_10 -> V_121 ;
F_248 ( V_572 , 20 ) ;
...
F_252 ( V_10 ) ;
F_17 ( 0 , V_175 ) ;
V_493 = F_253 ( V_10 -> V_11 . V_396 -> V_534 , F_216 ,
...
F_256 ( V_572 , & V_590 , NULL ) ;
F_256 ( V_572 , & V_595 , NULL ) ;
F_256 ( V_572 , & V_592 , NULL ) ;
F_256 ( V_572 , & V_596 , NULL ) ;
F_256 ( V_572 , & V_599 , NULL ) ;
F_256 ( V_572 , & V_602 , NULL ) ;
F_256 ( V_572 , & V_600 , NULL ) ;
F_256 ( V_572 , & V_605 , NULL ) ;
F_256 ( V_572 , & V_606 , NULL ) ;
F_256 ( V_572 , & V_608 , NULL ) ;
if ( V_115 )
F_39 ( V_10 , L_111 ) ;
F_257 ( V_10 ) ;
F_56 ( V_10 ) ;
...
return 0 ;
V_588:
F_266 ( V_10 -> V_11 . V_396 -> V_534 , V_10 ) ;
V_586:
F_267 ( & V_10 -> V_121 ) ;
F_267 ( & V_10 -> V_560 ) ;
F_268 ( & V_10 -> V_11 . V_326 ) ;
V_583:
if ( V_10 -> V_585 )
F_269 ( V_10 -> V_585 ) ;
F_270 ( F_244 ( V_10 -> V_11 . V_396 , 0 ) ,
F_245 ( V_10 -> V_11 . V_396 , 0 ) ) ;
return V_493 ;
}
...
static int F_283 ( struct V_563 * V_563 )
{
struct V_618 * V_326 = F_272 ( V_563 ) ;
struct V_9 * V_10 = F_273 ( V_326 ) ;
unsigned long V_164 ;
...
F_285 ( V_10 -> V_251 . V_623 ) ;
F_53 ( & V_10 -> V_166 , V_164 ) ;
V_10 -> V_167 = V_10 -> V_251 . V_162 ;
V_10 -> V_512 = V_10 -> V_251 . V_372 ;
V_10 -> V_254 = V_10 -> V_251 . V_254 ;
F_206 ( V_10 , & V_10 -> V_167 ) ;
F_207 ( V_10 , V_10 -> V_512 ) ;
F_59 ( V_10 , 0 ) ;
F_54 ( & V_10 -> V_166 , V_164 ) ;
return 0 ;
}
static int T_14 F_286 ( void )
{
int V_626 ;
V_573 = 0 ;
F_23 ( L_118 , V_627 ) ;
