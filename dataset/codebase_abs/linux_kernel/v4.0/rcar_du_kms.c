...
{
static const unsigned int V_61 [] = {
V_62 , V_63
} ;
...
V_8 -> V_68 . V_72 = 2047 ;
V_8 -> V_68 . V_73 = & V_74 ;
V_11 -> V_75 = V_11 -> V_56 -> V_75 ;
V_67 = F_3 ( V_11 -> V_75 , 2 ) ;
for ( V_3 = 0 ; V_3 < V_67 ; ++ V_3 ) {
struct V_76 * V_77 = & V_11 -> V_78 [ V_3 ] ;
V_77 -> V_8 = V_11 ;
V_77 -> V_79 = V_61 [ V_3 ] ;
V_77 -> V_80 = V_3 ;
V_48 = F_26 ( V_77 ) ;
...
for ( V_3 = 0 ; V_3 < V_11 -> V_75 ; ++ V_3 ) {
struct V_76 * V_77 = & V_11 -> V_78 [ V_3 / 2 ] ;
V_48 = F_27 ( V_77 , V_3 ) ;
if ( V_48 < 0 )
return V_48 ;
}
...
struct V_81 * V_82 = F_31 ( V_44 ) ;
const struct V_83 * V_84 =
& V_11 -> V_56 -> V_57 [ V_82 -> V_31 ] ;
V_44 -> V_58 = V_84 -> V_58 ;
V_44 -> V_85 = ( 1 << V_54 ) - 1 ;
}
for ( V_3 = 0 ; V_3 < V_67 ; ++ V_3 ) {
V_48 = F_32 ( & V_11 -> V_78 [ V_3 ] ) ;
if ( V_48 < 0 )
return V_48 ;
}
F_33 ( V_8 ) ;
F_34 ( V_8 ) ;
V_29 = F_35 ( V_8 , 32 , V_8 -> V_68 . V_86 ,
V_8 -> V_68 . V_87 ) ;
if ( F_36 ( V_29 ) )
return F_37 ( V_29 ) ;
#ifndef F_38
