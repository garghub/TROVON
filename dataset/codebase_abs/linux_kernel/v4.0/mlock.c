...
F_34 ( V_21 & ~ V_29 ) ;
F_34 ( V_22 & ~ V_29 ) ;
F_35 ( V_21 < V_20 -> V_30 , V_20 ) ;
F_35 ( V_22 > V_20 -> V_31 , V_20 ) ;
F_36 ( ! F_37 ( & V_25 -> V_32 ) , V_25 ) ;
V_28 = V_33 | V_34 ;
if ( ( V_20 -> V_35 & ( V_36 | V_37 ) ) == V_36 )
V_28 |= V_38 ;
if ( V_20 -> V_35 & ( V_39 | V_36 | V_40 ) )
V_28 |= V_41 ;
return F_38 ( V_42 , V_25 , V_21 , V_14 , V_28 ,
NULL , NULL , V_23 ) ;
}
static int F_39 ( long V_43 )
{
if ( V_43 == - V_44 )
V_43 = - V_45 ;
else if ( V_43 == - V_45 )
...
static bool F_40 ( struct V_3 * V_3 , struct V_47 * V_48 ,
int * V_49 )
{
F_41 ( F_18 ( V_3 ) , V_3 ) ;
F_41 ( ! F_15 ( V_3 ) , V_3 ) ;
if ( F_25 ( V_3 ) <= 1 && F_42 ( V_3 ) ) {
F_43 ( V_48 , V_3 ) ;
if ( F_44 ( V_3 ) )
( * V_49 ) ++ ;
F_45 ( V_3 ) ;
...
static void F_46 ( struct V_47 * V_48 , int V_49 )
{
F_47 ( V_13 , F_48 ( V_48 ) ) ;
F_49 ( V_48 ) ;
F_47 ( V_50 , V_49 ) ;
}
static void F_50 ( struct V_47 * V_48 , struct V_15 * V_15 )
{
int V_51 ;
int V_52 = F_48 ( V_48 ) ;
int V_53 ;
...
static unsigned long F_55 ( struct V_47 * V_48 ,
struct V_19 * V_20 , int V_56 , unsigned long V_21 ,
unsigned long V_22 )
{
T_1 * V_57 ;
T_2 * V_58 ;
V_57 = F_56 ( V_20 -> V_26 , V_21 , & V_58 ) ;
V_22 = F_57 ( V_21 , V_22 ) ;
V_22 = F_58 ( V_21 , V_22 ) ;
V_22 = F_59 ( V_21 , V_22 ) ;
V_21 += V_27 ;
...
V_57 ++ ;
if ( F_60 ( * V_57 ) )
V_3 = F_61 ( V_20 , V_21 , * V_57 ) ;
if ( ! V_3 || F_62 ( V_3 ) != V_56 )
break;
F_20 ( V_3 ) ;
V_21 += V_27 ;
if ( F_43 ( V_48 , V_3 ) == 0 )
...
static int F_69 ( struct V_19 * V_20 , struct V_19 * * V_66 ,
...
F_70 ( V_20 ) || V_20 == F_71 ( V_42 -> V_25 ) )
goto V_18;
V_68 = V_20 -> V_71 + ( ( V_21 - V_20 -> V_30 ) >> V_65 ) ;
* V_66 = F_72 ( V_25 , * V_66 , V_21 , V_22 , V_67 , V_20 -> V_72 ,
V_20 -> V_73 , V_68 , F_73 ( V_20 ) ) ;
if ( * V_66 ) {
V_20 = * V_66 ;
goto V_74;
}
if ( V_21 != V_20 -> V_30 ) {
V_10 = F_74 ( V_25 , V_20 , V_21 , 1 ) ;
if ( V_10 )
goto V_18;
}
if ( V_22 != V_20 -> V_31 ) {
V_10 = F_74 ( V_25 , V_20 , V_22 , 0 ) ;
if ( V_10 )
goto V_18;
}
V_74:
...
static int F_75 ( unsigned long V_21 , T_5 V_76 , int V_77 )
{
...
if ( V_79 > V_22 )
V_79 = V_22 ;
error = F_69 ( V_20 , & V_66 , V_78 , V_79 , V_67 ) ;
if ( error )
break;
V_78 = V_79 ;
if ( V_78 < V_66 -> V_31 )
...
int F_78 ( unsigned long V_21 , unsigned long V_76 , int V_83 )
{
...
if ( V_88 & V_92 )
V_67 |= V_59 ;
F_69 ( V_20 , & V_66 , V_20 -> V_30 , V_20 -> V_31 , V_67 ) ;
F_83 () ;
}
V_18:
return 0 ;
}
int F_84 ( T_5 V_93 , struct V_94 * V_95 )
{
...
void F_88 ( T_5 V_93 , struct V_94 * V_95 )
{
F_85 ( & V_99 ) ;
