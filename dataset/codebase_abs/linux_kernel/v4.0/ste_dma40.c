...
static enum V_300 F_141 ( struct V_172 * V_4 ,
T_3 V_177 ,
struct V_301 * V_302 )
{
struct V_2 * V_3 = F_77 ( V_4 , struct V_2 , V_4 ) ;
...
static void T_9 F_152 ( struct V_187 * V_8 , struct V_327 * V_328 ,
struct V_2 * V_329 , int V_195 ,
int V_330 )
{
int V_33 = 0 ;
struct V_2 * V_3 ;
F_24 ( & V_328 -> V_331 ) ;
for ( V_33 = V_195 ; V_33 < V_195 + V_330 ; V_33 ++ ) {
V_3 = & V_329 [ V_33 ] ;
V_3 -> V_8 = V_8 ;
V_3 -> V_4 . V_1 = V_328 ;
F_153 ( & V_3 -> V_37 ) ;
...
static void F_155 ( struct V_187 * V_8 , struct V_327 * V_5 )
{
...
if ( F_103 ( V_336 , V_5 -> V_235 ) )
V_5 -> V_337 = F_136 ;
if ( F_103 ( V_338 , V_5 -> V_235 ) )
V_5 -> V_339 = F_139 ;
V_5 -> V_340 = F_130 ;
V_5 -> V_341 = F_132 ;
V_5 -> V_342 = F_144 ;
...
{
int V_178 ;
F_152 ( V_8 , & V_8 -> V_349 , V_8 -> V_350 ,
0 , V_8 -> V_205 ) ;
F_122 ( V_8 -> V_349 . V_235 ) ;
F_123 ( V_237 , V_8 -> V_349 . V_235 ) ;
F_123 ( V_338 , V_8 -> V_349 . V_235 ) ;
F_155 ( V_8 , & V_8 -> V_349 ) ;
V_178 = F_157 ( & V_8 -> V_349 ) ;
if ( V_178 ) {
F_94 ( V_8 -> V_5 , L_46 ) ;
goto V_351;
}
F_152 ( V_8 , & V_8 -> V_352 , V_8 -> V_350 ,
V_8 -> V_205 , V_8 -> V_353 ) ;
F_122 ( V_8 -> V_352 . V_235 ) ;
F_123 ( V_236 , V_8 -> V_352 . V_235 ) ;
F_123 ( V_336 , V_8 -> V_352 . V_235 ) ;
F_155 ( V_8 , & V_8 -> V_352 ) ;
V_178 = F_157 ( & V_8 -> V_352 ) ;
if ( V_178 ) {
F_94 ( V_8 -> V_5 ,
L_47 ) ;
goto V_354;
}
F_152 ( V_8 , & V_8 -> V_355 , V_8 -> V_356 ,
0 , V_348 ) ;
F_122 ( V_8 -> V_355 . V_235 ) ;
F_123 ( V_237 , V_8 -> V_355 . V_235 ) ;
F_123 ( V_236 , V_8 -> V_355 . V_235 ) ;
F_123 ( V_336 , V_8 -> V_355 . V_235 ) ;
F_123 ( V_338 , V_8 -> V_349 . V_235 ) ;
F_155 ( V_8 , & V_8 -> V_355 ) ;
V_178 = F_157 ( & V_8 -> V_355 ) ;
if ( V_178 ) {
F_94 ( V_8 -> V_5 ,
L_48 ) ;
goto V_357;
...
{
struct V_358 * V_359 = F_160 ( V_5 ) ;
struct V_187 * V_8 = F_161 ( V_359 ) ;
int V_34 ;
V_34 = F_162 ( V_5 ) ;
if ( V_34 )
return V_34 ;
if ( V_8 -> V_360 )
V_34 = F_163 ( V_8 -> V_360 ) ;
return V_34 ;
}
...
int V_34 = 0 ;
if ( V_8 -> V_360 ) {
V_34 = F_165 ( V_8 -> V_360 ) ;
if ( V_34 )
return V_34 ;
}
return F_166 ( V_5 ) ;
}
static void F_167 ( void T_1 * V_361 , T_2 * V_362 ,
T_2 * V_363 , int V_12 , bool V_364 )
{
int V_33 ;
for ( V_33 = 0 ; V_33 < V_12 ; V_33 ++ ) {
void T_1 * V_123 = V_361 + V_363 [ V_33 ] ;
if ( V_364 )
V_362 [ V_33 ] = F_168 ( V_123 ) ;
else
F_169 ( V_362 [ V_33 ] , V_123 ) ;
}
}
static void F_170 ( struct V_187 * V_8 , bool V_364 )
{
int V_33 ;
for ( V_33 = 0 ; V_33 < V_8 -> V_206 ; V_33 ++ ) {
void T_1 * V_123 ;
int V_39 ;
if ( V_8 -> V_226 [ V_33 ] . V_365 )
continue;
V_123 = V_8 -> V_9 + V_10 + V_33 * V_13 ;
V_39 = V_33 * F_171 ( V_366 ) ;
F_167 ( V_123 , & V_8 -> V_367 [ V_39 ] ,
V_366 ,
F_171 ( V_366 ) ,
V_364 ) ;
}
F_167 ( V_8 -> V_9 , V_8 -> V_368 ,
V_369 , F_171 ( V_369 ) ,
V_364 ) ;
if ( V_8 -> V_189 . V_362 )
F_167 ( V_8 -> V_9 , V_8 -> V_370 ,
V_8 -> V_189 . V_362 ,
V_8 -> V_189 . V_371 ,
V_364 ) ;
}
...
int V_376 = - 2 ;
int V_377 = V_378 ;
V_133 [ 0 ] = F_53 ( V_8 -> V_9 + V_379 ) ;
V_133 [ 1 ] = F_53 ( V_8 -> V_9 + V_380 ) ;
for ( V_33 = 0 ; V_33 < V_8 -> V_206 ; V_33 ++ ) {
V_8 -> V_226 [ V_33 ] . V_12 = V_33 ;
V_376 += 2 * ( ( V_33 % 2 ) == 0 ) ;
if ( ( ( V_133 [ V_33 % 2 ] >> V_376 ) & 3 ) == 1 ) {
V_8 -> V_226 [ V_33 ] . V_213 = V_216 ;
V_8 -> V_226 [ V_33 ] . V_214 = V_216 ;
V_8 -> V_226 [ V_33 ] . V_365 = true ;
V_377 |= F_175 ( F_176 ( V_33 ) ,
V_381 ) ;
V_377 |= F_175 ( F_176 ( V_33 ) ,
V_382 ) ;
} else {
...
V_8 -> V_226 [ V_33 ] . V_365 = false ;
V_375 ++ ;
}
F_153 ( & V_8 -> V_226 [ V_33 ] . V_37 ) ;
}
for ( V_33 = 0 ; V_8 -> V_74 -> V_383 [ V_33 ] != - 1 ; V_33 ++ ) {
int V_4 = V_8 -> V_74 -> V_383 [ V_33 ] ;
V_8 -> V_226 [ V_4 ] . V_213 = V_216 ;
V_8 -> V_226 [ V_4 ] . V_214 = V_216 ;
V_8 -> V_226 [ V_4 ] . V_365 = true ;
V_377 |= F_175 ( F_176 ( V_4 ) ,
V_381 ) ;
V_377 |= F_175 ( F_176 ( V_4 ) ,
V_382 ) ;
V_375 -- ;
}
for ( V_33 = 0 ; V_33 < V_8 -> V_74 -> V_384 ; V_33 ++ ) {
int V_4 = V_8 -> V_74 -> V_385 [ V_33 ] ;
V_8 -> V_226 [ V_4 ] . V_76 = true ;
}
F_177 ( V_8 -> V_5 , L_49 ,
V_375 , V_8 -> V_206 ) ;
V_133 [ 0 ] = F_53 ( V_8 -> V_9 + V_386 ) ;
for ( V_33 = 0 ; V_33 < V_8 -> V_206 ; V_33 ++ ) {
...
F_30 ( V_374 , V_8 -> V_9 + V_373 ) ;
V_8 -> V_372 = V_377 ;
return V_375 ;
}
static struct V_187 * T_9 F_178 ( struct V_358 * V_359 )
{
struct V_387 * V_74 = F_179 ( & V_359 -> V_5 ) ;
struct V_388 * V_388 = NULL ;
void T_1 * V_9 = NULL ;
struct V_389 * V_173 = NULL ;
...
V_173 = F_183 ( V_359 , V_394 , L_53 ) ;
if ( ! V_173 )
goto V_393;
if ( F_184 ( V_173 -> V_395 , F_185 ( V_173 ) ,
V_396 L_54 ) == NULL )
goto V_393;
V_9 = F_186 ( V_173 -> V_395 , F_185 ( V_173 ) ) ;
if ( ! V_9 )
goto V_393;
for ( V_391 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_391 |= ( F_53 ( V_9 + F_185 ( V_173 ) - 0x20 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
for ( V_392 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_392 |= ( F_53 ( V_9 + F_185 ( V_173 ) - 0x10 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
if ( V_392 != V_397 ) {
F_94 ( & V_359 -> V_5 , L_55 ) ;
goto V_393;
}
if ( F_187 ( V_391 ) != V_398 ) {
F_94 ( & V_359 -> V_5 , L_56 ,
F_187 ( V_391 ) ,
V_398 ) ;
goto V_393;
...
V_277 = F_188 ( V_391 ) ;
if ( V_277 < 2 ) {
F_94 ( & V_359 -> V_5 , L_57 , V_277 ) ;
goto V_393;
}
if ( V_74 -> V_399 )
V_206 = V_74 -> V_399 ;
else
V_206 = 4 * ( F_53 ( V_9 + V_400 ) & 0x7 ) + 4 ;
if ( V_74 -> V_401 )
V_353 = V_74 -> V_401 ;
else
V_353 = F_171 ( V_239 ) ;
...
V_8 -> V_206 = V_206 ;
V_8 -> V_205 = V_205 ;
V_8 -> V_404 = V_173 -> V_395 ;
V_8 -> V_405 = F_185 ( V_173 ) ;
V_8 -> V_9 = V_9 ;
V_8 -> V_74 = V_74 ;
V_8 -> V_5 = & V_359 -> V_5 ;
V_8 -> V_356 = ( ( void * ) V_8 ) + F_47 ( sizeof( struct V_187 ) , 4 ) ;
V_8 -> V_350 = & V_8 -> V_356 [ V_206 ] ;
if ( V_8 -> V_74 -> V_399 == 14 ) {
V_8 -> V_189 . V_362 = V_406 ;
V_8 -> V_189 . V_371 = V_407 ;
V_8 -> V_189 . V_408 = V_409 ;
V_8 -> V_189 . V_410 = V_411 ;
V_8 -> V_189 . V_273 = V_412 ;
V_8 -> V_189 . V_274 = V_413 ;
V_8 -> V_189 . V_275 = V_414 ;
V_8 -> V_189 . V_276 = V_415 ;
V_8 -> V_189 . V_192 = V_416 ;
V_8 -> V_189 . V_190 = F_171 ( V_416 ) ;
V_8 -> V_189 . V_417 = V_418 ;
V_8 -> V_189 . V_419 = F_171 ( V_418 ) ;
} else {
if ( V_8 -> V_277 >= 3 ) {
V_8 -> V_189 . V_362 = V_420 ;
V_8 -> V_189 . V_371 = V_421 ;
}
V_8 -> V_189 . V_408 = V_422 ;
V_8 -> V_189 . V_410 = V_423 ;
V_8 -> V_189 . V_273 = V_424 ;
V_8 -> V_189 . V_274 = V_425 ;
V_8 -> V_189 . V_275 = V_426 ;
V_8 -> V_189 . V_276 = V_427 ;
V_8 -> V_189 . V_192 = V_428 ;
V_8 -> V_189 . V_190 = F_171 ( V_428 ) ;
V_8 -> V_189 . V_417 = V_429 ;
V_8 -> V_189 . V_419 = F_171 ( V_429 ) ;
}
...
if ( ! V_8 -> V_36 . V_40 )
goto V_393;
V_8 -> V_48 = F_190 ( V_396 , sizeof( struct V_14 ) ,
0 , V_430 ,
NULL ) ;
if ( V_8 -> V_48 == NULL )
goto V_393;
...
int V_33 ;
T_2 V_431 [ 2 ] = { 0 , 0 } ;
T_2 V_432 [ 2 ] = { 0xFFFFFFFF , 0xFFFFFFFF } ;
T_2 V_433 = 0 ;
T_2 V_434 = 0 ;
struct V_435 * V_436 = V_8 -> V_189 . V_417 ;
T_2 V_437 = V_8 -> V_189 . V_419 ;
for ( V_33 = 0 ; V_33 < V_437 ; V_33 ++ )
F_30 ( V_436 [ V_33 ] . V_133 ,
V_8 -> V_9 + V_436 [ V_33 ] . V_122 ) ;
for ( V_33 = 0 ; V_33 < V_8 -> V_206 ; V_33 ++ ) {
V_432 [ V_33 % 2 ] = V_432 [ V_33 % 2 ] << 2 ;
...
F_30 ( V_431 [ 1 ] , V_8 -> V_9 + V_153 ) ;
F_30 ( V_431 [ 0 ] , V_8 -> V_9 + V_438 ) ;
F_30 ( V_432 [ 1 ] , V_8 -> V_9 + V_112 ) ;
F_30 ( V_432 [ 0 ] , V_8 -> V_9 + V_113 ) ;
F_30 ( V_433 , V_8 -> V_9 + V_8 -> V_189 . V_408 ) ;
F_30 ( V_434 , V_8 -> V_9 + V_8 -> V_189 . V_410 ) ;
V_8 -> V_189 . V_417 = NULL ;
V_8 -> V_189 . V_419 = 0 ;
}
...
int V_33 , V_225 ;
int V_34 = 0 ;
V_439 = F_6 ( sizeof( unsigned long ) * V_440 ,
V_403 ) ;
if ( ! V_439 ) {
V_34 = - V_25 ;
goto V_393;
}
V_8 -> V_36 . V_441 = V_442 * V_8 -> V_206 / V_443 ;
for ( V_33 = 0 ; V_33 < V_440 ; V_33 ++ ) {
V_439 [ V_33 ] = F_197 ( V_403 ,
V_8 -> V_36 . V_441 ) ;
if ( ! V_439 [ V_33 ] ) {
F_94 ( V_8 -> V_5 , L_60 ,
V_8 -> V_36 . V_441 ) ;
...
F_198 ( V_439 [ V_225 ] , V_8 -> V_36 . V_441 ) ;
goto V_393;
}
if ( ( F_112 ( ( void * ) V_439 [ V_33 ] ) &
( V_444 - 1 ) ) == 0 )
break;
}
for ( V_225 = 0 ; V_225 < V_33 ; V_225 ++ )
F_198 ( V_439 [ V_225 ] , V_8 -> V_36 . V_441 ) ;
if ( V_33 < V_440 ) {
V_8 -> V_36 . V_8 = ( void * ) V_439 [ V_33 ] ;
} else {
F_199 ( V_8 -> V_5 ,
L_61 ,
V_128 , V_8 -> V_36 . V_441 ) ;
V_8 -> V_36 . V_445 = F_6 ( V_442 *
V_8 -> V_206 +
V_444 ,
V_403 ) ;
if ( ! V_8 -> V_36 . V_445 ) {
...
V_8 -> V_36 . V_8 = F_7 ( V_8 -> V_36 . V_445 ,
V_444 ) ;
}
...
static int T_9 F_200 ( struct V_358 * V_359 ,
struct V_332 * V_447 )
{
struct V_387 * V_448 ;
int V_449 = 0 , V_450 = 0 , V_451 = 0 ;
const T_11 * V_452 ;
V_448 = F_201 ( & V_359 -> V_5 ,
sizeof( struct V_387 ) ,
V_403 ) ;
if ( ! V_448 )
return - V_25 ;
F_202 ( V_447 , L_62 , & V_449 ) ;
if ( V_449 > 0 )
V_448 -> V_399 = V_449 ;
V_452 = F_203 ( V_447 , L_63 , & V_450 ) ;
V_450 /= sizeof( * V_452 ) ;
...
V_239 ,
V_450 ) ;
V_452 = F_203 ( V_447 , L_65 , & V_451 ) ;
V_451 /= sizeof( * V_452 ) ;
if ( V_451 >= V_454 || V_451 < 0 ) {
F_94 ( & V_359 -> V_5 ,
L_66 ,
V_451 ) ;
return - V_35 ;
...
V_451 ) ;
V_448 -> V_383 [ V_451 ] = - 1 ;
V_359 -> V_5 . V_455 = V_448 ;
return 0 ;
}
static int T_9 F_205 ( struct V_358 * V_359 )
{
struct V_387 * V_74 = F_179 ( & V_359 -> V_5 ) ;
struct V_332 * V_447 = V_359 -> V_5 . V_456 ;
int V_34 = - V_457 ;
struct V_187 * V_8 = NULL ;
struct V_389 * V_173 = NULL ;
int V_348 ;
...
F_153 ( & V_8 -> V_193 ) ;
F_153 ( & V_8 -> V_111 ) ;
V_173 = F_183 ( V_359 , V_394 , L_68 ) ;
if ( ! V_173 ) {
V_34 = - V_457 ;
F_94 ( & V_359 -> V_5 , L_69 ) ;
goto V_393;
}
V_8 -> V_458 = F_185 ( V_173 ) ;
V_8 -> V_459 = V_173 -> V_395 ;
if ( F_184 ( V_173 -> V_395 , F_185 ( V_173 ) ,
V_396 L_70 ) == NULL ) {
V_34 = - V_116 ;
F_94 ( & V_359 -> V_5 , L_71 , V_173 ) ;
goto V_393;
}
V_133 = F_53 ( V_8 -> V_9 + V_460 ) ;
if ( V_173 -> V_395 != V_133 && V_133 != 0 ) {
F_199 ( & V_359 -> V_5 ,
L_72 ,
V_128 , V_133 , & V_173 -> V_395 ) ;
} else
F_30 ( V_173 -> V_395 , V_8 -> V_9 + V_460 ) ;
V_8 -> V_286 = F_186 ( V_173 -> V_395 , F_185 ( V_173 ) ) ;
if ( ! V_8 -> V_286 ) {
V_34 = - V_25 ;
F_94 ( & V_359 -> V_5 , L_73 ) ;
goto V_393;
...
V_8 -> V_36 . V_8 = F_186 ( V_173 -> V_395 ,
F_185 ( V_173 ) ) ;
if ( ! V_8 -> V_36 . V_8 ) {
V_34 = - V_25 ;
F_94 ( & V_359 -> V_5 , L_76 ) ;
...
F_30 ( V_173 -> V_395 , V_8 -> V_9 + V_446 ) ;
} else {
V_34 = F_196 ( V_8 ) ;
if ( V_34 ) {
F_94 ( & V_359 -> V_5 , L_77 ) ;
...
F_153 ( & V_8 -> V_36 . V_37 ) ;
V_8 -> V_185 = F_207 ( V_359 , 0 ) ;
V_34 = F_208 ( V_8 -> V_185 , F_90 , 0 , V_396 , V_8 ) ;
if ( V_34 ) {
F_94 ( & V_359 -> V_5 , L_78 ) ;
goto V_393;
}
if ( V_8 -> V_74 -> V_73 ) {
V_8 -> V_360 = F_209 ( V_8 -> V_5 , L_74 ) ;
if ( F_181 ( V_8 -> V_360 ) ) {
F_94 ( & V_359 -> V_5 , L_79 ) ;
V_34 = F_210 ( V_8 -> V_360 ) ;
V_8 -> V_360 = NULL ;
goto V_393;
}
V_34 = F_165 ( V_8 -> V_360 ) ;
...
F_215 ( V_8 -> V_5 ) ;
F_216 ( V_8 -> V_5 ) ;
V_34 = F_156 ( V_8 , V_348 ) ;
if ( V_34 )
goto V_393;
V_8 -> V_5 -> V_462 = & V_8 -> V_462 ;
...
V_442 * V_8 -> V_206 ,
V_31 ) ;
if ( ! V_8 -> V_36 . V_445 && V_8 -> V_36 . V_8 )
