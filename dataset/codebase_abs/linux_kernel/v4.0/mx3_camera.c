...
V_54 = F_67 ( V_151 , V_75 , V_175 , V_172 , & V_174 ) ;
if ( V_54 < 0 )
return 0 ;
V_37 = F_74 ( V_174 ) ;
if ( ! V_37 ) {
...
F_3 ( V_17 , V_181 | ( V_182 << 16 ) , V_111 ) ;
V_180 = F_1 ( V_17 , V_112 ) & 0xffff0000 ;
F_3 ( V_17 , V_180 | 0 | ( 0 << 8 ) , V_112 ) ;
}
...
V_54 = F_67 ( V_151 , V_75 , V_203 , V_194 ) ;
if ( V_54 < 0 )
return V_54 ;
V_54 = F_67 ( V_151 , V_75 , V_204 , & V_200 ) ;
if ( V_54 < 0 )
return V_54 ;
...
if ( V_200 . V_55 & 7 ) {
F_82 ( & V_200 . V_55 ) ;
V_54 = F_67 ( V_151 , V_75 , V_205 , & V_200 ) ;
if ( V_54 < 0 )
return V_54 ;
}
...
V_200 . V_208 = V_51 -> V_208 ;
V_200 . V_174 = V_50 -> V_174 ;
V_54 = F_67 ( V_151 , V_75 , V_210 , & V_200 ) ;
if ( V_54 < 0 )
return V_54 ;
V_51 -> V_55 = V_200 . V_55 ;
V_51 -> V_58 = V_200 . V_58 ;
...
V_153 . V_93 = V_156 ;
V_54 = F_67 ( V_151 , V_75 , V_229 , & V_153 ) ;
if ( V_54 < 0 && V_54 != - V_158 ) {
F_10 ( V_20 , L_24 ,
V_156 , V_54 ) ;
return V_54 ;
}
V_228 = F_1 ( V_17 , V_132 ) &
~ ( ( 1 << V_131 ) |
( 1 << V_129 ) |
( 1 << V_125 ) |
( 1 << V_127 ) |
...
F_3 ( V_17 , V_228 | V_227 , V_132 ) ;
F_10 ( V_20 , L_25 , V_228 | V_227 ) ;
return 0 ;
}
static int F_94 ( struct V_231 * V_232 )
{
struct V_161 * V_162 = V_232 -> V_20 . V_163 ;
struct V_1 * V_17 ;
struct V_233 * V_234 ;
void T_8 * V_4 ;
int V_235 = 0 ;
struct V_44 * V_135 ;
V_234 = F_95 ( V_232 , V_236 , 0 ) ;
V_4 = F_96 ( & V_232 -> V_20 , V_234 ) ;
if ( F_97 ( V_4 ) )
return F_98 ( V_4 ) ;
if ( ! V_162 )
return - V_48 ;
V_17 = F_99 ( & V_232 -> V_20 , sizeof( * V_17 ) , V_237 ) ;
if ( ! V_17 ) {
F_29 ( & V_232 -> V_20 , L_26 ) ;
return - V_238 ;
}
V_17 -> V_133 = F_100 ( & V_232 -> V_20 , NULL ) ;
if ( F_97 ( V_17 -> V_133 ) )
return F_98 ( V_17 -> V_133 ) ;
V_17 -> V_162 = V_162 ;
V_17 -> V_115 = V_162 -> V_93 ;
if ( ! ( V_17 -> V_115 & V_239 ) ) {
F_69 ( & V_232 -> V_20 , L_27
L_28 ) ;
V_17 -> V_115 |= V_119 ;
}
if ( V_17 -> V_115 & V_240 )
...
V_135 -> V_101 = & V_244 ;
V_135 -> V_47 = V_17 ;
V_135 -> V_136 . V_20 = & V_232 -> V_20 ;
V_135 -> V_245 = V_232 -> V_164 ;
V_17 -> V_60 = F_102 ( & V_232 -> V_20 ) ;
if ( F_97 ( V_17 -> V_60 ) )
return F_98 ( V_17 -> V_60 ) ;
if ( V_162 -> V_246 ) {
V_135 -> V_247 = V_162 -> V_247 ;
V_135 -> V_246 = V_162 -> V_246 ;
}
V_235 = F_103 ( V_135 ) ;
if ( V_235 )
goto V_248;
...
static int F_106 ( struct V_231 * V_232 )
{
struct V_44 * V_135 = F_21 ( & V_232 -> V_20 ) ;
