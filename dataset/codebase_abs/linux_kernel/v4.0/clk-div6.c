...
( F_15 ( clock -> V_12 ) - 1 ) ;
for ( V_10 = 0 ; V_10 < F_16 ( V_2 -> V_14 ) ; V_10 ++ ) {
if ( clock -> V_15 [ V_10 ] == V_11 )
return V_10 ;
}
F_17 ( L_1 ,
V_16 , F_18 ( V_2 -> V_14 ) , V_11 ) ;
return 0 ;
}
...
T_2 V_11 ;
T_1 V_18 ;
if ( V_17 >= F_16 ( V_2 -> V_14 ) )
return - V_19 ;
V_18 = ~ ( ( F_15 ( clock -> V_12 ) - 1 ) << clock -> V_13 ) ;
V_11 = clock -> V_15 [ V_17 ] ;
F_5 ( ( F_3 ( clock -> V_5 ) & V_18 ) |
( V_11 << clock -> V_13 ) , clock -> V_5 ) ;
return 0 ;
}
static void T_3 F_20 ( struct V_20 * V_21 )
{
...
clock -> V_15 = F_23 ( V_22 , sizeof( * clock -> V_15 ) ,
V_29 ) ;
V_24 = F_23 ( V_22 , sizeof( * V_24 ) ,
V_29 ) ;
if ( ! V_24 )
return;
clock -> V_5 = F_24 ( V_21 , 0 ) ;
if ( clock -> V_5 == NULL ) {
F_17 ( L_3 ,
V_16 , V_21 -> V_27 ) ;
goto error;
...
V_28 = F_25 ( V_21 , L_4 , & V_27 ) ;
if ( V_28 < 0 ) {
F_17 ( L_5 ,
V_16 , V_21 -> V_27 ) ;
goto error;
}
for ( V_10 = 0 , V_23 = 0 ; V_10 < V_22 ; V_10 ++ ) {
const char * V_27 = F_26 ( V_21 , V_10 ) ;
if ( V_27 ) {
V_24 [ V_23 ] = V_27 ;
clock -> V_15 [ V_23 ] = V_10 ;
V_23 ++ ;
}
}
switch ( V_22 ) {
...
V_26 . V_22 = V_23 ;
clock -> V_2 . V_26 = & V_26 ;
V_14 = F_27 ( NULL , & clock -> V_2 ) ;
if ( F_28 ( V_14 ) ) {
F_17 ( L_7 ,
V_16 , V_21 -> V_27 , F_29 ( V_14 ) ) ;
goto error;
}
F_30 ( V_21 , V_34 , V_14 ) ;
F_31 ( V_24 ) ;
