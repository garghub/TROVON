...
{
struct V_4 * V_117 = V_3 -> V_5 ;
unsigned long V_118 ;
if ( V_115 == V_119 ) {
return - V_120 ;
} else {
V_118 = V_113 -> V_121 + ( V_117 -> V_77 >> V_122 ) ;
}
V_113 -> V_123 = F_56 ( V_113 -> V_123 ) ;
if ( F_57 ( V_113 , V_113 -> V_124 , V_118 ,
V_113 -> V_125 - V_113 -> V_124 ,
V_113 -> V_123 ) )
return - V_126 ;
return 0 ;
}
void T_5 F_58 ( unsigned long V_127 )
{
struct V_128 V_129 = {
. V_130 = V_131 ,
. type = V_132 ,
