...
} while ( F_63 ( V_153 , & V_80 ) );
V_78 = F_64 ( F_65 ( V_125 ) ) ;
...
F_67 ( & V_7 -> V_168 , 0 ) ;
V_7 -> V_169 = 0 ;
V_7 -> V_133 = V_78 -> V_170 -> V_139 . V_171 ;
V_7 -> V_172 = 0 ;
V_7 -> V_173 = V_174 ;
switch ( V_78 -> V_155 ) {
case V_175 :
...
V_78 -> V_180 ? V_78 -> V_180 : L_31 ,
V_155 ,
F_60 ( V_78 -> V_181 . V_182 ) ,
F_60 ( V_78 -> V_181 . V_183 ) ,
V_7 -> V_133 ) ;
V_7 -> V_163 ++ ;
V_153 = V_7 -> V_79 ;
V_157 = V_78 -> V_135 -> V_184 [ 0 ] ;
if ( V_157 -> V_185 != V_154 ) {
F_19 ( V_152 , L_32 ) ;
V_83 = - V_134 ;
goto V_160;
}
