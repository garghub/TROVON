...
static int F_137 ( struct V_404 * V_405 )
{
int V_1 ;
V_360 = F_138 (
V_405 , V_358 , 0 ,
...
static void F_140 ( struct V_408 * V_409 ,
T_1 V_410 )
{
struct V_411 * V_412 ;
void T_3 * V_413 ;
T_1 V_40 ;
V_412 = F_141 ( V_409 , V_414 ,
L_24 ) ;
if ( ! V_412 ) {
F_142 ( & V_409 -> V_415 ,
L_25 ) ;
...
V_413 = F_143 ( V_412 -> V_416 , F_144 ( V_412 ) ) ;
if ( ! V_413 ) {
F_142 ( & V_409 -> V_415 , L_26 ) ;
return;
}
V_40 = F_3 ( V_413 + V_410 ) ;
V_38 . V_40 . V_381 = ( V_40 & 0xFF ) ;
V_38 . V_40 . V_417 = ( V_40 >> 8 ) & 0xFF ;
V_38 . V_40 . V_418 = ( V_40 >> 16 ) & 0xFF ;
V_38 . V_40 . V_419 = ( V_40 >> 24 ) & 0xFF ;
strncpy ( V_38 . V_40 . V_420 ,
...
void T_7 F_147 ( T_1 V_422 , T_1 V_329 )
{
V_26 = F_143 ( V_422 , V_329 ) ;
if ( ! V_26 )
F_39 ( L_28 , V_134 ) ;
F_148 ( & V_78 . V_79 ) ;
F_148 ( & V_78 . V_377 ) ;
...
{
if ( F_14 () ) {
V_426 [ 3 ] . V_276 = 1000000 ;
V_426 [ 3 ] . V_280 = V_427 ;
}
}
static int F_154 ( struct V_428 * V_429 ,
struct V_430 * V_431 )
{
struct V_404 * V_405 ;
struct V_411 V_432 ;
...
. V_321 = V_437 ,
. V_438 = V_431 ,
. V_439 = sizeof( struct V_430 ) ,
. V_440 = & V_432 ,
. V_441 = 1 ,
} ;
if ( ! V_429 -> V_442 )
return - V_443 ;
F_155 (parent->of_node, np) {
if ( F_156 ( V_405 , V_434 . V_436 ) )
break;
}
if ( ! V_405 ) {
F_157 ( V_429 , L_31 ) ;
...
F_158 ( V_405 , & V_432 , 1 ) ;
return F_159 ( V_429 , 0 , & V_434 , 1 , NULL , 0 , NULL ) ;
}
static int F_160 ( struct V_408 * V_409 )
{
struct V_404 * V_405 = V_409 -> V_415 . V_442 ;
struct V_444 * V_431 = F_161 ( & V_409 -> V_415 ) ;
int V_367 = 0 , V_445 = 0 ;
struct V_411 * V_412 ;
V_412 = F_141 ( V_409 , V_414 , L_32 ) ;
if ( ! V_412 ) {
F_142 ( & V_409 -> V_415 , L_33 ) ;
return - V_47 ;
}
V_26 = F_162 ( & V_409 -> V_415 , V_412 -> V_416 , F_144 ( V_412 ) ) ;
if ( ! V_26 ) {
F_142 ( & V_409 -> V_415 ,
L_34 ) ;
return - V_446 ;
...
F_152 () ;
F_140 ( V_409 , V_431 -> V_410 ) ;
V_412 = F_141 ( V_409 , V_414 , L_35 ) ;
if ( ! V_412 ) {
F_142 ( & V_409 -> V_415 , L_36 ) ;
return - V_47 ;
}
V_41 = F_162 ( & V_409 -> V_415 , V_412 -> V_416 ,
F_144 ( V_412 ) ) ;
if ( ! V_41 ) {
F_142 ( & V_409 -> V_415 ,
L_37 ) ;
...
V_367 = F_163 ( V_409 , 0 ) ;
if ( V_367 <= 0 ) {
F_142 ( & V_409 -> V_415 , L_38 ) ;
return V_367 ;
}
V_445 = F_164 ( V_367 , F_125 ,
F_127 , V_447 , L_32 , NULL ) ;
if ( V_445 < 0 ) {
F_39 ( L_39 ) ;
return V_445 ;
}
...
F_165 ( V_283 ) ;
F_153 () ;
V_445 = F_159 ( & V_409 -> V_415 , 0 , V_448 ,
F_38 ( V_448 ) , NULL , 0 , V_360 ) ;
if ( V_445 ) {
F_39 ( L_40 ) ;
return V_445 ;
}
if ( ! F_166 ( L_41 ) ) {
V_445 = F_159 ( & V_409 -> V_415 , 0 , V_449 ,
F_38 ( V_449 ) , NULL , 0 ,
V_360 ) ;
if ( V_445 ) {
F_167 ( & V_409 -> V_415 ) ;
...
V_445 = F_154 ( & V_409 -> V_415 , V_431 -> V_450 ) ;
if ( V_445 ) {
F_167 ( & V_409 -> V_415 ) ;
F_39 ( L_42 ) ;
return V_445 ;
