...
if ( ( F_112 ( V_63 -> V_94 ) ) || ( F_2 ( V_63 -> V_94 ) ) ) {
...
static int F_114 ( struct V_134 * V_134 , char * V_201 , int V_202 )
{
int V_123 ;
struct V_1 * V_2 ;
struct V_127 * V_128 ;
...
V_123 = F_115 ( strlen ( V_120 -> V_28 ) + 1 , ( V_204 ) V_202 ) ;
...
static void * F_116 ( struct V_134 * V_134 , struct V_205 * V_206 )
{
int V_146 = 0 ;
char * V_207 = F_117 () ;
...
V_146 = F_114 ( V_134 , V_207 , V_208 ) ;
if ( V_146 < 0 ) {
F_118 ( V_207 ) ;
V_207 = F_35 ( V_146 ) ;
} else
V_207 [ F_115 ( V_146 , V_208 - 1 ) ] = 0 ;
}
F_119 ( V_206 , V_207 ) ;
return NULL ;
}
void
F_120 ( struct V_134 * V_134 , struct V_205 * V_206 , void * V_209 )
{
char * V_210 = F_121 ( V_206 ) ;
F_11 ( V_114 , L_23 ,
V_134 , F_56 ( V_210 ) ? L_24 : V_210 ) ;
if ( ! F_56 ( V_210 ) )
F_118 ( V_210 ) ;
}
static int F_122 ( struct V_63 * V_133 , struct V_134 * V_134 ,
...
static int
F_123 ( struct V_63 * V_133 , struct V_134 * V_134 , const char * V_211 )
{
F_11 ( V_114 , L_26 ,
V_133 -> V_124 , V_134 , V_211 ) ;
return F_122 ( V_133 , V_134 , V_21 , V_211 ) ;
}
static int
F_124 ( struct V_134 * V_162 , struct V_63 * V_133 ,
struct V_134 * V_134 )
{
int V_123 ;
char * V_54 ;
...
V_123 = F_122 ( V_133 , V_134 , V_143 , V_54 ) ;
F_118 ( V_54 ) ;
if ( ! V_123 ) {
F_126 ( V_166 , V_162 -> V_138 ) ;
F_69 ( V_133 ) ;
}
V_212:
F_42 ( V_166 ) ;
...
static int
F_127 ( struct V_63 * V_133 , struct V_134 * V_134 , T_2 V_3 , T_3 V_19 )
{
struct V_1 * V_2 = F_44 ( V_133 ) ;
int V_123 ;
char * V_54 ;
...
return - V_117 ;
if ( F_6 ( V_3 ) )
sprintf ( V_54 , L_30 , F_128 ( V_19 ) , F_129 ( V_19 ) ) ;
else if ( F_7 ( V_3 ) )
sprintf ( V_54 , L_31 , F_128 ( V_19 ) , F_129 ( V_19 ) ) ;
else if ( F_5 ( V_3 ) )
* V_54 = 0 ;
else if ( F_4 ( V_3 ) )
* V_54 = 0 ;
...
V_141 = F_1 ( V_2 , V_3 ) ;
V_123 = F_122 ( V_133 , V_134 , V_141 , V_54 ) ;
F_118 ( V_54 ) ;
return V_123 ;
}
int F_126 ( struct V_127 * V_128 , struct V_63 * V_63 )
{
int V_119 ;
T_3 V_19 ;
T_7 V_213 ;
