...
{
int V_46 ;
if ( F_53 ( V_140 , L_25 , NULL ) )
V_40 -> V_55 = 1 ;
V_46 = F_54 ( V_140 , L_26 ,
& V_40 -> V_142 ) ;
if ( V_46 ) {
F_9 ( V_29 ,
L_27 ) ;
...
{
struct V_39 * V_40 = F_56 ( & V_14 -> V_29 ) ;
...
static int F_67 ( struct V_7 * V_14 )
{
