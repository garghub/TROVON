...
static int F_60 ( struct V_68 V_21 , void * V_91 )
{
struct V_26 V_26 ;
if ( F_30 ( V_21 , & V_26 ) != 0 )
return - V_71 ;
...
struct V_78 V_99 ;
if ( F_79 ( & V_99 ) ) {
F_33 ( V_99 . V_21 , F_46 ( & V_81 ) ) ;
if ( F_74 ( & V_99 . V_21 , & V_21 ) )
return 0 ;
}
F_80 ( 100 ) ;
}
...
static int F_83 ( struct V_68 V_21 , struct V_26 * V_101 )
{
int V_102 ;
V_100 = 0 ;
V_103 = F_82 ;
...
static int F_85 ( struct V_68 V_21 , void * V_91 )
{
struct V_26 V_26 ;
if ( F_83 ( V_21 , & V_26 ) )
return - V_71 ;
...
static int F_103 ( struct V_68 V_21 , void * V_91 )
{
struct V_26 V_26 ;
...
static int F_104 ( struct V_127 * V_125 ,
struct V_68 * V_21 )
{
struct V_123 V_124 ;
V_124 . V_125 = * V_125 ;
...
void F_105 ( struct V_127 * V_125 )
{
struct V_68 V_128 ( V_21 ) ;
F_106 ( NULL , NULL , NULL ) ;
if ( F_104 ( V_125 , & V_21 ) != 0 )
F_107 ( L_19 ) ;
F_108 ( * ( ( V_43 * ) & V_21 ) ) ;
}
int T_1 F_109 ( struct V_129 * V_130 )
{
struct V_68 V_21 ;
struct V_26 V_26 ;
...
int F_110 ( struct V_7 * V_8 , struct V_134 * V_134 , T_4 V_19 , T_4 V_30 )
{
int V_98 ;
