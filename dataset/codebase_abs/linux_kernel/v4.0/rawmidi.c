...
V_143 = V_16 -> V_17 ;
if ( V_147 )
memcpy ( V_147 + V_142 , V_16 -> V_33 + V_16 -> V_34 , V_143 ) ;
if ( V_146 ) {
F_21 ( & V_16 -> V_27 , V_40 ) ;
if ( F_64 ( V_146 + V_142 ,
V_16 -> V_33 + V_16 -> V_34 , V_143 ) ) {
...
{
return F_89 ( V_14 , NULL , V_102 , V_19 ) ;
}
static T_4 F_90 ( struct V_6 * V_6 , const char T_3 * V_102 ,
T_1 V_19 , T_5 * V_148 )
{
long V_142 , V_43 ;
int V_143 ;
...
F_73 ( & V_16 -> V_27 ) ;
V_143 = F_89 ( V_14 , V_102 , NULL , V_19 ) ;
if ( V_143 < 0 )
return V_142 > 0 ? V_142 : V_143 ;
V_142 += V_143 ;
V_102 += V_143 ;
...
static int F_97 ( struct V_1 * V_47 ,
struct V_52 * V_31 ,
int V_161 ,
int V_19 )
{
...
V_14 -> V_47 = V_47 ;
V_14 -> V_110 = V_31 ;
F_99 ( & V_14 -> V_163 , & V_31 -> V_164 ) ;
V_31 -> V_60 ++ ;
}
return 0 ;
}
static void F_100 ( struct V_4 * V_165 )
{
F_14 ( F_7 ( V_165 , struct V_1 , V_165 ) ) ;
}
int F_101 ( struct V_2 * V_3 , char * V_106 , int V_4 ,
int V_166 , int V_167 ,
struct V_1 * * V_168 )
{
struct V_1 * V_47 ;
...
V_47 -> V_165 . V_176 = F_100 ;
F_107 ( & V_47 -> V_165 , L_21 , V_3 -> V_63 , V_4 ) ;
if ( ( V_42 = F_97 ( V_47 ,
& V_47 -> V_54 [ V_32 ] ,
V_32 ,
V_167 ) ) < 0 ) {
...
V_47 -> V_187 ++ ;
#ifdef F_120
F_121 ( F_120 , V_47 -> V_3 -> V_63 , V_47 -> V_107 ) ;
#endif
}
}
...
#endif
F_37 ( & V_77 ) ;
sprintf ( V_107 , L_24 , V_47 -> V_4 ) ;
V_159 = F_122 ( V_47 -> V_3 , V_107 , V_47 -> V_3 -> V_190 ) ;
if ( V_159 ) {
V_159 -> V_100 = V_47 ;
V_159 -> V_191 . V_192 . V_193 = F_94 ;
if ( F_123 ( V_159 ) < 0 ) {
F_114 ( V_159 ) ;
V_159 = NULL ;
}
...
V_47 -> V_179 = V_159 ;
#if F_124 ( V_194 ) || ( F_124 ( V_195 ) && F_124 ( V_196 ) )
if ( ! V_47 -> V_38 || ! V_47 -> V_38 -> V_172 ) {
if ( F_125 ( V_47 -> V_3 , V_47 -> V_4 , V_197 , 0 , & V_47 -> V_184 ) >= 0 ) {
V_47 -> V_184 -> V_100 = V_47 ;
V_47 -> V_184 -> V_104 = F_116 ;
sprintf ( V_47 -> V_184 -> V_107 , L_25 , V_47 -> V_3 -> V_63 , V_47 -> V_4 ) ;
F_126 ( V_47 -> V_3 , V_47 -> V_184 ) ;
}
}
#endif
return 0 ;
...
if ( V_47 -> V_187 ) {
if ( ( int ) V_47 -> V_4 == V_188 [ V_47 -> V_3 -> V_63 ] ) {
F_128 ( V_91 , V_47 -> V_3 , 0 ) ;
#ifdef F_120
F_129 ( F_120 , V_47 -> V_3 -> V_63 ) ;
#endif
}
if ( ( int ) V_47 -> V_4 == V_189 [ V_47 -> V_3 -> V_63 ] )
F_128 ( V_91 , V_47 -> V_3 , 1 ) ;
V_47 -> V_187 = 0 ;
}
#endif
F_118 ( & V_47 -> V_165 ) ;
...
void F_130 ( struct V_1 * V_47 , int V_31 ,
struct V_199 * V_38 )
{
struct V_13 * V_14 ;
