...
F_171 ( V_10 , V_118 -> V_46 ) ;
if ( V_125 ) {
int V_102 ;
for ( V_102 = 0 ; V_102 < V_118 -> V_127 ; V_102 ++ ) {
...
if ( F_177 ( (struct V_6 * ) V_10 , & V_4 -> V_8 ) )
F_178 ( & V_4 -> V_5 ) ;
} else
F_5 ( V_10 , 1 ) ;
}
...
void * F_181 ( struct V_20 * * V_21 , unsigned int V_110 ,
...
static void * F_182 ( struct V_112 * V_118 , T_6 V_51 ,
T_5 V_19 , int V_50 )
{
const int V_99 = 0 ;
struct V_20 * * V_21 ;
unsigned int V_127 , V_130 , V_102 ;
const T_6 V_131 = ( V_51 & V_55 ) | V_132 ;
const T_6 V_133 = V_51 | V_134 ;
V_127 = F_152 ( V_118 ) >> V_79 ;
V_130 = ( V_127 * sizeof( struct V_20 * ) ) ;
V_118 -> V_127 = V_127 ;
if ( V_130 > V_15 ) {
V_21 = F_183 ( V_130 , 1 , V_131 | V_135 ,
...
void * F_188 ( unsigned long V_46 , unsigned long V_47 ,
unsigned long V_25 , unsigned long V_11 , T_6 V_51 ,
T_5 V_19 , unsigned long V_139 , int V_50 ,
const void * V_119 )
{
struct V_112 * V_118 ;
void * V_10 ;
unsigned long V_140 = V_46 ;
V_46 = F_159 ( V_46 ) ;
if ( ! V_46 || ( V_46 >> V_79 ) > V_129 )
goto V_137;
V_118 = F_156 ( V_46 , V_47 , V_141 | V_120 |
V_139 , V_25 , V_11 , V_50 , V_51 , V_119 ) ;
if ( ! V_118 )
goto V_137;
V_10 = F_182 ( V_118 , V_51 , V_19 , V_50 ) ;
if ( ! V_10 )
return NULL ;
F_154 ( V_118 ) ;
F_189 ( V_10 , V_140 , 2 , V_51 ) ;
return V_10 ;
V_137:
F_187 ( V_51 , 0 ,
L_6 ,
...
{
return F_188 ( V_46 , V_47 , V_68 , V_69 ,
V_51 , V_19 , 0 , V_50 , V_119 ) ;
}
void * F_190 ( unsigned long V_46 , T_6 V_51 , T_5 V_19 )
{
return F_183 ( V_46 , 1 , V_51 , V_19 , V_124 ,
F_162 ( 0 ) ) ;
}
static inline void * F_191 ( unsigned long V_46 ,
int V_50 , T_6 V_66 )
{
return F_183 ( V_46 , 1 , V_66 , V_136 ,
V_50 , F_162 ( 0 ) ) ;
}
void * F_192 ( unsigned long V_46 )
{
return F_191 ( V_46 , V_124 ,
V_111 | V_135 ) ;
}
...
{
return F_183 ( V_46 , 1 , V_111 | V_135 , V_136 ,
V_50 , F_162 ( 0 ) ) ;
}
void * F_196 ( unsigned long V_46 , int V_50 )
{
return F_191 ( V_46 , V_50 ,
V_111 | V_135 | V_132 ) ;
}
void * F_197 ( unsigned long V_46 )
{
return F_183 ( V_46 , 1 , V_111 | V_135 , V_144 ,
V_124 , F_162 ( 0 ) ) ;
}
void * F_198 ( unsigned long V_46 )
{
return F_183 ( V_46 , 1 , V_145 , V_136 ,
V_124 , F_162 ( 0 ) ) ;
}
...
struct V_112 * V_118 ;
void * V_27 ;
V_27 = F_183 ( V_46 , 1 , V_145 | V_132 , V_136 ,
V_124 , F_162 ( 0 ) ) ;
if ( V_27 ) {
V_118 = F_166 ( V_27 ) ;
V_118 -> V_66 |= V_143 ;
...
static int F_200 ( char * V_146 , char * V_10 , unsigned long V_110 )
{
struct V_20 * V_4 ;
int V_147 = 0 ;
while ( V_110 ) {
unsigned long V_103 , V_148 ;
...
V_4 = F_39 ( V_10 ) ;
if ( V_4 ) {
void * V_149 = F_201 ( V_4 ) ;
memcpy ( V_146 , V_149 + V_103 , V_148 ) ;
F_202 ( V_149 ) ;
} else
memset ( V_146 , 0 , V_148 ) ;
V_10 += V_148 ;
V_146 += V_148 ;
V_147 += V_148 ;
V_110 -= V_148 ;
...
static int F_203 ( char * V_146 , char * V_10 , unsigned long V_110 )
{
struct V_20 * V_4 ;
int V_147 = 0 ;
while ( V_110 ) {
...
if ( V_4 ) {
void * V_149 = F_201 ( V_4 ) ;
memcpy ( V_149 + V_103 , V_146 , V_148 ) ;
F_202 ( V_149 ) ;
}
V_10 += V_148 ;
V_146 += V_148 ;
...
long F_204 ( char * V_146 , char * V_10 , unsigned long V_110 )
{
struct V_34 * V_38 ;
struct V_112 * V_113 ;
char * V_150 , * V_151 = V_146 ;
unsigned long V_152 = V_110 ;
unsigned long V_36 ;
if ( ( unsigned long ) V_10 + V_110 < V_110 )
V_110 = - ( unsigned long ) V_10 ;
F_63 ( & V_58 ) ;
F_205 (va, &vmap_area_list, list) {
if ( ! V_110 )
break;
if ( ! ( V_38 -> V_66 & V_117 ) )
continue;
V_113 = V_38 -> V_113 ;
V_150 = ( char * ) V_113 -> V_10 ;
if ( V_10 >= V_150 + F_152 ( V_113 ) )
continue;
while ( V_10 < V_150 ) {
if ( V_110 == 0 )
goto V_153;
...
V_36 = V_150 + F_152 ( V_113 ) - V_10 ;
if ( V_36 > V_110 )
V_36 = V_110 ;
if ( ! ( V_113 -> V_66 & V_121 ) )
F_200 ( V_146 , V_10 , V_36 ) ;
else
memset ( V_146 , 0 , V_36 ) ;
V_146 += V_36 ;
V_10 += V_36 ;
...
memset ( V_146 , 0 , V_152 - ( V_146 - V_151 ) ) ;
return V_152 ;
}
long F_206 ( char * V_146 , char * V_10 , unsigned long V_110 )
{
struct V_34 * V_38 ;
struct V_112 * V_113 ;
char * V_150 ;
...
int F_207 ( struct V_154 * V_155 , unsigned long V_156 ,
void * V_157 , unsigned long V_46 )
{
struct V_112 * V_118 ;
V_46 = F_159 ( V_46 ) ;
if ( ! F_170 ( V_156 ) || ! F_170 ( V_157 ) )
return - V_158 ;
V_118 = F_166 ( V_157 ) ;
if ( ! V_118 )
return - V_158 ;
if ( ! ( V_118 -> V_66 & V_143 ) )
return - V_158 ;
if ( V_157 + V_46 > V_118 -> V_10 + V_118 -> V_46 )
return - V_158 ;
do {
struct V_20 * V_20 = F_39 ( V_157 ) ;
int V_27 ;
V_27 = F_208 ( V_155 , V_156 , V_20 ) ;
if ( V_27 )
return V_27 ;
V_156 += V_15 ;
V_157 += V_15 ;
...
V_155 -> V_139 |= V_159 | V_160 ;
return 0 ;
}
int F_209 ( struct V_154 * V_155 , void * V_10 ,
unsigned long V_161 )
{
return F_207 ( V_155 , V_155 -> V_162 ,
V_10 + ( V_161 << V_79 ) ,
V_155 -> V_163 - V_155 -> V_162 ) ;
}
void __weak F_210 ( void )
{
}
static int F_211 ( T_2 * V_12 , T_10 V_164 , unsigned long V_10 , void * V_165 )
{
T_2 * * * V_4 = V_165 ;
if ( V_4 ) {
* ( * V_4 ) = V_12 ;
...
struct V_112 * F_212 ( T_8 V_46 , T_2 * * V_166 )
{
struct V_112 * V_118 ;
...
if ( V_118 == NULL )
return NULL ;
if ( F_213 ( & V_14 , ( unsigned long ) V_118 -> V_10 ,
V_46 , F_211 , V_166 ? & V_166 : NULL ) ) {
F_214 ( V_118 ) ;
return NULL ;
}
return V_118 ;
}
void F_214 ( struct V_112 * V_118 )
{
struct V_112 * V_27 ;
...
static struct V_34 * F_215 ( struct V_35 * V_36 )
{
return V_36 ? F_50 ( V_36 , struct V_34 , V_35 ) : NULL ;
}
static bool F_216 ( unsigned long V_11 ,
struct V_34 * * V_167 ,
struct V_34 * * V_168 )
{
struct V_35 * V_36 = V_37 . V_35 ;
...
if ( V_38 -> va_end > V_11 ) {
* V_167 = V_38 ;
* V_168 = F_215 ( F_55 ( & ( * V_167 ) -> V_35 ) ) ;
} else {
* V_168 = V_38 ;
* V_167 = F_215 ( F_217 ( & ( * V_168 ) -> V_35 ) ) ;
}
return true ;
}
static unsigned long F_218 ( struct V_34 * * V_167 ,
struct V_34 * * V_168 ,
unsigned long V_47 )
{
...
unsigned long V_10 ;
if ( * V_167 )
V_10 = F_219 ( ( * V_167 ) -> va_start & ~ ( V_47 - 1 ) , V_169 ) ;
else
V_10 = V_169 ;
...
T_8 V_47 )
{
const unsigned long V_173 = F_64 ( V_68 , V_47 ) ;
const unsigned long V_169 = V_69 & ~ ( V_47 - 1 ) ;
struct V_34 * * V_174 , * V_44 , * V_17 ;
struct V_112 * * V_175 ;
int V_118 , V_176 , V_177 , V_178 ;
unsigned long V_179 , V_25 , V_11 , V_180 ;
bool V_52 = false ;
F_21 ( V_47 & ~ V_54 || ! F_58 ( V_47 ) ) ;
for ( V_177 = 0 , V_118 = 0 ; V_118 < V_172 ; V_118 ++ ) {
V_25 = V_170 [ V_118 ] ;
V_11 = V_25 + V_171 [ V_118 ] ;
F_21 ( ! F_221 ( V_170 [ V_118 ] , V_47 ) ) ;
F_21 ( ! F_221 ( V_171 [ V_118 ] , V_47 ) ) ;
if ( V_25 > V_170 [ V_177 ] )
V_177 = V_118 ;
...
V_174 [ V_118 ] = F_147 ( sizeof( struct V_34 ) , V_111 ) ;
V_175 [ V_118 ] = F_147 ( sizeof( struct V_112 ) , V_111 ) ;
if ( ! V_174 [ V_118 ] || ! V_175 [ V_118 ] )
goto V_184;
}
V_57:
F_63 ( & V_58 ) ;
...
V_25 = V_170 [ V_118 ] ;
V_11 = V_25 + V_171 [ V_118 ] ;
if ( ! F_216 ( V_70 , & V_17 , & V_44 ) ) {
V_179 = V_169 - V_180 ;
goto V_65;
}
V_179 = F_218 ( & V_17 , & V_44 , V_47 ) - V_11 ;
while ( true ) {
...
V_17 = V_44 ;
V_44 = F_215 ( F_55 ( & V_17 -> V_35 ) ) ;
V_179 = F_218 ( & V_17 , & V_44 , V_47 ) - V_11 ;
V_178 = V_118 ;
continue;
}
V_118 = ( V_118 + V_172 - 1 ) % V_172 ;
if ( V_118 == V_178 )
break;
V_25 = V_170 [ V_118 ] ;
V_11 = V_25 + V_171 [ V_118 ] ;
F_216 ( V_179 + V_11 , & V_17 , & V_44 ) ;
}
V_65:
for ( V_118 = 0 ; V_118 < V_172 ; V_118 ++ ) {
struct V_34 * V_38 = V_174 [ V_118 ] ;
V_38 -> va_start = V_179 + V_170 [ V_118 ] ;
V_38 -> va_end = V_38 -> va_start + V_171 [ V_118 ] ;
F_51 ( V_38 ) ;
}
V_70 = V_179 + V_170 [ V_177 ] ;
F_67 ( & V_58 ) ;
for ( V_118 = 0 ; V_118 < V_172 ; V_118 ++ )
F_153 ( V_175 [ V_118 ] , V_174 [ V_118 ] , V_141 ,
F_220 ) ;
F_71 ( V_174 ) ;
return V_175 ;
V_184:
...
++ * V_187 ;
V_17 = F_66 ( V_38 -> V_8 . V_17 , F_226 ( * V_38 ) , V_8 ) ;
if ( & V_17 -> V_8 != & V_45 )
return V_17 ;
return NULL ;
}
...
if ( V_188 -> V_119 )
F_233 ( V_186 , L_9 , V_188 -> V_119 ) ;
if ( V_188 -> V_127 )
F_233 ( V_186 , L_10 , V_188 -> V_127 ) ;
if ( V_188 -> V_193 )
