...
{
struct V_40 * V_41 ;
if ( ! V_99 -> V_335 || V_168 < 0 || V_168 >= V_99 -> V_335 -> V_174 )
return 0 ;
V_41 = V_99 -> V_335 -> V_336 [ V_168 ] ;
if ( ! V_41 -> type -> V_337 )
return 0 ;
...
( V_41 -> V_45 . V_338 == V_231 -> V_45 . V_338 || ! V_231 -> V_45 . V_338 ) &&
( V_41 -> V_44 . V_339 == V_231 -> V_339 || ! V_231 -> V_339 ) &&
V_41 -> V_44 . V_232 == V_231 -> V_232 &&
( V_231 -> V_340 || ( V_231 -> V_341 & ( 1 << V_41 -> V_44 . V_342 ) ) ||
! ( F_210 ( V_231 -> V_45 . V_20 , V_343 ) ) ) &&
! ( V_41 -> V_44 . V_232 != V_279 &&
F_209 ( V_231 , V_41 , V_28 ) ) ;
}
static inline int
F_211 ( const struct V_224 * V_231 , const struct V_344 * V_335 , int V_345 ,
unsigned short V_28 )
{
int V_168 = V_345 ;
if ( V_231 -> V_241 ) {
...
V_345 = - 1 ;
for (; V_168 < V_335 -> V_174 ; V_168 ++ ) {
if ( F_207 ( V_231 , V_335 -> V_336 [ V_168 ] , V_28 ) )
return ++ V_168 ;
if ( V_335 -> V_336 [ V_168 ] -> V_44 . V_232 != V_279 ) {
if ( V_345 == - 1 )
V_345 = - 2 - V_168 ;
break;
}
...
static inline int F_214 ( const struct V_344 * V_335 , int V_348 , int * V_349 )
{
for (; V_348 < V_335 -> V_174 ; V_348 ++ ) {
if ( V_335 -> V_336 [ V_348 ] -> V_44 . V_232 != V_279 ) {
* V_349 = V_348 ;
return 1 ;
}
}
...
V_60 &= V_164 ;
V_351 = F_136 ( V_60 ) ;
if ( F_212 ( V_99 , & V_4 , V_28 , V_346 ) < 0 ) {
F_183 ( V_35 , V_353 ) ;
return 0 ;
}
F_217 ( V_99 , & V_4 , V_28 ) ;
if ( V_99 -> V_335 ) {
int V_129 ;
for ( V_129 = V_99 -> V_335 -> V_174 - 1 ; V_129 >= 0 ; V_129 -- ) {
struct V_40 * V_41 = V_99 -> V_335 -> V_336 [ V_129 ] ;
...
if ( ! V_81 ) {
struct V_79 * V_80 ;
V_80 = F_204 ( V_35 , & V_4 , V_28 , V_351 ,
F_133 , NULL ) ;
if ( F_134 ( V_80 ) )
V_81 = F_135 ( V_80 ) ;
else
...
if ( ! V_81 ) {
if ( V_99 -> V_335 && F_214 ( V_99 -> V_335 , 0 , & V_352 ) ) {
F_206 ( V_352 , V_99 , & V_4 ) ;
F_183 ( V_35 , V_356 ) ;
return 0 ;
}
return 1 ;
...
struct V_224 * V_358 [ V_245 ] ;
struct V_224 * * V_246 = V_244 ;
int V_359 = 0 ;
int V_129 , V_348 ;
if ( ( V_335 = V_99 -> V_335 ) == NULL )
V_335 = & V_357 ;
for ( V_350 = 0 ; V_350 < V_243 ; V_350 ++ ) {
if ( V_242 [ V_350 ] != V_81 &&
V_242 [ V_350 ] -> V_221 != V_297 ) {
F_183 ( V_35 , V_360 ) ;
goto V_337;
}
if ( V_359 + V_242 [ V_350 ] -> V_222 >= V_245 ) {
F_183 ( V_35 , V_361 ) ;
goto V_362;
}
for ( V_129 = 0 ; V_129 < V_242 [ V_350 ] -> V_222 ; V_129 ++ )
V_246 [ V_359 ++ ] = & V_242 [ V_350 ] -> V_223 [ V_129 ] ;
}
V_222 = V_359 ;
if ( V_243 > 1 ) {
F_218 ( V_358 , V_246 , V_222 , V_28 , V_35 ) ;
V_246 = V_358 ;
}
for ( V_129 = V_222 - 1 , V_348 = 0 ; V_129 >= 0 ; V_129 -- ) {
V_348 = F_211 ( V_246 [ V_129 ] , V_335 , V_348 , V_28 ) ;
if ( V_348 < 0 ) {
if ( V_348 < - 1 )
V_352 = - ( 2 + V_348 ) ;
F_183 ( V_35 , V_363 ) ;
...
static struct V_34 * F_220 ( struct V_34 * V_37 , T_3 V_366 )
{
...
struct V_250 * V_251 = (struct V_250 * ) V_37 ;
T_3 V_368 , V_369 ;
V_368 = F_231 ( V_37 -> V_277 ) ;
V_251 -> V_370 = V_368 ;
V_368 = F_232 ( V_37 -> V_101 , V_368 ) ;
V_369 = F_231 ( V_251 -> V_252 ) ;
V_251 -> V_369 = V_369 ;
if ( V_368 > V_369 )
V_368 = V_369 ;
F_233 ( V_37 , V_371 , V_368 ) ;
} while ( ( V_37 = V_37 -> V_57 ) );
}
static int F_221 ( struct V_250 * V_372 )
{
struct V_34 * V_37 = & V_372 -> V_7 . V_37 ;
struct V_250 * V_373 ;
T_3 V_374 ;
if ( ! F_234 ( V_37 -> V_262 , ( (struct V_250 * ) V_37 ) -> V_375 ) ||
...
return 0 ;
V_374 = F_231 ( V_37 -> V_277 ) ;
if ( V_251 -> V_370 != V_374 ) {
V_373 = V_251 ;
V_251 -> V_370 = V_374 ;
}
if ( ! F_234 ( V_251 -> V_252 , V_251 -> V_376 ) )
return 0 ;
V_374 = F_231 ( V_251 -> V_252 ) ;
if ( V_251 -> V_369 != V_374 ) {
V_373 = V_251 ;
V_251 -> V_369 = V_374 ;
}
V_37 = V_37 -> V_277 ;
...
for (; ; ) {
V_37 = & V_373 -> V_7 . V_37 ;
V_374 = F_232 ( V_37 -> V_101 , V_374 ) ;
if ( V_374 > V_373 -> V_369 )
V_374 = V_373 -> V_369 ;
F_233 ( V_37 , V_371 , V_374 ) ;
if ( V_373 == V_372 )
break;
V_373 = (struct V_250 * ) V_373 -> V_7 . V_37 . V_57 ;
V_373 -> V_370 = V_374 ;
}
return 1 ;
}
...
{
unsigned int V_374 = F_239 ( V_37 , V_371 ) ;
return V_374 ? : F_231 ( V_37 -> V_262 ) ;
}
static struct V_377 * F_240 ( const struct V_34 * V_37 ,
struct V_98 * V_99 ,
const void * V_9 )
{
return V_37 -> V_262 -> V_93 -> V_378 ( V_37 , V_99 , V_9 ) ;
}
...
if ( F_164 ( V_255 -> V_380 == NULL ) )
V_255 -> V_380 = V_381 ;
if ( F_164 ( V_255 -> V_382 == NULL ) )
V_255 -> V_382 = F_220 ;
if ( F_164 ( V_255 -> V_383 == NULL ) )
V_255 -> V_383 = F_236 ;
if ( F_164 ( V_255 -> V_374 == NULL ) )
V_255 -> V_374 = F_238 ;
if ( F_164 ( V_255 -> V_384 == NULL ) )
V_255 -> V_384 = F_226 ;
if ( F_164 ( V_255 -> V_385 == NULL ) )
V_255 -> V_385 = F_225 ;
if ( F_164 ( V_255 -> V_378 == NULL ) )
V_255 -> V_378 = F_240 ;
if ( F_164 ( V_32 -> V_386 == NULL ) )
V_32 -> V_386 = F_229 ;
...
switch ( V_32 -> V_28 ) {
case V_29 :
V_387 = & V_35 -> V_101 . V_256 ;
break;
#if F_162 ( V_257 )
case V_30 :
V_387 = & V_35 -> V_101 . V_258 ;
break;
#endif
default:
F_46 () ;
...
static int F_250 ( struct V_388 * V_389 , unsigned long V_390 , void * V_391 )
{
struct V_265 * V_266 = F_251 ( V_391 ) ;
switch ( V_390 ) {
case V_392 :
F_227 ( F_216 ( V_266 ) ) ;
}
...
{
int V_394 ;
V_35 -> V_395 . V_396 = F_253 ( struct V_397 ) ;
if ( ! V_35 -> V_395 . V_396 )
return - V_226 ;
V_394 = F_254 ( V_35 ) ;
if ( V_394 < 0 )
F_255 ( V_35 -> V_395 . V_396 ) ;
return V_394 ;
}
...
NULL ) ;
V_111 = 8 - 1 ;
V_398 = ( V_111 + 1 ) * sizeof( struct V_110 ) ;
V_35 -> V_101 . V_133 = F_70 ( V_398 ) ;
if ( ! V_35 -> V_101 . V_133 )
goto V_402;
...
struct V_403 * V_404 ;
V_404 = & V_35 -> V_101 . V_105 [ V_60 ] ;
F_73 ( V_404 -> V_114 , V_398 ) ;
}
F_73 ( V_35 -> V_101 . V_133 , V_398 ) ;
V_402:
return - V_226 ;
}
...
V_404 = & V_35 -> V_101 . V_105 [ V_60 ] ;
V_398 = ( V_404 -> V_111 + 1 ) * sizeof( struct V_110 ) ;
F_103 ( ! F_66 ( V_404 -> V_114 ) ) ;
F_73 ( V_404 -> V_114 , V_398 ) ;
}
V_398 = ( V_35 -> V_101 . V_102 + 1 ) * sizeof( struct V_110 ) ;
...
if ( V_189 )
F_280 ( V_415 , L_2 ,
V_189 -> V_416 , V_189 -> V_417 , V_189 -> V_418 ) ;
switch ( V_2 -> V_28 ) {
case V_29 :
F_280 ( V_415 , L_3 , & V_2 -> V_12 . V_10 ) ;
if ( V_2 -> V_13 != 32 )
F_280 ( V_415 , L_4 ,
V_2 -> V_13 ) ;
F_280 ( V_415 , L_5 , & V_2 -> V_9 . V_10 ) ;
if ( V_2 -> V_11 != 32 )
F_280 ( V_415 , L_6 ,
V_2 -> V_11 ) ;
break;
case V_30 :
F_280 ( V_415 , L_7 , V_2 -> V_12 . V_419 ) ;
if ( V_2 -> V_13 != 128 )
F_280 ( V_415 , L_4 ,
V_2 -> V_13 ) ;
F_280 ( V_415 , L_8 , V_2 -> V_9 . V_419 ) ;
if ( V_2 -> V_11 != 128 )
F_280 ( V_415 , L_6 ,
V_2 -> V_11 ) ;
break;
...
void F_281 ( struct V_54 * V_55 , int V_420 , bool V_194 )
{
struct V_414 * V_415 ;
V_415 = F_282 ( L_9 ) ;
if ( V_415 == NULL )
return;
F_283 ( V_194 , V_415 ) ;
F_280 ( V_415 , L_10 , V_420 ) ;
F_279 ( V_55 , V_415 ) ;
F_284 ( V_415 ) ;
}
void F_112 ( struct V_54 * V_55 , int V_420 ,
bool V_194 )
{
struct V_414 * V_415 ;
V_415 = F_282 ( L_11 ) ;
...
static bool F_285 ( const struct V_1 * V_421 ,
const struct V_1 * V_422 )
{
if ( V_421 -> V_20 == V_423 ) {
if ( V_422 -> V_28 == V_421 -> V_28 &&
F_286 ( & V_422 -> V_9 , & V_421 -> V_9 ,
V_421 -> V_28 ) &&
F_286 ( & V_422 -> V_12 , & V_421 -> V_12 ,
V_421 -> V_28 ) &&
...
static int F_288 ( const struct V_424 * V_183 , const struct V_224 * V_425 )
{
int V_203 = 0 ;
if ( V_425 -> V_232 == V_183 -> V_232 && V_425 -> V_45 . V_20 == V_183 -> V_20 &&
( V_183 -> V_339 == 0 || V_425 -> V_339 == V_183 -> V_339 ) ) {
switch ( V_425 -> V_232 ) {
case V_233 :
case V_234 :
if ( F_286 ( & V_425 -> V_45 . V_9 , & V_183 -> V_426 ,
V_183 -> V_427 ) &&
F_286 ( & V_425 -> V_12 , & V_183 -> V_428 ,
V_183 -> V_427 ) ) {
V_203 = 1 ;
}
break;
...
struct V_424 * V_183 , int V_429 )
{
struct V_424 * V_430 ;
int V_129 , V_431 , V_432 = 0 ;
F_71 ( & V_81 -> V_61 ) ;
if ( F_9 ( V_81 -> V_62 . V_63 ) ) {
F_72 ( & V_81 -> V_61 ) ;
return - V_193 ;
...
for ( V_431 = 0 , V_430 = V_183 ; V_431 < V_429 ; V_431 ++ , V_430 ++ ) {
if ( ! F_288 ( V_430 , & V_81 -> V_223 [ V_129 ] ) )
continue;
V_432 ++ ;
if ( V_81 -> V_223 [ V_129 ] . V_232 != V_233 &&
V_81 -> V_223 [ V_129 ] . V_232 != V_234 )
continue;
memcpy ( & V_81 -> V_223 [ V_129 ] . V_45 . V_9 , & V_430 -> V_433 ,
sizeof( V_81 -> V_223 [ V_129 ] . V_45 . V_9 ) ) ;
memcpy ( & V_81 -> V_223 [ V_129 ] . V_12 , & V_430 -> V_434 ,
sizeof( V_81 -> V_223 [ V_129 ] . V_12 ) ) ;
V_81 -> V_223 [ V_129 ] . V_235 = V_430 -> V_435 ;
F_53 ( & V_81 -> V_100 ) ;
}
}
F_72 ( & V_81 -> V_61 ) ;
...
static int F_290 ( const struct V_424 * V_183 , int V_429 )
{
int V_129 , V_431 ;
if ( V_429 < 1 || V_429 > V_245 )
return - V_201 ;
for ( V_129 = 0 ; V_129 < V_429 ; V_129 ++ ) {
if ( F_286 ( & V_183 [ V_129 ] . V_426 , & V_183 [ V_129 ] . V_433 ,
V_183 [ V_129 ] . V_427 ) &&
F_286 ( & V_183 [ V_129 ] . V_428 , & V_183 [ V_129 ] . V_434 ,
V_183 [ V_129 ] . V_427 ) )
return - V_201 ;
if ( F_149 ( & V_183 [ V_129 ] . V_433 , V_183 [ V_129 ] . V_435 ) ||
F_149 ( & V_183 [ V_129 ] . V_434 , V_183 [ V_129 ] . V_435 ) )
return - V_201 ;
for ( V_431 = V_129 + 1 ; V_431 < V_429 ; V_431 ++ ) {
if ( ! memcmp ( & V_183 [ V_129 ] . V_426 , & V_183 [ V_431 ] . V_426 ,
sizeof( V_183 [ V_129 ] . V_426 ) ) &&
! memcmp ( & V_183 [ V_129 ] . V_428 , & V_183 [ V_431 ] . V_428 ,
sizeof( V_183 [ V_129 ] . V_428 ) ) &&
V_183 [ V_129 ] . V_20 == V_183 [ V_431 ] . V_20 &&
V_183 [ V_129 ] . V_232 == V_183 [ V_431 ] . V_232 &&
V_183 [ V_129 ] . V_339 == V_183 [ V_431 ] . V_339 &&
V_183 [ V_129 ] . V_427 == V_183 [ V_431 ] . V_427 )
return - V_201 ;
}
}
return 0 ;
...
{
int V_129 , V_191 , V_438 = 0 , V_439 = 0 ;
struct V_54 * V_81 = NULL ;
struct V_40 * V_41 , * V_440 ;
struct V_40 * V_441 [ V_245 ] ;
struct V_40 * V_442 [ V_245 ] ;
struct V_424 * V_430 ;
if ( ( V_191 = F_290 ( V_183 , V_429 ) ) < 0 )
goto V_64;
if ( ( V_81 = F_287 ( V_2 , V_60 , type , V_35 ) ) == NULL ) {
V_191 = - V_193 ;
goto V_64;
}
for ( V_129 = 0 , V_430 = V_183 ; V_129 < V_429 ; V_129 ++ , V_430 ++ ) {
if ( ( V_41 = F_291 ( V_430 , V_35 ) ) ) {
V_441 [ V_438 ] = V_41 ;
V_438 ++ ;
if ( ( V_440 = F_292 ( V_41 , V_430 ) ) ) {
V_442 [ V_439 ] = V_440 ;
V_439 ++ ;
} else {
V_191 = - V_436 ;
...
if ( ( V_191 = F_289 ( V_81 , V_183 , V_429 ) ) < 0 )
goto V_443;
if ( V_438 ) {
F_293 ( V_441 , V_438 ) ;
F_294 ( V_441 , V_438 ) ;
}
F_295 ( V_2 , V_60 , type , V_183 , V_429 , V_348 ) ;
F_28 ( V_81 ) ;
return 0 ;
V_64:
return V_191 ;
