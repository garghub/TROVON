...
int F_37 ( unsigned int V_40 , const struct V_61 * V_61 ,
unsigned int V_62 )
{
if ( ! V_63 )
return V_9 ;
if ( ! F_38 ( V_64 , V_61 ) ) {
int V_46 = F_39 ( V_65 , V_61 ) ;
if ( V_46 < V_66 )
return F_4 ( V_46 ) ;
if ( V_62 )
return - 1 ;
...
static void F_43 ( struct V_50 * V_72 ) { }
static int F_44 ( struct V_68 * V_69 , unsigned int V_40 ,
T_4 V_73 )
{
struct V_21 * V_21 ;
F_5 ( L_9 , V_40 , V_73 ) ;
