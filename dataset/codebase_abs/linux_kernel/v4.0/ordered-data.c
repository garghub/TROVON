...
V_77 = F_51 ( & log -> V_75 [ V_79 ] ,
struct V_1 ,
V_52 ) ;
F_52 ( & V_77 -> V_52 ) ;
F_26 ( & log -> V_81 [ V_79 ] ) ;
if ( ! F_57 ( V_43 , & V_77 -> V_37 ) &&
! F_57 ( V_45 , & V_77 -> V_37 ) ) {
