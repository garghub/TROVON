...
if ( V_11 [ V_97 ] ) {
V_94 = true ;
V_93 -> V_98 = F_38 ( V_11 [ V_97 ] ) ;
}
if ( V_11 [ V_99 ] ) {
V_94 = true ;
V_93 -> V_100 = F_38 ( V_11 [ V_99 ] ) ;
}
return V_94 ;
}
static int F_39 ( struct V_4 * V_101 , struct V_40 * V_5 ,
...
int V_14 = F_40 ( V_13 , & V_93 ) ;
if ( V_14 < 0 )
return V_14 ;
}
F_32 ( V_11 , & V_53 ) ;
return F_41 ( V_5 , V_102 , & V_53 ) ;
}
static int F_42 ( struct V_40 * V_5 , struct V_84 * V_102 [] ,
struct V_84 * V_11 [] )
{
struct V_52 V_53 ;
struct V_92 V_93 ;
...
if ( F_47 ( V_2 , V_85 , V_104 -> V_25 ) ||
F_48 ( V_2 , V_86 , V_104 -> V_10 . V_20 ) ||
F_48 ( V_2 , V_87 , V_104 -> V_10 . V_19 ) ||
F_49 ( V_2 , V_88 , V_104 -> V_10 . V_28 ) ||
F_49 ( V_2 , V_89 , V_104 -> V_10 . V_90 ) ||
F_49 ( V_2 , V_91 ,
