...
static int F_71 ( struct V_4 * V_38 )
{
struct V_32 * V_32 = F_32 ( V_38 ) ;
const struct V_76 * V_72 = V_38 -> V_19 ? V_38 -> V_19 -> V_72 : NULL ;
if ( F_66 ( V_32 ) )
...
int F_89 ( struct V_1 * V_2 , struct V_100 * V_101 ,
const char * V_102 )
{
...
struct V_1 * F_95 ( const struct V_32 * V_38 )
{
if ( V_38 -> V_19 )
return V_38 -> V_19 ;
else {
...
static int F_96 ( struct V_4 * V_38 , struct V_21 * V_2 )
{
struct V_32 * V_32 = F_32 ( V_38 ) ;
struct V_1 * V_46 ;
...
static int F_99 ( struct V_4 * V_38 , struct V_112 * V_113 )
{
struct V_32 * V_33 ;
if ( ! V_38 )
return - V_37 ;
V_33 = F_32 ( V_38 ) ;
if ( F_100 ( V_113 , L_7 , V_33 -> V_7 ) )
return - V_13 ;
if ( F_100 ( V_113 , L_8 , V_33 -> V_3 , V_33 -> V_4 ) )
return - V_13 ;
if ( F_100 ( V_113 , L_9 , V_33 -> V_34 ,
V_33 -> V_35 ) )
return - V_13 ;
if ( F_100 ( V_113 , L_10 , F_101 ( V_33 ) ) )
return - V_13 ;
if ( F_100 ( V_113 , L_11 ,
V_33 -> V_3 , V_33 -> V_4 ,
V_33 -> V_34 , V_33 -> V_35 ,
