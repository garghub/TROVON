...
F_80 ( & V_81 -> V_99 ) ;
V_6 = - V_18 ;
V_81 -> V_92 = F_81 ( V_106 , sizeof( * V_60 ) , V_17 ,
true ) ;
if ( ! V_81 -> V_92 )
goto V_77;
V_81 -> V_91 = F_81 ( V_107 , 1024 , V_17 ,
true ) ;
if ( ! V_81 -> V_91 )
goto V_77;
V_60 = V_81 -> V_92 -> V_26 . V_44 ;
V_60 -> V_108 . V_109 = 0 ;
V_60 -> V_108 . V_110 = F_82 ( - 1 ) ;
V_60 -> V_108 . V_111 = 0 ;
...
T_3 V_112 ;
F_4 ( L_28 , V_113 , V_50 , V_80 ) ;
F_3 ( & V_2 , V_3 , 2 * sizeof( T_3 ) , V_14 ) ;
V_112 = F_84 ( & V_2 ) ;
if ( V_80 != 0 && V_80 != V_112 )
goto V_14;
F_37 ( & V_23 -> V_62 ) ;
V_81 = F_56 ( V_23 , V_112 ) ;
if ( V_81 ) {
...
int F_85 ( struct V_22 * V_23 , const char * V_114 ,
T_3 * V_115 )
{
struct V_79 * V_81 ;
void * V_2 , * V_3 ;
...
V_81 -> V_103 = V_115 ;
F_80 ( & V_81 -> V_99 ) ;
V_81 -> V_92 = F_81 ( V_116 ,
sizeof( T_3 ) + sizeof( T_1 ) + strlen ( V_114 ) ,
V_17 , true ) ;
if ( ! V_81 -> V_92 ) {
V_6 = - V_18 ;
goto V_77;
}
V_81 -> V_91 = F_81 ( V_117 , 1024 ,
V_17 , true ) ;
if ( ! V_81 -> V_91 ) {
V_6 = - V_18 ;
goto V_77;
...
V_80 = ++ V_23 -> V_97 ;
F_86 ( & V_2 , V_80 ) ;
F_33 ( & V_2 , V_3 , V_114 , strlen ( V_114 ) ) ;
...
struct V_79 * V_81 ;
struct V_82 * V_2 ;
for ( V_2 = F_88 ( & V_23 -> V_84 ) ; V_2 ; V_2 = F_89 ( V_2 ) ) {
...
static void V_48 ( struct V_118 * V_119 )
{
struct V_22 * V_23 =
F_63 ( V_119 , struct V_22 , V_48 . V_119 ) ;
F_4 ( L_30 ) ;
F_37 ( & V_23 -> V_62 ) ;
if ( V_23 -> V_63 ) {
F_19 ( V_23 ) ;
...
{
struct V_120 * V_121 = V_23 -> V_69 -> V_122 ;
struct V_21 * V_123 = V_121 -> V_123 ;
int V_11 = V_121 -> V_11 ;
int V_5 ;
...
return - V_18 ;
for ( V_5 = 0 ; V_5 < V_11 ; V_5 ++ ) {
V_23 -> V_38 -> V_15 [ V_5 ] . V_19 = V_123 [ V_5 ] ;
V_23 -> V_38 -> V_15 [ V_5 ] . V_19 . V_125 = 0 ;
V_23 -> V_38 -> V_15 [ V_5 ] . V_126 . type =
V_43 ;
V_23 -> V_38 -> V_15 [ V_5 ] . V_126 . V_52 = F_34 ( V_5 ) ;
}
V_23 -> V_38 -> V_11 = V_11 ;
return 0 ;
}
int F_94 ( struct V_22 * V_23 , struct V_73 * V_127 )
{
int V_6 = 0 ;
F_4 ( L_31 ) ;
...
if ( V_6 )
goto V_77;
V_23 -> V_35 = F_96 ( V_127 -> V_122 -> V_126 ,
V_127 -> V_122 -> V_128 ) ;
if ( F_50 ( V_23 -> V_35 ) ) {
V_6 = F_51 ( V_23 -> V_35 ) ;
goto V_129;
...
V_132 | V_133 ;
V_6 = - V_18 ;
V_23 -> V_34 = F_81 ( V_134 ,
sizeof( struct V_59 ) ,
V_17 , true ) ;
if ( ! V_23 -> V_34 )
goto V_135;
V_23 -> V_33 = F_81 ( V_136 , 96 , V_17 ,
true ) ;
if ( ! V_23 -> V_33 )
goto V_137;
V_23 -> V_32 = F_81 ( V_138 , 4096 , V_17 ,
true ) ;
if ( ! V_23 -> V_32 )
goto V_139;
V_23 -> V_25 = F_81 ( V_140 , 4096 , V_17 , true ) ;
V_23 -> V_24 = 0 ;
if ( ! V_23 -> V_25 )
goto V_141;
F_97 ( & V_23 -> V_30 , V_23 , & V_142 ,
& V_23 -> V_69 -> V_143 ) ;
V_23 -> V_31 = - 1 ;
V_23 -> V_63 = true ;
V_23 -> V_40 = V_41 ;
...
F_37 ( & V_23 -> V_62 ) ;
V_75 = F_48 ( V_23 ) ;
V_145 = F_92 ( V_23 -> V_35 ) ;
V_23 -> V_24 = 0 ;
V_37 = F_104 ( V_23 -> V_35 , V_50 -> V_26 . V_44 ,
V_50 -> V_26 . V_27 ,
V_23 -> V_25 -> V_26 . V_44 ,
V_23 -> V_25 -> V_45 ) ;
if ( V_37 < 0 ) {
V_23 -> V_69 -> V_146 = V_37 ;
F_55 ( & V_23 -> V_69 -> V_70 ) ;
} else if ( V_37 > 0 ) {
F_14 ( V_23 , V_37 ) ;
} else if ( ! V_145 && F_92 ( V_23 -> V_35 ) ) {
F_4 ( L_33 ) ;
V_23 -> V_69 -> V_143 . V_147 . V_126 . type = V_148 ;
V_23 -> V_69 -> V_143 . V_147 . V_126 . V_52 =
F_34 ( V_23 -> V_35 -> V_72 ) ;
F_31 ( V_23 ) ;
F_87 ( V_23 ) ;
}
...
if ( V_23 -> V_24 )
return 0 ;
V_37 = F_105 ( V_23 -> V_35 , V_23 -> V_25 -> V_26 . V_44 ,
V_23 -> V_25 -> V_45 ) ;
if ( V_37 <= 0 )
return V_37 ;
F_14 ( V_23 , V_37 ) ;
...
static void F_107 ( struct V_93 * V_30 , struct V_49 * V_50 )
{
struct V_22 * V_23 = V_30 -> V_96 ;
int type = F_108 ( V_50 -> V_28 . type ) ;
if ( ! V_23 )
return;
switch ( type ) {
case V_138 :
...
break;
case V_150 :
F_109 ( & V_23 -> V_69 -> V_151 , V_50 ) ;
break;
default:
if ( V_23 -> V_69 -> V_152 &&
V_23 -> V_69 -> V_152 ( V_23 -> V_69 , V_50 ) == 0 )
break;
F_40 ( L_34 , type ,
F_110 ( type ) ) ;
}
...
static struct V_49 * F_111 ( struct V_93 * V_30 ,
struct V_94 * V_28 ,
int * V_95 )
{
struct V_22 * V_23 = V_30 -> V_96 ;
int type = F_108 ( V_28 -> type ) ;
...
F_112 ( L_36 ,
V_29 , V_4 -> V_45 ,
( unsigned int ) V_30 -> V_154 . type ,
F_70 ( V_30 -> V_154 . V_52 ) ) ;
F_64 ( V_4 ) ;
V_4 = F_81 ( type , V_29 , V_17 , false ) ;
}
return V_4 ;
}
static void F_113 ( struct V_93 * V_30 )
{
struct V_22 * V_23 = V_30 -> V_96 ;
if ( ! V_23 )
return;
...
static struct V_93 * F_114 ( struct V_93 * V_30 )
{
return V_30 ;
}
static void F_115 ( struct V_93 * V_30 )
{
}
