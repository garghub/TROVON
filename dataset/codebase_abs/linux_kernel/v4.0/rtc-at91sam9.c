...
F_31 ( & V_53 -> V_7 , 1 ) ;
F_32 ( V_53 , V_2 ) ;
V_55 = F_33 ( V_53 , V_59 , 0 ) ;
V_2 -> V_60 = F_34 ( & V_53 -> V_7 , V_55 ) ;
if ( F_35 ( V_2 -> V_60 ) )
return F_36 ( V_2 -> V_60 ) ;
if ( ! V_53 -> V_7 . V_61 ) {
void T_3 * V_4 ;
V_55 = F_33 ( V_53 , V_59 , 1 ) ;
V_4 = F_34 ( & V_53 -> V_7 , V_55 ) ;
if ( F_35 ( V_4 ) )
return F_36 ( V_4 ) ;
V_2 -> V_4 = F_37 ( NULL , V_4 ,
& V_62 ) ;
} else {
struct V_63 args ;
V_49 = F_38 ( V_53 -> V_7 . V_61 ,
L_12 , 1 , 0 ,
& args ) ;
if ( V_49 )
return V_49 ;
V_2 -> V_4 = F_39 ( args . V_64 ) ;
V_2 -> V_5 = args . args [ 0 ] ;
}
if ( F_35 ( V_2 -> V_4 ) ) {
F_28 ( & V_53 -> V_7 , L_13 ) ;
...
V_23 &= ~ ( V_25 | V_26 ) ;
F_12 ( V_2 , V_24 , V_23 ) ;
V_2 -> V_45 = F_43 ( & V_53 -> V_7 , V_53 -> V_68 ,
& V_69 , V_70 ) ;
if ( F_35 ( V_2 -> V_45 ) )
return F_36 ( V_2 -> V_45 ) ;
V_49 = F_44 ( & V_53 -> V_7 , V_2 -> V_47 , F_22 ,
V_71 | V_72 ,
F_45 ( & V_2 -> V_45 -> V_7 ) , V_2 ) ;
if ( V_49 ) {
...
struct V_1 * V_2 = F_48 ( V_53 ) ;
T_1 V_23 = F_7 ( V_2 , V_24 ) ;
V_2 -> V_73 = V_23 & ( V_25 | V_26 ) ;
F_12 ( V_2 , V_24 , V_23 & ~ V_2 -> V_73 ) ;
}
