...
T_2 V_59 = 0 ;
F_45 ( & V_59 ) ;
if ( F_46 ( ( void V_23 * ) V_17 , & V_59 , sizeof( V_59 ) ) )
return - V_9 ;
return 0 ;
}
...
V_63 . V_73 = V_61 -> V_74
/ V_61 -> V_72 ;
F_48 ( V_63 . V_39 , V_61 -> V_75 -> V_39 , sizeof( V_63 . V_39 ) ) ;
V_63 . V_76 = V_61 -> V_76 ;
V_63 . type = V_61 -> V_75 -> type ;
V_63 . V_77 = F_49 ( V_26 ) -> V_77 -> V_78 ;
V_63 . V_53 = F_50 ( F_49 ( V_26 ) -> V_79 ) ;
V_63 . V_80 = F_51 ( F_49 ( V_26 ) -> V_79 ) ;
if ( F_46 ( ( void V_23 * ) V_17 , & V_63 ,
sizeof( struct V_62 ) ) ) {
F_9 ( L_20 ) ;
return - V_9 ;
}
...
static long F_52 ( struct V_42 * V_43 , unsigned int V_44 , unsigned long V_17 )
{
int V_45 ;
if ( F_53 ( & V_81 ) )
return - V_9 ;
