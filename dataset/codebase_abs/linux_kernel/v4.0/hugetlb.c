...
return 0 ;
V_65 = F_135 ( V_65 ) ;
return F_136 ( V_65 ) == F_117 ;
}
int F_137 ( struct V_65 * V_120 )
{
if ( ! F_138 ( V_120 ) )
return 0 ;
return F_136 ( V_120 ) == F_117 ;
}
T_1 F_139 ( struct V_65 * V_65 )
{
struct V_65 * V_120 = F_135 ( V_65 ) ;
T_1 V_121 = F_140 ( V_120 ) ;
unsigned long V_122 ;
if ( ! F_92 ( V_120 ) )
return F_140 ( V_65 ) ;
if ( F_141 ( V_120 ) >= V_123 )
V_122 = F_84 ( V_65 ) - F_84 ( V_120 ) ;
else
V_122 = V_65 - V_120 ;
return ( V_121 << F_141 ( V_120 ) ) + V_122 ;
}
static struct V_65 * F_142 ( struct V_40 * V_41 , int V_66 )
{
struct V_65 * V_65 ;
V_65 = F_143 ( V_66 ,
...
static int F_147 ( struct V_40 * V_41 , T_3 * V_87 ,
bool V_130 )
{
int V_104 , V_105 ;
int V_10 = 0 ;
F_148 (h, nr_nodes, node, nodes_allowed) {
if ( ( ! V_130 || V_41 -> V_118 [ V_105 ] ) &&
! F_149 ( & V_41 -> V_68 [ V_105 ] ) ) {
struct V_65 * V_65 =
...
static void F_150 ( struct V_65 * V_65 )
{
F_8 ( & V_117 ) ;
...
void F_151 ( unsigned long V_96 , unsigned long V_97 )
{
...
if ( V_91 > F_31 ( V_41 ) )
V_91 = F_31 ( V_41 ) ;
F_72 ( ! F_153 ( V_96 , 1 << V_91 ) ) ;
for ( V_100 = V_96 ; V_100 < V_97 ; V_100 += 1 << V_91 )
F_150 ( F_89 ( V_100 ) ) ;
}
static struct V_65 * F_154 ( struct V_40 * V_41 , int V_66 )
{
struct V_65 * V_65 ;
unsigned int V_131 ;
if ( F_107 ( V_41 ) )
...
struct V_65 * F_157 ( struct V_40 * V_41 , int V_66 )
{
struct V_65 * V_65 = NULL ;
F_8 ( & V_117 ) ;
...
F_2 ( & V_117 ) ;
if ( ! V_65 )
V_65 = F_154 ( V_41 , V_66 ) ;
return V_65 ;
}
static int F_158 ( struct V_40 * V_41 , int V_9 )
{
struct V_21 V_134 ;
...
while ( V_93 -- ) {
if ( ! F_147 ( V_41 , & V_140 [ V_141 ] , 1 ) )
break;
F_161 ( & V_117 ) ;
}
}
static long F_162 ( struct V_40 * V_41 ,
...
static struct V_65 * F_164 ( struct V_14 * V_15 ,
...
struct V_144 * V_145 ;
V_143 = F_125 ( V_41 ) ;
V_31 = F_162 ( V_41 , V_15 , V_142 ) ;
if ( V_31 < 0 )
return F_165 ( - V_11 ) ;
if ( V_31 || V_75 )
if ( F_10 ( V_2 , 1 ) )
return F_165 ( - V_146 ) ;
V_10 = F_166 ( V_143 , F_108 ( V_41 ) , & V_145 ) ;
if ( V_10 )
goto V_147;
F_8 ( & V_117 ) ;
...
F_167 ( V_143 , F_108 ( V_41 ) , V_145 , V_65 ) ;
F_2 ( & V_117 ) ;
F_120 ( V_65 , ( unsigned long ) V_2 ) ;
F_163 ( V_41 , V_15 , V_142 ) ;
return V_65 ;
V_148:
F_168 ( V_143 , F_108 ( V_41 ) , V_145 ) ;
V_147:
if ( V_31 || V_75 )
F_11 ( V_2 , 1 ) ;
return F_165 ( - V_146 ) ;
}
struct V_65 * F_169 ( struct V_14 * V_15 ,
unsigned long V_142 , int V_75 )
{
struct V_65 * V_65 = F_164 ( V_15 , V_142 , V_75 ) ;
if ( F_170 ( V_65 ) )
V_65 = NULL ;
return V_65 ;
}
int __weak F_171 ( struct V_40 * V_41 )
{
struct V_149 * V_150 ;
int V_104 , V_105 ;
...
return 0 ;
V_152:
F_9 ( ! F_153 ( F_173 ( V_150 ) , F_116 ( V_41 ) ) ) ;
F_22 ( & V_150 -> V_153 , & V_154 ) ;
V_150 -> V_40 = V_41 ;
return 1 ;
}
static void T_4 F_174 ( struct V_65 * V_65 , int V_91 )
{
...
#endif
F_181 ( F_91 ( V_65 ) != 1 ) ;
F_174 ( V_65 , V_41 -> V_91 ) ;
F_181 ( F_90 ( V_65 ) ) ;
F_102 ( V_41 , V_65 , F_52 ( V_65 ) ) ;
if ( F_107 ( V_41 ) )
F_182 ( V_65 , 1 << V_41 -> V_91 ) ;
}
}
static void T_4 F_183 ( struct V_40 * V_41 )
{
unsigned long V_92 ;
...
static char * T_4 F_185 ( char * V_158 , unsigned long V_159 )
{
if ( V_159 >= ( 1UL << 30 ) )
...
char V_158 [ 32 ] ;
F_187 ( L_4 ,
F_185 ( V_158 , F_116 ( V_41 ) ) ,
V_41 -> V_69 ) ;
}
}
static void F_188 ( struct V_40 * V_41 , unsigned long V_3 ,
T_3 * V_87 )
{
int V_92 ;
if ( F_107 ( V_41 ) )
return;
F_189 (i, *nodes_allowed) {
...
static inline void F_188 ( struct V_40 * V_41 , unsigned long V_3 ,
T_3 * V_87 )
{
}
static int F_191 ( struct V_40 * V_41 , T_3 * V_87 ,
int V_9 )
{
int V_104 , V_105 ;
F_72 ( V_9 != - 1 && V_9 != 1 ) ;
...
static unsigned long F_192 ( struct V_40 * V_41 , unsigned long V_3 ,
T_3 * V_87 )
{
...
return V_41 -> V_157 ;
F_8 ( & V_117 ) ;
while ( V_41 -> V_119 && V_3 > F_193 ( V_41 ) ) {
if ( ! F_191 ( V_41 , V_87 , - 1 ) )
break;
}
while ( V_3 > F_193 ( V_41 ) ) {
F_2 ( & V_117 ) ;
if ( F_107 ( V_41 ) )
V_10 = F_103 ( V_41 , V_87 ) ;
else
V_10 = F_145 ( V_41 , V_87 ) ;
F_8 ( & V_117 ) ;
if ( ! V_10 )
goto V_35;
if ( F_194 ( V_162 ) )
...
F_188 ( V_41 , V_161 , V_87 ) ;
while ( V_161 < F_193 ( V_41 ) ) {
if ( ! F_147 ( V_41 , V_87 , 0 ) )
break;
F_161 ( & V_117 ) ;
}
while ( V_3 < F_193 ( V_41 ) ) {
...
return F_196 ( V_164 , V_165 ) ;
}
static T_5 F_197 ( struct V_163 * V_164 ,
struct V_169 * V_170 , char * V_158 )
{
struct V_40 * V_41 ;
unsigned long V_106 ;
int V_66 ;
V_41 = F_195 ( V_164 , & V_66 ) ;
if ( V_66 == V_133 )
V_106 = V_41 -> V_106 ;
else
...
V_87 = & V_140 [ V_141 ] ;
V_41 -> V_157 = F_192 ( V_41 , V_3 , V_87 ) ;
if ( V_87 != & V_140 [ V_141 ] )
F_201 ( V_87 ) ;
return V_172 ;
V_35:
...
int V_66 ;
int V_85 ;
V_85 = F_204 ( V_158 , 10 , & V_3 ) ;
if ( V_85 )
return V_85 ;
V_41 = F_195 ( V_164 , & V_66 ) ;
return F_198 ( V_171 , V_41 , V_66 , V_3 , V_172 ) ;
}
static T_5 F_205 ( struct V_163 * V_164 ,
struct V_169 * V_170 , char * V_158 )
{
return F_197 ( V_164 , V_170 , V_158 ) ;
}
static T_5 F_206 ( struct V_163 * V_164 ,
struct V_169 * V_170 , const char * V_158 , T_6 V_172 )
{
return F_203 ( false , V_164 , V_158 , V_172 ) ;
}
...
struct V_169 * V_170 , const char * V_158 , T_6 V_172 )
{
return F_203 ( true , V_164 , V_158 , V_172 ) ;
}
static T_5 F_209 ( struct V_163 * V_164 ,
struct V_169 * V_170 , char * V_158 )
{
struct V_40 * V_41 = F_195 ( V_164 , NULL ) ;
...
static T_5 F_213 ( struct V_163 * V_164 ,
struct V_169 * V_170 , char * V_158 )
{
struct V_40 * V_41 ;
unsigned long V_119 ;
...
static int F_214 ( struct V_40 * V_41 , struct V_163 * V_176 ,
struct V_163 * * V_167 ,
struct V_177 * V_178 )
{
int V_179 ;
int V_180 = F_125 ( V_41 ) ;
V_167 [ V_180 ] = F_215 ( V_41 -> V_181 , V_176 ) ;
if ( ! V_167 [ V_180 ] )
return - V_11 ;
V_179 = F_216 ( V_167 [ V_180 ] , V_178 ) ;
if ( V_179 )
F_217 ( V_167 [ V_180 ] ) ;
return V_179 ;
}
...
struct V_40 * V_41 ;
int V_85 ;
V_182 = F_215 ( L_6 , V_183 ) ;
if ( ! V_182 )
return;
F_115 (h) {
V_85 = F_214 ( V_41 , V_182 ,
V_167 , & V_178 ) ;
if ( V_85 )
F_219 ( L_7 , V_41 -> V_181 ) ;
}
}
static struct V_40 * F_196 ( struct V_163 * V_164 , int * V_165 )
{
int V_66 ;
...
static void F_221 ( struct V_105 * V_105 )
{
struct V_40 * V_41 ;
...
static void F_224 ( struct V_105 * V_105 )
{
struct V_40 * V_41 ;
struct V_185 * V_186 = & V_187 [ V_105 -> V_188 . V_189 ] ;
int V_85 ;
if ( V_186 -> V_182 )
return;
V_186 -> V_182 = F_215 ( L_6 ,
& V_105 -> V_188 . V_164 ) ;
if ( ! V_186 -> V_182 )
return;
F_115 (h) {
V_85 = F_214 ( V_41 , V_186 -> V_182 ,
V_186 -> V_167 ,
& V_191 ) ;
if ( V_85 ) {
F_219 ( L_8 ,
...
static void T_7 F_227 ( void )
{
struct V_40 * V_41 ;
F_222 () ;
F_115 (h) {
F_217 ( V_167 [ F_125 ( V_41 ) ] ) ;
}
F_217 ( V_182 ) ;
F_3 ( V_192 ) ;
}
static int T_4 F_228 ( void )
{
int V_92 ;
if ( ! F_152 () )
return 0 ;
...
static int T_4 F_237 ( char * V_205 )
{
V_193 = F_238 ( V_205 , & V_205 ) ;
return 1 ;
}
static unsigned int F_239 ( unsigned int * V_208 )
{
int V_105 ;
unsigned int V_209 = 0 ;
F_189 (node, cpuset_current_mems_allowed)
V_209 += V_208 [ V_105 ] ;
return V_209 ;
}
static int F_240 ( bool V_171 ,
...
V_10 = F_241 ( V_211 , V_212 , V_213 , V_214 , V_215 ) ;
if ( V_10 )
goto V_35;
if ( V_212 )
V_10 = F_198 ( V_171 , V_41 ,
V_133 , V_135 , * V_214 ) ;
V_35:
return V_10 ;
}
...
void T_8 * V_213 , T_6 * V_214 , T_9 * V_215 )
{
return F_240 ( false , V_211 , V_212 ,
V_213 , V_214 , V_215 ) ;
}
int F_243 ( struct V_210 * V_211 , int V_212 ,
void T_8 * V_213 , T_6 * V_214 , T_9 * V_215 )
{
return F_240 ( true , V_211 , V_212 ,
V_213 , V_214 , V_215 ) ;
}
int F_244 ( struct V_210 * V_211 , int V_212 ,
void T_8 * V_213 ,
T_6 * V_214 , T_9 * V_215 )
{
struct V_40 * V_41 = & V_198 ;
...
static int F_250 ( struct V_40 * V_41 , long V_9 )
{
int V_10 = - V_11 ;
F_8 ( & V_117 ) ;
if ( V_9 > 0 ) {
...
F_254 ( & V_18 -> V_48 , F_41 ) ;
if ( V_221 ) {
F_250 ( V_41 , - V_221 ) ;
F_11 ( V_2 , V_221 ) ;
}
}
static int F_255 ( struct V_14 * V_15 , struct V_224 * V_225 )
{
F_220 () ;
return 0 ;
}
static T_10 F_256 ( struct V_14 * V_15 , struct V_65 * V_65 ,
int V_226 )
{
T_10 V_227 ;
if ( V_226 ) {
V_227 = F_257 ( F_258 ( F_259 ( V_65 ,
V_15 -> V_228 ) ) ) ;
} else {
V_227 = F_260 ( F_259 ( V_65 ,
V_15 -> V_228 ) ) ;
}
V_227 = F_261 ( V_227 ) ;
V_227 = F_262 ( V_227 ) ;
V_227 = F_263 ( V_227 , V_15 , V_65 , V_226 ) ;
return V_227 ;
}
static void F_264 ( struct V_14 * V_15 ,
unsigned long V_42 , T_10 * V_229 )
{
T_10 V_227 ;
V_227 = F_257 ( F_258 ( F_265 ( V_229 ) ) ) ;
if ( F_266 ( V_15 , V_42 , V_229 , V_227 , 1 ) )
F_267 ( V_15 , V_42 , V_229 ) ;
}
static int F_268 ( T_10 V_230 )
{
T_11 V_231 ;
if ( F_269 ( V_230 ) || F_270 ( V_230 ) )
return 0 ;
V_231 = F_271 ( V_230 ) ;
if ( F_272 ( V_231 ) && F_273 ( V_231 ) )
return 1 ;
else
return 0 ;
}
static int F_274 ( T_10 V_230 )
{
T_11 V_231 ;
if ( F_269 ( V_230 ) || F_270 ( V_230 ) )
return 0 ;
V_231 = F_271 ( V_230 ) ;
if ( F_272 ( V_231 ) && F_275 ( V_231 ) )
return 1 ;
else
return 0 ;
}
int F_276 ( struct V_232 * V_233 , struct V_232 * V_234 ,
struct V_14 * V_15 )
{
...
V_241 = V_15 -> V_223 ;
if ( V_238 )
F_277 ( V_234 , V_240 , V_241 ) ;
for ( V_142 = V_15 -> V_43 ; V_142 < V_15 -> V_223 ; V_142 += V_239 ) {
T_12 * V_244 , * V_245 ;
V_235 = F_278 ( V_234 , V_142 ) ;
if ( ! V_235 )
continue;
V_236 = F_279 ( V_233 , V_142 , V_239 ) ;
if ( ! V_236 ) {
V_10 = - V_11 ;
break;
}
if ( V_236 == V_235 )
continue;
V_245 = F_280 ( V_41 , V_233 , V_236 ) ;
V_244 = F_281 ( V_41 , V_234 , V_235 ) ;
F_282 ( V_244 , V_246 ) ;
V_227 = F_265 ( V_235 ) ;
if ( F_269 ( V_227 ) ) {
;
} else if ( F_67 ( F_268 ( V_227 ) ||
F_274 ( V_227 ) ) ) {
T_11 V_247 = F_271 ( V_227 ) ;
if ( F_283 ( V_247 ) && V_238 ) {
F_284 ( & V_247 ) ;
V_227 = F_285 ( V_247 ) ;
F_286 ( V_234 , V_142 , V_235 , V_227 ) ;
}
F_286 ( V_233 , V_142 , V_236 , V_227 ) ;
} else {
if ( V_238 ) {
F_287 ( V_234 , V_142 , V_235 ) ;
F_288 ( V_234 , V_240 ,
V_241 ) ;
}
V_227 = F_265 ( V_235 ) ;
...
if ( V_238 )
F_292 ( V_234 , V_240 , V_241 ) ;
return V_10 ;
}
void F_293 ( struct V_248 * V_249 , struct V_14 * V_15 ,
...
F_181 ( ! F_35 ( V_15 ) ) ;
F_9 ( V_222 & ~ F_294 ( V_41 ) ) ;
F_9 ( V_36 & ~ F_294 ( V_41 ) ) ;
F_295 ( V_249 , V_15 ) ;
F_277 ( V_252 , V_240 , V_241 ) ;
V_42 = V_222 ;
V_255:
for (; V_42 < V_36 ; V_42 += V_239 ) {
V_229 = F_278 ( V_252 , V_42 ) ;
if ( ! V_229 )
continue;
V_254 = F_280 ( V_41 , V_252 , V_229 ) ;
if ( F_296 ( V_252 , & V_42 , V_229 ) )
goto V_256;
V_230 = F_265 ( V_229 ) ;
if ( F_269 ( V_230 ) )
goto V_256;
if ( F_67 ( ! F_270 ( V_230 ) ) ) {
F_297 ( V_252 , V_42 , V_229 ) ;
goto V_256;
}
V_65 = F_289 ( V_230 ) ;
if ( V_250 ) {
...
V_230 = F_298 ( V_252 , V_42 , V_229 ) ;
F_299 ( V_249 , V_229 , V_42 ) ;
if ( F_300 ( V_230 ) )
F_301 ( V_65 ) ;
F_302 ( V_65 ) ;
V_251 = ! F_303 ( V_249 , V_65 ) ;
if ( V_251 ) {
V_42 += V_239 ;
F_2 ( V_254 ) ;
break;
...
F_292 ( V_252 , V_240 , V_241 ) ;
F_305 ( V_249 , V_15 ) ;
}
void F_306 ( struct V_248 * V_249 ,
struct V_14 * V_15 , unsigned long V_222 ,
unsigned long V_36 , struct V_65 * V_250 )
{
F_293 ( V_249 , V_15 , V_222 , V_36 , V_250 ) ;
V_15 -> V_53 &= ~ V_54 ;
}
void F_307 ( struct V_14 * V_15 , unsigned long V_222 ,
unsigned long V_36 , struct V_65 * V_250 )
{
struct V_232 * V_252 ;
struct V_248 V_249 ;
V_252 = V_15 -> V_253 ;
F_308 ( & V_249 , V_252 , V_222 , V_36 ) ;
F_293 ( & V_249 , V_15 , V_222 , V_36 , V_250 ) ;
F_309 ( & V_249 , V_222 , V_36 ) ;
}
static void F_310 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
struct V_55 * V_56 ;
T_1 V_259 ;
V_42 = V_42 & F_294 ( V_41 ) ;
V_259 = ( ( V_42 - V_15 -> V_43 ) >> V_156 ) +
V_15 -> V_44 ;
V_56 = F_15 ( V_15 -> V_16 ) -> V_51 ;
F_311 ( V_56 ) ;
F_312 (iter_vma, &mapping->i_mmap, pgoff, pgoff) {
if ( V_258 == V_15 )
continue;
if ( ! F_48 ( V_258 , V_64 ) )
F_307 ( V_258 , V_42 ,
...
static int F_314 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
V_261 = F_289 ( V_230 ) ;
V_264:
if ( F_121 ( V_261 ) == 1 && F_315 ( V_261 ) ) {
F_316 ( V_261 , V_15 , V_42 ) ;
...
F_317 ( V_261 ) ;
F_2 ( V_254 ) ;
V_262 = F_164 ( V_15 , V_42 , V_263 ) ;
if ( F_170 ( V_262 ) ) {
if ( V_263 ) {
F_318 ( V_261 ) ;
F_9 ( F_269 ( V_230 ) ) ;
F_310 ( V_252 , V_15 , V_261 , V_42 ) ;
F_9 ( F_269 ( V_230 ) ) ;
F_8 ( V_254 ) ;
V_229 = F_278 ( V_252 , V_42 & F_294 ( V_41 ) ) ;
if ( F_319 ( V_229 &&
F_320 ( F_265 ( V_229 ) , V_230 ) ) )
goto V_264;
return 0 ;
}
V_10 = ( F_321 ( V_262 ) == - V_11 ) ?
V_265 : V_266 ;
goto V_267;
}
if ( F_67 ( F_322 ( V_15 ) ) ) {
...
F_323 ( V_262 , V_261 , V_42 , V_15 ,
F_108 ( V_41 ) ) ;
F_324 ( V_262 ) ;
V_240 = V_42 & F_294 ( V_41 ) ;
V_241 = V_240 + F_116 ( V_41 ) ;
F_277 ( V_252 , V_240 , V_241 ) ;
F_8 ( V_254 ) ;
V_229 = F_278 ( V_252 , V_42 & F_294 ( V_41 ) ) ;
if ( F_319 ( V_229 && F_320 ( F_265 ( V_229 ) , V_230 ) ) ) {
F_123 ( V_262 ) ;
F_325 ( V_15 , V_42 , V_229 ) ;
F_288 ( V_252 , V_240 , V_241 ) ;
F_286 ( V_252 , V_42 , V_229 ,
F_256 ( V_15 , V_262 , 1 ) ) ;
F_302 ( V_261 ) ;
F_326 ( V_262 , V_15 , V_42 ) ;
V_262 = V_261 ;
}
F_2 ( V_254 ) ;
F_292 ( V_252 , V_240 , V_241 ) ;
...
static struct V_65 * F_327 ( struct V_40 * V_41 ,
struct V_14 * V_15 , unsigned long V_42 )
{
struct V_55 * V_56 ;
T_1 V_143 ;
...
return F_328 ( V_56 , V_143 ) ;
}
static bool F_329 ( struct V_40 * V_41 ,
struct V_14 * V_15 , unsigned long V_42 )
{
struct V_55 * V_56 ;
T_1 V_143 ;
...
V_56 = V_15 -> V_16 -> V_57 ;
V_143 = F_29 ( V_41 , V_15 , V_42 ) ;
V_65 = F_330 ( V_56 , V_143 ) ;
if ( V_65 )
F_128 ( V_65 ) ;
return V_65 != NULL ;
}
static int F_331 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
if ( ! V_65 ) {
V_115 = F_332 ( V_56 -> V_58 ) >> F_30 ( V_41 ) ;
if ( V_143 >= V_115 )
goto V_35;
V_65 = F_164 ( V_15 , V_42 , 0 ) ;
if ( F_170 ( V_65 ) ) {
V_10 = F_321 ( V_65 ) ;
if ( V_10 == - V_11 )
V_10 = V_265 ;
...
F_333 ( V_65 , V_42 , F_108 ( V_41 ) ) ;
F_324 ( V_65 ) ;
if ( V_15 -> V_53 & V_54 ) {
int V_85 ;
struct V_12 * V_12 = V_56 -> V_58 ;
V_85 = F_334 ( V_65 , V_56 , V_143 , V_7 ) ;
if ( V_85 ) {
F_128 ( V_65 ) ;
if ( V_85 == - V_272 )
goto V_32;
...
if ( F_162 ( V_41 , V_15 , V_42 ) < 0 ) {
V_10 = V_265 ;
goto V_275;
}
V_254 = F_281 ( V_41 , V_252 , V_229 ) ;
F_8 ( V_254 ) ;
V_115 = F_332 ( V_56 -> V_58 ) >> F_30 ( V_41 ) ;
if ( V_143 >= V_115 )
goto V_278;
V_10 = 0 ;
if ( ! F_269 ( F_265 ( V_229 ) ) )
goto V_278;
if ( V_269 ) {
F_123 ( V_65 ) ;
F_326 ( V_65 , V_15 , V_42 ) ;
} else
F_291 ( V_65 ) ;
V_270 = F_256 ( V_15 , V_65 , ( ( V_15 -> V_53 & V_279 )
&& ( V_15 -> V_53 & V_242 ) ) ) ;
F_286 ( V_252 , V_42 , V_229 , V_270 ) ;
if ( ( V_61 & V_277 ) && ! ( V_15 -> V_53 & V_242 ) ) {
V_10 = F_314 ( V_252 , V_15 , V_42 , V_229 , V_270 , V_65 , V_254 ) ;
}
F_2 ( V_254 ) ;
F_339 ( V_65 ) ;
V_35:
...
static T_13 F_340 ( struct V_40 * V_41 , struct V_232 * V_252 ,
struct V_14 * V_15 ,
struct V_55 * V_56 ,
...
V_281 = F_341 ( ( T_13 * ) & V_280 , sizeof( V_280 ) / sizeof( T_13 ) , 0 ) ;
...
int F_342 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
V_227 = F_265 ( V_229 ) ;
if ( F_67 ( F_268 ( V_227 ) ) ) {
F_343 ( V_15 , V_252 , V_229 ) ;
return 0 ;
} else if ( F_67 ( F_274 ( V_227 ) ) )
return V_283 |
F_338 ( F_125 ( V_41 ) ) ;
}
V_229 = F_279 ( V_252 , V_42 , F_116 ( V_41 ) ) ;
if ( ! V_229 )
return V_265 ;
V_56 = V_15 -> V_16 -> V_57 ;
V_143 = F_29 ( V_41 , V_15 , V_42 ) ;
V_281 = F_340 ( V_41 , V_252 , V_15 , V_56 , V_143 , V_42 ) ;
F_344 ( & V_192 [ V_281 ] ) ;
V_227 = F_265 ( V_229 ) ;
if ( F_269 ( V_227 ) ) {
V_10 = F_331 ( V_252 , V_15 , V_56 , V_143 , V_42 , V_229 , V_61 ) ;
goto V_284;
}
V_10 = 0 ;
if ( ! F_270 ( V_227 ) )
goto V_284;
if ( ( V_61 & V_277 ) && ! F_345 ( V_227 ) ) {
if ( F_162 ( V_41 , V_15 , V_42 ) < 0 ) {
V_10 = V_265 ;
goto V_284;
}
...
V_254 = F_280 ( V_41 , V_252 , V_229 ) ;
if ( F_67 ( ! F_320 ( V_227 , F_265 ( V_229 ) ) ) )
goto V_285;
V_65 = F_289 ( V_227 ) ;
if ( V_65 != V_260 )
if ( ! F_346 ( V_65 ) ) {
...
if ( V_61 & V_277 ) {
if ( ! F_345 ( V_227 ) ) {
V_10 = F_314 ( V_252 , V_15 , V_42 , V_229 , V_227 ,
V_260 , V_254 ) ;
goto V_286;
}
V_227 = F_258 ( V_227 ) ;
...
V_227 = F_261 ( V_227 ) ;
if ( F_266 ( V_15 , V_42 , V_229 , V_227 ,
V_61 & V_277 ) )
F_267 ( V_15 , V_42 , V_229 ) ;
V_286:
if ( V_65 != V_260 )
...
long F_349 ( struct V_232 * V_252 , struct V_14 * V_15 ,
struct V_65 * * V_287 , struct V_14 * * V_288 ,
unsigned long * V_289 , unsigned long * V_93 ,
long V_92 , unsigned int V_61 )
{
unsigned long V_290 ;
unsigned long V_291 = * V_289 ;
unsigned long V_292 = * V_93 ;
struct V_40 * V_41 = F_33 ( V_15 ) ;
while ( V_291 < V_15 -> V_223 && V_292 ) {
T_10 * V_230 ;
T_12 * V_254 = NULL ;
int V_293 ;
struct V_65 * V_65 ;
V_230 = F_278 ( V_252 , V_291 & F_294 ( V_41 ) ) ;
if ( V_230 )
V_254 = F_280 ( V_41 , V_252 , V_230 ) ;
V_293 = ! V_230 || F_269 ( F_265 ( V_230 ) ) ;
if ( V_293 && ( V_61 & V_294 ) &&
! F_329 ( V_41 , V_15 , V_291 ) ) {
if ( V_230 )
F_2 ( V_254 ) ;
V_292 = 0 ;
break;
}
if ( V_293 || F_350 ( F_265 ( V_230 ) ) ||
( ( V_61 & V_295 ) &&
! F_345 ( F_265 ( V_230 ) ) ) ) {
int V_10 ;
if ( V_230 )
F_2 ( V_254 ) ;
V_10 = F_342 ( V_252 , V_15 , V_291 ,
( V_61 & V_295 ) ? V_277 : 0 ) ;
if ( ! ( V_10 & V_296 ) )
continue;
V_292 = 0 ;
...
V_290 = ( V_291 & ~ F_294 ( V_41 ) ) >> V_156 ;
V_65 = F_289 ( F_265 ( V_230 ) ) ;
V_297:
if ( V_287 ) {
V_287 [ V_92 ] = F_351 ( V_65 , V_290 ) ;
F_352 ( V_287 [ V_92 ] ) ;
}
if ( V_288 )
V_288 [ V_92 ] = V_15 ;
...
* V_93 = V_292 ;
* V_289 = V_291 ;
return V_92 ? V_92 : - V_298 ;
}
unsigned long F_353 ( struct V_14 * V_15 ,
unsigned long V_42 , unsigned long V_36 , T_14 V_299 )
{
struct V_232 * V_252 = V_15 -> V_253 ;
...
F_9 ( V_42 >= V_36 ) ;
F_354 ( V_15 , V_42 , V_36 ) ;
F_277 ( V_252 , V_222 , V_36 ) ;
F_311 ( V_15 -> V_16 -> V_57 ) ;
...
if ( F_67 ( F_268 ( V_230 ) ) ) {
T_11 V_227 = F_271 ( V_230 ) ;
if ( F_283 ( V_227 ) ) {
T_10 V_300 ;
F_284 ( & V_227 ) ;
V_300 = F_285 ( V_227 ) ;
F_286 ( V_252 , V_42 , V_229 , V_300 ) ;
V_287 ++ ;
}
F_2 ( V_254 ) ;
continue;
...
if ( ! F_269 ( V_230 ) ) {
V_230 = F_298 ( V_252 , V_42 , V_229 ) ;
V_230 = F_262 ( F_355 ( V_230 , V_299 ) ) ;
V_230 = F_263 ( V_230 , V_15 , NULL , 0 ) ;
F_286 ( V_252 , V_42 , V_229 , V_230 ) ;
V_287 ++ ;
}
F_2 ( V_254 ) ;
}
F_356 ( V_15 , V_222 , V_36 ) ;
F_288 ( V_252 , V_222 , V_36 ) ;
F_313 ( V_15 -> V_16 -> V_57 ) ;
F_292 ( V_252 , V_222 , V_36 ) ;
return V_287 << V_41 -> V_91 ;
}
int F_357 ( struct V_12 * V_12 ,
long V_29 , long V_28 ,
struct V_14 * V_15 ,
T_15 V_53 )
{
long V_10 , V_31 ;
struct V_40 * V_41 = F_358 ( V_12 ) ;
...
F_254 ( & V_17 -> V_48 , F_41 ) ;
return V_10 ;
}
void F_359 ( struct V_12 * V_12 , long V_302 , long V_303 )
{
struct V_40 * V_41 = F_358 ( V_12 ) ;
...
struct V_1 * V_2 = F_12 ( V_12 ) ;
if ( V_17 )
V_31 = F_23 ( V_17 , V_302 ) ;
F_8 ( & V_12 -> V_273 ) ;
V_12 -> V_274 -= ( F_335 ( V_41 ) * V_303 ) ;
F_2 ( & V_12 -> V_273 ) ;
F_11 ( V_2 , ( V_31 - V_303 ) ) ;
F_250 ( V_41 , - ( V_31 - V_303 ) ) ;
}
static unsigned long F_360 ( struct V_14 * V_304 ,
struct V_14 * V_15 ,
unsigned long V_142 , T_1 V_143 )
{
unsigned long V_305 = ( ( V_143 - V_304 -> V_44 ) << V_156 ) +
V_304 -> V_43 ;
unsigned long V_306 = V_305 & V_307 ;
unsigned long V_308 = V_306 + V_309 ;
unsigned long V_53 = V_15 -> V_53 & ~ V_310 ;
unsigned long V_311 = V_304 -> V_53 & ~ V_310 ;
if ( F_361 ( V_142 ) != F_361 ( V_305 ) ||
V_53 != V_311 ||
V_306 < V_304 -> V_43 || V_304 -> V_223 < V_308 )
return 0 ;
return V_305 ;
}
static int F_362 ( struct V_14 * V_15 , unsigned long V_142 )
{
unsigned long V_312 = V_142 & V_307 ;
unsigned long V_36 = V_312 + V_309 ;
if ( V_15 -> V_53 & V_54 &&
V_15 -> V_43 <= V_312 && V_36 <= V_15 -> V_223 )
return 1 ;
return 0 ;
}
T_10 * F_363 ( struct V_232 * V_252 , unsigned long V_142 , T_16 * V_313 )
{
struct V_14 * V_15 = F_364 ( V_252 , V_142 ) ;
struct V_55 * V_56 = V_15 -> V_16 -> V_57 ;
...
T_12 * V_254 ;
if ( ! F_362 ( V_15 , V_142 ) )
return ( T_10 * ) F_365 ( V_252 , V_313 , V_142 ) ;
F_311 ( V_56 ) ;
F_312 (svma, &mapping->i_mmap, idx, idx) {
if ( V_304 == V_15 )
continue;
V_305 = F_360 ( V_304 , V_15 , V_142 , V_143 ) ;
if ( V_305 ) {
V_314 = F_278 ( V_304 -> V_253 , V_305 ) ;
if ( V_314 ) {
F_366 ( V_252 ) ;
F_290 ( F_180 ( V_314 ) ) ;
break;
...
if ( ! V_314 )
goto V_35;
V_254 = F_281 ( F_33 ( V_15 ) , V_252 , V_314 ) ;
F_8 ( V_254 ) ;
if ( F_367 ( * V_313 ) ) {
F_368 ( V_252 , V_313 ,
( V_315 * ) ( ( unsigned long ) V_314 & V_316 ) ) ;
} else {
F_128 ( F_180 ( V_314 ) ) ;
F_366 ( V_252 ) ;
}
F_2 ( V_254 ) ;
V_35:
V_230 = ( T_10 * ) F_365 ( V_252 , V_313 , V_142 ) ;
F_313 ( V_56 ) ;
return V_230 ;
}
int F_296 ( struct V_232 * V_252 , unsigned long * V_142 , T_10 * V_229 )
{
T_17 * V_317 = F_369 ( V_252 , * V_142 ) ;
T_16 * V_313 = F_370 ( V_317 , * V_142 ) ;
F_9 ( F_91 ( F_180 ( V_229 ) ) == 0 ) ;
if ( F_91 ( F_180 ( V_229 ) ) == 1 )
return 0 ;
F_371 ( V_313 ) ;
F_128 ( F_180 ( V_229 ) ) ;
F_372 ( V_252 ) ;
* V_142 = F_98 ( * V_142 , V_194 * V_318 ) - V_194 ;
return 1 ;
}
T_10 * F_363 ( struct V_232 * V_252 , unsigned long V_142 , T_16 * V_313 )
{
...
T_10 * F_279 ( struct V_232 * V_252 ,
unsigned long V_142 , unsigned long V_239 )
{
T_17 * V_317 ;
T_16 * V_313 ;
T_10 * V_230 = NULL ;
V_317 = F_369 ( V_252 , V_142 ) ;
V_313 = F_373 ( V_252 , V_317 , V_142 ) ;
if ( V_313 ) {
if ( V_239 == V_309 ) {
V_230 = ( T_10 * ) V_313 ;
} else {
F_9 ( V_239 != V_319 ) ;
if ( F_374 () && F_367 ( * V_313 ) )
V_230 = F_363 ( V_252 , V_142 , V_313 ) ;
else
V_230 = ( T_10 * ) F_365 ( V_252 , V_313 , V_142 ) ;
}
}
F_9 ( V_230 && ! F_375 ( * V_230 ) && ! F_376 ( * V_230 ) ) ;
return V_230 ;
}
T_10 * F_278 ( struct V_232 * V_252 , unsigned long V_142 )
{
T_17 * V_317 ;
T_16 * V_313 ;
V_315 * V_320 = NULL ;
V_317 = F_369 ( V_252 , V_142 ) ;
if ( F_377 ( * V_317 ) ) {
V_313 = F_370 ( V_317 , V_142 ) ;
if ( F_378 ( * V_313 ) ) {
if ( F_379 ( * V_313 ) )
return ( T_10 * ) V_313 ;
V_320 = F_380 ( V_313 , V_142 ) ;
}
}
return ( T_10 * ) V_320 ;
}
struct V_65 * __weak
F_381 ( struct V_232 * V_252 , unsigned long V_42 ,
int V_212 )
{
return F_165 ( - V_174 ) ;
}
struct V_65 * __weak
F_382 ( struct V_232 * V_252 , unsigned long V_42 ,
V_315 * V_320 , int V_61 )
{
struct V_65 * V_65 = NULL ;
T_12 * V_254 ;
V_32:
V_254 = F_383 ( V_252 , V_320 ) ;
F_8 ( V_254 ) ;
if ( ! F_384 ( * V_320 ) )
goto V_35;
if ( F_385 ( * V_320 ) ) {
V_65 = F_289 ( * ( T_10 * ) V_320 ) +
( ( V_42 & ~ V_321 ) >> V_156 ) ;
if ( V_61 & V_322 )
F_290 ( V_65 ) ;
} else {
if ( F_268 ( F_265 ( ( T_10 * ) V_320 ) ) ) {
F_2 ( V_254 ) ;
F_386 ( V_252 , ( T_10 * ) V_320 , V_254 ) ;
goto V_32;
}
}
V_35:
...
struct V_65 * __weak
F_387 ( struct V_232 * V_252 , unsigned long V_42 ,
T_16 * V_313 , int V_61 )
{
if ( V_61 & V_322 )
return NULL ;
return F_289 ( * ( T_10 * ) V_313 ) + ( ( V_42 & ~ V_307 ) >> V_156 ) ;
}
static int F_388 ( struct V_65 * V_323 )
{
struct V_65 * V_65 ;
struct V_65 * V_135 ;
struct V_40 * V_41 = F_118 ( V_323 ) ;
int V_66 = F_52 ( V_323 ) ;
...
bool F_391 ( struct V_65 * V_65 , struct V_21 * V_153 )
{
F_109 ( ! F_138 ( V_65 ) , V_65 ) ;
if ( ! F_392 ( V_65 ) )
return false ;
F_8 ( & V_117 ) ;
F_393 ( & V_65 -> V_67 , V_153 ) ;
F_2 ( & V_117 ) ;
return true ;
}
void F_394 ( struct V_65 * V_65 )
{
F_109 ( ! F_138 ( V_65 ) , V_65 ) ;
F_8 ( & V_117 ) ;
F_393 ( & V_65 -> V_67 , & ( F_118 ( V_65 ) ) -> V_71 ) ;
F_2 ( & V_117 ) ;
F_128 ( V_65 ) ;
}
bool F_395 ( struct V_65 * V_65 )
{
