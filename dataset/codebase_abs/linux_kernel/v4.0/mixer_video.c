...
static int F_92 ( struct V_178 * V_179 , unsigned int V_192 )
{
struct V_41 * V_42 = F_86 ( V_179 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
...
static void F_95 ( unsigned long V_198 )
{
...
V_42 -> V_199 = NULL ;
if ( V_42 -> V_199 ) {
F_96 ( & V_42 -> V_199 -> V_186 , V_201 ) ;
V_42 -> V_199 = NULL ;
}
if ( V_42 -> V_200 ) {
F_96 ( & V_42 -> V_200 -> V_186 , V_201 ) ;
V_42 -> V_200 = NULL ;
}
F_91 ( & V_42 -> V_189 , V_132 ) ;
}
static void F_97 ( struct V_178 * V_179 )
{
struct V_41 * V_42 = F_86 ( V_179 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
...
static void F_114 ( struct V_158 * V_213 )
{
F_115 ( L_32 ) ;
}
