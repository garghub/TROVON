...
{
struct V_109 * V_110 = F_4 ( V_108 ) ;
struct V_198 * V_169 = & V_108 -> V_169 ;
F_33 ( V_169 , V_199 ,
F_17 ( V_199 ) ) ;
F_34 ( V_169 , V_200 ,
F_17 ( V_200 ) ) ;
...
static int F_41 ( struct V_218 * V_219 , int V_244 ,
...
static int F_42 ( struct V_218 * V_219 , unsigned int V_248 )
{
struct V_107 * V_108 = V_219 -> V_108 ;
unsigned int V_221 = 0 ;
unsigned int V_223 = 0 ;
...
static int F_43 ( struct V_218 * V_219 , unsigned int V_270 ,
...
static int F_44 ( struct V_279 * V_280 , unsigned int V_281 ,
unsigned int V_282 )
{
T_1 V_283 ;
...
static int F_48 ( struct V_218 * V_219 , int V_297 , int V_298 ,
...
static int F_49 ( struct V_218 * V_318 , int V_319 )
{
...
break;
case V_330 :
if ( V_108 -> V_169 . V_331 == V_332 ) {
V_162 = F_52 ( F_17 ( V_110 -> V_333 ) ,
V_110 -> V_333 ) ;
if ( V_162 != 0 ) {
F_8 ( V_108 -> V_2 ,
L_30 ,
...
F_6 ( V_108 , V_13 ,
V_335 , 0 ) ;
F_53 ( V_110 -> V_334 , true ) ;
F_55 ( V_110 -> V_334 ) ;
F_56 ( F_17 ( V_110 -> V_333 ) ,
V_110 -> V_333 ) ;
F_57 ( V_110 -> V_324 ) ;
break;
}
V_108 -> V_169 . V_331 = V_322 ;
return 0 ;
}
...
if ( V_127 -> V_141 ) {
struct V_337 V_338 =
F_59 ( L_35 , V_110 -> V_346 ,
F_12 , F_10 ) ;
V_110 -> V_347 = F_62 ( sizeof( char * )
* V_127 -> V_141 , V_342 ) ;
if ( ! V_110 -> V_347 )
return;
...
static int F_66 ( struct V_350 * V_351 ,
const struct V_352 * V_353 )
{
struct V_109 * V_110 ;
unsigned int V_157 ;
int V_162 , V_129 ;
V_110 = F_67 ( & V_351 -> V_2 , sizeof( struct V_109 ) ,
V_342 ) ;
if ( V_110 == NULL )
return - V_354 ;
V_110 -> V_324 = F_68 ( & V_351 -> V_2 , L_39 ) ;
if ( F_69 ( V_110 -> V_324 ) ) {
V_162 = F_70 ( V_110 -> V_324 ) ;
F_8 ( & V_351 -> V_2 , L_40 ) ;
return V_162 ;
}
V_110 -> V_334 = F_71 ( V_351 , & V_355 ) ;
if ( F_69 ( V_110 -> V_334 ) ) {
V_162 = F_70 ( V_110 -> V_334 ) ;
F_8 ( & V_351 -> V_2 , L_41 ,
V_162 ) ;
return V_162 ;
}
...
V_358 = F_72 ( V_359 , V_351 -> V_2 . V_356 ) ;
if ( V_358 == NULL )
return - V_122 ;
V_110 -> V_201 = * ( (enum V_360 * ) V_358 -> V_361 ) ;
} else {
V_110 -> V_201 = V_353 -> V_362 ;
}
F_73 ( V_351 , V_110 ) ;
V_110 -> V_127 = V_351 -> V_2 . V_363 ;
for ( V_129 = 0 ; V_129 < F_17 ( V_110 -> V_333 ) ; V_129 ++ )
V_110 -> V_333 [ V_129 ] . V_364 = V_365 [ V_129 ] ;
V_162 = F_74 ( & V_351 -> V_2 , F_17 ( V_110 -> V_333 ) ,
V_110 -> V_333 ) ;
if ( V_162 != 0 ) {
...
V_162 = F_75 ( V_110 -> V_334 , V_4 , & V_157 ) ;
if ( V_162 < 0 ) {
...
V_162 = F_75 ( V_110 -> V_334 , V_5 , & V_157 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_351 -> V_2 , L_45 ,
V_162 ) ;
goto V_366;
}
F_76 ( & V_351 -> V_2 , L_46 , V_157 + 'A' ) ;
V_162 = F_77 ( V_110 -> V_334 , V_4 , 0 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_351 -> V_2 , L_47 , V_162 ) ;
goto V_366;
}
F_78 ( V_110 -> V_334 , V_35 ,
V_367 , V_367 ) ;
F_78 ( V_110 -> V_334 , V_36 ,
V_367 , V_367 ) ;
F_78 ( V_110 -> V_334 , V_31 ,
V_368 , V_368 ) ;
F_78 ( V_110 -> V_334 , V_32 ,
V_368 , V_368 ) ;
F_78 ( V_110 -> V_334 , V_47 ,
V_369 | V_370 ,
V_369 | V_370 ) ;
F_78 ( V_110 -> V_334 , V_48 ,
V_369 | V_371 ,
V_369 | V_371 ) ;
F_78 ( V_110 -> V_334 , V_49 ,
V_372 | V_373 ,
V_372 | V_373 ) ;
F_78 ( V_110 -> V_334 , V_50 ,
V_372 | V_374 ,
V_372 | V_374 ) ;
F_78 ( V_110 -> V_334 , V_24 ,
V_375 , 0 ) ;
if ( V_110 -> V_127 ) {
for ( V_129 = 0 ; V_129 < V_376 ; V_129 ++ ) {
if ( ! V_110 -> V_127 -> V_377 [ V_129 ] )
continue;
F_78 ( V_110 -> V_334 ,
V_70 + V_129 ,
0xffff ,
...
V_15 + V_129 ,
0xffff ,
V_110 -> V_127 -> V_379 [ V_129 ] ) ;
}
F_78 ( V_110 -> V_334 , V_59 ,
V_380 , V_380 ) ;
F_78 ( V_110 -> V_334 , V_13 ,
V_381 , 0 ) ;
F_53 ( V_110 -> V_334 , true ) ;
F_56 ( F_17 ( V_110 -> V_333 ) , V_110 -> V_333 ) ;
V_162 = F_79 ( & V_351 -> V_2 ,
& V_382 , & V_348 , 1 ) ;
if ( V_162 != 0 )
return V_162 ;
return 0 ;
...
static int F_80 ( struct V_350 * V_383 )
{
F_81 ( & V_383 -> V_2 ) ;
return 0 ;
}
