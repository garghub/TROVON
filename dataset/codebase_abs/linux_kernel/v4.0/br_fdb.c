...
int F_98 ( struct V_98 * V_99 , struct V_139 * V_140 [] ,
struct V_59 * V_27 ,
...
static int F_103 ( struct V_6 * V_7 , const T_5 * V_23 , T_4 V_142 )
{
...
int F_109 ( struct V_6 * V_7 , struct V_25 * V_26 ,
const unsigned char * V_23 , T_4 V_16 )
{
struct V_37 * V_20 ;
struct V_2 * V_11 ;
