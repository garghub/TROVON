...
static int F_23 ( struct V_55 * V_77 )
{
struct V_2 * V_78 = F_24 ( V_77 ) ;
struct V_1 * V_4 = F_12 ( V_78 ) ;
return F_25 ( V_77 , V_4 -> V_9 ,
V_4 -> V_24 ) ;
}
...
static int F_27 ( struct V_55 * V_77 )
{
return 0 ;
}
...
static void F_29 ( struct V_55 * V_77 )
{
}
static int F_30 ( struct V_55 * V_77 ,
unsigned char V_79 ,
T_3 * V_80 , T_1 V_44 ,
unsigned char V_81 ,
int V_82 )
...
V_85 -> V_92 = & V_93 ;
V_85 -> V_94 = V_95 ;
V_85 -> V_96 = V_4 -> V_20 . V_96 ;
V_85 -> V_97 = V_4 -> V_20 . V_97 ;
V_85 -> V_71 = V_4 -> V_20 . V_71 ;
V_4 -> V_55 = V_85 ;
sprintf ( V_85 -> V_98 , L_4 , L_5 ) ;
F_36 ( V_85 , V_3 ) ;
V_13 = F_37 ( V_85 ) ;
if ( V_13 )
goto V_89;
...
static int F_44 ( struct V_2 * V_78 )
{
struct V_1 * V_4 = F_12 ( V_78 ) ;
F_41 ( & V_78 -> V_3 , false ) ;
F_43 ( V_78 -> V_33 ) ;
