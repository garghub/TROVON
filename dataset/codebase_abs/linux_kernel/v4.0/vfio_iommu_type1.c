...
static void * F_86 ( unsigned long V_116 )
{
struct V_2 * V_3 ;
...
{
struct V_2 * V_3 = V_97 ;
struct V_59 * V_60 , * V_121 ;
struct V_99 * V_100 , * V_122 ;
F_81 ( V_3 ) ;
...
unsigned int V_123 , unsigned long V_116 )
{
struct V_2 * V_3 = V_97 ;
unsigned long V_124 ;
if ( V_123 == V_125 ) {
...
struct V_128 V_129 ;
V_124 = F_93 ( struct V_128 , V_130 ) ;
if ( F_94 ( & V_129 , ( void V_131 * ) V_116 , V_124 ) )
return - V_38 ;
if ( V_129 . V_132 < V_124 )
return - V_76 ;
V_129 . V_83 = 0 ;
V_129 . V_130 = F_50 ( V_3 ) ;
return F_95 ( ( void V_131 * ) V_116 , & V_129 , V_124 ) ;
} else if ( V_123 == V_133 ) {
struct V_81 V_82 ;
T_5 V_75 = V_85 |
V_84 ;
V_124 = F_93 ( struct V_81 , V_5 ) ;
if ( F_94 ( & V_82 , ( void V_131 * ) V_116 , V_124 ) )
return - V_38 ;
if ( V_82 . V_132 < V_124 || V_82 . V_83 & ~ V_75 )
return - V_76 ;
return F_60 ( V_3 , & V_82 ) ;
} else if ( V_123 == V_134 ) {
struct V_73 V_74 ;
long V_37 ;
V_124 = F_93 ( struct V_73 , V_5 ) ;
if ( F_94 ( & V_74 , ( void V_131 * ) V_116 , V_124 ) )
return - V_38 ;
if ( V_74 . V_132 < V_124 || V_74 . V_83 )
return - V_76 ;
V_37 = F_54 ( V_3 , & V_74 ) ;
if ( V_37 )
return V_37 ;
return F_95 ( ( void V_131 * ) V_116 , & V_74 , V_124 ) ;
}
return - V_135 ;
}
