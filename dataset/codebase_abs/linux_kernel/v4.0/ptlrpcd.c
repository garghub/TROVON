...
int F_62 ( int V_8 , int V_82 , const char * V_94 , struct V_6 * V_25 )
{
int V_43 ;
if ( F_63 ( V_95 , & V_25 -> V_70 ) ) {
F_64 ( L_5 ,
V_94 , V_25 ) ;
return 0 ;
}
...
F_65 ( & V_25 -> V_81 ) ;
F_66 ( & V_25 -> V_64 ) ;
F_67 ( V_25 -> V_53 , V_94 , sizeof( V_25 -> V_53 ) ) ;
V_25 -> V_29 = F_68 () ;
if ( V_25 -> V_29 == NULL ) {
V_43 = - V_91 ;
goto V_96;
...
V_100 = F_69 ( F_39 , V_25 , L_6 , V_25 -> V_53 ) ;
if ( F_70 ( V_100 ) ) {
V_43 = F_71 ( V_100 ) ;
goto V_101;
}
...
void F_75 ( struct V_6 * V_25 , int V_102 )
{
...
F_75 ( & V_12 -> V_20 [ V_28 ] , 0 ) ;
for ( V_28 = 0 ; V_28 < V_12 -> V_15 ; V_28 ++ )
F_76 ( & V_12 -> V_20 [ V_28 ] ) ;
F_75 ( & V_12 -> V_13 , 0 ) ;
F_76 ( & V_12 -> V_13 ) ;
F_77 ( V_12 , V_12 -> V_103 ) ;
V_12 = NULL ;
}
}
...
V_104 &= ~ 1 ;
V_105 = F_80 ( struct F_39 , V_20 [ V_104 ] ) ;
F_60 ( V_12 , V_105 ) ;
if ( V_12 == NULL ) {
V_43 = - V_91 ;
goto V_96;
...
V_43 = F_62 ( - 1 , V_104 , V_94 , & V_12 -> V_13 ) ;
if ( V_43 < 0 )
goto V_96;
for ( V_28 = 0 ; V_28 < V_104 ; V_28 ++ ) {
snprintf ( V_94 , sizeof( V_94 ) , L_9 , V_28 ) ;
V_43 = F_62 ( V_28 , V_104 , V_94 , & V_12 -> V_20 [ V_28 ] ) ;
if ( V_43 < 0 )
goto V_96;
}
V_12 -> V_103 = V_105 ;
...
F_75 ( & V_12 -> V_20 [ V_106 ] , 0 ) ;
for ( V_106 = 0 ; V_106 <= V_28 ; V_106 ++ )
F_76 ( & V_12 -> V_20 [ V_106 ] ) ;
F_75 ( & V_12 -> V_13 , 0 ) ;
F_76 ( & V_12 -> V_13 ) ;
F_77 ( V_12 , V_105 ) ;
V_12 = NULL ;
