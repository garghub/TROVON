...
F_165 ( V_3 , V_7 , F_15 ( V_7 ) , V_7 -> V_203 ) ;
if ( V_311 )
goto V_315;
return 0 ;
}
if ( V_7 -> V_203 < F_166 ( V_7 ) || F_167 ( V_7 ) )
goto V_316;
if ( V_3 -> V_18 == V_148 ) {
...
F_163 ( V_3 , V_7 ) ;
if ( F_170 ( V_3 , V_7 , F_15 ( V_7 ) , V_7 -> V_203 ) )
goto V_317;
if ( V_311 )
goto V_315;
return 0 ;
...
F_154 ( V_311 , V_3 ) ;
V_311 = F_171 ( & V_39 -> V_299 , V_311 ) ;
} else {
F_169 ( V_311 ) ;
V_311 = F_171 ( & V_39 -> V_299 , NULL ) ;
}
}
F_83 ( V_311 ) ;
return 0 ;
}
static void F_172 ( struct V_6 * V_7 , const struct V_113 * V_127 ,
const struct V_112 * V_129 )
{
...
F_114 ( V_7 ) -> V_323 = F_175 ( V_129 ) ;
F_114 ( V_7 ) -> V_221 = 0 ;
F_114 ( V_7 ) -> V_324 = F_176 ( V_127 ) ;
F_114 ( V_7 ) -> V_325 = 0 ;
}
static void F_177 ( struct V_6 * V_7 )
{
memmove ( F_173 ( V_7 ) , & F_114 ( V_7 ) -> V_222 . V_223 ,
sizeof( struct V_123 ) ) ;
}
...
goto V_328;
F_129 ( V_134 , V_329 ) ;
if ( ! F_179 ( V_7 , sizeof( struct V_112 ) ) )
goto V_328;
V_129 = F_15 ( V_7 ) ;
if ( V_129 -> V_211 < sizeof( struct V_112 ) / 4 )
goto V_330;
if ( ! F_179 ( V_7 , V_129 -> V_211 * 4 ) )
goto V_328;
if ( F_180 ( V_7 , V_94 , V_331 ) )
goto V_332;
V_129 = F_15 ( V_7 ) ;
V_127 = F_14 ( V_7 ) ;
V_3 = F_181 ( & V_136 , V_7 , V_129 -> V_28 , V_129 -> V_27 ,
F_67 ( V_7 ) ) ;
if ( ! V_3 )
goto V_333;
V_334:
...
if ( ! F_182 ( V_3 , V_337 , V_7 ) )
goto V_336;
F_172 ( V_7 , V_127 , V_129 ) ;
#ifdef F_26
if ( F_109 ( V_3 , V_7 ) )
goto V_336;
#endif
...
return V_219 ? - 1 : 0 ;
V_333:
if ( ! F_182 ( NULL , V_337 , V_7 ) )
goto V_328;
F_172 ( V_7 , V_127 , V_129 ) ;
if ( V_7 -> V_203 < ( V_129 -> V_211 << 2 ) || F_167 ( V_7 ) ) {
V_332:
F_129 ( V_134 , V_318 ) ;
V_330:
F_129 ( V_134 , V_319 ) ;
...
switch ( F_188 ( F_54 ( V_3 ) , V_7 , V_129 ) ) {
case V_341 :
{
struct V_2 * V_342 ;
...
if ( V_7 -> V_326 != V_327 )
return;
if ( ! F_179 ( V_7 , F_191 ( V_7 ) + sizeof( struct V_112 ) ) )
return;
V_127 = F_14 ( V_7 ) ;
V_129 = F_15 ( V_7 ) ;
if ( V_129 -> V_211 < sizeof( struct V_112 ) / 4 )
...
V_7 -> V_346 = V_347 ;
if ( V_3 -> V_18 != V_139 ) {
struct V_8 * V_9 = F_192 ( V_3 -> V_12 ) ;
if ( V_9 )
V_9 = F_193 ( V_9 , F_6 ( V_3 ) -> V_16 ) ;
if ( V_9 &&
F_5 ( V_3 ) -> V_13 == V_7 -> V_14 )
F_194 ( V_7 , V_9 ) ;
}
...
static void F_200 ( struct V_348 * V_132 ,
...
F_202 ( V_351 ) ,
V_157 -> V_357 ,
F_203 ( F_204 ( V_132 ) , V_350 ) ,
0 ,
0 ,
0 , V_157 ) ;
}
static void F_205 ( struct V_348 * V_132 , struct V_2 * V_358 , int V_349 )
{
...
F_207 ( V_362 - V_353 ) ,
V_37 -> V_373 ,
F_203 ( F_204 ( V_132 ) , F_208 ( V_358 ) ) ,
V_37 -> V_374 ,
F_209 ( V_358 ) ,
F_210 ( & V_358 -> V_375 ) , V_358 ,
F_202 ( V_37 -> V_376 ) ,
F_202 ( V_37 -> V_377 . V_378 ) ,
( V_37 -> V_377 . V_379 << 1 ) | V_37 -> V_377 . V_380 ,
V_41 -> V_381 ,
V_358 -> V_18 == V_148 ?
( V_364 ? V_364 -> V_382 : 0 ) :
( F_211 ( V_41 ) ? - 1 : V_41 -> V_383 )
) ;
}
static void F_212 ( struct V_348 * V_132 ,
struct V_267 * V_268 , int V_349 )
{
const struct V_4 * V_27 , * V_354 ;
T_9 V_359 , V_360 ;
T_10 V_384 = V_268 -> V_385 - F_213 () ;
V_27 = & V_268 -> V_386 ;
V_354 = & V_268 -> V_387 ;
...
V_27 -> V_25 [ 2 ] , V_27 -> V_25 [ 3 ] , V_359 ,
V_268 -> V_390 , 0 , 0 ,
3 , F_207 ( V_384 ) , 0 , 0 , 0 , 0 ,
F_210 ( & V_268 -> V_391 ) , V_268 ) ;
}
static int F_214 ( struct V_348 * V_132 , void * V_392 )
{
struct V_393 * V_394 ;
...
case V_399 :
if ( V_3 -> V_18 == V_139 )
F_212 ( V_132 , V_392 , V_394 -> V_400 ) ;
else
F_205 ( V_132 , V_392 , V_394 -> V_400 ) ;
break;
case V_401 :
F_200 ( V_132 , V_394 -> V_402 , V_392 , V_394 -> V_400 , V_394 -> V_350 ) ;
break;
}
V_142:
return 0 ;
}
int T_11 F_216 ( struct V_134 * V_134 )
{
return F_217 ( V_134 , & V_403 ) ;
}
void F_218 ( struct V_134 * V_134 )
{
F_219 ( V_134 , & V_403 ) ;
}
static void F_220 ( struct V_2 * V_3 , int V_404 )
{
struct V_34 * V_35 = F_5 ( V_3 ) ;
F_221 ( V_3 , F_222 ( struct V_34 , V_294 ) ) ;
V_404 -= F_222 ( struct V_34 , V_294 ) + sizeof( V_35 -> V_294 ) ;
memset ( & V_35 -> V_294 + 1 , 0 , V_404 ) ;
}
static int T_11 F_223 ( struct V_134 * V_134 )
{
return F_224 ( & V_134 -> V_242 . F_17 , V_405 ,
V_406 , V_94 , V_134 ) ;
}
static void T_12 F_225 ( struct V_134 * V_134 )
{
F_226 ( V_134 -> V_242 . F_17 ) ;
}
static void T_12 F_227 ( struct V_407 * V_408 )
{
F_228 ( & V_136 , & V_105 , V_51 ) ;
}
int T_13 F_229 ( void )
{
int V_219 ;
V_219 = F_230 ( & V_409 , V_94 ) ;
if ( V_219 )
goto V_142;
V_219 = F_231 ( & V_410 ) ;
if ( V_219 )
