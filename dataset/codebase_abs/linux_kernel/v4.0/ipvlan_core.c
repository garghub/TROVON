...
struct V_106 V_107 = {
. V_108 = V_78 -> V_109 ,
. V_110 = F_52 ( V_47 -> V_111 ) ,
. V_112 = V_113 ,
. V_91 = V_47 -> V_91 ,
. V_54 = V_47 -> V_54 ,
} ;
V_103 = F_53 ( F_54 ( V_78 ) , & V_107 , NULL ) ;
if ( F_55 ( V_103 ) )
goto V_104;
...
V_117 = F_63 ( F_54 ( V_78 ) , NULL , & V_123 ) ;
if ( V_117 -> error ) {
V_65 = V_117 -> error ;
F_64 ( V_117 ) ;
goto V_104;
...
if ( F_69 ( V_37 ) ) {
F_70 ( V_37 , sizeof( * V_131 ) ) ;
V_37 -> V_132 = ( F_71 ( V_37 -> V_132 ) ) ~ 0U ;
F_72 ( V_37 ) ;
}
...
static int F_73 ( struct V_36 * V_37 , struct V_81 * V_78 )
{
const struct V_2 * V_3 = F_74 ( V_78 ) ;
void * V_38 ;
struct V_22 * V_26 ;
int V_88 ;
V_38 = F_26 ( V_37 , & V_88 ) ;
...
V_85:
V_37 -> V_78 = V_3 -> V_73 ;
return F_66 ( V_37 , V_3 ) ;
}
static int F_75 ( struct V_36 * V_37 , struct V_81 * V_78 )
{
const struct V_2 * V_3 = F_74 ( V_78 ) ;
struct V_61 * V_62 = F_38 ( V_37 ) ;
struct V_22 * V_26 ;
...
int F_77 ( struct V_36 * V_37 , struct V_81 * V_78 )
{
struct V_2 * V_3 = F_74 ( V_78 ) ;
struct V_23 * V_24 = F_78 ( V_3 -> V_73 ) ;
if ( ! V_24 )
goto V_85;
...
switch( V_24 -> V_136 ) {
case V_137 :
return F_75 ( V_37 , V_78 ) ;
case V_138 :
return F_73 ( V_37 , V_78 ) ;
}
F_79 ( true , L_3 ,
V_24 -> V_136 ) ;
V_85:
...
static bool F_80 ( struct V_36 * V_37 , struct V_23 * V_24 )
{
struct V_61 * V_62 = F_38 ( V_37 ) ;
struct V_22 * V_26 ;
void * V_38 ;
int V_88 ;
if ( F_43 ( V_62 -> V_133 , V_37 -> V_78 -> V_139 ) ) {
V_38 = F_26 ( V_37 , & V_88 ) ;
if ( ! V_38 )
return true ;
...
static T_3 F_81 ( struct V_36 * * V_140 ,
struct V_23 * V_24 )
{
void * V_38 ;
int V_88 ;
...
static T_3 F_82 ( struct V_36 * * V_140 ,
struct V_23 * V_24 )
{
struct V_36 * V_37 = * V_140 ;
struct V_61 * V_62 = F_38 ( V_37 ) ;
...
T_3 F_83 ( struct V_36 * * V_140 )
{
struct V_36 * V_37 = * V_140 ;
struct V_23 * V_24 = F_78 ( V_37 -> V_78 ) ;
if ( ! V_24 )
return V_141 ;
switch ( V_24 -> V_136 ) {
case V_137 :
return F_82 ( V_140 , V_24 ) ;
case V_138 :
return F_81 ( V_140 , V_24 ) ;
}
F_79 ( true , L_4 ,
V_24 -> V_136 ) ;
F_48 ( V_37 ) ;
