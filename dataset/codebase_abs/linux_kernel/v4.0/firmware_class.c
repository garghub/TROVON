...
V_103 = F_95 ( V_107 , & V_113 ) ;
if ( V_103 ) {
F_74 ( V_107 , L_15 , V_23 ) ;
goto V_114;
}
F_38 ( & V_45 ) ;
F_17 ( & V_17 -> V_22 , & V_64 ) ;
F_41 ( & V_45 ) ;
V_103 = F_96 ( V_107 , & V_115 ) ;
if ( V_103 ) {
F_38 ( & V_45 ) ;
F_55 ( & V_17 -> V_22 ) ;
F_41 ( & V_45 ) ;
F_74 ( V_107 , L_16 , V_23 ) ;
goto V_116;
}
if ( V_106 & V_117 ) {
V_17 -> V_118 = true ;
F_93 ( V_107 , false ) ;
F_37 ( V_107 , L_17 , V_17 -> V_20 ) ;
F_97 ( & V_59 -> V_50 . V_84 , V_119 ) ;
} else {
V_111 = V_12 ;
}
V_103 = F_98 ( & V_17 -> V_21 ,
V_111 ) ;
if ( V_103 == - V_120 || ! V_103 ) {
F_38 ( & V_45 ) ;
F_56 ( V_59 ) ;
F_41 ( & V_45 ) ;
}
...
static int
F_110 ( struct V_1 * * V_124 , const char * V_3 ,
struct V_38 * V_38 )
{
struct V_1 * V_1 ;
struct V_13 * V_17 ;
int V_123 ;
* V_124 = V_1 = F_5 ( sizeof( * V_1 ) , V_56 ) ;
if ( ! V_1 ) {
F_74 ( V_38 , L_18 ,
V_23 ) ;
return - V_29 ;
...
F_38 ( & V_45 ) ;
if ( ! V_17 -> V_8 || F_99 ( V_17 ) ) {
F_41 ( & V_45 ) ;
return - V_40 ;
}
if ( V_38 && ( V_106 & V_117 ) )
F_48 ( V_38 , V_17 -> V_20 ) ;
if ( V_17 -> V_16 -> V_125 == V_126 ) {
if ( F_112 ( V_17 -> V_20 ) )
F_15 ( & V_17 -> V_19 ) ;
}
F_43 ( V_17 , V_2 ) ;
...
static int
F_113 ( const struct V_1 * * V_124 , const char * V_3 ,
struct V_38 * V_38 , unsigned int V_106 )
{
struct V_1 * V_2 ;
long V_111 ;
...
if ( V_106 & V_129 ) {
F_35 ( V_38 , L_23 ) ;
V_123 = F_104 ( V_2 , V_3 , V_38 ,
V_106 , V_111 ) ;
}
}
if ( ! V_123 )
V_123 = F_111 ( V_2 , V_38 , V_106 ) ;
F_117 () ;
V_80:
if ( V_123 < 0 ) {
F_118 ( V_2 ) ;
...
int
F_119 ( const struct V_1 * * V_124 , const char * V_3 ,
struct V_38 * V_38 )
{
int V_123 ;
F_120 ( V_130 ) ;
V_123 = F_113 ( V_124 , V_3 , V_38 ,
V_117 | V_131 ) ;
F_121 ( V_130 ) ;
return V_123 ;
}
int F_122 ( const struct V_1 * * V_124 ,
const char * V_3 , struct V_38 * V_38 )
{
int V_123 ;
F_120 ( V_130 ) ;
...
V_135 = F_52 ( V_133 , struct V_134 , V_133 ) ;
F_113 ( & V_2 , V_135 -> V_3 , V_135 -> V_38 ,
V_135 -> V_106 ) ;
V_135 -> V_136 ( V_2 , V_135 -> V_137 ) ;
F_103 ( V_135 -> V_38 ) ;
F_121 ( V_135 -> V_138 ) ;
F_64 ( V_135 ) ;
}
int
F_124 (
struct V_138 * V_138 , bool V_139 ,
const char * V_3 , struct V_38 * V_38 , T_4 V_140 , void * V_137 ,
void (* V_136)( const struct V_1 * V_2 , void * V_137 ) )
{
struct V_134 * V_135 ;
V_135 = F_5 ( sizeof ( struct V_134 ) , V_140 ) ;
if ( ! V_135 )
return - V_29 ;
V_135 -> V_138 = V_138 ;
V_135 -> V_3 = V_3 ;
...
static struct V_142 * F_132 ( const char * V_3 )
{
struct V_142 * V_143 ;
V_143 = F_5 ( sizeof( * V_143 ) + strlen ( V_3 ) + 1 , V_18 ) ;
if ( ! V_143 )
goto exit;
strcpy ( V_143 -> V_3 , V_3 ) ;
exit:
return V_143 ;
}
...
static void F_135 ( void * V_147 ,
T_5 V_148 )
{
struct V_142 * V_143 = V_147 ;
struct V_15 * V_16 = & V_25 ;
int V_123 ;
V_123 = F_129 ( V_143 -> V_3 ) ;
if ( V_123 ) {
F_14 ( & V_16 -> V_144 ) ;
F_136 ( & V_143 -> V_27 ) ;
F_16 ( & V_16 -> V_144 ) ;
...
static void F_137 ( struct V_38 * V_50 , void * V_51 ,
void * V_9 )
{
struct V_52 * V_53 = V_51 ;
const char * V_14 = V_53 -> V_3 ;
struct V_149 * V_28 = V_9 ;
struct V_142 * V_143 ;
V_143 = F_132 ( V_14 ) ;
if ( V_143 )
F_17 ( & V_143 -> V_27 , V_28 ) ;
}
static int F_138 ( struct V_38 * V_50 , void * V_51 ,
void * V_55 )
{
struct V_52 * V_53 = V_51 ;
return ( V_53 -> V_54 == ( unsigned long ) V_55 ) ;
}
static void F_139 ( struct V_38 * V_50 , void * V_9 )
{
F_140 ( V_150 ) ;
struct V_142 * V_143 ;
struct V_142 * V_151 ;
...
struct V_142 * V_143 ;
F_14 ( & V_16 -> V_144 ) ;
while ( ! F_58 ( & V_16 -> V_146 ) ) {
V_143 = F_144 ( V_16 -> V_146 . V_122 ,
struct V_142 , V_27 ) ;
F_136 ( & V_143 -> V_27 ) ;
F_16 ( & V_16 -> V_144 ) ;
F_131 ( V_143 -> V_3 ) ;
...
static void F_151 ( struct V_132 * V_133 )
{
F_150 () ;
}
static void F_152 ( unsigned long V_155 )
{
F_153 ( V_156 , & V_25 . V_133 ,
F_154 ( V_155 ) ) ;
}
static int F_155 ( struct V_60 * V_157 ,
