...
static void F_28 ( struct V_15 * V_40 ,
struct V_12 * V_13 )
{
F_29 ( & V_40 -> V_11 , & V_13 -> V_41 ) ;
}
static void F_30 ( struct V_10 * V_42 )
{
struct V_10 * V_43 , * V_44 ;
F_31 (list_ptr, tmp, head) {
struct V_15 * V_16 =
...
static void F_23 ( struct V_10 * V_42 )
{
struct V_12 * V_16 ;
...
static struct V_15 * F_33 ( struct V_12 * V_45 ,
const char * V_17 )
{
struct V_10 * V_11 ;
...
static struct V_12 * F_34 ( struct V_26 * V_27 ,
const char * V_46 )
{
...
char * V_18 )
{
struct V_12 * V_13 = F_34 ( V_27 , V_46 ) ;
...
return - V_30 ;
F_16 ( & V_52 -> V_11 ) ;
F_37 ( V_52 -> V_17 , V_17 , sizeof( V_52 -> V_17 ) ) ;
if ( type == V_54 ) {
snprintf ( V_52 -> V_18 , V_49 ,
L_5 , ( * ( ( long * ) V_18 ) ) ) ;
} else if ( type == V_55 ) {
F_37 ( V_52 -> V_18 , ( char * ) V_18 , sizeof( V_52 -> V_18 ) ) ;
} else if ( type == V_56 ) {
snprintf ( V_52 -> V_18 , V_49 ,
...
int F_38 ( struct V_26 * V_27 , const char * V_14 )
{
struct V_4 * V_32 = V_27 -> V_32 ;
struct V_12 * V_13 = F_34 ( V_27 , V_14 ) ;
if ( V_13 )
return 0 ;
V_13 = F_15 ( sizeof( * V_13 ) , V_29 ) ;
if ( ! V_13 )
return - V_30 ;
F_37 ( V_13 -> V_14 , V_14 , sizeof( V_13 -> V_14 ) ) ;
F_16 ( & V_13 -> V_41 ) ;
F_22 ( & V_32 -> V_31 ) ;
F_29 ( & V_13 -> V_11 , & V_32 -> V_8 ) ;
F_24 ( & V_32 -> V_31 ) ;
return 0 ;
}
