...
static struct V_48 * F_11 ( struct V_1 * V_2 )
{
struct V_48 * V_49 ;
F_12 ( & V_2 -> V_50 ) ;
if ( F_13 ( & V_2 -> V_51 ) )
return NULL ;
F_14 (arvif, &ar->arvifs, list)
if ( V_49 -> V_52 )
return V_49 ;
return F_15 ( & V_2 -> V_51 , F_16 ( * V_49 ) , V_53 ) ;
}
...
V_65 = F_21 ( T_5 , 1 , V_2 -> V_5 . V_69 . V_65 ) ;
V_64 . V_55 = V_55 ;
V_64 . V_70 = V_65 ;
V_64 . V_71 = V_72 ;
V_64 . V_73 = V_74 ;
...
static T_8 F_23 ( struct V_105 * V_105 , char T_9 * V_106 ,
T_4 V_65 , T_10 * V_107 )
{
...
V_109 = strlen ( V_57 ) ;
return F_26 ( V_106 , V_65 , V_107 , V_57 , V_109 ) ;
}
static T_8 F_27 ( struct V_105 * V_105 ,
...
T_8 V_109 ;
int V_54 ;
V_109 = F_28 ( V_65 , sizeof( V_20 ) - 1 ) ;
if ( F_29 ( V_20 , V_106 , V_109 ) )
return - V_112 ;
V_20 [ V_109 ] = '\0' ;
F_24 ( & V_2 -> V_50 ) ;
...
return F_26 ( V_106 , V_65 , V_107 , V_20 , V_109 ) ;
}
static T_8 F_31 ( struct V_105 * V_105 ,
const char T_9 * V_106 ,
T_4 V_65 , T_10 * V_107 )
{
struct V_1 * V_2 = V_105 -> V_108 ;
...
static T_8 F_34 ( struct V_105 * V_105 ,
const char T_9 * V_106 ,
T_4 V_65 , T_10 * V_107 )
{
struct V_1 * V_2 = V_105 -> V_108 ;
...
return - V_31 ;
F_24 ( & V_2 -> V_50 ) ;
V_2 -> V_5 . V_69 . V_76 = F_36 ( V_114 ) ;
V_2 -> V_5 . V_69 . V_76 += V_100 ;
F_25 ( & V_2 -> V_50 ) ;
return V_65 ;
}
static struct V_116 * F_37 ( const char * V_117 ,
struct V_116 * V_118 ,
T_11 V_57 ,
struct V_119 * V_20 ,
int * V_120 )
{
struct V_116 * V_121 ;
V_121 = F_38 ( V_117 , V_57 , V_118 , V_20 ,
& V_122 ) ;
* V_120 = 1 ;
return V_121 ;
}
static int F_39 ( struct V_116 * V_116 )
{
F_40 ( V_116 ) ;
return 0 ;
}
...
int F_42 ( struct V_48 * V_49 )
{
if ( ! V_49 -> V_52 )
return 0 ;
return F_19 ( V_49 -> V_2 , V_58 ) ;
}
