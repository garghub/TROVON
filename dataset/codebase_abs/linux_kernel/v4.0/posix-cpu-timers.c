...
static int F_37 ( const T_2 V_8 , struct V_14 * V_15 )
{
const T_3 V_10 = F_7 ( V_8 ) ;
int V_49 = - V_12 ;
if ( V_10 == 0 ) {
...
static int F_38 ( struct V_23 * V_51 )
{
int V_16 = 0 ;
...
V_5 = F_43 ( V_9 , & V_46 ) ;
if ( F_44 ( V_5 == NULL ) ) {
F_42 ( ! F_45 ( & V_24 -> V_29 . V_30 . V_53 ) ) ;
} else {
if ( V_24 -> V_29 . V_30 . V_56 )
V_16 = V_57 ;
else
F_46 ( & V_24 -> V_29 . V_30 . V_53 ) ;
F_47 ( V_9 , & V_46 ) ;
}
if ( ! V_16 )
F_48 ( V_9 ) ;
...
static int F_72 ( struct V_23 * V_24 , int V_80 ,
...
if ( F_44 ( V_24 -> V_29 . V_30 . V_56 ) ) {
V_24 -> V_29 . V_30 . V_56 = - 1 ;
V_16 = V_57 ;
} else
F_51 ( & V_24 -> V_29 . V_30 . V_53 ) ;
if ( F_11 ( V_24 -> V_52 ) ) {
F_27 ( V_24 -> V_52 , V_9 , & V_87 ) ;
} else {
F_65 ( V_24 -> V_52 , V_9 , & V_87 ) ;
}
if ( V_83 ) {
if ( V_84 == 0 ) {
V_83 -> V_88 . V_18 = 0 ;
...
static void F_74 ( struct V_23 * V_24 , struct V_81 * V_95 )
{
unsigned long long V_25 ;
struct V_1 * V_9 = V_24 -> V_29 . V_30 . V_2 ;
F_42 ( V_9 == NULL ) ;
...
while ( ! F_45 ( V_96 ) ) {
struct V_60 * V_99 ;
V_99 = F_76 ( V_96 , struct V_60 , V_53 ) ;
...
static void F_78 ( struct V_1 * V_42 ,
struct V_58 * V_56 )
{
...
unsigned long long V_21 ;
unsigned long V_103 ;
V_21 = F_75 ( V_96 , V_56 , F_23 ( V_42 ) ) ;
V_102 -> V_68 = F_60 ( V_21 ) ;
V_21 = F_75 ( ++ V_96 , V_56 , F_24 ( V_42 ) ) ;
V_102 -> V_69 = F_60 ( V_21 ) ;
V_102 -> V_70 = F_75 ( ++ V_96 , V_56 ,
V_42 -> V_62 . V_35 ) ;
V_103 = F_79 ( V_101 -> V_104 [ V_105 ] . V_106 ) ;
if ( V_103 != V_107 ) {
unsigned long V_108 =
F_79 ( V_101 -> V_104 [ V_105 ] . V_109 ) ;
if ( V_108 != V_107 &&
V_42 -> V_110 . V_111 > F_80 ( V_108 , V_112 / V_36 ) ) {
F_81 ( V_113 , V_114 , V_42 ) ;
return;
}
if ( V_42 -> V_110 . V_111 > F_80 ( V_103 , V_112 / V_36 ) ) {
if ( V_103 < V_108 ) {
V_103 += V_112 ;
...
F_82 ( V_115
L_1 ,
V_42 -> V_116 , F_83 ( V_42 ) ) ;
F_81 ( V_117 , V_114 , V_42 ) ;
}
}
}
static void F_84 ( struct V_100 * V_101 )
{
...
static void F_85 ( struct V_1 * V_42 , struct V_118 * V_29 ,
unsigned long long * V_21 ,
...
F_81 ( V_120 , V_114 , V_42 ) ;
}
if ( V_29 -> V_21 && ( ! * V_21 || V_29 -> V_21 < * V_21 ) ) {
* V_21 = V_29 -> V_21 ;
}
}
static void F_87 ( struct V_1 * V_42 ,
struct V_58 * V_56 )
{
struct V_100 * const V_101 = V_42 -> signal ;
...
V_131 = V_4 . V_35 ;
V_130 = F_75 ( V_96 , V_56 , V_128 ) ;
V_129 = F_75 ( ++ V_96 , V_56 , V_33 ) ;
V_132 = F_75 ( ++ V_96 , V_56 , V_131 ) ;
F_85 ( V_42 , & V_101 -> V_29 [ V_7 ] , & V_130 , V_128 ,
V_124 ) ;
F_85 ( V_42 , & V_101 -> V_29 [ V_39 ] , & V_129 , V_33 ,
V_133 ) ;
V_103 = F_79 ( V_101 -> V_104 [ V_134 ] . V_106 ) ;
if ( V_103 != V_107 ) {
unsigned long V_135 = F_88 ( V_128 ) ;
unsigned long V_108 =
F_79 ( V_101 -> V_104 [ V_134 ] . V_109 ) ;
T_1 V_136 ;
if ( V_135 >= V_108 ) {
F_81 ( V_113 , V_114 , V_42 ) ;
return;
...
V_24 -> V_29 . V_30 . V_21 = 0 ;
goto V_90;
} else if ( F_44 ( V_9 -> V_137 ) && F_89 ( V_9 ) ) {
F_47 ( V_9 , & V_46 ) ;
goto V_90;
}
F_65 ( V_24 -> V_52 , V_9 , & V_25 ) ;
...
static inline int F_91 ( struct V_1 * V_42 )
{
struct V_100 * V_101 ;
T_1 V_33 , V_34 ;
V_32 ( V_42 , & V_33 , & V_34 ) ;
...
if ( F_90 ( & V_138 , & V_42 -> V_66 ) )
return 1 ;
}
V_101 = V_42 -> signal ;
if ( V_101 -> V_44 . V_47 ) {
struct V_32 V_139 ;
F_92 ( & V_101 -> V_44 . V_48 ) ;
V_139 = V_101 -> V_44 . V_4 ;
F_93 ( & V_101 -> V_44 . V_48 ) ;
if ( F_90 ( & V_139 , & V_101 -> V_66 ) )
return 1 ;
}
return 0 ;
}
void F_94 ( struct V_1 * V_42 )
{
F_95 ( V_56 ) ;
...
static int F_99 ( const T_2 V_8 , int V_46 ,
...
V_29 -> V_88 = * V_145 ;
F_3 ( & V_24 . V_141 ) ;
error = F_72 ( & V_24 , V_46 , V_29 , NULL ) ;
if ( error ) {
F_5 ( & V_24 . V_141 ) ;
return error ;
}
...
static int F_104 ( const T_2 V_8 , int V_46 ,
struct V_14 * V_145 , struct V_14 T_4 * V_149 )
{
struct V_150 * V_150 = & V_13 -> V_150 ;
struct V_81 V_29 ;
int error ;
if ( F_11 ( V_8 ) &&
( F_7 ( V_8 ) == 0 ||
F_7 ( V_8 ) == V_13 -> V_10 ) )
return - V_12 ;
error = F_99 ( V_8 , V_46 , V_145 , & V_29 ) ;
if ( error == - V_148 ) {
if ( V_46 & V_91 )
return - V_151 ;
if ( V_149 && F_105 ( V_149 , & V_29 . V_88 , sizeof *V_149 ) )
return - V_152 ;
V_150 -> V_153 = V_154 ;
V_150 -> V_155 . V_156 = V_8 ;
V_150 -> V_155 . V_149 = V_149 ;
V_150 -> V_155 . V_21 = F_106 ( V_145 ) ;
}
return error ;
}
...
error = F_99 ( V_8 , V_91 , & V_99 , & V_29 ) ;
if ( error == - V_148 ) {
struct V_14 T_4 * V_149 = V_150 -> V_155 . V_149 ;
if ( V_149 && F_105 ( V_149 , & V_29 . V_88 , sizeof *V_149 ) )
return - V_152 ;
V_150 -> V_155 . V_21 = F_106 ( & V_99 ) ;
}
return error ;
}
...
static int F_110 ( const T_2 V_8 , int V_46 ,
struct V_14 * V_145 ,
struct V_14 T_4 * V_149 )
{
return F_104 ( V_157 , V_46 , V_145 , V_149 ) ;
}
static long F_111 ( struct V_150 * V_150 )
{
return - V_12 ;
}
