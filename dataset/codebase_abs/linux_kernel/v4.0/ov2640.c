...
struct V_1 * V_42 ;
struct V_40 * V_41 = F_18 ( V_3 ) ;
struct V_115 * V_116 = F_37 ( V_3 -> V_10 . V_117 ) ;
int V_7 ;
if ( ! V_41 ) {
F_23 ( & V_116 -> V_10 ,
L_15 ) ;
...
V_42 = F_39 ( & V_3 -> V_10 , sizeof( struct V_1 ) , V_120 ) ;
if ( ! V_42 ) {
F_23 ( & V_116 -> V_10 ,
L_17 ) ;
return - V_121 ;
}
F_40 ( & V_42 -> V_4 , V_3 , & V_122 ) ;
F_41 ( & V_42 -> V_29 , 2 ) ;
F_42 ( & V_42 -> V_29 , & V_123 ,
V_31 , 0 , 1 , 1 , 0 ) ;
F_42 ( & V_42 -> V_29 , & V_123 ,
V_34 , 0 , 1 , 1 , 0 ) ;
V_42 -> V_4 . V_124 = & V_42 -> V_29 ;
if ( V_42 -> V_29 . error )
