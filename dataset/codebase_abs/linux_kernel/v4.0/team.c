...
static int F_226 ( struct V_2 * V_3 , bool V_213 )
{
struct V_14 * V_14 = F_180 ( V_3 ) ;
V_14 -> V_71 = true ;
if ( V_213 )
...
struct V_214 * V_215 )
{
F_229 ( V_215 -> V_216 , V_217 , sizeof( V_215 -> V_216 ) ) ;
F_229 ( V_215 -> V_218 , V_219 , sizeof( V_215 -> V_218 ) ) ;
}
...
V_3 -> V_11 = V_6 -> V_11 ;
V_3 -> V_152 = V_6 -> V_152 ;
memcpy ( V_3 -> V_221 , V_6 -> V_221 , V_6 -> V_11 ) ;
F_231 ( V_3 , V_6 ) ;
}
...
V_3 -> V_229 = 0 ;
V_3 -> V_145 |= V_230 ;
V_3 -> V_134 &= ~ ( V_132 | V_231 ) ;
V_3 -> V_134 |= V_232 | V_233 ;
V_3 -> V_147 |= V_234 ;
V_3 -> V_147 |= V_235 ;
V_3 -> V_147 |= V_236 ;
V_3 -> V_237 = V_127 |
...
V_239 |
V_240 ;
V_3 -> V_237 &= ~ ( V_241 & ~ V_242 ) ;
V_3 -> V_147 |= V_3 -> V_237 ;
}
static int F_237 ( struct V_243 * V_244 , struct V_2 * V_3 ,
struct V_245 * V_246 [] , struct V_245 * V_163 [] )
{
if ( V_246 [ V_247 ] == NULL )
F_238 ( V_3 ) ;
return F_239 ( V_3 ) ;
}
static int F_240 ( struct V_245 * V_246 [] , struct V_245 * V_163 [] )
{
if ( V_246 [ V_247 ] ) {
if ( F_241 ( V_246 [ V_247 ] ) != V_248 )
return - V_62 ;
if ( ! F_207 ( F_242 ( V_246 [ V_247 ] ) ) )
return - V_197 ;
}
return 0 ;
}
...
static int F_245 ( struct V_67 * V_68 , struct V_251 * V_32 )
{
struct V_67 * V_252 ;
void * V_253 ;
int V_29 ;
V_252 = F_246 ( V_254 , V_30 ) ;
if ( ! V_252 )
return - V_31 ;
V_253 = F_247 ( V_252 , V_32 -> V_255 , V_32 -> V_256 ,
& V_257 , 0 , V_258 ) ;
if ( ! V_253 ) {
V_29 = - V_259 ;
goto V_260;
...
F_248 ( V_252 , V_253 ) ;
return F_249 ( F_250 ( V_32 ) , V_252 , V_32 -> V_255 ) ;
V_260:
F_251 ( V_252 ) ;
return V_29 ;
}
static struct V_14 * F_252 ( struct V_251 * V_32 )
{
struct V_243 * V_243 = F_250 ( V_32 ) ;
int V_261 ;
struct V_2 * V_3 ;
struct V_14 * V_14 ;
if ( ! V_32 -> V_262 [ V_263 ] )
return NULL ;
V_261 = F_253 ( V_32 -> V_262 [ V_263 ] ) ;
V_3 = F_254 ( V_243 , V_261 ) ;
if ( ! V_3 || V_3 -> V_224 != & V_225 ) {
if ( V_3 )
F_125 ( V_3 ) ;
return NULL ;
}
...
static int F_256 ( struct V_67 * V_68 , struct V_14 * V_14 , T_4 V_264 )
{
return F_249 ( F_257 ( V_14 -> V_3 ) , V_68 , V_264 ) ;
}
...
if ( V_29 )
return V_29 ;
V_265 = F_259 ( V_68 , V_266 ) ;
if ( ! V_265 )
return - V_259 ;
if ( F_260 ( V_68 , V_267 , V_21 -> V_22 ) )
goto V_268;
if ( V_54 -> V_5 &&
F_261 ( V_68 , V_269 ,
V_54 -> V_5 -> V_3 -> V_261 ) )
...
switch ( V_21 -> type ) {
case V_271 :
if ( F_262 ( V_68 , V_272 , V_273 ) )
goto V_268;
if ( F_261 ( V_68 , V_274 , V_49 . V_163 . V_165 ) )
goto V_268;
break;
case V_275 :
if ( F_262 ( V_68 , V_272 , V_276 ) )
goto V_268;
if ( F_260 ( V_68 , V_274 ,
V_49 . V_163 . V_164 ) )
goto V_268;
break;
case V_277 :
if ( F_262 ( V_68 , V_272 , V_278 ) )
goto V_268;
if ( F_263 ( V_68 , V_274 , V_49 . V_163 . V_279 . V_102 ,
V_49 . V_163 . V_279 . V_280 ) )
goto V_268;
break;
case V_281 :
if ( F_262 ( V_68 , V_272 , V_282 ) )
goto V_268;
if ( V_49 . V_163 . V_166 &&
F_264 ( V_68 , V_274 ) )
goto V_268;
break;
case V_283 :
if ( F_262 ( V_68 , V_272 , V_284 ) )
goto V_268;
if ( F_265 ( V_68 , V_274 , V_49 . V_163 . V_167 ) )
goto V_268;
break;
default:
F_266 () ;
}
if ( V_24 -> V_35 && F_264 ( V_68 , V_285 ) )
goto V_268;
if ( V_24 -> V_34 ) {
if ( F_264 ( V_68 , V_286 ) )
goto V_268;
...
struct V_14 * V_14 , T_4 V_264 ,
T_11 * V_287 )
{
int V_29 ;
if ( * V_92 ) {
V_29 = V_287 ( * V_92 , V_14 , V_264 ) ;
if ( V_29 )
return V_29 ;
}
* V_92 = F_270 ( V_288 , V_30 ) ;
if ( ! * V_92 )
return - V_31 ;
return 0 ;
}
static int F_271 ( struct V_14 * V_14 , T_4 V_264 , T_4 V_289 ,
int V_145 , T_11 * V_287 ,
struct V_107 * V_290 )
{
struct V_245 * V_46 ;
struct V_291 * V_292 ;
...
struct V_23 , V_294 ) ;
V_295:
V_29 = F_269 ( & V_68 , V_14 , V_264 , V_287 ) ;
if ( V_29 )
return V_29 ;
V_253 = F_247 ( V_68 , V_264 , V_289 , & V_257 , V_145 | V_296 ,
V_297 ) ;
if ( ! V_253 )
return - V_259 ;
if ( F_261 ( V_68 , V_263 , V_14 -> V_3 -> V_261 ) )
goto V_298;
V_46 = F_259 ( V_68 , V_299 ) ;
if ( ! V_46 )
goto V_298;
V_28 = 0 ;
V_293 = false ;
...
goto V_295;
V_301:
V_292 = F_274 ( V_68 , V_264 , V_289 , V_302 , 0 , V_145 | V_296 ) ;
if ( ! V_292 ) {
V_29 = F_269 ( & V_68 , V_14 , V_264 , V_287 ) ;
if ( V_29 )
goto V_300;
...
static int F_276 ( struct V_67 * V_68 , struct V_251 * V_32 )
{
struct V_14 * V_14 ;
struct V_23 * V_24 ;
int V_29 ;
...
return - V_62 ;
F_14 (opt_inst, &team->option_inst_list, list)
F_22 ( & V_24 -> V_294 , & V_290 ) ;
V_29 = F_271 ( V_14 , V_32 -> V_255 , V_32 -> V_256 ,
V_303 , F_256 ,
& V_290 ) ;
F_255 ( V_14 ) ;
return V_29 ;
}
static int F_278 ( struct V_67 * V_68 , struct V_251 * V_32 )
{
struct V_14 * V_14 ;
int V_29 = 0 ;
int V_28 ;
...
char * V_20 ;
bool V_316 = false ;
if ( F_280 ( V_304 ) != V_266 ) {
V_29 = - V_62 ;
goto V_306;
}
V_29 = F_281 ( V_307 , V_308 ,
V_304 , V_317 ) ;
if ( V_29 )
goto V_306;
if ( ! V_307 [ V_267 ] ||
...
V_310 = V_307 [ V_274 ] ;
if ( V_312 != V_281 && ! V_310 ) {
V_29 = - V_62 ;
goto V_306;
}
V_20 = F_242 ( V_307 [ V_267 ] ) ;
V_309 = V_307 [ V_269 ] ;
if ( V_309 )
V_313 = F_253 ( V_309 ) ;
V_309 = V_307 [ V_270 ] ;
...
switch ( V_312 ) {
case V_271 :
V_49 . V_163 . V_165 = F_253 ( V_310 ) ;
break;
case V_275 :
if ( F_241 ( V_310 ) > V_319 ) {
V_29 = - V_62 ;
goto V_306;
}
V_49 . V_163 . V_164 = F_242 ( V_310 ) ;
break;
case V_277 :
V_49 . V_163 . V_279 . V_102 = F_241 ( V_310 ) ;
V_49 . V_163 . V_279 . V_280 = F_242 ( V_310 ) ;
break;
case V_281 :
V_49 . V_163 . V_166 = V_310 ? true : false ;
break;
case V_283 :
V_49 . V_163 . V_167 = F_283 ( V_310 ) ;
break;
default:
F_266 () ;
}
...
{
struct V_245 * V_320 ;
V_320 = F_259 ( V_68 , V_321 ) ;
if ( ! V_320 )
goto V_268;
if ( F_261 ( V_68 , V_322 , V_5 -> V_3 -> V_261 ) )
goto V_268;
if ( V_5 -> V_34 ) {
if ( F_264 ( V_68 , V_323 ) )
goto V_268;
...
( V_5 -> V_18 . V_15 &&
F_264 ( V_68 , V_325 ) ) ||
F_261 ( V_68 , V_326 , V_5 -> V_18 . V_327 ) ||
F_262 ( V_68 , V_328 , V_5 -> V_18 . V_329 ) )
goto V_268;
F_267 ( V_68 , V_320 ) ;
return 0 ;
V_268:
...
static int F_287 ( struct V_14 * V_14 , T_4 V_264 , T_4 V_289 ,
int V_145 , T_11 * V_287 ,
struct V_1 * V_330 )
{
struct V_245 * V_79 ;
...
if ( F_261 ( V_68 , V_263 , V_14 -> V_3 -> V_261 ) )
goto V_298;
V_79 = F_259 ( V_68 , V_332 ) ;
if ( ! V_79 )
goto V_298;
V_28 = 0 ;
V_293 = false ;
if ( V_330 ) {
V_29 = F_286 ( V_68 , V_330 ) ;
if ( V_29 )
goto V_300;
} else if ( V_5 ) {
...
if ( ! V_14 )
return - V_62 ;
V_29 = F_287 ( V_14 , V_32 -> V_255 , V_32 -> V_256 ,
V_303 , F_256 , NULL ) ;
F_255 ( V_14 ) ;
return V_29 ;
}
...
struct V_14 * V_14 , T_4 V_264 )
{
return F_291 ( & V_257 , F_257 ( V_14 -> V_3 ) ,
V_68 , 0 , 0 , V_30 ) ;
}
...
V_29 = F_285 ( V_14 , & V_290 ) ;
if ( V_29 && V_29 != - V_335 )
F_297 ( V_14 -> V_3 , L_29 ,
V_29 ) ;
}
static void F_298 ( struct V_1 * V_5 , bool V_15 )
{
int V_29 ;
V_5 -> V_34 = true ;
V_5 -> V_18 . V_15 = V_15 ;
...
if ( V_15 ) {
struct V_336 V_337 ;
V_29 = F_299 ( V_5 -> V_3 , & V_337 ) ;
if ( ! V_29 ) {
V_5 -> V_18 . V_327 = F_300 ( & V_337 ) ;
V_5 -> V_18 . V_329 = V_337 . V_329 ;
goto V_338;
}
}
V_5 -> V_18 . V_327 = 0 ;
V_5 -> V_18 . V_329 = 0 ;
V_338:
V_29 = F_292 ( V_5 -> V_14 , V_5 ) ;
if ( V_29 && V_29 != - V_335 )
F_297 ( V_5 -> V_14 -> V_3 , L_30 ,
V_5 -> V_3 -> V_22 , V_29 ) ;
}
...
static void F_301 ( struct V_1 * V_5 , bool V_15 )
{
...
static int F_303 ( struct V_340 * V_171 ,
unsigned long V_341 , void * V_280 )
{
struct V_2 * V_3 = F_304 ( V_280 ) ;
struct V_1 * V_5 ;
V_5 = F_3 ( V_3 ) ;
if ( ! V_5 )
return V_342 ;
