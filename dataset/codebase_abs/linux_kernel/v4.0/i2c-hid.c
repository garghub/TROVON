...
struct V_10 * V_11 = F_2 ( V_2 ) ;
int V_14 ;
F_53 ( & V_2 -> V_45 , L_24 , V_2 -> V_71 ) ;
V_14 = F_54 ( V_2 -> V_71 , NULL , F_22 ,
V_121 | V_122 ,
V_2 -> V_123 , V_11 ) ;
if ( V_14 < 0 ) {
F_55 ( & V_2 -> V_45 ,
...
T_6 V_139 ;
int V_14 ;
V_14 = F_63 ( V_45 -> V_140 , L_33 , & V_139 ) ;
if ( V_14 ) {
F_13 ( & V_2 -> V_45 , L_34 ) ;
return - V_125 ;
}
...
const struct V_141 * V_72 )
{
int V_14 ;
struct V_10 * V_11 ;
struct V_80 * V_69 ;
V_89 V_142 ;
struct V_128 * V_143 = V_2 -> V_45 . V_143 ;
F_41 ( L_36 , V_2 -> V_30 ) ;
if ( ! V_2 -> V_71 ) {
F_13 ( & V_2 -> V_45 ,
L_37 ) ;
...
F_65 ( V_2 , V_11 ) ;
V_11 -> V_2 = V_2 ;
V_142 = V_11 -> V_129 . V_137 ;
V_11 -> V_24 = F_66 ( V_142 ) ;
F_67 ( & V_11 -> V_19 ) ;
...
V_69 -> V_81 = V_2 ;
V_69 -> V_147 = & V_148 ;
V_69 -> V_45 . V_149 = & V_2 -> V_45 ;
F_74 ( & V_69 -> V_45 , F_75 ( & V_2 -> V_45 ) ) ;
V_69 -> V_150 = V_151 ;
V_69 -> V_152 = F_12 ( V_11 -> V_42 . V_126 ) ;
V_69 -> V_153 = F_12 ( V_11 -> V_42 . V_154 ) ;
V_69 -> V_155 = F_12 ( V_11 -> V_42 . V_156 ) ;
snprintf ( V_69 -> V_123 , sizeof( V_69 -> V_123 ) , L_38 ,
V_2 -> V_123 , V_69 -> V_153 , V_69 -> V_155 ) ;
V_14 = F_76 ( V_69 ) ;
if ( V_14 ) {
if ( V_14 != - V_125 )
F_43 ( V_2 , L_39 , V_14 ) ;
...
static int F_83 ( struct V_76 * V_45 )
{
...
if ( F_86 ( & V_2 -> V_45 ) )
F_87 ( V_2 -> V_71 ) ;
if ( V_69 -> V_158 && V_69 -> V_158 -> V_159 )
V_14 = V_69 -> V_158 -> V_159 ( V_69 , V_160 ) ;
F_15 ( V_2 , V_63 ) ;
return V_14 ;
}
static int F_88 ( struct V_76 * V_45 )
{
int V_14 ;
struct V_1 * V_2 = F_84 ( V_45 ) ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
...
if ( F_86 ( & V_2 -> V_45 ) )
F_90 ( V_2 -> V_71 ) ;
if ( V_69 -> V_158 && V_69 -> V_158 -> V_161 ) {
V_14 = V_69 -> V_158 -> V_161 ( V_69 ) ;
return V_14 ;
}
return 0 ;
}
static int F_91 ( struct V_76 * V_45 )
{
struct V_1 * V_2 = F_84 ( V_45 ) ;
F_15 ( V_2 , V_63 ) ;
F_85 ( V_2 -> V_71 ) ;
