...
static int F_75 ( struct V_6 * V_4 )
{
struct V_2 * V_3 = F_2 ( V_4 ) ;
...
static int F_77 ( struct V_6 * V_4 ,
struct V_147 * V_148 )
{
struct V_2 * V_3 = F_2 ( V_4 ) ;
enum V_149 V_150 ;
...
static enum V_160 F_78 ( struct V_6 * V_4 ,
T_4 V_18 ,
struct V_161 * V_162 )
{
return F_79 ( V_4 , V_18 , V_162 ) ;
}
...
V_101 = F_60 ( sizeof( * V_101 ) + V_170 , V_122 ) ;
if ( ! V_101 )
return - V_172 ;
V_169 = & V_101 -> V_169 ;
V_101 -> V_114 = F_83 ( V_164 ) -> V_173 ;
V_101 -> V_171 = V_166 -> V_171 ;
F_61 ( & V_169 -> V_174 ) ;
for ( V_113 = 0 ; V_113 < V_166 -> V_171 ; V_113 ++ ) {
const struct V_175 * V_176 = & V_166 -> V_174 [ V_113 ] ;
struct V_2 * V_3 = & V_101 -> V_174 [ V_113 ] ;
V_3 -> V_4 . V_1 = V_169 ;
V_3 -> V_20 = V_176 -> V_177 ;
V_3 -> V_104 = V_176 -> V_104 ;
V_3 -> V_101 = V_101 ;
V_3 -> V_117 = F_84 ( NULL , V_176 -> V_112 ) ;
if ( F_85 ( V_3 -> V_117 ) ) {
F_22 ( & V_164 -> V_5 , L_16 ,
V_176 -> V_112 ) ;
continue;
...
V_169 -> V_188 = F_80 ;
V_169 -> V_189 = F_78 ;
F_90 ( V_169 -> V_5 , V_134 ) ;
if ( V_101 -> V_114 ) {
F_89 ( V_190 , V_169 -> V_179 ) ;
V_169 -> V_191 = F_67 ;
V_101 -> V_119 = F_27 ;
V_101 -> V_125 = F_28 ;
V_101 -> V_102 = F_30 ;
...
V_95 = F_91 ( V_169 ) ;
if ( F_92 ( V_95 ) ) {
for ( V_113 = 0 ; V_113 < V_101 -> V_171 ; V_113 ++ ) {
struct V_2 * V_3 = & V_101 -> V_174 [ V_113 ] ;
if ( ! F_93 ( V_3 -> V_117 ) )
F_94 ( V_3 -> V_117 ) ;
}
