...
struct V_1 * V_2 = & V_33 -> V_5 -> V_21 . V_57 ;
struct V_6 * V_7 ;
...
static void F_48 ( struct V_65 * V_15 )
{
F_49 ( F_50 ( V_15 ) , V_66 ) ;
}
static void F_51 ( struct V_65 * V_15 )
{
F_52 ( F_50 ( V_15 ) , V_66 ) ;
}
static int F_53 ( struct V_65 * V_15 )
{
struct V_13 * V_14 = F_50 ( V_15 ) ;
int V_67 ;
if ( F_54 ( ! F_55 ( V_14 ) ) )
return - V_68 ;
F_49 ( V_14 , V_66 ) ;
...
static int F_57 ( struct V_65 * V_69 ,
struct V_65 * V_70 , void * V_71 )
{
struct V_72 * V_73 = V_71 ;
if ( F_30 ( V_73 -> V_74 || V_73 -> V_15 ) )
return - V_75 ;
V_73 -> V_74 = & V_76 ;
V_73 -> V_15 = V_69 ;
return 0 ;
}
static void F_58 ( struct V_65 * V_69 ,
struct V_65 * V_70 , void * V_71 )
{
struct V_72 * V_73 = V_71 ;
V_73 -> V_74 = NULL ;
