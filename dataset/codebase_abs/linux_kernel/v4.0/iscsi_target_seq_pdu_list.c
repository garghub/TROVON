...
V_37 = V_2 -> V_39 -> V_43 -> V_44 ;
else
V_37 = V_2 -> V_39 -> V_43 -> V_45 ;
if ( ( V_33 -> type == V_29 ) ||
( V_33 -> type == V_31 ) )
V_34 = 1 ;
if ( ( V_33 -> type == V_30 ) ||
( V_33 -> type == V_31 ) )
V_36 = F_14 ( V_2 -> V_40 . V_46 ,
V_39 -> V_47 -> V_48 -> V_49 ) ;
while ( V_11 < V_2 -> V_40 . V_46 ) {
* V_10 += 1 ;
if ( V_34 ) {
V_34 = 0 ;
V_11 += V_33 -> V_50 ;
...
if ( V_36 > 0 ) {
if ( ( V_11 + V_37 ) >= V_2 -> V_40 . V_46 ) {
V_36 -=
( V_2 -> V_40 . V_46 - V_11 ) ;
V_11 += ( V_2 -> V_40 . V_46 - V_11 ) ;
continue;
}
if ( ( V_11 + V_37 )
>= V_39 -> V_47 -> V_48 -> V_49 ) {
...
struct V_32 * V_33 )
{
int V_34 = 0 , V_52 , V_53 ;
T_2 V_35 = 0 , V_11 = 0 , V_3 = 0 , V_37 ;
...
V_37 = V_2 -> V_39 -> V_43 -> V_45 ;
V_52 = V_39 -> V_47 -> V_48 -> V_54 ;
V_53 = V_39 -> V_47 -> V_48 -> V_55 ;
if ( ( V_33 -> type == V_29 ) ||
( V_33 -> type == V_31 ) )
V_34 = 1 ;
if ( ( V_33 -> type == V_30 ) ||
...
if ( ! V_52 ) {
V_16 [ V_3 ] . type = V_61 ;
V_16 [ V_3 ] . V_18 = ( V_2 -> V_40 . V_46 - V_11 ) ;
}
if ( ! V_53 ) {
V_5 [ V_14 ] . type = V_20 ;
V_5 [ V_14 ] . V_10 = V_10 ;
...
if ( V_71 -> V_77 )
V_33 . V_63 |= V_64 ;
if ( ! V_2 -> V_78 && ! V_2 -> V_79 )
V_33 . type = V_74 ;
else if ( V_2 -> V_78 && ! V_2 -> V_79 )
V_33 . type = V_29 ;
else if ( ! V_2 -> V_78 && V_2 -> V_79 )
V_33 . type = V_30 ;
else if ( V_2 -> V_78 && V_2 -> V_79 )
...
if ( ! V_39 -> V_47 -> V_48 -> V_55 ) {
V_5 = F_9 ( V_7 , sizeof( struct V_4 ) , V_80 ) ;
if ( ! V_5 ) {
F_10 ( L_13 ) ;
return - V_28 ;
}
...
if ( ! V_39 -> V_47 -> V_48 -> V_54 ) {
V_16 = F_9 ( V_10 , sizeof( struct V_15 ) , V_80 ) ;
if ( ! V_16 ) {
F_10 ( L_14 ) ;
F_11 ( V_5 ) ;
return - V_28 ;
...
F_2 ( L_31
L_32 ,
V_2 -> V_8 [ V_3 ] . V_56 , V_2 -> V_8 [ V_3 ] . V_12 ,
V_2 -> V_8 [ V_3 ] . V_14 ) ;
if ( ( V_2 -> V_8 [ V_3 ] . V_56 +
V_2 -> V_8 [ V_3 ] . V_12 ) >=
( V_11 + V_18 ) )
