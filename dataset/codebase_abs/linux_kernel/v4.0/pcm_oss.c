...
F_32 ( & V_138 ) ;
if ( F_69 ( & V_49 -> V_112 ) )
F_77 ( & V_138 , ( V_142 int ) V_143 ) ;
else {
F_77 ( & V_138 , ( V_142 int ) V_144 ) ;
if ( ! V_134 )
F_77 ( & V_138 , ( V_142 int ) V_145 ) ;
}
...
if ( V_248 -> V_249 == 0 )
continue;
if ( ( V_374 = F_206 ( V_21 -> V_308 , L_48 , V_248 -> V_382 ) ) != NULL ) {
V_374 -> V_383 = V_384 ;
