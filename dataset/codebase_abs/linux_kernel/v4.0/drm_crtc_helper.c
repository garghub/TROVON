...
int V_47 ;
if ( V_20 -> V_25 -> V_99 )
V_98 = V_20 -> V_25 -> V_99 ( V_20 ) ;
else if ( V_20 -> V_100 )
V_98 = F_41 ( V_20 -> V_100 , sizeof( * V_98 ) ,
V_74 ) ;
else
V_98 = F_27 ( sizeof( * V_98 ) , V_74 ) ;
if ( ! V_98 )
return - V_75 ;
V_98 -> V_20 = V_20 ;
V_98 -> V_57 = true ;
...
F_42 ( & V_98 -> V_42 , V_42 ) ;
if ( V_31 -> V_102 ) {
V_47 = V_31 -> V_102 ( V_20 , V_98 ) ;
if ( V_47 ) {
F_28 ( V_98 ) ;
return V_47 ;
}
}
F_43 ( V_20 -> V_100 , V_98 ) ;
V_31 -> V_103 ( V_20 ) ;
if ( V_98 ) {
if ( V_20 -> V_25 -> V_104 )
V_20 -> V_25 -> V_104 ( V_20 , V_98 ) ;
else
F_28 ( V_98 ) ;
}
...
{
struct V_105 * V_106 ;
struct V_107 * V_108 = V_20 -> V_33 ;
if ( V_108 -> V_25 -> V_99 )
V_106 = V_108 -> V_25 -> V_99 ( V_108 ) ;
else if ( V_108 -> V_100 )
V_106 = F_45 ( V_108 ) ;
else
V_106 = F_27 ( sizeof( * V_106 ) , V_74 ) ;
if ( ! V_106 )
return - V_75 ;
V_106 -> V_108 = V_108 ;
V_106 -> V_20 = V_20 ;
F_46 ( V_106 , V_20 -> V_33 -> V_34 ) ;
V_106 -> V_109 = 0 ;
V_106 -> V_110 = 0 ;
V_106 -> V_111 = V_20 -> V_37 . V_112 ;
V_106 -> V_113 = V_20 -> V_37 . V_114 ;
V_106 -> V_115 = V_38 << 16 ;
V_106 -> V_116 = V_39 << 16 ;
V_106 -> V_117 = V_20 -> V_37 . V_112 << 16 ;
V_106 -> V_118 = V_20 -> V_37 . V_114 << 16 ;
return F_47 ( V_108 , V_106 , V_41 ) ;
}
