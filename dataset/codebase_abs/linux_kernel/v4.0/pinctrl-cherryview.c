...
V_2 -> V_42 = & V_133 -> V_42 ;
#ifdef F_75
V_2 -> V_145 = F_76 ( V_2 -> V_42 ,
V_2 -> V_17 -> V_23 , sizeof( * V_2 -> V_145 ) ,
V_139 ) ;
if ( ! V_2 -> V_145 )
return - V_140 ;
#endif
V_137 = F_77 ( V_133 , V_146 , 0 ) ;
V_2 -> V_11 = F_78 ( & V_133 -> V_42 , V_137 ) ;
if ( F_79 ( V_2 -> V_11 ) )
...
V_2 -> V_147 = V_148 ;
V_2 -> V_147 . V_21 = F_64 ( & V_133 -> V_42 ) ;
V_2 -> V_147 . V_22 = V_2 -> V_17 -> V_22 ;
V_2 -> V_147 . V_23 = V_2 -> V_17 -> V_23 ;
V_2 -> V_16 = F_82 ( & V_2 -> V_147 , & V_133 -> V_42 , V_2 ) ;
if ( ! V_2 -> V_16 ) {
...
{
struct V_1 * V_2 = F_86 ( V_133 ) ;
F_70 ( & V_2 -> V_88 ) ;
F_83 ( V_2 -> V_16 ) ;
return 0 ;
}
static int F_87 ( struct V_149 * V_42 )
{
struct V_132 * V_133 = F_88 ( V_42 ) ;
struct V_1 * V_2 = F_86 ( V_133 ) ;
int V_41 ;
V_2 -> V_150 = F_4 ( V_2 -> V_11 + V_102 ) ;
for ( V_41 = 0 ; V_41 < V_2 -> V_17 -> V_23 ; V_41 ++ ) {
const struct V_151 * V_117 ;
struct V_152 * V_153 ;
void T_1 * V_4 ;
V_117 = & V_2 -> V_17 -> V_22 [ V_41 ] ;
if ( F_5 ( V_2 , V_117 -> V_90 ) )
continue;
V_153 = & V_2 -> V_145 [ V_41 ] ;
V_4 = F_1 ( V_2 , V_117 -> V_90 , V_31 ) ;
V_153 -> V_154 = F_4 ( V_4 ) & ~ V_92 ;
V_4 = F_1 ( V_2 , V_117 -> V_90 , V_13 ) ;
V_153 -> V_155 = F_4 ( V_4 ) ;
}
return 0 ;
}
static int F_89 ( struct V_149 * V_42 )
{
struct V_132 * V_133 = F_88 ( V_42 ) ;
struct V_1 * V_2 = F_86 ( V_133 ) ;
int V_41 ;
