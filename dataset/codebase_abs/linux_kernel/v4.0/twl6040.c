...
{
struct V_73 * V_41 = & V_2 -> V_41 ;
if ( F_34 ( V_41 , L_1 ) )
return - 1 ;
if ( F_34 ( V_41 , L_2 ) ||
F_34 ( V_41 , L_3 ) ) {
T_1 V_66 = F_35 ( V_2 , V_11 ) ;
if ( V_66 & V_35 )
return - 8 ;
else
return - 1 ;
...
int F_37 ( struct V_1 * V_2 , enum V_74 V_75 )
{
if ( F_38 ( V_75 >= V_76 ) )
return - V_77 ;
...
V_43 = F_49 ( V_6 , V_5 -> V_98 , V_5 -> V_102 , V_5 -> V_101 ) ;
if ( V_43 ) {
F_47 ( V_2 -> V_100 , L_7 , V_43 ) ;
return - V_103 ;
}
return 0 ;
}
static int F_50 ( struct V_90 * V_104 ,
...
break;
default:
F_47 ( V_2 -> V_100 , L_8 , V_105 ) ;
return - V_77 ;
}
return 0 ;
}
static void F_51 ( struct V_1 * V_2 , enum V_109 V_110 ,
int V_111 )
{
struct V_6 * V_6 = V_2 -> V_7 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
...
static int F_52 ( struct V_90 * V_91 , int V_111 )
{
switch ( V_91 -> V_110 ) {
case V_121 :
F_51 ( V_91 -> V_2 , V_115 , V_111 ) ;
F_51 ( V_91 -> V_2 , V_117 , V_111 ) ;
break;
case V_115 :
case V_117 :
F_51 ( V_91 -> V_2 , V_91 -> V_110 , V_111 ) ;
break;
default:
break;
}
...
{
struct V_4 * V_5 ;
struct V_6 * V_6 = F_54 ( V_2 -> V_100 -> V_122 ) ;
struct V_123 * V_124 = F_21 ( V_2 -> V_100 ,
struct V_123 , V_100 ) ;
int V_43 = 0 ;
V_5 = F_55 ( V_2 -> V_100 , sizeof( * V_5 ) , V_125 ) ;
if ( V_5 == NULL )
return - V_126 ;
F_56 ( V_2 , V_5 ) ;
V_5 -> V_2 = V_2 ;
V_2 -> V_7 = V_6 ;
V_5 -> V_127 = F_57 ( V_124 , 0 ) ;
if ( V_5 -> V_127 < 0 ) {
F_47 ( V_2 -> V_100 , L_9 ) ;
return - V_77 ;
}
F_58 ( & V_5 -> V_54 . V_56 , F_20 ) ;
F_59 ( & V_5 -> V_50 ) ;
V_43 = F_60 ( V_5 -> V_127 , NULL ,
F_22 , V_128 ,
L_10 , V_2 ) ;
if ( V_43 ) {
F_47 ( V_2 -> V_100 , L_11 , V_43 ) ;
return V_43 ;
}
F_41 ( V_2 , V_83 ) ;
F_8 ( V_2 ) ;
