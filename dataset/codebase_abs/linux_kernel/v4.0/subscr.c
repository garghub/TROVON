...
static void F_21 ( struct V_42 * V_37 ,
struct V_14 * V_15 )
{
struct V_3 * V_4 ;
struct V_3 * V_40 ;
...
static int F_22 ( struct V_12 * V_12 , struct V_42 * V_37 ,
struct V_14 * V_15 ,
struct V_3 * * V_44 )
{
...
V_4 -> V_34 = F_26 ( F_1 ( V_37 -> V_34 , V_2 ) ) ;
...
F_27 ( & V_4 -> V_36 , & V_15 -> V_36 ) ;
V_4 -> V_15 = V_15 ;
V_4 -> V_2 = V_2 ;
memcpy ( & V_4 -> V_19 . V_37 , V_37 , sizeof( struct V_42 ) ) ;
F_28 ( & V_11 -> V_39 ) ;
if ( V_4 -> V_34 != V_35 ) {
F_29 ( & V_4 -> V_41 , F_8 , ( unsigned long ) V_4 ) ;
F_30 ( & V_4 -> V_41 , V_51 + V_4 -> V_34 ) ;
}
* V_44 = V_4 ;
return 0 ;
}
static void F_31 ( int V_25 , void * V_52 )
{
F_18 ( (struct V_14 * ) V_52 ) ;
}
static void F_32 ( struct V_12 * V_12 , int V_25 ,
...
struct V_3 * V_4 = NULL ;
F_9 ( & V_15 -> V_33 ) ;
if ( F_22 ( V_12 , (struct V_42 * ) V_55 , V_15 ,
& V_4 ) < 0 ) {
F_10 ( & V_15 -> V_33 ) ;
F_16 ( V_4 ) ;
return;
...
static void * F_34 ( int V_25 )
{
struct V_14 * V_15 ;
V_15 = F_35 ( sizeof( struct V_14 ) , V_49 ) ;
if ( V_15 == NULL ) {
F_24 ( L_4 ) ;
return NULL ;
}
...
int F_38 ( struct V_12 * V_12 )
{
struct V_10 * V_11 = F_4 ( V_12 , V_13 ) ;
const char V_57 [] = L_5 ;
struct V_58 * V_24 ;
struct V_53 * V_59 ;
V_59 = F_35 ( sizeof( * V_59 ) , V_49 ) ;
if ( ! V_59 )
return - V_50 ;
V_59 -> V_60 = V_61 ;
V_59 -> V_62 = V_63 ;
