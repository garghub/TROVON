...
static int F_52 ( struct V_136 * V_32 )
{
int V_13 = - V_20 ;
char V_137 [ 16 ] ;
struct V_4 * V_5 ;
...
static int F_54 ( struct V_136 * V_32 )
{
struct V_4 * V_5 ;
V_5 = V_32 -> V_138 ;
F_55 ( & V_5 -> V_141 ) ;
...
static int F_56 ( struct V_136 * V_32 )
{
struct V_4 * V_5 ;
V_5 = V_32 -> V_138 ;
F_57 ( & V_5 -> V_141 ) ;
...
int F_58 ( struct V_142 * V_26 , int V_32 ,
int V_11 , struct V_4 * V_5 )
{
static struct V_143 V_30 = {
. V_144 = F_56 ,
. V_145 = F_52 ,
. V_146 = F_54 ,
} ;
...
V_5 -> V_25 = V_11 ;
F_59 ( & V_5 -> V_141 , V_26 ) ;
F_60 ( & V_5 -> V_141 , L_19 , V_26 -> V_147 , V_32 ) ;
return F_61 ( V_26 , V_148 , V_5 , & V_30 ) ;
}
static int F_62 ( struct V_4 * V_32 )
{
int V_13 ;
if ( ! V_32 -> V_26 )
return - V_20 ;
...
static int F_64 ( struct V_4 * V_32 )
{
return F_65 ( V_32 -> V_26 ) ;
}
int F_66 ( struct V_4 * V_32 )
{
int V_69 ;
if ( V_32 -> V_139 == NULL || V_32 -> V_30 == NULL )
return - V_20 ;
F_14 ( L_21 , V_32 -> V_139 ) ;
...
int F_68 ( struct V_4 * V_32 )
{
F_14 ( L_22 , V_32 -> V_139 ) ;
F_10 ( & V_149 ) ;
F_64 ( V_32 ) ;
F_11 ( & V_149 ) ;
return 0 ;
