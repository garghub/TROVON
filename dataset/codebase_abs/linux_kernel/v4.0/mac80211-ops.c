...
F_69 ( V_64 ) ;
if ( V_180 -> V_185 > 0 ) {
V_8 -> V_178 . time += V_180 -> V_185 / div ;
V_8 -> V_178 . V_186 += V_180 -> V_187 / div ;
V_8 -> V_178 . V_188 += V_180 -> V_189 / div ;
V_8 -> V_178 . V_190 += V_180 -> V_191 / div ;
}
memset ( V_180 , 0 , sizeof( * V_180 ) ) ;
F_36 ( & V_64 -> V_184 ) ;
memcpy ( V_178 , & V_8 -> V_178 , sizeof( * V_178 ) ) ;
V_178 -> V_192 = V_46 -> V_48 . V_193 ;
V_178 -> V_194 = V_8 -> V_195 ;
V_178 -> V_196 = V_197 |
V_198 |
V_199 |
V_200 |
