...
V_5 = V_183 -> V_184 . V_51 ;
V_13 -> V_185 [ V_5 ] . V_186 = V_183 ;
V_13 -> V_185 [ V_5 ] . V_187 . V_188 . V_189 =
F_62 ( V_183 , 0 ) ;
V_13 -> V_185 [ V_5 ] . V_187 . V_188 . V_190 =
F_62 ( V_183 , 1 ) ;
V_13 -> V_98 ++ ;
} else if ( V_171 -> type == V_72 ) {
if ( F_60 ( F_61 (
...
if ( V_193 -> type == V_56 ) {
F_51 ( & V_32 -> V_160 , V_158 ) ;
F_28 ( V_32 -> V_96 , V_200 ,
& V_13 -> V_201 , & V_13 -> V_83 ) ;
F_67 ( & V_13 -> V_201 ) ;
V_13 -> V_18 = 0 ;
V_13 -> V_202 = 1 ;
V_13 -> V_203 = 0 ;
...
struct V_157 * V_206 ;
if ( V_171 -> type == V_72 ) {
V_206 = & V_13 -> V_191 [ V_183 -> V_184 . V_51 ] ;
V_206 -> V_158 &= ~ V_164 ;
F_51 ( & V_32 -> V_160 , V_158 ) ;
F_69 ( & V_206 -> V_163 , & V_13 -> V_161 ) ;
V_13 -> V_14 ++ ;
F_52 ( & V_32 -> V_160 , V_158 ) ;
} else if ( V_171 -> type == V_56 ) {
V_206 = & V_13 -> V_185 [ V_183 -> V_184 . V_51 ] ;
V_206 -> V_158 &= ~ V_164 ;
F_51 ( & V_32 -> V_160 , V_158 ) ;
F_70 ( V_183 -> V_184 . V_51 , & V_13 -> V_203 ) ;
F_69 ( & V_206 -> V_163 , & V_13 -> V_201 ) ;
V_13 -> V_18 ++ ;
F_52 ( & V_32 -> V_160 , V_158 ) ;
} else {
...
struct V_207 * F_71 ( void )
{
return & V_208 ;
}
struct V_209 * F_72 ( void )
{
return & V_210 ;
}
const struct V_211 * F_73 ( void )
{
return & V_212 ;
}
...
V_214 . V_226 = 0 ;
V_13 -> V_227 [ V_5 ] = F_77 ( & V_13 -> V_194 ,
& V_214 , NULL ) ;
} else {
V_13 -> V_227 [ V_5 ] = F_78 ( & V_13 -> V_194 ,
& V_218 ,
V_216 [ V_5 ] . V_128 , V_216 [ V_5 ] . V_220 ,
