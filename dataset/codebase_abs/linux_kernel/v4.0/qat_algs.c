...
struct V_186 * V_187 ,
struct V_186 * V_188 ,
struct V_186 * V_189 , T_1 * V_190 ,
T_1 V_191 ,
struct V_167 * V_168 )
{
struct V_156 * V_157 = & F_49 ( V_159 -> V_160 ) ;
int V_32 , V_192 = 0 , V_193 = 0 ;
int V_194 = F_58 ( V_188 ) , V_195 = F_58 ( V_187 ) ;
struct V_169 * V_196 ;
struct V_169 * V_197 = NULL ;
T_4 V_173 ;
T_4 V_175 = 0 ;
struct V_186 * V_198 ;
T_5 V_177 , V_176 = sizeof( struct V_169 ) +
( ( 1 + V_194 + V_195 ) * sizeof( struct V_199 ) ) ;
if ( F_59 ( ! V_194 ) )
return - V_151 ;
V_196 = F_60 ( V_176 , V_163 ,
F_61 ( & F_49 ( V_159 -> V_160 ) ) ) ;
if ( F_59 ( ! V_196 ) )
return - V_164 ;
V_173 = F_62 ( V_157 , V_196 , V_176 , V_183 ) ;
if ( F_59 ( F_63 ( V_157 , V_173 ) ) )
goto V_200;
F_64 (assoc, sg, assoc_n, i) {
if ( ! V_198 -> V_201 )
continue;
V_196 -> V_179 [ V_192 ] . V_180 = F_62 ( V_157 ,
F_65 ( V_198 ) ,
V_198 -> V_201 ,
V_182 ) ;
V_196 -> V_179 [ V_192 ] . V_181 = V_198 -> V_201 ;
if ( F_59 ( F_63 ( V_157 , V_196 -> V_179 [ V_192 ] . V_180 ) ) )
goto V_200;
V_192 ++ ;
}
if ( V_191 ) {
V_196 -> V_179 [ V_192 ] . V_180 = F_62 ( V_157 , V_190 , V_191 ,
V_182 ) ;
V_196 -> V_179 [ V_192 ] . V_181 = V_191 ;
if ( F_59 ( F_63 ( V_157 , V_196 -> V_179 [ V_192 ] . V_180 ) ) )
goto V_200;
V_192 ++ ;
}
F_64 (sgl, sg, n, i) {
int V_202 = V_193 + V_192 ;
if ( ! V_198 -> V_201 )
continue;
V_196 -> V_179 [ V_202 ] . V_180 = F_62 ( V_157 , F_65 ( V_198 ) ,
V_198 -> V_201 ,
V_182 ) ;
V_196 -> V_179 [ V_202 ] . V_181 = V_198 -> V_201 ;
if ( F_59 ( F_63 ( V_157 , V_196 -> V_179 [ V_202 ] . V_180 ) ) )
goto V_200;
V_193 ++ ;
}
V_196 -> V_178 = V_193 + V_192 ;
V_168 -> V_171 . V_170 = V_196 ;
...
( ( 1 + V_194 + V_195 ) * sizeof( struct V_199 ) ) ;
V_193 = 0 ;
V_197 = F_60 ( V_177 , V_163 ,
F_61 ( & F_49 ( V_159 -> V_160 ) ) ) ;
if ( F_59 ( ! V_197 ) )
goto V_200;
V_175 = F_62 ( V_157 , V_197 , V_177 , V_183 ) ;
if ( F_59 ( F_63 ( V_157 , V_175 ) ) )
goto V_200;
V_179 = V_197 -> V_179 ;
for ( V_32 = 0 ; V_32 < V_192 ; V_32 ++ ) {
V_179 [ V_32 ] . V_181 = V_196 -> V_179 [ V_32 ] . V_181 ;
V_179 [ V_32 ] . V_180 = V_196 -> V_179 [ V_32 ] . V_180 ;
}
F_64 (sglout, sg, n, i) {
int V_202 = V_193 + V_192 ;
if ( ! V_198 -> V_201 )
continue;
V_179 [ V_202 ] . V_180 = F_62 ( V_157 , F_65 ( V_198 ) ,
V_198 -> V_201 ,
V_182 ) ;
if ( F_59 ( F_63 ( V_157 , V_179 [ V_202 ] . V_180 ) ) )
goto V_200;
V_179 [ V_202 ] . V_181 = V_198 -> V_201 ;
V_193 ++ ;
}
V_197 -> V_178 = V_193 + V_192 ;
V_197 -> V_185 = V_193 ;
V_168 -> V_171 . V_172 = V_197 ;
...
F_66 ( V_157 , L_1 ) ;
V_193 = 0 ;
for ( V_32 = 0 ; V_32 < V_194 + V_192 ; V_32 ++ )
if ( ! F_63 ( V_157 , V_196 -> V_179 [ V_32 ] . V_180 ) )
F_55 ( V_157 , V_196 -> V_179 [ V_32 ] . V_180 ,
V_196 -> V_179 [ V_32 ] . V_181 ,
V_182 ) ;
if ( ! F_63 ( V_157 , V_173 ) )
F_55 ( V_157 , V_173 , V_176 , V_183 ) ;
F_56 ( V_196 ) ;
if ( V_188 != V_189 && V_197 ) {
V_194 = F_58 ( V_189 ) ;
for ( V_32 = V_192 ; V_32 < V_194 + V_192 ; V_32 ++ )
...
struct V_167 * V_168 )
{
struct V_14 * V_15 = V_168 -> V_205 ;
struct V_162 * V_159 = V_15 -> V_159 ;
struct V_206 * V_207 = V_168 -> V_208 ;
T_1 V_209 = V_204 -> V_210 . V_211 ;
int V_212 = 0 , V_213 = F_68 ( V_209 ) ;
F_54 ( V_159 , V_168 ) ;
if ( F_59 ( V_213 != V_214 ) )
V_212 = - V_215 ;
V_207 -> V_216 . V_217 ( & V_207 -> V_216 , V_212 ) ;
}
static void F_69 ( struct V_203 * V_204 ,
struct V_167 * V_168 )
{
struct V_139 * V_15 = V_168 -> V_218 ;
struct V_162 * V_159 = V_15 -> V_159 ;
struct V_219 * V_207 = V_168 -> V_220 ;
T_1 V_209 = V_204 -> V_210 . V_211 ;
int V_212 = 0 , V_213 = F_68 ( V_209 ) ;
F_54 ( V_159 , V_168 ) ;
if ( F_59 ( V_213 != V_214 ) )
...
void F_70 ( void * V_221 )
{
struct V_203 * V_204 = V_221 ;
struct V_167 * V_168 =
( void * ) ( V_222 long ) V_204 -> V_223 ;
V_168 -> V_224 ( V_204 , V_168 ) ;
}
static int F_71 ( struct V_206 * V_207 )
{
struct V_59 * V_60 = F_72 ( V_207 ) ;
struct V_225 * V_34 = F_73 ( V_60 ) ;
struct V_14 * V_15 = F_74 ( V_34 ) ;
struct V_167 * V_168 = F_75 ( V_207 ) ;
struct V_133 * V_226 ;
struct V_130 * V_131 ;
struct V_71 * V_227 ;
int V_228 = F_26 ( V_60 ) -> V_62 ;
int V_36 , V_229 = 0 ;
V_36 = F_57 ( V_15 -> V_159 , V_207 -> V_187 , V_207 -> V_230 , V_207 -> V_231 ,
V_207 -> V_190 , V_109 , V_168 ) ;
if ( F_59 ( V_36 ) )
return V_36 ;
V_227 = & V_168 -> V_140 ;
* V_227 = V_15 -> V_129 ;
...
V_168 -> V_208 = V_207 ;
V_168 -> V_224 = F_67 ;
V_168 -> V_140 . V_232 . V_223 = ( V_233 ) ( V_222 long ) V_168 ;
V_168 -> V_140 . V_232 . V_234 = V_168 -> V_171 . V_173 ;
V_168 -> V_140 . V_232 . V_235 = V_168 -> V_171 . V_175 ;
V_226 = ( void * ) & V_168 -> V_140 . V_132 ;
V_226 -> V_236 = V_207 -> V_237 - V_228 ;
V_226 -> V_238 = V_207 -> V_239 + V_109 ;
memcpy ( V_226 -> V_101 . V_240 , V_207 -> V_190 , V_109 ) ;
V_131 = ( void * ) ( ( T_1 * ) V_226 + sizeof( * V_226 ) ) ;
V_131 -> V_241 = 0 ;
V_131 -> V_242 = V_207 -> V_239 +
V_226 -> V_236 + V_109 ;
do {
V_36 = F_76 ( V_15 -> V_159 -> V_243 , ( V_244 * ) V_227 ) ;
} while ( V_36 == - V_245 && V_229 ++ < 10 );
if ( V_36 == - V_245 ) {
...
static int F_77 ( struct V_206 * V_207 , T_1 * V_190 ,
int V_248 )
{
struct V_59 * V_60 = F_72 ( V_207 ) ;
struct V_225 * V_34 = F_73 ( V_60 ) ;
...
V_131 = ( void * ) ( ( T_1 * ) V_226 + sizeof( * V_226 ) ) ;
if ( V_248 ) {
V_226 -> V_236 = V_207 -> V_237 + V_109 ;
V_226 -> V_238 = V_207 -> V_239 ;
} else {
memcpy ( V_226 -> V_101 . V_240 , V_190 , V_109 ) ;
V_226 -> V_236 = V_207 -> V_237 ;
V_226 -> V_238 = V_207 -> V_239 + V_109 ;
}
V_131 -> V_241 = 0 ;
V_131 -> V_242 = V_207 -> V_239 + V_207 -> V_237 + V_109 ;
do {
V_36 = F_76 ( V_15 -> V_159 -> V_243 , ( V_244 * ) V_227 ) ;
} while ( V_36 == - V_245 && V_229 ++ < 10 );
if ( V_36 == - V_245 ) {
...
{
return F_77 ( V_207 , V_207 -> V_190 , 0 ) ;
}
static int F_79 ( struct V_249 * V_140 )
{
struct V_59 * V_60 = F_72 ( & V_140 -> V_207 ) ;
struct V_225 * V_34 = F_73 ( V_60 ) ;
struct V_14 * V_15 = F_74 ( V_34 ) ;
T_3 V_250 ;
memcpy ( V_140 -> V_251 , V_15 -> V_153 , V_109 ) ;
V_250 = F_14 ( V_140 -> V_250 ) ;
memcpy ( V_140 -> V_251 + V_109 - sizeof( V_233 ) ,
& V_250 , sizeof( V_233 ) ) ;
return F_77 ( & V_140 -> V_207 , V_140 -> V_251 , 1 ) ;
}
static int F_80 ( struct V_252 * V_34 ,
const T_1 * V_86 ,
unsigned int V_142 )
{
struct V_139 * V_15 = F_81 ( V_34 ) ;
struct V_156 * V_157 ;
F_48 ( & V_15 -> V_158 ) ;
if ( V_15 -> V_65 ) {
V_157 = & F_49 ( V_15 -> V_159 -> V_160 ) ;
...
static int F_82 ( struct V_219 * V_140 )
{
struct V_252 * V_253 = F_83 ( V_140 ) ;
struct V_225 * V_34 = F_84 ( V_253 ) ;
struct V_139 * V_15 = F_74 ( V_34 ) ;
struct V_167 * V_168 = F_85 ( V_140 ) ;
struct V_133 * V_226 ;
struct V_71 * V_227 ;
int V_36 , V_229 = 0 ;
V_36 = F_57 ( V_15 -> V_159 , NULL , V_140 -> V_230 , V_140 -> V_231 ,
NULL , 0 , V_168 ) ;
if ( F_59 ( V_36 ) )
return V_36 ;
V_227 = & V_168 -> V_140 ;
...
V_168 -> V_140 . V_232 . V_235 = V_168 -> V_171 . V_175 ;
V_226 = ( void * ) & V_168 -> V_140 . V_132 ;
V_226 -> V_236 = V_140 -> V_254 ;
V_226 -> V_238 = 0 ;
memcpy ( V_226 -> V_101 . V_240 , V_140 -> V_255 , V_109 ) ;
do {
V_36 = F_76 ( V_15 -> V_159 -> V_243 , ( V_244 * ) V_227 ) ;
} while ( V_36 == - V_245 && V_229 ++ < 10 );
if ( V_36 == - V_245 ) {
...
static int F_86 ( struct V_219 * V_140 )
{
struct V_252 * V_253 = F_83 ( V_140 ) ;
struct V_225 * V_34 = F_84 ( V_253 ) ;
struct V_139 * V_15 = F_74 ( V_34 ) ;
...
static int F_87 ( struct V_225 * V_34 ,
enum V_3 V_13 ,
const char * V_256 )
{
struct V_14 * V_15 = F_74 ( V_34 ) ;
V_15 -> V_19 = F_88 ( V_256 , 0 , 0 ) ;
if ( F_89 ( V_15 -> V_19 ) )
return - V_11 ;
F_90 ( & V_15 -> V_158 ) ;
V_15 -> V_4 = V_13 ;
V_34 -> V_257 . V_258 = sizeof( struct V_206 ) +
sizeof( struct V_167 ) ;
V_15 -> V_34 = V_34 ;
return 0 ;
}
static int F_91 ( struct V_225 * V_34 )
{
return F_87 ( V_34 , V_5 , L_2 ) ;
}
static int F_92 ( struct V_225 * V_34 )
{
return F_87 ( V_34 , V_7 , L_3 ) ;
}
static int F_93 ( struct V_225 * V_34 )
{
return F_87 ( V_34 , V_9 , L_4 ) ;
}
static void F_94 ( struct V_225 * V_34 )
{
struct V_14 * V_15 = F_74 ( V_34 ) ;
struct V_162 * V_159 = V_15 -> V_159 ;
struct V_156 * V_157 ;
...
static int F_97 ( struct V_225 * V_34 )
{
struct V_139 * V_15 = F_74 ( V_34 ) ;
F_90 ( & V_15 -> V_158 ) ;
V_34 -> V_259 . V_258 = sizeof( struct V_219 ) +
sizeof( struct V_167 ) ;
V_15 -> V_34 = V_34 ;
return 0 ;
}
static void F_98 ( struct V_225 * V_34 )
{
struct V_139 * V_15 = F_74 ( V_34 ) ;
struct V_162 * V_159 = V_15 -> V_159 ;
struct V_156 * V_157 ;
...
if ( F_100 ( 1 , & V_260 ) == 1 ) {
int V_32 ;
for ( V_32 = 0 ; V_32 < F_101 ( V_261 ) ; V_32 ++ )
V_261 [ V_32 ] . V_262 =
( V_261 [ V_32 ] . V_263 == & V_264 ) ?
V_265 | V_266 :
V_267 | V_266 ;
return F_102 ( V_261 , F_101 ( V_261 ) ) ;
}
return 0 ;
}
int F_103 ( void )
{
if ( F_104 ( 1 , & V_260 ) == 0 )
return F_105 ( V_261 , F_101 ( V_261 ) ) ;
return 0 ;
}
int F_106 ( void )
{
