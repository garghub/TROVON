void F_1 ( T_1 V_1 , const enum V_2 V_3 ,
char * V_4 , int V_5 )
{
...
L_1 , L_8 , L_9 , L_10 , L_11 , L_12 , L_13
} ;
...
V_14 *= 1000 ;
V_14 /= V_11 [ V_3 ] ;
snprintf ( V_16 , sizeof( V_16 ) , L_14 , V_14 ) ;
V_16 [ V_13 + 1 ] = '\0' ;
}
}
snprintf ( V_4 , V_5 , L_15 , ( T_2 ) V_1 ,
V_16 , V_8 [ V_3 ] [ V_12 ] ) ;
}
...
int F_9 ( char * V_17 , char * V_18 , T_4 V_1 , unsigned int V_23 )
{
char * V_24 = V_18 ;
while ( * V_17 && -- V_1 ) {
...
static int F_10 ( unsigned char V_29 , char * * V_18 , T_4 * V_30 )
{
char * V_24 = * V_18 ;
if ( * V_30 < 1 )
return - V_31 ;
...
static int F_11 ( unsigned char V_29 , char * * V_18 , T_4 * V_30 )
{
char * V_24 = * V_18 ;
unsigned char V_32 ;
if ( * V_30 < 2 )
...
static int F_12 ( unsigned char V_29 , char * * V_18 , T_4 * V_30 )
{
char * V_24 = * V_18 ;
unsigned char V_32 ;
if ( * V_30 < 2 )
...
static int F_13 ( unsigned char V_29 , char * * V_18 , T_4 * V_30 )
{
char * V_24 = * V_18 ;
if ( * V_30 < 2 )
return - V_31 ;
...
static int F_14 ( unsigned char V_29 , char * * V_18 , T_4 * V_30 )
{
char * V_24 = * V_18 ;
if ( * V_30 < 4 )
return - V_31 ;
...
static int F_15 ( unsigned char V_29 , char * * V_18 , T_4 * V_30 )
{
char * V_24 = * V_18 ;
if ( * V_30 < 4 )
return - V_31 ;
...
int F_18 ( const char * V_17 , T_4 V_33 , char * * V_18 , T_4 V_30 ,
