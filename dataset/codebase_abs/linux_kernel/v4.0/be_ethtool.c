...
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_66 ;
struct V_260 * V_300 = & V_6 -> V_260 ;
if ( V_297 ) {
for ( V_66 = 0 ; V_66 < V_295 ; V_66 ++ )
V_297 [ V_66 ] = V_300 -> V_301 [ V_66 ] ;
}
if ( V_298 )
memcpy ( V_298 , V_300 -> V_284 , V_296 ) ;
if ( V_299 )
* V_299 = V_302 ;
return 0 ;
}
static int F_92 ( struct V_1 * V_2 , const T_1 * V_297 ,
const T_2 * V_298 , const T_2 V_299 )
{
int V_303 = 0 , V_66 , V_77 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
T_2 V_280 [ V_295 ] ;
if ( V_299 != V_304 && V_299 != V_302 )
return - V_207 ;
if ( V_297 ) {
struct V_72 * V_73 ;
for ( V_66 = 0 ; V_66 < V_295 ; V_66 ++ ) {
...
V_303 = F_83 ( V_6 , V_280 ,
V_6 -> V_260 . V_261 ,
V_295 , V_298 ) ;
if ( V_303 ) {
V_6 -> V_260 . V_261 = V_305 ;
return - V_40 ;
}
...
if ( V_26 )
goto V_224;
if ( V_245 -> V_83 + V_245 -> V_46 > V_309 ) {
V_26 = F_94 ( V_6 ,
V_315 ,
V_71 +
V_309 ) ;
