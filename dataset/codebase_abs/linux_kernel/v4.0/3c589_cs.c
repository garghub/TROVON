...
static T_5 F_53 ( struct V_101 * V_102 ,
struct V_5 * V_6 )
{
unsigned int V_30 = V_6 -> V_44 ;
...
unsigned long V_13 ;
F_52 ( V_6 , L_24 ,
( long ) V_102 -> V_33 , F_34 ( V_30 + V_51 ) ) ;
F_54 ( & V_8 -> V_10 , V_13 ) ;
V_6 -> V_95 . V_103 += V_102 -> V_33 ;
F_22 ( V_102 -> V_33 , V_30 + V_104 ) ;
F_22 ( 0x00 , V_30 + V_104 ) ;
F_55 ( V_30 + V_104 , V_102 -> V_105 , ( V_102 -> V_33 + 3 ) >> 2 ) ;
if ( F_34 ( V_30 + V_63 ) <= 1536 ) {
F_56 ( V_6 ) ;
F_22 ( V_106 + 1536 , V_30 + V_50 ) ;
}
F_51 ( V_6 ) ;
F_57 ( & V_8 -> V_10 , V_13 ) ;
F_58 ( V_102 ) ;
...
static T_6 V_42 ( int V_43 , void * V_108 )
{
...
F_60 ( & V_4 -> V_10 ) ;
while ( ( V_109 = F_34 ( V_30 + V_51 ) ) &
( V_70 | V_75 | V_76 ) ) {
if ( ( V_109 & 0xe000 ) != 0x2000 ) {
F_52 ( V_6 , L_26 ) ;
V_110 = 0 ;
break;
}
...
static void V_91 ( unsigned long V_116 )
{
...
V_117 = F_38 ( V_30 + 0 ) ;
F_22 ( V_65 , V_30 + V_50 ) ;
V_6 -> V_95 . V_122 += V_117 ;
if ( V_117 || ( V_4 -> V_60 & 0x0010 ) )
V_90 |= 0x0010 ;
}
if ( V_90 != V_4 -> V_60 ) {
...
F_22 ( V_64 , V_30 + V_50 ) ;
F_15 ( 6 ) ;
V_6 -> V_95 . V_122 += F_38 ( V_30 + 0 ) ;
V_6 -> V_95 . V_124 += F_38 ( V_30 + 1 ) ;
F_38 ( V_30 + 2 ) ;
V_6 -> V_95 . V_125 += F_38 ( V_30 + 3 ) ;
V_6 -> V_95 . V_126 += F_38 ( V_30 + 4 ) ;
V_6 -> V_95 . V_127 += F_38 ( V_30 + 5 ) ;
V_6 -> V_95 . V_128 += F_38 ( V_30 + 6 ) ;
F_38 ( V_30 + 7 ) ;
F_38 ( V_30 + 8 ) ;
F_34 ( V_30 + 10 ) ;
F_34 ( V_30 + 12 ) ;
...
F_52 ( V_6 , L_41 ,
F_34 ( V_30 + V_51 ) , F_34 ( V_30 + V_61 ) ) ;
while ( ! ( ( V_130 = F_34 ( V_30 + V_61 ) ) & 0x8000 ) &&
V_129 > 0 ) {
V_129 -- ;
if ( V_130 & 0x4000 ) {
...
struct V_101 * V_102 ;
V_102 = F_71 ( V_6 , V_136 + 5 ) ;
F_52 ( V_6 , L_42 ,
V_136 , V_130 ) ;
if ( V_102 != NULL ) {
F_72 ( V_102 , 2 ) ;
F_73 ( V_30 + V_137 , F_74 ( V_102 , V_136 ) ,
( V_136 + 3 ) >> 2 ) ;
V_102 -> V_138 = F_75 ( V_102 , V_6 ) ;
F_76 ( V_102 ) ;
V_6 -> V_95 . V_139 ++ ;
V_6 -> V_95 . V_140 += V_136 ;
} else {
F_52 ( V_6 , L_43 ,
V_136 ) ;
V_6 -> V_95 . V_141 ++ ;
