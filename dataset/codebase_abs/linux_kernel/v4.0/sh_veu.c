...
struct V_71 * V_76 ;
unsigned int V_153 , V_154 = * V_149 ;
if ( V_61 ) {
const struct V_73 * V_74 = & V_61 -> V_62 . V_74 ;
const struct V_87 * V_62 = F_32 ( V_61 ) ;
struct V_72 V_155 = * V_61 ;
if ( V_62 -> V_2 != V_74 -> V_68 )
return - V_45 ;
F_29 ( & V_155 , V_62 ) ;
if ( V_155 . V_62 . V_74 . V_77 != V_74 -> V_77 ||
V_155 . V_62 . V_74 . V_79 != V_74 -> V_79 )
return - V_45 ;
V_153 = V_74 -> V_83 ? V_74 -> V_83 * V_74 -> V_79 * V_62 -> V_85 / V_62 -> V_86 :
V_74 -> V_77 * V_74 -> V_79 * V_62 -> V_85 / V_62 -> V_86 ;
} else {
V_76 = F_25 ( V_14 , V_105 -> type ) ;
V_153 = V_76 -> V_83 * V_76 -> V_78 . V_79 * V_76 -> V_62 -> V_85 / V_76 -> V_62 -> V_86 ;
}
if ( V_154 < 2 )
* V_149 = V_154 = 2 ;
...
V_151 [ 0 ] = V_153 ;
V_152 [ 0 ] = V_14 -> V_157 ;
F_10 ( V_14 -> V_29 , L_12 , V_154 , V_153 ) ;
return 0 ;
}
static int F_61 ( struct V_20 * V_158 )
{
struct V_13 * V_14 = F_60 ( V_158 -> V_104 ) ;
struct V_71 * V_76 ;
unsigned int V_84 ;
V_76 = F_25 ( V_14 , V_158 -> V_104 -> type ) ;
V_84 = V_76 -> V_83 * V_76 -> V_78 . V_79 *
V_76 -> V_62 -> V_85 / V_76 -> V_62 -> V_86 ;
if ( F_62 ( V_158 , 0 ) < V_84 ) {
F_10 ( V_14 -> V_29 , L_13 ,
V_30 , F_62 ( V_158 , 0 ) , V_84 ) ;
return - V_45 ;
}
F_63 ( V_158 , 0 , V_84 ) ;
return 0 ;
}
static void F_64 ( struct V_20 * V_158 )
{
struct V_13 * V_14 = F_60 ( V_158 -> V_104 ) ;
F_10 ( V_14 -> V_29 , L_11 , V_30 , V_158 -> V_159 . type ) ;
F_65 ( V_14 -> V_36 , V_158 ) ;
}
...
static int F_67 ( struct V_49 * V_49 )
{
struct V_13 * V_14 = F_68 ( V_49 ) ;
struct V_37 * V_38 ;
V_38 = F_69 ( sizeof( * V_38 ) , V_174 ) ;
if ( ! V_38 )
return - V_175 ;
V_38 -> V_75 = V_14 ;
V_38 -> V_108 = true ;
...
static int F_71 ( struct V_49 * V_49 )
{
struct V_13 * V_14 = F_68 ( V_49 ) ;
struct V_37 * V_38 = V_49 -> V_176 ;
F_10 ( V_14 -> V_29 , L_15 , V_38 ) ;
if ( V_38 == V_14 -> V_41 ) {
V_14 -> V_41 = NULL ;
F_72 ( F_38 ( V_14 -> V_36 , V_40 ) ) ;
}
if ( V_38 == V_14 -> V_43 ) {
V_14 -> V_43 = NULL ;
F_72 ( F_38 ( V_14 -> V_36 , V_42 ) ) ;
}
...
static unsigned int F_76 ( struct V_49 * V_49 ,
struct V_177 * V_178 )
{
struct V_37 * V_38 = V_49 -> V_176 ;
return F_77 ( V_49 , V_38 -> V_75 -> V_36 , V_178 ) ;
}
static int F_78 ( struct V_49 * V_49 , struct V_179 * V_180 )
{
struct V_37 * V_38 = V_49 -> V_176 ;
return F_79 ( V_49 , V_38 -> V_75 -> V_36 , V_180 ) ;
}
static T_3 F_80 ( int V_181 , void * V_182 )
{
struct V_13 * V_14 = V_182 ;
if ( V_14 -> V_148 == V_183 || V_14 -> V_19 ) {
F_81 ( V_14 -> V_47 , V_14 -> V_36 ) ;
V_14 -> V_148 = 0 ;
} else {
F_11 ( V_14 ) ;
}
...
static T_3 F_82 ( int V_181 , void * V_182 )
{
struct V_13 * V_14 = V_182 ;
struct V_20 * V_185 ;
struct V_20 * V_186 ;
...
V_185 = F_83 ( V_14 -> V_36 ) ;
V_186 = F_84 ( V_14 -> V_36 ) ;
if ( ! V_186 || ! V_185 )
return V_189 ;
F_85 ( & V_14 -> V_172 ) ;
F_86 ( V_186 , V_190 ) ;
...
struct V_196 * V_197 ;
int V_181 , V_106 ;
V_195 = F_89 ( V_193 , V_198 , 0 ) ;
V_181 = F_90 ( V_193 , 0 ) ;
if ( ! V_195 || V_181 <= 0 ) {
F_91 ( & V_193 -> V_29 , L_16 ) ;
return - V_199 ;
}
V_14 = F_92 ( & V_193 -> V_29 , sizeof( * V_14 ) , V_174 ) ;
if ( ! V_14 )
return - V_175 ;
V_14 -> V_120 = F_93 ( V_195 ) == 0x22c ;
V_14 -> V_16 = F_94 ( & V_193 -> V_29 , V_195 ) ;
if ( F_95 ( V_14 -> V_16 ) )
return F_96 ( V_14 -> V_16 ) ;
V_106 = F_97 ( & V_193 -> V_29 , V_181 , F_82 , F_80 ,
0 , L_17 , V_14 ) ;
if ( V_106 < 0 )
return V_106 ;
V_106 = F_98 ( & V_193 -> V_29 , & V_14 -> V_107 ) ;
if ( V_106 < 0 ) {
F_91 ( & V_193 -> V_29 , L_18 ) ;
return V_106 ;
}
V_197 = & V_14 -> V_197 ;
V_14 -> V_157 = F_99 ( & V_193 -> V_29 ) ;
if ( F_95 ( V_14 -> V_157 ) ) {
V_106 = F_96 ( V_14 -> V_157 ) ;
goto V_200;
}
* V_197 = V_201 ;
V_197 -> V_107 = & V_14 -> V_107 ;
F_100 ( & V_14 -> V_172 ) ;
F_101 ( & V_14 -> V_173 ) ;
V_197 -> V_172 = & V_14 -> V_173 ;
F_102 ( V_197 , V_14 ) ;
V_14 -> V_29 = & V_193 -> V_29 ;
V_14 -> V_25 = V_202 ;
V_14 -> V_32 = V_203 ;
V_14 -> V_47 = F_103 ( & V_204 ) ;
if ( F_95 ( V_14 -> V_47 ) ) {
V_106 = F_96 ( V_14 -> V_47 ) ;
F_40 ( & V_14 -> V_107 , L_19 , V_106 ) ;
goto V_205;
}
F_104 ( & V_193 -> V_29 ) ;
F_105 ( & V_193 -> V_29 ) ;
V_106 = F_106 ( V_197 , V_206 , - 1 ) ;
F_107 ( & V_193 -> V_29 ) ;
if ( V_106 < 0 )
goto V_207;
return V_106 ;
...
{
struct V_208 * V_107 = F_113 ( V_193 ) ;
struct V_13 * V_14 = F_114 ( V_107 ,
struct V_13 , V_107 ) ;
F_115 ( & V_14 -> V_197 ) ;
F_108 ( & V_193 -> V_29 ) ;
F_109 ( V_14 -> V_47 ) ;
