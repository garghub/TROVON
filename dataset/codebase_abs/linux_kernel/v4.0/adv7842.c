...
V_143 += 128 ;
V_144 += 128 ;
F_51 ( 1 , V_52 , V_10 , L_35 , V_139 , V_140 , V_141 ) ;
F_51 ( 1 , V_52 , V_10 , L_36 , V_142 , V_143 , V_144 ) ;
F_46 ( V_10 , 0xc1 , V_139 ) ;
F_46 ( V_10 , 0xc0 , V_140 ) ;
F_46 ( V_10 , 0xc2 , V_141 ) ;
F_32 ( V_10 , 0xde , V_142 ) ;
F_32 ( V_10 , 0xdf , ( V_144 & 0xf0 ) | ( ( V_143 >> 4 ) & 0x0f ) ) ;
return 0 ;
}
case V_145 :
...
static int F_80 ( struct V_9 * V_10 , T_3 * V_146 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
* V_146 = 0 ;
...
V_89 ) )
return 0 ;
if ( F_84 ( V_151 -> V_156 + 1 , V_152 , V_151 -> V_157 ,
( V_151 -> V_158 == '+' ? V_159 : 0 ) |
( V_151 -> V_160 == '+' ? V_161 : 0 ) ,
V_40 -> V_162 , V_89 ) )
return 0 ;
...
static int F_85 ( struct V_9 * V_10 , struct V_150 * V_151 )
{
T_3 V_146 ;
F_80 ( V_10 , & V_146 ) ;
if ( V_146 & V_149 ) {
...
V_151 -> V_153 = ( ( F_45 ( V_10 , 0xb1 ) & 0x3f ) << 8 ) | F_45 ( V_10 , 0xb2 ) ;
V_151 -> V_156 = ( ( F_45 ( V_10 , 0xb3 ) & 0x7 ) << 8 ) | F_45 ( V_10 , 0xb4 ) ;
V_151 -> V_157 = F_45 ( V_10 , 0xb3 ) >> 3 ;
if ( ( F_45 ( V_10 , 0xb5 ) & 0x80 ) && ( ( F_45 ( V_10 , 0xb5 ) & 0x03 ) == 0x01 ) ) {
V_151 -> V_158 = ( ( F_45 ( V_10 , 0xb5 ) & 0x10 ) ?
( ( F_45 ( V_10 , 0xb5 ) & 0x08 ) ? '+' : '-' ) : 'x' ) ;
V_151 -> V_160 = ( ( F_45 ( V_10 , 0xb5 ) & 0x40 ) ?
( ( F_45 ( V_10 , 0xb5 ) & 0x20 ) ? '+' : '-' ) : 'x' ) ;
} else {
V_151 -> V_158 = 'x' ;
V_151 -> V_160 = 'x' ;
}
V_151 -> V_164 = ( F_45 ( V_10 , 0xb1 ) & 0x40 ) ? true : false ;
...
V_172 = ( ( F_42 ( V_10 , 0x51 ) << 1 ) + ( F_42 ( V_10 , 0x52 ) >> 7 ) ) * 1000000 ;
V_172 += ( ( F_42 ( V_10 , 0x52 ) & 0x7f ) * 7813 ) ;
if ( F_79 ( V_10 ) ) {
V_172 = V_172 * 8 / ( ( ( F_42 ( V_10 , 0x0b ) & 0xc0 ) >> 6 ) * 2 + 8 ) ;
}
V_6 -> V_108 = V_172 ;
...
F_42 ( V_10 , 0x33 ) ) / 2 ;
V_6 -> V_174 = ( ( F_42 ( V_10 , 0x05 ) & 0x10 ) ? V_161 : 0 ) |
( ( F_42 ( V_10 , 0x05 ) & 0x20 ) ? V_159 : 0 ) ;
if ( V_6 -> V_164 == V_170 ) {
V_6 -> V_96 += ( F_42 ( V_10 , 0x0b ) & 0x0f ) * 256 +
F_42 ( V_10 , 0x0c ) ;
V_6 -> V_175 = ( ( F_42 ( V_10 , 0x2c ) & 0x1f ) * 256 +
F_42 ( V_10 , 0x2d ) ) / 2 ;
V_6 -> V_176 = ( ( F_42 ( V_10 , 0x30 ) & 0x1f ) * 256 +
F_42 ( V_10 , 0x31 ) ) / 2 ;
V_6 -> V_177 = ( ( F_42 ( V_10 , 0x34 ) & 0x1f ) * 256 +
F_42 ( V_10 , 0x35 ) ) / 2 ;
}
F_89 ( V_10 , V_89 ) ;
} else {
if ( ! F_81 ( V_10 , & V_151 , V_89 ) )
goto V_178;
V_151 . V_157 += 1 ;
F_51 ( 1 , V_52 , V_10 , L_46 , V_53 , V_151 . V_157 ) ;
if ( ! F_81 ( V_10 , & V_151 , V_89 ) )
goto V_178;
V_151 . V_157 -= 2 ;
F_51 ( 1 , V_52 , V_10 , L_47 , V_53 , V_151 . V_157 ) ;
if ( F_81 ( V_10 , & V_151 , V_89 ) ) {
if ( V_40 -> V_169 ) {
...
F_89 ( V_10 , V_89 ) ;
V_40 -> V_89 = * V_89 ;
F_46 ( V_10 , 0x91 , V_6 -> V_164 ? 0x40 : 0x00 ) ;
V_30 = F_70 ( V_10 , V_89 ) ;
if ( V_30 ) {
F_71 ( V_10 , V_6 ) ;
}
...
{
F_30 ( V_10 , 0xe0 , 0xbf , V_182 -> V_183 ? 0x00 : 0x40 ) ;
if ( ! V_182 -> V_183 )
return;
F_30 ( V_10 , 0xe0 , 0x7f , V_182 -> V_184 == 2 ? 0x80 : 0x00 ) ;
F_30 ( V_10 , 0xe0 , 0xe0 , V_182 -> V_185 >> 8 ) ;
F_29 ( V_10 , 0xe1 , V_182 -> V_185 ) ;
F_30 ( V_10 , 0xe2 , 0xe0 , V_182 -> V_186 >> 8 ) ;
F_29 ( V_10 , 0xe3 , V_182 -> V_186 ) ;
F_30 ( V_10 , 0xe4 , 0xe0 , V_182 -> V_187 >> 8 ) ;
F_29 ( V_10 , 0xe5 , V_182 -> V_187 ) ;
F_30 ( V_10 , 0xe6 , 0x80 , V_182 -> V_188 >> 8 ) ;
F_29 ( V_10 , 0xe7 , V_182 -> V_188 ) ;
F_30 ( V_10 , 0xe8 , 0xe0 , V_182 -> V_189 >> 8 ) ;
F_29 ( V_10 , 0xe9 , V_182 -> V_189 ) ;
F_30 ( V_10 , 0xea , 0xe0 , V_182 -> V_190 >> 8 ) ;
F_29 ( V_10 , 0xeb , V_182 -> V_190 ) ;
F_30 ( V_10 , 0xec , 0xe0 , V_182 -> V_191 >> 8 ) ;
F_29 ( V_10 , 0xed , V_182 -> V_191 ) ;
F_30 ( V_10 , 0xee , 0x80 , V_182 -> V_192 >> 8 ) ;
F_29 ( V_10 , 0xef , V_182 -> V_192 ) ;
F_30 ( V_10 , 0xf0 , 0xe0 , V_182 -> V_193 >> 8 ) ;
F_29 ( V_10 , 0xf1 , V_182 -> V_193 ) ;
F_30 ( V_10 , 0xf2 , 0xe0 , V_182 -> V_194 >> 8 ) ;
F_29 ( V_10 , 0xf3 , V_182 -> V_194 ) ;
F_30 ( V_10 , 0xf4 , 0xe0 , V_182 -> V_195 >> 8 ) ;
F_29 ( V_10 , 0xf5 , V_182 -> V_195 ) ;
F_30 ( V_10 , 0xf6 , 0x80 , V_182 -> V_196 >> 8 ) ;
F_29 ( V_10 , 0xf7 , V_182 -> V_196 ) ;
}
...
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_51 ( 2 , V_52 , V_10 , L_53 , V_53 , V_201 ) ;
switch ( V_201 ) {
case V_204 :
V_40 -> V_54 = V_57 ;
V_40 -> V_198 = V_205 ;
...
F_96 ( V_10 ) ;
F_99 ( V_10 , V_40 -> V_198 ) ;
F_95 ( V_10 ) ;
F_101 ( V_10 , V_213 , NULL ) ;
return 0 ;
}
static int F_102 ( struct V_9 * V_10 , unsigned int V_214 ,
T_3 * V_215 )
{
if ( V_214 )
return - V_75 ;
...
static int F_105 ( struct V_9 * V_10 , T_3 V_146 , bool * V_227 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
...
V_40 -> V_162 = F_108 ( V_237 -> V_71 [ 0x15 ] ,
V_237 -> V_71 [ 0x16 ] ) ;
switch ( V_237 -> V_166 ) {
case V_234 :
...
V_30 = F_61 ( V_10 , V_237 -> V_166 ) ;
break;
default:
return - V_75 ;
}
if ( V_30 < 0 )
F_72 ( V_10 , L_60 , V_30 , V_237 -> V_166 ) ;
return V_30 ;
}
...
T_5 V_153 = ( ( F_45 ( V_10 , 0xb1 ) & 0x3f ) << 8 ) | F_45 ( V_10 , 0xb2 ) ;
T_5 V_156 = ( ( F_45 ( V_10 , 0xb3 ) & 0x7 ) << 8 ) | F_45 ( V_10 , 0xb4 ) ;
T_5 V_157 = F_45 ( V_10 , 0xb3 ) >> 3 ;
T_5 V_264 = ( ( F_45 ( V_10 , 0xb8 ) & 0x1f ) << 8 ) | F_45 ( V_10 , 0xb9 ) ;
char V_158 = ( ( F_45 ( V_10 , 0xb5 ) & 0x10 ) ?
( ( F_45 ( V_10 , 0xb5 ) & 0x08 ) ? '+' : '-' ) : 'x' ) ;
char V_160 = ( ( F_45 ( V_10 , 0xb5 ) & 0x40 ) ?
( ( F_45 ( V_10 , 0xb5 ) & 0x20 ) ? '+' : '-' ) : 'x' ) ;
F_63 ( V_10 ,
L_146 ,
V_156 , V_153 , V_157 , V_264 ,
( F_45 ( V_10 , 0xb1 ) & 0x40 ) ?
L_43 : L_44 ,
V_158 , V_160 ) ;
}
...
F_92 ( V_10 -> V_180 , L_148 ,
& V_89 , true ) ;
F_92 ( V_10 -> V_180 , L_149 ,
& V_40 -> V_89 , true ) ;
if ( F_78 ( V_10 ) )
return 0 ;
F_63 ( V_10 , L_150 ) ;
...
static int F_119 ( struct V_9 * V_10 , T_7 V_221 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
...
F_142 ( & V_40 -> V_65 ,
F_56 ) ;
V_40 -> V_166 . V_23 = V_357 ;
V_30 = F_143 ( & V_10 -> V_358 , 1 , & V_40 -> V_166 , 0 ) ;
if ( V_30 )
goto V_359;
V_30 = F_121 ( V_10 ) ;
if ( V_30 )
goto V_360;
F_63 ( V_10 , L_202 , V_16 -> V_180 ,
