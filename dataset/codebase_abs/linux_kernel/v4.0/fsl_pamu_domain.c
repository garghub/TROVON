...
{
struct V_10 * V_26 = & V_7 -> V_12 [ 0 ] ;
int V_27 , V_28 ;
unsigned long V_29 , V_30 ;
for ( V_27 = 0 ; V_27 < V_7 -> V_9 ; V_27 ++ ) {
if ( V_26 [ V_27 ] . V_22 ) {
V_29 = V_26 [ V_27 ] . V_23 >> V_31 ;
F_8 ( & V_32 , V_30 ) ;
...
static void F_27 ( struct V_6 * V_51 , T_4 V_9 )
{
unsigned long V_30 ;
F_28 ( & V_51 -> V_52 ) ;
F_8 ( & V_32 , V_30 ) ;
...
{
struct V_6 * V_51 , * V_56 ;
unsigned long V_30 ;
F_8 ( & V_53 , V_30 ) ;
V_56 = V_41 -> V_54 . V_15 ;
if ( V_56 && V_56 -> V_47 != V_7 ) {
F_10 ( & V_53 , V_30 ) ;
F_31 ( V_41 , V_56 -> V_47 ) ;
F_8 ( & V_53 , V_30 ) ;
}
...
V_51 -> V_25 = V_25 ;
V_51 -> V_47 = V_7 ;
F_34 ( & V_51 -> V_52 , & V_7 -> V_49 ) ;
if ( ! V_41 -> V_54 . V_15 )
V_41 -> V_54 . V_15 = V_51 ;
F_10 ( & V_53 , V_30 ) ;
}
static T_2 F_35 ( struct V_15 * V_47 ,
T_3 V_8 )
{
struct V_2 * V_7 = V_47 -> V_58 ;
if ( V_8 < V_47 -> V_16 . V_21 ||
V_8 > V_47 -> V_16 . V_59 )
return 0 ;
return F_5 ( V_7 , V_8 ) ;
}
static bool F_36 ( enum V_60 V_61 )
{
return V_61 == V_62 ;
}
static void F_37 ( struct V_15 * V_47 )
{
struct V_2 * V_7 = V_47 -> V_58 ;
V_47 -> V_58 = NULL ;
F_31 ( NULL , V_7 ) ;
...
static int F_38 ( struct V_15 * V_47 )
{
struct V_2 * V_7 ;
V_7 = F_22 () ;
if ( ! V_7 ) {
...
V_28 = F_17 ( V_51 -> V_25 , V_51 -> V_41 , V_7 ,
V_42 , V_9 ) ;
if ( V_28 )
break;
}
...
V_28 = F_20 ( V_51 -> V_25 , V_37 ) ;
}
}
return V_28 ;
}
static void F_44 ( struct V_15 * V_47 , T_4 V_37 )
{
struct V_2 * V_7 = V_47 -> V_58 ;
unsigned long V_30 ;
int V_28 ;
...
static int F_45 ( struct V_15 * V_47 , T_4 V_37 ,
...
static int F_47 ( struct V_15 * V_47 ,
struct V_40 * V_41 )
{
struct V_2 * V_7 = V_47 -> V_58 ;
const T_4 * V_25 ;
...
static void F_52 ( struct V_15 * V_47 ,
struct V_40 * V_41 )
{
struct V_2 * V_7 = V_47 -> V_58 ;
const T_4 * V_86 ;
...
static int F_53 ( struct V_15 * V_47 , void * V_87 )
{
struct V_13 * V_42 = V_87 ;
struct V_2 * V_7 = V_47 -> V_58 ;
T_3 V_17 ;
unsigned long V_30 ;
V_17 = V_42 -> V_59 - V_42 -> V_21 + 1 ;
...
static int F_58 ( struct V_15 * V_47 ,
...
static int F_59 ( struct V_15 * V_47 ,
enum V_94 V_95 , void * V_87 )
{
struct V_2 * V_7 = V_47 -> V_58 ;
int V_28 = 0 ;
...
static int F_76 ( struct V_15 * V_47 , T_4 V_109 )
{
struct V_2 * V_7 = V_47 -> V_58 ;
unsigned long V_30 ;
int V_28 ;
...
static T_4 F_80 ( struct V_15 * V_47 )
{
struct V_2 * V_7 = V_47 -> V_58 ;
return V_7 -> V_9 ;
}
