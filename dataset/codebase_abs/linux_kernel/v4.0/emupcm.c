...
int V_5 ( struct V_1 * V_2 , int V_245 )
{
struct V_246 * V_247 ;
struct V_12 * V_7 ;
int V_23 ;
if ( ( V_23 = F_89 ( V_2 -> V_171 , L_2 , V_245 , 32 , 1 , & V_247 ) ) < 0 )
return V_23 ;
V_247 -> V_15 = V_2 ;
...
struct V_12 * V_7 ;
int V_23 ;
if ( ( V_23 = F_89 ( V_2 -> V_171 , L_2 , V_245 , 1 , 0 , & V_247 ) ) < 0 )
return V_23 ;
V_247 -> V_15 = V_2 ;
...
struct V_246 * V_247 ;
int V_23 ;
if ( ( V_23 = F_89 ( V_2 -> V_171 , L_5 , V_245 , 0 , 1 , & V_247 ) ) < 0 )
return V_23 ;
V_247 -> V_15 = V_2 ;
...
static int F_96 ( struct V_175 * V_265 , struct V_266 * V_267 )
{
...
static int F_98 ( struct V_175 * V_265 , struct V_273 * V_274 )
{
struct V_1 * V_2 = F_97 ( V_265 ) ;
int V_230 = V_2 -> V_78 ? 64 : 32 ;
int V_121 ;
F_86 ( & V_2 -> V_73 ) ;
for ( V_121 = 0 ; V_121 < V_230 ; V_121 ++ )
V_274 -> V_270 . integer . V_270 [ V_121 ] = ( V_2 -> V_243 [ V_121 / 32 ] & ( 1 << ( V_121 % 32 ) ) ) ? 1 : 0 ;
F_87 ( & V_2 -> V_73 ) ;
return 0 ;
}
static int F_99 ( struct V_175 * V_265 , struct V_273 * V_274 )
{
struct V_1 * V_2 = F_97 ( V_265 ) ;
...
int V_278 , V_121 ;
V_275 [ 0 ] = V_275 [ 1 ] = 0 ;
for ( V_121 = 0 , V_276 = 0 ; V_121 < V_230 ; V_121 ++ )
...
struct V_286 * V_247 = & V_2 -> V_287 . V_247 [ V_7 -> V_20 ] ;
V_14 -> V_194 = V_320 ;
V_14 -> V_194 . V_228 = V_14 -> V_194 . V_240 = V_247 -> V_71 ;
V_14 -> V_194 . V_321 = ( V_247 -> V_21 * 2 ) / 2 ;
F_86 ( & V_2 -> V_73 ) ;
if ( V_247 -> V_322 == 0 ) {
F_87 ( & V_2 -> V_73 ) ;
return - V_323 ;
...
struct V_175 * V_176 ;
int V_23 ;
if ( ( V_23 = F_89 ( V_2 -> V_171 , L_7 , V_245 , 8 , 1 , & V_247 ) ) < 0 )
return V_23 ;
V_247 -> V_15 = V_2 ;
