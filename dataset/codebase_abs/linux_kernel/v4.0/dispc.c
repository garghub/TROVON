...
T_2 V_394 , V_2 ;
V_394 = ( 1 << 0 ) | ( 1 << 3 ) | ( 1 << 6 ) ;
V_2 = ( V_385 << 0 ) | ( V_386 << 3 ) | ( V_384 << 6 ) ;
V_394 <<= 16 + V_104 [ V_6 ] ;
V_2 <<= 16 + V_104 [ V_6 ] ;
F_234 ( V_3 . V_393 , V_3 . V_395 ,
V_394 , V_2 ) ;
}
}
...
V_396 = V_270 . V_276 + V_270 . V_277 + V_270 . V_278 + V_270 . V_279 ;
V_397 = V_270 . V_320 + V_270 . V_367 + V_270 . V_366 + V_270 . V_368 ;
V_398 = V_307 -> V_374 / V_396 ;
V_399 = V_307 -> V_374 / V_396 / V_397 ;
...
F_82 ( V_401 < 1 ) ;
F_1 ( F_237 ( V_6 ) ,
F_90 ( V_400 , 23 , 16 ) | F_90 ( V_401 , 7 , 0 ) ) ;
if ( F_12 ( V_38 ) == false &&
V_6 == V_140 )
...
T_2 V_242 ;
V_242 = F_3 ( F_237 ( V_6 ) ) ;
* V_400 = F_124 ( V_242 , 23 , 16 ) ;
* V_401 = F_124 ( V_242 , 7 , 0 ) ;
}
...
static void F_245 ( struct V_413 * V_414 , enum V_5 V_6 )
{
int V_410 , V_411 ;
enum V_415 V_416 ;
F_246 ( V_414 , L_48 , V_11 [ V_6 ] . V_53 ) ;
V_416 = F_243 ( V_6 ) ;
F_246 ( V_414 , L_49 , V_11 [ V_6 ] . V_53 ,
F_247 ( V_416 ) ,
F_248 ( V_416 ) ) ;
F_239 ( V_6 , & V_410 , & V_411 ) ;
F_246 ( V_414 , L_50 ,
F_196 ( V_6 ) , V_410 ) ;
F_246 ( V_414 , L_51 ,
F_195 ( V_6 ) , V_411 ) ;
}
void F_249 ( struct V_413 * V_414 )
{
int V_410 ;
T_2 V_242 ;
enum V_415 V_417 = F_240 () ;
if ( F_59 () )
return;
F_246 ( V_414 , L_52 ) ;
F_246 ( V_414 , L_53 ,
...
static void F_250 ( struct V_413 * V_414 )
{
int V_16 , V_17 ;
const char * V_419 [] = {
[ V_140 ] = L_56 ,
...
int F_253 ( unsigned long F_238 ,
struct V_441 * V_407 )
{
if ( V_407 -> V_400 > 255 || V_407 -> V_400 == 0 )
return - V_280 ;
if ( V_407 -> V_401 < 1 || V_407 -> V_401 > 255 )
return - V_280 ;
V_407 -> V_442 = F_238 / V_407 -> V_400 ;
V_407 -> V_443 = V_407 -> V_442 / V_407 -> V_401 ;
return 0 ;
}
bool F_254 ( unsigned long V_3 ,
unsigned long V_444 , unsigned long V_445 ,
T_9 V_446 , void * V_447 )
{
int V_448 , V_449 , V_450 ;
int V_451 , V_452 , V_453 ;
unsigned long V_443 , V_442 ;
unsigned long V_454 ;
...
V_454 = F_187 ( V_460 ) ;
V_444 = V_444 ? V_444 : 1 ;
V_445 = V_445 ? V_445 : V_461 ;
V_449 = F_179 ( F_177 ( V_3 , V_454 ) , 1ul ) ;
V_450 = F_150 ( V_3 / V_444 , 255ul ) ;
for ( V_448 = V_449 ; V_448 <= V_450 ; ++ V_448 ) {
V_442 = V_3 / V_448 ;
V_452 = F_179 ( F_177 ( V_442 , V_445 ) , V_455 ) ;
V_453 = F_150 ( V_442 / V_444 , V_456 ) ;
for ( V_451 = V_452 ; V_451 <= V_453 ; ++ V_451 ) {
V_443 = V_442 / V_451 ;
if ( F_12 ( V_38 ) )
V_458 = F_188 () ;
else
V_458 = V_442 ;
if ( V_458 < V_443 * V_457 )
continue;
if ( V_446 ( V_448 , V_451 , V_442 , V_443 , V_447 ) )
return true ;
}
}
return false ;
...
const struct V_441 * V_407 )
{
F_10 ( L_64 , V_407 -> V_442 , V_407 -> V_400 ) ;
F_10 ( L_65 , V_407 -> V_443 , V_407 -> V_401 ) ;
F_236 ( V_6 , V_407 -> V_400 , V_407 -> V_401 ) ;
}
...
unsigned long V_458 ;
V_458 = F_238 () ;
V_407 -> V_400 = F_6 ( F_237 ( V_6 ) , 23 , 16 ) ;
V_407 -> V_401 = F_6 ( F_237 ( V_6 ) , 7 , 0 ) ;
V_407 -> V_442 = V_458 / V_407 -> V_400 ;
V_407 -> V_443 = V_407 -> V_442 / V_407 -> V_401 ;
return 0 ;
}
T_2 F_258 ( void )
...
void F_260 ( T_2 V_394 )
{
T_2 V_462 = F_3 ( V_426 ) ;
F_58 ( ( V_394 ^ V_462 ) & V_394 ) ;
F_1 ( V_426 , V_394 ) ;
}
void F_261 ( void )
{
...
static int T_10 F_264 ( struct V_467 * V_43 )
{
const struct V_468 * V_469 ;
struct V_468 * V_470 ;
V_470 = F_265 ( & V_43 -> V_44 , sizeof( * V_470 ) , V_471 ) ;
if ( ! V_470 ) {
F_266 ( & V_43 -> V_44 , L_66 ) ;
return - V_472 ;
}
switch ( F_267 () ) {
case V_473 :
...
memcpy ( V_470 , V_469 , sizeof( * V_470 ) ) ;
V_3 . V_47 = V_470 ;
return 0 ;
}
static T_11 F_268 ( int V_490 , void * V_491 )
{
if ( ! V_3 . V_492 )
return V_493 ;
return V_3 . V_494 ( V_490 , V_3 . V_495 ) ;
}
int F_269 ( T_12 V_496 , void * V_497 )
{
int V_42 ;
if ( V_3 . V_494 != NULL )
return - V_498 ;
...
V_3 . V_495 = V_497 ;
F_270 () ;
V_42 = F_271 ( & V_3 . V_43 -> V_44 , V_3 . V_490 , F_268 ,
V_499 , L_67 , & V_3 ) ;
if ( V_42 ) {
V_3 . V_494 = NULL ;
V_3 . V_495 = NULL ;
...
void F_272 ( void * V_497 )
{
F_273 ( & V_3 . V_43 -> V_44 , V_3 . V_490 , & V_3 ) ;
V_3 . V_494 = NULL ;
V_3 . V_495 = NULL ;
}
static int T_10 F_274 ( struct V_467 * V_43 )
{
T_2 V_500 ;
int V_42 = 0 ;
struct V_501 * V_502 ;
struct V_503 * V_504 = V_43 -> V_44 . V_505 ;
V_3 . V_43 = V_43 ;
V_42 = F_264 ( V_3 . V_43 ) ;
if ( V_42 )
return V_42 ;
V_502 = F_275 ( V_3 . V_43 , V_506 , 0 ) ;
if ( ! V_502 ) {
F_74 ( L_68 ) ;
return - V_280 ;
}
V_3 . V_4 = F_276 ( & V_43 -> V_44 , V_502 -> V_169 ,
F_277 ( V_502 ) ) ;
if ( ! V_3 . V_4 ) {
F_74 ( L_69 ) ;
return - V_472 ;
}
V_3 . V_490 = F_278 ( V_3 . V_43 , 0 ) ;
if ( V_3 . V_490 < 0 ) {
F_74 ( L_70 ) ;
return - V_489 ;
}
if ( V_504 && F_279 ( V_504 , L_71 ) ) {
V_3 . V_393 = F_280 ( V_504 , L_71 ) ;
if ( F_281 ( V_3 . V_393 ) ) {
F_266 ( & V_43 -> V_44 , L_72 ) ;
return F_282 ( V_3 . V_393 ) ;
}
if ( F_283 ( V_504 , L_71 , 1 ,
& V_3 . V_395 ) ) {
F_266 ( & V_43 -> V_44 , L_73 ) ;
return - V_280 ;
}
}
F_284 ( & V_43 -> V_44 ) ;
...
F_263 () ;
V_500 = F_3 ( V_422 ) ;
F_285 ( & V_43 -> V_44 , L_74 ,
F_124 ( V_500 , 7 , 4 ) , F_124 ( V_500 , 3 , 0 ) ) ;
F_62 () ;
F_286 () ;
F_287 ( L_75 , F_250 ) ;
return 0 ;
...
static int T_13 F_289 ( struct V_467 * V_43 )
{
F_288 ( & V_43 -> V_44 ) ;
F_290 () ;
return 0 ;
}
static int F_291 ( struct V_508 * V_44 )
{
V_3 . V_492 = false ;
F_270 () ;
F_292 ( V_3 . V_490 ) ;
...
static int F_293 ( struct V_508 * V_44 )
{
if ( F_6 ( V_148 , 2 , 1 ) != V_464 ) {
F_263 () ;
F_56 () ;
}
V_3 . V_492 = true ;
...
int T_10 F_294 ( void )
{
return F_295 ( & V_509 , F_274 ) ;
}
void T_13 F_296 ( void )
{
F_297 ( & V_509 ) ;
}
