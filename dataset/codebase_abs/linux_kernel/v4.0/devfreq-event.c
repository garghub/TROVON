...
F_2 ( & V_30 ) ;
F_14 (edev, &devfreq_event_list, node) {
if ( ! strcmp ( V_2 -> V_4 -> V_31 , V_26 -> V_31 ) )
goto V_32;
}
V_2 = NULL ;
V_32:
...
{
struct V_1 * * V_47 , * V_2 ;
V_47 = F_39 ( F_37 , sizeof( * V_47 ) , V_37 ) ;
if ( ! V_47 )
return F_12 ( - V_38 ) ;
V_2 = F_21 ( V_11 , V_4 ) ;
if ( F_40 ( V_2 ) ) {
...
if ( ! V_2 || ! V_2 -> V_4 )
return - V_5 ;
return sprintf ( V_50 , L_8 , V_2 -> V_4 -> V_31 ) ;
}
...
if ( ! V_2 || ! V_2 -> V_4 )
return - V_5 ;
return sprintf ( V_50 , L_9 , V_2 -> V_9 ) ;
}
