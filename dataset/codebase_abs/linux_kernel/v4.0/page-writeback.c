...
int F_145 ( struct V_198 * V_198 )
{
if ( ! F_138 ( V_198 ) ) {
struct V_125 * V_126 = F_146 ( V_198 ) ;
unsigned long V_27 ;
if ( ! V_126 )
return 1 ;
F_147 ( & V_126 -> V_171 , V_27 ) ;
F_122 ( F_146 ( V_198 ) != V_126 ) ;
F_112 ( ! F_148 ( V_198 ) && ! F_149 ( V_198 ) ) ;
F_139 ( V_198 , V_126 ) ;
F_150 ( & V_126 -> V_172 , F_151 ( V_198 ) ,
V_173 ) ;
F_152 ( & V_126 -> V_171 , V_27 ) ;
if ( V_126 -> V_132 ) {
F_153 ( V_126 -> V_132 , V_211 ) ;
}
return 1 ;
}
return 0 ;
}
void F_154 ( struct V_198 * V_198 )
{
struct V_125 * V_126 = V_198 -> V_126 ;
if ( V_126 && F_141 ( V_126 ) ) {
V_26 -> V_136 -- ;
F_155 ( V_198 , V_209 ) ;
F_156 ( F_77 ( V_126 -> V_132 ) , V_109 ) ;
}
}
int F_157 ( struct V_175 * V_176 , struct V_198 * V_198 )
{
int V_40 ;
V_176 -> V_212 ++ ;
V_40 = F_145 ( V_198 ) ;
...
int F_158 ( struct V_198 * V_198 )
{
struct V_125 * V_126 = F_146 ( V_198 ) ;
if ( F_159 ( V_126 ) ) {
int (* F_160)( struct V_198 * ) = V_126 -> V_203 -> F_158 ;
F_161 ( V_198 ) ;
#ifdef F_162
if ( ! F_160 )
F_160 = V_213 ;
...
int F_175 ( struct V_198 * V_198 , bool V_219 )
{
struct V_125 * V_126 = F_146 ( V_198 ) ;
struct V_214 * V_215 ;
int V_40 ;
...
int F_178 ( struct V_125 * V_126 , int V_186 )
{
return F_179 ( & V_126 -> V_172 , V_186 ) ;
}
void F_180 ( struct V_198 * V_198 )
{
if ( F_181 ( F_77 ( V_198 -> V_126 -> V_132 ) ) )
F_121 ( V_198 ) ;
}
