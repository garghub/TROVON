...
V_50 = & V_16 -> V_60 ;
V_54 = F_33 ( V_39 , V_50 , V_5 -> V_61 , & V_56 , V_62 ) ;
if ( F_25 ( V_54 ) ) {
V_43 = F_34 ( V_54 ) ;
goto error;
}
V_58 = V_50 -> V_63 & V_64 ? F_27 ( V_65 ) : 0 ;
V_52 = F_35 ( V_39 , V_5 , 1 , V_66 , true ) ;
F_5 ( V_50 -> V_6 , V_7 ) ;
V_5 -> V_67 = 1 ;
if ( V_50 -> V_63 & V_21 ) {
V_57 = ( T_5 * ) V_16 -> V_30 ;
...
V_43 = F_36 ( V_1 -> V_11 , V_54 , V_5 , V_56 . V_69 ,
V_50 -> V_70 , V_50 -> V_71 ,
V_50 -> V_72 , V_58 , V_52 , V_51 ,
V_50 -> V_63 , V_7 , V_14 , V_57 ,
...
static int F_40 ( struct V_2 * V_2 , struct V_4 * V_5 ,
struct V_15 * V_59 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
struct V_39 * V_39 = F_20 ( V_2 -> V_40 ) ;
T_3 V_51 = F_13 ( V_1 -> V_11 -> V_33 -> V_32 ) -> V_35 ;
T_3 V_52 = F_35 ( V_39 , V_5 , 1 , V_66 , true ) ;
return F_41 ( V_59 ,
F_20 ( V_2 -> V_40 ) ,
F_31 ( V_5 ) -> V_59 ,
V_62 , V_5 -> V_61 , V_52 , V_51 ) ;
}
