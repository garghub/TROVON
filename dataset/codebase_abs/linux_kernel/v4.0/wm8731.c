...
static int F_24 ( struct V_37 * V_49 ,
unsigned int V_58 )
{
struct V_5 * V_6 = V_49 -> V_6 ;
T_1 V_39 = 0 ;
...
V_21 = F_33 ( V_6 -> V_2 , F_5 ( V_8 -> V_80 ) ,
V_8 -> V_80 ) ;
if ( V_21 != 0 ) {
F_34 ( V_6 -> V_2 , L_2 , V_21 ) ;
return V_21 ;
}
V_21 = F_26 ( F_5 ( V_8 -> V_80 ) ,
V_8 -> V_80 ) ;
if ( V_21 != 0 ) {
F_34 ( V_6 -> V_2 , L_3 , V_21 ) ;
return V_21 ;
}
V_21 = F_35 ( V_6 ) ;
if ( V_21 < 0 ) {
F_34 ( V_6 -> V_2 , L_4 , V_21 ) ;
goto V_87;
}
F_25 ( V_6 , V_77 ) ;
...
struct V_7 * V_8 ;
int V_21 ;
V_8 = F_38 ( & V_94 -> V_2 , sizeof( * V_8 ) , V_95 ) ;
if ( V_8 == NULL )
return - V_96 ;
F_39 ( & V_8 -> V_23 ) ;
V_8 -> V_81 = F_40 ( V_94 , & V_97 ) ;
if ( F_41 ( V_8 -> V_81 ) ) {
V_21 = F_42 ( V_8 -> V_81 ) ;
F_34 ( & V_94 -> V_2 , L_5 ,
V_21 ) ;
...
struct V_7 * V_8 ;
int V_21 ;
V_8 = F_38 ( & V_101 -> V_2 , sizeof( struct V_7 ) ,
V_95 ) ;
if ( V_8 == NULL )
return - V_96 ;
F_39 ( & V_8 -> V_23 ) ;
V_8 -> V_81 = F_48 ( V_101 , & V_97 ) ;
if ( F_41 ( V_8 -> V_81 ) ) {
V_21 = F_42 ( V_8 -> V_81 ) ;
F_34 ( & V_101 -> V_2 , L_5 ,
V_21 ) ;
...
& V_98 , & V_99 , 1 ) ;
if ( V_21 != 0 ) {
F_34 ( & V_101 -> V_2 , L_6 , V_21 ) ;
return V_21 ;
}
return 0 ;
}
static int F_50 ( struct V_100 * V_104 )
{
F_46 ( & V_104 -> V_2 ) ;
return 0 ;
}
