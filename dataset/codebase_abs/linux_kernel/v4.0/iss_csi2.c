...
static struct V_31 *
F_55 ( struct V_1 * V_2 , struct V_214 * V_215 ,
unsigned int V_169 , enum V_216 V_217 )
{
if ( V_217 == V_218 )
return F_56 ( V_215 , V_169 ) ;
return & V_2 -> V_33 [ V_169 ] ;
}
static void
F_57 ( struct V_1 * V_2 , struct V_214 * V_215 ,
unsigned int V_169 , struct V_31 * V_32 ,
enum V_216 V_217 )
{
T_2 V_219 ;
struct V_31 * V_220 ;
...
V_220 . V_224 = 1 ;
V_220 . V_225 = 1 ;
F_57 ( V_2 , V_215 , V_236 -> V_169 , & V_220 , V_218 ) ;
...
static int F_64 ( struct V_166 * V_231 , struct V_214 * V_215 ,
struct V_241 * V_32 )
{
struct V_1 * V_2 = F_62 ( V_231 ) ;
struct V_31 * V_220 ;
...
static int F_65 ( struct V_166 * V_231 , struct V_214 * V_215 ,
struct V_241 * V_32 )
{
struct V_1 * V_2 = F_62 ( V_231 ) ;
struct V_31 * V_220 ;
...
static int F_69 ( struct V_166 * V_231 , struct V_214 * V_215 )
{
struct V_241 V_220 ;
memset ( & V_220 , 0 , sizeof( V_220 ) ) ;
V_220 . V_169 = V_34 ;
V_220 . V_217 = V_215 ? V_218 : V_249 ;
V_220 . V_220 . V_37 = V_38 ;
V_220 . V_220 . V_224 = 4096 ;
V_220 . V_220 . V_225 = 4096 ;
F_65 ( V_231 , V_215 , & V_220 ) ;
return 0 ;
}
...
static int F_78 ( struct V_257 * V_171 ,
const struct V_168 * V_258 ,
const struct V_168 * V_259 , T_2 V_260 )
{
struct V_166 * V_231 = F_31 ( V_171 ) ;
struct V_1 * V_2 = F_62 ( V_231 ) ;
struct V_4 * V_6 = & V_2 -> V_6 ;
switch ( V_258 -> V_233 | F_79 ( V_259 -> V_171 ) ) {
case V_178 | V_261 :
if ( V_260 & V_262 ) {
if ( V_2 -> V_53 & ~ V_55 )
return - V_150 ;
...
{
int V_250 ;
V_250 = F_84 ( V_265 , & V_2 -> V_202 ) ;
if ( V_250 < 0 )
goto error;
V_250 = F_85 ( & V_2 -> V_179 , V_265 ) ;
if ( V_250 < 0 )
goto error;
return 0 ;
error:
...
struct V_257 * V_267 = & V_231 -> V_171 ;
int V_250 ;
char V_268 [ V_269 ] ;
F_87 ( V_231 , & V_270 ) ;
V_231 -> V_271 = & V_272 ;
...
F_88 ( V_231 , V_2 ) ;
V_231 -> V_260 |= V_274 ;
V_170 [ V_178 ] . V_260 = V_275 ;
V_170 [ V_34 ] . V_260 = V_276 ;
V_267 -> V_277 = & V_278 ;
V_250 = F_89 ( V_267 , V_279 , V_170 , 0 ) ;
if ( V_250 < 0 )
return V_250 ;
F_69 ( V_231 , NULL ) ;
...
V_250 = F_91 ( & V_2 -> V_179 , V_268 ) ;
if ( V_250 < 0 )
goto V_286;
V_250 = F_92 ( & V_2 -> V_202 . V_171 , V_178 ,
...
struct V_1 * V_289 = & V_7 -> V_289 ;
int V_250 ;
V_288 -> V_7 = V_7 ;
V_288 -> V_146 = 1 ;
V_288 -> V_8 = V_290 ;
V_288 -> V_148 = & V_7 -> V_291 ;
V_288 -> V_253 = V_292 ;
V_288 -> V_251 = V_252 ;
F_96 ( & V_288 -> V_208 ) ;
V_250 = F_86 ( V_288 , L_11 ) ;
if ( V_250 < 0 )
return V_250 ;
V_289 -> V_7 = V_7 ;
V_289 -> V_146 = 1 ;
V_289 -> V_8 = V_293 ;
V_289 -> V_148 = & V_7 -> V_294 ;
V_289 -> V_253 = V_295 ;
V_289 -> V_251 = V_252 ;
F_96 ( & V_289 -> V_208 ) ;
V_250 = F_86 ( V_289 , L_12 ) ;
if ( V_250 < 0 )
return V_250 ;
return 0 ;
}
...
struct V_1 * V_289 = & V_7 -> V_289 ;
F_93 ( & V_288 -> V_179 ) ;
F_94 ( & V_288 -> V_202 . V_171 ) ;
F_93 ( & V_289 -> V_179 ) ;
F_94 ( & V_289 -> V_202 . V_171 ) ;
}
