...
int F_32 ( struct V_2 * V_3 , T_2 V_62 , int V_16 )
{
int V_17 ;
...
int F_34 ( struct V_2 * V_3 , int V_39 , int V_16 )
{
if ( V_39 <= 0 )
return - V_35 ;
V_39 = F_15 ( V_39 , 4 ) ;
return F_10 ( V_3 ,
F_19 ( V_3 -> V_18 , V_42 ) ,
V_3 -> V_65 , V_39 , 0 , NULL , V_16 ) ;
}
static int F_35 ( struct V_2 * V_3 , T_1 * V_8 )
{
int V_17 ;
F_36 ( V_3 ) ;
F_31 ( V_3 , V_66 , V_67 , 0x00 , 0x00 ) ;
F_31 ( V_3 , V_66 , V_68 , 0x00 , 0x00 ) ;
V_17 = F_32 ( V_3 , V_69 , 100 ) ;
if ( V_17 )
return V_17 ;
V_17 = F_34 ( V_3 , 2 , 100 ) ;
if ( V_17 )
return V_17 ;
* V_8 = ( ( V_3 -> V_65 [ 0 ] >> 2 ) & 0x0f ) |
( ( V_3 -> V_65 [ 1 ] & 0x03 ) << 4 ) ;
return 0 ;
}
int F_37 ( struct V_2 * V_3 , T_1 * V_8 )
{
int V_17 ;
T_1 * V_24 ;
if ( ! V_8 )
...
V_17 = F_32 ( V_3 , V_77 , 2000 ) ;
if ( V_17 < 0 )
return V_17 ;
V_17 = F_39 ( V_3 , V_99 , 0xff ,
V_100 | V_106 | V_107 ) ;
if ( V_17 < 0 )
return V_17 ;
F_43 ( 100 , 1000 ) ;
V_17 = F_39 ( V_3 , V_97 , V_98 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
V_3 -> V_89 = V_82 ;
return 0 ;
...
V_140 | V_141 | V_142 ,
V_140 | V_141 | V_142 ) ;
V_17 = F_32 ( V_3 , V_77 , 100 ) ;
if ( V_17 )
return V_17 ;
F_20 ( V_3 , V_143 , & V_72 ) ;
if ( ( V_72 & V_144 ) || ( ( V_72 & V_145 ) == V_146 ) ) {
V_17 = F_38 ( V_3 , 0xC2 , 0x7C ) ;
if ( V_17 )
return V_17 ;
}
return 0 ;
...
return V_17 ;
F_43 ( 100 , 1000 ) ;
V_17 = F_39 ( V_3 , V_97 , V_98 , 0x00 ) ;
if ( V_17 )
return V_17 ;
V_17 = F_20 ( V_3 , V_150 , & V_72 ) ;
if ( V_17 )
return V_17 ;
V_3 -> V_151 = V_72 & V_152 ;
V_17 = F_20 ( V_3 , V_153 , & V_72 ) ;
if ( V_17 )
return V_17 ;
if ( V_72 & V_154 ) {
V_3 -> V_155 = V_116 ;
...
if ( V_17 )
goto V_175;
F_54 ( & V_3 -> V_20 , F_1 , ( unsigned long ) V_3 ) ;
V_17 = F_55 ( & V_160 -> V_5 , V_176 ,
F_56 ( V_176 ) ) ;
if ( V_17 )
goto V_175;
#ifdef F_57
