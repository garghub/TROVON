...
struct V_4 * V_5 = (struct V_4 * ) V_2 ;
unsigned int V_15 ;
F_14 ( V_2 -> V_16 -> V_17 , L_1 ) ;
F_11 ( V_5 , V_11 , V_5 -> V_12 | V_18 ) ;
F_15 ( V_5 , V_19 ) ;
V_15 = F_15 ( V_5 , V_20 ) ;
if ( ( V_15 & V_21 ) == V_21 ) {
F_14 ( V_2 -> V_16 -> V_17 , L_2 ) ;
return - V_22 ;
}
F_11 ( V_5 , V_11 , V_5 -> V_12 & ~ V_18 ) ;
F_15 ( V_5 , V_19 ) ;
V_15 = F_15 ( V_5 , V_20 ) ;
if ( ! ( V_15 & V_21 ) ) {
F_14 ( V_2 -> V_16 -> V_17 , L_3 ) ;
return - V_22 ;
}
if ( V_2 -> type == V_23 ) {
F_11 ( V_5 , V_11 , V_5 -> V_12 | V_24 ) ;
F_15 ( V_5 , V_19 ) ;
V_15 = F_15 ( V_5 , V_20 ) ;
if ( ( V_15 & V_25 ) == V_25 ) {
F_14 ( V_2 -> V_16 -> V_17 , L_4 ) ;
return - V_22 ;
}
F_11 ( V_5 , V_11 , V_5 -> V_12 & ~ V_24 ) ;
F_15 ( V_5 , V_19 ) ;
V_15 = F_15 ( V_5 , V_20 ) ;
if ( ! ( V_15 & V_25 ) ) {
F_14 ( V_2 -> V_16 -> V_17 , L_5 ) ;
return - V_22 ;
}
}
F_14 ( V_2 -> V_16 -> V_17 , L_6 ) ;
return 0 ;
}
static void F_16 ( struct V_1 * V_5 , int V_26 )
{
F_11 ( V_5 , V_27 , V_26 ? V_28 : V_29 ) ;
F_11 ( V_5 , V_30 , 0 ) ;
}
...
static void F_18 ( struct V_1 * V_5 , struct V_31 * V_32 ,
...
static void F_21 ( struct V_1 * V_5 , struct V_31 * V_32 ,
struct V_33 * V_34 , int V_35 )
{
int V_9 = V_34 -> V_37 ;
T_1 * V_38 = ( T_1 * ) ( V_32 -> V_39 + V_9 ) ;
...
static int F_23 ( struct V_1 * V_5 , unsigned int V_6 , unsigned int V_42 , unsigned char V_15 )
{
unsigned int V_43 ;
...
static int F_25 ( struct V_1 * V_5 , const struct V_47 * V_48 )
{
unsigned int V_43 ;
unsigned int V_6 ;
const unsigned char * V_49 ;
F_11 ( V_5 , V_50 , V_44 | V_51 ) ;
F_15 ( V_5 , V_50 ) ;
F_26 ( 10 ) ;
F_11 ( V_5 , V_50 , V_44 ) ;
F_15 ( V_5 , V_50 ) ;
...
static int F_29 ( struct V_1 * V_57 , int V_58 , const struct V_47 * V_59 )
{
int V_60 ;
switch ( V_58 ) {
case 1 :
if ( ( V_60 = F_25 ( V_57 , V_59 ) ) < 0 )
return V_60 ;
if ( ( V_60 = F_13 ( V_57 ) ) < 0 )
return V_60 ;
return 0 ;
case 2 :
return F_30 ( V_57 , V_59 ) ;
case 3 :
...
static void F_34 ( struct V_1 * V_2 , int V_66 )
{
struct V_4 * V_5 = (struct V_4 * ) V_2 ;
if ( V_66 ) {
F_11 ( V_5 , V_67 , V_68 | V_69 ) ;
V_5 -> V_12 |= V_70 ;
} else {
F_11 ( V_5 , V_67 , V_68 & ~ V_69 ) ;
V_5 -> V_12 &= ~ V_70 ;
...
F_11 ( V_5 , V_72 , ( ( V_15 & 0x800000 ) ? V_73 : 0 ) ) ;
F_15 ( V_5 , V_74 ) ;
}
...
unsigned int V_10 ;
if ( V_3 == V_75 ) {
F_35 ( V_5 , V_15 ? V_76 : V_77 ) ;
return;
}
if ( F_19 ( V_15 >= sizeof( V_78 ) ) )
return;
switch ( V_3 ) {
case V_79 :
V_10 = V_80 ;
...
static void F_37 ( struct V_1 * V_5 , int V_83 , unsigned int V_15 )
{
int V_43 ;
F_15 ( V_5 , V_71 ) ;
for ( V_43 = 0 ; V_43 < 24 ; V_43 ++ , V_15 <<= 1 )
...
V_92 ;
V_5 -> V_89 &= ~ V_93 ;
F_11 ( V_2 , V_94 , V_5 -> V_89 ) ;
}
}
static void F_39 ( struct V_1 * V_2 , int V_95 )
{
struct V_4 * V_5 = (struct V_4 * ) V_2 ;
switch ( V_95 ) {
case V_96 :
...
F_11 ( V_5 , V_99 , V_5 -> V_97 ) ;
}
static void F_40 ( struct V_1 * V_2 , int V_100 )
{
struct V_4 * V_5 = (struct V_4 * ) V_2 ;
if ( V_100 == V_101 )
V_5 -> V_97 &= ~ V_102 ;
...
static void F_41 ( struct V_1 * V_2 , int V_103 )
{
struct V_4 * V_5 = (struct V_4 * ) V_2 ;
V_5 -> V_12 = V_84 | V_13 ;
V_5 -> V_97 = 0 ;
...
F_11 ( V_5 , V_94 , V_5 -> V_89 ) ;
V_15 = ( unsigned int ) V_104 << 16 |
( unsigned int ) V_5 -> V_110 [ 1 ] << 8 |
( unsigned int ) V_5 -> V_110 [ 0 ] ;
F_15 ( V_5 , V_72 ) ;
for ( V_43 = 0 ; V_43 < 32 ; V_43 ++ , V_15 <<= 1 )
F_11 ( V_5 , V_72 , ( ( V_15 & 0x80000000 ) ? V_73 : 0 ) ) ;
F_15 ( V_5 , V_74 ) ;
}
static int F_43 ( struct V_111 * V_112 , struct V_113 * V_114 )
{
V_114 -> type = V_115 ;
V_114 -> V_35 = 2 ;
...
static int F_44 ( struct V_111 * V_112 , struct V_120 * V_121 )
{
struct V_1 * V_2 = F_45 ( V_112 ) ;
struct V_4 * V_5 = (struct V_4 * ) V_2 ;
F_46 ( & V_2 -> V_122 ) ;
...
static int F_48 ( struct V_111 * V_112 , struct V_120 * V_121 )
{
struct V_1 * V_2 = F_45 ( V_112 ) ;
struct V_4 * V_5 = (struct V_4 * ) V_2 ;
...
static int F_49 ( struct V_111 * V_112 , struct V_113 * V_114 )
{
V_114 -> type = V_115 ;
V_114 -> V_35 = 1 ;
V_114 -> V_116 . integer . V_117 = 0 ;
...
static int F_50 ( struct V_111 * V_112 , struct V_120 * V_121 )
{
struct V_1 * V_2 = F_45 ( V_112 ) ;
struct V_4 * V_5 = (struct V_4 * ) V_2 ;
...
V_5 -> V_106 = 0 ;
F_42 ( V_5 ) ;
if ( ( V_60 = F_53 ( V_2 -> V_16 , F_54 ( & V_123 , V_5 ) ) ) < 0 )
return V_60 ;
if ( ( V_60 = F_53 ( V_2 -> V_16 , F_54 ( & V_124 , V_5 ) ) ) < 0 )
return V_60 ;
return 0 ;
}
