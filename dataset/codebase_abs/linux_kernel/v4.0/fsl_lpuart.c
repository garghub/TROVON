...
{
struct V_265 * V_266 = V_264 -> V_23 . V_267 ;
struct V_15 * V_16 ;
struct V_268 * V_269 ;
int V_163 ;
V_16 = F_70 ( & V_264 -> V_23 , sizeof( * V_16 ) , V_174 ) ;
if ( ! V_16 )
return - V_165 ;
V_264 -> V_23 . V_270 = 0 ;
V_163 = F_108 ( V_266 , L_13 ) ;
if ( V_163 < 0 ) {
F_12 ( & V_264 -> V_23 , L_14 , V_163 ) ;
return V_163 ;
}
V_16 -> V_4 . line = V_163 ;
V_16 -> V_86 = F_109 ( V_266 , L_15 ) ;
V_269 = F_110 ( V_264 , V_271 , 0 ) ;
V_16 -> V_4 . V_6 = F_111 ( & V_264 -> V_23 , V_269 ) ;
if ( F_112 ( V_16 -> V_4 . V_6 ) )
return F_113 ( V_16 -> V_4 . V_6 ) ;
V_16 -> V_4 . V_167 = V_269 -> V_272 ;
V_16 -> V_4 . V_23 = & V_264 -> V_23 ;
V_16 -> V_4 . type = V_237 ;
V_16 -> V_4 . V_273 = V_243 ;
V_16 -> V_4 . V_83 = F_114 ( V_264 , 0 ) ;
if ( V_16 -> V_86 )
V_16 -> V_4 . V_274 = & V_275 ;
else
V_16 -> V_4 . V_274 = & V_276 ;
V_16 -> V_4 . V_32 = V_277 ;
V_16 -> V_258 = F_115 ( & V_264 -> V_23 , L_16 ) ;
if ( F_112 ( V_16 -> V_258 ) ) {
V_163 = F_113 ( V_16 -> V_258 ) ;
F_12 ( & V_264 -> V_23 , L_17 , V_163 ) ;
return V_163 ;
}
V_163 = F_116 ( V_16 -> V_258 ) ;
if ( V_163 ) {
F_12 ( & V_264 -> V_23 , L_18 , V_163 ) ;
return V_163 ;
}
V_16 -> V_4 . V_216 = F_100 ( V_16 -> V_258 ) ;
V_251 [ V_16 -> V_4 . line ] = V_16 ;
F_117 ( V_264 , & V_16 -> V_4 ) ;
if ( V_16 -> V_86 )
V_278 . V_279 = V_280 ;
else
V_278 . V_279 = V_281 ;
V_163 = F_118 ( & V_278 , & V_16 -> V_4 ) ;
if ( V_163 ) {
F_119 ( V_16 -> V_258 ) ;
return V_163 ;
}
V_16 -> V_48 = F_120 ( V_16 -> V_4 . V_23 , L_19 ) ;
if ( ! V_16 -> V_48 )
F_121 ( V_16 -> V_4 . V_23 , L_20
L_21 ) ;
V_16 -> V_60 = F_120 ( V_16 -> V_4 . V_23 , L_22 ) ;
if ( ! V_16 -> V_60 )
F_121 ( V_16 -> V_4 . V_23 , L_23
L_24 ) ;
return 0 ;
}
static int F_122 ( struct V_263 * V_264 )
{
struct V_15 * V_16 = F_123 ( V_264 ) ;
F_124 ( & V_278 , & V_16 -> V_4 ) ;
F_119 ( V_16 -> V_258 ) ;
if ( V_16 -> V_48 )
F_125 ( V_16 -> V_48 ) ;
if ( V_16 -> V_60 )
...
static int F_126 ( struct V_164 * V_23 )
{
struct V_15 * V_16 = F_127 ( V_23 ) ;
unsigned long V_5 ;
if ( V_16 -> V_86 ) {
V_5 = F_1 ( V_16 -> V_4 . V_6 + V_10 ) ;
V_5 &= ~ ( V_151 | V_11 | V_12 ) ;
...
F_128 ( & V_278 , & V_16 -> V_4 ) ;
return 0 ;
}
static int F_129 ( struct V_164 * V_23 )
{
struct V_15 * V_16 = F_127 ( V_23 ) ;
unsigned long V_5 ;
if ( V_16 -> V_86 ) {
...
F_130 ( & V_278 , & V_16 -> V_4 ) ;
return 0 ;
}
static int T_5 F_131 ( void )
{
int V_163 = F_132 ( & V_278 ) ;
if ( V_163 )
return V_163 ;
V_163 = F_133 ( & V_282 ) ;
if ( V_163 )
