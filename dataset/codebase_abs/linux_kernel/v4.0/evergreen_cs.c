...
struct V_148 * V_149 ;
T_1 V_150 ;
T_1 V_151 , V_14 , V_91 , * V_89 ;
int V_87 ;
if ( V_53 -> V_152 -> V_114 >= V_153 )
V_150 = F_73 ( V_154 ) ;
else
V_150 = F_73 ( V_155 ) ;
V_14 = ( V_145 >> 7 ) ;
if ( V_14 >= V_150 ) {
F_7 ( V_53 -> V_66 , L_53 , V_145 , V_105 ) ;
return - V_68 ;
}
V_151 = 1 << ( ( V_145 >> 2 ) & 31 ) ;
if ( V_53 -> V_152 -> V_114 >= V_153 ) {
...
case V_186 :
case V_187 :
V_87 = F_74 ( V_53 , & V_149 , 0 ) ;
if ( V_87 ) {
F_7 ( V_53 -> V_66 , L_54
L_55 , V_145 ) ;
return - V_68 ;
}
V_89 [ V_105 ] += ( T_1 ) ( ( V_149 -> V_188 >> 8 ) & 0xffffffff ) ;
break;
case V_189 :
...
V_89 [ V_105 ] &= ~ F_75 ( 0xf ) ;
V_13 -> V_33 &= ~ F_75 ( 0xf ) ;
V_89 [ V_105 ] |= F_75 ( F_1 ( V_149 -> V_1 ) ) ;
V_13 -> V_33 |= F_75 ( F_1 ( V_149 -> V_1 ) ) ;
if ( V_149 -> V_1 & V_2 ) {
...
V_89 [ V_105 ] |= F_82 ( F_1 ( V_149 -> V_1 ) ) ;
V_13 -> V_21 [ V_91 ] |= F_82 ( F_1 ( V_149 -> V_1 ) ) ;
}
V_13 -> V_28 = true ;
break;
case V_243 :
...
case V_289 :
case V_290 :
V_91 = ( V_145 - V_283 ) / 0x3c ;
V_87 = F_74 ( V_53 , & V_149 , 0 ) ;
if ( V_87 ) {
F_88 ( V_53 -> V_66 , L_57 , V_145 ) ;
return - V_68 ;
}
V_89 [ V_105 ] += ( T_1 ) ( ( V_149 -> V_188 >> 8 ) & 0xffffffff ) ;
V_13 -> V_15 [ V_91 ] = V_149 -> V_202 ;
break;
case V_291 :
case V_292 :
case V_293 :
...
V_91 = ( V_145 - V_315 ) / 0x3c ;
V_13 -> V_20 [ V_91 ] = F_43 ( V_53 , V_105 ) ;
V_89 [ V_105 ] += ( T_1 ) ( ( V_149 -> V_188 >> 8 ) & 0xffffffff ) ;
V_13 -> V_19 [ V_91 ] = V_149 -> V_202 ;
V_13 -> V_28 = true ;
break;
case V_323 :
case V_324 :
...
static bool F_89 ( struct V_52 * V_53 , T_1 V_145 , T_1 V_105 )
{
T_1 V_150 , V_151 , V_14 ;
if ( V_53 -> V_152 -> V_114 >= V_153 )
V_150 = F_73 ( V_154 ) ;
else
V_150 = F_73 ( V_155 ) ;
...
V_13 -> V_453 = F_23 ( V_149 -> V_202 ) ;
V_89 [ V_105 + 1 ] = V_149 -> V_188 ;
V_89 [ V_105 + 2 ] = F_91 ( V_149 -> V_188 ) & 0xff ;
break;
}
case V_454 :
case V_455 :
{
T_2 V_93 = V_144 -> V_435 == V_454 ? 16 : 20 ;
if ( V_144 -> V_147 != 1 ) {
F_64 ( L_76 ) ;
return - V_68 ;
}
if ( V_434 + V_93 > V_13 -> V_453 ) {
F_7 ( V_53 -> V_66 , L_77 ,
V_434 , V_93 , V_13 -> V_453 ) ;
return - V_68 ;
}
V_87 = F_63 ( V_53 ) ;
if ( V_87 ) {
...
V_89 [ V_105 + 0 ] = V_434 + ( T_1 ) ( V_149 -> V_188 & 0xffffffff ) ;
V_87 = F_63 ( V_53 ) ;
if ( V_87 ) {
F_7 ( V_53 -> V_66 , L_65 , V_67 , __LINE__ ) ;
return V_87 ;
...
case V_459 :
{
T_1 V_460 , V_93 , V_461 ;
T_2 V_86 , V_91 ;
if ( V_144 -> V_147 != 4 ) {
F_64 ( L_82 ) ;
return - V_68 ;
}
V_460 = F_43 ( V_53 , V_105 + 4 ) ;
V_93 = V_460 & 0x1fffff ;
V_461 = F_43 ( V_53 , V_105 + 1 ) ;
if ( ( ( ( V_461 & 0x60000000 ) >> 29 ) != 0 ) ||
( ( ( V_461 & 0x00300000 ) >> 20 ) != 0 ) ||
( ( ( ( V_461 & 0x00300000 ) >> 20 ) == 0 ) &&
( V_460 & V_462 ) ) ||
( ( ( ( V_461 & 0x60000000 ) >> 29 ) == 0 ) &&
( V_460 & V_463 ) ) ) {
if ( V_93 % 4 ) {
F_64 ( L_83 ) ;
return - V_68 ;
...
( ( T_2 ) ( F_43 ( V_53 , V_105 + 1 ) & 0xff ) << 32 ) ;
V_86 = V_149 -> V_188 + V_91 ;
if ( ( V_91 + V_93 ) > F_23 ( V_149 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_87 ,
V_91 + V_93 , F_23 ( V_149 -> V_202 ) ) ;
return - V_68 ;
}
V_89 [ V_105 ] = V_86 ;
V_89 [ V_105 + 1 ] = ( V_89 [ V_105 + 1 ] & 0xffffff00 ) | ( F_91 ( V_86 ) & 0xff ) ;
} else if ( ( ( V_461 & 0x60000000 ) >> 29 ) != 2 ) {
F_64 ( L_88 ) ;
return - V_68 ;
}
}
if ( V_460 & V_462 ) {
if ( ( ( V_461 & 0x00300000 ) >> 20 ) != 1 ) {
F_64 ( L_89 ) ;
return - V_68 ;
}
} else {
...
V_89 [ V_105 + 2 ] += ( T_1 ) ( ( V_149 -> V_188 >> 8 ) & 0xffffffff ) ;
}
break;
case V_467 :
...
V_145 = V_432 + ( 4 * V_14 ) ;
V_87 = F_72 ( V_53 , V_145 , V_105 + 1 + V_14 ) ;
if ( V_87 )
return V_87 ;
}
break;
...
V_103 = V_149 -> V_202 ;
V_106 = ( T_1 ) ( ( V_149 -> V_188 >> 8 ) & 0xffffffff ) ;
...
V_107 = ( T_1 ) ( ( V_149 -> V_188 >> 8 ) & 0xffffffff ) ;
V_104 = V_149 -> V_202 ;
}
...
if ( V_53 -> V_152 && ( V_93 + V_86 ) > F_23 ( V_149 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_103 ) ;
V_89 [ V_105 + 1 + ( V_14 * 8 ) + 1 ] = F_23 ( V_149 -> V_202 ) - V_86 ;
}
V_485 = V_149 -> V_188 + V_86 ;
...
if ( ( V_86 + 4 ) > F_23 ( V_149 -> V_202 ) ) {
F_64 ( L_110 ,
V_86 + 4 , F_23 ( V_149 -> V_202 ) ) ;
return - V_68 ;
}
V_86 += V_149 -> V_188 ;
V_89 [ V_105 + 1 ] = V_86 ;
...
if ( ( V_86 + 8 ) > F_23 ( V_149 -> V_202 ) ) {
F_64 ( L_116 ,
V_86 + 8 , F_23 ( V_149 -> V_202 ) ) ;
return - V_68 ;
}
V_86 += V_149 -> V_188 ;
V_89 [ V_105 + 0 ] = V_86 ;
...
int V_87 ;
if ( V_53 -> V_13 == NULL ) {
V_13 = F_101 ( sizeof( * V_13 ) , V_505 ) ;
if ( V_13 == NULL )
return - V_506 ;
F_3 ( V_13 ) ;
if ( V_53 -> V_152 -> V_114 >= V_153 )
V_91 = V_53 -> V_152 -> V_507 . V_508 . V_509 ;
else
V_91 = V_53 -> V_152 -> V_507 . V_510 . V_509 ;
switch ( V_91 & 0xf ) {
case 0 :
V_13 -> V_76 = 1 ;
break;
...
do {
V_87 = F_102 ( V_53 , & V_144 , V_53 -> V_105 ) ;
if ( V_87 ) {
F_103 ( V_53 -> V_13 ) ;
V_53 -> V_13 = NULL ;
return V_87 ;
...
} while ( V_53 -> V_105 < V_53 -> V_515 -> V_516 );
#if 0
...
{
struct V_517 * V_518 = V_53 -> V_515 ;
struct V_148 * V_519 , * V_520 , * V_521 ;
T_1 V_522 , V_523 , V_147 , V_524 ;
volatile T_1 * V_89 = V_53 -> V_89 . V_90 ;
T_1 V_105 ;
T_2 V_525 , V_526 , V_527 ;
int V_87 ;
do {
if ( V_53 -> V_105 >= V_518 -> V_516 ) {
F_64 ( L_124 ,
V_53 -> V_105 , V_518 -> V_516 ) ;
return - V_68 ;
}
V_105 = V_53 -> V_105 ;
V_522 = F_43 ( V_53 , V_105 ) ;
V_523 = F_105 ( V_522 ) ;
V_147 = F_106 ( V_522 ) ;
V_524 = F_107 ( V_522 ) ;
switch ( V_523 ) {
case V_528 :
V_87 = F_108 ( V_53 , & V_520 ) ;
if ( V_87 ) {
F_64 ( L_125 ) ;
return - V_68 ;
}
switch ( V_524 ) {
case 8 :
V_526 = F_43 ( V_53 , V_105 + 1 ) ;
V_526 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_188 >> 8 ) ;
V_53 -> V_105 += V_147 + 7 ;
break;
case 0 :
V_526 = F_43 ( V_53 , V_105 + 1 ) ;
V_526 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 2 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_520 -> V_188 ) & 0xff ;
V_53 -> V_105 += V_147 + 3 ;
break;
default:
F_64 ( L_126 , V_105 , V_522 ) ;
return - V_68 ;
}
if ( ( V_526 + ( V_147 * 4 ) ) > F_23 ( V_520 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_127 ,
V_526 , F_23 ( V_520 -> V_202 ) ) ;
return - V_68 ;
}
break;
case V_529 :
V_87 = F_108 ( V_53 , & V_519 ) ;
if ( V_87 ) {
F_64 ( L_128 ) ;
return - V_68 ;
}
...
switch ( V_524 ) {
case 0x00 :
V_525 = F_43 ( V_53 , V_105 + 2 ) ;
V_525 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 4 ) & 0xff ) ) << 32 ;
V_526 = F_43 ( V_53 , V_105 + 1 ) ;
V_526 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_525 + ( V_147 * 4 ) ) > F_23 ( V_519 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_129 ,
V_525 + ( V_147 * 4 ) , F_23 ( V_519 -> V_202 ) ) ;
return - V_68 ;
}
if ( ( V_526 + ( V_147 * 4 ) ) > F_23 ( V_520 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_130 ,
V_526 + ( V_147 * 4 ) , F_23 ( V_520 -> V_202 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_519 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_520 -> V_188 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_519 -> V_188 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
case 0x08 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
V_525 = F_43 ( V_53 , V_105 + 1 ) ;
V_525 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_519 -> V_188 >> 8 ) ;
V_526 = F_43 ( V_53 , V_105 + 7 ) ;
V_526 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_520 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_520 -> V_188 ) & 0xff ;
} else {
V_525 = F_43 ( V_53 , V_105 + 7 ) ;
V_525 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_519 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_519 -> V_188 ) & 0xff ;
V_526 = F_43 ( V_53 , V_105 + 1 ) ;
V_526 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_188 >> 8 ) ;
}
...
V_526 = F_43 ( V_53 , V_105 + 1 ) ;
V_526 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_525 + V_147 ) > F_23 ( V_519 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_133 ,
V_525 + V_147 , F_23 ( V_519 -> V_202 ) ) ;
return - V_68 ;
}
if ( ( V_526 + V_147 ) > F_23 ( V_520 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_134 ,
V_526 + V_147 , F_23 ( V_520 -> V_202 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_519 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_520 -> V_188 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_519 -> V_188 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_519 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_519 -> V_188 ) & 0xff ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_520 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 5 ] += F_91 ( V_520 -> V_188 ) & 0xff ;
V_53 -> V_105 += 9 ;
break;
case 0x44 :
V_87 = F_108 ( V_53 , & V_521 ) ;
if ( V_87 ) {
F_64 ( L_136 ) ;
return - V_68 ;
}
V_526 = F_43 ( V_53 , V_105 + 1 ) ;
V_526 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 4 ) & 0xff ) ) << 32 ;
V_527 = F_43 ( V_53 , V_105 + 2 ) ;
V_527 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 5 ) & 0xff ) ) << 32 ;
V_525 = F_43 ( V_53 , V_105 + 3 ) ;
V_525 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 6 ) & 0xff ) ) << 32 ;
if ( ( V_525 + ( V_147 * 4 ) ) > F_23 ( V_519 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_137 ,
V_525 + ( V_147 * 4 ) , F_23 ( V_519 -> V_202 ) ) ;
return - V_68 ;
...
if ( ( V_527 + ( V_147 * 4 ) ) > F_23 ( V_521 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_139 ,
V_527 + ( V_147 * 4 ) , F_23 ( V_521 -> V_202 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_521 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( T_1 ) ( V_519 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 4 ] += F_91 ( V_520 -> V_188 ) & 0xff ;
V_89 [ V_105 + 5 ] += F_91 ( V_521 -> V_188 ) & 0xff ;
V_89 [ V_105 + 6 ] += F_91 ( V_519 -> V_188 ) & 0xff ;
V_53 -> V_105 += 7 ;
break;
case 0x48 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_527 = F_43 ( V_53 , V_105 + 2 ) ;
V_527 <<= 8 ;
V_525 = F_43 ( V_53 , V_105 + 8 ) ;
V_525 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 9 ) & 0xff ) ) << 32 ;
if ( ( V_525 + ( V_147 * 4 ) ) > F_23 ( V_519 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_141 ,
V_525 + ( V_147 * 4 ) , F_23 ( V_519 -> V_202 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_188 >> 8 ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_521 -> V_188 >> 8 ) ;
V_89 [ V_105 + 8 ] += ( T_1 ) ( V_519 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 9 ] += F_91 ( V_519 -> V_188 ) & 0xff ;
V_53 -> V_105 += 10 ;
break;
case 0x49 :
if ( V_53 -> V_114 < V_153 ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_519 -> V_188 >> 8 ) ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_520 -> V_188 >> 8 ) ;
V_53 -> V_105 += 13 ;
break;
case 0x4f :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_526 = F_43 ( V_53 , V_105 + 1 ) ;
V_526 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 3 ) & 0x00ff0000 ) ) << 16 ;
if ( ( V_526 + ( V_147 * 4 ) ) > F_23 ( V_520 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_152 ,
V_526 , F_23 ( V_520 -> V_202 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( F_91 ( V_520 -> V_188 ) << 16 ) & 0x00ff0000 ;
V_53 -> V_105 += 4 ;
break;
case V_531 :
V_53 -> V_105 += 1 ;
...
for ( V_14 = 0 ; V_14 < ( V_460 & 0x1fffff ) ; V_14 ++ ) {
V_145 = V_432 + ( 4 * V_14 ) ;
if ( ! F_109 ( V_145 ) ) {
F_64 ( L_156 ) ;
return - V_68 ;
...
int F_111 ( struct V_606 * V_152 , struct V_616 * V_89 )
{
int V_617 = 0 ;
T_1 V_105 = 0 ;
struct V_143 V_144 ;
do {
V_144 . V_105 = V_105 ;
V_144 . type = F_112 ( V_89 -> V_90 [ V_105 ] ) ;
V_144 . V_147 = F_113 ( V_89 -> V_90 [ V_105 ] ) ;
V_144 . V_618 = 0 ;
switch ( V_144 . type ) {
case V_512 :
F_88 ( V_152 -> V_66 , L_158 ) ;
V_617 = - V_68 ;
break;
case V_513 :
V_105 += 1 ;
break;
case V_514 :
V_144 . V_435 = F_114 ( V_89 -> V_90 [ V_105 ] ) ;
V_617 = F_110 ( V_152 , V_89 -> V_90 , & V_144 ) ;
V_105 += V_144 . V_147 + 2 ;
break;
default:
F_88 ( V_152 -> V_66 , L_123 , V_144 . type ) ;
V_617 = - V_68 ;
break;
}
if ( V_617 )
break;
} while ( V_105 < V_89 -> V_516 );
return V_617 ;
}
int F_115 ( struct V_606 * V_152 , struct V_616 * V_89 )
{
T_1 V_105 = 0 ;
T_1 V_522 , V_523 , V_147 , V_524 ;
do {
V_522 = V_89 -> V_90 [ V_105 ] ;
V_523 = F_105 ( V_522 ) ;
V_147 = F_106 ( V_522 ) ;
V_524 = F_107 ( V_522 ) ;
switch ( V_523 ) {
...
break;
default:
F_64 ( L_126 , V_105 , V_89 -> V_90 [ V_105 ] ) ;
return - V_68 ;
}
break;
case V_529 :
...
break;
default:
F_64 ( L_150 , V_105 , V_89 -> V_90 [ V_105 ] ) ;
return - V_68 ;
}
break;
case V_530 :
