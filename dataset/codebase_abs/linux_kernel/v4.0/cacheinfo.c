...
static struct V_5 * F_30 ( const struct V_9 * V_33 )
{
struct V_5 * V_5 = NULL ;
struct V_5 * V_14 ;
F_11 (iter, &cache_list, list) {
...
static bool F_31 ( const struct V_9 * V_34 )
{
...
static struct V_5 * F_33 ( struct V_9 * V_33 ,
int V_8 )
{
...
static struct V_5 * F_34 ( struct V_9 * V_33 , int V_8 )
{
struct V_5 * V_5 ;
if ( F_31 ( V_33 ) )
V_5 = F_32 ( V_33 , V_8 ) ;
...
static struct V_5 * F_35 ( struct V_9 * V_33 ,
int V_8 )
{
struct V_5 * V_5 ;
V_5 = F_30 ( V_33 ) ;
...
static void F_36 ( struct V_5 * V_39 , struct V_5 * V_40 )
{
while ( V_39 -> V_15 ) {
if ( V_39 -> V_15 == V_40 )
return;
...
static struct V_5 * F_41 ( unsigned int V_43 )
{
struct V_9 * V_44 ;
...
static struct V_47 * F_43 ( unsigned int V_43 )
{
struct V_47 * V_47 ;
struct V_48 * V_49 ;
struct V_2 * V_4 = NULL ;
...
static T_2 F_49 ( struct V_2 * V_3 , struct V_52 * V_53 , char * V_54 )
{
struct V_55 * V_56 ;
V_56 = F_2 ( V_53 , struct V_55 , V_53 ) ;
return V_56 -> V_57 ( V_3 , V_56 , V_54 ) ;
}
static struct V_5 * F_50 ( struct V_2 * V_3 )
{
struct V_1 * V_51 ;
V_51 = F_1 ( V_3 ) ;
return V_51 -> V_5 ;
...
static T_2 F_57 ( struct V_2 * V_3 , struct V_55 * V_53 , char * V_54 )
{
struct V_1 * V_51 ;
struct V_5 * V_5 ;
int V_20 ;
V_51 = F_1 ( V_3 ) ;
V_5 = V_51 -> V_5 ;
V_20 = F_58 ( V_54 , V_60 - 1 , L_18 ,
F_59 ( & V_5 -> V_19 ) ) ;
V_54 [ V_20 ++ ] = '\n' ;
V_54 [ V_20 ] = '\0' ;
return V_20 ;
}
static void F_60 ( struct V_1 * V_61 )
{
const char * V_62 ;
const char * V_63 ;
struct V_5 * V_5 ;
...
V_62 = V_5 -> V_10 -> V_16 ;
V_63 = F_3 ( V_5 ) ;
for ( V_26 = 0 ; V_26 < F_26 ( V_64 ) ; V_26 ++ ) {
struct V_55 * V_53 ;
T_2 V_65 ;
V_53 = V_64 [ V_26 ] ;
V_65 = V_53 -> V_57 ( & V_61 -> V_4 , V_53 , V_54 ) ;
if ( V_65 <= 0 ) {
F_14 ( L_19
L_20 ,
V_53 -> V_53 . V_7 , V_62 ,
...
if ( F_62 ( & V_61 -> V_4 , & V_53 -> V_53 ) )
F_14 ( L_21 ,
V_53 -> V_53 . V_7 , V_62 , V_63 ) ;
}
F_17 ( V_54 ) ;
}
static void F_63 ( struct V_5 * V_5 , int V_51 ,
struct V_47 * V_47 )
{
struct V_1 * V_66 ;
int V_65 ;
V_66 = F_9 ( sizeof( * V_66 ) , V_13 ) ;
if ( ! V_66 )
goto V_31;
V_66 -> V_5 = V_5 ;
V_65 = F_64 ( & V_66 -> V_4 , & V_67 ,
V_47 -> V_4 , L_22 , V_51 ) ;
if ( V_65 )
goto V_31;
V_66 -> V_18 = V_47 -> V_51 ;
...
static void F_65 ( unsigned int V_43 ,
struct V_5 * V_12 )
{
struct V_47 * V_47 ;
struct V_5 * V_5 ;
...
static struct V_5 * F_67 ( unsigned int V_43 )
{
struct V_9 * V_44 ;
struct V_5 * V_5 ;
V_44 = F_42 ( V_43 , NULL ) ;
...
static void F_68 ( struct V_47 * V_47 )
{
struct V_1 * V_51 ;
V_51 = V_47 -> V_51 ;
while ( V_51 ) {
...
static void F_69 ( struct V_47 * V_47 )
{
F_68 ( V_47 ) ;
F_70 ( V_47 -> V_4 ) ;
F_47 ( V_47 -> V_4 ) ;
...
static void F_71 ( struct V_5 * V_5 , int V_17 )
{
while ( V_5 ) {
