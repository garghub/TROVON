...
static int F_58 ( struct V_7 * V_8 , struct V_102 * V_103 )
{
union V_138 V_139 = { . V_52 = V_45 } ;
int V_12 , V_140 , V_21 ;
for ( V_12 = 0 ; V_12 < 2 ; V_12 ++ ) {
...
F_60 ( V_8 -> V_56 ) ;
F_21 ( 100 ) ;
for ( V_140 = 100000 ; -- V_140 ; F_21 ( 10 ) ) {
if ( F_20 ( V_8 -> V_56 ) && ! F_61 ( V_8 -> V_56 ) )
break;
}
if ( ! V_140 ) {
F_17 ( V_62
...
F_62 ( V_8 , & V_139 . V_52 ) ;
F_8 ( L_24 ,
V_139 . V_139 . V_141 , V_139 . V_139 . V_142 ,
V_139 . V_139 . V_143 , V_139 . V_139 . V_144 ) ;
if ( ! V_103 )
return 1 ;
for ( V_12 = 0 ; V_12 < V_145 ; V_12 ++ ) {
if ( ! memcmp ( & V_146 [ V_12 ] , & V_139 , sizeof( V_139 ) ) )
return 1 ;
}
F_8 ( L_25 ) ;
if ( ! V_103 -> V_147 ) {
V_21 = F_63 ( & V_103 -> V_147 , L_26 ,
& V_103 -> V_148 -> V_130 ) ;
if ( V_21 ) {
F_17 ( V_62
L_27 , V_21 ) ;
...
V_21 = F_6 ( V_8 , V_103 -> V_147 -> V_11 , V_103 -> V_147 -> V_16 ) ;
if ( V_21 ) {
F_17 ( V_62
L_28 , V_21 ) ;
return V_21 ;
...
F_64 ( V_8 , 0 , V_151 ) ;
F_65 ( V_8 , V_151 , & V_44 ) ;
F_8 ( L_29 , V_44 . V_48 [ 0 ] , V_44 . V_48 [ 1 ] ) ;
F_66 ( V_8 , 0 ) ;
F_67 ( V_8 , 0 ) ;
F_68 ( V_8 , 0 ) ;
F_69 ( V_8 , 0 ) ;
...
F_71 ( V_8 , V_152 , 0 , 0 , V_153 , V_154 ,
V_155 , V_156 ) ;
F_27 ( V_8 , V_156 , 0x7fff , 0x7fff ) ;
F_9 ( V_8 , V_157 , V_158 , NULL , NULL ) ;
F_71 ( V_8 , V_159 , 0 , 0 , V_160 , V_161 , V_162 ,
V_163 ) ;
F_27 ( V_8 , V_163 , 0x7fff , 0x7fff ) ;
F_13 ( V_8 , 0x30648 + V_163 * 4 , 0x01 , 0x00000005 ) ;
F_13 ( V_8 , 0x301A8 , 0x02 , 0x00000002 ) ;
F_13 ( V_8 , 0x30264 , 0x08 , 0xffffffff ) ;
F_9 ( V_8 , V_164 , V_165 , NULL , NULL ) ;
F_41 ( V_8 , V_166 , 48000 ,
( ( T_1 ) V_167 * 65536 ) / 48000 ,
( ( T_1 ) V_167 * 65536 ) % 48000 ) ;
F_71 ( V_8 , V_168 , 0 , 0 , V_166 , V_169 , V_170 ,
V_171 ) ;
F_72 ( V_8 , 1 ) ;
F_9 ( V_8 , V_172 , V_173 , NULL , NULL ) ;
F_9 ( V_8 , V_174 , V_175 , NULL , NULL ) ;
F_9 ( V_8 , V_174 , V_176 , NULL , NULL ) ;
F_73 ( V_8 -> V_56 ) ;
F_74 ( V_8 -> V_56 ) ;
F_73 ( V_8 -> V_56 ) ;
V_8 -> V_61 = 1 ;
...
static T_2 F_75 ( struct V_104
* V_105 )
{
struct V_102 * V_103 = F_76 ( V_105 ) ;
struct V_107 * V_108 = V_105 -> V_108 ;
struct V_109 * V_11 = F_77 ( V_105 ) ;
struct V_7 * V_8 = V_103 -> V_8 ;
union V_43 V_44 = V_45 ;
T_2 V_52 ;
F_78 ( V_8 , 0 , V_11 -> V_91 , & V_44 ) ;
...
static int F_79 ( struct V_104 * V_105 , int V_50 )
{
int V_12 , V_53 ;
struct V_102 * V_103 = F_76 ( V_105 ) ;
struct V_109 * V_11 = F_77 ( V_105 ) ;
...
case V_178 :
if ( ! ( V_11 -> V_116 & V_125 ) ) {
F_81 ( V_8 , V_11 -> V_91 , V_11 -> V_179 . V_10 ) ;
F_74 ( V_8 -> V_56 ) ;
V_11 -> V_116 = V_125 ;
if ( V_11 -> V_29 != 0xff )
...
switch ( V_92 ) {
case 1 :
if ( V_90 == 48000 && V_93 == V_187 )
V_186 = V_11 -> V_188 . V_189 ;
else
V_186 = V_11 -> V_188 . V_190 ;
break;
case 2 :
if ( V_90 == 48000 && V_93 == V_187 )
V_186 = V_11 -> V_188 . V_189 ;
else
V_186 = V_11 -> V_188 . V_191 ;
break;
}
F_8 ( L_34 ,
V_11 -> V_179 . V_192 ) ;
if ( V_11 -> V_179 . V_192 ) {
unsigned int V_12 , V_53 , V_16 , V_118 , V_193 , V_194 , V_195 ;
struct V_112 * V_5 , * V_13 = NULL ;
V_16 = F_46 ( V_108 , V_108 -> V_196 ) ;
V_195 = F_46 ( V_108 , V_108 -> V_128 ) ;
V_193 = V_197 ;
while ( ( V_16 + ( V_193 >> 1 ) - 1 ) <= ( V_193 << 7 ) && ( V_193 << 1 ) > V_195 )
V_193 = V_193 >> 1 ;
V_118 = ( V_16 + V_193 - 1 ) / V_193 ;
V_11 -> V_16 = V_16 ;
V_11 -> V_118 = V_118 ;
F_8
( L_35 ,
V_16 , V_118 , V_193 , V_195 ) ;
V_194 = 0 ;
V_53 = 0 ;
for ( V_12 = 0 ; V_12 < V_118 ; V_12 ++ ) {
unsigned int V_198 , V_10 ;
V_5 = & V_11 -> V_119 [ V_12 ] ;
if ( V_13 )
V_13 -> V_199 = F_45 ( V_11 -> V_179 . V_10 +
( V_12 *
sizeof( struct
V_112 ) ) ) ;
V_5 -> V_199 = F_45 ( V_11 -> V_179 . V_10 ) ;
V_198 = V_53 << V_200 ;
V_10 = F_87 ( V_105 , V_198 ) + V_194 ;
V_5 -> V_201 = F_45 ( V_10 ) ;
V_194 = ( V_194 + V_193 ) % V_197 ;
if ( V_194 == 0 )
V_53 ++ ;
V_5 -> V_122 = F_45 ( V_193 ) ;
V_5 -> V_120 =
F_45 ( V_202 | V_203 |
V_204 ) ;
V_13 = V_5 ;
...
if ( V_186 && V_186 != V_11 -> V_186 ) {
if ( V_11 -> V_186 )
F_11 ( V_8 , V_11 -> V_27 , V_11 -> V_186 ) ;
F_9 ( V_8 , V_11 -> V_27 , V_186 ,
& V_11 -> V_29 , V_11 -> V_89 ) ;
V_11 -> V_186 = V_186 ;
V_11 -> V_90 = 0 ;
}
...
struct V_102 * V_103 = F_76 ( V_105 ) ;
struct V_109 * V_11 = F_77 ( V_105 ) ;
struct V_207 * V_179 = & V_11 -> V_179 ;
int V_21 ;
F_8 ( L_36 , V_11 -> V_91 ,
V_179 -> V_192 , ( unsigned long ) V_179 -> V_10 ,
( int ) V_179 -> V_208 ) ;
if ( V_179 -> V_192 )
F_90 ( V_179 ) ;
if ( ( V_21 = F_91 ( V_209 ,
F_92 ( V_103 -> V_148 ) ,
sizeof( struct V_112 ) * ( V_210 + 1 ) ,
V_179 ) ) < 0 ) {
F_17 ( V_62 L_37 ,
( int ) sizeof( struct V_112 ) * ( V_210 + 1 ) ) ;
return V_21 ;
}
V_11 -> V_119 = (struct V_112 * ) V_179 -> V_192 ;
return F_93 ( V_105 ,
F_94 ( V_206 ) ) ;
}
static int F_95 ( struct V_104 * V_105 )
{
struct V_102 * V_103 = F_76 ( V_105 ) ;
struct V_109 * V_11 = F_77 ( V_105 ) ;
struct V_7 * V_8 = V_103 -> V_8 ;
...
struct V_107 * V_108 = V_105 -> V_108 ;
struct V_109 * V_11 ;
int V_211 = V_105 -> V_212 ;
V_103 -> V_113 [ V_211 ] = V_105 ;
V_108 -> V_213 = V_214 ;
V_11 = F_98 ( sizeof( struct V_109 ) , V_215 ) ;
if ( V_11 == NULL )
return - V_216 ;
V_11 -> V_188 = V_217 [ V_211 ] ;
V_11 -> V_91 = V_218 [ V_211 ] ;
V_11 -> V_27 = V_219 [ V_211 ] ;
V_11 -> V_89 [ 0 ] = 0xff ;
V_11 -> V_89 [ 1 ] = 0xff ;
V_11 -> V_116 = V_117 ;
V_108 -> V_115 = V_11 ;
...
static int F_104 ( struct V_102 * V_103 , int V_129 )
{
struct V_225 * V_135 ;
int V_21 ;
if ( ( V_21 =
F_105 ( V_103 -> V_132 , L_38 , V_129 , V_106 , 1 ,
& V_135 ) ) < 0 )
return V_21 ;
F_106 ( V_135 , V_226 ,
& V_227 ) ;
...
static T_4
F_108 ( int V_233 , void * V_101 )
{
struct V_102 * V_103 = V_101 ;
struct V_7 * V_8 = V_103 -> V_8 ;
if ( V_8 ) {
V_103 -> V_234 ++ ;
if ( F_109 ( V_8 -> V_56 ) || F_110 ( V_8 -> V_56 ) ||
F_111 ( V_8 -> V_56 ) ) {
V_103 -> V_235 ++ ;
F_112 ( & V_103 -> V_236 ) ;
}
if ( V_103 -> V_237 && F_113 ( V_8 -> V_56 ) ) {
V_103 -> V_235 ++ ;
F_114 ( V_233 ,
V_103 -> V_237 -> V_115 ) ;
}
...
static void
F_115 ( struct V_239 * V_136 , unsigned short V_240 ,
unsigned short V_20 )
{
...
static unsigned short F_116 ( struct V_239 * V_136 ,
...
if ( F_16 ( ! V_8 ) )
return 0 ;
if ( F_65 ( V_8 , V_240 , & V_44 ) != 0 )
F_65 ( V_8 , V_240 , & V_44 ) ;
F_8 ( L_41 , V_240 , V_44 . V_83 [ 1 ] ) ;
return V_44 . V_83 [ 1 ] ;
}
...
V_8 = V_103 -> V_8 ;
if ( ! V_8 ) {
if ( ( V_8 = F_98 ( sizeof( struct V_7 ) , V_215 ) ) == NULL )
return - V_216 ;
...
static int F_120 ( struct V_102 * V_103 )
{
struct V_7 * V_8 ;
if ( ! V_103 )
return 0 ;
...
if ( V_103 -> V_233 >= 0 )
F_121 ( V_103 -> V_233 , V_103 ) ;
F_122 ( V_103 -> V_147 ) ;
F_123 ( V_103 -> V_242 ) ;
F_102 ( V_103 ) ;
return 0 ;
}
static int F_124 ( struct V_243 * V_129 )
{
struct V_102 * V_103 = V_129 -> V_244 ;
return F_120 ( V_103 ) ;
}
static int
F_125 ( struct V_131 * V_132 , struct V_245 * V_148 ,
struct V_102 * * V_246 )
{
struct V_102 * V_103 ;
struct V_55 * V_56 ;
...
* V_246 = NULL ;
if ( ( V_21 = F_126 ( V_148 ) ) < 0 )
return V_21 ;
if ( ! ( V_103 = F_98 ( sizeof( struct V_102 ) , V_215 ) ) )
return - V_216 ;
F_117 ( & V_103 -> V_64 ) ;
V_103 -> V_132 = V_132 ;
V_103 -> V_148 = V_148 ;
V_103 -> V_233 = - 1 ;
V_103 -> V_180 = 0 ;
V_103 -> V_68 = F_127 ( V_148 , 0 ) ;
V_103 -> V_234 = 0 ;
V_103 -> V_235 = 0 ;
V_103 -> V_8 = NULL ;
F_128 ( & V_103 -> V_236 , F_43 , ( unsigned long ) V_103 ) ;
if ( ( V_103 -> V_242 =
F_129 ( V_103 -> V_68 , 64 , L_38 ) ) == NULL ) {
F_17 ( V_62
L_44 ,
...
F_130 ( V_56 ) ;
if ( F_131 ( V_148 -> V_233 , F_108 , V_250 ,
V_251 , V_103 ) ) {
F_17 ( V_62 L_45 ,
V_148 -> V_233 ) ;
F_120 ( V_103 ) ;
...
V_103 -> V_233 = V_148 -> V_233 ;
V_103 -> V_241 = V_148 -> V_129 ;
F_132 ( V_148 ) ;
if ( ( V_21 = F_56 ( V_103 ) ) < 0 ) {
F_120 ( V_103 ) ;
return V_21 ;
}
if ( ( V_21 = F_133 ( V_132 , V_252 , V_103 , & V_248 ) ) < 0 ) {
F_120 ( V_103 ) ;
return V_21 ;
}
* V_246 = V_103 ;
...
static void
F_134 ( struct V_253 * V_254 ,
struct V_255 * V_256 )
{
struct V_102 * V_103 = V_254 -> V_115 ;
struct V_109 * V_11 ;
int V_12 ;
struct V_7 * V_8 = NULL ;
...
if ( ! V_103 )
return;
F_135 ( V_256 , L_46 , V_103 -> V_132 -> V_257 ) ;
F_135 ( V_256 , L_47 ,
V_103 -> V_241 , V_103 -> V_235 , V_103 -> V_234 ) ;
for ( V_12 = 0 ; V_12 < 64 ; V_12 += 4 )
F_135 ( V_256 , L_48 ,
( V_12 % 16 ) ? ' ' : '\n' , V_12 , F_136 ( V_103 -> V_68 + V_12 ) ) ;
if ( ( V_8 = V_103 -> V_8 ) ) {
F_135 ( V_256 ,
L_49 ,
V_103 -> V_139 . V_139 . V_141 ,
V_103 -> V_139 . V_139 . V_142 ,
V_103 -> V_139 . V_139 . V_143 ,
V_103 -> V_139 . V_139 . V_144 ) ;
F_135 ( V_256 , L_50 ) ;
for ( V_12 = 0 ; V_12 < 12 ; V_12 ++ ) {
F_42 ( V_8 , V_12 , & V_81 , & V_82 ) ;
F_135 ( V_256 , L_51 , V_12 , V_81 , V_82 ) ;
}
F_135 ( V_256 ,
L_52 ,
V_8 -> V_75 , V_8 -> V_59 ,
...
while ( V_12 >= 2 ) {
V_12 -= 2 ;
F_135 ( V_256 , L_57 , V_13 [ V_12 ] , V_13 [ V_12 + 1 ] ) ;
}
F_135 ( V_256 , L_58 ) ;
}
static void F_137 ( struct V_102 * V_103 )
{
struct V_253 * V_254 ;
if ( ! F_138 ( V_103 -> V_132 , L_59 , & V_254 ) )
F_139 ( V_254 , V_103 , F_134 ) ;
}
static int F_140 ( struct V_102 * V_103 )
{
struct V_258 * V_259 ;
struct V_260 V_136 ;
int V_21 = 0 ;
static struct V_261 V_248 = {
. V_262 = F_115 ,
. V_263 = F_116 ,
} ;
...
V_136 . V_115 = V_103 ;
V_136 . V_264 = V_265 ;
if ( ( V_21 = V_258 ( V_103 -> V_132 , 0 , & V_248 , V_103 , & V_259 ) ) < 0 )
return V_21 ;
V_103 -> V_266 = V_259 ;
V_136 . V_148 = V_103 -> V_148 ;
if ( ( V_21 = F_141 ( V_259 , & V_136 , & V_103 -> V_136 ) ) < 0 )
return V_21 ;
return V_21 ;
}
static int
F_142 ( struct V_245 * V_148 , const struct V_267 * V_91 )
{
static int V_130 ;
struct V_268 * V_268 ;
int V_52 ;
...
static void F_147 ( struct V_245 * V_148 )
{
struct V_268 * V_268 = F_148 ( V_148 ) ;
if ( V_268 ) {
F_149 ( V_268 -> V_276 , 8 ) ;
F_150 ( V_268 ) ;
}
...
static int
F_151 ( struct V_245 * V_148 , const struct V_267 * V_277 )
{
static int V_130 ;
struct V_131 * V_132 ;
struct V_102 * V_103 ;
...
V_21 = F_152 ( & V_148 -> V_130 , V_278 [ V_130 ] , V_91 [ V_130 ] , V_279 ,
0 , & V_132 ) ;
if ( V_21 < 0 )
return V_21 ;
V_21 = F_125 ( V_132 , V_148 , & V_103 ) ;
if ( V_21 < 0 )
goto error;
V_132 -> V_115 = V_103 ;
V_21 = F_104 ( V_103 , 0 ) ;
...
if ( V_284 [ V_130 ] )
V_20 |= V_285 | V_286 ;
V_20 |= ( V_103 -> V_233 << 4 ) & 0xf0 ;
F_154 ( V_103 -> V_148 , V_287 , V_20 ) ;
if ( V_284 [ V_130 ] ) {
V_20 = V_284 [ V_130 ] ;
F_154 ( V_103 -> V_148 , V_288 , V_20 ) ;
V_21 = F_155 ( V_132 , 0 , V_289 ,
V_20 , V_290 , - 1 ,
& V_103 -> V_237 ) ;
if ( V_21 < 0 )
F_17 ( V_275
...
if ( V_281 [ V_130 ] ) {
V_20 = V_281 [ V_130 ] ;
F_154 ( V_103 -> V_148 , V_292 , V_20 ) ;
V_21 = F_156 ( V_132 , V_20 , V_20 + 2 ,
V_293 , 0 , & V_103 -> V_294 ) ;
if ( V_21 < 0 )
F_17 ( V_275
L_63 ,
...
V_103 -> V_295 = V_20 ;
V_21 = F_157 ( V_103 -> V_294 , 0 , 1 , NULL ) ;
if ( V_21 < 0 )
F_17 ( V_275
L_64 ) ;
}
...
if ( V_274 [ V_130 ] ) {
V_20 = V_274 [ V_130 ] ;
F_154 ( V_103 -> V_148 , V_296 , V_20 ) ;
V_103 -> V_297 = V_20 ;
}
#endif
strcpy ( V_132 -> V_298 , L_38 ) ;
strcpy ( V_132 -> V_299 , L_65 ) ;
#ifdef F_153
snprintf ( V_132 -> V_257 , sizeof( V_132 -> V_257 ) ,
L_66 ,
V_132 -> V_299 , V_103 -> V_68 , V_103 -> V_233 , V_103 -> V_291 ,
V_103 -> V_295 , V_103 -> V_297 ) ;
#else
snprintf ( V_132 -> V_257 , sizeof( V_132 -> V_257 ) ,
L_67 ,
V_132 -> V_299 , V_103 -> V_68 , V_103 -> V_233 , V_103 -> V_291 ,
...
static void F_160 ( struct V_245 * V_148 )
{
F_159 ( F_148 ( V_148 ) ) ;
}
