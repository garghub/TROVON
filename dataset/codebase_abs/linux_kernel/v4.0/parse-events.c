...
static char * F_43 ( struct V_29 * V_98 )
{
struct V_80 * V_81 ;
...
V_36 = F_18 ( V_30 , V_31 , & V_33 , NULL , V_102 -> V_35 ) ;
return V_36 ? 0 : - V_38 ;
}
if ( F_46 ( V_102 , V_97 , & V_100 ) )
return - V_10 ;
F_39 ( & V_33 , V_97 , 0 ) ;
if ( F_47 ( V_102 , & V_33 , V_97 ) )
return - V_10 ;
V_36 = F_18 ( V_30 , V_31 , & V_33 , F_43 ( V_97 ) ,
V_102 -> V_35 ) ;
if ( V_36 ) {
...
char * V_108 )
{
return F_49 ( V_30 , V_108 , true ) ;
}
void F_50 ( char * V_22 , struct V_29 * V_30 )
{
struct V_28 * V_109 ;
F_51 ( V_30 ) ;
V_109 = F_52 ( V_30 -> V_110 , struct V_28 , V_37 ) ;
V_109 -> V_111 = V_22 ? F_16 ( V_22 ) : NULL ;
}
void F_53 ( struct V_29 * V_112 ,
struct V_29 * V_113 )
{
F_54 ( V_112 , V_113 ) ;
free ( V_112 ) ;
}
static int F_55 ( struct V_114 * V_115 , char * V_23 ,
struct V_28 * V_36 )
{
...
int V_128 = 0 ;
int V_129 = V_36 ? V_36 -> V_33 . V_129 : 0 ;
int V_130 = V_116 | V_118 | V_120 ;
int V_131 = V_36 ? V_36 -> V_131 : 0 ;
memset ( V_115 , 0 , sizeof( * V_115 ) ) ;
while ( * V_23 ) {
if ( * V_23 == 'u' ) {
if ( ! V_130 )
V_130 = V_116 = V_118 = V_120 = 1 ;
V_116 = 0 ;
} else if ( * V_23 == 'k' ) {
if ( ! V_130 )
V_130 = V_116 = V_118 = V_120 = 1 ;
...
return - 1 ;
while ( * V_132 ) {
if ( * V_132 != 'p' && strchr ( V_132 + 1 , * V_132 ) )
return - 1 ;
V_132 ++ ;
}
return 0 ;
}
int F_49 ( struct V_29 * V_30 , char * V_23 , bool V_133 )
{
struct V_28 * V_36 ;
struct V_114 V_115 ;
if ( V_23 == NULL )
...
if ( F_56 ( V_23 ) )
return - V_10 ;
if ( ! V_133 && F_55 ( & V_115 , V_23 , NULL ) )
return - V_10 ;
F_57 (list, evsel) {
if ( V_133 && F_55 ( & V_115 , V_23 , V_36 ) )
return - V_10 ;
...
V_36 -> V_131 = V_115 . V_131 ;
V_36 -> V_128 = V_115 . V_128 ;
if ( F_58 ( V_36 ) )
V_36 -> V_33 . V_129 = V_115 . V_129 ;
}
return 0 ;
}
...
static int
F_60 ( const void * V_134 , const void * V_135 )
{
struct V_136 * V_137 = (struct V_136 * ) V_134 ;
struct V_136 * V_138 = (struct V_136 * ) V_135 ;
return strcmp ( V_137 -> V_139 , V_138 -> V_139 ) ;
}
...
int V_74 = 0 ;
V_102 = F_45 ( L_20 ) ;
if ( ( V_102 == NULL ) || F_63 ( & V_102 -> V_144 ) ) {
V_140 = - 1 ;
return;
}
F_40 (alias, &pmu->aliases, list) {
if ( strchr ( V_143 -> V_22 , '-' ) )
V_74 ++ ;
V_74 ++ ;
}
V_141 = malloc ( sizeof( struct V_136 ) * V_74 ) ;
if ( ! V_141 )
return;
V_140 = V_74 ;
V_74 = 0 ;
F_40 (alias, &pmu->aliases, list) {
struct V_136 * V_132 = V_141 + V_74 ;
char * V_145 = strchr ( V_143 -> V_22 , '-' ) ;
if ( V_145 != NULL ) {
F_64 ( F_15 ( V_143 -> V_22 , V_145 - V_143 -> V_22 ) ,
V_146 ) ;
V_132 ++ ;
F_64 ( F_16 ( ++ V_145 ) , V_147 ) ;
V_74 += 2 ;
} else {
F_64 ( F_16 ( V_143 -> V_22 ) , V_148 ) ;
V_74 ++ ;
}
}
qsort ( V_141 , V_74 ,
sizeof( struct V_136 ) , F_60 ) ;
return;
V_149:
F_61 () ;
}
...
{
struct V_136 V_132 , * V_151 ;
if ( V_140 == 0 )
F_62 () ;
if ( ( V_140 <= 0 ) || ! strcmp ( V_22 , L_20 ) )
return V_152 ;
V_132 . V_139 = F_16 ( V_22 ) ;
V_151 = bsearch ( & V_132 , V_141 ,
( V_153 ) V_140 ,
sizeof( struct V_136 ) , F_60 ) ;
free ( V_132 . V_139 ) ;
...
if ( ! F_86 ( type , V_42 ) )
continue;
if ( strlen ( V_192 -> V_143 ) )
snprintf ( V_22 , sizeof( V_22 ) , L_29 ,
V_192 -> V_139 , V_192 -> V_143 ) ;
else
snprintf ( V_22 , sizeof( V_22 ) , L_9 , V_192 -> V_139 ) ;
...
for ( V_42 = 0 ; V_42 < V_193 ; V_42 ++ , V_192 ++ ) {
if ( V_176 != NULL &&
! ( F_30 ( V_192 -> V_139 , V_176 ) ||
( V_192 -> V_143 && F_30 ( V_192 -> V_143 , V_176 ) ) ) )
continue;
if ( ! F_86 ( type , V_42 ) )
continue;
if ( V_177 ) {
printf ( L_30 , V_192 -> V_139 ) ;
continue;
}
if ( strlen ( V_192 -> V_143 ) )
snprintf ( V_22 , V_48 , L_29 , V_192 -> V_139 , V_192 -> V_143 ) ;
else
strncpy ( V_22 , V_192 -> V_139 , V_48 ) ;
printf ( L_28 , V_22 , V_181 [ type ] ) ;
V_199 ++ ;
}
if ( V_199 )
...
{
return V_81 -> V_82 != V_201 ;
}
static int F_98 ( struct V_80 * * V_202 , int V_203 ,
int V_82 , char * V_12 ,
char * V_23 , T_1 V_86 )
{
struct V_80 * V_81 ;
V_81 = F_12 ( sizeof( * V_81 ) ) ;
if ( ! V_81 )
return - V_38 ;
F_99 ( & V_81 -> V_30 ) ;
V_81 -> V_203 = V_203 ;
...
int F_100 ( struct V_80 * * V_81 ,
int V_82 , char * V_12 , T_1 V_86 )
{
return F_98 ( V_81 , V_204 , V_82 ,
V_12 , NULL , V_86 ) ;
}
int F_101 ( struct V_80 * * V_81 ,
int V_82 , char * V_12 , char * V_23 )
{
return F_98 ( V_81 , V_205 , V_82 ,
V_12 , V_23 , 0 ) ;
}
...
V_206 = & V_196 [ V_31 ] ;
if ( V_12 )
return F_98 ( V_81 , V_205 ,
V_201 , V_12 ,
( char * ) V_206 -> V_139 , 0 ) ;
else
return F_98 ( V_81 , V_205 ,
V_201 ,
( char * ) L_37 , ( char * ) V_206 -> V_139 , 0 ) ;
}
int F_104 ( struct V_80 * * V_207 ,
struct V_80 * V_81 )
{
return F_98 ( V_207 , V_81 -> V_203 , V_81 -> V_82 , V_81 -> V_12 ,
V_81 -> V_85 . V_23 , V_81 -> V_85 . V_86 ) ;
}
void F_76 ( struct V_29 * V_159 )
{
struct V_80 * V_81 , * V_208 ;
