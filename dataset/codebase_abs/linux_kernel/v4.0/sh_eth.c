...
static int F_71 ( struct V_6 * V_7 , T_1 V_185 , int * V_186 )
{
struct V_1 * V_2 = F_4 ( V_7 ) ;
struct V_99 * V_100 ;
...
if ( ! V_2 -> V_32 -> V_142 )
F_73 (
F_74 ( F_51 ( V_100 -> V_83 , 4 ) ) ,
V_189 + 2 ) ;
V_68 = V_2 -> V_95 [ V_180 ] ;
V_2 -> V_95 [ V_180 ] = NULL ;
if ( V_2 -> V_32 -> V_127 )
F_28 ( V_68 , V_128 ) ;
F_69 ( & V_7 -> V_114 , V_100 -> V_83 ,
F_51 ( V_2 -> V_106 , 16 ) ,
V_115 ) ;
F_75 ( V_68 , V_189 ) ;
V_68 -> V_207 = F_76 ( V_68 , V_7 ) ;
F_77 ( V_68 ) ;
V_7 -> V_182 . V_208 ++ ;
...
static void F_81 ( struct V_6 * V_7 , T_1 V_185 )
{
struct V_1 * V_2 = F_4 ( V_7 ) ;
T_1 V_212 ;
T_1 V_213 ;
...
if ( V_185 & V_232 ) {
V_7 -> V_182 . V_233 ++ ;
F_82 ( V_2 , V_229 , V_7 , L_4 ) ;
}
if ( V_185 & V_234 ) {
V_7 -> V_182 . V_233 ++ ;
F_82 ( V_2 , V_229 , V_7 , L_5 ) ;
}
if ( V_185 & V_210 ) {
V_7 -> V_182 . V_206 ++ ;
}
...
static T_6 F_84 ( int V_242 , void * V_243 )
{
...
static int F_90 ( struct V_251 * V_250 , int V_252 )
{
...
if ( V_260 ) {
struct V_259 * V_263 ;
V_263 = F_96 ( V_260 , L_9 , 0 ) ;
V_254 = F_97 ( V_7 , V_263 ,
F_92 , 0 ,
V_2 -> V_9 ) ;
if ( ! V_254 )
V_254 = F_98 ( - V_264 ) ;
...
V_48 = F_107 ( V_2 -> V_254 , V_273 ) ;
F_108 ( & V_2 -> V_246 , V_274 ) ;
return V_48 ;
}
...
return - V_275 ;
F_106 ( & V_2 -> V_246 , V_274 ) ;
V_48 = F_112 ( V_2 -> V_254 ) ;
F_108 ( & V_2 -> V_246 , V_274 ) ;
return V_48 ;
}
static T_1 F_113 ( struct V_6 * V_7 )
{
struct V_1 * V_2 = F_4 ( V_7 ) ;
return V_2 -> V_278 ;
}
static void F_114 ( struct V_6 * V_7 , T_1 V_8 )
{
struct V_1 * V_2 = F_4 ( V_7 ) ;
V_2 -> V_278 = V_8 ;
}
static int F_115 ( struct V_6 * V_243 , int V_279 )
{
switch ( V_279 ) {
case V_280 :
return V_281 ;
...
static void F_117 ( struct V_6 * V_7 , T_1 V_284 , T_8 * V_70 )
{
switch ( V_284 ) {
case V_280 :
memcpy ( V_70 , * V_285 ,
...
int V_48 = 0 ;
struct V_1 * V_2 = F_4 ( V_7 ) ;
F_127 ( & V_2 -> V_300 -> V_114 ) ;
F_128 ( & V_2 -> V_250 ) ;
V_48 = F_129 ( V_7 -> V_242 , F_84 ,
...
static int F_135 ( struct V_67 * V_68 , struct V_6 * V_7 )
{
struct V_1 * V_2 = F_4 ( V_7 ) ;
struct V_101 * V_102 ;
T_1 V_180 ;
...
static int F_141 ( struct V_6 * V_7 , struct V_321 * V_322 , int V_323 )
{
struct V_1 * V_2 = F_4 ( V_7 ) ;
struct V_253 * V_254 = V_2 -> V_254 ;
if ( ! F_120 ( V_7 ) )
...
if ( ! V_254 )
return - V_275 ;
return F_142 ( V_254 , V_322 , V_323 ) ;
}
static void * F_143 ( struct V_1 * V_2 ,
int V_180 )
{
return F_144 ( V_2 , V_324 ) + ( V_180 / 8 * 4 ) ;
}
static T_1 F_145 ( int V_180 )
{
return 0x0f << ( 28 - ( ( V_180 % 8 ) * 4 ) ) ;
}
static T_1 F_146 ( struct V_1 * V_2 , int V_180 )
{
...
V_3 = F_143 ( V_2 , V_180 ) ;
V_326 = F_13 ( V_3 ) ;
F_16 ( V_326 | F_146 ( V_2 , V_180 ) , V_3 ) ;
}
...
static int F_152 ( struct V_6 * V_7 , void * V_333 ,
const T_8 * V_83 )
{
T_1 V_135 ;
...
static void F_153 ( void * V_333 , T_8 * V_83 )
{
T_1 V_135 ;
V_135 = F_13 ( V_333 ) ;
...
static int F_154 ( struct V_6 * V_7 , const T_8 * V_83 )
{
struct V_1 * V_2 = F_4 ( V_7 ) ;
void * V_3 = F_144 ( V_2 , V_335 ) ;
int V_21 ;
T_8 V_336 [ V_80 ] ;
...
int V_48 ;
T_8 V_338 [ V_80 ] ;
F_20 ( V_2 , F_150 ( V_2 , V_339 ) &
~ ( 1 << ( 31 - V_180 ) ) , V_339 ) ;
memset ( V_338 , 0 , sizeof( V_338 ) ) ;
V_48 = F_152 ( V_7 , V_3 + V_180 * 8 , V_338 ) ;
if ( V_48 < 0 )
return V_48 ;
return 0 ;
}
static int F_158 ( struct V_6 * V_7 , const T_8 * V_83 )
{
struct V_1 * V_2 = F_4 ( V_7 ) ;
void * V_3 = F_144 ( V_2 , V_335 ) ;
int V_21 , V_48 ;
...
if ( V_21 < 0 )
return - V_130 ;
V_48 = F_152 ( V_7 , V_3 + V_21 * 8 , V_83 ) ;
if ( V_48 < 0 )
return V_48 ;
F_20 ( V_2 , F_150 ( V_2 , V_339 ) |
( 1 << ( 31 - V_21 ) ) , V_339 ) ;
...
static int F_159 ( struct V_6 * V_7 , const T_8 * V_83 )
{
struct V_1 * V_2 = F_4 ( V_7 ) ;
int V_21 , V_48 ;
if ( ! V_2 -> V_32 -> V_340 )
...
struct V_349 * V_350 ;
F_164 (ha, ndev) {
if ( V_343 && F_162 ( V_350 -> V_83 ) )
continue;
if ( F_158 ( V_7 , V_350 -> V_83 ) < 0 ) {
if ( ! V_343 ) {
F_161 ( V_7 ) ;
V_342 &= ~ V_345 ;
V_343 = 1 ;
...
V_89 = F_174 ( V_114 , sizeof( struct V_88 ) , V_129 ) ;
if ( ! V_89 )
return - V_130 ;
...
V_2 -> V_268 -> V_242 = F_176 ( V_114 , V_393 , sizeof( int ) ,
V_129 ) ;
if ( ! V_2 -> V_268 -> V_242 ) {
V_48 = - V_130 ;
goto V_394;
...
static const T_5 * F_179 ( int V_398 )
{
const T_5 * V_3 = NULL ;
switch ( V_398 ) {
case V_399 :
...
static struct V_381 * F_180 ( struct V_384 * V_114 )
{
struct V_259 * V_260 = V_114 -> V_262 ;
struct V_381 * V_407 ;
const char * V_408 ;
V_407 = F_174 ( V_114 , sizeof( * V_407 ) , V_129 ) ;
if ( ! V_407 )
return NULL ;
V_407 -> V_9 = F_181 ( V_260 ) ;
V_408 = F_182 ( V_260 ) ;
if ( V_408 )
...
static inline struct V_381 * F_180 ( struct V_384 * V_114 )
{
return NULL ;
}
static int F_184 ( struct V_383 * V_300 )
{
int V_48 , V_409 = 0 ;
struct V_410 * V_411 ;
struct V_6 * V_7 = NULL ;
struct V_1 * V_2 = NULL ;
struct V_381 * V_382 = F_185 ( & V_300 -> V_114 ) ;
const struct V_412 * V_269 = F_186 ( V_300 ) ;
V_411 = F_187 ( V_300 , V_413 , 0 ) ;
V_7 = F_188 ( sizeof( struct V_1 ) ) ;
if ( ! V_7 )
return - V_130 ;
F_189 ( & V_300 -> V_114 ) ;
F_127 ( & V_300 -> V_114 ) ;
...
V_7 -> V_242 = V_48 ;
F_191 ( V_7 , & V_300 -> V_114 ) ;
V_2 = F_4 ( V_7 ) ;
V_2 -> V_98 = V_416 ;
V_2 -> V_96 = V_417 ;
V_2 -> V_83 = F_192 ( & V_300 -> V_114 , V_411 ) ;
if ( F_100 ( V_2 -> V_83 ) ) {
V_48 = F_101 ( V_2 -> V_83 ) ;
goto V_415;
}
...
V_382 = F_180 ( & V_300 -> V_114 ) ;
if ( ! V_382 ) {
F_194 ( & V_300 -> V_114 , L_22 ) ;
V_48 = - V_296 ;
goto V_415;
}
...
V_421 = F_195 ( F_196 ( V_422 ) ,
& V_300 -> V_114 ) ;
V_2 -> V_32 = (struct V_31 * ) V_421 -> V_70 ;
}
V_2 -> V_3 = F_179 ( V_2 -> V_32 -> V_398 ) ;
if ( ! V_2 -> V_3 ) {
F_194 ( & V_300 -> V_114 , L_23 ,
V_2 -> V_32 -> V_398 ) ;
V_48 = - V_296 ;
goto V_415;
}
...
if ( V_2 -> V_32 -> V_340 ) {
struct V_410 * V_431 ;
V_431 = F_187 ( V_300 , V_413 , 1 ) ;
V_2 -> V_432 = F_192 ( & V_300 -> V_114 , V_431 ) ;
if ( F_100 ( V_2 -> V_432 ) ) {
V_48 = F_101 ( V_2 -> V_432 ) ;
goto V_415;
}
V_2 -> V_325 = V_409 % 2 ;
V_7 -> V_433 = V_434 ;
...
if ( V_2 -> V_32 -> V_136 )
F_6 ( V_7 , 0x1 , V_137 ) ;
V_48 = F_173 ( V_2 , V_382 ) ;
if ( V_48 ) {
F_194 ( & V_7 -> V_114 , L_25 ) ;
goto V_415;
}
F_200 ( V_7 , & V_2 -> V_250 , F_90 , 64 ) ;
V_48 = F_201 ( V_7 ) ;
if ( V_48 )
goto V_437;
F_102 ( V_7 , L_26 ,
...
static int F_207 ( struct V_383 * V_300 )
{
struct V_6 * V_7 = F_208 ( V_300 ) ;
struct V_1 * V_2 = F_4 ( V_7 ) ;
F_209 ( V_7 ) ;
F_204 ( & V_2 -> V_250 ) ;
F_170 ( V_2 ) ;
...
static int F_210 ( struct V_384 * V_114 )
{
struct V_6 * V_7 = F_211 ( V_114 ) ;
int V_48 = 0 ;
if ( F_120 ( V_7 ) ) {
F_121 ( V_7 ) ;
V_48 = F_138 ( V_7 ) ;
...
static int F_212 ( struct V_384 * V_114 )
{
struct V_6 * V_7 = F_211 ( V_114 ) ;
int V_48 = 0 ;
if ( F_120 ( V_7 ) ) {
...
static int F_213 ( struct V_384 * V_114 )
{
return 0 ;
}
