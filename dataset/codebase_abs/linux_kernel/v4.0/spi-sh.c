...
static T_1 F_34 ( int V_67 , void * V_68 )
{
...
V_63 = F_46 ( & V_71 -> V_76 , sizeof( struct V_1 ) ) ;
if ( V_63 == NULL ) {
F_44 ( & V_71 -> V_76 , L_8 ) ;
return - V_79 ;
}
...
V_2 -> V_67 = V_67 ;
V_2 -> V_63 = V_63 ;
V_2 -> V_6 = F_48 ( & V_71 -> V_76 , V_73 -> V_84 , F_49 ( V_73 ) ) ;
if ( V_2 -> V_6 == NULL ) {
F_44 ( & V_71 -> V_76 , L_10 ) ;
V_25 = - V_79 ;
goto V_83;
...
V_25 = F_56 ( V_67 , F_34 , 0 , L_12 , V_2 ) ;
if ( V_25 < 0 ) {
F_44 ( & V_71 -> V_76 , L_13 ) ;
goto V_87;
}
