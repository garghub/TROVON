...
F_48 ( V_172 , & V_156 -> V_159 ) ;
struct V_17 * V_18 ;
struct V_9 * V_10 ;
struct V_99 * V_100 ;
int V_173 ;
struct V_1 * V_19 ;
V_10 = F_49 ( V_156 , & V_174 , 0 ) ;
if ( F_33 ( V_10 ) )
return F_50 ( V_10 ) ;
V_18 = F_9 ( V_10 ) ;
V_19 = F_51 ( & V_156 -> V_159 , sizeof( * V_19 ) , V_175 ) ;
if ( ! V_19 ) {
V_173 = - V_176 ;
goto V_177;
}
V_19 -> V_3 = V_171 ? V_171 -> V_2 : (struct V_178 * )
V_156 -> V_179 -> V_180 ;
V_18 -> V_20 = V_19 ;
V_19 -> V_181 = F_52 ( & V_156 -> V_159 , L_16 ) ;
if ( F_33 ( V_19 -> V_181 ) ) {
V_173 = F_50 ( V_19 -> V_181 ) ;
goto V_177;
}
V_19 -> V_182 = F_52 ( & V_156 -> V_159 , L_17 ) ;
if ( F_33 ( V_19 -> V_182 ) ) {
V_173 = F_50 ( V_19 -> V_182 ) ;
goto V_177;
}
V_19 -> V_183 = F_52 ( & V_156 -> V_159 , L_18 ) ;
if ( F_33 ( V_19 -> V_183 ) ) {
V_173 = F_50 ( V_19 -> V_183 ) ;
goto V_177;
}
V_18 -> V_184 = V_19 -> V_183 ;
V_18 -> clock = F_53 ( V_18 -> V_184 ) ;
F_54 ( V_19 -> V_183 ) ;
F_54 ( V_19 -> V_181 ) ;
F_54 ( V_19 -> V_182 ) ;
V_19 -> V_134 = F_55 ( & V_156 -> V_159 ) ;
if ( F_33 ( V_19 -> V_134 ) ) {
V_173 = F_50 ( V_19 -> V_134 ) ;
goto V_185;
}
V_19 -> V_135 = F_56 ( V_19 -> V_134 ,
V_186 ) ;
if ( F_33 ( V_19 -> V_135 ) )
F_57 ( F_23 ( V_10 -> V_105 ) , L_19 ) ;
V_10 -> V_187 |= V_188 ;
if ( V_19 -> V_3 -> V_7 & V_189 )
V_10 -> V_187 |= V_190
| V_191 ;
if ( F_4 ( V_19 ) ) {
F_6 ( 0x08100810 , V_10 -> V_15 + V_192 ) ;
V_10 -> V_193 |= V_194 ;
V_10 -> V_105 -> V_195 |= V_196 ;
}
if ( V_19 -> V_3 -> V_7 & V_63 )
V_197 . V_198 =
F_30 ;
if ( V_19 -> V_3 -> V_7 & V_65 )
F_6 ( F_7 ( V_10 -> V_15 + V_199 ) |
V_200 | V_201 ,
V_10 -> V_15 + V_199 ) ;
V_100 = & V_19 -> V_100 ;
if ( F_41 ( V_156 , V_100 ) < 0 ) {
if ( ! V_10 -> V_105 -> V_202 -> V_203 ) {
F_58 ( F_23 ( V_10 -> V_105 ) , L_20 ) ;
V_173 = - V_138 ;
goto V_185;
}
V_19 -> V_100 = * ( (struct V_99 * )
V_10 -> V_105 -> V_202 -> V_203 ) ;
}
if ( V_100 -> V_113 == V_114 ) {
V_173 = F_59 ( V_10 -> V_105 , V_100 -> V_167 ) ;
if ( V_173 ) {
F_58 ( F_23 ( V_10 -> V_105 ) ,
L_21 ) ;
goto V_185;
}
V_10 -> V_105 -> V_204 |= V_205 ;
}
switch ( V_100 -> V_162 ) {
case V_166 :
V_173 = F_60 ( V_10 -> V_105 , V_100 -> V_165 , 0 ) ;
if ( V_173 ) {
F_58 ( F_23 ( V_10 -> V_105 ) ,
L_22 ) ;
goto V_185;
...
switch ( V_100 -> V_168 ) {
case 8 :
V_10 -> V_105 -> V_195 |= V_209 | V_210 ;
break;
case 4 :
V_10 -> V_105 -> V_195 |= V_210 ;
break;
case 1 :
default:
V_10 -> V_187 |= V_211 ;
...
! F_33 ( V_19 -> V_135 ) ) {
V_19 -> V_136 = F_56 ( V_19 -> V_134 ,
V_212 ) ;
V_19 -> V_137 = F_56 ( V_19 -> V_134 ,
V_213 ) ;
if ( F_33 ( V_19 -> V_136 ) ||
F_33 ( V_19 -> V_137 ) ) {
F_57 ( F_23 ( V_10 -> V_105 ) ,
L_23 ) ;
V_10 -> V_193 |= V_214 ;
}
} else {
...
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
int V_215 = ( F_7 ( V_10 -> V_15 + V_36 ) == 0xffffffff ) ;
F_71 ( & V_156 -> V_159 ) ;
F_72 ( & V_156 -> V_159 ) ;
F_73 ( & V_156 -> V_159 ) ;
F_74 ( V_10 , V_215 ) ;
...
static int F_75 ( struct V_216 * V_159 )
{
...
static int F_79 ( struct V_216 * V_159 )
{
struct V_9 * V_10 = F_76 ( V_159 ) ;
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
