...
F_1 ( V_2 , V_21 ,
V_50 -> V_22 . V_4 ) ;
F_12 ( & V_49 -> V_40 , L_3 , V_50 -> V_22 . V_52 ,
V_50 -> V_22 . V_17 ) ;
V_50 -> V_32 = F_20 (
V_26 ,
& V_50 -> V_22 ,
& V_50 -> V_30 , & V_50 -> V_31 ) ;
if ( V_50 -> V_24 . V_53 . V_52 < 0 ) {
F_19 ( V_25 ,
V_54 , V_42 ,
V_55 |
V_56 ,
...
struct V_10 * V_11 ;
struct V_16 * V_16 ;
struct V_41 * V_25 = V_49 -> V_40 . V_58 ;
struct V_1 * V_2 ;
V_11 = F_22 ( & V_49 -> V_40 , sizeof( struct V_16 ) ) ;
if ( ! V_11 )
return - V_59 ;
F_23 ( V_49 , V_11 ) ;
V_16 = F_3 ( V_11 ) ;
...
V_2 = F_26 ( V_60 , sizeof( V_60 ) , V_61 ) ;
if ( ! V_2 ) {
F_25 ( & V_49 -> V_40 , L_7 ) ;
return - V_59 ;
}
V_37 = F_18 ( V_49 , V_25 , V_2 ,
V_26 , V_16 ) ;
if ( V_37 ) {
F_25 ( & V_49 -> V_40 , L_8 ) ;
goto V_62;
