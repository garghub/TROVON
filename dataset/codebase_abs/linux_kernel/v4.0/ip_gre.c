...
if ( V_54 [ V_126 ] )
V_33 -> V_11 . V_30 = F_66 ( V_54 [ V_126 ] ) ;
if ( V_54 [ V_121 ] )
V_33 -> V_11 . V_29 = F_66 ( V_54 [ V_121 ] ) ;
if ( V_54 [ V_127 ] )
V_33 -> V_11 . V_34 = F_67 ( V_54 [ V_127 ] ) ;
if ( V_54 [ V_128 ] )
V_33 -> V_11 . V_88 = F_67 ( V_54 [ V_128 ] ) ;
if ( ! V_54 [ V_129 ] || F_67 ( V_54 [ V_129 ] ) )
V_33 -> V_11 . V_74 = F_4 ( V_75 ) ;
}
static bool F_68 ( struct V_115 * V_54 [] ,
struct V_130 * V_131 )
{
bool V_132 = false ;
...
if ( V_54 [ V_133 ] ) {
V_132 = true ;
V_131 -> type = F_69 ( V_54 [ V_133 ] ) ;
}
if ( V_54 [ V_134 ] ) {
V_132 = true ;
V_131 -> V_28 = F_69 ( V_54 [ V_134 ] ) ;
}
if ( V_54 [ V_135 ] ) {
V_132 = true ;
...
static int F_70 ( struct V_41 * V_7 )
{
F_48 ( V_7 ) ;
V_7 -> V_139 |= V_140 ;
return F_53 ( V_7 ) ;
}
static void F_71 ( struct V_41 * V_7 )
{
F_72 ( V_7 ) ;
V_7 -> V_95 = & V_141 ;
V_7 -> V_139 |= V_140 ;
...
static int F_73 ( struct V_6 * V_142 , struct V_41 * V_7 ,
...
if ( F_68 ( V_54 , & V_131 ) ) {
struct V_13 * V_14 = F_14 ( V_7 ) ;
int V_63 = F_74 ( V_14 , & V_131 ) ;
if ( V_63 < 0 )
return V_63 ;
}
F_64 ( V_54 , V_116 , & V_65 ) ;
return F_75 ( V_7 , V_116 , & V_65 ) ;
}
static int F_76 ( struct V_41 * V_7 , struct V_115 * V_116 [] ,
struct V_115 * V_54 [] )
{
struct V_64 V_65 ;
struct V_130 V_131 ;
...
F_64 ( V_54 , V_116 , & V_65 ) ;
return F_77 ( V_7 , V_116 , & V_65 ) ;
}
static T_7 F_78 ( const struct V_41 * V_7 )
{
return
F_79 ( 4 ) +
F_79 ( 2 ) +
...
static int F_80 ( struct V_1 * V_2 , const struct V_41 * V_7 )
{
struct V_13 * V_14 = F_14 ( V_7 ) ;
struct V_64 * V_65 = & V_14 -> V_33 ;
if ( F_81 ( V_2 , V_122 , V_65 -> V_89 ) ||
F_82 ( V_2 , V_117 , F_31 ( V_65 -> V_76 ) ) ||
F_82 ( V_2 , V_118 , F_31 ( V_65 -> V_43 ) ) ||
F_83 ( V_2 , V_123 , V_65 -> V_124 ) ||
F_83 ( V_2 , V_125 , V_65 -> V_44 ) ||
F_83 ( V_2 , V_126 , V_65 -> V_11 . V_30 ) ||
F_83 ( V_2 , V_121 , V_65 -> V_11 . V_29 ) ||
F_84 ( V_2 , V_127 , V_65 -> V_11 . V_34 ) ||
F_84 ( V_2 , V_128 , V_65 -> V_11 . V_88 ) ||
F_84 ( V_2 , V_129 ,
...
static int T_4 F_86 ( struct V_6 * V_6 )
{
return F_55 ( V_6 , V_25 , & V_146 , NULL ) ;
}
static void T_5 F_87 ( struct V_6 * V_6 )
{
