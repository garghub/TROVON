...
struct V_1 * V_2 ;
enum V_60 type ;
unsigned long V_61 = F_18 ( V_53 , V_62 ) >> V_10 ;
T_3 V_63 ;
int V_64 ;
V_7 = F_19 ( V_7 , V_62 ) ;
if ( V_54 ) {
...
* V_59 = NULL ;
V_63 = F_20 ( & V_6 -> V_68 . V_69 , V_7 ,
sizeof( struct V_1 ) ) ;
V_2 = F_21 ( sizeof( struct V_1 ) , V_70 ) ;
if ( V_2 == NULL )
return - V_71 ;
V_64 = F_22 ( V_6 -> V_72 , & V_2 -> V_21 , V_7 ) ;
if ( F_23 ( V_64 ) ) {
F_14 ( V_2 ) ;
return V_64 ;
}
...
int F_32 ( struct V_1 * V_2 , void * * V_80 )
{
bool V_81 ;
int V_64 ;
if ( V_2 -> V_82 ) {
...
V_64 = F_33 ( & V_2 -> V_8 , 0 , V_2 -> V_8 . V_9 , & V_2 -> V_83 ) ;
if ( V_64 ) {
return V_64 ;
}
V_2 -> V_82 = F_34 ( & V_2 -> V_83 , & V_81 ) ;
if ( V_80 ) {
* V_80 = V_2 -> V_82 ;
}
F_35 ( V_2 , 0 , 0 ) ;
...
int F_42 ( struct V_1 * V_2 , T_2 V_24 , T_1 V_84 ,
T_1 * V_85 )
{
int V_64 , V_26 ;
if ( F_43 ( V_2 -> V_8 . V_86 ) )
return - V_87 ;
if ( V_2 -> V_88 ) {
V_2 -> V_88 ++ ;
if ( V_85 )
...
* V_85 = F_44 ( V_2 ) ;
if ( V_24 == V_30 )
V_2 -> V_6 -> V_93 += F_48 ( V_2 ) ;
else
V_2 -> V_6 -> V_94 += F_48 ( V_2 ) ;
} else {
F_49 ( V_2 -> V_6 -> V_95 , L_3 , V_2 ) ;
}
return V_64 ;
}
int F_50 ( struct V_1 * V_2 , T_2 V_24 , T_1 * V_85 )
{
return F_42 ( V_2 , V_24 , 0 , V_85 ) ;
}
int F_51 ( struct V_1 * V_2 )
{
int V_64 , V_26 ;
if ( ! V_2 -> V_88 ) {
F_52 ( V_2 -> V_6 -> V_95 , L_4 , V_2 ) ;
return 0 ;
}
V_2 -> V_88 -- ;
if ( V_2 -> V_88 )
...
{
if ( ! V_6 -> V_102 ) {
V_6 -> V_33 . V_103 = F_59 ( V_6 -> V_33 . V_104 ,
V_6 -> V_33 . V_105 ) ;
}
F_60 ( L_8 ,
V_6 -> V_33 . V_106 >> 20 ,
...
T_1 V_111 = V_110 >> 1 ;
return F_67 ( V_111 , 1024 * 1024ull ) ;
}
...
T_1 V_111 = F_65 ( V_6 ) ;
F_24 ( & V_119 ) ;
V_64 = F_69 ( V_113 , V_115 , true , & V_119 ) ;
if ( F_23 ( V_64 != 0 ) ) {
return V_64 ;
}
...
V_134 -> V_2 = V_2 ;
V_140:
F_78 ( V_6 , V_26 , V_2 -> V_132 , V_2 -> V_142 ,
...
int F_35 ( struct V_1 * V_2 , bool V_162 ,
bool V_163 )
{
if ( ! V_163 )
F_75 ( & V_2 -> V_8 . V_58 -> V_137 . V_138 ) ;
...
{
int V_64 ;
V_64 = F_88 ( & V_2 -> V_8 , true , V_168 , false , NULL ) ;
if ( F_23 ( V_64 != 0 ) )
return V_64 ;
if ( V_3 )
* V_3 = V_2 -> V_8 . V_16 . V_3 ;
V_64 = F_89 ( & V_2 -> V_8 , true , true , V_168 ) ;
F_90 ( & V_2 -> V_8 ) ;
return V_64 ;
}
void F_91 ( struct V_1 * V_2 , struct V_169 * V_170 ,
bool V_171 )
{
