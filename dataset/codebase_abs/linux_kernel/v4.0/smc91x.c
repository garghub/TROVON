...
struct V_12 * V_13 ;
struct V_10 * V_284 ;
struct V_287 * V_288 , * V_315 ;
unsigned int T_2 * V_205 ;
unsigned long V_256 = V_316 ;
int V_216 ;
...
V_315 = F_188 ( V_283 , V_337 , 0 ) ;
if ( ! V_315 ) {
V_216 = - V_260 ;
goto V_338;
}
V_284 -> V_182 = V_315 -> V_290 ;
if ( V_256 == - 1 || V_315 -> V_28 & V_339 )
V_256 = V_315 -> V_28 & V_339 ;
...
static int F_199 ( struct V_303 * V_11 )
{
struct V_282 * V_283 = F_200 ( V_11 ) ;
struct V_10 * V_284 = F_155 ( V_283 ) ;
if ( V_284 ) {
if ( F_201 ( V_284 ) ) {
F_202 ( V_284 ) ;
...
static int F_203 ( struct V_303 * V_11 )
{
struct V_282 * V_283 = F_200 ( V_11 ) ;
struct V_10 * V_284 = F_155 ( V_283 ) ;
if ( V_284 ) {
