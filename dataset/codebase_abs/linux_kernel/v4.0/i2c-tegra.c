...
F_42 ( V_2 -> V_19 , L_8 ,
V_40 , F_44 ( & V_2 -> V_84 ) , V_2 -> V_74 ) ;
if ( F_45 ( V_2 -> V_74 == V_92 ) )
return 0 ;
if ( V_2 -> V_74 == V_76 )
F_32 ( F_46 ( 2 * 1000000 , V_2 -> V_114 ) ) ;
F_30 ( V_2 ) ;
if ( V_2 -> V_74 == V_76 ) {
if ( V_87 -> V_93 & V_109 )
return 0 ;
...
static int F_47 ( struct V_117 * V_118 , struct V_86 V_119 [] ,
int V_120 )
{
struct V_1 * V_2 = F_48 ( V_118 ) ;
int V_121 ;
int V_40 = 0 ;
if ( V_2 -> V_122 )
return - V_123 ;
...
V_40 = F_40 ( V_2 , & V_119 [ V_121 ] , V_124 ) ;
if ( V_40 )
break;
}
F_29 ( V_2 ) ;
...
static T_1 F_49 ( struct V_117 * V_118 )
{
struct V_1 * V_2 = F_48 ( V_118 ) ;
...
static int F_50 ( struct V_133 * V_134 )
{
struct V_1 * V_2 ;
struct V_135 * V_136 ;
struct V_137 * V_44 ;
...
V_5 = F_52 ( & V_134 -> V_19 , V_136 ) ;
if ( F_53 ( V_5 ) )
return F_54 ( V_5 ) ;
V_136 = F_51 ( V_134 , V_141 , 0 ) ;
if ( ! V_136 ) {
F_27 ( & V_134 -> V_19 , L_9 ) ;
return - V_91 ;
}
V_65 = V_136 -> V_142 ;
V_44 = F_55 ( & V_134 -> V_19 , L_10 ) ;
if ( F_53 ( V_44 ) ) {
F_27 ( & V_134 -> V_19 , L_11 ) ;
return F_54 ( V_44 ) ;
}
V_2 = F_56 ( & V_134 -> V_19 , sizeof( * V_2 ) , V_143 ) ;
if ( ! V_2 )
return - V_144 ;
V_2 -> V_5 = V_5 ;
V_2 -> V_44 = V_44 ;
...
V_2 -> V_19 = & V_134 -> V_19 ;
V_2 -> V_47 = F_57 ( & V_134 -> V_19 , L_12 ) ;
if ( F_53 ( V_2 -> V_47 ) ) {
F_27 ( & V_134 -> V_19 , L_13 ) ;
return F_54 ( V_2 -> V_47 ) ;
}
V_40 = F_58 ( V_2 -> V_19 -> V_149 , L_14 ,
& V_2 -> V_114 ) ;
if ( V_40 )
V_2 -> V_114 = 100000 ;
V_2 -> V_41 = & V_150 ;
...
V_152 = F_59 ( V_153 , & V_134 -> V_19 ) ;
V_2 -> V_41 = V_152 -> V_8 ;
V_2 -> V_6 = F_60 ( V_134 -> V_19 . V_149 ,
L_15 ) ;
...
F_61 ( & V_2 -> V_84 ) ;
if ( ! V_2 -> V_41 -> V_42 ) {
V_43 = F_55 ( & V_134 -> V_19 , L_16 ) ;
if ( F_53 ( V_43 ) ) {
F_27 ( & V_134 -> V_19 , L_17 ) ;
return F_54 ( V_43 ) ;
}
V_2 -> V_43 = V_43 ;
}
...
V_40 = F_30 ( V_2 ) ;
if ( V_40 ) {
F_27 ( & V_134 -> V_19 , L_20 ) ;
goto V_155;
}
V_40 = F_65 ( & V_134 -> V_19 , V_2 -> V_65 ,
F_35 , 0 , F_66 ( & V_134 -> V_19 ) , V_2 ) ;
if ( V_40 ) {
F_27 ( & V_134 -> V_19 , L_21 , V_2 -> V_65 ) ;
goto V_155;
}
F_67 ( & V_2 -> V_145 , V_2 ) ;
V_2 -> V_145 . V_156 = V_157 ;
V_2 -> V_145 . V_158 = V_159 ;
F_68 ( V_2 -> V_145 . V_160 , L_22 ,
...
static int F_74 ( struct V_163 * V_19 )
{
...
static int F_78 ( struct V_163 * V_19 )
{
struct V_1 * V_2 = F_75 ( V_19 ) ;
int V_40 ;
F_76 ( & V_2 -> V_145 ) ;
