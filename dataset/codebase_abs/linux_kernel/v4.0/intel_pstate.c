...
static void F_58 ( struct V_23 * V_24 , int * V_38 , int * V_39 )
{
...
static void F_59 ( struct V_23 * V_24 , int V_35 )
{
int V_74 , V_77 ;
F_15 () ;
F_58 ( V_24 , & V_77 , & V_74 ) ;
...
return;
F_60 ( V_35 * V_24 -> V_35 . V_101 , V_24 -> V_24 ) ;
...
V_110 = F_63 ( V_110 , F_7 ( V_109 -> V_112 ) ) ;
V_109 -> V_41 = F_5 (
F_1 ( F_7 (
...
static inline void F_64 ( struct V_23 * V_24 )
{
T_2 V_111 , V_112 ;
unsigned long V_114 ;
F_65 ( V_114 ) ;
...
static inline void F_68 ( struct V_23 * V_24 )
{
int V_120 ;
V_120 = F_69 ( 50 ) ;
F_70 ( & V_24 -> V_121 , V_122 + V_120 ) ;
}
static inline void F_71 ( struct V_23 * V_24 )
{
int V_120 ;
V_120 = F_69 ( V_25 . V_123 ) ;
F_70 ( & V_24 -> V_121 , V_122 + V_120 ) ;
}
static inline T_1 F_72 ( struct V_23 * V_24 )
{
...
V_126 = ( V_49 ) F_73 ( V_24 -> V_109 . time ,
V_24 -> V_117 ) ;
if ( V_126 > V_127 * 3 ) {
V_125 = F_2 ( F_7 ( V_127 ) ,
F_7 ( V_126 ) ) ;
...
F_59 ( V_24 , V_24 -> V_35 . V_100 - V_130 ) ;
}
static void F_75 ( unsigned long V_131 )
{
...
static int F_78 ( unsigned int V_132 )
{
struct V_23 * V_24 ;
if ( ! V_29 [ V_132 ] )
V_29 [ V_132 ] = F_79 ( sizeof( struct V_23 ) ,
V_133 ) ;
if ( ! V_29 [ V_132 ] )
return - V_134 ;
V_24 = V_29 [ V_132 ] ;
...
V_24 -> V_121 . V_137 = F_75 ;
F_12 ( V_24 ) ;
F_64 ( V_24 ) ;
F_81 ( & V_24 -> V_121 , V_132 ) ;
F_82 ( L_7 , V_132 ) ;
return 0 ;
}
static unsigned int F_83 ( unsigned int V_138 )
{
struct V_109 * V_109 ;
struct V_23 * V_24 ;
V_24 = V_29 [ V_138 ] ;
...
F_90 ( V_140 -> V_24 , V_140 -> V_149 ) ;
return 0 ;
}
static int F_91 ( void )
{
T_2 V_111 , V_112 , V_150 ;
F_16 ( V_115 , V_111 ) ;
F_16 ( V_116 , V_112 ) ;
if ( ! V_102 . V_105 () ||
! V_102 . V_104 () ||
...
static void F_92 ( struct V_151 * V_140 )
{
...
static void F_93 ( struct V_102 * V_152 )
{
V_102 . V_105 = V_152 -> V_105 ;
V_102 . V_104 = V_152 -> V_104 ;
V_102 . V_106 = V_152 -> V_106 ;
V_102 . V_107 = V_152 -> V_107 ;
V_102 . V_103 = V_152 -> V_103 ;
V_102 . V_108 = V_152 -> V_108 ;
}
...
T_7 V_153 ;
union V_154 * V_155 ;
struct V_156 V_157 = { V_158 , NULL } ;
struct V_159 * V_160 = F_96 ( V_161 , V_52 ) ;
if ( ! V_160 )
continue;
V_153 = F_97 ( V_160 -> V_162 , L_9 , NULL , & V_157 ) ;
if ( F_98 ( V_153 ) )
continue;
V_155 = V_157 . V_163 ;
if ( V_155 && V_155 -> type == V_164 ) {
F_99 ( V_155 ) ;
return false ;
}
F_99 ( V_155 ) ;
...
if ( V_174 ||
F_98 ( F_104 ( V_175 , 0 , & V_166 ) ) )
return false ;
for ( V_168 = V_176 ; V_168 -> V_177 ; V_168 ++ ) {
if ( ! strncmp ( V_166 . V_178 , V_168 -> V_178 , V_179 ) &&
! strncmp ( V_166 . V_180 , V_168 -> V_180 ,
V_181 ) )
switch ( V_168 -> V_182 ) {
case V_183 :
return F_94 () ;
...
if ( F_102 () )
return - V_143 ;
V_187 = (struct V_186 * ) V_170 -> V_193 ;
F_92 ( & V_187 -> V_194 ) ;
F_93 ( & V_187 -> V_152 ) ;
if ( F_91 () )
return - V_143 ;
F_45 ( L_11 ) ;
V_29 = F_106 ( sizeof( void * ) * F_107 () ) ;
if ( ! V_29 )
return - V_134 ;
if ( F_108 ( V_189 , V_195 ) && ! V_196 )
F_44 () ;
if ( ! V_53 && V_197 )
goto V_198;
V_79 = F_109 ( & V_199 ) ;
...
static int T_3 F_111 ( char * V_200 )
{
if ( ! V_200 )
return - V_70 ;
