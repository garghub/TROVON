...
void F_33 ( struct V_23 * V_24 , bool V_99 )
{
struct V_100 * V_25 = V_24 -> V_25 ;
...
return;
if ( V_99 ) {
F_3 ( V_101 + V_29 -> V_31 -> V_13 ,
F_34 ( 1 ) ) ;
F_3 ( V_102 + V_29 -> V_31 -> V_13 ,
V_103 |
V_104 |
V_105 |
V_106 ) ;
} else {
F_3 ( V_102 + V_29 -> V_31 -> V_13 , 0 ) ;
}
V_29 -> V_31 -> V_107 = V_99 ;
}
