...
static struct V_203 *
F_43 ( struct V_1 * V_2 , struct V_204 * V_205 )
{
const struct V_206 * V_207 = V_205 -> V_207 ;
struct V_208 * V_209 = NULL ;
struct V_203 * V_210 = NULL ;
#ifdef F_44
V_2 -> V_211 = F_45 ( V_205 -> V_212 ,
V_2 -> V_213 ) ;
if ( ! V_2 -> V_211 ) {
F_11 ( V_2 ,
L_38 ) ;
...
V_209 = V_2 -> V_211 ;
#endif
V_210 = V_207 -> V_214 ( V_2 -> V_33 , V_2 -> V_23 , & V_2 -> V_12 , V_209 ) ;
#ifdef F_44
if ( ! V_210 ) {
F_46 ( V_2 -> V_211 ) ;
V_2 -> V_211 = NULL ;
...
static void V_42 ( const struct V_88 * V_89 , void * V_215 )
{
...
int V_216 ;
struct V_43 * V_44 ;
const unsigned int V_217 = V_2 -> V_23 -> V_29 ;
unsigned int V_218 = V_2 -> V_23 -> V_219 ;
const unsigned int V_220 = V_2 -> V_23 -> V_30 ;
T_2 V_92 ;
int V_9 ;
bool V_221 = false ;
V_12 -> V_85 . V_134 = V_222 ;
V_12 -> V_85 . V_161 =
V_223 ;
V_12 -> V_85 . V_182 = V_224 ;
if ( ! V_218 )
V_218 = V_217 ;
...
if ( V_91 -> V_98 )
V_216 = F_28 ( V_2 , V_89 , V_44 ) ;
else
V_216 = F_33 ( V_2 , V_89 , V_44 ,
& V_12 -> V_85 ) ;
if ( V_216 )
goto V_225;
V_92 = F_29 ( V_2 -> V_12 . V_97 ) ;
if ( V_2 -> V_26 != V_27 ) {
if ( V_92 < V_220 || V_92 > V_217 ) {
F_11 ( V_2 ,
L_42
L_43 ,
V_217 , V_92 ) ;
...
V_205 = & V_204 [ V_233 ] ;
F_37 ( V_2 , L_49 ,
V_2 -> V_12 . V_110 , V_205 -> V_212 ) ;
F_53 ( & V_2 -> V_234 , & V_205 -> V_2 ) ;
if ( V_205 -> V_207 ) {
V_2 -> V_210 = F_43 ( V_2 , V_205 ) ;
if ( ! V_2 -> V_210 ) {
F_54 ( & V_231 ) ;
goto V_235;
}
...
struct V_1 * F_59 ( struct V_237 * V_33 ,
const struct V_200 * V_23 )
{
struct V_1 * V_2 ;
int V_238 ;
...
V_2 -> V_33 -> V_209 = F_45 ( L_54 , V_2 -> V_213 ) ;
if ( ! V_2 -> V_33 -> V_209 ) {
F_11 ( V_2 , L_55 ) ;
V_238 = - V_19 ;
goto V_241;
...
int F_68 ( const char * V_212 , const struct V_206 * V_207 )
{
int V_9 ;
struct V_1 * V_2 ;
struct V_204 * V_205 ;
F_52 ( & V_231 ) ;
for ( V_9 = 0 ; V_9 < F_6 ( V_204 ) ; V_9 ++ ) {
V_205 = & V_204 [ V_9 ] ;
if ( strcmp ( V_205 -> V_212 , V_212 ) )
continue;
V_205 -> V_207 = V_207 ;
...
void F_70 ( const char * V_212 )
{
int V_9 ;
struct V_1 * V_2 ;
F_52 ( & V_231 ) ;
for ( V_9 = 0 ; V_9 < F_6 ( V_204 ) ; V_9 ++ ) {
if ( strcmp ( V_204 [ V_9 ] . V_212 , V_212 ) )
continue;
V_204 [ V_9 ] . V_207 = NULL ;
