...
static int F_78 ( struct V_6 * V_9 , struct V_183 * V_140 )
{
struct V_5 * V_7 = F_3 ( V_9 ) ;
...
static int F_82 ( struct V_6 * V_9 )
{
struct V_5 * V_7 = F_3 ( V_9 ) ;
if ( ! V_7 -> V_56 )
return - V_185 ;
...
static int F_84 ( struct V_1 * V_21 , int V_106 )
{
struct V_5 * V_7 ;
V_7 = F_72 ( sizeof( * V_7 ) , V_187 ) ;
if ( ! V_7 )
return - V_188 ;
V_7 -> V_25 = V_21 -> V_25 ;
V_7 -> V_106 = V_106 ;
V_7 -> V_8 . V_189 = F_5 ;
F_85 ( & V_7 -> V_8 , & V_21 -> V_4 ) ;
F_86 ( & V_7 -> V_78 ) ;
return 0 ;
}
...
{
F_88 ( & V_21 -> V_128 ) ;
while ( ! F_43 ( & V_21 -> V_4 . V_190 ) ) {
struct V_5 * V_7 = F_44 ( & V_21 -> V_4 . V_190 ,
struct V_5 , V_8 . V_9 . V_191 ) ;
F_32 ( & V_7 -> V_8 . V_9 . V_191 ) ;
F_88 ( & V_7 -> V_8 . V_128 ) ;
F_6 ( V_7 ) ;
}
}
...
struct V_194 * V_195 ;
int V_196 , V_48 , V_94 ;
V_21 = F_90 ( & V_193 -> V_54 , sizeof( * V_21 ) , V_187 ) ;
if ( ! V_21 )
return - V_188 ;
V_195 = F_91 ( V_193 , V_197 , 0 ) ;
V_21 -> V_27 = F_92 ( & V_193 -> V_54 , V_195 ) ;
if ( F_93 ( V_21 -> V_27 ) )
return F_94 ( V_21 -> V_27 ) ;
V_21 -> V_32 = F_95 () ;
if ( ! V_21 -> V_32 )
return - V_198 ;
V_21 -> V_25 = V_21 -> V_32 -> V_25 ;
F_96 ( V_199 , V_21 -> V_4 . V_200 ) ;
F_96 ( V_201 , V_21 -> V_4 . V_200 ) ;
V_21 -> V_4 . V_202 = F_51 ;
V_21 -> V_4 . V_203 = F_55 ;
V_21 -> V_4 . V_204 = F_64 ;
V_21 -> V_4 . V_205 = F_67 ;
...
V_21 -> V_4 . V_210 = F_83 ;
V_21 -> V_4 . V_211 = F_79 ;
V_21 -> V_4 . V_212 = V_213 ;
V_21 -> V_4 . V_214 = V_213 ;
V_21 -> V_4 . V_215 = F_50 ( V_66 ) | F_50 ( V_127 ) ;
V_21 -> V_4 . V_216 = V_217 ;
V_21 -> V_4 . V_54 = & V_193 -> V_54 ;
F_86 ( & V_21 -> V_4 . V_190 ) ;
F_86 ( & V_21 -> V_93 ) ;
F_97 ( & V_21 -> V_90 ) ;
F_97 ( & V_21 -> V_97 ) ;
F_98 ( & V_21 -> V_128 , F_38 , ( unsigned long ) V_21 ) ;
for ( V_48 = 0 ; V_48 < 127 ; V_48 ++ ) {
V_196 = F_84 ( V_21 , V_48 ) ;
if ( V_196 ) {
F_87 ( V_21 ) ;
return V_196 ;
}
...
V_94 = F_99 ( V_193 , 1 ) ;
if ( V_94 <= 0 ) {
F_100 ( & V_193 -> V_54 , L_7 , V_94 ) ;
V_21 -> V_105 = true ;
} else {
V_21 -> V_99 = 0 ;
F_14 ( V_21 , V_107 , 0 ) ;
V_196 = F_101 ( & V_193 -> V_54 , V_94 , F_46 ,
V_218 , L_8 , V_21 ) ;
if ( V_196 )
return V_196 ;
}
V_196 = F_102 ( & V_21 -> V_4 ) ;
if ( V_196 ) {
F_103 ( L_9 ,
V_196 ) ;
F_87 ( V_21 ) ;
...
F_104 ( V_193 , V_21 ) ;
if ( V_193 -> V_54 . V_219 ) {
V_220 . V_221 = V_21 -> V_4 . V_200 ;
V_196 = F_105 ( V_193 -> V_54 . V_219 ,
V_222 , & V_220 ) ;
if ( V_196 ) {
F_103 ( L_10 ) ;
F_106 ( & V_21 -> V_4 ) ;
...
F_100 ( & V_193 -> V_54 , L_11 ) ;
return V_196 ;
}
static int F_107 ( struct V_192 * V_193 )
{
struct V_1 * V_21 = F_108 ( V_193 ) ;
if ( V_193 -> V_54 . V_219 )
F_109 ( V_193 -> V_54 . V_219 ) ;
F_106 ( & V_21 -> V_4 ) ;
if ( ! V_21 -> V_105 ) {
F_14 ( V_21 , V_108 , 0 ) ;
}
...
bool F_110 ( struct V_6 * V_9 , void * V_223 )
{
if ( V_9 -> V_35 -> V_54 -> V_224 == & V_225 . V_224 ) {
struct V_5 * V_7 = F_3 ( V_9 ) ;
unsigned V_226 = * ( unsigned * ) V_223 ;
return V_226 == V_7 -> V_106 ;
}
return false ;
}
