...
V_85 . V_109 . V_11 = 0 ;
for ( V_91 = 0 ;
( V_91 < V_81 -> V_110 ) && V_91 < F_18 ( V_111 ) ;
V_91 ++ )
...
V_118 = F_20 ( V_87 . V_123 . V_11 ,
V_124 ) ;
V_89 = F_21 ( V_20 ,
F_22 ( V_20 , V_118 ) ,
V_125 ,
( const V_18 * ) & ( V_87 . V_102 . V_11 . V_11 ) ,
V_87 . V_126 . V_11 , V_87 . V_127 . V_11 ,
V_87 . V_128 . V_11 ,
V_92 ,
V_93 ,
...
static int F_25 ( struct V_20 * V_20 , T_2 V_131 )
{
struct V_82 * V_83 = F_16 ( V_20 ) ;
T_1 * V_9 = V_83 -> V_9 ;
T_2 V_11 ;
...
struct V_142 V_143 ;
T_2 V_10 ;
int V_144 = V_139 -> V_108 ;
int V_145 = - 1 ;
int V_146 = ( V_139 -> V_147 . V_148 == V_43 ) ||
( V_139 -> V_147 . V_148 == V_44 ) ;
int V_28 ;
int V_2 = 0 ;
if ( V_141 ) {
V_145 = F_19 ( V_141 -> V_114 ) ;
V_28 = F_2 ( V_9 ,
V_149 ,
V_145 ) ;
if ( V_28 )
...
( ( V_139 -> V_150 == V_152 ) && ! V_146 ) )
V_143 . V_153 . V_11 = V_154 ;
else if ( ( V_139 -> V_150 == V_155 ) ||
( ( V_139 -> V_150 == V_152 ) && V_146 ) )
V_143 . V_153 . V_11 = V_156 ;
else
F_6 ( V_22 ,
L_5 ,
V_139 -> V_150 ) ;
...
V_143 . V_16 = V_161 ;
memcpy ( V_143 . V_106 . V_11 . V_11 , V_139 -> V_106 , V_144 ) ;
V_143 . V_106 . V_11 . V_19 = V_144 ;
V_28 = F_3 ( V_9 , ( V_18 * ) & V_143 ) ;
exit:
if ( V_28 )
V_2 = - V_35 ;
return V_2 ;
...
int V_2 = 0 ;
V_143 . V_16 = V_161 ;
memcpy ( V_143 . V_106 . V_11 . V_11 , L_6 , 3 ) ;
V_143 . V_106 . V_11 . V_19 = 3 ;
V_28 = F_3 ( V_9 , ( V_18 * ) & V_143 ) ;
if ( V_28 )
V_2 = - V_35 ;
return V_2 ;
...
static int F_30 ( struct V_20 * V_20 , struct V_164 * V_94 ,
enum V_165 type , int V_166 )
{
struct V_82 * V_83 = F_16 ( V_20 ) ;
T_1 * V_9 = V_83 -> V_9 ;
T_2 V_11 ;
...
static int F_32 ( struct V_20 * V_20 , struct V_164 * V_94 ,
int * V_68 )
{
struct V_82 * V_83 = F_16 ( V_20 ) ;
T_1 * V_9 = V_83 -> V_9 ;
...
void F_33 ( T_1 * V_9 , V_18 V_171 )
{
T_5 V_70 = V_171 ?
V_172 : V_173 ;
F_34 ( V_9 -> V_95 , V_9 -> V_102 ,
NULL , 0 , NULL , 0 , V_70 , V_129 ) ;
}
void F_35 ( T_1 * V_9 )
{
F_36 ( V_9 -> V_95 , 0 , NULL ,
0 , V_129 ) ;
}
void F_37 ( T_1 * V_9 )
{
F_38 ( V_9 -> V_95 , NULL , V_9 -> V_102 ,
NULL , 0 , NULL , 0 , V_129 ) ;
}
static struct V_20 * F_39 ( struct V_174 * V_22 , T_1 * V_9 )
{
struct V_20 * V_20 ;
struct V_82 * V_83 ;
V_20 = F_40 ( & V_175 , sizeof( * V_83 ) ) ;
if ( ! V_20 )
return NULL ;
V_83 = F_16 ( V_20 ) ;
V_83 -> V_9 = V_9 ;
memcpy ( V_83 -> V_113 , V_111 , sizeof( V_111 ) ) ;
memcpy ( V_83 -> V_176 , V_177 , sizeof( V_177 ) ) ;
V_83 -> V_178 . V_113 = V_83 -> V_113 ;
V_83 -> V_178 . V_110 = F_18 ( V_111 ) ;
V_83 -> V_178 . V_179 = V_83 -> V_176 ;
V_83 -> V_178 . V_180 = F_18 ( V_177 ) ;
V_83 -> V_178 . V_178 = V_124 ;
V_83 -> V_178 . V_181 . V_182 = false ;
V_20 -> V_183 [ V_124 ] = & V_83 -> V_178 ;
F_41 ( V_20 , V_22 ) ;
V_20 -> V_184 = V_185 ;
V_20 -> V_186 = 1 ;
V_20 -> V_187 = F_14 ( V_32 )
| F_14 ( V_29 ) ;
V_20 -> V_188 = V_189 ;
V_20 -> V_190 = V_191 ;
V_20 -> V_192 = V_193 ;
