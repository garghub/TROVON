...
static void T_6 F_61 ( struct V_31 * V_11 )
{
struct V_6 * V_7 = F_26 ( V_11 ) ;
struct V_8 * V_9 = & V_7 -> V_23 . V_9 ;
V_9 -> V_97 = 4 ;
...
static int F_66 ( struct V_121 * V_122 [] , struct V_121 * V_78 [] )
{
return 0 ;
}
static void F_67 ( struct V_121 * V_78 [] ,
struct V_53 * V_23 )
{
...
V_23 -> V_99 = V_102 ;
if ( V_78 [ V_123 ] )
V_23 -> V_124 = F_68 ( V_78 [ V_123 ] ) ;
if ( V_78 [ V_125 ] )
V_23 -> V_24 = F_69 ( V_78 [ V_125 ] ) ;
if ( V_78 [ V_126 ] )
V_23 -> V_67 = F_69 ( V_78 [ V_126 ] ) ;
if ( V_78 [ V_127 ] )
V_23 -> V_9 . V_17 = F_69 ( V_78 [ V_127 ] ) ;
if ( V_78 [ V_128 ] )
V_23 -> V_9 . V_18 = F_69 ( V_78 [ V_128 ] ) ;
}
static int F_70 ( struct V_10 * V_129 , struct V_31 * V_11 ,
struct V_121 * V_122 [] , struct V_121 * V_78 [] )
{
struct V_53 V_23 ;
F_67 ( V_78 , & V_23 ) ;
return F_71 ( V_11 , V_122 , & V_23 ) ;
}
static int F_72 ( struct V_31 * V_11 , struct V_121 * V_122 [] ,
struct V_121 * V_78 [] )
{
struct V_53 V_91 ;
F_67 ( V_78 , & V_91 ) ;
return F_73 ( V_11 , V_122 , & V_91 ) ;
}
static T_8 F_74 ( const struct V_31 * V_11 )
{
return
F_75 ( 4 ) +
F_75 ( 4 ) +
...
static int F_76 ( struct V_1 * V_2 , const struct V_31 * V_11 )
{
struct V_6 * V_130 = F_26 ( V_11 ) ;
struct V_53 * V_91 = & V_130 -> V_23 ;
F_77 ( V_2 , V_123 , V_91 -> V_124 ) ;
F_78 ( V_2 , V_125 , V_91 -> V_24 ) ;
F_78 ( V_2 , V_126 , V_91 -> V_67 ) ;
F_78 ( V_2 , V_127 , V_91 -> V_9 . V_17 ) ;
F_78 ( V_2 , V_128 , V_91 -> V_9 . V_18 ) ;
return 0 ;
}
...
goto V_133;
V_131 = L_4 ;
V_30 = F_82 ( & V_134 , V_79 ) ;
if ( V_30 < 0 )
goto V_135;
V_30 = F_82 ( & V_136 , V_81 ) ;
if ( V_30 < 0 )
goto V_137;
V_30 = F_82 ( & V_138 , V_82 ) ;
if ( V_30 < 0 )
goto V_139;
V_131 = L_5 ;
V_30 = F_83 ( & V_119 ) ;
