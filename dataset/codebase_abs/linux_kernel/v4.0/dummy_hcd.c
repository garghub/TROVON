...
V_242 ) ;
V_60 -> V_243 = 1 ;
V_60 -> V_244 . V_245 . V_246 = 0x04 ;
V_60 -> V_244 . V_245 . V_247 = 0xffff ;
}
...
V_242 ) ;
V_60 -> V_243 = 1 ;
V_60 -> V_244 . V_248 . V_247 [ 0 ] = 0xff ;
V_60 -> V_244 . V_248 . V_247 [ 1 ] = 0xff ;
}
static int F_126 (
struct V_10 * V_11 ,
T_5 V_249 ,
...
if ( ( V_198 >> 8 ) != V_261 )
goto error;
memcpy ( V_89 , & V_262 , sizeof( V_262 ) ) ;
V_62 = sizeof( V_262 ) ;
break;
case V_263 :
* ( V_264 * ) V_89 = F_127 ( 0 ) ;
...
F_21 ( V_32 ) ;
( ( V_267 * ) V_89 ) [ 0 ] = F_124 ( V_32 -> V_34 ) ;
( ( V_267 * ) V_89 ) [ 1 ] = F_124 ( V_32 -> V_34 >> 16 ) ;
break;
case V_268 :
V_62 = - V_230 ;
break;
...
F_30 ( & V_11 -> V_15 . V_277 -> V_19 , L_19 , V_142 ) ;
F_77 ( & V_32 -> V_13 -> V_30 ) ;
V_32 -> V_44 = V_45 ;
F_21 ( V_32 ) ;
V_11 -> V_141 = V_278 ;
...
static inline T_2 F_130 ( char * V_89 , T_6 V_280 , struct V_144 * V_144 )
{
...
T_6 V_281 ;
V_281 = F_130 ( V_89 , V_117 - V_280 , V_151 -> V_144 ) ;
V_89 += V_281 ;
V_280 += V_281 ;
}
F_33 ( & V_32 -> V_13 -> V_30 , V_79 ) ;
...
V_32 -> V_159 . V_282 = ( unsigned long ) V_32 ;
V_32 -> V_44 = V_160 ;
V_32 -> V_145 = 0 ;
F_36 ( & V_32 -> V_155 ) ;
F_5 ( V_32 ) -> V_283 = V_284 ;
F_5 ( V_32 ) -> V_141 = V_279 ;
F_5 ( V_32 ) -> V_285 = 1 ;
#ifdef F_66
F_5 ( V_32 ) -> V_15 . V_286 = 1 ;
#endif
return 0 ;
return F_70 ( F_6 ( V_32 ) , & V_287 ) ;
}
...
V_13 -> V_25 -> V_13 = V_13 ;
V_11 -> V_22 = V_289 ;
V_11 -> V_15 . V_277 -> V_22 = V_70 ;
} else {
V_13 -> V_24 = F_4 ( V_11 ) ;
V_13 -> V_24 -> V_13 = V_13 ;
V_11 -> V_22 = V_33 ;
V_11 -> V_15 . V_277 -> V_22 = V_23 ;
}
return 0 ;
}
static int F_142 ( struct V_10 * V_11 , struct V_290 * V_154 ,
struct V_291 * * V_292 , unsigned int V_293 ,
unsigned int V_294 , T_1 V_80 )
{
struct V_9 * V_32 = F_4 ( V_11 ) ;
unsigned long V_79 ;
int V_295 ;
...
return - V_67 ;
F_32 ( & V_32 -> V_13 -> V_30 , V_79 ) ;
for ( V_121 = 0 ; V_121 < V_293 ; V_121 ++ ) {
V_143 = F_81 ( & V_292 [ V_121 ] -> V_60 ) ;
if ( ( 1 << V_143 ) & V_32 -> V_145 ) {
V_296 = - V_67 ;
goto V_297;
}
V_295 = F_27 ( & V_292 [ V_121 ] -> V_298 ) ;
if ( ! V_295 ) {
V_296 = - V_67 ;
goto V_297;
}
...
V_32 -> V_145 |= 1 << V_143 ;
F_88 ( V_32 ,
F_82 ( & V_292 [ V_121 ] -> V_60 ) , V_296 ) ;
}
V_297:
F_33 ( & V_32 -> V_13 -> V_30 , V_79 ) ;
return V_296 ;
}
static int F_143 ( struct V_10 * V_11 , struct V_290 * V_154 ,
struct V_291 * * V_292 , unsigned int V_293 ,
T_1 V_80 )
{
struct V_9 * V_32 = F_4 ( V_11 ) ;
...
struct V_10 * V_24 ;
int V_62 ;
F_139 ( & V_134 -> V_19 , L_54 V_300 L_55 , V_301 ) ;
V_13 = * ( ( void * * ) F_68 ( & V_134 -> V_19 ) ) ;
if ( ! V_109 . V_110 )
V_9 . V_79 = V_289 ;
...
int V_62 = - V_152 ;
int V_121 ;
struct V_17 * V_13 [ V_308 ] ;
if ( F_158 () )
return - V_309 ;
if ( ! V_109 . V_112 && V_109 . V_110 )
return - V_67 ;
if ( V_109 . V_310 < 1 || V_109 . V_310 > V_308 ) {
F_159 ( L_57 ,
V_308 ) ;
return - V_67 ;
}
for ( V_121 = 0 ; V_121 < V_109 . V_310 ; V_121 ++ ) {
V_311 [ V_121 ] = F_160 ( V_312 , V_121 ) ;
if ( ! V_311 [ V_121 ] ) {
V_121 -- ;
while ( V_121 >= 0 )
F_161 ( V_311 [ V_121 -- ] ) ;
...
for ( V_121 = 0 ; V_121 < V_109 . V_310 ; V_121 ++ ) {
V_13 [ V_121 ] = F_35 ( sizeof( struct V_17 ) , V_315 ) ;
if ( ! V_13 [ V_121 ] ) {
V_62 = - V_152 ;
goto V_316;
}
V_62 = F_162 ( V_311 [ V_121 ] , & V_13 [ V_121 ] ,
sizeof( void * ) ) ;
if ( V_62 )
goto V_316;
V_62 = F_162 ( V_313 [ V_121 ] , & V_13 [ V_121 ] ,
sizeof( void * ) ) ;
if ( V_62 )
goto V_316;
}
...
for ( V_121 = 0 ; V_121 < V_109 . V_310 ; V_121 ++ ) {
struct V_17 * V_13 ;
V_13 = * ( ( void * * ) F_68 ( & V_313 [ V_121 ] -> V_19 ) ) ;
F_168 ( V_313 [ V_121 ] ) ;
F_168 ( V_311 [ V_121 ] ) ;
F_39 ( V_13 ) ;
}
