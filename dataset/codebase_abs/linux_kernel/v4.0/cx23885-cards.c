...
if ( V_113 )
break;
V_2 -> V_114 = F_24 ( V_2 , V_115 ) ;
F_25 ( V_2 -> V_116 , V_117 , V_118 ,
V_110 , V_109 ) ;
break;
case V_79 :
case V_80 :
...
F_25 ( V_2 -> V_116 , V_117 , V_118 ,
V_108 , V_95 ) ;
F_25 ( V_2 -> V_114 , V_119 , V_120 , & V_112 ) ;
V_112 . V_121 = false ;
V_112 . V_122 = false ;
V_112 . V_123 = true ;
F_25 ( V_2 -> V_114 , V_119 , V_124 , & V_112 ) ;
V_112 . V_122 = true ;
F_25 ( V_2 -> V_114 , V_119 , V_124 , & V_112 ) ;
break;
case V_125 :
...
static int F_30 ( void * V_132 , int V_133 , int V_134 , int V_135 )
{
int V_136 ;
int V_137 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) V_132 ;
V_136 = ( ( F_31 ( V_22 ) ) & ( ~ 0x00000002 ) ) ;
V_136 |= ( V_133 ? 0x00020002 : 0x00020000 ) ;
F_20 ( V_22 , V_136 ) ;
V_136 = ( ( F_31 ( V_62 ) ) & ( ~ 0x0000a000 ) ) ;
V_136 |= ( V_134 ? 0x00008000 : 0 ) ;
F_20 ( V_62 , V_136 ) ;
if ( V_135 )
V_137 = ( V_136 & 0x00004000 ) ? 1 : 0 ;
F_20 ( V_62 , V_136 | 0x00002000 ) ;
F_32 ( 1 ) ;
F_20 ( V_62 , V_136 ) ;
return V_137 ;
}
...
struct V_27 * V_139 = & V_2 -> V_139 ;
static T_1 V_140 [ 256 ] ;
if ( V_2 -> V_14 [ 0 ] . V_141 == 0 ) {
V_2 -> V_14 [ 0 ] . V_15 . V_142 = 0xa0 >> 1 ;
...
case V_86 :
case V_87 :
V_2 -> V_116 = F_37 ( & V_2 -> V_155 ,
& V_2 -> V_14 [ 2 ] . V_156 ,
L_17 , 0x88 >> 1 , NULL ) ;
if ( V_2 -> V_116 ) {
V_2 -> V_116 -> V_157 = V_128 ;
F_25 ( V_2 -> V_116 , V_117 , V_158 ) ;
}
break;
}
switch ( V_2 -> V_19 ) {
...
F_2 ( V_7 L_21 ,
V_164 . V_169 , V_161 ) ;
V_113 = F_40 ( & V_160 , V_161 , & V_2 -> V_4 -> V_2 ) ;
if ( V_113 != 0 )
F_2 ( V_32 L_22
L_23
L_24 , V_161 ) ;
