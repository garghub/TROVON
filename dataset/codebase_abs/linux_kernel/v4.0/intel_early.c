...
V_65 = 0x00000001 ;
V_67 = 0 ;
F_23 ( & V_65 , & V_66 , & V_67 , & V_68 ) ;
V_17 . V_18 = V_65 ;
V_33 = F_9 ( V_17 . V_18 ) ;
V_34 = F_10 ( V_17 . V_18 ) ;
if ( ( V_34 >= 5 ) || ( V_33 > 6 ) ) {
F_24 ( V_69 , V_63 [ 0 ] , V_63 [ 1 ] ) ;
V_17 . V_20 = 1 << ( ( V_63 [ 1 ] >> 18 ) & 7 ) ;
}
F_25 ( V_70 , 0 , 0 ) ;
F_26 () ;
F_24 ( V_70 , V_63 [ 0 ] , V_63 [ 1 ] ) ;
V_17 . V_11 = V_63 [ 1 ] ;
V_6 -> V_10 = V_17 ;
V_6 -> V_71 = 1 ;
return 0 ;
...
static T_2 enum V_1
F_34 ( unsigned long V_58 , unsigned long V_75 ,
struct V_29 * V_29 ,
unsigned long * V_26 ,
struct V_5 * V_6 )
{
...
V_77 . V_59 = NULL ;
V_77 . V_60 = 0 ;
V_77 = F_35 ( V_30 , ( void * ) V_58 , V_60 , & V_78 ) ;
if ( ! V_77 . V_59 )
return V_62 ;
...
static void
F_36 ( struct V_5 * V_6 , unsigned int V_72 )
{
int V_57 = F_29 () ;
F_37 ( L_7 ,
V_57 ,
...
if ( V_82 == NULL )
return;
F_36 ( V_6 , V_82 -> V_52 . V_72 ) ;
}
static int F_42 ( struct V_5 * V_6 , bool V_85 )
{
struct V_2 * V_82 ;
unsigned int V_63 [ 2 ] ;
V_82 = V_6 -> V_24 ;
