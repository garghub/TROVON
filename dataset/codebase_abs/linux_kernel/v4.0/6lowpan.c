...
unsigned long V_156 ,
unsigned long V_41 , int V_157 )
{
return F_113 ( V_156 + V_41 , V_33 ) ;
}
...
if ( ! V_135 )
return - V_38 ;
V_62 = F_120 ( V_135 , F_121 ( V_161 ) , 0 ,
V_69 , V_15 ) ;
...
V_135 -> V_138 = V_162 ;
V_135 -> V_145 = V_67 ;
F_125 ( & V_135 -> V_163 , V_164 ) ;
F_10 ( L_29 , V_135 , V_135 -> V_145 ) ;
V_62 = F_126 ( V_135 , V_69 , F_121 ( V_161 ) ) ;
if ( V_62 ) {
F_106 ( V_135 ) ;
F_127 ( L_30 , V_62 ) ;
return NULL ;
...
static int F_128 ( char * V_165 , T_1 * V_69 , T_3 * V_73 ,
struct V_17 * * V_18 )
{
struct V_126 * V_30 ;
struct V_166 * V_31 ;
...
{
struct V_1 * V_29 ;
struct V_5 * V_6 , * V_169 , * V_170 ;
struct V_171 V_8 ;
F_88 ( & V_8 ) ;
F_13 () ;
F_14 (entry, &bt_6lowpan_devices, list) {
F_14 (peer, &entry->peers, list) {
V_170 = F_134 ( sizeof( * V_170 ) , V_33 ) ;
if ( ! V_170 )
break;
V_170 -> V_13 = V_6 -> V_13 ;
F_88 ( & V_170 -> V_7 ) ;
...
{
struct V_172 * V_172 = F_77 ( V_124 ,
struct V_172 , V_124 ) ;
if ( ! V_172 -> V_173 || V_128 != V_172 -> V_173 )
F_133 () ;
V_128 = V_172 -> V_173 ;
if ( V_174 ) {
F_123 ( V_174 , 0 ) ;
...
static int F_139 ( void * V_48 , T_5 V_175 )
{
struct V_172 * V_172 ;
V_172 = F_86 ( sizeof( * V_172 ) , V_176 ) ;
if ( ! V_172 )
return - V_143 ;
V_172 -> V_173 = ! ! V_175 ;
F_108 ( & V_172 -> V_124 , F_137 ) ;
F_109 ( & V_172 -> V_124 ) ;
return 0 ;
}
static int F_140 ( void * V_48 , T_5 * V_175 )
{
* V_175 = V_128 ;
return 0 ;
}
static T_6 F_141 ( struct V_177 * V_178 ,
const char T_7 * V_179 ,
T_8 V_26 ,
T_9 * V_180 )
{
char V_165 [ 32 ] ;
T_8 V_181 = F_142 ( V_26 , sizeof( V_165 ) - 1 ) ;
int V_45 ;
T_1 V_69 ;
T_3 V_73 ;
struct V_17 * V_18 = NULL ;
if ( F_143 ( V_165 , V_179 , V_181 ) )
return - V_182 ;
V_165 [ V_181 ] = '\0' ;
if ( memcmp ( V_165 , L_33 , 8 ) == 0 ) {
V_45 = F_128 ( & V_165 [ 8 ] , & V_69 , & V_73 , & V_18 ) ;
if ( V_45 == - V_38 )
return V_45 ;
if ( V_174 ) {
F_123 ( V_174 , 0 ) ;
...
if ( memcmp ( V_165 , L_36 , 11 ) == 0 ) {
V_45 = F_128 ( & V_165 [ 11 ] , & V_69 , & V_73 , & V_18 ) ;
if ( V_45 < 0 )
return V_45 ;
...
static int F_144 ( struct V_184 * V_185 , void * V_186 )
{
struct V_1 * V_29 ;
struct V_5 * V_6 ;
F_87 ( & V_140 ) ;
...
static int F_147 ( struct V_187 * V_187 , struct V_177 * V_177 )
{
return F_148 ( V_177 , F_144 , V_187 -> V_188 ) ;
}
static void F_149 ( void )
{
struct V_1 * V_29 , * V_189 , * V_190 ;
struct V_171 V_191 ;
F_88 ( & V_191 ) ;
F_13 () ;
F_14 (entry, &bt_6lowpan_devices, list) {
V_190 = F_134 ( sizeof( * V_190 ) , V_33 ) ;
if ( ! V_190 )
break;
V_190 -> V_3 = V_29 -> V_3 ;
F_88 ( & V_190 -> V_7 ) ;
...
unsigned long V_194 , void * V_186 )
{
struct V_2 * V_3 = F_151 ( V_186 ) ;
struct V_1 * V_29 ;
if ( V_3 -> type != V_47 )
return V_195 ;
switch ( V_194 ) {
...
{
V_197 = F_154 ( L_40 , 0644 ,
V_198 , NULL ,
& V_199 ) ;
V_200 = F_154 ( L_41 , 0644 ,
V_198 , NULL ,
& V_201 ) ;
return F_155 ( & V_202 ) ;
}
