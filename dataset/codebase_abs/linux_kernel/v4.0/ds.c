...
static int F_69 ( struct V_42 * V_46 , char * V_132 )
{
...
if ( ! V_132 )
return - V_28 ;
F_34 ( & V_46 -> V_46 , L_41 , V_132 ) ;
if ( F_70 ( & V_134 , V_132 , & V_46 -> V_46 ) == 0 ) {
if ( V_134 -> V_135 >= V_136 ) {
V_57 = - V_28 ;
F_40 ( V_137 , & V_46 -> V_46 ,
L_42 ) ;
goto V_105;
}
if ( ! F_71 ( V_55 , V_134 -> V_138 , V_134 -> V_135 ) )
V_57 = 0 ;
else {
F_40 ( V_137 , & V_46 -> V_46 ,
L_43 ) ;
...
static inline int F_69 ( struct V_42 * V_46 , char * V_132 )
{
return - V_58 ;
}
...
static int F_75 ( struct V_44 * V_46 , struct V_153 * V_154 )
{
struct V_42 * V_43 ;
int V_6 ;
T_1 V_7 [ 4 ] = { 0 , 0 , 0 , 0 } ;
...
if ( F_76 ( V_154 , L_49 , V_43 -> V_51 -> V_78 ) )
return - V_30 ;
if ( F_76 ( V_154 , L_50 , V_43 -> V_25 ) )
return - V_30 ;
if ( F_76 ( V_154 , L_51
L_52 ,
...
static T_2 F_83 ( struct V_44 * V_46 , struct V_157 * V_158 ,
char * V_16 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
return V_43 -> V_51 ? sprintf ( V_16 , L_53 , V_43 -> V_60 ) : - V_58 ;
}
static T_2 F_84 ( struct V_44 * V_46 ,
struct V_157 * V_158 , char * V_16 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
char * V_100 = V_16 ;
int V_6 ;
for ( V_6 = 0 ; V_6 < V_159 ; V_6 ++ )
V_100 += sprintf ( V_100 , L_54 , V_43 -> V_71 [ V_6 ] ) ;
return V_100 - V_16 ;
}
static T_2 F_85 ( struct V_44 * V_46 , struct V_157 * V_158 , char * V_16 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
if ( V_43 -> V_160 )
return sprintf ( V_16 , L_55 ) ;
else
return sprintf ( V_16 , L_56 ) ;
}
static T_2 F_86 ( struct V_44 * V_46 , struct V_157 * V_158 ,
...
if ( ! V_17 )
return - V_28 ;
if ( ( ! V_43 -> V_160 ) && ! strncmp ( V_16 , L_57 , 3 ) )
V_57 = F_77 ( V_46 ) ;
else if ( V_43 -> V_160 && ! strncmp ( V_16 , L_58 , 2 ) )
V_57 = F_81 ( V_46 ) ;
return V_57 ? V_57 : V_17 ;
}
static T_2 F_87 ( struct V_44 * V_46 , struct V_157 * V_158 , char * V_16 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
int V_6 ;
T_1 V_7 [ 4 ] = { 0 , 0 , 0 , 0 } ;
...
static T_2 F_88 ( struct V_44 * V_46 ,
struct V_157 * V_158 , const char * V_16 , T_3 V_17 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
if ( ! V_17 )
return - V_28 ;
...
static int F_79 ( struct V_44 * V_46 , T_13 V_127 )
{
struct V_42 * V_43 = F_28 ( V_46 ) ;
struct V_1 * V_2 = NULL ;
int V_57 = 0 ;
...
{
struct V_54 * V_164 = V_125 ;
struct V_42 * V_43 = F_28 ( V_46 ) ;
if ( V_43 -> V_51 != V_164 || V_43 -> V_160 )
return 0 ;
return F_77 ( V_46 ) ;
}
static int F_92 ( struct V_44 * V_46 , void * V_125 )
{
struct V_54 * V_164 = V_125 ;
struct V_42 * V_43 = F_28 ( V_46 ) ;
if ( V_43 -> V_51 != V_164 || ! V_43 -> V_160 )
...
static int F_93 ( struct V_54 * V_164 )
{
F_34 ( & V_164 -> V_46 , L_67 , V_164 -> V_78 ) ;
F_67 ( & V_40 , NULL , V_164 , F_92 ) ;
return 0 ;
}
static int F_94 ( struct V_54 * V_164 )
{
F_34 ( & V_164 -> V_46 , L_68 , V_164 -> V_78 ) ;
if ( F_67 ( & V_40 , NULL , V_164 ,
F_91 ) ) {
F_93 ( V_164 ) ;
return - V_165 ;
}
...
static int F_95 ( struct V_54 * V_164 )
{
F_96 ( & V_164 -> V_166 , 0 ) ;
F_43 ( V_164 , NULL ) ;
F_7 ( & V_164 -> V_72 ) ;
...
static int F_99 ( struct V_54 * V_164 )
{
F_96 ( & V_164 -> V_166 , 1 ) ;
F_7 ( & V_164 -> V_72 ) ;
V_164 -> V_73 = 0 ;
...
static int F_100 ( struct V_54 * V_164 )
{
if ( ! F_101 ( V_164 ) )
return 0 ;
F_34 ( & V_164 -> V_46 , L_69 ) ;
F_95 ( V_164 ) ;
F_7 ( & V_164 -> V_72 ) ;
F_97 ( V_164 ) ;
F_14 ( V_164 -> V_129 ) ;
...
struct V_42 * F_102 ( struct V_42 * V_167 )
{
struct V_42 * V_43 ;
...
if ( ! V_43 )
return NULL ;
if ( F_103 ( & V_43 -> V_51 -> V_166 ) != 0 )
V_57 = V_43 ;
F_29 ( V_43 ) ;
return V_57 ;
}
static int F_104 ( struct V_44 * V_46 ,
struct V_168 * V_169 )
{
struct V_54 * V_51 = F_105 ( V_46 ) ;
int V_57 ;
V_51 = F_51 ( V_51 ) ;
if ( ! V_51 ) {
F_40 ( V_137 , V_46 ,
...
V_57 = F_106 ( & V_46 -> V_170 , & V_171 ) ;
if ( V_57 ) {
F_40 ( V_137 , V_46 , L_71 ) ;
F_35 ( V_51 ) ;
return V_57 ;
}
F_21 ( & V_51 -> V_108 ) ;
...
static void F_108 ( struct V_44 * V_46 ,
struct V_168 * V_169 )
{
struct V_54 * V_51 = F_105 ( V_46 ) ;
if ( ! V_51 )
...
F_109 ( V_51 ) ;
F_9 ( & V_51 -> V_173 ) ;
F_110 ( & V_46 -> V_170 , & V_171 ) ;
F_35 ( V_51 ) ;
return;
}
static int T_14 F_111 ( void )
{
int V_57 ;
V_57 = F_112 ( & V_40 ) ;
if ( V_57 < 0 ) {
