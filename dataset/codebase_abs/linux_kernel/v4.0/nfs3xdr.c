...
int F_111 ( struct V_17 * V_18 , struct V_204 * V_205 ,
int V_206 )
{
struct V_204 V_154 = * V_205 ;
T_2 * V_20 ;
int error ;
V_20 = F_9 ( V_18 , 4 ) ;
if ( F_10 ( V_20 == NULL ) )
...
error = F_15 ( V_18 , & V_205 -> V_209 ) ;
if ( F_10 ( error ) )
return error ;
error = F_19 ( V_18 , & V_205 -> V_26 , & V_205 -> V_6 ) ;
if ( F_10 ( error ) )
return error ;
V_205 -> V_210 = V_205 -> V_37 ;
error = F_27 ( V_18 , & V_205 -> V_37 ) ;
if ( F_10 ( error ) )
return error ;
V_205 -> V_211 = V_212 ;
if ( V_206 ) {
V_205 -> V_87 -> V_103 = 0 ;
error = F_56 ( V_18 , V_205 -> V_87 ) ;
if ( F_10 ( error ) )
return error ;
if ( V_205 -> V_87 -> V_103 & V_104 )
V_205 -> V_211 = F_112 ( V_205 -> V_87 -> V_47 ) ;
if ( V_205 -> V_87 -> V_25 != V_205 -> V_209 ) {
V_205 -> V_87 -> V_213 = V_205 -> V_209 ;
V_205 -> V_87 -> V_103 |= V_214 ;
}
V_20 = F_9 ( V_18 , 4 ) ;
if ( F_10 ( V_20 == NULL ) )
goto V_22;
if ( * V_20 != V_76 ) {
error = F_43 ( V_18 , V_205 -> V_55 ) ;
if ( F_10 ( error ) ) {
if ( error == - V_58 )
goto V_215;
return error ;
...
V_20 = F_33 ( V_20 , & V_183 -> V_220 ) ;
V_20 = F_33 ( V_20 , & V_183 -> V_221 ) ;
V_20 = F_33 ( V_20 , & V_183 -> V_222 ) ;
F_33 ( V_20 , & V_183 -> V_223 ) ;
return 0 ;
V_22:
F_3 ( V_23 , V_18 ) ;
return - V_24 ;
...
V_183 -> V_229 = F_11 ( V_20 ++ ) ;
V_183 -> V_230 = F_11 ( V_20 ++ ) ;
V_183 -> V_231 = F_11 ( V_20 ++ ) ;
V_20 = F_33 ( V_20 , & V_183 -> V_232 ) ;
F_46 ( V_20 , & V_183 -> V_233 ) ;
V_183 -> V_234 = 0 ;
return 0 ;
V_22:
F_3 ( V_23 , V_18 ) ;
...
if ( F_10 ( V_20 == NULL ) )
goto V_22;
V_183 -> V_236 = F_11 ( V_20 ++ ) ;
V_183 -> V_237 = F_11 ( V_20 ) ;
return 0 ;
V_22:
F_3 ( V_23 , V_18 ) ;
return - V_24 ;
...
goto V_115;
error = - V_105 ;
if ( V_183 -> V_169 & ~ ( V_170 | V_244 | V_171 | V_245 ) )
goto V_115;
V_243 = F_124 ( V_18 ) ;
V_241 = NULL ;
...
V_241 = & V_183 -> V_180 ;
V_242 = NULL ;
if ( V_183 -> V_169 & V_244 )
V_242 = & V_183 -> V_246 ;
error = F_125 ( V_18 -> V_33 , V_243 , V_242 , V_241 ) ;
if ( F_10 ( error <= 0 ) )
goto V_115;
V_241 = NULL ;
...
V_241 = & V_183 -> V_181 ;
V_242 = NULL ;
if ( V_183 -> V_169 & V_245 )
V_242 = & V_183 -> V_247 ;
error = F_125 ( V_18 -> V_33 , V_243 + error , V_242 , V_241 ) ;
if ( F_10 ( error <= 0 ) )
return error ;
error = 0 ;
V_115:
...
{
int V_248 ;
for ( V_248 = 0 ; V_249 [ V_248 ] . V_250 != - 1 ; V_248 ++ ) {
if ( V_249 [ V_248 ] . V_250 == ( int ) V_46 )
return V_249 [ V_248 ] . V_251 ;
}
F_4 ( L_15 , V_46 ) ;
return V_249 [ V_248 ] . V_251 ;
}
