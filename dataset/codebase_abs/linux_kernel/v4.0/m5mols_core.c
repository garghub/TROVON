...
static int F_63 ( struct V_5 * V_6 , struct V_99 * V_100 )
{
struct V_87 * V_107 = F_35 ( V_100 , 0 ) ;
* V_107 = V_85 [ 0 ] ;
return 0 ;
}
static T_4 F_64 ( int V_160 , void * V_1 )
{
...
{
const struct V_136 * V_137 = V_11 -> V_140 . V_164 ;
unsigned long V_165 ;
struct V_12 * V_13 ;
struct V_5 * V_6 ;
int V_21 ;
...
V_13 = F_69 ( & V_11 -> V_140 , sizeof( * V_13 ) , V_166 ) ;
if ( ! V_13 )
return - V_167 ;
V_13 -> V_137 = V_137 ;
...
V_165 = V_137 -> V_143
? V_168 : V_169 ;
V_21 = F_70 ( & V_11 -> V_140 , V_137 -> V_142 , V_165 ,
L_17 ) ;
if ( V_21 ) {
...
V_6 = & V_13 -> V_6 ;
F_72 ( V_6 , V_11 , & V_170 ) ;
F_73 ( V_6 -> V_159 , V_171 , sizeof( V_6 -> V_159 ) ) ;
V_6 -> V_25 |= V_172 ;
V_6 -> V_173 = & V_174 ;
V_13 -> V_116 . V_25 = V_175 ;
V_21 = F_74 ( & V_6 -> V_176 , 1 , & V_13 -> V_116 , 0 ) ;
if ( V_21 < 0 )
return V_21 ;
V_6 -> V_176 . type = V_177 ;
F_75 ( & V_13 -> V_50 ) ;
F_76 ( & V_13 -> V_108 ) ;
V_21 = F_77 ( & V_11 -> V_140 , V_11 -> V_160 , F_64 ,
V_178 , V_171 , V_6 ) ;
if ( V_21 ) {
