...
struct V_429 V_222 ;
memset ( & V_222 , 0 , sizeof( V_222 ) ) ;
V_222 . V_26 = V_8 -> V_430 ;
V_222 . V_29 = V_8 -> V_431 ;
V_222 . V_432 = V_433 ;
F_2 ( V_179 , L_151 ,
V_222 . V_26 , V_222 . V_29 ) ;
F_98 ( & V_8 -> V_180 , 0 , V_181 , V_434 , & V_222 ) ;
}
if ( V_8 -> V_435 || V_8 -> V_261 ) {
V_171 V_2 ;
F_2 ( V_179 , L_152 ,
V_8 -> V_436 ) ;
switch ( V_8 -> V_436 ) {
...
if ( V_8 -> V_427 && V_8 -> V_27 < V_8 -> V_430 ) {
V_8 -> V_27 = V_8 -> V_430 ;
V_8 -> V_452 = ! 0 ;
} else if ( V_8 -> V_452 ) {
V_8 -> V_427 = ! 0 ;
V_8 -> V_430 = F_177 ( 720 , V_8 -> V_27 ) ;
}
if ( V_8 -> V_428 && V_8 -> V_30 < V_8 -> V_431 ) {
V_8 -> V_30 = V_8 -> V_431 ;
V_8 -> V_453 = ! 0 ;
} else if ( V_8 -> V_453 ) {
int V_448 = V_8 -> V_41 & V_42 ? 480 : 576 ;
V_8 -> V_428 = ! 0 ;
V_8 -> V_431 = F_177 ( V_448 , V_8 -> V_30 ) ;
}
V_446 =
( V_8 -> V_99 ||
V_8 -> V_58 ||
...
static void V_368 ( struct V_459 * V_460 )
{
int V_187 = 0 ;
struct V_7 * V_8 = F_181 ( V_460 , struct V_7 , V_367 ) ;
F_102 ( V_8 -> V_188 ) ; do {
V_187 = F_182 ( V_8 ) ;
} while ( 0 ); F_103 ( V_8 -> V_188 ) ;
if ( V_187 && V_8 -> V_285 ) {
...
static int F_107 ( struct V_7 * V_8 , int V_461 )
{
return F_183 (
V_8 -> V_307 ,
( V_8 -> V_462 == 0 ) &&
( ! V_461 || ( V_8 -> V_82 != V_461 ) ) ) ;
}
...
int F_189 ( struct V_7 * V_8 , struct V_21 * V_465 )
{
int V_24 = 0 ;
F_102 ( V_8 -> V_188 ) ;
V_24 = F_16 ( V_8 ) ;
if ( ! V_24 ) {
memcpy ( V_465 , & V_8 -> V_23 , sizeof( V_8 -> V_23 ) ) ;
}
F_103 ( V_8 -> V_188 ) ;
return V_24 ;
}
int F_190 ( struct V_7 * V_8 , struct V_417 * V_466 )
{
F_102 ( V_8 -> V_188 ) ; do {
if ( V_8 -> V_49 ) {
F_41 ( V_8 ) ;
}
memcpy ( V_466 , & V_8 -> V_50 , sizeof( struct V_417 ) ) ;
} while ( 0 ); F_103 ( V_8 -> V_188 ) ;
return 0 ;
}
struct V_467 * F_191 ( struct V_7 * V_468 )
{
return V_468 -> V_277 ;
}
...
int V_469 = F_73 ( V_8 ) ;
F_102 ( V_8 -> V_188 ) ; do {
F_193 ( V_470 L_157 , V_469 ) ;
F_98 ( & V_8 -> V_180 , 0 , V_266 , V_471 ) ;
F_2 ( V_246 , L_158 ) ;
F_194 ( & V_8 -> V_69 , L_135 ) ;
F_195 ( V_8 ) ;
F_193 ( V_470 L_159 , V_469 ) ;
} while ( 0 ); F_103 ( V_8 -> V_188 ) ;
}
static T_5 * F_196 ( struct V_7 * V_8 )
{
struct V_472 V_473 [ 2 ] ;
T_5 * V_474 ;
T_5 V_475 [ 2 ] ;
T_5 V_389 ;
T_2 V_476 ;
...
int V_59 ;
int V_478 = 0 ;
unsigned V_479 , V_480 ;
V_474 = F_82 ( V_481 , V_151 ) ;
if ( ! V_474 ) {
F_2 ( V_135 ,
L_160
L_161 ) ;
...
V_478 = ( V_389 & 1 ) ;
V_476 = ( V_478 ? V_481 : 256 ) ;
F_197 ( L_163
L_164 , V_476 , V_389 ,
V_478 ? 16 : 8 ) ;
V_473 [ 0 ] . V_389 = V_389 ;
V_473 [ 0 ] . V_78 = 0 ;
V_473 [ 0 ] . V_96 = V_478 ? 2 : 1 ;
V_473 [ 0 ] . V_207 = V_475 ;
V_473 [ 1 ] . V_389 = V_389 ;
V_473 [ 1 ] . V_78 = V_482 ;
memset ( V_474 , 0 , V_481 ) ;
for ( V_480 = 0 ; V_480 < V_481 ; V_480 += V_479 ) {
V_479 = 16 ;
if ( V_479 + V_480 > V_481 ) V_479 = V_481 - V_480 ;
V_477 = V_480 + ( V_476 - V_481 ) ;
if ( V_478 ) {
V_475 [ 0 ] = V_477 >> 8 ;
V_475 [ 1 ] = V_477 ;
} else {
...
V_8 -> V_486 = ( V_483 != 2 ) ;
if ( V_8 -> V_486 ) {
V_8 -> V_485 = ( V_483 == 1 ) ? 0x4000 : 0x2000 ;
F_2 ( V_484 ,
L_167
L_168 , V_8 -> V_485 ) ;
V_8 -> V_375 = F_137 ( V_8 -> V_485 , V_151 ) ;
if ( ! V_8 -> V_375 ) {
V_8 -> V_485 = 0 ;
break;
}
...
int F_202 ( struct V_7 * V_8 , unsigned int V_477 ,
...
if ( V_477 + V_141 > V_8 -> V_485 ) V_141 = V_8 -> V_485 - V_477 ;
memcpy ( V_207 , V_8 -> V_375 + V_477 , V_141 ) ;
F_2 ( V_484 ,
L_175 ,
V_477 , V_141 ) ;
V_59 = V_141 ;
...
enum V_487 V_488 , int V_13 )
{
switch ( V_488 ) {
case V_489 : V_8 -> V_356 = V_13 ; break;
case V_490 : V_8 -> V_357 = V_13 ; break;
case V_491 : V_8 -> V_358 = V_13 ; break;
default: break;
}
}
static void F_205 ( struct V_492 * V_492 )
{
struct V_7 * V_8 = V_492 -> V_493 ;
V_8 -> V_494 = 0 ;
if ( V_8 -> V_495 ) return;
F_206 ( & V_8 -> V_496 ) ;
}
static void F_207 ( struct V_492 * V_492 )
{
struct V_7 * V_8 = V_492 -> V_493 ;
V_8 -> V_495 = 0 ;
if ( V_8 -> V_494 ) return;
...
void * V_500 , unsigned int V_501 ,
void * V_502 , unsigned int V_503 )
{
unsigned int V_131 ;
int V_504 = 0 ;
struct V_505 V_506 ;
...
V_8 -> V_509 = 1 ;
if ( V_501 ) {
V_8 -> V_510 = ( ( unsigned char * ) V_500 ) [ 0 ] ;
} else {
V_8 -> V_510 = 0 ;
}
V_8 -> V_511 = V_501 ;
...
V_8 -> V_494 = 0 ;
V_8 -> V_495 = 0 ;
F_138 ( & V_506 , F_208 , ( unsigned long ) V_8 ) ;
V_506 . V_513 = V_514 + V_498 ;
if ( V_501 ) {
V_8 -> V_509 = 2 ;
for ( V_131 = 0 ; V_131 < V_501 ; V_131 ++ ) {
V_8 -> V_359 [ V_131 ] =
( ( unsigned char * ) V_500 ) [ V_131 ] ;
}
F_211 ( V_8 -> V_362 ,
V_8 -> V_118 ,
F_79 ( V_8 -> V_118 ,
...
if ( V_501 ) {
if ( ( V_8 -> V_362 -> V_504 != 0 ) &&
( V_8 -> V_362 -> V_504 != - V_134 ) &&
( V_8 -> V_362 -> V_504 != - V_518 ) &&
( V_8 -> V_362 -> V_504 != - V_519 ) ) {
V_504 = V_8 -> V_362 -> V_504 ;
if ( ! V_499 ) {
F_2 ( V_135 ,
L_188
L_189 ,
...
if ( V_503 ) {
if ( ( V_8 -> V_363 -> V_504 != 0 ) &&
( V_8 -> V_363 -> V_504 != - V_134 ) &&
( V_8 -> V_363 -> V_504 != - V_518 ) &&
( V_8 -> V_363 -> V_504 != - V_519 ) ) {
V_504 = V_8 -> V_363 -> V_504 ;
if ( ! V_499 ) {
F_2 ( V_135 ,
L_192
L_189 ,
...
for ( V_131 = 0 ; V_131 < V_503 ; V_131 ++ ) {
( ( unsigned char * ) V_502 ) [ V_131 ] =
V_8 -> V_361 [ V_131 ] ;
}
}
V_170:
...
static int F_93 ( struct V_7 * V_8 , V_171 V_520 )
{
int V_59 ;
unsigned int V_141 = 1 ;
unsigned int args = 0 ;
F_102 ( V_8 -> V_203 ) ;
V_8 -> V_204 [ 0 ] = V_520 & 0xffu ;
args = ( V_520 >> 8 ) & 0xffu ;
args = ( args > 2 ) ? 2 : args ;
if ( args ) {
V_141 += args ;
V_8 -> V_204 [ 1 ] = ( V_520 >> 16 ) & 0xffu ;
if ( args > 1 ) {
V_8 -> V_204 [ 2 ] = ( V_520 >> 24 ) & 0xffu ;
}
}
if ( V_444 & V_206 ) {
unsigned int V_131 ;
unsigned int V_443 , V_158 ;
char V_521 [ 50 ] ;
V_520 &= 0xffu ;
V_158 = 0 ;
V_443 = F_128 ( V_521 + V_158 ,
sizeof( V_521 ) - V_158 ,
L_194 , V_520 ) ;
V_158 += V_443 ;
for ( V_131 = 0 ; V_131 < F_87 ( V_522 ) ; V_131 ++ ) {
if ( V_522 [ V_131 ] . V_66 == V_520 ) {
V_443 = F_128 ( V_521 + V_158 ,
sizeof( V_521 ) - V_158 ,
L_195 ,
V_522 [ V_131 ] . V_259 ) ;
...
F_2 ( V_206 , L_199 , V_158 , V_521 ) ;
}
V_59 = F_187 ( V_8 , V_8 -> V_204 , V_141 , NULL , 0 ) ;
F_103 ( V_8 -> V_203 ) ;
return V_59 ;
}
int F_89 ( struct V_7 * V_8 , T_2 V_523 , V_171 V_152 )
{
int V_59 ;
F_102 ( V_8 -> V_203 ) ;
V_8 -> V_204 [ 0 ] = V_524 ;
...
V_8 -> V_204 [ 5 ] = 0 ;
V_8 -> V_204 [ 6 ] = ( V_523 >> 8 ) & 0xff ;
V_8 -> V_204 [ 7 ] = V_523 & 0xff ;
V_59 = F_187 ( V_8 , V_8 -> V_204 , 8 , V_8 -> V_204 , 0 ) ;
F_103 ( V_8 -> V_203 ) ;
return V_59 ;
}
static int F_217 ( struct V_7 * V_8 , T_2 V_523 , V_171 * V_152 )
{
int V_59 = 0 ;
F_102 ( V_8 -> V_203 ) ;
V_8 -> V_204 [ 0 ] = V_525 ;
...
F_2 ( V_206 , L_206 , V_2 ) ;
V_527 [ 0 ] = V_2 ? 0x01 : 0x00 ;
V_137 = F_80 ( V_8 -> V_118 , 0 ) ;
V_59 = F_84 ( V_8 -> V_118 , V_137 , 0xa0 , 0x40 , 0xe600 , 0 , V_527 , 1 , V_153 ) ;
if ( V_59 < 0 ) {
F_2 ( V_135 ,
L_207 , V_2 , V_59 ) ;
F_121 ( V_8 ) ;
...
V_564 = 0 ;
F_247 ( V_8 ) ;
for ( V_377 = 0 ; ( V_377 < F_87 ( V_565 ) ) && V_8 -> V_369 ; V_377 ++ ) {
if ( (* V_565 [ V_377 ])( V_8 ) ) {
V_564 = ! 0 ;
V_563 = ! 0 ;
F_247 ( V_8 ) ;
...
static unsigned int F_251 ( struct V_7 * V_8 , int V_568 ,
char * V_207 , unsigned int V_566 )
{
switch ( V_568 ) {
case 0 :
...
V_207 , V_566 ,
L_234 ,
( V_8 -> V_455 ? L_235 : L_145 ) ,
( V_8 -> V_195 ?
L_236 : L_237 ) ,
( V_8 -> V_81 ? L_238 : L_145 ) ,
( V_8 -> V_456 ? L_239 : L_145 ) ) ;
case 2 :
return F_128 (
V_207 , V_566 ,
L_240 ,
...
if ( V_237 ) {
V_443 = F_128 ( V_207 + V_480 , V_566 - V_480 , L_264 , V_237 ) ;
V_480 += V_443 ;
} else {
V_443 = F_128 ( V_207 + V_480 , V_566 - V_480 ,
L_265 , V_66 ) ;
V_480 += V_443 ;
}
V_579 = F_254 ( V_235 ) ;
...
char * V_207 , unsigned int V_566 )
{
unsigned int V_158 , V_443 , V_131 ;
V_158 = 0 ;
F_102 ( V_8 -> V_188 ) ;
for ( V_131 = 0 ; ; V_131 ++ ) {
V_443 = F_251 ( V_8 , V_131 , V_207 , V_566 ) ;
if ( ! V_443 ) break;
V_158 += V_443 ; V_566 -= V_443 ; V_207 += V_443 ;
if ( ! V_566 ) break;
V_207 [ 0 ] = '\n' ; V_443 = 1 ;
V_158 += V_443 ; V_566 -= V_443 ; V_207 += V_443 ;
}
V_443 = F_253 ( V_8 , V_207 , V_566 ) ;
V_158 += V_443 ; V_566 -= V_443 ; V_207 += V_443 ;
F_103 ( V_8 -> V_188 ) ;
return V_158 ;
}
...
for ( V_131 = 0 ; ; V_131 ++ ) {
V_443 = F_251 ( V_8 , V_131 , V_207 , sizeof( V_207 ) ) ;
if ( ! V_443 ) break;
F_193 ( V_470 L_268 , V_8 -> V_1 , V_443 , V_207 ) ;
}
V_443 = F_253 ( V_8 , V_207 , sizeof( V_207 ) ) ;
V_581 = 0 ;
while ( V_581 < V_443 ) {
V_580 = 0 ;
while ( ( V_580 + V_581 < V_443 ) && ( V_207 [ V_580 + V_581 ] != '\n' ) ) {
V_580 ++ ;
}
F_193 ( V_470 L_268 , V_8 -> V_1 , V_580 , V_207 + V_581 ) ;
V_581 += V_580 + 1 ;
}
}
...
{
return F_217 ( V_8 , V_589 , V_588 ) ;
}
int F_178 ( struct V_7 * V_8 , V_171 * V_588 )
{
return F_217 ( V_8 , V_590 , V_588 ) ;
}
int F_258 ( struct V_7 * V_8 , V_171 * V_588 )
{
return F_217 ( V_8 , V_591 , V_588 ) ;
}
...
{
struct V_417 * V_466 = & V_8 -> V_50 ;
memset ( V_466 , 0 , sizeof( * V_466 ) ) ;
V_466 -> type = ( V_8 -> V_45 == V_124 ) ?
V_419 : V_420 ;
V_8 -> V_49 = 0 ;
F_98 ( & V_8 -> V_180 , 0 , V_198 , V_595 , V_466 ) ;
F_2 ( V_179 , L_277
L_278
L_279 ,
V_466 -> type ,
V_466 -> signal , V_466 -> V_101 , V_466 -> V_53 ,
V_466 -> V_55 , V_466 -> V_51 ) ;
V_8 -> V_355 = 0 ;
}
