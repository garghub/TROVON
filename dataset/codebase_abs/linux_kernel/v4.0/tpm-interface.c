...
int F_23 ( T_1 V_116 , int V_108 , T_2 * V_109 )
{
struct V_1 * V_2 ;
int V_17 ;
V_2 = F_24 ( V_116 ) ;
...
int F_27 ( T_1 V_116 , int V_108 , const T_2 * V_118 )
{
struct V_56 V_43 ;
int V_17 ;
struct V_1 * V_2 ;
...
int F_31 ( T_1 V_116 , void * V_43 , T_4 V_128 )
{
struct V_1 * V_2 ;
int V_17 ;
V_2 = F_24 ( V_116 ) ;
...
int F_33 ( struct V_1 * V_2 , T_2 V_129 , unsigned long V_85 ,
...
int F_41 ( T_1 V_116 , T_2 * V_28 , T_4 V_146 )
{
struct V_1 * V_2 ;
struct V_56 V_57 ;
T_1 V_147 , V_148 = F_42 ( T_1 , V_146 , V_149 ) ;
...
{
int V_17 ;
V_160 = F_45 ( V_161 , L_24 ) ;
if ( F_46 ( V_160 ) ) {
F_47 ( L_25 ) ;
return F_48 ( V_160 ) ;
}
V_17 = F_49 ( & V_162 , 0 , V_163 , L_24 ) ;
if ( V_17 < 0 ) {
F_47 ( L_26 ) ;
F_50 ( V_160 ) ;
return V_17 ;
