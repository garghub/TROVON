...
F_68 ( V_2 -> V_85 , V_2 ) ;
F_69 ( & V_2 -> V_95 ) ;
F_21 ( & V_2 -> V_107 . V_133 ) ;
}
static int F_70 ( struct V_134 * V_4 ,
struct V_133 * V_24 )
{
struct V_1 * V_2 ;
bool V_135 = false ;
T_1 V_6 , V_136 ;
int V_50 ;
V_2 = F_71 ( V_4 -> V_32 , sizeof( * V_2 ) , V_20 ) ;
if ( ! V_2 )
return - V_38 ;
V_2 -> V_32 = V_4 -> V_32 ;
V_2 -> V_4 = V_4 ;
...
F_18 ( & V_2 -> V_27 ) ;
F_18 ( & V_2 -> V_28 ) ;
V_135 = F_73 ( V_24 , L_11 ) ;
V_2 -> V_121 = F_73 ( V_24 , L_12 ) ;
V_50 = F_74 ( V_24 , L_13 , & V_6 ) ;
if ( V_50 ) {
F_35 ( V_4 -> V_32 , L_14 ) ;
return V_50 ;
}
...
V_2 -> V_85 = F_77 ( V_24 , 0 ) ;
V_50 = F_78 ( V_2 -> V_85 , F_55 , V_147 ,
L_18 , V_2 ) ;
if ( V_50 ) {
...
F_79 ( & V_2 -> V_95 , F_31 ,
( unsigned long ) V_2 ) ;
V_2 -> V_107 . V_148 = & V_4 -> V_107 ;
F_52 ( & V_2 -> V_107 . V_133 , & V_4 -> V_107 . V_149 ) ;
...
static struct V_30 * F_80 ( struct V_150 * V_151 ,
struct V_152 * V_153 )
{
struct V_134 * V_4 = V_153 -> V_154 ;
int V_155 = V_151 -> args [ 0 ] ;
if ( V_155 >= V_156 )
return NULL ;
return F_81 ( & V_4 -> V_2 [ V_155 ] -> V_107 ) ;
}
static int F_82 ( struct V_157 * V_158 )
{
struct V_133 * V_24 = V_158 -> V_32 . V_159 ;
struct V_134 * V_4 ;
struct V_133 * V_160 ;
struct V_161 * V_162 ;
T_1 V_163 ;
int V_72 , V_50 ;
V_4 = F_71 ( & V_158 -> V_32 , sizeof( * V_4 ) , V_20 ) ;
if ( ! V_4 )
return - V_38 ;
V_4 -> V_32 = & V_158 -> V_32 ;
V_162 = F_83 ( V_158 , V_164 , 0 ) ;
V_4 -> V_5 = F_84 ( & V_158 -> V_32 , V_162 ) ;
if ( F_85 ( V_4 -> V_5 ) )
return F_86 ( V_4 -> V_5 ) ;
V_4 -> V_56 = F_73 ( V_24 , L_21 ) ;
V_50 = F_74 ( V_24 , L_22 , & V_163 ) ;
if ( V_50 < 0 ) {
F_35 ( V_4 -> V_32 , L_23 ) ;
return V_50 ;
}
...
if ( V_50 < 0 )
F_87 ( V_4 -> V_32 , L_25 ) ;
V_4 -> V_107 . V_32 = & V_158 -> V_32 ;
F_18 ( & V_4 -> V_107 . V_149 ) ;
F_88 ( V_165 , V_4 -> V_107 . V_166 ) ;
F_88 ( V_167 , V_4 -> V_107 . V_166 ) ;
V_4 -> V_107 . V_168 =
F_32 ;
V_4 -> V_107 . V_169 =
F_25 ;
V_4 -> V_107 . V_170 =
F_60 ;
V_4 -> V_107 . V_171 = F_65 ;
V_4 -> V_107 . V_172 = F_37 ;
V_4 -> V_107 . V_173 = F_49 ;
F_89 ( V_158 , V_4 ) ;
F_90 (node, child) {
V_50 = F_70 ( V_4 , V_160 ) ;
if ( V_50 < 0 )
...
for ( V_72 = 0 ; V_72 < V_156 ; V_72 ++ )
if ( V_4 -> V_2 [ V_72 ] )
V_4 -> V_2 [ V_72 ] -> V_64 = V_163 ;
F_91 ( & V_4 -> V_107 ) ;
V_50 = F_92 ( V_24 , F_80 ,
V_4 ) ;
if ( V_50 < 0 ) {
F_35 ( & V_158 -> V_32 , L_26 ) ;
F_93 ( & V_4 -> V_107 ) ;
goto error;
}
F_94 ( & V_158 -> V_32 , L_27 ) ;
return 0 ;
error:
for ( V_72 = 0 ; V_72 < V_156 ; V_72 ++ )
if ( V_4 -> V_2 [ V_72 ] )
...
static int F_95 ( struct V_157 * V_158 )
{
struct V_134 * V_4 = F_96 ( V_158 ) ;
int V_72 ;
F_97 ( V_158 -> V_32 . V_159 ) ;
F_93 ( & V_4 -> V_107 ) ;
for ( V_72 = 0 ; V_72 < V_156 ; V_72 ++ )
if ( V_4 -> V_2 [ V_72 ] )
F_67 ( V_4 -> V_2 [ V_72 ] ) ;
