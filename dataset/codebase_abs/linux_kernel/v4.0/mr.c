...
if ( ! V_111 )
return - V_18 ;
F_78 ( & V_20 -> V_113 -> V_114 -> V_20 , V_112 ,
V_36 * sizeof ( T_2 ) , V_115 ) ;
for ( V_12 = 0 ; V_12 < V_36 ; ++ V_12 )
V_111 [ V_12 ] = F_74 ( V_110 [ V_12 ] | V_116 ) ;
F_79 ( & V_20 -> V_113 -> V_114 -> V_20 , V_112 ,
V_36 * sizeof ( T_2 ) , V_115 ) ;
return 0 ;
}
...
int V_118 ;
int V_119 ;
V_118 = V_120 / sizeof( T_2 ) ;
V_119 = V_118 - ( V_39 -> V_24 + V_109 )
% V_118 ;
V_117 = F_81 ( int , V_119 , V_36 ) ;
while ( V_36 > 0 ) {
V_30 = F_77 ( V_20 , V_39 , V_109 , V_117 , V_110 ) ;
if ( V_30 )
return V_30 ;
V_36 -= V_117 ;
V_109 += V_117 ;
V_110 += V_117 ;
V_117 = F_81 ( int , V_118 , V_36 ) ;
}
return V_30 ;
}
...
V_121 = V_48 -> V_66 ;
while ( V_36 > 0 ) {
V_117 = F_81 ( int , V_122 / sizeof( T_2 ) - 2 ,
V_36 ) ;
V_121 [ 0 ] = F_74 ( V_39 -> V_24 + V_109 ) ;
V_121 [ 1 ] = 0 ;
for ( V_12 = 0 ; V_12 < V_117 ; ++ V_12 )
V_121 [ V_12 + 2 ] = F_74 ( V_110 [ V_12 ] |
V_116 ) ;
V_30 = F_56 ( V_20 , V_48 , V_117 ) ;
if ( V_30 ) {
F_45 ( V_20 , V_48 ) ;
return V_30 ;
}
...
if ( V_66 -> V_124 == 1 )
V_110 [ V_12 ] = V_66 -> V_125 . V_126 + ( V_12 << V_66 -> V_37 ) ;
else
V_110 [ V_12 ] = V_66 -> V_110 [ V_12 ] . V_126 ;
V_30 = F_82 ( V_20 , V_39 , 0 , V_66 -> V_36 , V_110 ) ;
F_15 ( V_110 ) ;
return V_30 ;
}
int F_85 ( struct V_19 * V_20 , T_1 V_69 , enum V_127 type ,
struct V_128 * V_129 )
{
T_1 V_89 ;
if ( ( type == V_130 &&
! ( V_20 -> V_43 . V_76 & V_131 ) ) ||
( type == V_132 &&
! ( V_20 -> V_43 . V_133 & V_134 ) ) )
return - V_135 ;
V_89 = F_59 ( V_20 ) ;
if ( V_89 == - 1 )
return - V_18 ;
V_129 -> V_46 = F_35 ( V_89 ) ;
V_129 -> V_69 = V_69 ;
V_129 -> type = type ;
V_129 -> V_59 = V_82 ;
return 0 ;
}
int F_86 ( struct V_19 * V_20 , struct V_128 * V_129 )
{
struct V_47 * V_48 ;
struct V_56 * V_57 ;
int V_30 ;
V_30 = F_65 ( V_20 , F_36 ( V_129 -> V_46 ) , V_14 ) ;
if ( V_30 )
return V_30 ;
V_48 = F_42 ( V_20 ) ;
if ( F_76 ( V_48 ) ) {
...
V_57 = V_48 -> V_66 ;
V_57 -> V_46 = F_53 ( F_36 ( V_129 -> V_46 ) ) ;
V_57 -> V_70 = F_53 ( V_129 -> V_69 ) ;
if ( V_129 -> type == V_132 ) {
V_57 -> V_76 |= F_53 ( V_98 ) ;
V_57 -> V_136 = F_53 ( V_137 ) ;
V_57 -> V_70 |= F_53 ( V_74 ) ;
}
V_30 = F_37 ( V_20 , V_48 ,
F_36 ( V_129 -> V_46 ) &
...
F_45 ( V_20 , V_48 ) ;
V_105:
F_68 ( V_20 , F_36 ( V_129 -> V_46 ) ) ;
return V_30 ;
}
void F_87 ( struct V_19 * V_20 , struct V_128 * V_129 )
{
int V_30 ;
if ( V_129 -> V_59 == V_60 ) {
V_30 = F_38 ( V_20 , NULL ,
...
return;
if ( V_85 -> V_141 >= 0 )
F_29 ( V_20 , V_85 -> V_141 ,
F_93 ( V_20 -> V_43 . V_141 - 1 ) ) ;
F_16 ( & V_22 -> V_26 ) ;
F_94 ( & V_22 -> V_86 ) ;
}
static inline int F_96 ( struct V_143 * V_144 , T_2 * V_110 ,
int V_36 , T_2 V_79 )
{
int V_12 , V_145 ;
if ( V_36 > V_144 -> V_146 )
return - V_61 ;
V_145 = ( 1 << V_144 -> V_37 ) - 1 ;
if ( V_79 & V_145 )
return - V_61 ;
if ( 0 )
for ( V_12 = 0 ; V_12 < V_36 ; ++ V_12 ) {
...
int F_97 ( struct V_19 * V_20 , struct V_143 * V_144 , T_2 * V_110 ,
int V_36 , T_2 V_79 , T_1 * V_149 , T_1 * V_150 )
{
T_1 V_46 ;
int V_12 , V_30 ;
V_30 = F_96 ( V_144 , V_110 , V_36 , V_79 ) ;
if ( V_30 )
return V_30 ;
++ V_144 -> V_147 ;
V_46 = F_36 ( V_144 -> V_81 . V_46 ) ;
V_46 += V_20 -> V_43 . V_58 ;
* V_149 = * V_150 = V_144 -> V_81 . V_46 = F_35 ( V_46 ) ;
* ( V_67 * ) V_144 -> V_151 = V_152 ;
F_47 () ;
F_78 ( & V_20 -> V_113 -> V_114 -> V_20 , V_144 -> V_112 ,
V_36 * sizeof( T_2 ) , V_115 ) ;
for ( V_12 = 0 ; V_12 < V_36 ; ++ V_12 )
V_144 -> V_111 [ V_12 ] = F_74 ( V_110 [ V_12 ] | V_116 ) ;
F_79 ( & V_20 -> V_113 -> V_114 -> V_20 , V_144 -> V_112 ,
V_36 * sizeof( T_2 ) , V_115 ) ;
V_144 -> V_151 -> V_46 = F_53 ( V_46 ) ;
V_144 -> V_151 -> V_149 = F_53 ( V_46 ) ;
V_144 -> V_151 -> V_96 = F_74 ( V_36 * ( 1ull << V_144 -> V_37 ) ) ;
V_144 -> V_151 -> V_95 = F_74 ( V_79 ) ;
F_47 () ;
* ( V_67 * ) V_144 -> V_151 = V_68 ;
F_47 () ;
return 0 ;
}
int F_98 ( struct V_19 * V_20 , T_1 V_69 , T_1 V_75 , int V_146 ,
int V_148 , V_67 V_37 , struct V_143 * V_144 )
{
struct F_18 * V_85 = F_18 ( V_20 ) ;
int V_30 = - V_18 ;
if ( V_148 > V_20 -> V_43 . V_153 )
return - V_61 ;
if ( V_37 < ( F_99 ( V_20 -> V_43 . V_154 ) - 1 ) || V_37 >= 32 )
return - V_61 ;
if ( V_146 * sizeof * V_144 -> V_111 > V_120 )
return - V_61 ;
V_144 -> V_37 = V_37 ;
V_144 -> V_146 = V_146 ;
V_144 -> V_148 = V_148 ;
V_144 -> V_147 = 0 ;
V_30 = F_69 ( V_20 , V_69 , 0 , 0 , V_75 , V_146 ,
V_37 , & V_144 -> V_81 ) ;
if ( V_30 )
return V_30 ;
V_144 -> V_111 = F_41 ( & V_85 -> V_22 . V_27 ,
V_144 -> V_81 . V_39 . V_24 ,
& V_144 -> V_112 ) ;
if ( ! V_144 -> V_111 ) {
V_30 = - V_18 ;
goto V_155;
...
return 0 ;
V_155:
( void ) F_71 ( V_20 , & V_144 -> V_81 ) ;
return V_30 ;
}
int F_100 ( struct V_19 * V_20 , struct V_143 * V_144 )
{
struct F_18 * V_85 = F_18 ( V_20 ) ;
int V_30 ;
V_30 = F_75 ( V_20 , & V_144 -> V_81 ) ;
if ( V_30 )
return V_30 ;
V_144 -> V_151 = F_41 ( & V_85 -> V_22 . V_63 ,
F_36 ( V_144 -> V_81 . V_46 ) , NULL ) ;
if ( ! V_144 -> V_151 )
return - V_18 ;
return 0 ;
}
void F_101 ( struct V_19 * V_20 , struct V_143 * V_144 ,
T_1 * V_149 , T_1 * V_150 )
{
struct V_47 * V_48 ;
int V_30 ;
...
V_144 -> V_81 . V_59 = V_62 ;
}
int F_103 ( struct V_19 * V_20 , struct V_143 * V_144 )
{
int V_94 ;
if ( V_144 -> V_147 )
return - V_156 ;
V_94 = F_71 ( V_20 , & V_144 -> V_81 ) ;
if ( V_94 )
return V_94 ;
V_144 -> V_81 . V_59 = V_82 ;
return 0 ;
}
int F_48 ( struct V_19 * V_20 )
{
return F_31 ( V_20 , 0 , 0 , 0 , V_157 ,
V_34 , V_158 ) ;
}
