...
{
struct V_55 * V_55 = & V_54 -> V_56 ;
struct V_1 * V_2 = F_62 ( V_55 -> V_91 ) -> V_2 ;
F_63 ( V_58 -> V_90 ) ;
V_58 -> V_92 = V_55 -> V_93 ;
V_58 -> V_94 = V_55 -> V_95 ;
V_58 -> V_96 = V_55 -> V_97 ;
...
F_55 ( V_58 -> V_60 ) , V_58 -> V_92 ,
V_58 -> V_86 ) ;
return 0 ;
}
F_2 ( L_23 ,
V_55 , V_58 , V_58 -> V_88 ,
V_58 -> V_88 -> V_44 , F_55 ( V_58 -> V_60 ) ,
V_58 -> V_92 ) ;
F_5 ( & V_2 -> V_101 ) ;
F_60 ( & V_54 -> V_102 , & V_2 -> V_103 ) ;
F_7 ( & V_2 -> V_101 ) ;
return 1 ;
}
...
i_snap_realm_item) {
struct V_55 * V_55 = F_65 ( & V_54 -> V_56 ) ;
if ( ! V_55 )
continue;
F_7 ( & V_4 -> V_25 ) ;
F_66 ( V_104 ) ;
...
F_2 ( L_27 , V_106 ) ;
V_113:
F_69 ( & V_12 , V_105 , sizeof( * V_109 ) , V_114 ) ;
V_109 = V_12 ;
V_12 += sizeof( * V_109 ) ;
F_69 ( & V_12 , V_105 , sizeof( T_1 ) * ( F_70 ( V_109 -> V_42 ) +
F_70 ( V_109 -> V_41 ) ) , V_114 ) ;
V_29 = V_12 ;
V_12 += sizeof( T_1 ) * F_70 ( V_109 -> V_42 ) ;
V_28 = V_12 ;
V_12 += sizeof( T_1 ) * F_70 ( V_109 -> V_41 ) ;
V_4 = F_20 ( V_2 , F_71 ( V_109 -> V_16 ) ) ;
if ( ! V_4 ) {
V_4 = F_13 ( V_2 , F_71 ( V_109 -> V_16 ) ) ;
if ( F_38 ( V_4 ) ) {
V_39 = F_39 ( V_4 ) ;
goto V_43;
}
}
V_39 = F_37 ( V_2 , V_4 , F_71 ( V_109 -> V_13 ) ) ;
if ( V_39 < 0 )
goto V_43;
V_111 += V_39 ;
if ( F_71 ( V_109 -> V_44 ) > V_4 -> V_44 ) {
F_2 ( L_28 ,
V_4 -> V_16 , V_4 , V_4 -> V_44 , F_71 ( V_109 -> V_44 ) ) ;
V_4 -> V_44 = F_71 ( V_109 -> V_44 ) ;
V_4 -> V_115 = F_71 ( V_109 -> V_115 ) ;
V_4 -> V_49 = F_71 ( V_109 -> V_49 ) ;
V_4 -> V_42 = F_70 ( V_109 -> V_42 ) ;
...
struct V_120 * V_121 )
{
struct V_122 * V_123 = V_2 -> V_124 -> V_123 ;
int V_125 = V_118 -> V_126 ;
T_1 V_127 ;
int V_128 ;
int V_129 ;
struct V_3 * V_4 = NULL ;
void * V_12 = V_121 -> V_130 . V_131 ;
void * V_105 = V_12 + V_121 -> V_130 . V_132 ;
struct V_133 * V_134 ;
int V_135 , V_136 ;
T_3 * V_137 = NULL , * V_138 = NULL ;
int V_48 ;
int V_139 = 0 ;
if ( V_121 -> V_130 . V_132 < sizeof( * V_134 ) )
goto V_114;
V_134 = V_12 ;
V_128 = F_70 ( V_134 -> V_128 ) ;
V_127 = F_71 ( V_134 -> V_127 ) ;
V_135 = F_70 ( V_134 -> V_135 ) ;
V_136 = F_70 ( V_134 -> V_136 ) ;
V_129 = F_70 ( V_134 -> V_129 ) ;
V_12 += sizeof( * V_134 ) ;
F_2 ( L_35 , V_125 ,
F_77 ( V_128 ) , V_127 , V_129 ) ;
F_78 ( & V_118 -> V_119 ) ;
V_118 -> V_140 ++ ;
F_74 ( & V_118 -> V_119 ) ;
F_36 ( & V_2 -> V_31 ) ;
...
struct V_108 * V_109 ;
V_137 = V_12 ;
V_12 += sizeof( T_1 ) * V_135 ;
V_138 = V_12 ;
V_12 += sizeof( T_1 ) * V_136 ;
F_69 ( & V_12 , V_105 , sizeof( * V_109 ) , V_114 ) ;
V_109 = V_12 ;
V_4 = F_20 ( V_2 , V_127 ) ;
if ( ! V_4 ) {
...
for ( V_48 = 0 ; V_48 < V_135 ; V_48 ++ ) {
struct V_143 V_144 = {
. V_16 = F_71 ( V_137 [ V_48 ] ) ,
. V_145 = V_146 ,
} ;
struct V_55 * V_55 = F_79 ( V_123 , V_144 ) ;
struct V_53 * V_54 ;
struct V_3 * V_147 ;
if ( ! V_55 )
continue;
