...
V_208 += 8 ;
V_207 = F_103 ( V_205 -> V_212 , sizeof( * V_207 ) , V_213 ) ;
if ( ! V_207 )
return - V_214 ;
V_88 = F_103 ( V_208 , sizeof( * V_88 ) , V_213 ) ;
if ( ! V_88 )
goto V_215;
for ( V_66 = 0 ; V_66 < V_208 ; V_66 ++ )
F_101 ( & V_88 [ V_66 ] , V_66 , F_87 ( V_66 ) ) ;
for ( V_66 = 0 ; V_66 < V_205 -> V_212 ; V_66 ++ ) {
F_99 ( & V_207 [ V_66 ] ,
V_205 -> V_207 [ V_66 ] . V_191 ,
V_205 -> V_216 [ V_66 ] . V_197 , V_66 ) ;
}
...
F_106 ( V_2 -> V_28 ) ;
if ( F_47 ( V_2 -> V_28 -> V_220 -> V_154 [ V_194 ] ) ) {
F_104 ( V_2 -> V_28 -> V_220 -> V_154 [ V_194 ] -> V_207 ) ;
F_104 ( V_2 -> V_28 -> V_220 -> V_154 [ V_194 ] -> V_157 ) ;
V_2 -> V_28 -> V_220 -> V_154 [ V_194 ] = NULL ;
V_2 -> V_28 -> V_220 -> V_154 [ V_195 ] = NULL ;
}
F_104 ( V_2 -> V_205 . V_216 ) ;
}
...
if ( V_9 )
return V_9 ;
V_2 -> V_28 -> V_225 = V_2 -> V_7 -> V_226 ;
V_2 -> V_28 -> V_72 =
F_108 (unsigned int, IEEE80211_TX_STATUS_HEADROOM,
rt2x00dev->extra_tx_headroom) ;
if ( F_62 ( V_2 , V_74 ) )
V_2 -> V_28 -> V_72 += V_227 ;
else if ( F_62 ( V_2 , V_228 ) )
V_2 -> V_28 -> V_72 += V_229 ;
V_2 -> V_28 -> V_230 = sizeof( struct V_231 ) ;
if ( F_62 ( V_2 , V_232 ) ) {
int V_233 =
F_109 ( V_2 -> V_7 -> V_226 *
V_2 -> V_234 -> V_235 *
sizeof( T_1 ) ) ;
V_9 = F_110 ( & V_2 -> V_236 , V_233 ,
V_213 ) ;
if ( V_9 )
return V_9 ;
}
...
V_251 -> V_256 = F_123 ( V_38 ) ;
#ifdef F_124
V_251 -> V_256 |= F_123 ( V_40 ) ;
#endif
...
V_253 -> V_262 = 1 ;
V_2 -> V_28 -> V_220 -> V_263 = V_2 -> V_257 ;
V_2 -> V_28 -> V_220 -> V_264 = 1 ;
}
...
return 0 ;
if ( F_38 ( V_2 ) )
return V_2 -> V_234 [ 0 ] . V_265 + V_2 -> V_234 [ 0 ] . V_266 ;
return V_2 -> V_234 [ 0 ] . V_265 ;
}
...
F_128 ( & V_2 -> V_55 ) ;
F_7 ( V_31 , & V_2 -> V_11 ) ;
V_2 -> V_28 -> V_272 = sizeof( struct V_20 ) ;
V_2 -> V_28 -> V_220 -> V_273 [ V_274 - 1 ] =
( V_2 -> V_7 -> V_8 - 1 ) ;
V_2 -> V_144 =
F_131 ( L_5 , 0 , F_132 ( V_2 -> V_28 -> V_220 ) ) ;
if ( ! V_2 -> V_144 ) {
V_246 = - V_214 ;
goto exit;
}
F_133 ( & V_2 -> V_27 , F_27 ) ;
F_134 ( & V_2 -> V_30 , F_30 ) ;
F_133 ( & V_2 -> V_118 , F_75 ) ;
V_246 = V_2 -> V_7 -> V_12 -> V_275 ( V_2 ) ;
if ( V_246 ) {
F_31 ( V_2 , L_6 ) ;
goto exit;
}
...
goto exit;
V_2 -> V_72 = F_125 ( V_2 ) ;
V_2 -> V_28 -> V_220 -> V_276 = F_123 ( V_277 ) ;
if ( V_2 -> V_278 -> V_235 > 0 )
V_2 -> V_28 -> V_220 -> V_276 |=
F_123 ( V_39 ) |
F_123 ( V_38 ) |
#ifdef F_124
F_123 ( V_40 ) |
...
int F_150 ( struct V_1 * V_2 , T_8 V_283 )
{
F_151 ( V_2 , L_8 ) ;
...
F_152 ( V_2 ) ;
F_146 ( V_2 ) ;
if ( V_2 -> V_7 -> V_12 -> V_13 ( V_2 , V_284 ) )
F_88 ( V_2 , L_9 ) ;
return 0 ;
}
