...
V_61 = F_15 ( V_2 , V_63 -> V_67 ) ;
if ( ! V_61 ) {
F_14 ( V_5 -> V_7 , L_6 ) ;
return - 1 ;
}
switch ( F_16 ( V_63 -> type ) ) {
case V_68 :
F_17 ( V_2 -> V_55 ,
V_63 -> V_67 ,
V_69 ,
...
break;
case V_147 :
V_72 = F_16 ( * ( V_80 * ) V_5 -> V_81 ) ;
F_2 ( V_5 -> V_7 , L_41 , V_72 ) ;
V_5 -> V_148 =
F_31 ( T_1 , V_5 -> V_149 , V_72 ) ;
F_2 ( V_5 -> V_7 , L_42 ,
V_5 -> V_148 ) ;
break;
case V_150 :
