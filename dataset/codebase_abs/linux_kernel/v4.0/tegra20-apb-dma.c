...
T_1 V_117 , enum V_107 V_108 , int V_118 )
{
int V_119 ;
int V_120 ;
V_119 = V_117 * V_108 ;
...
enum V_124 V_125 , unsigned long * V_126 ,
unsigned long * V_57 , unsigned long * V_45 , unsigned int * V_117 ,
enum V_107 * V_108 )
{
switch ( V_125 ) {
case V_127 :
* V_126 = V_7 -> V_33 . V_128 ;
* V_57 = F_60 ( V_7 , V_7 -> V_33 . V_129 ) ;
* V_117 = V_7 -> V_33 . V_130 ;
* V_108 = V_7 -> V_33 . V_129 ;
* V_45 = V_131 ;
return 0 ;
case V_132 :
* V_126 = V_7 -> V_33 . V_133 ;
* V_57 = F_60 ( V_7 , V_7 -> V_33 . V_134 ) ;
* V_117 = V_7 -> V_33 . V_135 ;
* V_108 = V_7 -> V_33 . V_134 ;
* V_45 = 0 ;
return 0 ;
default:
F_18 ( F_10 ( V_7 ) , L_13 ) ;
...
struct V_54 * V_55 , T_1 V_118 )
{
T_1 V_137 = ( V_118 - 4 ) & 0xFFFC ;
if ( V_7 -> V_2 -> V_41 -> V_64 )
V_55 -> V_66 = V_137 ;
else
V_55 -> V_45 |= V_137 ;
...
enum V_124 V_125 , unsigned long V_18 ,
void * V_141 )
{
struct V_6 * V_7 = F_7 ( V_10 ) ;
struct V_11 * V_17 ;
...
V_104 = F_63 ( V_7 , V_125 , & V_59 , & V_57 , & V_45 ,
& V_117 , & V_108 ) ;
if ( V_104 < 0 )
return NULL ;
F_66 ( & V_145 ) ;
...
V_61 |= F_62 ( V_7 , V_117 , V_108 , V_118 ) ;
V_17 -> V_106 += V_118 ;
V_28 -> V_55 . V_59 = V_59 ;
V_28 -> V_55 . V_63 = V_155 ;
V_28 -> V_55 . V_45 = V_45 ;
F_64 ( V_7 , & V_28 -> V_55 , V_118 ) ;
V_28 -> V_55 . V_57 = V_57 ;
V_28 -> V_55 . V_61 = V_61 ;
V_28 -> V_68 = false ;
V_28 -> V_74 = false ;
...
struct V_9 * V_10 , T_5 V_158 , T_6 V_159 ,
T_6 V_160 , enum V_124 V_125 ,
unsigned long V_18 )
{
struct V_6 * V_7 = F_7 ( V_10 ) ;
...
static struct V_9 * F_77 ( struct V_167 * V_168 ,
struct V_169 * V_170 )
{
...
static int F_79 ( struct V_173 * V_174 )
{
struct V_175 * V_176 ;
struct V_1 * V_2 ;
int V_104 ;
...
V_180 = F_80 ( V_181 , & V_174 -> V_16 ) ;
if ( ! V_180 ) {
F_18 ( & V_174 -> V_16 , L_29 ) ;
return - V_182 ;
}
V_178 = V_180 -> V_86 ;
V_2 = F_81 ( & V_174 -> V_16 , sizeof( * V_2 ) + V_178 -> V_183 *
...
V_2 -> V_41 = V_178 ;
F_82 ( V_174 , V_2 ) ;
V_176 = F_83 ( V_174 , V_186 , 0 ) ;
V_2 -> V_5 = F_84 ( & V_174 -> V_16 , V_176 ) ;
if ( F_85 ( V_2 -> V_5 ) )
return F_86 ( V_2 -> V_5 ) ;
V_2 -> V_163 = F_87 ( & V_174 -> V_16 , NULL ) ;
if ( F_85 ( V_2 -> V_163 ) ) {
F_18 ( & V_174 -> V_16 , L_31 ) ;
return F_86 ( V_2 -> V_163 ) ;
}
V_2 -> V_187 = F_88 ( & V_174 -> V_16 , L_32 ) ;
if ( F_85 ( V_2 -> V_187 ) ) {
F_18 ( & V_174 -> V_16 , L_33 ) ;
return F_86 ( V_2 -> V_187 ) ;
}
F_89 ( & V_2 -> V_37 ) ;
F_90 ( & V_174 -> V_16 ) ;
if ( ! F_91 ( & V_174 -> V_16 ) ) {
V_104 = F_92 ( & V_174 -> V_16 ) ;
if ( V_104 ) {
F_18 ( & V_174 -> V_16 , L_34 ,
V_104 ) ;
goto V_188;
}
}
...
F_76 ( V_2 -> V_163 ) ;
F_66 ( & V_2 -> V_172 . V_191 ) ;
for ( V_142 = 0 ; V_142 < V_178 -> V_183 ; V_142 ++ ) {
struct V_6 * V_7 = & V_2 -> V_191 [ V_142 ] ;
V_7 -> V_8 = V_192 +
V_142 * V_178 -> V_193 ;
V_176 = F_83 ( V_174 , V_194 , V_142 ) ;
if ( ! V_176 ) {
V_104 = - V_136 ;
F_18 ( & V_174 -> V_16 , L_35 , V_142 ) ;
goto V_195;
}
V_7 -> V_89 = V_176 -> V_196 ;
snprintf ( V_7 -> V_197 , sizeof( V_7 -> V_197 ) , L_36 , V_142 ) ;
V_104 = F_95 ( & V_174 -> V_16 , V_7 -> V_89 ,
F_50 , 0 , V_7 -> V_197 , V_7 ) ;
if ( V_104 ) {
F_18 ( & V_174 -> V_16 ,
L_37 ,
V_104 , V_142 ) ;
...
F_97 ( V_199 , V_2 -> V_172 . V_200 ) ;
F_97 ( V_201 , V_2 -> V_172 . V_200 ) ;
F_97 ( V_202 , V_2 -> V_172 . V_200 ) ;
V_2 -> V_172 . V_16 = & V_174 -> V_16 ;
V_2 -> V_172 . V_203 =
F_71 ;
V_2 -> V_172 . V_204 =
F_74 ;
V_2 -> V_172 . V_205 = F_65 ;
V_2 -> V_172 . V_206 = F_70 ;
V_2 -> V_172 . V_207 = F_98 ( V_109 ) |
F_98 ( V_111 ) |
F_98 ( V_113 ) |
F_98 ( V_115 ) ;
V_2 -> V_172 . V_208 = F_98 ( V_109 ) |
F_98 ( V_111 ) |
F_98 ( V_113 ) |
F_98 ( V_115 ) ;
V_2 -> V_172 . V_209 = F_98 ( V_132 ) | F_98 ( V_127 ) ;
V_2 -> V_172 . V_210 = V_211 ;
V_2 -> V_172 . V_212 = F_27 ;
V_2 -> V_172 . V_213 = F_56 ;
V_2 -> V_172 . V_214 = F_57 ;
V_2 -> V_172 . V_215 = F_55 ;
V_104 = F_99 ( & V_2 -> V_172 ) ;
if ( V_104 < 0 ) {
F_18 ( & V_174 -> V_16 ,
L_38 , V_104 ) ;
goto V_195;
}
V_104 = F_100 ( V_174 -> V_16 . V_216 ,
F_77 , V_2 ) ;
if ( V_104 < 0 ) {
F_18 ( & V_174 -> V_16 ,
L_39 , V_104 ) ;
...
static int F_106 ( struct V_173 * V_174 )
{
struct V_1 * V_2 = F_107 ( V_174 ) ;
int V_142 ;
struct V_6 * V_7 ;
F_101 ( & V_2 -> V_172 ) ;
for ( V_142 = 0 ; V_142 < V_2 -> V_41 -> V_183 ; ++ V_142 ) {
V_7 = & V_2 -> V_191 [ V_142 ] ;
F_102 ( & V_7 -> V_91 ) ;
}
F_103 ( & V_174 -> V_16 ) ;
