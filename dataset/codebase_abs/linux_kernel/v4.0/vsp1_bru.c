...
static struct V_70 * F_25 ( struct V_1 * V_2 ,
struct V_52 * V_53 ,
unsigned int V_59 , T_1 V_71 )
{
switch ( V_71 ) {
case V_72 :
return F_26 ( V_53 , V_59 ) ;
case V_73 :
...
{
struct V_1 * V_2 = F_10 ( V_17 ) ;
V_76 -> V_22 = * F_28 ( & V_2 -> V_4 , V_53 , V_76 -> V_59 ,
V_76 -> V_71 ) ;
return 0 ;
}
...
break;
default:
V_22 = F_28 ( & V_2 -> V_4 , V_53 ,
F_21 ( 0 ) , V_71 ) ;
V_76 -> V_55 = V_22 -> V_55 ;
break;
}
V_76 -> V_34 = F_30 ( V_76 -> V_34 , V_65 , V_67 ) ;
V_76 -> V_36 = F_30 ( V_76 -> V_36 , V_65 , V_67 ) ;
V_76 -> V_78 = V_79 ;
V_76 -> V_80 = V_81 ;
}
static int F_31 ( struct V_16 * V_17 , struct V_52 * V_53 ,
struct V_75 * V_76 )
{
struct V_1 * V_2 = F_10 ( V_17 ) ;
struct V_21 * V_22 ;
F_29 ( V_2 , V_53 , V_76 -> V_59 , & V_76 -> V_22 , V_76 -> V_71 ) ;
V_22 = F_28 ( & V_2 -> V_4 , V_53 , V_76 -> V_59 ,
V_76 -> V_71 ) ;
* V_22 = V_76 -> V_22 ;
if ( V_76 -> V_59 != V_27 ) {
struct V_70 * V_74 ;
V_74 = F_25 ( V_2 , V_53 , V_76 -> V_59 , V_76 -> V_71 ) ;
V_74 -> V_82 = 0 ;
V_74 -> V_83 = 0 ;
V_74 -> V_34 = V_22 -> V_34 ;
V_74 -> V_36 = V_22 -> V_36 ;
...
return 0 ;
case V_89 :
V_85 -> V_88 = * F_25 ( V_2 , V_53 , V_85 -> V_59 , V_85 -> V_71 ) ;
return 0 ;
default:
return - V_61 ;
}
...
if ( V_85 -> V_86 != V_89 )
return - V_61 ;
V_22 = F_28 ( & V_2 -> V_4 , V_53 , V_27 ,
V_85 -> V_71 ) ;
V_85 -> V_88 . V_82 = F_34 (unsigned int, sel->r.left, 0 , format->width - 1 ) ;
V_85 -> V_88 . V_83 = F_34 (unsigned int, sel->r.top, 0 , format->height - 1 ) ;
V_22 = F_28 ( & V_2 -> V_4 , V_53 , V_85 -> V_59 ,
V_85 -> V_71 ) ;
V_85 -> V_88 . V_34 = V_22 -> V_34 ;
V_85 -> V_88 . V_36 = V_22 -> V_36 ;
V_74 = F_25 ( V_2 , V_53 , V_85 -> V_59 , V_85 -> V_71 ) ;
* V_74 = V_85 -> V_88 ;
return 0 ;
}
struct V_1 * F_35 ( struct V_90 * V_5 )
{
struct V_16 * V_17 ;
struct V_1 * V_2 ;
int V_25 ;
V_2 = F_36 ( V_5 -> V_91 , sizeof( * V_2 ) , V_92 ) ;
if ( V_2 == NULL )
return F_37 ( - V_93 ) ;
V_2 -> V_4 . type = V_94 ;
V_25 = F_38 ( V_5 , & V_2 -> V_4 , 5 ) ;
if ( V_25 < 0 )
return F_37 ( V_25 ) ;
V_17 = & V_2 -> V_4 . V_17 ;
F_39 ( V_17 , & V_95 ) ;
