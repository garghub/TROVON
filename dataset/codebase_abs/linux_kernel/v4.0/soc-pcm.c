...
#ifdef F_59
V_37 -> V_137 = F_60 ( V_38 -> V_17 -> V_40 , 0644 ,
V_33 -> V_138 , & V_37 -> V_131 ) ;
#endif
return 1 ;
}
...
static void F_83 ( struct V_1 * V_33 ,
int V_3 , enum V_173 V_131 )
{
struct V_19 * V_20 =
F_62 ( V_33 , V_3 ) ;
F_84 ( V_20 ) ;
if ( V_131 == V_166 && V_33 -> V_37 [ V_3 ] . V_174 ) {
F_85 ( V_20 ,
V_33 -> V_37 [ V_3 ] . V_174 - 1 ) ;
V_33 -> V_37 [ V_3 ] . V_174 = 0 ;
}
V_33 -> V_37 [ V_3 ] . V_158 = V_131 ;
F_86 ( V_20 ) ;
}
static int F_87 ( struct V_19 * V_139 )
{
...
int F_88 ( struct V_1 * V_33 , int V_3 )
{
struct V_36 * V_37 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
struct V_1 * V_38 = V_37 -> V_38 ;
...
continue;
if ( ( V_38 -> V_37 [ V_3 ] . V_131 != V_178 ) &&
( V_38 -> V_37 [ V_3 ] . V_131 != V_179 ) &&
( V_38 -> V_37 [ V_3 ] . V_131 != V_177 ) &&
...
V_33 -> V_17 -> V_40 ) ;
V_161 = F_90 ( V_33 , V_3 ) ;
V_33 -> V_37 [ V_3 ] . V_131 = V_177 ;
F_83 ( V_33 , V_3 , V_166 ) ;
F_36 ( & V_33 -> V_111 -> V_182 ) ;
return 0 ;
}
int F_93 ( struct V_1 * V_33 , int V_3 )
{
struct V_36 * V_37 ;
int V_43 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
if ( ! F_79 ( V_33 , V_38 , V_3 ) )
continue;
if ( ! F_94 ( V_33 , V_38 , V_3 ) )
continue;
if ( ( V_38 -> V_37 [ V_3 ] . V_131 != V_167 ) &&
( V_38 -> V_37 [ V_3 ] . V_131 != V_178 ) &&
( V_38 -> V_37 [ V_3 ] . V_131 != V_177 ) )
continue;
F_8 ( V_38 -> V_39 , L_69 ,
V_37 -> V_33 -> V_17 -> V_40 ) ;
...
int F_97 ( struct V_1 * V_33 , int V_3 ,
int V_122 )
{
struct V_36 * V_37 ;
int V_43 = 0 ;
...
( V_38 -> V_37 [ V_3 ] . V_131 != V_181 ) )
continue;
V_43 = F_96 ( V_37 , V_140 , V_122 ) ;
if ( V_43 )
return V_43 ;
V_38 -> V_37 [ V_3 ] . V_131 = V_186 ;
break;
case V_187 :
...
static int F_85 ( struct V_19 * V_20 , int V_122 )
{
struct V_1 * V_33 = V_20 -> V_42 ;
int V_3 = V_20 -> V_3 , V_43 ;
enum V_193 V_123 = V_33 -> V_17 -> V_123 [ V_3 ] ;
V_33 -> V_37 [ V_3 ] . V_158 = V_175 ;
switch ( V_123 ) {
case V_194 :
F_8 ( V_33 -> V_39 , L_76 ,
...
static int F_98 ( struct V_19 * V_20 , int V_122 )
{
struct V_1 * V_33 = V_20 -> V_42 ;
int V_3 = V_20 -> V_3 ;
if ( V_33 -> V_37 [ V_3 ] . V_158 != V_166 ) {
V_33 -> V_37 [ V_3 ] . V_174 = V_122 + 1 ;
return 0 ;
}
return F_85 ( V_20 , V_122 ) ;
}
int F_99 ( struct V_1 * V_33 , int V_3 )
{
struct V_36 * V_37 ;
int V_43 = 0 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
F_83 ( V_33 , V_3 , V_175 ) ;
if ( F_101 ( & V_33 -> V_37 [ V_3 ] . V_134 ) ) {
F_12 ( V_33 -> V_39 , L_84 ,
V_33 -> V_17 -> V_40 ) ;
V_43 = - V_57 ;
goto V_88;
}
V_43 = F_99 ( V_33 , V_20 -> V_3 ) ;
if ( V_43 < 0 )
goto V_88;
V_43 = F_45 ( V_20 ) ;
if ( V_43 < 0 ) {
...
unsigned int V_122 , void * V_197 )
{
struct V_1 * V_2 = V_20 -> V_42 ;
struct V_82 * V_83 = V_2 -> V_83 ;
if ( V_83 -> V_45 -> V_86 && V_83 -> V_45 -> V_86 -> V_198 )
return V_83 -> V_45 -> V_86 -> V_198 ( V_20 , V_122 , V_197 ) ;
return F_103 ( V_20 , V_122 , V_197 ) ;
}
...
F_8 ( V_33 -> V_39 , L_87 ,
V_33 -> V_17 -> V_40 ) ;
V_161 = F_54 ( V_20 , V_190 ) ;
if ( V_161 < 0 )
F_12 ( V_33 -> V_39 , L_77 , V_161 ) ;
} else {
F_8 ( V_33 -> V_39 , L_88 ,
V_33 -> V_17 -> V_40 ) ;
V_161 = F_97 ( V_33 , V_3 , V_190 ) ;
if ( V_161 < 0 )
F_12 ( V_33 -> V_39 , L_77 , V_161 ) ;
}
V_161 = F_90 ( V_33 , V_3 ) ;
...
int F_108 ( struct V_144 * V_111 )
{
int V_6 , V_201 , V_160 , V_156 ;
F_32 ( & V_111 -> V_182 , V_183 ) ;
for ( V_6 = 0 ; V_6 < V_111 -> V_202 ; V_6 ++ ) {
struct V_151 * V_152 ;
...
int F_110 ( struct V_1 * V_33 , int V_203 )
{
struct V_36 * V_37 ;
struct V_204 * V_205 =
& V_33 -> V_37 [ V_8 ] . V_134 ;
...
struct V_58 * V_207 = V_116 -> V_45 ;
F_8 ( V_38 -> V_39 , L_99 ,
V_38 -> V_17 -> V_40 ) ;
if ( V_207 -> V_86 && V_207 -> V_86 -> V_208 &&
V_116 -> V_9 )
V_207 -> V_86 -> V_208 ( V_116 , V_203 ) ;
}
}
return 0 ;
}
static int F_111 ( struct V_19 * V_139 )
{
struct V_1 * V_33 = V_139 -> V_42 ;
struct V_36 * V_37 ;
struct V_151 * V_152 ;
...
int F_113 ( struct V_1 * V_2 , int V_209 )
{
struct V_82 * V_83 = V_2 -> V_83 ;
struct V_4 * V_63 ;
struct V_4 * V_5 = V_2 -> V_5 ;
...
if ( V_2 -> V_17 -> V_96 ) {
snprintf ( V_212 , sizeof( V_212 ) , L_101 ,
V_2 -> V_17 -> V_105 ) ;
V_43 = F_114 ( V_2 -> V_111 -> V_217 , V_212 , V_209 ,
V_65 , V_67 , & V_211 ) ;
} else {
if ( V_2 -> V_17 -> V_95 )
...
V_2 -> V_17 -> V_105 ,
( V_2 -> V_10 > 1 ) ?
L_12 : V_2 -> V_63 -> V_40 , V_209 ) ;
V_43 = F_115 ( V_2 -> V_111 -> V_217 , V_212 , V_209 , V_65 ,
V_67 , & V_211 ) ;
}
if ( V_43 < 0 ) {
...
F_8 ( V_2 -> V_111 -> V_39 , L_105 , V_209 , V_212 ) ;
F_116 ( & V_2 -> V_104 , F_39 ) ;
V_2 -> V_211 = V_211 ;
V_211 -> V_42 = V_2 ;
if ( V_2 -> V_17 -> V_96 ) {
if ( V_65 )
V_211 -> V_218 [ V_8 ] . V_20 -> V_42 = V_2 ;
if ( V_67 )
V_211 -> V_218 [ V_109 ] . V_20 -> V_42 = V_2 ;
goto V_88;
}
if ( V_2 -> V_17 -> V_95 ) {
V_2 -> V_86 . V_89 = F_111 ;
V_2 -> V_86 . V_117 = F_95 ;
V_2 -> V_86 . V_110 = F_100 ;
V_2 -> V_86 . V_123 = F_98 ;
V_2 -> V_86 . V_121 = F_92 ;
V_2 -> V_86 . V_101 = F_112 ;
V_2 -> V_86 . V_128 = F_55 ;
V_2 -> V_86 . V_198 = F_102 ;
} else {
V_2 -> V_86 . V_89 = F_29 ;
V_2 -> V_86 . V_117 = F_51 ;
V_2 -> V_86 . V_110 = F_45 ;
...
if ( V_83 -> V_45 -> V_86 ) {
V_2 -> V_86 . V_219 = V_83 -> V_45 -> V_86 -> V_219 ;
V_2 -> V_86 . V_220 = V_83 -> V_45 -> V_86 -> V_220 ;
V_2 -> V_86 . V_221 = V_83 -> V_45 -> V_86 -> V_221 ;
V_2 -> V_86 . V_222 = V_83 -> V_45 -> V_86 -> V_222 ;
V_2 -> V_86 . V_223 = V_83 -> V_45 -> V_86 -> V_223 ;
}
if ( V_65 )
F_117 ( V_211 , V_8 , & V_2 -> V_86 ) ;
if ( V_67 )
F_117 ( V_211 , V_109 , & V_2 -> V_86 ) ;
if ( V_83 -> V_45 -> V_224 ) {
V_43 = V_83 -> V_45 -> V_224 ( V_2 ) ;
if ( V_43 < 0 ) {
F_12 ( V_83 -> V_39 ,
L_106 ,
V_43 ) ;
...
V_211 -> V_225 = V_83 -> V_45 -> V_226 ;
V_88:
F_118 ( V_2 -> V_111 -> V_39 , L_107 ,
( V_2 -> V_10 > 1 ) ? L_12 : V_2 -> V_63 -> V_40 ,
V_5 -> V_40 ) ;
return V_43 ;
}
int F_119 ( struct V_1 * V_33 , int V_3 )
{
if ( V_33 -> V_37 [ V_3 ] . V_158 == V_175 )
return 1 ;
return 0 ;
}
...
{
return V_38 -> V_211 -> V_218 [ V_3 ] . V_20 ;
}
enum V_227
F_120 ( struct V_1 * V_38 , int V_3 )
{
return V_38 -> V_37 [ V_3 ] . V_131 ;
}
void F_121 ( struct V_1 * V_38 ,
int V_3 , enum V_227 V_131 )
{
...
static char * F_123 ( enum V_227 V_131 )
{
switch ( V_131 ) {
case V_171 :
return L_108 ;
...
static T_4 F_124 ( struct V_1 * V_33 ,
int V_3 , char * V_228 , T_5 V_229 )
{
struct V_54 * V_55 = & V_33 -> V_37 [ V_3 ] . V_117 ;
struct V_36 * V_37 ;
T_4 V_125 = 0 ;
V_125 += snprintf ( V_228 + V_125 , V_229 - V_125 ,
L_119 , V_33 -> V_17 -> V_40 ,
V_3 ? L_120 : L_121 ) ;
V_125 += snprintf ( V_228 + V_125 , V_229 - V_125 , L_122 ,
F_123 ( V_33 -> V_37 [ V_3 ] . V_131 ) ) ;
if ( ( V_33 -> V_37 [ V_3 ] . V_131 >= V_178 ) &&
( V_33 -> V_37 [ V_3 ] . V_131 <= V_181 ) )
V_125 += snprintf ( V_228 + V_125 , V_229 - V_125 ,
L_123
...
F_15 ( V_55 ) ,
F_14 ( V_55 ) ) ;
V_125 += snprintf ( V_228 + V_125 , V_229 - V_125 , L_125 ) ;
if ( F_101 ( & V_33 -> V_37 [ V_3 ] . V_134 ) ) {
V_125 += snprintf ( V_228 + V_125 , V_229 - V_125 ,
L_126 ) ;
goto V_88;
...
static T_4 F_126 ( struct V_230 * V_230 , char T_6 * V_231 ,
T_5 V_169 , T_7 * V_232 )
{
struct V_1 * V_33 = V_230 -> V_42 ;
T_4 V_233 = V_234 , V_125 = 0 , V_43 = 0 ;
char * V_228 ;
V_228 = F_127 ( V_233 , V_129 ) ;
if ( ! V_228 )
return - V_130 ;
if ( V_33 -> V_5 -> V_45 -> V_65 . V_80 )
V_125 += F_124 ( V_33 , V_8 ,
V_228 + V_125 , V_233 - V_125 ) ;
if ( V_33 -> V_5 -> V_45 -> V_67 . V_80 )
V_125 += F_124 ( V_33 , V_109 ,
V_228 + V_125 , V_233 - V_125 ) ;
V_43 = F_128 ( V_231 , V_169 , V_232 , V_228 , V_125 ) ;
F_67 ( V_228 ) ;
return V_43 ;
}
