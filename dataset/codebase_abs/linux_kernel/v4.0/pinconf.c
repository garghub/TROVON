...
{
const struct V_3 * V_4 = V_2 -> V_5 -> V_6 ;
F_21 ( V_2 , V_34 , V_47 , 0 ) ;
if ( V_4 && V_4 -> V_48 )
V_4 -> V_48 ( V_2 , V_34 , V_25 ) ;
}
static int F_25 ( struct V_33 * V_34 , void * V_42 )
{
struct V_1 * V_2 = V_34 -> V_43 ;
const struct V_37 * V_38 = V_2 -> V_5 -> V_38 ;
...
static T_1 F_31 ( struct V_52 * V_52 ,
...
char * V_74 ;
int V_13 ;
V_73 = F_32 ( V_67 , sizeof( V_71 ) - 1 ) ;
if ( F_33 ( V_71 , V_66 , V_73 ) )
return - V_75 ;
V_71 [ V_73 ] = 0 ;
V_74 = F_34 ( & V_72 , L_25 ) ;
if ( ! V_74 )
...
static int F_35 ( struct V_51 * V_51 , struct V_52 * V_52 )
{
return F_27 ( V_52 , F_29 , V_51 -> V_53 ) ;
}
