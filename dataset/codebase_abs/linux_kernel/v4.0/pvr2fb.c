...
if ( ! V_119 )
return - V_79 ;
V_120 = F_20 ( V_125 , V_125 -> V_126 , ( unsigned long ) V_111 ,
V_117 , V_127 , 0 , V_119 ) ;
if ( V_120 < V_117 ) {
V_117 = V_120 ;
V_120 = - V_68 ;
...
F_21 ( V_129 , 0x12c1 ) ;
V_114 = ( unsigned long ) V_3 -> V_130 + * V_113 ;
...
F_23 ( V_129 , V_115 , 0 , V_25 ) ;
F_23 ( V_132 , 0 , V_114 , V_25 ) ;
F_24 ( V_132 ) ;
goto V_133;
}
...
F_25 ( V_129 , ( unsigned long ) F_22 ( V_119 [ V_121 ] ) , 0 ) ;
F_25 ( V_132 , 0 , V_114 ) ;
F_24 ( V_132 ) ;
}
V_133:
...
V_3 -> V_130 = F_29 ( V_136 . V_63 ,
V_136 . V_78 ) ;
if ( ! V_3 -> V_130 ) {
F_30 ( V_137 L_5 ) ;
goto V_138;
}
V_2 -> V_4 = ( unsigned long ) F_29 ( V_136 . V_139 ,
V_136 . V_140 ) ;
if ( ! V_2 -> V_4 ) {
F_30 ( V_137 L_6 ) ;
goto V_138;
}
F_31 ( V_3 -> V_130 , 0 , V_136 . V_78 ) ;
V_136 . V_141 = V_142 ? 0 : 1 ;
V_136 . V_143 = V_144 ? 0 : 1 ;
V_3 -> V_145 = & V_146 ;
V_3 -> V_62 = V_136 ;
V_3 -> V_2 = V_97 ;
V_3 -> V_27 = V_97 -> V_147 ;
...
if ( ! V_153 )
V_153 = L_7 ;
if ( ! F_32 ( & V_3 -> V_13 , V_3 , V_153 , V_154 ,
V_155 , & V_154 [ V_151 ] , 16 ) )
V_3 -> V_13 = V_156 ;
F_33 ( & V_3 -> V_24 , 256 , 0 ) ;
if ( F_34 ( V_3 ) < 0 )
goto V_138;
F_13 ( V_3 ) ;
V_134 = F_5 ( V_3 -> V_13 . V_10 ,
V_3 -> V_13 . V_14 ) ;
V_134 *= V_3 -> V_13 . V_69 ;
V_135 = F_14 ( V_2 -> V_4 + 0x04 ) ;
V_3 ( V_3 , L_8 ,
V_3 -> V_62 . V_157 , ( V_135 >> 4 ) & 0x0f , V_135 & 0x0f ,
V_134 >> 10 ,
...
( char * ) F_35 ( V_158 , NULL , V_30 , 3 ) ,
( char * ) F_35 ( V_159 , NULL , V_32 , 3 ) ) ;
#ifdef F_36
F_37 ( V_3 , L_10 ) ;
V_160 = F_38 ( V_3 -> V_62 . V_63 , V_3 -> V_62 . V_78 ,
V_3 -> V_62 . V_157 , V_161 ) ;
F_37 ( V_3 , L_11 ,
V_160 ) ;
#endif
return 0 ;
...
return - V_162 ;
if ( F_10 () == V_31 ) {
V_3 -> V_163 . V_164 = 30000 ;
V_3 -> V_163 . V_165 = 70000 ;
V_3 -> V_163 . V_166 = 60 ;
V_3 -> V_163 . V_167 = 60 ;
} else {
V_3 -> V_163 . V_164 = 15469 ;
V_3 -> V_163 . V_165 = 15781 ;
V_3 -> V_163 . V_166 = 49 ;
V_3 -> V_163 . V_167 = 51 ;
}
if ( V_32 < 0 ) {
...
V_136 . V_63 = 0xa5000000 ;
V_136 . V_78 = 8 << 20 ;
V_136 . V_139 = 0xa05f8000 ;
V_136 . V_140 = 0x2000 ;
if ( F_42 ( V_169 , F_16 , V_170 ,
L_12 , V_3 ) ) {
return - V_171 ;
}
#ifdef F_43
if ( F_44 ( V_132 , L_13 ) != 0 ) {
F_45 ( V_169 , V_3 ) ;
return - V_171 ;
}
#endif
...
static int F_48 ( struct V_172 * V_173 ,
...
V_120 = F_50 ( V_173 , L_15 ) ;
if ( V_120 ) {
F_30 ( V_137 L_16 ) ;
return V_120 ;
}
V_136 . V_63 = F_51 ( V_173 , 0 ) ;
V_136 . V_78 = F_52 ( V_173 , 0 ) ;
V_136 . V_139 = F_51 ( V_173 , 1 ) ;
V_136 . V_140 = F_52 ( V_173 , 1 ) ;
V_3 -> V_176 = & V_173 -> V_177 ;
return F_28 () ;
}
static void F_53 ( struct V_172 * V_173 )
{
if ( V_3 -> V_130 ) {
F_39 ( V_3 -> V_130 ) ;
V_3 -> V_130 = NULL ;
...
static int F_35 ( const struct V_179 * V_180 , const char * V_181 , int V_6 ,
int V_182 )
{
int V_121 ;
for ( V_121 = 0 ; V_121 < V_182 ; V_121 ++ ) {
if ( V_181 != NULL ) {
if ( ! strncasecmp ( V_180 [ V_121 ] . V_183 , V_181 , strlen ( V_181 ) ) )
return V_180 [ V_121 ] . V_6 ;
} else {
if ( V_180 [ V_121 ] . V_6 == V_6 )
return ( int ) V_180 [ V_121 ] . V_183 ;
}
}
return - 1 ;
}
static int T_5 F_59 ( char * V_184 )
{
char * V_185 ;
char V_186 [ 80 ] ;
char V_187 [ 80 ] ;
if ( ! V_184 || ! * V_184 )
return 0 ;
while ( ( V_185 = F_60 ( & V_184 , L_17 ) ) ) {
if ( ! * V_185 )
continue;
if ( ! strcmp ( V_185 , L_18 ) ) {
F_61 () ;
} else if ( ! strncmp ( V_185 , L_19 , 6 ) ) {
strcpy ( V_186 , V_185 + 6 ) ;
} else if ( ! strncmp ( V_185 , L_20 , 7 ) ) {
strcpy ( V_187 , V_185 + 7 ) ;
} else if ( ! strncmp ( V_185 , L_21 , 5 ) ) {
V_142 = 1 ;
} else if ( ! strncmp ( V_185 , L_22 , 6 ) ) {
V_144 = 1 ;
} else {
V_153 = V_185 ;
}
...
if ( * V_186 )
V_30 = F_35 ( V_158 , V_186 , 0 , 3 ) ;
if ( * V_187 )
V_32 = F_35 ( V_159 , V_187 , 0 , 3 ) ;
return 0 ;
}
static int T_5 F_62 ( void )
{
int V_121 , V_120 = - V_188 ;
int V_182 ;
#ifndef F_63
char * V_189 = NULL ;
if ( F_64 ( L_15 , & V_189 ) )
...
F_59 ( V_189 ) ;
#endif
V_182 = sizeof( struct V_3 ) + sizeof( struct V_1 ) + 16 * sizeof( V_26 ) ;
...
V_97 = V_3 -> V_2 ;
for ( V_121 = 0 ; V_121 < F_66 ( V_190 ) ; V_121 ++ ) {
struct V_191 * V_192 = V_190 + V_121 ;
if ( ! V_192 -> V_193 )
continue;
V_120 = V_192 -> V_193 () ;
if ( V_120 != 0 ) {
