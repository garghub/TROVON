...
static int F_61 ( struct V_56 * V_16 , struct V_112 * V_113 , int V_3 )
{
struct V_1 * V_2 = F_41 ( V_16 ) ;
return F_62 ( & V_2 -> V_84 , F_63 ( V_113 ) , V_3 , NULL ) ;
}
static int F_64 ( struct V_56 * V_16 , void * V_114 )
{
struct V_1 * V_2 = F_41 ( V_16 ) ;
struct V_57 * V_7 = (struct V_57 * ) & V_2 -> V_7 ;
...
V_50 &= ~ V_130 ;
F_28 ( V_2 -> V_16 , L_19 ,
V_21 , F_70 ( & V_123 ) , V_123 . V_128 , V_50 ) ;
F_37 ( V_2 , V_50 ) ;
return 0 ;
}
...
T_2 V_58 ;
int V_40 ;
F_49 ( V_2 -> V_16 , V_2 -> V_84 . V_74 , V_131 , V_132 ) ;
F_49 ( V_2 -> V_16 , V_2 -> V_84 . V_74 , V_133 ,
V_134 | V_135 ) ;
F_72 ( & V_2 -> V_84 ) ;
V_40 = F_37 ( V_2 , V_125 ) ;
if ( V_40 < 0 )
...
static int F_75 ( struct V_1 * V_2 , struct V_150 * V_151 )
{
struct V_57 * V_7 = (struct V_57 * ) & V_2 -> V_7 ;
T_2 V_152 , V_153 ;
int V_40 , V_140 ;
...
F_28 ( V_2 -> V_16 , L_31 , V_2 -> V_16 -> V_119 ) ;
