...
V_39 = F_39 ( V_63 -> V_49 , V_58 -> V_64 , V_58 -> V_65 , V_4 ) ;
if ( V_39 <= 0 ) {
F_22 ( L_7 ) ;
F_38 ( V_67 ) ;
return F_40 ( - V_69 ) ;
...
static void * F_43 ( struct V_46 * V_47 , unsigned long V_70 )
{
struct V_6 * V_7 = V_47 -> V_54 ;
return V_7 -> V_9 + V_70 * V_56 ;
}
...
static struct V_46 * F_46 ( void * V_15 , unsigned long V_71 )
{
struct V_6 * V_7 = V_15 ;
struct V_46 * V_47 ;
if ( F_47 ( ! V_7 -> V_9 ) )
return NULL ;
V_47 = F_48 ( V_7 , & V_72 , V_7 -> V_2 , V_71 , NULL ) ;
if ( F_49 ( V_47 ) )
return NULL ;
F_6 ( & V_7 -> V_11 ) ;
return V_47 ;
}
static int F_50 ( void * V_73 )
{
struct V_6 * V_7 = V_73 ;
V_7 -> V_9 = F_51 ( V_7 -> V_47 ) ;
return V_7 -> V_9 ? 0 : - V_74 ;
}
static void F_52 ( void * V_73 )
{
struct V_6 * V_7 = V_73 ;
F_53 ( V_7 -> V_47 , V_7 -> V_9 ) ;
V_7 -> V_9 = NULL ;
}
...
static void * F_55 ( void * V_1 , struct V_46 * V_47 ,
