...
F_86 ( void )
{
return V_208 + F_87 ( V_209 ) ;
}
static struct V_210 *
F_88 ( struct V_56 * V_75 )
{
struct V_210 * V_211 =
F_89 ( sizeof( struct V_210 ) ,
V_148 | V_212 ) ;
if ( V_211 == NULL )
return NULL ;
V_211 -> V_85 = F_83 () ;
...
static void
F_90 ( struct V_210 * V_211 )
{
F_22 ( V_211 ) ;
}
static void
F_91 ( struct V_210 * V_211 )
{
struct V_145 * V_68 = & V_211 -> V_75 . V_68 ;
char V_214 [ 40 ] , V_215 [ 40 ] , V_216 [ 40 ] , V_217 [ 40 ] , V_218 [ 40 ] ,
V_219 [ 40 ] ;
char * V_132 [] = {
V_214 , V_215 , V_216 , V_217 , V_218 , V_219 , NULL
} ;
sprintf ( V_214 , L_49 ) ;
sprintf ( V_215 , L_50 , V_211 -> V_85 ) ;
sprintf ( V_216 , L_51 ,
V_68 -> V_88 . V_31 . V_220 ) ;
sprintf ( V_217 , L_52 ,
V_68 -> V_88 . V_89 ) ;
sprintf ( V_218 , L_53 ,
V_68 -> V_88 . V_91 >> 3 ) ;
...
F_93 ( & V_224 ) ;
F_94 (pos, tmp, &Parahotplug_request_list) {
struct V_210 * V_211 =
F_95 ( V_222 , struct V_210 , V_225 ) ;
if ( F_96 ( V_208 , V_211 -> V_213 ) ) {
F_33 ( V_222 ) ;
if ( V_211 -> V_75 . V_72 . V_73 . V_74 )
F_42 (
& V_211 -> V_75 . V_72 ,
V_226 ,
V_211 -> V_75 . V_68 . V_88 . V_31 ) ;
F_90 ( V_211 ) ;
}
}
F_97 ( & V_224 ) ;
...
F_33 ( V_222 ) ;
F_97 ( & V_224 ) ;
V_211 -> V_75 . V_68 . V_88 . V_31 . V_220 = V_220 ;
if ( V_211 -> V_75 . V_72 . V_73 . V_74 )
F_42 (
& V_211 -> V_75 . V_72 , V_62 ,
V_211 -> V_75 . V_68 . V_88 . V_31 ) ;
F_90 ( V_211 ) ;
return 0 ;
}
...
F_93 ( & V_224 ) ;
F_100 ( & ( V_211 -> V_225 ) , & V_227 ) ;
F_97 ( & V_224 ) ;
F_91 ( V_211 ) ;
}
}
static BOOL
F_101 ( struct V_56 V_57 , T_8 V_156 )
{
struct V_145 * V_68 = & V_57 . V_68 ;
T_9 V_228 = 0 ;
T_4 V_229 = 0 ;
...
BOOL V_230 = FALSE ;
struct V_56 V_231 ;
V_230 = ( V_57 . V_72 . V_73 . V_93 == 1 ) ;
if ( V_156 == 0 ) {
F_36 ( L_57 ) ;
return TRUE ;
}
V_228 = V_156 + V_57 . V_72 . V_80 ;
V_229 = V_57 . V_72 . V_79 ;
if ( V_228 != 0 && V_229 != 0 ) {
BOOL V_232 = FALSE ;
V_166 =
F_102 ( V_228 , V_229 ,
...
F_103 ( L_59 ) ;
F_103 ( L_60 , ( T_6 ) V_57 . V_72 . V_85 ) ;
F_103 ( L_61 , ( T_9 ) V_228 ) ;
F_103 ( L_62 , ( T_6 ) V_229 ) ;
F_103 ( L_63 , V_230 ) ;
}
}
if ( ! V_230 ) {
F_38 ( & V_231 , & V_57 . V_72 ,
V_62 ) ;
if ( ( V_8 )
&&
( ! F_41
...
static T_8 F_105 ( void )
{
T_9 V_244 = 0 ;
T_4 V_245 = 0 ;
if ( ! F_106 ( F_107 ( & V_244 , & V_245 ) ) ) {
F_108 ( L_78 ,
V_94 ) ;
return 0 ;
}
...
goto V_66;
F_35 ( V_266 , V_64 ) ;
V_75 . V_72 . V_85 = V_234 ;
V_75 . V_68 . V_69 . V_235 = 23 ;
V_75 . V_68 . V_69 . V_236 = 0 ;
F_34 ( & V_75 ) ;
if ( F_3 ( V_8 ,
F_4 ( struct V_9 ,
V_101 ) ,
...
static void
F_117 ( T_6 V_112 , T_6 V_120 , int V_78 )
{
F_50 ( V_123 , V_112 , V_120 , V_78 ) ;
}
void
F_118 ( T_6 V_89 , T_6 V_91 , int V_78 )
{
F_48 ( V_86 ,
V_89 , V_91 , V_78 ,
V_138 ) ;
...
static void
F_119 ( T_6 V_112 , T_6 V_120 , int V_78 )
{
F_48 ( V_86 ,
V_112 , V_120 , V_78 ,
V_135 ) ;
...
BOOL
F_120 ( T_6 V_89 , struct V_26 * V_272 )
{
...
BOOL
F_123 ( T_6 V_89 , T_6 V_91 , void * V_273 )
{
struct V_33 * V_27 =
...
void *
F_124 ( struct V_276 * V_277 , BOOL V_278 ,
...
void
F_127 ( struct V_276 * V_277 , void * V_27 , char * V_279 , int V_280 )
{
if ( ! V_27 ) {
...
V_299 = F_141 ( V_293 , 0 ) ;
V_61 = F_142 ( V_299 , & V_8 ) ;
if ( V_61 < 0 ) {
F_108 ( L_109 , V_61 ) ;
F_35 ( V_296 , V_297 ) ;
goto V_66;
}
memset ( & V_237 , 0 , sizeof( struct V_76 ) ) ;
