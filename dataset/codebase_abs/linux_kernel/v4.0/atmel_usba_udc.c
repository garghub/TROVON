...
static T_9 F_127 ( int V_247 , void * V_248 )
{
struct V_38 * V_13 = V_248 ;
int V_268 ;
F_91 ( 10 ) ;
...
static int F_128 ( struct V_181 * V_66 ,
struct V_273 * V_168 )
{
int V_41 ;
struct V_38 * V_13 = F_129 ( V_66 , struct V_38 , V_66 ) ;
unsigned long V_115 ;
F_76 ( & V_13 -> V_14 , V_115 ) ;
V_13 -> V_184 = 1 << V_189 ;
V_13 -> V_168 = V_168 ;
F_77 ( & V_13 -> V_14 , V_115 ) ;
V_41 = F_130 ( V_13 -> V_274 ) ;
if ( V_41 )
return V_41 ;
V_41 = F_130 ( V_13 -> V_275 ) ;
if ( V_41 ) {
F_131 ( V_13 -> V_274 ) ;
return V_41 ;
}
V_13 -> V_269 = 0 ;
if ( F_44 ( V_13 -> V_76 ) )
F_132 ( F_133 ( V_13 -> V_76 ) ) ;
F_76 ( & V_13 -> V_14 , V_115 ) ;
if ( F_43 ( V_13 ) && V_13 -> V_269 == 0 ) {
F_46 ( V_13 , 1 ) ;
F_42 ( V_13 , V_186 , V_270 ) ;
F_41 ( V_13 , V_261 ) ;
}
...
static void F_136 ( struct V_38 * V_13 , int V_78 )
{
unsigned int V_276 = F_137 ( V_277 ) ;
if ( V_78 )
F_138 ( V_277 , V_276 | V_278 ) ;
else
F_138 ( V_277 , V_276 & ~ ( V_278 ) ) ;
}
static void F_139 ( struct V_38 * V_13 )
{
unsigned int V_276 = F_137 ( V_277 ) ;
F_138 ( V_277 , V_276 & ~ ( V_278 ) ) ;
F_138 ( V_277 , V_276 | V_278 ) ;
}
static struct V_3 * F_140 ( struct V_279 * V_61 ,
struct V_38 * V_13 )
{
T_5 V_74 ;
const char * V_47 ;
enum V_280 V_115 ;
struct V_281 * V_282 = V_61 -> V_62 . V_283 ;
const struct V_284 * V_285 ;
struct V_281 * V_286 ;
int V_39 , V_41 ;
struct V_3 * V_287 , * V_4 ;
V_285 = F_141 ( V_288 , V_282 ) ;
if ( ! V_285 )
return F_142 ( - V_125 ) ;
V_13 -> V_79 = V_285 -> V_40 ;
V_13 -> V_260 = 0 ;
V_13 -> V_76 = F_143 ( V_282 , L_66 , 0 ,
& V_115 ) ;
V_13 -> V_77 = ( V_115 & V_289 ) ? 1 : 0 ;
V_286 = NULL ;
while ( ( V_286 = F_144 ( V_282 , V_286 ) ) )
V_13 -> V_260 ++ ;
V_287 = F_145 ( & V_61 -> V_62 , sizeof( struct V_3 ) * V_13 -> V_260 ,
V_11 ) ;
if ( ! V_287 )
return F_142 ( - V_12 ) ;
V_13 -> V_66 . V_72 = & V_287 [ 0 ] . V_4 ;
F_3 ( & V_287 [ 0 ] . V_4 . V_290 ) ;
V_286 = NULL ;
V_39 = 0 ;
while ( ( V_286 = F_144 ( V_282 , V_286 ) ) ) {
V_4 = & V_287 [ V_39 ] ;
V_41 = F_146 ( V_286 , L_67 , & V_74 ) ;
if ( V_41 ) {
F_31 ( & V_61 -> V_62 , L_68 , V_41 ) ;
goto V_291;
}
V_4 -> V_120 = V_74 ;
V_41 = F_146 ( V_286 , L_69 , & V_74 ) ;
if ( V_41 ) {
F_31 ( & V_61 -> V_62 , L_70 , V_41 ) ;
goto V_291;
}
V_4 -> V_123 = V_74 ;
V_41 = F_146 ( V_286 , L_71 , & V_74 ) ;
if ( V_41 ) {
F_31 ( & V_61 -> V_62 , L_72 , V_41 ) ;
goto V_291;
}
V_4 -> V_139 = V_74 ;
V_4 -> V_54 = F_147 ( V_286 , L_73 ) ;
V_4 -> V_137 = F_147 ( V_286 , L_74 ) ;
V_41 = F_148 ( V_286 , L_75 , & V_47 ) ;
V_4 -> V_4 . V_47 = V_47 ;
V_4 -> V_292 = V_13 -> V_44 + F_149 ( V_39 ) ;
V_4 -> V_293 = V_13 -> V_44 + F_150 ( V_39 ) ;
V_4 -> V_85 = V_13 -> V_85 + F_151 ( V_39 ) ;
V_4 -> V_4 . V_294 = & V_295 ;
F_152 ( & V_4 -> V_4 , V_4 -> V_123 ) ;
V_4 -> V_13 = V_13 ;
F_3 ( & V_4 -> V_17 ) ;
if ( V_39 )
F_7 ( & V_4 -> V_4 . V_290 , & V_13 -> V_66 . V_290 ) ;
V_39 ++ ;
}
if ( V_39 == 0 ) {
F_31 ( & V_61 -> V_62 , L_76 ) ;
...
static struct V_3 * F_153 ( struct V_279 * V_61 ,
struct V_38 * V_13 )
{
struct V_297 * V_298 = F_154 ( & V_61 -> V_62 ) ;
struct V_3 * V_287 ;
int V_39 ;
if ( ! V_298 )
return F_142 ( - V_299 ) ;
V_287 = F_145 ( & V_61 -> V_62 , sizeof( struct V_3 ) * V_298 -> V_260 ,
V_11 ) ;
if ( ! V_287 )
return F_142 ( - V_12 ) ;
V_13 -> V_66 . V_72 = & V_287 [ 0 ] . V_4 ;
V_13 -> V_76 = V_298 -> V_76 ;
V_13 -> V_77 = V_298 -> V_77 ;
V_13 -> V_260 = V_298 -> V_260 ;
F_3 ( & V_287 [ 0 ] . V_4 . V_290 ) ;
for ( V_39 = 0 ; V_39 < V_298 -> V_260 ; V_39 ++ ) {
struct V_3 * V_4 = & V_287 [ V_39 ] ;
V_4 -> V_292 = V_13 -> V_44 + F_149 ( V_39 ) ;
V_4 -> V_293 = V_13 -> V_44 + F_150 ( V_39 ) ;
V_4 -> V_85 = V_13 -> V_85 + F_151 ( V_39 ) ;
V_4 -> V_4 . V_294 = & V_295 ;
V_4 -> V_4 . V_47 = V_298 -> V_4 [ V_39 ] . V_47 ;
V_4 -> V_123 = V_298 -> V_4 [ V_39 ] . V_123 ;
F_152 ( & V_4 -> V_4 , V_4 -> V_123 ) ;
V_4 -> V_13 = V_13 ;
F_3 ( & V_4 -> V_17 ) ;
V_4 -> V_139 = V_298 -> V_4 [ V_39 ] . V_139 ;
V_4 -> V_120 = V_298 -> V_4 [ V_39 ] . V_120 ;
V_4 -> V_54 = V_298 -> V_4 [ V_39 ] . V_54 ;
V_4 -> V_137 = V_298 -> V_4 [ V_39 ] . V_137 ;
if ( V_39 )
F_7 ( & V_4 -> V_4 . V_290 , & V_13 -> V_66 . V_290 ) ;
}
return V_287 ;
}
static int F_155 ( struct V_279 * V_61 )
{
struct V_64 * V_44 , * V_85 ;
struct V_300 * V_274 , * V_275 ;
struct V_38 * V_13 ;
int V_247 , V_41 , V_39 ;
V_13 = F_145 ( & V_61 -> V_62 , sizeof( * V_13 ) , V_11 ) ;
if ( ! V_13 )
return - V_12 ;
V_13 -> V_66 = V_301 ;
F_3 ( & V_13 -> V_66 . V_290 ) ;
V_44 = F_35 ( V_61 , V_67 , V_68 ) ;
V_85 = F_35 ( V_61 , V_67 , V_302 ) ;
if ( ! V_44 || ! V_85 )
return - V_299 ;
V_247 = F_156 ( V_61 , 0 ) ;
if ( V_247 < 0 )
return V_247 ;
V_274 = F_157 ( & V_61 -> V_62 , L_77 ) ;
if ( F_34 ( V_274 ) )
return F_158 ( V_274 ) ;
V_275 = F_157 ( & V_61 -> V_62 , L_78 ) ;
if ( F_34 ( V_275 ) )
return F_158 ( V_275 ) ;
F_159 ( & V_13 -> V_14 ) ;
V_13 -> V_61 = V_61 ;
...
V_13 -> V_76 = - V_176 ;
V_41 = - V_12 ;
V_13 -> V_44 = F_160 ( & V_61 -> V_62 , V_44 -> V_303 , F_37 ( V_44 ) ) ;
if ( ! V_13 -> V_44 ) {
F_31 ( & V_61 -> V_62 , L_79 ) ;
return V_41 ;
}
F_109 ( & V_61 -> V_62 , L_80 ,
( unsigned long ) V_44 -> V_303 , V_13 -> V_44 ) ;
V_13 -> V_85 = F_160 ( & V_61 -> V_62 , V_85 -> V_303 , F_37 ( V_85 ) ) ;
if ( ! V_13 -> V_85 ) {
F_31 ( & V_61 -> V_62 , L_81 ) ;
return V_41 ;
}
F_109 ( & V_61 -> V_62 , L_82 ,
( unsigned long ) V_85 -> V_303 , V_13 -> V_85 ) ;
F_161 ( V_61 , V_13 ) ;
V_41 = F_130 ( V_274 ) ;
if ( V_41 ) {
F_31 ( & V_61 -> V_62 , L_83 ) ;
...
F_131 ( V_274 ) ;
if ( V_61 -> V_62 . V_283 )
V_13 -> V_3 = F_140 ( V_61 , V_13 ) ;
else
V_13 -> V_3 = F_153 ( V_61 , V_13 ) ;
F_46 ( V_13 , 0 ) ;
if ( F_34 ( V_13 -> V_3 ) )
return F_158 ( V_13 -> V_3 ) ;
V_41 = F_162 ( & V_61 -> V_62 , V_247 , F_123 , 0 ,
L_84 , V_13 ) ;
if ( V_41 ) {
F_31 ( & V_61 -> V_62 , L_85 ,
V_247 , V_41 ) ;
...
V_13 -> V_247 = V_247 ;
if ( F_44 ( V_13 -> V_76 ) ) {
if ( ! F_163 ( & V_61 -> V_62 , V_13 -> V_76 , L_84 ) ) {
V_41 = F_162 ( & V_61 -> V_62 ,
F_133 ( V_13 -> V_76 ) ,
F_127 , 0 ,
L_84 , V_13 ) ;
if ( V_41 ) {
...
V_41 = F_164 ( & V_61 -> V_62 , & V_13 -> V_66 ) ;
if ( V_41 )
return V_41 ;
F_33 ( V_13 ) ;
...
static int T_10 F_165 ( struct V_279 * V_61 )
{
struct V_38 * V_13 ;
int V_39 ;
V_13 = F_166 ( V_61 ) ;
