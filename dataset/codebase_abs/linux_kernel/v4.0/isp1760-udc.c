...
static int F_86 ( struct V_1 * V_10 )
{
T_2 V_170 ;
T_1 V_171 ;
F_7 ( V_10 , V_172 , 0xbabe ) ;
V_171 = F_5 ( V_10 , V_173 ) ;
V_170 = F_5 ( V_10 , V_172 ) ;
if ( V_170 != 0xbabe ) {
F_43 ( V_10 -> V_30 -> V_31 ,
L_51 ,
V_170 , V_171 ) ;
...
if ( V_171 != 0x00011582 && V_171 != 0x00158210 ) {
F_43 ( V_10 -> V_30 -> V_31 , L_52 , V_171 ) ;
return - V_174 ;
}
F_7 ( V_10 , V_155 , V_175 ) ;
F_87 ( 10000 , 11000 ) ;
F_7 ( V_10 , V_155 , 0 ) ;
F_87 ( 10000 , 11000 ) ;
return 0 ;
}
int F_88 ( struct V_176 * V_30 , int V_157 ,
unsigned long V_177 )
{
...
V_10 -> V_12 = V_30 -> V_12 ;
F_89 ( & V_10 -> V_33 ) ;
F_90 ( & V_10 -> V_124 , F_83 ,
( unsigned long ) V_10 ) ;
V_115 = F_86 ( V_10 ) ;
if ( V_115 < 0 )
return V_115 ;
V_178 = F_91 ( V_30 -> V_31 ) ;
V_10 -> V_179 = F_92 ( strlen ( V_178 ) + 7 , V_180 ) ;
if ( ! V_10 -> V_179 )
return - V_181 ;
sprintf ( V_10 -> V_179 , L_53 , V_178 ) ;
V_115 = F_93 ( V_157 , F_80 , V_182 | V_177 ,
V_10 -> V_179 , V_10 ) ;
if ( V_115 < 0 )
goto error;
V_10 -> V_157 = V_157 ;
V_10 -> V_3 . V_167 = & V_183 ;
V_10 -> V_3 . V_127 = V_128 ;
V_10 -> V_3 . V_152 = V_160 ;
V_10 -> V_3 . V_166 = L_54 ;
F_84 ( V_10 ) ;
V_115 = F_94 ( V_30 -> V_31 , & V_10 -> V_3 ) ;
if ( V_115 < 0 )
goto error;
return 0 ;
error:
if ( V_10 -> V_157 >= 0 )
F_95 ( V_10 -> V_157 , V_10 ) ;
F_53 ( V_10 -> V_179 ) ;
return V_115 ;
}
void F_96 ( struct V_176 * V_30 )
{
struct V_1 * V_10 = & V_30 -> V_10 ;
if ( ! V_10 -> V_30 )
return;
