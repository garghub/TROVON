...
struct V_1 * F_64 ( struct V_10 * V_11 , int V_82 )
{
if ( F_65 ( V_82 < 0 || V_82 >= F_66 ( V_11 ) ) )
V_82 = 0 ;
...
static void F_68 ( struct V_10 * V_11 , struct V_3 * V_4 )
{
if ( ! F_67 ( & V_4 -> V_2 ) )
return;
switch ( F_22 ( & V_4 -> V_2 ) ) {
case 1 :
case 2 :
V_4 -> V_36 = F_2 ( F_64 ( V_11 , 0 ) ) ;
break;
case 4 :
V_4 -> V_36 = F_2 ( F_64 ( V_11 , 3 ) ) ;
break;
case 8 :
V_4 -> V_36 = F_2 ( F_64 ( V_11 , 7 ) ) ;
break;
}
}
...
struct V_88 * V_90 ;
struct V_91 * V_92 ;
struct V_93 * V_72 = F_70 ( V_11 ) ;
struct V_12 * V_13 = & V_85 -> V_13 ;
int V_94 , V_15 ;
if ( ! V_87 )
return;
V_89 = F_71 ( V_13 -> V_95 , L_14 ) ;
if ( ! V_89 )
return;
V_94 = F_72 ( V_89 ) ;
if ( ! V_94 )
...
V_15 ++ ;
V_92 = V_72 -> V_92 + V_15 ;
if ( F_75 ( V_90 , L_16 , NULL ) )
V_92 -> V_99 |= V_83 ;
V_92 -> V_63 = F_76 ( V_90 , 0 ) ;
V_92 -> V_74 = F_75 ( V_90 , L_17 , NULL ) ?
0 : 1 ;
if ( F_75 ( V_90 , L_18 , NULL ) )
V_92 -> V_99 |= V_8 ;
}
V_96:
F_77 ( V_89 ) ;
...
F_69 ( V_85 , V_87 , V_11 ) ;
V_94 = V_72 -> V_98 ;
V_4 = F_73 ( V_13 , sizeof( * V_4 ) * V_94 , V_97 ) ;
if ( ! V_4 ) {
F_23 ( V_13 , L_19 ) ;
return - V_105 ;
}
...
snprintf ( V_103 , V_104 , L_20 ,
V_80 , V_15 ) ;
V_102 = F_80 ( V_13 , V_103 ) ;
if ( F_81 ( V_102 ) )
return F_82 ( V_102 ) ;
V_4 -> V_72 = V_100 ;
V_76 = & V_107 ;
...
V_76 = & V_77 ;
F_84 ( & V_4 -> V_2 , V_76 , V_102 , V_108 , V_15 ) ;
F_68 ( V_11 , V_4 ) ;
}
return 0 ;
}
