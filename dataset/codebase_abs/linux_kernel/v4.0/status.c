...
V_156 = & V_20 -> V_156 [ V_36 ] ;
V_150 = F_67 ( F_68 ( F_69 () , V_159 ) ) ;
if ( V_156 -> V_161 < V_150 )
V_156 -> V_161 = V_150 ;
V_156 -> V_162 ++ ;
V_156 -> V_163 += V_150 ;
if ( ! V_156 -> V_164 )
...
return;
V_20 -> V_169 ++ ;
if ( ! V_20 -> V_20 . V_170 && V_20 -> V_169 < V_171 )
return;
if ( V_20 -> V_20 . V_170 &&
( V_20 -> V_169 < V_172 ||
F_71 ( V_26 ,
V_20 -> V_173 + V_174 ) ) )
return;
F_72 ( V_20 -> V_28 -> V_134 , V_20 -> V_20 . V_48 ,
V_20 -> V_169 , V_144 ) ;
V_20 -> V_169 = 0 ;
}
...
if ( ( V_8 -> V_12 & V_167 ) &&
! ( V_8 -> V_12 & V_168 ) ) {
V_8 -> V_84 . V_85 [ V_151 ] . V_86 = - 1 ;
V_8 -> V_84 . V_85 [ V_151 ] . V_176 = 0 ;
break;
} else if ( V_8 -> V_84 . V_85 [ V_151 ] . V_86 < 0 ) {
break;
} else if ( V_151 >= V_2 -> V_178 ) {
V_8 -> V_84 . V_85 [ V_151 ] . V_86 = - 1 ;
V_8 -> V_84 . V_85 [ V_151 ] . V_176 = 0 ;
break;
}
V_176 += V_8 -> V_84 . V_85 [ V_151 ] . V_176 ;
}
V_175 = V_151 - 1 ;
if ( V_176 < 0 )
V_176 = 0 ;
...
int V_175 ;
bool V_136 , V_181 ;
V_175 = F_73 ( V_2 , V_8 , & V_91 ) ;
V_90 = V_2 -> V_182 -> V_183 [ V_8 -> V_184 ] ;
V_136 = ! ! ( V_8 -> V_12 & V_105 ) ;
V_181 = ! ! ( V_8 -> V_12 & V_185 ) ;
if ( V_180 ) {
struct V_19 * V_20 ;
V_20 = F_75 ( V_180 , struct V_19 , V_20 ) ;
if ( ! V_136 )
V_20 -> V_186 ++ ;
V_20 -> V_187 += V_91 ;
if ( V_136 ) {
...
void F_77 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_3 * V_194 ;
struct V_21 * V_22 = (struct V_21 * ) V_4 -> V_23 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
V_175 = F_73 ( V_2 , V_8 , & V_91 ) ;
F_48 () ;
V_90 = V_6 -> V_2 . V_182 -> V_183 [ V_8 -> V_184 ] ;
V_154 = V_22 -> V_33 ;
F_78 (local, hdr->addr1, sta, tmp) {
if ( ! F_79 ( V_22 -> V_201 , V_20 -> V_28 -> V_27 . V_48 ) )
continue;
V_93 = F_80 ( & V_20 -> V_28 -> V_27 ) ;
if ( V_8 -> V_12 & V_202 )
F_81 ( V_20 , V_203 ) ;
V_136 = ! ! ( V_8 -> V_12 & V_105 ) ;
...
if ( F_82 ( & V_20 -> V_28 -> V_27 ) &&
F_12 ( V_154 ) )
F_83 (
F_13 ( V_22 ) ,
V_20 , true , V_136 ) ;
if ( ( V_6 -> V_2 . V_12 & V_204 ) &&
( F_51 ( V_22 -> V_33 ) ) &&
( V_175 != - 1 ) )
V_20 -> V_205 = V_8 -> V_84 . V_85 [ V_175 ] ;
if ( ( V_8 -> V_12 & V_206 ) &&
( F_12 ( V_154 ) ) ) {
T_2 V_81 ;
T_1 * V_59 ;
...
if ( ! V_136 && F_85 ( V_154 ) ) {
T_2 V_25 ;
V_199 = (struct V_198 * ) V_4 -> V_23 ;
V_25 = F_84 ( V_199 -> V_25 ) ;
if ( ! ( V_25 & V_209 ) ) {
T_2 V_81 = F_84 ( V_199 -> V_210 ) ;
V_36 = ( V_25 &
V_211 ) >>
V_212 ;
F_29 ( V_20 , V_36 , V_81 ) ;
...
if ( ! V_136 )
V_20 -> V_214 [ V_36 ] ++ ;
V_20 -> V_215 [ V_36 ] += V_91 ;
}
}
F_87 ( V_6 , V_90 , V_20 , V_4 ) ;
if ( F_82 ( & V_20 -> V_28 -> V_27 ) )
F_88 ( V_6 , V_20 , V_4 ) ;
if ( ! ( V_8 -> V_12 & V_216 ) && V_136 )
F_25 ( V_20 , V_4 ) ;
if ( ( V_20 -> V_28 -> V_27 . type == V_76 ) &&
( V_6 -> V_2 . V_12 & V_57 ) )
F_89 ( V_20 -> V_28 , ( void * ) V_4 -> V_23 ,
V_136 , V_8 -> V_84 . V_217 ) ;
if ( V_6 -> V_2 . V_12 & V_57 ) {
if ( V_8 -> V_12 & V_105 ) {
if ( V_20 -> V_169 )
V_20 -> V_169 = 0 ;
...
if ( V_136 )
V_20 -> V_218 = V_8 -> V_84 . V_219 ;
F_65 ( V_6 , V_4 , V_20 , V_22 ) ;
}
F_58 () ;
F_90 ( V_6 ) ;
if ( ( V_8 -> V_12 & V_105 ) ||
...
if ( F_54 ( V_154 ) && F_94 ( V_154 ) &&
( V_6 -> V_2 . V_12 & V_57 ) &&
! ( V_8 -> V_12 & V_216 ) &&
V_6 -> V_221 && ! ( V_6 -> V_222 ) ) {
if ( V_8 -> V_12 & V_105 ) {
V_6 -> V_221 -> V_61 . V_132 . V_12 |=
V_223 ;
} else
F_18 ( & V_6 -> V_224 , V_26 +
F_95 ( 10 ) ) ;
...
F_47 ( V_6 , V_4 , false ) ;
F_96 ( V_4 ) ;
V_197 = ! ! ( V_8 -> V_12 & V_216 ) ||
! ( F_51 ( V_154 ) ) ;
if ( ! V_6 -> V_225 && ( ! V_197 || ! V_6 -> V_226 ) ) {
F_97 ( V_4 ) ;
return;
}
V_92 = F_30 ( V_8 ) ;
if ( F_98 ( F_99 ( V_4 ) < V_92 ) ) {
F_100 ( L_3 ) ;
F_97 ( V_4 ) ;
return;
}
...
V_4 -> V_227 = V_228 ;
V_4 -> V_10 = V_229 ;
V_4 -> V_230 = F_102 ( V_231 ) ;
memset ( V_4 -> V_232 , 0 , sizeof( V_4 -> V_232 ) ) ;
F_48 () ;
F_49 (sdata, &local->interfaces, list) {
if ( V_28 -> V_27 . type == V_233 ) {
if ( ! F_27 ( V_28 ) )
continue;
if ( ( V_28 -> V_61 . V_234 & V_235 ) &&
! V_197 )
continue;
if ( V_196 ) {
V_194 = F_103 ( V_4 , V_144 ) ;
if ( V_194 ) {
V_194 -> V_134 = V_196 ;
F_104 ( V_194 ) ;
}
...
void F_105 ( struct V_179 * V_180 , T_3 V_236 )
{
struct V_19 * V_20 = F_75 ( V_180 , struct V_19 , V_20 ) ;
F_72 ( V_20 -> V_28 -> V_134 , V_20 -> V_20 . V_48 ,
V_236 , V_144 ) ;
}
