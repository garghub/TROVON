...
V_88 = F_51 ( V_13 ) ;
V_25 = F_52 ( V_88 * sizeof( int ) ) ;
V_27 = F_52 ( V_88 * sizeof( int ) ) ;
do {
F_53 ( V_89 , V_87 , & V_83 , & V_84 , & V_85 , & V_86 ) ;
if ( V_83 == 0 )
break;
V_25 [ V_87 ] = V_84 ;
V_27 [ V_87 ] = V_83 ;
...
int V_91 ;
V_92 [ 0 ] = 0 ;
V_92 [ 1 ] = F_55 ( struct V_3 , V_23 ) ;
if ( ! V_93 ) {
for ( V_91 = 2 ; V_91 < V_88 ; V_91 ++ ) {
if ( F_56 ( V_91 , ( unsigned long * ) & V_13 ) ) {
V_92 [ V_91 ] = V_25 [ V_91 ] ;
V_90 [ V_91 ] = V_27 [ V_91 ] ;
}
}
...
int V_91 ;
if ( ! V_93 ) {
F_53 ( V_89 , 0 , & V_83 , & V_84 , & V_85 , & V_86 ) ;
V_39 = V_84 ;
return;
}
V_39 = V_94 + V_95 ;
...
if ( F_56 ( V_91 , ( unsigned long * ) & V_13 ) ) {
F_53 ( V_89 , V_91 , & V_83 , & V_84 , & V_85 , & V_86 ) ;
V_39 += V_83 ;
}
}
}
...
void F_71 ( void )
{
static T_5 void (* F_72)( void ) = F_65 ;
void (* F_73)( void );
if ( ! V_96 )
return;
F_73 = F_72 ;
...
static inline void T_4 F_74 ( void )
{
V_62 -> V_5 . V_6 . V_7 =
F_58 ( V_39 , F_59 ( struct V_43 ) ) ;
if ( ! V_28 )
F_57 () ;
}
void F_75 ( void )
{
static T_5 void (* F_76)( void ) = F_74 ;
F_77 () ;
F_78 () -> V_49 = 0 ;
if ( V_99 == V_100 )
F_79 ( V_108 ) ;
...
void * F_83 ( struct V_43 * V_11 , int V_110 )
{
int V_111 = F_51 ( V_110 ) - 1 ;
if ( ! F_56 ( V_111 , ( unsigned long * ) & V_13 ) )
return NULL ;
