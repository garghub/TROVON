...
F_14 ( & V_56 -> V_34 -> V_24 ) ;
F_19 ( & V_56 -> V_24 , V_28 ) ;
F_40 ( & V_56 -> V_34 -> V_26 , & V_56 -> V_25 ) ;
F_16 ( & V_56 -> V_24 ) ;
F_16 ( & V_56 -> V_34 -> V_24 ) ;
F_16 ( & V_15 -> V_23 ) ;
return V_56 ;
}
int F_41 ( struct V_1 * V_1 , int V_58 )
{
...
V_64 . V_65 . V_66 = V_15 -> V_67 ;
V_64 . V_65 . type = V_68 ;
if ( ( V_1 = F_39 ( V_41 , V_9 , V_15 , 0 ) ) == NULL )
return - V_61 ;
V_64 . V_69 = V_1 -> V_70 . V_69 ;
memcpy ( V_64 . V_71 , V_1 -> V_70 . V_71 , V_64 . V_69 ) ;
V_64 . V_71 [ V_64 . V_69 ] = '\0' ;
F_17 ( V_1 ) ;
if ( F_46 ( V_63 , & V_64 , sizeof( struct V_62 ) ) )
V_30 = - V_72 ;
F_14 ( & V_15 -> V_46 ) ;
V_5 = F_2 ( V_1 ) ;
V_5 -> V_6 = V_7 ;
...
struct V_14 * V_15 , int V_73 )
{
struct V_1 * V_1 ;
int V_30 = - V_61 ;
if ( F_49 ( V_15 -> type ) )
V_1 = F_32 ( V_41 , V_9 , V_15 , V_73 ) ;
else
V_1 = F_39 ( V_41 , V_9 , V_15 , V_73 ) ;
if ( V_1 ) {
struct V_4 * V_5 = F_2 ( V_1 ) ;
V_30 = F_42 ( V_15 , V_1 , V_74 ) ;
F_14 ( & V_15 -> V_46 ) ;
V_5 -> V_6 = V_7 ;
V_5 -> V_47 &= ~ V_51 ;
F_47 ( & V_5 -> V_52 ) ;
...
struct V_14 * V_15 , int T_1 * V_75 )
{
int V_3 = 0 ;
if ( V_75 && F_51 ( V_3 , V_75 ) )
return - V_72 ;
