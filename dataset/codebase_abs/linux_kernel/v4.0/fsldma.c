...
static enum V_117 F_82 ( struct V_49 * V_50 ,
T_4 V_62 ,
struct V_118 * V_119 )
{
struct V_1 * V_2 = F_32 ( V_50 ) ;
enum V_117 V_74 ;
V_74 = F_83 ( V_50 , V_62 , V_119 ) ;
if ( V_74 == V_120 )
return V_74 ;
F_39 ( & V_2 -> V_63 ) ;
F_62 ( V_2 ) ;
F_43 ( & V_2 -> V_63 ) ;
return F_83 ( V_50 , V_62 , V_119 ) ;
}
static T_6 F_84 ( int V_121 , void * V_122 )
{
...
static void F_86 ( unsigned long V_122 )
{
...
static T_6 F_87 ( int V_121 , void * V_122 )
{
...
T_1 V_134 , V_135 ;
int V_43 ;
V_134 = ( V_132 -> V_16 & V_136 ) ? F_88 ( V_132 -> V_4 )
: F_89 ( V_132 -> V_4 ) ;
V_135 = 0xff000000 ;
F_90 ( V_132 -> V_84 , L_24 , V_134 ) ;
for ( V_43 = 0 ; V_43 < V_137 ; V_43 ++ ) {
V_2 = V_132 -> V_2 [ V_43 ] ;
if ( ! V_2 )
continue;
if ( V_134 & V_135 ) {
F_90 ( V_132 -> V_84 , L_25 , V_2 -> V_138 ) ;
F_84 ( V_121 , V_2 ) ;
V_133 ++ ;
}
V_134 &= ~ V_135 ;
...
F_90 ( V_132 -> V_84 , L_26 ) ;
F_93 ( V_132 -> V_121 , V_132 ) ;
return;
}
for ( V_43 = 0 ; V_43 < V_137 ; V_43 ++ ) {
V_2 = V_132 -> V_2 [ V_43 ] ;
...
int V_43 ;
if ( V_132 -> V_121 != V_139 ) {
F_90 ( V_132 -> V_84 , L_28 ) ;
V_74 = F_95 ( V_132 -> V_121 , F_87 , V_140 ,
L_29 , V_132 ) ;
return V_74 ;
}
for ( V_43 = 0 ; V_43 < V_137 ; V_43 ++ ) {
...
F_42 ( V_2 , L_31 ) ;
V_74 = F_95 ( V_2 -> V_121 , F_84 , V_140 ,
L_32 , V_2 ) ;
if ( V_74 ) {
F_23 ( V_2 , L_33 ) ;
goto V_142;
...
struct V_145 V_146 ;
int V_147 ;
V_2 = F_97 ( sizeof( * V_2 ) , V_148 ) ;
if ( ! V_2 ) {
F_98 ( V_132 -> V_84 , L_34 ) ;
V_147 = - V_85 ;
goto V_149;
}
V_2 -> V_4 = F_99 ( V_66 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_98 ( V_132 -> V_84 , L_35 ) ;
V_147 = - V_85 ;
goto V_150;
}
V_147 = F_100 ( V_66 , 0 , & V_146 ) ;
if ( V_147 ) {
F_98 ( V_132 -> V_84 , L_36 ) ;
goto V_151;
}
V_2 -> V_16 = V_16 ;
if ( ! V_132 -> V_16 )
V_132 -> V_16 = V_2 -> V_16 ;
F_101 ( V_132 -> V_16 != V_2 -> V_16 ) ;
V_2 -> V_84 = V_132 -> V_84 ;
V_2 -> V_138 = ( V_146 . V_152 & 0xfff ) < 0x300 ?
( ( V_146 . V_152 - 0x100 ) & 0xfff ) >> 7 :
( ( V_146 . V_152 - 0x200 ) & 0xfff ) >> 7 ;
if ( V_2 -> V_138 >= V_137 ) {
F_98 ( V_132 -> V_84 , L_37 ) ;
V_147 = - V_51 ;
goto V_151;
}
V_132 -> V_2 [ V_2 -> V_138 ] = V_2 ;
F_102 ( & V_2 -> V_129 , F_86 , ( unsigned long ) V_2 ) ;
...
F_104 ( & V_2 -> V_70 ) ;
V_2 -> V_121 = F_105 ( V_66 , 0 ) ;
F_59 ( & V_2 -> V_70 . V_143 , & V_132 -> V_70 . V_158 ) ;
F_106 ( V_132 -> V_84 , L_39 , V_2 -> V_138 , V_144 ,
...
static int F_111 ( struct V_159 * V_160 )
{
struct V_131 * V_132 ;
struct V_143 * V_61 ;
int V_147 ;
V_132 = F_97 ( sizeof( * V_132 ) , V_148 ) ;
if ( ! V_132 ) {
F_98 ( & V_160 -> V_84 , L_40 ) ;
V_147 = - V_85 ;
goto V_149;
}
V_132 -> V_84 = & V_160 -> V_84 ;
F_51 ( & V_132 -> V_70 . V_158 ) ;
V_132 -> V_4 = F_99 ( V_160 -> V_84 . V_161 , 0 ) ;
if ( ! V_132 -> V_4 ) {
F_98 ( & V_160 -> V_84 , L_35 ) ;
V_147 = - V_85 ;
goto V_162;
}
V_132 -> V_121 = F_105 ( V_160 -> V_84 . V_161 , 0 ) ;
F_112 ( V_163 , V_132 -> V_70 . V_164 ) ;
F_112 ( V_165 , V_132 -> V_70 . V_164 ) ;
F_112 ( V_166 , V_132 -> V_70 . V_164 ) ;
V_132 -> V_70 . V_167 = F_63 ;
V_132 -> V_70 . V_168 = F_69 ;
V_132 -> V_70 . V_169 = F_71 ;
V_132 -> V_70 . V_170 = F_74 ;
V_132 -> V_70 . V_171 = F_82 ;
V_132 -> V_70 . V_172 = F_81 ;
V_132 -> V_70 . V_173 = F_80 ;
V_132 -> V_70 . V_174 = F_79 ;
V_132 -> V_70 . V_84 = & V_160 -> V_84 ;
V_132 -> V_70 . V_175 = V_176 ;
V_132 -> V_70 . V_177 = V_176 ;
V_132 -> V_70 . V_178 = F_113 ( V_179 ) | F_113 ( V_112 ) ;
V_132 -> V_70 . V_180 = V_181 ;
F_114 ( & ( V_160 -> V_84 ) , F_115 ( 36 ) ) ;
F_116 ( V_160 , V_132 ) ;
F_117 (op->dev.of_node, child) {
if ( F_118 ( V_61 , L_41 ) ) {
F_96 ( V_132 , V_61 ,
V_18 | V_136 ,
L_41 ) ;
...
static int F_120 ( struct V_159 * V_160 )
{
struct V_131 * V_132 ;
unsigned int V_43 ;
V_132 = F_121 ( V_160 ) ;
...
for ( V_43 = 0 ; V_43 < V_137 ; V_43 ++ ) {
if ( V_132 -> V_2 [ V_43 ] )
F_109 ( V_132 -> V_2 [ V_43 ] ) ;
}
F_107 ( V_132 -> V_4 ) ;
F_108 ( V_132 ) ;
return 0 ;
}
static int F_123 ( struct V_157 * V_84 )
{
struct V_159 * V_183 = F_124 ( V_84 ) ;
struct V_131 * V_132 = F_121 ( V_183 ) ;
struct V_1 * V_2 ;
int V_43 ;
for ( V_43 = 0 ; V_43 < V_137 ; V_43 ++ ) {
V_2 = V_132 -> V_2 [ V_43 ] ;
...
static int F_125 ( struct V_157 * V_84 )
{
struct V_159 * V_183 = F_124 ( V_84 ) ;
struct V_131 * V_132 = F_121 ( V_183 ) ;
struct V_1 * V_2 ;
