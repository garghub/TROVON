...
static int F_20 ( struct V_19 * V_20 , unsigned long V_29 ,
void * V_30 )
{
struct V_1 * V_4 ;
V_4 = F_2 ( V_20 , struct V_1 , V_31 ) ;
V_4 -> V_7 ( V_4 , 1 ) ;
return V_28 ;
}
...
int V_34 ;
bool V_35 ;
struct V_1 * V_4 = F_22 ( & V_33 -> V_36 ) ;
if ( ! V_4 )
return - V_37 ;
V_35 = V_4 -> V_10 < V_38 * 1000 ;
if ( V_35 ) {
V_4 -> V_3 . V_26 = & V_39 ;
F_23 ( & V_4 -> V_15 , F_8 ,
...
V_4 -> V_3 . V_41 = & V_42 ;
V_4 -> V_3 . V_6 = V_43 ;
V_34 = V_4 -> V_3 . V_26 -> V_44 ( & V_4 -> V_3 , V_6 ) ;
if ( V_34 )
goto V_45;
F_24 ( & V_4 -> V_3 , V_46 ) ;
V_4 -> V_23 . V_47 = & F_19 ;
