...
V_125 -> V_67 = V_130 | V_131 |
V_132 ;
V_125 -> type = V_133 ;
}
return 0 ;
}
static T_4 F_42 ( int V_51 , void * V_134 )
{
...
{
return F_3 ( V_2 , V_151 , V_11 << 4 ) ;
}
static enum V_152 F_49 ( unsigned int V_53 )
{
switch ( V_53 ) {
case V_153 :
case V_154 :
...
V_176 = V_179 [ V_175 ] ;
for ( V_177 = 0 ; V_177 < F_51 ( V_179 [ 0 ] ) ; V_177 ++ )
F_3 ( V_2 , 0x0052 + V_177 , V_176 [ V_177 ] ) ;
if ( V_175 == V_174 ) {
F_3 ( V_2 , 0x005f , 0xa8 ) ;
F_3 ( V_2 , 0x005a , 0x90 ) ;
F_3 ( V_2 , 0x0060 , 0xb0 ) ;
...
static int F_54 ( struct V_190 * V_5 ,
const struct V_191 * V_74 )
{
struct V_1 * V_2 ;
struct V_47 * V_48 ;
int V_56 ;
if ( ! F_55 ( V_5 -> V_192 , V_193 ) )
return - V_194 ;
F_56 ( V_5 , L_1 ,
V_5 -> V_195 , V_5 -> V_192 -> V_196 ) ;
V_2 = F_57 ( & V_5 -> V_197 , sizeof( * V_2 ) , V_198 ) ;
if ( V_2 == NULL )
return - V_199 ;
V_2 -> V_5 = V_5 ;
V_2 -> V_69 = V_122 ;
V_2 -> V_12 = (struct V_200 * ) V_74 -> V_201 ;
if ( V_2 -> V_12 -> V_67 & V_68 ) {
V_2 -> V_10 = F_58 ( V_5 -> V_192 ,
V_147 ) ;
if ( ! V_2 -> V_10 )
return - V_199 ;
}
if ( V_2 -> V_12 -> V_67 & V_116 ) {
V_2 -> V_14 = F_58 ( V_5 -> V_192 ,
V_149 ) ;
if ( ! V_2 -> V_14 ) {
V_56 = - V_199 ;
goto V_202;
...
if ( V_56 )
goto V_206;
V_2 -> V_207 . V_67 = V_208 ;
V_48 -> V_209 . V_67 |= V_210 ;
V_56 = F_61 ( & V_48 -> V_209 , 1 , & V_2 -> V_207 , 0 ) ;
if ( V_56 )
goto V_211;
V_56 = F_52 ( V_2 ) ;
if ( V_56 )
...
static int F_68 ( struct V_190 * V_5 )
{
...
static int F_71 ( struct V_217 * V_197 )
{
struct V_190 * V_5 = F_72 ( V_197 ) ;
struct V_47 * V_48 = F_69 ( V_5 ) ;
struct V_1 * V_2 = F_14 ( V_48 ) ;
return F_24 ( V_2 , false ) ;
}
static int F_73 ( struct V_217 * V_197 )
{
struct V_190 * V_5 = F_72 ( V_197 ) ;
struct V_47 * V_48 = F_69 ( V_5 ) ;
struct V_1 * V_2 = F_14 ( V_48 ) ;
