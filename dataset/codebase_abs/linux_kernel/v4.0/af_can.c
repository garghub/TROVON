...
{
struct V_41 * V_42 = (struct V_41 * ) V_38 -> V_43 ;
if ( F_23 ( ! F_13 ( F_59 ( V_52 ) , & V_24 ) ) )
goto V_122;
if ( F_60 ( V_52 -> type != V_55 ||
V_38 -> V_44 != V_45 ||
V_42 -> V_44 > V_47 ,
L_8
L_9 ,
...
static int F_61 ( struct V_37 * V_38 , struct V_72 * V_52 ,
struct V_119 * V_120 , struct V_72 * V_121 )
{
struct V_41 * V_42 = (struct V_41 * ) V_38 -> V_43 ;
if ( F_23 ( ! F_13 ( F_59 ( V_52 ) , & V_24 ) ) )
...
int F_62 ( const struct V_11 * V_13 )
{
int V_125 = V_13 -> V_12 ;
int V_19 = 0 ;
...
F_65 ( V_14 [ V_125 ] , V_13 ) ;
F_66 ( & V_126 ) ;
if ( V_19 < 0 )
F_67 ( V_13 -> V_15 ) ;
return V_19 ;
}
void F_68 ( const struct V_11 * V_13 )
{
int V_125 = V_13 -> V_12 ;
F_64 ( & V_126 ) ;
F_69 ( V_14 [ V_125 ] != V_13 ) ;
F_65 ( V_14 [ V_125 ] , NULL ) ;
F_66 ( & V_126 ) ;
F_70 () ;
F_67 ( V_13 -> V_15 ) ;
}
static int F_71 ( struct V_128 * V_129 , unsigned long V_130 ,
void * V_131 )
{
struct V_72 * V_52 = F_72 ( V_131 ) ;
struct V_71 * V_80 ;
if ( ! F_13 ( F_59 ( V_52 ) , & V_24 ) )
return V_132 ;
if ( V_52 -> type != V_55 )
return V_132 ;
switch ( V_130 ) {
case V_133 :
V_80 = F_73 ( sizeof( * V_80 ) , V_32 ) ;
if ( ! V_80 )
return V_132 ;
F_69 ( V_52 -> V_74 ) ;
V_52 -> V_74 = V_80 ;
...
static T_2 int F_74 ( void )
{
F_75 ( F_76 ( struct V_114 , V_136 ) !=
F_76 ( struct V_41 , V_44 ) ||
F_76 ( struct V_114 , V_43 ) !=
F_76 ( struct V_41 , V_43 ) ) ;
F_77 ( L_15 V_137 L_16 ) ;
memset ( & V_73 , 0 , sizeof( V_73 ) ) ;
V_101 = F_78 ( L_17 , sizeof( struct V_97 ) ,
0 , 0 , NULL ) ;
if ( ! V_101 )
return - V_33 ;
if ( V_138 ) {
F_79 ( & V_139 , V_140 , 0 ) ;
F_80 ( & V_139 , F_81 ( V_141 + V_142 ) ) ;
} else
V_139 . V_143 = NULL ;
F_82 () ;
F_83 ( & V_144 ) ;
