...
static int F_33 ( unsigned long V_54 , unsigned int V_55 ,
struct V_56 * V_57 )
{
unsigned long V_58 = * ( unsigned long * ) F_34 ( V_57 ) ;
...
F_38 ( V_63 | ( V_63 << 8 ) ,
V_20 -> V_64 + V_65 ) ;
F_38 ( V_18 -> V_66 , V_20 -> V_64 + V_67 ) ;
V_62 = F_39 ( V_20 -> V_64 + V_68 + V_69 ) ;
V_62 &= ~ V_70 ;
V_62 |= F_40 ( 12 ) ;
F_41 ( V_62 , V_20 -> V_64 + V_68 + V_69 ) ;
F_42 ( 17 , F_33 , V_71 , 0 ,
L_11 ) ;
}
...
static int T_3 F_45 ( struct V_72 * V_73 )
{
struct V_17 * V_18 = F_46 ( V_73 ) ;
F_47 ( V_18 -> V_77 ) ;
return 0 ;
}
static int T_2 F_48 ( struct V_72 * V_73 )
{
...
struct V_81 * V_81 ;
int V_39 = 0 ;
V_18 = F_49 ( & V_73 -> V_2 , sizeof( * V_18 ) ,
V_82 ) ;
if ( ! V_18 )
return - V_83 ;
V_20 = & V_18 -> V_20 ;
...
V_79 = F_53 ( V_73 , V_84 , 2 ) ;
V_80 = F_54 ( V_2 , V_79 ) ;
if ( F_55 ( V_80 ) )
return F_56 ( V_80 ) ;
V_18 -> V_66 = F_39 ( V_80 ) >> 16 ;
F_57 ( V_2 , V_80 ) ;
F_58 ( V_2 , V_79 -> V_85 , F_59 ( V_79 ) ) ;
V_20 -> V_2 = V_2 ;
F_60 ( V_73 , V_18 ) ;
V_18 -> V_77 = F_61 ( V_2 , L_15 ) ;
if ( F_55 ( V_18 -> V_77 ) ) {
F_11 ( V_2 , L_16 ) ;
return F_56 ( V_18 -> V_77 ) ;
}
V_39 = F_62 ( V_18 -> V_77 ) ;
if ( V_39 )
return V_39 ;
