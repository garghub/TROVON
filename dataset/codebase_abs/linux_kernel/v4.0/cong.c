...
if ( ! F_23 ( 0 , & V_25 -> V_32 ) ) {
F_24 ( V_33 ) ;
F_25 ( V_34 , & V_25 -> V_35 , 0 ) ;
}
}
F_11 ( & V_23 , V_16 ) ;
}
void F_26 ( struct V_1 * V_8 , T_2 V_36 )
{
F_14 ( L_4 ,
V_8 , & V_8 -> V_10 ) ;
F_24 ( V_37 ) ;
...
int F_37 ( unsigned long * V_47 )
{
unsigned long V_48 = F_38 ( & V_38 ) ;
if ( F_39 ( * V_47 == V_48 ) )
return 0 ;
* V_47 = V_48 ;
return 1 ;
}
void F_40 ( struct V_1 * V_8 , T_3 V_49 )
{
unsigned long V_15 ;
unsigned long V_50 ;
F_14 ( L_5 ,
& V_8 -> V_10 , F_41 ( V_49 ) , V_8 ) ;
V_15 = F_42 ( V_49 ) / V_51 ;
V_50 = F_42 ( V_49 ) % V_51 ;
F_43 ( V_50 , ( void * ) V_8 -> V_22 [ V_15 ] ) ;
}
void F_44 ( struct V_1 * V_8 , T_3 V_49 )
{
unsigned long V_15 ;
unsigned long V_50 ;
F_14 ( L_6 ,
...
V_15 = F_42 ( V_49 ) / V_51 ;
V_50 = F_42 ( V_49 ) % V_51 ;
F_45 ( V_50 , ( void * ) V_8 -> V_22 [ V_15 ] ) ;
}
static int F_46 ( struct V_1 * V_8 , T_3 V_49 )
{
unsigned long V_15 ;
unsigned long V_50 ;
V_15 = F_42 ( V_49 ) / V_51 ;
V_50 = F_42 ( V_49 ) % V_51 ;
return F_47 ( V_50 , ( void * ) V_8 -> V_22 [ V_15 ] ) ;
}
...
F_51 ( & V_43 , V_16 ) ;
F_10 ( & V_23 , V_16 ) ;
V_8 = F_1 ( V_42 -> V_53 , NULL ) ;
F_11 ( & V_23 , V_16 ) ;
if ( V_8 && F_46 ( V_8 , V_42 -> V_54 ) ) {
F_44 ( V_8 , V_42 -> V_54 ) ;
F_21 ( V_8 ) ;
}
}
int F_53 ( struct V_1 * V_8 , T_3 V_49 , int V_55 ,
struct V_41 * V_42 )
{
if ( ! F_46 ( V_8 , V_49 ) )
return 0 ;
...
struct V_61 * F_59 ( struct V_24 * V_25 )
{
struct V_1 * V_8 = V_25 -> V_26 ;
struct V_61 * V_62 ;
V_62 = F_60 ( V_8 -> V_22 , V_63 ) ;
if ( ! F_61 ( V_62 ) )
