...
{
struct V_445 * V_453 ;
while ( ( V_453 = * V_452 ) != NULL ) {
if ( V_453 -> V_94 == V_4 -> V_94 ) {
F_297 ( V_4 , V_453 , - 1 ) ;
* V_452 = V_453 -> V_201 ;
F_185 ( V_453 ) ;
} else
...
static int F_305 ( struct V_23 * V_24 , struct V_454 * V_455 )
{
struct V_13 * V_14 = F_36 ( V_24 ) ;
struct V_445 * V_453 , * V_199 ;
struct V_3 * V_4 ;
int V_92 ;
F_76 () ;
V_92 = - V_260 ;
V_4 = F_77 ( F_78 ( V_24 ) , V_455 -> V_456 ) ;
if ( ! V_4 )
goto V_457;
V_92 = - V_223 ;
if ( V_455 -> V_458 > V_4 -> V_405 )
goto V_457;
V_92 = - V_182 ;
...
goto V_457;
V_92 = 0 ;
for ( V_453 = V_14 -> V_459 ; V_453 ; V_453 = V_453 -> V_201 ) {
if ( V_453 -> V_94 == V_455 -> V_456 &&
V_453 -> type == V_455 -> V_460 &&
V_453 -> V_448 == V_455 -> V_458 &&
memcmp ( V_453 -> V_31 , V_455 -> V_461 , V_453 -> V_448 ) == 0 ) {
V_453 -> V_462 ++ ;
F_185 ( V_199 ) ;
goto V_457;
}
}
V_199 -> type = V_455 -> V_460 ;
V_199 -> V_94 = V_455 -> V_456 ;
V_199 -> V_448 = V_455 -> V_458 ;
memcpy ( V_199 -> V_31 , V_455 -> V_461 , V_199 -> V_448 ) ;
V_199 -> V_462 = 1 ;
V_199 -> V_201 = V_14 -> V_459 ;
V_14 -> V_459 = V_199 ;
V_92 = F_297 ( V_4 , V_199 , 1 ) ;
if ( V_92 ) {
V_14 -> V_459 = V_199 -> V_201 ;
F_185 ( V_199 ) ;
}
V_457:
F_79 () ;
...
static int F_307 ( struct V_23 * V_24 , struct V_454 * V_455 )
{
struct V_445 * V_453 , * * V_452 ;
F_76 () ;
for ( V_452 = & F_36 ( V_24 ) -> V_459 ; ( V_453 = * V_452 ) != NULL ; V_452 = & V_453 -> V_201 ) {
if ( V_453 -> V_94 == V_455 -> V_456 &&
V_453 -> type == V_455 -> V_460 &&
V_453 -> V_448 == V_455 -> V_458 &&
memcmp ( V_453 -> V_31 , V_455 -> V_461 , V_453 -> V_448 ) == 0 ) {
...
return;
F_76 () ;
while ( ( V_453 = V_14 -> V_459 ) != NULL ) {
struct V_3 * V_4 ;
V_14 -> V_459 = V_453 -> V_201 ;
V_4 = F_77 ( F_78 ( V_24 ) , V_453 -> V_94 ) ;
if ( V_4 != NULL )
F_297 ( V_4 , V_453 , - 1 ) ;
F_185 ( V_453 ) ;
...
static int
F_308 ( struct V_249 * V_23 , int V_463 , int V_464 , char T_10 * V_465 , unsigned int V_466 )
{
struct V_23 * V_24 = V_23 -> V_24 ;
struct V_13 * V_14 = F_36 ( V_24 ) ;
int V_8 ;
...
if ( V_173 < sizeof( struct V_470 ) )
return - V_223 ;
if ( V_173 > sizeof( V_455 ) )
V_173 = sizeof( V_455 ) ;
if ( F_309 ( & V_455 , V_465 , V_173 ) )
return - V_352 ;
if ( V_173 < ( V_455 . V_458 + F_241 ( struct V_470 , V_461 ) ) )
return - V_223 ;
if ( V_464 == V_468 )
V_8 = F_305 ( V_24 , & V_455 ) ;
else
V_8 = F_307 ( V_24 , & V_455 ) ;
return V_8 ;
}
case V_471 :
case V_472 :
...
if ( F_36 ( V_24 ) -> V_376 )
return - V_223 ;
if ( F_309 ( & V_100 . V_473 , V_465 , V_173 ) )
return - V_352 ;
...
return - V_223 ;
if ( F_309 ( & V_475 , V_465 , sizeof( V_475 ) ) )
return - V_352 ;
F_36 ( V_24 ) -> V_327 = V_475 ;
return 0 ;
}
case V_476 :
{
...
if ( F_309 ( & V_475 , V_465 , sizeof( V_475 ) ) )
return - V_352 ;
return F_171 ( V_24 , V_475 & 0xffff , V_475 >> 16 ) ;
}
case V_484 :
{
unsigned int V_475 ;
...
static int F_310 ( struct V_249 * V_23 , int V_463 , int V_464 ,
char T_10 * V_465 , int T_10 * V_466 )
{
int V_173 ;
...
if ( V_173 > V_486 )
V_173 = V_486 ;
if ( F_312 ( V_173 , V_466 ) )
return - V_352 ;
if ( F_313 ( V_465 , V_81 , V_173 ) )
return - V_352 ;
return 0 ;
}
static int F_314 ( struct V_495 * V_496 ,
unsigned long V_251 , void * V_497 )
{
struct V_23 * V_24 ;
struct V_3 * V_4 = F_315 ( V_497 ) ;
...
static int F_317 ( struct V_249 * V_23 , unsigned int V_502 ,
unsigned long V_503 )
{
struct V_23 * V_24 = V_23 -> V_24 ;
switch ( V_502 ) {
case V_504 :
{
int V_505 = F_318 ( V_24 ) ;
return F_312 ( V_505 , ( int T_10 * ) V_503 ) ;
}
case V_506 :
{
struct V_1 * V_2 ;
...
case V_507 :
return F_320 ( V_24 , (struct V_508 T_10 * ) V_503 ) ;
case V_509 :
return F_321 ( V_24 , (struct V_44 T_10 * ) V_503 ) ;
#ifdef F_322
case V_510 :
case V_511 :
case V_512 :
...
case V_522 :
case V_523 :
return V_524 . V_525 ( V_23 , V_502 , V_503 ) ;
#endif
default:
return - V_526 ;
}
...
static unsigned int F_323 ( struct V_527 * V_527 , struct V_249 * V_23 ,
T_11 * V_528 )
{
struct V_23 * V_24 = V_23 -> V_24 ;
struct V_13 * V_14 = F_36 ( V_24 ) ;
unsigned int V_529 = F_324 ( V_527 , V_23 , V_528 ) ;
F_69 ( & V_24 -> V_129 . V_79 ) ;
if ( V_14 -> V_78 . V_68 ) {
...
F_70 ( & V_24 -> V_129 . V_79 ) ;
F_69 ( & V_24 -> V_532 . V_79 ) ;
if ( V_14 -> V_75 . V_68 ) {
if ( F_64 ( V_14 , & V_14 -> V_75 , V_169 ) )
V_529 |= V_533 | V_534 ;
}
F_70 ( & V_24 -> V_532 . V_79 ) ;
return V_529 ;
}
static void F_325 ( struct V_535 * V_536 )
{
struct V_527 * V_527 = V_536 -> V_537 ;
struct V_249 * V_23 = V_527 -> V_538 ;
struct V_23 * V_24 = V_23 -> V_24 ;
if ( V_24 )
F_121 ( & F_36 ( V_24 ) -> V_539 ) ;
}
static void F_326 ( struct V_535 * V_536 )
{
struct V_527 * V_527 = V_536 -> V_537 ;
struct V_249 * V_23 = V_527 -> V_538 ;
struct V_23 * V_24 = V_23 -> V_24 ;
if ( V_24 )
F_110 ( & F_36 ( V_24 ) -> V_539 ) ;
}
static void F_327 ( struct V_104 * V_68 , unsigned int V_540 ,
unsigned int V_173 )
{
int V_199 ;
...
static char * F_330 ( unsigned long V_540 )
{
char * V_69 ;
T_12 V_541 = V_227 | V_542 |
V_543 | V_544 | V_545 ;
V_69 = ( char * ) F_331 ( V_541 , V_540 ) ;
if ( V_69 )
return V_69 ;
V_69 = F_332 ( ( 1 << V_540 ) * V_139 ) ;
if ( V_69 )
return V_69 ;
V_541 &= ~ V_545 ;
V_69 = ( char * ) F_331 ( V_541 , V_540 ) ;
...
static struct V_104 * F_333 ( struct V_546 * V_473 , int V_540 )
{
unsigned int V_547 = V_473 -> V_113 ;
struct V_104 * V_68 ;
int V_199 ;
V_68 = F_334 ( V_547 , sizeof( struct V_104 ) , V_227 ) ;
if ( F_2 ( ! V_68 ) )
goto V_130;
for ( V_199 = 0 ; V_199 < V_547 ; V_199 ++ ) {
V_68 [ V_199 ] . V_69 = F_330 ( V_540 ) ;
...
T_8 V_193 ;
int V_92 = - V_223 ;
struct V_546 * V_473 = & V_100 -> V_473 ;
if ( ! V_549 && V_75 && ( V_14 -> V_37 > V_41 ) ) {
F_54 ( 1 , L_8 ) ;
goto V_130;
}
V_63 = V_75 ? & V_14 -> V_75 : & V_14 -> V_78 ;
V_77 = V_75 ? & V_24 -> V_532 : & V_24 -> V_129 ;
V_92 = - V_477 ;
if ( ! V_549 ) {
if ( F_92 ( & V_14 -> V_539 ) )
goto V_130;
...
V_92 = - V_223 ;
if ( F_2 ( ( int ) V_473 -> V_111 <= 0 ) )
goto V_130;
if ( F_2 ( V_473 -> V_111 & ( V_139 - 1 ) ) )
goto V_130;
if ( V_14 -> V_37 >= V_43 &&
( int ) ( V_473 -> V_111 -
F_85 ( V_100 -> V_102 . V_125 ) ) <= 0 )
goto V_130;
if ( F_2 ( V_473 -> V_554 < V_14 -> V_115 +
V_14 -> V_325 ) )
goto V_130;
if ( F_2 ( V_473 -> V_554 & ( V_555 - 1 ) ) )
goto V_130;
V_63 -> V_67 = V_473 -> V_111 / V_473 -> V_554 ;
if ( F_2 ( V_63 -> V_67 <= 0 ) )
goto V_130;
if ( F_2 ( ( V_63 -> V_67 * V_473 -> V_113 ) !=
V_473 -> V_556 ) )
goto V_130;
V_92 = - V_226 ;
V_540 = F_335 ( V_473 -> V_111 ) ;
V_68 = F_333 ( V_473 , V_540 ) ;
if ( F_2 ( ! V_68 ) )
goto V_130;
switch ( V_14 -> V_37 ) {
case V_43 :
...
V_92 = - V_477 ;
F_172 ( & V_14 -> V_358 ) ;
if ( V_549 || F_92 ( & V_14 -> V_539 ) == 0 ) {
V_92 = 0 ;
F_69 ( & V_77 -> V_79 ) ;
F_336 ( V_63 -> V_68 , V_68 ) ;
V_63 -> V_177 = ( V_473 -> V_556 - 1 ) ;
V_63 -> V_71 = 0 ;
V_63 -> V_70 = V_473 -> V_554 ;
F_70 ( & V_77 -> V_79 ) ;
F_336 ( V_63 -> V_557 , V_540 ) ;
F_336 ( V_63 -> V_558 , V_473 -> V_113 ) ;
V_63 -> V_559 = V_473 -> V_111 / V_139 ;
...
F_44 ( & V_14 -> V_29 ) ;
if ( V_549 && ( V_14 -> V_37 > V_41 ) ) {
if ( ! V_75 )
F_67 ( V_14 , V_75 , V_77 ) ;
}
F_270 ( V_24 ) ;
if ( V_68 )
F_327 ( V_68 , V_540 , V_473 -> V_113 ) ;
V_130:
return V_92 ;
}
static int F_337 ( struct V_527 * V_527 , struct V_249 * V_23 ,
struct V_535 * V_536 )
{
struct V_23 * V_24 = V_23 -> V_24 ;
struct V_13 * V_14 = F_36 ( V_24 ) ;
...
if ( V_63 -> V_68 == NULL )
continue;
for ( V_199 = 0 ; V_199 < V_63 -> V_558 ; V_199 ++ ) {
struct V_30 * V_30 ;
void * V_565 = V_63 -> V_68 [ V_199 ] . V_69 ;
int V_566 ;
for ( V_566 = 0 ; V_566 < V_63 -> V_559 ; V_566 ++ ) {
V_30 = F_48 ( V_565 ) ;
V_92 = F_338 ( V_536 , V_137 , V_30 ) ;
if ( F_2 ( V_92 ) )
goto V_130;
V_137 += V_139 ;
V_565 += V_139 ;
...
static void * F_339 ( struct V_569 * V_570 , T_13 * V_571 )
__acquires( T_14 )
{
struct V_209 * V_209 = F_340 ( V_570 ) ;
F_20 () ;
return F_341 ( & V_209 -> V_396 . V_423 , * V_571 ) ;
}
static void * F_342 ( struct V_569 * V_570 , void * V_572 , T_13 * V_571 )
{
struct V_209 * V_209 = F_340 ( V_570 ) ;
return F_343 ( V_572 , & V_209 -> V_396 . V_423 , V_571 ) ;
}
static void F_344 ( struct V_569 * V_570 , void * V_572 )
__releases( T_14 )
{
F_24 () ;
}
static int F_345 ( struct V_569 * V_570 , void * V_572 )
{
if ( V_572 == V_573 )
F_346 ( V_570 , L_10 ) ;
else {
struct V_23 * V_392 = F_347 ( V_572 ) ;
...
V_14 -> V_25 ,
F_92 ( & V_392 -> V_185 ) ,
F_349 ( F_350 ( V_570 ) , F_351 ( V_392 ) ) ,
F_352 ( V_392 ) ) ;
}
return 0 ;
}
static int F_353 ( struct V_575 * V_575 , struct V_527 * V_527 )
{
return F_354 ( V_575 , V_527 , & V_576 ,
sizeof( struct V_577 ) ) ;
}
...
if ( ! F_357 ( L_12 , 0 , V_209 -> V_578 , & V_579 ) )
return - V_226 ;
return 0 ;
}
static void T_16 F_358 ( struct V_209 * V_209 )
{
F_359 ( L_12 , V_209 -> V_578 ) ;
}
