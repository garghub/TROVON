...
static void F_55 ( struct V_9 * V_10 , int V_130 ,
int V_27 )
{
T_1 V_11 , V_102 ;
V_11 = F_3 ( V_10 , V_52 ) ;
...
static int F_56 ( struct V_118 * V_136 ,
struct V_137 * V_138 )
{
...
static void F_57 ( struct V_118 * V_136 ,
struct V_137 * V_138 )
{
struct V_9 * V_10 = V_138 -> V_10 ;
struct V_1 * V_2 = F_4 ( V_10 ) ;
...
F_55 ( V_10 , V_136 -> V_141 , 0 ) ;
}
static int F_58 ( struct V_118 * V_136 ,
struct V_142 * V_143 ,
struct V_137 * V_138 )
{
struct V_9 * V_10 = V_138 -> V_10 ;
...
V_2 -> V_109 = 1 ;
V_2 -> V_125 = F_60 ( V_143 ) ;
V_2 -> V_127 = F_62 ( V_143 ,
V_126 ) -> V_166 ;
V_2 -> V_129 = F_59 ( V_143 ) ;
if ( V_2 -> V_122 )
F_53 ( V_2 , V_136 ) ;
return 0 ;
}
static int F_63 ( struct V_137 * V_167 , int V_168 ,
...
static int F_64 ( struct V_137 * V_167 , unsigned int V_171 )
{
struct V_9 * V_10 = V_167 -> V_10 ;
struct V_1 * V_2 = F_4 ( V_10 ) ;
T_1 V_146 , V_145 ;
...
static int F_65 ( struct V_137 * V_138 , int V_181 )
{
struct V_9 * V_10 = V_138 -> V_10 ;
...
static void F_66 ( struct V_9 * V_10 , int V_130 ,
int V_27 )
{
T_1 V_11 , V_102 ;
V_11 = F_3 ( V_10 , V_52 ) ;
...
static int F_67 ( struct V_118 * V_136 ,
struct V_137 * V_138 )
{
struct V_9 * V_10 = V_138 -> V_10 ;
struct V_1 * V_2 = F_4 ( V_10 ) ;
...
static void F_68 ( struct V_118 * V_136 ,
struct V_137 * V_138 )
{
struct V_9 * V_10 = V_138 -> V_10 ;
F_66 ( V_10 , V_136 -> V_141 , 0 ) ;
}
static int F_69 ( struct V_118 * V_136 ,
struct V_142 * V_143 ,
struct V_137 * V_138 )
{
struct V_9 * V_10 = V_138 -> V_10 ;
...
static int F_71 ( struct V_137 * V_167 ,
unsigned int V_171 )
{
struct V_9 * V_10 = V_167 -> V_10 ;
struct V_1 * V_2 = F_4 ( V_10 ) ;
...
static int F_72 ( struct V_137 * V_138 , int V_181 )
{
struct V_9 * V_10 = V_138 -> V_10 ;
...
{
return F_79 ( & V_195 -> V_40 , & V_196 ,
V_197 , F_80 ( V_197 ) ) ;
}
static int F_81 ( struct V_194 * V_195 )
{
F_82 ( & V_195 -> V_40 ) ;
return 0 ;
}
