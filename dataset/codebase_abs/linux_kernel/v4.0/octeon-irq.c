...
static int T_2 F_183 ( struct V_68 * V_109 ,
struct V_68 * V_110 )
{
const T_10 * V_180 ;
T_5 V_181 ;
...
F_127 ( & V_83 -> V_38 ) ;
V_180 = F_185 ( V_109 , 0 , NULL , NULL ) ;
if ( ! V_180 ) {
F_103 ( L_11 , V_109 -> V_79 ) ;
return - V_65 ;
}
V_83 -> V_178 = ( T_4 ) F_186 (
F_187 ( V_109 , V_180 ) ) ;
V_180 = F_185 ( V_109 , 1 , NULL , NULL ) ;
if ( ! V_180 ) {
F_103 ( L_12 , V_109 -> V_79 ) ;
return - V_65 ;
}
V_83 -> V_170 = ( T_4 ) F_186 (
F_187 ( V_109 , V_180 ) ) ;
