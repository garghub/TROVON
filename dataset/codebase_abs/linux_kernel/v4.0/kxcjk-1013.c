...
static T_2 F_39 ( int V_81 , void * V_82 )
{
...
int V_85 , V_5 , V_29 = 0 ;
F_29 ( & V_2 -> V_61 ) ;
F_40 (bit, indio_dev->active_scan_mask,
...
static T_2 F_46 ( int V_81 , void * V_92 )
{
...
static T_2 F_49 ( int V_81 , void * V_92 )
{
struct V_55 * V_56 = V_92 ;
struct V_1 * V_2 = F_28 ( V_56 ) ;
V_2 -> V_88 = F_50 () ;
...
static const char * F_52 ( struct V_110 * V_8 ,
enum V_111 * V_31 ,
bool * V_112 )
{
const struct V_113 * V_114 ;
V_114 = F_53 ( V_8 -> V_115 -> V_116 , V_8 ) ;
if ( ! V_114 )
return NULL ;
...
static int F_55 ( struct V_118 * V_6 ,
struct V_1 * V_2 )
{
struct V_110 * V_8 ;
struct V_119 * V_120 ;
...
return V_5 ;
V_5 = F_60 ( V_120 ) ;
F_8 ( V_8 , L_21 , F_61 ( V_120 ) , V_5 ) ;
return V_5 ;
}
static int F_62 ( struct V_118 * V_6 ,
const struct V_122 * V_114 )
{
struct V_1 * V_2 ;
struct V_55 * V_56 ;
struct V_123 * V_124 ;
...
return V_5 ;
F_67 ( & V_2 -> V_61 ) ;
V_56 -> V_8 . V_128 = & V_6 -> V_8 ;
V_56 -> V_129 = V_130 ;
V_56 -> V_131 = F_10 ( V_130 ) ;
V_56 -> V_125 = V_125 ;
V_56 -> V_132 = V_133 ;
V_56 -> V_71 = & V_134 ;
if ( V_6 -> V_81 < 0 )
V_6 -> V_81 = F_55 ( V_6 , V_2 ) ;
if ( V_6 -> V_81 >= 0 ) {
V_5 = F_68 ( & V_6 -> V_8 , V_6 -> V_81 ,
F_49 ,
F_46 ,
V_135 ,
V_136 ,
...
V_2 -> V_79 -> V_8 . V_128 = & V_6 -> V_8 ;
V_2 -> V_79 -> V_138 = & V_139 ;
F_70 ( V_2 -> V_79 , V_56 ) ;
V_56 -> V_78 = V_2 -> V_79 ;
F_71 ( V_56 -> V_78 ) ;
V_5 = F_72 ( V_2 -> V_79 ) ;
if ( V_5 )
goto V_137;
V_2 -> V_80 -> V_8 . V_128 = & V_6 -> V_8 ;
V_2 -> V_80 -> V_138 = & V_139 ;
F_70 ( V_2 -> V_80 , V_56 ) ;
V_5 = F_72 ( V_2 -> V_80 ) ;
if ( V_5 ) {
V_2 -> V_80 = NULL ;
...
static int F_82 ( struct V_118 * V_6 )
{
struct V_55 * V_56 = F_83 ( V_6 ) ;
struct V_1 * V_2 = F_28 ( V_56 ) ;
F_84 ( & V_6 -> V_8 ) ;
F_85 ( & V_6 -> V_8 ) ;
F_16 ( & V_6 -> V_8 ) ;
...
static int F_86 ( struct V_110 * V_8 )
{
struct V_55 * V_56 = F_83 ( F_87 ( V_8 ) ) ;
struct V_1 * V_2 = F_28 ( V_56 ) ;
int V_5 ;
F_29 ( & V_2 -> V_61 ) ;
V_5 = F_1 ( V_2 , V_9 ) ;
...
V_5 = F_1 ( V_2 , V_9 ) ;
if ( V_5 < 0 ) {
F_3 ( & V_2 -> V_6 -> V_8 , L_26 ) ;
return - V_145 ;
}
return 0 ;
}
static int F_90 ( struct V_110 * V_8 )
{
struct V_55 * V_56 = F_83 ( F_87 ( V_8 ) ) ;
struct V_1 * V_2 = F_28 ( V_56 ) ;
int V_5 ;
