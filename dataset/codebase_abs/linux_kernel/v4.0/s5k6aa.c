...
int V_33 = 0 ;
if ( V_190 -> V_20 >= F_29 ( V_23 ) )
return - V_58 ;
F_71 ( & V_190 -> V_14 , V_191 ,
V_192 , 1 ,
& V_190 -> V_16 , V_193 ,
V_194 , 1 , 0 ) ;
F_62 ( & V_5 -> V_169 ) ;
V_176 = & V_23 [ V_190 -> V_20 ] ;
if ( V_190 -> V_14 > V_176 -> V_186 . V_14 || V_190 -> V_16 > V_176 -> V_186 . V_16 )
V_33 = - V_58 ;
else
V_190 -> V_177 = V_176 -> V_177 ;
F_63 ( & V_5 -> V_169 ) ;
return V_33 ;
}
...
return - V_58 ;
while ( -- V_11 )
if ( V_197 -> V_18 == V_19 [ V_11 ] . V_18 )
break;
V_197 -> V_18 = V_19 [ V_11 ] . V_18 ;
V_197 -> V_198 = V_191 ;
V_197 -> V_199 = V_192 ;
V_197 -> V_200 = V_193 ;
V_197 -> V_201 = V_194 ;
...
static struct V_122 *
F_74 ( struct V_5 * V_5 , struct V_187 * V_188 ,
enum V_202 V_203 )
{
if ( V_203 == V_204 )
return & V_5 -> V_124 ;
...
{
unsigned int V_20 ;
F_71 ( & V_118 -> V_14 , V_191 ,
V_192 , 1 ,
& V_118 -> V_16 , V_193 ,
V_194 , 1 , 0 ) ;
if ( V_118 -> V_119 != V_206 &&
V_118 -> V_119 != V_207 )
V_118 -> V_119 = V_206 ;
V_20 = F_31 ( V_5 , V_118 ) ;
...
static int F_78 ( struct V_1 * V_7 , struct V_187 * V_188 ,
struct V_210 * V_211 )
{
struct V_5 * V_5 = F_3 ( V_7 ) ;
struct V_117 * V_118 ;
memset ( V_211 -> V_212 , 0 , sizeof( V_211 -> V_212 ) ) ;
if ( V_211 -> V_203 == V_205 ) {
V_118 = F_79 ( V_188 , 0 ) ;
V_211 -> V_213 = * V_118 ;
return 0 ;
}
F_62 ( & V_5 -> V_169 ) ;
V_211 -> V_213 = V_5 -> V_9 -> V_13 ;
F_63 ( & V_5 -> V_169 ) ;
return 0 ;
}
static int F_80 ( struct V_1 * V_7 , struct V_187 * V_188 ,
struct V_210 * V_211 )
{
struct V_5 * V_5 = F_3 ( V_7 ) ;
...
int V_33 = 0 ;
F_62 ( & V_5 -> V_169 ) ;
F_77 ( V_5 , & V_211 -> V_213 ) ;
if ( V_211 -> V_203 == V_205 ) {
V_118 = F_79 ( V_188 , V_211 -> V_215 ) ;
V_214 = F_76 ( V_188 , 0 ) ;
} else {
if ( V_5 -> V_167 ) {
V_33 = - V_216 ;
...
* V_118 = V_211 -> V_213 ;
V_214 -> V_14 = F_81 (unsigned int, crop->width, mf->width,
S5K6AA_WIN_WIDTH_MAX) ;
V_214 -> V_16 = F_81 (unsigned int, crop->height, mf->height,
S5K6AA_WIN_HEIGHT_MAX) ;
V_214 -> V_128 = F_81 (unsigned int, crop->left, 0 ,
S5K6AA_WIN_WIDTH_MAX - crop->width) ;
V_214 -> V_130 = F_81 (unsigned int, crop->top, 0 ,
...
return - V_58 ;
memset ( V_218 -> V_212 , 0 , sizeof( V_218 -> V_212 ) ) ;
F_62 ( & V_5 -> V_169 ) ;
V_219 = F_74 ( V_5 , V_188 , V_218 -> V_203 ) ;
V_218 -> V_123 = * V_219 ;
F_63 ( & V_5 -> V_169 ) ;
F_8 ( 1 , V_40 , V_7 , L_9 ,
V_219 -> V_128 , V_219 -> V_130 , V_219 -> V_14 , V_219 -> V_16 ) ;
return 0 ;
}
...
return - V_58 ;
F_62 ( & V_5 -> V_169 ) ;
V_224 = F_74 ( V_5 , V_188 , V_218 -> V_203 ) ;
if ( V_218 -> V_203 == V_204 ) {
V_118 = & V_5 -> V_9 -> V_13 ;
V_5 -> V_132 = 1 ;
} else {
V_118 = F_79 ( V_188 , 0 ) ;
}
F_71 ( & V_218 -> V_123 . V_14 , V_118 -> V_14 ,
V_192 , 1 ,
& V_218 -> V_123 . V_16 , V_118 -> V_16 ,
V_194 , 1 , 0 ) ;
V_222 = ( V_192 - V_218 -> V_123 . V_14 ) & ~ 1 ;
V_223 = ( V_194 - V_218 -> V_123 . V_16 ) & ~ 1 ;
V_218 -> V_123 . V_128 = F_81 (unsigned int, sel->r.left, 0 , max_x) ;
V_218 -> V_123 . V_130 = F_81 (unsigned int, sel->r.top, 0 , max_y) ;
* V_224 = V_218 -> V_123 ;
F_63 ( & V_5 -> V_169 ) ;
F_8 ( 1 , V_40 , V_7 , L_10 ,
V_224 -> V_128 , V_224 -> V_130 , V_224 -> V_14 , V_224 -> V_16 ) ;
return 0 ;
}
...
break;
case V_227 :
V_179 = F_11 ( V_26 , V_228 , V_3 -> V_28 ) ;
break;
case V_229 :
V_179 = F_28 ( V_5 , V_3 -> V_28 ) ;
break;
case V_230 :
V_179 = F_11 ( V_26 , V_231 , V_3 -> V_28 ) ;
break;
case V_232 :
...
break;
case V_235 :
V_179 = F_11 ( V_26 , V_236 , V_3 -> V_28 ) ;
break;
case V_237 :
V_179 = F_11 ( V_26 , V_238 , V_3 -> V_28 ) ;
break;
case V_239 :
...
{
F_87 ( V_7 -> V_171 , V_7 -> V_240 ) ;
return 0 ;
}
static int F_88 ( struct V_5 * V_5 )
{
const struct V_241 * V_242 = & V_243 ;
struct V_76 * V_6 = & V_5 -> V_6 ;
struct V_244 * V_245 = & V_6 -> V_4 ;
int V_33 = F_89 ( V_245 , 16 ) ;
if ( V_33 )
return V_33 ;
V_6 -> V_75 = F_90 ( V_245 , V_242 , V_226 ,
0 , 1 , 1 , 1 ) ;
V_6 -> V_80 = F_91 ( V_245 , & V_76 [ 0 ] , NULL ) ;
V_6 -> V_83 = F_91 ( V_245 , & V_76 [ 1 ] , NULL ) ;
V_6 -> V_86 = F_91 ( V_245 , & V_76 [ 2 ] , NULL ) ;
F_92 ( 4 , & V_6 -> V_75 , 0 , false ) ;
V_6 -> V_246 = F_90 ( V_245 , V_242 , V_233 , 0 , 1 , 1 , 0 ) ;
V_6 -> V_71 = F_90 ( V_245 , V_242 , V_247 , 0 , 1 , 1 , 0 ) ;
F_93 ( 2 , & V_6 -> V_246 ) ;
V_6 -> V_248 = F_94 ( V_245 , V_242 ,
V_232 ,
V_249 , 0 , V_99 ) ;
V_6 -> V_89 = F_90 ( V_245 , V_242 , V_250 ,
0 , 6000000U , 1 , 100000U ) ;
V_6 -> V_93 = F_90 ( V_245 , V_242 , V_251 ,
0 , 256 , 1 , 256 ) ;
F_92 ( 3 , & V_6 -> V_248 , 0 , false ) ;
F_94 ( V_245 , V_242 , V_234 ,
V_102 , 0 ,
V_102 ) ;
F_94 ( V_245 , V_242 , V_229 ,
V_112 , ~ 0x6f , V_108 ) ;
F_90 ( V_245 , V_242 , V_239 ,
0 , 256 , 1 , 0 ) ;
F_90 ( V_245 , V_242 , V_235 , - 127 , 127 , 1 , 0 ) ;
F_90 ( V_245 , V_242 , V_227 , - 127 , 127 , 1 , 0 ) ;
F_90 ( V_245 , V_242 , V_230 , - 127 , 127 , 1 , 0 ) ;
F_90 ( V_245 , V_242 , V_237 , - 127 , 127 , 1 , 0 ) ;
if ( V_245 -> error ) {
V_33 = V_245 -> error ;
F_95 ( V_245 ) ;
return V_33 ;
...
static int F_96 ( struct V_1 * V_7 , struct V_187 * V_188 )
{
struct V_117 * V_213 = F_79 ( V_188 , 0 ) ;
struct V_122 * V_214 = F_76 ( V_188 , 0 ) ;
V_213 -> V_119 = V_19 [ 0 ] . V_119 ;
V_213 -> V_18 = V_19 [ 0 ] . V_18 ;
V_213 -> V_14 = V_15 ;
V_213 -> V_16 = V_17 ;
V_213 -> V_208 = V_209 ;
V_214 -> V_14 = V_192 ;
...
V_160 = & V_259 -> V_261 ;
if ( F_53 ( V_160 -> V_160 ) ) {
V_34 = ( V_160 -> V_161 ? V_262 : V_263 )
| V_264 ;
V_33 = F_102 ( & V_26 -> V_265 , V_160 -> V_160 , V_34 ,
L_14 ) ;
if ( V_33 < 0 )
return V_33 ;
...
const struct V_267 * V_114 )
{
const struct V_258 * V_259 = V_26 -> V_265 . V_268 ;
struct V_1 * V_7 ;
struct V_5 * V_5 ;
int V_11 , V_33 ;
if ( V_259 == NULL ) {
F_104 ( & V_26 -> V_265 , L_16 ) ;
return - V_58 ;
}
if ( V_259 -> V_54 == 0 ) {
F_104 ( & V_26 -> V_265 , L_17 ) ;
return - V_58 ;
}
V_5 = F_105 ( & V_26 -> V_265 , sizeof( * V_5 ) , V_269 ) ;
if ( ! V_5 )
return - V_270 ;
F_106 ( & V_5 -> V_169 ) ;
V_5 -> V_54 = V_259 -> V_54 ;
V_5 -> V_134 = V_259 -> V_134 ;
V_5 -> V_157 = V_259 -> V_135 ;
V_5 -> V_165 = V_259 -> V_271 ;
V_5 -> V_74 = V_259 -> V_70 ;
V_5 -> V_72 = V_259 -> V_272 ;
V_7 = & V_5 -> V_7 ;
F_107 ( V_7 , V_26 , & V_273 ) ;
F_108 ( V_7 -> V_240 , V_274 , sizeof( V_7 -> V_240 ) ) ;
V_7 -> V_275 = & V_276 ;
V_7 -> V_34 |= V_277 ;
V_5 -> V_215 . V_34 = V_278 ;
V_7 -> V_279 . type = V_280 ;
V_33 = F_109 ( & V_7 -> V_279 , 1 , & V_5 -> V_215 , 0 ) ;
if ( V_33 )
return V_33 ;
V_33 = F_101 ( V_5 , V_259 ) ;
if ( V_33 )
goto V_281;
for ( V_11 = 0 ; V_11 < V_162 ; V_11 ++ )
V_5 -> V_163 [ V_11 ] . V_282 = V_283 [ V_11 ] ;
V_33 = F_110 ( & V_26 -> V_265 , V_162 ,
V_5 -> V_163 ) ;
if ( V_33 ) {
F_104 ( & V_26 -> V_265 , L_18 ) ;
goto V_281;
}
V_33 = F_88 ( V_5 ) ;
if ( V_33 )
goto V_281;
F_4 ( V_5 ) ;
V_5 -> V_124 . V_14 = V_192 ;
V_5 -> V_124 . V_16 = V_194 ;
V_5 -> V_124 . V_128 = 0 ;
V_5 -> V_124 . V_130 = 0 ;
return 0 ;
V_281:
