...
V_104 = F_12 ( V_39 , V_108 ) ;
if ( V_104 > V_52 ) {
V_59 -> V_109 = - V_110 ;
V_104 = V_52 ;
}
if ( V_104 > 0 ) {
F_21 ( & V_9 -> V_42 [ 0 ] , V_104 , V_105 ) ;
V_59 -> V_106 += V_104 ;
}
V_73 = V_111 ;
...
F_3 ( V_9 -> V_13 , 0 ) ;
F_15 ( V_39 , V_116 , V_73 ) ;
}
static void F_22 ( struct V_9 * V_9 )
{
void T_2 * V_39 = V_9 -> V_103 -> V_39 ;
struct V_71 * V_59 = F_20 ( V_9 ) ;
struct V_58 * V_72 ;
T_3 V_73 = V_117 ;
T_1 * V_118 ;
T_1 V_119 ;
if ( ! V_59 ) {
F_11 ( V_9 -> V_61 , L_19 , F_4 ( V_39 , V_116 ) ) ;
return;
}
V_72 = & V_59 -> V_72 ;
V_118 = ( T_1 * ) V_72 -> V_105 + V_72 -> V_106 ;
V_119 = F_23 ( ( unsigned ) V_120 ,
V_72 -> V_107 - V_72 -> V_106 ) ;
F_6 ( & V_9 -> V_42 [ 0 ] , V_119 , V_118 ) ;
V_72 -> V_106 += V_119 ;
if ( V_119 < V_121
...
V_9 -> V_112 = V_4 ;
F_15 ( V_39 , V_116 , V_111 ) ;
while ( ( F_4 ( V_39 , V_116 )
& V_124 ) != 0 )
F_25 () ;
V_9 -> V_115 = 0 ;
} else
...
return - V_127 ;
F_27 ( & V_9 -> V_64 ) ;
V_125 = V_9 -> V_126 -> V_128 ( & V_9 -> V_21 , V_11 ) ;
F_28 ( & V_9 -> V_64 ) ;
return V_125 ;
}
...
F_3 ( V_12 , 0 ) ;
V_73 = F_4 ( V_39 , V_116 ) ;
V_52 = F_12 ( V_39 , V_108 ) ;
F_11 ( V_9 -> V_61 , L_21 ,
V_73 , V_52 , F_1 ( V_9 -> V_112 ) ) ;
if ( V_73 & V_113 ) {
return V_130 ;
}
if ( V_73 & V_131 ) {
...
F_24 ( V_9 , & V_128 ) ;
V_125 = V_130 ;
if ( F_32 ( V_9 -> V_21 . V_86 == V_136 ) ) {
T_1 V_137 ;
F_33 ( V_138 L_25
L_26 ,
V_139 ) ;
V_137 = F_12 ( V_12 , V_140 ) ;
V_9 -> V_21 . V_86 = ( V_137 & V_141 )
? V_87 : V_142 ;
}
switch ( V_9 -> V_112 ) {
case V_6 :
...
static int
F_35 ( struct V_144 * V_37 , const struct V_145 * V_46 )
{
return - V_47 ;
}
static int F_36 ( struct V_144 * V_146 )
{
return - V_47 ;
}
static int
F_37 ( struct V_144 * V_146 , struct V_58 * V_123 , T_5 V_147 )
{
struct V_36 * V_37 ;
struct V_71 * V_59 ;
struct V_9 * V_9 ;
...
static int F_44 ( struct V_144 * V_37 , struct V_58 * V_59 )
{
return - V_47 ;
}
static int F_45 ( struct V_144 * V_146 , int V_156 )
{
struct V_36 * V_37 ;
struct V_9 * V_9 ;
void T_2 * V_157 , * V_39 ;
