...
return - V_68 ;
V_34 -> V_37 = V_2 ;
V_18 = F_25 ( V_49 , & V_2 -> V_15 , & V_46 , V_52 ) ;
if ( V_18 )
return V_18 ;
V_2 -> V_32 = V_32 ;
V_2 -> V_51 = V_51 ;
...
F_28 ( V_34 , V_60 -> V_31 [ 0 ] , V_60 -> V_84 ) ;
F_29 ( V_34 , & V_2 -> V_50 , V_55 -> V_85 ,
V_55 -> V_86 ) ;
V_34 -> V_87 = V_32 ;
V_34 -> V_88 = V_51 ;
V_34 -> V_89 . V_24 = V_90 ;
...
int V_18 ;
int V_93 = 32 ;
if ( F_41 ( V_57 ) && V_57 -> V_82 . V_83 < ( 2048 * 1024 ) )
V_93 = 16 ;
V_2 = F_42 ( V_57 -> V_49 -> V_49 , sizeof( struct V_1 ) , V_94 ) ;
if ( ! V_2 )
return - V_68 ;
V_57 -> V_2 = V_2 ;
F_43 ( & V_2 -> V_25 ) ;
F_44 ( V_57 -> V_49 , & V_2 -> V_50 , & V_95 ) ;
V_18 = F_45 ( V_57 -> V_49 , & V_2 -> V_50 ,
V_57 -> V_96 , V_97 ) ;
if ( V_18 )
return V_18 ;
V_18 = F_46 ( & V_2 -> V_50 ) ;
...
void F_49 ( struct V_56 * V_57 )
{
if ( ! V_57 -> V_2 )
return;
F_31 ( V_57 -> V_49 , V_57 -> V_2 ) ;
}
