...
static void F_12 ( struct V_10 * V_11 , const void * V_37 ,
int V_38 )
{
F_13 ( & V_11 -> V_39 , L_1 ) ;
F_14 ( V_11 , V_37 ) ;
}
static int F_15 ( struct V_40 * V_26 ,
unsigned V_41 ,
void * V_42 )
{
struct V_10 * V_11 = F_16 ( V_42 ) ;
struct V_16 * V_16 = F_3 ( V_11 ) ;
F_13 ( & V_11 -> V_39 , L_2 ) ;
if ( F_17 ( & V_16 -> V_25 . V_43 ) )
F_12 ( V_11 ,
& V_16 -> V_44 ,
sizeof( V_16 -> V_44 ) ) ;
return 0 ;
}
static int F_18 ( struct V_40 * V_26 ,
unsigned V_41 ,
T_1 V_45 , char * V_46 ,
void * V_42 )
{
...
F_1 ( V_2 , V_22 ,
V_49 -> V_23 . V_4 ) ;
F_13 ( & V_48 -> V_39 , L_3 , V_49 -> V_23 . V_51 ,
V_49 -> V_23 . V_17 ) ;
...
V_2 = F_26 ( V_59 , sizeof( V_59 ) , V_60 ) ;
if ( ! V_2 ) {
F_25 ( & V_48 -> V_39 , L_7 ) ;
return - V_58 ;
}
V_36 = F_19 ( V_48 , V_26 , V_2 ,
V_27 , V_16 ) ;
if ( V_36 ) {
F_25 ( & V_48 -> V_39 , L_8 ) ;
goto V_61;
