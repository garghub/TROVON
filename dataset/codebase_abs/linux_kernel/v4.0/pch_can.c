...
F_27 ( V_77 ) ;
V_83 -> V_121 ++ ;
V_83 -> V_122 += V_79 -> V_123 ;
}
static T_3 F_28 ( int V_124 , void * V_125 )
{
struct V_74 * V_12 = (struct V_74 * ) V_125 ;
struct V_3 * V_4 = F_23 ( V_12 ) ;
if ( ! F_15 ( V_4 ) )
return V_126 ;
F_11 ( V_4 , V_34 ) ;
...
static void F_30 ( struct V_3 * V_4 , int V_129 )
{
if ( V_129 < V_130 ) {
F_2 ( V_46 | V_48 |
...
static void F_31 ( struct V_74 * V_12 , int V_129 )
{
struct V_3 * V_4 = F_23 ( V_12 ) ;
struct V_82 * V_83 = & ( V_4 -> V_12 -> V_83 ) ;
struct V_76 * V_77 ;
...
static int F_32 ( struct V_74 * V_12 , T_2 V_135 , int V_136 )
{
T_2 V_137 ;
T_4 V_138 ;
int V_139 = 0 ;
...
do {
F_2 ( V_42 , & V_4 -> V_8 -> V_43 [ 0 ] . V_44 ) ;
F_8 ( & V_4 -> V_8 -> V_43 [ 0 ] . V_45 , V_135 ) ;
V_137 = F_3 ( & V_4 -> V_8 -> V_43 [ 0 ] . V_49 ) ;
if ( V_137 & V_67 )
break;
if ( V_137 & V_132 ) {
F_31 ( V_12 , V_135 ) ;
...
if ( V_50 & V_141 ) {
V_138 = ( F_3 ( & V_4 -> V_8 -> V_43 [ 0 ] . V_63 ) & 0xffff ) ;
V_138 |= ( ( ( V_50 ) & 0x1fff ) << 16 ) ;
V_79 -> V_88 = V_138 | V_142 ;
} else {
V_138 = ( V_50 >> 2 ) & V_143 ;
V_79 -> V_88 = V_138 ;
}
if ( V_50 & V_69 )
V_79 -> V_88 |= V_144 ;
V_79 -> V_123 = F_34 ( ( F_3 ( & V_4 -> V_8 ->
V_43 [ 0 ] . V_49 ) ) & 0xF ) ;
for ( V_52 = 0 ; V_52 < V_79 -> V_123 ; V_52 += 2 ) {
V_140 = F_35 ( & V_4 -> V_8 -> V_43 [ 0 ] . V_64 [ V_52 / 2 ] ) ;
V_79 -> V_64 [ V_52 ] = V_140 ;
V_79 -> V_64 [ V_52 + 1 ] = V_140 >> 8 ;
}
F_27 ( V_77 ) ;
V_139 ++ ;
V_83 -> V_121 ++ ;
...
static void F_36 ( struct V_74 * V_12 , T_2 V_145 )
{
struct V_3 * V_4 = F_23 ( V_12 ) ;
struct V_82 * V_83 = & ( V_4 -> V_12 -> V_83 ) ;
T_2 V_146 ;
F_37 ( V_12 , V_145 - V_54 - 1 ) ;
F_2 ( V_42 | V_147 ,
& V_4 -> V_8 -> V_43 [ 1 ] . V_44 ) ;
F_8 ( & V_4 -> V_8 -> V_43 [ 1 ] . V_45 , V_145 ) ;
V_146 = F_34 ( F_3 ( & V_4 -> V_8 -> V_43 [ 1 ] . V_49 ) &
V_148 ) ;
V_83 -> V_149 += V_146 ;
V_83 -> V_150 ++ ;
if ( V_145 == V_57 )
...
static int F_39 ( struct V_151 * V_127 , int V_136 )
{
struct V_74 * V_12 = V_127 -> V_152 ;
struct V_3 * V_4 = F_23 ( V_12 ) ;
T_2 V_145 ;
T_2 V_153 ;
int V_154 = V_136 ;
...
if ( V_136 == 0 )
goto V_155;
if ( ( V_145 >= V_53 ) && ( V_145 <= V_54 ) ) {
V_136 -= F_32 ( V_12 , V_145 , V_136 ) ;
} else if ( ( V_145 >= V_56 ) &&
( V_145 <= V_57 ) ) {
F_36 ( V_12 , V_145 ) ;
}
...
{
struct V_3 * V_4 = F_23 ( V_12 ) ;
const struct V_160 * V_161 = & V_4 -> V_16 . V_162 ;
T_2 V_163 ;
T_2 V_164 ;
F_1 ( & V_4 -> V_8 -> V_9 , V_165 ) ;
V_163 = ( V_161 -> V_166 - 1 ) & V_167 ;
V_163 |= ( V_161 -> V_168 - 1 ) << V_169 ;
V_163 |= ( V_161 -> V_170 + V_161 -> V_171 - 1 ) << V_172 ;
V_163 |= ( V_161 -> V_173 - 1 ) << V_174 ;
V_164 = ( ( V_161 -> V_166 - 1 ) & V_175 ) >> V_176 ;
F_2 ( V_163 , & V_4 -> V_8 -> V_177 ) ;
F_2 ( V_164 , & V_4 -> V_8 -> V_178 ) ;
F_4 ( & V_4 -> V_8 -> V_9 , V_165 ) ;
return 0 ;
}
static void F_42 ( struct V_74 * V_12 )
{
struct V_3 * V_4 = F_23 ( V_12 ) ;
if ( V_4 -> V_16 . V_85 != V_179 )
F_21 ( V_4 ) ;
F_41 ( V_12 ) ;
F_7 ( V_4 ) ;
F_14 ( V_4 , 1 ) ;
...
static int F_43 ( struct V_74 * V_12 , enum V_181 V_6 )
{
int V_182 = 0 ;
switch ( V_6 ) {
case V_183 :
...
struct V_3 * V_4 = F_23 ( V_12 ) ;
int V_185 ;
V_185 = F_45 ( V_4 -> V_152 -> V_124 , F_28 , V_186 ,
V_12 -> V_187 , V_12 ) ;
if ( V_185 ) {
F_6 ( V_12 , L_8 ) ;
goto V_188;
...
V_190 = V_4 -> V_192 ;
if ( V_4 -> V_192 == V_57 ) {
if ( F_3 ( & V_4 -> V_8 -> V_193 ) & V_194 )
F_51 ( V_12 ) ;
V_4 -> V_192 = V_56 ;
} else {
V_4 -> V_192 ++ ;
}
F_1 ( & V_4 -> V_8 -> V_43 [ 1 ] . V_44 , V_195 ) ;
if ( V_79 -> V_88 & V_142 ) {
F_2 ( V_79 -> V_88 & 0xffff , & V_4 -> V_8 -> V_43 [ 1 ] . V_63 ) ;
V_50 = ( ( V_79 -> V_88 >> 16 ) & 0x1fff ) | V_141 ;
} else {
F_2 ( 0 , & V_4 -> V_8 -> V_43 [ 1 ] . V_63 ) ;
V_50 = ( V_79 -> V_88 & V_143 ) << 2 ;
}
V_50 |= V_51 ;
if ( ! ( V_79 -> V_88 & V_144 ) )
V_50 |= V_69 ;
...
F_57 ( V_77 , V_12 , V_190 - V_54 - 1 ) ;
F_2 ( V_79 -> V_123 | V_70 | V_72 |
V_40 , & V_4 -> V_8 -> V_43 [ 1 ] . V_49 ) ;
F_8 ( & V_4 -> V_8 -> V_43 [ 1 ] . V_45 , V_190 ) ;
return V_191 ;
}
static void F_58 ( struct V_196 * V_197 )
{
struct V_74 * V_12 = F_59 ( V_197 ) ;
struct V_3 * V_4 = F_23 ( V_12 ) ;
F_60 ( V_4 -> V_12 ) ;
if ( V_4 -> V_198 )
F_61 ( V_4 -> V_152 ) ;
...
static T_2 F_70 ( struct V_3 * V_4 , T_2 V_202 )
{
T_2 V_203 ;
F_2 ( V_42 , & V_4 -> V_8 -> V_43 [ 0 ] . V_44 ) ;
F_8 ( & V_4 -> V_8 -> V_43 [ 0 ] . V_45 , V_202 ) ;
...
{
return ( F_3 ( & V_4 -> V_8 -> V_204 ) & 0xffff ) |
( F_3 ( & V_4 -> V_8 -> V_193 ) << 16 ) ;
}
static int F_72 ( struct V_196 * V_197 , T_7 V_85 )
{
int V_52 ;
int V_185 ;
T_2 V_205 ;
int V_25 = V_26 ;
struct V_74 * V_152 = F_59 ( V_197 ) ;
struct V_3 * V_4 = F_23 ( V_152 ) ;
F_5 ( V_4 , V_11 ) ;
V_4 -> V_16 . V_85 = V_179 ;
while ( V_25 ) {
V_205 = F_71 ( V_4 ) ;
...
F_14 ( V_4 , 0 ) ;
for ( V_52 = V_53 ; V_52 <= V_54 ; V_52 ++ ) {
V_4 -> V_207 [ V_52 - 1 ] = F_68 ( V_4 , V_52 ,
V_55 ) ;
V_4 -> V_208 [ V_52 - 1 ] = F_70 ( V_4 , V_52 ) ;
}
F_13 ( V_4 , 0 ) ;
V_185 = F_74 ( V_197 ) ;
if ( V_185 ) {
F_73 ( & V_197 -> V_152 , L_11 ) ;
} else {
F_75 ( V_197 , V_209 , 0 ) ;
F_63 ( V_197 ) ;
F_76 ( V_197 , F_77 ( V_197 , V_85 ) ) ;
}
return V_185 ;
}
...
F_7 ( V_4 ) ;
for ( V_52 = V_56 ; V_52 <= V_57 ; V_52 ++ )
F_12 ( V_4 , V_52 , V_4 -> V_206 [ V_52 - 1 ] , V_58 ) ;
for ( V_52 = V_53 ; V_52 <= V_54 ; V_52 ++ ) {
F_69 ( V_4 , V_52 , V_4 -> V_208 [ V_52 - 1 ] ) ;
F_12 ( V_4 , V_52 , V_4 -> V_207 [ V_52 - 1 ] , V_55 ) ;
}
F_66 ( V_4 ) ;
F_5 ( V_4 , V_7 ) ;
return V_185 ;
}
static int F_81 ( const struct V_74 * V_152 ,
struct V_211 * V_212 )
{
struct V_3 * V_4 = F_23 ( V_152 ) ;
T_2 V_80 = F_3 ( & V_4 -> V_8 -> V_80 ) ;
V_212 -> V_213 = V_80 & V_98 ;
V_212 -> V_214 = ( V_80 & V_96 ) >> 8 ;
return 0 ;
}
static int F_82 ( struct V_196 * V_197 ,
const struct V_215 * V_138 )
{
struct V_74 * V_12 ;
struct V_3 * V_4 ;
int V_216 ;
...
V_216 = F_80 ( V_197 ) ;
if ( V_216 ) {
F_73 ( & V_197 -> V_152 , L_13 , V_216 ) ;
goto V_217;
}
V_216 = F_83 ( V_197 , V_218 ) ;
if ( V_216 ) {
F_73 ( & V_197 -> V_152 , L_14 , V_216 ) ;
goto V_219;
}
V_1 = F_84 ( V_197 , 1 , 0 ) ;
if ( ! V_1 ) {
V_216 = - V_220 ;
F_73 ( & V_197 -> V_152 , L_15 ) ;
goto V_221;
}
V_12 = F_85 ( sizeof( struct V_3 ) , V_57 ) ;
if ( ! V_12 ) {
V_216 = - V_222 ;
F_73 ( & V_197 -> V_152 , L_16 ) ;
goto V_223;
}
V_4 = F_23 ( V_12 ) ;
V_4 -> V_12 = V_12 ;
V_4 -> V_8 = V_1 ;
V_4 -> V_152 = V_197 ;
V_4 -> V_16 . V_224 = & V_225 ;
V_4 -> V_16 . V_226 = F_43 ;
V_4 -> V_16 . V_227 = F_81 ;
V_4 -> V_16 . V_228 = V_18 |
V_20 ;
V_4 -> V_192 = V_56 ;
V_12 -> V_124 = V_197 -> V_124 ;
V_12 -> V_229 |= V_230 ;
F_86 ( V_197 , V_12 ) ;
F_87 ( V_12 , & V_197 -> V_152 ) ;
V_12 -> V_231 = & V_232 ;
V_4 -> V_16 . clock . V_233 = V_234 ;
F_88 ( V_12 , & V_4 -> V_127 , F_39 , V_54 ) ;
V_216 = F_89 ( V_4 -> V_152 ) ;
if ( V_216 ) {
F_6 ( V_12 , L_17 ) ;
V_4 -> V_198 = 0 ;
} else {
