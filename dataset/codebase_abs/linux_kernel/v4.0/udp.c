...
if ( V_60 -> V_264 )
F_154 ( V_162 , V_80 , sizeof( struct V_90 ) ) ;
V_95 = V_252 ;
if ( V_229 & V_258 )
V_95 = V_164 ;
V_261:
...
if ( V_7 != NULL ) {
int V_233 ;
if ( F_210 ( V_7 ) && V_91 -> V_133 && ! F_88 ( V_7 ) )
F_211 ( V_80 , V_134 , V_91 -> V_133 ,
V_305 ) ;
V_233 = F_177 ( V_7 , V_80 ) ;
F_49 ( V_7 ) ;
if ( V_233 > 0 )
...
if ( F_133 ( V_80 ) )
goto V_281;
F_134 ( V_1 , V_308 , V_295 == V_304 ) ;
F_212 ( V_80 , V_106 , V_309 , 0 ) ;
F_172 ( V_80 ) ;
return 0 ;
V_306:
F_121 ( L_5 ,
...
F_215 ( V_310 , V_87 , V_85 ) ;
const T_9 V_311 = F_216 ( V_86 , V_54 ) ;
F_53 () ;
V_70 = NULL ;
F_44 (sk, node, &hslot2->head) {
if ( F_217 ( V_7 , V_1 , V_310 ,
V_87 , V_85 , V_311 , V_58 ) )
V_70 = V_7 ;
break;
}
if ( V_70 ) {
if ( F_47 ( ! F_48 ( & V_70 -> V_76 , 2 ) ) )
V_70 = NULL ;
else if ( F_47 ( ! F_217 ( V_7 , V_1 , V_310 ,
V_87 , V_85 ,
V_311 , V_58 ) ) ) {
F_49 ( V_70 ) ;
V_70 = NULL ;
...
else if ( V_80 -> V_312 == V_315 )
V_7 = F_214 ( V_1 , V_91 -> V_96 , V_82 -> V_56 ,
V_91 -> V_97 , V_82 -> V_48 , V_58 ) ;
else
return;
if ( ! V_7 )
...
F_223 = F_182 ( V_123 -> F_223 ) ;
if ( F_223 )
F_223 ( V_7 ) ;
}
}
int F_224 ( struct V_6 * V_7 , int V_318 , int V_319 ,
char V_247 * V_320 , unsigned int V_205 ,
int (* F_225)( struct V_6 * ) )
{
struct V_122 * V_123 = F_7 ( V_7 ) ;
int V_321 , V_322 ;
int V_95 = 0 ;
...
if ( V_205 < sizeof( int ) )
return - V_185 ;
if ( F_226 ( V_321 , ( int V_247 * ) V_320 ) )
return - V_323 ;
V_322 = V_321 ? 1 : 0 ;
switch ( V_319 ) {
case V_324 :
...
return F_224 ( V_7 , V_318 , V_319 , V_320 , V_205 ,
F_94 ) ;
return F_228 ( V_7 , V_318 , V_319 , V_320 , V_205 ) ;
}
int F_229 ( struct V_6 * V_7 , int V_318 , int V_319 ,
char V_247 * V_320 , unsigned int V_205 )
{
if ( V_318 == V_341 || V_318 == V_342 )
return F_224 ( V_7 , V_318 , V_319 , V_320 , V_205 ,
F_94 ) ;
return F_230 ( V_7 , V_318 , V_319 , V_320 , V_205 ) ;
}
int F_231 ( struct V_6 * V_7 , int V_318 , int V_319 ,
char V_247 * V_320 , int V_247 * V_205 )
{
struct V_122 * V_123 = F_7 ( V_7 ) ;
int V_321 , V_125 ;
if ( F_226 ( V_125 , V_205 ) )
return - V_323 ;
V_125 = F_232 (unsigned int, len, sizeof(int)) ;
if ( V_125 < 0 )
return - V_185 ;
switch ( V_319 ) {
case V_324 :
...
{
if ( V_318 == V_341 || V_318 == V_342 )
return F_231 ( V_7 , V_318 , V_319 , V_320 , V_205 ) ;
return F_235 ( V_7 , V_318 , V_319 , V_320 , V_205 ) ;
}
int F_236 ( struct V_6 * V_7 , int V_318 , int V_319 ,
char V_247 * V_320 , int V_247 * V_205 )
{
if ( V_318 == V_341 || V_318 == V_342 )
return F_231 ( V_7 , V_318 , V_319 , V_320 , V_205 ) ;
return F_237 ( V_7 , V_318 , V_319 , V_320 , V_205 ) ;
}
unsigned int F_238 ( struct V_343 * V_343 , struct V_344 * V_6 , T_10 * V_345 )
{
unsigned int V_32 = F_239 ( V_343 , V_6 , V_345 ) ;
...
static struct V_6 * F_241 ( struct V_352 * V_353 , int V_354 )
{
struct V_6 * V_7 ;
struct V_355 * V_356 = V_353 -> V_357 ;
struct V_1 * V_1 = F_242 ( V_353 ) ;
for ( V_356 -> V_358 = V_354 ; V_356 -> V_358 <= V_356 -> V_22 -> V_32 ;
++ V_356 -> V_358 ) {
struct V_10 * V_11 ;
struct V_3 * V_4 = & V_356 -> V_22 -> V_74 [ V_356 -> V_358 ] ;
if ( F_243 ( & V_4 -> V_42 ) )
continue;
F_21 ( & V_4 -> V_19 ) ;
...
static struct V_6 * F_244 ( struct V_352 * V_353 , struct V_6 * V_7 )
{
struct V_355 * V_356 = V_353 -> V_357 ;
struct V_1 * V_1 = F_242 ( V_353 ) ;
do {
V_7 = F_245 ( V_7 ) ;
} while ( V_7 && ( ! F_5 ( F_6 ( V_7 ) , V_1 ) || V_7 -> V_61 != V_356 -> V_359 ) );
if ( ! V_7 ) {
if ( V_356 -> V_358 <= V_356 -> V_22 -> V_32 )
F_24 ( & V_356 -> V_22 -> V_74 [ V_356 -> V_358 ] . V_19 ) ;
return F_241 ( V_353 , V_356 -> V_358 + 1 ) ;
}
return V_7 ;
}
static struct V_6 * F_246 ( struct V_352 * V_353 , T_11 V_360 )
{
struct V_6 * V_7 = F_241 ( V_353 , 0 ) ;
if ( V_7 )
while ( V_360 && ( V_7 = F_244 ( V_353 , V_7 ) ) != NULL )
-- V_360 ;
return V_360 ? NULL : V_7 ;
}
static void * F_247 ( struct V_352 * V_353 , T_11 * V_360 )
{
struct V_355 * V_356 = V_353 -> V_357 ;
V_356 -> V_358 = V_361 ;
return * V_360 ? F_246 ( V_353 , * V_360 - 1 ) : V_362 ;
}
static void * F_248 ( struct V_352 * V_353 , void * V_363 , T_11 * V_360 )
{
struct V_6 * V_7 ;
if ( V_363 == V_362 )
V_7 = F_246 ( V_353 , 0 ) ;
else
V_7 = F_244 ( V_353 , V_363 ) ;
++ * V_360 ;
return V_7 ;
}
static void F_249 ( struct V_352 * V_353 , void * V_363 )
{
struct V_355 * V_356 = V_353 -> V_357 ;
if ( V_356 -> V_358 <= V_356 -> V_22 -> V_32 )
F_24 ( & V_356 -> V_22 -> V_74 [ V_356 -> V_358 ] . V_19 ) ;
}
int F_250 ( struct V_364 * V_364 , struct V_343 * V_343 )
{
struct V_365 * V_366 = F_251 ( V_364 ) ;
struct V_355 * V_367 ;
int V_95 ;
V_95 = F_252 ( V_364 , V_343 , & V_366 -> V_368 ,
sizeof( struct V_355 ) ) ;
if ( V_95 < 0 )
return V_95 ;
...
int F_253 ( struct V_1 * V_1 , struct V_365 * V_366 )
{
struct V_370 * V_371 ;
int V_274 = 0 ;
V_366 -> V_368 . V_354 = F_247 ;
V_366 -> V_368 . V_372 = F_248 ;
V_366 -> V_368 . V_373 = F_249 ;
V_371 = F_254 ( V_366 -> V_374 , V_375 , V_1 -> V_376 ,
V_366 -> V_377 , V_366 ) ;
if ( ! V_371 )
V_274 = - V_275 ;
return V_274 ;
}
void F_255 ( struct V_1 * V_1 , struct V_365 * V_366 )
{
F_256 ( V_366 -> V_374 , V_1 -> V_376 ) ;
}
static void F_257 ( struct V_6 * V_378 , struct V_352 * V_379 ,
int V_358 )
{
struct V_44 * V_60 = F_26 ( V_378 ) ;
T_3 V_96 = V_60 -> V_63 ;
T_3 V_126 = V_60 -> V_47 ;
T_1 V_380 = F_51 ( V_60 -> V_64 ) ;
T_1 V_381 = F_51 ( V_60 -> V_147 ) ;
F_258 ( V_379 , L_9
L_10 ,
V_358 , V_126 , V_381 , V_96 , V_380 , V_378 -> V_117 ,
F_143 ( V_378 ) ,
F_259 ( V_378 ) ,
0 , 0L , 0 ,
F_260 ( F_261 ( V_379 ) , F_3 ( V_378 ) ) ,
0 , F_262 ( V_378 ) ,
F_263 ( & V_378 -> V_76 ) , V_378 ,
F_263 ( & V_378 -> V_241 ) ) ;
}
int F_264 ( struct V_352 * V_353 , void * V_363 )
{
F_265 ( V_353 , 127 ) ;
if ( V_363 == V_362 )
F_266 ( V_353 , L_11
...
struct V_355 * V_356 = V_353 -> V_357 ;
F_257 ( V_363 , V_353 , V_356 -> V_358 ) ;
}
F_267 ( V_353 , '\n' ) ;
return 0 ;
}
static int T_12 F_268 ( struct V_1 * V_1 )
{
return F_253 ( V_1 , & V_382 ) ;
}
static void T_13 F_269 ( struct V_1 * V_1 )
{
F_255 ( V_1 , & V_382 ) ;
}
int T_14 F_270 ( void )
...
static int T_14 F_274 ( char * V_384 )
{
T_15 V_233 ;
if ( ! V_384 )
return 0 ;
V_233 = F_275 ( V_384 , 0 , & V_385 ) ;
if ( V_233 )
return 0 ;
...
void T_14 F_276 ( struct V_22 * V_387 , const char * V_374 )
{
unsigned int V_289 ;
V_387 -> V_74 = F_277 ( V_374 ,
2 * sizeof( struct V_3 ) ,
V_385 ,
21 ,
0 ,
...
V_386 ,
64 * 1024 ) ;
V_387 -> V_77 = V_387 -> V_74 + ( V_387 -> V_32 + 1 ) ;
for ( V_289 = 0 ; V_289 <= V_387 -> V_32 ; V_289 ++ ) {
F_278 ( & V_387 -> V_74 [ V_289 ] . V_42 , V_289 ) ;
V_387 -> V_74 [ V_289 ] . V_35 = 0 ;
F_279 ( & V_387 -> V_74 [ V_289 ] . V_19 ) ;
}
for ( V_289 = 0 ; V_289 <= V_387 -> V_32 ; V_289 ++ ) {
F_278 ( & V_387 -> V_77 [ V_289 ] . V_42 , V_289 ) ;
V_387 -> V_77 [ V_289 ] . V_35 = 0 ;
F_279 ( & V_387 -> V_77 [ V_289 ] . V_19 ) ;
}
}
