...
F_44 ( V_10 -> V_96 ) ;
if ( ! V_57 -> V_97 )
F_43 ( V_95 , L_29 , V_10 -> V_38 ) ;
else
F_45 ( (struct V_1 * ) V_57 -> V_97 , V_95 ) ;
F_43 ( V_95 , L_30 , V_10 -> V_38 ) ;
for ( V_6 = (struct V_1 * ) V_57 -> V_98 ; V_6 ; V_6 = (struct V_1 * ) V_6 -> V_99 )
F_45 ( V_6 , V_95 ) ;
F_43 ( V_95 , L_31 , V_10 -> V_38 ) ;
...
{
F_43 ( V_95 , L_32 , V_2 -> V_101 -> V_102 -> V_38 , V_2 -> V_101 -> V_103 , V_2 -> V_101 -> V_104 ) ;
F_47 ( V_95 , L_33 ) ;
F_48 ( V_2 -> V_105 , V_95 ) ;
}
static void F_48 ( unsigned char * V_106 , struct V_94 * V_95 )
{
int V_25 , V_107 ;
F_49 ( V_106 [ 0 ] , V_95 ) ;
for ( V_25 = 1 , V_107 = F_50 ( V_106 [ 0 ] ) ; V_25 < V_107 ; ++ V_25 )
F_43 ( V_95 , L_34 , V_106 [ V_25 ] ) ;
F_51 ( V_95 , '\n' ) ;
}
static void F_49 ( int V_108 , struct V_94 * V_95 )
{
F_43 ( V_95 , L_35 , V_108 , V_108 ) ;
}
static int F_52 ( struct V_9 * V_10 , int V_87 )
{
F_7 () ;
int V_25 , V_109 ;
unsigned long V_58 ;
...
static int F_58 ( struct V_1 * V_2 , void (* F_59) ( struct V_1 * ) )
{
...
F_61 ( V_135 , L_42 , V_10 -> V_38 , ( V_2 -> V_105 [ 0 ] == V_134 ) ? L_43 : L_44 ) ;
F_19 ( & V_57 -> V_60 , 0 ) ;
return 0 ;
}
T_1 F_62 ( int V_136 , void * V_62 )
{
F_7 () ;
...
F_59 = 0 ;
F_61 ( V_137 , L_46 , V_10 -> V_38 ) ;
F_64 ( V_10 ) ;
( void ) F_9 ( V_141 ) ;
} else if ( V_22 & V_142 ) {
F_61 ( V_137 , L_47 , V_10 -> V_38 ) ;
( void ) F_9 ( V_141 ) ;
} else if ( ( F_9 ( V_27 ) & V_143 ) == V_143 ) {
F_61 ( V_137 , L_48 , V_10 -> V_38 ) ;
( void ) F_9 ( V_141 ) ;
} else {
#if F_29 ( F_32 )
...
int V_147 ;
if ( ! V_57 -> V_97 )
F_65 ( L_49 , V_10 -> V_148 ) ;
V_147 = ( V_57 -> V_116 - F_66 ( V_10 ) ) ;
...
#else
F_61 ( V_137 , L_50 , V_22 , F_9 ( V_28 ) , F_9 ( V_27 ) ) ;
( void ) F_9 ( V_141 ) ;
#endif
}
}
...
static int F_68 ( struct V_9 * V_10 , struct V_1 * V_2 )
{
F_7 () ;
struct V_56 * V_57 = (struct V_56 * ) V_10 -> V_57 ;
...
V_57 -> V_155 = 0 ;
F_39 ( V_156 , V_10 ) ;
F_61 ( V_156 , L_51 , V_10 -> V_38 , V_10 -> V_86 ) ;
F_23 ( V_69 , 0 ) ;
F_23 ( V_72 , V_57 -> V_71 ) ;
F_23 ( V_28 , V_157 ) ;
F_46 ( V_10 -> V_96 ) ;
...
F_23 ( V_28 , V_121 ) ;
F_23 ( V_29 , V_73 ) ;
F_61 ( V_156 , L_55 , V_10 -> V_38 ) ;
goto V_160;
}
F_69 ( 2 ) ;
F_61 ( V_156 , L_56 , V_10 -> V_38 ) ;
F_23 ( V_72 , ( V_57 -> V_71 | ( 1 << F_70 ( V_2 ) ) ) ) ;
...
F_69 ( 1 ) ;
F_61 ( V_164 , L_57 , V_10 -> V_38 , F_70 ( V_2 ) ) ;
V_58 = V_17 + ( 250 * V_67 / 1000 ) ;
V_57 -> V_165 = 0 ;
V_57 -> V_153 = V_2 ;
V_154:
...
V_2 -> V_133 ( V_2 ) ;
F_23 ( V_70 , V_57 -> V_71 ) ;
F_61 ( V_164 , L_61 , V_10 -> V_38 ) ;
F_23 ( V_70 , V_57 -> V_71 ) ;
return 0 ;
}
V_57 -> V_117 |= ( 1 << F_70 ( V_2 ) ) ;
F_46 ( V_10 -> V_96 ) ;
...
F_61 ( V_164 , L_63 , V_10 -> V_38 , V_2 -> V_101 -> V_103 ) ;
V_128 [ 0 ] = F_71 ( ( ( V_10 -> V_61 == V_68 ) ? 0 : 1 ) , V_2 -> V_101 -> V_104 ) ;
V_151 = 1 ;
V_2 -> V_167 = 0 ;
V_21 = V_128 ;
V_150 = V_168 ;
F_72 ( V_10 , & V_150 , & V_151 , & V_21 ) ;
F_61 ( V_164 , L_64 , V_10 -> V_38 ) ;
V_57 -> V_97 = V_2 ;
...
static int F_72 ( struct V_9 * V_10 , unsigned char * V_150 , int * V_169 , unsigned char * * V_21 ) {
F_7 () ;
...
F_8 ( V_10 ) ;
if ( ! ( V_170 & V_140 ) )
F_61 ( V_174 , L_65 , V_10 -> V_38 , V_171 ) ;
else
F_61 ( V_174 , L_66 , V_10 -> V_38 , V_171 ) ;
F_23 ( V_69 , F_73 ( V_170 ) ) ;
...
F_61 ( V_178 , L_67 , V_10 -> V_38 ) ;
if ( ( V_128 & V_42 ) != V_170 ) {
F_61 ( V_178 , L_68 , V_10 -> V_38 ) ;
F_40 ( V_178 , V_10 ) ;
break;
}
if ( ! ( V_170 & V_140 ) )
...
F_61 ( V_174 , L_70 , V_10 -> V_38 , V_171 ) ;
* V_169 = V_171 ;
* V_21 = V_172 ;
V_128 = F_9 ( V_27 ) ;
if ( V_128 & V_37 )
...
static void F_55 ( struct V_9 * V_102 ) {
F_7 () ;
F_8 ( V_102 ) ;
F_23 ( V_69 , F_73 ( F_9 ( V_27 ) & V_42 ) ) ;
F_23 ( V_29 , V_73 | V_182 ) ;
F_69 ( 25 ) ;
F_23 ( V_29 , V_73 ) ;
}
static int F_54 ( struct V_9 * V_102 ) {
F_7 () ;
...
V_151 = 1 ;
V_150 = V_168 ;
F_72 ( V_102 , & V_150 , & V_151 , & V_183 ) ;
return V_151 ? - 1 : 0 ;
}
static int F_74 ( struct V_9 * V_10 , unsigned char * V_150 , int * V_169 , unsigned char * * V_21 ) {
F_7 () ;
...
#endif
F_61 ( V_191 , L_71 , V_10 -> V_38 , V_10 -> V_192 , ( V_170 & V_140 ) ? L_72 : L_73 , V_171 , ( V_170 & V_140 ) ? L_74 : L_75 , ( unsigned ) V_172 ) ;
V_57 -> V_193 = ( V_170 & V_140 ) ? F_76 ( V_10 , V_172 , V_171 ) : F_77 ( V_10 , V_172 , V_171 ) ;
#endif
F_23 ( V_69 , F_73 ( V_170 ) ) ;
#ifdef F_32
...
F_23 ( V_28 , V_121 | V_194 ) ;
#endif
F_61 ( V_191 , L_76 , V_10 -> V_38 , F_9 ( V_28 ) ) ;
if ( V_170 & V_140 ) {
F_78 ( 1 ) ;
F_23 ( V_199 , 0 ) ;
} else {
...
F_61 ( V_191 , L_77 , V_10 -> V_38 , V_128 , F_9 ( V_27 ) ) ;
F_23 ( V_28 , V_121 ) ;
F_23 ( V_29 , V_73 ) ;
V_190 = F_66 ( V_10 ) ;
V_171 -= V_190 ;
...
F_61 ( V_191 , L_80 , V_186 , * V_21 ) ;
F_72 ( V_10 , V_150 , & V_186 , V_21 ) ;
* V_169 -= V_187 - V_186 ;
}
#endif
F_61 ( V_191 , L_81 , * V_21 , * V_169 , * ( * V_21 + * V_169 - 1 ) , * ( * V_21 + * V_169 ) ) ;
return 0 ;
#elif F_29 ( F_32 )
return 0 ;
#else
if ( V_170 & V_140 ) {
#ifdef F_79
V_185 = F_80 ( V_10 , V_172 , V_171 ) ;
#else
int V_204 = 1 ;
if ( V_57 -> V_87 & V_88 ) {
V_204 = 0 ;
}
if ( ! ( V_185 = F_80 ( V_10 , V_172 , V_171 - V_204 ) ) ) {
if ( ! ( V_57 -> V_87 & V_88 ) ) {
...
#else
int V_58 ;
F_61 ( V_207 , L_82 , V_171 ) ;
if ( ! ( V_185 = F_81 ( V_10 , V_172 , V_171 ) ) ) {
if ( ! ( V_57 -> V_87 & V_119 ) ) {
V_58 = 20000 ;
while ( ! ( F_9 ( V_30 ) & V_205 ) && ( F_9 ( V_30 ) & V_146 ) ) ;
if ( ! V_58 )
F_61 ( V_208 , L_83 , V_10 -> V_38 ) ;
if ( V_57 -> V_87 & V_120 ) {
V_57 -> V_87 &= ~ V_120 ;
if ( F_9 ( V_69 ) & V_209 ) {
V_57 -> V_87 |= V_119 ;
F_61 ( V_208 , L_84 , V_10 -> V_38 ) ;
}
}
} else {
F_61 ( V_207 , L_85 ) ;
...
V_57 -> V_97 = V_128 ;
F_61 ( V_214 , L_93 , V_10 -> V_38 , V_128 -> V_101 -> V_103 , V_128 -> V_101 -> V_104 , V_128 -> V_167 ) ;
}
}
static void F_83 ( T_4 * V_10 ) {
F_7 () ;
struct V_56 * V_57 = (struct V_56 * ) V_10 -> V_57 ;
int V_147 ;
F_8 ( V_10 ) ;
...
F_38 ( V_10 ) ;
F_8 ( V_10 ) ;
F_61 ( V_216 , L_95 , V_10 -> V_38 ) ;
F_61 ( V_216 , L_96 , F_9 ( V_30 ) , F_9 ( V_27 ) ) ;
#if 0
...
#endif
if ( V_57 -> V_97 ) {
F_61 ( V_216 , L_100 , V_10 -> V_38 ) ;
return V_219 ;
}
for ( V_128 = (struct V_1 * ) V_57 -> V_100 ; V_128 ; V_128 = (struct V_1 * ) V_128 -> V_99 )
if ( V_2 == V_128 ) {
F_61 ( V_216 , L_101 , V_10 -> V_38 ) ;
if ( F_68 ( V_10 , V_2 ) )
return V_219 ;
F_61 ( V_216 , L_102 , V_10 -> V_38 ) ;
F_54 ( V_10 ) ;
