...
int F_115 ( struct V_49 * V_49 , int V_185 ,
...
static void F_119 ( struct V_28 * V_29 , struct V_200 * V_35 ,
struct V_50 * V_20 )
{
...
F_121 (t, n, thead, hash_node)
if ( ! F_59 ( F_60 ( V_13 -> V_40 ) , V_49 ) )
F_113 ( V_13 -> V_40 , V_35 ) ;
}
}
void F_122 ( struct V_28 * V_29 , struct V_50 * V_20 )
{
F_123 ( V_209 ) ;
F_117 () ;
F_119 ( V_29 , & V_209 , V_20 ) ;
F_124 ( & V_209 ) ;
F_118 () ;
}
int F_125 ( struct V_48 * V_40 , struct V_210 * V_211 [] ,
struct V_22 * V_23 )
{
struct V_12 * V_87 ;
...
int F_127 ( struct V_48 * V_40 , struct V_210 * V_211 [] ,
struct V_22 * V_23 )
{
struct V_12 * V_13 ;
struct V_12 * V_52 = F_22 ( V_40 ) ;
...
int F_128 ( struct V_48 * V_40 )
{
struct V_12 * V_52 = F_22 ( V_40 ) ;
struct V_73 * V_38 = & V_52 -> V_37 . V_38 ;
int V_51 ;
V_40 -> V_215 = F_109 ;
V_40 -> V_94 = F_129 ( struct V_93 ) ;
if ( ! V_40 -> V_94 )
return - V_61 ;
V_52 -> V_14 = F_130 ( struct V_6 ) ;
if ( ! V_52 -> V_14 ) {
F_111 ( V_40 -> V_94 ) ;
return - V_61 ;
}
V_51 = F_131 ( & V_52 -> V_114 , V_40 ) ;
if ( V_51 ) {
F_111 ( V_52 -> V_14 ) ;
F_111 ( V_40 -> V_94 ) ;
return V_51 ;
...
void F_133 ( struct V_48 * V_40 , int V_218 )
{
struct V_12 * V_52 = F_22 ( V_40 ) ;
V_52 -> V_185 = V_218 ;
}
