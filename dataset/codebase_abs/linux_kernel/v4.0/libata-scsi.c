...
if ( V_155 & 0x40 ) F_58 ( L_6 ) ;
if ( V_155 & 0x20 ) F_58 ( L_7 ) ;
if ( V_155 & 0x10 ) F_58 ( L_8 ) ;
if ( V_155 & 0x08 ) F_58 ( L_9 ) ;
if ( V_155 & 0x04 ) F_58 ( L_10 ) ;
if ( V_155 & 0x02 ) F_58 ( L_11 ) ;
if ( V_155 & 0x01 ) F_58 ( L_12 ) ;
F_58 ( L_13 ) ;
if ( V_157 ) {
F_58 ( V_159 L_14 , V_93 , V_157 ) ;
if ( V_157 & 0x04 ) F_58 ( L_15 ) ;
if ( V_157 & 0x80 ) {
if ( V_157 & 0x04 ) F_58 ( L_16 ) ;
else F_58 ( L_17 ) ;
}
if ( V_157 & 0x40 ) F_58 ( L_18 ) ;
if ( V_157 & 0x10 ) F_58 ( L_19 ) ;
if ( V_157 & 0x02 ) F_58 ( L_20 ) ;
if ( V_157 & 0x01 ) F_58 ( L_21 ) ;
F_58 ( L_13 ) ;
}
}
}
static void F_59 ( unsigned V_93 , T_3 V_161 , T_3 V_162 , T_3 * V_58 ,
T_3 * V_59 , T_3 * V_60 , int V_163 )
{
int V_164 ;
static const unsigned char V_165 [] [ 4 ] = {
{ 0xd1 , V_166 , 0x00 , 0x00 } ,
{ 0xd0 , V_166 , 0x00 , 0x00 } ,
{ 0x61 , V_167 , 0x00 , 0x00 } ,
{ 0x84 , V_166 , 0x47 , 0x00 } ,
{ 0x37 , V_168 , 0x04 , 0x00 } ,
{ 0x09 , V_168 , 0x04 , 0x00 } ,
{ 0x01 , V_169 , 0x13 , 0x00 } ,
{ 0x02 , V_167 , 0x00 , 0x00 } ,
{ 0x08 , V_168 , 0x04 , 0x00 } ,
{ 0x10 , V_79 , 0x21 , 0x00 } ,
{ 0x20 , V_170 , 0x28 , 0x00 } ,
{ 0x40 , V_169 , 0x11 , 0x04 } ,
{ 0x80 , V_169 , 0x11 , 0x04 } ,
{ 0xFF , 0xFF , 0xFF , 0xFF } ,
} ;
static const unsigned char V_171 [] [ 4 ] = {
{ 0x80 , V_166 , 0x47 , 0x00 } ,
{ 0x20 , V_167 , 0x44 , 0x00 } ,
{ 0x08 , V_166 , 0x47 , 0x00 } ,
...
if ( V_162 ) {
for ( V_164 = 0 ; V_165 [ V_164 ] [ 0 ] != 0xFF ; V_164 ++ ) {
if ( ( V_165 [ V_164 ] [ 0 ] & V_162 ) ==
V_165 [ V_164 ] [ 0 ] ) {
* V_58 = V_165 [ V_164 ] [ 1 ] ;
* V_59 = V_165 [ V_164 ] [ 2 ] ;
* V_60 = V_165 [ V_164 ] [ 3 ] ;
...
for ( V_164 = 0 ; V_171 [ V_164 ] [ 0 ] != 0xFF ; V_164 ++ ) {
if ( V_171 [ V_164 ] [ 0 ] & V_161 ) {
* V_58 = V_171 [ V_164 ] [ 1 ] ;
* V_59 = V_171 [ V_164 ] [ 2 ] ;
* V_60 = V_171 [ V_164 ] [ 3 ] ;
goto V_172;
...
F_58 ( V_173 L_22
L_23 ,
V_93 , V_161 , V_162 , * V_58 , * V_59 , * V_60 ) ;
return;
}
static void F_60 ( struct V_139 * V_140 )
{
struct V_56 * V_57 = V_140 -> V_143 ;
struct V_153 * V_154 = & V_140 -> V_174 ;
unsigned char * V_175 = V_57 -> V_64 ;
unsigned char * V_121 = V_175 + 8 ;
int V_163 = V_140 -> V_9 -> V_65 -> V_176 == NULL ;
memset ( V_175 , 0 , V_111 ) ;
V_57 -> V_61 = ( V_62 << 24 ) | V_63 ;
if ( V_140 -> V_177 ||
V_154 -> V_156 & ( V_160 | V_178 | V_179 | V_180 ) ) {
F_59 ( V_140 -> V_9 -> V_181 , V_154 -> V_156 , V_154 -> V_158 ,
& V_175 [ 1 ] , & V_175 [ 2 ] , & V_175 [ 3 ] , V_163 ) ;
V_175 [ 1 ] &= 0x0f ;
} else {
V_175 [ 1 ] = V_125 ;
V_175 [ 2 ] = 0 ;
...
static int F_64 ( struct V_141 * V_197 )
{
if ( F_65 ( V_197 -> V_198 != V_199 ) )
return 0 ;
if ( ! F_66 ( V_197 ) || ( V_197 -> V_200 & V_201 ) )
return 0 ;
return F_67 ( V_197 -> V_57 [ 0 ] ) == V_202 ;
}
static int F_68 ( struct V_28 * V_29 ,
struct V_12 * V_13 )
{
struct V_203 * V_204 = V_29 -> V_203 ;
if ( ! F_69 ( V_13 -> V_93 ) )
V_13 -> V_16 |= V_37 ;
F_70 ( V_204 , V_13 -> V_205 ) ;
if ( V_13 -> V_49 == V_206 ) {
void * V_4 ;
V_29 -> V_207 = V_114 ;
F_71 ( V_204 , V_208 - 1 ) ;
V_4 = F_41 ( V_209 , V_204 -> V_210 | V_115 ) ;
if ( ! V_4 ) {
F_72 ( V_13 , L_24 ) ;
return - V_113 ;
}
F_73 ( V_204 , F_64 , V_4 , V_209 ) ;
} else {
V_29 -> V_207 = F_74 ( V_13 -> V_93 ) ;
V_29 -> V_211 = 1 ;
}
if ( V_29 -> V_207 > V_27 )
F_75 ( V_13 ,
L_25 ,
V_29 -> V_207 ) ;
F_76 ( V_204 , V_29 -> V_207 - 1 ) ;
if ( V_13 -> V_16 & V_212 )
F_77 ( V_213 , V_29 -> V_214 ) ;
if ( V_13 -> V_16 & V_215 ) {
int V_216 ;
V_216 = F_78 ( V_29 -> V_34 -> V_217 , F_79 ( V_13 -> V_93 ) ) ;
V_216 = F_78 ( V_218 - 1 , V_216 ) ;
F_80 ( V_29 , V_216 ) ;
}
F_81 ( V_204 , false ) ;
V_13 -> V_29 = V_29 ;
...
F_5 ( V_9 -> V_21 , V_16 ) ;
V_13 -> V_16 &= ~ V_223 ;
if ( V_222 == 1 || ! F_87 ( V_13 ) ) {
V_13 -> V_16 |= V_223 ;
V_222 = 1 ;
}
F_9 ( V_9 -> V_21 , V_16 ) ;
V_222 = F_78 ( V_222 , V_29 -> V_34 -> V_217 ) ;
V_222 = F_78 ( V_222 , F_79 ( V_13 -> V_93 ) ) ;
V_222 = F_78 ( V_222 , V_218 - 1 ) ;
if ( V_29 -> V_222 == V_222 )
return - V_20 ;
return F_80 ( V_29 , V_222 ) ;
}
int F_88 ( struct V_28 * V_29 , int V_222 )
{
struct V_8 * V_9 = F_3 ( V_29 -> V_34 ) ;
return F_85 ( V_9 , V_29 , V_222 ) ;
}
static unsigned int F_89 ( struct V_139 * V_140 )
{
struct V_56 * V_149 = V_140 -> V_143 ;
struct V_153 * V_154 = & V_140 -> V_154 ;
const T_3 * V_224 = V_149 -> V_225 ;
if ( V_149 -> V_226 < 5 )
goto V_227;
V_154 -> V_16 |= V_228 | V_229 ;
V_154 -> V_230 = V_231 ;
if ( V_224 [ 1 ] & 0x1 ) {
;
}
...
if ( ( V_140 -> V_9 -> V_16 & V_236 ) &&
V_237 == V_238 )
goto V_239;
if ( ( V_140 -> V_9 -> V_16 & V_240 ) &&
F_90 () )
goto V_239;
V_154 -> V_156 = V_241 ;
}
...
static void F_92 ( const T_3 * V_224 , T_7 * V_247 , T_8 * V_248 )
{
T_7 V_249 = 0 ;
T_8 V_45 ;
F_93 ( L_26 ) ;
V_249 |= ( ( T_7 ) ( V_224 [ 1 ] & 0x1f ) ) << 16 ;
V_249 |= ( ( T_7 ) V_224 [ 2 ] ) << 8 ;
V_249 |= ( ( T_7 ) V_224 [ 3 ] ) ;
V_45 = V_224 [ 4 ] ;
* V_247 = V_249 ;
...
static void F_94 ( const T_3 * V_224 , T_7 * V_247 , T_8 * V_248 )
{
T_7 V_249 = 0 ;
T_8 V_45 = 0 ;
F_93 ( L_27 ) ;
V_249 |= ( ( T_7 ) V_224 [ 2 ] ) << 24 ;
V_249 |= ( ( T_7 ) V_224 [ 3 ] ) << 16 ;
V_249 |= ( ( T_7 ) V_224 [ 4 ] ) << 8 ;
V_249 |= ( ( T_7 ) V_224 [ 5 ] ) ;
V_45 |= ( ( T_8 ) V_224 [ 7 ] ) << 8 ;
V_45 |= ( ( T_8 ) V_224 [ 8 ] ) ;
...
static void F_95 ( const T_3 * V_224 , T_7 * V_247 , T_8 * V_248 )
{
T_7 V_249 = 0 ;
T_8 V_45 = 0 ;
F_93 ( L_28 ) ;
V_249 |= ( ( T_7 ) V_224 [ 2 ] ) << 56 ;
V_249 |= ( ( T_7 ) V_224 [ 3 ] ) << 48 ;
V_249 |= ( ( T_7 ) V_224 [ 4 ] ) << 40 ;
V_249 |= ( ( T_7 ) V_224 [ 5 ] ) << 32 ;
V_249 |= ( ( T_7 ) V_224 [ 6 ] ) << 24 ;
V_249 |= ( ( T_7 ) V_224 [ 7 ] ) << 16 ;
V_249 |= ( ( T_7 ) V_224 [ 8 ] ) << 8 ;
V_249 |= ( ( T_7 ) V_224 [ 9 ] ) ;
V_45 |= ( ( T_8 ) V_224 [ 10 ] ) << 24 ;
V_45 |= ( ( T_8 ) V_224 [ 11 ] ) << 16 ;
V_45 |= ( ( T_8 ) V_224 [ 12 ] ) << 8 ;
V_45 |= ( ( T_8 ) V_224 [ 13 ] ) ;
* V_247 = V_249 ;
* V_248 = V_45 ;
...
struct V_153 * V_154 = & V_140 -> V_154 ;
struct V_12 * V_13 = V_140 -> V_13 ;
T_7 V_250 = V_140 -> V_13 -> V_85 ;
const T_3 * V_224 = V_149 -> V_225 ;
T_7 V_191 ;
T_8 V_251 ;
V_154 -> V_16 |= V_229 | V_228 ;
V_154 -> V_230 = V_231 ;
if ( V_224 [ 0 ] == V_252 ) {
if ( V_149 -> V_226 < 10 )
goto V_227;
F_94 ( V_224 , & V_191 , & V_251 ) ;
} else if ( V_224 [ 0 ] == V_253 ) {
if ( V_149 -> V_226 < 16 )
goto V_227;
F_95 ( V_224 , & V_191 , & V_251 ) ;
} else
goto V_227;
if ( ! V_251 )
goto V_254;
if ( V_191 >= V_250 )
goto V_255;
if ( ( V_191 + V_251 ) > V_250 )
goto V_255;
if ( V_13 -> V_16 & V_232 ) {
V_154 -> V_16 |= V_233 ;
if ( F_97 ( V_191 , V_251 ) ) {
V_154 -> V_156 = V_235 ;
V_154 -> V_1 |= ( V_191 >> 24 ) & 0xf ;
} else if ( F_98 ( V_191 , V_251 ) ) {
if ( ! ( V_13 -> V_16 & V_256 ) )
goto V_255;
V_154 -> V_16 |= V_186 ;
V_154 -> V_156 = V_257 ;
V_154 -> V_187 = ( V_251 >> 8 ) & 0xff ;
V_154 -> V_190 = ( V_191 >> 40 ) & 0xff ;
V_154 -> V_189 = ( V_191 >> 32 ) & 0xff ;
V_154 -> V_188 = ( V_191 >> 24 ) & 0xff ;
} else
goto V_255;
V_154 -> V_182 = V_251 & 0xff ;
V_154 -> V_185 = ( V_191 >> 16 ) & 0xff ;
V_154 -> V_184 = ( V_191 >> 8 ) & 0xff ;
V_154 -> V_183 = V_191 & 0xff ;
V_154 -> V_1 |= V_234 ;
} else {
T_8 V_258 , V_259 , V_260 , V_261 ;
if ( ! F_97 ( V_191 , V_251 ) )
goto V_255;
V_261 = ( T_8 ) V_191 / V_13 -> V_262 ;
V_260 = V_261 / V_13 -> V_263 ;
V_259 = V_261 % V_13 -> V_263 ;
V_258 = ( T_8 ) V_191 % V_13 -> V_262 + 1 ;
F_99 ( L_29 ,
( T_8 ) V_191 , V_261 , V_260 , V_259 , V_258 ) ;
if ( ( V_260 >> 16 ) || ( V_259 >> 4 ) || ( V_258 >> 8 ) || ( ! V_258 ) )
goto V_255;
V_154 -> V_156 = V_235 ;
V_154 -> V_182 = V_251 & 0xff ;
V_154 -> V_183 = V_258 ;
...
T_8 V_251 ;
int V_33 ;
if ( V_224 [ 0 ] == V_265 || V_224 [ 0 ] == V_266 || V_224 [ 0 ] == V_267 )
V_264 |= V_268 ;
switch ( V_224 [ 0 ] ) {
case V_269 :
case V_265 :
if ( F_19 ( V_149 -> V_226 < 10 ) )
goto V_227;
F_94 ( V_224 , & V_191 , & V_251 ) ;
if ( V_224 [ 1 ] & ( 1 << 3 ) )
V_264 |= V_270 ;
...
case V_271 :
case V_266 :
if ( F_19 ( V_149 -> V_226 < 6 ) )
goto V_227;
F_92 ( V_224 , & V_191 , & V_251 ) ;
if ( ! V_251 )
V_251 = 256 ;
break;
case V_272 :
case V_267 :
if ( F_19 ( V_149 -> V_226 < 16 ) )
goto V_227;
F_95 ( V_224 , & V_191 , & V_251 ) ;
if ( V_224 [ 1 ] & ( 1 << 3 ) )
V_264 |= V_270 ;
...
goto V_254;
V_140 -> V_16 |= V_246 ;
V_140 -> V_152 = V_251 * V_149 -> V_1 -> V_207 ;
V_33 = F_101 ( & V_140 -> V_154 , V_140 -> V_13 , V_191 , V_251 , V_264 ,
V_140 -> V_142 ) ;
if ( F_65 ( V_33 == 0 ) )
return 0 ;
if ( V_33 == - V_273 )
...
struct V_56 * V_57 = V_140 -> V_143 ;
T_3 * V_224 = V_57 -> V_225 ;
int V_274 = ( V_140 -> V_177 != 0 ) ;
if ( ( ( V_224 [ 0 ] == V_118 ) || ( V_224 [ 0 ] == V_275 ) ) &&
( ( V_224 [ 2 ] & 0x20 ) || V_274 ) ) {
F_60 ( V_140 ) ;
} else {
if ( ! V_274 ) {
...
if ( V_274 && ! V_9 -> V_65 -> V_176 )
F_57 ( V_9 -> V_181 , & V_140 -> V_174 ) ;
V_140 -> V_144 ( V_57 ) ;
F_103 ( V_140 ) ;
}
...
T_3 * V_143 = args -> V_57 -> V_225 , * V_323 = V_296 ;
const T_3 V_324 [] = {
0 , 0 , 0 , 0 ,
0 ,
0 , 0x2 , 0x0
...
V_330 = 0 ;
if ( F_136 ( args -> V_93 ) && ( V_13 -> V_16 & V_256 ) &&
...
{
if ( V_140 -> V_177 && ( ( V_140 -> V_177 & V_346 ) == 0 ) ) {
F_60 ( V_140 ) ;
}
...
#ifdef F_148
if ( V_9 -> V_65 -> V_347 )
V_9 -> V_65 -> V_347 ( V_9 , & V_140 -> V_154 ) ;
#endif
V_57 -> V_64 [ 0 ] = 0x70 ;
...
V_140 -> V_281 = V_116 ;
memset ( & V_140 -> V_224 , 0 , V_140 -> V_13 -> V_349 ) ;
V_140 -> V_224 [ 0 ] = V_350 ;
V_140 -> V_224 [ 4 ] = V_111 ;
V_140 -> V_154 . V_16 |= V_229 | V_228 ;
V_140 -> V_154 . V_156 = V_351 ;
if ( F_146 ( V_9 ) ) {
V_140 -> V_154 . V_230 = V_352 ;
V_140 -> V_154 . V_158 |= V_353 ;
} else {
V_140 -> V_154 . V_230 = V_354 ;
V_140 -> V_154 . V_184 = V_111 ;
V_140 -> V_154 . V_185 = 0 ;
}
V_140 -> V_152 = V_111 ;
V_140 -> V_282 = F_145 ;
...
{
struct V_56 * V_57 = V_140 -> V_143 ;
unsigned int V_177 = V_140 -> V_177 ;
F_93 ( L_46 , V_177 ) ;
if ( F_19 ( V_140 -> V_9 -> V_65 -> V_176 &&
( V_177 || V_140 -> V_16 & V_355 ) ) ) {
if ( ! ( V_140 -> V_16 & V_355 ) ) {
F_60 ( V_140 ) ;
}
if ( V_140 -> V_224 [ 0 ] == V_356 && V_140 -> V_13 -> V_29 )
...
T_3 * V_143 = V_57 -> V_225 ;
if ( ( V_143 [ 0 ] == V_358 ) && ( ( V_143 [ 1 ] & 0x03 ) == 0 ) ) {
unsigned long V_16 ;
T_3 * V_4 ;
...
struct V_56 * V_149 = V_140 -> V_143 ;
struct V_12 * V_13 = V_140 -> V_13 ;
int V_359 = ( V_149 -> V_278 == V_117 ) ;
int V_360 = ! V_359 && ( V_13 -> V_16 & V_338 ) ;
unsigned int V_152 ;
memset ( V_140 -> V_224 , 0 , V_13 -> V_349 ) ;
memcpy ( V_140 -> V_224 , V_149 -> V_225 , V_149 -> V_226 ) ;
V_140 -> V_282 = F_151 ;
V_140 -> V_154 . V_16 |= V_229 | V_228 ;
if ( V_149 -> V_278 == V_279 ) {
V_140 -> V_154 . V_16 |= V_268 ;
F_99 ( L_47 ) ;
}
V_140 -> V_154 . V_156 = V_351 ;
F_55 ( V_140 ) ;
...
if ( V_152 & 0x1 )
V_152 ++ ;
V_140 -> V_154 . V_184 = ( V_152 & 0xFF ) ;
V_140 -> V_154 . V_185 = ( V_152 >> 8 ) ;
if ( V_359 )
V_140 -> V_154 . V_230 = V_361 ;
else if ( V_360 )
V_140 -> V_154 . V_230 = V_354 ;
else {
V_140 -> V_154 . V_230 = V_352 ;
...
struct V_12 * V_13 = V_140 -> V_13 ;
const T_3 * V_224 = V_149 -> V_225 ;
if ( ( V_154 -> V_230 = F_158 ( V_224 [ 1 ] ) ) == V_371 )
goto V_227;
if ( V_224 [ 0 ] == V_118 ) {
if ( V_224 [ 1 ] & 0x01 ) {
V_154 -> V_372 = V_224 [ 3 ] ;
...
V_154 -> V_182 = V_224 [ 6 ] ;
V_154 -> V_183 = V_224 [ 8 ] ;
V_154 -> V_184 = V_224 [ 10 ] ;
V_154 -> V_185 = V_224 [ 12 ] ;
V_154 -> V_1 = V_224 [ 13 ] ;
V_154 -> V_156 = V_224 [ 14 ] ;
} else {
V_154 -> V_16 &= ~ V_186 ;
V_154 -> V_158 = V_224 [ 3 ] ;
V_154 -> V_182 = V_224 [ 4 ] ;
...
V_154 -> V_1 = V_13 -> V_43 ?
V_154 -> V_1 | V_373 : V_154 -> V_1 & ~ V_373 ;
switch ( V_154 -> V_156 ) {
case V_374 :
case V_375 :
case V_376 :
case V_377 :
if ( V_154 -> V_230 != V_370 || V_154 -> V_182 != 1 )
goto V_227;
V_140 -> V_378 = F_56 ( V_149 ) ;
break;
case V_379 :
case V_380 :
case V_381 :
...
F_55 ( V_140 ) ;
if ( V_154 -> V_230 == V_369 && V_13 -> V_407 == 0 )
goto V_227;
if ( ( V_224 [ 1 ] & 0xe0 ) && ! F_160 ( V_154 ) )
goto V_227;
if ( F_160 ( V_154 ) ) {
unsigned int V_339 = 1 << ( V_224 [ 1 ] >> 5 ) ;
if ( V_339 != V_13 -> V_339 )
F_75 ( V_13 , L_48 ,
V_339 ) ;
}
if ( V_154 -> V_156 == V_408 &&
V_154 -> V_158 == V_409 )
goto V_227;
if ( V_154 -> V_156 >= 0x5C && V_154 -> V_156 <= 0x5F && ! V_410 )
goto V_227;
return 0 ;
V_227:
...
V_411 = F_164 ( V_4 , 512 , V_191 , V_251 ) ;
if ( F_87 ( V_13 ) && F_165 ( V_13 ) ) {
V_154 -> V_230 = V_412 ;
V_154 -> V_156 = V_413 ;
V_154 -> V_187 = V_414 & 0x1f ;
V_154 -> V_182 = V_140 -> V_142 << 3 ;
V_154 -> V_372 = ( V_411 / 512 ) >> 8 ;
V_154 -> V_158 = V_411 / 512 ;
V_154 -> V_415 = 1 ;
} else {
V_154 -> V_230 = V_369 ;
V_154 -> V_372 = 0 ;
V_154 -> V_158 = V_416 ;
V_154 -> V_187 = ( V_411 / 512 ) >> 8 ;
V_154 -> V_182 = V_411 / 512 ;
V_154 -> V_156 = V_417 ;
}
V_154 -> V_16 |= V_229 | V_228 | V_186 |
V_268 ;
F_55 ( V_140 ) ;
return 0 ;
V_227:
...
if ( V_149 -> V_226 < 9 )
goto V_227;
V_45 = ( V_224 [ 7 ] << 8 ) + V_224 [ 8 ] ;
V_424 = 8 ;
}
if ( ( V_224 [ 1 ] & 0x11 ) != 0x10 )
goto V_227;
if ( ! F_54 ( V_149 ) || F_53 ( V_149 ) -> V_427 < V_45 )
goto V_428;
V_323 = F_162 ( F_163 ( F_53 ( V_149 ) ) ) ;
if ( V_45 < V_424 )
goto V_428;
if ( V_329 )
V_425 = V_323 [ 3 ] ;
...
struct V_12 * V_13 )
{
T_3 V_434 = V_149 -> V_225 [ 0 ] ;
T_9 V_276 ;
int V_33 = 0 ;
if ( V_13 -> V_49 == V_50 || V_13 -> V_49 == V_51 ) {
if ( F_19 ( ! V_149 -> V_226 || V_149 -> V_226 > V_13 -> V_349 ) )
goto V_435;
...
if ( F_19 ( V_45 > V_149 -> V_226 || V_45 > V_13 -> V_349 ) )
goto V_435;
V_276 = F_152 ;
} else {
if ( F_19 ( V_149 -> V_226 > 16 ) )
...
if ( V_276 )
V_33 = F_104 ( V_13 , V_149 , V_276 ) ;
else
F_174 ( V_13 , V_149 ) ;
return V_33 ;
V_435:
F_99 ( L_50 ,
V_149 -> V_226 , V_434 , V_13 -> V_349 ) ;
V_149 -> V_61 = V_286 << 16 ;
V_149 -> V_80 ( V_149 ) ;
return 0 ;
}
...
{
int V_164 , V_33 ;
for ( V_164 = 0 ; V_164 < V_34 -> V_454 ; V_164 ++ ) {
struct V_8 * V_9 = V_34 -> V_455 [ V_164 ] ;
struct V_6 * V_7 ;
V_33 = - V_113 ;
...
V_7 -> V_195 = 1 ;
V_7 -> V_467 = 1 ;
if ( F_179 ( V_7 , V_34 -> V_468 ) )
goto V_469;
V_33 = F_180 ( V_9 -> V_459 ,
& V_9 -> V_470 , V_9 -> V_34 -> V_13 ) ;
if ( V_33 )
goto V_469;
}
return 0 ;
V_469:
F_181 ( V_34 -> V_455 [ V_164 ] -> V_459 ) ;
V_456:
while ( -- V_164 >= 0 ) {
struct V_6 * V_7 = V_34 -> V_455 [ V_164 ] -> V_459 ;
F_182 ( V_7 ) ;
F_181 ( V_7 ) ;
}
return V_33 ;
}
void F_183 ( struct V_8 * V_9 , int V_471 )
{
int V_472 = 5 ;
...
V_366 = V_11 -> V_475 ;
V_29 = F_185 ( V_9 -> V_459 , V_366 , V_93 , 0 ,
NULL ) ;
if ( ! F_186 ( V_29 ) ) {
V_13 -> V_29 = V_29 ;
F_187 ( V_29 ) ;
...
F_190 ( V_477 , & V_9 -> V_478 ,
F_191 ( V_120 ) ) ;
}
int F_192 ( struct V_12 * V_13 )
{
if ( V_13 -> V_29 ) {
F_193 ( V_13 -> V_29 , V_479 ) ;
return 1 ;
}
return 0 ;
}
...
{
if ( V_13 -> V_29 )
F_205 ( V_13 -> V_29 , V_213 ,
V_483 ) ;
}
void F_206 ( struct V_484 * V_485 )
{
struct V_8 * V_9 =
F_207 ( V_485 , struct V_8 , V_478 . V_485 ) ;
int V_164 ;
if ( V_9 -> V_39 & V_486 ) {
F_99 ( L_53 ) ;
return;
...
F_201 ( & V_9 -> V_11 ) ;
if ( V_9 -> V_365 )
for ( V_164 = 0 ; V_164 < V_489 ; V_164 ++ )
F_201 ( & V_9 -> V_365 [ V_164 ] ) ;
F_183 ( V_9 , 0 ) ;
F_198 ( & V_9 -> V_488 ) ;
F_99 ( L_33 ) ;
}
int F_209 ( struct V_6 * V_7 , unsigned int V_366 ,
...
if ( ! V_9 -> V_65 -> V_176 )
return - V_24 ;
if ( V_367 != V_490 && V_367 )
return - V_20 ;
if ( ! F_156 ( V_9 ) ) {
if ( V_366 != V_490 && V_366 )
return - V_20 ;
V_43 = V_93 ;
} else {
if ( V_93 != V_490 && V_93 )
...
if ( V_13 ) {
struct V_491 * V_492 = & V_13 -> V_11 -> V_52 ;
V_492 -> V_493 |= 1 << V_13 -> V_43 ;
V_492 -> V_88 |= V_89 ;
} else
V_33 = - V_20 ;
}
...
void F_210 ( struct V_484 * V_485 )
{
struct V_8 * V_9 =
F_207 ( V_485 , struct V_8 , V_495 ) ;
struct V_10 * V_11 ;
struct V_12 * V_13 ;
unsigned long V_16 ;
F_195 ( & V_9 -> V_488 ) ;
...
struct V_8 * F_212 ( struct V_451 * V_34 ,
struct V_496 * V_497 ,
struct V_6 * V_7 )
{
struct V_8 * V_9 ;
...
V_9 -> V_498 = 0 ;
V_9 -> V_21 = & V_34 -> V_21 ;
V_9 -> V_499 = V_497 -> V_499 ;
V_9 -> V_500 = V_497 -> V_500 ;
V_9 -> V_501 = V_497 -> V_501 ;
V_9 -> V_16 |= V_497 -> V_16 ;
V_9 -> V_65 = V_497 -> V_502 ;
V_9 -> V_503 = V_504 ;
return V_9 ;
}
...
{
int V_33 = V_9 -> V_65 -> V_506 ( V_9 ) ;
if ( V_33 )
return V_33 ;
V_9 -> V_181 = F_221 ( & V_507 ) ;
return 0 ;
}
...
{
unsigned int V_509 = V_9 -> V_34 -> V_468 ;
unsigned int V_164 , V_142 ;
for ( V_164 = 0 , V_142 = V_9 -> V_510 + 1 ; V_164 < V_509 ; V_164 ++ , V_142 ++ ) {
if ( V_9 -> V_16 & V_511 )
V_142 = 1 ;
else
V_142 = V_142 < V_509 ? V_142 : 0 ;
if ( V_142 == V_512 )
continue;
if ( ! F_226 ( V_142 , & V_9 -> V_513 ) ) {
V_9 -> V_510 = V_142 ;
return V_142 ;
}
}
