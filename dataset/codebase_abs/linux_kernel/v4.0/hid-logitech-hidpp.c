...
struct V_122 * V_122 , bool V_123 )
{
struct V_124 * V_125 = V_17 -> V_126 ;
if ( ( V_17 -> V_118 & V_119 ) && V_123 )
return;
F_37 ( V_127 , V_122 -> V_128 ) ;
F_37 ( V_129 , V_122 -> V_128 ) ;
F_38 ( V_130 , V_122 -> V_128 ) ;
F_38 ( V_131 , V_122 -> V_128 ) ;
F_39 ( V_122 , V_132 , 0 , V_125 -> V_81 , 0 , 0 ) ;
F_40 ( V_122 , V_132 , V_125 -> V_133 ) ;
F_39 ( V_122 , V_134 , 0 , V_125 -> V_82 , 0 , 0 ) ;
F_40 ( V_122 , V_134 , V_125 -> V_133 ) ;
F_39 ( V_122 , V_135 , 0 , 50 , 0 , 0 ) ;
F_41 ( V_122 , V_129 , V_136 ) ;
if ( V_17 -> V_118 & V_137 )
F_41 ( V_122 , V_129 , V_138 ) ;
else
F_37 ( V_139 , V_122 -> V_140 ) ;
F_42 ( V_122 , V_125 -> V_85 , V_141 |
V_142 ) ;
V_125 -> V_143 = V_122 ;
}
...
{
int V_145 ;
if ( ! V_144 -> V_102 || V_144 -> V_98 )
return;
V_145 = F_44 ( V_125 -> V_143 , V_144 -> V_102 ) ;
F_45 ( V_125 -> V_143 , V_145 ) ;
F_46 ( V_125 -> V_143 , V_146 ,
V_144 -> V_99 ) ;
if ( V_144 -> V_99 ) {
F_47 ( V_125 -> V_143 , V_127 , V_132 ,
V_144 -> V_96 ) ;
F_47 ( V_125 -> V_143 , V_127 , V_134 ,
V_125 -> V_147 ? V_125 -> V_82 - V_144 -> V_97 :
V_144 -> V_97 ) ;
F_47 ( V_125 -> V_143 , V_127 , V_135 ,
V_144 -> V_101 ) ;
}
}
...
F_43 ( V_125 , & ( V_148 -> V_109 [ V_72 ] ) ) ;
if ( V_148 -> V_105 &&
! ( V_17 -> V_118 & V_137 ) )
F_47 ( V_125 -> V_143 , V_129 , V_136 , V_148 -> V_108 ) ;
if ( V_148 -> V_105 || V_148 -> V_107 <= 2 ) {
F_49 ( V_125 -> V_143 ) ;
F_50 ( V_125 -> V_143 ) ;
}
}
static int F_51 ( struct V_16 * V_17 , V_13 * V_91 )
{
struct V_124 * V_125 = V_17 -> V_126 ;
V_13 V_149 = ( ( V_91 [ 7 ] & 0xf ) * ( V_91 [ 7 ] & 0xf ) +
( V_91 [ 7 ] >> 4 ) * ( V_91 [ 7 ] >> 4 ) ) / 2 ;
V_13 V_150 = ( ( V_91 [ 13 ] & 0xf ) * ( V_91 [ 13 ] & 0xf ) +
...
static int F_53 ( struct V_1 * V_2 , V_13 * V_91 , int V_152 )
{
struct V_16 * V_17 = F_35 ( V_2 ) ;
struct V_124 * V_125 = V_17 -> V_126 ;
struct V_3 * V_47 = (struct V_3 * ) V_91 ;
struct V_103 V_148 ;
if ( ! V_125 || ! V_125 -> V_143 )
return 1 ;
switch ( V_91 [ 0 ] ) {
case 0x02 :
if ( V_152 < 2 ) {
...
if ( V_17 -> V_118 & V_137 ) {
F_47 ( V_125 -> V_143 , V_129 , V_136 ,
! ! ( V_91 [ 1 ] & 0x01 ) ) ;
F_47 ( V_125 -> V_143 , V_129 , V_138 ,
! ! ( V_91 [ 1 ] & 0x02 ) ) ;
F_50 ( V_125 -> V_143 ) ;
return 0 ;
} else {
if ( V_152 < 21 )
return 1 ;
return F_51 ( V_17 , & V_91 [ 7 ] ) ;
}
case V_9 :
if ( ( V_47 -> V_32 . V_33 != V_125 -> V_153 ) ||
( V_47 -> V_32 . V_36 != V_154 ) )
return 1 ;
F_33 ( V_17 , V_91 + 4 , & V_148 ) ;
F_48 ( V_17 , & V_148 ) ;
return 0 ;
}
return 0 ;
...
if ( V_5 )
return V_5 ;
V_5 = F_29 ( V_17 , V_125 -> V_153 ,
& V_79 ) ;
if ( V_5 )
return V_5 ;
V_125 -> V_81 = V_79 . V_81 ;
V_125 -> V_82 = V_79 . V_82 ;
V_125 -> V_85 = V_79 . V_85 ;
V_125 -> V_147 = V_79 . V_86 == V_156 ;
V_125 -> V_133 = V_79 . V_87 ;
if ( ! V_125 -> V_133 )
V_125 -> V_133 = V_157 ;
return 0 ;
}
static int F_55 ( struct V_1 * V_2 , const struct V_158 * V_159 )
{
struct V_16 * V_17 = F_35 ( V_2 ) ;
struct V_124 * V_125 ;
V_125 = F_56 ( & V_2 -> V_160 , sizeof( struct V_124 ) ,
V_39 ) ;
if ( ! V_125 )
return - V_40 ;
V_17 -> V_126 = V_125 ;
...
static int F_57 ( struct V_1 * V_2 , bool V_161 )
{
struct V_16 * V_17 = F_35 ( V_2 ) ;
struct V_124 * V_125 = V_17 -> V_126 ;
int V_5 ;
...
struct V_122 * V_143 , bool V_123 )
{
if ( V_17 -> V_118 & V_162 )
F_36 ( V_17 , V_143 , V_123 ) ;
}
static void F_60 ( struct V_1 * V_2 ,
struct V_110 * V_163 )
{
struct V_16 * V_17 = F_35 ( V_2 ) ;
struct V_122 * V_143 = V_163 -> V_143 ;
F_59 ( V_17 , V_143 , true ) ;
}
...
static int F_67 ( struct V_1 * V_2 , struct V_165 * V_47 ,
V_13 * V_91 , int V_152 )
{
struct V_16 * V_17 = F_35 ( V_2 ) ;
int V_5 = 0 ;
...
return V_5 ;
if ( V_17 -> V_118 & V_162 )
return F_53 ( V_2 , V_91 , V_152 ) ;
return 0 ;
}
static void F_68 ( struct V_1 * V_2 , bool V_166 )
{
struct V_16 * V_17 = F_35 ( V_2 ) ;
char * V_48 ;
if ( V_166 )
...
static int F_69 ( struct V_122 * V_160 )
{
struct V_1 * V_167 = F_70 ( V_160 ) ;
return F_71 ( V_167 ) ;
}
static void F_72 ( struct V_122 * V_160 )
{
struct V_1 * V_167 = F_70 ( V_160 ) ;
F_73 ( V_167 ) ;
}
static struct V_122 * F_74 ( struct V_1 * V_2 )
{
struct V_122 * V_122 = F_75 ( & V_2 -> V_160 ) ;
struct V_16 * V_17 = F_35 ( V_2 ) ;
if ( ! V_122 )
return NULL ;
F_76 ( V_122 , V_2 ) ;
V_122 -> V_168 = F_69 ;
V_122 -> V_169 = F_72 ;
V_122 -> V_48 = V_17 -> V_48 ;
V_122 -> V_170 = V_2 -> V_170 ;
V_122 -> V_171 = V_2 -> V_171 ;
V_122 -> V_159 . V_172 = V_2 -> V_173 ;
V_122 -> V_159 . V_174 = V_2 -> V_174 ;
V_122 -> V_159 . V_175 = V_2 -> V_175 ;
V_122 -> V_159 . V_176 = V_2 -> V_176 ;
V_122 -> V_160 . V_177 = & V_2 -> V_160 ;
return V_122 ;
}
...
V_178 = F_79 ( & V_2 -> V_160 , V_39 , L_14 , V_48 ) ;
F_10 ( V_48 ) ;
if ( ! V_178 )
return;
V_17 -> V_48 = V_178 ;
...
F_59 ( V_17 , V_143 , false ) ;
V_5 = F_80 ( V_143 ) ;
if ( V_5 )
F_81 ( V_143 ) ;
V_17 -> V_179 = V_143 ;
}
static int F_82 ( struct V_1 * V_2 , const struct V_158 * V_159 )
{
struct V_16 * V_17 ;
int V_5 ;
bool V_161 ;
unsigned int V_180 = V_181 ;
V_17 = F_56 ( & V_2 -> V_160 , sizeof( struct V_16 ) ,
V_39 ) ;
if ( ! V_17 )
return - V_40 ;
V_17 -> V_23 = V_2 ;
...
F_68 ( V_2 , V_159 -> V_185 == V_186 ) ;
F_65 ( & V_17 -> V_161 , V_161 ) ;
if ( V_161 && ( V_17 -> V_118 & V_162 ) ) {
V_5 = F_54 ( V_17 ) ;
if ( V_5 )
goto V_184;
}
