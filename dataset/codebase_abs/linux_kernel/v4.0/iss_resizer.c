...
V_160 . V_101 = 1 ;
V_160 . V_82 = 1 ;
F_30 ( V_2 , V_153 , V_171 -> V_154 , & V_160 ,
V_157 ) ;
...
V_160 . V_154 = V_70 ;
V_160 . V_156 = V_153 ? V_157 : V_182 ;
V_160 . V_160 . V_76 = V_77 ;
V_160 . V_160 . V_101 = 4096 ;
V_160 . V_160 . V_82 = 4096 ;
F_36 ( V_138 , V_153 , & V_160 ) ;
return 0 ;
}
static int F_39 ( struct V_183 * V_124 ,
const struct V_184 * V_185 ,
const struct V_184 * V_186 , T_2 V_187 )
{
struct V_137 * V_138 = F_40 ( V_124 ) ;
struct V_1 * V_2 = F_22 ( V_138 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
switch ( V_185 -> V_168 | F_41 ( V_186 -> V_124 ) ) {
case V_70 | V_188 :
if ( ! ( V_187 & V_189 ) ) {
V_2 -> V_90 = V_190 ;
break;
...
if ( V_2 -> V_90 != V_190 )
return - V_191 ;
if ( V_186 -> V_124 == & V_4 -> V_192 . V_123 . V_124 )
V_2 -> V_90 = V_91 ;
else if ( V_186 -> V_124 == & V_4 -> V_193 . V_123 . V_124 )
V_2 -> V_90 = V_194 ;
break;
case V_71 | V_195 :
if ( V_187 & V_189 ) {
...
struct V_184 * V_196 = V_2 -> V_196 ;
struct V_183 * V_197 = & V_138 -> V_124 ;
int V_139 ;
V_2 -> V_90 = V_190 ;
F_43 ( V_138 , & V_198 ) ;
V_138 -> V_199 = & V_200 ;
...
F_45 ( V_138 , V_2 ) ;
V_138 -> V_187 |= V_203 ;
V_196 [ V_70 ] . V_187 = V_204 ;
V_196 [ V_71 ] . V_187 = V_205 ;
V_197 -> V_206 = & V_207 ;
V_139 = F_46 ( V_197 , V_208 , V_196 , 0 ) ;
if ( V_139 < 0 )
return V_139 ;
F_38 ( V_138 , NULL ) ;
V_2 -> V_80 . type = V_209 ;
...
V_2 -> V_80 . V_211 = F_47 ( 4096 * 4096 ) * 3 ;
V_2 -> V_80 . V_212 = 32 ;
V_2 -> V_80 . V_213 = 1 ;
...
{
int V_139 ;
V_139 = F_55 ( V_216 , & V_2 -> V_123 ) ;
if ( V_139 < 0 )
goto error;
V_139 = F_56 ( & V_2 -> V_80 , V_216 ) ;
if ( V_139 < 0 )
goto error;
return 0 ;
error:
