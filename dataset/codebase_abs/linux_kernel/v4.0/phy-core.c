...
struct V_4 * F_49 ( struct V_19 * V_35 , const char * V_7 )
{
struct V_4 * V_4 = NULL ;
int V_36 = 0 ;
if ( V_7 )
V_36 = F_50 ( V_35 , L_7 , V_7 ) ;
V_4 = F_43 ( V_35 , V_36 ) ;
if ( F_45 ( V_4 ) )
return V_4 ;
...
void F_53 ( struct V_1 * V_2 , struct V_4 * V_4 )
{
int V_41 ;
if ( ! V_4 )
return;
V_41 = F_54 ( V_2 , F_1 , F_7 , V_4 ) ;
F_55 ( V_2 , V_41 , L_8 ) ;
}
struct V_4 * F_56 ( struct V_1 * V_2 , struct V_37
* args )
{
struct V_4 * V_4 ;
struct V_42 V_43 ;
F_57 ( & V_43 , V_44 , NULL , NULL ) ;
while ( ( V_2 = F_58 ( & V_43 ) ) ) {
V_4 = F_59 ( V_2 ) ;
...
struct V_4 * F_61 ( struct V_1 * V_2 , const char * string )
{
int V_36 = 0 ;
struct V_4 * V_4 ;
if ( string == NULL ) {
...
{
struct V_4 * V_4 = F_61 ( V_2 , string ) ;
if ( F_64 ( V_4 ) == - V_18 )
V_4 = NULL ;
return V_4 ;
}
...
{
struct V_4 * * V_45 , * V_4 ;
V_45 = F_66 ( F_1 , sizeof( * V_45 ) , V_12 ) ;
if ( ! V_45 )
return F_19 ( - V_13 ) ;
V_4 = F_61 ( V_2 , string ) ;
if ( ! F_45 ( V_4 ) ) {
...
struct V_4 * F_70 ( struct V_1 * V_2 , struct V_19 * V_35 ,
const char * V_7 )
{
struct V_4 * * V_45 , * V_4 ;
V_45 = F_66 ( F_1 , sizeof( * V_45 ) , V_12 ) ;
...
struct V_4 * F_71 ( struct V_1 * V_2 , struct V_19 * V_15 ,
...
if ( ! V_4 )
return F_19 ( - V_13 ) ;
V_47 = F_73 ( & V_48 , 0 , 0 , V_12 ) ;
if ( V_47 < 0 ) {
F_37 ( V_2 , L_10 ) ;
V_23 = V_47 ;
goto V_49;
}
V_4 -> V_31 = F_74 ( V_2 , L_11 ) ;
if ( F_45 ( V_4 -> V_31 ) ) {
if ( F_64 ( V_4 -> V_31 ) == - V_22 ) {
V_23 = - V_22 ;
goto V_50;
}
V_4 -> V_31 = NULL ;
...
V_4 -> V_47 = V_47 ;
V_4 -> V_28 = V_28 ;
V_23 = F_77 ( & V_4 -> V_2 , L_12 , F_18 ( V_2 ) , V_47 ) ;
if ( V_23 )
goto V_53;
V_23 = F_78 ( & V_4 -> V_2 ) ;
if ( V_23 )
...
struct V_4 * F_82 ( struct V_1 * V_2 , struct V_19 * V_15 ,
const struct V_46 * V_28 )
{
struct V_4 * * V_45 , * V_4 ;
V_45 = F_66 ( F_5 , sizeof( * V_45 ) , V_12 ) ;
if ( ! V_45 )
return F_19 ( - V_13 ) ;
V_4 = F_71 ( V_2 , V_15 , V_28 ) ;
if ( ! F_45 ( V_4 ) ) {
* V_45 = V_4 ;
F_67 ( V_2 , V_45 ) ;
} else {
...
void F_85 ( struct V_1 * V_2 , struct V_4 * V_4 )
{
int V_41 ;
V_41 = F_54 ( V_2 , F_5 , F_7 , V_4 ) ;
F_55 ( V_2 , V_41 , L_8 ) ;
}
