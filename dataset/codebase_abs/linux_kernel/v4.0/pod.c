...
return sprintf ( V_8 , L_1 , V_2 -> V_30 ) ;
}
...
static T_1 F_12 ( struct V_24 * V_25 ,
struct V_26 * V_27 , char * V_8 )
{
struct V_28 * V_29 = F_9 ( V_25 ) ;
struct V_1 * V_2 = F_10 ( V_29 ) ;
...
{
struct V_1 * V_2 =
F_19 ( V_41 , struct V_1 , V_39 ) ;
struct V_7 * V_5 = & V_2 -> V_5 ;
F_14 ( V_2 -> V_31 , V_42 ) ;
F_20 ( & V_2 -> V_5 , & V_2 -> V_30 ) ;
F_21 ( V_5 -> V_43 ) ;
}
...
static void F_26 ( struct V_7 * V_5 )
{
struct V_1 * V_2 = (struct V_1 * ) V_5 ;
F_27 ( & V_2 -> V_33 ) ;
F_28 ( & V_2 -> V_39 ) ;
}
static int F_29 ( struct V_7 * V_5 ,
...
const struct V_56 * V_57 )
{
return F_38 ( V_29 , V_57 , L_4 ,
& V_68 [ V_57 -> V_69 ] ,
F_29 , sizeof( struct V_1 ) ) ;
}
