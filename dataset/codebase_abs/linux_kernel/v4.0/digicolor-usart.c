...
V_14 -> V_2 . V_48 = F_57 ( V_113 , 0 ) ;
if ( F_58 ( V_14 -> V_2 . V_48 ) )
return V_14 -> V_2 . V_48 ;
V_14 -> V_2 . V_129 = V_130 ;
V_14 -> V_2 . V_80 = F_59 ( V_122 ) ;
V_14 -> V_2 . V_131 = 16 ;
...
F_61 ( V_113 , & V_14 -> V_2 ) ;
F_62 ( & V_14 -> V_15 , F_8 ) ;
V_118 = F_63 ( & V_113 -> V_116 , V_14 -> V_2 . V_48 , F_24 , 0 ,
F_64 ( & V_113 -> V_116 ) , & V_14 -> V_2 ) ;
if ( V_118 )
return V_118 ;
return F_65 ( & V_134 , & V_14 -> V_2 ) ;
}
static int F_66 ( struct V_112 * V_113 )
{
struct V_1 * V_2 = F_67 ( V_113 ) ;
F_68 ( & V_134 , V_2 ) ;
return 0 ;
}
