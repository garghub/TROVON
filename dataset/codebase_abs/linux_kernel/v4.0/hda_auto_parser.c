...
F_7 , NULL ) ;
F_24 ( V_14 , L_6 ,
V_14 -> V_94 , V_16 -> V_64 , V_16 -> V_46 [ 0 ] ,
V_16 -> V_46 [ 1 ] , V_16 -> V_46 [ 2 ] ,
V_16 -> V_46 [ 3 ] , V_16 -> V_46 [ 4 ] ,
V_16 -> V_90 == V_91 ? L_7 :
( V_16 -> V_90 == V_93 ?
L_8 : L_9 ) ) ;
F_24 ( V_14 , L_10 ,
...
unsigned int V_107 ;
int V_11 , V_35 , V_108 ;
V_107 = F_12 ( V_14 , V_16 -> V_19 [ V_106 ] . V_12 ) ;
V_35 = F_13 ( V_107 ) ;
if ( V_35 <= V_103 )
return 1 ;
V_35 = 0 ;
for ( V_11 = 0 ; V_11 < V_16 -> V_17 ; V_11 ++ ) {
V_107 = F_12 ( V_14 , V_16 -> V_19 [ V_11 ] . V_12 ) ;
V_108 = F_13 ( V_107 ) ;
if ( V_108 >= V_103 ) {
if ( V_35 && V_35 != V_108 )
return 1 ;
...
int V_106 )
{
int type = V_16 -> V_19 [ V_106 ] . type ;
int V_109 = 0 ;
if ( ( V_106 > 0 && V_16 -> V_19 [ V_106 - 1 ] . type == type ) ||
( V_106 < V_16 -> V_17 - 1 && V_16 -> V_19 [ V_106 + 1 ] . type == type ) )
V_109 = 1 ;
if ( V_109 && type == V_37 )
V_109 &= F_28 ( V_14 , V_16 , V_106 ) ;
return F_27 ( V_14 , & V_16 -> V_19 [ V_106 ] ,
V_16 -> V_19 [ V_106 ] . V_12 ,
V_109 ) ;
}
...
{
int V_11 , V_112 , V_113 = 0 ;
const char * V_114 = F_31 ( V_14 , V_1 ) ;
V_11 = F_29 ( V_1 , V_9 , V_10 ) ;
if ( V_11 < 0 )
return - 1 ;
for ( V_112 = 0 ; V_112 < V_11 ; V_112 ++ )
if ( V_114 == F_31 ( V_14 , V_9 [ V_112 ] ) )
V_113 ++ ;
return V_113 ;
}
static int F_33 ( struct V_13 * V_14 , T_1 V_1 ,
const struct V_15 * V_16 ,
const char * V_115 , char * V_116 , int V_117 ,
int * V_110 )
{
unsigned int V_36 = F_12 ( V_14 , V_1 ) ;
int V_35 = F_13 ( V_36 ) ;
const char * V_114 , * V_118 = L_36 ;
if ( ! strcmp ( V_115 , L_39 ) && V_35 == V_96 )
V_115 = L_40 ;
V_114 = F_31 ( V_14 , V_1 ) ;
if ( V_16 ) {
V_118 = F_30 ( V_1 , V_16 -> V_46 , V_16 -> V_64 ,
V_110 ) ;
if ( ! V_118 )
V_118 = F_30 ( V_1 , V_16 -> V_48 , V_16 -> V_65 ,
V_110 ) ;
if ( ! V_118 ) {
int V_113 = F_32 ( V_14 , V_1 , V_16 -> V_50 ,
V_16 -> V_66 ) ;
if ( V_113 >= 0 && V_110 )
* V_110 = V_113 ;
V_118 = L_36 ;
...
snprintf ( V_116 , V_117 , L_41 , V_114 , V_115 , V_118 ) ;
return 1 ;
}
int F_34 ( struct V_13 * V_14 , T_1 V_1 ,
const struct V_15 * V_16 ,
char * V_116 , int V_117 , int * V_110 )
{
unsigned int V_36 = F_12 ( V_14 , V_1 ) ;
...
continue;
V_115 = F_26 ( V_14 , V_16 , V_11 ) ;
if ( V_115 )
break;
}
}
if ( ! V_115 )
V_115 = F_27 ( V_14 , NULL , V_1 , true ) ;
break;
}
if ( ! V_115 )
return 0 ;
F_36 ( V_116 , V_115 , V_117 ) ;
return 1 ;
}
...
{
int V_11 ;
for ( V_11 = 0 ; V_11 < V_14 -> V_123 . V_125 ; V_11 ++ ) {
struct V_121 * * V_122 = F_40 ( & V_14 -> V_123 , V_11 ) ;
F_41 ( V_14 , * V_122 ) ;
}
}
void F_42 ( struct V_13 * V_14 ,
const struct V_126 * V_16 )
{
for (; V_16 -> V_1 ; V_16 ++ )
F_43 ( V_14 , V_16 -> V_1 , V_16 -> V_127 ) ;
}
static void F_44 ( struct V_13 * V_14 ,
const struct V_126 * V_16 )
{
for (; V_16 -> V_1 ; V_16 ++ )
F_45 ( V_14 , V_16 -> V_1 , V_16 -> V_127 ) ;
}
static void F_46 ( struct V_13 * V_14 , int V_128 , int V_129 , int V_130 )
{
const char * V_131 = V_14 -> V_132 ;
while ( V_128 >= 0 ) {
const struct V_133 * V_134 = V_14 -> V_135 + V_128 ;
if ( V_134 -> V_136 )
F_46 ( V_14 , V_134 -> V_137 , V_129 , V_130 + 1 ) ;
switch ( V_134 -> type ) {
case V_138 :
if ( V_129 != V_139 || ! V_134 -> V_122 . V_9 )
break;
F_25 ( V_14 , L_45 ,
V_14 -> V_94 , V_131 ) ;
F_42 ( V_14 , V_134 -> V_122 . V_9 ) ;
break;
case V_140 :
if ( V_129 != V_141 || ! V_134 -> V_122 . V_123 )
break;
F_25 ( V_14 , L_46 ,
V_14 -> V_94 , V_131 ) ;
F_37 ( V_14 , V_134 -> V_122 . V_123 ) ;
break;
case V_142 :
if ( ! V_134 -> V_122 . V_143 )
break;
F_25 ( V_14 , L_47 ,
V_14 -> V_94 , V_131 ) ;
V_134 -> V_122 . V_143 ( V_14 , V_134 , V_129 ) ;
break;
case V_144 :
if ( V_129 != V_141 || ! V_134 -> V_122 . V_9 )
break;
F_25 ( V_14 , L_48 ,
V_14 -> V_94 , V_131 ) ;
F_44 ( V_14 , V_134 -> V_122 . V_9 ) ;
break;
default:
F_47 ( V_14 , L_49 ,
V_14 -> V_94 , V_134 -> type ) ;
break;
}
if ( ! V_134 -> V_145 || V_134 -> V_136 )
break;
if ( ++ V_130 > 10 )
break;
V_128 = V_134 -> V_137 ;
...
void F_48 ( struct V_13 * V_14 , int V_129 )
{
if ( V_14 -> V_135 )
F_46 ( V_14 , V_14 -> V_146 , V_129 , 0 ) ;
}
...
#ifdef F_51
V_14 -> V_132 = V_150 -> V_115 ;
F_25 ( V_14 , L_50 ,
V_14 -> V_94 , V_14 -> V_132 ) ;
#endif
V_14 -> V_135 = V_149 ;
return;
}
...
if ( V_14 -> V_146 != V_151 )
return;
if ( V_14 -> V_131 && ! strcmp ( V_14 -> V_131 , L_51 ) ) {
V_14 -> V_135 = NULL ;
V_14 -> V_132 = NULL ;
V_14 -> V_146 = V_161 ;
F_25 ( V_14 , L_52 ,
...
if ( V_14 -> V_131 && V_157 ) {
while ( V_157 -> V_115 ) {
if ( ! strcmp ( V_14 -> V_131 , V_157 -> V_115 ) ) {
V_14 -> V_146 = V_157 -> V_128 ;
V_14 -> V_132 = V_157 -> V_115 ;
V_14 -> V_135 = V_149 ;
F_25 ( V_14 , L_53 ,
V_14 -> V_94 , V_14 -> V_132 ) ;
return;
...
V_115 = V_160 -> V_115 ;
F_25 ( V_14 , L_54 ,
V_14 -> V_94 , V_115 , V_160 -> V_164 ? L_36 : L_55 ) ;
#endif
}
}
if ( V_128 < 0 && V_159 ) {
for ( V_160 = V_159 ; V_160 -> V_152 || V_160 -> V_165 ; V_160 ++ ) {
unsigned int V_166 =
V_160 -> V_165 | ( V_160 -> V_152 << 16 ) ;
unsigned int V_167 = 0xffff0000 | V_160 -> V_164 ;
if ( ( V_14 -> V_153 & V_167 ) == ( V_166 & V_167 ) ) {
V_128 = V_160 -> V_155 ;
#ifdef F_51
V_115 = V_160 -> V_115 ;
F_25 ( V_14 , L_56 ,
