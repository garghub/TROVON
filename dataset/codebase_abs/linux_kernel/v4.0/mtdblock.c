...
F_24 ( & V_24 -> V_43 ) ;
V_24 -> V_26 = V_31 ;
if ( ! ( V_25 -> V_6 -> V_44 & V_45 ) && V_25 -> V_6 -> V_40 ) {
...
static void F_25 ( struct V_37 * V_25 )
{
struct V_23 * V_24 = F_19 ( V_25 , struct V_23 , V_25 ) ;
F_14 ( L_9 ) ;
F_26 ( & V_24 -> V_43 ) ;
...
static void F_31 ( struct V_48 * V_49 , struct V_5 * V_6 )
{
struct V_23 * V_38 = F_32 ( sizeof( * V_38 ) , V_50 ) ;
if ( ! V_38 )
return;
V_38 -> V_25 . V_6 = V_6 ;
V_38 -> V_25 . V_51 = V_6 -> V_52 ;
