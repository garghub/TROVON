...
static int F_43 ( struct V_1 * V_2 , struct V_88 * V_89 ,
...
static inline unsigned long F_46 ( unsigned V_103 , unsigned V_104 )
{
return F_47 ( V_104 + V_103 - 1 , V_103 ) ;
}
...
V_121 = V_119 + V_125 ;
V_117 = false ;
for ( V_63 = V_120 ; V_63 >= V_121 ; V_63 -= sizeof( V_116 ) ) {
V_6 = F_8 ( V_2 , V_63 , & V_116 , sizeof( V_116 ) ) ;
if ( V_6 ) {
F_51 ( V_2 ,
L_12 ,
V_63 ) ;
...
V_13 = F_18 ( V_2 , V_5 -> V_64 . V_111 , V_21 ) ;
if ( V_13 ) {
F_51 ( V_2 , L_16 , V_13 ) ;
return V_13 ;
}
...
V_131 = ! ! ( V_21 [ 0 ] & F_37 ( 6 ) ) ;
V_132 = ! ! ( V_21 [ 0 ] & F_37 ( 7 ) ) ;
V_13 = F_18 ( V_2 , V_5 -> V_64 . V_111 + 1 , V_21 ) ;
if ( V_13 ) {
F_51 ( V_2 , L_17 , V_13 ) ;
return V_13 ;
}
...
V_138 = V_21 [ 0 ] | ( V_21 [ 1 ] << 8 ) ;
V_139 = V_21 [ 2 ] | ( V_21 [ 3 ] << 8 ) ;
V_5 -> V_142 = F_55 ( V_138 , 10 ) ;
V_5 -> V_143 = F_55 ( V_139 , 10 ) ;
F_50 ( V_2 , L_22 ,
V_11 , V_5 -> V_142 , V_5 -> V_143 ) ;
V_140 += 12 ;
}
}
if ( V_131 )
...
V_13 = F_8 ( V_2 , V_5 -> V_64 . V_113 , V_21 , 10 ) ;
if ( V_13 ) {
F_51 ( V_2 , L_25 , V_13 ) ;
return V_13 ;
}
V_5 -> V_144 = V_21 [ 6 ] | ( V_21 [ 7 ] << 8 ) ;
...
V_13 = F_8 ( V_2 , V_5 -> V_74 . V_111 , V_21 , 2 ) ;
if ( V_13 ) {
F_51 ( V_2 , L_27 , V_13 ) ;
return V_13 ;
}
...
V_147 = ( V_5 -> V_75 + 7 ) / 8 ;
V_148 = ( V_145 && V_146 ) ? V_147 : 0 ;
V_148 += V_147 ;
V_149 = 2 * V_147 ;
V_5 -> V_74 . V_71 = V_147 ;
V_13 = F_8 ( V_2 , V_5 -> V_74 . V_113 + V_148 ,
V_21 , V_149 ) ;
if ( V_13 ) {
F_51 ( V_2 , L_28 ,
V_149 , V_13 ) ;
...
int V_150 = V_63 >> 3 ;
int V_151 = V_63 & 0x07 ;
T_1 V_152 = V_21 [ V_150 ] ;
T_1 V_153 = V_21 [ V_150 + V_147 ] ;
bool V_154 = ( V_152 >> V_151 ) & F_37 ( 0 ) ;
bool V_155 = ( V_153 >> V_151 ) & F_37 ( 0 ) ;
if ( V_154 == 0 ) {
if ( V_155 ) {
V_5 -> V_156 ++ ;
F_11 ( V_63 , & V_5 -> V_76 ) ;
...
static void F_58 ( struct V_1 * V_2 , struct V_157 * V_158 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_159 * V_46 = V_158 -> V_46 ;
int V_13 ;
int V_160 , V_161 , V_63 ;
V_5 -> V_46 = V_46 ;
F_33 ( V_2 , L_32 ) ;
V_13 = F_59 ( V_2 ) ;
if ( V_13 )
...
if ( V_13 )
goto exit;
F_61 ( V_49 , V_46 -> V_162 ) ;
F_62 ( V_46 , V_50 , 1 , V_5 -> V_144 , 0 , 0 ) ;
F_62 ( V_46 , V_51 , 1 , V_5 -> V_48 , 0 , 0 ) ;
if ( V_5 -> V_142 && V_5 -> V_143 ) {
V_160 = ( V_5 -> V_144 - 1 ) / V_5 -> V_142 ;
V_161 = ( V_5 -> V_48 - 1 ) / V_5 -> V_143 ;
F_63 ( V_46 , V_50 , V_160 ) ;
F_63 ( V_46 , V_51 , V_161 ) ;
}
F_62 ( V_46 , V_52 , 0 , 1 , 0 , 0 ) ;
F_62 ( V_46 , V_53 , 0 , 0xff , 0 , 0 ) ;
F_62 ( V_46 , V_54 , 0 , 0x0f , 0 , 0 ) ;
F_62 ( V_46 , V_55 , 0 , 0x0f , 0 , 0 ) ;
F_64 ( V_46 , V_5 -> V_66 , V_163 ) ;
if ( V_5 -> V_156 ) {
F_61 ( V_78 , V_46 -> V_162 ) ;
for ( V_63 = 0 ; V_63 < V_5 -> V_156 ; V_63 ++ )
F_61 ( V_79 + V_63 , V_46 -> V_164 ) ;
if ( V_5 -> V_156 == 1 )
F_61 ( V_165 , V_46 -> V_166 ) ;
}
F_11 ( V_81 , & V_5 -> V_29 ) ;
exit:
F_65 ( V_2 ) ;
...
struct V_157 * V_158 , struct V_88 * V_89 ,
struct V_90 * V_91 , unsigned long * * V_167 , int * F_22 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( V_5 -> V_92 & V_93 ) {
if ( ( V_5 -> V_92 & V_97 ) &&
...
static int F_68 ( struct V_1 * V_2 , unsigned type ,
unsigned V_168 , struct V_85 * * V_18 )
{
int V_63 ;
* V_18 = V_2 -> V_169 [ type ] . V_170 [ V_168 ] ;
if ( * V_18 ) {
for ( V_63 = 0 ; V_63 < ( * V_18 ) -> V_171 ; V_63 ++ ) {
unsigned V_172 = ( * V_18 ) -> V_89 [ V_63 ] -> V_94 ;
if ( ( V_172 & V_99 ) >= V_173 )
return 1 ;
}
}
...
static int F_69 ( struct V_1 * V_2 , const struct V_174 * V_168 )
{
struct V_4 * V_5 = NULL ;
int V_13 ;
T_4 V_175 ;
...
struct V_85 * V_177 ;
struct V_85 * V_178 ;
V_5 = F_70 ( & V_2 -> V_10 , sizeof( struct V_4 ) , V_179 ) ;
if ( ! V_5 )
return - V_180 ;
F_71 ( & V_5 -> V_58 , F_25 ) ;
V_5 -> V_2 = V_2 ;
...
V_5 -> V_9 = F_74 ( V_177 ) ;
V_5 -> V_92 |= V_93 ;
V_175 = V_5 -> V_9 + V_5 -> V_83 ;
V_5 -> V_7 = F_70 ( & V_2 -> V_10 , V_175 , V_179 ) ;
if ( ! V_5 -> V_7 ) {
V_13 = - V_180 ;
return V_13 ;
}
