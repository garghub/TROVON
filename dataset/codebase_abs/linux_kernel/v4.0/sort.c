...
V_177 = 1 ;
} else if ( V_150 -> V_151 == & V_178 ) {
V_43 = 1 ;
}
return F_92 ( V_150 ) ;
}
for ( V_83 = 0 ; V_83 < F_97 ( V_179 ) ; V_83 ++ ) {
struct V_164 * V_165 = & V_179 [ V_83 ] ;
if ( strncasecmp ( V_166 , V_165 -> V_44 , strlen ( V_166 ) ) )
continue;
return F_93 ( V_165 ) ;
}
for ( V_83 = 0 ; V_83 < F_97 ( V_180 ) ; V_83 ++ ) {
struct V_149 * V_150 = & V_180 [ V_83 ] ;
if ( strncasecmp ( V_166 , V_150 -> V_44 , strlen ( V_166 ) ) )
continue;
if ( V_181 != V_182 )
return - V_174 ;
if ( V_150 -> V_151 == & V_183 || V_150 -> V_151 == & V_184 )
V_177 = 1 ;
F_92 ( V_150 ) ;
return 0 ;
}
for ( V_83 = 0 ; V_83 < F_97 ( V_185 ) ; V_83 ++ ) {
struct V_149 * V_150 = & V_185 [ V_83 ] ;
if ( strncasecmp ( V_166 , V_150 -> V_44 , strlen ( V_166 ) ) )
continue;
if ( V_181 != V_186 )
return - V_174 ;
if ( V_150 -> V_151 == & V_187 )
V_177 = 1 ;
F_92 ( V_150 ) ;
return 0 ;
}
...
void F_105 ( int V_201 , bool V_160 )
{
struct V_129 * V_3 ;
struct V_132 * V_138 ;
F_106 (fmt) {
...
static bool F_107 ( struct V_202 * V_158 , const char * V_203 , T_6 * V_204 )
{
...
continue;
V_138 = F_71 ( V_3 , struct V_132 , V_135 ) ;
V_3 -> V_160 = F_110 ( V_138 -> V_136 -> V_139 , V_206 ) ;
}
F_106 (fmt) {
if ( ! F_70 ( V_3 ) )
continue;
