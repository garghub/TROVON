...
int V_28 = 0 ;
V_22 -> V_25 = & V_49 -> V_25 ;
V_27 = F_16 ( & V_49 -> V_25 , sizeof( struct V_26 ) , V_54 ) ;
if ( V_27 == NULL )
return - V_55 ;
if ( V_51 ) {
struct V_50 * V_56 ;
