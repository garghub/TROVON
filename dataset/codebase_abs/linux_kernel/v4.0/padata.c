...
V_6 = V_14 -> V_6 . V_7 ;
V_97 = snprintf ( V_96 , V_99 , L_2 ,
V_100 , F_104 ( V_6 ) ) ;
F_85 ( & V_14 -> V_18 ) ;
return V_97 < V_99 ? V_97 : - V_26 ;
}
static T_2 F_105 ( struct V_13 * V_14 ,
struct V_94 * V_95 ,
...
if ( ! F_44 ( & V_102 , V_57 ) )
return - V_58 ;
V_103 = F_106 ( V_96 , V_101 , F_104 ( V_102 ) ,
V_105 ) ;
if ( V_103 < 0 )
goto V_30;
...
static T_2 F_107 ( struct V_92 * V_93 ,
struct V_94 * V_95 , char * V_96 )
{
struct V_13 * V_14 ;
struct V_106 * V_107 ;
...
static T_2 F_109 ( struct V_92 * V_93 , struct V_94 * V_95 ,
const char * V_96 , T_3 V_101 )
{
struct V_13 * V_14 ;
struct V_106 * V_107 ;
...
struct V_13 * F_110 ( struct V_111 * V_36 )
{
return F_111 ( V_36 , V_112 , V_112 ) ;
}
