...
static inline int F_131 ( struct V_98 * V_99 )
{
struct V_1 * V_2 ;
if ( V_99 == NULL )
return - V_169 ;
...
V_2 = (struct V_1 * ) V_99 -> V_109 ;
if ( ( ( V_99 -> V_34 &&
F_138 ( V_209 , & V_99 -> V_34 -> V_64 -> V_190 ) ) ||
F_138 ( V_209 , & V_2 -> V_190 ) ) &&
! F_138 ( V_210 , & V_99 -> V_190 ) ) {
F_39 ( V_203 , V_2 , L_47
L_48 , V_99 ) ;
V_99 -> V_199 = V_211 ;
V_99 -> V_208 = - V_89 ;
...
V_40 = F_140 ( V_2 -> V_56 , V_99 -> V_188 ,
...
F_123 ( F_143 ( V_2 -> V_56 ) , V_190 ) ;
F_144 ( V_2 , V_223 ) ;
F_125 ( F_143 ( V_2 -> V_56 ) , V_190 ) ;
F_75 ( V_2 ) ;
}
void F_145 ( struct V_1 * V_2 , int V_224 )
{
if ( V_224 == 0 )
F_146 ( & V_2 -> V_16 ) ;
else
F_147 ( & V_2 -> V_16 , V_212 + V_224 ) ;
}
void F_46 ( struct V_1 * V_2 )
{
F_146 ( & V_2 -> V_16 ) ;
}
static void F_148 ( struct V_225 * V_56 ,
unsigned long V_226 )
{
struct V_98 * V_99 ;
struct V_1 * V_2 ;
...
void F_153 ( struct V_225 * V_56 , unsigned long V_226 ,
struct V_228 * V_228 )
{
...
V_229 = NULL ;
V_224 = 0 ;
if ( F_154 ( & V_228 -> V_232 ) == ( V_233 | V_234 ) &&
F_155 ( & V_228 -> V_232 ) == 0 ) {
V_99 -> V_199 = V_247 ;
V_99 -> V_151 = V_230 ;
if ( V_99 -> V_248 . V_229 != & V_2 -> V_15 ) {
V_229 = F_157 ( V_99 -> V_248 . V_229 ,
struct V_98 , V_248 ) ;
}
} else {
if ( ! F_138 ( V_189 , & V_99 -> V_190 ) &&
V_99 -> V_196 > 0 ) {
...
enum V_251 F_158 ( struct V_225 * V_56 , struct V_228 * V_228 )
{
struct V_1 * V_2 ;
V_2 = F_150 ( V_56 ) ;
if ( F_30 ( V_2 ) )
goto V_68;
if ( F_138 ( V_252 , & V_2 -> V_190 ) ||
V_2 -> V_26 != V_2 -> V_28 ||
! V_2 -> V_42 -> V_239 ) {
F_23 ( V_2 ) ;
goto V_68;
...
if ( ! V_254 -> V_34 )
return;
F_160 (l, n, &device->ccw_queue) {
V_99 = F_157 ( V_103 , struct V_98 , V_248 ) ;
if ( V_99 -> V_199 == V_227 &&
...
struct V_98 * V_99 ;
struct V_33 * V_34 ;
void (* F_164)( struct V_98 * , void * V_19 );
void * V_257 ;
char V_197 [ V_198 ] ;
F_160 (l, n, final_queue) {
V_99 = F_157 ( V_103 , struct V_98 , V_248 ) ;
F_165 ( & V_99 -> V_248 ) ;
V_34 = V_99 -> V_34 ;
F_164 = V_99 -> F_164 ;
...
if ( F_53 ( & V_2 -> V_15 ) )
return;
V_99 = F_157 ( V_2 -> V_15 . V_229 , struct V_98 , V_248 ) ;
if ( ( V_99 -> V_199 == V_200 && V_99 -> V_224 != 0 ) &&
( F_167 ( V_212 , V_99 -> V_224 + V_99 -> V_202 ) ) ) {
if ( F_138 ( V_261 , & V_2 -> V_190 ) ) {
V_99 -> V_196 ++ ;
}
...
F_162 ( & V_99 -> V_248 , & V_267 ) ;
}
V_268:
F_172 ( F_143 ( V_2 -> V_56 ) ) ;
...
void F_176 ( struct V_1 * V_2 , int V_270 )
{
V_2 -> V_249 |= V_270 ;
}
void F_144 ( struct V_1 * V_2 , int V_270 )
{
V_2 -> V_249 &= ~ V_270 ;
if ( ! V_2 -> V_249 )
F_71 ( & V_271 ) ;
...
{
F_170 ( F_143 ( V_99 -> V_109 -> V_56 ) ) ;
V_99 -> V_257 = V_272 ;
F_172 ( F_143 ( V_99 -> V_109 -> V_56 ) ) ;
F_71 ( & V_271 ) ;
}
...
static int F_187 ( struct V_98 * V_279 , int V_280 )
{
struct V_1 * V_2 ;
int V_40 ;
struct V_102 V_15 ;
...
V_279 -> V_199 = V_274 ;
V_2 = V_279 -> V_109 ;
F_178 ( & V_279 -> V_281 , & V_15 ) ;
for ( V_99 = V_279 ; F_186 ( V_99 ) ;
V_99 = F_188 ( & V_15 ,
struct V_98 , V_281 ) ) {
if ( F_183 ( V_99 ) )
continue;
...
F_83 ( V_271 , F_182 ( V_99 ) ) ;
}
V_279 -> V_152 = F_134 () ;
if ( ( V_279 -> V_199 != V_258 ) &&
( V_279 -> V_208 != - V_284 ) )
F_184 ( V_279 , & V_279 -> V_228 ) ;
if ( V_279 -> V_199 == V_258 )
V_40 = 0 ;
else if ( V_279 -> V_208 )
V_40 = V_279 -> V_208 ;
...
static int F_194 ( struct V_102 * V_15 , int V_280 )
{
struct V_1 * V_2 ;
struct V_98 * V_99 , * V_255 ;
int V_40 ;
...
F_123 ( F_143 ( V_34 -> V_64 -> V_56 ) , V_190 ) ;
F_144 ( V_34 -> V_64 , V_223 ) ;
F_125 ( F_143 ( V_34 -> V_64 -> V_56 ) , V_190 ) ;
F_60 ( V_34 ) ;
}
...
return;
if ( V_287 -> V_26 < V_71 ) {
while ( ( V_101 = F_202 ( V_34 -> V_290 ) ) )
F_203 ( V_101 , - V_205 ) ;
return;
}
while ( ( V_101 = F_204 ( V_291 ) ) ) {
if ( V_287 -> V_81 & V_292 &&
F_87 ( V_101 ) == V_293 ) {
F_39 ( V_183 , V_287 ,
L_89 ,
...
V_300:
F_160 (l, n, &block->ccw_queue) {
V_99 = F_157 ( V_103 , struct V_98 , V_281 ) ;
if ( V_99 -> V_199 != V_258 &&
V_99 -> V_199 != V_277 &&
V_99 -> V_199 != V_259 &&
V_99 -> V_199 != V_260 )
...
if ( F_189 ( V_64 ) &&
V_99 -> V_199 == V_277 ) {
F_209 ( V_64 , V_99 , V_301 ) ;
V_99 -> V_199 = V_274 ;
V_99 -> V_196 = 255 ;
F_123 ( F_143 ( V_64 -> V_56 ) , V_190 ) ;
F_176 ( V_64 , V_302 ) ;
F_125 ( F_143 ( V_64 -> V_56 ) ,
V_190 ) ;
goto V_300;
}
if ( V_99 -> V_278 ) {
...
if ( V_99 -> V_199 != V_274 )
continue;
if ( F_138 ( V_209 , & V_34 -> V_64 -> V_190 ) &&
! F_138 ( V_210 , & V_99 -> V_190 ) ) {
V_99 -> V_199 = V_277 ;
V_99 -> V_208 = - V_89 ;
F_60 ( V_34 ) ;
...
static void F_215 ( struct V_290 * V_291 )
{
struct V_33 * V_34 ;
V_34 = V_291 -> V_304 ;
F_86 ( & V_34 -> V_38 ) ;
...
enum V_305 F_216 ( struct V_100 * V_101 )
{
...
{
int V_40 ;
V_34 -> V_290 = F_217 ( F_215 ,
& V_34 -> V_36 ) ;
if ( V_34 -> V_290 == NULL )
return - V_4 ;
V_34 -> V_290 -> V_304 = V_34 ;
F_218 ( V_34 -> V_290 -> V_314 ) ;
V_34 -> V_290 -> V_314 = NULL ;
F_73 ( & V_34 -> V_290 -> V_315 ) ;
V_40 = F_219 ( V_34 -> V_290 , L_94 ) ;
if ( V_40 )
F_220 ( V_34 -> V_290 ) ;
F_74 ( & V_34 -> V_290 -> V_315 ) ;
return V_40 ;
}
...
V_316 = V_34 -> V_64 -> V_42 -> V_317 << V_34 -> V_70 ;
}
F_221 ( V_34 -> V_290 ,
V_34 -> V_73 ) ;
F_222 ( V_34 -> V_290 , V_316 ) ;
F_223 ( V_34 -> V_290 , - 1L ) ;
F_224 ( V_34 -> V_290 , V_9 ) ;
F_225 ( V_34 -> V_290 , V_9 - 1 ) ;
}
...
static int F_226 ( struct V_318 * V_85 , T_7 V_177 )
{
struct V_1 * V_64 ;
int V_40 ;
V_64 = F_227 ( V_85 -> V_86 ) ;
if ( ! V_64 )
return - V_204 ;
F_228 ( & V_64 -> V_34 -> V_35 ) ;
if ( F_138 ( V_252 , & V_64 -> V_190 ) ) {
V_40 = - V_204 ;
goto V_319;
}
if ( ! F_229 ( V_64 -> V_42 -> V_44 ) ) {
V_40 = - V_169 ;
goto V_319;
}
if ( V_96 ) {
F_230 ( & V_64 -> V_56 -> V_57 ,
L_95
L_96 ) ;
V_40 = - V_89 ;
goto V_68;
...
if ( V_64 -> V_26 <= V_62 ) {
F_39 ( V_183 , V_64 , L_97 ,
L_98 ) ;
V_40 = - V_204 ;
goto V_68;
}
if ( ( V_177 & V_320 ) &&
( F_138 ( V_321 , & V_64 -> V_190 ) ||
( V_64 -> V_81 & V_292 ) ) ) {
V_40 = - V_322 ;
goto V_68;
}
...
F_26 ( V_64 -> V_42 -> V_44 ) ;
V_319:
F_231 ( & V_64 -> V_34 -> V_35 ) ;
F_23 ( V_64 ) ;
return V_40 ;
}
static void F_232 ( struct V_74 * V_75 , T_7 V_177 )
{
struct V_1 * V_64 = F_227 ( V_75 ) ;
if ( V_64 ) {
F_231 ( & V_64 -> V_34 -> V_35 ) ;
F_26 ( V_64 -> V_42 -> V_44 ) ;
F_23 ( V_64 ) ;
...
static int F_233 ( struct V_318 * V_85 , struct V_323 * V_324 )
{
struct V_1 * V_64 ;
V_64 = F_227 ( V_85 -> V_86 ) ;
if ( ! V_64 )
...
V_324 -> V_326 = F_234 ( V_85 ) >> V_64 -> V_34 -> V_70 ;
F_23 ( V_64 ) ;
return 0 ;
}
static void
...
static void F_244 ( void * V_19 , T_8 V_338 )
{
...
V_56 -> V_341 = & F_153 ;
if ( ( F_249 ( V_56 , V_342 ) > 0 ) ||
( V_343 && F_250 ( F_35 ( & V_56 -> V_57 ) ) != 0 ) )
F_251 ( F_244 , V_56 ) ;
return 0 ;
}
void F_252 ( struct V_225 * V_56 )
{
struct V_1 * V_2 ;
struct V_33 * V_34 ;
V_56 -> V_341 = NULL ;
...
if ( F_255 ( V_252 , & V_2 -> V_190 ) &&
! F_138 ( V_261 , & V_2 -> V_190 ) ) {
F_23 ( V_2 ) ;
F_254 ( V_56 ) ;
return;
}
...
F_263 ( V_347 , & V_2 -> V_190 ) ;
} else
if ( F_138 ( V_252 , & V_2 -> V_190 ) ) {
F_23 ( V_2 ) ;
return - V_207 ;
}
if ( F_264 ( V_347 , & V_2 -> V_190 ) &&
! F_255 ( V_261 , & V_2 -> V_190 ) ) {
...
{
struct V_98 * V_99 ;
F_266 ( & V_2 -> V_56 -> V_57 , L_109
L_110 ) ;
F_39 ( V_60 , V_2 , L_1 , L_111 ) ;
F_209 ( V_2 , NULL , V_349 ) ;
if ( V_2 -> V_26 < V_62 )
return 0 ;
...
int F_268 ( struct V_225 * V_56 , int V_350 )
{
struct V_1 * V_2 ;
int V_339 ;
V_2 = F_150 ( V_56 ) ;
...
void F_269 ( struct V_225 * V_56 , int * V_355 )
{
int V_356 ;
T_9 V_357 , V_358 ;
struct V_1 * V_2 ;
...
if ( F_30 ( V_2 ) )
return;
for ( V_356 = 0 ; V_356 < 8 ; V_356 ++ ) {
V_358 = 0x80 >> V_356 ;
if ( V_355 [ V_356 ] & V_359 ) {
V_357 = V_2 -> V_215 . V_216 ;
V_2 -> V_215 . V_216 &= ~ V_358 ;
V_2 -> V_215 . V_219 &= ~ V_358 ;
V_2 -> V_215 . V_220 &= ~ V_358 ;
if ( V_357 && ! V_2 -> V_215 . V_216 ) {
F_266 ( & V_2 -> V_56 -> V_57 ,
L_115
L_110 ) ;
F_39 ( V_60 , V_2 ,
...
if ( V_355 [ V_356 ] & V_360 ) {
V_2 -> V_215 . V_216 &= ~ V_358 ;
V_2 -> V_215 . V_219 &= ~ V_358 ;
V_2 -> V_215 . V_220 &= ~ V_358 ;
V_2 -> V_215 . V_221 |= V_358 ;
F_75 ( V_2 ) ;
}
if ( V_355 [ V_356 ] & V_361 ) {
if ( ! ( V_2 -> V_215 . V_216 & V_358 ) &&
! ( V_2 -> V_215 . V_221 & V_358 ) ) {
V_2 -> V_215 . V_221 |= V_358 ;
F_75 ( V_2 ) ;
}
...
if ( F_30 ( V_2 ) )
return F_103 ( V_2 ) ;
F_121 ( V_363 , & V_2 -> V_190 ) ;
if ( V_2 -> V_42 -> V_364 )
V_40 = V_2 -> V_42 -> V_364 ( V_2 ) ;
F_176 ( V_2 , V_365 ) ;
F_12 ( & V_362 ) ;
F_170 ( F_143 ( V_56 ) ) ;
V_40 = 0 ;
...
V_192 = V_99 -> V_188 ;
V_192 -> V_370 = V_371 ;
if ( F_277 ( V_367 , V_368 ) ) {
V_369 = ( unsigned long * ) ( V_99 -> V_19 ) ;
V_192 -> V_372 = ( V_373 ) ( V_374 ) V_369 ;
V_192 -> V_190 = V_375 ;
V_369 = F_278 ( V_369 , V_367 , V_368 ) ;
} else {
V_192 -> V_372 = ( V_373 ) ( V_374 ) V_367 ;
V_192 -> V_190 = 0 ;
}
V_192 -> V_376 = V_368 ;
V_99 -> V_109 = V_2 ;
...
void * V_367 , int V_368 )
{
int V_339 ;
struct V_98 * V_99 ;
V_99 = F_276 ( V_2 , V_367 , V_368 ,
V_184 ) ;
if ( F_30 ( V_99 ) )
return F_103 ( V_99 ) ;
V_339 = F_195 ( V_99 ) ;
F_129 ( V_99 , V_99 -> V_366 ) ;
return V_339 ;
}
char * F_280 ( struct V_228 * V_228 )
{
struct V_377 * V_377 = NULL ;
char * V_378 = NULL ;
if ( F_281 ( & V_228 -> V_232 ) && ( V_228 -> V_232 . V_379 . V_380 == 0x01 ) ) {
if ( V_228 -> V_232 . V_379 . V_381 )
V_377 = F_282 ( (struct V_381 * ) ( unsigned long )
V_228 -> V_232 . V_379 . V_381 ) ;
if ( V_377 && V_377 -> V_382 == 64 && V_377 -> V_190 )
switch ( V_377 -> V_190 & 0x07 ) {
case 1 :
V_378 = V_377 -> V_383 . V_384 . V_378 ;
break;
case 2 :
V_378 = V_377 -> V_383 . V_385 . V_378 ;
break;
default:
break;
}
} else if ( V_228 -> V_242 . V_386 . V_387 . V_388 ) {
V_378 = V_228 -> V_389 ;
}
return V_378 ;
}
