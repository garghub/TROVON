...
V_129 = F_51 ( V_29 -> V_5 [ V_55 ] ) ;
if ( V_39 > V_42 || V_129 > V_130 )
return - V_16 ;
return F_52 ( V_7 , V_39 , V_129 ) ;
}
...
if ( V_58 . V_59 < V_132 || V_58 . V_59 > V_133 )
return - V_16 ;
if ( V_58 . V_59 == V_60 ) {
if ( ! V_29 -> V_5 [ V_61 ] )
return - V_16 ;
...
static int F_70 ( const struct V_139 * V_125 , struct V_30 * V_31 ,
struct V_28 * V_29 )
{
struct V_6 * V_7 ;
struct V_1 * V_1 ;
struct V_23 * V_92 ;
bool V_140 = V_125 -> V_141 & V_142 ;
if ( V_140 )
F_28 () ;
...
static void F_75 ( const struct V_139 * V_125 , struct V_30 * V_31 ,
struct V_28 * V_29 )
{
if ( V_29 -> V_88 [ 1 ] ) {
