...
int V_99 ;
struct V_14 * V_14 ;
struct V_18 V_108 , V_109 , F_37 , * V_110 = NULL ;
struct V_18 V_111 ;
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
T_1 V_85 ;
if ( ! V_21 -> V_24 )
...
F_76 ( V_3 -> V_76 , & V_108 ) ;
F_76 ( V_3 -> V_76 , & V_109 ) ;
V_3 -> V_116 = F_77 ( V_3 -> V_76 ) ? 1 : V_3 -> V_116 ;
if ( F_31 ( V_3 -> V_116 ) && F_25 ( V_3 ) ) {
F_59 ( & V_3 -> V_23 ) ;
F_75 ( & V_3 -> V_106 , & V_108 ) ;
F_60 ( & V_3 -> V_23 ) ;
F_1 ( V_3 ) ;
} else
...
{
struct V_2 * V_3 =
F_82 ( V_118 , struct V_2 , V_40 ) ;
F_47 ( V_3 -> V_42 -> V_84 ) ;
}
static void F_83 ( struct V_117 * V_118 )
{
struct V_2 * V_3 = F_82 ( V_118 , struct V_2 ,
V_5 ) ;
...
if ( F_98 ( V_42 , V_124 [ 0 ] , F_99 ( V_42 -> V_84 ) ,
& V_3 -> V_25 [ V_25 ] . V_38 ) ) {
V_42 -> error = L_14 ;
return - V_127 ;
}
...
V_119 = F_101 ( V_124 [ 0 ] , V_42 , F_29 , V_130 ,
V_124 + 2 ) ;
if ( ! V_119 ) {
V_42 -> error = L_18 ;
return NULL ;
...
static int F_102 ( struct V_2 * V_3 , unsigned V_128 , char * * V_124 ,
unsigned * V_129 )
{
unsigned V_131 ;
...
static int F_103 ( struct V_41 * V_42 , unsigned int V_128 , char * * V_124 )
{
int V_69 ;
...
struct V_82 * V_119 ;
char V_125 ;
V_119 = F_100 ( V_42 , V_128 , V_124 , & V_129 ) ;
if ( ! V_119 )
return - V_126 ;
V_124 += V_129 ;
V_128 -= V_129 ;
...
V_3 = F_85 ( V_30 , V_119 -> type -> V_134 ( V_119 ) , V_42 , V_119 ) ;
if ( ! V_3 ) {
F_104 ( V_119 ) ;
return - V_135 ;
}
for ( V_27 = 0 ; V_27 < V_30 ; V_27 ++ ) {
V_69 = F_97 ( V_3 , V_42 , V_27 , V_124 ) ;
if ( V_69 ) {
F_94 ( V_3 , V_42 , V_27 ) ;
return V_69 ;
}
...
V_42 -> V_137 = 1 ;
V_42 -> V_138 = 1 ;
V_42 -> V_139 = sizeof( struct V_140 ) ;
V_42 -> V_141 = true ;
V_3 -> V_4 = F_106 ( L_25 , V_142 , 0 ) ;
if ( ! V_3 -> V_4 ) {
F_26 ( L_26 ) ;
V_69 = - V_135 ;
goto V_136;
...
V_3 -> V_7 = 0 ;
F_107 ( & V_3 -> V_40 , V_40 ) ;
V_69 = F_102 ( V_3 , V_128 , V_124 , & V_129 ) ;
if ( V_69 )
goto V_143;
V_124 += V_129 ;
V_128 -= V_129 ;
...
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
struct V_140 * V_145 =
F_118 ( V_14 , sizeof( struct V_140 ) ) ;
V_145 -> V_146 . V_89 = NULL ;
if ( V_15 == V_20 ) {
V_145 -> V_147 = F_52 ( V_3 -> V_76 , V_14 ) ;
F_10 ( V_3 , V_14 , V_15 ) ;
return V_148 ;
}
...
F_121 ( V_3 -> V_76 , V_145 -> V_147 ) ;
return error ;
}
if ( error == - V_104 )
goto V_36;
if ( ( error == - V_149 ) && ( V_14 -> V_50 & V_154 ) )
goto V_36;
if ( F_31 ( error ) ) {
if ( ! V_145 -> V_146 . V_89 ) {
F_35 ( L_28 ) ;
