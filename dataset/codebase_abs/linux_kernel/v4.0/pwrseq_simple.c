...
int F_14 ( struct V_7 * V_8 , struct V_11 * V_12 )
{
struct V_1 * V_2 ;
int V_4 , V_5 , V_13 = 0 ;
V_5 = F_15 ( V_12 -> V_14 , L_1 ) ;
if ( V_5 < 0 )
V_5 = 0 ;
...
V_2 -> V_6 [ V_4 ] = F_19 ( V_12 , L_3 , V_4 ,
V_19 ) ;
if ( F_2 ( V_2 -> V_6 [ V_4 ] ) &&
F_18 ( V_2 -> V_6 [ V_4 ] ) != - V_18 &&
F_18 ( V_2 -> V_6 [ V_4 ] ) != - V_20 ) {
V_13 = F_18 ( V_2 -> V_6 [ V_4 ] ) ;
while ( V_4 -- )
F_11 ( V_2 -> V_6 [ V_4 ] ) ;
goto F_12;
}
