...
static void F_38 ( struct V_10 * V_10 , struct V_3 * V_29 ,
T_1 V_27 )
{
struct V_24 * V_25 ;
V_25 = F_34 ( V_10 , V_27 ) ;
...
static void F_40 ( struct V_10 * V_10 , struct V_3 * V_29 , T_1 V_27 )
{
struct V_13 * V_14 = F_4 ( V_10 , V_15 ) ;
struct V_3 * V_4 ;
F_41 ( & V_14 -> V_49 ) ;
V_4 = F_42 ( V_10 , V_29 -> type , V_29 -> V_5 ,
...
void F_46 ( struct V_10 * V_10 , struct V_41 * V_51 , T_1 V_27 )
{
struct V_3 * V_29 , * V_52 ;
F_47 (publ, tmp, nsub_list, nodesub_list)
F_40 ( V_10 , V_29 , V_27 ) ;
}
static bool F_48 ( struct V_10 * V_10 , struct V_1 * V_2 ,
T_1 V_25 , T_1 V_53 )
{
struct V_3 * V_29 = NULL ;
if ( V_53 == V_36 ) {
V_29 = F_49 ( V_10 , F_50 ( V_2 -> type ) ,
F_50 ( V_2 -> V_5 ) ,
F_50 ( V_2 -> V_6 ) ,
V_46 , V_25 ,
F_50 ( V_2 -> V_7 ) , F_50 ( V_2 -> V_8 ) ) ;
if ( V_29 ) {
F_33 ( V_10 , V_29 , V_25 ) ;
return true ;
}
} else if ( V_53 == V_38 ) {
V_29 = F_42 ( V_10 , F_50 ( V_2 -> type ) ,
F_50 ( V_2 -> V_5 ) ,
V_25 , F_50 ( V_2 -> V_7 ) ,
F_50 ( V_2 -> V_8 ) ) ;
if ( V_29 ) {
...
static void F_51 ( struct V_1 * V_2 , T_1 type , T_1 V_25 )
{
struct V_54 * V_55 ;
unsigned long V_56 = F_52 () ;
V_55 = F_53 ( sizeof( * V_55 ) , V_28 ) ;
if ( ! V_55 )
return;
V_55 -> V_53 = type ;
V_55 -> V_25 = V_25 ;
V_55 -> V_57 = V_56 + F_54 ( V_58 ) ;
...
char V_27 [ 16 ] ;
unsigned long V_56 = F_52 () ;
F_47 (e, tmp, &tipc_dist_queue, next) {
if ( F_56 ( V_55 -> V_57 , V_56 ) ) {
if ( ! F_48 ( V_10 , & V_55 -> V_2 , V_55 -> V_25 , V_55 -> V_53 ) )
continue;
} else {
F_57 ( V_27 , V_55 -> V_25 ) ;
F_58 ( L_8 ,
V_55 -> V_53 , F_50 ( V_55 -> V_2 . type ) ,
F_50 ( V_55 -> V_2 . V_5 ) ,
F_50 ( V_55 -> V_2 . V_6 ) ,
V_27 , F_50 ( V_55 -> V_2 . V_8 ) ) ;
}
F_24 ( & V_55 -> V_59 ) ;
F_59 ( V_55 ) ;
}
}
void F_60 ( struct V_10 * V_10 , struct V_39 * V_61 )
{
struct V_13 * V_14 = F_4 ( V_10 , V_15 ) ;
struct V_18 * V_19 ;
struct V_1 * V_30 ;
...
int V_63 ;
F_41 ( & V_14 -> V_49 ) ;
for ( V_22 = F_61 ( V_61 ) ; V_22 ; V_22 = F_61 ( V_61 ) ) {
V_19 = F_6 ( V_22 ) ;
V_63 = F_62 ( V_19 ) ;
