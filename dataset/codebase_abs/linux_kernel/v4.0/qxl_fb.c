...
if ( V_106 )
goto free;
V_106 = F_79 ( & V_16 -> V_100 ) ;
if ( V_106 )
goto V_172;
V_106 = F_80 ( & V_16 -> V_100 , V_167 ) ;
if ( V_106 )
goto V_172;
return 0 ;
V_172:
...
void F_82 ( struct V_2 * V_3 , int V_173 )
{
F_83 ( V_3 -> V_99 . V_16 -> V_100 . V_101 , V_173 ) ;
}
bool F_84 ( struct V_2 * V_3 , struct V_104 * V_174 )
{
if ( V_174 == F_34 ( V_3 -> V_99 . V_16 -> V_22 . V_112 ) )
return true ;
return false ;
}
