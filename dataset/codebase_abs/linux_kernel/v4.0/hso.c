...
V_88 = V_31 -> V_36 -> V_88 ;
V_199 = V_31 -> V_36 -> V_68 -> V_200 -> V_201 . V_202 ;
V_191 = & V_188 -> V_191 ;
if ( V_191 -> V_203 != V_204 ||
V_191 -> V_205 != V_206 ||
F_55 ( V_191 -> V_207 ) != V_208 ||
F_55 ( V_191 -> V_209 ) != V_199 ||
F_55 ( V_191 -> V_210 ) != V_211 ) {
F_41 ( & V_88 -> V_15 ,
L_52 ) ;
F_46 ( V_191 ,
sizeof( struct V_192 ) ) ;
...
static int
F_101 ( struct V_6 * V_31 , unsigned long V_227 )
{
F_102 ( V_228 , V_229 ) ;
struct V_197 V_230 , V_231 ;
struct V_187 * V_188 ;
int V_232 ;
V_188 = V_31 -> V_188 ;
if ( ! V_188 )
return - V_55 ;
F_103 ( & V_31 -> V_165 ) ;
memcpy ( & V_230 , & V_188 -> V_198 , sizeof( struct V_197 ) ) ;
F_104 ( & V_31 -> V_165 ) ;
F_105 ( & V_188 -> V_226 , & V_228 ) ;
for (; ; ) {
F_103 ( & V_31 -> V_165 ) ;
...
memset ( V_198 , 0 , sizeof( struct V_239 ) ) ;
if ( ! V_188 )
return - V_55 ;
F_103 ( & V_31 -> V_165 ) ;
memcpy ( & V_231 , & V_188 -> V_198 , sizeof( struct V_197 ) ) ;
F_104 ( & V_31 -> V_165 ) ;
V_198 -> V_240 = V_231 . V_240 ;
V_198 -> V_222 = V_231 . V_222 ;
V_198 -> V_218 = V_231 . V_218 ;
V_198 -> V_224 = V_231 . V_224 ;
V_198 -> V_241 = V_231 . V_241 ;
V_198 -> V_242 = V_231 . V_242 ;
V_198 -> V_216 = V_231 . V_216 ;
V_198 -> V_243 = V_231 . V_243 ;
V_198 -> V_213 = V_231 . V_213 ;
V_198 -> V_220 = V_231 . V_220 ;
V_198 -> V_244 = V_231 . V_244 ;
return 0 ;
}
...
struct V_6 * V_31 = V_152 -> V_154 ;
int V_232 = 0 ;
F_64 ( L_54 , V_252 , V_227 ) ;
if ( ! V_31 )
return - V_54 ;
switch ( V_252 ) {
case V_253 :
V_232 = F_101 ( V_31 , V_227 ) ;
break;
default:
V_232 = - V_254 ;
break;
...
goto V_182;
V_255 = V_31 -> V_183 ;
V_31 -> V_183 = V_31 -> V_258 ;
V_31 -> V_258 = V_255 ;
V_31 -> V_259 = V_31 -> V_181 ;
V_31 -> V_181 = 0 ;
if ( V_255 && V_31 -> V_260 ) {
...
V_263 -> V_207 = 0 ;
V_263 -> V_209 = F_117 ( F_10 ( V_40 ) ) ;
V_263 -> V_210 = F_117 ( V_265 ) ;
if ( type == V_267 ) {
V_263 -> V_268 = V_269 |
V_270 |
V_271 ;
V_263 -> V_272 = V_267 ;
V_266 = F_114 ( V_31 -> V_36 -> V_88 , 0 ) ;
} else {
V_263 -> V_268 = V_273 |
V_270 |
V_271 ;
V_263 -> V_272 = V_274 ;
V_266 = F_118 ( V_31 -> V_36 -> V_88 , 0 ) ;
}
F_119 ( L_56 ,
...
if ( V_152 && F_31 ( V_284 , & V_152 -> V_47 ) ) {
F_128 ( V_152 ) ;
return - 1 ;
}
F_20 ( L_71 ) ;
...
static int F_141 ( struct V_6 * V_31 , int V_296 ,
int V_297 , int V_298 )
{
struct V_14 * V_15 ;
int V_155 ;
...
V_31 -> V_276 [ V_43 ] = F_146 ( V_31 -> V_156 ,
V_174 ) ;
if ( ! V_31 -> V_276 [ V_43 ] )
goto exit;
}
V_31 -> V_280 = F_145 ( 0 , V_174 ) ;
if ( ! V_31 -> V_280 ) {
F_8 ( V_15 , L_78 ) ;
goto exit;
}
V_31 -> V_280 -> V_120 = NULL ;
V_31 -> V_280 -> V_124 = 0 ;
V_31 -> V_259 = 0 ;
V_31 -> V_181 = 0 ;
V_31 -> V_180 = V_298 ;
V_31 -> V_258 = F_146 ( V_31 -> V_180 , V_174 ) ;
if ( ! V_31 -> V_258 )
goto exit;
...
static struct V_2 * F_147 ( struct V_300 * V_301 ,
int V_19 )
{
struct V_2 * V_3 ;
...
F_154 ( V_1 -> V_70 ) ;
for ( V_43 = 0 ; V_43 < V_288 ; V_43 ++ ) {
F_138 ( V_1 -> V_289 [ V_43 ] ) ;
F_139 ( V_1 -> V_290 [ V_43 ] ) ;
V_1 -> V_290 [ V_43 ] = NULL ;
}
F_138 ( V_1 -> V_87 ) ;
F_139 ( V_1 -> V_85 ) ;
...
static struct V_2 * F_163 ( struct V_300 * V_68 ,
int V_19 )
{
int V_38 , V_43 ;
struct V_69 * V_70 ;
...
for ( V_43 = 0 ; V_43 < V_288 ; V_43 ++ ) {
V_1 -> V_289 [ V_43 ] = F_145 ( 0 , V_174 ) ;
if ( ! V_1 -> V_289 [ V_43 ] ) {
F_8 ( & V_68 -> V_15 , L_88 ) ;
goto exit;
}
V_1 -> V_290 [ V_43 ] = F_146 ( V_125 ,
V_174 ) ;
if ( ! V_1 -> V_290 [ V_43 ] )
goto exit;
}
...
static
struct V_2 * F_174 ( struct V_300 * V_68 ,
int V_40 ,
struct V_41 * V_37 )
{
struct V_2 * V_3 ;
...
static
struct V_41 * F_175 ( struct V_300 * V_68 )
{
...
static int F_176 ( struct V_300 * V_68 )
{
struct V_189 * V_337 = F_148 ( V_68 ) ;
T_5 * V_338 = F_177 ( 17 , V_174 ) ;
T_2 V_199 = V_68 -> V_200 -> V_201 . V_202 ;
T_8 V_38 ;
if ( ! V_338 )
return - V_339 ;
...
static int F_178 ( struct V_300 * V_68 ,
...
if ( V_68 -> V_348 -> V_201 . V_349 != 0xFF ) {
F_8 ( & V_68 -> V_15 , L_93 ) ;
return - V_54 ;
}
V_199 = V_68 -> V_200 -> V_201 . V_202 ;
if ( V_345 -> V_350 )
V_19 = ( ( T_2 * ) ( V_345 -> V_350 ) ) [ V_199 ] ;
else
V_19 = F_176 ( V_68 ) ;
if ( V_68 -> V_351 > 1 )
F_179 ( F_148 ( V_68 ) , V_199 , 1 ) ;
V_68 -> V_352 = 1 ;
switch ( V_19 & V_353 ) {
case V_166 :
if ( ( V_19 & V_20 ) == V_30 ) {
...
static void F_183 ( struct V_300 * V_68 )
{
F_182 ( V_68 ) ;
F_181 ( V_68 , NULL ) ;
}
static void V_302 ( struct V_355 * V_84 )
{
struct V_2 * V_3 =
F_184 ( V_84 , struct V_2 , V_302 ) ;
F_77 ( V_3 -> V_68 ) ;
}
static void V_303 ( struct V_355 * V_84 )
{
struct V_2 * V_3 =
...
{
if ( V_3 -> V_88 -> V_356 == V_357 ) {
if ( ! V_3 -> V_358 ) {
V_3 -> V_358 = 1 ;
F_185 ( & V_3 -> V_302 ) ;
}
}
if ( V_3 -> V_88 -> V_356 != V_359 )
return - V_61 ;
F_57 ( V_3 -> V_88 ) ;
return 0 ;
}
...
static int F_186 ( struct V_300 * V_360 , T_9 V_361 )
{
int V_43 , V_38 ;
for ( V_43 = 0 ; V_43 < V_44 ; V_43 ++ ) {
if ( V_45 [ V_43 ] && ( V_45 [ V_43 ] -> V_68 == V_360 ) ) {
V_38 = F_81 ( V_45 [ V_43 ] ) ;
if ( V_38 )
goto V_182;
}
...
static int F_187 ( struct V_300 * V_360 )
{
int V_43 , V_38 = 0 ;
struct V_1 * V_1 ;
for ( V_43 = 0 ; V_43 < V_44 ; V_43 ++ ) {
...
static void V_185 ( struct V_363 * V_175 )
{
struct V_2 * V_3 = F_184 ( V_175 , struct V_2 , V_175 ) ;
F_170 ( V_3 ) ;
}
static void F_182 ( struct V_300 * V_68 )
{
struct V_6 * V_31 ;
int V_43 ;
for ( V_43 = 0 ; V_43 < V_44 ; V_43 ++ ) {
...
struct V_323 * V_364 = F_1 ( V_305 [ V_43 ] ) -> V_323 ;
...
static struct V_365 * F_165 ( struct V_300 * V_301 ,
int type , int V_366 )
{
int V_43 ;
struct V_367 * V_360 = V_301 -> V_348 ;
struct V_365 * V_190 ;
for ( V_43 = 0 ; V_43 < V_360 -> V_201 . V_368 ; V_43 ++ ) {
V_190 = & V_360 -> V_369 [ V_43 ] . V_201 ;
if ( ( ( V_190 -> V_90 & V_370 ) == V_366 ) &&
( F_191 ( V_190 ) == type ) )
return V_190 ;
}
return NULL ;
}
static int F_180 ( struct V_300 * V_301 , unsigned char * V_371 )
{
int V_43 ;
struct V_367 * V_360 = V_301 -> V_348 ;
if ( V_360 -> V_372 == 3 ) {
