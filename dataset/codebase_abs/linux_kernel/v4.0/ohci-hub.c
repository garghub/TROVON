...
V_24 |= V_118 ;
V_101 -> V_119 = F_40 ( V_24 ) ;
V_102 = F_41 ( V_2 ) ;
memset ( V_101 -> V_120 . V_121 . V_122 , 0xff ,
sizeof( V_101 -> V_120 . V_121 . V_122 ) ) ;
V_101 -> V_120 . V_121 . V_122 [ 0 ] = V_102 & V_123 ;
if ( V_2 -> V_25 > 7 ) {
V_101 -> V_120 . V_121 . V_122 [ 1 ] = ( V_102 & V_123 ) >> 8 ;
V_101 -> V_120 . V_121 . V_122 [ 2 ] = 0xff ;
} else
V_101 -> V_120 . V_121 . V_122 [ 1 ] = 0xff ;
}
static int F_42 ( struct V_41 * V_42 , unsigned V_124 )
{
struct V_1 * V_2 = F_19 ( V_42 ) ;
T_3 V_5 ;
if ( ! V_124 )
return - V_125 ;
V_124 -- ;
V_5 = F_2 ( V_2 , & V_2 -> V_7 -> V_21 . V_22 [ V_124 ] ) ;
if ( ! ( V_5 & V_93 ) )
return - V_126 ;
F_4 ( V_2 , V_127 , & V_2 -> V_7 -> V_21 . V_22 [ V_124 ] ) ;
return 0 ;
}
static inline int F_43 ( struct V_1 * V_2 , unsigned V_124 )
{
T_1 T_2 * V_20 = & V_2 -> V_7 -> V_21 . V_22 [ V_124 ] ;
T_3 V_24 = 0 ;
T_4 V_128 = F_2 ( V_2 , & V_2 -> V_7 -> V_129 ) ;
T_4 V_130 = V_128 + V_131 ;
int V_132 = F_44 ( V_131 , V_133 ) ;
do {
int V_134 ;
V_134 = V_133 * 2 ;
while ( -- V_134 >= 0 ) {
...
F_4 ( V_2 , V_127 , V_20 ) ;
F_6 ( V_133 ) ;
V_128 = F_2 ( V_2 , & V_2 -> V_7 -> V_129 ) ;
} while ( F_46 ( V_128 , V_130 ) && -- V_132 >= 0 );
return 0 ;
}
int F_47 (
struct V_41 * V_42 ,
...
F_4 ( V_2 , V_24 ,
& V_2 -> V_7 -> V_21 . V_22 [ V_137 ] ) ;
break;
case V_155 :
F_39 ( V_2 , (struct V_100 * ) V_85 ) ;
break;
case V_156 :
V_24 = F_34 ( V_2 ) & ~ ( V_157 | V_158 ) ;
F_48 ( V_24 , V_85 ) ;
break;
case V_159 :
if ( ! V_137 || V_137 > V_139 )
