...
int V_202 = 0 , V_308 = 0 ;
F_177 ( & V_2 -> V_257 ) ;
while ( V_304 [ V_308 ] != V_307 ) {
V_202 = F_201 ( V_9 , V_304 [ V_308 ] ) ;
if ( ! V_202 )
break;
V_308 ++ ;
}
...
V_9 -> V_185 . V_258 . V_309 ( V_9 , 0 , V_9 -> V_185 . V_269 , 0 ) ;
else
V_9 -> V_185 . V_258 . V_309 ( V_9 , 0 , V_9 -> V_185 . V_310 , 0 ) ;
F_178 ( & V_2 -> V_257 ) ;
F_7 () ;
F_8 ( V_3 , & V_2 -> V_4 ) ;
F_188 ( V_2 ) ;
...
memset ( V_90 -> V_314 , 0 , V_90 -> V_130 ) ;
}
...
memset ( V_28 -> V_314 , 0 , V_28 -> V_130 ) ;
}
...
struct V_8 * V_9 = & V_2 -> V_9 ;
struct V_51 * V_39 = V_2 -> V_39 ;
if ( V_9 -> V_185 . V_258 . V_316 ( V_9 ) ) {
F_136 ( V_9 , L_25 ) ;
} else {
V_9 -> V_185 . V_258 . V_317 ( V_9 ) ;
F_200 ( V_2 ) ;
}
if ( F_203 ( V_2 -> V_9 . V_185 . V_269 ) ) {
memcpy ( V_39 -> V_147 , V_2 -> V_9 . V_185 . V_269 ,
V_39 -> V_318 ) ;
memcpy ( V_39 -> V_310 , V_2 -> V_9 . V_185 . V_269 ,
V_39 -> V_318 ) ;
}
V_2 -> V_319 = V_74 ;
}
...
int V_321 ;
V_321 = V_322 ;
V_320 = F_224 ( V_2 -> V_12 , V_2 -> V_209 ,
V_321 , V_320 ) ;
if ( V_320 < 0 ) {
F_10 ( & V_2 -> V_12 -> V_13 ,
L_26 ) ;
...
T_6 V_323 = F_227 ( T_6 , F_228 () , V_324 ) ;
switch ( V_9 -> V_325 ) {
case V_305 :
V_2 -> V_196 = V_323 ;
V_2 -> V_198 = V_323 ;
...
int V_202 = 0 ;
int V_204 , V_331 ;
V_331 = F_115 ( V_2 -> V_196 , V_2 -> V_198 ) ;
V_331 = F_227 ( int , V_331 , F_228 () ) ;
V_331 += V_166 ;
V_2 -> V_209 = F_232 ( V_331 ,
sizeof( struct V_207 ) , V_326 ) ;
if ( ! V_2 -> V_209 ) {
V_202 = - V_330 ;
goto V_203;
}
for ( V_204 = 0 ; V_204 < V_331 ; V_204 ++ )
V_2 -> V_209 [ V_204 ] . V_208 = V_204 ;
V_202 = F_223 ( V_2 , V_331 ) ;
if ( V_202 )
goto V_203;
...
int V_271 , V_332 ;
struct V_52 * V_53 ;
V_332 = V_2 -> V_165 - V_166 ;
for ( V_271 = 0 ; V_271 < V_332 ; V_271 ++ ) {
V_53 = F_230 ( sizeof( struct V_52 ) , V_326 ) ;
if ( ! V_53 )
goto V_333;
V_53 -> V_2 = V_2 ;
V_53 -> V_154 = V_271 ;
...
{
int V_271 , V_332 = V_2 -> V_165 - V_166 ;
for ( V_271 = 0 ; V_271 < V_332 ; V_271 ++ ) {
...
V_9 -> V_274 . V_258 . V_347 ( V_9 ) ;
V_9 -> V_185 . V_348 = 2 ;
V_9 -> V_185 . V_349 = 2 ;
F_246 ( & V_2 -> V_257 ) ;
V_202 = V_9 -> V_185 . V_258 . V_316 ( V_9 ) ;
if ( V_202 ) {
F_247 ( & V_12 -> V_13 ,
L_35 ) ;
} else {
...
F_200 ( V_2 ) ;
V_202 = V_9 -> V_185 . V_258 . V_350 ( V_9 , V_9 -> V_185 . V_269 ) ;
if ( V_202 )
F_247 ( & V_12 -> V_13 , L_37 ) ;
else if ( F_248 ( V_2 -> V_9 . V_185 . V_269 ) )
F_247 ( & V_12 -> V_13 ,
L_38 ) ;
memcpy ( V_39 -> V_147 , V_9 -> V_185 . V_269 , V_39 -> V_318 ) ;
}
if ( ! F_203 ( V_39 -> V_147 ) ) {
F_247 ( & V_12 -> V_13 , L_39 ) ;
F_249 ( V_39 ) ;
memcpy ( V_9 -> V_185 . V_269 , V_39 -> V_147 , V_39 -> V_318 ) ;
}
V_2 -> V_153 = 1 ;
V_2 -> V_168 = 1 ;
V_2 -> V_328 = V_351 ;
...
if ( V_357 -> V_149 . V_36 || V_357 -> V_70 . V_36 )
V_356 |= 1 << V_59 ;
}
...
T_10 V_202 ;
F_177 ( & V_2 -> V_257 ) ;
V_202 = V_9 -> V_185 . V_258 . V_361 ( V_9 , & V_359 , & V_360 , false ) ;
F_178 ( & V_2 -> V_257 ) ;
if ( V_202 && F_258 ( V_74 , V_2 -> V_319 + ( 10 * V_354 ) ) ) {
V_2 -> V_49 |= V_50 ;
V_360 = false ;
}
V_2 -> V_360 = V_360 ;
...
static void F_263 ( struct V_365 * V_366 )
{
struct V_1 * V_2 = F_112 ( V_366 ,
struct V_1 ,
V_7 ) ;
struct V_8 * V_9 = & V_2 -> V_9 ;
if ( F_14 ( V_9 -> V_11 ) ) {
...
if ( ! V_28 -> V_314 )
return;
F_269 ( V_28 -> V_13 , V_28 -> V_130 , V_28 -> V_314 ,
V_28 -> V_33 ) ;
V_28 -> V_314 = NULL ;
}
...
V_28 -> V_314 = F_273 ( V_28 -> V_13 , V_28 -> V_130 ,
& V_28 -> V_33 , V_326 ) ;
if ( ! V_28 -> V_314 )
goto V_202;
return 0 ;
...
V_90 -> V_314 = F_273 ( V_90 -> V_13 , V_90 -> V_130 ,
& V_90 -> V_33 , V_326 ) ;
if ( ! V_90 -> V_314 )
goto V_202;
return 0 ;
...
F_268 ( V_90 -> V_110 ) ;
V_90 -> V_110 = NULL ;
F_269 ( V_90 -> V_13 , V_90 -> V_130 , V_90 -> V_314 ,
V_90 -> V_33 ) ;
V_90 -> V_314 = NULL ;
}
...
struct V_389 * V_390 = F_287 ( V_31 ) ;
V_390 -> V_391 = 0 ;
V_390 -> V_392 = 0 ;
F_288 ( V_31 ) -> V_392 = ~ F_289 ( V_390 -> V_393 ,
V_390 -> V_394 , 0 ,
V_395 ,
0 ) ;
V_375 |= V_396 ;
...
V_374 |= F_295 ( V_31 ) ;
V_375 |= V_396 ;
V_408 = F_287 ( V_31 ) -> V_98 ;
break;
case F_66 ( V_409 ) :
V_374 |= F_295 ( V_31 ) ;
V_408 = F_291 ( V_31 ) -> V_410 ;
break;
default:
if ( F_16 ( F_298 () ) ) {
F_299 ( V_28 -> V_13 ,
...
if ( F_42 ( ! V_121 ) )
break;
V_55 -> V_111 . V_432 = V_416 | F_40 ( V_130 ) ;
V_59 ++ ;
V_55 ++ ;
if ( V_59 == V_28 -> V_43 ) {
V_55 = F_38 ( V_28 , 0 ) ;
...
#endif
T_2 V_384 = 0 ;
T_2 * V_436 = F_313 ( V_31 , 0 , 0 , NULL ) ;
if ( ! V_436 || F_314 ( V_436 ) ) {
F_208 ( V_31 ) ;
return V_437 ;
}
V_28 = V_2 -> V_28 [ V_31 -> V_438 ] ;
#if V_105 > V_431
for ( V_435 = 0 ; V_435 < F_80 ( V_31 ) -> V_134 ; V_435 ++ )
V_43 += F_312 ( F_80 ( V_31 ) -> V_117 [ V_435 ] . V_130 ) ;
#else
...
V_383 -> V_397 = V_397 ;
V_383 -> V_98 = F_317 ( V_31 ) ;
V_434 = F_284 ( V_28 , V_383 , & V_384 ) ;
if ( V_434 < 0 )
goto V_442;
else if ( ! V_434 )
F_297 ( V_28 , V_383 ) ;
F_302 ( V_28 , V_383 , V_384 ) ;
F_310 ( V_28 , V_443 ) ;
return V_437 ;
V_442:
F_22 ( V_383 -> V_31 ) ;
...
static int F_318 ( struct V_51 * V_39 , void * V_444 )
{
struct V_1 * V_2 = F_30 ( V_39 ) ;
struct V_8 * V_9 = & V_2 -> V_9 ;
struct V_445 * V_269 = V_444 ;
if ( ! F_203 ( V_269 -> V_446 ) )
return - V_447 ;
memcpy ( V_39 -> V_147 , V_269 -> V_446 , V_39 -> V_318 ) ;
memcpy ( V_9 -> V_185 . V_269 , V_269 -> V_446 , V_39 -> V_318 ) ;
F_177 ( & V_2 -> V_257 ) ;
V_9 -> V_185 . V_258 . V_309 ( V_9 , 0 , V_9 -> V_185 . V_269 , 0 ) ;
F_178 ( & V_2 -> V_257 ) ;
return 0 ;
}
static int F_319 ( struct V_51 * V_39 , int V_448 )
{
struct V_1 * V_2 = F_30 ( V_39 ) ;
struct V_8 * V_9 = & V_2 -> V_9 ;
int V_449 = V_448 + V_254 + V_255 ;
int V_450 = V_451 ;
...
static int F_321 ( struct V_337 * V_12 , T_12 V_4 )
{
...
static int F_327 ( struct V_337 * V_12 )
{
struct V_51 * V_39 = F_322 ( V_12 ) ;
struct V_1 * V_2 = F_30 ( V_39 ) ;
T_1 V_202 ;
...
static void F_332 ( struct V_337 * V_12 )
{
F_321 ( V_12 , V_457 ) ;
}
static struct V_458 * F_333 ( struct V_51 * V_39 ,
struct V_458 * V_37 )
{
struct V_1 * V_2 = F_30 ( V_39 ) ;
unsigned int V_459 ;
...
int V_59 ;
F_250 ( V_2 ) ;
V_37 -> V_460 = V_2 -> V_37 . V_290 - V_2 -> V_37 . V_291 ;
for ( V_59 = 0 ; V_59 < V_2 -> V_196 ; V_59 ++ ) {
V_36 = V_2 -> V_90 [ V_59 ] ;
do {
V_459 = F_334 ( & V_36 -> V_68 ) ;
V_69 = V_36 -> V_37 . V_69 ;
V_38 = V_36 -> V_37 . V_38 ;
} while ( F_335 ( & V_36 -> V_68 , V_459 ) );
V_37 -> V_461 += V_69 ;
V_37 -> V_462 += V_38 ;
}
for ( V_59 = 0 ; V_59 < V_2 -> V_198 ; V_59 ++ ) {
...
static int F_338 ( struct V_337 * V_12 , const struct V_468 * V_469 )
{
struct V_51 * V_39 ;
struct V_1 * V_2 = NULL ;
struct V_8 * V_9 = NULL ;
...
V_202 = F_341 ( V_12 , V_477 ) ;
if ( V_202 ) {
F_10 ( & V_12 -> V_13 , L_61 , V_202 ) ;
goto V_478;
}
F_330 ( V_12 ) ;
...
F_336 ( V_39 ) ;
memcpy ( & V_9 -> V_185 . V_258 , V_471 -> V_485 , sizeof( V_9 -> V_185 . V_258 ) ) ;
V_9 -> V_185 . type = V_471 -> V_185 ;
memcpy ( & V_9 -> V_274 . V_258 , & V_486 ,
sizeof( struct V_487 ) ) ;
V_202 = F_245 ( V_2 ) ;
if ( V_202 )
goto V_488;
...
F_214 ( V_39 ) ;
F_199 ( V_2 ) ;
F_247 ( & V_12 -> V_13 , L_64 , V_39 -> V_147 ) ;
F_247 ( & V_12 -> V_13 , L_65 , V_9 -> V_185 . type ) ;
switch ( V_9 -> V_185 . type ) {
case V_252 :
F_247 ( & V_12 -> V_13 , L_66 ) ;
break;
case V_503 :
F_247 ( & V_12 -> V_13 , L_67 ) ;
break;
case V_453 :
default:
F_247 ( & V_12 -> V_13 , L_68 ) ;
break;
}
return 0 ;
V_502:
...
static void F_355 ( struct V_337 * V_12 )
{
struct V_51 * V_39 = F_322 ( V_12 ) ;
struct V_1 * V_2 ;
bool V_475 ;
...
static T_13 F_358 ( struct V_337 * V_12 ,
T_14 V_4 )
{
struct V_51 * V_39 = F_322 ( V_12 ) ;
struct V_1 * V_2 = F_30 ( V_39 ) ;
...
static void F_360 ( struct V_337 * V_12 )
{
struct V_51 * V_39 = F_322 ( V_12 ) ;
struct V_1 * V_2 = F_30 ( V_39 ) ;
if ( F_281 ( V_39 ) )
