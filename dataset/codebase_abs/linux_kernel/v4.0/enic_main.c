...
if ( V_8 == V_155 )
memset ( V_26 -> V_139 , 0 , V_157 ) ;
}
} else {
V_154 -> V_166 |= V_182 ;
if ( V_154 -> V_168 == V_183 ) {
memset ( V_154 -> V_180 , 0 , V_157 ) ;
if ( V_8 == V_155 )
memset ( V_26 -> V_139 , 0 , V_157 ) ;
}
}
if ( V_8 == V_155 )
memset ( V_154 -> V_156 , 0 , V_157 ) ;
return V_69 ;
}
static int F_126 ( struct V_36 * V_26 , int V_8 ,
struct V_56 * V_57 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
T_2 V_184 = V_185 ;
...
return - V_186 ;
V_69 = F_127 ( V_1 , V_8 , V_154 -> V_168 , & V_184 ) ;
if ( V_69 )
return V_69 ;
if ( F_128 ( V_57 , V_164 , V_154 -> V_168 ) ||
F_128 ( V_57 , V_187 , V_184 ) ||
( ( V_154 -> V_166 & V_170 ) &&
F_129 ( V_57 , V_169 , V_172 , V_154 -> V_171 ) ) ||
( ( V_154 -> V_166 & V_174 ) &&
F_129 ( V_57 , V_173 , V_176 ,
V_154 -> V_175 ) ) ||
( ( V_154 -> V_166 & V_178 ) &&
F_129 ( V_57 , V_177 , V_176 , V_154 -> V_179 ) ) )
goto V_188;
return 0 ;
V_188:
return - V_189 ;
}
static void F_130 ( struct V_190 * V_33 , struct V_191 * V_13 )
{
...
static int F_131 ( struct V_190 * V_33 )
{
struct V_1 * V_1 = F_7 ( V_33 -> V_14 ) ;
struct V_36 * V_26 = V_1 -> V_26 ;
struct V_56 * V_57 ;
...
if ( V_13 -> V_19 ) {
F_132 ( V_33 , V_13 -> V_19 , V_194 , V_13 -> V_16 ,
V_13 -> V_17 ) ;
return 0 ;
}
V_57 = F_133 ( V_26 , V_17 ) ;
if ( ! V_57 )
return - V_64 ;
...
static bool F_135 ( struct V_36 * V_26 , struct V_56 * * V_57 ,
...
if ( V_17 > V_1 -> V_202 )
return false ;
V_201 = F_133 ( V_26 , V_17 ) ;
if ( ! V_201 )
return false ;
F_136 ( V_1 -> V_2 , V_13 -> V_16 , V_17 ,
V_203 ) ;
memcpy ( V_201 -> V_44 , ( * V_57 ) -> V_44 , V_17 ) ;
* V_57 = V_201 ;
return true ;
}
static void F_137 ( struct V_190 * V_33 ,
...
struct V_36 * V_26 = V_1 -> V_26 ;
struct V_56 * V_57 ;
struct V_205 * V_206 = & V_1 -> V_206 [ F_138 ( V_1 , V_33 -> V_207 ) ] ;
...
if ( V_68 && V_227 > 0 ) {
if ( ! F_135 ( V_26 , & V_57 , V_13 , V_227 ) ) {
V_13 -> V_19 = NULL ;
F_8 ( V_1 -> V_2 , V_13 -> V_16 , V_13 -> V_17 ,
V_192 ) ;
}
F_140 ( V_57 -> V_44 - V_232 ) ;
F_141 ( V_57 , V_227 ) ;
V_57 -> V_75 = F_142 ( V_57 , V_26 ) ;
F_143 ( V_57 , V_23 ) ;
if ( V_26 -> V_233 & V_234 ) {
F_144 ( V_57 , V_230 ,
( V_224 &
...
V_57 -> V_86 = V_241 ;
if ( V_210 )
F_145 ( V_57 , F_146 ( V_242 ) , V_228 ) ;
F_147 ( V_57 , & V_1 -> V_54 [ V_33 -> V_207 ] ) ;
if ( F_148 ( V_33 ) ||
! ( V_26 -> V_233 & V_243 ) )
F_149 ( V_57 ) ;
else
F_150 ( & V_1 -> V_54 [ V_23 ] , V_57 ) ;
if ( V_1 -> V_244 . V_245 )
F_134 ( & V_206 -> V_246 ,
V_227 ) ;
} else {
...
static int F_153 ( struct V_55 * V_54 , int V_248 )
{
struct V_36 * V_26 = V_54 -> V_62 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_249 = F_138 ( V_1 , 0 ) ;
unsigned int V_250 = F_154 ( V_1 , 0 ) ;
unsigned int V_49 = F_41 () ;
unsigned int V_251 = V_248 ;
unsigned int V_252 = - 1 ;
unsigned int V_253 , V_254 = 0 , V_255 ;
int V_69 ;
V_255 = F_155 ( & V_1 -> V_206 [ V_250 ] , V_252 ,
F_12 , NULL ) ;
if ( ! F_156 ( & V_1 -> V_33 [ V_249 ] ) ) {
if ( V_255 > 0 )
F_157 ( & V_1 -> V_49 [ V_49 ] ,
V_255 ,
0 ,
...
F_160 ( & V_1 -> V_33 [ V_249 ] ) ;
return V_254 ;
}
static void F_161 ( struct V_1 * V_1 , struct V_190 * V_33 )
{
unsigned int V_49 = F_162 ( V_1 , V_33 -> V_207 ) ;
struct V_205 * V_206 = & V_1 -> V_206 [ F_138 ( V_1 , V_33 -> V_207 ) ] ;
T_3 V_256 = V_206 -> V_257 ;
if ( V_206 -> V_257 != V_206 -> V_258 ) {
F_163 ( & V_1 -> V_49 [ V_49 ] , V_256 ) ;
V_206 -> V_258 = V_206 -> V_257 ;
}
}
static void F_164 ( struct V_1 * V_1 , struct V_190 * V_33 )
{
...
{
F_168 ( V_1 -> V_26 -> V_275 ) ;
V_1 -> V_26 -> V_275 = NULL ;
}
static void F_169 ( struct V_1 * V_1 )
{
int V_29 , V_276 ;
if ( F_170 ( V_1 -> V_14 ) == V_277 ) {
V_1 -> V_26 -> V_275 = F_171 ( V_1 -> V_32 ) ;
if ( F_60 ( ! V_1 -> V_26 -> V_275 ) )
return;
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ ) {
V_276 = F_172 ( V_1 -> V_26 -> V_275 ,
...
static int F_173 ( struct V_55 * V_54 )
{
struct V_36 * V_26 = V_54 -> V_62 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_33 = ( V_54 - & V_1 -> V_54 [ 0 ] ) ;
unsigned int V_206 = F_138 ( V_1 , V_33 ) ;
unsigned int V_49 = F_162 ( V_1 , V_33 ) ;
unsigned int V_280 = - 1 ;
unsigned int V_253 ;
if ( ! F_174 ( & V_1 -> V_33 [ V_33 ] ) )
return V_281 ;
V_253 = F_155 ( & V_1 -> V_206 [ V_206 ] , V_280 ,
F_151 , NULL ) ;
if ( V_253 > 0 )
F_157 ( & V_1 -> V_49 [ V_49 ] ,
V_253 , 0 , 0 ) ;
F_158 ( & V_1 -> V_33 [ V_33 ] , F_131 ) ;
if ( V_1 -> V_244 . V_245 )
F_164 ( V_1 , & V_1 -> V_33 [ V_33 ] ) ;
F_175 ( & V_1 -> V_33 [ V_33 ] ) ;
return V_253 ;
}
static int F_176 ( struct V_55 * V_54 , int V_248 )
{
struct V_36 * V_26 = V_54 -> V_62 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
...
unsigned int V_283 ;
V_283 = V_11 -> V_207 ;
V_206 = F_154 ( V_1 , V_283 ) ;
V_49 = F_177 ( V_1 , V_283 ) ;
V_255 = F_155 ( & V_1 -> V_206 [ V_206 ] , V_252 ,
F_12 , NULL ) ;
F_157 ( & V_1 -> V_49 [ V_49 ] , V_255 ,
0 ,
1 ) ;
if ( ! V_255 ) {
F_159 ( V_54 ) ;
...
static int F_178 ( struct V_55 * V_54 , int V_248 )
{
struct V_36 * V_26 = V_54 -> V_62 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_33 = ( V_54 - & V_1 -> V_54 [ 0 ] ) ;
...
int V_69 ;
if ( ! F_156 ( & V_1 -> V_33 [ V_33 ] ) )
return V_248 ;
if ( V_248 > 0 )
V_253 = F_155 ( & V_1 -> V_206 [ V_206 ] ,
V_280 , F_151 , NULL ) ;
if ( V_253 > 0 )
F_157 ( & V_1 -> V_49 [ V_49 ] ,
V_253 ,
0 ,
0 ) ;
V_69 = F_158 ( & V_1 -> V_33 [ V_33 ] , F_131 ) ;
if ( V_69 )
V_253 = V_280 ;
if ( V_1 -> V_244 . V_245 )
F_164 ( V_1 , & V_1 -> V_33 [ V_33 ] ) ;
...
break;
case V_277 :
for ( V_29 = 0 ; V_29 < F_184 ( V_1 -> V_289 ) ; V_29 ++ )
if ( V_1 -> V_289 [ V_29 ] . V_290 )
F_183 ( V_1 -> V_278 [ V_29 ] . V_279 ,
...
switch ( F_170 ( V_1 -> V_14 ) ) {
case V_287 :
V_69 = F_186 ( V_1 -> V_2 -> V_43 , F_39 ,
V_292 , V_26 -> V_171 , V_26 ) ;
break;
case V_288 :
V_69 = F_186 ( V_1 -> V_2 -> V_43 , F_50 ,
0 , V_26 -> V_171 , V_1 ) ;
break;
case V_277 :
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ ) {
...
V_69 = F_186 ( V_1 -> V_278 [ V_29 ] . V_279 ,
...
int V_207 = - 1 ;
struct V_259 * V_260 = & V_1 -> V_244 ;
if ( V_277 != F_170 ( V_1 -> V_14 ) ) {
F_26 ( V_1 -> V_26 , L_16 ) ;
return;
}
V_296 = F_190 ( V_1 -> V_14 ) ;
if ( V_297 < V_296 )
V_207 = V_298 ;
else if ( V_299 < V_296 )
V_207 = V_300 ;
...
V_308:
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ )
F_205 ( & V_1 -> V_33 [ V_29 ] , F_130 ) ;
F_206 ( V_1 ) ;
V_307:
F_182 ( V_1 ) ;
return V_69 ;
}
static int F_207 ( struct V_36 * V_26 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_29 ;
int V_69 ;
...
if ( F_170 ( V_1 -> V_14 ) == V_277 )
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ )
F_212 ( & V_1 -> V_54 [ F_154 ( V_1 , V_29 ) ] ) ;
if ( ! F_1 ( V_1 ) && ! F_3 ( V_1 ) )
F_109 ( V_1 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ ) {
V_69 = F_217 ( & V_1 -> V_11 [ V_29 ] ) ;
if ( V_69 )
return V_69 ;
}
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ ) {
V_69 = F_218 ( & V_1 -> V_33 [ V_29 ] ) ;
if ( V_69 )
return V_69 ;
}
F_206 ( V_1 ) ;
F_182 ( V_1 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ )
F_219 ( & V_1 -> V_11 [ V_29 ] , F_6 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ )
F_205 ( & V_1 -> V_33 [ V_29 ] , F_130 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_309 ; V_29 ++ )
F_220 ( & V_1 -> V_206 [ V_29 ] ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_295 ; V_29 ++ )
F_221 ( & V_1 -> V_49 [ V_29 ] ) ;
return 0 ;
}
static int F_222 ( struct V_36 * V_26 , int V_310 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
...
static void F_223 ( struct V_312 * V_313 )
{
struct V_1 * V_1 = F_224 ( V_313 , struct V_1 , V_40 ) ;
struct V_36 * V_26 = V_1 -> V_26 ;
...
F_44 ( & V_1 -> V_49 [ 0 ] ) ;
F_187 ( V_1 ) ;
V_69 = F_218 ( & V_1 -> V_33 [ 0 ] ) ;
if ( V_69 ) {
F_226 () ;
F_22 ( V_26 , L_21 ) ;
return;
}
F_205 ( & V_1 -> V_33 [ 0 ] , F_130 ) ;
F_220 ( & V_1 -> V_206 [ 0 ] ) ;
F_221 ( & V_1 -> V_49 [ 0 ] ) ;
V_26 -> V_35 = V_310 ;
F_158 ( & V_1 -> V_33 [ 0 ] , F_131 ) ;
...
int V_69 ;
F_231 ( F_232 () ) ;
V_69 = F_229 ( V_14 , V_314 ) ;
if ( V_69 )
return V_69 ;
time = V_285 + ( V_316 * 2 ) ;
do {
V_69 = F_230 ( V_14 , & V_315 ) ;
if ( V_69 )
return V_69 ;
if ( V_315 )
return 0 ;
F_233 ( V_316 / 10 ) ;
} while ( F_234 ( time , V_285 ) );
return - V_317 ;
}
static int F_235 ( struct V_1 * V_1 )
{
int V_69 ;
V_69 = F_228 ( V_1 -> V_14 , V_318 ,
V_319 , 0 ) ;
if ( V_69 )
...
sizeof( union V_322 ) ) ;
F_194 ( & V_1 -> V_306 ) ;
F_242 ( V_1 -> V_2 , sizeof( union V_322 ) ,
V_323 , V_324 ) ;
return V_69 ;
}
static int F_243 ( struct V_1 * V_1 )
{
F_244 ( V_1 -> V_331 , V_327 ) ;
return F_239 ( V_1 ) ;
}
static int F_245 ( struct V_1 * V_1 , T_1 V_332 )
{
T_6 V_333 ;
...
sizeof( union V_334 ) ) ;
F_194 ( & V_1 -> V_306 ) ;
F_242 ( V_1 -> V_2 , sizeof( union V_334 ) ,
V_335 , V_333 ) ;
return V_69 ;
}
static int F_248 ( struct V_1 * V_1 , T_1 V_337 ,
...
const T_1 V_332 = 7 ;
const T_1 V_339 = 0 ;
T_1 V_340 = F_251 ( V_1 , V_345 ) && ( V_1 -> V_32 > 1 ) ;
if ( V_340 ) {
if ( ! F_243 ( V_1 ) ) {
if ( F_245 ( V_1 , V_332 ) ) {
V_340 = 0 ;
...
return F_248 ( V_1 , V_337 , V_338 ,
V_332 , V_339 , V_340 ) ;
}
static void F_253 ( struct V_312 * V_313 )
{
struct V_1 * V_1 = F_224 ( V_313 , struct V_1 , V_52 ) ;
if ( ! F_108 ( V_1 -> V_26 ) )
return;
F_225 () ;
F_13 ( & V_1 -> V_346 ) ;
...
F_196 ( V_1 -> V_26 ) ;
F_19 ( & V_1 -> V_346 ) ;
F_257 ( V_347 , V_1 -> V_26 ) ;
F_226 () ;
}
static int F_258 ( struct V_1 * V_1 )
{
...
unsigned int V_29 ;
F_231 ( F_184 ( V_1 -> V_278 ) < V_348 + V_349 + 2 ) ;
...
V_1 -> V_309 = 2 ;
V_1 -> V_295 = 3 ;
F_260 ( V_1 -> V_14 , V_287 ) ;
return 0 ;
}
F_260 ( V_1 -> V_14 , V_352 ) ;
return - V_159 ;
}
...
if ( F_170 ( V_1 -> V_14 ) == V_277 )
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ )
F_267 ( & V_1 -> V_54 [ F_154 ( V_1 , V_29 ) ] ) ;
F_268 ( V_1 ) ;
F_262 ( V_1 ) ;
}
static void F_269 ( struct V_1 * V_1 )
{
if ( F_270 () ) {
F_271 ( F_237 ( V_1 ) , L_29 ) ;
V_1 -> V_32 = 1 ;
V_1 -> V_31 = 1 ;
...
switch ( F_170 ( V_1 -> V_14 ) ) {
default:
F_278 ( V_26 , & V_1 -> V_54 [ 0 ] , F_153 , 64 ) ;
F_279 ( & V_1 -> V_54 [ 0 ] ) ;
break;
case V_277 :
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ ) {
F_278 ( V_26 , & V_1 -> V_54 [ V_29 ] ,
F_178 , V_358 ) ;
F_279 ( & V_1 -> V_54 [ V_29 ] ) ;
}
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ )
F_278 ( V_26 , & V_1 -> V_54 [ F_154 ( V_1 , V_29 ) ] ,
F_176 , V_358 ) ;
break;
}
return 0 ;
...
{
unsigned int V_29 ;
for ( V_29 = 0 ; V_29 < F_184 ( V_1 -> V_359 ) ; V_29 ++ )
if ( V_1 -> V_359 [ V_29 ] . V_360 )
F_281 ( V_1 -> V_359 [ V_29 ] . V_360 ) ;
}
static int F_282 ( struct V_361 * V_2 , const struct V_362 * V_363 )
{
...
V_69 = F_287 ( V_2 , V_370 ) ;
if ( V_69 ) {
F_236 ( V_62 , L_38 ) ;
goto V_371;
}
F_288 ( V_2 ) ;
V_69 = F_289 ( V_2 , F_290 ( 64 ) ) ;
if ( V_69 ) {
V_69 = F_289 ( V_2 , F_290 ( 32 ) ) ;
if ( V_69 ) {
F_236 ( V_62 , L_39 ) ;
goto V_372;
}
V_69 = F_291 ( V_2 , F_290 ( 32 ) ) ;
if ( V_69 ) {
F_236 ( V_62 , L_40
L_41 , 32 ) ;
goto V_372;
...
for ( V_29 = 0 ; V_29 < F_184 ( V_1 -> V_359 ) ; V_29 ++ ) {
if ( ! ( F_292 ( V_2 , V_29 ) & V_373 ) )
continue;
V_1 -> V_359 [ V_29 ] . V_17 = F_293 ( V_2 , V_29 ) ;
V_1 -> V_359 [ V_29 ] . V_360 = F_294 ( V_2 , V_29 , V_1 -> V_359 [ V_29 ] . V_17 ) ;
if ( ! V_1 -> V_359 [ V_29 ] . V_360 ) {
F_236 ( V_62 , L_42 , V_29 ) ;
V_69 = - V_374 ;
goto V_375;
}
V_1 -> V_359 [ V_29 ] . V_376 = F_295 ( V_2 , V_29 ) ;
}
V_1 -> V_14 = F_296 ( NULL , V_1 , V_2 , V_1 -> V_359 ,
F_184 ( V_1 -> V_359 ) ) ;
if ( ! V_1 -> V_14 ) {
F_236 ( V_62 , L_43 ) ;
V_69 = - V_374 ;
...
#ifdef F_5
V_365 = F_297 ( V_2 , V_377 ) ;
if ( V_365 ) {
F_298 ( V_2 , V_365 + V_378 ,
& V_1 -> V_9 ) ;
if ( V_1 -> V_9 ) {
V_69 = F_299 ( V_2 , V_1 -> V_9 ) ;
if ( V_69 ) {
F_236 ( V_62 , L_44
L_45 ,
V_69 ) ;
...
#endif
V_1 -> V_154 = F_300 ( V_366 , sizeof( * V_1 -> V_154 ) , V_380 ) ;
if ( ! V_1 -> V_154 ) {
V_69 = - V_64 ;
goto V_381;
}
...
F_304 ( V_26 , V_1 -> V_32 ) ;
F_305 ( & V_1 -> V_284 ) ;
V_1 -> V_284 . V_384 = F_179 ;
V_1 -> V_284 . V_44 = ( unsigned long ) V_1 ;
F_189 ( V_1 ) ;
F_306 ( & V_1 -> V_52 , F_253 ) ;
F_306 ( & V_1 -> V_40 , F_223 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ )
F_301 ( & V_1 -> V_25 [ V_29 ] ) ;
...
static void F_317 ( struct V_361 * V_2 )
{
struct V_36 * V_26 = F_318 ( V_2 ) ;
if ( V_26 ) {
struct V_1 * V_1 = F_40 ( V_26 ) ;
F_319 ( & V_1 -> V_52 ) ;
F_319 ( & V_1 -> V_40 ) ;
...
static int T_10 F_321 ( void )
{
F_322 ( L_53 , V_408 , V_409 ) ;
return F_323 ( & V_410 ) ;
}
