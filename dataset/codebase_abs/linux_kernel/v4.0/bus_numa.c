...
struct V_1 T_1 * F_9 ( int V_25 , int V_26 ,
int V_7 , int V_27 )
{
struct V_1 * V_3 ;
V_3 = F_10 ( sizeof( * V_3 ) , V_28 ) ;
if ( ! V_3 )
return V_3 ;
...
void F_13 ( struct V_1 * V_3 , T_2 V_5 ,
...
if ( V_17 -> V_18 != V_18 )
continue;
V_38 = F_14 ( V_17 -> V_5 , V_5 ) ;
V_39 = F_15 ( V_17 -> V_30 , V_30 ) ;
if ( V_38 > V_39 + 1 )
continue;
V_36 = F_15 ( V_17 -> V_5 , V_5 ) ;
V_37 = F_14 ( V_17 -> V_30 , V_30 ) ;
V_17 -> V_5 = V_36 ;
V_17 -> V_30 = V_37 ;
return;
}
V_35:
V_11 = F_10 ( sizeof( * V_11 ) , V_28 ) ;
if ( ! V_11 )
return;
V_17 = & V_11 -> V_17 ;
V_17 -> V_29 = V_3 -> V_29 ;
