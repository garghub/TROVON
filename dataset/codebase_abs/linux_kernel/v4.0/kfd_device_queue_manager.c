...
struct V_13 * V_14 )
{
return V_15 -> F_6 ( V_7 -> V_8 -> V_16 , V_14 -> V_17 ,
V_14 -> V_18 ,
V_14 -> V_19 ,
V_14 -> V_20 ,
V_14 -> V_21 ) ;
...
{
V_61 V_86 ;
V_86 = ( V_32 == 0 ) ? 0 : ( V_61 ) V_32 |
V_87 ;
return V_15 -> F_11 ( V_7 -> V_8 -> V_16 , V_86 ,
V_17 ) ;
}
...
F_10 ( L_15 , V_23 -> V_66 ) ;
F_10 ( L_16 , V_23 -> V_30 . V_104 ) ;
F_10 ( L_17 , V_23 -> V_30 . V_111 ) ;
F_51 ( V_7 , V_23 , V_14 ) ;
V_33 = V_53 -> V_57 ( V_53 , & V_23 -> V_53 , & V_23 -> V_58 ,
& V_23 -> V_59 , & V_23 -> V_30 ) ;
if ( V_33 != 0 ) {
