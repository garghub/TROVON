...
== V_157 ) {
V_2 = ( F_70 ( V_150 -> V_158 ) & V_87 ) ?
V_72 : V_32 ;
V_1 = F_70 ( V_150 -> V_158 ) & V_159 ;
...
__acquires( V_54 -> V_125 )
{
struct V_55 * V_56 , * V_166 ;
struct V_53 * V_167 = V_54 ;
int V_137 = 0 ;
...
if ( ( V_54 -> type == V_112 ) &&
V_56 -> V_74 . V_57 )
V_167 = V_54 -> V_4 -> V_136 ;
F_51 ( & V_167 -> V_75 , & V_56 -> V_74 ) ;
F_52 ( V_54 -> V_125 ) ;
}
}
if ( V_137 == - V_118 )
...
type = V_74 . V_152 ;
V_4 -> V_144 = ( type & V_170 ) ? V_72 : V_32 ;
switch ( V_74 . V_171 ) {
case V_172 :
if ( type == ( V_173 | V_157 ) &&
F_70 ( V_74 . V_174 ) ==
...
if ( type != ( V_173 | V_154 ) )
goto V_179;
if ( F_70 ( V_74 . V_176 ) != 0 ||
F_70 ( V_74 . V_158 ) != 0 )
break;
V_4 -> V_163 = ( T_2 ) F_70 ( V_74 . V_174 ) ;
V_4 -> V_162 = true ;
V_168 = F_74 ( V_4 ) ;
break;
case V_183 :
...
if ( V_74 . V_176 != 0 )
break;
switch ( F_70 ( V_74 . V_174 ) ) {
case V_178 :
V_4 -> V_133 = 1 ;
V_168 = F_74 ( V_4 ) ;
break;
case V_184 :
V_169 = F_70 ( V_74 . V_158 ) >> 8 ;
switch ( V_169 ) {
case V_185 :
case V_186 :
case V_187 :
...
V_4 -> V_144 = V_72 ;
F_50 ( & V_4 -> V_125 ) ;
V_168 = V_4 -> V_138 -> V_150 ( & V_4 -> V_94 , & V_74 ) ;
F_52 ( & V_4 -> V_125 ) ;
break;
}
if ( V_168 < 0 ) {
...
static int F_82 ( struct V_129 * V_75 ,
const struct V_193 * V_143 )
{
struct V_53 * V_54 = F_54 ( V_75 , struct V_53 , V_75 ) ;
int V_137 = 0 ;
unsigned long V_130 ;
...
if ( ! F_32 ( & V_54 -> V_101 . V_102 ) )
F_67 ( V_54 -> V_4 -> V_139 , L_7 ) ;
V_54 -> V_2 = F_83 ( V_143 ) ? V_72 : V_32 ;
V_54 -> V_1 = F_84 ( V_143 ) ;
V_54 -> type = F_85 ( V_143 ) ;
V_54 -> V_75 . V_76 = F_86 ( V_143 ) & 0x07ff ;
V_54 -> V_75 . V_146 = F_87 ( F_86 ( V_143 ) ) ;
if ( V_54 -> type == V_112 )
V_110 |= V_194 ;
V_110 |= V_195 ;
...
static int F_88 ( struct V_129 * V_75 )
{
struct V_53 * V_54 = F_54 ( V_75 , struct V_53 , V_75 ) ;
int V_197 , V_137 = 0 ;
unsigned long V_130 ;
...
static struct V_140 * F_89 ( struct V_129 * V_75 , T_3 V_142 )
{
...
static void F_90 ( struct V_129 * V_75 , struct V_140 * V_74 )
{
struct V_53 * V_54 = F_54 ( V_75 , struct V_53 , V_75 ) ;
struct V_55 * V_56 = F_54 ( V_74 , struct V_55 , V_74 ) ;
struct V_60 * V_62 , * V_116 ;
...
static int F_92 ( struct V_129 * V_75 , struct V_140 * V_74 )
{
struct V_53 * V_54 = F_54 ( V_75 , struct V_53 , V_75 ) ;
struct V_55 * V_56 = F_54 ( V_74 , struct V_55 , V_74 ) ;
unsigned long V_130 ;
...
static int F_94 ( struct V_129 * V_75 , int V_36 )
{
struct V_53 * V_54 = F_54 ( V_75 , struct V_53 , V_75 ) ;
int V_197 , V_137 = 0 ;
unsigned long V_130 ;
...
static int F_96 ( struct V_129 * V_75 )
{
struct V_53 * V_54 = F_54 ( V_75 , struct V_53 , V_75 ) ;
unsigned long V_130 ;
if ( V_75 == NULL || V_54 -> V_75 . V_143 == NULL )
...
static void F_97 ( struct V_129 * V_75 )
{
struct V_53 * V_54 = F_54 ( V_75 , struct V_53 , V_75 ) ;
unsigned long V_130 ;
if ( V_75 == NULL ) {
F_64 ( V_54 -> V_4 -> V_139 , L_10 , F_36 ( V_54 ) ) ;
return;
}
F_55 ( V_54 -> V_125 , V_130 ) ;
F_5 ( V_54 -> V_4 , V_54 -> V_1 , V_54 -> V_2 ) ;
...
static int F_98 ( struct V_128 * V_201 , int V_202 )
{
...
static int F_102 ( struct V_128 * V_201 )
{
struct V_3 * V_4 = F_54 ( V_201 , struct V_3 , V_94 ) ;
unsigned long V_130 ;
int V_88 = 0 ;
...
static int F_103 ( struct V_128 * V_201 , unsigned V_214 )
{
struct V_3 * V_4 = F_54 ( V_201 , struct V_3 , V_94 ) ;
if ( V_4 -> V_215 )
return F_104 ( V_4 -> V_215 , V_214 ) ;
return - V_216 ;
}
static int F_105 ( struct V_128 * V_201 , int V_217 )
{
struct V_3 * V_4 = F_54 ( V_201 , struct V_3 , V_94 ) ;
struct V_53 * V_54 = V_4 -> V_136 ;
unsigned long V_130 ;
...
static int F_106 ( struct V_128 * V_201 , int V_217 )
{
struct V_3 * V_4 = F_54 ( V_201 , struct V_3 , V_94 ) ;
if ( ! V_4 -> V_204 )
return - V_199 ;
...
F_108 ( V_54 -> V_220 , sizeof( V_54 -> V_220 ) , L_11 , V_58 ,
( V_218 == V_72 ) ? L_12 : L_13 ) ;
V_54 -> V_4 = V_4 ;
V_54 -> V_125 = & V_4 -> V_125 ;
V_54 -> V_66 = V_4 -> V_66 ;
V_54 -> V_75 . V_220 = V_54 -> V_220 ;
V_54 -> V_75 . V_221 = & V_222 ;
F_109 ( & V_54 -> V_75 , ( unsigned short ) ~ 0 ) ;
...
if ( V_138 -> V_206 == NULL )
return - V_37 ;
V_4 -> V_135 -> V_75 . V_143 = & V_228 ;
V_137 = F_112 ( & V_4 -> V_135 -> V_75 ) ;
if ( V_137 )
return V_137 ;
V_4 -> V_136 -> V_75 . V_143 = & V_229 ;
V_137 = F_112 ( & V_4 -> V_136 -> V_75 ) ;
if ( V_137 )
return V_137 ;
V_4 -> V_138 = V_138 ;
if ( F_80 ( V_4 ) && V_4 -> V_230 . V_231 ) {
F_113 ( V_4 ) ;
return V_137 ;
}
F_99 ( & V_4 -> V_94 . V_139 ) ;
...
static int F_114 ( struct V_128 * V_94 )
{
struct V_3 * V_4 = F_54 ( V_94 , struct V_3 , V_94 ) ;
unsigned long V_130 ;
F_55 ( & V_4 -> V_125 , V_130 ) ;
...
{
struct V_244 * V_139 = V_4 -> V_139 ;
int V_137 = 0 ;
F_118 ( & V_4 -> V_125 ) ;
V_4 -> V_94 . V_221 = & V_245 ;
V_4 -> V_94 . V_131 = V_132 ;
V_4 -> V_94 . V_246 = V_239 ;
V_4 -> V_94 . V_247 = V_4 -> V_247 ? 1 : 0 ;
V_4 -> V_94 . V_220 = V_4 -> V_207 -> V_220 ;
F_34 ( & V_4 -> V_94 . V_226 ) ;
V_4 -> V_223 = F_119 ( L_14 , V_139 ,
sizeof( struct V_248 ) ,
64 , V_81 ) ;
if ( V_4 -> V_223 == NULL )
return - V_64 ;
V_4 -> V_66 = F_119 ( L_15 , V_139 ,
sizeof( struct V_67 ) ,
64 , V_81 ) ;
if ( V_4 -> V_66 == NULL ) {
V_137 = - V_64 ;
...
if ( V_137 )
goto V_250;
V_4 -> V_94 . V_251 = & V_4 -> V_136 -> V_75 ;
V_137 = F_120 ( V_139 , & V_4 -> V_94 ) ;
if ( V_137 )
goto F_110;
F_121 ( & V_4 -> V_94 . V_139 ) ;
F_122 ( & V_4 -> V_94 . V_139 ) ;
return V_137 ;
F_110:
F_110 ( V_4 ) ;
V_250:
...
{
if ( V_4 -> V_247 )
F_127 ( V_4 , V_255 | V_254 , V_254 ) ;
}
int F_129 ( struct V_3 * V_4 )
{
struct V_256 * V_257 ;
if ( ! F_7 ( V_4 , V_258 , V_259 ) )
return - V_260 ;
V_257 = F_130 ( V_4 -> V_139 , sizeof( struct V_256 ) , V_224 ) ;
if ( ! V_257 )
return - V_64 ;
V_257 -> V_261 = F_126 ;
V_257 -> V_262 = F_128 ;
