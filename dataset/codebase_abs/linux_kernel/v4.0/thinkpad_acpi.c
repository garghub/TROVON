...
switch ( V_342 >> 12 ) {
case 1 :
V_397 = F_190 ( V_342 , & V_366 ,
& V_367 ) ;
break;
case 2 :
V_397 = F_191 ( V_342 , & V_366 ,
& V_367 ) ;
break;
case 3 :
switch ( V_342 ) {
...
break;
case 4 :
V_397 = F_193 ( V_342 , & V_366 ,
& V_367 ) ;
break;
case 5 :
V_397 = F_194 ( V_342 , & V_366 ,
& V_367 ) ;
break;
case 6 :
V_397 = F_195 ( V_342 , & V_366 ,
& V_367 ) ;
break;
case 7 :
if ( V_186 . V_187 &&
...
static int F_209 ( enum V_405 V_205 )
{
int V_30 ;
F_17 ( V_140 ,
L_174 ,
...
{
return F_83 ( V_407 , V_91 ) ;
}
static int F_217 ( char * V_126 )
{
return F_85 ( V_407 , V_126 ) ;
}
...
static int F_219 ( enum V_405 V_205 )
{
int V_30 ;
F_17 ( V_140 ,
L_184 ,
...
static int F_228 ( enum V_405 V_205 )
{
int V_30 ;
F_17 ( V_140 ,
L_194 ,
...
if ( F_6 () )
F_182 ( V_434 ) ;
if ( V_435 && F_7 ( NULL , & V_432 , L_201 , L_64 ) && V_432 )
V_436 = V_435 ;
if ( ! V_436 )
V_437 = V_438 ;
else if ( F_6 () &&
F_7 ( V_436 , & V_439 , L_202 , L_107 ) )
V_437 = V_440 ;
else if ( F_6 () &&
F_7 ( V_436 , & V_439 , L_203 , L_107 ) )
V_437 = V_441 ;
else
V_437 = V_442 ;
F_17 ( V_55 , L_204 ,
...
switch ( V_437 ) {
case V_440 :
if ( ! F_7 ( V_436 , & V_449 , L_202 , L_64 ) )
return - V_50 ;
break;
case V_441 :
case V_442 :
if ( ! F_7 ( V_436 , & V_449 , L_217 , L_64 ) )
return - V_50 ;
break;
default:
return - V_448 ;
...
{
if ( ! F_7 ( V_436 , NULL , L_218 , L_9 , ( V_204 ) ? 1 : 0 ) )
return - V_50 ;
return 0 ;
}
...
if ( V_17 )
return V_17 ;
V_17 = F_7 ( V_452 , NULL , L_219 , L_220 ) ;
break;
case V_441 :
case V_442 :
V_17 = F_233 ( 1 ) ;
if ( V_17 )
return V_17 ;
V_17 = F_7 ( V_436 , NULL , L_221 , L_220 ) ;
break;
default:
return - V_448 ;
}
...
switch ( V_437 ) {
case V_440 :
return F_7 ( V_452 , NULL , L_222 , L_220 ) ?
0 : - V_50 ;
case V_441 :
return F_7 ( V_436 , NULL , L_223 , L_220 ) ?
0 : - V_50 ;
case V_442 :
...
static void F_244 ( struct V_460 * V_461 )
{
struct V_462 * V_66 =
F_245 ( V_461 , struct V_462 , V_461 ) ;
if ( F_140 ( V_69 == V_70 ) )
F_243 ( ( V_66 -> V_463 != V_464 ) ) ;
}
static void F_246 ( struct V_465 * V_466 ,
enum V_467 V_468 )
{
struct V_462 * V_66 =
F_245 ( V_466 ,
struct V_462 ,
V_465 ) ;
V_66 -> V_463 = ( V_468 != V_469 ) ?
V_470 : V_464 ;
F_247 ( V_471 , & V_66 -> V_461 ) ;
}
static enum V_467 F_248 ( struct V_465 * V_466 )
{
return ( F_242 () == 1 ) ? V_472 : V_469 ;
}
...
F_182 ( V_475 ) ;
F_250 ( & V_476 . V_461 , F_244 ) ;
V_186 . V_456 = ( V_48 || V_459 ) && ! V_477 ;
if ( V_186 . V_456 )
V_186 . V_455 =
F_7 ( V_452 , NULL , L_245 , L_247 ) ;
F_17 ( V_55 , L_248 ,
F_1 ( V_186 . V_456 ) ,
F_1 ( V_186 . V_455 ) ) ;
if ( ! V_186 . V_456 )
...
static inline bool F_265 ( const unsigned int V_480 )
{
#ifdef F_266
return false ;
#else
return ( 1U & ( V_481 >> V_480 ) ) == 0 ;
#endif
}
static int F_267 ( const unsigned int V_480 )
{
int V_30 ;
enum V_482 V_483 ;
switch ( V_484 ) {
...
static int F_268 ( const unsigned int V_480 ,
const enum V_482 V_488 )
{
static const unsigned int V_489 [] = { 0 , 1 , 3 } ;
static const unsigned int V_490 [] = { 0 , 0x80 , 0xc0 } ;
int V_73 = 0 ;
switch ( V_484 ) {
case V_485 :
if ( F_142 ( V_480 > 7 ) )
return - V_94 ;
if ( F_142 ( F_265 ( V_480 ) ) )
return - V_158 ;
if ( ! F_7 ( V_491 , NULL , NULL , L_8 ,
( 1 << V_480 ) , V_489 [ V_488 ] ) )
V_73 = - V_50 ;
break;
case V_492 :
...
static void F_269 ( struct V_460 * V_461 )
{
struct V_462 * V_66 =
F_245 ( V_461 , struct V_462 , V_461 ) ;
if ( F_140 ( V_69 == V_70 ) )
F_268 ( V_66 -> V_480 , V_66 -> V_463 ) ;
}
static void F_270 ( struct V_465 * V_466 ,
enum V_467 V_468 )
{
struct V_462 * V_66 = F_245 ( V_466 ,
struct V_462 , V_465 ) ;
if ( V_468 == V_469 )
V_66 -> V_463 = V_464 ;
else if ( V_487 [ V_66 -> V_480 ] != V_486 )
V_66 -> V_463 = V_470 ;
else
V_66 -> V_463 = V_486 ;
F_247 ( V_471 , & V_66 -> V_461 ) ;
}
static int F_271 ( struct V_465 * V_466 ,
unsigned long * V_498 , unsigned long * V_499 )
{
struct V_462 * V_66 = F_245 ( V_466 ,
struct V_462 , V_465 ) ;
if ( * V_498 == 0 && * V_499 == 0 ) {
* V_498 = 500 ;
* V_499 = 500 ;
} else if ( ( * V_498 != 500 ) || ( * V_499 != 500 ) )
return - V_94 ;
V_66 -> V_463 = V_486 ;
F_247 ( V_471 , & V_66 -> V_461 ) ;
return 0 ;
}
static enum V_467 F_272 ( struct V_465 * V_466 )
{
int V_73 ;
struct V_462 * V_66 = F_245 ( V_466 ,
struct V_462 , V_465 ) ;
V_73 = F_267 ( V_66 -> V_480 ) ;
if ( V_73 == V_464 || V_73 < 0 )
V_73 = V_469 ;
else
V_73 = V_472 ;
return V_73 ;
...
{
unsigned int V_42 ;
for ( V_42 = 0 ; V_42 < V_497 ; V_42 ++ ) {
if ( V_500 [ V_42 ] . V_465 . V_51 )
F_253 ( & V_500 [ V_42 ] . V_465 ) ;
}
F_254 ( V_471 ) ;
F_37 ( V_500 ) ;
}
static int T_1 F_274 ( unsigned int V_480 )
{
int V_73 ;
V_500 [ V_480 ] . V_480 = V_480 ;
if ( ! V_501 [ V_480 ] )
return 0 ;
V_500 [ V_480 ] . V_465 . V_502 = & F_270 ;
V_500 [ V_480 ] . V_465 . V_503 = & F_271 ;
if ( V_484 == V_485 )
V_500 [ V_480 ] . V_465 . V_504 =
& F_272 ;
V_500 [ V_480 ] . V_465 . V_51 = V_501 [ V_480 ] ;
F_250 ( & V_500 [ V_480 ] . V_461 , F_269 ) ;
V_73 = F_251 ( & V_154 -> V_60 ,
& V_500 [ V_480 ] . V_465 ) ;
if ( V_73 < 0 )
V_500 [ V_480 ] . V_465 . V_51 = NULL ;
return V_73 ;
}
static enum V_505 T_1 F_275 ( void )
{
T_4 V_30 ;
if ( F_6 () ) {
V_30 = F_18 ( V_452 , L_258 , & V_491 ) ;
if ( F_19 ( V_30 ) )
return V_485 ;
V_30 = F_18 ( V_452 , L_259 , & V_491 ) ;
if ( F_19 ( V_30 ) )
return V_492 ;
}
V_30 = F_18 ( V_452 , L_260 , & V_491 ) ;
if ( F_19 ( V_30 ) )
return V_496 ;
V_491 = NULL ;
return V_506 ;
...
return - V_75 ;
while ( ( V_159 = F_46 ( & V_126 ) ) ) {
if ( sscanf ( V_159 , L_269 , & V_480 ) != 1 )
return - V_94 ;
if ( V_480 < 0 || V_480 > ( V_497 - 1 ) ||
V_500 [ V_480 ] . V_480 < 0 )
return - V_75 ;
...
static int F_284 ( int V_515 , T_17 * V_38 )
{
int V_157 ;
T_18 V_516 ;
char V_517 [ 5 ] ;
...
case V_524 :
if ( V_515 <= 7 ) {
snprintf ( V_517 , sizeof( V_517 ) , L_274 , '0' + V_515 ) ;
if ( ! F_7 ( V_452 , NULL , L_275 , L_220 ) )
return - V_50 ;
if ( ! F_7 ( V_452 , & V_157 , V_517 , L_64 ) )
return - V_50 ;
* V_38 = ( V_157 - 2732 ) * 100 ;
return 0 ;
}
...
static int F_285 ( struct V_528 * V_118 )
{
int V_17 , V_42 ;
int V_217 ;
V_217 = 8 ;
...
V_17 = F_284 ( V_42 , & V_118 -> V_529 [ V_42 ] ) ;
if ( V_17 )
return V_17 ;
}
return V_217 ;
...
F_32 ( L_276 ) ;
for ( V_42 = 0 ; V_42 < V_217 ; V_42 ++ ) {
if ( V_157 . V_529 [ V_42 ] != V_530 )
F_286 ( L_277 , ( int ) ( V_157 . V_529 [ V_42 ] / 1000 ) ) ;
else
F_286 ( L_278 ) ;
}
F_286 ( L_279 ) ;
...
struct V_531 * V_532 =
F_288 ( V_122 ) ;
int V_515 = V_532 -> V_533 ;
T_17 V_38 ;
int V_17 ;
V_17 = F_284 ( V_515 , & V_38 ) ;
if ( V_17 )
return V_17 ;
if ( V_38 == V_530 )
return - V_49 ;
...
{
T_6 V_157 , V_534 , V_535 ;
int V_42 ;
int V_536 ;
int V_17 ;
F_17 ( V_55 , L_280 ) ;
V_536 = F_7 ( V_452 , NULL , L_281 , L_247 ) ;
if ( V_7 . V_12 ) {
V_534 = V_535 = 0 ;
for ( V_42 = 0 ; V_42 < 8 ; V_42 ++ ) {
if ( F_11 ( V_518 + V_42 , & V_157 ) ) {
V_534 |= V_157 ;
} else {
V_534 = 0 ;
break;
}
if ( F_11 ( V_522 + V_42 , & V_157 ) ) {
V_535 |= V_157 ;
} else {
V_534 = 0 ;
break;
...
F_84 ( V_91 , L_288 , V_157 . V_529 [ V_42 ] / 1000 ) ;
F_84 ( V_91 , L_44 , V_157 . V_529 [ V_42 ] / 1000 ) ;
} else
F_84 ( V_91 , L_289 ) ;
return 0 ;
}
...
if ( F_157 ( & V_546 ) < 0 )
return;
if ( F_142 ( ! F_11 ( V_547 , & V_541 ) ) )
goto V_548;
V_541 &= V_549 ;
V_542 = F_131 ( V_238 ) ;
if ( V_541 != ( ( V_542 & V_240 )
>> V_241 ) ) {
V_542 &= ~ ( V_240 <<
V_241 ) ;
V_542 |= V_541 ;
...
F_20 ( V_545 ,
L_291 ,
( unsigned int ) V_541 , ( unsigned int ) V_542 ) ;
} else
F_17 ( V_545 ,
L_292 ,
( unsigned int ) V_541 , ( unsigned int ) V_542 ) ;
...
V_555 :
V_556 ;
V_553 = ( V_38 > V_554 ) ? 1 : - 1 ;
for ( V_42 = V_554 ; V_42 != V_38 ; V_42 += V_553 )
if ( F_15 ( V_47 ) )
return - V_50 ;
return 0 ;
}
static int V_502 ( unsigned int V_38 )
{
int V_17 ;
if ( V_38 > V_272 )
return - V_94 ;
...
static int F_298 ( struct V_557 * V_558 )
{
unsigned int V_56 =
( V_558 -> V_559 . V_560 == V_561 &&
V_558 -> V_559 . V_562 == V_561 ) ?
V_558 -> V_559 . V_468 : 0 ;
F_20 ( V_545 ,
L_294 ,
V_56 ) ;
...
static int V_504 ( struct V_557 * V_558 )
{
int V_30 , V_17 ;
V_17 = F_157 ( & V_546 ) ;
if ( V_17 < 0 )
...
{
struct V_26 V_565 = { V_566 , NULL } ;
union V_23 * V_567 ;
struct V_59 * V_74 , * V_568 ;
int V_73 ;
if ( F_22 ( V_16 , & V_74 ) )
return 0 ;
V_73 = 0 ;
F_302 (child, &device->children, node) {
T_4 V_30 = F_9 ( V_568 -> V_16 , L_295 ,
NULL , & V_565 ) ;
if ( F_31 ( V_30 ) )
continue;
V_567 = (union V_23 * ) V_565 . V_36 ;
if ( ! V_567 || ( V_567 -> type != V_569 ) ) {
F_8 ( L_296 ,
V_346 ) ;
V_73 = 0 ;
} else {
V_73 = V_567 -> V_570 . V_35 ;
}
break;
}
F_37 ( V_565 . V_36 ) ;
...
T_3 V_571 ;
int V_572 = 0 ;
F_24 ( L_13 , NULL , & V_571 ) ;
if ( V_571 )
V_572 = F_301 ( V_571 ) ;
V_186 . V_573 = ( V_572 > 0 ) ;
return ( V_572 > 2 ) ? ( V_572 - 2 ) : 0 ;
}
...
if ( F_295 ( & V_574 ) < 0 )
return 1 ;
memset ( & V_559 , 0 , sizeof( struct V_575 ) ) ;
V_559 . type = V_581 ;
V_559 . V_582 = V_272 ;
V_559 . V_468 = V_574 & V_549 ;
V_563 = F_306 ( V_583 ,
NULL , NULL ,
& V_584 ,
& V_559 ) ;
if ( F_147 ( V_563 ) ) {
int V_73 = F_307 ( V_563 ) ;
V_563 = NULL ;
F_8 ( L_314 ) ;
return V_73 ;
}
...
if ( F_157 ( & V_599 ) < 0 )
return;
if ( F_142 ( ! F_11 ( V_600 , & V_541 ) ) )
goto V_548;
V_541 &= V_590 ;
V_542 = F_131 ( V_245 ) ;
if ( V_541 != ( V_542 & V_590 ) ) {
V_542 &= ~ V_590 ;
V_542 |= V_541 ;
F_294 ( V_542 , V_245 ) ;
F_20 ( V_595 ,
...
static int F_324 ( const T_6 V_601 )
{
int V_73 ;
T_6 V_118 , V_217 ;
if ( V_601 > V_602 )
...
{
int V_606 ;
if ( ! F_7 ( V_452 , & V_606 , L_341 , L_342 , V_604 )
|| V_606 != V_604 )
F_62 ( L_345 ) ;
}
static int F_327 ( const T_6 V_601 )
{
F_20 ( V_595 ,
L_346 , V_601 ) ;
return F_324 ( V_601 ) ;
...
static int F_330 ( struct V_613 * V_614 ,
struct V_615 * V_616 )
{
V_616 -> type = V_617 ;
V_616 -> V_35 = 1 ;
V_616 -> V_38 . integer . V_618 = 0 ;
V_616 -> V_38 . integer . V_127 = V_602 ;
return 0 ;
}
static int F_331 ( struct V_613 * V_614 ,
struct V_619 * V_620 )
{
T_6 V_118 ;
int V_73 ;
...
if ( V_73 < 0 )
return V_73 ;
V_620 -> V_38 . integer . V_38 [ 0 ] = V_118 & V_598 ;
return 0 ;
}
static int F_332 ( struct V_613 * V_614 ,
struct V_619 * V_620 )
{
F_82 ( L_347 , L_348 ,
V_620 -> V_38 . integer . V_38 [ 0 ] ) ;
return F_327 ( V_620 -> V_38 . integer . V_38 [ 0 ] ) ;
}
static int F_333 ( struct V_613 * V_614 ,
struct V_619 * V_620 )
{
T_6 V_118 ;
int V_73 ;
...
static int F_334 ( struct V_613 * V_614 ,
struct V_619 * V_620 )
{
F_82 ( L_347 , L_349 ,
V_620 -> V_38 . integer . V_38 [ 0 ] ?
L_42 : L_1 ) ;
return F_322 ( ! V_620 -> V_38 . integer . V_38 [ 0 ] ) ;
}
...
V_66 = V_622 -> V_609 ;
V_66 -> V_622 = V_622 ;
F_342 ( V_622 -> V_81 , V_628 ,
sizeof( V_622 -> V_81 ) ) ;
F_342 ( V_622 -> V_629 , V_630 ,
sizeof( V_622 -> V_629 ) ) ;
snprintf ( V_622 -> V_631 , sizeof( V_622 -> V_631 ) , L_352 ,
( V_7 . V_632 ) ?
V_7 . V_632 : L_353 ) ;
snprintf ( V_622 -> V_633 , sizeof( V_622 -> V_633 ) ,
L_354 , V_622 -> V_629 , V_600 ,
( V_7 . V_632 ) ?
V_7 . V_632 : L_355 ) ;
if ( V_593 ) {
V_634 . V_635 = F_332 ;
...
if ( ! V_186 . V_596 ) {
V_623 = F_343 ( & V_634 , NULL ) ;
V_73 = F_344 ( V_622 , V_623 ) ;
if ( V_73 < 0 ) {
F_8 ( L_356 ,
V_73 ) ;
goto V_345;
}
V_66 -> V_612 = & V_623 -> V_144 ;
}
V_624 = F_343 ( & V_638 , NULL ) ;
V_73 = F_344 ( V_622 , V_624 ) ;
if ( V_73 < 0 ) {
F_8 ( L_357 , V_73 ) ;
goto V_345;
}
V_66 -> V_610 = & V_624 -> V_144 ;
V_73 = F_345 ( V_622 ) ;
if ( V_73 < 0 ) {
F_8 ( L_358 , V_73 ) ;
goto V_345;
...
V_656 -- ;
continue;
} else if ( sscanf ( V_159 , L_381 , & V_658 ) == 1 &&
V_658 >= 0 && V_658 <= V_602 ) {
V_656 = V_658 ;
continue;
}
...
F_82 ( L_384 ,
L_385 ,
V_657 ? L_1 : L_42 , V_656 ) ;
V_73 = F_320 ( V_657 | V_656 ) ;
}
F_328 () ;
return ( V_73 == - V_589 ) ? - V_294 : V_73 ;
}
...
static void F_350 ( T_6 * V_662 )
{
if ( F_142 ( V_186 . V_661 ) ) {
if ( * V_662 != V_660 ) {
V_186 . V_661 = 0 ;
} else {
* V_662 = V_663 ;
...
if ( V_186 . V_664 ) {
T_6 V_665 ;
if ( F_12 ( V_666 , & V_665 ) < 0 )
return false ;
V_665 &= 0xFEU ;
if ( F_14 ( V_666 , V_665 ) < 0 )
return false ;
}
return true ;
}
...
case V_670 : {
int V_17 ;
if ( F_142 ( ! F_7 ( V_671 , & V_17 , NULL , L_64 ) ) )
return - V_50 ;
if ( F_140 ( V_30 ) )
* V_30 = V_17 & 0x07 ;
break;
...
static int F_356 ( unsigned int * V_675 )
{
T_6 V_676 , V_677 ;
switch ( V_669 ) {
case V_672 :
...
static int F_357 ( unsigned int * V_675 )
{
T_6 V_676 , V_677 ;
bool V_73 ;
switch ( V_669 ) {
...
case V_681 :
if ( V_56 >= 0 && V_56 <= 7 ) {
if ( ! F_7 ( V_682 , NULL , NULL , L_9 , V_56 ) )
return - V_50 ;
} else
return - V_94 ;
break;
...
V_118 &= 0x07 ;
V_118 |= 4 ;
if ( ! F_7 ( V_682 , NULL , NULL , L_9 , V_118 ) )
V_73 = - V_50 ;
else
V_73 = 0 ;
break;
...
break;
case V_681 :
if ( ! F_7 ( V_682 , NULL , NULL , L_9 , 0x00 ) )
V_73 = - V_50 ;
else
V_668 = 0 ;
break;
...
switch ( V_680 ) {
case V_683 :
if ( V_675 >= 0 && V_675 <= 65535 ) {
if ( ! F_7 ( V_687 , NULL , NULL , L_391 ,
V_675 , V_675 , V_675 ) )
V_73 = - V_50 ;
} else
V_73 = - V_94 ;
...
static void F_367 ( struct V_460 * V_691 )
{
int V_73 ;
if ( V_69 != V_70 )
return;
...
if ( V_17 < 0 )
return V_17 ;
return snprintf ( V_126 , V_102 , L_397 , V_675 ) ;
}
...
char * V_126 )
{
return snprintf ( V_126 , V_102 , L_397 , V_689 ) ;
}
...
V_73 = F_215 ( & V_537 -> V_60 . V_125 ,
& V_706 ) ;
if ( V_73 < 0 )
return V_73 ;
V_73 = F_101 ( & V_707 . V_81 ,
& V_708 ) ;
if ( V_73 < 0 ) {
F_55 ( & V_537 -> V_60 . V_125 ,
& V_706 ) ;
...
{
int V_712 ;
if ( sscanf ( V_159 , L_433 , & V_712 ) != 1 )
return 0 ;
if ( V_712 < 0 || V_712 > 120 )
* V_73 = - V_94 ;
else {
V_689 = V_712 ;
F_82 ( L_425 ,
...
static int F_387 ( struct V_713 * V_157 , bool V_205 )
{
T_3 V_529 ;
int V_714 ;
if ( ! F_19 ( F_18 ( V_129 , V_157 -> V_51 , & V_529 ) ) ) {
F_62 ( L_435 , V_157 -> V_51 ) ;
return - V_50 ;
}
if ( ! F_7 ( V_129 , & V_714 , V_157 -> V_51 , L_7 ,
V_205 ? V_157 -> V_715 : V_157 -> V_716 ) )
return - V_50 ;
V_157 -> V_205 = V_205 ;
return V_205 ;
}
int F_388 ( int V_717 , bool V_718 )
{
struct V_713 * V_157 ;
if ( V_717 < 0 || V_717 >= V_719 )
return - V_94 ;
V_157 = & V_720 [ V_717 ] ;
if ( V_157 -> V_205 < 0 || V_157 -> V_205 == V_718 )
return V_157 -> V_205 ;
return F_387 ( V_157 , V_718 ) ;
}
static int F_389 ( struct V_306 * V_307 )
{
T_3 V_529 ;
int V_42 ;
for ( V_42 = 0 ; V_42 < V_719 ; V_42 ++ ) {
struct V_713 * V_157 = & V_720 [ V_42 ] ;
if ( F_19 ( F_18 ( V_129 , V_157 -> V_51 , & V_529 ) ) )
F_387 ( V_157 , false ) ;
else
V_157 -> V_205 = - V_75 ;
...
static void F_392 ( const unsigned int V_721 )
{
if ( V_563 ) {
switch ( V_721 ) {
case V_722 :
...
{
static char V_728 [] V_729 = L_437 ;
return ( V_1 ) ? & V_728 [ 4 ] : & V_728 [ 0 ] ;
}
...
F_25 ( V_68 == NULL ) ;
F_400 ( & V_68 -> V_730 ) ;
if ( V_68 -> V_79 . V_736 && ! V_736 )
return 0 ;
F_20 ( V_55 ,
L_443 , V_68 -> V_51 ) ;
if ( V_307 -> V_737 ) {
V_100 = V_307 -> V_737 ( V_307 ) ;
if ( V_100 > 0 )
return 0 ;
if ( V_100 )
return V_100 ;
...
L_445 , V_68 -> V_51 ) ;
if ( V_68 -> V_93 ) {
T_19 V_356 = V_307 -> V_739 ;
if ( ! V_356 )
V_356 = V_740 ;
if ( V_68 -> V_101 )
V_356 |= V_741 ;
V_735 = F_401 ( V_68 -> V_51 , V_356 , V_732 ,
& V_742 , V_68 ) ;
if ( ! V_735 ) {
F_8 ( L_446 , V_68 -> V_51 ) ;
V_100 = - V_75 ;
...
return 0 ;
V_118 = F_407 ( V_748 ) ;
V_745 -> V_749 = F_408 ( V_118 , V_83 ) ;
if ( V_118 && ! V_745 -> V_749 )
return - V_84 ;
if ( ! ( F_404 ( V_745 -> V_749 , 'E' ) ||
F_404 ( V_745 -> V_749 , 'C' ) ) )
return 0 ;
V_745 -> V_10 = V_745 -> V_749 [ 0 ]
| ( V_745 -> V_749 [ 1 ] << 8 ) ;
V_745 -> V_184 = ( V_745 -> V_749 [ 4 ] << 8 )
| V_745 -> V_749 [ 5 ] ;
while ( ( V_60 = F_409 ( V_750 , NULL , V_60 ) ) ) {
if ( sscanf ( V_60 -> V_51 ,
L_450 ,
V_747 ) == 1 ) {
V_747 [ sizeof( V_747 ) - 1 ] = 0 ;
V_747 [ strcspn ( V_747 , L_451 ) ] = 0 ;
V_745 -> V_632 = F_408 ( V_747 , V_83 ) ;
if ( ! V_745 -> V_632 )
return - V_84 ;
if ( F_404 ( V_747 , 'H' ) ) {
V_745 -> V_12 = V_747 [ 0 ]
| ( V_747 [ 1 ] << 8 ) ;
V_745 -> V_185 = ( V_747 [ 4 ] << 8 )
| V_747 [ 5 ] ;
} else {
F_32 ( L_452
L_453 ,
...
V_118 = F_407 ( V_754 ) ;
V_745 -> V_755 = F_408 ( V_118 , V_83 ) ;
if ( V_118 && ! V_745 -> V_755 )
return - V_84 ;
return 0 ;
}
...
if ( ! F_6 () && ! F_5 () )
return - V_75 ;
V_756 = ( V_7 . V_752 != NULL ) ||
( V_7 . V_12 != 0 ) ||
F_107 () ;
F_24 ( L_456 , V_758 , & V_452 ) ;
if ( ! V_452 ) {
if ( V_756 )
F_8 ( L_457 ) ;
return - V_75 ;
...
static int T_1 F_412 ( const char * V_665 , struct V_761 * V_762 )
{
unsigned int V_42 ;
struct V_67 * V_68 ;
if ( ! V_762 || ! V_762 -> V_51 || ! V_665 )
return - V_94 ;
for ( V_42 = 0 ; V_42 < F_100 ( V_763 ) ; V_42 ++ ) {
V_68 = V_763 [ V_42 ] . V_66 ;
F_413 ( V_68 == NULL ) ;
if ( ! V_68 || ! V_68 -> V_51 )
continue;
if ( strcmp ( V_68 -> V_51 , V_762 -> V_51 ) == 0 && V_68 -> V_101 ) {
if ( strlen ( V_665 ) > sizeof( V_763 [ V_42 ] . V_764 ) - 2 )
return - V_765 ;
strcpy ( V_763 [ V_42 ] . V_764 , V_665 ) ;
strcat ( V_763 [ V_42 ] . V_764 , L_28 ) ;
return 0 ;
}
}
return - V_94 ;
...
V_732 = F_424 ( V_775 , V_776 ) ;
if ( ! V_732 ) {
F_8 ( L_463 V_775 L_279 ) ;
F_414 () ;
return - V_75 ;
}
V_100 = F_425 ( & V_772 ) ;
...
V_208 -> V_51 = L_471 ;
V_208 -> V_782 = V_780 L_472 ;
V_208 -> V_144 . V_783 = V_784 ;
V_208 -> V_144 . V_6 = V_7 . V_6 ;
V_208 -> V_144 . V_785 = V_786 ;
V_208 -> V_144 . V_787 = V_788 ;
V_208 -> V_60 . V_52 = & V_154 -> V_60 ;
}
F_304 () ;
for ( V_42 = 0 ; V_42 < F_100 ( V_763 ) ; V_42 ++ ) {
V_100 = F_399 ( & V_763 [ V_42 ] ) ;
if ( V_100 >= 0 && * V_763 [ V_42 ] . V_764 )
V_100 = V_763 [ V_42 ] . V_66 -> V_101 ( V_763 [ V_42 ] . V_764 ) ;
if ( V_100 < 0 ) {
F_414 () ;
return V_100 ;
}
