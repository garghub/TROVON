...
static void T_1 F_66 ( struct V_9 * V_10 , unsigned long V_126 )
{
struct V_1 * V_2 = V_10 -> V_2 ;
struct V_85 * V_86 ;
struct V_127 * V_128 ;
...
int V_131 = F_67 ( V_2 ) ;
int V_132 = V_2 -> V_133 ;
V_86 = F_68 ( sizeof( struct V_127 ) + V_131 + V_132 + 15 ,
V_23 ) ;
if ( ! V_86 )
return;
F_69 ( V_86 , V_131 ) ;
V_128 = (struct V_127 * ) F_70 ( V_86 , sizeof( struct V_127 ) ) ;
memset ( V_128 , 0 , sizeof( struct V_127 ) ) ;
F_71 ( V_86 ) ;
V_130 = F_72 ( V_86 ) ;
V_130 -> V_134 = 4 ;
V_130 -> V_135 = 5 ;
V_130 -> V_136 = F_52 ( sizeof( struct V_127 ) ) ;
V_130 -> V_137 = F_52 ( V_138 ) ;
V_130 -> V_139 = 64 ;
V_130 -> V_140 = V_141 ;
V_130 -> V_142 = F_37 ( V_143 ) ;
V_130 -> V_144 = F_73 ( ( unsigned char * ) V_130 , V_130 -> V_135 ) ;
V_128 -> V_145 . V_146 = F_52 ( 68 ) ;
V_128 -> V_145 . V_147 = F_52 ( 67 ) ;
V_128 -> V_145 . V_121 = F_52 ( sizeof( struct V_127 ) - sizeof( struct V_129 ) ) ;
V_128 -> V_148 = V_149 ;
if ( V_2 -> type < 256 )
V_128 -> V_150 = V_2 -> type ;
else if ( V_2 -> type == V_151 )
V_128 -> V_150 = V_152 ;
else {
F_40 ( L_20 , V_2 -> type , V_2 -> V_6 ) ;
V_128 -> V_150 = V_2 -> type ;
}
V_128 -> V_131 = V_2 -> V_100 ;
memcpy ( V_128 -> V_153 , V_2 -> V_109 , V_2 -> V_100 ) ;
V_128 -> V_154 = F_52 ( V_126 / V_155 ) ;
V_128 -> V_26 = V_10 -> V_26 ;
#ifdef F_74
if ( V_22 & V_156 )
F_60 ( V_128 -> V_157 ) ;
else
...
F_63 ( V_128 -> V_157 ) ;
V_86 -> V_2 = V_2 ;
V_86 -> V_140 = F_52 ( V_105 ) ;
if ( F_75 ( V_86 , V_2 , F_51 ( V_86 -> V_140 ) ,
V_2 -> V_158 , V_2 -> V_109 , V_86 -> V_121 ) < 0 ) {
F_56 ( V_86 ) ;
F_40 ( L_21 ) ;
return;
}
...
static int T_1 F_77 ( char * V_147 , char * V_159 , int V_121 , int V_160 )
{
if ( ! V_121 )
return 0 ;
if ( V_121 > V_160 - 1 )
V_121 = V_160 - 1 ;
memcpy ( V_147 , V_159 , V_121 ) ;
V_147 [ V_121 ] = '\0' ;
return 1 ;
}
static void T_1 F_78 ( T_4 * V_161 )
{
T_4 V_162 ;
int V_113 ;
T_2 V_18 ;
...
case 1 :
if ( V_60 == V_68 )
memcpy ( & V_60 , V_161 + 1 , 4 ) ;
break;
case 3 :
if ( V_67 == V_68 )
memcpy ( & V_67 , V_161 + 1 , 4 ) ;
break;
case 6 :
V_162 = * V_161 / 4 ;
if ( V_162 > V_114 )
...
if ( V_115 [ V_113 ] == V_68 )
memcpy ( & V_115 [ V_113 ] , V_161 + 1 + 4 * V_113 , 4 ) ;
}
break;
case 12 :
F_77 ( F_62 () -> V_78 , V_161 + 1 , * V_161 ,
V_164 ) ;
V_77 = 1 ;
break;
case 15 :
F_77 ( V_165 , V_161 + 1 , * V_161 , sizeof( V_165 ) ) ;
break;
case 17 :
if ( ! V_166 [ 0 ] )
F_77 ( V_166 , V_161 + 1 , * V_161 ,
sizeof( V_166 ) ) ;
break;
case 26 :
...
sizeof( struct V_171 ) ) )
goto V_96;
V_128 = (struct V_127 * ) F_80 ( V_86 ) ;
V_130 = & V_128 -> V_172 ;
if ( V_130 -> V_135 != 5 || V_130 -> V_134 != 4 || V_130 -> V_140 != V_141 )
goto V_96;
if ( F_81 ( V_130 ) ) {
F_82 ( L_25 ) ;
goto V_96;
}
if ( V_86 -> V_121 < F_51 ( V_130 -> V_136 ) )
goto V_96;
if ( F_73 ( ( char * ) V_130 , V_130 -> V_135 ) )
goto V_96;
if ( V_128 -> V_145 . V_146 != F_52 ( 67 ) || V_128 -> V_145 . V_147 != F_52 ( 68 ) )
goto V_96;
if ( F_51 ( V_130 -> V_136 ) < F_51 ( V_128 -> V_145 . V_121 ) + sizeof( struct V_129 ) )
goto V_96;
V_121 = F_51 ( V_128 -> V_145 . V_121 ) - sizeof( struct V_171 ) ;
V_168 = V_121 - ( sizeof( * V_128 ) -
sizeof( struct V_129 ) -
sizeof( struct V_171 ) -
sizeof( V_128 -> V_157 ) ) ;
if ( V_168 < 0 )
...
if ( ! V_10 )
goto V_108;
if ( V_128 -> V_148 != V_173 ||
V_128 -> V_26 != V_10 -> V_26 ) {
F_82 ( L_26 ,
V_128 -> V_148 , V_128 -> V_26 ) ;
goto V_108;
}
if ( V_128 -> V_26 != V_174 ) {
F_82 ( L_27 ) ;
...
if ( V_168 >= 4 &&
! memcmp ( V_128 -> V_157 , V_122 , 4 ) ) {
T_4 * V_175 = ( T_4 * ) V_128 + F_51 ( V_128 -> V_172 . V_136 ) ;
T_4 * V_161 ;
#ifdef F_74
if ( V_22 & V_156 ) {
V_27 V_176 = V_68 ;
...
V_58 = V_128 -> V_179 ;
V_80 = V_128 -> V_181 ;
V_110 = V_128 -> V_172 . V_180 ;
if ( V_67 == V_68 && V_128 -> V_184 )
V_67 = V_128 -> V_184 ;
if ( V_115 [ 0 ] == V_68 )
V_115 [ 0 ] = V_80 ;
V_107 = V_19 ;
...
F_86 ( L_33 ,
V_189
? ( ( V_22 & V_156 ) ? L_34 : L_35 ) : L_36 ,
( V_189 && V_190 ) ? L_37 : L_36 ,
V_190 ? L_38 : L_36 ) ;
V_186 = V_30 ;
V_10 = V_15 ;
V_185 = V_191 ;
F_11 ( & V_187 , sizeof( V_187 ) ) ;
V_187 = V_192 + ( V_187 % ( unsigned int ) V_193 ) ;
for (; ; ) {
#ifdef F_84
V_174 = V_10 -> V_26 ;
if ( V_189 && ( V_10 -> V_17 & V_19 ) )
F_66 ( V_10 , V_30 - V_186 ) ;
#endif
#ifdef F_85
if ( V_190 && ( V_10 -> V_17 & V_21 ) )
F_57 ( V_10 ) ;
#endif
V_188 = V_30 + ( V_10 -> V_25 ? V_194 : V_187 ) ;
while ( F_14 ( V_30 , V_188 ) && ! V_107 )
F_87 ( 1 ) ;
#ifdef F_74
if ( ( V_107 & V_19 ) &&
( V_22 & V_156 ) &&
...
F_40 ( L_43 ,
( ( V_107 & V_21 ) ? L_38
: ( V_22 & V_156 ) ? L_34 : L_35 ) ,
& V_110 ) ;
F_88 ( L_44 , & V_58 ) ;
return 0 ;
}
static int F_89 ( struct V_197 * V_198 , void * V_199 )
{
int V_113 ;
if ( V_200 & V_201 )
F_90 ( V_198 , L_45 ,
( V_200 & V_21 ) ? L_38
: ( V_200 & V_156 ) ? L_34 : L_35 ) ;
else
F_91 ( V_198 , L_46 ) ;
if ( V_165 [ 0 ] )
F_90 ( V_198 ,
...
static int F_92 ( struct V_202 * V_203 , struct V_204 * V_204 )
{
return F_93 ( V_204 , F_89 , NULL ) ;
}
...
V_206 = V_207 = V_6 ;
while ( V_205 < 4 ) {
while ( * V_206 >= '0' && * V_206 <= '9' )
V_206 ++ ;
if ( V_206 == V_207 || V_206 - V_207 > 3 )
break;
if ( * V_206 == '.' || V_205 == 3 )
V_205 ++ ;
if ( V_205 < 4 )
...
if ( V_205 == 4 && ( * V_206 == ':' || * V_206 == '\0' ) ) {
if ( * V_206 == ':' )
* V_206 ++ = '\0' ;
V_37 = F_95 ( V_6 ) ;
memmove ( V_6 , V_206 , strlen ( V_206 ) + 1 ) ;
} else
V_37 = V_68 ;
return V_37 ;
}
...
unsigned int V_113 ;
#ifdef F_100
F_101 ( L_50 , V_211 , V_49 . V_212 , & V_213 ) ;
#endif
if ( ! V_214 )
return 0 ;
F_12 ( ( L_51 ) ) ;
...
static int T_1 F_108 ( char * V_219 )
{
...
V_220 = V_219 ;
while ( V_220 && * V_220 ) {
if ( ( V_206 = strchr ( V_220 , ':' ) ) )
* V_206 ++ = '\0' ;
if ( strlen ( V_220 ) > 0 ) {
F_12 ( ( L_70 , V_222 , V_220 ) ) ;
switch ( V_222 ) {
case 0 :
if ( ( V_58 = F_95 ( V_220 ) ) == V_224 )
V_58 = V_68 ;
break;
case 1 :
if ( ( V_80 = F_95 ( V_220 ) ) == V_224 )
V_80 = V_68 ;
break;
case 2 :
if ( ( V_67 = F_95 ( V_220 ) ) == V_224 )
V_67 = V_68 ;
break;
case 3 :
if ( ( V_60 = F_95 ( V_220 ) ) == V_224 )
V_60 = V_68 ;
break;
case 4 :
if ( ( V_221 = strchr ( V_220 , '.' ) ) ) {
* V_221 ++ = '\0' ;
F_109 ( F_62 () -> V_167 , V_221 ,
sizeof( F_62 () -> V_167 ) ) ;
}
F_109 ( F_62 () -> V_78 , V_220 ,
sizeof( F_62 () -> V_78 ) ) ;
V_77 = 1 ;
break;
case 5 :
F_109 ( V_5 , V_220 , sizeof( V_5 ) ) ;
break;
case 6 :
if ( F_104 ( V_220 ) == 0 &&
V_58 == V_68 ) {
...
static int T_1 F_110 ( char * V_219 )
{
return F_108 ( V_219 ) ;
}
static int T_1 F_111 ( char * V_219 )
{
if ( F_109 ( V_124 , V_219 ,
sizeof( V_124 ) )
>= sizeof( V_124 ) )
F_8 ( L_71 ,
V_124 ) ;
