...
ASSERT ( F_59 ( V_8 -> V_26 ) ) ;
V_71 = F_2 ( V_8 -> V_20 . V_71 ,
struct V_70 , V_71 ) ;
V_108 . V_113 = V_71 -> V_113 ;
V_108 . V_114 = V_8 -> V_26 ;
V_107 = F_60 ( & V_108 , V_115 | V_116 , V_71 -> V_117 ) ;
if ( F_61 ( V_107 ) ) {
V_32 = F_62 ( V_107 ) ;
} else {
...
V_109 , V_110 ) ;
V_111 = V_110 - V_109 ;
F_63 ( V_109 + V_111 , == , V_110 ) ;
}
}
V_112 = F_64 ( V_11 ) ;
V_32 = F_65 ( V_107 , V_112 , V_111 , & V_109 ) ;
F_66 ( V_11 ) ;
if ( V_32 != V_111 )
V_32 = - V_36 ;
F_67 ( V_107 ) ;
...
void F_68 ( struct V_120 * V_121 , struct V_11 * V_11 )
{
struct V_7 * V_8 ;
struct V_70 * V_71 ;
