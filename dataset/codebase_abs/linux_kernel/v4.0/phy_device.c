...
V_105 |= F_65 ( V_103 ) ;
if ( V_105 != V_104 ) {
V_18 = F_66 ( V_2 , V_110 , V_105 ) ;
if ( V_18 < 0 )
return V_18 ;
V_107 = 1 ;
}
V_106 = F_51 ( V_2 , V_115 ) ;
if ( V_106 < 0 )
return V_106 ;
if ( ! ( V_106 & V_116 ) )
return V_107 ;
V_105 = F_51 ( V_2 , V_117 ) ;
if ( V_105 < 0 )
return V_105 ;
V_104 = V_105 ;
V_105 &= ~ ( V_118 | V_119 ) ;
...
if ( V_127 == V_2 -> V_28 )
V_122 |= V_128 ;
return F_66 ( V_2 , V_74 , V_122 ) ;
}
int F_69 ( struct V_1 * V_2 )
{
int V_122 = F_51 ( V_2 , V_74 ) ;
if ( V_122 < 0 )
return V_122 ;
V_122 |= V_129 | V_130 ;
V_122 &= ~ V_131 ;
...
V_137 = F_51 ( V_2 , V_143 ) ;
if ( V_137 < 0 )
return V_137 ;
V_2 -> V_141 |= F_76 ( V_137 ) ;
V_105 = F_51 ( V_2 , V_110 ) ;
if ( V_105 < 0 )
return V_105 ;
V_139 = V_137 & V_105 ;
...
if ( ! ( V_156 & 1 ) )
continue;
F_78 ( V_2 , V_154 , V_158 ) ;
V_155 = F_78 ( V_2 , V_154 , V_158 ) ;
...
{
struct V_183 * V_184 = V_2 -> V_3 . V_185 ;
T_1 V_186 ;
if ( ! F_87 ( V_187 ) )
return;
if ( ! V_184 )
return;
if ( ! F_88 ( V_184 , L_6 , & V_186 ) ) {
V_2 -> V_109 &= V_188 ;
switch ( V_186 ) {
default:
return;
...
struct V_192 * V_77 = V_2 -> V_3 . V_83 ;
...
int F_92 ( struct V_93 * V_196 )
{
int V_133 ;
V_196 -> V_83 . V_197 = V_196 -> V_197 ;
V_196 -> V_83 . V_21 = & V_37 ;
V_196 -> V_83 . V_87 = F_89 ;
V_196 -> V_83 . remove = F_91 ;
V_133 = F_93 ( & V_196 -> V_83 ) ;
if ( V_133 ) {
F_34 ( L_7 ,
V_196 -> V_197 , V_133 ) ;
return V_133 ;
}
F_94 ( L_8 , V_196 -> V_197 ) ;
return 0 ;
}
int F_95 ( struct V_93 * V_196 , int V_198 )
{
int V_50 , V_73 = 0 ;
for ( V_50 = 0 ; V_50 < V_198 ; V_50 ++ ) {
V_73 = F_92 ( V_196 + V_50 ) ;
if ( V_73 ) {
while ( V_50 -- > 0 )
F_96 ( V_196 + V_50 ) ;
break;
...
void F_98 ( struct V_93 * V_77 , int V_198 )
{
int V_50 ;
for ( V_50 = 0 ; V_50 < V_198 ; V_50 ++ )
F_96 ( V_77 + V_50 ) ;
