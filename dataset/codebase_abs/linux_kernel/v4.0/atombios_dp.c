...
V_57 = F_18 ( & V_74 -> V_75 -> V_54 ) ;
if ( ! V_57 )
V_74 -> V_75 -> V_78 = true ;
F_19 ( V_57 , L_4 , V_57 ) ;
}
static void F_20 ( T_1 V_79 [ V_80 ] ,
int V_81 ,
T_1 V_82 [ 4 ] )
{
T_1 V_83 = 0 ;
...
T_1 V_86 = F_21 ( V_79 , V_85 ) ;
T_1 V_87 = F_22 ( V_79 , V_85 ) ;
F_11 ( L_5 ,
V_85 ,
V_88 [ V_86 >> V_89 ] ,
V_90 [ V_87 >> V_91 ] ) ;
...
int V_106 ;
if ( F_26 ( V_103 ) )
V_106 = F_27 ( F_28 ( V_104 ) , 540000 ) ;
else
V_106 = F_27 ( F_28 ( V_104 ) , 270000 ) ;
return V_106 ;
}
static int F_29 ( struct V_102 * V_103 ,
T_1 V_104 [ V_105 ] ,
int V_107 )
{
int V_101 = F_23 ( F_30 ( V_103 ) ) ;
int V_106 = F_25 ( V_103 , V_104 ) ;
int V_108 = F_31 ( V_104 ) ;
int V_100 ;
int V_109 ;
for ( V_100 = 1 ; V_100 < V_108 ; V_100 <<= 1 ) {
V_109 = F_24 ( V_106 , V_100 , V_101 ) ;
if ( V_107 <= V_109 )
break;
}
return V_100 ;
...
V_111 )
return 270000 ;
V_100 = F_29 ( V_103 , V_104 , V_107 ) ;
V_110 = F_24 ( 162000 , V_100 , V_101 ) ;
if ( V_107 <= V_110 )
return 162000 ;
V_110 = F_24 ( 270000 , V_100 , V_101 ) ;
if ( V_107 <= V_110 )
return 270000 ;
if ( F_26 ( V_103 ) ) {
V_110 = F_24 ( 540000 , V_100 , V_101 ) ;
if ( V_107 <= V_110 )
return 540000 ;
}
return F_25 ( V_103 , V_104 ) ;
}
...
args . V_119 = V_100 ;
args . V_120 = 0 ;
F_35 ( V_22 -> V_32 . V_33 , V_25 , ( V_48 * ) & args ) ;
return args . V_120 ;
}
T_1 F_36 ( struct V_74 * V_74 )
{
struct V_19 * V_20 = V_74 -> V_28 . V_20 ;
struct V_21 * V_22 = V_20 -> V_23 ;
return F_34 ( V_22 , V_121 , 0 ,
V_74 -> V_75 -> V_42 . V_43 , 0 ) ;
}
static void F_37 ( struct V_74 * V_74 )
{
struct V_122 * V_123 = V_74 -> V_124 ;
T_1 V_125 [ 3 ] ;
if ( ! ( V_123 -> V_104 [ V_126 ] & V_127 ) )
return;
if ( F_38 ( & V_74 -> V_75 -> V_54 , V_128 , V_125 , 3 ) == 3 )
F_11 ( L_7 ,
V_125 [ 0 ] , V_125 [ 1 ] , V_125 [ 2 ] ) ;
if ( F_38 ( & V_74 -> V_75 -> V_54 , V_129 , V_125 , 3 ) == 3 )
F_11 ( L_8 ,
V_125 [ 0 ] , V_125 [ 1 ] , V_125 [ 2 ] ) ;
}
bool F_39 ( struct V_74 * V_74 )
{
struct V_122 * V_123 = V_74 -> V_124 ;
T_1 V_56 [ V_105 ] ;
int V_57 ;
V_57 = F_38 ( & V_74 -> V_75 -> V_54 , V_130 , V_56 ,
V_105 ) ;
if ( V_57 > 0 ) {
...
int F_40 ( struct V_131 * V_132 ,
struct V_102 * V_103 )
{
struct V_19 * V_20 = V_132 -> V_20 ;
struct V_21 * V_22 = V_20 -> V_23 ;
struct V_74 * V_74 = F_41 ( V_103 ) ;
struct V_122 * V_123 ;
int V_133 = V_134 ;
V_38 V_135 = F_33 ( V_103 ) ;
T_1 V_136 ;
if ( ! F_9 ( V_22 ) )
return V_133 ;
if ( ! V_74 -> V_124 )
...
( V_123 -> V_146 == V_148 ) ) {
V_123 -> V_113 =
F_32 ( V_103 , V_123 -> V_104 , V_145 -> clock ) ;
V_123 -> V_149 =
F_29 ( V_103 , V_123 -> V_104 , V_145 -> clock ) ;
}
}
int F_44 ( struct V_102 * V_103 ,
struct V_144 * V_145 )
{
struct V_74 * V_74 = F_41 ( V_103 ) ;
struct V_122 * V_123 ;
...
if ( F_46 ( & V_74 -> V_75 -> V_54 , V_79 )
<= 0 )
return false ;
if ( F_47 ( V_79 , V_152 -> V_149 ) )
return false ;
return true ;
}
void F_48 ( struct V_102 * V_103 ,
T_1 V_153 )
{
struct V_74 * V_74 = F_41 ( V_103 ) ;
struct V_122 * V_123 ;
...
V_157 ,
0 , V_156 -> V_82 [ 0 ] ) ;
F_53 ( V_156 -> V_54 , V_158 ,
V_156 -> V_82 , V_156 -> V_149 ) ;
}
static void F_54 ( struct V_155 * V_156 , int V_159 )
{
int V_160 = 0 ;
...
F_34 ( V_156 -> V_22 , V_168 ,
V_156 -> V_113 , V_156 -> V_169 , V_160 ) ;
}
F_49 ( V_156 -> V_54 , V_170 , V_159 ) ;
}
static int F_56 ( struct V_155 * V_156 )
{
struct V_171 * V_171 = F_57 ( V_156 -> V_132 ) ;
struct V_172 * V_152 = V_171 -> V_173 ;
T_1 V_136 ;
F_48 ( V_156 -> V_103 , V_174 ) ;
...
F_49 ( V_156 -> V_54 ,
V_175 , 0 ) ;
if ( V_152 -> V_133 == V_139 )
F_49 ( V_156 -> V_54 , V_177 , 1 ) ;
V_136 = V_156 -> V_149 ;
if ( F_58 ( V_156 -> V_104 ) )
V_136 |= V_178 ;
F_49 ( V_156 -> V_54 , V_179 , V_136 ) ;
V_136 = F_59 ( V_156 -> V_113 ) ;
F_49 ( V_156 -> V_54 , V_180 , V_136 ) ;
if ( F_9 ( V_156 -> V_22 ) || ! V_156 -> V_161 )
F_55 ( V_156 -> V_132 ,
V_181 , 0 ) ;
else
F_34 ( V_156 -> V_22 , V_182 ,
...
if ( F_65 ( V_156 -> V_79 , V_156 -> V_149 ) ) {
V_186 = true ;
break;
}
...
F_20 ( V_156 -> V_79 , V_156 -> V_149 , V_156 -> V_82 ) ;
F_51 ( V_156 ) ;
}
if ( ! V_186 ) {
F_64 ( L_13 ) ;
...
static int F_66 ( struct V_155 * V_156 )
{
bool V_189 ;
if ( V_156 -> V_190 )
F_54 ( V_156 , V_166 ) ;
...
if ( F_47 ( V_156 -> V_79 , V_156 -> V_149 ) ) {
V_189 = true ;
break;
}
if ( V_156 -> V_188 > 5 ) {
...
V_156 . V_161 = true ;
V_25 = F_6 ( V_26 , V_115 ) ;
if ( F_69 ( V_22 -> V_32 . V_33 , V_25 , & V_191 , & V_192 ) ) {
if ( V_192 > 1 ) {
V_156 . V_161 = false ;
}
}
...
V_156 . V_169 |= V_198 ;
if ( F_42 ( & V_74 -> V_75 -> V_54 , V_199 , & V_136 )
== 1 ) {
if ( F_70 ( V_22 ) && ( V_136 & V_200 ) )
V_156 . V_190 = true ;
else
V_156 . V_190 = false ;
} else {
