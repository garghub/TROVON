...
{
struct V_90 * V_39 ;
F_47 (crtc, &dev->mode_config.crtc_list, head)
F_54 ( V_39 , V_89 ) ;
}
...
struct V_1 * V_2 = V_27 -> V_28 ;
unsigned int V_31 ;
F_58 ( V_2 -> V_33 -> V_34 , V_93 , 0xffffffff ) ;
F_3 ( V_2 -> V_33 -> V_34 , V_36 , & V_31 ) ;
}
static int F_60 ( struct V_26 * V_27 , int V_39 )
{
struct V_1 * V_2 = V_27 -> V_28 ;
F_58 ( V_2 -> V_33 -> V_34 , V_92 , V_38 ) ;
return 0 ;
}
static void F_61 ( struct V_26 * V_27 , int V_39 )
{
struct V_1 * V_2 = V_27 -> V_28 ;
F_58 ( V_2 -> V_33 -> V_34 , V_93 , V_38 ) ;
}
static int F_62 ( struct V_69 * V_70 )
{
struct V_26 * V_94 ;
int V_56 ;
V_94 = F_63 ( & V_95 , & V_70 -> V_27 ) ;
if ( ! V_94 )
return - V_79 ;
V_56 = F_64 ( V_94 , F_65 ( V_94 -> V_27 ) ) ;
if ( V_56 )
goto V_96;
V_56 = F_20 ( V_94 ) ;
if ( V_56 )
