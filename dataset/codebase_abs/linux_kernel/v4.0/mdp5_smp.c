...
F_9 ( & V_3 -> V_50 , V_48 ) ;
if ( V_47 ) {
V_35 = F_10 ( 0 , V_35 - V_47 ) ;
F_11 ( L_1 , V_35 , V_47 ) ;
}
V_43 = V_45 - F_12 ( V_3 -> V_51 , V_45 ) ;
if ( V_35 > V_43 ) {
...
V_44 = F_12 ( V_39 -> V_54 , V_45 ) ;
if ( V_35 > V_44 ) {
for ( V_41 = V_44 ; V_41 < V_35 ; V_41 ++ ) {
int V_55 = F_14 ( V_3 -> V_51 , V_45 ) ;
F_15 ( V_55 , V_39 -> V_54 ) ;
F_15 ( V_55 , V_3 -> V_51 ) ;
}
} else {
for ( V_41 = V_44 ; V_41 > V_35 ; V_41 -- ) {
int V_55 = F_16 ( V_39 -> V_54 , V_45 ) ;
F_17 ( V_55 , V_39 -> V_54 ) ;
}
}
V_53:
...
T_1 V_59 ;
V_59 = ( V_35 * V_56 ) / 4 ;
F_20 ( V_1 , F_21 ( V_11 ) , V_59 * 1 ) ;
F_20 ( V_1 , F_22 ( V_11 ) , V_59 * 2 ) ;
F_20 ( V_1 , F_23 ( V_11 ) , V_59 * 3 ) ;
}
int F_24 ( struct V_2 * V_3 , enum V_10 V_11 , T_1 V_60 , T_1 V_61 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
struct V_62 * V_6 = V_1 -> V_6 ;
int V_63 = F_25 ( V_1 -> V_49 ) ;
...
V_67 = F_29 ( V_68 * V_66 , V_3 -> V_57 ) ;
if ( V_63 == 0 )
V_67 = F_30 ( V_67 ) ;
F_11 ( L_3 , F_31 ( V_11 ) , V_41 , V_67 ) ;
...
void F_32 ( struct V_2 * V_3 , enum V_10 V_11 )
{
int V_41 , V_35 ;
...
int V_45 = V_3 -> V_46 ;
T_1 V_55 , V_59 ;
F_34 (blk, *assigned, cnt) {
int V_71 = V_55 / 3 ;
int V_72 = V_55 % 3 ;
V_59 = F_35 ( V_1 , F_36 ( V_71 ) ) ;
switch ( V_72 ) {
case 0 :
V_59 &= ~ V_73 ;
V_59 |= F_37 ( V_34 ) ;
...
F_20 ( V_1 , F_36 ( V_71 ) , V_59 ) ;
F_20 ( V_1 , F_40 ( V_71 ) , V_59 ) ;
}
}
void F_41 ( struct V_2 * V_3 , enum V_10 V_11 )
{
int V_45 = V_3 -> V_46 ;
T_2 V_70 ;
int V_41 ;
...
struct V_38 * V_39 = & V_3 -> V_40 [ V_34 ] ;
F_42 ( V_70 , V_39 -> V_76 , V_39 -> V_54 , V_45 ) ;
F_33 ( V_3 , V_34 , & V_70 ) ;
}
}
void F_43 ( struct V_2 * V_3 , enum V_10 V_11 )
{
int V_45 = V_3 -> V_46 ;
T_2 V_77 ;
int V_41 ;
...
enum V_9 V_34 = F_4 ( V_11 , V_41 ) ;
struct V_38 * V_39 = & V_3 -> V_40 [ V_34 ] ;
if ( F_44 ( V_77 , V_39 -> V_76 , V_39 -> V_54 , V_45 ) ) {
unsigned long V_48 ;
F_9 ( & V_3 -> V_50 , V_48 ) ;
F_44 ( V_3 -> V_51 , V_3 -> V_51 , V_77 , V_45 ) ;
F_18 ( & V_3 -> V_50 , V_48 ) ;
F_33 ( V_3 , V_33 , & V_77 ) ;
}
F_45 ( V_39 -> V_76 , V_39 -> V_54 , V_45 ) ;
}
}
...
struct V_2 * F_48 ( struct V_62 * V_6 , const struct V_78 * V_49 )
{
struct V_2 * V_3 = NULL ;
int V_42 ;
V_3 = F_49 ( sizeof( * V_3 ) , V_79 ) ;
if ( F_50 ( ! V_3 ) ) {
V_42 = - V_80 ;
goto V_53;
}
...
V_3 -> V_46 = V_49 -> V_81 ;
V_3 -> V_57 = V_49 -> V_82 ;
F_45 ( V_3 -> V_51 , V_49 -> V_83 , V_3 -> V_46 ) ;
F_51 ( & V_3 -> V_50 ) ;
return V_3 ;
V_53:
if ( V_3 )
