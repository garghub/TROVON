...
static int F_14 ( struct V_42 * V_26 ,
unsigned V_43 ,
void * V_44 )
{
...
struct V_16 * V_16 = F_3 ( V_11 ) ;
F_12 ( & V_11 -> V_41 , L_2 ) ;
if ( F_16 ( & V_16 -> V_25 . V_45 ) )
F_11 ( V_11 ,
& V_16 -> V_46 ,
sizeof( V_16 -> V_46 ) ) ;
return 0 ;
}
static int F_17 ( struct V_42 * V_26 ,
unsigned V_43 ,
T_1 V_47 , char * V_48 ,
void * V_44 )
{
...
F_1 ( V_2 , V_22 ,
V_51 -> V_23 . V_4 ) ;
F_12 ( & V_50 -> V_41 , L_3 , V_51 -> V_23 . V_53 ,
V_51 -> V_23 . V_17 ) ;
V_51 -> V_33 = F_20 (
V_27 ,
& V_51 -> V_23 ,
& V_51 -> V_31 , & V_51 -> V_32 ) ;
if ( V_51 -> V_25 . V_54 . V_53 < 0 ) {
F_19 ( V_26 ,
V_55 , V_43 ,
V_56 |
V_57 ,
...
struct V_10 * V_11 ;
struct V_16 * V_16 ;
struct V_42 * V_26 = V_50 -> V_41 . V_59 ;
struct V_1 * V_2 ;
V_11 = F_22 ( & V_50 -> V_41 ,
sizeof( struct V_16 ) ) ;
if ( ! V_11 )
