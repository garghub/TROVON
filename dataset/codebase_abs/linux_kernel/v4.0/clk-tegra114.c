...
V_11 [ V_96 ] = V_2 ;
V_2 = F_32 ( L_32 , L_30 , 0 , V_1 ,
0 , 48 , V_97 ) ;
V_11 [ V_98 ] = V_2 ;
V_2 = F_32 ( L_33 , L_31 , 0 , V_1 ,
0 , 82 , V_97 ) ;
V_11 [ V_99 ] = V_2 ;
V_2 = F_31 ( NULL , L_34 , V_100 ,
F_8 ( V_100 ) ,
V_92 ,
V_1 + V_101 ,
29 , 3 , 0 , & V_102 ) ;
V_2 = F_33 ( L_35 , L_34 , V_1 + V_101 ,
& V_102 ) ;
V_11 [ V_103 ] = V_2 ;
for ( V_21 = 0 ; V_21 < F_8 ( V_104 ) ; V_21 ++ ) {
V_89 = & V_104 [ V_21 ] ;
V_2 = F_34 ( V_89 -> V_105 ,
V_89 -> V_106 . V_107 , V_89 -> V_108 ,
& V_89 -> V_109 , V_1 , V_89 -> V_110 , V_89 -> V_111 ) ;
V_11 [ V_89 -> V_112 ] = V_2 ;
}
F_35 ( V_1 , V_87 , V_113 ,
& V_114 ) ;
}
static void F_36 ( T_3 V_115 )
{
unsigned int V_20 ;
do {
V_20 = F_22 ( V_1 + V_116 ) ;
...
V_137 | V_138 |
V_139 | V_140 ) ;
F_12 ( V_134 , V_1 + V_141 ) ;
V_133 |= ( V_127 | V_128 |
V_129 | V_130 |
V_131 | V_132 ) ;
F_12 ( V_133 , V_1 + V_142 ) ;
F_46 () ;
}
void F_48 ( void )
{
...
static void T_1 F_50 ( struct V_146 * V_147 )
{
struct V_146 * V_148 ;
V_1 = F_51 ( V_147 , 0 ) ;
if ( ! V_1 ) {
...
F_16 ( V_1 , V_87 ) ;
F_30 ( V_1 , V_87 ) ;
F_54 ( V_1 , V_87 , V_113 , & V_151 ) ;
F_55 ( V_87 , V_113 ) ;
F_56 ( V_1 , V_87 , V_113 ,
& V_152 ) ;
F_57 ( V_147 ) ;
F_58 ( V_153 , F_8 ( V_153 ) ) ;
V_154 = F_41 ;
V_155 = & V_156 ;
}
