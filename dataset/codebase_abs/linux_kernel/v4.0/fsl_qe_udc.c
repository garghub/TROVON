...
F_100 ( & V_2 -> V_9 ) ;
if ( V_76 != 0 )
F_104 ( & V_2 -> V_2 . V_317 , & V_7 -> V_12 . V_317 ) ;
V_2 -> V_12 = & V_7 -> V_12 ;
return 0 ;
}
static void F_137 ( struct V_318 * V_13 )
{
...
unsigned int V_63 ;
const void * V_321 ;
V_320 = F_139 ( V_322 , & V_299 -> V_13 ) ;
if ( ! V_320 )
return - V_103 ;
V_321 = F_140 ( V_301 , L_39 , NULL ) ;
if ( ! V_321 || strcmp ( V_321 , L_40 ) )
return - V_147 ;
V_7 = F_130 ( V_299 ) ;
if ( ! V_7 ) {
...
V_7 -> V_53 = ( unsigned long ) V_320 -> V_162 ;
...
F_134 ( V_7 ) ;
V_7 -> V_12 . V_315 = & V_324 ;
V_7 -> V_12 . V_325 = & V_7 -> V_39 [ 0 ] . V_2 ;
F_100 ( & V_7 -> V_12 . V_317 ) ;
V_7 -> V_12 . V_135 = V_232 ;
V_7 -> V_12 . V_21 = V_326 ;
...
( unsigned long ) V_7 ) ;
V_7 -> V_332 = F_144 ( V_301 , 0 ) ;
if ( ! V_7 -> V_332 ) {
V_237 = - V_103 ;
goto V_333;
}
V_237 = F_145 ( V_7 -> V_332 , F_127 , 0 ,
V_326 , V_7 ) ;
if ( V_237 ) {
F_40 ( V_7 -> V_13 , L_42 ,
V_7 -> V_332 , V_237 ) ;
