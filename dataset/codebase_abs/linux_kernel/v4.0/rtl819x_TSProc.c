...
static void F_30 ( T_5 V_35 , T_3 * V_36 ,
T_8 V_96 , T_9 V_97 , T_3 V_98 ,
T_3 V_99 )
{
T_3 V_57 ;
if( V_35 == NULL )
...
static void F_34 ( struct V_3 * V_4 , T_5 V_122 ,
T_7 V_77 )
{
unsigned long V_8 = 0 ;
F_27 ( & V_122 -> V_63 ) ;
...
void F_40 ( struct V_3 * V_4 , T_3 * V_36 )
{
T_5 V_44 , V_127 ;
F_41 ( L_12 , V_36 ) ;
F_42 (pTS, pTmpTS, &ieee->Tx_TS_Pending_List, List)
{
...
F_42 (pTS, pTmpTS, &ieee->Tx_TS_Admit_List, List)
{
if ( memcmp ( V_44 -> V_36 , V_36 , 6 ) == 0 )
{
F_41 ( L_13 ) ;
...
F_42 (pTS, pTmpTS, &ieee->Rx_TS_Pending_List, List)
{
if ( memcmp ( V_44 -> V_36 , V_36 , 6 ) == 0 )
{
F_34 ( V_4 , V_44 , V_123 ) ;
...
F_42 (pTS, pTmpTS, &ieee->Rx_TS_Admit_List, List)
{
if ( memcmp ( V_44 -> V_36 , V_36 , 6 ) == 0 )
{
F_34 ( V_4 , V_44 , V_123 ) ;
...
void F_44 ( struct V_3 * V_4 , T_4 V_53 )
{
if( V_53 -> V_47 == false )
{
V_53 -> V_47 = true ;
