...
static int F_26 ( struct V_1 * V_2 , T_5 V_61 ,
T_2 V_63 , T_4 V_46 , T_1 * V_64 )
{
int V_8 ;
struct V_1 * V_3 ;
if ( V_63 >= V_65 )
return V_49 ;
V_3 = F_27 ( V_2 -> V_56 , V_63 ) ;
if ( ! V_3 )
return V_49 ;
switch ( V_61 ) {
case V_66 :
V_2 -> V_67 . V_68 ++ ;
V_8 = F_1 ( V_2 , V_3 , V_64 ) ;
break;
case V_69 :
V_2 -> V_67 . V_70 ++ ;
V_8 = F_9 ( V_2 , V_3 , V_64 ) ;
break;
case V_71 :
V_2 -> V_67 . V_72 ++ ;
V_8 = F_7 ( V_2 , V_3 ) ;
...
case V_83 :
V_2 -> V_67 . V_84 ++ ;
V_8 = F_19 ( V_2 , V_3 , V_64 ) ;
break;
case V_85 :
V_2 -> V_67 . V_86 ++ ;
V_8 = F_20 ( V_2 , V_3 , V_61 ) ;
break;
case V_87 :
V_2 -> V_67 . V_88 ++ ;
V_8 = F_20 ( V_2 , V_3 , V_61 ) ;
...
static int F_28 ( struct V_1 * V_2 , T_5 V_61 )
{
...
{
int V_95 = ( V_2 -> V_10 . V_32 -> V_96 & 0x00f0 ) >> 4 ;
int V_97 = V_2 -> V_10 . V_32 -> V_96 & 0x000f ;
T_4 V_46 ;
T_2 V_63 = V_2 -> V_98 -> V_99 . V_100 . V_101 [ V_97 ] ;
T_5 V_61 ;
int V_8 ;
if ( V_2 -> V_10 . V_32 -> V_33 . V_35 & V_102 )
return F_30 ( V_2 , V_103 ) ;
V_61 = F_31 ( V_2 ) ;
if ( F_28 ( V_2 , V_61 ) )
return - V_52 ;
if ( V_95 % 2 )
V_46 = V_2 -> V_98 -> V_99 . V_100 . V_101 [ V_95 ] ;
else
V_46 = V_2 -> V_98 -> V_99 . V_100 . V_101 [ V_95 + 1 ] ;
F_32 ( V_2 , V_61 , V_63 , V_46 ) ;
switch ( V_61 ) {
case V_104 :
V_2 -> V_67 . V_105 ++ ;
V_8 = F_12 ( V_2 , V_46 ) ;
break;
default:
V_8 = F_26 ( V_2 , V_61 , V_63 ,
V_46 ,
& V_2 -> V_98 -> V_99 . V_100 . V_101 [ V_95 ] ) ;
}
if ( V_8 < 0 )
return V_8 ;
F_33 ( V_2 , V_8 ) ;
