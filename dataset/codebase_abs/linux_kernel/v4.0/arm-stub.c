...
void F_19 ( T_11 * V_75 , unsigned long V_76 ,
unsigned long V_77 , T_11 * V_78 ,
int * V_79 )
{
T_9 V_80 = V_81 ;
T_11 * V_47 = V_78 ;
int V_82 ;
for ( V_82 = 0 ; V_82 < V_76 ; V_82 += V_77 ) {
T_11 * V_83 = ( void * ) V_75 + V_82 ;
T_9 V_84 , V_8 ;
if ( ! ( V_83 -> V_85 & V_86 ) )
continue;
V_84 = F_20 ( V_83 -> V_87 , V_88 ) ;
V_8 = F_21 ( V_83 -> V_89 * V_90 +
V_83 -> V_87 - V_84 , V_88 ) ;
if ( F_22 ( V_83 -> V_87 , V_91 ) && V_8 >= V_91 )
V_80 = F_21 ( V_80 , V_91 ) ;
V_83 -> V_92 = V_80 + V_83 -> V_87 - V_84 ;
V_80 += V_8 ;
memcpy ( V_47 , V_83 , V_77 ) ;
V_47 = ( void * ) V_47 + V_77 ;
++ * V_79 ;
}
}
