...
{
unsigned V_70 = F_56 ( V_22 ) ;
return ( V_70 & V_73 ) ? false : true ;
}
void * F_60 ( struct V_21 * V_22 , T_2 V_60 )
{
V_22 -> V_74 = F_61 ( V_60 , V_75 ) ;
if ( V_22 -> V_74 )
V_22 -> V_70 |= V_76 ;
return V_22 -> V_74 ;
}
...
F_77 ( V_101 . V_105 , V_2 -> V_13 -> V_105 , V_91 ) ;
F_77 ( V_101 . V_90 , V_2 -> V_90 , V_91 ) ;
V_22 = F_37 ( V_33 ) ;
if ( V_22 )
...
V_101 . V_107 = - 1 ;
if ( F_75 ( V_86 , & V_101 , sizeof( V_101 ) ) )
return - V_89 ;
return 0 ;
}
...
struct V_21 * V_22 ;
V_109 = F_79 ( V_2 -> V_83 , sizeof( * V_109 ) , V_75 ) ;
if ( ! V_109 )
return - V_111 ;
for ( V_15 = 0 ; V_15 < V_2 -> V_83 ; V_15 ++ ) {
V_22 = & V_2 -> V_84 [ V_15 ] ;
...
V_81 = F_75 ( V_86 , V_109 , V_2 -> V_83 * sizeof( * V_109 ) ) ;
F_10 ( V_109 ) ;
return V_81 ? - V_89 : 0 ;
}
...
struct V_21 * V_22 ;
struct V_43 * V_44 ;
if ( F_71 ( & V_143 , V_86 , sizeof( V_143 ) ) )
return - V_89 ;
...
if ( V_22 -> V_48 != V_33 )
return - V_151 ;
if ( V_143 . V_148 && ! ( V_44 -> V_78 . V_68 & V_152 ) ) {
V_143 . V_148 = F_84 ( V_22 , V_143 . V_148 ) ;
F_85 ( V_22 , V_143 . V_148 ) ;
if ( F_59 ( V_22 ) &&
F_86 ( V_22 ) == 0 ) {
F_62 ( V_2 , V_22 ) ;
}
}
if ( V_143 . V_149 && ( V_44 -> V_78 . V_68 & V_152 ) ) {
V_143 . V_149 =
F_87 ( V_22 , V_143 . V_149 ) ;
F_88 ( V_22 , V_143 . V_149 ) ;
}
V_150:
...
V_99:
if ( F_75 ( V_86 , & V_143 , sizeof( V_143 ) ) )
return - V_89 ;
return 0 ;
}
...
F_90 ( L_8 ,
V_155 [ 0 ] ) ;
F_90 ( L_9 , V_187 , __FILE__ ) ;
F_90 ( L_10 , V_154 -> V_156 ) ;
return 0 ;
}
return - V_65 ;
}
static int F_91 ( struct V_1 * V_2 , struct V_153 * V_154 ,
...
int V_15 = 0 ;
int V_81 = 0 ;
if ( F_71 ( & V_212 , V_86 , sizeof( V_212 ) ) )
return - V_89 ;
V_155 = F_97 ( V_214 , sizeof( unsigned int ) , V_75 ) ;
if ( ! V_155 ) {
V_81 = - V_111 ;
goto error;
}
V_213 = F_79 ( V_212 . V_215 , sizeof( * V_213 ) , V_75 ) ;
if ( ! V_213 ) {
V_81 = - V_111 ;
goto error;
}
if ( F_71 ( V_213 , V_212 . V_213 ,
...
if ( F_71 ( V_155 , V_213 [ V_15 ] . V_155 ,
...
V_81 = F_91 ( V_2 , V_213 + V_15 , V_155 , V_33 ) ;
if ( V_81 < 0 )
goto error;
if ( V_213 [ V_15 ] . V_154 & V_217 ) {
if ( F_75 ( V_213 [ V_15 ] . V_155 , V_155 ,
V_213 [ V_15 ] . V_156 * sizeof( unsigned int ) ) ) {
F_40 ( V_2 -> V_9 ,
L_23 ) ;
V_81 = - V_89 ;
...
if ( F_71 ( & V_154 , V_86 , sizeof( V_154 ) ) ) {
V_81 = - V_89 ;
goto error;
}
...
V_81 = F_91 ( V_2 , & V_154 , V_155 , V_33 ) ;
if ( V_81 < 0 )
goto error;
...
if ( F_104 ( V_79 ) )
return F_105 ( V_79 ) ;
V_81 = F_94 ( V_22 , V_78 -> V_220 , V_79 ) ;
if ( V_81 < 0 ) {
F_10 ( V_79 ) ;
return V_81 ;
}
...
V_81 = F_102 ( V_2 , V_22 , V_221 , & V_44 -> V_78 ) ;
if ( V_81 )
goto V_222;
V_81 = V_22 -> V_219 ( V_2 , V_22 , & V_44 -> V_78 ) ;
if ( V_44 -> V_78 . V_68 & V_223 || V_81 ) {
F_40 ( V_2 -> V_9 , L_32 , V_81 ) ;
V_78 = V_44 -> V_78 ;
V_78 . V_79 = ( unsigned int V_224 * ) V_221 ;
V_78 . V_155 = NULL ;
if ( F_75 ( V_86 , & V_78 , sizeof( V_78 ) ) ) {
F_40 ( V_2 -> V_9 , L_33 ) ;
V_81 = - V_89 ;
goto V_222;
}
...
V_22 = & V_2 -> V_84 [ V_78 . V_138 ] ;
if ( V_221 ) {
V_81 = F_102 ( V_2 , V_22 , V_221 , & V_78 ) ;
if ( V_81 )
return V_81 ;
}
...
static int F_108 ( struct V_1 * V_2 , unsigned long V_86 ,
void * V_33 )
{
int V_81 = 0 ;
unsigned long V_68 ;
...
static int F_109 ( struct V_1 * V_2 , unsigned long V_86 ,
void * V_33 )
{
struct V_21 * V_22 ;
if ( V_86 >= V_2 -> V_83 )
...
static int F_110 ( struct V_1 * V_2 , unsigned long V_86 ,
void * V_33 )
{
struct V_21 * V_22 ;
if ( V_86 >= V_2 -> V_83 )
...
static int F_111 ( struct V_1 * V_2 , unsigned long V_86 ,
void * V_33 )
{
struct V_21 * V_22 ;
if ( V_86 >= V_2 -> V_83 )
...
static int F_112 ( struct V_1 * V_2 , unsigned long V_86 ,
struct V_33 * V_33 )
{
struct V_34 * V_35 = V_33 -> V_36 ;
...
! ( V_231 -> V_44 -> V_78 . V_68 & V_152 ) )
return - V_49 ;
F_35 ( V_35 -> V_30 ) = V_232 ;
return 0 ;
}
static int F_113 ( struct V_1 * V_2 , unsigned long V_86 ,
struct V_33 * V_33 )
{
struct V_34 * V_35 = V_33 -> V_36 ;
struct V_21 * V_231 , * V_232 ;
...
static long F_114 ( struct V_33 * V_33 , unsigned int V_78 ,
unsigned long V_86 )
{
...
break;
case V_238 :
V_233 = F_76 ( V_2 , (struct V_100 T_3 * ) V_86 ,
V_33 ) ;
break;
case V_239 :
V_233 = F_78 ( V_2 ,
...
break;
case V_240 :
V_233 = F_81 ( V_2 , ( void T_3 * ) V_86 ) ;
break;
case V_241 :
V_233 = F_115 ( V_2 , ( void T_3 * ) V_86 ) ;
break;
case V_242 :
V_233 = F_83 ( V_2 ,
...
break;
case V_243 :
V_233 = F_108 ( V_2 , V_86 , V_33 ) ;
break;
case V_244 :
V_233 = F_109 ( V_2 , V_86 , V_33 ) ;
break;
case V_245 :
V_233 = F_110 ( V_2 , V_86 , V_33 ) ;
break;
case V_246 :
V_233 = F_106 ( V_2 , (struct V_218 T_3 * ) V_86 , V_33 ) ;
break;
case V_247 :
V_233 = F_107 ( V_2 , (struct V_218 T_3 * ) V_86 ,
V_33 ) ;
break;
case V_248 :
V_233 = F_96 ( V_2 ,
...
break;
case V_249 :
V_233 = F_100 ( V_2 , (struct V_153 T_3 * ) V_86 ,
V_33 ) ;
break;
case V_250 :
V_233 = F_111 ( V_2 , V_86 , V_33 ) ;
break;
case V_251 :
V_233 = F_112 ( V_2 , V_86 , V_33 ) ;
break;
case V_252 :
V_233 = F_113 ( V_2 , V_86 , V_33 ) ;
break;
default:
V_233 = - V_235 ;
break;
...
static void F_116 ( struct V_253 * V_254 )
{
struct V_255 * V_256 ;
V_256 = V_254 -> V_257 ;
F_117 ( V_256 ) ;
...
static int F_120 ( struct V_33 * V_33 , struct V_253 * V_258 )
{
struct V_34 * V_35 = V_33 -> V_36 ;
struct V_1 * V_2 = V_35 -> V_2 ;
struct V_21 * V_22 ;
...
if ( F_123 ( V_258 , V_259 ,
F_124 ( F_125 ( V_58 -> V_269 ) ) ,
V_50 , V_270 ) ) {
V_45 = - V_196 ;
goto V_236;
}
...
static unsigned int F_127 ( struct V_33 * V_33 , T_4 * V_274 )
{
unsigned int V_66 = 0 ;
struct V_34 * V_35 = V_33 -> V_36 ;
struct V_1 * V_2 = V_35 -> V_2 ;
...
V_22 = F_37 ( V_33 ) ;
if ( V_22 && V_22 -> V_44 ) {
F_128 ( V_33 , & V_22 -> V_44 -> V_80 , V_274 ) ;
if ( ! V_22 -> V_48 || ! F_57 ( V_22 ) ||
( V_22 -> V_44 -> V_78 . V_68 & V_152 ) ||
F_129 ( V_22 ) > 0 )
V_66 |= V_275 | V_276 ;
}
V_22 = F_38 ( V_33 ) ;
if ( V_22 && V_22 -> V_44 ) {
unsigned int V_277 = F_130 ( V_22 ) ;
F_128 ( V_33 , & V_22 -> V_44 -> V_80 , V_274 ) ;
...
if ( ! ( V_44 -> V_78 . V_68 & V_152 ) ) {
V_45 = - V_65 ;
goto V_197;
}
F_135 ( & V_44 -> V_80 , & V_274 ) ;
V_284 = true ;
while ( V_280 > 0 && ! V_45 ) {
F_136 ( V_287 ) ;
if ( ! F_57 ( V_22 ) ) {
...
V_282 = F_71 ( V_44 -> V_293 + V_44 -> V_144 ,
V_58 , V_156 ) ;
if ( V_282 ) {
V_156 -= V_282 ;
V_45 = - V_89 ;
...
static T_1 F_139 ( struct V_33 * V_33 , char T_3 * V_58 , T_2 V_280 ,
T_5 * V_281 )
{
struct V_21 * V_22 ;
struct V_43 * V_44 ;
...
static int F_140 ( struct V_296 * V_296 , struct V_33 * V_33 )
{
...
V_35 = F_61 ( sizeof( * V_35 ) , V_75 ) ;
if ( ! V_35 )
return - V_111 ;
V_35 -> V_2 = V_2 ;
F_16 ( & V_2 -> V_5 ) ;
if ( ! V_2 -> V_12 && ! F_70 ( V_297 ) ) {
F_40 ( V_2 -> V_9 , L_38 ) ;
V_233 = - V_61 ;
goto V_197;
}
...
static int F_143 ( int V_299 , struct V_33 * V_33 , int V_300 )
{
struct V_34 * V_35 = V_33 -> V_36 ;
struct V_1 * V_2 = V_35 -> V_2 ;
return F_144 ( V_299 , V_33 , V_300 , & V_2 -> V_301 ) ;
}
static int F_145 ( struct V_296 * V_296 , struct V_33 * V_33 )
{
struct V_34 * V_35 = V_33 -> V_36 ;
struct V_1 * V_2 = V_35 -> V_2 ;
...
if ( ! F_57 ( V_22 ) )
return;
if ( V_22 -> V_44 -> V_304 & V_227 )
V_303 |= V_71 ;
if ( V_22 -> V_44 -> V_304 & V_305 ) {
V_303 |= V_72 ;
V_70 |= V_72 ;
}
if ( V_303 ) {
F_53 ( V_22 , V_303 , V_70 ) ;
}
if ( V_44 -> V_225 & V_22 -> V_44 -> V_304 ) {
F_147 ( & V_44 -> V_80 ) ;
if ( V_22 -> V_28 & V_29 )
F_148 ( & V_2 -> V_301 , V_306 , V_307 ) ;
if ( V_22 -> V_28 & V_31 )
F_148 ( & V_2 -> V_301 , V_306 , V_308 ) ;
}
V_22 -> V_44 -> V_304 = 0 ;
}
struct V_1 * F_149 ( struct V_27 * V_309 )
{
struct V_1 * V_2 ;
struct V_27 * V_55 ;
unsigned V_15 ;
V_2 = F_61 ( sizeof( * V_2 ) , V_75 ) ;
if ( V_2 == NULL )
return F_150 ( - V_111 ) ;
F_1 ( V_2 ) ;
F_151 ( V_2 , V_309 ) ;
...
F_163 ( & V_313 , & V_314 ) ;
V_313 . V_315 = V_316 ;
V_45 = F_164 ( & V_313 . V_317 , L_46 ) ;
if ( V_45 ) {
F_165 ( F_24 ( V_20 , 0 ) ,
V_311 ) ;
return V_45 ;
}
if ( F_166 ( & V_313 , F_24 ( V_20 , 0 ) , V_311 ) ) {
F_165 ( F_24 ( V_20 , 0 ) ,
V_311 ) ;
return - V_199 ;
}
V_19 = F_167 ( V_316 , L_46 ) ;
if ( F_104 ( V_19 ) ) {
F_152 ( L_47 ) ;
F_168 ( & V_313 ) ;
F_165 ( F_24 ( V_20 , 0 ) ,
