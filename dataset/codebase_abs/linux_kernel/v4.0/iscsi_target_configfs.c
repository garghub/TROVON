...
char * V_2 )
{
return sprintf ( V_2 , L_81 V_147 L_82 ) ;
}
...
return sprintf ( V_2 , L_74 , V_161 -> V_165 ) ;
}
static T_1 F_68 (
struct V_145 * V_146 ,
const char * V_2 ,
...
{
struct V_63 * V_64 = V_68 -> V_72 ;
return snprintf ( V_39 , V_180 , L_100 , V_64 -> V_77 ) ;
}
