...
V_22 = F_6 ( V_5 , V_16 . V_14 + 0x01 ) ;
if ( V_22 != 0xff ) {
V_17 . V_14 = F_7 ( V_5 , V_22 , & V_18 , & V_19 ,
& V_20 , & V_21 ) ;
...
struct V_6 * V_7 = ( void * ) V_2 -> V_7 ;
struct V_8 * V_9 = & V_7 -> V_9 ;
F_19 ( V_9 , F_20 ( V_41 -> V_42 , L_5 , true ) ) ;
return 0 ;
}
static void
F_21 ( struct V_1 * V_2 )
...
V_28 = F_35 ( V_50 , 0 , 1 , V_66 , V_66 , 1 , & V_44 -> V_51 ) ;
if ( V_28 )
V_44 -> V_51 = NULL ;
}
if ( F_29 ( ! V_44 -> V_51 ) )
...
do {
if ( V_61 )
V_28 = F_37 ( V_58 , 0 , type , V_63 , V_62 , V_54 , & V_59 ) ;
else
V_28 = F_35 ( V_58 , 0 , type , V_63 , V_62 , V_54 , & V_59 ) ;
if ( V_28 ) {
F_31 ( & V_2 -> V_36 . V_53 ) ;
...
T_3 V_76 , V_77 ;
T_1 V_78 , V_79 , V_80 , V_81 ;
V_78 = F_40 ( V_2 , 0x100200 ) ;
V_79 = F_40 ( V_2 , 0x100204 ) ;
V_80 = F_40 ( V_2 , 0x100250 ) ;
F_41 ( V_2 , L_6 ,
V_78 , V_79 , V_80 , F_40 ( V_2 , 0x001540 ) ) ;
V_72 = ( V_79 & 0x0000f000 ) >> 12 ;
V_73 = ( ( V_79 & 0x000f0000 ) >> 16 ) + 8 ;
V_74 = ( ( V_79 & 0x00f00000 ) >> 20 ) + 8 ;
V_75 = 1 << ( ( ( V_79 & 0x03000000 ) >> 24 ) + 2 ) ;
V_76 = V_7 -> V_82 * V_75 * ( 1 << V_72 ) * 8 ;
V_77 = V_76 << V_73 ;
if ( V_78 & 0x00000004 )
V_77 += V_76 << V_74 ;
if ( V_77 != V_7 -> V_15 ) {
...
int
F_43 ( struct V_83 * V_84 , struct V_83 * V_85 ,
struct V_86 * V_87 , int V_69 , void * * V_88 )
{
const T_1 V_89 = ( 256 * 1024 ) >> 12 ;
const T_1 V_90 = ( 1024 * 1024 ) >> 12 ;
struct V_4 * V_5 = V_4 ( V_84 ) ;
struct V_1 * V_2 = V_1 ( V_84 ) ;
struct V_71 * V_7 ;
int V_28 ;
V_28 = F_44 ( V_84 , V_85 , V_87 , V_69 , V_88 ) ;
V_7 = * V_88 ;
if ( V_28 )
return V_28 ;
V_7 -> V_15 = F_40 ( V_2 , 0x10020c ) ;
V_7 -> V_15 = ( V_7 -> V_15 & 0xffffff00 ) | ( ( V_7 -> V_15 & 0x000000ff ) << 32 ) ;
V_7 -> V_91 = ( F_40 ( V_2 , 0x001540 ) & 0x00ff0000 ) >> 16 ;
V_7 -> V_82 = F_45 ( V_7 -> V_91 ) ;
...
V_28 = F_47 ( & V_2 -> V_49 , V_89 , ( V_7 -> V_15 >> 12 ) -
( V_89 + V_90 ) ,
F_39 ( V_2 , V_7 ) >> 12 ) ;
if ( V_28 )
return V_28 ;
...
static int
F_48 ( struct V_83 * V_84 , struct V_83 * V_85 ,
struct V_86 * V_87 , void * V_14 , T_1 V_98 ,
struct V_83 * * V_88 )
{
struct V_6 * V_7 ;
int V_28 , V_29 ;
V_28 = F_49 ( V_84 , V_85 , V_87 , & V_7 ) ;
* V_88 = F_50 ( V_7 ) ;
if ( V_28 )
return V_28 ;
switch ( V_7 -> V_36 . type ) {
...
V_7 -> V_9 . V_102 = F_51 ( 0x002504 ) ;
V_7 -> V_9 . V_103 = F_51 ( 0x00c040 ) ;
V_7 -> V_9 . V_104 = F_51 ( 0x004008 ) ;
V_7 -> V_9 . V_105 = F_51 ( 0x00400c ) ;
V_7 -> V_9 . V_106 = F_51 ( 0x100210 ) ;
V_7 -> V_9 . V_107 = F_51 ( 0x1002d0 ) ;
V_7 -> V_9 . V_108 = F_51 ( 0x1002d4 ) ;
V_7 -> V_9 . V_109 = F_51 ( 0x1002dc ) ;
for ( V_29 = 0 ; V_29 < 8 ; V_29 ++ )
V_7 -> V_9 . V_110 [ V_29 ] = F_51 ( 0x100da0 + ( V_29 * 0x04 ) ) ;
V_7 -> V_9 . V_111 = F_51 ( 0x100e20 ) ;
V_7 -> V_9 . V_112 = F_51 ( 0x100e24 ) ;
V_7 -> V_9 . V_113 = F_51 ( 0x611200 ) ;
for ( V_29 = 0 ; V_29 < 9 ; V_29 ++ )
V_7 -> V_9 . V_114 [ V_29 ] = F_51 ( 0x100220 + ( V_29 * 0x04 ) ) ;
if ( V_7 -> V_36 . V_96 > 1 ) {
V_7 -> V_9 . V_115 [ 0 ] = F_52 ( 0x1002c0 , 0x1002c8 ) ;
V_7 -> V_9 . V_115 [ 1 ] = F_52 ( 0x1002c4 , 0x1002cc ) ;
V_7 -> V_9 . V_115 [ 2 ] = F_52 ( 0x1002e0 , 0x1002e8 ) ;
V_7 -> V_9 . V_115 [ 3 ] = F_52 ( 0x1002e4 , 0x1002ec ) ;
} else {
V_7 -> V_9 . V_115 [ 0 ] = F_51 ( 0x1002c0 ) ;
V_7 -> V_9 . V_115 [ 1 ] = F_51 ( 0x1002c4 ) ;
V_7 -> V_9 . V_115 [ 2 ] = F_51 ( 0x1002e0 ) ;
V_7 -> V_9 . V_115 [ 3 ] = F_51 ( 0x1002e4 ) ;
}
return 0 ;
}
