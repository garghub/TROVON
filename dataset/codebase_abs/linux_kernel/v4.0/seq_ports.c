...
static inline int F_51 ( struct V_36 * V_78 , struct V_36 * V_79 )
{
return ( V_78 -> V_3 == V_79 -> V_3 ) && ( V_78 -> V_5 == V_79 -> V_5 ) ;
}
static int F_52 ( struct V_71 * V_78 ,
struct V_71 * V_79 )
{
if ( F_51 ( & V_78 -> V_49 , & V_79 -> V_49 ) &&
F_51 ( & V_78 -> V_47 , & V_79 -> V_47 ) ) {
...
V_73 = - V_91 ;
if ( V_17 ) {
if ( ! F_39 ( & V_86 -> V_15 ) || ! F_39 ( & V_47 -> V_15 ) )
goto V_92;
} else {
if ( V_86 -> V_17 || V_47 -> V_17 )
goto V_92;
F_3 (s, &src->list_head, src_list) {
if ( F_52 ( V_46 , & V_79 -> V_46 ) )
goto V_92;
}
...
if ( ( V_73 = F_47 ( V_82 , V_83 , V_86 , V_46 ,
V_81 -> V_27 != V_82 -> V_27 ) ) < 0 )
goto V_92;
V_87 = 1 ;
if ( ( V_73 = F_47 ( V_84 , V_85 , V_47 , V_46 ,
V_81 -> V_27 != V_84 -> V_27 ) ) < 0 )
goto V_92;
F_18 ( & V_86 -> V_18 , V_22 ) ;
F_19 ( & V_41 -> V_45 , & V_86 -> V_15 ) ;
...
struct V_40 * F_57 ( struct V_13 * V_93 ,
struct V_36 * V_94 )
{
struct V_40 * V_79 , * V_12 = NULL ;
F_58 ( & V_93 -> V_19 ) ;
F_3 (s, &src_grp->list_head, src_list) {
if ( F_51 ( V_94 , & V_79 -> V_46 . V_47 ) ) {
V_12 = V_79 ;
break;
}
}
