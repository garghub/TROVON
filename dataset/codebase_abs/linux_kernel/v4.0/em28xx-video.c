...
static int F_102 ( struct V_271 * V_271 , void * V_253 ,
struct V_352 * V_204 )
{
if ( F_103 ( V_204 -> V_238 >= F_67 ( V_47 ) ) )
return - V_199 ;
...
static int F_110 ( struct V_271 * V_376 )
{
...
static int F_129 ( struct V_271 * V_376 )
{
struct V_1 * V_2 = F_65 ( V_376 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
int V_93 ;
...
if ( V_44 )
goto V_440;
V_4 -> V_211 = F_131 ( V_2 , & V_450 , L_67 ) ;
if ( ! V_4 -> V_211 ) {
F_18 ( L_68 ) ;
V_44 = - V_451 ;
goto V_440;
...
F_152 ( & V_4 -> V_452 ) ;
F_152 ( & V_4 -> V_453 ) ;
V_4 -> V_211 -> V_454 = & V_4 -> V_222 ;
V_4 -> V_211 -> V_454 -> V_381 = & V_4 -> V_452 ;
if ( V_2 -> V_5 . V_6 ) {
...
if ( F_3 ( V_2 ) == 1 ) {
V_4 -> V_350 = F_131 ( V_2 , & V_450 ,
L_70 ) ;
V_4 -> V_350 -> V_454 = & V_4 -> V_236 ;
V_4 -> V_350 -> V_454 -> V_381 = & V_4 -> V_453 ;
...
if ( V_333 [ V_2 -> V_334 ] . V_401 . type == V_468 ) {
V_4 -> V_351 = F_131 ( V_2 , & V_469 ,
L_72 ) ;
if ( ! V_4 -> V_351 ) {
F_18 ( L_68 ) ;
V_44 = - V_451 ;
