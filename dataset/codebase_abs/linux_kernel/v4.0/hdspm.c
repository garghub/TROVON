...
static int F_232 ( struct V_403 * V_172 )
{
struct V_3 * V_3 = F_191 ( V_172 ) ;
F_36 ( & V_3 -> V_25 ) ;
V_3 -> V_27 = - 1 ;
...
static int F_233 ( struct V_456 * V_446 , struct V_457 * V_457 )
{
return 0 ;
}
static inline int F_234 ( void T_5 * V_458 , void T_6 * V_459 )
{
V_18 V_8 = F_6 ( V_459 ) ;
return F_235 ( V_458 , & V_8 , 4 ) ;
}
static int F_236 ( struct V_456 * V_446 , struct V_457 * V_457 ,
unsigned int V_431 , unsigned long V_215 )
{
void T_5 * V_460 = ( void T_5 * ) V_215 ;
struct V_3 * V_3 = V_446 -> V_175 ;
struct V_461 V_13 ;
struct V_462 V_428 ;
struct V_463 V_32 ;
struct V_464 V_464 ;
...
V_466 -> V_33 = F_5 ( V_3 , V_37 ) ;
V_87 = F_235 ( V_460 , V_466 , sizeof( struct V_465 ) ) ;
if ( 0 != V_87 ) {
return - V_490 ;
}
break;
...
V_87 = F_235 ( V_460 , & V_352 , sizeof( struct V_467 ) ) ;
if ( 0 != V_87 ) {
return - V_490 ;
}
break;
...
V_428 . V_503 = F_20 ( V_3 ) ;
V_428 . V_110 = V_3 -> V_110 ;
V_428 . V_504 =
F_18 ( V_3 ) ;
V_428 . V_359 = F_74 ( V_3 ) ;
V_428 . V_505 = F_90 ( V_3 ) ;
V_428 . V_358 = F_19 ( V_3 ) ;
V_428 . V_506 = F_108 ( V_3 , V_373 ) ;
V_428 . V_507 = 0 ;
F_38 ( & V_3 -> V_25 ) ;
if ( F_235 ( V_460 , & V_428 , sizeof( V_428 ) ) )
return - V_490 ;
break;
case V_508 :
...
V_32 . V_509 = V_3 -> V_5 ;
V_32 . V_510 = F_19 ( V_3 ) ;
V_32 . V_511 = 110069313433624ULL ;
V_32 . V_512 = F_5 ( V_3 , V_217 ) ;
switch ( V_3 -> V_5 ) {
case V_53 :
case V_49 :
V_32 . V_513 . V_514 . V_515 =
F_20 ( V_3 ) ;
V_32 . V_513 . V_514 . V_516 =
F_144 ( V_3 ) ;
V_32 . V_513 . V_514 . V_517 =
F_24 ( V_3 ) ;
V_32 . V_513 . V_514 . V_518 =
F_26 ( V_3 ) ;
V_468 =
F_5 ( V_3 , V_38 ) ;
V_32 . V_513 . V_514 . V_519 =
( V_468 & V_381 ) ? 1 : 0 ;
V_32 . V_513 . V_514 . V_520 =
( V_468 & V_382 ) ? 1 : 0 ;
V_32 . V_513 . V_514 . V_521 = 0 ;
default:
break;
}
if ( F_235 ( V_460 , & V_32 , sizeof( V_32 ) ) )
return - V_490 ;
break;
case V_522 :
memset ( & V_464 , 0 , sizeof( V_464 ) ) ;
V_464 . V_509 = V_3 -> V_5 ;
F_237 ( V_464 . V_523 , V_3 -> V_362 ,
sizeof( V_464 . V_523 ) ) ;
V_464 . V_368 = V_3 -> V_368 ;
V_464 . V_364 = V_3 -> V_364 ;
V_464 . V_524 = 0 ;
if ( V_3 -> V_234 )
V_464 . V_524 |= V_525 ;
if ( F_235 ( V_460 , & V_464 ,
sizeof( V_464 ) ) )
return - V_490 ;
break;
case V_526 :
if ( F_238 ( & V_13 , V_460 , sizeof( V_13 ) ) )
return - V_490 ;
...
static int F_239 ( struct V_179 * V_106 ,
struct V_3 * V_3 )
{
struct V_456 * V_446 ;
int V_180 ;
V_180 = F_240 ( V_106 , L_166 , 0 , & V_446 ) ;
if ( V_180 < 0 )
return V_180 ;
V_3 -> V_528 = V_446 ;
V_446 -> V_175 = V_3 ;
strcpy ( V_446 -> V_206 , L_167 ) ;
V_446 -> V_529 . V_530 = F_233 ;
V_446 -> V_529 . V_531 = F_236 ;
V_446 -> V_529 . V_532 = F_236 ;
V_446 -> V_529 . V_533 = F_233 ;
return 0 ;
}
...
static int F_245 ( struct V_179 * V_106 ,
struct V_3 * V_3 )
{
struct V_534 * V_535 ;
int V_180 ;
V_180 = F_246 ( V_106 , V_3 -> V_362 , 0 , 1 , 1 , & V_535 ) ;
if ( V_180 < 0 )
return V_180 ;
V_3 -> V_535 = V_535 ;
V_535 -> V_175 = V_3 ;
...
static int F_251 ( struct V_179 * V_106 ,
struct V_3 * V_3 )
{
struct V_545 * V_538 = V_3 -> V_538 ;
int V_180 ;
unsigned long V_546 ;
V_3 -> V_186 = - 1 ;
V_3 -> V_106 = V_106 ;
...
return V_180 ;
F_254 ( V_3 -> V_538 ) ;
V_180 = F_255 ( V_538 , L_151 ) ;
if ( V_180 < 0 )
return V_180 ;
V_3 -> V_369 = F_256 ( V_538 , 0 ) ;
V_546 = F_257 ( V_538 , 0 ) ;
F_202 ( V_106 -> V_107 , L_185 ,
V_3 -> V_369 , V_3 -> V_369 + V_546 - 1 ) ;
V_3 -> V_9 = F_258 ( V_3 -> V_369 , V_546 ) ;
if ( ! V_3 -> V_9 ) {
...
sizeof( struct V_527 ) ) ;
V_3 -> V_13 = F_260 ( sizeof( struct V_527 ) , V_556 ) ;
if ( ! V_3 -> V_13 ) {
F_46 ( V_106 -> V_107 ,
L_191 ,
( int ) sizeof( struct V_527 ) ) ;
return - V_557 ;
}
V_3 -> V_136 = NULL ;
V_3 -> V_138 = NULL ;
...
V_595 ) {
V_3 -> V_216 ++ ;
V_3 -> V_234 = F_260 ( sizeof( struct V_596 ) ,
V_556 ) ;
if ( NULL != V_3 -> V_234 ) {
F_148 ( V_3 ) ;
}
...
static void F_269 ( struct V_179 * V_106 )
{
struct V_3 * V_3 = V_106 -> V_175 ;
if ( V_3 )
F_263 ( V_3 ) ;
}
static int F_270 ( struct V_545 * V_538 ,
...
V_180 = F_271 ( & V_538 -> V_107 , V_236 [ V_107 ] , V_156 [ V_107 ] ,
...
static void F_274 ( struct V_545 * V_538 )
{
F_272 ( F_275 ( V_538 ) ) ;
}
