...
static bool
F_163 ( struct V_1 * V_1 , int V_363 )
{
...
static bool
F_167 ( struct V_1 * V_1 , int V_363 )
{
struct V_343 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_233 * V_233 ;
...
static bool
F_168 ( struct V_1 * V_1 , int V_363 )
{
struct V_343 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_233 * V_233 ;
...
V_1 -> V_346 = 0 ;
memcpy ( V_402 , & V_1 -> V_261 . V_274 , 2 ) ;
F_12 ( L_44 ,
F_18 ( V_1 ) ,
V_402 [ 0 ] , V_402 [ 1 ] ) ;
return false ;
...
F_173 (
V_7 -> V_326 , V_16 ,
V_16 , V_407 [ V_7 -> V_328 [ V_16 ] ] ) ;
V_1 -> V_179 = V_7 -> V_328 [ 0 ] ;
F_174 ( & V_7 -> V_4 . V_4 . V_4 ,
V_7 -> V_326 , 0 ) ;
return true ;
}
static bool
...
return false ;
V_7 -> V_333 = V_410 [ 0 ] ;
V_7 -> V_331 = V_410 [ 0 ] - V_44 ;
V_7 -> V_332 = V_7 -> V_331 ;
V_7 -> V_329 =
F_176 ( V_10 , 0 , L_46 , 0 , V_410 [ 0 ] ) ;
if ( ! V_7 -> V_329 )
return false ;
F_174 ( & V_6 -> V_4 ,
V_7 -> V_329 ,
...
F_177 ( V_439 , V_440 ) ;
if ( V_409 . V_441 ) {
if ( ! F_29 ( V_1 , V_442 , & V_44 , 2 ) )
return false ;
V_7 -> V_443 = 1 ;
V_7 -> V_444 = V_44 & 0x1 ;
V_7 -> V_441 =
F_176 ( V_10 , 0 , L_53 , 0 , 1 ) ;
if ( ! V_7 -> V_441 )
return false ;
F_174 ( & V_6 -> V_4 ,
V_7 -> V_441 ,
...
if ( F_125 ( V_7 ) )
return F_175 ( V_1 , V_7 , V_409 . V_304 ) ;
else if ( F_126 ( V_7 ) )
return F_178 ( V_1 , V_7 , V_409 . V_304 ) ;
else
return true ;
}
static int F_179 ( struct V_446 * V_447 ,
struct V_23 * V_24 ,
int V_448 )
{
struct V_1 * V_280 = V_447 -> V_449 ;
if ( ! F_27 ( V_280 , V_280 -> V_56 ) )
return - V_342 ;
return V_280 -> V_31 -> V_450 -> V_451 ( V_280 -> V_31 , V_24 , V_448 ) ;
}
static T_1 F_180 ( struct V_446 * V_447 )
{
struct V_1 * V_280 = V_447 -> V_449 ;
return V_280 -> V_31 -> V_450 -> V_452 ( V_280 -> V_31 ) ;
}
static bool
F_181 ( struct V_1 * V_280 ,
struct V_9 * V_10 )
{
V_280 -> V_281 . V_453 = V_454 ;
V_280 -> V_281 . V_455 = V_456 ;
snprintf ( V_280 -> V_281 . V_37 , V_457 , L_56 ) ;
V_280 -> V_281 . V_10 . V_458 = & V_10 -> V_459 -> V_10 ;
V_280 -> V_281 . V_449 = V_280 ;
V_280 -> V_281 . V_450 = & V_460 ;
return F_182 ( & V_280 -> V_281 ) == 0 ;
}
bool F_183 ( struct V_9 * V_10 , T_7 V_17 , bool V_356 )
{
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_2 * V_2 ;
struct V_1 * V_1 ;
...
V_2 = & V_1 -> V_4 ;
V_2 -> type = V_462 ;
F_184 ( V_10 , & V_2 -> V_4 , & V_463 , 0 ) ;
for ( V_16 = 0 ; V_16 < 0x40 ; V_16 ++ ) {
T_2 V_464 ;
if ( ! F_10 ( V_1 , V_16 , & V_464 ) ) {
F_12 ( L_57 ,
F_18 ( V_1 ) ) ;
goto V_391;
}
