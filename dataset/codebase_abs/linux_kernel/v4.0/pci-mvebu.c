...
static int F_68 ( struct V_149 * V_53 )
{
struct V_110 * V_52 ;
...
V_52 -> V_120 . V_65 = V_174 ;
V_52 -> V_120 . V_51 = F_73 ( T_4 ,
V_175 ,
F_40 ( & V_52 -> V_64 ) ) ;
} else
V_52 -> V_120 = V_52 -> V_64 ;
V_50 = F_74 ( V_151 , & V_52 -> V_126 ) ;
if ( V_50 ) {
F_26 ( & V_53 -> V_54 , L_8 ,
V_50 ) ;
return V_50 ;
...
V_2 -> V_178 = F_81 ( V_171 ,
L_14 , 0 , & V_133 ) ;
if ( F_82 ( V_2 -> V_178 ) ) {
T_1 V_179 = 20000 ;
V_2 -> V_180 = V_133 & V_181 ;
V_2 -> V_182 = F_79 ( V_172 ,
L_15 , V_2 -> V_2 , V_2 -> V_177 ) ;
F_77 ( V_171 , L_16 ,
& V_179 ) ;
V_50 = F_83 ( & V_53 -> V_54 ,
V_2 -> V_178 , V_183 , V_2 -> V_182 ) ;
if ( V_50 ) {
if ( V_50 == - V_184 )
return V_50 ;
continue;
...
V_52 -> V_114 = V_17 ;
for ( V_17 = 0 ; V_17 < ( V_175 - V_135 ) ; V_17 += V_135 )
