...
if ( ( ( V_2 -> V_34 + V_35 ) < V_2 -> V_34 ) ||
( ( V_2 -> V_34 + V_35 ) > V_41 ) ) {
F_23 ( L_5 ,
( unsigned long long ) V_41 , V_2 -> V_34 , V_35 ) ;
return V_45 ;
}
if ( V_38 [ 0 ] & 0x10 ) {
F_24 ( L_6 ) ;
...
if ( ! V_40 -> V_48 )
return V_43 ;
V_42 = F_25 ( V_4 , V_2 , & V_2 -> V_7 [ 0 ] , V_35 , true ) ;
if ( V_42 )
return V_42 ;
V_2 -> V_47 = V_40 -> V_48 ;
return 0 ;
...
{
unsigned char * V_12 , * V_49 ;
struct V_50 * V_51 ;
unsigned int V_52 ;
T_1 V_42 = V_53 ;
int V_54 , V_55 ;
V_12 = F_27 ( V_2 -> V_17 , V_56 ) ;
if ( ! V_12 ) {
F_23 ( L_9 ) ;
return V_57 ;
}
...
for ( V_54 = 0 ; V_54 < V_51 -> V_61 ; V_54 ++ )
* ( V_49 + V_51 -> V_52 + V_54 ) ^= * ( V_12 + V_52 + V_54 ) ;
V_52 += V_51 -> V_61 ;
F_32 ( V_49 ) ;
}
V_60:
...
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_50 * V_71 = NULL , * V_51 ;
unsigned char * V_12 = NULL , * V_49 ;
struct V_72 V_73 ;
unsigned int V_52 = 0 , V_74 ;
...
V_12 = F_40 ( V_2 -> V_17 , V_56 ) ;
if ( ! V_12 ) {
F_23 ( L_12 ) ;
V_42 = V_57 ;
goto V_60;
}
V_71 = F_27 ( sizeof( struct V_50 ) * V_2 -> V_59 ,
V_56 ) ;
if ( ! V_71 ) {
F_23 ( L_13 ) ;
V_42 = V_57 ;
...
F_41 ( V_71 , V_2 -> V_59 ) ;
V_78 = F_28 ( V_2 -> V_58 , V_2 -> V_59 , V_12 ,
V_2 -> V_17 ) ;
if ( ! V_78 ) {
F_23 ( L_14 ) ;
V_42 = V_57 ;
...
V_49 = ( unsigned char * ) F_30 ( F_31 ( V_51 ) ) ;
if ( ! V_49 ) {
V_42 = V_57 ;
goto V_60;
}
V_74 = F_42 ( V_51 -> V_61 , V_77 ) ;
if ( memcmp ( V_49 , V_12 + V_52 , V_74 ) ) {
F_24 ( L_15 ,
V_49 , V_12 + V_52 ) ;
F_32 ( V_49 ) ;
goto V_80;
...
V_54 = 0 ;
V_74 = V_2 -> V_76 * V_16 ;
F_43 ( & V_73 , V_2 -> V_58 , V_2 -> V_59 , V_81 ) ;
while ( V_74 ) {
F_44 ( & V_73 ) ;
if ( V_16 < V_82 ) {
F_45 ( & V_71 [ V_54 ] , V_73 . V_83 , V_16 ,
V_16 ) ;
} else {
F_44 ( & V_73 ) ;
F_45 ( & V_71 [ V_54 ] , V_73 . V_83 , V_16 ,
...
V_42 = V_2 -> V_62 ( V_2 , V_2 -> V_79 , V_2 -> V_97 ,
V_98 ) ;
if ( V_42 ) {
V_2 -> V_88 = NULL ;
F_38 ( & V_4 -> V_70 ) ;
...
static int
F_51 ( T_5 V_99 , enum V_100 V_101 ,
...
if ( F_51 ( V_99 , V_4 -> V_15 . V_25 ,
V_102 , V_2 ) )
return V_14 ;
V_2 -> V_101 = V_4 -> V_15 . V_25 ;
V_2 -> V_118 = V_4 -> V_118 * V_35 ;
if ( V_99 )
V_2 -> V_17 = V_35 * V_4 -> V_15 . V_16 ;
F_52 ( L_20
L_21 ,
V_119 , V_2 -> V_101 , V_2 -> V_17 , V_2 -> V_118 ,
V_2 -> V_103 , V_2 -> V_105 ) ;
return V_53 ;
}
static int
...
T_1
F_55 ( struct V_1 * V_2 , struct V_39 * V_40 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned char * V_6 = V_2 -> V_7 ;
unsigned int V_123 ;
...
if ( F_53 ( V_4 , V_2 , V_6 ) )
return V_14 ;
V_42 = F_25 ( V_4 , V_2 , V_6 , V_35 , false ) ;
if ( V_42 )
return V_42 ;
V_2 -> V_68 |= V_125 ;
V_2 -> V_62 = V_40 -> V_62 ;
...
if ( F_53 ( V_4 , V_2 , V_6 ) )
return V_14 ;
V_42 = F_25 ( V_4 , V_2 , V_6 , V_35 , true ) ;
if ( V_42 )
return V_42 ;
V_2 -> V_68 |= V_125 ;
V_2 -> V_62 = V_40 -> V_62 ;
...
V_123 = F_12 ( V_2 , 1 ) ;
V_2 -> V_34 = F_56 ( & V_6 [ 12 ] ) ;
V_42 = F_22 ( V_2 , & V_6 [ 10 ] , V_40 ) ;
if ( V_42 )
return V_42 ;
break;
default:
...
V_123 = 2 * F_12 ( V_2 , V_35 ) ;
V_2 -> V_34 = F_56 ( & V_6 [ 2 ] ) ;
V_2 -> V_76 = V_35 ;
V_2 -> V_68 |= V_125 | V_142 ;
V_2 -> V_62 = V_40 -> V_62 ;
V_2 -> V_47 = F_48 ;
V_2 -> V_88 = F_39 ;
break;
...
V_123 = V_165 ;
if ( V_123 / 16 > V_4 -> V_15 . V_168 ) {
V_42 = V_169 ;
goto V_170;
}
V_161 = & V_12 [ 8 ] ;
F_52 ( L_40
L_41 , V_4 -> V_9 -> V_93 , V_164 , V_165 , V_123 , V_161 ) ;
while ( V_123 >= 16 ) {
V_162 = F_56 ( & V_161 [ 0 ] ) ;
V_163 = F_9 ( & V_161 [ 8 ] ) ;
F_52 ( L_42 ,
...
V_42 = F_61 ( V_2 , V_160 , V_162 , V_163 ) ;
if ( V_42 )
goto V_170;
V_161 += 16 ;
V_123 -= 16 ;
...
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_172 * V_173 ;
struct V_50 * V_174 , * V_175 = V_2 -> V_111 ;
T_4 V_176 = V_2 -> V_34 ;
void * V_177 , * V_178 ;
int V_54 , V_179 , V_52 = 0 ;
F_29 (cmd->t_data_sg, dsg, cmd->t_data_nents, i) {
V_177 = F_30 ( F_31 ( V_174 ) ) + V_174 -> V_52 ;
V_178 = F_30 ( F_31 ( V_175 ) ) + V_175 -> V_52 ;
...
V_173 = V_178 + V_52 ;
V_173 -> V_180 = F_64 ( F_65 ( V_177 + V_179 ,
V_4 -> V_15 . V_16 ) ) ;
if ( V_4 -> V_15 . V_25 == V_107 )
V_173 -> V_181 = F_66 ( V_176 & 0xffffffff ) ;
V_173 -> V_182 = 0 ;
F_52 ( L_43
L_44 ,
( unsigned long long ) V_176 , V_173 -> V_180 ,
V_173 -> V_182 , F_67 ( V_173 -> V_181 ) ) ;
V_176 ++ ;
V_52 += sizeof( struct V_172 ) ;
}
F_32 ( V_178 ) ;
F_32 ( V_177 ) ;
}
...
static T_1
F_68 ( struct V_3 * V_4 , struct V_172 * V_173 ,
const void * V_183 , T_4 V_176 , unsigned int V_184 )
{
int V_16 = V_4 -> V_15 . V_16 ;
T_6 V_185 ;
V_185 = F_64 ( F_65 ( V_183 , V_16 ) ) ;
if ( V_173 -> V_180 != V_185 ) {
F_23 ( L_45
L_46 , ( unsigned long long ) V_176 ,
F_69 ( V_173 -> V_180 ) , F_69 ( V_185 ) ) ;
return V_186 ;
}
if ( V_4 -> V_15 . V_25 == V_107 &&
F_67 ( V_173 -> V_181 ) != ( V_176 & 0xffffffff ) ) {
F_23 ( L_47
L_48 , ( unsigned long long ) V_176 ,
F_67 ( V_173 -> V_181 ) , ( T_2 ) ( V_176 & 0xffffffff ) ) ;
return V_187 ;
}
if ( V_4 -> V_15 . V_25 == V_116 &&
F_67 ( V_173 -> V_181 ) != V_184 ) {
F_23 ( L_49
L_50 , ( unsigned long long ) V_176 ,
F_67 ( V_173 -> V_181 ) , V_184 ) ;
return V_187 ;
}
return 0 ;
...
static void
F_70 ( struct V_1 * V_2 , unsigned int V_35 , bool V_188 ,
struct V_50 * V_51 , int V_189 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_50 * V_175 ;
void * V_178 , * V_49 ;
unsigned int V_54 , V_74 , V_190 ;
unsigned int V_52 = V_189 ;
V_190 = V_35 * V_4 -> V_118 ;
F_29 (cmd->t_prot_sg, psg, cmd->t_prot_nents, i) {
unsigned int V_191 , V_192 = 0 ;
V_178 = F_30 ( F_31 ( V_175 ) ) + V_175 -> V_52 ;
V_191 = F_42 ( V_190 , V_175 -> V_61 ) ;
while ( V_191 ) {
V_74 = F_42 ( V_191 , V_51 -> V_61 - V_52 ) ;
V_49 = F_30 ( F_31 ( V_51 ) ) + V_51 -> V_52 + V_52 ;
if ( V_188 )
memcpy ( V_178 + V_192 , V_49 , V_74 ) ;
else
memcpy ( V_49 , V_178 + V_192 , V_74 ) ;
V_190 -= V_74 ;
V_52 += V_74 ;
V_192 += V_74 ;
V_191 -= V_74 ;
...
unsigned int V_184 , struct V_50 * V_51 , int V_189 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_172 * V_173 ;
struct V_50 * V_174 , * V_175 = V_2 -> V_111 ;
...
( unsigned long long ) V_176 , V_173 -> V_180 ,
V_173 -> V_182 , F_67 ( V_173 -> V_181 ) ) ;
V_78 = F_68 ( V_4 , V_173 , V_177 + V_179 , V_176 ,
V_184 ) ;
if ( V_78 ) {
F_32 ( V_178 ) ;
F_32 ( V_177 ) ;
...
F_70 ( V_2 , V_35 , false , V_51 , V_189 ) ;
return 0 ;
}
static T_1
F_72 ( struct V_1 * V_2 , T_4 V_193 , unsigned int V_35 ,
unsigned int V_184 , struct V_50 * V_51 , int V_189 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_172 * V_173 ;
struct V_50 * V_174 , * V_175 = V_51 ;
T_4 V_176 = V_193 ;
void * V_177 , * V_178 ;
int V_54 , V_179 , V_52 = V_189 ;
T_1 V_78 ;
F_29 (cmd->t_data_sg, dsg, cmd->t_data_nents, i) {
V_177 = F_30 ( F_31 ( V_174 ) ) + V_174 -> V_52 ;
V_178 = F_30 ( F_31 ( V_175 ) ) + V_51 -> V_52 ;
for ( V_179 = 0 ; V_179 < V_174 -> V_61 ; V_179 += V_4 -> V_15 . V_16 ) {
if ( V_52 >= V_175 -> V_61 ) {
F_32 ( V_178 ) ;
V_175 = F_63 ( V_175 ) ;
...
{
struct V_3 * V_4 = V_2 -> V_5 ;
T_2 V_35 = V_2 -> V_118 / V_4 -> V_118 ;
return F_72 ( V_2 , V_2 -> V_34 , V_35 , 0 ,
V_2 -> V_111 , 0 ) ;
}
T_1
F_74 ( struct V_1 * V_2 , T_4 V_193 , unsigned int V_35 ,
unsigned int V_184 , struct V_50 * V_51 , int V_189 )
{
T_1 V_78 ;
V_78 = F_72 ( V_2 , V_193 , V_35 , V_184 , V_51 , V_189 ) ;
if ( V_78 )
return V_78 ;
F_70 ( V_2 , V_35 , true , V_51 , V_189 ) ;
return 0 ;
}
