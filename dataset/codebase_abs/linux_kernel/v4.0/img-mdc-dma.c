...
static int F_48 ( struct V_9 * V_68 )
{
struct V_6 * V_7 = F_7 ( V_68 ) ;
struct V_12 * V_67 ;
unsigned long V_77 ;
...
static int F_52 ( struct V_9 * V_68 ,
struct V_141 * V_59 )
{
struct V_6 * V_7 = F_7 ( V_68 ) ;
unsigned long V_77 ;
...
static T_5 F_55 ( int V_143 , void * V_144 )
{
struct V_6 * V_7 = (struct V_6 * ) V_144 ;
struct V_12 * V_67 ;
T_1 V_5 , V_126 , V_145 , V_146 ;
unsigned int V_106 ;
F_56 ( & V_7 -> V_11 . V_116 ) ;
V_5 = F_5 ( V_7 , V_129 ) ;
V_126 = ( V_5 >> V_134 ) &
...
for ( V_106 = V_126 ; V_106 != V_145 ;
V_106 = ( V_106 + 1 ) % ( V_135 + 1 ) ) {
if ( ! V_67 -> V_136 ) {
V_67 -> V_136 = true ;
continue;
}
...
T_1 V_5 ;
int V_121 ;
V_2 = F_71 ( & V_159 -> V_21 , sizeof( * V_2 ) , V_164 ) ;
if ( ! V_2 )
return - V_165 ;
F_72 ( V_159 , V_2 ) ;
V_163 = F_73 ( V_166 , & V_159 -> V_21 ) ;
V_2 -> V_110 = V_163 -> V_167 ;
V_161 = F_74 ( V_159 , V_168 , 0 ) ;
V_2 -> V_4 = F_75 ( & V_159 -> V_21 , V_161 ) ;
if ( F_76 ( V_2 -> V_4 ) )
return F_77 ( V_2 -> V_4 ) ;
V_2 -> V_156 = F_78 ( V_159 -> V_21 . V_169 ,
L_4 ) ;
if ( F_76 ( V_2 -> V_156 ) )
return F_77 ( V_2 -> V_156 ) ;
V_2 -> V_170 = F_79 ( & V_159 -> V_21 , L_5 ) ;
if ( F_76 ( V_2 -> V_170 ) )
return F_77 ( V_2 -> V_170 ) ;
V_121 = F_80 ( V_2 -> V_170 ) ;
if ( V_121 )
return V_121 ;
F_81 ( V_2 -> V_20 . V_171 ) ;
F_82 ( V_172 , V_2 -> V_20 . V_171 ) ;
F_82 ( V_173 , V_2 -> V_20 . V_171 ) ;
F_82 ( V_174 , V_2 -> V_20 . V_171 ) ;
F_82 ( V_175 , V_2 -> V_20 . V_171 ) ;
V_5 = F_1 ( V_2 , V_176 ) ;
V_2 -> V_177 = ( V_5 >> V_178 ) &
V_179 ;
V_2 -> V_180 =
...
F_83 ( V_159 -> V_21 . V_169 , L_6 ,
& V_2 -> V_177 ) ;
V_121 = F_83 ( V_159 -> V_21 . V_169 ,
L_7 ,
& V_2 -> V_55 ) ;
if ( V_121 )
goto V_185;
...
F_84 ( & V_2 -> V_20 . V_200 ) ;
for ( V_106 = 0 ; V_106 < V_2 -> V_177 ; V_106 ++ ) {
struct V_6 * V_7 = & V_2 -> V_200 [ V_106 ] ;
V_7 -> V_2 = V_2 ;
V_7 -> V_8 = V_106 ;
V_7 -> V_143 = F_85 ( V_159 , V_106 ) ;
if ( V_7 -> V_143 < 0 ) {
V_121 = V_7 -> V_143 ;
goto V_185;
}
V_121 = F_86 ( & V_159 -> V_21 , V_7 -> V_143 , F_55 ,
V_201 ,
F_87 ( & V_159 -> V_21 ) , V_7 ) ;
if ( V_121 < 0 )
goto V_185;
...
if ( V_121 )
goto V_185;
V_121 = F_91 ( V_159 -> V_21 . V_169 , F_61 , V_2 ) ;
if ( V_121 )
goto V_203;
F_92 ( & V_159 -> V_21 , L_8 ,
V_2 -> V_177 , V_2 -> V_180 ) ;
...
struct V_6 * V_7 , * V_70 ;
F_97 ( V_159 -> V_21 . V_169 ) ;
F_93 ( & V_2 -> V_20 ) ;
F_98 (mchan, next, &mdma->dma_dev.channels,
vc.chan.device_node) {
F_38 ( & V_7 -> V_11 . V_68 . V_204 ) ;
F_99 ( V_7 -> V_143 ) ;
F_100 ( & V_159 -> V_21 , V_7 -> V_143 , V_7 ) ;
F_101 ( & V_7 -> V_11 . V_205 ) ;
}
F_94 ( V_2 -> V_170 ) ;
return 0 ;
}
