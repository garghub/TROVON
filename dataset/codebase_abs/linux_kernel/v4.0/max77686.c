...
struct V_9 * V_10 = F_4 ( V_18 ) ;
int V_21 , V_1 = F_5 ( V_18 ) ;
V_20 = F_1 ( V_1 ) ;
V_19 = V_22 ;
V_21 = F_6 ( V_18 -> V_23 , V_18 -> V_24 -> V_25 ,
...
return F_6 ( V_18 -> V_23 , V_18 -> V_24 -> V_25 ,
V_18 -> V_24 -> V_26 ,
V_10 -> V_27 [ V_1 ] << V_20 ) ;
}
static int F_11 ( struct V_17 * V_18 , int V_35 )
{
...
if ( F_14 ( V_46 -> V_48 ) ) {
V_10 -> V_14 |= ( 1 << V_24 -> V_1 ) ;
return F_6 ( V_46 -> V_23 , V_24 -> V_25 ,
V_24 -> V_26 ,
V_15 ) ;
}
return 0 ;
...
{
struct V_54 * V_55 = F_16 ( V_53 -> V_56 . V_57 ) ;
struct V_9 * V_10 ;
int V_58 ;
struct V_45 V_46 = { } ;
F_17 ( & V_53 -> V_56 , L_4 , V_59 ) ;
V_10 = F_18 ( & V_53 -> V_56 , sizeof( struct V_9 ) ,
V_60 ) ;
if ( ! V_10 )
return - V_61 ;
V_46 . V_56 = V_55 -> V_56 ;
