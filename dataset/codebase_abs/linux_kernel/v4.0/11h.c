...
struct V_49 V_50 ;
struct V_51 * V_51 =
F_12 ( V_48 , struct V_51 , V_48 ) ;
struct V_1 * V_2 =
F_12 ( V_51 , struct V_1 ,
V_52 ) ;
if ( F_13 ( ! V_2 ) )
return;
V_50 = V_2 -> V_53 ;
...
sizeof( T_2 ) ) ;
if ( F_22 ( V_86 -> V_93 ) != V_94 ) {
F_23 ( V_2 -> V_55 -> V_56 , L_4 ) ;
return - 1 ;
}
V_89 = ( void * ) & V_86 -> V_95 ;
while ( V_90 >= sizeof( struct V_9 ) ) {
V_88 = ( void * ) & V_86 -> V_95 ;
V_91 = F_24 ( V_88 -> V_23 . V_25 ) ;
switch ( F_24 ( V_88 -> V_23 . type ) ) {
case V_96 :
if ( V_88 -> V_97 . V_98 ) {
F_25 ( V_2 -> V_55 -> V_56 ,
L_5 ,
...
V_59 ) ;
F_14 ( V_2 -> V_55 -> V_56 , L_7 ,
V_101 -> V_103 ) ;
F_14 ( V_2 -> V_55 -> V_56 , L_8 ,
V_101 -> V_104 ) ;
} else {
F_14 ( V_2 -> V_55 -> V_56 , L_9 ) ;
}
return 0 ;
}
