...
V_149 |= V_234 ;
V_222 -> V_235 = F_128 ( V_149 ) ;
V_49 = F_45 ( V_1 , V_53 . V_100 , & V_223 ) ;
if ( V_49 )
return V_49 ;
memset ( V_222 -> V_97 . V_236 . V_237 , 0xff ,
sizeof( V_222 -> V_97 . V_236 . V_237 ) ) ;
V_222 -> V_97 . V_236 . V_237 [ 0 ] = V_223 & V_238 ;
if ( V_1 -> V_59 > 7 ) {
V_222 -> V_97 . V_236 . V_237 [ 1 ] = ( V_223 & V_238 ) >> 8 ;
V_222 -> V_97 . V_236 . V_237 [ 2 ] = 0xff ;
} else
V_222 -> V_97 . V_236 . V_237 [ 1 ] = 0xff ;
return 0 ;
}
...
static int F_131 ( struct V_1 * V_1 , T_5 * V_222 , T_3 V_241 )
{
...
static int F_132 ( struct V_1 * V_1 , int V_244 )
{
int V_49 ;
T_2 V_245 ;
T_3 V_246 ;
...
static int F_134 ( struct V_1 * V_1 , T_3 V_254 ,
T_3 V_241 )
{
if ( V_241 == 0 || V_241 > V_1 -> V_59 ) {
return - V_141 ;
...
static int F_137 ( struct V_5 * V_6 , T_3 V_278 , T_3 V_254 ,
...
static int F_138 ( struct V_5 * V_6 , unsigned V_290 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 1 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_12
...
if ( V_12 -> V_18 . V_306 )
return - V_141 ;
V_6 = F_150 ( & V_307 , & V_12 -> V_18 , F_151 ( & V_12 -> V_18 ) ) ;
if ( ! V_6 ) {
F_118 ( V_208 L_77
) ;
F_49 ( V_12 ) ;
