...
if ( ! V_48 -> V_193 ) {
F_101 ( & V_132 -> V_35 , L_31 ,
V_48 -> V_7 ) ;
continue;
}
V_48 -> V_160 = F_102 ( V_48 -> V_134 , 32 ,
& V_194 , NULL ) ;
if ( ! V_48 -> V_160 ) {
F_101 ( & V_132 -> V_35 , L_32 ,
V_48 -> V_7 ) ;
continue;
}
V_54 = F_103 ( V_48 -> V_160 , 32 , 1 ,
L_33 , V_180 ,
V_189 , 0 , V_195 ) ;
if ( V_54 ) {
...
F_43 ( 0xffffffff , V_48 -> V_109 + V_187 ) ;
F_43 ( 0xffffffff , V_48 -> V_109 + V_196 ) ;
V_3 = F_105 ( V_48 -> V_160 , 0 ) ;
V_3 -> V_109 = V_48 -> V_109 ;
V_3 -> V_175 = V_48 ;
V_3 -> V_197 [ 0 ] . V_198 . V_55 = V_187 ;
V_3 -> V_197 [ 0 ] . V_198 . V_199 = V_200 ;
V_3 -> V_197 [ 0 ] . V_107 . V_201 = V_202 ;
V_3 -> V_197 [ 0 ] . V_107 . V_203 = V_204 ;
V_3 -> V_197 [ 0 ] . V_107 . V_205 = V_206 ;
V_3 -> V_197 [ 0 ] . V_107 . V_207 = V_208 ;
V_3 -> V_197 [ 0 ] . V_107 . V_209 = F_96 ;
V_3 -> V_197 [ 0 ] . V_107 . V_210 = F_99 ;
V_3 -> V_197 [ 0 ] . V_107 . V_211 = F_91 ;
V_3 -> V_212 = F_106 ( V_48 -> V_16 ) ;
F_107 ( V_48 -> V_162 , V_48 ) ;
F_108 ( V_48 -> V_162 , F_83 ) ;
}
return 0 ;
}
...
static int F_113 ( struct V_1 * V_48 ,
struct V_5 * V_6 )
{
struct V_216 V_217 ;
void T_5 * V_113 ;
if ( F_114 ( V_48 -> V_134 , 0 , & V_217 ) ) {
F_12 ( V_6 -> V_35 , L_36 ) ;
return - V_218 ;
}
V_48 -> V_109 = F_115 ( V_6 -> V_35 , & V_217 ) ;
if ( F_60 ( V_48 -> V_109 ) )
return F_61 ( V_48 -> V_109 ) ;
if ( F_116 ( V_48 -> V_134 ,
L_37 ) ) {
struct V_26 * V_219 ;
V_219 = F_117 ( V_48 -> V_134 -> V_33 ,
L_38 , 0 ) ;
if ( ! V_219 ) {
if ( F_114 ( V_48 -> V_134 , 1 , & V_217 ) ) {
F_12 ( V_6 -> V_35 , L_36 ) ;
return - V_218 ;
}
V_113 = F_115 ( V_6 -> V_35 , & V_217 ) ;
if ( F_60 ( V_113 ) )
return F_61 ( V_113 ) ;
V_220 . V_221 =
F_118 ( & V_217 ) - 4 ;
V_220 . V_7 =
L_39 ;
V_48 -> V_74 = F_119 ( V_6 -> V_35 ,
V_113 ,
& V_220 ) ;
}
}
V_48 -> V_162 = F_120 ( V_48 -> V_134 , 0 ) ;
V_48 -> V_222 = F_121 ( V_48 -> V_134 , 0 ) ;
if ( F_60 ( V_48 -> V_222 ) )
return F_61 ( V_48 -> V_222 ) ;
return F_122 ( V_48 -> V_222 ) ;
}
static struct V_88 * F_123 (
struct V_5 * V_173 ,
struct V_131 * V_132 )
{
const struct V_223 * V_224 ;
struct V_26 * V_219 = V_132 -> V_35 . V_134 ;
struct V_26 * V_27 ;
struct V_88 * V_13 ;
struct V_1 * V_48 ;
int V_225 , V_226 , V_8 , V_126 ;
V_224 = F_55 ( V_227 , V_219 ) ;
V_13 = (struct V_88 * ) V_224 -> V_39 ;
F_54 (node, np) {
if ( ! F_124 ( V_27 , L_40 , NULL ) )
continue;
V_48 = V_13 -> V_14 ;
for ( V_8 = 0 ; V_8 < V_13 -> V_18 ; ++ V_8 , ++ V_48 ) {
...
struct V_231 * V_232 = & V_48 -> V_57 [ V_126 ] ;
int V_233 ;
if ( V_230 >= V_48 -> V_16 )
break;
if ( V_232 -> V_65 >= 0 ) {
...
V_232 -> V_65 = ( V_232 -> type & V_61 ) ?
V_226 : V_225 ;
}
F_18 ( V_173 -> V_35 , L_41 ,
V_8 , V_126 , V_232 -> V_65 ) ;
V_233 = ( V_232 -> type & V_64 ) ? 8 : 4 ;
if ( V_232 -> type & V_61 )
V_226 += V_233 ;
else
V_225 += V_233 ;
...
static int T_6 F_126 ( struct V_133 * V_35 )
{
struct V_5 * V_6 = F_127 ( V_35 ) ;
int V_54 = F_128 ( V_6 -> V_152 ) ;
if ( V_54 )
return V_54 ;
if ( V_6 -> V_13 -> type == V_95 ) {
V_54 = F_21 ( V_6 -> V_63 , V_234 ,
& V_235 ) ;
if ( V_54 ) {
F_129 ( V_6 -> V_152 ) ;
return V_54 ;
...
static int T_6 F_130 ( struct V_133 * V_35 )
{
struct V_5 * V_6 = F_127 ( V_35 ) ;
int V_54 = F_36 ( V_6 -> V_63 , V_234 ,
V_235 |
V_236 ) ;
if ( V_54 )
return V_54 ;
return F_129 ( V_6 -> V_152 ) ;
}
static int F_131 ( struct V_131 * V_132 )
{
struct V_5 * V_6 ;
struct V_133 * V_35 = & V_132 -> V_35 ;
struct V_88 * V_13 ;
struct V_26 * V_27 = V_132 -> V_35 . V_134 , * V_219 ;
struct V_216 * V_217 ;
void T_5 * V_113 ;
int V_54 ;
if ( ! V_35 -> V_134 ) {
...
return - V_37 ;
V_6 -> V_35 = V_35 ;
V_13 = F_123 ( V_6 , V_132 ) ;
if ( ! V_13 ) {
F_12 ( V_35 , L_43 ) ;
return - V_20 ;
}
V_6 -> V_13 = V_13 ;
V_219 = F_117 ( V_27 , L_44 , 0 ) ;
if ( V_219 ) {
V_6 -> V_63 = F_132 ( V_219 ) ;
if ( F_60 ( V_6 -> V_63 ) )
return F_61 ( V_6 -> V_63 ) ;
} else {
V_217 = F_133 ( V_132 , V_238 , 0 ) ;
V_113 = F_115 ( & V_132 -> V_35 , V_217 ) ;
if ( F_60 ( V_113 ) )
return F_61 ( V_113 ) ;
V_220 . V_221 = F_118 ( V_217 ) - 4 ;
V_220 . V_7 = L_45 ;
V_6 -> V_63 = F_119 ( & V_132 -> V_35 , V_113 ,
& V_220 ) ;
V_6 -> V_239 = F_118 ( V_217 ) ;
if ( V_13 -> type == V_94 && V_6 -> V_239 < 0x200 ) {
V_217 = F_133 ( V_132 , V_238 , 1 ) ;
V_113 = F_115 ( & V_132 -> V_35 , V_217 ) ;
if ( F_60 ( V_113 ) )
return F_61 ( V_113 ) ;
V_220 . V_221 =
F_118 ( V_217 ) - 4 ;
V_220 . V_7 = L_46 ;
V_6 -> V_74 = F_119 ( & V_132 -> V_35 ,
V_113 ,
& V_220 ) ;
}
}
V_219 = F_117 ( V_27 , L_38 , 0 ) ;
if ( V_219 ) {
V_6 -> V_62 = F_132 ( V_219 ) ;
if ( F_60 ( V_6 -> V_62 ) )
return F_61 ( V_6 -> V_62 ) ;
}
V_54 = F_109 ( V_132 , V_6 ) ;
if ( V_54 )
return V_54 ;
V_54 = F_67 ( V_132 , V_6 ) ;
if ( V_54 ) {
