...
F_6 ( 0x4050 , V_2 -> V_16 + V_239 ) ;
F_6 ( 0 , V_2 -> V_16 + V_25 ) ;
F_6 ( V_234 , V_2 -> V_16 + V_235 ) ;
F_36 ( & V_2 -> V_11 [ 0 ] , 7 ) ;
F_45 ( V_2 -> V_170 ) ;
F_45 ( V_2 -> V_171 ) ;
return 0 ;
...
static bool F_61 ( struct V_140 * V_141 , void * V_240 )
{
struct V_6 * V_7 = F_32 ( V_141 ) ;
struct V_163 * V_64 = V_240 ;
if ( ! F_62 ( V_141 ) )
return false ;
V_7 -> V_64 = * V_64 ;
...
static struct V_140 * F_63 ( struct V_241 * V_242 ,
struct V_243 * V_244 )
{
struct V_1 * V_2 = V_244 -> V_245 ;
T_7 V_246 = V_2 -> V_247 . V_248 ;
struct V_163 V_64 ;
if ( V_242 -> V_249 != 3 )
return NULL ;
V_64 . V_169 = V_242 -> args [ 0 ] ;
V_64 . V_72 = V_242 -> args [ 1 ] ;
V_64 . V_147 = V_242 -> args [ 2 ] ;
return F_64 ( V_246 , F_61 , & V_64 ) ;
}
static int F_65 ( struct V_250 * V_251 )
{
const struct V_252 * V_253 =
F_66 ( V_254 , & V_251 -> V_24 ) ;
struct V_255 * V_256 = V_251 -> V_24 . V_257 ;
const char * V_231 ;
int V_21 ;
int V_66 ;
struct V_258 * V_259 ;
struct V_260 * V_261 = F_67 ( & V_251 -> V_24 ) ;
int V_60 ;
struct V_1 * V_2 ;
T_6 * V_213 ;
const struct V_262 * V_5 = NULL ;
if ( V_253 )
V_5 = V_253 -> V_64 ;
else if ( V_251 -> V_263 )
V_5 = ( void * ) V_251 -> V_263 -> V_264 ;
if ( ! V_5 ) {
F_12 ( & V_251 -> V_24 , L_21 ) ;
return - V_15 ;
}
V_21 = F_68 ( & V_251 -> V_24 , F_69 ( 32 ) ) ;
if ( V_21 )
return V_21 ;
V_2 = F_70 ( & V_251 -> V_24 , sizeof( * V_2 ) , V_37 ) ;
if ( ! V_2 )
return - V_38 ;
F_71 ( & V_2 -> V_39 ) ;
V_2 -> V_24 = & V_251 -> V_24 ;
...
if ( V_66 < 0 )
return V_66 ;
V_259 = F_73 ( V_251 , V_265 , 0 ) ;
V_2 -> V_16 = F_74 ( & V_251 -> V_24 , V_259 ) ;
if ( F_75 ( V_2 -> V_16 ) )
return F_76 ( V_2 -> V_16 ) ;
V_2 -> V_170 = F_77 ( & V_251 -> V_24 , L_22 ) ;
if ( F_75 ( V_2 -> V_170 ) )
return F_76 ( V_2 -> V_170 ) ;
V_2 -> V_171 = F_77 ( & V_251 -> V_24 , L_23 ) ;
if ( F_75 ( V_2 -> V_171 ) )
return F_76 ( V_2 -> V_171 ) ;
F_78 ( V_2 -> V_170 ) ;
F_78 ( V_2 -> V_171 ) ;
V_21 = F_79 ( & V_251 -> V_24 , V_66 , F_26 , 0 , L_24 ,
V_2 ) ;
if ( V_21 )
return V_21 ;
...
V_213 [ V_60 ] = - V_15 ;
F_81 ( V_266 , V_2 -> V_247 . V_248 ) ;
F_81 ( V_267 , V_2 -> V_247 . V_248 ) ;
F_82 ( & V_2 -> V_247 . V_268 ) ;
for ( V_60 = 0 ; V_60 < V_236 ; V_60 ++ ) {
struct V_6 * V_7 = & V_2 -> V_11 [ V_60 ] ;
V_7 -> V_2 = V_2 ;
F_71 ( & V_7 -> V_162 ) ;
V_7 -> V_141 . V_269 = & V_2 -> V_247 ;
F_83 ( & V_7 -> V_141 ) ;
V_7 -> V_11 = V_60 ;
F_84 ( & V_7 -> V_69 , F_25 ,
( unsigned long ) V_7 ) ;
if ( V_60 )
F_85 ( & V_7 -> V_141 . V_255 ,
& V_2 -> V_247 . V_268 ) ;
}
V_21 = F_60 ( V_2 ) ;
if ( V_21 )
...
F_54 ( V_2 , V_261 -> V_80 ) ;
if ( V_261 ) {
V_21 = F_58 ( V_2 , V_261 -> V_231 ) ;
if ( V_21 )
F_86 ( & V_251 -> V_24 , L_25 ) ;
} else {
V_21 = F_87 ( V_256 , L_26 ,
& V_231 ) ;
if ( V_21 )
F_86 ( & V_251 -> V_24 , L_27 ) ;
else {
V_21 = F_58 ( V_2 , V_231 ) ;
if ( V_21 )
F_86 ( & V_251 -> V_24 , L_28 ) ;
}
}
V_2 -> V_247 . V_24 = & V_251 -> V_24 ;
V_2 -> V_247 . V_271 = F_41 ;
V_2 -> V_247 . V_272 = F_44 ;
V_2 -> V_247 . V_273 = F_51 ;
V_2 -> V_247 . V_274 = F_46 ;
V_2 -> V_247 . V_275 = F_49 ;
V_2 -> V_247 . V_276 = F_50 ;
V_2 -> V_247 . V_277 = F_34 ;
V_2 -> V_247 . V_278 = F_9 ( V_186 ) ;
V_2 -> V_247 . V_279 = F_9 ( V_186 ) ;
V_2 -> V_247 . V_280 = F_9 ( V_130 ) | F_9 ( V_281 ) ;
V_2 -> V_247 . V_282 = V_283 ;
V_2 -> V_247 . V_284 = F_53 ;
V_2 -> V_247 . V_24 -> V_285 = & V_2 -> V_285 ;
F_88 ( V_2 -> V_247 . V_24 , 65535 ) ;
F_89 ( V_251 , V_2 ) ;
V_21 = F_90 ( & V_2 -> V_247 ) ;
if ( V_21 ) {
F_12 ( & V_251 -> V_24 , L_29 ) ;
goto V_270;
}
if ( V_256 ) {
V_21 = F_91 ( V_256 , F_63 , V_2 ) ;
if ( V_21 ) {
F_12 ( & V_251 -> V_24 , L_30 ) ;
goto V_286;
}
}
F_56 ( V_2 -> V_24 , L_31 ) ;
