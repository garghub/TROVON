...
static int
F_114 ( struct V_10 * V_11 , bool V_112 )
{
struct V_25 * V_26 = V_25 ( V_11 ) ;
struct V_15 * V_16 ;
F_104 ( V_26 , L_18 ) ;
...
return V_18 ;
F_52 ( V_2 ) ;
return F_114 ( V_119 , false ) ;
}
static int
F_124 ( struct V_36 * V_11 )
{
struct V_1 * V_2 = F_117 ( V_11 ) ;
struct V_10 * V_119 = F_102 ( V_2 ) ;
...
static int
F_140 ( struct V_10 * V_11 , struct V_137 * V_138 )
{
struct V_25 * V_26 = V_25 ( V_11 ) ;
struct V_15 * V_16 ;
char V_3 [ 32 ] , V_139 [ V_140 ] ;
int V_18 ;
V_18 = F_93 ( V_11 -> V_11 ) ;
if ( V_18 < 0 && V_18 != - V_141 )
return V_18 ;
F_141 ( V_139 , V_142 ) ;
snprintf ( V_3 , sizeof( V_3 ) , L_25 , V_139 , F_142 ( V_138 -> V_143 ) ) ;
V_18 = F_7 ( F_6 ( V_11 ) , V_3 , sizeof( * V_16 ) ,
( void * * ) & V_16 ) ;
if ( V_18 )
goto V_144;
V_16 -> V_21 . V_145 = false ;
if ( V_26 -> V_36 . V_51 . V_52 >= V_103 ) {
V_18 = F_72 ( F_73 ( & V_26 -> V_36 ) , 0 , ( 1ULL << 40 ) ,
0x1000 , & V_16 -> V_24 ) ;
if ( V_18 ) {
...
V_138 -> V_146 = V_16 ;
F_143 ( & V_26 -> V_92 . V_22 ) ;
F_144 ( & V_16 -> V_147 , & V_26 -> V_94 ) ;
F_145 ( & V_26 -> V_92 . V_22 ) ;
V_144:
F_85 ( V_11 -> V_11 ) ;
F_146 ( V_11 -> V_11 ) ;
return V_18 ;
...
static void
F_147 ( struct V_10 * V_11 , struct V_137 * V_138 )
{
struct V_15 * V_16 = V_15 ( V_138 ) ;
struct V_25 * V_26 = V_25 ( V_11 ) ;
F_93 ( V_11 -> V_11 ) ;
if ( V_16 -> V_148 )
F_148 ( V_16 -> V_148 ) ;
...
static void
F_150 ( struct V_10 * V_11 , struct V_137 * V_138 )
{
struct V_15 * V_16 = V_15 ( V_138 ) ;
F_12 ( V_16 ) ;
F_85 ( V_11 -> V_11 ) ;
...
long
F_151 ( struct V_149 * V_149 , unsigned int V_150 , unsigned long V_151 )
{
struct V_137 * V_152 = V_149 -> V_153 ;
struct V_10 * V_11 = V_152 -> V_154 -> V_11 ;
long V_18 ;
V_18 = F_93 ( V_11 -> V_11 ) ;
if ( V_18 < 0 && V_18 != - V_141 )
return V_18 ;
switch ( F_152 ( V_150 ) - V_155 ) {
case V_156 :
V_18 = F_153 ( V_152 , ( void V_157 * ) V_151 , F_154 ( V_150 ) ) ;
break;
default:
V_18 = F_155 ( V_149 , V_150 , V_151 ) ;
break;
}
F_85 ( V_11 -> V_11 ) ;
F_146 ( V_11 -> V_11 ) ;
