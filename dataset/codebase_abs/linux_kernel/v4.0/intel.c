...
static unsigned int F_55 ( struct V_1 * V_2 , unsigned int V_90 )
{
...
static void F_56 ( const unsigned char V_91 )
{
unsigned char V_92 ;
if ( V_91 == 0 )
return;
...
F_58 ( 2 , & V_122 [ 0 ] , & V_122 [ 1 ] , & V_122 [ 2 ] , & V_122 [ 3 ] ) ;
