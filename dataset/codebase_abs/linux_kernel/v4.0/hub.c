...
void F_226 ( struct V_7 * V_445 )
{
F_71 ( & V_445 -> V_19 , L_125 ) ;
V_445 -> V_221 = 1 ;
}
static int F_227 ( struct V_7 * V_11 , enum V_446 V_87 )
{
struct V_447 * V_448 ;
unsigned long long V_449 ;
...
if ( V_11 -> V_87 != V_88 )
return 0 ;
V_449 = F_228 ( V_11 -> V_50 . V_43 , 1000 ) ;
V_450 = F_228 ( V_11 -> V_50 . V_40 , 1000 ) ;
V_451 = F_228 ( V_11 -> V_51 . V_43 , 1000 ) ;
V_452 = F_228 ( V_11 -> V_51 . V_40 , 1000 ) ;
if ( ( V_87 == V_453 &&
( V_449 > V_454 ||
V_450 > V_454 ) ) ||
( V_87 == V_455 &&
...
if ( V_452 > V_456 )
V_452 = V_456 ;
V_448 = F_56 ( sizeof *( V_448 ) , V_206 ) ;
if ( ! V_448 )
return - V_165 ;
V_448 -> V_449 = V_449 ;
V_448 -> V_450 = V_450 ;
V_448 -> V_451 = F_229 ( V_451 ) ;
V_448 -> V_452 = F_229 ( V_452 ) ;
...
if ( V_87 == V_453 )
V_11 -> V_50 . V_462 = V_462 ;
else
V_11 -> V_51 . V_462 = V_462 ;
return 0 ;
}
...
{
int V_462 , V_54 ;
T_4 V_467 = V_11 -> V_14 -> V_18 -> V_20 ;
T_5 V_468 = V_11 -> V_14 -> V_18 -> V_21 ;
if ( ( V_87 == V_453 && V_467 == 0 ) ||
( V_87 == V_455 && V_468 == 0 ) )
return;
...
V_462 = V_156 -> V_157 -> V_469 ( V_156 , V_11 , V_87 ) ;
if ( V_462 == 0 )
return;
if ( V_462 < 0 ) {
...
if ( F_231 ( V_11 , V_87 , V_462 ) )
V_156 -> V_157 -> V_470 ( V_156 , V_11 , V_87 ) ;
else if ( V_11 -> V_8 )
...
if ( V_156 -> V_157 -> V_470 ( V_156 , V_11 , V_87 ) )
...
return 0 ;
V_11 -> V_471 ++ ;
if ( ( V_11 -> V_50 . V_462 == 0 && V_11 -> V_51 . V_462 == 0 ) )
return 0 ;
if ( F_234 ( V_156 , V_11 , V_453 ) )
goto V_472;
if ( F_234 ( V_156 , V_11 , V_455 ) )
goto V_472;
return 0 ;
V_472:
F_236 ( V_11 ) ;
...
V_11 -> V_471 -- ;
V_156 = F_60 ( V_11 -> V_170 ) ;
if ( ! V_156 || ! V_156 -> V_157 -> V_469 ||
! V_156 -> V_157 -> V_470 )
return;
if ( V_11 -> V_471 > 0 )
return;
F_233 ( V_156 , V_11 , V_453 ) ;
F_233 ( V_156 , V_11 , V_455 ) ;
}
...
int F_237 ( struct V_1 * V_2 , int V_69 , bool V_474 )
{
int V_54 ;
T_1 V_177 , V_3 ;
unsigned V_475 = 0xffff ;
int V_176 , V_476 = 0 ;
struct V_77 * V_78 = V_2 -> V_79 [ V_69 - 1 ] ;
for ( V_176 = 0 ; ; V_176 += V_181 ) {
V_54 = F_28 ( V_2 , V_69 , & V_3 , & V_177 ) ;
...
int V_478 ;
struct V_190 * V_156 = F_60 ( V_11 -> V_170 ) ;
if ( ! V_156 -> V_157 -> V_479 && V_168 <= 1 )
return - V_66 ;
if ( V_11 -> V_87 == V_430 )
return 0 ;
if ( V_11 -> V_87 != V_403 )
return - V_66 ;
if ( V_156 -> V_157 -> V_479 )
V_478 = V_156 -> V_157 -> V_479 ( V_156 , V_11 ) ;
else
V_478 = F_14 ( V_11 , F_242 () ,
V_480 , 0 , V_168 , 0 ,
NULL , 0 , V_200 ) ;
if ( V_478 == 0 ) {
F_137 ( V_11 , V_168 ) ;
...
if ( ( V_11 -> V_14 -> V_15 -> V_17 & F_244 ( V_482 ) ) ||
V_370 == V_372 ) {
V_11 -> V_483 = 1 ;
F_210 ( V_11 , 1 ) ;
}
...
{
struct V_190 * V_156 = F_60 ( V_11 -> V_170 ) ;
if ( ! V_156 -> V_157 -> V_484 )
return 0 ;
if ( V_11 -> V_87 == V_430 )
return 0 ;
if ( V_11 -> V_87 != V_403 )
return - V_66 ;
return V_156 -> V_157 -> V_484 ( V_156 , V_11 ) ;
}
static int
...
int V_53 , V_486 , V_478 ;
unsigned V_192 = V_395 ;
enum V_487 V_488 = V_11 -> V_12 ;
const char * V_12 ;
...
V_478 = F_194 ( V_2 , V_69 , V_11 , V_192 , false ) ;
if ( V_478 < 0 )
goto V_243;
V_478 = - V_113 ;
if ( V_488 != V_490 && V_488 != V_11 -> V_12 ) {
...
case V_49 :
case V_398 :
V_11 -> V_342 . V_280 . V_491 = F_229 ( 512 ) ;
break;
case V_13 :
V_11 -> V_342 . V_280 . V_491 = F_229 ( 64 ) ;
break;
case V_400 :
V_11 -> V_342 . V_280 . V_491 = F_229 ( 64 ) ;
break;
case V_399 :
V_11 -> V_342 . V_280 . V_491 = F_229 ( 8 ) ;
break;
default:
goto V_243;
}
...
V_168 , V_11 -> V_170 -> V_492 -> V_157 -> V_493 ) ;
if ( V_4 -> V_142 ) {
...
for ( V_53 = 0 ; V_53 < V_494 ; ( ++ V_53 , F_66 ( 100 ) ) ) {
bool V_495 = false ;
if ( F_189 ( V_11 , V_485 ) ) {
struct V_496 * V_497 ;
int V_498 = 0 ;
...
#define F_248 64
V_497 = F_56 ( F_248 , V_206 ) ;
if ( ! V_497 ) {
V_478 = - V_165 ;
continue;
}
for ( V_486 = 0 ; V_486 < 3 ; ++ V_486 ) {
V_497 -> V_499 = 0 ;
V_498 = F_14 ( V_11 , F_249 () ,
V_61 , V_62 ,
V_500 << 8 , 0 ,
V_497 , F_248 ,
V_501 ) ;
...
if ( V_11 -> V_334 == 0 ) {
for ( V_486 = 0 ; V_486 < V_505 ; ++ V_486 ) {
V_478 = F_241 ( V_11 , V_168 ) ;
if ( V_478 >= 0 )
break;
F_66 ( 200 ) ;
}
...
if ( V_11 -> V_33 . V_499 == 0xff ||
V_11 -> V_12 == V_49 )
V_53 = 512 ;
else
V_53 = V_11 -> V_33 . V_499 ;
...
V_11 -> V_342 . V_280 . V_491 = F_229 ( V_53 ) ;
F_238 ( V_11 ) ;
}
V_478 = F_185 ( V_11 , V_508 ) ;
if ( V_478 < ( signed ) sizeof( V_11 -> V_33 ) ) {
if ( V_478 != - V_113 )
...
if ( V_11 -> V_334 == 0 && F_12 ( V_11 -> V_33 . V_506 ) >= 0x0201 ) {
V_478 = F_251 ( V_11 ) ;
if ( ! V_478 ) {
V_11 -> V_23 = F_5 ( V_11 ) ;
F_11 ( V_11 ) ;
...
V_478 = 0 ;
if ( V_156 -> V_157 -> V_510 )
V_156 -> V_157 -> V_510 ( V_156 , V_11 ) ;
F_243 ( V_11 ) ;
V_243:
if ( V_478 ) {
F_72 ( V_2 , V_69 , 0 ) ;
...
if ( V_11 -> V_329 & V_513 )
return;
V_512 = F_56 ( sizeof *V_512 , V_242 ) ;
if ( V_512 == NULL )
return;
V_80 = F_253 ( V_11 , V_514 , 0 ,
V_512 , sizeof *V_512 ) ;
if ( V_80 == sizeof *V_512 ) {
F_7 ( & V_11 -> V_19 , L_164
L_165 ) ;
if ( V_2 -> V_224 ) {
...
static int V_516 = - 1 ;
if ( V_11 ) {
if ( V_156 -> V_517 && ! V_4 -> V_22 )
F_257 ( V_156 -> V_517 , V_11 -> V_12 ) ;
F_84 ( & V_78 -> V_184 ) ;
}
if ( ! ( V_3 & V_207 ) ||
( V_177 & V_209 ) )
...
if ( F_12 ( V_11 -> V_33 . V_506 ) >= 0x0200
&& V_11 -> V_12 == V_400
&& V_289 != 0 )
F_252 ( V_2 , V_11 , V_69 ) ;
V_80 = 0 ;
...
V_405:
F_72 ( V_2 , V_69 , 1 ) ;
if ( V_156 -> V_157 -> V_527 && ! V_2 -> V_4 -> V_22 )
...
int V_546 ;
char * V_497 ;
if ( memcmp ( & V_11 -> V_33 , V_539 ,
sizeof( * V_539 ) ) != 0 )
return 1 ;
if ( ( V_541 && ! V_11 -> V_14 ) || ( ! V_541 && V_11 -> V_14 ) )
return 1 ;
if ( V_11 -> V_14 ) {
V_544 = F_12 ( V_11 -> V_14 -> V_280 -> V_356 ) ;
if ( V_544 != F_12 ( V_541 -> V_280 -> V_356 ) )
return 1 ;
if ( memcmp ( V_11 -> V_14 -> V_280 , V_541 -> V_280 , V_544 ) )
return 1 ;
}
if ( V_11 -> V_350 )
V_543 = strlen ( V_11 -> V_350 ) + 1 ;
V_544 = V_543 ;
for ( V_542 = 0 ; V_542 < V_11 -> V_33 . V_547 ; V_542 ++ ) {
V_545 = F_12 ( V_11 -> V_353 [ V_542 ] . V_280 . V_356 ) ;
V_544 = F_277 ( V_544 , V_545 ) ;
}
V_497 = F_56 ( V_544 , V_206 ) ;
if ( V_497 == NULL ) {
...
for ( V_542 = 0 ; V_542 < V_11 -> V_33 . V_547 ; V_542 ++ ) {
V_545 = F_12 ( V_11 -> V_353 [ V_542 ] . V_280 . V_356 ) ;
V_546 = F_253 ( V_11 , V_548 , V_542 , V_497 ,
V_545 ) ;
if ( V_546 != V_545 ) {
...
if ( memcmp ( V_497 , V_11 -> V_355 [ V_542 ] , V_545 )
!= 0 ) {
...
if ( ! V_85 && V_543 ) {
V_546 = F_278 ( V_11 , V_11 -> V_33 . V_347 ,
V_497 , V_543 ) ;
if ( V_546 + 1 != V_543 ) {
F_22 ( & V_11 -> V_19 , L_189 ,
V_546 ) ;
V_85 = 1 ;
} else if ( memcmp ( V_497 , V_11 -> V_350 , V_546 ) != 0 ) {
...
{
struct V_7 * V_551 = V_11 -> V_22 ;
struct V_1 * V_552 ;
struct V_190 * V_156 = F_60 ( V_11 -> V_170 ) ;
struct V_496 V_33 = V_11 -> V_33 ;
struct V_540 * V_14 ;
int V_53 , V_486 , V_54 = 0 ;
int V_69 = V_11 -> V_126 ;
if ( V_11 -> V_87 == V_185 ||
V_11 -> V_87 == V_323 ) {
...
for ( V_53 = 0 ; V_53 < V_518 ; ++ V_53 ) {
F_238 ( V_11 ) ;
V_54 = F_246 ( V_552 , V_11 , V_69 , V_53 ) ;
...
V_54 = F_14 ( V_11 , F_17 ( V_11 , 0 ) ,
V_555 , 0 ,
V_11 -> V_8 -> V_280 . V_550 , 0 ,
NULL , 0 , V_200 ) ;
if ( V_54 < 0 ) {
F_30 ( & V_11 -> V_19 ,
L_197 ,
V_11 -> V_8 -> V_280 . V_550 , V_54 ) ;
F_31 ( V_156 -> V_473 ) ;
goto V_554;
}
F_31 ( V_156 -> V_473 ) ;
F_73 ( V_11 , V_88 ) ;
for ( V_53 = 0 ; V_53 < V_11 -> V_8 -> V_280 . V_556 ; V_53 ++ ) {
struct V_557 * V_353 = V_11 -> V_8 ;
...
for ( V_486 = 0 ; V_486 < V_120 -> V_293 -> V_280 . V_302 ; V_486 ++ )
V_120 -> V_293 -> V_232 [ V_486 ] . V_562 = 0 ;
}
V_405:
F_210 ( V_11 , 1 ) ;
F_212 ( V_11 ) ;
...
F_184 ( V_11 ) ;
if ( V_353 ) {
for ( V_53 = 0 ; V_53 < V_353 -> V_280 . V_556 ; ++ V_53 ) {
struct V_119 * V_564 = V_353 -> V_10 [ V_53 ] ;
struct V_565 * V_155 ;
int V_566 = 0 ;
if ( V_564 -> V_19 . V_157 ) {
V_155 = F_284 ( V_564 -> V_19 . V_157 ) ;
if ( V_155 -> V_567 && V_155 -> V_568 )
V_566 = ( V_155 -> V_567 ) ( V_564 ) ;
else if ( V_564 -> V_569 ==
V_570 )
V_566 = 1 ;
if ( V_566 )
...
F_199 ( V_78 ) ;
if ( V_353 ) {
for ( V_53 = V_353 -> V_280 . V_556 - 1 ; V_53 >= 0 ; -- V_53 ) {
struct V_119 * V_564 = V_353 -> V_10 [ V_53 ] ;
struct V_565 * V_155 ;
int V_571 = V_564 -> V_572 ;
if ( ! V_571 && V_564 -> V_19 . V_157 ) {
V_155 = F_284 ( V_564 -> V_19 . V_157 ) ;
if ( V_155 -> V_568 )
V_571 = ( V_155 -> V_568 ) ( V_564 ) ;
else if ( V_564 -> V_569 ==
V_570 )
V_571 = 1 ;
if ( V_571 )
...
if ( V_370 == V_372 ) {
T_2 V_576 = 1 << ( V_53 % 8 ) ;
if ( ! ( V_280 -> V_34 . V_248 . V_249 [ V_53 / 8 ] & V_576 ) ) {
F_22 ( & V_78 -> V_19 , L_201 ) ;
V_280 -> V_34 . V_248 . V_249 [ V_53 / 8 ] |= V_576 ;
}
}
}
} else {
T_1 V_577 = F_12 ( V_280 -> V_34 . V_35 . V_249 ) ;
for ( V_53 = 1 ; V_53 <= V_4 -> V_9 ; V_53 ++ ) {
struct V_77 * V_78 = V_2 -> V_79 [ V_53 - 1 ] ;
V_370 = V_78 -> V_370 ;
if ( V_370 == V_372 ) {
...
V_280 -> V_34 . V_35 . V_249 = F_229 ( V_577 ) ;
}
}
